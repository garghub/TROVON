...
static int F_63 ( struct V_162 * V_115 )
{
int V_6 ;
struct V_77 * V_43 = V_115 -> V_163 -> V_157 ;
struct V_156 * V_157 = V_43 -> V_79 -> V_157 ;
if ( F_5 ( & V_43 -> V_79 -> V_164 ) )
return - V_12 ;
V_6 = V_157 -> V_170 [ V_43 -> V_88 ] ( V_115 ) ;
F_12 ( & V_43 -> V_79 -> V_164 ) ;
return V_6 ;
}
static int F_64 ( struct V_162 * V_115 )
{
int V_6 ;
struct V_77 * V_43 = V_115 -> V_163 -> V_157 ;
struct V_156 * V_157 = V_43 -> V_79 -> V_157 ;
if ( F_5 ( & V_43 -> V_79 -> V_164 ) )
return - V_12 ;
V_6 = V_157 -> V_171 [ V_43 -> V_88 ] ( V_115 ) ;
F_12 ( & V_43 -> V_79 -> V_164 ) ;
return V_6 ;
}
...
{
int V_6 ;
struct V_156 * V_172 = V_43 -> V_79 -> V_157 ;
if ( V_43 -> V_88 == 1 ) {
if ( V_63 . V_64 ) {
V_6 = F_35 ( V_43 -> V_79 ) ;
if ( V_6 ) {
...
V_43 -> V_173 [ 0 ] . V_115 = F_66 ( V_174 ,
& V_41 [ V_43 -> V_88 ] , & V_43 -> V_79 -> V_175 ) ;
if ( V_43 -> V_173 [ 0 ] . V_115 ) {
V_172 -> V_165 [ V_43 -> V_88 ] =
V_43 -> V_173 [ 0 ] . V_115 -> V_176 . V_165 ;
V_43 -> V_173 [ 0 ] . V_115 -> V_176 . V_165 =
F_59 ;
V_172 -> V_167 [ V_43 -> V_88 ] =
V_43 -> V_173 [ 0 ] . V_115 -> V_176 . V_167 ;
V_43 -> V_173 [ 0 ] . V_115 -> V_176 . V_167 =
F_60 ;
V_172 -> V_168 [ V_43 -> V_88 ] = V_43 -> V_173 [ 0 ] . V_115 -> V_176 . V_168 ;
V_43 -> V_173 [ 0 ] . V_115 -> V_176 . V_168 = F_61 ;
V_172 -> V_169 [ V_43 -> V_88 ] = V_43 -> V_173 [ 0 ] . V_115 -> V_176 . V_169 ;
V_43 -> V_173 [ 0 ] . V_115 -> V_176 . V_169 = F_62 ;
}
return V_43 -> V_173 [ 0 ] . V_115 == NULL ? - V_147 : 0 ;
}
static int F_67 ( struct V_77 * V_43 )
{
int V_6 ;
struct V_156 * V_172 = V_43 -> V_79 -> V_157 ;
F_27 ( L_10 , V_60 ) ;
...
case V_132 :
case V_135 :
V_6 = F_66 ( V_177 , V_43 -> V_173 [ 0 ] . V_115 ,
& V_43 -> V_79 -> V_175 , & V_178 ,
V_63 . V_128 [ V_43 -> V_88 ] )
== NULL ? - V_147 : 0 ;
break;
case V_133 :
case V_137 :
V_6 = F_66 ( V_179 , V_43 -> V_173 [ 0 ] . V_115 ,
& V_43 -> V_79 -> V_175 ,
& V_180 ) == NULL ? - V_147 : 0 ;
break;
case V_136 :
V_6 = F_66 ( V_181 , V_43 -> V_173 [ 0 ] . V_115 , 0xc0 ,
& V_43 -> V_79 -> V_175 ,
& V_182 ) == NULL ? - V_147 : 0 ;
break;
case V_138 :
V_6 = F_66 ( V_183 , V_43 -> V_173 [ 0 ] . V_115 ,
& V_43 -> V_79 -> V_175 ,
& V_184 ) == NULL ? - V_147 : 0 ;
break;
case V_140 :
V_6 = F_66 ( V_185 , V_43 -> V_173 [ 0 ] . V_115 ,
& V_43 -> V_79 -> V_175 ,
& V_186 ) == NULL ? - V_147 : 0 ;
break;
case V_141 :
...
break;
case V_131 :
V_6 = F_66 ( V_188 , V_43 -> V_173 [ 0 ] . V_115 , 0xc0 ,
& V_43 -> V_79 -> V_175 ,
V_189 ) == NULL ? - V_147 : 0 ;
break;
case V_144 :
V_6 = F_66 ( V_190 , V_43 -> V_173 [ 0 ] . V_115 ,
& V_43 -> V_79 -> V_175 ,
& V_191 ) == NULL ? - V_147 : 0 ;
break;
case V_143 :
V_6 = F_66 ( V_192 , V_43 -> V_173 [ 0 ] . V_115 ,
& V_43 -> V_79 -> V_175 ,
0xc0 , & V_193 ) == NULL ? - V_147 : 0 ;
break;
case V_134 :
default:
V_6 = - V_147 ;
...
if ( V_43 -> V_173 [ 0 ] . V_115 -> V_176 . V_194 . V_168 ) {
V_172 -> V_170 [ V_43 -> V_88 ] =
V_43 -> V_173 [ 0 ] . V_115 -> V_176 . V_194 . V_168 ;
V_43 -> V_173 [ 0 ] . V_115 -> V_176 . V_194 . V_168 = F_63 ;
}
if ( V_43 -> V_173 [ 0 ] . V_115 -> V_176 . V_194 . V_169 ) {
V_172 -> V_171 [ V_43 -> V_88 ] =
V_43 -> V_173 [ 0 ] . V_115 -> V_176 . V_194 . V_169 ;
V_43 -> V_173 [ 0 ] . V_115 -> V_176 . V_194 . V_169 = F_64 ;
}
return V_6 ;
}
static int F_68 ( struct V_195 * V_196 ,
const struct V_197 * V_88 )
{
int V_6 = 0 ;
struct V_35 * V_36 = NULL ;
struct V_1 * V_2 = F_69 ( V_196 ) ;
T_1 V_47 ;
F_27 ( L_42 , V_60 ,
V_196 -> V_198 -> V_153 . V_199 ) ;
if ( V_196 -> V_198 -> V_153 . V_199 == 0 ) {
V_6 = F_53 ( V_2 ) ;
if ( V_6 )
return V_6 ;
for ( V_47 = 0 ; V_47 < V_111 ; V_47 ++ ) {
V_6 = F_70 ( V_196 , & V_113 [ V_47 ] ,
V_200 , & V_36 , V_201 ) ;
if ( ! V_6 )
break;
if ( V_6 != - V_147 )
