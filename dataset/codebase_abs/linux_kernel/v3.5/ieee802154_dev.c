...
struct V_32 *
F_28 ( T_1 V_33 , struct V_34 * V_10 )
{
struct V_16 * V_17 ;
struct V_5 * V_4 ;
T_1 V_35 ;
if ( ! V_10 || ! V_10 -> V_36 || ! V_10 -> V_37 || ! V_10 -> V_11 ||
! V_10 -> V_15 || ! V_10 -> V_38 ) {
F_29 ( V_39
L_1 ) ;
return NULL ;
}
V_35 = F_30 ( sizeof( * V_4 ) , V_40 ) + V_33 ;
V_17 = F_31 ( V_35 ) ;
if ( ! V_17 ) {
F_29 ( V_39
L_2 ) ;
...
V_4 -> V_7 . V_4 = ( char * ) V_4 + F_30 ( sizeof( * V_4 ) , V_40 ) ;
V_4 -> V_10 = V_10 ;
F_32 ( & V_4 -> V_24 ) ;
F_33 ( & V_4 -> V_20 ) ;
return & V_4 -> V_7 ;
}
void F_34 ( struct V_32 * V_7 )
{
...
void F_45 ( struct V_32 * V_2 )
{
struct V_5 * V_4 = F_35 ( V_2 ) ;
struct V_3 * V_25 , * V_49 ;
F_46 ( V_4 -> V_42 ) ;
F_44 ( V_4 -> V_42 ) ;
F_14 () ;
F_11 ( & V_4 -> V_20 ) ;
