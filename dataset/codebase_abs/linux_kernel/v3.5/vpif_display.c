...
V_117 ;
F_118 ( V_298 , & V_54 -> V_294 -> V_172 ) ;
V_54 -> V_294 -> V_167 = & V_30 -> V_167 ;
F_28 ( 1 , V_98 , L_51 ,
( int ) V_54 , ( int ) & V_54 -> V_294 ) ;
V_269 = F_119 ( V_54 -> V_294 ,
V_299 , ( V_270 ? 3 : 2 ) ) ;
if ( V_269 < 0 )
goto V_300;
F_120 ( V_54 -> V_294 , V_54 ) ;
}
V_285 = F_121 ( 1 ) ;
V_94 = V_280 -> V_76 . V_148 ;
V_288 = V_94 -> V_288 ;
V_282 = V_94 -> V_301 ;
V_77 . V_217 = F_42 ( sizeof( struct V_302 * ) * V_288 ,
V_134 ) ;
if ( V_77 . V_217 == NULL ) {
F_9 ( L_52 ) ;
V_269 = - V_135 ;
...
V_77 . V_217 [ V_78 ] = F_122 ( & V_77 . V_185 ,
V_285 ,
& V_282 [ V_78 ] . V_303 ,
NULL ) ;
if ( ! V_77 . V_217 [ V_78 ] ) {
...
F_126 ( V_179 , ( void * ) ( & V_77 . V_76 [ V_283 ] -> V_58 ) ) ;
V_14 = F_110 ( V_280 , V_289 , V_283 - 1 ) ;
V_179 = V_14 -> V_291 ;
}
return V_269 ;
}
static int F_127 ( struct V_279 * V_306 )
{
struct V_53 * V_54 ;
int V_78 ;
F_125 ( & V_77 . V_185 ) ;
...
int V_308 ;
int V_78 = 0 ;
V_280 = F_131 ( V_147 , struct V_279 , V_76 ) ;
while ( ( V_14 = F_110 ( V_280 , V_289 , V_78 ) ) ) {
for ( V_308 = V_14 -> V_290 ; V_308 <= V_14 -> V_291 ; V_308 ++ )
F_126 ( V_308 ,
