...
int V_87 = 1 ;
V_87 = F_87 ( V_2 -> V_86 , F_39 , 0 , L_53 , V_2 ) ;
if ( V_87 )
F_17 ( V_51 L_54 ,
V_2 -> V_86 , V_87 ) ;
}
...
static void F_90 ( struct V_140 * V_140 , const char * V_26 ,
unsigned int V_27 )
{
...
static struct V_142 * F_91 ( struct V_140 * V_140 ,
int * V_10 )
{
* V_10 = V_140 -> V_10 ;
return V_119 ;
}
static int T_4 F_92 ( struct V_140 * V_140 , char * V_143 )
{
struct V_1 * V_2 ;
int V_87 ;
...
struct V_144 * V_145 ;
F_50 = F_44 ;
for ( V_145 = F_94 ( NULL , L_57 , L_58 ) ;
V_145 != NULL ;
V_145 = F_94 ( V_145 , L_57 , L_58 ) ) {
struct V_1 * V_2 ;
const T_5 * V_29 , * V_76 ;
V_29 = F_95 ( V_145 , L_59 , NULL ) ;
V_76 = F_95 ( V_145 , L_60 , NULL ) ;
if ( ! V_29 || ! V_76 )
continue;
if ( V_120 >= V_146 ) {
F_96 ( V_145 ) ;
