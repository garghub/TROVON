...
F_32 ( V_29 , V_2 -> V_24 ) ;
if ( V_26 ) {
V_2 -> V_26 = ( V_2 -> V_24 + V_44 / 2 ) / V_44 ;
F_18 ( V_2 , V_2 -> V_26 , 1 ) ;
}
}
static void F_33 ( enum V_45 V_30 ,
struct V_43 * V_29 )
{
...
F_38 ( V_29 , 1 , 0x300 , 0xffffffff ) ;
V_20 = F_39 ( V_2 -> V_56 . V_27 , & V_2 -> V_56 ) ;
if ( V_20 ) {
...
static int F_40 ( struct V_1 * V_2 , char * V_36 ,
unsigned long V_57 ,
unsigned long V_58 )
{
if ( V_57 )
...
static int F_41 ( struct V_1 * V_2 , struct V_59 * V_6 )
{
...
V_2 -> V_10 = F_45 ( V_61 -> V_16 , F_46 ( V_61 ) ) ;
if ( V_2 -> V_10 == NULL ) {
F_14 ( & V_2 -> V_6 -> V_7 , L_10 ) ;
goto V_63;
}
V_2 -> V_56 . V_36 = F_47 ( & V_2 -> V_6 -> V_7 ) ;
V_2 -> V_56 . V_65 = F_19 ;
V_2 -> V_56 . V_28 = V_2 ;
V_2 -> V_56 . V_27 = V_27 ;
V_2 -> V_56 . V_17 = V_66 | V_67 | \
V_68 | V_69 ;
V_2 -> V_21 = F_48 ( & V_2 -> V_6 -> V_7 , L_11 ) ;
if ( F_49 ( V_2 -> V_21 ) ) {
F_14 ( & V_2 -> V_6 -> V_7 , L_12 ) ;
V_20 = F_50 ( V_2 -> V_21 ) ;
goto V_70;
}
return F_40 ( V_2 , ( char * ) F_47 ( & V_2 -> V_6 -> V_7 ) ,
V_5 -> V_57 ,
V_5 -> V_58 ) ;
V_70:
F_51 ( V_2 -> V_10 ) ;
...
static int T_4 F_52 ( struct V_59 * V_6 )
{
...
static int T_5 F_58 ( struct V_59 * V_6 )
{
return - V_73 ;
}
