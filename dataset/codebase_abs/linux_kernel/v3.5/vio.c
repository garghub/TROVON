...
static void T_6 F_87 ( struct V_48 * V_49 )
{
struct V_137 * V_139 = F_88 ( V_49 ) ;
if ( V_139 )
F_89 ( V_139 , V_49 -> V_4 ?
V_49 -> V_4 -> V_162 : F_90 ( V_49 ) ) ;
F_5 ( V_49 -> V_4 ) ;
F_49 ( F_24 ( V_49 ) ) ;
}
...
struct V_7 * V_8 ;
struct V_1 * V_163 ;
const unsigned int * V_164 ;
const unsigned int * V_165 = NULL ;
enum V_166 V_85 ;
const char * V_167 = V_4 -> V_159 ? V_4 -> V_159 : L_18 ;
V_163 = F_92 ( V_4 ) ;
if ( V_163 ) {
if ( ! strcmp ( V_163 -> V_162 , L_19 ) )
V_85 = V_87 ;
else if ( ! strcmp ( V_163 -> V_162 , L_20 ) )
V_85 = V_86 ;
else {
F_93 ( L_21 ,
V_89 ,
...
V_164 = F_40 ( V_4 , L_28 , NULL ) ;
if ( V_164 == NULL ) {
F_93 ( L_29 ,
V_89 , V_167 ) ;
goto V_39;
}
F_94 ( & V_8 -> V_49 , L_30 , * V_164 ) ;
V_8 -> V_168 = F_95 ( V_4 , 0 ) ;
V_8 -> V_164 = * V_164 ;
} else {
V_165 = F_40 ( V_4 , L_31 , NULL ) ;
if ( V_165 != NULL )
V_8 -> V_120 = * V_165 ;
V_164 = NULL ;
F_94 ( & V_8 -> V_49 , L_32 , V_167 ) ;
V_8 -> type = V_167 ;
V_8 -> V_168 = 0 ;
}
V_8 -> V_159 = V_4 -> V_159 ;
...
F_52 ( & V_8 -> V_49 , & V_56 ) ;
F_97 ( & V_8 -> V_49 , F_72 ( V_8 ) ) ;
F_98 ( & V_8 -> V_49 , F_99 ( V_4 ) ) ;
...
if ( V_173 ) {
V_174 = F_105 ( V_173 , NULL ) ;
while ( V_174 ) {
F_91 ( V_174 ) ;
V_174 = F_105 ( V_173 , V_174 ) ;
}
F_5 ( V_173 ) ;
}
}
...
static T_5 F_108 ( struct V_48 * V_49 ,
struct V_101 * V_102 , char * V_103 )
{
...
return sprintf ( V_103 , L_37 , V_4 ? V_4 -> V_162 : L_38 ) ;
}
static T_5 F_110 ( struct V_48 * V_49 , struct V_101 * V_102 ,
char * V_103 )
{
...
if ( ! V_176 )
return - V_152 ;
V_177 = F_40 ( V_176 , L_39 , NULL ) ;
if ( ! V_177 )
return - V_152 ;
return sprintf ( V_103 , L_40 , V_7 -> type , V_177 ) ;
}
void T_6 F_111 ( struct V_7 * V_8 )
{
F_112 ( & V_8 -> V_49 ) ;
}
static int F_113 ( struct V_48 * V_49 , struct V_178 * V_179 )
{
const struct V_7 * V_7 = F_24 ( V_49 ) ;
...
static int F_114 ( struct V_48 * V_49 , struct V_181 * V_182 )
{
const struct V_7 * V_7 = F_24 ( V_49 ) ;
struct V_1 * V_176 ;
const char * V_177 ;
...
if ( ! V_177 )
return - V_152 ;
F_115 ( V_182 , L_41 , V_7 -> type , V_177 ) ;
return 0 ;
}
const void * F_116 ( struct V_7 * V_112 , char * V_183 , int * V_72 )
{
return F_40 ( V_112 -> V_49 . V_4 , V_183 , V_72 ) ;
}
static struct V_7 * F_117 ( const char * V_159 )
{
struct V_48 * V_79 ;
V_79 = F_118 ( & V_107 , NULL , V_159 ) ;
if ( ! V_79 )
return NULL ;
return F_24 ( V_79 ) ;
}
struct V_7 * F_119 ( struct V_1 * V_184 )
{
const T_8 * V_164 ;
char V_185 [ 20 ] ;
struct V_1 * V_186 ;
...
if ( ! V_186 )
return NULL ;
V_187 = F_40 ( V_186 , L_42 , NULL ) ;
F_5 ( V_186 ) ;
if ( ! V_187 )
return NULL ;
if ( ! strcmp ( V_187 , L_1 ) ) {
V_164 = F_40 ( V_184 , L_28 , NULL ) ;
if ( ! V_164 )
return NULL ;
snprintf ( V_185 , sizeof( V_185 ) , L_30 , * V_164 ) ;
...
int F_120 ( struct V_7 * V_49 )
{
int V_188 = F_121 ( V_49 -> V_164 , V_189 ) ;
if ( V_188 != V_98 )
...
{
int V_188 = F_121 ( V_49 -> V_164 , V_190 ) ;
if ( V_188 != V_98 )
F_58 ( V_99 L_44 , V_188 ) ;
return V_188 ;
}
