...
struct V_63 V_64 ;
if ( F_23 ( V_44 , V_25 , sizeof( V_57 ) , & V_57 ) )
goto V_65;
#ifdef F_7
if ( V_2 -> V_39 ) {
struct V_35 V_66 = {
...
if ( F_23 ( V_44 , V_26 , sizeof( V_66 ) , & V_66 ) )
goto V_65;
}
#endif
V_64 . V_67 = F_24 ( V_54 - V_2 -> V_52 . V_67 ) ;
V_64 . V_53 = F_24 ( V_54 - V_2 -> V_52 . V_53 ) ;
V_64 . V_68 = F_24 ( V_2 -> V_52 . V_68 ) ;
if ( F_23 ( V_44 , V_69 , sizeof( V_64 ) , & V_64 ) )
goto V_65;
return V_44 -> V_70 ;
V_65:
F_25 ( V_44 , V_56 ) ;
