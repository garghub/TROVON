...
unsigned int * V_75 , T_5 * V_76 )
{
unsigned int V_77 ;
int V_78 = 0 ;
F_39 ( V_78 , V_19 -> V_79 , 3 * V_80 ,
( ( ( V_77 = F_40 ( V_76 ) )
- * V_75 ) <= ( 1 << 23 ) ) ) ;
* V_75 = V_77 ;
return V_78 ;
...
T_2 V_82 = V_11 ;
T_2 V_81 = 0 ;
T_2 V_91 = 0 , V_92 = 0 , V_93 = 0 , V_94 = 0 ;
switch ( V_1 ) {
case 0 :
break;
case 1 :
...
do {
V_91 = ( ( F_26 ( V_87 ) & V_100 ) >>
V_101 ) ;
V_93 = ( ( F_26 ( V_89 ) & V_102 ) >>
V_103 ) ;
V_92 = ( ( F_26 ( V_87 ) & V_100 ) >>
V_101 ) ;
} while ( V_91 != V_92 );
V_94 = ( V_91 << 8 ) | V_93 ;
V_99:
