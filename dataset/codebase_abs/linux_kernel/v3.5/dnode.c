...
struct V_3 * V_5 ;
struct V_3 * V_6 = F_2 ( V_2 ) ;
unsigned V_38 = F_27 ( V_36 , V_37 ) ;
for ( V_5 = F_3 ( V_2 ) ; V_5 < V_6 ; V_5 = F_4 ( V_5 ) ) {
int V_23 = F_28 ( V_28 , V_35 , V_36 , V_5 -> V_35 , V_5 -> V_36 , V_5 -> V_39 ) ;
if ( ! V_23 ) {
...
memset ( V_5 , 0 , V_38 ) ;
if ( V_37 ) {
* ( V_34 * ) ( ( char * ) V_5 + V_38 - 4 ) = F_24 ( V_37 ) ;
V_5 -> V_31 = 1 ;
}
V_5 -> V_32 = F_25 ( V_38 ) ;
V_5 -> V_40 = F_29 ( V_35 , V_36 ) ;
V_5 -> V_36 = V_36 ;
memcpy ( V_5 -> V_35 , V_35 , V_36 ) ;
V_2 -> V_33 = F_24 ( F_5 ( V_2 -> V_33 ) + V_38 ) ;
return V_5 ;
}
...
struct V_42 V_43 ;
struct V_1 * V_44 ;
if ( ( V_44 = F_32 ( V_28 , F_22 ( V_5 ) , & V_43 ) ) ) {
...
static int F_35 ( struct V_9 * V_7 , T_2 V_41 ,
...
if ( ! ( V_2 = F_32 ( V_7 -> V_64 , V_41 , & V_43 ) ) ) {
F_10 ( V_52 ) ;
F_10 ( V_56 ) ;
return 1 ;
}
...
if ( F_36 ( V_7 -> V_64 , V_41 , & V_61 , & V_62 , L_13 ) ) {
F_34 ( & V_43 ) ;
F_10 ( V_52 ) ;
F_10 ( V_56 ) ;
return 1 ;
}
if ( F_5 ( V_2 -> V_33 ) + F_27 ( V_36 , V_37 ) <= 2048 ) {
T_1 V_22 ;
F_37 ( V_5 = F_26 ( V_7 -> V_64 , V_2 , V_35 , V_36 , V_37 ) , V_47 ) ;
V_22 = F_1 ( V_2 , V_5 ) ;
...
F_37 ( V_5 = F_26 ( V_7 -> V_64 , V_52 , V_35 , V_36 , V_37 ) , V_47 ) ;
F_12 ( V_7 , F_15 , F_1 ( V_52 , V_5 ) , 1 ) ;
V_57 = ( ( char * ) F_18 ( V_52 ) - ( char * ) V_52 ) / 2 + 10 ;
if ( ! ( V_50 = F_38 ( V_7 -> V_64 , F_5 ( V_2 -> V_45 ) , & V_53 , & V_48 ) ) ) {
F_20 ( V_7 -> V_64 , L_15 ) ;
F_34 ( & V_43 ) ;
F_10 ( V_52 ) ;
F_10 ( V_56 ) ;
...
F_37 ( F_26 ( V_7 -> V_64 , V_50 , V_5 -> V_35 , V_5 -> V_36 , V_5 -> V_31 ? F_22 ( V_5 ) : 0 ) , V_5 ) ;
...
V_52 -> V_33 = F_24 ( F_5 ( V_52 -> V_33 ) - ( ( char * ) V_5 - ( char * ) V_52 - 20 ) ) ;
...
if ( ! ( V_51 = F_38 ( V_7 -> V_64 , F_5 ( V_2 -> V_45 ) , & V_54 , & V_49 ) ) ) {
F_20 ( V_7 -> V_64 , L_15 ) ;
F_34 ( & V_43 ) ;
F_34 ( & V_48 ) ;
F_10 ( V_52 ) ;
...
V_51 -> V_46 = 1 ;
V_51 -> V_45 = V_2 -> V_45 ;
if ( ! ( V_60 = F_39 ( V_7 -> V_64 , F_5 ( V_2 -> V_45 ) , & V_59 ) ) ) {
F_40 ( V_7 -> V_64 , V_54 ) ;
F_34 ( & V_43 ) ;
F_34 ( & V_48 ) ;
F_34 ( & V_49 ) ;
...
V_60 -> V_68 . V_69 [ 0 ] . V_70 = F_24 ( V_54 ) ;
F_41 ( V_59 ) ;
F_42 ( V_59 ) ;
F_8 ( V_7 ) -> V_71 = V_54 ;
V_2 -> V_45 = V_50 -> V_45 = F_24 ( V_54 ) ;
...
V_31:
if ( F_21 ( V_7 -> V_64 ) -> V_30 )
if ( F_36 ( V_7 -> V_64 , V_41 , & V_61 , & V_62 , L_16 ) ) return 1 ;
if ( ! ( V_2 = F_32 ( V_7 -> V_64 , V_41 , & V_43 ) ) ) return 1 ;
V_6 = F_2 ( V_2 ) ;
for ( V_5 = F_3 ( V_2 ) ; V_5 < V_6 ; V_5 = F_4 ( V_5 ) ) {
if ( ! ( V_23 = F_28 ( V_7 -> V_64 , V_35 , V_36 , V_5 -> V_35 , V_5 -> V_36 , V_5 -> V_39 ) ) ) {
F_34 ( & V_43 ) ;
return - 1 ;
}
if ( V_23 < 0 ) {
...
F_34 ( & V_43 ) ;
if ( F_44 ( V_7 -> V_64 , V_72 ) ) {
V_23 = 1 ;
goto V_73;
}
V_7 -> V_74 ++ ;
V_23 = F_35 ( V_7 , V_41 , V_35 , V_36 , V_47 , 0 ) ;
V_73:
return V_23 ;
}
static T_3 F_45 ( struct V_9 * V_7 , T_2 V_75 , T_2 V_76 )
{
T_2 V_41 , V_77 ;
T_2 V_78 = V_76 ;
struct V_1 * V_1 ;
...
while ( 1 ) {
if ( F_21 ( V_7 -> V_64 ) -> V_30 )
if ( F_36 ( V_7 -> V_64 , V_41 , & V_61 , & V_62 , L_17 ) )
return 0 ;
if ( ! ( V_1 = F_32 ( V_7 -> V_64 , V_41 , & V_43 ) ) ) return 0 ;
if ( F_21 ( V_7 -> V_64 ) -> V_30 ) {
...
if ( ! ( V_1 = F_32 ( V_7 -> V_64 , V_45 , & V_43 ) ) ) return 0 ;
if ( V_1 -> V_46 ) {
...
F_30 ( V_7 -> V_64 , V_1 , V_5 ) ;
F_19 ( V_7 -> V_64 , V_1 , V_77 ) ;
F_33 ( & V_43 ) ;
F_34 ( & V_43 ) ;
V_79 = F_35 ( V_7 , V_76 , V_55 -> V_35 , V_55 -> V_36 , V_55 , V_75 ) ;
F_10 ( V_55 ) ;
if ( V_79 ) return 0 ;
return V_41 ;
}
static void F_46 ( struct V_9 * V_7 , T_2 V_41 )
{
struct V_11 * V_12 = F_8 ( V_7 ) ;
struct V_42 V_43 ;
struct V_1 * V_1 ;
...
int V_61 , V_62 = 0 ;
V_81:
if ( F_36 ( V_7 -> V_64 , V_41 , & V_61 , & V_62 , L_23 ) ) return;
if ( ! ( V_1 = F_32 ( V_7 -> V_64 , V_41 , & V_43 ) ) ) return;
...
if ( ( V_84 = F_32 ( V_7 -> V_64 , V_31 , & V_48 ) ) ) {
V_84 -> V_45 = F_24 ( V_45 ) ;
V_84 -> V_46 = 1 ;
F_33 ( & V_48 ) ;
F_34 ( & V_48 ) ;
}
if ( ( V_60 = F_39 ( V_7 -> V_64 , V_45 , & V_59 ) ) ) {
V_60 -> V_68 . V_69 [ 0 ] . V_70 = F_24 ( V_31 ) ;
F_41 ( V_59 ) ;
F_42 ( V_59 ) ;
}
V_12 -> V_71 = V_31 ;
...
if ( ! ( V_1 = F_32 ( V_7 -> V_64 , V_45 , & V_43 ) ) ) return;
V_21 = 1 ;
V_6 = F_2 ( V_1 ) ;
...
if ( V_87 -> V_31 ) if ( ( V_84 = F_32 ( V_7 -> V_64 , F_22 ( V_87 ) , & V_48 ) ) ) {
V_84 -> V_45 = F_24 ( V_80 ) ;
F_33 ( & V_48 ) ;
F_34 ( & V_48 ) ;
}
F_35 ( V_7 , V_80 , V_87 -> V_35 , V_87 -> V_36 , V_87 , V_87 -> V_31 ? F_22 ( V_87 ) : 0 ) ;
V_41 = V_45 ;
F_10 ( V_87 ) ;
goto V_81;
} else {
...
V_80 = F_22 ( V_89 ) ;
if ( ( V_84 = F_32 ( V_7 -> V_64 , V_80 , & V_48 ) ) ) {
...
V_91 -> V_32 = F_25 ( F_23 ( V_91 -> V_32 ) + 4 ) ;
V_91 -> V_31 = 1 ;
V_84 -> V_33 = F_24 ( F_5 ( V_84 -> V_33 ) + 4 ) ;
}
if ( V_90 && ! V_31 ) {
V_91 -> V_32 = F_25 ( F_23 ( V_91 -> V_32 ) - 4 ) ;
V_91 -> V_31 = 0 ;
...
* ( V_34 * ) ( ( void * ) V_91 + F_23 ( V_91 -> V_32 ) - 4 ) = F_24 ( V_31 ) ;
} else goto V_88;
...
F_30 ( V_7 -> V_64 , V_1 , V_89 ) ;
if ( ! V_89 -> V_31 ) {
V_89 -> V_32 = F_25 ( F_23 ( V_89 -> V_32 ) + 4 ) ;
V_89 -> V_31 = 1 ;
V_1 -> V_33 = F_24 ( F_5 ( V_1 -> V_33 ) + 4 ) ;
}
* ( V_34 * ) ( ( void * ) V_89 + F_23 ( V_89 -> V_32 ) - 4 ) = F_24 ( V_80 ) ;
F_33 ( & V_43 ) ;
F_34 ( & V_43 ) ;
F_12 ( V_7 , F_14 , ( ( T_1 ) V_45 << 4 ) | ( V_21 - 1 ) , 4 ) ;
F_12 ( V_7 , F_14 , ( ( T_1 ) V_45 << 4 ) | V_21 , ( ( T_1 ) V_45 << 4 ) | ( V_21 - 1 ) ) ;
if ( V_31 ) if ( ( V_84 = F_32 ( V_7 -> V_64 , F_22 ( V_5 ) , & V_48 ) ) ) {
V_84 -> V_45 = F_24 ( V_80 ) ;
F_33 ( & V_48 ) ;
F_34 ( & V_48 ) ;
}
F_35 ( V_7 , V_80 , V_87 -> V_35 , V_87 -> V_36 , V_87 , V_90 ) ;
V_41 = V_45 ;
F_10 ( V_87 ) ;
goto V_81;
}
...
int F_47 ( struct V_9 * V_7 , T_2 V_41 , struct V_3 * V_5 ,
...
F_34 ( V_43 ) ;
if ( V_31 ) {
T_2 V_79 = F_45 ( V_7 , V_31 , V_41 ) ;
F_12 ( V_7 , F_14 , 5 , V_22 ) ;
if ( V_79 ) F_46 ( V_7 , V_79 ) ;
return ! V_79 ;
}
F_46 ( V_7 , V_41 ) ;
return 0 ;
}
void F_48 ( struct V_27 * V_28 , T_2 V_41 , int * V_96 ,
int * V_97 , int * V_98 )
{
struct V_1 * V_1 ;
struct V_42 V_43 ;
...
if ( V_96 ) ( * V_96 ) ++ ;
if ( F_21 ( V_28 ) -> V_30 )
if ( F_36 ( V_28 , V_41 , & V_61 , & V_62 , L_34 ) ) return;
V_29 = 0 ;
V_63:
if ( ! ( V_1 = F_32 ( V_28 , V_41 , & V_43 ) ) ) return;
...
F_34 ( & V_43 ) ;
if ( F_21 ( V_28 ) -> V_30 )
if ( F_36 ( V_28 , V_29 , & V_84 , & V_100 , L_37 ) ) return;
V_99 = - 1 ;
goto V_63;
}
static struct V_3 * F_49 ( struct V_27 * V_28 , T_2 V_41 , int V_24 ,
struct V_42 * V_43 , struct V_1 * * V_105 )
{
int V_7 ;
struct V_3 * V_5 , * V_6 ;
struct V_1 * V_1 ;
V_1 = F_32 ( V_28 , V_41 , V_43 ) ;
if ( ! V_1 ) return NULL ;
if ( V_105 ) * V_105 = V_1 ;
V_5 = F_3 ( V_1 ) ;
V_6 = F_2 ( V_1 ) ;
...
T_2 F_50 ( struct V_27 * V_28 , T_2 V_41 )
{
struct V_42 V_43 ;
T_2 V_2 = V_41 ;
T_2 V_45 = 0 ;
...
V_106:
if ( F_21 ( V_28 ) -> V_30 )
if ( F_36 ( V_28 , V_2 , & V_61 , & V_62 , L_39 ) )
return V_2 ;
if ( ! ( V_5 = F_49 ( V_28 , V_2 , 1 , & V_43 , NULL ) ) ) return V_41 ;
if ( F_21 ( V_28 ) -> V_30 )
...
struct V_3 * F_51 ( struct V_9 * V_9 , T_1 * V_107 ,
struct V_42 * V_43 )
{
T_1 V_10 ;
unsigned V_23 ;
...
V_41 = V_10 >> 6 << 2 ;
V_10 &= 077 ;
if ( ! ( V_5 = F_49 ( V_9 -> V_64 , V_41 , V_10 , V_43 , & V_1 ) ) )
goto V_112;
...
if ( V_2 -> V_31 ) {
* V_107 = ( ( T_1 ) F_50 ( V_9 -> V_64 , F_22 ( V_2 ) ) << 4 ) + 1 ;
}
return V_5 ;
}
if ( V_1 -> V_46 ) goto V_112;
if ( ! ( V_110 = F_32 ( V_9 -> V_64 , F_5 ( V_1 -> V_45 ) , & V_111 ) ) )
goto V_112;
V_109 = F_2 ( V_110 ) ;
V_23 = 0 ;
...
struct V_3 * F_52 ( struct V_9 * V_9 , T_2 V_41 ,
...
struct V_3 * V_6 ;
int V_61 , V_62 = 0 ;
if ( ! F_53 ( V_9 -> V_114 ) ) F_20 ( V_9 -> V_64 , L_44 ) ;
V_106:
if ( F_21 ( V_9 -> V_64 ) -> V_30 )
if ( F_36 ( V_9 -> V_64 , V_41 , & V_61 , & V_62 , L_45 ) ) return NULL ;
if ( ! ( V_1 = F_32 ( V_9 -> V_64 , V_41 , V_43 ) ) ) return NULL ;
V_6 = F_2 ( V_1 ) ;
for ( V_5 = F_3 ( V_1 ) ; V_5 < V_6 ; V_5 = F_4 ( V_5 ) ) {
int V_22 = F_28 ( V_9 -> V_64 , V_35 , V_113 , V_5 -> V_35 , V_5 -> V_36 , V_5 -> V_39 ) ;
if ( ! V_22 ) {
if ( V_44 ) * V_44 = V_41 ;
return V_5 ;
}
...
void F_54 ( struct V_27 * V_28 , T_2 V_41 )
{
struct V_42 V_43 ;
struct V_1 * V_1 ;
struct V_3 * V_5 ;
...
do {
while ( V_84 ) {
if ( ! ( V_1 = F_32 ( V_28 , V_41 = V_84 , & V_43 ) ) ) return;
V_5 = F_3 ( V_1 ) ;
if ( ! V_5 -> V_39 ) goto error;
V_84 = V_5 -> V_31 ? F_22 ( V_5 ) : 0 ;
F_34 ( & V_43 ) ;
...
struct V_3 * F_55 ( struct V_27 * V_28 , T_4 V_115 ,
...
if ( ! ( V_121 = F_39 ( V_28 , F_5 ( F_13 -> V_45 ) , & V_59 ) ) ) {
F_10 ( V_117 ) ;
return NULL ;
}
if ( ! F_56 ( V_121 ) ) {
...
V_23 = F_28 ( V_28 , V_116 , V_118 , V_5 -> V_35 , V_5 -> V_36 , V_5 -> V_39 ) ;
if ( V_23 < 0 && V_5 -> V_31 ) {
V_41 = F_22 ( V_5 ) ;
F_34 ( V_43 ) ;
if ( F_21 ( V_28 ) -> V_30 )
if ( F_36 ( V_28 , V_41 , & V_61 , & V_62 , L_50 ) ) {
F_10 ( V_117 ) ;
return NULL ;
}
goto V_101;
...
V_23 = F_28 ( V_28 , V_117 , V_119 , V_5 -> V_35 , V_5 -> V_36 , V_5 -> V_39 ) ;
...
F_34 ( V_43 ) ;
if ( F_21 ( V_28 ) -> V_30 )
if ( F_36 ( V_28 , V_120 , & V_84 , & V_100 , L_51 ) ) {
F_10 ( V_117 ) ;
return NULL ;
}
goto V_63;
