...
if ( V_8 )
return V_8 ;
V_13 = ( V_13 & V_6 [ V_7 ] . V_20 )
>> V_6 [ V_7 ] . V_21 ;
F_4 ( F_5 ( V_2 ) , L_2 , V_9 , V_7 , V_13 ) ;
F_15 ( V_13 >= V_6 [ V_7 ] . V_15 . V_16 ) ;
return V_6 [ V_7 ] . V_18 [ V_13 ] ;
}
int F_16 ( struct V_1 * V_2 , int V_22 ,
int V_23 , unsigned * V_14 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
struct V_5 * V_6 = V_4 -> V_6 ;
int V_7 = F_3 ( V_2 ) ;
...
int T_1 F_19 ( struct V_24 * V_25 )
{
struct V_26 * V_27 , * V_28 ;
int V_29 = 0 ;
F_20 ( V_25 -> V_30 . V_27 -> V_31 ) ;
V_27 = F_21 ( V_25 -> V_30 . V_27 -> V_31 , L_4 ) ;
if ( ! V_27 )
return - V_32 ;
F_22 (parent, child)
V_29 ++ ;
...
if ( ! V_27 )
return NULL ;
V_36 = F_25 ( & V_25 -> V_30 , sizeof( * V_36 ) * V_4 -> V_35 ,
V_39 ) ;
if ( ! V_36 )
return NULL ;
V_37 = V_36 ;
