...
F_5 ( V_1 , 0x08 , 0x008d ) ;
F_8 ( 150 ) ;
V_171 = ( ( F_7 ( V_1 , 0x00 ) & 0x0f ) << 4 )
| ( ( F_7 ( V_1 , 0x01 ) & 0xf0 ) >> 4 ) ;
F_29 ( V_172 , L_5 , V_171 ) ;
if ( V_171 == 0x0007 ) {
F_26 ( V_1 , V_48 ) ;
return 0x0f ;
}
...
V_173 = F_7 ( V_1 , 0x0a ) << 8 ;
V_173 |= F_7 ( V_1 , 0x0b ) ;
F_29 ( V_172 , L_6 , V_173 ) ;
switch ( V_173 ) {
case 0x7631 :
F_5 ( V_1 , 0x06 , 0x0010 ) ;
break;
...
return 0x11 ;
F_5 ( V_1 , 0x02 , 0x0010 ) ;
V_173 = F_1 ( V_1 , 0x000b ) << 8 ;
V_173 |= F_1 ( V_1 , 0x000a ) ;
F_29 ( V_172 , L_7 , V_173 ) ;
F_1 ( V_1 , 0x0010 ) ;
if ( ( V_173 & 0xff00 ) == 0x6400 )
return 0x02 ;
for ( V_23 = 0 ; V_23 < F_12 ( V_175 ) ; V_23 ++ ) {
if ( V_175 [ V_23 ] . V_176 == V_173 ) {
V_22 -> V_177 = V_173 ;
F_26 ( V_1 , V_50 ) ;
return V_175 [ V_23 ] . V_178 ;
}
}
F_5 ( V_1 , 0x01 , 0x0000 ) ;
F_5 ( V_1 , 0x01 , 0x0001 ) ;
...
F_5 ( V_1 , 0x01 , 0x0012 ) ;
F_5 ( V_1 , 0x05 , 0x0012 ) ;
V_173 = F_7 ( V_1 , 0x00 ) << 8 ;
V_173 |= F_7 ( V_1 , 0x01 ) ;
F_29 ( V_172 , L_10 , V_173 ) ;
if ( V_173 == 0x2030 ) {
#ifdef F_32
T_1 V_13 ;
V_13 = F_7 ( V_1 , 0x02 ) ;
F_29 ( V_172 , L_11 , V_13 ) ;
#endif
F_26 ( V_1 , V_51 ) ;
return V_173 ;
}
...
{
struct V_22 * V_22 = (struct V_22 * ) V_1 ;
if ( V_180 -> V_181 == 0x301b )
V_22 -> V_182 = V_183 ;
else
V_22 -> V_182 = V_184 ;
V_22 -> V_53 = V_180 -> V_185 ;
V_22 -> V_68 = V_186 ;
F_35 ( & V_22 -> V_162 , F_21 ) ;
return 0 ;
}
static int F_36 ( struct V_187 * V_188 )
{
struct V_1 * V_1 =
F_22 ( V_188 -> V_189 , struct V_1 , V_190 ) ;
struct V_22 * V_22 = (struct V_22 * ) V_1 ;
switch ( V_188 -> V_180 ) {
case V_191 :
V_1 -> V_4 = 0 ;
if ( V_188 -> V_20 && V_22 -> V_192 && V_1 -> V_170 )
V_22 -> V_192 -> V_20 = F_15 ( V_1 ) ;
return V_1 -> V_4 ;
}
return - V_193 ;
}
static int F_37 ( struct V_187 * V_188 )
{
struct V_1 * V_1 =
F_22 ( V_188 -> V_189 , struct V_1 , V_190 ) ;
struct V_22 * V_22 = (struct V_22 * ) V_1 ;
int V_23 , V_194 ;
V_1 -> V_4 = 0 ;
if ( V_188 -> V_180 == V_195 ) {
V_194 = V_22 -> V_68 >> 1 ;
for ( V_23 = 0 ; V_23 < F_12 ( V_67 ) ; V_23 ++ ) {
if ( V_188 -> V_20 <= V_67 [ V_23 ] )
break;
}
if ( V_23 > 0 && V_23 == V_194 && V_188 -> V_20 < V_67 [ V_23 ] )
V_23 -- ;
if ( V_23 >= 2 && V_1 -> V_170 &&
! V_1 -> V_157 . V_196 )
return - V_197 ;
V_22 -> V_68 = ( V_23 << 1 ) | 1 ;
V_188 -> V_20 = V_67 [ V_23 ] ;
}
if ( ! V_1 -> V_170 )
return 0 ;
switch ( V_188 -> V_180 ) {
...
case V_191 :
F_20 ( V_1 , V_188 -> V_20 ) ;
if ( ! V_1 -> V_4 && ! V_188 -> V_20 && V_22 -> V_192 )
F_16 ( V_1 , V_22 -> V_192 -> V_20 ) ;
break;
case V_199 :
F_19 ( V_1 , V_188 -> V_20 ) ;
break;
...
V_1 -> V_203 . V_190 = V_202 ;
F_39 ( V_202 , 8 ) ;
V_22 -> V_55 = F_40 ( V_202 , & V_204 ,
V_205 , 0 , 255 , 1 , 128 ) ;
V_22 -> V_56 = F_40 ( V_202 , & V_204 ,
V_206 , 0 , 255 , 1 , 128 ) ;
V_22 -> gamma = F_40 ( V_202 , & V_204 ,
V_198 , 1 , 6 , 1 , gamma [ V_22 -> V_53 ] ) ;
if ( V_22 -> V_53 == V_41 )
V_22 -> V_192 = F_40 ( V_202 , & V_204 ,
V_207 , 0x30d , 0x493e , 1 , 0x927 ) ;
V_22 -> V_208 = F_40 ( V_202 , & V_204 ,
V_191 , 0 , 1 , 1 , 1 ) ;
if ( V_22 -> V_53 != V_47 )
V_22 -> V_209 = F_41 ( V_202 , & V_204 ,
V_199 ,
V_210 , 0 ,
V_211 ) ;
V_22 -> V_212 = F_40 ( V_202 , & V_204 ,
V_200 , 0 , 3 , 1 ,
V_22 -> V_53 == V_51 ? 0 : 2 ) ;
V_22 -> V_213 = F_40 ( V_202 , & V_204 ,
V_195 ,
...
V_53 = F_33 ( V_1 ) ;
if ( V_53 >= 0 )
F_29 ( V_172 , L_14 , V_53 ) ;
if ( ( unsigned ) V_215 < V_33 ) {
V_22 -> V_53 = V_215 ;
F_29 ( V_172 , L_15 , V_215 ) ;
} else {
switch ( V_53 ) {
case - 1 :
switch ( V_22 -> V_53 ) {
...
V_157 = & V_1 -> V_157 ;
switch ( V_214 [ V_22 -> V_53 ] ) {
case 0 :
V_157 -> V_158 = V_216 ;
V_157 -> V_217 = F_12 ( V_216 ) ;
break;
case 1 :
V_157 -> V_158 = V_218 ;
V_157 -> V_217 = F_12 ( V_218 ) ;
break;
default:
V_157 -> V_158 = V_219 ;
V_157 -> V_217 = F_12 ( V_219 ) ;
break;
}
F_5 ( V_1 , 0x01 , 0x0000 ) ;
return V_1 -> V_4 ;
...
{
struct V_22 * V_22 = (struct V_22 * ) V_1 ;
V_1 -> V_157 . V_196 = ( V_22 -> V_68 >= 4 ) ? 1 : 0 ;
return 0 ;
}
...
struct V_22 * V_22 = (struct V_22 * ) V_1 ;
int V_70 ;
static const struct V_17 * V_220 [ V_33 ] [ 2 ] = {
[ V_34 ] =
{ V_221 , V_222 } ,
[ V_35 ] =
{ V_223 , V_224 } ,
...
F_48 ( V_22 -> V_66 , V_1 -> V_259 , V_1 -> V_260 ,
0x21 ) ;
V_70 = V_1 -> V_157 . V_158 [ V_1 -> V_159 ] . V_160 ;
switch ( V_22 -> V_53 ) {
case V_41 :
...
F_20 ( V_1 , F_49 ( V_22 -> V_208 ) ) ;
if ( V_1 -> V_4 < 0 )
return V_1 -> V_4 ;
V_22 -> V_264 = F_50 ( V_265 ) ;
F_51 ( V_22 -> V_264 , & V_22 -> V_162 ) ;
return 0 ;
}
...
struct V_22 * V_22 = (struct V_22 * ) V_1 ;
if ( V_267 >= 3
&& V_266 [ V_267 - 3 ] == 0xff && V_266 [ V_267 - 2 ] == 0xd9 ) {
F_55 ( V_1 , V_268 ,
V_266 , V_267 - 1 ) ;
return;
}
if ( V_266 [ 0 ] == 0xff && V_266 [ 1 ] == 0xd8 ) {
F_55 ( V_1 , V_269 ,
V_22 -> V_66 , V_270 ) ;
V_266 += 18 ;
V_267 -= 18 ;
}
F_55 ( V_1 , V_271 , V_266 , V_267 ) ;
}
...
struct V_22 * V_22 = (struct V_22 * ) V_1 ;
int V_3 ;
V_3 = F_57 ( V_22 -> V_213 , V_273 -> V_274 ) ;
if ( V_3 )
return V_3 ;
V_273 -> V_274 = F_49 ( V_22 -> V_213 ) ;
return 0 ;
}
...
int V_267 )
{
if ( V_267 == 8 && V_266 [ 4 ] == 1 ) {
F_60 ( V_1 -> V_278 , V_279 , 1 ) ;
F_61 ( V_1 -> V_278 ) ;
F_60 ( V_1 -> V_278 , V_279 , 0 ) ;
F_61 ( V_1 -> V_278 ) ;
}
return 0 ;
}
static int F_62 ( struct V_280 * V_281 ,
const struct V_179 * V_180 )
{
return F_63 ( V_281 , V_180 , & V_282 , sizeof( struct V_22 ) ,
V_283 ) ;
}
