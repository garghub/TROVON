...
static inline struct V_38 * F_15 ( struct V_7 * V_8 )
{
...
{
struct V_38 * V_11 = F_15 ( V_8 ) ;
return V_11 -> V_41 -> V_42 ( & V_11 -> V_40 . V_8 ) ;
}
static int F_17 ( struct V_7 * V_8 , T_2 V_43 )
{
struct V_38 * V_11 = F_15 ( V_8 ) ;
int V_17 ;
...
struct V_19 * F_18 ( const char * V_20 , void T_1 * V_1 , T_2 V_2 ,
