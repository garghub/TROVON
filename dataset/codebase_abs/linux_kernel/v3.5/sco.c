...
static inline struct V_2 * F_14 ( struct V_11 * V_16 )
{
struct V_2 * V_3 = NULL ;
F_15 ( V_16 ) ;
V_3 = V_16 -> V_3 ;
...
static inline int F_20 ( struct V_11 * V_16 , struct V_2 * V_3 , struct V_2 * V_26 )
{
int V_25 = 0 ;
F_15 ( V_16 ) ;
if ( V_16 -> V_3 )
...
type = V_31 ;
V_13 = F_28 ( V_15 , type , V_22 , V_32 , V_33 ,
V_34 ) ;
if ( F_29 ( V_13 ) ) {
V_25 = F_30 ( V_13 ) ;
goto V_35;
...
{
struct V_11 * V_16 = F_36 ( V_3 ) -> V_16 ;
struct V_44 * V_45 ;
int V_25 ;
if ( V_43 > V_16 -> V_24 )
return - V_46 ;
...
static inline void F_42 ( struct V_11 * V_16 , struct V_44 * V_45 )
{
...
V_3 -> V_4 = V_66 ;
F_7 ( V_3 , V_67 ) ;
F_31 ( F_36 ( V_3 ) -> V_16 -> V_13 ) ;
F_36 ( V_3 ) -> V_16 -> V_13 = NULL ;
} else
F_18 ( V_3 , V_68 ) ;
break;
case V_39 :
...
if ( V_115 )
F_32 ( & V_92 -> V_93 , & F_23 ( V_3 ) -> V_22 ) ;
else
F_32 ( & V_92 -> V_93 , & F_23 ( V_3 ) -> V_20 ) ;
return 0 ;
}
...
V_129 . V_132 = F_36 ( V_3 ) -> V_16 -> V_13 -> V_133 ;
memcpy ( V_129 . V_134 , F_36 ( V_3 ) -> V_16 -> V_13 -> V_134 , 3 ) ;
...
F_61 ( V_3 , V_26 ) ;
F_32 ( & F_23 ( V_3 ) -> V_20 , V_16 -> V_20 ) ;
F_32 ( & F_23 ( V_3 ) -> V_22 , V_16 -> V_22 ) ;
F_104 ( V_16 -> V_13 ) ;
F_21 ( V_16 , V_3 , V_26 ) ;
V_3 -> V_4 = V_38 ;
V_26 -> V_142 ( V_26 , 1 ) ;
...
struct V_53 * V_54 ;
int V_143 = 0 ;
F_2 ( L_20 , V_15 -> V_144 , F_24 ( V_21 ) ) ;
F_48 ( & V_57 . V_19 ) ;
F_45 (sk, node, &sco_sk_list.head) {
if ( V_3 -> V_4 != V_55 )
continue;
if ( ! F_46 ( & F_23 ( V_3 ) -> V_20 , & V_15 -> V_21 ) ||
! F_46 ( & F_23 ( V_3 ) -> V_20 , V_58 ) ) {
V_143 |= V_145 ;
break;
}
}
...
{
F_2 ( L_21 , V_13 , F_24 ( & V_13 -> V_22 ) , V_146 ) ;
if ( ! V_146 ) {
struct V_11 * V_16 ;
V_16 = F_11 ( V_13 ) ;
if ( V_16 )
...
F_48 ( & V_57 . V_19 ) ;
F_45 (sk, node, &sco_sk_list.head) {
F_111 ( V_149 , L_24 , F_24 ( & F_23 ( V_3 ) -> V_20 ) ,
F_24 ( & F_23 ( V_3 ) -> V_22 ) , V_3 -> V_4 ) ;
}
F_49 ( & V_57 . V_19 ) ;
return 0 ;
}
