...
struct V_124 * F_87 ( int V_125 )
{
struct V_124 * V_56 ;
int V_22 ;
V_56 = F_88 ( sizeof( struct V_124 ) ,
V_126 , F_89 ( V_125 ) ) ;
if ( V_56 ) {
...
static int F_91 ( int V_125 )
{
struct V_10 * V_11 = & F_92 ( V_10 , V_125 ) ;
if ( ! ( V_5 . V_129 || V_5 . V_130 ) )
return V_131 ;
V_11 -> V_94 = F_87 ( V_125 ) ;
if ( ! V_11 -> V_94 )
return V_132 ;
return V_131 ;
}
static void F_93 ( int V_125 )
{
struct V_10 * V_11 = & F_92 ( V_10 , V_125 ) ;
int V_128 = F_94 ( V_125 ) ;
int V_22 ;
F_95 ( V_125 ) ;
F_96 () ;
V_11 -> V_133 = NULL ;
...
struct V_124 * V_135 ;
V_135 = F_92 ( V_10 , V_22 ) . V_94 ;
if ( V_135 && V_135 -> V_128 == V_128 ) {
V_11 -> V_136 = V_11 -> V_94 ;
V_11 -> V_94 = V_135 ;
break;
}
}
V_11 -> V_94 -> V_128 = V_128 ;
V_11 -> V_94 -> V_137 ++ ;
}
if ( V_5 . V_130 )
V_11 -> V_133 = & V_11 -> V_94 -> V_56 [ V_138 ] ;
}
static void F_98 ( int V_125 )
{
struct V_10 * V_11 = & F_92 ( V_10 , V_125 ) ;
struct V_124 * V_135 ;
V_135 = V_11 -> V_94 ;
if ( V_135 ) {
if ( V_135 -> V_128 == - 1 || -- V_135 -> V_137 == 0 )
F_99 ( V_135 ) ;
V_11 -> V_94 = NULL ;
}
F_100 ( V_125 ) ;
...
static T_2 void F_103 ( void )
{
F_39 ( V_140 L_3 ) ;
V_5 . V_141 = 0 ;
V_5 . V_142 = NULL ;
}
static T_2 void F_104 ( void )
{
int V_59 ;
F_52 (bit, x86_pmu.events_mask, ARRAY_SIZE(intel_arch_events_map)) {
V_2 [ V_143 [ V_59 ] . V_144 ] = 0 ;
F_39 ( V_140 L_4 ,
V_143 [ V_59 ] . V_145 ) ;
}
}
static T_2 void F_105 ( void )
{
union V_146 V_147 ;
V_147 . V_148 = V_5 . V_149 ;
if ( V_147 . V_150 . V_151 ) {
V_2 [ V_152 ] = 0x7f89 ;
V_147 . V_150 . V_151 = 0 ;
V_5 . V_149 = V_147 . V_148 ;
F_39 ( V_153 L_5 ) ;
}
}
T_2 int F_106 ( void )
...
F_110 ( 10 , & V_157 . V_148 , & V_147 . V_148 , & V_158 , & V_155 . V_148 ) ;
if ( V_157 . V_150 . V_163 < V_164 )
return - V_162 ;
V_42 = V_157 . V_150 . V_165 ;
if ( V_42 < 2 )
V_5 = V_166 ;
else
V_5 = V_167 ;
V_5 . V_42 = V_42 ;
V_5 . V_50 = V_157 . V_150 . V_50 ;
V_5 . V_168 = V_157 . V_150 . V_169 ;
V_5 . V_170 = ( 1ULL << V_157 . V_150 . V_169 ) - 1 ;
V_5 . V_149 = V_147 . V_148 ;
V_5 . V_171 = V_157 . V_150 . V_163 ;
if ( V_42 > 1 )
V_5 . V_51 = F_111 ( ( int ) V_155 . V_150 . V_51 , 3 ) ;
if ( V_42 > 1 ) {
T_1 V_172 ;
F_22 ( V_173 , V_172 ) ;
V_5 . V_6 . V_172 = V_172 ;
