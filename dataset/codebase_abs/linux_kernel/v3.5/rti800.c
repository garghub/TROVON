...
if ( V_9 [ 0 ] ) {
V_6 -> V_45 &= ~ V_9 [ 0 ] ;
V_6 -> V_45 |= V_9 [ 0 ] & V_9 [ 1 ] ;
F_6 ( V_6 -> V_45 ^ 0xff , V_2 -> V_17 + V_46 ) ;
}
V_9 [ 1 ] = V_6 -> V_45 ;
return 2 ;
}
static int F_15 ( struct V_4 * V_2 , struct V_47 * V_48 )
{
unsigned int V_1 ;
unsigned long V_17 ;
int V_49 ;
struct V_5 * V_6 ;
V_17 = V_48 -> V_50 [ 0 ] ;
F_10 ( V_51 L_3 , V_2 -> V_52 , V_17 ) ;
if ( ! F_16 ( V_17 , V_53 , L_4 ) ) {
F_10 ( V_28 L_5 ) ;
return - V_29 ;
}
V_2 -> V_17 = V_17 ;
...
if ( V_49 < 0 )
return V_49 ;
V_49 = F_20 ( V_2 , sizeof( struct V_58 ) ) ;
if ( V_49 < 0 )
return V_49 ;
V_20 -> V_59 = V_48 -> V_50 [ 2 ] ;
V_20 -> V_60 = V_48 -> V_50 [ 3 ] ;
V_20 -> V_33 = V_48 -> V_50 [ 4 ] ;
V_20 -> V_61 = V_48 -> V_50 [ 5 ] ;
V_20 -> V_37 = V_48 -> V_50 [ 6 ] ;
V_20 -> V_62 = V_48 -> V_50 [ 7 ] ;
V_20 -> V_63 = V_48 -> V_50 [ 8 ] ;
V_20 -> V_16 = - 1 ;
V_6 = V_2 -> V_64 + 0 ;
V_6 -> type = V_65 ;
V_6 -> V_66 = V_67 | V_68 ;
...
static void F_21 ( struct V_4 * V_2 )
{
if ( V_2 -> V_17 )
F_22 ( V_2 -> V_17 , V_53 ) ;
if ( V_2 -> V_1 )
