...
V_239 -> V_249 |= V_250 | V_251 ;
V_239 -> V_252 = F_81 ( V_239 -> V_249 ) ;
F_82 ( V_123 , V_239 , V_240 ) ;
if ( F_83 ( V_239 , V_239 -> V_248 , V_240 >> V_242 ,
V_239 -> V_247 - V_239 -> V_248 , V_239 -> V_252 ) )
return - V_253 ;
return 0 ;
}
static int
...
{
const bool V_254 = V_119 -> V_43 & V_255 ;
V_119 -> V_43 &= ~ V_255 ;
#ifdef F_87
V_119 -> V_43 |= V_254 ? 0 : V_256 ;
#else
V_119 -> V_43 |= V_254 ? V_256 : 0 ;
#endif
if ( V_119 -> V_43 & V_256 && ! F_88 ( V_119 ) ) {
F_89 ( L_6
L_7 , V_119 -> V_15 . V_121 ) ;
return - V_257 ;
} else if ( ! ( V_119 -> V_43 & V_256 ) && F_88 ( V_119 ) ) {
F_89 ( L_8
L_7 , V_119 -> V_15 . V_121 ) ;
return - V_257 ;
}
...
static bool F_90 ( struct V_258 * V_259 , struct V_258 * V_260 )
{
if ( V_259 -> V_261 == V_260 -> V_261 )
return true ;
if ( V_259 -> V_261 > V_260 -> V_261 && V_259 -> V_261 < V_260 -> V_261 + V_260 -> V_39 )
return true ;
return false ;
}
static bool F_91 ( struct V_262 * V_263 ,
struct V_262 * V_264 )
{
int V_35 , V_36 ;
if ( ! V_264 || ! V_263 )
return false ;
for ( V_35 = 0 ; V_35 < V_264 -> V_7 ; ++ V_35 ) {
struct V_258 * V_75 = & V_264 -> V_265 [ V_35 ] ;
for ( V_36 = 0 ; V_36 < V_263 -> V_7 ; ++ V_36 ) {
struct V_258 * V_266 = & V_263 -> V_265 [ V_36 ] ;
F_57 ( V_267 L_9 ,
( unsigned long long ) V_266 -> V_261 ,
( unsigned long long ) V_266 -> V_39 ,
( unsigned long long ) V_75 -> V_261 ,
...
static void F_92 ( struct V_262 * V_268 ,
const char * V_269 , bool V_270 )
{
int V_35 ;
...
if ( ! V_6 [ V_35 ] )
continue;
if ( ! ( V_6 [ V_35 ] -> V_43 & V_272 ) )
continue;
V_271 = V_6 [ V_35 ] -> V_273 ;
if ( F_91 ( V_271 , V_268 ) ||
( V_270 && V_271 && V_271 -> V_7 &&
V_271 -> V_265 [ 0 ] . V_261 == V_274 ) ) {
F_57 ( V_275 L_10
L_11 ,
V_269 , V_6 [ V_35 ] -> V_15 . V_121 ) ;
F_93 ( V_6 [ V_35 ] ) ;
}
}
}
...
F_97 ( & V_1 -> V_11 ) ;
F_97 ( & V_1 -> V_243 ) ;
V_1 -> V_278 = F_98 ( V_279 , V_1 -> V_280 ,
F_99 ( V_281 , V_35 ) , NULL , L_5 , V_35 ) ;
if ( F_100 ( V_1 -> V_278 ) ) {
F_57 ( V_184 L_12 , V_35 , F_101 ( V_1 -> V_278 ) ) ;
V_1 -> V_278 = NULL ;
} else
F_102 ( V_1 ) ;
if ( V_1 -> V_282 . V_42 == NULL ) {
V_1 -> V_282 . V_42 = F_26 ( V_283 , V_102 ) ;
if ( V_1 -> V_282 . V_42 ) {
V_1 -> V_282 . V_39 = V_283 ;
V_1 -> V_282 . V_41 = 1 ;
V_1 -> V_282 . V_284 = 1 ;
V_1 -> V_282 . V_285 = 32 ;
V_1 -> V_282 . V_43 = V_286 ;
}
}
V_1 -> V_282 . V_24 = 0 ;
if ( ! V_1 -> V_282 . V_287 )
V_1 -> V_282 . V_287 = ~ ( T_2 ) 0 ;
if ( ! V_1 -> V_282 . V_288 )
V_1 -> V_282 . V_288 = ~ ( T_2 ) 0 ;
...
return - V_150 ;
if ( V_1 -> V_278 ) {
F_107 ( V_279 , F_99 ( V_281 , V_35 ) ) ;
V_1 -> V_278 = NULL ;
}
return 0 ;
}
void F_108 ( struct V_262 * V_268 ,
const char * V_269 , bool V_270 )
{
F_3 ( & V_5 ) ;
F_92 ( V_268 , V_269 , V_270 ) ;
F_5 ( & V_5 ) ;
}
int
...
F_112 ( void )
{
F_113 ( L_13 , 0 , NULL , & V_295 ) ;
if ( F_114 ( V_281 , L_13 , & V_296 ) )
F_57 ( L_14 , V_281 ) ;
V_279 = F_115 ( V_297 , L_15 ) ;
if ( F_100 ( V_279 ) ) {
F_57 ( V_184 L_16 , F_101 ( V_279 ) ) ;
V_279 = NULL ;
}
return 0 ;
}
...
struct V_298 * V_117 , * V_48 ;
struct V_299 * V_171 ;
struct V_167 * V_116 , V_182 ;
int V_135 = 1 ;
F_121 (pos, n, &info->modelist) {
V_171 = F_122 ( V_117 , struct V_299 , V_300 ) ;
V_116 = & V_171 -> V_182 ;
F_123 ( & V_13 , V_116 ) ;
V_13 . V_156 = V_301 ;
...
return - V_4 ;
V_158 . V_10 = V_10 ;
V_135 = F_52 ( V_302 , & V_158 ) ;
F_62 ( V_10 ) ;
}
return V_135 ;
}
int F_125 ( char * V_269 , char * * V_303 )
{
char * V_304 , * V_305 = NULL ;
int V_306 = 0 ;
int V_307 = strlen ( V_269 ) , V_35 ;
if ( V_307 && V_308 && strncmp ( V_269 , L_17 , 4 ) )
V_306 = 1 ;
if ( V_307 && ! V_306 ) {
for ( V_35 = 0 ; V_35 < V_3 ; V_35 ++ ) {
if ( V_309 [ V_35 ] == NULL )
...
continue;
V_304 = V_309 [ V_35 ] ;
if ( ! strncmp ( V_269 , V_304 , V_307 ) &&
V_304 [ V_307 ] == ':' )
V_305 = V_304 + V_307 + 1 ;
}
}
if ( V_305 && ! strncmp ( V_305 , L_18 , 3 ) )
V_306 = 1 ;
if ( V_303 )
* V_303 = V_305 ;
return V_306 ;
}
static int T_11 F_126 ( char * V_305 )
{
int V_35 , V_310 = 0 ;
if ( ! V_305 || ! * V_305 )
V_310 = 1 ;
if ( ! V_310 && ! strncmp ( V_305 , L_19 , 6 ) ) {
V_308 = 1 ;
V_310 = 1 ;
}
if ( ! V_310 && ! strchr ( V_305 , ':' ) ) {
V_311 = V_305 ;
V_310 = 1 ;
}
if ( ! V_310 ) {
