...
static void F_26 ( struct V_109 * V_109 )
{
struct V_50 * V_51 = V_109 -> V_110 ;
struct V_111 * V_96 = V_51 -> V_96 ;
int error ;
switch ( V_109 -> V_112 ) {
case 0 :
break;
...
return;
default:
F_27 ( & V_96 -> V_51 , L_13 , V_109 -> V_112 ) ;
goto exit;
}
if ( F_11 ( V_51 , V_51 -> V_117 -> V_118 ) )
F_12 ( 1 , L_14 ,
V_51 -> V_117 -> V_118 ) ;
exit:
error = F_28 ( V_51 -> V_117 , V_119 ) ;
if ( error )
F_21 ( & V_96 -> V_51 , L_15 , error ) ;
}
static void F_29 ( struct V_109 * V_109 )
{
struct V_50 * V_51 = V_109 -> V_110 ;
struct V_111 * V_96 = V_51 -> V_96 ;
int error ;
...
return;
default:
F_27 ( & V_96 -> V_51 , L_17 , V_109 -> V_112 ) ;
goto exit;
}
if ( V_51 -> V_120 -> V_118 == 2 )
goto exit;
if ( F_18 ( V_51 , V_51 -> V_120 -> V_118 ) )
F_12 ( 1 , L_18 ,
V_51 -> V_120 -> V_118 ) ;
exit:
error = F_28 ( V_51 -> V_120 , V_119 ) ;
if ( error )
F_21 ( & V_96 -> V_51 , L_19 , error ) ;
}
...
error = F_28 ( V_51 -> V_117 , V_94 ) ;
if ( error )
goto V_122;
error = F_28 ( V_51 -> V_120 , V_94 ) ;
if ( error )
goto V_123;
return 0 ;
V_123:
...
static int F_40 ( struct V_111 * V_126 , T_3 V_127 )
{
...
static int F_42 ( struct V_111 * V_126 )
{
struct V_50 * V_51 = F_41 ( V_126 ) ;
int error = 0 ;
F_36 ( & V_51 -> V_124 ) ;
...
static int F_43 ( struct V_111 * V_126 ,
...
V_51 -> V_7 = * V_7 ;
F_47 ( & V_51 -> V_124 ) ;
V_51 -> V_117 = F_48 ( 0 , V_94 ) ;
if ( ! V_51 -> V_117 )
goto V_129;
V_51 -> V_120 = F_48 ( 0 , V_94 ) ;
if ( ! V_51 -> V_120 )
goto V_130;
...
V_51 -> V_85 , V_51 -> V_120 -> V_132 ) ;
V_135:
F_58 ( V_51 -> V_3 , V_51 -> V_7 . V_131 ,
V_51 -> V_53 , V_51 -> V_117 -> V_132 ) ;
V_133:
F_59 ( V_51 -> V_120 ) ;
V_130:
F_59 ( V_51 -> V_117 ) ;
...
static void F_61 ( struct V_111 * V_126 )
{
struct V_50 * V_51 = F_41 ( V_126 ) ;
F_57 ( V_126 , NULL ) ;
F_62 ( V_51 -> V_59 ) ;
