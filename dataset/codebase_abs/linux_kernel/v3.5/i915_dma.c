...
F_15 ( L_27 , ( T_1 ) V_167 -> V_16 ) ;
V_27 -> V_28 . V_29 = V_167 -> V_16 & ( 0x1ffff << 12 ) ;
V_2 -> V_5 . V_6 = F_74 ( V_4 -> V_168 -> V_169 + V_167 -> V_16 ,
4096 ) ;
if ( V_2 -> V_5 . V_6 == NULL ) {
F_23 ( V_4 ) ;
V_27 -> V_28 . V_29 = 0 ;
...
static void
F_123 ( struct V_1 * V_2 , unsigned long V_169 ,
unsigned long V_36 )
{
V_2 -> V_161 . V_220 = - 1 ;
#if F_124 ( V_221 )
...
return;
#endif
V_2 -> V_161 . V_220 = F_125 ( V_169 , V_36 , V_223 , 1 ) ;
if ( V_2 -> V_161 . V_220 < 0 ) {
F_105 ( L_37
L_38 ) ;
}
}
...
if ( ! V_225 )
return;
V_225 -> V_226 [ 0 ] . V_169 = V_2 -> V_4 -> V_168 -> V_169 ;
V_225 -> V_226 [ 0 ] . V_36 =
V_2 -> V_161 . V_227 -> V_228 << V_229 ;
V_11 =
V_136 -> V_230 [ V_231 ] . V_179 & V_232 ;
F_128 ( V_225 , L_39 , V_11 ) ;
F_55 ( V_225 ) ;
}
...
int V_44 = 0 , V_235 ;
T_14 V_236 ;
V_234 = (struct V_233 * ) V_179 ;
if ( V_234 -> V_19 >= 6 && ! F_20 ( V_4 , V_30 ) )
return - V_67 ;
V_4 -> V_237 += 4 ;
V_4 -> V_238 [ 6 ] = V_239 ;
V_4 -> V_238 [ 7 ] = V_240 ;
...
F_131 ( V_4 -> V_136 ) ;
if ( F_132 ( V_4 ) )
F_133 ( & V_4 -> V_136 -> V_4 , F_134 ( 30 ) ) ;
if ( F_135 ( V_4 ) || F_136 ( V_4 ) )
F_133 ( & V_4 -> V_136 -> V_4 , F_134 ( 32 ) ) ;
V_235 = F_132 ( V_4 ) ? 1 : 0 ;
V_2 -> V_246 = F_137 ( V_4 -> V_136 , V_235 , 0 ) ;
if ( ! V_2 -> V_246 ) {
F_13 ( L_41 ) ;
V_44 = - V_243 ;
goto V_245;
}
V_236 = V_2 -> V_161 . V_227 -> V_228 << V_229 ;
V_2 -> V_161 . V_247 =
F_138 ( V_4 -> V_168 -> V_169 , V_236 ) ;
if ( V_2 -> V_161 . V_247 == NULL ) {
V_44 = - V_243 ;
goto V_248;
}
F_123 ( V_2 , V_4 -> V_168 -> V_169 , V_236 ) ;
V_2 -> V_249 = F_139 ( L_42 ,
V_250 | V_251 ,
1 ) ;
if ( V_2 -> V_249 == NULL ) {
F_13 ( L_43 ) ;
...
if ( ! F_145 ( V_4 ) && ! F_146 ( V_4 ) )
F_147 ( V_4 -> V_136 ) ;
F_148 ( & V_2 -> V_254 ) ;
F_148 ( & V_2 -> V_255 ) ;
F_148 ( & V_2 -> V_256 ) ;
F_148 ( & V_2 -> V_257 ) ;
if ( F_149 ( V_4 ) || F_150 ( V_4 ) )
V_2 -> V_258 = 3 ;
else if ( F_151 ( V_4 ) || ! F_132 ( V_4 ) )
V_2 -> V_258 = 2 ;
else
V_2 -> V_258 = 1 ;
V_44 = F_152 ( V_4 , V_2 -> V_258 ) ;
if ( V_44 )
goto V_253;
V_2 -> V_161 . V_218 = 1 ;
F_153 ( V_4 ) ;
...
F_155 ( V_4 ) ;
F_156 () ;
F_157 ( & V_2 -> V_259 , V_260 ,
( unsigned long ) V_4 ) ;
if ( F_46 ( V_4 ) )
F_158 ( V_2 ) ;
return 0 ;
V_253:
if ( V_2 -> V_161 . V_261 . V_262 )
F_159 ( & V_2 -> V_161 . V_261 ) ;
if ( V_4 -> V_136 -> V_263 )
F_160 ( V_4 -> V_136 ) ;
F_161 ( V_4 ) ;
F_89 ( V_4 ) ;
...
V_252:
if ( V_2 -> V_161 . V_220 >= 0 ) {
F_163 ( V_2 -> V_161 . V_220 , V_4 -> V_168 -> V_169 ,
V_4 -> V_168 -> V_264 . V_265 * 1024 * 1024 ) ;
V_2 -> V_161 . V_220 = - 1 ;
}
F_164 ( V_2 -> V_161 . V_247 ) ;
V_248:
F_165 ( V_4 -> V_136 , V_2 -> V_246 ) ;
V_245:
F_166 ( V_2 -> V_170 ) ;
V_244:
F_55 ( V_2 ) ;
...
int F_184 ( struct V_7 * V_4 , struct V_64 * V_271 )
{
struct V_272 * V_65 ;
F_15 ( L_18 ) ;
...
return - V_22 ;
V_271 -> V_13 = V_65 ;
F_148 ( & V_65 -> V_161 . V_273 ) ;
F_185 ( & V_65 -> V_161 . V_274 ) ;
return 0 ;
}
void F_186 ( struct V_7 * V_4 )
{
T_2 * V_2 = V_4 -> V_8 ;
if ( ! V_2 || F_20 ( V_4 , V_30 ) ) {
F_187 ( V_4 ) ;
F_188 () ;
return;
}
...
void F_190 ( struct V_7 * V_4 , struct V_64 * V_65 )
{
F_191 ( V_4 , V_65 ) ;
}
void F_192 ( struct V_7 * V_4 , struct V_64 * V_271 )
{
struct V_272 * V_65 = V_271 -> V_13 ;
F_55 ( V_65 ) ;
}
int F_193 ( struct V_7 * V_4 )
{
return 1 ;
}
