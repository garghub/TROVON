...
int V_102 )
{
V_10 -> V_76 ( V_8 , V_103 , 0 , V_102 ) ;
V_10 -> V_104 ( V_8 , V_10 -> V_105 , V_8 -> V_106 ) ;
return 0 ;
}
void F_42 ( struct V_1 * V_2 )
{
if ( F_6 ( V_2 , V_107 ) & V_108 ) {
F_3 ( V_2 , V_68 , V_109 | V_61 ) ;
F_9 ( V_2 , V_107 , V_110 ) ;
} else {
F_9 ( V_2 , V_107 , V_110 ) ;
F_3 ( V_2 , V_68 , V_109 | V_61 ) ;
...
T_4 F_47 ( struct V_118 * V_119 ,
struct V_120 * V_121 , char * V_43 )
{
struct V_7 * V_8 = F_48 ( V_119 , struct V_7 , V_2 ) ;
struct V_1 * V_2 = F_12 ( V_8 ) ;
char * V_122 = V_2 -> V_123 ? L_11 : L_12 ;
strcpy ( V_43 , V_122 ) ;
return strlen ( V_122 ) ;
}
...
V_124 = F_1 ( V_2 , V_80 ) & V_125 ;
V_4 = F_1 ( V_2 , V_13 ) ;
V_2 -> V_123 = ( V_4 & ( V_14 | V_15 ) ) && ( V_4 & V_126 ) ;
F_14 ( L_14 ,
V_2 -> V_123 ? L_15 : L_16 ,
V_124 ? L_17 : L_18 ) ;
V_2 -> V_124 = V_124 ;
...
{
V_2 -> V_8 = F_51 ( sizeof( struct V_7 ) , V_127 ) ;
if ( ! V_2 -> V_8 )
goto V_128;
F_17 ( V_2 -> V_129 ) ;
V_2 -> V_8 -> V_130 = V_131 ;
V_2 -> V_8 -> V_11 = V_2 -> V_10 ;
V_2 -> V_8 -> V_2 . V_132 = & V_2 -> V_36 -> V_2 ;
if ( V_2 -> V_124 )
V_2 -> V_10 -> V_133 |= V_134 ;
F_42 ( V_2 ) ;
if ( F_52 ( V_2 -> V_8 , V_2 -> V_123 ) )
goto V_135;
if ( F_53 ( & V_2 -> V_8 -> V_2 , & V_136 ) )
F_14 ( L_19 ) ;
V_2 -> V_129 = 1 ;
return 0 ;
V_135:
...
void F_58 ( struct V_137 * V_138 )
{
struct V_1 * V_2 =
F_48 ( V_138 , struct V_1 , V_139 . V_138 ) ;
F_45 ( V_2 ) ;
F_46 ( V_2 ) ;
V_2 -> V_51 = 0 ;
if ( V_2 -> V_111 == V_2 -> V_129 )
goto exit;
F_49 ( V_2 ) ;
if ( V_2 -> V_111 )
F_50 ( V_2 ) ;
...
static T_5 F_60 ( int V_143 , void * V_122 )
{
...
V_144 = F_1 ( V_2 , V_142 ) ;
F_3 ( V_2 , V_142 , V_144 ) ;
if ( V_144 & ( V_116 | V_115 ) ) {
V_146 = V_148 ;
V_2 -> V_111 = ! ! ( V_144 & V_116 ) ;
F_17 ( V_2 -> V_51 ) ;
F_59 ( V_2 ) ;
if ( V_2 -> V_51 )
goto V_149;
...
int F_64 ( struct V_36 * V_36 , const struct V_153 * V_154 )
{
int error ;
struct V_9 * V_10 ;
struct V_1 * V_2 ;
...
if ( error )
goto V_135;
error = F_69 ( V_36 , V_155 ) ;
if ( error )
goto V_156;
error = - V_157 ;
V_10 = F_51 ( sizeof( struct V_9 ) , V_127 ) ;
if ( ! V_10 )
goto V_158;
V_10 -> V_159 = F_34 ;
V_10 -> V_160 = F_35 ;
...
V_10 -> V_161 = F_30 ;
V_10 -> V_162 = F_33 ;
V_10 -> V_163 . V_82 = V_164 ;
V_10 -> V_163 . V_165 = V_37 ;
V_10 -> V_163 . V_166 = V_167 ;
V_10 -> V_163 . V_168 = 2 ;
V_10 -> V_163 . V_169 = F_38 ;
V_10 -> V_163 . V_170 = F_39 ;
V_10 -> V_163 . V_171 = F_40 ;
V_10 -> V_163 . V_172 = F_41 ;
V_2 = F_51 ( sizeof( struct V_1 ) , V_127 ) ;
if ( ! V_2 )
goto V_173;
V_10 -> V_11 = V_2 ;
V_2 -> V_10 = V_10 ;
...
goto V_176;
error = - V_157 ;
V_2 -> V_54 = F_51 ( V_53 , V_127 ) ;
if ( ! V_2 -> V_54 )
goto V_177;
F_73 ( & V_2 -> V_41 ) ;
V_2 -> V_150 = F_74 ( V_155 ) ;
if ( ! V_2 -> V_150 )
goto V_178;
F_75 ( & V_2 -> V_139 , F_58 ) ;
F_44 ( V_2 ) ;
F_59 ( V_2 ) ;
F_13 ( V_2 ) ;
V_2 -> V_143 = V_36 -> V_143 ;
F_76 ( & V_2 -> V_49 ) ;
V_2 -> V_111 = 0 ;
F_45 ( V_2 ) ;
error = - V_175 ;
if ( F_77 ( V_36 -> V_143 , & F_60 , V_179 ,
V_155 , V_2 ) )
goto V_180;
F_61 ( V_2 -> V_150 ,
& V_2 -> V_139 , 0 ) ;
...
static int F_90 ( struct V_118 * V_118 )
{
struct V_1 * V_2 = F_85 ( F_91 ( V_118 ) ) ;
if ( V_2 -> V_58 & V_62 )
return - V_181 ;
F_86 ( & V_2 -> V_139 ) ;
F_59 ( V_2 ) ;
...
static int F_92 ( struct V_118 * V_118 )
{
struct V_1 * V_2 = F_85 ( F_91 ( V_118 ) ) ;
F_59 ( V_2 ) ;
F_45 ( V_2 ) ;
