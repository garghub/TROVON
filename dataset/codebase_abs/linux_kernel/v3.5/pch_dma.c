...
static int T_8 F_88 ( struct V_142 * V_143 ,
...
V_46 = V_19 -> V_158 = F_95 ( V_143 , 1 , 0 ) ;
if ( ! V_19 -> V_158 ) {
...
F_96 ( V_143 ) ;
V_145 = F_97 ( V_143 -> V_124 , F_70 , V_159 , V_156 , V_19 ) ;
if ( V_145 ) {
...
( unsigned long ) V_14 ) ;
F_38 ( & V_14 -> V_6 . V_162 , & V_19 -> V_10 . V_132 ) ;
}
F_101 ( V_19 -> V_10 . V_163 ) ;
F_102 ( V_164 , V_19 -> V_10 . V_163 ) ;
F_102 ( V_165 , V_19 -> V_10 . V_163 ) ;
V_19 -> V_10 . V_166 = F_48 ;
V_19 -> V_10 . V_167 = F_54 ;
V_19 -> V_10 . V_168 = F_56 ;
V_19 -> V_10 . V_169 = F_58 ;
V_19 -> V_10 . V_170 = F_59 ;
V_19 -> V_10 . V_171 = F_65 ;
...
static void T_9 F_108 ( struct V_142 * V_143 )
{
struct V_7 * V_19 = F_80 ( V_143 ) ;
struct V_4 * V_14 ;
struct V_5 * V_6 , * V_135 ;
