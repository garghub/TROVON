...
struct V_91 * V_91 = V_52 -> V_53 ;
int error ;
if ( ( ! F_91 ( F_92 () , V_91 -> V_143 ) ) && ! F_93 ( V_144 ) )
return - V_145 ;
if ( ! F_94 ( V_91 -> V_146 ) )
return - V_33 ;
error = F_95 ( V_35 , V_116 ) ;
if ( error )
return error ;
F_79 ( V_91 ) ;
...
int
F_124 ( struct V_34 * V_35 , struct V_1 * V_71 )
{
int V_171 = 0 ;
F_3 () ;
if ( V_71 -> V_72 )
...
int F_125 ( struct V_34 * V_35 , struct V_1 * V_2 )
{
if ( V_35 -> V_147 && V_35 -> V_147 -> V_36 )
return V_35 -> V_147 -> V_36 ( V_35 , V_172 , V_2 ) ;
return 0 ;
}
static void F_126 ( struct V_173 * V_160 , struct V_1 * V_2 ,
...
if ( V_91 ) {
#ifdef F_128
F_127 ( V_160 , L_22 , V_22 ,
V_91 -> V_133 -> V_178 , V_91 -> V_179 ) ;
#else
F_127 ( V_160 , L_23 , V_22 ,
F_129 ( V_91 -> V_133 -> V_180 ) ,
F_130 ( V_91 -> V_133 -> V_180 ) , V_91 -> V_179 ) ;
#endif
} else {
F_127 ( V_160 , L_24 , V_22 ) ;
}
if ( F_42 ( V_2 ) ) {
if ( V_2 -> V_25 == V_41 )
F_127 ( V_160 , L_25 , V_2 -> V_24 ) ;
else
F_127 ( V_160 , L_26 , V_2 -> V_24 , V_2 -> V_25 ) ;
} else {
F_127 ( V_160 , L_27 ) ;
}
}
static int F_131 ( struct V_173 * V_160 , void * V_181 )
{
struct V_1 * V_2 , * V_182 ;
V_2 = F_132 ( V_181 , struct V_1 , V_10 ) ;
F_126 ( V_160 , V_2 , * ( ( T_2 * ) V_160 -> V_183 ) , L_28 ) ;
F_61 (bfl, &fl->fl_block, fl_block)
F_126 ( V_160 , V_182 , * ( ( T_2 * ) V_160 -> V_183 ) , L_29 ) ;
return 0 ;
}
static void * F_133 ( struct V_173 * V_160 , T_2 * V_76 )
{
T_2 * V_184 = V_160 -> V_183 ;
F_3 () ;
* V_184 = ( * V_76 + 1 ) ;
return F_134 ( & V_77 , * V_76 ) ;
}
static void * F_135 ( struct V_173 * V_160 , void * V_181 , T_2 * V_76 )
{
T_2 * V_184 = V_160 -> V_183 ;
++ * V_184 ;
return F_136 ( V_181 , & V_77 , V_76 ) ;
}
static void F_137 ( struct V_173 * V_160 , void * V_181 )
{
F_5 () ;
}
static int F_138 ( struct V_91 * V_91 , struct V_34 * V_35 )
{
return F_139 ( V_35 , & V_185 , sizeof( T_2 ) ) ;
}
static int T_6 F_140 ( void )
{
F_141 ( L_30 , 0 , NULL , & V_186 ) ;
return 0 ;
}
...
int F_143 ( struct V_91 * V_91 , T_2 V_44 , unsigned long V_187 )
{
struct V_1 * V_2 ;
int V_188 = 1 ;
F_3 () ;
