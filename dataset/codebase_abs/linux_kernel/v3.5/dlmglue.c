...
V_6 -> V_13 = F_139 ( V_27 -> V_231 ) ;
V_6 -> V_14 = F_139 ( V_27 -> V_232 ) ;
V_6 -> V_15 = F_140 ( V_27 -> V_233 ) ;
V_6 -> V_16 = F_140 ( V_27 -> V_234 ) ;
V_6 -> V_17 =
F_53 ( F_136 ( & V_27 -> V_235 ) ) ;
V_6 -> V_18 =
F_53 ( F_136 ( & V_27 -> V_236 ) ) ;
V_6 -> V_19 =
F_53 ( F_136 ( & V_27 -> V_237 ) ) ;
V_6 -> V_20 = F_139 ( V_124 -> V_238 ) ;
V_6 -> V_239 = F_140 ( V_124 -> V_240 ) ;
...
T_1 V_241 )
{
V_220 -> V_222 = V_241 >> V_225 ;
V_220 -> V_224 = V_241 & V_226 ;
}
static void F_143 ( struct V_27 * V_27 )
{
struct V_123 * V_124 = F_45 ( V_27 ) ;
struct V_3 * V_4 = & V_124 -> V_208 ;
struct V_5 * V_6 ;
...
F_144 ( V_27 , F_5 ( V_6 -> V_12 ) ) ;
V_124 -> V_238 = F_4 ( V_6 -> V_20 ) ;
V_124 -> V_240 = F_6 ( V_6 -> V_239 ) ;
F_145 ( V_27 ) ;
if ( F_146 ( V_27 -> V_233 ) && ! V_124 -> V_230 )
V_27 -> V_243 = 0 ;
else
V_27 -> V_243 = F_147 ( V_27 ) ;
V_27 -> V_231 = F_4 ( V_6 -> V_13 ) ;
V_27 -> V_232 = F_4 ( V_6 -> V_14 ) ;
V_27 -> V_233 = F_6 ( V_6 -> V_15 ) ;
F_148 ( V_27 , F_6 ( V_6 -> V_16 ) ) ;
F_142 ( & V_27 -> V_235 ,
F_5 ( V_6 -> V_17 ) ) ;
F_142 ( & V_27 -> V_237 ,
F_5 ( V_6 -> V_19 ) ) ;
...
static inline int F_149 ( struct V_27 * V_27 ,
struct V_3 * V_4 )
{
struct V_5 * V_6 = F_2 ( & V_4 -> V_7 ) ;
if ( F_150 ( & V_4 -> V_7 )
...
static inline void F_152 ( struct V_3 * V_4 ,
int V_161 )
{
unsigned long V_152 ;
F_80 ( & V_4 -> V_89 , V_152 ) ;
...
static int F_153 ( struct V_27 * V_27 ,
struct V_245 * * V_246 )
{
int V_161 = 0 ;
struct V_123 * V_124 = F_45 ( V_27 ) ;
...
F_158 ( V_248 -> V_126 ) ,
V_27 -> V_126 ) ;
F_44 ( F_159 ( V_248 -> V_252 ) ||
! ( V_248 -> V_253 & F_160 ( V_254 ) ) ,
L_56 ,
( unsigned long long ) V_124 -> V_96 ,
( unsigned long long ) F_159 ( V_248 -> V_252 ) ,
F_158 ( V_248 -> V_253 ) ) ;
F_161 ( V_27 , V_248 ) ;
F_34 ( V_4 ) ;
}
...
static int F_162 ( struct V_27 * V_27 ,
struct V_245 * * V_255 ,
struct V_245 * V_256 )
{
int V_161 ;
...
V_161 = F_157 ( V_27 , V_255 ) ;
if ( V_161 < 0 )
F_113 ( V_161 ) ;
return V_161 ;
}
int F_164 ( struct V_27 * V_27 ,
struct V_245 * * V_255 ,
int V_204 ,
int V_184 ,
int V_257 )
...
{
int V_60 ;
V_60 = F_169 ( V_27 , V_255 , V_204 , V_202 ) ;
if ( V_60 == - V_162 ) {
F_170 ( V_265 ) ;
if ( F_171 ( V_27 , V_255 , V_204 ) == 0 )
F_167 ( V_27 , V_204 ) ;
V_60 = V_266 ;
}
return V_60 ;
...
int F_175 ( struct V_36 * V_39 , T_2 * V_269 )
{
struct V_3 * V_4 ;
struct V_270 * V_6 ;
int V_161 = 0 ;
...
void F_176 ( struct V_36 * V_39 , T_2 V_269 )
{
struct V_3 * V_4 ;
struct V_270 * V_6 ;
if ( ! F_126 ( V_39 ) && ! F_123 ( V_39 ) ) {
...
V_6 = F_2 ( & V_4 -> V_7 ) ;
V_6 -> V_9 = V_273 ;
V_6 -> V_274 = F_139 ( V_269 ) ;
F_16 ( V_39 , V_4 , V_136 ) ;
}
}
int F_177 ( struct V_36 * V_39 ,
int V_204 )
{
int V_161 = 0 ;
int V_1 = V_204 ? V_136 : V_137 ;
...
void F_181 ( struct V_36 * V_39 )
{
struct V_3 * V_4 = & V_39 -> V_277 ;
if ( ! F_123 ( V_39 ) )
F_16 ( V_39 , V_4 , V_136 ) ;
}
int F_182 ( struct V_36 * V_39 , int V_204 )
{
int V_161 ;
...
void F_183 ( struct V_36 * V_39 , int V_204 )
{
struct V_3 * V_4 = & V_39 -> V_278 ;
if ( ! F_123 ( V_39 ) )
F_16 ( V_39 , V_4 ,
...
int V_29 ( struct V_279 * V_279 , int V_204 )
{
int V_60 ;
int V_1 = V_204 ? V_136 : V_137 ;
...
void F_184 ( struct V_279 * V_279 , int V_204 )
{
int V_1 = V_204 ? V_136 : V_137 ;
struct V_29 * V_108 = V_279 -> V_280 ;
struct V_36 * V_39 = F_46 ( V_279 -> V_281 ) ;
...
static void F_185 ( struct V_282 * V_282 )
{
struct V_49 * V_50 ;
V_50 = F_9 ( V_282 , struct V_49 , V_283 ) ;
F_186 ( V_50 ) ;
}
void F_187 ( struct V_49 * V_50 )
{
if ( V_50 )
F_188 ( & V_50 -> V_283 , F_185 ) ;
}
static void F_189 ( struct V_49 * V_284 )
{
F_190 ( & V_284 -> V_283 ) ;
}
struct V_49 * F_191 ( void )
{
struct V_49 * V_50 ;
V_50 = F_192 ( sizeof( struct V_49 ) , V_285 ) ;
if ( ! V_50 ) {
F_113 ( - V_286 ) ;
goto V_163;
}
...
static struct V_3 * F_194 ( struct V_3 * V_288 ,
struct V_289 * V_73 )
{
struct V_3 * V_290 , * V_60 = NULL ;
struct V_49 * V_50 = V_73 -> V_291 ;
F_68 ( & V_51 ) ;
F_195 (iter, &start->l_debug_list, l_debug_list) {
...
static void * F_196 ( struct V_292 * V_293 , T_6 * V_294 )
{
struct V_289 * V_73 = V_293 -> V_295 ;
struct V_3 * V_290 ;
F_21 ( & V_51 ) ;
V_290 = F_194 ( & V_73 -> V_296 , V_73 ) ;
if ( V_290 ) {
V_73 -> V_297 = * V_290 ;
V_290 = & V_73 -> V_297 ;
}
...
static void F_197 ( struct V_292 * V_293 , void * V_298 )
{
}
static void * F_198 ( struct V_292 * V_293 , void * V_298 , T_6 * V_294 )
{
struct V_289 * V_73 = V_293 -> V_295 ;
struct V_3 * V_290 = V_298 ;
struct V_3 * V_299 = & V_73 -> V_296 ;
F_21 ( & V_51 ) ;
V_290 = F_194 ( V_290 , V_73 ) ;
F_26 ( & V_299 -> V_52 ) ;
if ( V_290 ) {
...
static int F_199 ( struct V_292 * V_293 , void * V_298 )
{
int V_300 ;
char * V_6 ;
...
if ( ! V_4 )
return - V_217 ;
F_200 ( V_293 , L_61 , V_301 ) ;
if ( V_4 -> V_21 == V_30 )
F_200 ( V_293 , L_62 , V_107 - 1 ,
V_4 -> V_8 ,
( unsigned int ) F_50 ( V_4 ) ) ;
else
F_200 ( V_293 , L_63 , V_47 , V_4 -> V_8 ) ;
F_200 ( V_293 , L_64
L_65
L_61
L_61
...
F_200 ( V_293 , L_61 , V_6 [ V_300 ] ) ;
#ifdef F_201
# define F_202 ( T_7 ) ((_l)->l_lock_prmode.ls_gets)
# define F_203 ( T_7 ) ((_l)->l_lock_exmode.ls_gets)
# define F_204 ( T_7 ) ((_l)->l_lock_prmode.ls_fail)
# define F_205 ( T_7 ) ((_l)->l_lock_exmode.ls_fail)
# define F_206 ( T_7 ) ((_l)->l_lock_prmode.ls_total)
# define F_207 ( T_7 ) ((_l)->l_lock_exmode.ls_total)
# define F_208 ( T_7 ) ((_l)->l_lock_prmode.ls_max)
# define F_209 ( T_7 ) ((_l)->l_lock_exmode.ls_max)
# define F_210 ( T_7 ) ((_l)->l_lock_refresh)
#else
# define F_202 ( T_7 ) (0)
# define F_203 ( T_7 ) (0)
# define F_204 ( T_7 ) (0)
...
static int F_211 ( struct V_27 * V_27 , struct V_213 * V_213 )
{
struct V_292 * V_303 = V_213 -> V_215 ;
struct V_289 * V_73 = V_303 -> V_295 ;
struct V_3 * V_34 = & V_73 -> V_296 ;
F_24 ( V_34 ) ;
F_187 ( V_73 -> V_291 ) ;
return F_212 ( V_27 , V_213 ) ;
}
static int F_213 ( struct V_27 * V_27 , struct V_213 * V_213 )
{
int V_60 ;
struct V_289 * V_73 ;
struct V_292 * V_303 ;
struct V_36 * V_39 ;
V_73 = F_214 ( sizeof( struct V_289 ) , V_285 ) ;
if ( ! V_73 ) {
V_60 = - V_286 ;
F_113 ( V_60 ) ;
goto V_163;
...
static int F_216 ( struct V_36 * V_39 )
{
int V_60 = 0 ;
struct V_49 * V_50 = V_39 -> V_84 ;
V_50 -> V_287 = F_217 ( L_69 ,
V_306 | V_307 ,
V_39 -> V_308 ,
V_39 ,
& V_309 ) ;
...
static void F_218 ( struct V_36 * V_39 )
{
struct V_49 * V_50 = V_39 -> V_84 ;
if ( V_50 ) {
F_219 ( V_50 -> V_287 ) ;
...
V_39 -> V_313 = F_221 ( V_314 , V_39 , L_71 ) ;
if ( F_222 ( V_39 -> V_313 ) ) {
V_161 = F_223 ( V_39 -> V_313 ) ;
V_39 -> V_313 = NULL ;
F_113 ( V_161 ) ;
goto V_175;
}
V_161 = F_224 ( V_39 -> V_315 ,
V_39 -> V_316 ,
strlen ( V_39 -> V_316 ) ,
& V_170 , V_317 , V_39 ,
& V_311 ) ;
...
F_81 ( & V_4 -> V_89 , V_152 ) ;
F_3 ( 0 , L_78 , V_4 -> V_8 ) ;
V_60 = F_231 ( V_39 -> V_176 , & V_4 -> V_7 , V_183 ) ;
if ( V_60 ) {
F_95 ( L_79 , V_60 , V_4 ) ;
...
F_80 ( & V_4 -> V_89 , V_152 ) ;
V_4 -> V_82 |= V_198 ;
while ( V_4 -> V_82 & V_320 ) {
F_106 ( V_4 , & V_59 , V_320 , 0 ) ;
F_81 ( & V_4 -> V_89 , V_152 ) ;
F_3 ( 0 , L_82 , V_4 -> V_8 ) ;
V_161 = F_103 ( & V_59 ) ;
if ( V_161 )
...
static void F_229 ( struct V_36 * V_39 )
{
F_234 ( V_39 , & V_39 -> V_276 ) ;
F_234 ( V_39 , & V_39 -> V_277 ) ;
F_234 ( V_39 , & V_39 -> V_278 ) ;
F_234 ( V_39 , & V_39 -> V_271 . V_272 ) ;
}
int F_235 ( struct V_27 * V_27 )
{
int V_161 , V_321 ;
V_321 = F_230 ( F_46 ( V_27 -> V_97 ) ,
& F_45 ( V_27 ) -> V_209 ) ;
if ( V_321 < 0 )
F_113 ( V_321 ) ;
V_161 = V_321 ;
...
static int F_236 ( struct V_36 * V_39 ,
struct V_3 * V_4 ,
struct V_323 * V_324 )
{
unsigned long V_152 ;
...
V_1 = V_4 -> V_74 ;
F_81 ( & V_4 -> V_89 , V_152 ) ;
V_324 -> V_333 = V_4 -> V_37 -> V_331 ( V_4 , V_325 ) ;
if ( V_324 -> V_333 == V_334 ) {
F_3 ( V_158 , L_97 ,
V_4 -> V_8 ) ;
goto V_327;
}
F_80 ( & V_4 -> V_89 , V_152 ) ;
if ( ( V_325 != V_4 -> V_77 ) || ( V_1 != V_4 -> V_74 ) ) {
F_3 ( V_158 , L_98
L_99 , V_4 -> V_8 , V_325 ,
...
F_81 ( & V_4 -> V_89 , V_152 ) ;
V_60 = F_135 ( V_39 , V_4 , V_138 , V_319 ,
V_174 ) ;
V_327:
if ( V_60 )
F_113 ( V_60 ) ;
...
static int F_245 ( struct V_340 * V_341 ,
struct V_3 * V_4 ,
int V_138 )
{
int V_342 = F_246 ( V_341 ) ;
F_11 ( V_138 != V_139 && V_138 != V_137 ) ;
F_11 ( V_4 -> V_74 != V_136 && ! V_342 ) ;
if ( V_342 )
return 1 ;
F_247 ( F_46 ( F_248 ( V_341 ) ) ) ;
return 0 ;
}
...
{
struct V_27 * V_27 = F_10 ( V_4 ) ;
return F_245 ( F_155 ( V_27 ) , V_4 , V_138 ) ;
}
...
static void F_251 ( struct V_36 * V_39 ,
struct V_3 * V_4 )
{
...
F_21 ( & V_345 ) ;
while ( 1 ) {
V_279 = F_254 ( V_108 -> V_109 ,
V_108 -> V_347 , 1 ) ;
if ( ! V_279 )
break;
F_23 ( & V_345 ) ;
F_3 ( 0 , L_103 , V_279 -> V_348 . V_45 ,
V_279 -> V_348 . V_44 ) ;
F_255 ( V_279 ) ;
F_256 ( V_279 ) ;
F_21 ( & V_345 ) ;
...
struct V_33 * V_350 =
F_14 ( V_4 ) ;
return F_245 ( & V_350 -> V_351 , V_4 , V_138 ) ;
}
...
{
struct V_352 * V_6 ;
struct V_31 * V_353 = F_13 ( V_4 ) ;
struct V_354 * V_98 = F_260 ( V_353 -> V_99 . V_100 ,
V_353 -> V_99 . V_129 ) ;
V_6 = F_2 ( & V_4 -> V_7 ) ;
V_6 -> V_9 = V_355 ;
V_6 -> V_356 = F_139 ( V_98 -> V_357 ) ;
V_6 -> V_358 = F_139 ( V_98 -> V_359 ) ;
V_6 -> V_360 = F_139 ( V_353 -> V_361 ) ;
V_6 -> V_362 = F_139 ( V_353 -> V_99 . V_363 ) ;
V_6 -> V_364 = F_139 ( V_353 -> V_99 . V_365 ) ;
V_6 -> V_366 = F_139 ( V_353 -> V_99 . V_367 ) ;
}
void F_261 ( struct V_31 * V_353 , int V_204 )
{
struct V_3 * V_4 = & V_353 -> V_368 ;
struct V_36 * V_39 = F_46 ( V_353 -> V_99 . V_100 ) ;
int V_1 = V_204 ? V_136 : V_137 ;
if ( ! F_126 ( V_39 ) && ! F_123 ( V_39 ) )
F_16 ( V_39 , V_4 , V_1 ) ;
}
static int F_262 ( struct V_31 * V_353 )
{
struct V_354 * V_98 = F_260 ( V_353 -> V_99 . V_100 ,
V_353 -> V_99 . V_129 ) ;
struct V_3 * V_4 = & V_353 -> V_368 ;
struct V_352 * V_6 = F_2 ( & V_4 -> V_7 ) ;
struct V_245 * V_246 = NULL ;
struct V_369 * V_370 ;
int V_161 = 0 ;
if ( F_150 ( & V_4 -> V_7 ) &&
...
V_353 -> V_361 = F_4 ( V_6 -> V_360 ) ;
V_353 -> V_99 . V_363 = F_4 ( V_6 -> V_362 ) ;
V_353 -> V_99 . V_365 = F_4 ( V_6 -> V_364 ) ;
V_353 -> V_99 . V_367 =
F_4 ( V_6 -> V_366 ) ;
} else {
V_161 = F_263 ( V_353 -> V_371 ,
V_353 -> V_372 , & V_246 ) ;
if ( V_161 ) {
F_113 ( V_161 ) ;
goto V_175;
...
V_370 = (struct V_369 * )
( V_246 -> V_251 + V_373 ) ;
V_98 -> V_357 = F_158 ( V_370 -> V_357 ) ;
V_98 -> V_359 = F_158 ( V_370 -> V_359 ) ;
V_353 -> V_361 = F_158 ( V_370 -> V_361 ) ;
V_353 -> V_99 . V_363 = F_158 ( V_370 -> V_363 ) ;
V_353 -> V_99 . V_365 = F_158 ( V_370 -> V_365 ) ;
V_353 -> V_99 . V_367 =
F_158 ( V_370 -> V_367 ) ;
F_166 ( V_246 ) ;
F_34 ( V_4 ) ;
...
int F_264 ( struct V_31 * V_353 , int V_204 )
{
struct V_3 * V_4 = & V_353 -> V_368 ;
struct V_36 * V_39 = F_46 ( V_353 -> V_99 . V_100 ) ;
int V_1 = V_204 ? V_136 : V_137 ;
...
int F_265 ( struct V_33 * V_374 , int V_204 )
{
int V_161 ;
int V_1 = V_204 ? V_136 : V_137 ;
struct V_3 * V_4 = & V_374 -> V_35 ;
...
void F_266 ( struct V_33 * V_374 , int V_204 )
{
int V_1 = V_204 ? V_136 : V_137 ;
struct V_3 * V_4 = & V_374 -> V_35 ;
struct V_36 * V_39 = V_4 -> V_28 ;
...
goto V_375;
F_81 ( & V_4 -> V_89 , V_152 ) ;
V_161 = F_236 ( V_39 , V_4 , & V_324 ) ;
if ( V_161 < 0 )
F_113 ( V_161 ) ;
F_80 ( & V_4 -> V_89 , V_152 ) ;
V_375:
if ( V_4 -> V_82 & V_198 || ! V_324 . V_329 ) {
F_72 ( V_4 , V_320 ) ;
} else
F_85 ( V_39 , V_4 ) ;
F_3 ( V_158 , L_105 , V_4 -> V_8 ,
V_324 . V_329 ? L_106 : L_107 ) ;
F_81 ( & V_4 -> V_89 , V_152 ) ;
if ( V_324 . V_333 != V_339
&& V_4 -> V_37 -> V_376 )
V_4 -> V_37 -> V_376 ( V_39 , V_4 ) ;
}
...
F_71 ( V_4 , V_320 ) ;
F_80 ( & V_39 -> V_377 , V_152 ) ;
if ( F_25 ( & V_4 -> V_91 ) ) {
F_107 ( & V_4 -> V_91 ,
& V_39 -> V_378 ) ;
V_39 -> V_379 ++ ;
}
F_81 ( & V_39 -> V_377 , V_152 ) ;
}
static void F_268 ( struct V_36 * V_39 )
{
unsigned long V_380 ;
unsigned long V_152 ;
struct V_3 * V_4 ;
...
static int F_271 ( struct V_36 * V_39 )
{
int V_385 = 0 ;
unsigned long V_152 ;
F_80 ( & V_39 -> V_377 , V_152 ) ;
