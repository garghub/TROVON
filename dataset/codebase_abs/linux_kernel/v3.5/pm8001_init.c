...
V_2 -> V_34 . V_35 [ V_71 ] . V_64 = V_72 ;
V_2 -> V_34 . V_35 [ V_71 ] . V_38 = 64 ;
V_2 -> V_34 . V_35 [ V_71 ] . V_66 = V_72 * 64 ;
V_2 -> V_34 . V_35 [ V_71 ] . V_67 = 64 ;
V_2 -> V_34 . V_35 [ V_73 ] . V_64 = V_72 ;
V_2 -> V_34 . V_35 [ V_73 ] . V_38 = 64 ;
V_2 -> V_34 . V_35 [ V_73 ] . V_66 = V_72 * 64 ;
V_2 -> V_34 . V_35 [ V_73 ] . V_67 = 64 ;
V_2 -> V_34 . V_35 [ V_74 ] . V_64 = 1 ;
V_2 -> V_34 . V_35 [ V_74 ] . V_38 = 4096 ;
V_2 -> V_34 . V_35 [ V_74 ] . V_66 = 4096 ;
V_2 -> V_34 . V_35 [ V_75 ] . V_64 = 1 ;
V_2 -> V_34 . V_35 [ V_75 ] . V_38 = V_76 *
sizeof( struct V_77 ) ;
V_2 -> V_34 . V_35 [ V_75 ] . V_66 = V_76 *
sizeof( struct V_77 ) ;
V_2 -> V_34 . V_35 [ V_78 ] . V_64 = 1 ;
V_2 -> V_34 . V_35 [ V_78 ] . V_38 = V_60 *
sizeof( struct V_79 ) ;
V_2 -> V_34 . V_35 [ V_78 ] . V_66 = V_60 *
sizeof( struct V_79 ) ;
for ( V_32 = 0 ; V_32 < V_33 ; V_32 ++ ) {
if ( F_17 ( V_2 -> V_37 ,
& V_2 -> V_34 . V_35 [ V_32 ] . V_36 ,
...
F_27 ( struct V_97 * V_37 , T_3 V_104 , struct V_105 * V_29 )
{
struct V_1 * V_2 ;
...
static int T_1 F_35 ( struct V_105 * V_29 ,
...
V_119 = F_36 ( V_117 , sizeof( void * ) , V_61 ) ;
if ( ! V_119 )
goto exit;
V_121 = F_36 ( V_118 , sizeof( void * ) , V_61 ) ;
if ( ! V_121 )
goto V_122;
V_49 -> V_7 = V_119 ;
V_49 -> V_123 = V_121 ;
...
static void T_1 F_37 ( struct V_105 * V_29 ,
const struct V_115 * V_116 )
{
int V_32 = 0 ;
struct V_1 * V_2 ;
...
V_49 -> V_123 [ V_32 ] = & V_2 -> V_55 [ V_32 ] . V_123 ;
}
V_49 -> V_135 = V_112 ;
V_49 -> V_106 = V_2 -> V_106 ;
V_49 -> V_136 = V_137 ;
V_49 -> V_25 = & V_2 -> V_25 [ 0 ] ;
V_49 -> V_138 = V_116 -> V_11 ;
V_49 -> V_139 = 1 ;
V_49 -> V_140 = V_133 ;
V_49 -> V_141 . V_29 = V_29 ;
}
...
V_144 . V_146 = 0 ;
V_144 . V_147 = 128 ;
V_144 . V_148 = F_16 ( 128 , V_61 ) ;
V_40 -> V_149 ( V_2 , & V_144 ) ;
F_41 ( & V_142 ) ;
for ( V_32 = 0 ; V_32 < V_2 -> V_10 -> V_11 ; V_32 ++ ) {
...
#endif
V_163:
V_113 = F_45 ( V_37 -> V_46 , V_153 , V_164 , V_112 ,
F_28 ( V_2 -> V_29 ) ) ;
return V_113 ;
}
static int T_1 F_51 ( struct V_97 * V_37 ,
...
F_59 ( & V_2 -> V_59 , & V_180 ) ;
V_40 -> V_181 ( V_2 , 0x252acbcd ) ;
V_113 = V_40 -> V_182 ( V_2 ) ;
if ( V_113 )
goto V_183;
...
static void T_6 F_66 ( struct V_97 * V_37 )
{
...
for ( V_32 = 0 ; V_32 < V_2 -> V_155 ; V_32 ++ )
F_46 ( V_2 -> V_158 [ V_32 ] . V_161 , V_49 ) ;
F_47 ( V_37 ) ;
#else
F_46 ( V_2 -> V_46 , V_49 ) ;
#endif
...
static int F_73 ( struct V_97 * V_37 , T_7 V_187 )
{
struct V_28 * V_49 = F_67 ( V_37 ) ;
struct V_1 * V_2 ;
int V_32 , V_188 ;
