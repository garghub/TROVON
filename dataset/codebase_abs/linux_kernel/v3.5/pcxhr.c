...
static int T_4 F_59 ( struct V_6 * V_7 ,
...
static void T_4 F_71 ( struct V_87 * V_88 )
{
struct V_211 * V_212 ;
if ( ! F_72 ( V_88 -> V_191 , L_60 , & V_212 ) )
F_73 ( V_212 , V_88 , F_63 ) ;
if ( ! F_72 ( V_88 -> V_191 , L_61 , & V_212 ) )
F_73 ( V_212 , V_88 , F_65 ) ;
if ( V_88 -> V_7 -> V_58 &&
! F_72 ( V_88 -> V_191 , L_62 , & V_212 ) ) {
F_73 ( V_212 , V_88 , F_66 ) ;
V_212 -> V_243 . V_244 . V_245 = F_68 ;
V_212 -> V_246 |= V_247 ;
}
}
...
static int T_4 F_81 ( struct V_252 * V_195 ,
...
if ( ( V_12 = F_82 ( V_195 ) ) < 0 )
return V_12 ;
F_83 ( V_195 ) ;
if ( F_84 ( V_195 , F_85 ( 32 ) ) < 0 ) {
F_5 ( V_36 L_64
L_65 ) ;
F_80 ( V_195 ) ;
return - V_261 ;
...
if ( F_21 ( V_254 -> V_262 >= V_263 ) ) {
F_57 ( V_7 ) ;
F_80 ( V_195 ) ;
return - V_258 ;
}
V_256 =
V_264 [ V_254 -> V_262 ] . V_265 ;
V_7 -> V_206 =
V_264 [ V_254 -> V_262 ] . V_206 ;
V_7 -> V_208 =
V_264 [ V_254 -> V_262 ] . V_208 ;
V_7 -> V_266 =
V_264 [ V_254 -> V_262 ] . V_266 ;
V_7 -> V_267 =
V_264 [ V_254 -> V_262 ] . V_267 ;
V_7 -> V_173 = V_268 [ V_210 ] ;
...
V_7 -> V_153 = V_272 ;
if ( ( V_12 = F_88 ( V_195 , V_256 ) ) < 0 ) {
F_57 ( V_7 ) ;
F_80 ( V_195 ) ;
return V_12 ;
}
for ( V_138 = 0 ; V_138 < 3 ; V_138 ++ )
V_7 -> V_273 [ V_138 ] = F_89 ( V_195 , V_138 ) ;
V_7 -> V_195 = V_195 ;
V_7 -> V_248 = - 1 ;
if ( F_90 ( V_195 -> V_248 , V_274 , V_275 ,
V_276 , V_7 ) ) {
F_5 ( V_36 L_66 , V_195 -> V_248 ) ;
F_74 ( V_7 ) ;
return - V_177 ;
}
V_7 -> V_248 = V_195 -> V_248 ;
sprintf ( V_7 -> V_277 , L_67 , V_256 ) ;
sprintf ( V_7 -> V_215 , L_68 ,
V_7 -> V_277 ,
V_7 -> V_273 [ 0 ] , V_7 -> V_273 [ 1 ] , V_7 -> V_273 [ 2 ] , V_7 -> V_248 ) ;
F_91 ( & V_7 -> V_151 ) ;
F_91 ( & V_7 -> V_278 ) ;
F_92 ( & V_7 -> V_145 ) ;
F_93 ( & V_7 -> V_279 , V_280 ,
( unsigned long ) V_7 ) ;
F_93 ( & V_7 -> V_158 , F_23 ,
( unsigned long ) V_7 ) ;
V_7 -> V_251 = F_94 ( sizeof( * V_7 -> V_251 ) +
sizeof( V_281 ) * ( V_282 -
V_231 ) ,
V_204 ) ;
if ( ! V_7 -> V_251 ) {
...
for ( V_138 = 0 ; V_138 < V_283 ; V_138 ++ ) {
struct V_199 * V_191 ;
char V_284 [ 16 ] ;
int V_200 ;
if ( V_138 >= F_95 ( V_7 -> V_206 , V_7 -> V_208 ) )
break;
V_7 -> V_146 ++ ;
if ( V_285 [ V_210 ] < 0 )
V_200 = V_285 [ V_210 ] ;
else
V_200 = V_285 [ V_210 ] + V_138 ;
snprintf ( V_284 , sizeof( V_284 ) , L_69 ,
V_286 [ V_210 ] ? V_286 [ V_210 ] : V_256 , V_138 ) ;
V_12 = F_96 ( V_200 , V_284 , V_287 , 0 , & V_191 ) ;
if ( V_12 < 0 ) {
F_5 ( V_36 L_70 , V_138 ) ;
F_74 ( V_7 ) ;
return V_12 ;
}
strcpy ( V_191 -> V_288 , V_289 ) ;
sprintf ( V_191 -> V_277 , L_71 , V_7 -> V_277 , V_138 ) ;
sprintf ( V_191 -> V_215 , L_71 , V_7 -> V_215 , V_138 ) ;
...
if ( V_138 == 0 )
F_71 ( V_7 -> V_88 [ V_138 ] ) ;
if ( ( V_12 = F_97 ( V_191 ) ) < 0 ) {
F_74 ( V_7 ) ;
return V_12 ;
}
}
V_255 = F_98 ( sizeof( struct V_290 ) ) ;
if ( F_99 ( V_194 , F_55 ( V_195 ) ,
V_255 , & V_7 -> V_249 ) < 0 ) {
F_74 ( V_7 ) ;
return - V_205 ;
}
memset ( V_7 -> V_249 . V_250 , 0 , V_255 ) ;
V_12 = F_100 ( V_7 ) ;
if ( V_12 < 0 ) {
F_74 ( V_7 ) ;
return V_12 ;
...
static void T_6 F_102 ( struct V_252 * V_195 )
{
F_74 ( F_103 ( V_195 ) ) ;
F_101 ( V_195 , NULL ) ;
}
