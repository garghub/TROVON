...
struct V_66 * V_67 ;
struct V_1 * V_2 ;
struct V_122 * V_123 , * V_144 ;
V_79 = 0 ;
V_123 = NULL ;
V_2 = F_43 ( V_128 ) ;
V_136 = F_1 ( V_2 , V_3 ) ;
if ( V_141 )
V_124 = V_141 -> V_145 . V_146 . V_124 ;
else
V_124 = V_40 ;
...
V_67 -> V_72 = ( void * ) V_144 ;
}
F_78 ( & V_67 -> V_74 ) ;
V_143 = F_79 ( V_141 , V_129 , V_148 ) ;
if ( F_55 ( V_143 ) ) {
V_79 = F_62 ( V_143 ) ;
goto error;
}
...
static int F_81 ( struct V_63 * V_128 , struct V_129 * V_129 , T_2 V_3 )
{
int V_79 ;
T_1 V_136 ;
struct V_122 * V_123 ;
...
struct V_129 * F_82 ( struct V_63 * V_128 , struct V_129 * V_129 ,
struct V_140 * V_140 )
{
struct V_129 * V_4 ;
struct V_64 * V_65 ;
...
int V_150 = 0 ;
F_10 ( V_109 , L_14 ,
V_128 , V_129 -> V_135 . V_56 , V_129 , V_140 ) ;
if ( V_129 -> V_135 . V_151 > V_152 )
return F_34 ( - V_153 ) ;
V_65 = V_128 -> V_139 ;
V_2 = F_43 ( V_128 ) ;
V_132 = F_61 ( V_129 -> V_134 ) ;
...
if ( V_2 -> V_95 )
V_63 = F_83 ( V_2 , V_123 , V_128 -> V_139 ) ;
else
V_63 = F_72 ( V_2 , V_123 , V_128 -> V_139 ) ;
if ( F_55 ( V_63 ) ) {
V_150 = F_62 ( V_63 ) ;
...
int F_85 ( struct V_63 * V_157 , struct V_129 * V_158 )
{
return F_60 ( V_157 , V_158 , 0 ) ;
}
int F_86 ( struct V_63 * V_157 , struct V_129 * V_158 )
{
return F_60 ( V_157 , V_158 , V_126 ) ;
}
int
F_87 ( struct V_63 * V_159 , struct V_129 * V_160 ,
...
F_88 ( & V_2 -> V_169 ) ;
if ( F_27 ( V_2 ) ) {
V_118 = F_89 ( V_165 , V_160 -> V_135 . V_56 ,
V_166 , V_162 -> V_135 . V_56 ) ;
if ( V_118 == - V_130 )
V_118 = F_90 ( V_164 , V_166 ,
V_162 -> V_135 . V_56 ) ;
if ( V_118 != - V_130 )
goto V_170;
}
...
static int
F_94 ( struct V_173 * V_174 , struct V_129 * V_129 ,
struct V_175 * V_17 )
{
int V_79 ;
struct V_1 * V_2 ;
...
static int F_97 ( struct V_129 * V_129 , struct V_179 * V_179 )
{
int V_118 ;
struct V_1 * V_2 ;
struct V_122 * V_123 ;
...
if ( F_99 ( V_129 -> V_133 -> V_94 ) )
F_100 ( V_129 -> V_133 -> V_86 ) ;
V_118 = F_91 ( V_123 , & V_48 ) ;
if ( V_118 < 0 )
return V_118 ;
if ( ( V_179 -> V_180 & V_188 ) &&
V_179 -> V_189 != F_101 ( V_129 -> V_133 ) )
F_102 ( V_129 -> V_133 , V_179 -> V_189 ) ;
F_68 ( V_129 -> V_133 ) ;
F_103 ( V_129 -> V_133 , V_179 ) ;
F_104 ( V_129 -> V_133 ) ;
return 0 ;
}
void
...
if ( ( F_99 ( V_63 -> V_94 ) ) || ( F_2 ( V_63 -> V_94 ) ) ) {
...
V_3 |= V_63 -> V_94 & ~ V_18 ;
V_63 -> V_94 = V_3 ;
F_106 ( V_63 , V_17 -> V_55 ) ;
V_63 -> V_80 = ( F_101 ( V_63 ) + 512 - 1 ) >> 9 ;
V_67 -> V_73 &= ~ V_200 ;
}
...
static int F_107 ( struct V_129 * V_129 , char * V_201 , int V_202 )
{
int V_118 ;
struct V_1 * V_2 ;
struct V_122 * V_123 ;
...
V_118 = F_108 ( V_201 , V_202 ) ;
V_167:
F_57 ( V_115 ) ;
F_58 ( V_115 ) ;
return V_118 ;
}
static void * F_109 ( struct V_129 * V_129 , struct V_140 * V_141 )
{
int V_151 = 0 ;
char * V_204 = F_110 () ;
...
V_151 = F_107 ( V_129 , V_204 , V_205 ) ;
if ( V_151 < 0 ) {
F_111 ( V_204 ) ;
V_204 = F_34 ( V_151 ) ;
} else
V_204 [ F_112 ( V_151 , V_205 - 1 ) ] = 0 ;
}
F_113 ( V_141 , V_204 ) ;
return NULL ;
}
void
F_114 ( struct V_129 * V_129 , struct V_140 * V_141 , void * V_206 )
{
char * V_207 = F_115 ( V_141 ) ;
F_10 ( V_109 , L_23 ,
V_129 -> V_135 . V_56 , F_55 ( V_207 ) ? L_24 : V_207 ) ;
if ( ! F_55 ( V_207 ) )
F_111 ( V_207 ) ;
}
static int F_116 ( struct V_63 * V_128 , struct V_129 * V_129 ,
...
static int
F_117 ( struct V_63 * V_128 , struct V_129 * V_129 , const char * V_208 )
{
F_10 ( V_109 , L_26 ,
V_128 -> V_119 , V_129 -> V_135 . V_56 , V_208 ) ;
return F_116 ( V_128 , V_129 , V_21 , V_208 ) ;
}
static int
F_118 ( struct V_129 * V_160 , struct V_63 * V_128 ,
struct V_129 * V_129 )
{
int V_118 ;
char * V_56 ;
...
V_118 = F_116 ( V_128 , V_129 , V_138 , V_56 ) ;
F_111 ( V_56 ) ;
if ( ! V_118 ) {
F_120 ( V_164 , V_160 -> V_133 ) ;
F_68 ( V_128 ) ;
}
V_209:
F_41 ( V_164 ) ;
...
static int
F_121 ( struct V_63 * V_128 , struct V_129 * V_129 , T_2 V_3 , T_3 V_19 )
{
...
return - V_112 ;
if ( F_6 ( V_3 ) )
sprintf ( V_56 , L_29 , F_122 ( V_19 ) , F_123 ( V_19 ) ) ;
else if ( F_7 ( V_3 ) )
sprintf ( V_56 , L_30 , F_122 ( V_19 ) , F_123 ( V_19 ) ) ;
else if ( F_5 ( V_3 ) )
* V_56 = 0 ;
else if ( F_4 ( V_3 ) )
* V_56 = 0 ;
...
V_136 = F_1 ( V_2 , V_3 ) ;
V_118 = F_116 ( V_128 , V_129 , V_136 , V_56 ) ;
F_111 ( V_56 ) ;
return V_118 ;
}
int F_120 ( struct V_122 * V_123 , struct V_63 * V_63 )
{
int V_114 ;
T_3 V_19 ;
T_7 V_210 ;
