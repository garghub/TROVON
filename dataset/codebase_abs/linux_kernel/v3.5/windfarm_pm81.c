...
if ( V_90 )
return;
if ( V_77 == NULL && ! strcmp ( V_89 -> V_91 , L_27 ) ) {
if ( F_25 ( V_89 ) == 0 )
V_77 = V_89 ;
}
if ( V_29 == NULL && ! strcmp ( V_89 -> V_91 , L_28 ) ) {
if ( F_25 ( V_89 ) == 0 )
V_29 = V_89 ;
}
if ( V_78 == NULL && ! strcmp ( V_89 -> V_91 , L_29 ) ) {
if ( F_25 ( V_89 ) == 0 )
V_78 = V_89 ;
}
if ( V_9 > 3 ) {
...
if ( V_31 == NULL && ! strcmp ( V_89 -> V_91 , L_30 ) ) {
if ( F_25 ( V_89 ) == 0 )
V_31 = V_89 ;
}
...
static void F_26 ( struct V_92 * V_93 )
{
if ( V_94 )
return;
if ( V_82 == NULL && ! strcmp ( V_93 -> V_91 , L_31 ) ) {
if ( F_27 ( V_93 ) == 0 )
V_82 = V_93 ;
}
if ( V_81 == NULL && ! strcmp ( V_93 -> V_91 , L_32 ) ) {
if ( F_27 ( V_93 ) == 0 )
V_81 = V_93 ;
}
if ( V_41 == NULL && ! strcmp ( V_93 -> V_91 , L_33 ) ) {
if ( F_27 ( V_93 ) == 0 )
V_41 = V_93 ;
}
if ( V_82 && V_81 && V_41 )
...
case V_99 :
F_7 ( L_34 ,
( (struct V_88 * ) V_98 ) -> V_91 ) ;
F_24 ( V_98 ) ;
V_39 = 1 ;
break;
case V_100 :
F_7 ( L_35 ,
( (struct V_92 * ) V_98 ) -> V_91 ) ;
F_26 ( V_98 ) ;
break;
case V_101 :
if ( V_90 && V_94 )
...
static int T_2 F_32 ( struct V_105 * V_106 )
{
F_33 ( & V_107 ) ;
F_34 ( 1000 ) ;
if ( V_82 )
