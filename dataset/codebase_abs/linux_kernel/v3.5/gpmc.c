...
V_118 = F_67 ( V_119 , V_133 , V_134 , L_15 , NULL ) ;
if ( V_118 )
F_50 ( L_16 ,
V_119 , V_118 ) ;
return V_118 ;
...
int F_72 ( int V_4 , const T_6 * V_169 , T_6 * V_170 )
{
...
* V_170 ++ = V_2 ;
* V_170 ++ = V_2 >> 16 ;
* V_170 ++ = ( ( V_2 >> 8 ) & 0x0f ) | ( ( V_2 >> 20 ) & 0xf0 ) ;
V_159 = - V_70 ;
return 0 ;
}
int F_73 ( int V_4 , int V_172 , int V_173 )
{
if ( V_159 != - V_70 )
return - V_70 ;
if ( ! F_21 () ) {
...
int F_76 ( int V_4 , int V_156 , int V_157 , int V_172 ,
int V_173 )
{
unsigned int V_2 ;
if ( V_159 != - V_70 )
...
int F_77 ( int V_4 , const T_6 * V_169 , T_6 * V_174 )
{
int V_138 ;
unsigned long V_172 , V_175 , V_176 , V_177 ;
if ( V_159 != V_4 )
return - V_70 ;
V_172 = ( ( F_3 ( V_168 ) >> 4 ) & 0x7 ) + 1 ;
for ( V_138 = 0 ; V_138 < V_172 ; V_138 ++ ) {
V_175 = V_178 + 16 * V_138 ;
V_176 = F_3 ( V_175 + 0 ) ;
V_177 = F_3 ( V_175 + 4 ) ;
* V_174 ++ = 0x28 ^ ( ( V_177 >> 12 ) & 0xFF ) ;
* V_174 ++ = 0x13 ^ ( ( V_177 >> 4 ) & 0xFF ) ;
* V_174 ++ = 0xcc ^ ( ( ( V_177 & 0xF ) << 4 ) | ( ( V_176 >> 28 ) & 0xF ) ) ;
* V_174 ++ = 0x39 ^ ( ( V_176 >> 20 ) & 0xFF ) ;
* V_174 ++ = 0x96 ^ ( ( V_176 >> 12 ) & 0xFF ) ;
* V_174 ++ = 0xac ^ ( ( V_176 >> 4 ) & 0xFF ) ;
* V_174 ++ = 0x7f ^ ( ( V_176 & 0xF ) << 4 ) ;
}
V_159 = - V_70 ;
return 0 ;
}
int F_78 ( int V_4 , const T_6 * V_169 , T_6 * V_174 )
{
int V_138 ;
unsigned long V_172 , V_175 , V_176 , V_177 , V_179 , V_180 ;
if ( V_159 != V_4 )
return - V_70 ;
V_172 = ( ( F_3 ( V_168 ) >> 4 ) & 0x7 ) + 1 ;
for ( V_138 = 0 ; V_138 < V_172 ; V_138 ++ ) {
...
V_179 = F_3 ( V_175 + 8 ) ;
V_180 = F_3 ( V_175 + 12 ) ;
* V_174 ++ = 0xef ^ ( V_180 & 0xFF ) ;
* V_174 ++ = 0x51 ^ ( ( V_179 >> 24 ) & 0xFF ) ;
* V_174 ++ = 0x2e ^ ( ( V_179 >> 16 ) & 0xFF ) ;
* V_174 ++ = 0x09 ^ ( ( V_179 >> 8 ) & 0xFF ) ;
* V_174 ++ = 0xed ^ ( V_179 & 0xFF ) ;
* V_174 ++ = 0x93 ^ ( ( V_177 >> 24 ) & 0xFF ) ;
* V_174 ++ = 0x9a ^ ( ( V_177 >> 16 ) & 0xFF ) ;
* V_174 ++ = 0xc2 ^ ( ( V_177 >> 8 ) & 0xFF ) ;
* V_174 ++ = 0x97 ^ ( V_177 & 0xFF ) ;
* V_174 ++ = 0x79 ^ ( ( V_176 >> 24 ) & 0xFF ) ;
* V_174 ++ = 0xe5 ^ ( ( V_176 >> 16 ) & 0xFF ) ;
* V_174 ++ = 0x24 ^ ( ( V_176 >> 8 ) & 0xFF ) ;
* V_174 ++ = 0xb5 ^ ( V_176 & 0xFF ) ;
}
V_159 = - V_70 ;
return 0 ;
}
