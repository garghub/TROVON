...
static int F_69 ( struct V_101 * V_131 , T_4 V_132 )
{
struct V_4 * V_5 = F_67 ( V_131 ) ;
V_5 -> V_68 = 0 ;
F_62 ( V_5 -> V_10 . V_11 -> V_98 ) ;
F_42 ( & V_5 -> V_70 ) ;
F_62 ( V_5 -> V_10 . V_11 -> V_84 ) ;
F_3 ( V_133 , L_45 ) ;
return 0 ;
}
static int F_70 ( struct V_101 * V_131 )
{
struct V_4 * V_5 = F_67 ( V_131 ) ;
int V_134 ;
V_5 -> V_68 = 1 ;
V_134 = F_26 ( V_5 -> V_10 . V_11 -> V_98 , V_95 ) ;
if ( V_134 ) {
...
static int F_71 ( struct V_101 * V_131 )
{
...
int V_144 ;
F_78 ( V_121 ) ;
for ( V_144 = 0 ; V_144 < V_121 -> V_145 ; V_144 ++ )
F_79 ( V_121 -> V_5 + V_144 ) ;
F_80 ( & V_142 ) ;
F_76 ( V_121 ) ;
V_121 = NULL ;
}
