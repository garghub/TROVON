...
if ( ! V_42 -> V_73 )
F_23 ( V_74 , V_15 -> V_75 ) ;
for ( V_8 = 0 ; V_8 < V_42 -> V_69 -> V_76 ; V_8 ++ ) {
unsigned int V_77 = V_42 -> V_69 -> V_30 [ V_8 ] ;
V_2 -> V_37 |= 1 << F_24 ( V_77 ) ;
V_2 -> V_39 |= 1 << F_25 ( V_77 ) ;
}
V_2 -> V_6 = V_6 ;
V_2 -> V_42 = V_42 ;
V_2 -> V_15 = V_15 ;
V_2 -> V_5 = & V_78 [ V_6 -> V_79 ] ;
V_7 = F_12 ( V_2 ) ;
if ( V_7 < 0 )
goto V_72;
V_7 = F_26 ( V_15 ) ;
...
V_7 = F_28 ( V_12 , NULL , F_4 , V_80 ,
L_3 , V_2 ) ;
if ( V_7 ) {
F_27 ( & V_58 -> V_13 , L_4 , V_7 ) ;
goto V_81;
}
F_29 ( V_58 , V_2 ) ;
return 0 ;
...
static int T_4 F_33 ( struct V_57 * V_58 )
{
