...
static int
F_47 ( struct V_10 * V_11 , V_30 * V_71 , int * V_72 , int * V_73 )
{
V_30 V_74 = F_20 ( V_11 ) -> V_74 ;
const int V_75 = F_48 ( V_11 ) ;
V_30 V_76 = V_75 + F_49 ( struct V_56 , V_74 ) ;
int V_77 = V_75 + sizeof( struct V_56 ) ;
int V_37 = V_11 -> V_37 - V_77 ;
V_30 V_78 = V_79 ;
while ( V_74 != V_80 ) {
struct V_81 V_82 ;
int V_83 ;
...
if ( V_37 < ( int ) sizeof( struct V_81 ) ) {
F_18 ( L_13 ) ;
return - 1 ;
}
if ( F_51 ( V_11 , V_77 , & V_82 , sizeof( V_82 ) ) )
F_52 () ;
if ( V_74 == V_85 )
V_83 = ( V_82 . V_83 + 2 ) << 2 ;
else
...
struct V_10 * F_54 ( struct V_10 * V_11 , T_2 V_86 )
{
struct V_10 * V_60 ;
...
if ( F_58 ( & V_14 . V_48 ) > V_14 . V_89 )
F_11 () ;
V_13 = F_59 ( V_21 -> V_90 , V_86 , & V_82 -> V_6 , & V_82 -> V_7 ) ;
if ( V_13 == NULL ) {
F_18 ( L_17 ) ;
goto V_88;
}
...
void F_62 ( unsigned int V_91 , struct V_10 * V_11 ,
struct V_52 * V_92 , struct V_52 * V_19 ,
int (* F_63)( struct V_10 * ) )
{
struct V_10 * V_93 , * V_94 ;
for ( V_93 = F_5 ( V_11 ) -> V_12 ; V_93 ; ) {
F_64 ( V_93 -> V_95 ) ;
F_65 ( V_11 ) ;
V_93 -> V_95 = V_11 ;
V_94 = V_93 -> V_24 ;
V_93 -> V_24 = NULL ;
F_66 ( V_96 , V_91 , V_93 , V_92 , V_19 , F_63 ,
V_97 + 1 ) ;
V_93 = V_94 ;
}
F_64 ( V_11 ) ;
...
V_8 . V_101 = NULL ;
V_8 . V_102 = F_4 ;
V_8 . V_103 = sizeof( struct V_3 ) ;
V_8 . V_104 = V_105 ;
V_8 . V_106 = F_15 ;
V_8 . V_107 = 10 * 60 * V_108 ;
V_14 . V_109 = V_110 ;
V_14 . V_89 = V_111 ;
V_14 . V_112 = V_113 ;
F_68 ( & V_14 ) ;
