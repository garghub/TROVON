...
{
struct V_96 * V_97 = & V_37 -> V_91 . V_92 ;
struct V_98 * V_99 = V_37 -> V_99 ;
struct V_1 * V_17 ;
struct V_40 * V_41 , * V_100 ;
struct V_23 * V_81 , * V_101 ;
struct V_10 * V_80 ;
struct V_20 * V_79 ;
int V_102 = 0 ;
int V_87 = 0 ;
...
if ( F_60 ( V_78 ) )
return - V_104 ;
if ( F_61 ( & V_37 -> V_91 . V_92 . V_105 , 1 , V_106 ) == 0 )
return - V_107 ;
V_87 = - V_34 ;
...
goto V_109;
F_62 ( & V_3 ) ;
memcpy ( V_100 -> V_78 , V_78 , V_56 ) ;
memset ( V_100 -> V_110 , 0xff , V_56 ) ;
V_100 -> V_111 = false ;
V_100 -> V_37 = V_37 ;
V_100 -> V_50 = 0 ;
F_63 ( & V_100 -> V_52 ) ;
V_101 -> V_41 = V_100 ;
V_100 -> V_112 . V_54 = ( unsigned long ) V_100 ;
V_100 -> V_112 . V_113 = V_114 ;
V_100 -> V_115 = V_116 ;
F_11 ( & V_100 -> V_82 ) ;
F_64 ( & V_100 -> V_112 ) ;
V_17 = F_1 () ;
V_103 = F_23 ( V_78 , V_37 , V_17 ) ;
V_80 = & V_17 -> V_9 [ V_103 ] ;
F_65 ( & V_17 -> V_11 [ V_103 ] ) ;
V_87 = - V_88 ;
...
F_54 ( & V_101 -> V_26 , V_80 ) ;
if ( F_67 ( & V_17 -> V_14 ) >=
V_17 -> V_30 * ( V_17 -> V_13 + 1 ) )
V_102 = 1 ;
V_118 ++ ;
F_68 ( & V_17 -> V_11 [ V_103 ] ) ;
F_69 ( & V_3 ) ;
if ( V_102 ) {
F_70 ( V_119 , & V_97 -> V_120 ) ;
F_71 ( & V_99 -> V_121 , & V_37 -> V_122 ) ;
}
return 0 ;
V_117:
F_68 ( & V_17 -> V_11 [ V_103 ] ) ;
...
F_8 ( V_100 ) ;
V_108:
F_16 ( & V_37 -> V_91 . V_92 . V_105 ) ;
return V_87 ;
}
static void F_72 ( struct V_123 * V_95 )
{
struct V_1 * V_17 = F_73 ( V_95 , struct V_1 , V_123 ) ;
F_13 ( V_17 , false ) ;
}
void F_74 ( void )
{
...
int F_79 ( T_2 * V_78 , T_2 * V_125 , struct V_36 * V_37 )
{
struct V_96 * V_97 = & V_37 -> V_91 . V_92 ;
struct V_98 * V_99 = V_37 -> V_99 ;
struct V_1 * V_17 ;
...
{
struct V_1 * V_17 ;
static const T_2 V_127 [ V_56 ] = { 0xff , 0xff , 0xff , 0xff , 0xff , 0xff } ;
struct V_40 * V_41 ;
struct V_23 * V_81 ;
struct V_20 * V_21 ;
struct V_36 * V_37 = V_43 -> V_37 ;
int V_6 ;
T_3 V_128 = F_81 ( V_129 ) ;
F_36 () ;
V_17 = F_37 ( V_2 ) ;
F_52 (tbl, p, node, i) {
V_41 = V_81 -> V_41 ;
...
++ V_41 -> V_131 ;
F_17 ( & V_41 -> V_82 ) ;
F_82 ( V_37 -> V_91 . V_92 . V_132 . V_133 ,
V_41 -> V_78 , F_83 ( V_41 -> V_131 ) ,
V_128 , V_127 , V_37 ) ;
}
}
F_38 () ;
}
static void F_84 ( struct V_123 * V_134 )
{
struct V_23 * V_81 = F_73 ( V_134 , struct V_23 , V_95 ) ;
struct V_36 * V_37 = V_81 -> V_41 -> V_37 ;
F_85 ( & V_81 -> V_41 -> V_112 ) ;
F_16 ( & V_37 -> V_91 . V_92 . V_105 ) ;
F_8 ( V_81 -> V_41 ) ;
F_8 ( V_81 ) ;
}
...
return ( V_72 == V_41 ) ? - V_138 : 0 ;
}
void F_96 ( struct V_44 * V_45 ,
struct V_36 * V_37 )
{
F_97 ( V_45 ) ;
V_37 -> V_91 . V_92 . V_139 . V_140 ++ ;
}
...
V_41 = V_81 -> V_41 ;
V_101 -> V_41 = V_41 ;
V_103 = F_23 ( V_41 -> V_78 , V_41 -> V_37 , V_7 ) ;
F_105 ( & V_101 -> V_26 ,
& V_7 -> V_9 [ V_103 ] ) ;
return 0 ;
}
