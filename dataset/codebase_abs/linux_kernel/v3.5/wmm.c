...
V_26 = V_15 -> V_26 [ V_27 ] ;
if ( V_26 && F_27 ( & V_26 -> V_30 . V_90 ) )
return false ;
}
return true ;
}
static void
F_28 ( struct V_25 * V_26 ,
struct V_13 * V_17 )
{
struct V_14 * V_15 = V_26 -> V_15 ;
struct V_91 * V_92 , * V_48 ;
F_29 (&ra_list->skb_head, skb, tmp)
F_30 ( V_15 , V_92 , - 1 ) ;
}
static void
...
{
struct V_13 * V_17 ;
F_32 (ra_list, ra_list_head, list)
F_28 ( V_26 , V_17 ) ;
}
...
F_42 ( & V_26 -> V_30 . V_97 , V_96 ) ;
}
static struct V_13 *
F_43 ( struct V_25 * V_26 , T_1 V_73 ,
T_1 * V_100 )
{
struct V_13 * V_17 ;
F_32 (ra_list, &priv->wmm.tid_tbl_ptr[tid].ra_list,
list) {
...
static struct V_13 *
F_44 ( struct V_25 * V_26 , T_1 V_73 , T_1 * V_100 )
{
struct V_13 * V_17 ;
V_17 = F_43 ( V_26 , V_73 , V_100 ) ;
if ( V_17 )
return V_17 ;
F_10 ( V_26 , V_100 ) ;
return F_43 ( V_26 , V_73 , V_100 ) ;
}
int
...
{
struct V_13 * V_102 ;
F_32 (rlist, &priv->wmm.tid_tbl_ptr[ptr_index].ra_list,
list) {
if ( V_102 == V_17 )
return true ;
}
...
if ( ! F_11 ( V_26 ) ) {
if ( ! F_47 ( & V_26 -> V_30 . V_31 [ V_103 ] . V_17 ) )
V_17 = F_48 (
...
V_134 -> V_122 . type = F_53 ( ( T_2 ) V_140 [ 0 ] ) ;
V_134 -> V_122 . V_107 = F_53 ( ( T_2 ) V_140 [ 1 ] ) ;
...
F_40 ( & V_15 -> V_162 [ V_49 ] . V_163 ,
V_96 ) ;
V_161 = F_47 ( & V_15 -> V_162 [ V_49 ]
. V_164 ) ;
F_42 ( & V_15 -> V_162 [ V_49 ] . V_163 ,
V_96 ) ;
if ( V_161 )
continue;
...
for ( V_27 = F_27 ( V_160 ) ; V_27 >= V_166 ; -- V_27 ) {
V_159 = & ( V_152 ) -> V_30 .
V_31 [ V_39 [ V_27 ] ] ;
if ( ! V_159 -> V_32 )
continue;
...
return NULL ;
V_168:
F_40 ( & V_152 -> V_30 . V_97 , V_96 ) ;
if ( F_27 ( V_160 ) > V_27 )
F_16 ( V_160 , V_27 ) ;
F_42 ( & V_152 -> V_30 . V_97 , V_96 ) ;
* V_26 = V_152 ;
* V_73 = V_39 [ V_27 ] ;
return V_153 ;
}
...
int V_178 = 0 , V_73 = 0 ;
unsigned long V_96 ;
V_153 = F_58 ( V_15 , & V_26 , & V_101 ) ;
if ( ! V_153 )
return - 1 ;
V_73 = F_67 ( V_153 ) ;
F_9 ( V_15 -> V_19 , L_26 , V_73 ) ;
F_40 ( & V_26 -> V_30 . V_97 , V_96 ) ;
if ( ! F_45 ( V_26 , V_153 , V_101 ) ) {
F_42 ( & V_26 -> V_30 . V_97 , V_96 ) ;
return - 1 ;
}
if ( F_62 ( V_26 , V_153 ) ) {
F_65 ( V_26 , V_153 , V_101 , V_96 ) ;
return 0 ;
}
if ( ! V_153 -> V_29 ||
F_68 ( V_26 , V_153 , V_73 ) ||
V_26 -> V_179 . V_180 ||
( ( V_26 -> V_181 . V_182 ||
V_26 -> V_181 . V_183 ) &&
! V_26 -> V_184 ) ) {
F_61 ( V_26 , V_153 , V_101 , V_96 ) ;
} else {
if ( F_69 ( V_26 , V_73 ) ) {
if ( F_70 ( V_15 ) ) {
F_71 ( V_26 , V_153 -> V_16 , V_73 ,
V_185 ) ;
F_72 ( V_26 , V_73 , V_153 -> V_16 ) ;
} else if ( F_73
( V_26 , V_73 , & V_178 , V_16 ) ) {
F_71 ( V_26 , V_153 -> V_16 , V_73 ,
V_185 ) ;
F_74 ( V_26 , V_178 , V_16 , 1 ) ;
}
}
if ( F_75 ( V_26 , V_73 ) &&
F_60 ( V_26 , V_153 ,
V_15 -> V_186 ) )
F_76 ( V_26 , V_153 , V_187 ,
V_101 , V_96 ) ;
else
F_61 ( V_26 , V_153 , V_101 , V_96 ) ;
}
