...
const struct V_256 * V_257 = F_93 ( V_4 ) ;
if ( V_257 ) {
V_255 -> V_56 = V_257 -> V_258 ;
V_255 -> V_58 . V_8 = V_257 -> V_259 ;
} else {
V_255 -> V_56 = 0 ;
V_255 -> V_58 . V_8 = 0 ;
}
...
int F_95 ( struct V_65 * V_43 , int V_116 ,
int V_117 , char T_6 * V_118 , unsigned int V_17 )
{
int V_28 ;
if ( V_116 != V_10 )
...
! F_65 ( V_117 ) ) {
F_67 ( V_43 ) ;
V_28 = F_97 ( V_43 , V_147 , V_117 , V_118 , V_17 ) ;
F_91 ( V_43 ) ;
}
#endif
return V_28 ;
}
int F_98 ( struct V_65 * V_43 , int V_116 , int V_117 ,
...
return F_99 ( V_43 , V_116 , V_117 , V_118 , V_17 ,
F_95 ) ;
V_28 = F_63 ( V_43 , V_116 , V_117 , V_118 , V_17 ) ;
#ifdef F_96
if ( V_28 == - V_167 && V_117 != V_122 &&
...
static int F_101 ( struct V_65 * V_43 , int V_116 , int V_117 ,
...
return - V_260 ;
if ( F_65 ( V_117 ) )
return F_102 ( V_43 , V_117 , V_118 , V_17 ) ;
if ( F_64 ( V_34 , V_17 ) )
return - V_135 ;
if ( V_34 < 0 )
return - V_51 ;
...
return F_103 ( 0 , V_17 ) ;
F_11 ( V_16 ) ;
V_34 = F_104 (unsigned int, len, opt->optlen) ;
if ( F_103 ( V_34 , V_17 ) )
return - V_135 ;
if ( F_105 ( V_118 , V_16 -> V_24 , V_34 ) )
return - V_135 ;
return 0 ;
}
case V_11 :
...
break;
case V_130 :
V_119 = ( V_178 int ) F_81 ( ( V_266 ) V_42 -> V_179 ) ;
break;
case V_182 :
{
struct V_185 V_57 ;
V_34 = F_104 (unsigned int, len, sizeof(struct in_addr)) ;
V_57 . V_8 = V_42 -> V_191 ;
F_91 ( V_43 ) ;
if ( F_103 ( V_34 , V_17 ) )
return - V_135 ;
if ( F_105 ( V_118 , & V_57 , V_34 ) )
return - V_135 ;
return 0 ;
}
case V_195 :
...
V_6 . V_58 . V_8 = V_42 -> V_270 ;
V_6 . V_56 = V_42 -> V_190 ;
F_4 ( & V_2 , V_10 , V_11 , sizeof( V_6 ) , & V_6 ) ;
}
if ( V_42 -> V_45 & V_157 ) {
int V_271 = V_42 -> V_173 ;
...
if ( F_103 ( V_34 , V_17 ) )
return - V_135 ;
if ( F_105 ( V_118 , & V_136 , 1 ) )
return - V_135 ;
} else {
V_34 = F_104 (unsigned int, sizeof(int), len) ;
if ( F_103 ( V_34 , V_17 ) )
return - V_135 ;
if ( F_105 ( V_118 , & V_119 , V_34 ) )
return - V_135 ;
}
return 0 ;
}
int F_111 ( struct V_65 * V_43 , int V_116 ,
int V_117 , char T_6 * V_118 , int T_6 * V_17 )
{
int V_28 ;
V_28 = F_101 ( V_43 , V_116 , V_117 , V_118 , V_17 , 0 ) ;
#ifdef F_96
if ( V_28 == - V_167 && V_117 != V_267 &&
! F_65 ( V_117 ) ) {
int V_34 ;
if ( F_64 ( V_34 , V_17 ) )
return - V_135 ;
F_67 ( V_43 ) ;
V_28 = F_112 ( V_43 , V_147 , V_117 , V_118 ,
& V_34 ) ;
F_91 ( V_43 ) ;
if ( V_28 >= 0 )
V_28 = F_103 ( V_34 , V_17 ) ;
return V_28 ;
}
#endif
return V_28 ;
}
int F_113 ( struct V_65 * V_43 , int V_116 , int V_117 ,
char T_6 * V_118 , int T_6 * V_17 )
{
int V_28 ;
if ( V_117 == V_231 )
return F_114 ( V_43 , V_116 , V_117 , V_118 , V_17 ,
F_111 ) ;
V_28 = F_101 ( V_43 , V_116 , V_117 , V_118 , V_17 ,
V_273 ) ;
#ifdef F_96
if ( V_28 == - V_167 && V_117 != V_267 &&
! F_65 ( V_117 ) ) {
...
return - V_135 ;
F_67 ( V_43 ) ;
V_28 = F_115 ( V_43 , V_147 , V_117 , V_118 , & V_34 ) ;
F_91 ( V_43 ) ;
if ( V_28 >= 0 )
V_28 = F_103 ( V_34 , V_17 ) ;
return V_28 ;
