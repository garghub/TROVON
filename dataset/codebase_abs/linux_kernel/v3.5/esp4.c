...
return ( ( V_95 - V_20 -> V_44 . V_100 - F_23 ( V_26 -> V_2 ) -
V_97 ) & ~ ( V_96 - 1 ) ) + ( V_97 - 2 ) ;
}
static void F_69 ( struct V_16 * V_17 , T_3 V_101 )
{
struct V_102 * V_102 = F_70 ( V_17 -> V_103 ) ;
const struct V_77 * V_78 = ( const struct V_77 * ) V_17 -> V_18 ;
struct V_21 * V_22 = (struct V_21 * ) ( V_17 -> V_18 + ( V_78 -> V_81 << 2 ) ) ;
struct V_19 * V_20 ;
if ( F_71 ( V_17 ) -> type != V_104 ||
F_71 ( V_17 ) -> V_105 != V_106 )
return;
V_20 = F_72 ( V_102 , V_17 -> V_107 , ( const T_5 * ) & V_78 -> V_108 ,
V_22 -> V_66 , V_48 , V_109 ) ;
if ( ! V_20 )
return;
F_73 ( V_110 L_1 ,
F_74 ( V_22 -> V_66 ) , F_74 ( V_78 -> V_108 ) ) ;
F_75 ( V_20 ) ;
}
...
struct V_1 * V_2 ;
int V_15 ;
V_2 = F_79 ( V_20 -> V_2 -> V_111 , 0 , 0 ) ;
V_15 = F_80 ( V_2 ) ;
if ( F_81 ( V_2 ) )
goto error;
V_26 -> V_2 = V_2 ;
V_15 = F_82 ( V_2 , V_20 -> V_2 -> V_112 ,
( V_20 -> V_2 -> V_113 + 7 ) / 8 ) ;
if ( V_15 )
goto error;
V_15 = F_83 ( V_2 , V_20 -> V_2 -> V_114 / 8 ) ;
if ( V_15 )
goto error;
error:
return V_15 ;
...
L_2 ,
V_20 -> V_126 ? V_20 -> V_126 -> V_111 : L_3 ,
...
( V_20 -> V_124 -> V_113 + 7 ) / 8 + F_85 ( sizeof( * V_116 ) ) ;
V_15 = - V_37 ;
...
V_118 = ( void * ) V_120 ;
V_118 -> V_128 = V_129 ;
V_118 -> V_130 = F_86 ( sizeof( * V_116 ) ) ;
V_116 = F_87 ( V_118 ) ;
V_120 += F_85 ( sizeof( * V_116 ) ) ;
if ( V_20 -> V_126 ) {
struct V_131 * V_132 ;
memcpy ( V_120 , V_20 -> V_126 -> V_112 , ( V_20 -> V_126 -> V_113 + 7 ) / 8 ) ;
V_120 += ( V_20 -> V_126 -> V_113 + 7 ) / 8 ;
V_132 = F_88 ( V_20 -> V_126 -> V_111 , 0 ) ;
F_89 ( ! V_132 ) ;
V_15 = - V_84 ;
...
V_116 -> V_139 = F_90 ( ( V_20 -> V_124 -> V_113 + 7 ) / 8 ) ;
memcpy ( V_120 , V_20 -> V_124 -> V_112 , ( V_20 -> V_124 -> V_113 + 7 ) / 8 ) ;
V_15 = F_82 ( V_2 , V_119 , V_123 ) ;
V_137:
F_19 ( V_119 ) ;
error:
return V_15 ;
...
else if ( V_20 -> V_44 . V_88 == V_98 && V_20 -> V_140 . V_141 != V_142 )
V_20 -> V_44 . V_100 += V_143 ;
if ( V_20 -> V_49 ) {
struct V_50 * V_49 = V_20 -> V_49 ;
switch ( V_49 -> V_56 ) {
default:
...
{
if ( F_94 ( & V_145 , V_109 ) < 0 ) {
F_95 ( L_6 , V_146 ) ;
return - V_147 ;
}
if ( F_96 ( & V_148 , V_48 ) < 0 ) {
F_95 ( L_7 , V_146 ) ;
F_97 ( & V_145 , V_109 ) ;
return - V_147 ;
}
...
{
if ( F_99 ( & V_148 , V_48 ) < 0 )
F_95 ( L_8 , V_146 ) ;
if ( F_97 ( & V_145 , V_109 ) < 0 )
F_95 ( L_9 , V_146 ) ;
}
