...
F_93 ( V_7 , V_15 ) ;
F_94 ( & V_15 -> V_91 , F_47 , ( unsigned long ) V_15 ) ;
F_95 ( & V_15 -> V_143 ) ;
F_95 ( & V_15 -> V_138 ) ;
F_95 ( & V_15 -> V_60 ) ;
F_95 ( & V_15 -> V_33 ) ;
F_96 ( & V_15 -> V_35 ) ;
V_64 = F_97 ( V_7 -> V_87 , F_44 , V_171 ,
L_59 , V_15 ) ;
if ( V_64 ) {
...
static int F_98 ( struct V_14 * V_15 , struct V_6 * V_175 )
{
int V_43 ;
for ( V_43 = 0 ; V_43 < V_15 -> V_95 ; V_43 ++ ) {
struct V_3 * V_4 ;
struct V_19 * V_20 ;
F_104 ( & V_15 -> V_139 [ V_43 ] ) ;
F_104 ( & V_15 -> V_61 [ V_43 ] ) ;
V_15 -> V_12 [ V_43 ] = F_105 ( L_59 , V_175 , & V_176 , - 1 , NULL ) ;
if ( ! V_15 -> V_12 [ V_43 ] ) {
F_106 ( & V_15 -> V_7 -> V_7 , L_61 , V_43 ) ;
F_107 ( V_15 ) ;
return - V_53 ;
}
if ( F_108 ( & V_15 -> V_12 [ V_43 ] -> V_13 , & V_177 ) )
F_106 ( & V_15 -> V_7 -> V_7 , L_62 , V_43 ) ;
if ( F_109 ( & V_15 -> V_12 [ V_43 ] -> V_13 . V_178 , & V_179 ) )
F_106 ( & V_15 -> V_7 -> V_7 , L_63 , V_43 ) ;
...
F_110 ( & V_15 -> V_12 [ V_43 ] -> V_13 . V_178 , & V_179 ) ;
F_111 ( V_15 -> V_12 [ V_43 ] ) ;
V_4 = V_15 -> V_98 [ V_43 ] ;
if ( V_4 ) {
F_49 ( V_15 -> V_7 , F_50 ( V_4 ) -> V_99 ,
V_100 , V_101 ) ;
...
static void F_113 ( struct V_150 * V_7 )
{
struct V_14 * V_15 = F_114 ( V_7 ) ;
F_38 ( 0 , V_15 -> V_78 + V_173 ) ;
F_38 ( 1 , V_15 -> V_78 + V_79 ) ;
( void ) F_39 ( V_15 -> V_78 + V_79 ) ;
F_107 ( V_15 ) ;
