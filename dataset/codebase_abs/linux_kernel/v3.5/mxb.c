...
static int F_34 ( struct V_98 * V_98 , void * V_99 , struct V_2 * V_3 )
{
struct V_19 * V_20 = ( (struct V_104 * ) V_99 ) -> V_20 ;
struct V_1 * V_1 = (struct V_1 * ) V_20 -> V_23 ;
if ( V_3 -> V_101 ) {
...
static int F_37 ( struct V_98 * V_98 , void * V_99 , struct V_120 * V_121 )
{
struct V_19 * V_20 = ( (struct V_104 * ) V_99 ) -> V_20 ;
struct V_1 * V_1 = (struct V_1 * ) V_20 -> V_23 ;
...
static int F_42 ( struct V_98 * V_98 , void * V_99 , struct V_128 * V_129 )
{
struct V_19 * V_20 = ( (struct V_104 * ) V_99 ) -> V_20 ;
struct V_1 * V_1 = (struct V_1 * ) V_20 -> V_23 ;
...
return - V_136 ;
if ( F_45 ( & V_134 -> V_137 ) ) {
V_134 -> V_27 = F_46 ( V_20 , V_134 -> V_134 ) ;
V_134 -> V_138 = 4 ;
return 0 ;
}
F_33 ( V_20 , V_60 , V_139 , V_134 ) ;
return 0 ;
}
static int F_47 ( struct V_98 * V_98 , void * V_99 , struct V_133 * V_134 )
{
struct V_19 * V_20 = ( (struct V_104 * ) V_99 ) -> V_20 ;
if ( ! F_44 ( V_135 ) )
return - V_136 ;
...
return F_33 ( V_20 , V_60 , V_140 , V_134 ) ;
}
static int F_48 ( struct V_19 * V_20 , struct V_141 * V_142 )
{
struct V_1 * V_1 ;
F_28 ( L_24 , V_20 ) ;
F_49 ( V_20 , & V_124 ) ;
...
V_124 . V_143 . F_27 = F_27 ;
V_124 . V_143 . F_29 = F_29 ;
V_124 . V_143 . F_30 = F_30 ;
V_124 . V_143 . F_35 = F_35 ;
V_124 . V_143 . F_31 = F_31 ;
V_124 . V_143 . F_34 = F_34 ;
V_124 . V_143 . F_36 = F_36 ;
V_124 . V_143 . F_37 = F_37 ;
V_124 . V_143 . F_40 = F_40 ;
V_124 . V_143 . F_41 = F_41 ;
V_124 . V_143 . F_42 = F_42 ;
#ifdef F_51
V_124 . V_143 . F_43 = F_43 ;
V_124 . V_143 . F_47 = F_47 ;
#endif
if ( F_52 ( & V_1 -> V_144 , V_20 , L_25 , V_145 ) ) {
F_53 ( L_26 ) ;
F_50 ( V_20 ) ;
return - 1 ;
}
if ( F_54 ( V_20 ) ) {
if ( F_52 ( & V_1 -> V_146 , V_20 , L_25 , V_147 ) ) {
F_53 ( L_27 ) ;
}
}
F_25 ( L_28 , V_38 ) ;
...
static int F_57 ( struct V_19 * V_20 , struct V_148 * V_149 )
{
struct V_1 * V_1 = (struct V_1 * ) V_20 -> V_23 ;
if ( V_150 == V_149 -> V_24 ) {
T_1 V_56 = V_150 ;
