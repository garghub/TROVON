...
static long F_21 ( struct V_1 * V_2 , unsigned long V_17 ,
unsigned long * V_18 )
{
if ( V_17 >= 125000000 )
V_17 = 125000000 ;
else if ( V_17 >= 100000000 )
V_17 = 100000000 ;
else if ( V_17 >= 50000000 )
V_17 = 50000000 ;
else
V_17 = 25000000 ;
return V_17 ;
}
static int F_22 ( struct V_1 * V_2 , unsigned long V_17 ,
unsigned long V_15 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
T_1 V_7 , div ;
...
struct V_28 * F_23 ( enum V_29 type , const char * V_30 ,
