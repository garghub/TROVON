...
static void F_150 ( struct V_1 * V_173 )
{
F_45 ( V_174 ) ;
struct V_1 * V_57 ;
struct V_1 * V_58 ;
struct V_2 * V_3 ;
static T_1 V_175 ;
F_50 ( (struct V_176 * ) & V_173 -> V_56 , & V_174 ) ;
while ( ! F_47 ( & V_174 ) ) {
...
static int F_152 ( struct V_177 * V_178 ,
...
void F_156 ( struct V_6 * V_36 , struct V_28 * V_29 )
{
F_75 ( & V_98 ) ;
F_83 ( V_36 ) ;
F_19 ( F_4 ( V_36 ) , V_29 ) ;
...
int F_163 ( T_1 * V_185 )
{
return F_25 ( * V_185 , V_103 -> V_33 ) ;
}
static const struct V_1 * F_164 ( const struct V_1 * V_9 )
{
while ( ! ( F_9 ( V_9 ) || F_10 ( V_9 ) ) && V_9 -> V_32 )
V_9 = V_9 -> V_32 ;
return V_9 ;
}
int F_165 ( int V_186 , T_13 V_187 )
{
const struct V_1 * V_9 ;
int V_188 ;
if ( F_166 () || ( V_187 & V_189 ) )
return 1 ;
F_167 ( ! ( V_187 & V_190 ) ) ;
if ( F_168 ( V_186 , V_103 -> V_33 ) )
return 1 ;
if ( F_81 ( F_82 ( V_107 ) ) )
return 1 ;
if ( V_187 & V_190 )
...
V_9 = F_164 ( F_4 ( V_103 ) ) ;
F_88 ( V_103 ) ;
V_188 = F_168 ( V_186 , V_9 -> V_33 ) ;
F_76 ( & V_98 ) ;
return V_188 ;
}
int F_169 ( int V_186 , T_13 V_187 )
{
if ( F_166 () || ( V_187 & V_189 ) )
return 1 ;
if ( F_168 ( V_186 , V_103 -> V_33 ) )
...
static int F_171 ( int * V_191 )
{
int V_186 ;
V_186 = F_172 ( * V_191 , V_103 -> V_33 ) ;
if ( V_186 == V_192 )
V_186 = F_173 ( V_103 -> V_33 ) ;
* V_191 = V_186 ;
return V_186 ;
}
int F_174 ( void )
{
if ( V_103 -> V_193 == V_194 )
V_103 -> V_193 =
F_175 ( & V_103 -> V_33 ) ;
return F_171 ( & V_103 -> V_193 ) ;
}
int F_176 ( void )
{
...
V_103 -> V_195 =
F_175 ( & V_103 -> V_33 ) ;
return F_171 ( & V_103 -> V_195 ) ;
}
int F_177 ( const struct V_6 * V_196 ,
const struct V_6 * V_197 )
{
return F_25 ( V_196 -> V_33 , V_197 -> V_33 ) ;
}
void F_178 ( struct V_6 * V_36 )
{
struct V_18 * V_18 ;
V_18 = F_4 ( V_36 ) -> V_5 . V_2 -> V_18 ;
F_114 ( & V_198 ) ;
snprintf ( V_199 , V_200 ,
V_18 ? ( const char * ) V_18 -> V_201 . V_202 : L_10 ) ;
F_131 ( V_203 , V_204 ,
V_36 -> V_33 ) ;
F_54 ( V_205 L_11 ,
V_36 -> V_206 , V_199 , V_203 ) ;
F_115 ( & V_198 ) ;
}
void F_179 ( void )
{
...
static int F_180 ( struct V_207 * V_208 , void * V_209 )
{
struct V_210 * V_210 ;
struct V_6 * V_36 ;
char * V_93 ;
...
V_94 = - V_211 ;
V_210 = V_208 -> V_147 ;
V_36 = F_181 ( V_210 , V_212 ) ;
if ( ! V_36 )
goto V_213;
V_94 = - V_49 ;
F_59 () ;
V_5 = F_5 ( V_36 , V_4 ) ;
V_94 = F_182 ( V_5 -> V_2 , V_93 , V_97 ) ;
if ( V_94 < 0 )
goto V_214;
F_183 ( V_208 , V_93 ) ;
F_184 ( V_208 , '\n' ) ;
...
static int F_186 ( struct V_215 * V_215 , struct V_163 * V_163 )
{
struct V_210 * V_210 = F_187 ( V_215 ) -> V_210 ;
return F_188 ( V_163 , F_180 , V_210 ) ;
}
void F_189 ( struct V_207 * V_208 , struct V_6 * V_7 )
{
F_190 ( V_208 , L_12 ) ;
F_191 ( V_208 , & V_7 -> V_33 ) ;
F_190 ( V_208 , L_13 ) ;
F_190 ( V_208 , L_14 ) ;
F_192 ( V_208 , & V_7 -> V_33 ) ;
F_190 ( V_208 , L_13 ) ;
}
