...
static T_1 F_50 ( int V_9 , void * V_17 )
{
return V_22 ;
}
...
static T_1 F_53 ( int V_9 , void * V_17 )
{
return V_22 ;
}
...
if ( V_20 -> V_14 == 0 )
return V_61 ;
V_61 = F_55 ( V_20 -> V_20 , V_20 -> V_13 , V_20 -> V_14 ) ;
if ( V_61 )
return V_61 ;
...
#ifdef F_61
case V_67 :
V_61 = F_57 ( V_29 , V_20 , V_9 ) ;
break;
#endif
#ifdef F_62
case V_68 :
V_61 = F_58 ( V_29 , V_20 , V_9 ) ;
break;
#endif
default:
V_61 = - V_48 ;
...
V_61 = 0 ;
if ( V_47 )
V_61 = F_59 ( V_29 , V_6 , V_47 ) ;
if ( V_61 )
goto V_74;
if ( V_46 )
V_61 = F_63 ( V_29 , V_6 , V_69 , V_46 ) ;
V_74:
F_69 ( & V_29 -> V_70 ) ;
return V_61 ;
}
...
static int F_71 ( struct V_76 * V_20 )
{
#ifdef F_72
int V_10 ;
bool V_77 = false ;
...
if ( ! F_73 ( V_20 , V_10 ) )
continue;
V_80 = F_74 ( & V_20 -> V_20 . V_84 , V_85 ) ;
if ( ! V_80 )
return - V_86 ;
V_81 = F_75 ( V_85 , L_4 , V_80 , V_10 ) ;
F_29 ( V_80 ) ;
if ( ! V_81 )
return - V_86 ;
V_61 = F_76 ( V_81 , V_87 , & V_82 ) ;
F_29 ( V_81 ) ;
if ( V_61 )
return V_61 ;
V_83 = V_82 . V_88 -> V_89 ;
V_61 = F_77 ( V_83 , V_90 | V_91 | V_92 ) ;
F_78 ( & V_82 ) ;
if ( V_61 )
return V_61 ;
V_77 = true ;
...
static int F_79 ( struct V_29 * V_29 ,
struct V_94 * V_8 )
{
int V_61 = 0 , V_95 ;
struct V_1 * V_6 ;
...
V_6 = F_81 ( sizeof( struct V_1 ) , V_85 ) ;
if ( V_6 == NULL ) {
F_5 ( V_51 L_5 ,
V_52 ) ;
V_61 = - V_86 ;
...
if ( V_116 -> V_14 == 0 ) {
V_116 -> V_14 = V_115 -> V_115 ;
if ( V_116 -> V_14 == 0 ||
V_116 -> V_14 > V_118 ) {
V_61 = - V_48 ;
goto V_117;
}
V_116 -> V_13 = F_81 ( sizeof( struct V_12 ) *
V_115 -> V_115 ,
V_85 ) ;
if ( ! V_116 -> V_13 ) {
V_61 = - V_86 ;
...
V_116 -> V_34 =
F_81 ( sizeof( struct V_12 ) * V_115 -> V_115 ,
V_85 ) ;
if ( ! V_116 -> V_34 ) {
F_29 ( V_116 -> V_13 ) ;
V_61 = - V_86 ;
...
for ( V_10 = 0 ; V_10 < V_116 -> V_14 ; V_10 ++ )
if ( V_116 -> V_34 [ V_10 ] . V_15 == 0 ||
V_116 -> V_34 [ V_10 ] . V_120 == V_120 -> V_120 ) {
V_116 -> V_34 [ V_10 ] . V_120 = V_120 -> V_120 ;
V_116 -> V_34 [ V_10 ] . V_15 = V_120 -> V_40 ;
V_116 -> V_13 [ V_10 ] . V_120 = V_120 -> V_120 ;
break;
}
if ( V_10 == V_116 -> V_14 ) {
V_61 = - V_122 ;
...
long F_98 ( struct V_29 * V_29 , unsigned V_123 ,
unsigned long V_124 )
{
void T_5 * V_125 = ( void T_5 * ) V_124 ;
int V_61 ;
switch ( V_123 ) {
case V_126 : {
struct V_94 V_8 ;
V_61 = - V_127 ;
if ( F_99 ( & V_8 , V_125 , sizeof V_8 ) )
goto V_74;
V_61 = F_79 ( V_29 , & V_8 ) ;
if ( V_61 )
goto V_74;
...
struct V_64 V_69 ;
V_61 = - V_127 ;
if ( F_99 ( & V_69 , V_125 , sizeof V_69 ) )
goto V_74;
V_61 = F_66 ( V_29 , & V_69 ) ;
if ( V_61 )
goto V_74;
...
case V_133 : {
struct V_134 V_135 ;
struct V_134 T_5 * V_136 ;
struct V_137 * V_138 ;
V_61 = - V_127 ;
if ( F_99 ( & V_135 , V_125 , sizeof( V_135 ) ) )
goto V_74;
V_61 = - V_48 ;
...
goto V_74;
V_61 = - V_86 ;
V_138 = F_101 ( V_135 . V_139 * sizeof( * V_138 ) ) ;
if ( ! V_138 )
goto V_74;
V_61 = - V_127 ;
V_136 = V_125 ;
if ( F_99 ( V_138 , V_136 -> V_138 ,
V_135 . V_139 * sizeof( * V_138 ) ) )
goto V_141;
V_61 = F_102 ( V_29 , V_138 , V_135 . V_139 ,
V_135 . V_27 ) ;
V_141:
F_103 ( V_138 ) ;
break;
...
struct V_114 V_115 ;
V_61 = - V_127 ;
if ( F_99 ( & V_115 , V_125 , sizeof V_115 ) )
goto V_74;
V_61 = F_95 ( V_29 , & V_115 ) ;
if ( V_61 )
goto V_74;
break;
}
...
struct V_119 V_120 ;
V_61 = - V_127 ;
if ( F_99 ( & V_120 , V_125 , sizeof V_120 ) )
goto V_74;
V_61 = F_96 ( V_29 , & V_120 ) ;
if ( V_61 )
goto V_74;
break;
}
