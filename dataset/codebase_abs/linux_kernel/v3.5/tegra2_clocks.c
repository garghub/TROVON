...
V_13 -> div = V_98 + 2 ;
V_13 -> V_55 = 2 ;
} else if ( V_13 -> V_56 & V_115 ) {
T_1 V_116 = V_22 & V_117 ;
V_13 -> div = V_116 + 1 ;
V_13 -> V_55 = 1 ;
} else {
V_13 -> div = 1 ;
...
V_13 -> V_29 = V_30 ;
if ( ! V_13 -> V_45 . V_118 . V_119 )
return;
if ( ! ( F_3 ( V_120 + F_61 ( V_13 ) ) &
F_62 ( V_13 ) ) )
V_13 -> V_29 = V_53 ;
if ( ! ( V_13 -> V_56 & V_121 ) )
if ( F_3 ( V_122 + F_61 ( V_13 ) ) &
F_62 ( V_13 ) )
V_13 -> V_29 = V_53 ;
}
...
return 0 ;
F_33 ( & V_57 , V_56 ) ;
V_123 = V_124 [ V_13 -> V_45 . V_118 . V_119 ] ++ ;
if ( V_123 > 1 )
goto V_48;
F_2 ( F_62 ( V_13 ) ,
V_125 + F_64 ( V_13 ) ) ;
if ( ! ( V_13 -> V_56 & V_121 ) && ! ( V_13 -> V_56 & V_126 ) )
F_2 ( F_62 ( V_13 ) ,
V_50 + F_64 ( V_13 ) ) ;
if ( V_13 -> V_56 & V_127 ) {
V_22 = F_3 ( V_13 -> V_27 ) ;
...
F_33 ( & V_57 , V_56 ) ;
if ( V_13 -> V_43 )
V_124 [ V_13 -> V_45 . V_118 . V_119 ] -- ;
if ( V_124 [ V_13 -> V_45 . V_118 . V_119 ] == 0 )
F_2 ( F_62 ( V_13 ) ,
V_128 + F_64 ( V_13 ) ) ;
F_34 ( & V_57 , V_56 ) ;
}
...
{
unsigned long V_129 = assert ? V_49 : V_50 ;
F_11 ( L_12 , V_6 ,
assert ? L_7 : L_8 , V_13 -> V_21 ) ;
F_15 ( ! V_13 -> V_45 . V_118 . V_119 ) ;
if ( ! ( V_13 -> V_56 & V_121 ) )
F_2 ( F_62 ( V_13 ) ,
V_129 + F_64 ( V_13 ) ) ;
}
...
void F_70 ( struct V_12 * V_13 , int V_131 )
{
T_1 V_27 ;
unsigned long V_56 ;
F_33 ( & V_13 -> V_132 , V_56 ) ;
V_131 = F_71 ( V_131 , 0 , 15 ) ;
V_27 = F_3 ( V_13 -> V_27 ) ;
V_27 &= ~ V_133 ;
V_27 |= V_134 ;
V_27 |= V_131 << V_135 ;
F_2 ( V_27 , V_13 -> V_27 ) ;
F_34 ( & V_13 -> V_132 , V_56 ) ;
}
...
static int F_88 ( struct V_12 * V_138 )
{
struct V_12 * V_13 ;
unsigned long V_8 = V_138 -> V_139 ;
F_89 (c, &bus->shared_bus_list, u.shared_bus_user.node)
if ( V_13 -> V_45 . V_140 . V_141 )
V_8 = F_90 ( V_13 -> V_45 . V_140 . V_8 , V_8 ) ;
if ( V_8 == F_73 ( V_138 ) )
return 0 ;
return F_91 ( V_138 , V_8 ) ;
}
static void F_92 ( struct V_12 * V_13 )
{
unsigned long V_56 ;
V_13 -> V_95 = V_13 -> V_40 -> V_95 ;
V_13 -> V_45 . V_140 . V_8 = V_13 -> V_40 -> V_95 ;
V_13 -> V_29 = V_53 ;
V_13 -> V_142 = true ;
F_33 ( & V_13 -> V_40 -> V_132 , V_56 ) ;
F_93 ( & V_13 -> V_45 . V_140 . V_143 ,
& V_13 -> V_40 -> V_144 ) ;
F_34 ( & V_13 -> V_40 -> V_132 , V_56 ) ;
}
...
int V_44 ;
long V_145 = V_8 ;
V_145 = F_95 ( V_13 -> V_40 , V_145 ) ;
if ( V_145 < 0 )
return V_145 ;
F_33 ( & V_13 -> V_40 -> V_132 , V_56 ) ;
V_13 -> V_45 . V_140 . V_8 = V_145 ;
V_44 = F_88 ( V_13 -> V_40 ) ;
F_34 ( & V_13 -> V_40 -> V_132 , V_56 ) ;
return V_44 ;
}
...
struct V_150 * V_151 ;
for ( V_58 = 0 ; V_148 -> V_21 ; V_58 ++ , V_26 ++ , V_148 ++ ) {
V_26 -> V_38 = F_101 ( V_148 -> V_21 ) ;
if ( ! V_26 -> V_38 )
F_4 ( L_15 , V_6 ,
V_148 -> V_21 ) ;
V_26 -> V_39 = V_148 -> V_39 ;
}
V_151 = V_152 ;
for ( V_58 = 0 ; V_58 < F_102 ( V_152 ) ; V_58 ++ , V_151 ++ ) {
F_103 ( V_151 -> V_12 ) ;
F_104 ( V_151 ) ;
}
}
...
F_103 ( V_13 ) ;
F_106 ( & V_13 -> V_144 ) ;
if ( ! V_13 -> V_151 . V_153 && ! V_13 -> V_151 . V_154 )
V_13 -> V_151 . V_154 = V_13 -> V_21 ;
V_13 -> V_151 . V_12 = V_13 ;
F_104 ( & V_13 -> V_151 ) ;
}
void T_3 F_107 ( void )
{
int V_58 ;
struct V_12 * V_13 ;
for ( V_58 = 0 ; V_58 < F_102 ( V_155 ) ; V_58 ++ )
F_105 ( V_155 [ V_58 ] ) ;
for ( V_58 = 0 ; V_58 < F_102 ( V_156 ) ; V_58 ++ )
F_105 ( & V_156 [ V_58 ] ) ;
for ( V_58 = 0 ; V_58 < F_102 ( V_157 ) ; V_58 ++ ) {
V_13 = F_101 ( V_157 [ V_58 ] . V_21 ) ;
if ( ! V_13 ) {
F_4 ( L_16 , V_6 ,
V_157 [ V_58 ] . V_21 ) ;
continue;
}
V_157 [ V_58 ] . V_151 . V_12 = V_13 ;
F_104 ( & V_157 [ V_58 ] . V_151 ) ;
}
F_100 () ;
}
void F_108 ( void )
{
unsigned long V_158 , V_58 ;
T_1 * V_159 = V_160 ;
* V_159 ++ = F_3 ( V_15 ) & V_161 ;
* V_159 ++ = F_3 ( V_162 . V_27 + V_71 ) ;
* V_159 ++ = F_3 ( V_162 . V_27 + F_51 ( & V_162 ) ) ;
* V_159 ++ = F_3 ( V_163 . V_27 + V_71 ) ;
* V_159 ++ = F_3 ( V_163 . V_27 + F_51 ( & V_163 ) ) ;
* V_159 ++ = F_3 ( V_164 . V_27 + V_71 ) ;
* V_159 ++ = F_3 ( V_164 . V_27 + F_51 ( & V_164 ) ) ;
* V_159 ++ = F_3 ( V_165 . V_27 + V_71 ) ;
* V_159 ++ = F_3 ( V_165 . V_27 + F_51 ( & V_165 ) ) ;
* V_159 ++ = F_3 ( V_166 . V_27 + V_71 ) ;
* V_159 ++ = F_3 ( V_166 . V_27 + F_51 ( & V_166 ) ) ;
* V_159 ++ = F_3 ( V_167 . V_27 ) ;
* V_159 ++ = F_3 ( V_168 . V_27 ) ;
* V_159 ++ = F_3 ( V_169 . V_27 ) ;
* V_159 ++ = F_3 ( V_170 . V_27 ) ;
* V_159 ++ = F_3 ( V_170 . V_27 + V_41 ) ;
* V_159 ++ = F_3 ( V_171 . V_27 ) ;
* V_159 ++ = F_3 ( V_171 . V_27 + V_41 ) ;
* V_159 ++ = F_3 ( V_172 . V_27 ) ;
* V_159 ++ = F_3 ( V_173 . V_27 ) ;
for ( V_158 = V_174 ; V_158 <= V_175 ;
V_158 += 4 ) {
if ( V_158 == V_176 )
continue;
* V_159 ++ = F_3 ( V_158 ) ;
...
V_158 = V_122 ;
for ( V_58 = 0 ; V_58 < V_177 ; V_58 ++ , V_158 += 4 )
* V_159 ++ = F_3 ( V_158 ) ;
V_158 = V_120 ;
for ( V_58 = 0 ; V_58 < V_178 ; V_58 ++ , V_158 += 4 )
* V_159 ++ = F_3 ( V_158 ) ;
* V_159 ++ = F_3 ( V_179 ) ;
* V_159 ++ = F_3 ( V_180 ) ;
F_15 ( V_159 - V_160 != F_102 ( V_160 ) ) ;
}
void F_109 ( void )
{
unsigned long V_158 , V_58 ;
const T_1 * V_159 = V_160 ;
T_1 V_22 ;
V_22 = F_3 ( V_15 ) & ~ V_161 ;
V_22 |= * V_159 ++ ;
F_2 ( V_22 , V_15 ) ;
F_2 ( * V_159 ++ , V_162 . V_27 + V_71 ) ;
F_2 ( * V_159 ++ , V_162 . V_27 + F_51 ( & V_162 ) ) ;
F_2 ( * V_159 ++ , V_163 . V_27 + V_71 ) ;
F_2 ( * V_159 ++ , V_163 . V_27 + F_51 ( & V_163 ) ) ;
F_2 ( * V_159 ++ , V_164 . V_27 + V_71 ) ;
F_2 ( * V_159 ++ , V_164 . V_27 + F_51 ( & V_164 ) ) ;
F_2 ( * V_159 ++ , V_165 . V_27 + V_71 ) ;
F_2 ( * V_159 ++ , V_165 . V_27 + F_51 ( & V_165 ) ) ;
F_2 ( * V_159 ++ , V_166 . V_27 + V_71 ) ;
F_2 ( * V_159 ++ , V_166 . V_27 + F_51 ( & V_166 ) ) ;
F_45 ( 1000 ) ;
F_2 ( * V_159 ++ , V_167 . V_27 ) ;
F_2 ( * V_159 ++ , V_168 . V_27 ) ;
F_2 ( * V_159 ++ , V_169 . V_27 ) ;
F_2 ( * V_159 ++ , V_170 . V_27 ) ;
F_2 ( * V_159 ++ , V_170 . V_27 + V_41 ) ;
F_2 ( * V_159 ++ , V_171 . V_27 ) ;
F_2 ( * V_159 ++ , V_171 . V_27 + V_41 ) ;
F_2 ( * V_159 ++ , V_172 . V_27 ) ;
F_2 ( * V_159 ++ , V_173 . V_27 ) ;
F_2 ( 0xbffffff9ul , V_120 ) ;
F_2 ( 0xfefffff7ul , V_120 + 4 ) ;
F_2 ( 0x77f01bfful , V_120 + 8 ) ;
F_110 () ;
for ( V_158 = V_174 ; V_158 <= V_175 ;
V_158 += 4 ) {
if ( V_158 == V_176 )
