...
static int F_20 ( struct V_64 * V_65 , struct V_21 * V_66 ,
T_1 V_67 , enum V_68 V_69 )
{
struct V_39 * V_41 = V_65 -> V_41 ;
struct V_12 * V_43 = V_41 -> V_70 ;
struct V_17 * V_71 ;
struct V_21 * V_72 ;
struct V_73 V_74 ;
T_1 V_75 ;
...
T_1 V_78 ;
T_2 V_79 ;
V_79 = V_65 -> V_80 * V_41 -> V_81 -> V_82 . V_83 ;
V_75 = F_21 ( V_79 , V_27 ) ;
V_77 = V_79 ;
V_76 = V_65 -> V_84 ;
V_71 = F_19 ( V_43 , V_77 ) ;
if ( ! V_71 )
return - V_34 ;
V_72 = & V_71 -> V_18 [ V_77 - V_71 -> V_35 ] ;
F_4 ( L_23 ,
V_43 -> V_26 ,
V_69 == V_85 ? L_24 : L_25 ,
V_65 -> V_80 , V_76 , V_77 , V_75 ) ;
V_78 = V_27 - V_75 ;
F_22 ( & V_74 , V_66 , V_67 ,
V_69 == V_85 ?
V_86 : V_87 ) ;
...
void * V_89 ;
F_23 ( & V_74 ) ;
V_88 = F_24 ( ( T_1 ) V_74 . V_37 , V_78 ) ;
V_74 . V_90 = V_88 ;
V_89 = F_25 ( V_72 ) + V_75 ;
if ( V_69 == V_85 )
memcpy ( V_74 . V_91 , V_89 , V_88 ) ;
else
memcpy ( V_89 , V_74 . V_91 , V_88 ) ;
V_76 -= V_88 ;
if ( ! V_76 )
continue;
V_78 -= V_88 ;
...
T_3 V_93 )
{
struct V_12 * V_12 = V_41 -> V_94 ;
char * V_95 , * V_96 , * V_97 ;
T_4 args [ V_98 ] ;
int V_47 = 0 , V_99 , V_100 ;
V_97 = F_29 ( V_19 , V_5 ) ;
if ( ! V_97 )
return - V_6 ;
V_95 = V_97 ;
while ( ( V_96 = F_30 ( & V_97 , L_26 ) ) != NULL ) {
if ( ! * V_96 )
continue;
V_100 = F_31 ( V_96 , V_101 , args ) ;
switch ( V_100 ) {
case V_102 :
F_32 ( args , & V_99 ) ;
V_12 -> V_33 = V_99 ;
...
{
struct V_12 * V_12 = V_41 -> V_94 ;
T_3 V_106 = sprintf ( V_105 , L_30 ,
V_12 -> V_26 ) ;
V_106 += sprintf ( V_105 + V_106 , L_31
L_32 , V_12 -> V_33 ,
V_27 , V_12 -> V_24 ) ;
return V_106 ;
}
...
{
struct V_12 * V_12 = V_43 -> V_70 ;
unsigned long long V_109 = ( ( V_12 -> V_33 * V_27 ) /
V_43 -> V_81 -> V_82 . V_83 ) - 1 ;
return V_109 ;
}
int T_6 F_38 ( void )
{
