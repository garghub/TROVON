...
static T_1 F_2 ( struct V_1 * V_2 , struct V_11 * V_12 ,
T_1 V_13 , unsigned int * V_14 ,
unsigned int * V_15 )
{
struct V_16 * V_17 = & V_12 -> V_18 [ V_13 ] ;
struct V_19 * V_20 ;
struct V_21 * V_22 ;
struct V_23 * V_24 = V_17 -> V_24 ;
T_1 V_25 = F_3 ( V_17 -> V_26 ) , V_27 ;
int V_28 ;
F_4 ( & V_24 -> V_29 ) ;
F_5 ( V_30 , L_1 ,
V_12 -> V_31 , V_13 , V_17 , V_24 ) ;
V_20 = & V_12 -> V_32 [ V_25 ] . V_33 ;
F_6 ( & V_2 -> V_34 -> V_35 , F_7 ( V_20 ) ,
F_8 ( V_20 ) , V_36 ) ;
V_28 = F_9 ( V_20 -> V_28 ) - 1 ;
#ifdef F_10
if ( ( V_28 - 1 ) > ( V_37 + 2 ) ) {
F_11 ( L_2 ) ;
F_12 () ;
...
while ( V_28 > 0 ) {
V_22 = & V_12 -> V_32 [ V_25 ] . V_40 ;
F_14 ( & V_2 -> V_34 -> V_35 , F_7 ( V_22 ) ,
F_8 ( V_22 ) , V_36 ) ;
if ( -- V_28 )
V_25 = F_3 ( F_13 ( V_25 ) ) ;
}
...
int F_18 ( struct V_1 * V_2 , struct V_11 * V_12 )
{
struct V_42 * V_43 ;
T_1 V_44 , V_45 , V_46 = V_12 -> V_47 ;
unsigned int V_14 = 0 , V_15 = 0 ;
#ifdef F_10
if ( F_19 ( V_2 -> V_48 ) )
return - 1 ;
#endif
V_43 = F_20 ( V_2 -> V_35 , V_12 -> V_31 ) ;
V_44 = F_9 ( * V_12 -> V_49 ) ;
V_45 = V_12 -> V_50 ;
while ( V_45 != V_44 ) {
T_1 V_51 ;
...
F_5 ( V_30 ,
L_3 ,
V_12 -> V_31 , V_44 , V_45 , V_51 ) ;
V_46 = F_2 ( V_2 , V_12 , V_51 ,
& V_14 , & V_15 ) ;
V_45 ++ ;
}
F_21 ( V_43 , V_14 , V_15 ) ;
...
if ( ( F_23 ( V_43 ) ) &&
( V_2 -> V_52 == V_53 ) &&
( F_26 ( V_2 , V_12 ) >= V_37 + 4 ) )
F_27 ( V_43 ) ;
F_28 ( V_43 ) ;
}
return 0 ;
}
static inline void F_29 ( struct V_5 * V_7 ,
T_1 V_13 )
{
T_1 V_54 = V_7 -> V_55 ;
if ( F_30 ( V_13 , V_54 ) > 0 )
...
F_32 ( V_7 -> V_63 ,
F_33 ( F_9 ( V_58 -> V_64 . V_65 [ V_62 ] ) ) ) ;
F_5 ( V_66 , L_4 ,
V_56 - 1 , F_9 ( V_58 -> V_64 . V_65 [ V_56 - 1 ] ) ) ;
F_4 ( ( void * ) ( V_7 -> V_63 ) ) ;
F_29 ( V_7 ,
F_9 ( V_58 -> V_64 . V_65 [ V_56 - 1 ] ) ) ;
V_54 = F_33 ( V_7 -> V_55 ) ;
V_59 = V_54 >> V_67 ;
V_60 = F_33 ( V_7 -> V_68 ) >> V_67 ;
if ( V_59 + 1 != V_60 )
V_59 ++ ;
for ( V_62 = V_60 ; V_62 != V_59 ; V_62 = F_34 ( V_62 ) ) {
if ( F_16 ( V_7 -> V_63 [ V_62 ] ) )
break;
V_7 -> V_63 [ V_62 ] = V_69 ;
V_61 += V_70 ;
}
...
static T_2 F_36 ( const struct V_1 * V_2 ,
const struct V_71 * V_58 )
{
if ( ( V_2 -> V_35 -> V_72 & V_73 ) &&
( V_58 -> V_74 & V_75 ) )
return F_37 ( V_58 -> V_76 ) ;
return 0 ;
}
static void F_38 ( struct V_5 * V_7 , T_1 V_77 ,
T_1 V_78 , T_1 V_79 ,
struct V_71 * V_58 )
{
struct V_1 * V_2 = V_7 -> V_2 ;
struct V_80 * V_81 = & V_7 -> V_82 [ V_78 ] ;
struct V_80 * V_83 = & V_7 -> V_82 [ V_79 ] ;
struct V_84 * V_85 = & V_7 -> V_86 [ V_79 ] ;
T_3 V_87 ;
struct V_88 * V_89 = & V_7 -> V_89 [ V_77 ] ;
struct V_80 * V_90 = & V_89 -> V_90 ;
if ( V_89 -> V_91 != V_92 )
F_11 ( L_6 , V_77 ) ;
V_87 = F_39 ( & V_2 -> V_34 -> V_35 ,
V_90 -> V_93 + V_94 ,
V_7 -> V_95 , V_96 ) ;
if ( F_19 ( F_40 ( & V_2 -> V_34 -> V_35 , V_87 ) ) ) {
F_41 ( V_7 , V_78 , V_79 ) ;
V_89 -> V_91 = V_97 ;
return;
}
V_83 -> V_93 = V_90 -> V_93 ;
F_42 ( V_83 , V_87 , V_87 ) ;
V_85 -> V_98 = F_43 ( F_44 ( V_87 ) ) ;
V_85 -> V_99 = F_43 ( F_45 ( V_87 ) ) ;
* V_90 = * V_81 ;
V_89 -> V_100 =
F_9 ( V_58 -> V_101 . V_38 ) ;
V_89 -> V_102 = F_9 ( V_58 -> V_102 ) ;
V_89 -> V_91 = V_103 ;
V_89 -> V_104 = F_9 ( V_58 -> V_104 ) ;
V_89 -> V_105 = V_58 -> V_105 ;
V_89 -> V_106 = F_36 ( V_2 , V_58 ) ;
if ( V_7 -> V_107 == V_108 ) {
T_1 V_109 = F_9 ( V_58 -> V_110 ) ;
V_89 -> V_111 =
V_112 * V_113 / V_109 * V_109 ;
V_89 -> V_109 = V_109 ;
}
#ifdef F_10
V_7 -> V_114 |= ( 1 << V_77 ) ;
#ifdef F_46
F_5 (NETIF_MSG_RX_STATUS, L_7 ,
#else
...
DP(NETIF_MSG_IFUP, L_64, loaded_fw, my_fw);
if (loaded_fw != my_fw) {
if (is_err)
BNX2X_ERR(L_65,
loaded_fw, my_fw);
...
DP(NETIF_MSG_IFUP, L_67, bp->num_queues);
for_each_queue(bp, i)
bnx2x_bz_fp(bp, i);
...
BNX2X_DEV_INFO(L_69, bp->fw_seq);
bp->fw_drv_pulse_wr_seq =
(SHMEM_RD(bp, func_mb[BP_FW_MB_IDX(bp)].drv_pulse_mb) &
DRV_PULSE_SEQ_MASK);
BNX2X_DEV_INFO(L_70, bp->fw_drv_pulse_wr_seq);
...
bp->port.pmf = 0;
DP(NETIF_MSG_IFUP, L_75, bp->port.pmf);
...
break;
default:
dev_err(&bp->pdev->dev, L_87, state);
return -EINVAL;
}
return 0;
}
...
DP(NETIF_MSG_TX_QUEUED, L_105, tx_data_bd);
first_bd->nbd = cpu_to_le16(nbd);
bd_prod = TX_BD(NEXT_TX_IDX(bd_prod));
...
pbd_e2->parsing_data);
DP(NETIF_MSG_TX_QUEUED, L_108, nbd, bd_prod);
