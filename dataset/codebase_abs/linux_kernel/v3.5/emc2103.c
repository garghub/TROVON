...
return - V_65 ;
V_21 = F_39 ( sizeof( struct V_20 ) , V_74 ) ;
if ( ! V_21 )
return - V_75 ;
F_40 ( V_2 , V_21 ) ;
F_41 ( & V_21 -> V_27 ) ;
...
V_5 = F_42 ( & V_2 -> V_6 . V_80 , & V_81 ) ;
if ( V_5 )
goto V_78;
if ( V_21 -> V_33 >= 3 ) {
V_5 = F_42 ( & V_2 -> V_6 . V_80 ,
& V_82 ) ;
if ( V_5 )
goto V_83;
}
...
V_21 -> V_86 = F_43 ( & V_2 -> V_6 ) ;
if ( F_44 ( V_21 -> V_86 ) ) {
V_5 = F_45 ( V_21 -> V_86 ) ;
goto V_87;
}
F_46 ( & V_2 -> V_6 , L_3 ,
F_47 ( V_21 -> V_86 ) , V_2 -> V_88 ) ;
return 0 ;
V_87:
if ( V_21 -> V_33 == 4 )
F_48 ( & V_2 -> V_6 . V_80 , & V_84 ) ;
V_85:
if ( V_21 -> V_33 >= 3 )
F_48 ( & V_2 -> V_6 . V_80 , & V_82 ) ;
V_83:
F_48 ( & V_2 -> V_6 . V_80 , & V_81 ) ;
V_78:
F_49 ( V_21 ) ;
return V_5 ;
}
...
static int
F_52 ( struct V_1 * V_89 , struct V_90 * V_91 )
{
struct V_92 * V_72 = V_89 -> V_72 ;
int V_93 , V_94 ;
if ( ! F_38 ( V_72 , V_73 ) )
return - V_95 ;
V_93 = F_2 ( V_89 , V_96 ) ;
...
return - V_95 ;
V_94 = F_2 ( V_89 , V_76 ) ;
if ( ( V_94 != 0x24 ) && ( V_94 != 0x26 ) )
return - V_95 ;
F_53 ( V_91 -> type , L_4 , V_97 ) ;
return 0 ;
}
