...
static int F_30 ( struct V_45 * V_46 , struct V_11 * V_1 ,
struct V_47 * V_48 , T_2 V_14 )
{
struct V_1 * V_2 = V_1 -> V_2 ;
struct V_18 * V_19 = F_5 ( V_2 ) -> V_19 ;
struct V_37 * V_38 ;
...
if ( V_1 -> V_27 != V_28 )
return - V_51 ;
V_38 = F_31 ( V_19 , V_2 , V_48 -> V_52 , V_14 , & V_20 ) ;
if ( V_38 == NULL )
return V_20 ;
V_20 = F_32 ( F_33 ( V_38 , V_14 ) , V_48 -> V_53 , V_14 ) ;
if ( V_20 < 0 ) {
F_34 ( V_38 ) ;
return V_20 ;
}
...
static int F_36 ( struct V_45 * V_46 , struct V_11 * V_1 ,
struct V_47 * V_48 , T_2 V_14 , int V_15 )
{
int V_54 = V_15 & V_55 ;
struct V_1 * V_2 = V_1 -> V_2 ;
struct V_37 * V_38 ;
...
V_20 = F_38 ( V_38 , 0 , V_48 -> V_53 , V_56 ) ;
F_39 ( V_2 , V_38 ) ;
return V_20 ? : V_56 ;
}
...
static int F_45 ( struct V_60 * V_60 , struct V_11 * V_1 ,
...
return - V_63 ;
V_1 -> V_64 = & V_65 ;
V_2 = F_46 ( V_60 , V_66 , V_67 , V_61 -> V_68 ) ;
if ( ! V_2 )
return - V_69 ;
F_47 ( V_1 , V_2 ) ;
V_2 -> V_70 = V_61 -> V_71 ;
