...
{
unsigned long V_150 = F_64 ( V_62 ) ;
struct V_1 * V_2 = F_46 ( V_114 -> V_115 ) ;
struct V_3 * V_4 = V_2 -> V_4 ;
struct V_5 * V_6 = & V_4 -> V_7 [ V_2 -> type ] ;
int V_151 = F_8 ( V_103 , & V_6 -> V_11 ) ;
unsigned V_142 = 0 ;
...
void F_66 ( struct V_1 * V_2 , int V_156 )
{
struct V_3 * V_4 = V_2 -> V_4 ;
struct V_5 * V_6 = & V_4 -> V_7 [ V_2 -> type ] ;
F_65 ( L_25 , V_6 -> V_22 ) ;
...
static void F_67 ( struct V_1 * V_2 , int V_57 , V_52 V_56 )
{
struct V_3 * V_4 = V_2 -> V_4 ;
struct V_5 * V_6 = & V_4 -> V_7 [ V_2 -> type ] ;
F_65 ( L_25 , V_6 -> V_22 ) ;
...
V_4 -> V_158 = V_159 ;
V_4 -> V_118 = 0 ;
F_13 ( V_162 , & V_4 -> V_111 ) ;
F_7 ( V_6 ) ;
}
int F_70 ( struct V_113 * V_114 )
{
struct V_163 * V_12 = V_114 -> V_115 ;
...
F_71 ( V_114 ) ) {
F_72 ( V_4 ) ;
F_13 ( V_164 , & V_4 -> V_111 ) ;
F_16 ( V_4 , V_165 , V_166 , V_4 -> V_167 ) ;
F_73 ( V_4 ) ;
if ( V_4 -> V_168 & V_169 ) {
F_74 ( V_4 , V_169 , V_170 , V_171 ,
V_172 , 0 ) ;
}
if ( F_38 ( & V_4 -> V_100 ) > 0 ) {
F_43 ( V_4 , V_173 , 1 ,
...
if ( V_6 -> type >= V_17 ) {
struct V_5 * V_176 = & V_4 -> V_7 [ V_108 ] ;
F_67 ( V_2 , V_177 | V_178 , 0 ) ;
