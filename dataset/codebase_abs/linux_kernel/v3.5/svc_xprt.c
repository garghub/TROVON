...
int F_74 ( struct V_76 * V_77 , long V_131 )
{
struct V_18 * V_19 = NULL ;
struct V_32 * V_33 = V_77 -> V_132 ;
struct V_86 * V_87 = V_77 -> V_133 ;
int V_14 , V_119 ;
int V_134 ;
struct V_135 * V_136 ;
F_75 ( V_137 , V_138 ) ;
...
V_136 = & V_77 -> V_149 ;
V_136 -> V_113 [ 0 ] . V_150 = F_83 ( V_77 -> V_142 [ 0 ] ) ;
V_136 -> V_113 [ 0 ] . V_114 = V_140 ;
V_136 -> V_134 = V_77 -> V_142 + 1 ;
V_136 -> V_118 = 0 ;
V_136 -> V_117 = ( V_134 - 2 ) * V_140 ;
V_136 -> V_14 = ( V_134 - 1 ) * V_140 ;
V_136 -> V_151 [ 0 ] . V_114 = 0 ;
F_84 () ;
F_85 () ;
if ( F_79 () || F_80 () )
return - V_148 ;
...
F_86 ( & V_77 -> V_108 , & V_137 ) ;
F_39 ( & V_87 -> V_96 ) ;
V_139 = F_81 ( V_131 ) ;
F_84 () ;
F_37 ( & V_87 -> V_96 ) ;
F_87 ( & V_77 -> V_108 , & V_137 ) ;
if ( ! V_139 )
V_87 -> V_99 . V_155 ++ ;
V_19 = V_77 -> V_103 ;
if ( ! V_19 ) {
...
if ( V_158 ) {
F_89 ( V_158 -> V_23 -> V_24 ) ;
F_72 ( V_19 -> V_35 ) ;
F_37 ( & V_33 -> V_73 ) ;
F_24 ( V_72 , & V_158 -> V_26 ) ;
F_38 ( & V_158 -> V_36 , & V_33 -> V_128 ) ;
V_33 -> V_127 ++ ;
...
V_77 -> V_103 -> V_29 -> V_115 ( V_77 ) ;
V_173 = & V_77 -> V_112 ;
V_173 -> V_14 = V_173 -> V_113 [ 0 ] . V_114 +
V_173 -> V_117 +
V_173 -> V_151 [ 0 ] . V_114 ;
F_96 ( & V_19 -> V_40 ) ;
...
F_91 ( & V_33 -> V_160 , V_163 + V_164 * V_154 ) ;
}
...
struct V_188 * V_189 ;
if ( V_77 -> V_149 . V_117 || ! V_77 -> V_200 )
return NULL ;
if ( V_77 -> V_116 ) {
V_189 = V_77 -> V_116 ;
V_77 -> V_116 = NULL ;
...
V_201 = V_77 -> V_149 . V_14 - V_77 -> V_149 . V_113 [ 0 ] . V_114 ;
memcpy ( V_189 -> args , V_77 -> V_149 . V_113 [ 0 ] . V_150 - V_201 ,
V_189 -> V_208 << 2 ) ;
}
F_57 ( V_77 -> V_103 ) ;
...
{
struct V_188 * V_189 = V_77 -> V_116 ;
V_77 -> V_149 . V_113 [ 0 ] . V_150 = V_189 -> args + ( V_189 -> V_209 >> 2 ) ;
V_77 -> V_149 . V_113 [ 0 ] . V_114 = ( V_189 -> V_208 << 2 ) - V_189 -> V_209 ;
V_77 -> V_149 . V_117 = 0 ;
...
static struct V_188 * F_92 ( struct V_18 * V_19 )
{
...
if ( ! V_225 )
return V_227 ;
return ( V_225 > V_33 -> V_120 ? NULL : & V_33 -> V_121 [ V_225 - 1 ] ) ;
}
...
unsigned int V_225 = ( V_87 - & V_33 -> V_121 [ 0 ] ) ;
if ( V_225 < V_33 -> V_120 - 1 )
V_87 = & V_33 -> V_121 [ V_225 + 1 ] ;
else
V_87 = NULL ;
}
++ * V_218 ;
