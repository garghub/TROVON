...
return - V_154 ;
V_16 -> V_155 &= ~ V_156 ;
memcpy ( V_16 -> V_146 , V_36 , V_16 -> V_157 ) ;
F_31 ( V_2 , V_36 ) ;
return 0 ;
}
static void F_93 ( struct V_158 * V_159 )
{
struct V_1 * V_2 =
F_94 ( V_159 , struct V_1 , V_149 ) ;
...
static int T_8 F_97 ( struct V_160 * V_161 )
{
int V_95 = - V_101 ;
struct V_162 * V_163 ;
struct V_15 * V_16 ;
struct V_1 * V_2 ;
struct V_164 * V_165 = V_161 -> V_58 . V_166 ;
T_1 V_167 ;
unsigned V_35 ;
V_163 = F_98 ( V_161 , V_168 , 0 ) ;
if ( ! F_99 ( V_163 -> V_169 , F_100 ( V_163 ) , V_148 ) )
goto V_170;
V_16 = F_101 ( sizeof( struct V_1 ) ) ;
if ( ! V_16 )
goto V_171;
F_102 ( V_16 , & V_161 -> V_58 ) ;
V_2 = F_36 ( V_16 ) ;
V_2 -> V_16 = V_16 ;
F_103 ( & V_2 -> V_149 , F_93 ) ;
V_2 -> V_3 = F_104 ( V_163 -> V_169 , F_100 ( V_163 ) ) ;
V_2 -> V_11 = V_163 -> V_44 ;
if ( ! V_2 -> V_3 )
goto V_172;
V_2 -> V_126 = F_105 ( V_161 , 0 ) ;
if ( V_2 -> V_126 < 0 ) {
V_95 = V_2 -> V_126 ;
goto V_173;
}
V_2 -> V_58 = ( V_161 -> V_58 . V_174 ) ? V_161 -> V_58 . V_174 : & V_161 -> V_58 ;
if ( ! ( V_2 -> V_11 & V_12 ) && V_165 &&
( V_165 -> V_175 != - 1 ) &&
( V_165 -> V_176 != - 1 ) ) {
V_2 -> V_93 . V_143 = V_165 -> V_176 ;
V_2 -> V_51 . V_143 = V_165 -> V_175 ;
} else {
V_2 -> V_93 . V_143 = - 1 ;
V_2 -> V_51 . V_143 = - 1 ;
}
...
V_35 = V_16 -> V_157 ;
if ( V_165 ) {
for ( V_35 = 0 ; V_35 < V_16 -> V_157 ; V_35 ++ )
if ( V_165 -> V_181 [ V_35 ] != 0 )
break;
if ( V_35 < V_16 -> V_157 )
memcpy ( V_16 -> V_146 , V_165 -> V_181 ,
V_16 -> V_157 ) ;
}
if ( V_35 == V_16 -> V_157 ) {
F_30 ( V_2 , V_16 -> V_146 ) ;
...
V_167 = F_14 ( V_2 , 32 , V_33 ) ;
strcpy ( V_16 -> V_182 , L_16 ) ;
V_95 = F_108 ( V_16 ) ;
if ( V_95 )
goto V_183;
F_109 ( V_161 , V_16 ) ;
F_110 ( L_17 ,
( V_167 >> 8 ) & 0xff , ( V_167 >> 4 ) & 0xf , ( V_167 >> 1 ) & 0x7 ) ;
return 0 ;
V_183:
V_173:
F_111 ( V_2 -> V_3 ) ;
...
F_112 ( V_16 ) ;
V_171:
F_113 ( V_163 -> V_169 , F_100 ( V_163 ) ) ;
V_170:
return V_95 ;
}
static int T_9 F_114 ( struct V_160 * V_161 )
{
struct V_15 * V_16 = F_115 ( V_161 ) ;
struct V_1 * V_2 = F_36 ( V_16 ) ;
struct V_162 * V_163 = F_98 ( V_161 , V_168 , 0 ) ;
F_116 ( V_16 ) ;
F_75 ( & V_2 -> V_130 ) ;
F_111 ( V_2 -> V_3 ) ;
F_112 ( V_16 ) ;
