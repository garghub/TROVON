...
void T_1 F_47 ( T_2 V_219 ) {}
static inline void F_48 ( unsigned V_228 )
{
if ( V_228 & V_229 )
F_12 ( V_230 , 1 ) ;
if ( V_228 & V_231 )
...
static inline void F_49 ( unsigned V_228 )
{
if ( V_228 & V_229 )
F_12 ( V_240 , 1 ) ;
if ( V_228 & V_231 )
...
void T_1 F_50 ( unsigned V_246 , unsigned V_228 )
{
struct V_247 * V_248 ;
switch ( V_246 ) {
case V_249 :
...
static inline void F_52 ( unsigned V_228 )
{
F_12 ( V_255 , 1 ) ;
F_12 ( V_256 , 0 ) ;
if ( V_228 & V_257 )
...
static inline void F_53 ( unsigned V_228 )
{
F_12 ( V_260 , 1 ) ;
F_12 ( V_261 , 0 ) ;
if ( V_228 & V_257 )
...
static inline void F_54 ( unsigned V_228 )
{
F_12 ( V_264 , 1 ) ;
F_12 ( V_265 , 0 ) ;
if ( V_228 & V_257 )
...
static inline void F_55 ( unsigned V_228 )
{
F_12 ( V_144 , 1 ) ;
F_12 ( V_145 , 0 ) ;
if ( V_228 & V_257 )
...
void T_1 F_56 ( unsigned V_246 , unsigned V_268 , unsigned V_228 )
{
struct V_247 * V_248 ;
struct V_269 * V_15 ;
switch ( V_246 ) {
