...
if ( ! V_109 )
return 1 ;
V_59 = F_56 ( V_106 , L_36 ) ;
if ( V_59 < 0 ) {
F_26 ( & V_102 -> V_17 , L_37 , V_59 ) ;
return V_59 ;
}
V_102 -> V_111 = V_59 ;
if ( F_57 ( V_106 , L_38 , NULL ) )
V_13 -> V_82 = 1 ;
if ( F_57 ( V_106 , L_39 , NULL ) )
V_13 -> V_51 = 1 ;
...
const struct V_115 * V_111 = F_59 ( V_102 ) ;
* V_104 = V_111 -> V_116 ;
if ( V_113 ) {
...
static int F_60 ( struct V_101 * V_17 )
{
...
int V_59 , V_120 ;
V_13 = F_61 ( sizeof( struct V_12 ) , V_121 ) ;
if ( ! V_13 ) {
V_59 = - V_122 ;
goto V_123;
}
V_59 = F_54 ( V_17 , V_13 , & V_117 ) ;
if ( V_59 > 0 )
V_59 = F_58 ( V_17 , V_13 , & V_117 ) ;
if ( V_59 < 0 )
goto V_124;
V_119 = F_62 ( V_17 , V_125 , 0 ) ;
V_120 = F_63 ( V_17 , 0 ) ;
if ( V_119 == NULL || V_120 < 0 ) {
V_59 = - V_126 ;
goto V_124;
}
if ( ! F_64 ( V_119 -> V_127 , F_65 ( V_119 ) , V_119 -> V_128 ) ) {
V_59 = - V_122 ;
goto V_124;
}
V_13 -> V_16 . V_129 = V_130 ;
V_13 -> V_16 . V_80 = 5 ;
F_66 ( & V_13 -> V_75 ) ;
F_67 ( & V_13 -> V_76 ) ;
V_13 -> V_16 . V_131 = V_17 -> V_111 ;
snprintf ( V_13 -> V_16 . V_128 , sizeof( V_13 -> V_16 . V_128 ) , L_40 ,
V_13 -> V_16 . V_131 ) ;
...
V_13 -> V_133 = F_71 ( V_119 -> V_127 , F_65 ( V_119 ) ) ;
if ( ! V_13 -> V_133 ) {
V_59 = - V_134 ;
goto V_135;
}
V_13 -> V_136 = V_13 -> V_133 + V_137 [ V_117 ] . V_138 ;
V_13 -> V_139 = V_13 -> V_133 + V_137 [ V_117 ] . V_140 ;
V_13 -> V_141 = V_13 -> V_133 + V_137 [ V_117 ] . V_29 ;
V_13 -> V_142 = V_13 -> V_133 + V_137 [ V_117 ] . V_57 ;
if ( V_117 != V_143 )
V_13 -> V_48 = V_13 -> V_133 + V_137 [ V_117 ] . V_144 ;
V_13 -> V_145 = V_119 -> V_127 ;
V_13 -> V_146 = F_65 ( V_119 ) ;
V_13 -> V_120 = V_120 ;
V_13 -> V_49 = V_147 ;
if ( V_113 ) {
#ifdef F_30
...
V_59 = F_73 ( V_120 , F_43 , V_152 ,
V_13 -> V_16 . V_128 , V_13 ) ;
if ( V_59 )
goto V_153;
}
F_27 ( V_13 ) ;
...
F_83 ( V_13 ) ;
V_123:
F_84 ( V_119 -> V_127 , F_65 ( V_119 ) ) ;
return V_59 ;
}
static int T_3 F_85 ( struct V_101 * V_17 )
{
struct V_12 * V_13 = F_86 ( V_17 ) ;
F_77 ( V_17 , NULL ) ;
F_87 ( & V_13 -> V_16 ) ;
if ( ! V_13 -> V_82 )
F_79 ( V_13 -> V_120 , V_13 ) ;
F_80 ( V_13 -> V_132 ) ;
F_82 ( V_13 -> V_132 ) ;
F_81 ( V_13 -> V_133 ) ;
