...
{
F_4 ( L_10 ,
( unsigned int ) V_23 -> V_36 , F_27 ( V_23 ) ,
V_23 -> V_39 ) ;
...
V_23 -> V_24 = 0 ;
V_34 = F_99 ( V_23 -> V_32 , V_49 -> V_26 . V_43 ,
V_49 -> V_26 . V_27 ,
V_23 -> V_25 -> V_26 . V_43 ,
V_23 -> V_25 -> V_44 ) ;
if ( V_34 < 0 ) {
...
if ( V_23 -> V_24 )
return 0 ;
V_34 = F_100 ( V_23 -> V_32 , V_23 -> V_25 -> V_26 . V_43 ,
V_23 -> V_25 -> V_44 ) ;
if ( V_34 <= 0 )
return V_34 ;
F_14 ( V_23 , V_34 ) ;
...
static void F_102 ( struct V_86 * V_30 , struct V_48 * V_49 )
{
struct V_22 * V_23 = V_30 -> V_89 ;
int type = F_103 ( V_49 -> V_28 . type ) ;
if ( ! V_23 )
return;
switch ( type ) {
case V_148 :
...
static struct V_48 * F_106 ( struct V_86 * V_30 ,
struct V_87 * V_28 ,
int * V_88 )
{
struct V_22 * V_23 = V_30 -> V_89 ;
int type = F_103 ( V_28 -> type ) ;
...
static void F_107 ( struct V_86 * V_30 )
{
struct V_22 * V_23 = V_30 -> V_89 ;
if ( ! V_23 )
return;
