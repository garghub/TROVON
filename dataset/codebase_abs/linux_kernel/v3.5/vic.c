...
V_30 -> V_28 = V_28 ;
V_22 ++ ;
V_30 -> V_42 = F_17 ( V_40 , F_18 ( V_32 ) , V_28 , 0 ,
& V_43 , V_30 ) ;
}
static void F_19 ( struct V_44 * V_27 )
{
void T_1 * V_1 = F_20 ( V_27 ) ;
unsigned int V_28 = V_27 -> V_29 ;
F_2 ( 1 << V_28 , V_1 + V_17 ) ;
F_2 ( 1 << V_28 , V_1 + V_20 ) ;
}
static void F_21 ( struct V_44 * V_27 )
{
void T_1 * V_1 = F_20 ( V_27 ) ;
unsigned int V_28 = V_27 -> V_29 ;
F_2 ( 1 << V_28 , V_1 + V_17 ) ;
...
static struct V_7 * F_23 ( unsigned int V_28 )
{
...
static int F_24 ( struct V_44 * V_27 , unsigned int V_46 )
{
struct V_7 * V_30 = F_23 ( V_27 -> V_28 ) ;
...
static void T_2 F_25 ( void T_1 * V_1 )
{
F_2 ( 0 , V_1 + V_12 ) ;
F_2 ( 0 , V_1 + V_16 ) ;
F_2 ( ~ 0 , V_1 + V_17 ) ;
...
static void T_2 F_27 ( void T_1 * V_1 , unsigned int V_53 ,
...
void T_2 F_28 ( void T_1 * V_1 , unsigned int V_53 ,
T_4 V_54 , T_4 V_38 ,
struct V_39 * V_40 )
{
unsigned int V_2 ;
...
void T_2 F_29 ( void T_1 * V_1 , unsigned int V_53 ,
T_4 V_54 , T_4 V_38 )
{
F_28 ( V_1 , V_53 , V_54 , V_38 , NULL ) ;
}
int T_2 F_30 ( struct V_39 * V_40 , struct V_39 * V_65 )
{
void T_1 * V_66 ;
int V_67 ;
if ( F_31 ( V_65 , L_6 ) )
...
if ( F_33 ( ! V_66 ) )
return - V_68 ;
V_67 = F_34 ( - 1 , 0 , 32 , F_35 () ) ;
if ( F_33 ( V_67 < 0 ) )
goto V_69;
F_28 ( V_66 , V_67 , ~ 0 , ~ 0 , V_40 ) ;
return 0 ;
V_69:
F_36 ( V_66 ) ;
return - V_68 ;
}
static int F_37 ( struct V_7 * V_8 , struct V_70 * V_66 )
{
T_4 V_71 , V_28 ;
int V_72 = 0 ;
while ( ( V_71 = F_38 ( V_8 -> V_1 + V_73 ) ) ) {
V_28 = F_39 ( V_71 ) - 1 ;
F_40 ( F_41 ( V_8 -> V_42 , V_28 ) , V_66 ) ;
V_72 = 1 ;
}
return V_72 ;
}
T_5 void T_6 F_42 ( struct V_70 * V_66 )
{
int V_2 , V_72 ;
do {
for ( V_2 = 0 , V_72 = 0 ; V_2 < V_22 ; ++ V_2 )
V_72 |= F_37 ( & V_23 [ V_2 ] , V_66 ) ;
} while ( V_72 );
}
