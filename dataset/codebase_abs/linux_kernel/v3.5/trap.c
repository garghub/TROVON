...
void F_35 ( int V_64 , struct V_44 * V_45 )
{
struct V_48 * V_49 = F_20 ( V_45 ) ;
...
if ( ! V_4 && ( V_1 >= V_66 ) && ( V_1 < V_67 ) ) {
F_40 () ;
return 0 ;
}
else if ( V_8 -> V_7 == NULL ) {
F_41 ( F_42 ( V_45 , struct V_68 , V_45 ) ) ;
F_43 ( L_4 ) ;
}
...
V_8 -> V_62 . V_70 = ( void * ) V_1 ;
F_45 ( V_65 , 1 ) ;
}
else if ( V_8 -> V_62 . V_70 != NULL )
F_43 ( L_5 ) ;
...
void F_48 ( int V_64 , struct V_44 * V_45 )
{
if ( ! F_36 ( V_45 ) ) {
if ( V_64 == V_71 )
F_23 ( V_74 L_7
...
F_49 ( V_64 , V_45 ) ;
V_8 -> V_62 . V_63 . V_48 = * F_20 ( V_45 ) ;
F_50 ( V_64 , V_8 ) ;
}
void F_51 ( int V_64 , struct V_44 * V_45 )
{
if ( V_8 -> V_62 . V_69 != NULL )
F_45 ( V_8 -> V_62 . V_69 , 1 ) ;
else F_48 ( V_64 , V_45 ) ;
}
void F_52 ( int V_64 , struct V_44 * V_45 )
{
F_53 ( V_75 , V_45 ) ;
}
void F_54 ( void )
