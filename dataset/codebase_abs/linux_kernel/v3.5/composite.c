...
F_42 ( & V_39 -> V_50 ) ;
V_39 -> V_62 = 0 ;
memset ( V_39 -> V_64 , 0 , sizeof( V_39 -> V_64 ) ) ;
V_57 = V_51 ( V_39 ) ;
if ( V_57 < 0 ) {
while ( ! F_43 ( & V_39 -> V_50 ) ) {
struct V_7 * V_8 ;
V_8 = F_44 ( & V_39 -> V_50 ,
struct V_7 , V_49 ) ;
F_11 ( & V_8 -> V_49 ) ;
...
struct V_7 * V_8 = V_39 -> V_64 [ V_145 ] ;
if ( ! V_8 )
continue;
F_9 ( V_43 , L_17 ,
V_145 , V_8 -> V_44 , V_8 ) ;
...
V_48:
if ( V_57 )
F_9 ( V_43 , L_18 , V_39 -> V_45 ,
V_39 -> V_76 , V_57 ) ;
return V_57 ;
}
static void F_46 ( struct V_55 * V_43 ,
struct V_38 * V_39 )
{
while ( ! F_43 ( & V_39 -> V_50 ) ) {
struct V_7 * V_8 ;
...
F_11 ( & V_8 -> V_49 ) ;
if ( V_8 -> V_144 ) {
F_9 ( V_43 , L_10 , V_8 -> V_44 , V_8 ) ;
V_8 -> V_144 ( V_39 , V_8 ) ;
}
}
F_11 ( & V_39 -> V_49 ) ;
if ( V_39 -> V_144 ) {
F_9 ( V_43 , L_19 , V_39 -> V_45 , V_39 ) ;
V_39 -> V_144 ( V_39 ) ;
}
}
void F_47 ( struct V_55 * V_43 ,
struct V_38 * V_39 )
{
unsigned long V_56 ;
F_13 ( & V_43 -> V_58 , V_56 ) ;
...
static void F_48 ( struct V_146 * * V_147 , T_2 * V_67 )
{
...
continue;
V_41 = F_50 ( V_148 , V_61 , V_67 ) ;
if ( V_41 > 0 )
return V_41 ;
}
return - V_42 ;
}
static int F_51 ( struct V_55 * V_43 ,
...
V_159 ;
else if ( V_43 -> V_160 == V_61 )
V_151 = V_161 ? : V_154 -> V_161 ;
else if ( V_43 -> V_162 == V_61 )
...
return F_50 ( & V_155 , 0xff , V_67 ) ;
}
if ( V_154 -> V_155 ) {
V_72 = F_49 ( V_154 -> V_155 , V_67 , V_149 , V_61 ) ;
if ( V_72 > 0 )
return V_72 ;
}
F_24 (c, &cdev->configs, list) {
if ( V_69 -> V_155 ) {
V_72 = F_49 ( V_69 -> V_155 , V_67 , V_149 , V_61 ) ;
if ( V_72 > 0 )
return V_72 ;
}
F_24 (f, &c->functions, list) {
if ( ! V_8 -> V_155 )
continue;
V_72 = F_49 ( V_8 -> V_155 , V_67 , V_149 , V_61 ) ;
if ( V_72 > 0 )
return V_72 ;
}
}
...
int F_53 ( struct V_55 * V_43 , struct V_164 * V_151 )
{
int V_70 = V_43 -> V_165 ;
...
int F_55 ( struct V_55 * V_69 , unsigned V_166 )
{
unsigned V_70 = V_69 -> V_165 ;
if ( F_54 ( V_166 > 254 || ( unsigned ) V_70 + V_166 > 254 ) )
return - V_65 ;
V_69 -> V_165 += V_166 ;
return V_70 + 1 ;
}
static void F_56 ( struct V_9 * V_137 , struct V_167 * V_86 )
{
if ( V_86 -> V_57 || V_86 -> V_168 != V_86 -> V_169 )
F_9 ( (struct V_55 * ) V_137 -> V_170 ,
L_20 ,
V_86 -> V_57 , V_86 -> V_168 , V_86 -> V_169 ) ;
}
static int
F_57 ( struct V_5 * V_60 , const struct V_131 * V_132 )
{
struct V_55 * V_43 = F_58 ( V_60 ) ;
struct V_167 * V_86 = V_43 -> V_86 ;
int V_41 = - V_171 ;
int V_57 = 0 ;
T_3 V_172 = F_29 ( V_132 -> V_173 ) ;
T_1 V_174 = V_172 & 0xFF ;
T_3 V_82 = F_29 ( V_132 -> V_175 ) ;
T_3 V_176 = F_29 ( V_132 -> V_177 ) ;
struct V_7 * V_8 = NULL ;
T_1 V_178 ;
V_86 -> V_179 = 0 ;
V_86 -> V_180 = F_56 ;
V_86 -> V_169 = 0 ;
V_60 -> V_127 -> V_170 = V_43 ;
switch ( V_132 -> V_181 ) {
case V_182 :
...
V_41 = F_59 ( V_176 , ( T_3 ) sizeof V_43 -> V_29 ) ;
...
V_41 = F_26 ( V_43 , V_82 ) ;
if ( V_41 >= 0 )
V_41 = F_59 ( V_176 , ( T_3 ) V_41 ) ;
break;
case V_153 :
V_41 = F_51 ( V_43 , V_86 -> V_67 ,
V_172 , V_82 & 0xff ) ;
if ( V_41 >= 0 )
V_41 = F_59 ( V_176 , ( T_3 ) V_41 ) ;
break;
...
* ( T_1 * ) V_86 -> V_67 = 0 ;
V_41 = F_59 ( V_176 , ( T_3 ) 1 ) ;
break;
case V_192 :
if ( V_132 -> V_183 != V_193 )
goto V_185;
if ( ! V_43 -> V_39 || V_174 >= V_63 )
break;
V_8 = V_43 -> V_39 -> V_64 [ V_174 ] ;
if ( ! V_8 )
break;
if ( V_82 && ! V_8 -> V_46 )
break;
V_41 = V_8 -> V_46 ( V_8 , V_172 , V_82 ) ;
if ( V_41 == V_139 ) {
F_9 ( V_43 ,
L_7 ,
V_140 , V_174 , V_8 -> V_44 ) ;
V_43 -> V_141 ++ ;
F_9 ( V_43 , L_8 ,
V_43 -> V_141 ) ;
}
...
if ( ! V_8 )
break;
V_41 = V_8 -> V_195 ? V_8 -> V_195 ( V_8 , V_172 ) : 0 ;
if ( V_41 < 0 )
break;
* ( ( T_1 * ) V_86 -> V_67 ) = V_41 ;
V_41 = F_59 ( V_176 , ( T_3 ) 1 ) ;
...
if ( V_8 && V_8 -> V_205 )
V_41 = V_8 -> V_205 ( V_8 , V_132 ) ;
else {
struct V_38 * V_69 ;
V_69 = V_43 -> V_39 ;
if ( V_69 && V_69 -> V_205 )
V_41 = V_69 -> V_205 ( V_69 , V_132 ) ;
}
goto V_48;
}
if ( V_41 >= 0 && V_41 != V_139 ) {
V_86 -> V_169 = V_41 ;
V_86 -> V_179 = V_41 < V_176 ;
V_41 = F_64 ( V_60 -> V_127 , V_86 , V_206 ) ;
if ( V_41 < 0 ) {
F_9 ( V_43 , L_26 , V_41 ) ;
V_86 -> V_57 = 0 ;
F_56 ( V_60 -> V_127 , V_86 ) ;
}
} else if ( V_41 == V_139 && V_176 != 0 ) {
F_65 ( V_43 ,
L_27 ,
V_140 ) ;
}
...
struct V_55 * V_43 = F_58 ( V_60 ) ;
return sprintf ( V_67 , L_28 , V_43 -> V_212 ) ;
}
static void
...
struct V_55 * V_43 = F_58 ( V_60 ) ;
F_18 ( V_43 -> V_39 ) ;
while ( ! F_43 ( & V_43 -> V_143 ) ) {
struct V_38 * V_69 ;
V_69 = F_44 ( & V_43 -> V_143 ,
struct V_38 , V_49 ) ;
F_46 ( V_43 , V_69 ) ;
}
if ( V_154 -> V_144 )
...
static T_1 F_74 ( struct V_55 * V_43 , T_1 * V_29 )
{
if ( ! * V_29 ) {
int V_214 = F_52 ( V_43 ) ;
if ( F_54 ( V_214 < 0 ) )
...
F_73 ( V_60 , V_43 ) ;
F_42 ( & V_43 -> V_143 ) ;
V_43 -> V_86 = F_79 ( V_60 -> V_127 , V_216 ) ;
if ( ! V_43 -> V_86 )
goto V_217;
V_43 -> V_86 -> V_67 = F_80 ( V_73 , V_216 ) ;
if ( ! V_43 -> V_86 -> V_67 )
goto V_217;
V_43 -> V_86 -> V_180 = F_56 ;
V_60 -> V_127 -> V_170 = V_43 ;
V_43 -> V_218 = V_73 ;
V_43 -> V_219 = V_154 ;
if ( V_80 <= V_220 )
...
if ( V_57 < 0 )
goto V_217;
V_43 -> V_29 = * V_154 -> V_209 ;
if ( V_221 )
V_43 -> V_29 . V_221 = F_25 ( V_221 ) ;
else
V_221 = F_29 ( V_43 -> V_29 . V_221 ) ;
if ( V_222 )
V_43 -> V_29 . V_222 = F_25 ( V_222 ) ;
else
V_222 = F_29 ( V_43 -> V_29 . V_222 ) ;
if ( V_223 )
V_43 -> V_29 . V_223 = F_25 ( V_223 ) ;
else
V_223 = F_29 ( V_43 -> V_29 . V_223 ) ;
if ( V_158 || ! V_43 -> V_29 . V_158 ) {
...
V_60 -> V_44 ) ;
V_43 -> V_157 =
F_74 ( V_43 , & V_43 -> V_29 . V_158 ) ;
}
if ( V_161 || ( ! V_43 -> V_29 . V_161 && V_154 -> V_161 ) )
V_43 -> V_160 =
F_74 ( V_43 , & V_43 -> V_29 . V_161 ) ;
if ( V_163 ||
( ! V_43 -> V_29 . V_163 && V_154 -> V_163 ) )
V_43 -> V_162 =
F_74 ( V_43 , & V_43 -> V_29 . V_163 ) ;
if ( V_154 -> V_226 && ! V_43 -> V_29 . V_163 )
F_75 ( V_43 , L_31 ) ;
V_57 = F_84 ( & V_60 -> V_209 , & V_213 ) ;
if ( V_57 )
goto V_217;
F_37 ( V_43 , L_32 , V_154 -> V_44 ) ;
return 0 ;
V_217:
F_69 ( V_60 ) ;
return V_57 ;
...
{
if ( ! V_219 || ! V_219 -> V_209 || ! V_51 || V_154 )
return - V_42 ;
if ( ! V_219 -> V_44 )
V_219 -> V_44 = L_35 ;
if ( ! V_219 -> V_161 )
V_219 -> V_161 = V_219 -> V_44 ;
...
F_13 ( & V_43 -> V_58 , V_56 ) ;
if ( V_43 -> V_141 == 0 ) {
F_65 ( V_43 , L_37 , V_140 ) ;
} else if ( -- V_43 -> V_141 == 0 ) {
F_9 ( V_43 , L_38 , V_140 ) ;
V_86 -> V_169 = 0 ;
V_41 = F_64 ( V_43 -> V_60 -> V_127 , V_86 , V_206 ) ;
if ( V_41 < 0 ) {
F_9 ( V_43 , L_26 , V_41 ) ;
V_86 -> V_57 = 0 ;
F_56 ( V_43 -> V_60 -> V_127 , V_86 ) ;
}
}
F_15 ( & V_43 -> V_58 , V_56 ) ;
}
