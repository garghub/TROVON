...
V_16 = F_8 ( V_20 / V_10 , V_16 ) ;
for ( V_12 = 1 ; V_12 <= V_16 ; V_12 ++ ) {
V_3 = F_9 ( F_10 ( V_2 -> V_18 ) ,
F_11 ( V_10 , V_12 ) ) ;
V_15 = V_3 / V_12 ;
...
struct V_18 * V_18 ;
struct V_29 V_30 ;
div = F_18 ( sizeof( struct V_4 ) , V_31 ) ;
if ( ! div ) {
F_19 ( L_1 , V_32 ) ;
return F_20 ( - V_33 ) ;
}
