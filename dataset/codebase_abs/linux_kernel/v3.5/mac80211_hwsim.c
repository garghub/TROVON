...
V_154 -> V_119 . V_299 = F_90 ( V_36 -> V_298 [ V_300 ] ) ;
if ( ! ( V_93 & V_116 ) &&
( V_93 & V_301 ) ) {
if ( V_14 -> V_112 >= 16 ) {
...
V_28 -> V_84 -> V_337 = & V_338 ;
V_28 -> V_84 -> V_339 = 1 ;
if ( V_325 ) {
V_28 -> V_84 -> V_340 = 255 ;
V_28 -> V_84 -> V_341 = V_307 ;
}
V_28 -> V_342 = 1 ;
V_28 -> V_343 = 4 ;
V_28 -> V_84 -> V_344 =
...
V_352 |
V_353 ;
V_28 -> V_84 -> V_34 |= V_354 |
V_355 ;
V_28 -> V_356 = sizeof( struct V_3 ) ;
V_28 -> V_357 = sizeof( struct V_10 ) ;
memcpy ( V_19 -> V_358 , V_359 ,
sizeof( V_359 ) ) ;
memcpy ( V_19 -> V_360 , V_361 ,
sizeof( V_361 ) ) ;
memcpy ( V_19 -> V_120 , V_362 , sizeof( V_362 ) ) ;
for ( V_133 = V_363 ; V_133 < V_364 ; V_133 ++ ) {
struct V_365 * V_366 = & V_19 -> V_367 [ V_133 ] ;
switch ( V_133 ) {
case V_363 :
V_366 -> V_259 = V_19 -> V_358 ;
V_366 -> V_258 =
F_148 ( V_359 ) ;
V_366 -> V_368 = V_19 -> V_120 ;
V_366 -> V_369 = F_148 ( V_362 ) ;
break;
case V_370 :
V_366 -> V_259 = V_19 -> V_360 ;
V_366 -> V_258 =
F_148 ( V_361 ) ;
V_366 -> V_368 = V_19 -> V_120 + 4 ;
V_366 -> V_369 = F_148 ( V_362 ) - 4 ;
break;
default:
break;
}
V_366 -> V_371 . V_372 = true ;
V_366 -> V_371 . V_373 = V_374 |
V_375 |
V_376 |
V_377 ;
V_366 -> V_371 . V_378 = 0x3 ;
V_366 -> V_371 . V_379 = 0x6 ;
memset ( & V_366 -> V_371 . V_380 , 0 ,
sizeof( V_366 -> V_371 . V_380 ) ) ;
V_366 -> V_371 . V_380 . V_381 [ 0 ] = 0xff ;
V_366 -> V_371 . V_380 . V_381 [ 1 ] = 0xff ;
V_366 -> V_371 . V_380 . V_382 = V_383 ;
V_28 -> V_84 -> V_367 [ V_133 ] = V_366 ;
}
V_19 -> V_149 = 1 ;
F_163 ( & V_19 -> V_263 ) ;
V_28 -> V_384 = 4 ;
...
( unsigned long ) V_28 ) ;
F_171 ( & V_19 -> V_407 , & V_330 ) ;
}
V_39 = F_172 ( 0 , L_46 , F_125 ) ;
if ( V_39 == NULL )
goto V_332;
F_173 () ;
V_230 = F_174 ( V_39 , V_39 -> V_408 ) ;
if ( V_230 < 0 )
goto V_409;
V_230 = F_175 ( V_39 ) ;
if ( V_230 < 0 )
