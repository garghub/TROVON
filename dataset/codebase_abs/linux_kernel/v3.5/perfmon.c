...
V_219 -> V_224 ,
V_219 -> V_225 ) ) ;
V_88 = ( ( V_220 != V_219 -> V_222 )
|| ( V_220 != V_219 -> V_223 )
|| ( V_220 != V_219 -> V_220 )
|| ( V_221 != V_219 -> V_224 )
|| ( V_221 != V_219 -> V_225 )
|| ( V_221 != V_219 -> V_221 ) ) && ! F_169 ( V_226 ) ;
F_170 () ;
return V_88 ;
}
static int
F_171 ( struct V_1 * V_2 , T_15 * V_227 )
{
int V_44 ;
V_44 = V_227 -> V_44 ;
if ( V_44 & V_51 ) {
...
if ( V_84 -> V_231 ) V_229 = F_173 ( V_91 ) ;
...
static int
F_182 ( T_1 * V_27 , T_16 V_242 , struct V_1 * * V_2 )
{
...
F_184 ( & V_244 ) ;
V_243 = F_185 ( V_242 ) ;
if ( V_243 ) F_186 ( V_243 ) ;
F_187 ( & V_244 ) ;
if ( V_243 == NULL ) return - V_245 ;
}
V_88 = F_179 ( V_27 , V_243 ) ;
if ( V_88 == 0 ) {
* V_2 = V_243 ;
} else if ( V_243 != V_3 ) {
F_1 ( V_243 ) ;
...
static int
F_188 ( T_1 * V_27 , void * V_91 , int V_246 , struct V_86 * V_87 )
{
T_15 * V_237 = ( T_15 * ) V_91 ;
struct V_125 * V_126 ;
struct V_174 V_174 ;
...
V_88 = F_172 ( V_3 , V_126 , V_27 , V_44 , 0 , V_237 ) ;
if ( V_88 )
goto V_248;
}
F_40 ( ( L_92 ,
...
static void
F_194 ( T_1 * V_27 , unsigned long * V_261 , int V_252 )
{
...
V_27 -> V_28 [ V_24 ] . V_20 = V_20 = F_193 ( V_27 -> V_28 + V_24 , V_252 ) ;
...
static void
F_195 ( T_1 * V_27 , unsigned long * V_261 , int V_252 )
{
unsigned long V_59 = V_261 [ 0 ] ;
unsigned long V_262 = 0UL ;
unsigned long V_20 ;
...
if ( V_27 -> V_46 == V_68 ) {
F_194 ( V_27 , V_261 , V_252 ) ;
return;
}
V_59 >>= V_63 ;
for( V_24 = V_63 ; V_59 ; V_24 ++ , V_59 >>= 1 ) {
if ( ( V_59 & 0x1UL ) == 0UL ) continue;
V_20 = F_193 ( V_27 -> V_28 + V_24 , V_252 ) ;
V_262 |= V_27 -> V_28 [ V_24 ] . V_263 [ 0 ] ;
F_59 ( ( L_93 , V_252 ? L_94 : L_95 , V_24 , V_20 ) ) ;
F_37 ( V_27 , V_24 , V_20 ) ;
}
...
static int
F_196 ( T_1 * V_27 , void * V_91 , int V_246 , struct V_86 * V_87 )
{
struct V_1 * V_2 ;
...
if ( V_273 && V_264 != F_177 ( V_267 ) && V_66 ^ V_265 ) {
F_40 ( ( L_100 ,
V_267 ,
V_265 ,
V_66 ) ) ;
...
F_200 ( V_27 , V_29 -> V_283 [ V_267 ] . V_295 [ 0 ] ) ;
if ( V_273 ) F_201 ( V_27 , 1UL << V_267 ) ;
...
return 0 ;
error:
F_199 ( V_237 -> V_268 , V_297 ) ;
return V_88 ;
}
static int
F_202 ( T_1 * V_27 , void * V_91 , int V_246 , struct V_86 * V_87 )
{
struct V_1 * V_2 ;
T_18 * V_237 = ( T_18 * ) V_91 ;
...
F_200 ( V_27 , F_205 ( V_267 ) ) ;
F_200 ( V_27 , F_206 ( V_267 ) ) ;
if ( V_274 && V_155 == V_68 ) {
...
static int
F_208 ( T_1 * V_27 , void * V_91 , int V_246 , struct V_86 * V_87 )
{
struct V_1 * V_2 ;
...
V_267 = V_237 -> V_278 ;
V_268 = V_237 -> V_268 ;
if ( F_203 ( ! F_204 ( V_267 ) ) ) goto error;
if ( F_203 ( ! F_209 ( V_27 , V_267 ) ) ) goto error;
...
int
F_210 ( struct V_1 * V_2 , void * V_237 , unsigned int V_311 , struct V_86 * V_87 )
{
T_1 * V_27 ;
...
return F_196 ( V_27 , V_237 , V_311 , V_87 ) ;
}
int
F_211 ( struct V_1 * V_2 , void * V_237 , unsigned int V_311 , struct V_86 * V_87 )
{
T_1 * V_27 ;
if ( V_237 == NULL ) return - V_106 ;
V_27 = F_121 () ;
if ( V_27 == NULL ) return - V_106 ;
if ( V_2 != V_3 && V_27 -> V_50 == 0 ) return - V_108 ;
return F_208 ( V_27 , V_237 , V_311 , V_87 ) ;
}
int
...
static int
F_214 ( T_1 * V_27 , void * V_91 , int V_246 , struct V_86 * V_87 )
{
struct V_1 * V_2 ;
T_4 * V_84 ;
T_5 V_317 ;
...
static int
F_219 ( T_1 * V_27 , void * V_91 , int V_246 , struct V_86 * V_87 )
{
...
static int
F_220 ( int V_330 , T_1 * V_27 , void * V_91 , int V_246 , struct V_86 * V_87 )
{
...
F_199 ( V_237 -> V_346 , V_297 ) ;
return V_88 ;
}
static int
F_223 ( T_1 * V_27 , void * V_91 , int V_246 , struct V_86 * V_87 )
{
return F_220 ( V_337 , V_27 , V_91 , V_246 , V_87 ) ;
}
static int
F_224 ( T_1 * V_27 , void * V_91 , int V_246 , struct V_86 * V_87 )
{
return F_220 ( V_339 , V_27 , V_91 , V_246 , V_87 ) ;
}
int
F_225 ( struct V_1 * V_2 , void * V_237 , unsigned int V_311 , struct V_86 * V_87 )
{
T_1 * V_27 ;
if ( V_237 == NULL ) return - V_106 ;
V_27 = F_121 () ;
if ( V_27 == NULL ) return - V_106 ;
if ( V_2 != V_3 && V_27 -> V_50 == 0 ) return - V_108 ;
return F_223 ( V_27 , V_237 , V_311 , V_87 ) ;
}
int
F_226 ( struct V_1 * V_2 , void * V_237 , unsigned int V_311 , struct V_86 * V_87 )
{
T_1 * V_27 ;
if ( V_237 == NULL ) return - V_106 ;
V_27 = F_121 () ;
if ( V_27 == NULL ) return - V_106 ;
if ( V_2 != V_3 && V_27 -> V_50 == 0 ) return - V_108 ;
return F_224 ( V_27 , V_237 , V_311 , V_87 ) ;
}
static int
...
static int
F_233 ( T_1 * V_27 , void * V_91 , int V_246 , struct V_86 * V_87 )
{
T_18 * V_237 = ( T_18 * ) V_91 ;
unsigned int V_267 ;
int V_24 ;
...
for ( V_24 = 0 ; V_24 < V_246 ; V_24 ++ , V_237 ++ ) {
V_267 = V_237 -> V_278 ;
if ( ! F_176 ( V_267 ) ) goto V_299;
V_237 -> V_279 = F_177 ( V_267 ) ;
F_199 ( V_237 -> V_268 , 0 ) ;
...
V_88 = F_182 ( V_27 , V_237 -> V_361 , & V_2 ) ;
if ( V_88 ) {
...
V_312 -> V_313 , V_27 ) ) ;
V_88 = - V_108 ;
V_355 = F_238 ( V_362 , & V_312 -> V_313 , NULL , V_27 , sizeof( T_1 * ) ) ;
if ( V_355 != NULL ) {
...
F_53 ( V_27 , - 1 ) ;
V_27 -> V_352 = 0UL ;
F_230 ( V_87 ) -> V_351 = F_230 ( V_87 ) -> V_350 = 0 ;
}
V_88 = 0 ;
V_363:
...
T_27 long
F_249 ( int V_144 , int V_143 , void T_8 * V_91 , int V_246 )
{
...
int (* F_250)( T_1 * V_27 , void * V_91 , int V_246 , struct V_86 * V_87 );
int (* F_251)( void * V_91 , T_9 * V_236 );
#define F_252 4096
if ( F_203 ( V_29 == NULL ) ) return - V_381 ;
if ( F_203 ( V_143 < 0 || V_143 >= V_382 ) ) {
F_40 ( ( L_159 , V_143 ) ) ;
return - V_106 ;
}
F_250 = V_383 [ V_143 ] . V_384 ;
V_377 = V_383 [ V_143 ] . V_385 ;
V_375 = V_383 [ V_143 ] . V_386 ;
F_251 = V_383 [ V_143 ] . V_387 ;
...
V_375 ,
V_246 ) ) ;
if ( F_203 ( ( V_377 == V_388 && V_246 <= 0 ) || ( V_377 > 0 && V_377 != V_246 ) ) )
return - V_106 ;
V_389:
V_236 = V_376 + V_375 * V_246 ;
if ( F_203 ( V_236 > F_252 ) ) {
F_63 ( V_67 L_161 , F_60 ( V_3 ) , V_236 ) ;
return - V_390 ;
}
if ( F_198 ( V_246 && V_374 == NULL ) ) {
V_374 = F_254 ( F_252 , V_45 ) ;
if ( V_374 == NULL ) return - V_179 ;
}
V_88 = - V_138 ;
if ( V_236 && F_255 ( V_374 , V_91 , V_236 ) ) {
F_40 ( ( L_162 , V_236 , V_91 ) ) ;
goto V_391;
}
if ( V_378 == 0 && F_251 ) {
V_88 = (* F_251)( V_374 , & V_376 ) ;
if ( V_88 ) goto V_391;
V_378 = 1 ;
F_40 ( ( L_163 , V_236 , V_376 ) ) ;
if ( F_198 ( V_376 ) ) goto V_389;
}
if ( F_203 ( ( V_380 & V_392 ) == 0 ) ) goto V_393;
V_88 = - V_147 ;
V_125 = F_256 ( V_144 ) ;
if ( F_203 ( V_125 == NULL ) ) {
F_40 ( ( L_164 , V_144 ) ) ;
...
V_393:
V_88 = (* F_250)( V_27 , V_374 , V_246 , F_119 ( V_3 ) ) ;
V_379 = 1 ;
V_136:
if ( F_198 ( V_27 ) ) {
F_40 ( ( L_167 ) ) ;
...
if ( V_379 && F_257 ( V_143 ) && F_110 ( V_91 , V_374 , V_375 * V_246 ) ) V_88 = - V_138 ;
V_391:
if ( V_125 )
F_258 ( V_125 ) ;
F_56 ( V_374 ) ;
...
static void
F_259 ( T_1 * V_27 , unsigned long V_261 , struct V_86 * V_87 )
{
T_4 * V_84 = V_27 -> V_166 ;
T_5 V_317 ;
int V_155 ;
...
F_266 ( & V_27 -> V_146 , V_399 , V_400 ) ;
return 0 ;
}
static int
F_267 ( T_1 * V_27 , unsigned long V_401 )
{
T_2 * V_37 = NULL ;
if ( V_27 -> V_52 == 0 ) {
V_37 = F_39 ( V_27 ) ;
...
int V_417 = 0 ;
if ( F_203 ( V_27 -> V_46 == V_163 ) ) goto V_418;
if ( F_203 ( ( V_409 & 0x1 ) == 0 ) ) goto V_419;
V_414 = F_269 () ;
V_59 = V_409 >> V_63 ;
V_30 = V_29 -> V_30 ;
V_416 = F_215 ( V_27 ) ;
...
if ( F_198 ( V_411 > V_412 ) ) {
V_401 |= 1UL << V_24 ;
if ( F_207 ( V_27 , V_24 ) ) V_413 |= 1UL << V_24 ;
}
F_59 ( ( L_188 ,
V_24 ,
V_412 ,
...
static void *
F_280 ( struct V_455 * V_325 , T_10 * V_100 )
{
if ( * V_100 == 0 ) {
return V_456 ;
}
...
static void *
F_282 ( struct V_455 * V_325 , void * V_301 , T_10 * V_100 )
{
++ * V_100 ;
return F_280 ( V_325 , V_100 ) ;
}
static void
F_283 ( struct V_455 * V_325 , void * V_301 )
{
}
static void
F_284 ( struct V_455 * V_325 )
{
struct V_99 * V_100 ;
T_4 * V_101 ;
unsigned long V_11 ;
...
static int
F_286 ( struct V_455 * V_325 , void * V_301 )
{
unsigned long V_65 ;
unsigned int V_24 ;
int V_90 ;
...
V_90 , F_287 ( V_463 , V_90 ) & V_364 ? 1 : 0 ,
V_90 , F_287 ( V_463 , V_90 ) & V_69 ? 1 : 0 ,
V_90 , F_287 ( V_463 , V_90 ) & V_365 ? 1 : 0 ,
V_90 , F_287 ( V_464 , V_90 ) ? F_287 ( V_464 , V_90 ) -> V_242 : - 1 ,
V_90 , F_287 ( V_465 , V_90 ) ,
V_90 , F_287 ( V_466 , V_90 ) ) ;
if ( F_288 () == 1 && V_277 . V_326 > 0 ) {
V_65 = F_21 () ;
F_27 () ;
F_285 ( V_325 ,
L_224
...
{
return F_291 ( V_125 , & V_467 ) ;
}
void
F_292 ( struct V_1 * V_2 , unsigned long V_148 , int V_468 )
{
struct V_86 * V_87 ;
unsigned long V_469 ;
unsigned long V_470 ;
...
V_87 = F_119 ( V_2 ) ;
F_230 ( V_87 ) -> V_350 = V_468 ? V_470 : 0 ;
return;
}
if ( V_470 ) {
V_469 = F_22 ( V_70 ) ;
...
F_246 ( F_120 () ) ;
if ( F_203 ( ( V_2 -> V_312 . V_11 & V_366 ) == 0 ) ) return;
V_11 = F_8 ( V_27 ) ;
V_65 = F_21 () ;
...
V_499 = F_310 ( L_243 , V_182 , NULL , & V_500 ) ;
if ( V_499 == NULL ) {
F_63 ( V_67 L_244 ) ;
V_29 = NULL ;
return - 1 ;
...
V_148 = F_64 () ;
V_469 = F_22 ( V_70 ) ;
if ( V_148 == 0 && F_230 ( V_87 ) -> V_350 == 0 && ( V_469 & V_71 ) == 0 ) {
F_124 ( V_11 ) ;
return;
}
F_63 ( L_245 ,
...
for ( V_24 = 1 ; F_175 ( V_24 ) == 0 ; V_24 ++ ) {
if ( F_176 ( V_24 ) == 0 ) continue;
F_63 ( L_248 , V_426 , V_24 , F_272 ( V_24 ) , V_24 , V_27 -> V_64 [ V_24 ] ) ;
}
...
T_27 long
F_249 ( int V_144 , int V_143 , void * V_91 , int V_246 )
{
return - V_381 ;
}
