...
T_1
F_152 ( struct V_1 * V_2 , struct V_22 * V_23 , struct V_314 * V_315 , int V_109 )
{
T_1 V_11 ;
...
F_159 ( void )
{
struct V_141 * V_327 , * V_328 ;
unsigned int V_329 ;
F_22 ( L_9 ) ;
for ( V_329 = 0 ; V_329 < V_330 ; V_329 ++ ) {
V_327 = V_152 [ V_329 ] . V_154 ;
while( V_327 ) {
V_328 = V_327 ;
V_327 = V_327 -> V_155 ;
F_55 ( V_328 ) ;
}
V_152 [ V_329 ] . V_154 = NULL ;
}
}
int
F_160 ( int V_331 )
...
F_22 ( L_10 , V_331 ) ;
for ( V_329 = 0 ; V_329 < V_330 ; V_329 ++ ) {
F_162 ( & V_152 [ V_329 ] . V_153 ) ;
V_327 = & V_152 [ V_329 ] . V_154 ;
for ( V_332 = 0 ; V_332 < V_333 ; V_332 ++ ) {
* V_327 = F_163 ( sizeof( struct V_141 ) , V_88 ) ;
if ( ! * V_327 )
goto V_334;
V_327 = & ( * V_327 ) -> V_155 ;
}
...
V_176 = F_52 ( V_23 -> V_29 , V_24 , & V_335 ) ;
if ( V_176 < 0 )
return F_64 ( V_176 ) ;
V_94 = F_65 ( V_335 , V_176 ) ;
F_55 ( V_335 ) ;
return V_94 ;
}
int
...
V_335 = F_54 ( V_176 , V_88 ) ;
if ( ! V_335 )
return - V_89 ;
error = F_58 ( V_94 , V_335 , V_176 ) ;
if ( error < 0 )
goto V_340;
V_176 = error ;
} else
...
goto V_340;
if ( V_176 )
error = F_59 ( V_23 -> V_29 , V_24 , V_335 , V_176 , 0 ) ;
else {
