...
static int F_16 ( struct V_12 * V_13 , unsigned int V_34 )
{
unsigned int V_15 = 0 ;
struct V_1 * V_2 = F_6 ( V_13 ) ;
int V_7 , V_14 = F_7 ( V_13 ) ;
...
{
struct V_1 * V_2 ;
struct V_5 * V_6 = F_20 ( V_39 -> V_40 . V_41 ) ;
struct V_42 * V_43 =
F_21 ( & V_39 -> V_40 ) ;
struct V_44 * V_45 ;
struct V_46 V_47 = { } ;
...
V_14 = V_43 -> V_51 [ V_48 ] . V_14 ;
V_73 = V_43 -> V_51 [ V_48 ] . V_73 ;
}
V_68 = & V_16 [ V_14 ] . V_68 ;
V_47 . V_40 = & V_39 -> V_40 ;
V_47 . V_73 = V_73 ;
V_47 . V_77 = V_2 ;
V_47 . V_78 = V_76 ;
V_2 -> V_51 [ V_48 ] = F_27 ( V_68 , & V_47 ) ;
if ( F_28 ( V_2 -> V_51 [ V_48 ] ) ) {
F_29 ( & V_39 -> V_40 , L_3 ,
V_16 [ V_48 ] . V_68 . V_79 ) ;
V_7 = F_30 ( V_2 -> V_51 [ V_48 ] ) ;
goto V_33;
}
}
return 0 ;
...
static int T_3 F_32 ( struct V_38 * V_39 )
{
