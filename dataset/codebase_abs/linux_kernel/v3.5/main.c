...
V_52 = 0 ;
V_2 -> V_112 = false ;
if ( V_63 > ( ( ( ( V_2 -> V_113 & V_114 ) >> 24 ) *
sizeof( V_115 ) ) - sizeof( struct V_94 ) ) ) {
V_95 . V_63 =
( ( ( V_2 -> V_113 & V_114 ) >> 24 ) *
sizeof( V_115 ) ) -
sizeof( struct V_94 ) ;
...
V_95 . V_117 = V_23 -> V_44 ;
V_95 . V_118 = V_23 -> V_55 ;
V_95 . V_119 = 0 ;
...
static long F_49 ( struct V_3 * V_3 , unsigned int V_122 , unsigned long V_89 )
{
struct V_1 * V_2 ;
struct V_22 * V_23 = V_3 -> V_50 ;
...
V_124 = F_40 ( sizeof( struct V_123 ) ,
V_100 ) ;
if ( ! V_124 ) {
V_52 = - V_35 ;
goto V_33;
...
static long F_51 ( struct V_3 * V_3 ,
unsigned int V_122 , unsigned long V_89 )
{
return F_49 ( V_3 , V_122 , ( unsigned long ) F_52 ( V_89 ) ) ;
}
static unsigned int F_53 ( struct V_3 * V_3 , T_5 * V_126 )
{
struct V_22 * V_23 = V_3 -> V_50 ;
struct V_1 * V_2 ;
...
static int T_6 F_55 ( struct V_132 * V_26 ,
...
static void T_7 F_79 ( struct V_132 * V_26 )
{
struct V_1 * V_2 ;
if ( V_1 != V_26 )
return;
...
if ( V_2 -> V_154 . V_47 == V_53 ) {
V_2 -> V_154 . V_47 = V_54 ;
F_22 ( V_2 , & V_2 -> V_154 ) ;
}
F_81 ( V_2 ) ;
F_8 ( & V_26 -> V_2 , L_35 ) ;
F_25 ( V_2 , V_2 -> V_154 . V_44 ) ;
...
static int F_83 ( struct V_155 * V_155 )
{
struct V_132 * V_26 = F_84 ( V_155 ) ;
...
static int F_86 ( struct V_155 * V_155 )
{
struct V_132 * V_26 = F_84 ( V_155 ) ;
struct V_1 * V_2 ;
int V_31 ;
