...
static int F_47 ( struct V_34 * V_97 )
{
struct V_42 * V_43 = F_20 ( V_97 ) ;
struct V_44 * V_45 = F_21 ( V_43 -> V_46 ) ;
struct V_1 * V_17 = V_45 -> V_47 ;
struct V_15 * V_73 = V_17 -> V_15 [ 0 ] ;
...
static int F_49 ( struct V_34 * V_97 ,
struct V_42 * V_43 )
{
V_97 -> type = V_101 ;
...
T_1 V_111 ;
long V_112 ;
F_3 ( V_17 , ( 640 - 1 ) | ( ( 480 - 1 ) << 16 ) , V_113 ) ;
V_111 = F_1 ( V_17 , V_114 ) & 0xffff0000 ;
F_3 ( V_17 , V_111 , V_114 ) ;
V_111 = 0 << V_115 ;
V_111 |= V_116 ;
if ( V_17 -> V_117 & V_118 )
V_111 |= 3 << V_119 ;
else if ( V_17 -> V_117 & V_120 )
V_111 |= 2 << V_119 ;
else if ( V_17 -> V_117 & V_121 )
V_111 |= 1 << V_119 ;
else
V_111 |= 0 << V_119 ;
if ( V_17 -> V_117 & V_122 )
...
if ( V_17 -> V_117 & V_132 )
V_111 |= 1 << V_133 ;
F_3 ( V_17 , V_111 , V_134 ) ;
F_52 ( V_17 -> V_135 ) ;
V_112 = F_53 ( V_17 -> V_135 , V_17 -> V_136 ) ;
F_10 ( V_43 -> V_46 , L_8 , V_111 , V_112 ) ;
if ( V_112 )
F_54 ( V_17 -> V_135 , V_112 ) ;
}
...
{
struct V_151 * V_152 = F_64 ( V_43 ) ;
struct V_44 * V_45 = F_21 ( V_43 -> V_46 ) ;
struct V_1 * V_17 = V_45 -> V_47 ;
struct V_153 V_154 = { . type = V_155 ,} ;
unsigned long V_156 , V_157 ;
int V_54 = F_61 ( V_17 , V_150 , & V_156 ) ;
F_10 ( V_43 -> V_46 , L_11 , V_150 , V_54 ) ;
if ( V_54 < 0 )
return V_54 ;
V_54 = F_65 ( V_152 , V_75 , V_158 , & V_154 ) ;
if ( ! V_54 ) {
V_157 = F_66 ( & V_154 ,
V_156 ) ;
if ( ! V_157 ) {
...
if ( ! V_161 )
return false ;
V_163 = V_161 -> V_17 -> V_164 . V_165 . V_20 -> V_166 ;
return V_161 -> V_167 == V_13 -> V_168 &&
V_163 -> V_169 == V_13 -> V_19 -> V_20 ;
}
static bool F_70 ( const struct V_77 * V_37 )
{
return V_37 -> V_170 == V_171 ||
( V_37 -> V_172 == 8 &&
V_37 -> V_170 == V_173 ) ||
( V_37 -> V_172 > 8 &&
V_37 -> V_170 == V_174 ) ;
}
static int F_71 ( struct V_42 * V_43 , unsigned int V_175 ,
struct V_49 * V_50 )
{
struct V_151 * V_152 = F_64 ( V_43 ) ;
...
V_54 = F_65 ( V_152 , V_75 , V_179 , V_175 , & V_178 ) ;
if ( V_54 < 0 )
return 0 ;
V_37 = F_72 ( V_178 ) ;
if ( ! V_37 ) {
...
int V_54 = F_74 ( V_37 , & V_187 , & V_188 ) ;
F_58 ( V_54 < 0 ) ;
...
F_3 ( V_17 , V_185 | ( V_186 << 16 ) , V_113 ) ;
V_184 = F_1 ( V_17 , V_114 ) & 0xffff0000 ;
F_3 ( V_17 , V_184 | 0 | ( 0 << 8 ) , V_114 ) ;
}
...
V_54 = F_65 ( V_152 , V_75 , V_205 , V_197 ) ;
if ( V_54 < 0 )
return V_54 ;
V_54 = F_65 ( V_152 , V_75 , V_206 , & V_202 ) ;
if ( V_54 < 0 )
return V_54 ;
if ( V_202 . V_178 != V_43 -> V_78 -> V_178 )
return - V_48 ;
if ( V_202 . V_55 & 7 ) {
F_79 ( & V_202 . V_55 ) ;
V_54 = F_65 ( V_152 , V_75 , V_207 , & V_202 ) ;
if ( V_54 < 0 )
return V_54 ;
}
if ( V_202 . V_55 != V_43 -> V_94 || V_202 . V_58 != V_43 -> V_92 )
F_73 ( V_17 , V_202 . V_55 , V_202 . V_58 ,
V_43 -> V_78 -> V_56 ) ;
F_10 ( V_43 -> V_46 , L_16 ,
V_202 . V_55 , V_202 . V_58 ) ;
V_43 -> V_94 = V_202 . V_55 ;
V_43 -> V_92 = V_202 . V_58 ;
return V_54 ;
}
...
V_202 . V_178 = V_50 -> V_178 ;
V_54 = F_65 ( V_152 , V_75 , V_207 , & V_202 ) ;
if ( V_54 < 0 )
return V_54 ;
if ( V_202 . V_178 != V_50 -> V_178 )
return - V_48 ;
if ( ! V_17 -> V_15 [ 0 ] ) {
V_54 = F_75 ( V_17 ) ;
if ( V_54 < 0 )
...
V_202 . V_210 = V_51 -> V_210 ;
V_202 . V_178 = V_50 -> V_178 ;
V_54 = F_65 ( V_152 , V_75 , V_212 , & V_202 ) ;
if ( V_54 < 0 )
return V_54 ;
V_51 -> V_55 = V_202 . V_55 ;
V_51 -> V_58 = V_202 . V_58 ;
...
V_154 . V_79 = V_157 ;
V_54 = F_65 ( V_152 , V_75 , V_229 , & V_154 ) ;
if ( V_54 < 0 && V_54 != - V_159 ) {
F_10 ( V_20 , L_24 ,
V_157 , V_54 ) ;
return V_54 ;
}
V_228 = F_1 ( V_17 , V_134 ) &
~ ( ( 1 << V_133 ) |
( 1 << V_131 ) |
( 1 << V_127 ) |
( 1 << V_129 ) |
...
F_3 ( V_17 , V_228 | V_227 , V_134 ) ;
F_10 ( V_20 , L_25 , V_228 | V_227 ) ;
return 0 ;
}
static int T_8 F_91 ( struct V_231 * V_232 )
{
struct V_1 * V_17 ;
struct V_233 * V_234 ;
void T_9 * V_4 ;
...
V_17 -> V_135 = F_94 ( & V_232 -> V_20 , NULL ) ;
if ( F_95 ( V_17 -> V_135 ) ) {
V_235 = F_96 ( V_17 -> V_135 ) ;
goto V_241;
}
V_17 -> V_163 = V_232 -> V_20 . V_166 ;
V_17 -> V_117 = V_17 -> V_163 -> V_79 ;
if ( ! ( V_17 -> V_117 & ( V_242 |
V_121 | V_120 |
V_118 ) ) ) {
...
if ( V_17 -> V_117 & V_118 )
V_17 -> V_140 |= 1 << 14 ;
V_17 -> V_136 = V_17 -> V_163 -> V_243 * 10000 ;
if ( ! V_17 -> V_136 ) {
F_67 ( & V_232 -> V_20 ,
L_29
L_30 ) ;
...
F_45 ( & V_17 -> V_32 ) ;
F_97 ( & V_17 -> V_24 ) ;
V_4 = F_98 ( V_234 -> V_244 , F_99 ( V_234 ) ) ;
if ( ! V_4 ) {
F_100 ( L_31 , F_99 ( V_234 ) , V_234 -> V_244 ) ;
V_235 = - V_239 ;
goto V_245;
}
V_17 -> V_4 = V_4 ;
...
V_164 -> V_106 = & V_248 ;
V_164 -> V_47 = V_17 ;
V_164 -> V_165 . V_20 = & V_232 -> V_20 ;
V_164 -> V_249 = V_232 -> V_167 ;
...
static int T_10 F_108 ( struct V_231 * V_232 )
{
struct V_44 * V_164 = F_21 ( & V_232 -> V_20 ) ;
struct V_1 * V_17 = F_6 ( V_164 ,
struct V_1 , V_164 ) ;
F_106 ( V_17 -> V_135 ) ;
F_109 ( V_164 ) ;
F_105 ( V_17 -> V_4 ) ;
