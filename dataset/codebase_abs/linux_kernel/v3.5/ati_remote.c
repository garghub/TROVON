...
F_5 ( V_14 , L_8 ,
V_17 , V_16 [ 0 ] , V_16 [ 1 ] , V_16 [ 2 ] , V_16 [ 3 ] , V_16 [ 4 ] , V_16 [ 5 ] ) ;
}
...
static int F_22 ( struct V_18 * V_18 , T_1 V_38 , unsigned char * V_16 )
{
int V_39 = 0 ;
...
return;
default:
F_19 ( & V_18 -> V_2 -> V_14 , L_17 ,
V_25 , V_32 -> V_34 ) ;
}
V_39 = F_8 ( V_32 , V_44 ) ;
if ( V_39 )
F_9 ( & V_18 -> V_2 -> V_14 , L_18 ,
V_25 , V_39 ) ;
}
...
static int F_59 ( struct V_1 * V_2 , const struct V_129 * V_106 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
...
sizeof( V_18 -> V_105 ) ) ;
F_66 ( V_18 -> V_116 , L_24 , sizeof( V_18 -> V_116 ) ) ;
F_66 ( V_18 -> V_105 , L_25 , sizeof( V_18 -> V_105 ) ) ;
if ( V_4 -> V_5 )
F_65 ( V_18 -> V_114 , V_4 -> V_5 ,
sizeof( V_18 -> V_114 ) ) ;
if ( V_4 -> V_6 )
snprintf ( V_18 -> V_114 , sizeof( V_18 -> V_114 ) ,
L_26 , V_18 -> V_114 , V_4 -> V_6 ) ;
