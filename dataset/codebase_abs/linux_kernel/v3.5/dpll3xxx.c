...
static void F_16 ( struct V_1 * V_1 , T_1 * V_28 , T_3 V_29 , T_1 V_17 )
{
...
static void F_17 ( struct V_1 * V_1 , T_1 * V_32 , T_3 V_29 , T_1 V_17 )
{
unsigned long V_30 , V_33 ;
int V_34 , V_35 ;
V_30 = V_1 -> V_31 -> V_21 ;
V_30 /= 100000 ;
V_34 = ( V_30 * V_29 ) % ( 250 * V_17 ) ;
...
static int F_18 ( struct V_1 * V_1 , T_3 V_29 , T_1 V_17 , T_3 V_36 )
{
...
V_5 = F_2 ( V_4 -> V_6 ) ;
V_5 &= ~ V_4 -> V_37 ;
V_5 |= V_36 << F_3 ( V_4 -> V_37 ) ;
F_4 ( V_5 , V_4 -> V_6 ) ;
}
V_5 = F_2 ( V_4 -> V_38 ) ;
V_5 &= ~ ( V_4 -> V_39 | V_4 -> V_40 ) ;
V_5 |= V_29 << F_3 ( V_4 -> V_39 ) ;
V_5 |= ( V_17 - 1 ) << F_3 ( V_4 -> V_40 ) ;
if ( V_4 -> V_41 ) {
F_16 ( V_1 , & V_28 , V_29 , V_17 ) ;
V_5 &= ~ ( V_4 -> V_41 ) ;
V_5 |= V_28 << F_3 ( V_4 -> V_41 ) ;
}
if ( V_4 -> V_42 ) {
F_17 ( V_1 , & V_32 , V_29 , V_17 ) ;
V_5 &= ~ ( V_4 -> V_42 ) ;
V_5 |= V_32 << F_3 ( V_4 -> V_42 ) ;
}
F_4 ( V_5 , V_4 -> V_38 ) ;
F_10 ( V_1 ) ;
return 0 ;
...
if ( ! V_4 )
return - V_11 ;
if ( V_1 -> V_21 == V_4 -> V_43 -> V_21 ) {
F_24 ( V_1 -> V_31 != V_4 -> V_43 ) ;
V_23 = F_14 ( V_1 ) ;
} else {
F_24 ( V_1 -> V_31 != V_4 -> V_20 ) ;
V_23 = F_10 ( V_1 ) ;
}
if ( ! V_23 )
V_1 -> V_21 = ( V_1 -> V_44 ) ? V_1 -> V_44 ( V_1 ) :
F_22 ( V_1 ) ;
return V_23 ;
}
...
if ( ! V_4 )
return - V_11 ;
V_46 = ( V_1 -> V_44 ) ? V_1 -> V_44 ( V_1 ) : F_22 ( V_1 ) ;
if ( V_21 == V_46 )
return 0 ;
F_27 ( V_4 -> V_43 ) ;
F_27 ( V_4 -> V_20 ) ;
if ( V_4 -> V_43 -> V_21 == V_21 &&
( V_1 -> V_3 -> V_25 & ( 1 << V_26 ) ) ) {
F_8 ( L_10 , V_1 -> V_16 ) ;
V_10 = F_14 ( V_1 ) ;
if ( ! V_10 )
...
V_5 >>= F_3 ( V_4 -> V_7 ) ;
if ( ( V_5 != V_57 ) || ( V_4 -> V_58 & V_59 ) )
V_21 = V_1 -> V_31 -> V_21 ;
else
V_21 = V_1 -> V_31 -> V_21 * 2 ;
return V_21 ;
}
