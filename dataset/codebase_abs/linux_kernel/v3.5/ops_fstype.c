...
static int F_94 ( struct V_11 * V_14 , int V_54 )
{
...
V_270 -> V_208 = V_268 ;
V_270 -> V_241 = 1 ;
for ( V_273 = args -> V_277 ; ( V_272 = F_96 ( & V_273 , L_59 ) ) ; ) {
T_3 V_278 [ V_279 ] ;
int V_280 , V_281 ;
if ( ! V_272 || ! * V_272 )
continue;
V_280 = F_97 ( V_272 , * V_268 -> V_282 , V_278 ) ;
switch ( V_280 ) {
case V_283 :
V_172 = F_98 ( & V_278 [ 0 ] , & V_281 ) ;
if ( V_172 || V_281 < 0 )
goto V_284;
...
if ( F_102 ( ! F_103 ( V_290 , & V_14 -> V_21 ) ) &&
V_268 -> V_291 )
V_268 -> V_291 ( V_14 ) ;
}
static int F_104 ( void * V_292 )
{
if ( F_105 ( V_293 ) )
return - V_294 ;
F_106 () ;
...
{
if ( V_14 -> V_207 . V_208 -> V_289 == NULL )
return 0 ;
return F_108 ( & V_14 -> V_21 , V_20 , F_104 , V_295 ) ;
}
...
char V_296 [ 20 ] ;
char V_297 [ 20 ] ;
char * V_206 [] = { V_296 , V_297 , NULL } ;
sprintf ( V_296 , L_63 , ( V_13 -> V_298 & V_299 ) ? 1 : 0 ) ;
sprintf ( V_297 , L_64 , V_14 -> V_135 . V_231 ? 1 : 0 ) ;
F_66 ( & V_14 -> V_210 , V_300 , V_206 ) ;
}
static int F_110 ( struct V_12 * V_13 , struct V_271 * args , int V_54 )
{
struct V_11 * V_14 ;
struct V_142 V_143 ;
int error ;
...
V_13 -> V_314 = V_315 ;
V_13 -> V_316 = & V_317 ;
F_111 ( V_13 ) -> V_318 |= V_319 ;
V_13 -> V_320 = 1 ;
V_13 -> V_321 = V_322 ;
V_14 -> V_56 . V_79 = F_112 ( V_13 , V_323 ) ;
V_14 -> V_56 . V_80 = V_13 -> V_324 ;
V_14 -> V_109 = V_14 -> V_56 . V_80 -
V_110 ;
V_14 -> V_111 = 1 << V_14 -> V_109 ;
V_14 -> V_22 . V_325 = V_14 -> V_135 . V_326 ;
V_14 -> V_22 . V_327 = V_14 -> V_135 . V_328 ;
if ( V_14 -> V_135 . V_329 ) {
V_14 -> V_22 . V_330 = 0 ;
V_14 -> V_22 . V_331 = V_14 -> V_135 . V_329 ;
} else {
V_14 -> V_22 . V_330 = 1 ;
V_14 -> V_22 . V_331 = 30 ;
}
...
if ( error )
goto V_151;
snprintf ( V_14 -> V_332 , V_140 , L_66 , V_14 -> V_141 ) ;
F_113 ( V_14 ) ;
error = F_114 ( V_14 ) ;
if ( error )
goto V_151;
error = F_94 ( V_14 , V_54 ) ;
if ( error )
goto V_333;
...
if ( V_14 -> V_135 . V_231 )
snprintf ( V_14 -> V_332 , V_140 , L_67 ,
V_14 -> V_141 ) ;
else
snprintf ( V_14 -> V_332 , V_140 , L_68 ,
...
static int F_121 ( struct V_12 * V_71 , void * V_340 )
{
V_71 -> V_97 = V_340 ;
V_71 -> V_341 = V_71 -> V_97 -> V_342 ;
V_71 -> V_343 = & F_122 ( V_71 -> V_97 ) -> V_344 ;
return 0 ;
}
static int F_123 ( struct V_12 * V_71 , void * V_345 )
{
struct V_346 * V_347 = V_345 ;
return ( V_347 == V_71 -> V_97 ) ;
}
static struct V_165 * F_124 ( struct V_348 * V_349 , int V_318 ,
const char * V_350 , void * V_340 )
{
struct V_346 * V_347 ;
struct V_12 * V_71 ;
...
V_71 = F_127 ( V_349 , F_123 , F_121 , V_347 ) ;
F_76 ( & V_347 -> V_355 ) ;
error = F_53 ( V_71 ) ;
if ( F_52 ( V_71 ) )
goto V_358;
...
if ( V_71 -> V_178 ) {
error = - V_357 ;
if ( ( V_318 ^ V_71 -> V_298 ) & V_299 )
goto V_365;
} else {
char V_366 [ V_367 ] ;
V_71 -> V_298 = V_318 ;
V_71 -> V_368 = V_351 ;
F_44 ( V_71 -> V_138 , F_130 ( V_347 , V_366 ) , sizeof( V_71 -> V_138 ) ) ;
F_57 ( V_71 , F_131 ( V_347 ) ) ;
error = F_110 ( V_71 , & args , V_318 & V_369 ? 1 : 0 ) ;
if ( error )
goto V_365;
V_71 -> V_298 |= V_370 ;
V_347 -> V_371 = V_71 ;
...
static int F_134 ( struct V_12 * V_71 , void * V_345 )
{
return - V_62 ;
}
static struct V_165 * F_135 ( struct V_348 * V_349 ,
int V_318 , const char * V_350 , void * V_340 )
{
struct V_12 * V_71 ;
struct V_11 * V_14 ;
struct V_372 V_372 ;
int error ;
error = F_136 ( V_350 , V_373 , & V_372 ) ;
if ( error ) {
F_15 ( V_61 L_72 ,
V_350 , error ) ;
return F_133 ( error ) ;
}
V_71 = F_127 ( & V_374 , F_123 , F_134 ,
V_372 . V_165 -> V_226 -> V_375 -> V_97 ) ;
F_137 ( & V_372 ) ;
if ( F_52 ( V_71 ) ) {
F_15 ( V_61 L_73 ) ;
return F_126 ( V_71 ) ;
