...
static void
F_34 ( struct V_1 * V_2 , struct V_81 * V_39 ,
T_2 * V_36 )
{
T_2 V_94 [ 3 ] ;
if ( ! ( V_36 [ V_95 ] & V_96 ) )
return;
if ( ! F_7 ( V_2 , V_39 -> V_85 , 9 , V_97 , V_94 , 3 ) )
F_17 ( V_2 , L_18 ,
V_94 [ 0 ] , V_94 [ 1 ] , V_94 [ 2 ] ) ;
if ( ! F_7 ( V_2 , V_39 -> V_85 , 9 , V_98 , V_94 , 3 ) )
F_17 ( V_2 , L_19 ,
V_94 [ 0 ] , V_94 [ 1 ] , V_94 [ 2 ] ) ;
}
bool
...
if ( ! V_39 )
return false ;
V_16 = F_7 ( V_2 , V_39 -> V_85 , 9 , V_99 , V_36 , 8 ) ;
if ( V_16 )
return false ;
V_76 -> V_29 . V_32 = 27000 * V_36 [ 1 ] ;
V_76 -> V_29 . V_31 = V_36 [ 2 ] & V_100 ;
F_17 ( V_2 , L_20 ,
V_76 -> V_29 . V_31 , V_76 -> V_29 . V_32 , V_36 [ 0 ] ) ;
F_17 ( V_2 , L_21 ,
V_76 -> V_22 -> V_101 . V_31 ,
V_76 -> V_22 -> V_101 . V_32 ) ;
if ( V_76 -> V_22 -> V_101 . V_31 < V_76 -> V_29 . V_31 )
V_76 -> V_29 . V_31 = V_76 -> V_22 -> V_101 . V_31 ;
if ( V_76 -> V_22 -> V_101 . V_32 < V_76 -> V_29 . V_32 )
V_76 -> V_29 . V_32 = V_76 -> V_22 -> V_101 . V_32 ;
F_17 ( V_2 , L_22 ,
...
int
F_33 ( struct V_81 * V_39 , int V_102 , int V_10 ,
T_4 * V_11 , int V_103 )
{
return F_7 ( V_39 -> V_2 , V_39 -> V_85 , V_102 , V_10 , V_11 , V_103 ) ;
}
static int
F_36 ( struct V_104 * V_105 , struct V_106 * V_107 , int V_108 )
{
struct V_81 * V_39 = (struct V_81 * ) V_105 ;
struct V_106 * V_109 = V_107 ;
int V_16 , V_110 = V_108 ;
while ( V_110 -- ) {
T_2 V_111 = V_109 -> V_112 ;
T_2 * V_113 = V_109 -> V_94 ;
while ( V_111 ) {
T_2 V_114 = ( V_111 > 16 ) ? 16 : V_111 ;
T_2 V_102 ;
...
if ( V_110 || V_111 > 16 )
V_102 |= V_119 ;
V_16 = F_33 ( V_39 , V_102 , V_109 -> V_10 , V_113 , V_114 ) ;
if ( V_16 < 0 )
return V_16 ;
V_113 += V_114 ;
V_111 -= V_114 ;
