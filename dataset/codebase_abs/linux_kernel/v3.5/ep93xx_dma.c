...
if ( V_95 )
return V_95 ;
V_95 = F_59 ( V_3 -> V_110 , F_50 , 0 , V_118 , V_3 ) ;
if ( V_95 )
goto V_125;
F_47 ( & V_3 -> V_96 ) ;
F_60 ( & V_3 -> V_4 ) ;
V_95 = V_3 -> V_101 -> V_126 ( V_3 ) ;
F_49 ( & V_3 -> V_96 ) ;
if ( V_95 )
goto V_127;
for ( V_119 = 0 ; V_119 < V_128 ; V_119 ++ ) {
struct V_7 * V_8 ;
V_8 = F_61 ( sizeof( * V_8 ) , V_129 ) ;
if ( ! V_8 ) {
F_22 ( F_1 ( V_3 ) , L_10 ) ;
break;
}
...
static struct V_116 *
F_68 ( struct V_6 * V_4 , T_5 V_134 ,
T_5 V_135 , T_6 V_136 , unsigned long V_17 )
{
struct V_2 * V_3 = F_2 ( V_4 ) ;
struct V_7 * V_8 , * V_137 ;
T_6 V_138 , V_139 ;
V_137 = NULL ;
for ( V_139 = 0 ; V_139 < V_136 ; V_139 += V_138 ) {
V_8 = F_32 ( V_3 ) ;
if ( ! V_8 ) {
F_22 ( F_1 ( V_3 ) , L_11 ) ;
goto V_140;
}
V_138 = F_69 ( T_6 , V_136 - V_139 , V_141 ) ;
V_8 -> V_37 = V_135 + V_139 ;
V_8 -> V_38 = V_134 + V_139 ;
V_8 -> V_40 = V_138 ;
if ( ! V_137 )
V_137 = V_8 ;
else
F_7 ( & V_8 -> V_10 , & V_137 -> V_11 ) ;
}
V_137 -> V_13 . V_18 = - V_142 ;
V_137 -> V_13 . V_17 = V_17 ;
return & V_137 -> V_13 ;
V_140:
F_38 ( V_3 , V_137 ) ;
return NULL ;
...
static struct V_116 *
F_70 ( struct V_6 * V_4 , struct V_143 * V_144 ,
unsigned int V_145 , enum V_146 V_147 ,
unsigned long V_17 , void * V_148 )
{
struct V_2 * V_3 = F_2 ( V_4 ) ;
struct V_7 * V_8 , * V_137 ;
struct V_143 * V_149 ;
int V_119 ;
if ( ! V_3 -> V_101 -> V_120 && V_147 != F_23 ( V_4 ) ) {
F_22 ( F_1 ( V_3 ) ,
L_12 ) ;
return NULL ;
}
...
static struct V_116 *
F_74 ( struct V_6 * V_4 , T_5 V_150 ,
T_6 V_151 , T_6 V_152 ,
enum V_146 V_147 , void * V_148 )
{
struct V_2 * V_3 = F_2 ( V_4 ) ;
struct V_7 * V_8 , * V_137 ;
T_6 V_139 = 0 ;
...
V_137 = NULL ;
for ( V_139 = 0 ; V_139 < V_151 ; V_139 += V_152 ) {
V_8 = F_32 ( V_3 ) ;
if ( ! V_8 ) {
F_22 ( F_1 ( V_3 ) , L_11 ) ;
goto V_140;
...
if ( V_147 == V_36 ) {
V_8 -> V_37 = V_150 + V_139 ;
V_8 -> V_38 = V_3 -> V_133 ;
} else {
V_8 -> V_37 = V_3 -> V_133 ;
V_8 -> V_38 = V_150 + V_139 ;
}
V_8 -> V_40 = V_152 ;
if ( ! V_137 )
V_137 = V_8 ;
...
static int F_79 ( struct V_6 * V_4 , enum V_166 V_167 ,
unsigned long V_168 )
{
struct V_2 * V_3 = F_2 ( V_4 ) ;
struct V_154 * V_155 ;
...
return F_76 ( V_3 ) ;
case V_170 :
V_155 = (struct V_154 * ) V_168 ;
return F_78 ( V_3 , V_155 ) ;
default:
break;
}
return - V_171 ;
}
static enum V_172 F_80 ( struct V_6 * V_4 ,
T_4 V_18 ,
struct V_173 * V_174 )
{
struct V_2 * V_3 = F_2 ( V_4 ) ;
...
static int T_7 F_83 ( struct V_175 * V_176 )
{
struct V_177 * V_178 = F_84 ( & V_176 -> V_5 ) ;
struct V_179 * V_101 ;
struct V_180 * V_181 ;
T_6 V_182 ;
int V_95 , V_119 ;
V_182 = V_178 -> V_183 * sizeof( struct V_2 ) ;
V_101 = F_61 ( sizeof( * V_101 ) + V_182 , V_129 ) ;
if ( ! V_101 )
return - V_184 ;
V_181 = & V_101 -> V_181 ;
V_101 -> V_120 = F_85 ( V_176 ) -> V_185 ;
...
V_3 -> V_101 = V_101 ;
V_3 -> V_124 = F_86 ( NULL , V_188 -> V_118 ) ;
if ( F_87 ( V_3 -> V_124 ) ) {
F_22 ( & V_176 -> V_5 , L_16 ,
V_188 -> V_118 ) ;
continue;
...
F_90 ( V_181 -> V_191 ) ;
F_91 ( V_192 , V_181 -> V_191 ) ;
F_91 ( V_193 , V_181 -> V_191 ) ;
V_181 -> V_5 = & V_176 -> V_5 ;
V_181 -> V_194 = F_56 ;
V_181 -> V_195 = F_66 ;
V_181 -> V_196 = F_70 ;
...
V_181 -> V_199 = F_82 ;
V_181 -> V_200 = F_80 ;
F_92 ( V_181 -> V_5 , V_141 ) ;
if ( V_101 -> V_120 ) {
F_91 ( V_201 , V_181 -> V_191 ) ;
V_181 -> V_202 = F_68 ;
V_101 -> V_126 = F_27 ;
V_101 -> V_132 = F_28 ;
V_101 -> V_102 = F_30 ;
