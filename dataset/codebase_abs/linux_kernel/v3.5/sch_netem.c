...
F_24 ( V_3 ) ;
if ( V_54 > 1 && ( V_53 = F_25 ( V_3 , V_62 ) ) != NULL ) {
struct V_46 * V_63 = F_26 ( V_47 ) ;
T_1 V_64 = V_12 -> V_55 ;
V_12 -> V_55 = 0 ;
F_27 ( V_53 , V_63 ) ;
V_12 -> V_55 = V_64 ;
}
if ( V_12 -> V_65 && V_12 -> V_65 >= F_5 ( & V_12 -> V_66 ) ) {
if ( ! ( V_3 = F_28 ( V_3 , V_62 ) ) ||
( V_3 -> V_67 == V_68 &&
F_29 ( V_3 ) ) )
return F_30 ( V_3 , V_47 ) ;
V_3 -> V_4 [ F_4 () % F_31 ( V_3 ) ] ^= 1 << ( F_4 () % 8 ) ;
}
if ( F_32 ( F_33 ( & V_47 -> V_12 ) >= V_47 -> V_69 ) )
return F_34 ( V_3 , V_47 ) ;
V_47 -> V_58 . V_70 += F_35 ( V_3 ) ;
V_52 = V_1 ( V_3 ) ;
if ( V_12 -> V_71 == 0 ||
...
if ( ! F_37 ( V_49 ) ) {
V_76 -= V_75 - V_1 ( F_38 ( V_49 ) ) -> V_51 ;
V_75 = V_1 ( F_15 ( V_49 ) ) -> V_51 ;
}
}
V_52 -> V_51 = V_75 + V_76 ;
++ V_12 -> V_72 ;
...
V_12 -> V_65 = V_114 -> V_115 ;
F_3 ( & V_12 -> V_66 , V_114 -> V_116 ) ;
}
...
if ( V_145 < 0 )
return V_145 ;
V_47 -> V_69 = V_144 -> V_69 ;
V_12 -> V_77 = V_144 -> V_77 ;
V_12 -> V_78 = V_144 -> V_78 ;
V_12 -> V_69 = V_144 -> V_69 ;
...
if ( F_93 ( V_3 , V_149 , sizeof( V_73 ) , & V_73 ) )
goto V_155;
V_65 . V_115 = V_12 -> V_65 ;
V_65 . V_116 = V_12 -> V_66 . V_7 ;
if ( F_93 ( V_3 , V_150 , sizeof( V_65 ) , & V_65 ) )
goto V_155;
V_44 . V_44 = V_12 -> V_44 ;
V_44 . V_38 = V_12 -> V_38 ;
V_44 . V_39 = V_12 -> V_39 ;
