...
V_53 = ( F_21 ( V_49 -> V_70 ) & V_71 ) >> 4 ;
F_22 ( V_72 , L_6 , V_47 ,
V_47 -> V_61 - V_13 -> V_73 ,
V_16 ? L_7 : L_8 ,
V_53 , * V_45 ) ;
F_23 ( & V_2 -> V_74 , V_47 ) ;
F_24 ( V_2 -> V_75 , & V_2 -> V_76 ) ;
return V_51 ;
}
void F_25 ( struct V_1 * V_2 , struct V_77 * V_15 )
{
unsigned long V_78 [ F_26 ( V_79 ) ] = { 0 } ;
T_1 V_80 ;
T_1 V_81 = V_15 -> V_81 & V_82 ;
T_1 V_83 = V_2 -> V_84 & V_82 ;
T_1 V_84 ;
T_1 V_10 , V_85 ;
T_1 V_86 , V_87 ;
T_2 V_45 ;
...
V_87 = F_27 ( V_15 -> V_88 [ V_83 ] ) ;
F_28 ( V_2 , V_87 , V_80 ) ;
F_29 ( V_2 , V_90 , V_2 -> V_91 ,
V_80 , true ) ;
V_86 = 0 ;
while ( V_86 < V_80 ) {
V_87 = F_27 ( V_15 -> V_88 [ V_83 ] ) ;
...
{
int V_98 ;
if ( V_2 -> V_99 [ V_94 ] == V_95 ) {
F_8 ( L_12
L_13 , V_94 ) ;
return 0 ;
}
V_98 = F_36 ( V_2 , V_94 , V_95 , V_97 ) ;
if ( V_98 ) {
F_11 ( L_14 ,
V_95 ? L_15 : L_16 , V_94 , V_98 ) ;
return V_98 ;
}
V_2 -> V_99 [ V_94 ] = V_95 ;
return 0 ;
