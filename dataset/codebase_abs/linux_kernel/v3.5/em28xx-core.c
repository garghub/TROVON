...
for ( V_36 = 0 ; V_36 < V_210 -> V_213 ; V_36 ++ ) {
...
int V_36 ;
struct V_195 * V_195 ;
struct V_209 * V_210 = & V_2 -> V_203 . V_211 ;
F_46 ( L_29 ) ;
for ( V_36 = 0 ; V_36 < V_210 -> V_213 ; V_36 ++ ) {
V_195 = V_210 -> V_195 [ V_36 ] ;
if ( V_195 ) {
...
int F_58 ( struct V_1 * V_2 , enum V_190 V_128 ,
int V_217 , int V_213 , int V_185 )
{
struct V_209 * V_210 ;
int V_36 ;
int V_218 , V_8 ;
...
F_50 ( V_2 , V_128 ) ;
V_210 -> V_213 = V_213 ;
V_210 -> V_195 = F_59 ( sizeof( void * ) * V_213 , V_221 ) ;
if ( ! V_210 -> V_195 ) {
F_43 ( L_31 ) ;
return - V_222 ;
}
V_210 -> V_214 = F_59 ( sizeof( void * ) * V_213 ,
V_221 ) ;
if ( ! V_210 -> V_214 ) {
F_43 ( L_32 ) ;
F_56 ( V_210 -> V_195 ) ;
...
V_210 -> V_185 = V_185 ;
V_210 -> V_223 = V_217 ;
V_2 -> V_203 . V_224 = NULL ;
V_2 -> V_203 . V_225 = NULL ;
V_218 = V_210 -> V_223 * V_210 -> V_185 ;
for ( V_36 = 0 ; V_36 < V_210 -> V_213 ; V_36 ++ ) {
V_195 = F_60 ( V_210 -> V_223 , V_221 ) ;
if ( ! V_195 ) {
F_61 ( L_33 , V_36 ) ;
F_50 ( V_2 , V_128 ) ;
return - V_222 ;
...
V_210 -> V_214 [ V_36 ] = F_62 ( V_2 -> V_9 ,
V_218 , V_221 , & V_195 -> V_216 ) ;
if ( ! V_210 -> V_214 [ V_36 ] ) {
F_61 ( L_34
L_35 ,
V_218 , V_36 ,
...
memset ( V_210 -> V_214 [ V_36 ] , 0 , V_218 ) ;
V_8 = F_64 ( V_2 -> V_9 ,
V_128 == V_129 ?
V_226 : V_227 ) ;
F_65 ( V_195 , V_2 -> V_9 , V_8 ,
V_210 -> V_214 [ V_36 ] , V_218 ,
F_45 , V_2 , 1 ) ;
V_195 -> V_205 = V_210 -> V_223 ;
V_195 -> V_228 = V_229 | V_230 ;
V_220 = 0 ;
for ( V_219 = 0 ; V_219 < V_210 -> V_223 ; V_219 ++ ) {
V_195 -> V_206 [ V_219 ] . V_231 = V_220 ;
V_195 -> V_206 [ V_219 ] . V_232 =
V_210 -> V_185 ;
V_220 += V_210 -> V_185 ;
}
}
...
{
F_69 ( & V_2 -> V_240 , 0 , V_241 , V_242 , 0 ) ;
F_69 ( & V_2 -> V_240 , 0 , V_243 , V_244 ,
F_25 ( V_2 -> V_61 ) -> V_245 , 0 , 0 ) ;
F_69 ( & V_2 -> V_240 , 0 , V_243 , V_246 , 0 ) ;
}
int F_70 ( struct V_247 * V_248 )
{
struct V_1 * V_2 = NULL ;
F_4 ( & V_249 ) ;
F_71 ( & V_248 -> V_250 , & V_251 ) ;
F_72 (dev, &em28xx_devlist, devlist) {
V_248 -> V_252 ( V_2 ) ;
}
F_6 ( & V_249 ) ;
F_3 ( V_253 L_40 , V_248 -> V_254 ) ;
return 0 ;
}
void F_73 ( struct V_247 * V_248 )
{
struct V_1 * V_2 = NULL ;
F_4 ( & V_249 ) ;
F_72 (dev, &em28xx_devlist, devlist) {
...
F_74 ( & V_248 -> V_250 ) ;
F_6 ( & V_249 ) ;
F_3 ( V_253 L_41 , V_248 -> V_254 ) ;
}
void F_75 ( struct V_1 * V_2 )
{
const struct V_247 * V_248 = NULL ;
F_4 ( & V_249 ) ;
F_71 ( & V_2 -> V_256 , & V_257 ) ;
