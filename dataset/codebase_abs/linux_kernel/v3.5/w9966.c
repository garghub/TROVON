...
F_47 ( V_146 , & V_2 -> V_138 . V_147 ) ;
F_48 ( & V_2 -> V_138 , V_2 ) ;
F_49 ( & V_2 -> V_93 ) ;
if ( F_50 ( & V_2 -> V_138 , V_148 , V_149 ) < 0 )
return - 1 ;
F_1 ( V_2 , V_150 , V_150 ) ;
F_51 ( V_67 , L_11 ,
V_2 -> V_10 -> V_68 ) ;
...
if ( V_153 [ V_22 ] . V_5 != 0 )
continue;
if ( strcmp ( V_154 [ V_22 ] , L_12 ) == 0 || strcmp ( V_154 [ V_22 ] , V_128 -> V_68 ) == 0 ) {
if ( F_41 ( & V_153 [ V_22 ] , V_128 ) != 0 )
F_52 ( & V_153 [ V_22 ] ) ;
break;
}
}
...
int V_22 ;
for ( V_22 = 0 ; V_22 < V_152 ; V_22 ++ )
if ( V_153 [ V_22 ] . V_5 != 0 && V_153 [ V_22 ] . V_10 == V_128 )
F_52 ( & V_153 [ V_22 ] ) ;
}
