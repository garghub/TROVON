...
{
struct V_178 * V_179 = F_85 ( V_177 ) ;
V_116 -> V_180 = 0 ;
for (; V_179 != NULL ; V_179 = F_86 ( V_177 , V_179 ) ) {
if ( ! F_87 ( V_177 , V_179 ) )
return - V_129 ;
if ( V_179 -> V_181 != V_167 )
continue;
if ( V_179 -> V_182 <= V_183 &&
! F_88 ( V_116 -> V_16 , V_179 -> V_182 ) )
return - V_129 ;
switch ( V_179 -> V_182 ) {
case V_184 :
if ( V_179 -> V_185 != F_89 ( sizeof( V_186 ) ) )
return - V_129 ;
V_116 -> V_180 = * ( V_186 * ) F_90 ( V_179 ) ;
break;
default:
return - V_129 ;
}
...
int F_91 ( struct V_187 * V_188 , struct V_15 * V_16 , struct V_176 * V_177 ,
T_5 V_118 )
{
const struct V_45 * V_46 = F_8 ( V_16 ) ;
const int V_74 = V_177 -> V_189 ;
const int V_190 = V_74 & V_191 ;
struct V_115 * V_116 ;
int V_111 , V_192 ;
long V_193 ;
if ( V_118 > V_46 -> V_57 )
...
V_193 = F_93 ( V_16 , V_190 ) ;
if ( ( 1 << V_16 -> V_18 ) & ~ ( V_197 | V_198 ) )
if ( ( V_111 = F_94 ( V_16 , & V_193 ) ) != 0 )
goto V_196;
V_192 = V_16 -> V_22 -> V_199 + V_118 ;
F_56 ( V_16 ) ;
V_116 = F_95 ( V_16 , V_192 , V_190 , & V_111 ) ;
F_53 ( V_16 ) ;
if ( V_116 == NULL )
goto V_196;
F_96 ( V_116 , V_16 -> V_22 -> V_199 ) ;
V_111 = F_97 ( F_98 ( V_116 , V_118 ) , V_177 -> V_200 , V_118 ) ;
if ( V_111 != 0 )
goto V_201;
...
int F_102 ( struct V_187 * V_188 , struct V_15 * V_16 , struct V_176 * V_177 ,
T_5 V_118 , int V_203 , int V_74 , int * V_204 )
{
...
V_177 -> V_189 |= V_213 ;
if ( F_109 ( V_116 , 0 , V_177 -> V_200 , V_118 ) ) {
V_118 = - V_134 ;
break;
}
if ( V_74 & V_213 )
...
int F_110 ( struct V_91 * V_15 , int V_71 )
{
struct V_15 * V_16 = V_15 -> V_16 ;
unsigned char V_78 ;
int V_77 ;
F_53 ( V_16 ) ;
V_77 = - V_129 ;
if ( V_15 -> V_1 != V_214 || V_15 -> type != V_215 )
goto V_113;
V_78 = V_16 -> V_18 ;
if ( ! ( ( 1 << V_78 ) & ( V_216 | V_217 ) ) )
goto V_113;
if ( V_78 != V_6 ) {
V_77 = F_31 ( V_16 , V_71 ) ;
if ( V_77 )
...
void F_113 ( struct V_15 * V_16 , long V_221 )
{
struct V_45 * V_46 = F_8 ( V_16 ) ;
struct V_115 * V_116 ;
V_128 V_222 = 0 ;
...
F_114 ( V_16 , & V_46 -> V_202 ) ;
while ( ( V_116 = F_115 ( & V_16 -> V_82 ) ) != NULL ) {
V_222 += V_116 -> V_118 ;
F_39 ( V_116 ) ;
}
if ( V_222 ) {
...
F_13 ( V_16 , V_79 ) ;
F_2 ( V_16 , V_13 ) ;
} else if ( F_17 ( V_16 , V_224 ) && ! V_16 -> V_225 ) {
V_16 -> V_22 -> V_226 ( V_16 , 0 ) ;
...
void F_127 ( struct V_15 * V_16 , int V_228 )
{
F_3 ( L_30 , V_228 ) ;
}
static inline int F_128 ( void )
{
return F_129 ( ( void V_229 * * ) V_230 ,
sizeof( struct V_231 ) ,
F_130 ( struct V_231 ) ) ;
}
static inline void F_131 ( void )
{
F_132 ( ( void V_229 * * ) V_230 ) ;
}
static int T_6 F_133 ( void )
{
unsigned long V_232 ;
int V_233 , V_234 , V_138 ;
int V_111 ;
F_134 ( sizeof( struct V_235 ) >
F_135 ( struct V_115 , V_236 ) ) ;
V_111 = F_136 ( & V_237 , 0 ) ;
if ( V_111 )
goto V_238;
V_111 = - V_139 ;
...
V_239 . V_240 =
F_138 ( L_31 ,
sizeof( struct V_241 ) , 0 ,
V_242 , NULL ) ;
if ( ! V_239 . V_240 )
goto V_243;
if ( V_244 >= ( 128 * 1024 ) )
V_232 = V_244 >> ( 21 - V_245 ) ;
else
V_232 = V_244 >> ( 23 - V_245 ) ;
if ( V_246 )
V_232 = ( V_246 *
sizeof( struct V_247 ) ) >> V_245 ;
for ( V_233 = 0 ; ( 1UL << V_233 ) < V_232 ; V_233 ++ )
;
do {
unsigned long V_248 = ( 1UL << V_233 ) * V_249 /
sizeof( struct V_247 ) ;
while ( V_248 & ( V_248 - 1 ) )
V_248 -- ;
V_239 . V_250 = V_248 - 1 ;
V_239 . V_251 = (struct V_247 * )
F_139 ( V_252 | V_253 , V_233 ) ;
} while ( ! V_239 . V_251 && -- V_233 > 0 );
if ( ! V_239 . V_251 ) {
F_140 ( L_32 ) ;
goto V_254;
}
for ( V_138 = 0 ; V_138 <= V_239 . V_250 ; V_138 ++ ) {
F_141 ( & V_239 . V_251 [ V_138 ] . V_255 , V_138 ) ;
F_141 ( & V_239 . V_251 [ V_138 ] . V_256 , V_138 ) ;
}
if ( F_142 ( & V_239 ) )
goto V_257;
V_234 = V_233 ;
do {
V_239 . V_258 = ( 1UL << V_234 ) * V_249 /
sizeof( struct V_259 ) ;
if ( ( V_239 . V_258 > ( 64 * 1024 ) ) &&
V_234 > 0 )
continue;
V_239 . V_260 = (struct V_259 * )
F_139 ( V_252 | V_253 , V_234 ) ;
} while ( ! V_239 . V_260 && -- V_234 >= 0 );
if ( ! V_239 . V_260 ) {
F_140 ( L_33 ) ;
goto V_261;
}
for ( V_138 = 0 ; V_138 < V_239 . V_258 ; V_138 ++ ) {
F_143 ( & V_239 . V_260 [ V_138 ] . V_262 ) ;
F_144 ( & V_239 . V_260 [ V_138 ] . V_255 ) ;
}
V_111 = F_128 () ;
if ( V_111 )
goto V_263;
...
F_131 () ;
V_263:
F_151 ( ( unsigned long ) V_239 . V_260 , V_234 ) ;
V_261:
F_152 ( & V_239 ) ;
V_257:
F_151 ( ( unsigned long ) V_239 . V_251 , V_233 ) ;
V_254:
F_153 ( V_239 . V_240 ) ;
V_243:
F_154 ( & V_237 ) ;
...
F_156 () ;
F_131 () ;
F_151 ( ( unsigned long ) V_239 . V_260 ,
F_157 ( V_239 . V_258 *
sizeof( struct V_259 ) ) ) ;
F_151 ( ( unsigned long ) V_239 . V_251 ,
F_157 ( ( V_239 . V_250 + 1 ) *
sizeof( struct V_247 ) ) ) ;
F_152 ( & V_239 ) ;
F_153 ( V_239 . V_240 ) ;
