...
static int F_77 ( struct V_32 * V_33 , struct V_87 * V_88 )
{
struct V_1 * V_9 ;
int V_69 , V_11 = 0 ;
unsigned long V_10 ;
...
V_9 -> V_35 |= V_36 ;
F_6 ( & V_9 -> V_12 , V_10 ) ;
if ( ( ( V_69 = F_72 ( V_9 , V_22 , V_37 , V_21 ) ) ) ) {
F_63 ( & V_9 -> V_19 ) ;
F_9 ( V_90 L_32 ) ;
return V_69 ;
}
...
static void F_78 ( struct V_32 * V_33 , struct V_87 * V_88 )
{
struct V_1 * V_9 ;
unsigned long V_10 ;
int V_37 ;
...
static int F_86 ( int V_101 )
{
int V_64 ;
V_56 = F_87 ( V_101 * sizeof( V_57 ) , V_70 ) ;
if ( ! V_56 )
return - V_84 ;
V_57 = V_101 ;
for ( V_64 = 0 ; V_64 < V_57 ; V_64 ++ )
...
{
int V_69 = F_101 ( & V_123 ) ;
if ( V_69 ) {
F_9 ( V_65 L_42 ) ;
return V_69 ;
}
F_102 ( L_43 ) ;
V_69 = F_103 ( & ( V_123 . V_124 ) , & V_125 ) ;
if ( V_69 )
F_104 ( V_65 L_44 , V_69 ) ;
return 0 ;
}
