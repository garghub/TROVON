...
for ( V_15 = 0 ; V_15 < F_20 ( V_24 -> V_117 ) ; V_15 ++ )
V_24 -> V_117 [ V_15 ] . V_119 = V_120 [ V_15 ] ;
V_107 = F_36 ( V_12 -> V_61 , F_20 ( V_24 -> V_117 ) ,
V_24 -> V_117 ) ;
if ( V_107 != 0 ) {
F_22 ( V_12 -> V_61 , L_12 , V_107 ) ;
goto V_121;
}
V_107 = F_29 ( F_20 ( V_24 -> V_117 ) ,
V_24 -> V_117 ) ;
if ( V_107 != 0 ) {
F_22 ( V_12 -> V_61 , L_11 , V_107 ) ;
goto V_122;
}
V_107 = F_37 ( V_12 , 8 , 8 , V_123 ) ;
if ( V_107 < 0 ) {
F_22 ( V_12 -> V_61 , L_13 , V_107 ) ;
return V_107 ;
}
F_38 ( V_12 , V_124 , 0xc2 ) ;
F_38 ( V_12 , V_125 , 0xc2 ) ;
F_38 ( V_12 , V_110 , 0x5c ) ;
F_38 ( V_12 , V_32 , 0x10 ) ;
F_38 ( V_12 , V_126 , 0x60 ) ;
F_38 ( V_12 , V_127 , 0x00 ) ;
F_38 ( V_12 , V_128 , 0x40 ) ;
if ( ! ( V_24 -> V_43 -> V_129 & V_130 ) )
V_118 |= V_131 ;
if ( ! ( V_24 -> V_43 -> V_129 & V_132 ) )
V_118 |= V_133 ;
F_28 ( V_12 , V_39 ,
V_131 | V_133 ,
V_118 ) ;
...
F_39 ( & V_24 -> V_36 , F_11 ) ;
F_27 ( V_12 , V_113 ) ;
F_31 ( F_20 ( V_24 -> V_117 ) , V_24 -> V_117 ) ;
return 0 ;
V_122:
F_40 ( F_20 ( V_24 -> V_117 ) , V_24 -> V_117 ) ;
V_121:
return V_107 ;
}
...
static T_2 int F_43 ( struct V_148 * V_149 ,
const struct V_150 * V_151 )
{
struct V_23 * V_24 ;
int V_107 ;
V_24 = F_44 ( & V_149 -> V_61 , sizeof( struct V_23 ) ,
V_152 ) ;
if ( ! V_24 )
return - V_153 ;
F_45 ( V_149 , V_24 ) ;
V_107 = F_46 ( & V_149 -> V_61 , & V_154 , & V_155 , 1 ) ;
if ( V_107 != 0 )
F_22 ( & V_149 -> V_61 , L_14 , V_107 ) ;
return V_107 ;
}
static T_3 int F_47 ( struct V_148 * V_156 )
{
F_48 ( & V_156 -> V_61 ) ;
return 0 ;
}
