...
type = ( V_45 == V_51 ) ? 1 : 0 ;
V_43 = F_12 ( V_33 , type , V_7 ) ;
if ( V_43 == - 1 )
return false ;
return true ;
}
static void T_6 F_19 ( T_2 * V_52 )
{
V_52 [ 0 ] = V_53 ;
V_52 [ 1 ] = 1 ;
V_52 [ 2 ] = V_54 ;
...
static struct V_55 * T_6 F_21 ( void )
{
struct V_55 * V_56 ;
union V_37 * V_38 ;
T_2 * V_52 ;
V_56 = F_22 ( sizeof( struct V_55 ) , V_57 ) ;
if ( ! V_56 ) {
F_2 ( V_58 L_5 ) ;
return NULL ;
}
V_38 = F_22 ( sizeof( union V_37 ) , V_57 ) ;
if ( ! V_38 ) {
F_2 ( V_58 L_5 ) ;
F_11 ( V_56 ) ;
return NULL ;
...
static int T_6
F_23 ( T_3 V_33 , struct V_55 * V_61 )
{
T_4 V_44 = V_62 ;
if ( V_3 == V_4 ) {
union V_37 * V_38 ;
...
static T_4 T_1
F_27 ( T_3 V_33 , T_2 V_66 , void * V_67 , void * * V_68 )
{
if ( F_16 ( V_33 ) == false )
return V_62 ;
F_25 ( V_33 ) ;
