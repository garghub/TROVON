...
{
const char * V_35 = V_154 -> V_156 + V_29 -> V_34 . V_58 -> V_159 ;
...
static int F_66 ( struct V_44 * V_26 ,
struct V_28 * V_29 , struct V_153 * V_154 )
{
const char * V_35 ;
...
case V_92 :
return F_68 ( V_26 , V_29 -> V_39 . V_40 , V_154 ) &&
F_68 ( V_26 , V_29 -> V_39 . V_41 , V_154 ) ;
case V_93 :
return F_68 ( V_26 , V_29 -> V_39 . V_40 , V_154 ) ||
F_68 ( V_26 , V_29 -> V_39 . V_41 , V_154 ) ;
case V_89 :
return ! F_68 ( V_26 , V_29 -> V_39 . V_41 , V_154 ) ;
default:
return 0 ;
}
}
...
if ( ! V_21 -> V_25 )
return V_160 ;
V_19 = F_71 ( V_27 , V_154 ) ;
V_16 = F_11 ( V_21 , V_19 ) ;
if ( ! V_16 )
return V_161 ;
return F_68 ( V_16 -> V_26 , V_16 -> V_21 , V_154 ) ?
V_162 : V_163 ;
}
static char * F_72 ( struct V_20 * V_21 , struct V_28 * V_29 )
{
char * V_34 = NULL ;
char * V_40 = NULL ;
char * V_41 = NULL ;
...
V_165 = 0 ;
if ( V_164 >= 0 ) {
if ( ( V_29 -> V_39 . type == V_92 && ! V_164 ) ||
( V_29 -> V_39 . type == V_93 && V_164 ) ) {
V_34 = V_40 ;
V_40 = NULL ;
break;
}
...
if ( V_165 >= 0 ) {
if ( ( V_29 -> V_39 . type == V_92 && ! V_165 ) ||
( V_29 -> V_39 . type == V_93 && V_165 ) ) {
V_34 = V_41 ;
V_41 = NULL ;
break;
}
...
V_34 = F_4 ( V_6 ) ;
snprintf ( V_34 , V_6 , L_58 , V_39 , V_41 ) ;
break;
default:
break;
}
...
char * V_34 ;
V_34 = F_4 ( 30 ) ;
snprintf ( V_34 , 30 , L_59 , V_29 -> V_62 . V_35 ) ;
return V_34 ;
}
...
char * V_34 ;
int V_6 ;
V_166 = F_52 ( V_21 , V_29 -> exp . V_40 ) ;
V_167 = F_52 ( V_21 , V_29 -> exp . V_41 ) ;
switch ( V_29 -> exp . type ) {
case V_96 :
V_39 = L_16 ;
break;
...
V_6 = strlen ( V_39 ) + strlen ( V_166 ) + strlen ( V_167 ) + 4 ;
V_34 = F_4 ( V_6 ) ;
snprintf ( V_34 , V_6 , L_61 , V_166 , V_39 , V_167 ) ;
free ( V_166 ) ;
free ( V_167 ) ;
return V_34 ;
}
...
char * V_39 = NULL ;
int V_6 ;
V_166 = F_52 ( V_21 , V_29 -> V_78 . V_40 ) ;
V_167 = F_52 ( V_21 , V_29 -> V_78 . V_41 ) ;
switch ( V_29 -> V_78 . type ) {
case V_82 :
V_39 = L_27 ;
case V_84 :
...
if ( ! V_39 )
V_39 = L_31 ;
V_6 = strlen ( V_166 ) + strlen ( V_39 ) + strlen ( V_167 ) + 4 ;
V_34 = F_4 ( V_6 ) ;
sprintf ( V_34 , L_61 , V_166 , V_39 , V_167 ) ;
break;
default:
break;
}
...
int F_78 ( struct V_20 * V_168 , struct V_20 * V_169 )
{
struct V_16 * V_170 ;
struct V_16 * V_171 ;
char * V_172 , * V_173 ;
int V_174 ;
int V_7 ;
if ( V_168 -> V_25 != V_169 -> V_25 )
return 0 ;
if ( ! V_168 -> V_25 && ! V_169 -> V_25 )
return 1 ;
for ( V_7 = 0 ; V_7 < V_168 -> V_25 ; V_7 ++ ) {
V_170 = & V_168 -> V_24 [ V_7 ] ;
V_171 = F_11 ( V_169 , V_170 -> V_19 ) ;
if ( ! V_171 )
break;
if ( V_170 -> V_21 -> type != V_171 -> V_21 -> type )
break;
switch ( V_170 -> V_21 -> type ) {
case V_149 :
case V_150 :
continue;
default:
...
V_172 = F_52 ( V_168 , V_170 -> V_21 ) ;
V_173 = F_52 ( V_169 , V_171 -> V_21 ) ;
V_174 = strcmp ( V_172 , V_173 ) != 0 ;
free ( V_172 ) ;
free ( V_173 ) ;
if ( V_174 )
break;
