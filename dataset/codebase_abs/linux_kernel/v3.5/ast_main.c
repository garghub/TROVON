...
struct V_48 * V_49 ;
int V_8 ;
V_50 = F_24 ( V_10 , V_59 , V_56 -> V_60 [ 0 ] ) ;
if ( V_50 == NULL )
return F_25 ( - V_61 ) ;
V_49 = F_26 ( sizeof( * V_49 ) , V_62 ) ;
if ( ! V_49 ) {
F_15 ( V_50 ) ;
return F_25 ( - V_63 ) ;
}
V_8 = F_19 ( V_10 , V_49 , V_56 , V_50 ) ;
if ( V_8 ) {
F_15 ( V_50 ) ;
F_17 ( V_49 ) ;
return F_25 ( V_8 ) ;
...
int F_29 ( struct V_9 * V_10 , unsigned long V_69 )
{
struct V_1 * V_2 ;
int V_8 = 0 ;
V_2 = F_26 ( sizeof( struct V_1 ) , V_62 ) ;
if ( ! V_2 )
return - V_63 ;
V_10 -> V_11 = V_2 ;
V_2 -> V_10 = V_10 ;
V_2 -> V_70 = F_30 ( V_10 -> V_12 , 1 , 0 ) ;
if ( ! V_2 -> V_70 ) {
V_8 = - V_71 ;
goto V_72;
}
V_2 -> V_73 = F_30 ( V_10 -> V_12 , 2 , 0 ) ;
if ( ! V_2 -> V_73 ) {
V_8 = - V_71 ;
goto V_72;
}
...
F_11 ( V_10 ) ;
V_2 -> V_74 = F_27 ( V_10 ) ;
F_8 ( L_9 , V_2 -> V_36 , V_2 -> V_29 , V_2 -> V_28 , V_2 -> V_74 ) ;
}
V_8 = F_31 ( V_2 ) ;
if ( V_8 )
goto V_72;
F_32 ( V_10 ) ;
V_10 -> V_75 . V_76 = ( void * ) & V_77 ;
V_10 -> V_75 . V_78 = 0 ;
V_10 -> V_75 . V_79 = 0 ;
V_10 -> V_75 . V_80 = 24 ;
V_10 -> V_75 . V_81 = 1 ;
...
F_38 ( V_10 ) ;
F_39 ( V_2 ) ;
F_40 ( V_10 -> V_12 , V_2 -> V_73 ) ;
F_40 ( V_10 -> V_12 , V_2 -> V_70 ) ;
F_17 ( V_2 ) ;
return 0 ;
}
...
args -> V_84 = args -> V_93 * args -> V_95 ;
V_8 = F_41 ( V_10 , args -> V_84 , false ,
& V_92 ) ;
if ( V_8 )
return V_8 ;
V_8 = F_45 ( V_52 , V_92 , & V_53 ) ;
F_15 ( V_92 ) ;
if ( V_8 )
return V_8 ;
args -> V_53 = V_53 ;
...
int F_46 ( struct V_51 * V_52 ,
struct V_9 * V_10 ,
T_1 V_53 )
{
return F_47 ( V_52 , V_53 ) ;
}
int F_48 ( struct V_57 * V_50 )
{
F_49 () ;
return 0 ;
}
void F_50 ( struct V_86 * * V_96 )
{
struct V_97 * V_98 ;
if ( ( * V_96 ) == NULL )
return;
...
void F_52 ( struct V_57 * V_50 )
{
struct V_86 * V_86 = F_53 ( V_50 ) ;
if ( ! V_86 )
return;
F_50 ( & V_86 ) ;
}
static inline T_5 F_54 ( struct V_86 * V_96 )
{
return V_96 -> V_96 . V_99 ;
}
int
