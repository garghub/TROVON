...
if ( V_75 + 3 > V_76 )
break;
if ( memcmp ( & V_4 -> V_77 , & V_45 [ V_75 - 1 ] , 4 ) == 0 )
break;
}
if ( V_75 + 3 <= V_76 ) {
V_4 -> V_50 = 1 ;
F_12 ( V_2 ) -> V_5 = V_4 -> V_77 ;
...
memcpy ( & V_77 , & V_45 [ V_75 - 1 ] , 4 ) ;
V_80 = V_2 -> V_86 ;
F_32 ( V_2 , NULL ) ;
V_81 = F_33 ( V_2 , V_77 , V_9 -> V_41 , V_9 -> V_87 , V_2 -> V_37 ) ;
V_79 = F_8 ( V_2 ) ;
