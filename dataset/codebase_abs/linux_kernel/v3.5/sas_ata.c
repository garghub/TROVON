...
F_18 ( & V_30 -> V_89 , 1 , 0 , ( V_94 * ) & V_28 -> V_95 . V_59 ) ;
V_28 -> V_31 = V_30 ;
if ( F_19 ( V_30 -> V_89 . V_96 ) ) {
...
V_28 -> V_107 = V_30 -> V_70 ;
V_28 -> V_95 . V_108 = 1 ;
V_28 -> V_109 = V_110 ;
V_30 -> V_67 = V_28 ;
switch ( V_30 -> V_89 . V_96 ) {
case V_111 :
V_28 -> V_95 . V_112 = 1 ;
case V_113 :
case V_114 :
...
F_6 ( V_30 -> V_50 , V_28 ) ;
if ( V_38 -> V_116 < 2 )
V_71 = V_81 -> V_117 -> V_118 ( V_28 , 1 , V_85 ) ;
else
V_71 = F_21 ( V_28 ) ;
if ( V_71 ) {
F_2 ( L_3 , V_71 ) ;
...
F_25 ( V_33 -> V_56 . V_59 , & V_30 -> V_119 ) ;
return true ;
}
...
memcpy ( V_33 -> V_134 , & V_33 -> V_56 . V_132 . V_135 . V_59 ,
sizeof( struct V_136 ) ) ;
F_30 ( V_33 ) ;
}
return 0 ;
...
F_41 = F_32 ;
F_35 ( V_121 ) ;
V_71 = F_43 ( V_44 , V_156 , F_41 ) ;
if ( V_71 && V_71 != - V_160 )
F_37 ( V_161 , V_33 , L_8 , V_71 ) ;
...
else if ( ( V_59 -> V_191 == 1 &&
V_59 -> V_188 == 1 &&
V_59 -> V_192 == 0x14 &&
V_59 -> V_193 == 0xEB &&
( V_59 -> V_148 & ~ 0x10 ) == 0 ) )
V_33 -> V_56 . V_57 = V_58 ;
else if ( ( V_59 -> V_187 == 1 &&
V_59 -> V_188 == 1 &&
V_59 -> V_189 == 0x3C &&
V_59 -> V_190 == 0xC3 &&
V_59 -> V_148 == 0 )
...
F_73 ( V_40 -> V_78 . V_79 , V_46 ) ;
F_74 ( V_33 ) ;
}
void F_75 ( struct V_76 * V_79 )
{
struct V_37 * V_38 = F_76 ( V_79 ) ;
F_77 ( V_202 ) ;
int V_81 ;
F_78 ( V_38 ) ;
F_79 ( & V_38 -> V_203 ) ;
for ( V_81 = 0 ; V_81 < V_38 -> V_204 ; V_81 ++ ) {
struct V_194 * V_39 = V_38 -> V_205 [ V_81 ] ;
struct V_32 * V_33 ;
F_22 ( & V_39 -> V_206 ) ;
...
void F_84 ( struct V_76 * V_79 , struct V_207 * V_208 ,
struct V_207 * V_209 )
{
