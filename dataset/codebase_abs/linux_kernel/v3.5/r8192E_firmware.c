...
if ( V_68 != V_55 ) {
memcpy ( V_6 -> V_86 [ V_68 ] ,
V_81 -> V_29 , V_81 -> V_85 ) ;
V_6 -> V_78 [ V_68 ] =
V_81 -> V_85 ;
} else {
memset ( V_6 -> V_86 [ V_68 ] ,
0 , 128 ) ;
memcpy ( & V_6 -> V_86 [ V_68 ] [ 128 ] ,
V_81 -> V_29 , V_81 -> V_85 ) ;
V_6 -> V_78 [ V_68 ] =
V_81 -> V_85 + 128 ;
}
...
V_66 = V_65 [ V_68 ] ;
if ( V_68 == V_58 ) {
memcpy ( V_6 -> V_86 [ V_68 ] , V_67 , V_66 ) ;
V_6 -> V_78 [ V_68 ] = V_66 ;
}
break;
default:
