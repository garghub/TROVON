...
V_2 = F_24 ( & V_6 -> V_16 , sizeof( struct V_1 ) , V_51 ) ;
if ( V_2 == NULL ) {
F_9 ( V_16 , L_7 ) ;
return - V_52 ;
}
...
int F_33 ( struct V_1 * V_25 , T_2 V_59 )
{
int V_23 ;
F_4 ( V_25 -> V_16 , L_12 , V_60 , V_59 . V_61 ) ;
if ( V_59 . V_61 == V_62 ) {
V_23 = F_13 ( V_25 , V_54 ) ;
if ( V_25 -> V_28 -> V_63 == V_64 ) {
F_3 ( V_25 , V_65 , V_25 -> V_66 |
V_67 |
V_68 ) ;
V_25 -> V_32 = 0 ;
}
