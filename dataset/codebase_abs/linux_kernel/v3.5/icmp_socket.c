...
V_29 -> V_53 = V_5 -> V_11 ;
if ( V_29 -> V_48 . V_54 != V_55 ) {
V_29 -> V_51 = V_56 ;
V_29 -> V_48 . V_54 = V_55 ;
F_32 ( V_5 , V_29 , V_25 ) ;
goto V_47;
}
if ( F_33 ( & V_12 -> V_57 ) != V_58 )
goto V_59;
V_42 = F_34 ( V_12 , V_29 -> V_60 ) ;
if ( ! V_42 )
goto V_59;
V_43 = F_35 ( V_42 ) ;
if ( ! V_43 )
...
memcpy ( V_29 -> V_68 ,
V_43 -> V_61 -> V_65 -> V_66 , V_67 ) ;
F_36 ( V_40 , V_43 -> V_61 , V_43 -> V_69 ) ;
goto V_45;
V_59:
V_29 -> V_51 = V_70 ;
F_32 ( V_5 , V_29 , V_25 ) ;
...
static unsigned int F_41 ( struct V_3 * V_3 , T_5 * V_71 )
{
struct V_5 * V_5 = V_3 -> V_16 ;
F_42 ( V_3 , & V_5 -> V_15 , V_71 ) ;
if ( V_5 -> V_10 > 0 )
return V_72 | V_73 ;
return 0 ;
}
