...
{
struct V_74 * V_75 = V_6 -> V_27 ;
struct V_76 * V_77 = F_21 ( F_22 ( V_75 ) , V_78 ) ;
if ( V_77 -> V_79 ) {
V_6 -> V_80 = F_23 ( V_75 -> V_28 ,
V_81 , V_77 -> V_79 ,
& V_82 , V_6 ) ;
if ( V_6 -> V_80 == NULL )
F_24 ( L_47 ,
...
memcpy ( V_6 -> V_84 , V_75 -> V_28 , V_85 ) ;
}
}
...
struct V_74 * V_75 = V_6 -> V_27 ;
struct V_76 * V_77 = F_21 ( F_22 ( V_75 ) , V_78 ) ;
if ( V_77 -> V_79 && V_6 -> V_80 ) {
F_26 ( V_6 -> V_84 , V_77 -> V_79 ) ;
memset ( V_6 -> V_84 , 0 , V_85 ) ;
V_6 -> V_80 = NULL ;
}
}
void T_4 F_27 ( struct V_76 * V_77 )
{
if ( ! V_77 -> V_79 ) {
V_77 -> V_79 = F_28 ( V_83 , V_77 -> V_86 -> V_87 ) ;
if ( ! V_77 -> V_79 )
F_24 ( L_48 ,
V_83 ) ;
}
}
void T_5 F_29 ( struct V_76 * V_77 )
{
if ( V_77 -> V_79 ) {
F_26 ( V_83 , V_77 -> V_86 -> V_87 ) ;
V_77 -> V_79 = NULL ;
}
}
