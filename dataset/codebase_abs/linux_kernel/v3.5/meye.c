...
static int F_98 ( struct V_250 * V_251 , T_7 V_108 )
{
F_99 ( V_251 ) ;
V_7 . V_252 = V_7 . V_71 ;
F_37 () ;
...
static int F_100 ( struct V_250 * V_251 )
{
F_101 ( V_251 ) ;
F_102 ( V_7 . V_9 , V_253 , 1 ) ;
F_28 ( V_74 , 0 ) ;
F_28 ( V_38 , V_46 ) ;
F_38 ( 1 ) ;
F_25 ( V_254 , 1 ) ;
...
static int T_8 F_103 ( struct V_250 * V_257 ,
const struct V_258 * V_259 )
{
struct V_260 * V_261 = & V_7 . V_261 ;
int V_262 = - V_117 ;
unsigned long V_263 ;
if ( V_7 . V_9 != NULL ) {
F_17 ( V_76 L_25 ) ;
...
memcpy ( V_7 . V_265 , & V_269 , sizeof( V_269 ) ) ;
V_7 . V_265 -> V_261 = & V_7 . V_261 ;
V_262 = - V_270 ;
if ( ( V_262 = F_62 ( V_271 , 1 ) ) ) {
F_105 ( V_261 , L_30 ) ;
F_105 ( V_261 , L_31
L_32 ) ;
goto V_272;
}
if ( ( V_262 = F_110 ( V_7 . V_9 ) ) ) {
F_105 ( V_261 , L_33 ) ;
goto V_273;
}
V_263 = F_111 ( V_7 . V_9 , 0 ) ;
if ( ! V_263 ) {
F_105 ( V_261 , L_34 ) ;
goto V_274;
}
...
V_7 . V_31 = F_114 ( V_263 , V_275 ) ;
if ( ! V_7 . V_31 ) {
F_105 ( V_261 , L_36 ) ;
goto V_276;
}
V_7 . V_277 = V_257 -> V_95 ;
if ( F_115 ( V_7 . V_277 , F_49 ,
V_278 | V_279 , L_8 , F_49 ) ) {
F_105 ( V_261 , L_37 ) ;
goto V_280;
}
...
V_286 ) ;
F_121 ( V_261 , L_40 ,
V_7 . V_9 -> V_287 , V_263 , V_7 . V_277 ) ;
return 0 ;
V_285:
F_122 ( V_7 . V_277 , F_49 ) ;
V_280:
F_123 ( V_7 . V_31 ) ;
V_276:
...
static void T_9 F_128 ( struct V_250 * V_257 )
{
F_129 ( V_7 . V_265 ) ;
F_37 () ;
F_36 () ;
