...
static int F_49 ( struct V_22 * V_93 ,
...
V_20 -> V_97 = & V_98 ;
V_20 -> V_99 = V_100 ;
V_20 -> V_101 = V_100 | V_102 ;
F_53 ( V_20 , & V_103 ) ;
F_54 ( V_20 , & V_93 -> V_104 ) ;
V_24 = F_55 ( V_20 ) ;
if ( V_24 != 0 ) {
F_56 ( L_9 ) ;
F_57 ( V_20 ) ;
...
memcpy ( V_20 -> V_106 , V_82 . V_107 , V_108 ) ;
F_30 ( V_20 ) ;
V_105:
return V_24 ;
}
static int F_59 ( struct V_22 * V_93 )
{
struct V_19 * V_20 ;
struct V_3 * V_64 ;
struct V_6 * V_19 ;
