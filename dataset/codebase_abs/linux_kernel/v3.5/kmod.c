...
int (* V_40)( struct V_1 * V_2 , struct V_27 * V_28 ) ,
void (* V_42)( struct V_1 * ) , void * V_25 )
{
struct V_1 * V_2 ;
T_4 V_75 = ( V_5 == V_59 ) ? V_81 : V_7 ;
V_2 = F_59 ( V_41 , V_3 , V_6 , V_75 ) ;
if ( V_2 == NULL )
return - V_12 ;
F_62 ( V_2 , V_40 , V_42 , V_25 ) ;
return F_63 ( V_2 , V_5 ) ;
}
static int F_68 ( struct V_82 * V_83 , int V_84 ,
void V_53 * V_85 , T_5 * V_86 , T_6 * V_87 )
{
struct V_82 V_88 ;
...
if ( V_83 -> V_25 == V_97 )
V_89 [ V_93 ] = V_37 . V_98 [ V_93 ] ;
else if ( V_83 -> V_25 == V_99 )
V_89 [ V_93 ] = V_39 . V_98 [ V_93 ] ;
else
F_70 () ;
}
F_26 ( & V_35 ) ;
V_88 = * V_83 ;
V_88 . V_25 = & V_89 ;
V_92 = F_71 ( & V_88 , V_84 , V_85 , V_86 , V_87 ) ;
if ( V_92 < 0 )
return V_92 ;
for ( V_93 = 0 ; V_93 < V_90 ; V_93 ++ )
V_91 . V_98 [ V_93 ] = V_89 [ V_93 ] ;
F_24 ( & V_35 ) ;
if ( V_84 ) {
if ( V_83 -> V_25 == V_97 )
V_37 = F_25 ( V_37 , V_91 ) ;
