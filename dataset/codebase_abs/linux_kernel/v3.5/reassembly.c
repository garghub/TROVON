...
bool F_8 ( struct V_15 * V_16 , void * V_20 )
{
struct V_17 * V_18 ;
struct V_21 * V_22 = V_20 ;
V_18 = F_7 ( V_16 , struct V_17 , V_16 ) ;
return V_18 -> V_6 == V_22 -> V_6 &&
V_18 -> V_23 == V_22 -> V_23 &&
...
F_52 ( V_79 == NULL ) ;
F_52 ( F_41 ( V_79 ) -> V_51 != 0 ) ;
V_55 = ( ( V_79 -> V_30 - F_34 ( V_79 ) ) -
sizeof( struct V_67 ) + V_18 -> V_16 . V_65 -
sizeof( struct V_46 ) ) ;
if ( V_55 > V_57 )
goto V_83;
if ( F_53 ( V_79 ) && F_54 ( V_79 , 0 , 0 , V_81 ) )
goto V_82;
if ( F_55 ( V_79 ) ) {
struct V_44 * V_84 ;
int V_85 , V_86 = 0 ;
if ( ( V_84 = F_56 ( 0 , V_81 ) ) == NULL )
goto V_82;
V_84 -> V_50 = V_79 -> V_50 ;
V_79 -> V_50 = V_84 ;
F_57 ( V_84 ) -> V_87 = F_57 ( V_79 ) -> V_87 ;
F_58 ( V_79 ) ;
for ( V_85 = 0 ; V_85 < F_57 ( V_79 ) -> V_88 ; V_85 ++ )
V_86 += F_59 ( & F_57 ( V_79 ) -> V_3 [ V_85 ] ) ;
V_84 -> V_65 = V_84 -> V_89 = V_79 -> V_89 - V_86 ;
V_79 -> V_89 -= V_84 -> V_65 ;
V_79 -> V_65 -= V_84 -> V_65 ;
V_84 -> V_63 = 0 ;
V_84 -> V_60 = V_79 -> V_60 ;
F_42 ( V_84 -> V_75 , & V_18 -> V_16 . V_1 -> V_5 ) ;
}
V_48 = V_18 -> V_76 ;
F_34 ( V_79 ) [ V_48 ] = F_60 ( V_79 ) [ 0 ] ;
...
V_79 -> V_63 = F_63 ( V_79 -> V_63 , V_78 -> V_63 ) ;
if ( F_64 ( V_79 , V_78 , & V_92 , & V_93 ) ) {
F_65 ( V_78 , V_92 ) ;
} else {
if ( ! F_57 ( V_79 ) -> V_87 )
F_57 ( V_79 ) -> V_87 = V_78 ;
...
struct V_46 * V_47 ;
struct V_17 * V_18 ;
const struct V_67 * V_97 = F_31 ( V_45 ) ;
struct V_1 * V_1 = F_28 ( F_29 ( V_45 ) -> V_32 ) ;
F_22 ( V_1 , F_32 ( F_29 ( V_45 ) ) , V_98 ) ;
if ( V_97 -> V_55 == 0 )
goto V_99;
if ( ! F_71 ( V_45 , ( F_72 ( V_45 ) +
sizeof( struct V_46 ) ) ) )
goto V_99;
V_97 = F_31 ( V_45 ) ;
V_47 = (struct V_46 * ) F_60 ( V_45 ) ;
if ( ! ( V_47 -> V_54 & F_37 ( 0xFFF9 ) ) ) {
V_45 -> V_100 += sizeof( struct V_46 ) ;
F_22 ( V_1 ,
F_32 ( F_29 ( V_45 ) ) , V_95 ) ;
F_67 ( V_45 ) -> V_48 = ( V_56 * ) V_47 - F_34 ( V_45 ) ;
return 1 ;
}
if ( F_3 ( & V_1 -> V_2 . V_3 . V_5 ) > V_1 -> V_2 . V_3 . V_101 )
F_15 ( V_1 , F_32 ( F_29 ( V_45 ) ) ) ;
V_18 = F_73 ( V_1 , V_47 -> V_102 , & V_97 -> V_8 , & V_97 -> V_9 ) ;
if ( V_18 != NULL ) {
int V_103 ;
F_19 ( & V_18 -> V_16 . V_33 ) ;
V_103 = F_27 ( V_18 , V_45 , V_47 , F_67 ( V_45 ) -> V_48 ) ;
F_26 ( & V_18 -> V_16 . V_33 ) ;
F_11 ( V_18 ) ;
return V_103 ;
}
...
F_33 ( V_45 , V_59 , F_68 ( V_45 ) ) ;
return - 1 ;
}
static int T_4 F_74 ( struct V_1 * V_1 )
{
struct V_104 * V_105 ;
struct V_106 * V_97 ;
V_105 = V_107 ;
if ( ! F_75 ( V_1 , & V_108 ) ) {
V_105 = F_76 ( V_105 , sizeof( V_107 ) , V_109 ) ;
if ( V_105 == NULL )
goto V_110;
V_105 [ 0 ] . V_30 = & V_1 -> V_2 . V_3 . V_101 ;
V_105 [ 1 ] . V_30 = & V_1 -> V_2 . V_3 . V_111 ;
V_105 [ 2 ] . V_30 = & V_1 -> V_2 . V_3 . V_112 ;
}
V_97 = F_77 ( V_1 , L_3 , V_105 ) ;
if ( V_97 == NULL )
goto V_113;
V_1 -> V_2 . V_114 . V_115 = V_97 ;
return 0 ;
V_113:
if ( ! F_75 ( V_1 , & V_108 ) )
F_78 ( V_105 ) ;
...
static void T_5 F_79 ( struct V_1 * V_1 )
{
struct V_104 * V_105 ;
V_105 = V_1 -> V_2 . V_114 . V_115 -> V_117 ;
F_80 ( V_1 -> V_2 . V_114 . V_115 ) ;
if ( ! F_75 ( V_1 , & V_108 ) )
F_78 ( V_105 ) ;
}
static int F_81 ( void )
{
V_118 = F_77 ( & V_108 , L_3 ,
V_119 ) ;
...
static int T_4 F_83 ( struct V_1 * V_1 )
{
V_1 -> V_2 . V_3 . V_101 = V_120 ;
V_1 -> V_2 . V_3 . V_111 = V_121 ;
V_1 -> V_2 . V_3 . V_112 = V_122 ;
F_84 ( & V_1 -> V_2 . V_3 ) ;
return F_74 ( V_1 ) ;
}
static void T_5 F_85 ( struct V_1 * V_1 )
{
F_79 ( V_1 ) ;
F_86 ( & V_1 -> V_2 . V_3 , & V_19 ) ;
}
int T_6 F_87 ( void )
{
int V_103 ;
V_103 = F_88 ( & V_123 , V_124 ) ;
if ( V_103 )
goto V_36;
V_103 = F_81 () ;
if ( V_103 )
