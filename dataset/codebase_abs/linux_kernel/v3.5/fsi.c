...
int V_71 , V_72 ;
V_33 = & V_14 -> V_50 ;
V_71 = F_35 ( V_33 , V_73 , V_14 , V_33 ) ;
V_33 = & V_14 -> V_54 ;
V_72 = F_35 ( V_33 , V_73 , V_14 , V_33 ) ;
if ( V_71 < 0 )
return V_71 ;
if ( V_72 < 0 )
return V_72 ;
...
int V_71 , V_72 ;
V_33 = & V_14 -> V_50 ;
V_71 = F_35 ( V_33 , remove , V_14 , V_33 ) ;
V_33 = & V_14 -> V_54 ;
...
static int F_51 ( struct V_75 * V_67 , struct V_13 * V_14 ,
long V_98 , int V_93 )
{
T_3 V_31 = F_20 ( V_14 ) ;
int V_7 ;
...
V_148 = F_34 ( V_55 , V_33 -> V_61 ) ;
V_119 = F_77 ( V_33 ) ;
F_81 ( V_26 -> V_67 , V_119 , V_148 , V_138 ) ;
F_82 ( & V_146 , 1 ) ;
F_83 ( & V_146 , F_84 ( F_85 ( V_119 ) ) ,
V_148 , F_86 ( V_119 ) ) ;
F_87 ( & V_146 ) = V_119 ;
F_88 ( & V_146 ) = V_148 ;
V_144 = F_89 ( V_142 , & V_146 , 1 , V_138 ,
V_149 | V_150 ) ;
if ( ! V_144 ) {
F_37 ( V_26 -> V_67 , L_6 ) ;
return;
...
F_52 ( V_14 , V_154 , V_155 , V_155 ) ;
F_29 ( V_14 , V_46 , 0 ) ;
}
}
}
static bool F_91 ( struct V_141 * V_142 , void * V_156 )
{
struct V_157 * V_158 = V_156 ;
V_142 -> V_159 = V_158 ;
return true ;
}
static int F_92 ( struct V_13 * V_14 , struct V_32 * V_33 )
{
F_93 ( & V_33 -> V_160 ) ;
return 0 ;
}
static void F_94 ( struct V_13 * V_14 , struct V_32 * V_33 ,
int V_161 )
{
struct V_5 * V_6 = F_11 ( V_14 ) ;
T_1 V_129 = F_13 ( V_14 ) ? V_130 : V_131 ;
T_1 V_93 = V_161 ? V_162 : 0 ;
F_52 ( V_14 , V_86 , V_162 , V_93 ) ;
F_95 ( V_33 -> V_142 ) ;
if ( F_12 ( V_14 ) )
F_67 ( V_6 , V_132 , V_129 , ( V_93 ) ? V_129 : 0 ) ;
}
...
F_97 ( V_3 ) ;
F_98 ( V_163 , V_3 ) ;
V_33 -> V_142 = F_99 ( V_3 , F_91 , & V_33 -> V_158 ) ;
if ( ! V_33 -> V_142 )
return - V_69 ;
F_100 ( & V_33 -> V_160 , F_80 , ( unsigned long ) V_33 ) ;
return 0 ;
}
static int F_101 ( struct V_13 * V_14 , struct V_32 * V_33 )
{
F_102 ( & V_33 -> V_160 ) ;
F_103 ( V_14 , V_33 ) ;
if ( V_33 -> V_142 )
...
F_52 ( V_14 , V_167 , V_155 , V_155 ) ;
} else {
F_29 ( V_14 , V_154 , V_168 ) ;
F_52 ( V_14 , V_154 , V_155 , V_155 ) ;
}
}
...
switch ( V_33 -> V_64 ) {
case 2 :
V_2 = F_108 ( 16 , V_33 -> V_65 ) ;
break;
case 4 :
V_2 = F_108 ( 24 , V_33 -> V_65 ) ;
break;
}
F_41 ( V_14 , V_33 , V_2 , V_67 ) ;
F_46 ( V_14 , V_33 ) ;
F_49 ( V_14 ) ;
F_105 ( V_14 , V_33 , V_67 ) ;
return 0 ;
}
...
static int F_112 ( struct V_17 * V_18 , int V_178 ,
struct V_21 * V_26 )
{
struct V_13 * V_14 = F_19 ( V_18 ) ;
...
case V_179 :
F_33 ( V_14 , V_33 , V_18 ) ;
F_107 ( V_14 , V_33 , V_26 -> V_67 ) ;
V_7 = F_38 ( V_33 ) ;
if ( 0 == V_7 )
F_113 ( V_14 , V_33 ) ;
break;
case V_180 :
F_109 ( V_14 , V_26 -> V_67 ) ;
F_103 ( V_14 , V_33 ) ;
F_36 ( V_14 , V_33 ) ;
break;
}
...
static int F_114 ( struct V_13 * V_14 , unsigned int V_76 )
{
switch ( V_76 & V_181 ) {
case V_182 :
V_14 -> V_76 = V_183 ;
...
static int F_116 ( struct V_21 * V_26 , unsigned int V_76 )
{
...
static T_10 F_127 ( struct V_17 * V_18 )
{
struct V_13 * V_14 = F_19 ( V_18 ) ;
struct V_32 * V_33 = F_30 ( V_14 , V_18 ) ;
return F_25 ( V_14 , V_33 -> V_60 ) ;
}
static void F_128 ( struct V_198 * V_199 )
{
F_129 ( V_199 ) ;
}
...
{
V_14 -> V_50 . V_204 = & V_205 ;
V_14 -> V_50 . V_56 = V_14 ;
V_14 -> V_54 . V_204 = & V_206 ;
V_14 -> V_54 . V_56 = V_14 ;
if ( V_14 -> V_30 -> V_207 ) {
V_14 -> V_50 . V_158 . V_208 = V_14 -> V_30 -> V_207 ;
V_14 -> V_50 . V_204 = & V_209 ;
}
}
...
struct V_214 * V_30 = V_211 -> V_67 . V_215 ;
struct V_216 * V_217 ;
unsigned int V_133 ;
int V_7 ;
V_213 = V_211 -> V_213 ;
if ( ! V_213 ) {
F_37 ( & V_211 -> V_67 , L_11 ) ;
return - V_218 ;
}
V_217 = F_135 ( V_211 , V_219 , 0 ) ;
V_133 = F_136 ( V_211 , 0 ) ;
if ( ! V_217 || ( int ) V_133 <= 0 ) {
F_37 ( & V_211 -> V_67 , L_12 ) ;
V_7 = - V_218 ;
goto exit;
}
V_6 = F_137 ( sizeof( * V_6 ) , V_201 ) ;
if ( ! V_6 ) {
F_37 ( & V_211 -> V_67 , L_13 ) ;
V_7 = - V_220 ;
goto exit;
}
V_6 -> V_10 = F_138 ( V_217 -> V_161 , F_139 ( V_217 ) ) ;
if ( ! V_6 -> V_10 ) {
V_7 = - V_221 ;
F_37 ( & V_211 -> V_67 , L_14 ) ;
goto V_222;
}
V_6 -> V_133 = V_133 ;
V_6 -> V_11 = (struct V_223 * ) V_213 -> V_224 ;
F_140 ( & V_6 -> V_9 ) ;
V_6 -> V_28 . V_10 = V_6 -> V_10 ;
V_6 -> V_28 . V_6 = V_6 ;
V_6 -> V_28 . V_30 = & V_30 -> V_225 ;
F_133 ( & V_6 -> V_28 ) ;
V_7 = F_39 ( & V_6 -> V_28 ) ;
if ( V_7 < 0 ) {
F_37 ( & V_211 -> V_67 , L_15 ) ;
goto V_226;
}
V_6 -> V_29 . V_10 = V_6 -> V_10 + 0x40 ;
V_6 -> V_29 . V_6 = V_6 ;
V_6 -> V_29 . V_30 = & V_30 -> V_227 ;
F_133 ( & V_6 -> V_29 ) ;
V_7 = F_39 ( & V_6 -> V_29 ) ;
if ( V_7 < 0 ) {
F_37 ( & V_211 -> V_67 , L_16 ) ;
goto V_228;
}
F_141 ( & V_211 -> V_67 ) ;
F_142 ( & V_211 -> V_67 , V_6 ) ;
V_7 = F_143 ( V_133 , & F_71 , 0 ,
V_213 -> V_229 , V_6 ) ;
if ( V_7 ) {
F_37 ( & V_211 -> V_67 , L_17 ) ;
goto V_230;
}
V_7 = F_144 ( & V_211 -> V_67 , & V_231 ) ;
if ( V_7 < 0 ) {
F_37 ( & V_211 -> V_67 , L_18 ) ;
goto V_232;
}
V_7 = F_145 ( & V_211 -> V_67 , V_233 ,
F_146 ( V_233 ) ) ;
if ( V_7 < 0 ) {
F_37 ( & V_211 -> V_67 , L_19 ) ;
goto V_234;
}
return V_7 ;
V_234:
...
{
struct V_5 * V_6 ;
V_6 = F_153 ( & V_211 -> V_67 ) ;
F_148 ( V_6 -> V_133 , V_6 ) ;
F_150 ( & V_211 -> V_67 ) ;
F_154 ( & V_211 -> V_67 , F_146 ( V_233 ) ) ;
F_147 ( & V_211 -> V_67 ) ;
F_40 ( & V_6 -> V_28 ) ;
F_40 ( & V_6 -> V_29 ) ;
F_149 ( V_6 -> V_10 ) ;
...
if ( ! F_31 ( V_14 , V_33 ) )
return;
F_107 ( V_14 , V_33 , V_67 ) ;
if ( F_12 ( V_14 ) && V_14 -> V_98 )
F_51 ( V_67 , V_14 , V_14 -> V_98 , 1 ) ;
F_113 ( V_14 , V_33 ) ;
}
static int F_157 ( struct V_75 * V_67 )
{
struct V_5 * V_6 = F_153 ( V_67 ) ;
struct V_13 * V_28 = & V_6 -> V_28 ;
struct V_13 * V_29 = & V_6 -> V_29 ;
F_155 ( V_28 , & V_28 -> V_50 , V_67 ) ;
F_155 ( V_28 , & V_28 -> V_54 , V_67 ) ;
F_155 ( V_29 , & V_29 -> V_50 , V_67 ) ;
F_155 ( V_29 , & V_29 -> V_54 , V_67 ) ;
return 0 ;
}
static int F_158 ( struct V_75 * V_67 )
{
struct V_5 * V_6 = F_153 ( V_67 ) ;
struct V_13 * V_28 = & V_6 -> V_28 ;
struct V_13 * V_29 = & V_6 -> V_29 ;
F_156 ( V_28 , & V_28 -> V_50 , V_67 ) ;
F_156 ( V_28 , & V_28 -> V_54 , V_67 ) ;
F_156 ( V_29 , & V_29 -> V_50 , V_67 ) ;
F_156 ( V_29 , & V_29 -> V_54 , V_67 ) ;
return 0 ;
}
