...
if ( V_12 -> V_15 -> V_74 && V_12 -> V_15 -> V_74 -> V_75 &&
( ( V_62 = V_12 -> V_15 -> V_74 -> V_75 ( V_12 ) ) < 0 ) ) {
F_45 ( & V_12 -> V_2 ,
L_24 ,
F_62 ( & V_12 -> V_2 ) , V_62 ) ;
goto V_76;
}
F_68 ( & V_12 -> V_49 , & V_12 -> V_16 -> V_77 ) ;
return 0 ;
V_76:
F_69 ( & V_12 -> V_2 , & V_72 ) ;
V_73:
...
int V_62 ;
struct V_80 V_81 ;
V_12 = F_71 ( sizeof( struct V_11 ) , V_82 ) ;
if ( ! V_12 ) {
F_45 ( & V_2 -> V_2 ,
L_25 ,
V_8 ) ;
...
V_12 -> V_90 = V_2 -> V_91 ;
V_2 -> V_17 ++ ;
memcpy ( V_81 . V_52 . V_52 , V_51 , sizeof( V_81 . V_52 ) ) ;
V_81 . type = V_92 ;
F_79 ( V_2 , & V_81 ) ;
return 0 ;
}
...
F_80 ( & V_12 -> V_49 ) ;
if ( V_12 -> V_15 -> V_74 && V_12 -> V_15 -> V_74 -> V_93 )
V_12 -> V_15 -> V_74 -> V_93 ( V_12 ) ;
memset ( & V_81 , 0 , sizeof( V_81 ) ) ;
memcpy ( V_81 . V_52 . V_52 , & V_12 -> V_23 , sizeof( V_81 . V_52 ) ) ;
V_81 . type = V_94 ;
F_79 ( V_12 -> V_16 , & V_81 ) ;
F_69 ( & V_12 -> V_2 , & V_72 ) ;
F_69 ( & V_12 -> V_2 , & V_70 ) ;
...
F_21 ( & V_96 ) ;
return ( V_95 ) ? V_12 : NULL ;
}
void F_85 ( struct V_78 * V_79 , int V_97 )
{
...
F_49 (dev, &w1_masters, w1_master_entry) {
F_5 ( & V_2 -> V_2 , L_29
L_30 , V_2 -> V_9 , V_79 -> V_99 ) ;
F_18 ( & V_2 -> V_32 ) ;
F_86 (sl, sln, &dev->slist, w1_slave_entry) {
if ( ( V_97 && V_12 -> V_15 -> V_99 == V_100
&& V_12 -> V_23 . V_15 == V_79 -> V_99 ) ||
( ! V_97 && V_12 -> V_15 -> V_99 == V_79 -> V_99 ) ) {
struct V_50 V_51 ;
...
if ( V_51 && V_35 -> V_56 == F_47 ( ( V_24 * ) & V_101 , 7 ) )
F_52 ( V_2 , V_35 ) ;
}
F_88 ( & V_2 -> V_13 ) ;
}
void F_89 ( struct V_6 * V_2 , V_24 V_102 , T_6 V_103 )
{
T_4 V_104 , V_51 , V_105 ;
int V_53 , V_17 = 0 ;
int V_106 , V_107 ;
int V_108 , V_109 ;
V_24 V_110 = 0 ;
...
if ( V_2 -> V_42 == 1 ) {
F_91 ( V_2 , V_111 ) ;
if ( F_23 ( V_2 , ( V_24 * ) & V_51 , 8 ) == 8 && V_51 )
V_103 ( V_2 , V_51 ) ;
break;
}
F_91 ( V_2 , V_102 ) ;
...
V_108 = ( ( V_104 >> V_53 ) & 0x1 ) ;
V_110 = F_92 ( V_2 , V_108 ) ;
if ( ( V_110 & 0x03 ) == 0x03 )
break;
if ( V_110 == 0 )
V_106 = V_53 ;
...
void F_94 ( struct V_6 * V_2 , V_24 V_102 ,
T_6 V_103 )
{
struct V_11 * V_12 , * V_98 ;
F_49 (sl, &dev->slist, w1_slave_entry)
F_95 ( V_86 , ( long * ) & V_12 -> V_87 ) ;
F_96 ( V_2 , V_102 , V_103 ) ;
F_86 (sl, sln, &dev->slist, w1_slave_entry) {
if ( ! F_97 ( V_86 , ( unsigned long * ) & V_12 -> V_87 ) && ! -- V_12 -> V_90 )
F_55 ( V_12 ) ;
else if ( F_97 ( V_86 , ( unsigned long * ) & V_12 -> V_87 ) )
V_12 -> V_90 = V_2 -> V_91 ;
}
if ( V_2 -> V_37 > 0 )
V_2 -> V_37 -- ;
}
static void F_98 ( struct V_6 * V_2 , V_24 V_102 )
{
F_94 ( V_2 , V_102 , F_87 ) ;
}
int F_99 ( void * V_112 )
{
struct V_6 * V_2 = (struct V_6 * ) V_112 ;
const unsigned long V_113 = F_100 ( V_41 * 1000 ) ;
while ( ! F_93 () ) {
if ( V_2 -> V_37 ) {
F_18 ( & V_2 -> V_32 ) ;
F_98 ( V_2 , V_114 ) ;
