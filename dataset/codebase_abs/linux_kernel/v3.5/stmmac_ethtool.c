...
static int F_25 ( struct V_1 * V_40 , int V_73 )
{
struct V_5 * V_6 = F_2 ( V_40 ) ;
int V_74 ;
switch ( V_73 ) {
...
static void F_26 ( struct V_1 * V_2 , T_1 V_77 , T_3 * V_57 )
{
int V_34 ;
T_3 * V_67 = V_57 ;
struct V_5 * V_6 = F_2 ( V_2 ) ;
...
static int F_30 ( struct V_1 * V_2 , struct V_80 * V_81 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
T_1 V_87 = V_84 | V_85 ;
