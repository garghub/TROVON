...
int V_35 ;
F_38 ( & V_11 ) ;
V_27 = F_39 ( F_4 , NULL , V_36 ) ;
if ( F_40 ( V_27 ) )
return F_41 ( V_27 ) ;
V_35 = - V_37 ;
V_12 . V_17 = V_12 . V_16 = 0 ;
V_12 . V_29 = F_42 ( V_38 , V_39 ) ;
if ( ! V_12 . V_29 )
goto V_40;
V_41 = F_43 ( 1 ) ;
if ( ! V_41 )
...
static void
F_52 ( const char * V_29 , unsigned V_26 )
{
unsigned V_21 = 0 ;
while ( F_11 () & V_20 )
continue;
...
static void
F_53 ( struct V_53 * V_54 , const char * V_29 , unsigned V_26 )
{
if ( V_27 == NULL )
F_52 ( V_29 , V_26 ) ;
else
...
static struct V_55 *
F_54 ( struct V_53 * V_54 , int * V_56 )
{
* V_56 = V_54 -> V_56 ;
return V_41 ;
}
...
static void T_3
F_57 ( struct V_53 * V_54 , const char * V_29 , unsigned int V_26 )
{
F_52 ( V_29 , V_26 ) ;
}
struct V_53 * T_3
F_58 ( unsigned int V_11 , unsigned int V_58 )
{
return & V_59 ;
}
