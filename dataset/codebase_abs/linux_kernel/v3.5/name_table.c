...
static void F_57 ( struct V_17 * V_19 , struct V_77 * V_78 , T_1 V_79 ,
T_1 V_80 )
{
char V_81 [ 27 ] ;
...
struct V_3 * V_10 ;
struct V_39 * V_40 ;
F_58 ( V_78 , L_14 , V_19 -> V_4 , V_19 -> V_5 ) ;
if ( V_79 == 2 ) {
F_58 ( V_78 , L_15 ) ;
return;
}
...
static void V_55 ( struct V_20 * V_29 , struct V_77 * V_78 , T_1 V_79 ,
T_1 type , T_1 V_83 , T_1 V_84 , T_1 V_80 )
{
struct V_17 * V_19 ;
char V_85 [ 11 ] ;
if ( V_29 -> V_30 == 0 )
return;
sprintf ( V_85 , L_21 , V_29 -> type ) ;
if ( V_79 == 1 ) {
F_58 ( V_78 , L_22 , V_85 ) ;
return;
}
for ( V_19 = V_29 -> V_25 ; V_19 != & V_29 -> V_25 [ V_29 -> V_30 ] ; V_19 ++ ) {
if ( ( V_83 <= V_19 -> V_5 ) && ( V_84 >= V_19 -> V_4 ) ) {
F_58 ( V_78 , L_23 , V_85 ) ;
F_38 ( & V_29 -> V_24 ) ;
F_57 ( V_19 , V_78 , V_79 , V_80 ) ;
F_43 ( & V_29 -> V_24 ) ;
sprintf ( V_85 , L_24 , L_20 ) ;
}
}
}
static void F_63 ( struct V_77 * V_78 , T_1 V_79 )
{
const char * V_86 [] = {
L_25 ,
L_26 ,
...
static void F_64 ( struct V_77 * V_78 , T_1 V_88 ,
...
struct V_91 * F_65 ( const void * V_92 , int V_93 )
{
struct V_91 * V_78 ;
struct V_94 * V_95 ;
struct V_96 * V_97 ;
struct V_77 V_98 ;
int V_99 ;
if ( ! F_66 ( V_92 , V_93 , V_100 ) )
return F_67 ( V_101 ) ;
V_78 = F_68 ( F_69 ( V_102 ) ) ;
if ( ! V_78 )
return NULL ;
V_97 = (struct V_96 * ) V_78 -> V_103 ;
F_70 ( & V_98 , F_71 ( V_97 ) , V_102 ) ;
V_95 = (struct V_94 * ) F_71 ( V_92 ) ;
F_36 ( & V_67 ) ;
F_64 ( & V_98 , F_72 ( V_95 -> V_79 ) , F_72 ( V_95 -> type ) ,
F_72 ( V_95 -> V_83 ) , F_72 ( V_95 -> V_84 ) ) ;
F_44 ( & V_67 ) ;
V_99 = F_73 ( & V_98 ) ;
F_74 ( V_78 , F_69 ( V_99 ) ) ;
F_75 ( V_97 , V_104 , NULL , V_99 ) ;
return V_78 ;
}
int F_76 ( void )
{
