...
break;
case 3 : V_86 = F_55 ( V_22 -> V_83 . V_77 -> V_87 -> V_88 ) ;
F_56 ( & V_86 -> V_78 -> V_89 ) ;
F_40 ( V_7 ) ;
F_57 ( & V_86 -> V_78 -> V_89 ) ;
F_46 ( V_86 ) ;
...
struct V_67 * V_68 = V_22 -> V_83 . V_77 -> V_87 ;
int V_52 = 0 ;
V_7 = F_26 ( V_49 , V_50 ) ;
if ( F_18 ( V_7 ) )
return F_17 ( V_7 ) ;
...
if ( V_77 -> V_78 )
goto V_91;
V_66 = F_34 ( V_68 , V_92 | 0644 ) ;
V_52 = - V_55 ;
if ( ! V_66 )
goto V_91;
V_52 = F_60 ( & V_93 , & V_79 , & V_80 ) ;
if ( V_52 ) {
F_61 ( V_66 ) ;
V_66 = NULL ;
goto V_91;
...
static int F_67 ( struct V_67 * V_68 , void * V_98 , int V_99 )
{
static struct V_100 V_101 [] = {
[ 2 ] = { L_15 , & V_102 , V_103 | V_104 } ,
[ 3 ] = { L_16 , & V_105 , V_103 } ,
{ L_17 }
} ;
int V_52 = F_68 ( V_68 , V_106 , V_101 ) ;
if ( ! V_52 )
V_68 -> V_107 = & V_108 ;
return V_52 ;
}
...
{
return F_70 ( V_110 , V_12 , V_98 , F_67 ) ;
}
