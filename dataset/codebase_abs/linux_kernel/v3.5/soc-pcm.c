...
V_44:
F_19 ( V_183 L_95 , V_36 -> V_10 ,
V_35 -> V_10 ) ;
return V_17 ;
}
int F_97 ( struct V_1 * V_2 , int V_26 )
{
...
enum V_184
F_98 ( struct V_1 * V_7 , int V_26 )
{
return V_7 -> V_6 [ V_26 ] . V_95 ;
}
void F_99 ( struct V_1 * V_7 ,
int V_26 , enum V_184 V_95 )
{
...
static char * F_101 ( enum V_184 V_95 )
{
switch ( V_95 ) {
case V_133 :
return L_96 ;
...
struct V_5 * V_6 ;
T_3 V_90 = 0 ;
V_90 += snprintf ( V_185 + V_90 , V_186 - V_90 ,
L_107 , V_2 -> V_9 -> V_10 ,
V_26 ? L_108 : L_109 ) ;
V_90 += snprintf ( V_185 + V_90 , V_186 - V_90 , L_110 ,
F_101 ( V_2 -> V_6 [ V_26 ] . V_95 ) ) ;
if ( ( V_2 -> V_6 [ V_26 ] . V_95 >= V_138 ) &&
( V_2 -> V_6 [ V_26 ] . V_95 <= V_140 ) )
V_90 += snprintf ( V_185 + V_90 , V_186 - V_90 ,
L_111
...
F_74 ( V_82 ) ,
F_32 ( V_82 ) ) ;
V_90 += snprintf ( V_185 + V_90 , V_186 - V_90 , L_113 ) ;
if ( F_81 ( & V_2 -> V_6 [ V_26 ] . V_98 ) ) {
V_90 += snprintf ( V_185 + V_90 , V_186 - V_90 ,
L_114 ) ;
goto V_44;
...
static T_3 F_104 ( struct V_187 * V_187 , char T_5 * V_188 ,
T_4 V_131 , T_6 * V_189 )
{
struct V_1 * V_2 = V_187 -> V_16 ;
T_3 V_190 = V_191 , V_90 = 0 , V_17 = 0 ;
char * V_185 ;
V_185 = F_105 ( V_190 , V_93 ) ;
if ( ! V_185 )
return - V_94 ;
if ( V_2 -> V_35 -> V_18 -> V_28 . V_54 )
V_90 += F_102 ( V_2 , V_27 ,
V_185 + V_90 , V_190 - V_90 ) ;
if ( V_2 -> V_35 -> V_18 -> V_30 . V_54 )
V_90 += F_102 ( V_2 , V_78 ,
V_185 + V_90 , V_190 - V_90 ) ;
V_17 = F_106 ( V_188 , V_131 , V_189 , V_185 , V_90 ) ;
F_48 ( V_185 ) ;
return V_17 ;
}
int F_107 ( struct V_1 * V_15 )
{
if ( ! V_15 -> V_9 )
return 0 ;
V_15 -> V_102 = F_108 ( V_15 -> V_9 -> V_10 ,
V_15 -> V_109 -> V_192 ) ;
if ( ! V_15 -> V_102 ) {
F_3 ( V_15 -> V_8 ,
L_118 ,
