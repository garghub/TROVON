...
case V_18 :
if ( V_119 . V_120 ) {
F_68 (KERN_INFO pr_fmt(L_1),
&iph->daddr) ;
} else {
V_85 = F_69 ( V_2 , V_70 ,
F_70 ( V_39 -> V_108 . V_121 . V_122 ) ,
V_33 -> V_19 ) ;
if ( ! V_85 )
goto V_16;
}
...
V_111 = V_97 & ( V_129 - 1 ) ;
F_58 () ;
V_113 = F_74 ( V_130 [ V_111 ] ) ;
if ( V_113 && V_113 -> V_131 )
V_113 -> V_131 ( V_33 , V_85 ) ;
F_62 () ;
V_16:
return;
V_114:
...
F_77 ( V_33 , F_27 ( V_33 ) -> V_108 . V_109 ) ;
}
V_16:
return;
V_114:
F_23 ( F_21 ( V_33 -> V_19 ) , V_132 ) ;
goto V_16;
}
static void F_78 ( struct V_32 * V_33 )
{
struct V_2 * V_2 ;
V_2 = F_21 ( F_66 ( V_33 ) -> V_19 ) ;
if ( ! V_2 -> V_3 . V_137 ) {
...
goto V_114;
F_80 ( & V_140 ) ;
V_35 . V_38 . V_141 [ 1 ] = F_81 ( ( V_140 . V_142 % 86400 ) * V_143 +
V_140 . V_144 / V_145 ) ;
V_35 . V_38 . V_141 [ 2 ] = V_35 . V_38 . V_141 [ 1 ] ;
if ( F_82 ( V_33 , 0 , & V_35 . V_38 . V_141 [ 0 ] , 4 ) )
F_83 () ;
V_35 . V_38 . V_39 = * F_27 ( V_33 ) ;
V_35 . V_38 . V_39 . type = V_146 ;
...
return;
V_114:
F_23 ( F_21 ( F_66 ( V_33 ) -> V_19 ) , V_132 ) ;
goto V_16;
}
...
F_88 ( V_148 ) ) {
T_2 V_153 , * V_154 ;
V_154 = F_55 ( V_33 , 0 , sizeof( V_153 ) , & V_153 ) ;
F_89 ( V_154 == NULL ) ;
for ( V_150 = V_148 -> V_152 ; V_150 ; V_150 = V_150 -> V_155 ) {
if ( * V_154 == V_150 -> V_156 &&
F_90 ( F_37 ( V_33 ) -> V_58 , V_150 ) )
break;
}
if ( ! V_150 )
F_91 ( L_4 ,
V_154 ,
V_19 -> V_128 , & F_37 ( V_33 ) -> V_58 ) ;
}
}
...
struct V_7 * V_8 = F_34 ( V_33 ) ;
struct V_2 * V_2 = F_21 ( V_8 -> V_13 . V_19 ) ;
if ( ! F_94 ( NULL , V_157 , V_33 ) ) {
struct V_158 * V_159 = F_95 ( V_33 ) ;
int V_160 ;
if ( ! ( V_159 && V_159 -> V_161 [ V_159 -> V_30 - 1 ] -> V_162 . V_20 &
V_163 ) )
goto V_164;
...
int V_172 , V_74 ;
V_2 -> V_3 . F_1 =
F_108 ( V_173 * sizeof( struct V_1 * ) , V_174 ) ;
if ( V_2 -> V_3 . F_1 == NULL )
return - V_175 ;
F_104 (i) {
struct V_1 * V_4 ;
V_74 = F_109 ( & V_4 , V_176 ,
V_177 , V_66 , V_2 ) ;
if ( V_74 < 0 )
goto V_178;
V_2 -> V_3 . F_1 [ V_172 ] = V_4 ;
V_4 -> V_179 = 2 * F_110 ( 64 * 1024 ) ;
F_111 ( V_4 , V_180 ) ;
F_36 ( V_4 ) -> V_181 = V_182 ;
}
V_2 -> V_3 . V_137 = 0 ;
V_2 -> V_3 . V_169 = 1 ;
V_2 -> V_3 . V_126 = 1 ;
V_2 -> V_3 . V_25 = 1 * V_183 ;
V_2 -> V_3 . V_22 = 0x1818 ;
V_2 -> V_3 . V_103 = 0 ;
return 0 ;
V_178:
