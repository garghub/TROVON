...
T_1 long F_68 ( void T_4 * V_122 , T_2 V_123 ,
const char T_4 * V_124 )
{
return F_69 ( V_122 , V_123 , V_124 ) ;
}
T_1 long F_70 ( const char T_4 * V_125 ,
unsigned int V_126 )
{
return F_71 ( V_125 , V_126 ) ;
}
T_1 long F_68 ( const char T_4 * V_125 ,
...
unsigned long V_132 )
{
return F_73 ( V_25 , V_129 , V_130 , ( V_131 << 32 ) | V_132 ) ;
}
...
unsigned long V_132 )
{
return F_75 ( V_25 , V_129 , V_130 , ( V_131 << 32 ) | V_132 ) ;
}
...
T_8 V_130 )
{
return F_77 ( V_25 , ( V_133 << 32 ) | V_134 , V_130 ) ;
}
long F_78 ( int V_25 ,
unsigned long V_133 ,
unsigned long V_134 ,
T_8 V_123 , int V_135 )
{
return F_79 ( V_25 , ( V_133 << 32 ) | V_134 , V_123 , V_135 ) ;
}
long F_80 ( int V_25 ,
...
T_1 long F_81 ( int V_138 , int V_139 ,
T_13 T_4 * V_140 ,
T_8 V_130 )
{
T_6 V_77 = F_36 () ;
int V_76 ;
T_14 V_141 ;
if ( V_140 && F_51 ( V_141 , V_140 ) )
return - V_79 ;
F_37 ( V_78 ) ;
V_76 = F_82 ( V_138 , V_139 ,
...
T_1 long F_83 ( int V_138 , int V_139 ,
T_15 T_4 * V_140 ,
T_8 V_130 )
{
T_6 V_77 = F_36 () ;
int V_76 ;
T_16 V_142 ;
if ( V_140 && F_51 ( V_142 , V_140 ) )
return - V_79 ;
F_37 ( V_78 ) ;
V_76 = F_84 ( V_138 , V_139 ,
...
T_1 long F_85 ( const char T_4 * V_65 ,
int V_126 , int V_35 )
{
return F_86 ( V_143 , V_65 , V_126 , V_35 ) ;
}
long F_87 ( unsigned long V_144 ,
unsigned long V_145 ,
char T_4 * V_146 , T_17 V_123 )
{
return F_88 ( ( V_144 << 32 ) | V_145 ,
V_146 , V_123 ) ;
}
long F_89 ( int V_25 , unsigned long V_147 , unsigned long V_148 , unsigned long V_149 , unsigned long V_150 , int V_126 )
{
return F_90 ( V_25 ,
( V_147 << 32 ) | V_148 ,
( V_149 << 32 ) | V_150 ,
...
T_1 long F_91 ( int V_25 , int V_35 , T_2 V_133 , T_2 V_134 ,
T_2 V_136 , T_2 V_137 )
{
return F_92 ( V_25 , V_35 , ( ( T_16 ) V_133 << 32 ) | V_134 ,
( ( T_16 ) V_136 << 32 ) | V_137 ) ;
}
