...
V_3 -> V_72 . V_104 = V_105 ;
V_6 = F_65 ( sizeof( * V_6 ) , V_106 ) ;
if ( ! V_6 ) {
V_14 = - V_107 ;
goto V_56;
}
...
if ( V_54 -> V_119 ) {
int V_120 = V_54 -> V_57 ;
V_14 = F_73 ( V_120 , V_121 , L_20 ) ;
if ( V_14 ) {
F_31 ( & V_3 -> V_48 , L_21 ) ;
goto V_122;
}
V_14 = F_78 ( F_29 ( V_120 ) , V_123 ,
V_124 ,
L_22 , V_3 ) ;
if ( V_14 ) {
F_31 ( & V_3 -> V_48 , L_23 ) ;
...
V_14 = F_81 ( V_3 , V_6 -> V_16 , V_129 ) ;
if ( V_14 ) {
F_31 ( & V_3 -> V_48 , L_26 ) ;
goto V_130;
}
V_14 = F_82 ( & V_3 -> V_48 . V_131 , & V_132 ) ;
if ( V_14 ) {
F_31 ( & V_3 -> V_48 , L_27 ) ;
goto V_130;
}
...
static T_6 V_123 ( int V_148 , void * V_4 )
{
struct V_2 * V_3 = V_4 ;
struct V_5 * V_6 = F_20 ( & V_3 -> V_48 ) ;
int V_149 ;
int V_14 ;
V_149 = F_101 ( & V_6 -> V_108 , 1 , 0 ) ;
if ( V_149 ) {
F_23 ( & V_6 -> V_126 ) ;
...
static void V_127 ( struct V_151 * V_152 )
{
struct V_5 * V_6 = F_103 ( V_152 , struct V_5 ,
V_126 . V_152 ) ;
...
static int F_27 ( struct V_2 * V_3 , bool V_153 )
{
struct V_5 * V_6 = F_20 ( & V_3 -> V_48 ) ;
struct V_1 * V_54 = F_1 ( V_3 ) ;
int V_14 ;
if ( V_153 )
V_14 = F_10 ( V_6 , V_154 , 0 ) ;
else
V_14 = F_8 ( V_6 , V_155 ) ;
if ( ! V_54 -> V_119 )
F_107 ( V_3 , V_153 ) ;
if ( V_6 -> V_20 -> V_21 . V_156 )
F_13 ( V_6 -> V_20 -> V_21 . V_156 ) ;
return V_14 ;
}
static int F_108 ( struct V_2 * V_3 , bool V_153 )
{
struct V_5 * V_6 = F_20 ( & V_3 -> V_48 ) ;
int V_14 ;
F_40 ( & V_6 -> V_67 ) ;
...
static int F_112 ( struct V_2 * V_3 , bool V_153 )
{
struct V_5 * V_6 = F_20 ( & V_3 -> V_48 ) ;
int V_14 ;
F_39 ( & V_3 -> V_48 , L_47 , V_153 ) ;
F_40 ( & V_6 -> V_67 ) ;
if ( V_6 -> V_32 == V_153 )
goto V_157;
F_41 ( V_3 ) ;
...
static int F_114 ( struct V_2 * V_3 , int V_158 )
{
struct V_5 * V_6 = F_20 ( & V_3 -> V_48 ) ;
T_1 V_25 , V_26 , V_27 ;
int V_14 ;
...
V_14 = F_117 ( V_3 , V_6 -> V_16 , V_161 ) ;
if ( V_14 )
goto V_59;
while ( V_162 < V_159 ) {
T_1 V_13 = V_160 ? 0x2e : 0x3e ;
V_160 = 0 ;
V_14 = F_7 ( V_3 , V_6 -> V_16 , V_13 ,
V_15 + V_162 , V_159 - V_162 ) ;
if ( V_14 < 0 ) {
F_31 ( & V_3 -> V_48 , L_48 ) ;
goto V_163;
}
...
static void V_111 ( struct V_151 * V_152 )
{
struct V_5 * V_6 = F_103 ( V_152 , struct V_5 ,
V_53 . V_152 ) ;
struct V_2 * V_3 = V_6 -> V_3 ;
F_40 ( & V_6 -> V_67 ) ;
if ( V_3 -> V_144 != V_146 || ! V_6 -> V_68 ) {
F_43 ( & V_6 -> V_67 ) ;
return;
}
F_41 ( V_3 ) ;
...
static void V_110 ( struct V_151 * V_152 )
{
struct V_5 * V_6 = F_103 ( V_152 , struct V_5 ,
V_51 . V_152 ) ;
struct V_2 * V_3 = V_6 -> V_3 ;
