...
if ( V_46 [ V_48 ] . V_55 & V_56 ) {
if ( ! ( V_46 [ V_48 ] . V_55 & V_57 ) ||
V_46 [ V_48 ] . V_19 [ 0 ] < 1 ||
V_46 [ V_48 ] . V_54 < V_46 [ V_48 ] . V_19 [ 0 ] +
V_58 ) {
V_49 = - V_52 ;
break;
}
...
if ( ( V_61 . V_65 == V_68 ) ||
( V_61 . V_65 == V_66 ) )
V_64 = sizeof( V_61 . V_79 -> V_80 ) ;
else if ( ( V_61 . V_65 == V_69 ) ||
( V_61 . V_65 == V_70 ) )
V_64 = sizeof( V_61 . V_79 -> V_81 ) ;
else
V_64 = sizeof( V_61 . V_79 -> V_82 ) ;
if ( ( V_61 . V_65 == V_70 ) ||
( V_61 . V_65 == V_74 ) ||
( V_61 . V_65 == V_73 ) ||
( V_61 . V_75 == V_77 ) ) {
if ( F_34 ( & V_63 , V_61 . V_79 , V_64 ) )
return - V_33 ;
}
if ( V_61 . V_65 == V_72 ) {
V_61 . V_65 = V_73 ;
...
V_61 . V_75 , V_61 . V_78 , V_61 . V_65 , & V_63 ) ;
if ( ! V_49 && ( ( V_61 . V_65 == V_70 ) ||
( V_61 . V_65 == V_74 ) ||
( V_61 . V_75 == V_76 ) ) ) {
if ( F_20 ( V_61 . V_79 , & V_63 , V_64 ) )
return - V_33 ;
}
return V_49 ;
}
