...
V_53 -> V_8 = V_89 ;
if ( V_53 -> V_51 == V_52 ) {
memcpy ( & V_53 -> V_15 . V_91 ,
& V_46 -> V_92 . V_93 ,
V_94 ) ;
} else if ( V_53 -> V_51 == V_95 ) {
memcpy ( & V_53 -> V_15 . V_96 ,
& V_46 -> V_97 . V_93 ,
sizeof( struct V_98 ) ) ;
}
V_90 = V_53 -> V_62 ;
}
F_53 ( V_2 , V_46 -> V_99 , V_46 ) ;
F_52 ( V_100 , & V_46 -> V_9 ) ;
if ( F_54 ( V_101 , & V_46 -> V_9 ) )
F_55 ( & V_2 -> V_102 ) ;
if ( ! F_6 ( V_103 , & V_46 -> V_9 ) )
F_56 ( V_2 , V_46 -> V_71 ) ;
if ( V_90 )
V_62 ( V_90 ) ;
}
...
struct V_23 * V_24 )
{
int V_104 = V_65 , V_105 = - 1 ;
struct V_106 * V_107 = F_58 ( V_11 ) ;
struct V_108 * V_109 = V_11 -> V_78 -> V_110 ;
...
V_105 = F_60 ( V_2 , V_109 ,
V_112 ) ;
} else
V_105 = F_61 ( V_107 , ! F_36 ( V_11 ) ) ;
}
F_25 ( V_2 , V_24 ) ;
