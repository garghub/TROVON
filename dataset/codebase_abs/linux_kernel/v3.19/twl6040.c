...
{
struct V_4 * V_5 ;
struct V_6 * V_6 = F_53 ( V_2 -> V_100 -> V_122 ) ;
struct V_123 * V_124 = F_20 ( V_2 -> V_100 ,
struct V_123 , V_100 ) ;
int V_42 = 0 ;
V_5 = F_54 ( V_2 -> V_100 , sizeof( * V_5 ) , V_125 ) ;
if ( V_5 == NULL )
return - V_126 ;
F_55 ( V_2 , V_5 ) ;
V_5 -> V_2 = V_2 ;
V_2 -> V_7 = V_6 ;
V_5 -> V_127 = F_56 ( V_124 , 0 ) ;
if ( V_5 -> V_127 < 0 ) {
F_46 ( V_2 -> V_100 , L_9 ) ;
return - V_77 ;
}
F_57 ( & V_5 -> V_53 . V_55 , F_19 ) ;
F_58 ( & V_5 -> V_49 ) ;
V_42 = F_59 ( V_5 -> V_127 , NULL ,
F_21 , V_128 ,
L_10 , V_2 ) ;
if ( V_42 ) {
