...
T_1 * V_131 , T_1 * V_132 , unsigned long V_80 ,
struct V_1 * * V_97 )
{
struct V_1 * V_2 ;
struct V_3 * V_70 ;
...
unsigned long V_80 , int V_164 , struct V_1 * V_98 )
{
struct V_1 * V_2 = NULL ;
struct V_3 * V_57 ;
int V_165 = 0 ;
...
L_13 ,
F_19 ( V_26 ) , V_15 ,
F_149 ( V_177 -> V_200 ) , V_179 ) ;
F_144 ( V_41 ) ;
return 0 ;
}
int F_150 ( struct V_201 * V_54 , struct V_10 * V_11 ,
int V_174 )
{
T_1 V_15 = V_11 -> V_15 ;
unsigned long V_140 , V_202 = F_151 ( V_11 -> V_15 , V_11 -> V_21 ) ;
int V_74 = 0 ;
...
int F_152 ( struct V_26 * V_26 , T_1 V_15 , struct V_129 * V_129 ,
unsigned int V_173 )
{
T_1 V_50 ;
T_1 V_205 ;
...
if ( V_74 ) {
V_206 = F_158 ( sizeof( * V_206 ) , V_125 ) ;
if ( ! V_206 )
return - V_36 ;
V_206 -> V_15 = V_15 ;
...
V_206 -> V_209 = 0 ;
F_159 ( & V_215 -> V_48 ) ;
V_213 = F_160 ( V_215 , V_15 , V_206 -> V_21 ) ;
if ( ! V_213 ) {
F_161 ( & V_215 -> V_48 ) ;
F_139 ( V_206 ) ;
return - V_154 ;
...
int F_165 ( struct V_26 * V_26 , struct V_41 * V_222 ,
struct V_166 * V_206 , int V_210 )
{
int V_207 ;
V_207 = F_154 ( F_125 ( V_26 ) -> V_54 -> V_175 ,
...
struct V_41 * F_166 ( struct V_26 * V_26 , struct V_41 * V_222 ,
struct V_166 * V_206 ,
...
F_145 ( V_41 , V_129 , V_206 -> V_21 , V_173 ) ;
return V_41 ;
}
static int F_168 ( struct V_41 * V_222 , T_1 V_236 ,
...
V_74 = F_157 ( V_26 , V_15 , V_16 , & V_206 ) ;
if ( V_74 )
return V_74 ;
V_74 = F_165 ( V_26 , V_222 , V_206 , V_210 ) ;
if ( ! V_74 ) {
F_138 ( V_26 , V_206 ) ;
return - V_154 ;
}
...
V_41 = F_166 ( V_26 , V_222 , V_206 , V_129 ,
V_15 - F_136 ( V_129 ) ,
...
int F_169 ( struct V_129 * V_129 , int V_95 , T_1 V_15 , T_1 V_16 )
{
int V_244 = ( V_95 == 0 ) ;
struct V_24 * V_25 ;
int V_74 = 0 ;
...
static void F_171 ( struct V_41 * V_41 , int V_95 )
{
struct V_246 * V_247 ;
T_1 V_15 ;
T_1 V_16 ;
...
if ( V_247 -> V_249 + V_247 -> V_250 != V_149 )
F_173 ( F_125 ( V_129 -> V_28 -> V_29 ) -> V_54 -> V_175 ,
L_20 ,
...
static void F_176 ( struct V_41 * V_41 , int V_95 )
{
struct V_246 * V_247 ;
int V_244 = F_163 ( V_252 , & V_41 -> V_253 ) ;
...
if ( ! V_74 && ! V_95 &&
F_163 ( V_252 , & V_41 -> V_253 ) )
V_244 = 1 ;
} else {
V_74 = F_168 ( V_41 , V_56 , V_129 , V_15 , V_16 ,
V_257 ) ;
if ( V_74 == 0 ) {
V_244 =
F_163 ( V_252 , & V_41 -> V_253 ) ;
...
struct V_41 *
F_180 ( struct V_264 * V_194 , T_1 V_265 , int V_266 ,
T_3 V_267 )
{
struct V_40 * V_180 ;
struct V_41 * V_41 ;
V_41 = F_181 ( V_267 , V_266 , V_38 ) ;
...
struct V_41 * F_182 ( struct V_41 * V_41 , T_3 V_271 )
{
struct V_40 * V_180 ;
struct V_41 * V_5 ;
V_5 = F_183 ( V_41 , V_271 , V_38 ) ;
if ( V_5 ) {
V_180 = V_40 ( V_5 ) ;
V_180 -> V_232 = NULL ;
V_180 -> V_270 = NULL ;
...
static int T_4 F_184 ( int V_273 , struct V_41 * V_41 ,
...
F_188 ( V_273 , V_25 , V_129 , V_56 , V_286 , V_41 , V_217 ) ||
F_145 ( V_41 , V_129 , V_286 , V_56 ) < V_286 ) {
V_74 = F_184 ( V_273 , V_41 , V_174 ,
V_282 ) ;
if ( V_74 < 0 )
return V_74 ;
V_41 = NULL ;
...
V_283 = F_191 ( V_194 ) ;
V_41 = F_180 ( V_194 , V_179 , V_283 , V_125 | V_288 ) ;
if ( ! V_41 )
return - V_36 ;
F_145 ( V_41 , V_129 , V_286 , V_56 ) ;
V_41 -> V_228 = V_281 ;
V_41 -> V_231 = V_25 ;
if ( V_279 )
* V_279 = V_41 ;
else
V_74 = F_184 ( V_273 , V_41 , V_174 , V_217 ) ;
return V_74 ;
}
...
V_213 = F_198 ( V_26 , V_129 , V_173 , V_293 ,
...
V_299 = F_131 ( F_200 ( V_213 ) - V_293 , V_16 - V_293 + 1 ) ;
V_296 = F_131 ( F_200 ( V_213 ) - 1 , V_16 ) ;
V_299 = F_208 ( V_299 , V_301 ) ;
if ( V_303 & V_220 ) {
V_300 = V_213 -> V_307 ;
V_179 = V_213 -> V_218 >> 9 ;
} else {
...
F_202 ( V_25 , V_138 [ V_126 ] , V_290 , V_291 , V_41 ,
V_174 , V_217 , V_273 ) ;
F_106 ( V_138 [ V_126 ] ) ;
}
}
...
V_74 = F_202 ( V_25 , V_129 , V_290 , NULL , V_41 , V_174 ,
V_217 , V_273 ) ;
return V_74 ;
}
...
int V_74 ;
V_74 = F_215 ( V_25 , V_129 , V_290 , & V_41 , V_174 ,
& V_217 , V_315 ) ;
if ( V_41 )
V_74 = F_184 ( V_315 , V_41 , V_174 , V_217 ) ;
return V_74 ;
}
...
int V_283 = 0 ;
bool V_335 ;
if ( V_25 -> V_46 && V_25 -> V_46 -> V_336 ) {
V_74 = V_25 -> V_46 -> V_336 ( V_129 , V_15 ,
V_292 ) ;
if ( V_74 ) {
if ( V_74 == - V_337 )
V_317 -> V_338 ++ ;
...
F_222 ( V_317 , V_129 ) ;
F_219 ( V_129 , V_317 , V_318 ) ;
F_118 ( V_129 ) ;
V_74 = 1 ;
goto V_339;
}
}
F_219 ( V_129 , V_317 , V_318 + 1 ) ;
V_16 = V_292 ;
if ( V_261 <= V_15 ) {
if ( V_25 -> V_46 && V_25 -> V_46 -> V_245 )
...
F_72 ( V_340 <= V_293 ) ;
F_72 ( V_16 < V_293 ) ;
V_299 = F_131 ( V_340 - V_293 , V_16 - V_293 + 1 ) ;
V_299 = F_208 ( V_299 , V_301 ) ;
V_179 = ( V_213 -> V_218 + V_294 ) >> 9 ;
V_194 = V_213 -> V_194 ;
V_218 = V_213 -> V_218 ;
V_335 = F_163 ( V_219 , & V_213 -> V_7 ) ;
F_162 ( V_213 ) ;
V_213 = NULL ;
if ( V_335 || V_218 == V_309 ||
V_218 == V_310 ) {
if ( ! V_335 && V_25 -> V_46 &&
V_25 -> V_46 -> V_245 )
V_25 -> V_46 -> V_245 ( V_129 , V_293 ,
...
if ( V_25 -> V_46 && V_25 -> V_46 -> V_341 ) {
V_74 = V_25 -> V_46 -> V_341 ( V_129 , V_293 ,
V_293 + V_299 - 1 ) ;
} else {
V_74 = 0 ;
}
...
unsigned long V_342 = ( V_261 >> V_127 ) + 1 ;
F_110 ( V_25 , V_293 , V_293 + V_299 - 1 ) ;
if ( ! F_224 ( V_129 ) ) {
F_173 ( F_125 ( V_26 ) -> V_54 -> V_175 ,
L_27 ,
V_129 -> V_126 , V_293 , V_16 ) ;
}
V_74 = F_189 ( V_333 , V_25 , V_129 ,
V_179 , V_299 , V_173 ,
V_194 , & V_326 -> V_41 , V_342 ,
F_171 ,
0 , 0 , 0 ) ;
if ( V_74 )
F_128 ( V_129 ) ;
...
static int F_225 ( struct V_129 * V_129 , struct V_316 * V_317 ,
void * V_226 )
{
struct V_26 * V_26 = V_129 -> V_28 -> V_29 ;
...
if ( V_317 -> V_343 == V_344 )
V_333 = V_197 ;
else
V_333 = V_190 ;
F_226 ( V_129 , V_26 , V_317 ) ;
F_41 ( ! F_227 ( V_129 ) ) ;
F_228 ( V_129 ) ;
V_173 = V_261 & ( V_149 - 1 ) ;
if ( V_129 -> V_126 > V_128 ||
( V_129 -> V_126 == V_128 && ! V_173 ) ) {
V_129 -> V_28 -> V_345 -> V_346 ( V_129 , 0 , V_149 ) ;
F_118 ( V_129 ) ;
return 0 ;
}
if ( V_129 -> V_126 == V_128 ) {
...
V_173 = 0 ;
F_197 ( V_129 ) ;
V_74 = F_220 ( V_26 , V_129 , V_317 , V_326 , V_15 , & V_318 ) ;
if ( V_74 == 1 )
goto V_339;
if ( V_74 )
goto V_147;
V_74 = F_221 ( V_26 , V_129 , V_317 , V_326 ,
V_261 , V_318 , V_333 , & V_283 ) ;
if ( V_74 == 1 )
goto V_339;
V_147:
if ( V_283 == 0 ) {
...
F_70 ( & V_11 -> V_351 ) ;
if ( F_236 ( V_352 , & V_11 -> V_347 ) ) {
F_237 ( V_348 , & V_11 -> V_347 ) ;
F_74 ( & V_11 -> V_351 ) ;
F_238 ( V_11 , V_353 ) ;
F_239 ( & V_175 -> V_354 ,
- V_11 -> V_21 ,
...
if ( ! V_74 )
return V_74 ;
V_202 = F_151 ( V_11 -> V_15 , V_11 -> V_21 ) ;
for ( V_140 = 0 ; V_140 < V_202 ; V_140 ++ ) {
struct V_129 * V_60 = V_11 -> V_138 [ V_140 ] ;
if ( ! F_240 ( V_60 ) ) {
if ( ! V_349 ) {
...
{
F_242 ( V_348 , & V_11 -> V_347 ) ;
F_243 () ;
F_244 ( & V_11 -> V_347 , V_348 ) ;
}
static void F_245 ( struct V_129 * V_129 )
{
struct V_10 * V_11 = (struct V_10 * ) V_129 -> V_50 ;
struct V_356 * V_357 = F_125 ( V_11 -> V_175 -> V_204 ) ;
F_128 ( V_129 ) ;
if ( F_246 ( V_358 , & V_11 -> V_347 ) )
return;
switch ( V_11 -> V_359 ) {
case - 1 :
F_237 ( V_360 , & V_357 -> V_361 ) ;
break;
case 0 :
F_237 ( V_362 , & V_357 -> V_361 ) ;
break;
case 1 :
F_237 ( V_363 , & V_357 -> V_361 ) ;
break;
default:
F_247 () ;
}
...
F_72 ( ! V_11 ) ;
V_147 = F_40 ( & V_11 -> V_364 ) ;
if ( V_95 || F_163 ( V_358 , & V_11 -> V_347 ) ) {
F_170 ( V_129 ) ;
F_245 ( V_129 ) ;
}
F_129 ( V_129 ) ;
...
unsigned long V_140 , V_202 ;
unsigned long V_217 = 0 ;
int V_273 = ( V_326 -> V_350 ? V_197 : V_190 ) | V_365 ;
int V_74 = 0 ;
F_242 ( V_358 , & V_11 -> V_347 ) ;
V_202 = F_151 ( V_11 -> V_15 , V_11 -> V_21 ) ;
F_36 ( & V_11 -> V_364 , V_202 ) ;
if ( F_250 ( V_11 ) == V_366 )
V_217 = V_367 ;
for ( V_140 = 0 ; V_140 < V_202 ; V_140 ++ ) {
struct V_129 * V_60 = V_11 -> V_138 [ V_140 ] ;
...
F_245 ( V_60 ) ;
F_129 ( V_60 ) ;
if ( F_251 ( V_202 - V_140 , & V_11 -> V_364 ) )
F_241 ( V_11 ) ;
V_74 = - V_154 ;
break;
}
...
struct V_10 * V_11 , * V_368 = NULL ;
struct V_325 V_326 = {
. V_41 = NULL ,
. V_25 = V_25 ,
. V_330 = 0 ,
. V_350 = V_317 -> V_343 == V_344 ,
. V_217 = 0 ,
} ;
int V_74 = 0 ;
int V_147 = 0 ;
...
while ( ! V_147 && ! V_369 && ( V_126 <= V_16 ) &&
( V_139 = F_255 ( & V_371 , V_28 , & V_126 , V_373 ,
F_131 ( V_16 - V_126 , ( T_9 ) V_377 - 1 ) + 1 ) ) ) {
unsigned V_140 ;
V_372 = 1 ;
for ( V_140 = 0 ; V_140 < V_139 ; V_140 ++ ) {
struct V_129 * V_129 = V_371 . V_138 [ V_140 ] ;
if ( ! F_193 ( V_129 ) )
continue;
...
continue;
V_368 = V_11 ;
V_74 = F_231 ( V_11 , V_175 , & V_326 ) ;
if ( ! V_74 ) {
F_257 ( V_11 ) ;
continue;
}
V_74 = F_249 ( V_11 , V_175 , V_317 , & V_326 ) ;
if ( V_74 ) {
V_147 = 1 ;
F_257 ( V_11 ) ;
break;
...
static void F_264 ( struct V_325 * V_326 )
{
if ( V_326 -> V_41 ) {
int V_273 = V_190 ;
int V_74 ;
if ( V_326 -> V_350 )
V_273 = V_197 ;
V_74 = F_184 ( V_273 , V_326 -> V_41 , 0 , V_326 -> V_217 ) ;
F_72 ( V_74 < 0 ) ;
V_326 -> V_41 = NULL ;
}
}
...
unsigned V_384 ;
unsigned long V_217 = 0 ;
struct V_129 * V_385 [ 16 ] ;
struct V_129 * V_129 ;
struct V_212 * V_291 = NULL ;
int V_283 = 0 ;
for ( V_384 = 0 ; V_384 < V_139 ; V_384 ++ ) {
V_129 = F_11 ( V_138 -> V_71 , struct V_129 , V_386 ) ;
F_269 ( & V_129 -> V_7 ) ;
F_8 ( & V_129 -> V_386 ) ;
if ( F_270 ( V_129 , V_28 ,
V_129 -> V_126 , V_125 ) ) {
...
V_385 [ V_283 ++ ] = V_129 ;
if ( V_283 < F_271 ( V_385 ) )
continue;
F_214 ( V_25 , V_385 , V_283 , V_290 , & V_291 ,
& V_41 , 0 , & V_217 , V_315 ) ;
V_283 = 0 ;
}
if ( V_283 )
...
F_72 ( ! F_10 ( V_138 ) ) ;
if ( V_41 )
return F_184 ( V_315 , V_41 , 0 , V_217 ) ;
return 0 ;
}
...
static int F_273 ( struct V_214 * V_387 ,
struct V_24 * V_25 ,
...
V_21 = V_16 - V_15 + 1 ;
F_275 ( & V_387 -> V_48 ) ;
V_213 = F_160 ( V_387 , V_15 , V_21 ) ;
if ( ! V_213 ) {
F_276 ( & V_387 -> V_48 ) ;
break;
}
if ( F_163 ( V_389 , & V_213 -> V_7 ) ||
V_213 -> V_15 != V_15 ) {
F_276 ( & V_387 -> V_48 ) ;
F_162 ( V_213 ) ;
break;
...
return F_273 ( V_387 , V_25 , V_129 , V_49 ) ;
}
...
T_12 * V_290 )
{
T_1 V_391 = F_125 ( V_26 ) -> V_54 -> V_391 ;
struct V_212 * V_213 ;
T_1 V_21 ;
if ( V_56 >= V_162 )
return NULL ;
...
if ( V_21 == 0 )
break;
V_21 = F_208 ( V_21 , V_391 ) ;
V_213 = V_290 ( V_26 , NULL , 0 , V_56 , V_21 , 0 ) ;
if ( F_201 ( V_213 ) )
return V_213 ;
if ( ! F_163 ( V_392 , & V_213 -> V_7 ) &&
V_213 -> V_218 != V_309 ) {
return V_213 ;
}
V_56 = F_200 ( V_213 ) ;
...
int F_279 ( struct V_26 * V_26 , struct V_393 * V_394 ,
...
return - V_36 ;
V_401 -> V_405 = 1 ;
V_15 = F_281 ( V_15 , F_125 ( V_26 ) -> V_54 -> V_391 ) ;
V_21 = F_282 ( F_132 , F_125 ( V_26 ) -> V_54 -> V_391 ) - V_15 ;
V_74 = F_283 ( NULL , V_54 , V_401 , F_19 ( V_26 ) , - 1 ,
0 ) ;
if ( V_74 < 0 ) {
F_284 ( V_401 ) ;
return V_74 ;
...
F_41 ( ! V_74 ) ;
V_401 -> V_406 [ 0 ] -- ;
F_285 ( V_401 -> V_407 [ 0 ] , & V_399 , V_401 -> V_406 [ 0 ] ) ;
V_395 = V_399 . type ;
if ( V_399 . V_408 != F_19 ( V_26 ) ||
V_395 != V_409 ) {
V_162 = ( T_1 ) - 1 ;
V_396 = V_27 ;
} else {
...
break;
V_402 = F_132 ( V_213 -> V_15 , V_262 ) ;
if ( ! F_163 ( V_219 , & V_213 -> V_7 ) )
V_410 = V_402 - V_213 -> V_15 ;
V_340 = F_200 ( V_213 ) ;
V_403 = V_340 - V_402 ;
V_397 = 0 ;
V_7 = 0 ;
...
if ( V_262 >= F_132 )
V_16 = 1 ;
if ( V_213 -> V_218 == V_411 ) {
V_16 = 1 ;
V_7 |= V_412 ;
} else if ( V_213 -> V_218 == V_310 ) {
V_7 |= ( V_413 |
V_414 ) ;
} else if ( V_213 -> V_218 == V_415 ) {
V_7 |= ( V_416 |
V_417 ) ;
} else if ( V_394 -> V_418 ) {
T_1 V_419 = V_213 -> V_218 -
( V_213 -> V_15 - V_213 -> V_420 ) ;
V_397 = V_213 -> V_218 + V_410 ;
...
( V_162 == ( T_1 ) - 1 && V_27 <= V_340 ) ) {
V_7 |= V_412 ;
V_16 = 1 ;
}
V_213 = F_278 ( V_26 , V_262 , V_396 ,
V_290 ) ;
if ( F_287 ( V_213 ) ) {
V_74 = F_288 ( V_213 ) ;
goto V_107;
...
{
return ( F_13 ( & V_11 -> V_364 ) ||
F_163 ( V_348 , & V_11 -> V_347 ) ||
F_163 ( V_352 , & V_11 -> V_347 ) ) ;
}
static void F_293 ( struct V_10 * V_11 )
{
unsigned long V_126 ;
struct V_129 * V_129 ;
int V_424 = ! F_163 ( V_425 , & V_11 -> V_347 ) ;
F_72 ( F_292 ( V_11 ) ) ;
V_126 = F_151 ( V_11 -> V_15 , V_11 -> V_21 ) ;
if ( V_126 == 0 )
return;
do {
V_126 -- ;
...
if ( V_129 && V_424 ) {
F_70 ( & V_129 -> V_28 -> V_378 ) ;
if ( F_193 ( V_129 ) &&
V_129 -> V_50 == ( unsigned long ) V_11 ) {
F_72 ( F_163 ( V_352 , & V_11 -> V_347 ) ) ;
F_72 ( F_121 ( V_129 ) ) ;
F_72 ( F_224 ( V_129 ) ) ;
F_294 ( V_129 ) ;
F_196 ( V_129 , 0 ) ;
...
struct V_129 * V_60 ;
struct V_10 * V_5 ;
unsigned long V_202 = F_151 ( V_437 -> V_15 , V_437 -> V_21 ) ;
V_5 = F_296 ( NULL , V_437 -> V_15 , V_437 -> V_21 , V_125 ) ;
if ( V_5 == NULL )
return NULL ;
for ( V_140 = 0 ; V_140 < V_202 ; V_140 ++ ) {
V_60 = F_301 ( V_125 ) ;
...
F_237 ( V_438 , & V_5 -> V_347 ) ;
F_237 ( V_425 , & V_5 -> V_347 ) ;
return V_5 ;
}
struct V_10 * F_303 ( T_1 V_15 , unsigned long V_21 )
{
struct V_10 * V_11 ;
unsigned long V_202 = F_151 ( 0 , V_21 ) ;
unsigned long V_140 ;
V_11 = F_296 ( NULL , V_15 , V_21 , V_125 ) ;
if ( ! V_11 )
return NULL ;
for ( V_140 = 0 ; V_140 < V_202 ; V_140 ++ ) {
...
int V_17 ;
V_17 = F_13 ( & V_11 -> V_17 ) ;
if ( V_17 >= 2 && F_163 ( V_439 , & V_11 -> V_347 ) )
return;
F_70 ( & V_11 -> V_351 ) ;
if ( ! F_246 ( V_439 , & V_11 -> V_347 ) )
F_82 ( & V_11 -> V_17 ) ;
F_74 ( & V_11 -> V_351 ) ;
}
...
{
struct V_10 * V_11 , * V_442 = NULL ;
int V_74 ;
V_11 = F_310 ( V_175 , V_15 ) ;
if ( V_11 )
return V_11 ;
V_11 = F_303 ( V_15 , V_21 ) ;
if ( ! V_11 )
return NULL ;
V_11 -> V_175 = V_175 ;
V_104:
V_74 = F_315 ( V_125 & ~ V_443 ) ;
if ( V_74 )
goto V_444;
F_70 ( & V_175 -> V_445 ) ;
V_74 = F_316 ( & V_175 -> V_441 ,
V_15 >> V_127 , V_11 ) ;
F_74 ( & V_175 -> V_445 ) ;
F_317 () ;
if ( V_74 == - V_84 ) {
V_442 = F_310 ( V_175 , V_15 ) ;
if ( V_442 )
goto V_444;
else
goto V_104;
...
T_1 V_15 , unsigned long V_21 )
{
unsigned long V_202 = F_151 ( V_15 , V_21 ) ;
unsigned long V_140 ;
unsigned long V_126 = V_15 >> V_127 ;
struct V_10 * V_11 ;
struct V_10 * V_442 = NULL ;
struct V_129 * V_60 ;
...
if ( V_11 )
return V_11 ;
V_11 = F_296 ( V_175 , V_15 , V_21 , V_125 ) ;
if ( ! V_11 )
return NULL ;
...
static inline void F_322 ( struct V_447 * V_6 )
{
struct V_10 * V_11 =
F_323 ( V_6 , struct V_10 , V_447 ) ;
F_291 ( V_11 ) ;
}
...
if ( V_17 <= 3 )
break;
V_448 = F_327 ( & V_11 -> V_17 , V_17 , V_17 - 1 ) ;
if ( V_448 == V_17 )
return;
}
F_70 ( & V_11 -> V_351 ) ;
if ( F_13 ( & V_11 -> V_17 ) == 2 &&
F_163 ( V_425 , & V_11 -> V_347 ) )
F_71 ( & V_11 -> V_17 ) ;
if ( F_13 ( & V_11 -> V_17 ) == 2 &&
F_163 ( V_449 , & V_11 -> V_347 ) &&
! F_292 ( V_11 ) &&
F_236 ( V_439 , & V_11 -> V_347 ) )
F_71 ( & V_11 -> V_17 ) ;
F_324 ( V_11 ) ;
}
...
F_41 ( ! F_193 ( V_129 ) ) ;
F_105 ( V_129 ) ;
F_330 ( & V_129 -> V_28 -> V_450 ) ;
if ( ! F_121 ( V_129 ) ) {
F_331 ( & V_129 -> V_28 -> V_451 ,
F_332 ( V_129 ) ,
V_375 ) ;
}
F_333 ( & V_129 -> V_28 -> V_450 ) ;
F_228 ( V_129 ) ;
F_118 ( V_129 ) ;
}
F_41 ( F_13 ( & V_11 -> V_17 ) == 0 ) ;
}
int F_334 ( struct V_10 * V_11 )
{
unsigned long V_140 ;
unsigned long V_202 ;
int V_452 = 0 ;
F_307 ( V_11 ) ;
V_452 = F_246 ( V_352 , & V_11 -> V_347 ) ;
V_202 = F_151 ( V_11 -> V_15 , V_11 -> V_21 ) ;
F_41 ( F_13 ( & V_11 -> V_17 ) == 0 ) ;
F_41 ( ! F_163 ( V_439 , & V_11 -> V_347 ) ) ;
for ( V_140 = 0 ; V_140 < V_202 ; V_140 ++ )
F_335 ( V_11 -> V_138 [ V_140 ] ) ;
return V_452 ;
}
...
{
return F_163 ( V_438 , & V_11 -> V_347 ) ;
}
int F_338 ( struct V_24 * V_25 ,
...
V_202 = F_151 ( V_11 -> V_15 , V_11 -> V_21 ) ;
for ( V_140 = V_453 ; V_140 < V_202 ; V_140 ++ ) {
V_129 = V_11 -> V_138 [ V_140 ] ;
if ( V_109 == V_457 ) {
if ( ! F_240 ( V_129 ) )
goto V_458;
...
F_242 ( V_459 , & V_11 -> V_347 ) ;
V_11 -> V_460 = 0 ;
F_36 ( & V_11 -> V_364 , V_456 ) ;
for ( V_140 = V_453 ; V_140 < V_202 ; V_140 ++ ) {
V_129 = V_11 -> V_138 [ V_140 ] ;
if ( ! F_203 ( V_129 ) ) {
F_228 ( V_129 ) ;
...
if ( V_41 ) {
V_95 = F_184 ( V_315 | V_365 , V_41 , V_174 ,
V_217 ) ;
if ( V_95 )
return V_95 ;
}
...
void F_340 ( struct V_10 * V_11 , void * V_462 ,
unsigned long V_15 ,
unsigned long V_21 )
{
T_10 V_293 ;
...
T_10 V_465 = V_11 -> V_15 & ( ( T_1 ) V_149 - 1 ) ;
unsigned long V_140 = ( V_465 + V_15 ) >> V_127 ;
F_41 ( V_15 > V_11 -> V_21 ) ;
F_41 ( V_15 + V_21 > V_11 -> V_15 + V_11 -> V_21 ) ;
V_56 = ( V_465 + V_15 ) & ( V_149 - 1 ) ;
while ( V_21 > 0 ) {
V_129 = V_11 -> V_138 [ V_140 ] ;
V_293 = F_131 ( V_21 , ( V_149 - V_56 ) ) ;
V_463 = F_341 ( V_129 ) ;
memcpy ( V_464 , V_463 + V_56 , V_293 ) ;
V_464 += V_293 ;
V_21 -= V_293 ;
V_56 = 0 ;
V_140 ++ ;
...
int F_342 ( struct V_10 * V_11 , void T_17 * V_462 ,
unsigned long V_15 ,
unsigned long V_21 )
{
T_10 V_293 ;
...
V_293 = F_131 ( V_21 , ( V_149 - V_56 ) ) ;
V_463 = F_341 ( V_129 ) ;
if ( F_343 ( V_464 , V_463 + V_56 , V_293 ) ) {
V_74 = - V_466 ;
break;
}
V_464 += V_293 ;
...
int F_344 ( struct V_10 * V_11 , unsigned long V_15 ,
unsigned long V_467 , char * * V_387 ,
unsigned long * V_468 ,
unsigned long * V_469 )
{
...
int F_345 ( struct V_10 * V_11 , const void * V_471 ,
unsigned long V_15 ,
unsigned long V_21 )
{
T_10 V_293 ;
...
V_293 = F_131 ( V_21 , ( V_149 - V_56 ) ) ;
V_463 = F_341 ( V_129 ) ;
V_74 = memcmp ( V_472 , V_463 + V_56 , V_293 ) ;
if ( V_74 )
break;
V_472 += V_293 ;
V_21 -= V_293 ;
...
void F_346 ( struct V_10 * V_11 , const void * V_473 ,
...
void F_347 ( struct V_10 * V_11 , char V_474 ,
unsigned long V_15 , unsigned long V_21 )
{
T_10 V_293 ;
T_10 V_56 ;
...
V_293 = F_131 ( V_21 , V_149 - V_56 ) ;
V_463 = F_341 ( V_129 ) ;
memset ( V_463 + V_56 , V_474 , V_293 ) ;
V_21 -= V_293 ;
V_56 = 0 ;
V_140 ++ ;
}
}
void F_302 ( struct V_10 * V_464 , struct V_10 * V_437 ,
...
struct V_129 * V_129 ;
char * V_463 ;
T_10 V_465 = V_464 -> V_15 & ( ( T_1 ) V_149 - 1 ) ;
unsigned long V_140 = ( V_465 + V_475 ) >> V_127 ;
F_41 ( V_437 -> V_21 != V_477 ) ;
V_56 = ( V_465 + V_475 ) &
( V_149 - 1 ) ;
while ( V_21 > 0 ) {
V_129 = V_464 -> V_138 [ V_140 ] ;
F_41 ( ! F_203 ( V_129 ) ) ;
V_293 = F_131 ( V_21 , ( unsigned long ) ( V_149 - V_56 ) ) ;
V_463 = F_341 ( V_129 ) ;
F_340 ( V_437 , V_463 + V_56 , V_476 , V_293 ) ;
V_476 += V_293 ;
V_21 -= V_293 ;
V_56 = 0 ;
V_140 ++ ;
...
static inline bool F_348 ( unsigned long V_437 , unsigned long V_464 , unsigned long V_21 )
{
unsigned long V_478 = ( V_437 > V_464 ) ? V_437 - V_464 : V_464 - V_437 ;
return V_478 < V_21 ;
}
static void F_349 ( struct V_129 * V_479 , struct V_129 * V_480 ,
unsigned long V_481 , unsigned long V_482 ,
unsigned long V_21 )
{
char * V_483 = F_341 ( V_479 ) ;
char * V_484 ;
int V_485 = 0 ;
if ( V_479 != V_480 ) {
V_484 = F_341 ( V_480 ) ;
...
V_484 = V_483 ;
if ( F_348 ( V_482 , V_481 , V_21 ) )
V_485 = 1 ;
}
if ( V_485 )
memmove ( V_483 + V_481 , V_484 + V_482 , V_21 ) ;
else
memcpy ( V_483 + V_481 , V_484 + V_482 , V_21 ) ;
}
void F_350 ( struct V_10 * V_464 , unsigned long V_475 ,
...
F_15 ( V_20 L_30
L_31 , V_476 , V_21 , V_464 -> V_21 ) ;
F_72 ( 1 ) ;
}
if ( V_475 + V_21 > V_464 -> V_21 ) {
F_15 ( V_20 L_32
L_31 , V_475 , V_21 , V_464 -> V_21 ) ;
F_72 ( 1 ) ;
}
while ( V_21 > 0 ) {
V_486 = ( V_465 + V_475 ) &
...
V_487 = ( V_465 + V_476 ) &
( V_149 - 1 ) ;
V_488 = ( V_465 + V_475 ) >> V_127 ;
V_489 = ( V_465 + V_476 ) >> V_127 ;
V_293 = F_131 ( V_21 , ( unsigned long ) ( V_149 -
V_487 ) ) ;
V_293 = F_117 (unsigned long, cur,
(unsigned long)(PAGE_CACHE_SIZE - dst_off_in_page)) ;
F_349 ( V_464 -> V_138 [ V_488 ] , V_464 -> V_138 [ V_489 ] ,
V_486 , V_487 , V_293 ) ;
V_476 += V_293 ;
V_475 += V_293 ;
V_21 -= V_293 ;
...
void F_351 ( struct V_10 * V_464 , unsigned long V_475 ,
unsigned long V_476 , unsigned long V_21 )
{
T_10 V_293 ;
T_10 V_486 ;
T_10 V_487 ;
unsigned long V_490 = V_475 + V_21 - 1 ;
unsigned long V_491 = V_476 + V_21 - 1 ;
T_10 V_465 = V_464 -> V_15 & ( ( T_1 ) V_149 - 1 ) ;
unsigned long V_488 ;
unsigned long V_489 ;
if ( V_476 + V_21 > V_464 -> V_21 ) {
F_15 ( V_20 L_30
L_33 , V_476 , V_21 , V_464 -> V_21 ) ;
F_72 ( 1 ) ;
}
if ( V_475 + V_21 > V_464 -> V_21 ) {
F_15 ( V_20 L_32
L_33 , V_475 , V_21 , V_464 -> V_21 ) ;
F_72 ( 1 ) ;
}
if ( V_475 < V_476 ) {
F_350 ( V_464 , V_475 , V_476 , V_21 ) ;
return;
}
while ( V_21 > 0 ) {
V_488 = ( V_465 + V_490 ) >> V_127 ;
V_489 = ( V_465 + V_491 ) >> V_127 ;
V_486 = ( V_465 + V_490 ) &
( V_149 - 1 ) ;
V_487 = ( V_465 + V_491 ) &
( V_149 - 1 ) ;
V_293 = F_117 (unsigned long, len, src_off_in_page + 1 ) ;
V_293 = F_131 ( V_293 , V_486 + 1 ) ;
F_349 ( V_464 -> V_138 [ V_488 ] , V_464 -> V_138 [ V_489 ] ,
V_486 - V_293 + 1 ,
V_487 - V_293 + 1 , V_293 ) ;
V_490 -= V_293 ;
