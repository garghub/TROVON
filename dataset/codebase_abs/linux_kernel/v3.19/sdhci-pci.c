...
static int F_78 ( struct V_50 * V_37 )
{
return 0 ;
}
...
if ( ! ( F_80 ( V_3 , V_143 ) & V_144 ) ) {
F_41 ( & V_3 -> V_37 , L_12 , V_143 ) ;
return F_81 ( - V_59 ) ;
}
if ( F_82 ( V_3 , V_143 ) < 0x100 ) {
F_41 ( & V_3 -> V_37 , L_13
L_14 ) ;
}
...
V_11 -> V_24 = V_3 -> V_24 ;
V_62 = F_86 ( V_3 , V_143 , F_87 ( V_11 -> V_21 ) ) ;
if ( V_62 ) {
F_41 ( & V_3 -> V_37 , L_20 ) ;
goto V_152;
}
V_11 -> V_79 = F_88 ( V_3 , V_143 ) ;
if ( ! V_11 -> V_79 ) {
F_41 ( & V_3 -> V_37 , L_21 ) ;
V_62 = - V_153 ;
goto V_154;
...
if ( V_10 -> V_54 >= 0 &&
F_90 ( V_11 -> V_21 , V_10 -> V_53 , V_10 -> V_54 ,
V_10 -> V_55 , 0 , NULL ) ) {
F_18 ( & V_3 -> V_37 , L_24 ) ;
V_10 -> V_54 = - 1 ;
}
...
if ( V_10 -> V_147 && V_10 -> V_147 -> V_152 )
V_10 -> V_147 -> V_152 ( V_10 -> V_147 ) ;
F_93 ( V_10 -> V_2 -> V_3 , V_10 -> V_145 ) ;
F_94 ( V_10 -> V_11 ) ;
}
static void F_97 ( struct V_50 * V_37 )
{
F_98 ( V_37 ) ;
F_99 ( V_37 ) ;
F_100 ( V_37 , 50 ) ;
...
static void F_103 ( struct V_50 * V_37 )
{
F_104 ( V_37 ) ;
F_105 ( V_37 ) ;
}
static int F_106 ( struct V_74 * V_3 ,
...
if ( V_62 )
return V_62 ;
V_2 = F_111 ( sizeof( struct V_1 ) , V_169 ) ;
if ( ! V_2 ) {
V_62 = - V_153 ;
goto V_28;
}
...
static void F_116 ( struct V_74 * V_3 )
{
int V_93 ;
struct V_1 * V_2 ;
V_2 = F_67 ( V_3 ) ;
