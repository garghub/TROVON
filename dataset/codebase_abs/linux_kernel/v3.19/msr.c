...
static T_2 F_5 ( struct V_1 * V_1 , char T_3 * V_11 ,
T_4 V_12 , T_1 * V_13 )
{
T_5 T_3 * V_14 = ( T_5 T_3 * ) V_11 ;
T_5 V_15 [ 2 ] ;
T_5 V_16 = * V_13 ;
int V_17 = F_6 ( F_2 ( V_1 ) ) ;
int V_18 = 0 ;
T_2 V_19 = 0 ;
if ( V_12 % 8 )
return - V_10 ;
...
static char * F_28 ( struct V_40 * V_41 , T_6 * V_52 )
{
return F_29 ( V_53 , L_2 , F_30 ( V_41 -> V_54 ) ) ;
}
static int T_7 F_31 ( void )
{
int V_55 , V_18 = 0 ;
V_55 = 0 ;
if ( F_32 ( V_43 , 0 , V_56 , L_3 , & V_57 ) ) {
F_33 ( L_4 , V_43 ) ;
V_18 = - V_58 ;
goto V_59;
}
