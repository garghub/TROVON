...
unsigned int V_51 = F_18 ( T_2 , F_19 ( V_47 ) ,
F_20 ( V_44 | V_46 ) ) ;
if ( V_41 + V_49 >= 5 )
return - 1 ;
...
continue;
V_65 = F_24 ( V_65 , ( T_4 ) V_10 -> V_83 [ V_49 ] . V_45 ) ;
V_64 = F_25 ( V_64 , ( T_4 ) V_10 -> V_83 [ V_49 ] . V_85 ) ;
V_32 = V_10 -> V_86 [ V_49 ] ;
...
V_67 = ( V_65 - V_68 ) & - V_68 ;
F_27 ( V_10 , 0 , 0 , V_91 , V_67 ) ;
V_65 = F_24 ( V_65 , ( T_4 ) V_67 ) ;
F_28 ( L_8 , V_75 , V_67 ) ;
V_62 = F_29 () ;
V_78 = F_30 ( V_10 -> V_76 , L_9 , & V_33 ) ;
...
static void T_6 F_35 ( struct V_9 * V_10 )
{
T_7 V_104 ;
int V_105 ;
...
| V_110 ;
F_37 ( V_10 , 0 , 0 , V_106 , V_104 ) ;
V_105 = F_23 ( V_10 , 0 , 0 , V_111 ) ;
if ( V_105 ) {
int V_112 = V_105 + V_113 ;
V_104 = V_114 | V_115
| V_116 | V_117 ;
F_37 ( V_10 , 0 , 0 , V_112 , V_104 ) ;
} else {
F_38 ( V_10 , 0 , 0 , V_118 , 0x80 ) ;
}
}
...
int F_40 ( struct V_124 * V_125 , int V_126 )
{
int V_33 ;
struct V_9 * V_10 ;
struct V_42 V_127 ;
...
V_25 = V_10 -> V_26 = F_46 ( V_127 . V_45 , F_16 ( & V_127 ) ) ;
if ( ! V_10 -> V_26 )
goto V_137;
F_47 ( V_10 , V_127 . V_45 , V_127 . V_45 + 0x4 ,
V_138 ) ;
if ( F_7 ( & V_25 -> V_80 ) < V_139 )
V_10 -> V_12 |= V_13 ;
if ( F_23 ( V_10 , 0 , 0 , V_79 ) ) {
V_10 -> V_14 = & V_140 ;
F_48 ( V_10 , 0 , 0 , V_4 , & V_3 ) ;
if ( ( V_3 & 0x7f ) != V_5 )
goto V_137;
} else {
F_48 ( V_10 , 0 , 0 , V_141 , & V_129 ) ;
if ( ( V_129 & 1 ) &&
! F_49 ( V_2 , L_29 ) )
goto V_137;
}
...
static void T_3 * F_54 ( struct V_17 * V_18 ,
...
goto V_158;
F_55 ( V_153 -> V_157 + V_159 , V_155 ) ;
V_153 -> V_155 = V_155 ;
V_158:
return V_153 -> V_160 + V_32 ;
}
static int F_56 ( struct V_17 * V_18 , unsigned int V_31 ,
int V_32 , int V_33 , T_2 * V_11 )
{
void T_3 * V_145 ;
V_145 = F_54 ( V_18 , V_31 , V_32 ) ;
if ( ! V_145 )
return V_148 ;
switch ( V_33 ) {
case 1 :
...
static int F_60 ( struct V_17 * V_18 , unsigned int V_31 ,
int V_32 , int V_33 , T_2 V_11 )
{
struct V_9 * V_10 = F_8 ( V_18 ) ;
void T_3 * V_145 ;
...
static int T_6 F_63 ( struct V_9 * V_10 ,
struct V_42 * V_78 )
{
struct V_152 * V_153 ;
T_2 V_162 ;
int V_156 = - V_134 ;
V_153 = F_64 ( sizeof( * V_153 ) , V_163 ) ;
if ( ! V_153 )
return V_156 ;
V_153 -> V_157 = F_46 ( V_78 -> V_45 , F_16 ( V_78 ) ) ;
if ( ! V_153 -> V_157 )
goto V_164;
V_162 = F_59 ( V_153 -> V_157 + V_165 ) ;
if ( ! V_162 ) {
V_156 = - V_132 ;
goto V_166;
}
V_153 -> V_160 = F_46 ( V_162 , 0x1000 ) ;
if ( ! V_153 -> V_160 )
goto V_166;
F_65 ( V_10 -> V_76 -> V_154 ) ;
V_10 -> V_76 -> V_154 = V_153 ;
V_10 -> V_14 = & V_167 ;
V_10 -> V_12 |= V_13 ;
F_55 ( V_153 -> V_157 + V_168 , 0 ) ;
F_55 ( V_153 -> V_157 + V_159 , 0 ) ;
if ( F_4 ( V_10 ) )
V_10 -> V_12 |= V_34 ;
return 0 ;
V_166:
...
V_10 -> V_136 = V_128 ? V_128 [ 1 ] : 0xff ;
if ( F_68 ( V_2 , L_37 ) ) {
V_156 = F_63 ( V_10 , & V_169 ) ;
if ( V_156 )
goto V_164;
} else {
F_47 ( V_10 , V_170 . V_45 ,
V_170 . V_45 + 4 , 0 ) ;
}
F_43 ( V_144 L_30
L_31 ,
...
if ( ! ( F_59 ( & V_173 [ V_49 ] . V_175 ) & V_176 ) )
continue;
if ( F_71 () == F_59 ( & V_173 [ V_49 ] . V_177 ) )
return ( T_4 ) F_59 ( & V_173 [ V_49 ] . V_178 ) << 32 |
F_59 ( & V_173 [ V_49 ] . V_179 ) ;
}
F_43 ( V_133 L_38 ) ;
}
#endif
#if F_72 ( V_180 ) || F_72 ( V_181 )
if ( ! V_171 ) {
T_2 V_182 ;
F_73 ( V_10 -> V_18 ,
F_74 ( 0 , 0 ) , V_91 , & V_182 ) ;
...
static int F_75 ( struct V_184 * V_185 , T_2 V_186 )
{
...
static int F_82 ( T_8 V_211 )
{
struct V_9 * V_10 ;
struct V_42 * V_43 ;
int V_49 ;
F_83 (hose, &hose_list, list_node) {
if ( ! ( V_10 -> V_12 & V_142 ) )
continue;
...
if ( V_218 )
return;
V_217 = F_93 ( NULL , L_39 ) ;
while ( ( V_218 = F_94 ( V_217 ) ) ) {
F_95 ( V_217 ) ;
V_217 = V_218 ;
if ( F_96 ( V_219 , V_217 ) && F_41 ( V_217 ) )
return;
}
F_97 (np, pci_ids) {
if ( F_41 ( V_217 ) ) {
...
static T_9 F_98 ( int V_220 , void * V_221 )
{
...
int V_43 ;
T_7 V_227 ;
V_2 = F_100 ( & V_10 -> V_18 -> V_228 , F_101 ( * V_2 ) , V_229 ) ;
F_102 ( V_2 , V_2 -> V_230 + V_231 , & V_227 ) ;
V_227 &= ~ V_232 ;
F_103 ( V_2 , V_2 -> V_230 + V_231 , V_227 ) ;
V_226 = F_104 ( V_10 -> V_76 , 0 ) ;
if ( ! V_226 ) {
F_105 ( & V_2 -> V_2 , L_40 ) ;
return - V_233 ;
}
V_43 = F_106 ( V_10 -> V_121 , V_226 ,
F_98 ,
V_234 ,
L_41 , V_10 ) ;
if ( V_43 < 0 ) {
F_105 ( & V_2 -> V_2 , L_42 , V_226 ) ;
F_107 ( V_226 ) ;
return - V_132 ;
}
V_25 = V_10 -> V_26 ;
...
F_114 (hose, tmp, &hose_list, list_node)
F_112 ( V_10 ) ;
return 0 ;
}
...
void F_117 ( struct V_9 * V_244 )
{
#ifdef F_118
F_99 ( V_244 ) ;
#endif
}
static int F_119 ( struct V_124 * V_125 )
{
struct V_130 * V_245 ;
int V_156 ;
V_245 = V_125 -> V_2 . V_131 ;
V_156 = F_40 ( V_125 , V_218 == V_245 ) ;
F_120 ( V_125 ) ;
return 0 ;
}
