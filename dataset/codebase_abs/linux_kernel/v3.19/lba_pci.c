...
if ( V_12 -> V_6 ) {
T_1 V_74 ;
( void ) F_47 ( V_12 -> V_57 , V_75 , & V_74 ) ;
( void ) F_48 ( V_12 -> V_57 , V_75 , V_74 | V_69 ) ;
} else {
}
V_73 = V_76 ;
}
...
V_52 |= V_78 | V_79 | V_73 ;
( void ) F_49 ( V_51 , V_77 , V_52 ) ;
}
#endif
}
static void
F_50 ( struct V_80 * V_81 , struct V_14 * V_82 )
{
unsigned long V_83 ;
long V_84 ;
long V_52 ;
...
T_5 * V_87 ;
int V_4 ;
V_86 = F_51 ( sizeof( T_5 ) , V_88 ) ;
if ( ! V_86 )
return;
V_87 = F_51 ( sizeof( T_5 ) , V_88 ) ;
if ( ! V_87 ) {
F_52 ( V_86 ) ;
return;
}
V_52 = F_53 ( & V_83 , V_81 -> V_89 , V_81 -> V_90 ,
V_91 , V_86 ) ;
V_85 = V_86 -> V_92 [ 1 ] ;
V_52 |= F_53 ( & V_83 , V_81 -> V_89 , V_81 -> V_90 ,
V_93 , V_87 ) ;
...
break;
case V_111 :
V_82 -> V_112 = F_56 ( V_97 -> V_7 , 64 * 1024 * 1024 ) ;
sprintf ( V_82 -> V_16 . V_113 , L_35 ,
( int ) V_82 -> V_16 . V_100 . V_7 ) ;
V_2 = & V_82 -> V_16 . V_59 ;
V_2 -> V_60 = V_82 -> V_16 . V_113 ;
V_2 -> V_7 = F_57 ( V_82 -> V_16 . V_114 ) ;
...
static void
F_58 ( struct V_80 * V_81 , struct V_14 * V_82 )
{
struct V_1 * V_2 ;
int V_117 ;
...
V_2 -> V_9 = V_107 ;
V_2 -> V_7 &= V_122 ;
V_2 -> V_7 = F_60 ( F_61 ( V_82 ) , V_2 -> V_7 ) ;
V_121 = ~ F_11 ( V_82 -> V_16 . V_28 + V_103 ) ;
V_121 /= V_123 ;
V_2 -> V_7 += ( V_121 + 1 ) * F_62 ( V_81 -> V_124 . V_7 ) ;
...
V_117 = F_57 ( V_82 -> V_16 . V_114 ) ;
V_2 -> V_7 |= V_117 ;
V_2 -> V_8 |= V_117 ;
}
static int T_6
F_64 ( struct V_14 * V_3 )
{
T_2 V_129 ;
T_2 V_130 ;
#if 0
...
void * V_142 ;
char * V_143 ;
void T_3 * V_144 = F_56 ( V_51 -> V_124 . V_7 , 4096 ) ;
int V_145 ;
...
} else if ( F_69 ( V_51 ) || F_70 ( V_51 ) ) {
int V_149 , V_150 ;
V_141 &= 0xff ;
V_149 = V_141 >> 4 , V_150 = V_141 & 0xf ;
F_2 ( V_147 L_51 ,
F_69 ( V_51 ) ? L_52 : L_53 , V_149 ,
...
V_142 = F_71 ( V_51 -> V_124 . V_7 + V_153 ) ;
V_82 = F_51 ( sizeof( struct V_14 ) , V_88 ) ;
if ( ! V_82 ) {
F_2 ( V_64 L_55 ) ;
return ( 1 ) ;
}
...
F_77 ( & V_137 , & V_82 -> V_16 . V_59 ,
F_57 ( V_82 -> V_16 . V_114 ) ) ;
if ( V_82 -> V_16 . V_63 . V_9 )
F_77 ( & V_137 , & V_82 -> V_16 . V_63 ,
V_82 -> V_16 . V_105 ) ;
if ( V_82 -> V_16 . V_61 . V_9 )
F_77 ( & V_137 , & V_82 -> V_16 . V_61 ,
V_82 -> V_16 . V_105 ) ;
if ( V_82 -> V_16 . V_65 . V_9 )
F_78 ( & V_137 , & V_82 -> V_16 . V_65 ) ;
F_78 ( & V_137 , & V_82 -> V_16 . V_100 ) ;
V_51 -> V_51 . V_54 = V_82 ;
V_138 = V_82 -> V_16 . V_17 =
F_79 ( & V_51 -> V_51 , V_82 -> V_16 . V_100 . V_7 ,
V_140 , NULL , & V_137 ) ;
if ( ! V_138 ) {
F_80 ( & V_137 ) ;
return 0 ;
...
{
void T_3 * V_28 = F_56 ( V_167 -> V_124 . V_7 , 4096 ) ;
V_169 <<= 2 ;
