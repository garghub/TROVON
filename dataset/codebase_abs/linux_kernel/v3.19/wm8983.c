...
static int F_27 ( struct V_149 * V_150 )
{
struct V_68 * V_69 ;
int V_74 ;
V_69 = F_28 ( & V_150 -> V_24 , sizeof *V_69 , V_151 ) ;
if ( ! V_69 )
return - V_152 ;
V_69 -> V_131 = F_29 ( V_150 , & V_153 ) ;
if ( F_30 ( V_69 -> V_131 ) ) {
V_74 = F_31 ( V_69 -> V_131 ) ;
F_10 ( & V_150 -> V_24 , L_19 , V_74 ) ;
return V_74 ;
}
F_32 ( V_150 , V_69 ) ;
V_74 = F_33 ( & V_150 -> V_24 ,
& V_154 , & V_155 , 1 ) ;
return V_74 ;
}
...
static int F_36 ( struct V_156 * V_157 ,
const struct V_158 * V_159 )
{
struct V_68 * V_69 ;
int V_74 ;
V_69 = F_28 ( & V_157 -> V_24 , sizeof *V_69 , V_151 ) ;
if ( ! V_69 )
return - V_152 ;
V_69 -> V_131 = F_37 ( V_157 , & V_153 ) ;
if ( F_30 ( V_69 -> V_131 ) ) {
V_74 = F_31 ( V_69 -> V_131 ) ;
...
F_38 ( V_157 , V_69 ) ;
V_74 = F_33 ( & V_157 -> V_24 ,
& V_154 , & V_155 , 1 ) ;
return V_74 ;
}
static int F_39 ( struct V_156 * V_160 )
{
F_35 ( & V_160 -> V_24 ) ;
return 0 ;
}
