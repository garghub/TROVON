...
static T_5 void F_212 ( struct V_234 * V_235 )
{
F_66 ( & V_236 ) ;
F_213 ( & V_237 ) ;
F_214 ( 1 ) ;
...
static T_5 int F_217 ( void * V_239 )
{
void * V_240 ;
...
static T_5 void F_223 ( void )
{
struct V_243 * V_244 ;
V_244 = F_224 ( F_217 , NULL , L_49 ) ;
F_216 ( 1 ) ;
F_225 ( V_244 ) ;
}
static T_5 void F_226 ( void )
{
struct V_89 * V_90 ;
struct V_35 * V_53 ;
struct V_5 * V_14 ;
...
static void
F_229 ( unsigned long V_190 , unsigned long V_191 ,
...
V_41 -> V_190 = V_190 ;
V_41 -> V_191 = V_191 ;
F_234 ( V_40 , V_31 , V_38 , V_39 ) ;
V_127:
F_235 ( & F_232 ( V_253 , V_252 ) ) ;
F_236 () ;
}
static T_5 void F_237 ( void )
{
int V_25 ;
V_25 = F_238 ( & V_255 ) ;
if ( F_13 ( V_25 < 0 ) ) {
