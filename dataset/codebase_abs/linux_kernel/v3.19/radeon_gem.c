...
int F_30 ( struct V_61 * V_58 , void * V_62 ,
struct V_44 * V_63 )
{
...
int F_39 ( struct V_61 * V_58 , void * V_62 ,
struct V_44 * V_63 )
{
struct V_9 * V_10 = V_58 -> V_64 ;
...
goto V_93;
V_84 = F_2 ( V_2 ) ;
V_18 = F_41 ( V_84 -> V_7 . V_94 , args -> V_85 , args -> V_14 ) ;
if ( V_18 )
goto V_95;
if ( args -> V_14 & V_90 ) {
V_18 = F_42 ( V_84 , args -> V_85 ) ;
if ( V_18 )
goto V_95;
}
if ( args -> V_14 & V_89 ) {
...
F_43 ( V_84 , V_27 ) ;
V_18 = F_44 ( & V_84 -> V_7 , & V_84 -> V_98 , true , false ) ;
F_24 ( V_84 ) ;
F_36 ( & V_29 -> V_96 -> V_97 ) ;
if ( V_18 )
goto V_95;
...
int F_45 ( struct V_61 * V_58 , void * V_62 ,
struct V_44 * V_63 )
{
struct V_9 * V_10 = V_58 -> V_64 ;
...
int V_18 ;
F_34 ( & V_10 -> V_82 ) ;
V_2 = F_46 ( V_58 , V_63 , args -> V_81 ) ;
if ( V_2 == NULL ) {
F_36 ( & V_10 -> V_82 ) ;
return - V_100 ;
}
V_4 = F_2 ( V_2 ) ;
V_18 = F_13 ( V_2 , args -> V_101 , args -> V_102 ) ;
F_38 ( V_2 ) ;
F_36 ( & V_10 -> V_82 ) ;
V_18 = F_28 ( V_4 -> V_10 , V_18 ) ;
return V_18 ;
}
int F_47 ( struct V_44 * V_63 ,
struct V_61 * V_58 ,
T_2 V_81 , T_3 * V_103 )
{
struct V_1 * V_2 ;
struct V_3 * V_4 ;
V_2 = F_46 ( V_58 , V_63 , V_81 ) ;
if ( V_2 == NULL ) {
return - V_100 ;
}
V_4 = F_2 ( V_2 ) ;
if ( F_48 ( V_4 -> V_7 . V_94 ) ) {
F_38 ( V_2 ) ;
return - V_104 ;
}
* V_103 = F_49 ( V_4 ) ;
...
int F_50 ( struct V_61 * V_58 , void * V_62 ,
struct V_44 * V_63 )
{
struct V_105 * args = V_62 ;
return F_47 ( V_63 , V_58 , args -> V_81 , & args -> V_106 ) ;
}
...
V_4 = F_2 ( V_2 ) ;
V_18 = F_52 ( V_4 , & V_108 , true ) ;
args -> V_36 = F_53 ( V_108 ) ;
F_38 ( V_2 ) ;
V_18 = F_28 ( V_10 , V_18 ) ;
return V_18 ;
}
int F_54 ( struct V_61 * V_58 , void * V_62 ,
struct V_44 * V_63 )
{
struct V_9 * V_10 = V_58 -> V_64 ;
struct V_109 * args = V_62 ;
struct V_1 * V_2 ;
struct V_3 * V_4 ;
int V_18 = 0 ;
T_2 V_108 = 0 ;
...
V_4 = F_2 ( V_2 ) ;
V_110 = F_15 ( V_4 -> V_7 . V_39 , true , true , 30 * V_40 ) ;
if ( V_110 == 0 )
V_18 = - V_41 ;
else if ( V_110 < 0 )
V_18 = V_110 ;
if ( V_10 -> V_111 -> V_112 &&
F_53 ( V_108 ) == V_26 )
V_4 -> V_10 -> V_111 -> V_112 ( V_10 ) ;
F_38 ( V_2 ) ;
V_18 = F_28 ( V_10 , V_18 ) ;
return V_18 ;
}
int F_55 ( struct V_61 * V_58 , void * V_62 ,
struct V_44 * V_63 )
{
struct V_113 * args = V_62 ;
struct V_1 * V_2 ;
struct V_3 * V_4 ;
int V_18 = 0 ;
F_6 ( L_8 , args -> V_81 ) ;
...
return - V_100 ;
V_4 = F_2 ( V_2 ) ;
V_18 = F_56 ( V_4 , args -> V_114 , args -> V_115 ) ;
F_38 ( V_2 ) ;
return V_18 ;
}
...
if ( F_58 ( V_18 != 0 ) )
goto V_117;
F_59 ( V_46 , & args -> V_114 , & args -> V_115 ) ;
F_24 ( V_46 ) ;
V_117:
F_38 ( V_2 ) ;
return V_18 ;
...
int V_18 ;
F_17 ( & V_32 ) ;
V_119 . V_84 = & V_53 -> V_84 -> V_7 ;
V_119 . V_126 = true ;
F_61 ( & V_119 . V_127 , & V_32 ) ;
V_122 = F_62 ( V_10 , V_53 -> V_51 , & V_32 ) ;
if ( ! V_122 )
return;
V_18 = F_63 ( & V_124 , & V_32 , true , NULL ) ;
if ( V_18 )
goto V_128;
F_64 (entry, &list, head) {
V_36 = F_53 ( V_120 -> V_84 -> V_129 . V_130 ) ;
if ( V_36 == V_38 )
goto V_131;
}
F_10 ( & V_53 -> V_51 -> V_31 ) ;
V_18 = F_65 ( V_10 , V_53 -> V_51 ) ;
if ( V_18 )
goto V_132;
if ( V_53 -> V_133 . V_134 )
V_18 = F_66 ( V_10 , V_53 , & V_53 -> V_84 -> V_7 . V_129 ) ;
V_132:
F_12 ( & V_53 -> V_51 -> V_31 ) ;
V_131:
F_67 ( & V_124 , & V_32 ) ;
...
int F_69 ( struct V_61 * V_58 , void * V_62 ,
struct V_44 * V_63 )
{
...
V_18 = F_70 ( V_10 , V_53 , args -> V_143 , args -> V_14 ) ;
break;
case V_149 :
V_18 = F_70 ( V_10 , V_53 , 0 , 0 ) ;
break;
default:
break;
}
...
T_2 V_81 ;
int V_18 ;
args -> V_115 = F_73 ( V_10 , args -> V_159 , args -> V_160 , 0 ) * ( ( args -> V_160 + 1 ) / 8 ) ;
args -> V_11 = args -> V_115 * args -> V_161 ;
args -> V_11 = F_74 ( args -> V_11 , V_19 ) ;
V_18 = F_5 ( V_10 , args -> V_11 , 0 ,
V_26 , 0 ,
false , & V_2 ) ;
if ( V_18 )
return - V_23 ;
V_18 = F_37 ( V_45 , V_2 , & V_81 ) ;
F_38 ( V_2 ) ;
if ( V_18 ) {
return V_18 ;
}
...
static int F_75 ( struct V_162 * V_163 , void * V_62 )
{
...
unsigned V_36 ;
const char * V_98 ;
V_36 = F_53 ( V_46 -> V_7 . V_129 . V_130 ) ;
switch ( V_36 ) {
case V_26 :
V_98 = L_14 ;
break;
...
F_76 ( V_163 , L_17 ,
V_168 , F_77 ( V_46 ) >> 10 , F_77 ( V_46 ) >> 20 ,
