...
int F_75 ( struct V_1 * V_2 , struct V_159 * V_160 )
{
T_1 V_161 ;
V_160 -> V_25 = F_2 ( V_2 , V_32 ) ;
V_160 -> V_26 = F_2 ( V_2 , V_34 ) ;
V_160 -> V_162 = F_2 ( V_2 , V_163 ) ;
V_161 = F_2 ( V_2 , V_149 ) ;
V_160 -> V_76 = V_161 >> 32 ;
V_160 -> V_130 = V_161 & 0xffffffff ;
V_160 -> V_164 = F_2 ( V_2 , V_165 ) ;
V_160 -> V_166 = F_2 ( V_2 , V_167 ) ;
return 0 ;
}
