...
int F_28 ( struct V_3 * V_3 , struct V_4 * V_26 ,
T_1 V_13 )
{
unsigned long V_11 ;
int V_7 = 0 ;
...
bool
F_31 ( struct V_3 * V_3 , struct V_4 * V_26 )
{
unsigned long V_11 ;
bool V_7 ;
F_15 ( V_3 -> V_15 , V_11 ) ;
...
{
struct V_29 * V_19 =
F_21 ( V_26 , struct V_29 , V_30 ) ;
F_33 ( V_19 -> V_31 , V_32 ) ;
}
signed long
F_34 ( struct V_3 * V_3 , bool V_16 , signed long V_17 )
{
struct V_29 V_26 ;
unsigned long V_11 ;
...
V_7 = F_38 ( V_7 ) ;
F_15 ( V_3 -> V_15 , V_11 ) ;
if ( V_7 > 0 && V_16 && F_35 ( V_33 ) )
V_7 = - V_34 ;
}
if ( ! F_23 ( & V_26 . V_30 . V_12 ) )
F_39 ( & V_26 . V_30 . V_12 ) ;
F_37 ( V_38 ) ;
V_35:
F_16 ( V_3 -> V_15 , V_11 ) ;
...
void
F_40 ( struct V_3 * V_3 , const struct V_39 * V_18 ,
