...
static int F_116 ( struct V_165 * V_114 , void * V_88 , T_8 V_166 )
{
struct V_167 V_168 = { . V_169 = V_166 , . V_170 = V_88 , } ;
struct V_171 V_172 = { . V_173 = V_174 , } ;
return F_117 ( V_114 , & V_172 , & V_168 , 1 , V_166 , V_172 . V_173 ) ;
}
static int F_118 ( struct V_165 * V_114 , struct V_167 * V_168 ,
T_8 V_175 , T_8 V_176 )
{
int V_49 ;
...
V_49 = F_119 ( V_114 , & V_172 , V_168 , V_175 , V_176 ) ;
if ( F_120 ( V_49 == V_176 ) )
return 0 ;
...
static void F_126 ( struct V_185 * V_172 , T_10 V_186 , T_10 V_132 , T_1 V_133 )
{
memset ( V_172 , 0 , sizeof( struct V_185 ) ) ;
V_172 -> V_187 = F_127 ( V_188 ) ;
V_172 -> V_186 = F_127 ( V_186 ) ;
V_172 -> V_132 = F_127 ( V_132 ) ;
V_172 -> V_59 = F_128 ( V_42 ) ;
V_172 -> V_60 = 0 ;
V_172 -> V_133 = F_128 ( V_133 ) ;
}
static int F_129 ( struct V_43 * V_46 ,
struct V_16 * * V_189 ,
int * error )
{
int V_49 = 0 ;
...
void F_130 ( unsigned long * V_190 , unsigned V_191 )
{
struct V_16 * V_17 ;
int V_7 , V_49 ;
F_24 ( V_191 < ( F_131 ( V_192 ) * sizeof( unsigned long ) ) ) ;
memset ( V_190 , 0 , V_191 ) ;
for ( V_7 = 0 ; V_7 < V_192 ; ++ V_7 ) {
F_129 ( F_25 ( V_7 ) , & V_17 , & V_49 ) ;
if ( ! V_49 ) {
F_132 ( V_7 , V_190 ) ;
F_56 ( V_17 ) ;
}
...
int F_133 ( T_1 V_132 , T_1 V_133 , struct V_167 * V_193 ,
...
V_196 = F_135 ( (struct V_199 * ) V_193 , V_194 ) ;
if ( V_196 > V_152 ) {
F_44 ( 0 , L_34 , V_196 ) ;
V_49 = - V_153 ;
goto V_63;
...
F_136 ( & V_2 ) ;
F_3 ( & V_2 ) ;
F_137 ( V_46 -> V_104 , F_129 ( V_46 , & V_17 , & V_49 ) ) ;
if ( V_49 )
goto V_63;
F_7 ( & V_2 , V_17 ) ;
V_175 = V_194 + 1 ;
V_168 = F_138 ( sizeof( struct V_167 ) * V_175 , V_52 ) ;
if ( V_168 == NULL ) {
F_44 ( 0 , L_35 , V_175 ) ;
V_49 = - V_154 ;
goto V_63;
}
V_172 = F_138 ( sizeof( struct V_185 ) , V_52 ) ;
if ( ! V_172 ) {
F_44 ( 0 , L_36 ) ;
V_49 = - V_154 ;
goto V_63;
}
F_126 ( V_172 , V_196 , V_132 , V_133 ) ;
...
if ( V_49 )
goto V_63;
V_172 -> V_201 = F_128 ( V_48 . V_53 ) ;
F_8 ( & V_2 , V_48 . V_53 ) ;
F_5 ( & V_2 ) ;
F_122 ( & V_17 -> V_128 ) ;
V_49 = F_118 ( V_17 -> V_71 , V_168 , V_175 ,
sizeof( struct V_185 ) + V_196 ) ;
F_124 ( & V_17 -> V_128 ) ;
F_139 ( V_172 , L_37 , V_49 ) ;
if ( V_49 < 0 ) {
F_44 ( 0 , L_38 , V_49 ) ;
goto V_63;
}
F_6 ( & V_2 ) ;
F_137 ( V_48 . V_56 , F_45 ( V_46 , & V_48 ) ) ;
F_17 ( & V_2 , V_17 ) ;
V_49 = F_23 ( V_48 . V_57 ) ;
if ( V_60 && ! V_49 )
* V_60 = V_48 . V_58 ;
...
int F_141 ( T_1 V_132 , T_1 V_133 , void * V_88 , T_1 V_166 ,
T_2 V_195 , int * V_60 )
{
struct V_167 V_168 = {
. V_170 = V_88 ,
...
return F_133 ( V_132 , V_133 , & V_168 , 1 ,
V_195 , V_60 ) ;
}
static int F_142 ( struct V_165 * V_114 , struct V_185 * V_202 ,
...
F_24 ( V_203 >= V_40 ) ;
V_202 -> V_59 = F_128 ( V_203 ) ;
V_202 -> V_60 = F_128 ( V_38 ) ;
V_202 -> V_187 = F_127 ( V_204 ) ;
V_202 -> V_186 = 0 ;
F_139 ( V_202 , L_40 , V_38 ) ;
return F_118 ( V_114 , & V_168 , 1 , sizeof( struct V_185 ) ) ;
}
...
V_205 = 0 ;
V_131 = F_115 ( F_145 ( V_202 -> V_132 ) ,
F_146 ( V_202 -> V_133 ) ) ;
if ( ! V_131 ) {
F_44 ( V_162 , L_43 ,
F_145 ( V_202 -> V_132 ) , F_146 ( V_202 -> V_133 ) ) ;
V_203 = V_210 ;
goto V_211;
}
V_203 = V_42 ;
if ( F_145 ( V_202 -> V_186 ) > V_131 -> V_158 )
V_203 = V_212 ;
if ( V_203 != V_42 )
goto V_211;
F_13 ( V_17 ) ;
V_17 -> V_213 = F_146 ( V_202 -> V_133 ) ;
V_17 -> V_214 = F_145 ( V_202 -> V_132 ) ;
...
V_211:
F_122 ( & V_17 -> V_128 ) ;
V_49 = F_142 ( V_17 -> V_71 , V_202 , V_203 ,
V_205 ) ;
F_124 ( & V_17 -> V_128 ) ;
V_202 = NULL ;
F_44 ( 0 , L_44 ,
...
{
struct V_215 * V_216 = F_148 ( V_17 -> V_74 ) ;
struct V_43 * V_46 = F_25 ( V_17 -> V_72 -> V_110 ) ;
if ( V_216 -> V_217 != F_149 ( V_218 ) ) {
F_85 ( V_107 L_45 V_108 L_46
L_47
L_48 , F_86 ( V_17 ) ,
( unsigned long long ) F_150 ( V_216 -> V_217 ) ,
V_218 ) ;
F_100 ( V_46 , V_17 , - V_102 ) ;
return - 1 ;
}
if ( F_146 ( V_216 -> V_219 ) !=
F_22 () ) {
...
F_49 ( V_17 , L_55 ) ;
F_11 ( V_17 ) ;
if ( F_154 ( V_17 -> V_223 == 0 ) ) {
if( V_17 -> V_225 < sizeof( struct V_215 ) ) {
V_88 = F_148 ( V_17 -> V_74 ) + V_17 -> V_225 ;
V_226 = sizeof( struct V_215 ) - V_17 -> V_225 ;
V_49 = F_116 ( V_17 -> V_71 , V_88 , V_226 ) ;
if ( V_49 > 0 )
V_17 -> V_225 += V_49 ;
}
if ( V_17 -> V_225 == sizeof( struct V_215 ) ) {
...
V_17 -> V_225 += V_49 ;
if ( V_17 -> V_225 == sizeof( struct V_185 ) ) {
V_202 = F_148 ( V_17 -> V_74 ) ;
if ( F_145 ( V_202 -> V_186 ) >
V_152 )
V_49 = - V_228 ;
}
}
...
V_202 = F_148 ( V_17 -> V_74 ) ;
F_139 ( V_202 , L_56 , V_17 -> V_225 ) ;
if ( V_17 -> V_225 - sizeof( struct V_185 ) < F_145 ( V_202 -> V_186 ) ) {
V_88 = F_148 ( V_17 -> V_74 ) + V_17 -> V_225 ;
V_226 = ( sizeof( struct V_185 ) + F_145 ( V_202 -> V_186 ) ) -
V_17 -> V_225 ;
V_49 = F_116 ( V_17 -> V_71 , V_88 , V_226 ) ;
if ( V_49 > 0 )
V_17 -> V_225 += V_49 ;
...
static int F_155 ( struct V_165 * V_114 )
{
int V_49 , V_229 = 1 ;
T_11 V_230 ;
V_230 = F_156 () ;
...
static int F_158 ( struct V_165 * V_114 )
{
int V_236 = V_237 ;
return F_159 ( V_114 , V_233 , V_238 ,
...
( unsigned long long ) F_150 ( V_239 -> V_242 ) ) ;
F_160 () ;
F_121 ( V_17 , V_239 , sizeof( * V_239 ) ) ;
F_56 ( V_17 ) ;
}
...
static void F_164 ( struct V_89 * V_90 )
{
struct V_43 * V_46 =
...
V_49 = F_167 ( V_252 , V_253 , V_254 , & V_114 ) ;
if ( V_49 < 0 ) {
F_44 ( 0 , L_63 , V_49 ) ;
goto V_63;
}
...
static void F_171 ( struct V_89 * V_90 )
{
struct V_43 * V_46 =
F_47 ( V_90 , struct V_43 , V_105 . V_90 ) ;
F_172 ( F_27 ( V_46 ) ) ;
}
void F_173 ( struct V_75 * V_7 )
{
...
static void F_175 ( struct V_75 * V_7 , int V_44 ,
void * V_88 )
{
F_176 ( V_44 ) ;
if ( ! V_7 )
...
F_182 ( & V_268 , V_272 ,
F_177 , NULL , V_271 ) ;
V_49 = F_183 ( NULL , & V_268 ) ;
if ( V_49 == 0 )
V_49 = F_183 ( NULL , & V_269 ) ;
if ( V_49 )
F_179 () ;
return V_49 ;
}
static int F_184 ( struct V_165 * V_114 , int * V_273 )
{
int V_49 , V_274 ;
struct V_246 sin ;
...
F_24 ( V_114 == NULL ) ;
* V_273 = 0 ;
V_49 = F_185 ( V_114 -> V_115 -> V_277 , V_114 -> V_115 -> V_278 ,
V_114 -> V_115 -> V_279 , & V_275 ) ;
if ( V_49 )
goto V_63;
V_275 -> type = V_114 -> type ;
V_275 -> V_181 = V_114 -> V_181 ;
V_49 = V_114 -> V_181 -> V_280 ( V_114 , V_275 , V_266 ) ;
if ( V_49 < 0 )
goto V_63;
* V_273 = 1 ;
...
static int F_190 ( T_12 V_287 , T_13 V_288 )
{
struct V_165 * V_114 = NULL ;
int V_49 ;
struct V_246 sin = {
...
if ( V_49 < 0 ) {
F_85 ( V_289 L_82
L_83 , V_49 , & V_287 , F_187 ( V_288 ) ) ;
goto V_63;
}
V_49 = V_114 -> V_181 -> V_292 ( V_114 , 64 ) ;
if ( V_49 < 0 )
F_85 ( V_289 L_84 ,
V_49 , & V_287 , F_187 ( V_288 ) ) ;
V_63:
if ( V_49 ) {
V_284 = NULL ;
if ( V_114 )
...
F_98 ( & V_114 -> V_115 -> V_116 ) ;
for ( V_294 = 0 ; V_294 < F_26 ( V_45 ) ; V_294 ++ ) {
struct V_75 * V_7 = F_166 ( V_294 ) ;
if ( V_7 ) {
F_173 ( V_7 ) ;
F_52 ( V_7 ) ;
}
...
if ( F_197 () )
goto V_63;
V_239 = F_62 ( sizeof( struct V_215 ) , V_295 ) ;
V_243 = F_62 ( sizeof( struct V_185 ) , V_295 ) ;
V_208 = F_62 ( sizeof( struct V_185 ) , V_295 ) ;
if ( ! V_239 || ! V_243 || ! V_208 )
goto V_63;
V_239 -> V_217 = F_149 ( V_218 ) ;
V_239 -> V_242 = F_149 ( 1 ) ;
V_243 -> V_187 = F_127 ( V_207 ) ;
V_208 -> V_187 = F_127 ( V_209 ) ;
for ( V_294 = 0 ; V_294 < F_26 ( V_45 ) ; V_294 ++ ) {
struct V_43 * V_46 = F_25 ( V_294 ) ;
F_152 ( & V_46 -> V_224 , 0 ) ;
F_198 ( & V_46 -> V_50 ) ;
F_68 ( & V_46 -> V_113 , F_164 ) ;
F_68 ( & V_46 -> V_109 ,
F_170 ) ;
F_68 ( & V_46 -> V_105 , F_171 ) ;
V_46 -> V_99 = - V_102 ;
F_33 ( & V_46 -> V_104 ) ;
F_199 ( & V_46 -> V_51 ) ;
F_2 ( & V_46 -> V_55 ) ;
