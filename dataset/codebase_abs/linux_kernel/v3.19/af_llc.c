...
V_137 = V_128 ;
if ( ! ( V_83 & V_149 ) ) {
int V_10 = F_79 ( V_18 , V_142 , V_110 , V_137 ) ;
if ( V_10 ) {
if ( ! V_133 )
V_133 = - V_150 ;
break;
...
goto V_151;
if ( ! ( V_83 & V_140 ) ) {
F_80 ( & V_9 -> V_124 . V_152 , V_132 ) ;
F_81 ( V_9 , V_18 ) ;
F_82 ( & V_9 -> V_124 . V_152 , V_132 ) ;
* V_135 = 0 ;
}
...
F_86 ( V_18 , V_156 ) ;
V_10 = F_87 ( F_88 ( V_18 , V_133 ) , V_110 , V_133 ) ;
if ( V_10 )
goto V_43;
...
static int F_93 ( struct V_26 * V_8 , unsigned int V_166 ,
unsigned long V_167 )
{
return - V_168 ;
}
static int F_94 ( struct V_26 * V_8 , int V_169 , int V_170 ,
...
static int F_96 ( struct V_26 * V_8 , int V_169 , int V_170 ,
...
V_10 = 0 ;
if ( F_97 ( V_128 , V_172 ) || F_98 ( V_171 , & V_199 , V_128 ) )
V_10 = - V_150 ;
V_43:
F_28 ( V_9 ) ;
return V_10 ;
