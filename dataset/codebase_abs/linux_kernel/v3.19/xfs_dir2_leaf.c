...
return;
if ( V_53 )
V_55 -> V_16 . V_56 = F_18 ( V_53 -> V_57 . V_58 ) ;
F_19 ( V_4 , V_48 ) ;
}
static void
F_20 (
...
{
int V_64 ;
V_64 = F_25 ( V_60 , V_2 , V_61 , V_62 , V_63 ,
V_65 , & V_66 ) ;
if ( ! V_64 && V_60 )
F_26 ( V_60 , * V_63 , V_67 ) ;
return V_64 ;
...
V_15 -> V_16 . V_70 = F_18 ( V_70 ) ;
F_29 ( & V_15 -> V_16 . V_46 , & V_22 -> V_43 . V_47 ) ;
} else {
...
int error ;
ASSERT ( V_12 == V_19 || V_12 == V_42 ) ;
ASSERT ( V_74 >= F_31 ( args -> V_32 , V_76 ) &&
V_74 < F_31 ( args -> V_32 , V_77 ) ) ;
error = F_32 ( V_60 , V_2 , F_33 ( args -> V_32 , V_74 ) ,
- 1 , & V_4 , V_65 ) ;
if ( error )
return error ;
F_28 ( V_22 , V_60 , V_4 , V_2 -> V_78 , V_12 ) ;
F_34 ( args , V_4 ) ;
if ( V_12 == V_19 )
F_35 ( args , V_4 ) ;
* V_63 = V_4 ;
...
V_2 = args -> V_2 ;
V_60 = args -> V_75 ;
if ( ( error = F_38 ( args , & V_17 ) ) ) {
return error ;
}
V_84 = F_39 ( args -> V_32 , V_17 ) ;
ASSERT ( V_84 == F_31 ( args -> V_32 , V_76 ) ) ;
error = F_30 ( args , V_84 , & V_83 , V_19 ) ;
if ( error )
return error ;
V_6 = V_83 -> V_7 ;
V_23 = V_79 -> V_7 ;
F_40 ( V_2 , V_79 ) ;
V_82 = F_41 ( args -> V_32 , V_23 ) ;
V_81 = F_42 ( V_82 ) ;
...
* V_103 = F_51 ( V_100 , * V_103 ) ;
* V_104 = F_52 ( V_99 - 1 , * V_104 ) ;
V_9 -> V_27 -- ;
return & V_25 [ V_99 - 1 ] ;
}
ASSERT ( V_101 - V_99 >= 0 ) ;
...
* V_103 = F_51 ( V_99 , * V_103 ) ;
* V_104 = F_52 ( V_101 , * V_104 ) ;
V_9 -> V_27 -- ;
return & V_25 [ V_99 ] ;
}
int
...
V_2 = args -> V_2 ;
V_60 = args -> V_75 ;
error = F_24 ( V_60 , V_2 , args -> V_32 -> V_112 , - 1 , & V_83 ) ;
if ( error )
return error ;
V_99 = F_55 ( args , V_83 ) ;
V_6 = V_83 -> V_7 ;
...
continue;
V_28 = F_56 ( args -> V_32 , F_7 ( V_105 -> V_38 ) ) ;
ASSERT ( V_28 < F_7 ( V_26 -> V_72 ) ) ;
ASSERT ( V_80 [ V_28 ] != F_11 ( V_115 ) ) ;
if ( F_57 ( V_80 [ V_28 ] ) >= V_98 ) {
V_111 = V_28 ;
break;
}
}
...
if ( V_111 == - 1 ) {
if ( ( error = F_62 ( args , V_121 ,
& V_111 ) ) ) {
F_58 ( V_60 , V_83 ) ;
return error ;
}
if ( ( error = F_63 ( args , V_111 , & V_79 ) ) ) {
F_58 ( V_60 , V_83 ) ;
return error ;
}
...
V_107 = ( T_16 * )
( ( char * ) V_23 + F_57 ( V_88 [ 0 ] . V_122 ) ) ;
ASSERT ( F_57 ( V_107 -> V_98 ) >= V_98 ) ;
V_86 = V_85 = 0 ;
F_66 ( args , V_79 , V_107 ,
( V_91 ) ( ( char * ) V_107 - ( char * ) V_23 ) , V_98 ,
& V_85 , & V_86 ) ;
V_106 = ( T_15 * ) V_107 ;
V_106 -> V_123 = F_18 ( args -> V_123 ) ;
...
if ( V_85 )
F_46 ( args , V_79 ) ;
F_67 ( args , V_79 , V_106 ) ;
if ( F_57 ( V_80 [ V_111 ] ) != F_57 ( V_88 [ 0 ] . V_98 ) ) {
V_80 [ V_111 ] = V_88 [ 0 ] . V_98 ;
if ( ! V_108 )
F_48 ( args , V_83 , V_111 , V_111 ) ;
}
V_105 = F_50 ( & V_9 , V_25 , V_99 , V_102 , V_100 ,
V_101 , & V_103 , & V_104 ) ;
V_105 -> V_37 = F_8 ( args -> V_37 ) ;
V_105 -> V_38 = F_8 (
F_68 ( args -> V_32 , V_111 ,
F_57 ( * V_110 ) ) ) ;
V_2 -> V_10 -> V_90 ( V_6 , & V_9 ) ;
F_34 ( args , V_83 ) ;
F_43 ( args , V_83 , V_103 , V_104 ) ;
F_47 ( V_2 , V_83 ) ;
F_40 ( V_2 , V_79 ) ;
return 0 ;
}
...
ASSERT ( V_9 -> V_27 > 1 ) ;
V_99 = * V_131 ;
F_49 ( V_9 , V_25 , V_99 , & V_100 , & V_101 ) ;
if ( V_100 >= 0 &&
( V_101 == V_9 -> V_35 ||
...
V_6 -> V_23 . V_16 . V_12 == F_11 ( V_45 ) ) ;
V_26 = F_5 ( args -> V_32 , V_6 ) ;
F_70 ( args -> V_75 , V_4 , ( V_143 ) ( ( char * ) V_26 - ( char * ) V_6 ) ,
...
struct V_24 * V_25 ;
F_72 ( args ) ;
if ( ( error = F_73 ( args , & V_83 , & V_99 , & V_79 ) ) ) {
return error ;
}
V_60 = args -> V_75 ;
V_2 = args -> V_2 ;
...
V_106 = ( T_15 * )
( ( char * ) V_79 -> V_7 +
F_74 ( args -> V_32 , F_7 ( V_105 -> V_38 ) ) ) ;
args -> V_123 = F_2 ( V_106 -> V_123 ) ;
args -> V_126 = V_2 -> V_10 -> V_147 ( V_106 ) ;
error = F_75 ( args , V_106 -> V_124 , V_106 -> V_114 ) ;
F_58 ( V_60 , V_79 ) ;
F_58 ( V_60 , V_83 ) ;
return error ;
}
...
if ( F_7 ( V_105 -> V_38 ) == V_39 )
continue;
V_151 = F_56 ( args -> V_32 ,
F_7 ( V_105 -> V_38 ) ) ;
if ( V_151 != V_150 ) {
if ( V_79 )
F_58 ( V_60 , V_79 ) ;
error = F_65 ( V_60 , V_2 ,
F_33 ( args -> V_32 , V_151 ) ,
- 1 , & V_79 ) ;
if ( error ) {
F_58 ( V_60 , V_83 ) ;
return error ;
...
V_25 = V_2 -> V_10 -> V_34 ( V_6 ) ;
V_105 = & V_25 [ V_99 ] ;
V_163 = F_56 ( args -> V_32 , F_7 ( V_105 -> V_38 ) ) ;
V_106 = ( T_15 * ) ( ( char * ) V_23 +
F_74 ( args -> V_32 , F_7 ( V_105 -> V_38 ) ) ) ;
V_86 = V_85 = 0 ;
V_164 = F_57 ( V_88 [ 0 ] . V_98 ) ;
V_26 = F_5 ( args -> V_32 , V_6 ) ;
V_80 = F_6 ( V_26 ) ;
ASSERT ( F_57 ( V_80 [ V_163 ] ) == V_164 ) ;
F_44 ( args , V_79 ,
...
F_34 ( args , V_83 ) ;
V_105 -> V_38 = F_8 ( V_39 ) ;
F_43 ( args , V_83 , V_99 , V_99 ) ;
if ( V_86 )
F_45 ( V_2 , V_23 , & V_85 ) ;
if ( V_85 )
F_46 ( args , V_79 ) ;
if ( F_57 ( V_88 [ 0 ] . V_98 ) != V_164 ) {
V_80 [ V_163 ] = V_88 [ 0 ] . V_98 ;
F_48 ( args , V_83 , V_163 , V_163 ) ;
}
F_40 ( V_2 , V_79 ) ;
if ( F_57 ( V_88 [ 0 ] . V_98 ) ==
args -> V_32 -> V_92 - V_2 -> V_10 -> V_165 ) {
ASSERT ( V_163 != args -> V_32 -> V_166 ) ;
if ( ( error = F_78 ( args , V_163 , V_79 ) ) ) {
...
V_2 = args -> V_2 ;
V_60 = args -> V_75 ;
error = F_65 ( V_60 , V_2 , F_33 ( args -> V_32 , V_163 ) ,
- 1 , & V_79 ) ;
if ( error )
return error ;
V_6 = V_83 -> V_7 ;
...
F_35 ( args , V_83 ) ;
F_48 ( args , V_83 , 0 , F_7 ( V_26 -> V_72 ) - 1 ) ;
return 0 ;
}
static inline T_19
F_84 (
...
V_2 = args -> V_2 ;
V_60 = args -> V_75 ;
if ( ( error = F_87 ( V_2 , & V_179 , V_65 ) ) ) {
return error ;
}
V_179 -= args -> V_32 -> V_185 ;
while ( V_179 > args -> V_32 -> V_186 ) {
if ( ( error = F_88 ( args , V_179 , & V_180 ) ) ) {
return error ;
}
if ( V_180 )
V_179 -= args -> V_32 -> V_185 ;
...
if ( ( error = F_89 ( V_60 , V_2 , & V_179 , V_65 ) ) ) {
return error ;
}
if ( F_90 ( V_22 , V_179 ) > V_76 + args -> V_32 -> V_92 )
return 0 ;
...
V_9 . V_12 == V_45 ) ;
error = F_91 ( V_60 , V_2 , args -> V_32 -> V_186 , & V_178 ) ;
if ( error )
return error ;
free = V_178 -> V_7 ;
V_2 -> V_10 -> V_188 ( & V_182 , free ) ;
ASSERT ( ! V_182 . V_189 ) ;
if ( F_84 ( & V_9 , V_182 . V_190 ) > args -> V_32 -> V_92 ) {
F_58 ( V_60 , V_178 ) ;
return 0 ;
}
if ( V_9 . V_27 )
