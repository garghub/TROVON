...
int V_50 ;
int V_23 ;
V_49 = F_17 ( V_51 , & V_12 -> V_18 ) ;
if ( ! V_49 )
return - V_35 ;
if ( F_14 ( V_12 -> V_18 . V_19 , L_11 , NULL ) )
return - V_52 ;
V_14 = F_18 ( sizeof( * V_14 ) , V_53 ) ;
if ( V_14 == NULL )
return - V_54 ;
...
{
struct V_58 * V_59 = F_33 ( V_14 -> line ) ;
struct V_1 * V_10 = & V_59 -> V_10 ;
F_34 ( V_14 -> line ) ;
if ( V_14 -> V_20 && ( ! F_35 ( V_10 ) || V_66 ) )
F_15 ( V_14 -> V_20 ) ;
}
...
static inline void F_32 ( struct V_13 * V_14 )
{
}
static inline void F_36 ( struct V_13 * V_14 )
{
}
static int F_38 ( struct V_67 * V_18 )
{
...
static int F_40 ( struct V_67 * V_18 )
{
struct V_13 * V_14 = F_39 ( V_18 ) ;
switch ( V_14 -> type ) {
case V_56 ... V_57 :
