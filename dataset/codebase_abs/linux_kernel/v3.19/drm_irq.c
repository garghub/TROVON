...
T_1 V_14 ;
V_33 = F_68 ( V_2 , V_3 ) ;
if ( F_76 ( V_33 , L_18 , V_3 , V_33 ) )
return;
V_14 = F_50 ( V_2 , V_3 ) ;
V_33 = F_77 ( V_2 -> V_5 [ V_3 ] . V_37 ,
V_14 != F_50 ( V_2 , V_3 ) ,
F_78 ( 100 ) ) ;
F_76 ( V_33 == 0 , L_19 , V_3 ) ;
F_71 ( V_2 , V_3 ) ;
}
...
void F_84 ( struct V_1 * V_2 , int V_3 )
{
struct V_4 * V_5 = & V_2 -> V_5 [ V_3 ] ;
unsigned long V_17 ;
if ( F_34 ( V_3 >= V_2 -> V_30 ) )
...
void F_85 ( struct V_67 * V_3 )
{
F_84 ( V_3 -> V_2 , F_52 ( V_3 ) ) ;
}
...
int F_88 ( struct V_1 * V_2 , void * V_58 ,
struct V_59 * V_60 )
{
struct F_88 * V_127 = V_58 ;
unsigned int V_3 ;
if ( ! V_2 -> V_30 )
return 0 ;
if ( F_27 ( V_2 , V_56 ) )
...
static int F_89 ( struct V_1 * V_2 , int V_119 ,
union V_131 * V_132 ,
struct V_59 * V_60 )
{
...
F_58 ( & V_110 -> V_81 . V_115 , & V_2 -> V_145 ) ;
V_132 -> V_144 . V_114 = V_132 -> V_138 . V_114 ;
}
F_11 ( & V_2 -> V_112 , V_79 ) ;
return 0 ;
...
if ( V_79 & V_156 ) {
return F_89 ( V_2 , V_3 , V_132 , V_60 ) ;
}
if ( ( V_79 & V_143 ) &&
( V_111 - V_132 -> V_138 . V_114 ) <= ( 1 << 23 ) ) {
V_132 -> V_138 . V_114 = V_111 + 1 ;
...
if ( V_33 != - V_158 ) {
struct V_10 V_106 ;
V_132 -> V_144 . V_114 = F_53 ( V_2 , V_3 , & V_106 ) ;
...
static void F_93 ( struct V_1 * V_2 , int V_3 )
{
struct V_109 * V_110 , * V_125 ;
struct V_10 V_106 ;
unsigned int V_111 ;
...
bool F_95 ( struct V_1 * V_2 , int V_3 )
{
struct V_4 * V_5 = & V_2 -> V_5 [ V_3 ] ;
T_1 V_18 ;
T_2 V_19 ;
...
bool F_96 ( struct V_67 * V_3 )
{
return F_95 ( V_3 -> V_2 , F_52 ( V_3 ) ) ;
}
