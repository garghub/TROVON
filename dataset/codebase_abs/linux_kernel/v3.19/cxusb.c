...
static int F_82 ( struct V_201 * V_38 ,
struct V_202 * V_68 ,
struct V_203 * * V_204 ,
int * V_205 )
{
int V_206 = * V_205 ;
* V_205 = V_38 -> V_39 . V_207 == 0xff &&
V_38 -> V_39 . V_208 == 0xff &&
V_38 -> V_39 . V_209 == 0xff ;
if ( * V_205 && ! V_206 )
* V_204 = NULL ;
return 0 ;
}
static int F_83 ( struct V_201 * V_38 ,
const struct V_210 * V_211 )
{
int V_212 ;
for ( V_212 = 0 ; V_212 < F_84 ( V_213 ) ; V_212 ++ ) {
int V_214 = V_213 [ V_212 ] ;
if ( V_211 -> V_215 < V_214 + 4 )
continue;
if ( V_211 -> V_216 [ V_214 ] == ( V_217 & 0xff ) &&
V_211 -> V_216 [ V_214 + 1 ] == V_217 >> 8 ) {
struct V_210 V_218 ;
T_1 * V_219 = F_85 ( V_211 -> V_215 ) ;
int V_35 ;
if ( ! V_219 )
return - V_220 ;
memcpy ( V_219 , V_211 -> V_216 , V_211 -> V_215 ) ;
V_218 . V_215 = V_211 -> V_215 ;
V_218 . V_216 = V_219 ;
V_219 [ V_214 + 2 ] =
F_15 ( V_38 -> V_39 . V_221 ) + 1 ;
V_219 [ V_214 + 3 ] =
F_15 ( V_38 -> V_39 . V_221 ) >> 8 ;
V_35 = F_86 ( V_38 , & V_218 ,
V_222 ) ;
F_87 ( V_219 ) ;
return V_35 ;
}
...
static void F_90 ( struct V_223 * V_224 )
{
struct V_1 * V_2 = F_91 ( V_224 ) ;
struct V_13 * V_14 = V_2 -> V_15 ;
struct V_186 * V_242 ;
V_242 = V_14 -> V_200 ;
if ( V_242 ) {
F_81 ( V_242 -> V_62 . V_197 -> V_198 ) ;
F_80 ( V_242 ) ;
}
V_242 = V_14 -> V_199 ;
if ( V_242 ) {
