...
{
F_89 ( & V_21 -> V_128 ) ;
while ( ! F_43 ( & V_21 -> V_4 . V_198 ) ) {
struct V_5 * V_7 = F_44 ( & V_21 -> V_4 . V_198 ,
struct V_5 , V_8 . V_9 . V_199 ) ;
F_32 ( & V_7 -> V_8 . V_9 . V_199 ) ;
F_89 ( & V_7 -> V_8 . V_128 ) ;
F_6 ( V_7 ) ;
}
}
static int F_90 ( struct V_6 * V_200 ,
struct V_201 * V_202 )
{
V_202 -> V_203 = V_204 ;
V_202 -> V_205 = V_204 ;
V_202 -> V_206 = F_50 ( V_66 ) | F_50 ( V_127 ) ;
V_202 -> V_207 = true ;
V_202 -> V_208 = true ;
V_202 -> V_209 = V_210 ;
return 0 ;
...
struct V_213 * V_214 ;
int V_215 , V_48 , V_94 ;
V_21 = F_92 ( & V_212 -> V_54 , sizeof( * V_21 ) , V_195 ) ;
if ( ! V_21 )
return - V_196 ;
V_214 = F_93 ( V_212 , V_216 , 0 ) ;
V_21 -> V_27 = F_94 ( & V_212 -> V_54 , V_214 ) ;
if ( F_95 ( V_21 -> V_27 ) )
...
V_94 = F_101 ( V_212 , 1 ) ;
if ( V_94 <= 0 ) {
F_102 ( & V_212 -> V_54 , L_7 , V_94 ) ;
V_21 -> V_105 = true ;
} else {
V_21 -> V_99 = 0 ;
F_14 ( V_21 , V_107 , 0 ) ;
V_215 = F_103 ( & V_212 -> V_54 , V_94 , F_46 ,
V_229 , L_8 , V_21 ) ;
if ( V_215 )
return V_215 ;
}
V_215 = F_104 ( & V_21 -> V_4 ) ;
if ( V_215 ) {
F_105 ( L_9 ,
V_215 ) ;
F_88 ( V_21 ) ;
...
F_106 ( V_212 , V_21 ) ;
if ( V_212 -> V_54 . V_230 ) {
V_231 . V_232 = V_21 -> V_4 . V_219 ;
V_215 = F_107 ( V_212 -> V_54 . V_230 ,
V_233 , & V_231 ) ;
if ( V_215 ) {
F_105 ( L_10 ) ;
F_108 ( & V_21 -> V_4 ) ;
...
F_102 ( & V_212 -> V_54 , L_11 ) ;
return V_215 ;
}
static int F_109 ( struct V_211 * V_212 )
{
struct V_1 * V_21 = F_110 ( V_212 ) ;
if ( V_212 -> V_54 . V_230 )
F_111 ( V_212 -> V_54 . V_230 ) ;
F_108 ( & V_21 -> V_4 ) ;
if ( ! V_21 -> V_105 ) {
F_14 ( V_21 , V_108 , 0 ) ;
}
...
bool F_112 ( struct V_6 * V_9 , void * V_234 )
{
if ( V_9 -> V_35 -> V_54 -> V_235 == & V_236 . V_235 ) {
struct V_5 * V_7 = F_3 ( V_9 ) ;
unsigned V_237 = * ( unsigned * ) V_234 ;
return V_237 == V_7 -> V_106 ;
}
return false ;
}
