...
struct V_22 * F_31 ( struct V_6 * V_7 , int V_66 )
{
struct V_24 * V_5 ;
V_5 = F_13 ( V_66 , V_7 ) ;
if ( F_15 ( V_5 ) )
...
struct V_2 * V_25 ;
int V_11 = - V_21 ;
V_9 = ( V_76 -> V_78 + V_12 - 1 ) / V_12 ;
V_77 = F_4 ( sizeof *V_77 + V_9 * sizeof V_77 -> V_5 . V_13 [ 0 ] , V_14 ) ;
if ( ! V_77 )
goto V_15;
V_11 = F_3 ( & V_77 -> V_5 , V_7 , V_76 -> V_78 ) ;
if ( V_11 )
goto V_15;
V_11 = F_12 ( & V_77 -> V_5 , 0 ) ;
if ( V_11 )
goto V_28;
V_77 -> V_3 . V_33 = V_77 -> V_5 . V_32 ;
V_77 -> V_3 . V_32 = V_77 -> V_5 . V_32 ;
V_77 -> V_5 . V_29 = V_48 ;
V_77 -> V_5 . V_19 = V_76 -> V_78 ;
V_77 -> V_5 . V_62 = V_76 -> V_62 ;
V_25 = & V_77 -> V_3 ;
V_31:
return V_25 ;
V_28:
...
int F_35 ( struct V_2 * V_3 , T_1 * V_73 ,
int V_79 , T_1 V_40 )
{
...
T_2 V_83 ;
int V_25 ;
V_10 = F_36 ( & V_77 -> V_5 . V_18 ) ;
if ( V_10 > 2 )
return - V_65 ;
if ( V_79 > V_77 -> V_5 . V_19 ) {
V_25 = - V_56 ;
goto V_15;
}
V_81 = & F_37 ( V_3 -> V_84 ) -> V_85 ;
F_38 ( & V_81 -> V_86 , V_82 ) ;
V_77 -> V_5 . V_39 = V_40 ;
V_77 -> V_5 . V_40 = V_40 ;
V_83 = 1 << V_77 -> V_5 . V_62 ;
V_77 -> V_5 . V_44 = V_79 * V_83 ;
V_9 = 0 ;
V_38 = 0 ;
for ( V_10 = 0 ; V_10 < V_79 ; V_10 ++ ) {
V_77 -> V_5 . V_13 [ V_9 ] -> V_41 [ V_38 ] . V_42 = ( void * ) V_73 [ V_10 ] ;
V_77 -> V_5 . V_13 [ V_9 ] -> V_41 [ V_38 ] . V_44 = V_83 ;
if ( ++ V_38 == V_12 ) {
V_9 ++ ;
V_38 = 0 ;
}
