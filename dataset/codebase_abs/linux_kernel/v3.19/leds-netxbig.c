...
static T_1 F_23 ( struct V_46 * V_47 ,
...
{
struct V_58 * V_59 = F_27 ( & V_55 -> V_47 ) ;
F_28 ( & V_28 -> V_33 ) ;
V_28 -> V_2 = V_59 -> V_2 ;
V_28 -> V_29 . V_60 = V_57 -> V_60 ;
V_28 -> V_29 . V_61 = V_57 -> V_61 ;
V_28 -> V_29 . V_62 = F_14 ;
V_28 -> V_29 . V_63 = F_18 ;
V_28 -> V_40 = 0 ;
V_28 -> V_29 . V_64 = V_38 ;
...
V_28 -> V_30 = V_57 -> V_30 ;
V_28 -> V_45 = V_57 -> V_45 ;
V_28 -> V_43 = ( 1 << V_59 -> V_2 -> V_7 ) - 1 ;
V_28 -> V_23 = V_59 -> V_23 ;
V_28 -> V_24 = V_59 -> V_24 ;
if ( V_28 -> V_30 [ V_41 ] != V_32 )
V_28 -> V_29 . V_66 = V_67 ;
return F_29 ( & V_55 -> V_47 , & V_28 -> V_29 ) ;
}
...
return - V_14 ;
V_68 = F_31 ( & V_55 -> V_47 ,
sizeof( struct V_27 ) * V_59 -> V_69 , V_70 ) ;
if ( ! V_68 )
return - V_71 ;
V_31 = F_8 ( V_59 -> V_2 ) ;
if ( V_31 < 0 )
return V_31 ;
for ( V_13 = 0 ; V_13 < V_59 -> V_69 ; V_13 ++ ) {
V_31 = F_26 ( V_55 , & V_68 [ V_13 ] , & V_59 -> V_72 [ V_13 ] ) ;
if ( V_31 < 0 )
goto V_73;
}
F_32 ( V_55 , V_68 ) ;
