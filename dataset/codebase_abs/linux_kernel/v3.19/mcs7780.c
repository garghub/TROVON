...
static void V_73 ( struct V_110 * V_110 )
{
T_2 * V_111 ;
...
& V_2 -> V_67 , 0xc0 ) ;
for ( V_78 = 0 ; V_78 < V_110 -> V_113 ; V_78 ++ )
F_57 ( V_2 -> V_52 , & V_2 -> V_52 -> V_54 ,
& V_2 -> V_67 , V_111 [ V_78 ] ) ;
F_57 ( V_2 -> V_52 , & V_2 -> V_52 -> V_54 ,
& V_2 -> V_67 , 0xc1 ) ;
...
F_21 ( V_2 , V_110 -> V_114 ,
V_110 -> V_113 ) ;
}
else {
F_29 ( V_2 , V_110 -> V_114 ,
V_110 -> V_113 ) ;
}
F_53 ( & V_2 -> V_104 ) ;
}
V_11 = F_37 ( V_110 , V_115 ) ;
}
static void F_58 ( struct V_110 * V_110 )
{
struct V_1 * V_2 = V_110 -> V_112 ;
struct V_85 * V_116 = V_2 -> V_52 ;
if ( F_8 ( V_2 -> V_33 ) )
F_59 ( & V_2 -> V_84 ) ;
else
F_42 ( V_116 ) ;
...
F_46 ( V_116 ) ;
V_2 = F_45 ( V_116 ) ;
F_61 ( & V_2 -> V_118 , V_117 ) ;
V_2 -> V_33 = F_62 ( V_45 ) ;
if ( F_63 ( V_2 -> V_33 == V_2 -> V_32 ) )
V_2 -> V_33 = 0 ;
if( V_2 -> V_32 < 576000 ) {
V_47 = F_14 ( V_45 , V_2 -> V_119 ) ;
}
else if( V_2 -> V_32 == 576000 || V_2 -> V_32 == 1152000 ) {
V_47 = F_19 ( V_45 , V_2 -> V_119 ) ;
}
else {
V_47 = F_16 ( V_45 , V_2 -> V_119 ) ;
}
F_35 ( V_2 -> V_65 , V_2 -> V_7 ,
F_52 ( V_2 -> V_7 , V_2 -> V_82 ) ,
V_2 -> V_119 , V_47 , F_58 , V_2 ) ;
if ( ( V_11 = F_37 ( V_2 -> V_65 , V_115 ) ) ) {
F_13 ( L_12 , V_11 ) ;
switch ( V_11 ) {
case - V_120 :
case - V_121 :
...
V_2 -> V_52 -> V_54 . V_123 ++ ;
V_2 -> V_52 -> V_54 . V_124 += V_45 -> V_48 ;
}
F_64 ( V_45 ) ;
F_65 ( & V_2 -> V_118 , V_117 ) ;
return V_125 ;
}
static int F_66 ( struct V_126 * V_127 ,
const struct V_128 * V_129 )
{
struct V_5 * V_130 = F_67 ( V_127 ) ;
struct V_85 * V_116 = NULL ;
struct V_1 * V_2 ;
int V_11 = - V_99 ;
V_116 = F_68 ( sizeof( * V_2 ) ) ;
if ( ! V_116 )
goto V_98;
F_69 ( L_13 , V_130 -> V_105 ) ;
F_70 ( V_116 , & V_127 -> V_6 ) ;
V_11 = F_71 ( V_130 ) ;
if ( V_11 != 0 ) {
F_13 ( L_14 ) ;
goto V_107;
...
V_11 = F_38 ( V_2 , V_127 -> V_146 -> V_147 ,
V_127 -> V_146 -> V_79 . V_148 ) ;
if ( ! V_11 ) {
V_11 = - V_120 ;
goto V_107;
}
