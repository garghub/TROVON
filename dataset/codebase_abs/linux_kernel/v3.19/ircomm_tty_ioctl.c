...
if ( ( V_44 -> V_10 & V_47 ) &&
! ( V_5 & V_47 ) ) {
V_2 -> V_26 . V_48 &= ~ ( V_49 | V_50 ) ;
F_3 ( V_2 , V_51 , TRUE ) ;
}
if ( ! ( V_44 -> V_10 & V_47 ) &&
( V_5 & V_47 ) ) {
V_2 -> V_26 . V_48 |= V_49 ;
if ( ! ( V_4 -> V_9 . V_10 & V_29 ) ||
! F_7 ( V_52 , & V_4 -> V_31 ) ) {
V_2 -> V_26 . V_48 |= V_50 ;
}
F_3 ( V_2 , V_51 , TRUE ) ;
...
if ( V_4 -> V_31 & ( 1 << V_55 ) )
return - V_56 ;
V_54 = ( ( V_2 -> V_26 . V_48 & V_50 ) ? V_57 : 0 )
| ( ( V_2 -> V_26 . V_48 & V_49 ) ? V_58 : 0 )
| ( ( V_2 -> V_26 . V_59 & V_60 ) ? V_61 : 0 )
| ( ( V_2 -> V_26 . V_59 & V_62 ) ? V_63 : 0 )
| ( ( V_2 -> V_26 . V_59 & V_64 ) ? V_65 : 0 )
| ( ( V_2 -> V_26 . V_59 & V_66 ) ? V_67 : 0 ) ;
return V_54 ;
}
...
F_11 (self->magic == IRCOMM_TTY_MAGIC, return -1;) ;
if ( V_68 & V_57 )
V_2 -> V_26 . V_48 |= V_50 ;
if ( V_68 & V_58 )
V_2 -> V_26 . V_48 |= V_49 ;
...
V_74 . line = V_2 -> line ;
V_74 . V_31 = V_2 -> V_30 . V_31 ;
V_74 . V_76 = V_2 -> V_26 . V_27 ;
V_74 . V_77 = V_2 -> V_30 . V_77 ;
V_74 . V_78 = V_2 -> V_30 . V_78 ;
V_74 . type = V_79 ;
V_74 . V_30 = 0 ;
V_74 . V_80 = 0 ;
V_74 . V_81 = 0 ;
...
switch ( V_85 ) {
case V_88 :
V_87 = F_12 ( V_2 , (struct V_72 T_1 * ) V_86 ) ;
break;
case V_89 :
V_87 = F_14 ( V_2 , (struct V_72 T_1 * ) V_86 ) ;
break;
case V_92 :
F_16 ( L_2 ) ;
break;
