...
int F_42 ( struct V_65 * V_66 ,
unsigned long V_53 , void * V_67 )
{
struct V_55 * V_56 ;
struct V_8 * V_9 =
F_43 ( V_66 , struct V_8 , V_68 ) ;
int * V_2 = V_67 ;
unsigned long V_41 ;
struct V_69 * V_70 ;
...
int F_46 ( struct V_55 * V_7 , int V_2 )
{
...
void F_48 ( struct V_55 * V_7 , int V_2 )
{
...
int F_52 ( struct V_55 * V_56 , struct V_4 * V_5 ,
struct V_75 * V_17 , struct V_75 * V_76 )
{
struct V_1 * V_2 = & V_5 -> V_1 ;
int V_26 ;
V_26 = F_53 ( V_56 , V_2 , V_17 , V_76 ,
& V_77 ) ;
if ( V_26 ) {
F_10 ( L_25 ) ;
return - V_44 ;
