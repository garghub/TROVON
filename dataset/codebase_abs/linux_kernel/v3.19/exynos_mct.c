...
if ( V_83 == V_84 ) {
V_46 -> V_55 = V_62 [ V_85 + V_75 ] ;
if ( F_38 ( V_46 -> V_55 , F_34 ,
V_86 | V_87 ,
V_46 -> V_35 , V_66 ) ) {
F_39 ( L_5 ,
V_46 -> V_55 ) ;
...
static void T_5 F_46 ( struct V_97 * V_98 , void T_7 * V_70 )
{
int V_99 ;
struct V_65 * V_66 = F_31 ( & V_73 ) ;
struct V_100 * V_101 , * V_102 ;
V_102 = V_98 ? F_47 ( V_98 , L_6 ) :
F_48 ( NULL , L_6 ) ;
if ( F_49 ( V_102 ) )
F_6 ( L_7 , V_103 ) ;
V_33 = F_50 ( V_102 ) ;
V_101 = V_98 ? F_47 ( V_98 , L_8 ) : F_48 ( NULL , L_8 ) ;
if ( F_49 ( V_101 ) )
F_6 ( L_9 , V_103 ) ;
F_51 ( V_101 ) ;
V_6 = V_70 ;
...
void T_5 F_57 ( void T_7 * V_70 , int V_107 , int V_108 , int V_109 )
{
V_62 [ V_63 ] = V_107 ;
V_62 [ V_85 ] = V_108 ;
V_62 [ V_110 ] = V_109 ;
...
static void T_5 F_58 ( struct V_97 * V_98 , unsigned int V_111 )
{
T_1 V_112 , V_5 ;
V_83 = V_111 ;
V_62 [ V_63 ] = F_59 ( V_98 , V_63 ) ;
#ifdef F_60
V_112 = F_61 ( V_98 ) ;
#else
V_112 = 0 ;
#endif
for ( V_5 = V_85 ; V_5 < V_112 ; V_5 ++ )
V_62 [ V_5 ] = F_59 ( V_98 , V_5 ) ;
F_46 ( V_98 , F_62 ( V_98 , 0 ) ) ;
F_15 () ;
F_24 () ;
}
static void T_5 F_63 ( struct V_97 * V_98 )
{
return F_58 ( V_98 , V_84 ) ;
}
static void T_5 F_64 ( struct V_97 * V_98 )
{
return F_58 ( V_98 , V_104 ) ;
}
