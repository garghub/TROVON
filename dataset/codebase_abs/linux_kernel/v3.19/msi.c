...
F_40 ( & V_18 -> V_37 ,
L_19 ) ;
F_41 ( V_18 , V_18 -> V_64 + V_65 , & V_62 ) ;
V_63 = 0xffff0000 | ( ( V_62 >> ( 48 - 32 ) ) << 4 ) ;
F_42 ( V_18 , V_18 -> V_64 + V_66 , V_63 ) ;
F_42 ( V_18 , V_18 -> V_64 + V_65 , 0 ) ;
}
static int F_43 ( struct V_17 * V_18 , int V_67 , int type )
{
struct V_1 * V_2 ;
