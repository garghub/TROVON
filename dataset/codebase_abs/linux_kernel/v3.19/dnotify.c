...
static T_1 F_21 ( unsigned long V_41 )
{
T_1 V_3 = V_27 ;
if ( V_41 & V_42 )
V_3 |= V_13 ;
...
int F_23 ( int V_57 , struct V_35 * V_36 , unsigned long V_41 )
{
struct V_7 * V_60 , * V_8 ;
struct V_1 * V_61 , * V_2 ;
struct V_5 * V_6 ;
...
F_30 ( V_36 , F_31 ( V_62 ) , V_73 , 0 ) ;
error = F_22 ( V_6 , V_8 , V_37 , V_57 , V_36 , V_10 ) ;
if ( ! error )
V_6 = NULL ;
else if ( error == - V_59 )
error = 0 ;
