...
struct V_19 * F_69 ( struct V_15 * V_16 , T_2 V_105 )
{
struct V_19 * V_106 ;
...
long V_109 = F_73 ( F_74 ( V_20 -> V_110 ) ) ;
if ( V_57 ) {
if ( V_20 -> V_27 == 1 )
F_75 ( V_65 , V_57 , V_109 ) ;
F_76 ( V_65 , V_57 , V_20 -> V_27 - 1 ) ;
}
}
void F_77 ( struct V_17 * V_18 , int V_111 )
{
struct V_19 * V_20 = V_18 -> V_21 ;
struct V_15 * V_16 = V_20 -> V_51 ;
F_13 ( L_21 ,
V_18 -> V_28 , F_71 ( V_20 -> V_107 ) , V_111 ) ;
F_78 ( V_16 , V_20 -> V_107 , V_111 ) ;
V_16 -> V_92 . V_112 ++ ;
V_20 -> V_110 = F_79 ( F_80 () , V_20 -> V_113 ) ;
...
static inline int F_83 ( struct V_15 * V_16 )
{
return V_16 -> V_118 != 0 ;
}
bool F_84 ( struct V_17 * V_18 )
{
struct V_19 * V_20 = V_18 -> V_21 ;
struct V_15 * V_16 = V_20 -> V_51 ;
bool V_119 = false ;
...
if ( ( V_18 -> V_120 & V_121 )
&& F_62 ( V_16 )
&& V_20 -> V_122 == V_16 -> V_86 ) {
V_16 -> V_41 -> V_123 ( V_18 ) ;
F_44 ( & V_16 -> V_54 , V_18 , F_82 ) ;
goto V_44;
}
}
...
if ( ! V_20 -> V_117 ) {
if ( F_64 ( & V_20 -> V_114 ) && F_87 ( V_18 ) ) {
F_24 ( & V_16 -> V_40 ) ;
memcpy ( & V_20 -> V_115 , & V_20 -> V_126 ,
sizeof( V_20 -> V_115 ) ) ;
...
F_24 ( & V_16 -> V_40 ) ;
V_16 -> V_41 -> V_123 ( V_18 ) ;
V_124 = F_90 ( & V_16 -> V_129 ) ;
if ( V_124 > V_16 -> V_92 . V_130 )
V_16 -> V_92 . V_130 = V_124 ;
V_16 -> V_92 . V_131 ++ ;
V_16 -> V_92 . V_132 += V_16 -> V_92 . V_131 - V_16 -> V_92 . V_112 ;
V_16 -> V_92 . V_133 += V_16 -> V_134 . V_135 ;
V_16 -> V_92 . V_136 += V_16 -> V_35 . V_135 ;
V_16 -> V_92 . V_137 += V_16 -> V_54 . V_135 ;
if ( ! F_62 ( V_16 ) )
V_18 -> V_30 = - V_138 ;
else {
if ( ! V_20 -> V_117 && F_87 ( V_18 ) )
F_44 ( & V_16 -> V_54 , V_18 , F_82 ) ;
V_20 -> V_122 = V_16 -> V_86 ;
}
F_25 ( & V_16 -> V_40 ) ;
}
static void F_91 ( struct V_15 * V_16 , struct V_17 * V_18 )
{
F_60 ( V_139 , & V_16 -> V_24 ) ;
F_44 ( & V_16 -> V_134 , V_18 , NULL ) ;
}
static void F_92 ( struct V_15 * V_16 )
{
if ( F_93 ( & V_16 -> V_134 ) == NULL )
F_18 ( V_139 , & V_16 -> V_24 ) ;
}
static bool F_94 ( struct V_15 * V_16 , struct V_17 * V_18 )
{
bool V_119 = false ;
...
static struct V_19 * F_95 ( struct V_15 * V_16 , T_3 V_141 )
{
struct V_19 * V_20 = F_96 ( - V_31 ) ;
if ( ! F_97 ( & V_16 -> V_129 , 1 , V_16 -> V_142 ) )
goto V_8;
V_20 = F_98 ( sizeof( struct V_19 ) , V_141 ) ;
if ( V_20 != NULL )
goto V_8;
F_99 ( & V_16 -> V_129 ) ;
V_20 = F_96 ( - V_143 ) ;
...
static bool F_100 ( struct V_15 * V_16 , struct V_19 * V_20 )
{
if ( F_97 ( & V_16 -> V_129 , - 1 , V_16 -> V_144 ) ) {
F_101 ( V_20 ) ;
return true ;
}
return false ;
}
void F_102 ( struct V_15 * V_16 , struct V_17 * V_18 )
{
struct V_19 * V_20 ;
F_2 ( & V_16 -> V_140 ) ;
if ( ! F_64 ( & V_16 -> free ) ) {
V_20 = F_103 ( V_16 -> free . V_145 , struct V_19 , V_114 ) ;
F_104 ( & V_20 -> V_114 ) ;
goto V_146;
}
V_20 = F_95 ( V_16 , V_147 | V_148 ) ;
if ( ! F_105 ( V_20 ) )
goto V_146;
switch ( F_106 ( V_20 ) ) {
case - V_143 :
...
static void F_109 ( struct V_15 * V_16 , struct V_19 * V_20 )
{
F_2 ( & V_16 -> V_140 ) ;
if ( ! F_100 ( V_16 , V_20 ) ) {
memset ( V_20 , 0 , sizeof( * V_20 ) ) ;
F_110 ( & V_20 -> V_114 , & V_16 -> free ) ;
}
F_92 ( V_16 ) ;
F_6 ( & V_16 -> V_140 ) ;
}
...
V_20 = F_112 ( & V_16 -> free , struct V_19 , V_114 ) ;
F_104 ( & V_20 -> V_114 ) ;
F_101 ( V_20 ) ;
}
}
struct V_15 * F_113 ( struct V_149 * V_149 , T_4 V_150 ,
unsigned int V_151 ,
unsigned int V_152 )
{
struct V_15 * V_16 ;
struct V_19 * V_20 ;
int V_153 ;
V_16 = F_98 ( V_150 , V_154 ) ;
if ( V_16 == NULL )
goto V_8;
F_114 ( V_16 , V_149 ) ;
for ( V_153 = 0 ; V_153 < V_151 ; V_153 ++ ) {
V_20 = F_98 ( sizeof( struct V_19 ) , V_154 ) ;
if ( ! V_20 )
goto V_155;
F_110 ( & V_20 -> V_114 , & V_16 -> free ) ;
}
...
V_18 -> V_30 = - V_31 ;
F_119 () ;
V_16 = F_120 ( V_18 -> V_63 -> V_157 ) ;
if ( ! F_94 ( V_16 , V_18 ) )
V_16 -> V_41 -> V_158 ( V_16 , V_18 ) ;
F_121 () ;
}
void F_122 ( struct V_17 * V_18 )
{
struct V_15 * V_16 ;
V_18 -> V_30 = 0 ;
if ( V_18 -> V_21 != NULL )
...
static inline T_2 F_123 ( struct V_15 * V_16 )
{
return ( V_159 T_2 ) V_16 -> V_105 ++ ;
}
static inline void F_124 ( struct V_15 * V_16 )
{
V_16 -> V_105 = F_125 () ;
}
static void F_107 ( struct V_17 * V_18 , struct V_15 * V_16 )
{
struct V_19 * V_20 = V_18 -> V_21 ;
F_126 ( & V_20 -> V_114 ) ;
...
V_20 -> V_51 = V_16 ;
V_20 -> V_160 = NULL ;
V_20 -> V_107 = F_123 ( V_16 ) ;
V_20 -> V_122 = V_16 -> V_86 - 1 ;
V_20 -> V_45 = 0 ;
V_20 -> V_161 . V_116 = 0 ;
V_20 -> V_161 . V_162 = 0 ;
V_20 -> V_126 . V_116 = 0 ;
...
V_16 = V_20 -> V_51 ;
if ( V_18 -> V_164 -> V_165 != NULL )
V_18 -> V_164 -> V_165 ( V_18 , V_18 -> V_166 ) ;
else if ( V_18 -> V_63 )
F_128 ( V_18 , V_18 -> V_63 -> V_167 ) ;
F_24 ( & V_16 -> V_40 ) ;
V_16 -> V_41 -> V_46 ( V_16 , V_18 ) ;
if ( V_16 -> V_41 -> V_168 )
V_16 -> V_41 -> V_168 ( V_18 ) ;
if ( ! F_64 ( & V_20 -> V_114 ) )
F_104 ( & V_20 -> V_114 ) ;
V_16 -> V_169 = V_78 ;
if ( F_64 ( & V_16 -> V_88 ) && F_83 ( V_16 ) )
F_129 ( & V_16 -> V_57 ,
V_16 -> V_169 + V_16 -> V_118 ) ;
F_25 ( & V_16 -> V_40 ) ;
if ( V_20 -> V_160 )
V_16 -> V_41 -> V_170 ( V_20 -> V_160 ) ;
if ( V_20 -> V_171 != NULL )
F_130 ( V_20 -> V_171 ) ;
V_18 -> V_21 = NULL ;
if ( V_20 -> V_163 )
...
static void F_114 ( struct V_15 * V_16 , struct V_149 * V_149 )
{
F_115 ( & V_16 -> V_172 , 1 ) ;
F_134 ( & V_16 -> V_40 ) ;
F_134 ( & V_16 -> V_140 ) ;
...
V_16 -> V_49 = V_176 ;
V_16 -> V_177 = 0 ;
F_136 ( & V_16 -> V_178 , L_31 ) ;
F_136 ( & V_16 -> V_54 , L_32 ) ;
F_137 ( & V_16 -> V_35 , L_33 ) ;
F_137 ( & V_16 -> V_134 , L_34 ) ;
F_124 ( V_16 ) ;
V_16 -> V_156 = F_138 ( V_149 ) ;
}
struct V_15 * F_139 ( struct V_179 * args )
{
int V_180 ;
struct V_15 * V_16 ;
struct V_1 * V_3 ;
...
if ( args -> V_183 & V_184 )
V_16 -> V_118 = 0 ;
F_140 ( & V_16 -> V_38 , F_55 ) ;
if ( F_83 ( V_16 ) )
F_141 ( & V_16 -> V_57 , F_63 ,
( unsigned long ) V_16 ) ;
else
F_142 ( & V_16 -> V_57 ) ;
if ( strlen ( args -> V_103 ) > V_185 ) {
F_143 ( V_16 ) ;
return F_96 ( - V_186 ) ;
}
V_16 -> V_103 = F_144 ( args -> V_103 , V_154 ) ;
if ( V_16 -> V_103 == NULL ) {
F_143 ( V_16 ) ;
return F_96 ( - V_143 ) ;
}
...
static void F_143 ( struct V_15 * V_16 )
{
F_13 ( L_38 , V_16 ) ;
F_146 ( & V_16 -> V_57 ) ;
F_147 ( V_16 ) ;
...
F_149 ( & V_16 -> V_38 ) ;
F_101 ( V_16 -> V_103 ) ;
V_16 -> V_41 -> V_187 ( V_16 ) ;
}
void F_150 ( struct V_15 * V_16 )
{
if ( F_151 ( & V_16 -> V_172 ) )
F_143 ( V_16 ) ;
}
