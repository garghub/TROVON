...
struct V_17 * V_27 = & V_148 [ V_146 -> V_149 ] ;
struct V_45 * V_141 ;
struct V_41 * V_42 ;
int V_47 ;
int V_131 ;
...
switch ( V_147 ) {
case V_151 :
F_61 ( V_27 -> V_51 , V_27 -> V_34 + V_152 ,
V_153 , V_153 ) ;
if( V_27 -> V_154 ) {
V_47 = F_62 ( V_27 -> V_51 , V_27 -> V_154 , & V_131 ) ;
if ( V_47 != 0 ) {
F_21 ( V_27 , L_64 ,
V_47 ) ;
return V_47 ;
...
F_61 ( V_27 -> V_51 , V_27 -> V_34 + V_152 ,
V_160 | V_161 , 0 ) ;
F_61 ( V_27 -> V_51 , V_27 -> V_34 + V_163 ,
V_164 , 0 ) ;
F_61 ( V_27 -> V_51 , V_27 -> V_34 + V_152 ,
V_153 , 0 ) ;
...
static int F_63 ( struct V_17 * V_27 )
{
unsigned int V_131 ;
int V_47 , V_44 ;
V_47 = F_64 ( V_27 -> V_51 , V_27 -> V_34 + V_165 ,
V_166 , V_166 ) ;
if ( V_47 != 0 )
return V_47 ;
for ( V_44 = 0 ; V_44 < 10 ; ++ V_44 ) {
V_47 = F_62 ( V_27 -> V_51 , V_27 -> V_34 + V_167 ,
& V_131 ) ;
if ( V_47 != 0 )
return V_47 ;
if ( V_131 & V_168 )
...
int V_47 ;
unsigned int V_131 ;
V_47 = F_62 ( V_27 -> V_51 , V_170 , & V_131 ) ;
if ( V_47 != 0 ) {
F_21 ( V_27 , L_64 , V_47 ) ;
return;
}
...
return;
V_159:
F_61 ( V_27 -> V_51 , V_27 -> V_34 + V_165 ,
V_166 | V_176 | V_177 , 0 ) ;
}
int F_69 ( struct V_145 * V_146 ,
...
V_166 | V_176 |
V_177 , 0 ) ;
F_73 ( V_27 -> V_51 , V_27 -> V_34 + V_181 , 0 ) ;
F_73 ( V_27 -> V_51 , V_27 -> V_34 + V_182 , 0 ) ;
F_73 ( V_27 -> V_51 , V_27 -> V_34 + V_183 , 0 ) ;
if ( V_27 -> V_175 ) {
V_47 = F_68 ( V_27 -> V_175 , 1200000 ,
1800000 ) ;
if ( V_47 != 0 )
F_41 ( V_27 ,
L_71 ,
V_47 ) ;
V_47 = F_74 ( V_27 -> V_175 ) ;
if ( V_47 != 0 )
F_21 ( V_27 ,
L_69 ,
V_47 ) ;
...
int F_75 ( struct V_17 * V_18 , bool V_175 )
{
int V_47 ;
V_47 = F_61 ( V_18 -> V_51 , V_18 -> V_34 + V_165 ,
V_184 , 0 ) ;
if ( V_47 != 0 ) {
F_21 ( V_18 , L_73 , V_47 ) ;
return V_47 ;
...
F_59 ( & V_18 -> V_134 ) ;
F_59 ( & V_18 -> V_67 ) ;
F_51 ( & V_18 -> V_169 , F_66 ) ;
if ( V_175 ) {
V_18 -> V_175 = F_76 ( V_18 -> V_89 , L_74 ) ;
if ( F_77 ( V_18 -> V_175 ) ) {
V_47 = F_78 ( V_18 -> V_175 ) ;
F_21 ( V_18 , L_75 , V_47 ) ;
return V_47 ;
}
V_47 = F_67 ( V_18 -> V_175 ) ;
if ( V_47 != 0 ) {
F_21 ( V_18 , L_76 , V_47 ) ;
return V_47 ;
}
V_47 = F_68 ( V_18 -> V_175 , 1200000 , 1800000 ) ;
if ( V_47 != 0 ) {
F_21 ( V_18 , L_77 , V_47 ) ;
return V_47 ;
}
V_47 = F_74 ( V_18 -> V_175 ) ;
if ( V_47 != 0 ) {
F_21 ( V_18 , L_78 , V_47 ) ;
return V_47 ;
}
