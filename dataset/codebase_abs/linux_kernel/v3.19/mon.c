...
static struct V_2 * F_24 ( const char * V_74 ,
const T_2 V_75 )
{
struct V_2 * V_3 ;
...
static struct V_2 * F_26 ( const struct V_1 * V_76 )
{
struct V_2 * V_3 ;
F_25 (nsm, &nsm_handles, sm_link)
if ( F_27 ( F_1 ( V_3 ) , V_76 ) )
return V_3 ;
return NULL ;
}
static struct V_2 * F_28 ( const struct V_77 * V_41 )
{
struct V_2 * V_3 ;
F_25 (nsm, &nsm_handles, sm_link)
...
V_80 = F_30 () ;
F_31 ( V_80 , V_79 ) ;
F_31 ( ( unsigned long ) V_3 , V_79 + 1 ) ;
}
static struct V_2 * F_32 ( const struct V_1 * V_76 ,
const T_2 V_81 ,
const char * V_74 ,
const T_2 V_82 )
{
struct V_2 * V_34 ;
V_34 = F_33 ( sizeof( * V_34 ) + V_82 + 1 , V_83 ) ;
if ( F_19 ( V_34 == NULL ) )
return NULL ;
F_34 ( & V_34 -> V_70 , 1 ) ;
...
struct V_2 * F_36 ( const struct V_1 * V_76 ,
...
F_7 ( & V_88 ) ;
V_34 = F_32 ( V_76 , V_81 , V_74 , V_82 ) ;
if ( F_19 ( V_34 == NULL ) )
return NULL ;
goto V_87;
}
struct V_2 * F_41 ( const struct V_91 * V_92 )
{
struct V_2 * V_85 ;
F_6 ( & V_88 ) ;
V_85 = F_28 ( & V_92 -> V_41 ) ;
...
static void F_45 ( struct V_94 * V_95 , const char * string )
{
const T_1 V_75 = strlen ( string ) ;
T_5 * V_79 ;
V_79 = F_46 ( V_95 , 4 + V_75 ) ;
F_47 ( V_79 , string , V_75 ) ;
}
static void F_48 ( struct V_94 * V_95 , const struct V_40 * V_96 )
{
F_45 ( V_95 , V_96 -> V_47 ) ;
}
static void F_49 ( struct V_94 * V_95 , const struct V_40 * V_96 )
{
T_5 * V_79 ;
F_45 ( V_95 , V_96 -> V_49 ) ;
V_79 = F_46 ( V_95 , 4 + 4 + 4 ) ;
* V_79 ++ = F_50 ( V_96 -> V_43 ) ;
* V_79 ++ = F_50 ( V_96 -> V_45 ) ;
* V_79 = F_50 ( V_96 -> V_36 ) ;
}
...
static void F_52 ( struct V_94 * V_95 , const struct V_40 * V_96 )
{
T_5 * V_79 ;
V_79 = F_46 ( V_95 , V_97 ) ;
F_53 ( V_79 , V_96 -> V_41 -> V_78 , V_97 ) ;
}
...
static void F_55 ( struct V_98 * V_99 , struct V_94 * V_95 ,
const struct V_40 * V_96 )
{
F_51 ( V_95 , V_96 ) ;
}
static int F_56 ( struct V_98 * V_100 ,
struct V_94 * V_95 ,
struct V_37 * V_101 )
{
T_5 * V_79 ;
...
if ( F_19 ( V_79 == NULL ) )
return - V_67 ;
V_101 -> V_39 = F_58 ( V_79 ++ ) ;
V_101 -> V_69 = F_58 ( V_79 ) ;
F_15 ( L_20 ,
V_102 , V_101 -> V_39 , V_101 -> V_69 ) ;
return 0 ;
}
static int F_59 ( struct V_98 * V_100 ,
struct V_94 * V_95 ,
struct V_37 * V_101 )
{
T_5 * V_79 ;
