...
static int F_212 ( struct V_308 * V_308 , struct V_309 * V_309 )
{
...
int V_19 ;
V_19 = - V_23 ;
if ( ! F_214 ( L_5 , V_314 , V_18 -> V_315 , & V_316 ) )
goto V_250;
if ( ! F_214 ( L_6 , V_314 , V_18 -> V_315 ,
& V_317 ) )
goto V_318;
V_19 = 0 ;
V_250:
return V_19 ;
V_318:
F_215 ( L_5 , V_18 -> V_315 ) ;
goto V_250;
}
static void T_7 F_216 ( struct V_18 * V_18 )
{
F_215 ( L_6 , V_18 -> V_315 ) ;
F_215 ( L_5 , V_18 -> V_315 ) ;
}
...
{
int V_19 ;
V_19 = F_218 ( & V_18 -> V_147 . V_215 , V_319 ,
V_320 , V_223 , V_18 ) ;
if ( V_19 < 0 ) {
F_219 ( L_7 ,
V_19 ) ;
