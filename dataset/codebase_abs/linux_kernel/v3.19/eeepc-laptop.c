...
static void F_125 ( struct V_7 * V_8 , int V_70 )
{
if ( ! V_8 -> V_139 )
return;
if ( ! F_126 ( V_8 -> V_139 , V_70 , 1 , true ) )
F_127 ( L_37 , V_70 ) ;
}
static void F_128 ( struct V_140 * V_17 , T_5 V_70 )
{
struct V_7 * V_8 = F_129 ( V_17 ) ;
int V_141 , V_142 ;
T_7 V_19 ;
if ( V_70 > V_143 )
return;
V_19 = V_8 -> V_144 [ V_70 % 128 ] ++ ;
F_130 ( V_17 -> V_145 . V_146 ,
F_131 ( & V_17 -> V_18 ) , V_70 ,
V_19 ) ;
if ( V_70 < V_147 || V_70 > V_148 ) {
F_125 ( V_8 , V_70 ) ;
return;
}
if ( ! V_8 -> V_117 )
...
if ( ! V_149 )
return;
if ( strcmp ( V_149 , L_38 ) == 0 || strcmp ( V_149 , L_39 ) == 0 ) {
V_8 -> V_31 = true ;
F_127 ( L_40 ,
V_149 ) ;
F_127 ( L_41 ) ;
}
if ( strcmp ( V_149 , L_42 ) == 0 || strcmp ( V_149 , L_43 ) == 0 ||
strcmp ( V_149 , L_44 ) == 0 ) {
V_8 -> V_102 = true ;
F_127 ( L_45 ) ;
}
}
static void F_134 ( struct V_7 * V_8 , int V_9 , const char * V_50 )
{
int V_151 ;
if ( ! ( V_8 -> V_13 & ( 1 << V_9 ) )
&& ! F_3 ( V_8 -> V_1 , V_14 [ V_9 ] , & V_151 ) ) {
F_127 ( L_46 ,
V_50 , 1 << V_9 ) ;
V_8 -> V_13 |= 1 << V_9 ;
}
...
{
F_134 ( V_8 , V_152 , L_47 ) ;
F_134 ( V_8 , V_153 , L_48 ) ;
F_134 ( V_8 , V_154 , L_49 ) ;
F_134 ( V_8 , V_43 , L_50 ) ;
}
...
if ( V_6 )
return V_6 ;
if ( ! V_8 -> V_17 -> V_4 . V_156 ) {
F_52 ( L_51 ) ;
return - V_12 ;
}
V_155 = V_157 | V_158 ;
F_138 ( L_52 , V_155 ) ;
if ( F_1 ( V_8 -> V_1 , L_53 , V_155 ) ) {
F_52 ( L_54 ) ;
return - V_12 ;
}
...
static int F_140 ( struct V_140 * V_17 )
{
struct V_7 * V_8 ;
int V_6 ;
F_138 ( V_160 L_7 ) ;
...
static int F_144 ( struct V_140 * V_17 )
{
struct V_7 * V_8 = F_129 ( V_17 ) ;
F_115 ( V_8 ) ;
F_81 ( V_8 ) ;
