...
static int F_122 ( struct V_243 * V_244 , struct V_189 * V_14 ,
struct V_245 * V_246 , T_8 V_79 )
{
struct V_14 * V_15 = V_14 -> V_15 ;
struct V_36 * V_37 = F_8 ( V_15 ) ;
F_123 ( struct V_164 * , V_247 , V_246 -> V_248 ) ;
struct V_164 V_249 ;
int V_2 = - V_111 ;
...
V_247 = & V_249 ;
V_247 -> V_168 = V_169 ;
V_247 -> V_173 = V_37 -> type ;
V_247 -> V_217 = V_37 -> V_228 . V_14 ;
V_247 -> V_170 = V_37 -> V_228 . V_27 ;
memcpy ( V_247 -> V_172 , V_37 -> V_228 . V_5 , V_38 ) ;
}
V_2 = F_124 ( V_15 , V_247 , V_246 , V_79 , V_95 & V_251 ) ;
if ( V_2 >= 0 )
V_2 = V_79 ;
V_17:
F_97 ( V_15 ) ;
...
static int F_125 ( struct V_243 * V_244 , struct V_189 * V_14 ,
struct V_245 * V_246 , T_8 V_254 , int V_95 )
{
struct V_14 * V_15 = V_14 -> V_15 ;
struct V_36 * V_37 = F_8 ( V_15 ) ;
F_123 ( struct V_164 * , V_165 , V_246 -> V_248 ) ;
...
F_97 ( V_15 ) ;
V_256 = false ;
V_57 = F_126 ( V_15 , V_95 & ~ V_251 ,
V_95 & V_251 , & V_2 ) ;
if ( ! V_57 ) {
if ( V_2 == - V_132 && ( V_15 -> V_208 & V_257 ) )
V_2 = 0 ;
goto V_17;
}
V_60 = F_50 ( V_57 ) ;
V_255 = F_53 ( V_60 -> V_116 ) - sizeof( struct V_59 ) ;
if ( V_255 > V_254 ) {
V_255 = V_254 ;
V_246 -> V_250 |= V_258 ;
}
V_2 = F_127 ( V_57 , sizeof( struct V_59 ) , V_246 , V_255 ) ;
if ( V_2 )
goto V_259;
if ( V_57 -> V_260 . V_261 )
V_15 -> V_262 = V_57 -> V_260 ;
if ( V_165 ) {
V_165 -> V_168 = V_169 ;
...
long V_263 = 0 ;
struct V_14 * V_15 = V_14 -> V_15 ;
void T_1 * V_264 = ( void T_1 * ) V_10 ;
F_96 ( V_15 ) ;
switch ( V_160 ) {
case V_265 :
V_263 = V_15 -> V_266 - F_130 ( V_15 ) ;
if ( V_263 < 0 )
V_263 = 0 ;
V_2 = F_100 ( V_263 , ( int T_1 * ) V_264 ) ;
break;
case V_267 : {
struct V_56 * V_57 = F_131 ( & V_15 -> V_19 ) ;
if ( V_57 )
V_263 = V_57 -> V_79 - sizeof( struct V_59 ) ;
V_2 = F_100 ( V_263 , ( int T_1 * ) V_264 ) ;
break;
}
case V_268 :
...
( const unsigned short T_1 * ) V_264 ) ;
break;
case V_273 :
V_2 = F_133 ( V_15 , V_264 ) ;
break;
case V_274 :
case V_275 :
case V_276 :
...
static int F_135 ( struct V_189 * V_14 , int V_281 )
{
struct V_14 * V_15 = V_14 -> V_15 ;
if ( V_281 < V_282 || V_281 > V_283 )
return - V_111 ;
++ V_281 ;
F_96 ( V_15 ) ;
V_15 -> V_208 |= V_281 ;
...
F_72 ( V_288 ) ;
V_146 = F_142 ( V_289 , F_119 ) ;
if ( ! V_146 )
F_72 ( V_290 ) ;
V_149 = F_143 ( V_291 , F_119 ) ;
if ( ! V_149 )
F_72 ( V_292 ) ;
F_144 ( & V_293 ) ;
F_145 () ;
