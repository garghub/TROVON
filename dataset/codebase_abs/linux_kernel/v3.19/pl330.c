...
static int F_104 ( struct V_260 * V_72 , enum V_295 V_296 , unsigned long V_38 )
{
struct V_203 * V_204 = F_84 ( V_72 ) ;
struct V_118 * V_4 ;
unsigned long V_189 ;
...
if ( ! F_92 ( & V_204 -> V_273 ) )
F_107 ( V_187 -> V_87 . V_88 ) ;
F_108 ( & V_204 -> V_301 , & V_187 -> V_277 ) ;
F_108 ( & V_204 -> V_273 , & V_187 -> V_277 ) ;
F_108 ( & V_204 -> V_272 , & V_187 -> V_277 ) ;
F_55 ( & V_204 -> V_197 , V_189 ) ;
F_97 ( V_187 -> V_87 . V_88 ) ;
F_98 ( V_187 -> V_87 . V_88 ) ;
break;
case V_302 :
V_298 = (struct V_297 * ) V_38 ;
if ( V_298 -> V_303 == V_135 ) {
if ( V_298 -> V_155 )
V_204 -> V_304 = V_298 -> V_155 ;
if ( V_298 -> V_305 )
V_204 -> V_306 = F_109 ( V_298 -> V_305 ) ;
if ( V_298 -> V_307 )
V_204 -> V_308 = V_298 -> V_307 ;
} else if ( V_298 -> V_303 == V_136 ) {
if ( V_298 -> V_154 )
V_204 -> V_304 = V_298 -> V_154 ;
if ( V_298 -> V_309 )
V_204 -> V_306 = F_109 ( V_298 -> V_309 ) ;
if ( V_298 -> V_310 )
V_204 -> V_308 = V_298 -> V_310 ;
}
break;
default:
...
unsigned long V_189 ;
F_83 ( & V_204 -> V_208 ) ;
F_106 ( V_204 -> V_5 -> V_87 . V_88 ) ;
F_54 ( & V_204 -> V_197 , V_189 ) ;
F_68 ( V_204 -> V_266 ) ;
V_204 -> V_266 = NULL ;
if ( V_204 -> V_270 )
F_108 ( & V_204 -> V_273 , & V_204 -> V_5 -> V_277 ) ;
F_55 ( & V_204 -> V_197 , V_189 ) ;
F_97 ( V_204 -> V_5 -> V_87 . V_88 ) ;
F_98 ( V_204 -> V_5 -> V_87 . V_88 ) ;
}
static enum V_312
F_111 ( struct V_260 * V_72 , T_6 V_267 ,
struct V_313 * V_314 )
{
return F_112 ( V_72 , V_267 , V_314 ) ;
}
static void F_113 ( struct V_260 * V_72 )
{
struct V_203 * V_204 = F_84 ( V_72 ) ;
unsigned long V_189 ;
F_54 ( & V_204 -> V_197 , V_189 ) ;
if ( F_92 ( & V_204 -> V_273 ) ) {
F_114 ( F_92 ( & V_204 -> V_301 ) ) ;
F_106 ( V_204 -> V_5 -> V_87 . V_88 ) ;
}
F_108 ( & V_204 -> V_301 , & V_204 -> V_273 ) ;
F_55 ( & V_204 -> V_197 , V_189 ) ;
F_89 ( ( unsigned long ) V_204 ) ;
}
static T_6 F_115 ( struct V_262 * V_263 )
{
struct V_118 * V_4 , * V_315 = F_86 ( V_263 ) ;
struct V_203 * V_204 = F_84 ( V_263 -> V_72 ) ;
T_6 V_267 ;
unsigned long V_189 ;
F_54 ( & V_204 -> V_197 , V_189 ) ;
while ( ! F_92 ( & V_315 -> V_271 ) ) {
V_4 = F_116 ( V_315 -> V_271 . V_316 , struct V_118 , V_271 ) ;
if ( V_204 -> V_270 ) {
V_4 -> V_264 . V_274 = V_315 -> V_264 . V_274 ;
V_4 -> V_264 . V_275 = V_315 -> V_264 . V_275 ;
}
F_117 ( & V_4 -> V_264 ) ;
F_91 ( & V_4 -> V_271 , & V_204 -> V_301 ) ;
}
V_267 = F_117 ( & V_315 -> V_264 ) ;
F_61 ( & V_315 -> V_271 , & V_204 -> V_301 ) ;
F_55 ( & V_204 -> V_197 , V_189 ) ;
return V_267 ;
}
static inline void F_118 ( struct V_118 * V_4 )
{
V_4 -> V_122 . V_184 = V_317 ;
V_4 -> V_122 . V_180 = V_318 ;
V_4 -> V_122 . V_182 = V_318 ;
V_4 -> V_264 . V_319 = F_115 ;
F_78 ( & V_4 -> V_271 ) ;
}
static int F_119 ( struct V_186 * V_187 , T_7 V_320 , int V_289 )
{
struct V_118 * V_4 ;
unsigned long V_189 ;
int V_210 ;
V_4 = F_120 ( V_289 , sizeof( * V_4 ) , V_320 ) ;
if ( ! V_4 )
return 0 ;
F_54 ( & V_187 -> V_321 , V_189 ) ;
for ( V_210 = 0 ; V_210 < V_289 ; V_210 ++ ) {
F_118 ( & V_4 [ V_210 ] ) ;
F_61 ( & V_4 [ V_210 ] . V_271 , & V_187 -> V_277 ) ;
}
F_55 ( & V_187 -> V_321 , V_189 ) ;
return V_289 ;
}
static struct V_118 * F_121 ( struct V_186 * V_187 )
{
struct V_118 * V_4 = NULL ;
unsigned long V_189 ;
F_54 ( & V_187 -> V_321 , V_189 ) ;
if ( ! F_92 ( & V_187 -> V_277 ) ) {
V_4 = F_116 ( V_187 -> V_277 . V_316 ,
struct V_118 , V_271 ) ;
F_122 ( & V_4 -> V_271 ) ;
V_4 -> V_206 = V_276 ;
...
static struct V_118 * F_123 ( struct V_203 * V_204 )
{
struct V_186 * V_187 = V_204 -> V_5 ;
...
F_125 ( & V_4 -> V_264 , & V_204 -> V_72 ) ;
return V_4 ;
}
static inline void F_126 ( struct V_148 * V_150 ,
T_8 V_46 , T_8 V_323 , T_9 V_324 )
{
V_150 -> V_153 = V_324 ;
V_150 -> V_155 = V_46 ;
V_150 -> V_154 = V_323 ;
...
static struct V_118 *
F_127 ( struct V_203 * V_204 , T_8 V_46 ,
T_8 V_323 , T_9 V_324 )
{
struct V_118 * V_4 = F_123 ( V_204 ) ;
if ( ! V_4 ) {
F_32 ( V_204 -> V_5 -> V_87 . V_88 , L_42 ,
V_124 , __LINE__ ) ;
return NULL ;
}
F_126 ( & V_4 -> V_150 , V_46 , V_323 , V_324 ) ;
return V_4 ;
}
static inline int F_128 ( struct V_118 * V_4 , T_9 V_324 )
{
struct V_203 * V_204 = V_4 -> V_205 ;
struct V_186 * V_187 = V_204 -> V_5 ;
int V_308 ;
V_308 = V_187 -> V_7 . V_237 / 8 ;
V_308 *= V_187 -> V_7 . V_240 / V_187 -> V_7 . V_213 ;
V_308 >>= V_4 -> V_122 . V_177 ;
if ( V_308 > 16 )
V_308 = 16 ;
while ( V_308 > 1 ) {
if ( ! ( V_324 % ( V_308 << V_4 -> V_122 . V_177 ) ) )
break;
V_308 -- ;
}
return V_308 ;
}
static struct V_262 * F_129 (
struct V_260 * V_72 , T_8 V_325 , T_9 V_324 ,
T_9 V_326 , enum V_327 V_303 ,
unsigned long V_189 )
{
struct V_118 * V_4 = NULL , * V_328 = NULL ;
struct V_203 * V_204 = F_84 ( V_72 ) ;
struct V_186 * V_187 = V_204 -> V_5 ;
unsigned int V_210 ;
T_8 V_46 ;
...
for ( V_210 = 0 ; V_210 < V_324 / V_326 ; V_210 ++ ) {
V_4 = F_123 ( V_204 ) ;
if ( ! V_4 ) {
F_32 ( V_204 -> V_5 -> V_87 . V_88 , L_42 ,
V_124 , __LINE__ ) ;
...
return NULL ;
F_54 ( & V_187 -> V_321 , V_189 ) ;
while ( ! F_92 ( & V_328 -> V_271 ) ) {
V_4 = F_116 ( V_328 -> V_271 . V_316 ,
struct V_118 , V_271 ) ;
F_91 ( & V_4 -> V_271 , & V_187 -> V_277 ) ;
}
F_91 ( & V_328 -> V_271 , & V_187 -> V_277 ) ;
F_55 ( & V_187 -> V_321 , V_189 ) ;
return NULL ;
}
switch ( V_303 ) {
...
V_4 -> V_134 = V_303 ;
V_4 -> V_122 . V_177 = V_204 -> V_306 ;
V_4 -> V_122 . V_174 = 1 ;
F_126 ( & V_4 -> V_150 , V_46 , V_323 , V_326 ) ;
if ( ! V_328 )
V_328 = V_4 ;
else
F_61 ( & V_4 -> V_271 , & V_328 -> V_271 ) ;
V_325 += V_326 ;
}
if ( ! V_4 )
return NULL ;
...
static struct V_262 *
F_131 ( struct V_260 * V_72 , T_8 V_46 ,
T_8 V_323 , T_9 V_324 , unsigned long V_189 )
{
struct V_118 * V_4 ;
struct V_203 * V_204 = F_84 ( V_72 ) ;
struct V_186 * V_187 = V_204 -> V_5 ;
int V_329 ;
if ( F_132 ( ! V_204 || ! V_324 ) )
return NULL ;
V_4 = F_127 ( V_204 , V_46 , V_323 , V_324 ) ;
if ( ! V_4 )
return NULL ;
V_4 -> V_122 . V_162 = 1 ;
V_4 -> V_122 . V_164 = 1 ;
V_4 -> V_134 = V_137 ;
V_329 = V_187 -> V_7 . V_237 / 8 ;
while ( ( V_323 | V_46 | V_324 ) & ( V_329 - 1 ) )
V_329 /= 2 ;
V_4 -> V_122 . V_177 = 0 ;
while ( V_329 != ( 1 << V_4 -> V_122 . V_177 ) )
V_4 -> V_122 . V_177 ++ ;
if ( V_4 -> V_122 . V_177 * 8 < V_187 -> V_7 . V_237 )
V_4 -> V_122 . V_174 = 1 ;
V_4 -> V_122 . V_174 = F_128 ( V_4 , V_324 ) ;
V_4 -> V_264 . V_189 = V_189 ;
return & V_4 -> V_264 ;
}
...
static struct V_262 *
F_134 ( struct V_260 * V_72 , struct V_330 * V_331 ,
unsigned int V_332 , enum V_327 V_303 ,
unsigned long V_320 , void * V_333 )
{
struct V_118 * V_328 , * V_4 = NULL ;
struct V_203 * V_204 = F_84 ( V_72 ) ;
struct V_330 * V_334 ;
int V_210 ;
T_8 V_73 ;
if ( F_132 ( ! V_204 || ! V_331 || ! V_332 ) )
return NULL ;
V_73 = V_204 -> V_304 ;
V_328 = NULL ;
...
V_4 -> V_122 . V_164 = 0 ;
F_126 ( & V_4 -> V_150 ,
V_73 , F_136 ( V_334 ) , F_137 ( V_334 ) ) ;
} else {
V_4 -> V_122 . V_162 = 0 ;
V_4 -> V_122 . V_164 = 1 ;
F_126 ( & V_4 -> V_150 ,
F_136 ( V_334 ) , V_73 , F_137 ( V_334 ) ) ;
}
V_4 -> V_122 . V_177 = V_204 -> V_306 ;
V_4 -> V_122 . V_174 = 1 ;
V_4 -> V_134 = V_303 ;
}
V_4 -> V_264 . V_189 = V_320 ;
return & V_4 -> V_264 ;
}
static T_10 F_138 ( int V_335 , void * V_209 )
{
if ( F_59 ( V_209 ) )
return V_336 ;
else
...
static int F_139 ( struct V_260 * V_338 ,
struct V_339 * V_340 )
{
V_340 -> V_341 = V_342 ;
V_340 -> V_343 = V_342 ;
V_340 -> V_344 = F_140 ( V_136 ) | F_140 ( V_135 ) ;
V_340 -> V_345 = false ;
V_340 -> V_346 = true ;
V_340 -> V_347 = V_348 ;
return 0 ;
}
static int T_11 F_141 ( struct V_280 * V_88 )
{
struct V_349 * V_350 = F_142 ( V_88 ) ;
F_143 ( V_88 ) ;
if ( ! F_144 ( V_88 ) ) {
F_145 ( V_350 ) ;
}
...
static int T_11 F_147 ( struct V_280 * V_88 )
{
struct V_349 * V_350 = F_142 ( V_88 ) ;
int V_190 ;
V_190 = F_148 ( V_350 ) ;
...
static int
F_151 ( struct V_349 * V_351 , const struct V_352 * V_84 )
{
struct V_353 * V_354 ;
struct V_131 * V_7 ;
struct V_186 * V_187 ;
struct V_203 * V_204 , * V_355 ;
struct V_356 * V_357 ;
struct V_358 * V_359 ;
int V_210 , V_190 , V_335 ;
int V_213 ;
V_354 = F_152 ( & V_351 -> V_88 ) ;
V_190 = F_153 ( & V_351 -> V_88 , F_154 ( 32 ) ) ;
if ( V_190 )
return V_190 ;
V_187 = F_155 ( & V_351 -> V_88 , sizeof( * V_187 ) , V_255 ) ;
if ( ! V_187 ) {
F_32 ( & V_351 -> V_88 , L_44 ) ;
return - V_200 ;
}
V_357 = & V_187 -> V_87 ;
V_357 -> V_88 = & V_351 -> V_88 ;
V_187 -> V_199 = V_354 ? V_354 -> V_360 : 0 ;
V_359 = & V_351 -> V_359 ;
V_187 -> V_78 = F_156 ( & V_351 -> V_88 , V_359 ) ;
if ( F_157 ( V_187 -> V_78 ) )
return F_158 ( V_187 -> V_78 ) ;
F_159 ( V_351 , V_187 ) ;
for ( V_210 = 0 ; V_210 < V_361 ; V_210 ++ ) {
V_335 = V_351 -> V_335 [ V_210 ] ;
if ( V_335 ) {
V_190 = F_160 ( & V_351 -> V_88 , V_335 ,
F_138 , 0 ,
F_161 ( & V_351 -> V_88 ) , V_187 ) ;
if ( V_190 )
return V_190 ;
} else {
break;
...
V_7 = & V_187 -> V_7 ;
V_7 -> V_10 = V_351 -> V_362 ;
V_190 = F_76 ( V_187 ) ;
if ( V_190 )
return V_190 ;
F_78 ( & V_187 -> V_277 ) ;
F_77 ( & V_187 -> V_321 ) ;
if ( ! F_119 ( V_187 , V_255 , V_363 ) )
F_162 ( & V_351 -> V_88 , L_45 ) ;
F_78 ( & V_357 -> V_214 ) ;
if ( V_354 )
V_213 = F_163 ( int , V_354 -> V_364 , V_7 -> V_213 ) ;
else
V_213 = F_163 ( int , V_7 -> V_196 , V_7 -> V_213 ) ;
V_187 -> V_293 = V_213 ;
V_187 -> V_294 = F_72 ( V_213 * sizeof( * V_204 ) , V_255 ) ;
if ( ! V_187 -> V_294 ) {
V_190 = - V_200 ;
F_32 ( & V_351 -> V_88 , L_46 ) ;
goto V_365;
}
for ( V_210 = 0 ; V_210 < V_213 ; V_210 ++ ) {
V_204 = & V_187 -> V_294 [ V_210 ] ;
if ( ! V_351 -> V_88 . V_366 )
V_204 -> V_72 . V_284 = V_354 ? & V_354 -> V_279 [ V_210 ] : NULL ;
else
V_204 -> V_72 . V_284 = V_351 -> V_88 . V_366 ;
F_78 ( & V_204 -> V_301 ) ;
F_78 ( & V_204 -> V_273 ) ;
F_78 ( & V_204 -> V_272 ) ;
F_77 ( & V_204 -> V_197 ) ;
V_204 -> V_266 = NULL ;
V_204 -> V_72 . V_280 = V_357 ;
V_204 -> V_5 = V_187 ;
F_61 ( & V_204 -> V_72 . V_367 , & V_357 -> V_214 ) ;
}
if ( V_354 ) {
V_357 -> V_368 = V_354 -> V_368 ;
} else {
F_164 ( V_369 , V_357 -> V_368 ) ;
if ( V_7 -> V_196 ) {
F_164 ( V_370 , V_357 -> V_368 ) ;
F_164 ( V_371 , V_357 -> V_368 ) ;
F_164 ( V_372 , V_357 -> V_368 ) ;
}
}
V_357 -> V_373 = F_102 ;
V_357 -> V_374 = F_110 ;
...
V_190 = F_165 ( V_357 ) ;
if ( V_190 ) {
F_32 ( & V_351 -> V_88 , L_47 ) ;
goto V_382;
}
if ( V_351 -> V_88 . V_366 ) {
V_190 = F_166 ( V_351 -> V_88 . V_366 ,
F_100 , V_187 ) ;
if ( V_190 ) {
F_32 ( & V_351 -> V_88 ,
L_48 ) ;
...
V_351 -> V_88 . V_383 = & V_187 -> V_383 ;
V_190 = F_167 ( & V_351 -> V_88 , 1900800 ) ;
if ( V_190 )
F_32 ( & V_351 -> V_88 , L_49 ) ;
F_38 ( & V_351 -> V_88 ,
L_50 , V_351 -> V_362 ) ;
F_38 ( & V_351 -> V_88 ,
L_51 ,
...
chan.device_node) {
F_63 ( & V_204 -> V_72 . V_367 ) ;
if ( V_204 -> V_266 ) {
F_104 ( & V_204 -> V_72 , V_300 , 0 ) ;
F_110 ( & V_204 -> V_72 ) ;
}
}
V_365:
...
static int F_171 ( struct V_349 * V_351 )
{
struct V_186 * V_187 = F_172 ( V_351 ) ;
struct V_203 * V_204 , * V_355 ;
F_173 ( V_187 -> V_87 . V_88 ) ;
if ( V_351 -> V_88 . V_366 )
F_174 ( V_351 -> V_88 . V_366 ) ;
F_175 ( & V_187 -> V_87 ) ;
F_62 (pch, _p, &pl330->ddma.channels,
chan.device_node) {
F_63 ( & V_204 -> V_72 . V_367 ) ;
