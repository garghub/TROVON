...
bool V_240 = false ;
while ( V_238 && V_238 -> V_241 != 0 ) {
if ( V_2 -> V_242 -> V_243 == V_238 -> V_244 &&
V_2 -> V_242 -> V_97 == V_238 -> V_241 &&
V_2 -> V_242 -> V_245 == V_238 -> V_246 &&
V_2 -> V_242 -> V_247 == V_238 -> V_248 ) {
V_240 = true ;
break;
}
++ V_238 ;
...
V_2 -> V_8 . V_54 = 0 ;
V_2 -> V_8 . V_28 = 0 ;
if ( V_2 -> V_82 && V_2 -> V_285 . V_286 ) {
F_106 (crtc,
&ddev->mode_config.crtc_list, head) {
V_284 = F_107 ( V_283 ) ;
if ( V_284 -> V_287 ) {
V_2 -> V_8 . V_54 |= ( 1 << V_284 -> V_288 ) ;
V_2 -> V_8 . V_28 ++ ;
}
}
}
...
V_284 = F_107 ( V_283 ) ;
if ( V_283 -> V_287 ) {
V_2 -> V_8 . V_16 . V_202 |= ( 1 << V_284 -> V_288 ) ;
V_2 -> V_8 . V_16 . V_166 ++ ;
}
}
}
...
{
int V_283 , V_292 , V_293 , V_294 ;
bool V_295 = true ;
for ( V_283 = 0 ; ( V_283 < V_2 -> V_82 ) && V_295 ; V_283 ++ ) {
if ( V_2 -> V_8 . V_54 & ( 1 << V_283 ) ) {
V_294 = F_111 ( V_2 -> V_73 , V_283 , 0 , & V_292 , & V_293 , NULL , NULL ) ;
if ( ( V_294 & V_296 ) &&
! ( V_294 & V_297 ) )
V_295 = false ;
}
...
static bool F_21 ( struct V_1 * V_2 , bool V_298 )
{
T_1 V_299 = 0 ;
bool V_295 = F_18 ( V_2 ) ;
if ( V_295 == false )
...
F_6 ( & V_2 -> V_8 . V_15 ) ;
F_114 ( & V_2 -> V_301 . V_302 , V_300 ) ;
}
static int F_115 ( struct V_308 * V_309 , void * V_310 )
{
struct V_311 * V_312 = (struct V_311 * ) V_309 -> V_313 ;
struct V_102 * V_98 = V_312 -> V_314 -> V_98 ;
...
F_3 ( & V_2 -> V_8 . V_15 ) ;
if ( V_2 -> V_20 -> V_16 . V_315 )
F_117 ( V_2 , V_309 ) ;
else
F_116 ( V_309 , L_46 ) ;
F_6 ( & V_2 -> V_8 . V_15 ) ;
} else {
F_116 ( V_309 , L_47 , V_2 -> V_8 . V_65 ) ;
if ( ( V_2 -> V_18 >= V_267 ) && ( V_2 -> V_90 & V_92 ) )
F_116 ( V_309 , L_48 , V_2 -> V_8 . V_68 ) ;
else
F_116 ( V_309 , L_48 , F_118 ( V_2 ) ) ;
F_116 ( V_309 , L_49 , V_2 -> V_8 . V_67 ) ;
if ( V_2 -> V_20 -> V_8 . V_316 )
F_116 ( V_309 , L_50 , F_119 ( V_2 ) ) ;
if ( V_2 -> V_8 . V_221 )
F_116 ( V_309 , L_51 , V_2 -> V_8 . V_221 ) ;
if ( V_2 -> V_20 -> V_8 . V_317 )
F_116 ( V_309 , L_52 , F_120 ( V_2 ) ) ;
}
return 0 ;
}
...
{
#if F_121 ( V_318 )
return F_122 ( V_2 , V_319 , F_123 ( V_319 ) ) ;
#else
return 0 ;
#endif
}
