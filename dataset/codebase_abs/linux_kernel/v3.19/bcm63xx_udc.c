...
F_115 ( & V_11 -> V_197 ) ;
if ( V_273 && V_11 -> V_195 )
V_11 -> V_195 -> V_277 ( & V_11 -> V_4 ) ;
else if ( V_274 && V_11 -> V_195 )
F_116 ( & V_11 -> V_4 , V_11 -> V_195 ) ;
return V_278 ;
}
static T_3 F_117 ( int V_270 , void * V_271 )
{
...
V_279 = true ;
F_77 ( & V_11 -> V_209 ) ;
V_10 -> V_207 = F_118 ( V_10 -> V_207 , V_10 -> V_83 ) ;
} else {
F_28 ( V_11 , V_66 , V_78 ) ;
}
}
...
static int F_119 ( struct V_280 * V_281 , void * V_282 )
{
struct V_1 * V_11 = V_281 -> V_283 ;
if ( ! V_11 -> V_195 )
return - V_254 ;
F_120 ( V_281 , L_15 ,
V_284 [ V_11 -> V_172 ] ) ;
...
static int F_121 ( struct V_280 * V_281 , void * V_282 )
{
struct V_1 * V_11 = V_281 -> V_283 ;
int V_111 , V_37 ;
T_1 V_285 , V_286 ;
...
F_120 ( V_281 , V_111 & 0x01 ? L_33 : L_34 ) ;
F_120 ( V_281 , L_35 ,
...
V_285 = F_13 ( V_11 , V_127 , V_111 ) ;
V_286 = F_13 ( V_11 , V_290 , V_111 ) ;
F_120 ( V_281 , L_37 ,
F_13 ( V_11 , V_126 , V_111 ) ,
V_285 >> 16 , V_285 & 0xffff ,
V_286 >> 16 , V_286 & 0xffff ,
F_13 ( V_11 , V_291 , V_111 ) ) ;
F_120 ( V_281 , L_38 , V_66 -> V_89 ,
V_66 -> V_104 ) ;
if ( V_66 -> V_27 ) {
V_37 = 0 ;
F_123 (pos, &iudma->bep->queue)
V_37 ++ ;
F_120 ( V_281 , L_39 , V_37 ) ;
} else {
F_120 ( V_281 , L_40 ) ;
}
...
static int F_124 ( struct V_292 * V_292 , struct V_293 * V_293 )
{
return F_125 ( V_293 , F_119 , V_292 -> V_294 ) ;
}
static int F_126 ( struct V_292 * V_292 , struct V_293 * V_293 )
{
return F_125 ( V_293 , F_121 , V_292 -> V_294 ) ;
}
static void F_127 ( struct V_1 * V_11 )
{
struct V_295 * V_296 , * V_297 , * V_66 ;
if ( ! F_128 ( V_298 ) )
return;
V_296 = F_129 ( V_11 -> V_4 . V_164 , NULL ) ;
if ( F_57 ( V_296 ) || ! V_296 )
goto V_299;
V_297 = F_130 ( L_4 , 0400 , V_296 , V_11 ,
& V_300 ) ;
if ( ! V_297 )
goto V_301;
V_66 = F_130 ( L_44 , 0400 , V_296 , V_11 ,
& V_302 ) ;
if ( ! V_66 )
goto V_303;
V_11 -> V_304 = V_296 ;
...
static int F_133 ( struct V_307 * V_308 )
{
struct V_309 * V_119 = & V_308 -> V_119 ;
struct V_310 * V_147 = F_134 ( V_119 ) ;
struct V_1 * V_11 ;
struct V_311 * V_312 ;
...
V_312 = F_136 ( V_308 , V_313 , 0 ) ;
V_11 -> V_13 = F_137 ( V_119 , V_312 ) ;
if ( F_57 ( V_11 -> V_13 ) )
return F_138 ( V_11 -> V_13 ) ;
V_312 = F_136 ( V_308 , V_313 , 1 ) ;
V_11 -> V_15 = F_137 ( V_119 , V_312 ) ;
if ( F_57 ( V_11 -> V_15 ) )
return F_138 ( V_11 -> V_15 ) ;
F_139 ( & V_11 -> V_197 ) ;
F_140 ( & V_11 -> V_209 , F_100 ) ;
V_11 -> V_4 . V_166 = & V_314 ;
V_11 -> V_4 . V_164 = F_141 ( V_119 ) ;
if ( ! V_147 -> V_315 && ! V_315 )
V_11 -> V_4 . V_183 = V_36 ;
else
...
if ( F_143 ( V_119 , V_270 , & F_113 , 0 ,
F_141 ( V_119 ) , V_11 ) < 0 ) {
F_34 ( V_119 , L_48 , V_270 ) ;
goto V_317;
}
for ( V_37 = 0 ; V_37 < V_40 ; V_37 ++ ) {
V_270 = F_142 ( V_308 , V_37 + 1 ) ;
if ( V_270 < 0 ) {
F_34 ( V_119 , L_49 , V_37 + 1 ) ;
goto V_317;
}
if ( F_143 ( V_119 , V_270 , & F_117 , 0 ,
...
static int F_145 ( struct V_307 * V_308 )
{
struct V_1 * V_11 = F_146 ( V_308 ) ;
F_132 ( V_11 ) ;
F_147 ( & V_11 -> V_4 ) ;
F_62 ( V_11 -> V_195 ) ;
F_50 ( V_11 ) ;
