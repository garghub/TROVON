...
int V_87 ;
F_27 ( V_63 ) ;
V_6 = F_34 ( & V_63 -> V_67 , sizeof( * V_6 ) , V_88 ) ;
if ( ! V_6 )
return - V_89 ;
V_86 = F_35 ( V_63 , V_90 , 0 ) ;
V_6 -> V_14 = F_36 ( & V_63 -> V_67 , V_86 ) ;
if ( F_37 ( V_6 -> V_14 ) )
...
V_6 -> V_14 + V_92 ,
V_6 -> V_14 + V_93 , NULL ,
V_6 -> V_14 + V_94 , NULL , 0 ) ;
if ( V_87 )
goto V_95;
V_6 -> V_13 . V_4 . V_96 = F_30 ;
V_6 -> V_13 . V_4 . V_14 = ( V_63 -> V_97 < 0 ) ? F_43 ( V_83 , L_7 ) * 32 :
V_63 -> V_97 * 32 ;
