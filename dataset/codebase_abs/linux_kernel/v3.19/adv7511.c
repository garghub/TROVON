...
V_139 & 0xff ) ;
V_81 = ! ( V_134 -> V_110 & V_147 ) ;
V_82 = ! ( V_134 -> V_110 & V_148 ) ;
} else {
enum V_149 V_150 ;
enum V_149 V_151 ;
if ( V_134 -> V_110 & V_152 )
V_150 = V_153 ;
else
V_150 = V_154 ;
if ( V_134 -> V_110 & V_155 )
V_151 = V_153 ;
else
V_151 = V_154 ;
if ( V_1 -> V_81 != V_150 &&
...
if ( V_38 -> V_157 <= 24000 )
V_135 = V_158 ;
else if ( V_38 -> V_157 <= 25000 )
V_135 = V_159 ;
else if ( V_38 -> V_157 <= 30000 )
V_135 = V_160 ;
else
V_135 = V_161 ;
F_10 ( V_1 -> V_26 , 0xfb ,
...
F_10 ( V_1 -> V_26 , 0x17 ,
0x60 , ( V_82 << 6 ) | ( V_81 << 5 ) ) ;
V_1 -> V_162 = V_38 -> clock ;
}
static int F_47 ( struct V_163 * V_164 ,
struct V_64 * V_35 )
{
const char * V_165 ;
int V_84 ;
memset ( V_35 , 0 , sizeof( * V_35 ) ) ;
F_48 ( V_164 , L_1 , & V_35 -> V_69 ) ;
if ( V_35 -> V_69 != 8 && V_35 -> V_69 != 10 &&
V_35 -> V_69 != 12 )
return - V_101 ;
V_84 = F_49 ( V_164 , L_2 , & V_165 ) ;
if ( V_84 < 0 )
return V_84 ;
if ( ! strcmp ( V_165 , L_3 ) )
V_35 -> V_70 = V_47 ;
...
if ( V_35 -> V_70 == V_55 ||
V_35 -> V_71 != V_166 ) {
V_84 = F_48 ( V_164 , L_10 ,
& V_35 -> V_76 ) ;
if ( V_84 )
return V_84 ;
if ( V_35 -> V_76 < 1 || V_35 -> V_76 > 3 )
return - V_101 ;
V_84 = F_49 ( V_164 , L_11 ,
& V_165 ) ;
if ( V_84 < 0 )
return V_84 ;
...
F_48 ( V_164 , L_15 , & V_35 -> V_66 ) ;
if ( V_35 -> V_66 < - 1200 || V_35 -> V_66 > 1600 )
return - V_101 ;
V_35 -> V_73 = F_50 ( V_164 , L_16 ) ;
V_35 -> V_80 = V_170 ;
V_35 -> V_82 = V_156 ;
V_35 -> V_81 = V_156 ;
return 0 ;
}
static int F_51 ( struct V_171 * V_172 , const struct V_173 * V_174 )
{
struct V_64 V_175 ;
struct V_1 * V_1 ;
...
if ( ! V_6 -> V_176 )
return - V_101 ;
V_1 = F_52 ( V_6 , sizeof( * V_1 ) , V_177 ) ;
if ( ! V_1 )
return - V_178 ;
V_1 -> V_115 = V_179 ;
V_1 -> V_103 = V_125 ;
V_84 = F_47 ( V_6 -> V_176 , & V_175 ) ;
if ( V_84 )
return V_84 ;
V_1 -> V_180 = F_53 ( V_6 , L_17 , V_181 ) ;
if ( F_54 ( V_1 -> V_180 ) )
return F_55 ( V_1 -> V_180 ) ;
if ( V_1 -> V_180 ) {
F_56 ( 5 ) ;
F_57 ( V_1 -> V_180 , 0 ) ;
}
V_1 -> V_26 = F_58 ( V_172 , & V_182 ) ;
if ( F_54 ( V_1 -> V_26 ) )
...
return V_84 ;
F_59 ( V_6 , L_18 , V_123 ) ;
V_84 = F_60 ( V_1 -> V_26 , V_183 ,
F_34 ( V_183 ) ) ;
if ( V_84 )
return V_84 ;
F_12 ( V_1 -> V_26 , V_184 , V_185 ) ;
F_12 ( V_1 -> V_26 , V_186 ,
V_187 ) ;
F_12 ( V_1 -> V_26 , V_188 , V_189 ) ;
F_15 ( V_1 , 0xffff ) ;
V_1 -> V_93 = V_172 ;
V_1 -> V_109 = F_61 ( V_172 -> V_113 , V_185 >> 1 ) ;
if ( ! V_1 -> V_109 )
return - V_178 ;
if ( V_172 -> V_86 ) {
F_62 ( & V_1 -> V_88 ) ;
V_84 = F_63 ( V_6 , V_172 -> V_86 , NULL ,
F_24 ,
V_190 , F_64 ( V_6 ) ,
V_1 ) ;
if ( V_84 )
...
{
struct V_1 * V_1 = F_68 ( V_172 ) ;
F_66 ( V_1 -> V_109 ) ;
F_37 ( V_1 -> V_40 ) ;
return 0 ;
}
static int F_69 ( struct V_171 * V_172 , struct V_194 * V_6 ,
struct V_195 * V_3 )
{
struct V_1 * V_1 = F_68 ( V_172 ) ;
V_3 -> V_4 = V_1 ;
