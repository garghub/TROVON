...
V_45 . V_63 = 1 ;
V_45 . V_64 = 1 ;
F_113 ( V_2 , V_401 , V_427 -> V_280 , & V_45 , V_409 ) ;
...
V_45 = F_8 ( V_2 , V_401 , V_61 , V_430 -> V_297 ) ;
F_116 ( V_2 , V_45 , & V_430 -> V_433 ) ;
break;
case V_435 :
V_430 -> V_433 = * F_111 ( V_2 , V_401 , V_430 -> V_297 ) ;
break;
default:
return - V_57 ;
}
...
V_45 = F_8 ( V_2 , V_401 , V_61 , V_430 -> V_297 ) ;
F_116 ( V_2 , V_45 , & V_430 -> V_433 ) ;
* F_111 ( V_2 , V_401 , V_430 -> V_297 ) = V_430 -> V_433 ;
V_45 = F_8 ( V_2 , V_401 , V_318 , V_430 -> V_297 ) ;
F_113 ( V_2 , V_401 , V_318 , V_45 , V_430 -> V_297 ) ;
return 0 ;
}
...
static int F_126 ( struct V_450 * V_203 ,
const struct V_279 * V_451 ,
const struct V_279 * V_452 , T_3 V_110 )
{
struct V_270 * V_395 = F_69 ( V_203 ) ;
struct V_1 * V_2 = F_102 ( V_395 ) ;
struct V_3 * V_4 = F_2 ( V_2 ) ;
switch ( V_451 -> V_296 | F_127 ( V_452 -> V_203 ) ) {
case V_61 | V_453 :
if ( ! ( V_110 & V_454 ) ) {
V_2 -> V_225 = V_455 ;
break;
...
if ( V_2 -> V_225 != V_455 )
return - V_103 ;
if ( V_452 -> V_203 == & V_4 -> V_456 . V_202 . V_203 )
V_2 -> V_225 = V_457 ;
else if ( V_452 -> V_203 == & V_4 -> V_458 . V_202 . V_203 )
V_2 -> V_225 = V_459 ;
else if ( V_452 -> V_203 == & V_4 -> V_460 . V_202 . V_203 )
V_2 -> V_225 = V_461 ;
else
V_2 -> V_225 = V_243 ;
break;
...
struct V_450 * V_465 = & V_395 -> V_203 ;
int V_120 ;
V_2 -> V_225 = V_455 ;
F_135 ( V_395 , & V_466 ) ;
V_395 -> V_467 = & V_468 ;
F_136 ( V_395 -> V_469 , L_17 , sizeof( V_395 -> V_469 ) ) ;
V_395 -> V_470 = 1 << 16 ;
F_137 ( V_395 , V_2 ) ;
V_395 -> V_110 |= V_471 | V_472 ;
V_287 [ V_61 ] . V_110 = V_473
| V_474 ;
V_287 [ V_210 ] . V_110 = V_475 ;
V_287 [ V_318 ] . V_110 = V_475 ;
V_465 -> V_476 = & V_477 ;
V_120 = F_138 ( V_465 , V_478 , V_287 , 0 ) ;
if ( V_120 < 0 )
return V_120 ;
F_125 ( V_395 , NULL ) ;
V_2 -> V_329 . type = V_479 ;
V_2 -> V_329 . V_476 = & V_480 ;
V_2 -> V_329 . V_4 = F_2 ( V_2 ) ;
V_2 -> V_329 . V_481 = F_139 ( 4096 * 4096 ) * 3 ;
V_2 -> V_329 . V_482 = 32 ;
