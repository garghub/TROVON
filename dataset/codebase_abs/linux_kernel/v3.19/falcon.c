...
V_284 [ V_521 ] +
V_284 [ V_522 ] ;
V_504 -> V_523 = V_284 [ V_524 ] ;
V_504 -> V_525 =
V_284 [ V_526 ] +
V_284 [ V_527 ] ;
V_504 -> V_528 = V_284 [ V_529 ] ;
V_504 -> V_530 = V_284 [ V_531 ] ;
V_504 -> V_532 = V_284 [ V_533 ] ;
V_504 -> V_534 = ( V_504 -> V_525 +
V_504 -> V_528 +
V_504 -> V_530 +
V_284 [ V_535 ] ) ;
}
...
static void F_198 ( struct V_3 * V_4 , enum V_536 V_537 )
{
F_159 ( V_4 ) -> type -> V_538 ( V_4 , V_537 ) ;
}
static void F_199 ( struct V_3 * V_4 , struct V_539 * V_540 )
{
V_540 -> V_541 = 0 ;
V_540 -> V_542 = 0 ;
memset ( & V_540 -> V_543 , 0 , sizeof( V_540 -> V_543 ) ) ;
}
static int F_200 ( struct V_3 * V_4 , T_10 type )
{
if ( type != 0 )
return - V_65 ;
return 0 ;
