...
static void F_9 ( struct V_46 * V_26 , int V_63 ,
...
static void F_11 ( struct V_46 * V_26 , int V_63 ,
T_1 V_64 , T_1 V_34 , T_1 V_65 ,
T_1 V_66 )
{
struct V_1 * V_2 = F_5 ( V_26 ) ;
...
static void F_13 ( struct V_46 * V_26 , int V_63 ,
T_1 * V_64 , T_1 * V_34 , T_1 * V_65 ,
T_1 * V_66 )
{
struct V_1 * V_2 = F_5 ( V_26 ) ;
...
static void F_15 ( struct V_46 * V_26 , int V_63 ,
T_1 * V_64 , T_1 * V_34 , T_1 * V_65 ,
T_1 * V_66 )
{
struct V_1 * V_2 = F_5 ( V_26 ) ;
...
static void F_17 ( struct V_46 * V_26 , int V_68 ,
T_1 V_69 )
{
struct V_1 * V_2 = F_5 ( V_26 ) ;
...
static void F_19 ( struct V_46 * V_70 )
{
struct V_1 * V_2 = F_5 ( V_70 ) ;
while ( F_20 ( V_71 , & V_2 -> V_49 ) )
F_21 ( 1000 , 2000 ) ;
if ( F_22 ( V_70 ) )
V_70 -> V_72 -> V_73 ( V_70 ) ;
F_23 ( V_2 ) ;
...
F_31 ( V_8 , V_15 , V_32 ) ;
F_32 ( V_8 , V_15 , V_82 ) ;
F_33 ( V_57 , V_80 , V_81 , V_34 ,
V_32 , V_82 ) ;
for ( V_12 = 0 ; V_12 < V_91 ; V_12 ++ )
F_34 ( V_26 , V_12 , V_82 [ V_12 ] ) ;
V_76 = V_92 ;
}
if ( V_2 -> V_78 & V_37 ) {
if ( V_8 -> V_45 ) {
...
static T_1 F_39 ( struct V_46 * V_26 , int V_97 , T_1 * V_98 )
{
struct V_1 * V_2 = F_5 ( V_26 ) ;
switch ( V_97 ) {
case V_99 :
...
static int F_40 ( struct V_46 * V_26 , int V_107 , T_1 * V_108 )
{
struct V_1 * V_2 = F_5 ( V_26 ) ;
if ( V_2 -> V_47 & V_48 ) {
switch ( V_107 ) {
...
static int F_44 ( struct V_46 * V_26 , T_1 V_113 , T_2 V_114 )
{
struct V_1 * V_2 = F_5 ( V_26 ) ;
struct V_19 V_20 = {
. V_21 = V_113 ,
...
static int F_45 ( struct V_46 * V_70 ,
struct V_115 * V_116 )
{
struct V_1 * V_2 = F_5 ( V_70 ) ;
...
return - V_112 ;
if ( ! V_2 -> V_118 ) {
V_2 -> V_118 = F_47 ( sizeof( struct V_115 ) ,
V_128 ) ;
if ( ! V_2 -> V_118 )
return - V_129 ;
for ( V_12 = 0 ; V_12 < V_91 ; V_12 ++ )
...
return - V_112 ;
if ( V_125 != F_49 ( V_70 ) ) {
V_124 = F_7 ( V_70 , V_125 ) ;
if ( V_124 )
return V_124 ;
} else if ( V_126 ) {
F_19 ( V_70 ) ;
}
return F_50 ( & V_2 -> V_57 , V_116 , V_84 ) ;
}
static int F_51 ( struct V_46 * V_70 ,
struct V_130 * V_131 )
{
struct V_1 * V_2 = F_5 ( V_70 ) ;
...
return - V_112 ;
if ( ! V_2 -> V_133 ) {
V_2 -> V_133 = F_47 ( sizeof( struct V_130 ) ,
V_128 ) ;
if ( ! V_2 -> V_133 )
return - V_129 ;
}
...
if ( V_131 -> V_93 )
V_124 = F_36 ( V_57 , V_131 -> V_93 , V_82 ) ;
else
...
if ( ! ( V_2 -> V_50 & V_127 ) )
return - V_112 ;
V_124 = F_54 ( V_70 , V_20 ) ;
if ( V_124 )
return V_124 ;
#ifdef F_2
if ( V_20 -> V_21 == V_142 &&
V_20 -> V_23 == V_24 ) {
T_1 V_143 = F_55 ( V_70 , V_20 ) ;
if ( V_143 & ( 1 << V_2 -> V_27 . V_25 ) )
return 0 ;
...
if ( ! V_148 -> V_149 )
F_56 ( V_2 , V_148 -> V_150 ,
V_20 -> V_68 , V_144 ) ;
}
}
return 0 ;
}
static int F_57 ( struct V_46 * V_70 ,
struct V_19 * V_20 )
{
struct V_1 * V_2 = F_5 ( V_70 ) ;
int V_124 ;
...
int V_144 ;
long unsigned int V_143 = F_55 ( V_70 , V_20 ) ;
int V_152 = V_143 ? F_59 ( & V_143 , 8 ) : 0 ;
V_2 -> V_145 = V_152 ;
for ( V_144 = 0 ; V_144 < V_2 -> V_146 ; V_144 ++ ) {
struct V_147 * V_148 = & V_2 -> V_148 [ V_144 ] ;
if ( ! V_148 -> V_149 )
...
static T_1 F_60 ( struct V_46 * V_70 )
{
struct V_1 * V_2 = F_5 ( V_70 ) ;
return V_2 -> V_50 ;
}
static T_1 F_61 ( struct V_46 * V_70 , T_1 V_153 )
{
struct V_1 * V_2 = F_5 ( V_70 ) ;
