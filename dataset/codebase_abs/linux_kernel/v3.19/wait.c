...
T_3 int F_69 ( struct V_29 * V_35 )
{
unsigned long V_47 = F_70 ( V_37 ) ;
if ( F_26 ( V_18 -> V_17 , V_18 ) )
return 1 ;
if ( F_71 ( V_47 , V_35 -> V_26 ) )
return - V_48 ;
F_37 ( V_35 -> V_26 - V_47 ) ;
return 0 ;
}
T_3 int F_72 ( struct V_29 * V_35 )
{
unsigned long V_47 = F_70 ( V_37 ) ;
if ( F_26 ( V_18 -> V_17 , V_18 ) )
return 1 ;
