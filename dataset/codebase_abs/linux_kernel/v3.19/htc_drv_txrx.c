...
F_20 ( V_41 , V_250 ) ;
V_70 = (struct V_69 * ) V_41 -> V_46 ;
if ( V_222 . V_232 & V_254 ) {
if ( F_109 ( & V_8 -> V_255 , V_70 ,
& V_222 , V_247 -> V_252 ) ) {
}
goto V_251;
}
if ( ! F_110 ( V_29 , V_70 , V_247 , & V_222 ,
& V_249 , V_8 -> V_198 ) )
goto V_251;
F_111 ( V_29 , V_41 , & V_222 ,
V_247 , V_249 ) ;
if ( F_112 ( V_29 , V_15 , & V_222 , V_247 ) )
goto V_251;
V_222 . V_256 = F_113 ( V_29 , V_70 ) ;
F_114 ( V_29 , V_15 , & V_222 , V_247 ) ;
V_247 -> V_159 = V_30 -> V_257 -> V_158 -> V_159 ;
V_247 -> V_258 = V_30 -> V_257 -> V_158 -> V_259 ;
V_247 -> V_260 = V_222 . V_237 ;
V_247 -> V_225 |= V_261 ;
return true ;
V_251:
return false ;
...
{
struct V_7 * V_8 = (struct V_7 * ) V_46 ;
struct V_244 * V_245 = NULL , * V_262 = NULL ;
struct V_246 V_247 ;
struct V_40 * V_41 ;
unsigned long V_13 ;
struct V_69 * V_70 ;
do {
F_65 ( & V_8 -> V_263 . V_264 , V_13 ) ;
...
V_41 = V_245 -> V_41 ;
V_70 = (struct V_69 * ) V_41 -> V_46 ;
if ( F_118 ( V_70 -> V_72 ) && V_8 -> V_267 )
F_119 ( V_8 -> V_15 , & V_8 -> V_268 ) ;
F_68 ( & V_8 -> V_263 . V_264 , V_13 ) ;
F_120 ( V_8 -> V_15 , V_41 ) ;
F_65 ( & V_8 -> V_263 . V_264 , V_13 ) ;
V_266:
V_245 -> V_265 = false ;
V_245 -> V_41 = NULL ;
F_121 ( & V_245 -> V_170 , & V_8 -> V_263 . V_245 ) ;
V_245 = NULL ;
F_68 ( & V_8 -> V_263 . V_264 , V_13 ) ;
} while ( 1 );
}
...
F_73 ( & V_8 -> V_263 . V_264 ) ;
if ( V_245 == NULL ) {
F_37 ( V_29 , V_269 , L_11 ) ;
goto V_270;
}
F_71 ( & V_8 -> V_263 . V_264 ) ;
V_245 -> V_41 = V_41 ;
...
{
int V_178 = 0 ;
F_125 ( & V_8 -> V_263 . V_245 ) ;
F_126 ( & V_8 -> V_263 . V_264 ) ;
for ( V_178 = 0 ; V_178 < V_273 ; V_178 ++ ) {
struct V_244 * V_245 =
F_70 ( sizeof( struct V_244 ) , V_274 ) ;
if ( V_245 == NULL )
goto V_270;
F_72 ( & V_245 -> V_170 , & V_8 -> V_263 . V_245 ) ;
}
return 0 ;
V_270:
F_123 ( V_8 ) ;
