...
static int F_50 ( struct V_2 * V_4 , enum V_99 V_100 ,
unsigned long V_101 )
{
struct V_1 * V_3 = F_1 ( V_4 ) ;
int V_52 ;
...
{
while ( ! F_52 ( & V_6 -> V_105 . V_106 ) ) {
struct V_1 * V_107 ;
V_107 = F_53 ( & V_6 -> V_105 . V_106 ,
struct V_1 , V_4 . V_108 ) ;
F_54 ( & V_107 -> V_4 . V_108 ) ;
F_55 ( V_107 ) ;
}
}
static int F_56 ( struct V_109 * V_110 , struct V_5 * V_6 )
{
struct V_1 * V_107 ;
int V_22 ;
int V_52 ;
T_1 V_111 ;
V_52 = F_57 ( V_110 -> V_112 , L_2 ,
& V_111 ) ;
if ( V_52 )
return V_52 ;
V_111 *= 2 ;
for ( V_22 = 0 ; V_22 < V_111 ; V_22 ++ ) {
V_107 = F_58 ( sizeof( * V_107 ) , V_113 ) ;
if ( ! V_107 )
goto V_114;
V_107 -> V_6 = V_6 ;
if ( V_22 & 1 ) {
...
V_107 -> V_47 = V_6 -> V_115 + F_60 ( V_22 >> 1 ) ;
V_107 -> V_46 = 0 ;
}
V_107 -> V_97 = V_22 >> 1 ;
...
F_61 ( & V_107 -> V_4 . V_108 , & V_6 -> V_105 . V_106 ) ;
}
V_6 -> V_87 = V_111 ;
return 0 ;
V_114:
...
static void F_62 ( struct V_109 * V_110 , struct V_5 * V_6 )
{
unsigned int V_117 ;
int V_22 ;
...
F_5 ( 0 , V_6 -> V_18 + F_64 ( V_22 ) ) ;
F_65 ( V_110 , V_117 , V_6 -> V_86 ,
V_6 -> V_12 ) ;
}
}
...
static void F_67 ( struct V_109 * V_110 , struct V_5 * V_6 )
{
F_66 ( V_6 ) ;
F_62 ( V_110 , V_6 ) ;
F_5 ( 0 , V_6 -> V_18 + V_121 ) ;
F_5 ( 0 , V_6 -> V_18 + V_121 ) ;
F_65 ( V_110 , V_122 , V_6 -> V_123 ,
V_6 -> V_124 ) ;
}
static int F_68 ( struct V_109 * V_110 , struct V_5 * V_6 )
{
unsigned int V_125 ;
unsigned int V_117 ;
int V_22 ;
T_1 V_55 ;
T_1 V_126 ;
F_69 ( sizeof( struct V_10 ) &
( sizeof( struct V_10 ) - 1 ) ) ;
F_69 ( sizeof( struct V_10 ) < 32 ) ;
F_69 ( V_11 < 32 ) ;
...
for ( V_22 = 0 ; V_22 < V_118 ; V_22 ++ ) {
V_55 = V_126 << V_127 ;
V_55 |= ( F_70 ( V_125 ) - 5 ) << V_128 ;
V_55 |= F_70 ( V_11 ) - 5 ;
F_69 ( V_118 != 1 ) ;
V_6 -> V_86 = F_71 ( V_110 , V_117 ,
& V_6 -> V_12 , V_113 ) ;
if ( ! V_6 -> V_86 )
return - V_116 ;
F_5 ( V_6 -> V_12 , V_6 -> V_18 + F_63 ( V_22 ) ) ;
F_5 ( V_55 , V_6 -> V_18 + F_64 ( V_22 ) ) ;
V_126 += V_11 ;
}
return 0 ;
}
...
V_55 = F_73 ( V_129 ) ;
V_55 |= F_74 ( V_129 ) | V_131 ;
V_55 |= F_75 ( V_129 + 1 ) ;
V_55 |= F_76 ( V_129 + 1 ) | V_132 ;
F_5 ( V_55 , V_6 -> V_119 + F_77 ( V_130 ) ) ;
V_130 ++ ;
}
V_55 = 15 * 2 * 2 - 1 ;
V_55 |= V_133 ;
...
static int F_78 ( struct V_109 * V_110 , struct V_5 * V_6 )
{
int V_52 ;
F_69 ( V_122 > ( ( 1 << 14 ) - 1 ) ) ;
V_6 -> V_123 = F_71 ( V_110 , V_122 ,
& V_6 -> V_124 , V_113 ) ;
if ( ! V_6 -> V_123 )
return - V_116 ;
...
static bool F_79 ( struct V_2 * V_4 , void * V_138 )
{
struct V_1 * V_107 ;
struct V_5 * V_6 ;
...
V_140 = V_6 -> V_146 ;
F_69 ( F_80 ( V_147 ) != F_80 ( V_148 ) ) ;
if ( F_18 ( V_107 -> V_97 > F_80 ( V_147 ) ) )
return false ;
V_107 -> V_29 = V_140 [ V_107 -> V_97 ] . V_90 ;
V_107 -> V_59 = V_140 [ V_107 -> V_97 ] . V_95 ;
return true ;
}
static struct V_2 * F_81 ( struct V_149 * V_150 ,
struct V_151 * V_152 )
{
...
if ( V_153 != 2 )
return NULL ;
return F_82 ( V_156 -> V_159 , V_156 -> V_158 ,
& V_150 -> args [ 0 ] ) ;
}
static const struct V_160 * F_83 ( struct V_109 * V_110 )
{
const struct V_161 * V_162 ;
V_162 = F_84 ( V_163 , V_110 -> V_112 ) ;
if ( ! V_162 )
return NULL ;
return V_162 -> V_20 ;
}
...
if ( ! V_166 )
return - V_167 ;
V_6 = F_86 ( & V_165 -> V_110 , sizeof( * V_6 ) , V_113 ) ;
if ( ! V_6 )
return - V_116 ;
F_87 ( V_168 , V_6 -> V_105 . V_169 ) ;
V_6 -> V_105 . V_170 = F_23 ;
V_6 -> V_105 . V_171 = F_26 ;
V_6 -> V_105 . V_172 = F_27 ;
V_6 -> V_105 . V_173 = F_31 ;
V_6 -> V_105 . V_174 = F_40 ;
V_6 -> V_105 . V_175 = F_50 ;
V_6 -> V_105 . V_110 = V_110 ;
F_88 ( & V_6 -> V_105 . V_106 ) ;
V_176 . V_159 = V_6 -> V_105 . V_169 ;
V_6 -> V_23 = F_89 ( V_110 -> V_112 , 0 ) ;
V_6 -> V_115 = F_89 ( V_110 -> V_112 , 1 ) ;
V_6 -> V_119 = F_89 ( V_110 -> V_112 , 2 ) ;
V_6 -> V_18 = F_89 ( V_110 -> V_112 , 3 ) ;
...
if ( V_52 )
goto V_179;
V_19 = F_92 ( V_110 -> V_112 , 0 ) ;
if ( ! V_19 ) {
V_52 = - V_167 ;
goto V_180;
}
F_5 ( V_25 , V_6 -> V_23 + V_181 ) ;
V_52 = F_93 ( & V_165 -> V_110 , V_19 , V_166 -> V_182 , V_183 ,
F_94 ( V_110 ) , V_6 ) ;
if ( V_52 )
goto V_180;
V_6 -> V_19 = V_19 ;
...
{
struct V_5 * V_6 = F_103 ( V_165 ) ;
F_104 ( V_165 -> V_110 . V_112 ) ;
F_98 ( & V_6 -> V_105 ) ;
F_5 ( 0 , V_6 -> V_23 + V_186 ) ;
F_105 ( & V_165 -> V_110 , V_6 -> V_19 , V_6 ) ;
F_51 ( V_6 ) ;
F_67 ( & V_165 -> V_110 , V_6 ) ;
F_101 ( V_6 -> V_23 ) ;
F_101 ( V_6 -> V_115 ) ;
F_101 ( V_6 -> V_119 ) ;
F_101 ( V_6 -> V_18 ) ;
...
{
struct V_5 * V_6 = F_107 ( V_110 ) ;
V_6 -> V_187 = F_7 ( V_6 -> V_115 + V_137 ) ;
F_5 ( 0 , V_6 -> V_23 + V_186 ) ;
F_66 ( V_6 ) ;
return 0 ;
}
static int F_108 ( struct V_109 * V_110 )
{
struct V_5 * V_6 = F_107 ( V_110 ) ;
struct V_1 * V_3 ;
int V_22 ;
for ( V_22 = 0 ; V_22 < V_118 ; V_22 ++ )
F_5 ( V_6 -> V_12 , V_6 -> V_18 + F_63 ( V_22 ) ) ;
F_109 (c, &cdd->ddev.channels, chan.device_node)
if ( ! V_3 -> V_46 )
F_5 ( V_3 -> V_29 , V_3 -> V_47 + V_48 ) ;
F_72 ( V_6 ) ;
