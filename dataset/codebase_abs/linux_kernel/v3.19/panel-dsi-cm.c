...
V_141 = F_73 ( & V_48 -> V_49 ) ;
V_12 = F_74 ( V_141 -> V_142 ) ;
if ( V_12 == NULL ) {
F_22 ( & V_48 -> V_49 , L_31 ) ;
return - V_143 ;
}
...
V_2 -> V_46 = - 1 ;
V_2 -> V_41 = V_141 -> V_41 ;
V_2 -> V_145 = V_141 -> V_145 ;
V_2 -> V_94 = V_141 -> V_94 ;
V_66 = & V_2 -> V_66 ;
V_66 -> V_146 = V_141 -> V_146 ;
return 0 ;
}
static int F_75 ( struct V_76 * V_48 )
{
struct V_147 * V_148 = V_48 -> V_49 . V_149 ;
struct V_1 * V_2 = F_36 ( V_48 ) ;
struct V_11 * V_12 ;
int V_150 ;
V_150 = F_76 ( V_148 , L_32 , 0 ) ;
if ( ! F_19 ( V_150 ) ) {
F_22 ( & V_48 -> V_49 , L_33 ) ;
return V_150 ;
}
V_2 -> V_83 = V_150 ;
V_150 = F_76 ( V_148 , L_34 , 0 ) ;
if ( F_19 ( V_150 ) || V_150 == - V_151 ) {
V_2 -> V_46 = V_150 ;
} else {
F_22 ( & V_48 -> V_49 , L_35 ) ;
return V_150 ;
...
static int F_80 ( struct V_76 * V_48 )
{
struct V_152 V_56 ;
struct V_1 * V_2 ;
struct V_54 * V_153 = NULL ;
struct V_73 * V_49 = & V_48 -> V_49 ;
struct V_11 * V_66 ;
int V_13 ;
F_29 ( V_49 , L_36 ) ;
V_2 = F_81 ( V_49 , sizeof( * V_2 ) , V_154 ) ;
if ( ! V_2 )
return - V_135 ;
F_82 ( V_48 , V_2 ) ;
V_2 -> V_48 = V_48 ;
...
if ( F_19 ( V_2 -> V_46 ) ) {
V_13 = F_85 ( V_49 , V_2 -> V_46 ,
V_167 , L_40 ) ;
if ( V_13 ) {
F_22 ( V_49 , L_41 ) ;
return V_13 ;
}
V_13 = F_86 ( V_49 , F_21 ( V_2 -> V_46 ) ,
F_57 ,
V_168 ,
L_42 , V_2 ) ;
if ( V_13 ) {
...
F_43 ( V_2 ) ;
if ( V_2 -> V_145 ) {
memset ( & V_56 , 0 , sizeof( struct V_152 ) ) ;
V_56 . V_169 = 255 ;
V_56 . type = V_170 ;
V_153 = F_90 ( F_91 ( V_49 ) ,
V_49 , V_2 , & V_171 , & V_56 ) ;
if ( F_78 ( V_153 ) ) {
V_13 = F_79 ( V_153 ) ;
goto V_172;
...
V_2 -> V_153 = V_153 ;
V_153 -> V_56 . V_57 = V_58 ;
V_153 -> V_56 . V_59 = V_58 ;
V_153 -> V_56 . V_60 = 255 ;
F_27 ( V_153 ) ;
}
V_13 = F_92 ( & V_49 -> V_173 , & V_174 ) ;
if ( V_13 ) {
F_22 ( V_49 , L_47 ) ;
goto V_175;
}
...
static int T_6 F_95 ( struct V_76 * V_48 )
{
struct V_1 * V_2 = F_36 ( V_48 ) ;
struct V_11 * V_66 = & V_2 -> V_66 ;
struct V_54 * V_153 ;
...
F_55 ( V_66 ) ;
F_52 ( V_66 ) ;
F_97 ( & V_48 -> V_49 . V_173 , & V_174 ) ;
V_153 = V_2 -> V_153 ;
if ( V_153 != NULL ) {
V_153 -> V_56 . V_59 = V_176 ;
F_27 ( V_153 ) ;
F_93 ( V_153 ) ;
}
F_98 ( V_2 -> V_12 ) ;
