...
goto V_65;
if ( V_88 -> V_95 ) {
F_59 ( struct V_50 * , V_96 , V_88 -> V_95 ) ;
V_73 = - V_55 ;
...
V_73 = - V_102 ;
V_16 = F_60 ( V_3 , 2 + V_103 + sizeof( struct V_35 ) +
4 + V_31 , 0 , V_104 ) ;
if ( ! V_16 )
goto error;
F_61 ( V_16 , 2 + V_103 ) ;
F_62 ( V_16 ) ;
F_61 ( V_16 , sizeof( struct V_35 ) ) ;
F_63 ( V_16 ) ;
* ( ( T_1 * ) F_64 ( V_16 , 4 ) ) = 0 ;
V_73 = F_65 ( F_64 ( V_16 , V_31 ) , V_88 , V_31 ) ;
if ( V_73 < 0 ) {
F_27 ( V_16 ) ;
goto error;
}
V_92 = & V_9 -> V_105 . V_106 . V_107 . V_108 ;
if ( V_93 )
V_90 = (struct V_89 * ) F_66 ( V_3 , 0 ) ;
F_67 () ;
if ( V_90 == NULL ) {
const struct V_109 * V_110 ;
V_110 = F_68 ( V_9 -> V_110 ) ;
if ( V_110 && V_110 -> V_111 . V_112 )
V_38 = V_110 -> V_111 . V_113 ;
...
F_73 ( V_16 , & V_90 -> V_117 ) ;
goto V_118;
}
}
F_74 ( V_16 , & V_90 -> V_117 ) ;
V_118:
V_73 = F_75 ( V_3 , V_16 , & V_9 -> V_105 . V_106 ) ;
F_76 () ;
error:
if ( V_73 >= 0 )
V_73 = V_31 ;
...
static int F_77 ( struct V_85 * V_86 , struct V_2 * V_3 , struct V_87 * V_88 ,
T_3 V_31 , int V_121 , int V_75 , int * V_49 )
{
struct V_8 * V_9 = F_4 ( V_3 ) ;
T_3 V_122 = 0 ;
int V_123 = - V_124 ;
...
if ( V_75 & V_126 )
goto V_65;
V_16 = F_78 ( V_3 , V_75 , V_121 , & V_123 ) ;
if ( ! V_16 )
goto V_65;
V_122 = V_16 -> V_31 ;
if ( V_31 < V_122 ) {
...
V_123 = F_79 ( V_16 , 0 , V_88 , V_122 ) ;
if ( V_123 )
goto V_129;
F_80 ( V_88 , V_3 , V_16 ) ;
if ( sin ) {
sin -> V_130 = V_57 ;
sin -> V_131 . V_60 = F_81 ( V_16 ) -> V_132 ;
sin -> V_133 = 0 ;
memset ( & sin -> V_134 , 0 , sizeof( sin -> V_134 ) ) ;
* V_49 = sizeof( * sin ) ;
}
if ( V_9 -> V_135 )
F_82 ( V_88 , V_16 ) ;
