...
if ( V_46 < 0 )
goto V_249;
V_229 = F_110 ( & V_2 -> V_39 , V_224 ,
V_221 -> V_250 , NULL ) ;
if ( ! V_229 ) {
V_46 = - V_208 ;
goto V_251;
}
V_46 = F_111 ( V_34 , V_252 , - 1 ) ;
if ( V_46 < 0 )
goto V_253;
return 0 ;
V_253:
...
struct V_254 * V_39 = F_119 ( V_220 ) ;
struct V_1 * V_2 = F_120 ( V_39 ,
struct V_1 , V_39 ) ;
struct V_228 * V_255 = F_72 ( V_39 -> V_256 . V_59 ,
struct V_228 , V_257 ) ;
struct V_258 * V_259 = F_121 ( V_255 ) ;
struct V_225 * V_226 ;
if ( V_184 > 0 )
F_115 ( V_184 , V_2 ) ;
F_113 ( & V_220 -> V_40 ) ;
