...
{
struct V_82 * V_67 , * V_61 ;
struct V_8 * V_9 ;
void T_1 * V_18 ;
struct V_83 V_84 ;
void * V_85 [ 1 ] ;
V_67 = F_26 ( V_81 , V_86 , 0 ) ;
V_18 = F_27 ( & V_81 -> V_24 , V_67 ) ;
if ( F_28 ( V_18 ) )
return F_29 ( V_18 ) ;
V_61 = F_26 ( V_81 , V_86 , 1 ) ;
if ( ! V_61 || ! V_61 -> V_62 )
return - V_87 ;
V_9 = F_30 ( & V_81 -> V_24 ,
sizeof( struct V_8 ) , V_88 ) ;
if ( ! V_9 )
return - V_89 ;
V_9 -> V_61 = * V_61 ;
V_9 -> V_79 . V_62 = V_9 -> V_61 . V_62 ;
V_9 -> V_79 . V_90 = V_9 -> V_61 . V_90 ;
V_9 -> V_79 . V_91 = V_92 ;
V_9 -> V_67 = V_67 ;
V_9 -> V_26 = F_31 ( V_81 , 0 ) ;
V_9 -> V_18 = V_18 ;
V_9 -> V_24 = & V_81 -> V_24 ;
if ( V_9 -> V_26 < 0 ) {
F_15 ( & V_81 -> V_24 , L_6 ) ;
...
struct V_82 V_13 ;
int V_33 ;
V_33 = F_32 ( V_81 -> V_24 . V_93 , & V_13 ) ;
if ( V_33 < 0 ) {
F_15 ( & V_81 -> V_24 , L_7 ) ;
return V_33 ;
}
V_9 -> V_13 = V_13 . V_62 ;
if ( V_13 . V_90 != V_13 . V_62 )
F_33 ( & V_81 -> V_24 , L_8 ) ;
} else {
V_9 -> V_13 = V_81 -> V_94 ;
}
