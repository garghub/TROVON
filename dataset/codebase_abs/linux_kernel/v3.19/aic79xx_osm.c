...
int
F_128 ( struct V_1 * V_2 , int V_240 , char V_55 ,
...
F_132 ( V_2 , V_50 . V_55 , V_50 . V_240 ,
V_50 . V_105 , V_250 ) ;
F_133 ( V_2 , & V_50 ) ;
F_2 ( L_47 , V_10 ) ;
} else {
...
int V_18 ;
V_3 -> V_4 -> V_101 = 0 ;
F_137 (cmd, cur_seg, nseg, i) {
T_9 V_271 ;
T_8 V_272 ;
V_271 = F_138 ( V_270 ) ;
V_272 = F_139 ( V_270 ) ;
V_3 -> V_4 -> V_101 += V_272 ;
V_267 = F_140 ( V_2 , V_3 , V_267 , V_271 , V_272 ,
V_18 == ( V_254 - 1 ) ) ;
}
}
...
void
F_132 ( struct V_1 * V_2 , char V_55 ,
...
+ ( F_149 ( V_43 ) ? V_284 : 0 )
+ ( F_150 ( V_43 ) ? V_285 : 0 ) ;
if ( V_52 -> V_112 . V_65 == F_151 ( V_43 )
&& V_52 -> V_112 . V_21 == F_152 ( V_43 )
&& V_52 -> V_112 . V_66 == F_153 ( V_43 )
&& V_52 -> V_112 . V_113 == V_276 )
if ( V_73 == 0 )
break;
F_151 ( V_43 ) = V_52 -> V_112 . V_65 ;
F_152 ( V_43 ) = V_52 -> V_112 . V_21 ;
F_153 ( V_43 ) = V_52 -> V_112 . V_66 ;
F_144 ( V_43 ) = V_52 -> V_112 . V_113 & V_279 ? 1 : 0 ;
F_145 ( V_43 ) = V_52 -> V_112 . V_113 & V_280 ? 1 : 0 ;
F_146 ( V_43 ) = V_52 -> V_112 . V_113 & V_114 ? 1 : 0 ;
F_147 ( V_43 ) = V_52 -> V_112 . V_113 & V_281 ? 1 : 0 ;
F_148 ( V_43 ) = V_52 -> V_112 . V_113 & V_282 ? 1 : 0 ;
F_45 ( V_43 ) = V_52 -> V_112 . V_113 & V_283 ? 1 : 0 ;
F_149 ( V_43 ) = V_52 -> V_112 . V_113 & V_284 ? 1 : 0 ;
F_150 ( V_43 ) = V_52 -> V_112 . V_113 & V_285 ? 1 : 0 ;
F_154 ( V_43 ) ;
break;
}
case V_286 :
...
void
F_158 ( struct V_1 * V_2 , struct V_3 * V_3 )
{
struct V_24 * V_25 ;
struct V_35 * V_36 ;
if ( ( V_3 -> V_47 & V_111 ) == 0 ) {
...
} else if ( F_162 ( V_3 ) == V_297 ) {
F_167 ( V_2 , V_25 -> V_37 , V_3 ) ;
}
if ( V_36 -> V_74 == 1
&& F_162 ( V_3 ) == V_296
&& F_168 ( V_3 ) != V_298 )
...
T_6 V_311 ;
if ( V_3 -> V_47 & V_306 ) {
V_310 = F_172 ( sizeof( struct V_312 )
- F_173 ( V_3 ) ,
( T_14 ) V_313 ) ;
V_311 = 0 ;
} else {
...
static void
F_171 ( struct V_1 * V_2 , struct V_24 * V_25 )
{
int V_243 ;
int V_325 = V_326 ;
int V_327 = 0 ;
...
F_184 (pending_scb, &ahd->pending_scbs, pending_links) {
if ( V_358 -> V_26 == V_25 )
break;
}
if ( V_358 == NULL ) {
...
V_365 = F_188 ( V_2 ) ;
F_189 ( V_2 , V_368 , V_368 ) ;
V_361 = F_8 ( V_2 , V_369 ) ;
V_359 = F_190 ( V_2 ) ;
V_360 = V_359 ;
if ( V_364 && ( F_8 ( V_2 , V_370 ) & V_371 ) == 0 ) {
struct V_3 * V_372 ;
V_372 = F_191 ( V_2 , V_360 ) ;
if ( V_372 == V_358 )
V_364 = FALSE ;
}
V_362 = F_8 ( V_2 , V_373 ) ;
...
static void F_195 ( struct V_42 * V_43 , int V_21 )
{
...
static void F_196 ( struct V_42 * V_43 , int V_65 )
{
struct V_28 * V_385 = F_39 ( V_43 -> V_36 . V_126 ) ;
struct V_1 * V_2 = * ( (struct V_1 * * ) V_385 -> V_32 ) ;
struct V_53 * V_54 ;
...
static void F_198 ( struct V_42 * V_43 , int V_66 )
{
struct V_28 * V_385 = F_39 ( V_43 -> V_36 . V_126 ) ;
struct V_1 * V_2 = * ( (struct V_1 * * ) V_385 -> V_32 ) ;
struct V_53 * V_54 ;
...
static void F_199 ( struct V_42 * V_43 , int V_386 )
{
struct V_28 * V_385 = F_39 ( V_43 -> V_36 . V_126 ) ;
struct V_1 * V_2 = * ( (struct V_1 * * ) V_385 -> V_32 ) ;
struct V_53 * V_54 ;
...
static void F_200 ( struct V_42 * V_43 , int V_391 )
{
struct V_28 * V_385 = F_39 ( V_43 -> V_36 . V_126 ) ;
struct V_1 * V_2 = * ( (struct V_1 * * ) V_385 -> V_32 ) ;
struct V_53 * V_54 ;
...
static void F_201 ( struct V_42 * V_43 , int V_392 )
{
struct V_28 * V_385 = F_39 ( V_43 -> V_36 . V_126 ) ;
struct V_1 * V_2 = * ( (struct V_1 * * ) V_385 -> V_32 ) ;
struct V_53 * V_54 ;
...
static void F_202 ( struct V_42 * V_43 , int V_393 )
{
struct V_28 * V_385 = F_39 ( V_43 -> V_36 . V_126 ) ;
struct V_1 * V_2 = * ( (struct V_1 * * ) V_385 -> V_32 ) ;
struct V_53 * V_54 ;
...
static void F_203 ( struct V_42 * V_43 , int V_394 )
{
struct V_28 * V_385 = F_39 ( V_43 -> V_36 . V_126 ) ;
struct V_1 * V_2 = * ( (struct V_1 * * ) V_385 -> V_32 ) ;
struct V_53 * V_54 ;
...
static void F_204 ( struct V_42 * V_43 , int V_395 )
{
struct V_28 * V_385 = F_39 ( V_43 -> V_36 . V_126 ) ;
struct V_1 * V_2 = * ( (struct V_1 * * ) V_385 -> V_32 ) ;
struct V_53 * V_54 ;
...
static void F_205 ( struct V_42 * V_43 , int V_396 )
{
struct V_28 * V_385 = F_39 ( V_43 -> V_36 . V_126 ) ;
struct V_1 * V_2 = * ( (struct V_1 * * ) V_385 -> V_32 ) ;
struct V_53 * V_54 ;
...
static void F_206 ( struct V_42 * V_43 , int V_397 )
{
struct V_28 * V_385 = F_39 ( V_43 -> V_36 . V_126 ) ;
struct V_1 * V_2 = * ( (struct V_1 * * ) V_385 -> V_32 ) ;
struct V_53 * V_54 ;
...
static void F_207 ( struct V_28 * V_385 )
{
struct V_1 * V_2 = * (struct V_1 * * ) V_385 -> V_32 ;
unsigned long V_47 ;
V_357 V_398 ;
