...
static bool F_38 ( struct V_134 * V_104 , unsigned int V_135 )
{
switch ( V_135 ) {
case V_136 :
case V_137 :
...
const struct V_140 * V_30 )
{
struct V_9 * V_9 ;
int V_141 ;
V_9 = F_40 ( & V_139 -> V_104 , sizeof( * V_9 ) , V_142 ) ;
if ( ! V_9 )
return - V_143 ;
V_9 -> V_14 = F_41 ( V_139 ,
& V_144 ) ;
...
F_20 ( V_9 -> V_14 , V_136 , 0x00 ) ;
F_44 ( & V_139 -> V_104 , V_9 ) ;
V_141 = F_45 ( & V_139 -> V_104 , & V_145 ,
V_146 , F_32 ( V_146 ) ) ;
return V_141 ;
}
