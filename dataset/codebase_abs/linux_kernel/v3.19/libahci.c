...
static T_9 F_124 ( int V_302 , void * V_303 )
{
struct V_13 * V_14 = V_303 ;
struct V_98 * V_99 = V_14 -> V_18 ;
void T_1 * V_22 = F_12 ( V_14 ) ;
T_2 V_186 ;
V_186 = F_125 ( & V_99 -> V_304 , 0 ) ;
if ( ! V_186 )
return V_305 ;
F_126 ( V_14 -> V_30 ) ;
F_117 ( V_14 , V_22 , V_186 ) ;
...
static T_9 F_128 ( int V_302 , void * V_303 )
{
struct V_13 * V_14 = V_303 ;
void T_1 * V_22 = F_12 ( V_14 ) ;
struct V_98 * V_99 = V_14 -> V_18 ;
...
V_186 = F_2 ( V_22 + V_167 ) ;
F_3 ( V_186 , V_22 + V_167 ) ;
F_129 ( V_186 , & V_99 -> V_304 ) ;
F_59 ( L_52 ) ;
return V_307 ;
}
static T_9 F_130 ( int V_302 , void * V_303 )
{
struct V_79 * V_17 = V_303 ;
struct V_15 * V_16 ;
unsigned int V_2 , V_308 = 0 ;
void T_1 * V_1 ;
T_2 V_256 , V_309 ;
F_59 ( L_33 ) ;
V_16 = V_17 -> V_18 ;
...
unsigned int F_135 ( struct V_230 * V_231 )
{
struct V_13 * V_14 = V_231 -> V_14 ;
void T_1 * V_22 = F_12 ( V_14 ) ;
struct V_98 * V_99 = V_14 -> V_18 ;
V_99 -> V_300 = V_231 -> V_7 -> V_93 ;
if ( V_231 -> V_175 . V_242 == V_310 )
F_3 ( 1 << V_231 -> V_181 , V_22 + V_89 ) ;
if ( V_99 -> V_209 && V_99 -> V_311 != V_231 -> V_7 -> V_93 -> V_132 ) {
T_2 V_252 = F_2 ( V_22 + V_253 ) ;
V_252 &= ~ ( V_312 | V_255 ) ;
V_252 |= V_231 -> V_7 -> V_93 -> V_132 << V_313 ;
F_3 ( V_252 , V_22 + V_253 ) ;
V_99 -> V_311 = V_231 -> V_7 -> V_93 -> V_132 ;
}
F_3 ( 1 << V_231 -> V_181 , V_22 + V_202 ) ;
F_45 ( V_231 -> V_7 -> V_93 ) ;
return 0 ;
}
static bool F_136 ( struct V_230 * V_231 )
{
struct V_98 * V_99 = V_231 -> V_14 -> V_18 ;
T_6 * V_223 = V_99 -> V_223 ;
if ( V_99 -> V_209 )
V_223 += V_231 -> V_7 -> V_93 -> V_132 * V_314 ;
if ( V_231 -> V_175 . V_242 == V_315 && V_231 -> V_316 == V_317 &&
! ( V_231 -> V_28 & V_318 ) ) {
F_137 ( V_223 + V_319 , & V_231 -> V_320 ) ;
V_231 -> V_320 . V_226 = ( V_223 + V_319 ) [ 15 ] ;
} else
F_137 ( V_223 + V_224 , & V_231 -> V_320 ) ;
return true ;
}
...
static int F_149 ( struct V_13 * V_14 , T_10 V_349 )
{
const char * V_138 = NULL ;
int V_129 ;
V_129 = F_42 ( V_14 , & V_138 ) ;
...
T_5 V_351 ;
T_4 V_352 , V_353 ;
V_99 = F_152 ( V_7 , sizeof( * V_99 ) , V_354 ) ;
if ( ! V_99 )
return - V_355 ;
if ( V_14 -> V_17 -> V_169 > 1 ) {
V_99 -> V_356 = F_152 ( V_7 , 8 , V_354 ) ;
if ( ! V_99 -> V_356 ) {
F_153 ( V_7 , V_99 ) ;
return - V_355 ;
}
snprintf ( V_99 -> V_356 , 8 ,
L_63 , F_154 ( V_7 ) , V_14 -> V_149 ) ;
}
if ( ( V_16 -> V_19 & V_70 ) && F_155 ( V_14 ) ) {
void T_1 * V_22 = F_12 ( V_14 ) ;
T_2 V_108 = F_2 ( V_22 + V_23 ) ;
if ( V_108 & V_357 )
V_99 -> V_346 = true ;
...
V_350 = F_156 ( V_7 , V_352 , & V_351 , V_354 ) ;
if ( ! V_350 )
return - V_355 ;
...
void F_159 ( struct V_79 * V_17 , const char * V_363 )
{
struct V_15 * V_16 = V_17 -> V_18 ;
void T_1 * V_1 = V_16 -> V_1 ;
T_2 V_50 , V_19 , V_20 , V_364 , V_365 ;
const char * V_366 ;
V_50 = F_2 ( V_1 + V_21 ) ;
V_19 = V_16 -> V_19 ;
V_20 = V_16 -> V_20 ;
...
static int F_161 ( struct V_79 * V_17 , int V_302 ,
struct V_387 * V_388 )
{
int V_2 , V_129 ;
V_129 = F_162 ( V_17 ) ;
...
V_129 = F_164 ( V_17 -> V_7 , V_302 + V_2 ,
F_128 ,
F_124 , V_389 ,
V_99 -> V_356 , V_17 -> V_170 [ V_2 ] ) ;
if ( V_129 )
goto V_390;
}
for ( V_2 = 0 ; V_2 < V_17 -> V_169 ; V_2 ++ )
F_165 ( V_17 -> V_170 [ V_2 ] , L_97 , V_302 + V_2 ) ;
V_129 = F_166 ( V_17 , V_388 ) ;
if ( V_129 )
goto V_391;
return 0 ;
V_391:
...
V_390:
for ( V_2 -- ; V_2 >= 0 ; V_2 -- )
F_167 ( V_17 -> V_7 , V_302 + V_2 , V_17 -> V_170 [ V_2 ] ) ;
return V_129 ;
}
int F_168 ( struct V_79 * V_17 , int V_302 ,
struct V_387 * V_388 )
{
struct V_15 * V_16 = V_17 -> V_18 ;
int V_129 ;
if ( V_16 -> V_28 & V_362 )
V_129 = F_161 ( V_17 , V_302 , V_388 ) ;
else
V_129 = F_169 ( V_17 , V_302 , F_130 ,
V_389 , V_388 ) ;
return V_129 ;
}
