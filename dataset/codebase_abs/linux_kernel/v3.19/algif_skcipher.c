...
long V_64 = 0 ;
F_43 ( V_2 ) ;
for ( V_86 = V_56 -> V_87 . V_86 , V_84 = V_56 -> V_87 . V_88 ; V_84 > 0 ;
V_84 -- , V_86 ++ ) {
unsigned long V_89 = V_86 -> V_90 ;
char T_3 * V_91 = V_86 -> V_92 ;
while ( V_89 ) {
V_13 = F_13 ( & V_6 -> V_16 ,
struct V_12 , V_18 ) ;
V_15 = V_13 -> V_15 ;
...
V_11 = F_14 (unsigned long, ctx->used, seglen) ;
V_11 = F_54 ( & V_6 -> V_93 , V_91 , V_11 , 1 ) ;
V_31 = V_11 ;
if ( V_31 < 0 )
goto V_75;
...
static unsigned int F_60 ( struct V_95 * V_95 , struct V_54 * V_1 ,
T_4 * V_30 )
{
struct V_1 * V_2 = V_1 -> V_2 ;
struct V_3 * V_4 = F_2 ( V_2 ) ;
...
static void * F_62 ( const char * V_99 , T_5 type , T_5 V_96 )
{
return F_63 ( V_99 , type , V_96 ) ;
}
static void F_64 ( void * V_7 )
{
F_65 ( V_7 ) ;
}
static int F_66 ( void * V_7 , const T_6 * V_100 , unsigned int V_101 )
{
return F_67 ( V_7 , V_100 , V_101 ) ;
}
...
struct V_58 * V_59 = F_40 ( & V_6 -> V_60 ) ;
F_20 ( V_2 ) ;
F_69 ( V_2 , V_6 -> V_72 , F_41 ( V_59 ) ) ;
F_19 ( V_2 , V_6 , V_6 -> V_76 ) ;
F_70 ( V_2 ) ;
}
static int F_71 ( void * V_7 , struct V_1 * V_2 )
{
struct V_5 * V_6 ;
struct V_3 * V_4 = F_2 ( V_2 ) ;
unsigned int V_76 = sizeof( * V_6 ) + F_72 ( V_7 ) ;
