...
static void F_37 ( void * V_79 , struct V_9 * V_10 ,
int V_80 )
{
struct V_3 * V_4 = V_79 ;
struct V_22 * V_23 ;
...
V_4 -> V_5 . V_36 |= 0x10 ;
V_25 = F_38 ( V_4 -> V_11 -> V_12 , V_4 -> V_5 . V_83 ,
V_49 , V_84 ) ;
if ( V_25 < 0 )
return;
V_4 -> V_5 . V_42 = 0 ;
if ( F_39 ( V_23 -> V_38 ) != V_4 -> V_5 . V_77 )
...
int F_40 ( struct V_19 * V_11 , T_2 * V_85 , T_1 V_24 )
{
struct V_9 * V_10 ;
struct V_3 * V_4 = F_10 ( V_11 ) ;
struct V_20 * V_21 ;
...
if ( V_24 ) {
V_21 -> V_38 |= V_40 ;
memcpy ( F_12 ( V_10 , V_24 ) , V_85 , V_24 ) ;
}
...
V_4 -> V_5 . V_77 = F_39 ( V_21 -> V_38 ) ;
return F_4 ( V_11 , V_14 ,
V_15 , V_10 -> V_16 ,
V_10 -> V_17 , V_4 -> V_18 , V_4 ) ;
}
static void F_43 ( void * V_79 , struct V_9 * V_10 ,
int V_80 )
{
struct V_3 * V_4 = V_79 ;
struct V_61 * V_95 ;
