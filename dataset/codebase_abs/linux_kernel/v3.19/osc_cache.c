...
V_19 = F_89 ( & V_165 -> V_310 ) ;
V_176 = & F_88 ( V_59 ) -> V_177 ;
F_114 ( V_19 ) ;
V_26 = F_115 ( V_59 , V_19 , V_176 ) ;
F_116 ( V_19 ) ;
V_308 [ V_311 ] = V_176 -> V_312 ;
V_308 [ V_313 ] = V_176 -> V_314 ;
if ( V_26 == 0 && F_183 ( V_84 , V_308 ) == V_315 )
V_26 = - V_218 ;
if ( V_26 )
return V_26 ;
}
V_24 -> V_275 = V_168 ;
V_24 -> V_120 = V_291 -> V_316 ;
V_24 -> V_117 = V_291 -> V_317 - V_291 -> V_316 ;
V_24 -> V_154 = 0 ;
V_24 -> V_195 = V_303 ;
F_149 ( V_165 , L_40 ,
V_24 , V_24 -> V_298 , V_24 -> V_275 & V_318 ) ;
V_49 = F_17 ( V_24 ) -> V_50 ;
V_2 = V_302 -> V_319 ;
...
struct V_142 * V_320 = V_291 -> V_180 . V_321 ;
T_1 V_49 = V_320 -> V_50 ;
struct V_23 * V_24 = & V_291 -> V_293 ;
bool V_322 = false ;
int V_26 = 0 ;
...
V_26 = F_188 ( V_59 , V_136 , F_91 ( V_320 ) , V_172 ) ;
if ( V_26 )
goto V_27;
F_104 ( & V_24 -> V_156 ) ;
V_24 -> V_154 |= V_155 | V_323 ;
F_105 ( & V_24 -> V_156 ) ;
if ( F_189 () )
V_2 -> V_10 = 1 ;
V_2 -> V_9 = 1 ;
...
struct V_13 * V_14 , int V_168 , int V_303 )
{
struct V_83 * V_84 = F_54 ( V_19 ) ;
struct V_1 * V_2 ;
...
int F_194 ( const struct V_58 * V_59 , struct V_301 * V_302 ,
struct V_18 * V_19 , T_3 V_329 )
{
struct V_83 * V_84 = F_54 ( V_19 ) ;
struct V_1 * V_2 ;
...
int V_171 = 0 ;
bool V_132 ;
V_49 = F_195 ( F_67 ( V_19 ) , V_329 ) ;
V_132 = V_329 > F_117 ( F_67 ( V_19 ) , V_49 ) ;
V_331:
F_51 ( V_19 ) ;
V_2 = F_37 ( V_19 , V_49 ) ;
if ( V_2 == NULL )
...
V_49 = V_2 -> V_39 + 1 ;
V_132 = false ;
F_7 ( V_302 -> V_332 == NULL ) ;
V_302 -> V_332 = F_30 ( V_2 ) ;
F_18 ( V_66 , V_2 ,
L_53 , V_329 ) ;
}
F_32 ( V_59 , V_2 ) ;
...
if ( V_330 != NULL ) {
int V_26 ;
V_26 = F_74 ( V_59 , V_330 , V_32 ) ;
if ( V_26 < 0 )
F_18 ( V_66 , V_330 , L_54 , V_26 ) ;
F_32 ( V_59 , V_330 ) ;
V_330 = NULL ;
goto V_331;
}
...
void F_196 ( const struct V_58 * V_59 , struct V_301 * V_302 ,
struct V_18 * V_19 )
{
struct V_1 * V_2 = V_302 -> V_332 ;
V_302 -> V_332 = NULL ;
if ( V_2 != NULL ) {
bool V_322 = false ;
F_71 ( V_2 -> V_33 > 0 , V_2 ) ;
...
T_1 V_327 , T_1 V_123 , int V_333 , int V_334 )
{
struct V_1 * V_2 ;
F_162 ( V_335 ) ;
bool V_322 = false ;
...
if ( V_333 || V_334 ) {
int V_26 ;
V_26 = F_197 ( V_59 , V_19 , V_327 , V_123 ) ;
if ( V_171 >= 0 && V_26 < 0 )
V_171 = V_26 ;
}
F_149 ( V_19 , L_58 ) ;
