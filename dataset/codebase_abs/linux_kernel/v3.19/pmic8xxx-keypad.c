...
int V_5 ;
unsigned int V_41 ;
V_5 = F_31 ( & V_45 -> V_9 , & V_72 , & V_73 ) ;
if ( V_5 )
return V_5 ;
if ( V_73 > V_76 || V_72 > V_34 ||
V_73 < V_77 ) {
F_4 ( & V_45 -> V_9 , L_22 ) ;
return - V_36 ;
}
V_74 = ! F_32 ( V_45 -> V_9 . V_47 ,
L_23 ) ;
V_75 = F_32 ( V_45 -> V_9 . V_47 ,
L_24 ) ;
V_2 = F_33 ( & V_45 -> V_9 , sizeof( * V_2 ) , V_78 ) ;
if ( ! V_2 )
return - V_79 ;
V_2 -> V_7 = F_34 ( V_45 -> V_9 . V_80 , NULL ) ;
if ( ! V_2 -> V_7 )
return - V_81 ;
F_35 ( V_45 , V_2 ) ;
V_2 -> V_19 = V_72 ;
...
V_2 -> V_82 = F_37 ( V_45 , 0 ) ;
if ( V_2 -> V_82 < 0 ) {
F_4 ( & V_45 -> V_9 , L_26 ) ;
return V_2 -> V_82 ;
}
V_2 -> V_83 = F_37 ( V_45 , 1 ) ;
if ( V_2 -> V_83 < 0 ) {
F_4 ( & V_45 -> V_9 , L_27 ) ;
return V_2 -> V_83 ;
}
V_2 -> V_26 -> V_84 = L_28 ;
V_2 -> V_26 -> V_85 = L_29 ;
V_2 -> V_26 -> V_86 . V_87 = V_88 ;
V_2 -> V_26 -> V_86 . V_89 = 0x0001 ;
V_2 -> V_26 -> V_86 . V_90 = 0x0001 ;
V_2 -> V_26 -> V_86 . V_91 = 0x0001 ;
V_2 -> V_26 -> V_92 = F_27 ;
V_2 -> V_26 -> V_93 = F_29 ;
V_5 = F_38 ( NULL , NULL ,
V_34 , V_76 ,
...
static int F_45 ( struct V_97 * V_9 )
{
...
static int F_52 ( struct V_97 * V_9 )
{
struct V_44 * V_45 = F_46 ( V_9 ) ;
struct V_1 * V_2 = F_47 ( V_45 ) ;
struct V_71 * V_71 = V_2 -> V_26 ;
