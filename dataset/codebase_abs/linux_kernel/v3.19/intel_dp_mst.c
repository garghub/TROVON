...
static enum V_71
F_44 ( struct V_67 * V_68 , bool V_72 )
{
struct V_20 * V_20 = F_40 ( V_68 ) ;
struct V_11 * V_11 = V_20 -> V_69 ;
return F_45 ( V_68 , & V_11 -> V_32 , V_20 -> V_38 ) ;
}
static int
...
static struct V_82 * F_52 ( struct V_67 * V_68 )
{
struct V_20 * V_20 = F_40 ( V_68 ) ;
struct V_11 * V_11 = V_20 -> V_69 ;
return & V_11 -> V_83 [ 0 ] -> V_7 . V_7 ;
}
static void F_53 ( struct V_82 * V_2 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
F_54 ( V_2 ) ;
F_43 ( V_6 ) ;
}
static bool F_55 ( struct V_20 * V_68 )
{
if ( V_68 -> V_2 ) {
enum V_52 V_52 ;
if ( ! V_68 -> V_2 -> V_84 ( V_68 -> V_2 , & V_52 ) )
return false ;
return true ;
}
return false ;
}
static void F_56 ( struct V_20 * V_68 )
{
#ifdef F_57
struct V_41 * V_42 = F_58 ( V_68 -> V_7 . V_14 ) ;
F_59 ( & V_42 -> V_85 -> V_86 , & V_68 -> V_7 ) ;
#endif
}
static void F_60 ( struct V_20 * V_68 )
{
#ifdef F_57
struct V_41 * V_42 = F_58 ( V_68 -> V_7 . V_14 ) ;
F_61 ( & V_42 -> V_85 -> V_86 , & V_68 -> V_7 ) ;
#endif
}
static struct V_67 * F_62 ( struct V_87 * V_88 , struct V_89 * V_38 , const char * V_90 )
{
struct V_11 * V_11 = F_63 ( V_88 , struct V_11 , V_32 ) ;
struct V_8 * V_9 = F_64 ( V_11 ) ;
struct V_13 * V_14 = V_9 -> V_7 . V_7 . V_14 ;
struct V_20 * V_20 ;
struct V_67 * V_68 ;
int V_91 ;
V_20 = F_65 ( sizeof( * V_20 ) , V_92 ) ;
if ( ! V_20 )
return NULL ;
V_68 = & V_20 -> V_7 ;
F_66 ( V_14 , V_68 , & V_93 , V_94 ) ;
F_67 ( V_68 , & V_95 ) ;
V_20 -> V_96 = V_97 ;
V_20 -> V_84 = F_55 ;
V_20 -> V_69 = V_11 ;
V_20 -> V_38 = V_38 ;
for ( V_91 = V_98 ; V_91 <= V_99 ; V_91 ++ ) {
F_68 ( & V_20 -> V_7 ,
& V_11 -> V_83 [ V_91 ] -> V_7 . V_7 ) ;
}
F_69 ( V_11 , V_68 ) ;
F_70 ( & V_68 -> V_7 , V_14 -> V_100 . V_101 , 0 ) ;
F_70 ( & V_68 -> V_7 , V_14 -> V_100 . V_102 , 0 ) ;
F_71 ( V_68 , V_90 ) ;
F_72 ( V_14 ) ;
F_73 ( & V_14 -> V_100 . V_103 ) ;
F_56 ( V_20 ) ;
F_74 ( & V_14 -> V_100 . V_103 ) ;
F_75 ( & V_20 -> V_7 ) ;
return V_68 ;
}
...
static struct V_5 *
F_80 ( struct V_8 * V_9 , enum V_52 V_52 )
{
struct V_5 * V_6 ;
struct V_1 * V_1 ;
struct V_13 * V_14 = V_9 -> V_7 . V_7 . V_14 ;
V_6 = F_65 ( sizeof( * V_6 ) , V_92 ) ;
if ( ! V_6 )
return NULL ;
V_6 -> V_52 = V_52 ;
V_1 = & V_6 -> V_7 ;
V_6 -> V_10 = V_9 ;
F_81 ( V_14 , & V_1 -> V_7 , & V_104 ,
V_105 ) ;
V_1 -> type = V_106 ;
V_1 -> V_107 = 0x7 ;
V_1 -> V_108 = 0 ;
...
struct V_11 * V_11 = & V_9 -> V_12 ;
for ( V_91 = V_98 ; V_91 <= V_99 ; V_91 ++ )
V_11 -> V_83 [ V_91 ] = F_80 ( V_9 , V_91 ) ;
return true ;
}
int
F_83 ( struct V_8 * V_9 , int V_114 )
{
struct V_11 * V_11 = & V_9 -> V_12 ;
struct V_13 * V_14 = V_9 -> V_7 . V_7 . V_14 ;
int V_36 ;
...
F_82 ( V_9 ) ;
V_36 = F_84 ( & V_11 -> V_32 , V_14 -> V_14 , & V_11 -> V_118 , 16 , 3 , V_114 ) ;
if ( V_36 ) {
V_11 -> V_115 = false ;
return V_36 ;
}
