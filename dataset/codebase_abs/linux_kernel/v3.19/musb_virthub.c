...
void F_10 ( struct V_3 * V_3 , bool V_22 )
{
...
void F_17 ( struct V_3 * V_3 , bool V_35 )
{
T_1 V_5 ;
void T_2 * V_24 = V_3 -> V_8 ;
if ( V_3 -> V_18 -> V_19 -> V_20 == V_36 ) {
F_5 ( V_3 -> V_11 , L_5 ) ;
V_3 -> V_13 &= ~ V_37 ;
return;
}
...
case V_27 :
if ( V_19 -> V_28 -> V_29 ) {
V_3 -> V_18 -> V_19 -> V_20 = V_51 ;
V_3 -> V_52 . V_53 = 1 ;
break;
}
case V_21 :
V_3 -> V_18 -> V_19 -> V_20 = V_54 ;
V_3 -> V_12 = 0 ;
break;
case V_55 :
V_3 -> V_18 -> V_19 -> V_20 = V_36 ;
break;
default:
F_5 ( V_3 -> V_11 , L_8 ,
F_15 ( V_3 -> V_18 -> V_19 -> V_20 ) ) ;
...
int F_19 ( struct V_56 * V_17 , char * V_57 )
{
struct V_3 * V_3 = F_20 ( V_17 ) ;
int V_58 = 0 ;
