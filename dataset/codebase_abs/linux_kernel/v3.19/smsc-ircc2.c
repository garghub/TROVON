...
F_32 ( L_26 , V_21 , V_139 ) ;
return;
}
F_21 ( L_27 , V_21 , V_203 , V_139 ) ;
V_31 = F_84 ( V_139 + 1 ) ;
if ( ! V_31 )
return;
F_85 ( V_31 , 1 ) ;
...
static T_7 F_92 ( int V_223 , void * V_7 )
{
struct V_32 * V_5 = V_7 ;
struct V_33 * V_34 = F_27 ( V_5 ) ;
...
F_99 ( V_34 ) ;
sprintf ( V_238 , L_36 , V_34 -> V_35 . V_37 ) ;
...
static int F_110 ( struct V_242 * V_5 , T_8 V_64 )
{
...
static int F_123 ( int V_1 , int V_96 , T_10 * V_250 , int V_139 )
{
int V_248 = 0 ;
...
static int T_2 F_127 ( const struct V_271 * V_272 , unsigned short V_273 , char * type )
{
...
F_16 ( L_50 ,
V_21 , V_8 , V_9 , V_10 , V_11 , V_274 ) ;
if ( V_8 && F_11 ( V_8 , V_9 , V_10 , V_11 ) == 0 )
V_14 = 0 ;
F_2 ( V_284 , V_273 ) ;
return V_14 ;
}
static int T_2 F_128 ( const struct V_271 * V_272 , unsigned short V_260 , char * type )
{
...
static int T_2 F_130 ( unsigned short V_260 , unsigned char V_287 )
{
F_21 ( L_5 , V_21 ) ;
F_2 ( V_287 , V_260 ) ;
return F_3 ( V_260 ) != V_287 ? - 1 : 0 ;
}
static const struct V_271 * T_2 F_129 ( unsigned short V_260 , T_1 V_287 , const struct V_271 * V_79 , char * type )
{
...
static int T_2 F_17 ( unsigned short V_260 )
{
int V_14 = - 1 ;
...
if ( ! F_127 ( V_265 , V_260 , L_47 ) ||
! F_128 ( V_267 , V_260 , L_47 ) )
V_14 = 0 ;
F_48 ( V_260 , 2 ) ;
}
return V_14 ;
}
static int T_2 F_18 ( unsigned short V_260 )
{
int V_14 = - 1 ;
if ( ! F_49 ( V_260 , 2 , V_20 ) ) {
F_32 ( L_54 ,
...
if ( ! F_127 ( V_269 , V_260 , L_48 ) ||
! F_128 ( V_270 , V_260 , L_48 ) )
V_14 = 0 ;
F_48 ( V_260 , 2 ) ;
}
return V_14 ;
...
static int T_2 F_132 ( struct V_310 * V_5 ,
struct
V_293
* V_294 )
{
...
static void T_2 F_137 ( struct V_310 * V_5 ,
...
static int T_2 F_138 ( struct V_310 * V_5 ,
struct
V_293
* V_294 )
{
