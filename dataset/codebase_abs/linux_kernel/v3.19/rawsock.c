...
static int F_37 ( struct V_51 * V_52 , struct V_14 * V_3 ,
struct V_53 * V_54 , T_2 V_19 )
{
struct V_3 * V_4 = V_3 -> V_4 ;
struct V_23 * V_24 = F_11 ( V_4 ) -> V_24 ;
struct V_42 * V_43 ;
...
if ( V_3 -> V_32 != V_33 )
return - V_57 ;
V_43 = F_38 ( V_24 , V_4 , V_54 -> V_58 , V_19 , & V_25 ) ;
if ( V_43 == NULL )
return V_25 ;
V_25 = F_39 ( F_40 ( V_43 , V_19 ) , V_54 , V_19 ) ;
if ( V_25 < 0 ) {
F_31 ( V_43 ) ;
return V_25 ;
}
...
static int F_42 ( struct V_51 * V_52 , struct V_14 * V_3 ,
struct V_53 * V_54 , T_2 V_19 , int V_20 )
{
int V_59 = V_20 & V_60 ;
struct V_3 * V_4 = V_3 -> V_4 ;
struct V_42 * V_43 ;
...
static int F_51 ( struct V_65 * V_65 , struct V_14 * V_3 ,
const struct V_31 * V_66 )
{
struct V_3 * V_4 ;
F_8 ( L_10 , V_3 ) ;
if ( ( V_3 -> type != V_67 ) && ( V_3 -> type != V_15 ) )
return - V_68 ;
if ( V_3 -> type == V_15 )
V_3 -> V_69 = & V_70 ;
else
V_3 -> V_69 = & V_71 ;
V_4 = F_52 ( V_65 , V_72 , V_73 , V_66 -> V_74 ) ;
if ( ! V_4 )
return - V_75 ;
F_53 ( V_3 , V_4 ) ;
V_4 -> V_76 = V_66 -> V_77 ;
