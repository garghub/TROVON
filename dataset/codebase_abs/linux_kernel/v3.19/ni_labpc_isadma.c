...
F_10 ( V_11 ) ;
F_8 ( V_15 -> V_19 ) ;
V_15 -> V_38 ( V_11 , 0x1 , V_39 ) ;
}
void F_14 ( struct V_10 * V_11 )
{
const struct V_40 * V_41 = V_11 -> V_42 ;
struct V_14 * V_15 = V_11 -> V_16 ;
if ( V_15 -> V_36 & V_43 ||
( V_41 -> V_44 && V_15 -> V_45 & V_46 ) )
F_13 ( V_11 ) ;
}
int F_15 ( struct V_10 * V_11 , unsigned int V_19 )
{
struct V_14 * V_15 = V_11 -> V_16 ;
void * V_37 ;
unsigned long V_47 ;
...
if ( V_19 != 1 && V_19 != 3 )
return - V_49 ;
V_37 = F_16 ( V_9 , V_50 | V_51 ) ;
if ( ! V_37 )
return - V_52 ;
V_48 = F_17 ( V_19 , V_11 -> V_53 ) ;
if ( V_48 ) {
F_18 ( V_37 ) ;
return V_48 ;
}
