...
static T_4 F_68 ( struct V_11 * V_9 , T_6 * V_141 ,
struct V_142 * V_143 )
{
struct V_65 * V_66 = V_9 -> V_66 ;
T_6 * V_120 = V_66 -> V_120 ;
...
if ( V_18 != 0 )
return V_18 ;
memcpy ( F_75 ( V_171 , V_176 ) ,
V_9 -> V_174 . V_177 , sizeof( V_9 -> V_174 ) ) ;
return F_76 ( V_9 , V_178 ,
V_171 , sizeof( V_171 ) , NULL , 0 , NULL ) ;
}
static void F_77 ( struct V_11 * V_9 , struct V_179 * V_180 )
{
struct V_65 * V_66 = V_9 -> V_66 ;
V_180 -> V_181 = V_182 ;
if ( V_66 -> V_183 != - 1 )
...
{
unsigned V_194 = V_24 + F_85 ( V_9 ) ;
unsigned V_195 = V_24 + F_86 ( V_9 ) ;
unsigned int V_196 ;
unsigned int V_197 = F_87 ( V_193 , 4 ) ;
F_88 ( V_191 != 4 ) ;
F_89 ( V_9 , V_190 , V_194 ) ;
for ( V_196 = 0 ; V_196 < V_197 ; V_196 ++ )
F_89 ( V_9 , & V_192 [ V_196 ] , V_194 + V_191 + 4 * V_196 ) ;
F_90 () ;
F_14 ( V_9 , ( V_198 V_199 ) 0x45789abc , V_195 ) ;
}
static bool F_91 ( struct V_11 * V_9 )
{
unsigned int V_194 = V_24 + F_85 ( V_9 ) ;
T_1 V_190 ;
F_92 ( V_9 , & V_190 , V_194 ) ;
return F_93 ( V_190 , V_200 ) != 0xffffffff &&
F_93 ( V_190 , V_201 ) ;
}
static void F_94 ( struct V_11 * V_9 , T_1 * V_202 ,
T_4 V_203 , T_4 V_204 )
{
unsigned int V_194 = V_24 + F_85 ( V_9 ) ;
unsigned int V_205 = F_87 ( V_204 , 4 ) ;
int V_196 ;
for ( V_196 = 0 ; V_196 < V_205 ; V_196 ++ )
F_92 ( V_9 , & V_202 [ V_196 ] , V_194 + V_203 + 4 * V_196 ) ;
}
...
return - V_71 ;
V_213 = & V_217 [ type ] ;
if ( V_213 -> V_219 != F_99 ( V_9 ) )
return - V_71 ;
V_18 = F_100 ( V_9 , type , & V_214 , & V_215 , & V_216 ) ;
if ( V_18 )
return V_18 ;
if ( V_216 )
return - V_71 ;
...
int V_18 ;
F_103 () ;
V_18 = F_104 ( V_9 , & V_233 ) ;
if ( V_18 )
return V_18 ;
V_228 = F_105 ( F_106 ( V_233 ) , sizeof( * V_228 ) , V_68 ) ;
if ( ! V_228 )
return - V_69 ;
type = 0 ;
V_229 = 0 ;
...
V_18 = F_101 ( V_9 , V_228 , V_229 ) ;
if ( V_18 )
goto V_187;
V_18 = F_107 ( V_9 , & V_228 [ 0 ] . V_221 , V_229 , sizeof( * V_228 ) ) ;
V_187:
if ( V_18 )
F_46 ( V_228 ) ;
return V_18 ;
