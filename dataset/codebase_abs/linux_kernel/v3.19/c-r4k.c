...
V_201 [ V_127 -> V_26 . V_31 ] , V_127 -> V_26 . V_147 ) ;
F_116 ( L_8 ,
V_114 >> 10 , V_201 [ V_127 -> V_134 . V_31 ] ,
...
{
unsigned long V_21 , V_2 , V_202 , V_24 , V_203 ;
unsigned int V_138 = F_109 () ;
struct V_126 * V_127 = & V_25 ;
if ( V_138 & V_178 )
return 0 ;
V_202 = ( unsigned long ) & V_204 ;
V_202 &= ~ ( ( 4 * 1024 * 1024 ) - 1 ) ;
V_24 = V_202 + ( 4 * 1024 * 1024 ) ;
F_20 ( V_21 ) ;
V_203 = ( 64 * 1024 ) ;
for ( V_2 = V_202 ; V_2 < V_24 ; V_2 = ( V_202 + V_203 ) ) {
unsigned long * V_205 = ( unsigned long * ) V_2 ;
...
F_118 ( V_208 , V_202 ) ;
V_203 = ( 128 * 1024 ) ;
for ( V_2 = V_202 + ( 128 * 1024 ) ; V_2 < V_24 ; V_2 = V_202 + V_203 ) {
F_118 ( V_209 , V_2 ) ;
__asm__ __volatile__("nop; nop; nop; nop;");
if ( ! F_119 () )
break;
...
V_2 -= V_202 ;
V_63 = V_2 ;
V_127 -> V_210 . V_147 = 16 << ( ( V_138 & V_211 ) >> 22 ) ;
V_127 -> V_210 . V_31 = 1 ;
V_127 -> V_134 . V_29 = 0 ;
return 1 ;
}
...
struct V_126 * V_127 = & V_25 ;
V_63 = 512 * 1024 ;
V_127 -> V_210 . V_147 = 32 ;
V_127 -> V_210 . V_31 = 4 ;
V_127 -> V_210 . V_29 = 0 ;
V_127 -> V_210 . V_27 = V_63 / ( V_127 -> V_210 . V_31 ) ;
V_127 -> V_210 . V_173 = V_63 / ( V_127 -> V_210 . V_147 * V_127 -> V_210 . V_31 ) ;
F_121 ( L_12 ,
V_63 >> 10 , V_201 [ V_127 -> V_210 . V_31 ] , V_127 -> V_210 . V_147 ) ;
V_127 -> V_151 |= V_212 ;
}
static void T_6 F_122 ( void )
{
struct V_126 * V_127 = & V_25 ;
unsigned int V_213 , V_141 ;
V_213 = F_123 () ;
V_141 = ( V_213 >> 4 ) & 15 ;
if ( V_141 )
V_127 -> V_210 . V_147 = 2 << V_141 ;
else
V_127 -> V_210 . V_147 = 0 ;
V_127 -> V_210 . V_173 = 64 << ( ( V_213 >> 8 ) & 15 ) ;
V_127 -> V_210 . V_31 = 1 + ( V_213 & 15 ) ;
V_63 = V_127 -> V_210 . V_173 *
V_127 -> V_210 . V_31 *
V_127 -> V_210 . V_147 ;
V_63 *= 4 ;
V_127 -> V_210 . V_29 = 0 ;
...
case V_85 :
case V_86 :
V_63 = 0x80000 << ( ( V_138 & V_216 ) >> 16 ) ;
V_127 -> V_210 . V_147 = 64 << ( ( V_138 >> 13 ) & 1 ) ;
V_127 -> V_210 . V_31 = 2 ;
V_127 -> V_210 . V_29 = 0 ;
V_214 = 1 ;
break;
...
return;
default:
if ( V_127 -> V_218 & ( V_219 | V_220 |
V_221 | V_222 ) ) {
#ifdef F_130
if ( F_131 () ) {
V_63 = V_127 -> V_210 . V_31 * V_127 -> V_210 . V_173 * V_127 -> V_210 . V_147 ;
F_116 ( L_13 ,
V_63 >> 10 ,
V_201 [ V_127 -> V_210 . V_31 ] , V_127 -> V_210 . V_147 ) ;
}
#else
if ( ! ( V_127 -> V_210 . V_21 & V_223 ) )
F_114 ( L_14 ) ;
#endif
return;
}
...
static int T_6 F_136 ( char * V_227 )
{
F_137 ( & V_227 , & V_228 ) ;
return 0 ;
}
...
{
extern char __weak V_232 ;
extern char __weak V_233 ;
switch ( F_30 () ) {
case V_181 :
case V_182 :
F_143 ( 0x100 , & V_233 , 0x80 ) ;
break;
default:
F_143 ( 0x100 , & V_232 , 0x80 ) ;
break;
}
}
void F_144 ( void )
{
extern void V_234 ( void ) ;
extern void V_235 ( void ) ;
struct V_126 * V_127 = & V_25 ;
F_108 () ;
F_124 () ;
F_14 () ;
...
V_249 = ( void * ) F_107 ;
V_250 = ( void * ) F_107 ;
V_25 . V_134 . V_21 &= ~ V_197 ;
V_25 . V_151 |= V_212 ;
break;
}
}
static int F_147 ( struct V_261 * V_262 , unsigned long V_263 ,
void * V_264 )
{
switch ( V_263 ) {
case V_265 :
