...
if ( ! V_8 -> V_46 )
return;
for ( V_86 = 0 ; V_86 < ( 1U << V_8 -> V_48 ) ; V_86 ++ ) {
V_29 = & V_8 -> V_46 [ V_86 ] ;
...
struct V_28 * V_88 , V_47 V_89 ,
struct V_28 * V_90 , V_47 V_91 )
{
...
V_95 = & V_90 [ F_16 ( ( V_47 ) ( long ) V_96 -> V_31 , V_91 ) ] ;
V_93 = & V_95 -> V_9 ;
V_12 = NULL ;
while ( * V_93 ) {
V_12 = * V_93 ;
V_97 = F_4 ( V_12 , struct V_1 , V_35 ) ;
F_42 ( V_97 -> V_31 == V_96 -> V_31 ) ;
...
static void * F_43 ( T_2 V_98 , int V_99 )
{
void * V_100 ;
V_100 = F_44 ( V_98 , V_101 | V_102 | V_54 , V_99 ) ;
if ( ! V_100 )
V_100 = F_45 ( V_98 , V_99 ) ;
return V_100 ;
}
...
return 0 ;
V_104 = F_43 ( sizeof( struct V_28 ) << log ,
F_49 ( V_57 -> V_106 ) ) ;
if ( ! V_104 )
return - V_107 ;
...
V_105 = V_8 -> V_46 ;
if ( V_105 )
F_41 ( V_8 , V_105 , V_8 -> V_48 , V_104 , log ) ;
V_8 -> V_46 = V_104 ;
V_8 -> V_48 = log ;
F_51 ( V_57 ) ;
F_46 ( V_105 ) ;
...
static int F_52 ( struct V_56 * V_57 , struct V_108 * V_109 )
{
struct V_7 * V_8 = F_24 ( V_57 ) ;
...
if ( ! V_109 )
return - V_115 ;
V_112 = F_53 ( V_110 , V_111 , V_109 , V_116 ) ;
if ( V_112 < 0 )
return V_112 ;
F_50 ( V_57 ) ;
V_114 = V_8 -> V_48 ;
if ( V_110 [ V_117 ] ) {
V_47 V_118 = F_54 ( V_110 [ V_117 ] ) ;
if ( V_118 >= 1 && V_118 <= F_55 ( 256 * 1024 ) )
V_114 = V_118 ;
else
V_112 = - V_115 ;
}
if ( V_110 [ V_119 ] )
V_57 -> V_61 = F_54 ( V_110 [ V_119 ] ) ;
if ( V_110 [ V_120 ] )
V_8 -> V_62 = F_54 ( V_110 [ V_120 ] ) ;
if ( V_110 [ V_121 ] ) {
V_47 V_67 = F_54 ( V_110 [ V_121 ] ) ;
if ( V_67 > 0 )
V_8 -> V_67 = V_67 ;
else
V_112 = - V_115 ;
...
if ( V_110 [ V_122 ] )
V_8 -> V_52 = F_54 ( V_110 [ V_122 ] ) ;
if ( V_110 [ V_123 ] )
F_56 ( L_1 ,
F_54 ( V_110 [ V_123 ] ) ) ;
if ( V_110 [ V_124 ] )
V_8 -> V_78 = F_54 ( V_110 [ V_124 ] ) ;
if ( V_110 [ V_125 ] ) {
V_47 V_126 = F_54 ( V_110 [ V_125 ] ) ;
if ( V_126 <= 1 )
V_8 -> V_77 = V_126 ;
else
V_112 = - V_115 ;
...
if ( V_110 [ V_127 ] ) {
V_47 V_128 = F_54 ( V_110 [ V_127 ] ) ;
V_8 -> V_66 = F_57 ( V_128 ) ;
}
if ( ! V_112 ) {
F_51 ( V_57 ) ;
V_112 = F_48 ( V_57 , V_114 ) ;
F_50 ( V_57 ) ;
}
...
static int F_61 ( struct V_56 * V_57 , struct V_108 * V_109 )
{
struct V_7 * V_8 = F_24 ( V_57 ) ;
int V_112 ;
V_57 -> V_61 = 10000 ;
...
F_65 ( & V_8 -> V_75 , V_57 ) ;
if ( V_109 )
V_112 = F_52 ( V_57 , V_109 ) ;
else
V_112 = F_48 ( V_57 , V_8 -> V_48 ) ;
return V_112 ;
}
...
struct V_7 * V_8 = F_24 ( V_57 ) ;
struct V_108 * V_129 ;
V_129 = F_67 ( V_41 , V_130 ) ;
if ( V_129 == NULL )
goto V_131;
if ( F_68 ( V_41 , V_119 , V_57 -> V_61 ) ||
F_68 ( V_41 , V_120 , V_8 -> V_62 ) ||
F_68 ( V_41 , V_121 , V_8 -> V_67 ) ||
F_68 ( V_41 , V_122 , V_8 -> V_52 ) ||
F_68 ( V_41 , V_125 , V_8 -> V_77 ) ||
F_68 ( V_41 , V_124 , V_8 -> V_78 ) ||
F_68 ( V_41 , V_127 ,
F_69 ( V_8 -> V_66 ) ) ||
F_68 ( V_41 , V_117 , V_8 -> V_48 ) )
goto V_131;
return F_70 ( V_41 , V_129 ) ;
V_131:
return - 1 ;
}
static int F_71 ( struct V_56 * V_57 , struct V_132 * V_133 )
{
struct V_7 * V_8 = F_24 ( V_57 ) ;
T_1 V_70 = F_31 () ;
struct V_134 V_135 = {
...
return F_72 ( V_133 , & V_135 , sizeof( V_135 ) ) ;
}
