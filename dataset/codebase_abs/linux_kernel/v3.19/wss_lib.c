...
static const char * const V_272 [ 4 ] = {
L_65 , L_69 , L_67 , L_68
} ;
static const char * const V_273 [ 4 ] = {
L_65 , L_70 , L_67 , L_68
} ;
const char * const * V_274 = V_271 ;
struct V_5 * V_6 = F_122 ( V_268 ) ;
if ( F_123 ( ! V_6 -> V_224 ) )
return - V_52 ;
if ( ! strcmp ( V_6 -> V_224 -> V_275 , L_71 ) )
V_274 = V_273 ;
switch ( V_6 -> V_30 ) {
case V_88 :
V_274 = V_273 ;
...
unsigned long V_22 ;
F_23 ( & V_6 -> V_23 , V_22 ) ;
V_277 -> V_14 . V_278 . V_279 [ 0 ] = ( V_6 -> V_18 [ V_75 ] & V_280 ) >> 6 ;
V_277 -> V_14 . V_278 . V_279 [ 1 ] = ( V_6 -> V_18 [ V_76 ] & V_280 ) >> 6 ;
F_24 ( & V_6 -> V_23 , V_22 ) ;
return 0 ;
}
static int F_126 ( struct V_267 * V_268 ,
struct V_276 * V_277 )
{
struct V_5 * V_6 = F_122 ( V_268 ) ;
unsigned long V_22 ;
unsigned short V_281 , V_282 ;
int V_283 ;
if ( V_277 -> V_14 . V_278 . V_279 [ 0 ] > 3 ||
V_277 -> V_14 . V_278 . V_279 [ 1 ] > 3 )
return - V_52 ;
V_281 = V_277 -> V_14 . V_278 . V_279 [ 0 ] << 6 ;
V_282 = V_277 -> V_14 . V_278 . V_279 [ 1 ] << 6 ;
F_23 ( & V_6 -> V_23 , V_22 ) ;
V_281 = ( V_6 -> V_18 [ V_75 ] & ~ V_280 ) | V_281 ;
V_282 = ( V_6 -> V_18 [ V_76 ] & ~ V_280 ) | V_282 ;
V_283 = V_281 != V_6 -> V_18 [ V_75 ] ||
V_282 != V_6 -> V_18 [ V_76 ] ;
F_12 ( V_6 , V_75 , V_281 ) ;
F_12 ( V_6 , V_76 , V_282 ) ;
F_24 ( & V_6 -> V_23 , V_22 ) ;
...
struct V_269 * V_270 )
{
int V_284 = ( V_268 -> V_285 >> 16 ) & 0xff ;
V_270 -> type = V_284 == 1 ? V_286 : V_287 ;
V_270 -> V_137 = 1 ;
V_270 -> V_14 . integer . V_288 = 0 ;
V_270 -> V_14 . integer . V_289 = V_284 ;
return 0 ;
}
...
struct V_5 * V_6 = F_122 ( V_268 ) ;
unsigned long V_22 ;
int V_13 = V_268 -> V_285 & 0xff ;
int V_290 = ( V_268 -> V_285 >> 8 ) & 0xff ;
int V_284 = ( V_268 -> V_285 >> 16 ) & 0xff ;
int V_291 = ( V_268 -> V_285 >> 24 ) & 0xff ;
F_23 ( & V_6 -> V_23 , V_22 ) ;
V_277 -> V_14 . integer . V_14 [ 0 ] = ( V_6 -> V_18 [ V_13 ] >> V_290 ) & V_284 ;
F_24 ( & V_6 -> V_23 , V_22 ) ;
if ( V_291 )
V_277 -> V_14 . integer . V_14 [ 0 ] = V_284 - V_277 -> V_14 . integer . V_14 [ 0 ] ;
return 0 ;
}
...
int V_283 ;
unsigned short V_8 ;
V_8 = ( V_277 -> V_14 . integer . V_14 [ 0 ] & V_284 ) ;
if ( V_291 )
V_8 = V_284 - V_8 ;
V_8 <<= V_290 ;
F_23 ( & V_6 -> V_23 , V_22 ) ;
V_8 = ( V_6 -> V_18 [ V_13 ] & ~ ( V_284 << V_290 ) ) | V_8 ;
V_283 = V_8 != V_6 -> V_18 [ V_13 ] ;
F_12 ( V_6 , V_13 , V_8 ) ;
F_24 ( & V_6 -> V_23 , V_22 ) ;
return V_283 ;
}
...
struct V_5 * V_6 = F_122 ( V_268 ) ;
unsigned long V_22 ;
int V_292 = V_268 -> V_285 & 0xff ;
int V_293 = ( V_268 -> V_285 >> 8 ) & 0xff ;
int V_294 = ( V_268 -> V_285 >> 16 ) & 0x07 ;
int V_295 = ( V_268 -> V_285 >> 19 ) & 0x07 ;
int V_284 = ( V_268 -> V_285 >> 24 ) & 0xff ;
int V_291 = ( V_268 -> V_285 >> 22 ) & 1 ;
F_23 ( & V_6 -> V_23 , V_22 ) ;
V_277 -> V_14 . integer . V_14 [ 0 ] = ( V_6 -> V_18 [ V_292 ] >> V_294 ) & V_284 ;
V_277 -> V_14 . integer . V_14 [ 1 ] = ( V_6 -> V_18 [ V_293 ] >> V_295 ) & V_284 ;
F_24 ( & V_6 -> V_23 , V_22 ) ;
if ( V_291 ) {
V_277 -> V_14 . integer . V_14 [ 0 ] = V_284 - V_277 -> V_14 . integer . V_14 [ 0 ] ;
V_277 -> V_14 . integer . V_14 [ 1 ] = V_284 - V_277 -> V_14 . integer . V_14 [ 1 ] ;
}
return 0 ;
}
int F_132 ( struct V_267 * V_268 ,
struct V_276 * V_277 )
{
struct V_5 * V_6 = F_122 ( V_268 ) ;
unsigned long V_22 ;
...
int V_291 = ( V_268 -> V_285 >> 22 ) & 1 ;
int V_283 ;
unsigned short V_296 , V_297 ;
V_296 = V_277 -> V_14 . integer . V_14 [ 0 ] & V_284 ;
V_297 = V_277 -> V_14 . integer . V_14 [ 1 ] & V_284 ;
if ( V_291 ) {
V_296 = V_284 - V_296 ;
V_297 = V_284 - V_297 ;
}
...
F_23 ( & V_6 -> V_23 , V_22 ) ;
if ( V_292 != V_293 ) {
V_296 = ( V_6 -> V_18 [ V_292 ] & ~ ( V_284 << V_294 ) ) | V_296 ;
V_297 = ( V_6 -> V_18 [ V_293 ] & ~ ( V_284 << V_295 ) ) | V_297 ;
V_283 = V_296 != V_6 -> V_18 [ V_292 ] ||
V_297 != V_6 -> V_18 [ V_293 ] ;
F_12 ( V_6 , V_292 , V_296 ) ;
F_12 ( V_6 , V_293 , V_297 ) ;
} else {
V_284 = ( V_284 << V_294 ) | ( V_284 << V_295 ) ;
V_296 = ( V_6 -> V_18 [ V_292 ] & ~ V_284 ) | V_296 | V_297 ;
V_283 = V_296 != V_6 -> V_18 [ V_292 ] ;
F_12 ( V_6 , V_292 , V_296 ) ;
}
F_24 ( & V_6 -> V_23 , V_22 ) ;
...
unsigned int V_298 ;
int V_135 ;
int V_137 = F_38 ( V_299 ) ;
if ( F_123 ( ! V_6 || ! V_6 -> V_217 ) )
return - V_52 ;
V_224 = V_6 -> V_224 ;
strcpy ( V_224 -> V_300 , V_6 -> V_217 -> V_254 ) ;
if ( V_6 -> V_30 & V_84 )
V_137 = 11 ;
else if ( V_6 -> V_30 == V_192 )
V_137 = 9 ;
for ( V_298 = 0 ; V_298 < V_137 ; V_298 ++ ) {
V_135 = F_134 ( V_224 ,
F_135 ( & V_299 [ V_298 ] ,
V_6 ) ) ;
if ( V_135 < 0 )
...
const struct V_301 * F_136 ( int V_302 )
{
return V_302 == V_246 ?
& V_247 : & V_249 ;
}
