...
unsigned int F_42 ( struct V_20 * V_21 )
{
struct V_22 * V_23 = V_21 -> V_23 ;
...
{
struct V_22 * V_23 = V_21 -> V_23 ;
unsigned int V_67 = F_42 ( V_21 ) ;
if ( V_55 > V_67 )
V_55 = V_67 ;
V_23 -> V_42 += V_55 ;
V_23 -> V_45 += V_55 ;
F_39 ( V_21 , V_23 -> V_42 - V_23 -> V_51 ) ;
...
static unsigned int F_47 ( struct V_22 * V_23 )
{
...
const void * V_68 , unsigned int V_57 )
{
struct V_22 * V_23 = V_21 -> V_23 ;
unsigned int V_69 = V_23 -> V_45 ;
while ( V_57 ) {
unsigned int V_63 ;
if ( V_69 + V_57 > V_23 -> V_25 )
V_63 = V_23 -> V_25 - V_69 ;
else
V_63 = V_57 ;
memcpy ( V_23 -> V_24 + V_69 , V_68 , V_63 ) ;
V_68 += V_63 ;
V_57 -= V_63 ;
V_69 = 0 ;
}
...
void * V_70 , unsigned int V_55 )
{
void * V_71 ;
struct V_22 * V_23 = V_21 -> V_23 ;
unsigned int V_72 = V_23 -> V_46 ;
while ( V_55 ) {
unsigned int V_63 ;
V_71 = V_23 -> V_24 + V_72 ;
if ( V_55 >= V_23 -> V_25 - V_72 )
V_63 = V_23 -> V_25 - V_72 ;
else
V_63 = V_55 ;
memcpy ( V_70 , V_71 , V_63 ) ;
V_55 -= V_63 ;
V_70 += V_63 ;
V_72 = 0 ;
}
...
const void * V_68 , unsigned int V_73 )
{
unsigned int V_74 ;
unsigned int V_55 ;
V_74 = F_52 ( V_21 ,
...
unsigned int F_56 ( struct V_20 * V_21 ,
void * V_68 , unsigned int V_73 )
{
unsigned int V_74 ;
unsigned int V_55 ;
V_74 = F_52 ( V_21 ,
