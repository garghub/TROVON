...
V_341 = (struct V_568 * ) F_456 ( V_484 , V_1201 ) ;
...
if ( V_1212 > V_580 )
V_1212 = V_580 ;
F_439 ( V_493 , V_799 , V_502 , V_1212 , V_1204 , V_1202 ) ;
V_1204 = V_1202 = 0 ;
...
static int F_462 ( struct V_308 * V_11 , struct V_1235 * V_1153 )
{
struct V_3 * V_4 = F_400 ( V_11 ) ;
struct V_38 * V_13 ;
V_13 = & V_4 -> V_39 ;
...
static int F_464 ( struct V_308 * V_11 , struct V_1235 * V_1153 )
{
struct V_3 * V_4 = F_400 ( V_11 ) ;
struct V_38 * V_13 = & V_4 -> V_39 ;
V_13 -> V_174 = V_1153 -> V_174 ;
V_13 -> V_302 = F_465 ( V_1153 ) ;
...
static int F_476 ( T_1 V_1276 , T_1 * V_929 )
{
T_1 V_403 = 0 ;
if ( V_1276 & V_1278 )
V_403 |= V_1277 ;
...
V_1293 -> V_35 = F_475 ( V_4 -> V_25 -> V_929 [ V_421 -
V_425 ] ) ;
return 0 ;
}
static void F_478 ( struct V_909 * V_341 ,
struct V_1296 * V_1297 )
{
T_3 V_585 ;
T_4 V_1298 ;
V_585 = ( V_341 -> V_403 [ 3 ] & V_1299 ) >> V_1300 ;
V_1297 -> V_1301 . V_1302 . V_1303 = F_479 ( V_585 ) ;
V_585 = ( V_341 -> V_403 [ 3 ] & V_1304 ) >> V_1305 ;
V_1297 -> V_1301 . V_1302 . V_1306 = F_479 ( V_585 ) ;
V_585 = ( V_341 -> V_912 [ 3 ] & V_1299 ) >> V_1300 ;
V_1297 -> V_1307 . V_1302 . V_1303 = F_479 ( V_585 ) ;
V_585 = ( V_341 -> V_912 [ 3 ] & V_1304 ) >> V_1305 ;
V_1297 -> V_1307 . V_1302 . V_1306 = F_479 ( V_585 ) ;
...
V_1312 ) >> 16 ;
V_1297 -> V_1301 . V_1302 . V_1313 = F_443 ( V_1298 ) ;
V_1298 = ( ( V_341 -> V_403 [ 2 ] & V_1311 ) >>
V_1312 ) & 0xffff ;
V_1297 -> V_1301 . V_1302 . V_1314 = F_443 ( V_1298 ) ;
V_1298 = ( ( V_341 -> V_912 [ 2 ] & V_1311 ) >>
V_1312 ) >> 16 ;
V_1297 -> V_1307 . V_1302 . V_1313 = F_443 ( V_1298 ) ;
V_1298 = ( ( V_341 -> V_912 [ 2 ] & V_1311 ) >>
V_1312 ) & 0xffff ;
V_1297 -> V_1307 . V_1302 . V_1314 = F_443 ( V_1298 ) ;
break;
case V_1258 :
case V_1261 :
V_585 = ( V_341 -> V_403 [ 2 ] & V_1311 ) >>
V_1312 ;
V_1297 -> V_1301 . V_1315 . V_1316 = F_479 ( V_585 ) ;
V_585 = ( V_341 -> V_912 [ 2 ] & V_1311 ) >>
V_1312 ;
V_1297 -> V_1307 . V_1315 . V_1316 = F_479 ( V_585 ) ;
break;
case V_1273 :
V_585 = ( V_341 -> V_403 [ 2 ] & V_1311 ) >>
V_1312 ;
V_1297 -> V_1301 . V_1317 . V_1318 = F_479 ( V_585 ) ;
V_585 = ( V_341 -> V_912 [ 2 ] & V_1311 ) >>
V_1312 ;
V_1297 -> V_1307 . V_1317 . V_1318 = F_479 ( V_585 ) ;
...
V_1327 ;
V_861 = F_473 ( V_421 , & V_1297 -> V_1249 ) ;
if ( V_861 < 0 ) {
...
static int F_483 ( struct V_308 * V_11 , struct V_1292 * V_1153 ,
T_3 * V_1332 )
{
struct V_3 * V_4 = F_400 ( V_11 ) ;
int V_861 = 0 ;
...
break;
case V_1339 :
V_861 = F_480 ( V_4 , V_1153 ) ;
break;
case V_1340 :
V_861 = F_482 ( V_4 , V_1153 , V_1332 ) ;
break;
default:
V_861 = - V_21 ;
break;
...
case V_1253 :
case V_1255 :
V_1347 = F_442 ( V_1297 -> V_1301 . V_1302 . V_1313 ) ;
V_1349 = F_442 ( V_1297 -> V_1307 . V_1302 . V_1313 ) ;
V_1348 = F_442 ( V_1297 -> V_1301 . V_1302 . V_1314 ) ;
V_1350 = F_442 ( V_1297 -> V_1307 . V_1302 . V_1314 ) ;
...
static int F_489 ( struct V_308 * V_11 , struct V_1292 * V_1153 )
{
struct V_3 * V_4 = F_400 ( V_11 ) ;
int V_861 = 0 ;
switch ( V_1153 -> V_1153 ) {
case V_1363 :
V_861 = F_484 ( V_4 , V_1153 ) ;
break;
case V_1364 :
V_861 = F_487 ( V_4 , V_1153 ) ;
break;
case V_1365 :
V_861 = F_488 ( V_4 , V_1153 -> V_1324 . V_1325 ) ;
break;
default:
V_861 = - V_21 ;
break;
...
static int F_507 ( struct V_3 * V_4 , T_3 V_1183 , T_3 V_1408 )
{
...
V_490 = V_10 ;
V_1183 += 3 ;
V_1410 = F_502 ( V_4 , V_1183 + 4 ) ;
V_10 = F_505 ( V_4 , V_1183 + 5 , V_1402 , 64 ) ;
if ( V_10 < 0 )
return V_10 ;
V_1411 = NULL ;
V_1412 = 0 ;
...
F_226 ( V_4 -> V_508 , L_143 , V_1402 , V_1410 ) ;
return - V_21 ;
}
if ( V_1411 ) {
...
static void F_515 ( struct V_3 * V_4 , T_3 V_1183 )
{
T_3 V_486 ;
int V_10 ;
V_10 = F_504 ( V_4 , V_1183 + 1 ) ;
if ( V_10 < 0 )
return;
V_486 = V_10 + 3 ;
...
while ( V_1183 < V_1408 ) {
V_861 = V_1183 ;
V_10 = F_503 ( V_4 , V_1183 + 0 ) ;
if ( V_10 != 0x55aa )
return 0 ;
V_10 = F_503 ( V_4 , V_1183 + 23 ) ;
if ( V_10 < 0 )
return 0 ;
V_1183 += V_10 ;
V_10 = F_503 ( V_4 , V_1183 + 0 ) ;
...
if ( V_10 != 0x4952 )
return 0 ;
V_10 = F_502 ( V_4 , V_1183 + 20 ) ;
if ( V_10 < 0 )
return 0 ;
if ( V_10 != 0x01 ) {
V_10 = F_502 ( V_4 , V_861 + 2 ) ;
if ( V_10 < 0 )
return 0 ;
V_1183 = V_861 + ( V_10 * 512 ) ;
continue;
}
V_10 = F_504 ( V_4 , V_1183 + 8 ) ;
if ( V_10 < 0 )
return V_10 ;
V_861 += V_10 ;
V_10 = F_502 ( V_4 , V_861 + 0 ) ;
if ( V_10 != 0x82 )
return 0 ;
return V_861 ;
}
...
if ( ( V_1438 & 0xff ) != 0xab ) {
F_226 ( V_4 -> V_508 , L_156 , ( int ) ( V_1438 & 0xff ) ) ;
return - V_21 ;
}
V_2 = F_16 ( V_1442 ) ;
switch ( V_4 -> V_30 ) {
...
return - V_21 ;
for ( V_26 = 0 ; V_26 < V_2 ; V_26 += 4 ) {
T_1 V_585 = F_16 ( F_471 ( 14 + ( V_26 / 4 ) ) ) ;
...
V_1490 -> V_845 [ V_843 ] =
V_1485 + V_1489 ;
F_239 ( L_176 , V_1490 -> V_845 [ V_843 ] ) ;
if ( ++ V_1489 == V_1488 )
V_1489 = 0 ;
}
F_239 ( L_177 ) ;
...
V_1516 = F_538 ( V_1234 , V_1513 , 1 , V_1516 ) ;
if ( V_1516 < 0 ) {
V_4 -> V_87 &= ~ V_1519 ;
return;
}
...
const T_3 * V_1522 ;
int V_26 ;
V_1522 = F_541 ( V_1521 -> V_11 . V_1523 , L_181 , NULL ) ;
if ( ! V_1522 )
return - V_8 ;
...
for ( V_26 = 0 ; V_26 < V_4 -> V_28 ; V_26 ++ ) {
struct V_12 * V_13 = & V_4 -> V_29 [ V_26 ] ;
F_543 ( V_4 -> V_11 , & V_13 -> V_535 , F_235 , 64 ) ;
V_13 -> V_4 = V_4 ;
...
V_1528 = 0 ;
V_10 = F_497 ( V_4 , V_25 , V_1511 [ V_1528 ] ,
F_544 ( V_30 ) ) ;
if ( V_10 )
return V_10 ;
V_1528 ++ ;
...
V_1531 = F_548 ( V_4 -> V_1234 ) ;
V_1420 = F_541 ( V_1531 , L_142 , & V_1410 ) ;
if ( ! V_1420 ) {
F_10 ( V_11 , L_182 ,
V_1531 -> V_1533 ) ;
return - V_21 ;
...
V_1532 = F_541 ( V_1531 , L_140 , & V_1410 ) ;
if ( ! V_1532 ) {
F_10 ( V_11 , L_185 ,
V_1531 -> V_1533 ) ;
return - V_21 ;
...
V_1413 = F_541 ( V_1531 , L_137 , & V_1410 ) ;
if ( V_1413 )
strcpy ( V_4 -> V_1225 . V_1413 , V_1413 ) ;
if ( F_549 ( V_1531 , L_189 , & V_1410 ) ) {
V_4 -> V_87 |= ( V_88 | V_344 |
V_134 ) ;
}
return 0 ;
...
{
struct V_1520 * V_1541 = F_552 ( V_11 ) ;
struct V_24 * V_498 = F_553 ( & V_1541 -> V_11 ) ;
...
struct V_1538 * V_1539 , char * V_1540 )
{
return F_555 ( V_11 , V_1539 , V_1540 , 1 ) ;
}
...
struct V_24 * V_498 ;
int V_26 ;
V_1541 = F_560 ( L_205 , V_1548 ,
NULL , 0 ) ;
if ( F_561 ( V_1541 ) )
return NULL ;
for ( V_26 = 0 ; V_1549 [ V_26 ] . V_1539 . V_1118 ; V_26 ++ ) {
int V_10 = F_562 ( & V_1541 -> V_11 ,
& V_1549 [ V_26 ] ) ;
if ( V_10 )
goto V_1550;
}
V_498 = F_563 ( sizeof( * V_498 ) , V_801 ) ;
if ( ! V_498 )
goto V_1550;
V_498 -> V_375 = V_1548 ++ ;
...
V_498 -> V_339 = V_543 ;
F_564 ( & V_498 -> V_1552 ) ;
F_565 ( & V_498 -> V_1553 , 0 ) ;
F_566 ( & V_498 -> V_1552 , & V_1554 ) ;
F_567 ( & V_498 -> V_155 ) ;
V_498 -> V_903 = 7500 ;
V_498 -> V_441 = V_1555 ;
...
if ( ! V_498 )
V_498 = F_559 ( V_4 , V_1464 , V_543 ) ;
if ( V_498 ) {
char V_1560 [ 6 ] ;
int V_10 ;
sprintf ( V_1560 , L_206 , V_30 ) ;
V_10 = F_572 ( & V_498 -> V_1541 -> V_11 . V_1561 ,
& V_4 -> V_508 -> V_1561 ,
V_1560 ) ;
if ( ! V_10 ) {
...
sprintf ( V_1560 , L_206 , V_30 ) ;
F_570 ( & V_1559 ) ;
F_576 ( & V_498 -> V_1541 -> V_11 . V_1561 , V_1560 ) ;
V_498 -> V_1427 [ V_30 ] = NULL ;
V_4 -> V_25 = NULL ;
if ( F_577 ( & V_498 -> V_1553 ) ) {
F_578 ( & V_498 -> V_1552 ) ;
F_568 ( V_498 -> V_1541 ) ;
}
F_574 ( & V_1559 ) ;
...
T_14 V_1564 ;
void * V_861 ;
V_861 = F_580 ( V_11 , V_487 , & V_1564 , V_1563 ) ;
if ( V_861 )
* V_1562 = V_1564 ;
return V_861 ;
}
...
{
F_582 ( V_11 , V_487 , V_1565 , V_1562 ) ;
}
static T_1 F_583 ( struct V_508 * V_11 , struct V_485 * V_485 ,
unsigned long V_486 , T_13 V_487 ,
enum V_1566 V_1567 )
{
return F_584 ( V_11 , V_485 , V_486 , V_487 , V_1567 ) ;
}
static void F_585 ( struct V_508 * V_11 , T_1 V_1568 ,
T_13 V_487 , enum V_1566 V_1567 )
{
F_586 ( V_11 , V_1568 , V_487 , V_1567 ) ;
}
static T_1 F_587 ( struct V_508 * V_11 , void * V_1565 ,
T_13 V_487 ,
enum V_1566 V_1567 )
{
return F_588 ( V_11 , V_1565 , V_487 , V_1567 ) ;
}
static void F_589 ( struct V_508 * V_11 , T_1 V_1568 ,
T_13 V_487 ,
enum V_1566 V_1567 )
{
F_590 ( V_11 , V_1568 , V_487 , V_1567 ) ;
}
...
static struct V_308 * F_592 ( struct V_508 * V_1570 ,
...
V_10 = F_600 ( V_1234 ) ;
if ( V_10 ) {
F_226 ( & V_1234 -> V_11 , L_217 ) ;
return V_10 ;
}
if ( ! ( F_601 ( V_1234 , 0 ) & V_1586 ) ||
! ( F_601 ( V_1234 , 2 ) & V_1586 ) ) {
F_226 ( & V_1234 -> V_11 , L_218 ) ;
V_10 = - V_8 ;
goto V_1587;
}
V_10 = F_602 ( V_1234 , V_1227 ) ;
if ( V_10 ) {
F_226 ( & V_1234 -> V_11 , L_219 ) ;
goto V_1587;
}
if ( ! F_603 ( V_1234 ) ) {
F_226 ( & V_1234 -> V_11 , L_220 ) ;
V_10 = - V_8 ;
goto V_1588;
}
V_11 = F_592 ( & V_1234 -> V_11 , V_1234 , NULL ,
& V_1589 , F_604 ( V_1234 -> V_1590 ) ) ;
if ( ! V_11 ) {
V_10 = - V_506 ;
goto V_1588;
}
...
V_1584 . V_1591 . V_1592 = F_605 ( V_1234 -> V_1593 ) ;
V_1584 . V_1591 . V_1593 = V_1234 -> V_1593 -> V_1594 ;
V_1584 . V_1591 . V_508 = F_606 ( V_1234 -> V_1590 ) ;
V_4 -> V_25 = F_569 ( V_4 , & V_1584 ,
V_1544 ) ;
if ( ! V_4 -> V_25 ) {
V_10 = - V_506 ;
goto V_1595;
...
if ( ! V_10 ) {
V_11 -> V_552 |= V_1603 ;
V_10 = F_610 ( V_1234 , V_1585 ) ;
if ( V_10 ) {
F_226 ( & V_1234 -> V_11 , L_221 ) ;
goto V_1604;
}
}
if ( V_10 ) {
...
if ( V_10 ) {
if ( V_10 != - V_8 )
F_226 ( & V_1234 -> V_11 , L_224 ) ;
goto V_1607;
}
V_10 = F_614 ( V_11 ) ;
if ( V_10 ) {
F_226 ( & V_1234 -> V_11 , L_225 ) ;
goto V_1607;
}
F_615 ( V_1234 , V_11 ) ;
F_597 ( V_4 ) ;
...
{
unsigned long V_1609 = F_630 ( V_487 ) ;
unsigned long V_485 = F_631 ( V_1563 , V_1609 ) ;
if ( V_485 == 0UL )
return NULL ;
...
{
unsigned long V_1609 = F_630 ( V_487 ) ;
F_634 ( ( unsigned long ) V_1565 , V_1609 ) ;
}
...
static void F_637 ( struct V_508 * V_11 , T_1 V_1568 ,
T_13 V_487 , enum V_1566 V_1567 )
{
}
static T_1 F_638 ( struct V_508 * V_11 , void * V_1565 ,
T_13 V_487 ,
enum V_1566 V_1567 )
{
return F_632 ( V_1565 ) ;
}
static void F_639 ( struct V_508 * V_11 , T_1 V_1568 ,
T_13 V_487 ,
enum V_1566 V_1567 )
{
}
static int F_640 ( struct V_1520 * V_1521 )
{
union V_1547 V_1584 ;
struct V_308 * V_11 ;
struct V_3 * V_4 ;
...
int V_10 ;
F_591 () ;
V_1 = F_541 ( V_1521 -> V_11 . V_1523 , L_226 , NULL ) ;
if ( ! V_1 ) {
F_226 ( & V_1521 -> V_11 , L_227 ,
V_1521 -> V_11 . V_1523 -> V_1533 ) ;
return - V_8 ;
}
V_11 = F_592 ( & V_1521 -> V_11 , NULL , V_1521 ,
& V_1610 , V_1 [ 0 ] & 0x1 ) ;
if ( ! V_11 ) {
V_10 = - V_506 ;
goto V_1611;
...
V_4 = F_400 ( V_11 ) ;
memset ( & V_1584 , 0 , sizeof( V_1584 ) ) ;
V_1584 . V_1612 = F_641 ( V_1521 -> V_11 . V_1523 ) ;
V_4 -> V_25 = F_569 ( V_4 , & V_1584 ,
V_343 ) ;
if ( ! V_4 -> V_25 ) {
V_10 = - V_506 ;
...
F_598 ( V_11 ) ;
V_4 -> V_1503 = F_642 ( & V_1521 -> V_1613 [ 1 ] , 0 ,
F_643 ( & V_1521 -> V_1613 [ 1 ] ) ,
L_228 ) ;
if ( ! V_4 -> V_1503 ) {
F_226 ( & V_1521 -> V_11 , L_223 ) ;
V_10 = - V_506 ;
goto V_1604;
}
V_4 -> V_1614 = F_642 ( & V_1521 -> V_1613 [ 2 ] , 0 ,
F_643 ( & V_1521 -> V_1613 [ 2 ] ) ,
L_229 ) ;
if ( ! V_4 -> V_1614 ) {
F_226 ( & V_1521 -> V_11 , L_230 ) ;
V_10 = - V_506 ;
goto V_1607;
}
V_4 -> V_1615 = F_642 ( & V_1521 -> V_1613 [ 3 ] , 0 ,
F_643 ( & V_1521 -> V_1613 [ 3 ] ) ,
L_231 ) ;
if ( ! V_4 -> V_1615 ) {
F_226 ( & V_1521 -> V_11 , L_232 ) ;
V_10 = - V_506 ;
goto V_1607;
}
F_596 ( V_11 ) ;
...
if ( V_10 ) {
if ( V_10 != - V_8 )
F_226 ( & V_1521 -> V_11 , L_224 ) ;
goto V_1607;
}
V_10 = F_614 ( V_11 ) ;
if ( V_10 ) {
F_226 ( & V_1521 -> V_11 , L_225 ) ;
goto V_1607;
}
F_644 ( V_1521 , V_11 ) ;
F_597 ( V_4 ) ;
...
V_1607:
if ( V_4 -> V_1614 ) {
F_645 ( & V_1521 -> V_1613 [ 2 ] , V_4 -> V_1614 ,
F_643 ( & V_1521 -> V_1613 [ 2 ] ) ) ;
V_4 -> V_1614 = NULL ;
}
if ( V_4 -> V_1615 ) {
F_645 ( & V_1521 -> V_1613 [ 3 ] , V_4 -> V_1615 ,
F_643 ( & V_1521 -> V_1613 [ 3 ] ) ) ;
V_4 -> V_1615 = NULL ;
}
if ( V_4 -> V_1503 ) {
F_645 ( & V_1521 -> V_1613 [ 1 ] , V_4 -> V_1503 ,
F_643 ( & V_1521 -> V_1613 [ 1 ] ) ) ;
V_4 -> V_1503 = NULL ;
}
V_1604:
...
static int F_646 ( struct V_1520 * V_1521 )
{
struct V_308 * V_11 = F_647 ( V_1521 ) ;
if ( V_11 ) {
struct V_3 * V_4 = F_400 ( V_11 ) ;
F_622 ( V_11 ) ;
if ( V_4 -> V_1614 ) {
