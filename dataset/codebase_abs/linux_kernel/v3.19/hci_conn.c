...
F_59 ( & V_2 -> V_151 ) ;
F_60 ( V_2 ) ;
if ( F_61 ( V_162 , & V_2 -> V_27 ) )
F_62 ( V_2 -> V_3 , & V_2 -> V_18 , V_2 -> V_78 ) ;
F_63 ( V_3 ) ;
F_64 ( V_2 ) ;
return 0 ;
}
struct V_5 * F_65 ( T_7 * V_18 , T_7 * V_130 )
{
int V_163 = F_66 ( V_130 , V_164 ) ;
struct V_5 * V_3 = NULL , * V_165 ;
F_4 ( L_7 , V_130 , V_18 ) ;
F_67 ( & V_166 ) ;
F_68 (d, &hci_dev_list, list) {
if ( ! F_61 ( V_167 , & V_165 -> V_27 ) ||
F_61 ( V_168 , & V_165 -> V_169 ) ||
V_165 -> V_170 != V_171 )
continue;
if ( V_163 ) {
if ( ! F_66 ( & V_165 -> V_17 , V_130 ) ) {
V_3 = V_165 ; break;
}
} else {
if ( F_66 ( & V_165 -> V_17 , V_18 ) ) {
V_3 = V_165 ; break;
}
}
}
...
V_2 -> V_10 = V_105 ;
F_71 ( V_3 , & V_2 -> V_18 , V_2 -> type , V_2 -> V_78 ,
V_92 ) ;
F_29 ( V_2 , V_92 ) ;
F_30 ( V_2 ) ;
F_72 ( V_3 ) ;
...
static void F_74 ( struct V_5 * V_3 , T_3 V_92 )
{
struct V_1 * V_2 ;
if ( V_92 == 0 )
return;
...
static void F_77 ( struct V_174 * V_175 ,
struct V_1 * V_2 )
{
struct V_176 V_9 ;
struct V_5 * V_3 = V_2 -> V_3 ;
T_3 V_177 ;
memset ( & V_9 , 0 , sizeof( V_9 ) ) ;
if ( F_78 ( V_175 , false , & V_177 ) )
return;
V_9 . V_178 = F_8 ( V_3 -> V_179 ) ;
V_9 . V_180 = F_8 ( V_3 -> V_181 ) ;
F_5 ( & V_9 . V_182 , & V_2 -> V_18 ) ;
V_9 . V_183 = V_2 -> V_78 ;
V_9 . V_184 = V_177 ;
V_9 . V_83 = F_8 ( V_2 -> V_185 ) ;
V_9 . V_84 = F_8 ( V_2 -> V_186 ) ;
V_9 . V_81 = F_8 ( V_2 -> V_187 ) ;
V_9 . V_82 = F_8 ( V_2 -> V_188 ) ;
V_9 . V_85 = F_8 ( 0x0000 ) ;
V_9 . V_86 = F_8 ( 0x0000 ) ;
F_79 ( V_175 , V_189 , sizeof( V_9 ) , & V_9 ) ;
V_2 -> V_10 = V_11 ;
}
static void F_80 ( struct V_174 * V_175 ,
struct V_1 * V_2 )
{
struct V_5 * V_3 = V_175 -> V_3 ;
struct V_190 V_9 ;
T_3 V_177 ;
T_3 V_125 ;
F_81 ( V_191 , & V_3 -> V_169 ) ;
if ( F_78 ( V_175 , false , & V_177 ) < 0 )
return;
memset ( & V_9 , 0 , sizeof( V_9 ) ) ;
V_9 . type = V_192 ;
V_9 . V_184 = V_177 ;
V_9 . V_193 = V_2 -> V_78 ;
F_5 ( & V_9 . V_194 , & V_2 -> V_18 ) ;
V_9 . V_195 = V_3 -> V_196 ;
F_79 ( V_175 , V_197 , sizeof( V_9 ) , & V_9 ) ;
V_125 = 0x01 ;
F_79 ( V_175 , V_126 , sizeof( V_125 ) , & V_125 ) ;
V_2 -> V_10 = V_11 ;
}
struct V_1 * F_82 ( struct V_5 * V_3 , T_7 * V_18 ,
T_3 V_78 , T_3 V_198 , T_4 V_199 ,
T_3 V_13 )
{
struct V_75 * V_76 ;
struct V_1 * V_2 ;
...
if ( V_2 )
return F_84 ( - V_204 ) ;
V_201 = F_85 ( V_3 , V_18 , V_78 ) ;
if ( V_201 && F_66 ( & V_201 -> V_205 , V_164 ) ) {
V_18 = & V_201 -> V_205 ;
V_78 = V_206 ;
}
...
V_2 -> V_199 = V_199 ;
F_86 ( & V_175 , V_3 ) ;
if ( F_61 ( V_191 , & V_3 -> V_169 ) ) {
T_3 V_125 = 0x00 ;
F_79 ( & V_175 , V_126 , sizeof( V_125 ) ,
& V_125 ) ;
}
if ( V_2 -> V_13 == V_124 ) {
if ( F_61 ( V_209 , & V_3 -> V_169 ) &&
V_3 -> V_210 == V_211 ) {
F_59 ( & V_175 . V_212 ) ;
F_30 ( V_2 ) ;
return F_84 ( - V_204 ) ;
...
struct V_1 * F_90 ( struct V_5 * V_3 , T_7 * V_18 ,
T_3 V_198 , T_3 V_132 )
{
struct V_1 * V_159 ;
if ( ! F_61 ( V_215 , & V_3 -> V_169 ) )
return F_84 ( - V_216 ) ;
V_159 = F_83 ( V_3 , V_42 , V_18 ) ;
if ( ! V_159 ) {
...
struct V_1 * F_91 ( struct V_5 * V_3 , int type , T_7 * V_18 ,
T_2 V_60 )
{
struct V_1 * V_159 ;
struct V_1 * V_93 ;
V_159 = F_90 ( V_3 , V_18 , V_208 , V_217 ) ;
if ( F_92 ( V_159 ) )
return V_159 ;
V_93 = F_83 ( V_3 , type , V_18 ) ;
if ( ! V_93 ) {
...
F_93 ( V_159 , V_218 ) ;
if ( F_61 ( V_114 , & V_159 -> V_27 ) ) {
F_9 ( V_219 , & V_159 -> V_27 ) ;
return V_93 ;
}
F_28 ( V_159 , 0x00 ) ;
}
...
static int F_97 ( struct V_1 * V_2 , T_1 V_198 , T_1 V_132 )
{
F_4 ( L_1 , V_2 ) ;
if ( V_2 -> V_203 > V_198 )
V_198 = V_2 -> V_203 ;
...
V_9 . V_45 = F_8 ( V_2 -> V_45 ) ;
V_9 . V_231 = 0x01 ;
F_2 ( V_2 -> V_3 , V_232 , sizeof( V_9 ) ,
& V_9 ) ;
}
}
int F_99 ( struct V_1 * V_2 , T_1 V_198 , T_1 V_132 ,
bool V_233 )
{
F_4 ( L_1 , V_2 ) ;
if ( V_2 -> type == V_99 )
return F_100 ( V_2 , V_198 ) ;
if ( V_198 == V_234 )
return 1 ;
if ( V_198 == V_208 && ! F_96 ( V_2 ) )
return 1 ;
if ( ! F_61 ( V_224 , & V_2 -> V_27 ) )
goto V_235;
if ( V_2 -> V_136 == V_222 &&
V_198 == V_236 )
goto V_231;
...
goto V_231;
V_235:
if ( F_61 ( V_229 , & V_2 -> V_27 ) )
return 0 ;
if ( V_233 )
F_9 ( V_244 , & V_2 -> V_27 ) ;
if ( ! F_97 ( V_2 , V_198 , V_132 ) )
return 0 ;
V_231:
if ( F_61 ( V_223 , & V_2 -> V_27 ) )
return 1 ;
...
int F_101 ( struct V_1 * V_2 , T_1 V_198 )
{
F_4 ( L_1 , V_2 ) ;
if ( V_198 != V_238 && V_198 != V_236 )
return 1 ;
if ( V_2 -> V_198 == V_238 ||
V_2 -> V_198 == V_236 )
return 1 ;
...
void F_93 ( struct V_1 * V_2 , T_1 V_250 )
{
struct V_5 * V_3 = V_2 -> V_3 ;
F_4 ( L_3 , V_2 , V_2 -> V_107 ) ;
if ( V_2 -> V_107 != V_251 )
goto V_252;
if ( ! F_61 ( V_142 , & V_2 -> V_27 ) && ! V_250 )
goto V_252;
if ( ! F_39 ( V_114 , & V_2 -> V_27 ) ) {
struct V_253 V_9 ;
V_9 . V_45 = F_8 ( V_2 -> V_45 ) ;
...
if ( F_61 ( V_224 , & V_2 -> V_27 ) )
V_29 |= V_264 ;
if ( F_61 ( V_265 , & V_2 -> V_27 ) )
V_29 |= V_266 ;
if ( F_61 ( V_267 , & V_2 -> V_27 ) )
V_29 |= V_268 ;
return V_29 ;
}
...
{
struct V_1 * V_260 ;
struct V_270 V_175 , * V_271 ;
struct V_272 * V_273 ;
struct V_5 * V_3 ;
int V_261 = 0 , V_274 , V_202 ;
if ( F_112 ( & V_175 , V_269 , sizeof( V_175 ) ) )
return - V_275 ;
if ( ! V_175 . V_276 || V_175 . V_276 > ( V_277 * 2 ) / sizeof( * V_273 ) )
return - V_278 ;
V_274 = sizeof( V_175 ) + V_175 . V_276 * sizeof( * V_273 ) ;
V_271 = F_113 ( V_274 , V_129 ) ;
if ( ! V_271 )
return - V_207 ;
V_3 = F_114 ( V_175 . V_279 ) ;
if ( ! V_3 ) {
F_115 ( V_271 ) ;
return - V_280 ;
}
V_273 = V_271 -> V_281 ;
F_24 ( V_3 ) ;
F_68 (c, &hdev->conn_hash.list, list) {
...
if ( ++ V_261 >= V_175 . V_276 )
break;
}
F_26 ( V_3 ) ;
V_271 -> V_279 = V_3 -> V_282 ;
V_271 -> V_276 = V_261 ;
V_274 = sizeof( V_175 ) + V_261 * sizeof( * V_273 ) ;
F_63 ( V_3 ) ;
V_202 = F_116 ( V_269 , V_271 , V_274 ) ;
F_115 ( V_271 ) ;
return V_202 ? - V_275 : 0 ;
}
...
struct V_272 V_273 ;
struct V_1 * V_2 ;
char T_9 * V_284 = V_269 + sizeof( V_175 ) ;
if ( F_112 ( & V_175 , V_269 , sizeof( V_175 ) ) )
return - V_275 ;
F_24 ( V_3 ) ;
V_2 = F_83 ( V_3 , V_175 . type , & V_175 . V_17 ) ;
if ( V_2 ) {
...
return - V_275 ;
F_24 ( V_3 ) ;
V_2 = F_83 ( V_3 , V_42 , & V_175 . V_17 ) ;
if ( V_2 )
V_175 . type = V_2 -> V_132 ;
F_26 ( V_3 ) ;
if ( ! V_2 )
return - V_285 ;
return F_116 ( V_269 , & V_175 , sizeof( V_175 ) ) ? - V_275 : 0 ;
}
...
{
struct V_287 * V_292 ;
F_68 (hchan, &hcon->chan_list, list) {
if ( V_292 -> V_45 == V_45 )
return V_292 ;
}
return NULL ;
