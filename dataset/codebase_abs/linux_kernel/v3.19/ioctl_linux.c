...
memset ( & V_4 , 0 , sizeof( union V_3 ) ) ;
V_4 . V_10 . V_11 = V_12 ;
memset ( V_4 . V_10 . V_13 , 0 , V_17 ) ;
F_4 ( V_18 , L_2 ) ;
F_2 ( V_2 -> V_5 , V_19 , & V_4 , NULL ) ;
}
static char * F_6 ( struct V_1 * V_2 ,
struct V_20 * V_21 ,
struct V_22 * V_23 ,
char * V_24 , char * V_25 )
{
...
V_24 = F_7 ( V_21 , V_24 , V_25 , & V_27 , V_45 ) ;
V_27 . V_43 = V_46 ;
V_27 . V_44 . V_47 . V_48 = 1 ;
V_27 . V_44 . V_47 . V_49 = F_8 ( T_1 , V_23 -> V_15 . V_50 . V_51 , 32 ) ;
V_24 = F_9 ( V_21 , V_24 , V_25 , & V_27 , V_23 -> V_15 . V_50 . V_50 ) ;
V_33 = F_10 ( & V_23 -> V_15 . V_52 [ 12 ] , V_53 , & V_30 , V_23 -> V_15 . V_54 - 12 ) ;
if ( V_33 && V_30 > 0 ) {
struct V_55 * V_56 ;
V_36 = true ;
...
V_24 = F_7 ( V_21 , V_24 , V_25 , & V_27 , V_68 ) ;
V_27 . V_43 = V_69 ;
memcpy ( & V_29 , F_13 ( V_23 -> V_15 . V_52 ) , 2 ) ;
V_28 = F_14 ( V_29 ) ;
if ( V_28 & ( V_70 | V_71 ) ) {
if ( V_28 & V_71 )
V_27 . V_44 . V_72 = V_73 ;
...
V_27 . V_44 . V_72 = V_74 ;
V_24 = F_7 ( V_21 , V_24 , V_25 , & V_27 , V_75 ) ;
}
if ( V_23 -> V_15 . V_66 . V_67 < 1 )
V_23 -> V_15 . V_66 . V_67 = 1 ;
V_27 . V_43 = V_76 ;
V_27 . V_44 . V_77 . V_78 = F_15 ( V_23 -> V_15 . V_66 . V_67 ) * 100000 ;
V_27 . V_44 . V_77 . V_79 = 1 ;
V_27 . V_44 . V_77 . V_37 = V_23 -> V_15 . V_66 . V_67 ;
V_24 = F_7 ( V_21 , V_24 , V_25 , & V_27 , V_80 ) ;
V_27 . V_43 = V_81 ;
if ( V_28 & V_82 )
...
V_24 = F_7 ( V_21 , V_24 , V_25 , & V_27 , V_91 ) ;
{
T_4 V_92 [ V_93 ] ;
T_4 V_94 [ 255 ] , V_95 [ 255 ] ;
T_1 V_96 = 0 , V_97 = 0 ;
T_4 * V_33 ;
F_16 ( V_23 -> V_15 . V_52 , V_23 -> V_15 . V_54 , V_95 , & V_97 , V_94 , & V_96 ) ;
F_17 ( V_98 , V_99 , ( L_15 , V_23 -> V_15 . V_50 . V_50 ) ) ;
F_17 ( V_98 , V_99 , ( L_16 , V_96 , V_97 ) ) ;
if ( V_96 > 0 ) {
V_33 = V_92 ;
memset ( V_92 , 0 , V_93 ) ;
...
V_24 = F_9 ( V_21 , V_24 , V_25 , & V_27 , V_92 ) ;
memset ( & V_27 , 0 , sizeof( V_27 ) ) ;
V_27 . V_43 = V_101 ;
V_27 . V_44 . V_47 . V_49 = V_96 ;
V_24 = F_9 ( V_21 , V_24 , V_25 , & V_27 , V_94 ) ;
}
if ( V_97 > 0 ) {
V_33 = V_92 ;
memset ( V_92 , 0 , V_93 ) ;
...
V_24 = F_9 ( V_21 , V_24 , V_25 , & V_27 , V_95 ) ;
}
}
{
T_5 V_102 = 0 , V_103 ;
...
while ( V_102 < V_103 ) {
if ( F_18 ( & V_106 [ V_102 ] , & V_105 ) && ( V_105 > 2 ) ) {
V_104 = & V_106 [ V_102 ] ;
V_27 . V_43 = V_101 ;
V_27 . V_44 . V_47 . V_49 = ( T_1 ) V_105 ;
V_24 = F_9 ( V_21 , V_24 , V_25 , & V_27 , V_104 ) ;
}
...
if ( F_19 ( V_8 , V_114 ) == true &&
F_20 ( & V_8 -> V_14 . V_15 , & V_23 -> V_15 ) ) {
...
V_24 = F_7 ( V_21 , V_24 , V_25 , & V_27 , V_123 ) ;
return V_24 ;
}
static int F_21 ( struct V_124 * V_125 , T_3 V_90 )
{
struct V_1 * V_2 = (struct V_1 * ) F_22 ( V_125 ) ;
int V_126 = 0 ;
...
static int F_24 ( struct V_124 * V_125 , struct V_143 * V_144 , T_3 V_145 )
{
int V_126 = 0 ;
...
F_17 ( V_162 , V_99 , ( L_27 , V_146 ) ) ;
F_23 ( L_27 , V_146 ) ;
if ( V_146 > V_161 )
return - V_142 ;
F_17 ( V_162 , V_99 , ( L_28 , V_146 ) ) ;
if ( V_147 > 0 ) {
V_147 = V_147 <= 5 ? 5 : 13 ;
V_148 = V_147 + F_25 ( struct V_149 , V_167 ) ;
V_150 = (struct V_149 * ) F_26 ( V_148 ) ;
if ( V_150 == NULL ) {
F_17 ( V_162 , V_163 , ( L_29 ) ) ;
goto exit;
}
...
if ( F_19 ( V_8 , V_185 | V_186 ) ) {
V_180 = F_29 ( V_183 , F_30 ( V_8 ) ) ;
if ( V_180 == NULL ) {
;
} else {
...
memcpy ( V_180 -> V_191 . V_176 , V_144 -> V_44 . V_153 . V_157 , ( V_144 -> V_44 . V_153 . V_158 > 16 ? 16 : V_144 -> V_44 . V_153 . V_158 ) ) ;
...
F_23 ( L_34 ) ;
F_31 ( V_2 , ( unsigned char * ) V_180 , true ) ;
} else {
memcpy ( V_2 -> V_129 . V_195 [ V_144 -> V_44 . V_153 . V_160 ] . V_176 , V_144 -> V_44 . V_153 . V_157 , ( V_144 -> V_44 . V_153 . V_158 > 16 ? 16 : V_144 -> V_44 . V_153 . V_158 ) ) ;
...
F_28 ( V_2 , & V_2 -> V_129 , V_144 -> V_44 . V_153 . V_160 , 1 ) ;
}
}
V_181 = F_32 ( V_2 ) ;
if ( V_181 == NULL ) {
...
static int F_34 ( struct V_1 * V_2 , char * V_200 , unsigned short V_201 )
{
T_4 * V_92 = NULL ;
int V_202 = 0 , V_203 = 0 ;
int V_126 = 0 ;
if ( ( V_201 > V_93 ) || ( V_200 == NULL ) ) {
F_35 ( & V_2 -> V_9 , V_204 ) ;
if ( V_200 == NULL )
return V_126 ;
else
...
F_23 ( L_37 , V_92 [ V_37 ] , V_92 [ V_37 + 1 ] , V_92 [ V_37 + 2 ] , V_92 [ V_37 + 3 ] , V_92 [ V_37 + 4 ] , V_92 [ V_37 + 5 ] , V_92 [ V_37 + 6 ] , V_92 [ V_37 + 7 ] ) ;
}
if ( V_201 < V_207 ) {
F_17 ( V_162 , V_163 , ( L_38 , V_201 ) ) ;
V_126 = - 1 ;
goto exit;
}
if ( F_37 ( V_92 , V_201 , & V_202 , & V_203 , NULL ) == V_208 ) {
V_2 -> V_129 . V_134 = V_178 ;
V_2 -> V_129 . V_132 = V_138 ;
memcpy ( V_2 -> V_129 . V_209 , & V_92 [ 0 ] , V_201 ) ;
}
if ( F_38 ( V_92 , V_201 , & V_202 , & V_203 , NULL ) == V_208 ) {
V_2 -> V_129 . V_134 = V_178 ;
...
F_23 ( L_39 ) ;
V_2 -> V_129 . V_223 = ( ( V_92 [ V_102 + 1 ] + 2 ) < ( V_93 << 2 ) ) ? ( V_92 [ V_102 + 1 ] + 2 ) : ( V_93 << 2 ) ;
...
T_6 * V_228 = NULL ;
F_17 ( V_98 , V_99 , ( L_41 , V_21 -> V_43 ) ) ;
if ( F_19 ( V_8 , V_114 | V_229 ) == true ) {
V_33 = F_10 ( & V_227 -> V_52 [ 12 ] , V_53 , & V_30 , V_227 -> V_54 - 12 ) ;
if ( V_33 && V_30 > 0 )
V_36 = true ;
V_228 = & V_227 -> V_63 ;
if ( F_11 ( ( T_4 * ) V_228 ) == true ) {
if ( V_36 )
snprintf ( V_4 -> V_64 , V_65 , L_3 ) ;
else
snprintf ( V_4 -> V_64 , V_65 , L_4 ) ;
} else if ( ( F_12 ( ( T_4 * ) V_228 ) ) == true ) {
if ( V_36 )
snprintf ( V_4 -> V_64 , V_65 , L_5 ) ;
else
snprintf ( V_4 -> V_64 , V_65 , L_6 ) ;
} else {
if ( V_227 -> V_66 . V_67 > 14 ) {
if ( V_36 )
...
struct V_226 * V_227 = & V_8 -> V_14 . V_15 ;
if ( F_19 ( V_8 , V_114 ) ) {
V_4 -> V_77 . V_78 = F_15 ( V_227 -> V_66 . V_67 ) * 100000 ;
V_4 -> V_77 . V_79 = 1 ;
V_4 -> V_77 . V_37 = V_227 -> V_66 . V_67 ;
} else {
V_4 -> V_77 . V_78 = F_15 ( V_2 -> V_231 . V_232 ) * 100000 ;
V_4 -> V_77 . V_79 = 1 ;
V_4 -> V_77 . V_37 = V_2 -> V_231 . V_232 ;
}
return 0 ;
}
static int F_43 ( struct V_124 * V_125 , struct V_20 * V_233 ,
...
default:
V_126 = - V_142 ;
F_17 ( V_162 , V_163 , ( L_48 , V_245 [ V_4 -> V_72 ] ) ) ;
goto exit;
}
if ( F_45 ( V_2 , V_236 ) == false ) {
V_126 = - V_237 ;
goto exit;
}
F_46 ( V_2 , V_236 ) ;
...
static int F_47 ( struct V_124 * V_125 , struct V_20 * V_233 ,
union V_3 * V_4 , char * V_234 )
{
struct V_1 * V_2 = (struct V_1 * ) F_22 ( V_125 ) ;
struct V_7 * V_8 = & ( V_2 -> V_9 ) ;
...
if ( F_19 ( V_8 , V_185 ) )
V_4 -> V_72 = V_243 ;
else if ( ( F_19 ( V_8 , V_229 ) ) ||
( F_19 ( V_8 , V_246 ) ) )
V_4 -> V_72 = V_74 ;
else if ( F_19 ( V_8 , V_247 ) )
V_4 -> V_72 = V_73 ;
else
V_4 -> V_72 = V_239 ;
return 0 ;
...
for ( V_248 = 0 ; V_248 < V_256 ; V_248 ++ ) {
if ( ! memcmp ( V_152 -> V_257 [ V_248 ] . V_258 , V_253 , V_17 ) ) {
memset ( V_152 -> V_257 [ V_248 ] . V_258 , 0x00 , V_17 ) ;
...
V_269 -> V_77 [ V_272 ] . V_78 = F_15 ( V_271 -> V_289 [ V_37 ] . V_290 ) * 100000 ;
...
F_23 ( L_57 , V_327 ) ;
V_324 = V_326 -> V_328 ;
F_23 ( L_58 , V_327 , V_326 -> V_43 , V_324 ) ;
switch ( V_326 -> V_43 ) {
case V_329 :
if ( ! F_60 ( V_2 ) )
V_126 = - 1 ;
...
static int F_61 ( struct V_124 * V_125 , struct V_20 * V_233 ,
union V_3 * V_4 , char * V_225 )
{
T_4 V_331 = false ;
int V_126 = 0 ;
...
int V_345 = F_8 ( int , V_343 -> V_346 ,
V_347 ) ;
memcpy ( V_333 [ 0 ] . V_50 , V_343 -> V_348 , V_345 ) ;
V_333 [ 0 ] . V_51 = V_345 ;
F_23 ( L_61 , V_343 -> V_348 , V_343 -> V_346 ) ;
F_52 ( & V_8 -> V_319 ) ;
V_331 = F_62 ( V_2 , V_333 , 1 , NULL , 0 ) ;
F_55 ( & V_8 -> V_319 ) ;
...
V_331 = F_63 ( V_2 , V_333 , V_334 ) ;
} else {
V_331 = F_63 ( V_2 , NULL , 0 ) ;
}
}
if ( ! V_331 )
V_126 = - 1 ;
...
V_365 = 100 ;
V_366 = V_340 | V_341 ;
while ( F_19 ( V_8 , V_366 ) ) {
F_65 ( 30 ) ;
V_102 ++ ;
if ( V_102 > V_365 )
break;
}
F_52 ( & ( V_8 -> V_315 . V_319 ) ) ;
V_310 = F_53 ( V_314 ) ;
V_363 = V_310 -> V_321 ;
while ( V_310 != V_363 ) {
if ( ( V_25 - V_364 ) < V_369 ) {
...
V_23 = F_54 ( V_363 , struct V_22 , V_322 ) ;
if ( F_66 ( V_2 -> V_231 . V_289 , V_23 -> V_15 . V_66 . V_67 ) >= 0 )
V_364 = F_6 ( V_2 , V_233 , V_23 , V_364 , V_25 ) ;
V_363 = V_363 -> V_321 ;
}
...
V_345 = ( V_4 -> V_348 . V_49 < V_347 ) ? V_4 -> V_348 . V_49 : V_347 ;
if ( V_4 -> V_348 . V_49 != 33 )
F_23 ( L_67 , V_225 , V_4 -> V_348 . V_49 ) ;
memset ( & V_371 , 0 , sizeof( struct V_332 ) ) ;
V_371 . V_51 = V_345 ;
memcpy ( V_371 . V_50 , V_225 , V_345 ) ;
V_373 = V_371 . V_50 ;
F_17 ( V_162 , V_99 , ( L_68 , V_373 ) ) ;
F_52 ( & V_314 -> V_319 ) ;
V_310 = F_53 ( V_314 ) ;
V_8 -> V_320 = V_310 -> V_321 ;
while ( V_310 != V_8 -> V_320 ) {
...
( L_71 , V_317 ) ) ;
F_56 ( V_2 , V_317 ) ;
if ( F_69 ( V_2 , & V_371 ) == false ) {
V_126 = - 1 ;
goto exit;
}
}
exit:
F_23 ( L_72 , V_327 , V_126 ) ;
return V_126 ;
}
...
F_17 ( V_98 , V_99 , ( L_74 ) ) ;
F_17 ( V_162 , V_99 , ( L_75 , V_376 , V_88 ) ) ;
if ( V_376 == - 1 ) {
V_377 = 11 ;
goto V_379;
}
...
F_17 ( V_162 , V_99 , ( L_76 , V_374 [ V_37 ] ) ) ;
}
return 0 ;
}
...
{
T_1 V_34 = 0 ;
V_34 = F_73 ( (struct V_1 * ) F_22 ( V_125 ) ) ;
if ( V_34 == 0 )
return - V_237 ;
V_4 -> V_87 . V_88 = 0 ;
...
F_23 ( L_77 , V_327 , V_2 -> V_335 . V_381 ) ;
return 0 ;
}
...
F_23 ( L_78 , V_327 , V_2 -> V_383 . V_384 ) ;
return 0 ;
}
...
V_388 . V_169 = V_388 . V_168 + F_25 ( struct V_149 , V_167 ) ;
} else {
V_388 . V_168 = 0 ;
if ( V_387 == 1 ) {
V_2 -> V_129 . V_395 = V_157 ;
F_23 ( L_85 , V_157 , V_2 -> V_129 . V_177 [ V_157 ] ) ;
...
int V_126 ;
struct V_1 * V_2 = (struct V_1 * ) F_22 ( V_125 ) ;
V_126 = F_34 ( V_2 , V_225 , V_4 -> V_47 . V_49 ) ;
return V_126 ;
}
...
V_126 = F_21 ( V_125 , ( T_3 ) V_144 -> V_90 ) ;
break;
case V_412 :
break;
case V_413 :
...
static int F_88 ( struct V_124 * V_125 ,
struct V_20 * V_21 ,
union V_3 * V_4 , char * V_225 )
{
char * V_415 ;
...
V_144 = (struct V_143 * ) F_26 ( V_145 ) ;
if ( V_144 == NULL )
return - 1 ;
memset ( V_144 , 0 , V_145 ) ;
V_144 -> V_43 = V_419 ;
memset ( V_144 -> V_159 , 0xff , V_17 ) ;
switch ( V_418 -> V_155 ) {
case V_420 :
V_415 = L_32 ;
break;
...
static int F_90 ( struct V_124 * V_125 , struct V_20 * V_233 ,
union V_3 * V_4 , char * V_234 )
{
return - 1 ;
}
static int F_91 ( struct V_124 * V_125 , T_4 V_64 , T_3 V_90 )
{
T_5 V_126 = 0 ;
struct V_1 * V_2 = (struct V_1 * ) F_22 ( V_125 ) ;
switch ( V_64 ) {
...
static int F_92 ( struct V_124 * V_125 , T_3 V_437 , T_3 V_324 )
{
int V_126 = 0 ;
struct V_1 * V_2 = (struct V_1 * ) F_22 ( V_125 ) ;
switch ( V_437 ) {
...
static int F_93 ( struct V_124 * V_125 , struct V_389 * V_33 )
{
struct V_143 * V_144 ;
T_5 V_126 = 0 ;
...
V_144 = (struct V_143 * ) F_26 ( V_33 -> V_49 ) ;
if ( V_144 == NULL ) {
V_126 = - V_206 ;
goto V_441;
}
if ( F_94 ( V_144 , V_33 -> V_440 , V_33 -> V_49 ) ) {
F_33 ( V_144 ) ;
V_126 = - V_442 ;
goto V_441;
}
switch ( V_144 -> V_43 ) {
case V_443 :
V_126 = F_91 ( V_125 , V_144 -> V_44 . V_444 . V_64 , V_144 -> V_44 . V_444 . V_90 ) ;
break;
case V_445 :
V_126 = F_34 ( (struct V_1 * ) F_22 ( V_125 ) ,
( char * ) V_144 -> V_44 . V_94 . V_47 , ( T_1 ) V_144 -> V_44 . V_94 . V_345 ) ;
break;
case V_419 :
V_126 = F_24 ( V_125 , V_144 , V_33 -> V_49 ) ;
break;
case V_446 :
V_126 = F_92 ( V_125 , V_144 -> V_44 . V_326 . V_437 , V_144 -> V_44 . V_326 . V_328 ) ;
break;
default:
F_23 ( L_90 , V_144 -> V_43 ) ;
V_126 = - V_174 ;
break;
}
if ( V_126 == 0 && F_95 ( V_33 -> V_440 , V_144 , V_33 -> V_49 ) )
V_126 = - V_442 ;
F_33 ( V_144 ) ;
V_441:
return V_126 ;
}
static T_4 F_96 ( struct V_1 * V_2 , struct V_179 * V_180 )
{
struct V_447 * V_448 ;
struct V_449 * V_450 ;
struct V_451 * V_452 = & V_2 -> V_453 ;
T_4 V_454 = V_208 ;
V_448 = F_97 ( sizeof( struct V_447 ) , V_205 ) ;
if ( V_448 == NULL ) {
V_454 = V_173 ;
goto exit;
}
V_450 = F_97 ( sizeof( struct V_449 ) , V_205 ) ;
if ( V_450 == NULL ) {
F_33 ( V_448 ) ;
V_454 = V_173 ;
goto exit;
}
F_98 ( V_448 , V_450 , V_455 ) ;
V_450 -> V_456 = ( T_4 ) V_180 -> V_190 ;
memcpy ( V_450 -> V_457 , V_180 -> V_458 , V_17 ) ;
memcpy ( V_450 -> V_157 , & V_180 -> V_191 , 16 ) ;
V_454 = F_99 ( V_452 , V_448 ) ;
exit:
return V_454 ;
}
static int F_100 ( struct V_1 * V_2 , T_4 * V_157 , T_4 V_155 , int V_459 )
{
T_4 V_460 ;
struct V_447 * V_461 ;
struct V_462 * V_463 ;
...
int V_454 = V_208 ;
F_23 ( L_57 , V_327 ) ;
V_461 = F_97 ( sizeof( struct V_447 ) , V_205 ) ;
if ( V_461 == NULL ) {
V_454 = V_173 ;
goto exit;
}
V_463 = F_97 ( sizeof( struct V_462 ) , V_205 ) ;
if ( V_463 == NULL ) {
F_33 ( V_461 ) ;
V_454 = V_173 ;
goto exit;
...
V_461 -> V_470 = 0 ;
F_101 ( & V_461 -> V_322 ) ;
V_454 = F_99 ( V_452 , V_461 ) ;
exit:
return V_454 ;
}
static int F_102 ( struct V_1 * V_2 , T_4 * V_157 , T_4 V_460 , int V_459 )
{
T_4 V_155 ;
switch ( V_460 ) {
case 5 :
...
return F_100 ( V_2 , V_157 , V_155 , V_459 ) ;
}
static int F_103 ( struct V_124 * V_125 , struct V_143 * V_144 , T_3 V_145 )
{
int V_126 = 0 ;
T_3 V_146 , V_147 , V_148 ;
struct V_149 * V_150 = NULL ;
...
V_180 = F_29 ( V_183 , V_144 -> V_159 ) ;
if ( ! V_180 ) {
F_23 ( L_91 ) ;
goto exit;
}
}
if ( strcmp ( V_144 -> V_44 . V_153 . V_155 , L_32 ) == 0 && ( V_180 == NULL ) ) {
F_23 ( L_92 , V_144 -> V_44 . V_153 . V_160 ) ;
goto exit;
}
if ( strcmp ( V_144 -> V_44 . V_153 . V_155 , L_25 ) == 0 && ( V_180 == NULL ) ) {
F_23 ( L_93 ) ;
V_146 = V_144 -> V_44 . V_153 . V_160 ;
V_147 = V_144 -> V_44 . V_153 . V_158 ;
F_23 ( L_94 , V_146 , V_147 ) ;
...
memcpy ( & ( V_152 -> V_175 [ V_146 ] . V_176 [ 0 ] ) , V_150 -> V_167 , V_150 -> V_168 ) ;
V_152 -> V_177 [ V_146 ] = V_150 -> V_168 ;
F_102 ( V_2 , V_150 -> V_167 , V_150 -> V_168 , V_146 ) ;
} else {
F_23 ( L_31 ) ;
memcpy ( & ( V_152 -> V_175 [ V_146 ] . V_176 [ 0 ] ) , V_150 -> V_167 , V_150 -> V_168 ) ;
V_152 -> V_177 [ V_146 ] = V_150 -> V_168 ;
...
if ( ! V_180 && F_19 ( V_8 , V_247 ) ) {
if ( V_144 -> V_44 . V_153 . V_172 == 1 ) {
if ( strcmp ( V_144 -> V_44 . V_153 . V_155 , L_25 ) == 0 ) {
F_23 ( L_96 , V_327 ) ;
memcpy ( V_152 -> V_195 [ V_144 -> V_44 . V_153 . V_160 ] . V_176 ,
V_144 -> V_44 . V_153 . V_157 , ( V_144 -> V_44 . V_153 . V_158 > 16 ? 16 : V_144 -> V_44 . V_153 . V_158 ) ) ;
V_152 -> V_166 = V_165 ;
...
F_100 ( V_2 , V_144 -> V_44 . V_153 . V_157 , V_152 -> V_166 , V_144 -> V_44 . V_153 . V_160 ) ;
V_181 = F_32 ( V_2 ) ;
if ( V_181 ) {
V_181 -> V_187 = false ;
...
static int F_104 ( struct V_124 * V_125 , struct V_143 * V_144 , int V_345 )
{
int V_126 = 0 ;
struct V_1 * V_2 = (struct V_1 * ) F_22 ( V_125 ) ;
struct V_7 * V_8 = & ( V_2 -> V_9 ) ;
...
F_23 ( L_104 , V_327 , V_345 ) ;
if ( F_19 ( V_8 , V_247 ) != true )
return - V_142 ;
memcpy ( & V_183 -> V_473 , V_144 -> V_44 . V_472 . V_474 , 2 ) ;
if ( ( V_183 -> V_473 > V_475 ) || ( V_183 -> V_473 <= 0 ) )
V_183 -> V_473 = V_475 ;
if ( F_105 ( V_2 , V_471 , ( V_345 - 12 - 2 ) ) == V_208 )
V_126 = 0 ;
else
V_126 = - V_142 ;
return V_126 ;
...
static int F_109 ( struct V_124 * V_125 , struct V_143 * V_144 )
{
int V_126 = 0 ;
...
struct V_7 * V_8 = & ( V_2 -> V_9 ) ;
struct V_182 * V_183 = & V_2 -> V_184 ;
F_23 ( L_105 , V_144 -> V_44 . V_476 . V_477 , ( V_144 -> V_159 ) ) ;
if ( ! F_19 ( V_8 , ( V_114 | V_247 ) ) )
return - V_142 ;
if ( V_144 -> V_159 [ 0 ] == 0xff && V_144 -> V_159 [ 1 ] == 0xff &&
V_144 -> V_159 [ 2 ] == 0xff && V_144 -> V_159 [ 3 ] == 0xff &&
V_144 -> V_159 [ 4 ] == 0xff && V_144 -> V_159 [ 5 ] == 0xff )
...
V_180 -> V_481 = 1 ;
memcpy ( ( void * ) & V_180 -> V_484 . V_36 , ( void * ) & V_144 -> V_44 . V_476 . V_36 , sizeof( struct V_55 ) ) ;
} else {
...
static int F_111 ( struct V_124 * V_125 , struct V_143 * V_144 )
{
int V_126 = 0 ;
struct V_179 * V_180 = NULL ;
struct V_1 * V_2 = (struct V_1 * ) F_22 ( V_125 ) ;
...
struct V_182 * V_183 = & V_2 -> V_184 ;
int V_110 = 0 ;
F_23 ( L_106 , ( V_144 -> V_159 ) ) ;
if ( F_19 ( V_8 , ( V_114 | V_247 ) ) != true )
return - V_142 ;
if ( V_144 -> V_159 [ 0 ] == 0xff && V_144 -> V_159 [ 1 ] == 0xff &&
V_144 -> V_159 [ 2 ] == 0xff && V_144 -> V_159 [ 3 ] == 0xff &&
V_144 -> V_159 [ 4 ] == 0xff && V_144 -> V_159 [ 5 ] == 0xff )
...
if ( V_180 ) {
F_52 ( & V_183 -> V_486 ) ;
if ( ! F_112 ( & V_180 -> V_487 ) ) {
F_113 ( & V_180 -> V_487 ) ;
V_183 -> V_488 -- ;
V_110 = F_114 ( V_2 , V_180 , true , V_489 ) ;
}
F_55 ( & V_183 -> V_486 ) ;
F_115 ( V_2 , V_110 ) ;
V_180 = NULL ;
...
static int F_116 ( struct V_124 * V_125 , struct V_143 * V_144 , int V_345 )
{
int V_126 = 0 ;
struct V_179 * V_180 = NULL ;
struct V_1 * V_2 = (struct V_1 * ) F_22 ( V_125 ) ;
...
memcpy ( & V_493 -> V_36 , & V_180 -> V_484 . V_36 , sizeof( struct V_55 ) ) ;
...
static int F_117 ( struct V_124 * V_125 , struct V_143 * V_144 )
{
int V_126 = 0 ;
struct V_179 * V_180 = NULL ;
struct V_1 * V_2 = (struct V_1 * ) F_22 ( V_125 ) ;
...
V_180 = F_29 ( V_183 , V_144 -> V_159 ) ;
if ( V_180 ) {
if ( ( V_180 -> V_94 [ 0 ] == V_512 ) || ( V_180 -> V_94 [ 0 ] == V_513 ) ) {
int V_514 ;
int V_515 ;
V_514 = V_180 -> V_94 [ 1 ] ;
V_515 = ( ( V_514 + 2 ) > sizeof( V_180 -> V_94 ) ) ? ( sizeof( V_180 -> V_94 ) ) : ( V_514 + 2 ) ;
...
static int F_118 ( struct V_124 * V_125 , struct V_143 * V_144 , int V_345 )
{
int V_126 = 0 ;
...
V_8 -> V_517 = NULL ;
if ( V_516 > 0 ) {
V_8 -> V_517 = F_26 ( V_516 ) ;
V_8 -> V_518 = V_516 ;
if ( V_8 -> V_517 == NULL ) {
F_23 ( L_111 , V_327 , __LINE__ ) ;
return - V_142 ;
}
memcpy ( V_8 -> V_517 , V_144 -> V_44 . V_472 . V_92 , V_516 ) ;
F_119 ( V_2 , V_222 , V_221 , true ) ;
V_271 -> V_519 = true ;
}
return V_126 ;
}
...
static int F_121 ( struct V_124 * V_125 , struct V_143 * V_144 , int V_345 )
{
int V_126 = 0 ;
struct V_1 * V_2 = (struct V_1 * ) F_22 ( V_125 ) ;
struct V_7 * V_8 = & ( V_2 -> V_9 ) ;
...
if ( F_19 ( V_8 , V_247 ) != true )
return - V_142 ;
if ( V_144 -> V_44 . V_444 . V_64 != 0 )
F_23 ( L_112 , V_327 , V_144 -> V_44 . V_444 . V_64 ) ;
V_90 = V_144 -> V_44 . V_444 . V_90 ;
if ( V_90 != 1 && V_90 != 2 )
V_90 = 0 ;
F_23 ( L_113 , V_327 , V_90 ) ;
V_525 -> V_527 = V_90 ;
return V_126 ;
}
static int F_123 ( struct V_124 * V_125 , struct V_143 * V_144 , int V_345 )
{
int V_126 = 0 ;
struct V_1 * V_2 = (struct V_1 * ) F_22 ( V_125 ) ;
struct V_7 * V_8 = & ( V_2 -> V_9 ) ;
...
if ( F_19 ( V_8 , V_247 ) != true )
return - V_142 ;
F_128 ( V_2 , V_144 -> V_44 . V_326 . V_437 ) ;
return V_126 ;
}
static int F_129 ( struct V_124 * V_125 , struct V_389 * V_33 )
{
struct V_143 * V_144 ;
int V_126 = 0 ;
struct V_1 * V_2 = (struct V_1 * ) F_22 ( V_125 ) ;
...
break;
case V_529 :
V_126 = F_109 ( V_125 , V_144 ) ;
break;
case V_530 :
V_126 = F_111 ( V_125 , V_144 ) ;
break;
case V_531 :
V_126 = F_104 ( V_125 , V_144 , V_33 -> V_49 ) ;
break;
case V_532 :
V_126 = F_103 ( V_125 , V_144 , V_33 -> V_49 ) ;
break;
case V_533 :
V_126 = F_117 ( V_125 , V_144 ) ;
break;
case V_534 :
V_126 = F_118 ( V_125 , V_144 , V_33 -> V_49 ) ;
break;
case V_535 :
V_126 = F_120 ( V_125 , V_144 , V_33 -> V_49 ) ;
break;
case V_536 :
V_126 = F_121 ( V_125 , V_144 , V_33 -> V_49 ) ;
break;
case V_537 :
V_126 = F_122 ( V_125 , V_144 , V_33 -> V_49 ) ;
break;
case V_538 :
V_126 = F_116 ( V_125 , V_144 , V_33 -> V_49 ) ;
break;
case V_539 :
...
break;
case V_541 :
V_126 = F_123 ( V_125 , V_144 , V_33 -> V_49 ) ;
break;
default:
F_23 ( L_114 , V_144 -> V_43 ) ;
V_126 = - V_174 ;
break;
}
if ( V_126 == 0 && F_95 ( V_33 -> V_440 , V_144 , V_33 -> V_49 ) )
...
static int F_130 ( struct V_124 * V_125 ,
struct V_20 * V_21 ,
union V_3 * V_306 ,
char * V_225 )
{
...
if ( ! V_542 )
return - V_206 ;
if ( F_94 ( V_542 , V_543 -> V_440 , V_345 ) ) {
F_132 ( V_542 ) ;
return - V_442 ;
}
...
V_544 = V_546 > V_547 ? V_547 : V_546 ;
V_8 -> V_548 = 0 ;
F_33 ( V_8 -> V_549 ) ;
V_8 -> V_549 = NULL ;
V_8 -> V_549 = F_26 ( V_544 ) ;
if ( V_8 -> V_549 == NULL ) {
F_133 ( L_111 , V_327 , __LINE__ ) ;
V_126 = - V_142 ;
goto V_550;
}
...
V_126 = F_61 ( V_125 , V_21 , V_306 , V_542 ) ;
goto V_550;
}
V_550:
F_132 ( V_542 ) ;
...
static struct V_551 * F_134 ( struct V_124 * V_125 )
{
struct V_1 * V_2 = (struct V_1 * ) F_22 ( V_125 ) ;
...
int F_135 ( struct V_124 * V_125 , struct V_558 * V_559 , int V_43 )
{
struct V_560 * V_561 = (struct V_560 * ) V_559 ;
int V_126 = 0 ;
switch ( V_43 ) {
case V_562 :
V_126 = F_93 ( V_125 , & V_561 -> V_44 . V_47 ) ;
break;
#ifdef F_136
case V_563 :
V_126 = F_129 ( V_125 , & V_561 -> V_44 . V_47 ) ;
break;
#endif
case ( V_564 + 1 ) :
V_126 = F_137 ( V_125 , V_559 , V_43 ) ;
break;
default:
V_126 = - V_174 ;
break;
