...
V_4 = V_13 ;
V_4 -> V_9 = V_24 + sizeof( struct V_188 ) ;
V_4 -> V_31 . V_189 . V_146 = 0 ;
V_4 -> V_31 . V_189 . V_28 = V_48 -> V_28 ;
if ( V_52 -> V_62 & V_144 ) {
V_4 -> V_11 = V_190 ;
V_4 -> V_31 . V_189 . V_4 [ 0 ] = ( V_52 -> V_62 >> 24 ) & 0x1f ;
V_4 -> V_31 . V_189 . V_4 [ 1 ] = ( V_52 -> V_62 >> 18 ) & 0x3f ;
V_4 -> V_31 . V_189 . V_4 [ 2 ] = ( V_52 -> V_62 >> 14 ) & 0x0f ;
V_4 -> V_31 . V_189 . V_4 [ 3 ] = ( V_52 -> V_62 >> 6 ) & 0xff ;
V_4 -> V_31 . V_189 . V_4 [ 4 ] = V_52 -> V_62 & 0x3f ;
} else {
V_4 -> V_11 = V_191 ;
V_4 -> V_31 . V_189 . V_4 [ 0 ] = ( V_52 -> V_62 >> 6 ) & 0x1f ;
V_4 -> V_31 . V_189 . V_4 [ 1 ] = V_52 -> V_62 & 0x3f ;
}
V_4 -> V_31 . V_189 . V_4 [ 5 ] = V_52 -> V_66 ;
memcpy ( & V_4 -> V_31 . V_189 . V_4 [ 6 ] , V_52 -> V_92 , V_52 -> V_66 ) ;
if ( V_52 -> V_62 & V_147 )
V_4 -> V_31 . V_189 . V_146 |= V_140 ;
for ( V_81 = 0 ; V_81 < F_77 ( V_48 -> V_56 ) ; V_81 ++ ) {
...
F_71 , V_46 ) ;
F_31 ( V_75 , & V_48 -> V_80 ) ;
F_78 ( V_50 , V_55 , V_46 -> V_73 ) ;
F_79 ( & V_48 -> V_74 ) ;
if ( F_80 ( & V_48 -> V_74 ) >= V_57 )
F_70 ( V_55 ) ;
V_14 = F_32 ( V_75 , V_79 ) ;
if ( F_81 ( V_14 ) ) {
F_82 ( V_55 , V_46 -> V_73 ) ;
...
{
struct V_47 * V_48 = F_63 ( V_55 ) ;
struct V_194 * V_195 = & V_48 -> V_58 . V_196 ;
struct V_1 * V_2 = V_48 -> V_2 ;
struct V_3 * V_4 ;
int V_29 ;
V_4 = F_12 ( sizeof( * V_4 ) , V_20 ) ;
...
return - V_21 ;
V_4 -> V_11 = V_197 ;
V_4 -> V_9 = V_24 + sizeof( struct V_198 ) ;
V_4 -> V_31 . V_199 . V_28 = V_48 -> V_28 ;
V_4 -> V_31 . V_199 . V_33 = 0xff ;
V_4 -> V_31 . V_199 . V_200 = F_84 ( V_195 -> V_200 ) ;
V_4 -> V_31 . V_199 . V_201 = V_195 -> V_201 ;
V_4 -> V_31 . V_199 . V_202 = V_195 -> V_203 + V_195 -> V_204 ;
V_4 -> V_31 . V_199 . V_205 = V_195 -> V_206 ;
if ( V_48 -> V_58 . V_172 & V_207 )
V_4 -> V_31 . V_199 . V_208 = 3 ;
else
V_4 -> V_31 . V_199 . V_208 = 1 ;
V_29 = F_1 ( V_2 , V_4 ) ;
F_10 ( V_4 ) ;
return V_29 ;
}
...
const struct V_216 * V_11 , int V_28 )
{
struct V_1 * V_2 = F_91 ( V_215 ) ;
struct V_76 * V_55 ;
struct V_47 * V_48 ;
int V_81 , V_14 ;
V_14 = F_11 ( V_2 , V_183 , V_28 ) ;
if ( V_14 )
return V_14 ;
...
V_48 -> V_28 = V_28 ;
V_48 -> V_58 . V_60 = V_184 ;
V_48 -> V_58 . clock . V_217 = V_218 ;
V_48 -> V_58 . V_219 = & V_220 ;
V_48 -> V_58 . V_221 = F_83 ;
V_48 -> V_58 . V_222 = F_85 ;
if ( V_11 -> V_223 & V_224 )
V_48 -> V_58 . V_225 = F_86 ;
V_48 -> V_58 . V_226 = V_207 ;
if ( V_11 -> V_223 & V_227 )
V_48 -> V_58 . V_226 |= V_173 ;
V_55 -> V_146 |= V_228 ;
V_55 -> V_229 = & V_230 ;
F_94 ( V_55 , & V_215 -> V_2 ) ;
V_55 -> V_231 = V_28 ;
...
static int F_96 ( const struct V_214 * V_215 ,
struct V_232 * * V_233 ,
struct V_232 * * V_234 )
{
...
int V_81 ;
V_236 = & V_215 -> V_238 [ 0 ] ;
for ( V_81 = 0 ; V_81 < V_236 -> V_239 . V_240 ; ++ V_81 ) {
V_237 = & V_236 -> V_237 [ V_81 ] . V_239 ;
if ( ! * V_233 && F_97 ( V_237 ) )
* V_233 = V_237 ;
if ( ! * V_234 && F_98 ( V_237 ) )
* V_234 = V_237 ;
...
static int F_99 ( struct V_214 * V_215 ,
const struct V_216 * V_11 )
{
struct V_1 * V_2 ;
int V_14 = - V_21 ;
int V_81 , V_241 = 3 ;
V_2 = F_100 ( & V_215 -> V_2 , sizeof( * V_2 ) , V_20 ) ;
if ( ! V_2 )
return - V_21 ;
V_14 = F_96 ( V_215 , & V_2 -> V_22 , & V_2 -> V_7 ) ;
if ( V_14 ) {
F_8 ( & V_215 -> V_2 , L_27 ) ;
return V_14 ;
}
...
F_103 ( & V_215 -> V_2 , L_30 ,
( ( V_2 -> V_36 >> 24 ) & 0xff ) ,
( ( V_2 -> V_36 >> 16 ) & 0xff ) ,
( V_2 -> V_36 & 0xffff ) ) ;
for ( V_81 = 0 ; V_81 < V_2 -> V_40 ; V_81 ++ ) {
V_14 = F_90 ( V_215 , V_11 , V_81 ) ;
if ( V_14 ) {
F_87 ( V_2 ) ;
return V_14 ;
}
...
static void F_104 ( struct V_214 * V_215 )
{
struct V_1 * V_2 = F_91 ( V_215 ) ;
F_102 ( V_215 , NULL ) ;
if ( ! V_2 )
