...
if ( ! V_13 -> V_190 ) {
V_179 = F_84 ( & V_174 -> V_14 , V_13 -> V_96 , NULL ,
F_36 ,
V_215 |
V_216 ,
...
F_85 ( & V_13 -> V_93 ) ;
F_86 ( & V_13 -> V_93 , F_31 , ( unsigned long ) V_13 ) ;
F_34 ( & V_13 -> V_93 , V_94 +
F_35 ( V_13 -> V_43 . V_95 ) ) ;
return 0 ;
}
...
V_187:
if ( ! F_68 ( V_13 -> V_185 ) )
return F_88 ( V_13 -> V_185 ) ;
return V_179 ;
}
static int F_89 ( struct V_173 * V_174 )
{
int V_20 ;
struct V_12 * V_13 = F_90 ( V_174 ) ;
if ( ! V_13 -> V_190 )
F_91 ( & V_174 -> V_14 , V_13 -> V_96 , V_13 ) ;
else
F_92 ( & V_13 -> V_93 ) ;
for ( V_20 = 0 ; V_20 < V_13 -> V_88 . V_89 ; V_20 ++ )
F_93 ( & V_13 -> V_88 , & V_13 -> V_2 [ V_20 ] ) ;
F_87 ( & V_13 -> V_88 ) ;
if ( ! F_68 ( V_13 -> V_185 ) )
return F_88 ( V_13 -> V_185 ) ;
return 0 ;
