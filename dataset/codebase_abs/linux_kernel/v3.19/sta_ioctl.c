...
int
F_64 ( struct V_20 * V_21 , T_2 V_286 )
{
if ( F_59 ( V_21 ) == V_286 ) {
F_8 ( V_21 -> V_12 -> V_4 ,
L_39 ) ;
...
F_9 ( V_21 , V_289 ,
V_33 , 0 , NULL , true ) ;
return F_67 ( V_21 , false ) ;
}
int
F_68 ( struct V_20 * V_21 ,
struct V_290 * log )
{
return F_9 ( V_21 , V_291 ,
V_134 , 0 , log , true ) ;
}
...
return F_9 ( V_21 , V_294 , V_120 , 0 , V_293 , true ) ;
}
int
F_70 ( struct V_20 * V_21 , T_4 V_305 ,
T_4 V_306 , T_4 V_307 )
{
struct V_292 V_293 ;
V_293 . type = F_38 ( V_305 ) ;
V_293 . V_308 = F_38 ( V_306 ) ;
V_293 . V_309 = F_38 ( V_307 ) ;
return F_69 ( V_21 , & V_293 , V_33 ) ;
}
int
F_71 ( struct V_20 * V_21 , T_4 V_305 ,
T_4 V_306 , T_4 * V_309 )
{
int V_23 ;
struct V_292 V_293 ;
V_293 . type = F_38 ( V_305 ) ;
V_293 . V_308 = F_38 ( V_306 ) ;
V_23 = F_69 ( V_21 , & V_293 , V_134 ) ;
if ( V_23 )
goto V_95;
* V_309 = F_37 ( V_293 . V_309 ) ;
V_95:
return V_23 ;
}
int
F_72 ( struct V_20 * V_21 , T_1 V_308 , T_1 V_310 ,
T_2 * V_309 )
{
int V_23 ;
struct V_311 V_312 ;
V_312 . V_308 = F_48 ( ( T_1 ) V_308 ) ;
V_312 . V_313 = F_48 ( ( T_1 ) V_310 ) ;
V_23 = F_9 ( V_21 , V_314 ,
V_134 , 0 , & V_312 , true ) ;
if ( ! V_23 )
...
static int
F_73 ( struct V_20 * V_21 , T_2 * V_203 ,
T_1 V_204 )
{
int V_23 = 0 ;
struct V_316 * V_317 ;
...
if ( ! V_204 ) {
V_21 -> V_320 = 0 ;
V_21 -> V_321 . V_322 = false ;
return 0 ;
} else if ( ! V_203 ) {
return - 1 ;
}
V_317 = (struct V_316 * ) V_203 ;
if ( ( ( V_317 -> V_323 == V_207 ) &&
( ! memcmp ( V_317 -> V_324 , V_318 , sizeof( V_318 ) ) ) ) ||
( V_317 -> V_323 == V_209 ) ) {
V_23 = F_50 ( V_21 , V_203 , V_204 ) ;
V_21 -> V_321 . V_322 = false ;
return V_23 ;
} else if ( V_317 -> V_323 == V_213 ) {
V_23 = F_51 ( V_21 , V_203 , V_204 ) ;
return V_23 ;
}
if ( V_204 < ( sizeof( V_21 -> V_325 ) - V_21 -> V_320 ) ) {
V_317 = (struct V_316 * ) V_203 ;
if ( ( V_317 -> V_323 == V_207 ) &&
( ! memcmp ( V_317 -> V_324 , V_319 , sizeof( V_319 ) ) ) ) {
V_21 -> V_321 . V_322 = true ;
F_8 ( V_21 -> V_12 -> V_4 ,
L_40 ) ;
V_23 = F_52 ( V_21 , V_203 , V_204 ) ;
}
memcpy ( V_21 -> V_325 + V_21 -> V_320 , V_203 ,
V_204 ) ;
V_21 -> V_320 += V_204 ;
} else {
V_23 = - 1 ;
...
case V_328 :
if ( V_120 == V_134 ) {
V_327 -> V_46 = V_21 -> V_206 ;
memcpy ( V_327 -> V_329 , V_21 -> V_205 , V_327 -> V_46 ) ;
} else {
F_73 ( V_21 , V_327 -> V_329 ,
( T_1 ) V_327 -> V_46 ) ;
}
break;
case V_330 :
memset ( V_12 -> V_331 , 0 , sizeof( V_12 -> V_331 ) ) ;
if ( V_327 -> V_46 > V_332 ) {
V_12 -> V_333 = 0 ;
F_5 ( V_12 -> V_4 , L_41 ) ;
return - 1 ;
} else {
memcpy ( V_12 -> V_331 , V_327 -> V_329 ,
V_327 -> V_46 ) ;
V_12 -> V_333 = V_327 -> V_46 ;
}
break;
default:
F_5 ( V_12 -> V_4 , L_42 ) ;
...
int
F_75 ( struct V_20 * V_21 , const T_2 * V_334 , int V_204 )
{
struct V_326 V_327 ;
if ( V_204 > V_335 )
return - V_336 ;
V_327 . type = V_328 ;
V_327 . V_46 = V_204 ;
memcpy ( V_327 . V_329 , V_334 , V_204 ) ;
if ( F_74 ( V_21 , & V_327 , V_33 ) )
return - V_336 ;
return 0 ;
}
