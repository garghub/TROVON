...
int V_97 ;
int V_43 ;
V_148 = F_100 ( V_103 , V_149 , 0 ) ;
if ( ! V_148 ) {
F_101 ( & V_103 -> V_42 , L_16 ) ;
V_97 = - V_150 ;
goto V_98;
}
V_148 = F_102 ( & V_103 -> V_42 , V_148 -> V_151 ,
F_103 ( V_148 ) , F_56 ( & V_103 -> V_42 ) ) ;
if ( ! V_148 ) {
F_101 ( & V_103 -> V_42 , L_17 ) ;
V_97 = - V_152 ;
goto V_98;
}
V_153 = F_104 ( & V_103 -> V_42 ,
V_148 -> V_151 , F_103 ( V_148 ) ) ;
if ( ! V_153 ) {
F_101 ( & V_103 -> V_42 , L_18 ,
V_103 -> V_101 ) ;
V_97 = - V_8 ;
goto V_98;
}
...
static int
F_111 ( struct V_146 * V_103 )
{
struct V_41 * V_42 = F_112 ( V_103 ) ;
if ( V_42 ) {
F_75 ( V_42 ) ;
F_31 ( V_42 ) ;
F_67 ( V_42 ) ;
