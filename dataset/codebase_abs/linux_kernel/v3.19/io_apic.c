...
if ( ( V_61 . V_65 == 0 ) && ( V_61 . V_83 == V_174 ) ) {
V_175 . V_49 = V_49 ;
V_175 . V_12 = V_12 ;
goto V_176;
}
...
V_173 = F_76 ( 0 , V_177 ) ;
V_172 = F_78 ( 0 , V_177 ) ;
if ( ( V_175 . V_12 == - 1 ) && ( V_173 >= 0 ) ) {
F_130 ( V_178 L_56 ) ;
V_175 . V_12 = V_173 ;
V_175 . V_49 = V_172 ;
}
if ( ( ( V_175 . V_49 != V_172 ) || ( V_175 . V_12 != V_173 ) ) &&
( V_173 >= 0 ) && ( V_175 . V_12 >= 0 ) )
{
F_130 ( V_178 L_57 ) ;
}
F_66 () ;
...
V_61 . V_46 = 0 ;
V_61 . V_139 = F_137 () ;
F_41 ( V_175 . V_49 , V_175 . V_12 , V_61 ) ;
}
if ( V_179 || F_138 () )
F_139 ( V_175 . V_12 != - 1 ) ;
}
...
L_63 ,
F_1 ( V_1 ) ) ;
F_145 ( V_181 , V_181 , V_69 ) ;
}
if ( V_182 != F_1 ( V_1 ) )
for ( V_24 = 0 ; V_24 < V_32 ; V_24 ++ )
if ( V_33 [ V_24 ] . V_30 == V_182 )
V_33 [ V_24 ] . V_30
= F_1 ( V_1 ) ;
...
static int T_2 F_148 ( char * V_194 )
{
V_195 = 1 ;
return 1 ;
}
...
F_152 ( ( 10 * 1000 ) / V_198 ) ;
F_153 ( V_62 ) ;
if ( F_154 ( V_197 , V_196 + 4 ) )
return 1 ;
return 0 ;
}
static unsigned int F_155 ( struct V_77 * V_54 )
{
int V_199 = 0 , V_13 = V_54 -> V_13 ;
unsigned long V_62 ;
F_37 ( & V_63 , V_62 ) ;
if ( V_13 < F_7 () ) {
V_144 -> V_65 ( V_13 ) ;
...
bool V_209 ;
F_167 ( V_44 ) ;
V_209 = F_162 ( V_54 , V_44 ) ;
V_24 = V_44 -> V_46 ;
V_210 = F_168 ( V_211 + ( ( V_24 & ~ 0x1f ) >> 1 ) ) ;
F_169 () ;
if ( ! ( V_210 & ( 1 << ( V_24 & 0x1f ) ) ) ) {
F_170 ( & V_212 ) ;
F_64 ( V_13 , V_44 ) ;
}
F_164 ( V_54 , V_44 , V_209 ) ;
}
...
{
F_113 ( V_13 , V_130 ) ;
F_115 ( V_13 , & V_217 , V_132 ,
L_19 ) ;
}
static inline void T_2 F_178 ( void )
{
int V_49 , V_12 , V_24 ;
struct V_41 V_218 , V_78 ;
unsigned char V_219 , V_220 ;
V_12 = F_76 ( 8 , V_115 ) ;
if ( V_12 == - 1 ) {
F_179 ( 1 ) ;
return;
...
V_78 . V_139 = F_180 () ;
V_78 . V_83 = V_174 ;
V_78 . V_99 = V_218 . V_99 ;
V_78 . V_79 = 0 ;
V_78 . V_46 = 0 ;
F_41 ( V_49 , V_12 , V_78 ) ;
V_219 = F_181 ( V_221 ) ;
V_220 = F_181 ( V_222 ) ;
F_182 ( ( V_220 & ~ V_223 ) | 0x6 ,
V_222 ) ;
F_182 ( V_219 | V_224 , V_221 ) ;
V_24 = 100 ;
while ( V_24 -- > 0 ) {
F_152 ( 10 ) ;
if ( ( F_181 ( V_225 ) & V_226 ) == V_226 )
V_24 -= 10 ;
}
F_182 ( V_219 , V_221 ) ;
F_182 ( V_220 , V_222 ) ;
F_65 ( V_49 , V_12 ) ;
F_41 ( V_49 , V_12 , V_218 ) ;
}
static int T_2 F_183 ( char * V_227 )
{
V_228 = 1 ;
return 0 ;
}
...
F_174 ( V_215 , V_216 | V_234 ) ;
V_144 -> V_235 ( 1 ) ;
V_230 = F_76 ( 0 , V_115 ) ;
V_229 = F_78 ( 0 , V_115 ) ;
V_232 = V_175 . V_12 ;
V_231 = V_175 . V_49 ;
F_13 ( V_236 , V_90 L_67
L_68 ,
V_44 -> V_46 , V_229 , V_230 , V_231 , V_232 ) ;
if ( V_230 == - 1 ) {
F_186 ( L_69 ) ;
V_230 = V_232 ;
V_229 = V_231 ;
...
if ( V_230 != - 1 ) {
if ( V_233 ) {
F_49 ( V_44 , V_36 , V_229 , V_230 ) ;
F_121 ( V_229 , V_230 , V_44 -> V_46 ) ;
} else {
int V_38 ;
V_38 = F_75 ( V_229 , V_230 , V_115 ) ;
if ( V_38 != - 1 && F_85 ( V_38 ) )
F_60 ( V_44 ) ;
}
if ( F_149 () ) {
...
F_65 ( V_229 , V_230 ) ;
if ( ! V_233 )
F_13 ( V_236 , V_185 L_71
L_72 ) ;
F_13 ( V_236 , V_90 L_73
L_74 ) ;
F_13 ( V_236 , V_90
L_75 , V_231 , V_232 ) ;
F_50 ( V_44 , V_36 , V_229 , V_230 , V_231 , V_232 ) ;
F_121 ( V_231 , V_232 , V_44 -> V_46 ) ;
V_144 -> V_237 ( 0 ) ;
if ( F_149 () ) {
F_13 ( V_236 , V_90 L_76 ) ;
goto V_123;
}
F_187 () ;
V_144 -> V_65 ( 0 ) ;
F_65 ( V_231 , V_232 ) ;
F_13 ( V_236 , V_90 L_77 ) ;
}
F_13 ( V_236 , V_90
L_78 ) ;
F_177 ( 0 ) ;
F_174 ( V_215 , V_238 | V_44 -> V_46 ) ;
V_144 -> V_237 ( 0 ) ;
if ( F_149 () ) {
F_13 ( V_236 , V_90 L_79 ) ;
goto V_123;
}
F_187 () ;
V_144 -> V_65 ( 0 ) ;
F_174 ( V_215 , V_216 | V_238 | V_44 -> V_46 ) ;
F_13 ( V_236 , V_90 L_80 ) ;
F_13 ( V_236 , V_90
L_81 ) ;
V_144 -> V_235 ( 0 ) ;
V_144 -> V_213 ( 0 ) ;
...
if ( V_44 -> type == V_243 )
return 0 ;
V_241 -> V_17 = F_189 ( V_44 -> V_244 , V_240 , V_44 -> V_245 ,
( void * ) ( long ) V_8 ) ;
if( ! V_241 -> V_17 ) {
F_21 ( V_241 -> V_15 ) ;
V_241 -> V_15 = NULL ;
...
static int
F_202 ( unsigned int V_13 , int V_36 , struct V_134 * V_135 )
{
struct V_43 * V_44 = F_25 ( V_13 , V_36 ) ;
int V_204 ;
if ( ! V_44 )
return - V_253 ;
V_204 = F_43 ( V_44 , V_36 , V_135 -> V_8 , V_135 -> V_142 ) ;
if ( ! V_204 )
...
unsigned int F_204 ( unsigned int V_254 )
{
return V_251 ? V_246 : V_255 ;
}
static int F_205 ( int V_8 , int V_256 )
{
union V_153 V_154 ;
...
if ( V_49 -> V_186 ( & V_257 , V_256 ) ) {
for ( V_24 = 0 ; V_24 < F_142 () ; V_24 ++ ) {
if ( ! V_49 -> V_186 ( & V_257 , V_24 ) )
break;
}
if ( V_24 == F_142 () )
F_14 ( L_90 ) ;
...
static T_7 F_207 ( int V_38 , T_7 V_259 )
{
if ( ( V_189 . V_190 == V_191 ) &&
! F_147 ( V_192 [ V_193 ] ) )
return F_205 ( V_38 , V_259 ) ;
else
return V_259 ;
}
static T_7 F_207 ( int V_38 , T_7 V_259 )
...
V_261 = F_211 ( V_260 , 256 ) ;
V_154 . V_162 . V_164 = V_261 ;
F_37 ( & V_63 , V_62 ) ;
F_40 ( V_38 , 0 , V_154 . V_161 ) ;
V_154 . V_161 = F_35 ( V_38 , 0 ) ;
F_38 ( & V_63 , V_62 ) ;
F_194 ( V_154 . V_162 . V_164 != V_261 ) ;
return V_261 ;
}
static int F_212 ( int V_8 )
{
union V_155 V_156 ;
unsigned long V_62 ;
F_37 ( & V_63 , V_62 ) ;
...
int F_213 ( T_1 V_104 , int * V_79 , int * V_99 )
{
int V_8 , V_12 , V_38 ;
if ( V_20 )
return - 1 ;
...
static struct V_266 * T_2 F_217 ( void )
{
unsigned long V_267 ;
struct V_266 * V_268 ;
char * V_269 ;
...
V_281:
#endif
V_277 = ( unsigned long ) F_220 ( V_282 ) ;
V_277 = F_221 ( V_277 ) ;
}
F_222 ( V_38 , V_277 ) ;
F_13 ( V_25 , L_100 ,
F_223 ( V_38 ) + ( V_277 & ~ V_283 ) ,
V_277 ) ;
V_38 ++ ;
V_279 -> V_284 = V_277 ;
...
return - 1 ;
V_9 = F_3 ( V_8 ) ;
if ( F_226 ( V_104 > V_9 -> V_10 ) )
return - 1 ;
return V_104 - V_9 -> V_11 ;
}
static int F_227 ( int V_38 )
{
union V_153 V_154 ;
union V_155 V_156 ;
union V_157 V_158 ;
...
{
int V_38 ;
for ( V_38 = 0 ; V_38 < V_290 ; V_38 ++ )
if ( V_2 [ V_38 ] . V_42 == 0 )
return V_38 ;
return V_290 ;
}
int F_229 ( int V_259 , T_1 V_291 , T_1 V_11 ,
struct V_242 * V_44 )
{
bool V_292 = ! ! V_251 ;
struct V_6 * V_9 ;
...
V_2 [ V_38 ] . V_3 . type = V_295 ;
V_2 [ V_38 ] . V_3 . V_62 = V_296 ;
V_2 [ V_38 ] . V_3 . V_5 = V_291 ;
F_222 ( V_278 + V_38 , V_291 ) ;
if ( F_227 ( V_38 ) ) {
F_230 ( V_278 + V_38 ) ;
return - V_297 ;
}
V_2 [ V_38 ] . V_3 . V_4 = F_207 ( V_38 , V_259 ) ;
V_2 [ V_38 ] . V_3 . V_298 = F_212 ( V_38 ) ;
V_167 = F_203 ( V_38 ) ;
V_10 = V_11 + V_167 - 1 ;
F_24 (ioapic) {
V_9 = F_3 ( V_8 ) ;
...
static inline void F_235 ( struct V_134 * V_300 ,
int V_8 , int V_142 ,
int V_79 , int V_99 )
{
V_300 -> V_8 = V_8 ;
...
int F_96 ( struct V_16 * V_48 , unsigned int V_301 ,
T_8 V_117 )
{
int V_8 = ( int ) ( long ) V_48 -> V_105 ;
...
if ( F_213 ( V_104 , & V_110 -> V_79 ,
& V_110 -> V_99 ) < 0 ) {
V_110 -> V_79 = 1 ;
V_110 -> V_99 = 1 ;
}
V_110 -> V_36 = V_302 ;
if ( V_301 >= F_7 () || V_110 -> V_113 )
V_110 -> V_114 = 1 ;
}
F_235 ( & V_135 , V_8 , V_117 , V_110 -> V_79 ,
V_110 -> V_99 ) ;
return F_202 ( V_301 , V_110 -> V_36 , & V_135 ) ;
}
void F_106 ( struct V_16 * V_48 , unsigned int V_301 )
{
struct V_77 * V_54 = F_105 ( V_301 ) ;
struct V_43 * V_44 = V_43 ( V_301 ) ;
int V_8 = ( int ) ( long ) V_48 -> V_105 ;
int V_12 = ( int ) V_54 -> V_117 ;
F_42 ( V_8 , V_12 ) ;
F_46 ( V_44 , V_8 , V_12 ) ;
F_226 ( ! F_134 ( & V_44 -> V_68 ) ) ;
F_236 ( V_301 ) ;
}
int F_237 ( T_1 V_104 , int V_79 , int V_99 , int V_36 )
{
int V_204 = 0 ;
int V_8 , V_12 ;
struct V_14 * V_110 ;
