...
{
struct V_1 * V_64 = F_1 ( V_3 ) ;
if ( V_64 -> V_89 && V_64 -> V_89 -> V_221 )
return V_64 -> V_89 -> V_221 -> V_222 ;
F_73 () ;
return 0 ;
}
static void V_209 ( struct V_205 * V_206 , int V_223 )
{
struct V_108 * V_109 = V_206 -> V_210 ;
struct V_115 * V_116 = V_109 -> V_117 ;
V_116 -> V_119 = V_206 -> V_224 ;
V_116 -> V_225 = V_206 -> V_226 ;
V_109 -> V_227 = F_43 ( V_116 -> V_119 ) << 1 ;
if ( V_109 -> V_227 ) {
F_6 ( L_79
...
{
struct V_230 * V_231 = & V_232 . V_233 ;
F_78 ( & V_232 ) ;
