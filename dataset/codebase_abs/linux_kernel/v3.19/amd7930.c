...
static int F_53 ( struct V_105 * V_77 ,
struct V_109 * V_110 ,
int V_31 , int V_115 ,
struct V_1 * * V_116 )
{
...
V_2 -> V_12 . V_22 = ( V_122 | V_123 |
V_124 | V_125 ) ;
V_2 -> V_12 . V_24 = ( V_126 | V_127 ) ;
F_8 ( V_2 ) ;
F_3 ( V_128 , V_2 -> V_6 + V_7 ) ;
F_3 ( V_129 | ( V_130 << 4 ) ,
V_2 -> V_6 + V_8 ) ;
F_4 ( & V_2 -> V_4 , V_3 ) ;
if ( ( V_76 = F_59 ( V_77 , V_131 ,
V_2 , & V_132 ) ) < 0 ) {
F_47 ( V_2 ) ;
return V_76 ;
}
...
{
struct V_111 * V_133 = & V_110 -> V_111 [ 0 ] ;
static int V_134 ;
struct V_105 * V_77 ;
struct V_1 * V_2 ;
int V_76 , V_31 ;
V_31 = V_110 -> V_135 . V_136 [ 0 ] ;
if ( V_134 >= V_137 )
return - V_138 ;
if ( ! V_139 [ V_134 ] ) {
V_134 ++ ;
...
V_76 = F_61 ( & V_110 -> V_115 , V_141 [ V_134 ] , V_142 [ V_134 ] ,
V_143 , 0 , & V_77 ) ;
if ( V_76 < 0 )
return V_76 ;
strcpy ( V_77 -> V_144 , L_5 ) ;
strcpy ( V_77 -> V_85 , L_6 ) ;
sprintf ( V_77 -> V_145 , L_7 ,
V_77 -> V_85 ,
V_133 -> V_3 & 0xffL ,
( unsigned long long ) V_133 -> V_146 ,
V_31 ) ;
...
{
struct V_1 * V_151 = V_149 ;
while ( V_151 != NULL ) {
struct V_1 * V_148 = V_151 -> V_148 ;
F_63 ( V_151 -> V_77 ) ;
V_151 = V_148 ;
}
V_149 = NULL ;
