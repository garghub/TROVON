...
int F_50 ( struct V_1 * V_2 , unsigned int V_23 )
{
...
if ( V_23 == V_19 ) {
if ( V_40 ) {
F_51 ( & V_40 -> V_15 . V_82 , - 1 , 0 ) ;
V_80 = ! V_40 -> V_15 . V_83 ;
}
goto V_81;
}
if ( V_40 ) {
F_52 ( & V_40 -> V_15 . V_39 , V_84 ) ;
if ( ! V_40 -> V_15 . V_17
&& ! V_40 -> V_15 . V_83
&& V_40 -> V_15 . V_18 != V_54 )
error = - V_47 ;
...
void F_64 ( struct V_1 * V_2 , bool V_88 )
{
F_15 ( & V_2 -> V_15 . V_39 ) ;
if ( V_2 -> V_15 . V_17 > 0 ) {
V_2 -> V_15 . V_17 ++ ;
...
static void F_74 ( struct V_1 * V_2 , int V_91 , int V_92 )
{
...
void F_76 ( struct V_1 * V_2 , int V_77 )
{
int V_91 , V_92 ;
F_15 ( & V_2 -> V_15 . V_39 ) ;
V_91 = V_2 -> V_15 . V_28 ;
...
void F_77 ( struct V_1 * V_2 , bool V_93 )
{
int V_91 , V_92 ;
F_15 ( & V_2 -> V_15 . V_39 ) ;
V_91 = V_2 -> V_15 . V_28 ;
...
V_2 -> V_15 . V_56 = false ;
V_2 -> V_15 . V_17 = 1 ;
F_79 ( & V_2 -> V_15 . V_45 , 0 ) ;
V_2 -> V_15 . V_42 = 0 ;
F_79 ( & V_2 -> V_15 . V_82 , 0 ) ;
F_80 ( V_2 , false ) ;
V_2 -> V_15 . V_90 = true ;
V_2 -> V_15 . V_50 = false ;
V_2 -> V_15 . V_26 = V_27 ;
V_2 -> V_15 . V_48 = false ;
V_2 -> V_15 . V_16 = V_13 ;
F_81 ( & V_2 -> V_15 . V_61 , F_36 ) ;
V_2 -> V_15 . V_24 = 0 ;
F_82 ( & V_2 -> V_15 . V_25 , F_38 ,
( unsigned long ) V_2 ) ;
F_83 ( & V_2 -> V_15 . V_64 ) ;
}
