...
static int F_174 ( struct V_1 * V_4 , struct V_256 * V_257 )
{
int V_7 = 0 ;
struct V_2 * V_2 = F_175 ( V_257 ) ;
F_21 () ;
F_91 ( & V_65 ) ;
if ( F_176 ( V_4 -> V_218 == NULL ) ) {
V_4 -> V_218 = V_257 ;
...
struct V_256 * F_178 ( struct V_2 * V_2 , struct V_32 * V_33 )
{
struct V_1 * V_4 ;
struct V_5 V_108 = {
. V_109 = V_33 -> V_132 ? : V_133 ,
...
int F_179 ( struct V_256 * V_257 , int V_260 , char T_8 * V_261 , unsigned int V_262 )
{
int V_210 , V_224 = 0 ;
struct V_184 V_80 ;
struct V_223 V_64 ;
...
struct V_2 * V_2 = F_175 ( V_257 ) ;
struct V_1 * V_4 ;
V_4 = F_1 ( V_2 , F_180 ( V_257 ) -> V_263 ? : V_45 ) ;
if ( V_4 == NULL )
return - V_77 ;
if ( V_260 != V_264 ) {
if ( V_257 != V_4 -> V_218 && ! F_181 ( V_2 -> V_265 , V_266 ) )
return - V_26 ;
}
switch ( V_260 ) {
case V_264 :
if ( V_257 -> V_267 != V_268 ||
F_182 ( V_257 ) -> V_269 != V_270 )
return - V_271 ;
if ( V_262 < sizeof( int ) )
return - V_28 ;
return F_174 ( V_4 , V_257 ) ;
case V_272 :
return F_177 ( V_257 ) ;
case V_273 :
if ( V_262 < sizeof( V_80 ) )
return - V_28 ;
if ( F_183 ( & V_80 , V_261 , sizeof( V_80 ) ) )
return - V_274 ;
if ( V_80 . V_187 >= V_183 )
return - V_252 ;
F_21 () ;
...
if ( V_262 < sizeof( T_6 ) )
return - V_28 ;
if ( F_183 ( & V_201 , V_261 , sizeof( T_6 ) ) )
return - V_274 ;
F_21 () ;
...
return - V_28 ;
if ( F_183 ( & V_64 , V_261 , sizeof( V_64 ) ) )
return - V_274 ;
if ( V_224 == 0 )
V_224 = V_64 . V_251 ;
F_21 () ;
...
int F_185 ( struct V_256 * V_257 , int V_260 , char T_8 * V_261 ,
int T_8 * V_262 )
{
int V_288 ;
int V_289 ;
...
if ( F_184 ( V_288 , V_262 ) )
return - V_274 ;
V_288 = F_186 ( int , V_288 , sizeof( int ) ) ;
if ( V_288 < 0 )
return - V_28 ;
if ( F_187 ( V_288 , V_262 ) )
return - V_274 ;
if ( F_188 ( V_261 , & V_289 , V_288 ) )
return - V_274 ;
return 0 ;
}
int F_189 ( struct V_256 * V_257 , int V_291 , void T_8 * V_11 )
{
struct V_292 V_293 ;
struct V_294 V_295 ;
struct V_69 * V_80 ;
...
switch ( V_291 ) {
case V_296 :
if ( F_183 ( & V_295 , V_11 , sizeof( V_295 ) ) )
return - V_274 ;
...
F_37 ( & V_65 ) ;
if ( F_188 ( V_11 , & V_295 , sizeof( V_295 ) ) )
return - V_274 ;
return 0 ;
}
F_37 ( & V_65 ) ;
return - V_157 ;
case V_301 :
if ( F_183 ( & V_293 , V_11 , sizeof( V_293 ) ) )
return - V_274 ;
F_35 ( & V_65 ) ;
...
F_37 ( & V_65 ) ;
if ( F_188 ( V_11 , & V_293 , sizeof( V_293 ) ) )
return - V_274 ;
return 0 ;
}
F_37 ( & V_65 ) ;
...
int F_190 ( struct V_256 * V_257 , unsigned int V_291 , void T_8 * V_11 )
{
struct V_307 V_293 ;
struct V_308 V_295 ;
struct V_69 * V_80 ;
...
static inline int F_191 ( struct V_32 * V_33 )
{
F_192 ( F_63 ( F_141 ( V_33 ) -> V_82 ) , F_193 ( F_141 ( V_33 ) ) ,
V_309 ) ;
F_194 ( F_63 ( F_141 ( V_33 ) -> V_82 ) , F_193 ( F_141 ( V_33 ) ) ,
V_310 , V_33 -> V_121 ) ;
return F_195 ( V_33 ) ;
}
static int F_196 ( struct V_2 * V_2 , struct V_1 * V_4 ,
...
V_80 -> V_86 ++ ;
V_80 -> V_85 += V_33 -> V_121 ;
if ( F_200 ( V_33 , sizeof( * V_311 ) + F_201 ( V_82 ) ) )
goto V_314;
V_311 = F_67 ( V_33 ) ;
V_311 -> V_315 -- ;
F_202 ( V_33 ) -> V_13 |= V_316 ;
return F_203 ( V_317 , V_318 , V_33 , V_33 -> V_82 , V_82 ,
F_191 ) ;
V_314:
F_80 ( V_33 ) ;
return 0 ;
}
static int F_204 ( struct V_1 * V_4 , struct V_106 * V_82 )
{
int V_66 ;
...
if ( V_319 != - 1 ) {
struct V_32 * V_328 = F_205 ( V_33 , V_205 ) ;
if ( V_328 )
F_196 ( V_2 , V_4 , V_328 , V_67 , V_319 ) ;
}
V_319 = V_66 ;
}
}
V_327:
if ( V_319 != - 1 ) {
F_196 ( V_2 , V_4 , V_33 , V_67 , V_319 ) ;
return;
}
V_326:
F_80 ( V_33 ) ;
}
int F_206 ( struct V_32 * V_33 )
{
struct V_60 * V_67 ;
struct V_2 * V_2 = F_63 ( V_33 -> V_82 ) ;
struct V_1 * V_4 ;
...
if ( F_212 ( V_33 , V_346 , sizeof( V_336 ) , & V_336 ) < 0 )
return - V_207 ;
V_331 -> V_347 = V_348 ;
return 1 ;
}
int F_213 ( struct V_2 * V_2 ,
...
V_82 = V_33 -> V_82 ;
if ( V_82 == NULL || ( V_80 = F_204 ( V_4 , V_82 ) ) < 0 ) {
F_37 ( & V_65 ) ;
return - V_329 ;
}
...
static int F_214 ( struct V_1 * V_4 , struct V_32 * V_33 ,
...
struct V_330 * V_331 ;
int V_7 ;
V_170 = F_215 ( V_33 , V_176 , V_75 , V_291 , sizeof( * V_331 ) , V_13 ) ;
if ( V_170 == NULL )
return - V_207 ;
V_331 = F_105 ( V_170 ) ;
V_331 -> V_363 = V_248 ;
...
V_331 -> V_372 = V_374 ;
V_331 -> V_360 = 0 ;
if ( F_212 ( V_33 , V_375 , 16 , & V_163 -> V_93 ) ||
F_212 ( V_33 , V_376 , 16 , & V_163 -> V_92 ) )
goto V_369;
V_7 = F_129 ( V_4 , V_33 , V_163 , V_331 ) ;
if ( V_7 < 0 && V_7 != - V_77 )
goto V_369;
return F_216 ( V_33 , V_170 ) ;
V_369:
F_217 ( V_33 , V_170 ) ;
return - V_207 ;
}
static int F_218 ( bool V_167 , int V_72 )
{
T_9 V_121 =
F_219 ( sizeof( struct V_330 ) )
+ F_220 ( 4 )
+ F_220 ( sizeof( struct V_198 ) )
+ F_220 ( sizeof( struct V_198 ) )
;
if ( ! V_167 )
V_121 = V_121
+ F_220 ( 4 )
+ F_220 ( 0 )
+ V_72 * F_221 ( sizeof( struct V_332 ) )
+ F_220 ( sizeof( struct V_335 ) )
;
return V_121 ;
}
...
struct V_32 * V_33 ;
int V_7 = - V_190 ;
V_33 = F_222 ( F_218 ( V_64 -> V_94 >= V_183 , V_4 -> V_72 ) ,
V_205 ) ;
if ( V_33 == NULL )
goto V_377;
V_7 = F_214 ( V_4 , V_33 , 0 , 0 , V_64 , V_291 , 0 ) ;
if ( V_7 < 0 )
goto V_377;
F_223 ( V_33 , V_2 , 0 , V_378 , NULL , V_205 ) ;
return;
V_377:
F_80 ( V_33 ) ;
if ( V_7 < 0 )
...
{
struct V_2 * V_2 = F_175 ( V_33 -> V_257 ) ;
struct V_1 * V_4 ;
struct V_60 * V_64 ;
