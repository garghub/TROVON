...
static char * F_122 ( T_8 * V_198 , char * V_199 )
{
char V_200 , * V_201 ;
int V_76 ;
for ( V_76 = 0 , V_201 = V_199 ; V_76 < 6 ; V_76 ++ ) {
V_200 = ( V_198 -> V_202 [ V_76 ] >> 1 ) & 0x7F ;
if ( V_200 != ' ' )
* V_201 ++ = V_200 ;
}
* V_201 ++ = '-' ;
V_76 = ( V_198 -> V_202 [ 6 ] >> 1 ) & 0x0F ;
if ( V_76 > 9 ) {
* V_201 ++ = '1' ;
V_76 -= 10 ;
}
...
F_124 ( & V_76 -> V_168 ) ;
#if F_15 ( V_32 )
if ( V_210 == V_33 || V_210 == V_35 )
F_122 ( ( T_8 * ) V_76 -> V_38 , V_205 ) ;
else {
#endif
for ( V_207 = 0 , V_208 = 0 ; V_207 < V_206 - 3 && V_208 < V_4 -> V_12 ; V_208 ++ ) {
V_205 [ V_207 ++ ] = F_125 ( V_76 -> V_38 [ V_208 ] ) ;
V_205 [ V_207 ++ ] = F_126 ( V_76 -> V_38 [ V_208 ] ) ;
V_205 [ V_207 ++ ] = ':' ;
}
if ( V_207 != 0 )
-- V_207 ;
...
#endif
sprintf ( V_209 , L_5 , V_76 -> V_18 ) ;
F_127 ( V_204 , L_6 ,
V_209 , V_210 , F_92 ( V_76 ) , V_205 , V_4 -> V_170 ) ;
F_128 ( & V_76 -> V_168 ) ;
}
...
char V_209 [ 16 ] ;
sprintf ( V_209 , L_5 , V_76 -> V_212 ) ;
F_127 ( V_204 , L_6 ,
V_209 , V_210 , V_163 | V_164 , L_7 ,
V_4 ? V_4 -> V_170 : L_4 ) ;
}
static int F_130 ( struct V_203 * V_204 , void * V_213 )
{
if ( V_213 == V_214 ) {
F_131 ( V_204 , L_8
L_9 ) ;
} else {
struct V_215 * V_126 = V_204 -> V_216 ;
if ( V_126 -> V_39 & V_217 )
F_129 ( V_204 , V_213 ) ;
else
F_123 ( V_204 , V_213 ) ;
...
static void * F_132 ( struct V_203 * V_204 , T_9 * V_218 )
{
return F_133 ( V_204 , V_218 , & V_78 , V_219 ) ;
}
static int F_134 ( struct V_220 * V_220 , struct V_221 * V_221 )
{
return F_135 ( V_220 , V_221 , & V_222 ,
sizeof( struct V_215 ) ) ;
}
static int T_10 F_136 ( struct V_66 * V_66 )
{
if ( ! F_137 ( L_10 , V_223 , V_66 -> V_224 , & V_225 ) )
return - V_226 ;
return 0 ;
}
static void T_11 F_138 ( struct V_66 * V_66 )
{
F_139 ( L_10 , V_66 -> V_224 ) ;
}
