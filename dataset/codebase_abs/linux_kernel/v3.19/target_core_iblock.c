...
V_101 = & V_63 -> V_104 [ 0 ] ;
if ( V_63 -> V_105 > 1 ||
V_101 -> V_106 != V_63 -> V_80 -> V_35 . V_61 ) {
F_8 ( L_23
L_24 , V_63 -> V_105 , V_101 -> V_106 ,
V_63 -> V_80 -> V_35 . V_61 ) ;
return V_107 ;
}
...
F_56 ( & V_65 -> V_68 , 1 ) ;
while ( V_103 ) {
while ( F_57 ( V_72 , F_58 ( V_101 ) , V_101 -> V_106 , V_101 -> V_110 )
!= V_101 -> V_106 ) {
V_72 = F_37 ( V_63 , V_102 , 1 ) ;
if ( ! V_72 )
goto V_111;
...
{
struct V_1 * V_11 = F_1 ( V_3 ) ;
char * V_116 , * V_117 , * V_118 , * V_119 ;
T_7 args [ V_120 ] ;
int V_20 = 0 , V_121 ;
unsigned long V_122 ;
V_119 = F_60 ( V_114 , V_12 ) ;
if ( ! V_119 )
return - V_21 ;
V_116 = V_119 ;
while ( ( V_117 = F_61 ( & V_119 , L_25 ) ) != NULL ) {
if ( ! * V_117 )
continue;
V_121 = F_62 ( V_117 , V_123 , args ) ;
switch ( V_121 ) {
case V_124 :
if ( V_11 -> V_34 ) {
F_8 ( L_26
...
V_27:
F_24 ( V_116 ) ;
return ( ! V_20 ) ? V_115 : V_20 ;
}
static T_6 F_66 ( struct V_2 * V_3 , char * V_129 )
{
struct V_1 * V_11 = F_1 ( V_3 ) ;
...
T_6 V_132 = 0 ;
if ( V_16 )
V_132 += sprintf ( V_129 + V_132 , L_32 ,
F_67 ( V_16 , V_130 ) ) ;
if ( V_11 -> V_22 & V_23 )
V_132 += sprintf ( V_129 + V_132 , L_33 ,
V_11 -> V_28 ) ;
V_132 += sprintf ( V_129 + V_132 , L_34 , V_11 -> V_31 ) ;
V_132 += sprintf ( V_129 + V_132 , L_35 ) ;
if ( V_16 ) {
V_132 += sprintf ( V_129 + V_132 , L_36 ,
F_68 ( V_16 -> V_133 ) , F_69 ( V_16 -> V_133 ) , ( ! V_16 -> V_134 ) ?
L_37 : ( V_16 -> V_135 == V_11 ) ?
L_38 : L_39 ) ;
} else {
V_132 += sprintf ( V_129 + V_132 , L_40 ) ;
}
return V_132 ;
}
static int
...
V_137 = F_71 ( V_72 , V_82 , V_63 -> V_141 ) ;
if ( ! V_137 ) {
F_8 ( L_42 ) ;
return - V_21 ;
}
V_137 -> V_142 . V_143 = ( V_63 -> V_144 / V_3 -> V_35 . V_61 ) *
V_3 -> V_145 ;
V_137 -> V_142 . V_86 = V_72 -> V_85 . V_86 ;
F_4 ( L_43 , V_137 -> V_142 . V_143 ,
( unsigned long long ) V_137 -> V_142 . V_86 ) ;
F_72 (cmd->t_prot_sg, sg, cmd->t_prot_nents, i) {
V_139 = F_73 ( V_72 , F_58 ( V_101 ) , V_101 -> V_106 ,
V_101 -> V_110 ) ;
if ( V_139 != V_101 -> V_106 ) {
F_8 ( L_44 , V_139 ) ;
return - V_21 ;
}
F_4 ( L_45 ,
F_58 ( V_101 ) , V_101 -> V_106 , V_101 -> V_110 ) ;
}
return 0 ;
}
static T_5
F_74 ( struct V_62 * V_63 , struct V_100 * V_146 , T_1 V_147 ,
enum V_148 V_149 )
{
struct V_2 * V_3 = V_63 -> V_80 ;
struct V_64 * V_65 ;
struct V_72 * V_72 , * V_150 ;
struct V_87 V_88 ;
struct V_100 * V_101 ;
T_1 V_79 = V_147 ;
T_4 V_102 ;
