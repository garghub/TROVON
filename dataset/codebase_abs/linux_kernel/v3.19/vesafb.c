...
static int F_10 ( char * V_35 )
{
char * V_36 ;
if ( ! V_35 || ! * V_35 )
return 0 ;
while ( ( V_36 = F_11 ( & V_35 , L_1 ) ) != NULL ) {
if ( ! * V_36 ) continue;
if ( ! strcmp ( V_36 , L_2 ) )
V_37 = 1 ;
...
static int F_32 ( struct V_42 * V_113 )
{
struct V_3 * V_4 = F_33 ( V_113 ) ;
F_34 ( V_4 ) ;
F_31 ( V_4 ) ;
return 0 ;
}
