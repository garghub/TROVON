...
const unsigned int * V_11 ,
const char * const * V_324 )
{
struct V_14 * V_15 ;
const char * const * V_325 ;
int V_7 ;
...
if ( V_7 < 0 )
return V_7 ;
for ( V_325 = V_324 ; * V_325 ; V_325 ++ ) {
struct V_14 * V_327 ;
V_327 = F_156 ( V_2 , * V_325 ) ;
if ( ! V_327 ) {
F_179 ( V_2 -> V_8 -> V_9 -> V_328 ,
L_63 , * V_325 ) ;
continue;
}
V_7 = F_180 ( V_15 , V_327 ) ;
if ( V_7 < 0 )
return V_7 ;
}
return 0 ;
...
int V_7 ;
if ( F_61 ( V_2 , 0x5a , 9 ) )
if ( ( V_7 = F_1 ( V_2 , & V_329 [ 0 ] , 1 ) ) < 0 )
return V_7 ;
if ( ( V_7 = F_1 ( V_2 , & V_329 [ 1 ] , F_42 ( V_329 ) - 1 ) ) < 0 )
return V_7 ;
V_15 = F_156 ( V_2 , L_47 ) ;
if ( ! V_15 )
return - V_43 ;
...
struct V_1 * V_335 ;
V_335 = F_14 ( V_28 ) ;
V_333 = F_8 ( V_335 , 0x7a ) >> 14 ;
V_334 = F_8 ( V_335 , 0x20 ) >> 8 ;
V_33 -> V_21 . V_34 . V_35 [ 0 ] = ( V_333 << 1 ) + V_334 ;
return 0 ;
}
static int F_185 ( struct V_14 * V_28 ,
struct V_32 * V_33 )
{
T_2 V_333 , V_334 , V_336 ;
struct V_1 * V_335 ;
V_335 = F_14 ( V_28 ) ;
V_333 = V_33 -> V_21 . V_34 . V_35 [ 0 ] >> 1 ;
V_334 = V_33 -> V_21 . V_34 . V_35 [ 0 ] & 1 ;
V_336 = F_8 ( V_335 , 0x7a ) ;
F_35 ( V_335 , 0x7a , ( V_336 & 0x3FFF ) + ( V_333 << 14 ) ) ;
V_336 = F_8 ( V_335 , 0x20 ) ;
F_35 ( V_335 , 0x20 , ( V_336 & 0xFEFF ) + ( V_334 << 8 ) ) ;
return 0 ;
}
...
V_339 [ V_28 -> V_40 ] . V_340 ) ;
}
static int F_188 ( struct V_14 * V_28 ,
struct V_32 * V_33 )
{
unsigned short V_341 , V_342 ;
struct V_1 * V_335 = F_14 ( V_28 ) ;
F_7 ( & V_335 -> V_25 ) ;
V_341 = F_8 ( V_335 , V_26 ) & V_27 ;
F_9 ( V_335 , V_26 , V_27 , 0 ) ;
V_342 = F_8 ( V_335 , 0x60 ) &
V_339 [ V_28 -> V_40 ] . V_20 ;
F_9 ( V_335 , V_26 , V_27 , V_341 ) ;
F_10 ( & V_335 -> V_25 ) ;
V_33 -> V_21 . V_34 . V_35 [ 0 ] = V_342 >>
V_339 [ V_28 -> V_40 ] . V_119 ;
return 0 ;
}
...
struct V_29 * V_30 )
{
static const char * const V_343 [] = { L_73 , L_74 } ;
return F_12 ( V_30 , 1 , 2 , V_343 ) ;
}
...
{
int V_7 ;
if ( ( V_7 = F_1 ( V_2 , V_345 , F_42 ( V_345 ) ) ) < 0 )
return V_7 ;
if ( ( V_7 = F_1 ( V_2 , V_346 , F_42 ( V_346 ) ) ) < 0 )
return V_7 ;
return 0 ;
}
...
{
int V_6 , V_7 ;
for ( V_6 = 0 ; V_6 < F_42 ( V_348 ) ; V_6 ++ )
if ( ( V_7 = F_2 ( V_2 -> V_8 -> V_9 , F_198 ( & V_348 [ V_6 ] , V_2 ) ) ) < 0 )
return V_7 ;
return 0 ;
}
...
if ( ( V_7 = F_2 ( V_2 -> V_8 -> V_9 , F_198 ( & V_351 [ V_6 ] , V_2 ) ) ) < 0 )
return V_7 ;
return 0 ;
}
