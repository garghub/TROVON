...
{
struct V_1 * V_2 = V_19 -> V_30 ;
memcpy ( V_129 , & V_2 -> V_130 , sizeof( * V_129 ) ) ;
return 0 ;
}
...
F_65 ( V_2 , V_26 ) ;
} else if ( V_132 -> V_137 && ! V_47 -> V_137 ) {
V_2 -> V_138 ++ ;
V_47 -> V_137 = true ;
if ( F_54 ( V_2 ) )
F_66 ( V_2 , V_26 ) ;
...
if ( V_133 & V_145 && ! V_132 -> V_146 )
F_44 ( V_144 , & V_2 -> V_15 ) ;
if ( V_133 & ( V_147 | V_148 |
V_149 | V_150 |
V_151 | V_152 ) )
F_69 ( V_2 , V_47 , V_132 , V_133 ) ;
}
...
T_1 * V_175 , T_1 * V_180 , T_1 * V_69 , T_1 * V_181 )
{
struct V_1 * V_2 = V_19 -> V_30 ;
struct V_3 * V_4 ;
F_76 (rt2x00dev, queue) {
