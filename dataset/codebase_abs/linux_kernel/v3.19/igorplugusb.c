...
V_46 = & V_44 -> V_52 [ 0 ] . V_49 ;
if ( ! F_17 ( V_46 ) || ! F_18 ( V_46 ) ) {
F_4 ( & V_38 -> V_8 , L_7 ) ;
return - V_51 ;
}
V_2 = F_19 ( & V_38 -> V_8 , sizeof( * V_2 ) , V_53 ) ;
if ( ! V_2 )
return - V_54 ;
V_2 -> V_8 = & V_38 -> V_8 ;
...
V_2 -> V_16 = F_22 ( 0 , V_53 ) ;
if ( ! V_2 -> V_16 )
return - V_54 ;
F_23 ( V_2 -> V_16 , V_42 ,
F_24 ( V_42 , 0 ) , ( V_59 * ) & V_2 -> V_33 ,
V_2 -> V_9 , sizeof( V_2 -> V_9 ) , F_9 , V_2 ) ;
F_25 ( V_42 , V_2 -> V_60 , sizeof( V_2 -> V_60 ) ) ;
V_13 = F_26 () ;
V_13 -> V_61 = V_62 ;
V_13 -> V_63 = V_2 -> V_60 ;
F_27 ( V_42 , & V_13 -> V_64 ) ;
V_13 -> V_8 . V_65 = & V_38 -> V_8 ;
V_13 -> V_66 = V_67 ;
V_13 -> V_68 = V_69 & ~ ( V_70 | V_71 |
V_72 | V_73 | V_74 |
V_75 | V_76 | V_77 ) ;
V_13 -> V_78 = V_2 ;
V_13 -> V_79 = V_80 ;
