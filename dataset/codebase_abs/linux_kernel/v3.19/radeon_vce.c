...
V_66 = & V_60 -> V_70 [ ( V_68 / 4 ) ] ;
V_8 = V_66 -> V_71 ;
V_10 = V_8 + F_39 ( V_66 -> V_72 ) ;
V_8 += V_67 ;
...
T_2 * V_5 = & V_76 ;
int V_11 , V_12 ;
while ( V_60 -> V_68 < V_60 -> V_77 -> V_57 ) {
T_2 V_78 = F_38 ( V_60 , V_60 -> V_68 ) ;
T_2 V_79 = F_38 ( V_60 , V_60 -> V_68 + 1 ) ;
if ( ( V_78 < 8 ) || ( V_78 & 3 ) ) {
F_30 ( L_18 , V_78 ) ;
return - V_23 ;
}
...
T_3 V_84 = V_82 -> V_32 ;
F_44 ( V_50 , V_85 ) ;
F_44 ( V_50 , ( V_84 >> 3 ) & 0x000FFFFF ) ;
F_44 ( V_50 , ( V_84 >> 23 ) & 0x000FFFFF ) ;
F_44 ( V_50 , 0x01003000 | ( V_83 ? 1 : 0 ) ) ;
if ( ! V_83 )
F_44 ( V_50 , V_86 ) ;
return true ;
}
...
{
struct V_80 * V_50 = & V_2 -> V_50 [ V_55 -> V_50 ] ;
F_44 ( V_50 , V_87 ) ;
F_44 ( V_50 , V_55 -> V_32 ) ;
...
struct V_51 * V_52 )
{
struct V_80 * V_50 = & V_2 -> V_50 [ V_52 -> V_50 ] ;
T_3 V_84 = V_2 -> V_88 [ V_52 -> V_50 ] . V_32 ;
F_44 ( V_50 , V_89 ) ;
F_44 ( V_50 , V_84 ) ;
F_44 ( V_50 , F_33 ( V_84 ) ) ;
F_44 ( V_50 , V_52 -> V_90 ) ;
...
int F_47 ( struct V_1 * V_2 , struct V_80 * V_50 )
{
T_2 V_92 = F_48 ( V_2 , V_50 ) ;
unsigned V_11 ;
int V_12 ;
...
int F_52 ( struct V_1 * V_2 , struct V_80 * V_50 )
{
