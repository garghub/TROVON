...
return;
V_26 = V_4 -> V_79 + 4 ;
while ( V_26 < V_4 -> V_79 + V_4 -> V_78 ) {
enum V_55 V_56 = V_26 [ 0 ] >> 4 ;
T_3 V_80 = V_26 [ 0 ] & 0x0f ;
T_3 V_81 = V_26 [ 1 ] & 0x80 ;
T_3 V_82 = ( V_26 [ 1 ] & 0x30 ) >> 4 ;
T_3 type = V_26 [ 1 ] & 0x0f ;
T_3 V_69 = V_26 [ 3 ] ;
if ( V_81 && V_80 == 1 && V_82 == 1
&& V_56 == V_61 && type == 3 && V_69 == 8 )
V_63 . V_57 = F_24 ( & V_26 [ 4 ] ) ;
V_26 += V_69 + 4 ;
}
if ( V_63 . V_57 ) {
V_63 . V_2 = & V_4 -> V_83 ;
...
static int F_26 ( struct V_1 * V_84 ,
struct V_85 * V_86 )
{
struct V_3 * V_4 = F_2 ( V_84 -> V_32 ) ;
struct V_3 * V_87 ;
...
if ( ! F_27 ( V_4 ) ) {
struct V_22 * V_90 = NULL ;
while ( ( V_23 = F_28 ( & V_4 -> V_91 -> V_92 , V_90 ) ) != NULL ) {
F_23 ( V_23 , V_4 ) ;
V_90 = V_23 ;
}
return - V_6 ;
...
V_89 = V_11 [ 1 ] + 1 ;
V_36 = V_11 + 8 ;
for ( V_27 = 0 ; V_27 < V_89 && V_36 < V_11 + V_69 ; V_27 ++ ) {
V_70 += V_36 [ 2 ] ;
V_36 += V_36 [ 3 ] + 4 ;
}
V_34 -> V_37 = V_36 ;
...
if ( ! V_59 )
goto V_95;
V_23 = F_29 ( V_84 -> V_32 , F_30 ( & V_4 -> V_83 ) ,
V_65 , & V_98 ) ;
if ( F_22 ( V_23 ) ) {
V_5 = F_31 ( V_23 ) ;
goto V_95;
...
F_18 ( V_23 , V_4 , 1 ) ;
F_32 (tmp_sdev, sdev->host) {
if ( V_87 -> V_99 != 0 || F_27 ( V_87 ) )
continue;
F_23 ( V_23 , V_87 ) ;
}
return 0 ;
...
{
struct V_22 * V_23 , * V_90 = NULL ;
while ( ( V_23 = F_28 ( & V_4 -> V_91 -> V_92 , V_90 ) ) != NULL ) {
V_90 = V_23 ;
if ( ! F_35 ( V_23 , & V_4 -> V_83 ) )
break;
}
if ( V_23 )
F_36 ( & V_23 -> V_23 ) ;
...
static void F_39 ( struct V_1 * V_84 ,
struct V_85 * V_86 )
{
struct V_3 * V_4 = F_2 ( V_84 -> V_32 ) ;
if ( ! F_27 ( V_4 ) )
