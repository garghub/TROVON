...
if ( ! ( V_86 & V_102 ) ) {
V_100 = V_82 -> V_31 ;
F_64 ( V_82 , ( V_100 & ~ V_31 ) ) ;
} else {
V_100 = V_82 -> V_103 ;
F_65 ( V_82 , ( V_100 & ~ V_31 ) ) ;
}
F_23 ( & V_82 -> V_101 ) ;
* V_99 = ! ( V_100 & ~ V_31 ) ;
return V_31 & V_100 ;
...
V_105 = F_63 ( V_82 , V_31 , V_86 ,
& V_106 ) ;
if ( V_106 )
F_68 ( V_82 , V_3 ) ;
F_35 ( & V_3 -> V_107 ) ;
F_69 ( V_82 ) ;
if ( V_105 & F_70 ( V_18 ) -> V_108 )
F_71 ( V_18 ) ;
return 0 ;
}
...
static T_6 F_75 ( struct V_81 * V_82 ,
T_6 V_31 ,
unsigned int V_86 )
{
T_6 V_100 = - 1 ;
...
T_6 V_110 = V_82 -> V_103 | V_31 ;
F_65 ( V_82 , V_110 ) ;
if ( V_86 & V_111 )
V_82 -> V_86 |= V_112 ;
}
if ( ! ( V_86 & V_113 ) ) {
T_6 V_110 = V_82 -> V_103 | V_114 ;
F_65 ( V_82 , V_110 ) ;
}
F_23 ( & V_82 -> V_101 ) ;
return V_31 & ~ V_100 ;
}
static struct V_81 * F_76 ( struct V_2 * V_3 ,
struct V_71 * V_71 ,
struct V_104 * V_18 )
{
struct V_81 * V_115 ;
int V_24 ;
if ( F_77 ( & V_3 -> V_116 ) > V_3 -> V_14 . V_117 )
return F_6 ( - V_118 ) ;
V_115 = F_78 ( V_83 , V_119 ) ;
if ( ! V_115 )
return F_6 ( - V_120 ) ;
F_79 ( V_115 , F_52 ) ;
V_24 = F_80 ( V_115 , V_3 , V_71 , V_18 , 0 ) ;
if ( V_24 ) {
F_69 ( V_115 ) ;
return F_6 ( V_24 ) ;
}
...
V_82 = F_67 ( V_3 , V_18 ) ;
if ( ! V_82 ) {
V_82 = F_76 ( V_3 , NULL , V_18 ) ;
if ( F_12 ( V_82 ) ) {
F_35 ( & V_3 -> V_107 ) ;
return F_14 ( V_82 ) ;
}
}
V_121 = F_75 ( V_82 , V_31 , V_86 ) ;
F_35 ( & V_3 -> V_107 ) ;
if ( V_121 & ~ F_70 ( V_18 ) -> V_108 )
F_71 ( V_18 ) ;
F_69 ( V_82 ) ;
return 0 ;
}
...
{
V_83 = F_84 ( V_81 , V_123 ) ;
V_124 = F_84 ( V_9 , V_123 ) ;
#ifdef F_28
V_125 = F_84 ( V_38 ,
V_123 ) ;
#endif
