...
F_103 ( V_49 -> V_142 -> V_230 , & V_124 -> V_262 ) ;
V_124 -> V_161 = F_104 ( V_2 -> V_125 ) ;
memcpy ( V_124 -> V_159 , V_49 -> V_263 , V_49 -> V_160 ) ;
V_124 -> V_264 = 0 ;
V_124 -> V_265 = 0 ;
V_124 -> V_266 = V_2 -> V_110 . V_112 ;
V_124 -> V_267 = V_2 -> V_158 ;
V_124 -> V_265 = V_268 ;
}
...
memset ( V_49 -> V_283 , 0 , V_282 ) ;
if ( V_275 )
memcpy ( V_49 -> V_283 , V_273 , V_275 ) ;
for ( V_66 = 0 ; V_66 < V_217 ; V_66 ++ )
F_107 ( V_19 , 1 ) ;
}
}
int F_108 ( struct V_140 * V_141 ,
struct V_48 * V_49 )
{
...
V_269 = (struct V_240 * )
& ( V_138 -> V_222 . V_223 . V_224 . V_269 . V_290 ) ;
F_92 ( V_2 , V_269 , V_217 ) ;
