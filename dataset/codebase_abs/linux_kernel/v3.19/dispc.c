...
const struct V_269 * V_307 )
{
if ( ! F_226 ( V_307 -> V_276 , V_307 -> V_320 ) )
return false ;
if ( ! F_228 ( V_6 , V_307 -> V_374 ) )
return false ;
if ( F_134 ( V_6 ) ) {
if ( V_307 -> V_308 )
return false ;
if ( ! F_227 ( V_307 -> V_278 , V_307 -> V_277 ,
...
enum V_378 V_381 )
{
T_2 V_382 , V_383 , V_242 ;
bool V_384 , V_385 , V_386 ;
V_382 = F_90 ( V_278 - 1 , V_3 . V_47 -> V_387 , 0 ) |
F_90 ( V_277 - 1 , V_3 . V_47 -> V_388 , 8 ) |
F_90 ( V_279 - 1 , V_3 . V_47 -> V_389 , 20 ) ;
V_383 = F_90 ( V_366 - 1 , V_3 . V_47 -> V_387 , 0 ) |
F_90 ( V_367 , V_3 . V_47 -> V_388 , 8 ) |
F_90 ( V_368 , V_3 . V_47 -> V_389 , 20 ) ;
F_1 ( F_231 ( V_6 ) , V_382 ) ;
F_1 ( F_232 ( V_6 ) , V_383 ) ;
switch ( V_379 ) {
case V_390 :
...
const struct V_269 * V_307 )
{
unsigned V_393 , V_394 ;
unsigned long V_395 , V_396 ;
...
V_270 . V_367 , V_270 . V_368 , V_270 . V_376 , V_270 . V_377 ,
V_270 . V_379 , V_270 . V_380 , V_270 . V_381 ) ;
V_393 = V_270 . V_276 + V_270 . V_277 + V_270 . V_278 + V_270 . V_279 ;
V_394 = V_270 . V_320 + V_270 . V_367 + V_270 . V_366 + V_270 . V_368 ;
V_395 = V_307 -> V_374 / V_393 ;
V_396 = V_307 -> V_374 / V_393 / V_394 ;
F_10 ( L_40 , V_307 -> V_374 ) ;
F_10 ( L_41 ,
V_270 . V_278 , V_270 . V_277 , V_270 . V_279 , V_270 . V_366 , V_270 . V_367 , V_270 . V_368 ) ;
F_10 ( L_42 ,
V_270 . V_376 , V_270 . V_377 , V_270 . V_379 ,
V_270 . V_380 , V_270 . V_381 ) ;
F_10 ( L_43 , V_395 , V_396 ) ;
} else {
if ( V_270 . V_308 == true )
V_270 . V_320 /= 2 ;
}
...
static void F_235 ( enum V_5 V_6 , T_1 V_397 ,
T_1 V_398 )
{
F_82 ( V_397 < 1 ) ;
F_82 ( V_398 < 1 ) ;
F_1 ( F_236 ( V_6 ) ,
F_90 ( V_397 , 23 , 16 ) | F_90 ( V_398 , 7 , 0 ) ) ;
if ( F_12 ( V_38 ) == false &&
V_6 == V_140 )
V_3 . V_399 = F_237 () / V_397 ;
}
static void F_238 ( enum V_5 V_6 , int * V_397 ,
int * V_398 )
{
T_2 V_242 ;
V_242 = F_3 ( F_236 ( V_6 ) ) ;
* V_397 = F_124 ( V_242 , 23 , 16 ) ;
* V_398 = F_124 ( V_242 , 7 , 0 ) ;
}
...
void F_243 ( unsigned long V_267 )
{
V_3 . V_409 = V_267 ;
}
...
static void F_244 ( struct V_410 * V_411 , enum V_5 V_6 )
{
int V_407 , V_408 ;
enum V_412 V_413 ;
F_245 ( V_411 , L_46 , V_11 [ V_6 ] . V_53 ) ;
V_413 = F_242 ( V_6 ) ;
F_245 ( V_411 , L_47 , V_11 [ V_6 ] . V_53 ,
F_246 ( V_413 ) ,
F_247 ( V_413 ) ) ;
F_238 ( V_6 , & V_407 , & V_408 ) ;
F_245 ( V_411 , L_48 ,
F_196 ( V_6 ) , V_407 ) ;
F_245 ( V_411 , L_49 ,
F_195 ( V_6 ) , V_408 ) ;
}
void F_248 ( struct V_410 * V_411 )
{
int V_407 ;
T_2 V_242 ;
enum V_412 V_414 = F_239 () ;
if ( F_59 () )
return;
F_245 ( V_411 , L_50 ) ;
F_245 ( V_411 , L_51 ,
...
static void F_249 ( struct V_410 * V_411 )
{
int V_16 , V_17 ;
const char * V_416 [] = {
[ V_140 ] = L_54 ,
...
const char * * V_418 ;
#define F_250 ( V_42 ) seq_printf(s, "%-50s %08x\n", #r, dispc_read_reg(r))
if ( F_59 () )
return;
F_250 ( V_419 ) ;
F_250 ( V_420 ) ;
...
F_250 ( V_431 ) ;
#undef F_250
#define F_251 ( V_16 , V_53 ) name(i)
#define F_250 ( V_16 , V_42 ) seq_printf(s, "%s(%s)%*s %08x\n", #r, p_names[i], \
...
#undef F_251
#undef F_250
#define F_251 ( V_56 , V_53 , V_16 ) name(plane, i)
#define F_250 ( V_56 , V_53 , V_16 ) \
seq_printf(s, "%s_%d(%s)%*s %08x\n", #name, i, p_names[plane], \
(int)(46 - strlen(#name) - strlen(p_names[plane])), " ", \
dispc_read_reg(DISPC_REG(plane, name, i)))
for ( V_16 = 1 ; V_16 < F_27 () ; V_16 ++ ) {
for ( V_17 = 0 ; V_17 < 8 ; V_17 ++ )
F_250 ( V_16 , F_76 , V_17 ) ;
for ( V_17 = 0 ; V_17 < 8 ; V_17 ++ )
F_250 ( V_16 , F_78 , V_17 ) ;
for ( V_17 = 0 ; V_17 < 5 ; V_17 ++ )
F_250 ( V_16 , F_93 , V_17 ) ;
if ( F_12 ( V_35 ) ) {
for ( V_17 = 0 ; V_17 < 8 ; V_17 ++ )
F_250 ( V_16 , F_80 , V_17 ) ;
}
if ( F_12 ( V_36 ) ) {
for ( V_17 = 0 ; V_17 < 8 ; V_17 ++ )
F_250 ( V_16 , F_83 , V_17 ) ;
for ( V_17 = 0 ; V_17 < 8 ; V_17 ++ )
F_250 ( V_16 , F_85 , V_17 ) ;
for ( V_17 = 0 ; V_17 < 8 ; V_17 ++ )
...
int F_252 ( unsigned long F_237 ,
struct V_438 * V_404 )
{
if ( V_404 -> V_397 > 255 || V_404 -> V_397 == 0 )
return - V_280 ;
if ( V_404 -> V_398 < 1 || V_404 -> V_398 > 255 )
return - V_280 ;
V_404 -> V_439 = F_237 / V_404 -> V_397 ;
V_404 -> V_440 = V_404 -> V_439 / V_404 -> V_398 ;
return 0 ;
}
bool F_253 ( unsigned long V_3 ,
...
const struct V_438 * V_404 )
{
F_10 ( L_62 , V_404 -> V_439 , V_404 -> V_397 ) ;
F_10 ( L_63 , V_404 -> V_440 , V_404 -> V_398 ) ;
F_235 ( V_6 , V_404 -> V_397 , V_404 -> V_398 ) ;
}
...
unsigned long V_455 ;
V_455 = F_237 () ;
V_404 -> V_397 = F_6 ( F_236 ( V_6 ) , 23 , 16 ) ;
V_404 -> V_398 = F_6 ( F_236 ( V_6 ) , 7 , 0 ) ;
V_404 -> V_439 = V_455 / V_404 -> V_397 ;
V_404 -> V_440 = V_404 -> V_439 / V_404 -> V_398 ;
return 0 ;
}
T_2 F_257 ( void )
...
static int T_10 F_263 ( struct V_465 * V_43 )
{
const struct V_466 * V_467 ;
struct V_466 * V_468 ;
V_468 = F_264 ( & V_43 -> V_44 , sizeof( * V_468 ) , V_469 ) ;
if ( ! V_468 ) {
F_265 ( & V_43 -> V_44 , L_64 ) ;
return - V_470 ;
}
switch ( F_266 () ) {
case V_471 :
...
memcpy ( V_468 , V_467 , sizeof( * V_468 ) ) ;
V_3 . V_47 = V_468 ;
return 0 ;
}
static T_11 F_267 ( int V_487 , void * V_488 )
{
if ( ! V_3 . V_489 )
return V_490 ;
return V_3 . V_491 ( V_487 , V_3 . V_492 ) ;
}
int F_268 ( T_12 V_493 , void * V_494 )
{
int V_42 ;
if ( V_3 . V_491 != NULL )
return - V_495 ;
...
V_3 . V_492 = V_494 ;
F_269 () ;
V_42 = F_270 ( & V_3 . V_43 -> V_44 , V_3 . V_487 , F_267 ,
V_496 , L_65 , & V_3 ) ;
if ( V_42 ) {
V_3 . V_491 = NULL ;
V_3 . V_492 = NULL ;
...
void F_271 ( void * V_494 )
{
F_272 ( & V_3 . V_43 -> V_44 , V_3 . V_487 , & V_3 ) ;
V_3 . V_491 = NULL ;
V_3 . V_492 = NULL ;
}
static int T_10 F_273 ( struct V_465 * V_43 )
{
T_2 V_497 ;
int V_42 = 0 ;
struct V_498 * V_499 ;
...
if ( V_42 )
return V_42 ;
V_499 = F_274 ( V_3 . V_43 , V_500 , 0 ) ;
if ( ! V_499 ) {
F_74 ( L_66 ) ;
return - V_280 ;
}
V_3 . V_4 = F_275 ( & V_43 -> V_44 , V_499 -> V_169 ,
F_276 ( V_499 ) ) ;
if ( ! V_3 . V_4 ) {
F_74 ( L_67 ) ;
return - V_470 ;
}
V_3 . V_487 = F_277 ( V_3 . V_43 , 0 ) ;
if ( V_3 . V_487 < 0 ) {
F_74 ( L_68 ) ;
return - V_486 ;
}
...
F_262 () ;
V_497 = F_3 ( V_419 ) ;
F_279 ( & V_43 -> V_44 , L_69 ,
F_124 ( V_497 , 7 , 4 ) , F_124 ( V_497 , 3 , 0 ) ) ;
F_62 () ;
F_280 () ;
F_281 ( L_70 , F_249 ) ;
return 0 ;
...
static int T_13 F_283 ( struct V_465 * V_43 )
{
F_282 ( & V_43 -> V_44 ) ;
F_284 () ;
return 0 ;
}
static int F_285 ( struct V_502 * V_44 )
{
V_3 . V_489 = false ;
F_269 () ;
F_286 ( V_3 . V_487 ) ;
...
static int F_287 ( struct V_502 * V_44 )
{
