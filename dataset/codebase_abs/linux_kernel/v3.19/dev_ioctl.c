...
case V_34 :
if ( ! V_16 -> V_35 )
memset ( V_4 -> V_36 . V_37 , 0 ,
sizeof( V_4 -> V_36 . V_37 ) ) ;
else
memcpy ( V_4 -> V_36 . V_37 , V_16 -> V_38 ,
F_11 ( sizeof( V_4 -> V_36 . V_37 ) ,
( V_39 ) V_16 -> V_35 ) ) ;
...
void F_24 ( struct V_1 * V_1 , const char * V_123 )
{
struct V_15 * V_16 ;
int V_124 ;
F_25 () ;
...
V_124 = ! V_16 ;
if ( V_124 && F_27 ( V_125 ) )
V_124 = F_28 ( L_1 , V_123 ) ;
if ( V_124 && F_27 ( V_126 ) )
F_28 ( L_2 , V_123 ) ;
}
int F_29 ( struct V_1 * V_1 , unsigned int V_24 , void T_1 * V_3 )
{
struct V_2 V_4 ;
int V_127 ;
char * V_128 ;
...
case V_116 :
case V_104 :
if ( ! F_33 ( V_1 -> V_132 , V_125 ) )
return - V_133 ;
F_24 ( V_1 , V_4 . V_6 ) ;
F_30 () ;
V_127 = F_14 ( V_1 , & V_4 , V_24 ) ;
F_31 () ;
if ( ! V_127 ) {
if ( V_128 )
* V_128 = ':' ;
...
V_127 = F_14 ( V_1 , & V_4 , V_24 ) ;
F_31 () ;
if ( ! V_127 && F_4 ( V_3 , & V_4 ,
sizeof( struct V_2 ) ) )
V_127 = - V_5 ;
return V_127 ;
}
if ( V_24 >= V_138 && V_24 <= V_139 )
return F_34 ( V_1 , & V_4 , V_24 , V_3 ) ;
return - V_56 ;
}
}
