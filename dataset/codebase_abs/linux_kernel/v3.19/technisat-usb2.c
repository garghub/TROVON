...
{
struct V_1 * V_2 = V_91 -> V_52 -> V_2 ;
int V_9 ;
V_91 -> V_53 [ 0 ] . V_51 = F_32 ( V_92 , & V_88 ,
& V_91 -> V_52 -> V_78 , V_93 ) ;
if ( V_91 -> V_53 [ 0 ] . V_51 ) {
struct V_94 * V_95 ;
V_95 = F_32 ( V_96 ,
...
V_88 . V_98 = V_95 -> V_98 ;
V_88 . V_99 = V_95 -> V_99 ;
V_88 . V_100 = V_95 -> V_100 ;
V_88 . V_101 = V_95 -> V_101 ;
V_88 . V_102 = V_95 -> V_102 ;
V_88 . V_103 = V_95 -> V_103 ;
V_88 . V_104 = V_95 -> V_104 ;
V_88 . V_105 = V_95 -> V_105 ;
V_88 . V_106 = V_95 -> V_106 ;
V_88 . V_107 = V_95 -> V_107 ;
V_88 . V_108 = V_95 -> V_108 ;
if ( V_91 -> V_53 [ 0 ] . V_51 -> V_58 . V_109 )
V_91 -> V_53 [ 0 ] . V_51 -> V_58 . V_109 ( V_91 -> V_53 [ 0 ] . V_51 ) ;
if ( F_10 ( & V_91 -> V_52 -> V_23 ) < 0 )
return - V_24 ;
...
if ( V_9 != 0 )
F_4 ( L_14 ) ;
V_91 -> V_53 [ 0 ] . V_51 -> V_58 . V_111 = F_30 ;
F_33 ( V_91 -> V_53 [ 0 ] . V_51 -> V_58 . F_23 . V_112 , V_91 -> V_52 -> V_66 -> V_112 ,
sizeof( V_91 -> V_53 [ 0 ] . V_51 -> V_58 . F_23 . V_112 ) ) ;
} else {
F_34 ( V_91 -> V_53 [ 0 ] . V_51 ) ;
V_91 -> V_53 [ 0 ] . V_51 = NULL ;
}
}
F_16 ( V_91 -> V_52 , 1 , 1 ) ;
return V_91 -> V_53 [ 0 ] . V_51 == NULL ? - V_12 : 0 ;
}
...
V_114 . V_119 = 0 ;
while ( 1 ) {
V_114 . V_119 = ! V_114 . V_119 ;
V_114 . V_120 = ( * V_8 * V_121 * V_122 ) / 1000 ;
F_36 ( V_22 -> V_123 , & V_114 ) ;
V_8 ++ ;
if ( * V_8 == 0xff ) {
V_114 . V_119 = 0 ;
V_114 . V_120 = 888888 * 2 ;
F_36 ( V_22 -> V_123 , & V_114 ) ;
break;
}
}
...
static int F_39 ( struct V_124 * V_125 ,
const struct V_126 * V_127 )
{
struct V_21 * V_52 ;
if ( F_40 ( V_125 , & V_128 , V_129 ,
& V_52 , V_130 ) != 0 )
return - V_12 ;
if ( V_52 ) {
...
static void F_42 ( struct V_124 * V_125 )
{
struct V_21 * V_52 = F_43 ( V_125 ) ;
if ( V_52 != NULL ) {
struct V_48 * V_34 = V_52 -> V_72 ;
if ( V_34 != NULL )
F_44 ( & V_34 -> V_49 ) ;
