...
if ( V_7 -> V_147 )
goto V_148;
for ( V_144 = V_149 ; V_144 -> V_136 ; V_144 ++ ) {
...
if ( ! V_145 ) {
sprintf ( V_146 , L_49 , V_139 ) ;
V_145 = V_146 ;
}
V_7 -> V_147 = F_77 ( V_145 , V_53 ) ;
if ( ! V_7 -> V_147 )
return - V_54 ;
V_148:
if ( V_7 -> V_151 )
return 0 ;
if ( V_7 -> V_2 && V_7 -> V_2 -> V_150 )
V_7 -> V_151 = F_77 ( V_7 -> V_2 -> V_150 , V_53 ) ;
else {
sprintf ( V_146 , L_50 , V_7 -> V_139 & 0xffff ) ;
V_7 -> V_151 = F_77 ( V_146 , V_53 ) ;
}
if ( ! V_7 -> V_151 )
return - V_54 ;
return 0 ;
...
for ( V_18 = 0 ; V_18 < V_144 -> V_185 . V_175 ; V_18 ++ ) {
V_51 = F_83 ( & V_144 -> V_185 , V_18 ) ;
if ( ! V_51 -> V_253 && V_51 -> V_242 == V_242 &&
F_47 ( F_46 ( V_144 , V_51 -> V_25 ) ) == type )
V_51 -> V_254 = 1 ;
}
}
}
...
static struct V_307 *
F_188 ( struct V_6 * V_7 , const char * V_150 , int V_109 , int V_264 )
{
struct V_338 V_136 ;
...
V_136 . V_113 = V_109 ;
V_136 . V_281 = V_264 ;
if ( F_43 ( strlen ( V_150 ) >= sizeof( V_136 . V_150 ) ) )
return NULL ;
strcpy ( V_136 . V_150 , V_150 ) ;
return F_189 ( V_7 -> V_10 -> V_108 , & V_136 ) ;
}
struct V_307 * F_190 ( struct V_6 * V_7 ,
const char * V_150 )
{
return F_188 ( V_7 , V_150 , 0 , 0 ) ;
}
static int F_191 ( struct V_6 * V_7 , const char * V_150 ,
int V_341 )
{
int V_18 , V_264 ;
for ( V_18 = 0 , V_264 = V_341 ; V_18 < 16 ; V_18 ++ , V_264 ++ ) {
if ( ! F_188 ( V_7 , V_150 , 0 , V_264 ) )
return V_264 ;
}
return - V_200 ;
}
...
F_14 ( V_7 , L_62 ,
V_342 -> V_136 . V_150 , V_342 -> V_136 . V_281 , V_281 ) ;
return - V_61 ;
}
...
char V_372 [ sizeof( V_371 -> V_136 . V_150 ) ] ;
const char * V_150 = * V_370 ;
if ( V_367 ) {
snprintf ( V_372 , sizeof( V_372 ) , L_58 ,
V_150 , V_367 ) ;
V_150 = V_372 ;
}
if ( ! strcmp ( V_371 -> V_136 . V_150 , V_150 ) ) {
...
T_7 V_377 = F_208 () ;
F_209 ( F_210 () ) ;
if ( ! V_342 -> V_336 . V_144 ( V_342 , 0 , sizeof( V_325 ) , V_325 ) )
V_336 = V_325 ;
F_209 ( V_377 ) ;
...
int F_216 ( struct V_6 * V_7 , char * V_150 ,
...
return F_219 ( V_310 , 1 , 3 , V_384 ) ;
}
static int F_220 ( struct V_307 * V_308 ,
struct V_319 * V_320 )
{
struct V_385 * V_386 = F_174 ( V_308 ) ;
V_320 -> V_314 . V_387 . V_343 [ 0 ] = V_386 -> V_388 ;
return 0 ;
}
static int F_221 ( struct V_307 * V_308 ,
struct V_319 * V_320 )
{
struct V_385 * V_386 = F_174 ( V_308 ) ;
unsigned int V_389 = V_386 -> V_388 ;
V_386 -> V_388 = V_320 -> V_314 . V_387 . V_343 [ 0 ] ;
if ( V_386 -> V_388 > V_390 )
V_386 -> V_388 = V_390 ;
if ( V_389 == V_386 -> V_388 )
return 0 ;
F_222 ( V_386 ) ;
return 1 ;
}
...
{
struct V_307 * V_342 ;
if ( ! V_386 -> V_386 || ! V_386 -> V_392 )
return 0 ;
F_224 ( V_386 -> V_392 , V_386 -> V_386 , V_7 ) ;
V_386 -> V_7 = V_7 ;
V_386 -> V_388 = V_390 ;
if ( ! V_391 )
return 0 ;
V_342 = F_225 ( & V_393 , V_386 ) ;
if ( ! V_342 )
return - V_54 ;
return F_192 ( V_7 , 0 , V_342 ) ;
}
void F_222 ( struct V_385 * V_386 )
{
if ( ! V_386 -> V_386 || ! V_386 -> V_7 )
return;
if ( V_386 -> V_7 -> V_10 -> V_115 )
return;
switch ( V_386 -> V_388 ) {
case V_390 :
F_226 ( V_386 -> V_392 ) ;
break;
default:
V_386 -> V_386 ( V_386 -> V_7 , V_386 -> V_388 ) ;
break;
}
}
...
int V_33 ;
F_2 ( & V_7 -> V_209 ) ;
V_144 = (struct V_399 * ) V_308 -> V_347 ;
V_308 -> V_347 = * V_144 -> V_400 ;
V_33 = V_144 -> V_12 -> V_266 ( V_308 , V_310 ) ;
V_308 -> V_347 = ( long ) V_144 ;
F_4 ( & V_7 -> V_209 ) ;
return V_33 ;
}
...
V_144 = (struct V_399 * ) V_308 -> V_347 ;
V_308 -> V_347 = * V_144 -> V_400 ;
V_33 = V_144 -> V_12 -> V_401 ( V_308 , V_320 ) ;
V_308 -> V_347 = ( long ) V_144 ;
F_4 ( & V_7 -> V_209 ) ;
return V_33 ;
}
int F_235 ( struct V_307 * V_308 ,
struct V_319 * V_320 )
{
struct V_6 * V_7 = F_174 ( V_308 ) ;
struct V_399 * V_144 ;
...
F_2 ( & V_7 -> V_209 ) ;
V_144 = (struct V_399 * ) V_308 -> V_347 ;
for ( V_402 = V_144 -> V_400 ; * V_402 ; V_402 ++ ) {
V_308 -> V_347 = * V_402 ;
V_33 = V_144 -> V_12 -> V_379 ( V_308 , V_320 ) ;
if ( V_33 < 0 )
break;
V_322 |= V_33 ;
}
...
int F_236 ( struct V_307 * V_308 , int V_323 ,
...
V_144 = (struct V_399 * ) V_308 -> V_347 ;
V_308 -> V_347 = * V_144 -> V_400 ;
V_33 = V_144 -> V_12 -> V_336 ( V_308 , V_323 , V_324 , V_336 ) ;
V_308 -> V_347 = ( long ) V_144 ;
F_4 ( & V_7 -> V_209 ) ;
return V_33 ;
}
...
struct V_319 * V_320 )
{
V_320 -> V_314 . V_404 . V_405 [ 0 ] = V_406 |
V_407 |
V_408 |
V_409 ;
V_320 -> V_314 . V_404 . V_405 [ 1 ] = V_410 |
V_411 ;
return 0 ;
}
...
static int F_240 ( struct V_307 * V_308 ,
struct V_319 * V_320 )
{
struct V_6 * V_7 = F_174 ( V_308 ) ;
...
V_320 -> V_314 . V_404 . V_405 [ 0 ] = V_413 -> V_405 & 0xff ;
V_320 -> V_314 . V_404 . V_405 [ 1 ] = ( V_413 -> V_405 >> 8 ) & 0xff ;
V_320 -> V_314 . V_404 . V_405 [ 2 ] = ( V_413 -> V_405 >> 16 ) & 0xff ;
V_320 -> V_314 . V_404 . V_405 [ 3 ] = ( V_413 -> V_405 >> 24 ) & 0xff ;
F_4 ( & V_7 -> V_208 ) ;
return 0 ;
}
static unsigned short F_241 ( unsigned int V_414 )
{
...
static unsigned int F_242 ( unsigned short V_29 )
{
...
static void F_243 ( struct V_6 * V_7 , T_2 V_25 ,
int V_27 , int V_29 )
{
const T_2 * V_422 ;
F_244 ( V_7 , V_25 , 0 , V_27 , V_29 ) ;
V_422 = V_7 -> V_364 ;
if ( ! V_422 )
return;
for (; * V_422 ; V_422 ++ )
F_244 ( V_7 , * V_422 , 0 , V_27 , V_29 ) ;
}
static inline void F_245 ( struct V_6 * V_7 , T_2 V_25 ,
int V_423 , int V_424 )
{
if ( V_423 != - 1 )
F_243 ( V_7 , V_25 , V_425 , V_423 ) ;
if ( V_424 != - 1 )
F_243 ( V_7 , V_25 , V_426 , V_424 ) ;
}
...
V_413 = F_83 ( & V_7 -> V_190 , V_264 ) ;
V_25 = V_413 -> V_25 ;
V_413 -> V_405 = V_320 -> V_314 . V_404 . V_405 [ 0 ] |
( ( unsigned int ) V_320 -> V_314 . V_404 . V_405 [ 1 ] << 8 ) |
( ( unsigned int ) V_320 -> V_314 . V_404 . V_405 [ 2 ] << 16 ) |
( ( unsigned int ) V_320 -> V_314 . V_404 . V_405 [ 3 ] << 24 ) ;
V_29 = F_241 ( V_413 -> V_405 ) ;
V_29 |= V_413 -> V_427 & 1 ;
V_322 = V_413 -> V_427 != V_29 ;
V_413 -> V_427 = V_29 ;
if ( V_322 && V_25 != ( T_4 ) - 1 )
...
static int F_247 ( struct V_307 * V_308 ,
struct V_319 * V_320 )
{
struct V_6 * V_7 = F_174 ( V_308 ) ;
int V_264 = V_308 -> V_347 ;
...
F_2 ( & V_7 -> V_208 ) ;
V_413 = F_83 ( & V_7 -> V_190 , V_264 ) ;
V_320 -> V_314 . integer . V_314 [ 0 ] = V_413 -> V_427 & V_428 ;
F_4 ( & V_7 -> V_208 ) ;
return 0 ;
}
static inline void F_248 ( struct V_6 * V_7 , T_2 V_25 ,
int V_423 , int V_424 )
{
F_245 ( V_7 , V_25 , V_423 , V_424 ) ;
if ( ( F_46 ( V_7 , V_25 ) & V_429 ) &&
( V_423 & V_428 ) )
F_168 ( V_7 , V_25 , V_273 , 0 ,
V_296 , 0 ) ;
}
static int F_249 ( struct V_307 * V_308 ,
struct V_319 * V_320 )
{
struct V_6 * V_7 = F_174 ( V_308 ) ;
int V_264 = V_308 -> V_347 ;
...
type == V_436 ) {
for ( V_433 = V_438 ; V_433 -> V_150 ; V_433 ++ ) {
V_342 = F_188 ( V_7 , V_433 -> V_150 , 0 , 0 ) ;
if ( ! V_342 )
break;
V_342 -> V_136 . V_281 = V_434 ;
}
V_10 -> V_435 = V_436 ;
}
if ( ! V_10 -> V_435 )
...
V_439 , 0 ) ;
V_413 -> V_405 = F_242 ( V_413 -> V_427 ) ;
return 0 ;
}
struct V_214 * F_251 ( struct V_6 * V_7 ,
T_2 V_25 )
{
int V_18 ;
...
void F_252 ( struct V_6 * V_7 , int V_264 )
{
struct V_214 * V_413 ;
F_2 ( & V_7 -> V_208 ) ;
V_413 = F_83 ( & V_7 -> V_190 , V_264 ) ;
...
void F_253 ( struct V_6 * V_7 , int V_264 , T_2 V_25 )
{
struct V_214 * V_413 ;
unsigned short V_29 ;
F_2 ( & V_7 -> V_208 ) ;
...
V_413 -> V_25 = V_25 ;
V_29 = V_413 -> V_427 ;
F_248 ( V_7 , V_25 , V_29 & 0xff , ( V_29 >> 8 ) & 0xff ) ;
}
F_4 ( & V_7 -> V_208 ) ;
}
...
struct V_319 * V_320 )
{
struct V_440 * V_441 = F_174 ( V_308 ) ;
V_320 -> V_314 . integer . V_314 [ 0 ] = V_441 -> V_442 ;
return 0 ;
}
static int F_255 ( struct V_307 * V_308 ,
struct V_319 * V_320 )
{
struct V_440 * V_441 = F_174 ( V_308 ) ;
V_441 -> V_442 = ! ! V_320 -> V_314 . integer . V_314 [ 0 ] ;
return 0 ;
}
...
if ( ! V_441 -> V_443 )
return 0 ;
V_342 = F_225 ( & V_444 , V_441 ) ;
if ( ! V_342 )
return - V_54 ;
return F_192 ( V_7 , V_441 -> V_443 , V_342 ) ;
}
static int F_257 ( struct V_307 * V_308 ,
struct V_319 * V_320 )
{
struct V_6 * V_7 = F_174 ( V_308 ) ;
V_320 -> V_314 . integer . V_314 [ 0 ] = V_7 -> V_445 ;
return 0 ;
}
...
static int F_259 ( struct V_307 * V_308 ,
struct V_319 * V_320 )
{
struct V_6 * V_7 = F_174 ( V_308 ) ;
T_2 V_25 = V_308 -> V_347 ;
...
V_414 = F_242 ( V_29 ) ;
V_320 -> V_314 . V_404 . V_405 [ 0 ] = V_414 ;
V_320 -> V_314 . V_404 . V_405 [ 1 ] = V_414 >> 8 ;
V_320 -> V_314 . V_404 . V_405 [ 2 ] = V_414 >> 16 ;
V_320 -> V_314 . V_404 . V_405 [ 3 ] = V_414 >> 24 ;
return 0 ;
}
...
for ( V_433 = V_446 ; V_433 -> V_150 ; V_433 ++ ) {
V_342 = F_225 ( V_433 , V_7 ) ;
if ( ! V_342 )
return - V_54 ;
V_342 -> V_347 = V_25 ;
...
V_27 = V_27 | ( V_28 >> 8 ) ;
V_28 &= 0xff ;
V_263 = F_261 ( V_25 , V_27 ) ;
F_2 ( & V_7 -> V_10 -> V_35 ) ;
V_144 = F_148 ( & V_7 -> V_192 , V_263 ) ;
if ( V_144 ) {
V_144 -> V_29 = V_28 ;
V_144 -> V_254 = V_300 ;
}
...
int F_262 ( struct V_6 * V_7 , T_2 V_25 ,
int V_26 , unsigned int V_27 , unsigned int V_28 )
{
struct V_212 * V_144 ;
T_1 V_263 ;
...
V_263 = F_261 ( V_25 , V_27 ) ;
F_2 ( & V_7 -> V_10 -> V_35 ) ;
V_144 = F_147 ( & V_7 -> V_192 , V_263 ) ;
if ( V_144 && V_144 -> V_29 == V_28 ) {
F_4 ( & V_7 -> V_10 -> V_35 ) ;
return 0 ;
}
F_4 ( & V_7 -> V_10 -> V_35 ) ;
return F_244 ( V_7 , V_25 , V_26 , V_27 , V_28 ) ;
}
...
V_303 -> V_254 = 0 ;
F_4 ( & V_7 -> V_210 ) ;
F_24 ( V_7 , F_264 ( V_263 ) , 0 ,
F_265 ( V_263 ) , V_303 -> V_29 ) ;
F_2 ( & V_7 -> V_210 ) ;
}
F_4 ( & V_7 -> V_210 ) ;
}
...
{
for (; V_46 -> V_25 ; V_46 ++ )
F_244 ( V_7 , V_46 -> V_25 , 0 , V_46 -> V_27 ,
V_46 -> V_47 ) ;
}
...
void F_268 ( struct V_6 * V_7 , T_2 V_197 ,
unsigned int V_447 )
{
T_2 V_25 = V_7 -> V_164 ;
int V_18 ;
...
static unsigned int F_269 ( struct V_6 * V_7 ,
T_2 V_197 ,
unsigned int V_447 )
{
unsigned long V_455 = V_456 + F_270 ( 500 ) ;
...
if ( V_457 == V_447 )
break;
if ( F_271 ( V_456 , V_455 ) )
break;
F_141 ( 1 ) ;
}
return V_448 ;
}
unsigned int F_272 ( struct V_6 * V_7 ,
T_2 V_25 ,
unsigned int V_447 )
{
...
V_452 ,
V_448 ) ;
F_268 ( V_7 , V_197 , V_447 ) ;
}
V_448 = F_269 ( V_7 , V_197 , V_447 ) ;
if ( ! ( V_448 & V_459 ) )
break;
}
return V_448 ;
...
static inline void F_275 ( struct V_6 * V_7 ) {}
static unsigned int F_276 ( struct V_6 * V_7 , bool V_465 )
{
unsigned int V_448 ;
V_7 -> V_466 = 1 ;
if ( V_7 -> V_106 . V_467 )
...
struct V_475 * V_354 = V_7 -> V_358 [ V_18 ] . V_354 ;
struct V_476 * V_477 =
& V_7 -> V_358 [ V_18 ] . V_478 [ V_474 ] ;
struct V_479 * V_480 ;
const struct V_481 * V_482 ;
if ( V_7 -> V_358 [ V_18 ] . V_483 )
continue;
if ( ! V_354 || ! V_477 -> V_484 )
continue;
V_482 = V_477 -> V_480 ? V_477 -> V_480 : V_485 ;
V_33 = F_285 ( V_354 , V_474 , V_482 ,
V_477 -> V_486 ,
0 , & V_480 ) ;
if ( V_33 < 0 )
return V_33 ;
...
unsigned int F_286 ( struct V_6 * V_7 ,
unsigned int V_490 ,
unsigned int V_491 ,
unsigned int V_248 ,
unsigned int V_492 ,
...
{
return F_154 ( V_7 , V_25 , 0 , F_290 ( V_25 ) ,
F_288 ) ;
}
static unsigned int F_291 ( struct V_6 * V_7 , T_2 V_25 ,
int V_276 )
{
unsigned int V_359 = F_27 ( V_7 , V_25 , V_506 ) ;
if ( ! V_359 || V_359 == - 1 )
V_359 = F_27 ( V_7 , V_7 -> V_137 , V_506 ) ;
if ( ! V_359 || V_359 == - 1 )
return 0 ;
return V_359 ;
}
static unsigned int F_292 ( struct V_6 * V_7 , T_2 V_25 )
{
return F_154 ( V_7 , V_25 , 0 , F_293 ( V_25 ) ,
F_291 ) ;
}
...
if ( V_508 || V_509 ) {
T_8 V_513 = 0 ;
unsigned int V_359 , V_514 ;
V_359 = F_292 ( V_7 , V_25 ) ;
if ( ! V_359 )
return - V_76 ;
V_514 = 0 ;
if ( V_359 & V_515 ) {
...
int F_295 ( struct V_6 * V_7 , T_2 V_25 ,
unsigned int V_248 )
{
int V_18 ;
...
static int F_297 ( struct V_476 * V_477 ,
struct V_6 * V_7 ,
unsigned int V_242 ,
unsigned int V_248 ,
struct V_526 * V_527 )
...
static int F_298 ( struct V_476 * V_477 ,
struct V_6 * V_7 ,
struct V_526 * V_527 )
{
F_299 ( V_7 , V_477 -> V_25 ) ;
return 0 ;
}
...
V_266 -> V_12 . V_528 = F_296 ;
if ( V_266 -> V_12 . V_529 == NULL )
V_266 -> V_12 . V_529 = F_296 ;
if ( V_266 -> V_12 . V_530 == NULL ) {
if ( F_43 ( ! V_266 -> V_25 ) )
return - V_61 ;
V_266 -> V_12 . V_530 = F_297 ;
}
if ( V_266 -> V_12 . V_531 == NULL ) {
if ( F_43 ( ! V_266 -> V_25 ) )
return - V_61 ;
V_266 -> V_12 . V_531 = F_298 ;
}
return 0 ;
}
...
int V_302 ;
F_2 ( & V_7 -> V_10 -> V_128 ) ;
V_302 = V_477 -> V_12 . V_530 ( V_477 , V_7 , V_478 , V_248 , V_527 ) ;
if ( V_302 >= 0 )
F_145 ( V_7 ) ;
F_4 ( & V_7 -> V_10 -> V_128 ) ;
return V_302 ;
...
static int F_303 ( struct V_9 * V_10 , unsigned int type )
{
...
break;
#endif
if ( ! F_305 ( V_532 [ type ] [ V_18 ] , V_10 -> V_361 ) )
return V_532 [ type ] [ V_18 ] ;
}
#ifdef F_304
for ( V_18 = 10 ; V_18 < 32 ; V_18 ++ ) {
if ( ! F_305 ( V_18 , V_10 -> V_361 ) )
return V_18 ;
}
#endif
F_306 ( V_10 -> V_108 -> V_109 , L_80 ,
V_536 [ type ] ) ;
#ifndef F_304
F_306 ( V_10 -> V_108 -> V_109 ,
L_81 ) ;
#endif
return - V_39 ;
}
static int F_307 ( struct V_6 * V_7 , struct V_356 * V_354 )
{
struct V_9 * V_10 = V_7 -> V_10 ;
struct V_476 * V_266 ;
int V_478 , V_33 ;
...
V_266 = & V_354 -> V_478 [ V_478 ] ;
if ( V_266 -> V_484 ) {
V_33 = F_300 ( V_7 , V_266 ) ;
if ( V_33 < 0 )
return V_33 ;
}
}
return V_10 -> V_12 . V_537 ( V_10 , V_7 , V_354 ) ;
}
...
struct V_356 * V_357 = & V_7 -> V_358 [ V_354 ] ;
int V_109 ;
if ( ! V_357 -> V_478 [ 0 ] . V_484 && ! V_357 -> V_478 [ 1 ] . V_484 )
continue;
if ( ! V_357 -> V_354 ) {
V_109 = F_303 ( V_7 -> V_10 , V_357 -> V_539 ) ;
if ( V_109 < 0 )
continue;
V_357 -> V_113 = V_109 ;
V_33 = F_307 ( V_7 , V_357 ) ;
if ( V_33 < 0 ) {
F_14 ( V_7 ,
L_83 ,
V_109 , V_7 -> V_30 ) ;
...
const struct V_432 * V_540 )
{
int V_33 ;
for (; V_540 -> V_150 ; V_540 ++ ) {
struct V_307 * V_342 ;
int V_30 = 0 , V_264 = 0 ;
if ( V_540 -> V_339 == - 1 )
continue;
for (; ; ) {
V_342 = F_225 ( V_540 , V_7 ) ;
if ( ! V_342 )
return - V_54 ;
if ( V_30 > 0 )
...
if ( ! V_7 -> V_468 || V_7 -> V_541 ) {
V_7 -> V_469 = 0 ;
F_200 ( & V_7 -> V_221 ) ;
return;
}
F_200 ( & V_7 -> V_221 ) ;
V_448 = F_276 ( V_7 , true ) ;
if ( ! V_10 -> V_233 && ( V_448 & V_542 ) )
F_7 ( V_7 , false ) ;
}
...
{
unsigned long V_543 = V_456 - V_7 -> V_470 ;
if ( V_7 -> V_468 )
V_7 -> V_544 += V_543 ;
else
V_7 -> V_545 += V_543 ;
...
static void F_311 ( struct V_6 * V_7 , bool V_546 )
{
...
{
if ( ! V_7 -> V_468 || V_7 -> V_541 || V_7 -> V_469 )
return;
if ( V_127 ( V_7 ) ) {
V_7 -> V_469 = - 1 ;
F_95 ( V_7 -> V_10 -> V_98 , & V_7 -> V_187 ,
F_270 ( V_127 ( V_7 ) * 1000 ) ) ;
}
}
void F_314 ( struct V_6 * V_7 , int V_543 , bool V_547 )
{
F_199 ( & V_7 -> V_221 ) ;
V_7 -> V_541 += V_543 ;
F_315 ( V_7 ) ;
...
T_2 V_25 )
{
const struct V_550 * V_51 ;
int V_280 , V_551 ;
if ( ! V_549 -> V_552 )
return 0 ;
for ( V_51 = V_549 -> V_552 ; V_51 -> V_25 ; V_51 ++ ) {
if ( V_51 -> V_25 == V_25 )
break;
}
if ( ! V_51 -> V_25 )
...
for ( V_51 = V_549 -> V_552 ; V_51 -> V_25 ; V_51 ++ ) {
for ( V_280 = 0 ; V_280 < 2 ; V_280 ++ ) {
V_551 = F_165 ( V_7 , V_51 -> V_25 , V_280 , V_51 -> V_276 ,
V_51 -> V_264 ) ;
if ( ! ( V_551 & V_296 ) && V_551 > 0 ) {
if ( ! V_549 -> V_468 ) {
V_549 -> V_468 = 1 ;
F_16 ( V_7 ) ;
}
...
V_310 -> type = V_556 ;
V_310 -> V_313 = 1 ;
V_310 -> V_314 . V_387 . V_349 = V_555 ;
if ( V_310 -> V_314 . V_387 . V_343 >= V_555 )
V_310 -> V_314 . V_387 . V_343 = V_555 - 1 ;
sprintf ( V_310 -> V_314 . V_387 . V_150 , L_84 ,
V_554 [ V_310 -> V_314 . V_387 . V_343 ] . V_491 ) ;
return 0 ;
}
...
{
int V_18 ;
for ( V_18 = 0 ; V_18 < V_555 ; V_18 ++ ) {
if ( V_557 == V_554 [ V_18 ] . V_491 ) {
V_320 -> V_314 . V_387 . V_343 [ 0 ] = V_18 ;
break;
}
}
return 0 ;
...
{
unsigned int V_559 ;
V_559 = V_320 -> V_314 . V_387 . V_343 [ 0 ] ;
if ( V_559 >= V_555 )
return - V_61 ;
if ( * V_558 == V_554 [ V_559 ] . V_491 )
return 0 ;
* V_558 = V_554 [ V_559 ] . V_491 ;
if ( V_554 [ V_559 ] . V_560 )
F_266 ( V_7 , V_554 [ V_559 ] . V_560 ) ;
return 1 ;
}
int F_320 ( const struct V_561 * V_562 ,
struct V_309 * V_310 )
{
unsigned int V_281 ;
V_310 -> type = V_556 ;
V_310 -> V_313 = 1 ;
V_310 -> V_314 . V_387 . V_349 = V_562 -> V_563 ;
if ( ! V_562 -> V_563 )
return 0 ;
V_281 = V_310 -> V_314 . V_387 . V_343 ;
if ( V_281 >= V_562 -> V_563 )
V_281 = V_562 -> V_563 - 1 ;
strcpy ( V_310 -> V_314 . V_387 . V_150 , V_562 -> V_349 [ V_281 ] . V_564 ) ;
return 0 ;
}
...
if ( ! V_562 -> V_563 )
return 0 ;
V_264 = V_320 -> V_314 . V_387 . V_343 [ 0 ] ;
if ( V_264 >= V_562 -> V_563 )
V_264 = V_562 -> V_563 - 1 ;
if ( * V_565 == V_264 )
return 0 ;
F_244 ( V_7 , V_25 , 0 , V_566 ,
V_562 -> V_349 [ V_264 ] . V_281 ) ;
* V_565 = V_264 ;
return 1 ;
}
int F_322 ( struct V_307 * V_308 ,
struct V_309 * V_310 ,
...
return F_219 ( V_310 , 1 , V_563 , V_384 ) ;
}
...
if ( V_7 -> V_364 ) {
const T_2 * V_422 ;
for ( V_422 = V_7 -> V_364 ; * V_422 ; V_422 ++ )
...
static void F_324 ( struct V_6 * V_7 , T_2 V_25 )
{
F_299 ( V_7 , V_25 ) ;
if ( V_7 -> V_364 ) {
const T_2 * V_422 ;
...
{
F_2 ( & V_7 -> V_208 ) ;
if ( V_441 -> V_571 == V_572 )
F_324 ( V_7 , V_441 -> V_443 ) ;
V_441 -> V_571 = V_573 ;
F_4 ( & V_7 -> V_208 ) ;
return 0 ;
}
...
{
F_2 ( & V_7 -> V_208 ) ;
F_323 ( V_7 , V_441 -> V_443 , V_242 , V_248 ) ;
F_4 ( & V_7 -> V_208 ) ;
return 0 ;
}
...
struct V_476 * V_477 )
{
struct V_574 * V_575 = V_527 -> V_575 ;
V_575 -> V_576 . V_486 = V_441 -> V_557 ;
if ( V_441 -> V_443 ) {
if ( ! V_441 -> V_577 ) {
V_441 -> V_577 = V_477 -> V_510 ;
V_441 -> V_578 = V_477 -> V_513 ;
V_441 -> V_579 = V_477 -> V_492 ;
} else {
V_575 -> V_576 . V_510 = V_441 -> V_577 ;
V_575 -> V_576 . V_513 = V_441 -> V_578 ;
V_477 -> V_492 = V_441 -> V_579 ;
}
if ( ! V_441 -> V_580 ) {
F_294 ( V_7 , V_441 -> V_443 ,
& V_441 -> V_580 ,
& V_441 -> V_581 ,
& V_441 -> V_582 ) ;
}
F_2 ( & V_7 -> V_208 ) ;
if ( V_441 -> V_442 ) {
if ( ( V_575 -> V_576 . V_510 & V_441 -> V_580 ) &&
( V_575 -> V_576 . V_513 & V_441 -> V_581 ) ) {
V_575 -> V_576 . V_510 &= V_441 -> V_580 ;
V_575 -> V_576 . V_513 &= V_441 -> V_581 ;
if ( V_441 -> V_582 < V_477 -> V_492 )
V_477 -> V_492 = V_441 -> V_582 ;
} else {
V_441 -> V_442 = 0 ;
}
}
...
struct V_526 * V_527 )
{
const T_2 * V_189 = V_441 -> V_584 ;
int V_311 = V_527 -> V_575 -> V_491 ;
struct V_214 * V_413 ;
int V_18 ;
F_2 ( & V_7 -> V_208 ) ;
V_413 = F_251 ( V_7 , V_441 -> V_443 ) ;
if ( V_441 -> V_443 && V_441 -> V_442 &&
V_441 -> V_571 != V_573 ) {
if ( V_311 == 2 &&
F_295 ( V_7 , V_441 -> V_443 ,
V_248 ) &&
! ( V_413 -> V_405 & V_407 ) ) {
V_441 -> V_571 = V_572 ;
F_323 ( V_7 , V_441 -> V_443 ,
V_242 , V_248 ) ;
} else {
V_441 -> V_571 = 0 ;
F_324 ( V_7 , V_441 -> V_443 ) ;
...
0 , V_248 ) ;
if ( ! V_441 -> V_586 &&
V_441 -> V_587 && V_441 -> V_587 != V_189 [ V_585 ] )
F_142 ( V_7 , V_441 -> V_587 , V_242 ,
0 , V_248 ) ;
for ( V_18 = 0 ; V_18 < F_10 ( V_441 -> V_588 ) ; V_18 ++ )
if ( ! V_441 -> V_586 && V_441 -> V_588 [ V_18 ] )
F_142 ( V_7 ,
V_441 -> V_588 [ V_18 ] ,
V_242 , 0 , V_248 ) ;
for ( V_18 = 1 ; V_18 < V_441 -> V_589 ; V_18 ++ ) {
if ( V_311 >= ( V_18 + 1 ) * 2 )
...
for ( V_18 = 0 ; V_18 < F_10 ( V_441 -> V_590 ) ; V_18 ++ ) {
int V_280 = 0 ;
if ( ! V_441 -> V_590 [ V_18 ] )
break;
if ( V_311 >= ( V_18 + 1 ) * 2 )
...
const T_2 * V_189 = V_441 -> V_584 ;
int V_18 ;
for ( V_18 = 0 ; V_18 < V_441 -> V_589 ; V_18 ++ )
F_299 ( V_7 , V_189 [ V_18 ] ) ;
if ( V_441 -> V_587 )
F_299 ( V_7 , V_441 -> V_587 ) ;
for ( V_18 = 0 ; V_18 < F_10 ( V_441 -> V_588 ) ; V_18 ++ )
if ( V_441 -> V_588 [ V_18 ] )
F_299 ( V_7 ,
V_441 -> V_588 [ V_18 ] ) ;
...
V_441 -> V_590 [ V_18 ] ) ;
F_2 ( & V_7 -> V_208 ) ;
if ( V_441 -> V_443 && V_441 -> V_571 == V_572 ) {
F_324 ( V_7 , V_441 -> V_443 ) ;
V_441 -> V_571 = 0 ;
}
F_4 ( & V_7 -> V_208 ) ;
...
unsigned int F_335 ( struct V_6 * V_7 , T_2 V_167 )
{
unsigned int V_591 ;
unsigned int V_244 ;
...
unsigned int F_336 ( struct V_6 * V_7 ,
...
int F_337 ( struct V_6 * V_7 , T_2 V_167 ,
unsigned int V_29 , bool V_615 )
{
V_29 = F_336 ( V_7 , V_167 , V_29 ) ;
F_88 ( V_7 , V_167 , V_29 ) ;
if ( V_615 )
return F_262 ( V_7 , V_167 , 0 ,
V_180 , V_29 ) ;
else
return F_24 ( V_7 , V_167 , 0 ,
V_180 , V_29 ) ;
}
int F_338 ( struct V_6 * V_7 ,
...
F_339 ( V_562 -> V_349 [ V_562 -> V_563 ] . V_564 , V_564 ,
sizeof( V_562 -> V_349 [ V_562 -> V_563 ] . V_564 ) ) ;
...
static void F_341 ( void * V_369 , T_9 V_619 )
{
F_280 ( V_369 ) ;
}
...
if ( F_43 ( V_623 >= 4096 ) )
return NULL ;
V_625 = F_347 ( V_174 -> V_4 , V_324 , V_53 | V_626 ) ;
if ( ! V_625 )
return NULL ;
V_174 -> V_4 = V_625 ;
V_174 -> V_622 = V_623 ;
...
void F_348 ( int V_354 , char * V_262 , int V_627 )
{
