...
static int F_28 ( struct V_33 * V_33 ,
struct V_36 * V_37 ,
struct V_38 * * V_39 )
{
T_1 V_40 ;
...
. V_50 = V_51 ,
. V_52 = V_53 } ;
struct V_54 * V_55 = F_30 ( V_33 ) ;
struct V_56 * exp = V_55 -> V_57 ;
int V_34 ;
F_31 ( & V_3 -> V_58 ) ;
V_40 = F_32 ( V_33 , V_59 , & V_42 , 0 , V_60 ) ;
if ( V_40 != 0 ) {
V_37 -> V_61 . V_62 . V_63 = V_42 . V_64 ;
V_37 -> V_61 . V_62 . V_65 = V_40 ;
goto V_66;
}
V_44 = F_33 ( NULL , V_33 , NULL , NULL , 0 , 0 ,
V_67 , NULL ) ;
if ( F_34 ( V_44 ) ) {
F_35 ( & V_3 -> V_58 ) ;
return F_36 ( V_44 ) ;
...
V_37 -> V_61 . V_62 . V_85 , F_39 ( F_40 ( V_33 ) ) ) ;
V_34 = V_37 -> V_61 . V_62 . V_85 ;
if ( V_34 == - V_32 )
V_34 = - V_86 ;
goto V_87;
}
V_78 = F_44 ( & V_39 -> V_88 , & V_89 ) ;
if ( V_78 == NULL ) {
F_45 ( L_13 ) ;
V_34 = - V_20 ;
goto V_87;
}
V_73 = F_46 ( & V_39 -> V_88 , & V_90 ,
V_78 -> V_91 ) ;
V_74 = F_46 ( & V_39 -> V_88 , & V_92 ,
V_78 -> V_93 ) ;
V_79 = F_46 ( & V_39 -> V_88 , & V_94 ,
