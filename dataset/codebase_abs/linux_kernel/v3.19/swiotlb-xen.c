...
T_2 V_58 ;
V_53 &= ~ ( V_59 | V_60 ) ;
if ( F_41 ( V_52 , V_22 , V_30 , & V_56 ) )
return V_56 ;
V_56 = F_42 ( V_52 , V_22 , V_30 , V_53 , V_55 ) ;
if ( ! V_56 )
return V_56 ;
if ( V_52 && V_52 -> V_5 )
V_4 = F_1 ( V_52 , V_53 ) ;
...
if ( F_19 ( V_57 , V_44 ,
F_43 ( V_4 ) , V_30 ) != 0 ) {
F_44 ( V_52 , V_22 , V_56 , ( T_2 ) V_57 , V_55 ) ;
return NULL ;
}
}
memset ( V_56 , 0 , V_22 ) ;
...
void
F_45 ( struct V_1 * V_52 , T_4 V_22 , void * V_61 ,
T_2 V_58 , struct V_54 * V_55 )
{
int V_44 = F_17 ( V_22 ) ;
T_3 V_57 ;
T_6 V_4 = F_2 ( 32 ) ;
if ( F_46 ( V_52 , V_44 , V_61 ) )
return;
if ( V_52 && V_52 -> V_5 )
V_4 = V_52 -> V_5 ;
V_57 = F_6 ( V_58 ) ;
...
F_11 ( V_57 , V_22 ) )
F_47 ( V_57 , V_44 ) ;
F_44 ( V_52 , V_22 , V_61 , ( T_2 ) V_57 , V_55 ) ;
}
...
! F_11 ( V_57 , V_22 ) &&
! F_52 ( V_2 , F_5 ( V_57 ) , F_5 ( V_58 ) ) &&
! V_67 ) {
F_53 ( V_2 , V_62 , V_58 , V_15 , V_22 , V_64 , V_55 ) ;
return V_58 ;
}
F_54 ( V_2 , V_58 , V_22 , V_67 ) ;
V_65 = F_55 ( V_2 , V_51 , V_57 , V_22 , V_64 ) ;
if ( V_65 == V_68 )
return V_69 ;
F_53 ( V_2 , F_56 ( V_65 >> V_10 ) ,
V_58 , V_65 & ~ V_11 , V_22 , V_64 , V_55 ) ;
V_58 = F_3 ( V_65 ) ;
if ( ! F_51 ( V_2 , V_58 , V_22 ) ) {
F_57 ( V_2 , V_65 , V_22 , V_64 ) ;
V_58 = 0 ;
}
return V_58 ;
}
static void F_58 ( struct V_1 * V_52 , T_2 V_58 ,
T_4 V_22 , enum V_63 V_64 ,
struct V_54 * V_55 )
{
T_3 V_7 = F_6 ( V_58 ) ;
F_50 ( V_64 == V_66 ) ;
F_59 ( V_52 , V_58 , V_22 , V_64 , V_55 ) ;
if ( F_12 ( V_58 ) ) {
F_57 ( V_52 , V_7 , V_22 , V_64 ) ;
return;
}
if ( V_64 != V_70 )
return;
...
void F_62 ( struct V_1 * V_52 , T_2 V_58 ,
T_4 V_22 , enum V_63 V_64 ,
struct V_54 * V_55 )
{
F_58 ( V_52 , V_58 , V_22 , V_64 , V_55 ) ;
}
static void
F_63 ( struct V_1 * V_52 , T_2 V_58 ,
T_4 V_22 , enum V_63 V_64 ,
enum V_71 V_72 )
{
T_3 V_7 = F_6 ( V_58 ) ;
F_50 ( V_64 == V_66 ) ;
if ( V_72 == V_73 )
F_64 ( V_52 , V_58 , V_22 , V_64 ) ;
if ( F_12 ( V_58 ) )
F_65 ( V_52 , V_7 , V_22 , V_64 , V_72 ) ;
if ( V_72 == V_74 )
F_66 ( V_52 , V_58 , V_22 , V_64 ) ;
if ( V_64 != V_70 )
return;
F_60 ( F_61 ( V_7 ) , V_22 ) ;
}
void
F_67 ( struct V_1 * V_52 , T_2 V_58 ,
T_4 V_22 , enum V_63 V_64 )
{
F_63 ( V_52 , V_58 , V_22 , V_64 , V_73 ) ;
}
void
F_68 ( struct V_1 * V_52 , T_2 V_58 ,
T_4 V_22 , enum V_63 V_64 )
{
F_63 ( V_52 , V_58 , V_22 , V_64 , V_74 ) ;
}
int
F_69 ( struct V_1 * V_52 , struct V_75 * V_76 ,
...
if ( V_65 == V_68 ) {
F_72 ( V_52 , L_12 ) ;
F_73 ( V_52 , V_76 , V_18 , V_64 ,
V_55 ) ;
F_74 ( V_76 ) = 0 ;
return 0 ;
}
F_53 ( V_52 , F_56 ( V_65 >> V_10 ) ,
V_58 ,
V_65 & ~ V_11 ,
V_78 -> V_16 ,
V_64 ,
...
F_50 ( V_64 == V_66 ) ;
F_70 (sgl, sg, nelems, i)
F_58 ( V_52 , V_78 -> V_79 , F_74 ( V_78 ) , V_64 , V_55 ) ;
}
static void
F_75 ( struct V_1 * V_52 , struct V_75 * V_76 ,
int V_77 , enum V_63 V_64 ,
enum V_71 V_72 )
{
struct V_75 * V_78 ;
...
void
F_76 ( struct V_1 * V_52 , struct V_75 * V_78 ,
int V_77 , enum V_63 V_64 )
{
F_75 ( V_52 , V_78 , V_77 , V_64 , V_73 ) ;
}
void
F_77 ( struct V_1 * V_52 , struct V_75 * V_78 ,
int V_77 , enum V_63 V_64 )
{
F_75 ( V_52 , V_78 , V_77 , V_64 , V_74 ) ;
}
int
F_78 ( struct V_1 * V_52 , T_2 V_23 )
{
return ! V_23 ;
}
int
F_79 ( struct V_1 * V_52 , T_6 V_80 )
{
return F_8 ( V_25 - 1 ) <= V_80 ;
}
int
