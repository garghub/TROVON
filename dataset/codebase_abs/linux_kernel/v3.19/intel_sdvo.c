...
static void F_135 ( struct V_344 * V_3 )
{
...
V_356 = & ( V_12 -> V_358 [ 1 ] ) ;
if ( V_356 -> V_359 )
V_281 -> V_56 = 1 << ( ( V_356 -> V_360 & 0xf0 ) >> 4 ) ;
else
F_140 ( V_281 ) ;
}
static void
...
V_356 = & V_12 -> V_358 [ 1 ] ;
if ( V_356 -> V_359 && F_143 ( V_356 -> V_362 ) )
V_361 = V_356 -> V_362 ;
else
V_361 = V_363 ;
V_281 -> V_31 = F_105 ( V_12 , V_361 ) ;
F_144 ( V_281 -> V_31 , true ) ;
}
static void
F_145 ( struct V_1 * V_281 )
{
F_144 ( V_281 -> V_31 , false ) ;
}
static bool
F_146 ( struct V_1 * V_1 , int V_364 )
{
return F_50 ( V_1 ) ;
}
static T_2
F_147 ( struct V_9 * V_10 , struct V_1 * V_281 )
{
struct V_11 * V_12 = V_10 -> V_13 ;
struct V_355 * V_365 , * V_366 ;
if ( V_281 -> V_357 ) {
V_365 = & V_12 -> V_358 [ 0 ] ;
V_366 = & V_12 -> V_358 [ 1 ] ;
} else {
...
static void
F_148 ( struct V_234 * V_234 )
{
struct V_5 * V_5 ;
struct V_1 * V_367 ;
V_5 = & V_234 -> V_4 ;
V_367 = F_3 ( & V_234 -> V_4 ) ;
F_149 ( & V_5 -> V_368 -> V_369 ,
V_367 -> V_282 . V_10 . V_369 . V_37 ) ;
F_150 ( V_234 ) ;
}
static int
...
if ( V_30 < 0 )
goto V_380;
V_30 = F_156 ( & V_5 -> V_368 -> V_369 ,
& V_3 -> V_282 . V_10 . V_369 ,
V_3 -> V_282 . V_10 . V_369 . V_37 ) ;
if ( V_30 < 0 )
goto V_381;
return 0 ;
V_381:
...
F_159 ( & V_6 -> V_4 . V_4 ) ;
if ( F_71 ( V_10 ) -> V_221 >= 4 && F_160 ( V_10 ) ) {
F_161 ( & V_6 -> V_4 . V_4 ) ;
V_1 -> V_205 = true ;
}
}
static bool
F_162 ( struct V_1 * V_1 , int V_364 )
{
struct V_344 * V_3 = & V_1 -> V_4 . V_4 ;
struct V_5 * V_6 ;
...
static bool
F_166 ( struct V_1 * V_1 , int V_364 )
{
struct V_344 * V_3 = & V_1 -> V_4 . V_4 ;
struct V_5 * V_6 ;
struct V_234 * V_234 ;
...
static bool
F_167 ( struct V_1 * V_1 , int V_364 )
{
struct V_344 * V_3 = & V_1 -> V_4 . V_4 ;
struct V_5 * V_6 ;
struct V_234 * V_234 ;
...
V_1 -> V_347 = 0 ;
memcpy ( V_403 , & V_1 -> V_262 . V_275 , 2 ) ;
F_12 ( L_44 ,
F_18 ( V_1 ) ,
V_403 [ 0 ] , V_403 [ 1 ] ) ;
return false ;
...
static bool F_164 ( struct V_1 * V_1 ,
struct V_7 * V_7 ,
int type )
{
struct V_9 * V_10 = V_1 -> V_4 . V_4 . V_10 ;
...
return false ;
V_7 -> V_406 = 0 ;
for ( V_16 = 0 ; V_16 < V_328 ; V_16 ++ )
if ( V_178 & ( 1 << V_16 ) )
V_7 -> V_329 [ V_7 -> V_406 ++ ] = V_16 ;
V_7 -> V_327 =
F_171 ( V_10 , V_407 ,
L_45 , V_7 -> V_406 ) ;
if ( ! V_7 -> V_327 )
...
F_172 (
V_7 -> V_327 , V_16 ,
V_16 , V_408 [ V_7 -> V_329 [ V_16 ] ] ) ;
V_1 -> V_179 = V_7 -> V_329 [ 0 ] ;
F_173 ( & V_7 -> V_4 . V_4 . V_4 ,
V_7 -> V_327 , 0 ) ;
return true ;
}
static bool
...
return false ;
V_7 -> V_334 = V_411 [ 0 ] ;
V_7 -> V_332 = V_411 [ 0 ] - V_44 ;
V_7 -> V_333 = V_7 -> V_332 ;
V_7 -> V_330 =
F_175 ( V_10 , 0 , L_46 , 0 , V_411 [ 0 ] ) ;
if ( ! V_7 -> V_330 )
return false ;
F_173 ( & V_6 -> V_4 ,
V_7 -> V_330 ,
...
if ( F_124 ( V_7 ) )
return F_174 ( V_1 , V_7 , V_410 . V_305 ) ;
else if ( F_125 ( V_7 ) )
return F_177 ( V_1 , V_7 , V_410 . V_305 ) ;
else
return true ;
}
static int F_178 ( struct V_447 * V_448 ,
struct V_23 * V_24 ,
int V_449 )
{
...
static T_1 F_179 ( struct V_447 * V_448 )
{
struct V_1 * V_281 = V_448 -> V_450 ;
return V_281 -> V_31 -> V_451 -> V_453 ( V_281 -> V_31 ) ;
}
static bool
F_180 ( struct V_1 * V_281 ,
struct V_9 * V_10 )
{
...
return F_181 ( & V_281 -> V_282 ) == 0 ;
}
bool F_182 ( struct V_9 * V_10 , T_7 V_17 , bool V_357 )
{
struct V_11 * V_12 = V_10 -> V_13 ;
struct V_2 * V_2 ;
struct V_1 * V_1 ;
