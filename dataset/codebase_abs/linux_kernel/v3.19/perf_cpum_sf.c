...
static void F_104 ( struct V_176 V_176 ,
...
static int F_108 ( char * V_196 , const struct V_197 * V_198 )
{
if ( ! F_109 () )
return - V_62 ;
return sprintf ( V_196 , L_38 , V_29 , V_30 ) ;
}
static int F_110 ( const char * V_199 , const struct V_197 * V_198 )
{
int V_19 ;
...
V_26 = V_30 ;
if ( strchr ( V_199 , ',' ) )
V_19 = ( sscanf ( V_199 , L_38 , & V_25 , & V_26 ) == 2 ) ? 0 : - V_22 ;
else
V_19 = F_111 ( V_199 , 10 , & V_26 ) ;
...
static void T_3 F_114 ( unsigned int V_200 )
{
F_41 ( L_41
L_42 , V_200 ) ;
}
...
if ( V_28 . V_33 != sizeof( struct V_202 ) ) {
F_114 ( V_203 ) ;
return - V_22 ;
}
if ( V_28 . V_86 )
F_15 ( V_29 , V_30 ) ;
V_11 = F_116 ( V_204 , 2 , 1 , 80 ) ;
if ( ! V_11 )
F_41 ( L_43 ) ;
F_117 ( V_11 , & V_205 ) ;
V_55 = F_118 ( V_206 ,
