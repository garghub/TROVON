...
F_84 () ;
V_123 = F_74 ( V_120 , L_36 , & V_124 ) ;
F_7 ( L_37 ,
V_123 ? ( V_124 / 4 ) : 0 ) ;
V_126 = V_124 / 4 ;
V_127 = F_89 ( V_126 * sizeof( unsigned int ) , V_128 ) ;
for ( V_23 = 0 ; V_123 && V_23 < ( V_124 / 4 ) ; V_23 ++ , V_123 ++ ) {
unsigned int V_129 = F_90 ( V_123 ) ;
unsigned int V_100 = F_91 ( NULL , V_129 ) ;
if ( V_100 == V_130 ) {
F_18 ( L_38 , V_129 ) ;
continue;
}
V_52 = F_92 ( V_100 , F_64 , 0 , L_23 , NULL ) ;
if ( V_52 )
F_18 ( L_39
L_40 , V_52 , V_100 , V_129 ) ;
V_127 [ V_23 ] = V_100 ;
}
V_52 = F_67 () ;
if ( V_52 == 0 ) {
...
struct V_131 * F_103 ( void * V_132 ,
unsigned long V_133 )
{
struct V_131 * V_134 , * V_135 = NULL ;
unsigned long V_23 = 0 ;
V_134 = F_89 ( V_136 , V_128 ) ;
if ( ! V_134 )
goto V_137;
V_135 = V_134 ;
while ( V_133 > 0 ) {
T_3 V_6 = F_104 ( V_132 ) << V_138 ;
T_3 V_139 = F_105 ( V_133 , V_136 ) ;
V_134 -> V_15 [ V_23 ] . V_6 = F_44 ( V_6 ) ;
V_134 -> V_15 [ V_23 ] . V_139 = F_44 ( V_139 ) ;
V_23 ++ ;
if ( V_23 >= V_140 ) {
struct V_131 * V_141 ;
V_141 = F_89 ( V_136 , V_128 ) ;
if ( ! V_141 )
goto V_137;
V_134 -> V_139 = F_44 (
V_23 * sizeof( struct V_142 ) + 16 ) ;
V_23 = 0 ;
V_134 -> V_141 = F_44 ( F_37 ( V_141 ) ) ;
V_134 = V_141 ;
}
V_132 += V_139 ;
V_133 -= V_139 ;
}
V_134 -> V_139 = F_44 ( V_23 * sizeof( struct V_142 ) + 16 ) ;
return V_135 ;
V_137:
F_42 ( L_41 , V_41 ) ;
F_106 ( V_135 ) ;
...
void F_106 ( struct V_131 * V_134 )
{
while ( V_134 ) {
T_3 V_141 = F_31 ( V_134 -> V_141 ) ;
F_107 ( V_134 ) ;
if ( V_141 )
V_134 = F_11 ( V_141 ) ;
else
