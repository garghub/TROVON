...
static struct V_2 * F_21 ( struct V_26 * V_27 ,
struct V_23 * V_24 ,
struct V_28 * V_35 )
{
...
V_58 -> V_13 = V_66 ;
V_58 -> V_67 = & V_68 ;
V_30 = F_35 ( & V_58 -> V_69 , 256 , 0 ) ;
if ( V_30 < 0 ) {
F_20 ( V_27 -> V_34 , L_4 , V_30 ) ;
goto V_70;
}
F_36 ( V_58 , V_3 -> V_46 [ 0 ] , V_3 -> V_71 ) ;
F_37 ( V_58 , V_7 , V_3 -> V_39 , V_3 -> V_40 ) ;
V_56 = V_58 -> V_72 . V_73 * V_55 +
V_58 -> V_72 . V_74 * V_3 -> V_46 [ 0 ] ;
if ( V_19 -> V_20 ) {
V_19 -> V_21 = F_38 ( V_19 -> V_20 , V_19 -> V_75 , V_76 ,
F_39 ( V_77 ) ) ;
if ( ! V_19 -> V_21 ) {
F_20 ( V_27 -> V_34 , L_5 ) ;
V_30 = - V_32 ;
...
V_58 -> V_82 = ( void V_83 * ) V_19 -> V_21 + V_56 ;
V_58 -> V_84 = V_41 ;
V_58 -> V_85 . V_86 = ( unsigned long ) ( V_19 -> V_81 + V_56 ) ;
V_58 -> V_85 . V_87 = V_41 ;
return 0 ;
V_70:
F_40 ( V_3 ) ;
...
static struct V_5 * F_42 ( struct V_26 * V_27 )
{
struct V_5 * V_51 ;
...
F_43 ( V_27 , & V_51 -> V_4 , & V_88 ) ;
return V_51 ;
}
static void F_44 ( struct V_5 * V_51 )
{
F_12 ( V_51 ) ;
}
static int F_45 ( struct V_5 * V_51 ,
unsigned int V_89 ,
unsigned int V_90 ,
unsigned int V_91 )
{
...
int V_30 ;
V_30 = F_46 ( V_27 , & V_51 -> V_4 , V_90 , V_91 ) ;
if ( V_30 < 0 ) {
F_20 ( V_27 -> V_34 , L_7 ,
V_30 ) ;
return V_30 ;
...
V_30 = F_47 ( & V_51 -> V_4 ) ;
if ( V_30 < 0 ) {
F_20 ( V_27 -> V_34 , L_8 , V_30 ) ;
goto V_92;
}
V_30 = F_48 ( & V_51 -> V_4 , V_89 ) ;
if ( V_30 < 0 ) {
F_20 ( V_27 -> V_34 , L_9 ,
V_30 ) ;
goto V_92;
...
static void F_50 ( struct V_5 * V_51 )
{
struct V_57 * V_58 = V_51 -> V_4 . V_51 ;
if ( V_58 ) {
int V_30 ;
V_30 = F_51 ( V_58 ) ;
if ( V_30 < 0 )
...
struct V_52 * V_53 = V_27 -> V_54 ;
int V_30 ;
V_30 = F_45 ( V_53 -> V_51 , 32 , V_27 -> V_78 . V_90 ,
V_27 -> V_78 . V_100 ) ;
if ( V_30 < 0 )
return V_30 ;
#endif
