...
static void F_122 ( enum V_528 V_529 , char * V_530 ,
struct V_1 * V_2 , ... )
{
...
static bool T_2 F_123 ( char * * V_538 , char * V_539 )
{
char * V_540 = * V_538 ;
while ( * V_539 != '\0' ) {
char V_541 = * V_540 ++ ;
...
static int T_2 F_124 ( char * V_543 )
{
while ( true ) {
struct V_357 * V_266 =
& V_357 [ V_356 ++ ] ;
...
while ( * V_543 != '\0' && * V_543 != ';' ) {
if ( F_123 ( & V_543 , L_198 ) ) {
unsigned long V_89 = F_125 ( V_543 ,
& V_543 , 0 ) ;
V_99 . V_101 = true ;
switch ( V_89 ) {
case 0x330 :
...
} else if ( F_123 ( & V_543 , L_201 ) )
V_99 . V_100 = true ;
else if ( F_123 ( & V_543 , L_202 ) )
V_99 . V_164 = true ;
else if ( F_123 ( & V_543 , L_203 ) )
V_99 . V_350 = true ;
else if ( F_123 ( & V_543 , L_204 ) )
V_99 . V_544 = true ;
else if ( F_123 ( & V_543 , L_205 ) )
V_99 . V_165 = true ;
else if ( F_123 ( & V_543 , L_206 ) )
V_99 . V_166 = true ;
else if ( F_123 ( & V_543 , L_207 ) ||
F_123 ( & V_543 , L_208 ) ) {
for ( V_201 = 0 ; V_201 < V_264 ; V_201 ++ ) {
unsigned short V_265 = F_125 ( V_543 , & V_543 , 0 ) ;
if ( V_265 > V_484 ) {
...
V_543 ++ ;
} else if ( F_123 ( & V_543 , L_212 ) || F_123 ( & V_543 , L_213 ) ) {
unsigned short V_265 = F_125 ( V_543 , & V_543 , 0 ) ;
if ( V_265 == 0 ||
V_265 > V_484 ) {
F_8 ( L_199 L_209 , NULL , V_265 ) ;
...
for ( V_201 = 0 ; V_201 < V_264 ; V_201 ++ )
V_266 -> V_265 [ V_201 ] = V_265 ;
} else if ( F_123 ( & V_543 , L_214 ) ||
F_123 ( & V_543 , L_215 ) ) {
if ( F_123 ( & V_543 , L_216 ) ) {
V_266 -> V_229 = 0x0000 ;
V_266 -> V_272 = 0x0000 ;
} else if ( F_123 ( & V_543 , L_217 ) ) {
V_266 -> V_229 = 0xFFFF ;
V_266 -> V_272 = 0xFFFF ;
} else if ( F_123 ( & V_543 , L_218 ) ) {
V_266 -> V_229 = 0x0000 ;
V_266 -> V_272 = 0xFFFF ;
} else {
...
L_222 ) )
V_266 -> V_325 = true ;
else if ( F_123 ( & V_543 , L_223 ) )
V_78 . V_143 = true ;
else if ( F_123 ( & V_543 , L_224 ) )
V_78 . V_185 = true ;
else if ( F_123 ( & V_543 , L_225 ) )
V_78 . V_79 = true ;
else if ( F_123 ( & V_543 , L_226 ) )
V_78 . V_419 = true ;
else if ( F_123 ( & V_543 , L_227 ) ) {
V_78 . V_143 = true ;
V_78 . V_185 = true ;
V_78 . V_79 = true ;
V_78 . V_419 = true ;
...
{
int V_546 [ 3 ] ;
( void ) F_126 ( V_538 , F_127 ( V_546 ) , V_546 ) ;
if ( V_546 [ 0 ] != 0 ) {
