...
static int F_12 ( struct V_68 * V_69 ,
const struct V_70 * V_71 )
{
struct V_20 * V_20 ;
int V_72 ;
if ( ! F_13 ( V_69 -> V_73 , V_74 ) )
return - V_46 ;
V_20 = F_14 ( & V_69 -> V_2 , sizeof( struct V_20 ) , V_75 ) ;
if ( ! V_20 )
return - V_76 ;
V_20 -> V_31 = F_15 ( V_69 , & V_77 ) ;
if ( F_16 ( V_20 -> V_31 ) ) {
V_72 = F_17 ( V_20 -> V_31 ) ;
...
static int F_20 ( struct V_68 * V_80 )
{
F_21 ( & V_80 -> V_2 ) ;
return 0 ;
}
