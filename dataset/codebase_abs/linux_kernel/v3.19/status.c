...
V_90 = V_2 -> V_181 -> V_182 [ V_8 -> V_183 ] ;
...
V_175 = F_73 ( V_2 , V_8 , & V_91 ) ;
F_48 () ;
V_90 = V_6 -> V_2 . V_181 -> V_182 [ V_8 -> V_183 ] ;
V_154 = V_22 -> V_33 ;
F_78 (local, hdr->addr1, sta, tmp) {
if ( ! F_79 ( V_22 -> V_198 , V_20 -> V_28 -> V_27 . V_48 ) )
continue;
...
F_13 ( V_22 ) ,
V_20 , true , V_136 ) ;
if ( ( V_6 -> V_2 . V_12 & V_201 ) &&
( F_51 ( V_22 -> V_33 ) ) &&
( V_175 != - 1 ) )
V_20 -> V_202 = V_8 -> V_84 . V_85 [ V_175 ] ;
if ( ( V_8 -> V_12 & V_203 ) &&
( F_12 ( V_154 ) ) ) {
T_2 V_36 , V_81 ;
T_1 * V_59 ;
...
V_25 = F_84 ( V_197 -> V_25 ) ;
if ( ! ( V_25 & V_206 ) ) {
T_2 V_81 = F_84 ( V_197 -> V_207 ) ;
V_36 = ( V_25 &
V_208 ) >>
V_209 ;
F_29 ( V_20 , V_36 , V_81 ) ;
...
if ( F_54 ( V_154 ) && F_92 ( V_154 ) &&
( V_6 -> V_2 . V_12 & V_57 ) &&
! ( V_8 -> V_12 & V_211 ) &&
V_6 -> V_216 && ! ( V_6 -> V_217 ) ) {
if ( V_8 -> V_12 & V_105 ) {
V_6 -> V_216 -> V_61 . V_132 . V_12 |=
V_218 ;
} else
F_18 ( & V_6 -> V_219 , V_26 +
F_93 ( 10 ) ) ;
...
F_47 ( V_6 , V_4 , false ) ;
F_94 ( V_4 ) ;
V_195 = ! ! ( V_8 -> V_12 & V_211 ) ||
! ( F_51 ( V_154 ) ) ;
if ( ! V_6 -> V_220 && ( ! V_195 || ! V_6 -> V_221 ) ) {
F_95 ( V_4 ) ;
return;
}
V_92 = F_30 ( V_8 ) ;
...
V_4 -> V_222 = V_223 ;
V_4 -> V_10 = V_224 ;
V_4 -> V_225 = F_100 ( V_226 ) ;
memset ( V_4 -> V_227 , 0 , sizeof( V_4 -> V_227 ) ) ;
F_48 () ;
F_49 (sdata, &local->interfaces, list) {
if ( V_28 -> V_27 . type == V_228 ) {
if ( ! F_27 ( V_28 ) )
continue;
if ( ( V_28 -> V_61 . V_229 & V_230 ) &&
! V_195 )
continue;
if ( V_194 ) {
V_192 = F_101 ( V_4 , V_144 ) ;
if ( V_192 ) {
V_192 -> V_134 = V_194 ;
F_102 ( V_192 ) ;
}
...
void F_103 ( struct V_179 * V_180 , T_3 V_231 )
{
