...
if ( V_126 )
return - V_42 ;
V_192 = F_72 ( V_190 -> V_193 ) & ~ V_194 ;
F_72 ( V_190 -> V_193 ) =
V_192 | F_73 ( V_195 ) ;
return F_74 ( V_190 , V_18 -> V_29 ,
V_18 -> V_32 ) ;
}
...
static int F_76 ( struct V_57 * V_58 , struct V_196 * V_197 )
{
return - V_42 ;
}
...
while ( V_205 != & V_180 ) {
F_85 ( V_205 ) ;
V_203 = F_86 ( V_205 , struct V_17 , V_97 ) ;
if ( ! F_49 ( & V_203 -> V_58 . V_61 , V_203 ) ) {
F_60 ( V_203 ) ;
F_87 ( V_205 , & V_179 ) ;
} else {
F_17 ( & V_35 ) ;
V_206 = V_203 -> V_58 . V_61 . V_210 ;
V_203 -> V_58 . V_61 . V_62 = 16 ;
F_37 ( & V_203 -> V_58 . V_61 ) ;
if ( F_43 ( & V_203 -> V_58 . V_61 ,
& V_203 -> V_58 ,
V_102 , NULL , 0 , NULL , 16 ) ) {
V_203 -> V_58 . V_61 . V_210 |=
V_211 | V_212 ;
F_88 ( & V_203 -> V_58 , & V_203 -> V_58 . V_61 ) ;
} else {
F_7 (KERN_ERR MODULE_NAME
L_38 ) ;
}
V_203 -> V_58 . V_61 . V_210 = V_206 ;
F_15 ( & V_35 ) ;
}
F_66 ( V_203 ) ;
V_205 = V_180 . V_209 ;
...
void F_89 ( struct V_201 * V_202 )
{
struct V_17 * V_203 , * V_209 ;
F_15 ( & V_35 ) ;
if ( V_118 != V_202 ) {
F_17 ( & V_35 ) ;
return;
