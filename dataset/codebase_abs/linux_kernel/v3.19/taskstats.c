...
V_39 = F_61 ( V_66 ) ;
memset ( V_39 , 0 , sizeof( * V_39 ) ) ;
V_17 = F_66 ( V_39 , V_81 . V_84 -> V_88 . V_89 ) ;
if ( V_17 < 0 ) {
F_6 ( V_78 ) ;
goto V_76;
}
...
if ( ! F_69 ( & V_55 , V_9 ) )
return - V_10 ;
V_17 = F_49 ( V_2 -> V_82 [ V_90 ] , V_55 ) ;
if ( V_17 < 0 )
goto V_49;
V_17 = F_42 ( V_2 -> V_91 , V_55 , REGISTER ) ;
V_49:
F_70 ( V_55 ) ;
return V_17 ;
}
...
if ( ! F_69 ( & V_55 , V_9 ) )
return - V_10 ;
V_17 = F_49 ( V_2 -> V_82 [ V_92 ] , V_55 ) ;
if ( V_17 < 0 )
goto V_49;
V_17 = F_42 ( V_2 -> V_91 , V_55 , V_93 ) ;
V_49:
F_70 ( V_55 ) ;
return V_17 ;
}
