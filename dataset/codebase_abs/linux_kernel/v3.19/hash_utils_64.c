...
V_209 = F_122 ( V_211 , V_207 ) ;
if ( ! V_209 )
continue;
V_195 = F_123 ( V_211 , V_207 ) ;
...
void F_124 ( unsigned long V_215 , int V_197 )
{
if ( V_31 . F_124 )
V_31 . F_124 ( V_215 , V_197 ) ;
else {
int V_207 ;
struct V_216 * V_217 =
F_125 ( & V_216 ) ;
for ( V_207 = 0 ; V_207 < V_215 ; V_207 ++ )
F_112 ( V_217 -> V_25 [ V_207 ] , V_217 -> V_132 [ V_207 ] ,
V_217 -> V_14 , V_217 -> V_15 , V_197 ) ;
}
}
void F_126 ( struct V_218 * V_203 , unsigned long V_219 , int V_78 )
{
enum V_168 V_169 = F_87 () ;
if ( F_127 ( V_203 ) ) {
#ifdef F_128
if ( V_78 == - 2 )
F_129 ( V_220 , V_203 , V_221 , V_219 ) ;
else
#endif
F_129 ( V_222 , V_203 , V_223 , V_219 ) ;
} else
F_130 ( V_203 , V_219 , V_222 ) ;
F_105 ( V_169 ) ;
}
...
static void F_133 ( unsigned long V_16 , unsigned long V_229 )
{
unsigned long V_22 ;
unsigned long V_24 = F_4 ( V_16 , V_98 ) ;
unsigned long V_25 = F_5 ( V_16 , V_24 , V_98 ) ;
unsigned long V_230 = F_1 ( V_97 ) ;
long V_20 ;
V_22 = F_9 ( V_25 , V_34 , V_98 ) ;
if ( ! V_24 )
return;
V_20 = F_131 ( V_22 , V_25 , F_44 ( V_16 ) , V_230 ,
V_33 ,
V_82 , V_98 ) ;
F_10 ( V_20 < 0 ) ;
F_134 ( & V_231 ) ;
...
static void F_136 ( unsigned long V_16 , unsigned long V_229 )
{
...
void F_137 ( struct V_134 * V_134 , int V_232 , int V_233 )
{
...
void F_139 ( T_9 V_234 ,
T_9 V_235 )
{
F_10 ( V_234 != 0 ) ;
V_125 = F_140 ( T_5 , V_235 , 0x40000000 ) ;
F_60 ( V_125 ) ;
}
