...
int V_217 ;
T_3 V_218 ;
V_218 = F_116 ( 0x80000000 | ( ( V_216 -> V_59 ) - 4 ) ) ;
memcpy ( V_216 -> V_60 [ 0 ] . V_83 , & V_218 , 4 ) ;
...
{
struct V_96 * V_219 = & V_10 -> V_147 . V_60 [ 0 ] ;
F_118 ( V_219 , 0 ) ;
}
...
int V_130 = 0 ;
F_8 ( L_50 , V_2 ) ;
V_15 = F_133 ( sizeof( * V_15 ) , V_229 ) ;
if ( ! V_15 )
return F_134 ( - V_169 ) ;
V_227 = V_2 -> V_3 ;
if ( V_228 )
V_130 = F_135 ( V_119 , F_75 ( V_2 -> V_3 ) , V_227 -> V_4 ,
V_227 -> V_88 ,
F_136 ( F_22 ( V_227 ) -> V_230 ) ) ;
if ( V_130 < 0 ) {
F_137 ( V_15 ) ;
return F_134 ( V_130 ) ;
}
...
bool F_138 ( struct V_149 * V_149 , int V_235 )
{
int V_130 ;
struct V_1 * V_2 = F_139 ( V_235 , & V_130 ) ;
bool V_107 = false ;
if ( ! V_2 )
goto V_62;
...
int F_141 ( struct V_118 * V_119 , const int V_235 , char * V_236 ,
const T_1 V_59 )
{
int V_130 = 0 ;
struct V_1 * V_237 = F_139 ( V_235 , & V_130 ) ;
...
return V_130 ;
V_130 = - V_238 ;
if ( ( V_237 -> V_3 -> V_4 != V_89 ) && ( V_237 -> V_3 -> V_4 != V_93 ) )
goto V_62;
V_130 = - V_239 ;
if ( V_237 -> V_3 -> V_88 != V_212 &&
V_237 -> V_3 -> V_88 != V_73 )
goto V_62;
V_130 = - V_240 ;
...
F_18 (char buf[RPC_MAX_ADDRBUFLEN]) ;
F_8 ( L_52 ,
V_119 -> V_251 -> V_252 , V_246 ,
F_85 ( sin , V_85 , sizeof( V_85 ) ) ) ;
if ( V_246 != V_73 && V_246 != V_212 ) {
F_78 ( V_170 L_53
L_54 ) ;
return F_134 ( - V_253 ) ;
}
type = ( V_246 == V_73 ) ? V_234 : V_254 ;
switch ( sin -> V_255 ) {
case V_8 :
V_249 = V_93 ;
break;
...
error = F_146 ( V_149 , V_249 , type , V_246 , & V_2 , 1 ) ;
if ( error < 0 )
return F_134 ( error ) ;
F_1 ( V_2 ) ;
V_250 = 1 ;
