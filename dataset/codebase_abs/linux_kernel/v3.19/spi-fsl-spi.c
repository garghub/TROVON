...
static void F_52 ( struct V_10 * V_11 , bool V_109 )
{
struct V_12 * V_12 = F_4 ( V_11 -> V_14 ) ;
...
{
struct V_26 * V_27 = F_55 ( V_2 ) ;
struct V_72 * V_14 = F_56 ( V_2 ) ;
...
V_12 -> V_112 = 0 ;
if ( F_58 ( V_114 ) ) {
V_12 -> V_112 = F_59 ( V_114 ) ;
F_7 ( & V_19 -> V_110 , 0xffffffff ) ;
}
V_14 -> V_117 = V_12 -> V_112 ;
V_27 -> V_33 = F_52 ;
}
static struct V_72 * F_60 ( struct V_1 * V_2 ,
...
T_3 V_120 ;
int V_66 = 0 ;
V_14 = F_61 ( V_2 , sizeof( struct V_12 ) ) ;
if ( V_14 == NULL ) {
V_66 = - V_86 ;
goto V_121;
}
F_62 ( V_2 , V_14 ) ;
F_63 ( V_2 , V_119 , V_104 ) ;
V_14 -> V_122 = F_33 ;
V_14 -> V_123 = F_41 ;
V_14 -> V_124 = F_26 ;
V_12 = F_4 ( V_14 ) ;
...
if ( V_66 )
goto V_126;
V_12 -> V_19 = F_65 ( V_119 -> V_127 , F_66 ( V_119 ) ) ;
if ( V_12 -> V_19 == NULL ) {
V_66 = - V_86 ;
goto V_128;
}
...
goto V_136;
F_71 ( V_2 , L_6 , V_19 ,
V_12 -> V_104 , F_72 ( V_12 -> V_21 ) ) ;
return V_14 ;
V_136:
V_131 ( V_12 -> V_104 , V_12 ) ;
V_131:
F_50 ( V_12 -> V_19 ) ;
V_128:
F_51 ( V_12 ) ;
...
static void F_75 ( struct V_10 * V_11 , bool V_109 )
{
struct V_1 * V_2 = V_11 -> V_2 . V_30 -> V_30 ;
struct V_26 * V_27 = F_55 ( V_2 ) ;
struct V_137 * V_138 = F_76 ( V_27 ) ;
T_7 V_16 = V_11 -> V_111 ;
int V_139 = V_138 -> V_140 [ V_16 ] ;
bool V_141 = V_138 -> V_142 [ V_16 ] ;
F_53 ( V_139 , V_109 ^ V_141 ) ;
}
static int F_77 ( struct V_1 * V_2 )
{
struct V_143 * V_144 = V_2 -> V_5 ;
struct V_26 * V_27 = F_55 ( V_2 ) ;
struct V_137 * V_138 = F_76 ( V_27 ) ;
int V_145 ;
int V_146 = 0 ;
...
V_138 -> V_140 = F_79 ( V_145 * sizeof( * V_138 -> V_140 ) , V_85 ) ;
if ( ! V_138 -> V_140 )
return - V_86 ;
memset ( V_138 -> V_140 , - 1 , V_145 * sizeof( * V_138 -> V_140 ) ) ;
V_138 -> V_142 = F_35 ( V_145 * sizeof( * V_138 -> V_142 ) ,
V_85 ) ;
if ( ! V_138 -> V_142 ) {
V_66 = - V_86 ;
goto V_148;
}
for (; V_146 < V_145 ; V_146 ++ ) {
int V_139 ;
enum V_149 V_21 ;
V_139 = F_80 ( V_144 , V_146 , & V_21 ) ;
if ( ! F_37 ( V_139 ) ) {
F_29 ( V_2 , L_7 , V_146 , V_139 ) ;
V_66 = V_139 ;
goto V_150;
}
V_66 = F_38 ( V_139 , F_19 ( V_2 ) ) ;
if ( V_66 ) {
F_29 ( V_2 , L_8 , V_146 , V_66 ) ;
goto V_150;
}
V_138 -> V_140 [ V_146 ] = V_139 ;
V_138 -> V_142 [ V_146 ] = V_21 & V_151 ;
V_66 = F_39 ( V_138 -> V_140 [ V_146 ] ,
V_138 -> V_142 [ V_146 ] ) ;
if ( V_66 ) {
F_29 ( V_2 , L_9
L_10 , V_146 , V_66 ) ;
...
V_150:
while ( V_146 >= 0 ) {
if ( F_37 ( V_138 -> V_140 [ V_146 ] ) )
F_40 ( V_138 -> V_140 [ V_146 ] ) ;
V_146 -- ;
}
F_42 ( V_138 -> V_142 ) ;
V_138 -> V_142 = NULL ;
...
if ( ! V_138 -> V_140 )
return 0 ;
for ( V_146 = 0 ; V_146 < V_27 -> V_147 ; V_146 ++ ) {
if ( F_37 ( V_138 -> V_140 [ V_146 ] ) )
F_40 ( V_138 -> V_140 [ V_146 ] ) ;
}
F_42 ( V_138 -> V_140 ) ;
...
struct V_143 * V_144 = V_153 -> V_2 . V_5 ;
struct V_72 * V_14 ;
struct V_118 V_119 ;
int V_104 , type ;
int V_66 = - V_86 ;
...
static int F_91 ( struct V_152 * V_154 )
{
struct V_118 * V_119 ;
int V_104 ;
struct V_72 * V_14 ;
if ( ! F_55 ( & V_154 -> V_2 ) )
return - V_47 ;
V_119 = F_92 ( V_154 , V_155 , 0 ) ;
if ( ! V_119 )
return - V_47 ;
V_104 = F_93 ( V_154 , 0 ) ;
if ( V_104 <= 0 )
return - V_47 ;
V_14 = F_60 ( & V_154 -> V_2 , V_119 , V_104 ) ;
return F_94 ( V_14 ) ;
}
static int F_95 ( struct V_152 * V_154 )
{
return F_90 ( & V_154 -> V_2 ) ;
}
