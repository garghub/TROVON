...
{
struct V_111 * V_6 = F_76 ( & V_110 -> V_54 ) ;
struct V_26 * V_27 = F_77 ( V_110 ) ;
struct V_1 * V_2 = F_34 ( V_27 ) ;
const char * V_112 = F_78 ( V_27 ) ;
struct V_113 * V_114 ;
int V_115 ;
int V_91 ;
int V_116 ;
if ( V_6 && F_69 ( V_6 -> V_117 ) ) {
memcpy ( V_27 -> V_30 , V_6 -> V_117 , V_28 ) ;
} else {
F_79 ( V_27 ) ;
}
V_114 = F_80 ( V_110 , V_118 , 0 ) ;
V_2 -> V_4 = F_81 ( & V_110 -> V_54 , V_114 ) ;
if ( F_82 ( V_2 -> V_4 ) )
return F_83 ( V_2 -> V_4 ) ;
V_115 = F_84 ( V_114 ) ;
F_85 ( & V_2 -> V_18 ) ;
V_2 -> V_33 = V_115 < V_119 ;
if ( V_2 -> V_33 ) {
V_2 -> V_120 = F_10 ;
V_2 -> V_121 = F_14 ;
V_2 -> V_122 = F_15 ;
...
F_26 ( V_2 ) ;
if ( F_45 ( V_2 , V_126 ) != V_127 )
return - V_128 ;
V_91 = F_86 ( V_110 , 0 ) ;
if ( V_91 < 0 )
return V_91 ;
V_116 = F_87 ( V_91 , F_58 ,
V_129 , V_112 , V_27 ) ;
if ( V_116 < 0 )
return V_116 ;
V_2 -> V_91 = V_91 ;
V_2 -> V_56 = V_6 ? V_6 -> V_56 : - V_130 ;
if ( F_35 ( V_2 -> V_56 ) ) {
char * V_131 = F_88 ( & V_110 -> V_54 , 16 , V_132 ) ;
if ( ! V_131 )
return - V_87 ;
snprintf ( V_131 , 16 , L_6 , V_112 ) ;
V_2 -> V_133 = F_89 ( V_2 -> V_56 ) ;
if ( F_90 ( V_2 -> V_133 , F_62 ,
V_134 | V_135 ,
V_131 , V_2 -> V_27 ) < 0 )
V_2 -> V_56 = - V_130 ;
}
F_91 ( V_27 , L_7 , ( V_136 ) V_114 -> V_137 , V_91 ) ;
return 0 ;
}
static int F_92 ( struct V_109 * V_110 )
{
struct V_1 * V_2 ;
struct V_26 * V_27 ;
int V_138 ;
V_27 = F_93 ( sizeof( * V_2 ) ) ;
if ( ! V_27 )
return - V_87 ;
F_94 ( V_27 , & V_110 -> V_54 ) ;
F_95 ( V_110 , V_27 ) ;
V_2 = F_34 ( V_27 ) ;
V_2 -> V_27 = V_27 ;
V_27 -> V_139 = & V_140 ;
...
F_101 ( V_2 -> V_91 , V_27 ) ;
if ( F_35 ( V_2 -> V_56 ) )
F_101 ( V_2 -> V_133 , V_27 ) ;
F_98 ( V_27 ) ;
F_99 ( V_27 ) ;
return 0 ;
}
static int F_102 ( struct V_149 * V_54 )
{
struct V_109 * V_110 = F_103 ( V_54 ) ;
struct V_26 * V_27 = F_77 ( V_110 ) ;
struct V_1 * V_2 = F_34 ( V_27 ) ;
if ( F_63 ( V_27 ) ) {
F_66 ( V_27 ) ;
...
static int F_105 ( struct V_149 * V_54 )
{
struct V_109 * V_110 = F_103 ( V_54 ) ;
struct V_26 * V_27 = F_77 ( V_110 ) ;
struct V_1 * V_2 = F_34 ( V_27 ) ;
