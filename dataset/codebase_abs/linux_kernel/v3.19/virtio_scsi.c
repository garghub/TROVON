...
T_1 V_65 ;
struct V_192 * V_193 ;
V_65 = F_123 ( V_3 , V_65 ) ? : 1 ;
V_191 = F_123 ( V_3 , V_194 ) + 1 ;
if ( V_65 == 1 )
V_193 = & V_195 ;
else
V_193 = & V_196 ;
...
if ( V_70 )
goto V_198;
V_10 -> V_174 . V_199 = & F_116 ;
V_70 = F_125 ( & V_10 -> V_174 ) ;
if ( V_70 ) {
F_48 ( L_12 ) ;
goto V_200;
}
V_160 = F_123 ( V_3 , V_160 ) ? : 1 ;
V_84 -> V_160 = F_15 ( T_1 , V_160 , V_84 -> V_201 ) ;
V_84 -> V_202 = F_123 ( V_3 , V_202 ) ? : 0xFFFF ;
V_84 -> V_203 = F_123 ( V_3 , V_203 ) + 1 + 0x4000 ;
V_84 -> V_204 = V_191 ;
V_84 -> V_205 = 0 ;
V_84 -> V_206 = V_136 ;
V_84 -> V_207 = V_65 ;
