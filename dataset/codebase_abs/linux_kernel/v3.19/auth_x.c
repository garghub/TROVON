...
V_78 -> V_85 = F_44 ( V_32 -> V_31 ) ;
V_78 -> V_40 . V_18 = 1 ;
V_78 -> V_40 . V_66 = F_7 ( V_32 -> V_66 ) ;
V_78 -> V_40 . V_86 = F_44 ( V_81 ) ;
if ( V_81 ) {
...
F_45 ( & V_75 -> V_88 , sizeof( V_75 -> V_88 ) ) ;
V_80 . V_18 = 1 ;
...
F_50 ( V_22 , V_23 , V_20 , V_63 ) ;
F_51 ( V_22 , V_23 , V_71 , V_20 , V_63 ) ;
} else {
F_50 ( V_22 , V_23 , 0 , V_63 ) ;
}
return 0 ;
V_63:
return - V_90 ;
...
if ( V_22 > V_23 )
return - V_90 ;
V_17 -> V_101 = F_53 ( V_109 ) ;
V_21 = F_41 ( V_2 , V_32 , & V_4 -> V_110 ) ;
if ( V_21 )
return V_21 ;
F_54 ( & V_22 , V_4 -> V_110 . V_71 -> V_69 . V_83 ,
...
static int F_55 ( struct V_1 * V_2 , int V_112 ,
void * V_71 , void * V_23 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
...
V_101 = F_56 ( V_17 -> V_101 ) ;
V_112 = F_57 ( V_17 -> V_112 ) ;
...
return - V_29 ;
if ( V_75 -> V_88 + 1 != F_14 ( V_132 . V_134 ) )
V_21 = - V_29 ;
else
V_21 = 0 ;
F_3 ( L_22 ,
V_75 -> V_88 , F_14 ( V_132 . V_134 ) , V_21 ) ;
return V_21 ;
}
...
static int F_67 ( struct V_119 * V_96 ,
struct V_135 * V_136 )
{
int V_21 ;
if ( ! V_96 -> V_120 )
return 0 ;
V_21 = F_66 ( (struct V_74 * ) V_96 -> V_120 ,
V_136 , & V_136 -> V_140 . V_137 ) ;
if ( V_21 < 0 )
return V_21 ;
V_136 -> V_140 . V_144 |= V_145 ;
return 0 ;
}
...
if ( V_21 < 0 )
return V_21 ;
if ( V_146 == V_136 -> V_140 . V_137 )
return 0 ;
if ( V_136 -> V_140 . V_144 & V_145 )
F_3 ( L_25
L_26 , V_136 , V_136 -> V_140 . V_137 , V_146 ) ;
else
F_3 ( L_27
L_28 , V_136 ) ;
return - V_147 ;
