...
if ( strlen ( V_45 -> V_13 ) ) {
F_84 ( V_124 , L_25 , V_45 -> V_13 ) ;
return F_85 ( V_124 ) ;
} else
return 0 ;
}
static int F_86 ( struct V_129 * V_129 , struct V_130 * V_130 )
{
int V_42 ;
struct V_126 * V_127 ;
V_42 = F_87 ( V_129 , V_130 , & V_131 ,
sizeof( struct V_126 ) ) ;
if ( ! V_42 ) {
V_127 = ( (struct V_123 * ) V_130 -> V_132 ) -> V_108 ;
V_127 -> V_3 = ( unsigned long ) F_88 ( V_129 ) ;
}
return V_42 ;
}
static void * F_89 ( struct V_123 * V_124 , void * V_128 , T_7 * V_133 ,
bool V_134 )
{
...
if ( F_89 ( V_124 , NULL , NULL , V_134 ) == NULL )
return NULL ;
return V_140 ;
}
static void F_91 ( struct V_123 * V_124 , void * V_128 )
{
struct V_139 * V_140 = V_124 -> V_108 ;
switch ( V_140 -> V_141 ) {
case V_136 :
...
static void * F_92 ( struct V_123 * V_124 , T_7 * V_125 )
{
return F_90 ( V_124 , V_125 , false ) ;
}
static void * F_93 ( struct V_123 * V_124 , void * V_128 , T_7 * V_133 )
{
return F_89 ( V_124 , V_128 , V_133 , false ) ;
}
static int F_94 ( struct V_123 * V_124 , void * V_128 )
{
...
static int F_95 ( struct V_129 * V_129 , struct V_130 * V_130 )
{
struct V_139 * V_140 ;
V_140 = F_96 ( V_130 , & V_147 , sizeof( * V_140 ) ) ;
if ( ! V_140 )
return - V_59 ;
V_140 -> V_20 = ( unsigned long ) F_88 ( V_129 ) ;
return 0 ;
}
static void * F_97 ( struct V_123 * V_124 , T_7 * V_125 )
{
return F_90 ( V_124 , V_125 , true ) ;
}
static void * F_98 ( struct V_123 * V_124 , void * V_128 , T_7 * V_133 )
{
return F_89 ( V_124 , V_128 , V_133 , true ) ;
}
...
{
struct V_139 * V_140 ;
V_140 = F_96 ( V_130 , & V_148 , sizeof( * V_140 ) ) ;
if ( ! V_140 )
return - V_59 ;
V_140 -> V_20 = ( unsigned long ) F_88 ( V_129 ) ;
return 0 ;
...
struct V_149 * V_154 ;
int V_42 ;
V_154 = F_103 ( sizeof( * V_154 ) * V_152 , V_95 ) ;
if ( V_154 == NULL )
return F_16 ( - V_59 ) ;
...
void F_105 ( const struct V_101 * V_45 , struct V_149 * V_154 )
{
F_106 ( V_154 , F_102 ( V_45 -> V_151 ) ) ;
F_56 ( V_154 ) ;
}
int F_107 ( struct V_102 * V_102 , T_1 V_3 )
{
#ifdef F_108
char V_27 [ V_159 ] ;
struct V_160 * V_161 ;
...
return - V_44 ;
#ifdef F_108
F_109 ( V_27 , V_21 [ V_3 ] , sizeof( V_27 ) ) ;
F_110 ( V_27 , V_162 , sizeof( V_27 ) ) ;
V_161 = F_111 ( V_27 , 0440 , V_102 -> V_163 , & V_164 ,
( void * ) ( unsigned long ) V_3 ) ;
if ( ! V_161 )
goto V_119;
F_109 ( V_27 , V_21 [ V_3 ] , sizeof( V_27 ) ) ;
F_110 ( V_27 , V_165 , sizeof( V_27 ) ) ;
V_161 = F_111 ( V_27 , 0440 , V_102 -> V_163 , & V_166 ,
( void * ) ( unsigned long ) V_3 ) ;
if ( ! V_161 )
goto V_167;
F_109 ( V_27 , V_21 [ V_3 ] , sizeof( V_27 ) ) ;
F_110 ( V_27 , V_168 , sizeof( V_27 ) ) ;
V_161 = F_111 ( V_27 , 0440 , V_102 -> V_163 , & V_169 ,
( void * ) ( unsigned long ) V_3 ) ;
if ( ! V_161 )
goto V_170;
#endif
...
static int T_9 F_114 ( struct V_102 * V_102 )
{
int V_9 ;
for ( V_9 = 0 ; V_9 < V_171 ; V_9 ++ )
F_115 ( & V_102 -> V_5 . V_122 [ V_9 ] ) ;
return 0 ;
}
...
int V_172 ;
F_49 (i) {
F_117 ( & F_118 ( V_173 , V_9 ) ) ;
}
V_5 = F_103 ( sizeof( struct V_54 ) * V_171 , V_95 ) ;
if ( ! V_5 )
return - V_59 ;
for ( V_9 = 0 ; V_9 < V_171 ; V_9 ++ ) {
F_119 ( & V_5 [ V_9 ] . V_6 ) ;
