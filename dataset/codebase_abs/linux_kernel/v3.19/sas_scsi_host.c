...
enum V_172 F_85 ( struct V_1 * V_53 )
{
F_86 ( V_53 , L_36 , V_53 ) ;
return V_173 ;
}
int F_87 ( struct V_174 * V_175 , int V_53 , void T_3 * V_176 )
{
struct V_46 * V_33 = F_88 ( V_175 ) ;
if ( F_22 ( V_33 ) )
return F_89 ( V_33 -> V_79 . V_80 , V_175 , V_53 , V_176 ) ;
return - V_177 ;
}
struct V_46 * F_90 ( struct V_178 * V_139 )
{
struct V_71 * V_101 = F_91 ( V_139 -> V_33 . V_179 ) ;
struct V_47 * V_35 = F_27 ( V_101 ) ;
struct V_46 * V_180 = NULL ;
int V_74 ;
unsigned long V_48 ;
F_10 ( & V_35 -> V_123 , V_48 ) ;
for ( V_74 = 0 ; V_74 < V_35 -> V_181 ; V_74 ++ ) {
struct V_97 * V_34 = V_35 -> V_182 [ V_74 ] ;
struct V_46 * V_33 ;
F_92 ( & V_34 -> V_183 ) ;
F_93 (dev, &port->dev_list, dev_list_node) {
if ( V_139 == V_33 -> V_139 ) {
V_180 = V_33 ;
F_94 ( & V_34 -> V_183 ) ;
goto V_184;
...
int F_95 ( struct V_185 * V_186 )
{
struct V_178 * V_139 = F_96 ( V_186 -> V_33 . V_179 ) ;
struct V_46 * V_180 = F_90 ( V_139 ) ;
if ( ! V_180 )
return - V_144 ;
F_72 ( & V_180 -> V_165 ) ;
V_186 -> V_187 = V_180 ;
...
int F_97 ( struct V_174 * V_188 )
{
struct V_46 * V_33 = F_88 ( V_188 ) ;
struct V_47 * V_87 ;
F_41 ( V_33 -> V_139 -> V_189 . V_190 != V_191 ) ;
if ( F_22 ( V_33 ) ) {
F_98 ( V_188 , V_33 -> V_79 . V_80 ) ;
return 0 ;
}
V_87 = V_33 -> V_34 -> V_35 ;
F_99 ( V_188 ) ;
...
int F_101 ( struct V_174 * V_175 , int V_195 )
{
struct V_46 * V_33 = F_88 ( V_175 ) ;
if ( F_22 ( V_33 ) )
return F_102 ( V_33 -> V_79 . V_80 , V_175 , V_195 ) ;
if ( ! V_175 -> V_192 )
V_195 = 1 ;
return F_100 ( V_175 , V_195 ) ;
}
int F_103 ( struct V_174 * V_188 ,
struct V_196 * V_197 ,
T_4 V_198 , int * V_199 )
{
V_199 [ 0 ] = 255 ;
...
if ( ! V_201 )
return;
if ( ! F_106 ( & V_201 -> V_203 ) )
return;
V_201 -> V_203 . V_204 ( V_201 -> V_203 . V_205 ) ;
return;
}
if ( F_22 ( V_4 -> V_33 ) ) {
F_107 ( V_4 ) ;
} else {
struct V_206 * V_207 = V_2 -> V_61 -> V_206 ;
unsigned long V_48 ;
F_10 ( V_207 -> V_208 , V_48 ) ;
F_108 ( V_2 -> V_209 ) ;
F_12 ( V_207 -> V_208 , V_48 ) ;
}
}
void F_109 ( struct V_185 * V_186 )
{
struct V_46 * V_180 = V_186 -> V_187 ;
if ( ! V_180 )
return;
V_186 -> V_187 = NULL ;
F_75 ( V_180 ) ;
}
static void F_110 ( T_5 * V_116 , const char * V_210 )
{
int V_74 ;
for ( V_74 = 0 ; V_74 < V_211 ; V_74 ++ ) {
T_5 V_212 , V_213 ;
if ( ! * V_210 )
break;
V_212 = isdigit ( * V_210 ) ? * V_210 - '0' : toupper ( * V_210 ) - 'A' + 10 ;
V_210 ++ ;
V_213 = isdigit ( * V_210 ) ? * V_210 - '0' : toupper ( * V_210 ) - 'A' + 10 ;
V_210 ++ ;
V_116 [ V_74 ] = ( V_212 << 4 ) | V_213 ;
}
}
int F_111 ( struct V_71 * V_101 , T_5 * V_214 )
{
int V_76 ;
const struct V_215 * V_216 ;
V_76 = F_112 ( & V_216 , L_39 , & V_101 -> V_217 ) ;
if ( V_76 )
return V_76 ;
