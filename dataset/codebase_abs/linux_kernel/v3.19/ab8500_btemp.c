...
T_1 V_100 ;
V_5 = F_60 ( & V_122 -> V_19 , sizeof( * V_5 ) , V_131 ) ;
if ( ! V_5 ) {
...
V_5 -> V_10 = V_129 ;
if ( V_126 ) {
V_23 = F_61 ( & V_122 -> V_19 , V_126 , V_5 -> V_10 ) ;
if ( V_23 ) {
F_7 ( & V_122 -> V_19 , L_40 ) ;
return V_23 ;
}
...
for ( V_43 = 0 ; V_43 < F_53 ( V_124 ) ; V_43 ++ ) {
V_83 = F_54 ( V_122 , V_124 [ V_43 ] . V_105 ) ;
V_23 = F_67 ( V_83 , NULL , V_124 [ V_43 ] . V_147 ,
V_148 | V_149 ,
