...
static void F_74 ( struct V_1 * V_36 )
{
struct V_37 * V_38 ;
struct V_17 * V_18 ;
V_38 = F_16 ( V_36 -> V_16 ) ;
V_18 = F_5 ( V_36 -> V_16 ) ;
F_75 ( V_36 ) ;
F_76 ( V_18 , V_36 -> V_131 , V_36 -> V_132 , V_36 -> V_133 ) ;
}
...
static void F_80 ( struct V_1 * V_36 )
{
struct V_17 * V_18 ;
if ( ! V_36 )
return;
...
if ( V_36 -> V_2 ) {
if ( V_36 -> V_2 -> V_27 )
F_81 ( V_18 , V_36 -> V_2 -> V_27 ) ;
F_80 ( V_36 -> V_2 ) ;
}
F_80 ( V_36 ) ;
}
}
static struct V_1 * F_83 (
...
struct V_17 * V_18 = F_5 ( V_16 ) ;
int V_131 ;
V_131 = F_78 ( V_18 , V_135 ) ;
if ( V_131 < 0 )
return NULL ;
V_36 = F_84 ( V_18 , sizeof( struct V_1 ) ,
V_144 ) ;
if ( ! V_36 )
return NULL ;
V_36 -> V_16 = V_16 ;
...
V_36 -> V_135 = V_135 ;
V_36 -> V_145 = V_143 ;
V_36 -> V_132 = F_85 ( V_18 , V_131 , & V_36 -> V_133 ,
V_144 ) ;
if ( ! V_36 -> V_132 ) {
F_81 ( V_18 , V_36 ) ;
return NULL ;
...
static T_3 F_88 ( enum V_148 V_149 , T_4 V_150 )
{
...
int V_62 ;
V_143 = F_88 ( V_157 , V_151 ++ ) ;
V_55 = F_83 ( V_16 , V_142 ++ ,
V_138 , V_143 ) ;
if ( ! V_55 ) {
V_62 = - V_26 ;
goto V_158;
}
V_143 = F_88 ( V_159 , V_154 ++ ) ;
V_2 = F_83 ( V_16 , V_142 ++ ,
V_137 , V_143 ) ;
if ( ! V_2 ) {
V_62 = - V_26 ;
...
V_55 -> V_2 = V_2 ;
V_38 -> V_55 = V_55 ;
V_143 = F_88 ( V_159 , V_152 ++ ) ;
V_90 = F_83 ( V_16 , V_142 ++ ,
V_138 , V_143 ) ;
if ( ! V_90 ) {
V_62 = - V_26 ;
goto V_158;
...
static int F_92 ( struct V_15 * V_16 , void * V_168 )
{
struct V_37 * V_38 = F_16 ( V_16 ) ;
int V_62 ;
V_62 = F_93 ( V_16 , V_168 ) ;
if ( V_62 )
return V_62 ;
...
V_18 = & V_141 -> V_18 ;
V_16 = V_38 -> V_16 ;
V_172 = F_95 ( V_141 , V_175 , L_6 ) ;
V_38 -> V_173 = F_96 ( V_18 , V_172 ) ;
if ( F_97 ( V_38 -> V_173 ) ) {
F_79 ( V_18 , L_7 ) ;
return F_98 ( V_38 -> V_173 ) ;
}
V_172 = F_95 ( V_141 , V_175 , L_8 ) ;
V_38 -> V_176 = F_96 ( V_18 , V_172 ) ;
if ( F_97 ( V_38 -> V_176 ) ) {
F_79 ( V_18 , L_9 ) ;
return F_98 ( V_38 -> V_176 ) ;
}
V_172 = F_95 ( V_141 , V_175 , L_10 ) ;
V_38 -> V_146 = F_96 ( V_18 , V_172 ) ;
if ( F_97 ( V_38 -> V_146 ) ) {
F_79 ( V_18 , L_11 ) ;
return F_98 ( V_38 -> V_146 ) ;
}
V_62 = F_99 ( V_141 , 0 ) ;
if ( V_62 <= 0 ) {
F_79 ( V_18 , L_12 ) ;
...
V_38 -> V_160 = V_62 ;
V_174 = F_100 ( V_18 -> V_178 ) ;
if ( V_174 )
memcpy ( V_16 -> V_179 , V_174 , V_16 -> V_180 ) ;
else
F_101 ( V_16 ) ;
memcpy ( V_16 -> V_181 , V_16 -> V_179 , V_16 -> V_180 ) ;
V_38 -> V_124 = F_102 ( V_141 -> V_18 . V_178 ) ;
if ( V_38 -> V_124 < 0 ) {
F_79 ( V_18 , L_13 ) ;
return V_38 -> V_124 ;
}
...
V_38 -> V_185 = F_103 ( & V_141 -> V_18 , NULL ) ;
V_62 = F_97 ( V_38 -> V_185 ) ;
if ( F_97 ( V_38 -> V_185 ) ) {
F_79 ( & V_141 -> V_18 , L_15 ) ;
V_62 = F_98 ( V_38 -> V_185 ) ;
return V_62 ;
}
V_173 = V_38 -> V_173 ;
...
static int F_104 ( struct V_37 * V_38 )
{
...
static int F_106 ( struct V_170 * V_141 )
{
struct V_15 * V_16 ;
struct V_37 * V_38 ;
...
goto V_158;
V_56 = & V_38 -> V_55 -> V_56 ;
F_114 ( V_16 , V_56 , F_56 , V_216 ) ;
V_117 = V_38 -> V_117 ;
if ( V_38 -> V_124 == V_125 )
V_62 = F_115 ( V_38 ) ;
else
F_116 ( & V_38 -> V_127 , V_117 -> V_217 ) ;
return V_62 ;
V_158:
F_117 ( V_16 ) ;
F_118 ( V_16 ) ;
...
static int F_119 ( struct V_170 * V_141 )
{
struct V_37 * V_38 ;
struct V_121 * V_117 ;
struct V_15 * V_16 ;
