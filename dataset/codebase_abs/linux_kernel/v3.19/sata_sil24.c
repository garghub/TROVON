...
static int F_90 ( struct V_182 * V_183 , const struct V_184 * V_185 )
{
extern int V_186 ;
...
V_6 = F_96 ( & V_183 -> V_10 , V_190 ,
F_97 ( V_190 [ 0 ] -> V_31 ) ) ;
if ( ! V_6 )
return - V_178 ;
V_6 -> V_7 = V_7 ;
if ( ! F_98 ( V_183 , F_99 ( 64 ) ) ) {
V_73 = F_100 ( V_183 , F_99 ( 64 ) ) ;
if ( V_73 ) {
V_73 = F_100 ( V_183 , F_99 ( 32 ) ) ;
if ( V_73 ) {
F_77 ( & V_183 -> V_10 ,
L_28 ) ;
return V_73 ;
...
V_73 = F_98 ( V_183 , F_99 ( 32 ) ) ;
if ( V_73 ) {
F_77 ( & V_183 -> V_10 , L_29 ) ;
return V_73 ;
}
V_73 = F_100 ( V_183 , F_99 ( 32 ) ) ;
if ( V_73 ) {
...
F_101 ( V_183 , 4096 ) ;
F_89 ( V_6 ) ;
if ( V_197 && ! F_102 ( V_183 ) ) {
F_95 ( & V_183 -> V_10 , L_31 ) ;
F_103 ( V_183 , 0 ) ;
}
F_104 ( V_183 ) ;
return F_105 ( V_6 , V_183 -> V_160 , F_76 , V_198 ,
& V_199 ) ;
}
static int F_106 ( struct V_182 * V_183 )
{
struct V_162 * V_6 = F_107 ( V_183 ) ;
void T_1 * V_163 = V_6 -> V_7 [ V_164 ] ;
int V_73 ;
V_73 = F_108 ( V_183 ) ;
if ( V_73 )
