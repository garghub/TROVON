...
static void F_70 ( struct V_1 * V_2 , struct V_17 * V_18 )
{
struct V_13 * V_14 = F_3 ( V_2 -> V_4 ) ;
bool V_130 = false ;
...
static void F_75 ( struct V_1 * V_2 , struct V_17 * V_18 , bool V_138 )
{
struct V_139 * V_140 ;
struct V_13 * V_14 = F_3 ( V_2 -> V_4 ) ;
...
V_9 = F_21 ( V_18 ) ;
F_4 ( ! V_9 ) ;
F_83 ( V_2 -> V_45 , V_9 -> V_22 ,
V_14 -> V_26 , V_69 ) ;
V_148 = F_84 ( V_12 , V_146 , V_18 -> V_25 ) ;
if ( V_148 == - V_149 ) {
F_20 ( V_2 -> V_45 , V_9 -> V_22 ,
V_14 -> V_26 , V_69 ) ;
return false ;
...
static struct V_8 * F_86 ( struct V_1 * V_2 ,
struct V_145 * V_146 ,
enum V_36 V_37 )
{
struct V_8 * V_9 = NULL ;
while ( F_81 ( V_2 , V_37 , V_146 , & V_9 ) ) {
if ( ! V_9 )
continue;
return V_9 ;
}
...
return NULL ;
V_16 = V_9 -> V_19 ;
V_148 = F_88 ( V_12 , V_16 , V_146 ) ;
if ( V_148 == - V_149 ) {
struct V_145 V_151 ;
struct V_8 * V_47 ;
struct V_15 * V_152 ;
memset ( & V_151 , 0 , sizeof( V_151 ) ) ;
if ( F_89 ( & V_9 -> V_43 , & V_2 -> V_27 . V_42 ) ) {
V_2 -> V_27 . V_28 = NULL ;
return NULL ;
}
V_47 = F_90 ( V_9 -> V_43 . V_153 , struct V_8 , V_43 ) ;
V_152 = V_47 -> V_19 ;
V_148 = F_88 ( V_12 , V_152 , & V_151 ) ;
if ( V_148 == - V_149 )
return NULL ;
V_148 = F_88 ( V_12 , V_16 , V_146 ) ;
if ( V_148 == - V_149 ) {
...
F_92 ( V_162 , V_163 , V_158 ) ;
F_95 ( V_2 , V_162 ) ;
if ( V_162 -> V_170 & V_172 ) {
F_96 ( V_2 , V_140 , V_162 , V_163 -> V_160 ) ;
if ( F_97 ( & V_2 -> V_173 , V_140 , V_162 , V_163 -> V_160 ) )
F_94 ( V_174 ) ;
return - V_150 ;
}
F_56 ( & V_2 -> V_79 ) ;
if ( ! F_98 ( V_14 , V_140 , V_163 , V_162 , V_164 ,
V_2 -> V_60 -> V_80 ) ) {
F_61 ( & V_2 -> V_79 ) ;
return - V_150 ;
}
...
if ( F_100 ( ! V_12 -> V_177 ) )
return - V_150 ;
if ( F_101 ( V_14 , V_74 , V_162 , V_163 ) ) {
...
int F_64 ( struct V_1 * V_2 , int V_10 , bool V_204 )
{
struct V_8 * V_9 ;
...
V_207 = F_93 ( V_2 , V_206 , & V_146 , V_157 ,
& V_164 , V_158 ) ;
if ( V_207 )
goto V_214;
...
V_9 -> V_23 = V_205 ;
V_9 -> V_22 = V_211 ;
F_112 ( V_18 , V_146 . V_154 + V_12 -> V_5 . V_44 ) ;
if ( V_12 -> V_5 . V_44 )
F_113 ( V_18 , V_12 -> V_5 . V_44 ) ;
if ( ! V_146 . V_155 )
F_114 ( V_14 , V_206 , & V_146 ,
V_157 , V_164 ) ;
if ( V_146 . V_155 ) {
F_94 ( V_217 ) ;
if ( V_2 -> V_27 . V_213 ) {
...
if ( V_2 -> V_27 . V_213 ) {
int V_220 = V_18 -> V_126 - F_115 ( V_206 ) ;
if ( F_116 ( V_206 , 0 , V_220 , V_215 ) < 0 ) {
F_54 ( V_18 ) ;
F_94 ( V_216 ) ;
goto V_214;
}
V_2 -> V_27 . V_213 = NULL ;
F_117 ( V_18 , F_112 ( V_206 , V_18 -> V_126 ) ,
V_18 -> V_126 ) ;
F_34 ( V_18 ) ;
V_18 = V_206 ;
}
if ( V_157 -> V_186 & V_221 )
F_118 ( V_18 , V_18 -> V_126 - 8 ) ;
F_119 ( & V_2 -> V_222 , V_210 ) ;
if ( ( V_2 -> V_131 & ( V_132 |
V_137 |
V_143 ) ) ||
F_1 ( V_2 ) )
F_75 ( V_2 , V_18 , V_146 . V_176 ) ;
F_120 ( & V_2 -> V_222 , V_210 ) ;
F_107 ( V_2 , & V_146 ) ;
F_109 ( V_2 , & V_146 , V_157 ) ;
F_121 ( V_2 , & V_146 , V_18 ) ;
V_140 = (struct V_139 * ) V_18 -> V_25 ;
if ( F_122 ( V_140 -> V_141 ) )
F_123 ( V_2 -> V_4 , V_18 , V_146 . V_161 ) ;
F_124 ( V_74 , V_18 ) ;
V_214:
if ( V_2 -> V_27 . V_213 ) {
F_34 ( V_2 -> V_27 . V_213 ) ;
