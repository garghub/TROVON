...
{
struct V_206 * V_115 = F_124 ( V_16 ) ;
struct V_244 * V_15 = F_125 ( V_16 ) ;
...
static int F_133 ( struct V_146 * V_16 )
{
struct V_206 * V_115 = F_124 ( V_16 ) ;
struct V_244 * V_15 = F_125 ( V_16 ) ;
struct V_1 * V_2 = V_15 -> V_20 ;
...
static int F_139 ( struct V_1 * V_2 , int V_16 )
{
struct V_251 * V_252 ;
struct V_253 * V_254 ;
T_1 V_19 ;
if ( ! V_255 [ V_16 ] )
return - V_256 ;
V_254 = F_140 ( V_257 , 8 , L_15 ) ;
if ( ! V_254 )
return - V_123 ;
V_2 -> V_251 = V_252 = F_141 () ;
if ( ! V_252 ) {
F_69 ( V_2 -> V_15 -> V_16 ,
L_16 ) ;
F_142 ( V_254 ) ;
...
F_143 ( V_252 , L_17 ) ;
F_144 ( V_252 , L_18 , F_145 ( V_2 -> V_115 ) ) ;
F_146 ( V_252 , & V_2 -> V_115 -> V_16 ) ;
V_252 -> V_258 = V_257 ;
F_147 ( V_252 , V_254 ) ;
F_148 ( V_252 ) ;
return 0 ;
...
{
if ( V_2 -> V_251 ) {
struct V_253 * V_254 = F_150 ( V_2 -> V_251 ) ;
F_151 ( V_2 -> V_251 ) ;
V_2 -> V_251 = NULL ;
F_142 ( V_254 ) ;
}
}
static inline int F_139 ( struct V_1 * V_2 , int V_16 ) { return - V_259 ; }
...
if ( ! V_169 )
return - V_117 ;
snprintf ( V_2 -> V_260 , sizeof( V_2 -> V_260 ) , L_19 ,
F_145 ( V_2 -> V_115 ) ) ;
V_169 -> V_155 = V_2 -> V_15 -> V_261 ;
V_169 -> V_260 = V_2 -> V_260 ;
V_169 -> V_168 . V_262 = V_263 ;
V_169 -> V_168 . V_264 = V_2 -> V_115 -> V_264 ;
V_169 -> V_168 . V_265 = V_2 -> V_115 -> V_146 ;
V_169 -> V_16 . V_266 = & V_2 -> V_115 -> V_16 ;
F_154 ( V_267 , V_169 -> V_268 ) ;
F_154 ( V_170 , V_169 -> V_269 ) ;
F_154 ( V_172 , V_169 -> V_269 ) ;
F_154 ( V_171 , V_169 -> V_269 ) ;
V_113 = F_155 ( V_169 ) ;
if ( V_113 ) {
F_156 ( V_169 ) ;
return V_113 ;
...
static void F_157 ( struct V_270 * V_271 , T_2 V_272 )
{
struct V_1 * V_2 = V_271 -> V_20 ;
struct V_273 V_274 = * F_158 ( V_2 ) ;
T_1 V_19 = 0 ;
V_19 |= ( V_272 & V_275 ) ? ( 1 << V_274 . V_4 ) : 0 ;
V_19 |= ( V_272 & V_276 ) ? ( 1 << V_274 . V_277 ) : 0 ;
V_19 |= ( V_272 & V_278 ) ? ( 1 << V_274 . V_279 ) : 0 ;
F_2 ( V_19 , V_2 -> V_5 + V_280 ) ;
}
static T_2 F_159 ( struct V_270 * V_271 )
{
struct V_1 * V_2 = V_271 -> V_20 ;
struct V_273 V_274 = * F_158 ( V_2 ) ;
T_1 V_19 = F_7 ( V_2 -> V_5 + V_280 ) ;
T_2 V_281 = 0 ;
if ( V_19 & ( 1 << V_274 . V_4 ) )
V_281 |= V_275 ;
if ( V_19 & ( 1 << V_274 . V_282 ) )
V_281 |= V_283 ;
return V_281 ;
}
static void F_160 ( struct V_270 * V_271 , bool V_284 )
{
struct V_1 * V_2 = V_271 -> V_20 ;
unsigned long V_258 = V_2 -> V_5 + V_280 ;
T_1 V_285 = F_7 ( V_258 + V_286 ) ;
struct V_273 V_274 = * F_158 ( V_2 ) ;
if ( V_284 ) {
F_2 ( ~ ( ( 1 << V_274 . V_4 ) | ( 1 << V_274 . V_277 ) | ( 1 << V_274 . V_279 ) ) ,
V_258 + V_287 ) ;
F_2 ( V_285 | ( 1 << V_274 . V_4 ) | ( 1 << V_274 . V_277 ) | ( 1 << V_274 . V_279 ) ,
V_258 + V_286 ) ;
} else {
F_2 ( ~ ( ( 1 << V_274 . V_277 ) | ( 1 << V_274 . V_279 ) | ( 1 << V_274 . V_4 ) | ( 1 << V_274 . V_282 ) ) ,
V_258 + V_287 ) ;
F_2 ( ( V_285 & ~ ( ( 1 << V_274 . V_4 ) | ( 1 << V_274 . V_282 ) ) )
| ( 1 << V_274 . V_277 ) | ( 1 << V_274 . V_279 ) , V_258 + V_286 ) ;
}
}
...
static int F_169 ( struct V_289 * V_146 )
{
struct V_1 * V_2 = V_146 -> V_290 ;
return F_161 ( V_2 ) ;
}
static int F_170 ( struct V_244 * V_15 ,
struct V_206 * V_115 ,
int V_116 ,
int V_291 ,
int V_292 ,
...
struct V_1 * * V_295 )
{
static struct V_296 V_190 = {
. V_297 = F_169 ,
} ;
struct V_1 * V_2 ;
int V_23 , V_113 ;
* V_295 = NULL ;
if ( ( V_113 = F_135 ( V_115 ) ) < 0 )
return V_113 ;
if ( F_171 ( V_115 , F_172 ( 28 ) ) < 0 ||
F_173 ( V_115 , F_172 ( 28 ) ) < 0 ) {
F_69 ( V_15 -> V_16 ,
L_20 ) ;
F_130 ( V_115 ) ;
return - V_298 ;
...
V_2 -> V_147 = V_291 ;
V_2 -> V_148 = V_292 ;
if ( ( V_113 = F_177 ( V_115 , L_11 ) ) < 0 ) {
F_63 ( V_2 ) ;
F_130 ( V_115 ) ;
return V_113 ;
}
V_2 -> V_5 = F_178 ( V_115 , 0 ) ;
if ( F_179 ( V_115 -> V_173 , F_107 , V_299 ,
V_300 , V_2 ) ) {
F_69 ( V_15 -> V_16 , L_21 , V_115 -> V_173 ) ;
F_161 ( V_2 ) ;
return - V_123 ;
}
...
for ( V_23 = 0 ; V_23 < ( int ) F_180 ( V_301 ) ; V_23 ++ ) {
if ( V_2 -> type == V_301 [ V_23 ] . type &&
V_200 == V_301 [ V_23 ] . V_264 ) {
V_245 = 1 ;
break;
}
}
...
V_2 -> V_245 = V_245 ;
F_118 ( V_2 ) ;
if ( ( V_113 = F_181 ( V_15 , V_302 , V_2 , & V_190 ) ) < 0 ) {
F_161 ( V_2 ) ;
return V_113 ;
}
#ifdef F_164
if ( V_2 -> V_115 -> V_303 != 0x125d )
goto V_304;
V_113 = F_182 ( & V_115 -> V_16 , & V_2 -> V_288 ) ;
if ( V_113 < 0 ) {
F_161 ( V_2 ) ;
return V_113 ;
}
V_2 -> V_271 . V_288 = & V_2 -> V_288 ;
V_2 -> V_271 . V_20 = V_2 ;
V_2 -> V_271 . V_294 = V_294 ;
V_2 -> V_271 . V_190 = & V_305 ;
sprintf ( V_2 -> V_271 . V_306 , L_23 , F_145 ( V_115 ) ) ;
for ( V_23 = 0 ; V_23 < F_180 ( V_307 ) ; V_23 ++ ) {
V_2 -> V_308 = V_23 ;
if ( ! F_183 ( & V_2 -> V_271 , V_309 ) ) {
F_91 ( V_15 -> V_16 , L_24 ,
F_158 ( V_2 ) -> V_155 ) ;
F_184 ( V_2 -> V_271 . V_15 , F_158 ( V_2 ) -> V_155 ,
sizeof( V_2 -> V_271 . V_15 ) ) ;
break;
}
}
V_304:
...
static int F_185 ( struct V_206 * V_115 ,
...
V_113 = F_186 ( & V_115 -> V_16 , V_22 [ V_16 ] , V_168 [ V_16 ] , V_309 ,
0 , & V_15 ) ;
if ( V_113 < 0 )
return V_113 ;
if ( V_116 [ V_16 ] < 128 )
...
switch ( V_2 -> type ) {
case V_319 :
strcpy ( V_15 -> V_261 , L_25 ) ;
strcpy ( V_15 -> V_320 , L_26 ) ;
break;
case V_321 :
strcpy ( V_15 -> V_261 , L_27 ) ;
strcpy ( V_15 -> V_320 , L_28 ) ;
break;
case V_322 :
strcpy ( V_15 -> V_261 , L_29 ) ;
strcpy ( V_15 -> V_320 , L_30 ) ;
break;
}
...
unsigned short V_200 ;
F_114 ( V_2 -> V_115 , V_201 , & V_200 ) ;
for ( V_23 = 0 ; V_23 < F_180 ( V_324 ) ; V_23 ++ ) {
if ( V_2 -> type == V_324 [ V_23 ] . type &&
V_200 == V_324 [ V_23 ] . V_264 ) {
V_323 [ V_16 ] = 0 ;
break;
}
}
...
if ( ! V_2 -> clock )
F_85 ( V_2 ) ;
sprintf ( V_15 -> V_329 , L_33 ,
V_15 -> V_320 , V_2 -> V_5 , V_2 -> V_173 ) ;
if ( ( V_113 = F_189 ( V_15 ) ) < 0 ) {
F_187 ( V_15 ) ;
return V_113 ;
}
F_190 ( V_115 , V_15 ) ;
...
static void F_191 ( struct V_206 * V_115 )
{
F_187 ( F_192 ( V_115 ) ) ;
}
