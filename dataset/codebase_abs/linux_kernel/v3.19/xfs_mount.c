...
{
ASSERT ( V_178 > V_179 ) ;
if ( ( V_2 -> V_180 -> V_181 . V_182 >= V_178 ) ||
F_118 ( V_2 ) || ( V_2 -> V_8 & V_123 ) )
return false ;
return true ;
}
int
...
if ( ! F_85 ( & V_2 -> V_4 ) )
return 0 ;
V_119 = F_120 ( V_2 , V_184 , V_15 ) ;
error = F_60 ( V_119 , & F_61 ( V_2 ) -> V_185 , 0 , 0 ) ;
if ( error ) {
F_62 ( V_119 , 0 ) ;
return error ;
}
F_64 ( V_119 , V_186 | V_187 | V_188 ) ;
F_121 ( V_119 ) ;
error = F_65 ( V_119 , 0 ) ;
return error ;
}
...
int V_192 ;
long long V_193 ;
long long V_194 , V_195 ;
switch ( V_189 ) {
case V_196 :
V_193 = ( long long ) V_2 -> V_4 . V_197 ;
V_193 += V_190 ;
if ( V_193 < 0 ) {
ASSERT ( 0 ) ;
return - V_10 ;
...
case V_200 :
V_193 = ( long long )
V_2 -> V_4 . V_201 - F_123 ( V_2 ) ;
V_194 = ( long long ) ( V_2 -> V_202 - V_2 -> V_203 ) ;
if ( V_190 > 0 ) {
if ( V_194 > V_190 ) {
V_2 -> V_203 += V_190 ;
} else {
...
if ( ! V_191 )
return - V_204 ;
V_193 = ( long long ) V_2 -> V_203 + V_190 ;
if ( V_193 >= 0 ) {
V_2 -> V_203 = V_193 ;
return 0 ;
}
...
V_2 -> V_4 . V_201 = V_193 + F_123 ( V_2 ) ;
return 0 ;
case V_206 :
V_193 = ( long long ) V_2 -> V_4 . V_207 ;
V_193 += V_190 ;
if ( V_193 < 0 ) {
return - V_204 ;
}
...
int V_221 ;
#ifdef F_126
ASSERT ( V_189 < V_196 || V_189 > V_200 ) ;
#endif
F_14 ( & V_2 -> V_122 ) ;
V_221 = F_122 ( V_2 , V_189 , V_190 , V_191 ) ;
F_16 ( & V_2 -> V_122 ) ;
return V_221 ;
}
int
...
int error = 0 ;
F_14 ( & V_2 -> V_122 ) ;
for ( V_224 = V_222 ; V_224 < ( V_222 + V_223 ) ; V_224 ++ ) {
ASSERT ( V_224 -> V_225 < V_196 ||
V_224 -> V_225 > V_200 ) ;
error = F_122 ( V_2 , V_224 -> V_225 ,
V_224 -> V_226 , V_191 ) ;
if ( error )
goto V_227;
}
...
T_12 * V_119 ;
int error ;
ASSERT ( V_229 & ( V_86 | V_88 | V_230 |
V_134 | V_135 |
V_138 ) ) ;
V_119 = F_59 ( V_2 , V_231 ) ;
error = F_60 ( V_119 , & F_61 ( V_2 ) -> V_185 , 0 , 0 ) ;
if ( error ) {
F_62 ( V_119 , 0 ) ;
return error ;
...
T_17 * V_239 ;
T_2 * V_2 ;
V_2 = ( T_2 * ) F_10 ( V_236 , T_2 , V_240 ) ;
V_239 = ( T_17 * )
F_137 ( V_2 -> V_241 , ( unsigned long ) V_238 ) ;
switch ( V_237 ) {
case V_242 :
case V_243 :
memset ( V_239 , 0 , sizeof( T_17 ) ) ;
break;
case V_244 :
case V_245 :
F_138 ( V_2 ) ;
...
F_141 ( V_2 , V_198 ) ;
F_141 ( V_2 , V_200 ) ;
V_2 -> V_4 . V_197 += V_239 -> V_248 ;
V_2 -> V_4 . V_199 += V_239 -> V_249 ;
V_2 -> V_4 . V_201 += V_239 -> V_250 ;
memset ( V_239 , 0 , sizeof( T_17 ) ) ;
F_142 ( V_2 , V_196 , 0 ) ;
F_142 ( V_2 , V_198 , 0 ) ;
F_142 ( V_2 , V_200 , 0 ) ;
...
T_17 * V_239 ;
int V_7 ;
V_2 -> V_241 = F_144 ( T_17 ) ;
if ( V_2 -> V_241 == NULL )
return - V_39 ;
F_145 (i) {
V_239 = ( T_17 * ) F_137 ( V_2 -> V_241 , V_7 ) ;
memset ( V_239 , 0 , sizeof( T_17 ) ) ;
}
F_24 ( & V_2 -> V_252 ) ;
V_2 -> V_253 = - 1 ;
#ifdef F_146
V_2 -> V_240 . V_254 = F_136 ;
V_2 -> V_240 . V_255 = 0 ;
F_147 ( & V_2 -> V_240 ) ;
#endif
return 0 ;
...
T_17 * V_239 ;
int V_7 ;
memset ( V_259 , 0 , sizeof( T_17 ) ) ;
if ( ! ( V_57 & V_260 ) )
F_157 ( V_2 ) ;
F_145 (i) {
V_239 = ( T_17 * ) F_137 ( V_2 -> V_241 , V_7 ) ;
V_259 -> V_248 += V_239 -> V_248 ;
V_259 -> V_249 += V_239 -> V_249 ;
V_259 -> V_250 += V_239 -> V_250 ;
}
if ( ! ( V_57 & V_260 ) )
F_158 ( V_2 ) ;
}
...
return;
F_157 ( V_2 ) ;
if ( ! F_153 ( V_189 , & V_2 -> V_253 ) ) {
F_159 ( V_2 , & V_259 , V_260 ) ;
switch( V_189 ) {
case V_196 :
V_2 -> V_4 . V_197 = V_259 . V_248 ;
break;
case V_198 :
V_2 -> V_4 . V_199 = V_259 . V_249 ;
break;
case V_200 :
V_2 -> V_4 . V_201 = V_259 . V_250 ;
break;
default:
F_28 () ;
}
...
F_157 ( V_2 ) ;
F_145 (i) {
V_239 = F_137 ( V_2 -> V_241 , V_7 ) ;
switch ( V_189 ) {
case V_196 :
V_239 -> V_248 = V_261 + V_262 ;
break;
case V_198 :
V_239 -> V_249 = V_261 + V_262 ;
break;
case V_200 :
V_239 -> V_250 = V_261 + V_262 ;
break;
default:
F_28 () ;
break;
...
T_18 V_261 , V_262 ;
int V_264 = F_164 () ;
T_18 V_265 = ( T_18 ) V_263 ;
F_141 ( V_2 , V_189 ) ;
switch ( V_189 ) {
case V_196 :
V_261 = V_2 -> V_4 . V_197 ;
V_262 = F_48 ( V_261 , V_264 ) ;
if ( V_261 < F_165 ( V_265 , V_266 ) )
return;
break;
case V_198 :
V_261 = V_2 -> V_4 . V_199 ;
...
V_261 = V_2 -> V_4 . V_201 ;
V_262 = F_48 ( V_261 , V_264 ) ;
if ( V_261 < F_165 ( V_265 , F_166 ( V_2 ) ) )
return;
break;
default:
F_28 () ;
...
V_268:
F_169 () ;
V_256 = F_170 ( V_2 -> V_241 ) ;
if ( F_89 ( F_160 ( V_2 , V_189 ) ) )
goto V_269;
F_152 ( V_256 ) ;
if ( F_89 ( F_160 ( V_2 , V_189 ) ) ) {
F_155 ( V_256 ) ;
...
break;
case V_200 :
F_171 ( ( V_2 -> V_202 - V_2 -> V_203 ) != 0 ) ;
V_193 = V_256 -> V_250 - F_123 ( V_2 ) ;
V_193 += V_190 ;
if ( F_89 ( V_193 < 0 ) )
goto V_270;
V_256 -> V_250 = V_193 + F_123 ( V_2 ) ;
break;
default:
F_28 () ;
break;
...
F_14 ( & V_2 -> V_122 ) ;
V_267 = F_122 ( V_2 , V_189 , V_190 , V_191 ) ;
F_16 ( & V_2 -> V_122 ) ;
if ( V_267 != - V_204 )
F_139 ( V_2 , V_189 , 0 ) ;
F_140 ( V_2 ) ;
