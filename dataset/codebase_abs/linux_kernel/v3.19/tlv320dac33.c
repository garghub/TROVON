...
static inline void F_33 ( struct V_8 * V_9 )
{
...
static inline void F_42 ( struct V_8 * V_9 )
{
struct V_1 * V_2 = V_9 -> V_2 ;
unsigned long V_68 ;
switch ( V_9 -> V_55 ) {
...
static T_2 F_45 ( int V_93 , void * V_14 )
{
struct V_1 * V_2 = V_14 ;
struct V_8 * V_9 = F_4 ( V_2 ) ;
unsigned long V_68 ;
...
static int F_48 ( struct V_99 * V_51 ,
struct V_100 * V_101 )
{
...
static void F_49 ( struct V_99 * V_51 ,
struct V_100 * V_101 )
{
struct V_1 * V_2 = V_101 -> V_2 ;
struct V_8 * V_9 = F_4 ( V_2 ) ;
...
static int F_50 ( struct V_99 * V_51 ,
struct V_102 * V_103 ,
struct V_100 * V_101 )
{
struct V_1 * V_2 = V_101 -> V_2 ;
...
case 16 :
V_9 -> V_104 = V_105 ;
V_9 -> V_77 = F_53 ( V_9 -> V_106 , 32 ) ;
break;
case 32 :
V_9 -> V_104 = V_107 ;
V_9 -> V_77 = F_53 ( V_9 -> V_106 , 64 ) ;
break;
default:
F_6 ( V_2 -> V_14 , L_11 ,
F_52 ( V_103 ) ) ;
...
static int F_27 ( struct V_99 * V_51 ,
struct V_1 * V_2 )
{
struct V_8 * V_9 = F_4 ( V_2 ) ;
unsigned int V_108 , V_109 , V_110 , V_111 ;
T_1 V_112 , V_113 , V_114 ;
switch ( V_51 -> V_115 -> V_116 ) {
case 44100 :
case 48000 :
V_108 = F_54 ( V_51 -> V_115 -> V_116 , V_9 -> V_117 ) ;
V_109 = F_55 ( V_51 -> V_115 -> V_116 ,
V_9 -> V_117 ) ;
break;
default:
F_6 ( V_2 -> V_14 , L_10 ,
...
F_7 ( V_2 , V_131 , 96 ) ;
F_7 ( V_2 , V_132 , F_56 ( 2 ) |
F_57 ( 1 ) ) ;
F_7 ( V_2 , V_133 , F_58 ( 4 ) ) ;
V_110 = F_1 ( V_2 , V_36 ) ;
V_110 |= V_38 | V_39 | V_40 ;
F_7 ( V_2 , V_36 , V_110 ) ;
F_47 ( V_2 ) ;
if ( V_9 -> V_55 ) {
F_7 ( V_2 , V_134 , F_59 ( 1 ) ) ;
F_7 ( V_2 , V_135 , 1 ) ;
...
static void F_26 ( struct V_99 * V_51 ,
struct V_1 * V_2 )
{
struct V_8 * V_9 = F_4 ( V_2 ) ;
unsigned int V_151 = V_51 -> V_115 -> V_151 ;
unsigned int V_116 = V_51 -> V_115 -> V_116 ;
unsigned int V_152 ;
if ( ! V_9 -> V_55 )
return;
switch ( V_9 -> V_55 ) {
...
V_9 -> V_71 = V_151 ;
V_9 -> V_154 = F_39 ( V_9 -> V_77 ,
V_9 -> V_71 ) ;
V_9 -> V_74 = 0 ;
V_9 -> V_73 = 0 ;
break;
case V_80 :
V_9 -> V_149 = F_63 ( V_151 , V_116 ,
V_9 -> V_77 ) + 9 ;
...
static int F_64 ( struct V_99 * V_51 , int V_155 ,
struct V_100 * V_101 )
{
struct V_1 * V_2 = V_101 -> V_2 ;
struct V_8 * V_9 = F_4 ( V_2 ) ;
...
static int F_66 ( struct V_100 * V_171 ,
...
struct V_8 * V_9 = F_4 ( V_2 ) ;
if ( V_9 -> V_93 >= 0 ) {
F_72 ( V_9 -> V_93 , V_9 -> V_2 ) ;
F_76 ( V_9 -> V_94 ) ;
}
return 0 ;
}
static int F_77 ( struct V_207 * V_208 ,
...
V_9 = F_78 ( & V_208 -> V_14 , sizeof( struct V_8 ) ,
V_214 ) ;
if ( V_9 == NULL )
return - V_205 ;
V_9 -> V_13 = V_208 ;
...
V_11 = F_84 ( & V_208 -> V_14 , F_21 ( V_9 -> V_43 ) ,
V_9 -> V_43 ) ;
if ( V_11 != 0 ) {
F_6 ( & V_208 -> V_14 , L_23 , V_11 ) ;
goto V_218;
}
V_11 = F_85 ( & V_208 -> V_14 ,
& V_219 , & V_220 , 1 ) ;
if ( V_11 < 0 )
goto V_218;
return V_11 ;
