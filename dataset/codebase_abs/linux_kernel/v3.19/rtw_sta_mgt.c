...
struct V_1 * F_24 ( struct V_25 * V_26 , V_3 * V_61 )
{
T_2 V_58 ;
struct V_52 * V_62 ;
struct V_1 * V_2 ;
...
V_2 = F_18 ( ( & V_64 -> V_66 ) -> V_55 , struct V_1 , V_5 ) ;
F_26 ( & ( V_2 -> V_5 ) ) ;
F_19 ( & V_64 -> V_4 ) ;
F_1 ( V_2 ) ;
memcpy ( V_2 -> V_61 , V_61 , V_67 ) ;
V_58 = F_27 ( V_61 ) ;
F_28 ( V_68 , V_69 , ( L_2 , V_58 ) ) ;
if ( V_58 >= V_29 ) {
F_28 ( V_68 , V_70 , ( L_3 ) ) ;
V_2 = NULL ;
goto exit;
...
T_1 F_31 ( struct V_83 * V_73 , struct V_1 * V_2 )
{
int V_27 ;
struct V_63 * V_64 ;
struct V_56 * V_57 ;
...
F_32 ( V_87 , & V_2 -> V_7 ) ;
V_2 -> V_8 = 0 ;
F_32 ( V_87 , & V_85 -> V_89 . V_90 ) ;
F_26 ( & ( V_85 -> V_89 . V_91 ) ) ;
F_32 ( V_87 , & V_85 -> V_92 . V_90 ) ;
F_26 ( & ( V_85 -> V_92 . V_91 ) ) ;
F_32 ( V_87 , & V_85 -> V_93 . V_90 ) ;
F_26 ( & ( V_85 -> V_93 . V_91 ) ) ;
F_32 ( V_87 , & V_85 -> V_94 . V_90 ) ;
F_26 ( & ( V_85 -> V_94 . V_91 ) ) ;
F_19 ( & V_87 -> V_4 ) ;
F_26 ( & V_2 -> V_6 ) ;
F_28 ( V_68 , V_70 , ( L_5 , V_26 -> V_35 , V_2 -> V_61 [ 0 ] , V_2 -> V_61 [ 1 ] , V_2 -> V_61 [ 2 ] , V_2 -> V_61 [ 3 ] , V_2 -> V_61 [ 4 ] , V_2 -> V_61 [ 5 ] ) ) ;
V_26 -> V_35 -- ;
F_5 ( & V_2 -> V_9 ) ;
F_6 ( & V_2 -> V_10 ) ;
F_22 ( & V_2 -> V_95 ) ;
...
V_53 = V_54 -> V_55 ;
while ( ! F_25 ( V_54 ) ) {
V_97 = F_18 ( V_53 , struct V_96 , V_5 ) ;
...
V_2 -> V_112 = 0 ;
V_2 -> V_113 = 0 ;
V_26 -> V_38 &= ~ F_35 ( V_2 -> V_114 ) ;
V_26 -> V_39 &= ~ F_35 ( V_2 -> V_114 ) ;
...
void F_36 ( struct V_83 * V_73 )
{
struct V_52 * V_53 , * V_54 ;
T_2 V_58 ;
struct V_1 * V_2 = NULL ;
struct V_25 * V_26 = & V_73 -> V_48 ;
struct V_1 * V_116 = F_37 ( V_73 ) ;
if ( V_26 -> V_35 == 1 )
return;
F_17 ( & V_26 -> V_34 ) ;
for ( V_58 = 0 ; V_58 < V_29 ; V_58 ++ ) {
...
struct V_1 * F_38 ( struct V_25 * V_26 , V_3 * V_61 )
{
struct V_52 * V_53 , * V_54 ;
struct V_1 * V_2 = NULL ;
T_1 V_58 ;
...
struct V_1 * F_37 ( struct V_83 * V_73 )
{
struct V_1 * V_2 ;
struct V_25 * V_26 = & V_73 -> V_48 ;
V_3 V_118 [ V_67 ] = { 0xff , 0xff , 0xff , 0xff , 0xff , 0xff } ;
...
V_3 F_41 ( struct V_83 * V_73 , V_3 * V_122 )
{
V_3 V_119 = true ;
#ifdef F_7
struct V_52 * V_53 , * V_54 ;
...
V_53 = V_54 -> V_55 ;
while ( V_54 != V_53 ) {
V_124 = F_18 ( V_53 , struct V_123 , V_5 ) ;
V_53 = V_53 -> V_55 ;
