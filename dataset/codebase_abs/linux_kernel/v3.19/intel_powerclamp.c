...
static int F_78 ( struct V_117 * V_117 ,
struct V_118 * V_118 )
{
return F_79 ( V_118 , F_76 , V_117 -> V_119 ) ;
}
static inline void F_80 ( void )
{
V_120 = F_81 ( L_14 , NULL ) ;
if ( ! V_120 )
return;
if ( ! F_82 ( L_15 , V_121 , V_120 ,
V_40 , & V_122 ) )
goto V_123;
return;
V_123:
...
int V_124 ;
int V_125 ;
V_125 = F_85 ( F_63 () ) * sizeof( long ) ;
V_66 = F_86 ( V_125 , V_126 ) ;
if ( ! V_66 )
return - V_127 ;
V_124 = F_73 () ;
if ( V_124 )
...
V_10 = 2 ;
F_87 ( & V_129 ) ;
V_90 = F_88 ( struct V_87 * ) ;
if ( ! V_90 ) {
V_124 = - V_127 ;
goto V_130;
}
V_131 = F_89 ( L_14 , NULL ,
& V_132 ) ;
if ( F_56 ( V_131 ) ) {
V_124 = - V_108 ;
goto V_133;
