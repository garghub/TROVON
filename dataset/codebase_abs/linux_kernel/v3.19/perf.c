...
static int F_19 ( int * V_27 , const char * * * V_9 )
{
...
if ( V_39 )
return V_39 & 0xff ;
if ( F_30 ( fileno ( stdout ) , & V_41 ) )
return 0 ;
if ( F_31 ( V_41 . V_50 ) || F_32 ( V_41 . V_50 ) )
return 0 ;
V_39 = 1 ;
if ( fflush ( stdout ) ) {
fprintf ( V_15 , L_32 ,
F_33 ( V_30 , V_43 , sizeof( V_43 ) ) ) ;
goto V_51;
}
if ( ferror ( stdout ) ) {
fprintf ( V_15 , L_33 ) ;
...
static int F_41 ( int * V_27 , const char * * * V_9 )
{
int V_59 = 0 ;
while ( 1 ) {
F_34 ( * V_27 , * V_9 ) ;
F_36 ( * V_9 ) ;
if ( V_59 || ! F_19 ( V_27 , V_9 ) )
break;
V_59 = 1 ;
}
return V_59 ;
...
fprintf ( V_15 , L_48 ,
V_6 , F_33 ( V_30 , V_43 , sizeof( V_43 ) ) ) ;
V_51:
return 1 ;
}
