...
return F_56 ( V_2 , V_118 ) ;
}
T_2 F_57 ( struct V_3 * V_4 )
{
return V_157 ;
}
T_1
F_58 ( struct V_1 * V_2 ,
T_1 (* F_59)( struct V_1 * , void * ,
T_4 , T_4 ) ,
void * V_158 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
unsigned char * V_12 , * V_159 = NULL ;
T_4 V_160 ;
int V_118 ;
T_2 V_161 ;
T_1 V_50 = 0 ;
...
V_118 = V_163 ;
if ( V_118 / 16 > V_4 -> V_15 . V_166 ) {
V_50 = V_167 ;
goto V_168;
}
V_159 = & V_12 [ 8 ] ;
F_52 ( L_29
L_30 , V_4 -> V_9 -> V_91 , V_162 , V_163 , V_118 , V_159 ) ;
while ( V_118 >= 16 ) {
V_160 = F_54 ( & V_159 [ 0 ] ) ;
V_161 = F_9 ( & V_159 [ 8 ] ) ;
F_52 ( L_31 ,
( unsigned long long ) V_160 , V_161 ) ;
if ( V_161 > V_4 -> V_15 . V_169 ) {
V_50 = V_167 ;
goto V_168;
}
if ( V_160 + V_161 > V_4 -> V_9 -> V_10 ( V_4 ) + 1 ) {
V_50 = V_156 ;
goto V_168;
}
V_50 = F_59 ( V_2 , V_158 , V_160 , V_161 ) ;
if ( V_50 )
goto V_168;
V_159 += 16 ;
V_118 -= 16 ;
...
struct V_3 * V_4 = V_2 -> V_5 ;
struct V_170 * V_171 ;
struct V_47 * V_172 , * V_173 = V_2 -> V_109 ;
T_4 V_174 = V_2 -> V_34 ;
void * V_175 , * V_176 ;
int V_52 , V_177 , V_49 = 0 ;
F_28 (cmd->t_data_sg, dsg, cmd->t_data_nents, i) {
V_175 = F_29 ( F_30 ( V_172 ) ) + V_172 -> V_49 ;
V_176 = F_29 ( F_30 ( V_173 ) ) + V_173 -> V_49 ;
for ( V_177 = 0 ; V_177 < V_172 -> V_59 ; V_177 += V_4 -> V_15 . V_16 ) {
if ( V_49 >= V_173 -> V_59 ) {
F_31 ( V_176 ) ;
V_173 = F_61 ( V_173 ) ;
V_176 = F_29 ( F_30 ( V_173 ) ) + V_173 -> V_49 ;
...
V_171 = V_176 + V_49 ;
V_171 -> V_178 = F_62 ( F_63 ( V_175 + V_177 ,
V_4 -> V_15 . V_16 ) ) ;
if ( V_4 -> V_15 . V_25 == V_105 )
V_171 -> V_179 = F_64 ( V_174 & 0xffffffff ) ;
V_171 -> V_180 = 0 ;
F_52 ( L_32
L_33 ,
( unsigned long long ) V_174 , V_171 -> V_178 ,
V_171 -> V_180 , F_65 ( V_171 -> V_179 ) ) ;
V_174 ++ ;
V_49 += sizeof( struct V_170 ) ;
}
F_31 ( V_176 ) ;
F_31 ( V_175 ) ;
}
...
static T_1
F_66 ( struct V_3 * V_4 , struct V_170 * V_171 ,
const void * V_181 , T_4 V_174 , unsigned int V_182 )
{
int V_16 = V_4 -> V_15 . V_16 ;
T_6 V_183 ;
V_183 = F_62 ( F_63 ( V_181 , V_16 ) ) ;
if ( V_171 -> V_178 != V_183 ) {
F_23 ( L_34
L_35 , ( unsigned long long ) V_174 ,
F_67 ( V_171 -> V_178 ) , F_67 ( V_183 ) ) ;
return V_184 ;
}
if ( V_4 -> V_15 . V_25 == V_105 &&
F_65 ( V_171 -> V_179 ) != ( V_174 & 0xffffffff ) ) {
F_23 ( L_36
L_37 , ( unsigned long long ) V_174 ,
F_65 ( V_171 -> V_179 ) , ( T_2 ) ( V_174 & 0xffffffff ) ) ;
return V_185 ;
}
if ( V_4 -> V_15 . V_25 == V_114 &&
F_65 ( V_171 -> V_179 ) != V_182 ) {
F_23 ( L_38
L_39 , ( unsigned long long ) V_174 ,
F_65 ( V_171 -> V_179 ) , V_182 ) ;
return V_185 ;
}
return 0 ;
...
static void
F_68 ( struct V_1 * V_2 , unsigned int V_35 , bool V_186 ,
struct V_47 * V_48 , int V_187 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
struct V_47 * V_173 ;
void * V_176 , * V_46 ;
unsigned int V_52 , V_72 , V_188 ;
unsigned int V_49 = V_187 ;
V_188 = V_35 * V_4 -> V_116 ;
F_28 (cmd->t_prot_sg, psg, cmd->t_prot_nents, i) {
unsigned int V_189 , V_190 = 0 ;
V_176 = F_29 ( F_30 ( V_173 ) ) + V_173 -> V_49 ;
V_189 = F_41 ( V_188 , V_173 -> V_59 ) ;
while ( V_189 ) {
V_72 = F_41 ( V_189 , V_48 -> V_59 - V_49 ) ;
V_46 = F_29 ( F_30 ( V_48 ) ) + V_48 -> V_49 + V_49 ;
if ( V_186 )
memcpy ( V_176 + V_190 , V_46 , V_72 ) ;
else
memcpy ( V_46 , V_176 + V_190 , V_72 ) ;
V_188 -= V_72 ;
V_49 += V_72 ;
V_190 += V_72 ;
V_189 -= V_72 ;
...
T_1
F_69 ( struct V_1 * V_2 , T_4 V_191 , unsigned int V_35 ,
unsigned int V_182 , struct V_47 * V_48 , int V_187 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
struct V_170 * V_171 ;
struct V_47 * V_172 , * V_173 = V_2 -> V_109 ;
...
( unsigned long long ) V_174 , V_171 -> V_178 ,
V_171 -> V_180 , F_65 ( V_171 -> V_179 ) ) ;
V_76 = F_66 ( V_4 , V_171 , V_175 + V_177 , V_174 ,
V_182 ) ;
if ( V_76 ) {
F_31 ( V_176 ) ;
F_31 ( V_175 ) ;
...
F_68 ( V_2 , V_35 , false , V_48 , V_187 ) ;
return 0 ;
}
static T_1
F_70 ( struct V_1 * V_2 , T_4 V_191 , unsigned int V_35 ,
unsigned int V_182 , struct V_47 * V_48 , int V_187 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
struct V_170 * V_171 ;
struct V_47 * V_172 , * V_173 = V_48 ;
T_4 V_174 = V_191 ;
void * V_175 , * V_176 ;
int V_52 , V_177 , V_49 = V_187 ;
T_1 V_76 ;
F_28 (cmd->t_data_sg, dsg, cmd->t_data_nents, i) {
V_175 = F_29 ( F_30 ( V_172 ) ) + V_172 -> V_49 ;
V_176 = F_29 ( F_30 ( V_173 ) ) + V_48 -> V_49 ;
for ( V_177 = 0 ; V_177 < V_172 -> V_59 ; V_177 += V_4 -> V_15 . V_16 ) {
if ( V_49 >= V_173 -> V_59 ) {
F_31 ( V_176 ) ;
V_173 = F_61 ( V_173 ) ;
...
return F_70 ( V_2 , V_2 -> V_34 , V_35 , 0 ,
V_2 -> V_109 , 0 ) ;
}
T_1
F_72 ( struct V_1 * V_2 , T_4 V_191 , unsigned int V_35 ,
unsigned int V_182 , struct V_47 * V_48 , int V_187 )
{
T_1 V_76 ;
V_76 = F_70 ( V_2 , V_191 , V_35 , V_182 , V_48 , V_187 ) ;
if ( V_76 )
return V_76 ;
F_68 ( V_2 , V_35 , true , V_48 , V_187 ) ;
return 0 ;
}
