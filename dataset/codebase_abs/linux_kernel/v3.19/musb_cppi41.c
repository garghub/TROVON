...
static void F_43 ( struct V_53 * V_127 )
{
struct V_31 * V_32 ;
int V_128 ;
...
unsigned V_5 ;
unsigned int V_84 ;
V_56 = F_48 ( V_132 , L_5 , V_128 , & V_136 ) ;
if ( V_56 )
goto V_137;
if ( F_49 ( V_136 , L_6 ) )
V_5 = 1 ;
else if ( F_49 ( V_136 , L_7 ) )
V_5 = 0 ;
else {
F_50 ( V_130 , L_8 , V_136 ) ;
goto V_137;
}
V_56 = F_51 ( V_136 + 2 , 0 , & V_84 ) ;
if ( V_56 )
goto V_137;
V_56 = - V_138 ;
if ( V_84 > V_105 || ! V_84 )
...
V_135 -> V_23 = V_24 ;
V_135 -> V_139 = V_140 ;
V_32 = F_53 ( V_130 , V_136 ) ;
if ( ! V_32 ) {
F_50 ( V_130 , L_9 , V_136 ) ;
V_56 = - V_141 ;
goto V_137;
}
V_2 -> V_32 = V_32 ;
...
struct V_102 * F_57 ( struct V_7 * V_7 ,
void T_3 * V_142 )
{
struct V_53 * V_6 ;
int V_56 = 0 ;
...
V_6 = F_58 ( sizeof( * V_6 ) , V_143 ) ;
if ( ! V_6 )
goto V_144;
F_59 ( & V_6 -> V_58 , V_145 , V_79 ) ;
V_6 -> V_58 . V_146 = F_15 ;
F_52 ( & V_6 -> V_62 ) ;
V_6 -> V_7 = V_7 ;
V_6 -> V_6 . V_147 = F_36 ;
