...
goto V_102;
V_96 = V_97 ;
if ( ! F_62 ( V_107 , & V_55 -> V_108 ) && V_10 -> V_109 )
goto V_102;
switch ( V_10 -> V_15 ) {
case V_16 :
break;
case V_110 :
F_63 ( & V_55 -> V_111 . V_39 [ 0 ] , V_10 -> V_112 ) ;
V_96 = V_113 ;
break;
case V_18 :
if ( ! F_64 ( V_55 , & V_10 -> V_19 ) )
goto V_102;
V_96 = V_113 ;
break;
default:
F_27 ( V_114 L_4 , V_10 -> V_15 ) ;
F_12 ( V_10 ) ;
}
goto V_102;
}
void
F_65 ( struct V_54 * V_55 , int V_115 , T_2 * V_116 )
{
struct V_9 * V_10 = V_55 -> V_98 ;
struct V_117 * V_118 = & V_55 -> V_111 . V_39 [ 0 ] , * V_119 ;
T_1 V_93 ;
struct V_24 * V_25 ;
int V_66 ;
T_4 V_120 = 0 ;
...
V_93 = F_6 ( V_10 -> V_72 ) ;
V_25 = & V_32 [ V_93 ] ;
V_66 = V_118 -> V_22 - ( ( char * ) V_116 - ( char * ) V_118 -> V_20 ) ;
V_66 >>= 2 ;
if ( ! V_116 || V_66 > ( 256 >> 2 ) ) {
F_17 ( V_25 , V_10 ) ;
return;
...
V_119 = & V_10 -> V_19 ;
V_120 = V_66 << 2 ;
V_119 -> V_20 = F_66 ( V_120 , V_12 ) ;
if ( ! V_119 -> V_20 ) {
F_17 ( V_25 , V_10 ) ;
return;
}
V_119 -> V_22 = V_120 ;
memcpy ( V_119 -> V_20 , V_116 , V_120 ) ;
break;
case V_16 :
F_17 ( V_25 , V_10 ) ;
return;
...
V_21 += V_120 ;
F_34 ( V_25 , V_10 ) ;
V_10 -> V_109 = F_62 ( V_107 , & V_55 -> V_108 ) ;
V_10 -> V_15 = V_115 ;
V_10 -> V_13 = V_121 ;
F_19 ( & V_25 -> V_26 ) ;
return;
...
static int
F_64 ( struct V_54 * V_55 , struct V_117 * V_122 )
{
struct V_117 * V_123 = & V_55 -> V_111 . V_39 [ 0 ] ;
if ( V_123 -> V_22 + V_122 -> V_22 > V_68 ) {
F_27 ( V_114 L_6 ,
V_122 -> V_22 ) ;
return 0 ;
}
memcpy ( ( char * ) V_123 -> V_20 + V_123 -> V_22 , V_122 -> V_20 , V_122 -> V_22 ) ;
V_123 -> V_22 += V_122 -> V_22 ;
return 1 ;
}
static int F_67 ( struct V_124 * V_125 , void * V_126 )
{
F_68 ( V_125 , L_7 , V_29 ) ;
F_68 ( V_125 , L_8 ,
F_39 ( & V_23 ) ) ;
F_68 ( V_125 , L_9 , 1 << V_8 ) ;
F_68 ( V_125 , L_10 , V_21 ) ;
F_68 ( V_125 , L_11 , V_99 . V_104 ) ;
F_68 ( V_125 , L_12 , V_99 . V_103 ) ;
F_68 ( V_125 , L_13 , V_99 . V_100 ) ;
F_68 ( V_125 , L_14 , V_74 ) ;
F_68 ( V_125 , L_15 , V_87 ) ;
F_68 ( V_125 , L_16 , V_88 ) ;
return 0 ;
}
int F_69 ( struct V_127 * V_127 , struct V_128 * V_128 )
{
return F_70 ( V_128 , F_67 , NULL ) ;
}
