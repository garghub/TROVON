...
T_2 V_25 ;
int V_53 = 0 ;
V_6 = F_19 ( & V_42 -> V_2 , sizeof( * V_6 ) , V_54 ) ;
if ( ! V_6 )
return - V_55 ;
V_52 = F_20 ( V_42 , V_56 , 0 ) ;
V_6 -> V_7 = F_21 ( & V_42 -> V_2 , V_52 ) ;
if ( F_22 ( V_6 -> V_7 ) )
return F_23 ( V_6 -> V_7 ) ;
V_6 -> V_57 = F_24 ( & V_42 -> V_2 , NULL ) ;
if ( ! F_22 ( V_6 -> V_57 ) )
F_25 ( V_6 -> V_57 ) ;
...
V_25 = F_6 ( V_6 -> V_7 + V_24 ) ;
if ( F_7 ( ( V_25 >> V_23 ) & 0xff ) >= 38 ) {
F_27 ( & V_42 -> V_2 , L_4 ) ;
F_4 ( 0x130101 , V_6 -> V_7 + V_24 ) ;
}
V_6 -> V_43 = F_28 ( V_42 , 0 ) ;
F_29 ( V_42 , V_6 ) ;
if ( V_6 -> V_43 >= 0 ) {
F_30 ( & V_42 -> V_2 , 1 ) ;
V_6 -> V_47 = F_31 ( & V_42 -> V_2 , V_42 -> V_61 ,
& V_62 ,
V_63 ) ;
} else {
V_6 -> V_47 = F_31 ( & V_42 -> V_2 , V_42 -> V_61 ,
...
if ( V_6 -> V_43 >= 0 ) {
F_4 ( 0 , V_6 -> V_7 + V_38 ) ;
if ( F_32 ( & V_42 -> V_2 , V_6 -> V_43 , F_16 ,
V_65 ,
V_42 -> V_61 , V_6 ) < 0 ) {
F_33 ( & V_42 -> V_2 , L_5 ) ;
V_6 -> V_43 = - 1 ;
...
static int T_5 F_35 ( struct V_41 * V_42 )
{
struct V_5 * V_6 = F_15 ( V_42 ) ;
if ( V_6 -> V_43 >= 0 )
F_30 ( & V_42 -> V_2 , 0 ) ;
