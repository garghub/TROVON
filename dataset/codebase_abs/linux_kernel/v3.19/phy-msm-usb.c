...
{
struct V_1 * V_2 = F_12 ( V_89 -> V_24 , struct V_1 , V_9 ) ;
struct V_111 * V_112 ;
if ( V_2 -> V_35 -> V_73 == V_79 ) {
F_49 ( V_89 -> V_24 -> V_10 , L_32 ) ;
return - V_121 ;
}
if ( ! V_90 ) {
if ( V_89 -> V_122 == V_115 ) {
...
switch ( V_89 -> V_122 ) {
case V_119 :
F_57 ( V_89 -> V_24 -> V_10 , L_40 ) ;
F_31 ( V_89 -> V_24 ) ;
F_80 ( V_2 ) ;
V_89 -> V_122 = V_162 ;
case V_162 :
F_57 ( V_89 -> V_24 -> V_10 , L_41 ) ;
...
V_2 -> V_48 = F_114 ( & V_196 -> V_10 , V_216 ? L_63 : L_64 ) ;
if ( F_34 ( V_2 -> V_48 ) ) {
F_3 ( & V_196 -> V_10 , L_65 ) ;
return F_105 ( V_2 -> V_48 ) ;
}
V_2 -> V_100 = F_114 ( & V_196 -> V_10 , V_216 ? L_66 : L_67 ) ;
if ( F_34 ( V_2 -> V_100 ) ) {
F_3 ( & V_196 -> V_10 , L_68 ) ;
...
F_49 ( & V_196 -> V_10 , L_71 , V_2 -> V_215 ) ;
