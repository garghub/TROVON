...
{
int V_132 = F_77 ( V_131 , V_133 - 2 , & V_16 -> V_127 ) ;
V_131 [ V_132 ++ ] = '\n' ;
V_131 [ V_132 ] = '\0' ;
return V_132 ;
}
static int F_78 ( struct V_33 * V_33 , struct V_62 * V_134 )
{
...
switch ( V_151 & ~ V_154 ) {
case V_155 :
if ( ! F_81 ( V_117 , & V_16 -> V_127 ) )
break;
V_153 = F_82 ( V_156 , V_117 ) ;
if ( V_153 < 0 )
break;
F_83 ( V_153 , & V_16 -> V_127 ) ;
default:
break;
}
return V_157 ;
}
static int F_84 ( struct V_62 * V_134 )
{
struct V_158 * V_159 ;
int V_4 , V_90 , V_1 ;
V_16 = F_85 ( & V_134 -> V_66 , sizeof( * V_16 ) , V_160 ) ;
if ( ! V_16 )
return - V_161 ;
V_159 = F_86 ( V_134 , V_162 , 0 ) ;
V_16 -> V_37 = F_87 ( & V_134 -> V_66 , V_159 ) ;
if ( F_88 ( V_16 -> V_37 ) )
return - V_161 ;
V_16 -> V_3 = 0 ;
...
F_92 ( & V_16 -> V_93 ) ;
F_93 ( & V_16 -> V_91 , 0 ) ;
F_83 ( F_94 () , & V_16 -> V_127 ) ;
V_90 = F_95 ( & V_164 ) ;
if ( V_90 )
return V_90 ;
V_90 = F_78 ( V_16 , V_134 ) ;
if ( V_90 )
return V_90 ;
return 0 ;
}
static int F_96 ( struct V_62 * V_134 )
{
if ( ! F_97 () )
return - V_65 ;
return F_98 ( V_134 -> V_66 . V_165 , NULL , NULL , & V_134 -> V_66 ) ;
}
static inline void F_99 ( struct V_166 * V_167 , T_2 V_168 , T_4 V_169 )
{
V_167 -> V_167 = V_170 | V_168 ;
V_167 -> V_169 = V_169 ;
}
static inline bool F_100 ( struct V_166 * V_167 )
{
return ! ! ( V_167 -> V_167 & V_170 ) ;
}
static inline bool F_101 ( struct V_166 * V_167 , T_4 V_169 )
{
return V_167 -> V_169 == ( V_169 & V_171 ) ;
}
static int F_102 ( struct V_172 * V_173 , int type )
{
int V_4 ;
bool V_174 ;
struct V_172 * V_175 ;
V_175 = F_103 ( V_173 , L_8 , 0 ) ;
...
int F_104 ( struct V_172 * V_173 )
{
return F_102 ( V_173 , V_178 ) ;
}
...
struct V_172 * V_179 ;
F_106 (cpu) {
V_179 = F_107 ( V_117 , NULL ) ;
if ( F_108 ( ! V_179 , L_9 ) )
continue;
V_167 = F_102 ( V_179 , V_180 ) ;
if ( V_167 < 0 )
continue;
F_99 ( & V_166 [ V_117 ] , V_167 , F_109 ( V_117 ) ) ;
}
F_106 (cpu) {
F_108 ( ! F_100 ( & V_166 [ V_117 ] ) ,
L_10 ,
V_117 ) ;
}
}
static void T_8 F_110 ( unsigned int V_167 , bool V_181 )
{
...
int T_8 F_111 ( T_4 V_169 )
{
int V_117 ;
bool V_185 ;
for ( V_117 = 0 ; V_117 < V_186 ; V_117 ++ ) {
V_185 = F_100 ( & V_166 [ V_117 ] ) ;
if ( V_185 && F_101 ( & V_166 [ V_117 ] , V_169 ) ) {
F_110 ( V_166 [ V_117 ] . V_167 , false ) ;
return 0 ;
}
}
return - V_65 ;
}
T_10 void T_11 F_112 ( void )
{
asm volatile ("\n"
" .arch armv7-a\n"
...
int T_8 F_115 ( struct V_172 * V_173 , bool V_181 )
{
int V_167 ;
if ( ! V_173 )
return - V_65 ;
V_167 = F_102 ( V_173 , V_178 ) ;
if ( F_116 ( V_167 < 0 , L_11 ,
V_173 -> V_187 ) )
return - V_65 ;
F_110 ( V_167 , V_181 ) ;
return 0 ;
}
int T_8 F_117 ( T_2 V_167 , bool V_181 )
{
...
const char * V_196 ;
bool V_197 ;
V_194 = F_119 ( NULL , V_198 ) ;
if ( ! V_194 )
return - V_65 ;
if ( ! F_120 ( V_194 ) )
return - V_65 ;
V_191 = F_121 ( V_198 , V_194 ) -> V_199 ;
if ( ! V_191 )
return - V_65 ;
V_176 = V_191 -> V_192 + V_191 -> V_193 ;
V_177 = F_122 ( V_176 , sizeof( * V_177 ) , V_160 ) ;
if ( ! V_177 )
return - V_161 ;
V_90 = F_123 ( V_194 , 0 , & V_159 ) ;
if ( ! V_90 ) {
V_6 = F_124 ( V_159 . V_144 , F_125 ( & V_159 ) ) ;
V_200 = V_159 . V_144 ;
}
if ( V_90 || ! V_6 ) {
F_108 ( 1 , L_12 ) ;
...
V_197 = strcmp ( V_196 , L_15 ) == 0 ;
if ( ! V_197 && strcmp ( V_196 , L_16 ) ) {
F_108 ( 1 , L_17 ,
V_195 -> V_187 ) ;
continue;
}
V_90 = F_123 ( V_195 , 0 , & V_159 ) ;
if ( ! V_90 ) {
V_177 [ V_4 ] . V_37 = F_124 ( V_159 . V_144 , F_125 ( & V_159 ) ) ;
...
if ( V_197 ) {
if ( F_128 ( V_192 >= V_191 -> V_192 ) )
continue;
V_177 [ V_4 ] . type = V_180 ;
++ V_192 ;
} else {
if ( F_128 ( V_193 >= V_191 -> V_193 ) )
continue;
...
F_129 ( & V_177 ) ;
F_129 ( & V_166 ) ;
F_130 ( V_177 , sizeof( * V_177 ) * V_176 ) ;
F_131 ( L_19 ) ;
return 0 ;
V_202:
F_132 ( V_177 ) ;
