...
if ( V_26 < 0 )
return V_26 ;
V_4 += snprintf ( V_4 , V_177 - V_4 , L_91 , V_30 -> V_169 ) ;
if ( V_30 -> V_170 )
V_4 += snprintf ( V_4 , V_177 - V_4 , L_92 ,
V_30 -> V_170 ) ;
if ( V_30 -> V_132 )
V_4 += snprintf ( V_4 , V_177 - V_4 , L_93 , V_30 -> V_132 ) ;
if ( V_30 -> V_171 )
V_4 += snprintf ( V_4 , V_177 - V_4 , L_94 ,
F_106 ( V_30 -> V_171 ) ,
V_30 -> V_171 ) ;
if ( V_30 -> V_169 == V_193 ) {
struct V_194 * V_195 = F_110 ( V_30 , 1 ) ;
...
V_4 += snprintf ( V_4 , V_177 - V_4 , L_96 , V_225 ,
F_22 ( V_30 , V_225 ) ) ;
}
}
V_26 = V_4 - V_1 ;
...
F_139 ( V_296 , L_97 , V_295 ) ;
} else {
F_139 ( V_296 , L_98 , V_244 -> V_250 ) ;
V_26 = - V_16 ;
}
F_82 ( V_295 , 256 ) ;
return V_26 ;
