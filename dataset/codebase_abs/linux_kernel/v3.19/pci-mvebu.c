...
static T_4 F_48 ( struct V_132 * V_54 ,
...
return F_49 ( V_65 , F_50 ( T_4 , V_138 ,
F_51 ( V_16 ) ) ) ;
else if ( V_134 -> V_136 & V_139 )
return F_49 ( V_65 , F_50 ( T_4 , V_140 ,
F_51 ( V_16 ) ) ) ;
else
return V_65 ;
}
static void F_52 ( struct V_110 * V_52 )
{
struct V_141 V_142 ;
memset ( & V_142 , 0 , sizeof( V_142 ) ) ;
#ifdef F_53
V_142 . V_143 = V_52 -> V_144 ;
#endif
V_142 . V_145 = 1 ;
V_142 . V_113 = ( void * * ) & V_52 ;
V_142 . V_146 = F_38 ;
V_142 . V_147 = F_45 ;
V_142 . V_148 = V_149 ;
V_142 . V_150 = & V_131 ;
...
if ( ! V_172 )
return;
V_52 -> V_144 = F_68 ( V_172 ) ;
if ( V_52 -> V_144 )
V_52 -> V_144 -> V_54 = & V_52 -> V_53 -> V_54 ;
}
...
F_73 ( & V_52 -> V_64 ) ;
if ( F_41 ( & V_52 -> V_64 ) != 0 ) {
V_52 -> V_123 . V_136 = V_52 -> V_64 . V_136 ;
...
if ( V_2 -> V_36 < 0 )
continue;
V_50 = F_59 ( V_154 , V_2 -> V_36 , V_139 ,
& V_2 -> V_70 , & V_2 -> V_71 ) ;
if ( V_50 < 0 ) {
F_26 ( & V_53 -> V_54 , L_13 ,
V_2 -> V_2 , V_2 -> V_180 ) ;
...
V_52 -> V_114 = V_17 ;
for ( V_17 = 0 ; V_17 < ( V_178 - V_138 ) ; V_17 += V_138 )
