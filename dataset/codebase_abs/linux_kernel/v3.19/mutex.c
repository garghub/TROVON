...
static T_2 int T_1
F_50 ( struct V_1 * V_2 , long V_41 , unsigned int V_42 ,
...
int V_46 ;
F_51 () ;
F_52 ( & V_2 -> V_32 , V_42 , 0 , V_44 , V_33 ) ;
...
goto V_47;
F_55 ( V_2 , & V_45 ) ;
F_56 ( V_2 , & V_45 , F_57 ( V_24 ) ) ;
F_58 ( & V_45 . V_48 , & V_2 -> V_8 ) ;
V_45 . V_24 = V_24 ;
F_59 ( & V_2 -> V_32 , V_33 ) ;
for (; ; ) {
if ( F_19 ( & V_2 -> V_6 ) >= 0 &&
...
return 0 ;
V_50:
F_62 ( V_2 , & V_45 , F_57 ( V_24 ) ) ;
F_24 ( & V_2 -> V_7 , V_20 ) ;
F_65 ( & V_45 ) ;
F_66 ( & V_2 -> V_32 , 1 , V_33 ) ;
F_53 () ;
return V_46 ;
}
void T_1
...
void T_1
F_68 ( struct V_1 * V_2 , struct V_43 * V_53 )
{
F_10 () ;
F_50 ( V_2 , V_51 ,
0 , V_53 , V_52 , NULL , 0 ) ;
...
int T_1
F_69 ( struct V_1 * V_2 , unsigned int V_42 )
{
F_10 () ;
