...
return V_134 ;
return F_60 ( V_85 ,
V_125 -> V_135 [ 0 ] . V_136 . V_137 , V_134 ) ;
}
static int F_61 ( struct V_3 * V_4 )
{
struct V_138 * V_139 [ 4 ] = { } ;
struct V_84 * V_85 = V_4 -> V_85 ;
int V_140 ;
V_140 = F_62 ( V_4 -> V_125 -> V_141 , V_139 ) ;
if ( V_140 )
return V_140 ;
V_4 -> V_110 = F_63 ( V_85 ,
F_64 ( & V_139 [ 0 ] -> V_136 ) ) ;
...
V_4 -> V_15 = F_66 ( V_4 -> V_125 , V_139 + 1 ,
3 , V_68 , V_144 ) ;
if ( V_4 -> V_15 < 0 )
return V_4 -> V_15 ;
V_4 -> V_90 = 1 ;
...
V_139 [ 0 ] = F_68 ( V_85 , V_4 -> V_99 ) ;
V_139 [ 1 ] = F_68 ( V_85 , V_4 -> V_88 ) ;
V_139 [ 2 ] = F_68 ( V_85 , V_4 -> V_89 ) ;
F_69 ( V_4 -> V_125 , V_139 , 3 , V_144 ) ;
}
static int F_70 ( struct V_133 * V_125 , const struct V_145 * V_146 )
{
int V_24 = - V_147 ;
struct V_60 * V_61 = NULL ;
struct V_3 * V_4 ;
struct V_84 * V_85 = F_71 ( V_125 ) ;
if ( ! F_72 ( V_125 , V_146 ) )
return - V_148 ;
if ( F_58 ( V_85 , V_125 ) )
return - V_148 ;
...
F_79 ( V_125 , NULL ) ;
V_150:
F_60 ( V_85 , V_125 -> V_135 [ 0 ] . V_136 . V_137 , 0 ) ;
if ( V_61 )
F_82 ( V_61 ) ;
return V_24 ;
}
...
do {
F_85 ( & V_4 -> V_2 ) ;
V_140 = F_86 ( & V_4 -> V_111 , 5000 ) ;
if ( V_140 == 0 )
return - V_160 ;
V_140 = F_86 ( & V_4 -> V_113 , 500 ) ;
if ( V_140 == 0 )
return - V_160 ;
if ( F_87 ( V_159 , V_158 + 5 * V_161 ) )
return - V_160 ;
} while ( ! F_83 ( V_4 ) );
return 0 ;
}
static int F_88 ( struct V_133 * V_125 )
{
...
static int F_92 ( struct V_133 * V_125 )
{
struct V_60 * V_61 = F_89 ( V_125 ) ;
struct V_3 * V_4 = (struct V_3 * ) V_61 -> V_20 ;
unsigned long V_9 ;
...
static int F_94 ( struct V_133 * V_125 , T_2 V_163 )
{
struct V_60 * V_61 = F_89 ( V_125 ) ;
struct V_3 * V_4 = (struct V_3 * ) V_61 -> V_20 ;
if ( F_84 ( V_4 ) != 0 ) {
...
static int F_95 ( struct V_133 * V_125 )
{
return 0 ;
}
static int F_96 ( struct V_133 * V_125 )
{
struct V_60 * V_61 = F_89 ( V_125 ) ;
struct V_3 * V_4 = (struct V_3 * ) V_61 -> V_20 ;
unsigned long V_9 ;
...
static void F_97 ( struct V_133 * V_125 )
{
struct V_60 * V_61 = F_89 ( V_125 ) ;
struct V_3 * V_4 = (struct V_3 * ) V_61 -> V_20 ;
unsigned long V_9 ;
