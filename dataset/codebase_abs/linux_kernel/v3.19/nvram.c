...
static void T_4 F_43 ( int V_115 )
{
int V_24 ;
V_24 = F_19 ( & V_49 ) ;
if ( V_24 != 0 ) {
...
return;
V_116 = ( V_79 * 100 ) / 45 ;
V_77 = F_36 ( V_116 , V_108 ) ;
if ( V_77 ) {
V_57 . V_117 = F_36 ( F_45 (
V_60 , V_61 ) , V_108 ) ;
if ( ! V_57 . V_117 ) {
F_10 ( L_19
L_20 ,
...
const T_6 * V_121 ;
unsigned int V_122 ;
V_120 = F_50 ( NULL , L_24 ) ;
if ( V_120 == NULL )
return - V_12 ;
V_121 = F_51 ( V_120 , L_25 , & V_122 ) ;
if ( V_121 == NULL || V_122 != sizeof( unsigned int ) ) {
F_52 ( V_120 ) ;
return - V_16 ;
}
V_9 = F_53 ( V_121 ) ;
