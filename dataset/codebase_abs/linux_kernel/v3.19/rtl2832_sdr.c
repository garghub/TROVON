...
if ( V_2 -> V_154 -> V_155 -> V_157 )
V_2 -> V_154 -> V_155 -> V_157 ( V_2 -> V_84 , 1 ) ;
F_79 ( V_124 , & V_2 -> V_13 ) ;
V_6 = F_75 ( V_2 ) ;
if ( V_6 )
goto V_125;
...
F_81 ( V_124 , & V_2 -> V_13 ) ;
if ( V_2 -> V_154 -> V_155 -> V_157 )
V_2 -> V_154 -> V_155 -> V_157 ( V_2 -> V_84 , 0 ) ;
if ( V_2 -> V_154 -> V_155 -> V_156 )
V_2 -> V_154 -> V_155 -> V_156 ( V_2 -> V_154 , 0 ) ;
F_53 ( & V_2 -> V_87 ) ;
}
static int F_82 ( struct V_90 * V_90 , void * V_158 ,
struct V_159 * V_160 )
{
struct V_1 * V_2 = F_56 ( V_90 ) ;
F_24 ( & V_2 -> V_45 -> V_16 , L_70 , V_160 -> V_161 , V_160 -> type ) ;
if ( V_160 -> V_161 == 0 ) {
F_57 ( V_160 -> V_96 , L_71 , sizeof( V_160 -> V_96 ) ) ;
V_160 -> type = V_162 ;
V_160 -> V_163 = V_164 | V_165 ;
V_160 -> V_166 = 300000 ;
V_160 -> V_167 = 3200000 ;
} else if ( V_160 -> V_161 == 1 ) {
F_57 ( V_160 -> V_96 , L_72 , sizeof( V_160 -> V_96 ) ) ;
V_160 -> type = V_168 ;
V_160 -> V_163 = V_164 | V_165 ;
V_160 -> V_166 = 50000000 ;
V_160 -> V_167 = 2000000000 ;
} else {
return - V_14 ;
}
return 0 ;
}
static int F_83 ( struct V_90 * V_90 , void * V_158 ,
...
static int F_84 ( struct V_90 * V_90 , void * V_158 ,
struct V_169 * V_170 )
{
struct V_1 * V_2 = F_56 ( V_90 ) ;
F_24 ( & V_2 -> V_45 -> V_16 , L_73 ,
V_170 -> V_130 , V_170 -> type , V_170 -> V_161 ) ;
if ( V_170 -> V_130 == 0 ) {
if ( V_170 -> V_161 >= F_85 ( V_171 ) )
return - V_14 ;
* V_170 = V_171 [ V_170 -> V_161 ] ;
} else if ( V_170 -> V_130 == 1 ) {
if ( V_170 -> V_161 >= F_85 ( V_172 ) )
return - V_14 ;
* V_170 = V_172 [ V_170 -> V_161 ] ;
} else {
return - V_14 ;
}
return 0 ;
}
static int F_86 ( struct V_90 * V_90 , void * V_158 ,
struct V_173 * V_174 )
{
struct V_1 * V_2 = F_56 ( V_90 ) ;
int V_6 = 0 ;
F_24 ( & V_2 -> V_45 -> V_16 , L_74 ,
V_174 -> V_130 , V_174 -> type ) ;
if ( V_174 -> V_130 == 0 ) {
V_174 -> V_146 = V_2 -> V_123 ;
V_174 -> type = V_162 ;
} else if ( V_174 -> V_130 == 1 ) {
V_174 -> V_146 = V_2 -> V_141 ;
V_174 -> type = V_168 ;
} else {
return - V_14 ;
}
...
F_24 ( & V_2 -> V_45 -> V_16 , L_77 , V_174 -> V_146 ) ;
V_6 = F_71 ( V_2 ) ;
} else {
V_6 = - V_14 ;
}
...
static int F_91 ( struct V_90 * V_90 , void * V_158 ,
struct V_175 * V_174 )
{
struct V_1 * V_2 = F_56 ( V_90 ) ;
F_24 ( & V_2 -> V_45 -> V_16 , L_17 ) ;
if ( V_174 -> V_161 >= V_2 -> V_176 )
return - V_14 ;
F_57 ( V_174 -> V_177 , V_178 [ V_174 -> V_161 ] . V_96 , sizeof( V_174 -> V_177 ) ) ;
V_174 -> V_34 = V_178 [ V_174 -> V_161 ] . V_34 ;
return 0 ;
}
static int F_92 ( struct V_90 * V_90 , void * V_158 ,
struct V_107 * V_174 )
{
struct V_1 * V_2 = F_56 ( V_90 ) ;
F_24 ( & V_2 -> V_45 -> V_16 , L_17 ) ;
V_174 -> V_108 . V_179 . V_34 = V_2 -> V_34 ;
V_174 -> V_108 . V_179 . V_114 = V_2 -> V_114 ;
memset ( V_174 -> V_108 . V_179 . V_180 , 0 , sizeof( V_174 -> V_108 . V_179 . V_180 ) ) ;
return 0 ;
}
static int F_93 ( struct V_90 * V_90 , void * V_158 ,
struct V_107 * V_174 )
{
struct V_1 * V_2 = F_56 ( V_90 ) ;
struct V_105 * V_181 = & V_2 -> V_182 ;
int V_37 ;
F_24 ( & V_2 -> V_45 -> V_16 , L_78 ,
( char * ) & V_174 -> V_108 . V_179 . V_34 ) ;
if ( F_94 ( V_181 ) )
return - V_183 ;
memset ( V_174 -> V_108 . V_179 . V_180 , 0 , sizeof( V_174 -> V_108 . V_179 . V_180 ) ) ;
for ( V_37 = 0 ; V_37 < V_2 -> V_176 ; V_37 ++ ) {
if ( V_178 [ V_37 ] . V_34 == V_174 -> V_108 . V_179 . V_34 ) {
V_2 -> V_34 = V_178 [ V_37 ] . V_34 ;
V_2 -> V_114 = V_178 [ V_37 ] . V_114 ;
V_174 -> V_108 . V_179 . V_114 = V_178 [ V_37 ] . V_114 ;
return 0 ;
}
}
V_2 -> V_34 = V_178 [ 0 ] . V_34 ;
V_2 -> V_114 = V_178 [ 0 ] . V_114 ;
V_174 -> V_108 . V_179 . V_34 = V_178 [ 0 ] . V_34 ;
V_174 -> V_108 . V_179 . V_114 = V_178 [ 0 ] . V_114 ;
return 0 ;
}
static int F_95 ( struct V_90 * V_90 , void * V_158 ,
struct V_107 * V_174 )
{
struct V_1 * V_2 = F_56 ( V_90 ) ;
int V_37 ;
...
static int F_96 ( struct V_138 * V_184 )
{
struct V_1 * V_2 =
F_64 ( V_184 -> V_185 , struct V_1 ,
V_142 ) ;
struct V_83 * V_84 = V_2 -> V_84 ;
struct V_135 * V_136 = & V_84 -> V_137 ;
int V_6 ;
F_24 ( & V_2 -> V_45 -> V_16 ,
L_79 ,
V_184 -> V_186 , V_184 -> V_96 , V_184 -> V_4 ,
V_184 -> V_187 , V_184 -> V_188 , V_184 -> V_189 ) ;
switch ( V_184 -> V_186 ) {
case V_143 :
case V_144 :
if ( V_2 -> V_139 -> V_4 ) {
T_5 V_4 = V_2 -> V_123 + F_68 ( V_2 -> V_140 -> V_189 , 2 ) ;
T_4 V_190 ;
V_4 = F_90 ( T_5 , V_4 , V_2 -> V_140 -> V_187 ,
V_2 -> V_140 -> V_188 ) ;
V_190 = V_4 - V_2 -> V_140 -> V_187 ;
V_190 = V_2 -> V_140 -> V_189 *
F_68 ( V_190 , V_2 -> V_140 -> V_189 ) ;
V_2 -> V_140 -> V_4 = V_2 -> V_140 -> V_187 + V_190 ;
}
...
static void F_97 ( struct V_191 * V_160 )
{
struct V_1 * V_2 =
F_64 ( V_160 , struct V_1 , V_88 ) ;
F_98 ( & V_2 -> V_142 ) ;
F_99 ( & V_2 -> V_88 ) ;
F_100 ( V_2 ) ;
}
struct V_83 * F_101 ( struct V_83 * V_84 ,
struct V_192 * V_15 , const struct V_193 * V_11 ,
struct V_194 * V_195 )
{
int V_6 ;
struct V_1 * V_2 ;
const struct V_196 * V_126 = & V_197 ;
struct V_198 * V_154 = F_102 ( V_15 ) ;
V_2 = F_103 ( sizeof( struct V_1 ) , V_199 ) ;
if ( V_2 == NULL ) {
F_6 ( & V_154 -> V_45 -> V_16 ,
L_80 ) ;
return NULL ;
...
V_2 -> V_15 = V_15 ;
V_2 -> V_11 = V_11 ;
V_2 -> V_123 = V_171 [ 0 ] . V_166 ;
V_2 -> V_141 = V_172 [ 0 ] . V_166 ;
V_2 -> V_34 = V_178 [ 0 ] . V_34 ;
V_2 -> V_114 = V_178 [ 0 ] . V_114 ;
V_2 -> V_176 = V_200 ;
if ( ! V_201 )
...
F_105 ( & V_2 -> V_25 ) ;
F_106 ( & V_2 -> V_26 ) ;
V_2 -> V_182 . type = V_202 ;
V_2 -> V_182 . V_203 = V_204 | V_205 | V_206 ;
V_2 -> V_182 . V_207 = V_2 ;
V_2 -> V_182 . V_208 = sizeof( struct V_24 ) ;
V_2 -> V_182 . V_126 = & V_209 ;
V_2 -> V_182 . V_210 = & V_211 ;
V_2 -> V_182 . V_212 = V_213 ;
V_6 = F_107 ( & V_2 -> V_182 ) ;
if ( V_6 ) {
...
F_108 ( & V_2 -> V_142 , 9 ) ;
if ( V_195 )
F_109 ( & V_2 -> V_142 , V_195 -> V_215 , NULL ) ;
break;
case V_134 :
F_108 ( & V_2 -> V_142 , 2 ) ;
...
V_2 -> V_89 = V_217 ;
V_2 -> V_89 . V_218 = & V_2 -> V_182 ;
V_2 -> V_89 . V_218 -> V_219 = & V_2 -> V_86 ;
F_112 ( & V_2 -> V_89 , V_2 ) ;
V_2 -> V_88 . V_220 = F_97 ;
...
V_2 -> V_88 . V_215 = & V_2 -> V_142 ;
V_2 -> V_89 . V_88 = & V_2 -> V_88 ;
V_2 -> V_89 . V_219 = & V_2 -> V_87 ;
V_2 -> V_89 . V_221 = V_222 ;
V_6 = F_114 ( & V_2 -> V_89 , V_223 , - 1 ) ;
if ( V_6 ) {
F_6 ( & V_2 -> V_45 -> V_16 ,
L_85 ,
V_6 ) ;
