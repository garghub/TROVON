...
int F_49 ( void * V_43 , struct V_145 * V_41 ,
char * V_146 , int V_147 , int V_148 ,
int V_149 , struct V_1 * * V_2 )
{
struct V_35 * V_10 ;
int V_5 = 0 ;
int V_150 ;
...
V_150 = F_52 ( V_156 , V_157 ) ;
if ( V_150 >= V_157 )
return - V_158 ;
F_53 ( V_150 , V_156 ) ;
F_54 ( V_33 . V_159 , sizeof( V_33 . V_159 ) , L_5 ,
L_6 , V_150 ) ;
V_151 = V_118 |
V_160 |
V_117 |
