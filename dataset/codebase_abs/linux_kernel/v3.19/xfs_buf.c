...
while ( ! F_33 ( & V_195 ) ) {
struct V_1 * V_2 ;
V_2 = F_158 ( & V_195 , struct V_1 , V_16 ) ;
F_159 ( & V_2 -> V_16 ) ;
if ( V_2 -> V_7 & V_140 ) {
F_53 ( V_76 -> V_89 ,
L_7
...
struct V_203 * V_204 )
{
struct V_25 * V_76 = F_119 ( V_202 ,
struct V_25 , V_205 ) ;
F_155 ( V_195 ) ;
unsigned long V_206 ;
unsigned long V_207 = V_204 -> V_207 ;
V_206 = F_164 ( & V_76 -> V_15 , V_204 -> V_208 , F_161 ,
& V_195 , & V_207 ) ;
while ( ! F_33 ( & V_195 ) ) {
struct V_1 * V_2 ;
V_2 = F_158 ( & V_195 , struct V_1 , V_16 ) ;
...
struct V_25 * V_76 = F_119 ( V_202 ,
struct V_25 , V_205 ) ;
return F_166 ( & V_76 -> V_15 , V_204 -> V_208 ) ;
}
void
F_167 (
struct V_175 * V_176 ,
...
if ( F_178 ( & V_76 -> V_15 ) )
goto error;
V_76 -> V_205 . V_222 = F_165 ;
V_76 -> V_205 . V_223 = F_163 ;
V_76 -> V_205 . V_224 = V_225 ;
V_76 -> V_205 . V_29 = V_226 ;
F_179 ( & V_76 -> V_205 ) ;
return V_76 ;
error:
F_14 ( V_76 ) ;
