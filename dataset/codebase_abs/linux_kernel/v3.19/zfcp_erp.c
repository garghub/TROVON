...
static int F_114 ( struct V_14 * V_15 , int V_108 )
{
struct V_16 * V_17 = F_11 ( V_15 ) ;
switch ( V_108 ) {
case V_79 :
...
F_116 ( & V_17 -> V_21 -> V_2 -> V_111 -> V_41 ,
L_19
L_20 ,
...
static int F_119 ( struct V_20 * V_21 , int V_108 )
{
switch ( V_108 ) {
case V_79 :
F_88 ( & V_21 -> V_109 , 0 ) ;
...
switch ( V_19 -> V_43 ) {
case V_30 :
V_108 = F_114 ( V_15 , V_108 ) ;
break;
case V_34 :
case V_33 :
V_108 = F_119 ( V_21 , V_108 ) ;
break;
case V_37 :
V_108 = F_120 ( V_2 , V_108 ) ;
break;
}
return V_108 ;
}
static int F_122 ( T_2 * V_112 , T_1 V_113 )
{
int V_12 = F_12 ( V_112 ) ;
if ( ( V_12 & V_31 ) &&
( V_113 & V_40 ) )
...
static void F_126 ( struct V_5 * V_6 , int V_108 )
{
struct V_1 * V_2 = V_6 -> V_2 ;
struct V_20 * V_21 = V_6 -> V_21 ;
struct V_14 * V_15 = V_6 -> V_15 ;
...
F_130 ( & V_2 -> V_116 ) ;
F_131 ( V_2 ) ;
F_132 ( V_2 -> V_117 , & V_2 -> V_118 ) ;
} else
F_133 ( & V_2 -> V_116 ) ;
F_134 ( & V_2 -> V_42 , V_119 ) ;
break;
}
}
...
F_34 ( & V_2 -> V_54 , V_53 ) ;
if ( V_124 != & V_2 -> V_10 ) {
V_6 = F_140 ( V_124 , struct V_5 , V_9 ) ;
if ( F_136 ( V_6 ) != V_120 )
F_69 ( V_2 ) ;
}
}
...
{
struct V_125 * V_126 ;
V_126 = F_142 ( F_137 , V_2 , L_29 ,
F_143 ( & V_2 -> V_111 -> V_41 ) ) ;
if ( F_76 ( V_126 ) ) {
F_116 ( & V_2 -> V_111 -> V_41 ,
L_30 ) ;
return F_144 ( V_126 ) ;
