...
V_3 = F_41 ( V_3 , V_12 -> V_37 [ V_16 ] - 15 , V_12 -> V_37 [ V_16 ] ) ;
...
{
struct V_11 * V_12 ;
struct V_112 * V_113 = F_93 ( & V_96 -> V_19 ) ;
int V_20 = V_21 [ V_113 -> type ] ;
int V_22 = V_23 [ V_113 -> type ] ;
int V_81 , V_99 ;
T_2 V_114 , V_2 ;
V_12 = F_94 ( & V_96 -> V_19 , sizeof( struct V_11 ) ,
V_115 ) ;
if ( ! V_12 )
return - V_116 ;
V_12 -> V_13 = F_95 ( V_96 , V_117 , 0 ) -> V_118 ;
V_12 -> type = V_113 -> type ;
V_12 -> V_35 =
( V_12 -> type == V_17 || V_12 -> type == V_38 ) ? 0 : 1 ;
F_96 ( & V_12 -> V_25 ) ;
F_97 ( V_96 , V_12 ) ;
V_114 = F_13 ( V_12 , V_119 ) ;
if ( V_114 & 0x04 ) {
F_91 ( & V_96 -> V_19 , L_14 ) ;
return - V_120 ;
}
...
V_12 -> V_135 = F_98 ( & V_96 -> V_19 ) ;
if ( F_99 ( V_12 -> V_135 ) ) {
V_81 = F_100 ( V_12 -> V_135 ) ;
V_12 -> V_135 = NULL ;
goto V_122;
}
return 0 ;
...
int V_22 = V_23 [ V_12 -> type ] ;
int V_99 ;
T_2 V_114 = F_13 ( V_12 , V_119 ) ;
if ( V_12 -> V_135 )
F_102 ( V_12 -> V_135 ) ;
F_85 ( & V_96 -> V_19 , & V_121 ) ;
if ( V_114 & 0x01 ) {
switch ( V_12 -> type ) {
case V_17 :
if ( V_12 -> V_83 & 0x10 )
...
static int T_5 F_103 ( int V_136 , struct V_112 * V_113 )
{
T_1 V_137 ;
...
if ( V_81 )
return V_81 ;
V_137 = F_4 ( V_136 , V_139 ) ;
if ( V_137 != V_140 ) {
F_104 ( L_16 ) ;
V_81 = - V_120 ;
goto exit;
}
V_137 = V_141 ? V_141 : F_4 ( V_136 , V_142 ) ;
switch ( V_137 ) {
case V_143 :
V_113 -> type = V_54 ;
break;
...
F_8 ( V_136 , V_158 ) ;
if ( ! ( F_1 ( V_136 , V_159 ) & 0x01 ) ) {
F_106 ( L_18 ) ;
V_81 = - V_120 ;
goto exit;
}
V_138 = F_4 ( V_136 , V_160 ) ;
if ( V_138 == 0 ) {
F_106 ( L_19 ) ;
V_81 = - V_120 ;
goto exit;
...
V_81 = V_138 ;
F_105 ( L_20 ,
V_94 [ V_113 -> type ] , ( unsigned int ) V_138 ,
( int ) F_1 ( V_136 , V_162 ) ) ;
exit:
F_9 ( V_136 ) ;
return V_81 ;
}
static int T_5 F_107 ( int V_138 ,
...
int V_81 ;
V_167 = F_108 ( V_4 , V_138 ) ;
if ( ! V_167 )
return - V_116 ;
V_164 . V_168 = V_167 -> V_168 ;
V_81 = F_109 ( & V_164 ) ;
if ( V_81 )
goto V_169;
V_81 = F_110 ( V_167 , & V_164 , 1 ) ;
if ( V_81 ) {
F_7 ( L_21 ) ;
goto V_169;
}
V_81 = F_111 ( V_167 , V_113 ,
sizeof( struct V_112 ) ) ;
if ( V_81 ) {
F_7 ( L_22 ) ;
goto V_169;
...
V_138 = F_103 ( 0x2e , & V_113 ) ;
if ( V_138 < 0 )
V_138 = F_103 ( 0x4e , & V_113 ) ;
if ( V_138 < 0 )
return V_138 ;
V_81 = F_115 ( & V_170 ) ;
if ( V_81 )
return V_81 ;
V_81 = F_107 ( V_138 , & V_113 ) ;
if ( V_81 )
goto V_171;
return 0 ;
V_171:
