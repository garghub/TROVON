...
if ( ! V_135 )
return - V_38 ;
V_62 = F_120 ( V_135 , F_121 ( V_128 ) , 0 ,
V_69 , V_15 ) ;
...
F_10 ( L_29 , V_128 , V_135 ,
V_135 -> V_145 ) ;
V_62 = F_126 ( V_135 , V_69 , F_121 ( V_128 ) ) ;
if ( V_62 ) {
F_106 ( V_135 ) ;
F_127 ( L_30 , V_62 ) ;
return NULL ;
...
{
struct V_171 * V_171 = F_77 ( V_124 , struct V_171 , V_124 ) ;
if ( V_171 -> V_172 == 0 || V_128 != V_171 -> V_172 )
F_133 () ;
V_128 = V_171 -> V_172 ;
if ( V_173 ) {
F_123 ( V_173 , 0 ) ;
