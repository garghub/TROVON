...
V_2 -> V_5 = V_5 ;
V_2 -> V_87 = V_87 ;
V_2 -> V_114 = F_60 ( & V_107 -> V_7 , V_111 ) ;
if ( F_61 ( V_2 -> V_114 ) )
return F_62 ( V_2 -> V_114 ) ;
V_2 -> V_105 = F_63 ( & V_107 -> V_7 , NULL ) ;
if ( F_61 ( V_2 -> V_105 ) ) {
F_3 ( & V_107 -> V_7 , L_18 ) ;
return F_62 ( V_2 -> V_105 ) ;
}
V_5 -> V_115 = V_107 -> V_115 ;
V_5 -> V_116 . V_117 = V_118 ;
V_5 -> V_119 = F_41 ;
V_5 -> V_120 = F_44 ;
V_5 -> V_7 . V_8 = & V_107 -> V_7 ;
V_5 -> V_40 = V_2 -> V_16 ;
V_5 -> V_121 = sizeof( V_2 -> V_16 [ 0 ] ) ;
V_5 -> V_47 = F_15 ( V_2 -> V_16 ) ;
F_64 ( V_5 , V_2 ) ;
V_5 -> V_122 [ 0 ] = F_65 ( V_123 ) | F_65 ( V_124 ) ;
F_66 ( V_5 , V_75 , V_76 ) ;
if ( V_4 ) {
error = F_17 ( V_2 ) ;
} else {
...
V_2 -> V_74 = F_67 ( V_4 -> V_15 ) ;
if ( ( V_4 -> V_41 && V_2 -> V_43 [ 0 ] != - 1 ) ||
( V_4 -> V_42 && V_2 -> V_43 [ 1 ] != - 1 ) ) {
V_5 -> V_122 [ 0 ] |= F_65 ( V_125 ) ;
}
error = F_68 ( & V_107 -> V_7 , V_87 , F_36 ,
0 , V_107 -> V_115 , V_2 ) ;
if ( error ) {
F_3 ( & V_107 -> V_7 , L_20 ) ;
return error ;
