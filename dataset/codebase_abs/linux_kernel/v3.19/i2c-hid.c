...
T_3 V_65 )
{
struct V_79 * V_68 = V_74 -> V_75 ;
struct V_1 * V_2 = V_68 -> V_80 ;
struct V_10 * V_11 = F_2 ( V_2 ) ;
unsigned int V_54 , V_64 ;
V_54 = F_23 ( V_74 ) ;
if ( F_11 ( V_2 ,
V_74 -> type == V_81 ? 0x03 : 0x01 ,
V_74 -> V_82 , V_78 , V_54 ) )
return;
F_3 ( V_11 , L_13 , V_54 , V_54 , V_78 ) ;
...
static void F_26 ( struct V_79 * V_68 )
{
struct V_73 * V_74 ;
struct V_1 * V_2 = V_68 -> V_80 ;
struct V_10 * V_11 = F_2 ( V_2 ) ;
T_1 * V_66 = F_27 ( V_11 -> V_65 , V_83 ) ;
if ( ! V_66 ) {
F_13 ( & V_2 -> V_45 , L_15 ) ;
return;
}
...
F_24 ( V_74 , V_66 , V_11 -> V_65 ) ;
F_30 ( & V_2 -> V_45 ) ;
F_31 ( V_66 ) ;
}
static void F_32 ( struct V_79 * V_68 , unsigned int type ,
unsigned int * V_84 )
{
struct V_73 * V_74 ;
unsigned int V_54 ;
...
sizeof( V_88 ) +
V_86 ;
V_11 -> V_66 = F_27 ( V_86 , V_83 ) ;
V_11 -> V_85 = F_27 ( V_86 , V_83 ) ;
V_11 -> V_47 = F_27 ( V_7 , V_83 ) ;
V_11 -> V_13 = F_27 ( sizeof( union V_4 ) + V_7 , V_83 ) ;
if ( ! V_11 -> V_66 || ! V_11 -> V_85 || ! V_11 -> V_47 || ! V_11 -> V_13 ) {
F_33 ( V_11 ) ;
return - V_89 ;
}
V_11 -> V_65 = V_86 ;
...
static int F_35 ( struct V_79 * V_68 ,
...
if ( V_92 == V_95 )
return - V_96 ;
V_94 = F_36 ( V_91 + 2 , ( T_3 ) V_11 -> V_65 ) ;
V_14 = F_11 ( V_2 ,
V_92 == V_81 ? 0x03 : 0x01 ,
V_90 , V_11 -> V_85 , V_94 ) ;
if ( V_14 < 0 )
return V_14 ;
V_93 = V_11 -> V_85 [ 0 ] | ( V_11 -> V_85 [ 1 ] << 8 ) ;
if ( V_93 <= 2 )
return 0 ;
V_93 = F_36 ( V_93 , V_94 ) ;
V_91 = F_36 ( V_91 , V_93 - 2 ) ;
memcpy ( V_34 , V_11 -> V_85 + 2 , V_91 ) ;
return V_91 ;
}
static int F_37 ( struct V_79 * V_68 , V_87 * V_34 ,
...
static int F_38 ( struct V_79 * V_68 , V_87 * V_34 ,
T_3 V_91 )
{
return F_37 ( V_68 , V_34 , V_91 , V_95 ,
false ) ;
}
static int F_39 ( struct V_79 * V_68 , unsigned char V_98 ,
...
static int F_40 ( struct V_79 * V_68 )
{
struct V_1 * V_2 = V_68 -> V_80 ;
struct V_10 * V_11 = F_2 ( V_2 ) ;
...
static int F_45 ( struct V_79 * V_68 )
{
struct V_1 * V_2 = V_68 -> V_80 ;
struct V_10 * V_11 = F_2 ( V_2 ) ;
int V_14 ;
unsigned int V_65 = V_110 ;
F_32 ( V_68 , V_69 , & V_65 ) ;
F_32 ( V_68 , V_95 , & V_65 ) ;
F_32 ( V_68 , V_81 , & V_65 ) ;
if ( V_65 > V_11 -> V_65 ) {
...
static void F_46 ( struct V_79 * V_68 )
{
V_68 -> V_113 = 0 ;
}
static int F_47 ( struct V_79 * V_68 )
{
struct V_1 * V_2 = V_68 -> V_80 ;
struct V_10 * V_11 = F_2 ( V_2 ) ;
int V_14 = 0 ;
...
static void F_50 ( struct V_79 * V_68 )
{
struct V_1 * V_2 = V_68 -> V_80 ;
struct V_10 * V_11 = F_2 ( V_2 ) ;
F_48 ( & V_114 ) ;
...
static int F_51 ( struct V_79 * V_68 , int V_117 )
{
struct V_1 * V_2 = V_68 -> V_80 ;
struct V_10 * V_11 = F_2 ( V_2 ) ;
...
V_11 = F_27 ( sizeof( struct V_10 ) , V_83 ) ;
if ( ! V_11 )
return - V_89 ;
if ( V_2 -> V_45 . V_139 ) {
