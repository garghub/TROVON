...
F_59 ( V_9 -> V_42 , V_104 ,
F_60 ( V_42 -> V_101 -> V_105 -> V_96 ) ) )
goto V_92;
}
#endif
}
if ( V_42 -> V_106 &&
F_59 ( V_9 -> V_42 , V_107 , F_60 ( V_42 -> V_106 ) ) )
goto V_92;
if ( V_70 && V_42 -> V_100 &&
...
V_62 = F_62 ( V_42 , V_111 . V_112 ) ;
if ( V_62 > 0 ) {
V_111 . V_113 = F_56 ( V_62 ) ;
if ( F_57 ( V_9 -> V_42 , V_114 , sizeof( V_111 ) , & V_111 ) )
goto V_92;
}
}
if ( V_70 && F_63 ( V_42 ) ) {
if ( F_64 ( V_9 -> V_42 , V_115 , F_56 ( V_42 -> V_100 -> type ) ) ||
F_64 ( V_9 -> V_42 , V_116 ,
F_56 ( V_42 -> V_100 -> V_117 ) ) )
goto V_92;
V_81 = F_65 ( V_42 ) ;
...
if ( V_42 -> V_121 . V_122 ) {
struct V_123 V_124 ;
struct V_125 V_126 = F_66 ( V_42 -> V_121 ) ;
V_124 . V_127 = F_67 ( V_126 . V_128 ) ;
V_124 . V_129 = F_67 ( V_126 . V_130 ) ;
if ( F_57 ( V_9 -> V_42 , V_131 , sizeof( V_124 ) , & V_124 ) )
goto V_92;
}
V_80 = V_42 -> V_80 ;
...
T_6 V_139 = F_60 ( F_69 ( V_17 , V_137 -> V_140 ) ) ;
T_6 V_141 = F_60 ( F_70 ( V_17 , V_137 -> V_142 ) ) ;
F_71 ( & V_80 -> V_134 ) ;
if ( F_59 ( V_9 -> V_42 , V_143 , V_139 ) ||
F_59 ( V_9 -> V_42 , V_144 , V_141 ) )
goto V_92;
} else
F_71 ( & V_80 -> V_134 ) ;
}
if ( ( V_9 -> V_52 & V_145 ) &&
F_59 ( V_9 -> V_42 , V_146 , F_60 ( V_9 -> V_147 ++ ) ) )
goto V_92;
if ( ( V_9 -> V_52 & V_148 ) &&
F_59 ( V_9 -> V_42 , V_149 ,
F_60 ( F_72 ( & log -> V_150 ) ) ) )
...
struct V_151 * V_152 ;
int V_153 = F_73 ( V_66 ) ;
if ( F_50 ( V_9 -> V_42 ) < F_74 ( V_66 ) )
goto V_92;
V_152 = (struct V_151 * ) F_75 ( V_9 -> V_42 , F_74 ( V_66 ) ) ;
V_152 -> V_154 = V_155 ;
V_152 -> V_156 = V_153 ;
if ( F_76 ( V_42 , 0 , F_77 ( V_152 ) , V_66 ) )
F_78 () ;
}
V_59 -> V_157 = V_9 -> V_42 -> V_78 - V_77 ;
return 0 ;
V_92:
F_79 ( V_158 L_2 ) ;
return - 1 ;
...
if ( V_72 )
V_73 = strlen ( V_72 ) + 1 ;
V_153 = F_81 ( sizeof( struct V_61 ) )
+ F_74 ( sizeof( struct V_74 ) )
+ F_74 ( sizeof( T_3 ) )
+ F_74 ( sizeof( T_3 ) )
#if F_58 ( V_94 )
+ F_74 ( sizeof( T_3 ) )
...
+ F_74 ( sizeof( T_3 ) )
+ F_74 ( V_73 )
+ F_74 ( sizeof( struct V_110 ) )
+ F_74 ( sizeof( struct V_123 ) )
+ F_74 ( sizeof( struct V_61 ) ) ;
if ( V_159 && F_63 ( V_42 ) ) {
V_153 += F_74 ( V_42 -> V_100 -> V_117 )
+ F_74 ( sizeof( T_2 ) )
+ F_74 ( sizeof( T_2 ) ) ;
}
F_21 ( & V_9 -> V_26 ) ;
if ( V_9 -> V_52 & V_145 )
V_153 += F_74 ( sizeof( T_3 ) ) ;
if ( V_9 -> V_52 & V_148 )
V_153 += F_74 ( sizeof( T_3 ) ) ;
V_31 = V_9 -> V_31 ;
...
if ( V_9 -> V_42 && V_153 > F_50 ( V_9 -> V_42 ) ) {
F_35 ( V_9 ) ;
}
if ( ! V_9 -> V_42 ) {
...
if ( V_175 == V_178 && V_56 -> V_89 == V_179 ) {
int V_180 ;
F_21 ( & log -> V_19 ) ;
...
static int
F_86 ( struct V_79 * V_184 , struct V_53 * V_42 ,
const struct V_58 * V_59 ,
const struct V_151 * const V_185 [] )
{
return - V_186 ;
}
static int
F_87 ( struct V_79 * V_184 , struct V_53 * V_42 ,
const struct V_58 * V_59 ,
const struct V_151 * const V_187 [] )
{
...
return F_111 ( V_215 , L_3 ,
V_9 -> V_4 ,
V_9 -> V_30 , V_9 -> V_57 ,
V_9 -> V_37 , V_9 -> V_39 ,
V_9 -> V_33 , F_112 ( & V_9 -> V_11 ) ) ;
}
static int F_113 ( struct V_218 * V_218 , struct V_136 * V_136 )
{
return F_114 ( V_218 , V_136 , & V_219 ,
sizeof( struct V_209 ) ) ;
}
