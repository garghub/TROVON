...
V_14 = V_25 + V_6 * V_31 ;
if ( F_10 ( * V_24 ) || F_11 ( * V_24 ) || F_12 ( * V_24 ) )
F_3 ( V_2 , V_14 , 3 , F_13 ( * V_24 ) ) ;
else
F_5 ( V_2 , V_24 , V_14 ) ;
}
}
static void F_14 ( struct V_1 * V_2 , T_6 * V_32 , unsigned long V_25 )
{
T_5 * V_29 = F_15 ( V_32 , 0 ) ;
unsigned long V_14 ;
unsigned V_6 ;
for ( V_6 = 0 ; V_6 < V_33 ; V_6 ++ , V_29 ++ ) {
V_14 = V_25 + V_6 * V_34 ;
if ( F_16 ( * V_29 ) || F_17 ( * V_29 ) || F_18 ( * V_29 ) )
F_3 ( V_2 , V_14 , 2 , F_19 ( * V_29 ) ) ;
else
F_8 ( V_2 , V_29 , V_14 ) ;
}
}
static void F_20 ( struct V_1 * V_2 , struct V_35 * V_36 , unsigned long V_25 )
{
T_6 * V_32 = F_21 ( V_36 , 0UL ) ;
unsigned V_6 ;
unsigned long V_14 ;
for ( V_6 = 0 ; V_6 < V_37 ; V_6 ++ , V_32 ++ ) {
V_14 = V_25 + V_6 * V_38 ;
if ( F_22 ( * V_32 ) || F_23 ( * V_32 ) )
F_3 ( V_2 , V_14 , 1 , F_24 ( * V_32 ) ) ;
else
F_14 ( V_2 , V_32 , V_14 ) ;
}
}
static int F_25 ( struct V_39 * V_40 , void * V_41 )
{
struct V_1 V_2 = {
. V_13 = V_40 ,
. V_20 = V_42 ,
...
static int F_26 ( struct V_45 * V_45 , struct V_46 * V_46 )
{
return F_27 ( V_46 , F_25 , NULL ) ;
}
static int F_28 ( void )
{
struct V_47 * V_48 ;
unsigned V_6 , V_49 ;
for ( V_6 = 0 ; V_6 < F_29 ( V_18 ) ; V_6 ++ )
if ( V_18 [ V_6 ] . V_4 )
for ( V_49 = 0 ; V_49 < V_18 [ V_6 ] . V_5 ; V_49 ++ )
V_18 [ V_6 ] . V_9 |= V_18 [ V_6 ] . V_4 [ V_49 ] . V_9 ;
V_42 [ V_50 ] . V_19 =
( unsigned long ) F_30 ( V_51 ) ;
V_42 [ V_52 ] . V_19 =
( unsigned long ) F_30 ( V_53 ) ;
V_48 = F_31 ( L_7 , 0400 , NULL , NULL ,
& V_54 ) ;
return V_48 ? 0 : - V_55 ;
}
