...
struct V_28 * V_29 = V_28 ( V_3 ) ;
unsigned long V_30 ;
struct V_31 * V_32 ;
int V_33 , V_34 ;
unsigned int V_35 ;
F_18 ( sizeof( struct V_31 ) !=
sizeof( unsigned long ) ) ;
V_34 = F_19 ( V_3 , V_29 , V_27 ) ;
if ( V_34 != 0 )
return V_34 ;
...
static void F_24 ( int V_33 , unsigned long V_24 )
{
unsigned long V_30 ;
struct V_31 * V_32 ;
F_18 ( sizeof( struct V_31 ) !=
...
static int
F_25 ( struct V_1 * V_2 , const struct V_26 * V_50 ,
bool V_52 )
{
struct V_28 * V_29 = F_26 ( V_2 ) ;
unsigned int V_35 ;
...
unsigned long V_24 , int V_25 )
{
int V_54 , V_3 = F_29 ( F_6 ( V_23 ) ) ;
if ( ! V_3 )
return - V_55 ;
V_54 = F_16 ( V_21 , V_3 , V_22 , V_23 , V_24 ,
V_25 ) ;
if ( V_54 == V_3 )
F_4 ( V_3 , V_24 , V_23 ) ;
else
