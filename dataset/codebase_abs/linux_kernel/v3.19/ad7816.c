...
V_3 , V_20 -> V_25 ) ;
return - V_26 ;
} else if ( strcmp ( V_20 -> V_25 , L_10 ) == 0 && V_3 > 1 ) {
F_4 ( & V_2 -> V_5 -> V_9 ,
L_11 , V_3 ) ;
return - V_26 ;
} else if ( strcmp ( V_20 -> V_25 , L_12 ) == 0 && V_3 > 0 ) {
F_4 ( & V_2 -> V_5 -> V_9 ,
L_13 , V_3 ) ;
return - V_26 ;
}
...
F_30 ( V_2 -> V_13 ) ;
V_20 -> V_25 = F_29 ( V_5 ) -> V_25 ;
V_20 -> V_9 . V_44 = & V_5 -> V_9 ;
V_20 -> V_45 = & V_46 ;
V_20 -> V_47 = V_48 ;
if ( V_5 -> V_32 ) {
V_6 = F_31 ( & V_5 -> V_9 , V_5 -> V_32 ,
NULL ,
& F_19 ,
V_49 | V_50 ,
V_20 -> V_25 ,
