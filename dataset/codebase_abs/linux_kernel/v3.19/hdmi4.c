...
static int F_94 ( struct V_75 * V_3 )
{
int V_1 ;
int V_6 ;
V_2 . V_3 = V_3 ;
...
if ( V_1 )
return V_1 ;
V_1 = F_98 ( V_3 , & V_2 . V_38 , & V_2 . V_9 ) ;
if ( V_1 )
return V_1 ;
V_1 = F_99 ( V_3 , & V_2 . V_42 ) ;
if ( V_1 )
goto V_89;
V_1 = F_100 ( V_3 , & V_2 . V_47 ) ;
if ( V_1 )
goto V_89;
V_6 = F_101 ( V_3 , 0 ) ;
if ( V_6 < 0 ) {
...
static int T_4 F_107 ( struct V_75 * V_3 )
{
if ( V_2 . V_62 )
F_108 ( V_2 . V_62 ) ;
F_72 ( V_3 ) ;
...
static int F_109 ( struct V_90 * V_4 )
{
F_110 () ;
return 0 ;
}
static int F_111 ( struct V_90 * V_4 )
{
int V_1 ;
V_1 = F_112 () ;
if ( V_1 < 0 )
