...
T_1 V_52 ;
V_162 [ 0 ] = 0 ;
if ( strcmp ( V_161 -> V_172 , L_44 ) == 0 ) {
V_21 = F_25 ( V_161 , struct V_3 ,
V_173 ) ;
V_132 = F_33 ( V_162 , V_21 -> V_2 ) ;
} else if ( strcmp ( V_161 -> V_172 , L_45 ) == 0 ) {
V_21 = F_25 ( V_161 , struct V_3 ,
V_174 ) ;
for ( V_52 = 0 ; V_52 < V_171 ; V_52 ++ ) {
V_170 [ V_52 ] =
( char ) V_21 -> V_24 . V_175 [ V_52 ] ;
if ( V_21 -> V_24 . V_175 [ V_52 ] == 0 )
break;
}
V_170 [ V_171 - 1 ] = 0x0 ;
V_132 = F_40 ( V_162 , V_170 ) ;
} else {
V_21 = F_25 ( V_161 , struct V_3 ,
V_164 ) ;
F_36 ( V_162 , L_46 ,
...
V_21 -> V_7 -> V_183 ) ) ;
F_34 ( V_162 , L_68 ,
V_181 -> V_184 ( V_21 -> V_7 -> V_183 ) ) ;
F_36 ( V_162 , L_69 ,
V_181 -> V_185 (
V_21 -> V_7 -> V_183 ,
V_186 ) ) ;
}
V_132 = F_36 ( V_162 , L_70 ,
F_41 ( 0 ) / 1000 ) ;
}
return V_132 ;
}
static void F_42 ( struct V_158 * V_159 , struct V_160 * V_161 )
{
F_43 ( V_159 , V_161 ) ;
F_44 ( V_159 ) ;
F_45 ( V_159 ) ;
}
static void F_46 ( struct V_3 * V_21 )
{
struct V_105 * V_104 ;
struct V_80 * V_79 ;
struct V_59 * V_58 ;
...
if ( V_21 -> V_190 ) {
F_43 ( V_21 -> V_190 , & V_21 -> V_173 ) ;
F_43 ( V_21 -> V_190 , & V_21 -> V_174 ) ;
F_43 ( V_21 -> V_190 , & V_21 -> V_164 ) ;
F_44 ( V_21 -> V_190 ) ;
F_45 ( V_21 -> V_190 ) ;
V_21 -> V_190 = NULL ;
}
}
static int F_47 ( struct V_3 * V_21 ,
T_1 V_81 )
{
struct V_105 * V_104 ;
struct V_80 * V_79 ;
...
F_13 ( ! V_21 ) ;
F_13 ( V_21 -> V_190 ) ;
V_21 -> V_190 = F_18 ( V_21 -> V_190 ) ;
if ( ! V_21 -> V_190 )
return - V_62 ;
V_132 = F_48 ( V_21 -> V_190 , & V_191 ,
V_140 . V_192 , L_71 , V_81 ) ;
if ( V_132 < 0 )
return V_132 ;
V_21 -> V_189 = F_49 ( L_72 , V_21 -> V_190 ) ;
if ( ! V_21 -> V_189 )
return - V_62 ;
V_21 -> V_188 = F_49 ( L_73 , V_21 -> V_190 ) ;
if ( ! V_21 -> V_188 )
return - V_62 ;
V_21 -> V_187 = F_49 ( L_74 , V_21 -> V_190 ) ;
if ( ! V_21 -> V_187 )
return - V_62 ;
V_21 -> V_173 . V_172 = L_44 ;
V_21 -> V_173 . V_193 = V_194 ;
F_50 ( & V_21 -> V_173 ) ;
V_21 -> V_174 . V_172 = L_45 ;
V_21 -> V_174 . V_193 = V_194 ;
F_50 ( & V_21 -> V_174 ) ;
V_21 -> V_164 . V_172 = L_75 ;
V_21 -> V_164 . V_193 = V_194 ;
F_50 ( & V_21 -> V_164 ) ;
V_132 = F_51 ( V_21 -> V_190 , & V_21 -> V_173 ) ;
if ( V_132 < 0 )
return V_132 ;
V_132 = F_51 ( V_21 -> V_190 , & V_21 -> V_174 ) ;
if ( V_132 < 0 )
return V_132 ;
V_132 = F_51 ( V_21 -> V_190 , & V_21 -> V_164 ) ;
if ( V_132 < 0 )
return V_132 ;
V_52 = 0 ;
F_3 (mem, &dev->mem_props, list) {
V_58 -> V_159 = F_52 ( sizeof( struct V_158 ) , V_195 ) ;
if ( ! V_58 -> V_159 )
return - V_62 ;
V_132 = F_48 ( V_58 -> V_159 , & V_196 ,
V_21 -> V_189 , L_71 , V_52 ) ;
if ( V_132 < 0 )
return V_132 ;
V_58 -> V_161 . V_172 = L_75 ;
V_58 -> V_161 . V_193 = V_194 ;
F_50 ( & V_58 -> V_161 ) ;
V_132 = F_51 ( V_58 -> V_159 , & V_58 -> V_161 ) ;
if ( V_132 < 0 )
return V_132 ;
V_52 ++ ;
}
V_52 = 0 ;
F_3 (cache, &dev->cache_props, list) {
V_79 -> V_159 = F_52 ( sizeof( struct V_158 ) , V_195 ) ;
if ( ! V_79 -> V_159 )
return - V_62 ;
V_132 = F_48 ( V_79 -> V_159 , & V_92 ,
V_21 -> V_188 , L_71 , V_52 ) ;
if ( V_132 < 0 )
return V_132 ;
V_79 -> V_161 . V_172 = L_75 ;
V_79 -> V_161 . V_193 = V_194 ;
F_50 ( & V_79 -> V_161 ) ;
V_132 = F_51 ( V_79 -> V_159 , & V_79 -> V_161 ) ;
if ( V_132 < 0 )
return V_132 ;
V_52 ++ ;
}
V_52 = 0 ;
F_3 (iolink, &dev->io_link_props, list) {
V_104 -> V_159 = F_52 ( sizeof( struct V_158 ) , V_195 ) ;
if ( ! V_104 -> V_159 )
return - V_62 ;
V_132 = F_48 ( V_104 -> V_159 , & V_165 ,
V_21 -> V_187 , L_71 , V_52 ) ;
if ( V_132 < 0 )
return V_132 ;
V_104 -> V_161 . V_172 = L_75 ;
V_104 -> V_161 . V_193 = V_194 ;
F_50 ( & V_104 -> V_161 ) ;
V_132 = F_51 ( V_104 -> V_159 , & V_104 -> V_161 ) ;
if ( V_132 < 0 )
return V_132 ;
V_52 ++ ;
}
...
if ( ! V_140 . V_197 )
return - V_62 ;
V_132 = F_48 ( V_140 . V_197 ,
& V_198 , & V_199 -> V_159 ,
L_77 ) ;
if ( V_132 < 0 )
return V_132 ;
V_140 . V_192 = F_49 ( L_78 ,
V_140 . V_197 ) ;
if ( ! V_140 . V_192 )
return - V_62 ;
V_140 . V_163 . V_172 = L_79 ;
V_140 . V_163 . V_193 = V_194 ;
F_50 ( & V_140 . V_163 ) ;
V_132 = F_51 ( V_140 . V_197 ,
& V_140 . V_163 ) ;
if ( V_132 < 0 )
return V_132 ;
V_140 . V_164 . V_172 = L_80 ;
V_140 . V_164 . V_193 = V_194 ;
F_50 ( & V_140 . V_164 ) ;
V_132 = F_51 ( V_140 . V_197 ,
& V_140 . V_164 ) ;
if ( V_132 < 0 )
...
V_157 = 0 ;
memset ( & V_140 , 0 , sizeof( V_140 ) ) ;
V_132 = F_6 ( V_10 , & V_200 ) ;
if ( V_132 == 0 && V_200 > 0 ) {
F_14 ( L_81 , V_200 ) ;
V_10 = F_59 ( V_200 , V_195 ) ;
if ( ! V_10 ) {
V_132 = - V_62 ;
F_11 ( L_82 ) ;
goto V_19;
...
static T_1 F_64 ( struct V_1 * V_7 )
{
T_1 V_201 ;
T_1 V_202 [ 7 ] ;
int V_52 ;
if ( ! V_7 )
return 0 ;
V_202 [ 0 ] = V_7 -> V_9 -> V_203 ;
V_202 [ 1 ] = V_7 -> V_9 -> V_204 ;
V_202 [ 2 ] = V_7 -> V_9 -> V_205 ;
V_202 [ 3 ] = V_7 -> V_9 -> V_5 ;
V_202 [ 4 ] = V_7 -> V_9 -> V_206 -> V_207 ;
V_202 [ 5 ] = ( T_1 ) ( V_181 -> V_184 ( V_7 -> V_183 ) & 0xffffffff ) ;
V_202 [ 6 ] = ( T_1 ) ( V_181 -> V_184 ( V_7 -> V_183 ) >> 32 ) ;
for ( V_52 = 0 , V_201 = 0 ; V_52 < 7 ; V_52 ++ )
V_201 ^= F_65 ( V_202 [ V_52 ] , V_208 ) ;
return V_201 ;
}
static struct V_3 * F_66 ( struct V_1 * V_7 )
{
struct V_3 * V_21 ;
...
static void F_67 ( T_1 V_2 , int V_210 )
{
}
int F_68 ( struct V_1 * V_7 )
{
T_1 V_2 ;
struct V_3 * V_21 ;
int V_211 ;
...
V_21 -> V_2 = V_2 ;
V_7 -> V_81 = V_2 ;
V_21 -> V_24 . V_178 = V_7 -> V_9 -> V_212 ;
V_21 -> V_24 . V_179 = V_7 -> V_9 -> V_5 ;
V_21 -> V_24 . V_180 = ( V_7 -> V_9 -> V_206 -> V_207 << 24 ) +
( V_7 -> V_9 -> V_203 & 0xffffff ) ;
V_211 = 0 ;
V_19:
F_61 ( & V_6 ) ;
if ( V_211 == 0 )
