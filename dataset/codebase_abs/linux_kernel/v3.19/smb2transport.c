...
{
unsigned int V_27 , V_73 = F_29 ( V_72 -> V_74 ) ;
V_72 -> V_75 = F_30 ( V_2 ) ;
for ( V_27 = 1 ; V_27 < V_73 ; V_27 ++ )
F_31 ( V_2 ) ;
}
static struct V_76 *
F_32 ( const struct V_19 * V_77 ,
struct V_1 * V_2 )
{
struct V_76 * V_78 ;
if ( V_2 == NULL ) {
...
memset ( V_78 , 0 , sizeof( struct V_76 ) ) ;
V_78 -> V_81 = F_34 ( V_77 -> V_75 ) ;
V_78 -> V_82 = V_83 -> V_82 ;
V_78 -> V_84 = V_77 -> V_65 ;
V_78 -> V_85 = V_86 ;
V_78 -> V_2 = V_2 ;
...
static int
F_36 ( struct V_18 * V_21 , struct V_19 * V_93 ,
struct V_76 * * V_81 )
{
if ( V_21 -> V_2 -> V_59 == V_94 )
return - V_95 ;
if ( V_21 -> V_2 -> V_59 == V_96 ) {
F_4 ( V_69 , L_32 ) ;
return - V_97 ;
}
if ( V_21 -> V_98 == V_99 ) {
...
* V_81 = F_32 ( V_93 , V_21 -> V_2 ) ;
if ( * V_81 == NULL )
return - V_11 ;
F_12 ( & V_101 ) ;
F_37 ( & ( * V_81 ) -> V_102 , & V_21 -> V_2 -> V_103 ) ;
F_14 ( & V_101 ) ;
return 0 ;
}
int
F_38 ( struct V_76 * V_81 , struct V_1 * V_2 ,
bool V_104 )
{
unsigned int V_105 = F_39 ( V_81 -> V_106 ) ;
struct V_31 V_32 ;
struct V_25 V_26 = { . V_33 = & V_32 ,
. V_35 = 1 } ;
V_32 . V_37 = ( char * ) V_81 -> V_106 ;
V_32 . V_43 = F_39 ( V_81 -> V_106 ) + 4 ;
F_40 ( V_81 -> V_106 , F_41 ( V_107 , 80 , V_105 ) ) ;
if ( V_105 > 24 && V_2 -> V_108 ) {
int V_3 ;
V_3 = F_25 ( & V_26 , V_2 ) ;
if ( V_3 )
F_4 ( V_8 , L_33 ,
...
return F_42 ( V_81 -> V_106 , V_104 ) ;
}
struct V_76 *
F_43 ( struct V_18 * V_21 , struct V_25 * V_26 )
{
int V_3 ;
struct V_19 * V_72 = (struct V_19 * ) V_26 -> V_33 [ 0 ] . V_37 ;
struct V_76 * V_81 ;
F_28 ( V_21 -> V_2 , V_72 ) ;
V_3 = F_36 ( V_21 , V_72 , & V_81 ) ;
if ( V_3 )
return F_44 ( V_3 ) ;
...
struct V_76 *
F_46 ( struct V_1 * V_2 , struct V_25 * V_26 )
{
int V_3 ;
struct V_19 * V_72 = (struct V_19 * ) V_26 -> V_33 [ 0 ] . V_37 ;
struct V_76 * V_81 ;
