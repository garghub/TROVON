...
V_11 -> V_290 = & V_291 ;
V_11 -> V_292 = F_163 ( V_293 ) ;
V_11 -> V_294 = & V_295 ;
F_164 ( & V_13 -> V_152 , F_85 ) ;
...
V_281 = V_301 | V_302 ;
#endif
V_277 = F_165 ( V_11 -> V_178 , F_95 ,
V_281 , V_11 -> V_286 , V_11 ) ;
if ( V_277 )
goto V_283;
#ifdef F_49
V_13 -> V_303 = F_166 ( V_11 , F_105 ) ;
V_13 -> V_304 = F_166 ( V_11 , F_102 ) ;
V_13 -> V_82 = 0 ;
V_13 -> V_104 = 0 ;
...
if ( V_277 ) {
if ( V_13 -> V_303 != - 1 ) {
F_169 ( V_11 , V_13 -> V_303 ) ;
}
if ( V_13 -> V_304 != - 1 ) {
F_169 ( V_11 , V_13 -> V_304 ) ;
}
}
#endif
return V_277 ;
}
static int F_170 ( struct V_307 * V_308 )
{
struct V_10 * V_309 ;
struct V_310 * V_311 ;
struct V_12 * V_13 ;
...
int V_223 ;
F_6 ( V_19 , L_3 , V_20 ) ;
V_311 = F_171 ( V_308 , V_312 , 0 ) ;
if ( ! V_311 ) {
V_223 = - V_282 ;
goto V_313;
}
if ( ! F_172 ( V_311 -> V_314 , V_315 , V_61 ) ) {
V_223 = - V_316 ;
goto V_313;
}
V_309 = F_173 ( sizeof( struct V_12 ) ) ;
if ( ! V_309 ) {
V_223 = - V_317 ;
goto V_318;
}
F_174 ( V_309 , & V_308 -> V_11 ) ;
V_309 -> V_199 = ( unsigned char ) - 1 ;
V_309 -> V_178 = F_175 ( V_308 , 0 ) ;
V_13 = F_5 ( V_309 ) ;
V_13 -> V_153 = V_309 ;
#ifdef F_21
{
struct V_319 * V_320 = F_176 ( & V_308 -> V_11 ) ;
if ( ! V_320 ) {
V_223 = - V_247 ;
goto V_321;
}
...
F_180 ( V_309 ) ;
V_318:
F_181 ( V_311 -> V_314 , V_315 ) ;
V_313:
F_182 ( L_78 , V_61 , V_223 ) ;
}
#ifdef F_49
else {
...
static int F_183 ( struct V_307 * V_308 )
{
struct V_10 * V_309 = F_184 ( V_308 ) ;
struct V_12 * V_13 = F_5 ( V_309 ) ;
struct V_310 * V_311 ;
F_6 ( V_19 , V_309 , L_3 , V_20 ) ;
F_185 ( V_309 ) ;
F_186 ( V_309 -> V_178 , V_309 ) ;
#ifdef F_49
{
if ( V_13 -> V_303 != - 1 ) {
F_169 ( V_11 , V_13 -> V_303 ) ;
...
static int F_187 ( struct V_307 * V_11 , T_5 V_324 )
{
struct V_10 * V_309 = F_184 ( V_11 ) ;
struct V_12 * V_13 = F_5 ( V_309 ) ;
F_6 ( V_19 , V_309 , L_3 , V_20 ) ;
if ( V_309 ) {
if ( F_188 ( V_309 ) ) {
...
static int F_190 ( struct V_307 * V_11 )
{
struct V_10 * V_309 = F_184 ( V_11 ) ;
F_6 ( V_19 , V_309 , L_3 , V_20 ) ;
if ( V_309 ) {
