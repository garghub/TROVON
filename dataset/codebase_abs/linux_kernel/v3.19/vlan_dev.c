...
{
const struct V_17 * V_18 = V_17 ( V_4 ) ;
const struct V_176 * V_90 = V_18 -> V_34 -> V_176 ;
if ( V_90 -> V_177 ) {
return V_90 -> V_177 ( V_18 -> V_34 , V_169 ) ;
} else {
V_169 -> V_178 = V_179 |
V_180 ;
V_169 -> V_181 = - 1 ;
...
static struct V_182 * F_89 ( struct V_3 * V_4 , struct V_182 * V_42 )
{
struct V_41 * V_81 ;
T_3 V_183 = 0 , V_46 = 0 ;
int V_163 ;
...
unsigned int V_189 ;
V_81 = F_91 ( V_17 ( V_4 ) -> V_41 , V_163 ) ;
do {
V_189 = F_92 ( & V_81 -> V_43 ) ;
V_184 = V_81 -> V_190 ;
V_185 = V_81 -> V_191 ;
V_186 = V_81 -> V_192 ;
V_187 = V_81 -> V_44 ;
V_188 = V_81 -> V_45 ;
} while ( F_93 ( & V_81 -> V_43 , V_189 ) );
V_42 -> V_190 += V_184 ;
V_42 -> V_191 += V_185 ;
V_42 -> V_193 += V_186 ;
V_42 -> V_44 += V_187 ;
...
static int F_95 ( struct V_3 * V_4 , struct V_194 * V_195 )
{
struct V_17 * V_18 = V_17 ( V_4 ) ;
struct V_3 * V_34 = V_18 -> V_34 ;
struct V_35 * V_35 ;
int V_72 = 0 ;
V_35 = F_96 ( sizeof( * V_35 ) , V_63 ) ;
V_72 = - V_161 ;
if ( ! V_35 )
goto V_75;
V_72 = F_97 ( V_35 , V_34 ) ;
