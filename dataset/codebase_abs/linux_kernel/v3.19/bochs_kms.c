...
F_4 ( V_2 , 0 , 0 , V_13 ) ;
if ( V_33 ) {
F_21 ( & V_15 -> V_36 -> V_37 , V_35 ) ;
F_22 ( V_15 -> V_36 , - 1 , V_33 ) ;
F_23 ( & V_15 -> V_36 -> V_37 , V_35 ) ;
}
return 0 ;
}
static void F_24 ( struct V_38 * V_36 )
{
...
static void F_30 ( struct V_42 * V_43 , int V_44 )
{
}
...
static void F_33 ( struct V_38 * V_36 )
{
struct V_14 * V_15 = V_36 -> V_39 ;
...
int F_36 ( struct V_49 * V_50 )
{
int V_51 ;
V_51 = F_37 ( V_50 , 8192 , 8192 ) ;
F_38 ( V_50 , V_52 , V_53 ) ;
return V_51 ;
}
...
if ( V_59 )
return F_41 ( V_50 -> V_36 , V_59 ) ;
return NULL ;
}
static enum V_61 F_42 ( struct V_49
* V_50 , bool V_62 )
{
return V_63 ;
}
static void F_43 ( struct V_38 * V_36 )
{
struct V_14 * V_15 = V_36 -> V_39 ;
