...
F_81 ( V_6 -> V_153 ) ;
if ( V_154 )
F_82 ( V_94 -> V_152 , V_94 ) ;
else
F_83 ( V_94 -> V_152 , NULL ) ;
}
...
static int F_86 ( struct V_114 * V_64 , struct V_5 * V_6 )
{
...
static inline void F_88 ( struct V_93 * V_94 ,
int V_152 , const bool V_80 )
{
struct V_5 * V_6 ;
struct V_60 * V_61 ;
unsigned V_52 ;
V_6 = F_89 ( V_94 , struct V_5 , V_95 ) ;
F_90 (pos, &pcs->irqs) {
struct V_161 * V_162 ;
unsigned V_163 ;
...
{
struct V_93 * V_94 = F_94 ( V_166 ) ;
F_88 ( V_94 , V_166 -> V_152 , false ) ;
}
static void F_95 ( struct V_165 * V_166 )
{
struct V_93 * V_94 = F_94 ( V_166 ) ;
F_88 ( V_94 , V_166 -> V_152 , true ) ;
}
static int F_96 ( struct V_165 * V_166 , unsigned int V_167 )
{
if ( V_167 )
F_95 ( V_166 ) ;
else
...
static T_5 F_100 ( int V_152 , void * V_166 )
{
struct V_93 * V_94 = V_166 ;
return F_97 ( V_94 ) ? V_171 : V_172 ;
}
static void F_101 ( unsigned int V_152 , struct V_173 * V_100 )
{
struct V_93 * V_94 = F_102 ( V_100 ) ;
struct V_174 * V_175 ;
V_175 = F_103 ( V_152 ) ;
F_104 ( V_175 , V_100 ) ;
F_97 ( V_94 ) ;
...
static int F_106 ( struct V_176 * V_166 , unsigned int V_152 ,
T_6 V_170 )
{
...
F_113 ( & V_6 -> V_178 ) ;
V_6 -> V_175 . V_14 = V_14 ;
V_6 -> V_175 . V_182 = F_93 ;
V_6 -> V_175 . V_183 = F_93 ;
V_6 -> V_175 . V_184 = F_95 ;
V_6 -> V_175 . V_185 = F_96 ;
if ( V_154 ) {
int V_103 ;
V_103 = F_114 ( V_94 -> V_152 , F_100 ,
V_186 | V_187 ,
V_14 , V_94 ) ;
if ( V_103 ) {
V_94 -> V_152 = - 1 ;
...
static int F_120 ( struct V_189 * V_190 )
{
struct V_5 * V_6 ;
V_6 = F_118 ( V_190 ) ;
if ( ! V_6 )
...
{
struct V_114 * V_115 = V_190 -> V_12 . V_191 ;
const struct V_192 * V_193 ;
struct V_194 * V_195 ;
struct V_196 * V_103 ;
struct V_5 * V_6 ;
const struct V_93 * V_197 ;
int V_73 ;
V_193 = F_123 ( V_198 , & V_190 -> V_12 ) ;
if ( ! V_193 )
return - V_17 ;
V_6 = F_53 ( & V_190 -> V_12 , sizeof( * V_6 ) , V_112 ) ;
if ( ! V_6 ) {
F_17 ( & V_190 -> V_12 , L_31 ) ;
return - V_101 ;
}
V_6 -> V_12 = & V_190 -> V_12 ;
F_124 ( & V_6 -> V_53 ) ;
...
V_197 = V_193 -> V_63 ;
V_6 -> V_51 = V_197 -> V_51 ;
memcpy ( & V_6 -> V_95 , V_197 , sizeof( * V_197 ) ) ;
F_126 ( L_32 , & V_6 -> V_24 ,
L_33 ) ;
V_73 = F_127 ( V_115 , L_34 ,
& V_6 -> V_47 ) ;
if ( ! V_73 ) {
V_6 -> V_199 = F_43 ( V_6 -> V_47 ) - 1 ;
V_6 -> V_200 = V_6 -> V_47 >> V_6 -> V_199 ;
} else {
V_6 -> V_47 = 0 ;
V_6 -> V_199 = 0 ;
V_6 -> V_200 = 0 ;
...
V_6 -> V_100 . V_208 = & V_209 ;
if ( V_130 )
V_6 -> V_100 . V_210 = & V_211 ;
...
if ( V_73 < 0 )
goto free;
V_6 -> V_95 . V_152 = F_136 ( V_115 , 0 ) ;
if ( V_6 -> V_95 . V_152 )
V_6 -> V_51 |= V_214 ;
V_195 = F_137 ( & V_190 -> V_12 ) ;
if ( V_195 ) {
if ( V_195 -> V_164 )
V_6 -> V_95 . V_164 = V_195 -> V_164 ;
if ( V_195 -> V_152 ) {
V_6 -> V_95 . V_152 = V_195 -> V_152 ;
V_6 -> V_51 |= V_214 ;
}
}
if ( V_215 ) {
...
static int F_139 ( struct V_189 * V_190 )
{
struct V_5 * V_6 = F_118 ( V_190 ) ;
if ( ! V_6 )
return 0 ;
F_84 ( V_6 ) ;
return 0 ;
