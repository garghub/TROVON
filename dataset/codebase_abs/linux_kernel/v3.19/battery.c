...
const char * V_133 ;
V_133 = F_44 ( V_134 ) ;
if ( V_133 && ! strncasecmp ( V_133 , L_21 , 8 ) ) {
F_45 ( F_40 , V_2 ) ;
if ( F_7 ( V_104 ,
& V_2 -> V_54 ) &&
V_2 -> V_37 ) {
...
static int F_46 ( struct V_1 * V_2 , bool V_135 )
{
...
static int F_49 ( struct V_137 * V_138 , int V_92 )
{
...
V_2 -> V_143 ,
F_8 ( V_2 ) ) ;
F_50 ( V_138 , L_39 , V_2 -> V_61 ) ;
F_50 ( V_138 , L_40 , V_2 -> V_65 ) ;
F_50 ( V_138 , L_41 , V_2 -> type ) ;
F_50 ( V_138 , L_42 , V_2 -> V_63 ) ;
V_139:
if ( V_92 )
F_50 ( V_138 , L_43 ) ;
return V_92 ;
}
static int F_51 ( struct V_137 * V_138 , int V_92 )
{
struct V_1 * V_2 = V_138 -> V_127 ;
if ( V_92 )
goto V_139;
...
static T_3 F_53 ( struct V_144 * V_144 ,
const char T_5 * V_96 ,
T_4 V_78 , T_6 * V_145 )
{
int V_92 = 0 ;
...
if ( F_54 ( V_146 , V_96 , V_78 ) ) {
V_92 = - V_77 ;
goto V_139;
}
V_146 [ V_78 ] = '\0' ;
if ( F_55 ( V_146 , 0 , & V_2 -> V_55 ) ) {
V_92 = - V_66 ;
goto V_139;
}
V_92 = F_23 ( V_2 ) ;
...
static int F_56 ( int V_149 , struct V_137 * V_138 )
{
struct V_1 * V_2 = V_138 -> V_127 ;
int V_92 = F_46 ( V_2 , false ) ;
return V_150 [ V_149 ] ( V_138 , V_92 ) ;
}
static int F_57 ( struct V_151 * V_3 )
{
...
static void F_63 ( struct V_151 * V_3 )
{
int V_74 ;
if ( ! F_59 ( V_3 ) )
return;
for ( V_74 = 0 ; V_74 < V_155 ; ++ V_74 )
F_64 ( V_156 [ V_74 ] . V_93 ,
F_59 ( V_3 ) ) ;
F_64 ( F_34 ( V_3 ) , V_154 ) ;
F_59 ( V_3 ) = NULL ;
}
static void F_65 ( struct V_151 * V_3 , T_7 V_158 )
{
...
F_48 ( V_2 ) ;
F_46 ( V_2 , false ) ;
F_67 ( V_3 -> V_162 . V_163 ,
F_68 ( & V_3 -> V_112 ) , V_158 ,
F_1 ( V_2 ) ) ;
F_69 ( V_3 , V_158 , F_1 ( V_2 ) ) ;
...
{
struct V_1 * V_2 = F_72 ( V_165 , struct V_1 ,
V_167 ) ;
int V_92 ;
switch ( V_80 ) {
case V_168 :
...
static int F_73 ( const struct V_170 * V_171 )
{
V_100 = 1 ;
return 0 ;
}
...
static int F_76 ( struct V_151 * V_3 )
{
int V_92 = 0 ;
struct V_1 * V_2 = NULL ;
if ( ! V_3 )
...
if ( V_3 -> V_173 )
return - V_174 ;
V_2 = F_77 ( sizeof( struct V_1 ) , V_175 ) ;
if ( ! V_2 )
return - V_176 ;
V_2 -> V_3 = V_3 ;
strcpy ( F_78 ( V_3 ) , V_177 ) ;
strcpy ( F_79 ( V_3 ) , V_178 ) ;
V_3 -> V_179 = V_2 ;
F_80 ( & V_2 -> V_98 ) ;
F_80 ( & V_2 -> V_124 ) ;
...
static int F_85 ( struct V_151 * V_3 )
{
struct V_1 * V_2 = NULL ;
if ( ! V_3 || ! F_62 ( V_3 ) )
return - V_66 ;
...
static int F_87 ( struct V_3 * V_112 )
{
struct V_1 * V_2 ;
if ( ! V_112 )
return - V_66 ;
...
static void T_8 F_89 ( void * V_182 , T_9 V_183 )
{
if ( V_184 )
return;
F_90 ( V_185 ) ;
