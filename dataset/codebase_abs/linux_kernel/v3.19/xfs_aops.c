...
if ( type == V_82 &&
( ! V_70 || F_46 ( V_62 -> V_83 ) ) ) {
error = F_47 ( V_11 , V_60 , V_62 ) ;
if ( ! error )
F_48 ( V_11 , V_60 , V_64 , type , V_62 ) ;
return error ;
}
#ifdef F_49
if ( type == V_48 ) {
...
T_6 V_120 = F_86 ( V_119 , V_62 -> V_86 ) ;
T_8 V_121 = F_87 ( F_6 ( V_9 ) , V_62 -> V_83 ) ;
ASSERT ( V_62 -> V_83 != V_84 ) ;
ASSERT ( V_62 -> V_83 != V_85 ) ;
...
type = V_125 ;
ASSERT ( F_51 ( V_9 , V_62 , V_60 ) ) ;
F_102 ( V_5 ) ;
if ( type != V_125 )
F_89 ( V_9 , V_5 , V_62 , V_60 ) ;
F_84 ( V_9 , V_5 , V_60 , type ,
V_127 , V_56 ) ;
V_131 -- ;
V_64 ++ ;
} else {
...
} while ( V_60 += V_130 , ( V_5 = V_5 -> V_7 ) != V_6 );
if ( V_132 && V_5 == V_6 )
F_103 ( V_1 ) ;
if ( V_64 ) {
if ( -- V_95 -> V_137 <= 0 &&
...
int V_56 = 0 , V_142 ;
F_105 ( & V_141 , 0 ) ;
while ( ! V_56 && V_126 <= V_139 ) {
unsigned V_130 = F_98 ( T_9 , V_143 , V_139 - V_126 + 1 ) ;
if ( ! F_106 ( & V_141 , V_9 -> V_135 , V_126 , V_130 ) )
break;
for ( V_142 = 0 ; V_142 < F_107 ( & V_141 ) ; V_142 ++ ) {
V_56 = F_95 ( V_9 , V_141 . V_144 [ V_142 ] , V_126 ++ ,
V_62 , V_127 , V_95 ) ;
if ( V_56 )
break;
}
...
unsigned int V_145 )
{
F_111 ( V_1 -> V_124 -> V_146 , V_1 , V_60 ,
V_145 ) ;
F_112 ( V_1 , V_60 , V_145 ) ;
}
STATIC void
F_113 (
struct V_1 * V_1 )
...
V_153 = ( V_60 - 1 ) >> V_161 ;
if ( V_1 -> V_133 < V_152 )
V_128 = ( T_6 ) ( V_1 -> V_133 + 1 ) << V_161 ;
else {
unsigned V_162 = V_60 & ( V_136 - 1 ) ;
if ( V_1 -> V_133 > V_152 ||
...
if ( V_155 )
V_155 = F_51 ( V_9 , & V_62 , V_60 ) ;
if ( ! V_155 ) {
V_163 = 1 ;
V_154 = F_41 ( V_9 , V_60 , & V_62 , type ,
V_63 ) ;
if ( V_154 )
goto error;
V_155 = F_51 ( V_9 , & V_62 , V_60 ) ;
...
if ( F_34 ( V_13 ) )
return - V_55 ;
V_60 = ( T_6 ) V_167 << V_9 -> V_65 ;
ASSERT ( V_168 -> V_106 >= ( 1 << V_9 -> V_65 ) ) ;
V_172 = V_168 -> V_106 ;
if ( ! V_169 && V_170 && V_60 >= F_119 ( V_9 ) )
return 0 ;
if ( V_169 && ! V_170 ) {
V_171 = V_44 ;
F_22 ( V_11 , V_171 ) ;
...
ASSERT ( V_60 <= V_13 -> V_79 -> V_80 ) ;
if ( V_60 + V_172 > V_13 -> V_79 -> V_80 )
V_172 = V_13 -> V_79 -> V_80 - V_60 ;
V_67 = F_43 ( V_13 , ( V_81 ) V_60 + V_172 ) ;
V_66 = F_44 ( V_13 , V_60 ) ;
error = F_45 ( V_11 , V_66 , V_67 - V_66 ,
& V_62 , & V_70 , V_69 ) ;
if ( error )
...
V_173 = 1 ;
error = F_133 ( V_11 , V_60 , V_172 , & V_62 ) ;
if ( error )
goto V_174;
F_24 ( V_11 , V_171 ) ;
}
F_134 ( V_11 , V_60 , V_172 , 0 , & V_62 ) ;
} else if ( V_70 ) {
F_135 ( V_11 , V_60 , V_172 , 0 , & V_62 ) ;
F_24 ( V_11 , V_171 ) ;
} else {
F_136 ( V_11 , V_60 , V_172 ) ;
goto V_174;
}
if ( V_62 . V_83 != V_84 &&
V_62 . V_83 != V_85 ) {
if ( V_169 || ! F_137 ( & V_62 ) )
F_85 ( V_9 , V_168 , & V_62 , V_60 ) ;
if ( V_169 && F_137 ( & V_62 ) ) {
if ( V_170 ) {
V_168 -> V_21 = V_9 ;
F_138 ( V_168 ) ;
...
if ( V_170 || V_172 > ( 1 << V_9 -> V_65 ) ) {
T_6 V_175 ;
V_175 = V_62 . V_86 + V_62 . V_87 - V_167 ;
V_175 <<= V_9 -> V_65 ;
ASSERT ( V_175 > 0 ) ;
if ( V_175 > V_172 )
V_175 = V_172 ;
if ( V_60 < F_119 ( V_9 ) &&
V_60 + V_175 >= F_119 ( V_9 ) ) {
V_175 = F_142 ( F_119 ( V_9 ) - V_60 ,
1 << V_9 -> V_65 ) ;
}
if ( V_175 > V_176 )
V_175 = V_176 ;
...
int V_169 )
{
return F_129 ( V_9 , V_167 , V_168 , V_169 , 0 ) ;
}
STATIC int
F_144 (
struct V_9 * V_9 ,
...
int V_169 )
{
return F_129 ( V_9 , V_167 , V_168 , V_169 , 1 ) ;
}
STATIC void
F_145 (
struct V_177 * V_178 ,
...
void * V_179 )
{
struct V_25 * V_18 = V_178 -> V_179 ;
if ( V_60 + V_172 > F_119 ( V_18 -> V_28 ) )
F_146 ( V_18 -> V_28 , V_60 + V_172 ) ;
V_178 -> V_179 = NULL ;
V_18 -> V_26 = V_60 ;
V_18 -> V_27 = V_172 ;
if ( V_179 && V_172 > 0 )
...
T_3 V_60 )
{
struct V_9 * V_9 = V_178 -> V_183 -> V_184 -> V_146 ;
struct V_8 * V_185 = F_5 ( V_9 ) ;
struct V_25 * V_18 = NULL ;
T_4 V_186 ;
if ( V_180 & V_99 ) {
T_12 V_172 = F_148 ( V_182 ) ;
V_178 -> V_179 = V_18 = F_37 ( V_9 , V_187 ) ;
if ( V_60 + V_172 > F_6 ( V_9 ) -> V_29 . V_30 )
V_18 -> V_51 = 1 ;
V_186 = F_149 ( V_180 , V_178 , V_9 , V_185 , V_182 ,
V_60 , F_144 ,
F_145 , NULL ,
V_188 ) ;
if ( V_186 != - V_189 && V_178 -> V_179 )
goto V_190;
} else {
V_186 = F_149 ( V_180 , V_178 , V_9 , V_185 , V_182 ,
V_60 , F_144 ,
...
T_5 V_67 ;
int error ;
V_149 = F_43 ( V_11 -> V_14 , V_191 ) ;
V_67 = F_43 ( V_11 -> V_14 , V_192 ) ;
if ( V_67 <= V_149 )
return;
F_22 ( V_11 , V_44 ) ;
...
T_3 V_195 ;
T_3 V_196 ;
T_3 V_197 = V_193 & ( V_136 - 1 ) ;
T_3 V_198 = V_197 + V_130 ;
struct V_4 * V_5 , * V_6 ;
V_194 = ( V_193 >> V_161 ) << V_161 ;
ASSERT ( V_194 + V_197 == V_193 ) ;
V_6 = F_2 ( V_1 ) ;
V_195 = 0 ;
for ( V_5 = V_6 ; V_5 != V_6 || ! V_195 ;
V_5 = V_5 -> V_7 , V_195 = V_196 ,
V_194 += V_5 -> V_106 ) {
V_196 = V_195 + V_5 -> V_106 ;
if ( V_196 <= V_197 )
continue;
if ( V_195 >= V_198 )
break;
...
void * * V_201 )
{
T_9 V_133 = V_193 >> V_161 ;
struct V_1 * V_1 ;
int V_202 ;
ASSERT ( V_130 <= V_136 ) ;
V_1 = F_157 ( V_124 , V_133 , V_157 ) ;
if ( ! V_1 )
return - V_203 ;
V_202 = F_158 ( V_1 , V_193 , V_130 , F_143 ) ;
if ( F_159 ( V_202 ) ) {
struct V_9 * V_9 = V_124 -> V_146 ;
T_12 V_43 = F_119 ( V_9 ) ;
F_151 ( V_9 , V_1 , V_193 , V_130 ) ;
F_74 ( V_1 ) ;
if ( V_193 + V_130 > V_43 ) {
T_4 V_191 = F_160 ( T_4 , V_193 , V_43 ) ;
F_161 ( V_9 , V_191 , V_193 + V_130 ) ;
}
F_162 ( V_1 ) ;
V_1 = NULL ;
}
...
int V_186 ;
ASSERT ( V_130 <= V_136 ) ;
V_186 = F_164 ( V_199 , V_124 , V_193 , V_130 , V_204 , V_1 , V_201 ) ;
if ( F_159 ( V_186 < V_130 ) ) {
struct V_9 * V_9 = V_124 -> V_146 ;
T_12 V_43 = F_119 ( V_9 ) ;
T_3 V_198 = V_193 + V_130 ;
if ( V_198 > V_43 ) {
if ( V_193 > V_43 )
V_43 = V_193 ;
F_150 ( V_9 , V_43 , V_198 ) ;
F_161 ( V_9 , V_43 , V_198 ) ;
}
}
return V_186 ;
}
...
F_167 ( V_124 ) ;
F_24 ( V_11 , V_206 ) ;
return F_168 ( V_124 , V_205 , F_143 ) ;
}
STATIC int
F_169 (
struct V_199 * V_207 ,
...
unsigned V_209 )
{
return F_172 ( V_124 , V_144 , V_209 , F_143 ) ;
}
STATIC int
F_173 (
struct V_1 * V_1 )
...
F_182 ( & V_124 -> V_212 , V_157 ) ;
F_183 ( V_124 -> V_146 , V_215 ) ;
}
return V_210 ;
}
