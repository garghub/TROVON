...
V_5 = F_12 ( V_37 , sizeof( struct V_40 ) , V_18 ) ;
if ( ! V_5 )
return - V_15 ;
V_41 = V_5 ;
F_13 ( & V_45 -> V_58 ) ;
F_14 (li, tmp, &cfile->llist->locks, llist) {
...
V_41 -> V_65 = F_17 ( V_49 -> V_51 ) ;
V_41 -> V_66 = F_17 ( V_49 -> V_59 ) ;
V_41 -> V_67 = F_18 ( V_68 ) ;
F_19 ( & V_49 -> V_64 , & V_55 ) ;
if ( ++ V_38 == V_37 ) {
V_36 = F_20 ( V_1 , V_22 ,
...
if ( V_38 ) {
V_36 = F_20 ( V_1 , V_22 , V_33 -> V_12 . V_29 ,
V_33 -> V_12 . V_30 , V_60 -> V_61 ,
V_38 , V_5 ) ;
if ( V_36 ) {
F_21 ( & V_55 , & V_33 -> V_64 -> V_69 ) ;
V_6 = V_36 ;
} else
F_22 ( & V_55 ) ;
}
...
static int
F_24 ( struct V_70 * V_71 , const unsigned int V_1 ,
...
struct V_42 * V_22 = F_9 ( V_33 -> V_43 ) ;
F_25 (li, &fdlocks->locks, llist) {
V_41 -> V_65 = F_17 ( V_49 -> V_51 ) ;
V_41 -> V_66 = F_17 ( V_49 -> V_59 ) ;
V_41 -> V_67 = F_18 ( V_49 -> type |
V_72 ) ;
if ( ++ V_38 == V_37 ) {
V_36 = F_20 ( V_1 , V_22 ,
V_33 -> V_12 . V_29 ,
...
F_25 (fdlocks, &cinode->llist, llist) {
V_36 = F_24 ( V_71 , V_1 , V_5 , V_37 ) ;
if ( V_36 )
V_6 = V_36 ;
}
F_7 ( V_5 ) ;
