...
static void F_12 ( unsigned int V_21 , struct V_25 * V_26 )
{
struct V_27 * V_28 = F_13 ( V_26 ) ;
F_14 ( F_15 ( V_28 , V_21 ) ) ;
}
static int T_3 F_16 ( struct V_29 * V_30 ,
struct V_29 * V_31 )
{
int V_32 , V_33 , V_34 = F_17 ( V_30 ) ;
struct V_35 V_36 ;
struct V_1 * V_2 ;
struct V_27 * V_28 ;
void T_4 * V_37 ;
...
if ( ! F_19 ( V_36 . V_40 , F_20 ( & V_36 ) ,
V_30 -> V_38 ) ) {
F_9 ( L_3 , V_30 -> V_38 ) ;
return - V_41 ;
}
V_37 = F_21 ( V_36 . V_40 , F_20 ( & V_36 ) ) ;
if ( ! V_37 ) {
V_33 = - V_41 ;
F_9 ( L_4 , V_30 -> V_38 ) ;
goto V_42;
...
unsigned int V_21 = F_24 ( V_30 , V_32 ) ;
F_25 ( V_21 , V_28 ) ;
F_26 ( V_21 , F_12 ) ;
}
F_1 ( V_2 , V_61 , 0 ) ;
