...
V_19 = F_14 ( V_15 , V_27 - 2 , V_18 , V_17 ) ;
V_15 [ V_19 ++ ] = '\n' ;
V_15 [ V_19 ] = '\0' ;
F_15 ( V_18 ) ;
return V_19 ;
...
{
const char * V_55 = V_9 -> V_55 ? V_9 -> V_55 : L_1 ;
...
if ( F_62 ( V_69 , L_11 , & V_9 -> V_26 ) ) {
F_42 ( V_41 , L_12 ,
V_9 -> V_10 ) ;
return F_55 ( - V_30 ) ;
}
V_9 -> V_55 = F_58 ( V_69 , L_13 , NULL ) ;
if ( F_62 ( V_69 , L_14 , & V_9 -> type ) )
V_9 -> type = V_2 ;
V_9 -> V_40 = ! ! F_58 ( V_69 , L_15 , NULL ) ;
V_9 -> V_29 = ! ! F_58 ( V_69 , L_16 , NULL ) ;
if ( F_62 ( V_69 , L_17 ,
& V_9 -> V_60 ) )
V_9 -> V_60 = 5 ;
}
...
{
struct V_56 * V_41 = & V_54 -> V_41 ;
const struct V_64 * V_23 = F_64 ( V_41 ) ;
struct V_13 * V_14 ;
struct V_33 * V_34 ;
T_4 V_78 ;
int V_20 , error ;
...
error = F_71 ( & V_54 -> V_41 . V_91 , & V_92 ) ;
if ( error ) {
F_42 ( V_41 , L_21 ,
error ) ;
return error ;
...
static int F_76 ( struct V_56 * V_41 )
{
struct V_13 * V_14 = F_77 ( V_41 ) ;
struct V_33 * V_34 = V_14 -> V_34 ;
int V_20 ;
if ( F_78 ( V_41 ) ) {
for ( V_20 = 0 ; V_20 < V_14 -> V_23 -> V_24 ; V_20 ++ ) {
...
static int F_80 ( struct V_56 * V_41 )
{
struct V_13 * V_14 = F_77 ( V_41 ) ;
struct V_33 * V_34 = V_14 -> V_34 ;
int error = 0 ;
