...
int V_3 ;
struct V_18 * V_19 = V_2 -> V_16 -> V_20 ;
if ( V_2 -> V_78 . V_79 == V_77 )
return 0 ;
switch ( V_77 ) {
case V_80 :
case V_81 :
F_4 ( V_2 , V_68 , V_82 | V_67 ) ;
break;
case V_83 :
...
return - V_48 ;
if ( F_13 ( V_19 -> V_21 ) ) {
V_86 = F_30 ( V_19 -> V_21 , V_88 ,
L_6 ) ;
if ( V_86 )
goto V_89;
}
if ( F_13 ( V_19 -> V_85 ) ) {
V_86 = F_30 ( V_19 -> V_85 , V_88 ,
L_7 ) ;
if ( V_86 )
goto V_90;
} else {
...
struct V_24 * V_25 ;
int V_86 ;
V_25 = F_35 ( & V_95 -> V_16 , sizeof( struct V_24 ) ,
V_98 ) ;
if ( V_25 == NULL )
return - V_99 ;
F_36 ( V_95 , V_25 ) ;
