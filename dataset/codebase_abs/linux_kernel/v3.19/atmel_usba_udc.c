...
static struct V_3 * F_101 ( struct V_38 * V_13 , T_7 V_189 )
{
struct V_3 * V_4 ;
if ( ( V_189 & V_117 ) == 0 )
...
static inline void F_104 ( struct V_38 * V_13 , unsigned int V_192 )
{
T_5 V_193 ;
F_46 ( V_194 , L_35 , V_192 ) ;
V_193 = F_75 ( V_13 , V_185 ) ;
V_193 = F_105 ( V_195 , V_192 , V_193 ) ;
F_74 ( V_13 , V_185 , V_193 ) ;
}
...
struct V_3 * V_4 ;
struct V_197 * V_62 = & V_13 -> V_61 -> V_62 ;
int V_198 ;
V_198 = V_13 -> V_198 ;
F_100 ( V_13 ) ;
switch ( V_198 ) {
...
static inline bool F_108 ( struct V_207 * V_208 )
{
if ( V_208 -> V_209 == F_109 ( V_184 ) )
return true ;
return false ;
}
static inline bool F_110 ( struct V_207 * V_208 )
{
if ( V_208 -> V_209 == F_109 ( V_210 ) )
return true ;
return false ;
}
static inline bool F_111 ( struct V_207 * V_208 )
{
if ( V_208 -> V_209 == F_109 ( V_211 ) )
return true ;
return false ;
}
...
== ( V_190 | V_218 ) ) {
struct V_3 * V_219 ;
V_219 = F_101 ( V_13 , F_113 ( V_208 -> V_189 ) ) ;
if ( ! V_219 )
goto V_220;
V_34 = 0 ;
if ( F_103 ( V_13 , V_219 ) )
...
goto V_221;
if ( V_208 -> V_222 != F_109 ( sizeof( V_34 ) ) )
goto V_220;
V_4 -> V_59 = V_168 ;
F_114 ( V_34 , V_4 -> V_83 ) ;
F_48 ( V_4 , V_84 , V_85 ) ;
...
F_113 ( V_208 -> V_209 ) , F_113 ( V_208 -> V_189 ) ,
F_113 ( V_208 -> V_222 ) ) ;
F_102 ( V_13 , V_4 ) ;
return - 1 ;
}
...
V_41 = - 1 ;
if ( V_4 -> V_118 == 0 )
V_41 = F_112 ( V_13 , V_4 , & V_208 . V_208 ) ;
else {
F_60 ( & V_13 -> V_14 ) ;
...
F_113 ( V_208 . V_208 . V_222 ) , V_4 -> V_59 , V_41 ) ;
if ( V_41 < 0 ) {
F_102 ( V_13 , V_4 ) ;
}
}
...
static T_9 F_121 ( int V_246 , void * V_247 )
{
...
F_100 ( V_13 ) ;
if ( V_13 -> V_66 . V_153 != V_154 && V_13 -> V_167 ) {
V_13 -> V_66 . V_153 = V_154 ;
F_60 ( & V_13 -> V_14 ) ;
F_122 ( & V_13 -> V_66 , V_13 -> V_167 ) ;
F_62 ( & V_13 -> V_14 ) ;
}
if ( V_34 & V_260 )
V_13 -> V_66 . V_153 = V_261 ;
else
V_13 -> V_66 . V_153 = V_262 ;
F_46 ( V_194 , L_64 ,
F_123 ( V_13 -> V_66 . V_153 ) ) ;
V_73 = & V_13 -> V_3 [ 0 ] ;
V_73 -> V_4 . V_112 = & V_263 ;
V_73 -> V_59 = V_191 ;
F_48 ( V_73 , V_145 ,
( F_69 ( V_125 , V_264 )
| F_69 ( V_130 , V_131 )
...
V_4 -> V_137 = V_275 ;
V_4 -> V_54 = F_140 ( V_280 , L_73 ) ;
V_4 -> V_135 = F_140 ( V_280 , L_74 ) ;
V_41 = F_141 ( V_280 , L_75 , & V_47 ) ;
V_4 -> V_4 . V_47 = V_47 ;
...
if ( V_246 < 0 )
return V_246 ;
V_272 = F_150 ( & V_61 -> V_62 , L_77 ) ;
if ( F_34 ( V_272 ) )
return F_151 ( V_272 ) ;
V_273 = F_150 ( & V_61 -> V_62 , L_78 ) ;
if ( F_34 ( V_273 ) )
return F_151 ( V_273 ) ;
F_152 ( & V_13 -> V_14 ) ;
V_13 -> V_61 = V_61 ;
...
V_41 = F_155 ( & V_61 -> V_62 , V_246 , F_121 , 0 ,
L_84 , V_13 ) ;
if ( V_41 ) {
F_31 ( & V_61 -> V_62 , L_85 ,
V_246 , V_41 ) ;
...
V_13 -> V_246 = V_246 ;
if ( F_40 ( V_13 -> V_74 ) ) {
if ( ! F_156 ( & V_61 -> V_62 , V_13 -> V_74 , L_84 ) ) {
