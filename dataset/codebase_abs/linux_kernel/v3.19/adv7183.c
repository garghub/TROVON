...
static int F_27 ( struct V_2 * V_3 , int V_111 )
{
struct V_1 * V_16 = F_1 ( V_3 ) ;
if ( V_111 )
F_28 ( V_16 -> V_112 , 0 ) ;
...
static int F_30 ( struct V_2 * V_3 , struct V_113 * V_8 )
{
V_8 -> V_70 = F_4 ( V_3 , V_8 -> V_8 & 0xff ) ;
V_8 -> V_114 = 1 ;
return 0 ;
}
static int F_31 ( struct V_2 * V_3 , const struct V_113 * V_8 )
{
F_7 ( V_3 , V_8 -> V_8 & 0xff , V_8 -> V_70 & 0xff ) ;
return 0 ;
}
static int F_32 ( struct V_9 * V_10 ,
const struct V_115 * V_90 )
{
struct V_1 * V_16 ;
struct V_2 * V_3 ;
struct V_116 * V_7 ;
...
if ( ! F_33 ( V_10 -> V_119 , V_120 ) )
return - V_121 ;
F_34 ( V_10 , L_33 ,
V_10 -> V_122 << 1 , V_10 -> V_119 -> V_59 ) ;
V_118 = V_10 -> V_123 . V_124 ;
if ( V_118 == NULL )
return - V_69 ;
V_16 = F_35 ( & V_10 -> V_123 , sizeof( * V_16 ) , V_125 ) ;
if ( V_16 == NULL )
return - V_126 ;
V_16 -> V_127 = V_118 [ 0 ] ;
V_16 -> V_112 = V_118 [ 1 ] ;
if ( F_36 ( & V_10 -> V_123 , V_16 -> V_127 ,
V_128 , L_34 ) ) {
F_37 ( V_10 , L_35 , V_16 -> V_127 ) ;
return - V_129 ;
}
if ( F_36 ( & V_10 -> V_123 , V_16 -> V_112 ,
V_130 ,
L_36 ) ) {
F_37 ( V_10 , L_35 , V_16 -> V_112 ) ;
return - V_129 ;
}
V_3 = & V_16 -> V_3 ;
F_38 ( V_3 , V_10 , & V_131 ) ;
