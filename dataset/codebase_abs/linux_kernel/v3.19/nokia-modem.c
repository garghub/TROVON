...
if ( V_21 )
return V_21 ;
V_21 = F_20 ( V_3 -> V_13 [ V_10 ] . V_15 , 0 ) ;
if ( V_21 )
return V_21 ;
V_21 = F_21 ( V_9 , V_3 -> V_13 [ V_10 ] . V_14 ,
V_3 -> V_13 [ V_10 ] . V_15 ) ;
if ( V_21 )
return V_21 ;
}
...
static int F_22 ( struct V_4 * V_9 )
{
struct V_16 * V_17 ;
struct V_2 * V_3 ;
struct V_26 * V_27 = F_23 ( V_9 ) ;
struct V_28 * V_29 = F_24 ( V_27 ) ;
int V_6 , V_30 , V_21 ;
struct V_31 V_32 ;
V_17 = V_9 -> V_18 ;
if ( ! V_17 ) {
...
V_32 . V_39 = NULL ;
V_32 . V_40 = NULL ;
V_3 -> V_5 = F_31 ( V_29 , & V_32 ) ;
if ( ! V_3 -> V_5 ) {
F_12 ( V_9 , L_15 ) ;
goto V_41;
}
V_21 = F_32 ( & V_3 -> V_5 -> V_4 ) ;
if ( V_21 == 0 ) {
F_12 ( V_9 , L_16 ) ;
V_21 = - V_42 ;
goto V_43;
