...
{
return V_15 < V_17 -> V_153 ||
V_15 > V_17 -> V_153 + V_154 ;
}
static void F_156 ( struct V_45 * V_46 , struct V_20 * V_20 )
{
...
V_157 = * V_156 ;
V_158 = F_157 ( V_157 ) ;
if ( V_56 < F_158 ( V_158 ) -> V_55 . V_56 )
V_156 = & ( * V_156 ) -> V_160 ;
else
V_156 = & ( * V_156 ) -> V_161 ;
}
V_158 = F_70 ( V_20 , sizeof( struct V_66 ) ) ;
F_159 ( & V_158 -> V_155 , V_157 , V_156 ) ;
F_160 ( & V_158 -> V_155 , & V_46 -> V_159 ) ;
}
static void F_161 ( struct V_45 * V_46 )
{
struct V_155 * V_162 ;
struct V_66 * V_158 ;
struct V_20 * V_20 ;
for ( V_162 = F_162 ( & V_46 -> V_159 ) ; V_162 ; V_162 = F_163 ( V_162 ) ) {
V_158 = F_157 ( V_162 ) ;
V_20 = F_158 ( V_158 ) ;
F_76 ( & V_46 -> V_51 , V_20 ) ;
F_164 ( & V_158 -> V_155 , & V_46 -> V_159 ) ;
}
F_130 ( ! F_165 ( & V_46 -> V_159 ) ) ;
}
...
static int F_172 ( const void * V_166 , const void * V_167 )
{
...
static unsigned F_173 ( struct V_17 * V_17 , struct V_48 * V_49 )
{
unsigned V_111 = 0 ;
struct V_21 * V_27 , * V_40 ;
F_56 (cell, tmp, cells, user_list) {
...
F_174 ( V_17 -> V_171 , V_111 , sizeof( V_27 ) , F_172 , NULL ) ;
return V_111 ;
}
static void F_175 ( struct V_45 * V_46 )
{
struct V_17 * V_17 = V_46 -> V_17 ;
unsigned long V_47 ;
struct V_48 V_49 ;
...
static struct V_45 * F_178 ( struct V_17 * V_17 )
{
struct V_45 * V_46 = NULL ;
F_59 () ;
if ( ! F_176 ( & V_17 -> V_175 ) ) {
V_46 = F_179 ( V_17 -> V_175 . V_176 , struct V_45 , V_37 ) ;
F_180 ( V_46 ) ;
}
F_61 () ;
return V_46 ;
}
static struct V_45 * F_181 ( struct V_17 * V_17 , struct V_45 * V_46 )
{
struct V_45 * V_177 = V_46 ;
F_59 () ;
F_182 (tc, &pool->active_thins, list) {
F_180 ( V_46 ) ;
F_183 ( V_177 ) ;
F_61 () ;
return V_46 ;
...
static void F_186 ( struct V_178 * V_179 )
{
struct V_17 * V_17 = F_187 ( V_179 , struct V_17 , V_19 ) ;
F_6 ( & V_17 -> V_10 ) ;
F_170 ( V_17 -> V_96 ) ;
F_7 ( & V_17 -> V_10 ) ;
...
static void F_188 ( struct V_178 * V_179 )
{
struct V_17 * V_17 = F_187 ( F_189 ( V_179 ) , struct V_17 , V_181 ) ;
F_15 ( V_17 ) ;
F_190 ( V_17 -> V_18 , & V_17 -> V_181 , V_154 ) ;
}
static void F_191 ( struct V_178 * V_179 )
{
struct V_17 * V_17 = F_187 ( F_189 ( V_179 ) , struct V_17 ,
V_182 ) ;
if ( F_120 ( V_17 ) == V_126 && ! V_17 -> V_120 . V_138 )
F_122 ( V_17 , V_128 ) ;
}
static struct V_183 * F_192 ( struct V_178 * V_179 )
{
return F_187 ( V_179 , struct V_183 , V_19 ) ;
}
static void F_193 ( struct V_183 * V_184 )
{
F_194 ( & V_184 -> F_194 ) ;
}
static void F_195 ( struct V_183 * V_184 , struct V_17 * V_17 ,
void (* F_24)( struct V_178 * ) )
{
F_196 ( & V_184 -> V_19 , F_24 ) ;
F_197 ( & V_184 -> F_194 ) ;
F_16 ( V_17 -> V_18 , & V_184 -> V_19 ) ;
F_198 ( & V_184 -> F_194 ) ;
}
static struct V_185 * F_199 ( struct V_178 * V_179 )
{
return F_187 ( F_192 ( V_179 ) , struct V_185 , V_184 ) ;
}
static void F_200 ( struct V_178 * V_179 )
{
struct V_185 * V_186 = F_199 ( V_179 ) ;
...
struct V_185 V_186 ;
V_186 . V_46 = V_46 ;
F_195 ( & V_186 . V_184 , V_46 -> V_17 , F_24 ) ;
}
static enum V_137 F_120 ( struct V_17 * V_17 )
{
return V_17 -> V_120 . V_187 ;
}
static void F_202 ( struct V_17 * V_17 , const char * V_188 )
{
F_128 ( V_17 -> V_133 -> V_134 ) ;
F_203 ( L_13 ,
...
bool V_192 = F_204 ( V_17 -> V_96 ) ;
enum V_137 V_193 = F_120 ( V_17 ) ;
unsigned long V_182 = F_205 ( V_194 ) * V_195 ;
...
F_190 ( V_17 -> V_18 , & V_17 -> V_182 , V_182 ) ;
break;
case V_127 :
if ( V_193 != V_188 )
F_202 ( V_17 , L_18 ) ;
...
static void F_209 ( struct V_17 * V_17 )
{
...
static void F_212 ( struct V_45 * V_46 , struct V_20 * V_20 )
{
struct V_17 * V_17 = V_46 -> V_17 ;
F_11 ( & V_17 -> V_10 ) ;
F_88 ( V_46 , V_20 ) ;
...
static void F_213 ( struct V_45 * V_46 , struct V_21 * V_27 )
{
unsigned long V_47 ;
struct V_17 * V_17 = V_46 -> V_17 ;
F_11 ( & V_17 -> V_10 ) ;
...
static void F_214 ( struct V_45 * V_46 , struct V_20 * V_20 )
{
struct V_66 * V_67 = F_70 ( V_20 , sizeof( struct V_66 ) ) ;
V_67 -> V_46 = V_46 ;
V_67 -> V_148 = NULL ;
...
static int F_215 ( struct V_199 * V_133 , struct V_20 * V_20 )
{
int V_23 ;
...
static int F_217 ( struct V_203 * V_204 , int V_205 )
{
struct V_189 * V_190 = F_187 ( V_204 , struct V_189 , V_206 ) ;
struct V_207 * V_208 ;
if ( F_120 ( V_190 -> V_17 ) == V_126 )
return 1 ;
V_208 = F_218 ( V_190 -> V_209 -> V_61 ) ;
return F_219 ( & V_208 -> V_210 , V_205 ) ;
}
...
static bool F_221 ( struct V_189 * V_190 )
{
struct V_207 * V_208 = F_218 ( V_190 -> V_209 -> V_61 ) ;
return V_208 && F_222 ( V_208 ) ;
}
static bool F_223 ( T_2 V_211 , T_5 V_212 )
{
return ! F_64 ( V_211 , V_212 ) ;
}
static void F_224 ( struct V_189 * V_190 )
{
struct V_17 * V_17 = V_190 -> V_17 ;
struct V_42 * V_213 = V_190 -> V_209 -> V_61 ;
struct V_214 * V_215 = & F_218 ( V_213 ) -> V_216 ;
...
V_217 = L_25 ;
else if ( ! F_223 ( V_211 , V_215 -> V_221 ) )
V_217 = L_26 ;
if ( V_217 ) {
F_126 ( L_27 , F_225 ( V_213 , V_218 ) , V_217 ) ;
V_190 -> V_196 . V_144 = false ;
}
}
static int F_226 ( struct V_17 * V_17 , struct V_199 * V_133 )
{
...
static void F_227 ( struct V_17 * V_17 , struct V_199 * V_133 )
{
if ( V_17 -> V_133 == V_133 )
V_17 -> V_133 = NULL ;
}
static void F_228 ( struct V_222 * V_120 )
{
V_120 -> V_187 = V_127 ;
V_120 -> V_121 = true ;
V_120 -> V_223 = true ;
...
static void F_229 ( struct V_17 * V_17 )
{
F_40 ( V_17 ) ;
if ( F_230 ( V_17 -> V_96 ) < 0 )
F_126 ( L_28 , V_147 ) ;
F_231 ( V_17 -> V_25 ) ;
F_232 ( V_17 -> V_112 ) ;
if ( V_17 -> V_18 )
...
static struct V_17 * F_237 ( struct V_38 * V_41 ,
struct V_42 * V_224 ,
unsigned long V_211 ,
...
V_96 = F_238 ( V_224 , V_211 , V_228 ) ;
if ( F_239 ( V_96 ) ) {
* error = L_29 ;
return (struct V_17 * ) V_96 ;
}
V_17 = F_240 ( sizeof( * V_17 ) , V_229 ) ;
if ( ! V_17 ) {
* error = L_30 ;
V_226 = F_241 ( - V_105 ) ;
goto V_230;
...
V_17 -> V_112 = F_244 ( & V_232 ) ;
if ( F_239 ( V_17 -> V_112 ) ) {
V_23 = F_245 ( V_17 -> V_112 ) ;
* error = L_32 ;
V_226 = F_241 ( V_23 ) ;
goto V_233;
}
V_17 -> V_18 = F_246 ( L_33 V_234 , V_235 ) ;
if ( ! V_17 -> V_18 ) {
* error = L_34 ;
V_226 = F_241 ( - V_105 ) ;
goto V_236;
...
F_4 ( & V_17 -> V_10 ) ;
F_247 ( & V_17 -> V_19 , F_186 ) ;
F_248 ( & V_17 -> V_181 , F_188 ) ;
F_248 ( & V_17 -> V_182 , F_191 ) ;
F_249 ( & V_17 -> V_12 ) ;
F_47 ( & V_17 -> V_71 ) ;
F_35 ( & V_17 -> V_75 ) ;
F_35 ( & V_17 -> V_180 ) ;
...
static void F_252 ( struct V_17 * V_17 )
{
F_37 ( ! F_38 ( & V_34 . V_35 ) ) ;
V_17 -> V_243 ++ ;
}
...
static struct V_17 * F_254 ( struct V_38 * V_41 ,
struct V_42 * V_224 ,
...
V_17 = F_237 ( V_41 , V_224 , V_211 , V_225 , error ) ;
* V_244 = 1 ;
}
}
return V_17 ;
}
static void F_255 ( struct V_199 * V_133 )
{
struct V_189 * V_190 = V_133 -> V_191 ;
F_256 ( & V_34 . V_35 ) ;
F_227 ( V_190 -> V_17 , V_133 ) ;
F_253 ( V_190 -> V_17 ) ;
F_257 ( V_133 , V_190 -> V_224 ) ;
F_257 ( V_133 , V_190 -> V_209 ) ;
F_236 ( V_190 ) ;
F_258 ( & V_34 . V_35 ) ;
}
static int F_259 ( struct V_246 * V_247 , struct V_222 * V_120 ,
struct V_199 * V_133 )
{
int V_23 ;
unsigned V_248 ;
...
if ( ! V_247 -> V_248 )
return 0 ;
V_23 = F_260 ( V_251 , V_247 , & V_248 , & V_133 -> error ) ;
if ( V_23 )
return - V_129 ;
while ( V_248 && ! V_23 ) {
V_249 = F_261 ( V_247 ) ;
...
static T_2 F_263 ( struct V_42 * V_61 )
{
return F_264 ( V_61 -> V_252 ) >> V_100 ;
}
static void F_265 ( struct V_42 * V_61 )
{
T_2 V_253 = F_263 ( V_61 ) ;
char V_254 [ V_219 ] ;
if ( V_253 > V_255 )
F_126 ( L_48 ,
F_225 ( V_61 , V_254 ) , V_256 ) ;
}
static T_2 F_266 ( struct V_42 * V_61 )
{
T_2 V_253 = F_263 ( V_61 ) ;
if ( V_253 > V_256 )
V_253 = V_256 ;
...
static T_1 F_267 ( struct V_42 * V_61 )
{
T_2 V_253 = F_266 ( V_61 ) ;
F_64 ( V_253 , V_257 ) ;
return V_253 ;
}
static T_1 F_268 ( struct V_189 * V_190 )
{
T_1 V_258 = F_267 ( V_190 -> V_224 -> V_61 ) / 4 ;
return F_269 ( ( T_1 ) 1024ULL , V_258 ) ;
}
static int F_270 ( struct V_199 * V_133 , unsigned V_248 , char * * V_259 )
{
int V_23 , V_260 = 0 ;
struct V_189 * V_190 ;
struct V_17 * V_17 ;
...
F_228 ( & V_120 ) ;
F_271 ( & V_247 , 4 ) ;
V_23 = F_259 ( & V_247 , & V_120 , V_133 ) ;
if ( V_23 )
goto V_262;
V_261 = V_263 | ( ( V_120 . V_187 == V_128 ) ? 0 : V_264 ) ;
V_23 = F_272 ( V_133 , V_259 [ 0 ] , V_261 , & V_224 ) ;
if ( V_23 ) {
V_133 -> error = L_50 ;
goto V_262;
}
F_265 ( V_224 -> V_61 ) ;
V_23 = F_272 ( V_133 , V_259 [ 1 ] , V_263 | V_264 , & V_209 ) ;
if ( V_23 ) {
V_133 -> error = L_51 ;
goto V_265;
}
if ( F_273 ( V_259 [ 2 ] , 10 , & V_211 ) || ! V_211 ||
V_211 < V_266 ||
V_211 > V_267 ||
V_211 & ( V_266 - 1 ) ) {
V_133 -> error = L_52 ;
...
if ( F_274 ( V_259 [ 3 ] , 10 , ( unsigned long long * ) & V_131 ) ) {
V_133 -> error = L_53 ;
V_23 = - V_129 ;
goto V_88;
}
V_190 = F_275 ( sizeof( * V_190 ) , V_229 ) ;
if ( ! V_190 ) {
V_23 = - V_105 ;
goto V_88;
}
V_17 = F_254 ( F_276 ( V_133 -> V_134 ) , V_224 -> V_61 ,
...
V_133 -> V_191 = V_190 ;
V_23 = F_277 ( V_190 -> V_17 -> V_96 ,
F_268 ( V_190 ) ,
F_262 ,
V_17 ) ;
if ( V_23 )
goto V_268;
V_190 -> V_206 . V_275 = F_217 ;
F_278 ( V_133 -> V_134 , & V_190 -> V_206 ) ;
F_258 ( & V_34 . V_35 ) ;
return 0 ;
V_269:
F_253 ( V_17 ) ;
...
static int F_279 ( struct V_199 * V_133 , struct V_20 * V_20 )
{
int V_23 ;
struct V_189 * V_190 = V_133 -> V_191 ;
struct V_17 * V_17 = V_190 -> V_17 ;
...
static int F_280 ( struct V_199 * V_133 , bool * V_276 )
{
int V_23 ;
struct V_189 * V_190 = V_133 -> V_191 ;
struct V_17 * V_17 = V_190 -> V_17 ;
...
static int F_283 ( struct V_199 * V_133 , bool * V_276 )
{
int V_23 ;
struct V_189 * V_190 = V_133 -> V_191 ;
struct V_17 * V_17 = V_190 -> V_17 ;
T_1 V_253 , V_279 ;
* V_276 = false ;
V_253 = F_267 ( V_17 -> V_43 ) ;
V_23 = F_284 ( V_17 -> V_96 , & V_279 ) ;
if ( V_23 ) {
F_206 ( L_60 ,
F_127 ( V_17 -> V_41 ) ) ;
return V_23 ;
...
static int F_286 ( struct V_199 * V_133 )
{
int V_23 ;
bool V_280 , V_281 ;
struct V_189 * V_190 = V_133 -> V_191 ;
struct V_17 * V_17 = V_190 -> V_17 ;
V_23 = F_226 ( V_17 , V_133 ) ;
if ( V_23 )
return V_23 ;
V_23 = F_280 ( V_133 , & V_280 ) ;
if ( V_23 )
return V_23 ;
V_23 = F_283 ( V_133 , & V_281 ) ;
if ( V_23 )
return V_23 ;
if ( V_280 || V_281 )
( void ) F_123 ( V_17 ) ;
...
static void F_287 ( struct V_17 * V_17 )
{
struct V_45 * V_46 ;
V_46 = F_178 ( V_17 ) ;
while ( V_46 ) {
...
static void F_289 ( struct V_17 * V_17 )
{
struct V_45 * V_46 ;
V_46 = F_178 ( V_17 ) ;
while ( V_46 ) {
...
static void F_291 ( struct V_199 * V_133 )
{
struct V_189 * V_190 = V_133 -> V_191 ;
struct V_17 * V_17 = V_190 -> V_17 ;
unsigned long V_47 ;
...
static int F_297 ( unsigned V_248 , unsigned V_284 )
{
if ( V_248 != V_284 ) {
F_126 ( L_65 ,
V_248 , V_284 ) ;
...
static int F_298 ( char * V_285 , T_7 * V_286 , int V_287 )
{
if ( ! F_274 ( V_285 , 10 , ( unsigned long long * ) V_286 ) &&
* V_286 <= V_288 )
return 0 ;
if ( V_287 )
F_126 ( L_66 , V_285 ) ;
...
static int F_299 ( unsigned V_248 , char * * V_259 , struct V_17 * V_17 )
{
T_7 V_286 ;
int V_23 ;
V_23 = F_297 ( V_248 , 2 ) ;
if ( V_23 )
return V_23 ;
V_23 = F_298 ( V_259 [ 1 ] , & V_286 , 1 ) ;
if ( V_23 )
return V_23 ;
V_23 = F_300 ( V_17 -> V_96 , V_286 ) ;
if ( V_23 ) {
F_126 ( L_67 ,
V_259 [ 1 ] ) ;
return V_23 ;
...
static int F_301 ( unsigned V_248 , char * * V_259 , struct V_17 * V_17 )
{
T_7 V_286 ;
T_7 V_289 ;
int V_23 ;
...
if ( V_23 )
return V_23 ;
V_23 = F_298 ( V_259 [ 2 ] , & V_289 , 1 ) ;
if ( V_23 )
return V_23 ;
V_23 = F_302 ( V_17 -> V_96 , V_286 , V_289 ) ;
if ( V_23 ) {
F_126 ( L_68 ,
V_259 [ 1 ] , V_259 [ 2 ] ) ;
return V_23 ;
...
static int F_303 ( unsigned V_248 , char * * V_259 , struct V_17 * V_17 )
{
T_7 V_286 ;
int V_23 ;
V_23 = F_297 ( V_248 , 2 ) ;
...
if ( V_23 )
return V_23 ;
V_23 = F_304 ( V_17 -> V_96 , V_286 ) ;
if ( V_23 )
F_126 ( L_69 , V_259 [ 1 ] ) ;
return V_23 ;
}
static int F_305 ( unsigned V_248 , char * * V_259 , struct V_17 * V_17 )
{
T_7 V_290 , V_291 ;
int V_23 ;
V_23 = F_297 ( V_248 , 3 ) ;
if ( V_23 )
return V_23 ;
if ( F_274 ( V_259 [ 1 ] , 10 , ( unsigned long long * ) & V_290 ) ) {
F_126 ( L_70 , V_259 [ 1 ] ) ;
return - V_129 ;
}
if ( F_274 ( V_259 [ 2 ] , 10 , ( unsigned long long * ) & V_291 ) ) {
F_126 ( L_71 , V_259 [ 2 ] ) ;
return - V_129 ;
}
V_23 = F_306 ( V_17 -> V_96 , V_290 , V_291 ) ;
if ( V_23 ) {
F_126 ( L_72 ,
V_259 [ 1 ] , V_259 [ 2 ] ) ;
return V_23 ;
...
static int F_307 ( unsigned V_248 , char * * V_259 , struct V_17 * V_17 )
{
int V_23 ;
V_23 = F_297 ( V_248 , 1 ) ;
if ( V_23 )
return V_23 ;
( void ) F_123 ( V_17 ) ;
V_23 = F_308 ( V_17 -> V_96 ) ;
if ( V_23 )
F_126 ( L_73 ) ;
return V_23 ;
}
static int F_309 ( unsigned V_248 , char * * V_259 , struct V_17 * V_17 )
{
int V_23 ;
V_23 = F_297 ( V_248 , 1 ) ;
if ( V_23 )
return V_23 ;
V_23 = F_310 ( V_17 -> V_96 ) ;
if ( V_23 )
F_126 ( L_74 ) ;
return V_23 ;
}
static int F_311 ( struct V_199 * V_133 , unsigned V_248 , char * * V_259 )
{
int V_23 = - V_129 ;
struct V_189 * V_190 = V_133 -> V_191 ;
struct V_17 * V_17 = V_190 -> V_17 ;
...
V_23 = F_299 ( V_248 , V_259 , V_17 ) ;
else if ( ! strcasecmp ( V_259 [ 0 ] , L_77 ) )
V_23 = F_301 ( V_248 , V_259 , V_17 ) ;
else if ( ! strcasecmp ( V_259 [ 0 ] , L_78 ) )
V_23 = F_303 ( V_248 , V_259 , V_17 ) ;
else if ( ! strcasecmp ( V_259 [ 0 ] , L_79 ) )
V_23 = F_305 ( V_248 , V_259 , V_17 ) ;
else if ( ! strcasecmp ( V_259 [ 0 ] , L_80 ) )
V_23 = F_307 ( V_248 , V_259 , V_17 ) ;
else if ( ! strcasecmp ( V_259 [ 0 ] , L_81 ) )
V_23 = F_309 ( V_248 , V_259 , V_17 ) ;
else
F_126 ( L_82 , V_259 [ 0 ] ) ;
if ( ! V_23 )
( void ) F_123 ( V_17 ) ;
...
static void F_312 ( struct V_222 * V_120 , char * V_135 ,
...
static void F_314 ( struct V_199 * V_133 , T_8 type ,
...
if ( ! ( V_294 & V_303 ) && ! F_315 ( V_133 ) )
( void ) F_123 ( V_17 ) ;
V_23 = F_316 ( V_17 -> V_96 , & V_295 ) ;
if ( V_23 ) {
F_206 ( L_90 ,
F_127 ( V_17 -> V_41 ) , V_23 ) ;
goto V_78;
}
V_23 = F_317 ( V_17 -> V_96 , & V_297 ) ;
if ( V_23 ) {
F_206 ( L_91 ,
F_127 ( V_17 -> V_41 ) , V_23 ) ;
goto V_78;
}
V_23 = F_284 ( V_17 -> V_96 , & V_299 ) ;
if ( V_23 ) {
F_206 ( L_92 ,
F_127 ( V_17 -> V_41 ) , V_23 ) ;
goto V_78;
...
V_23 = F_281 ( V_17 -> V_96 , & V_298 ) ;
if ( V_23 ) {
F_206 ( L_94 ,
F_127 ( V_17 -> V_41 ) , V_23 ) ;
goto V_78;
}
V_23 = F_318 ( V_17 -> V_96 , & V_300 ) ;
if ( V_23 ) {
F_206 ( L_95 ,
F_127 ( V_17 -> V_41 ) , V_23 ) ;
goto V_78;
...
case V_304 :
F_313 ( L_104 ,
F_319 ( V_218 , V_190 -> V_224 -> V_61 -> V_305 ) ,
F_319 ( V_301 , V_190 -> V_209 -> V_61 -> V_305 ) ,
( unsigned long ) V_17 -> V_57 ,
( unsigned long long ) V_190 -> V_131 ) ;
F_312 ( & V_190 -> V_270 , V_135 , V_292 , V_293 ) ;
break;
}
return;
V_78:
...
static int F_320 ( struct V_199 * V_133 ,
T_10 F_24 , void * V_306 )
{
struct V_189 * V_190 = V_133 -> V_191 ;
return F_24 ( V_133 , V_190 -> V_209 , 0 , V_133 -> V_117 , V_306 ) ;
}
static int F_321 ( struct V_199 * V_133 , struct V_307 * V_308 ,
...
return F_269 ( V_311 , V_208 -> V_312 ( V_208 , V_308 , V_310 ) ) ;
}
static void F_322 ( struct V_189 * V_190 , struct V_214 * V_216 )
{
struct V_17 * V_17 = V_190 -> V_17 ;
struct V_214 * V_215 ;
V_216 -> V_220 = V_17 -> V_57 ;
if ( V_190 -> V_196 . V_144 ) {
V_215 = & F_218 ( V_190 -> V_209 -> V_61 ) -> V_216 ;
V_216 -> V_221 = F_323 ( V_215 -> V_221 ,
V_17 -> V_57 << V_100 ) ;
} else
V_216 -> V_221 = V_17 -> V_57 << V_100 ;
}
static void F_324 ( struct V_199 * V_133 , struct V_214 * V_216 )
{
struct V_189 * V_190 = V_133 -> V_191 ;
struct V_17 * V_17 = V_190 -> V_17 ;
T_2 V_313 = V_216 -> V_314 >> V_100 ;
if ( V_216 -> V_315 < V_17 -> V_57 ) {
while ( ! F_223 ( V_17 -> V_57 , V_216 -> V_315 ) ) {
if ( ( V_216 -> V_315 & ( V_216 -> V_315 - 1 ) ) == 0 )
V_216 -> V_315 -- ;
V_216 -> V_315 = F_325 ( V_216 -> V_315 ) ;
}
}
if ( V_313 < V_17 -> V_57 ||
! F_223 ( V_313 , V_17 -> V_57 ) ) {
if ( F_223 ( V_17 -> V_57 , V_216 -> V_315 ) )
F_326 ( V_216 , V_216 -> V_315 << V_100 ) ;
else
F_326 ( V_216 , V_17 -> V_57 << V_100 ) ;
...
static void F_180 ( struct V_45 * V_46 )
{
F_90 ( & V_46 -> V_316 ) ;
}
...
static void F_328 ( struct V_199 * V_133 )
{
struct V_45 * V_46 = V_133 -> V_191 ;
unsigned long V_47 ;
...
F_253 ( V_46 -> V_17 ) ;
F_331 ( V_46 -> V_2 ) ;
F_257 ( V_133 , V_46 -> V_60 ) ;
if ( V_46 -> V_62 )
F_257 ( V_133 , V_46 -> V_62 ) ;
F_236 ( V_46 ) ;
F_258 ( & V_34 . V_35 ) ;
}
static int F_332 ( struct V_199 * V_133 , unsigned V_248 , char * * V_259 )
{
int V_23 ;
struct V_45 * V_46 ;
...
V_46 = V_133 -> V_191 = F_275 ( sizeof( * V_46 ) , V_229 ) ;
if ( ! V_46 ) {
V_133 -> error = L_106 ;
V_23 = - V_105 ;
goto V_262;
}
V_46 -> V_282 = F_276 ( V_133 -> V_134 ) ;
F_249 ( & V_46 -> V_12 ) ;
F_35 ( & V_46 -> V_50 ) ;
F_47 ( & V_46 -> V_51 ) ;
F_47 ( & V_46 -> V_52 ) ;
V_46 -> V_159 = V_318 ;
if ( V_248 == 3 ) {
V_23 = F_272 ( V_133 , V_259 [ 2 ] , V_263 , & V_62 ) ;
if ( V_23 ) {
V_133 -> error = L_107 ;
goto V_319;
}
...
V_23 = F_272 ( V_133 , V_259 [ 0 ] , F_333 ( V_133 -> V_134 ) , & V_60 ) ;
if ( V_23 ) {
V_133 -> error = L_108 ;
goto V_320;
}
V_46 -> V_60 = V_60 ;
if ( F_298 ( V_259 [ 1 ] , ( unsigned long long * ) & V_46 -> V_286 , 0 ) ) {
V_133 -> error = L_109 ;
V_23 = - V_129 ;
goto V_321;
}
V_41 = F_334 ( V_46 -> V_60 -> V_61 -> V_305 ) ;
if ( ! V_41 ) {
V_133 -> error = L_110 ;
V_23 = - V_129 ;
goto V_321;
...
V_23 = F_335 ( V_46 -> V_17 -> V_96 , V_46 -> V_286 , & V_46 -> V_2 ) ;
if ( V_23 ) {
V_133 -> error = L_113 ;
goto V_230;
}
V_23 = F_336 ( V_133 , V_46 -> V_17 -> V_57 ) ;
if ( V_23 )
goto V_323;
V_133 -> V_271 = 1 ;
V_133 -> V_324 = true ;
...
F_113 ( & V_46 -> V_316 , 1 ) ;
F_197 ( & V_46 -> V_317 ) ;
F_337 ( & V_46 -> V_37 , & V_46 -> V_17 -> V_175 ) ;
F_53 ( & V_46 -> V_17 -> V_12 , V_47 ) ;
F_330 () ;
F_338 ( V_41 ) ;
return 0 ;
...
static int F_339 ( struct V_199 * V_133 , struct V_20 * V_20 )
{
V_20 -> V_55 . V_56 = F_340 ( V_133 , V_20 -> V_55 . V_56 ) ;
return F_215 ( V_133 , V_20 ) ;
}
static int F_341 ( struct V_199 * V_133 , struct V_20 * V_20 , int V_78 )
{
unsigned long V_47 ;
struct V_66 * V_67 = F_70 ( V_20 , sizeof( struct V_66 ) ) ;
struct V_48 V_283 ;
...
static void F_343 ( struct V_199 * V_133 )
{
struct V_45 * V_46 = V_133 -> V_191 ;
if ( F_344 ( V_133 ) )
V_185 ( V_46 , F_200 ) ;
}
static void F_345 ( struct V_199 * V_133 )
{
struct V_45 * V_46 = V_133 -> V_191 ;
V_185 ( V_46 , F_201 ) ;
}
static int F_346 ( struct V_199 * V_133 )
{
struct V_45 * V_46 = V_133 -> V_191 ;
if ( V_46 -> V_62 )
V_46 -> V_124 = F_263 ( V_46 -> V_62 -> V_61 ) ;
return 0 ;
}
static void F_347 ( struct V_199 * V_133 , T_8 type ,
unsigned V_294 , char * V_135 , unsigned V_293 )
{
int V_23 ;
T_11 V_292 = 0 ;
...
switch ( type ) {
case V_302 :
V_23 = F_348 ( V_46 -> V_2 , & V_327 ) ;
if ( V_23 ) {
F_206 ( L_116 , V_23 ) ;
goto V_78;
}
V_23 = F_349 ( V_46 -> V_2 , & V_328 ) ;
if ( V_23 < 0 ) {
F_206 ( L_117 , V_23 ) ;
goto V_78;
}
F_313 ( L_97 , V_327 * V_46 -> V_17 -> V_57 ) ;
if ( V_23 )
F_313 ( L_118 , ( ( V_328 + 1 ) *
V_46 -> V_17 -> V_57 ) - 1 ) ;
else
...
case V_304 :
F_313 ( L_119 ,
F_319 ( V_218 , V_46 -> V_60 -> V_61 -> V_305 ) ,
( unsigned long ) V_46 -> V_286 ) ;
if ( V_46 -> V_62 )
F_313 ( L_120 , F_319 ( V_218 , V_46 -> V_62 -> V_61 -> V_305 ) ) ;
break;
}
}
return;
...
static int F_350 ( struct V_199 * V_133 , struct V_307 * V_308 ,
struct V_309 * V_310 , int V_311 )
{
struct V_45 * V_46 = V_133 -> V_191 ;
struct V_207 * V_208 = F_218 ( V_46 -> V_60 -> V_61 ) ;
if ( ! V_208 -> V_312 )
return V_311 ;
V_308 -> V_59 = V_46 -> V_60 -> V_61 ;
V_308 -> V_56 = F_340 ( V_133 , V_308 -> V_56 ) ;
return F_269 ( V_311 , V_208 -> V_312 ( V_208 , V_308 , V_310 ) ) ;
}
static int F_351 ( struct V_199 * V_133 ,
T_10 F_24 , void * V_306 )
{
T_2 V_329 ;
struct V_45 * V_46 = V_133 -> V_191 ;
