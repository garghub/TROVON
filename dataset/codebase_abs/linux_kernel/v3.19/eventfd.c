...
static void F_35 ( struct V_35 * V_36 , struct V_12 * V_37 )
{
...
struct V_1 * F_41 ( int V_38 )
{
struct V_1 * V_2 ;
struct V_38 V_37 = F_42 ( V_38 ) ;
if ( ! V_37 . V_12 )
return F_39 ( - V_39 ) ;
V_2 = F_43 ( V_37 . V_12 ) ;
F_44 ( V_37 ) ;
...
struct V_12 * F_45 ( unsigned int V_8 , int V_4 )
{
struct V_12 * V_12 ;
struct V_1 * V_2 ;
F_46 ( V_42 != V_43 ) ;
