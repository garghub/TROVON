...
static int F_100 ( struct V_2 * V_3 , enum V_117 V_118 ,
unsigned long V_119 )
{
struct V_1 * V_5 = F_1 ( V_3 ) ;
struct V_21 * V_24 , * V_40 ;
...
struct V_1 * V_5 = F_1 ( V_3 ) ;
enum V_122 V_41 ;
V_41 = F_102 ( V_3 , V_62 , V_124 ) ;
if ( V_41 == V_125 )
return V_125 ;
F_38 ( & V_5 -> V_43 ) ;
F_77 ( V_5 ) ;
F_43 ( & V_5 -> V_43 ) ;
return F_102 ( V_3 , V_62 , V_124 ) ;
}
...
F_107 ( V_3 ) ;
V_5 -> V_66 = V_127 | V_128 | V_129 ;
F_108 ( V_5 ) ;
if ( ! F_59 () || ( V_5 -> V_66 & V_130 ) )
V_5 -> V_66 |= V_131 ;
if ( V_3 -> V_18 -> V_132 ) {
if ( V_58 )
return - V_121 ;
...
static int T_9 F_118 ( struct V_137 * V_138 )
{
struct V_139 * V_140 =
F_119 ( & V_138 -> V_19 ) ;
struct V_137 * V_141 = V_140 -> V_141 ;
struct V_142 * V_143 = F_119 ( & V_141 -> V_19 ) ;
struct V_1 * V_5 ;
int V_144 ;
int V_145 = V_138 -> V_146 % V_97 ;
int V_88 ;
V_5 = F_120 ( & V_138 -> V_19 , sizeof( * V_5 ) , V_136 ) ;
if ( ! V_5 )
return - V_147 ;
V_5 -> V_96 . V_19 = & V_138 -> V_19 ;
V_5 -> V_96 . V_148 = F_106 ;
V_5 -> V_96 . V_149 = F_113 ;
V_5 -> V_96 . V_150 = F_100 ;
V_5 -> V_96 . V_151 = F_101 ;
V_5 -> V_96 . V_152 = F_105 ;
if ( V_143 && V_143 -> V_153 == V_145 ) {
V_5 -> V_96 . V_132 = F_90 ;
F_121 ( V_154 , V_5 -> V_96 . V_155 ) ;
} else {
V_5 -> V_96 . V_156 = F_96 ;
F_121 ( V_157 , V_5 -> V_96 . V_155 ) ;
F_121 ( V_158 , V_5 -> V_96 . V_155 ) ;
}
F_34 ( & V_5 -> V_96 . V_159 ) ;
V_5 -> V_15 = F_122 ( V_141 ) ;
if ( V_5 -> V_15 -> V_88 < 0 ) {
V_88 = F_123 ( V_138 , 0 ) ;
if ( V_88 < 0 )
return V_88 ;
...
( unsigned long ) V_5 ) ;
V_5 -> V_88 = V_88 ;
V_144 = F_125 ( & V_138 -> V_19 , V_5 -> V_88 ,
F_82 , 0 , F_126 ( & V_138 -> V_19 ) , V_5 ) ;
if ( V_144 )
return V_144 ;
} else
V_5 -> V_88 = - 1 ;
V_5 -> V_15 -> V_3 [ V_145 ] = V_5 ;
V_5 -> V_3 . V_18 = & V_5 -> V_96 ;
F_89 ( & V_5 -> V_3 . V_160 , & V_5 -> V_3 . V_18 -> V_159 ) ;
F_107 ( & V_5 -> V_3 ) ;
if ( F_14 ( V_5 ) )
V_5 -> V_6 = & F_18 ( V_5 -> V_15 ) -> V_161 [ V_145 ] ;
else
V_5 -> V_6 = & F_19 ( V_5 -> V_15 ) -> V_161 [ V_145 ] ;
F_127 ( & V_5 -> V_43 ) ;
F_34 ( & V_5 -> V_27 ) ;
F_34 ( & V_5 -> V_31 ) ;
F_34 ( & V_5 -> V_47 ) ;
F_53 ( V_5 ) ;
F_128 ( V_138 , V_5 ) ;
V_144 = F_129 ( & V_5 -> V_96 ) ;
if ( V_144 )
return V_144 ;
F_42 ( & V_138 -> V_19 , L_36 ,
V_5 -> V_96 . V_91 ,
F_130 ( V_154 , V_5 -> V_96 . V_155 ) ? L_37 : L_38 ,
F_130 ( V_157 , V_5 -> V_96 . V_155 ) ? L_39 : L_38 ) ;
return 0 ;
}
static int F_131 ( struct V_137 * V_138 )
{
struct V_1 * V_5 = F_122 ( V_138 ) ;
F_132 ( & V_5 -> V_96 ) ;
if ( V_5 -> V_88 >= 0 )
F_133 ( & V_5 -> V_92 ) ;
V_5 -> V_15 -> V_3 [ V_138 -> V_146 % V_97 ] = NULL ;
return 0 ;
}
static int T_9 F_134 ( struct V_137 * V_138 )
{
struct V_142 * V_143 = F_119 ( & V_138 -> V_19 ) ;
struct V_162 * V_163 ;
struct V_14 * V_15 ;
T_4 V_94 ;
int V_144 ;
V_163 = F_135 ( V_138 , V_164 , 0 ) ;
if ( ! V_163 )
return - V_121 ;
V_15 = F_120 ( & V_138 -> V_19 , sizeof( * V_15 ) , V_136 ) ;
if ( ! V_15 )
return - V_147 ;
if ( ! F_136 ( & V_138 -> V_19 , V_163 -> V_165 , F_137 ( V_163 ) ,
F_126 ( & V_138 -> V_19 ) ) )
return - V_166 ;
V_15 -> V_16 = F_138 ( & V_138 -> V_19 , V_163 -> V_165 , F_137 ( V_163 ) ) ;
if ( ! V_15 -> V_16 )
return - V_147 ;
V_15 -> V_167 = V_143 -> V_167 ;
if ( F_93 ( V_15 ) )
V_15 -> V_38 = sizeof( struct V_73 ) ;
else
V_15 -> V_38 = sizeof( struct V_74 ) ;
F_116 ( V_15 ) ;
V_15 -> V_88 = F_123 ( V_138 , 0 ) ;
if ( V_15 -> V_88 >= 0 ) {
F_124 ( & V_15 -> V_92 , F_85 ,
( unsigned long ) V_15 ) ;
V_144 = F_125 ( & V_138 -> V_19 , V_15 -> V_88 ,
F_87 , 0 , F_126 ( & V_138 -> V_19 ) , V_15 ) ;
if ( V_144 )
return V_144 ;
}
V_94 = V_168 | V_169 ;
if ( V_143 && V_143 -> V_153 >= 0 )
V_94 |= F_139 ( V_143 -> V_153 ) ;
F_117 ( V_15 , V_95 , V_94 ) ;
F_128 ( V_138 , V_15 ) ;
return 0 ;
}
static int F_140 ( struct V_137 * V_138 )
{
struct V_14 * V_15 = F_122 ( V_138 ) ;
F_116 ( V_15 ) ;
if ( V_15 -> V_88 >= 0 )
F_133 ( & V_15 -> V_92 ) ;
return 0 ;
}
static void F_141 ( struct V_137 * V_138 )
{
struct V_14 * V_15 = F_122 ( V_138 ) ;
F_116 ( V_15 ) ;
}
