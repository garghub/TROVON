...
{
return strncasecmp ( V_50 , V_51 , strlen ( V_51 ) ) == 0 ;
}
static void F_46 ( char * V_5 , struct V_52 * V_23 ,
struct V_6 * * V_53 )
{
int V_54 , V_55 , V_56 ;
struct V_6 * V_7 ;
...
static void F_48 ( char * V_5 , struct V_52 * V_23 ,
struct V_6 * * V_53 )
{
F_38 ( * V_53 , V_5 ) ;
}
...
{
F_35 ( ( * V_53 ) -> V_60 ) ;
( * V_53 ) -> V_60 = F_52 ( V_5 , V_27 ) ;
}
static void F_53 ( char * V_5 , struct V_52 * V_23 ,
struct V_6 * * V_53 )
{
F_35 ( ( * V_53 ) -> V_61 ) ;
( * V_53 ) -> V_61 = F_52 ( V_5 , V_27 ) ;
}
static int F_54 ( char * V_5 , struct V_52 * V_23 )
{
int V_12 ;
for ( V_12 = 0 ; V_12 < F_55 ( V_62 ) ; V_12 ++ ) {
if ( ! V_62 [ V_12 ] . V_63 )
continue;
...
static int F_56 ( char * V_5 , int V_66 , T_2 * V_67 ,
const void * * V_68 )
{
int V_13 ;
T_2 V_69 = * V_67 ;
...
int F_57 ( struct V_52 * V_23 , T_2 V_69 , const void * V_70 )
{
char V_5 [ 128 ] ;
struct V_6 * V_7 ;
int V_71 ;
V_71 = V_65 ;
V_7 = NULL ;
while ( F_56 ( V_5 , sizeof( V_5 ) - 1 , & V_69 , & V_70 ) ) {
if ( ! * V_5 || * V_5 == '#' || * V_5 == '\n' )
continue;
if ( * V_5 == '[' )
V_71 = F_54 ( V_5 , V_23 ) ;
...
F_59 ( & V_7 -> V_14 ) ;
#ifdef F_60
F_61 ( & V_7 -> V_29 , sizeof( struct V_30 ) , 32 ) ;
F_61 ( & V_7 -> V_38 , sizeof( struct V_39 ) , 32 ) ;
F_61 ( & V_7 -> V_46 , sizeof( struct V_16 ) , 16 ) ;
#endif
}
