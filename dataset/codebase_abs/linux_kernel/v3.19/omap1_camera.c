...
V_37 = F_69 ( V_128 , V_132 , V_133 , V_124 , & V_41 ) ;
if ( V_37 < 0 )
return 0 ;
V_131 = F_70 ( V_41 ) ;
if ( ! V_131 ) {
...
static bool F_73 ( T_5 V_146 , unsigned int V_44 ,
enum V_25 V_20 )
{
int V_11 = V_146 * V_44 ;
return F_74 ( V_146 , V_59 ) &&
F_74 ( V_11 , F_27 ( V_20 ) * V_59 ) ;
}
static int F_75 ( int * V_42 , int * V_44 ,
const struct V_130 * V_131 ,
enum V_25 V_20 , bool V_147 )
{
T_5 V_146 = F_76 ( * V_42 , V_131 ) ;
if ( V_146 < 0 )
return V_146 ;
if ( ! F_73 ( V_146 , * V_44 , V_20 ) ) {
unsigned int V_148 = F_77 ( V_146 / * V_42 ) ;
unsigned int V_149 = F_31 ( V_20 ) +
V_64 - V_148 ;
unsigned int V_150 = V_147 << V_149 ;
F_78 ( V_42 , 1 , * V_42 + V_150 , 0 ,
V_44 , 1 , * V_44 + V_150 , 0 , V_149 ) ;
return 0 ;
}
return 1 ;
}
...
{
T_5 V_146 ;
int V_37 = F_80 ( V_2 , V_30 , V_13 , V_128 , V_153 , V_152 ) ;
if ( V_37 < 0 ) {
F_81 ( V_30 , L_20 , V_22 ) ;
return V_37 ;
}
if ( V_152 -> V_41 != V_126 -> V_41 ) {
F_81 ( V_30 , L_21 , V_22 ) ;
return - V_48 ;
}
V_146 = F_76 ( V_152 -> V_42 , V_126 -> V_143 ) ;
if ( V_146 < 0 ) {
F_81 ( V_30 , L_22 ,
V_22 ) ;
return V_146 ;
}
if ( ! F_73 ( V_146 , V_152 -> V_44 , V_2 -> V_20 ) ) {
F_81 ( V_30 , L_23 ,
V_22 , V_152 -> V_42 , V_152 -> V_44 ) ;
return - V_48 ;
}
return 0 ;
}
...
{
const struct V_156 * V_157 = & V_155 -> V_158 ;
...
struct V_151 V_152 ;
int V_37 ;
V_37 = F_80 ( V_2 , V_30 , V_13 , V_128 , V_159 , V_155 ) ;
if ( V_37 < 0 ) {
F_58 ( V_30 , L_24 , V_22 ,
V_157 -> V_42 , V_157 -> V_44 , V_157 -> V_160 , V_157 -> V_161 ) ;
return V_37 ;
}
V_37 = F_69 ( V_128 , V_132 , V_162 , & V_152 ) ;
if ( V_37 < 0 ) {
F_58 ( V_30 , L_25 , V_22 ) ;
return V_37 ;
}
V_37 = F_75 ( & V_152 . V_42 , & V_152 . V_44 , V_126 -> V_143 , V_2 -> V_20 ,
false ) ;
if ( V_37 < 0 ) {
F_81 ( V_30 , L_26 ,
V_22 , V_152 . V_42 , V_152 . V_44 ,
...
if ( ! V_37 ) {
V_37 = F_79 ( V_2 , V_30 , V_13 , V_128 , & V_152 , V_126 ) ;
if ( V_37 < 0 ) {
F_81 ( V_30 , L_27 , V_22 ) ;
return V_37 ;
}
}
V_13 -> V_43 = V_152 . V_42 ;
V_13 -> V_45 = V_152 . V_44 ;
return 0 ;
}
...
struct V_15 * V_16 = F_6 ( V_30 ) ;
struct V_1 * V_2 = V_16 -> V_18 ;
struct V_165 * V_166 = & V_164 -> V_131 . V_166 ;
struct V_151 V_152 ;
int V_37 ;
V_126 = F_84 ( V_13 , V_166 -> V_167 ) ;
if ( ! V_126 ) {
F_58 ( V_30 , L_28 , V_22 ,
V_166 -> V_167 ) ;
return - V_48 ;
}
V_152 . V_42 = V_166 -> V_42 ;
V_152 . V_44 = V_166 -> V_44 ;
V_152 . V_36 = V_166 -> V_36 ;
V_152 . V_168 = V_166 -> V_168 ;
V_152 . V_41 = V_126 -> V_41 ;
V_37 = F_75 ( & V_152 . V_42 , & V_152 . V_44 , V_126 -> V_143 , V_2 -> V_20 ,
true ) ;
if ( V_37 < 0 ) {
F_81 ( V_30 , L_26 ,
V_22 , V_166 -> V_42 , V_166 -> V_44 ,
V_126 -> V_143 -> V_145 ) ;
return V_37 ;
}
V_37 = F_79 ( V_2 , V_30 , V_13 , V_128 , & V_152 , V_126 ) ;
...
V_166 -> V_42 = V_152 . V_42 ;
V_166 -> V_44 = V_152 . V_44 ;
V_166 -> V_36 = V_152 . V_36 ;
...
V_152 . V_168 = V_166 -> V_168 ;
V_152 . V_41 = V_126 -> V_41 ;
V_37 = F_69 ( V_128 , V_132 , V_169 , & V_152 ) ;
if ( V_37 < 0 )
return V_37 ;
V_166 -> V_42 = V_152 . V_42 ;
V_166 -> V_44 = V_152 . V_44 ;
...
static int F_86 ( struct V_8 * V_170 ,
struct V_26 * V_24 ,
struct V_171 * V_172 )
{
...
struct V_1 * V_2 = V_16 -> V_18 ;
int V_37 ;
V_37 = V_2 -> V_173 ( V_170 , V_24 , V_172 ) ;
if ( V_37 == - V_174 )
V_175 = true ;
return V_37 ;
}
static void F_87 ( struct V_8 * V_170 ,
struct V_12 * V_13 )
{
struct V_15 * V_16 = F_6 ( V_13 -> V_17 ) ;
struct V_1 * V_2 = V_16 -> V_18 ;
...
V_13 -> V_17 , & V_2 -> V_98 ,
V_177 , V_178 ,
sizeof( struct V_23 ) , V_13 , & V_16 -> V_179 ) ;
else
F_89 ( V_170 , & V_176 ,
V_13 -> V_17 , & V_2 -> V_98 ,
V_177 , V_178 ,
sizeof( struct V_23 ) , V_13 , & V_16 -> V_179 ) ;
V_2 -> V_20 = V_175 ? V_73 : V_28 ;
if ( ! V_175 && V_170 -> V_180 -> V_173 != F_86 ) {
V_2 -> V_173 = V_170 -> V_180 -> V_173 ;
V_170 -> V_180 -> V_173 = F_86 ;
}
}
...
struct V_23 * V_24 = F_18 ( V_13 -> V_184 . V_185 [ V_183 ] ,
struct V_23 , V_27 ) ;
V_24 -> V_40 = 0 ;
F_91 ( & V_24 -> V_27 . V_38 ) ;
}
...
struct V_186 * V_187 )
{
F_93 ( V_187 -> V_188 , L_30 , sizeof( V_187 -> V_188 ) ) ;
V_187 -> V_189 = V_190 | V_191 ;
V_187 -> V_192 = V_187 -> V_189 | V_193 ;
return 0 ;
}
...
struct V_15 * V_16 = F_6 ( V_30 ) ;
struct V_1 * V_2 = V_16 -> V_18 ;
T_2 V_194 = V_13 -> V_39 -> V_143 -> V_195 ;
const struct V_125 * V_126 ;
const struct V_130 * V_131 ;
struct V_196 V_197 = { . type = V_198 ,} ;
unsigned long V_199 ;
T_2 V_75 , V_77 ;
int V_37 ;
V_37 = F_69 ( V_128 , V_132 , V_200 , & V_197 ) ;
if ( ! V_37 ) {
V_199 = F_95 ( & V_197 , V_201 ) ;
if ( ! V_199 ) {
F_58 ( V_30 ,
L_31 ,
V_197 . V_97 , V_201 ) ;
...
( V_199 & V_204 ) ) {
if ( ! V_2 -> V_205 ||
V_2 -> V_205 -> V_97 & V_206 )
V_199 &= ~ V_204 ;
else
V_199 &= ~ V_203 ;
}
V_197 . V_97 = V_199 ;
V_37 = F_69 ( V_128 , V_132 , V_207 , & V_197 ) ;
if ( V_37 < 0 && V_37 != - V_202 ) {
F_8 ( V_30 , L_32 ,
V_199 , V_37 ) ;
return V_37 ;
}
...
if ( V_75 & V_81 )
F_40 ( V_2 , V_76 , V_75 ) ;
V_126 = F_84 ( V_13 , V_194 ) ;
V_131 = V_126 -> V_143 ;
V_77 = F_57 ( V_2 , V_78 ) & ~ ( V_82 | V_83 | V_84 ) ;
if ( V_131 -> V_209 == V_210 ) {
F_8 ( V_30 , L_35 ) ;
F_40 ( V_2 , V_78 , V_77 & ~ V_211 ) ;
} else {
F_8 ( V_30 , L_36 ) ;
F_40 ( V_2 , V_78 , V_77 | V_211 ) ;
}
...
static unsigned int F_96 ( struct V_212 * V_212 , T_6 * V_213 )
{
struct V_12 * V_13 = V_212 -> V_214 ;
struct V_23 * V_24 ;
V_24 = F_33 ( V_13 -> V_184 . V_215 . V_68 , struct V_23 ,
V_27 . V_215 ) ;
F_97 ( V_212 , & V_24 -> V_27 . V_91 , V_213 ) ;
...
unsigned int V_99 ;
int V_222 = 0 ;
V_221 = F_99 ( V_219 , V_223 , 0 ) ;
V_99 = F_100 ( V_219 , 0 ) ;
if ( ! V_221 || ( int ) V_99 <= 0 ) {
V_222 = - V_224 ;
goto exit;
}
V_113 = F_101 ( & V_219 -> V_30 , L_37 ) ;
if ( F_102 ( V_113 ) ) {
V_222 = F_103 ( V_113 ) ;
goto exit;
}
V_2 = F_104 ( sizeof( * V_2 ) + F_105 ( V_221 ) , V_225 ) ;
if ( ! V_2 ) {
F_81 ( & V_219 -> V_30 , L_38 ) ;
V_222 = - V_174 ;
goto V_226;
}
V_2 -> V_221 = V_221 ;
V_2 -> V_113 = V_113 ;
V_2 -> V_205 = V_219 -> V_30 . V_227 ;
if ( V_2 -> V_205 ) {
V_2 -> V_108 = V_2 -> V_205 -> V_97 ;
V_2 -> V_118 = V_2 -> V_205 -> V_228 * 1000 ;
}
switch ( V_2 -> V_118 ) {
case 6000000 :
case 8000000 :
...
V_2 -> V_118 = 0 ;
case 0 :
F_106 ( & V_219 -> V_30 , L_42 ) ;
}
F_91 ( & V_2 -> V_67 ) ;
F_107 ( & V_2 -> V_98 ) ;
if ( ! F_108 ( V_221 -> V_229 , F_105 ( V_221 ) , V_230 ) ) {
V_222 = - V_231 ;
goto V_232;
}
V_6 = F_109 ( V_221 -> V_229 , F_105 ( V_221 ) ) ;
if ( ! V_6 ) {
V_222 = - V_174 ;
goto V_233;
}
...
V_2 -> V_6 = V_6 ;
F_60 ( V_2 , true ) ;
V_222 = F_110 ( V_234 , V_230 ,
F_53 , ( void * ) V_2 , & V_2 -> V_52 ) ;
if ( V_222 < 0 ) {
F_81 ( & V_219 -> V_30 , L_43 ) ;
V_222 = - V_231 ;
goto V_235;
}
F_8 ( & V_219 -> V_30 , L_44 , V_2 -> V_52 ) ;
F_111 ( V_2 -> V_52 , V_236 ,
V_237 , V_221 -> V_229 + V_238 ,
0 , 0 ) ;
F_112 ( V_2 -> V_52 , V_239 ) ;
F_113 ( V_2 -> V_52 , V_2 -> V_52 ) ;
V_222 = F_114 ( V_2 -> V_99 , F_56 , 0 , V_230 , V_2 ) ;
if ( V_222 ) {
F_81 ( & V_219 -> V_30 , L_45 ) ;
goto V_240;
}
V_2 -> V_90 . V_241 = V_230 ;
V_2 -> V_90 . V_242 = & V_243 ;
V_2 -> V_90 . V_18 = V_2 ;
V_2 -> V_90 . V_244 . V_30 = & V_219 -> V_30 ;
V_2 -> V_90 . V_245 = V_219 -> V_246 ;
V_222 = F_115 ( & V_2 -> V_90 ) ;
if ( V_222 )
goto V_247;
F_106 ( & V_219 -> V_30 , L_46 ) ;
return 0 ;
V_247:
F_116 ( V_2 -> V_99 , V_2 ) ;
V_240:
...
{
struct V_15 * V_90 = F_6 ( & V_219 -> V_30 ) ;
