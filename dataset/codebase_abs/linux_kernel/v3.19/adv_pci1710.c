...
struct V_3 * V_4 )
{
struct V_18 * V_19 = & V_4 -> V_94 -> V_19 ;
unsigned int V_45 ;
unsigned int V_6 ;
int V_51 ;
V_45 = F_10 ( V_2 -> V_37 + V_46 ) ;
...
V_6 = F_10 ( V_2 -> V_37 + V_60 ) ;
V_51 = F_1 ( V_2 , V_4 , V_4 -> V_94 -> V_99 , V_6 ) ;
if ( V_51 ) {
V_4 -> V_94 -> V_95 |= V_96 | V_97 ;
break;
}
...
unsigned int V_105 ;
unsigned int V_106 ;
V_106 = F_10 ( V_2 -> V_37 + V_46 ) ;
if ( ! ( V_106 & V_107 ) ) {
F_29 ( V_2 -> V_16 , L_7 , V_106 ) ;
V_4 -> V_94 -> V_95 |= V_96 | V_97 ;
F_30 ( V_2 , V_4 ) ;
return;
}
...
V_105 = V_33 -> V_108 ;
if ( F_34 ( V_4 , V_105 ) >= V_4 -> V_94 -> V_109 ) {
V_106 = F_35 ( V_4 , V_4 -> V_94 -> V_109 ) ;
if ( F_32 ( V_2 , V_4 , V_106 , 0 ) )
return;
V_105 -= V_106 ;
}
if ( V_105 ) {
if ( F_32 ( V_2 , V_4 , V_105 , 1 ) )
return;
}
if ( V_19 -> V_100 == V_101 &&
V_4 -> V_94 -> V_102 >= V_19 -> V_103 ) {
...
static T_2 F_36 ( int V_110 , void * V_111 )
{
...
int V_133 = 0 ;
unsigned int V_134 ;
V_133 |= F_39 ( & V_19 -> V_128 , V_132 | V_129 ) ;
V_133 |= F_39 ( & V_19 -> V_135 , V_136 ) ;
V_133 |= F_39 ( & V_19 -> V_124 , V_125 | V_129 ) ;
V_133 |= F_39 ( & V_19 -> V_137 , V_101 ) ;
V_133 |= F_39 ( & V_19 -> V_100 , V_101 | V_138 ) ;
if ( V_133 )
return 1 ;
V_133 |= F_40 ( V_19 -> V_128 ) ;
V_133 |= F_40 ( V_19 -> V_124 ) ;
V_133 |= F_40 ( V_19 -> V_100 ) ;
if ( V_133 )
return 2 ;
V_133 |= F_41 ( & V_19 -> V_139 , 0 ) ;
V_133 |= F_41 ( & V_19 -> V_140 , 0 ) ;
if ( V_19 -> V_124 == V_125 )
V_133 |= F_42 ( & V_19 -> V_141 ,
V_33 -> V_142 ) ;
else
V_133 |= F_41 ( & V_19 -> V_141 , 0 ) ;
V_133 |= F_41 ( & V_19 -> V_143 , V_19 -> V_28 ) ;
if ( V_19 -> V_100 == V_101 )
V_133 |= F_42 ( & V_19 -> V_103 , 1 ) ;
else
V_133 |= F_41 ( & V_19 -> V_103 , 0 ) ;
if ( V_133 )
return 3 ;
if ( V_19 -> V_124 == V_125 ) {
V_134 = V_19 -> V_141 ;
...
V_11 = F_50 ( V_2 , sizeof( * V_11 ) ) ;
if ( ! V_11 )
return - V_160 ;
V_51 = F_51 ( V_2 ) ;
if ( V_51 )
return V_51 ;
V_2 -> V_37 = F_52 ( V_153 , 2 ) ;
V_155 = 0 ;
if ( V_33 -> V_161 )
V_155 ++ ;
if ( V_33 -> V_145 )
...
static int F_57 ( struct V_152 * V_2 ,
