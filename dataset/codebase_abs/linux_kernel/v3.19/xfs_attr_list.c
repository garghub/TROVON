...
struct V_53 * V_54 ;
V_42 = V_50 -> V_55 ;
switch ( F_16 ( V_42 -> V_21 . V_56 . V_57 ) ) {
case V_58 :
case V_59 :
F_17 ( V_7 ) ;
F_18 ( NULL , V_50 ) ;
...
if ( F_21 ( V_71 -> V_39 ) == V_8 -> V_39 ) {
if ( V_8 -> V_40 == V_7 -> V_74 ) {
V_7 -> V_74 = 0 ;
break;
}
V_7 -> V_74 ++ ;
} else if ( F_21 ( V_71 -> V_39 ) >
V_8 -> V_39 ) {
V_7 -> V_74 = 0 ;
break;
}
