...
F_153 ( & V_9 -> V_11 . V_372 ) ;
}
V_9 -> V_11 . V_36 &= ~ ( V_373 | V_368 ) ;
...
static void F_150 ( struct V_74 * V_12 , int V_381 )
{
unsigned long V_382 ;
struct V_8 * V_9 = (struct V_8 * ) V_12 -> V_77 ;
unsigned long V_227 = V_5 ;
...
if ( F_156 ( V_365 ) )
break;
if ( V_381 && F_157 ( V_5 , V_382 + V_381 ) )
break;
V_227 = V_5 ;
V_321 = F_73 () ;
V_228 =
...
F_162 ( V_12 , V_9 -> V_11 . V_374 ,
! ( V_9 -> V_11 . V_36 & V_368 ) ) ;
#ifdef F_163
if ( V_9 -> V_11 . V_36 & V_387 )
return - V_388 ;
else
return - V_389 ;
#else
...
if ( V_12 -> V_13 . V_14 & V_392 ) {
V_386 = 1 ;
}
V_29 = 0 ;
F_164 ( & V_9 -> V_11 . V_372 , & V_385 ) ;
#ifdef F_103
F_5 ( L_101 ,
V_9 -> line , V_9 -> V_11 . V_92 ) ;
#endif
...
int V_29 ;
int V_394 = 0 ;
V_9 = V_195 + V_12 -> V_395 ;
if ( ! V_9 -> V_196 )
return - V_396 ;
#ifdef F_103
F_5 ( L_104 , V_365 -> V_366 , V_12 -> V_397 ,
V_9 -> V_11 . V_92 ) ;
#endif
V_9 -> V_11 . V_92 ++ ;
V_12 -> V_77 = V_9 ;
...
static void F_174 ( struct V_403 * V_404 , struct V_8 * V_9 )
{
unsigned long V_305 ;
F_175 ( V_404 , L_111 ,
V_9 -> line , ( unsigned long ) V_9 -> V_40 , V_9 -> V_51 ) ;
if ( ! V_9 -> V_40 || ( V_9 -> type == V_405 ) ) {
F_175 ( V_404 , L_112 ) ;
return;
}
F_175 ( V_404 , L_113 , V_9 -> V_21 ) ;
F_175 ( V_404 , L_114 ,
...
#endif
if ( V_9 -> V_129 . V_221 )
F_175 ( V_404 , L_119 , ( unsigned long ) V_9 -> V_129 . V_221 ) ;
if ( V_9 -> V_129 . V_220 )
F_175 ( V_404 , L_120 , ( unsigned long ) V_9 -> V_129 . V_220 ) ;
if ( V_9 -> V_129 . V_224 )
F_175 ( V_404 , L_121 , ( unsigned long ) V_9 -> V_129 . V_224 ) ;
if ( V_9 -> V_129 . V_215 )
F_175 ( V_404 , L_122 , ( unsigned long ) V_9 -> V_129 . V_215 ) ;
if ( ! F_141 ( V_9 ) )
F_176 ( V_404 , L_123 ) ;
if ( ! F_145 ( V_9 ) )
F_176 ( V_404 , L_124 ) ;
...
static int F_177 ( struct V_403 * V_404 , void * V_406 )
{
int V_187 ;
F_175 ( V_404 , L_129 , V_407 ) ;
for ( V_187 = 0 ; V_187 < V_194 ; V_187 ++ ) {
if ( ! V_195 [ V_187 ] . V_196 )
continue;
F_174 ( V_404 , & V_195 [ V_187 ] ) ;
}
#ifdef F_178
...
F_179 ( V_4 [ V_187 ] . V_6 ) ) ;
F_175 ( V_404 , V_4 [ V_187 ] . string , V_4 [ V_187 ] . V_1 ) ;
}
F_175 ( V_404 , L_131 , V_187 , V_3 ) ;
V_2 = 0 ;
#endif
return 0 ;
}
static int F_180 ( struct V_408 * V_408 , struct V_363 * V_363 )
{
...
int V_187 ;
struct V_8 * V_9 ;
struct V_410 * V_411 = F_184 ( V_194 ) ;
if ( ! V_411 )
return - V_250 ;
F_182 () ;
#if ! F_38 ( V_412 )
...
V_411 -> V_421 = V_422 ;
V_411 -> V_421 . V_14 =
V_423 | V_424 | V_425 | V_257 | V_392 ;
V_411 -> V_421 . V_426 = 115200 ;
V_411 -> V_421 . V_427 = 115200 ;
V_411 -> V_36 = V_428 ;
F_188 ( V_411 , & V_429 ) ;
V_430 = V_411 ;
...
if ( V_9 -> V_196 ) {
F_5 ( V_409 L_141 ,
V_430 -> V_397 , V_9 -> line , V_9 -> V_40 ) ;
}
F_192 ( & V_9 -> V_11 , V_411 , V_187 ) ;
}
if ( F_193 ( V_411 ) )
F_62 ( L_142 ) ;
#ifdef V_134
