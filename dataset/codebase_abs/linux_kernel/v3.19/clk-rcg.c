...
unsigned long * V_56 , struct V_8 * * V_57 )
{
unsigned long V_58 ;
struct V_13 * V_31 ;
V_44 = F_29 ( V_44 , V_51 ) ;
...
unsigned long * V_56 , struct V_8 * * V_31 )
{
struct V_10 * V_11 = F_4 ( V_9 ) ;
...
static long F_36 ( struct V_8 * V_9 , unsigned long V_51 ,
unsigned long * V_56 , struct V_8 * * V_57 )
{
struct V_10 * V_11 = F_4 ( V_9 ) ;
...
static int F_38 ( struct V_10 * V_11 , const struct V_43 * V_44 )
{
T_1 V_3 , V_27 , V_61 ;
struct V_26 * V_26 = & V_11 -> V_26 ;
T_1 V_7 = 0 ;
...
if ( V_11 -> V_26 . V_29 ) {
V_7 = F_8 ( V_26 -> V_50 ) ;
F_39 ( V_11 -> V_15 . V_16 , V_62 , V_7 , V_7 ) ;
F_6 ( V_11 -> V_15 . V_16 , V_11 -> V_47 , & V_27 ) ;
V_27 = F_16 ( V_26 , V_44 -> V_34 , V_44 -> V_35 , V_27 ) ;
F_12 ( V_11 -> V_15 . V_16 , V_11 -> V_47 , V_27 ) ;
F_6 ( V_11 -> V_15 . V_16 , V_11 -> V_17 , & V_3 ) ;
if ( V_11 -> V_15 . V_55 != V_11 -> V_17 ) {
F_6 ( V_11 -> V_15 . V_16 , V_11 -> V_15 . V_55 , & V_61 ) ;
V_61 = F_20 ( V_26 , V_44 -> V_34 , V_44 -> V_35 , V_61 ) ;
F_12 ( V_11 -> V_15 . V_16 , V_11 -> V_15 . V_55 , V_61 ) ;
} else {
V_3 = F_20 ( V_26 , V_44 -> V_34 , V_44 -> V_35 , V_3 ) ;
}
V_3 = F_19 ( V_26 , V_44 -> V_34 , V_44 -> V_35 , V_3 ) ;
...
F_12 ( V_11 -> V_15 . V_16 , V_11 -> V_17 , V_3 ) ;
F_39 ( V_11 -> V_15 . V_16 , V_62 , V_7 , 0 ) ;
return 0 ;
}
...
static int F_43 ( struct V_8 * V_9 , unsigned long V_51 ,
unsigned long V_54 )
{
return F_42 ( V_9 , V_51 ) ;
}
