...
static int
F_131 ( struct V_319 * V_305 )
{
struct V_14 * V_15 = V_305 -> V_320 ;
return F_125 ( V_15 ) ;
}
static inline void
F_132 ( const struct V_14 * V_15 )
{
T_2 V_321 ;
F_34 ( V_15 -> V_27 -> V_28 ,
L_61
...
V_15 -> V_86 = V_86 ;
V_15 -> V_266 = - 1 ;
if ( F_137 ( V_86 , F_138 ( 24 ) ) < 0 ||
F_139 ( V_86 , F_138 ( 24 ) ) < 0 ) {
F_38 ( V_27 -> V_28 ,
L_70
) ;
V_129 = - V_335 ;
...
V_129 = F_140 ( V_86 , L_71 ) ;
if ( V_129 < 0 )
goto V_334;
V_15 -> V_16 = F_141 ( V_86 , 0 ) ;
V_15 -> V_17 = F_141 ( V_86 , 1 ) ;
V_15 -> V_322 = F_141 ( V_86 , 2 ) ;
V_15 -> V_323 = F_141 ( V_86 , 3 ) ;
V_15 -> V_18 = F_141 ( V_86 , 4 ) ;
...
V_129 = F_133 ( V_27 , V_86 , V_344 -> V_354 , & V_15 ) ;
if ( V_129 < 0 )
goto V_334;
V_27 -> V_62 = V_15 ;
V_129 = F_149 (
...
{
struct V_326 * V_86 = F_168 ( V_28 ) ;
struct V_125 * V_27 = F_169 ( V_28 ) ;
struct V_14 * V_15 = V_27 -> V_62 ;
T_2 * V_363 ;
F_170 ( V_27 , V_364 ) ;
F_171 ( V_15 -> V_233 [ V_199 ] ) ;
F_171 ( V_15 -> V_233 [ V_198 ] ) ;
F_162 ( V_15 ) ;
