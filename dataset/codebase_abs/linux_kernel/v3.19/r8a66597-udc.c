...
static int T_6 F_135 ( struct V_294 * V_295 )
{
struct V_1 * V_1 = F_136 ( V_295 ) ;
F_137 ( & V_1 -> V_15 ) ;
F_138 ( & V_1 -> V_269 ) ;
...
static void F_140 ( struct V_275 * V_21 , struct V_278 * V_297 )
{
}
...
{
struct V_298 * V_299 ;
V_299 = F_142 ( V_295 , V_300 , L_20 ) ;
V_1 -> V_301 = F_143 ( & V_295 -> V_302 , V_299 ) ;
return F_144 ( V_1 -> V_301 ) ;
}
static int F_145 ( struct V_294 * V_295 )
{
struct V_303 * V_302 = & V_295 -> V_302 ;
char V_304 [ 8 ] ;
struct V_298 * V_299 , * V_305 ;
int V_252 ;
void T_7 * V_5 = NULL ;
struct V_1 * V_1 = NULL ;
int V_31 = 0 ;
int V_54 ;
unsigned long V_306 ;
V_299 = F_146 ( V_295 , V_300 , 0 ) ;
V_5 = F_143 ( & V_295 -> V_302 , V_299 ) ;
if ( F_147 ( V_5 ) )
return F_148 ( V_5 ) ;
V_305 = F_146 ( V_295 , V_307 , 0 ) ;
V_252 = V_305 -> V_308 ;
V_306 = V_305 -> V_274 & V_309 ;
if ( V_252 < 0 ) {
F_17 ( V_302 , L_21 ) ;
return - V_107 ;
}
V_1 = F_149 ( V_302 , sizeof( struct V_1 ) , V_212 ) ;
if ( V_1 == NULL )
return - V_81 ;
F_150 ( & V_1 -> V_14 ) ;
F_151 ( V_295 , V_1 ) ;
V_1 -> V_46 = F_152 ( V_302 ) ;
V_1 -> V_157 = V_306 == V_310 ;
V_1 -> V_15 . V_311 = & V_312 ;
V_1 -> V_15 . V_288 = V_228 ;
V_1 -> V_15 . V_313 = V_314 ;
F_153 ( & V_1 -> V_269 ) ;
V_1 -> V_269 . V_315 = F_113 ;
V_1 -> V_269 . V_316 = ( unsigned long ) V_1 ;
V_1 -> V_5 = V_5 ;
if ( V_1 -> V_46 -> V_47 ) {
snprintf ( V_304 , sizeof( V_304 ) , L_22 , V_295 -> V_317 ) ;
V_1 -> V_296 = F_154 ( V_302 , V_304 ) ;
if ( F_147 ( V_1 -> V_296 ) ) {
F_17 ( V_302 , L_23 , V_304 ) ;
return F_148 ( V_1 -> V_296 ) ;
}
F_155 ( V_1 -> V_296 ) ;
}
if ( V_1 -> V_46 -> V_318 ) {
V_31 = F_141 ( V_1 , V_295 ) ;
if ( V_31 < 0 )
goto V_319;
}
F_12 ( V_1 ) ;
V_31 = F_156 ( V_302 , V_252 , F_110 , V_320 ,
V_314 , V_1 ) ;
if ( V_31 < 0 ) {
F_17 ( V_302 , L_24 , V_31 ) ;
goto V_319;
}
F_14 ( & V_1 -> V_15 . V_321 ) ;
V_1 -> V_15 . V_211 = & V_1 -> V_21 [ 0 ] . V_21 ;
F_14 ( & V_1 -> V_15 . V_211 -> V_321 ) ;
for ( V_54 = 0 ; V_54 < V_27 ; V_54 ++ ) {
struct V_57 * V_21 = & V_1 -> V_21 [ V_54 ] ;
if ( V_54 != 0 ) {
F_14 ( & V_1 -> V_21 [ V_54 ] . V_21 . V_321 ) ;
F_123 ( & V_1 -> V_21 [ V_54 ] . V_21 . V_321 ,
& V_1 -> V_15 . V_321 ) ;
}
V_21 -> V_1 = V_1 ;
F_14 ( & V_21 -> V_22 ) ;
V_21 -> V_21 . V_313 = V_322 [ V_54 ] ;
V_21 -> V_21 . V_311 = & V_323 ;
F_157 ( & V_21 -> V_21 , 512 ) ;
}
...
V_1 -> V_210 -> V_324 = F_140 ;
V_31 = F_158 ( V_302 , & V_1 -> V_15 ) ;
if ( V_31 )
goto V_325;
F_159 ( V_302 , L_25 , V_326 ) ;
return 0 ;
V_325:
F_121 ( & V_1 -> V_21 [ 0 ] . V_21 , V_1 -> V_210 ) ;
V_319:
