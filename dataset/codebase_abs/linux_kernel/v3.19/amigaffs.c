...
return F_29 ( V_1 -> V_7 ) -> V_94 & V_96 ;
}
int
F_44 ( const unsigned char * V_13 , int V_97 , bool V_98 )
{
int V_99 ;
if ( V_97 > 30 ) {
if ( V_98 )
...
int
F_45 ( unsigned char * V_102 , struct V_29 * V_29 )
{
int V_97 = F_46 ( V_29 -> V_103 . V_97 , 30u ) ;
* V_102 ++ = V_97 ;
memcpy ( V_102 , V_29 -> V_103 . V_13 , V_97 ) ;
return V_97 ;
}
