...
{
return F_43 ( V_83 , F_40 , F_44 ( V_82 ) ) ;
}
...
void
F_47 ( T_2 * V_15 , unsigned char * V_87 , unsigned short V_32 )
{
struct V_19 * V_20 ;
T_1 * V_10 = V_15 -> V_18 ;
struct V_8 * V_9 ;
...
V_88 = F_28 ( V_87 ) ;
V_92 = F_29 ( V_87 ) ;
if ( ( V_92 == V_94 ) && ( V_89 < 30 ) ) {
V_91 = V_32 + ( 30 - V_89 ) ;
if ( ! ( V_20 = F_17 ( V_91 , V_42 ) ) ) {
F_2 ( V_5 L_42 ,
V_15 -> V_26 ) ;
return;
}
memcpy ( F_18 ( V_20 , V_89 ) , V_87 , V_89 ) ;
memcpy ( F_18 ( V_20 , 2 * sizeof( T_8 ) ) , V_93 , 2 * sizeof( T_8 ) ) ;
memcpy ( F_18 ( V_20 , V_32 - V_89 ) , V_87 + V_89 ,
V_32 - V_89 ) ;
F_36 ( V_20 -> V_58 , 30 ) ;
} else {
if ( ! ( V_20 = F_17 ( V_32 , V_42 ) ) ) {
...
memcpy ( F_18 ( V_20 , V_32 ) , V_87 , V_32 ) ;
}
switch ( F_29 ( V_20 -> V_58 ) )
{
case V_95 :
V_90 = F_48 ( V_20 -> V_58 , 12 ) ;
switch ( V_90 )
{
case 0 :
F_49 ( & V_10 -> V_13 , V_88 , F_31 ( V_20 -> V_58 ) ,
V_6 [ V_88 - 1 ] . V_30 . V_39 ) ;
break;
case 0x0001 :
F_2 ( V_5 L_43
L_44 , V_15 -> V_26 ) ;
...
F_13 ( & V_10 -> V_21 ) ;
F_9 ( V_10 -> V_22 [ V_10 -> V_98 ] ) ;
V_10 -> V_22 [ V_10 -> V_98 ++ ] = NULL ;
if ( V_10 -> V_98 >= V_24 )
V_10 -> V_98 = 0 ;
if ( V_10 -> V_25 -- == V_24 )
F_53 ( & V_10 -> V_51 ) ;
...
if ( ! V_10 -> V_25 )
return (struct V_19 * ) NULL ;
return ( V_10 -> V_22 [ V_10 -> V_98 ] ) ;
}
int F_55 ( void )
{
int V_14 ;
for ( V_14 = 0 ; V_14 < V_4 ; V_14 ++ ) {
memset ( & ( V_6 [ V_14 ] ) , 0 , sizeof( V_99 ) ) ;
}
return ( 0 ) ;
}
void
...
if ( ! V_10 ) return;
V_9 = & V_10 -> V_51 ;
strcpy ( V_9 -> V_100 , L_52 ) ;
V_9 -> V_78 . V_101 = 2 ;
V_9 -> V_78 . V_102 = 0 ;
V_9 -> V_78 . V_103 = 3 ;
V_9 -> V_78 . V_104 = 2 ;
V_9 -> V_105 . V_106 = V_15 -> V_26 ;
V_9 -> V_105 . V_107 = V_15 -> V_50 ;
V_9 -> V_105 . V_108 = V_109 |
V_110 ;
V_9 -> V_105 . V_111 = V_112 |
( V_15 -> V_113 ? V_114 : 0 ) |
V_115 ;
V_9 -> V_105 . V_116 = V_117 |
( V_15 -> V_113 ? V_118 : 0 ) |
V_119 ;
V_9 -> V_105 . V_120 = V_121 |
V_122 |
( V_15 -> V_113 ? V_123 : 0 ) |
( V_15 -> V_113 ? V_124 : 0 ) |
V_125 ;
