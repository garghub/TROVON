...
F_65 ( & V_43 -> V_52 ) ;
V_43 -> V_54 ++ ;
V_43 -> V_53 += V_58 -> V_78 + ( F_66 ( V_58 ) ? V_79 : 0 ) ;
F_67 ( & V_43 -> V_52 ) ;
F_68 ( V_58 ) -> V_80 = V_17 ;
F_68 ( V_58 ) -> V_81 = NULL ;
...
V_100 . V_104 = V_96 -> V_105 ;
V_100 . V_106 = F_82 ( V_96 -> V_107 ) ;
V_100 . V_108 = V_92 ;
V_100 . V_109 = V_91 ;
V_98 = F_83 ( V_6 , & V_100 ) ;
if ( F_30 ( V_98 ) )
...
int F_87 ( struct V_17 * V_17 , struct V_57 * V_58 ,
struct V_74 * V_114 )
{
if ( F_70 ( ! V_17 -> V_10 -> V_115 ) )
return - V_29 ;
return V_17 -> V_10 -> V_115 ( V_17 , V_58 , V_114 ) ;
}
