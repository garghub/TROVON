...
void F_61 ( struct V_13 * V_14 , int V_101 )
{
F_62 ( V_14 -> V_90 . V_26 -> V_50 . V_65 , V_101 ) ;
}
int F_63 ( struct V_13 * V_14 )
{
struct V_23 * V_102 ;
int V_33 = 0 ;
V_102 = F_7 ( V_14 -> V_90 . V_26 -> V_63 . V_94 ) ;
V_33 += F_33 ( V_102 ) ;
return V_33 ;
}
bool F_64 ( struct V_13 * V_14 , struct V_23 * V_102 )
{
if ( V_102 == F_7 ( V_14 -> V_90 . V_26 -> V_63 . V_94 ) )
return true ;
return false ;
}
