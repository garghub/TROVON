...
unsigned int F_51 ( struct V_67 * V_67 , T_1 * V_72 )
{
...
F_62 ( & V_2 -> V_12 -> V_25 , & V_72 ) ;
F_13 ( V_24 ) ;
while ( V_96 < V_94 && V_73 == 0 ) {
if ( F_54 ( V_2 -> V_12 ) ) {
if ( V_96 )
break;
if ( V_67 -> V_100 & V_101 ) {
...
F_65 ( V_2 -> V_12 , V_12 ) ;
V_73 = F_66 ( ( void V_82 * ) V_93 + V_96 , V_12 ,
V_2 -> V_12 -> V_38 ) ;
if ( ! V_73 )
V_96 += V_2 -> V_12 -> V_38 ;
else
...
V_2 -> V_4 . V_9 , V_2 -> V_4 . V_5 , V_73 ? L_44 : L_45 , V_73 ) ;
return V_73 ? V_73 : V_96 ;
}
