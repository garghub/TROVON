...
V_173 -> V_37 = V_131 ;
V_173 -> V_115 = V_4 ;
V_173 -> V_188 = & V_4 -> V_3 . V_183 -> V_189 ;
F_88 ( V_173 , V_4 -> V_63 ) ;
if ( F_3 ( V_4 , 1 , 1 ) ) {
switch ( V_4 -> V_65 ) {
case V_190 :
...
static int V_194 ;
if ( V_194 ++ == 0 )
F_20 ( V_195 L_24 , V_196 ) ;
}
static int F_93 ( struct V_197 * V_183 , const struct V_198 * V_199 )
{
struct V_200 * V_201 ;
struct V_1 * V_4 ;
int V_38 ;
...
V_201 = F_94 () ;
V_38 = - V_174 ;
if ( ( V_183 -> V_184 << V_179 ) & ~ ( T_5 ) V_203 ) {
...
snprintf ( V_4 -> V_185 , sizeof( V_4 -> V_185 ) ,
V_205 L_28 , 'a' + ( ( int ) V_183 -> V_184 % 26 ) ) ;
V_4 -> V_63 = - 1 ;
V_202 = F_95 ( V_201 , V_183 -> V_206 , L_29 , NULL ) ;
V_4 -> V_202 = V_202 ? * V_202 : 0 ;
F_96 ( & V_4 -> V_42 , V_207 ,
( unsigned long ) V_4 ) ;
F_97 ( & V_4 -> V_98 , V_208 ) ;
V_38 = F_98 ( & V_4 -> V_3 , V_183 , V_209 ,
V_210 , F_99 ( V_210 ) ,
& V_211 , V_4 -> V_185 ) ;
if ( V_38 )
goto V_212;
...
static int F_103 ( struct V_197 * V_183 )
{
struct V_1 * V_4 = F_104 ( & V_183 -> V_189 ) ;
if ( V_4 ) {
unsigned long V_32 ;
F_37 ( & V_4 -> V_3 . V_95 , V_32 ) ;
F_62 ( V_4 -> V_16 -> V_37 ) ;
...
struct V_8 * V_9 = & V_4 -> V_3 . V_35 [ V_36 ] ;
T_2 V_217 ;
for ( V_217 = V_9 -> V_85 ; V_217 != V_9 -> V_108 ; V_217 = F_32 ( V_9 , V_217 ) ) {
struct V_69 * V_70 = F_29 ( V_9 , V_217 ) ;
struct V_74 * V_75 = & V_4 -> V_76 [ V_217 ] ;
struct V_77 * V_78 ;
F_31 ( V_4 -> V_3 . V_47 , V_70 -> V_82 , V_70 -> V_83 ) ;
V_70 -> V_79 . V_80 = V_84 ;
V_9 -> V_85 = F_32 ( V_9 , V_217 ) ;
V_78 = V_75 -> V_78 ;
if ( V_78 == NULL ) {
F_27 ( V_4 , V_70 ) ;
continue;
...
static void V_207 ( unsigned long V_218 )
{
struct V_1 * V_4 = (struct V_1 * ) V_218 ;
struct V_2 * V_3 = & V_4 -> V_3 ;
unsigned long V_32 ;
F_37 ( & V_3 -> V_95 , V_32 ) ;
if ( ! ( V_4 -> V_3 . V_219 & V_220 ) ) {
F_40 ( V_27 L_30 ,
V_4 -> V_185 , V_4 -> V_202 ) ;
F_110 ( V_4 ) ;
F_12 ( V_4 ) ;
...
static void V_208 ( struct V_221 * V_222 )
{
struct V_1 * V_4 ;
struct V_2 * V_3 ;
unsigned long V_32 ;
V_4 = F_2 ( V_222 , struct V_1 , V_98 ) ;
V_3 = & V_4 -> V_3 ;
F_37 ( & V_3 -> V_95 , V_32 ) ;
F_49 ( V_4 ) ;
F_46 ( & V_3 -> V_95 , V_32 ) ;
...
if ( V_4 -> V_202 )
F_115 ( & V_4 -> V_42 ,
F_116 ( V_224 + V_225 * V_4 -> V_202 ) ) ;
F_115 ( & V_4 -> V_3 . V_216 , F_116 ( V_224 + V_225 ) ) ;
return;
V_223:
F_79 ( & V_4 -> V_3 ) ;
}
