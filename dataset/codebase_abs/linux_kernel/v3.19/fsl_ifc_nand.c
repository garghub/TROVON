...
V_8 -> V_2 . V_8 = V_7 ;
V_8 -> V_2 . V_146 = V_147 ;
if ( ( F_9 ( & V_13 -> V_148 [ V_8 -> V_40 ] . V_149 ) ) & V_150 )
V_7 -> V_151 = F_22 ;
else
V_7 -> V_151 = F_20 ;
V_7 -> V_152 = F_18 ;
...
T_7 V_23 )
{
T_3 V_149 = F_9 ( & V_13 -> V_148 [ V_40 ] . V_149 ) ;
if ( ! ( V_149 & V_190 ) )
return 0 ;
if ( ( V_149 & V_191 ) != V_192 )
return 0 ;
return ( V_149 & V_193 ) == F_40 ( V_23 ) ;
}
static int F_41 ( struct V_194 * V_43 )
{
...
return - V_183 ;
V_13 = V_204 -> V_14 ;
V_198 = F_42 ( V_200 , 0 , & V_196 ) ;
if ( V_198 ) {
F_11 ( & V_43 -> V_43 , L_34 , V_44 ) ;
return V_198 ;
}
for ( V_40 = 0 ; V_40 < V_204 -> V_205 ; V_40 ++ ) {
if ( F_39 ( V_13 , V_40 , V_196 . V_206 ) )
break;
}
if ( V_40 >= V_204 -> V_205 ) {
F_11 ( & V_43 -> V_43 , L_35 ,
...
V_8 = F_43 ( & V_43 -> V_43 , sizeof( * V_8 ) , V_207 ) ;
if ( ! V_8 )
return - V_208 ;
F_44 ( & V_209 ) ;
if ( ! V_204 -> V_210 ) {
V_16 = F_45 ( sizeof( * V_16 ) , V_207 ) ;
if ( ! V_16 ) {
F_46 ( & V_209 ) ;
return - V_208 ;
}
...
V_16 -> V_23 = NULL ;
V_204 -> V_210 = V_16 ;
F_47 ( & V_16 -> V_165 . V_211 ) ;
F_48 ( & V_16 -> V_165 . V_212 ) ;
} else {
V_16 = V_204 -> V_210 ;
}
F_46 ( & V_209 ) ;
...
V_8 -> V_11 = V_204 ;
V_8 -> V_43 = & V_43 -> V_43 ;
V_8 -> V_24 = F_49 ( V_196 . V_206 , F_50 ( & V_196 ) ) ;
if ( ! V_8 -> V_24 ) {
...
V_220 ,
& V_13 -> V_18 . V_221 ) ;
V_8 -> V_2 . V_188 = F_52 ( V_207 , L_37 , ( V_222 ) V_196 . V_206 ) ;
if ( ! V_8 -> V_2 . V_188 ) {
V_198 = - V_208 ;
goto V_213;
}
...
static int F_57 ( struct V_194 * V_43 )
{
