...
static int F_72 ( struct V_252 * V_253 )
{
struct V_254 * V_255 = V_253 -> V_7 . V_256 ;
struct V_257 * V_258 = V_253 -> V_7 . V_259 ;
struct V_4 * V_5 ;
int V_126 = 0 ;
V_5 = F_73 ( & V_253 -> V_7 , sizeof( * V_5 ) , V_260 ) ;
if ( ! V_5 ) {
...
V_5 -> V_28 = V_258 ;
if ( V_255 ) {
V_126 = F_74 ( & V_253 -> V_7 , V_255 , V_5 -> V_28 ) ;
if ( V_126 ) {
F_3 ( & V_253 -> V_7 , L_47 ) ;
return V_126 ;
}
...
V_5 -> V_76 . V_145 = F_75 ( V_263 ) ;
V_5 -> V_76 . V_141 = F_50 ;
V_5 -> V_76 . V_139 = V_264 ;
V_5 -> V_76 . V_138 = F_75 ( V_264 ) ,
V_5 -> V_76 . V_265 =
F_43 ;
F_76 ( & V_5 -> V_6 , V_266 , V_267 ) ;
V_5 -> V_6 . V_268 = F_1 ;
F_76 ( & V_5 -> V_13 , V_266 , V_267 ) ;
V_5 -> V_13 . V_268 =
F_5 ;
V_5 -> V_10 =
F_77 ( L_48 ) ;
