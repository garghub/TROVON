...
V_6 = ( ( V_76 -> V_74 - ( T_4 ) V_76 -> V_83 ) * 8 + V_90 / 2 ) / V_90 ;
...
unsigned long V_92 = ( ( V_76 -> V_74 - ( T_4 ) V_76 -> V_89 - 1 ) *
1015 + V_90 / 2 ) / V_90 + 9 ;
if ( V_92 <= 32 )
V_6 = V_92 ;
else if ( V_92 <= 64 )
...
unsigned int V_94 = ( ( exp -> V_74 - ( T_4 ) exp -> V_83 ) * 1048 +
V_90 / 2 ) / V_90 + 1 ;
T_3 V_95 ;
F_11 ( V_3 , & V_95 ) ;
F_19 ( & V_3 -> V_33 , L_5 ,
...
if ( F_50 ( V_101 , V_110 ) &
V_114 )
return F_9 ( V_3 , V_119 , 0x8000 ) ;
else
return F_8 ( V_3 , V_119 , 0x8000 ) ;
}
...
struct V_1 * V_1 ;
struct V_100 * V_101 = F_39 ( V_3 ) ;
struct V_122 * V_123 = F_53 ( V_3 -> V_33 . V_124 ) ;
int V_7 ;
if ( ! V_101 ) {
F_44 ( & V_3 -> V_33 , L_9 ) ;
return - V_72 ;
...
V_1 = F_56 ( & V_3 -> V_33 , sizeof( struct V_1 ) , V_126 ) ;
if ( ! V_1 )
return - V_127 ;
F_57 ( & V_1 -> V_4 , V_3 , & V_128 ) ;
F_58 ( & V_1 -> V_78 , 5 ) ;
F_59 ( & V_1 -> V_78 , & V_129 ,
V_85 , 0 , 1 , 1 , 0 ) ;
F_59 ( & V_1 -> V_78 , & V_129 ,
...
& V_129 , V_81 , 1 , 0 ,
V_46 ) ;
V_1 -> V_82 = F_59 ( & V_1 -> V_78 , & V_129 ,
V_130 , 1 , 255 , 1 , 255 ) ;
V_1 -> V_4 . V_131 = & V_1 -> V_78 ;
if ( V_1 -> V_78 . error )
