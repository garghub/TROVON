...
V_20 -> V_43 . V_102 ;
V_20 -> V_86 [ V_103 ] =
( V_20 -> V_43 . V_104 ) & 0xFF ;
V_20 -> V_86 [ V_105 ] =
( V_20 -> V_43 . V_104 >> 8 ) & 0xFF ;
V_20 -> V_86 [ V_106 ] =
( V_20 -> V_43 . V_107 ) & 0xFF ;
V_20 -> V_86 [ V_108 ] =
( V_20 -> V_43 . V_107 >> 8 ) & 0xFF ;
if ( V_20 -> V_26 == V_27 ) {
...
V_20 -> V_26 = V_27 ;
if ( V_20 -> V_43 . V_117 != 0 ) {
F_15 ( & V_20 -> V_2 -> V_7 , L_21 ) ;
V_71 = V_76 | V_75 ;
if ( ( V_20 -> V_43 . V_117 == 0x20 ) ||
( V_20 -> V_43 . V_117 == 0x30 ) )
V_71 |= V_116 ;
V_71 |= V_20 -> V_43 . V_117 ;
V_5 = F_17 ( V_20 -> V_2 ,
( V_6 | V_74 ) , V_71 ) ;
if ( V_5 < 0 )
F_3 ( & V_20 -> V_2 -> V_7 ,
...
V_5 = F_17 ( V_20 -> V_2 ,
V_6 | V_74 , 0x00 ) ;
if ( V_20 -> V_65 && V_20 -> V_65 -> V_120 )
V_20 -> V_65 -> V_120 ( V_20 -> V_2 ) ;
return V_5 ;
}
static
...
V_126 += V_122 [ V_21 ] ;
V_125 -> V_128 = V_128 ( V_125 -> V_128 , V_122 [ V_21 ] ) ;
V_125 -> V_130 = V_130 ( V_125 -> V_130 , V_122 [ V_21 ] ) ;
}
V_125 -> V_132 = V_126 / V_123 ;
V_126 = 0 ;
for ( V_21 = 0 ; V_21 < V_123 ; V_21 ++ ) {
V_127 = V_122 [ V_21 ] - V_125 -> V_132 ;
V_126 += V_127 * V_127 ;
}
...
T_1 V_138 ;
T_1 V_139 = V_20 -> V_26 ;
if ( V_20 -> V_43 . V_140 > V_135 ) {
F_3 ( & V_20 -> V_2 -> V_7 ,
L_24 ,
V_8 , V_20 -> V_43 . V_140 ) ;
V_20 -> V_43 . V_140 = V_135 ;
}
F_19 ( V_10 ) ;
V_138 = V_20 -> V_43 . V_117 ;
V_20 -> V_43 . V_117 |= V_141 ;
F_16 ( V_10 ) ;
for ( V_21 = 0 ; V_21 < V_20 -> V_43 . V_140 ; V_21 ++ ) {
F_18 ( 15 ) ;
F_12 ( V_10 ) ;
V_134 [ V_21 ] = V_20 -> V_64 ;
...
V_137 = & V_136 [ V_142 ] ;
F_22 ( V_134 ,
V_20 -> V_43 . V_140 , V_137 ) ;
V_20 -> V_43 . V_107 = ( V_137 -> V_130 << 1 ) - V_137 -> V_132 ;
F_15 ( & V_20 -> V_2 -> V_7 , L_26 ,
V_137 -> V_128 , V_137 -> V_132 , V_137 -> V_130 ) ;
F_15 ( & V_20 -> V_2 -> V_7 ,
L_27 ,
V_20 -> V_2 -> V_80 , V_20 -> V_43 . V_107 ) ;
V_20 -> V_43 . V_117 = V_138 ;
if ( V_139 == V_27 )
F_16 ( V_10 ) ;
}
static T_5 F_25 ( struct V_143 * V_7 ,
struct V_144 * V_145 , char * V_16 )
{
struct V_19 * V_20 = F_6 ( F_26 ( V_7 ) ) ;
return snprintf ( V_16 , V_146 , L_28 , V_20 -> V_26 ) ;
}
static T_5 F_27 ( struct V_143 * V_7 ,
struct V_144 * V_145 , const char * V_16 , T_6 V_147 )
{
...
case V_55 :
case V_56 :
return snprintf ( V_16 , V_146 , L_29 , L_30 ) ;
}
return snprintf ( V_16 , V_146 , L_29 , L_31 ) ;
}
static T_5 F_30 ( struct V_143 * V_7 ,
struct V_144 * V_145 , char * V_16 )
{
return snprintf ( V_16 , V_146 , L_29 , L_32 ) ;
}
...
struct V_19 * V_20 = F_6 ( F_26 ( V_7 ) ) ;
int V_149 , V_150 ;
V_149 = ( V_151 - ( T_1 ) V_20 -> V_43 . V_84 ) + 1 ;
V_150 = V_149 * V_152 ;
V_149 /= 1000 ;
V_150 %= 1000 ;
return snprintf ( V_16 , V_146 , L_33 , V_149 , V_150 ) ;
}
...
struct V_153 V_154 ;
int V_5 ;
V_5 = F_33 ( V_16 , 100 , & V_154 . integer , & V_154 . V_155 ) ;
if ( V_5 )
return V_5 ;
V_154 . V_155 /= 3 ;
V_20 -> V_43 . V_84 =
...
{
struct V_19 * V_20 = F_6 ( F_26 ( V_7 ) ) ;
return snprintf ( V_16 , V_146 , L_28 ,
V_20 -> V_43 . V_78 ) ;
}
...
struct V_19 * V_20 = F_6 ( V_10 ) ;
unsigned long V_148 ;
if ( F_36 ( V_16 , 0 , & V_148 ) )
return - V_109 ;
if ( V_148 )
V_20 -> V_43 . V_78 = V_148 ;
F_20 ( V_10 ) ;
return V_147 ;
}
...
V_149 = ( V_151 - ( T_1 ) V_20 -> V_43 . V_84 ) + 1 ;
V_150 = V_149 * V_152 ;
V_157 = V_150 * ( V_20 -> V_43 . V_100 & 0x0F ) ;
V_149 = V_157 / 1000 ;
V_150 = V_157 % 1000 ;
return snprintf ( V_16 , V_146 , L_33 , V_149 , V_150 ) ;
}
...
struct V_19 * V_20 = F_6 ( F_26 ( V_7 ) ) ;
int V_149 , V_150 , V_157 ;
V_149 = ( V_151 - ( T_1 ) V_20 -> V_43 . V_88 ) + 1 ;
V_150 = V_149 * V_152 ;
V_157 = V_150 * ( ( V_20 -> V_43 . V_100 & 0xF0 ) >> 4 ) ;
V_149 = V_157 / 1000 ;
V_150 = V_157 % 1000 ;
return snprintf ( V_16 , V_146 , L_33 , V_149 , V_150 ) ;
}
...
int V_158 = 0 ;
while ( V_21 < ( V_159 * 3 ) ) {
V_158 += snprintf ( V_16 + V_158 , V_146 , L_37 ,
V_20 -> V_41 [ V_21 ] . V_15 ,
V_20 -> V_41 [ V_21 ] . V_11 ,
V_20 -> V_41 [ V_21 ] . V_12 ) ;
...
V_158 += snprintf ( V_16 + V_158 , V_146 , L_38 ) ;
return V_158 ;
}
...
struct V_9 * V_10 = F_26 ( V_7 ) ;
struct V_19 * V_20 = F_6 ( V_10 ) ;
int V_148 [ F_44 ( V_20 -> V_41 ) * 3 + 1 ] ;
int V_160 ;
F_45 ( V_16 , F_44 ( V_148 ) , V_148 ) ;
V_160 = V_148 [ 0 ] ;
if ( ( V_160 % 3 ) || V_160 < 6 ||
V_160 > ( ( F_44 ( V_20 -> V_41 ) - 1 ) * 3 ) ) {
F_15 ( V_7 , L_39 , V_160 ) ;
return - V_109 ;
}
...
memcpy ( V_20 -> V_41 , & V_148 [ 1 ] , ( V_148 [ 0 ] * 4 ) ) ;
F_20 ( V_10 ) ;
return V_147 ;
}
...
int V_5 ;
if ( V_162 -> type == V_166 )
V_5 = ! ! ( V_20 -> V_43 . V_117 & 0x10 ) ;
else
V_5 = ! ! ( V_20 -> V_43 . V_117 & 0x20 ) ;
return V_5 ;
}
...
if ( V_162 -> type == V_166 ) {
if ( V_4 )
V_20 -> V_43 . V_117 |= 0x10 ;
else
V_20 -> V_43 . V_117 &= 0x20 ;
} else {
if ( V_4 )
V_20 -> V_43 . V_117 |= 0x20 ;
else
...
struct V_9 * V_10 ;
struct V_19 * V_20 ;
V_10 = F_60 ( & V_194 -> V_7 , sizeof( * V_20 ) ) ;
if ( ! V_10 )
return - V_197 ;
V_20 = F_6 ( V_10 ) ;
V_20 -> V_2 = V_194 ;
...
F_62 ( & V_20 -> V_49 ) ;
V_20 -> V_26 = V_200 ;
V_20 -> V_65 = V_194 -> V_7 . V_201 ;
V_20 -> V_51 = V_51 -> V_199 ;
V_20 -> V_202 =
& V_203 [ V_204 [ V_51 -> V_199 ] ] ;
V_10 -> V_168 = V_20 -> V_202 -> V_168 ;
V_10 -> V_7 . V_205 = & V_194 -> V_7 ;
V_10 -> V_206 = V_207 ;
V_10 -> V_80 = V_20 -> V_2 -> V_80 ;
V_10 -> V_208 = V_20 -> V_202 -> V_177 ;
V_10 -> V_209 = V_20 -> V_202 -> V_210 ;
if ( V_194 -> V_186 ) {
...
if ( V_20 -> V_65 && V_20 -> V_65 -> V_213 ) {
T_9 V_214 = { V_215 } ;
V_20 -> V_65 -> V_213 ( V_7 , V_214 ) ;
}
return V_5 ;
}
