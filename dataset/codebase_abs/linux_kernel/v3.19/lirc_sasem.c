...
if ( V_7 )
F_15 ( & V_2 -> V_19 -> V_19 , L_26 , V_57 , V_45 ) ;
F_37 ( & V_61 ) ;
V_59 = ( V_61 . V_62 - V_2 -> V_63 . V_62 ) * 1000 +
( V_61 . V_64 - V_2 -> V_63 . V_64 ) / 1000 ;
if ( memcmp ( V_45 , L_27 , 8 ) == 0 ) {
if ( ( V_59 < 250 ) && ( V_2 -> V_65 != 0 ) ) {
memcpy ( V_45 , & V_2 -> V_66 , 8 ) ;
V_2 -> V_63 . V_62 = V_61 . V_62 ;
V_2 -> V_63 . V_64 = V_61 . V_64 ;
}
} else {
memcpy ( & V_2 -> V_66 , V_45 , 8 ) ;
V_2 -> V_65 = 1 ;
V_2 -> V_63 . V_62 = V_61 . V_62 ;
V_2 -> V_63 . V_64 = V_61 . V_64 ;
}
F_38 ( V_2 -> V_5 -> V_6 , V_45 ) ;
...
struct V_1 * V_2 = NULL ;
int V_48 ;
F_15 ( & V_14 -> V_19 , L_29 , V_8 ) ;
V_19 = F_41 ( F_42 ( V_14 ) ) ;
V_74 = V_14 -> V_83 ;
V_79 = V_74 -> V_84 . V_85 ;
V_81 = 0 ;
V_80 = 0 ;
for ( V_48 = 0 ; V_48 < V_79 && ! ( V_81 && V_80 ) ; ++ V_48 ) {
struct V_75 * V_86 ;
int V_87 ;
int V_88 ;
V_86 = & V_74 -> V_89 [ V_48 ] . V_84 ;
V_87 = V_86 -> V_35 & V_90 ;
V_88 = V_86 -> V_91 & V_92 ;
if ( ! V_81 &&
V_87 == V_93 &&
...
V_8 ) ;
V_82 = 0 ;
V_2 = F_43 ( sizeof( struct V_1 ) , V_43 ) ;
if ( ! V_2 ) {
V_82 = 1 ;
goto V_96;
}
V_5 = F_43 ( sizeof( struct V_76 ) , V_43 ) ;
if ( ! V_5 ) {
V_82 = 2 ;
goto V_96;
}
V_6 = F_44 ( sizeof( struct V_77 ) , V_43 ) ;
if ( ! V_6 ) {
V_82 = 3 ;
goto V_96;
}
...
F_15 ( & V_14 -> V_19 ,
L_41 ,
V_8 , V_19 -> V_111 -> V_112 , V_19 -> V_113 ) ;
V_109:
F_16 ( & V_2 -> V_20 ) ;
V_96:
switch ( V_82 ) {
