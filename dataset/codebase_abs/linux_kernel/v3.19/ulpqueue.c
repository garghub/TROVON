...
if ( ! F_31 ( V_11 , & F_16 ( V_22 ) -> V_39 ) )
goto V_38;
if ( F_32 ( & F_16 ( V_22 ) -> V_7 ) == 0 ) {
V_31 = & V_22 -> V_28 ;
} else {
if ( V_2 -> V_7 ) {
if ( ( V_11 -> V_19 & V_40 ) ||
...
F_38 ( & V_2 -> V_5 , V_45 , F_12 ( V_11 ) ) ;
}
static struct V_10 * F_39 ( struct V_49 * V_49 ,
...
struct V_8 * V_27 = F_40 ( V_50 ) -> V_55 ;
if ( V_50 == V_51 )
V_45 = NULL ;
else
V_45 = V_50 -> V_56 ;
...
return V_63 ;
V_71:
V_63 = F_39 ( F_47 ( V_2 -> V_4 -> V_30 . V_22 ) ,
& V_2 -> V_5 , V_61 , V_45 ) ;
if ( V_63 )
V_63 -> V_19 |= V_20 ;
goto V_72;
...
void F_52 ( struct V_1 * V_2 , T_2 V_78 )
{
...
if ( V_83 > V_82 )
break;
if ( V_83 == V_82 && F_58 ( V_88 , V_84 ) )
break;
}
F_38 ( & V_2 -> V_6 , V_45 , F_12 ( V_11 ) ) ;
}
...
static void F_59 ( struct V_1 * V_2 , T_5 V_82 )
{
struct V_8 * V_45 , * V_29 ;
struct V_10 * V_46 ;
struct V_10 * V_11 ;
...
V_83 = V_46 -> V_85 ;
V_84 = V_46 -> V_88 ;
if ( V_83 == V_82 && V_84 == F_55 ( V_81 , V_83 ) ) {
F_56 ( V_81 , V_83 ) ;
F_22 ( V_45 , V_6 ) ;
F_11 ( & V_16 , V_45 ) ;
V_11 = F_5 ( V_45 ) ;
...
void F_60 ( struct V_1 * V_2 , T_5 V_82 , T_5 V_88 )
{
struct V_80 * V_81 ;
V_81 = & V_2 -> V_4 -> V_86 -> V_81 ;
if ( F_58 ( V_88 , F_55 ( V_81 , V_82 ) ) )
return;
F_61 ( V_81 , V_82 , V_88 ) ;
F_59 ( V_2 , V_82 ) ;
}
...
{
return F_62 ( V_2 , & V_2 -> V_6 , V_90 ) ;
}
static T_5 F_66 ( struct V_1 * V_2 , T_5 V_90 )
{
return F_62 ( V_2 , & V_2 -> V_5 , V_90 ) ;
}
...
if ( V_9 != NULL ) {
V_48 = F_5 ( V_9 ) -> V_47 ;
if ( ! F_50 ( V_48 , F_49 ( & V_4 -> V_76 . V_77 ) ) )
return;
}
