...
( V_163 * sizeof( struct V_53 * ) ) ,
V_135 ) ;
if ( V_35 == NULL )
return;
V_35 -> V_164 =
F_20 ( sizeof( struct V_165 ) , V_135 ) ;
if ( ! V_35 -> V_164 ) {
F_26 ( V_21 -> V_21 , L_3 ) ;
F_27 ( V_35 ) ;
return;
...
V_35 -> V_39 = V_39 ;
V_35 -> V_166 = V_39 ;
V_160 = V_35 -> V_144 . V_167 ;
V_161 = V_160 + 256 ;
V_162 = V_161 + 256 ;
for ( V_159 = 0 ; V_159 < 256 ; V_159 ++ ) {
V_35 -> V_168 [ V_159 ] = V_159 ;
V_35 -> V_169 [ V_159 ] = V_159 ;
V_35 -> V_170 [ V_159 ] = V_159 ;
V_160 [ V_159 ] = V_159 << 8 ;
V_161 [ V_159 ] = V_159 << 8 ;
V_162 [ V_159 ] = V_159 << 8 ;
V_35 -> V_171 [ V_159 ] = 0 ;
...
F_30 ( & V_35 -> V_144 ,
V_33 -> V_150 -> V_172 ) ;
V_35 -> V_173 . V_3 = & V_35 -> V_144 ;
F_31 ( V_39 >= F_32 ( V_33 -> V_174 ) ||
V_33 -> V_174 [ V_35 -> V_166 ] != NULL ) ;
V_33 -> V_174 [ V_35 -> V_166 ] = & V_35 -> V_144 ;
V_33 -> V_175 [ V_35 -> V_39 ] = & V_35 -> V_144 ;
V_35 -> V_173 . V_176 = (struct V_53 * * ) ( V_35 + 1 ) ;
V_35 -> V_173 . V_177 = 0 ;
F_23 ( V_21 , V_35 ) ;
V_35 -> V_178 = true ;
}
...
int F_34 ( struct V_20 * V_21 , int V_179 )
{
int V_180 = 0 ;
struct V_53 * V_54 ;
int V_181 = 0 ;
