...
T_3 V_1 )
{
struct V_17 * V_52 , * V_53 = V_21 ;
struct V_14 * V_14 = F_27 ( V_21 -> V_27 ) ;
const struct V_4 * V_10 ;
const struct V_9 * V_28 ;
bool V_54 = true , V_55 = false ;
static F_47 ( V_50 ) ;
int V_29 ;
if ( V_1 >= V_8 )
...
if ( ! V_10 -> V_57 || ! V_10 -> abort ) {
F_3 ( V_1 ) ;
F_45 ( V_21 , V_26 , - V_56 ) ;
return F_49 ( V_21 ) ;
}
while ( V_21 -> V_58 >= F_33 ( 0 ) ) {
int V_59 , type ;
V_26 = F_50 ( V_21 ) ;
V_29 = 0 ;
if ( F_28 ( V_26 ) < sizeof( struct V_30 ) ||
...
goto V_60;
if ( V_28 -> V_66 ) {
V_29 = V_28 -> V_66 ( V_14 -> V_16 , V_21 , V_26 ,
( const struct V_35 * * ) V_36 ) ;
}
if ( V_29 == - V_42 ) {
F_42 ( & V_50 ) ;
...
V_60:
if ( V_26 -> V_61 & V_67 || V_29 ) {
if ( F_36 ( & V_50 , V_26 , V_29 ) < 0 ) {
F_42 ( & V_50 ) ;
F_45 ( V_21 , F_50 ( V_53 ) , - V_48 ) ;
V_54 = false ;
goto V_55;
}
if ( V_29 )
...
V_59 = V_21 -> V_58 ;
if ( V_26 -> F_28 < V_68 ||
V_21 -> V_58 < V_68 + sizeof( struct V_30 ) )
return;
V_30 = F_55 ( V_26 ) ;
F_52 ( V_21 , V_59 ) ;
F_46 ( V_21 , V_26 , V_30 -> V_71 ) ;
} else {
F_56 ( V_21 , & F_26 ) ;
}
}
...
static void T_8 F_60 ( struct V_44 * V_83 )
{
struct V_14 * V_14 ;
