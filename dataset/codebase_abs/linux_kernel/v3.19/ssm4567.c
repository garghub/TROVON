...
if ( V_54 )
V_53 |= V_62 ;
return F_15 ( V_22 -> V_31 , V_50 , V_53 ) ;
}
static int F_16 ( struct V_22 * V_22 , bool V_73 )
{
int V_43 = 0 ;
if ( ! V_73 ) {
V_43 = F_7 ( V_22 -> V_31 ,
...
break;
case V_79 :
if ( V_21 -> V_80 . V_81 == V_82 )
V_43 = F_16 ( V_22 , true ) ;
break;
case V_82 :
V_43 = F_16 ( V_22 , false ) ;
break;
}
if ( V_43 )
return V_43 ;
...
struct V_22 * V_22 ;
int V_43 ;
V_22 = F_22 ( & V_84 -> V_2 , sizeof( * V_22 ) , V_87 ) ;
if ( V_22 == NULL )
return - V_88 ;
F_23 ( V_84 , V_22 ) ;
V_22 -> V_31 = F_24 ( V_84 , & V_89 ) ;
if ( F_25 ( V_22 -> V_31 ) )
return F_26 ( V_22 -> V_31 ) ;
V_43 = F_15 ( V_22 -> V_31 , V_10 , 0x00 ) ;
if ( V_43 )
return V_43 ;
V_43 = F_16 ( V_22 , false ) ;
if ( V_43 )
return V_43 ;
return F_27 ( & V_84 -> V_2 , & V_90 ,
& V_91 , 1 ) ;
}
static int F_28 ( struct V_83 * V_92 )
{
F_29 ( & V_92 -> V_2 ) ;
return 0 ;
}
