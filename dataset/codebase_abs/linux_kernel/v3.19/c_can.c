...
struct V_27 * V_166 ;
struct V_53 * V_54 ;
if ( V_184 == V_123 || V_184 == V_185 )
return 0 ;
if ( ! ( V_2 -> V_95 . V_115 & V_186 ) )
return 0 ;
V_2 -> V_95 . V_168 . V_187 ++ ;
V_52 -> V_59 ++ ;
V_54 = F_25 ( V_12 , & V_166 ) ;
if ( F_26 ( ! V_54 ) )
return 0 ;
V_166 -> V_33 |= V_188 | V_189 ;
V_166 -> V_46 [ 2 ] |= V_190 ;
switch ( V_184 ) {
case V_191 :
F_70 ( V_12 , L_5 ) ;
...
static int F_71 ( struct V_205 * V_206 , int V_158 )
{
...
F_70 ( V_12 , L_11 ) ;
V_210 += F_67 ( V_12 , V_167 ) ;
}
if ( ( V_207 & V_212 ) && ( ! ( V_208 & V_212 ) ) ) {
F_70 ( V_12 , L_12 ) ;
V_210 += F_67 ( V_12 , V_171 ) ;
}
if ( ( V_207 & V_213 ) && ( ! ( V_208 & V_213 ) ) ) {
F_70 ( V_12 , L_13 ) ;
V_210 += F_67 ( V_12 , V_174 ) ;
goto V_214;
}
if ( ( ! ( V_207 & V_213 ) ) && ( V_208 & V_213 ) ) {
F_70 ( V_12 , L_14 ) ;
...
V_210 += F_69 ( V_12 , V_207 & V_215 ) ;
V_210 += F_65 ( V_12 , ( V_158 - V_210 ) ) ;
F_54 ( V_12 ) ;
V_214:
if ( V_210 < V_158 ) {
F_72 ( V_206 ) ;
...
static T_5 F_73 ( int V_216 , void * V_217 )
{
...
V_125 = F_77 ( V_12 -> V_216 , & F_73 , V_222 , V_12 -> V_223 ,
V_12 ) ;
if ( V_125 < 0 ) {
F_15 ( V_12 , L_17 ) ;
goto V_224;
...
return NULL ;
V_2 = F_12 ( V_12 ) ;
F_86 ( V_12 , & V_2 -> V_206 , F_71 , V_228 ) ;
V_2 -> V_12 = V_12 ;
