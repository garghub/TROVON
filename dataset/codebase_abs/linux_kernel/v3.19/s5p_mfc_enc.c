...
static void F_73 ( struct V_337 * V_350 )
{
struct V_17 * V_18 = F_36 ( V_350 -> V_343 ) ;
struct V_33 * V_34 = V_18 -> V_34 ;
F_74 ( & V_34 -> V_351 ) ;
}
...
static int F_77 ( struct V_334 * V_335 )
{
...
static int F_78 ( struct V_334 * V_335 )
{
struct V_337 * V_338 = V_335 -> V_337 ;
struct V_17 * V_18 = F_36 ( V_338 -> V_343 ) ;
int V_123 ;
...
static int F_79 ( struct V_337 * V_350 , unsigned int V_143 )
{
struct V_17 * V_18 = F_36 ( V_350 -> V_343 ) ;
struct V_33 * V_34 = V_18 -> V_34 ;
if ( F_21 ( V_34 ) &&
( V_350 -> type == V_105 ) ) {
if ( ( V_18 -> V_21 == V_22 ) &&
( V_34 -> V_359 == V_18 -> V_360 ) && V_34 -> V_361 ) {
F_65 ( V_18 ,
V_315 ,
0 ) ;
}
...
static void F_80 ( struct V_337 * V_350 )
{
unsigned long V_38 ;
struct V_17 * V_18 = F_36 ( V_350 -> V_343 ) ;
struct V_33 * V_34 = V_18 -> V_34 ;
...
if ( V_350 -> type == V_116 ) {
F_5 ( V_18 ) ;
F_15 ( V_34 -> V_42 , V_364 , & V_18 -> V_32 ,
& V_18 -> V_124 ) ;
F_10 ( & V_18 -> V_32 ) ;
V_18 -> V_19 = 0 ;
}
...
static void F_81 ( struct V_334 * V_335 )
{
struct V_337 * V_338 = V_335 -> V_337 ;
struct V_17 * V_18 = F_36 ( V_338 -> V_343 ) ;
struct V_33 * V_34 = V_18 -> V_34 ;
...
if ( V_338 -> type == V_105 ) {
V_365 = & V_18 -> V_352 [ V_335 -> V_70 . V_98 ] ;
V_365 -> V_38 &= ~ V_68 ;
F_12 ( & V_34 -> V_39 , V_38 ) ;
F_9 ( & V_365 -> V_30 , & V_18 -> V_40 ) ;
V_18 -> V_20 ++ ;
F_16 ( & V_34 -> V_39 , V_38 ) ;
} else if ( V_338 -> type == V_116 ) {
V_365 = & V_18 -> V_355 [ V_335 -> V_70 . V_98 ] ;
V_365 -> V_38 &= ~ V_68 ;
F_12 ( & V_34 -> V_39 , V_38 ) ;
...
struct V_367 * F_82 ( void )
{
return & V_368 ;
}
struct V_369 * F_83 ( void )
{
return & V_370 ;
}
const struct V_371 * F_84 ( void )
{
return & V_372 ;
}
...
V_18 -> V_390 [ V_5 ] = F_88 ( & V_18 -> V_375 ,
& V_374 , NULL ) ;
} else {
