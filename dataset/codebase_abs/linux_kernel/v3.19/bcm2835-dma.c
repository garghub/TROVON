...
vc.chan.device_node) {
F_14 ( & V_7 -> V_8 . V_9 . V_109 ) ;
F_55 ( & V_7 -> V_8 . V_110 ) ;
}
}
static struct V_6 * F_56 ( struct V_111 * V_112 ,
struct V_113 * V_114 )
{
struct V_1 * V_3 = V_114 -> V_115 ;
struct V_6 * V_9 ;
V_9 = F_57 ( & V_3 -> V_4 ) ;
if ( ! V_9 )
return NULL ;
F_3 ( V_9 ) -> V_92 = V_112 -> args [ 0 ] ;
return V_9 ;
}
static int F_58 ( struct V_6 * V_116 ,
struct V_117 * V_118 )
{
V_118 -> V_119 = F_59 ( V_85 ) ;
V_118 -> V_120 = F_59 ( V_85 ) ;
V_118 -> V_121 = F_59 ( V_51 ) | F_59 ( V_62 ) ;
V_118 -> V_122 = false ;
V_118 -> V_123 = true ;
return 0 ;
}
...
T_6 V_129 ;
if ( ! V_125 -> V_18 . V_130 )
V_125 -> V_18 . V_130 = & V_125 -> V_18 . V_131 ;
V_128 = F_61 ( & V_125 -> V_18 , F_62 ( 32 ) ) ;
if ( V_128 )
return V_128 ;
V_108 = F_49 ( & V_125 -> V_18 , sizeof( * V_108 ) , V_104 ) ;
if ( ! V_108 )
return - V_105 ;
V_125 -> V_18 . V_132 = & V_108 -> V_132 ;
F_63 ( & V_125 -> V_18 , 0x3FFFFFFF ) ;
V_127 = F_64 ( V_125 , V_133 , 0 ) ;
V_107 = F_65 ( & V_125 -> V_18 , V_127 ) ;
if ( F_66 ( V_107 ) )
return F_67 ( V_107 ) ;
V_108 -> V_107 = V_107 ;
F_68 ( V_134 , V_108 -> V_4 . V_135 ) ;
F_68 ( V_136 , V_108 -> V_4 . V_135 ) ;
F_68 ( V_137 , V_108 -> V_4 . V_135 ) ;
V_108 -> V_4 . V_138 = F_19 ;
V_108 -> V_4 . V_139 = F_22 ;
V_108 -> V_4 . V_140 = F_27 ;
V_108 -> V_4 . V_141 = F_30 ;
V_108 -> V_4 . V_142 = F_58 ;
V_108 -> V_4 . V_143 = F_32 ;
V_108 -> V_4 . V_144 = F_47 ;
V_108 -> V_4 . V_18 = & V_125 -> V_18 ;
F_51 ( & V_108 -> V_4 . V_145 ) ;
F_69 ( & V_108 -> V_36 ) ;
F_70 ( V_125 , V_108 ) ;
if ( F_71 ( V_125 -> V_18 . V_146 ,
L_6 ,
& V_129 ) ) {
F_34 ( & V_125 -> V_18 , L_7 ) ;
V_128 = - V_95 ;
...
V_129 &= ~ ( V_148 | V_149 ) ;
for ( V_43 = 0 ; V_43 < V_125 -> V_150 ; V_43 ++ ) {
V_33 = F_72 ( V_125 , V_43 ) ;
if ( V_33 < 0 )
break;
if ( V_129 & ( 1 << V_43 ) ) {
V_128 = F_48 ( V_108 , V_43 , V_33 ) ;
if ( V_128 )
goto V_147;
}
}
F_20 ( & V_125 -> V_18 , L_8 , V_43 ) ;
V_128 = F_73 ( V_125 -> V_18 . V_146 ,
F_56 , V_108 ) ;
if ( V_128 ) {
F_34 ( & V_125 -> V_18 , L_9 ) ;
goto V_147;
}
V_128 = F_74 ( & V_108 -> V_4 ) ;
if ( V_128 ) {
F_34 ( & V_125 -> V_18 ,
L_10 , V_128 ) ;
goto V_147;
}
F_20 ( & V_125 -> V_18 , L_11 ) ;
return 0 ;
V_147:
F_53 ( V_108 ) ;
return V_128 ;
