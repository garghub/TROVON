...
static struct V_22 * F_14 ( struct V_1 * V_2 ,
struct V_23 * V_24 ,
int V_12 )
{
V_12 |= V_25 ;
return F_15 ( V_2 , V_24 , V_12 ) ;
}
static int F_16 ( struct V_26 * V_2 , void * V_27 )
{
return V_2 -> V_28 == V_27 ;
}
static int F_17 ( struct V_26 * V_2 )
{
return F_18 ( & V_29 , F_19 ( V_2 ) ) ;
}
...
V_35 = F_26 ( V_33 , NULL ) ;
while ( V_35 ) {
F_27 ( V_2 , & V_37 , F_16 , V_35 ) ;
F_28 ( V_35 ) ;
V_35 = F_26 ( V_33 , V_35 ) ;
}
return F_29 ( V_2 , & V_38 , V_37 ) ;
}
