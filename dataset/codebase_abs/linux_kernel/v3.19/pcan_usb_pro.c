...
static int F_15 ( struct V_33 * V_34 , int V_58 ,
...
static void F_29 ( struct V_95 * V_95 )
{
F_30 ( V_95 ) ;
F_31 ( V_95 -> V_96 ) ;
}
...
V_110 -> V_117 |= V_155 ;
V_110 -> V_124 [ 1 ] |= V_138 ;
V_34 -> V_87 . V_156 . V_157 ++ ;
break;
case V_152 :
V_110 -> V_117 |= V_155 ;
V_110 -> V_124 [ 1 ] |= V_138 ;
V_34 -> V_87 . V_156 . V_158 ++ ;
break;
case V_137 :
break;
default:
...
T_3 V_12 ;
int V_37 = 0 ;
V_10 = F_1 ( & V_168 , V_95 -> V_170 ,
V_95 -> V_36 ) ;
if ( ! V_10 ) {
F_11 ( V_43 , L_11 , V_95 -> V_36 ) ;
return - V_171 ;
}
V_169 = V_95 -> V_170 + V_95 -> V_36 ;
V_12 = F_46 ( * V_168 . V_6 . V_172 ) ;
for (; V_12 > 0 ; V_12 -- ) {
union V_48 * V_11 = (union V_48 * ) V_10 ;
T_3 V_173 = V_53 [ V_11 -> V_54 ] ;
if ( ! V_173 ) {
F_11 ( V_43 ,
L_12 ) ;
V_37 = - V_174 ;
...
case V_177 :
case V_178 :
V_37 = F_39 ( V_106 , & V_11 -> V_179 ) ;
if ( V_37 < 0 )
goto V_180;
break;
case V_181 :
V_37 = F_45 ( V_106 , & V_11 -> V_182 ) ;
if ( V_37 < 0 )
goto V_180;
break;
case V_183 :
F_49 ( V_106 , & V_11 -> V_184 ) ;
break;
default:
F_11 ( V_43 ,
L_14 ,
...
if ( V_37 )
F_14 ( L_15 ,
V_95 -> V_170 , V_95 -> V_36 ) ;
return V_37 ;
}
static int F_52 ( struct V_33 * V_34 ,
struct V_111 * V_112 , T_1 * V_185 , T_4 * V_186 )
{
struct V_110 * V_187 = (struct V_110 * ) V_112 -> V_124 ;
T_1 V_54 , V_14 , V_119 ;
struct V_1 V_168 ;
F_2 ( & V_168 , V_185 , * V_186 ) ;
if ( ( V_187 -> V_117 & V_123 ) || ( V_187 -> V_118 == 0 ) )
V_54 = V_20 ;
else if ( V_187 -> V_118 <= 4 )
V_54 = V_19 ;
else
V_54 = V_18 ;
V_14 = ( V_34 -> V_76 << 4 ) | ( V_187 -> V_118 & 0x0f ) ;
V_119 = 0 ;
if ( V_187 -> V_117 & V_121 )
V_119 |= 0x02 ;
if ( V_187 -> V_117 & V_123 )
V_119 |= 0x01 ;
F_3 ( & V_168 , V_54 , 0 , V_119 , V_14 , V_187 -> V_117 ,
V_187 -> V_124 ) ;
* V_186 = V_168 . V_9 ;
return 0 ;
}
...
int V_37 ;
V_37 = F_24 ( V_34 ,
V_34 -> V_87 . V_88 & V_188 ) ;
if ( V_37 )
return V_37 ;
V_37 = F_25 ( V_34 , 1 ) ;
if ( V_37 )
return V_37 ;
if ( V_75 -> V_106 -> V_189 == 0 ) {
F_54 ( & V_75 -> V_106 -> V_125 , & V_190 ) ;
V_37 = F_20 ( V_34 , 1 ) ;
}
V_75 -> V_106 -> V_189 ++ ;
return V_37 ;
...
V_102 ) ;
V_192 = F_36 ( sizeof( struct V_191 ) , V_102 ) ;
V_194 = F_36 ( sizeof( struct V_193 ) , V_102 ) ;
if ( ! V_106 || ! V_192 || ! V_194 ) {
V_37 = - V_103 ;
goto V_196;
}
V_106 -> V_166 = 5 ;
V_37 = F_15 ( V_34 , V_197 ,
V_198 ,
V_192 , sizeof( * V_192 ) ) ;
if ( V_37 ) {
F_58 ( V_34 -> V_43 -> V_34 . V_199 ,
L_16 ,
V_190 . V_200 , V_37 ) ;
goto V_196;
}
...
if ( V_37 )
goto V_196;
F_59 ( V_34 -> V_43 -> V_34 . V_199 ,
L_18 ,
V_190 . V_200 ,
V_194 -> V_202 , V_194 -> V_203 , V_194 -> V_204 ,
V_190 . V_205 ) ;
} else {
V_106 = F_38 ( V_34 -> V_195 ) ;
}
V_75 -> V_106 = V_106 ;
...
{
if ( ! V_34 -> V_195 && ! V_34 -> V_207 )
F_37 ( F_38 ( V_34 ) ) ;
}
static int F_62 ( struct V_208 * V_209 )
{
struct V_210 * V_211 ;
int V_15 ;
V_211 = V_209 -> V_212 ;
for ( V_15 = 0 ; V_15 < V_211 -> V_213 . V_214 ; V_15 ++ ) {
struct V_215 * V_216 = & V_211 -> V_217 [ V_15 ] . V_213 ;
switch ( V_216 -> V_218 ) {
case V_41 :
case V_51 :
case V_219 :
