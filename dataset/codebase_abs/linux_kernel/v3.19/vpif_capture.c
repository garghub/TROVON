...
while ( ( V_254 = F_92 ( V_247 , V_255 , V_249 ) ) ) {
V_50 = F_93 ( & V_247 -> V_71 , V_254 -> V_256 , F_38 ,
V_257 , V_167 ,
( void * ) ( & V_72 . V_71 [ V_249 ] ->
V_56 ) ) ;
if ( V_50 ) {
V_50 = - V_16 ;
goto V_258;
...
V_72 . V_215 . V_263 = V_72 . V_80 -> V_218 ;
V_72 . V_215 . V_264 = V_72 . V_80 -> V_260 [ 0 ] ;
V_72 . V_215 . V_265 = F_73 ;
V_72 . V_215 . V_266 = F_88 ;
V_50 = F_97 ( & V_72 . V_205 ,
& V_72 . V_215 ) ;
if ( V_50 ) {
F_51 ( L_47 ) ;
V_50 = - V_16 ;
...
static int F_98 ( struct V_246 * V_267 )
{
struct V_8 * V_9 ;
struct V_6 * V_7 ;
int V_74 ;
...
static int F_99 ( struct V_267 * V_71 )
{
struct V_8 * V_9 ;
struct V_6 * V_7 ;
int V_74 ;
...
static int F_103 ( struct V_267 * V_71 )
{
struct V_8 * V_9 ;
struct V_6 * V_7 ;
int V_74 ;
