...
const struct V_26 * V_11 , unsigned long V_20 ,
T_1 V_15 )
{
F_35 ( ! ( V_24 & V_23 ) ) ;
V_5 -> type = V_24 ;
...
unsigned long F_36 ( const struct V_4 * V_5 )
{
...
T_3 F_37 ( struct V_4 * V_5 ,
struct V_1 * * V_34 , T_1 V_35 , unsigned V_36 ,
T_1 * V_37 )
{
if ( V_35 > V_5 -> V_15 )
V_35 = V_5 -> V_15 ;
...
static struct V_1 * * F_38 ( T_1 V_38 )
{
struct V_1 * * V_29 = F_39 ( V_38 * sizeof( struct V_1 * ) , V_39 ) ;
if ( ! V_29 )
V_29 = F_40 ( V_38 * sizeof( struct V_1 * ) ) ;
return V_29 ;
}
T_3 F_41 ( struct V_4 * V_5 ,
struct V_1 * * * V_34 , T_1 V_35 ,
T_1 * V_37 )
{
struct V_1 * * V_29 ;
if ( V_35 > V_5 -> V_15 )
...
T_1 F_42 ( void * V_28 , T_1 V_3 , T_4 * V_40 ,
struct V_4 * V_5 )
{
char * V_21 = V_28 ;
T_4 V_41 , V_42 ;
...
T_1 F_43 ( void * V_28 , T_1 V_3 , T_4 * V_40 ,
struct V_4 * V_5 )
{
char * V_14 = V_28 ;
T_4 V_41 , V_42 ;
...
int F_44 ( const struct V_4 * V_5 , int V_36 )
{
T_1 V_30 = V_5 -> V_15 ;
int V_44 = 0 ;
if ( ! V_30 )
