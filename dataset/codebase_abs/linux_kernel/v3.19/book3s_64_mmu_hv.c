...
if ( V_154 )
goto V_177;
V_93 = ( V_93 & ~ ( V_181 | V_182 | V_128 ) ) | V_56 ;
}
if ( V_46 < V_168 )
V_46 = V_168 ;
...
F_78 ( V_152 ) ;
V_106 [ 0 ] |= F_46 ( V_113 ) ;
F_79 ( V_1 , V_106 , V_107 ) ;
V_93 |= F_45 ( V_106 [ 1 ] ) & ( V_54 | V_55 ) ;
} else {
F_80 ( V_1 , V_5 , V_152 , V_107 , 0 ) ;
}
V_106 [ 1 ] = F_46 ( V_93 ) ;
F_81 () ;
V_106 [ 0 ] = F_46 ( V_144 [ 0 ] ) ;
...
T_6 V_149 , V_196 ;
V_194 = F_90 ( V_190 , V_38 -> V_197 ) ;
V_195 = F_91 ( V_191 , V_38 -> V_197 +
( V_38 -> V_41 << V_12 ) ) ;
if ( V_194 >= V_195 )
continue;
V_149 = F_92 ( V_194 , V_38 ) ;
V_196 = F_92 ( V_195 + V_168 - 1 , V_38 ) ;
for (; V_149 < V_196 ; ++ V_149 ) {
T_6 V_198 = V_149 - V_38 -> V_165 ;
V_50 = F_89 ( V_1 , & V_38 -> V_10 . V_152 [ V_198 ] , V_149 ) ;
V_193 |= V_50 ;
}
}
return V_193 ;
}
static int F_93 ( struct V_1 * V_1 , unsigned long V_150 ,
int (* F_89)( struct V_1 * V_1 , unsigned long * V_192 ,
unsigned long V_149 ) )
{
return F_88 ( V_1 , V_150 , V_150 + 1 , F_89 ) ;
}
static int F_94 ( struct V_1 * V_1 , unsigned long * V_192 ,
unsigned long V_149 )
{
struct V_4 * V_5 = V_1 -> V_10 . V_23 ;
unsigned long V_199 , V_40 , V_200 ;
T_4 * V_106 ;
...
V_200 = V_5 [ V_40 ] . V_203 ;
if ( V_200 == V_40 ) {
* V_192 &= ~ ( V_201 | V_202 ) ;
} else {
V_199 = V_5 [ V_40 ] . V_204 ;
V_5 [ V_199 ] . V_203 = V_200 ;
V_5 [ V_200 ] . V_204 = V_199 ;
V_5 [ V_40 ] . V_203 = V_5 [ V_40 ] . V_204 = V_40 ;
* V_192 = ( * V_192 & ~ V_202 ) | V_200 ;
}
V_74 = V_5 [ V_40 ] . V_116 ;
V_46 = F_40 ( F_45 ( V_106 [ 0 ] ) , V_74 ) ;
if ( ( F_45 ( V_106 [ 0 ] ) & V_112 ) &&
F_95 ( V_74 , V_46 ) == V_149 ) {
V_106 [ 0 ] |= F_46 ( V_113 ) ;
F_79 ( V_1 , V_106 , V_40 ) ;
...
int F_97 ( struct V_1 * V_1 , unsigned long V_150 )
{
F_93 ( V_1 , V_150 , F_94 ) ;
return 0 ;
}
int F_98 ( struct V_1 * V_1 , unsigned long V_190 , unsigned long V_191 )
{
F_88 ( V_1 , V_190 , V_191 , F_94 ) ;
return 0 ;
}
...
unsigned long V_149 ;
unsigned long V_205 ;
V_192 = V_38 -> V_10 . V_152 ;
V_149 = V_38 -> V_165 ;
for ( V_205 = V_38 -> V_41 ; V_205 ; -- V_205 ) {
if ( * V_192 & V_201 )
F_94 ( V_1 , V_192 , V_149 ) ;
++ V_192 ;
++ V_149 ;
}
}
static int F_100 ( struct V_1 * V_1 , unsigned long * V_192 ,
unsigned long V_149 )
{
struct V_4 * V_5 = V_1 -> V_10 . V_23 ;
unsigned long V_206 , V_40 , V_200 ;
T_4 * V_106 ;
int V_50 = 0 ;
V_207:
F_76 ( V_192 ) ;
...
V_106 [ 0 ] &= ~ F_46 ( V_115 ) ;
} while ( ( V_40 = V_200 ) != V_206 );
F_78 ( V_192 ) ;
return V_50 ;
}
int F_102 ( struct V_1 * V_1 , unsigned long V_190 , unsigned long V_191 )
{
return F_88 ( V_1 , V_190 , V_191 , F_100 ) ;
}
static int F_103 ( struct V_1 * V_1 , unsigned long * V_192 ,
unsigned long V_149 )
{
struct V_4 * V_5 = V_1 -> V_10 . V_23 ;
unsigned long V_206 , V_40 , V_200 ;
...
V_40 = V_206 = * V_192 & V_202 ;
do {
V_209 = ( unsigned long * ) ( V_1 -> V_10 . V_18 + ( V_40 << 4 ) ) ;
V_200 = V_5 [ V_40 ] . V_203 ;
if ( F_45 ( V_209 [ 1 ] ) & V_54 )
goto V_31;
} while ( ( V_40 = V_200 ) != V_206 );
}
V_50 = 0 ;
...
int F_104 ( struct V_1 * V_1 , unsigned long V_150 )
{
return F_93 ( V_1 , V_150 , F_103 ) ;
}
void F_105 ( struct V_1 * V_1 , unsigned long V_150 , T_5 V_180 )
{
F_93 ( V_1 , V_150 , F_94 ) ;
}
...
static int F_106 ( struct V_1 * V_1 , unsigned long * V_192 )
{
struct V_4 * V_5 = V_1 -> V_10 . V_23 ;
unsigned long V_206 , V_40 , V_200 ;
unsigned long V_205 ;
...
if ( ! F_55 ( V_106 , V_115 ) ) {
F_78 ( V_192 ) ;
while ( V_106 [ 0 ] & F_46 ( V_115 ) )
F_56 () ;
goto V_207;
}
if ( ! ( V_106 [ 0 ] & F_46 ( V_112 ) ) ) {
V_106 [ 0 ] &= ~ F_46 ( V_115 ) ;
continue;
}
V_106 [ 0 ] |= F_46 ( V_113 ) ;
...
V_93 = F_45 ( V_106 [ 1 ] ) ;
if ( V_93 & V_55 ) {
V_106 [ 1 ] = F_46 ( V_93 & ~ V_55 ) ;
if ( ! ( V_5 [ V_40 ] . V_116 & V_55 ) ) {
V_5 [ V_40 ] . V_116 |= V_55 ;
F_96 ( V_1 , & V_5 [ V_40 ] ) ;
}
V_205 = F_40 ( V_92 , V_93 ) ;
V_205 = ( V_205 + V_168 - 1 ) >> V_12 ;
if ( V_205 > V_210 )
V_210 = V_205 ;
F_81 () ;
}
...
static void F_107 ( struct V_213 * V_214 ,
struct V_37 * V_38 ,
unsigned long * V_215 )
{
unsigned long V_149 ;
...
return;
V_149 = V_214 -> V_135 >> V_12 ;
if ( V_149 < V_38 -> V_165 ||
V_149 >= V_38 -> V_165 + V_38 -> V_41 )
return;
V_214 -> V_216 = false ;
if ( V_215 )
F_108 ( V_149 - V_38 -> V_165 , V_215 ) ;
}
long F_109 ( struct V_1 * V_1 , struct V_37 * V_38 ,
unsigned long * V_215 )
{
unsigned long V_40 , V_200 ;
unsigned long * V_192 ;
struct V_35 * V_36 ;
F_42 () ;
V_192 = V_38 -> V_10 . V_152 ;
for ( V_40 = 0 ; V_40 < V_38 -> V_41 ; ++ V_40 ) {
int V_41 = F_106 ( V_1 , V_192 ) ;
if ( V_41 && V_215 )
for ( V_200 = V_40 ; V_41 ; ++ V_200 , -- V_41 )
F_108 ( V_200 , V_215 ) ;
++ V_192 ;
}
F_110 (i, vcpu, kvm) {
F_111 ( & V_36 -> V_10 . V_218 ) ;
F_107 ( & V_36 -> V_10 . V_214 , V_38 , V_215 ) ;
F_107 ( & V_36 -> V_10 . V_219 , V_38 , V_215 ) ;
F_112 ( & V_36 -> V_10 . V_218 ) ;
}
F_44 () ;
return 0 ;
}
void * F_113 ( struct V_1 * V_1 , unsigned long V_135 ,
unsigned long * V_220 )
{
struct V_37 * V_38 ;
...
if ( V_220 )
* V_220 = V_168 - V_221 ;
return F_114 ( V_6 ) + V_221 ;
V_26:
F_87 ( & V_1 -> V_188 , V_187 ) ;
return NULL ;
}
void F_115 ( struct V_1 * V_1 , void * V_222 , unsigned long V_135 ,
bool V_216 )
{
struct V_6 * V_6 = F_22 ( V_222 ) ;
struct V_37 * V_38 ;
unsigned long V_149 ;
unsigned long * V_152 ;
int V_187 ;
...
static int F_116 ( struct V_4 * V_223 , T_4 * V_224 )
{
unsigned long V_225 ;
if ( V_223 -> V_116 & V_226 )
return 1 ;
V_225 = ~ V_223 -> V_116 & ( V_54 | V_55 ) ;
if ( ( F_45 ( V_224 [ 0 ] ) & V_112 ) &&
( F_45 ( V_224 [ 1 ] ) & V_225 ) )
return 1 ;
return 0 ;
}
static long F_117 ( unsigned long V_71 , T_4 * V_224 ,
unsigned long * V_144 , struct V_4 * V_223 ,
int V_227 , int V_228 )
{
unsigned long V_92 , V_93 ;
unsigned long V_225 ;
int V_229 = 1 ;
int V_230 , V_216 ;
V_216 = F_116 ( V_223 , V_224 ) ;
if ( ! V_228 && ! V_216 )
return 0 ;
V_230 = 0 ;
if ( F_45 ( V_224 [ 0 ] ) & ( V_112 | V_113 ) ) {
V_230 = 1 ;
if ( ( V_71 & V_231 ) &&
! ( F_45 ( V_224 [ 0 ] ) & V_53 ) )
V_230 = 0 ;
...
if ( V_230 || V_216 ) {
F_42 () ;
while ( ! F_55 ( V_224 , V_115 ) )
F_56 () ;
V_92 = F_45 ( V_224 [ 0 ] ) ;
V_230 = ! ! ( V_92 & V_112 ) ;
V_216 = ! ! ( V_223 -> V_116 & V_226 ) ;
V_225 = ~ V_223 -> V_116 & ( V_54 | V_55 ) ;
if ( V_230 && ( V_225 & F_45 ( V_224 [ 1 ] ) ) ) {
V_223 -> V_116 |= ( F_45 ( V_224 [ 1 ] ) &
( V_54 | V_55 ) ) | V_226 ;
V_216 = 1 ;
}
if ( V_92 & V_113 ) {
...
if ( ( V_71 & V_231 ) && ! ( V_92 & V_53 ) )
V_230 = 0 ;
V_93 = V_223 -> V_116 ;
if ( V_230 == V_227 && V_216 ) {
V_93 &= ~ V_226 ;
V_223 -> V_116 = V_93 ;
}
...
static T_7 F_118 ( struct V_232 * V_232 , char T_8 * V_233 ,
T_9 V_234 , T_10 * V_235 )
{
struct V_236 * V_237 = V_232 -> V_238 ;
struct V_1 * V_1 = V_237 -> V_1 ;
struct V_239 V_240 ;
T_4 * V_224 ;
struct V_4 * V_223 ;
unsigned long V_40 , V_241 , V_242 ;
unsigned long T_8 * V_243 ;
struct V_239 T_8 * V_244 ;
unsigned long V_71 ;
int V_228 ;
unsigned long V_144 [ 2 ] ;
if ( ! F_119 ( V_245 , V_233 , V_234 ) )
return - V_166 ;
V_228 = V_237 -> V_228 ;
V_71 = V_237 -> V_71 ;
V_40 = V_237 -> V_107 ;
V_224 = ( T_4 * ) ( V_1 -> V_10 . V_18 + ( V_40 * V_246 ) ) ;
V_223 = V_1 -> V_10 . V_23 + V_40 ;
V_243 = ( unsigned long T_8 * ) V_233 ;
V_241 = 0 ;
while ( V_241 + sizeof( V_240 ) + V_246 < V_234 ) {
V_244 = (struct V_239 T_8 * ) V_233 ;
V_240 . V_247 = 0 ;
V_240 . V_248 = 0 ;
V_242 = V_241 ;
V_241 += sizeof( V_240 ) ;
V_243 = ( unsigned long T_8 * ) ( V_233 + sizeof( V_240 ) ) ;
if ( ! V_228 ) {
...
V_240 . V_247 < 0xffff &&
V_241 + V_246 < V_234 &&
F_117 ( V_71 , V_224 , V_144 , V_223 , 1 , V_228 ) ) {
++ V_240 . V_247 ;
if ( F_120 ( V_144 [ 0 ] , V_243 ) ||
F_120 ( V_144 [ 1 ] , V_243 + 1 ) )
return - V_166 ;
V_241 += V_246 ;
V_243 += 2 ;
++ V_40 ;
...
while ( V_40 < V_1 -> V_10 . V_20 &&
V_240 . V_248 < 0xffff &&
F_117 ( V_71 , V_224 , V_144 , V_223 , 0 , V_228 ) ) {
++ V_240 . V_248 ;
++ V_40 ;
V_224 += 2 ;
++ V_223 ;
}
if ( V_240 . V_247 || V_240 . V_248 ) {
if ( F_121 ( V_244 , & V_240 , sizeof( V_240 ) ) )
return - V_166 ;
V_242 = V_241 ;
V_233 = ( char T_8 * ) V_243 ;
} else {
V_241 = V_242 ;
}
...
static T_7 F_122 ( struct V_232 * V_232 , const char T_8 * V_233 ,
T_9 V_234 , T_10 * V_235 )
{
struct V_236 * V_237 = V_232 -> V_238 ;
struct V_1 * V_1 = V_237 -> V_1 ;
...
unsigned long T_8 * V_243 ;
T_4 * V_224 ;
unsigned long V_249 [ 2 ] ;
T_7 V_241 ;
long int V_26 , V_50 ;
int V_250 ;
if ( ! F_119 ( V_251 , V_233 , V_234 ) )
return - V_166 ;
F_13 ( & V_1 -> V_28 ) ;
V_250 = V_1 -> V_10 . V_29 ;
if ( V_250 ) {
...
V_26 = 0 ;
for ( V_241 = 0 ; V_241 + sizeof( V_240 ) <= V_234 ; ) {
V_26 = - V_166 ;
if ( F_123 ( & V_240 , V_233 , sizeof( V_240 ) ) )
break;
V_26 = 0 ;
if ( V_241 + V_240 . V_247 * V_246 > V_234 )
break;
V_241 += sizeof( V_240 ) ;
V_233 += sizeof( V_240 ) ;
V_26 = - V_63 ;
V_40 = V_240 . V_107 ;
if ( V_40 >= V_1 -> V_10 . V_20 ||
V_40 + V_240 . V_247 + V_240 . V_248 > V_1 -> V_10 . V_20 )
break;
V_224 = ( T_4 * ) ( V_1 -> V_10 . V_18 + ( V_40 * V_246 ) ) ;
V_243 = ( unsigned long T_8 * ) V_233 ;
for ( V_200 = 0 ; V_200 < V_240 . V_247 ; ++ V_200 ) {
T_4 V_252 ;
T_4 V_253 ;
V_26 = - V_166 ;
if ( F_124 ( V_252 , V_243 ) ||
F_124 ( V_253 , V_243 + 1 ) )
goto V_31;
V_92 = F_45 ( V_252 ) ;
V_93 = F_45 ( V_253 ) ;
...
if ( ! V_250 && F_126 ( V_92 ) ) {
unsigned long V_46 = F_127 ( V_92 , V_93 ) ;
unsigned long V_255 = F_128 ( V_46 ) ;
unsigned long V_256 ;
V_1 -> V_10 . V_111 = V_255 | V_89 |
( V_52 << V_257 ) ;
V_256 = V_255 << ( V_258 - 4 ) ;
F_129 ( V_1 , V_256 , V_259 ) ;
V_250 = 1 ;
}
++ V_40 ;
V_224 += 2 ;
}
for ( V_200 = 0 ; V_200 < V_240 . V_248 ; ++ V_200 ) {
if ( F_45 ( V_224 [ 0 ] ) & ( V_112 | V_113 ) )
F_125 ( V_1 , 0 , V_40 , 0 , V_249 ) ;
++ V_40 ;
V_224 += 2 ;
...
static int F_131 ( struct V_260 * V_260 , struct V_232 * V_261 )
{
struct V_236 * V_237 = V_261 -> V_238 ;
V_261 -> V_238 = NULL ;
if ( ! ( V_237 -> V_71 & V_262 ) )
F_132 ( & V_237 -> V_1 -> V_10 . V_263 ) ;
F_133 ( V_237 -> V_1 ) ;
F_134 ( V_237 ) ;
return 0 ;
}
int F_135 ( struct V_1 * V_1 , struct V_264 * V_265 )
{
int V_50 ;
struct V_236 * V_237 ;
int V_266 ;
if ( V_265 -> V_71 & ~ ( V_231 | V_262 ) )
return - V_63 ;
V_237 = F_136 ( sizeof( * V_237 ) , V_13 ) ;
if ( ! V_237 )
return - V_17 ;
F_137 ( V_1 ) ;
V_237 -> V_1 = V_1 ;
V_237 -> V_107 = V_265 -> V_267 ;
V_237 -> V_71 = V_265 -> V_71 ;
V_237 -> V_228 = 1 ;
V_266 = ( V_265 -> V_71 & V_262 ) ? V_268 : V_269 ;
V_50 = F_138 ( L_7 , & V_270 , V_237 , V_266 | V_271 ) ;
if ( V_50 < 0 ) {
F_133 ( V_1 ) ;
return V_50 ;
}
if ( V_266 == V_269 ) {
F_13 ( & V_1 -> V_272 ) ;
F_139 ( & V_1 -> V_10 . V_263 ) ;
F_140 ( & V_1 -> V_188 ) ;
F_18 ( & V_1 -> V_272 ) ;
}
return V_50 ;
}
void F_141 ( struct V_35 * V_36 )
{
struct V_273 * V_274 = & V_36 -> V_10 . V_274 ;
V_36 -> V_10 . V_84 = 32 ;
V_274 -> V_275 = F_41 ;
V_274 -> V_276 = F_32 ;
V_36 -> V_10 . V_277 |= V_278 ;
}
