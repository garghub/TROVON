...
return - V_130 ;
if ( V_25 -> V_108 & V_112 ) {
if ( V_132 / V_113 > V_25 -> V_19 )
return - V_127 ;
if ( V_133 / V_113 < V_25 -> V_19 )
return - V_127 ;
}
return 0 ;
}
...
V_25 -> V_119 = V_6 ;
V_25 -> V_137 = 1 ;
V_25 -> V_138 = V_68 / V_113 ;
V_25 -> V_124 = V_47 ;
V_25 -> V_139 = * V_107 ;
F_8 ( V_25 ) ;
V_25 -> time . V_12 = ( V_140 ) V_105 -> V_12 ;
V_25 -> time . V_141 = V_105 -> V_13 ;
if ( ! ( V_2 & V_32 ) )
V_25 -> time . V_141 /= V_33 ;
return V_134 ;
}
static inline struct V_142 F_39 ( struct V_93 V_105 )
{
struct V_142 V_143 = {
. V_144 = V_105 . V_12 ,
. V_145 = V_105 . V_13
} ;
if ( V_143 . V_145 > ( V_96 >> 1 ) ) {
V_143 . V_145 -= V_96 ;
V_143 . V_144 ++ ;
}
return V_143 ;
...
static inline void F_41 ( long V_146 )
{
V_10 [ 2 ] = V_10 [ 1 ] ;
V_10 [ 1 ] = V_10 [ 0 ] ;
V_10 [ 0 ] = V_146 ;
...
static long F_44 ( struct V_142 V_149 )
{
long V_74 , V_150 ;
T_1 V_151 ;
if ( V_149 . V_144 > ( 2 << V_7 ) ) {
V_2 |= V_18 ;
V_42 ++ ;
F_42 () ;
F_45 ( V_152
...
V_151 = F_19 ( ( ( T_1 ) ( - V_149 . V_145 ) ) << V_29 ,
V_149 . V_144 ) ;
V_74 = F_2 ( V_151 - V_14 , V_29 ) ;
V_14 = V_151 ;
if ( V_74 > V_153 || V_74 < - V_153 ) {
F_45 ( V_154
L_4 , V_74 ) ;
V_2 |= V_17 ;
V_44 ++ ;
...
V_69 = F_19 ( ( ( T_1 ) V_156 ) << V_29 ,
V_53 ) ;
V_70 = 0 ;
}
V_31 += ( V_30 - V_31 ) >> V_8 ;
}
void F_47 ( const struct V_93 * V_158 , const struct V_93 * V_159 )
{
struct V_142 V_160 , V_149 ;
V_160 = F_39 ( * V_158 ) ;
V_2 &= ~ ( V_16 | V_17 | V_18 ) ;
V_2 |= V_4 ;
V_15 = V_161 ;
...
V_149 = F_39 ( F_48 ( * V_159 , V_11 ) ) ;
if ( ( V_149 . V_144 == 0 ) ||
( V_149 . V_145 > V_85 * V_149 . V_144 ) ||
( V_149 . V_145 < - V_85 * V_149 . V_144 ) ) {
V_2 |= V_16 ;
V_11 = * V_159 ;
F_45 ( V_152 L_6 ) ;
...
static int T_4 F_49 ( char * V_162 )
{
int V_163 = F_50 ( V_162 , 0 , ( long * ) & V_49 ) ;
if ( V_163 )
return V_163 ;
V_49 <<= V_29 ;
return 1 ;
