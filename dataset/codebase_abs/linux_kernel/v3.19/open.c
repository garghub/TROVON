...
static int F_37 ( struct V_18 * V_18 , T_4 V_70 , T_5 V_71 )
{
struct V_19 * V_19 = V_18 -> V_1 -> V_16 ;
struct V_19 * V_64 = NULL ;
int error ;
...
struct V_19 * V_19 ;
int error ;
V_37 -> V_42 = F_47 ( V_37 -> V_39 ) | V_89 |
V_90 | V_91 ;
F_48 ( & V_37 -> V_41 ) ;
V_19 = V_37 -> V_92 = V_37 -> V_41 . V_1 -> V_16 ;
V_37 -> V_82 = V_19 -> V_93 ;
if ( F_49 ( V_37 -> V_39 & V_94 ) ) {
V_37 -> V_42 = V_95 ;
V_37 -> V_62 = & V_88 ;
return 0 ;
}
...
if ( F_8 ( V_19 -> V_20 ) )
V_37 -> V_42 |= V_98 ;
V_37 -> V_62 = F_52 ( V_19 -> V_99 ) ;
if ( F_49 ( F_53 ( ! V_37 -> V_62 ) ) ) {
error = - V_59 ;
goto V_100;
}
error = F_54 ( V_37 , V_86 ) ;
if ( error )
goto V_100;
...
F_55 ( V_19 ) ;
if ( ( V_37 -> V_42 & V_101 ) &&
F_56 ( V_37 -> V_62 -> V_102 || V_37 -> V_62 -> V_103 || V_37 -> V_62 -> V_104 ) )
V_37 -> V_42 |= V_105 ;
if ( ( V_37 -> V_42 & V_43 ) &&
F_56 ( V_37 -> V_62 -> V_106 || V_37 -> V_62 -> V_107 || V_37 -> V_62 -> V_108 ) )
V_37 -> V_42 |= V_109 ;
V_37 -> V_39 &= ~ ( V_110 | V_111 | V_112 | V_113 ) ;
F_57 ( & V_37 -> V_114 , V_37 -> V_82 -> V_115 -> V_93 ) ;
return 0 ;
V_100:
F_58 ( V_37 -> V_62 ) ;
if ( V_37 -> V_42 & V_97 ) {
...
struct V_4 * F_64 ( const struct V_18 * V_18 , int V_118 ,
const struct V_86 * V_86 )
{
int error ;
struct V_4 * V_37 ;
...
int F_68 ( const struct V_18 * V_18 , struct V_4 * V_5 ,
const struct V_86 * V_86 )
{
struct V_19 * V_19 = V_18 -> V_1 -> V_16 ;
if ( V_19 -> V_119 -> F_64 )
return V_19 -> V_119 -> F_64 ( V_18 -> V_1 , V_5 , V_86 ) ;
else {
V_5 -> V_41 = * V_18 ;
return F_45 ( V_5 , NULL , V_86 ) ;
}
}
static inline int F_72 ( int V_118 , T_3 V_49 , struct V_120 * V_121 )
{
int V_30 = 0 ;
int V_122 ;
...
struct V_4 * F_74 ( struct V_142 * V_143 , int V_118 , T_3 V_49 )
{
struct V_120 V_121 ;
int V_144 = F_72 ( V_118 , V_49 , & V_121 ) ;
return V_144 ? F_70 ( V_144 ) : F_75 ( V_33 , V_143 , & V_121 ) ;
}
struct V_4 * F_76 ( const char * V_142 , int V_118 , T_3 V_49 )
{
struct V_142 V_143 = { . V_143 = V_142 } ;
return F_74 ( & V_143 , V_118 , V_49 ) ;
}
struct V_4 * F_77 ( struct V_1 * V_1 , struct V_145 * V_22 ,
const char * V_142 , int V_118 )
{
struct V_120 V_121 ;
int V_144 = F_72 ( V_118 , 0 , & V_121 ) ;
if ( V_144 )
return F_70 ( V_144 ) ;
if ( V_118 & V_110 )
return F_70 ( - V_9 ) ;
...
return F_70 ( - V_147 ) ;
return F_78 ( V_1 , V_22 , V_142 , & V_121 ) ;
}
long F_79 ( int V_148 , const char T_2 * V_142 , int V_118 , T_3 V_49 )
{
struct V_120 V_121 ;
int V_35 = F_72 ( V_118 , V_49 , & V_121 ) ;
struct V_142 * V_149 ;
if ( V_35 )
return V_35 ;
V_149 = F_80 ( V_142 ) ;
...
V_35 = F_82 ( V_118 ) ;
if ( V_35 >= 0 ) {
struct V_4 * V_37 = F_75 ( V_148 , V_149 , & V_121 ) ;
if ( F_67 ( V_37 ) ) {
F_83 ( V_35 ) ;
V_35 = F_81 ( V_37 ) ;
} else {
...
int F_87 ( struct V_4 * V_5 , T_8 V_150 )
{
int V_151 = 0 ;
if ( ! F_88 ( V_5 ) ) {
F_89 ( V_152 L_1 ) ;
