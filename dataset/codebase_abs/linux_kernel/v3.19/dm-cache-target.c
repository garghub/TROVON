...
{
return V_152 < V_12 -> V_172 ||
V_152 > V_12 -> V_172 + V_173 ;
}
...
F_158 ( & V_176 ) ;
F_58 ( & V_12 -> V_63 , V_59 ) ;
F_159 ( & V_176 , & V_12 -> V_116 ) ;
F_158 ( & V_12 -> V_116 ) ;
F_60 ( & V_12 -> V_63 , V_59 ) ;
while ( ! F_160 ( & V_176 ) ) {
if ( F_23 ( V_12 , & V_45 ) ) {
F_58 ( & V_12 -> V_63 , V_59 ) ;
F_159 ( & V_12 -> V_116 , & V_176 ) ;
F_60 ( & V_12 -> V_63 , V_59 ) ;
break;
}
V_8 = F_161 ( & V_176 ) ;
...
static void F_162 ( struct V_12 * V_12 , bool V_177 )
{
unsigned long V_59 ;
struct V_175 V_176 ;
struct V_8 * V_8 ;
F_158 ( & V_176 ) ;
F_58 ( & V_12 -> V_63 , V_59 ) ;
F_159 ( & V_176 , & V_12 -> V_107 ) ;
F_158 ( & V_12 -> V_107 ) ;
F_60 ( & V_12 -> V_63 , V_59 ) ;
while ( ( V_8 = F_161 ( & V_176 ) ) )
...
if ( F_23 ( V_12 , & V_45 ) )
break;
V_29 = F_165 ( V_12 -> V_50 , & V_44 , & V_48 ) ;
if ( V_29 )
break;
...
static void F_166 ( struct V_12 * V_12 , struct V_178 * V_179 )
{
int V_29 = 0 ;
T_11 V_30 = F_40 ( V_179 -> V_180 -> V_30 ) ;
T_11 V_31 = F_40 ( V_179 -> V_180 -> V_31 ) ;
while ( V_30 != V_31 ) {
V_29 = F_167 ( V_12 -> V_50 , F_168 ( V_30 ) ) ;
if ( ! V_29 ) {
V_29 = F_111 ( V_12 -> V_66 , F_168 ( V_30 ) ) ;
if ( V_29 )
break;
} else if ( V_29 == - V_181 ) {
V_29 = 0 ;
...
static bool F_173 ( struct V_12 * V_12 )
{
...
{
F_176 ( V_12 -> V_188 , F_69 ( & V_12 -> V_187 ) ) ;
}
...
{
F_176 ( V_12 -> V_23 , ! F_69 ( & V_12 -> V_22 ) ) ;
}
...
static int F_184 ( struct V_12 * V_12 )
{
if ( F_173 ( V_12 ) )
...
static void F_185 ( struct V_191 * V_192 )
{
struct V_12 * V_12 = F_186 ( V_192 , struct V_12 , V_14 ) ;
do {
if ( ! F_173 ( V_12 ) ) {
F_164 ( V_12 ) ;
F_163 ( V_12 ) ;
...
{
struct V_12 * V_12 = F_186 ( F_188 ( V_192 ) , struct V_12 , V_189 ) ;
F_189 ( V_12 -> V_50 ) ;
F_11 ( V_12 ) ;
F_190 ( V_12 -> V_13 , & V_12 -> V_189 , V_173 ) ;
}
static int F_191 ( struct V_193 * V_35 , int V_194 )
{
struct V_195 * V_196 = F_192 ( V_35 -> V_92 ) ;
return F_193 ( & V_196 -> V_197 , V_194 ) ;
}
static int F_194 ( struct V_198 * V_199 , int V_194 )
{
struct V_12 * V_12 = F_186 ( V_199 , struct V_12 , V_200 ) ;
return F_191 ( V_12 -> V_91 , V_194 ) ||
F_191 ( V_12 -> V_96 , V_194 ) ;
}
static void F_195 ( struct V_12 * V_12 )
{
unsigned V_201 ;
if ( V_12 -> V_21 )
F_196 ( V_12 -> V_21 ) ;
...
F_201 ( V_12 -> V_66 ) ;
if ( V_12 -> V_202 )
F_202 ( V_12 -> V_51 , V_12 -> V_202 ) ;
if ( V_12 -> V_91 )
F_202 ( V_12 -> V_51 , V_12 -> V_91 ) ;
if ( V_12 -> V_96 )
F_202 ( V_12 -> V_51 , V_12 -> V_96 ) ;
if ( V_12 -> V_50 )
F_203 ( V_12 -> V_50 ) ;
for ( V_201 = 0 ; V_201 < V_12 -> V_203 ; V_201 ++ )
F_204 ( V_12 -> V_204 [ V_201 ] ) ;
F_204 ( V_12 -> V_204 ) ;
F_204 ( V_12 ) ;
}
static void F_205 ( struct V_205 * V_51 )
{
struct V_12 * V_12 = V_51 -> V_206 ;
F_195 ( V_12 ) ;
}
static T_10 F_206 ( struct V_193 * V_35 )
{
return F_207 ( V_35 -> V_92 -> V_207 ) >> V_140 ;
}
static void F_208 ( struct V_208 * V_209 )
{
if ( V_209 -> V_202 )
F_202 ( V_209 -> V_51 , V_209 -> V_202 ) ;
if ( V_209 -> V_96 )
F_202 ( V_209 -> V_51 , V_209 -> V_96 ) ;
if ( V_209 -> V_91 )
F_202 ( V_209 -> V_51 , V_209 -> V_91 ) ;
F_204 ( V_209 ) ;
}
static bool F_209 ( struct V_210 * V_211 , char * * error )
{
if ( ! V_211 -> V_212 ) {
* error = L_10 ;
return false ;
...
static int F_210 ( struct V_208 * V_209 , struct V_210 * V_211 ,
char * * error )
{
int V_29 ;
T_10 V_213 ;
char V_46 [ V_214 ] ;
if ( ! F_209 ( V_211 , error ) )
return - V_215 ;
V_29 = F_211 ( V_209 -> V_51 , F_212 ( V_211 ) , V_216 | V_217 ,
& V_209 -> V_202 ) ;
if ( V_29 ) {
* error = L_11 ;
return V_29 ;
}
V_213 = F_206 ( V_209 -> V_202 ) ;
if ( V_213 > V_218 )
F_115 ( L_12 ,
F_213 ( V_209 -> V_202 -> V_92 , V_46 ) , V_219 ) ;
return 0 ;
}
static int F_214 ( struct V_208 * V_209 , struct V_210 * V_211 ,
char * * error )
{
int V_29 ;
if ( ! F_209 ( V_211 , error ) )
...
if ( ! F_209 ( V_211 , error ) )
return - V_215 ;
if ( F_217 ( F_212 ( V_211 ) , 10 , & V_223 ) || ! V_223 ||
V_223 < V_224 ||
V_223 > V_225 ||
V_223 & ( V_224 - 1 ) ) {
* error = L_16 ;
...
static void F_218 ( struct V_75 * V_226 )
{
V_226 -> V_227 = V_228 ;
V_226 -> V_77 = V_79 ;
}
static int F_219 ( struct V_208 * V_209 , struct V_210 * V_211 ,
char * * error )
{
...
F_218 ( V_226 ) ;
V_29 = F_220 ( V_230 , V_211 , & V_212 , error ) ;
if ( V_29 )
return - V_215 ;
while ( V_212 -- ) {
V_231 = F_212 ( V_211 ) ;
...
static int F_221 ( struct V_208 * V_209 , struct V_210 * V_211 ,
char * * error )
{
static struct V_229 V_230 [] = {
{ 0 , 1024 , L_23 } ,
...
if ( ! F_209 ( V_211 , error ) )
return - V_215 ;
V_209 -> V_232 = F_212 ( V_211 ) ;
V_29 = F_220 ( V_230 , V_211 , & V_209 -> V_233 , error ) ;
if ( V_29 )
return - V_215 ;
V_209 -> V_234 = ( const char * * ) V_211 -> V_235 ;
F_222 ( V_211 , V_209 -> V_233 ) ;
return 0 ;
}
static int F_223 ( struct V_208 * V_209 , int V_212 , char * * V_235 ,
char * * error )
{
int V_29 ;
struct V_210 V_211 ;
V_211 . V_212 = V_212 ;
V_211 . V_235 = V_235 ;
V_29 = F_210 ( V_209 , & V_211 , error ) ;
if ( V_29 )
return V_29 ;
V_29 = F_214 ( V_209 , & V_211 , error ) ;
if ( V_29 )
return V_29 ;
...
if ( V_29 )
return V_29 ;
V_29 = F_219 ( V_209 , & V_211 , error ) ;
if ( V_29 )
return V_29 ;
V_29 = F_221 ( V_209 , & V_211 , error ) ;
if ( V_29 )
return V_29 ;
return 0 ;
}
static int F_224 ( struct V_12 * V_12 , const char * V_33 , const char * V_236 )
{
unsigned long V_149 ;
if ( ! strcasecmp ( V_33 , L_24 ) ) {
if ( F_217 ( V_236 , 10 , & V_149 ) )
return - V_215 ;
V_12 -> V_154 = V_149 ;
return 0 ;
}
...
{
int V_29 = F_224 ( V_12 , V_33 , V_236 ) ;
if ( V_29 == V_237 )
V_29 = F_226 ( V_12 -> V_50 , V_33 , V_236 ) ;
if ( V_29 )
F_115 ( L_25 , V_33 , V_236 ) ;
return V_29 ;
}
static int F_227 ( struct V_12 * V_12 , int V_212 , const char * * V_235 )
{
int V_29 = 0 ;
if ( V_212 & 1 ) {
F_115 ( L_26 ) ;
...
while ( V_212 ) {
V_29 = F_225 ( V_12 , V_235 [ 0 ] , V_235 [ 1 ] ) ;
if ( V_29 )
break;
V_212 -= 2 ;
V_235 += 2 ;
...
static int F_228 ( struct V_12 * V_12 , struct V_208 * V_209 ,
char * * error )
{
struct V_238 * V_25 = F_229 ( V_209 -> V_232 ,
V_12 -> V_239 ,
V_12 -> V_221 ,
V_12 -> V_57 ) ;
if ( F_230 ( V_25 ) ) {
...
static bool F_232 ( T_10 V_56 ,
T_10 V_240 )
{
( void ) F_81 ( V_240 , V_56 ) ;
return V_240 > V_241 ;
}
static T_10 F_233 ( T_10 V_242 ,
T_10 V_240 )
{
T_10 V_56 = V_242 ;
if ( V_240 )
while ( F_232 ( V_56 , V_240 ) )
V_56 *= 2 ;
return V_56 ;
}
static void F_234 ( struct V_12 * V_12 , T_5 V_243 )
{
...
static int F_235 ( struct V_208 * V_209 , struct V_12 * * V_245 )
{
int V_29 = 0 ;
...
V_12 -> V_200 . V_257 = F_194 ;
F_237 ( V_51 -> V_52 , & V_12 -> V_200 ) ;
...
F_234 ( V_12 , F_168 ( V_239 ) ) ;
} else {
V_12 -> V_53 = F_239 ( V_209 -> V_223 ) ;
F_234 ( V_12 , F_168 ( V_209 -> V_220 >> V_12 -> V_53 ) ) ;
}
V_29 = F_228 ( V_12 , V_209 , error ) ;
if ( V_29 )
goto V_258;
V_12 -> V_259 = V_209 -> V_233 ;
V_12 -> V_154 = V_260 ;
V_29 = F_227 ( V_12 , V_209 -> V_233 , V_209 -> V_234 ) ;
if ( V_29 ) {
* error = L_31 ;
goto V_258;
}
V_66 = F_240 ( V_12 -> V_202 -> V_92 ,
V_209 -> V_223 , V_248 ,
F_241 ( V_12 -> V_50 ) ) ;
if ( F_230 ( V_66 ) ) {
* error = L_32 ;
...
V_12 -> V_138 = F_245 ( & V_262 ) ;
if ( F_230 ( V_12 -> V_138 ) ) {
* error = L_37 ;
V_29 = F_231 ( V_12 -> V_138 ) ;
goto V_258;
}
V_12 -> V_13 = F_246 ( L_38 V_263 , V_264 ) ;
if ( ! V_12 -> V_13 ) {
* error = L_39 ;
goto V_258;
}
F_247 ( & V_12 -> V_14 , F_185 ) ;
F_248 ( & V_12 -> V_189 , F_187 ) ;
V_12 -> V_172 = V_152 ;
V_12 -> V_16 = F_249 () ;
if ( ! V_12 -> V_16 ) {
* error = L_40 ;
...
static int F_252 ( struct V_12 * V_12 , int V_212 , const char * * V_235 )
{
unsigned V_201 ;
const char * * V_270 ;
V_270 = F_253 ( V_212 , sizeof( * V_270 ) , V_249 ) ;
if ( ! V_270 )
return - V_26 ;
for ( V_201 = 0 ; V_201 < V_212 ; V_201 ++ ) {
V_270 [ V_201 ] = F_254 ( V_235 [ V_201 ] , V_249 ) ;
if ( ! V_270 [ V_201 ] ) {
while ( V_201 -- )
F_204 ( V_270 [ V_201 ] ) ;
F_204 ( V_270 ) ;
...
static int F_255 ( struct V_205 * V_51 , unsigned V_212 , char * * V_235 )
{
int V_29 = - V_215 ;
struct V_208 * V_209 ;
struct V_12 * V_12 = NULL ;
V_209 = F_236 ( sizeof( * V_209 ) , V_249 ) ;
if ( ! V_209 ) {
V_51 -> error = L_43 ;
return - V_26 ;
}
V_209 -> V_51 = V_51 ;
V_29 = F_223 ( V_209 , V_212 , V_235 , & V_51 -> error ) ;
if ( V_29 )
goto V_271;
V_29 = F_235 ( V_209 , & V_12 ) ;
if ( V_29 )
goto V_271;
V_29 = F_252 ( V_12 , V_212 - 3 , ( const char * * ) V_235 + 3 ) ;
if ( V_29 ) {
F_195 ( V_12 ) ;
goto V_271;
}
...
static int F_256 ( struct V_12 * V_12 , struct V_8 * V_8 , struct V_15 * * V_18 )
{
int V_29 ;
T_3 V_95 = F_86 ( V_12 , V_8 ) ;
T_1 V_97 = F_74 ( V_12 ) ;
...
if ( F_257 ( F_31 ( V_95 ) >= F_31 ( V_12 -> V_246 ) ) ) {
F_79 ( V_12 , V_8 ) ;
return V_272 ;
}
...
static int F_258 ( struct V_205 * V_51 , struct V_8 * V_8 )
{
int V_29 ;
struct V_15 * V_18 = NULL ;
struct V_12 * V_12 = V_51 -> V_206 ;
V_29 = F_256 ( V_12 , V_8 , & V_18 ) ;
if ( V_29 == V_272 && V_18 ) {
F_88 ( V_12 , V_8 , V_18 ) ;
F_104 ( V_12 , V_18 , false ) ;
}
...
static int F_259 ( struct V_205 * V_51 , struct V_8 * V_8 , int error )
{
struct V_12 * V_12 = V_51 -> V_206 ;
unsigned long V_59 ;
T_1 V_97 = F_74 ( V_12 ) ;
...
static int F_260 ( struct V_12 * V_12 )
{
unsigned V_201 , V_29 ;
for ( V_201 = 0 ; V_201 < F_40 ( V_12 -> V_239 ) ; V_201 ++ ) {
V_29 = F_261 ( V_12 -> V_66 , F_168 ( V_201 ) ,
F_38 ( V_12 , F_168 ( V_201 ) ) ) ;
if ( V_29 )
return V_29 ;
}
return 0 ;
...
{
unsigned V_201 , V_29 ;
V_29 = F_263 ( V_12 -> V_66 , V_12 -> V_56 ,
V_12 -> V_60 ) ;
if ( V_29 ) {
F_169 ( L_46 ) ;
return V_29 ;
...
V_29 = F_264 ( V_12 -> V_66 , F_54 ( V_201 ) ,
...
static bool F_265 ( struct V_12 * V_12 )
{
...
F_169 ( L_48 ) ;
F_68 ( V_12 ) ;
V_276 = F_266 ( V_12 -> V_66 , V_12 -> V_50 ) ;
if ( V_276 )
F_169 ( L_49 ) ;
V_277 = F_156 ( V_12 -> V_66 , ! V_274 && ! V_275 && ! V_276 ) ;
if ( V_277 )
F_169 ( L_50 ) ;
return ! V_274 && ! V_275 && ! V_276 && ! V_277 ;
}
static void F_267 ( struct V_205 * V_51 )
{
struct V_12 * V_12 = V_51 -> V_206 ;
F_177 ( V_12 ) ;
F_179 ( V_12 ) ;
...
static int F_268 ( void * V_131 , T_3 V_44 , T_5 V_48 ,
bool V_278 , T_8 V_279 , bool V_280 )
{
int V_29 ;
struct V_12 * V_12 = V_131 ;
V_29 = F_269 ( V_12 -> V_50 , V_44 , V_48 , V_279 , V_280 ) ;
if ( V_29 )
return V_29 ;
if ( V_278 )
F_41 ( V_12 , V_44 , V_48 ) ;
...
static void F_270 ( struct V_12 * V_12 ,
struct V_281 * V_282 )
{
V_282 -> V_12 = V_12 ;
V_282 -> V_283 = V_282 -> V_284 = 0 ;
}
static void F_271 ( struct V_281 * V_282 )
{
T_10 V_46 , V_142 ;
...
static int F_272 ( void * V_131 , T_10 V_56 ,
T_9 V_58 , bool V_146 )
{
...
static T_5 F_273 ( struct V_12 * V_12 )
{
T_10 V_243 = F_206 ( V_12 -> V_96 ) ;
( void ) F_81 ( V_243 , V_12 -> V_57 ) ;
return F_168 ( V_243 ) ;
}
static bool F_274 ( struct V_12 * V_12 , T_5 V_285 )
{
if ( F_40 ( V_285 ) > F_40 ( V_12 -> V_239 ) )
return true ;
while ( F_40 ( V_285 ) < F_40 ( V_12 -> V_239 ) ) {
V_285 = F_168 ( F_40 ( V_285 ) + 1 ) ;
if ( F_38 ( V_12 , V_285 ) ) {
F_169 ( L_51 ,
...
static int F_275 ( struct V_12 * V_12 , T_5 V_285 )
{
int V_29 ;
V_29 = F_276 ( V_12 -> V_66 , V_285 ) ;
if ( V_29 ) {
F_169 ( L_52 ) ;
return V_29 ;
}
...
static int F_277 ( struct V_205 * V_51 )
{
int V_29 = 0 ;
struct V_12 * V_12 = V_51 -> V_206 ;
T_5 V_286 = F_273 ( V_12 ) ;
if ( ! V_12 -> V_267 ) {
V_29 = F_275 ( V_12 , V_286 ) ;
if ( V_29 )
return V_29 ;
V_12 -> V_267 = true ;
...
if ( ! V_12 -> V_268 ) {
V_29 = F_278 ( V_12 -> V_66 , V_12 -> V_50 ,
F_268 , V_12 ) ;
if ( V_29 ) {
F_169 ( L_53 ) ;
return V_29 ;
...
F_5 ( V_12 -> V_64 , F_56 ( V_12 -> V_60 ) ) ;
F_270 ( V_12 , & V_282 ) ;
V_29 = F_279 ( V_12 -> V_66 , F_272 , & V_282 ) ;
if ( V_29 ) {
F_169 ( L_54 ) ;
return V_29 ;
}
...
static void F_280 ( struct V_205 * V_51 )
{
struct V_12 * V_12 = V_51 -> V_206 ;
V_12 -> V_98 = true ;
F_187 ( & V_12 -> V_189 . V_150 ) ;
}
static void F_281 ( struct V_205 * V_51 , T_12 type ,
...
switch ( type ) {
case V_294 :
if ( ! ( V_287 & V_295 ) && ! F_282 ( V_51 ) ) {
V_29 = F_156 ( V_12 -> V_66 , false ) ;
if ( V_29 )
F_169 ( L_55 ) ;
}
V_29 = F_283 ( V_12 -> V_66 ,
& V_290 ) ;
if ( V_29 ) {
F_169 ( L_56 ) ;
goto V_109;
}
V_29 = F_284 ( V_12 -> V_66 , & V_291 ) ;
if ( V_29 ) {
F_169 ( L_57 ) ;
goto V_109;
}
V_293 = F_285 ( V_12 -> V_50 ) ;
F_286 ( L_58 ,
( unsigned ) V_296 ,
...
F_169 ( L_62 , ( int ) V_12 -> V_81 . V_77 ) ;
goto V_109;
}
F_286 ( L_63 , ( unsigned long long ) V_12 -> V_154 ) ;
F_286 ( L_64 , F_287 ( V_12 -> V_50 ) ) ;
if ( V_289 < V_288 ) {
V_29 = F_288 ( V_12 -> V_50 , V_245 + V_289 , V_288 - V_289 ) ;
if ( V_29 )
F_169 ( L_65 , V_29 ) ;
}
break;
case V_297 :
F_289 ( V_292 , V_12 -> V_202 -> V_92 -> V_298 ) ;
F_286 ( L_64 , V_292 ) ;
F_289 ( V_292 , V_12 -> V_96 -> V_92 -> V_298 ) ;
F_286 ( L_64 , V_292 ) ;
F_289 ( V_292 , V_12 -> V_91 -> V_92 -> V_298 ) ;
F_286 ( L_66 , V_292 ) ;
for ( V_201 = 0 ; V_201 < V_12 -> V_203 - 1 ; V_201 ++ )
F_286 ( L_67 , V_12 -> V_204 [ V_201 ] ) ;
if ( V_12 -> V_203 )
F_286 ( L_67 , V_12 -> V_204 [ V_12 -> V_203 - 1 ] ) ;
}
return;
V_109:
F_286 ( L_68 ) ;
}
static int F_290 ( struct V_12 * V_12 , const char * V_299 ,
struct V_300 * V_245 )
{
char V_301 ;
T_11 V_46 , V_142 ;
...
return V_29 ;
if ( V_29 == 2 ) {
V_245 -> V_30 = F_168 ( V_46 ) ;
V_245 -> V_31 = F_168 ( V_142 ) ;
return 0 ;
}
...
if ( V_29 == 1 ) {
V_245 -> V_30 = F_168 ( V_46 ) ;
V_245 -> V_31 = F_168 ( F_40 ( V_245 -> V_30 ) + 1u ) ;
return 0 ;
}
F_169 ( L_71 , V_299 ) ;
return - V_215 ;
}
static int F_291 ( struct V_12 * V_12 , struct V_300 * V_302 )
{
T_11 V_46 = F_40 ( V_302 -> V_30 ) ;
T_11 V_142 = F_40 ( V_302 -> V_31 ) ;
T_11 V_54 = F_40 ( V_12 -> V_239 ) ;
if ( V_46 >= V_54 ) {
F_169 ( L_72 , V_46 , V_54 ) ;
return - V_215 ;
}
if ( V_142 > V_54 ) {
F_169 ( L_73 , V_142 , V_54 ) ;
return - V_215 ;
}
if ( V_46 >= V_142 ) {
F_169 ( L_74 , V_46 , V_142 ) ;
return - V_215 ;
}
return 0 ;
}
...
F_244 ( & V_179 . V_183 ) ;
F_171 ( & V_12 -> V_184 ) ;
F_293 ( & V_179 . V_124 , & V_12 -> V_185 ) ;
F_172 ( & V_12 -> V_184 ) ;
F_11 ( V_12 ) ;
F_176 ( V_179 . V_183 , F_69 ( & V_179 . V_182 ) ) ;
return V_179 . V_109 ;
}
static int F_294 ( struct V_12 * V_12 , unsigned V_136 ,
const char * * V_303 )
{
int V_29 = 0 ;
unsigned V_201 ;
...
V_29 = F_290 ( V_12 , V_303 [ V_201 ] , & V_302 ) ;
if ( V_29 )
break;
V_29 = F_291 ( V_12 , & V_302 ) ;
if ( V_29 )
break;
...
static int F_295 ( struct V_205 * V_51 , unsigned V_212 , char * * V_235 )
{
struct V_12 * V_12 = V_51 -> V_206 ;
if ( ! V_212 )
return - V_215 ;
if ( ! strcasecmp ( V_235 [ 0 ] , L_76 ) )
return F_294 ( V_12 , V_212 - 1 , ( const char * * ) V_235 + 1 ) ;
if ( V_212 != 2 )
return - V_215 ;
return F_225 ( V_12 , V_235 [ 0 ] , V_235 [ 1 ] ) ;
}
static int F_296 ( struct V_205 * V_51 ,
T_14 F_131 , void * V_305 )
{
int V_29 = 0 ;
struct V_12 * V_12 = V_51 -> V_206 ;
V_29 = F_131 ( V_51 , V_12 -> V_96 , 0 , F_206 ( V_12 -> V_96 ) , V_305 ) ;
if ( ! V_29 )
...
{
struct V_12 * V_12 = V_51 -> V_206 ;
struct V_195 * V_196 = F_192 ( V_12 -> V_91 -> V_92 ) ;
if ( ! V_196 -> V_311 )
return V_310 ;
V_307 -> V_90 = V_12 -> V_91 -> V_92 ;
return F_298 ( V_310 , V_196 -> V_311 ( V_196 , V_307 , V_309 ) ) ;
}
static void F_299 ( struct V_12 * V_12 , struct V_312 * V_313 )
{
V_313 -> V_314 = F_300 ( T_10 , V_12 -> V_56 * 1024 ,
V_12 -> V_221 ) ;
V_313 -> V_315 = V_12 -> V_56 << V_140 ;
}
static void F_301 ( struct V_205 * V_51 , struct V_312 * V_313 )
{
struct V_12 * V_12 = V_51 -> V_206 ;
T_11 V_316 = V_313 -> V_317 >> V_140 ;
if ( V_316 < V_12 -> V_57 ||
F_51 ( V_316 , V_12 -> V_57 ) ) {
F_302 ( V_313 , V_12 -> V_57 << V_140 ) ;
