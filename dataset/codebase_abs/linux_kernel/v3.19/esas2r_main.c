...
void F_104 ( struct V_1 * V_15 , struct V_22 * V_23 )
{
T_6 V_212 ;
T_6 V_213 ;
V_212 = F_105 ( V_214 ) ;
...
T_6 F_112 ( struct V_1 * V_15 , T_6 V_217 )
{
...
V_226 -= V_136 ;
while ( V_136 -- ) {
* V_227 ++ = F_116 ( V_15 , V_218 ) ;
V_218 ++ ;
}
}
return true ;
}
void F_117 ( V_141 V_202 , void * V_229 )
{
struct V_230 * V_231 ;
struct V_232 * V_233 ;
struct V_234 * V_235 ;
...
V_242 -> V_245 = F_85 ( V_242 -> V_245 ) ;
break;
case V_246 :
case V_247 :
V_240 = (struct V_239 * ) V_229 ;
V_240 -> V_34 = F_85 ( V_240 -> V_34 ) ;
break;
case V_248 :
case V_249 :
case V_250 :
...
V_233 -> V_254 = F_118 ( V_233 -> V_254 ) ;
V_233 -> V_255 = F_85 ( V_233 -> V_255 ) ;
V_233 -> V_256 = F_119 ( V_233 -> V_256 ) ;
V_233 -> V_161 = F_119 ( V_233 -> V_161 ) ;
V_233 -> V_162 = F_119 ( V_233 -> V_162 ) ;
V_233 -> V_257 = F_119 ( V_233 -> V_257 ) ;
break;
case V_258 :
case V_259 :
case V_260 :
...
V_231 -> V_254 = F_118 ( V_231 -> V_254 ) ;
V_231 -> V_255 = F_85 ( V_231 -> V_255 ) ;
V_231 -> V_275 = F_85 ( V_231 -> V_275 ) ;
V_231 -> V_257 = F_119 ( V_231 -> V_257 ) ;
for ( V_81 = 0 ; V_81 < 32 ; V_81 ++ )
V_231 -> V_276 [ V_81 ] = F_119 ( V_231 -> V_276 [ V_81 ] ) ;
break;
case V_277 :
case V_278 :
case V_279 :
...
V_235 -> V_283 = F_118 ( V_235 -> V_283 ) ;
V_235 -> V_284 = F_85 ( V_235 -> V_284 ) ;
V_235 -> V_255 = F_85 ( V_235 -> V_255 ) ;
V_235 -> V_161 = F_119 ( V_235 -> V_161 ) ;
break;
case V_285 :
V_237 = (struct V_236 * ) V_229 ;
V_237 -> V_286 = F_85 ( V_237 -> V_286 ) ;
V_237 -> V_287 = F_85 ( V_237 -> V_287 ) ;
break;
case V_288 :
V_110 = (struct V_238 * ) V_229 ;
for ( V_81 = 0 ; V_81 < 32 ; V_81 ++ )
V_110 -> V_289 [ V_81 ] = F_119 ( V_110 -> V_289 [ V_81 ] ) ;
break;
default:
break;
}
}
void F_120 ( V_141 V_202 , void * V_229 )
{
struct V_290 * V_291 ;
switch ( V_202 ) {
case V_292 :
...
V_291 -> V_295 . V_296 = F_119 ( V_291 -> V_295 . V_296 ) ;
V_291 -> V_82 = F_85 ( V_291 -> V_82 ) ;
V_291 -> V_297 = F_85 ( V_291 -> V_297 ) ;
V_291 -> V_298 = F_85 ( V_291 -> V_298 ) ;
V_291 -> V_299 = F_85 ( V_291 -> V_299 ) ;
V_291 -> V_300 = F_85 ( V_291 -> V_300 ) ;
break;
default:
break;
}
}
void F_121 ( union V_301 * V_302 )
{
struct V_303 * V_304 = & V_302 -> V_305 ;
struct V_306 * V_307 = & V_302 -> V_308 ;
switch ( V_302 -> V_309 . V_310 ) {
case V_311 :
V_304 -> V_312 = F_85 ( V_304 -> V_312 ) ;
break;
case V_313 :
V_307 -> V_314 = F_85 ( V_307 -> V_314 ) ;
V_307 -> V_315 = F_119 ( V_307 -> V_315 ) ;
V_307 -> V_34 . V_316 . V_317 = F_119 ( V_307 -> V_34 . V_316 . V_317 ) ;
if ( V_307 -> V_309 . V_318 >= F_122 ( struct V_306 , V_34 )
+ sizeof( struct V_319 ) ) {
V_307 -> V_34 . V_320 . V_321
= F_85 ( V_307 -> V_34 . V_320 . V_321 ) ;
V_307 -> V_34 . V_320 . V_322
= F_85 ( V_307 -> V_34 . V_320 . V_322 ) ;
}
break;
case V_323 :
default:
...
unsigned long V_147 ;
F_123 ( V_23 , V_15 ) ;
F_89 ( & V_15 -> V_324 , V_147 ) ;
F_124 ( & V_23 -> V_325 , & V_15 -> V_326 ) ;
...
unsigned long V_147 ;
F_89 ( & V_15 -> V_324 , V_147 ) ;
if ( F_70 ( F_125 ( & V_15 -> V_326 ) ) ) {
F_90 ( & V_15 -> V_324 , V_147 ) ;
return NULL ;
}
V_23 = F_126 ( & V_15 -> V_326 , struct V_22 ,
V_325 ) ;
F_127 ( & V_23 -> V_325 ) ;
F_90 ( & V_15 -> V_324 , V_147 ) ;
F_128 ( V_23 , V_15 ) ;
...
void F_129 ( struct V_1 * V_15 ,
struct V_22 * V_23 )
{
F_72 ( L_91 , V_23 ) ;
F_79 ( V_23 -> V_101 ) ;
if ( F_70 ( V_23 -> V_170 != V_201 ) ) {
F_72 ( L_92 , V_23 -> V_161 ,
V_23 -> V_170 ,
...
void F_131 ( unsigned long V_330 )
{
struct V_1 * V_15 = (struct V_1 * ) V_330 ;
if ( F_70 ( F_71 ( V_331 , & V_15 -> V_332 ) ) ) {
F_132 ( V_331 , & V_15 -> V_332 ) ;
F_133 ( V_15 ) ;
}
if ( F_64 ( F_71 ( V_333 , & V_15 -> V_332 ) ) ) {
F_132 ( V_333 , & V_15 -> V_332 ) ;
F_134 ( V_15 ) ;
}
if ( F_135 ( V_15 ) )
F_136 ( V_15 ) ;
if ( F_135 ( V_15 )
|| ( F_71 ( V_333 , & V_15 -> V_332 ) )
|| ( F_71 ( V_331 , & V_15 -> V_332 ) ) ) {
F_132 ( V_334 , & V_15 -> V_147 ) ;
F_137 ( V_15 ) ;
} else {
F_132 ( V_334 , & V_15 -> V_147 ) ;
}
...
{
struct V_1 * V_15 = (struct V_1 * ) V_330 ;
F_141 ( V_331 , & V_15 -> V_332 ) ;
F_137 ( V_15 ) ;
F_138 ( V_15 ) ;
}
static void
F_142 ( struct V_338 * V_339 )
{
unsigned long V_147 ;
struct V_1 * V_15 = V_339 -> V_15 ;
F_89 ( & V_15 -> V_340 , V_147 ) ;
F_127 ( & V_339 -> V_341 ) ;
F_143 ( V_339 ) ;
F_90 ( & V_15 -> V_340 , V_147 ) ;
}
void
F_144 ( struct V_1 * V_15 )
{
unsigned long V_147 ;
F_89 ( & V_15 -> V_340 , V_147 ) ;
V_15 -> V_342 = 1 ;
...
static void F_145 ( struct V_1 * V_15 , V_126 V_161 )
{
int V_343 ;
struct V_344 * V_345 ;
V_345 = F_146 ( V_15 -> V_7 , 0 , V_161 , 0 ) ;
if ( V_345 ) {
F_31 (
V_30 ,
& ( V_345 ->
...
L_94 ,
V_161 ) ;
V_343 = F_148 ( V_15 -> V_7 , 0 , V_161 , 0 ) ;
if ( V_343 ) {
F_31 (
V_45 ,
& ( V_15 -> V_7 ->
...
static void F_149 ( struct V_1 * V_15 , V_126 V_161 )
{
struct V_344 * V_345 ;
V_345 = F_146 ( V_15 -> V_7 , 0 , V_161 , 0 ) ;
if ( V_345 ) {
...
L_115 ,
type ) ;
F_153 ( V_30 , & V_302 -> V_349 ,
V_302 -> V_349 . V_309 . V_318 ) ;
}
static void
F_154 ( struct V_362 * V_363 )
{
struct V_338 * V_339 =
...
struct V_338 * V_339 ;
unsigned long V_147 ;
V_339 = F_28 ( sizeof( struct V_338 ) , V_372 ) ;
if ( ! V_339 ) {
F_29 ( V_30 ,
L_116 ) ;
return;
...
V_339 -> V_15 = V_15 ;
F_89 ( & V_15 -> V_340 , V_147 ) ;
F_156 ( & V_339 -> V_341 , & V_15 -> V_376 ) ;
F_157 ( & V_339 -> V_363 , F_154 ) ;
F_158 (
F_159 () , V_15 -> V_377 , & V_339 -> V_363 ,
F_108 ( 1 ) ) ;
F_90 ( & V_15 -> V_340 , V_147 ) ;
}
void F_160 ( struct V_1 * V_15 , V_126 V_378 ,
V_141 V_379 )
{
if ( V_379 == V_380 )
F_155 ( V_15 , V_366 , & V_378 ,
sizeof( V_378 ) ) ;
else if ( V_379 == V_125 )
F_155 ( V_15 , V_367 , & V_378 ,
sizeof( V_378 ) ) ;
else if ( V_379 == V_381 )
F_155 ( V_15 , V_368 , & V_378 ,
sizeof( V_378 ) ) ;
}
int F_130 ( V_141 V_170 )
{
switch ( V_170 ) {
case V_382 :
case V_211 :
