...
V_20 -> V_67 = V_66 ;
V_78 = F_52 ( V_20 ) ;
V_77 = (struct V_76 * ) V_78 + V_66 / sizeof( * V_77 ) ;
...
{
int V_54 , error ;
struct V_20 * V_62 = NULL , * V_79 ( V_80 ) ;
error = - V_81 ;
for ( V_54 = 0 ; V_54 < V_43 -> V_82 ; V_54 ++ ) {
struct V_20 * V_20 ;
V_20 = F_55 ( V_69 ) ;
if ( ! V_20 )
goto V_83;
...
V_62 -> V_36 = V_43 -> V_82 * V_61 / V_43 -> V_4 ;
error = 0 ;
V_83:
if ( F_60 ( error ) && V_62 ) {
F_47 ( V_62 ) ;
...
static inline int F_62 ( struct V_84 * V_85 )
{
if ( V_85 -> V_86 )
return 0 ;
V_85 -> V_86 = F_63 ( V_61 * 2 , NULL ) ;
if ( ! V_85 -> V_86 )
return - V_81 ;
return 0 ;
}
static inline void F_64 ( struct V_84 * V_85 )
{
if ( V_85 -> V_86 )
F_65 ( V_85 -> V_86 ) ;
V_85 -> V_86 = NULL ;
}
static inline void * F_66 ( struct V_84 * V_85 ,
struct V_20 * V_6 [ 2 ] , int V_66 , int V_4 )
{
F_21 ( F_67 ( V_85 -> V_86 , V_87 , V_6 ) ) ;
V_85 -> V_88 = V_85 -> V_86 -> V_89 ;
return V_85 -> V_88 + V_66 ;
}
static inline void F_68 ( struct V_84 * V_85 ,
struct V_20 * V_6 [ 2 ] , int V_66 , int V_4 )
{
unsigned long V_89 = ( unsigned long ) V_85 -> V_88 ;
F_69 ( V_89 , V_61 * 2 ) ;
}
static inline int F_62 ( struct V_84 * V_85 )
{
...
static void * F_66 ( struct V_84 * V_85 ,
struct V_20 * V_6 [ 2 ] , int V_66 , int V_4 )
{
int V_93 [ 2 ] ;
void * V_89 ;
...
V_93 [ 1 ] = V_4 - V_93 [ 0 ] ;
V_89 = F_52 ( V_6 [ 0 ] ) ;
memcpy ( V_94 , V_89 + V_66 , V_93 [ 0 ] ) ;
F_53 ( V_89 ) ;
V_89 = F_52 ( V_6 [ 1 ] ) ;
memcpy ( V_94 + V_93 [ 0 ] , V_89 , V_93 [ 1 ] ) ;
F_53 ( V_89 ) ;
V_52:
return V_85 -> V_90 ;
}
...
V_93 [ 1 ] = V_4 - V_93 [ 0 ] ;
V_89 = F_52 ( V_6 [ 0 ] ) ;
memcpy ( V_89 + V_66 , V_94 , V_93 [ 0 ] ) ;
F_53 ( V_89 ) ;
V_89 = F_52 ( V_6 [ 1 ] ) ;
memcpy ( V_89 , V_94 + V_93 [ 0 ] , V_93 [ 1 ] ) ;
F_53 ( V_89 ) ;
V_52:
F_73 () ;
}
static int F_74 ( struct V_96 * V_97 , unsigned long V_98 ,
void * V_99 )
{
int V_100 , V_101 = ( long ) V_99 ;
struct V_84 * V_85 ;
switch ( V_98 ) {
case V_102 :
V_85 = & F_75 ( V_103 , V_101 ) ;
V_100 = F_62 ( V_85 ) ;
if ( V_100 )
return F_76 ( V_100 ) ;
break;
...
{
int V_101 , V_79 ( V_100 ) ;
F_78 () ;
F_79 ( & V_107 ) ;
F_80 (cpu) {
V_100 = F_74 ( NULL , V_102 , ( void * ) ( long ) V_101 ) ;
if ( F_81 ( V_100 ) )
break;
}
F_82 () ;
...
F_78 () ;
F_80 (cpu)
F_74 ( NULL , V_104 , ( void * ) ( long ) V_101 ) ;
F_84 ( & V_107 ) ;
F_82 () ;
}
...
{
int V_108 ;
V_108 = ( V_91 - V_31 ) / V_32 + 1 ;
if ( ( V_91 - V_31 ) % V_32 )
V_108 += 1 ;
V_109 = V_108 ;
}
static unsigned int F_86 ( int V_4 , int V_82 )
{
return V_82 * V_61 / V_4 ;
}
static bool F_87 ( struct V_42 * V_110 , int V_4 , int V_82 )
{
if ( V_110 -> V_82 != V_82 )
return false ;
if ( F_86 ( V_110 -> V_4 , V_110 -> V_82 )
!= F_86 ( V_4 , V_82 ) )
return false ;
return true ;
}
...
V_6 [ 1 ] = F_36 ( V_20 ) ;
F_21 ( ! V_6 [ 1 ] ) ;
return F_66 ( V_85 , V_6 , V_66 , V_43 -> V_4 ) ;
}
...
if ( F_60 ( ! V_4 || V_4 > V_91 ) )
return 0 ;
V_43 = V_3 -> V_42 [ F_23 ( V_4 ) ] ;
F_93 ( & V_43 -> V_116 ) ;
V_62 = F_61 ( V_43 ) ;
if ( ! V_62 ) {
F_94 ( & V_43 -> V_116 ) ;
...
V_78 = F_52 ( V_113 ) ;
V_77 = (struct V_76 * ) V_78 + V_115 / sizeof( * V_77 ) ;
V_62 -> V_71 = V_77 -> V_48 ;
...
V_3 = F_97 ( sizeof( * V_3 ) , V_92 ) ;
if ( ! V_3 )
return NULL ;
V_3 -> V_42 = F_98 ( V_109 , sizeof( struct V_42 * ) ,
V_92 ) ;
if ( ! V_3 -> V_42 ) {
F_71 ( V_3 ) ;
return NULL ;
}
for ( V_54 = V_109 - 1 ; V_54 >= 0 ; V_54 -- ) {
int V_4 ;
int V_82 ;
struct V_42 * V_43 ;
V_4 = V_31 + V_54 * V_32 ;
...
V_82 = F_34 ( V_4 ) ;
if ( V_121 ) {
if ( F_87 ( V_121 , V_4 , V_82 ) ) {
V_3 -> V_42 [ V_54 ] = V_121 ;
continue;
}
}
V_43 = F_97 ( sizeof( struct V_42 ) , V_92 ) ;
if ( ! V_43 )
goto V_122;
V_43 -> V_4 = V_4 ;
V_43 -> V_67 = V_54 ;
