...
|| ( V_422 > V_429 ) )
return - V_430 ;
if ( ! F_65 ( V_431 , V_423 , sizeof( struct V_424 ) ) ) {
F_19 ( V_432 ,
L_10
L_11 , V_422 ,
V_423 ) ;
...
V_55 = F_66 ( sizeof( struct V_424 ) , V_30 ) ;
if ( V_55 == NULL ) {
F_19 ( V_432 ,
L_12 ,
sizeof( struct V_424 ) ) ;
...
V_426 = F_67 ( V_55 , V_423 , sizeof( struct V_424 ) ) ;
if ( V_426 != 0 ) {
F_19 ( V_432 ,
L_13 ,
V_426 ,
...
V_55 -> V_24 . V_438 = V_47 ;
V_426 = 0 ;
if ( V_422 == V_439 ) {
int V_440 = 0 , V_441 = 0 ;
V_55 -> V_97 . V_442 . V_443 = 0 ;
while ( V_440 < V_444 ) {
if ( V_445 [ V_440 ] ) {
V_55 -> V_97 . V_442 . V_443 ++ ;
V_55 -> V_97 . V_442 . V_446 [ V_441 ] = V_440 ;
V_441 ++ ;
}
V_440 ++ ;
}
...
if ( V_55 -> V_24 . V_446 == 0xFF ) {
V_2 = (struct V_1 * ) V_421 ;
} else {
V_2 = V_445 [ V_55 -> V_24 . V_446 ] ;
if ( V_55 -> V_24 . V_446 >= V_444 || ( V_2 == NULL ) ) {
V_55 -> V_24 . V_438 = V_448 ;
F_19 ( V_432 , L_15 ) ;
F_68 ( V_55 ) ;
return - V_430 ;
}
...
switch ( V_422 ) {
case V_449 :
if ( V_55 -> V_97 . V_450 . V_451 == V_452 ) {
V_426 = F_69 ( V_2 ,
( char * ) V_55 -> V_97 . V_450 . V_453 ,
0 ,
sizeof( struct
V_424 ) ) ;
if ( V_426 >= 0 ) {
V_426 = F_70 ( V_2 ,
( char * ) V_55 -> V_97 . V_450 .
V_453 ,
0 ,
sizeof( struct
V_424 ) ) ;
}
} else if ( V_55 -> V_97 . V_450 . V_451 == V_454 ) {
V_426 = F_71 ( V_2 ,
( char * ) V_55 -> V_97 . V_450 . V_453 ,
0 ,
sizeof( struct
...
V_55 -> V_24 . V_438 = V_455 ;
}
break;
case V_456 :
memcpy ( V_55 -> V_97 . V_457 . V_458 , V_2 -> V_341 ,
sizeof( struct V_420 ) ) ;
V_55 -> V_97 . V_457 . V_425 = 1 ;
break;
case V_459 :
V_4 = F_7 ( V_2 ) ;
if ( V_4 == NULL ) {
...
V_425 = F_62 ( V_2 , V_4 ,
(struct V_420 * ) V_55 -> V_97 . V_457 . V_458 ) ;
V_55 -> V_97 . V_457 . V_425 = V_425 ;
F_13 ( V_2 , V_4 ) ;
break;
case V_460 :
F_73 ( V_2 ,
...
break;
case V_461 :
V_55 -> V_97 . V_462 . V_141 = V_206 ;
V_55 -> V_97 . V_462 . V_143 = V_207 ;
V_55 -> V_97 . V_462 . V_463 = V_2 -> V_26 -> V_464 ;
V_55 -> V_97 . V_462 . V_262 = V_2 -> V_26 -> V_263 ;
V_55 -> V_97 . V_462 . V_260 = V_2 -> V_26 -> V_261 ;
V_55 -> V_97 . V_462 . V_465 = V_2 -> V_26 -> V_125 ;
V_55 -> V_97 . V_462 . V_466 = V_2 -> V_26 -> V_267 ;
V_55 -> V_97 . V_462 . V_467 = V_2 -> V_26 -> V_135 -> V_136 ;
V_55 -> V_97 . V_462 . V_468 = V_2 -> V_26 -> V_138 ;
V_55 -> V_97 . V_462 . V_469 = 0 ;
V_55 -> V_97 . V_462 . V_470 = V_2 -> V_471 -> V_470 ;
V_55 -> V_97 . V_462 . V_472 = 0 ;
break;
case V_473 :
V_55 -> V_24 . V_438 = F_25 ( V_2 ,
& V_55 -> V_97 .
V_474 ) ;
break;
case V_475 :
...
break;
case V_476 :
V_55 -> V_24 . V_438 = F_61 ( V_2 ,
& V_55 -> V_97 .
V_412 ) ;
break;
case V_477 :
V_426 = F_74 ( V_2 ,
( char * ) & V_55 -> V_97 . V_478 ,
0 ,
sizeof( struct V_479 ) +
V_55 -> V_97 . V_478 . V_355 ) ;
if ( V_426 >= 0 ) {
V_426 = F_75 ( V_2 ,
( char * ) & V_55 -> V_97 . V_478 ,
0 ,
...
break;
case V_480 :
V_55 -> V_97 . V_481 . V_10 = V_2 ;
V_55 -> V_97 . V_481 . V_482 = V_2 -> V_26 ;
V_55 -> V_97 . V_481 . V_483 = V_2 -> V_471 ;
V_55 -> V_97 . V_481 . V_470 = V_2 -> V_471 -> V_470 ;
break;
default:
F_9 ( L_16 , V_422 ) ;
V_55 -> V_24 . V_438 = V_484 ;
}
V_447:
if ( V_426 < 0 ) {
F_19 ( V_432 , L_17 , V_426 ,
V_422 ) ;
switch ( V_426 ) {
case - V_434 :
case - V_485 :
V_55 -> V_24 . V_438 = V_49 ;
break;
case - V_486 :
case - V_487 :
V_55 -> V_24 . V_438 = V_488 ;
break;
default:
V_55 -> V_24 . V_438 = V_489 ;
break;
}
}
...
int F_77 ( struct V_490 * V_491 , int V_422 , void T_4 * V_423 )
{
return F_64 ( V_491 -> V_471 -> V_421 , V_422 , V_423 ) ;
}
...
int F_70 ( struct V_1 * V_2 , char * V_492 , long V_493 , int V_494 )
{
F_80 () ;
if ( V_2 -> V_14 . V_495 == V_496 ) {
int V_497 = F_81 ( int , V_494 , sizeof( V_2 -> V_14 . V_24 ) ) ;
F_82 () ;
memcpy ( V_492 , & V_2 -> V_14 . V_24 , V_497 ) ;
F_9 ( L_21 , V_497 ) ;
return V_497 ;
}
if ( V_2 -> V_14 . V_495 == V_498 ) {
...
} else if ( V_2 -> V_14 . V_24 . V_499 == V_501 ) {
int V_497 =
F_83 ( ( int ) V_494 ,
...
V_494 ,
V_50 ) ;
memcpy ( V_492 , & V_2 -> V_14 . V_97 [ V_493 ] , V_494 ) ;
if ( V_50 <= V_493 + V_494 ) {
F_9 ( L_27 ) ;
F_78 ( V_2 ) ;
}
...
int F_69 ( struct V_1 * V_2 , const char * V_492 , long V_493 ,
int V_494 )
{
T_1 V_50 ;
if ( V_493 == 0 ) {
struct V_18 * V_24 =
(struct V_18 * ) V_492 ;
int V_502 = sizeof( struct V_503 ) ;
V_2 -> V_14 . V_495 = V_504 ;
if ( V_494 < 4
|| V_24 -> V_505 > V_506 ) {
F_9 (
L_29 ) ;
...
V_492 ,
sizeof( * V_24 ) ) ;
} else if ( V_24 -> V_499 == V_500
|| V_24 -> V_499 == V_501 ) {
memcpy ( & V_2 -> V_14 . V_24 ,
V_492 ,
sizeof( * V_24 ) ) ;
V_2 -> V_14 . V_495 = V_498 ;
F_9 (
L_32 ,
V_494 , V_24 -> V_499 ) ;
return V_494 ;
...
memcpy ( & V_2 -> V_14 . V_97 [ V_493 ] , V_492 , V_494 ) ;
if ( V_50 == V_493 + V_494 ) {
F_5 ( V_2 ,
(struct V_18 * ) V_2 -> V_14 . V_97 ) ;
memcpy ( & V_2 -> V_14 . V_24 ,
...
{
struct V_1 * V_2 = (struct V_1 * ) V_8 -> V_10 ;
int V_11 = ( V_35 * ) V_8 -> V_12 - ( V_35 * ) V_2 -> V_510 ;
( * V_9 ) = V_2 -> V_511 + V_11 ;
return V_512 - V_11 ;
}
int F_75 ( struct V_1 * V_2 , char * V_492 , long V_493 , int V_494 )
{
if ( ! V_2 -> V_510 )
return - V_434 ;
if ( V_493 == 0 ) {
...
V_8 . V_515 = V_4 ;
V_8 . V_10 = V_2 ;
V_8 . V_12 = V_2 -> V_510 + V_516 ;
V_8 . V_33 = ( V_34 ) F_85 ;
V_2 -> V_508 = 0 ;
V_514 =
F_86 ( V_2 , V_513 , V_4 , & V_8 ) ;
if ( V_514 ) {
while ( ! V_2 -> V_508 )
F_11 ( V_2 -> V_509 ,
V_2 -> V_508 ) ;
...
if ( V_493 > V_512 )
return 0 ;
if ( V_494 + V_493 > V_512 )
V_494 = V_512 - V_493 ;
if ( V_494 < 0 )
return 0 ;
memcpy ( V_492 , V_2 -> V_510 + V_493 , V_494 ) ;
return V_494 ;
}
int F_74 ( struct V_1 * V_2 , const char * V_492 , long V_493 ,
int V_494 )
{
if ( ! V_2 -> V_510 ) {
V_29 V_517 ;
V_2 -> V_510 = ( V_35 * ) F_8 ( & V_2 -> V_26 -> V_27 ,
( V_28 )
V_512 ,
& V_517 ,
V_30 ) ;
...
if ( V_494 < 1 )
return 0 ;
memcpy ( V_2 -> V_510 + V_493 , V_492 , V_494 ) ;
return V_494 ;
}
...
struct V_1 * V_2 = (struct V_1 * ) V_8 -> V_10 ;
struct V_520 * V_521 =
(struct V_520 * ) V_2 -> V_522 ;
T_1 V_11 = ( V_35 * ) V_8 -> V_12 - ( V_35 * ) V_521 ;
( * V_9 ) = V_2 -> V_523 + V_11 ;
return V_2 -> V_524 - V_11 ;
}
int F_72 ( struct V_1 * V_2 , char * V_492 , long V_493 , int V_494 )
{
if ( ! V_2 -> V_522 )
return - V_434 ;
if ( V_493 == 0 ) {
...
if ( V_493 > V_2 -> V_524 )
return 0 ;
if ( V_494 + V_493 > V_2 -> V_524 )
V_494 = V_2 -> V_524 - V_493 ;
if ( V_494 < 0 )
return 0 ;
memcpy ( V_492 , V_2 -> V_522 + V_493 , V_494 ) ;
return V_494 ;
}
int F_71 ( struct V_1 * V_2 , const char * V_492 , long V_493 ,
int V_494 )
{
if ( V_493 == 0 ) {
struct V_520 * V_521 = (struct V_520 * ) V_492 ;
T_1 V_50 = V_521 -> V_528 . V_50 + F_58 (
struct V_520 ,
V_97 ) ;
if ( V_521 -> V_528 . V_528 == V_529 )
V_50 = F_58 ( struct V_520 , V_97 ) ;
if ( V_494 < F_58 ( struct V_520 , V_97 ) )
return - V_487 ;
if ( V_2 -> V_522 ) {
if ( V_2 -> V_524 < V_50 ) {
F_12 ( & V_2 -> V_26 -> V_27 ,
...
if ( V_494 < 1 )
return 0 ;
memcpy ( V_2 -> V_522 + V_493 , V_492 , V_494 ) ;
return V_494 ;
}
