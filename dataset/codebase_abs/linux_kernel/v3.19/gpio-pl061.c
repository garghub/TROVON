...
static void F_18 ( unsigned V_32 , struct V_33 * V_34 )
{
unsigned long V_35 ;
int V_3 ;
struct V_1 * V_2 = F_19 ( V_34 ) ;
struct V_4 * V_5 = F_2 ( V_2 , struct V_4 , V_2 ) ;
struct V_36 * V_37 = F_20 ( V_34 ) ;
F_21 ( V_37 , V_34 ) ;
V_35 = F_8 ( V_5 -> V_7 + V_38 ) ;
F_10 ( V_35 , V_5 -> V_7 + V_39 ) ;
if ( V_35 ) {
...
struct V_1 * V_2 = F_16 ( V_17 ) ;
struct V_4 * V_5 = F_2 ( V_2 , struct V_4 , V_2 ) ;
T_1 V_41 = F_9 ( F_17 ( V_17 ) % V_23 ) ;
T_1 V_42 ;
F_27 ( & V_5 -> V_13 ) ;
V_42 = F_8 ( V_5 -> V_7 + V_43 ) & ~ V_41 ;
F_10 ( V_42 , V_5 -> V_7 + V_43 ) ;
F_28 ( & V_5 -> V_13 ) ;
}
...
static int F_30 ( struct V_44 * V_45 , const struct V_46 * V_47 )
{
struct V_48 * V_49 = & V_45 -> V_49 ;
struct V_50 * V_51 = F_31 ( V_49 ) ;
struct V_4 * V_5 ;
int V_52 , V_32 , V_53 , V_54 ;
V_5 = F_32 ( V_49 , sizeof( * V_5 ) , V_55 ) ;
if ( V_5 == NULL )
return - V_56 ;
if ( V_51 ) {
V_5 -> V_2 . V_7 = V_51 -> V_57 ;
V_54 = V_51 -> V_54 ;
if ( V_54 <= 0 ) {
F_33 ( & V_45 -> V_49 , L_1 ) ;
return - V_58 ;
...
V_5 -> V_7 = F_34 ( V_49 , & V_45 -> V_59 ) ;
if ( F_35 ( V_5 -> V_7 ) )
return F_36 ( V_5 -> V_7 ) ;
F_37 ( & V_5 -> V_13 ) ;
if ( F_38 ( V_49 -> V_60 , L_2 ) )
V_5 -> V_8 = true ;
V_5 -> V_2 . V_61 = F_1 ;
V_5 -> V_2 . free = F_4 ;
V_5 -> V_2 . V_62 = F_6 ;
...
V_5 -> V_75 . V_81 = F_8 ( V_5 -> V_7 + V_43 ) ;
...
F_10 ( V_5 -> V_75 . V_81 , V_5 -> V_7 + V_43 ) ;
return 0 ;
}
