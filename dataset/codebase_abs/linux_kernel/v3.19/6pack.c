...
return - V_113 ;
V_34 = F_55 ( sizeof( struct V_2 ) , L_10 , V_114 ,
F_28 ) ;
if ( ! V_34 ) {
V_110 = - V_115 ;
goto V_86;
...
F_58 ( & V_3 -> V_84 , 0 ) ;
V_24 = V_34 -> V_28 * 2 ;
V_109 = F_59 ( V_24 + 4 , V_116 ) ;
V_16 = F_59 ( V_24 + 4 , V_116 ) ;
...
static int F_68 ( struct V_80 * V_12 , struct V_125 * V_125 ,
unsigned int V_71 , unsigned long V_126 )
{
struct V_2 * V_3 = F_34 ( V_12 ) ;
struct V_41 * V_34 ;
unsigned int V_127 , V_110 ;
if ( ! V_3 )
return - V_128 ;
V_34 = V_3 -> V_34 ;
switch( V_71 ) {
case V_129 :
V_110 = F_69 ( ( void V_130 * ) V_126 , V_34 -> V_38 ,
strlen ( V_34 -> V_38 ) + 1 ) ? - V_131 : 0 ;
break;
case V_132 :
V_110 = F_70 ( 0 , ( int V_130 * ) V_126 ) ;
break;
case V_133 :
if ( F_71 ( V_127 , ( int V_130 * ) V_126 ) ) {
V_110 = - V_131 ;
break;
}
V_3 -> V_134 = V_127 ;
...
default:
V_110 = F_73 ( V_12 , V_125 , V_71 , V_126 ) ;
}
F_38 ( V_3 ) ;
return V_110 ;
}
static long F_74 ( struct V_80 * V_12 , struct V_125 * V_125 ,
unsigned int V_71 , unsigned long V_126 )
{
switch ( V_71 ) {
case V_129 :
...
case V_133 :
case V_136 :
return F_68 ( V_12 , V_125 , V_71 ,
( unsigned long ) F_75 ( V_126 ) ) ;
}
return - V_137 ;
}
...
static int F_4 ( unsigned char * V_144 , unsigned char * V_145 ,
int V_146 , unsigned char V_30 )
{
int V_27 = 0 ;
unsigned char V_147 = 0 , V_89 [ 400 ] ;
int V_148 = 0 ;
V_145 [ V_148 ++ ] = V_149 | V_150 ;
V_145 [ V_148 ++ ] = V_151 ;
V_89 [ 0 ] = V_30 ;
for ( V_27 = 1 ; V_27 < V_146 ; V_27 ++ )
V_89 [ V_27 ] = V_144 [ V_27 ] ;
for ( V_27 = 0 ; V_27 < V_146 ; V_27 ++ )
V_147 += V_89 [ V_27 ] ;
V_89 [ V_146 ] = ( unsigned char ) 0xff - V_147 ;
for ( V_27 = 0 ; V_27 <= V_146 ; V_27 ++ ) {
if ( ( V_27 % 3 ) == 0 ) {
V_145 [ V_148 ++ ] = ( V_89 [ V_27 ] & 0x3f ) ;
V_145 [ V_148 ] = ( ( V_89 [ V_27 ] >> 2 ) & 0x30 ) ;
} else if ( ( V_27 % 3 ) == 1 ) {
V_145 [ V_148 ++ ] |= ( V_89 [ V_27 ] & 0x0f ) ;
V_145 [ V_148 ] = ( ( V_89 [ V_27 ] >> 2 ) & 0x3c ) ;
} else {
V_145 [ V_148 ++ ] |= ( V_89 [ V_27 ] & 0x03 ) ;
V_145 [ V_148 ++ ] = ( V_89 [ V_27 ] >> 2 ) ;
}
}
if ( ( V_146 % 3 ) != 2 )
V_148 ++ ;
...
{
unsigned char V_147 = 0 , V_157 = 0 , V_1 ;
short V_158 ;
V_1 = V_71 & V_153 ;
switch ( V_71 & V_159 ) {
case V_151 :
...
V_157 = V_3 -> V_101 ;
if ( V_157 != 0 )
for ( V_158 = V_157 ; V_158 <= 3 ; V_158 ++ )
F_80 ( V_3 , 0 ) ;
if ( V_157 == 2 )
V_3 -> V_102 -= 2 ;
else if ( V_157 == 3 )
V_3 -> V_102 -= 1 ;
for ( V_158 = 0 ; V_158 < V_3 -> V_102 ; V_158 ++ )
V_147 += V_3 -> V_76 [ V_158 ] ;
if ( V_147 != V_160 ) {
F_8 ( V_37 L_12 , V_147 ) ;
} else {
...
break;
case V_161 : F_8 ( V_37 L_13 ) ;
break;
case V_162 : F_8 ( V_37 L_14 ) ;
break;
case V_163 :
F_8 ( V_37 L_15 ) ;
}
...
static void
F_45 ( struct V_2 * V_3 , unsigned char * V_164 , int V_27 )
{
unsigned char V_108 ;
int V_90 ;
...
if ( ( V_108 & V_149 ) != 0 )
F_81 ( V_3 , V_108 ) ;
else if ( ( V_108 & V_166 ) != 0 )
F_82 ( V_3 , V_108 ) ;
else if ( ( V_3 -> V_103 & V_155 ) == V_155 )
F_80 ( V_3 , V_108 ) ;
}
}
