...
T_2 F_27 ( struct V_1 * V_2 , T_1 V_33 ,
T_1 V_34 )
{
int V_5 ;
for ( V_5 = 0 ; V_5 < V_2 -> V_6 ; V_5 ++ ) {
...
if ( V_2 == NULL )
return V_35 ;
V_16 = F_27 ( V_2 , V_37 -> V_33 , V_37 -> V_34 ) ;
F_29 ( V_2 ) ;
return V_16 ;
}
int F_30 ( T_2 V_16 ,
