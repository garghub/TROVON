...
static int F_61 ( struct V_97 * V_92 )
{
struct V_95 * V_96 ;
struct V_93 * V_8 = F_62 ( V_92 ) ;
struct V_98 * V_99 ;
V_96 = F_63 ( L_2 , 0 , 0 ) ;
if ( F_64 ( V_96 ) )
return F_65 ( V_96 ) ;
...
static void F_69 ( struct V_97 * V_92 )
{
struct V_93 * V_8 = F_62 ( V_92 ) ;
F_70 ( V_8 -> V_96 ) ;
}
static unsigned long F_71 ( struct V_58 * V_59 )
{
struct V_1 * V_9 ;
unsigned long V_101 ;
...
struct V_2 * V_63 ;
V_101 = V_80 ;
while ( ! F_72 ( & V_59 -> V_84 ) ) {
V_9 = F_73 ( V_59 -> V_84 . V_102 ,
struct V_1 , V_72 ) ;
if time_before( V_101 , V_9 -> V_78 . V_83 )
break;
F_25 () ;
...
return - V_111 ;
F_78 (cpu) {
V_103 = F_79 ( V_85 . V_86 , V_87 ) ;
V_103 -> V_75 = 0 ;
V_103 -> V_82 = 0 ;
V_103 -> V_112 = false ;
F_80 ( & V_103 -> V_60 , V_113 ) ;
V_103 -> V_87 = V_87 ;
V_103 -> V_100 = & V_85 ;
V_103 -> V_28 = (struct V_27 * ) F_81 ( sizeof( struct V_27 ) , V_114 ) ;
if ( ! V_103 -> V_28 )
goto V_115;
F_12 ( V_103 -> V_28 ) ;
F_82 ( & V_103 -> V_84 ) ;
