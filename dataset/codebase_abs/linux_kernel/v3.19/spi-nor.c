...
static int F_39 ( struct V_1 * V_2 , struct V_23 * V_24 )
{
int V_26 ;
switch ( F_12 ( V_24 ) ) {
case V_30 :
...
int F_41 ( struct V_1 * V_2 , const char * V_106 , enum V_107 V_108 )
{
...
V_24 = ( void * ) V_78 -> V_82 ;
if ( V_106 && V_24 -> V_83 ) {
const struct V_76 * V_114 ;
V_114 = F_30 ( V_2 ) ;
if ( F_44 ( V_114 ) ) {
return F_45 ( V_114 ) ;
} else if ( V_114 != V_78 ) {
F_46 ( V_9 , L_18 ,
V_114 -> V_106 , V_78 -> V_106 ) ;
V_78 = V_114 ;
V_24 = ( void * ) V_114 -> V_82 ;
}
}
F_47 ( & V_2 -> V_49 ) ;
if ( F_12 ( V_24 ) == V_115 ||
...
V_21 -> V_119 = 1 ;
V_21 -> V_38 = V_120 ;
V_21 -> V_45 = V_24 -> V_121 * V_24 -> V_122 ;
V_21 -> V_123 = F_25 ;
V_21 -> V_124 = F_33 ;
if ( F_12 ( V_24 ) == V_29 ) {
V_21 -> V_125 = F_28 ;
...
{
V_2 -> V_131 = V_135 ;
V_21 -> V_57 = V_24 -> V_121 ;
}
if ( V_24 -> V_38 & V_136 )
V_21 -> V_38 |= V_137 ;
V_21 -> V_9 . V_138 = V_9 ;
V_2 -> V_100 = V_24 -> V_100 ;
V_21 -> V_139 = V_2 -> V_100 ;
if ( V_111 ) {
if ( F_50 ( V_111 , L_19 ) )
V_2 -> V_10 = V_11 ;
else
...
V_2 -> V_10 = V_13 ;
} else if ( V_108 == V_12 && V_24 -> V_38 & V_142 ) {
V_2 -> V_10 = V_12 ;
}
switch ( V_2 -> V_10 ) {
case V_13 :
...
V_2 -> V_157 = F_6 ( V_2 ) ;
F_51 ( V_9 , L_22 , V_78 -> V_106 ,
( long long ) V_21 -> V_45 >> 10 ) ;
F_20 ( V_9 ,
L_23
L_24 ,
V_21 -> V_106 , ( long long ) V_21 -> V_45 , ( long long ) ( V_21 -> V_45 >> 20 ) ,
V_21 -> V_57 , V_21 -> V_57 / 1024 , V_21 -> V_158 ) ;
if ( V_21 -> V_158 )
for ( V_101 = 0 ; V_101 < V_21 -> V_158 ; V_101 ++ )
F_20 ( V_9 ,
L_25
L_26
L_27 ,
V_101 , ( long long ) V_21 -> V_159 [ V_101 ] . V_67 ,
V_21 -> V_159 [ V_101 ] . V_57 ,
V_21 -> V_159 [ V_101 ] . V_57 / 1024 ,
V_21 -> V_159 [ V_101 ] . V_160 ) ;
return 0 ;
}
static const struct V_76 * F_42 ( const char * V_106 )
{
const struct V_76 * V_78 = V_81 ;
while ( V_78 -> V_106 [ 0 ] ) {
if ( ! strcmp ( V_106 , V_78 -> V_106 ) )
return V_78 ;
V_78 ++ ;
}
return NULL ;
