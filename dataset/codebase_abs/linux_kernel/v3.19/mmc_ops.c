...
V_107 = sizeof( V_111 ) ;
V_9 = V_112 ;
} else if ( V_105 -> V_109 == V_113 ) {
V_106 = V_114 ;
V_107 = sizeof( V_114 ) ;
V_9 = V_115 ;
} else
return - V_68 ;
V_108 = F_22 ( V_107 , V_65 ) ;
if ( ! V_108 )
return - V_66 ;
V_48 . V_7 = & V_7 ;
V_48 . V_50 = & V_50 ;
...
static int
F_39 ( struct V_1 * V_2 , struct V_20 * V_8 , T_2 V_9 ,
T_2 V_46 )
{
struct V_47 V_48 = { NULL } ;
struct V_6 V_7 = { 0 } ;
...
V_50 . V_57 = 1 ;
F_19 ( & V_50 , V_2 ) ;
F_18 ( & V_52 , V_108 , V_46 ) ;
F_20 ( V_8 , & V_48 ) ;
V_5 = 0 ;
if ( V_9 == V_123 ) {
for ( V_33 = 0 ; V_33 < V_46 / 4 ; V_33 ++ )
if ( ( V_119 [ V_33 ] ^ V_108 [ V_33 ] ) != 0xff ) {
V_5 = - V_118 ;
break;
}
}
...
return - V_68 ;
F_39 ( V_2 , V_2 -> V_8 , V_122 , V_125 ) ;
V_5 = F_39 ( V_2 , V_2 -> V_8 , V_123 , V_125 ) ;
return V_5 ;
}
