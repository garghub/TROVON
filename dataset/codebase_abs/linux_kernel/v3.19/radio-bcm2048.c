...
V_214 ;
V_205 -> V_215 = V_205 -> V_211 |
V_216 ;
return 0 ;
}
static int F_114 ( struct V_188 * V_217 , void * V_203 ,
unsigned int * V_122 )
{
* V_122 = 0 ;
return 0 ;
}
static int F_115 ( struct V_188 * V_217 , void * V_203 ,
unsigned int V_122 )
{
if ( V_122 )
return - V_66 ;
...
{
int V_122 ;
for ( V_122 = 0 ; V_122 < F_31 ( V_220 ) ; V_122 ++ ) {
if ( V_219 -> V_221 && V_219 -> V_221 == V_220 [ V_122 ] . V_221 ) {
* V_219 = V_220 [ V_122 ] ;
return 0 ;
}
}
...
if ( ! V_2 -> V_8 )
return - V_224 ;
V_24 = F_21 ( V_2 , F_126 ( V_251 -> V_46 ) ) ;
V_24 |= F_43 ( V_2 , V_253 ) ;
return V_24 ;
}
...
if ( ! V_2 -> V_8 )
return - V_224 ;
if ( ( V_255 -> V_231 != 0 ) || ( V_255 -> type != V_234 ) )
return - V_66 ;
V_24 = F_41 ( V_2 , V_255 -> V_256 ) ;
V_24 |= F_43 ( V_2 ,
V_94 ) ;
return V_24 ;
}
static int F_128 ( struct V_5 * V_6 ,
const struct V_257 * V_221 )
{
struct V_1 * V_2 ;
int V_24 , V_258 = 0 ;
...
* V_2 -> V_259 = V_263 ;
F_135 ( V_2 -> V_259 , V_2 ) ;
if ( F_136 ( V_2 -> V_259 , V_264 , V_265 ) ) {
F_96 ( & V_6 -> V_9 , L_18 ) ;
V_24 = - V_10 ;
goto V_266;
}
