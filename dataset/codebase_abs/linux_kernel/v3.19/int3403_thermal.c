...
static int
F_31 ( struct V_49 * V_50 , unsigned long V_51 )
{
struct V_4 * V_5 = V_50 -> V_6 ;
T_1 V_11 ;
...
if ( ! V_18 )
return - V_44 ;
V_11 = F_33 ( V_5 -> V_9 -> V_12 , L_11 , NULL , & V_56 ) ;
if ( F_3 ( V_11 ) )
return - V_60 ;
V_59 = V_56 . V_61 ;
...
static int F_39 ( struct V_68 * V_37 )
{
struct V_4 * V_5 ;
int V_40 = 0 ;
T_1 V_11 ;
...
static int F_42 ( struct V_68 * V_37 )
{
struct V_4 * V_5 = F_43 ( V_37 ) ;
switch ( V_5 -> type ) {
case V_19 :
F_26 ( V_5 ) ;
break;
