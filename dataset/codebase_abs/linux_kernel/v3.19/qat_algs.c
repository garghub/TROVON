...
T_3 * V_34 ;
int V_35 , V_36 ;
F_9 ( V_19 . V_31 , V_37 + 64 ) ;
V_20 -> V_38 = V_15 -> V_21 ;
V_20 -> V_39 = 0x0 ;
if ( V_17 > V_28 ) {
char V_40 [ V_41 ] ;
int V_42 = F_10 ( V_20 , V_16 ,
V_17 , V_40 ) ;
if ( V_42 )
return V_42 ;
memcpy ( V_30 , V_40 , V_29 ) ;
memcpy ( V_32 , V_40 , V_29 ) ;
F_9 ( V_30 + V_29 , V_28 - V_29 ) ;
F_9 ( V_32 + V_29 , V_28 - V_29 ) ;
} else {
memcpy ( V_30 , V_16 , V_17 ) ;
memcpy ( V_32 , V_16 , V_17 ) ;
F_9 ( V_30 + V_17 , V_28 - V_17 ) ;
F_9 ( V_32 + V_17 , V_28 - V_17 ) ;
}
...
* V_33 = F_14 ( * ( V_23 . V_47 + V_35 ) ) ;
break;
case V_7 :
if ( F_13 ( V_20 , & V_25 ) )
return - V_11 ;
for ( V_35 = 0 ; V_35 < V_29 > > 2 ; V_35 ++ , V_33 ++ )
* V_33 = F_14 ( * ( V_25 . V_47 + V_35 ) ) ;
break;
case V_9 :
if ( F_13 ( V_20 , & V_27 ) )
return - V_11 ;
for ( V_35 = 0 ; V_35 < V_29 > > 3 ; V_35 ++ , V_34 ++ )
* V_34 = F_15 ( * ( V_27 . V_47 + V_35 ) ) ;
break;
default:
return - V_11 ;
}
if ( F_11 ( V_20 ) )
return - V_11 ;
if ( F_12 ( V_20 , V_32 , V_28 ) )
return - V_11 ;
V_36 = F_16 ( F_4 ( V_15 -> V_4 ) , 8 ) ;
...
{
struct V_66 * V_67 = F_26 ( V_15 -> V_38 ) ;
unsigned int V_68 = F_27 ( V_67 ) -> V_69 ;
...
struct V_64 V_65 ;
int V_63 ;
if ( F_38 ( V_146 , V_15 -> V_147 , V_115 ) )
return - V_11 ;
if ( F_39 ( & V_65 , V_93 , V_145 ) )
goto V_148;
switch ( V_65 . V_77 ) {
case V_149 :
V_63 = V_150 ;
...
if ( F_25 ( V_15 , V_63 , & V_65 ) )
goto error;
if ( F_34 ( V_15 , V_63 , & V_65 ) )
goto error;
return 0 ;
V_148:
F_40 ( V_15 -> V_38 , V_155 ) ;
return - V_156 ;
error:
return - V_11 ;
}
static int F_41 ( struct V_66 * V_38 , const T_1 * V_93 ,
unsigned int V_145 )
{
struct V_14 * V_15 = F_42 ( V_38 ) ;
struct V_157 * V_158 ;
F_43 ( & V_15 -> V_159 ) ;
if ( V_15 -> V_72 ) {
V_158 = & F_44 ( V_15 -> V_160 -> V_161 ) ;
F_9 ( V_15 -> V_72 , sizeof( struct V_112 ) ) ;
F_9 ( V_15 -> V_133 , sizeof( struct V_112 ) ) ;
F_9 ( & V_15 -> V_80 ,
sizeof( struct V_78 ) ) ;
F_9 ( & V_15 -> V_135 ,
sizeof( struct V_78 ) ) ;
...
V_158 = & F_44 ( V_160 -> V_161 ) ;
V_15 -> V_160 = V_160 ;
V_15 -> V_72 = F_47 ( V_158 ,
sizeof( struct V_112 ) ,
& V_15 -> V_110 ,
V_164 ) ;
if ( ! V_15 -> V_72 ) {
...
F_46 ( & V_15 -> V_159 ) ;
if ( F_37 ( V_15 , V_93 , V_145 ) )
goto V_167;
return 0 ;
V_167:
F_9 ( V_15 -> V_133 , sizeof( struct V_112 ) ) ;
F_48 ( V_158 , sizeof( struct V_112 ) ,
...
static void F_49 ( struct V_163 * V_160 ,
struct V_168 * V_169 )
{
struct V_157 * V_158 = & F_44 ( V_160 -> V_161 ) ;
...
F_50 ( V_158 , V_171 -> V_180 [ V_35 ] . V_181 ,
V_171 -> V_180 [ V_35 ] . V_182 , V_183 ) ;
F_50 ( V_158 , V_174 , V_177 , V_184 ) ;
F_51 ( V_171 ) ;
if ( V_174 != V_175 ) {
int V_185 = V_178 - V_173 -> V_186 ;
for ( V_35 = V_185 ; V_35 < V_178 ; V_35 ++ ) {
F_50 ( V_158 , V_173 -> V_180 [ V_35 ] . V_181 ,
V_173 -> V_180 [ V_35 ] . V_182 ,
V_183 ) ;
}
F_50 ( V_158 , V_175 , V_177 , V_184 ) ;
F_51 ( V_173 ) ;
}
}
static int F_52 ( struct V_163 * V_160 ,
struct V_187 * V_188 ,
struct V_187 * V_189 ,
...
{
struct V_157 * V_158 = & F_44 ( V_160 -> V_161 ) ;
int V_35 , V_178 = 0 , V_193 = F_53 ( V_189 ) , V_194 = F_53 ( V_188 ) ;
struct V_170 * V_195 ;
...
if ( F_54 ( ! V_193 ) )
return - V_156 ;
V_195 = F_55 ( V_177 , V_164 ,
F_56 ( & F_44 ( V_160 -> V_161 ) ) ) ;
if ( F_54 ( ! V_195 ) )
return - V_165 ;
V_174 = F_57 ( V_158 , V_195 , V_177 , V_184 ) ;
if ( F_54 ( F_58 ( V_158 , V_174 ) ) )
goto V_199;
F_59 (assoc, sg, assoc_n, i) {
if ( ! V_197 -> V_200 )
continue;
V_195 -> V_180 [ V_178 ] . V_181 = F_57 ( V_158 ,
F_60 ( V_197 ) ,
V_197 -> V_200 ,
V_183 ) ;
V_195 -> V_180 [ V_178 ] . V_182 = V_197 -> V_200 ;
if ( F_54 ( F_58 ( V_158 , V_195 -> V_180 [ V_178 ] . V_181 ) ) )
goto V_199;
V_178 ++ ;
}
V_195 -> V_180 [ V_178 ] . V_181 = F_57 ( V_158 , V_191 , V_192 ,
V_183 ) ;
...
V_195 -> V_180 [ V_201 ] . V_181 = F_57 ( V_158 , F_60 ( V_197 ) ,
V_197 -> V_200 ,
V_183 ) ;
V_195 -> V_180 [ V_201 ] . V_182 = V_197 -> V_200 ;
if ( F_54 ( F_58 ( V_158 , V_195 -> V_180 [ V_201 ] . V_181 ) ) )
goto V_199;
}
...
if ( V_189 != V_190 ) {
struct V_198 * V_180 ;
V_196 = F_55 ( V_177 , V_164 ,
F_56 ( & F_44 ( V_160 -> V_161 ) ) ) ;
if ( F_54 ( ! V_196 ) )
goto V_199;
V_176 = F_57 ( V_158 , V_196 , V_177 , V_184 ) ;
if ( F_54 ( F_58 ( V_158 , V_176 ) ) )
goto V_199;
V_180 = V_196 -> V_180 ;
...
F_59 (sglout, sg, n, i) {
int V_201 = V_35 + V_178 ;
V_180 [ V_201 ] . V_181 = F_57 ( V_158 , F_60 ( V_197 ) ,
V_197 -> V_200 ,
V_183 ) ;
V_196 -> V_180 [ V_201 ] . V_182 = V_197 -> V_200 ;
if ( F_54 ( F_58 ( V_158 , V_180 [ V_201 ] . V_181 ) ) )
goto V_199;
}
...
V_199:
F_61 ( V_158 , L_1 ) ;
F_59 (sgl, sg, n + bufs, i) {
if ( ! F_58 ( V_158 , V_195 -> V_180 [ V_35 ] . V_181 ) ) {
F_50 ( V_158 , V_195 -> V_180 [ V_35 ] . V_181 ,
...
F_59 (sglout, sg, n, i) {
int V_201 = V_35 + V_178 ;
if ( ! F_58 ( V_158 , V_196 -> V_180 [ V_201 ] . V_181 ) )
F_50 ( V_158 , V_196 -> V_180 [ V_201 ] . V_181 ,
V_196 -> V_180 [ V_201 ] . V_182 ,
V_183 ) ;
}
if ( ! F_58 ( V_158 , V_176 ) )
F_50 ( V_158 , V_176 , V_177 , V_184 ) ;
F_51 ( V_196 ) ;
}
return - V_165 ;
}
void F_62 ( void * V_202 )
{
...
int V_212 = 0 , V_213 = F_63 ( V_209 ) ;
F_49 ( V_160 , V_169 ) ;
if ( F_54 ( V_213 != V_214 ) )
V_212 = - V_215 ;
V_208 -> V_216 . V_217 ( & V_208 -> V_216 , V_212 ) ;
}
static int F_64 ( struct V_207 * V_208 )
{
struct V_66 * V_67 = F_65 ( V_208 ) ;
struct V_218 * V_38 = F_66 ( V_67 ) ;
struct V_14 * V_15 = F_67 ( V_38 ) ;
struct V_168 * V_169 = F_68 ( V_208 ) ;
struct V_139 * V_219 ;
struct V_136 * V_137 ;
struct V_78 * V_220 ;
int V_221 = F_27 ( V_67 ) -> V_69 ;
int V_42 , V_222 = 0 ;
V_42 = F_52 ( V_15 -> V_160 , V_208 -> V_188 , V_208 -> V_223 , V_208 -> V_224 ,
...
V_219 -> V_230 + V_115 ;
do {
V_42 = F_69 ( V_15 -> V_160 -> V_237 , ( V_238 * ) V_220 ) ;
} while ( V_42 == - V_239 && V_222 ++ < 10 );
if ( V_42 == - V_239 ) {
F_49 ( V_15 -> V_160 , V_169 ) ;
return - V_240 ;
}
return - V_241 ;
}
static int F_70 ( struct V_207 * V_208 , T_1 * V_191 ,
int V_242 )
{
struct V_66 * V_67 = F_65 ( V_208 ) ;
struct V_218 * V_38 = F_66 ( V_67 ) ;
...
{
return F_70 ( V_208 , V_208 -> V_191 , 0 ) ;
}
static int F_72 ( struct V_243 * V_225 )
{
struct V_66 * V_67 = F_65 ( & V_225 -> V_208 ) ;
struct V_218 * V_38 = F_66 ( V_67 ) ;
struct V_14 * V_15 = F_67 ( V_38 ) ;
T_3 V_244 ;
memcpy ( V_225 -> V_245 , V_15 -> V_147 , V_115 ) ;
V_244 = F_15 ( V_225 -> V_244 ) ;
memcpy ( V_225 -> V_245 + V_115 - sizeof( V_227 ) ,
& V_244 , sizeof( V_227 ) ) ;
return F_70 ( & V_225 -> V_208 , V_225 -> V_245 , 1 ) ;
}
static int F_73 ( struct V_218 * V_38 ,
enum V_3 V_13 , const char * V_246 )
{
struct V_14 * V_15 = F_67 ( V_38 ) ;
F_9 ( V_15 , sizeof( * V_15 ) ) ;
V_15 -> V_21 = F_74 ( V_246 , 0 , 0 ) ;
if ( F_75 ( V_15 -> V_21 ) )
return - V_11 ;
F_76 ( & V_15 -> V_159 ) ;
V_15 -> V_4 = V_13 ;
...
{
return F_73 ( V_38 , V_5 , L_2 ) ;
}
static int F_78 ( struct V_218 * V_38 )
{
return F_73 ( V_38 , V_7 , L_3 ) ;
}
static int F_79 ( struct V_218 * V_38 )
{
return F_73 ( V_38 , V_9 , L_4 ) ;
}
static void F_80 ( struct V_218 * V_38 )
{
struct V_14 * V_15 = F_67 ( V_38 ) ;
struct V_163 * V_160 = V_15 -> V_160 ;
struct V_157 * V_158 ;
...
if ( F_84 ( 1 , & V_249 ) == 1 ) {
int V_35 ;
for ( V_35 = 0 ; V_35 < F_85 ( V_250 ) ; V_35 ++ )
V_250 [ V_35 ] . V_251 = V_252 |
V_253 ;
return F_86 ( V_250 , F_85 ( V_250 ) ) ;
}
return 0 ;
}
int F_87 ( void )
