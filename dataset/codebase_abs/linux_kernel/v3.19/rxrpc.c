...
F_42 ( & V_53 -> V_73 , V_74 ,
(struct V_75 * ) V_55 , 1 , V_62 - V_61 ) ;
if ( V_63 + V_60 >= V_64 )
V_4 -> V_76 = V_77 ;
V_10 = F_43 ( V_4 -> V_40 , V_53 ,
V_62 - V_61 ) ;
F_44 ( V_57 [ V_60 ] ) ;
if ( V_10 < 0 )
break;
...
int F_46 ( struct V_78 * V_79 , struct V_3 * V_4 , T_3 V_80 ,
...
int V_10 ;
struct V_36 * V_37 ;
F_4 ( L_18 , V_79 -> V_84 , F_47 ( V_4 -> V_85 ) ) ;
ASSERT ( V_4 -> type != NULL ) ;
ASSERT ( V_4 -> type -> V_39 != NULL ) ;
F_15 ( L_19 ,
V_4 , V_4 -> type -> V_39 , F_48 ( V_4 -> V_86 ) ,
F_17 ( & V_35 ) ) ;
V_4 -> V_82 = V_82 ;
V_4 -> V_6 = V_87 ;
F_49 ( & V_4 -> V_5 , F_1 ) ;
...
V_53 . V_90 = NULL ;
V_53 . V_91 = 0 ;
F_42 ( & V_53 . V_73 , V_74 , (struct V_75 * ) V_55 , 1 ,
V_4 -> V_45 ) ;
V_53 . V_92 = NULL ;
V_53 . V_93 = 0 ;
...
void F_74 ( struct V_3 * V_4 , struct V_36 * V_37 )
{
T_1 V_136 = V_37 -> V_136 ;
if ( F_75 ( V_37 , 0 , V_4 -> V_50 + V_4 -> V_46 , V_136 ) < 0 )
F_21 () ;
V_4 -> V_46 += V_136 ;
}
...
static int F_79 ( struct V_3 * V_4 , struct V_36 * V_37 ,
bool V_64 )
{
T_1 V_136 = V_37 -> V_136 ;
...
F_16 ( V_4 -> V_61 , < , 4 ) ;
V_136 = F_80 ( T_1 , V_136 , 4 - V_4 -> V_61 ) ;
if ( F_75 ( V_37 , 0 , V_140 + V_4 -> V_61 , V_136 ) < 0 )
F_21 () ;
if ( ! F_81 ( V_37 , V_136 ) )
F_21 () ;
V_4 -> V_61 += V_136 ;
...
V_53 . V_90 = NULL ;
V_53 . V_91 = 0 ;
F_42 ( & V_53 . V_73 , V_74 , V_55 , 0 , 0 ) ;
V_53 . V_92 = NULL ;
V_53 . V_93 = 0 ;
V_53 . V_67 = 0 ;
V_4 -> V_76 = V_106 ;
switch ( F_43 ( V_4 -> V_40 , & V_53 , 0 ) ) {
case 0 :
F_7 ( L_34 ) ;
return;
case - V_13 :
...
void F_84 ( struct V_3 * V_4 , const void * V_143 , T_1 V_136 )
{
struct V_52 V_53 ;
struct V_75 V_55 [ 1 ] ;
int V_59 ;
...
V_53 . V_90 = NULL ;
V_53 . V_91 = 0 ;
F_42 ( & V_53 . V_73 , V_74 , V_55 , 1 , V_136 ) ;
V_53 . V_92 = NULL ;
V_53 . V_93 = 0 ;
V_53 . V_67 = 0 ;
V_4 -> V_76 = V_106 ;
V_59 = F_43 ( V_4 -> V_40 , & V_53 , V_136 ) ;
if ( V_59 >= 0 ) {
F_7 ( L_34 ) ;
return;
}
...
int F_85 ( struct V_3 * V_4 , struct V_36 * V_37 ,
bool V_64 , void * V_143 , T_1 V_58 )
{
T_1 V_136 = V_37 -> V_136 ;
F_4 ( L_37 , V_4 -> V_61 , V_136 , V_64 , V_58 ) ;
F_16 ( V_4 -> V_61 , < , V_58 ) ;
V_136 = F_80 ( T_1 , V_136 , V_58 - V_4 -> V_61 ) ;
if ( F_75 ( V_37 , 0 , V_143 + V_4 -> V_61 , V_136 ) < 0 ||
! F_81 ( V_37 , V_136 ) )
F_21 () ;
V_4 -> V_61 += V_136 ;
if ( V_4 -> V_61 < V_58 ) {
