...
V_93 = V_14 -> V_73 . V_75 ( V_14 , V_4 , V_68 ) ;
}
if ( V_93 == V_69 ) {
struct V_97 * V_98 ;
V_98 = F_87 ( V_14 -> V_98 ) ;
...
V_4 -> V_118 = V_14 -> V_72 ++ ;
F_111 ( & V_4 -> V_122 ,
F_112 ( V_14 , V_4 -> V_118 ) ) ;
F_58 ( V_14 ) ;
F_107 ( V_14 , V_4 ) ;
if ( V_14 -> V_73 . V_123 )
V_14 -> V_73 . V_123 ( V_14 , V_4 ) ;
F_73 ( V_14 ) ;
F_81 ( V_14 ) ;
}
...
return;
if ( V_14 -> V_73 . V_125 )
V_14 -> V_73 . V_125 ( V_14 , V_4 ) ;
F_115 ( & V_4 -> V_122 ) ;
F_113 ( V_14 , V_4 -> V_118 ) ;
V_4 -> V_118 = - 1 ;
V_14 -> V_72 -- ;
F_108 ( V_14 , V_4 ) ;
F_58 ( V_14 ) ;
...
V_4 = F_29 ( sizeof( struct V_1 ) + V_14 -> V_58 -> V_151 ,
V_30 ) ;
if ( ! V_4 )
return - V_31 ;
V_4 -> V_3 = V_6 ;
...
{
struct V_1 * V_4 = V_49 -> V_32 -> V_4 ;
V_49 -> V_163 . V_166 = V_4 -> V_16 . V_15 ;
return 0 ;
}
...
{
struct V_1 * V_4 = V_49 -> V_32 -> V_4 ;
V_4 -> V_16 . V_15 = V_49 -> V_163 . V_166 ;
F_12 ( V_4 ) ;
F_168 ( V_4 -> V_14 ) ;
return 0 ;
}
...
{
struct V_1 * V_4 = V_49 -> V_32 -> V_4 ;
V_49 -> V_163 . V_166 = V_4 -> V_16 . V_17 ;
return 0 ;
}
...
{
struct V_1 * V_4 = V_49 -> V_32 -> V_4 ;
V_4 -> V_16 . V_17 = V_49 -> V_163 . V_166 ;
F_12 ( V_4 ) ;
F_168 ( V_4 -> V_14 ) ;
return 0 ;
}
...
F_121 ( & V_14 -> V_136 ) ;
F_14 (port, &team->port_list, list) {
V_29 = F_216 ( V_4 -> V_3 , V_206 , V_207 ) ;
if ( V_29 )
goto V_201;
}
F_122 ( & V_14 -> V_136 ) ;
...
static int F_226 ( struct V_2 * V_3 , bool V_212 )
{
struct V_14 * V_14 = F_180 ( V_3 ) ;
V_14 -> V_71 = true ;
if ( V_212 )
...
struct V_213 * V_214 )
{
F_229 ( V_214 -> V_215 , V_216 , sizeof( V_214 -> V_215 ) ) ;
F_229 ( V_214 -> V_217 , V_218 , sizeof( V_214 -> V_217 ) ) ;
}
...
static int F_237 ( struct V_242 * V_243 , struct V_2 * V_3 ,
...
static int F_240 ( struct V_244 * V_245 [] , struct V_244 * V_163 [] )
{
if ( V_245 [ V_246 ] ) {
if ( F_241 ( V_245 [ V_246 ] ) != V_247 )
return - V_62 ;
if ( ! F_207 ( F_242 ( V_245 [ V_246 ] ) ) )
return - V_197 ;
}
return 0 ;
}
...
static int F_245 ( struct V_67 * V_68 , struct V_250 * V_32 )
{
struct V_67 * V_251 ;
void * V_252 ;
int V_29 ;
V_251 = F_246 ( V_253 , V_30 ) ;
if ( ! V_251 )
return - V_31 ;
V_252 = F_247 ( V_251 , V_32 -> V_254 , V_32 -> V_255 ,
& V_256 , 0 , V_257 ) ;
if ( ! V_252 ) {
V_29 = - V_258 ;
goto V_259;
...
F_248 ( V_251 , V_252 ) ;
return F_249 ( F_250 ( V_32 ) , V_251 , V_32 -> V_254 ) ;
V_259:
F_251 ( V_251 ) ;
return V_29 ;
}
static struct V_14 * F_252 ( struct V_250 * V_32 )
{
struct V_242 * V_242 = F_250 ( V_32 ) ;
int V_260 ;
struct V_2 * V_3 ;
struct V_14 * V_14 ;
if ( ! V_32 -> V_261 [ V_262 ] )
return NULL ;
V_260 = F_253 ( V_32 -> V_261 [ V_262 ] ) ;
V_3 = F_254 ( V_242 , V_260 ) ;
...
static void F_255 ( struct V_14 * V_14 )
{
F_122 ( & V_14 -> V_136 ) ;
F_125 ( V_14 -> V_3 ) ;
}
static int F_256 ( struct V_67 * V_68 , struct V_14 * V_14 , T_4 V_263 )
{
return F_249 ( F_257 ( V_14 -> V_3 ) , V_68 , V_263 ) ;
}
static int F_258 ( struct V_67 * V_68 , struct V_14 * V_14 ,
struct V_23 * V_24 )
{
struct V_244 * V_264 ;
...
if ( V_29 )
return V_29 ;
V_264 = F_259 ( V_68 , V_265 ) ;
if ( ! V_264 )
return - V_258 ;
if ( F_260 ( V_68 , V_266 , V_21 -> V_22 ) )
goto V_267;
if ( V_54 -> V_4 &&
F_261 ( V_68 , V_268 ,
V_54 -> V_4 -> V_3 -> V_260 ) )
...
switch ( V_21 -> type ) {
case V_270 :
if ( F_262 ( V_68 , V_271 , V_272 ) )
goto V_267;
if ( F_261 ( V_68 , V_273 , V_49 . V_163 . V_165 ) )
goto V_267;
break;
case V_274 :
if ( F_262 ( V_68 , V_271 , V_275 ) )
goto V_267;
if ( F_260 ( V_68 , V_273 ,
V_49 . V_163 . V_164 ) )
goto V_267;
break;
case V_276 :
if ( F_262 ( V_68 , V_271 , V_277 ) )
goto V_267;
if ( F_263 ( V_68 , V_273 , V_49 . V_163 . V_278 . V_102 ,
V_49 . V_163 . V_278 . V_279 ) )
goto V_267;
break;
case V_280 :
if ( F_262 ( V_68 , V_271 , V_281 ) )
goto V_267;
if ( V_49 . V_163 . V_166 &&
F_264 ( V_68 , V_273 ) )
goto V_267;
break;
case V_282 :
if ( F_262 ( V_68 , V_271 , V_283 ) )
goto V_267;
if ( F_265 ( V_68 , V_273 , V_49 . V_163 . V_167 ) )
goto V_267;
break;
default:
F_266 () ;
}
if ( V_24 -> V_35 && F_264 ( V_68 , V_284 ) )
goto V_267;
if ( V_24 -> V_34 ) {
if ( F_264 ( V_68 , V_285 ) )
goto V_267;
...
static int F_269 ( struct V_67 * * V_92 ,
...
* V_92 = F_270 ( V_287 , V_30 ) ;
if ( ! * V_92 )
return - V_31 ;
return 0 ;
}
static int F_271 ( struct V_14 * V_14 , T_4 V_263 , T_4 V_288 ,
...
struct V_23 , V_293 ) ;
V_294:
V_29 = F_269 ( & V_68 , V_14 , V_263 , V_286 ) ;
if ( V_29 )
return V_29 ;
V_252 = F_247 ( V_68 , V_263 , V_288 , & V_256 , V_145 | V_295 ,
V_296 ) ;
if ( ! V_252 )
return - V_258 ;
if ( F_261 ( V_68 , V_262 , V_14 -> V_3 -> V_260 ) )
goto V_297;
V_46 = F_259 ( V_68 , V_298 ) ;
if ( ! V_46 )
goto V_297;
V_28 = 0 ;
V_292 = false ;
F_273 (opt_inst, sel_opt_inst_list, tmp_list) {
V_29 = F_258 ( V_68 , V_14 , V_24 ) ;
if ( V_29 ) {
if ( V_29 == - V_258 ) {
if ( ! V_28 )
goto V_299;
...
goto V_294;
V_300:
V_291 = F_274 ( V_68 , V_263 , V_288 , V_301 , 0 , V_145 | V_295 ) ;
if ( ! V_291 ) {
V_29 = F_269 ( & V_68 , V_14 , V_263 , V_286 ) ;
if ( V_29 )
goto V_299;
...
static int F_276 ( struct V_67 * V_68 , struct V_250 * V_32 )
{
struct V_14 * V_14 ;
struct V_23 * V_24 ;
int V_29 ;
...
V_29 = F_271 ( V_14 , V_32 -> V_254 , V_32 -> V_255 ,
V_302 , F_256 ,
& V_289 ) ;
F_255 ( V_14 ) ;
return V_29 ;
}
static int F_278 ( struct V_67 * V_68 , struct V_250 * V_32 )
{
struct V_14 * V_14 ;
int V_29 = 0 ;
int V_28 ;
...
F_279 (nl_option, info->attrs[TEAM_ATTR_LIST_OPTION], i) {
...
char * V_20 ;
bool V_315 = false ;
if ( F_280 ( V_303 ) != V_265 ) {
V_29 = - V_62 ;
goto V_305;
}
V_29 = F_281 ( V_306 , V_307 ,
V_303 , V_316 ) ;
if ( V_29 )
goto V_305;
if ( ! V_306 [ V_266 ] ||
...
switch ( V_311 ) {
case V_270 :
V_49 . V_163 . V_165 = F_253 ( V_309 ) ;
break;
case V_274 :
if ( F_241 ( V_309 ) > V_318 ) {
V_29 = - V_62 ;
goto V_305;
}
V_49 . V_163 . V_164 = F_242 ( V_309 ) ;
break;
case V_276 :
V_49 . V_163 . V_278 . V_102 = F_241 ( V_309 ) ;
V_49 . V_163 . V_278 . V_279 = F_242 ( V_309 ) ;
break;
case V_280 :
V_49 . V_163 . V_166 = V_309 ? true : false ;
break;
case V_282 :
V_49 . V_163 . V_167 = F_283 ( V_309 ) ;
break;
default:
F_266 () ;
}
...
{
struct V_244 * V_319 ;
V_319 = F_259 ( V_68 , V_320 ) ;
if ( ! V_319 )
goto V_267;
if ( F_261 ( V_68 , V_321 , V_4 -> V_3 -> V_260 ) )
goto V_267;
if ( V_4 -> V_34 ) {
if ( F_264 ( V_68 , V_322 ) )
goto V_267;
...
F_262 ( V_68 , V_327 , V_4 -> V_18 . V_328 ) )
goto V_267;
F_267 ( V_68 , V_319 ) ;
return 0 ;
V_267:
...
static int F_287 ( struct V_14 * V_14 , T_4 V_263 , T_4 V_288 ,
int V_145 , T_11 * V_286 ,
struct V_1 * V_329 )
{
struct V_244 * V_79 ;
...
if ( F_261 ( V_68 , V_262 , V_14 -> V_3 -> V_260 ) )
goto V_297;
V_79 = F_259 ( V_68 , V_331 ) ;
if ( ! V_79 )
goto V_297;
V_28 = 0 ;
V_292 = false ;
if ( V_329 ) {
V_29 = F_286 ( V_68 , V_329 ) ;
if ( V_29 )
goto V_299;
} else if ( V_4 ) {
F_273 (port, &team->port_list, list) {
V_29 = F_286 ( V_68 , V_4 ) ;
if ( V_29 ) {
if ( V_29 == - V_258 ) {
if ( ! V_28 )
...
if ( ! V_14 )
return - V_62 ;
V_29 = F_287 ( V_14 , V_32 -> V_254 , V_32 -> V_255 ,
V_302 , F_256 , NULL ) ;
F_255 ( V_14 ) ;
return V_29 ;
}
...
struct V_14 * V_14 , T_4 V_263 )
{
return F_291 ( & V_256 , F_257 ( V_14 -> V_3 ) ,
V_68 , 0 , 0 , V_30 ) ;
}
static int F_285 ( struct V_14 * V_14 ,
struct V_107 * V_289 )
{
return F_271 ( V_14 , 0 , 0 , 0 , F_290 ,
V_289 ) ;
}
static int F_292 ( struct V_14 * V_14 ,
struct V_1 * V_4 )
{
return F_287 ( V_14 , 0 , 0 , 0 , F_290 ,
V_4 ) ;
}
static int F_293 ( void )
{
return F_294 ( & V_256 , V_332 ,
V_333 ) ;
}
...
if ( V_15 ) {
struct V_335 V_336 ;
V_29 = F_299 ( V_4 -> V_3 , & V_336 ) ;
if ( ! V_29 ) {
V_4 -> V_18 . V_326 = F_300 ( & V_336 ) ;
V_4 -> V_18 . V_328 = V_336 . V_328 ;
goto V_337;
}
}
V_4 -> V_18 . V_326 = 0 ;
V_4 -> V_18 . V_328 = 0 ;
V_337:
V_29 = F_292 ( V_4 -> V_14 , V_4 ) ;
if ( V_29 && V_29 != - V_334 )
F_297 ( V_4 -> V_14 -> V_3 , L_30 ,
V_4 -> V_3 -> V_22 , V_29 ) ;
}
...
static void F_144 ( struct V_1 * V_4 , bool V_15 )
{
F_298 ( V_4 , V_15 ) ;
F_168 ( V_4 -> V_14 ) ;
}
...
static void F_302 ( struct V_1 * V_4 , bool V_15 )
{
...
static int F_303 ( struct V_339 * V_171 ,
unsigned long V_340 , void * V_279 )
{
struct V_2 * V_3 = F_304 ( V_279 ) ;
struct V_1 * V_4 ;
V_4 = F_4 ( V_3 ) ;
if ( ! V_4 )
return V_341 ;
