...
T_1 V_92 , V_93 , V_35 ;
int V_5 ;
V_91 . V_34 [ 0 ] = F_53 ( V_76 [ 0 ] ) ;
V_91 . V_34 [ 1 ] = F_53 ( V_76 [ 1 ] ) ;
V_91 . V_34 [ 2 ] = F_53 ( V_76 [ 2 ] ) ;
...
static void * F_56 ( struct V_62 * V_63 , void * V_91 , void * V_118 )
{
void * V_119 ;
while ( V_91 < V_118 ) {
V_119 = F_52 ( V_63 , V_91 ) ;
if ( ! V_119 )
return V_91 ;
V_91 = V_119 ;
}
...
static void F_57 ( struct V_62 * V_63 , unsigned int V_120 )
{
unsigned int V_49 ;
V_49 = F_45 ( V_63 ) ;
while ( V_49 != V_120 ) {
F_58 ( V_63 -> V_4 -> V_3 . V_78 ,
F_30 ( V_63 , V_49 ) ,
V_71 , V_79 ) ;
F_32 ( V_63 , V_49 ) ;
V_49 = F_43 ( V_49 ) ;
...
V_91 = F_56 ( V_63 , V_91 , V_122 ) ;
if ( V_91 < V_122 )
goto error;
V_91 -= V_77 * V_71 ;
}
V_91 = F_56 ( V_63 , V_91 , V_118 ) ;
if ( V_91 != V_118 ) {
if ( V_91 > V_118 )
F_41 ( V_63 , L_37 ) ;
goto error;
...
if ( ! V_63 -> V_64 [ V_49 ] )
goto V_129;
V_124 = F_63 ( V_4 -> V_3 . V_78 , V_63 -> V_64 [ V_49 ] ,
0 , V_71 , V_79 ) ;
if ( F_64 ( V_4 -> V_3 . V_78 , V_124 ) ) {
F_40 ( V_63 -> V_64 [ V_49 ] ) ;
V_63 -> V_64 [ V_49 ] = NULL ;
goto V_129;
}
F_65 ( V_63 -> V_64 [ V_49 ] , V_124 ) ;
}
for ( V_49 = 0 ; V_49 < V_77 ; V_49 ++ )
V_64 [ V_49 ] = V_63 -> V_64 [ V_49 ] ;
for ( V_49 = 0 ; V_49 < V_125 ; V_49 ++ )
V_64 [ V_77 + V_49 ] = V_63 -> V_64 [ V_49 ] ;
V_63 -> V_76 = F_66 ( V_64 , F_9 ( V_64 ) , V_130 , V_131 ) ;
if ( ! V_63 -> V_76 )
goto V_129;
...
F_11 ( V_63 -> V_4 , F_68 ( V_63 -> V_74 ) , V_63 -> V_133 | 1 ) ;
F_11 ( V_63 -> V_4 , F_36 ( V_63 -> V_74 ) , V_81 ) ;
}
static struct V_66 * F_69 ( struct V_66 * V_67 , int V_142 )
{
T_3 V_143 ;
...
int V_142 ;
struct V_146 * V_147 ;
V_147 = F_71 ( V_63 -> V_148 . V_119 ,
struct V_146 , V_149 ) ;
V_84 = V_63 -> V_84 ;
while ( V_84 -> V_69 != 0 ) {
struct V_146 * V_150 = V_147 ;
V_145 = F_72 ( V_84 -> V_69 ) ;
V_142 = V_145 & 0xf ;
V_145 &= ~ 0xf ;
V_63 -> V_151 = V_145 ;
if ( V_145 < V_147 -> V_152 ||
V_145 >= V_147 -> V_152 + V_147 -> V_153 )
V_147 = F_71 ( V_147 -> V_149 . V_119 ,
struct V_146 , V_149 ) ;
V_67 = V_147 -> V_76 + ( V_145 - V_147 -> V_152 ) / sizeof( * V_67 ) ;
V_84 = F_69 ( V_67 , V_142 ) ;
if ( ! V_63 -> V_154 ( V_63 , V_67 , V_84 ) )
break;
if ( V_150 != V_147 ) {
unsigned long V_155 ;
V_150 -> V_153 = 0 ;
F_73 ( & V_63 -> V_4 -> V_156 , V_155 ) ;
F_74 ( & V_150 -> V_149 , & V_63 -> V_148 ) ;
F_75 ( & V_63 -> V_4 -> V_156 , V_155 ) ;
}
V_63 -> V_84 = V_84 ;
}
}
static int F_76 ( struct V_144 * V_63 )
{
struct V_146 * V_147 ;
T_2 V_157 ( V_158 ) ;
int V_43 ;
...
return - V_141 ;
V_147 = F_77 ( V_63 -> V_4 -> V_3 . V_78 , V_71 ,
& V_158 , V_160 ) ;
if ( ! V_147 )
return - V_141 ;
...
V_147 -> V_153 = 0 ;
F_78 ( & V_147 -> V_149 , & V_63 -> V_148 ) ;
V_63 -> V_159 += V_71 ;
return 0 ;
}
static int F_79 ( struct V_144 * V_63 , struct V_1 * V_4 ,
T_1 V_74 , T_5 V_154 )
{
V_63 -> V_4 = V_4 ;
V_63 -> V_74 = V_74 ;
...
if ( F_76 ( V_63 ) < 0 )
return - V_141 ;
V_63 -> V_162 = F_71 ( V_63 -> V_148 . V_119 ,
struct V_146 , V_149 ) ;
...
static void F_85 ( struct V_144 * V_63 , T_1 V_168 )
{
struct V_1 * V_4 = V_63 -> V_4 ;
...
F_35 () ;
V_170 = F_69 ( V_63 -> V_164 , V_63 -> V_165 ) ;
...
static void F_87 ( struct V_144 * V_63 )
{
struct V_1 * V_4 = V_63 -> V_4 ;
T_1 V_173 ;
int V_49 ;
...
static int F_89 ( struct V_144 * V_63 ,
struct V_90 * V_175 )
{
struct V_1 * V_4 = V_63 -> V_4 ;
...
F_92 ( sizeof( struct V_177 ) > sizeof( struct V_66 ) ) ;
V_177 = (struct V_177 * ) & V_67 [ 3 ] ;
V_177 -> V_175 = V_175 ;
V_175 -> V_177 = V_177 ;
if ( V_175 -> V_98 > 0 ) {
if ( V_175 -> V_98 > sizeof( V_177 -> V_183 ) ) {
V_176 = F_93 ( V_4 -> V_3 . V_78 ,
V_175 -> V_108 ,
V_175 -> V_98 ,
V_184 ) ;
if ( F_64 ( V_4 -> V_3 . V_78 , V_176 ) ) {
V_175 -> V_109 = V_178 ;
return - 1 ;
}
V_175 -> V_176 = V_176 ;
...
if ( V_175 -> V_185 )
F_94 ( V_4 -> V_3 . V_78 , V_176 ,
V_175 -> V_98 , V_184 ) ;
V_175 -> V_109 = V_187 ;
return - 1 ;
}
F_86 ( V_63 , V_67 , V_142 , 4 - V_142 ) ;
if ( V_63 -> V_169 )
...
static void F_95 ( struct V_144 * V_63 )
{
F_96 ( & V_63 -> V_126 ) ;
V_63 -> V_188 = true ;
...
static int F_98 ( struct V_144 * V_144 ,
struct V_66 * V_67 ,
struct V_66 * V_84 )
{
struct V_177 * V_177 ;
...
return 1 ;
if ( V_175 -> V_185 )
F_94 ( V_4 -> V_3 . V_78 , V_175 -> V_176 ,
V_175 -> V_98 , V_184 ) ;
V_5 = F_49 ( V_84 -> V_72 ) & 0x1f ;
V_175 -> V_110 = F_49 ( V_84 -> V_70 ) ;
...
struct V_90 V_201 ;
int V_35 , V_93 , V_49 ;
V_35 = F_100 ( V_175 -> V_34 [ 0 ] ) ;
if ( F_90 ( V_35 ) )
V_93 = F_101 ( V_175 -> V_34 [ 3 ] ) ;
else
V_93 = 4 ;
V_49 = V_200 - V_202 ;
if ( V_49 + V_93 > V_203 ) {
F_102 ( & V_201 , V_175 -> V_34 ,
V_204 , NULL , 0 ) ;
} else if ( ! F_103 ( V_35 ) ) {
F_102 ( & V_201 , V_175 -> V_34 ,
V_205 , NULL , 0 ) ;
} else {
F_102 ( & V_201 , V_175 -> V_34 , V_206 ,
...
F_20 ( V_4 , L_39 ) ;
F_102 ( & V_201 , V_175 -> V_34 , V_220 , NULL , 0 ) ;
V_215:
F_55 ( & V_4 -> V_3 , & V_201 ) ;
}
static void F_107 ( struct V_144 * V_63 , struct V_90 * V_175 )
{
T_6 V_43 , V_200 ;
...
V_43 =
( ( unsigned long long )
F_108 ( V_175 -> V_34 [ 1 ] ) << 32 ) |
V_175 -> V_34 [ 2 ] ;
V_200 = V_43 - V_222 ;
if ( V_200 >= V_202 && V_200 < V_223 )
F_99 ( V_63 -> V_4 , V_175 , V_200 ) ;
else switch ( V_200 ) {
case V_216 :
case V_224 :
case V_225 :
case V_226 :
F_104 ( V_63 -> V_4 , V_175 , V_200 ) ;
break;
default:
if ( V_63 == & V_63 -> V_4 -> V_221 )
F_54 ( & V_63 -> V_4 -> V_3 , V_175 ) ;
else
F_55 ( & V_63 -> V_4 -> V_3 , V_175 ) ;
break;
}
...
static void F_109 ( struct V_144 * V_63 , struct V_90 * V_175 )
{
unsigned long V_155 ;
int V_57 ;
F_73 ( & V_63 -> V_4 -> V_156 , V_155 ) ;
if ( F_110 ( V_175 -> V_34 [ 0 ] ) == V_63 -> V_4 -> V_29 &&
V_63 -> V_4 -> V_26 == V_175 -> V_26 ) {
F_75 ( & V_63 -> V_4 -> V_156 , V_155 ) ;
F_107 ( V_63 , V_175 ) ;
return;
}
V_57 = F_89 ( V_63 , V_175 ) ;
F_75 ( & V_63 -> V_4 -> V_156 , V_155 ) ;
if ( V_57 < 0 )
V_175 -> V_154 ( V_175 , & V_63 -> V_4 -> V_3 , V_175 -> V_109 ) ;
}
...
unsigned int V_49 ;
char V_228 [ 8 ] ;
F_111 ( V_4 , L_41 , V_231 ) ;
F_111 ( V_4 , L_42 , V_232 ) ;
F_111 ( V_4 , L_43 , V_233 ) ;
F_111 ( V_4 , L_44 , V_234 ) ;
for ( V_49 = 0 ; V_49 < 32 ; ++ V_49 ) {
if ( ! ( V_4 -> V_235 & ( 1 << V_49 ) ) )
continue;
sprintf ( V_228 , L_45 , V_49 ) ;
F_111 ( V_4 , V_228 , F_113 ( V_49 ) ) ;
}
for ( V_49 = 0 ; V_49 < 32 ; ++ V_49 ) {
if ( ! ( V_4 -> V_236 & ( 1 << V_49 ) ) )
continue;
sprintf ( V_228 , L_46 , V_49 ) ;
F_111 ( V_4 , V_228 , F_114 ( V_49 ) ) ;
}
}
static T_1 F_115 ( T_1 V_237 )
{
T_1 V_238 ;
V_238 = V_237 & 0xfff ;
...
{
T_1 V_249 = F_116 ( V_4 ) >> 25 ;
if ( F_8 ( ! V_4 -> V_250 ) ) {
F_11 ( V_4 , V_251 , V_19 ) ;
V_4 -> V_252 = ( F_118 ( F_119 () ) & ~ 0x7f ) |
( V_249 & 0x40 ) ;
V_4 -> V_250 = true ;
}
...
static int F_120 ( struct V_1 * V_4 , int V_253 )
{
int V_173 ;
F_27 ( & V_4 -> V_61 ) ;
...
static int F_121 ( struct V_1 * V_4 , T_1 V_254 ,
int V_27 )
{
int V_49 ;
T_1 V_255 ;
...
static void F_124 ( struct V_259 * V_260 )
{
struct V_1 * V_4 =
F_1 ( V_260 , struct V_1 , F_124 ) ;
...
V_26 = ( F_53 ( V_4 -> V_254 [ 0 ] ) >> 16 ) & 0xff ;
F_48 () ;
for ( V_49 = 1 , V_262 = 0 ; V_262 < V_27 ; V_49 += 2 , V_262 ++ ) {
T_1 V_274 = F_53 ( V_4 -> V_254 [ V_49 ] ) ;
T_1 V_275 = F_53 ( V_4 -> V_254 [ V_49 + 1 ] ) ;
if ( V_274 != ~ V_275 ) {
if ( V_274 == 0xffff008f ) {
F_4 ( V_4 , L_51 ) ;
V_27 = V_262 ;
...
static T_8 F_128 ( int V_288 , void * V_44 )
{
struct V_1 * V_4 = V_44 ;
T_1 V_289 , V_290 ;
int V_49 ;
...
F_2 ( V_4 , V_289 ) ;
if ( V_289 & V_10 )
F_129 ( V_292 , & V_4 -> F_124 ) ;
if ( V_289 & V_11 )
F_130 ( & V_4 -> V_117 . V_126 ) ;
if ( V_289 & V_12 )
F_130 ( & V_4 -> V_293 . V_126 ) ;
if ( V_289 & V_13 )
F_130 ( & V_4 -> V_221 . V_126 ) ;
if ( V_289 & V_14 )
F_130 ( & V_4 -> V_227 . V_126 ) ;
if ( V_289 & V_15 ) {
...
static void F_136 ( V_41 * V_303 , const V_41 * V_304 , T_9 V_93 )
{
T_9 V_305 = V_93 * 4 ;
...
if ( V_207 ) {
V_4 -> V_278 =
F_77 ( V_4 -> V_3 . V_78 , V_203 ,
& V_4 -> V_280 ,
V_127 ) ;
if ( V_4 -> V_278 == NULL )
return - V_141 ;
F_136 ( V_4 -> V_278 , V_207 , V_93 ) ;
} else {
V_4 -> V_278 = V_4 -> V_207 ;
V_4 -> V_280 = V_4 -> V_279 ;
}
...
{
struct V_1 * V_4 = V_1 ( V_3 ) ;
F_109 ( & V_4 -> V_221 , V_175 ) ;
}
static void F_144 ( struct V_2 * V_3 , struct V_90 * V_175 )
{
struct V_1 * V_4 = V_1 ( V_3 ) ;
F_109 ( & V_4 -> V_227 , V_175 ) ;
}
static int F_145 ( struct V_2 * V_3 , struct V_90 * V_175 )
{
struct V_1 * V_4 = V_1 ( V_3 ) ;
...
F_15 ( V_4 ) ;
V_215:
F_75 ( & V_4 -> V_156 , V_155 ) ;
return V_57 ;
}
static T_1 F_147 ( struct V_2 * V_3 , int V_353 )
{
struct V_1 * V_4 = V_1 ( V_3 ) ;
unsigned long V_155 ;
T_1 V_354 ;
...
static void F_149 ( struct V_2 * V_3 , int V_353 , T_1 V_354 )
{
struct V_1 * V_4 = V_1 ( V_3 ) ;
unsigned long V_155 ;
switch ( V_353 ) {
...
static void F_150 ( struct V_366 * V_63 )
{
...
static void F_151 ( struct V_366 * V_63 , const T_1 * V_371 )
{
T_1 * V_372 ;
...
V_67 ++ ;
V_377 = F_72 ( V_67 -> V_140 ) ;
F_154 ( V_144 -> V_4 -> V_3 . V_78 ,
V_377 & V_378 ,
V_377 & ~ V_378 ,
F_49 ( V_67 -> V_135 ) ,
V_79 ) ;
}
F_151 ( V_63 , ( T_1 * ) ( V_84 + 1 ) ) ;
if ( V_84 -> V_136 & F_34 ( V_186 ) )
F_150 ( V_63 ) ;
return 1 ;
}
static int F_155 ( struct V_144 * V_144 ,
struct V_66 * V_67 ,
struct V_66 * V_84 )
{
struct V_366 * V_63 =
...
T_1 V_377 ;
V_135 = F_49 ( V_84 -> V_135 ) ;
V_70 = F_49 ( F_47 ( V_84 -> V_70 ) ) ;
V_379 = V_135 - V_70 ;
V_377 = F_72 ( V_84 -> V_140 ) ;
if ( V_379 > 0 ) {
V_63 -> V_380 = V_377 ;
V_63 -> V_381 = V_379 ;
}
...
static void F_156 ( struct V_366 * V_63 )
{
F_154 ( V_63 -> V_144 . V_4 -> V_3 . V_78 ,
V_63 -> V_380 & V_378 ,
V_63 -> V_380 & ~ V_378 ,
V_63 -> V_381 , V_79 ) ;
V_63 -> V_367 . V_154 . V_382 ( & V_63 -> V_367 ,
...
static inline void F_157 ( struct V_144 * V_144 ,
struct V_66 * V_376 )
{
T_3 V_136 ;
T_1 V_377 ;
...
static int F_158 ( struct V_144 * V_144 ,
struct V_66 * V_67 ,
struct V_66 * V_84 )
{
struct V_366 * V_63 =
...
V_372 = V_63 -> V_34 + V_63 -> V_97 ;
V_63 -> V_369 = F_49 ( V_84 -> V_70 ) ;
* V_372 = F_106 ( ( F_49 ( V_376 -> V_72 ) << 16 ) |
F_49 ( V_376 -> V_70 ) ) ;
V_63 -> V_97 += 4 ;
if ( V_84 -> V_136 & F_34 ( V_186 ) )
F_150 ( V_63 ) ;
...
static void F_159 ( struct V_1 * V_4 , T_6 V_383 )
{
...
static struct V_391 * F_161 ( struct V_2 * V_3 ,
...
V_393 = & V_4 -> V_398 ;
V_154 = F_153 ;
V_65 = * V_383 & 1ULL << V_392 ? F_131 ( * V_393 ) - 1 : - 1 ;
if ( V_65 >= 0 ) {
* V_383 &= ~ ( 1ULL << V_392 ) ;
* V_393 &= ~ ( 1 << V_65 ) ;
V_74 = F_114 ( V_65 ) ;
...
V_393 = & V_4 -> V_398 ;
V_154 = F_155 ;
V_65 = ! V_4 -> V_400 ? F_131 ( * V_393 ) - 1 : - 1 ;
if ( V_65 >= 0 ) {
V_4 -> V_400 = true ;
* V_393 &= ~ ( 1 << V_65 ) ;
V_74 = F_114 ( V_65 ) ;
...
V_57 = F_79 ( & V_63 -> V_144 , V_4 , V_74 , V_154 ) ;
if ( V_57 < 0 )
goto V_402;
if ( type == V_399 ) {
F_159 ( V_4 , 0 ) ;
...
static int F_165 ( struct V_391 * V_367 ,
...
F_11 ( V_4 , F_166 ( V_63 -> V_144 . V_74 ) , V_407 ) ;
F_85 ( & V_63 -> V_144 , V_136 ) ;
V_63 -> V_404 = V_404 ;
V_63 -> V_405 = V_405 ;
break;
}
...
static int F_167 ( struct V_391 * V_367 )
{
...
F_15 ( V_4 ) ;
F_87 ( & V_63 -> V_144 ) ;
F_168 ( & V_63 -> V_144 . V_126 ) ;
return 0 ;
}
static void F_169 ( struct V_391 * V_367 )
{
struct V_1 * V_4 = V_1 ( V_367 -> V_3 ) ;
struct V_366 * V_63 = F_1 ( V_367 , struct V_366 , V_367 ) ;
unsigned long V_155 ;
...
static int F_170 ( struct V_391 * V_367 , T_6 * V_383 )
{
struct V_1 * V_4 = V_1 ( V_367 -> V_3 ) ;
unsigned long V_155 ;
int V_57 ;
...
V_63 = & V_4 -> V_295 [ V_49 ] ;
if ( V_63 -> V_144 . V_169 )
F_165 ( & V_63 -> V_367 , 0 , V_63 -> V_404 , V_63 -> V_405 ) ;
}
...
static int F_172 ( struct V_366 * V_63 ,
struct V_419 * V_175 ,
struct V_420 * V_76 ,
unsigned long V_108 )
{
...
if ( V_91 -> V_97 > 0 )
V_142 ++ ;
V_427 = F_173 ( V_424 + V_91 -> V_98 ) >> V_429 ;
if ( V_91 -> V_98 > 0 )
V_423 = V_427 - ( V_424 >> V_429 ) ;
else
V_423 = 0 ;
V_142 += V_423 ;
V_422 = F_174 ( V_91 -> V_97 , sizeof( * V_67 ) ) ;
V_67 = F_84 ( & V_63 -> V_144 , V_142 + V_422 , & V_167 ) ;
if ( V_67 == NULL )
return - V_141 ;
if ( ! V_91 -> V_428 ) {
V_67 [ 0 ] . V_136 = F_34 ( V_179 ) ;
...
V_34 = ( T_4 * ) & V_67 [ 1 ] ;
V_34 [ 0 ] = F_33 ( F_175 ( V_91 -> V_430 ) |
F_176 ( V_91 -> V_431 ) |
F_177 ( V_182 ) |
F_178 ( V_63 -> V_367 . V_392 ) |
F_179 ( V_63 -> V_367 . V_31 ) ) ;
V_34 [ 1 ] =
F_33 ( F_180 ( V_91 -> V_97 +
V_91 -> V_98 ) ) ;
}
if ( V_91 -> V_97 > 0 ) {
...
V_139 |
V_288 ) ;
F_86 ( & V_63 -> V_144 , V_67 , V_142 , V_422 ) ;
return 0 ;
}
static int F_183 ( struct V_366 * V_63 ,
struct V_419 * V_175 ,
struct V_420 * V_76 ,
unsigned long V_108 )
{
...
V_373 = F_184 ( V_63 -> V_367 . V_373 , ( T_9 ) 8 ) ;
V_422 = F_174 ( V_373 , sizeof( * V_67 ) ) ;
V_59 = V_108 >> V_429 ;
V_43 = V_108 & ~ V_378 ;
V_436 = V_175 -> V_98 / V_435 ;
for ( V_49 = 0 ; V_49 < V_435 ; V_49 ++ ) {
V_142 = F_174 ( V_436 + V_43 , V_71 ) + 1 ;
V_67 = F_84 ( & V_63 -> V_144 ,
V_142 + V_422 , & V_167 ) ;
if ( V_67 == NULL )
return - V_141 ;
...
static int F_185 ( struct V_366 * V_63 ,
struct V_419 * V_175 ,
struct V_420 * V_76 ,
unsigned long V_108 )
{
...
V_43 = V_108 & ~ V_378 ;
V_434 = V_175 -> V_98 ;
V_142 = F_174 ( V_43 + V_434 , V_71 ) ;
if ( F_148 ( V_43 & 3 || V_434 & 3 || V_59 + V_142 > V_76 -> V_439 ) )
return - V_440 ;
for ( V_49 = 0 ; V_49 < V_142 ; V_49 ++ ) {
V_67 = F_84 ( & V_63 -> V_144 , 1 , & V_167 ) ;
if ( V_67 == NULL )
return - V_141 ;
V_67 -> V_136 = F_34 ( V_137 |
V_139 ) ;
...
V_43 = 0 ;
V_59 ++ ;
F_86 ( & V_63 -> V_144 , V_67 , 1 , 0 ) ;
}
return 0 ;
}
static int F_186 ( struct V_391 * V_367 ,
struct V_419 * V_175 ,
struct V_420 * V_76 ,
unsigned long V_108 )
{
...
unsigned long V_155 ;
int V_57 = - V_401 ;
F_73 ( & V_63 -> V_144 . V_4 -> V_156 , V_155 ) ;
switch ( V_367 -> type ) {
case V_394 :
V_57 = F_172 ( V_63 , V_175 , V_76 , V_108 ) ;
break;
case V_396 :
V_57 = F_183 ( V_63 , V_175 , V_76 , V_108 ) ;
break;
case V_399 :
V_57 = F_185 ( V_63 , V_175 , V_76 , V_108 ) ;
break;
}
F_75 ( & V_63 -> V_144 . V_4 -> V_156 , V_155 ) ;
return V_57 ;
}
static void F_187 ( struct V_391 * V_367 )
{
struct V_144 * V_63 =
& F_1 ( V_367 , struct V_366 , V_367 ) -> V_144 ;
F_11 ( V_63 -> V_4 , F_36 ( V_63 -> V_74 ) , V_75 ) ;
}
static int F_188 ( struct V_391 * V_367 )
{
struct V_366 * V_63 = F_1 ( V_367 , struct V_366 , V_367 ) ;
int V_57 = 0 ;
F_96 ( & V_63 -> V_144 . V_126 ) ;
if ( ! F_189 ( 0 , & V_63 -> V_441 ) ) {
F_70 ( ( unsigned long ) & V_63 -> V_144 ) ;
switch ( V_367 -> type ) {
case V_394 :
case V_396 :
if ( V_63 -> V_97 != 0 )
...
F_97 ( & V_63 -> V_144 . V_126 ) ;
return V_57 ;
}
static void F_192 ( struct V_442 * V_443 )
{
if ( F_193 ( V_444 ) ) {
struct V_445 * V_446 = F_194 ( V_443 ) ;
if ( V_446 ) {
F_195 ( V_447 , V_446 , 0 , 1 ) ;
F_195 ( V_448 , V_446 , 0 , 1 ) ;
}
}
}
static void F_196 ( struct V_442 * V_443 )
{
if ( F_193 ( V_444 ) ) {
struct V_445 * V_446 = F_194 ( V_443 ) ;
if ( V_446 ) {
F_195 ( V_448 , V_446 , 0 , 0 ) ;
F_195 ( V_447 , V_446 , 0 , 0 ) ;
}
}
}
static inline void F_192 ( struct V_442 * V_443 ) {}
static inline void F_196 ( struct V_442 * V_443 ) {}
static int F_197 ( struct V_442 * V_443 ,
...
F_200 ( & V_4 -> V_3 , & V_459 , & V_443 -> V_443 ) ;
F_192 ( V_443 ) ;
V_455 = F_201 ( V_443 ) ;
if ( V_455 ) {
F_198 ( & V_443 -> V_443 , L_64 ) ;
goto V_460;
}
F_202 ( V_443 ) ;
F_203 ( V_443 , V_461 , 0 ) ;
...
if ( ! ( F_208 ( V_443 , 0 ) & V_462 ) ||
F_209 ( V_443 , 0 ) < V_463 ) {
F_20 ( V_4 , L_65 ) ;
V_455 = - V_464 ;
goto V_465;
}
V_455 = F_210 ( V_443 , 0 , V_466 ) ;
if ( V_455 ) {
F_20 ( V_4 , L_66 ) ;
goto V_465;
}
V_4 -> V_45 = F_211 ( V_443 , 0 , V_463 ) ;
if ( V_4 -> V_45 == NULL ) {
F_20 ( V_4 , L_67 ) ;
V_455 = - V_464 ;
goto V_467;
...
V_455 = F_60 ( & V_4 -> V_117 , V_4 , 0 ,
V_474 ) ;
if ( V_455 < 0 )
goto V_475;
V_455 = F_60 ( & V_4 -> V_293 , V_4 , V_71 / 4 ,
V_476 ) ;
if ( V_455 < 0 )
goto V_477;
V_455 = F_79 ( & V_4 -> V_221 , V_4 ,
V_478 , F_98 ) ;
if ( V_455 < 0 )
goto V_479;
V_455 = F_79 ( & V_4 -> V_227 , V_4 ,
V_480 , F_98 ) ;
if ( V_455 < 0 )
goto V_481;
F_11 ( V_4 , V_413 , ~ 0 ) ;
...
F_11 ( V_4 , V_415 , ~ 0 ) ;
V_4 -> V_398 = V_4 -> V_236 ;
V_4 -> V_417 = F_212 ( V_4 -> V_398 ) ;
V_305 = sizeof( struct V_366 ) * V_4 -> V_417 ;
V_4 -> V_295 = F_199 ( V_305 , V_127 ) ;
F_11 ( V_4 , V_410 , ~ 0 ) ;
V_4 -> V_235 = F_13 ( V_4 , V_410 ) ;
F_11 ( V_4 , V_414 , ~ 0 ) ;
V_4 -> V_395 = V_4 -> V_235 ;
V_4 -> V_418 = F_212 ( V_4 -> V_395 ) ;
V_305 = sizeof( struct V_366 ) * V_4 -> V_418 ;
V_4 -> V_297 = F_199 ( V_305 , V_127 ) ;
...
V_455 = F_216 ( & V_4 -> V_3 , V_452 , V_453 , V_454 ) ;
if ( V_455 )
goto V_488;
V_317 = F_13 ( V_4 , V_46 ) & 0x00ff00ff ;
F_4 ( V_4 ,
...
F_37 ( & V_4 -> V_117 ) ;
V_475:
F_83 ( V_4 -> V_3 . V_78 , V_71 ,
V_4 -> V_132 , V_4 -> V_134 ) ;
V_473:
F_220 ( V_443 , V_4 -> V_45 ) ;
V_467:
F_221 ( V_443 , 0 ) ;
V_465:
F_222 ( V_443 ) ;
...
static void F_223 ( struct V_442 * V_443 )
{
struct V_1 * V_4 = F_224 ( V_443 ) ;
...
F_219 ( V_4 ) ;
F_196 ( V_443 ) ;
F_227 ( & V_443 -> V_443 , L_72 ) ;
}
static int F_228 ( struct V_442 * V_443 , T_11 V_489 )
{
struct V_1 * V_4 = F_224 ( V_443 ) ;
int V_455 ;
F_135 ( V_4 ) ;
...
V_455 = F_230 ( V_443 , F_231 ( V_443 , V_489 ) ) ;
if ( V_455 )
F_20 ( V_4 , L_74 , V_455 ) ;
F_196 ( V_443 ) ;
return 0 ;
}
static int F_232 ( struct V_442 * V_443 )
{
struct V_1 * V_4 = F_224 ( V_443 ) ;
int V_455 ;
F_192 ( V_443 ) ;
