...
F_3 ( V_6 , V_26 , V_28 ) ;
F_13 (buf, &q->active, list)
V_28 -> V_19 = V_26 -> V_19 ++ ;
return 0 ;
}
static int F_14 ( struct V_50 * V_26 , const struct V_3 * V_7 ,
...
static int F_15 ( struct V_57 * V_47 )
{
struct V_5 * V_6 = V_47 -> V_50 -> V_55 ;
struct V_27 * V_28 = F_16 ( V_47 , struct V_27 , V_47 ) ;
struct V_58 * V_59 = F_17 ( V_47 , 0 ) ;
unsigned int V_60 ;
unsigned int V_61 ;
if ( V_6 -> V_14 -> V_15 & V_16 )
V_60 = V_20 ;
...
return - V_62 ;
F_19 ( V_47 , 0 , V_61 ) ;
F_20 ( V_6 -> V_63 , & V_28 -> V_32 , V_59 -> V_64 ,
0 , V_10 * V_60 ,
V_10 , 0 ,
V_60 ) ;
return 0 ;
...
if ( V_32 -> V_66 )
F_22 ( V_6 -> V_63 , V_32 -> V_61 , V_32 -> V_66 , V_32 -> V_33 ) ;
...
V_28 -> V_32 . V_66 [ 1 ] = F_24 ( V_28 -> V_32 . V_33 + 8 ) ;
V_28 -> V_32 . V_69 [ 0 ] = F_24 ( V_70 | V_71 ) ;
...
V_28 -> V_32 . V_66 [ 0 ] |= F_24 ( V_72 ) ;
V_67 = F_11 ( V_26 -> V_44 . V_67 , struct V_27 , V_46 ) ;
F_25 ( & V_28 -> V_46 , & V_26 -> V_44 ) ;
V_28 -> V_19 = V_26 -> V_19 ++ ;
V_67 -> V_32 . V_69 [ 1 ] = F_24 ( V_28 -> V_32 . V_33 ) ;
F_12 ( 2 , L_3 ,
V_28 , V_28 -> V_47 . V_48 . V_49 ) ;
}
}
