...
struct V_107 * V_108 ;
int V_109 = - V_110 ;
V_46 = F_62 ( & V_102 -> V_51 , sizeof( * V_46 ) , V_111 ) ;
if ( ! V_46 )
goto V_112;
V_2 = F_63 ( L_22 , V_113 ) ;
if ( ! V_2 ) {
...
V_46 -> V_2 = V_2 ;
V_46 -> V_44 = V_100 ;
V_46 -> V_61 = F_64 ( - V_117 ) ;
if ( V_106 ) {
struct V_105 * V_118 ;
struct V_101 * V_119 ;
V_53 = F_62 ( & V_102 -> V_51 , sizeof( * V_53 ) , V_111 ) ;
if ( ! V_53 )
goto V_120;
V_55 = F_62 ( & V_102 -> V_51 , sizeof( * V_55 ) , V_111 ) ;
if ( ! V_55 )
goto V_120;
V_108 = F_62 ( & V_102 -> V_51 , sizeof( * V_108 ) , V_111 ) ;
if ( ! V_108 )
goto V_120;
F_65 ( V_106 , L_24 , ( T_2 * ) & V_53 -> V_121 ) ;
F_65 ( V_106 , L_25 ,
( T_2 * ) & V_55 -> V_69 ) ;
F_65 ( V_106 , L_26 , ( T_2 * ) & V_108 -> V_122 ) ;
F_65 ( V_106 , L_27 , ( T_2 * ) & V_108 -> V_123 ) ;
F_65 ( V_106 , L_28 , ( T_2 * ) & V_53 -> V_4 ) ;
V_108 -> V_124 = F_66 ( V_106 , L_29 ) ;
V_53 -> V_56 = V_55 ;
V_53 -> V_108 = V_108 ;
V_118 = F_67 ( V_106 , L_30 , 0 ) ;
if ( V_118 ) {
V_119 = F_68 ( V_118 ) ;
if ( ! V_119 ) {
...
V_109 = F_72 ( V_2 , V_104 ,
F_71 ( V_104 ) ) ;
if ( V_109 ) {
F_21 ( & V_102 -> V_51 , L_32 ) ;
goto V_120;
}
V_109 = F_73 ( V_2 , V_53 , sizeof( * V_53 ) ) ;
if ( V_109 ) {
