...
* V_201 ++ = ( ( V_83 -> V_51 >> 8 ) & 0x0F ) | V_219 ;
* V_201 ++ = ( V_83 -> V_51 >> 0 ) & 0xFF ;
* V_201 ++ = V_220 ;
} else {
V_201 = F_100 ( V_2 , V_184 ) ;
* V_201 ++ = ( ( V_83 -> V_51 >> 8 ) & 0x0F ) | V_221 ;
* V_201 ++ = ( V_83 -> V_51 >> 0 ) & 0xFF ;
* V_201 ++ = V_220 ;
}
} else {
...
static int F_126 ( struct V_61 * V_18 , unsigned int V_229 , unsigned long V_230 )
{
struct V_18 * V_19 = V_18 -> V_19 ;
struct V_82 * V_83 = F_11 ( V_19 ) ;
void T_1 * V_231 = ( void T_1 * ) V_230 ;
int V_8 ;
switch ( V_229 ) {
case V_232 : {
int V_233 ;
V_233 = V_19 -> V_129 - F_127 ( V_19 ) ;
if ( V_233 < 0 )
V_233 = 0 ;
V_8 = F_55 ( V_233 , ( unsigned int T_1 * ) V_231 ) ;
break;
}
case V_234 : {
struct V_1 * V_2 ;
...
if ( V_19 )
V_8 = F_128 ( V_19 ,
(struct V_236 T_1 * ) V_231 ) ;
break;
case V_237 :
V_8 = - V_71 ;
if ( V_19 )
V_8 = F_129 ( V_19 ,
(struct V_238 T_1 * ) V_231 ) ;
break;
case V_239 :
case V_240 :
case V_241 :
...
if ( ! F_130 ( V_252 ) )
break;
V_8 = F_131 ( V_229 , V_231 ) ;
break;
case V_253 :
V_8 = F_132 ( V_229 , V_231 ) ;
break;
case V_254 :
V_8 = - V_251 ;
if ( ! F_130 ( V_252 ) )
...
struct V_182 V_111 ;
V_8 = - V_72 ;
if ( F_133 ( & V_111 , V_231 , sizeof( V_111 ) ) )
break;
V_8 = - V_71 ;
F_59 ( V_19 ) ;
if ( V_19 -> V_45 != V_46 &&
V_19 -> V_45 != V_137 )
goto V_257;
if ( V_111 . V_115 < V_258 ||
V_111 . V_115 > V_259 )
goto V_257;
if ( V_111 . V_117 < V_258 ||
V_111 . V_117 > V_259 )
goto V_257;
if ( V_111 . V_112 < 1 ||
V_111 . V_112 > 127 )
...
struct V_183 V_264 ;
V_8 = - V_72 ;
if ( F_133 ( & V_264 , V_231 , sizeof( V_264 ) ) )
break;
V_8 = - V_71 ;
F_59 ( V_19 ) ;
if ( V_19 -> V_45 != V_46 &&
...
struct V_269 V_48 ;
V_8 = - V_72 ;
if ( F_133 ( & V_48 , V_231 , sizeof( V_48 ) ) )
break;
V_8 = - V_71 ;
if ( V_48 . V_193 > V_186 )
break;
...
case V_270 : {
F_59 ( V_19 ) ;
V_8 = F_57 ( V_231 , & V_83 -> V_271 , sizeof( V_83 -> V_271 ) )
? - V_72 : 0 ;
F_60 ( V_19 ) ;
break;
}
...
struct V_273 V_271 ;
V_8 = - V_72 ;
if ( F_133 ( & V_271 , V_231 , sizeof( V_271 ) ) )
break;
F_59 ( V_19 ) ;
V_83 -> V_271 = V_271 ;
F_60 ( V_19 ) ;
...
goto V_277;
V_8 = - V_72 ;
if ( F_133 ( & V_276 , V_231 ,
sizeof( V_276 ) ) )
goto V_277;
V_8 = - V_71 ;
if ( V_276 . V_47 > V_186 )
goto V_277;
V_83 -> V_47 = V_276 . V_47 ;
V_8 = 0 ;
V_277:
F_60 ( V_19 ) ;
break;
...
static int F_134 ( unsigned int V_229 ,
...
int V_8 = - V_71 ;
V_8 = - V_72 ;
if ( F_133 ( & V_284 , V_283 , sizeof( * V_283 ) ) )
goto V_70;
V_8 = - V_71 ;
V_22 = F_135 ( V_284 . V_285 ) ;
if ( V_22 == NULL )
goto V_70;
V_31 = F_19 ( V_22 ) ;
if ( V_31 == NULL )
...
if ( V_229 == V_253 ) {
F_27 ( & V_287 ) ;
V_284 . V_218 = V_31 -> V_218 ;
V_284 . V_288 = V_31 -> V_288 ;
F_29 ( & V_287 ) ;
V_8 = F_57 ( V_283 , & V_284 ,
sizeof( * V_283 ) ) ? - V_72 : 0 ;
} else {
V_8 = - V_71 ;
if ( V_284 . V_218 == 0 || V_284 . V_218 == 1 ) {
V_8 = 0 ;
F_6 ( & V_287 ) ;
V_31 -> V_218 = V_284 . V_218 ;
...
static int F_137 ( struct V_61 * V_18 , unsigned int V_229 ,
unsigned long V_230 )
{
void T_1 * V_231 = F_138 ( V_230 ) ;
struct V_18 * V_19 = V_18 -> V_19 ;
int V_8 = - V_281 ;
switch( V_229 ) {
case V_232 :
case V_234 :
V_8 = F_126 ( V_18 , V_229 , ( unsigned long ) V_231 ) ;
break;
case V_235 :
V_8 = - V_71 ;
if ( V_19 )
