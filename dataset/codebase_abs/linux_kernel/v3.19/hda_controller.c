...
static void F_147 ( struct V_173 * V_174 , bool V_293 )
{
struct V_1 * V_2 = V_174 -> V_168 ;
if ( ! ( V_2 -> V_52 & V_280 ) )
return;
if ( V_293 )
F_148 ( V_2 -> V_101 -> V_36 ) ;
else
...
int F_151 ( struct V_1 * V_2 , const char * V_296 ,
unsigned int V_297 ,
int * V_298 )
{
struct V_299 V_300 ;
...
#endif
V_113 = F_153 ( V_2 -> V_101 , & V_300 , & V_2 -> V_174 ) ;
if ( V_113 < 0 )
return V_113 ;
if ( V_2 -> V_52 & V_314 ) {
...
if ( ( V_2 -> V_227 & ( 1 << V_301 ) ) & V_2 -> V_316 ) {
struct V_175 * V_77 ;
V_113 = F_154 ( V_2 -> V_174 , V_301 , & V_77 ) ;
if ( V_113 < 0 )
continue;
V_77 -> V_319 = F_150 ( V_2 ) ;
...
{
return F_158 ( V_2 -> V_174 ) ;
}
static bool F_159 ( struct V_1 * V_2 , unsigned char V_6 )
{
return ( V_6 >= V_2 -> V_48 &&
...
for ( V_37 = 0 ; V_37 < V_2 -> V_261 ; V_37 ++ ) {
struct V_3 * V_3 = & V_2 -> V_3 [ V_37 ] ;
V_3 -> V_14 = ( V_26 V_324 * ) ( V_2 -> V_14 . V_95 + V_37 * 8 ) ;
V_3 -> V_325 = V_2 -> V_326 + ( 0x20 * V_37 + 0x80 ) ;
V_3 -> V_282 = 1 << V_37 ;
V_3 -> V_6 = V_37 ;
if ( V_2 -> V_52 & V_327 )
V_3 -> V_16 =
...
static int F_161 ( struct V_328 * V_329 , unsigned long V_330 , void * V_198 )
{
struct V_1 * V_2 = F_22 ( V_329 , struct V_1 , V_331 ) ;
F_162 ( V_2 -> V_174 ) ;
F_137 ( V_2 ) ;
return V_332 ;
}
