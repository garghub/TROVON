...
if ( V_36 != V_103 )
goto V_104;
F_36 ( V_7 , V_105 , & V_7 -> V_106 . V_107 ) ;
F_36 ( V_7 , V_108 , & V_91 ) ;
F_36 ( V_7 , V_109 , & V_92 ) ;
V_7 -> V_106 . V_110 = ( V_92 << 16 ) | V_91 ;
if ( V_7 -> V_8 . V_100 > V_111 ) {
V_36 = V_112 ;
goto V_104;
}
F_37 ( V_7 , V_113 , 0 , NULL ) ;
V_7 -> V_8 . V_114 = false ;
V_7 -> V_115 = V_116 ;
V_36 = F_38 ( V_7 ,
V_117 ,
...
{
struct V_118 * V_9 = & ( V_7 -> V_8 . V_9 ) ;
struct V_42 * V_119 ;
V_61 V_120 = V_9 -> V_87 ;
struct V_1 V_121 ;
struct V_1 * V_2 ;
V_2 = F_13 ( * V_9 , V_120 ) ;
V_119 = F_43 ( * V_9 , V_120 ) ;
while ( F_23 ( V_7 , V_7 -> V_8 . V_9 . V_12 ) != V_120 ) {
F_44 ( V_7 , V_122 ,
L_1 , V_123 , V_120 ,
...
{
T_1 V_129 = 0 ;
struct V_45 * V_130 = NULL ;
struct V_42 * V_119 ;
struct V_1 * V_131 ;
bool V_132 = false ;
V_61 V_63 = 0 ;
T_2 V_133 = 0 ;
V_133 = F_23 ( V_7 , V_7 -> V_8 . V_9 . V_12 ) ;
if ( V_133 >= V_7 -> V_8 . V_39 ) {
F_44 ( V_7 , V_122 ,
L_2 , V_133 ) ;
V_129 = V_134 ;
goto V_135;
...
V_119 = F_43 ( V_7 -> V_8 . V_9 , V_7 -> V_8 . V_9 . V_86 ) ;
if ( V_128 ) {
* V_119 = * V_128 ;
if ( V_119 -> V_136 ) {
V_2 -> V_64 =
F_14 ( F_15 ( V_119 -> V_136 ) ) ;
V_2 -> V_65 =
F_14 ( F_16 ( V_119 -> V_136 ) ) ;
}
} else {
memset ( V_119 , 0 , sizeof( struct V_42 ) ) ;
}
V_2 -> V_56 &= ~ F_2 ( V_119 -> V_137 ) ;
V_2 -> V_56 |= F_2 ( V_119 -> V_138 ) ;
F_28 ( & V_7 -> V_8 . V_89 ) ;
if ( V_127 > V_7 -> V_8 . V_76 ) {
F_44 ( V_7 ,
V_122 ,
L_4 ,
V_127 ) ;
...
V_131 = F_13 ( V_7 -> V_8 . V_9 , V_7 -> V_8 . V_9 . V_86 ) ;
* V_131 = * V_2 ;
if ( V_126 != NULL ) {
V_130 = & ( V_7 -> V_8 . V_9 . V_50 . V_74 [ V_7 -> V_8 . V_9 . V_86 ] ) ;
memcpy ( V_130 -> V_52 , V_126 , V_127 ) ;
V_131 -> V_60 = F_2 ( V_127 ) ;
V_131 -> V_66 . V_67 . V_68 =
F_14 ( F_15 ( V_130 -> V_69 ) ) ;
V_131 -> V_66 . V_67 . V_70 =
F_14 ( F_16 ( V_130 -> V_69 ) ) ;
}
F_44 ( V_7 , V_122 , L_7 ) ;
F_48 ( V_7 , V_145 , ( void * ) V_131 ,
V_126 , V_127 ) ;
( V_7 -> V_8 . V_9 . V_86 ) ++ ;
...
F_49 ( 1000 , 2000 ) ;
V_146 ++ ;
} while ( V_146 < V_7 -> V_8 . V_94 );
}
if ( F_46 ( V_7 ) ) {
* V_2 = * V_131 ;
if ( V_126 != NULL )
memcpy ( V_126 , V_130 -> V_52 , V_127 ) ;
V_63 = F_50 ( V_2 -> V_63 ) ;
if ( V_63 != 0 ) {
F_44 ( V_7 ,
V_122 ,
...
V_132 = true ;
if ( (enum V_147 ) V_63 == V_148 )
V_129 = 0 ;
else
V_129 = V_80 ;
V_7 -> V_8 . V_149 = (enum V_147 ) V_63 ;
}
F_44 ( V_7 , V_122 ,
L_9 ) ;
F_48 ( V_7 , V_145 , ( void * ) V_2 , V_126 , V_127 ) ;
if ( ( ! V_132 ) &&
( ! V_119 -> V_142 && ! V_119 -> V_141 ) ) {
F_44 ( V_7 ,
V_122 ,
L_10 ) ;
V_129 = V_102 ;
...
V_61 V_155 ;
F_28 ( & V_7 -> V_8 . V_90 ) ;
V_155 = ( F_23 ( V_7 , V_7 -> V_8 . V_20 . V_12 ) & V_156 ) ;
if ( V_155 == V_120 ) {
V_36 = V_157 ;
goto V_158;
}
V_2 = F_13 ( V_7 -> V_8 . V_20 , V_120 ) ;
V_154 = V_120 ;
V_56 = F_50 ( V_2 -> V_56 ) ;
if ( V_56 & V_159 ) {
V_36 = V_80 ;
V_7 -> V_8 . V_160 =
(enum V_147 ) F_50 ( V_2 -> V_63 ) ;
F_44 ( V_7 ,
V_122 ,
L_11 ,
V_7 -> V_8 . V_160 ) ;
...
V_152 -> V_2 = * V_2 ;
V_60 = F_50 ( V_2 -> V_60 ) ;
V_152 -> V_161 = F_53 ( V_60 , V_152 -> V_162 ) ;
if ( V_152 -> V_163 != NULL && ( V_152 -> V_161 != 0 ) )
memcpy ( V_152 -> V_163 , V_7 -> V_8 . V_20 . V_50 . V_51 [ V_154 ] . V_52 ,
V_152 -> V_161 ) ;
F_44 ( V_7 , V_122 , L_12 ) ;
F_48 ( V_7 , V_145 , ( void * ) V_2 , V_152 -> V_163 ,
V_7 -> V_8 . V_54 ) ;
V_46 = & V_7 -> V_8 . V_20 . V_50 . V_51 [ V_120 ] ;
memset ( ( void * ) V_2 , 0 , sizeof( struct V_1 ) ) ;
V_2 -> V_56 = F_2 ( V_57 ) ;
if ( V_7 -> V_8 . V_54 > V_58 )
V_2 -> V_56 |= F_2 ( V_59 ) ;
...
F_22 ( V_7 , V_7 -> V_8 . V_20 . V_10 , V_120 ) ;
V_120 ++ ;
if ( V_120 == V_7 -> V_8 . V_44 )
V_120 = 0 ;
V_7 -> V_8 . V_20 . V_87 = V_120 ;
V_7 -> V_8 . V_20 . V_86 = V_155 ;
V_158:
if ( V_153 != NULL )
* V_153 = ( V_120 > V_155 ? V_7 -> V_8 . V_20 . V_82 : 0 ) + ( V_155 - V_120 ) ;
F_29 ( & V_7 -> V_8 . V_90 ) ;
if ( F_1 ( & V_152 -> V_2 ) ) {
if ( V_7 -> V_8 . V_114 ) {
F_54 ( V_7 ) ;
