...
if ( ! V_2 -> V_95 )
return - V_185 ;
V_182 = F_66 ( V_11 , V_2 -> V_95 , F_62 ,
V_2 -> V_186 ) ;
if ( V_182 )
return V_182 ;
V_182 = F_67 ( V_11 , & V_181 ) ;
if ( V_182 )
return V_182 ;
...
static int F_70 ( struct V_13 * V_11 )
{
struct V_1 * V_2 = F_9 ( V_11 ) ;
struct V_16 * V_203 ;
int V_21 = 0 , V_42 = 0 ;
int V_204 = V_2 -> V_20 ;
V_2 -> V_29 = F_71 ( sizeof( * V_2 -> V_29 ) * V_2 -> V_20 ,
V_73 ) ;
if ( ! V_2 -> V_29 )
return - V_74 ;
V_2 -> V_19 = 0 ;
...
static void F_73 ( struct V_13 * V_11 )
{
struct V_1 * V_2 = F_9 ( V_11 ) ;
int V_208 ;
...
V_2 -> V_19 ) ;
if ( V_2 -> V_25 )
F_75 ( V_2 -> V_11 -> V_11 . V_70 , V_2 -> V_205 ,
V_2 -> V_25 , V_2 -> V_102 ) ;
F_72 ( V_2 -> V_29 ) ;
}
static int F_76 ( struct V_13 * V_11 )
{
struct V_1 * V_2 = F_9 ( V_11 ) ;
struct V_99 * V_209 ;
int V_21 = 0 , V_42 = 0 ;
int V_210 = V_2 -> V_120 ;
V_2 -> V_122 = F_71 ( sizeof( * V_2 -> V_122 ) * V_2 -> V_120 ,
V_73 ) ;
if ( ! V_2 -> V_122 )
return - V_74 ;
V_2 -> V_116 = 0 ;
...
static void F_77 ( struct V_13 * V_11 )
{
struct V_1 * V_2 = F_9 ( V_11 ) ;
F_40 ( V_11 , 1 ) ;
F_78 ( V_2 -> V_117 != V_2 -> V_96 ) ;
if ( V_2 -> V_118 )
F_75 ( V_2 -> V_11 -> V_11 . V_70 , V_2 -> V_211 ,
V_2 -> V_118 , V_2 -> V_98 ) ;
F_72 ( V_2 -> V_122 ) ;
}
...
if ( V_182 )
return V_182 ;
V_182 = F_79 ( V_11 -> V_149 , F_58 , 0 , V_11 -> V_212 , V_11 ) ;
if ( V_182 ) {
F_80 ( & V_11 -> V_11 , L_8 ) ;
return - V_213 ;
}
...
static int F_86 ( struct V_13 * V_11 , int V_152 )
{
int V_216 ;
struct V_1 * V_2 = F_9 ( V_11 ) ;
...
F_78 ( V_2 -> V_96 == V_2 -> V_117 ) ;
V_2 -> V_116 ++ ;
return V_218 ;
}
static int F_89 ( struct V_219 * V_39 , int V_130 )
{
struct V_1 * V_2 =
...
static int F_93 ( struct V_14 * V_15 , struct V_13 * V_11 )
{
struct V_1 * V_2 = F_9 ( V_11 ) ;
struct V_131 * V_124 = & V_11 -> V_124 ;
struct V_99 * V_110 ;
...
static int F_98 ( struct V_237 * V_238 , int V_184 , int V_239 )
{
...
static int F_101 ( struct V_13 * V_11 , struct V_245 * V_246 ,
int V_181 )
{
struct V_1 * V_2 = F_9 ( V_11 ) ;
if ( V_2 -> V_95 != NULL )
return F_102 ( V_2 -> V_95 , V_246 , V_181 ) ;
return - V_247 ;
}
static int F_67 ( struct V_13 * V_11 , struct V_180 * V_181 )
{
struct V_1 * V_2 = F_9 ( V_11 ) ;
int V_182 ;
V_182 = F_103 ( V_2 -> V_95 ) ;
if ( V_182 == 0 )
V_182 = F_104 ( V_2 -> V_95 , V_181 ) ;
return V_182 ;
}
static int F_68 ( struct V_13 * V_11 , struct V_180 * V_181 )
{
struct V_1 * V_2 = F_9 ( V_11 ) ;
return F_105 ( V_2 -> V_95 , V_181 ) ;
}
static void F_106 ( struct V_13 * V_11 ,
struct V_248 * V_249 )
{
F_107 ( V_249 -> V_250 , V_251 , sizeof( V_249 -> V_250 ) ) ;
F_107 ( V_249 -> V_252 , V_253 , sizeof( V_249 -> V_252 ) ) ;
F_107 ( V_249 -> V_254 , L_12 , sizeof( V_249 -> V_254 ) ) ;
F_107 ( V_249 -> V_255 , L_12 , sizeof( V_249 -> V_255 ) ) ;
}
static int F_108 ( struct V_256 * V_257 )
{
struct V_1 * V_2 = NULL ;
...
int V_182 ;
F_109 ( V_263 L_13 ) ;
V_260 = F_110 ( & V_257 -> V_11 , NULL ) ;
if ( F_111 ( V_260 ) ) {
F_80 ( & V_257 -> V_11 , L_14 ) ;
return - V_185 ;
}
F_112 ( V_260 ) ;
...
F_123 ( V_257 -> V_11 . V_274 , L_16 ,
& V_2 -> V_280 ) ;
V_262 = F_124 ( V_257 -> V_11 . V_274 , L_17 , 0 ) ;
if ( ! V_262 ) {
F_80 ( & V_257 -> V_11 , L_18 ) ;
return - V_217 ;
}
F_123 ( V_262 , L_19 , & V_2 -> V_184 ) ;
V_2 -> V_186 = F_125 ( V_257 -> V_11 . V_274 ) ;
}
F_78 ( V_2 -> V_280 > 2 ) ;
F_126 ( V_11 , & V_2 -> V_39 , F_89 , V_2 -> V_20 ) ;
...
V_2 -> V_183 -> V_287 = F_98 ;
V_2 -> V_183 -> V_288 = F_100 ;
snprintf ( V_2 -> V_183 -> V_289 , V_290 , L_21 ,
V_257 -> V_212 , V_257 -> V_289 ) ;
V_2 -> V_183 -> V_70 = & V_257 -> V_11 ;
V_2 -> V_183 -> V_291 = 0xffffffff ;
V_182 = F_129 ( V_2 -> V_183 ) ;
if ( V_182 )
goto V_292;
F_130 ( V_11 , & V_257 -> V_11 ) ;
F_69 ( V_2 ) ;
V_182 = F_131 ( V_11 ) ;
if ( V_182 )
goto V_293;
...
{
struct V_13 * V_11 = F_139 ( V_257 ) ;
struct V_1 * V_2 = F_9 ( V_11 ) ;
if ( V_2 -> V_61 ) {
F_75 ( V_2 -> V_11 -> V_11 . V_70 , V_71 ,
V_2 -> V_61 , V_2 -> V_72 ) ;
V_2 -> V_61 = NULL ;
}
if ( V_2 -> V_95 )
...
static void F_143 ( struct V_256 * V_257 )
{
struct V_13 * V_11 = F_139 ( V_257 ) ;
F_38 ( V_11 ) ;
}
...
static int F_145 ( struct V_256 * V_257 , T_6 V_295 )
{
return - V_294 ;
}
