...
V_37 = F_69 ( V_153 -> V_170 ) + 512 * V_48 ;
#ifdef F_10
F_11 ( L_41
...
static int F_72 ( struct V_171 * V_172 , struct V_173 * V_174 )
{
int V_13 = F_73 ( V_172 -> V_175 ) & 3 ;
V_174 -> V_139 = V_20 [ V_13 ] . type -> V_139 ;
V_174 -> V_176 = V_20 [ V_13 ] . V_97 -> V_98 * V_20 [ V_13 ] . type -> V_99 ;
V_174 -> V_177 = V_20 [ V_13 ] . type -> V_42 ;
return 0 ;
}
static int F_74 ( struct V_171 * V_172 , T_4 V_178 ,
...
if ( F_77 ( V_185 , & V_184 , sizeof( struct V_183 ) ) )
return - V_198 ;
break;
case V_199 :
case V_200 :
...
#ifdef F_78
case V_202 :
if ( F_77 ( V_185 , V_72 , V_181 -> type -> V_73 ) )
return - V_198 ;
else
...
static int F_79 ( struct V_171 * V_172 , T_4 V_178 ,
unsigned int V_179 , unsigned long V_180 )
{
int V_205 ;
F_5 ( & V_206 ) ;
V_205 = F_74 ( V_172 , V_178 , V_179 , V_180 ) ;
F_7 ( & V_206 ) ;
return V_205 ;
}
static void F_80 ( int V_207 )
{
unsigned long V_155 ;
int type ;
int V_13 ;
...
static int F_81 ( struct V_171 * V_172 , T_4 V_178 )
{
int V_13 = F_73 ( V_172 -> V_175 ) & 3 ;
int system = ( F_73 ( V_172 -> V_175 ) & 4 ) >> 2 ;
int V_212 ;
unsigned long V_15 ;
F_5 ( & V_206 ) ;
V_212 = V_213 [ V_13 ] ;
...
F_83 ( V_20 [ V_13 ] . V_156 , V_20 [ V_13 ] . V_168 ) ;
F_11 ( V_100 L_46 , V_13 ,
V_20 [ V_13 ] . type -> V_219 , V_218 [ system ] . V_219 ) ;
F_7 ( & V_206 ) ;
return 0 ;
}
static void F_84 ( struct V_156 * V_116 , T_4 V_178 )
{
...
static unsigned F_85 ( struct V_156 * V_116 , unsigned int V_221 )
{
struct V_160 * V_181 = V_116 -> V_165 ;
int V_13 = V_181 - V_20 ;
int V_222 ;
...
V_116 -> V_157 = F_88 ( F_71 , & V_228 ) ;
if ( ! V_116 -> V_157 ) {
V_20 [ V_13 ] . type -> V_155 = V_54 ;
continue;
}
V_226 ++ ;
if ( ( V_20 [ V_13 ] . V_110 = F_89 ( V_229 * 512 , V_230 ) ) == NULL ) {
F_11 ( L_49 ) ;
V_20 [ V_13 ] . type = & V_209 [ V_208 - 1 ] ;
V_226 -- ;
V_227 = 1 ;
...
static struct V_238 * F_91 ( T_7 V_207 , int * V_239 , void * V_37 )
{
int V_13 = * V_239 & 3 ;
if ( V_20 [ V_13 ] . type -> V_155 == V_54 )
return NULL ;
...
static int T_6 F_93 ( struct V_240 * V_241 )
{
int V_50 , V_205 ;
if ( F_94 ( V_232 , L_54 ) )
return - V_188 ;
V_205 = - V_237 ;
V_72 = F_95 ( V_242 , L_55 ) ;
if ( ! V_72 ) {
F_11 ( L_56 ) ;
goto V_243;
}
V_205 = - V_188 ;
if ( F_96 ( V_244 , F_36 , 0 , L_57 , NULL ) ) {
F_11 ( L_58 ) ;
goto V_245;
}
if ( F_96 ( V_246 , F_1 , 0 , L_59 , NULL ) ) {
F_11 ( L_60 ) ;
goto V_247;
}
V_205 = - V_189 ;
...
{
return F_104 ( & V_254 , F_93 ) ;
}
static int T_6 F_105 ( char * V_255 )
{
int V_40 ;
if ( ! V_256 )
return 0 ;
