...
static void F_18 ( T_1 * V_4 , int V_30 )
{
F_10 ( L_13 , F_3 ( V_4 ) ) ;
F_10 ( L_14 , V_30 ) ;
F_19 ( V_4 -> V_21 , NULL , V_34 ) ;
if ( V_4 -> V_33 )
F_10 ( L_15 ) ;
else
F_10 ( L_16 ) ;
...
static int F_20 ( int V_7 , const char * * V_8 )
{
int V_30 , V_35 ;
T_1 * V_4 , * V_36 ;
int V_11 ;
...
V_10 = 1 ;
V_11 = F_21 ( V_7 , V_8 , & V_10 , & V_39 . V_21 ,
& V_38 , & V_37 ) ;
if ( V_11 )
return V_11 ;
if ( ! V_39 . V_21 )
...
static int F_22 ( int V_7 , const char * * V_8 )
{
unsigned long V_46 ;
T_1 * V_4 = NULL ;
int V_47 = V_31 ;
...
if ( V_4 -> V_25 && ( V_50 == F_23 || V_50 == F_25 ) ) {
V_4 -> V_25 = 0 ;
F_26 ( V_28 ) ;
}
}
...
static int F_27 ( int V_7 , const char * * V_8 )
{
if ( V_7 != 0 )
return V_16 ;
F_2 ( V_3 ) ;
