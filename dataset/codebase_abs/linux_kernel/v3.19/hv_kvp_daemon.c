...
if ( error != 0 ) {
snprintf ( V_77 , V_90 , L_58 ,
error , F_46 ( error ) ) ;
return;
}
snprintf ( V_77 , V_90 , L_18 , V_157 -> V_163 ) ;
F_47 ( V_157 ) ;
}
static int
F_48 ( int V_8 , struct V_164 * V_165 )
{
struct V_166 V_167 = { . V_168 = V_169 } ;
unsigned int V_170 ;
struct V_171 V_172 ;
struct V_173 V_174 [ 2 ] ;
V_170 = sizeof( struct V_164 ) + V_165 -> V_73 ;
V_167 . V_175 = F_2 () ;
V_167 . V_176 = F_49 ( V_170 ) ;
V_174 [ 0 ] . V_177 = & V_167 ;
V_174 [ 0 ] . V_178 = sizeof( V_167 ) ;
V_174 [ 1 ] . V_177 = V_165 ;
V_174 [ 1 ] . V_178 = V_170 ;
memset ( & V_172 , 0 , sizeof( V_172 ) ) ;
V_172 . V_179 = & V_92 ;
V_172 . V_180 = sizeof( V_92 ) ;
V_172 . V_181 = V_174 ;
V_172 . V_182 = 2 ;
return F_50 ( V_8 , & V_172 , 0 ) ;
}
void F_51 ( char * V_183 [] )
{
fprintf ( V_184 , L_59
L_60
L_61
...
char * V_196 ;
T_2 V_197 ;
int V_198 = 1 , V_199 = 0 , V_200 ;
static struct V_201 V_202 [] = {
{ L_63 , V_203 , 0 , 'h' } ,
{ L_64 , V_203 , 0 , 'n' } ,
{ 0 , 0 , 0 , 0 }
} ;
while ( ( V_200 = F_52 ( V_185 , V_183 , L_65 , V_202 ,
& V_199 ) ) != - 1 ) {
switch ( V_200 ) {
case 'n' :
V_198 = 0 ;
...
F_54 ( L_66 , 0 , V_204 ) ;
F_4 ( V_205 , L_67 , F_2 () ) ;
V_197 = F_49 ( 0 ) + sizeof( struct V_164 ) + sizeof( struct V_191 ) ;
V_196 = calloc ( 1 , V_197 ) ;
if ( ! V_196 ) {
F_4 ( V_10 , L_68 ) ;
exit ( V_12 ) ;
}
F_17 () ;
F_43 ( V_206 , sizeof( V_206 ) ) ;
if ( F_8 () ) {
F_4 ( V_10 , L_69 ) ;
exit ( V_12 ) ;
}
V_8 = F_55 ( V_207 , V_208 , V_209 ) ;
if ( V_8 < 0 ) {
F_4 ( V_10 , L_70 , V_11 ,
strerror ( V_11 ) ) ;
exit ( V_12 ) ;
...
V_92 . V_212 = 0 ;
V_92 . V_213 = 0 ;
error = F_56 ( V_8 , (struct V_214 * ) & V_92 , sizeof( V_92 ) ) ;
if ( error < 0 ) {
...
V_186 = V_215 ;
if ( F_57 ( V_8 , V_216 , V_217 , & V_186 , sizeof( V_186 ) ) < 0 ) {
F_4 ( V_10 , L_72 , V_11 , strerror ( V_11 ) ) ;
F_12 ( V_8 ) ;
exit ( V_12 ) ;
}
V_172 = (struct V_164 * ) V_196 ;
V_172 -> V_218 . V_219 = V_215 ;
V_172 -> V_218 . V_220 = V_221 ;
V_192 = (struct V_191 * ) V_172 -> V_222 ;
V_192 -> V_223 . V_224 = V_225 ;
V_172 -> V_226 = 0 ;
V_172 -> V_73 = sizeof( struct V_191 ) ;
V_73 = F_48 ( V_8 , V_172 ) ;
if ( V_73 < 0 ) {
...
V_188 . V_8 = V_8 ;
while ( 1 ) {
struct V_214 * V_227 = (struct V_214 * ) & V_92 ;
T_4 V_228 = sizeof( V_92 ) ;
V_188 . V_229 = V_230 ;
V_188 . V_231 = 0 ;
if ( F_58 ( & V_188 , 1 , - 1 ) < 0 ) {
...
V_73 = F_59 ( V_8 , V_196 , V_197 , 0 ,
V_227 , & V_228 ) ;
if ( V_73 < 0 ) {
int V_233 = V_11 ;
F_4 ( V_10 , L_75 ,
V_92 . V_212 , V_11 , strerror ( V_11 ) ) ;
if ( V_233 == V_234 ) {
F_4 ( V_10 , L_76 ) ;
continue;
}
...
V_189 = (struct V_166 * ) V_196 ;
if ( V_189 -> V_168 != V_169 )
continue;
V_190 = (struct V_164 * ) F_60 ( V_189 ) ;
V_192 = (struct V_191 * ) V_190 -> V_222 ;
V_103 = V_192 -> V_223 . V_224 ;
V_1 = V_192 -> V_223 . V_1 ;
V_192 -> error = V_236 ;
if ( ( V_237 ) && ( V_103 == V_225 ) ) {
V_237 = 0 ;
V_44 = ( char * ) V_192 -> V_238 . V_239 . V_240 ;
V_241 = malloc ( strlen ( V_44 ) + 1 ) ;
if ( V_241 ) {
strcpy ( V_241 , V_44 ) ;
F_4 ( V_205 , L_78 ,
V_241 ) ;
...
switch ( V_103 ) {
case V_123 :
V_195 = & V_192 -> V_238 . V_195 ;
V_64 =
F_25 ( ( char * ) V_195 -> V_242 ) ;
if ( V_64 == NULL ) {
V_192 -> error = V_102 ;
break;
}
...
case V_245 :
if ( F_14 ( V_1 ,
V_192 -> V_238 . V_246 . V_222 . V_34 ,
V_192 -> V_238 . V_246 . V_222 . V_35 ,
V_192 -> V_238 . V_246 . V_222 . V_38 ,
V_192 -> V_238 . V_246 . V_222 . V_39 ) )
V_192 -> error = V_247 ;
break;
case V_248 :
if ( F_15 ( V_1 ,
...
case V_249 :
if ( F_13 ( V_1 ,
V_192 -> V_238 . V_250 . V_34 ,
V_192 -> V_238 . V_250 . V_35 ) )
V_192 -> error = V_247 ;
break;
default:
break;
...
if ( V_1 != V_252 ) {
if ( F_16 ( V_1 ,
V_192 -> V_238 . V_253 . V_42 ,
V_192 -> V_238 . V_253 . V_222 . V_34 ,
V_40 ,
V_192 -> V_238 . V_253 . V_222 . V_38 ,
V_41 ) )
V_192 -> error = V_247 ;
goto V_251;
}
V_192 = (struct V_191 * ) V_190 -> V_222 ;
V_194 = ( char * ) V_192 -> V_238 . V_253 . V_222 . V_34 ;
V_193 = ( char * ) V_192 -> V_238 . V_253 . V_222 . V_38 ;
switch ( V_192 -> V_238 . V_253 . V_42 ) {
case V_254 :
strcpy ( V_193 , V_206 ) ;
strcpy ( V_194 , L_79 ) ;
break;
...
V_251:
V_190 -> V_218 . V_219 = V_215 ;
V_190 -> V_218 . V_220 = V_221 ;
V_190 -> V_226 = 0 ;
