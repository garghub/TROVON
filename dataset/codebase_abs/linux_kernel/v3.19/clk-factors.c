...
struct V_1 * * V_26 )
{
struct V_27 * V_27 = V_2 -> V_27 , * V_28 , * V_29 = NULL ;
int V_30 , V_31 ;
...
struct V_27 * T_3 F_19 ( struct V_38 * V_39 ,
...
V_8 = F_20 ( V_39 , 0 ) ;
while ( V_30 < V_51 &&
( V_50 [ V_30 ] = F_21 ( V_39 , V_30 ) ) != NULL )
V_30 ++ ;
if ( V_41 -> V_49 )
V_48 = V_41 -> V_49 ;
else
F_22 ( V_39 , L_1 , & V_48 ) ;
V_11 = F_23 ( sizeof( struct V_10 ) , V_52 ) ;
if ( ! V_11 )
return NULL ;
V_11 -> V_8 = V_8 ;
V_11 -> V_13 = V_41 -> V_53 ;
...
V_11 -> V_37 = V_37 ;
if ( V_41 -> V_55 ) {
V_43 = F_23 ( sizeof( struct V_42 ) , V_52 ) ;
if ( ! V_43 ) {
F_24 ( V_11 ) ;
return NULL ;
}
...
if ( V_41 -> V_45 ) {
V_45 = F_23 ( sizeof( struct V_44 ) , V_52 ) ;
if ( ! V_45 ) {
F_24 ( V_11 ) ;
F_24 ( V_43 ) ;
return NULL ;
