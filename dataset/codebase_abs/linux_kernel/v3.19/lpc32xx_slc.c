...
if ( ! V_11 )
return NULL ;
F_69 ( V_133 , L_10 , & V_11 -> V_12 ) ;
F_69 ( V_133 , L_11 , & V_11 -> V_13 ) ;
F_69 ( V_133 , L_12 , & V_11 -> V_14 ) ;
F_69 ( V_133 , L_13 , & V_11 -> V_15 ) ;
F_69 ( V_133 , L_14 , & V_11 -> V_16 ) ;
F_69 ( V_133 , L_15 , & V_11 -> V_17 ) ;
F_69 ( V_133 , L_16 , & V_11 -> V_18 ) ;
F_69 ( V_133 , L_17 , & V_11 -> V_19 ) ;
...
return - V_146 ;
if ( F_25 ( V_2 -> V_11 -> V_33 ) && F_77 ( & V_138 -> V_79 ,
V_2 -> V_11 -> V_33 , L_22 ) ) {
F_41 ( & V_138 -> V_79 , L_23 ) ;
return - V_130 ;
}
F_27 ( V_2 ) ;
V_2 -> V_126 = F_78 ( & V_138 -> V_79 ) ;
V_21 = & V_2 -> V_21 ;
V_25 = & V_2 -> V_24 ;
V_25 -> V_26 = V_2 ;
V_21 -> V_26 = V_25 ;
...
V_2 -> V_9 = F_79 ( & V_138 -> V_79 , NULL ) ;
if ( F_75 ( V_2 -> V_9 ) ) {
F_41 ( & V_138 -> V_79 , L_24 ) ;
V_67 = - V_128 ;
goto V_149;
}
F_80 ( V_2 -> V_9 ) ;
V_25 -> V_150 = F_31 ( V_2 -> V_6 ) ;
...
F_1 ( V_2 ) ;
F_81 ( V_138 , V_2 ) ;
V_25 -> V_53 . V_34 = V_155 ;
V_25 -> V_156 = F_30 ;
V_25 -> V_41 = F_32 ;
V_25 -> V_47 = F_33 ;
V_25 -> V_53 . V_157 = F_60 ;
V_25 -> V_53 . V_158 = F_59 ;
V_25 -> V_53 . V_159 = F_62 ;
V_25 -> V_53 . V_160 = F_61 ;
V_25 -> V_53 . V_161 = F_35 ;
V_25 -> V_53 . V_162 = F_34 ;
V_25 -> V_53 . V_163 = F_29 ;
V_25 -> V_53 . V_119 = V_164 ;
V_25 -> V_53 . V_165 = 1 ;
V_25 -> V_53 . V_166 = F_28 ;
V_2 -> V_167 = V_168 + V_115 ;
V_2 -> V_97 = F_68 ( & V_138 -> V_79 , V_2 -> V_167 ,
V_135 ) ;
if ( V_2 -> V_97 == NULL ) {
V_67 = - V_144 ;
goto V_169;
...
V_2 -> V_107 = ( T_1 * ) ( V_2 -> V_97 + V_168 ) ;
if ( V_21 -> V_46 <= 512 )
V_25 -> V_53 . V_117 = & V_171 ;
V_25 -> V_53 . V_106 = 256 ;
V_25 -> V_53 . V_120 = V_172 ;
V_25 -> V_53 . V_173 = V_25 -> V_53 . V_174 = 0 ;
if ( V_2 -> V_11 -> V_136 ) {
V_25 -> V_175 |= V_176 ;
if ( V_21 -> V_46 <= 512 ) {
V_25 -> V_177 = & V_178 ;
...
V_67 = F_84 ( V_21 , NULL , & V_142 , V_2 -> V_11 -> V_182 ,
V_2 -> V_11 -> V_183 ) ;
if ( ! V_67 )
return V_67 ;
F_85 ( V_21 ) ;
...
static int F_91 ( struct V_137 * V_138 , T_6 V_184 )
{
T_1 V_4 ;
struct V_1 * V_2 = F_89 ( V_138 ) ;
V_4 = F_19 ( F_3 ( V_2 -> V_6 ) ) ;
