...
V_15 -> V_23 = 0 ;
for ( V_19 = V_6 -> V_26 . V_19 , V_17 = V_6 -> V_26 . V_27 ; V_17 > 0 ;
V_17 -- , V_19 ++ ) {
...
struct V_12 * V_13 = F_2 ( V_11 ) ;
struct V_14 * V_15 = V_13 -> V_16 ;
unsigned V_45 = F_19 ( F_20 ( & V_15 -> V_24 ) ) ;
int V_21 ;
if ( V_32 > V_45 )
V_32 = V_45 ;
else if ( V_32 < V_45 )
...
V_21 = F_21 ( V_6 , V_15 -> V_39 , V_32 ) ;
V_25:
F_12 ( V_11 ) ;
return V_21 ? : V_32 ;
}
static int F_22 ( struct V_3 * V_4 , struct V_3 * V_47 , int V_43 )
{
struct V_4 * V_11 = V_4 -> V_11 ;
struct V_12 * V_13 = F_2 ( V_11 ) ;
struct V_14 * V_15 = V_13 -> V_16 ;
struct V_48 * V_24 = & V_15 -> V_24 ;
char V_49 [ F_23 ( F_20 ( V_24 ) ) ] ;
struct V_4 * V_50 ;
struct V_12 * V_51 ;
struct V_14 * V_52 ;
int V_21 ;
...
static void * F_29 ( const char * V_54 , T_4 type , T_4 V_55 )
{
return F_30 ( V_54 , type , V_55 ) ;
}
static void F_31 ( void * V_16 )
{
F_32 ( V_16 ) ;
}
static int F_33 ( void * V_16 , const T_5 * V_56 , unsigned int V_57 )
{
return F_34 ( V_16 , V_56 , V_57 ) ;
}
...
F_36 ( V_11 , V_15 -> V_39 ,
F_19 ( F_20 ( & V_15 -> V_24 ) ) ) ;
F_37 ( V_11 , V_15 , V_15 -> V_32 ) ;
F_38 ( V_11 ) ;
}
static int F_39 ( void * V_16 , struct V_4 * V_11 )
{
struct V_14 * V_15 ;
struct V_12 * V_13 = F_2 ( V_11 ) ;
unsigned V_32 = sizeof( * V_15 ) + F_40 ( V_16 ) ;
unsigned V_45 = F_19 ( V_16 ) ;
V_15 = F_41 ( V_11 , V_32 , V_58 ) ;
if ( ! V_15 )
return - V_59 ;
V_15 -> V_39 = F_41 ( V_11 , V_45 , V_58 ) ;
if ( ! V_15 -> V_39 ) {
F_37 ( V_11 , V_15 , V_32 ) ;
return - V_59 ;
}
memset ( V_15 -> V_39 , 0 , V_45 ) ;
V_15 -> V_32 = V_32 ;
V_15 -> V_23 = 0 ;
F_42 ( & V_15 -> V_36 ) ;
V_13 -> V_16 = V_15 ;
