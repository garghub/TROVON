...
static int F_68 ( struct V_66 * V_67 , struct V_3 * V_4 ,
...
int F_73 ( struct V_135 * V_136 , struct V_137 * V_138 , struct V_114 * V_115 ,
T_5 V_139 )
{
struct V_138 * V_140 = V_138 -> V_140 ;
struct V_66 * V_67 = F_74 ( V_140 ) ;
F_75 ( struct V_100 * , V_141 , V_115 -> V_142 ) ;
T_6 V_143 ;
T_4 V_110 ;
struct V_3 * V_4 = NULL ;
struct V_1 * V_2 ;
...
V_30 = F_68 ( V_67 , V_4 , V_115 , & V_134 ) ;
if ( V_30 )
goto V_35;
