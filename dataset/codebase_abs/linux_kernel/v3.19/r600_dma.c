...
void F_37 ( struct V_1 * V_2 , struct V_69 * V_70 )
{
...
V_73 += 3 ;
F_23 ( V_4 , F_24 ( V_54 , 0 , 0 , 1 ) ) ;
F_23 ( V_4 , V_4 -> V_74 & 0xfffffffc ) ;
F_23 ( V_4 , F_11 ( V_4 -> V_74 ) & 0xff ) ;
F_23 ( V_4 , V_73 ) ;
}
while ( ( V_4 -> V_11 & 7 ) != 5 )
F_23 ( V_4 , F_24 ( V_75 , 0 , 0 , 0 ) ) ;
F_23 ( V_4 , F_24 ( V_76 , 0 , 0 , 0 ) ) ;
F_23 ( V_4 , ( V_70 -> V_32 & 0xFFFFFFE0 ) ) ;
F_23 ( V_4 , ( V_70 -> V_72 << 16 ) | ( F_11 ( V_70 -> V_32 ) & 0xFF ) ) ;
}
struct V_57 * F_38 ( struct V_1 * V_2 ,
T_4 V_77 , T_4 V_78 ,
unsigned V_79 ,
struct V_80 * V_81 )
{
struct V_57 * V_58 ;
struct V_82 V_83 ;
int V_84 = V_2 -> V_14 -> V_15 . V_85 ;
struct V_3 * V_4 = & V_2 -> V_4 [ V_84 ] ;
T_2 V_86 , V_87 ;
int V_48 , V_88 ;
int V_25 = 0 ;
F_39 ( & V_83 ) ;
V_86 = ( V_79 << V_89 ) / 4 ;
V_88 = F_40 ( V_86 , 0xFFFE ) ;
V_25 = F_21 ( V_2 , V_4 , V_88 * 4 + 8 ) ;
if ( V_25 ) {
F_22 ( L_9 , V_25 ) ;
F_41 ( V_2 , & V_83 , NULL ) ;
return F_42 ( V_25 ) ;
}
F_43 ( V_2 , & V_83 , V_81 , false ) ;
F_44 ( V_2 , & V_83 , V_4 -> V_51 ) ;
for ( V_48 = 0 ; V_48 < V_88 ; V_48 ++ ) {
V_87 = V_86 ;
if ( V_87 > 0xFFFE )
V_87 = 0xFFFE ;
V_86 -= V_87 ;
F_23 ( V_4 , F_24 ( V_90 , 0 , 0 , V_87 ) ) ;
F_23 ( V_4 , V_78 & 0xfffffffc ) ;
F_23 ( V_4 , V_77 & 0xfffffffc ) ;
F_23 ( V_4 , ( ( ( F_11 ( V_78 ) & 0xff ) << 16 ) |
( F_11 ( V_77 ) & 0xff ) ) ) ;
V_77 += V_87 * 4 ;
V_78 += V_87 * 4 ;
}
V_25 = F_45 ( V_2 , & V_58 , V_4 -> V_51 ) ;
if ( V_25 ) {
F_46 ( V_2 , V_4 ) ;
F_41 ( V_2 , & V_83 , NULL ) ;
return F_42 ( V_25 ) ;
