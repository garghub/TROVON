...
int F_41 ( struct V_1 * V_2 , struct V_21 * V_157 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
int V_9 ;
V_157 -> V_158 = NULL ;
...
V_9 = F_44 ( V_4 -> V_163 . V_164 , false ) ;
if ( V_9 ) {
F_45 ( V_4 , V_162 ) ;
F_8 ( V_160 ) ;
return V_9 ;
}
V_162 -> V_165 = F_46 ( V_4 , V_162 ,
V_4 -> V_163 . V_164 ) ;
V_9 = F_47 ( V_4 , V_162 -> V_165 ,
V_166 ,
V_167 |
V_168 ) ;
if ( V_9 ) {
...
if ( ! V_9 ) {
if ( V_162 -> V_165 )
F_49 ( V_4 , V_162 -> V_165 ) ;
F_50 ( V_4 -> V_163 . V_164 ) ;
}
F_45 ( V_4 , V_162 ) ;
}
F_8 ( V_160 ) ;
...
T_3 F_54 ( struct V_1 * V_2 , int V_38 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
...
return F_55 ( V_4 , V_38 ) ;
}
int F_56 ( struct V_1 * V_2 , int V_38 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
unsigned long V_169 ;
int V_9 ;
...
F_57 ( & V_4 -> V_170 . V_171 , V_169 ) ;
V_4 -> V_170 . V_172 [ V_38 ] = true ;
V_9 = F_58 ( V_4 ) ;
F_59 ( & V_4 -> V_170 . V_171 , V_169 ) ;
return V_9 ;
}
void F_60 ( struct V_1 * V_2 , int V_38 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
unsigned long V_169 ;
if ( V_38 < 0 || V_38 >= V_4 -> V_56 ) {
...
int F_61 ( struct V_1 * V_2 , int V_38 ,
int * V_173 ,
struct V_174 * V_175 ,
unsigned V_8 )
{
