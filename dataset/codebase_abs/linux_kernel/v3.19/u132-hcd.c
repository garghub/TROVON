...
F_101 ( & V_12 -> V_18 ) ) -> V_188 ;
T_3 V_190 = ( (struct V_189 * )
F_101 ( & V_12 -> V_18 ) ) -> V_190 ;
F_8 ( & V_1 -> V_65 ) ;
F_96 ( 10 ) ;
if ( V_188 == V_191 && V_190 == 0x740c ) {
V_1 -> V_157 = V_181 ;
} else if ( V_188 == V_192 && V_190 == 0xc861 ) {
F_46 ( & V_1 -> V_13 -> V_18 , L_43
L_44 ) ;
} else if ( V_188 == V_193 && V_190 == 0xa0f8 )
V_1 -> V_157 |= V_194 ;
V_49 = F_93 ( V_1 ) ;
if ( V_49 ) {
F_5 ( V_1 ) ;
...
struct V_19 * V_195 , T_1 V_20 , T_1 V_29 , T_1 V_30 ,
T_4 V_196 )
{
struct V_22 * V_23 ;
unsigned long V_67 ;
int V_197 ;
T_1 V_32 ;
struct V_27 * V_28 = F_104 ( sizeof( struct V_27 ) , V_196 ) ;
if ( ! V_28 )
return - V_198 ;
F_105 ( & V_28 -> V_69 . V_70 ) ;
F_51 ( & V_28 -> V_69 . V_70 , V_67 ) ;
V_197 = F_106 ( F_4 ( V_1 ) , V_66 ) ;
if ( V_197 ) {
F_53 ( & V_28 -> V_69 . V_70 , V_67 ) ;
F_34 ( V_28 ) ;
return V_197 ;
...
V_32 = ++ V_1 -> V_199 ;
V_66 -> V_200 -> V_46 = V_1 -> V_28 [ V_32 - 1 ] = V_28 ;
...
V_28 -> V_32 = V_32 ;
V_28 -> V_1 = V_1 ;
V_28 -> V_34 = V_66 -> V_200 ;
V_28 -> V_118 = F_110 ( V_66 -> V_112 ) ;
F_37 ( V_1 , V_28 ) ;
if ( F_76 ( V_66 -> V_112 ) ) {
V_28 -> V_83 = 0x2 ;
...
struct V_2 * V_3 , struct V_66 * V_66 ,
struct V_19 * V_195 , struct V_27 * V_28 , T_1 V_20 ,
T_1 V_29 , T_1 V_30 )
{
V_66 -> V_46 = V_1 ;
V_28 -> V_116 = 1 ;
...
V_23 = V_28 -> V_23 = & V_1 -> V_23 [ V_202 - 1 ] ;
if ( V_23 -> V_39 ) {
F_109 ( & V_28 -> V_37 , & V_23 -> V_39 -> V_37 ) ;
} else {
F_108 ( & V_28 -> V_37 ) ;
...
struct V_66 * V_66 ,
struct V_19 * V_195 , T_1 V_20 , T_1 V_29 ,
T_4 V_196 )
{
struct V_22 * V_23 ;
unsigned long V_67 ;
...
struct V_203 * V_31 = & V_1 -> V_31 [ V_195 -> V_204 ] ;
int V_58 = V_205 ;
int V_60 = 0 ;
while ( -- V_58 > 0 ) {
...
struct V_76 * V_77 =
F_104 ( sizeof( struct V_76 ) , V_201 ) ;
if ( V_77 == NULL ) {
V_28 -> V_73 -= 1 ;
return - V_198 ;
} else {
...
T_1 V_20 = F_119 ( V_66 -> V_112 ) ;
T_1 V_29 = F_120 ( V_66 -> V_112 ) ;
struct V_19 * V_195 = V_66 -> V_18 ;
if ( F_110 ( V_66 -> V_112 ) == V_119 ) {
T_1 V_30 = V_1 -> V_31 [ V_20 ] . V_30 ;
struct V_2 * V_3 = & V_1 -> V_3 [ V_30 ] ;
struct V_27 * V_28 = V_66 -> V_200 -> V_46 ;
V_66 -> V_99 = 0 ;
if ( V_28 ) {
unsigned long V_67 ;
int V_49 ;
...
} else if ( F_110 ( V_66 -> V_112 ) == V_210 ) {
F_46 ( & V_1 -> V_13 -> V_18 , L_50
L_51 ) ;
return - V_141 ;
} else if ( F_110 ( V_66 -> V_112 ) == V_211 ) {
T_1 V_30 = V_1 -> V_31 [ V_20 ] . V_30 ;
struct V_2 * V_3 = & V_1 -> V_3 [ V_30 ] ;
struct V_27 * V_28 = V_66 -> V_200 -> V_46 ;
V_66 -> V_99 = 0 ;
...
struct V_27 * V_28 = V_66 -> V_200 -> V_46 ;
T_3 V_212 = 8 ;
T_1 * V_100 = V_66 -> V_206 ;
int V_60 = 0 ;
char V_93 [ 30 * 3 + 4 ] ;
char * V_213 = V_93 ;
int V_214 = ( sizeof( V_93 ) - 1 ) / 3 ;
int V_215 = 0 ;
V_93 [ 0 ] = 0 ;
while ( V_212 -- > 0 ) {
if ( V_60 > V_214 ) {
} else if ( V_60 ++ < V_214 ) {
int V_216 = sprintf ( V_213 , L_52 , * V_100 ++ ) ;
V_213 += V_216 ;
V_215 += V_216 ;
} else
V_213 += sprintf ( V_213 , L_53 ) ;
}
if ( V_28 ) {
unsigned long V_67 ;
int V_49 ;
...
static int F_122 ( struct V_1 * V_1 , struct V_27 * V_28 ,
struct V_66 * V_66 , int V_54 )
{
unsigned long V_67 ;
int V_197 ;
F_51 ( & V_28 -> V_69 . V_70 , V_67 ) ;
V_197 = F_123 ( F_4 ( V_1 ) , V_66 , V_54 ) ;
if ( V_197 ) {
F_53 ( & V_28 -> V_69 . V_70 , V_67 ) ;
return V_197 ;
}
...
T_3 V_73 = V_28 -> V_73 ;
T_3 V_218 = V_28 -> V_71 ;
struct V_66 * * V_219 = NULL ;
while ( ++ V_217 < V_72 && -- V_73 > 0 ) {
if ( V_66 == V_28 -> V_78 [ V_79 &
++ V_218 ] ) {
V_219 = & V_28 -> V_78 [ V_79 &
V_218 ] ;
break;
} else
continue;
...
static int F_124 ( struct V_5 * V_6 , struct V_66 * V_66 , int V_54 )
{
struct V_1 * V_1 = F_3 ( V_6 ) ;
if ( V_1 -> V_14 > 2 ) {
F_46 ( & V_1 -> V_13 -> V_18 , L_12
...
return F_122 ( V_1 , V_28 , V_66 , V_54 ) ;
} else {
...
return V_49 ;
V_222 -> V_224 = 0x29 ;
V_222 -> V_225 = ( V_138 & V_180 ) >> 24 ;
V_222 -> V_226 = 0 ;
V_222 -> V_227 = V_1 -> V_59 ;
V_149 = 1 + ( V_1 -> V_59 / 8 ) ;
V_222 -> V_228 = 7 + 2 * V_149 ;
V_149 = 0 ;
if ( V_138 & V_152 )
V_149 |= 0x0002 ;
if ( V_138 & V_176 )
...
V_149 |= 0x0008 ;
V_222 -> V_229 = F_128 ( V_149 ) ;
V_49 = F_45 ( V_1 , V_53 . V_100 , & V_223 ) ;
if ( V_49 )
return V_49 ;
memset ( V_222 -> V_97 . V_230 . V_231 , 0xff ,
sizeof( V_222 -> V_97 . V_230 . V_231 ) ) ;
V_222 -> V_97 . V_230 . V_231 [ 0 ] = V_223 & V_232 ;
if ( V_1 -> V_59 > 7 ) {
V_222 -> V_97 . V_230 . V_231 [ 1 ] = ( V_223 & V_232 ) >> 8 ;
V_222 -> V_97 . V_230 . V_231 [ 2 ] = 0xff ;
} else
V_222 -> V_97 . V_230 . V_231 [ 1 ] = 0xff ;
return 0 ;
}
static int F_129 ( struct V_1 * V_1 , T_5 * V_222 )
{
T_2 V_233 = - 1 ;
int V_234 = F_45 ( V_1 , V_53 . V_54 , & V_233 ) ;
* V_222 = F_130 ( V_233 ) ;
return V_234 ;
}
static int F_131 ( struct V_1 * V_1 , T_5 * V_222 , T_3 V_235 )
{
if ( V_235 == 0 || V_235 > V_1 -> V_59 ) {
return - V_141 ;
} else {
int V_123 = V_235 - 1 ;
T_2 V_236 = - 1 ;
int V_237 = F_45 ( V_1 ,
V_53 . V_61 [ V_123 ] , & V_236 ) ;
* V_222 = F_130 ( V_236 ) ;
if ( * ( T_3 * ) ( V_222 + 2 ) ) {
...
static int F_132 ( struct V_1 * V_1 , int V_238 )
{
int V_49 ;
T_2 V_239 ;
T_3 V_240 ;
T_3 V_241 ;
V_49 = F_45 ( V_1 , V_239 , & V_239 ) ;
if ( V_49 )
return V_49 ;
V_240 = V_239 ;
V_241 = V_240 + V_242 ;
...
static int F_134 ( struct V_1 * V_1 , T_3 V_248 ,
T_3 V_235 )
{
if ( V_235 == 0 || V_235 > V_1 -> V_59 ) {
return - V_141 ;
...
int V_49 ;
int V_238 = V_235 - 1 ;
struct V_249 * V_123 = & V_1 -> V_123 [ V_238 ] ;
V_123 -> V_250 &= ~ ( 1 << V_248 ) ;
switch ( V_248 ) {
case V_251 :
V_49 = F_90 ( V_1 ,
V_53 . V_61 [ V_238 ] , V_252 ) ;
if ( V_49 )
return V_49 ;
return 0 ;
case V_253 :
V_49 = F_90 ( V_1 ,
V_53 . V_61 [ V_238 ] , V_254 ) ;
if ( V_49 )
return V_49 ;
return 0 ;
case V_255 :
V_49 = F_132 ( V_1 , V_238 ) ;
if ( V_49 )
return V_49 ;
return 0 ;
default:
...
static int F_135 ( struct V_1 * V_1 , T_3 V_248 ,
T_3 V_235 )
{
if ( V_235 == 0 || V_235 > V_1 -> V_59 ) {
return - V_141 ;
...
static int F_136 ( struct V_5 * V_6 , char * V_84 )
{
struct V_1 * V_1 = F_3 ( V_6 ) ;
if ( V_1 -> V_14 > 1 ) {
...
int V_60 , V_268 = 0 , V_38 = 1 ;
if ( V_1 -> V_157 & V_181 ) {
if ( ( V_1 -> V_57 & V_139 ) > V_269 ) {
...
if ( ! ( V_1 -> V_62 [ V_60 ] & V_245 ) )
continue;
if ( ( V_1 -> V_62 [ V_60 ] & V_252 ) )
continue;
}
V_270:
return V_268 ? V_38 : 0 ;
...
static int F_137 ( struct V_5 * V_6 , T_3 V_272 , T_3 V_248 ,
T_3 V_235 , char * V_84 , T_3 V_273 )
{
struct V_1 * V_1 = F_3 ( V_6 ) ;
if ( V_1 -> V_14 > 1 ) {
F_46 ( & V_1 -> V_13 -> V_18 , L_12
...
static int F_138 ( struct V_5 * V_6 , unsigned V_284 )
{
struct V_1 * V_1 = F_3 ( V_6 ) ;
if ( V_1 -> V_14 > 1 ) {
F_46 ( & V_1 -> V_13 -> V_18 , L_12
...
F_43 ( V_1 ) ;
while ( V_285 -- > 0 ) {
struct V_22 * V_23 = & V_1 -> V_23 [ V_285 ] ;
F_27 ( V_1 , V_23 ) ;
} while ( V_287 -- > 0 ) {
struct V_27 * V_28 = V_1 -> V_28 [ V_287 ] ;
if ( V_28 )
F_39 ( V_1 , V_28 ) ;
}
V_1 -> V_14 += 1 ;
...
static void F_144 ( struct V_1 * V_1 , struct V_11 * V_12 )
{
int V_285 = V_286 ;
int V_290 = V_140 ;
int V_291 = V_292 ;
...
F_107 ( & V_1 -> V_47 , F_47 ) ;
while ( V_290 -- > 0 ) {
struct V_249 * V_123 = & V_1 -> V_123 [ V_290 ] ;
V_123 -> V_1 = V_1 ;
V_123 -> V_295 = 0 ;
V_123 -> V_296 = 0 ;
V_123 -> V_124 = 0 ;
...
while ( V_291 -- > 0 ) {
struct V_203 * V_31 = & V_1 -> V_31 [ V_291 ] ;
V_31 -> V_30 = 0 ;
}
while ( V_293 -- > 0 ) {
struct V_2 * V_3 = & V_1 -> V_3 [ V_293 ] ;
int V_60 = F_146 ( V_3 -> V_43 ) ;
int V_297 = F_146 ( V_3 -> V_45 ) ;
V_3 -> V_19 = NULL ;
V_3 -> V_4 = 0 ;
V_3 -> V_20 = 0 ;
V_3 -> V_298 = 0 ;
...
if ( V_299 > 0 )
return - V_50 ;
V_49 = F_148 ( V_12 , V_136 , V_137 ) ;
if ( V_49 )
return V_49 ;
V_49 = F_149 ( V_12 , V_51 , & V_51 ) ;
if ( V_49 )
return V_49 ;
V_49 = F_149 ( V_12 , V_53 . V_56 , & V_138 ) ;
if ( V_49 )
return V_49 ;
V_59 = V_138 & V_139 ;
if ( V_12 -> V_18 . V_300 )
return - V_141 ;
V_6 = F_150 ( & V_301 , & V_12 -> V_18 , F_151 ( & V_12 -> V_18 ) ) ;
if ( ! V_6 ) {
F_118 ( V_208 L_77
) ;
F_49 ( V_12 ) ;
...
F_153 ( V_6 -> V_186 . V_187 ) ;
F_41 ( V_1 , 100 ) ;
return 0 ;
}
}
}
static int F_154 ( struct V_11 * V_12 , T_6 V_8 )
{
struct V_5 * V_6 = F_142 ( V_12 ) ;
struct V_1 * V_1 = F_3 ( V_6 ) ;
if ( V_1 -> V_14 > 1 ) {
...
V_299 += 1 ;
F_10 ( & V_15 ) ;
F_161 (u132, temp, &u132_static_list, u132_list) {
F_162 ( V_1 -> V_13 ) ;
}
F_163 ( & V_310 ) ;
F_118 ( V_289 L_82 ) ;
