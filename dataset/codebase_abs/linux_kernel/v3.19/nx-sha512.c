...
T_1 V_35 , V_36 = 0 , V_37 ;
unsigned long V_38 ;
int V_10 = 0 ;
int V_39 ;
T_1 V_40 = ( V_4 -> V_32 [ 0 ] % V_41 ) ;
F_9 ( & V_6 -> V_42 , V_38 ) ;
V_37 = ( V_4 -> V_32 [ 0 ] % V_41 ) + V_9 ;
if ( V_37 < V_41 ) {
...
F_9 ( & V_6 -> V_42 , V_38 ) ;
if ( V_4 -> V_32 [ 0 ] >= V_41 ) {
memcpy ( V_15 -> V_44 . V_45 . V_51 , V_4 -> V_22 ,
V_17 ) ;
F_10 ( V_15 ) &= ~ V_47 ;
F_10 ( V_15 ) |= V_48 ;
} else {
...
F_10 ( V_15 ) &= ~ V_47 ;
V_57 = V_4 -> V_32 [ 0 ] * 8 ;
V_15 -> V_44 . V_45 . V_58 = V_57 ;
V_9 = V_4 -> V_32 [ 0 ] & ( V_41 - 1 ) ;
V_10 = F_6 ( V_6 , V_6 -> V_49 ,
& V_6 -> V_19 . V_50 ,
& V_9 ,
( V_21 * ) V_4 -> V_43 ,
V_16 ) ;
if ( V_10 || V_9 != ( V_4 -> V_32 [ 0 ] & ( V_41 - 1 ) ) )
goto V_23;
V_9 = V_17 ;
V_10 = F_6 ( V_6 , V_6 -> V_18 ,
& V_6 -> V_19 . V_20 ,
...
static int F_17 ( struct V_1 * V_2 , const void * V_60 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
memcpy ( V_4 , V_60 , sizeof( * V_4 ) ) ;
return 0 ;
}
