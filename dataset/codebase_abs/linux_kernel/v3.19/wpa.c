...
V_9 = (struct V_8 * ) V_64 ;
V_64 += V_7 ;
V_96 = F_41 ( & V_4 -> V_54 . V_101 . V_102 ) ;
V_76 [ 5 ] = V_96 ;
V_76 [ 4 ] = V_96 >> 8 ;
V_76 [ 3 ] = V_96 >> 16 ;
V_76 [ 2 ] = V_96 >> 24 ;
...
struct V_63 * V_4 = V_2 -> V_4 ;
struct V_12 * V_13 = F_2 ( V_11 ) ;
const struct V_107 * V_108 = V_4 -> V_71 -> V_109 ;
int V_7 ;
T_2 * V_64 ;
if ( V_13 -> V_24 . V_25 &&
! ( V_13 -> V_24 . V_25 -> V_22 & V_66 ) ) {
...
if ( F_5 ( F_8 ( V_11 ) < V_108 -> V_110 &&
F_50 ( V_11 , V_108 -> V_110 , 0 , V_62 ) ) )
return V_21 ;
V_7 = F_4 ( V_9 -> V_19 ) ;
V_64 = F_18 ( V_11 , V_108 -> V_110 ) ;
memmove ( V_64 , V_64 + V_108 -> V_110 , V_7 ) ;
return V_20 ;
}
static inline int F_51 ( T_2 * V_111 , T_2 * V_112 , int V_18 )
{
int V_113 ;
for ( V_113 = V_18 - 1 ; V_113 >= 0 ; V_113 -- ) {
if ( V_111 [ V_113 ] < V_112 [ V_113 ] )
return - 1 ;
else if ( V_111 [ V_113 ] > V_112 [ V_113 ] )
return 1 ;
}
return 0 ;
}
...
T_2 * V_114 ;
T_2 V_82 ;
if ( ! V_36 -> V_71 || ! V_36 -> V_71 -> V_109 ||
! ( V_38 -> V_40 & V_46 ) )
return V_51 ;
if ( ! F_27 ( V_9 -> V_19 ) )
return V_39 ;
V_108 = V_36 -> V_71 -> V_109 ;
V_6 = V_36 -> V_11 -> V_18 - V_7 - V_108 -> V_110 ;
if ( V_6 < 0 )
return V_51 ;
if ( F_34 ( V_9 -> V_19 ) )
V_82 = * F_35 ( V_9 ) &
...
V_105 = V_4 -> V_54 . V_115 . V_105 [ V_82 ] ;
V_114 = V_36 -> V_11 -> V_3 + V_7 + V_108 -> V_116 ;
if ( F_51 ( V_114 , V_105 , V_108 -> V_117 ) <= 0 )
return V_51 ;
memcpy ( V_105 , V_114 , V_108 -> V_117 ) ;
if ( F_48 ( V_36 -> V_11 , V_36 -> V_11 -> V_18 - V_108 -> V_118 ) )
return V_51 ;
memmove ( V_36 -> V_11 -> V_3 + V_108 -> V_110 , V_36 -> V_11 -> V_3 , V_7 ) ;
F_29 ( V_36 -> V_11 , V_108 -> V_110 ) ;
return V_39 ;
}
static void F_53 ( struct V_10 * V_11 , T_2 * V_78 )
{
T_5 V_79 ;
struct V_8 * V_9 = (struct V_8 * ) V_11 -> V_3 ;
V_79 = V_9 -> V_19 ;
...
static inline void F_54 ( T_2 * V_119 , T_7 V_76 )
{
* V_119 ++ = V_76 ;
* V_119 ++ = V_76 >> 8 ;
* V_119 ++ = V_76 >> 16 ;
...
static inline void F_55 ( T_2 * V_119 , const T_2 * V_120 )
{
* V_119 ++ = V_120 [ 5 ] ;
* V_119 ++ = V_120 [ 4 ] ;
* V_119 ++ = V_120 [ 3 ] ;
...
T_2 V_78 [ 20 ] ;
T_7 V_96 ;
if ( F_17 ( F_57 ( & V_2 -> V_123 ) != 1 ) )
return V_21 ;
V_11 = F_58 ( & V_2 -> V_123 ) ;
V_13 = F_2 ( V_11 ) ;
if ( V_13 -> V_24 . V_25 )
return V_20 ;
if ( F_17 ( F_7 ( V_11 ) < sizeof( * V_122 ) ) )
return V_21 ;
V_122 = (struct V_121 * ) F_9 ( V_11 , sizeof( * V_122 ) ) ;
V_122 -> V_124 = V_125 ;
V_122 -> V_126 = sizeof( * V_122 ) - 2 ;
V_122 -> V_95 = F_32 ( V_4 -> V_15 . V_50 ) ;
V_96 = F_41 ( & V_4 -> V_54 . V_127 . V_102 ) ;
F_54 ( V_122 -> V_128 , V_96 ) ;
F_53 ( V_11 , V_78 ) ;
F_59 ( V_4 -> V_54 . V_127 . V_103 , V_78 ,
V_11 -> V_3 + 24 , V_11 -> V_18 - 24 , V_122 -> V_5 ) ;
return V_20 ;
}
T_4
...
struct V_63 * V_4 = V_36 -> V_4 ;
struct V_121 * V_122 ;
T_2 V_78 [ 20 ] , V_5 [ 8 ] , V_129 [ 6 ] ;
struct V_8 * V_9 = (struct V_8 * ) V_11 -> V_3 ;
if ( ! F_31 ( V_9 -> V_19 ) )
return V_39 ;
if ( V_11 -> V_18 < 24 + sizeof( * V_122 ) )
return V_51 ;
V_122 = (struct V_121 * )
( V_11 -> V_3 + V_11 -> V_18 - sizeof( * V_122 ) ) ;
if ( V_122 -> V_124 != V_125 ||
V_122 -> V_126 != sizeof( * V_122 ) - 2 )
return V_51 ;
F_55 ( V_129 , V_122 -> V_128 ) ;
if ( memcmp ( V_129 , V_4 -> V_54 . V_127 . V_105 , 6 ) <= 0 ) {
V_4 -> V_54 . V_127 . V_106 ++ ;
return V_51 ;
}
if ( ! ( V_38 -> V_40 & V_46 ) ) {
F_53 ( V_11 , V_78 ) ;
...
if ( memcmp ( V_5 , V_122 -> V_5 , sizeof( V_122 -> V_5 ) ) != 0 ) {
V_4 -> V_54 . V_127 . V_130 ++ ;
return V_51 ;
}
}
memcpy ( V_4 -> V_54 . V_127 . V_105 , V_129 , 6 ) ;
F_14 ( V_11 , V_11 -> V_18 - sizeof( * V_122 ) ) ;
return V_39 ;
}
T_1
F_61 ( struct V_1 * V_2 )
