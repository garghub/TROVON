...
int F_52 ( struct V_1 * V_2 , int V_161 , struct V_162 * * V_163 )
{
...
if ( V_163 )
* V_163 = NULL ;
if ( ( V_167 = F_53 ( V_165 , L_7 , V_161 , 1 , 1 , & V_166 ) ) < 0 )
return V_167 ;
sprintf ( V_166 -> V_168 , L_8 , V_2 -> V_169 >> 8 , V_2 -> V_169 & 0xff ) ;
V_166 -> V_170 = V_171 ;
V_166 -> V_101 = V_2 ;
F_54 ( V_166 , V_48 , & V_172 ) ;
F_54 ( V_166 , V_86 , & V_173 ) ;
if ( V_2 -> V_67 >= 0 && V_2 -> V_66 != V_2 -> V_67 )
F_55 ( V_165 , F_56 ( & V_174 , V_2 ) ) ;
else
V_166 -> V_170 = V_175 ;
F_57 ( V_166 , V_176 ,
F_58 () ,
...
const struct V_177 * F_59 ( int V_178 )
{
return V_178 == V_48 ?
& V_172 : & V_173 ;
}
