...
break;
default:
F_159 ( V_196 , V_98 , L_20 , F_160 ( V_59 , V_197 , sizeof( V_197 ) ) ) ;
break;
}
return 0 ;
}
int F_161 ( struct V_1 * V_2 V_139 ,
int V_59 , char * V_196 , T_1 V_98 )
{
int V_195 , V_141 ;
char V_197 [ V_201 ] , * V_202 = F_160 ( V_59 , V_197 , sizeof( V_197 ) ) ;
switch ( V_59 ) {
case V_199 :
case V_203 :
V_195 = F_159 ( V_196 , V_98 ,
L_27
L_28 , V_202 ) ;
V_141 = F_162 () ;
V_195 += F_159 ( V_196 + V_195 , V_98 - V_195 , L_29 ) ;
if ( V_141 >= 2 ) {
V_195 += F_159 ( V_196 + V_195 , V_98 - V_195 ,
L_30 ) ;
}
V_195 += F_159 ( V_196 + V_195 , V_98 - V_195 ,
L_31 ) ;
...
break;
default:
F_159 ( V_196 , V_98 , L_20 , V_202 ) ;
break;
}
return 0 ;
}
int F_163 ( struct V_1 * V_2 , int V_59 , char * V_196 , T_1 V_98 )
{
char V_197 [ V_201 ] , * V_202 = F_160 ( V_59 , V_197 , sizeof( V_197 ) ) ;
int V_204 = V_2 -> V_117 / 1024 , V_205 , V_195 = 0 ;
switch ( V_59 ) {
case V_203 :
F_107 ( L_6 , & V_205 ) ;
V_195 += F_159 ( V_196 + V_195 , V_98 - V_195 ,
...
return;
F_17 (evlist, n, evsel) {
if ( V_18 -> V_30 == V_206 -> V_30 )
F_165 ( & V_18 -> V_21 , & V_207 ) ;
}
F_166 ( & V_207 , & V_2 -> V_10 ) ;
}
