...
F_8 ( V_8 , F_47 ( 0 ) , 0xff , V_91 ) ;
F_8 ( V_8 , F_47 ( V_92 ) ,
V_93 , V_94 << 4 ) ;
F_8 ( V_8 , F_18 ( V_95 ) , 0x7f ,
V_96 ) ;
F_8 ( V_8 , F_47 ( V_97 ) , V_98 ,
V_98 ) ;
F_8 ( V_8 , F_47 ( V_99 ) , V_100 , 0 ) ;
...
V_110 = F_61 ( V_67 -> V_68 , V_22 ) ;
if ( V_110 ) {
if ( F_62 ( V_22 , V_67 -> V_107 ) )
F_63 ( V_110 ) ;
else
F_64 ( V_8 -> V_20 , L_4 ) ;
} else {
...
static int F_65 ( struct V_2 * V_3 , struct V_114 * V_63 ,
struct V_115 * V_116 )
{
...
V_67 -> V_3 . V_133 = F_65 ;
V_67 -> V_3 . V_134 = F_69 ;
V_67 -> V_68 = F_77 ( V_8 -> V_20 -> V_135 , V_108 ,
& V_136 , & V_67 -> V_3 ) ;
if ( ! V_67 -> V_68 ) {
F_42 ( & V_63 -> V_20 , L_6 ) ;
return - V_137 ;
}
V_84 = F_78 ( & V_63 -> V_20 , V_67 -> V_138 , F_59 ,
V_139 , V_129 . V_140 , V_8 ) ;
if ( V_84 < 0 ) {
F_42 ( & V_63 -> V_20 , L_7 , V_84 ) ;
goto V_84;
}
V_84 = F_78 ( & V_63 -> V_20 , V_67 -> V_141 , F_59 ,
V_139 , V_129 . V_140 , V_8 ) ;
if ( V_84 < 0 ) {
F_42 ( & V_63 -> V_20 , L_7 , V_84 ) ;
goto V_84;
}
V_67 -> V_142 = F_79 ( V_143 , 0 ) ;
V_11 = F_80 ( ( void * ) V_67 -> V_142 ) ;
...
struct V_46 V_47 ;
int V_84 , V_56 ;
V_84 = F_83 ( V_63 -> V_20 . V_135 , 0 , & V_47 ) ;
if ( V_84 )
return V_84 ;
V_8 -> V_145 = F_84 ( & V_63 -> V_20 , L_8 ) ;
if ( F_85 ( V_8 -> V_145 ) ) {
F_42 ( V_8 -> V_20 , L_9 ) ;
...
V_8 = F_104 ( & V_63 -> V_20 , sizeof( * V_8 ) , V_143 ) ;
if ( ! V_8 )
return - V_137 ;
V_8 -> V_20 = & V_63 -> V_20 ;
F_105 ( V_63 , V_8 ) ;
if ( F_106 ( V_63 -> V_20 . V_135 , & V_8 -> V_61 ) ) {
F_42 ( & V_63 -> V_20 , L_16 ) ;
return - V_120 ;
}
if ( F_107 ( & V_165 , V_63 -> V_20 . V_135 ) ) {
F_42 ( & V_63 -> V_20 , L_17 ) ;
return - V_120 ;
}
V_84 = F_82 ( V_63 , V_8 ) ;
if ( V_84 < 0 ) {
F_42 ( & V_63 -> V_20 , L_18 , V_84 ) ;
return V_84 ;
}
F_101 (&parser, &range) {
V_84 = F_108 ( & V_151 , V_63 -> V_20 . V_135 ,
& V_8 -> V_47 [ V_45 ++ ] ) ;
if ( V_84 < 0 )
return V_84 ;
if ( V_45 > V_57 )
...
V_84 = F_100 ( V_8 , V_63 -> V_20 . V_135 ) ;
if ( V_84 )
return V_84 ;
if ( F_49 ( F_37 ) ) {
V_84 = F_75 ( V_8 ) ;
...
V_14 = F_6 ( V_8 , V_178 ) ;
F_64 ( & V_63 -> V_20 , L_21 , ( V_14 >> 20 ) & 0x3f ) ;
F_35 ( V_8 ) ;
return 0 ;
}
