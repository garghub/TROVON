...
unsigned long V_258 ;
printf ( L_176 , F_17 () ) ;
for ( V_68 = 0 ; V_68 < V_259 ; V_68 ++ ) {
asm volatile("slbmfee %0,%1" : "=r" (esid) : "r" (i));
asm volatile("slbmfev %0,%1" : "=r" (vsid) : "r" (i));
V_257 = ( V_255 & V_260 ) ;
if ( V_257 | V_255 | V_256 ) {
...
{
int V_68 ;
for ( V_68 = 0 ; V_68 < V_266 ; V_68 ++ ) {
unsigned long V_267 , V_268 , V_269 ;
asm volatile("tlbre %0,%1,0" : "=r" (w0) : "r" (i));
asm volatile("tlbre %0,%1,1" : "=r" (w1) : "r" (i));
asm volatile("tlbre %0,%1,2" : "=r" (w2) : "r" (i));
printf ( L_182 , V_68 , V_267 , V_268 , V_269 ) ;
if ( V_267 & V_270 ) {
printf ( L_183 ,
V_267 & V_271 ,
V_268 & V_272 ,
...
{
V_171 V_279 , V_280 , V_281 ;
V_172 V_282 ;
int V_68 , V_283 , V_284 , V_285 , V_286 , V_287 , V_288 = 0 ;
int V_289 ;
...
V_293 = V_292 & 0xfff ;
V_294 = ( V_292 >> 24 ) & 0xff ;
for ( V_68 = 0 ; V_68 < V_293 ; V_68 ++ ) {
V_171 V_300 = F_157 ( V_283 ) ;
V_171 V_301 = F_158 ( V_302 ) ;
V_172 V_303 = 0 ;
V_172 V_304 ;
int V_305 = V_68 , V_306 = V_68 ;
if ( V_294 != 0 ) {
V_306 = V_68 / V_294 ;
V_305 = V_68 % V_294 ;
V_303 = V_306 * 0x1000 ;
...
printf ( L_220 , V_306 , 'A' + V_305 ) ;
else
printf ( L_221 , 'A' + V_305 ) ;
V_295 = 0 ;
printf ( L_222 ,
V_303 & ~ 0x3ffull ,
( V_301 >> 16 ) & 0x3fff ,
...
V_303 & V_320 ? 'g' : ' ' ,
V_303 & V_321 ? 'e' : ' ' ) ;
printf ( L_224 , V_304 & V_282 & ~ 0x7ffull ) ;
if ( V_301 & V_312 )
printf ( L_225 ,
V_290 [ ( V_304 >> 1 ) & 0x1f ] ) ;
else
...
int V_68 ;
V_172 V_251 ;
for ( V_68 = 0 ; V_68 < V_344 ; V_68 ++ ) {
if ( ! V_345 [ V_68 ] . V_342 )
continue;
if ( setjmp ( V_116 ) == 0 ) {
V_66 = 1 ;
F_2 () ;
V_342 = V_345 [ V_68 ] . V_342 ;
V_345 [ V_68 ] . V_349 =
F_172 ( & V_342 -> V_350 -> V_351 ) ;
V_251 = F_173 ( V_342 ) ;
V_345 [ V_68 ] . V_352 = V_251 ;
V_251 &= ~ V_353 ;
F_174 ( V_342 , V_251 ) ;
F_2 () ;
F_124 ( 200 ) ;
...
F_2 () ;
V_342 = V_345 [ V_68 ] . V_342 ;
F_174 ( V_342 , V_345 [ V_68 ] . V_352 ) ;
F_176 ( & V_342 -> V_350 -> V_351 ,
V_345 [ V_68 ] . V_349 ) ;
F_2 () ;
F_124 ( 200 ) ;
printf ( L_237 , V_68 ) ;
...
static void F_177 ( struct V_342 * V_342 )
{
printf ( L_239 , V_342 ) ;
F_178 ( V_342 , L_240 , V_343 ) ;
F_178 ( V_342 , L_137 , V_115 ) ;
F_178 ( V_342 , L_241 , V_354 ) ;
F_178 ( V_342 , L_242 , V_348 ) ;
F_178 ( V_342 , L_241 , V_355 ) ;
F_178 ( V_342 , L_240 , V_356 ) ;
F_178 ( V_342 , L_241 , V_36 ) ;
F_178 ( V_342 , L_243 , V_357 ) ;
F_178 ( V_342 , L_241 , V_358 ) ;
F_178 ( V_342 , L_241 , V_359 ) ;
F_178 ( V_342 , L_241 , V_360 ) ;
F_178 ( V_342 , L_241 , V_361 [ 0 ] ) ;
F_178 ( V_342 , L_241 , V_361 [ 1 ] ) ;
F_178 ( V_342 , L_241 , V_361 [ 2 ] ) ;
F_178 ( V_342 , L_240 , V_362 ) ;
F_178 ( V_342 , L_243 , V_144 ) ;
F_178 ( V_342 , L_242 , V_363 ) ;
F_178 ( V_342 , L_242 , V_364 ) ;
F_178 ( V_342 , L_242 , V_365 ) ;
F_178 ( V_342 , L_242 , V_366 ) ;
F_178 ( V_342 , L_241 , V_367 ) ;
F_178 ( V_342 , L_242 , V_350 ) ;
F_179 ( L_240 , V_350 -> V_351 ,
F_172 ( & V_342 -> V_350 -> V_351 ) ) ;
F_179 ( L_240 , V_350 -> V_368 ,
F_172 ( & V_342 -> V_350 -> V_368 ) ) ;
F_179 ( L_240 , V_350 -> V_369 ,
F_172 ( & V_342 -> V_350 -> V_369 ) ) ;
F_178 ( V_342 , L_242 , V_370 ) ;
F_178 ( V_342 , L_242 , V_371 ) ;
}
int
F_180 ( unsigned long V_214 , long V_215 , int V_216 )
{
return F_144 ( V_214 , V_215 , V_216 , V_372 ) ;
}
static void F_181 ( unsigned long V_211 , int V_373 )
{
unsigned long V_35 , V_6 , V_374 ;
if ( setjmp ( V_116 ) == 0 ) {
V_66 = 1 ;
F_2 () ;
V_374 = ( unsigned long ) V_345 [ V_211 ] . V_342 -> V_348 ;
F_2 () ;
F_124 ( 200 ) ;
} else {
V_66 = 0 ;
...
case 'f' :
F_109 ( & V_211 ) ;
if ( V_211 >= V_344 || ! V_345 [ V_211 ] . V_342 ) {
printf ( L_248 ) ;
return 0 ;
}
switch ( V_30 ) {
case 'f' :
F_177 ( V_345 [ V_211 ] . V_342 ) ;
break;
default:
F_181 ( V_211 , V_373 ) ;
break;
