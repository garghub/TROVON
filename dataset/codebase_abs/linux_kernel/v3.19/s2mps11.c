...
case V_53 :
case V_54 :
if ( V_8 -> V_55 & ( 1 << F_4 ( V_4 ) ) )
V_51 = V_56 ;
else if ( F_10 ( V_8 -> V_57 [ F_4 ( V_4 ) ] ) )
V_51 = V_58 ;
else
V_51 = V_4 -> V_27 -> V_59 ;
break;
...
V_36 = F_12 ( V_4 -> V_49 , V_4 -> V_27 -> V_63 , & V_51 ) ;
if ( V_36 < 0 )
return V_36 ;
V_8 -> V_55 |= ( 1 << F_4 ( V_4 ) ) ;
...
static void F_14 ( struct V_73 * V_74 ,
...
V_82 } ;
for ( V_78 = 0 ; V_78 < F_15 ( V_79 ) ; V_78 ++ ) {
unsigned int V_83 = V_79 [ V_78 ] ;
if ( ! V_76 [ V_83 ] . V_84 || ! V_76 [ V_83 ] . V_85 )
continue;
V_77 [ V_83 ] = F_16 ( V_76 [ V_83 ] . V_85 ,
L_2 , 0 ) ;
if ( F_10 ( V_77 [ V_83 ] ) )
F_17 ( & V_74 -> V_50 , L_3 ,
...
{
struct V_87 * V_88 ;
V_88 = F_19 ( V_74 -> V_50 . V_89 -> V_85 , L_4 ) ;
if ( ! V_88 ) {
F_8 ( & V_74 -> V_50 , L_5 ) ;
return - V_62 ;
}
...
{
struct V_101 * V_102 = F_23 ( V_74 -> V_50 . V_89 ) ;
...
V_8 = F_24 ( & V_74 -> V_50 , sizeof( struct V_7 ) ,
V_109 ) ;
if ( ! V_8 )
return - V_110 ;
V_8 -> V_52 = F_25 ( V_74 ) -> V_111 ;
switch ( V_8 -> V_52 ) {
case V_112 :
V_8 -> V_90 = F_15 ( V_113 ) ;
V_108 = V_113 ;
...
V_76 = F_27 ( sizeof( * V_76 ) * V_8 -> V_90 , V_109 ) ;
if ( ! V_76 )
return - V_110 ;
for ( V_78 = 0 ; V_78 < V_8 -> V_90 ; V_78 ++ )
V_76 [ V_78 ] . V_86 = V_108 [ V_78 ] . V_86 ;
V_36 = F_18 ( V_74 , V_76 , V_8 ) ;
if ( V_36 )
goto V_119;
V_117:
F_28 ( V_74 , V_8 ) ;
V_106 . V_50 = & V_74 -> V_50 ;
V_106 . V_49 = V_102 -> V_120 ;
V_106 . V_111 = V_8 ;
V_106 . V_121 = V_122 ;
V_106 . V_123 = true ;
for ( V_78 = 0 ; V_78 < V_8 -> V_90 ; V_78 ++ ) {
struct V_3 * V_124 ;
if ( V_104 ) {
V_106 . V_84 = V_104 -> V_108 [ V_78 ] . V_125 ;
V_106 . V_85 = V_104 -> V_108 [ V_78 ] . V_126 ;
} else {
V_106 . V_84 = V_76 [ V_78 ] . V_84 ;
V_106 . V_85 = V_76 [ V_78 ] . V_85 ;
}
V_106 . V_127 = V_8 -> V_57 [ V_78 ] ;
V_124 = F_29 ( & V_74 -> V_50 ,
& V_108 [ V_78 ] , & V_106 ) ;
if ( F_30 ( V_124 ) ) {
V_36 = F_31 ( V_124 ) ;
F_8 ( & V_74 -> V_50 , L_8 ,
...
if ( F_10 ( V_8 -> V_57 [ V_78 ] ) ) {
V_36 = F_13 ( V_8 ,
V_124 ) ;
if ( V_36 < 0 ) {
F_8 ( & V_74 -> V_50 ,
L_9 ,
V_124 -> V_27 -> V_86 , V_36 ) ;
goto V_119;
}
}
}
