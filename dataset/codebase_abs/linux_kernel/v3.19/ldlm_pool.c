...
static T_5 F_43 ( struct V_79 * V_79 ,
const char * V_80 , T_6 V_81 ,
T_7 * V_82 )
{
...
F_52 ( L_16 , & V_9 -> V_25 ,
& V_98 ) ;
F_52 ( L_17 , & V_9 -> V_99 , & V_100 ) ;
F_52 ( L_18 , & V_9 -> V_18 , & V_101 ) ;
F_52 ( L_19 , V_9 , & V_102 ) ;
F_52 ( L_20 , & V_9 -> V_30 ,
& V_101 ) ;
F_52 ( L_21 , & V_9 -> V_28 ,
...
V_108 | V_109 ,
L_34 , L_35 ) ;
V_90 = F_55 ( V_9 -> V_96 , L_36 , V_9 -> V_31 ) ;
V_95:
F_56 ( V_89 , V_91 + 1 ) ;
return V_90 ;
}
...
F_34 ( & V_9 -> V_30 , 0 ) ;
V_9 -> V_20 = F_62 ( V_114 ) ;
snprintf ( V_9 -> V_69 , sizeof( V_9 -> V_69 ) , L_37 ,
F_48 ( V_53 ) , V_112 ) ;
if ( V_113 == V_115 ) {
V_9 -> V_61 = & V_116 ;
F_25 ( V_9 , V_114 ) ;
...
static unsigned long F_93 ( struct V_135 * V_136 ,
struct V_137 * V_138 )
{
return F_76 ( V_115 , V_138 -> V_47 ) ;
}
static unsigned long F_94 ( struct V_135 * V_136 ,
struct V_137 * V_138 )
{
return F_91 ( V_115 , V_138 -> V_139 ,
V_138 -> V_47 ) ;
}
static unsigned long F_95 ( struct V_135 * V_136 ,
struct V_137 * V_138 )
{
return F_76 ( V_129 , V_138 -> V_47 ) ;
}
static unsigned long F_96 ( struct V_135 * V_136 ,
struct V_137 * V_138 )
{
