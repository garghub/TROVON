...
T_2 V_79 ;
const char * V_80 ;
V_75 = F_33 ( V_9 , V_81 , 0 ) ;
if ( ! V_75 )
return - V_82 ;
V_2 = F_34 ( sizeof( struct V_3 ) ) ;
if ( ! V_2 )
return - V_14 ;
V_4 = F_2 ( V_2 ) ;
V_4 -> V_9 = V_9 ;
...
F_35 ( & V_4 -> V_83 ) ;
V_2 -> V_84 = V_75 -> V_85 ;
V_4 -> V_75 = F_36 ( & V_9 -> V_2 , V_75 -> V_85 , F_37 ( V_75 ) ) ;
if ( ! V_4 -> V_75 ) {
V_78 = - V_14 ;
goto V_86;
}
V_4 -> V_87 = F_38 ( & V_9 -> V_2 , L_3 ) ;
if ( F_39 ( V_4 -> V_87 ) ) {
V_78 = F_40 ( V_4 -> V_87 ) ;
goto V_86;
}
...
V_4 -> V_89 = F_42 ( - V_82 ) ;
V_2 -> V_62 = F_43 ( V_9 , 0 ) ;
V_78 = F_44 ( & V_9 -> V_2 , V_2 -> V_62 , F_24 , 0 , V_2 -> V_90 , V_2 ) ;
if ( V_78 )
goto V_91;
V_2 -> V_92 = & V_93 ;
V_2 -> V_94 = & V_95 ;
F_45 ( V_9 , V_2 ) ;
F_46 ( V_2 , & V_9 -> V_2 ) ;
V_80 = F_47 ( V_9 -> V_2 . V_96 ) ;
if ( V_80 )
memcpy ( V_4 -> V_2 -> V_97 , V_80 , V_98 ) ;
else
F_48 ( V_4 ) ;
V_78 = F_49 ( V_9 -> V_2 . V_96 ) ;
if ( V_78 < 0 ) {
if ( V_73 && V_73 -> V_99 )
V_4 -> V_100 = V_101 ;
else
...
F_6 ( V_4 , V_22 , 0 ) ;
V_79 = F_18 ( V_103 , V_104 ) | F_5 ( V_105 ) ;
if ( V_4 -> V_100 == V_101 )
V_79 |= F_5 ( V_106 ) ;
F_6 ( V_4 , V_107 , V_79 ) ;
V_78 = F_50 ( V_2 ) ;
...
V_77 = V_4 -> V_35 ;
F_53 ( V_2 , L_4 ,
V_77 -> V_109 -> V_90 , F_54 ( & V_77 -> V_2 ) ,
V_77 -> V_62 ) ;
F_53 ( V_2 , L_5 ,
V_2 -> V_84 , V_2 -> V_62 , V_2 -> V_97 ) ;
return 0 ;
V_108:
F_55 ( V_2 ) ;
V_91:
...
static int F_58 ( struct V_71 * V_9 )
{
...
static int F_64 ( struct V_71 * V_9 , T_5 V_111 )
{
struct V_1 * V_112 = F_59 ( V_9 ) ;
struct V_3 * V_4 = F_2 ( V_112 ) ;
if ( F_65 ( V_112 ) ) {
F_13 ( V_112 ) ;
F_66 ( V_112 ) ;
F_56 ( V_4 -> V_87 ) ;
...
static int F_67 ( struct V_71 * V_9 )
{
struct V_1 * V_112 = F_59 ( V_9 ) ;
struct V_3 * V_4 = F_2 ( V_112 ) ;
if ( F_65 ( V_112 ) ) {
