...
int F_151 ( const char * V_9 , unsigned long V_2 ,
T_1 * V_10 )
{
...
if ( V_230 )
V_11 = V_11 < 0 ? - V_230 : V_230 ;
V_361 *= V_11 ;
F_63 ( V_361 , V_362 ) ;
* V_10 = V_360 * V_11 + V_361 ;
return 0 ;
}
static char * F_154 ( const char * V_363 , const char * V_364 , T_9 V_210 )
{
T_9 V_365 ;
V_365 = strlen ( V_364 ) ;
if ( ! V_365 )
...
char * V_10 ;
T_9 V_366 = * V_2 ;
V_10 = F_154 ( V_9 , V_28 , V_366 ) ;
if ( V_10 == NULL )
return ( char * ) V_9 ;
V_10 += strlen ( V_28 ) ;
while ( V_10 < V_9 + V_366 && isspace ( * V_10 ) )
V_10 ++ ;
* V_2 = 0 ;
while ( V_10 < V_9 + V_366 && isalnum ( * V_10 ) ) {
++ * V_2 ;
++ V_10 ;
}
return V_10 - * V_2 ;
...
const char * V_28 ,
T_3 V_33 ,
const struct V_30 * V_367 ,
void * V_29 )
{
struct V_26 * V_39 ;
F_23 ( ( V_367 -> V_35 == NULL ) == ( ( V_33 & 0222 ) == 0 ) ) ;
V_39 = F_13 ( V_28 , V_33 , V_37 , V_367 , V_29 ) ;
if ( V_39 == NULL )
return - V_36 ;
return 0 ;
}
...
void F_158 ( struct V_368 * V_369 , unsigned int V_370 )
{
if ( V_370 >= V_371 )
V_370 = V_371 - 1 ;
F_59 ( & V_369 -> V_372 ) ;
...
void F_159 ( struct V_368 * V_369 , unsigned int V_370 )
{
unsigned int V_10 ;
for ( V_10 = 0 ; ( ( 1 << V_10 ) < V_370 ) && ( V_10 <= V_371 ) ; V_10 ++ )
;
F_158 ( V_369 , V_10 ) ;
}
unsigned long F_160 ( struct V_368 * V_369 )
{
unsigned long V_7 = 0 ;
int V_6 ;
for ( V_6 = 0 ; V_6 < V_371 ; V_6 ++ )
V_7 += V_369 -> V_373 [ V_6 ] ;
return V_7 ;
}
void F_161 ( struct V_368 * V_369 )
{
F_59 ( & V_369 -> V_372 ) ;
memset ( V_369 -> V_373 , 0 , sizeof( V_369 -> V_373 ) ) ;
F_62 ( & V_369 -> V_372 ) ;
}
int F_162 ( struct V_50 * V_51 , void * V_29 )
{
struct V_58 * V_62 = V_29 ;
struct V_374 * V_81 = & V_62 -> V_80 . V_81 ;
int V_49 ;
F_163 ( & V_81 -> V_375 ) ;
V_49 = F_28 ( V_51 , L_9 , V_81 -> V_376 ) ;
F_164 ( & V_81 -> V_375 ) ;
return V_49 ;
}
