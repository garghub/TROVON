...
V_15 = F_83 (
V_2 , V_20 -> V_123 -> V_134 / 8 ) ;
if ( V_15 )
goto V_133;
}
V_113 -> V_135 = F_91 ( ( V_20 -> V_121 -> V_110 + 7 ) / 8 ) ;
...
else if ( V_20 -> V_40 . V_86 == V_96 && V_20 -> V_137 . V_138 != V_139 )
V_20 -> V_40 . V_97 += V_140 ;
if ( V_20 -> V_46 ) {
struct V_47 * V_46 = V_20 -> V_46 ;
switch ( V_46 -> V_53 ) {
default:
...
V_136 = F_5 ( F_27 ( V_2 ) , 4 ) ;
V_20 -> V_40 . V_141 = V_136 + 1 + F_23 ( V_2 ) ;
error:
return V_15 ;
}
...
{
if ( F_95 ( & V_142 , V_107 ) < 0 ) {
F_90 ( L_5 , V_143 ) ;
return - V_144 ;
}
if ( F_96 ( & V_145 , V_45 ) < 0 ) {
F_90 ( L_6 , V_143 ) ;
F_97 ( & V_142 , V_107 ) ;
return - V_144 ;
}
...
{
if ( F_99 ( & V_145 , V_45 ) < 0 )
F_90 ( L_7 , V_143 ) ;
if ( F_97 ( & V_142 , V_107 ) < 0 )
F_90 ( L_8 , V_143 ) ;
}
