...
V_146 , V_1 -> V_5 -> V_33 , V_1 ) ;
if ( V_70 < 0 ) {
F_6 ( 0 , L_17 ,
V_1 -> V_5 -> V_33 , V_1 -> V_60 -> V_38 ) ;
return V_70 ;
}
F_86 ( V_60 , V_147 , & V_144 ) ;
F_6 ( 1 , L_18
L_19 , V_5 -> V_33 , V_148 ,
F_87 ( V_60 ) , V_60 -> V_149 , V_60 -> V_38 ,
...
V_70 = F_91 ( & V_60 -> V_58 , V_155 [ V_148 ] , V_137 [ V_148 ] , V_156 ,
sizeof( T_1 ) , & V_103 ) ;
if ( V_70 < 0 )
return V_70 ;
V_103 -> V_157 = F_77 ;
...
if ( V_70 < 0 )
goto error;
V_70 = F_92 ( V_103 , F_93 ( & V_160 , V_1 ) ) ;
if ( V_70 < 0 )
goto error;
if ( V_5 -> V_128 )
F_92 ( V_103 , F_93 ( & V_161 , V_1 ) ) ;
strcpy ( V_103 -> V_162 , L_21 ) ;
sprintf ( V_103 -> V_163 , L_22 , V_60 -> V_100 ) ;
sprintf ( V_103 -> V_164 , L_23 ,
V_103 -> V_163 , ( unsigned long long ) F_88 ( V_60 , 0 ) ) ;
strcpy ( V_103 -> V_165 , L_24 ) ;
F_6 ( 0 , L_25 ,
V_103 -> V_162 , V_148 ) ;
V_70 = F_94 ( V_103 ) ;
if ( V_70 < 0 )
