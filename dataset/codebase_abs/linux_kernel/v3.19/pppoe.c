...
V_33 -> V_109 ) ;
V_26 -> V_57 . V_110 = V_33 -> V_110 - sizeof( struct V_67 ) - 2 ;
...
V_68 -> V_75 = 0 ;
V_68 -> V_1 = V_26 -> V_113 ;
V_68 -> V_73 = F_75 ( V_148 ) ;
V_55 -> V_145 = F_71 ( V_146 ) ;
V_55 -> V_33 = V_33 ;
F_74 ( V_55 , V_33 , V_146 ,
V_26 -> V_23 . V_8 , NULL , V_148 ) ;
F_76 ( V_55 ) ;
return 1 ;
abort:
F_39 ( V_55 ) ;
...
static int F_79 ( struct V_149 * V_57 , struct V_54 * V_55 )
{
...
V_55 = F_81 ( V_38 , V_100 & ~ V_151 ,
V_100 & V_151 , & error ) ;
if ( error < 0 )
goto V_103;
if ( V_55 ) {
V_138 = F_82 ( T_2 , V_138 , V_55 -> V_69 ) ;
error = F_83 ( V_55 , 0 , V_137 , V_138 ) ;
if ( error == 0 ) {
F_84 ( V_55 ) ;
return V_138 ;
}
...
V_26 = V_154 ;
V_155 = V_26 -> V_23 . V_33 ;
F_87 ( V_153 , L_2 ,
V_26 -> V_23 . V_1 , V_26 -> V_23 . V_8 , V_155 ) ;
V_71:
return 0 ;
}
static inline struct V_18 * F_88 ( struct V_2 * V_19 , T_3 V_157 )
{
struct V_18 * V_26 ;
int V_11 ;
for ( V_11 = 0 ; V_11 < V_36 ; V_11 ++ ) {
...
static void * F_89 ( struct V_152 * V_153 , T_3 * V_157 )
__acquires( V_19 -> V_29 )
{
struct V_2 * V_19 = F_2 ( F_90 ( V_153 ) ) ;
T_3 V_158 = * V_157 ;
F_13 ( & V_19 -> V_29 ) ;
return V_158 ? F_88 ( V_19 , -- V_158 ) : V_156 ;
}
static void * F_91 ( struct V_152 * V_153 , void * V_154 , T_3 * V_157 )
{
struct V_2 * V_19 = F_2 ( F_90 ( V_153 ) ) ;
struct V_18 * V_26 ;
++ * V_157 ;
...
static void F_92 ( struct V_152 * V_153 , void * V_154 )
__releases( V_19 -> V_29 )
{
struct V_2 * V_19 = F_2 ( F_90 ( V_153 ) ) ;
F_16 ( & V_19 -> V_29 ) ;
}
static int F_93 ( struct V_159 * V_159 , struct V_160 * V_160 )
{
return F_94 ( V_159 , V_160 , & V_161 ,
sizeof( struct V_162 ) ) ;
}
...
struct V_163 * V_164 ;
F_96 ( & V_19 -> V_29 ) ;
V_164 = F_97 ( L_3 , V_165 , V_3 -> V_166 , & V_167 ) ;
#ifdef F_98
if ( ! V_164 )
return - V_81 ;
#endif
