...
{
struct V_235 * V_208 = F_96 ( V_230 , struct V_235 , V_230 ) ;
struct V_1 * V_2 = F_96 ( V_208 , struct V_1 , V_183 ) ;
struct V_62 * V_32 = V_2 -> V_32 ;
...
static int F_97 ( struct V_236 * V_237 )
{
...
if ( ! V_80 -> V_244 )
return - V_98 ;
V_240 = F_98 ( V_237 , L_57 ) ;
V_241 = F_98 ( V_237 , L_27 ) ;
V_242 = F_98 ( V_237 , L_58 ) ;
if ( V_241 < 0 || V_242 < 0 )
return - V_98 ;
V_6 = F_99 ( sizeof( struct V_1 ) , V_80 ) ;
if ( ! V_6 )
return - V_207 ;
V_91 = F_100 ( V_6 ) ;
if ( V_91 < 0 )
...
V_2 -> V_36 = V_155 ;
V_2 -> V_184 = F_94 ( 4000 ) ;
V_239 = F_102 ( V_237 , V_246 , 0 ) ;
V_2 -> V_5 = F_103 ( V_80 , V_239 ) ;
if ( F_58 ( V_2 -> V_5 ) ) {
V_91 = F_104 ( V_2 -> V_5 ) ;
goto V_245;
}
V_2 -> V_247 = F_105 ( V_80 , NULL ) ;
if ( F_58 ( V_2 -> V_247 ) )
goto V_245;
V_2 -> V_126 = F_106 ( V_2 -> V_247 ) ;
V_91 = F_107 ( V_2 -> V_247 ) ;
if ( V_91 < 0 )
goto V_245;
V_243 = F_7 ( V_2 , V_248 ) ;
...
V_91 = F_110 ( V_80 , V_241 , F_88 , F_87 , 0 ,
F_38 ( V_80 ) , V_2 ) ;
if ( V_91 < 0 )
goto V_249;
V_91 = F_109 ( V_80 , V_242 , F_89 , 0 ,
F_38 ( V_80 ) , V_2 ) ;
if ( V_91 < 0 )
goto V_249;
F_111 ( & V_2 -> V_183 , F_95 ) ;
F_49 ( V_2 , V_239 -> V_102 ) ;
V_6 -> V_254 = & V_255 ;
V_6 -> V_252 |= V_256 | V_257 |
V_258 | V_259 | V_260 ;
V_6 -> V_261 = 32 ;
V_6 -> V_262 = 512 ;
V_6 -> V_263 = V_264 * V_6 -> V_261 ;
V_6 -> V_265 = V_6 -> V_263 / V_6 -> V_262 ;
V_6 -> V_266 = V_6 -> V_263 ;
if ( ! V_6 -> V_267 )
V_6 -> V_267 = V_2 -> V_126 ;
...
static int F_116 ( struct V_236 * V_237 )
{
struct V_1 * V_2 = F_117 ( V_237 ) ;
F_118 ( V_2 -> V_6 ) ;
F_15 ( V_2 ) ;
F_73 ( & V_2 -> V_183 ) ;
F_33 ( V_2 ) ;
