...
V_9 = F_31 ( V_9 , V_13 -> V_29 , V_11 , V_15 ) ;
V_9 = F_13 ( V_9 ) ;
...
if ( V_31 > V_40 )
V_31 = V_40 ;
F_21 ( V_8 , V_10 , V_11 , V_11 + V_31 ,
V_13 , V_14 , V_15 , V_16 ) ;
V_33 = true ;
}
if ( F_47 ( V_33 ) )
F_48 ( V_8 , V_12 - V_30 , V_11 ) ;
F_49 ( V_8 -> V_20 , V_34 , V_35 ) ;
...
if ( V_2 -> V_50 >= V_51 - 3 )
return - V_52 ;
V_38 = F_51 ( V_8 , V_11 , V_11 + V_41 ,
V_53 , & V_44 ) ;
if ( V_38 )
return V_38 ;
V_45 = V_8 -> V_54 + ( ( V_11 - V_8 -> V_55 ) >> V_56 ) ;
V_13 = F_52 ( & V_8 , V_15 , V_42 , V_45 ,
& V_16 ) ;
if ( ! V_13 )
return - V_52 ;
V_46 = F_39 ( V_8 , V_11 , V_13 , V_15 , V_41 ,
V_16 ) ;
if ( V_46 < V_41 ) {
F_39 ( V_13 , V_15 , V_8 , V_11 , V_46 ,
true ) ;
V_8 = V_13 ;
V_41 = V_42 ;
V_11 = V_15 ;
...
V_8 -> V_25 -> V_57 -> V_58 ( V_8 -> V_25 , V_13 ) ;
if ( V_44 & V_59 ) {
V_8 -> V_44 &= ~ V_59 ;
...
goto V_75;
if ( V_8 -> V_44 & V_59 ) {
unsigned long V_76 = ( V_42 - V_41 ) >> V_56 ;
if ( F_62 ( V_2 , V_76 ) )
goto V_66;
* V_64 = V_76 ;
}
...
struct V_1 * V_2 = V_65 -> V_2 ;
struct V_7 * V_8 ;
unsigned long V_80 = - V_78 ;
unsigned long V_76 = 0 ;
unsigned long V_81 ;
if ( V_15 & ~ V_82 )
goto V_83;
if ( V_42 > V_84 || V_15 > V_84 - V_42 )
goto V_83;
if ( ( V_15 <= V_3 ) && ( V_15 + V_42 ) > V_3 )
goto V_83;
if ( ( V_3 <= V_15 ) && ( V_3 + V_41 ) > V_15 )
goto V_83;
V_80 = F_54 ( V_2 , V_15 , V_42 ) ;
if ( V_80 )
goto V_83;
if ( V_41 >= V_42 ) {
V_80 = F_54 ( V_2 , V_3 + V_42 , V_41 - V_42 ) ;
if ( V_80 && V_41 != V_42 )
goto V_83;
V_41 = V_42 ;
}
V_8 = F_56 ( V_3 , V_41 , V_42 , & V_76 ) ;
if ( F_65 ( V_8 ) ) {
V_80 = F_66 ( V_8 ) ;
goto V_83;
}
...
if ( V_8 -> V_44 & V_86 )
V_81 |= V_87 ;
V_80 = F_67 ( V_8 -> V_25 , V_15 , V_42 , V_8 -> V_54 +
( ( V_3 - V_8 -> V_55 ) >> V_56 ) ,
V_81 ) ;
if ( V_80 & ~ V_82 )
goto V_88;
V_80 = F_50 ( V_8 , V_3 , V_41 , V_42 , V_15 , V_43 ) ;
if ( ! ( V_80 & ~ V_82 ) )
goto V_83;
V_88:
F_55 ( V_76 ) ;
...
static int F_68 ( struct V_7 * V_8 , unsigned long V_89 )
{
unsigned long V_90 = V_8 -> V_60 + V_89 ;
if ( V_90 < V_8 -> V_60 )
return 0 ;
if ( V_8 -> V_61 && V_8 -> V_61 -> V_55 < V_90 )
return 0 ;
if ( F_67 ( NULL , V_8 -> V_55 , V_90 - V_8 -> V_55 ,
0 , V_85 ) & ~ V_82 )
return 0 ;
return 1 ;
}
