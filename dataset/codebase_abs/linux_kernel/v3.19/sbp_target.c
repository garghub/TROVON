...
char * V_264 )
{
return sprintf ( V_264 , L_66 , V_265 ) ;
}
static T_7 F_183 (
struct V_34 * V_22 ,
char * V_264 )
...
struct V_58 * V_59 = V_17 -> V_59 ;
if ( V_59 -> V_223 == - 1 )
return sprintf ( V_264 , L_67 ) ;
else
return sprintf ( V_264 , L_68 , V_59 -> V_223 ) ;
}
static T_7 F_184 (
struct V_34 * V_22 ,
const char * V_264 ,
...
if ( strstr ( V_264 , L_70 ) == V_264 ) {
V_59 -> V_223 = - 1 ;
} else {
if ( F_176 ( V_264 , 16 , & V_266 ) < 0 )
return - V_36 ;
if ( V_266 > 0xffffff )
return - V_36 ;
V_59 -> V_223 = V_266 ;
...
struct V_16 * V_17 = F_72 ( V_22 , struct V_16 , V_22 ) ;
struct V_58 * V_59 = V_17 -> V_59 ;
return sprintf ( V_264 , L_71 , V_59 -> V_200 ) ;
}
static T_7 F_186 (
struct V_34 * V_22 ,
const char * V_264 ,
...
struct V_16 * V_17 = F_72 ( V_22 , struct V_16 , V_22 ) ;
struct V_58 * V_59 = V_17 -> V_59 ;
return sprintf ( V_264 , L_71 , V_59 -> V_226 ) ;
}
static T_7 F_188 (
struct V_34 * V_22 ,
const char * V_264 ,
...
struct V_16 * V_17 = F_72 ( V_22 , struct V_16 , V_22 ) ;
struct V_58 * V_59 = V_17 -> V_59 ;
return sprintf ( V_264 , L_71 , V_59 -> V_78 ) ;
}
static T_7 F_190 (
struct V_34 * V_22 ,
const char * V_264 ,
...
struct V_16 * V_17 = F_72 ( V_22 , struct V_16 , V_22 ) ;
struct V_58 * V_59 = V_17 -> V_59 ;
return sprintf ( V_264 , L_71 , V_59 -> V_73 ) ;
}
static T_7 F_192 (
struct V_34 * V_22 ,
const char * V_264 ,
...
V_268 -> V_271 . V_275 . V_273 = V_276 ;
V_268 -> V_271 . V_277 . V_273 = V_278 ;
V_268 -> V_271 . V_279 . V_273 = NULL ;
V_268 -> V_271 . V_280 . V_273 = NULL ;
V_268 -> V_271 . V_281 . V_273 = NULL ;
V_268 -> V_271 . V_282 . V_273 = NULL ;
V_268 -> V_271 . V_283 . V_273 = NULL ;
V_268 -> V_271 . V_284 . V_273 = NULL ;
V_4 = F_195 ( V_268 ) ;
if ( V_4 < 0 ) {
F_17 ( L_75 ) ;
return V_4 ;
