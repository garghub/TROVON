...
struct V_1 * V_1 ;
T_9 V_142 , V_143 ;
F_143 ( V_21 , struct V_186 , V_143 , & V_143 ) ;
F_143 ( V_21 , struct V_186 , V_142 , & V_142 ) ;
V_1 = F_9 ( V_9 , 0 ) ;
...
V_9 -> V_153 = F_29 ( V_191 * sizeof( struct V_15 * ) ,
V_44 ) ;
V_9 -> V_154 = F_29 ( V_191 * sizeof( struct V_15 * ) ,
V_44 ) ;
...
V_55 = V_9 -> V_21 -> V_172 -> V_193 ( V_9 -> V_21 , V_192 , V_189 ,
V_187 ,
( const char * * ) V_188 ) ;
if ( V_55 )
goto free;
...
V_9 -> V_63 = V_189 [ V_190 + 1 ] ;
for ( V_29 = 1 ; V_29 < V_191 ; V_29 ++ ) {
V_190 += 2 ;
V_9 -> V_153 [ V_29 ] = V_189 [ V_190 ] ;
V_9 -> V_154 [ V_29 ] = V_189 [ V_190 + 1 ] ;
}
}
F_18 ( V_188 ) ;
F_18 ( V_187 ) ;
...
static int F_158 ( struct V_20 * V_21 )
{
struct V_8 * V_9 ;
struct V_1 * V_1 ;
V_9 = V_21 -> V_185 ;
...
{
int V_55 ;
V_134 . V_159 = F_162 ( V_205 , L_37 ) ;
if ( F_99 ( V_134 . V_159 ) ) {
V_55 = F_100 ( V_134 . V_159 ) ;
F_163 ( L_38 , V_55 ) ;
return V_55 ;
}
V_134 . V_165 = F_164 ( L_37 , NULL ) ;
if ( ! V_134 . V_165 )
F_165 ( L_39 ) ;
F_151 ( & V_134 . V_136 ) ;
F_151 ( & V_134 . V_200 ) ;
