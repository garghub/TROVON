...
int V_193 = 0 ;
F_101 ( & V_59 ) ;
if ( V_4 -> V_37 -> V_152 & V_194 )
V_184 |= V_195 ;
V_196:
V_188 = 0 ;
F_80 ( & V_4 -> V_89 , V_152 ) ;
if ( V_189 && F_113 ( V_197 ) ) {
V_60 = - V_198 ;
goto V_199;
}
F_44 ( V_4 -> V_82 & V_200 ,
...
int V_207 )
{
int V_1 = V_206 ? V_136 : V_137 ;
unsigned long V_152 ;
T_2 V_184 = V_207 ? V_208 : 0 ;
F_80 ( & V_4 -> V_89 , V_152 ) ;
F_11 ( V_4 -> V_82 & V_150 ) ;
F_71 ( V_4 , V_157 ) ;
F_81 ( & V_4 -> V_89 , V_152 ) ;
...
V_60 = F_120 ( V_39 , & F_45 ( V_27 ) -> V_209 , 1 , 1 ) ;
if ( V_60 ) {
F_114 ( V_60 ) ;
goto V_176;
}
V_60 = F_120 ( V_39 , & F_45 ( V_27 ) -> V_210 , 1 , 0 ) ;
if ( V_60 ) {
F_114 ( V_60 ) ;
goto V_176;
}
V_60 = F_120 ( V_39 , & F_45 ( V_27 ) -> V_211 , 0 , 0 ) ;
if ( V_60 ) {
F_114 ( V_60 ) ;
goto V_176;
}
...
int F_123 ( struct V_27 * V_27 , int V_212 )
{
int V_162 , V_1 ;
struct V_3 * V_4 ;
struct V_36 * V_39 = F_46 ( V_27 -> V_97 ) ;
...
void F_125 ( struct V_27 * V_27 , int V_212 )
{
int V_1 = V_212 ? V_136 : V_137 ;
...
int F_128 ( struct V_27 * V_27 , int V_212 )
{
int V_162 = 0 , V_1 ;
struct V_3 * V_4 ;
struct V_36 * V_39 = F_46 ( V_27 -> V_97 ) ;
...
int F_133 ( struct V_215 * V_215 , int V_206 , int V_216 )
{
int V_60 , V_1 = V_206 ? V_136 : V_137 ;
unsigned int V_184 = V_216 ? V_202 : 0 ;
unsigned long V_152 ;
struct V_101 * V_102 = V_215 -> V_217 ;
struct V_3 * V_4 = & V_102 -> V_218 ;
struct V_36 * V_39 = F_46 ( V_215 -> V_104 -> V_105 -> V_97 ) ;
struct V_58 V_59 ;
F_101 ( & V_59 ) ;
if ( ( V_4 -> V_82 & V_149 ) ||
( V_4 -> V_74 > V_139 ) ) {
...
V_164:
F_3 ( 0 , L_48 ,
V_4 -> V_8 , V_206 , V_216 , V_60 ) ;
return V_60 ;
}
void F_134 ( struct V_215 * V_215 )
{
int V_60 ;
unsigned int V_175 ;
unsigned long V_152 ;
...
{
int V_60 ;
V_60 = F_174 ( V_27 , V_255 , V_206 , V_204 ) ;
if ( V_60 == - V_163 ) {
F_175 ( V_264 ) ;
if ( F_176 ( V_27 , V_255 , V_206 ) == 0 )
F_172 ( V_27 , V_206 ) ;
V_60 = V_265 ;
}
return V_60 ;
...
int F_187 ( struct V_36 * V_39 , int V_206 )
{
int V_162 ;
...
if ( F_124 ( V_39 ) )
return 0 ;
V_162 = F_117 ( V_39 , V_4 , V_206 ? V_65 : V_64 ,
0 , 0 ) ;
if ( V_162 < 0 )
F_3 ( V_165 , L_59 , V_162 ) ;
return V_162 ;
}
void F_188 ( struct V_36 * V_39 , int V_206 )
{
struct V_3 * V_4 = & V_39 -> V_277 ;
if ( ! F_124 ( V_39 ) )
F_16 ( V_39 , V_4 ,
...
int V_29 ( struct V_278 * V_278 , int V_206 )
{
int V_60 ;
int V_1 = V_206 ? V_136 : V_137 ;
...
void F_189 ( struct V_278 * V_278 , int V_206 )
{
int V_1 = V_206 ? V_136 : V_137 ;
struct V_29 * V_108 = V_278 -> V_279 ;
struct V_36 * V_39 = F_46 ( V_278 -> V_280 ) ;
...
static int F_216 ( struct V_27 * V_27 , struct V_215 * V_215 )
{
struct V_291 * V_302 = V_215 -> V_217 ;
struct V_288 * V_73 = V_302 -> V_294 ;
struct V_3 * V_34 = & V_73 -> V_295 ;
F_24 ( V_34 ) ;
F_192 ( V_73 -> V_290 ) ;
return F_217 ( V_27 , V_215 ) ;
}
static int F_218 ( struct V_27 * V_27 , struct V_215 * V_215 )
{
struct V_288 * V_73 ;
struct V_36 * V_39 ;
V_73 = F_219 ( V_215 , & V_303 , sizeof( * V_73 ) ) ;
if ( ! V_73 ) {
F_114 ( - V_285 ) ;
return - V_285 ;
}
...
F_80 ( & V_4 -> V_89 , V_152 ) ;
V_4 -> V_82 |= V_200 ;
if ( V_4 -> V_82 & V_321 && V_197 == V_39 -> V_312 ) {
F_81 ( & V_4 -> V_89 , V_152 ) ;
...
struct V_357 * V_98 = F_266 ( V_356 -> V_99 . V_100 ,
V_356 -> V_99 . V_129 ) ;
V_6 = F_2 ( & V_4 -> V_7 ) ;
V_6 -> V_9 = V_358 ;
...
void F_267 ( struct V_31 * V_356 , int V_206 )
{
...
static int F_268 ( struct V_31 * V_356 )
{
struct V_357 * V_98 = F_266 ( V_356 -> V_99 . V_100 ,
V_356 -> V_99 . V_129 ) ;
struct V_3 * V_4 = & V_356 -> V_371 ;
...
int F_270 ( struct V_31 * V_356 , int V_206 )
{
struct V_3 * V_4 = & V_356 -> V_371 ;
struct V_36 * V_39 = F_46 ( V_356 -> V_99 . V_100 ) ;
int V_1 = V_206 ? V_136 : V_137 ;
...
int F_271 ( struct V_33 * V_377 , int V_206 )
{
int V_162 ;
int V_1 = V_206 ? V_136 : V_137 ;
...
void F_272 ( struct V_33 * V_377 , int V_206 )
{
int V_1 = V_206 ? V_136 : V_137 ;
struct V_3 * V_4 = & V_377 -> V_35 ;
struct V_36 * V_39 = V_4 -> V_28 ;
