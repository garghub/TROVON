...
static T_2 int F_32 ( T_4 V_24 , unsigned long V_7 ,
unsigned long V_8 , int V_9 , struct V_10 * * V_11 , int * V_12 )
{
unsigned long V_13 ;
T_1 V_2 = * ( T_1 * ) & V_24 ;
...
static int F_33 ( T_5 V_28 , unsigned long V_7 , unsigned long V_8 ,
int V_9 , struct V_10 * * V_11 , int * V_12 )
{
unsigned long V_25 ;
T_4 * V_29 ;
...
return 0 ;
if ( F_5 ( F_37 ( V_24 ) ) ) {
if ( ! F_32 ( V_24 , V_7 , V_25 , V_9 , V_11 , V_12 ) )
return 0 ;
} else {
...
int F_38 ( unsigned long V_30 , int V_31 , int V_9 ,
struct V_10 * * V_11 )
{
...
if ( F_43 ( V_28 ) )
break;
if ( ! F_33 ( V_28 , V_7 , V_25 , V_9 , V_11 , & V_12 ) )
break;
