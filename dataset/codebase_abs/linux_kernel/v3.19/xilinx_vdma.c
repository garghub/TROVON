...
if ( ! V_17 )
return NULL ;
F_62 ( & V_17 -> V_35 , & V_2 -> V_107 ) ;
V_17 -> V_35 . V_108 = F_57 ;
F_63 ( & V_17 -> V_35 ) ;
V_12 = F_10 ( V_2 ) ;
if ( ! V_12 )
goto error;
...
V_73 -> V_78 = ( V_100 -> V_104 [ 0 ] . V_109 + V_100 -> V_104 [ 0 ] . V_105 ) <<
V_110 ;
V_73 -> V_78 |= V_2 -> V_52 . V_111 <<
V_112 ;
if ( V_100 -> V_102 != V_66 )
V_73 -> V_74 = V_100 -> V_113 ;
else
V_73 -> V_74 = V_100 -> V_114 ;
if ( ! F_44 ( & V_17 -> V_22 ) ) {
V_57 = F_64 ( & V_17 -> V_22 ,
struct V_11 , V_24 ) ;
V_57 -> V_73 . V_115 = V_12 -> V_13 ;
}
...
return F_54 ( V_2 ) ;
V_117 = F_6 ( V_2 , V_45 ) ;
V_2 -> V_52 . V_111 = V_116 -> V_111 ;
V_2 -> V_52 . V_61 = V_116 -> V_61 ;
V_2 -> V_52 . V_119 = V_116 -> V_119 ;
V_2 -> V_52 . V_120 = V_116 -> V_120 ;
if ( V_116 -> V_119 && V_2 -> V_121 ) {
V_117 |= V_122 ;
V_117 |= V_116 -> V_120 << V_123 ;
}
V_2 -> V_52 . V_59 = V_116 -> V_59 ;
if ( V_116 -> V_61 )
V_2 -> V_52 . V_63 = V_116 -> V_63 ;
else
V_2 -> V_52 . V_63 = - 1 ;
V_2 -> V_52 . V_124 = V_116 -> V_124 ;
V_2 -> V_52 . V_125 = V_116 -> V_125 ;
if ( V_116 -> V_124 <= V_126 ) {
V_117 |= V_116 -> V_124 << V_127 ;
V_2 -> V_52 . V_124 = V_116 -> V_124 ;
}
if ( V_116 -> V_125 <= V_128 ) {
V_117 |= V_116 -> V_125 << V_129 ;
V_2 -> V_52 . V_125 = V_116 -> V_125 ;
}
V_117 &= ~ V_130 ;
V_117 |= V_116 -> V_131 << V_132 ;
F_7 ( V_2 , V_45 , V_117 ) ;
return 0 ;
}
static int F_67 ( struct V_30 * V_31 ,
enum V_133 V_134 , unsigned long V_135 )
{
struct V_1 * V_2 = F_26 ( V_31 ) ;
if ( V_134 != V_136 )
return - V_137 ;
...
F_69 ( V_2 -> V_85 , V_2 ) ;
F_70 ( & V_2 -> V_95 ) ;
F_21 ( & V_2 -> V_107 . V_138 ) ;
}
static int F_71 ( struct V_139 * V_4 ,
struct V_138 * V_24 )
{
struct V_1 * V_2 ;
bool V_140 = false ;
...
F_18 ( & V_2 -> V_27 ) ;
F_18 ( & V_2 -> V_28 ) ;
V_140 = F_74 ( V_24 , L_11 ) ;
V_2 -> V_121 = F_74 ( V_24 , L_12 ) ;
...
F_80 ( & V_2 -> V_95 , F_31 ,
( unsigned long ) V_2 ) ;
V_2 -> V_107 . V_153 = & V_4 -> V_107 ;
F_52 ( & V_2 -> V_107 . V_138 , & V_4 -> V_107 . V_154 ) ;
...
static struct V_30 * F_81 ( struct V_155 * V_156 ,
struct V_157 * V_158 )
{
struct V_139 * V_4 = V_158 -> V_159 ;
int V_160 = V_156 -> args [ 0 ] ;
if ( V_160 >= V_161 )
return NULL ;
return F_82 ( & V_4 -> V_2 [ V_160 ] -> V_107 ) ;
}
static int F_83 ( struct V_162 * V_163 )
{
struct V_138 * V_24 = V_163 -> V_32 . V_164 ;
struct V_139 * V_4 ;
struct V_138 * V_165 ;
struct V_166 * V_167 ;
T_1 V_168 ;
int V_72 , V_50 ;
V_4 = F_72 ( & V_163 -> V_32 , sizeof( * V_4 ) , V_20 ) ;
if ( ! V_4 )
return - V_38 ;
V_4 -> V_32 = & V_163 -> V_32 ;
V_167 = F_84 ( V_163 , V_169 , 0 ) ;
V_4 -> V_5 = F_85 ( & V_163 -> V_32 , V_167 ) ;
if ( F_86 ( V_4 -> V_5 ) )
return F_87 ( V_4 -> V_5 ) ;
V_4 -> V_56 = F_74 ( V_24 , L_21 ) ;
V_50 = F_75 ( V_24 , L_22 , & V_168 ) ;
if ( V_50 < 0 ) {
F_35 ( V_4 -> V_32 , L_23 ) ;
return V_50 ;
}
...
if ( V_50 < 0 )
F_88 ( V_4 -> V_32 , L_25 ) ;
V_4 -> V_107 . V_32 = & V_163 -> V_32 ;
F_18 ( & V_4 -> V_107 . V_154 ) ;
F_89 ( V_170 , V_4 -> V_107 . V_171 ) ;
F_89 ( V_172 , V_4 -> V_107 . V_171 ) ;
V_4 -> V_107 . V_173 =
F_32 ;
V_4 -> V_107 . V_174 =
F_25 ;
V_4 -> V_107 . V_175 =
F_60 ;
V_4 -> V_107 . V_176 = F_67 ;
V_4 -> V_107 . V_177 = F_37 ;
V_4 -> V_107 . V_178 = F_49 ;
F_90 ( V_163 , V_4 ) ;
F_91 (node, child) {
V_50 = F_71 ( V_4 , V_165 ) ;
if ( V_50 < 0 )
...
if ( V_4 -> V_2 [ V_72 ] )
V_4 -> V_2 [ V_72 ] -> V_64 = V_168 ;
F_92 ( & V_4 -> V_107 ) ;
V_50 = F_93 ( V_24 , F_81 ,
V_4 ) ;
if ( V_50 < 0 ) {
F_35 ( & V_163 -> V_32 , L_26 ) ;
F_94 ( & V_4 -> V_107 ) ;
goto error;
}
F_95 ( & V_163 -> V_32 , L_27 ) ;
return 0 ;
error:
for ( V_72 = 0 ; V_72 < V_161 ; V_72 ++ )
if ( V_4 -> V_2 [ V_72 ] )
...
{
struct V_139 * V_4 = F_97 ( V_163 ) ;
int V_72 ;
F_98 ( V_163 -> V_32 . V_164 ) ;
F_94 ( & V_4 -> V_107 ) ;
for ( V_72 = 0 ; V_72 < V_161 ; V_72 ++ )
if ( V_4 -> V_2 [ V_72 ] )
F_68 ( V_4 -> V_2 [ V_72 ] ) ;
