...
V_68 = V_14 -> V_72 ;
V_2 [ 0 ] = V_14 -> V_2 ;
V_2 [ 1 ] = V_2 [ 0 ] != V_65 -> V_2 ? V_65 -> V_2 : NULL ;
for ( V_71 = 0 ; V_71 < 2 ; V_71 ++ )
V_70 [ V_71 ] = V_2 [ V_71 ] ? V_2 [ V_71 ] -> V_72 : NULL ;
if ( V_68 -> V_73 ) {
V_49 = V_68 -> V_73 ( V_14 , V_65 ) ;
if ( V_49 )
goto V_74;
}
if ( V_68 -> V_75 && V_65 -> V_16 ) {
V_49 = V_68 -> V_75 ( V_14 , V_65 -> V_16 ) ;
if ( V_49 )
goto V_74;
}
F_24 ( V_14 -> V_76 , V_65 ) ;
for ( V_71 = 0 ; V_71 < 2 ; V_71 ++ ) {
if ( V_70 [ V_71 ] && V_70 [ V_71 ] -> V_77 )
V_70 [ V_71 ] -> V_77 ( V_2 [ V_71 ] ) ;
}
V_68 -> V_78 ( V_14 , V_65 ) ;
for ( V_71 = 0 ; V_71 < 2 ; V_71 ++ ) {
if ( V_70 [ V_71 ] && V_70 [ V_71 ] -> V_79 )
V_70 [ V_71 ] -> V_79 ( V_2 [ V_71 ] ) ;
}
for ( V_71 = 0 ; V_71 < 2 ; V_71 ++ ) {
if ( ! V_2 [ V_71 ] )
continue;
...
if ( V_65 ) {
if ( V_14 -> V_51 -> V_81 )
V_14 -> V_51 -> V_81 ( V_14 , V_65 ) ;
else
F_28 ( V_14 , V_65 ) ;
}
return V_49 ;
}
int F_29 ( struct V_13 * V_14 , struct V_1 * V_2 ,
struct V_15 * V_16 ,
int V_31 , int V_32 ,
unsigned int V_33 , unsigned int V_34 ,
T_1 V_35 , T_1 V_36 ,
...
struct V_64 * V_65 ;
if ( V_14 -> V_51 -> V_82 )
V_65 = V_14 -> V_51 -> V_82 ( V_14 ) ;
else if ( V_14 -> V_76 )
V_65 = F_30 ( V_14 ) ;
else
V_65 = F_13 ( sizeof( * V_65 ) , V_53 ) ;
if ( ! V_65 )
return - V_54 ;
V_65 -> V_2 = V_2 ;
F_31 ( V_65 , V_16 ) ;
...
V_65 -> V_38 = V_38 ;
V_65 -> V_37 = V_37 ;
return F_23 ( V_14 , V_65 , V_14 -> V_16 ) ;
}
