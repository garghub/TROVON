...
struct V_307 * V_308 ;
struct V_7 * V_7 ;
V_7 = F_115 ( sizeof( struct V_7 ) , V_309 ) ;
if ( ! V_7 )
return false ;
if ( V_296 == 0 ) {
V_1 -> V_310 |= V_311 ;
...
return false ;
if ( ( V_24 & V_337 ) == 0 ) {
unsigned char V_338 [ 2 ] ;
V_1 -> V_310 = 0 ;
memcpy ( V_338 , & V_1 -> V_196 . V_209 , 2 ) ;
F_13 ( L_34 ,
F_15 ( V_1 ) ,
V_338 [ 0 ] , V_338 [ 1 ] ) ;
return false ;
}
V_1 -> V_4 . V_339 = ( 1 << 0 ) | ( 1 << 1 ) ;
return true ;
}
...
if ( V_147 & ( 1 << V_13 ) )
V_7 -> V_262 [ V_7 -> V_341 ++ ] = V_13 ;
V_7 -> V_259 =
F_122 ( V_10 , V_342 ,
L_35 , V_7 -> V_341 ) ;
if ( ! V_7 -> V_259 )
return false ;
for ( V_13 = 0 ; V_13 < V_7 -> V_341 ; V_13 ++ )
F_123 (
V_7 -> V_259 , V_13 ,
V_13 , V_343 [ V_7 -> V_262 [ V_13 ] ] ) ;
...
return false ;
V_7 -> V_267 = V_346 [ 0 ] ;
V_7 -> V_265 = V_346 [ 0 ] - V_38 ;
V_7 -> V_266 = V_7 -> V_265 ;
V_7 -> V_263 =
F_126 ( V_10 , 0 , L_36 , 0 , V_346 [ 0 ] ) ;
if ( ! V_7 -> V_263 )
return false ;
F_124 ( & V_6 -> V_4 ,
V_7 -> V_263 ,
...
return false ;
V_7 -> V_274 = V_346 [ 0 ] ;
V_7 -> V_272 = V_346 [ 0 ] - V_38 ;
V_7 -> V_273 = V_7 -> V_272 ;
V_7 -> V_270 =
F_126 ( V_10 , 0 , L_40 , 0 , V_346 [ 0 ] ) ;
if ( ! V_7 -> V_270 )
return false ;
F_124 ( & V_6 -> V_4 ,
V_7 -> V_270 ,
...
if ( F_82 ( V_7 ) )
return F_125 ( V_1 , V_7 , V_345 . V_240 ) ;
else if( F_83 ( V_7 ) )
return F_128 ( V_1 , V_7 , V_345 . V_240 ) ;
else
return true ;
}
static int F_129 ( struct V_382 * V_218 ,
struct V_21 * V_22 ,
int V_383 )
{
...
static T_1 F_130 ( struct V_382 * V_218 )
{
struct V_1 * V_211 = V_218 -> V_384 ;
...
struct V_1 * V_1 ;
int V_13 ;
V_1 = F_115 ( sizeof( struct V_1 ) , V_309 ) ;
if ( ! V_1 )
return false ;
V_1 -> V_16 = V_16 ;
