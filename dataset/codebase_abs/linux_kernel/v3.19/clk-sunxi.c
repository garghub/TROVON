...
goto V_84;
V_74 -> V_24 = V_24 ;
V_74 -> V_85 = V_29 -> div [ V_36 ] . V_74 ;
V_74 -> V_25 = & V_30 ;
V_70 = & V_74 -> V_17 ;
}
if ( V_29 -> div [ V_36 ] . V_86 ) {
V_76 = F_36 ( sizeof( * V_76 ) , V_58 ) ;
if ( ! V_76 )
goto V_87;
V_76 -> V_88 = 1 ;
V_76 -> div = V_29 -> div [ V_36 ] . V_86 ;
V_20 = & V_76 -> V_17 ;
V_72 = & V_89 ;
} else {
...
static void T_4 F_48 ( const struct V_93 * V_94 ,
void * V_95 )
{
struct V_26 * V_96 ;
const struct V_41 * V_29 ;
const struct V_93 * V_97 ;
void (* F_49)( struct V_26 * , const void * ) = V_95 ;
F_50 (np, clk_match, &match) {
V_29 = V_97 -> V_29 ;
F_49 ( V_96 , V_29 ) ;
}
}
static void T_4 F_51 ( const char * V_98 [] , int V_99 )
{
unsigned int V_36 ;
F_48 ( V_100 , F_18 ) ;
F_48 ( V_101 , F_27 ) ;
...
struct V_13 * V_13 = F_52 ( NULL , V_98 [ V_36 ] ) ;
if ( ! F_42 ( V_13 ) )
F_53 ( V_13 ) ;
}
}
...
static void T_4 F_58 ( struct V_26 * V_27 )
{
F_51 ( NULL , 0 ) ;
}
