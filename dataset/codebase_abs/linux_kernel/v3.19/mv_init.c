...
V_139 = V_39 ;
V_30 -> V_148 = F_43 ( T_2 , V_149 , V_150 ) ;
V_30 -> V_139 = V_139 ;
V_2 -> V_30 -> V_151 = V_152 ;
...
T_5 V_64 ;
for ( V_64 = 0 ; V_64 < V_2 -> V_11 -> V_12 ; V_64 ++ ) {
V_2 -> V_5 [ V_64 ] . V_153 = 0x5005043011ab0000ULL ;
V_2 -> V_5 [ V_64 ] . V_153 =
F_45 ( ( V_154 ) ( * ( V_154 * ) & V_2 -> V_5 [ V_64 ] . V_153 ) ) ;
}
memcpy ( V_2 -> V_26 , & V_2 -> V_5 [ 0 ] . V_153 , V_155 ) ;
}
static int F_46 ( struct V_106 * V_70 , const struct V_111 * V_112 )
{
unsigned int V_121 , V_156 = 0 ;
struct V_1 * V_2 ;
struct V_66 * V_157 ;
T_6 V_158 = F_13 ;
struct V_79 * V_30 = NULL ;
const struct V_123 * V_11 ;
F_39 ( V_159 , & V_70 -> V_42 ,
L_7 , V_160 ) ;
V_121 = F_47 ( V_70 ) ;
if ( V_121 )
goto V_161;
...
F_51 ( V_70 , F_33 ( V_30 ) ) ;
do {
V_2 = F_32 ( V_70 , V_112 , V_30 , V_156 ) ;
if ( ! V_2 ) {
V_121 = - V_165 ;
goto V_163;
}
memset ( & V_2 -> V_166 , 0xFF ,
sizeof( struct V_167 ) ) ;
F_44 ( V_2 ) ;
V_2 -> V_168 = V_156 ;
V_121 = V_57 -> V_169 ( V_2 ) ;
if ( V_121 ) {
F_3 ( V_2 ) ;
goto V_163;
}
V_156 ++ ;
} while ( V_156 < V_11 -> V_68 );
V_157 = (struct V_66 * ) ( F_33 ( V_30 ) -> V_67 ) ;
#ifdef F_14
F_52 ( & ( V_157 -> V_77 ) , F_10 ,
...
if ( V_121 )
goto V_170;
V_121 = F_55 ( V_70 -> V_71 , V_158 , V_171 ,
V_143 , F_33 ( V_30 ) ) ;
if ( V_121 )
goto V_172;
V_57 -> V_74 ( V_2 ) ;
...
static T_7
F_66 ( struct V_173 * V_174 ,
struct V_175 * V_176 , char * V_177 )
{
return snprintf ( V_177 , V_178 , L_8 , V_160 ) ;
}
static T_7
F_67 ( struct V_173 * V_174 ,
struct V_175 * V_176 ,
const char * V_177 , T_8 V_179 )
{
int V_180 = 0 ;
struct V_1 * V_2 = NULL ;
struct V_79 * V_30 = F_68 ( V_174 ) ;
struct V_29 * V_65 = F_33 ( V_30 ) ;
T_5 V_64 , V_63 ;
if ( V_177 == NULL )
return V_179 ;
if ( sscanf ( V_177 , L_9 , & V_180 ) != 1 )
return - V_181 ;
if ( V_180 >= 0x10000 ) {
F_69 ( L_10
L_11 , V_180 ) ;
...
static T_7 F_70 ( struct V_173 * V_174 ,
struct V_175 * V_176 , char * V_177 )
{
return snprintf ( V_177 , V_178 , L_13 , V_182 ) ;
}
