...
struct V_40 * F_75 ( int time , enum V_85 V_86 ,
T_1 V_87 , void * V_88 )
{
struct V_40 * V_89 ;
F_76 ( V_89 ) ;
...
V_100 = V_101 ;
while ( 1 ) {
F_48 ( V_104 , ( ! F_68 ( & V_103 ) ) ||
( V_100 == V_106 ) , & V_67 ) ;
if ( ( V_100 == V_106 ) && F_68 ( & V_103 ) )
break;
F_34 ( & V_99 ) ;
