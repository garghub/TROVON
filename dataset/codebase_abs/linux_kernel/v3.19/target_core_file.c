...
return - V_9 ;
V_137 = V_140 ;
while ( ( V_138 = F_59 ( & V_140 , L_44 ) ) != NULL ) {
if ( ! * V_138 )
continue;
...
struct V_1 * V_1 = F_1 ( V_3 ) ;
T_6 V_151 = 0 ;
V_151 = sprintf ( V_150 + V_151 , L_53 , V_1 -> V_59 ) ;
V_151 += sprintf ( V_150 + V_151 , L_54 ,
V_1 -> V_28 , V_1 -> V_63 ,
( V_1 -> V_21 & V_27 ) ?
L_55 : L_56 ) ;
return V_151 ;
...
{
struct V_163 * V_164 = & V_165 . V_166 ;
F_74 ( & V_165 ) ;
