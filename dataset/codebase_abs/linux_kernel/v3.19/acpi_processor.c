...
sprintf ( F_29 ( V_33 ) , L_15 , V_20 -> V_28 ) ;
...
struct V_33 * V_2 ;
int V_17 = 0 ;
V_20 = F_34 ( sizeof( struct V_19 ) , V_60 ) ;
if ( ! V_20 )
return - V_61 ;
if ( ! F_35 ( & V_20 -> V_54 . V_62 , V_60 ) ) {
V_17 = - V_61 ;
goto V_63;
}
V_20 -> V_26 = V_33 -> V_26 ;
strcpy ( F_36 ( V_33 ) , V_64 ) ;
strcpy ( F_37 ( V_33 ) , V_65 ) ;
V_33 -> V_66 = V_20 ;
V_17 = F_19 ( V_33 ) ;
if ( V_17 )
return 0 ;
...
#endif
F_39 ( V_20 -> V_28 >= V_68 ) ;
if ( F_40 ( V_69 , V_20 -> V_28 ) != NULL &&
F_40 ( V_69 , V_20 -> V_28 ) != V_33 ) {
F_41 ( & V_33 -> V_2 ,
L_21 ,
V_20 -> V_28 ) ;
goto V_70;
