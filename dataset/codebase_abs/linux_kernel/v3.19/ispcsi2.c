...
V_157 = V_159 -> V_164 ;
V_4 -> V_47 = 0 ;
F_38 ( V_159 , V_159 , V_165 , & V_4 -> V_47 ) ;
...
V_4 -> V_55 [ 0 ] . V_85 = V_4 -> V_171 . V_173 ;
V_4 -> V_55 [ 0 ] . V_66 = 1 ;
V_4 -> V_55 [ 0 ] . V_68 = 1 ;
F_29 ( V_2 , V_4 , 1 ) ;
F_24 ( V_2 , V_4 , 1 ) ;
...
{
struct V_192 * V_193 = F_54 ( & V_4 -> V_194 . V_163 ) ;
T_2 V_195 , V_196 ;
struct V_1 * V_2 = V_4 -> V_2 ;
if ( ! V_4 -> V_136 )
return;
...
unsigned int V_161 , enum V_206 V_207 )
{
if ( V_207 == V_208 )
return F_59 ( V_205 , V_161 ) ;
else
...
switch ( V_161 ) {
case V_28 :
for ( V_95 = 0 ; V_95 < F_61 ( V_213 ) ; V_95 ++ ) {
if ( V_26 -> V_32 == V_213 [ V_95 ] )
break;
}
if ( V_95 >= F_61 ( V_213 ) )
V_26 -> V_32 = V_33 ;
...
case V_170 :
V_209 = V_26 -> V_32 ;
V_210 = F_58 ( V_4 , V_205 , V_28 , V_207 ) ;
...
static int F_64 ( struct V_158 * V_221 ,
struct V_204 * V_205 ,
struct V_222 * V_32 )
{
...
static int F_66 ( struct V_158 * V_221 ,
struct V_204 * V_205 ,
struct V_225 * V_226 )
{
struct V_3 * V_4 = F_65 ( V_221 ) ;
...
V_210 . V_214 = 1 ;
V_210 . V_215 = 1 ;
F_60 ( V_4 , V_205 , V_226 -> V_161 , & V_210 , V_208 ) ;
...
static int F_67 ( struct V_158 * V_221 , struct V_204 * V_205 ,
struct V_231 * V_26 )
{
struct V_3 * V_4 = F_65 ( V_221 ) ;
struct V_25 * V_210 ;
V_210 = F_58 ( V_4 , V_205 , V_26 -> V_161 , V_26 -> V_207 ) ;
if ( V_210 == NULL )
return - V_224 ;
V_26 -> V_210 = * V_210 ;
return 0 ;
}
static int F_68 ( struct V_158 * V_221 , struct V_204 * V_205 ,
struct V_231 * V_26 )
{
struct V_3 * V_4 = F_65 ( V_221 ) ;
struct V_25 * V_210 ;
...
if ( V_210 == NULL )
return - V_224 ;
F_60 ( V_4 , V_205 , V_26 -> V_161 , & V_26 -> V_210 , V_26 -> V_207 ) ;
* V_210 = V_26 -> V_210 ;
if ( V_26 -> V_161 == V_28 ) {
V_210 = F_58 ( V_4 , V_205 , V_170 ,
V_26 -> V_207 ) ;
* V_210 = V_26 -> V_210 ;
F_60 ( V_4 , V_205 , V_170 , V_210 , V_26 -> V_207 ) ;
}
return 0 ;
}
static int F_69 ( struct V_158 * V_221 , struct V_204 * V_205 )
{
struct V_231 V_210 ;
memset ( & V_210 , 0 , sizeof( V_210 ) ) ;
V_210 . V_161 = V_28 ;
V_210 . V_207 = V_205 ? V_208 : V_232 ;
V_210 . V_210 . V_32 = V_33 ;
V_210 . V_210 . V_214 = 4096 ;
V_210 . V_210 . V_215 = 4096 ;
F_68 ( V_221 , V_205 , & V_210 ) ;
return 0 ;
}
static int F_70 ( struct V_158 * V_221 , int V_5 )
{
struct V_3 * V_4 = F_65 ( V_221 ) ;
struct V_1 * V_2 = V_4 -> V_2 ;
struct V_199 * V_171 = & V_4 -> V_171 ;
switch ( V_5 ) {
case V_233 :
if ( F_71 ( V_4 -> V_138 ) < 0 )
return - V_137 ;
...
static int F_77 ( struct V_239 * V_163 ,
const struct V_160 * V_240 ,
const struct V_160 * V_241 , T_2 V_242 )
{
struct V_158 * V_221 = F_37 ( V_163 ) ;
struct V_3 * V_4 = F_65 ( V_221 ) ;
struct V_6 * V_8 = & V_4 -> V_8 ;
switch ( V_240 -> V_223 | F_78 ( V_241 -> V_163 ) ) {
case V_170 | V_243 :
if ( V_242 & V_244 ) {
if ( V_4 -> V_43 & ~ V_45 )
return - V_140 ;
...
{
int V_248 ;
V_248 = F_83 ( V_247 , & V_4 -> V_194 ) ;
if ( V_248 < 0 )
goto error;
V_248 = F_84 ( & V_4 -> V_171 , V_247 ) ;
if ( V_248 < 0 )
goto error;
return 0 ;
error:
...
{
struct V_158 * V_221 = & V_4 -> V_194 ;
struct V_160 * V_162 = V_4 -> V_162 ;
struct V_239 * V_249 = & V_221 -> V_163 ;
int V_248 ;
F_86 ( V_221 , & V_250 ) ;
V_221 -> V_251 = & V_252 ;
...
F_88 ( V_221 , V_4 ) ;
V_221 -> V_242 |= V_254 ;
V_162 [ V_170 ] . V_242 = V_255 ;
V_162 [ V_28 ] . V_242 = V_256
| V_257 ;
V_249 -> V_258 = & V_259 ;
V_248 = F_89 ( V_249 , V_260 , V_162 , 0 ) ;
if ( V_248 < 0 )
return V_248 ;
F_69 ( V_221 , NULL ) ;
V_4 -> V_171 . type = V_261 ;
V_4 -> V_171 . V_258 = & V_262 ;
V_4 -> V_171 . V_263 = 32 ;
V_4 -> V_171 . V_264 = 1 ;
V_4 -> V_171 . V_265 = 0x1ffe0 ;
V_4 -> V_171 . V_2 = V_4 -> V_2 ;
V_4 -> V_171 . V_266 = F_90 ( 4096 * 4096 ) * 3 ;
V_248 = F_91 ( & V_4 -> V_171 , L_18 ) ;
if ( V_248 < 0 )
goto V_267;
V_248 = F_92 ( & V_4 -> V_194 . V_163 , V_170 ,
& V_4 -> V_171 . V_200 . V_163 , 0 , 0 ) ;
if ( V_248 < 0 )
goto V_268;
return 0 ;
V_268:
