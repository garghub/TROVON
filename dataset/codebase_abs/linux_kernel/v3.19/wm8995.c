...
static int F_46 ( struct V_446 * V_447 )
{
struct V_69 * V_70 ;
int V_28 ;
V_70 = F_47 ( & V_447 -> V_9 , sizeof( * V_70 ) , V_448 ) ;
if ( ! V_70 )
return - V_449 ;
F_48 ( V_447 , V_70 ) ;
V_70 -> V_411 = F_49 ( V_447 , & V_450 ) ;
if ( F_50 ( V_70 -> V_411 ) ) {
V_28 = F_51 ( V_70 -> V_411 ) ;
F_13 ( & V_447 -> V_9 , L_42 , V_28 ) ;
return V_28 ;
}
V_28 = F_52 ( & V_447 -> V_9 ,
& V_451 , V_452 ,
...
static int F_53 ( struct V_446 * V_447 )
{
F_54 ( & V_447 -> V_9 ) ;
return 0 ;
}
static int F_55 ( struct V_453 * V_454 ,
const struct V_455 * V_299 )
{
struct V_69 * V_70 ;
int V_28 ;
V_70 = F_47 ( & V_454 -> V_9 , sizeof( * V_70 ) , V_448 ) ;
if ( ! V_70 )
return - V_449 ;
F_56 ( V_454 , V_70 ) ;
V_70 -> V_411 = F_57 ( V_454 , & V_450 ) ;
if ( F_50 ( V_70 -> V_411 ) ) {
V_28 = F_51 ( V_70 -> V_411 ) ;
...
F_28 ( V_452 ) ) ;
if ( V_28 < 0 )
F_13 ( & V_454 -> V_9 , L_43 , V_28 ) ;
return V_28 ;
}
static int F_58 ( struct V_453 * V_456 )
{
F_54 ( & V_456 -> V_9 ) ;
return 0 ;
}
