...
static int F_32 ( struct V_140 * V_141 , const struct V_142 * V_143 ,
unsigned int * V_144 , unsigned int * V_145 ,
unsigned int V_146 [] , void * V_147 [] )
{
struct V_1 * V_2 = V_141 -> V_148 ;
V_2 -> V_125 . V_149 = V_150 ;
V_2 -> V_125 . V_151 = V_152 ;
* V_145 = 1 ;
V_146 [ 0 ] = V_150 * V_152 ;
V_147 [ 0 ] = V_2 -> V_153 ;
* V_144 = V_154 ;
...
{
struct V_1 * V_2 = V_156 -> V_140 -> V_148 ;
struct V_157 * V_158 =
F_34 ( V_156 , struct V_157 , V_156 ) ;
return F_35 ( V_158 , & V_2 -> V_125 ) ;
}
static void F_36 ( struct V_155 * V_156 )
{
struct V_1 * V_2 = V_156 -> V_140 -> V_148 ;
struct V_157 * V_158 = F_34 ( V_156 ,
struct V_157 , V_156 ) ;
F_37 ( V_2 , V_158 ) ;
}
...
struct V_157 * V_158 = F_34 ( V_156 ,
struct V_157 , V_156 ) ;
F_39 ( & V_2 -> V_125 , V_158 ) ;
}
static int F_40 ( struct V_140 * V_141 , unsigned int V_159 )
{
struct V_1 * V_2 = V_141 -> V_148 ;
struct V_160 * V_161 = & V_2 -> V_125 . V_162 ;
unsigned long V_163 ;
int V_164 ;
V_164 = F_30 ( V_2 , 1 ) ;
if ( V_164 == 0 ) {
struct V_157 * V_158 = F_41 ( V_161 -> V_165 . V_166 ,
struct V_157 , V_167 ) ;
F_42 ( & V_2 -> V_125 , V_161 , V_158 ) ;
return 0 ;
}
F_43 ( & V_2 -> V_168 , V_163 ) ;
while ( ! F_44 ( & V_161 -> V_165 ) ) {
struct V_157 * V_158 = F_41 ( V_161 -> V_165 . V_166 ,
struct V_157 , V_167 ) ;
F_45 ( & V_158 -> V_167 ) ;
F_46 ( & V_158 -> V_156 , V_169 ) ;
}
F_47 ( & V_2 -> V_168 , V_163 ) ;
return V_164 ;
}
...
static int F_50 ( struct V_171 * V_171 , void * V_86 , T_4 * V_123 )
{
struct V_1 * V_2 = F_51 ( V_171 ) ;
* V_123 = V_2 -> V_172 ;
return 0 ;
}
static int F_52 ( struct V_171 * V_171 , void * V_86 , T_4 V_123 )
{
struct V_1 * V_2 = F_51 ( V_171 ) ;
unsigned int V_93 ;
int V_164 ;
for ( V_93 = 0 ; V_93 < F_53 ( V_173 ) ; V_93 ++ )
if ( V_123 & V_173 [ V_93 ] . V_123 )
break;
if ( V_93 == F_53 ( V_173 ) )
return - V_174 ;
V_164 = F_54 ( V_2 , V_123 ) ;
if ( ! V_164 )
V_2 -> V_122 = V_173 [ V_93 ] ;
return V_164 ;
}
static int F_55 ( struct V_171 * V_171 , void * V_86 ,
struct V_175 * V_93 )
{
struct V_1 * V_2 = F_51 ( V_171 ) ;
F_2 ( 1 , L_1 , V_4 ) ;
return F_56 ( V_2 , V_93 ) ;
}
static int F_57 ( struct V_171 * V_171 , void * V_86 , unsigned int * V_93 )
{
return F_58 ( V_171 , V_86 , V_93 ) ;
}
static int F_59 ( struct V_171 * V_171 , void * V_86 , unsigned int V_93 )
{
return F_60 ( V_171 , V_86 , V_93 ) ;
}
static int F_61 ( struct V_171 * V_171 , void * V_86 ,
struct V_176 * V_177 )
{
struct V_1 * V_2 = F_51 ( V_171 ) ;
if ( V_2 -> V_178 == V_179 )
...
if ( 0 != V_177 -> V_180 )
return - V_174 ;
strcpy ( V_177 -> V_181 , L_76 ) ;
F_62 ( V_2 , V_182 , V_183 , V_177 ) ;
F_2 ( 1 , L_77 , V_177 -> type ) ;
return 0 ;
}
static int F_63 ( struct V_171 * V_171 , void * V_86 ,
const struct V_176 * V_177 )
{
struct V_1 * V_2 = F_51 ( V_171 ) ;
if ( V_2 -> V_178 == V_179 )
return - V_174 ;
F_62 ( V_2 , V_182 , V_184 , V_177 ) ;
return 0 ;
}
...
F_62 ( V_2 , V_182 , V_190 , V_186 ) ;
return 0 ;
}
static int F_65 ( struct V_171 * V_171 , void * V_86 ,
const struct V_185 * V_186 )
{
return F_66 ( V_171 , V_86 , V_186 ) ;
}
static int F_67 ( struct V_171 * V_171 , void * V_86 ,
struct V_191 * V_192 )
{
struct V_1 * V_2 = F_51 ( V_171 ) ;
struct V_193 * V_194 = & V_2 -> V_125 ;
F_68 ( V_192 -> V_195 , V_2 -> V_181 , sizeof( V_192 -> V_195 ) ) ;
F_68 ( V_192 -> V_196 , V_197 [ V_194 -> V_2 -> V_198 ] . V_181 ,
sizeof( V_192 -> V_196 ) ) ;
sprintf ( V_192 -> V_199 , L_78 , F_69 ( V_2 -> V_118 ) ) ;
V_192 -> V_200 =
V_201 |
V_202 |
V_203 |
...
static int F_70 ( struct V_171 * V_171 , void * V_86 ,
struct V_205 * V_186 )
{
if ( V_186 -> V_180 != 0 )
return - V_174 ;
F_68 ( V_186 -> V_206 , L_79 , sizeof( V_186 -> V_206 ) ) ;
V_186 -> V_207 = V_208 ;
return 0 ;
}
...
{
struct V_1 * V_2 = F_51 ( V_171 ) ;
V_186 -> V_143 . V_209 . V_207 = V_208 ;
V_186 -> V_143 . V_209 . V_210 = 0 ;
V_186 -> V_143 . V_209 . V_211 =
V_2 -> V_125 . V_149 * V_2 -> V_125 . V_151 ;
V_186 -> V_143 . V_209 . V_212 = 0 ;
V_186 -> V_143 . V_209 . V_127 = V_2 -> V_125 . V_127 ;
V_186 -> V_143 . V_209 . V_126 = V_2 -> V_125 . V_126 ;
V_186 -> V_143 . V_209 . V_213 = V_214 ;
F_2 ( 1 , L_80 ,
...
V_186 -> V_143 . V_209 . V_213 = V_214 ;
F_2 ( 1 , L_82 ,
V_186 -> V_143 . V_209 . V_127 , V_186 -> V_143 . V_209 . V_126 , V_186 -> V_143 . V_209 . V_213 ) ;
return 0 ;
}
...
struct V_1 * V_2 = F_51 ( V_171 ) ;
char V_181 [ 32 + 2 ] ;
snprintf ( V_181 , sizeof( V_181 ) , L_83 , V_2 -> V_181 ) ;
F_62 ( V_2 , V_215 , V_216 ) ;
F_75 ( & V_2 -> V_128 . V_217 , V_181 ) ;
return 0 ;
}
...
F_79 ( V_2 -> V_218 ) ;
F_80 ( & V_2 -> V_128 . V_217 ) ;
V_2 -> V_218 = NULL ;
}
}
static struct V_219 * F_81 (
struct V_193 * V_194 ,
struct V_220 * V_118 ,
struct V_219 * V_221 ,
char * type )
...
return NULL ;
* V_222 = * V_221 ;
snprintf ( V_222 -> V_181 , sizeof( V_222 -> V_181 ) , L_84 ,
...
struct V_140 * V_141 ;
F_2 ( 1 , L_1 , V_4 ) ;
if ( V_197 [ V_2 -> V_198 ] . V_226 != V_227 )
return V_100 ;
V_2 -> V_122 = V_173 [ 0 ] ;
if ( V_2 -> V_122 . V_123 & V_124 )
V_194 -> V_126 = 480 ;
...
V_100 = F_84 ( & V_2 -> V_128 , 50 ) ;
if ( V_100 )
return V_100 ;
V_2 -> V_128 . V_86 = V_2 ;
V_2 -> V_128 . V_230 = F_22 ;
F_85 ( & V_2 -> V_128 , V_194 -> V_126 == 576 ) ;
F_86 ( & V_2 -> V_231 , & V_2 -> V_128 . V_217 , NULL ) ;
V_2 -> V_218 = F_81 ( V_194 ,
V_2 -> V_118 , & V_232 , L_85 ) ;
V_141 = & V_2 -> V_233 ;
V_141 -> type = V_234 ;
V_141 -> V_235 = V_236 | V_237 | V_238 | V_239 ;
V_141 -> V_240 = V_241 ;
V_141 -> V_242 = 2 ;
V_141 -> V_148 = V_2 ;
V_141 -> V_243 = sizeof( struct V_157 ) ;
V_141 -> V_244 = & V_245 ;
V_141 -> V_246 = & V_247 ;
V_141 -> V_248 = V_249 ;
V_141 -> V_250 = & V_2 -> V_250 ;
V_100 = F_87 ( V_141 ) ;
if ( V_100 < 0 )
return V_100 ;
F_88 ( V_2 -> V_218 , V_2 ) ;
V_2 -> V_218 -> V_250 = & V_2 -> V_250 ;
V_2 -> V_218 -> V_167 = V_141 ;
V_100 = F_89 ( V_2 -> V_218 ,
V_251 , - 1 ) ;
if ( V_100 < 0 ) {
F_20 ( V_252 L_86 , V_2 -> V_181 ) ;
return V_100 ;
}
F_20 ( V_252 L_87 ,
V_2 -> V_181 , F_90 ( V_2 -> V_218 ) ) ;
F_30 ( V_2 , 0 ) ;
return 0 ;
}
