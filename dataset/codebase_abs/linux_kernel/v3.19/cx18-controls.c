...
int V_29 = V_7 == V_30 ;
struct V_31 V_3 ;
V_3 . V_32 = V_2 -> V_32 / ( V_29 ? 2 : 1 ) ;
V_3 . V_33 = V_2 -> V_33 ;
V_3 . V_34 = V_35 ;
F_11 ( V_5 -> V_36 , V_37 , V_38 , & V_3 ) ;
return 0 ;
}
static int F_12 ( struct V_1 * V_2 , T_1 V_39 )
{
static const T_1 V_40 [ 3 ] = { 44100 , 48000 , 32000 } ;
struct V_4 * V_5 = F_2 ( V_2 , struct V_4 , V_2 ) ;
if ( V_39 < F_13 ( V_40 ) )
F_14 ( V_5 , V_41 , V_42 , V_40 [ V_39 ] ) ;
return 0 ;
}
