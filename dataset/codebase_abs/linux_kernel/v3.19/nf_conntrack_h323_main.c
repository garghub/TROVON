...
unsigned int V_207 )
{
if ( ! exp || ! F_57 ( & exp -> V_207 ) )
return 0 ;
exp -> V_207 . V_208 = V_209 + V_207 * V_210 ;
F_58 ( & exp -> V_207 ) ;
return 1 ;
}
...
exp -> V_63 = V_64 ;
V_211 = F_15 ( V_213 ) ;
if ( V_211 && F_8 ( V_5 ) == V_58 &&
V_5 -> V_59 & V_60 ) {
V_43 = V_211 ( V_2 , V_5 , V_7 , V_3 , V_8 ,
V_28 , V_152 , V_31 , exp ) ;
} else {
if ( F_16 ( exp ) == 0 ) {
F_6 ( L_38 ) ;
F_17 ( & exp -> V_51 ) ;
V_12 -> V_214 [ V_13 ] = V_31 ;
} else
V_43 = - 1 ;
}
F_14 ( exp ) ;
...
enum V_6 V_7 ,
unsigned int V_3 ,
unsigned char * * V_8 , T_18 * V_215 )
{
F_10 (set_ras_addr_hook) V_216 ;
F_6 ( L_39 ) ;
V_216 = F_15 ( V_217 ) ;
if ( V_216 && F_8 ( V_5 ) == V_58 &&
V_5 -> V_59 & V_60 )
return V_216 ( V_2 , V_5 , V_7 , V_3 , V_8 ,
& V_215 -> V_218 , 1 ) ;
return 0 ;
}
...
struct V_46 * exp ;
F_6 ( L_40 ) ;
if ( ! F_29 ( V_5 , * V_8 , & V_219 -> V_218 , & V_30 , & V_31 ) )
return 0 ;
if ( ! memcmp ( & V_30 , & V_5 -> V_50 [ V_13 ] . V_51 . V_52 . V_53 , sizeof( V_30 ) ) &&
V_31 == V_5 -> V_50 [ V_13 ] . V_51 . V_52 . V_159 . V_220 . V_31 )
return 0 ;
if ( F_62 ( V_221 , & V_5 -> V_59 ) )
return 0 ;
if ( ( exp = F_12 ( V_5 ) ) == NULL )
return - 1 ;
F_13 ( exp , V_54 , F_8 ( V_5 ) ,
...
if ( V_216 && F_8 ( V_5 ) == V_58 &&
V_5 -> V_59 & V_60 ) {
V_43 = V_216 ( V_2 , V_5 , V_7 , V_3 , V_8 ,
V_223 -> V_218 . V_166 ,
V_223 -> V_218 . V_165 ) ;
if ( V_43 < 0 )
return - 1 ;
...
if ( V_223 -> V_67 & V_225 ) {
F_6 ( L_43 , V_223 -> V_226 ) ;
V_12 -> V_207 = V_223 -> V_226 ;
} else
V_12 -> V_207 = V_227 ;
return 0 ;
}
...
enum V_6 V_7 ,
unsigned int V_3 ,
unsigned char * * V_8 , T_21 * V_228 )
{
struct V_11 * V_12 = F_2 ( V_5 ) ;
int V_13 = F_3 ( V_7 ) ;
int V_43 ;
struct V_46 * exp ;
F_10 (set_sig_addr_hook) V_229 ;
F_6 ( L_44 ) ;
V_229 = F_15 ( V_230 ) ;
if ( V_229 && F_8 ( V_5 ) == V_58 &&
V_5 -> V_59 & V_60 ) {
V_43 = V_229 ( V_2 , V_5 , V_7 , V_3 , V_8 ,
V_228 -> V_224 . V_166 ,
V_228 -> V_224 . V_165 ) ;
if ( V_43 < 0 )
return - 1 ;
...
if ( V_228 -> V_67 & V_231 ) {
F_6 ( L_45 , V_228 -> V_226 ) ;
V_12 -> V_207 = V_228 -> V_226 ;
}
if ( V_12 -> V_207 > 0 ) {
F_6 ( L_46
L_47 , V_12 -> V_207 ) ;
F_65 ( V_5 , V_2 , V_12 -> V_207 * V_210 ) ;
F_25 ( & V_232 ) ;
...
V_12 -> V_214 [ V_13 ] = 0 ;
V_12 -> V_214 [ ! V_13 ] = 0 ;
F_65 ( V_5 , V_2 , 30 * V_210 ) ;
return 0 ;
}
static int F_68 ( struct V_1 * V_2 , struct V_4 * V_5 ,
enum V_6 V_7 ,
unsigned int V_3 ,
unsigned char * * V_8 , T_23 * V_234 )
{
...
V_153 = F_15 ( V_156 ) ;
if ( ( V_234 -> V_67 & V_235 ) &&
F_29 ( V_5 , * V_8 , & V_234 -> V_158 ,
& V_30 , & V_31 ) &&
! memcmp ( & V_30 , & V_5 -> V_50 [ V_13 ] . V_51 . V_52 . V_53 , sizeof( V_30 ) ) &&
V_31 == V_12 -> V_214 [ V_13 ] &&
F_8 ( V_5 ) == V_58 &&
V_153 && V_5 -> V_59 & V_60 ) {
...
if ( V_229 && F_8 ( V_5 ) == V_58 &&
V_5 -> V_59 & V_60 )
return V_229 ( V_2 , V_5 , V_7 , V_3 , V_8 ,
& V_238 -> V_158 , 1 ) ;
return 0 ;
}
if ( ( exp = F_12 ( V_5 ) ) == NULL )
...
if ( F_73 ( V_2 , V_5 , V_7 , V_3 , & V_8 , & V_243 ) < 0 )
goto V_118;
V_264:
F_27 ( & V_116 ) ;
return V_115 ;
