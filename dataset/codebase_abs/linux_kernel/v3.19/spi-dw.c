...
if ( ! V_6 -> V_41 ) {
T_5 V_140 ;
for ( V_140 = 2 ; V_140 <= 256 ; V_140 ++ ) {
F_18 ( V_6 , V_20 , V_140 ) ;
if ( V_140 != F_13 ( V_6 , V_20 ) )
break;
}
V_6 -> V_41 = ( V_140 == 2 ) ? 0 : V_140 - 1 ;
F_18 ( V_6 , V_20 , 0 ) ;
}
}
int F_49 ( struct V_141 * V_14 , struct V_5 * V_6 )
{
struct V_127 * V_13 ;
int V_10 ;
F_50 ( V_6 == NULL ) ;
...
snprintf ( V_6 -> V_146 , sizeof( V_6 -> V_146 ) , L_23 , V_6 -> V_147 ) ;
V_10 = F_52 ( V_14 , V_6 -> V_87 , F_35 , V_148 ,
V_6 -> V_146 , V_6 ) ;
if ( V_10 < 0 ) {
F_29 ( & V_13 -> V_14 , L_24 ) ;
goto V_149;
