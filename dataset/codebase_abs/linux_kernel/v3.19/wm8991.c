...
unsigned int V_13 ;
int V_12 ;
V_105 = F_23 ( & V_129 -> V_2 , sizeof( * V_105 ) , V_132 ) ;
if ( ! V_105 )
return - V_133 ;
V_105 -> V_114 = F_24 ( V_129 , & V_134 ) ;
if ( F_25 ( V_105 -> V_114 ) )
return F_26 ( V_105 -> V_114 ) ;
F_27 ( V_129 , V_105 ) ;
V_12 = F_28 ( V_105 -> V_114 , V_4 , & V_13 ) ;
if ( V_12 != 0 ) {
F_29 ( & V_129 -> V_2 , L_6 , V_12 ) ;
return V_12 ;
}
if ( V_13 != 0x8991 ) {
F_29 ( & V_129 -> V_2 , L_7 , V_13 ) ;
return - V_67 ;
}
V_12 = F_30 ( V_105 -> V_114 , V_4 , 0 ) ;
if ( V_12 < 0 ) {
F_29 ( & V_129 -> V_2 , L_8 , V_12 ) ;
return V_12 ;
}
F_31 ( V_105 -> V_114 , V_135 ,
V_136 , V_136 ) ;
F_31 ( V_105 -> V_114 , V_137 ,
V_138 , 1 ) ;
F_31 ( V_105 -> V_114 , V_108 ,
V_139 | V_109 ,
V_139 | V_109 ) ;
F_31 ( V_105 -> V_114 , V_48 ,
V_140 , V_140 ) ;
F_30 ( V_105 -> V_114 , V_100 , 0 ) ;
F_30 ( V_105 -> V_114 , V_141 ,
0x50 | ( 1 << 8 ) ) ;
F_30 ( V_105 -> V_114 , V_142 ,
0x50 | ( 1 << 8 ) ) ;
V_12 = F_32 ( & V_129 -> V_2 ,
& V_143 , & V_144 , 1 ) ;
return V_12 ;
}
static int F_33 ( struct V_128 * V_145 )
{
F_34 ( & V_145 -> V_2 ) ;
return 0 ;
}
