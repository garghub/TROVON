...
T_1 V_180 = 100 ;
F_18 ( V_9 , V_181 , 0xff ) ;
V_9 -> V_182 . V_183 = F_19 ( V_9 , V_184 ) ;
if ( V_178 -> V_185 != true ) {
T_3 V_131 ;
...
bool F_58 ( struct V_8 * V_9 )
{
bool V_190 ;
V_190 = ( F_19 ( V_9 , V_189 + 2 ) & F_33 ( 0 ) ) ? true : false ;
return V_190 ;
}
void F_59 ( struct V_8 * V_9 , T_2 V_191 )
{
...
void F_61 ( struct V_8 * V_9 , T_3 V_199 )
{
F_40 ( V_9 , V_152 , V_199 ) ;
}
void F_62 ( struct V_8 * V_9 , T_3 V_200 )
{
F_40 ( V_9 , V_153 , V_200 ) ;
}
void F_63 ( struct V_8 * V_9 , T_3 V_201 )
{
struct V_44 * V_45 = F_17 ( V_9 ) ;
V_45 -> V_202 = V_201 ;
F_40 ( V_9 , V_154 , V_201 ) ;
}
void F_64 ( struct V_8 * V_9 , T_3 V_203 )
{
F_40 ( V_9 , V_155 , V_203 ) ;
}
void F_65 ( struct V_8 * V_9 , T_1 V_123 )
{
F_18 ( V_9 , V_204 , V_123 ) ;
}
void F_66 ( struct V_8 * V_9 , T_3 V_205 )
{
struct V_44 * V_45 = F_17 ( V_9 ) ;
struct V_206 * V_207 = & V_45 -> V_208 . V_209 ;
if ( V_205 == 0xff )
F_67 ( & V_45 -> V_208 , V_207 -> V_210 ) ;
else {
V_207 -> V_210 = V_207 -> V_211 ;
F_67 ( & V_45 -> V_208 , V_205 ) ;
}
}
...
void F_70 ( struct V_8 * V_9 , T_3 V_123 )
{
struct V_44 * V_45 = F_17 ( V_9 ) ;
if ( V_123 == V_214 )
...
void F_72 ( struct V_8 * V_9 , T_1 V_123 )
{
F_18 ( V_9 , V_217 , V_123 ) ;
}
T_1 F_73 ( struct V_8 * V_9 )
{
struct V_44 * V_45 = F_17 ( V_9 ) ;
return V_45 -> V_218 ;
}
bool F_74 ( struct V_8 * V_9 )
{
bool V_190 ;
T_3 V_219 ;
if ( ( V_9 -> V_220 == true ) ||
