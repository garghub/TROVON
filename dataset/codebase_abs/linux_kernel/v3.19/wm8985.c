...
V_152 = F_31 ( V_64 -> V_2 , F_17 ( V_117 -> V_173 ) ,
V_117 -> V_173 ) ;
if ( V_152 ) {
...
static int F_32 ( struct V_188 * V_189 )
{
struct V_116 * V_117 ;
int V_152 ;
V_117 = F_33 ( & V_189 -> V_2 , sizeof *V_117 , V_190 ) ;
if ( ! V_117 )
return - V_191 ;
F_34 ( V_189 , V_117 ) ;
V_117 -> V_174 = F_35 ( V_189 , & V_192 ) ;
if ( F_36 ( V_117 -> V_174 ) ) {
V_152 = F_37 ( V_117 -> V_174 ) ;
F_11 ( & V_189 -> V_2 , L_18 ,
V_152 ) ;
return V_152 ;
}
V_152 = F_38 ( & V_189 -> V_2 ,
& V_193 , & V_194 , 1 ) ;
return V_152 ;
}
...
static int F_41 ( struct V_195 * V_196 ,
const struct V_197 * V_198 )
{
struct V_116 * V_117 ;
int V_152 ;
V_117 = F_33 ( & V_196 -> V_2 , sizeof *V_117 , V_190 ) ;
if ( ! V_117 )
return - V_191 ;
F_42 ( V_196 , V_117 ) ;
V_117 -> V_174 = F_43 ( V_196 , & V_192 ) ;
if ( F_36 ( V_117 -> V_174 ) ) {
V_152 = F_37 ( V_117 -> V_174 ) ;
F_11 ( & V_196 -> V_2 , L_18 ,
V_152 ) ;
