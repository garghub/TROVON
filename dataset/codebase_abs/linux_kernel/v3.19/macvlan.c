...
static int F_202 ( struct V_235 * V_236 ,
unsigned long V_237 , void * V_238 )
{
struct V_5 * V_6 = F_203 ( V_238 ) ;
...
if ( V_6 -> V_248 != V_249 )
break;
F_209 (vlan, next, &port->vlans, list)
