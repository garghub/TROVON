...
V_5 -> V_40 = V_22 -> V_41 ( V_22 , F_17 ( V_5 -> V_30 . V_36 ) ) ;
else
V_5 -> V_40 = V_22 -> V_41 ( V_22 , F_18 ( V_5 -> V_30 . V_36 ) ) ;
V_5 -> V_42 = V_5 -> V_40 ;
V_29 = F_19 ( V_20 , V_5 -> V_30 . V_35 , & V_27 , & V_28 , & V_26 ) ;
if ( ! V_29 ) {
F_16 ( L_2 ) ;
memset ( & V_26 , 0x00 , sizeof( V_26 ) ) ;
V_26 . type = V_43 ;
}
V_8 = F_20 ( V_10 , V_11 , V_44 ,
& V_26 , V_5 -> V_30 . V_35 ,
(struct V_1 * * ) & V_5 -> V_6 ) ;
if ( V_8 < 0 ) {
F_21 ( L_3 , V_8 ) ;
