...
static int T_3 F_45 ( struct V_89 * V_10 )
{
...
static int T_3 F_49 ( struct V_89 * V_10 )
{
struct V_1 * V_2 = F_46 ( V_10 ) ;
F_47 ( & V_2 -> V_66 -> V_90 ) ;
if ( V_2 -> V_66 -> V_91 )
...
struct V_89 * V_10 , int V_48 , T_4 V_94 )
{
const struct V_95 * V_17 = F_54 ( V_10 ) ;
struct V_1 * V_2 ;
struct V_65 * V_65 ;
int error ;
if ( ! V_17 || ! V_17 -> V_96 || V_48 <= 0 ) {
error = - V_97 ;
goto V_98;
}
V_2 = F_55 ( sizeof( * V_2 ) + V_94 , V_99 ) ;
V_65 = F_56 () ;
if ( ! V_2 || ! V_65 ) {
error = - V_100 ;
goto V_101;
...
V_2 -> V_48 = V_48 ;
F_57 ( & V_2 -> V_45 ) ;
snprintf ( V_2 -> V_102 , sizeof( V_2 -> V_102 ) , L_5 , F_58 ( V_10 ) ) ;
if ( V_17 -> V_103 ) {
error = V_17 -> V_103 () ;
if ( error ) {
F_38 ( V_2 -> V_10 , L_6 ,
