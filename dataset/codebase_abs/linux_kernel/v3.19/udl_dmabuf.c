...
{
return F_31 ( V_21 , & V_47 , V_21 -> V_9 , V_46 , NULL ) ;
}
static int F_32 ( struct V_22 * V_4 ,
T_1 V_9 ,
struct V_15 * V_33 ,
struct V_20 * * V_48 )
{
...
V_49 = V_9 / V_32 ;
* V_48 = NULL ;
V_21 = F_33 ( V_4 , V_49 * V_32 ) ;
if ( ! V_21 )
return - V_11 ;
V_21 -> V_33 = V_33 ;
V_21 -> V_31 = F_34 ( V_49 , sizeof( struct V_50 * ) ) ;
if ( V_21 -> V_31 == NULL ) {
F_12 ( L_8 , V_49 ) ;
return - V_11 ;
}
F_35 ( V_33 , V_21 -> V_31 , NULL , V_49 ) ;
* V_48 = V_21 ;
return 0 ;
}
struct V_45 * F_36 ( struct V_22 * V_4 ,
struct V_1 * V_1 )
{
struct V_5 * V_6 ;
struct V_15 * V_33 ;
...
V_29 = F_32 ( V_4 , V_1 -> V_9 , V_33 , & V_51 ) ;
if ( V_29 )
goto V_54;
V_51 -> V_23 . V_55 = V_6 ;
V_51 -> V_46 = V_56 ;
