...
F_5 ( V_65 , V_10 ,
V_3 | V_168 | V_169 ) ;
F_5 ( V_65 , V_9 , V_3 | V_168 ) ;
V_3 = F_4 ( V_65 , V_36 ) ;
F_5 ( V_65 , V_36 ,
V_3 | V_170 | V_171 ) ;
F_5 ( V_65 , V_35 , V_3 | V_172 ) ;
V_3 = F_4 ( V_65 , V_25 ) ;
F_5 ( V_65 , V_25 , V_3 | V_173 ) ;
V_3 = F_4 ( V_65 , V_8 ) ;
F_5 ( V_65 , V_8 , V_3 | V_174 ) ;
V_3 = F_4 ( V_65 , V_13 ) ;
V_3 |= V_175 ;
F_5 ( V_65 , V_13 , V_3 ) ;
V_3 = F_4 ( V_65 , V_32 ) ;
...
static int F_25 ( struct V_177 * V_178 ,
const struct V_179 * V_180 )
{
struct V_99 * V_100 ;
unsigned int V_110 ;
int V_181 ;
V_100 = F_26 ( & V_178 -> V_2 , sizeof( struct V_99 ) ,
V_182 ) ;
if ( V_100 == NULL )
return - V_183 ;
V_100 -> V_184 = F_27 ( V_178 , & V_185 ) ;
if ( F_28 ( V_100 -> V_184 ) )
return F_29 ( V_100 -> V_184 ) ;
V_181 = F_30 ( V_100 -> V_184 , V_4 , & V_110 ) ;
if ( V_181 != 0 ) {
F_9 ( & V_178 -> V_2 , L_14 , V_181 ) ;
return V_181 ;
}
if ( V_110 != 0x1801 ) {
F_9 ( & V_178 -> V_2 , L_15 , V_110 ) ;
return - V_106 ;
}
F_31 ( V_100 -> V_184 , true ) ;
V_181 = F_30 ( V_100 -> V_184 , V_8 , & V_110 ) ;
F_31 ( V_100 -> V_184 , false ) ;
if ( V_181 != 0 ) {
F_9 ( & V_178 -> V_2 , L_16 , V_181 ) ;
return V_181 ;
}
F_32 ( & V_178 -> V_2 , L_17 ,
( V_110 & V_186 ) >> V_187 ,
( ( V_110 & V_188 ) >> V_189 )
+ 'A' ) ;
V_181 = F_33 ( V_100 -> V_184 , V_4 , 0x1801 ) ;
if ( V_181 != 0 ) {
F_9 ( & V_178 -> V_2 , L_18 , V_181 ) ;
return V_181 ;
}
F_34 ( V_178 , V_100 ) ;
V_181 = F_35 ( & V_178 -> V_2 ,
& V_190 , & V_191 , 1 ) ;
return V_181 ;
}
static int F_36 ( struct V_177 * V_192 )
{
F_37 ( & V_192 -> V_2 ) ;
return 0 ;
}
