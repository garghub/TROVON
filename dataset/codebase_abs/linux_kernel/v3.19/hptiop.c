...
if ( V_224 > V_2 -> V_104 )
V_224 = V_2 -> V_104 ;
return F_92 ( V_223 , V_224 ) ;
}
static T_5 F_93 ( struct V_126 * V_225 ,
struct V_226 * V_227 , char * V_167 )
{
return snprintf ( V_167 , V_228 , L_21 , V_229 ) ;
}
static T_5 F_94 ( struct V_126 * V_225 ,
struct V_226 * V_227 , char * V_167 )
{
struct V_177 * V_90 = F_95 ( V_225 ) ;
struct V_1 * V_2 = (struct V_1 * ) V_90 -> V_178 ;
return snprintf ( V_167 , V_228 , L_22 ,
V_2 -> V_103 >> 24 ,
( V_2 -> V_103 >> 16 ) & 0xff ,
( V_2 -> V_103 >> 8 ) & 0xff ,
V_2 -> V_103 & 0xff ) ;
...
{
V_2 -> V_6 . V_37 . V_79 = F_98 ( & V_2 -> V_124 -> V_225 ,
0x800 , & V_2 -> V_6 . V_37 . V_80 , V_230 ) ;
...
{
T_1 V_73 = F_2 ( & V_2 -> V_6 . V_65 . V_31 -> V_231 ) ;
char * V_18 ;
V_196 V_232 ;
F_20 ( V_2 -> V_233 == 0 ) ;
if ( V_73 == 0 ) {
...
V_2 -> V_6 . V_65 . V_234 = 0x800 +
V_73 * sizeof( struct V_235 ) +
V_73 * sizeof( struct V_236 ) +
sizeof( int ) ;
V_18 = F_98 ( & V_2 -> V_124 -> V_225 ,
V_2 -> V_6 . V_65 . V_234 , & V_232 , V_230 ) ;
if ( ! V_18 )
return - 1 ;
V_2 -> V_6 . V_65 . V_79 . V_51 = V_18 ;
V_2 -> V_6 . V_65 . V_79 . V_189 = V_232 >> 5 ;
V_2 -> V_6 . V_65 . V_79 . V_136 = NULL ;
V_2 -> V_6 . V_65 . V_79 . V_134 = NULL ;
V_18 += 0x800 ;
V_232 += 0x800 ;
V_2 -> V_6 . V_65 . V_194 = (struct V_235 * ) V_18 ;
V_2 -> V_6 . V_65 . V_199 = V_232 ;
V_18 += V_73 * sizeof( struct V_235 ) ;
V_232 += V_73 * sizeof( struct V_235 ) ;
V_2 -> V_6 . V_65 . V_74 = (struct V_236 * ) V_18 ;
V_2 -> V_6 . V_65 . V_202 = V_232 ;
V_18 += V_73 * sizeof( struct V_236 ) ;
V_232 += V_73 * sizeof( struct V_236 ) ;
V_2 -> V_6 . V_65 . V_71 = ( V_237 * ) V_18 ;
V_2 -> V_6 . V_65 . V_205 = V_232 ;
return 0 ;
}
...
static int F_104 ( struct V_123 * V_124 , const struct V_238 * V_211 )
{
...
F_45 ( V_248 L_25 ,
V_124 -> V_249 -> V_250 , V_124 -> V_251 >> 3 , V_124 -> V_251 & 7 ,
V_124 -> V_172 ) ;
F_106 ( V_124 ) ;
V_240 = (struct V_239 * ) V_211 -> V_252 ;
if ( F_107 ( V_124 , F_108 ( V_240 -> V_253 ) ) ) {
if ( F_107 ( V_124 , F_108 ( 32 ) ) ) {
F_45 ( V_117 L_26 ) ;
goto V_254;
}
}
if ( F_109 ( V_124 , V_255 ) ) {
F_45 ( V_117 L_27 ) ;
goto V_254;
}
V_90 = F_110 ( & V_256 , sizeof( struct V_1 ) ) ;
if ( ! V_90 ) {
F_45 ( V_117 L_28 ) ;
goto V_257;
}
...
if ( V_2 -> V_82 -> V_263 ( V_2 ) )
goto V_264;
if ( V_2 -> V_82 -> V_265 ( V_2 , 20000 ) ) {
F_45 ( V_117 L_29 ,
V_2 -> V_90 -> V_118 ) ;
goto V_266;
}
if ( V_2 -> V_82 -> V_267 == V_268 ) {
if ( V_2 -> V_82 -> V_269 ( V_2 ) ) {
F_45 ( V_117 L_30 ,
V_2 -> V_90 -> V_118 ) ;
goto V_266;
}
}
if ( V_2 -> V_82 -> V_270 ( V_2 , & V_241 ) ) {
F_45 ( V_117 L_31 ,
V_2 -> V_90 -> V_118 ) ;
goto V_266;
}
V_2 -> V_104 = F_112 ( F_64 ( V_241 . V_104 ) ,
V_271 ) ;
V_2 -> V_109 = F_64 ( V_241 . V_109 ) ;
V_2 -> V_233 = F_64 ( V_241 . V_105 ) ;
V_2 -> V_184 = F_64 ( V_241 . V_106 ) ;
V_2 -> V_103 = F_64 ( V_241 . V_103 ) ;
V_2 -> V_102 = F_64 ( V_241 . V_102 ) ;
V_2 -> V_110 = F_64 ( V_241 . V_110 ) ;
if ( V_2 -> V_82 -> V_267 == V_272 ) {
if ( V_2 -> V_82 -> V_269 ( V_2 ) ) {
F_45 ( V_117 L_30 ,
V_2 -> V_90 -> V_118 ) ;
goto V_266;
...
V_2 -> V_159 = 1 ;
V_90 -> V_274 = F_64 ( V_241 . V_107 ) >> 9 ;
V_90 -> V_275 = F_64 ( V_241 . V_109 ) ;
V_90 -> V_276 = F_64 ( V_241 . V_106 ) ;
V_90 -> V_277 = F_64 ( V_241 . V_104 ) ;
V_90 -> V_278 = F_64 ( V_241 . V_104 ) ;
V_90 -> V_279 = 16 ;
V_246 = sizeof( struct V_44 )
+ sizeof( struct V_175 ) * ( V_2 -> V_184 - 1 ) ;
if ( ( V_246 & 0x1f ) != 0 )
V_246 = ( V_246 + 0x1f ) & ~ 0x1f ;
memset ( & V_242 , 0 , sizeof( struct V_111 ) ) ;
V_242 . V_280 = F_22 ( V_90 -> V_118 ) ;
V_242 . V_281 = F_113 ( V_90 -> V_118 ) ;
V_242 . V_282 = F_113 ( V_246 ) ;
if ( V_2 -> V_82 -> V_242 ( V_2 , & V_242 ) ) {
F_45 ( V_117 L_33 ,
V_2 -> V_90 -> V_118 ) ;
goto V_266;
}
F_114 ( V_124 , V_90 ) ;
if ( F_115 ( V_124 -> V_172 , F_68 , V_283 ,
V_255 , V_2 ) ) {
F_45 ( V_117 L_34 ,
V_2 -> V_90 -> V_118 , V_124 -> V_172 ) ;
goto V_266;
}
F_13 ( L_35 , V_246 , V_2 -> V_104 ) ;
V_2 -> V_246 = V_246 ;
V_244 = F_98 ( & V_124 -> V_225 ,
V_2 -> V_246 * V_2 -> V_104 + 0x20 ,
& V_243 , V_230 ) ;
if ( ! V_244 ) {
F_45 ( V_117 L_36 ,
V_2 -> V_90 -> V_118 ) ;
...
V_2 -> V_50 [ V_5 ] . V_51 = V_244 ;
V_2 -> V_50 [ V_5 ] . V_189 = V_243 >> 5 ;
V_2 -> V_50 [ V_5 ] . V_119 = V_5 ;
F_61 ( V_2 , & V_2 -> V_50 [ V_5 ] ) ;
V_244 = ( char * ) V_244 + V_2 -> V_246 ;
V_243 = V_243 + V_2 -> V_246 ;
}
if ( F_44 ( V_2 ) )
goto V_287;
if ( F_116 ( V_90 , & V_124 -> V_225 ) ) {
F_45 ( V_117 L_37 ,
V_2 -> V_90 -> V_118 ) ;
goto V_287;
}
