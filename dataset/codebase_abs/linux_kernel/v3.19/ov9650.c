...
continue;
V_171 = F_53 ( ( T_2 ) ( V_173 -> V_63 . V_65 * 10000 ) /
...
static int F_54 ( struct V_1 * V_7 ,
struct V_164 * V_165 )
{
struct V_5 * V_5 = F_3 ( V_7 ) ;
int V_17 ;
...
static int F_55 ( struct V_1 * V_7 , struct V_154 * V_155 ,
struct V_175 * V_176 )
{
struct V_5 * V_5 = F_3 ( V_7 ) ;
struct V_144 * V_145 ;
...
static int F_58 ( struct V_1 * V_7 , struct V_154 * V_155 ,
struct V_175 * V_176 )
{
...
static int F_61 ( struct V_1 * V_7 , int V_31 )
{
struct V_8 * V_9 = F_62 ( V_7 ) ;
struct V_5 * V_5 = F_3 ( V_7 ) ;
struct V_78 * V_6 = & V_5 -> V_6 ;
int V_17 = 0 ;
F_6 ( 1 , V_20 , V_9 , L_3 , V_21 , V_31 ) ;
...
static int F_64 ( struct V_1 * V_7 , struct V_154 * V_155 )
{
struct V_144 * V_145 = F_56 ( V_155 , 0 ) ;
F_48 ( V_145 ) ;
return 0 ;
}
...
{
int V_17 , V_24 ;
V_5 -> V_32 [ V_33 ] = V_197 -> V_198 ;
V_5 -> V_32 [ V_34 ] = V_197 -> V_199 ;
for ( V_24 = 0 ; V_24 < F_11 ( V_5 -> V_32 ) ; V_24 ++ ) {
int V_30 = V_5 -> V_32 [ V_24 ] ;
if ( ! F_15 ( V_30 ) )
continue;
V_17 = F_66 ( & V_5 -> V_9 -> V_200 , V_30 ,
V_201 , L_10 ) ;
if ( V_17 < 0 )
return V_17 ;
...
F_17 ( V_5 , 1 ) ;
F_18 ( 25000 , 26000 ) ;
V_17 = F_4 ( V_9 , V_204 , & V_202 ) ;
if ( ! V_17 )
V_17 = F_4 ( V_9 , V_205 , & V_203 ) ;
F_17 ( V_5 , 0 ) ;
if ( ! V_17 ) {
V_5 -> V_115 = F_69 ( V_202 , V_203 ) ;
if ( V_5 -> V_115 == V_206 || V_5 -> V_115 == V_207 ) {
F_70 ( V_7 , L_12 , V_5 -> V_115 ) ;
} else {
F_25 ( V_7 , L_13 ,
V_5 -> V_115 , V_17 ) ;
V_17 = - V_208 ;
...
const struct V_209 * V_115 )
{
const struct V_196 * V_197 = V_9 -> V_200 . V_210 ;
struct V_1 * V_7 ;
struct V_5 * V_5 ;
int V_17 ;
if ( V_197 == NULL ) {
...
V_5 = F_73 ( & V_9 -> V_200 , sizeof( * V_5 ) , V_211 ) ;
if ( ! V_5 )
return - V_212 ;
F_74 ( & V_5 -> V_36 ) ;
V_5 -> V_9 = V_9 ;
...
V_7 = & V_5 -> V_7 ;
F_75 ( V_7 , V_9 , & V_213 ) ;
F_76 ( V_7 -> V_119 , V_214 , sizeof( V_7 -> V_119 ) ) ;
V_7 -> V_215 = & V_216 ;
V_7 -> V_15 |= V_217 |
V_218 ;
V_17 = F_65 ( V_5 , V_197 ) ;
if ( V_17 < 0 )
return V_17 ;
V_5 -> V_184 . V_15 = V_219 ;
V_7 -> V_220 . type = V_221 ;
V_17 = F_77 ( & V_7 -> V_220 , 1 , & V_5 -> V_184 , 0 ) ;
if ( V_17 < 0 )
return V_17 ;
V_17 = F_40 ( V_5 ) ;
if ( V_17 < 0 )
