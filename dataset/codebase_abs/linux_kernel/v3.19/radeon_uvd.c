...
if ( V_115 >= V_112 -> V_120 ) {
F_28 ( L_16 ,
V_115 , V_112 -> V_120 ) ;
return - V_52 ;
}
V_114 = & V_101 -> V_121 [ ( V_115 / 4 ) ] ;
V_117 = V_114 -> V_122 ;
V_118 = V_117 + F_20 ( V_114 -> V_123 ) ;
V_117 += V_103 ;
V_101 -> V_124 . V_70 [ V_108 ] = V_117 & 0xFFFFFFFF ;
V_101 -> V_124 . V_70 [ V_109 ] = V_117 >> 32 ;
...
* V_110 = true ;
V_6 = F_34 ( V_101 , V_114 -> V_123 , V_103 , V_89 ) ;
if ( V_6 )
return V_6 ;
} else if ( ! * V_110 ) {
F_28 ( L_23 ) ;
...
int V_5 , V_6 ;
V_101 -> V_115 ++ ;
for ( V_5 = 0 ; V_5 <= V_126 -> V_127 ; ++ V_5 ) {
switch ( V_126 -> V_128 + V_5 * 4 ) {
case V_129 :
* V_108 = V_101 -> V_115 ;
break;
case V_130 :
...
do {
V_6 = F_41 ( V_101 , & V_126 , V_101 -> V_115 ) ;
if ( V_6 )
return V_6 ;
switch ( V_126 . type ) {
case V_134 :
V_6 = F_39 ( V_101 , & V_126 , & V_108 , & V_109 ,
V_89 , & V_110 ) ;
if ( V_6 )
return V_6 ;
break;
case V_135 :
V_101 -> V_115 += V_126 . V_127 + 2 ;
break;
default:
F_28 ( L_27 , V_126 . type ) ;
return - V_52 ;
}
} while ( V_101 -> V_115 < V_101 -> V_133 -> V_120 );
if ( ! V_110 ) {
F_28 ( L_28 ) ;
return - V_52 ;
}
...
struct V_137 V_124 ;
int V_5 , V_6 ;
V_6 = F_43 ( V_2 , V_68 , & V_124 , NULL , 64 ) ;
if ( V_6 )
return V_6 ;
V_124 . V_70 [ 0 ] = F_44 ( V_129 , 0 ) ;
V_124 . V_70 [ 1 ] = V_136 ;
V_124 . V_70 [ 2 ] = F_44 ( V_130 , 0 ) ;
V_124 . V_70 [ 3 ] = V_136 >> 32 ;
V_124 . V_70 [ 4 ] = F_44 ( V_131 , 0 ) ;
V_124 . V_70 [ 5 ] = 0 ;
for ( V_5 = 6 ; V_5 < 16 ; ++ V_5 )
V_124 . V_70 [ V_5 ] = F_45 ( 0 ) ;
V_124 . V_120 = 16 ;
V_6 = F_46 ( V_2 , & V_124 , NULL , false ) ;
if ( V_87 )
* V_87 = F_47 ( V_124 . V_87 ) ;
F_48 ( V_2 , & V_124 ) ;
return V_6 ;
}
...
{
T_3 V_138 = F_20 ( V_2 -> V_7 . V_61 ) -
V_58 ;
T_1 * V_88 = V_2 -> V_7 . V_63 + V_138 ;
T_3 V_136 = V_2 -> V_7 . V_62 + V_138 ;
int V_6 , V_5 ;
...
static void V_9 ( struct V_141 * V_142 )
{
struct V_1 * V_2 =
F_52 ( V_142 , struct V_1 , V_7 . V_8 . V_142 ) ;
if ( F_53 ( V_2 , V_69 ) == 0 ) {
if ( ( V_2 -> V_143 . V_144 == V_145 ) && V_2 -> V_143 . V_146 ) {
F_51 ( V_2 , & V_2 -> V_143 . V_147 . V_139 ,
& V_2 -> V_143 . V_147 . V_140 ) ;
F_54 ( V_2 , false ) ;
} else {
F_55 ( V_2 , 0 , 0 ) ;
}
...
{
bool V_149 = false ;
bool V_150 = ! F_58 ( & V_2 -> V_7 . V_8 ) ;
V_150 &= F_56 ( & V_2 -> V_7 . V_8 ,
F_57 ( V_148 ) ) ;
if ( ( V_2 -> V_143 . V_144 == V_145 ) && V_2 -> V_143 . V_146 ) {
unsigned V_140 = 0 , V_139 = 0 ;
F_51 ( V_2 , & V_139 , & V_140 ) ;
if ( ( V_2 -> V_143 . V_147 . V_139 != V_139 ) ||
( V_2 -> V_143 . V_147 . V_140 != V_140 ) ) {
V_2 -> V_143 . V_147 . V_139 = V_139 ;
V_2 -> V_143 . V_147 . V_140 = V_140 ;
}
}
if ( V_150 || V_149 ) {
...
static unsigned F_59 ( unsigned V_151 ,
unsigned V_152 ,
unsigned V_153 ,
unsigned V_154 )
{
unsigned V_155 = V_151 / V_152 ;
if ( V_155 < V_153 )
V_155 = V_153 ;
if ( ( V_151 / V_155 ) > V_152 )
V_155 += 1 ;
if ( V_155 > V_154 && V_155 % 2 )
V_155 += 1 ;
return V_155 ;
}
...
unsigned V_160 , unsigned V_161 ,
unsigned V_153 , unsigned V_162 ,
unsigned V_154 ,
unsigned * V_163 ,
unsigned * V_164 ,
unsigned * V_165 )
{
unsigned V_151 , V_166 = V_2 -> clock . V_167 . V_168 ;
unsigned V_169 = ~ 0 ;
V_158 = F_33 ( F_33 ( V_158 , V_156 ) , V_157 ) ;
for ( V_151 = V_158 ; V_151 <= V_159 ; V_151 += 100 ) {
T_3 V_170 = ( T_3 ) V_151 * V_160 ;
unsigned V_171 , V_172 , V_173 ;
F_61 ( V_170 , V_166 ) ;
if ( V_170 > V_161 )
break;
V_170 &= V_161 ;
V_171 = F_59 ( V_151 , V_156 ,
V_153 , V_154 ) ;
if ( V_171 > V_162 )
break;
V_172 = F_59 ( V_151 , V_157 ,
V_153 , V_154 ) ;
if ( V_171 > V_162 )
break;
V_173 = V_156 - ( V_151 / V_171 ) + V_157 - ( V_151 / V_172 ) ;
if ( V_173 < V_169 ) {
* V_163 = V_170 ;
* V_164 = V_171 ;
* V_165 = V_172 ;
...
F_63 ( V_174 , 0 , ~ V_175 ) ;
F_64 ( 10 ) ;
F_63 ( V_174 , V_175 , ~ V_175 ) ;
for ( V_5 = 0 ; V_5 < 100 ; ++ V_5 ) {
T_1 V_176 = V_177 | V_178 ;
if ( ( F_65 ( V_174 ) & V_176 ) == V_176 )
break;
F_64 ( 10 ) ;
}
F_63 ( V_174 , 0 , ~ V_175 ) ;
