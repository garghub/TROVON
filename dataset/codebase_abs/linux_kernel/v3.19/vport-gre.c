...
V_9 = F_25 ( V_13 -> V_16 ) ;
V_40 = F_26 ( V_39 -> V_55 . V_27 ) + V_39 -> V_55 . V_56
+ V_9 + sizeof( struct V_57 )
+ ( F_27 ( V_8 ) ? V_58 : 0 ) ;
if ( F_28 ( V_8 ) < V_40 || F_29 ( V_8 ) ) {
int V_59 = F_30 ( V_40 -
F_28 ( V_8 ) +
16 ) ;
V_42 = F_31 ( V_8 , F_32 ( int , V_59 , 0 ) ,
0 , V_60 ) ;
if ( F_15 ( V_42 ) )
goto V_61;
}
...
F_8 ( V_64 ) : 0 ;
V_8 -> V_65 = 1 ;
return F_34 ( V_8 -> V_66 , V_39 , V_8 , V_37 . V_47 ,
V_13 -> V_46 , V_54 ,
V_13 -> V_50 , V_13 -> V_67 , V_41 , false ) ;
V_61:
F_35 ( V_39 ) ;
V_44:
F_36 ( V_8 ) ;
...
static struct V_26 * F_44 ( const struct V_70 * V_71 )
{
struct V_34 * V_34 = F_21 ( V_71 -> V_35 ) ;
struct V_25 * V_25 ;
struct V_26 * V_26 ;
int V_42 ;
V_42 = F_37 () ;
...
V_26 = F_47 ( V_73 , & V_74 , V_71 ) ;
if ( F_7 ( V_26 ) )
goto error;
strncpy ( F_43 ( V_26 ) , V_71 -> V_75 , V_73 ) ;
...
static int F_52 ( struct V_26 * V_26 , struct V_7 * V_8 ,
struct V_23 * V_14 )
{
return F_53 ( V_14 ,
F_21 ( V_26 -> V_35 ) ,
