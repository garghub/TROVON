...
static int F_263 ( struct V_10 * V_226 )
{
...
static int F_270 ( struct V_1 * V_7 , enum V_342 V_343 )
{
return F_264 ( V_7 , V_343 , V_427 ) ;
}
static int F_271 ( struct V_1 * V_7 )
{
return F_264 ( V_7 , V_416 ,
V_428 ) ;
}
static struct V_36 * F_272 ( struct V_315 * V_316 )
{
struct V_36 * V_37 ;
...
static void F_273 ( struct V_315 * V_99 )
{
struct V_36 * V_37 ;
struct V_4 * V_35 , * V_153 ;
F_19 ( L_98 ) ;
...
static int F_274 ( struct V_158 * V_159 )
{
struct V_2 * V_3 = F_102 ( V_159 ) ;
F_275 ( V_3 ) ;
return 0 ;
...
static void F_277 ( unsigned int V_430 )
{
struct V_149 * V_150 ;
struct V_431 * V_130 ;
V_150 = & F_278 ( V_432 , V_430 ) ;
V_130 = F_279 ( F_93 ,
( void * ) V_150 , F_280 ( V_430 ) ,
L_101 , V_430 ) ;
if ( F_281 ( ! F_282 ( V_130 ) ) ) {
F_283 ( V_130 , V_430 ) ;
V_150 -> V_433 = V_130 ;
F_71 ( V_130 ) ;
}
