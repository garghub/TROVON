...
static int F_95 ( struct V_140 * V_141 )
{
return F_96 ( V_141 ) ;
}
...
static int F_102 ( struct V_1 * V_2 , struct V_157 * V_158 )
{
struct V_49 * V_50 ;
if ( F_103 ( V_2 , V_158 , true ) ) {
F_104 ( V_2 , V_159 , V_2 -> V_4 ,
L_3 ,
V_158 , V_2 -> V_4 -> V_160 ) ;
return - V_18 ;
}
...
V_50 -> V_164 = V_165 ;
F_86 ( & V_50 -> V_127 , & V_2 -> V_119 ) ;
V_2 -> V_51 ++ ;
F_25 ( V_2 , V_50 ) ;
return 0 ;
}
static void F_105 ( struct V_1 * V_2 , struct V_157 * V_158 )
{
struct V_49 * V_50 ;
V_50 = F_106 ( V_2 -> V_8 , V_158 , true ) ;
if ( ! V_50 )
return;
F_31 ( V_50 , true ) ;
F_90 ( & V_50 -> V_127 ) ;
...
switch ( V_144 ) {
case V_169 :
if ( F_102 ( V_2 , & V_167 -> V_50 ) )
return V_156 ;
break;
case V_170 :
F_105 ( V_2 , & V_167 -> V_50 ) ;
break;
}
return V_171 ;
}
static int F_109 ( struct V_1 * V_2 , struct V_172 * V_173 )
{
struct V_49 * V_50 ;
if ( F_103 ( V_2 , V_173 , false ) ) {
F_104 ( V_2 , V_159 , V_2 -> V_4 ,
L_4 ,
V_173 , V_2 -> V_4 -> V_160 ) ;
return - V_18 ;
...
static void F_110 ( struct V_1 * V_2 , struct V_172 * V_173 )
{
struct V_49 * V_50 ;
V_50 = F_106 ( V_2 -> V_8 , V_173 , false ) ;
if ( ! V_50 )
return;
F_31 ( V_50 , true ) ;
F_90 ( & V_50 -> V_127 ) ;
