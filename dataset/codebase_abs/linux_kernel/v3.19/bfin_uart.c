...
V_179 = F_117 ( V_4 ) ;
F_105 ( V_4 ) ;
* V_135 = F_118 () / ( 16 * V_179 ) ;
}
F_119 ( L_18 , V_147 , * V_135 , * V_61 , * V_178 ) ;
}
...
return - V_191 ;
if ( V_188 )
F_125 ( V_188 , & V_135 , & V_61 , & V_178 , & V_189 ) ;
else
F_116 ( V_4 , & V_135 , & V_61 , & V_178 ) ;
return F_126 ( & V_4 -> V_2 , V_183 , V_135 , V_61 , V_178 , V_189 ) ;
}
static void
...
return;
F_55 ( & V_192 . V_2 . V_76 , V_88 ) ;
F_123 ( & V_192 . V_2 , V_184 , V_185 ,
F_120 ) ;
F_58 ( & V_192 . V_2 . V_76 , V_88 ) ;
}
static int F_128 ( struct V_193 * V_194 , T_6 V_20 )
{
...
if ( V_197 == NULL ) {
F_134 ( & V_194 -> V_130 , L_22 ) ;
V_198 = - V_200 ;
goto V_213;
}
V_4 -> V_2 . V_203 = F_141 ( V_197 -> V_214 , F_142 ( V_197 ) ) ;
if ( ! V_4 -> V_2 . V_203 ) {
F_134 ( & V_194 -> V_130 , L_23 ) ;
V_198 = - V_215 ;
goto V_213;
}
V_4 -> V_2 . V_216 = V_197 -> V_214 ;
V_4 -> V_117 = F_143 ( V_194 , 0 ) ;
if ( V_4 -> V_117 < 0 ) {
F_134 ( & V_194 -> V_130 , L_24 ) ;
V_198 = - V_200 ;
goto V_217;
}
V_4 -> V_116 = F_143 ( V_194 , 1 ) ;
if ( V_4 -> V_116 < 0 ) {
F_134 ( & V_194 -> V_130 , L_25 ) ;
V_198 = - V_200 ;
goto V_217;
}
V_4 -> V_2 . V_12 = V_4 -> V_116 ;
V_4 -> V_129 = F_143 ( V_194 , 2 ) ;
if ( V_4 -> V_129 < 0 ) {
F_134 ( & V_194 -> V_130 , L_26 ) ;
V_198 = - V_200 ;
goto V_217;
}
#ifdef F_12
...
if ( V_197 == NULL ) {
F_134 ( & V_194 -> V_130 , L_28 ) ;
V_198 = - V_200 ;
goto V_217;
}
V_4 -> V_91 = V_197 -> V_214 ;
F_144 ( & ( V_4 -> V_94 ) ) ;
#endif
#if F_16 ( F_79 ) || \
F_16 ( F_7 )
...
int V_198 ;
if ( V_194 -> V_199 < 0 || V_194 -> V_199 >= V_190 ) {
F_134 ( & V_194 -> V_130 , L_29 ) ;
return - V_200 ;
}
V_198 = F_137 ( F_138 ( & V_194 -> V_130 ) ,
V_128 ) ;
if ( V_198 ) {
F_134 ( & V_194 -> V_130 ,
L_21 ) ;
...
V_192 . V_2 . line = V_194 -> V_199 ;
V_192 . V_2 . V_165 = F_118 () ;
V_192 . V_2 . V_205 = V_206 ;
F_139 ( & V_192 . V_2 . V_76 ) ;
return 0 ;
V_213:
F_150 ( F_138 ( & V_194 -> V_130 ) ) ;
return V_198 ;
