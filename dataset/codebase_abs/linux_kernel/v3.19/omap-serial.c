...
V_4 -> V_33 = * V_259 ;
if ( F_94 ( V_2 -> V_40 ) ) {
V_260 = ( V_4 -> V_33 . V_34 & V_35 ) ?
V_39 : V_63 ;
V_260 = ( V_4 -> V_33 . V_34 & V_260 ) ? 1 : 0 ;
F_24 ( V_2 -> V_40 , V_260 ) ;
} else
V_4 -> V_33 . V_34 &= ~ V_35 ;
V_2 -> V_29 = V_23 ;
...
static int F_95 ( struct V_261 * V_14 )
{
struct V_1 * V_2 = F_96 ( V_14 ) ;
V_2 -> V_262 = true ;
return 0 ;
}
static void F_97 ( struct V_261 * V_14 )
{
struct V_1 * V_2 = F_96 ( V_14 ) ;
V_2 -> V_262 = false ;
}
static int F_98 ( struct V_261 * V_14 )
{
struct V_1 * V_2 = F_96 ( V_14 ) ;
F_99 ( & V_263 , & V_2 -> V_4 ) ;
F_100 ( & V_2 -> V_155 ) ;
...
static int F_101 ( struct V_261 * V_14 )
{
struct V_1 * V_2 = F_96 ( V_14 ) ;
if ( F_71 ( V_14 ) )
F_11 ( V_2 , false ) ;
...
V_264 = F_104 ( V_2 -> V_4 . V_6 + ( V_269 << V_2 -> V_4 . V_5 ) ) ;
V_265 = V_264 >> V_270 ;
switch ( V_265 ) {
case 0 :
V_267 = ( V_264 & V_271 ) >>
...
static struct V_12 * F_107 ( struct V_261 * V_14 )
{
struct V_12 * V_281 ;
V_281 = F_108 ( V_14 , sizeof( * V_281 ) , V_282 ) ;
if ( ! V_281 )
return NULL ;
F_109 ( V_14 -> V_283 , L_16 ,
& V_281 -> V_25 ) ;
return V_281 ;
}
...
struct V_284 * V_285 )
{
struct V_258 * V_259 = & V_2 -> V_4 . V_33 ;
T_3 V_286 [ 2 ] ;
enum V_287 V_34 ;
int V_101 ;
V_259 -> V_34 = 0 ;
...
V_259 -> V_34 |= V_39 ;
V_2 -> V_40 = F_112 ( V_285 , L_18 , 0 , & V_34 ) ;
if ( F_94 ( V_2 -> V_40 ) ) {
...
{
struct V_12 * V_281 = F_7 ( & V_290 -> V_14 ) ;
struct V_1 * V_2 ;
struct V_291 * V_292 ;
void T_5 * V_293 ;
int V_294 = 0 ;
...
int V_101 ;
if ( V_290 -> V_14 . V_283 ) {
V_294 = F_117 ( V_290 -> V_14 . V_283 , 0 ) ;
if ( ! V_294 )
return - V_288 ;
V_18 = F_117 ( V_290 -> V_14 . V_283 , 1 ) ;
V_281 = F_107 ( & V_290 -> V_14 ) ;
V_290 -> V_14 . V_295 = V_281 ;
} else {
V_294 = F_118 ( V_290 , 0 ) ;
if ( V_294 < 0 )
return - V_288 ;
}
V_2 = F_108 ( & V_290 -> V_14 , sizeof( * V_2 ) , V_282 ) ;
if ( ! V_2 )
return - V_296 ;
V_292 = F_119 ( V_290 , V_297 , 0 ) ;
V_293 = F_120 ( & V_290 -> V_14 , V_292 ) ;
if ( F_121 ( V_293 ) )
return F_122 ( V_293 ) ;
V_2 -> V_14 = & V_290 -> V_14 ;
V_2 -> V_4 . V_14 = & V_290 -> V_14 ;
V_2 -> V_4 . type = V_237 ;
V_2 -> V_4 . V_298 = V_299 ;
V_2 -> V_4 . V_98 = V_294 ;
V_2 -> V_18 = V_18 ;
...
V_2 -> V_4 . V_300 = & V_301 ;
if ( V_290 -> V_14 . V_283 )
V_101 = F_124 ( V_290 -> V_14 . V_283 , L_24 ) ;
else
V_101 = V_290 -> V_302 ;
if ( V_101 < 0 ) {
F_125 ( & V_290 -> V_14 , L_25 ,
V_101 ) ;
goto V_303;
}
V_2 -> V_4 . line = V_101 ;
if ( V_2 -> V_4 . line >= V_304 ) {
F_125 ( & V_290 -> V_14 , L_26 , V_2 -> V_4 . line ,
V_304 ) ;
V_101 = - V_305 ;
goto V_303;
}
V_101 = F_110 ( V_2 , V_290 -> V_14 . V_283 ) ;
if ( V_101 < 0 )
goto V_306;
sprintf ( V_2 -> V_145 , L_27 , V_2 -> V_4 . line ) ;
V_2 -> V_4 . V_307 = V_292 -> V_308 ;
V_2 -> V_4 . V_6 = V_293 ;
V_2 -> V_4 . V_34 = V_281 -> V_34 ;
V_2 -> V_4 . V_25 = V_281 -> V_25 ;
V_2 -> V_4 . V_309 = F_93 ;
if ( ! V_2 -> V_4 . V_25 ) {
V_2 -> V_4 . V_25 = V_310 ;
F_105 ( & V_290 -> V_14 ,
...
F_18 ( & V_290 -> V_14 ) ;
F_103 ( V_2 ) ;
V_314 [ V_2 -> V_4 . line ] = V_2 ;
F_92 ( V_2 ) ;
V_101 = F_134 ( & V_263 , & V_2 -> V_4 ) ;
if ( V_101 != 0 )
goto V_315;
F_19 ( V_2 -> V_14 ) ;
F_20 ( V_2 -> V_14 ) ;
...
static int F_137 ( struct V_289 * V_14 )
{
...
static int F_144 ( struct V_261 * V_14 )
{
struct V_1 * V_2 = F_96 ( V_14 ) ;
if ( ! V_2 )
return - V_16 ;
...
static int F_146 ( struct V_261 * V_14 )
{
struct V_1 * V_2 = F_96 ( V_14 ) ;
int V_320 = F_6 ( V_2 ) ;
F_11 ( V_2 , false ) ;
