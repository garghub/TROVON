...
V_64 -> V_7 = 1 << V_62 ;
F_37 ( V_63 , V_27 , V_6 -> V_24 ) ;
F_38 ( V_63 , V_4 ) ;
F_39 ( V_63 , V_44 -> V_52 , V_44 -> V_51 ) ;
return 0 ;
}
void F_40 ( struct V_3 * V_4 , T_1 V_73 ,
...
F_37 ( V_34 , V_27 , V_6 -> V_24 ) ;
F_38 ( V_34 , V_4 ) ;
F_39 ( V_34 , V_40 , V_41 ) ;
}
V_4 -> V_75 = V_34 - V_4 -> V_22 ;
}
int F_43 ( struct V_1 * V_2 , unsigned int type )
{
struct V_3 * V_4 = F_3 ( V_2 ) ;
struct V_5 * V_6 = V_4 -> V_26 ;
unsigned int V_34 ;
...
if ( V_6 -> type & type ) {
V_2 -> V_27 = & V_6 -> V_27 ;
F_44 ( V_2 ) -> V_76 = V_6 -> V_24 ;
return 0 ;
}
}
return - V_16 ;
}
void F_45 ( struct V_3 * V_4 , T_1 V_73 ,
unsigned int V_40 , unsigned int V_41 )
{
...
static struct V_1 * F_49 ( struct V_3 * V_4 )
{
unsigned int V_63 ;
if ( ! V_4 -> V_54 )
return F_33 ( V_4 -> V_22 ) ;
if ( ! V_4 -> V_69 )
return NULL ;
V_63 = F_50 ( V_4 -> V_54 , V_4 -> V_22 + F_51 ( V_4 -> V_69 ) ) ;
return V_63 ? F_33 ( V_63 ) : NULL ;
}
static int F_52 ( void )
{
struct V_3 * V_4 ;
F_53 (gc, &gc_list, list) {
struct V_5 * V_6 = V_4 -> V_26 ;
if ( V_6 -> V_27 . V_78 ) {
struct V_1 * V_64 = F_49 ( V_4 ) ;
if ( V_64 )
V_6 -> V_27 . V_78 ( V_64 ) ;
}
}
