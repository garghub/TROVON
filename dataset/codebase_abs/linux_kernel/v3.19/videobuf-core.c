...
if ( F_57 ( V_115 , V_29 + V_3 -> V_118 , V_100 ) )
return - V_119 ;
return V_100 ;
}
...
int V_121 , int V_112 )
{
unsigned int * V_122 = F_56 ( V_3 , V_29 , V_28 ) ;
if ( V_121 ) {
V_122 += ( V_28 -> V_91 >> 2 ) - 1 ;
* V_122 = V_28 -> V_93 >> 1 ;
F_23 ( 1 , L_42 , * V_122 ) ;
...
V_13 = F_58 ( V_3 , V_3 -> V_51 , V_115 + V_101 , V_100 ,
V_101 , V_121 , V_112 ) ;
if ( V_13 < 0 ) {
V_101 = V_13 ;
break;
...
unsigned int F_66 ( struct V_124 * V_124 ,
struct V_2 * V_3 ,
T_6 * V_46 )
{
unsigned long V_125 = F_67 ( V_46 ) ;
struct V_1 * V_28 = NULL ;
unsigned int V_13 = 0 ;
F_33 ( V_3 ) ;
if ( V_3 -> V_49 ) {
...
int F_69 ( struct V_2 * V_3 , struct V_131 * V_132 )
{
int V_13 = - V_102 ;
int V_48 ;
F_10 ( V_3 -> V_6 -> V_10 , V_26 ) ;
