...
if ( V_48 -> V_230 -> V_19 . V_240 != 3 ) {
F_11 ( & V_48 -> V_16 , L_32 ) ;
return - V_106 ;
} else {
F_110 ( & V_48 -> V_16 , L_33 ) ;
V_222 = 1 ;
V_210 = V_211 = V_48 ;
goto V_241;
}
...
V_210 = F_109 ( V_194 , V_203 -> V_242 ) ;
V_211 = F_109 ( V_194 , ( V_220 = V_203 -> V_243 ) ) ;
}
if ( ! V_210 || ! V_211 ) {
F_11 ( & V_48 -> V_16 , L_34 ) ;
return - V_106 ;
...
F_11 ( & V_48 -> V_16 , L_35 ) ;
if ( V_210 == V_211 ) {
F_110 ( & V_48 -> V_16 , L_36 ) ;
V_222 = 1 ;
V_22 |= V_244 ;
if ( V_211 -> V_230 -> V_19 . V_240 != 3 ) {
F_22 ( & V_48 -> V_16 , L_37 ) ;
return - V_142 ;
}
V_241:
...
struct V_212 * V_245 ;
V_245 = & V_211 -> V_230 -> V_231 [ V_26 ] . V_19 ;
if ( F_111 ( V_245 ) )
V_213 = V_245 ;
else if ( F_112 ( V_245 ) )
V_215 = V_245 ;
...
V_229:
if ( V_211 -> V_230 -> V_19 . V_247
!= V_248 ) {
if ( V_210 -> V_230 -> V_19 . V_247
== V_248 ) {
struct V_47 * V_249 ;
F_11 ( & V_48 -> V_16 ,
L_38 ) ;
...
if ( V_211 -> V_230 -> V_19 . V_240 < 2 ||
V_210 -> V_230 -> V_19 . V_240 == 0 )
return - V_142 ;
...
F_120 ( & V_1 -> V_69 ) ;
F_121 ( & V_1 -> V_5 ) ;
V_1 -> V_252 = F_122 ( V_194 , V_214 -> V_253 ) ;
V_1 -> V_254 = F_123 ( V_214 ) ;
if ( V_1 -> V_254 )
...
F_125 ( & V_1 -> V_124 ) ;
V_1 -> V_22 = V_22 ;
V_12 = F_107 ( V_194 , V_216 , V_121 , & V_1 -> V_258 ) ;
if ( ! V_12 ) {
F_22 ( & V_48 -> V_16 , L_44 ) ;
goto V_259;
}
...
if ( F_123 ( V_215 ) )
F_127 ( V_266 -> V_37 , V_194 ,
F_130 ( V_194 , V_215 -> V_253 ) ,
NULL , V_1 -> V_127 , F_44 , V_266 , V_215 -> V_255 ) ;
else
F_128 ( V_266 -> V_37 , V_194 ,
F_131 ( V_194 , V_215 -> V_253 ) ,
NULL , V_1 -> V_127 , F_44 , V_266 ) ;
V_266 -> V_37 -> V_264 |= V_265 ;
V_266 -> V_97 = V_1 ;
}
F_132 ( V_48 , V_1 ) ;
V_26 = F_133 ( & V_48 -> V_16 , & V_268 ) ;
if ( V_26 < 0 )
goto V_267;
if ( V_205 ) {
V_1 -> V_50 = F_134 ( V_205 -> V_269 - 4 , V_121 ) ;
if ( ! V_1 -> V_50 )
goto V_270;
...
F_136 ( V_194 , V_213 -> V_253 ) ,
V_1 -> V_260 , V_216 , F_28 , V_1 ,
V_213 -> V_255 ? V_213 -> V_255 : 16 ) ;
V_1 -> V_120 -> V_264 |= V_265 ;
V_1 -> V_120 -> V_39 = V_1 -> V_258 ;
F_137 ( & V_48 -> V_16 , L_51 , V_8 ) ;
V_1 -> line . V_146 = F_98 ( 9600 ) ;
V_1 -> line . V_186 = 8 ;
F_101 ( V_1 , & V_1 -> line ) ;
F_138 ( & V_275 , V_211 , V_1 ) ;
F_132 ( V_211 , V_1 ) ;
F_139 ( V_210 ) ;
V_223 = F_140 ( & V_1 -> V_7 , V_276 , V_8 ,
& V_210 -> V_16 ) ;
if ( F_141 ( V_223 ) ) {
V_155 = F_142 ( V_223 ) ;
goto V_277;
...
F_102 ( V_1 ) ;
V_261:
F_104 ( V_194 , V_216 , V_1 -> V_260 , V_1 -> V_258 ) ;
V_259:
F_6 ( V_1 ) ;
F_63 ( V_1 ) ;
V_251:
...
F_143 ( V_1 -> V_91 [ V_26 ] ) ;
F_102 ( V_1 ) ;
F_104 ( V_194 , V_1 -> V_216 , V_1 -> V_260 , V_1 -> V_258 ) ;
F_105 ( V_1 ) ;
if ( ! V_1 -> V_222 )
F_151 ( & V_275 , V_48 == V_1 -> V_15 ?
V_1 -> V_43 : V_1 -> V_15 ) ;
F_51 ( & V_1 -> V_7 ) ;
}
static int F_152 ( struct V_47 * V_48 , T_5 V_278 )
{
struct V_1 * V_1 = F_25 ( V_48 ) ;
int V_279 ;
F_57 ( & V_1 -> V_34 ) ;
...
V_276 -> type = V_287 ,
V_276 -> V_288 = V_289 ,
V_276 -> V_33 = V_290 | V_291 ;
V_276 -> V_292 = V_293 ;
V_276 -> V_292 . V_178 = V_294 | V_189 | V_295 |
V_296 | V_190 ;
F_159 ( V_276 , & V_297 ) ;
V_14 = F_160 ( V_276 ) ;
if ( V_14 ) {
...
F_164 (KERN_INFO KBUILD_MODNAME L_54 DRIVER_DESC L_55 ) ;
return 0 ;
}
