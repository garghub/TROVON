...
struct V_1 * V_2 ;
struct V_10 * V_11 = F_93 ( V_15 ) ;
int V_112 = F_111 ( V_15 , V_112 ) ;
int V_113 ;
int V_27 ;
V_7 = F_73 ( sizeof( struct V_6 ) , V_114 ) ;
if ( ! V_7 ) {
F_41 ( V_11 , L_16 ) ;
return - V_115 ;
}
V_2 = F_73 ( sizeof( struct V_1 ) * V_112 , V_114 ) ;
if ( ! V_2 ) {
F_41 ( V_11 , L_17 ) ;
V_27 = - V_115 ;
goto V_116;
}
F_112 ( V_15 , & V_7 -> V_99 , V_117 ) ;
V_7 -> V_99 . V_59 = L_18 ;
V_7 -> V_99 . V_118 = F_108 ;
V_7 -> V_99 . V_119 = F_109 ;
V_7 -> V_2 = V_2 ;
V_7 -> V_120 = V_112 ;
F_113 ( V_7 ) ;
V_7 -> V_29 . V_11 . V_121 = V_11 ;
V_7 -> V_29 . V_59 = L_19 ;
V_7 -> V_29 . V_122 = & V_123 ;
V_7 -> V_29 . V_107 = V_124 ;
F_114 ( & V_7 -> V_29 . V_125 ) ;
F_115 (uep, gpriv, i) {
V_2 -> V_7 = V_7 ;
V_2 -> V_9 = NULL ;
snprintf ( V_2 -> V_126 , V_127 , L_20 , V_113 ) ;
V_2 -> V_13 . V_59 = V_2 -> V_126 ;
V_2 -> V_13 . V_122 = & V_128 ;
F_114 ( & V_2 -> V_13 . V_125 ) ;
if ( F_116 ( V_2 ) ) {
V_7 -> V_29 . V_129 = & V_2 -> V_13 ;
F_117 ( & V_2 -> V_13 , 64 ) ;
}
else {
F_117 ( & V_2 -> V_13 , 512 ) ;
F_118 ( & V_2 -> V_13 . V_125 , & V_7 -> V_29 . V_125 ) ;
}
}
