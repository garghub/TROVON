...
struct V_233 * V_234 )
{
int V_155 = V_234 -> V_77 , V_235 = 0 , V_236 = 0 ;
struct V_237 V_238 ;
if ( ! V_15 || ! V_15 -> V_213 || ! V_15 -> V_129 )
return - 1 ;
memset ( & V_238 , 0 , sizeof( struct V_237 ) ) ;
F_109 ( & V_238 . V_239 , V_240 | V_241 ,
V_234 -> V_189 , V_234 -> V_187 , V_155 ) ;
while ( V_236 < V_155 ) {
V_235 = F_110 ( V_15 -> V_213 , & V_238 ,
( V_155 - V_236 ) , V_242 ) ;
if ( V_235 <= 0 ) {
F_25 ( L_45 ,
V_235 , V_236 ) ;
...
V_217 = V_234 -> V_189 ;
V_207 = V_234 -> V_187 ;
V_48 = F_112 ( V_15 -> V_213 , & V_238 , V_217 , V_207 ,
V_234 -> V_77 ) ;
if ( V_48 != V_234 -> V_77 ) {
F_3 ( L_48 ,
V_48 , V_234 -> V_77 ) ;
...
if ( ! V_15 || ! V_15 -> V_213 || ! V_15 -> V_129 )
return - 1 ;
memset ( & V_244 , 0 , sizeof( struct V_233 ) ) ;
V_244 . V_189 = V_189 ;
V_244 . V_187 = V_187 ;
V_244 . V_77 = V_155 ;
V_244 . type = V_245 ;
return F_108 ( V_15 , & V_244 ) ;
}
int F_98 (
struct V_21 * V_15 ,
struct V_188 * V_189 ,
...
V_250 = & V_164 -> V_251 ;
F_43 ( & V_250 -> V_167 ) ;
if ( ! strcmp ( V_15 -> V_252 , V_250 -> V_253 ) &&
( ( F_88 () - V_250 -> V_254 ) < 10 ) ) {
F_44 ( & V_250 -> V_167 ) ;
return;
}
...
V_15 -> V_273 ) ;
F_116 ( V_250 -> V_275 ,
( V_248 ? V_248 -> V_276 : L_50 ) ,
sizeof( V_250 -> V_275 ) ) ;
V_250 -> V_277 = V_15 -> V_278 ;
snprintf ( V_250 -> V_253 , V_279 ,
L_51 , V_15 -> V_252 ) ;
V_250 -> V_254 = F_88 () ;
}
F_44 ( & V_250 -> V_167 ) ;
}
struct V_163 * F_114 ( struct V_21 * V_15 )
{
struct V_161 * V_162 ;
if ( ! V_15 || ! V_15 -> V_25 )
return NULL ;
