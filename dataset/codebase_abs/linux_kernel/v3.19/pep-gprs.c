...
static int F_32 ( struct V_9 * V_10 , int V_42 )
{
if ( ( V_42 < 576 ) || ( V_42 > ( V_43 - 11 ) ) )
return - V_18 ;
V_10 -> V_44 = V_42 ;
return 0 ;
}
...
{
static const char V_58 [] = L_2 ;
struct V_7 * V_8 ;
struct V_9 * V_10 ;
int V_16 ;
if ( F_35 ( V_11 -> V_59 == V_60 ) )
return - V_18 ;
V_10 = F_36 ( sizeof( * V_8 ) , V_58 , V_61 , F_33 ) ;
if ( ! V_10 )
return - V_62 ;
V_8 = F_26 ( V_10 ) ;
V_8 -> V_11 = V_11 ;
