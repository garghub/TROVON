...
static int F_26 ( struct V_22 * V_23 , unsigned int V_109 ,
T_2 * V_58 )
{
if ( V_109 >= F_18 ( V_110 ) )
return - V_38 ;
...
static int F_27 ( struct V_22 * V_23 , struct V_111 * V_112 )
{
V_112 -> V_113 . V_114 = 0 ;
V_112 -> V_113 . V_115 = 0 ;
V_112 -> V_113 . V_46 = V_92 ;
V_112 -> V_113 . V_47 = V_116 ;
V_112 -> type = V_117 ;
return 0 ;
}
static int F_28 ( struct V_22 * V_23 , struct V_118 * V_112 )
{
V_112 -> V_119 . V_114 = 0 ;
V_112 -> V_119 . V_115 = 0 ;
V_112 -> V_119 . V_46 = V_92 ;
V_112 -> V_119 . V_47 = V_116 ;
V_112 -> V_120 = V_112 -> V_119 ;
V_112 -> type = V_117 ;
V_112 -> V_121 . V_122 = 1 ;
V_112 -> V_121 . V_123 = 1 ;
return 0 ;
...
break;
default:
F_3 ( & V_2 -> V_16 , L_9 , V_124 , V_125 ) ;
V_5 = - V_137 ;
goto V_133;
}
F_32 ( & V_2 -> V_16 , L_10 ,
V_128 , V_124 , V_125 , V_126 , V_127 ) ;
V_5 = F_33 ( & V_28 -> V_30 ) ;
V_133:
F_13 ( & V_28 -> V_31 , 0 ) ;
return V_5 ;
...
struct V_1 * V_2 = F_10 ( V_23 ) ;
struct V_43 * V_44 = F_14 ( V_2 ) ;
V_139 -> V_10 = V_140 | V_141 |
V_142 | V_143 |
V_144 ;
V_139 -> type = V_145 ;
V_139 -> V_10 = F_35 ( V_44 , V_139 ) ;
return 0 ;
}
...
V_28 = F_37 ( & V_2 -> V_16 , sizeof( struct V_27 ) , V_148 ) ;
if ( ! V_28 ) {
F_3 ( & V_2 -> V_16 ,
L_12 ) ;
return - V_149 ;
}
F_38 ( & V_28 -> V_31 , V_2 , & V_150 ) ;
F_39 ( & V_28 -> V_30 , 2 ) ;
F_40 ( & V_28 -> V_30 , & V_151 ,
V_33 , 0 , 1 , 1 , 0 ) ;
F_40 ( & V_28 -> V_30 , & V_151 ,
V_36 , 0 , 1 , 1 , 0 ) ;
V_28 -> V_31 . V_152 = & V_28 -> V_30 ;
if ( V_28 -> V_30 . error )
