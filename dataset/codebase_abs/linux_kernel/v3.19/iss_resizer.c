...
switch ( V_156 ) {
case V_70 :
for ( V_163 = 0 ; V_163 < F_33 ( V_164 ) ; V_163 ++ ) {
if ( V_160 -> V_76 == V_164 [ V_163 ] )
break;
}
if ( V_163 >= F_33 ( V_164 ) )
V_160 -> V_76 = V_77 ;
...
case V_71 :
V_161 = V_160 -> V_76 ;
V_162 = F_30 ( V_2 , V_155 , V_70 ,
V_158 ) ;
memcpy ( V_160 , V_162 , sizeof( * V_160 ) ) ;
if ( ( V_161 == V_78 ) &&
( V_160 -> V_76 == V_77 ) )
V_160 -> V_76 = V_161 ;
...
switch ( V_76 -> V_156 ) {
case V_70 :
if ( V_76 -> V_170 >= F_33 ( V_164 ) )
return - V_171 ;
V_76 -> V_76 = V_164 [ V_76 -> V_170 ] ;
break;
case V_71 :
V_162 = F_30 ( V_2 , V_155 , V_70 ,
V_159 ) ;
if ( V_76 -> V_170 == 0 ) {
V_76 -> V_76 = V_162 -> V_76 ;
break;
}
switch ( V_162 -> V_76 ) {
case V_77 :
...
if ( V_173 -> V_170 != 0 )
return - V_171 ;
V_162 . V_76 = V_173 -> V_76 ;
V_162 . V_101 = 1 ;
V_162 . V_82 = 1 ;
F_32 ( V_2 , V_155 , V_173 -> V_156 , & V_162 ,
V_159 ) ;
V_173 -> V_174 = V_162 . V_101 ;
V_173 -> V_175 = V_162 . V_82 ;
if ( V_162 . V_76 != V_173 -> V_76 )
return - V_171 ;
V_162 . V_76 = V_173 -> V_76 ;
V_162 . V_101 = - 1 ;
V_162 . V_82 = - 1 ;
F_32 ( V_2 , V_155 , V_173 -> V_156 , & V_162 ,
V_159 ) ;
V_173 -> V_176 = V_162 . V_101 ;
V_173 -> V_177 = V_162 . V_82 ;
return 0 ;
}
...
struct V_1 * V_2 = F_24 ( V_140 ) ;
struct V_66 * V_162 ;
V_162 = F_30 ( V_2 , V_155 , V_160 -> V_156 , V_160 -> V_158 ) ;
if ( V_162 == NULL )
return - V_171 ;
V_160 -> V_162 = * V_162 ;
return 0 ;
...
if ( V_162 == NULL )
return - V_171 ;
F_32 ( V_2 , V_155 , V_160 -> V_156 , & V_160 -> V_162 , V_160 -> V_158 ) ;
* V_162 = V_160 -> V_162 ;
if ( V_160 -> V_156 == V_70 ) {
V_162 = F_30 ( V_2 , V_155 ,
V_71 ,
V_160 -> V_158 ) ;
* V_162 = V_160 -> V_162 ;
F_32 ( V_2 , V_155 , V_71 , V_162 ,
V_160 -> V_158 ) ;
}
return 0 ;
}
...
struct V_178 * V_182 )
{
if ( V_181 -> V_162 . V_101 != V_182 -> V_162 . V_101 ||
V_181 -> V_162 . V_82 != V_182 -> V_162 . V_82 )
return - V_183 ;
if ( V_181 -> V_162 . V_76 != V_182 -> V_162 . V_76 )
return - V_183 ;
return 0 ;
}
...
V_162 . V_156 = V_70 ;
V_162 . V_158 = V_155 ? V_159 : V_184 ;
V_162 . V_162 . V_76 = V_77 ;
V_162 . V_162 . V_101 = 4096 ;
V_162 . V_162 . V_82 = 4096 ;
F_38 ( V_140 , V_155 , & V_162 ) ;
return 0 ;
}
static int F_41 ( struct V_185 * V_123 ,
...
struct V_1 * V_2 = F_24 ( V_140 ) ;
struct V_3 * V_4 = F_2 ( V_2 ) ;
switch ( V_187 -> V_170 | F_43 ( V_188 -> V_123 ) ) {
case V_70 | V_190 :
if ( ! ( V_189 & V_191 ) ) {
V_2 -> V_90 = V_192 ;
break;
...
if ( V_2 -> V_90 != V_192 )
return - V_193 ;
if ( V_188 -> V_123 == & V_4 -> V_194 . V_122 . V_123 )
V_2 -> V_90 = V_91 ;
else if ( V_188 -> V_123 == & V_4 -> V_195 . V_122 . V_123 )
V_2 -> V_90 = V_196 ;
break;
case V_71 | V_197 :
if ( V_189 & V_191 ) {
...
struct V_185 * V_199 = & V_140 -> V_123 ;
int V_141 ;
V_2 -> V_90 = V_192 ;
F_45 ( V_140 , & V_200 ) ;
V_140 -> V_201 = & V_202 ;
F_46 ( V_140 -> V_203 , L_4 , sizeof( V_140 -> V_203 ) ) ;
V_140 -> V_204 = 1 << 16 ;
F_47 ( V_140 , V_2 ) ;
V_140 -> V_189 |= V_205 ;
...
V_199 -> V_208 = & V_209 ;
V_141 = F_48 ( V_199 , V_210 , V_198 , 0 ) ;
if ( V_141 < 0 )
return V_141 ;
F_40 ( V_140 , NULL ) ;
V_2 -> V_80 . type = V_211 ;
...
V_2 -> V_80 . V_213 = F_49 ( 4096 * 4096 ) * 3 ;
V_2 -> V_80 . V_214 = 32 ;
V_2 -> V_80 . V_215 = 1 ;
...
{
int V_141 ;
V_141 = F_57 ( V_218 , & V_2 -> V_122 ) ;
if ( V_141 < 0 )
goto error;
V_141 = F_58 ( & V_2 -> V_80 , V_218 ) ;
if ( V_141 < 0 )
goto error;
return 0 ;
error:
