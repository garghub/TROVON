...
F_103 ( & V_5 -> V_9 , V_306 ) ;
V_60 -> V_305 = V_305 ;
V_60 -> V_62 = F_104 ( V_305 ) ;
V_60 -> V_74 = V_305 -> V_308 & V_195 ;
V_60 -> V_66 = V_66 ;
V_60 -> V_309 = 0 ;
V_60 -> V_181 = FALSE ;
V_60 -> V_182 = FALSE ;
V_60 -> V_60 . V_64 = F_105 ( V_305 -> V_310 ) ;
F_21 ( V_5 , V_60 ) ;
F_18 ( V_5 , V_60 ) ;
F_106 ( & V_5 -> V_9 , V_306 ) ;
return 0 ;
...
static struct V_15 * F_108 (
struct V_13 * V_60 ,
T_8 V_311 )
{
struct V_113 * V_37 ;
V_37 = F_109 ( sizeof( * V_37 ) , V_311 ) ;
if ( ! V_37 )
return 0 ;
#ifdef F_47
V_37 -> V_37 . V_39 = V_114 ;
...
if ( V_37 -> V_115 ) {
if ( V_60 -> V_125 == NULL )
V_60 -> V_125 = ( T_2 * ) F_115 (
NULL , V_312 ,
& V_60 -> V_116 , V_313 | V_314 ) ;
if ( V_60 -> V_62 > 0 ) {
if ( V_60 -> V_74 == V_119 )
...
static int F_120 ( struct V_13 * V_14 , int V_315 )
{
T_2 V_175 ;
unsigned long V_306 ;
struct V_59 * V_60 ;
...
static int F_124 ( struct V_316 * V_317 )
{
T_1 V_47 ;
struct V_4 * V_5 ;
if ( V_317 == NULL ) {
...
V_5 = F_101 ( V_317 , struct V_4 , V_117 ) ;
if ( V_5 == NULL ) {
F_9 ( L_34 , V_8 ) ;
return - V_63 ;
}
...
if ( V_47 == 0 )
return - V_63 ;
V_47 = F_1 ( & V_5 -> V_53 -> V_216 ) & V_318 ;
return V_47 ;
}
static int F_125 ( struct V_316 * V_317 )
{
int V_6 ;
T_1 V_47 ;
struct V_4 * V_5 ;
...
F_5 ( & V_5 -> V_53 -> V_265 , V_319 ) ;
for ( V_6 = 0 ; V_6 < V_251 ; V_6 ++ ) {
V_47 = F_1 ( & V_5 -> V_53 -> V_265 ) ;
if ( V_47 & V_276 )
break;
}
F_6 ( & V_5 -> V_53 -> V_265 , V_319 ) ;
return 0 ;
}
static int F_127 ( struct V_316 * V_317 ,
int V_320 )
{
struct V_4 * V_5 ;
unsigned long V_306 ;
...
static int F_128 ( struct V_316 * V_317 , int V_321 )
{
return 0 ;
}
static int F_129 ( struct V_316 * V_317 , unsigned V_322 )
{
struct V_4 * V_5 ;
unsigned long V_306 ;
if ( V_317 == NULL ) {
...
static int F_130 ( struct V_316 * V_317 , int V_260 )
{
struct V_4 * V_5 ;
unsigned long V_306 ;
if ( V_317 == NULL ) {
...
V_60 -> V_5 = V_5 ;
V_60 -> V_305 = NULL ;
V_60 -> V_60 . V_326 = NULL ;
V_60 -> V_60 . V_325 = V_325 ;
V_60 -> V_60 . V_327 = & V_328 ;
if ( isdigit ( V_325 [ 2 ] ) ) {
long V_45 ;
int V_329 ;
char V_330 [ 2 ] ;
V_330 [ 0 ] = V_325 [ 2 ] ;
V_330 [ 1 ] = '\0' ;
V_329 = F_133 ( V_330 , 16 , & V_45 ) ;
if ( V_45 == 0 )
V_60 -> V_60 . V_64 = V_137 ;
else
V_60 -> V_60 . V_64 = V_331 ;
} else {
V_60 -> V_60 . V_64 = V_331 ;
}
F_116 ( & V_60 -> V_60 . V_332 , & V_5 -> V_117 . V_332 ) ;
F_110 ( & V_60 -> V_173 ) ;
}
static void T_9 F_134 ( struct V_4 * V_5 )
{
int V_6 ;
F_110 ( & V_5 -> V_117 . V_332 ) ;
V_5 -> V_117 . V_333 = & V_5 -> V_60 [ 0 ] . V_60 ;
for ( V_6 = 0 ; V_6 < V_52 ; V_6 ++ )
F_132 ( V_5 , & V_5 -> V_60 [ V_6 ] , V_334 [ V_6 ] ) ;
F_74 ( & V_5 -> V_60 [ 0 ] . V_60 . V_332 ) ;
}
static int T_9 F_135 (
struct V_335 * V_336 ,
struct V_4 * V_5 )
{
F_136 ( & V_5 -> V_9 ) ;
...
V_5 -> V_336 = V_336 ;
V_5 -> V_322 = 0 ;
V_5 -> V_336 -> V_10 . V_337 = F_137 ( 32 ) ;
F_134 ( V_5 ) ;
V_5 -> V_117 . V_327 = & V_338 ;
V_5 -> V_117 . V_333 = & V_5 -> V_60 [ 0 ] . V_60 ;
V_5 -> V_117 . V_203 = V_244 ;
V_5 -> V_117 . V_325 = V_339 ;
F_138 ( & V_5 -> V_117 . V_10 ) ;
F_139 ( & V_5 -> V_117 . V_10 , L_37 ) ;
V_5 -> V_117 . V_10 . V_118 = & V_336 -> V_10 ;
V_5 -> V_117 . V_10 . V_340 = V_336 -> V_10 . V_340 ;
return 0 ;
}
static int F_140 ( struct V_335 * V_336 )
{
int V_42 = - V_341 ;
struct V_4 * V_5 ;
struct V_342 * V_343 ;
...
F_141 ( V_336 , V_5 ) ;
V_343 = F_142 ( V_336 , V_346 , 0 ) ;
V_344 = F_143 ( & V_336 -> V_10 , V_343 ) ;
if ( F_144 ( V_344 ) )
return F_145 ( V_344 ) ;
V_293 = F_146 ( V_336 , 0 ) ;
if ( V_293 < 0 ) {
F_147 ( & V_336 -> V_10 , L_38 ) ;
return V_293 ;
}
V_42 = F_148 ( & V_336 -> V_10 , V_293 , F_99 ,
0 , V_339 , V_5 ) ;
V_5 -> V_53 = ( T_5 ) V_344 ;
if ( V_42 != 0 ) {
F_9 ( L_39 ) ;
...
static int T_11 F_153 ( struct V_335 * V_336 )
{
struct V_4 * V_5 ;
struct V_59 * V_60 ;
int V_6 ;
...
static int F_156 ( struct V_335 * V_336 , T_12 V_351 )
{
struct V_4 * V_5 ;
V_5 = F_152 ( V_336 ) ;
if ( V_5 == NULL )
...
static int F_157 ( struct V_335 * V_336 )
{
T_1 V_47 ;
struct V_4 * V_5 ;
V_5 = F_152 ( V_336 ) ;
