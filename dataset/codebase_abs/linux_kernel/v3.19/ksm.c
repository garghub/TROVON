...
V_22 -> V_146 == F_170 ( V_20 , V_36 ) ) {
return V_22 ;
}
if ( ! F_171 ( V_22 ) )
return V_22 ;
V_145 = F_172 ( V_147 , V_20 , V_36 ) ;
if ( V_145 ) {
F_173 ( V_145 , V_22 , V_36 , V_20 ) ;
F_174 ( V_145 ) ;
F_175 ( V_145 ) ;
F_176 ( V_145 ) ;
}
...
int F_177 ( struct V_22 * V_22 , struct V_148 * V_149 )
{
struct V_5 * V_5 ;
struct V_2 * V_2 ;
int V_23 = V_150 ;
...
continue;
if ( V_149 -> V_154 && V_149 -> V_154 ( V_20 , V_149 -> V_155 ) )
continue;
V_23 = V_149 -> V_156 ( V_22 , V_20 ,
V_2 -> V_36 , V_149 -> V_155 ) ;
if ( V_23 != V_150 ) {
F_182 ( V_35 ) ;
goto V_3;
}
if ( V_149 -> V_157 && V_149 -> V_157 ( V_22 ) ) {
F_182 ( V_35 ) ;
goto V_3;
}
}
...
void F_183 ( struct V_22 * V_158 , struct V_22 * V_159 )
{
struct V_5 * V_5 ;
F_178 ( ! F_179 ( V_159 ) , V_159 ) ;
F_178 ( ! F_179 ( V_158 ) , V_158 ) ;
F_178 ( V_158 -> V_56 != V_159 -> V_56 , V_158 ) ;
V_5 = F_124 ( V_158 ) ;
if ( V_5 ) {
F_178 ( V_5 -> V_39 != F_90 ( V_159 ) , V_159 ) ;
V_5 -> V_39 = F_90 ( V_158 ) ;
F_184 () ;
F_66 ( V_159 , NULL ) ;
}
...
while ( V_123 & V_160 ) {
F_151 ( & V_126 ) ;
F_185 ( & V_123 , F_186 ( V_160 ) ,
V_161 ) ;
F_149 ( & V_126 ) ;
}
}
static void F_187 ( unsigned long V_162 ,
unsigned long V_163 )
{
struct V_5 * V_5 ;
struct V_74 * V_75 , * V_42 ;
...
unsigned long V_166 , void * V_155 )
{
...
static T_6 F_193 ( struct V_174 * V_175 ,
struct V_176 * V_177 , char * V_178 )
{
return sprintf ( V_178 , L_1 , V_128 ) ;
}
static T_6 F_194 ( struct V_174 * V_175 ,
struct V_176 * V_177 ,
const char * V_178 , T_7 V_179 )
{
unsigned long V_180 ;
int V_69 ;
V_69 = F_195 ( V_178 , 10 , & V_180 ) ;
if ( V_69 || V_180 > V_181 )
return - V_182 ;
V_128 = V_180 ;
return V_179 ;
...
int V_69 ;
unsigned long V_171 ;
V_69 = F_195 ( V_178 , 10 , & V_171 ) ;
if ( V_69 || V_171 > V_181 )
return - V_182 ;
V_127 = V_171 ;
return V_179 ;
}
static T_6 F_198 ( struct V_174 * V_175 , struct V_176 * V_177 ,
char * V_178 )
{
return sprintf ( V_178 , L_2 , V_123 ) ;
}
static T_6 F_199 ( struct V_174 * V_175 , struct V_176 * V_177 ,
const char * V_178 , T_7 V_179 )
{
int V_69 ;
unsigned long V_85 ;
V_69 = F_195 ( V_178 , 10 , & V_85 ) ;
if ( V_69 || V_85 > V_181 )
return - V_182 ;
if ( V_85 > V_142 )
return - V_182 ;
...
static T_6 F_202 ( struct V_174 * V_175 ,
struct V_176 * V_177 , char * V_178 )
{
return sprintf ( V_178 , L_1 , V_40 ) ;
}
static T_6 F_203 ( struct V_174 * V_175 ,
struct V_176 * V_177 ,
const char * V_178 , T_7 V_179 )
{
int V_69 ;
unsigned long V_184 ;
V_69 = F_195 ( V_178 , 10 , & V_184 ) ;
if ( V_69 )
return V_69 ;
if ( V_184 > 1 )
return - V_182 ;
...
struct V_108 * V_178 ;
V_178 = F_204 ( V_186 + V_186 , sizeof( * V_178 ) ,
V_11 ) ;
if ( ! V_178 )
V_69 = - V_10 ;
else {
...
F_151 ( & V_126 ) ;
return V_69 ? V_69 : V_179 ;
}
static T_6 F_205 ( struct V_174 * V_175 ,
struct V_176 * V_177 , char * V_178 )
{
return sprintf ( V_178 , L_2 , V_44 ) ;
}
...
static T_6 F_207 ( struct V_174 * V_175 ,
struct V_176 * V_177 , char * V_178 )
{
return sprintf ( V_178 , L_2 , V_65 ) ;
}
...
struct V_176 * V_177 , char * V_178 )
{
return sprintf ( V_178 , L_2 , V_62 . V_63 ) ;
}
