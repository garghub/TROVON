...
V_154 = F_87 ( V_158 , V_163 , 0 ) ;
V_22 -> V_28 = F_88 ( & V_158 -> V_23 , V_154 ) ;
if ( F_73 ( V_22 -> V_28 ) )
return F_74 ( V_22 -> V_28 ) ;
V_116 = F_89 ( & V_158 -> V_23 , & V_22 -> V_51 ) ;
if ( V_116 )
return V_116 ;
F_90 ( & V_22 -> V_27 ) ;
V_160 = F_91 () ;
...
* V_160 = V_165 ;
V_160 -> V_166 = & V_22 -> V_27 ;
V_160 -> V_51 = & V_22 -> V_51 ;
F_92 ( V_160 , V_22 ) ;
snprintf ( V_160 -> V_95 , sizeof( V_160 -> V_95 ) , L_26 , V_165 . V_95 ) ;
V_22 -> V_160 = V_160 ;
F_93 ( & V_22 -> V_51 , V_167
L_27 , V_160 -> V_91 ) ;
F_94 ( V_158 , V_22 ) ;
V_162 = F_95 ( V_158 , 0 ) ;
V_116 = F_96 ( & V_158 -> V_23 , V_162 , F_21 , 0 ,
F_97 ( & V_158 -> V_23 ) , V_22 ) ;
if ( V_116 )
goto V_168;
...
{
struct V_21 * V_22 = F_107 ( V_158 ) ;
F_93 ( & V_22 -> V_51 , L_31 V_167 ) ;
F_108 ( V_22 -> V_160 ) ;
F_101 ( V_22 -> V_25 ) ;
F_102 ( V_22 -> V_130 ) ;
F_104 ( & V_22 -> V_51 ) ;
