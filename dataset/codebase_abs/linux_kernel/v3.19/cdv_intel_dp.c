...
V_93 |= ( ( T_6 ) V_90 [ V_92 ] ) << ( ( 3 - V_92 ) * 8 ) ;
return V_93 ;
}
static void
F_34 ( T_6 V_90 , T_1 * V_94 , int V_95 )
{
int V_92 ;
if ( V_95 > 4 )
V_95 = 4 ;
...
{
struct V_41 * V_42 = V_39 -> V_43 ;
T_6 V_100 = V_42 -> V_100 ;
struct V_58 * V_59 = V_39 -> V_60 . V_59 ;
T_6 V_101 = V_100 + 0x10 ;
T_6 V_102 = V_101 + 4 ;
int V_92 ;
int V_103 ;
T_6 V_104 ;
...
static bool
F_67 ( struct V_38 * V_39 , T_7 V_10 ,
T_1 * V_98 , int V_103 )
{
int V_8 , V_92 ;
for ( V_92 = 0 ; V_92 < 3 ; V_92 ++ ) {
