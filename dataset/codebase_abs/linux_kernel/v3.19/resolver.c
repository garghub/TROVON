...
T_1 = V_14 ;
* ( V_34 * ) ( V_18 -> V_14 + V_25 ) = F_12 ( T_1 ) ;
}
V_32:
F_18 ( V_19 ) ;
return V_27 ;
}
static int F_19 ( const struct V_1 * V_35 ,
...
F_10 ( V_16 -> V_12 , L_1 ) == 0 ||
F_10 ( V_16 -> V_12 , L_2 ) == 0 )
continue;
...
if ( V_9 ) {
T_1 = F_21 ( * ( V_34 * ) ( V_18 -> V_14 + V_43 ) ) ;
T_1 += V_9 ;
* ( V_34 * ) ( V_18 -> V_14 + V_43 ) = F_12 ( T_1 ) ;
}
}
}
F_3 (node, child) {
F_3 (target, childtarget)
if ( F_19 ( V_4 , V_40 ) == 0 )
break;
if ( ! V_40 ) {
F_15 ( L_14 ,
...
T_1 T_1 , V_9 ;
int V_27 ;
if ( ! V_44 || ! F_23 ( V_44 , V_50 ) )
return - V_31 ;
V_9 = F_4 () + 1 ;
F_8 ( V_44 , V_9 ) ;
V_45 = NULL ;
F_3 (resolve, childroot)
