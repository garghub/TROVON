...
int F_29 ( struct V_41 * V_42 , int V_54 , int type , int V_55 , void * V_56 )
{
...
int V_44 ;
if ( V_62 & V_42 -> V_63 )
return F_30 ( V_42 , V_54 , type , V_55 , V_56 ) ;
...
V_60 . V_28 = V_61 ;
V_44 = - V_66 ;
if ( F_31 ( V_57 , & V_60 , sizeof V_60 ) )
goto V_67;
if ( F_31 ( F_13 ( V_57 ) , V_56 , V_61 - sizeof( struct V_18 ) ) )
goto V_67;
V_61 = F_32 ( V_55 ) ;
if ( V_42 -> V_64 < V_61 )
V_61 = V_42 -> V_64 ;
...
void F_33 ( struct V_41 * V_42 , struct V_37 * V_38 )
{
struct V_18 T_4 * V_57
= ( V_58 struct V_18 T_4 * ) V_42 -> V_59 ;
int V_68 = 0 ;
...
V_40 = F_39 ( V_34 [ V_26 ] , & V_44 ) ;
if ( V_40 ) {
F_40 ( V_40 -> V_74 ) ;
F_41 ( V_40 -> V_74 ) ;
}
F_42 ( V_71 , F_43 ( V_34 [ V_26 ] ) ) ;
}
if ( V_26 > 0 )
{
int V_61 = F_23 ( V_26 * sizeof( int ) ) ;
V_44 = F_37 ( V_46 , & V_57 -> V_45 ) ;
if ( ! V_44 )
V_44 = F_37 ( V_48 , & V_57 -> V_47 ) ;
if ( ! V_44 )
V_44 = F_37 ( V_61 , & V_57 -> V_28 ) ;
if ( ! V_44 ) {
V_61 = F_32 ( V_26 * sizeof( int ) ) ;
V_42 -> V_59 += V_61 ;
V_42 -> V_64 -= V_61 ;
}
}
...
struct V_20 * F_44 ( struct V_20 * V_23 )
{
struct V_20 * V_75 ;
int V_26 ;
if ( ! V_23 )
return NULL ;
V_75 = F_45 ( V_23 , F_46 ( struct V_20 , V_34 [ V_23 -> V_32 ] ) ,
V_30 ) ;
if ( V_75 ) {
