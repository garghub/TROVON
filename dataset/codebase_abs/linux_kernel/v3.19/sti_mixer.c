...
F_4 ( V_2 , V_51 , V_18 << 16 | V_19 ) ;
F_4 ( V_2 , V_52 , V_20 << 16 | V_21 ) ;
F_7 ( V_2 , 0xFF , 0 , 0 ) ;
F_8 ( V_2 , V_17 ) ;
F_6 ( V_2 , true ) ;
return 0 ;
...
struct V_26 * V_27 , bool V_61 )
{
T_1 V_31 , V_8 ;
F_13 ( L_9 , V_61 ? L_10 : L_11 ,
F_1 ( V_2 ) , F_14 ( V_27 ) ) ;
V_31 = F_17 ( V_27 ) ;
if ( ! V_31 ) {
F_12 ( L_12 ) ;
...
T_1 V_8 ;
F_13 ( L_13 , F_1 ( V_2 ) ) ;
V_8 = F_2 ( V_2 , V_10 ) & 0xFFFF0000 ;
F_4 ( V_2 , V_10 , V_8 ) ;
}
void F_20 ( struct V_1 * V_2 )
{
unsigned int V_63 ;
for ( V_63 = 0 ; V_63 < F_21 ( V_64 ) ; V_63 ++ )
F_4 ( V_2 , V_65 + ( V_63 * 4 ) ,
V_64 [ V_63 ] ) ;
}
struct V_1 * F_22 ( struct V_66 * V_49 , int V_3 ,
void T_3 * V_67 )
{
struct V_1 * V_2 = F_23 ( V_49 , sizeof( * V_2 ) , V_68 ) ;
