...
if ( V_47 -> V_71 & V_97 )
V_53 += sprintf ( V_53 , L_34 , V_47 -> V_98 ) ;
if ( V_47 -> V_71 & V_99 ) {
const char * V_92 = NULL , * V_100 = NULL ;
F_11 ( V_47 -> V_101 , & V_92 , & V_100 ) ;
if ( V_92 != NULL && V_100 != NULL )
V_53 += sprintf ( V_53 , L_35 , V_92 , V_100 ) ;
else
...
V_53 = V_52 -> V_59 ;
if ( V_47 -> V_71 & V_102 ) {
T_2 V_103 = V_47 -> V_104 ;
V_53 += sprintf ( V_53 , L_37 , ( long long ) V_103 ) ;
switch ( ( V_103 >> 8 ) & 0xff ) {
case 1 :
...
if ( V_47 -> V_71 & V_105 )
V_53 += sprintf ( V_53 , L_56 ,
( long long ) V_47 -> V_106 ) ;
if ( V_47 -> V_71 & V_107 )
V_53 += sprintf ( V_53 , L_57 ,
( long long ) V_47 -> V_108 ) ;
if ( V_47 -> V_71 & V_109 )
V_53 += sprintf ( V_53 , L_58 ,
( long long ) V_47 -> V_108 ) ;
if ( V_53 > V_52 -> V_59 )
* ( V_53 - 1 ) = '\0' ;
V_54 = F_12 ( V_50 -> V_43 ) ;
snprintf ( V_52 -> V_110 , sizeof( V_52 -> V_110 ) ,
L_59 , V_50 -> V_82 , V_50 -> V_59 ) ;
F_13 ( type , V_50 -> V_58 , V_50 -> V_57 , V_50 -> V_56 ,
V_9 -> V_111 , V_50 -> V_60 , V_50 -> V_61 , V_50 -> V_62 ,
F_7 ( V_50 -> V_75 ) | V_50 -> V_78 ,
V_54 , V_50 -> V_112 , V_52 -> V_110 ) ;
F_14 ( type , V_9 , V_50 ) ;
}
int F_15 ( struct V_44 * V_44 , struct V_100 * V_113 )
{
bool V_114 = false ;
int V_115 , V_4 = 0 ;
struct V_8 * V_9 ;
...
void F_24 ( struct V_44 * V_44 )
{
struct V_8 * V_9 ;
struct V_51 * V_52 , * V_137 ;
