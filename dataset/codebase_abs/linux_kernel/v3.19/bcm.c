...
static int F_79 ( struct V_129 * V_130 , struct V_131 * V_5 ,
struct V_109 * V_110 , T_3 V_132 )
{
...
if ( ! V_19 -> V_134 )
return - V_135 ;
if ( V_132 < V_108 || ( V_132 - V_108 ) % V_41 )
return - V_107 ;
if ( ! V_8 && V_110 -> V_136 ) {
F_80 ( struct V_48 * , V_49 , V_110 -> V_136 ) ;
if ( V_110 -> V_137 < sizeof( * V_49 ) )
return - V_107 ;
if ( V_49 -> V_57 != V_58 )
return - V_107 ;
V_8 = V_49 -> V_59 ;
...
V_133 = F_69 ( ( V_115 * ) & V_64 , V_110 , V_108 ) ;
if ( V_133 < 0 )
return V_133 ;
F_81 ( V_6 ) ;
switch ( V_64 . V_66 ) {
case V_139 :
V_133 = F_68 ( & V_64 , V_110 , V_8 , V_6 ) ;
break;
case V_140 :
V_133 = F_76 ( & V_64 , V_110 , V_8 , V_6 ) ;
break;
case V_141 :
...
case V_143 :
V_64 . V_66 = V_144 ;
V_133 = F_67 ( & V_19 -> V_113 , & V_64 , V_8 ) ;
break;
case V_145 :
V_64 . V_66 = V_146 ;
V_133 = F_67 ( & V_19 -> V_128 , & V_64 , V_8 ) ;
break;
case V_147 :
if ( ( V_64 . V_27 != 1 ) || ( V_132 != V_41 + V_108 ) )
V_133 = - V_107 ;
else
V_133 = F_78 ( V_110 , V_8 , V_6 ) ;
break;
default:
V_133 = - V_107 ;
break;
...
static int F_83 ( struct V_148 * V_149 , unsigned long V_110 ,
void * V_150 )
{
struct V_9 * V_10 = F_84 ( V_150 ) ;
struct V_4 * V_19 = F_36 ( V_149 , struct V_4 , V_151 ) ;
...
F_89 ( & V_19 -> V_113 ) ;
F_89 ( & V_19 -> V_128 ) ;
V_19 -> V_151 . V_161 = F_83 ;
F_90 ( & V_19 -> V_151 ) ;
return 0 ;
}
static int F_91 ( struct V_131 * V_5 )
{
struct V_5 * V_6 = V_5 -> V_6 ;
struct V_4 * V_19 ;
struct V_20 * V_21 , * V_162 ;
if ( V_6 == NULL )
return 0 ;
V_19 = F_2 ( V_6 ) ;
F_92 ( & V_19 -> V_151 ) ;
...
static int F_96 ( struct V_131 * V_5 , struct V_165 * V_166 , int V_167 ,
int V_28 )
{
struct V_48 * V_49 = (struct V_48 * ) V_166 ;
struct V_5 * V_6 = V_5 -> V_6 ;
struct V_4 * V_19 = F_2 ( V_6 ) ;
if ( V_167 < sizeof( * V_49 ) )
return - V_107 ;
if ( V_19 -> V_134 )
return - V_168 ;
if ( V_49 -> V_59 ) {
...
V_19 -> V_134 = 1 ;
if ( V_163 ) {
sprintf ( V_19 -> V_164 , L_24 , F_97 ( V_6 ) ) ;
V_19 -> V_160 = F_98 ( V_19 -> V_164 , 0644 ,
V_163 ,
& V_169 , V_6 ) ;
}
return 0 ;
}
static int F_99 ( struct V_129 * V_130 , struct V_131 * V_5 ,
struct V_109 * V_110 , T_3 V_132 , int V_28 )
{
struct V_5 * V_6 = V_5 -> V_6 ;
struct V_36 * V_37 ;
int error = 0 ;
...
V_170 = V_28 & V_171 ;
V_28 &= ~ V_171 ;
V_37 = F_100 ( V_6 , V_28 , V_170 , & error ) ;
if ( ! V_37 )
return error ;
if ( V_37 -> V_167 < V_132 )
V_132 = V_37 -> V_167 ;
V_51 = F_101 ( V_110 , V_37 -> V_3 , V_132 ) ;
if ( V_51 < 0 ) {
F_102 ( V_6 , V_37 ) ;
return V_51 ;
}
...
V_110 -> V_137 = sizeof( struct V_48 ) ;
memcpy ( V_110 -> V_136 , V_37 -> V_56 , V_110 -> V_137 ) ;
}
F_102 ( V_6 , V_37 ) ;
return V_132 ;
}
...
{
int V_51 ;
F_106 ( L_25 V_172 L_26 ) ;
V_51 = F_107 ( & V_173 ) ;
if ( V_51 < 0 ) {
F_62 ( V_104 L_27 ) ;
return V_51 ;
}
V_163 = F_108 ( L_28 , V_11 . V_174 ) ;
return 0 ;
}
