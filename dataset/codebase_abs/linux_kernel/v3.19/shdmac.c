...
static int F_63 ( struct V_120 * V_37 )
{
return 0 ;
}
static int F_64 ( struct V_120 * V_37 )
{
struct V_3 * V_4 = F_62 ( V_37 ) ;
int V_30 , V_97 ;
V_97 = F_16 ( V_4 ) ;
...
static struct V_73 * F_66 ( void * V_122 , int V_30 )
{
...
int V_125 [ V_124 ] ;
#if F_68 ( V_126 ) || F_68 ( V_127 )
unsigned long V_128 = 0 ;
int V_129 ;
#endif
int V_113 , V_30 , V_130 = 0 , V_131 = 0 , V_132 = 0 ;
struct V_3 * V_4 ;
struct V_133 * V_36 ;
struct V_134 * V_33 , * V_68 , * V_135 , * V_136 ;
if ( V_112 -> V_37 . V_85 )
V_7 = F_69 ( V_137 , & V_112 -> V_37 ) -> V_16 ;
else
V_7 = F_70 ( & V_112 -> V_37 ) ;
if ( ! V_7 || ! V_7 -> V_31 )
return - V_138 ;
V_33 = F_71 ( V_112 , V_139 , 0 ) ;
V_68 = F_71 ( V_112 , V_139 , 1 ) ;
V_135 = F_71 ( V_112 , V_140 , 0 ) ;
if ( ! V_33 || ! V_135 )
return - V_138 ;
...
V_4 -> V_35 . V_148 = sizeof( struct V_75 ) ;
...
if ( V_113 < 0 )
F_51 ( & V_112 -> V_37 , L_10 , V_152 , V_113 ) ;
F_80 ( & V_25 ) ;
...
if ( V_113 )
goto V_155;
#if F_68 ( V_126 ) || F_68 ( V_156 )
V_136 = F_71 ( V_112 , V_140 , 1 ) ;
if ( ! V_136 )
V_136 = V_135 ;
else
V_131 ++ ;
...
V_128 = V_159 ;
V_129 = V_135 -> V_160 ;
V_113 = F_83 ( & V_112 -> V_37 , V_129 , F_40 , V_128 ,
L_11 , V_4 ) ;
if ( V_113 ) {
F_51 ( & V_112 -> V_37 ,
L_12 ,
...
! F_71 ( V_112 , V_140 , 1 ) ) {
for (; V_130 < V_7 -> V_31 ; V_130 ++ ) {
if ( V_130 < V_124 ) {
V_125 [ V_130 ] = V_136 -> V_160 ;
V_123 [ V_130 ] = V_159 ;
} else {
V_132 = 1 ;
break;
...
V_136 = F_71 ( V_112 ,
V_140 , ++ V_131 ) ;
} while ( V_130 < V_7 -> V_31 && V_136 );
}
for ( V_30 = 0 ; V_30 < V_130 ; V_30 ++ ) {
V_113 = F_48 ( V_4 , V_30 , V_125 [ V_30 ] , V_123 [ V_30 ] ) ;
if ( V_113 )
goto V_163;
}
if ( V_132 )
...
{
struct V_3 * V_4 = F_59 ( V_112 ) ;
struct V_133 * V_36 = & V_4 -> V_35 . V_36 ;
F_93 ( V_36 ) ;
F_80 ( & V_25 ) ;
F_88 ( & V_4 -> V_153 ) ;
F_82 ( & V_25 ) ;
