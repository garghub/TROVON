...
if ( ! V_2 -> V_89 )
return V_207 ;
V_207 = F_62 ( V_2 -> V_89 , V_90 ) ;
if ( V_207 < 0 ) {
F_43 ( V_2 , V_134 , L_61 ) ;
return V_207 ;
}
if ( V_207 & V_208 ) {
V_207 = F_97 ( V_2 -> V_89 , V_90 , V_207 & ~ V_208 ) ;
if ( V_207 < 0 ) {
F_43 ( V_2 , V_134 , L_62 ) ;
return V_207 ;
}
...
if ( ! V_2 -> V_89 )
return V_207 ;
V_207 = F_62 ( V_2 -> V_89 , V_209 ) ;
if ( V_207 < 0 ) {
F_43 ( V_2 , V_134 , L_61 ) ;
return V_207 ;
}
if ( V_207 & V_210 ) {
V_207 = F_97 ( V_2 -> V_89 , V_209 ,
V_207 & ( ~ V_210 ) ) ;
if ( V_207 < 0 ) {
F_43 ( V_2 , V_134 , L_62 ) ;
return V_207 ;
...
F_53 ( V_2 , V_224 , L_73 , V_29 -> V_136 ) ;
V_2 -> V_231 = 0 ;
F_108 () ;
V_36 = F_7 ( V_2 , V_192 ) ;
V_36 |= V_232 ;
...
static int F_113 ( struct V_23 * V_29 )
{
struct V_1 * V_2 = F_24 ( V_29 ) ;
unsigned int V_36 ;
V_36 = F_7 ( V_2 , V_230 ) ;
...
static int F_117 ( struct V_188 * V_189 , struct V_23 * V_29 )
{
struct V_1 * V_2 = F_24 ( V_29 ) ;
unsigned int V_241 ;
unsigned int V_242 ;
...
static struct V_249 * F_120 ( struct V_23 * V_29 )
{
struct V_1 * V_2 = F_24 ( V_29 ) ;
F_78 ( V_29 ) ;
V_29 -> V_160 . V_196 += F_7 ( V_2 , V_239 ) ;
...
static void F_121 ( struct V_23 * V_29 )
{
struct V_1 * V_2 = F_24 ( V_29 ) ;
unsigned long V_5 ;
if ( V_29 -> V_5 & V_250 ) {
...
static T_5 F_124 ( int V_136 , void * V_261 )
{
...
static void F_128 ( struct V_23 * V_29 )
{
F_129 ( V_29 -> V_136 ) ;
F_124 ( 0 , V_29 ) ;
F_130 ( V_29 -> V_136 ) ;
}
static int F_131 ( struct V_23 * V_29 , void * V_272 )
{
struct V_1 * V_2 = F_24 ( V_29 ) ;
struct V_273 * V_45 = V_272 ;
if ( V_2 -> V_211 <= 1 && F_132 ( V_29 ) )
return - V_274 ;
if ( ! F_133 ( V_45 -> V_275 ) )
return - V_276 ;
...
F_103 ( V_2 , V_29 -> V_213 ) ;
F_107 ( & V_2 -> V_46 ) ;
F_69 ( V_29 , L_83 , V_29 -> V_213 ) ;
return 0 ;
}
static int F_134 ( struct V_23 * V_29 , struct V_277 * V_278 , int V_279 )
{
struct V_1 * V_2 = F_24 ( V_29 ) ;
if ( ! F_132 ( V_29 ) || ! V_2 -> V_89 )
return - V_280 ;
return F_135 ( V_2 -> V_89 , V_278 , V_279 ) ;
}
static int
F_136 ( struct V_23 * V_29 , struct V_281 * V_279 )
{
struct V_1 * V_2 = F_24 ( V_29 ) ;
V_279 -> V_282 = 1 ;
V_279 -> V_283 = 1 ;
return F_137 ( V_2 -> V_89 , V_279 ) ;
}
static int
F_138 ( struct V_23 * V_29 , struct V_281 * V_279 )
{
struct V_1 * V_2 = F_24 ( V_29 ) ;
return F_139 ( V_2 -> V_89 , V_279 ) ;
}
static void F_140 ( struct V_23 * V_29 ,
struct V_284 * V_285 )
{
F_141 ( V_285 -> V_286 , V_287 , sizeof( V_285 -> V_286 ) ) ;
F_141 ( V_285 -> V_288 , V_289 , sizeof( V_285 -> V_288 ) ) ;
F_141 ( V_285 -> V_290 , F_70 ( V_29 -> V_29 . V_154 ) ,
sizeof( V_285 -> V_290 ) ) ;
}
static int F_142 ( struct V_23 * V_29 )
{
struct V_1 * V_2 = F_24 ( V_29 ) ;
return F_143 ( V_2 -> V_89 ) ;
}
...
static void F_145 ( struct V_23 * V_29 , T_1 V_292 )
{
struct V_1 * V_2 = F_24 ( V_29 ) ;
V_2 -> V_291 = V_292 ;
}
...
static void
F_147 ( struct V_23 * V_29 , struct V_296 * V_297 ,
void * V_15 )
{
struct V_1 * V_2 = F_24 ( V_29 ) ;
struct V_88 * V_89 = V_2 -> V_89 ;
...
static int F_149 ( struct V_1 * V_2 , T_1 V_299 )
{
int V_181 = 100 ;
T_1 V_300 ;
F_53 ( V_2 , V_134 , L_84 , V_299 ) ;
...
int V_25 ;
F_53 ( V_2 , V_134 , L_88 , V_302 ) ;
V_25 = F_149 ( V_2 , V_299 ) ;
if ( ! V_25 )
...
int V_30 ;
F_148 ( V_2 ) ;
V_247 = F_154 ( V_308 -> V_247 , V_306 ) ;
for ( V_30 = 0 ; V_30 < V_247 ; V_30 ++ ) {
int V_25 = F_150 ( V_2 , V_30 , V_309 ) ;
if ( V_25 < 0 ) {
V_308 -> V_247 = 0 ;
return V_25 ;
}
...
F_53 ( V_2 , V_131 , L_92 , V_29 -> V_136 ) ;
F_53 ( V_2 , V_131 , L_93 ) ;
F_158 ( & V_2 -> V_10 ) ;
F_158 ( & V_2 -> V_46 ) ;
if ( V_2 -> V_7 == NULL ) {
...
return - V_130 ;
V_29 -> V_5 |= V_318 ;
F_160 ( V_29 , & V_2 -> V_185 , F_81 , V_319 ) ;
V_29 -> V_320 = & V_321 ;
V_29 -> V_322 = & V_323 ;
return 0 ;
}
...
static int F_173 ( struct V_328 * V_4 ,
struct V_329 * V_330 )
{
const char * V_331 ;
T_1 V_332 = 0 ;
if ( ! V_330 )
return - V_130 ;
V_4 -> V_133 = F_174 ( V_330 ) ;
V_331 = F_175 ( V_330 ) ;
if ( V_331 )
memcpy ( V_4 -> V_331 , V_331 , V_92 ) ;
F_176 ( V_330 , L_107 , & V_4 -> V_333 ) ;
F_176 ( V_330 , L_108 , & V_332 ) ;
if ( V_332 == 4 )
V_4 -> V_5 |= V_6 ;
else
V_4 -> V_5 |= V_8 ;
if ( F_177 ( V_330 , L_109 , NULL ) )
V_4 -> V_226 = V_334 ;
if ( F_177 ( V_330 , L_110 , NULL ) )
V_4 -> V_228 = V_335 ;
if ( F_177 ( V_330 , L_111 , NULL ) )
V_4 -> V_5 |= V_58 ;
if ( F_177 ( V_330 , L_112 , NULL ) )
V_4 -> V_5 |= V_60 ;
if ( F_177 ( V_330 , L_113 , NULL ) )
V_4 -> V_5 |= V_317 ;
return 0 ;
}
static inline int F_173 (
struct V_328 * V_4 ,
struct V_329 * V_330 )
{
return - V_130 ;
...
struct V_23 * V_29 ;
struct V_1 * V_2 ;
struct V_328 * V_4 = F_179 ( & V_22 -> V_29 ) ;
struct V_324 * V_325 , * V_337 ;
...
V_338 = F_168 ( V_325 ) ;
V_337 = F_166 ( V_22 , V_342 , 0 ) ;
if ( ! V_337 ) {
F_180 ( L_115 ) ;
V_340 = - V_130 ;
goto V_341;
}
if ( ! F_181 ( V_325 -> V_327 , V_338 , V_287 ) ) {
V_340 = - V_274 ;
goto V_341;
}
V_29 = F_182 ( sizeof( struct V_1 ) ) ;
if ( ! V_29 ) {
V_340 = - V_144 ;
goto V_343;
}
F_183 ( V_29 , & V_22 -> V_29 ) ;
V_2 = F_24 ( V_29 ) ;
V_29 -> V_136 = V_337 -> V_327 ;
V_339 = V_337 -> V_5 & V_344 ;
V_2 -> V_7 = F_184 ( V_325 -> V_327 , V_338 ) ;
V_2 -> V_29 = V_29 ;
V_2 -> V_291 = ( ( 1 << V_345 ) - 1 ) ;
F_185 ( V_22 , V_29 ) ;
V_340 = F_33 ( V_22 ) ;
...
F_14 ( V_2 , V_230 , V_218 ) ;
F_104 ( V_29 ) ;
V_340 = F_188 ( V_29 -> V_136 , F_124 ,
V_339 | V_351 , V_29 -> V_135 , V_29 ) ;
if ( V_340 ) {
F_43 ( V_2 , V_131 ,
L_118 , V_29 -> V_136 ) ;
goto V_348;
...
V_340 = F_190 ( V_29 ) ;
if ( V_340 ) {
F_43 ( V_2 , V_131 , L_119 , V_340 ) ;
goto V_352;
} else {
F_53 ( V_2 , V_131 ,
L_120 , V_29 -> V_135 ) ;
}
V_340 = F_72 ( V_22 , V_29 ) ;
if ( V_340 ) {
F_43 ( V_2 , V_131 , L_121 , V_340 ) ;
goto V_353;
}
F_106 ( & V_2 -> V_46 ) ;
if ( F_133 ( V_29 -> V_213 ) ) {
...
F_53 ( V_2 , V_131 ,
L_122 ) ;
} else if ( F_133 ( V_2 -> V_4 . V_331 ) ) {
memcpy ( V_29 -> V_213 , V_2 -> V_4 . V_331 , V_92 ) ;
F_53 ( V_2 , V_131 ,
L_123 ) ;
} else {
F_191 ( V_29 ) ;
...
static int F_193 ( struct V_354 * V_29 )
{
...
static int F_195 ( struct V_354 * V_29 )
{
struct V_23 * V_24 = F_194 ( V_29 ) ;
struct V_1 * V_2 = F_24 ( V_24 ) ;
unsigned int V_313 = 100 ;
