...
V_7 -> V_33 = F_45 ( V_7 -> V_33 ) -> V_77 ;
F_19 ( V_7 -> V_33 ) ;
F_28 ( V_33 ) ;
}
}
static int F_46 ( struct V_78 * V_79 , unsigned long V_80 ,
void * V_81 )
{
struct V_32 * V_33 = F_47 ( V_81 ) ;
