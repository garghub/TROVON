...
int F_15 ( struct V_58 * V_59 , struct V_60 * V_60 V_22 ,
const char * V_17 ,
enum V_61 type )
{
...
V_25 [ V_33 ] != V_34 )
return - 1 ;
return V_25 [ V_37 ] == V_64 ;
}
enum V_65 F_25 ( int V_52 )
{
T_9 V_39 ;
int V_24 ;
V_24 = F_22 ( V_52 ) ;
...
int F_26 ( struct V_60 * V_60 , struct V_63 * V_63 V_22 ,
struct V_58 * V_59 ,
struct V_58 * T_13 V_22 ,
T_11 T_12 V_22 ,
int T_14 V_22 )
{
unsigned char * V_51 [ V_72 ] ;
int V_24 ;
V_24 = F_22 ( V_59 -> V_52 ) ;
if ( V_24 >= 0 )
V_60 -> V_73 = V_24 ;
if ( F_7 ( V_59 -> V_17 , V_51 , V_72 ) > 0 ) {
F_27 ( V_60 , V_51 ) ;
}
return 0 ;
}
...
int F_29 ( struct V_74 * T_18 V_22 )
{
return - 1 ;
}
void F_30 ( struct V_74 * T_18 V_22 )
{
}
