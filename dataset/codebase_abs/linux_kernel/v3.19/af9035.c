...
struct V_9 * V_9 = F_7 ( V_6 ) ;
int V_10 , V_3 ;
T_1 V_164 = ( V_6 -> V_16 -> V_165 == V_166 ? 5 : 87 ) * 188 / 4 ;
T_2 V_167 = ( V_6 -> V_16 -> V_165 == V_166 ? 64 : 512 ) / 4 ;
struct V_168 V_169 [] = {
{ 0x80f99d , 0x01 , 0x01 } ,
{ 0x80f9a4 , 0x01 , 0x01 } ,
{ 0x00dd11 , 0x00 , 0x20 } ,
...
{ 0x00dd13 , 0x00 , 0x40 } ,
{ 0x00dd11 , 0x20 , 0x20 } ,
{ 0x00dd88 , ( V_164 >> 0 ) & 0xff , 0xff } ,
{ 0x00dd89 , ( V_164 >> 8 ) & 0xff , 0xff } ,
{ 0x00dd0c , V_167 , 0xff } ,
{ 0x00dd11 , V_9 -> V_107 << 6 , 0x40 } ,
{ 0x00dd8a , ( V_164 >> 0 ) & 0xff , 0xff } ,
{ 0x00dd8b , ( V_164 >> 8 ) & 0xff , 0xff } ,
{ 0x00dd0d , V_167 , 0xff } ,
...
F_11 ( & V_6 -> V_16 -> V_17 ,
L_36 ,
V_27 , V_6 -> V_16 -> V_165 , V_164 , V_167 ) ;
for ( V_3 = 0 ; V_3 < F_43 ( V_169 ) ; V_3 ++ ) {
V_10 = F_18 ( V_6 , V_169 [ V_3 ] . V_29 , V_169 [ V_3 ] . V_30 ,
V_169 [ V_3 ] . V_35 ) ;
if ( V_10 < 0 )
goto V_49;
}
...
struct V_9 * V_9 = F_7 ( V_6 ) ;
int V_10 , V_3 ;
T_1 V_164 = ( V_6 -> V_16 -> V_165 == V_166 ? 5 : 816 ) * 188 / 4 ;
T_2 V_167 = ( V_6 -> V_16 -> V_165 == V_166 ? 64 : 512 ) / 4 ;
struct V_168 V_169 [] = {
{ 0x00da1a , 0x00 , 0x01 } ,
{ 0x00f41f , 0x04 , 0x04 } ,
...
V_27 , V_6 -> V_16 -> V_165 , V_164 , V_167 ) ;
for ( V_3 = 0 ; V_3 < F_43 ( V_169 ) ; V_3 ++ ) {
V_10 = F_18 ( V_6 , V_169 [ V_3 ] . V_29 ,
V_169 [ V_3 ] . V_30 , V_169 [ V_3 ] . V_35 ) ;
if ( V_10 < 0 )
goto V_49;
}
return 0 ;
...
if ( ( V_1 [ 2 ] + V_1 [ 3 ] ) == 0xff ) {
if ( ( V_1 [ 0 ] + V_1 [ 1 ] ) == 0xff ) {
V_170 = F_64 ( V_1 [ 0 ] , V_1 [ 2 ] ) ;
} else {
V_170 = F_65 ( V_1 [ 0 ] << 8 | V_1 [ 1 ] , V_1 [ 2 ] ) ;
}
} else {
V_170 = F_66 ( V_1 [ 0 ] << 24 | V_1 [ 1 ] << 16 |
V_1 [ 2 ] << 8 | V_1 [ 3 ] ) ;
}
F_11 ( & V_6 -> V_16 -> V_17 , L_37 , V_27 , 4 , V_1 ) ;
F_67 ( V_6 -> V_171 , V_172 , V_170 , 0 ) ;
return 0 ;
V_49:
F_11 ( & V_6 -> V_16 -> V_17 , L_4 , V_27 , V_10 ) ;
return V_10 ;
}
static int F_68 ( struct V_5 * V_6 , struct V_173 * V_174 )
{
struct V_9 * V_9 = F_7 ( V_6 ) ;
int V_10 ;
T_2 V_36 ;
V_10 = F_17 ( V_6 , V_9 -> V_70 + V_175 , & V_36 ) ;
if ( V_10 < 0 )
goto V_49;
F_11 ( & V_6 -> V_16 -> V_17 , L_38 , V_27 , V_36 ) ;
if ( V_36 == 5 ) {
V_10 = F_17 ( V_6 , V_9 -> V_70 + V_176 ,
& V_36 ) ;
if ( V_10 < 0 )
goto V_49;
F_11 ( & V_6 -> V_16 -> V_17 , L_39 , V_27 , V_36 ) ;
switch ( V_36 ) {
case 0 :
default:
V_174 -> V_177 = V_178 ;
...
static int F_69 ( struct V_143 * V_134 , T_2 * V_184 ,
struct V_185 * V_186 )
{
struct V_5 * V_6 = F_70 ( V_134 ) ;
F_11 ( & V_6 -> V_16 -> V_17 , L_40 , V_27 , F_71 ( V_134 ) -> V_133 ) ;
if ( V_6 -> V_16 -> V_165 == V_166 )
V_186 -> V_187 . V_188 . V_189 = 5 * 188 ;
return 0 ;
}
static int F_72 ( struct V_132 * V_52 , int V_190 )
{
struct V_9 * V_9 = F_50 ( V_52 ) ;
return V_9 -> V_135 . V_191 ( V_52 -> V_134 [ 0 ] , V_190 ) ;
}
static int F_73 ( struct V_132 * V_52 , int V_192 , T_1 V_193 ,
int V_190 )
{
struct V_9 * V_9 = F_50 ( V_52 ) ;
return V_9 -> V_135 . V_194 ( V_52 -> V_134 [ 0 ] , V_192 , V_193 , V_190 ) ;
}
static int F_74 ( struct V_195 * V_196 ,
const struct V_197 * V_133 )
{
struct V_198 * V_16 = F_75 ( V_196 ) ;
char V_199 [ sizeof( L_41 ) ] ;
memset ( V_199 , 0 , sizeof( V_199 ) ) ;
F_76 ( V_16 , V_16 -> V_200 . V_201 ,
V_199 , sizeof( V_199 ) ) ;
if ( ( F_77 ( V_16 -> V_200 . V_202 ) == V_203 ) &&
( F_77 ( V_16 -> V_200 . V_204 ) == 0x0099 ) ) {
if ( ! strcmp ( L_41 , V_199 ) ) {
F_11 ( & V_16 -> V_17 , L_42 , V_27 ) ;
return - V_48 ;
}
}
return F_78 ( V_196 , V_133 ) ;
}
