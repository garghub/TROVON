...
static int F_18 ( struct V_22 * V_23 , unsigned int V_79 ,
T_3 * V_70 )
{
if ( V_79 >= F_16 ( V_80 ) )
return - V_73 ;
...
static int F_19 ( struct V_22 * V_23 , struct V_81 * V_82 )
{
V_82 -> V_83 . V_84 = 0 ;
V_82 -> V_83 . V_85 = 0 ;
V_82 -> V_83 . V_33 = V_35 ;
...
static int F_20 ( struct V_22 * V_23 , struct V_91 * V_82 )
{
V_82 -> V_92 . V_84 = 0 ;
V_82 -> V_92 . V_85 = 0 ;
V_82 -> V_92 . V_33 = V_35 ;
...
static int F_21 ( struct V_93 * V_94 )
{
struct V_25 * V_26 =
F_22 ( V_94 -> V_95 , struct V_25 , V_96 ) ;
switch ( V_94 -> V_97 ) {
case V_98 :
V_26 -> V_27 = V_94 -> V_4 ;
break;
...
static int F_23 ( struct V_22 * V_23 , int V_100 )
{
struct V_1 * V_2 = F_9 ( V_23 ) ;
struct V_101 * V_102 = F_24 ( V_2 ) ;
struct V_25 * V_26 = F_10 ( V_23 ) ;
int V_5 ;
if ( V_100 ) {
V_5 = F_25 ( & V_2 -> V_14 , V_102 , V_26 -> V_103 ) ;
if ( V_5 < 0 )
return V_5 ;
if ( V_26 -> V_32 ) {
F_15 ( V_23 , & V_26 -> V_76 ) ;
...
F_26 ( & V_2 -> V_14 , V_102 , V_26 -> V_103 ) ;
}
return 0 ;
}
...
T_2 V_107 , V_108 ;
int V_5 ;
V_5 = F_23 ( & V_26 -> V_109 , 1 ) ;
if ( V_5 < 0 )
return V_5 ;
V_5 = F_1 ( V_2 , V_110 , & V_107 ) ;
if ( V_5 < 0 )
goto V_45;
V_5 = F_1 ( V_2 , V_111 , & V_108 ) ;
if ( V_5 < 0 )
goto V_45;
V_26 -> V_112 = ( V_107 << 8 ) | V_108 ;
V_5 = F_1 ( V_2 , V_113 , & V_26 -> V_114 ) ;
if ( V_5 < 0 )
goto V_45;
V_5 = F_1 ( V_2 , V_115 , & V_26 -> V_116 ) ;
if ( V_5 < 0 )
goto V_45;
V_5 = F_1 ( V_2 , V_117 , & V_26 -> V_118 ) ;
if ( V_5 < 0 )
goto V_45;
if ( V_26 -> V_112 != 0x9740 ) {
V_5 = - V_119 ;
goto V_45;
}
F_31 ( & V_2 -> V_14 , L_7
L_8 ,
V_26 -> V_112 , V_26 -> V_114 , V_26 -> V_116 , V_26 -> V_118 ) ;
V_5 = F_32 ( & V_26 -> V_96 ) ;
V_45:
F_23 ( & V_26 -> V_109 , 0 ) ;
return V_5 ;
...
struct V_1 * V_2 = F_9 ( V_23 ) ;
struct V_101 * V_102 = F_24 ( V_2 ) ;
V_121 -> V_9 = V_122 | V_123 |
V_124 | V_125 |
V_126 ;
V_121 -> type = V_127 ;
V_121 -> V_9 = F_34 ( V_102 , V_121 ) ;
return 0 ;
}
...
V_26 = F_36 ( & V_2 -> V_14 , sizeof( struct V_25 ) , V_130 ) ;
if ( ! V_26 ) {
F_4 ( & V_2 -> V_14 , L_10 ) ;
return - V_131 ;
}
F_37 ( & V_26 -> V_109 , V_2 , & V_132 ) ;
F_38 ( & V_26 -> V_96 , 13 ) ;
F_39 ( & V_26 -> V_96 , & V_133 ,
V_98 , 0 , 1 , 1 , 0 ) ;
F_39 ( & V_26 -> V_96 , & V_133 ,
V_99 , 0 , 1 , 1 , 0 ) ;
V_26 -> V_109 . V_134 = & V_26 -> V_96 ;
if ( V_26 -> V_96 . error )
return V_26 -> V_96 . error ;
V_26 -> V_103 = F_40 ( & V_2 -> V_14 , L_11 ) ;
if ( F_41 ( V_26 -> V_103 ) ) {
V_5 = F_42 ( V_26 -> V_103 ) ;
goto V_135;
}
