...
static int F_62 ( struct V_10 * V_11 , bool V_99 )
{
struct V_4 * V_5 = F_13 ( V_11 ) ;
T_1 V_100 ;
( void ) F_5 ( V_5 , V_41 ) ;
...
static bool F_64 ( struct V_10 * V_11 , bool V_105 )
{
struct V_4 * V_5 = F_13 ( V_11 ) ;
T_1 V_102 ;
T_1 V_106 ;
...
V_90 = F_73 ( V_11 ) ;
if ( F_69 ( V_104 , & V_5 -> V_40 ) ) {
V_118 = F_74 ( V_11 , & V_117 , & V_90 ) ;
...
V_11 -> V_125 = F_75 ( V_11 ) ;
V_118 = F_76 ( V_11 , & V_117 ) ;
if ( V_118 && V_118 != - V_94 )
F_21 ( V_11 -> V_11 , L_24 ,
V_118 ) ;
V_11 -> V_125 = F_75 ( V_11 ) ;
...
if ( ! V_11 )
return NULL ;
F_81 ( V_11 , & V_78 -> V_11 , & V_128 ) ;
V_5 = F_13 ( V_11 ) ;
F_82 ( & V_5 -> V_31 ) ;
return V_11 ;
}
int F_83 ( struct V_10 * V_11 , T_6 V_129 , T_1 V_130 )
{
struct V_4 * V_5 = F_13 ( V_11 ) ;
T_1 V_131 = F_84 ( V_129 ) ;
T_1 V_132 = F_85 ( V_129 ) ;
T_1 V_133 ;
if ( V_132 & ~ 0xF )
return - V_80 ;
if ( V_131 & 0xF )
