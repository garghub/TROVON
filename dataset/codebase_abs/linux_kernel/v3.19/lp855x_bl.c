...
V_37 -> V_91 = F_32 ( V_9 , L_14 ) ;
if ( F_12 ( V_37 -> V_91 ) ) {
if ( F_20 ( V_37 -> V_91 ) == - V_92 )
return - V_92 ;
V_37 -> V_91 = NULL ;
}
V_2 -> V_37 = V_37 ;
...
static int F_33 ( struct V_93 * V_94 , const struct V_95 * V_96 )
{
struct V_1 * V_2 ;
int V_7 ;
if ( ! F_34 ( V_94 -> V_97 , V_98 ) )
return - V_99 ;
V_2 = F_26 ( & V_94 -> V_9 , sizeof( struct V_1 ) , V_86 ) ;
if ( ! V_2 )
return - V_87 ;
V_2 -> V_5 = V_94 ;
V_2 -> V_9 = & V_94 -> V_9 ;
...
V_2 -> V_66 = V_69 ;
if ( V_2 -> V_37 -> V_91 ) {
V_7 = F_36 ( V_2 -> V_37 -> V_91 ) ;
if ( V_7 < 0 ) {
F_5 ( & V_94 -> V_9 , L_15 , V_7 ) ;
return V_7 ;
}
}
F_37 ( V_94 , V_2 ) ;
