...
struct V_265 V_266 ;
const struct V_40 * V_41 = V_2 -> V_40 ;
if ( ! V_41 -> V_267 || ! V_41 -> V_268 )
return - V_48 ;
V_34 = V_41 -> V_267 ( V_2 , & V_266 ) ;
if ( V_34 )
return V_34 ;
return F_55 ( V_2 , V_10 , V_41 -> V_268 ,
V_266 . V_269 ) ;
}
static int F_92 ( const struct V_270 * V_271 )
{
switch ( V_271 -> V_227 ) {
case V_272 :
case V_273 :
if ( V_271 -> V_140 != sizeof( T_1 ) ||
V_271 -> V_274 != V_275 )
return - V_35 ;
break;
default:
...
static int F_93 ( struct V_1 * V_2 , void T_2 * V_10 )
{
int V_34 ;
struct V_270 V_271 ;
const struct V_40 * V_41 = V_2 -> V_40 ;
...
if ( ! V_41 -> V_276 )
return - V_48 ;
if ( F_10 ( & V_271 , V_10 , sizeof( V_271 ) ) )
return - V_29 ;
V_34 = F_92 ( & V_271 ) ;
if ( V_34 )
return V_34 ;
V_50 = F_57 ( V_271 . V_140 , V_121 ) ;
if ( ! V_50 )
return - V_122 ;
V_34 = V_41 -> V_276 ( V_2 , & V_271 , V_50 ) ;
if ( V_34 )
goto V_123;
V_10 += sizeof( V_271 ) ;
V_34 = - V_29 ;
if ( F_8 ( V_10 , V_50 , V_271 . V_140 ) )
goto V_123;
V_34 = 0 ;
V_123:
F_31 ( V_50 ) ;
...
static int F_94 ( struct V_1 * V_2 , void T_2 * V_10 )
{
int V_34 ;
struct V_270 V_271 ;
const struct V_40 * V_41 = V_2 -> V_40 ;
...
V_10 += sizeof( V_271 ) ;
V_34 = - V_29 ;
if ( F_10 ( V_50 , V_10 , V_271 . V_140 ) )
goto V_123;
V_34 = V_41 -> V_277 ( V_2 , & V_271 , V_50 ) ;
V_123:
F_31 ( V_50 ) ;
return V_34 ;
}
int F_95 ( struct V_278 * V_278 , struct V_279 * V_280 )
{
struct V_1 * V_2 = F_96 ( V_278 , V_280 -> V_281 ) ;
void T_2 * V_10 = V_280 -> V_282 ;
T_1 V_74 ;
int V_104 ;
V_21 V_283 ;
if ( ! V_2 || ! F_97 ( V_2 ) )
...
break;
default:
if ( ! F_98 ( V_278 -> V_296 , V_297 ) )
return - V_298 ;
}
if ( V_2 -> V_40 -> V_299 ) {
V_104 = V_2 -> V_40 -> V_299 ( V_2 ) ;
if ( V_104 < 0 )
return V_104 ;
}
V_283 = V_2 -> V_17 ;
