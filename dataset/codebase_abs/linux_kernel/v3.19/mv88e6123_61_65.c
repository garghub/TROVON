...
static int
F_20 ( struct V_7 * V_8 , int V_35 , int V_36 )
{
struct V_30 * V_31 = F_17 ( V_8 ) ;
int V_23 = F_19 ( V_35 ) ;
int V_6 ;
F_21 ( & V_31 -> V_34 ) ;
V_6 = F_22 ( V_8 , V_23 , V_36 ) ;
F_23 ( & V_31 -> V_34 ) ;
return V_6 ;
}
static int
F_24 ( struct V_7 * V_8 ,
int V_35 , int V_36 , T_1 V_24 )
{
struct V_30 * V_31 = F_17 ( V_8 ) ;
int V_23 = F_19 ( V_35 ) ;
int V_6 ;
F_21 ( & V_31 -> V_34 ) ;
V_6 = F_25 ( V_8 , V_23 , V_36 , V_24 ) ;
F_23 ( & V_31 -> V_34 ) ;
return V_6 ;
}
static void
F_26 ( struct V_7 * V_8 , int V_35 , T_2 * V_37 )
{
F_27 ( V_8 , F_28 ( V_38 ) ,
V_38 , V_35 , V_37 ) ;
}
