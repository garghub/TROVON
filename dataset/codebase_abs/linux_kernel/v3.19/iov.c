...
{
struct V_24 V_96 ;
int V_97 = F_65 ( V_2 , V_95 ) ;
if ( ! V_97 )
return 0 ;
F_50 ( V_2 , V_86 , & V_96 , V_97 ) ;
return F_67 ( & V_96 ) ;
}
...
if ( ! V_2 -> V_68 )
return 0 ;
F_14 ( V_2 , V_2 -> V_7 -> V_32 + V_33 , & V_101 ) ;
V_99 = F_75 ( V_2 -> V_31 , V_101 , NULL ) ;
while ( V_99 ) {
if ( V_99 -> V_37 && ( V_99 -> V_36 == V_2 ) &&
F_76 ( V_99 ) )
V_100 ++ ;
V_99 = F_75 ( V_2 -> V_31 , V_101 , V_99 ) ;
}
return V_100 ;
}
int F_77 ( struct V_1 * V_2 , T_3 V_102 )
{
if ( ! V_2 -> V_68 )
return - V_69 ;
if ( V_102 > V_2 -> V_7 -> V_43 )
return - V_58 ;
