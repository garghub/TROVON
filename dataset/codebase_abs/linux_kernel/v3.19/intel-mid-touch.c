...
static int F_21 ( T_3 * V_49 , T_3 * V_50 )
{
int V_4 ;
T_4 V_51 ;
V_4 = F_22 ( V_52 , & V_51 ) ;
...
V_2 = F_29 ( & V_69 -> V_33 , sizeof( struct V_1 ) ,
V_71 ) ;
if ( ! V_2 ) {
F_10 ( & V_69 -> V_33 , L_7 ) ;
return - V_72 ;
...
V_2 -> V_36 = V_36 ;
V_2 -> V_42 = V_42 ;
snprintf ( V_2 -> V_73 , sizeof( V_2 -> V_73 ) ,
L_9 , F_31 ( V_2 -> V_33 ) ) ;
V_4 = F_26 ( V_2 ) ;
if ( V_4 ) {
F_10 ( & V_69 -> V_33 , L_10 ) ;
...
V_36 -> V_74 = L_11 ;
V_36 -> V_73 = V_2 -> V_73 ;
V_36 -> V_33 . V_75 = V_2 -> V_33 ;
V_36 -> V_76 . V_49 = V_2 -> V_49 ;
V_36 -> V_76 . V_77 = V_2 -> V_50 ;
V_36 -> V_78 [ 0 ] = F_32 ( V_79 ) | F_32 ( V_80 ) ;
V_36 -> V_81 [ F_33 ( V_38 ) ] = F_32 ( V_38 ) ;
F_34 ( V_2 -> V_36 , V_39 ,
V_82 , V_83 , V_84 , 0 ) ;
F_34 ( V_2 -> V_36 , V_40 ,
V_85 , V_86 , V_87 , 0 ) ;
F_34 ( V_2 -> V_36 , V_41 ,
V_88 , V_89 , 0 , 0 ) ;
V_4 = F_35 ( & V_69 -> V_33 , V_2 -> V_42 , NULL ,
F_20 , V_90 ,
L_12 , V_2 ) ;
if ( V_4 ) {
F_10 ( V_2 -> V_33 , L_13 ) ;
