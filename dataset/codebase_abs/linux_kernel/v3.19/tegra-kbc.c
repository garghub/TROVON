...
V_15 -> V_31 = true ;
if ( F_39 ( V_90 , L_7 , NULL ) )
V_15 -> V_56 = true ;
if ( ! F_40 ( V_90 , L_8 , & V_96 ) ) {
F_36 ( V_15 -> V_85 , L_9 ) ;
return - V_98 ;
}
V_86 = V_96 / sizeof( T_1 ) ;
if ( ! F_40 ( V_90 , L_10 , & V_96 ) ) {
F_36 ( V_15 -> V_85 , L_11 ) ;
return - V_98 ;
}
...
V_109 = F_43 ( V_110 , & V_102 -> V_85 ) ;
V_15 = F_44 ( & V_102 -> V_85 , sizeof( * V_15 ) , V_111 ) ;
if ( ! V_15 ) {
F_36 ( & V_102 -> V_85 , L_19 ) ;
return - V_112 ;
}
...
if ( ! F_35 ( V_15 , & V_86 ) )
return - V_99 ;
V_15 -> V_48 = F_46 ( V_102 , 0 ) ;
if ( V_15 -> V_48 < 0 ) {
F_36 ( & V_102 -> V_85 , L_20 ) ;
return - V_113 ;
}
V_15 -> V_35 = F_47 ( & V_102 -> V_85 ) ;
if ( ! V_15 -> V_35 ) {
F_36 ( & V_102 -> V_85 , L_21 ) ;
return - V_112 ;
}
F_48 ( & V_15 -> V_46 , F_11 , ( unsigned long ) V_15 ) ;
V_104 = F_49 ( V_102 , V_114 , 0 ) ;
V_15 -> V_22 = F_50 ( & V_102 -> V_85 , V_104 ) ;
if ( F_51 ( V_15 -> V_22 ) )
return F_52 ( V_15 -> V_22 ) ;
V_15 -> V_77 = F_53 ( & V_102 -> V_85 , NULL ) ;
if ( F_51 ( V_15 -> V_77 ) ) {
F_36 ( & V_102 -> V_85 , L_22 ) ;
return F_52 ( V_15 -> V_77 ) ;
}
V_15 -> V_78 = F_54 ( & V_102 -> V_85 , L_23 ) ;
if ( F_51 ( V_15 -> V_78 ) ) {
F_36 ( & V_102 -> V_85 , L_24 ) ;
return F_52 ( V_15 -> V_78 ) ;
}
V_76 = F_23 ( V_15 -> V_76 , V_81 ) ;
V_106 = ( V_115 + V_76 ) * V_86 ;
V_15 -> V_45 = V_116 + V_106 + V_15 -> V_79 ;
V_15 -> V_45 = F_55 ( V_15 -> V_45 , V_117 ) ;
...
F_57 ( V_126 , V_15 -> V_35 -> V_127 ) ;
F_58 ( V_15 -> V_35 , V_12 , V_13 ) ;
F_59 ( V_15 -> V_35 , V_15 ) ;
V_105 = F_60 ( & V_102 -> V_85 , V_15 -> V_48 , F_16 ,
V_128 | V_129 , V_102 -> V_118 , V_15 ) ;
if ( V_105 ) {
F_36 ( & V_102 -> V_85 , L_26 ) ;
return V_105 ;
}
F_29 ( V_15 -> V_48 ) ;
V_105 = F_61 ( V_15 -> V_35 ) ;
if ( V_105 ) {
F_36 ( & V_102 -> V_85 , L_27 ) ;
return V_105 ;
}
F_62 ( V_102 , V_15 ) ;
F_63 ( & V_102 -> V_85 , V_15 -> V_56 ) ;
return 0 ;
}
...
static int F_65 ( struct V_131 * V_85 )
{
struct V_101 * V_102 = F_66 ( V_85 ) ;
struct V_14 * V_15 = F_67 ( V_102 ) ;
F_68 ( & V_15 -> V_35 -> V_132 ) ;
if ( F_69 ( & V_102 -> V_85 ) ) {
F_29 ( V_15 -> V_48 ) ;
F_30 ( & V_15 -> V_46 ) ;
F_9 ( V_15 , false ) ;
F_10 ( 0x7 , V_15 -> V_22 + V_43 ) ;
V_15 -> V_133 = F_6 ( V_15 -> V_22 + V_134 ) ;
F_10 ( 0 , V_15 -> V_22 + V_134 ) ;
F_17 ( V_15 , true ) ;
F_70 ( 30 ) ;
V_15 -> V_52 = false ;
F_64 ( V_15 , true ) ;
...
F_72 ( & V_15 -> V_35 -> V_132 ) ;
return 0 ;
}
static int F_73 ( struct V_131 * V_85 )
{
struct V_101 * V_102 = F_66 ( V_85 ) ;
struct V_14 * V_15 = F_67 ( V_102 ) ;
int V_105 = 0 ;
...
F_17 ( V_15 , false ) ;
F_64 ( V_15 , false ) ;
F_10 ( V_15 -> V_133 , V_15 -> V_22 + V_134 ) ;
F_9 ( V_15 , true ) ;
if ( V_15 -> V_52 && V_15 -> V_136 ) {
F_2 ( V_15 -> V_35 , V_15 -> V_136 , 1 ) ;
F_8 ( V_15 -> V_35 ) ;
F_2 ( V_15 -> V_35 , V_15 -> V_136 , 0 ) ;
F_8 ( V_15 -> V_35 ) ;
}
} else {
if ( V_15 -> V_35 -> V_135 )
