...
V_8 -> V_105 . V_43 . V_107 = F_31 ;
return F_9 ( V_17 , & V_8 -> V_105 ) ;
}
...
int V_18 ;
enum V_110 V_2 ;
V_109 = F_30 ( V_28 -> V_109 ) ;
V_100 = F_30 ( V_28 -> V_100 ) ;
V_81 = V_28 -> V_85 & V_86 ;
V_2 = V_8 -> V_56 . V_2 ;
switch ( V_81 ) {
case V_87 :
...
V_82 = F_33 ( V_8 -> V_92 , V_123 ) ;
V_82 &= ~ ( V_124 ) ;
V_82 |= F_38 ( V_122 ) ;
F_36 ( V_8 -> V_92 , V_123 , V_82 ) ;
if ( V_122 )
F_13 ( & V_8 -> V_56 , V_125 ) ;
else
F_13 ( & V_8 -> V_56 , V_126 ) ;
...
V_8 -> V_139 = F_30 ( V_136 . V_139 ) ;
V_8 -> V_140 = F_30 ( V_136 . V_140 ) ;
V_82 = F_33 ( V_8 -> V_92 , V_93 ) ;
if ( V_82 & V_96 )
V_135 = V_8 -> V_140 ;
if ( V_82 & V_94 )
...
F_24 ( V_163 , V_161 , 0 ) ;
if ( F_55 ( V_162 -> V_69 , V_163 -> V_64 . V_144 ) &&
...
F_52 ( V_17 , V_15 ) ;
if ( ! F_19 ( & V_17 -> V_48 ) ) {
V_161 = F_23 ( & V_17 -> V_48 ) ;
F_24 ( V_17 , V_161 , 0 ) ;
}
if ( V_8 -> V_117 ) {
int V_18 ;
V_18 = F_57 ( V_8 , V_8 -> V_116 ) ;
if ( V_18 < 0 ) {
F_3 ( V_22 , L_25 ,
V_8 -> V_116 ) ;
F_21 ( V_8 ) ;
...
V_8 -> V_73 , 0 ,
V_173 ) ;
} else if ( ! F_55 ( V_42 -> V_43 . V_69 , V_17 -> V_64 . V_144 )
&& ( V_17 -> V_36 == 0 ) ) {
T_3 V_169 ;
T_3 V_144 ;
...
F_28 ( V_42 -> V_43 . V_69 > V_175 ) ;
V_144 = V_17 -> V_64 . V_144 ;
V_169 = F_62 ( V_42 -> V_43 . V_69 , V_144 ) ;
V_8 -> V_168 = true ;
V_18 = F_2 ( V_8 , V_17 -> V_36 ,
V_8 -> V_176 , V_169 ,
V_173 ) ;
...
V_180 = V_181 ;
V_180 |= V_182 ;
V_180 |= F_67 ( V_17 -> V_38 ) ;
memset ( & V_13 , 0 , sizeof( V_13 ) ) ;
V_18 = F_7 ( V_8 , V_17 -> V_36 , V_180 , & V_13 ) ;
F_68 ( V_18 ) ;
V_17 -> V_38 = 0 ;
}
