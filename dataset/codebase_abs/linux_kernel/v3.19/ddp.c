...
struct V_1 * V_2 = V_1 -> V_2 ;
struct V_10 * V_11 = F_10 ( V_2 ) ;
F_112 ( struct V_5 * , V_232 , V_231 -> V_233 ) ;
...
V_238 += V_32 -> V_247 ;
F_79 ( V_2 ) ;
V_147 = F_114 ( V_2 , V_238 , ( V_59 & V_239 ) , & V_180 ) ;
F_77 ( V_2 ) ;
if ( ! V_147 )
goto V_42;
F_115 ( V_147 , V_244 -> V_245 ) ;
F_115 ( V_147 , V_32 -> V_247 ) ;
V_147 -> V_32 = V_32 ;
F_113 ( V_2 , L_14 , V_2 ) ;
...
V_180 = F_117 ( F_116 ( V_147 , V_144 ) , V_231 , V_144 ) ;
if ( V_180 ) {
F_90 ( V_147 ) ;
V_180 = - V_113 ;
goto V_42;
...
struct V_146 * V_250 = F_118 ( V_147 , V_41 ) ;
if ( V_250 ) {
V_235 = 1 ;
F_113 ( V_2 , L_16 , V_2 ) ;
F_101 ( V_32 , V_250 , & V_232 -> V_14 , NULL ) ;
}
}
...
V_244 -> V_252 ( V_244 , V_147 , V_32 -> V_253 ) ;
} else {
F_113 ( V_2 , L_18 , V_2 ) ;
if ( V_82 -> V_59 & V_93 ) {
...
static int F_120 ( struct V_228 * V_229 , struct V_159 * V_1 , struct V_230 * V_231 ,
T_7 V_238 , int V_59 )
{
struct V_1 * V_2 = V_1 -> V_2 ;
struct V_204 * V_205 ;
...
int V_180 = 0 ;
struct V_146 * V_147 ;
V_147 = F_121 ( V_2 , V_59 & ~ V_239 ,
V_59 & V_239 , & V_180 ) ;
F_77 ( V_2 ) ;
if ( ! V_147 )
goto V_42;
V_205 = F_105 ( V_147 ) ;
V_254 = F_27 ( V_205 -> V_213 ) & 1023 ;
if ( V_2 -> V_255 != V_165 ) {
V_148 = sizeof( * V_205 ) ;
V_254 -= V_148 ;
}
...
V_180 = F_122 ( V_147 , V_148 , V_231 , V_254 ) ;
if ( ! V_180 && V_231 -> V_233 ) {
F_112 ( struct V_5 * , V_24 , V_231 -> V_233 ) ;
V_24 -> V_85 = V_86 ;
...
int V_162 = - V_257 ;
struct V_1 * V_2 = V_1 -> V_2 ;
void T_2 * V_258 = ( void T_2 * ) V_103 ;
switch ( V_102 ) {
case V_259 : {
long V_260 = V_2 -> V_261 - F_125 ( V_2 ) ;
if ( V_260 < 0 )
V_260 = 0 ;
V_162 = F_126 ( V_260 , ( int T_2 * ) V_258 ) ;
break;
}
case V_262 : {
...
long V_260 = 0 ;
if ( V_147 )
V_260 = V_147 -> V_144 - sizeof( struct V_204 ) ;
V_162 = F_126 ( V_260 , ( int T_2 * ) V_258 ) ;
break;
}
case V_263 :
V_162 = F_128 ( V_2 , V_258 ) ;
break;
case V_264 :
V_162 = F_129 ( V_2 , V_258 ) ;
break;
case V_140 :
case V_138 :
V_162 = - V_119 ;
if ( F_52 ( V_118 ) )
V_162 = F_57 ( V_102 , V_258 ) ;
break;
case V_131 :
case V_117 :
case V_133 :
