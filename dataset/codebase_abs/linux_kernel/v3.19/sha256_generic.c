...
F_11 ( V_5 , 64 * sizeof( T_1 ) ) ;
}
static int F_12 ( struct V_20 * V_21 )
{
struct V_22 * V_23 = F_13 ( V_21 ) ;
V_23 -> V_8 [ 0 ] = V_24 ;
V_23 -> V_8 [ 1 ] = V_25 ;
V_23 -> V_8 [ 2 ] = V_26 ;
V_23 -> V_8 [ 3 ] = V_27 ;
...
int F_15 ( struct V_20 * V_21 , const T_2 * V_41 ,
unsigned int V_42 )
{
struct V_22 * V_23 = F_13 ( V_21 ) ;
...
static int F_16 ( struct V_20 * V_21 , T_2 * V_47 )
{
struct V_22 * V_23 = F_13 ( V_21 ) ;
T_3 * V_48 = ( T_3 * ) V_47 ;
T_4 V_49 ;
...
V_49 = F_17 ( V_23 -> V_32 << 3 ) ;
V_50 = V_23 -> V_32 & 0x3f ;
V_51 = ( V_50 < 56 ) ? ( 56 - V_50 ) : ( ( 64 + 56 ) - V_50 ) ;
F_15 ( V_21 , V_52 , V_51 ) ;
F_15 ( V_21 , ( const T_2 * ) & V_49 , sizeof( V_49 ) ) ;
for ( V_19 = 0 ; V_19 < 8 ; V_19 ++ )
V_48 [ V_19 ] = F_18 ( V_23 -> V_8 [ V_19 ] ) ;
memset ( V_23 , 0 , sizeof( * V_23 ) ) ;
return 0 ;
}
static int F_19 ( struct V_20 * V_21 , T_2 * V_53 )
{
T_2 V_54 [ V_55 ] ;
F_16 ( V_21 , V_54 ) ;
...
static int F_20 ( struct V_20 * V_21 , void * V_47 )
{
struct V_22 * V_23 = F_13 ( V_21 ) ;
memcpy ( V_47 , V_23 , sizeof( * V_23 ) ) ;
return 0 ;
}
static int F_21 ( struct V_20 * V_21 , const void * V_57 )
{
struct V_22 * V_23 = F_13 ( V_21 ) ;
