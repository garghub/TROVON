...
static bool
F_68 ( struct V_21 * V_69 ,
T_1 V_99 , T_1 V_100 , struct V_72 * * V_101 )
{
struct V_1 * V_2 = V_69 -> V_11 -> V_2 ;
struct V_72 * V_73 ;
unsigned long V_78 ;
...
V_73 = F_69 ( & V_69 -> V_43 ,
struct V_72 , V_81 ) ;
if ( V_73 -> V_102 -> V_103 + V_99 > V_100 )
goto V_101;
V_69 -> V_45 += V_73 -> V_102 -> V_103 ;
F_47 ( & V_73 -> V_81 ) ;
* V_101 = V_73 ;
V_3 = true ;
V_101:
...
T_2 F_70 ( struct V_8 * V_9 , char T_3 * V_104 ,
T_1 V_105 , T_4 * V_106 )
{
struct V_21 * V_69 = V_9 -> V_34 ;
struct V_72 * V_73 ;
...
V_99 = 0 ;
while ( F_68 ( V_69 , V_99 , V_105 , & V_73 ) ) {
if ( F_72 ( V_104 + V_99 ,
V_73 -> V_102 , V_73 -> V_102 -> V_103 ) ) {
V_99 = - V_108 ;
V_73 -> V_83 ( V_73 ) ;
break;
}
V_99 += V_73 -> V_102 -> V_103 ;
V_73 -> V_83 ( V_73 ) ;
}
return V_99 ? : - V_109 ;
}
unsigned int F_73 ( struct V_8 * V_9 , struct V_110 * V_111 )
{
struct V_21 * V_69 = V_9 -> V_34 ;
unsigned int V_112 = 0 ;
F_74 ( V_9 , & V_69 -> V_44 , V_111 ) ;
if ( ! F_65 ( & V_69 -> V_43 ) )
V_112 |= V_113 | V_114 ;
return V_112 ;
}
