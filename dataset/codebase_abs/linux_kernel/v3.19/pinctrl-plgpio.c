...
static void F_26 ( unsigned V_47 , struct V_48 * V_49 )
{
struct V_7 * V_37 = F_27 ( V_49 ) ;
struct V_9 * V_9 = F_9 ( V_37 , struct V_9 , V_8 ) ;
...
static int F_37 ( struct V_61 * V_62 , struct V_9 * V_9 )
{
...
if ( ! F_39 ( V_64 , L_2 , & V_6 ) ) {
V_9 -> V_8 . V_24 = V_6 ;
} else {
F_40 ( & V_62 -> V_65 , L_3 ) ;
goto V_67;
}
if ( ! F_39 ( V_64 , L_4 , & V_6 ) )
V_9 -> V_16 . V_31 = V_6 ;
else
V_9 -> V_16 . V_31 = - 1 ;
if ( ! F_39 ( V_64 , L_5 , & V_6 ) ) {
V_9 -> V_16 . V_23 = V_6 ;
} else {
F_40 ( & V_62 -> V_65 , L_6 ) ;
goto V_67;
}
if ( ! F_39 ( V_64 , L_7 , & V_6 ) ) {
V_9 -> V_16 . V_17 = V_6 ;
} else {
F_40 ( & V_62 -> V_65 , L_8 ) ;
goto V_67;
}
if ( ! F_39 ( V_64 , L_9 , & V_6 ) ) {
V_9 -> V_16 . V_40 = V_6 ;
} else {
F_40 ( & V_62 -> V_65 , L_10 ) ;
goto V_67;
}
if ( ! F_39 ( V_64 , L_11 , & V_6 ) ) {
V_9 -> V_16 . V_26 = V_6 ;
} else {
F_40 ( & V_62 -> V_65 , L_12 ) ;
goto V_67;
}
if ( ! F_39 ( V_64 , L_13 , & V_6 ) ) {
V_9 -> V_16 . V_57 = V_6 ;
} else {
F_40 ( & V_62 -> V_65 , L_14 ) ;
goto V_67;
}
if ( ! F_39 ( V_64 , L_15 , & V_6 ) )
V_9 -> V_16 . V_43 = V_6 ;
else
V_9 -> V_16 . V_43 = - 1 ;
return 0 ;
...
struct V_68 * V_69 ;
int V_28 , V_47 ;
V_9 = F_42 ( & V_62 -> V_65 , sizeof( * V_9 ) , V_70 ) ;
if ( ! V_9 ) {
F_40 ( & V_62 -> V_65 , L_16 ) ;
return - V_71 ;
}
V_69 = F_43 ( V_62 , V_72 , 0 ) ;
V_9 -> V_1 = F_44 ( & V_62 -> V_65 , V_69 ) ;
if ( F_17 ( V_9 -> V_1 ) )
return F_45 ( V_9 -> V_1 ) ;
V_28 = F_37 ( V_62 , V_9 ) ;
if ( V_28 ) {
...
V_9 -> V_29 = F_46 ( & V_62 -> V_65 , NULL ) ;
if ( F_17 ( V_9 -> V_29 ) )
F_47 ( & V_62 -> V_65 , L_18 ) ;
#ifdef F_48
V_9 -> V_73 = F_42 ( & V_62 -> V_65 ,
sizeof( * V_9 -> V_73 ) *
F_29 ( V_9 -> V_8 . V_24 , V_56 ) ,
V_70 ) ;
if ( ! V_9 -> V_73 ) {
F_40 ( & V_62 -> V_65 , L_19 ) ;
return - V_71 ;
...
V_9 -> V_8 . V_77 = F_13 ;
V_9 -> V_8 . V_78 = F_14 ;
V_9 -> V_8 . V_79 = F_51 ( & V_62 -> V_65 ) ;
V_9 -> V_8 . V_65 = & V_62 -> V_65 ;
V_9 -> V_8 . V_80 = V_81 ;
V_9 -> V_8 . V_66 = V_62 -> V_65 . V_66 ;
if ( ! F_17 ( V_9 -> V_29 ) ) {
V_28 = F_52 ( V_9 -> V_29 ) ;
if ( V_28 ) {
F_40 ( & V_62 -> V_65 , L_20 ) ;
...
static int F_60 ( struct V_87 * V_65 )
{
struct V_9 * V_9 = F_61 ( V_65 ) ;
int V_54 , V_88 = F_29 ( V_9 -> V_8 . V_24 , V_56 ) ;
void T_2 * V_89 ;
for ( V_54 = 0 ; V_54 < V_88 ; V_54 ++ ) {
V_89 = V_9 -> V_1 + V_54 * sizeof( int * ) ;
if ( V_9 -> V_16 . V_31 != - 1 )
V_9 -> V_73 [ V_54 ] . V_31 =
...
V_89 ) ;
V_9 -> V_73 [ V_54 ] . V_40 = F_4 ( V_9 -> V_16 . V_40 + V_89 ) ;
}
return 0 ;
}
static int F_62 ( struct V_87 * V_65 )
{
struct V_9 * V_9 = F_61 ( V_65 ) ;
int V_54 , V_88 = F_29 ( V_9 -> V_8 . V_24 , V_56 ) ;
void T_2 * V_89 ;
...
V_89 ) ;
if ( V_9 -> V_16 . V_43 != - 1 )
F_6 ( V_9 -> V_73 [ V_54 ] . V_43 ,
V_9 -> V_16 . V_43 + V_89 ) ;
F_6 ( V_9 -> V_73 [ V_54 ] . V_40 , V_9 -> V_16 . V_40 + V_89 ) ;
if ( V_9 -> V_16 . V_31 != - 1 )
