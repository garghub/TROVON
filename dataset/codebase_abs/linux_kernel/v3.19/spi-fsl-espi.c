...
static int F_36 ( struct V_80 * V_5 ,
struct V_56 * V_57 )
{
struct V_24 * V_25 ;
T_5 * V_49 = NULL ;
...
void F_42 ( struct V_3 * V_4 , T_3 V_90 )
{
struct V_9 * V_10 = V_4 -> V_10 ;
if ( V_90 & V_91 ) {
T_3 V_92 , V_15 ;
T_5 V_93 ;
while ( F_43 ( V_90 ) < F_44 ( 4 , V_4 -> V_40 ) ) {
F_45 () ;
V_90 = F_4 ( & V_10 -> V_94 ) ;
}
if ( V_4 -> V_40 >= 4 ) {
...
static T_6 F_49 ( T_7 V_97 , void * V_98 )
{
struct V_3 * V_4 = V_98 ;
struct V_9 * V_10 = V_4 -> V_10 ;
T_6 V_46 = V_99 ;
...
static int F_53 ( struct V_80 * V_5 )
{
struct V_3 * V_3 ;
struct V_9 * V_10 ;
T_3 V_102 ;
...
static int F_54 ( struct V_80 * V_5 )
{
struct V_3 * V_3 ;
struct V_9 * V_10 ;
T_3 V_102 ;
...
static struct V_80 * F_55 ( struct V_103 * V_39 ,
struct V_104 * V_105 , unsigned int V_97 )
{
struct V_106 * V_107 = F_56 ( V_39 ) ;
struct V_80 * V_5 ;
struct V_3 * V_3 ;
struct V_9 * V_10 ;
struct V_108 * V_109 ;
...
V_3 = F_2 ( V_5 ) ;
V_3 -> V_118 = F_51 ;
V_3 -> V_10 = F_61 ( V_105 -> V_119 , F_62 ( V_105 ) ) ;
if ( ! V_3 -> V_10 ) {
V_46 = - V_73 ;
goto V_120;
}
V_10 = V_3 -> V_10 ;
V_46 = F_63 ( V_3 -> V_97 , F_49 ,
0 , L_8 , V_3 ) ;
if ( V_46 )
goto V_121;
if ( V_3 -> V_16 & V_122 ) {
...
F_5 ( & V_10 -> V_43 , 0 ) ;
F_5 ( & V_10 -> V_53 , 0 ) ;
F_5 ( & V_10 -> V_94 , 0xffffffff ) ;
F_64 (master->dev.of_node, nc) {
V_110 = F_65 ( V_109 , L_9 , & V_40 ) ;
if ( ! V_110 || V_40 < sizeof( * V_110 ) )
continue;
V_71 = F_66 ( V_110 ) ;
if ( V_71 < 0 || V_71 >= V_107 -> V_123 )
continue;
V_12 = V_124 ;
V_110 = F_65 ( V_109 , L_10 , & V_40 ) ;
if ( V_110 && V_40 >= sizeof( * V_110 ) ) {
V_12 &= ~ ( F_67 ( 0xf ) ) ;
V_12 |= F_67 ( F_66 ( V_110 ) ) ;
}
V_110 = F_65 ( V_109 , L_11 , & V_40 ) ;
if ( V_110 && V_40 >= sizeof( * V_110 ) ) {
V_12 &= ~ ( F_68 ( 0xf ) ) ;
V_12 |= F_68 ( F_66 ( V_110 ) ) ;
}
F_5 ( & V_10 -> V_12 [ V_71 ] , V_12 ) ;
F_69 ( V_39 , L_12 , V_71 , V_12 ) ;
}
V_102 = V_107 -> V_125 | V_126 | V_17 ;
F_5 ( & V_10 -> V_11 , V_102 ) ;
V_46 = F_70 ( V_5 ) ;
if ( V_46 < 0 )
goto V_127;
F_69 ( V_39 , L_13 , V_10 , V_3 -> V_97 ) ;
return V_5 ;
V_127:
V_121 ( V_3 -> V_97 , V_3 ) ;
V_121:
...
static int F_73 ( struct V_103 * V_39 )
{
struct V_108 * V_128 = V_39 -> V_129 ;
struct V_106 * V_107 = F_56 ( V_39 ) ;
const T_3 * V_110 ;
int V_40 ;
V_110 = F_65 ( V_128 , L_14 , & V_40 ) ;
if ( ! V_110 || V_40 < sizeof( * V_110 ) ) {
F_19 ( V_39 , L_15 ) ;
return - V_52 ;
}
...
{
struct V_103 * V_39 = & V_132 -> V_39 ;
struct V_108 * V_128 = V_132 -> V_39 . V_129 ;
struct V_80 * V_5 ;
struct V_104 V_105 ;
unsigned int V_97 ;
int V_46 = - V_73 ;
...
static int F_80 ( struct V_131 * V_39 )
{
return F_81 ( & V_39 -> V_39 ) ;
}
static int F_82 ( struct V_103 * V_39 )
{
struct V_80 * V_5 = F_83 ( V_39 ) ;
int V_46 ;
V_46 = F_84 ( V_5 ) ;
if ( V_46 ) {
F_85 ( V_39 , L_16 ) ;
...
static int F_86 ( struct V_103 * V_39 )
{
struct V_106 * V_107 = F_56 ( V_39 ) ;
struct V_80 * V_5 = F_83 ( V_39 ) ;
struct V_3 * V_3 ;
...
F_5 ( & V_10 -> V_53 , 0 ) ;
F_5 ( & V_10 -> V_94 , 0xffffffff ) ;
for ( V_71 = 0 ; V_71 < V_107 -> V_123 ; V_71 ++ )
