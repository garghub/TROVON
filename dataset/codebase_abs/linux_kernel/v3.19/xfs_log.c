...
V_154 -> V_199 = F_102 ;
V_59 -> V_204 = V_154 ;
V_59 -> V_205 = V_154 -> V_206 ;
#ifdef F_69
log -> V_207 [ V_186 ] = ( V_208 ) & ( V_59 -> V_209 ) ;
#endif
V_2 = & V_59 -> V_209 ;
memset ( V_2 , 0 , sizeof( T_15 ) ) ;
V_2 -> V_210 = F_126 ( V_211 ) ;
V_2 -> V_212 = F_126 (
F_109 ( & log -> V_153 -> V_80 ) ? 2 : 1 ) ;
V_2 -> V_213 = F_126 ( log -> V_169 ) ;
V_2 -> V_214 = F_126 ( V_215 ) ;
memcpy ( & V_2 -> V_216 , & V_37 -> V_80 . V_217 , sizeof( V_218 ) ) ;
V_59 -> V_219 = F_101 ( V_154 -> V_220 ) - log -> V_172 ;
V_59 -> V_67 = V_69 ;
V_59 -> V_157 = log ;
F_127 ( & V_59 -> V_118 , 0 ) ;
F_10 ( & V_59 -> V_66 ) ;
V_59 -> V_72 = & ( V_59 -> V_221 ) ;
V_59 -> V_222 = ( char * ) V_59 -> V_205 + log -> V_172 ;
F_124 ( & V_59 -> V_120 ) ;
F_124 ( & V_59 -> V_223 ) ;
V_184 = & V_59 -> V_99 ;
}
* V_184 = log -> V_97 ;
log -> V_97 -> V_203 = V_185 ;
error = F_128 ( log ) ;
if ( error )
goto V_202;
return log ;
...
F_44 ( V_59 ) ;
error = F_71 ( log , & V_112 , V_57 , V_224 , V_59 ,
V_226 ) ;
if ( error )
F_47 ( V_37 , V_73 ) ;
return error ;
...
V_229 = F_133 ( V_23 ) ;
V_232 = F_122 ( V_24 ) ;
V_232 = F_134 ( V_232 , ( log -> V_190 >> 2 ) ) ;
V_232 = F_134 ( V_232 , 256 ) ;
if ( V_229 >= V_232 )
return;
F_100 ( & log -> V_148 , & V_231 ,
& V_230 ) ;
V_230 += V_232 ;
if ( V_230 >= log -> V_190 ) {
V_230 -= log -> V_190 ;
...
V_230 ) ;
V_228 = F_2 ( & log -> V_147 ) ;
if ( F_136 ( V_227 , V_228 ) > 0 )
V_227 = V_228 ;
if ( ! F_26 ( log ) )
F_137 ( log -> V_88 , V_227 ) ;
}
STATIC void
F_138 (
struct V_1 * log ,
...
int V_163 = V_59 -> V_98 + V_233 ;
T_16 V_236 ;
V_208 V_237 ;
V_236 = F_139 ( V_59 -> V_209 . V_238 ) ;
V_237 = V_59 -> V_222 ;
...
{
T_13 V_246 ;
V_246 = F_141 ( ( char * ) V_245 ,
sizeof( struct V_244 ) ,
F_142 ( struct V_244 , V_247 ) ) ;
if ( F_109 ( & log -> V_153 -> V_80 ) ) {
union V_248 * V_240 = (union V_248 * ) V_245 ;
int V_186 ;
for ( V_186 = 1 ; V_186 < log -> V_174 ; V_186 ++ ) {
V_246 = F_143 ( V_246 , & V_240 [ V_186 ] . V_241 ,
sizeof( struct V_249 ) ) ;
}
}
V_246 = F_143 ( V_246 , V_237 , V_163 ) ;
return F_144 ( V_246 ) ;
}
STATIC int
F_145 (
...
int V_253 = 0 ;
int error ;
int V_254 = F_109 ( & log -> V_153 -> V_80 ) ;
int V_163 ;
F_27 ( V_255 ) ;
ASSERT ( F_150 ( & V_59 -> V_118 ) == 0 ) ;
V_252 = log -> V_172 + V_59 -> V_98 ;
if ( V_254 && log -> V_153 -> V_80 . V_256 > 1 ) {
V_251 = F_151 ( log , F_152 ( log , V_252 ) ) ;
} else {
V_251 = F_101 ( F_122 ( V_252 ) ) ;
}
V_233 = V_251 - V_252 ;
ASSERT ( V_233 >= 0 ) ;
ASSERT ( ( V_254 && log -> V_153 -> V_80 . V_256 > 1 &&
V_233 < log -> V_153 -> V_80 . V_256 )
||
( log -> V_153 -> V_80 . V_256 <= 1 &&
V_233 < F_101 ( 1 ) ) ) ;
F_6 ( log , & log -> V_56 . V_12 , V_233 ) ;
F_6 ( log , & log -> V_18 . V_12 , V_233 ) ;
F_138 ( log , V_59 , V_233 ) ;
V_163 = V_59 -> V_98 ;
if ( V_254 )
V_163 += V_233 ;
V_59 -> V_209 . V_257 = F_126 ( V_163 ) ;
V_154 = V_59 -> V_204 ;
F_153 ( V_154 , F_154 ( F_155 ( V_59 -> V_209 . V_238 ) ) ) ;
F_156 ( V_258 , F_122 ( V_251 ) ) ;
if ( F_157 ( V_154 ) + F_122 ( V_251 ) > log -> V_190 ) {
char * V_259 ;
V_253 = V_251 - ( F_101 ( log -> V_190 - F_157 ( V_154 ) ) ) ;
V_251 = F_101 ( log -> V_190 - F_157 ( V_154 ) ) ;
V_59 -> V_260 = 2 ;
V_259 = ( char * ) & V_59 -> V_209 + V_251 ;
for ( V_186 = 0 ; V_186 < V_253 ; V_186 += V_176 ) {
T_13 V_7 = F_158 ( * ( T_16 * ) V_259 ) ;
if ( ++ V_7 == V_211 )
V_7 ++ ;
* ( T_16 * ) V_259 = F_126 ( V_7 ) ;
V_259 += V_176 ;
}
} else {
V_59 -> V_260 = 1 ;
}
V_59 -> V_209 . V_247 = F_140 ( log , & V_59 -> V_209 ,
V_59 -> V_222 , V_163 ) ;
V_154 -> V_261 = F_122 ( V_251 ) ;
V_154 -> V_155 = V_59 ;
F_159 ( V_154 ) ;
F_160 ( V_154 ) ;
V_154 -> V_262 |= V_263 ;
V_154 -> V_264 = log -> V_153 -> V_179 ;
...
ASSERT ( F_157 ( V_154 ) + F_122 ( V_251 ) <= log -> V_190 ) ;
F_162 ( log , V_59 , V_251 , true ) ;
...
if ( V_253 ) {
V_154 = V_59 -> V_157 -> V_200 ;
F_153 ( V_154 , 0 ) ;
F_164 ( V_154 ,
( char * ) & V_59 -> V_209 + V_251 , V_253 ) ;
V_154 -> V_155 = V_59 ;
F_159 ( V_154 ) ;
F_160 ( V_154 ) ;
V_154 -> V_262 |= V_263 ;
...
F_82 ( log -> V_200 ) ;
F_83 ( log -> V_200 ) ;
F_166 ( log -> V_200 , F_122 ( log -> V_169 ) ) ;
F_129 ( log -> V_200 ) ;
V_59 = log -> V_97 ;
for ( V_186 = 0 ; V_186 < log -> V_166 ; V_186 ++ ) {
F_129 ( V_59 -> V_204 ) ;
...
* V_307 = 0 ;
* V_308 = 0 ;
if ( V_59 -> V_219 - V_309 <= sizeof( V_273 ) ) {
F_167 ( log , V_59 , * V_269 , * V_306 ) ;
* V_269 = 0 ;
* V_306 = 0 ;
F_12 ( & log -> V_117 ) ;
...
if ( error )
return error ;
ASSERT ( V_309 <= V_59 -> V_219 - 1 ) ;
V_314 = V_59 -> V_222 + V_309 ;
if ( ! * V_311 )
* V_311 = F_155 ( V_59 -> V_209 . V_238 ) ;
while ( V_280 && ( ! V_280 -> V_113 || V_312 < V_280 -> V_113 ) ) {
struct V_105 * V_106 ;
struct V_286 * V_287 ;
int V_315 ;
...
if ( V_59 -> V_219 - V_59 -> V_98 < 2 * sizeof( V_273 ) ) {
F_184 ( log , V_59 , V_59 -> V_219 ) ;
...
V_345 = V_59 -> V_98 ;
V_59 -> V_67 = V_70 ;
V_59 -> V_209 . V_346 = F_126 ( log -> V_191 ) ;
log -> V_191 = log -> V_342 ;
log -> V_347 = log -> V_192 ;
log -> V_342 += F_122 ( V_345 ) + F_122 ( log -> V_172 ) ;
if ( F_109 ( & log -> V_153 -> V_80 ) &&
log -> V_153 -> V_80 . V_256 > 1 ) {
T_13 V_348 = F_122 ( log -> V_153 -> V_80 . V_256 ) ;
...
* V_349 = 1 ;
F_12 ( & log -> V_117 ) ;
if ( F_155 ( V_59 -> V_209 . V_238 ) == V_61 &&
V_59 -> V_67 != V_119 )
goto V_352;
else
goto V_351;
...
V_44 += log -> V_172 ;
if ( F_109 ( & V_37 -> V_80 ) && V_37 -> V_80 . V_256 > 1 ) {
V_44 += 2 * V_37 -> V_80 . V_256 ;
} else {
V_44 += 2 * V_176 ;
}
return V_44 ;
...
int V_367 = 0 ;
for ( V_186 = 0 ; V_186 < log -> V_166 ; V_186 ++ ) {
if ( V_314 >= log -> V_207 [ V_186 ] &&
V_314 <= log -> V_207 [ V_186 ] + log -> V_169 )
V_367 ++ ;
}
if ( ! V_367 )
...
T_20 V_375 ;
T_5 V_376 ;
int V_30 , V_186 , V_234 , V_235 , V_377 ;
int V_378 ;
F_12 ( & log -> V_117 ) ;
V_373 = log -> V_97 ;
...
F_15 ( & log -> V_117 ) ;
if ( V_59 -> V_209 . V_210 != F_126 ( V_211 ) )
F_207 ( log -> V_153 , L_102 , V_116 ) ;
V_314 = ( V_208 ) & V_59 -> V_209 ;
for ( V_314 += V_176 ; V_314 < ( ( V_208 ) & V_59 -> V_209 ) + V_251 ;
V_314 += V_176 ) {
if ( * ( T_16 * ) V_314 == F_126 ( V_211 ) )
F_207 ( log -> V_153 , L_103 ,
V_116 ) ;
}
V_30 = F_158 ( V_59 -> V_209 . V_271 ) ;
V_314 = V_59 -> V_222 ;
V_374 = V_314 ;
V_372 = ( V_273 * ) V_314 ;
V_240 = V_59 -> V_205 ;
...
V_372 = ( V_273 * ) V_314 ;
V_375 = ( T_20 )
( ( V_208 ) & ( V_372 -> V_289 ) - V_374 ) ;
if ( ! V_371 || ( V_375 & 0x1ff ) ) {
V_376 = V_372 -> V_289 ;
} else {
V_378 = F_133 ( ( V_208 ) & ( V_372 -> V_289 ) - V_59 -> V_222 ) ;
if ( V_378 >= ( V_171 / V_176 ) ) {
V_234 = V_378 / ( V_171 / V_176 ) ;
V_235 = V_378 % ( V_171 / V_176 ) ;
V_376 = F_209 (
V_240 [ V_234 ] . V_241 . V_242 [ V_235 ] ) ;
} else {
V_376 = F_209 (
V_59 -> V_209 . V_239 [ V_378 ] ) ;
}
}
...
V_234 = V_378 / ( V_171 / V_176 ) ;
V_235 = V_378 % ( V_171 / V_176 ) ;
V_377 = F_158 ( V_240 [ V_234 ] . V_241 . V_242 [ V_235 ] ) ;
} else {
V_377 = F_158 ( V_59 -> V_209 . V_239 [ V_378 ] ) ;
}
}
