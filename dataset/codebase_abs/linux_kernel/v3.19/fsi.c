...
static void F_70 ( struct V_31 * V_32 , int V_120 )
{
V_32 -> V_59 += V_120 ;
if ( V_32 -> V_59 >=
...
static void F_72 ( struct V_13 * V_14 , T_3 * V_122 , int V_42 )
{
int V_123 ;
if ( F_15 ( V_14 ) ) {
T_1 * V_124 = ( T_1 * ) V_122 ;
for ( V_123 = 0 ; V_123 < V_42 / 2 ; V_123 ++ )
F_28 ( V_14 , V_125 , V_124 [ V_123 ] ) ;
} else {
T_4 * V_124 = ( T_4 * ) V_122 ;
for ( V_123 = 0 ; V_123 < V_42 ; V_123 ++ )
F_28 ( V_14 , V_125 , ( ( T_1 ) * ( V_124 + V_123 ) << 8 ) ) ;
}
}
static void F_73 ( struct V_13 * V_14 , T_3 * V_122 , int V_42 )
{
T_4 * V_124 = ( T_4 * ) V_122 ;
int V_123 ;
for ( V_123 = 0 ; V_123 < V_42 ; V_123 ++ )
* ( V_124 + V_123 ) = ( T_4 ) ( F_26 ( V_14 , V_126 ) >> 8 ) ;
}
static void F_74 ( struct V_13 * V_14 , T_3 * V_122 , int V_42 )
{
T_1 * V_124 = ( T_1 * ) V_122 ;
int V_123 ;
for ( V_123 = 0 ; V_123 < V_42 ; V_123 ++ )
...
static void F_75 ( struct V_13 * V_14 , T_3 * V_122 , int V_42 )
{
T_1 * V_124 = ( T_1 * ) V_122 ;
int V_123 ;
for ( V_123 = 0 ; V_123 < V_42 ; V_123 ++ )
* ( V_124 + V_123 ) = F_26 ( V_14 , V_126 ) ;
}
static T_3 * F_76 ( struct V_13 * V_14 , struct V_31 * V_32 )
{
struct V_56 * V_54 = V_32 -> V_19 -> V_54 ;
return V_54 -> V_127 +
F_33 ( V_54 , V_32 -> V_59 ) ;
}
static int F_77 ( struct V_13 * V_14 , struct V_31 * V_32 ,
void (* F_78)( struct V_13 * V_14 , T_3 * V_124 , int V_42 ) ,
void (* F_79)( struct V_13 * V_14 , T_3 * V_124 , int V_42 ) ,
int V_42 )
{
T_3 * V_124 ;
if ( ! F_30 ( V_14 , V_32 ) )
return - V_103 ;
V_124 = F_76 ( V_14 , V_32 ) ;
switch ( V_32 -> V_63 ) {
case 2 :
F_78 ( V_14 , V_124 , V_42 ) ;
break;
case 4 :
F_79 ( V_14 , V_124 , V_42 ) ;
break;
default:
return - V_103 ;
}
...
return F_77 ( V_14 , V_32 ,
F_73 ,
F_75 ,
V_42 ) ;
}
static int F_81 ( struct V_13 * V_14 , struct V_31 * V_32 )
{
int V_128 ;
int V_129 ;
int V_42 ;
...
static int F_82 ( struct V_13 * V_14 , struct V_31 * V_32 ,
int V_92 )
{
struct V_5 * V_6 = F_11 ( V_14 ) ;
...
F_45 ( V_14 , V_32 ) ;
if ( F_12 ( V_14 ) )
F_83 ( V_6 , V_133 , V_109 , ( V_92 ) ? V_109 : 0 ) ;
return 0 ;
}
static int F_84 ( struct V_13 * V_14 , struct V_31 * V_32 )
{
if ( F_15 ( V_14 ) )
V_32 -> V_64 = F_85 ( 24 , V_83 ) |
F_85 ( 16 , V_80 ) ;
else
V_32 -> V_64 = F_85 ( 24 , V_83 ) |
F_85 ( 16 , V_83 ) ;
...
static int F_86 ( struct V_13 * V_14 , struct V_31 * V_32 )
{
V_32 -> V_64 = F_85 ( 24 , V_83 ) |
F_85 ( 16 , V_83 ) ;
return 0 ;
}
static T_5 F_87 ( int V_134 , void * V_2 )
{
struct V_5 * V_6 = V_2 ;
T_1 V_91 = F_46 ( V_6 ) ;
F_83 ( V_6 , V_135 , V_136 , 0 ) ;
F_83 ( V_6 , V_135 , V_136 , V_136 ) ;
if ( V_91 & F_43 ( 1 , V_36 ) )
F_37 ( & V_6 -> V_29 . V_49 ) ;
if ( V_91 & F_43 ( 1 , V_38 ) )
F_37 ( & V_6 -> V_30 . V_49 ) ;
...
static int F_88 ( struct V_13 * V_14 , struct V_31 * V_32 )
{
V_32 -> V_64 = F_85 ( 24 , V_83 ) |
F_85 ( 16 , V_80 ) ;
return 0 ;
...
static int F_96 ( struct V_13 * V_14 , struct V_31 * V_32 ,
int V_153 )
{
struct V_5 * V_6 = F_11 ( V_14 ) ;
T_1 V_109 = F_13 ( V_14 ) ? V_131 : V_132 ;
T_1 V_92 = V_153 ? V_154 : 0 ;
F_62 ( V_14 , V_85 , V_154 , V_92 ) ;
F_97 ( V_32 -> V_144 ) ;
if ( F_12 ( V_14 ) )
F_83 ( V_6 , V_133 , V_109 , ( V_92 ) ? V_109 : 0 ) ;
return 0 ;
}
static int F_98 ( struct V_13 * V_14 , struct V_31 * V_32 , struct V_70 * V_66 )
{
T_6 V_3 ;
int V_33 = F_22 ( V_14 , V_32 ) ;
F_99 ( V_3 ) ;
F_100 ( V_155 , V_3 ) ;
V_32 -> V_144 = F_101 ( V_3 ,
V_156 , ( void * ) V_32 -> V_157 ,
V_66 , V_33 ? L_31 : L_32 ) ;
if ( V_32 -> V_144 ) {
struct V_158 V_159 ;
int V_7 ;
V_159 . V_160 = V_32 -> V_157 ;
V_159 . V_161 = 0 ;
V_159 . V_162 = 0 ;
V_159 . V_163 = V_33 ? V_142 : V_143 ;
V_7 = F_102 ( V_32 -> V_144 , & V_159 ) ;
if ( V_7 < 0 ) {
F_103 ( V_32 -> V_144 ) ;
V_32 -> V_144 = NULL ;
}
...
if ( ! V_32 -> V_144 ) {
if ( V_33 )
V_14 -> V_49 . V_164 = & V_165 ;
else
V_14 -> V_53 . V_164 = & V_166 ;
F_104 ( V_66 , L_33 ) ;
return F_38 ( V_14 , V_66 ) ;
}
return 0 ;
}
static int F_105 ( struct V_13 * V_14 , struct V_31 * V_32 )
{
F_106 ( V_14 , V_32 ) ;
if ( V_32 -> V_144 )
F_103 ( V_32 -> V_144 ) ;
...
T_1 V_35 , V_123 ;
int V_167 ;
V_35 = F_108 ( V_6 , V_168 ) ;
V_35 >>= F_21 ( V_14 , V_32 ) ;
V_35 &= V_169 ;
V_167 = 256 << V_35 ;
F_41 ( V_66 , L_34 , V_167 ) ;
for ( V_123 = 1 ; V_123 < V_14 -> V_41 ; V_123 <<= 1 )
V_167 >>= 1 ;
F_41 ( V_66 , L_35 ,
V_14 -> V_41 , V_167 ) ;
V_32 -> V_130 = F_23 ( V_14 , V_167 ) ;
if ( V_33 ) {
F_28 ( V_14 , V_170 , V_171 ) ;
F_62 ( V_14 , V_170 , V_152 , V_152 ) ;
} else {
F_28 ( V_14 , V_151 , V_171 ) ;
F_62 ( V_14 , V_151 , V_152 , V_152 ) ;
}
}
...
if ( F_12 ( V_14 ) )
V_2 = V_172 | V_173 ;
F_62 ( V_14 , V_106 , ( V_172 | V_173 ) , V_2 ) ;
V_2 = 0 ;
if ( V_14 -> V_174 )
V_2 |= ( 1 << 0 ) ;
if ( V_14 -> V_175 )
...
if ( F_14 ( V_14 ) ) {
F_49 ( V_14 , 1 ) ;
F_62 ( V_14 , V_177 , V_178 , V_178 ) ;
}
V_2 = 0 ;
switch ( V_32 -> V_63 ) {
case 2 :
V_2 = F_110 ( 16 , V_32 -> V_64 ) ;
break;
case 4 :
V_2 = F_110 ( 24 , V_32 -> V_64 ) ;
break;
}
F_40 ( V_14 , V_32 , V_2 , V_66 ) ;
F_45 ( V_14 , V_32 ) ;
F_48 ( V_14 ) ;
F_107 ( V_14 , V_32 , V_66 ) ;
if ( F_12 ( V_14 ) )
...
static int F_114 ( struct V_18 * V_19 , int V_179 ,
struct V_22 * V_27 )
{
struct V_13 * V_14 = F_20 ( V_19 ) ;
...
static int F_116 ( struct V_13 * V_14 , unsigned int V_75 )
{
switch ( V_75 & V_182 ) {
case V_183 :
V_14 -> V_75 = V_184 ;
...
if ( F_10 ( V_6 ) < 2 )
return - V_103 ;
V_14 -> V_75 = V_187 | V_186 ;
V_14 -> V_41 = 2 ;
return 0 ;
}
static int F_118 ( struct V_22 * V_27 , unsigned int V_75 )
{
...
static T_7 F_129 ( struct V_18 * V_19 )
{
struct V_13 * V_14 = F_20 ( V_19 ) ;
struct V_31 * V_32 = F_29 ( V_14 , V_19 ) ;
...
V_24 -> V_203 ,
V_204 ,
V_24 -> V_205 -> V_206 -> V_66 ,
V_207 , V_208 ) ;
}
static void F_134 ( char * V_209 ,
struct V_210 * V_211 ,
struct V_212 * V_213 ,
struct V_70 * V_66 )
{
...
for ( V_123 = 0 ; V_123 < F_135 ( V_215 ) ; V_123 ++ ) {
sprintf ( V_214 , L_39 , V_209 , V_215 [ V_123 ] . V_209 ) ;
if ( F_136 ( V_211 , V_214 , NULL ) )
V_8 |= V_215 [ V_123 ] . V_4 ;
}
V_213 -> V_8 = V_8 ;
F_41 ( V_66 , L_40 , V_209 , V_213 -> V_8 ) ;
}
...
V_14 -> V_53 . V_55 = V_14 ;
if ( V_213 -> V_219 ) {
V_14 -> V_49 . V_157 = V_213 -> V_219 ;
V_14 -> V_49 . V_164 = & V_220 ;
}
}
static int F_139 ( struct V_221 * V_222 )
{
struct V_5 * V_6 ;
struct V_210 * V_211 = V_222 -> V_66 . V_223 ;
struct V_224 V_213 ;
const struct V_225 * V_11 ;
struct V_13 * V_14 ;
struct V_226 * V_227 ;
unsigned int V_134 ;
int V_7 ;
...
V_229 = F_140 ( V_230 , & V_222 -> V_66 ) ;
if ( V_229 ) {
V_11 = V_229 -> V_2 ;
F_134 ( L_41 , V_211 , & V_213 . V_231 , & V_222 -> V_66 ) ;
F_134 ( L_42 , V_211 , & V_213 . V_232 , & V_222 -> V_66 ) ;
}
} else {
const struct V_233 * V_234 = V_222 -> V_234 ;
if ( V_234 )
V_11 = (struct V_225 * ) V_234 -> V_235 ;
if ( V_222 -> V_66 . V_236 )
memcpy ( & V_213 , V_222 -> V_66 . V_236 , sizeof( V_213 ) ) ;
}
if ( ! V_11 ) {
F_36 ( & V_222 -> V_66 , L_43 ) ;
return - V_237 ;
}
V_227 = F_141 ( V_222 , V_238 , 0 ) ;
V_134 = F_142 ( V_222 , 0 ) ;
if ( ! V_227 || ( int ) V_134 <= 0 ) {
F_36 ( & V_222 -> V_66 , L_44 ) ;
return - V_237 ;
}
V_6 = F_143 ( & V_222 -> V_66 , sizeof( * V_6 ) , V_239 ) ;
if ( ! V_6 ) {
F_36 ( & V_222 -> V_66 , L_45 ) ;
return - V_240 ;
}
V_6 -> V_10 = F_144 ( & V_222 -> V_66 ,
V_227 -> V_153 , F_145 ( V_227 ) ) ;
if ( ! V_6 -> V_10 ) {
F_36 ( & V_222 -> V_66 , L_46 ) ;
return - V_241 ;
}
V_6 -> V_11 = V_11 ;
F_146 ( & V_6 -> V_9 ) ;
...
V_14 -> V_10 = V_6 -> V_10 ;
V_14 -> V_6 = V_6 ;
F_137 ( V_14 , & V_213 . V_231 ) ;
F_138 ( V_14 , & V_213 . V_231 ) ;
V_7 = F_38 ( V_14 , & V_222 -> V_66 ) ;
if ( V_7 < 0 ) {
F_36 ( & V_222 -> V_66 , L_47 ) ;
return V_7 ;
}
V_14 = & V_6 -> V_30 ;
V_14 -> V_10 = V_6 -> V_10 + 0x40 ;
V_14 -> V_6 = V_6 ;
F_137 ( V_14 , & V_213 . V_232 ) ;
F_138 ( V_14 , & V_213 . V_232 ) ;
V_7 = F_38 ( V_14 , & V_222 -> V_66 ) ;
if ( V_7 < 0 ) {
F_36 ( & V_222 -> V_66 , L_48 ) ;
goto V_242;
}
F_147 ( & V_222 -> V_66 ) ;
F_148 ( & V_222 -> V_66 , V_6 ) ;
V_7 = F_149 ( & V_222 -> V_66 , V_134 , & F_87 , 0 ,
F_150 ( & V_222 -> V_66 ) , V_6 ) ;
if ( V_7 ) {
F_36 ( & V_222 -> V_66 , L_49 ) ;
goto V_243;
}
V_7 = F_151 ( & V_222 -> V_66 , & V_244 ) ;
if ( V_7 < 0 ) {
F_36 ( & V_222 -> V_66 , L_50 ) ;
goto V_243;
}
V_7 = F_152 ( & V_222 -> V_66 , & V_245 ,
V_246 , F_135 ( V_246 ) ) ;
if ( V_7 < 0 ) {
F_36 ( & V_222 -> V_66 , L_51 ) ;
goto V_247;
}
return V_7 ;
V_247:
...
static int F_155 ( struct V_221 * V_222 )
{
struct V_5 * V_6 ;
V_6 = F_156 ( & V_222 -> V_66 ) ;
F_154 ( & V_222 -> V_66 ) ;
F_157 ( & V_222 -> V_66 ) ;
F_153 ( & V_222 -> V_66 ) ;
F_39 ( & V_6 -> V_29 ) ;
...
if ( ! F_30 ( V_14 , V_32 ) )
return;
F_109 ( V_14 , V_32 , V_66 ) ;
F_115 ( V_14 , V_32 ) ;
}
static int F_160 ( struct V_70 * V_66 )
{
struct V_5 * V_6 = F_156 ( V_66 ) ;
struct V_13 * V_29 = & V_6 -> V_29 ;
struct V_13 * V_30 = & V_6 -> V_30 ;
F_158 ( V_29 , & V_29 -> V_49 , V_66 ) ;
F_158 ( V_29 , & V_29 -> V_53 , V_66 ) ;
F_158 ( V_30 , & V_30 -> V_49 , V_66 ) ;
F_158 ( V_30 , & V_30 -> V_53 , V_66 ) ;
return 0 ;
}
...
struct V_13 * V_29 = & V_6 -> V_29 ;
struct V_13 * V_30 = & V_6 -> V_30 ;
F_159 ( V_29 , & V_29 -> V_49 , V_66 ) ;
F_159 ( V_29 , & V_29 -> V_53 , V_66 ) ;
F_159 ( V_30 , & V_30 -> V_49 , V_66 ) ;
F_159 ( V_30 , & V_30 -> V_53 , V_66 ) ;
return 0 ;
}
