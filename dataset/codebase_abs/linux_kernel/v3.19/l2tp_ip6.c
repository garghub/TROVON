...
V_155:
F_39 ( V_3 ) ;
V_56 = F_83 ( V_3 , V_156 , V_111 ,
V_129 , V_128 , V_125 , V_126 , V_117 ,
& V_123 , (struct V_157 * ) V_121 ,
V_111 -> V_132 , V_127 ) ;
if ( V_56 )
F_40 ( V_3 ) ;
else if ( ! ( V_111 -> V_132 & V_158 ) )
V_56 = F_64 ( V_3 ) ;
F_41 ( V_3 ) ;
V_159:
F_84 ( V_121 ) ;
...
V_154:
F_85 ( V_121 ) ;
if ( ! ( V_111 -> V_132 & V_160 ) || V_31 )
goto V_155;
V_56 = 0 ;
goto V_159;
}
static int F_86 ( struct V_108 * V_109 , struct V_2 * V_3 ,
struct V_110 * V_111 , T_2 V_31 , int V_161 ,
int V_92 , int * V_48 )
{
struct V_51 * V_52 = F_45 ( V_3 ) ;
F_69 ( struct V_53 * , V_85 , V_111 -> V_114 ) ;
