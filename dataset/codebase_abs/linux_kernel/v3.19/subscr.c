...
F_29 ( & V_4 -> V_34 , V_4 -> V_29 ) ;
}
* V_39 = V_4 ;
return 0 ;
}
static void F_30 ( int V_21 , void * V_47 )
{
F_18 ( (struct V_10 * ) V_47 ) ;
}
static void F_31 ( int V_21 , struct V_48 * V_49 ,
void * V_47 , void * V_50 , T_2 V_51 )
{
struct V_10 * V_11 = V_47 ;
struct V_3 * V_4 = NULL ;
F_8 ( & V_11 -> V_28 ) ;
if ( F_22 ( (struct V_37 * ) V_50 , V_11 , & V_4 ) < 0 ) {
F_9 ( & V_11 -> V_28 ) ;
F_16 ( V_11 ) ;
return;
}
...
static void * F_33 ( int V_21 )
{
struct V_10 * V_11 ;
V_11 = F_34 ( sizeof( struct V_10 ) , V_44 ) ;
if ( V_11 == NULL ) {
F_24 ( L_4 ) ;
return NULL ;
}
