...
if ( ! V_82 )
return - V_85 ;
V_84 = (struct V_83 * ) ( V_82 -> V_86 + V_87 ) ;
memcpy ( & V_84 -> V_86 . V_88 . V_89 , V_2 -> V_89 , V_90 ) ;
if ( V_2 -> V_19 == V_21 )
memcpy ( V_84 -> V_86 . V_88 . V_91 , & V_2 -> V_36 . V_49 . V_2 ,
sizeof( struct V_51 ) ) ;
else
memcpy ( & V_84 -> V_86 . V_88 . V_92 , & V_2 -> V_36 . V_47 . V_2 , 4 ) ;
V_4 = F_41 ( V_28 , V_82 , NULL , NULL ) ;
return V_4 ;
}
static void F_42 ( T_3 * V_93 , unsigned int V_23 )
{
int V_24 , V_25 ;
...
V_84 = (struct V_83 * ) ( V_82 -> V_86 + V_87 ) ;
if ( V_2 -> V_19 == V_21 ) {
memcpy ( V_84 -> V_86 . V_94 . V_95 , & V_2 -> V_36 . V_49 . V_2 ,
sizeof( struct V_51 ) ) ;
F_42 ( V_93 , V_2 -> V_36 . V_49 . V_50 ) ;
memcpy ( V_84 -> V_86 . V_94 . V_48 , V_93 ,
sizeof( struct V_51 ) ) ;
V_84 -> V_86 . V_94 . V_58 = V_58 ;
} else {
memcpy ( V_84 -> V_86 . V_96 . V_95 , & V_2 -> V_36 . V_47 . V_2 , 4 ) ;
memcpy ( V_84 -> V_86 . V_96 . V_48 , & V_2 -> V_36 . V_47 . V_48 , 4 ) ;
V_84 -> V_86 . V_96 . V_58 = V_58 ;
}
V_4 = F_41 ( V_28 , V_82 , NULL , NULL ) ;
return V_4 ;
}
static int F_45 ( struct V_27 * V_28 ,
enum V_97 type , enum V_18 V_60 )
{
int V_4 ;
struct V_83 * V_84 ;
struct V_81 * V_82 ;
F_17 ( V_28 , 4 , L_16 ) ;
V_82 = F_40 ( V_28 , V_98 , V_60 ) ;
if ( ! V_82 )
return - V_85 ;
V_84 = (struct V_83 * ) ( V_82 -> V_86 + V_87 ) ;
V_84 -> V_86 . V_99 . type = ( type ) ;
V_4 = F_41 ( V_28 , V_82 , NULL , NULL ) ;
return V_4 ;
}
...
int V_4 ;
F_17 ( V_28 , 3 , L_17 ) ;
V_4 = F_46 ( V_28 , & V_28 -> V_43 . V_110 . type ,
V_20 ) ;
if ( V_4 )
return V_4 ;
V_4 = F_45 ( V_28 , V_28 -> V_43 . V_110 . type ,
V_20 ) ;
if ( V_4 ) {
V_28 -> V_43 . V_110 . type = V_102 ;
F_49 ( 2 , L_18
L_19 , V_4 ,
F_50 ( V_28 ) ) ;
}
...
if ( ! F_53 ( V_28 , V_111 ) )
return 0 ;
V_4 = F_46 ( V_28 , & V_28 -> V_43 . V_112 . type ,
V_21 ) ;
if ( V_4 )
return V_4 ;
V_4 = F_45 ( V_28 , V_28 -> V_43 . V_112 . type ,
V_21 ) ;
if ( V_4 ) {
V_28 -> V_43 . V_112 . type = V_102 ;
F_49 ( 2 , L_18
L_19 , V_4 ,
F_50 ( V_28 ) ) ;
}
...
F_21 ( & V_28 -> V_59 , V_58 ) ;
F_10 (ipatoe, &card->ipato.entries, entry) {
if ( V_31 -> V_19 != V_113 -> V_19 )
continue;
if ( ! memcmp ( V_31 -> V_2 , V_113 -> V_2 ,
( V_31 -> V_19 == V_20 ) ? 4 : 16 ) &&
( V_31 -> V_37 == V_113 -> V_37 ) ) {
V_4 = - V_114 ;
break;
}
}
if ( ! V_4 )
F_18 ( & V_113 -> V_53 , & V_28 -> V_34 . V_115 ) ;
F_22 ( & V_28 -> V_59 , V_58 ) ;
return V_4 ;
}
...
if ( V_19 == V_20 ) {
F_17 ( V_28 , 2 , L_23 ) ;
memcpy ( & V_116 -> V_36 . V_47 . V_2 , V_2 , 4 ) ;
V_116 -> V_36 . V_47 . V_48 = 0 ;
} else if ( V_19 == V_21 ) {
F_17 ( V_28 , 2 , L_24 ) ;
memcpy ( & V_116 -> V_36 . V_49 . V_2 , V_2 , 16 ) ;
V_116 -> V_36 . V_49 . V_50 = 0 ;
}
V_116 -> type = V_117 ;
V_116 -> V_56 = V_118 ;
V_116 -> V_119 = V_120 ;
...
return - V_85 ;
F_21 ( & V_28 -> V_59 , V_58 ) ;
if ( F_38 ( & V_28 -> V_69 , V_116 , 0 ) ||
F_38 ( V_28 -> V_54 , V_116 , 0 ) )
V_4 = - V_114 ;
F_22 ( & V_28 -> V_59 , V_58 ) ;
if ( V_4 ) {
F_15 ( V_116 ) ;
...
struct V_142 * V_143 , unsigned long V_86 )
{
struct V_83 * V_84 ;
F_17 ( V_28 , 4 , L_45 ) ;
V_84 = (struct V_83 * ) V_86 ;
if ( V_84 -> V_144 . V_145 == 0 ) {
V_84 -> V_144 . V_145 = V_84 -> V_86 . V_146 . V_144 . V_145 ;
...
if ( V_84 -> V_86 . V_146 . V_144 . V_152 == V_153 &&
V_84 -> V_86 . V_146 . V_144 . V_154 == V_155 ) {
V_28 -> V_100 . V_156 = V_84 -> V_86 . V_146 . V_86 . V_157 ;
F_44 ( V_28 , 3 , L_46 , V_28 -> V_100 . V_156 ) ;
}
if ( V_84 -> V_86 . V_146 . V_144 . V_152 == V_158 &&
V_84 -> V_86 . V_146 . V_144 . V_154 == V_155 ) {
V_28 -> V_100 . V_159 =
V_84 -> V_86 . V_146 . V_86 . V_157 ;
F_44 ( V_28 , 3 , L_47 , V_28 -> V_100 . V_159 ) ;
}
return 0 ;
}
...
if ( V_82 ) {
V_84 = (struct V_83 * ) ( V_82 -> V_86 + V_87 ) ;
V_84 -> V_86 . V_146 . V_144 . V_152 = V_161 ;
V_84 -> V_86 . V_146 . V_144 . V_164 = 8 + V_23 ;
V_84 -> V_86 . V_146 . V_144 . V_154 = V_162 ;
V_84 -> V_86 . V_146 . V_144 . V_145 = 0 ;
V_84 -> V_86 . V_146 . V_144 . V_165 = 0 ;
}
return V_82 ;
}
static int F_73 ( struct V_27 * V_28 ,
struct V_81 * V_82 , T_2 V_23 , long V_86 ,
...
V_84 -> V_86 . V_146 . V_86 . V_157 = ( V_167 ) V_86 ;
else
memcpy ( & V_84 -> V_86 . V_146 . V_86 , ( void * ) V_86 , V_23 ) ;
...
enum V_160 V_161 , T_2 V_162 , long V_86 )
{
int V_4 ;
int V_164 = 0 ;
struct V_81 * V_82 ;
...
V_84 = (struct V_83 * ) V_86 ;
if ( V_84 -> V_144 . V_145 == 0 )
V_28 -> V_100 . V_194 = * ( ( T_2 * )
& V_84 -> V_86 . V_193 . V_194 [ 6 ] ) ;
else {
V_28 -> V_100 . V_194 = V_197 |
V_198 ;
...
default:
F_49 ( 2 , L_113 ,
V_84 -> V_86 . V_199 . V_200 , F_50 ( V_28 ) ) ;
}
return 0 ;
}
static int
...
return - V_85 ;
V_84 = (struct V_83 * ) ( V_82 -> V_86 + V_87 ) ;
V_84 -> V_86 . V_199 . V_213 = 16 ;
V_84 -> V_86 . V_199 . V_214 = V_215 ;
V_84 -> V_86 . V_199 . type = V_216 ;
V_84 -> V_86 . V_199 . V_200 = V_211 ;
return F_41 ( V_28 , V_82 , F_102 , NULL ) ;
}
static void F_104 ( V_167 V_217 , char * V_89 ,
struct V_218 * V_125 )
{
F_105 ( V_217 , V_89 ) ;
}
...
V_28 -> V_86 . V_321 , 0 , & V_28 -> V_296 . V_297 ,
& V_28 -> V_296 . V_320 ) ;
...
if ( V_84 -> V_86 . V_146 . V_144 . V_145 ) {
V_84 -> V_144 . V_145 = V_84 -> V_86 . V_146 . V_144 . V_145 ;
F_17 ( V_28 , 4 , L_148 ) ;
F_44 ( V_28 , 4 , L_146 , V_84 -> V_144 . V_145 ) ;
return 0 ;
}
V_351 = & V_84 -> V_86 . V_146 . V_86 . V_374 ;
...
F_44 ( V_28 , 4 , L_152 , - V_85 ) ;
V_84 -> V_144 . V_145 = V_382 ;
goto V_383;
}
memcpy ( V_368 -> V_384 + V_368 -> V_381 ,
& V_351 -> V_86 + V_370 + V_371 ,
V_378 ) ;
V_370 += V_378 + V_371 ;
V_368 -> V_381 += V_378 ;
++ V_368 -> V_348 ;
}
if ( V_84 -> V_86 . V_146 . V_144 . V_165 <
V_84 -> V_86 . V_146 . V_144 . V_385 )
return 1 ;
...
{
F_17 ( V_28 , 4 , L_155 ) ;
memcpy ( V_82 -> V_86 , V_387 , V_87 ) ;
memcpy ( F_180 ( V_82 -> V_86 ) ,
& V_28 -> V_388 . V_389 , V_390 ) ;
return F_181 ( V_28 , V_87 + V_23 , V_82 ,
F_74 , V_166 ) ;
}
...
return - V_85 ;
V_84 = (struct V_83 * ) ( V_82 -> V_86 + V_87 ) ;
V_84 -> V_86 . V_146 . V_86 . V_374 . V_392 = 0x000F ;
V_84 -> V_86 . V_146 . V_86 . V_374 . V_355 = 0 ;
V_84 -> V_86 . V_146 . V_86 . V_374 . V_348 = 0 ;
V_4 = F_179 ( V_28 , V_82 ,
V_393 + V_394 ,
F_178 , ( void * ) V_368 ) ;
if ( V_4 ) {
...
int V_41 ;
F_17 ( V_28 , 3 , L_169 ) ;
if ( V_28 -> V_100 . V_339 || ( V_28 -> V_100 . type == V_101 ) )
return - V_170 ;
if ( ! F_53 ( V_28 , V_168 ) ) {
return - V_170 ;
}
...
break;
case V_421 :
if ( ( V_28 -> V_100 . type == V_422 ||
V_28 -> V_100 . type == V_423 ) &&
! V_28 -> V_100 . V_339 )
return 1 ;
return 0 ;
break;
...
V_129 : 0 ;
if ( ! memcmp ( V_253 -> V_86 , V_253 -> V_125 -> V_265 , 6 ) )
return V_131 ;
else {
T_4 V_435 ;
V_435 = * ( ( T_4 * ) V_253 -> V_86 ) ;
switch ( V_28 -> V_100 . V_436 ) {
case V_437 :
case V_438 :
if ( ( V_435 == V_439 ) ||
( V_435 == V_440 ) )
...
V_144 -> V_144 . V_260 . V_275 = 0 ;
if ( F_203 ( V_253 ) ) {
if ( ( V_446 == 4 ) || ( V_28 -> V_100 . type == V_101 ) )
...
if ( ! memcmp ( V_253 -> V_86 + sizeof( struct V_254 ) ,
V_253 -> V_125 -> V_265 , 6 ) ) {
...
F_209 ( V_253 ) -> V_476 * 4 ;
int V_482 = V_253 -> V_23 - ( V_481 - ( unsigned long ) V_253 -> V_86 ) ;
...
V_495 = F_220 ( V_253 ) ;
if ( ( V_28 -> V_100 . type == V_101 ) && ( ! V_495 ) &&
( F_210 ( V_253 ) -> V_497 == 0 ) ) {
V_487 = V_253 ;
...
F_223 ( V_487 , V_507 ) ;
F_224 ( V_487 , V_487 -> V_86 + 4 , 4 ) ;
F_225 ( V_487 , 4 ,
V_487 -> V_86 + 8 , 4 ) ;
F_225 ( V_487 , 8 ,
V_487 -> V_86 + 12 , 4 ) ;
V_484 = ( T_4 * ) ( V_487 -> V_86 + 12 ) ;
* V_484 = F_136 ( V_230 ) ;
...
if ( V_28 -> V_71 != V_73 )
return - V_409 ;
V_28 -> V_86 . V_71 = V_334 ;
V_28 -> V_71 = V_72 ;
F_235 ( V_125 ) ;
if ( F_236 ( V_28 -> V_86 . V_321 , 0 ) >= 0 ) {
F_237 ( & V_28 -> V_305 ) ;
F_155 ( & V_28 -> V_305 ) ;
} else
V_4 = - V_185 ;
...
if ( V_28 -> V_100 . type == V_422 ||
V_28 -> V_100 . type == V_423 ) {
if ( ( V_28 -> V_100 . V_436 == V_438 ) ||
( V_28 -> V_100 . V_436 == V_437 ) ) {
F_246 ( L_176 ) ;
return - V_409 ;
} else {
V_28 -> V_125 = F_247 ( 0 ) ;
...
F_101 ( V_28 ) ;
if ( ! ( V_28 -> V_100 . V_194 & V_198 ) )
V_28 -> V_125 -> V_541 = V_28 -> V_100 . V_194 &
0xffff ;
if ( ! V_28 -> V_100 . V_339 ) {
...
V_28 -> V_125 -> V_552 = V_28 -> V_100 . V_553 ;
V_28 -> V_125 -> V_554 = & V_555 ;
V_28 -> V_125 -> V_187 |= V_556 |
V_557 |
V_558 ;
F_249 ( V_28 -> V_125 ) ;
V_28 -> V_125 -> V_559 = 15 * V_560 ;
F_250 ( V_28 -> V_125 , & V_28 -> V_124 -> V_125 ) ;
F_251 ( V_28 -> V_125 , & V_28 -> V_305 , F_146 , V_561 ) ;
return F_252 ( V_28 -> V_125 ) ;
}
static int F_253 ( struct V_562 * V_124 )
{
...
static void F_256 ( struct V_562 * V_564 )
{
struct V_27 * V_28 = F_254 ( & V_564 -> V_125 ) ;
F_257 ( & V_564 -> V_125 ) ;
F_163 ( V_28 , 0 , 1 ) ;
F_258 ( V_28 -> V_565 , F_173 ( V_28 , 0xffffffff ) == 0 ) ;
if ( V_564 -> V_71 == V_566 )
F_259 ( V_564 ) ;
if ( V_28 -> V_125 ) {
F_260 ( V_28 -> V_125 ) ;
...
static int F_261 ( struct V_562 * V_124 , int V_332 )
{
struct V_27 * V_28 = F_254 ( & V_124 -> V_125 ) ;
int V_4 = 0 ;
enum V_567 V_568 ;
...
V_28 -> V_100 . V_563 = 0 ;
V_28 -> V_71 = V_336 ;
memset ( & V_28 -> V_296 , 0 , sizeof( struct V_574 ) ) ;
F_267 ( V_28 ) ;
F_65 ( V_139 , 2 , L_180 ) ;
V_4 = F_268 ( V_28 ) ;
if ( V_4 ) {
...
static int F_281 ( struct V_562 * V_124 )
{
return F_261 ( V_124 , 0 ) ;
}
static int F_282 ( struct V_562 * V_564 ,
int V_332 )
{
struct V_27 * V_28 = F_254 ( & V_564 -> V_125 ) ;
...
F_271 ( V_28 -> V_125 ) ;
V_568 = V_28 -> V_71 ;
if ( ( ! V_332 && V_28 -> V_100 . V_563 ) || V_28 -> V_100 . V_563 == 2 ) {
F_266 ( V_28 , V_580 ) ;
V_28 -> V_100 . V_563 = 1 ;
}
F_162 ( V_28 , V_332 ) ;
...
F_90 () ;
F_284 ( V_581 , V_28 -> V_125 ) ;
F_92 () ;
}
V_4 = F_276 ( F_277 ( V_28 ) ) ;
V_578 = F_276 ( F_278 ( V_28 ) ) ;
V_579 = F_276 ( F_279 ( V_28 ) ) ;
if ( ! V_4 )
...
if ( V_568 == V_72 )
V_28 -> V_71 = V_526 ;
F_274 ( & V_564 -> V_125 . V_576 , V_577 ) ;
F_275 ( & V_28 -> V_570 ) ;
F_275 ( & V_28 -> V_569 ) ;
return 0 ;
}
static int F_259 ( struct V_562 * V_564 )
{
return F_282 ( V_564 , 0 ) ;
}
static int F_285 ( void * V_582 )
{
struct V_27 * V_28 ;
int V_4 = 0 ;
...
static void F_292 ( struct V_562 * V_124 )
{
struct V_27 * V_28 = F_254 ( & V_124 -> V_125 ) ;
F_163 ( V_28 , 0 , 1 ) ;
if ( ( V_124 -> V_71 == V_566 ) && V_28 -> V_100 . V_563 )
F_266 ( V_28 , V_580 ) ;
F_167 ( V_28 , 0 ) ;
F_168 ( V_28 ) ;
F_280 ( F_277 ( V_28 ) ) ;
}
static int F_293 ( struct V_562 * V_124 )
{
struct V_27 * V_28 = F_254 ( & V_124 -> V_125 ) ;
if ( V_28 -> V_125 )
F_294 ( V_28 -> V_125 ) ;
...
static int F_295 ( struct V_562 * V_124 )
{
struct V_27 * V_28 = F_254 ( & V_124 -> V_125 ) ;
int V_4 = 0 ;
if ( V_124 -> V_71 == V_583 )
...
static int F_298 ( struct V_584 * V_585 ,
unsigned long V_586 , void * V_582 )
{
struct V_240 * V_241 = (struct V_240 * ) V_582 ;
struct V_218 * V_125 = (struct V_218 * ) V_241 -> V_587 -> V_125 ;
struct V_29 * V_2 ;
struct V_27 * V_28 ;
if ( F_299 ( V_125 ) != & V_588 )
return V_589 ;
V_28 = F_161 ( V_125 ) ;
if ( ! V_28 )
return V_589 ;
...
static int F_300 ( struct V_584 * V_585 ,
unsigned long V_586 , void * V_582 )
{
struct V_246 * V_241 = (struct V_246 * ) V_582 ;
struct V_218 * V_125 = (struct V_218 * ) V_241 -> V_592 -> V_125 ;
struct V_29 * V_2 ;
struct V_27 * V_28 ;
V_28 = F_161 ( V_125 ) ;
if ( ! V_28 )
