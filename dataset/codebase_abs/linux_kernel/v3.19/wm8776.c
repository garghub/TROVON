...
struct V_36 * V_37 ;
int V_58 ;
V_37 = F_22 ( & V_62 -> V_2 , sizeof( struct V_36 ) ,
V_63 ) ;
if ( V_37 == NULL )
return - V_64 ;
V_37 -> V_56 = F_23 ( V_62 , & V_65 ) ;
if ( F_24 ( V_37 -> V_56 ) )
return F_25 ( V_37 -> V_56 ) ;
F_26 ( V_62 , V_37 ) ;
V_58 = F_27 ( & V_62 -> V_2 ,
& V_66 , V_67 , F_12 ( V_67 ) ) ;
return V_58 ;
...
struct V_36 * V_37 ;
int V_58 ;
V_37 = F_22 ( & V_69 -> V_2 , sizeof( struct V_36 ) ,
V_63 ) ;
if ( V_37 == NULL )
return - V_64 ;
V_37 -> V_56 = F_31 ( V_69 , & V_65 ) ;
if ( F_24 ( V_37 -> V_56 ) )
return F_25 ( V_37 -> V_56 ) ;
F_32 ( V_69 , V_37 ) ;
V_58 = F_27 ( & V_69 -> V_2 ,
...
static int F_33 ( struct V_68 * V_71 )
{
F_29 ( & V_71 -> V_2 ) ;
return 0 ;
}
