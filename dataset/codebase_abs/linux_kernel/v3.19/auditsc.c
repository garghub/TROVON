...
if ( ! V_4 -> V_43 || strcmp ( V_4 -> V_43 -> V_43 , V_43 -> V_43 ) )
continue;
if ( V_317 ) {
if ( V_4 -> type == V_336 ||
V_4 -> type == V_330 )
...
return;
if ( V_43 ) {
T_6 V_183 = strlen ( V_43 -> V_43 ) + 1 ;
struct V_328 * V_337 = F_121 () ;
if ( F_2 ( ! V_337 ) )
goto V_279;
if ( V_183 <= ( V_338 - sizeof( * V_337 ) ) ) {
V_337 -> V_43 = ( char * ) ( V_337 ) + sizeof( * V_337 ) ;
V_337 -> V_339 = false ;
} else if ( V_183 <= V_338 ) {
struct V_328 * V_340 ;
V_340 = F_86 ( sizeof( * V_340 ) , V_36 ) ;
if ( F_2 ( ! V_340 ) ) {
F_122 ( V_337 ) ;
goto V_279;
}
V_340 -> V_43 = ( char * ) V_337 ;
V_340 -> V_339 = true ;
V_337 = V_340 ;
} else {
F_122 ( V_337 ) ;
...
F_123 ( ( char * ) V_337 -> V_43 , V_43 -> V_43 , V_183 ) ;
V_337 -> V_329 = NULL ;
V_337 -> V_324 = V_4 ;
V_4 -> V_43 = V_337 ;
V_4 -> V_189 = true ;
...
V_279:
if ( V_317 ) {
V_4 -> V_331 = V_4 -> V_43 ? F_124 ( V_4 -> V_43 -> V_43 ) : V_332 ;
V_4 -> type = V_336 ;
if ( V_273 & V_341 )
V_4 -> V_303 = true ;
} else {
...
F_110 ( V_192 ) ;
F_125 ( V_4 , V_192 , V_314 ) ;
}
void F_126 ( const struct V_343 * V_343 )
{
F_119 ( NULL , V_343 -> V_344 . V_192 , 0 ) ;
}
void F_127 ( const struct V_314 * V_317 ,
const struct V_192 * V_192 ,
const unsigned char type )
{
struct V_1 * V_172 = V_92 -> V_1 ;
const struct V_314 * V_314 = V_192 -> V_322 ;
const char * V_345 = V_192 -> V_346 . V_43 ;
...
continue;
if ( V_4 -> V_22 == V_317 -> V_349 &&
! F_128 ( V_345 , V_4 -> V_43 -> V_43 , V_4 -> V_331 ) ) {
V_347 = V_4 ;
break;
}
}
...
continue;
if ( V_347 && ( V_4 -> V_43 != V_347 -> V_43 ) )
continue;
if ( ! strcmp ( V_345 , V_4 -> V_43 -> V_43 ) ||
! F_128 ( V_345 , V_4 -> V_43 -> V_43 ,
V_347 ?
V_347 -> V_331 :
V_332 ) ) {
V_348 = V_4 ;
...
if ( ! V_4 )
return;
F_125 ( V_4 , NULL , V_317 ) ;
}
if ( ! V_348 ) {
V_348 = F_113 ( V_172 , type ) ;
if ( ! V_348 )
return;
if ( V_347 ) {
V_348 -> V_43 = V_347 -> V_43 ;
V_348 -> V_331 = V_332 ;
V_348 -> V_189 = false ;
}
}
if ( V_314 )
F_125 ( V_348 , V_192 , V_314 ) ;
else
V_348 -> V_22 = ( unsigned long ) - 1 ;
}
int F_129 ( struct V_1 * V_2 ,
struct V_350 * V_351 , unsigned int * V_188 )
{
if ( ! V_2 -> V_177 )
return 0 ;
if ( ! V_2 -> V_188 )
V_2 -> V_188 = F_130 () ;
V_351 -> V_255 = V_2 -> ctime . V_255 ;
V_351 -> V_256 = V_2 -> ctime . V_256 ;
* V_188 = V_2 -> V_188 ;
if ( ! V_2 -> V_24 ) {
V_2 -> V_24 = 1 ;
V_2 -> V_25 = V_26 ;
...
if ( ! F_133 ( V_354 ) )
return - V_353 ;
if ( F_132 ( V_355 ) && F_134 ( V_59 ) )
return - V_353 ;
return 0 ;
}
static void F_135 ( T_2 V_356 , T_2 V_357 ,
unsigned int V_358 , unsigned int V_204 ,
int V_46 )
{
struct V_206 * V_207 ;
T_8 V_42 , V_359 , V_59 ;
if ( ! V_309 )
return;
V_42 = F_72 ( & V_209 , F_136 ( V_92 ) ) ;
V_359 = F_72 ( & V_209 , V_356 ) ;
V_59 = F_72 ( & V_209 , V_357 ) ,
V_207 = F_70 ( NULL , V_36 , V_360 ) ;
if ( ! V_207 )
return;
F_71 ( V_207 , L_63 , F_28 ( V_92 ) , V_42 ) ;
F_137 ( V_207 ) ;
F_71 ( V_207 , L_64 ,
V_359 , V_59 , V_358 , V_204 , ! V_46 ) ;
F_76 ( V_207 ) ;
}
int F_138 ( T_2 V_59 )
{
struct V_49 * V_361 = V_92 ;
unsigned int V_358 , V_204 = ( unsigned int ) - 1 ;
T_2 V_359 ;
int V_46 ;
V_359 = F_139 ( V_92 ) ;
V_358 = F_140 ( V_92 ) ;
...
goto V_279;
if ( F_134 ( V_59 ) )
V_204 = ( unsigned int ) F_141 ( & V_362 ) ;
V_361 -> V_204 = V_204 ;
V_361 -> V_59 = V_59 ;
V_279:
F_135 ( V_359 , V_59 , V_358 , V_204 , V_46 ) ;
return V_46 ;
}
void F_142 ( int V_243 , T_1 V_21 , struct V_261 * V_244 )
{
struct V_1 * V_172 = V_92 -> V_1 ;
if ( V_244 )
...
void F_143 ( T_9 V_251 , T_6 V_252 , unsigned int V_253 ,
const struct V_350 * V_254 )
{
struct V_1 * V_172 = V_92 -> V_1 ;
struct V_350 * V_30 = & V_172 -> V_250 . V_254 ;
if ( V_254 )
memcpy ( V_30 , V_254 , sizeof( struct V_350 ) ) ;
else
memset ( V_30 , 0 , sizeof( struct V_350 ) ) ;
V_172 -> V_250 . V_251 = V_251 ;
V_172 -> V_250 . V_252 = V_252 ;
V_172 -> V_250 . V_253 = V_253 ;
V_172 -> type = V_249 ;
}
void F_144 ( T_9 V_251 , const struct V_363 * V_364 )
{
struct V_1 * V_172 = V_92 -> V_1 ;
if ( V_364 )
V_172 -> V_258 . V_259 = V_364 -> V_259 ;
else
V_172 -> V_258 . V_259 = 0 ;
V_172 -> V_258 . V_251 = V_251 ;
V_172 -> type = V_257 ;
}
void F_145 ( T_9 V_251 , struct V_261 * V_263 )
{
struct V_1 * V_172 = V_92 -> V_1 ;
...
void F_146 ( struct V_365 * V_366 )
{
struct V_1 * V_172 = V_92 -> V_1 ;
V_172 -> V_144 . V_42 = V_366 -> V_42 ;
V_172 -> V_144 . V_48 = V_366 -> V_48 ;
V_172 -> V_144 . V_21 = V_366 -> V_21 ;
V_172 -> V_144 . V_235 = 0 ;
F_147 ( V_366 , & V_172 -> V_144 . V_142 ) ;
V_172 -> type = V_143 ;
}
void F_148 ( unsigned long V_237 , T_8 V_42 , T_10 V_48 , T_1 V_21 )
{
struct V_1 * V_172 = V_92 -> V_1 ;
...
struct V_1 * V_172 = V_92 -> V_1 ;
V_172 -> type = V_226 ;
V_172 -> V_229 . V_230 = V_368 -> V_230 ;
}
int F_150 ( int V_233 , unsigned long * args )
{
struct V_1 * V_172 = V_92 -> V_1 ;
...
void F_151 ( int V_371 , int V_372 )
{
struct V_1 * V_172 = V_92 -> V_1 ;
V_172 -> V_290 [ 0 ] = V_371 ;
V_172 -> V_290 [ 1 ] = V_372 ;
}
int F_152 ( int V_183 , void * V_373 )
{
struct V_1 * V_172 = V_92 -> V_1 ;
if ( ! V_172 -> V_202 ) {
void * V_30 = F_86 ( sizeof( struct V_374 ) , V_36 ) ;
if ( ! V_30 )
return - V_201 ;
V_172 -> V_202 = V_30 ;
}
V_172 -> V_292 = V_183 ;
memcpy ( V_172 -> V_202 , V_373 , V_183 ) ;
return 0 ;
}
void F_153 ( struct V_49 * V_351 )
{
struct V_1 * V_172 = V_92 -> V_1 ;
V_172 -> V_296 = F_28 ( V_351 ) ;
V_172 -> V_297 = F_139 ( V_351 ) ;
V_172 -> V_298 = F_136 ( V_351 ) ;
V_172 -> V_299 = F_140 ( V_351 ) ;
F_37 ( V_351 , & V_172 -> V_300 ) ;
memcpy ( V_172 -> V_301 , V_351 -> V_205 , V_375 ) ;
}
int F_154 ( int V_376 , struct V_49 * V_351 )
{
struct V_294 * V_377 ;
struct V_49 * V_50 = V_92 ;
struct V_1 * V_2 = V_50 -> V_1 ;
T_2 V_42 = F_155 () , V_378 = F_136 ( V_351 ) ;
if ( V_168 && V_351 -> V_169 == V_168 ) {
...
if ( ! V_2 -> V_296 ) {
V_2 -> V_296 = F_157 ( V_351 ) ;
V_2 -> V_297 = F_139 ( V_351 ) ;
V_2 -> V_298 = V_378 ;
V_2 -> V_299 = F_140 ( V_351 ) ;
F_37 ( V_351 , & V_2 -> V_300 ) ;
memcpy ( V_2 -> V_301 , V_351 -> V_205 , V_375 ) ;
return 0 ;
}
V_377 = ( void * ) V_2 -> V_196 ;
if ( ! V_377 || V_377 -> V_295 == V_387 ) {
V_377 = F_12 ( sizeof( * V_377 ) , V_154 ) ;
if ( ! V_377 )
return - V_201 ;
V_377 -> V_316 . type = V_208 ;
V_377 -> V_316 . V_35 = V_2 -> V_196 ;
V_2 -> V_196 = ( void * ) V_377 ;
}
F_103 ( V_377 -> V_295 >= V_387 ) ;
V_377 -> V_296 [ V_377 -> V_295 ] = F_157 ( V_351 ) ;
V_377 -> V_297 [ V_377 -> V_295 ] = F_139 ( V_351 ) ;
V_377 -> V_298 [ V_377 -> V_295 ] = V_378 ;
V_377 -> V_299 [ V_377 -> V_295 ] = F_140 ( V_351 ) ;
F_37 ( V_351 , & V_377 -> V_300 [ V_377 -> V_295 ] ) ;
memcpy ( V_377 -> V_301 [ V_377 -> V_295 ] , V_351 -> V_205 , V_375 ) ;
V_377 -> V_295 ++ ;
return 0 ;
}
int F_158 ( struct V_367 * V_368 ,
const struct V_51 * V_337 , const struct V_51 * V_388 )
{
struct V_283 * V_389 ;
struct V_1 * V_172 = V_92 -> V_1 ;
struct V_390 V_391 ;
struct V_192 * V_192 ;
V_389 = F_86 ( sizeof( * V_389 ) , V_36 ) ;
if ( ! V_389 )
return - V_201 ;
V_389 -> V_316 . type = V_282 ;
V_389 -> V_316 . V_35 = V_172 -> V_195 ;
V_172 -> V_195 = ( void * ) V_389 ;
V_192 = F_159 ( V_368 -> V_343 -> V_344 . V_192 ) ;
F_160 ( V_192 , & V_391 ) ;
F_161 ( V_192 ) ;
V_389 -> V_286 . V_268 = V_391 . V_268 ;
V_389 -> V_286 . V_267 = V_391 . V_267 ;
V_389 -> V_286 . V_287 = ! ! ( V_391 . V_392 & V_393 ) ;
V_389 -> V_285 = ( V_391 . V_392 & V_394 ) >> V_395 ;
V_389 -> V_288 . V_268 = V_388 -> V_396 ;
V_389 -> V_288 . V_267 = V_388 -> V_397 ;
V_389 -> V_288 . V_269 = V_388 -> V_398 ;
V_389 -> V_289 . V_268 = V_337 -> V_396 ;
V_389 -> V_289 . V_267 = V_337 -> V_397 ;
V_389 -> V_289 . V_269 = V_337 -> V_398 ;
return 0 ;
}
void F_162 ( const struct V_51 * V_337 , const struct V_51 * V_388 )
{
struct V_1 * V_172 = V_92 -> V_1 ;
V_172 -> V_265 . V_96 = F_28 ( V_92 ) ;
V_172 -> V_265 . V_266 . V_269 = V_337 -> V_398 ;
V_172 -> V_265 . V_266 . V_267 = V_337 -> V_398 ;
V_172 -> V_265 . V_266 . V_268 = V_337 -> V_396 ;
V_172 -> type = V_264 ;
}
void F_163 ( int V_272 , int V_273 )
{
struct V_1 * V_172 = V_92 -> V_1 ;
...
static void F_164 ( struct V_206 * V_207 )
{
T_2 V_203 , V_42 ;
T_3 V_48 ;
unsigned int V_204 ;
struct V_399 * V_227 = V_92 -> V_227 ;
...
F_75 ( V_207 , F_166 ( V_205 , V_92 ) ) ;
if ( V_227 ) {
F_167 ( & V_227 -> V_400 ) ;
if ( V_227 -> V_401 )
F_98 ( V_207 , L_67 , & V_227 -> V_401 -> V_344 ) ;
F_168 ( & V_227 -> V_400 ) ;
} else
F_71 ( V_207 , L_68 ) ;
}
void F_169 ( long V_402 )
{
struct V_206 * V_207 ;
if ( ! V_309 )
return;
if ( V_402 == V_403 )
return;
V_207 = F_70 ( NULL , V_36 , V_404 ) ;
if ( F_2 ( ! V_207 ) )
return;
F_164 ( V_207 ) ;
F_71 ( V_207 , L_69 , V_402 ) ;
F_76 ( V_207 ) ;
}
void F_170 ( unsigned long V_405 , long V_402 , int V_406 )
{
struct V_206 * V_207 ;
V_207 = F_70 ( NULL , V_36 , V_407 ) ;
if ( F_2 ( ! V_207 ) )
return;
F_164 ( V_207 ) ;
F_71 ( V_207 , L_70 ,
V_402 , F_104 () , V_405 , F_171 () ,
F_172 ( V_92 ) , V_406 ) ;
F_76 ( V_207 ) ;
}
struct V_166 * F_173 ( void )
{
