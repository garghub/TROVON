...
if ( V_10 -> V_33 . V_179 &
( V_247 | V_241 ) )
V_282 = V_216 -> V_219 >> V_83 -> V_145 . V_221 ;
V_10 -> V_33 . V_220 = V_282 ;
}
...
STATIC int
F_108 ( void * * V_289 , struct V_290 * V_291 , int * V_292 )
{
struct V_293 V_14 * V_294 = (struct V_293 V_14 * ) * V_289 ;
...
if ( V_138 & V_172 )
V_295 . V_297 |= V_300 ;
error = F_110 ( V_10 , & V_295 , F_108 ,
( V_301 struct V_293 * ) V_92 + 1 ) ;
if ( error )
return error ;
...
STATIC int
F_111 ( void * * V_289 , struct V_290 * V_291 , int * V_292 )
{
struct V_290 V_14 * V_294 = (struct V_290 V_14 * ) * V_289 ;
...
if ( V_295 . V_296 < 2 )
return - V_17 ;
if ( V_295 . V_297 & ( ~ V_302 ) )
return - V_17 ;
error = F_110 ( V_10 , & V_295 , F_111 ,
( V_301 struct V_290 * ) V_92 + 1 ) ;
if ( error )
return error ;
...
if ( ! ( V_305 . V_12 -> V_73 & V_68 ) ||
! ( V_305 . V_12 -> V_73 & V_307 ) ||
( V_305 . V_12 -> V_71 & V_66 ) ) {
error = - V_13 ;
goto V_310;
}
if ( F_114 ( F_3 ( V_7 . V_12 ) ) ||
F_114 ( F_3 ( V_305 . V_12 ) ) ) {
error = - V_17 ;
goto V_310;
}
...
struct V_140 * V_83 = V_10 -> V_24 ;
void V_14 * V_92 = ( void V_14 * ) V_311 ;
int V_138 = 0 ;
int error ;
if ( V_58 -> V_73 & V_74 )
V_138 |= V_172 ;
...
T_25 * V_316 =
F_99 ( V_10 ) ?
V_83 -> V_317 : V_83 -> V_318 ;
V_315 . V_319 = V_315 . V_320 = V_316 -> V_321 ;
V_315 . V_322 = V_123 & ~ ( V_315 . V_320 - 1 ) ;
if ( F_10 ( V_92 , & V_315 , sizeof( V_315 ) ) )
return - V_37 ;
return 0 ;
}
case V_192 :
...
case V_326 :
return F_119 ( V_5 -> V_327 , ( int V_14 * ) V_92 ) ;
case V_328 :
...
case V_333 : {
struct V_93 V_334 ;
if ( F_16 ( & V_334 , V_92 , sizeof( V_334 ) ) )
return - V_37 ;
error = F_48 ( V_58 ) ;
if ( error )
return error ;
error = F_37 ( V_10 , V_334 . V_99 ,
V_334 . V_100 ) ;
F_49 ( V_58 ) ;
return error ;
}
...
case V_343 : {
struct V_344 V_303 ;
if ( F_16 ( & V_303 , V_92 , sizeof( T_24 ) ) )
return - V_37 ;
error = F_48 ( V_58 ) ;
if ( error )
return error ;
...
return error ;
V_348 = V_347 . V_349 ;
error = F_121 ( V_83 , & V_348 , & V_347 ) ;
F_49 ( V_58 ) ;
if ( error )
return error ;
if ( F_10 ( V_92 , & V_347 , sizeof( V_347 ) ) )
return - V_37 ;
return 0 ;
}
case V_350 : {
...
case V_351 : {
T_29 V_348 ;
if ( F_16 ( & V_348 , V_92 , sizeof( V_348 ) ) )
return - V_37 ;
error = F_48 ( V_58 ) ;
if ( error )
return error ;
error = F_122 ( V_83 , & V_348 ) ;
F_49 ( V_58 ) ;
return error ;
}
case V_352 : {
...
if ( ! F_21 ( V_60 ) )
return - V_61 ;
if ( F_125 ( V_348 , ( T_14 V_14 * ) V_92 ) )
return - V_37 ;
return F_126 ( V_83 , V_348 ) ;
}
case V_355 : {
T_32 V_348 ;
if ( ! F_21 ( V_60 ) )
...
if ( V_83 -> V_257 & V_258 )
return - V_259 ;
if ( F_16 ( & V_360 , V_92 , sizeof( V_360 ) ) )
return - V_37 ;
error = F_129 ( & V_360 , & V_362 ) ;
if ( error )
return error ;
return F_130 ( V_83 , & V_362 ) ;
}
default:
return - V_363 ;
}
