...
struct V_1 * V_4 = V_57 -> V_4 ;
int V_99 ;
V_99 = F_15 ( V_4 -> V_14 + F_59 ( V_57 -> V_10 ) ) ;
...
{
struct V_62 * V_63 = V_61 -> V_63 ;
struct V_108 * V_109 = & V_63 -> V_109 ;
T_1 V_110 = V_109 -> V_111 * F_73 ( V_61 ) ;
unsigned int V_102 = V_63 -> V_112 ;
T_1 V_113 , V_114 ;
int V_67 ;
F_74 ( V_61 , V_63 -> V_64 ) ;
V_114 = F_64 ( V_57 ) ;
if ( V_109 -> V_115 == V_116 && ( int ) ( V_114 - V_110 ) > 0 )
V_114 = V_110 ;
V_113 = F_65 ( V_57 ) ;
if ( V_109 -> V_115 == V_116 && ( int ) ( V_113 - V_110 ) > 0 )
V_113 = V_110 ;
if ( ( int ) ( V_113 - V_102 ) > 0 ) {
F_26 ( V_61 -> V_66 -> V_22 , L_12 ) ;
V_63 -> V_104 |= V_105 ;
return - 1 ;
}
V_67 = V_114 - V_63 -> V_117 ;
if ( V_67 <= 0 )
return 0 ;
if ( V_67 ) {
F_75 ( V_61 , V_67 ) ;
...
unsigned long V_55 ;
F_39 ( & V_4 -> V_7 , V_55 ) ;
V_118 = F_15 ( V_4 -> V_14 + F_77 ( V_57 -> V_10 ) ) ;
if ( V_118 & V_119 ) {
V_57 -> V_11 = 1 ;
F_23 ( V_120 ,
