...
const char * V_60 ;
T_2 V_61 ;
if ( F_17 ( V_47 , L_3 , & V_61 ) )
continue;
V_44 -> V_9 [ V_50 ] . V_1 = V_11 -> V_33 -> V_62 + V_61 ;
if ( ! F_18 ( V_47 , L_4 , & V_60 ) )
...
static int T_1 F_20 ( struct V_42 * V_43 )
{
struct V_48 * V_49 = & V_43 -> V_49 ;
struct V_41 * V_44 = F_21 ( V_49 ) ;
struct V_66 * V_67 = F_22 ( V_49 -> V_46 ) ;
struct V_68 * V_33 =
...
V_51 = F_27 ( V_67 , V_11 -> V_33 -> V_34 + V_50 ,
V_44 -> V_57 [ V_50 ] ) ;
if ( V_51 )
return V_51 ;
}
...
F_29 ( & V_11 -> V_9 [ V_50 ] . V_7 , F_2 ) ;
V_51 = F_30 ( V_49 -> V_46 , & V_11 -> V_9 [ V_50 ] . V_40 ) ;
if ( V_51 ) {
F_26 ( V_49 , L_9 , V_1 ) ;
break;
}
...
if ( V_51 )
while ( -- V_50 >= 0 ) {
F_31 ( & V_11 -> V_9 [ V_50 ] . V_40 ) ;
F_32 ( & V_11 -> V_9 [ V_50 ] . V_7 ) ;
}
return V_51 ;
}
