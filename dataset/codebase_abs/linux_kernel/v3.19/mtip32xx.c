...
static int F_184 ( struct V_22 * V_23 ,
const struct V_415 * V_416 )
{
struct V_17 * V_18 = V_416 -> V_18 ;
int V_295 ;
...
if ( ! V_20 -> V_79 )
return;
F_88 ( & V_5 -> V_2 -> V_10 , V_423 ,
V_20 -> V_79 , V_20 -> V_424 ) ;
}
static int F_187 ( void * V_116 , struct V_17 * V_18 , unsigned int V_421 ,
unsigned int V_422 , unsigned int V_376 )
{
struct V_4 * V_5 = V_116 ;
struct V_16 * V_20 = F_9 ( V_18 ) ;
T_2 V_425 = F_23 ( V_5 -> V_37 + V_53 ) & V_54 ;
V_20 -> V_79 = F_86 ( & V_5 -> V_2 -> V_10 , V_423 ,
& V_20 -> V_424 , V_161 ) ;
if ( ! V_20 -> V_79 )
return - V_221 ;
memset ( V_20 -> V_79 , 0 , V_423 ) ;
V_20 -> V_164 = V_5 -> V_12 -> V_364 +
( sizeof( struct V_426 ) * V_422 ) ;
V_20 -> V_427 = V_5 -> V_12 -> V_55 +
( sizeof( struct V_426 ) * V_422 ) ;
if ( V_425 )
V_20 -> V_164 -> V_428 = V_165 F_70 ( ( V_20 -> V_424 >> 16 ) >> 16 ) ;
V_20 -> V_164 -> V_429 = V_165 F_70 ( V_20 -> V_424 & 0xFFFFFFFF ) ;
F_188 ( V_20 -> V_29 , V_430 ) ;
return 0 ;
}
...
V_5 -> V_325 = F_189 ( V_435 , V_5 -> V_376 ) ;
if ( V_5 -> V_325 == NULL ) {
F_39 ( & V_5 -> V_2 -> V_10 ,
L_123 ) ;
V_70 = - V_207 ;
...
if ( V_70 )
goto V_439;
V_5 -> V_325 -> V_440 = & V_5 -> V_2 -> V_10 ;
V_5 -> V_325 -> V_441 = V_5 -> V_441 ;
V_5 -> V_325 -> V_442 = V_5 -> V_132 * V_435 ;
V_5 -> V_325 -> V_443 = & V_444 ;
V_5 -> V_325 -> V_307 = V_5 ;
V_5 -> V_334 = V_334 ;
F_125 ( V_5 ) ;
V_433:
memset ( & V_5 -> V_25 , 0 , sizeof( V_5 -> V_25 ) ) ;
V_5 -> V_25 . V_445 = & V_446 ;
V_5 -> V_25 . V_447 = 1 ;
V_5 -> V_25 . V_448 = V_449 ;
V_5 -> V_25 . V_450 = 1 ;
V_5 -> V_25 . V_451 = sizeof( struct V_16 ) ;
...
F_50 ( V_457 , & V_5 -> V_7 -> V_9 ) ;
F_195 ( V_5 -> V_7 , V_430 ) ;
F_196 ( V_5 -> V_7 , 4096 ) ;
F_197 ( V_5 -> V_7 , 0xffff ) ;
F_198 ( V_5 -> V_7 , 0x400000 ) ;
F_199 ( V_5 -> V_7 , 4096 ) ;
F_200 ( V_5 -> V_7 , V_5 -> V_2 -> V_458 ) ;
F_201 ( V_5 -> V_7 , 0 ) ;
if ( V_5 -> V_188 == true ) {
F_4 ( V_459 , & V_5 -> V_7 -> V_9 ) ;
V_5 -> V_7 -> V_460 . V_461 = 4096 ;
F_202 ( V_5 -> V_7 ,
V_218 * V_219 ) ;
V_5 -> V_7 -> V_460 . V_462 = 0 ;
}
if ( ! ( F_89 ( V_5 , & V_409 ) ) ) {
F_5 ( & V_5 -> V_2 -> V_10 ,
L_127 ) ;
...
V_455:
sprintf ( V_432 , L_128 , V_334 ) ;
V_5 -> V_464 = F_206 ( F_147 ,
V_5 , V_5 -> V_376 , L_75 ,
V_432 ) ;
if ( F_194 ( V_5 -> V_464 ) ) {
...
static void F_213 ( int V_466 )
{
V_467 [ V_466 ] -- ;
}
static int F_214 ( int V_468 )
{
int V_466 , V_469 , V_470 ;
...
{
if ( V_2 -> V_483 && V_2 -> V_483 -> V_484 ) {
if ( V_2 -> V_483 -> V_484 -> V_480 == V_485 &&
( ( V_2 -> V_483 -> V_484 -> V_199 & 0xff00 ) == 0x5a00 ) ) {
F_220 ( V_5 , V_2 -> V_483 -> V_484 ) ;
} else {
struct V_1 * V_486 = V_2 -> V_483 -> V_484 ;
if ( V_486 -> V_483 &&
V_486 -> V_483 -> V_487 &&
V_486 -> V_483 -> V_487 -> V_484 &&
V_486 -> V_483 -> V_487 -> V_484 -> V_480 ==
V_485 &&
( V_486 -> V_483 -> V_487 -> V_484 -> V_199 &
0xff00 ) == 0x5a00 ) {
F_220 ( V_5 ,
V_486 -> V_483 -> V_487 -> V_484 ) ;
}
...
char V_490 [ 256 ] ;
const struct V_471 * V_472 ;
int V_466 , V_52 = 0 , V_491 = 0 ;
int V_492 = V_493 ;
unsigned long V_14 ;
V_492 = F_225 ( V_2 -> V_483 ) ;
if ( V_492 != V_493 ) {
if ( ! F_226 ( V_492 ) )
V_492 = F_218 () ;
} else {
...
F_49 ( & V_2 -> V_10 , L_136 ,
V_492 , F_225 ( V_2 -> V_483 ) , F_227 ( & V_2 -> V_10 ) ,
F_228 ( F_229 () ) , F_229 () ) ;
V_5 = F_158 ( sizeof( struct V_4 ) , V_161 , V_492 ) ;
if ( V_5 == NULL ) {
F_39 ( & V_2 -> V_10 ,
L_137 ) ;
return - V_221 ;
...
F_236 ( & V_5 -> V_497 ) ;
F_236 ( & V_5 -> V_498 ) ;
memset ( V_5 -> V_499 , 0 , 32 ) ;
snprintf ( V_5 -> V_499 , 31 , L_141 , V_5 -> V_132 ) ;
V_5 -> V_128 = F_237 ( V_5 -> V_499 ) ;
if ( ! V_5 -> V_128 ) {
...
V_472 = F_215 ( V_5 -> V_376 ) ;
if ( ! F_238 ( V_472 ) ) {
F_217 (cpu, node_mask)
{
snprintf ( & V_490 [ V_491 ] , 256 - V_491 , L_143 , V_466 ) ;
V_491 = strlen ( V_490 ) ;
}
F_49 ( & V_2 -> V_10 , L_144 ,
V_5 -> V_376 ,
...
F_241 (cpu) {
memset ( V_490 , 0 , sizeof( V_490 ) ) ;
for ( V_52 = 0 , V_491 = 0 ; V_52 < V_125 ; V_52 ++ ) {
if ( V_5 -> V_126 [ V_52 ] . V_127 == V_466 ) {
snprintf ( & V_490 [ V_491 ] , 256 - V_491 , L_143 , V_52 ) ;
V_491 = strlen ( V_490 ) ;
}
}
if ( V_491 )
F_49 ( & V_2 -> V_10 , L_147 , V_466 , V_490 ) ;
}
F_242 ( & V_5 -> V_126 [ 0 ] . V_126 , V_501 ) ;
F_242 ( & V_5 -> V_126 [ 1 ] . V_126 , V_502 ) ;
F_242 ( & V_5 -> V_126 [ 2 ] . V_126 , V_503 ) ;
F_242 ( & V_5 -> V_126 [ 3 ] . V_126 , V_504 ) ;
F_242 ( & V_5 -> V_126 [ 4 ] . V_126 , V_505 ) ;
F_242 ( & V_5 -> V_126 [ 5 ] . V_126 , V_506 ) ;
F_242 ( & V_5 -> V_126 [ 6 ] . V_126 , V_507 ) ;
F_242 ( & V_5 -> V_126 [ 7 ] . V_126 , V_508 ) ;
F_243 ( V_2 ) ;
V_70 = F_244 ( V_2 ) ;
if ( V_70 ) {
F_5 ( & V_2 -> V_10 ,
...
static int F_253 ( struct V_1 * V_2 , T_15 V_512 )
{
int V_70 = 0 ;
struct V_4 * V_5 = F_2 ( V_2 ) ;
if ( ! V_5 ) {
