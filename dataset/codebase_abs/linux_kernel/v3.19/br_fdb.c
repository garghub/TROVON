...
static int F_96 ( struct V_98 * V_99 , struct V_25 * V_26 ,
...
F_32 ( & V_26 -> V_7 -> V_39 ) ;
V_24 = F_95 ( V_26 , V_23 , V_99 -> V_110 ,
V_137 , V_16 ) ;
F_34 ( & V_26 -> V_7 -> V_39 ) ;
}
return V_24 ;
}
int F_97 ( struct V_98 * V_99 , struct V_139 * V_140 [] ,
struct V_59 * V_27 ,
...
V_43 = F_36 ( V_26 ) ;
if ( V_16 ) {
if ( ! V_43 || ! F_101 ( V_16 , V_43 -> V_141 ) ) {
F_98 ( L_9
L_10 , V_16 , V_27 -> V_80 ) ;
return - V_79 ;
}
V_24 = F_96 ( V_99 , V_26 , V_23 , V_137 , V_16 ) ;
} else {
if ( ! V_43 || F_102 ( V_43 -> V_141 , V_142 ) ) {
V_24 = F_96 ( V_99 , V_26 , V_23 , V_137 , 0 ) ;
goto V_50;
}
F_40 (vid, pv->vlan_bitmap, VLAN_N_VID) {
V_24 = F_96 ( V_99 , V_26 , V_23 , V_137 , V_16 ) ;
...
static int F_103 ( struct V_6 * V_7 , const T_5 * V_23 , T_4 V_143 )
{
struct V_37 * V_20 = & V_7 -> V_38 [ F_9 ( V_23 , V_143 ) ] ;
struct V_2 * V_11 ;
V_11 = F_33 ( V_20 , V_23 , V_143 ) ;
if ( ! V_11 )
return - V_134 ;
F_23 ( V_7 , V_11 ) ;
return 0 ;
}
static int F_104 ( struct V_25 * V_26 ,
const unsigned char * V_23 , T_4 V_16 )
{
int V_24 ;
F_32 ( & V_26 -> V_7 -> V_39 ) ;
V_24 = F_103 ( V_26 -> V_7 , V_23 , V_16 ) ;
F_34 ( & V_26 -> V_7 -> V_39 ) ;
return V_24 ;
}
int F_105 ( struct V_98 * V_99 , struct V_139 * V_140 [] ,
struct V_59 * V_27 ,
const unsigned char * V_23 , T_4 V_16 )
{
struct V_25 * V_26 ;
...
V_24 = F_104 ( V_26 , V_23 , V_16 ) ;
} else {
if ( ! V_43 || F_102 ( V_43 -> V_141 , V_142 ) ) {
V_24 = F_104 ( V_26 , V_23 , 0 ) ;
goto V_50;
}
V_24 = - V_134 ;
F_40 (vid, pv->vlan_bitmap, VLAN_N_VID) {
...
int F_106 ( struct V_6 * V_7 , struct V_25 * V_26 )
{
struct V_2 * V_11 , * V_144 ;
int V_45 ;
int V_24 ;
F_16 () ;
for ( V_45 = 0 ; V_45 < V_18 ; V_45 ++ ) {
...
if ( ! V_144 -> V_12 )
continue;
F_21 ( V_26 -> V_27 , V_144 -> V_23 . V_23 ) ;
}
}
return V_24 ;
}
void F_107 ( struct V_6 * V_7 , struct V_25 * V_26 )
{
struct V_2 * V_11 ;
int V_45 ;
F_16 () ;
