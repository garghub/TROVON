...
break;
case V_92 : {
T_8 * const V_93 = ( T_8 * ) V_37 ;
if ( V_39 ( V_93 -> V_88 ) != sizeof( T_8 )
|| V_39 ( V_93 -> V_89 ) != sizeof( V_94 ) ) {
fprintf ( V_15 ,
L_19 , V_21 ) ;
F_6 () ;
}
if ( V_39 ( V_93 -> V_53 ) == V_77 ) {
V_38 = V_95 ;
V_85 = - 14 ;
}
if ( V_39 ( V_93 -> V_53 ) == V_72 ) {
V_38 = V_96 ;
V_97 = F_25 ;
V_98 = F_26 ;
V_99 = V_100 ;
...
int
main ( int V_101 , char * V_102 [] )
{
const char V_103 [] = L_20 ;
int V_104 = sizeof( V_103 ) - 1 ;
int V_105 = 0 ;
int V_106 ;
int V_107 ;
while ( ( V_106 = F_30 ( V_101 , V_102 , L_21 ) ) >= 0 ) {
switch ( V_106 ) {
case 'w' :
V_108 = 1 ;
break;
...
for ( V_107 = V_109 ; V_107 < V_101 ; V_107 ++ ) {
char * V_110 = V_102 [ V_107 ] ;
int const V_111 = setjmp ( V_112 ) ;
int V_113 ;
V_113 = strlen ( V_110 ) ;
if ( V_113 >= V_104 &&
strcmp ( V_110 + ( V_113 - V_104 ) , V_103 ) == 0 )
continue;
switch ( V_111 ) {
default:
fprintf ( V_15 , L_23 , V_110 ) ;
exit ( 1 ) ;
break;
case V_114 :
V_5 = - 1 ;
