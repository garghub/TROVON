...
{
return F_5 ( V_2 , V_3 , V_22 , & V_4 , 1 ) ;
}
static int F_8 ( struct V_1 * V_2 , T_1 V_3 , T_1 V_22 , T_1 * V_4 )
{
return F_6 ( V_2 , V_3 , V_22 , V_4 , 1 ) ;
}
static int F_9 ( struct V_1 * V_2 , int V_3 , T_2 * V_4 )
{
int V_6 ;
T_1 V_23 ;
T_1 V_24 , V_25 ;
...
return V_6 ;
V_32:
F_11 ( & V_2 -> V_15 -> V_16 , L_4 , V_33 , V_6 ) ;
return V_6 ;
}
...
static int F_13 ( struct V_36 * V_37 , int V_38 )
{
int V_6 ;
struct V_1 * V_2 = V_37 -> V_39 ;
F_11 ( & V_2 -> V_15 -> V_16 , L_5 , V_33 , V_38 ) ;
if ( V_2 -> V_40 == V_38 )
return 0 ;
V_6 = F_12 ( V_2 , V_41 , ( V_38 ? 0x1 : 0x0 ) ) ;
if ( V_6 )
goto V_32;
V_2 -> V_40 = V_38 ;
return V_6 ;
...
static int F_14 ( struct V_36 * V_37 , T_2 V_42 )
{
struct V_1 * V_2 = V_37 -> V_39 ;
int V_6 ;
T_3 V_43 ;
...
V_43 *= 0x400000 ;
V_43 = F_15 ( V_43 , V_2 -> V_12 . V_45 ) ;
V_43 = - V_43 ;
V_43 = V_43 & 0x3fffff ;
F_11 ( & V_2 -> V_15 -> V_16 , L_6 ,
V_33 , V_42 , ( unsigned ) V_43 ) ;
V_6 = F_12 ( V_2 , V_46 , V_44 ) ;
if ( V_6 )
return V_6 ;
V_6 = F_12 ( V_2 , V_47 , V_43 ) ;
return V_6 ;
}
...
F_11 ( & V_2 -> V_15 -> V_16 , L_7 , V_33 ) ;
for ( V_28 = 0 ; V_28 < F_17 ( V_50 ) ; V_28 ++ ) {
V_6 = F_12 ( V_2 , V_50 [ V_28 ] . V_3 ,
V_50 [ V_28 ] . V_91 ) ;
if ( V_6 )
goto V_32;
}
...
for ( V_28 = 0 ; V_28 < V_5 ; V_28 ++ ) {
V_6 = F_12 ( V_2 , V_49 [ V_28 ] . V_3 , V_49 [ V_28 ] . V_91 ) ;
if ( V_6 )
goto V_32;
}
#if 1
V_6 = F_12 ( V_2 , V_103 , 0x1 ) ;
if ( V_6 )
goto V_32;
V_6 = F_12 ( V_2 , V_103 , 0x0 ) ;
if ( V_6 )
goto V_32;
#endif
V_2 -> V_104 = false ;
...
if ( V_6 )
goto V_32;
V_6 = F_8 ( V_2 , 0x51 , 3 , & V_7 [ 2 ] ) ;
if ( V_6 )
goto V_32;
F_11 ( & V_2 -> V_15 -> V_16 , L_12 , V_33 , 3 , V_7 ) ;
switch ( ( V_7 [ 0 ] >> 2 ) & 3 ) {
case 0 :
V_114 -> V_131 = V_132 ;
break;
...
static int F_22 ( struct V_36 * V_37 , T_4 * V_155 )
{
struct V_1 * V_2 = V_37 -> V_39 ;
int V_6 ;
T_2 V_156 ;
...
static int F_23 ( struct V_36 * V_37 , T_5 * V_163 )
{
struct V_1 * V_2 = V_37 -> V_39 ;
int V_6 , V_143 , V_164 ;
T_1 V_7 [ 2 ] , V_156 ;
...
#define F_24 3
#define F_25 4
static const T_2 V_166 [ F_24 ] [ F_25 ] = {
{ 85387325 , 85387325 , 85387325 , 85387325 } ,
{ 86676178 , 86676178 , 87167949 , 87795660 } ,
{ 87659938 , 87659938 , 87885178 , 88241743 } ,
} ;
V_6 = F_8 ( V_2 , 0x3c , 3 , & V_156 ) ;
if ( V_6 )
goto V_32;
V_164 = ( V_156 >> 2 ) & 0x03 ;
if ( V_164 > F_24 - 1 )
...
static int F_27 ( struct V_36 * V_37 , T_2 * V_167 )
{
struct V_1 * V_2 = V_37 -> V_39 ;
int V_6 ;
T_1 V_7 [ 2 ] ;
...
static void F_32 ( struct V_170 * V_171 )
{
struct V_1 * V_2 = F_33 ( V_171 ,
...
static int F_35 ( struct V_19 * V_172 , void * V_173 , T_2 V_174 )
{
...
static int F_36 ( struct V_19 * V_172 , void * V_173 ,
T_2 V_174 )
{
struct V_1 * V_2 = V_173 ;
F_37 ( & V_2 -> V_168 , F_38 ( 100 ) ) ;
return 0 ;
}
...
struct V_1 * V_2 = V_37 -> V_39 ;
int V_6 ;
F_11 ( & V_2 -> V_15 -> V_16 , L_14 , V_33 ) ;
V_6 = F_5 ( V_2 , 0x0c , 1 , L_15 , 2 ) ;
if ( V_6 )
goto V_32;
V_6 = F_12 ( V_2 , V_66 , 0x1 ) ;
if ( V_6 )
goto V_32;
V_6 = F_7 ( V_2 , 0xbc , 0 , 0x18 ) ;
if ( V_6 )
goto V_32;
V_6 = F_7 ( V_2 , 0x22 , 0 , 0x01 ) ;
if ( V_6 )
goto V_32;
V_6 = F_7 ( V_2 , 0x26 , 0 , 0x1f ) ;
if ( V_6 )
goto V_32;
V_6 = F_7 ( V_2 , 0x27 , 0 , 0xff ) ;
if ( V_6 )
goto V_32;
V_6 = F_5 ( V_2 , 0x92 , 1 , L_16 , 3 ) ;
if ( V_6 )
goto V_32;
V_6 = F_12 ( V_2 , V_103 , 0x1 ) ;
if ( V_6 )
...
struct V_19 * F_40 ( struct V_36 * V_37 )
{
struct V_1 * V_2 = V_37 -> V_39 ;
return V_2 -> V_169 ;
}
struct V_19 * F_41 ( struct V_36 * V_37 )
{
struct V_1 * V_2 = V_37 -> V_39 ;
return V_2 -> V_19 ;
}
struct V_36 * F_42 ( const struct V_176 * V_12 ,
struct V_19 * V_15 )
{
struct V_1 * V_2 = NULL ;
int V_6 = 0 ;
T_1 V_156 ;
F_11 ( & V_15 -> V_16 , L_7 , V_33 ) ;
V_2 = F_43 ( sizeof( struct V_1 ) , V_177 ) ;
if ( V_2 == NULL )
goto V_32;
V_2 -> V_15 = V_15 ;
V_2 -> V_92 = V_12 -> V_92 ;
...
F_44 ( & V_2 -> V_168 , F_32 ) ;
V_2 -> V_19 = F_45 ( V_15 , & V_15 -> V_16 , V_2 , 0 , 0 , 0 ,
F_35 , NULL ) ;
if ( V_2 -> V_19 == NULL )
goto V_32;
V_6 = F_8 ( V_2 , 0x00 , 0x0 , & V_156 ) ;
if ( V_6 )
goto V_32;
V_2 -> V_169 = F_45 ( V_15 , & V_15 -> V_16 , V_2 ,
0 , 1 , 0 , F_35 , F_36 ) ;
if ( V_2 -> V_169 == NULL )
goto V_32;
