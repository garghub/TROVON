...
V_61 = V_25 -> V_41 + V_200 -> V_217 * 2 + V_200 -> V_218 * 2 + 2 ;
if ( V_61 > V_219 ) {
F_5 ( V_4 , L_17 ) ;
V_11 = - V_73 ;
goto V_220;
}
V_202 = (struct V_201 * ) ( V_221 ) V_200 -> V_202 ;
if ( F_55 ( V_25 -> V_40 + V_25 -> V_41 ,
( void V_145 * ) V_202 ,
sizeof( * V_202 ) * V_200 -> V_217 ) ) {
V_11 = - V_80 ;
goto V_220;
}
V_25 -> V_41 += V_200 -> V_217 * 2 ;
V_11 = F_78 ( V_4 , V_6 , V_200 -> V_217 , false ) ;
if ( V_11 < 0 )
goto V_220;
V_6 -> V_13 . V_137 = V_200 -> V_218 ;
if ( V_200 -> V_218 ) {
struct V_201 * V_222 ;
V_222 = (struct V_201 * ) ( V_221 ) V_200 -> V_222 ;
if ( F_55 ( V_25 -> V_40 + V_25 -> V_41 ,
( void V_145 * ) V_222 ,
sizeof( * V_222 ) * V_200 -> V_218 ) ) {
V_11 = - V_80 ;
goto V_220;
}
V_25 -> V_41 += V_200 -> V_218 * 2 ;
V_11 = F_78 ( V_4 , V_6 , V_200 -> V_218 , true ) ;
if ( V_11 < 0 )
goto V_220;
