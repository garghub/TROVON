...
static void
F_43 ( unsigned int V_48 , struct V_49 * V_50 )
{
struct V_5 * V_5 = F_44 ( V_48 ) ;
unsigned int V_51 ;
unsigned int V_52 , V_53 ;
V_53 = V_5 -> V_53 ;
while ( ( V_51 = F_13 ( V_5 -> V_8 + V_54 ) &
~ F_13 ( V_5 -> V_8 + V_55 ) ) )
...
{
struct V_5 * V_5 = F_48 ( V_58 ) ;
unsigned long V_6 ;
T_2 V_59 ;
F_4 ( & V_5 -> V_7 , V_6 ) ;
V_59 = F_13 ( V_5 -> V_8 + V_55 ) ;
V_59 |= 1 << ( V_58 -> V_48 - V_5 -> V_53 ) ;
F_6 ( V_59 , V_5 -> V_8 + V_55 ) ;
F_8 ( & V_5 -> V_7 , V_6 ) ;
}
...
V_53 = V_5 -> V_53 ;
for ( V_48 = V_53 ; V_48 < V_53 + V_56 ; V_48 ++ ) {
F_51 ( V_48 , & V_60 , V_61 ) ;
F_52 ( V_48 , V_5 ) ;
F_53 ( V_48 , V_62 | V_63 ) ;
}
...
F_21 ( 0 , V_5 -> V_8 + V_97 ) ;
F_21 ( 0xbf , V_5 -> V_8 + V_55 ) ;
F_73 ( V_98 L_5 ,
F_13 ( V_5 -> V_8 + V_99 ) ,
( unsigned long ) V_66 -> V_31 , V_5 -> V_48 ) ;
V_5 -> V_36 . V_42 = - 1 ;
if ( V_16 -> V_40 >= 0 ) {
...
V_5 -> V_113 . V_114 [ V_52 ] =
F_20 ( V_5 -> V_8 + F_34 ( V_52 ) ) ;
V_5 -> V_113 . V_115 [ V_52 ] =
F_20 ( V_5 -> V_8 + F_39 ( V_52 ) ) ;
V_5 -> V_113 . V_116 [ V_52 ] =
F_20 ( V_5 -> V_8 + F_7 ( V_52 ) ) ;
}
V_68 = V_16 -> V_117 ( V_3 ) ;
F_77 ( V_5 -> V_75 ) ;
return V_68 ;
...
F_21 ( 0xbf , V_5 -> V_8 + V_55 ) ;
for ( V_52 = 0 ; V_52 < 3 ; V_52 ++ ) {
F_21 ( V_5 -> V_113 . V_114 [ V_52 ] ,
V_5 -> V_8 + F_34 ( V_52 ) ) ;
F_21 ( V_5 -> V_113 . V_115 [ V_52 ] ,
V_5 -> V_8 + F_39 ( V_52 ) ) ;
F_21 ( V_5 -> V_113 . V_116 [ V_52 ] ,
V_5 -> V_8 + F_7 ( V_52 ) ) ;
}
return 0 ;
}
