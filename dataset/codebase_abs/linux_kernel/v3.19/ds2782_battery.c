...
static void F_23 ( struct V_35 * V_50 )
{
V_50 -> type = V_55 ;
V_50 -> V_56 = V_57 ;
V_50 -> V_58 = F_24 ( V_57 ) ;
...
static int F_25 ( struct V_61 * V_6 )
{
...
static int F_33 ( struct V_66 * V_7 )
{
struct V_61 * V_6 = F_34 ( V_7 ) ;
struct V_1 * V_2 = F_26 ( V_6 ) ;
F_32 ( & V_2 -> V_53 ) ;
return 0 ;
}
static int F_35 ( struct V_66 * V_7 )
{
struct V_61 * V_6 = F_34 ( V_7 ) ;
struct V_1 * V_2 = F_26 ( V_6 ) ;
F_22 ( & V_2 -> V_53 , V_54 ) ;
...
static int F_36 ( struct V_61 * V_6 ,
const struct V_67 * V_65 )
{
struct V_68 * V_69 = V_6 -> V_7 . V_70 ;
struct V_1 * V_2 ;
int V_5 ;
int V_71 ;
if ( V_65 -> V_72 == V_73 && ! V_69 ) {
F_3 ( & V_6 -> V_7 , L_4 ) ;
return - V_47 ;
}
F_29 ( & V_63 ) ;
V_5 = F_37 ( & V_64 , V_6 , 0 , 0 , V_74 ) ;
F_31 ( & V_63 ) ;
if ( V_5 < 0 )
goto V_75;
V_71 = V_5 ;
V_2 = F_38 ( sizeof( * V_2 ) , V_74 ) ;
if ( ! V_2 ) {
V_5 = - V_76 ;
goto V_77;
}
V_2 -> V_50 . V_62 = F_39 ( V_74 , L_5 , V_6 -> V_62 , V_71 ) ;
if ( ! V_2 -> V_50 . V_62 ) {
V_5 = - V_76 ;
goto V_78;
}
...
V_2 -> V_6 = V_6 ;
V_2 -> V_65 = V_71 ;
V_2 -> V_28 = & V_79 [ V_65 -> V_72 ] ;
F_23 ( & V_2 -> V_50 ) ;
V_2 -> V_22 = 100 ;
V_2 -> V_27 = V_31 ;
F_41 ( & V_2 -> V_53 , F_20 ) ;
V_5 = F_42 ( & V_6 -> V_7 , & V_2 -> V_50 ) ;
if ( V_5 ) {
F_3 ( & V_6 -> V_7 , L_6 ) ;
goto V_80;
} else {
