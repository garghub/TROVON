...
V_22 = F_44 ( sizeof( * V_2 ) , V_67 , V_93 , F_38 ) ;
if ( ! V_22 )
return NULL ;
V_22 -> V_71 = V_7 ;
V_2 = F_26 ( V_22 ) ;
...
static int F_57 ( struct V_61 * V_48 , struct V_103 * V_103 ,
unsigned int V_10 , unsigned long V_104 )
{
struct V_1 * V_2 = (struct V_1 * ) V_48 -> V_62 ;
unsigned int V_8 ;
if ( ! V_2 || V_2 -> V_58 != V_59 )
...
if ( F_58 ( ( void V_106 * ) V_104 , V_2 -> V_22 -> V_67 , V_8 ) )
return - V_107 ;
return 0 ;
case V_108 :
return - V_74 ;
default:
return F_59 ( V_48 , V_103 , V_10 , V_104 ) ;
}
}
...
F_61 ( L_3 ) ;
F_61 ( L_4 , V_90 ) ;
V_72 = F_62 ( sizeof( struct V_63 * ) * V_90 , V_110 ) ;
if ( ! V_72 )
return - V_111 ;
V_109 = F_63 ( V_112 , & V_113 ) ;
if ( V_109 ) {
F_29 ( V_114 L_5 ) ;
F_64 ( V_72 ) ;
}
