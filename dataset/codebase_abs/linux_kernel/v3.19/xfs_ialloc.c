...
V_26 = args . V_2 -> V_56 ;
if ( args . V_2 -> V_84 &&
args . V_2 -> V_3 . V_85 + V_26 > args . V_2 -> V_84 )
return - V_86 ;
args . V_87 = args . V_88 = args . V_2 -> V_89 ;
V_29 = F_17 ( V_24 ) ;
V_25 = F_12 ( V_29 -> V_90 ) ;
V_30 = F_12 ( V_29 -> V_31 ) ;
args . V_44 = F_44 ( args . V_2 , V_25 ) +
args . V_2 -> V_89 ;
if ( F_45 ( V_25 != V_73 &&
( args . V_44 < F_12 ( V_29 -> V_91 ) ) ) ) {
args . V_92 = F_46 ( args . V_2 , V_30 , args . V_44 ) ;
args . type = V_93 ;
args . V_94 = 1 ;
args . V_95 = 1 ;
...
goto V_130;
if ( ! V_82 -> V_132 ) {
error = F_65 ( V_2 , V_22 , V_30 , V_123 ) ;
if ( error )
goto V_130;
}
V_124 = V_2 -> V_89 ;
...
struct V_28 * V_29 = F_17 ( V_24 ) ;
T_7 V_30 = F_12 ( V_29 -> V_31 ) ;
T_7 V_127 = F_63 ( V_2 , V_119 ) ;
T_1 V_141 = F_71 ( V_2 , V_119 ) ;
struct V_81 * V_82 ;
...
V_152:
V_145 = F_74 ( V_18 . V_15 ) ;
ASSERT ( V_145 >= 0 ) ;
ASSERT ( V_145 < V_33 ) ;
ASSERT ( ( F_75 ( V_2 , V_18 . V_13 ) %
V_33 ) == 0 ) ;
V_8 = F_26 ( V_2 , V_30 , V_18 . V_13 + V_145 ) ;
V_18 . V_15 &= ~ F_76 ( V_145 ) ;
V_18 . V_14 -- ;
error = F_6 ( V_7 , & V_18 ) ;
if ( error )
goto V_147;
...
return error ;
F_68 ( V_12 == 1 ) ;
ASSERT ( ( F_75 ( V_7 -> V_40 , V_18 . V_13 ) %
V_33 ) == 0 ) ;
V_18 . V_15 &= ~ F_76 ( V_145 ) ;
V_18 . V_14 -- ;
F_68 ( ( V_18 . V_15 == V_163 -> V_15 ) &&
...
goto V_165;
if ( V_30 == V_127 )
error = F_77 ( V_141 , & V_7 , & V_18 ) ;
else
error = F_78 ( V_29 , V_7 , & V_18 ) ;
if ( error )
goto V_165;
V_145 = F_74 ( V_18 . V_15 ) ;
ASSERT ( V_145 >= 0 ) ;
...
if ( V_2 -> V_84 &&
V_2 -> V_3 . V_85 + V_2 -> V_56 > V_2 -> V_84 ) {
V_169 = 1 ;
V_121 = 0 ;
}
V_30 = V_170 ;
...
ASSERT ( F_44 ( V_2 , V_139 ) < F_12 ( V_29 -> V_91 ) ) ;
V_7 = F_18 ( V_2 , V_22 , V_24 , V_30 , V_109 ) ;
error = F_20 ( V_7 , V_29 ) ;
if ( error )
goto V_147;
...
ASSERT ( ! ( V_18 . V_15 & F_76 ( V_182 ) ) ) ;
V_18 . V_15 |= F_76 ( V_182 ) ;
V_18 . V_14 ++ ;
if ( ! ( V_2 -> V_101 & V_186 ) &&
( V_18 . V_14 == V_2 -> V_56 ) ) {
* V_178 = 1 ;
...
error = F_85 ( V_2 , V_22 , V_24 , V_139 , V_177 , V_178 , V_179 ,
& V_18 ) ;
if ( error )
goto V_147;
if ( F_53 ( & V_2 -> V_3 ) ) {
error = F_88 ( V_2 , V_22 , V_24 , V_139 , & V_18 ) ;
if ( error )
goto V_147;
}
return 0 ;
...
return - V_190 ;
if ( ( V_123 & V_194 ) &&
( V_18 . V_15 & F_76 ( V_139 - V_18 . V_13 ) ) )
return - V_190 ;
* V_192 = F_44 ( V_2 , V_18 . V_13 ) ;
* V_193 = V_44 - * V_192 ;
return 0 ;
}
int
...
V_50 = F_24 ( V_2 ) ;
if ( V_123 & V_194 ) {
error = F_90 ( V_2 , V_22 , V_30 , V_139 , V_44 ,
& V_192 , & V_193 , V_123 ) ;
if ( error )
return error ;
goto V_197;
...
V_195 -> V_200 = F_96 ( V_2 , V_50 ) ;
V_195 -> V_201 = ( V_202 ) ( V_145 << V_2 -> V_3 . V_66 ) ;
if ( ( V_195 -> V_199 + V_195 -> V_200 ) >
F_96 ( V_2 , V_2 -> V_3 . V_204 ) ) {
F_91 ( V_2 ,
L_13 ,
...
F_114 ( V_2 , V_30 ) ;
ASSERT ( V_30 != V_136 ) ;
error = F_115 ( V_2 , V_22 , V_2 -> V_58 ,
F_116 ( V_2 , V_30 , F_117 ( V_2 ) ) ,
F_118 ( V_2 , 1 ) , 0 , V_246 , & V_247 ) ;
if ( error )
return error ;
F_119 ( * V_246 , V_248 ) ;
return 0 ;
...
int error ;
F_120 ( V_2 , V_30 ) ;
error = F_113 ( V_2 , V_22 , V_30 , V_246 ) ;
if ( error )
return error ;
V_29 = F_17 ( * V_246 ) ;
V_82 = F_51 ( V_2 , V_30 ) ;
...
T_13 * V_212 = NULL ;
int error ;
error = F_83 ( V_2 , V_22 , V_30 , & V_212 ) ;
if ( error )
return error ;
if ( V_212 )
F_84 ( V_22 , V_212 ) ;
