...
int F_25 ( void * V_58 , int V_59 , int V_22 , int V_23 )
{
...
F_33 ( & V_2 -> V_10 , V_91 , sizeof( V_91 ) ) ;
}
switch ( V_2 -> V_25 ) {
case V_98 :
case V_99 :
...
V_93 . V_147 = F_25 ;
F_35 ( V_2 , V_130 , V_148 , & V_93 ) ;
V_94 &= ~ V_95 ;
}
if ( V_2 -> V_4 . V_5 != V_145 ) {
V_93 . V_94 = V_94 ;
V_93 . type = V_2 -> V_4 . V_5 ;
V_93 . V_36 = V_2 -> V_4 . V_149 ;
V_93 . V_147 = F_25 ;
F_35 ( V_2 , V_130 , V_148 , & V_93 ) ;
}
if ( V_2 -> V_4 . V_150 ) {
struct V_122 V_151 ;
V_151 . V_130 = V_152 ;
V_151 . V_58 = & V_2 -> V_4 . V_150 ;
F_35 ( V_2 , V_130 , V_132 , & V_151 ) ;
}
if ( V_2 -> V_4 . V_5 == V_65 ) {
struct V_122 V_153 ;
struct V_79 V_80 ;
...
F_22 ( 1 , L_33 ,
V_80 . V_81 ) ;
F_35 ( V_2 , V_130 , V_132 , & V_153 ) ;
}
F_35 ( V_2 , V_2 , V_154 , 0 ) ;
}
static int F_36 ( const char * V_18 , struct V_68 * V_69 )
{
unsigned int V_155 = V_145 ;
T_1 V_156 = 0 ;
T_1 V_157 ;
if ( V_158 & V_159 ) {
F_26 ( V_160 L_34 ,
...
V_155 = V_166 ;
if ( V_156 ) {
F_38 ( V_69 , V_167 , & V_157 ) ;
V_157 |= V_156 ;
F_39 ( V_69 , V_167 , V_157 ) ;
}
if ( V_145 != V_155 ) {
F_26 ( V_160 L_39 ,
V_18 , V_166 ) ;
F_39 ( V_69 , V_168 , V_166 ) ;
}
return 0 ;
}
int F_40 ( const struct V_1 * V_2 , struct V_68 * V_69 )
{
if ( F_41 ( F_42 ( V_69 , 0 ) ,
F_43 ( V_69 , 0 ) ,
V_2 -> V_18 ) )
...
F_26 ( V_62
L_40 ,
V_2 -> V_18 , F_44 ( V_69 -> V_169 ) ,
( unsigned long long ) F_42 ( V_69 , 0 ) ,
V_69 -> V_70 , V_69 -> V_71 ) ;
return - V_170 ;
}
struct V_1 * F_45 ( struct V_68 * V_69 , int V_171 )
{
struct V_1 * V_2 ;
int V_38 ;
V_2 = F_46 ( sizeof( * V_2 ) , V_172 ) ;
if ( V_2 == NULL )
return NULL ;
F_47 ( & V_2 -> V_173 ) ;
V_2 -> V_174 = V_69 -> V_175 -> V_176 ;
V_2 -> V_177 = F_48 ( V_69 -> V_169 ) ;
V_2 -> V_178 = V_179 | V_180 |
V_181 | V_182 |
V_183 | V_184 ;
F_49 ( & V_2 -> V_185 ) ;
V_2 -> V_171 = V_171 ;
sprintf ( V_2 -> V_18 , L_41 , V_2 -> V_171 ) ;
V_2 -> V_186 = V_187 ;
V_2 -> V_188 = 320 ;
V_2 -> V_189 = 240 ;
V_2 -> V_190 = V_191 ;
strcpy ( V_2 -> V_192 . V_18 , V_2 -> V_18 ) ;
if ( F_50 ( NULL , & V_2 -> V_192 ) ) {
F_51 ( V_2 ) ;
return NULL ;
}
if ( F_52 ( & V_2 -> V_193 , 13 ) ) {
F_53 ( & V_2 -> V_192 ) ;
F_51 ( V_2 ) ;
return NULL ;
}
if ( F_52 ( & V_2 -> V_194 , 13 ) ) {
F_54 ( & V_2 -> V_193 ) ;
F_53 ( & V_2 -> V_192 ) ;
F_51 ( V_2 ) ;
return NULL ;
...
F_36 ( V_2 -> V_18 , V_69 ) ;
V_2 -> V_195 = F_55 ( F_42 ( V_69 , 0 ) ,
F_43 ( V_69 , 0 ) ) ;
V_2 -> V_196 = ( T_1 V_197 * ) V_2 -> V_195 ;
if ( V_2 -> V_195 == NULL ) {
F_56 ( F_42 ( V_69 , 0 ) ,
F_43 ( V_69 , 0 ) ) ;
F_54 ( & V_2 -> V_193 ) ;
...
V_2 -> V_25 = V_145 ;
if ( V_198 [ V_2 -> V_171 ] < F_8 ( V_72 ) )
V_2 -> V_25 = V_198 [ V_2 -> V_171 ] ;
for ( V_38 = 0 ; V_145 == V_2 -> V_25 && V_38 < F_8 ( V_199 ) ; V_38 ++ )
if ( V_69 -> V_70 == V_199 [ V_38 ] . V_200 &&
V_69 -> V_71 == V_199 [ V_38 ] . V_201 )
V_2 -> V_25 = V_199 [ V_38 ] . V_198 ;
if ( V_145 == V_2 -> V_25 ) {
V_2 -> V_25 = V_202 ;
F_28 ( V_2 , V_69 ) ;
}
V_2 -> V_4 = V_72 [ V_2 -> V_25 ] ;
if ( ! V_2 -> V_4 . V_203 && ( V_2 -> V_4 . V_204 & V_205 ) )
V_2 -> V_4 . V_203 = 1 ;
F_3 ( V_2 , L_42 ,
V_69 -> V_70 , V_69 -> V_71 , V_2 -> V_4 . V_18 ,
V_2 -> V_25 , V_198 [ V_2 -> V_171 ] == V_2 -> V_25 ?
L_43 : L_44 ,
V_2 -> V_4 . V_203 ) ;
if ( V_130 [ V_2 -> V_171 ] != V_145 )
V_2 -> V_4 . V_5 = V_130 [ V_2 -> V_171 ] ;
if ( V_12 [ V_2 -> V_171 ] != V_145 )
V_2 -> V_4 . V_144 = V_12 [ V_2 -> V_171 ] ;
F_22 ( 1 , L_45 ,
V_2 -> V_4 . V_5 , V_2 -> V_4 . V_144 ) ;
F_57 ( V_2 ) ;
F_29 ( V_2 ) ;
F_58 ( V_2 , V_69 ) ;
if ( V_145 != V_2 -> V_4 . V_5 ) {
static const unsigned short V_206 [] = {
0x42 , 0x43 , 0x4a , 0x4b ,
0x60 , 0x61 , 0x62 , 0x63 , 0x64 , 0x65 , 0x66 , 0x67 ,
0x68 , 0x69 , 0x6a , 0x6c , 0x6d , 0x6e ,
V_207
} ;
int V_208 = ( V_2 -> V_4 . V_150 & V_209 ) ;
F_59 ( & V_2 -> V_192 , & V_2 -> V_43 ,
L_46 , 0 , F_60 ( V_210 ) ) ;
if ( V_208 )
F_59 ( & V_2 -> V_192 ,
& V_2 -> V_43 , L_46 ,
0 , F_60 ( V_211 ) ) ;
if ( V_2 -> V_4 . V_149 == V_212 ) {
F_59 ( & V_2 -> V_192 ,
& V_2 -> V_43 , L_46 ,
0 , V_208 ? V_206 + 4 : V_206 ) ;
} else {
F_59 ( & V_2 -> V_192 , & V_2 -> V_43 ,
L_46 , V_2 -> V_4 . V_149 , NULL ) ;
}
}
F_32 ( V_2 ) ;
if ( ! V_213 ) {
