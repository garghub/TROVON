...
const F_143 * V_466 = V_19 + V_459 -> V_249 . V_86 ;
V_305 = (* V_466)( V_270 , V_303 , V_16 ) ;
} else if ( V_459 -> V_39 & V_467 ) {
V_305 = V_459 -> V_249 . V_468 ( V_275 , V_270 , V_303 , V_16 ) ;
} else if ( ! V_275 -> V_469 ) {
V_305 = - V_393 ;
} else {
V_305 = V_275 -> V_469 ( V_270 , V_303 ,
...
static int F_144 ( unsigned int V_191 , void * V_471 , T_4 * V_472 ,
void T_3 * * V_473 , void * * * V_474 )
{
int V_305 = 0 ;
switch ( V_191 ) {
case V_475 :
...
case V_477 :
case V_478 : {
struct V_116 * V_479 = V_471 ;
if ( F_26 ( V_479 -> type ) && V_479 -> V_128 > 0 ) {
if ( V_479 -> V_128 > V_480 ) {
V_305 = - V_289 ;
break;
}
* V_473 = ( void T_3 * ) V_479 -> V_126 . V_127 ;
* V_474 = ( void * * ) & V_479 -> V_126 . V_127 ;
* V_472 = sizeof( struct V_120 ) * V_479 -> V_128 ;
V_305 = 1 ;
}
break;
}
case V_481 :
case V_482 : {
struct V_262 * V_483 = V_471 ;
if ( V_483 -> V_265 ) {
if ( V_483 -> V_265 > 256 ) {
V_305 = - V_289 ;
break;
}
* V_473 = ( void T_3 * ) V_483 -> V_483 ;
* V_474 = ( void * * ) & V_483 -> V_483 ;
* V_472 = V_483 -> V_265 * 128 ;
V_305 = 1 ;
}
break;
}
...
case V_485 :
case V_486 : {
struct V_168 * V_396 = V_471 ;
if ( V_396 -> V_90 != 0 ) {
if ( V_396 -> V_90 > V_487 ) {
V_305 = - V_289 ;
break;
}
* V_473 = ( void T_3 * ) V_396 -> V_171 ;
* V_474 = ( void * * ) & V_396 -> V_171 ;
* V_472 = sizeof( struct V_397 )
* V_396 -> V_90 ;
V_305 = 1 ;
}
break;
...
if ( F_146 ( V_191 ) <= sizeof( V_488 ) ) {
V_471 = V_488 ;
} else {
V_489 = F_147 ( F_146 ( V_191 ) , V_491 ) ;
if ( NULL == V_489 )
return - V_492 ;
V_471 = V_489 ;
}
...
unsigned int V_494 = F_146 ( V_191 ) ;
if ( F_133 ( V_191 ) ) {
T_2 V_39 = V_444 [ F_134 ( V_191 ) ] . V_39 ;
if ( V_39 & V_495 )
V_494 = ( V_39 & V_495 ) >> 16 ;
}
if ( F_148 ( V_471 , ( void T_3 * ) V_16 , V_494 ) )
goto V_496;
if ( V_494 < F_146 ( V_191 ) )
memset ( ( V_497 * ) V_471 + V_494 , 0 , F_146 ( V_191 ) - V_494 ) ;
} else {
memset ( V_471 , 0 , F_146 ( V_191 ) ) ;
}
}
V_354 = F_144 ( V_191 , V_471 , & V_472 , & V_473 , & V_474 ) ;
if ( V_354 < 0 )
goto V_496;
V_490 = V_354 ;
if ( V_490 ) {
V_489 = F_147 ( V_472 , V_491 ) ;
V_354 = - V_492 ;
if ( NULL == V_489 )
goto V_498;
V_354 = - V_493 ;
if ( F_148 ( V_489 , V_473 , V_472 ) )
goto V_498;
* V_474 = V_489 ;
}
V_354 = V_468 ( V_270 , V_191 , V_471 ) ;
if ( V_354 == - V_499 )
V_354 = - V_393 ;
if ( V_354 == 0 ) {
if ( V_191 == V_478 )
F_149 ( F_61 ( V_270 ) -> V_500 , V_471 ) ;
else if ( V_191 == V_477 )
F_150 ( F_61 ( V_270 ) -> V_500 , V_471 ) ;
}
if ( V_490 ) {
* V_474 = ( void V_501 * ) V_473 ;
if ( F_151 ( V_473 , V_489 , V_472 ) )
V_354 = - V_493 ;
goto V_498;
}
if ( V_354 < 0 && V_191 != V_502 )
goto V_496;
V_498:
switch ( F_138 ( V_191 ) ) {
case V_455 :
case ( V_456 | V_455 ) :
if ( F_151 ( ( void T_3 * ) V_16 , V_471 , F_146 ( V_191 ) ) )
V_354 = - V_493 ;
break;
}
V_496:
