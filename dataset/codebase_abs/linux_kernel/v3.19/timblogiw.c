...
F_17 ( & V_38 -> V_41 , L_1 , V_42 ) ;
if ( F_37 ( V_40 ) )
return F_38 ( V_40 -> V_95 , V_96 , V_103 , V_5 ) ;
else {
* V_5 = V_12 -> V_48 -> V_5 ;
return 0 ;
}
...
static int F_48 ( struct V_109 * V_110 , unsigned int * V_111 ,
unsigned int * V_112 )
{
...
static int F_49 ( struct V_109 * V_110 , struct V_13 * V_14 ,
enum V_115 V_53 )
{
struct V_11 * V_12 = V_110 -> V_113 ;
...
F_1 ( V_12 -> V_48 ) ;
T_2 V_123 ;
F_51 ( V_10 -> V_124 , F_4 ( V_10 -> V_124 ) ) ;
V_57 = F_52 ( V_110 , V_14 , NULL ) ;
if ( V_57 )
goto V_57;
V_123 = F_53 ( V_14 ) ;
for ( V_6 = 0 , V_112 = 0 ; V_112 < V_116 ; V_6 ++ ) {
F_54 ( V_10 -> V_124 + V_6 ) = V_123 + V_112 ;
V_112 += V_121 ;
F_55 ( V_10 -> V_124 + V_6 ) = ( V_112 > V_116 ) ?
( V_121 - ( V_112 - V_116 ) ) :
V_121 ;
}
V_14 -> V_18 = V_125 ;
...
static void F_57 ( struct V_109 * V_110 , struct V_13 * V_14 )
{
struct V_11 * V_12 = V_110 -> V_113 ;
struct V_9 * V_10 = F_50 ( V_14 , struct V_9 ,
V_14 ) ;
...
F_59 ( & V_12 -> V_15 ) ;
V_127 = F_60 ( V_12 -> V_29 ,
V_10 -> V_124 , V_128 , V_130 ,
V_131 ) ;
if ( ! V_127 ) {
F_61 ( & V_12 -> V_15 ) ;
F_62 ( & V_14 -> V_20 ) ;
...
V_40 -> V_95 = F_68 ( & V_40 -> V_141 , V_138 ,
V_40 -> V_139 . V_142 . V_143 , NULL ) ;
F_69 ( V_138 ) ;
if ( ! V_40 -> V_95 ) {
F_23 ( & V_38 -> V_41 , L_14 ,
V_40 -> V_139 . V_142 . V_144 ) ;
V_57 = - V_140 ;
goto V_58;
}
}
V_12 = F_70 ( sizeof( * V_12 ) , V_145 ) ;
if ( ! V_12 ) {
V_57 = - V_119 ;
goto V_58;
}
...
F_74 ( V_146 , V_135 ) ;
F_74 ( V_147 , V_135 ) ;
V_12 -> V_29 = F_75 ( V_135 , F_13 ,
( void * ) ( V_32 ) V_40 -> V_139 . V_148 ) ;
if ( ! V_12 -> V_29 ) {
F_23 ( & V_38 -> V_41 , L_15 ) ;
F_76 ( V_12 ) ;
V_57 = - V_140 ;
...
struct V_11 * V_12 = V_33 -> V_149 ;
F_17 ( & V_38 -> V_41 , L_9 , V_42 ) ;
return F_83 ( & V_12 -> V_59 , V_8 , V_111 , V_151 , 0 ,
V_33 -> V_93 & V_94 ) ;
}
...
struct V_11 * V_12 = V_33 -> V_149 ;
F_17 ( & V_38 -> V_41 , L_9 , V_42 ) ;
return F_85 ( V_33 , & V_12 -> V_59 , V_153 ) ;
}
static int F_86 ( struct V_33 * V_33 , struct V_154 * V_155 )
{
struct V_37 * V_38 = F_15 ( V_33 ) ;
struct V_11 * V_12 = V_33 -> V_149 ;
F_17 ( & V_38 -> V_41 , L_9 , V_42 ) ;
return F_87 ( & V_12 -> V_59 , V_155 ) ;
}
static int F_88 ( struct V_156 * V_157 )
{
int V_57 ;
struct V_39 * V_40 = NULL ;
struct V_158 * V_139 = V_157 -> V_41 . V_159 ;
if ( ! V_139 ) {
F_23 ( & V_157 -> V_41 , L_16 ) ;
V_57 = - V_44 ;
goto V_57;
}
if ( ! V_139 -> V_142 . V_144 )
F_89 ( & V_157 -> V_41 , L_17 ) ;
V_40 = F_90 ( & V_157 -> V_41 , sizeof( * V_40 ) , V_145 ) ;
if ( ! V_40 ) {
V_57 = - V_119 ;
goto V_57;
}
if ( V_157 -> V_41 . V_160 )
V_40 -> V_41 = V_157 -> V_41 . V_160 ;
else
V_40 -> V_41 = & V_157 -> V_41 ;
memcpy ( & V_40 -> V_139 , V_139 , sizeof( V_40 -> V_139 ) ) ;
F_91 ( & V_40 -> V_45 ) ;
V_40 -> V_161 = V_162 ;
F_92 ( V_40 -> V_141 . V_68 , V_66 , sizeof( V_40 -> V_141 . V_68 ) ) ;
V_57 = F_93 ( NULL , & V_40 -> V_141 ) ;
if ( V_57 )
goto V_57;
V_40 -> V_161 . V_141 = & V_40 -> V_141 ;
F_94 ( V_157 , V_40 ) ;
F_95 ( & V_40 -> V_161 , V_40 ) ;
V_57 = F_96 ( & V_40 -> V_161 , V_163 , 0 ) ;
if ( V_57 ) {
F_23 ( & V_157 -> V_41 , L_18 , V_57 ) ;
goto V_164;
}
return 0 ;
V_164:
F_97 ( & V_40 -> V_141 ) ;
V_57:
F_23 ( & V_157 -> V_41 , L_19 , V_57 ) ;
return V_57 ;
}
static int F_98 ( struct V_156 * V_157 )
{
struct V_39 * V_40 = F_99 ( V_157 ) ;
F_100 ( & V_40 -> V_161 ) ;
F_97 ( & V_40 -> V_141 ) ;
return 0 ;
}
