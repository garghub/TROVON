...
static inline T_2 F_203 ( T_2 V_266 )
{
return V_266 << V_267 ;
}
static inline T_2 F_204 ( T_2 V_187 )
{
return ( V_187 + V_268 - 1 ) >> V_267 ;
}
static void F_205 ( struct V_30 * V_30 , struct V_269 * V_270 )
{
struct V_271 * V_272 = & V_30 -> V_135 ;
memset ( V_270 , 0 , sizeof( * V_270 ) ) ;
F_5 ( & V_131 ) ;
V_270 -> V_273 = V_272 -> V_190 ;
V_270 -> V_274 = V_272 -> V_144 ;
V_270 -> V_275 = V_272 -> V_184 ;
V_270 -> V_276 = V_272 -> V_140 ;
V_270 -> V_277 = V_272 -> V_137 + V_272 -> V_138 ;
V_270 -> V_278 = V_272 -> V_136 ;
V_270 -> V_279 = V_272 -> V_145 ;
V_270 -> V_280 = V_272 -> V_141 ;
F_6 ( & V_131 ) ;
}
int F_206 ( struct V_1 * V_2 , struct V_22 V_23 ,
struct V_269 * V_270 )
{
struct V_30 * V_30 ;
V_30 = F_99 ( V_2 , V_23 ) ;
...
static int F_207 ( struct V_30 * V_30 , struct V_269 * V_270 )
{
struct V_271 * V_272 = & V_30 -> V_135 ;
int V_281 = 0 , V_282 = 0 ;
struct V_176 * V_283 = & F_42 ( V_30 -> V_34 ) -> V_53 [ V_30 -> V_35 . type ] ;
if ( V_270 -> V_284 & ~ V_285 )
return - V_232 ;
if ( ( ( V_270 -> V_284 & V_286 ) &&
F_204 ( V_270 -> V_274 ) > V_283 -> V_287 ) ||
( ( V_270 -> V_284 & V_288 ) &&
F_204 ( V_270 -> V_273 ) > V_283 -> V_287 ) ||
( ( V_270 -> V_284 & V_289 ) &&
( V_270 -> V_276 > V_283 -> V_290 ) ) ||
( ( V_270 -> V_284 & V_291 ) &&
( V_270 -> V_275 > V_283 -> V_290 ) ) )
return - V_292 ;
F_5 ( & V_131 ) ;
if ( V_270 -> V_284 & V_293 ) {
V_272 -> V_137 = V_270 -> V_277 - V_272 -> V_138 ;
V_281 = 1 ;
F_49 ( V_294 + V_295 , & V_30 -> V_48 ) ;
}
if ( V_270 -> V_284 & V_286 )
V_272 -> V_144 = V_270 -> V_274 ;
if ( V_270 -> V_284 & V_288 )
V_272 -> V_190 = V_270 -> V_273 ;
if ( V_270 -> V_284 & ( V_286 | V_288 ) ) {
V_281 = 1 ;
F_49 ( V_294 + V_296 , & V_30 -> V_48 ) ;
}
if ( V_270 -> V_284 & V_297 ) {
V_272 -> V_136 = V_270 -> V_278 ;
V_282 = 1 ;
F_49 ( V_294 + V_298 , & V_30 -> V_48 ) ;
}
if ( V_270 -> V_284 & V_289 )
V_272 -> V_140 = V_270 -> V_276 ;
if ( V_270 -> V_284 & V_291 )
V_272 -> V_184 = V_270 -> V_275 ;
if ( V_270 -> V_284 & ( V_289 | V_291 ) ) {
V_282 = 1 ;
F_49 ( V_294 + V_299 , & V_30 -> V_48 ) ;
}
if ( V_270 -> V_284 & V_300 ) {
V_272 -> V_145 = V_270 -> V_279 ;
V_281 = 1 ;
F_49 ( V_294 + V_301 , & V_30 -> V_48 ) ;
}
if ( V_270 -> V_284 & V_302 ) {
V_272 -> V_141 = V_270 -> V_280 ;
V_282 = 1 ;
F_49 ( V_294 + V_303 , & V_30 -> V_48 ) ;
}
if ( V_281 ) {
if ( ! V_272 -> V_144 ||
V_272 -> V_137 < V_272 -> V_144 ) {
V_272 -> V_145 = 0 ;
F_58 ( V_146 , & V_30 -> V_48 ) ;
} else if ( ! ( V_270 -> V_284 & V_300 ) )
V_272 -> V_145 = F_141 () + V_283 -> V_191 ;
}
if ( V_282 ) {
if ( ! V_272 -> V_140 ||
V_272 -> V_136 < V_272 -> V_140 ) {
V_272 -> V_141 = 0 ;
F_58 ( V_143 , & V_30 -> V_48 ) ;
} else if ( ! ( V_270 -> V_284 & V_302 ) )
V_272 -> V_141 = F_141 () + V_283 -> V_186 ;
}
if ( V_272 -> V_190 || V_272 -> V_144 || V_272 -> V_184 ||
V_272 -> V_140 )
...
V_304 = F_207 ( V_30 , V_270 ) ;
F_45 ( V_30 ) ;
V_83:
return V_304 ;
}
int F_209 ( struct V_1 * V_2 , int type , struct V_305 * V_306 )
{
struct V_176 * V_307 ;
F_34 ( & F_42 ( V_2 ) -> V_81 ) ;
if ( ! F_74 ( V_2 , type ) ) {
...
V_307 = F_42 ( V_2 ) -> V_53 + type ;
F_5 ( & V_131 ) ;
V_306 -> V_191 = V_307 -> V_191 ;
V_306 -> V_186 = V_307 -> V_186 ;
V_306 -> V_58 = V_307 -> V_58 & V_308 ;
V_306 -> V_309 = V_310 ;
F_6 ( & V_131 ) ;
F_35 ( & F_42 ( V_2 ) -> V_81 ) ;
return 0 ;
}
int F_210 ( struct V_1 * V_2 , int type , struct V_305 * V_306 )
{
struct V_176 * V_307 ;
int V_55 = 0 ;
F_34 ( & F_42 ( V_2 ) -> V_81 ) ;
...
V_307 = F_42 ( V_2 ) -> V_53 + type ;
F_5 ( & V_131 ) ;
if ( V_306 -> V_309 & V_311 )
V_307 -> V_191 = V_306 -> V_191 ;
if ( V_306 -> V_309 & V_312 )
V_307 -> V_186 = V_306 -> V_186 ;
if ( V_306 -> V_309 & V_313 )
V_307 -> V_58 = ( V_307 -> V_58 & ~ V_314 ) |
( V_306 -> V_58 & V_314 ) ;
F_6 ( & V_131 ) ;
F_48 ( V_2 , type ) ;
...
static int F_211 ( struct V_315 * V_316 , int V_317 ,
void T_3 * V_318 , T_4 * V_319 , T_5 * V_320 )
{
unsigned int type = ( int * ) V_316 -> V_321 - V_104 . V_322 ;
V_104 . V_322 [ type ] =
F_212 ( & V_104 . V_105 [ type ] ) ;
return F_213 ( V_316 , V_317 , V_318 , V_319 , V_320 ) ;
}
static int T_6 F_214 ( void )
{
int V_173 , V_51 ;
unsigned long V_323 , V_324 ;
F_3 ( V_325 L_19 , V_326 ) ;
F_215 ( V_327 ) ;
V_73 = F_216 ( L_20 ,
...
NULL ) ;
V_324 = 0 ;
V_33 = (struct V_31 * ) F_217 ( V_332 , V_324 ) ;
if ( ! V_33 )
F_218 ( L_21 ) ;
for ( V_173 = 0 ; V_173 < V_333 ; V_173 ++ ) {
V_51 = F_219 ( & V_104 . V_105 [ V_173 ] , 0 , V_334 ) ;
if ( V_51 )
F_218 ( L_22 ) ;
}
V_323 = ( 1UL << V_324 ) * V_335 / sizeof( struct V_31 ) ;
V_28 = 0 ;
do {
V_28 ++ ;
} while ( V_323 >> V_28 );
...
V_323 = 1UL << V_28 ;
V_29 = V_323 - 1 ;
for ( V_173 = 0 ; V_173 < V_323 ; V_173 ++ )
F_220 ( V_33 + V_173 ) ;
F_221 ( L_23
L_24 , V_323 , V_324 , ( V_335 << V_324 ) ) ;
F_222 ( & V_336 ) ;
return 0 ;
}
