...
V_82 = ( 4 - ( ( ( void * ) V_8 -> V_35 - NULL ) & 0x3 ) ) % 4 ;
V_55 = sizeof( * V_81 ) + V_82 ;
F_39 ( F_19 ( V_8 ) < V_55 + V_84 ) ;
F_40 ( V_8 , V_55 ) ;
V_81 = (struct V_80 * ) V_8 -> V_35 ;
memset ( V_81 , 0 , sizeof( * V_81 ) ) ;
V_81 -> V_52 = V_2 -> V_52 ;
V_81 -> V_53 = V_2 -> V_53 ;
V_81 -> V_85 = F_41 ( ( T_1 ) ( V_8 -> V_55 - V_55 ) ) ;
V_81 -> V_74 = ( V_45 ) V_8 -> V_74 ;
V_81 -> V_86 = F_42 ( V_2 , V_8 ) ;
if ( V_12 -> V_16 & V_87 ||
V_12 -> V_16 & V_88 ) {
V_81 -> V_89 = V_12 -> V_90 ;
V_81 -> V_16 |= V_91 ;
}
if ( V_81 -> V_74 < F_43 ( V_2 -> V_18 . V_92 ) )
V_81 -> V_93 =
F_44 ( V_2 -> V_18 . V_92 [ V_81 -> V_74 ] ) ;
if ( V_67 == V_72 ) {
V_81 -> V_94 = F_41 ( V_67 ) ;
V_55 += V_95 ;
}
