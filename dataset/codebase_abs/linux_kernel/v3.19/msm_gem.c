...
return - V_69 ;
V_62 = ( T_4 ) F_42 ( V_2 ) ;
V_17 = V_67 -> V_70 -> V_71 ( V_67 , V_62 , V_4 -> V_27 ,
V_2 -> V_25 , V_72 | V_73 ) ;
...
T_4 F_50 ( struct V_1 * V_2 , int V_63 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
F_43 ( ! V_4 -> V_65 [ V_63 ] . V_64 ) ;
return V_4 -> V_65 [ V_63 ] . V_64 ;
}
void F_51 ( struct V_1 * V_2 , int V_63 )
{
}
int F_52 ( struct V_74 * V_44 , struct V_24 * V_7 ,
struct V_75 * args )
{
args -> V_76 = F_53 ( args -> V_77 , args -> V_78 ) ;
args -> V_25 = F_54 ( args -> V_76 * args -> V_79 ) ;
return F_55 ( V_7 , V_44 , args -> V_25 ,
V_80 | V_29 , & args -> V_81 ) ;
}
int F_56 ( struct V_74 * V_44 , struct V_24 * V_7 ,
T_4 V_81 , T_3 * V_62 )
{
struct V_1 * V_2 ;
int V_17 = 0 ;
V_2 = F_57 ( V_7 , V_44 , V_81 ) ;
if ( V_2 == NULL ) {
V_17 = - V_82 ;
goto V_83;
}
...
if ( F_12 ( V_23 ) )
return F_16 ( V_23 ) ;
V_4 -> V_84 = F_60 ( V_23 , V_2 -> V_25 >> V_11 ,
V_85 , F_29 ( V_86 ) ) ;
}
return V_4 -> V_84 ;
}
...
V_4 -> V_95 = 0 ;
F_66 ( & V_4 -> V_97 ) ;
F_67 ( & V_4 -> V_97 , & V_6 -> V_99 ) ;
}
int F_69 ( struct V_1 * V_2 , T_4 V_100 ,
struct V_101 * V_102 )
{
struct V_24 * V_7 = V_2 -> V_7 ;
struct V_3 * V_4 = F_2 ( V_2 ) ;
int V_17 = 0 ;
if ( F_70 ( V_4 ) ) {
T_4 V_89 = F_63 ( V_4 , V_100 ) ;
if ( V_100 & V_103 )
V_102 = NULL ;
V_17 = F_71 ( V_7 , V_89 , V_102 ) ;
}
return V_17 ;
}
...
void F_73 ( struct V_1 * V_2 , struct V_104 * V_105 )
{
struct V_24 * V_7 = V_2 -> V_7 ;
struct V_3 * V_4 = F_2 ( V_2 ) ;
T_3 V_106 = F_74 ( & V_2 -> V_61 ) ;
F_43 ( ! F_44 ( & V_7 -> V_34 ) ) ;
F_75 ( V_105 , L_6 ,
V_4 -> V_28 , F_70 ( V_4 ) ? 'A' : 'I' ,
V_4 -> V_96 , V_4 -> V_95 ,
V_2 -> V_107 , V_2 -> V_108 . V_108 . V_109 ,
V_106 , V_4 -> V_84 , V_2 -> V_25 ) ;
}
void F_76 ( struct V_110 * V_111 , struct V_104 * V_105 )
{
struct V_3 * V_4 ;
int V_112 = 0 ;
T_5 V_25 = 0 ;
...
V_67 -> V_70 -> V_114 ( V_67 , V_62 , V_4 -> V_27 , V_2 -> V_25 ) ;
}
}
if ( V_2 -> V_115 ) {
if ( V_4 -> V_84 )
F_81 ( V_2 -> V_115 -> V_116 , V_4 -> V_84 ) ;
if ( V_4 -> V_23 )
F_7 ( V_4 -> V_23 ) ;
} else {
F_82 ( V_4 -> V_84 ) ;
...
int F_55 ( struct V_24 * V_7 , struct V_74 * V_44 ,
T_4 V_25 , T_4 V_28 , T_4 * V_81 )
{
struct V_1 * V_2 ;
int V_17 ;
V_17 = F_38 ( & V_7 -> V_34 ) ;
if ( V_17 )
return V_17 ;
V_2 = F_85 ( V_7 , V_25 , V_28 ) ;
F_26 ( & V_7 -> V_34 ) ;
if ( F_12 ( V_2 ) )
return F_14 ( V_2 ) ;
V_17 = F_86 ( V_44 , V_2 , V_81 ) ;
F_58 ( V_2 ) ;
return V_17 ;
}
static int F_87 ( struct V_24 * V_7 ,
T_4 V_25 , T_4 V_28 ,
struct V_1 * * V_2 )
{
struct V_5 * V_6 = V_7 -> V_8 ;
...
V_119 = sizeof( * V_4 ) ;
if ( ! F_10 ( & V_26 ) )
V_119 += sizeof( struct V_122 ) ;
V_4 = F_88 ( V_119 , V_123 ) ;
if ( ! V_4 )
return - V_19 ;
if ( ! F_10 ( & V_26 ) )
V_4 -> V_9 = ( void * ) & V_4 [ 1 ] ;
...
struct V_1 * F_85 ( struct V_24 * V_7 ,
T_4 V_25 , T_4 V_28 )
{
struct V_1 * V_2 = NULL ;
int V_17 ;
F_43 ( ! F_44 ( & V_7 -> V_34 ) ) ;
V_25 = F_54 ( V_25 ) ;
V_17 = F_87 ( V_7 , V_25 , V_28 , & V_2 ) ;
if ( V_17 )
goto V_83;
if ( F_10 ( & V_26 ) ) {
V_17 = F_91 ( V_7 , V_2 , V_25 ) ;
if ( V_17 )
goto V_83;
} else {
F_92 ( V_7 , V_2 , V_25 ) ;
...
struct V_1 * F_94 ( struct V_24 * V_7 ,
T_4 V_25 , struct V_125 * V_27 )
{
struct V_3 * V_4 ;
struct V_1 * V_2 ;
int V_17 , V_15 ;
...
V_17 = F_95 ( V_27 , V_4 -> V_23 , NULL , V_15 ) ;
if ( V_17 )
goto V_83;
return V_2 ;
V_83:
