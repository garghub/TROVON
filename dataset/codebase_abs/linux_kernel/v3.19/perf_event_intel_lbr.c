...
T_3 V_101 [ V_102 ] ;
int V_103 = 0 ;
V_99 = F_24 ( V_34 ) ? V_63 : V_61 ;
V_100 = F_24 ( V_33 ) ? V_63 : V_61 ;
if ( V_33 == 0 || V_34 == 0 )
return V_97 ;
if ( abort )
return V_75 | V_99 ;
...
if ( ! V_104 -> V_105 )
return V_97 ;
V_96 = F_25 ( V_101 , ( void V_106 * ) V_33 ,
V_102 ) ;
V_95 = V_102 - V_96 ;
if ( ! V_95 )
return V_97 ;
...
#ifdef F_27
V_103 = F_24 ( ( unsigned long ) V_94 ) || ! F_28 ( V_107 ) ;
#endif
F_29 ( & V_93 , V_94 , V_95 , V_103 ) ;
F_30 ( & V_93 ) ;
if ( ! V_93 . V_108 . V_109 )
return V_75 ;
switch ( V_93 . V_108 . V_110 [ 0 ] ) {
case 0xf :
switch ( V_93 . V_108 . V_110 [ 1 ] ) {
case 0x05 :
case 0x34 :
V_92 = V_111 ;
break;
...
if ( V_100 == V_61 && V_99 == V_63
&& V_92 != V_111 && V_92 != V_112 )
V_92 = V_116 ;
if ( V_92 != V_97 )
V_92 |= V_99 ;
return V_92 ;
...
if ( type != V_97 && ( V_23 & V_120 ) ) {
if ( V_3 -> V_37 [ V_10 ] . V_46 )
type |= V_77 ;
else
type |= V_79 ;
}
if ( type == V_97 || ( V_23 & type ) != type ) {
...
V_117 = V_10 ;
while ( ++ V_117 < V_3 -> V_41 . V_42 )
V_3 -> V_37 [ V_117 - 1 ] = V_3 -> V_37 [ V_117 ] ;
V_3 -> V_41 . V_42 -- ;
if ( ! V_3 -> V_37 [ V_10 ] . V_33 )
continue;
}
