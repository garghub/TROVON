...
if ( ! V_71 )
return - V_74 ;
if ( F_31 ( V_69 , L_2 , NULL ) )
V_71 -> V_36 |= V_37 ;
if ( F_31 ( V_69 , L_3 , NULL ) )
V_71 -> V_36 |= V_39 ;
if ( F_31 ( V_69 , L_4 , NULL ) )
V_71 -> V_36 |= V_41 ;
if ( F_31 ( V_69 , L_5 , NULL ) )
V_71 -> V_36 |= V_45 ;
if ( F_31 ( V_69 , L_6 , NULL ) )
V_71 -> V_36 |= V_43 ;
if ( F_31 ( V_69 , L_7 , NULL ) )
V_71 -> V_36 |= V_47 ;
if ( F_31 ( V_69 , L_8 , NULL ) )
V_71 -> V_36 |= V_49 ;
...
if ( ! V_22 )
return - V_74 ;
V_84 = F_40 ( V_67 , V_89 , 0 ) ;
V_22 -> V_90 = F_41 ( & V_67 -> V_54 , V_84 ) ;
if ( F_37 ( V_22 -> V_90 ) ) {
V_55 = F_38 ( V_22 -> V_90 ) ;
goto V_91;
}
...
V_2 = F_10 ( V_22 ) ;
V_2 -> V_56 = V_85 ;
V_2 -> V_5 = ( void V_95 * ) V_22 -> V_90 ;
for ( V_86 = 0 ; V_86 < 3 ; ++ V_86 ) {
char V_96 [ 6 ] ;
if ( ! ( V_33 -> V_36 & ( V_37 << V_86 ) ) )
continue;
sprintf ( V_96 , L_14 , V_86 + 1 ) ;
V_2 -> V_18 [ V_86 ] = F_43 ( & V_67 -> V_54 , V_96 ) ;
}
...
bool V_100 = F_56 ( V_54 ) ;
int V_19 ;
if ( F_57 ( V_101 , V_82 -> V_102 ) )
F_58 ( 5 ) ;
V_82 -> V_102 = V_101 ;
V_19 = F_59 ( V_22 , V_100 ) ;
if ( V_19 )
return V_19 ;
F_24 ( V_2 , V_54 ) ;
return V_19 ;
