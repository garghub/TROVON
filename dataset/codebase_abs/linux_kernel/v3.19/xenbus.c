...
V_40 = F_45 ( & V_41 -> V_41 , V_41 -> V_102 , V_101 ) ;
if ( F_42 ( V_40 ) ) {
V_87 = F_18 ( V_40 ) ;
F_33 ( V_41 , V_87 , L_50 ) ;
return V_87 ;
...
V_100 = 0 ;
if ( V_100 )
V_40 -> V_147 |= F_80 ( V_149 ) ;
if ( F_44 ( V_81 , V_41 -> V_109 , L_77 ,
L_23 , & V_100 ) < 0 )
V_100 = 0 ;
if ( V_100 )
V_40 -> V_148 |= F_80 ( V_149 ) ;
if ( F_44 ( V_81 , V_41 -> V_109 , L_27 ,
L_23 , & V_100 ) < 0 )
V_100 = 0 ;
if ( V_100 )
V_40 -> V_147 |= F_80 ( V_150 ) ;
if ( F_44 ( V_81 , V_41 -> V_109 , L_78 ,
L_23 , & V_100 ) < 0 )
V_100 = 0 ;
if ( V_100 )
V_40 -> V_148 |= F_80 ( V_150 ) ;
if ( V_40 -> V_147 & V_40 -> V_148 ) {
F_33 ( V_41 , V_87 ,
L_79
L_80 ,
V_41 -> V_109 ) ;
