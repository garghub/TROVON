...
struct V_6 * V_7 = V_142 ;
int V_8 = 0 ;
F_112 ( V_205 , 0x78 , 0 , 0x80 ) ;
F_112 ( V_205 , 0x1e , 0xc0 , 0xc0 ) ;
F_38 ( V_7 ) ;
F_63 ( V_109 , & V_7 -> V_45 ) ;
if ( V_7 -> V_125 > 0 )
F_8 ( V_7 ) ;
...
static int F_118 ( struct V_214 * V_215 )
{
int V_8 ;
struct V_216 * V_217 ;
struct V_218 * V_37 = V_215 -> V_12 . V_219 ;
struct V_220 V_221 = {
. type = L_15 ,
. V_222 = 0x42 >> 1 ,
. V_219 = & V_223 ,
...
if ( F_119 () && F_113 () )
return - V_134 ;
V_7 = F_120 ( sizeof( struct V_6 ) , V_226 ) ;
if ( V_7 == NULL )
return - V_77 ;
V_227 = V_7 ;
V_7 -> V_11 = V_215 ;
...
V_7 -> V_45 = 1 << V_109 ;
V_7 -> V_25 = V_230 ;
V_8 = F_122 ( & V_215 -> V_12 , & V_7 -> V_231 ) ;
if ( V_8 ) {
F_4 ( & V_215 -> V_12 , L_18 ) ;
goto V_232;
}
V_8 = F_123 ( & V_7 -> V_233 , 10 ) ;
if ( V_8 )
goto V_234;
V_7 -> V_231 . V_233 = & V_7 -> V_233 ;
V_215 -> V_12 . V_235 = & V_37 -> V_215 -> V_235 ;
F_124 ( & V_215 -> V_12 , 0xffffffff ) ;
F_112 ( V_205 , 0x78 , 0 , 0x80 ) ;
F_112 ( V_205 , 0x1e , 0xc0 , 0xc0 ) ;
V_8 = F_2 ( V_7 ) ;
if ( V_8 )
...
F_8 ( V_7 ) ;
V_217 = F_125 ( V_237 ) ;
V_7 -> V_238 = F_126 ( & V_7 -> V_231 , V_217 ,
& V_221 , NULL ) ;
if ( V_7 -> V_238 == NULL ) {
F_4 ( & V_215 -> V_12 , L_19 ) ;
V_8 = - V_239 ;
...
F_38 ( V_7 ) ;
V_8 = F_127 ( V_37 -> V_215 -> V_33 , F_22 ,
F_32 , V_241 , L_9 , V_7 ) ;
if ( V_8 )
goto V_240;
V_7 -> V_242 = V_243 ;
V_7 -> V_242 . V_231 = & V_7 -> V_231 ;
V_8 = F_128 ( & V_7 -> V_242 , V_244 , - 1 ) ;
if ( V_8 )
goto V_245;
F_129 ( & V_7 -> V_242 , V_7 ) ;
#ifdef F_130
