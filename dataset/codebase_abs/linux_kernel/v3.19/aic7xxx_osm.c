...
int
F_105 ( struct V_1 * V_2 , int V_216 , char V_62 ,
...
F_109 ( V_2 , V_57 . V_62 , V_57 . V_216 ,
V_57 . V_217 , V_225 ) ;
F_110 ( V_2 , & V_57 ) ;
F_2 ( L_36 , V_135 ) ;
} else {
...
void
F_109 ( struct V_1 * V_2 , char V_62 ,
...
&& V_59 -> V_240 . V_284 == F_133 ( V_50 )
&& V_59 -> V_240 . V_241 == F_134 ( V_50 )
&& V_59 -> V_240 . V_285 == V_280 )
if ( V_88 == 0 )
break;
F_46 ( V_50 ) = V_59 -> V_240 . V_282 ;
F_133 ( V_50 ) = V_59 -> V_240 . V_284 ;
F_134 ( V_50 ) = V_59 -> V_240 . V_241 ;
F_130 ( V_50 ) = V_59 -> V_240 . V_285 & V_286 ? 1 : 0 ;
F_131 ( V_50 ) = V_59 -> V_240 . V_285 & V_287 ? 1 : 0 ;
F_132 ( V_50 ) = V_59 -> V_240 . V_285 & V_288 ? 1 : 0 ;
F_135 ( V_50 ) ;
break;
}
case V_289 :
...
void
F_139 ( struct V_1 * V_2 , struct V_3 * V_3 )
{
struct V_19 * V_20 ;
struct V_41 * V_42 ;
F_140 ( V_3 , V_270 ) ;
...
} else if ( F_144 ( V_3 ) == V_300 ) {
F_149 ( V_2 , V_20 -> V_43 , V_3 ) ;
}
if ( V_42 -> V_89 == 1
&& F_144 ( V_3 ) == V_299
&& F_150 ( V_3 ) != V_301 )
...
if ( V_3 -> V_31 & V_311 ) {
T_5 V_312 ;
V_312 = F_154 ( sizeof( struct V_313 )
- F_155 ( V_3 ) ,
( T_11 ) V_314 ) ;
memcpy ( V_20 -> V_292 ,
F_156 ( V_2 , V_3 ) , V_312 ) ;
...
static void
F_153 ( struct V_1 * V_2 , struct V_19 * V_20 )
{
{
T_5 V_322 ;
switch ( F_158 ( V_20 ) ) {
...
F_164 (pending_scb, &ahc->pending_scbs, pending_links) {
if ( V_351 -> V_21 == V_20 )
break;
}
if ( V_351 == NULL && V_156 == V_106 ) {
F_164 (pending_scb, &ahc->pending_scbs, pending_links) {
if ( F_165 ( V_2 , V_351 , F_166 ( V_20 ) ,
F_63 ( V_20 ) + 'A' ,
V_81 ,
V_201 , V_82 ) )
break;
...
} else if ( F_169 ( V_2 , V_20 -> V_43 -> V_65 ,
V_20 -> V_43 -> V_62 + 'A' ,
V_20 -> V_43 -> V_217 ,
V_351 -> V_227 -> V_10 ,
V_82 , 0 ,
...
static void F_178 ( struct V_49 * V_50 , int V_284 )
{
...
static void F_179 ( struct V_49 * V_50 , int V_282 )
{
struct V_34 * V_383 = F_32 ( V_50 -> V_42 . V_109 ) ;
struct V_1 * V_2 = * ( (struct V_1 * * ) V_383 -> V_38 ) ;
struct V_60 * V_61 ;
...
V_385 = F_180 ( V_2 , & V_282 , & V_285 , V_68 ) ;
F_28 ( V_2 , & V_31 ) ;
F_41 ( V_2 , & V_57 , V_385 , V_282 , V_241 ,
V_285 , V_83 , FALSE ) ;
F_30 ( V_2 , & V_31 ) ;
}
static void F_181 ( struct V_49 * V_50 , int V_241 )
{
struct V_34 * V_383 = F_32 ( V_50 -> V_42 . V_109 ) ;
struct V_1 * V_2 = * ( (struct V_1 * * ) V_383 -> V_38 ) ;
struct V_60 * V_61 ;
...
static void F_182 ( struct V_49 * V_50 , int V_387 )
{
struct V_34 * V_383 = F_32 ( V_50 -> V_42 . V_109 ) ;
struct V_1 * V_2 = * ( (struct V_1 * * ) V_383 -> V_38 ) ;
struct V_60 * V_61 ;
...
static void F_183 ( struct V_34 * V_383 )
{
struct V_1 * V_2 = * (struct V_1 * * ) V_383 -> V_38 ;
unsigned long V_31 ;
V_361 V_388 ;
