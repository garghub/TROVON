...
static struct V_14 * F_23 ( struct V_14 * V_89 ,
bool V_90 )
{
T_3 V_91 = 0 ;
struct V_14 * V_71 ;
...
static T_4 F_27 ( const struct V_99 * V_27 )
{
...
V_71 = F_23 ( V_102 , V_90 ) ;
if ( ! V_71 )
return NULL ;
F_31 ( & V_71 -> V_85 , V_27 , V_105 ) ;
F_32 ( & V_71 -> V_85 , V_1 -> V_107 ) ;
V_108:
if ( V_90 )
...
. V_27 = V_111 ,
. V_55 = F_27 ( V_111 ) | V_104 -> V_55 ,
. V_1 = V_1 ,
. V_29 = V_112 ,
. V_36 = V_113 ,
. V_47 = V_47 ,
} ;
return F_28 ( V_1 , & V_102 , V_104 , V_90 ) ;
}
static int
...
static int
F_36 ( struct V_118 * T_6 V_119 ,
struct V_103 * V_104 V_119 )
{
return 0 ;
}
static int
F_37 ( struct V_118 * T_6 , struct V_103 * V_104 )
{
struct V_120 * V_121 = T_6 -> V_121 ;
struct V_36 * V_113 ;
V_113 = F_38 ( V_121 , V_104 ) ;
if ( V_113 == NULL )
return - V_122 ;
T_6 -> V_123 = V_113 ;
return 0 ;
...
static int
F_39 ( struct V_118 * T_6 , struct V_103 * V_104 )
{
T_2 V_124 ;
struct V_36 * V_113 = T_6 -> V_123 ;
struct V_1 * V_1 = F_40 ( T_6 -> V_125 ) ;
struct V_14 * V_71 ;
if ( V_113 == NULL )
return - V_126 ;
...
if ( ! V_124 )
V_124 = 1 ;
V_71 = F_33 ( V_1 , V_104 , T_6 -> V_27 , NULL , V_113 ,
V_124 , V_124 , 0 , true ) ;
if ( ! V_71 )
return - V_122 ;
T_6 -> V_71 = V_71 ;
...
static int
F_41 ( struct V_118 * T_6 ,
struct V_103 * V_104 V_119 )
{
struct V_127 * V_125 = T_6 -> V_125 ;
struct V_1 * V_1 = F_40 ( V_125 ) ;
struct V_14 * V_71 = T_6 -> V_71 ;
int V_128 = - V_126 ;
if ( V_71 == NULL )
goto V_108;
F_42 ( V_1 , V_71 -> V_55 ) ;
V_128 = F_43 ( V_71 , T_6 -> V_121 ) ;
V_108:
T_6 -> V_123 = NULL ;
T_6 -> V_71 = NULL ;
return V_128 ;
...
static int
F_44 ( struct V_118 * T_6 , struct V_103 * V_104 )
{
struct V_29 * V_112 ;
struct V_120 * V_121 = T_6 -> V_121 ;
V_112 = F_45 ( V_121 , V_104 ) ;
if ( ! V_112 )
return - V_122 ;
T_6 -> V_129 = 0 ;
...
static int
F_47 ( struct V_118 * T_6 , struct V_103 * V_104 )
{
...
static int
F_48 ( struct V_118 * T_6 , struct V_103 * V_104 )
{
struct V_29 * V_112 ;
struct V_127 * V_125 = T_6 -> V_125 ;
struct V_1 * V_1 = F_40 ( V_125 ) ;
...
goto V_108;
V_71 = F_33 ( V_1 , V_104 , T_6 -> V_27 , & V_112 [ V_133 ] , NULL ,
1 , 1 , 0 , true ) ;
if ( V_71 == NULL )
return - V_122 ;
F_42 ( V_1 , V_71 -> V_55 ) ;
...
static int
F_50 ( struct V_118 * T_6 V_119 ,
struct V_103 * V_104 V_119 )
{
return 0 ;
}
static int
F_51 ( struct V_118 * T_6 , struct V_103 * V_104 )
{
struct V_127 * V_125 = T_6 -> V_125 ;
struct V_120 * V_121 = T_6 -> V_121 ;
struct V_14 * V_71 ;
V_71 = F_33 ( F_40 ( V_125 ) , V_104 , T_6 -> V_27 , NULL , NULL ,
...
return 0 ;
T_6 -> V_71 = NULL ;
F_42 ( F_40 ( V_125 ) , V_71 -> V_55 ) ;
return F_43 ( V_71 , V_121 ) ;
}
static int
F_53 ( struct V_118 * T_6 V_119 ,
struct V_103 * V_104 V_119 )
{
struct V_14 * * V_135 ;
F_54 ( & V_136 ) ;
...
struct V_14 * V_71 ;
int V_128 = 0 ;
V_71 = F_33 ( V_1 , V_104 , T_6 -> V_27 , NULL , NULL ,
V_121 -> V_58 , V_121 -> V_67 ,
V_121 -> V_47 , true ) ;
if ( V_71 == NULL )
return - V_122 ;
...
if ( V_98 == NULL )
return 0 ;
return F_58 ( V_104 , V_98 , T_6 -> V_134 ) ;
}
static int
F_59 ( struct V_118 * T_6 ,
struct V_103 * V_104 )
{
struct V_127 * V_125 = T_6 -> V_125 ;
struct V_120 * V_121 = T_6 -> V_121 ;
...
V_135 [ T_6 -> V_129 ++ ] = V_71 ;
if ( V_10 . V_92 )
F_62 ( V_71 -> V_96 , & V_140 , V_121 -> V_58 ) ;
return 0 ;
}
static int
F_63 ( struct V_118 * T_6 ,
struct V_103 * V_104 V_119 )
{
F_30 ( & T_6 -> V_123 ) ;
T_6 -> V_71 = NULL ;
...
int F_64 ( struct V_118 * T_6 , struct V_103 * V_104 ,
struct V_127 * V_125 , struct V_120 * V_121 ,
int V_141 , void * V_142 )
{
int V_128 , V_143 ;
V_128 = F_65 ( V_121 , & T_6 -> V_27 , V_125 , V_104 ,
V_141 ) ;
if ( V_128 )
return V_128 ;
T_6 -> V_125 = V_125 ;
...
T_5
F_29 ( struct V_14 * V_151 , struct V_14 * V_152 )
{
struct V_153 * V_154 ;
T_5 V_106 = 0 ;
F_66 (fmt) {
...
T_5
F_68 ( struct V_14 * V_151 , struct V_14 * V_152 )
{
struct V_153 * V_154 ;
T_5 V_106 = 0 ;
F_66 (fmt) {
...
static bool F_71 ( struct V_1 * V_1 V_119 ,
struct V_157 * V_158 ,
struct V_14 * V_71 )
{
...
V_1 -> V_87 ++ ;
F_31 ( & V_71 -> V_85 , V_27 , V_105 ) ;
F_32 ( & V_71 -> V_85 , V_158 ) ;
return true ;
}
static struct V_157 * F_74 ( struct V_1 * V_1 )
{
struct V_157 * V_158 ;
F_75 ( & V_1 -> V_159 ) ;
V_158 = V_1 -> V_107 ;
...
static void F_77 ( struct V_1 * V_1 , struct V_14 * V_71 )
{
F_78 ( V_1 , V_71 ) ;
F_79 ( V_1 , V_71 ) ;
F_80 ( V_1 , V_71 ) ;
}
void F_81 ( struct V_1 * V_1 , struct V_161 * V_162 )
{
struct V_157 * V_158 ;
struct V_50 * V_51 ;
struct V_14 * V_53 ;
...
static int F_84 ( struct V_14 * V_163 , struct V_14 * V_164 )
{
struct V_153 * V_154 ;
T_5 V_106 = 0 ;
F_66 (fmt) {
...
static void F_87 ( struct V_1 * V_1 , struct V_14 * V_15 )
{
V_1 -> V_88 ++ ;
V_1 -> V_77 . V_79 += V_15 -> V_73 . V_58 ;
}
void F_88 ( struct V_1 * V_1 , struct V_14 * V_15 )
{
if ( ! V_15 -> V_55 )
F_87 ( V_1 , V_15 ) ;
V_1 -> V_87 ++ ;
...
static void F_89 ( struct V_157 * V_52 ,
struct V_14 * V_71 ,
T_2 V_166 )
{
...
F_31 ( & V_71 -> V_50 , V_27 , V_105 ) ;
F_32 ( & V_71 -> V_50 , V_52 ) ;
}
void F_90 ( struct V_1 * V_1 , struct V_161 * V_162 )
{
struct V_157 * V_158 ;
struct V_50 * V_51 ;
struct V_14 * V_53 ;
...
static void F_91 ( struct V_1 * V_1 , struct V_14 * V_15 ,
enum V_171 V_172 )
{
V_15 -> V_55 &= ~ ( 1 << V_172 ) ;
if ( V_15 -> V_55 )
...
void F_95 ( struct V_184 * V_77 , T_7 type )
{
++ V_77 -> V_68 [ 0 ] ;
++ V_77 -> V_68 [ type ] ;
}
void F_96 ( struct V_1 * V_1 , T_7 type )
{
F_95 ( & V_1 -> V_77 , type ) ;
}
void F_42 ( struct V_1 * V_1 , bool V_55 )
{
F_95 ( & V_1 -> V_77 , V_185 ) ;
if ( ! V_55 )
V_1 -> V_77 . V_175 ++ ;
}
static struct V_14 * F_97 ( struct V_1 * V_1 ,
struct V_14 * V_186 )
{
struct V_157 * V_158 ;
struct V_50 * * V_105 ;
...
void F_99 ( struct V_1 * V_188 , struct V_1 * V_189 )
{
struct V_157 * V_158 ;
struct V_50 * V_178 ;
...
V_186 = F_98 ( V_189 , V_190 ) ;
if ( V_186 )
F_100 ( V_186 , V_190 ) ;
}
}
int F_101 ( struct V_1 * V_188 , struct V_1 * V_189 )
{
struct V_157 * V_158 ;
struct V_50 * V_178 ;
struct V_14 * V_190 , * V_186 ;
...
T_3 F_103 ( struct V_191 * V_192 , T_8 * V_193 )
{
struct V_127 * V_190 ;
T_3 V_194 = 0 ;
F_104 (evlist, pos) {
V_194 += fprintf ( V_193 , L_1 , F_105 ( V_190 ) ) ;
V_194 += F_106 ( & F_40 ( V_190 ) -> V_77 , V_193 ) ;
}
return V_194 ;
}
T_2 F_107 ( struct V_1 * V_1 )
{
return V_10 . V_195 ? V_1 -> V_77 . V_79 :
V_1 -> V_77 . V_78 ;
}
int F_108 ( const struct V_196 * T_9 V_119 ,
const char * V_142 , int T_10 V_119 )
{
if ( ! strcmp ( V_142 , L_2 ) )
V_10 . V_195 = true ;
else if ( ! strcmp ( V_142 , L_3 ) )
V_10 . V_195 = false ;
else
return - 1 ;
return 0 ;
}
int F_109 ( const char * V_197 , const char * V_198 )
{
if ( ! strcmp ( V_197 , L_4 ) )
return F_108 ( NULL , V_198 , 0 ) ;
return 0 ;
}
static int F_110 ( struct V_127 * V_125 )
{
struct V_1 * V_1 = F_40 ( V_125 ) ;
memset ( V_1 , 0 , sizeof( * V_1 ) ) ;
V_1 -> V_160 [ 0 ] = V_1 -> V_160 [ 1 ] = V_170 ;
V_1 -> V_107 = & V_1 -> V_160 [ 0 ] ;
V_1 -> V_86 = V_170 ;
V_1 -> V_52 = V_170 ;
F_111 ( & V_1 -> V_159 , NULL ) ;
return 0 ;
}
int F_112 ( void )
{
int V_128 = F_113 ( sizeof( struct V_199 ) ,
F_110 , NULL ) ;
if ( V_128 )
fputs ( L_5 , V_200 ) ;
return V_128 ;
