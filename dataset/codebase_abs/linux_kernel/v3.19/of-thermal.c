...
V_67 -> V_33 = V_68 . V_34 ;
if ( V_68 . V_66 >= 2 ) {
V_67 -> V_38 = V_68 . args [ 0 ] ;
V_67 -> V_37 = V_68 . args [ 1 ] ;
} else {
F_38 ( L_11 ) ;
}
V_71:
...
const char * V_72 ;
int V_73 , V_28 ;
V_73 = F_40 ( V_34 , L_12 , & V_72 ) ;
if ( V_73 < 0 )
return V_73 ;
for ( V_28 = 0 ; V_28 < F_41 ( V_74 ) ; V_28 ++ )
if ( ! strcasecmp ( V_72 , V_74 [ V_28 ] ) ) {
* type = V_28 ;
return 0 ;
}
return - V_11 ;
...
int V_69 ;
int V_35 ;
V_35 = F_36 ( V_34 , L_13 , & V_69 ) ;
if ( V_35 < 0 ) {
F_38 ( L_14 ) ;
return V_35 ;
}
V_13 -> V_46 = V_69 ;
V_35 = F_36 ( V_34 , L_15 , & V_69 ) ;
if ( V_35 < 0 ) {
F_38 ( L_16 ) ;
return V_35 ;
}
...
V_2 = F_44 ( sizeof( * V_2 ) , V_76 ) ;
if ( ! V_2 )
return F_25 ( - V_77 ) ;
V_35 = F_36 ( V_34 , L_19 , & V_69 ) ;
if ( V_35 < 0 ) {
F_38 ( L_20 ) ;
goto V_78;
}
V_2 -> V_79 = V_69 ;
V_35 = F_36 ( V_34 , L_21 , & V_69 ) ;
if ( V_35 < 0 ) {
F_38 ( L_22 ) ;
goto V_78;
}
...
if ( V_2 -> V_12 == 0 )
goto V_80;
V_2 -> V_15 = F_44 ( V_2 -> V_12 * sizeof( * V_2 -> V_15 ) , V_76 ) ;
if ( ! V_2 -> V_15 ) {
V_35 = - V_77 ;
goto V_78;
}
...
if ( V_2 -> V_29 == 0 )
goto V_80;
V_2 -> V_32 = F_44 ( V_2 -> V_29 * sizeof( * V_2 -> V_32 ) , V_76 ) ;
if ( ! V_2 -> V_32 ) {
V_35 = - V_77 ;
goto V_81;
}
...
V_7 = F_52 ( & V_87 , sizeof( * V_7 ) , V_76 ) ;
if ( ! V_7 )
goto V_88;
V_86 = F_44 ( sizeof( * V_86 ) , V_76 ) ;
if ( ! V_86 ) {
F_47 ( V_7 ) ;
goto V_88;
}
