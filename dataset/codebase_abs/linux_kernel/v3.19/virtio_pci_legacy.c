...
int F_34 ( struct V_53 * V_53 ,
const struct V_54 * V_55 )
{
struct V_3 * V_4 ;
int V_28 ;
if ( V_53 -> V_51 < 0x1000 || V_53 -> V_51 > 0x103f )
return - V_56 ;
if ( V_53 -> V_57 != V_58 ) {
F_35 ( V_59 L_1 ,
V_58 , V_53 -> V_57 ) ;
...
V_4 = F_36 ( sizeof( struct V_3 ) , V_36 ) ;
if ( V_4 == NULL )
return - V_38 ;
V_4 -> V_2 . V_60 . V_61 = & V_53 -> V_60 ;
V_4 -> V_2 . V_60 . V_62 = F_31 ;
V_4 -> V_2 . V_63 = & V_64 ;
V_4 -> V_53 = V_53 ;
F_37 ( & V_4 -> V_65 ) ;
F_38 ( & V_4 -> V_66 ) ;
...
if ( V_28 )
goto V_68;
V_4 -> V_5 = F_42 ( V_53 , 0 , 0 ) ;
if ( V_4 -> V_5 == NULL ) {
V_28 = - V_38 ;
goto V_69;
}
V_4 -> V_70 = V_4 -> V_5 + V_50 ;
F_43 ( V_53 , V_4 ) ;
F_44 ( V_53 ) ;
V_4 -> V_2 . V_55 . V_71 = V_53 -> V_72 ;
V_4 -> V_2 . V_55 . V_51 = V_53 -> V_73 ;
V_4 -> V_74 = F_17 ;
V_4 -> F_20 = F_20 ;
V_4 -> F_30 = F_30 ;
V_28 = F_45 ( & V_4 -> V_2 ) ;
...
void F_49 ( struct V_53 * V_53 )
{
struct V_3 * V_4 = F_50 ( V_53 ) ;
F_51 ( & V_4 -> V_2 ) ;
F_52 ( & V_4 -> V_2 ) ;
F_46 ( V_53 , V_4 -> V_5 ) ;
F_47 ( V_53 ) ;
