...
static struct V_1 * F_83 ( struct V_1 * V_2 )
{
struct V_1 * V_90 ;
F_63 (p, t) {
if ( ! ( V_90 -> V_62 & V_91 ) )
...
static struct V_1 * F_84 ( struct V_1 * V_92 )
...
static void F_87 ( struct V_1 * V_92 , struct V_1 * V_2 ,
struct V_99 * V_100 )
{
...
V_2 -> V_52 = V_55 ;
F_88 ( & V_2 -> V_103 , V_100 ) ;
}
}
F_57 ( V_2 , V_92 ) ;
}
static void F_89 ( struct V_1 * V_92 ,
struct V_99 * V_100 )
{
struct V_1 * V_2 , * V_90 , * V_95 ;
if ( F_13 ( ! F_90 ( & V_92 -> V_104 ) ) )
F_91 ( V_92 , V_100 ) ;
V_95 = F_84 ( V_92 ) ;
if ( F_90 ( & V_92 -> V_105 ) )
return;
...
F_94 ( & V_92 -> V_105 , & V_95 -> V_105 ) ;
}
static void F_95 ( struct V_1 * V_13 , int V_3 )
{
bool V_108 ;
...
if ( V_13 -> V_52 == V_55 )
F_88 ( & V_13 -> V_103 , & V_100 ) ;
if ( F_13 ( V_13 -> signal -> V_24 < 0 ) )
F_15 ( V_13 -> signal -> V_25 ) ;
F_44 ( & V_50 ) ;
F_98 (p, n, &dead, ptrace_entry) {
F_4 ( & V_2 -> V_103 ) ;
F_34 ( V_2 ) ;
}
}
...
if ( free < V_111 ) {
F_102 ( L_1 ,
V_61 -> V_113 , F_103 ( V_61 ) , free ) ;
V_111 = free ;
}
F_25 ( & V_110 ) ;
}
static inline void F_99 ( void ) {}
void F_104 ( long V_114 )
{
struct V_1 * V_13 = V_61 ;
int V_3 ;
F_105 (int tasks_rcu_i) ;
F_106 ( V_13 ) ;
F_107 ( F_108 ( V_13 ) ) ;
if ( F_13 ( F_109 () ) )
F_110 ( L_2 ) ;
...
if ( V_3 ) {
F_124 ( & V_13 -> signal -> V_120 ) ;
F_125 ( V_13 -> signal ) ;
if ( V_13 -> V_69 )
F_126 ( & V_13 -> signal -> V_121 , V_13 -> V_69 ) ;
}
F_127 ( V_114 , V_3 ) ;
if ( V_3 )
F_128 () ;
...
F_141 ( V_13 ) ;
F_142 ( V_13 ) ;
F_143 ( F_144 ( V_13 ) -> V_123 -> V_124 ) ;
F_145 ( V_13 ) ;
F_105 ( V_125 = F_146 ( & V_126 ) ) ;
F_95 ( V_13 , V_3 ) ;
F_147 ( V_13 ) ;
#ifdef F_148
F_66 ( V_13 ) ;
...
F_154 ( V_13 -> V_130 ) ;
if ( V_13 -> V_131 . V_132 )
F_155 ( V_13 -> V_131 . V_132 ) ;
F_113 ( V_13 ) ;
F_99 () ;
F_156 () ;
if ( V_13 -> V_133 )
F_157 ( V_134 , V_13 -> V_133 ) ;
F_158 () ;
F_105 ( F_159 ( & V_126 , V_125 ) ) ;
F_118 () ;
F_119 ( & V_13 -> V_118 ) ;
V_13 -> V_135 = V_136 ;
V_13 -> V_62 |= V_137 ;
...
void F_162 ( struct V_138 * V_139 , long V_114 )
{
if ( V_139 )
F_75 ( V_139 ) ;
F_104 ( V_114 ) ;
...
static inline
struct V_56 * F_168 ( struct V_1 * V_81 , enum V_142 type )
{
if ( type != V_5 )
V_81 = V_81 -> V_51 ;
return V_81 -> V_143 [ type ] . V_56 ;
}
static int F_169 ( struct V_144 * V_145 , struct V_1 * V_2 )
{
return V_145 -> V_146 == V_147 ||
F_168 ( V_2 , V_145 -> V_146 ) == V_145 -> V_148 ;
}
...
? F_172 ( V_2 , V_158 , V_145 -> V_157 ) : 0 ;
F_33 ( V_2 ) ;
V_156 = V_145 -> V_159 ;
if ( V_156 ) {
if ( ! V_60 )
V_60 = F_173 ( V_101 , & V_156 -> V_160 ) ;
if ( ! V_60 )
V_60 = F_173 ( 0 , & V_156 -> V_161 ) ;
if ( ! V_60 )
V_60 = F_173 ( ( short ) V_153 , & V_156 -> V_162 ) ;
if ( ! V_60 )
V_60 = F_173 ( V_56 , & V_156 -> V_163 ) ;
if ( ! V_60 )
V_60 = F_173 ( V_152 , & V_156 -> V_164 ) ;
if ( ! V_60 )
V_60 = F_173 ( V_154 , & V_156 -> V_165 ) ;
}
if ( ! V_60 )
V_60 = V_56 ;
return V_60 ;
}
static int F_174 ( struct V_144 * V_145 , struct V_1 * V_2 )
{
int V_135 , V_60 , V_154 ;
T_2 V_56 = F_175 ( V_2 ) ;
T_3 V_152 = F_176 ( F_177 () , F_178 ( V_2 ) ) ;
struct V_155 T_4 * V_156 ;
if ( ! F_92 ( V_145 -> V_149 & V_166 ) )
return 0 ;
...
return F_171 ( V_145 , V_2 , V_56 , V_152 , V_153 , V_154 ) ;
}
V_135 = ( F_97 ( V_2 ) && F_7 ( V_2 ) ) ?
V_171 : V_55 ;
if ( F_180 ( & V_2 -> V_52 , V_53 , V_135 ) != V_53 )
return 0 ;
F_55 ( & V_50 ) ;
F_179 () ;
...
unsigned long V_121 ;
T_1 V_173 , V_174 ;
F_181 ( V_2 , & V_173 , & V_174 ) ;
F_165 ( & V_61 -> V_17 -> V_23 ) ;
F_18 ( & V_172 -> V_27 ) ;
...
V_121 = F_182 ( V_15 -> V_121 , V_15 -> V_184 ) ;
...
static int * F_184 ( struct V_1 * V_2 , bool V_102 )
{
if ( V_102 ) {
if ( F_185 ( V_2 ) &&
! ( V_2 -> V_186 & V_187 ) )
...
static int F_186 ( struct V_144 * V_145 ,
...
F_179 () ;
if ( F_13 ( V_145 -> V_149 & V_167 ) )
return F_171 ( V_145 , V_2 , V_56 , V_152 , V_153 , V_122 ) ;
V_60 = V_145 -> V_157
? F_172 ( V_2 , V_158 , V_145 -> V_157 ) : 0 ;
if ( ! V_60 && V_145 -> V_185 )
V_60 = F_173 ( ( V_122 << 8 ) | 0x7f , V_145 -> V_185 ) ;
V_156 = V_145 -> V_159 ;
if ( ! V_60 && V_156 )
V_60 = F_173 ( V_101 , & V_156 -> V_160 ) ;
if ( ! V_60 && V_156 )
...
static int F_187 ( struct V_144 * V_145 , struct V_1 * V_2 )
{
int V_60 ;
T_2 V_56 ;
T_3 V_152 ;
...
F_33 ( V_2 ) ;
if ( ! V_60 && V_145 -> V_185 )
V_60 = F_173 ( 0xffff , V_145 -> V_185 ) ;
if ( ! V_60 )
V_60 = V_56 ;
} else {
V_60 = F_171 ( V_145 , V_2 , V_56 , V_152 ,
V_195 , V_67 ) ;
F_64 ( V_60 == 0 ) ;
}
return V_60 ;
}
static int F_188 ( struct V_144 * V_145 , int V_102 ,
struct V_1 * V_2 )
{
int V_52 = F_189 ( V_2 -> V_52 ) ;
int V_196 ;
if ( F_13 ( V_52 == V_55 ) )
return 0 ;
V_196 = F_170 ( V_145 , V_2 ) ;
if ( ! V_196 )
return V_196 ;
V_196 = F_190 ( V_2 ) ;
if ( F_13 ( V_196 < 0 ) ) {
...
if ( F_92 ( ! V_102 ) && F_13 ( V_2 -> V_102 ) ) {
if ( ! F_97 ( V_2 ) )
V_102 = 1 ;
}
if ( V_52 == V_53 ) {
if ( ! F_191 ( V_2 ) ) {
if ( F_13 ( V_102 ) || F_92 ( ! V_2 -> V_102 ) )
return F_174 ( V_145 , V_2 ) ;
}
if ( F_92 ( ! V_102 ) || ( V_145 -> V_149 & ( V_193 | V_166 ) ) )
V_145 -> V_197 = 0 ;
} else {
V_145 -> V_197 = 0 ;
}
V_196 = F_186 ( V_145 , V_102 , V_2 ) ;
if ( V_196 )
return V_196 ;
return F_187 ( V_145 , V_2 ) ;
}
static int F_192 ( struct V_144 * V_145 , struct V_1 * V_13 )
{
struct V_1 * V_2 ;
F_61 (p, &tsk->children, sibling) {
int V_196 = F_188 ( V_145 , 0 , V_2 ) ;
if ( V_196 )
return V_196 ;
}
return 0 ;
...
int V_196 = F_188 ( V_145 , 1 , V_2 ) ;
if ( V_196 )
return V_196 ;
}
return 0 ;
}
static int F_194 ( T_5 * V_198 , unsigned V_199 ,
...
return 0 ;
return F_195 ( V_198 , V_199 , V_200 , V_201 ) ;
}
void F_196 ( struct V_1 * V_2 , struct V_1 * V_64 )
{
F_197 ( & V_64 -> signal -> V_205 ,
V_206 , 1 , V_2 ) ;
}
static long F_198 ( struct V_144 * V_145 )
{
struct V_1 * V_13 ;
int V_60 ;
F_199 ( V_145 -> V_148 ) ;
F_200 ( & V_145 -> V_202 , F_194 ) ;
V_145 -> V_202 . V_204 = V_61 ;
F_201 ( & V_61 -> signal -> V_205 , & V_145 -> V_202 ) ;
V_47:
V_145 -> V_197 = - V_207 ;
if ( ( V_145 -> V_146 < V_147 ) &&
( ! V_145 -> V_148 || F_202 ( & V_145 -> V_148 -> V_8 [ V_145 -> V_146 ] ) ) )
goto V_208;
F_115 ( V_206 ) ;
F_54 ( & V_50 ) ;
V_13 = V_61 ;
do {
V_60 = F_192 ( V_145 , V_13 ) ;
if ( V_60 )
goto V_209;
