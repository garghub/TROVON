...
{
struct V_79 * V_81 ;
struct V_124 * V_91 = V_50 -> V_26 . V_44 ;
T_3 V_80 = F_70 ( V_50 -> V_28 . V_80 ) ;
if ( V_50 -> V_26 . V_27 < sizeof( * V_91 ) )
goto V_14;
F_4 ( L_30 , V_50 , V_80 ) ;
...
static int F_90 ( struct V_22 * V_23 , T_1 V_126 ,
T_1 V_127 , T_3 V_128 ,
char * V_103 , int V_13 )
{
struct V_79 * V_81 ;
...
F_80 ( & V_81 -> V_99 ) ;
V_6 = - V_18 ;
V_81 -> V_92 = F_81 ( V_130 , sizeof( * V_60 ) , V_17 ,
true ) ;
if ( ! V_81 -> V_92 )
goto V_77;
V_81 -> V_91 = F_81 ( V_131 , 1024 , V_17 ,
true ) ;
if ( ! V_81 -> V_91 )
goto V_77;
...
V_60 -> V_109 . V_112 = 0 ;
V_60 -> V_9 = V_23 -> V_38 -> V_9 ;
V_60 -> V_127 = F_15 ( V_127 ) ;
V_60 -> V_126 = F_15 ( V_126 ) ;
V_60 -> V_132 = 0 ;
V_60 -> V_128 = F_34 ( V_128 ) ;
V_60 -> V_133 = 0 ;
V_6 = F_74 ( V_23 , V_81 ) ;
V_77:
F_66 ( & V_81 -> V_90 , F_62 ) ;
...
T_1 V_127 , T_3 * V_128 )
{
return F_90 ( V_23 , V_134 ,
V_127 , 0 , ( char * ) V_128 , sizeof( * V_128 ) ) ;
}
...
static void V_48 ( struct V_135 * V_136 )
{
struct V_22 * V_23 =
F_63 ( V_136 , struct V_22 , V_48 . V_136 ) ;
F_4 ( L_31 ) ;
F_37 ( & V_23 -> V_62 ) ;
if ( V_23 -> V_63 ) {
F_19 ( V_23 ) ;
...
{
struct V_137 * V_138 = V_23 -> V_69 -> V_139 ;
struct V_21 * V_140 = V_138 -> V_140 ;
int V_11 = V_138 -> V_11 ;
int V_5 ;
...
return - V_18 ;
for ( V_5 = 0 ; V_5 < V_11 ; V_5 ++ ) {
V_23 -> V_38 -> V_15 [ V_5 ] . V_19 = V_140 [ V_5 ] ;
V_23 -> V_38 -> V_15 [ V_5 ] . V_19 . V_142 = 0 ;
V_23 -> V_38 -> V_15 [ V_5 ] . V_143 . type =
V_43 ;
V_23 -> V_38 -> V_15 [ V_5 ] . V_143 . V_52 = F_34 ( V_5 ) ;
}
V_23 -> V_38 -> V_11 = V_11 ;
return 0 ;
}
int F_100 ( struct V_22 * V_23 , struct V_73 * V_144 )
{
int V_6 = 0 ;
F_4 ( L_32 ) ;
...
if ( V_6 )
goto V_77;
V_23 -> V_35 = F_102 ( V_144 -> V_139 -> V_143 ,
V_144 -> V_139 -> V_145 ) ;
if ( F_50 ( V_23 -> V_35 ) ) {
V_6 = F_51 ( V_23 -> V_35 ) ;
goto V_146;
...
V_149 | V_150 ;
V_6 = - V_18 ;
V_23 -> V_34 = F_81 ( V_151 ,
sizeof( struct V_59 ) ,
V_17 , true ) ;
if ( ! V_23 -> V_34 )
goto V_152;
V_23 -> V_33 = F_81 ( V_153 , 96 , V_17 ,
true ) ;
if ( ! V_23 -> V_33 )
goto V_154;
V_23 -> V_32 = F_81 ( V_155 , 4096 , V_17 ,
true ) ;
if ( ! V_23 -> V_32 )
goto V_156;
V_23 -> V_25 = F_81 ( V_157 , 4096 , V_17 , true ) ;
V_23 -> V_24 = 0 ;
if ( ! V_23 -> V_25 )
goto V_158;
F_103 ( & V_23 -> V_30 , V_23 , & V_159 ,
& V_23 -> V_69 -> V_160 ) ;
V_23 -> V_31 = - 1 ;
V_23 -> V_63 = true ;
V_23 -> V_40 = V_41 ;
...
V_23 -> V_25 -> V_45 ) ;
if ( V_37 < 0 ) {
V_23 -> V_69 -> V_163 = V_37 ;
F_55 ( & V_23 -> V_69 -> V_70 ) ;
} else if ( V_37 > 0 ) {
F_14 ( V_23 , V_37 ) ;
} else if ( ! V_162 && F_98 ( V_23 -> V_35 ) ) {
F_4 ( L_34 ) ;
V_23 -> V_69 -> V_160 . V_164 . V_143 . type = V_165 ;
V_23 -> V_69 -> V_160 . V_164 . V_143 . V_52 =
F_34 ( V_23 -> V_35 -> V_72 ) ;
F_31 ( V_23 ) ;
F_93 ( V_23 ) ;
}
...
break;
case V_167 :
F_115 ( & V_23 -> V_69 -> V_168 , V_50 ) ;
break;
default:
if ( V_23 -> V_69 -> V_169 &&
V_23 -> V_69 -> V_169 ( V_23 -> V_69 , V_50 ) == 0 )
break;
F_40 ( L_35 , type ,
F_116 ( type ) ) ;
}
...
F_118 ( L_37 ,
V_29 , V_4 -> V_45 ,
( unsigned int ) V_30 -> V_171 . type ,
F_70 ( V_30 -> V_171 . V_52 ) ) ;
F_64 ( V_4 ) ;
V_4 = F_81 ( type , V_29 , V_17 , false ) ;
}
return V_4 ;
