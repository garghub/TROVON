...
{
struct V_158 V_159 ;
T_4 V_160 = V_2 -> V_71 . V_160 ;
static T_1 V_161 ;
int V_162 ;
unsigned long V_39 ;
T_3 V_58 ;
F_20 ( V_2 -> V_13 -> V_14 , L_6 , V_163 , V_43 ) ;
if ( ( F_37 ( V_2 ) == V_164 ) &&
F_38 ( V_2 -> V_13 -> V_165 ) &&
V_2 -> V_13 -> V_104 &&
memcmp ( V_2 -> V_166 , V_157 , V_156 ) ) {
struct V_167 * V_168 ;
F_10 ( & V_2 -> V_169 , V_39 ) ;
V_168 = F_39 ( V_2 , V_157 ) ;
if ( ! V_168 ) {
F_40 ( V_2 -> V_13 -> V_14 ,
L_7 ,
V_157 ) ;
...
V_58 |= V_70 ;
V_159 . V_58 = F_6 ( V_58 ) ;
V_159 . V_174 = F_6 ( ( T_3 ) V_2 -> V_71 . V_175 ) ;
++ V_161 ;
if ( V_161 == 0 )
V_161 = 1 ;
V_159 . V_176 = V_161 ;
memcpy ( & V_159 . V_52 , V_157 , V_156 ) ;
V_162 = F_41 ( V_2 , V_177 ,
0 , 0 , & V_159 , false ) ;
return V_162 ;
}
...
V_179 . V_48 = F_6 ( V_43 << V_49 ) ;
V_48 = F_2 ( V_179 . V_48 ) ;
if ( V_178 )
V_48 |= V_180 ;
else
V_48 &= ~ V_180 ;
memcpy ( & V_179 . V_52 , V_157 , V_156 ) ;
V_162 = F_41 ( V_2 , V_181 ,
V_84 , 0 , & V_179 , false ) ;
return V_162 ;
}
...
struct V_45 * V_182 =
(struct V_45 * ) V_46 ;
T_2 V_48 = F_2 ( V_182 -> V_48 ) ;
int V_43 ;
V_43 = V_48 >> V_49 ;
F_14 ( V_2 , V_43 , V_182 -> V_52 ,
V_183 , F_15 ( V_48 ) ) ;
}
...
list) {
V_186 -> V_43 = ( T_3 ) V_188 -> V_43 ;
memcpy ( V_186 -> V_191 , V_188 -> V_191 , V_156 ) ;
V_186 -> V_192 = V_188 -> V_192 ;
V_186 -> V_193 = V_188 -> V_193 ;
for ( V_148 = 0 ; V_148 < V_188 -> V_193 ; ++ V_148 ) {
if ( V_188 -> V_194 [ V_148 ] )
V_186 -> V_108 [ V_148 ] = true ;
else
V_186 -> V_108 [ V_148 ] = false ;
}
V_186 ++ ;
V_189 ++ ;
if ( V_189 >= V_195 )
...
{
struct V_35 * V_38 ;
struct V_196 * V_186 = V_185 ;
int V_189 = 0 ;
unsigned long V_39 ;
F_10 ( & V_2 -> V_40 , V_39 ) ;
F_11 (tx_ba_tsr_tbl, &priv->tx_ba_stream_tbl_ptr, list) {
V_186 -> V_43 = ( T_3 ) V_38 -> V_43 ;
F_20 ( V_2 -> V_13 -> V_14 , L_8 ,
V_163 , V_186 -> V_43 ) ;
memcpy ( V_186 -> V_55 , V_38 -> V_55 , V_156 ) ;
V_186 -> V_73 = V_38 -> V_73 ;
V_186 ++ ;
V_189 ++ ;
if ( V_189 >= V_197 )
break;
...
if ( ! memcmp ( V_198 -> V_55 , V_55 , V_156 ) ) {
F_12 ( & V_2 -> V_40 ,
V_39 ) ;
F_28 ( V_2 , V_198 ) ;
F_10 ( & V_2 -> V_40 , V_39 ) ;
