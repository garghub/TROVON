...
if ( ! V_5 -> V_15 )
return - V_25 ;
F_21 ( ! F_22 ( & V_5 -> V_15 -> V_26 ) , V_5 -> V_15 ) ;
V_16 = F_23 ( V_5 -> V_15 , V_2 ) ;
do {
struct V_21 * V_22 = NULL ;
V_11 = F_24 ( V_2 , V_3 ) ;
V_22 = F_25 ( V_5 -> V_15 , V_2 ) ;
if ( V_22 ) {
if ( ( V_22 -> V_27 <= V_2 ) &&
( V_22 -> V_28 & V_29 ) ) {
if ( V_5 -> V_13 )
...
if ( V_7 )
break;
V_16 = F_23 ( V_5 -> V_15 , V_11 ) ;
continue;
}
if ( V_5 -> V_24 && ( V_22 -> V_27 <= V_2 ) &&
F_26 ( V_22 ) ) {
if ( V_22 -> V_30 < V_11 )
V_11 = V_22 -> V_30 ;
...
if ( V_5 -> V_31 )
V_7 = V_5 -> V_31 ( V_16 , V_2 , V_11 , V_5 ) ;
if ( ! V_7 &&
