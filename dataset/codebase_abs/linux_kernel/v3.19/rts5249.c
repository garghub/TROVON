...
int V_35 ;
if ( V_5 == V_10 ) {
V_35 = F_21 ( V_2 , V_82 , 0x4FC0 | 0x24 ) ;
if ( V_35 < 0 )
return V_35 ;
} else if ( V_5 == V_96 ) {
V_35 = F_21 ( V_2 , V_97 , 0x3C02 ) ;
if ( V_35 < 0 )
return V_35 ;
V_35 = F_21 ( V_2 , V_82 , 0x4C40 | 0x24 ) ;
if ( V_35 < 0 )
return V_35 ;
} else {
return - V_98 ;
...
V_2 -> V_11 = V_107 ;
V_2 -> V_21 = V_108 ;
V_2 -> V_109 = F_31 ( 1 , 29 , 16 ) ;
V_2 -> V_110 = F_31 ( 24 , 6 , 5 ) ;
V_2 -> V_111 = F_1 ( V_2 ) ;
V_2 -> V_112 = V_113 ;
V_2 -> V_114 = V_115 ;
V_2 -> V_116 = V_117 ;
