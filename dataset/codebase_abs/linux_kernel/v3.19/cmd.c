...
if ( ! V_37 -> V_41 . V_300 ) {
V_37 -> V_41 . V_300 = F_111 ( L_42 , V_35 -> V_71 ,
V_180 ,
V_180 , 0 ) ;
if ( ! V_37 -> V_41 . V_300 )
goto V_49;
...
void F_112 ( struct V_34 * V_35 , int V_302 )
{
struct V_36 * V_37 = V_36 ( V_35 ) ;
if ( V_37 -> V_41 . V_300 && ( V_302 & V_301 ) ) {
F_114 ( V_37 -> V_41 . V_300 ) ;
V_37 -> V_41 . V_300 = NULL ;
}
if ( ! F_109 ( V_35 ) && V_37 -> V_41 . V_72 &&
( V_302 & V_298 ) ) {
...
if ( V_37 -> V_41 . V_294 && ( V_302 & V_295 ) )
V_37 -> V_41 . V_294 = 0 ;
}
...
int V_124 ;
int V_49 = 0 ;
V_37 -> V_41 . V_59 = F_116 ( V_37 -> V_41 . V_303 *
sizeof ( struct V_58 ) ,
V_158 ) ;
if ( ! V_37 -> V_41 . V_59 )
return - V_16 ;
for ( V_124 = 0 ; V_124 < V_37 -> V_41 . V_303 ; ++ V_124 ) {
V_37 -> V_41 . V_59 [ V_124 ] . V_63 = V_124 ;
V_37 -> V_41 . V_59 [ V_124 ] . V_65 = V_124 + 1 ;
}
V_37 -> V_41 . V_59 [ V_37 -> V_41 . V_303 - 1 ] . V_65 = - 1 ;
V_37 -> V_41 . V_62 = 0 ;
F_108 ( & V_37 -> V_41 . V_60 , V_37 -> V_41 . V_303 ) ;
F_99 ( & V_37 -> V_41 . V_61 ) ;
for ( V_37 -> V_41 . V_64 = 1 ;
V_37 -> V_41 . V_64 < V_37 -> V_41 . V_303 ;
V_37 -> V_41 . V_64 <<= 1 )
;
-- V_37 -> V_41 . V_64 ;
F_13 ( & V_37 -> V_41 . V_51 ) ;
...
{
struct V_117 * V_304 ;
V_304 = F_116 ( sizeof *V_304 , V_158 ) ;
if ( ! V_304 )
return F_118 ( - V_16 ) ;
V_304 -> V_122 = F_119 ( V_36 ( V_35 ) -> V_41 . V_300 , V_158 ,
& V_304 -> V_126 ) ;
if ( ! V_304 -> V_122 ) {
F_59 ( V_304 ) ;
return F_118 ( - V_16 ) ;
}
memset ( V_304 -> V_122 , 0 , V_180 ) ;
return V_304 ;
}
...
if ( ! V_304 )
return;
F_120 ( V_36 ( V_35 ) -> V_41 . V_300 , V_304 -> V_122 , V_304 -> V_126 ) ;
F_59 ( V_304 ) ;
}
T_2 F_86 ( void )
{
return ( ( T_2 ) V_305 << 8 ) | ( T_2 ) V_306 ;
}
static int F_121 ( struct V_34 * V_35 , int V_134 )
{
if ( ( V_134 < 0 ) || ( V_134 >= V_35 -> V_307 ) ) {
F_24 ( V_35 , L_43 , V_134 , V_35 -> V_307 ) ;
return - V_8 ;
}
return V_134 + 1 ;
}
...
if ( V_134 < 0 )
return V_216 ;
F_125 ( V_216 . V_218 , V_35 -> V_308 [ V_134 ] . V_217 - 1 ,
F_126 ( ( int ) V_35 -> V_308 [ F_122 ( V_35 , V_108 ) ] . V_309 ,
V_35 -> V_95 . V_157 ) ) ;
return V_216 ;
}
...
unsigned V_311 = F_78 ( V_216 . V_218 , V_35 -> V_95 . V_157 ) ;
if ( V_114 <= 0 || V_114 > V_311 )
return - V_8 ;
V_310 = F_77 ( V_216 . V_218 , V_35 -> V_95 . V_157 ) ;
if ( V_114 <= V_310 )
V_114 = V_310 + 1 ;
return V_114 ;
}
...
struct V_312 F_129 ( struct V_34 * V_35 ,
int V_114 )
{
unsigned V_124 ;
struct V_312 V_313 ;
F_123 ( V_313 . V_314 , V_315 ) ;
if ( V_114 <= 0 || V_114 > V_35 -> V_95 . V_157 )
return V_313 ;
for ( V_124 = 0 ; V_124 < V_35 -> V_307 + 1 ; V_124 ++ ) {
struct V_215 V_216 =
F_76 ( V_35 , V_124 ) ;
if ( F_79 ( V_114 - 1 , V_216 . V_218 ) )
F_130 ( V_124 , V_313 . V_314 ) ;
}
return V_313 ;
}
struct V_312 F_131 (
struct V_34 * V_35 ,
const struct V_215 * V_316 )
{
unsigned V_124 ;
struct V_312 V_313 ;
F_123 ( V_313 . V_314 , V_315 ) ;
...
struct V_215 V_216 =
F_76 ( V_35 , V_124 ) ;
if ( F_132 ( V_316 -> V_218 , V_216 . V_218 ,
V_35 -> V_95 . V_157 ) )
F_130 ( V_124 , V_313 . V_314 ) ;
}
return V_313 ;
...
V_317 = & V_37 -> V_38 . V_163 . V_195 [ V_108 ] . V_194 [ V_114 ] ;
V_317 -> V_224 = V_224 ;
F_135 ( V_35 , L_45 ,
V_134 , V_114 , V_317 -> V_224 ) ;
return 0 ;
}
int F_136 ( struct V_34 * V_35 , int V_114 , int V_134 , T_3 V_319 , T_1 V_210 )
{
struct V_36 * V_37 = V_36 ( V_35 ) ;
struct V_187 * V_195 ;
int V_108 ;
if ( ( ! F_36 ( V_35 ) ) ||
! ( V_35 -> V_95 . V_200 & V_320 ) )
return - V_318 ;
if ( ( V_319 > 4095 ) || ( V_210 > 7 ) )
return - V_8 ;
V_108 = F_121 ( V_35 , V_134 ) ;
if ( V_108 < 0 )
return - V_8 ;
...
int F_138 ( struct V_34 * V_35 , int V_114 , int V_134 , bool V_321 )
{
struct V_36 * V_37 = V_36 ( V_35 ) ;
struct V_187 * V_317 ;
int V_108 ;
if ( ( ! F_36 ( V_35 ) ) ||
! ( V_35 -> V_95 . V_200 & V_322 ) )
return - V_318 ;
V_108 = F_121 ( V_35 , V_134 ) ;
if ( V_108 < 0 )
return - V_8 ;
...
int F_139 ( struct V_34 * V_35 , int V_114 , int V_134 , struct V_323 * V_324 )
{
struct V_36 * V_37 = V_36 ( V_35 ) ;
struct V_187 * V_317 ;
int V_108 ;
...
V_317 = & V_37 -> V_38 . V_163 . V_195 [ V_108 ] . V_194 [ V_114 ] ;
V_324 -> V_134 = V_134 ;
V_324 -> V_224 [ 0 ] = ( ( V_317 -> V_224 >> ( 5 * 8 ) ) & 0xff ) ;
V_324 -> V_224 [ 1 ] = ( ( V_317 -> V_224 >> ( 4 * 8 ) ) & 0xff ) ;
V_324 -> V_224 [ 2 ] = ( ( V_317 -> V_224 >> ( 3 * 8 ) ) & 0xff ) ;
V_324 -> V_224 [ 3 ] = ( ( V_317 -> V_224 >> ( 2 * 8 ) ) & 0xff ) ;
V_324 -> V_224 [ 4 ] = ( ( V_317 -> V_224 >> ( 1 * 8 ) ) & 0xff ) ;
V_324 -> V_224 [ 5 ] = ( ( V_317 -> V_224 ) & 0xff ) ;
V_324 -> V_319 = V_317 -> V_196 ;
V_324 -> V_210 = V_317 -> V_197 ;
V_324 -> V_325 = V_317 -> V_326 ;
V_324 -> V_327 = 0 ;
V_324 -> V_222 = V_317 -> V_222 ;
V_324 -> V_328 = V_317 -> V_198 ;
return 0 ;
}
...
V_337 < 0 || V_337 > 1 )
return - V_8 ;
V_37 -> V_38 . V_163 . V_195 [ V_108 ] . V_221 [ V_114 ] = V_337 ;
return 0 ;
}
