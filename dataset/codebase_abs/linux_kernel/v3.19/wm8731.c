...
V_23 = F_32 ( V_6 -> V_2 , F_5 ( V_8 -> V_82 ) ,
V_8 -> V_82 ) ;
if ( V_23 != 0 ) {
...
struct V_7 * V_8 ;
int V_23 ;
V_8 = F_37 ( & V_96 -> V_2 , sizeof( * V_8 ) , V_97 ) ;
if ( V_8 == NULL )
return - V_98 ;
F_38 ( & V_8 -> V_25 ) ;
V_8 -> V_83 = F_39 ( V_96 , & V_99 ) ;
if ( F_40 ( V_8 -> V_83 ) ) {
V_23 = F_41 ( V_8 -> V_83 ) ;
F_33 ( & V_96 -> V_2 , L_5 ,
V_23 ) ;
...
struct V_7 * V_8 ;
int V_23 ;
V_8 = F_37 ( & V_103 -> V_2 , sizeof( struct V_7 ) ,
V_97 ) ;
if ( V_8 == NULL )
return - V_98 ;
F_38 ( & V_8 -> V_25 ) ;
V_8 -> V_83 = F_47 ( V_103 , & V_99 ) ;
if ( F_40 ( V_8 -> V_83 ) ) {
V_23 = F_41 ( V_8 -> V_83 ) ;
F_33 ( & V_103 -> V_2 , L_5 ,
V_23 ) ;
...
& V_100 , & V_101 , 1 ) ;
if ( V_23 != 0 ) {
F_33 ( & V_103 -> V_2 , L_6 , V_23 ) ;
return V_23 ;
}
return 0 ;
}
static int F_49 ( struct V_102 * V_106 )
{
F_45 ( & V_106 -> V_2 ) ;
return 0 ;
}
