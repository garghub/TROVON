...
V_49 = V_5 -> V_11 [ V_6 ] . V_49 ;
V_48 -> V_55 ( V_49 ) ;
if ( V_52 )
goto V_54;
}
V_52 = F_11 ( V_3 -> V_56 [ V_51 ] , V_57 ,
V_58 , 0 , V_50 , 0 ) ;
if ( V_52 )
goto V_54;
V_52 = F_5 ( V_3 ,
...
V_52 = F_11 ( V_3 -> V_56 [ V_51 ] , V_57 ,
V_76 , V_69 ) ;
if ( ! V_52 && ( V_3 -> V_77 != NULL ) ) {
V_52 = F_11 ( V_3 -> V_77 , V_57 ,
V_76 , V_69 ) ;
}
if ( ! V_52 ) {
struct V_60 * V_61 = V_3 -> V_61 ;
...
! V_5 -> V_120 . V_14 [ 0 ] ||
! V_5 -> V_8 . V_14 [ 0 ] ) {
F_35 ( V_90 -> V_87 . V_107 , L_24
L_25 ) ;
return V_52 ;
}
V_3 = F_48 ( sizeof( * V_3 ) , V_113 ) ;
if ( V_3 == NULL ) {
F_35 ( V_90 -> V_87 . V_107 , L_26
L_27 ) ;
return - V_112 ;
}
V_3 -> V_5 = V_5 ;
