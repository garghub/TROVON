...
if ( V_513 >= 16 ) {
if ( ! F_276 ( & V_10 -> V_9 , V_513 - 16 ) )
return 1 ;
V_97 = F_257 ( & V_10 -> V_9 , V_308 ) ;
F_277 ( & V_10 -> V_9 , V_513 - 16 , V_97 ) ;
} else {
if ( ! F_276 ( & V_10 -> V_9 , V_513 ) )
return 1 ;
F_278 ( & V_10 -> V_9 , V_513 , & V_97 ) ;
F_113 ( & V_10 -> V_9 , V_308 , V_97 ) ;
}
F_31 ( & V_10 -> V_9 ) ;
return 1 ;
...
static T_2 F_281 ( struct V_8 * V_9 , T_2 V_516 )
{
struct V_1 * V_1 = F_8 ( F_4 ( V_9 ) ) ;
return V_1 -> V_2 . V_200 +
F_96 ( V_9 , V_516 ) ;
}
static int F_282 ( struct V_8 * V_9 , unsigned V_517 , T_2 * V_518 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
switch ( V_517 ) {
case V_519 : {
...
static int F_287 ( struct V_8 * V_9 , T_2 V_518 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
int V_537 , V_538 ;
if ( V_518 & ~ V_539 )
...
static int F_288 ( struct V_8 * V_9 , struct V_542 * V_42 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
...
break;
case V_534 :
return F_287 ( V_9 , V_518 ) ;
case V_546 :
F_290 ( V_9 , L_15 , V_517 , V_518 ) ;
break;
default:
return F_291 ( V_9 , V_42 ) ;
}
return 0 ;
}
...
static void F_306 ( struct V_8 * V_9 , T_2 * V_552 , T_2 * V_553 )
{
...
if ( F_7 ( V_9 ) ) {
int V_417 ;
F_308 ( V_10 -> V_1 -> V_58 . V_84 , V_407 ,
V_10 -> V_1 -> V_2 . V_371 ,
V_10 -> V_1 -> V_2 . V_369 ,
V_10 -> V_1 -> V_2 . V_449 ,
V_10 -> V_1 -> V_2 . V_450 ,
...
static void F_313 ( struct V_7 * V_10 )
{
int V_140 = F_53 () ;
struct V_113 * V_114 = F_56 ( V_123 , V_140 ) ;
...
static inline void F_315 ( struct V_7 * V_10 , int V_562 )
{
struct V_11 * V_2 ;
V_2 = & V_10 -> V_1 -> V_2 ;
V_2 -> V_448 = V_562 ;
...
struct V_7 * V_10 = F_4 ( V_9 ) ;
F_72 ( ! ( F_20 ( V_10 ) ) ) ;
F_317 ( V_9 -> V_39 . V_565 . V_78 ) ;
++ V_9 -> V_301 . V_566 ;
V_10 -> V_1 -> V_2 . V_90 = V_9 -> V_39 . V_565 . V_78 |
V_63 | V_64 ;
}
static void F_318 ( struct V_8 * V_9 , int V_567 , int V_568 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
...
static void F_319 ( struct V_8 * V_9 , bool V_569 )
{
return;
}
static int F_320 ( struct V_278 * V_278 )
{
return 0 ;
}
static void F_321 ( struct V_8 * V_9 , T_2 * V_570 )
{
return;
}
static void F_322 ( struct V_278 * V_278 , int V_571 )
{
return;
}
...
static void F_326 ( struct V_8 * V_9 , bool V_572 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
if ( V_572 ) {
V_10 -> V_9 . V_39 . V_40 |= V_560 ;
...
F_336 ( & V_10 -> V_9 , V_577 , V_96 ) ;
} else
F_337 ( & V_10 -> V_9 , V_577 ) ;
break;
case V_495 :
F_338 ( & V_10 -> V_9 , V_577 , false ) ;
break;
default:
break;
}
...
static void
F_348 ( struct V_8 * V_9 , unsigned char * V_586 )
{
V_586 [ 0 ] = 0x0f ;
V_586 [ 1 ] = 0x01 ;
V_586 [ 2 ] = 0xd9 ;
}
static void F_349 ( void * V_587 )
{
* ( int * ) V_587 = 0 ;
}
...
static T_2 F_351 ( struct V_8 * V_9 , T_11 V_588 , bool V_589 )
{
return 0 ;
}
...
static void F_353 ( T_1 V_590 , struct V_591 * V_592 )
{
switch ( V_590 ) {
case 0x80000001 :
if ( V_17 )
...
{
return F_365 ( & V_629 , sizeof( struct V_7 ) ,
F_366 ( struct V_7 ) , V_630 ) ;
}
