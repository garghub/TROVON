...
if ( F_13 ( & V_14 -> V_35 [ V_23 ] ) )
continue;
V_25 = F_14 ( F_1 ( & V_14 -> V_35 [ V_23 ] ) ,
struct V_10 , V_36 ) ;
...
F_7 ( & V_14 -> V_17 ) ;
if ( ! V_22 )
V_22 = V_21 ( V_6 , 0 , 0 , F_18 ( V_23 , V_24 ) , V_20 ) ;
else
F_19 ( V_26 ) ;
V_31:
return V_22 ;
...
F_30 (e, tmp, &vpci_dev->dev_list[slot],
list) {
struct V_4 * V_12 = V_39 -> V_12 ;
F_21 ( & V_39 -> V_36 ) ;
F_22 ( & V_12 -> V_12 ) ;
F_23 ( V_12 ) ;
F_24 ( & V_12 -> V_12 ) ;
...
static int F_31 ( struct V_4 * V_41 ,
struct V_5 * V_6 ,
