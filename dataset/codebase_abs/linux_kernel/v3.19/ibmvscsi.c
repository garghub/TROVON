...
static int F_123 ( struct V_161 * V_257 , int V_264 )
{
if ( V_264 > V_265 )
V_264 = V_265 ;
return F_124 ( V_257 , V_264 ) ;
}
...
static int F_142 ( struct V_12 * V_13 , const struct V_276 * V_162 )
{
struct V_3 * V_4 ;
struct V_258 * V_118 ;
...
V_4 -> V_286 = F_148 ( F_139 , V_4 , L_81 ,
L_8 , V_118 -> V_287 ) ;
if ( F_149 ( V_4 -> V_286 ) ) {
F_39 ( & V_13 -> V_5 , L_82 ,
F_150 ( V_4 -> V_286 ) ) ;
