...
if ( type != V_385 )
return - 1 ;
if ( ( V_393 = F_49 ( V_5 , type , V_10 , & V_24 ) ) == - 1 ) {
F_28 ( V_32 , L_8 ) ;
return - 1 ;
}
F_59 ( V_24 , V_393 , V_14 ) ;
F_60 ( & V_5 -> V_388 ) ;
return 0 ;
}
...
{
struct V_395 * V_396 = V_5 -> V_124 ;
struct V_397 * V_398 ;
struct V_19 * V_399 ;
int V_16 , V_17 ;
V_398 = & V_5 -> V_400 [ V_113 ] ;
F_5 (rep, &rep_enum->report_list, list)
for ( V_16 = 0 ; V_16 < V_399 -> V_23 ; V_16 ++ ) {
if ( V_399 -> V_24 [ V_16 ] -> V_122 < 1 )
continue;
for ( V_17 = 0 ; V_17 < V_399 -> V_24 [ V_16 ] -> V_25 ; V_17 ++ ) {
F_23 ( V_5 , V_113 , V_399 -> V_24 [ V_16 ] ) ;
if ( V_396 -> V_401 )
V_396 -> V_401 ( V_5 , V_399 -> V_24 [ V_16 ] ,
V_399 -> V_24 [ V_16 ] -> V_2 + V_17 ) ;
}
}
}
...
for ( V_16 = 0 ; V_16 < F_74 ( V_413 ) ; V_16 ++ )
V_412 |= V_116 -> V_117 -> V_130 [ V_16 ] ;
for ( V_16 = 0 ; V_16 < F_74 ( V_414 ) ; V_16 ++ )
V_412 |= V_116 -> V_117 -> V_37 [ V_16 ] ;
for ( V_16 = 0 ; V_16 < F_74 ( V_415 ) ; V_16 ++ )
V_412 |= V_116 -> V_117 -> V_416 [ V_16 ] ;
for ( V_16 = 0 ; V_16 < F_74 ( V_417 ) ; V_16 ++ )
V_412 |= V_116 -> V_117 -> V_374 [ V_16 ] ;
for ( V_16 = 0 ; V_16 < F_74 ( V_418 ) ; V_16 ++ )
V_412 |= V_116 -> V_117 -> V_215 [ V_16 ] ;
for ( V_16 = 0 ; V_16 < F_74 ( V_419 ) ; V_16 ++ )
V_412 |= V_116 -> V_117 -> V_420 [ V_16 ] ;
for ( V_16 = 0 ; V_16 < F_74 ( V_421 ) ; V_16 ++ )
V_412 |= V_116 -> V_117 -> V_422 [ V_16 ] ;
for ( V_16 = 0 ; V_16 < F_74 ( V_423 ) ; V_16 ++ )
V_412 |= V_116 -> V_117 -> V_424 [ V_16 ] ;
for ( V_16 = 0 ; V_16 < F_74 ( V_425 ) ; V_16 ++ )
V_412 |= V_116 -> V_117 -> V_426 [ V_16 ] ;
return ! ! V_412 ;
}
...
int F_77 ( struct V_12 * V_5 , unsigned int V_428 )
{
struct V_395 * V_396 = V_5 -> V_124 ;
struct V_19 * V_20 ;
...
F_79 ( & V_5 -> V_388 , F_52 ) ;
if ( ! V_428 ) {
for ( V_16 = 0 ; V_16 < V_5 -> V_429 ; V_16 ++ ) {
struct V_430 * V_431 = & V_5 -> V_432 [ V_16 ] ;
if ( V_431 -> type == V_433 ||
V_431 -> type == V_434 )
if ( F_80 ( V_431 -> V_2 ) )
break;
