...
static struct V_240 *
F_87 ( struct V_1 * V_2 , struct V_420 * V_421 ,
unsigned int V_422 , enum V_423 V_424 )
{
if ( V_424 == V_425 )
return F_88 ( V_421 , V_422 ) ;
else
return & V_2 -> V_242 [ V_422 ] ;
}
static struct V_426 *
F_89 ( struct V_1 * V_2 , struct V_420 * V_421 ,
enum V_423 V_424 )
{
if ( V_424 == V_425 )
return F_90 ( V_421 , V_243 ) ;
else
return & V_2 -> V_245 ;
}
static void F_91 ( struct V_1 * V_2 ,
struct V_420 * V_421 , unsigned int V_422 ,
struct V_240 * V_427 ,
enum V_423 V_424 )
{
T_2 V_212 ;
...
case V_243 :
if ( V_2 -> V_283 == V_284 ) {
V_427 -> V_229 = F_92 ( T_2 , V_427 -> V_229 , V_428 ,
F_61 ( V_2 ) ) ;
V_427 -> V_251 = F_92 ( T_2 , V_427 -> V_251 ,
V_429 ,
V_430 ) ;
}
V_427 -> V_431 = V_432 ;
for ( V_10 = 0 ; V_10 < F_37 ( V_433 ) ; V_10 ++ ) {
if ( V_427 -> V_252 == V_433 [ V_10 ] )
break;
}
if ( V_10 >= F_37 ( V_433 ) )
V_427 -> V_252 = V_434 ;
...
case V_373 :
V_212 = V_427 -> V_252 ;
* V_427 = * F_87 ( V_2 , V_421 , V_243 , V_424 ) ;
switch ( V_212 ) {
case V_215 :
case V_217 :
V_427 -> V_252 = V_212 ;
...
V_245 = F_89 ( V_2 , V_421 , V_424 ) ;
V_427 -> V_229 = V_245 -> V_229 ;
V_427 -> V_251 = V_245 -> V_251 ;
V_427 -> V_431 = V_435 ;
break;
}
V_427 -> V_436 = V_437 ;
...
const struct V_240 * V_438 ,
struct V_426 * V_245 )
{
unsigned int V_246 = V_439 ;
unsigned int V_440 = V_438 -> V_229 - V_441 ;
unsigned int V_249 = V_442 ;
unsigned int V_443 = V_438 -> V_251 - V_444 ;
if ( V_2 -> V_283 == V_371 ) {
V_246 += 2 ;
V_440 -= 2 ;
}
if ( V_438 -> V_252 != V_253 &&
V_438 -> V_252 != V_254 ) {
V_246 += 2 ;
V_440 -= 2 ;
V_249 += 2 ;
...
V_245 -> V_246 &= ~ 1 ;
V_245 -> V_249 &= ~ 1 ;
V_245 -> V_246 = F_92 ( T_2 , V_245 -> V_246 , V_246 , V_440 - V_445 ) ;
V_245 -> V_249 = F_92 ( T_2 , V_245 -> V_249 , V_249 , V_443 - V_446 ) ;
V_245 -> V_229 = F_92 ( T_2 , V_245 -> V_229 , V_445 ,
V_440 - V_245 -> V_246 ) ;
V_245 -> V_251 = F_92 ( T_2 , V_245 -> V_251 , V_446 ,
V_443 - V_245 -> V_249 ) ;
}
...
switch ( V_252 -> V_422 ) {
case V_243 :
if ( V_252 -> V_448 >= F_37 ( V_433 ) )
return - V_449 ;
V_252 -> V_252 = V_433 [ V_252 -> V_448 ] ;
break;
case V_373 :
if ( V_252 -> V_448 >= F_37 ( V_450 ) )
return - V_449 ;
V_252 -> V_252 = V_450 [ V_252 -> V_448 ] ;
break;
default:
return - V_449 ;
}
...
if ( V_452 -> V_448 != 0 )
return - V_449 ;
V_241 . V_252 = V_452 -> V_252 ;
V_241 . V_229 = 1 ;
V_241 . V_251 = 1 ;
F_91 ( V_2 , V_421 , V_452 -> V_422 , & V_241 , V_425 ) ;
V_452 -> V_453 = V_241 . V_229 ;
V_452 -> V_454 = V_241 . V_251 ;
if ( V_241 . V_252 != V_452 -> V_252 )
return - V_449 ;
V_241 . V_252 = V_452 -> V_252 ;
V_241 . V_229 = - 1 ;
V_241 . V_251 = - 1 ;
F_91 ( V_2 , V_421 , V_452 -> V_422 , & V_241 , V_425 ) ;
V_452 -> V_455 = V_241 . V_229 ;
V_452 -> V_456 = V_241 . V_251 ;
return 0 ;
}
...
struct V_1 * V_2 = F_78 ( V_410 ) ;
struct V_240 * V_241 ;
if ( V_458 -> V_422 != V_243 )
return - V_449 ;
switch ( V_458 -> V_459 ) {
case V_460 :
V_458 -> V_461 . V_246 = 0 ;
V_458 -> V_461 . V_249 = 0 ;
V_458 -> V_461 . V_229 = V_462 ;
V_458 -> V_461 . V_251 = V_462 ;
V_241 = F_87 ( V_2 , V_421 , V_243 ,
V_458 -> V_424 ) ;
F_93 ( V_2 , V_241 , & V_458 -> V_461 ) ;
break;
case V_463 :
V_458 -> V_461 = * F_89 ( V_2 , V_421 , V_458 -> V_424 ) ;
break;
default:
return - V_449 ;
}
...
struct V_1 * V_2 = F_78 ( V_410 ) ;
struct V_240 * V_241 ;
if ( V_458 -> V_459 != V_463 ||
V_458 -> V_422 != V_243 )
return - V_449 ;
if ( V_2 -> V_382 != V_395 )
return - V_464 ;
if ( V_458 -> V_183 & V_465 ) {
V_458 -> V_461 = * F_89 ( V_2 , V_421 , V_458 -> V_424 ) ;
return 0 ;
}
V_241 = F_87 ( V_2 , V_421 , V_243 , V_458 -> V_424 ) ;
F_93 ( V_2 , V_241 , & V_458 -> V_461 ) ;
* F_89 ( V_2 , V_421 , V_458 -> V_424 ) = V_458 -> V_461 ;
V_241 = F_87 ( V_2 , V_421 , V_373 , V_458 -> V_424 ) ;
F_91 ( V_2 , V_421 , V_373 , V_241 , V_458 -> V_424 ) ;
return 0 ;
}
static int F_98 ( struct V_409 * V_410 , struct V_420 * V_421 ,
struct V_466 * V_427 )
{
struct V_1 * V_2 = F_78 ( V_410 ) ;
struct V_240 * V_241 ;
V_241 = F_87 ( V_2 , V_421 , V_427 -> V_422 , V_427 -> V_424 ) ;
if ( V_241 == NULL )
return - V_449 ;
V_427 -> V_241 = * V_241 ;
return 0 ;
}
static int F_99 ( struct V_409 * V_410 , struct V_420 * V_421 ,
struct V_466 * V_427 )
{
struct V_1 * V_2 = F_78 ( V_410 ) ;
struct V_240 * V_241 ;
...
if ( V_241 == NULL )
return - V_449 ;
F_91 ( V_2 , V_421 , V_427 -> V_422 , & V_427 -> V_241 , V_427 -> V_424 ) ;
* V_241 = V_427 -> V_241 ;
if ( V_427 -> V_422 == V_243 ) {
V_245 = F_89 ( V_2 , V_421 , V_427 -> V_424 ) ;
V_245 -> V_246 = 0 ;
V_245 -> V_249 = 0 ;
V_245 -> V_229 = V_427 -> V_241 . V_229 ;
V_245 -> V_251 = V_427 -> V_241 . V_251 ;
F_93 ( V_2 , & V_427 -> V_241 , V_245 ) ;
V_241 = F_87 ( V_2 , V_421 , V_373 ,
V_427 -> V_424 ) ;
F_91 ( V_2 , V_421 , V_373 , V_241 ,
V_427 -> V_424 ) ;
}
return 0 ;
}
...
V_241 . V_422 = V_243 ;
V_241 . V_424 = V_421 ? V_425 : V_467 ;
V_241 . V_241 . V_252 = V_434 ;
V_241 . V_241 . V_229 = 4096 ;
V_241 . V_241 . V_251 = 4096 ;
F_99 ( V_410 , V_421 , & V_241 ) ;
return 0 ;
}
static int F_101 ( struct V_468 * V_272 ,
const struct V_469 * V_470 ,
const struct V_469 * V_471 , T_2 V_183 )
{
struct V_409 * V_410 = F_102 ( V_272 ) ;
struct V_1 * V_2 = F_78 ( V_410 ) ;
switch ( V_470 -> V_448 | F_103 ( V_471 -> V_272 ) ) {
case V_243 | V_472 :
if ( V_183 & V_473 ) {
if ( V_2 -> V_283 == V_371 )
return - V_464 ;
...
{
int V_478 ;
V_478 = F_108 ( V_477 , & V_2 -> V_271 ) ;
if ( V_478 < 0 )
goto error;
V_478 = F_109 ( & V_2 -> V_390 , V_477 ) ;
if ( V_478 < 0 )
goto error;
V_478 = F_109 ( & V_2 -> V_384 , V_477 ) ;
if ( V_478 < 0 )
goto error;
return 0 ;
error:
...
struct V_469 * V_479 = V_2 -> V_479 ;
struct V_468 * V_480 = & V_410 -> V_272 ;
int V_478 ;
V_2 -> V_283 = V_474 ;
F_111 ( V_410 , & V_481 ) ;
V_410 -> V_482 = & V_483 ;
...
V_410 -> V_183 |= V_485 ;
F_114 ( & V_2 -> V_405 , 2 ) ;
F_115 ( & V_2 -> V_405 , & V_486 , V_407 ,
V_487 , V_488 ,
V_489 , V_336 ) ;
F_115 ( & V_2 -> V_405 , & V_486 , V_408 ,
V_490 , V_491 ,
V_492 , V_335 ) ;
F_116 ( & V_2 -> V_405 ) ;
V_410 -> V_493 = & V_2 -> V_405 ;
V_479 [ V_243 ] . V_183 = V_494
| V_495 ;
V_479 [ V_373 ] . V_183 = V_496 ;
V_480 -> V_497 = & V_498 ;
V_478 = F_117 ( V_480 , V_499 , V_479 , 0 ) ;
if ( V_478 < 0 )
return V_478 ;
F_100 ( V_410 , NULL ) ;
V_2 -> V_390 . type = V_400 ;
V_2 -> V_390 . V_497 = & V_500 ;
V_2 -> V_390 . V_6 = F_2 ( V_2 ) ;
V_2 -> V_390 . V_501 = F_118 ( 4096 * 4096 ) * 2 * 3 ;
V_2 -> V_390 . V_502 = 64 ;
V_2 -> V_384 . type = V_401 ;
V_2 -> V_384 . V_497 = & V_500 ;
V_2 -> V_384 . V_6 = F_2 ( V_2 ) ;
V_2 -> V_384 . V_501 = F_118 ( 4096 * 4096 ) * 2 * 3 ;
V_2 -> V_384 . V_502 = 32 ;
V_478 = F_119 ( & V_2 -> V_390 , L_6 ) ;
if ( V_478 < 0 )
goto V_503;
V_478 = F_119 ( & V_2 -> V_384 , L_6 ) ;
if ( V_478 < 0 )
goto V_504;
V_478 = F_120 ( & V_2 -> V_390 . V_399 . V_272 , 0 ,
& V_2 -> V_271 . V_272 , V_243 , 0 ) ;
if ( V_478 < 0 )
goto V_505;
V_478 = F_120 ( & V_2 -> V_271 . V_272 , V_373 ,
& V_2 -> V_384 . V_399 . V_272 , 0 , 0 ) ;
if ( V_478 < 0 )
goto V_505;
return 0 ;
V_505:
