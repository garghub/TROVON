...
static int F_51 ( struct V_1 * V_2 , struct V_16 * V_17 )
{
int V_136 ;
if ( ! F_50 ( V_2 , V_94 ) )
return - V_122 ;
...
return - V_122 ;
V_136 = F_44 ( V_2 , V_17 -> V_27 - 1 , V_17 -> V_24 , 0 ) ;
if ( V_136 < 0 )
V_136 = F_52 ( V_2 , V_17 ) ;
V_17 -> V_20 = F_19 ( V_136 ) - 1 ;
return 0 ;
}
static int F_53 ( struct V_1 * V_2 , struct V_16 * V_17 )
{
int V_131 ;
if ( ! F_50 ( V_2 , V_94 ) )
return - V_122 ;
...
static T_1 F_55 ( struct V_1 * V_2 , T_1 V_139 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
if ( ( V_139 & ( V_50 | V_39 ) )
!= V_139 )
...
static int F_57 ( struct V_1 * V_2 , struct V_16 * V_144 )
{
struct V_52 V_53 ;
struct V_3 * V_4 = F_2 ( V_2 ) ;
struct V_14 * V_15 = V_4 -> V_14 ;
...
if ( ! V_53 . V_56 . V_6 . V_22 . V_23 )
break;
V_144 [ V_18 ] . V_27 = V_53 . V_56 . V_6 . V_22 . V_28 ;
V_144 [ V_18 ] . V_24 =
...
static int F_58 ( struct V_1 * V_2 , struct V_145 * V_146 )
{
struct V_52 V_53 ;
struct V_3 * V_4 = F_2 ( V_2 ) ;
struct V_14 * V_15 = V_4 -> V_14 ;
...
V_146 -> V_147 [ 7 - V_18 ] = ( V_60 >> ( V_18 * 4 ) ) & 0xF ;
F_25 ( V_53 , V_4 -> V_12 ) ;
V_53 . V_56 . V_6 . V_75 . type = V_73 ;
V_19 = F_26 ( V_15 , V_15 -> V_100 , & V_53 , sizeof( V_53 ) , & V_53 ) ;
if ( V_19 != V_101 ) {
...
for ( V_18 = 0 ; V_18 < V_107 ; V_18 ++ )
V_146 -> V_148 [ V_18 ] = V_53 . V_56 . V_6 . V_75 . V_75 [ V_18 ] ;
return 0 ;
}
static int F_59 ( struct V_1 * V_2 , struct V_149 * V_85 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
F_40 ( V_2 , V_121 , & ( V_85 -> V_150 ) ) ;
V_85 -> V_151 = V_4 -> V_6 . V_84 ;
return 0 ;
}
