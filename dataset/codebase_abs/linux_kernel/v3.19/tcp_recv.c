...
F_3 ( L_8 ,
V_16 , V_43 , V_11 -> V_16 ,
F_29 ( & V_39 -> V_53 -> V_54 -> V_55 ) ) ;
return V_16 - V_43 ;
}
static int F_30 ( struct V_19 * V_20 , T_3 V_44 )
{
struct V_38 * V_39 = V_20 -> V_40 ;
...
V_33 . error = 0 ;
V_33 . V_58 = 1 ;
F_31 ( V_57 -> V_54 , & V_33 , F_19 ) ;
F_3 ( L_9 , V_39 , V_44 ,
V_33 . error ) ;
return V_33 . error ;
}
int F_32 ( struct V_19 * V_20 )
{
struct V_38 * V_39 = V_20 -> V_40 ;
struct V_56 * V_57 = V_39 -> V_53 ;
int V_12 = 0 ;
...
void F_35 ( struct V_57 * V_54 )
{
void (* F_36)( struct V_57 * V_54 );
struct V_19 * V_20 ;
struct V_38 * V_39 ;
F_3 ( L_11 , V_54 ) ;
F_37 ( & V_54 -> V_60 ) ;
...
F_36 = V_39 -> V_63 ;
F_38 ( V_64 ) ;
if ( F_30 ( V_20 , V_65 ) == - V_45 )
F_39 ( V_66 , & V_20 -> V_67 , 0 ) ;
V_13:
F_40 ( & V_54 -> V_60 ) ;
F_36 ( V_54 ) ;
}
