...
static void F_46 ( struct V_52 * V_13 )
{
F_47 ( V_13 ) ;
}
...
struct V_55 * V_9 = F_49 ( V_10 -> V_23 ) ;
int V_20 = 0 ;
...
static int F_51 ( struct V_54 * V_10 )
{
struct V_55 * V_61 = F_49 ( V_10 -> V_23 ) ;
struct V_8 * V_62 ;
int V_63 ;
if ( ! V_61 )
return - V_64 ;
V_62 = F_52 ( V_10 -> V_23 , sizeof( * V_62 ) ,
V_65 ) ;
V_62 -> V_16 = V_61 -> V_66 ;
F_53 ( V_10 , V_62 ) ;
for ( V_63 = 0 ; V_63 < V_67 ; V_63 ++ ) {
F_54 ( & V_62 -> V_13 [ V_63 ] . V_46 ) ;
F_55 ( & V_62 -> V_13 [ V_63 ] . V_28 , F_21 ) ;
}
return 0 ;
}
static int F_56 ( struct V_54 * V_10 )
{
return 0 ;
}
static int F_57 ( struct V_68 * V_23 )
{
struct V_55 * V_55 = F_49 ( V_23 ) ;
struct V_8 * V_62 = F_58 ( V_23 ) ;
int V_20 ;
F_3 ( V_23 , L_19 ) ;
V_20 = F_59 ( V_23 , V_55 ) ;
if ( V_20 < 0 ) {
...
static int F_60 ( struct V_68 * V_23 )
{
struct V_55 * V_55 = F_49 ( V_23 ) ;
int V_20 ;
F_3 ( V_23 , L_21 ) ;
...
if ( V_20 )
return V_20 ;
return F_62 ( V_23 , V_55 ) ;
}
static int F_63 ( struct V_69 * V_70 )
{
struct V_55 * V_55 = F_49 ( & V_70 -> V_23 ) ;
int V_20 ;
V_20 = F_64 ( & V_70 -> V_23 , V_55 ) ;
if ( V_20 < 0 )
return - V_64 ;
V_20 = F_65 ( & V_70 -> V_23 , & V_71 ) ;
if ( V_20 < 0 )
goto V_72;
V_20 = F_66 ( & V_70 -> V_23 , & V_73 ,
V_74 , F_67 ( V_74 ) ) ;
if ( V_20 < 0 )
goto V_75;
return 0 ;
