...
struct V_3 * V_4 ;
struct V_194 * V_195 ;
struct V_196 * V_34 = NULL , * V_35 = NULL ;
void T_2 * V_13 ;
int V_33 , V_116 ;
T_1 V_197 = 0 ;
if ( V_190 -> V_27 . V_198 )
F_79 ( V_190 -> V_27 . V_198 ,
L_13 , & V_197 ) ;
if ( ! V_197 ) {
V_34 = F_80 ( & V_190 -> V_27 , L_14 ) ;
if ( F_81 ( V_34 ) ) {
F_82 ( & V_190 -> V_27 , L_15 ) ;
return F_83 ( V_34 ) ;
}
V_35 = F_80 ( & V_190 -> V_27 , L_16 ) ;
if ( F_81 ( V_35 ) ) {
F_82 ( & V_190 -> V_27 , L_17 ) ;
return F_83 ( V_35 ) ;
}
V_197 = F_84 ( V_35 ) ;
}
V_195 = F_85 ( V_190 , V_199 , 0 ) ;
V_116 = F_86 ( V_190 , 0 ) ;
if ( V_116 <= 0 )
return - V_188 ;
V_13 = F_87 ( & V_190 -> V_27 , V_195 ) ;
if ( F_81 ( V_13 ) )
return F_83 ( V_13 ) ;
V_192 = F_88 ( V_200 , & V_190 -> V_27 ) ;
if ( V_192 ) {
V_156 = V_192 -> V_41 ;
} else if ( F_89 ( V_190 ) -> V_201 ) {
V_156 = (struct V_193 * )
F_89 ( V_190 ) -> V_201 ;
} else {
return - V_188 ;
...
V_4 -> V_34 = V_34 ;
V_4 -> V_35 = V_35 ;
V_4 -> V_213 = F_91 ( & V_190 -> V_27 ) ;
V_4 -> V_156 = V_156 ;
V_4 -> V_5 = F_92 ( & V_190 -> V_27 , L_18 ) ;
if ( F_81 ( V_4 -> V_5 ) )
V_4 -> V_5 = NULL ;
F_93 ( V_27 , & V_4 -> V_108 , F_46 , V_214 ) ;
F_94 ( V_190 , V_27 ) ;
F_95 ( V_27 , & V_190 -> V_27 ) ;
V_33 = F_73 ( V_27 ) ;
if ( V_33 ) {
F_82 ( & V_190 -> V_27 , L_19 ) ;
goto V_215;
}
F_96 ( V_27 ) ;
...
static int T_4 F_102 ( struct V_216 * V_216 )
{
struct V_26 * V_27 = F_103 ( V_216 ) ;
struct V_3 * V_4 = F_19 ( V_27 ) ;
int V_33 ;
V_33 = F_14 ( V_4 ) ;
if ( V_33 )
...
static int T_4 F_106 ( struct V_216 * V_216 )
{
struct V_26 * V_27 = F_103 ( V_216 ) ;
struct V_3 * V_4 = F_19 ( V_27 ) ;
V_4 -> V_7 . V_96 = V_91 ;
