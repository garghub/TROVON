...
V_116 = F_64 ( & V_6 -> V_161 [ V_159 ] ) ;
if ( V_116 ) {
V_116 = - V_160 ;
goto exit;
}
V_116 = F_65 ( V_6 , V_159 , V_162 . V_98 ) ;
if ( V_116 ) {
F_4 ( & V_6 -> V_6 , L_27
L_28 , V_2 -> V_158 ,
( unsigned long long ) F_66 ( V_6 , V_159 ) ) ;
goto exit;
}
...
F_6 ( F_2 ( F_26 ( V_2 ) ) &
~ ( V_84 | V_60 ) , F_26 ( V_2 ) ) ;
V_2 -> V_26 . V_18 = V_166 / 5 ;
if ( V_2 -> V_27 & V_28 ) {
T_2 V_167 , V_51 ;
F_22 ( V_2 -> V_5 , V_52 , & V_51 ) ;
if ( V_51 & V_53 )
F_15 ( & V_6 -> V_6 , L_31 ) ;
F_22 ( V_2 -> V_5 , V_168 , & V_167 ) ;
if ( V_167 & V_169 ) {
F_67 ( & V_6 -> V_6 , L_32 ) ;
V_2 -> V_27 &= ~ V_28 ;
}
...
if ( V_2 -> V_27 & V_28 ) {
F_68 ( & V_2 -> V_31 ) ;
V_116 = F_69 ( V_6 -> V_49 , F_21 , V_170 ,
V_162 . V_98 , V_2 ) ;
if ( V_116 ) {
F_4 ( & V_6 -> V_6 , L_33 ,
V_6 -> V_49 , V_116 ) ;
...
F_54 ( V_2 ) ;
F_77 ( & V_2 -> V_26 ) ;
F_29 ( V_6 , V_62 , V_2 -> V_163 ) ;
if ( V_2 -> V_27 & V_28 )
F_72 ( V_6 -> V_49 , V_2 ) ;
F_73 ( V_6 , V_159 ) ;
F_74 ( V_2 ) ;
}
static int F_78 ( struct V_5 * V_6 , T_9 V_173 )
{
struct V_1 * V_2 = F_76 ( V_6 ) ;
F_79 ( V_6 ) ;
F_29 ( V_6 , V_62 , V_2 -> V_163 ) ;
F_80 ( V_6 , F_81 ( V_6 , V_173 ) ) ;
return 0 ;
}
