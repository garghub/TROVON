...
void
F_70 ( struct V_31 * V_10 , int V_14 )
{
struct V_8 * V_9 = V_8 ( V_10 ) ;
if ( V_9 -> V_6 ) {
if ( V_14 == V_15 ) {
...
return 0 ;
V_6 = F_74 ( sizeof( struct V_5 ) , V_127 ) ;
if ( ! V_6 )
return - V_95 ;
F_75 ( & V_6 -> V_121 , F_67 ) ;
V_6 -> V_10 = V_10 ;
V_9 -> V_6 = V_6 ;
F_76 ( V_10 , & V_6 -> V_33 , & V_128 ) ;
V_13 = F_77 ( V_10 , & V_6 -> V_33 ,
V_10 -> V_123 . V_124 , 4 ) ;
if ( V_13 ) {
F_78 ( V_6 ) ;
return V_13 ;
