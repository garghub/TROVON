...
static void F_34 ( struct V_84 * V_85 , struct V_98 * V_7 )
{
struct V_5 * V_6 =
F_8 ( V_7 , struct V_5 , V_7 ) ;
struct V_87 * V_88 = V_85 -> V_89 ;
...
void F_37 ( struct V_1 * V_2 , int V_113 )
{
V_2 -> V_114 = V_113 ;
V_2 -> V_115 = F_38 ( V_113 ) -> V_116 ;
F_39 ( V_2 , V_113 ) ;
F_40 ( V_2 , V_117 , V_118 , F_38 ( V_113 ) -> V_119 , 0 , 0 ) ;
F_41 ( V_2 , V_2 -> V_115 ) ;
F_31 ( V_2 -> V_2 , L_17 , V_113 ) ;
F_42 ( V_2 ) ;
}
...
if ( V_156 >= V_157 )
return - V_105 ;
if ( 0 == F_38 ( V_156 ) -> type )
return - V_105 ;
V_8 -> V_113 = V_156 ;
V_8 -> type = V_158 ;
strcpy ( V_8 -> V_159 , V_160 [ F_38 ( V_156 ) -> type ] ) ;
if ( ( V_161 == F_38 ( V_156 ) -> type ) ||
( V_162 == F_38 ( V_156 ) -> type ) )
V_8 -> type = V_163 ;
...
return 0 ;
case 6 :
F_76 ( V_200 -> V_159 , L_31 , sizeof( V_200 -> V_159 ) ) ;
return 0 ;
}
return - V_105 ;
}
...
struct V_87 * V_88 = V_127 ;
struct V_1 * V_2 = V_88 -> V_2 ;
F_76 ( V_224 -> V_226 , L_32 , sizeof( V_224 -> V_226 ) ) ;
...
static int F_127 ( struct V_126 * V_267 )
{
...
static int F_139 ( struct V_126 * V_267 )
{
struct V_87 * V_88 = V_267 -> V_277 ;
struct V_1 * V_2 = V_88 -> V_2 ;
int V_101 ;
...
static T_4
F_141 ( struct V_126 * V_267 , char T_5 * V_6 , T_6 V_86 ,
T_7 * V_73 )
{
struct V_87 * V_88 = V_267 -> V_277 ;
struct V_1 * V_2 = V_88 -> V_2 ;
...
if ( F_110 ( & V_2 -> V_275 ) )
return - V_276 ;
V_101 = F_142 ( & V_88 -> V_144 , V_6 , V_86 , V_73 , 0 ,
V_267 -> V_264 & V_265 ) ;
F_118 ( & V_2 -> V_275 ) ;
return V_101 ;
}
...
static unsigned int F_143 ( struct V_126 * V_267 , T_8 * V_301 )
{
unsigned long V_302 = F_144 ( V_301 ) ;
struct V_87 * V_88 = V_267 -> V_277 ;
struct V_1 * V_2 = V_88 -> V_2 ;
unsigned V_303 = 0 ;
int V_101 ;
...
F_146 ( V_267 , & V_88 -> V_88 . V_301 , V_301 ) ;
if ( ! ( V_302 & ( V_306 | V_307 ) ) )
return V_303 ;
if ( ( V_121 == V_88 -> type ) ||
( V_123 == V_88 -> type ) ) {
F_140 ( & V_2 -> V_275 ) ;
V_303 |= F_147 ( V_267 , & V_88 -> V_144 , V_301 ) ;
F_118 ( & V_2 -> V_275 ) ;
return V_303 ;
}
return V_303 | V_304 ;
}
static int F_148 ( struct V_126 * V_267 , struct V_308 * V_309 )
{
struct V_87 * V_88 = V_267 -> V_277 ;
struct V_1 * V_2 = V_88 -> V_2 ;
int V_101 ;
...
static struct V_225 * F_150 ( struct V_1 * V_2 ,
const struct V_225
...
snprintf ( V_314 -> V_159 , sizeof( V_314 -> V_159 ) , L_40 , V_2 -> V_159 , V_313 ) ;
F_152 ( V_314 , V_2 ) ;
if ( V_2 -> V_188 == V_241 ) {
F_153 ( V_314 , V_319 ) ;
F_153 ( V_314 , V_320 ) ;
...
V_2 -> V_165 = F_150 ( V_2 , & V_328 , L_42 ) ;
if ( ! V_2 -> V_165 ) {
F_47 ( V_2 -> V_2 , L_43 ) ;
return - V_125 ;
}
V_2 -> V_165 -> V_290 = & V_2 -> V_290 ;
V_155 = F_157 ( V_2 -> V_165 , V_270 ,
V_329 [ V_2 -> V_330 ] ) ;
if ( V_155 ) {
F_47 ( V_2 -> V_2 ,
L_44 ,
...
F_108 ( V_2 -> V_165 ) ) ;
V_331 = V_328 ;
strcpy ( V_331 . V_159 , L_46 ) ;
V_2 -> V_288 = F_150 ( V_2 , & V_331 , L_47 ) ;
if ( ! V_2 -> V_288 ) {
F_47 ( V_2 -> V_2 , L_43 ) ;
return - V_125 ;
}
V_2 -> V_288 -> V_290 = & V_2 -> V_290 ;
V_155 = F_157 ( V_2 -> V_288 , V_238 ,
V_332 [ V_2 -> V_330 ] ) ;
if ( V_155 < 0 ) {
F_47 ( V_2 -> V_2 , L_48 ) ;
return V_155 ;
