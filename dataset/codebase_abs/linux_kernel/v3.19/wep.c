...
int F_21 ( struct V_31 * V_32 , T_2 * V_33 ,
...
if ( F_4 ( V_32 ) )
return - 1 ;
V_36 = F_22 ( ~ F_23 ( ~ 0 , V_17 , V_35 ) ) ;
F_24 ( V_36 , ( T_4 * ) ( V_17 + V_35 ) ) ;
F_25 ( V_32 , V_33 , V_34 ) ;
for ( V_37 = 0 ; V_37 < V_35 + V_24 ; V_37 ++ )
F_26 ( V_32 , V_17 + V_37 , V_17 + V_37 ) ;
return 0 ;
}
...
F_28 ( V_14 , V_24 ) ;
return F_21 ( V_2 -> V_5 , V_33 , V_10 + 3 ,
V_9 + V_4 , V_38 ) ;
}
int F_29 ( struct V_31 * V_32 , T_2 * V_33 ,
T_3 V_34 , T_2 * V_17 , T_3 V_35 )
{
T_4 V_40 ;
int V_37 ;
...
F_25 ( V_32 , V_33 , V_34 ) ;
for ( V_37 = 0 ; V_37 < V_35 + V_24 ; V_37 ++ )
F_30 ( V_32 , V_17 + V_37 , V_17 + V_37 ) ;
V_40 = F_22 ( ~ F_23 ( ~ 0 , V_17 , V_35 ) ) ;
...
if ( F_29 ( V_2 -> V_7 , V_33 , V_34 ,
V_14 -> V_17 + V_20 +
V_4 , V_38 ) )
V_41 = - 1 ;
F_33 ( V_14 , V_14 -> V_38 - V_24 ) ;
memmove ( V_14 -> V_17 + V_4 , V_14 -> V_17 , V_20 ) ;
F_20 ( V_14 , V_4 ) ;
return V_41 ;
}
...
if ( F_38 ( V_44 -> V_14 ) )
return V_51 ;
if ( F_31 ( V_44 -> V_2 , V_44 -> V_14 , V_44 -> V_30 ) )
return V_51 ;
} else if ( ! ( V_46 -> V_49 & V_52 ) ) {
if ( ! F_39 ( V_44 -> V_14 , F_17 ( V_47 ) +
V_4 ) )
return V_51 ;
F_19 ( V_44 -> V_2 , V_44 -> V_14 , V_44 -> V_30 ) ;
if ( F_40 ( V_44 -> V_14 , V_44 -> V_14 -> V_38 - V_24 ) )
return V_51 ;
}
return V_48 ;
}
static int F_41 ( struct V_53 * V_54 , struct V_13 * V_14 )
{
struct V_18 * V_19 = F_12 ( V_14 ) ;
struct V_55 * V_26 = V_19 -> V_25 . V_26 ;
if ( ! V_26 ) {
if ( F_27 ( V_54 -> V_2 , V_14 , V_54 -> V_30 -> V_42 . V_30 ,
V_54 -> V_30 -> V_42 . V_10 ,
V_54 -> V_30 -> V_42 . V_12 ) )
return - 1 ;
} else if ( ( V_26 -> V_27 & V_56 ) ||
( V_26 -> V_27 & V_28 ) ) {
if ( ! F_11 ( V_54 -> V_2 , V_14 ,
V_54 -> V_30 -> V_42 . V_10 ,
V_54 -> V_30 -> V_42 . V_12 ) )
return - 1 ;
}
