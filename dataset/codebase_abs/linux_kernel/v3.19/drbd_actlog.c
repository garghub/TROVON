...
return 0 ;
if ( V_30 <= 0 || ! F_97 ( V_30 , 512 ) || V_30 > V_182 ) {
F_14 ( V_2 , L_20 ,
V_183 [ V_149 ] ,
...
V_179 = F_100 ( V_181 - 1 ) ;
if ( V_149 == V_152 ) {
if ( F_36 ( V_180 < V_185 - 1 ) )
goto V_45;
if ( F_36 ( V_180 == ( V_181 - 1 ) ) )
V_173 = V_179 ;
else
V_173 = F_100 ( V_180 - ( V_185 - 1 ) ) ;
V_172 = F_100 ( V_27 + V_185 - 1 ) ;
} else {
V_172 = F_100 ( V_27 ) ;
V_173 = F_100 ( V_180 ) ;
}
...
struct V_62 * V_68 ;
int V_79 ;
bool V_195 = F_110 ( V_2 , V_27 , true ) ;
if ( V_195 && V_2 -> V_196 != V_63 )
return - V_197 ;
F_39 ( & V_2 -> V_74 ) ;
if ( V_2 -> V_196 != V_130 && V_2 -> V_196 != V_63 ) {
V_117 = F_35 ( V_2 -> V_66 , V_2 -> V_196 ) ;
V_68 = V_117 ? F_37 ( V_117 , struct V_62 , V_69 ) : NULL ;
if ( V_68 ) {
F_28 ( V_2 , ! F_13 ( V_194 , & V_68 -> V_25 ) ) ;
...
F_49 ( V_2 -> V_66 ) ;
F_7 ( & V_2 -> V_76 ) ;
F_28 ( V_2 , F_13 ( V_194 , & V_68 -> V_25 ) == 0 ) ;
}
F_88 ( V_70 , & V_68 -> V_25 ) ;
