...
{
struct V_33 * V_34 = F_9 ( & V_32 -> V_35 ) ;
struct V_3 * V_4 ;
int V_7 , V_36 ;
if ( V_34 == NULL )
return 0 ;
...
if ( ! ( ( V_7 >= V_8 && V_7 <= V_17 ) ||
( V_7 >= V_19 && V_7 <= V_24 ) ) ) {
F_10 ( & V_32 -> V_35 , L_1 , V_7 ) ;
return - V_37 ;
}
V_4 = F_11 ( & V_32 -> V_35 , sizeof( struct V_3 ) , V_38 ) ;
if ( ! V_4 )
return - V_39 ;
V_4 -> V_30 . V_40 = V_34 -> V_40 ;
V_4 -> V_30 . V_41 = V_34 -> V_41 ;
V_4 -> V_30 . V_42 = F_6 ;
V_4 -> V_30 . V_43 = V_44 ;
V_4 -> V_7 = V_7 ;
V_4 -> V_13 = V_34 -> V_13 ;
V_4 -> V_15 = V_32 -> V_35 . V_45 ;
V_4 -> V_14 = V_44 ;
F_12 ( & V_4 -> V_2 , F_1 ) ;
V_36 = F_13 ( V_4 -> V_15 , & V_4 -> V_30 ) ;
if ( V_36 ) {
F_10 ( & V_32 -> V_35 , L_2 , V_7 ) ;
return V_36 ;
}
F_14 ( V_32 , V_4 ) ;
return 0 ;
