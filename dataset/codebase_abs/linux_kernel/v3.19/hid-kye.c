...
struct V_25 * V_26 ;
T_2 * V_27 ;
V_23 = & V_2 -> V_28 [ V_29 ] . V_30 ;
F_5 (head, list) {
V_26 = F_6 ( V_24 , struct V_25 , V_23 ) ;
if ( V_26 -> V_31 == 5 )
break;
}
if ( V_24 == V_23 ) {
...
if ( V_26 -> V_33 < 1 || V_26 -> V_34 [ 0 ] -> V_35 < 7 ) {
F_7 ( V_2 , L_8 ) ;
return - V_32 ;
}
V_27 = V_26 -> V_34 [ 0 ] -> V_27 ;
V_27 [ 0 ] = 0x12 ;
V_27 [ 1 ] = 0x10 ;
V_27 [ 2 ] = 0x11 ;
V_27 [ 3 ] = 0x12 ;
...
static int F_9 ( struct V_1 * V_2 , const struct V_37 * V_31 )
{
int V_38 ;
V_38 = F_10 ( V_2 ) ;
if ( V_38 ) {
