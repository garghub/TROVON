...
V_40 = V_22 -> V_62 ;
if ( F_31 ( V_63 , V_22 ) ) {
struct V_64 * V_65 = F_32 ( V_22 ) ;
if ( V_65 )
V_48 -= F_33 ( sizeof( V_66 ) +
V_65 -> V_67 ) ;
}
if ( V_40 > V_48 )
V_40 = V_48 ;
V_41 = 0 ;
V_47 = V_40 ;
if ( F_34 ( & V_22 -> V_68 [ V_69 ] ) &&
V_22 -> V_25 . V_70 == 0 &&
F_35 ( & V_22 -> V_25 . V_71 ) &&
V_49 > V_40 )
V_48 -= F_33 ( sizeof( V_72 ) ) ;
if ( V_22 -> V_73 < V_74 )
V_48 -= V_75 ;
if ( V_47 > V_48 )
V_47 = V_48 ;
...
V_13 = F_38 ( V_22 , V_37 , V_46 , V_50 , 0 ) ;
if ( ! V_13 ) {
V_45 = - V_52 ;
goto V_84;
}
V_45 = F_39 ( V_13 , V_46 , V_39 ) ;
if ( V_45 < 0 )
goto V_85;
F_40 ( V_13 -> V_86 , ( T_3 * ) V_13 -> V_87
- ( T_3 * ) V_13 -> V_86 -> V_88 ) ;
F_25 ( V_2 , V_13 ) ;
F_41 ( & V_13 -> V_24 , & V_2 -> V_9 ) ;
if ( 0 == V_42 )
V_46 = V_40 ;
}
if ( V_44 ) {
...
( V_37 -> V_80 & V_82 ) )
V_50 |= V_83 ;
V_13 = F_38 ( V_22 , V_37 , V_44 , V_50 , 0 ) ;
if ( ! V_13 ) {
V_45 = - V_52 ;
goto V_84;
}
V_45 = F_39 ( V_13 , V_44 , V_39 ) ;
F_40 ( V_13 -> V_86 , ( T_3 * ) V_13 -> V_87
- ( T_3 * ) V_13 -> V_86 -> V_88 ) ;
if ( V_45 < 0 )
goto V_85;
...
void F_44 ( struct V_12 * V_13 , int error )
{
V_13 -> V_2 -> V_4 = 1 ;
V_13 -> V_2 -> V_5 = error ;
}
