...
static int F_58 ( struct V_137 * V_21 , struct V_1 * V_2 )
{
struct V_138 * V_108 ;
T_7 V_139 ;
int V_130 = 0 , V_36 ;
while ( ( V_108 = F_59 ( V_21 , V_140 , V_130 ) ) ) {
for ( V_139 = V_108 -> V_109 ; V_139 <= V_108 -> V_141 ; V_139 ++ ) {
V_36 = F_60 ( & V_21 -> V_21 , V_139 , F_26 ,
0 , F_61 ( & V_21 -> V_21 ) , V_2 ) ;
if ( V_36 ) {
...
return V_130 > 0 ? 0 : - V_142 ;
}
static int F_62 ( struct V_137 * V_21 )
{
struct V_143 * V_144 = F_63 ( & V_21 -> V_21 ) ;
struct V_1 * V_2 ;
struct V_125 * V_145 ;
struct V_138 * V_108 ;
int V_36 ;
T_1 V_18 ;
V_2 = F_64 ( & V_21 -> V_21 , sizeof( struct V_1 ) , V_146 ) ;
if ( ! V_2 )
return - V_147 ;
V_2 -> V_16 = F_65 ( & V_21 -> V_21 , NULL ) ;
if ( F_36 ( V_2 -> V_16 ) ) {
F_12 ( & V_21 -> V_21 , L_21 ) ;
...
V_2 -> V_21 = & V_21 -> V_21 ;
F_66 ( V_21 , V_2 ) ;
V_108 = F_59 ( V_21 , V_148 , 0 ) ;
V_2 -> V_108 = V_108 ;
V_2 -> V_7 = F_67 ( & V_21 -> V_21 , V_108 ) ;
if ( F_36 ( V_2 -> V_7 ) )
return F_37 ( V_2 -> V_7 ) ;
V_36 = F_68 ( V_21 -> V_21 . V_149 , L_22 , & V_18 ) ;
V_2 -> V_18 = V_36 ? V_19 : V_18 ;
V_2 -> V_17 = 1 ;
if ( V_21 -> V_21 . V_149 ) {
const struct V_150 * V_151 ;
V_151 = F_69 ( V_152 , & V_21 -> V_21 ) ;
if ( V_151 ) {
...
V_145 -> V_155 = V_156 ;
V_145 -> V_157 = & V_158 ;
V_145 -> V_21 . V_159 = & V_21 -> V_21 ;
V_145 -> V_160 = 5 ;
V_145 -> V_161 = V_21 -> V_162 ;
V_145 -> V_21 . V_149 = V_21 -> V_21 . V_149 ;
F_75 ( V_145 -> V_163 , V_21 -> V_163 , sizeof( V_145 -> V_163 ) ) ;
F_76 ( & V_2 -> V_37 ) ;
F_77 ( & V_2 -> V_78 ) ;
V_36 = F_78 ( V_145 ) ;
if ( V_36 < 0 ) {
...
F_79 ( & V_21 -> V_21 , L_24 , V_145 -> V_161 , V_2 -> V_18 ) ;
return 0 ;
}
static int F_80 ( struct V_137 * V_21 )
{
struct V_1 * V_2 = F_81 ( V_21 ) ;
F_82 ( & V_2 -> V_145 ) ;
F_57 ( V_2 ) ;
F_83 ( & V_21 -> V_21 ) ;
return 0 ;
}
static int F_84 ( struct V_84 * V_21 )
{
return 0 ;
}
