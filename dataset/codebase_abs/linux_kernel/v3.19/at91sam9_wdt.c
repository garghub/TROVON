...
static int F_26 ( struct V_45 * V_46 , struct V_3 * V_4 )
{
T_2 V_47 = 0 ;
T_2 V_48 = V_49 ;
const char * V_22 ;
...
if ( F_31 ( V_46 , L_17 ) )
V_4 -> V_33 |= V_54 ;
V_4 -> V_33 |= V_48 | ( ( V_48 - V_47 ) << 16 ) ;
return 0 ;
}
static inline int F_26 ( struct V_45 * V_46 , struct V_3 * V_4 )
{
return 0 ;
}
...
int V_25 ;
struct V_3 * V_4 ;
V_4 = F_33 ( & V_21 -> V_31 , sizeof( * V_4 ) , V_57 ) ;
if ( ! V_4 )
return - V_58 ;
V_4 -> V_33 = ( V_59 * 256 ) | V_52 | V_38 |
V_54 | V_53 ;
V_4 -> V_27 = 0x3FFFFFFF ;
V_4 -> V_43 = V_43 ;
V_4 -> V_13 . V_50 = & V_21 -> V_31 ;
V_4 -> V_13 . V_60 = & V_61 ;
V_4 -> V_13 . V_62 = & V_63 ;
V_4 -> V_13 . V_17 = V_64 ;
V_4 -> V_13 . V_65 = 1 ;
V_4 -> V_13 . V_66 = 0xFFFF ;
V_56 = F_34 ( V_21 , V_67 , 0 ) ;
V_4 -> V_68 = F_35 ( & V_21 -> V_31 , V_56 ) ;
if ( F_36 ( V_4 -> V_68 ) )
return F_37 ( V_4 -> V_68 ) ;
if ( V_21 -> V_31 . V_69 ) {
V_25 = F_26 ( V_21 -> V_31 . V_69 , V_4 ) ;
if ( V_25 )
return V_25 ;
}
V_25 = F_15 ( V_21 , V_4 ) ;
