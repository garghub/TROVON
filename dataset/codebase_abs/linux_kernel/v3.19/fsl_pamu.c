...
int F_40 ( unsigned long V_111 , unsigned long V_114 ,
T_2 V_115 , T_2 V_116 ,
T_2 V_117 )
{
T_1 * V_118 ;
...
F_47 ( L_31 , F_48 ( F_38 ( V_154 + V_163 ) ,
F_38 ( V_154 + V_164 ) ) ) ;
F_47 ( L_32 , F_38 ( V_154 + V_165 ) ) ;
F_47 ( L_33 , F_48 ( F_38 ( V_154 + V_166 ) ,
F_38 ( V_154 + V_167 ) ) ) ;
...
F_47 ( L_34 , V_151 , F_38 ( V_2 + V_151 ) ) ;
}
...
T_1 V_171 = 0 ;
unsigned V_81 ;
V_120 = F_52 ( V_196 -> V_69 . V_70 , 0 ) ;
if ( ! V_120 ) {
F_57 ( & V_196 -> V_69 , L_40 ) ;
return - V_184 ;
}
F_58 ( V_196 -> V_69 . V_70 , 0 , & V_34 , NULL ) ;
V_146 = F_59 ( V_196 -> V_69 . V_70 , 0 ) ;
if ( V_146 == V_206 ) {
F_60 ( & V_196 -> V_69 , L_41 ) ;
goto error;
}
V_149 = F_61 ( sizeof( struct V_148 ) , V_207 ) ;
if ( ! V_149 ) {
F_57 ( & V_196 -> V_69 , L_42 ) ;
V_152 = - V_184 ;
goto error;
}
V_149 -> V_111 = V_120 ;
V_149 -> V_153 = V_34 / V_155 ;
V_152 = F_62 ( V_146 , F_46 , 0 , L_43 , V_149 ) ;
if ( V_152 < 0 ) {
F_57 ( & V_196 -> V_69 , L_44 ,
V_152 , V_146 ) ;
goto error;
}
V_202 = F_29 ( NULL , V_208 ) ;
if ( ! V_202 ) {
F_57 ( & V_196 -> V_69 , L_45 ,
V_196 -> V_69 . V_70 -> V_84 ) ;
V_152 = - V_183 ;
goto error;
}
V_198 = F_52 ( V_202 , 0 ) ;
