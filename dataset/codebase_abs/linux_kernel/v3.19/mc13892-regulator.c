...
F_3 ( V_2 -> V_5 ) ;
V_7 = F_16 ( V_2 -> V_5 , V_17 [ V_15 ] . V_27 ,
V_3 , V_33 ) ;
F_6 ( V_2 -> V_5 ) ;
return V_7 ;
}
...
F_6 ( V_6 ) ;
memcpy ( & V_69 , V_17 [ V_70 ] . V_34 . V_71 ,
sizeof( struct V_72 ) ) ;
V_69 . V_73 = F_17 ,
V_69 . V_74 = F_18 ,
V_17 [ V_70 ] . V_34 . V_71 = & V_69 ;
V_47 = F_25 ( V_41 , V_17 ,
F_26 ( V_17 ) ) ;
...
V_49 . V_80 = V_2 ;
V_49 . V_81 = V_79 ;
V_2 -> V_53 [ V_50 ] = F_27 ( & V_41 -> V_42 , V_34 ,
& V_49 ) ;
if ( F_28 ( V_2 -> V_53 [ V_50 ] ) ) {
F_29 ( & V_41 -> V_42 , L_3 ,
V_17 [ V_50 ] . V_34 . V_82 ) ;
return F_30 ( V_2 -> V_53 [ V_50 ] ) ;
}
}
return 0 ;
V_58:
