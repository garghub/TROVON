...
if ( F_23 ( V_46 ) )
return F_24 ( V_46 ) ;
V_19 = sscanf ( V_46 , L_5 , & V_41 , & V_33 ) ;
if ( V_19 < 2 ) {
F_6 ( V_20
L_6 ,
V_7 -> V_21 , V_47 ) ;
...
static T_2
F_27 ( struct V_2 * V_2 , const char T_3 * V_29 ,
T_4 V_30 , T_1 * V_39 )
{
struct V_8 * V_9 = V_2 -> V_16 ;
...
if ( F_23 ( V_46 ) )
return F_24 ( V_46 ) ;
V_19 = sscanf ( V_46 , L_5 , & V_41 , & V_49 ) ;
if ( V_19 < 2 ) {
F_6 ( V_20
L_6 ,
V_7 -> V_21 , V_47 ) ;
...
static int
F_29 ( struct V_1 * V_1 , struct V_2 * V_2 )
{
struct V_8 * V_9 = V_2 -> V_16 ;
if ( ! V_9 )
return 0 ;
...
static int
F_30 ( struct V_1 * V_1 , struct V_2 * V_2 )
{
...
snprintf ( V_51 , sizeof( V_51 ) , L_11 , V_7 -> V_57 ) ;
if ( ! V_4 -> V_58 ) {
V_4 -> V_58 =
F_32 ( V_51 , V_53 ) ;
if ( ! V_4 -> V_58 ) {
...
F_34 ( & V_54 ) ;
for ( V_42 = 0 ; V_42 < F_35 ( V_59 ) ; V_42 ++ ) {
V_2 = & V_59 [ V_42 ] ;
V_7 -> V_60 [ V_42 ] =
F_36 ( V_2 -> V_51 ,
V_2 -> V_61 ,
