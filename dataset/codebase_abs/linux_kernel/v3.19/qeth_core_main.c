...
return - V_50 ;
V_130 = (struct V_129 * ) ( V_113 -> V_117 + V_390 ) ;
V_130 -> V_117 . V_467 . V_117 . V_647 . V_130 = V_650 ;
V_130 -> V_117 . V_467 . V_117 . V_647 . V_651 = V_648 ;
...
F_4 ( V_2 , 4 , L_267 ) ;
V_130 = (struct V_129 * ) V_117 ;
V_653 = & V_130 -> V_117 . V_467 . V_117 . V_655 ;
F_45 ( V_65 , 2 , L_267 ) ;
F_45 ( V_65 , 2 , L_191 , V_2 -> V_10 -> V_9 . V_656 . V_516 ) ;
F_45 ( V_65 , 2 , L_268 ,
V_130 -> V_117 . V_467 . V_133 . V_139 ) ;
if ( V_130 -> V_117 . V_467 . V_133 . V_139 !=
V_657 )
F_68 ( 3 , L_269 ,
V_2 -> V_10 -> V_9 . V_656 . V_516 ,
V_653 -> V_658 ,
V_130 -> V_117 . V_467 . V_133 . V_139 ) ;
...
int F_344 ( struct V_1 * V_2 , int V_654 )
{
int V_37 = 0 ;
F_4 ( V_2 , 4 , L_288 ) ;
...
int F_346 ( struct V_636 * V_9 , int V_670 , int V_671 )
{
...
memcpy ( F_272 ( V_113 -> V_117 ) ,
& V_2 -> V_353 . V_416 , V_369 ) ;
V_709 = ( V_711 ) V_390 + V_162 ;
V_710 = ( V_711 ) V_162 ;
memcpy ( F_348 ( V_113 -> V_117 ) , & V_709 , 2 ) ;
memcpy ( F_349 ( V_113 -> V_117 ) , & V_710 , 2 ) ;
memcpy ( F_350 ( V_113 -> V_117 ) , & V_710 , 2 ) ;
memcpy ( F_351 ( V_113 -> V_117 ) , & V_710 , 2 ) ;
...
V_716 = & V_130 -> V_117 . V_467 . V_117 . V_716 ;
if ( V_130 -> V_133 . V_139 ) {
...
V_606 -= ( V_184 ) ( ( char * ) & V_716 -> V_117 - ( char * ) V_130 ) ;
else
V_606 -= ( V_184 ) ( ( char * ) & V_716 -> V_717 - ( char * ) V_130 ) ;
if ( ( V_714 -> V_718 - V_714 -> V_719 ) < V_606 ) {
...
( char * ) V_716 ,
V_606 + F_353 ( struct V_715 , V_117 ) ) ;
V_714 -> V_719 += F_353 ( struct V_715 , V_117 ) ;
} else {
memcpy ( V_714 -> V_721 + V_714 -> V_719 ,
( char * ) & V_716 -> V_717 , V_606 ) ;
}
V_714 -> V_719 += V_606 ;
F_52 ( V_2 , 4 , L_298 ,
V_130 -> V_117 . V_467 . V_133 . V_477 ) ;
...
int F_354 ( struct V_1 * V_2 , char T_4 * V_721 )
{
struct V_112 * V_113 ;
struct V_129 * V_130 ;
struct V_722 * V_723 ;
...
if ( F_355 ( & V_724 , V_721 + sizeof( int ) , sizeof( int ) ) )
return - V_726 ;
if ( V_724 > ( V_118 - V_390 -
sizeof( struct V_727 ) -
sizeof( struct V_498 ) ) )
return - V_405 ;
V_723 = F_356 ( V_721 , V_724 + sizeof( struct V_728 ) ) ;
if ( F_116 ( V_723 ) ) {
F_4 ( V_2 , 2 , L_301 ) ;
return F_117 ( V_723 ) ;
}
V_714 . V_718 = V_723 -> V_133 . V_606 ;
...
V_130 = (struct V_129 * ) ( V_113 -> V_117 + V_390 ) ;
memcpy ( & V_130 -> V_117 . V_467 . V_117 . V_716 , & V_723 -> V_130 , V_724 ) ;
V_37 = F_347 ( V_2 , V_113 , V_730 + V_724 ,
F_352 , ( void * ) & V_714 ) ;
if ( V_37 )
F_68 ( 2 , L_302 ,
F_81 ( V_2 ) , V_37 ) ;
else {
if ( F_357 ( V_721 , V_714 . V_721 , V_714 . V_718 ) )
V_37 = - V_726 ;
}
V_73:
F_32 ( V_723 ) ;
...
V_734 = V_130 -> V_117 . V_467 . V_133 . V_475 ;
V_733 = ( char * ) V_117 + 28 ;
...
int F_359 ( struct V_1 * V_2 , char T_4 * V_721 )
{
int V_37 = 0 ;
struct V_112 * V_113 ;
struct V_129 * V_130 ;
...
V_130 = (struct V_129 * ) V_117 ;
V_746 = & V_130 -> V_117 . V_467 . V_117 . V_746 ;
if ( V_130 -> V_117 . V_467 . V_133 . V_139 == 0 ) {
...
F_168 ( V_2 , V_345 ) ;
F_32 ( V_345 ) ;
V_37 = F_366 ( V_752 , & V_2 -> V_756 ) ;
if ( V_37 )
F_45 ( V_65 , 2 , L_188 , V_37 ) ;
F_45 ( V_65 , 2 , L_309 , V_2 -> V_756 . V_757 ) ;
F_45 ( V_65 , 2 , L_310 , V_2 -> V_756 . V_758 ) ;
F_45 ( V_65 , 2 , L_310 , V_2 -> V_756 . V_759 ) ;
F_45 ( V_65 , 2 , L_311 , V_2 -> V_756 . V_760 ) ;
...
F_369 [ V_44 ] = V_2 -> V_148 -> V_773 ;
F_368 ( V_2 , V_764 , F_369 ) ;
V_768 =
...
V_768 [ V_769 ] = (struct V_525 * ) F_313 (
V_2 -> V_46 . V_80 [ V_44 ] -> V_63 [ V_45 ] -> V_64 ) ;
}
memset ( & V_766 , 0 , sizeof( struct V_765 ) ) ;
V_766 . V_158 = F_44 ( V_2 ) ;
V_766 . V_775 = F_363 ( V_2 ) ;
V_766 . V_776 = 0 ;
V_766 . V_767 = V_767 ;
V_766 . V_777 = V_2 -> V_46 . V_72 ;
V_766 . V_778 = V_2 -> V_46 . V_78 ;
V_766 . V_779 = V_2 -> V_148 -> V_779 ;
V_766 . V_780 = V_2 -> V_148 -> V_780 ;
V_766 . V_781 = F_369 ;
...
static inline int F_378 ( struct V_444 * V_792 ,
struct V_793 * V_244 ,
struct V_231 * * V_794 , int V_183 , int * V_795 , int V_606 )
{
...
* V_794 = F_265 ( V_445 + V_446 ) ;
if ( ! ( * V_794 ) )
return - V_50 ;
}
F_379 ( * V_794 , V_446 ) ;
if ( V_606 <= V_445 ) {
memcpy ( F_380 ( * V_794 , V_606 ) , V_244 -> V_249 + V_183 ,
V_606 ) ;
} else {
F_381 ( V_440 ) ;
memcpy ( F_380 ( * V_794 , V_445 ) ,
V_244 -> V_249 + V_183 , V_445 ) ;
F_382 ( * V_794 , * V_795 , V_440 ,
V_183 + V_445 ,
V_606 - V_445 ) ;
( * V_794 ) -> V_606 += V_606 - V_445 ;
( * V_794 ) -> V_162 += V_606 - V_445 ;
( * V_794 ) -> V_796 += V_606 - V_445 ;
( * V_795 ) ++ ;
}
} else {
F_381 ( V_440 ) ;
F_382 ( * V_794 , * V_795 , V_440 , V_183 , V_606 ) ;
( * V_794 ) -> V_606 += V_606 ;
( * V_794 ) -> V_162 += V_606 ;
( * V_794 ) -> V_796 += V_606 ;
( * V_795 ) ++ ;
...
static inline int F_383 ( struct V_793 * V_797 )
{
return ( V_797 -> V_253 & V_447 ) ;
}
...
struct V_608 * * V_133 )
{
struct V_793 * V_244 = * V_798 ;
struct V_525 * V_64 = V_792 -> V_64 ;
int V_183 = * V_799 ;
...
switch ( ( * V_133 ) -> V_133 . V_804 . V_313 ) {
case V_805 :
V_800 = ( * V_133 ) -> V_133 . V_804 . V_806 ;
break;
case V_807 :
V_800 = ( * V_133 ) -> V_133 . V_623 . V_252 ;
V_802 = V_446 ;
break;
case V_808 :
V_800 = ( * V_133 ) -> V_133 . V_809 . V_810 ;
V_802 = sizeof( struct V_608 ) ;
break;
default:
break;
}
if ( ! V_800 )
return NULL ;
if ( ( ( V_800 >= V_2 -> V_66 . V_273 ) &&
( ! ( V_2 -> V_12 . type == V_18 ) ) &&
( ! F_51 ( & V_2 -> V_533 ) ) ) ||
( V_2 -> V_66 . V_67 == V_68 ) ) {
V_803 = 1 ;
} else {
V_232 = F_265 ( V_800 + V_802 ) ;
if ( ! V_232 )
goto V_811;
if ( V_802 )
F_379 ( V_232 , V_802 ) ;
}
V_801 = V_244 -> V_249 + V_183 ;
while ( V_800 ) {
V_606 = F_212 ( V_800 , ( int ) ( V_244 -> V_252 - V_183 ) ) ;
if ( V_606 ) {
if ( V_803 ) {
if ( F_378 ( V_792 , V_244 ,
& V_232 , V_183 , & V_599 , V_606 ) )
goto V_811;
} else {
memcpy ( F_380 ( V_232 , V_606 ) , V_801 ,
V_606 ) ;
}
}
V_800 -= V_606 ;
...
V_2 -> V_442 . V_812 ++ ;
V_2 -> V_442 . V_813 += F_321 ( V_232 ) -> V_600 ;
}
return V_232 ;
V_811:
if ( F_386 () ) {
...
{
int V_814 ;
for ( V_814 = 0 ; V_814 < V_815 ; V_814 ++ ) {
F_388 ( V_816 [ V_814 ] . V_313 ) ;
V_816 [ V_814 ] . V_313 = NULL ;
}
}
void F_389 ( T_5 * V_313 , int V_372 , char * V_817 , ... )
{
char V_818 [ 32 ] ;
T_6 args ;
...
return;
va_start ( args , V_817 ) ;
vsnprintf ( V_818 , sizeof( V_818 ) , V_817 , args ) ;
va_end ( args ) ;
F_391 ( V_313 , V_372 , V_818 ) ;
}
...
int V_814 ;
for ( V_814 = 0 ; V_814 < V_815 ; V_814 ++ ) {
V_816 [ V_814 ] . V_313 = F_393 ( V_816 [ V_814 ] . V_516 ,
V_816 [ V_814 ] . V_819 ,
V_816 [ V_814 ] . V_820 ,
V_816 [ V_814 ] . V_162 ) ;
if ( V_816 [ V_814 ] . V_313 == NULL ) {
F_387 () ;
return - V_50 ;
}
V_337 = F_394 ( V_816 [ V_814 ] . V_313 , V_816 [ V_814 ] . V_821 ) ;
if ( V_337 ) {
F_387 () ;
return V_337 ;
}
F_395 ( V_816 [ V_814 ] . V_313 , V_816 [ V_814 ] . V_372 ) ;
}
return 0 ;
}
...
{
struct V_828 * V_832 ;
V_2 -> V_833 = F_393 ( V_516 , 2 , 1 , 8 ) ;
if ( ! V_2 -> V_833 ) {
F_45 ( V_65 , 2 , L_191 , L_331 ) ;
goto V_834;
}
if ( F_394 ( V_2 -> V_833 , & V_835 ) )
goto V_836;
V_832 = F_27 ( sizeof( struct V_828 ) , V_49 ) ;
if ( ! V_832 )
goto V_836;
strncpy ( V_832 -> V_830 , V_516 , V_837 ) ;
V_832 -> V_831 = V_2 -> V_833 ;
F_397 ( & V_829 ) ;
F_33 ( & V_832 -> V_838 , & V_839 ) ;
F_400 ( & V_829 ) ;
return 0 ;
V_836:
F_388 ( V_2 -> V_833 ) ;
...
snprintf ( V_830 , sizeof( V_830 ) , L_333 ,
F_69 ( & V_10 -> V_9 ) ) ;
V_2 -> V_833 = F_403 ( V_830 ) ;
if ( ! V_2 -> V_833 ) {
V_37 = F_404 ( V_2 , V_830 ) ;
if ( V_37 )
goto V_843;
}
...
F_408 ( & V_10 -> V_9 , V_2 ) ;
V_2 -> V_10 = V_10 ;
V_10 -> V_158 [ 0 ] -> V_844 = F_118 ;
V_10 -> V_158 [ 1 ] -> V_844 = F_118 ;
V_10 -> V_158 [ 2 ] -> V_844 = F_118 ;
V_37 = F_151 ( V_2 ) ;
if ( V_37 ) {
F_45 ( V_65 , 2 , L_141 , V_37 ) ;
goto V_843;
...
case V_18 :
case V_16 :
V_37 = F_396 ( V_2 , V_826 ) ;
if ( V_37 )
goto V_843;
V_37 = V_2 -> V_148 -> V_847 ( V_2 -> V_10 ) ;
if ( V_37 )
goto V_848;
case V_14 :
case V_17 :
...
F_409 ( & V_849 . V_850 , V_32 ) ;
F_102 ( & V_2 -> V_42 , & V_849 . V_42 ) ;
F_410 ( & V_849 . V_850 , V_32 ) ;
F_364 ( V_2 ) ;
return 0 ;
V_848:
F_401 ( V_2 ) ;
...
static T_7 F_421 ( struct V_860 * V_861 ,
const char * V_230 , T_8 V_166 )
{
int V_834 ;
V_834 = F_422 ( V_862 ,
& V_863 , 3 , V_230 ) ;
return V_834 ? V_834 : V_166 ;
}
int F_423 ( struct V_636 * V_9 , int V_864 )
{
switch ( V_864 ) {
case V_865 :
return ( sizeof( V_866 ) / V_867 ) ;
default:
return - V_405 ;
}
}
void F_424 ( struct V_636 * V_9 ,
struct V_868 * V_528 , T_9 * V_117 )
{
struct V_1 * V_2 = V_9 -> V_641 ;
V_117 [ 0 ] = V_2 -> V_528 . V_869 -
V_2 -> V_442 . V_870 ;
V_117 [ 1 ] = V_2 -> V_442 . V_871 ;
V_117 [ 2 ] = V_2 -> V_528 . V_872 -
V_2 -> V_442 . V_873 ;
V_117 [ 3 ] = V_2 -> V_442 . V_557 ;
V_117 [ 4 ] = V_2 -> V_528 . V_872 - V_2 -> V_442 . V_873
- V_2 -> V_442 . V_627 ;
V_117 [ 5 ] = V_2 -> V_442 . V_557 - V_2 -> V_442 . V_561 ;
V_117 [ 6 ] = V_2 -> V_442 . V_627 ;
V_117 [ 7 ] = V_2 -> V_442 . V_561 ;
V_117 [ 8 ] = V_2 -> V_442 . V_874 ;
V_117 [ 9 ] = V_2 -> V_442 . V_875 ;
V_117 [ 10 ] = V_2 -> V_442 . V_812 ;
V_117 [ 11 ] = V_2 -> V_442 . V_813 ;
V_117 [ 12 ] = V_2 -> V_442 . V_443 ;
V_117 [ 13 ] = ( V_2 -> V_442 . V_876 >> 10 ) ;
V_117 [ 14 ] = V_2 -> V_442 . V_877 ;
...
V_117 [ 23 ] = V_2 -> V_442 . V_878 ;
V_117 [ 24 ] = V_2 -> V_442 . V_879 ;
V_117 [ 25 ] = V_2 -> V_442 . V_537 ;
V_117 [ 26 ] = V_2 -> V_442 . V_535 ;
V_117 [ 27 ] = V_2 -> V_442 . V_580 ;
V_117 [ 28 ] = V_2 -> V_442 . V_576 ;
V_117 [ 29 ] = V_2 -> V_442 . V_880 ;
V_117 [ 30 ] = V_2 -> V_442 . V_881 ;
V_117 [ 31 ] = V_2 -> V_442 . V_554 ;
V_117 [ 32 ] = V_2 -> V_442 . V_550 ;
V_117 [ 33 ] = V_2 -> V_442 . V_882 ;
V_117 [ 34 ] = V_2 -> V_442 . V_883 ;
V_117 [ 35 ] = V_2 -> V_442 . V_568 ;
V_117 [ 36 ] = V_2 -> V_442 . V_572 ;
}
void F_425 ( struct V_636 * V_9 , V_711 V_864 , V_278 * V_117 )
{
switch ( V_864 ) {
case V_865 :
memcpy ( V_117 , & V_866 ,
...
{
struct V_1 * V_2 = V_9 -> V_641 ;
F_427 ( V_12 -> V_885 , V_2 -> V_66 . V_306 ? L_328 : L_327 ,
sizeof( V_12 -> V_885 ) ) ;
F_427 ( V_12 -> V_886 , L_335 , sizeof( V_12 -> V_886 ) ) ;
F_427 ( V_12 -> V_887 , V_2 -> V_12 . V_301 ,
sizeof( V_12 -> V_887 ) ) ;
snprintf ( V_12 -> V_888 , sizeof( V_12 -> V_888 ) , L_336 ,
F_428 ( V_2 ) , F_429 ( V_2 ) , F_430 ( V_2 ) ) ;
}
static void F_431 ( struct V_889 * V_890 ,
int V_891 , int V_892 )
{
int V_893 , V_894 , V_895 , V_896 ;
switch ( V_892 ) {
case V_897 :
V_893 = V_898 ;
V_894 = V_899 ;
...
V_890 -> V_921 = V_922 | V_894 | V_896 ;
V_890 -> V_923 = V_924 | V_893 | V_895 ;
}
int F_432 ( struct V_636 * V_925 ,
struct V_889 * V_890 )
{
struct V_1 * V_2 = V_925 -> V_641 ;
enum V_452 V_19 ;
struct V_747 V_747 ;
int V_37 ;
V_711 V_926 ;
...
case V_20 :
case V_24 :
F_431 ( V_890 , V_911 , V_897 ) ;
V_926 = V_911 ;
V_890 -> V_933 = V_897 ;
break;
case V_22 :
case V_26 :
F_431 ( V_890 , V_906 , V_900 ) ;
V_926 = V_906 ;
V_890 -> V_933 = V_900 ;
break;
case V_23 :
F_431 ( V_890 , V_903 , V_900 ) ;
V_926 = V_903 ;
V_890 -> V_933 = V_900 ;
break;
default:
F_431 ( V_890 , V_916 , V_897 ) ;
V_926 = V_916 ;
V_890 -> V_933 = V_897 ;
}
F_433 ( V_890 , V_926 ) ;
