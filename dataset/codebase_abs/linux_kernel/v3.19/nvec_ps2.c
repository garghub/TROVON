...
{
int V_18 ;
unsigned char * V_19 = ( unsigned char * ) V_17 ;
switch ( V_16 ) {
case V_20 :
...
struct V_1 * V_2 ;
char V_27 [] = { V_4 , V_11 , V_28 , 3 } ;
V_2 = F_11 ( & V_24 -> V_13 , sizeof( struct V_1 ) , V_29 ) ;
if ( V_2 == NULL )
return - V_30 ;
V_2 -> V_31 . type = V_32 ;
V_2 -> V_33 = F_4 ;
V_2 -> V_34 = F_1 ;
V_2 -> V_35 = F_3 ;
F_12 ( V_2 -> V_36 , L_5 , sizeof( V_2 -> V_36 ) ) ;
F_12 ( V_2 -> V_37 , L_6 , sizeof( V_2 -> V_37 ) ) ;
V_7 . V_2 = V_2 ;
V_7 . V_38 . V_39 = F_6 ;
V_7 . V_8 = V_8 ;
F_13 ( V_8 , & V_7 . V_38 , 0 ) ;
F_14 ( V_2 ) ;
F_2 ( V_8 , V_27 , sizeof( V_27 ) ) ;
return 0 ;
}
...
static int F_18 ( struct V_41 * V_13 )
{
F_4 ( V_7 . V_2 , V_40 ) ;
F_3 ( V_7 . V_2 ) ;
return 0 ;
}
static int F_19 ( struct V_41 * V_13 )
{
F_1 ( V_7 . V_2 ) ;
F_4 ( V_7 . V_2 , V_12 ) ;
return 0 ;
