...
{
struct V_83 * V_31 = V_9 -> V_31 ;
struct V_84 * V_85 ;
struct V_86 * V_87 =
F_46 ( V_31 -> V_88 , struct V_86 , V_30 ) ;
T_1 V_89 = 0 ;
if ( ! V_31 -> V_36 )
return - V_90 ;
V_85 = V_31 -> V_36 -> V_91 ;
...
F_44 () ;
F_28 ( L_2 ) ;
if ( V_85 -> V_96 -> V_97 && V_85 -> V_96 -> V_97 -> V_98 ) {
V_89 = V_85 -> V_96 -> V_97 -> V_98 ( V_85 ) ;
if ( V_9 -> V_99 ) {
F_17 ( V_9 , 1 ) ;
F_14 ( 0x0c , 0x20 ) ;
}
...
F_28 ( L_3 ) ;
if ( V_85 && V_85 -> V_96 ) {
if ( V_85 -> V_96 -> V_97 && V_85 -> V_96 -> V_97 -> V_100 )
V_89 = V_85 -> V_96 -> V_97 -> V_100 ( V_85 ) ;
if ( V_9 -> V_99 )
F_17 ( V_9 , 0 ) ;
}
V_87 -> V_94 = 0 ;
...
struct V_83 * V_31 = V_9 -> V_31 ;
struct V_84 * V_85 ;
if ( ! V_31 -> V_101 || ! V_31 -> V_101 -> V_85 . V_102 )
return - V_90 ;
F_28 ( L_4 , V_10 ? L_5 : L_6 ) ;
V_85 = V_31 -> V_101 -> V_85 . V_102 ;
if ( V_10 ) {
if ( V_85 -> V_96 -> V_98 )
V_85 -> V_96 -> V_98 ( V_85 ) ;
} else {
if ( V_85 -> V_96 -> V_100 )
V_85 -> V_96 -> V_100 ( V_85 , V_103 ) ;
}
return 0 ;
}
static int F_48 ( struct V_83 * V_31 , struct V_104 * V_36 )
{
struct V_86 * V_87 ;
if ( ! V_31 )
return - V_90 ;
V_87 = F_46 ( V_31 -> V_88 , struct V_86 , V_30 ) ;
if ( V_87 != V_20 )
return - V_90 ;
V_31 -> V_36 = V_36 ;
V_87 -> V_9 . V_105 = 0 ;
...
if ( V_36 ) {
F_28 ( L_3 ) ;
V_31 -> V_36 -> V_107 = V_108 . V_107 ;
V_31 -> V_36 -> V_109 = V_87 -> V_9 . V_99 ;
V_87 -> V_94 = 1 ;
F_49 ( & V_87 -> V_110 , 100 ) ;
return 0 ;
} else {
...
static int F_50 ( struct V_83 * V_31 ,
struct V_115 * V_101 )
{
struct V_86 * V_87 ;
if ( ! V_31 )
...
if ( ! V_101 ) {
if ( ! V_31 -> V_116 )
V_31 -> V_101 -> V_117 -> V_118 ( V_31 -> V_101 , 0 ) ;
F_51 ( V_31 -> V_101 ) ;
V_31 -> V_101 = 0 ;
V_87 -> V_9 . V_119 = 0 ;
F_29 ( & V_87 -> V_9 ) ;
...
V_31 -> V_101 = V_101 ;
V_31 -> V_101 -> V_120 = ! V_87 -> V_9 . V_99 ;
V_87 -> V_9 . V_119 = 1 ;
F_52 ( L_9 , V_87 -> V_9 . V_99 ) ;
if ( V_87 -> V_9 . V_99 == 1 ) {
F_45 ( & V_87 -> V_9 , 0 ) ;
F_53 ( & V_87 -> V_9 , 0 ) ;
F_47 ( & V_87 -> V_9 , 1 ) ;
...
static int F_54 ( struct V_88 * V_30 , unsigned V_121 )
{
if ( ! V_20 )
return - V_90 ;
if ( V_30 -> V_31 -> V_32 == V_122 )
F_55 ( L_10 , V_121 ) ;
return 0 ;
}
static void F_56 ( struct V_123 * V_124 )
{
struct V_86 * V_125 = F_46 ( V_124 , struct V_86 , V_110 . V_124 ) ;
...
static int F_57 ( struct V_83 * V_31 )
{
struct V_86 * V_87 ;
if ( ! V_31 || V_31 -> V_32 != V_126 )
return - V_90 ;
V_87 = F_46 ( V_31 -> V_88 , struct V_86 , V_30 ) ;
if ( V_87 != V_20 )
return - V_90 ;
...
static int F_58 ( struct V_83 * V_31 )
{
struct V_86 * V_87 ;
if ( ! V_31 )
return - V_90 ;
...
struct V_83 * V_31 = ( (struct V_86 * ) V_128 ) -> V_30 . V_31 ;
T_1 V_129 , V_130 ;
V_130 = F_12 ( & V_5 -> V_12 ) ;
V_129 = V_130 & V_13 & ( V_130 >> 8 ) ;
F_10 ( V_130 , & V_5 -> V_12 ) ;
V_9 -> V_99 = ( V_130 & V_111 ) ? 1 : 0 ;
V_31 -> V_116 = ( V_9 -> V_99 == 0 ) ;
if ( V_129 ) {
if ( V_129 & V_131 ) {
V_9 -> V_99 = ( V_130 & V_111 ) ? 1 : 0 ;
V_31 -> V_116 = ( V_9 -> V_99 == 0 ) ;
...
V_9 -> V_133 = 0 ;
if ( V_31 -> V_36 )
V_31 -> V_36 -> V_109 = V_9 -> V_99 ;
if ( V_31 -> V_101 )
V_31 -> V_101 -> V_120 = ! V_9 -> V_99 ;
F_28 ( L_12 , V_9 -> V_99 ) ;
if ( V_9 -> V_99 ) {
F_49 (
& ( (struct V_86 * ) V_128 ) -> V_110 ,
100 ) ;
} else {
F_60 ( &
( (struct V_86 * ) V_128 ) ->
...
if ( ! V_138 )
return - V_43 ;
V_138 -> V_30 . V_31 = F_62 ( sizeof( struct V_83 ) , V_140 ) ;
if ( ! V_138 -> V_30 . V_31 ) {
F_34 ( V_138 ) ;
return - V_43 ;
}
F_63 ( & V_138 -> V_110 , F_56 ) ;
F_64 ( & V_77 ) ;
...
V_138 -> V_9 . V_117 = & V_143 ;
V_138 -> V_30 . V_144 = V_145 ;
V_138 -> V_30 . V_85 = & V_137 -> V_85 ;
V_138 -> V_30 . V_146 = F_54 ;
V_138 -> V_30 . V_31 -> V_88 = & V_138 -> V_30 ;
V_138 -> V_30 . V_31 -> V_147 = F_48 ;
V_138 -> V_30 . V_31 -> V_148 = F_50 ;
V_138 -> V_30 . V_31 -> V_149 = F_58 ;
V_138 -> V_30 . V_31 -> V_150 = F_57 ;
V_20 = V_138 ;
...
if ( F_12 ( & V_153 -> V_21 -> V_12 ) & V_111 ) {
V_153 -> V_30 . V_31 -> V_32 = V_112 ;
V_153 -> V_9 . V_99 = 1 ;
} else {
V_153 -> V_30 . V_31 -> V_32 = V_191 ;
V_153 -> V_9 . V_99 = 0 ;
}
F_52 ( L_16 , V_153 -> V_9 . V_99 ) ;
V_4 = F_12 ( & V_153 -> V_21 -> V_12 ) ;
V_4 |= V_192 ;
V_4 &= ~ ( V_14 | V_193 ) ;
F_10 ( V_4 , & V_153 -> V_21 -> V_12 ) ;
...
static long F_85 ( struct V_210 * V_210 , unsigned int V_211 ,
unsigned long V_212 )
{
T_1 V_89 = 0 ;
switch ( V_211 ) {
...
break;
case V_214 :
V_20 -> V_9 . V_215 = V_212 ;
break;
case V_216 :
V_20 -> V_9 . V_105 = V_212 ;
break;
case V_217 :
V_20 -> V_9 . V_106 = V_212 ;
break;
case V_218 :
V_20 -> V_9 . V_119 = V_212 ;
break;
default:
break;
}
...
static int F_86 ( struct V_219 * V_219 , struct V_210 * V_210 )
{
return 0 ;
}
static int F_87 ( struct V_219 * V_219 , struct V_210 * V_210 )
{
return 0 ;
}
...
V_220 = F_90 ( V_221 , V_152 , & V_222 ) ;
if ( V_220 ) {
F_89 ( & V_137 -> V_85 , L_43 ) ;
return V_220 ;
}
V_220 = F_91 ( & V_137 -> V_85 , & V_223 ) ;
if ( V_220 )
