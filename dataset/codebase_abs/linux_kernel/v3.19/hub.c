...
int V_80 , unsigned V_177 , unsigned V_3 )
{
struct V_77 * V_78 = V_2 -> V_79 [ V_69 - 1 ] ;
...
int F_161 ( struct V_7 * V_11 , T_3 V_420 )
{
struct V_1 * V_2 = F_3 ( V_11 -> V_22 ) ;
...
else if ( F_208 ( V_420 ) || F_207 ( V_11 ) > 0 )
...
if ( V_80 == 0 && ! V_11 -> V_419 && V_11 -> V_220
...
int F_216 ( struct V_7 * V_11 , T_3 V_420 )
{
struct V_1 * V_2 = F_3 ( V_11 -> V_22 ) ;
struct V_77 * V_78 = V_2 -> V_79 [ V_11 -> V_126 - 1 ] ;
int V_69 = V_11 -> V_126 ;
...
V_80 = F_215 ( V_11 , V_2 , & V_69 , & V_177 ,
& V_3 ) ;
V_80 = F_201 ( V_11 ,
...
static int F_218 ( struct V_1 * V_2 , unsigned int V_112 ,
T_1 V_3 , T_1 V_177 )
...
static int F_220 ( struct V_119 * V_120 , T_3 V_420 )
{
struct V_1 * V_2 = F_4 ( V_120 ) ;
struct V_7 * V_4 = V_2 -> V_4 ;
unsigned V_69 ;
...
static int F_223 ( struct V_119 * V_120 )
{
struct V_1 * V_2 = F_4 ( V_120 ) ;
F_22 ( & V_120 -> V_19 , L_114 , V_115 ) ;
F_78 ( V_2 , V_197 ) ;
...
void F_225 ( struct V_7 * V_444 )
{
F_71 ( & V_444 -> V_19 , L_125 ) ;
V_444 -> V_221 = 1 ;
}
static int F_226 ( struct V_7 * V_11 , enum V_445 V_87 )
{
struct V_446 * V_447 ;
...
if ( V_11 -> V_87 != V_88 )
return 0 ;
V_448 = F_227 ( V_11 -> V_50 . V_43 , 1000 ) ;
V_449 = F_227 ( V_11 -> V_50 . V_40 , 1000 ) ;
V_450 = F_227 ( V_11 -> V_51 . V_43 , 1000 ) ;
V_451 = F_227 ( V_11 -> V_51 . V_40 , 1000 ) ;
if ( ( V_87 == V_452 &&
( V_448 > V_453 ||
V_449 > V_453 ) ) ||
( V_87 == V_454 &&
...
if ( V_451 > V_455 )
V_451 = V_455 ;
V_447 = F_56 ( sizeof *( V_447 ) , V_206 ) ;
if ( ! V_447 )
return - V_165 ;
V_447 -> V_448 = V_448 ;
V_447 -> V_449 = V_449 ;
V_447 -> V_450 = F_228 ( V_450 ) ;
V_447 -> V_451 = F_228 ( V_451 ) ;
...
if ( V_87 == V_452 )
V_11 -> V_50 . V_461 = V_461 ;
else
V_11 -> V_51 . V_461 = V_461 ;
return 0 ;
}
static void F_232 ( struct V_190 * V_156 , struct V_7 * V_11 ,
enum V_445 V_87 )
{
int V_461 , V_54 ;
T_4 V_466 = V_11 -> V_14 -> V_18 -> V_20 ;
T_5 V_467 = V_11 -> V_14 -> V_18 -> V_21 ;
if ( ( V_87 == V_452 && V_466 == 0 ) ||
( V_87 == V_454 && V_467 == 0 ) )
return;
V_54 = F_226 ( V_11 , V_87 ) ;
if ( V_54 < 0 ) {
F_71 ( & V_11 -> V_19 , L_140 ,
V_456 [ V_87 ] ) ;
return;
}
V_461 = V_156 -> V_157 -> V_468 ( V_156 , V_11 , V_87 ) ;
if ( V_461 == 0 )
return;
if ( V_461 < 0 ) {
...
if ( F_230 ( V_11 , V_87 , V_461 ) )
V_156 -> V_157 -> V_469 ( V_156 , V_11 , V_87 ) ;
else if ( V_11 -> V_8 )
F_229 ( V_11 , V_87 , true ) ;
}
static int F_233 ( struct V_190 * V_156 , struct V_7 * V_11 ,
enum V_445 V_87 )
{
switch ( V_87 ) {
case V_452 :
...
if ( F_230 ( V_11 , V_87 , 0 ) )
return - V_321 ;
F_229 ( V_11 , V_87 , false ) ;
if ( V_156 -> V_157 -> V_469 ( V_156 , V_11 , V_87 ) )
...
return 0 ;
V_11 -> V_470 ++ ;
if ( ( V_11 -> V_50 . V_461 == 0 && V_11 -> V_51 . V_461 == 0 ) )
return 0 ;
if ( F_233 ( V_156 , V_11 , V_452 ) )
goto V_471;
if ( F_233 ( V_156 , V_11 , V_454 ) )
goto V_471;
return 0 ;
V_471:
F_235 ( V_11 ) ;
...
V_11 -> V_470 -- ;
V_156 = F_60 ( V_11 -> V_170 ) ;
if ( ! V_156 || ! V_156 -> V_157 -> V_468 ||
! V_156 -> V_157 -> V_469 )
return;
if ( V_11 -> V_470 > 0 )
return;
F_232 ( V_156 , V_11 , V_452 ) ;
F_232 ( V_156 , V_11 , V_454 ) ;
}
...
int F_236 ( struct V_1 * V_2 , int V_69 , bool V_473 )
{
int V_54 ;
T_1 V_177 , V_3 ;
unsigned V_474 = 0xffff ;
int V_176 , V_475 = 0 ;
struct V_77 * V_78 = V_2 -> V_79 [ V_69 - 1 ] ;
for ( V_176 = 0 ; ; V_176 += V_181 ) {
V_54 = F_28 ( V_2 , V_69 , & V_3 , & V_177 ) ;
...
{
F_238 ( V_11 , 0 + V_62 , true ) ;
F_238 ( V_11 , 0 + V_476 , true ) ;
F_239 ( V_11 , & V_11 -> V_342 , true ) ;
}
static int F_240 ( struct V_7 * V_11 , int V_168 )
{
int V_477 ;
struct V_190 * V_156 = F_60 ( V_11 -> V_170 ) ;
if ( ! V_156 -> V_157 -> V_478 && V_168 <= 1 )
return - V_66 ;
if ( V_11 -> V_87 == V_429 )
return 0 ;
if ( V_11 -> V_87 != V_403 )
return - V_66 ;
if ( V_156 -> V_157 -> V_478 )
V_477 = V_156 -> V_157 -> V_478 ( V_156 , V_11 ) ;
else
V_477 = F_14 ( V_11 , F_241 () ,
V_479 , 0 , V_168 , 0 ,
NULL , 0 , V_200 ) ;
if ( V_477 == 0 ) {
F_137 ( V_11 , V_168 ) ;
...
if ( ( V_11 -> V_14 -> V_15 -> V_17 & F_243 ( V_481 ) ) ||
V_370 == V_372 ) {
V_11 -> V_482 = 1 ;
F_209 ( V_11 , 1 ) ;
}
...
{
struct V_190 * V_156 = F_60 ( V_11 -> V_170 ) ;
if ( ! V_156 -> V_157 -> V_483 )
return 0 ;
if ( V_11 -> V_87 == V_429 )
return 0 ;
if ( V_11 -> V_87 != V_403 )
return - V_66 ;
return V_156 -> V_157 -> V_483 ( V_156 , V_11 ) ;
}
static int
F_245 ( struct V_1 * V_2 , struct V_7 * V_11 , int V_69 ,
int V_484 )
{
struct V_7 * V_4 = V_2 -> V_4 ;
struct V_190 * V_156 = F_60 ( V_4 -> V_170 ) ;
int V_53 , V_485 , V_477 ;
unsigned V_192 = V_395 ;
enum V_486 V_487 = V_11 -> V_12 ;
const char * V_12 ;
...
V_477 = F_194 ( V_2 , V_69 , V_11 , V_192 , false ) ;
if ( V_477 < 0 )
goto V_243;
V_477 = - V_113 ;
if ( V_487 != V_489 && V_487 != V_11 -> V_12 ) {
...
case V_49 :
case V_398 :
V_11 -> V_342 . V_280 . V_490 = F_228 ( 512 ) ;
break;
case V_13 :
V_11 -> V_342 . V_280 . V_490 = F_228 ( 64 ) ;
break;
case V_400 :
V_11 -> V_342 . V_280 . V_490 = F_228 ( 64 ) ;
break;
case V_399 :
V_11 -> V_342 . V_280 . V_490 = F_228 ( 8 ) ;
break;
default:
goto V_243;
}
...
V_168 , V_11 -> V_170 -> V_491 -> V_157 -> V_492 ) ;
if ( V_4 -> V_142 ) {
...
for ( V_53 = 0 ; V_53 < V_493 ; ( ++ V_53 , F_66 ( 100 ) ) ) {
bool V_494 = false ;
if ( F_189 ( V_11 , V_484 ) ) {
struct V_495 * V_496 ;
int V_497 = 0 ;
...
#define F_247 64
V_496 = F_56 ( F_247 , V_206 ) ;
if ( ! V_496 ) {
V_477 = - V_165 ;
continue;
}
for ( V_485 = 0 ; V_485 < 3 ; ++ V_485 ) {
V_496 -> V_498 = 0 ;
V_497 = F_14 ( V_11 , F_248 () ,
V_61 , V_62 ,
V_499 << 8 , 0 ,
V_496 , F_247 ,
V_500 ) ;
...
if ( V_11 -> V_334 == 0 ) {
for ( V_485 = 0 ; V_485 < V_504 ; ++ V_485 ) {
V_477 = F_240 ( V_11 , V_168 ) ;
if ( V_477 >= 0 )
break;
F_66 ( 200 ) ;
}
...
if ( V_11 -> V_33 . V_498 == 0xff ||
V_11 -> V_12 == V_49 )
V_53 = 512 ;
else
V_53 = V_11 -> V_33 . V_498 ;
if ( F_249 ( & V_11 -> V_342 . V_280 ) != V_53 ) {
if ( V_11 -> V_12 == V_399 ||
...
V_11 -> V_342 . V_280 . V_490 = F_228 ( V_53 ) ;
F_237 ( V_11 ) ;
}
V_477 = F_185 ( V_11 , V_507 ) ;
if ( V_477 < ( signed ) sizeof( V_11 -> V_33 ) ) {
if ( V_477 != - V_113 )
...
if ( V_11 -> V_334 == 0 && F_12 ( V_11 -> V_33 . V_505 ) >= 0x0201 ) {
V_477 = F_250 ( V_11 ) ;
if ( ! V_477 ) {
V_11 -> V_23 = F_5 ( V_11 ) ;
F_11 ( V_11 ) ;
...
V_477 = 0 ;
if ( V_156 -> V_157 -> V_509 )
V_156 -> V_157 -> V_509 ( V_156 , V_11 ) ;
F_242 ( V_11 ) ;
V_243:
if ( V_477 ) {
F_72 ( V_2 , V_69 , 0 ) ;
...
if ( V_11 -> V_329 & V_512 )
return;
V_511 = F_56 ( sizeof *V_511 , V_242 ) ;
if ( V_511 == NULL )
return;
V_80 = F_252 ( V_11 , V_513 , 0 ,
V_511 , sizeof *V_511 ) ;
if ( V_80 == sizeof *V_511 ) {
F_7 ( & V_11 -> V_19 , L_164
L_165 ) ;
if ( V_2 -> V_224 ) {
...
static int V_515 = - 1 ;
if ( V_11 ) {
if ( V_156 -> V_516 && ! V_4 -> V_22 )
F_256 ( V_156 -> V_516 , V_11 -> V_12 ) ;
F_84 ( & V_78 -> V_184 ) ;
}
if ( ! ( V_3 & V_207 ) ||
( V_177 & V_209 ) )
...
V_240 = 100 ;
V_80 = 0 ;
for ( V_53 = 0 ; V_53 < V_517 ; V_53 ++ ) {
V_11 = F_259 ( V_4 , V_4 -> V_170 , V_69 ) ;
if ( ! V_11 ) {
F_30 ( & V_78 -> V_19 ,
L_169 ) ;
goto V_405;
...
if ( F_12 ( V_11 -> V_33 . V_505 ) >= 0x0200
&& V_11 -> V_12 == V_400
&& V_289 != 0 )
F_251 ( V_2 , V_11 , V_69 ) ;
V_80 = 0 ;
...
V_405:
F_72 ( V_2 , V_69 , 1 ) ;
if ( V_156 -> V_157 -> V_526 && ! V_2 -> V_4 -> V_22 )
...
int V_545 ;
char * V_496 ;
if ( memcmp ( & V_11 -> V_33 , V_538 ,
sizeof( * V_538 ) ) != 0 )
return 1 ;
if ( ( V_540 && ! V_11 -> V_14 ) || ( ! V_540 && V_11 -> V_14 ) )
return 1 ;
if ( V_11 -> V_14 ) {
V_543 = F_12 ( V_11 -> V_14 -> V_280 -> V_356 ) ;
if ( V_543 != F_12 ( V_540 -> V_280 -> V_356 ) )
return 1 ;
if ( memcmp ( V_11 -> V_14 -> V_280 , V_540 -> V_280 , V_543 ) )
return 1 ;
}
if ( V_11 -> V_350 )
V_542 = strlen ( V_11 -> V_350 ) + 1 ;
V_543 = V_542 ;
for ( V_541 = 0 ; V_541 < V_11 -> V_33 . V_546 ; V_541 ++ ) {
V_544 = F_12 ( V_11 -> V_353 [ V_541 ] . V_280 . V_356 ) ;
V_543 = F_276 ( V_543 , V_544 ) ;
}
V_496 = F_56 ( V_543 , V_206 ) ;
if ( V_496 == NULL ) {
...
for ( V_541 = 0 ; V_541 < V_11 -> V_33 . V_546 ; V_541 ++ ) {
V_544 = F_12 ( V_11 -> V_353 [ V_541 ] . V_280 . V_356 ) ;
V_545 = F_252 ( V_11 , V_547 , V_541 , V_496 ,
V_544 ) ;
if ( V_545 != V_544 ) {
...
if ( memcmp ( V_496 , V_11 -> V_355 [ V_541 ] , V_544 )
!= 0 ) {
...
if ( ! V_85 && V_542 ) {
V_545 = F_277 ( V_11 , V_11 -> V_33 . V_347 ,
V_496 , V_542 ) ;
if ( V_545 + 1 != V_542 ) {
F_22 ( & V_11 -> V_19 , L_189 ,
V_545 ) ;
V_85 = 1 ;
} else if ( memcmp ( V_496 , V_11 -> V_350 , V_545 ) != 0 ) {
...
{
struct V_7 * V_550 = V_11 -> V_22 ;
struct V_1 * V_551 ;
struct V_190 * V_156 = F_60 ( V_11 -> V_170 ) ;
struct V_495 V_33 = V_11 -> V_33 ;
struct V_539 * V_14 ;
int V_53 , V_485 , V_54 = 0 ;
int V_69 = V_11 -> V_126 ;
if ( V_11 -> V_87 == V_185 ||
V_11 -> V_87 == V_323 ) {
...
for ( V_53 = 0 ; V_53 < V_517 ; ++ V_53 ) {
F_237 ( V_11 ) ;
V_54 = F_245 ( V_551 , V_11 , V_69 , V_53 ) ;
if ( V_54 >= 0 || V_54 == - V_397 || V_54 == - V_113 )
break;
}
if ( V_54 < 0 )
goto V_553;
if ( F_275 ( V_11 , & V_33 , V_14 ) ) {
F_7 ( & V_11 -> V_19 , L_194 ) ;
V_11 -> V_33 = V_33 ;
goto V_553;
}
...
goto V_405;
F_29 ( V_156 -> V_472 ) ;
V_54 = F_278 ( V_11 , V_11 -> V_8 , NULL , NULL ) ;
if ( V_54 < 0 ) {
F_71 ( & V_11 -> V_19 ,
L_195
L_196 ) ;
...
V_54 = F_14 ( V_11 , F_17 ( V_11 , 0 ) ,
V_554 , 0 ,
V_11 -> V_8 -> V_280 . V_549 , 0 ,
NULL , 0 , V_200 ) ;
if ( V_54 < 0 ) {
F_30 ( & V_11 -> V_19 ,
L_197 ,
V_11 -> V_8 -> V_280 . V_549 , V_54 ) ;
F_31 ( V_156 -> V_472 ) ;
goto V_553;
}
F_31 ( V_156 -> V_472 ) ;
F_73 ( V_11 , V_88 ) ;
for ( V_53 = 0 ; V_53 < V_11 -> V_8 -> V_280 . V_555 ; V_53 ++ ) {
struct V_556 * V_353 = V_11 -> V_8 ;
struct V_119 * V_120 = V_353 -> V_10 [ V_53 ] ;
struct V_557 * V_280 ;
V_280 = & V_120 -> V_293 -> V_280 ;
if ( V_280 -> V_558 == 0 ) {
F_279 ( V_11 , V_120 , true ) ;
F_280 ( V_11 , V_120 , true ) ;
V_54 = 0 ;
} else {
V_120 -> V_559 = 1 ;
V_54 = F_97 ( V_11 , V_280 -> V_560 ,
V_280 -> V_558 ) ;
V_120 -> V_559 = 0 ;
}
if ( V_54 < 0 ) {
...
for ( V_485 = 0 ; V_485 < V_120 -> V_293 -> V_280 . V_302 ; V_485 ++ )
V_120 -> V_293 -> V_232 [ V_485 ] . V_561 = 0 ;
}
V_405:
F_209 ( V_11 , 1 ) ;
F_211 ( V_11 ) ;
...
F_184 ( V_11 ) ;
if ( V_353 ) {
for ( V_53 = 0 ; V_53 < V_353 -> V_280 . V_555 ; ++ V_53 ) {
struct V_119 * V_563 = V_353 -> V_10 [ V_53 ] ;
struct V_564 * V_155 ;
int V_565 = 0 ;
if ( V_563 -> V_19 . V_157 ) {
V_155 = F_283 ( V_563 -> V_19 . V_157 ) ;
if ( V_155 -> V_566 && V_155 -> V_567 )
V_565 = ( V_155 -> V_566 ) ( V_563 ) ;
else if ( V_563 -> V_568 ==
V_569 )
V_565 = 1 ;
if ( V_565 )
...
F_199 ( V_78 ) ;
if ( V_353 ) {
for ( V_53 = V_353 -> V_280 . V_555 - 1 ; V_53 >= 0 ; -- V_53 ) {
struct V_119 * V_563 = V_353 -> V_10 [ V_53 ] ;
struct V_564 * V_155 ;
int V_570 = V_563 -> V_571 ;
if ( ! V_570 && V_563 -> V_19 . V_157 ) {
V_155 = F_283 ( V_563 -> V_19 . V_157 ) ;
if ( V_155 -> V_567 )
V_570 = ( V_155 -> V_567 ) ( V_563 ) ;
else if ( V_563 -> V_568 ==
V_569 )
V_570 = 1 ;
if ( V_570 )
...
if ( V_370 == V_372 ) {
T_2 V_575 = 1 << ( V_53 % 8 ) ;
if ( ! ( V_280 -> V_34 . V_248 . V_249 [ V_53 / 8 ] & V_575 ) ) {
F_22 ( & V_78 -> V_19 , L_201 ) ;
V_280 -> V_34 . V_248 . V_249 [ V_53 / 8 ] |= V_575 ;
}
}
}
} else {
T_1 V_576 = F_12 ( V_280 -> V_34 . V_35 . V_249 ) ;
for ( V_53 = 1 ; V_53 <= V_4 -> V_9 ; V_53 ++ ) {
struct V_77 * V_78 = V_2 -> V_79 [ V_53 - 1 ] ;
V_370 = V_78 -> V_370 ;
if ( V_370 == V_372 ) {
...
V_280 -> V_34 . V_35 . V_249 = F_228 ( V_576 ) ;
}
}
...
if ( ! V_2 )
return NULL ;
return F_290 ( & V_2 -> V_79 [ V_69 - 1 ] -> V_19 ) ;
}
