...
return F_144 ( V_202 , 1 , 14 , V_275 ) ;
}
static int F_145 ( struct V_26 * V_27 ,
struct V_28 * V_29 )
{
struct V_1 * V_2 = F_19 ( V_27 ) ;
static const unsigned char V_276 [ 16 ] = {
9 , 6 , 3 , 1 , 7 , 4 , 0 , 12 , 8 , 5 , 2 , 11 , 255 , 255 , 255 , 10
} ;
unsigned char V_14 ;
F_21 ( & V_2 -> V_34 ) ;
if ( F_1 ( V_2 ) ) {
V_29 -> V_30 . V_277 . V_278 [ 0 ] = 13 ;
} else {
V_14 = V_276 [ F_2 ( F_3 ( V_2 , V_3 ) ) & 15 ] ;
if ( V_14 == 255 ) {
F_88 () ;
V_14 = 0 ;
}
V_29 -> V_30 . V_277 . V_278 [ 0 ] = V_14 ;
}
F_22 ( & V_2 -> V_34 ) ;
return 0 ;
}
...
{
struct V_1 * V_2 = F_19 ( V_27 ) ;
static const unsigned int V_279 [ 13 ] = {
...
int V_200 = 0 ;
F_21 ( & V_2 -> V_34 ) ;
V_280 = F_2 ( F_3 ( V_2 , V_3 ) ) ;
if ( V_29 -> V_30 . V_277 . V_278 [ 0 ] == 13 ) {
F_6 ( V_280 | V_4 , F_3 ( V_2 , V_3 ) ) ;
} else {
V_184 = V_279 [ V_29 -> V_30 . integer . V_30 [ 0 ] % 13 ] ;
F_22 ( & V_2 -> V_34 ) ;
F_87 ( V_2 , V_184 , 1 ) ;
F_21 ( & V_2 -> V_34 ) ;
}
V_200 = F_2 ( F_3 ( V_2 , V_3 ) ) != V_280 ;
F_22 ( & V_2 -> V_34 ) ;
if ( ( V_280 & V_4 ) !=
( F_2 ( F_3 ( V_2 , V_3 ) ) & V_4 ) )
F_44 ( V_2 , F_1 ( V_2 ) ) ;
...
int V_281 = F_110 ( V_27 , & V_202 -> V_198 ) < 2 ? 12 : 11 ;
return F_144 ( V_202 , 1 , V_281 , V_275 ) ;
}
...
unsigned int V_14 , V_282 ;
F_21 ( & V_2 -> V_34 ) ;
V_14 = F_15 ( F_3 ( V_2 , V_250 ) ) ;
V_282 = F_10 ( F_3 ( V_2 , V_251 ) ) ;
F_22 ( & V_2 -> V_34 ) ;
V_14 >>= ( ( V_79 % 2 ) * 8 ) + ( ( V_79 / 2 ) * 2 ) ;
V_14 &= 3 ;
V_282 >>= ( ( V_79 / 2 ) * 8 ) + ( ( V_79 % 2 ) * 4 ) ;
if ( V_14 == 1 && V_79 < 2 )
V_29 -> V_30 . V_277 . V_278 [ 0 ] = 11 ;
else if ( V_14 == 2 )
V_29 -> V_30 . V_277 . V_278 [ 0 ] = ( V_282 & 7 ) + 1 ;
else if ( V_14 == 3 )
V_29 -> V_30 . V_277 . V_278 [ 0 ] = ( ( V_282 >> 3 ) & 1 ) + 9 ;
else
V_29 -> V_30 . V_277 . V_278 [ 0 ] = 0 ;
return 0 ;
}
...
int V_200 , V_283 ;
int V_79 = F_110 ( V_27 , & V_29 -> V_198 ) ;
unsigned int V_14 , V_284 , V_33 ;
if ( V_29 -> V_30 . V_277 . V_278 [ 0 ] >= 11 )
V_33 = V_79 < 2 ? 1 : 0 ;
else if ( V_29 -> V_30 . V_277 . V_278 [ 0 ] >= 9 )
V_33 = 3 ;
else if ( V_29 -> V_30 . V_277 . V_278 [ 0 ] >= 1 )
V_33 = 2 ;
else
V_33 = 0 ;
V_283 = ( ( V_79 % 2 ) * 8 ) + ( ( V_79 / 2 ) * 2 ) ;
F_21 ( & V_2 -> V_34 ) ;
V_14 = V_284 = F_15 ( F_3 ( V_2 , V_250 ) ) ;
V_14 &= ~ ( 0x03 << V_283 ) ;
V_14 |= V_33 << V_283 ;
V_200 = V_14 != V_284 ;
if ( V_200 )
...
return V_200 ;
F_21 ( & V_2 -> V_34 ) ;
V_14 = V_284 = F_10 ( F_3 ( V_2 , V_251 ) ) ;
V_283 = ( ( V_79 / 2 ) * 8 ) + ( ( V_79 % 2 ) * 4 ) ;
if ( V_33 == 2 ) {
V_33 = V_29 -> V_30 . V_277 . V_278 [ 0 ] - 1 ;
V_14 &= ~ ( 0x07 << V_283 ) ;
V_14 |= V_33 << V_283 ;
} else {
V_33 = ( V_29 -> V_30 . V_277 . V_278 [ 0 ] - 9 ) << 3 ;
V_14 &= ~ ( 0x08 << V_283 ) ;
V_14 |= V_33 << V_283 ;
}
if ( V_14 != V_284 ) {
...
{
struct V_1 * V_2 = F_19 ( V_27 ) ;
V_29 -> V_30 . integer . V_30 [ 0 ] = F_2 ( F_3 ( V_2 , V_285 ) ) ;
return 0 ;
}
...
int V_200 ;
F_21 ( & V_2 -> V_34 ) ;
V_200 = F_2 ( F_3 ( V_2 , V_285 ) ) != V_29 -> V_30 . integer . V_30 [ 0 ] ;
F_6 ( V_29 -> V_30 . integer . V_30 [ 0 ] , F_3 ( V_2 , V_285 ) ) ;
F_22 ( & V_2 -> V_34 ) ;
return V_200 ;
}
...
F_6 ( V_79 , F_3 ( V_2 , V_286 ) ) ;
V_29 -> V_30 . integer . V_30 [ V_79 ] = F_2 ( F_3 ( V_2 , V_287 ) ) ;
}
F_22 ( & V_2 -> V_34 ) ;
return 0 ;
}
...
{
long V_288 = 0x10000 ;
F_6 ( V_7 , F_12 ( V_2 , V_289 ) ) ;
F_6 ( V_50 & ~ V_290 , F_12 ( V_2 , V_291 ) ) ;
while ( V_288 -- > 0 && ( F_2 ( F_12 ( V_2 , V_292 ) ) & V_293 ) ) ;
return F_2 ( F_12 ( V_2 , V_294 ) ) ;
}
...
struct V_296 * const * V_297 , * V_298 ;
if ( ! V_295 || ! * V_295 ) {
V_2 -> V_226 . V_235 = 0 ;
if ( ( F_2 ( F_12 ( V_2 , V_292 ) ) & V_299 ) != 0 )
V_2 -> V_226 . V_235 = ( F_164 ( V_2 , V_50 , 0x00 ) << 0 ) |
...
T_4 V_300 , V_145 ;
F_166 ( V_2 -> V_156 , V_301 , & V_300 ) ;
F_166 ( V_2 -> V_156 , V_302 , & V_145 ) ;
V_2 -> V_226 . V_235 = ( ( unsigned int ) F_167 ( V_300 ) << 16 ) | F_167 ( V_145 ) ;
...
for ( V_297 = V_304 ; * V_297 ; V_297 ++ ) {
for ( V_298 = * V_297 ; V_298 -> V_235 ; V_298 ++ ) {
if ( V_295 && V_298 -> V_305 && ! strcmp ( V_295 , V_298 -> V_305 ) ) {
F_168 ( V_2 -> V_49 -> V_50 ,
L_64 , V_298 -> V_154 ) ;
V_2 -> V_226 . V_235 = V_298 -> V_235 ;
} else if ( V_298 -> V_235 != V_2 -> V_226 . V_235 )
continue;
if ( ! V_298 -> V_306 || ! V_298 -> V_307 )
goto V_308;
F_169 ( V_2 -> V_49 -> V_50 , L_65 ) ;
V_2 -> V_226 . V_237 = 1 ;
V_2 -> V_226 . V_236 = V_298 -> V_306 + 6 ;
memcpy ( V_2 -> V_226 . V_8 , V_298 -> V_307 , V_298 -> V_306 ) ;
goto V_309;
}
}
...
V_2 -> V_226 . V_235 ) ;
V_308:
V_2 -> V_226 . V_236 = F_164 ( V_2 , V_50 , 0x04 ) ;
...
V_2 -> V_226 . V_237 = F_164 ( V_2 , V_50 , 0x05 ) ;
...
V_2 -> V_226 . V_8 [ V_57 ] = F_164 ( V_2 , V_50 , V_57 + 6 ) ;
V_309:
V_2 -> V_226 . V_241 = V_2 -> V_226 . V_8 [ V_310 ] ;
V_2 -> V_226 . V_242 = V_2 -> V_226 . V_8 [ V_311 ] ;
V_2 -> V_226 . V_243 = V_2 -> V_226 . V_8 [ V_312 ] ;
return 0 ;
}
static int F_170 ( struct V_1 * V_2 )
{
F_6 ( V_313 | V_314 , F_12 ( V_2 , V_315 ) ) ;
F_171 ( 200 ) ;
F_6 ( V_314 , F_12 ( V_2 , V_315 ) ) ;
F_171 ( 200 ) ;
if ( V_2 -> V_226 . V_235 == V_316 &&
! V_2 -> V_317 )
V_2 -> V_226 . V_8 [ V_238 ] = 0x3a ;
F_172 ( V_2 -> V_156 , 0x60 , V_2 -> V_226 . V_8 [ V_238 ] ) ;
F_172 ( V_2 -> V_156 , 0x61 , V_2 -> V_226 . V_8 [ V_227 ] ) ;
F_172 ( V_2 -> V_156 , 0x62 , V_2 -> V_226 . V_8 [ V_239 ] ) ;
F_172 ( V_2 -> V_156 , 0x63 , V_2 -> V_226 . V_8 [ V_240 ] ) ;
if ( V_2 -> V_226 . V_235 != V_318 ) {
V_2 -> V_171 . V_319 = V_2 -> V_226 . V_241 ;
V_2 -> V_171 . V_320 = V_2 -> V_226 . V_243 ;
F_24 ( V_2 , V_36 ,
V_2 -> V_226 . V_241 ) ;
F_24 ( V_2 , V_35 ,
V_2 -> V_226 . V_243 ) ;
...
V_2 -> V_171 . V_319 = 0xc0 ;
V_2 -> V_171 . V_320 = 0xff ;
F_24 ( V_2 , V_36 , 0xc0 ) ;
F_24 ( V_2 , V_35 , 0xff ) ;
F_24 ( V_2 , V_37 ,
V_321 ) ;
...
F_24 ( V_2 , V_322 , 0 ) ;
if ( ! ( V_2 -> V_226 . V_8 [ V_238 ] & V_323 ) ) {
F_6 ( V_324 , F_12 ( V_2 , V_18 ) ) ;
F_171 ( 100 ) ;
F_6 ( 0 , F_12 ( V_2 , V_18 ) ) ;
F_171 ( 200 ) ;
F_24 ( V_2 , V_325 , 0 ) ;
...
F_87 ( V_2 , 48000 , 1 ) ;
F_6 ( ( ( V_2 -> V_226 . V_8 [ V_238 ] & V_326 ) == 0 ?
V_69 : 0 ) |
( ( V_2 -> V_226 . V_8 [ V_238 ] & V_323 ) ?
V_78 | V_83 | V_85 : 0 ) ,
F_12 ( V_2 , V_327 ) ) ;
...
if ( F_174 ( ! V_2 -> V_190 ) )
return - V_42 ;
V_46 = F_116 ( V_2 -> V_49 , V_328 = F_117 ( & V_329 , V_2 ) ) ;
if ( V_46 < 0 )
return V_46 ;
V_328 -> V_198 . V_145 = V_2 -> V_190 -> V_145 ;
V_46 = F_116 ( V_2 -> V_49 , V_328 = F_117 ( & V_330 , V_2 ) ) ;
if ( V_46 < 0 )
return V_46 ;
V_328 -> V_198 . V_145 = V_2 -> V_190 -> V_145 ;
V_46 = F_116 ( V_2 -> V_49 , V_328 = F_117 ( & V_331 , V_2 ) ) ;
if ( V_46 < 0 )
return V_46 ;
V_328 -> V_198 . V_145 = V_2 -> V_190 -> V_145 ;
V_46 = F_116 ( V_2 -> V_49 , V_328 = F_117 ( & V_332 , V_2 ) ) ;
if ( V_46 < 0 )
return V_46 ;
V_328 -> V_198 . V_145 = V_2 -> V_190 -> V_145 ;
V_2 -> V_51 . V_333 = V_328 ;
return 0 ;
}
...
return V_46 ;
if ( V_2 -> V_338 > 0 ) {
struct V_210 V_91 = V_339 ;
V_91 . V_204 = V_2 -> V_338 ;
...
if ( ! V_2 -> V_343 )
goto V_344;
F_6 ( V_345 | V_346 , F_3 ( V_2 , V_72 ) ) ;
F_6 ( 0xff , F_12 ( V_2 , V_327 ) ) ;
V_344:
if ( V_2 -> V_61 >= 0 )
F_177 ( V_2 -> V_61 , V_2 ) ;
if ( V_2 -> V_343 )
...
static int F_182 ( struct V_348 * V_145 )
{
struct V_1 * V_2 = V_145 -> V_349 ;
return F_176 ( V_2 ) ;
}
static int F_183 ( struct V_207 * V_49 ,
struct V_350 * V_156 ,
const char * V_295 ,
int V_351 ,
int V_47 ,
...
if ( V_46 < 0 )
return V_46 ;
if ( F_185 ( V_156 , F_186 ( 28 ) ) < 0 ||
F_187 ( V_156 , F_186 ( 28 ) ) < 0 ) {
F_43 ( V_49 -> V_50 ,
L_69 ) ;
F_180 ( V_156 ) ;
return - V_303 ;
}
V_2 = F_188 ( sizeof( * V_2 ) , V_355 ) ;
if ( V_2 == NULL ) {
F_180 ( V_156 ) ;
return - V_356 ;
}
...
V_2 -> V_61 = - 1 ;
F_191 ( V_156 ) ;
F_192 ( V_2 -> V_156 , 0x40 , 0x807f ) ;
F_192 ( V_2 -> V_156 , 0x42 , 0x0006 ) ;
F_125 ( V_2 ) ;
F_193 ( V_156 -> V_61 ) ;
V_49 -> V_15 = V_2 ;
V_46 = F_194 ( V_156 , L_70 ) ;
if ( V_46 < 0 ) {
F_181 ( V_2 ) ;
F_180 ( V_156 ) ;
return V_46 ;
}
V_2 -> V_343 = F_195 ( V_156 , 0 ) ;
V_2 -> V_107 = F_195 ( V_156 , 1 ) ;
V_2 -> V_368 = F_195 ( V_156 , 2 ) ;
V_2 -> V_369 = F_195 ( V_156 , 3 ) ;
if ( F_196 ( V_156 -> V_61 , F_45 , V_370 ,
V_371 , V_2 ) ) {
...
V_46 = F_197 ( V_49 , V_372 , V_2 , & V_52 ) ;
if ( V_46 < 0 ) {
F_176 ( V_2 ) ;
return V_46 ;
}
...
static int F_198 ( struct V_350 * V_156 ,
...
V_46 = F_199 ( & V_156 -> V_50 , V_192 [ V_50 ] , V_198 [ V_50 ] , V_380 ,
0 , & V_49 ) ;
if ( V_46 < 0 )
return V_46 ;
strcpy ( V_49 -> V_381 , L_70 ) ;
strcpy ( V_49 -> V_382 , L_72 ) ;
V_46 = F_183 ( V_49 , V_156 , V_305 [ V_50 ] , V_351 [ V_50 ] ,
V_47 [ V_50 ] , V_317 [ V_50 ] , & V_2 ) ;
if ( V_46 < 0 ) {
F_200 ( V_49 ) ;
return V_46 ;
}
for ( V_297 = V_304 ; * V_297 ; V_297 ++ ) {
for ( V_298 = * V_297 ; V_298 -> V_235 ; V_298 ++ ) {
if ( V_298 -> V_235 == V_2 -> V_226 . V_235 ) {
V_2 -> V_383 = V_298 ;
strcpy ( V_49 -> V_382 , V_298 -> V_154 ) ;
if ( V_298 -> V_381 )
strcpy ( V_49 -> V_381 , V_298 -> V_381 ) ;
if ( V_298 -> V_384 ) {
V_46 = V_298 -> V_384 ( V_2 ) ;
if ( V_46 < 0 ) {
F_200 ( V_49 ) ;
return V_46 ;
}
...
V_298 = & V_386 ;
V_385:
V_46 = F_105 ( V_2 , V_375 ++ , NULL ) ;
if ( V_46 < 0 ) {
F_200 ( V_49 ) ;
return V_46 ;
}
if ( F_120 ( V_2 ) ) {
V_46 = F_77 ( V_2 , V_375 ++ , NULL ) ;
if ( V_46 < 0 ) {
F_200 ( V_49 ) ;
return V_46 ;
}
...
L_73 , V_298 -> V_394 , V_49 -> V_98 ) ;
if ( V_2 -> V_226 . V_8 [ V_238 ] & V_326 ) {
V_46 = F_201 ( V_49 , 1 , V_389 ,
F_12 ( V_2 , V_395 ) ,
V_298 -> V_396 |
V_392 | V_393 ,
- 1 , & V_2 -> V_67 [ 1 ] ) ;
...
static void F_204 ( struct V_350 * V_156 )
{
struct V_207 * V_49 = F_205 ( V_156 ) ;
struct V_1 * V_2 = V_49 -> V_15 ;
if ( V_2 -> V_383 && V_2 -> V_383 -> V_398 )
V_2 -> V_383 -> V_398 ( V_2 ) ;
F_200 ( V_49 ) ;
}
static int F_206 ( struct V_145 * V_50 )
{
struct V_350 * V_156 = F_207 ( V_50 ) ;
struct V_207 * V_49 = F_208 ( V_50 ) ;
struct V_1 * V_2 = V_49 -> V_15 ;
if ( ! V_2 -> V_399 )
return 0 ;
F_209 ( V_49 , V_400 ) ;
...
F_21 ( & V_2 -> V_34 ) ;
V_2 -> V_401 = F_1 ( V_2 ) ;
V_2 -> V_402 = F_15 ( F_3 ( V_2 , V_252 ) ) ;
V_2 -> V_403 = F_15 ( F_3 ( V_2 , V_250 ) ) ;
F_22 ( & V_2 -> V_34 ) ;
if ( V_2 -> V_404 )
V_2 -> V_404 ( V_2 ) ;
F_180 ( V_156 ) ;
...
static int F_214 ( struct V_145 * V_50 )
{
struct V_350 * V_156 = F_207 ( V_50 ) ;
struct V_207 * V_49 = F_208 ( V_50 ) ;
struct V_1 * V_2 = V_49 -> V_15 ;
...
F_13 ( V_2 -> V_402 , F_3 ( V_2 , V_252 ) ) ;
F_13 ( V_2 -> V_403 , F_3 ( V_2 , V_250 ) ) ;
F_217 ( V_2 -> V_12 ) ;
F_209 ( V_49 , V_408 ) ;
return 0 ;
}
