...
{
int V_31 ;
V_31 = F_24 ( V_30 , & V_7 -> V_25 ,
V_7 -> V_10 -> V_11 ) ;
if ( V_31 )
return V_31 ;
V_7 -> V_3 . V_32 = V_33 ;
F_25 ( & V_7 -> V_25 , & V_34 ) ;
F_26 ( V_30 , & V_7 -> V_25 , & V_35 ,
V_36 ) ;
F_27 ( & V_7 -> V_3 ,
& V_37 ) ;
F_28 ( V_30 , & V_7 -> V_3 , & V_38 ,
V_39 ) ;
if ( V_7 -> V_13 )
...
static int F_31 ( struct V_40 * V_10 , struct V_40 * V_41 , void * V_42 )
{
...
int V_31 ;
const char * V_45 ;
V_7 = F_32 ( V_10 , sizeof( * V_7 ) , V_46 ) ;
if ( ! V_7 )
return - V_47 ;
V_44 = F_33 ( V_9 , L_1 , & V_7 -> V_48 ) ;
if ( V_44 )
V_7 -> V_16 = F_34 ( V_44 , V_7 -> V_48 , V_46 ) ;
V_31 = F_35 ( V_9 , L_2 , & V_45 ) ;
if ( ! V_31 ) {
if ( ! strcmp ( V_45 , L_3 ) )
V_7 -> V_28 = V_49 ;
...
static void F_40 ( struct V_40 * V_10 , struct V_40 * V_41 ,
void * V_42 )
{
