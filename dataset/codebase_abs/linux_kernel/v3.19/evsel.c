...
static int F_51 ( struct V_1 * T_1 , int V_164 , int V_165 )
{
int V_166 , V_167 ;
if ( T_1 -> V_168 )
V_165 = 1 ;
T_1 -> V_169 = F_52 ( V_164 , V_165 , sizeof( int ) ) ;
if ( T_1 -> V_169 ) {
for ( V_166 = 0 ; V_166 < V_164 ; V_166 ++ ) {
for ( V_167 = 0 ; V_167 < V_165 ; V_167 ++ ) {
F_53 ( T_1 , V_166 , V_167 ) = - 1 ;
}
}
}
return T_1 -> V_169 != NULL ? 0 : - V_170 ;
}
static int F_54 ( struct V_1 * T_1 , int V_164 , int V_165 ,
int V_171 , void * V_172 )
{
int V_166 , V_167 ;
if ( T_1 -> V_168 )
V_165 = 1 ;
for ( V_166 = 0 ; V_166 < V_164 ; V_166 ++ ) {
for ( V_167 = 0 ; V_167 < V_165 ; V_167 ++ ) {
int V_169 = F_53 ( T_1 , V_166 , V_167 ) ,
V_80 = F_55 ( V_169 , V_171 , V_172 ) ;
if ( V_80 )
return V_80 ;
}
}
...
int F_56 ( struct V_1 * T_1 , int V_164 , int V_165 ,
const char * V_173 )
{
return F_54 ( T_1 , V_164 , V_165 ,
V_174 ,
( void * ) V_173 ) ;
}
int F_57 ( struct V_1 * T_1 , int V_164 , int V_165 )
{
return F_54 ( T_1 , V_164 , V_165 ,
V_175 ,
0 ) ;
}
int F_58 ( struct V_1 * T_1 , int V_164 , int V_165 )
{
if ( T_1 -> V_168 )
V_165 = 1 ;
T_1 -> V_176 = F_52 ( V_164 , V_165 , sizeof( struct V_177 ) ) ;
if ( T_1 -> V_176 == NULL )
return - V_170 ;
T_1 -> V_46 = F_18 ( V_164 * V_165 * sizeof( T_3 ) ) ;
if ( T_1 -> V_46 == NULL ) {
F_59 ( T_1 -> V_176 ) ;
T_1 -> V_176 = NULL ;
return - V_170 ;
...
void F_60 ( struct V_1 * T_1 , int V_164 )
{
memset ( T_1 -> V_178 , 0 , ( sizeof( * T_1 -> V_178 ) +
( V_164 * sizeof( struct V_179 ) ) ) ) ;
}
int F_61 ( struct V_1 * T_1 , int V_164 )
{
T_1 -> V_178 = F_18 ( ( sizeof( * T_1 -> V_178 ) +
( V_164 * sizeof( struct V_179 ) ) ) ) ;
return T_1 -> V_178 != NULL ? 0 : - V_170 ;
}
...
void F_64 ( struct V_1 * T_1 , int V_164 , int V_165 )
{
int V_166 , V_167 ;
if ( T_1 -> V_168 )
V_165 = 1 ;
...
void F_71 ( struct V_1 * T_1 , int V_166 ,
struct V_179 * V_181 )
{
struct V_179 V_182 ;
if ( ! T_1 -> V_183 )
return;
if ( V_166 == - 1 ) {
V_182 = T_1 -> V_183 -> V_184 ;
T_1 -> V_183 -> V_184 = * V_181 ;
} else {
V_182 = T_1 -> V_183 -> V_166 [ V_166 ] ;
T_1 -> V_183 -> V_166 [ V_166 ] = * V_181 ;
}
V_181 -> V_185 = V_181 -> V_185 - V_182 . V_185 ;
V_181 -> V_186 = V_181 -> V_186 - V_182 . V_186 ;
V_181 -> V_187 = V_181 -> V_187 - V_182 . V_187 ;
}
void F_72 ( struct V_179 * V_181 ,
bool V_36 , T_7 * V_188 )
{
T_7 V_189 = 0 ;
if ( V_36 ) {
...
V_189 = - 1 ;
V_181 -> V_185 = 0 ;
} else if ( V_181 -> V_187 < V_181 -> V_186 ) {
V_189 = 1 ;
V_181 -> V_185 = ( T_3 ) ( ( double ) V_181 -> V_185 * V_181 -> V_186 / V_181 -> V_187 + 0.5 ) ;
}
} else
V_181 -> V_186 = V_181 -> V_187 = 0 ;
if ( V_188 )
* V_188 = V_189 ;
}
int F_73 ( struct V_1 * T_1 , int V_166 , int V_167 ,
T_8 V_190 )
{
struct V_179 V_181 ;
memset ( & V_181 , 0 , sizeof( V_181 ) ) ;
if ( F_53 ( T_1 , V_166 , V_167 ) < 0 )
return - V_7 ;
if ( F_74 ( F_53 ( T_1 , V_166 , V_167 ) , & V_181 , sizeof( V_181 ) ) < 0 )
return - V_191 ;
return V_190 ( T_1 , V_166 , V_167 , & V_181 ) ;
}
int F_75 ( struct V_1 * T_1 ,
int V_166 , int V_167 , bool V_36 )
{
struct V_179 V_181 ;
T_2 V_192 = V_36 ? 3 : 1 ;
if ( F_53 ( T_1 , V_166 , V_167 ) < 0 )
return - V_7 ;
if ( T_1 -> V_178 == NULL && F_61 ( T_1 , V_166 + 1 ) < 0 )
return - V_170 ;
if ( F_74 ( F_53 ( T_1 , V_166 , V_167 ) , & V_181 , V_192 * sizeof( T_3 ) ) < 0 )
return - V_191 ;
F_71 ( T_1 , V_166 , & V_181 ) ;
F_72 ( & V_181 , V_36 , NULL ) ;
T_1 -> V_178 -> V_166 [ V_166 ] = V_181 ;
return 0 ;
}
static int F_76 ( struct V_1 * T_1 , int V_166 , int V_167 )
{
struct V_1 * V_34 = T_1 -> V_34 ;
int V_169 ;
if ( F_49 ( T_1 ) )
return - 1 ;
F_77 ( ! V_34 -> V_169 ) ;
V_169 = F_53 ( V_34 , V_166 , V_167 ) ;
F_77 ( V_169 == - 1 ) ;
return V_169 ;
}
static T_2 F_78 ( struct V_32 * V_22 , T_9 * V_193 )
{
T_2 V_85 = 0 ;
V_85 += fprintf ( V_193 , L_30 , V_194 ) ;
V_85 += fprintf ( V_193 , L_31 ) ;
V_85 += F_79 ( type ) ;
V_85 += F_79 ( V_6 ) ;
V_85 += F_80 ( V_45 ) ;
V_85 += F_81 ( V_47 ) ;
...
V_85 += F_80 ( V_8 ) ;
V_85 += F_80 ( V_30 ) ;
V_85 += F_82 ( V_160 , V_115 ) ;
V_85 += F_82 ( V_195 , V_196 ) ;
V_85 += F_82 ( V_55 , V_54 ) ;
V_85 += F_82 ( V_56 , V_197 ) ;
V_85 += F_82 ( V_155 , V_157 ) ;
V_85 += F_82 ( V_156 , V_198 ) ;
V_85 += F_82 ( V_127 , V_132 ) ;
V_85 += F_82 ( V_162 , V_199 ) ;
...
V_165 = V_208 -> V_216 ;
if ( T_1 -> V_169 == NULL &&
F_51 ( T_1 , V_206 -> V_216 , V_165 ) < 0 )
return - V_170 ;
if ( T_1 -> V_180 ) {
V_209 |= V_217 ;
V_211 = T_1 -> V_180 -> V_169 ;
}
V_218:
if ( V_114 . V_219 )
...
if ( V_221 >= 2 )
F_78 ( & T_1 -> V_22 , V_222 ) ;
for ( V_166 = 0 ; V_166 < V_206 -> V_216 ; V_166 ++ ) {
for ( V_167 = 0 ; V_167 < V_165 ; V_167 ++ ) {
int V_223 ;
if ( ! T_1 -> V_180 && ! T_1 -> V_168 )
V_211 = V_208 -> V_224 [ V_167 ] ;
V_223 = F_76 ( T_1 , V_166 , V_167 ) ;
V_225:
F_86 ( L_34 ,
V_211 , V_206 -> V_224 [ V_166 ] , V_223 , V_209 ) ;
F_53 ( T_1 , V_166 , V_167 ) = F_87 ( & T_1 -> V_22 ,
V_211 ,
V_206 -> V_224 [ V_166 ] ,
V_223 , V_209 ) ;
if ( F_53 ( T_1 , V_166 , V_167 ) < 0 ) {
...
if ( V_80 != - V_7 || V_166 > 0 || V_167 > 0 )
goto V_234;
if ( ! V_114 . V_219 && ( V_209 & V_210 ) ) {
V_114 . V_219 = true ;
goto V_218;
} else if ( ! V_114 . V_156 && T_1 -> V_22 . V_156 ) {
V_114 . V_156 = true ;
goto V_218;
} else if ( ! V_114 . V_62 &&
...
void F_90 ( struct V_1 * T_1 , int V_164 , int V_165 )
{
if ( T_1 -> V_169 == NULL )
return;
F_64 ( T_1 , V_164 , V_165 ) ;
F_62 ( T_1 ) ;
}
...
V_254 -> V_166 = V_254 -> V_211 = V_254 -> V_250 = - 1 ;
...
static int F_110 ( T_9 * V_193 , bool * V_303 , const char * V_304 , ... )
{
T_11 args ;
int V_85 = 0 ;
if ( ! * V_303 ) {
V_85 += fprintf ( V_193 , L_38 ) ;
} else {
V_85 += fprintf ( V_193 , L_9 ) ;
* V_303 = false ;
}
va_start ( args , V_304 ) ;
V_85 += vfprintf ( V_193 , V_304 , args ) ;
va_end ( args ) ;
return V_85 ;
}
static int F_111 ( T_9 * V_193 , bool * V_303 , const char * V_300 , T_3 V_264 )
{
if ( V_264 == 0 )
return 0 ;
return F_110 ( V_193 , V_303 , L_39 V_305 , V_300 , V_264 ) ;
}
static int F_112 ( T_9 * V_193 , const char * V_300 , T_3 V_264 ,
struct V_306 * V_307 , bool * V_303 )
{
int V_11 = 0 , V_308 = F_110 ( V_193 , V_303 , L_40 , V_300 ) ;
bool V_309 = true ;
do {
if ( V_264 & V_307 [ V_11 ] . V_25 ) {
V_308 += fprintf ( V_193 , L_41 , V_309 ? L_1 : L_42 , V_307 [ V_11 ] . V_39 ) ;
V_309 = false ;
}
} while ( V_307 [ ++ V_11 ] . V_39 != NULL );
return V_308 ;
}
static int F_113 ( T_9 * V_193 , bool * V_303 , T_3 V_264 )
{
...
#undef F_114
return F_112 ( V_193 , L_43 , V_264 , V_307 , V_303 ) ;
}
static int F_115 ( T_9 * V_193 , bool * V_303 , T_3 V_264 )
{
...
#undef F_114
return F_112 ( V_193 , L_44 , V_264 , V_307 , V_303 ) ;
}
int F_116 ( struct V_1 * T_1 ,
struct V_314 * V_315 , T_9 * V_193 )
{
bool V_303 = true ;
int V_308 = 0 ;
if ( V_315 -> V_316 ) {
...
return 0 ;
if ( T_1 -> V_121 > 1 )
V_308 += fprintf ( V_193 , L_45 , T_1 -> V_91 ? : L_1 ) ;
V_308 += fprintf ( V_193 , L_6 , F_39 ( T_1 ) ) ;
F_43 (pos, evsel)
V_308 += fprintf ( V_193 , L_46 , F_39 ( V_93 ) ) ;
if ( T_1 -> V_121 > 1 )
V_308 += fprintf ( V_193 , L_47 ) ;
goto V_317;
}
V_308 += fprintf ( V_193 , L_6 , F_39 ( T_1 ) ) ;
if ( V_315 -> V_221 || V_315 -> V_127 ) {
V_308 += F_110 ( V_193 , & V_303 , L_48 V_305 ,
( T_3 ) T_1 -> V_22 . V_129 ) ;
}
if ( V_315 -> V_221 ) {
F_117 ( type ) ;
...
F_117 ( V_204 ) ;
F_117 ( V_6 ) ;
V_308 += F_113 ( V_193 , & V_303 , T_1 -> V_22 . V_8 ) ;
if ( T_1 -> V_22 . V_30 )
V_308 += F_115 ( V_193 , & V_303 , T_1 -> V_22 . V_30 ) ;
F_117 ( V_160 ) ;
F_117 ( V_115 ) ;
F_117 ( V_195 ) ;
F_117 ( V_196 ) ;
