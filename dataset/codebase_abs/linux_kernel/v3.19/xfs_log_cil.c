...
if ( V_29 -> V_65 -> V_9 < 0 )
F_49 ( V_74 , V_29 -> V_65 ) ;
V_29 -> V_130 = V_52 -> V_11 -> V_13 ;
if ( V_93 )
* V_93 = V_29 -> V_130 ;
F_35 ( V_74 , V_29 -> V_65 , NULL , V_127 ) ;
F_50 ( V_29 ) ;
F_51 ( V_29 , V_29 -> V_130 , 0 ) ;
F_41 ( log ) ;
F_52 ( & V_52 -> V_95 ) ;
}
T_1
...
if ( F_7 ( & V_34 -> V_58 ) )
return false ;
V_54 = V_34 -> V_133 -> V_126 -> V_10 -> V_11 ;
...
struct V_51 * V_52 ;
struct V_53 * V_54 ;
V_52 = F_10 ( sizeof( * V_52 ) , V_5 | V_134 ) ;
if ( ! V_52 )
return - V_135 ;
V_54 = F_10 ( sizeof( * V_54 ) , V_5 | V_134 ) ;
if ( ! V_54 ) {
F_5 ( V_52 ) ;
return - V_135 ;
}
