...
break;
case V_103 :
F_26 ( V_81 , L_10 , args [ 0 ] . V_104 ) ;
if ( V_5 -> V_17 )
V_7 = - V_78 ;
if ( strcmp ( args [ 0 ] . V_104 , L_11 ) == 0 )
V_5 -> V_17 = V_59 ;
else if ( strcmp ( args [ 0 ] . V_104 , L_12 ) == 0 )
V_5 -> V_17 = V_59 ;
else if ( strcmp ( args [ 0 ] . V_104 , L_13 ) == 0 )
V_5 -> V_17 = V_55 ;
else if ( strcmp ( args [ 0 ] . V_104 , L_14 ) == 0 )
V_5 -> V_17 = V_57 ;
else if ( ( strcmp ( args [ 0 ] . V_104 , L_15 ) == 0 )
|| ( strcmp ( args [ 0 ] . V_104 , L_16 ) == 0 ) )
V_5 -> V_17 = V_51 ;
...
break;
case V_105 :
F_26 ( V_81 , L_18 , args [ 0 ] . V_104 ) ;
if ( V_5 -> V_18 )
V_7 = - V_78 ;
if ( ( strcmp ( args [ 0 ] . V_104 , L_19 ) ) == 0 )
V_5 -> V_18 = V_106 ;
else if ( strcmp ( args [ 0 ] . V_104 , L_20 ) == 0 )
V_5 -> V_18 = V_107 ;
else if ( strcmp ( args [ 0 ] . V_104 , L_21 ) == 0 )
V_5 -> V_18 = V_108 ;
...
V_84 = F_31 ( & V_12 , L_38 ) ;
V_135 = strlen ( V_84 ) + 1 ;
V_84 += strspn ( V_84 , L_3 ) ;
if ( * V_84 == '#' || * V_84 == '\0' )
return V_135 ;
V_5 = F_41 ( sizeof( * V_5 ) , V_85 ) ;
if ( ! V_5 ) {
F_42 ( V_137 , NULL ,
NULL , V_134 , L_39 , - V_79 , V_136 ) ;
return - V_79 ;
}
F_43 ( & V_5 -> V_71 ) ;
V_7 = F_29 ( V_84 , V_5 ) ;
