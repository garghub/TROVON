...
static int F_46 ( struct V_90 * V_27 )
{
...
V_126 = F_48 ( V_27 , V_129 , 0 ) ;
V_5 -> V_11 = F_49 ( & V_27 -> V_5 , V_126 ) ;
if ( F_50 ( V_5 -> V_11 ) ) {
V_7 = F_51 ( V_5 -> V_11 ) ;
goto V_127;
}
...
static int F_58 ( struct V_90 * V_27 )
{
struct V_4 * V_5 ;
struct V_1 * V_50 ;
int V_7 , V_83 ;
...
static int F_60 ( struct V_133 * V_5 )
{
struct V_4 * V_134 = F_61 ( V_5 ) ;
if ( V_134 && V_134 -> V_37 )
F_57 ( V_134 -> V_37 ) ;
return 0 ;
}
static int F_62 ( struct V_133 * V_5 )
{
struct V_4 * V_134 = F_61 ( V_5 ) ;
int V_7 = - V_135 ;
if ( V_134 && V_134 -> V_37 )
