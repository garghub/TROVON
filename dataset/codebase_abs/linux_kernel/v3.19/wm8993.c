...
F_24 ( V_136 , V_85 , V_266 , 0 ) ;
for ( V_123 = 1 ; V_123 < F_6 ( V_263 -> V_267 ) ; V_123 ++ )
F_13 ( V_136 , V_85 + V_123 , V_263 -> V_267 [ V_123 ] ) ;
F_24 ( V_136 , V_85 , V_266 , V_261 ) ;
}
return 0 ;
}
static int F_37 ( struct V_165 * V_202 , int V_268 )
{
struct V_135 * V_136 = V_202 -> V_136 ;
unsigned int V_3 ;
V_3 = F_12 ( V_136 , V_19 ) ;
...
static int F_38 ( struct V_165 * V_166 , unsigned int V_270 ,
...
static T_3 F_39 ( int V_162 , void * V_280 )
{
struct V_139 * V_140 = V_280 ;
int V_281 , V_282 , V_147 ;
V_147 = F_40 ( V_140 -> V_192 , V_5 , & V_282 ) ;
if ( V_147 != 0 ) {
F_14 ( V_140 -> V_2 , L_23 ,
V_147 ) ;
return V_283 ;
}
V_147 = F_40 ( V_140 -> V_192 , V_28 , & V_281 ) ;
if ( V_147 != 0 ) {
F_14 ( V_140 -> V_2 , L_24 ,
V_147 ) ;
return V_283 ;
...
V_147 = F_43 ( V_140 -> V_192 , V_5 , V_282 ) ;
if ( V_147 != 0 )
...
{
struct V_139 * V_140 = F_9 ( V_136 ) ;
struct V_288 * V_188 = & V_136 -> V_188 ;
V_140 -> V_289 . V_290 = 1 ;
V_140 -> V_289 . V_291 = - 2 ;
V_140 -> V_289 . V_292 = - 2 ;
V_140 -> V_289 . V_293 = 1 ;
...
unsigned int V_3 ;
int V_147 , V_123 ;
V_140 = F_54 ( & V_142 -> V_2 , sizeof( struct V_139 ) ,
V_313 ) ;
if ( V_140 == NULL )
return - V_314 ;
V_140 -> V_2 = & V_142 -> V_2 ;
F_55 ( & V_140 -> V_163 ) ;
V_140 -> V_192 = F_56 ( V_142 , & V_315 ) ;
if ( F_57 ( V_140 -> V_192 ) ) {
V_147 = F_58 ( V_140 -> V_192 ) ;
...
V_147 = F_60 ( & V_142 -> V_2 , F_6 ( V_140 -> V_191 ) ,
V_140 -> V_191 ) ;
if ( V_147 != 0 ) {
...
if ( V_147 != 0 )
goto V_318;
V_147 = F_61 ( V_140 -> V_192 , V_319 ,
F_6 ( V_319 ) ) ;
if ( V_147 != 0 )
F_18 ( V_140 -> V_2 , L_37 ,
V_147 ) ;
if ( V_142 -> V_162 ) {
V_147 = F_62 ( V_140 -> V_192 , V_26 ,
V_320 |
V_321 , 7 ) ;
if ( V_147 != 0 )
goto V_318;
V_147 = F_63 ( V_142 -> V_162 , NULL , F_39 ,
V_322 | V_323 ,
L_38 , V_140 ) ;
if ( V_147 != 0 )
goto V_318;
