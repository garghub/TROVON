...
static int F_36 ( struct V_6 * V_7 , T_1 * V_134 , T_2 * V_135 ,
T_2 * V_136 )
{
struct V_1 * V_1 = F_5 ( V_7 ) ;
if ( V_135 )
memcpy ( V_135 , V_1 -> V_137 , V_133 ) ;
if ( V_136 )
* V_136 = V_138 ;
return 0 ;
}
static int F_37 ( struct V_6 * V_7 , const T_1 * V_134 ,
const T_2 * V_135 , const T_2 V_136 )
{
struct V_1 * V_1 = F_5 ( V_7 ) ;
if ( ( V_136 != V_139 && V_136 != V_138 ) ||
V_134 )
return - V_71 ;
if ( V_135 )
memcpy ( V_1 -> V_137 , V_135 , V_133 ) ;
return F_38 ( V_1 ) ;
}
