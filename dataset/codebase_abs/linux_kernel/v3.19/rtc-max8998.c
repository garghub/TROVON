...
struct V_49 * V_50 = V_47 -> V_50 ;
struct V_23 * V_24 ;
int V_25 ;
V_24 = F_22 ( & V_45 -> V_22 , sizeof( struct V_23 ) ,
V_51 ) ;
if ( ! V_24 )
return - V_52 ;
V_24 -> V_22 = & V_45 -> V_22 ;
...
V_24 -> V_26 = V_47 -> V_26 ;
F_23 ( V_45 , V_24 ) ;
V_24 -> V_40 = F_24 ( & V_45 -> V_22 , L_1 ,
& V_53 , V_54 ) ;
if ( F_25 ( V_24 -> V_40 ) ) {
V_25 = F_26 ( V_24 -> V_40 ) ;
F_27 ( & V_45 -> V_22 , L_2 , V_25 ) ;
return V_25 ;
}
if ( ! V_47 -> V_55 )
goto V_56;
V_24 -> V_39 = F_28 ( V_47 -> V_55 , V_57 ) ;
if ( ! V_24 -> V_39 ) {
F_29 ( & V_45 -> V_22 , L_3 ) ;
goto V_56;
}
V_25 = F_30 ( & V_45 -> V_22 , V_24 -> V_39 , NULL ,
F_19 , 0 , L_4 , V_24 ) ;
if ( V_25 < 0 )
F_27 ( & V_45 -> V_22 , L_5 ,
V_24 -> V_39 , V_25 ) ;
V_56:
F_31 ( & V_45 -> V_22 , L_6 , V_45 -> V_58 -> V_59 ) ;
if ( V_50 && V_50 -> V_60 ) {
V_24 -> V_28 = true ;
F_29 ( & V_45 -> V_22 , L_7
L_8 ) ;
