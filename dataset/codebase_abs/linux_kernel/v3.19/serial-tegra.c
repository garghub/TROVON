...
V_169 = F_80 ( V_2 -> V_4 . V_50 ,
V_2 -> V_4 . V_75 -> V_74 . V_80 , V_82 ,
V_103 ) ;
V_168 = V_2 -> V_4 . V_75 -> V_74 . V_80 ;
}
if ( V_166 ) {
V_171 . V_174 = V_2 -> V_4 . V_175 ;
V_171 . V_176 = V_177 ;
V_171 . V_178 = 4 ;
} else {
V_171 . V_179 = V_2 -> V_4 . V_175 ;
V_171 . V_180 = V_177 ;
V_171 . V_181 = 16 ;
}
V_47 = F_81 ( V_167 , & V_171 ) ;
if ( V_47 < 0 ) {
F_18 ( V_2 -> V_4 . V_50 ,
L_17 , V_47 ) ;
goto V_182;
...
V_47 = F_74 ( V_2 , true ) ;
if ( V_47 < 0 ) {
F_18 ( V_9 -> V_50 , L_19 , V_47 ) ;
goto V_184;
}
V_47 = F_70 ( V_2 ) ;
if ( V_47 < 0 ) {
F_18 ( V_9 -> V_50 , L_20 , V_47 ) ;
goto V_185;
}
V_47 = F_86 ( V_9 -> V_141 , F_65 , 0 ,
F_87 ( V_9 -> V_50 ) , V_2 ) ;
if ( V_47 < 0 ) {
F_18 ( V_9 -> V_50 , L_21 , V_9 -> V_141 ) ;
goto V_185;
}
return 0 ;
V_185:
...
struct V_187 * V_188 , struct V_187 * V_189 )
{
struct V_1 * V_2 = F_5 ( V_9 ) ;
unsigned int V_44 ;
unsigned long V_92 ;
unsigned int V_27 ;
int V_33 = 1 ;
struct V_190 * V_191 = F_93 ( V_2 -> V_49 ) ;
unsigned long V_192 = F_19 ( V_191 ) ;
int V_193 = ( V_2 -> V_37 -> V_48 ) ? 0x7FFF : 0xFFFF ;
V_193 *= 16 ;
F_32 ( & V_9 -> V_99 , V_92 ) ;
if ( V_2 -> V_23 )
F_8 ( V_2 , false ) ;
...
V_27 &= ~ V_194 ;
V_188 -> V_195 &= ~ V_196 ;
if ( ( V_188 -> V_195 & V_197 ) == V_197 ) {
V_33 ++ ;
if ( V_188 -> V_195 & V_198 ) {
V_27 |= V_194 ;
V_27 &= ~ V_199 ;
V_27 &= ~ V_200 ;
} else {
...
V_2 -> V_28 = V_27 ;
V_2 -> V_33 = V_33 ;
V_44 = F_94 ( V_9 , V_188 , V_189 ,
V_192 / V_193 ,
V_192 / 16 ) ;
F_36 ( & V_9 -> V_99 , V_92 ) ;
F_16 ( V_2 , V_44 ) ;
if ( F_95 ( V_188 ) )
F_96 ( V_188 , V_44 , V_44 ) ;
F_32 ( & V_9 -> V_99 , V_92 ) ;
if ( V_188 -> V_195 & V_211 ) {
V_2 -> V_17 |= V_159 ;
V_2 -> V_17 &= ~ V_18 ;
...
static int F_99 ( struct V_213 * V_214 ,
struct V_1 * V_2 )
{
struct V_215 * V_216 = V_214 -> V_50 . V_217 ;
int V_126 ;
V_126 = F_100 ( V_216 , L_22 ) ;
if ( V_126 < 0 ) {
F_18 ( & V_214 -> V_50 , L_23 , V_126 ) ;
return V_126 ;
}
V_2 -> V_4 . line = V_126 ;
V_2 -> V_10 = F_101 ( V_216 ,
L_24 ) ;
return 0 ;
}
static int F_102 ( struct V_213 * V_214 )
{
struct V_1 * V_2 ;
struct V_8 * V_9 ;
struct V_218 * V_218 ;
int V_47 ;
const struct V_219 * V_37 ;
const struct V_220 * V_221 ;
V_221 = F_103 ( V_222 , & V_214 -> V_50 ) ;
if ( ! V_221 ) {
F_18 ( & V_214 -> V_50 , L_25 ) ;
return - V_223 ;
}
V_37 = V_221 -> V_142 ;
V_2 = F_104 ( & V_214 -> V_50 , sizeof( * V_2 ) , V_172 ) ;
if ( ! V_2 ) {
F_18 ( & V_214 -> V_50 , L_26 ) ;
return - V_173 ;
}
V_47 = F_99 ( V_214 , V_2 ) ;
if ( V_47 < 0 )
...
V_2 -> V_37 = V_37 ;
F_105 ( V_214 , V_2 ) ;
V_218 = F_106 ( V_214 , V_227 , 0 ) ;
if ( ! V_218 ) {
F_18 ( & V_214 -> V_50 , L_27 ) ;
return - V_223 ;
}
V_9 -> V_175 = V_218 -> V_228 ;
V_9 -> V_5 = F_107 ( & V_214 -> V_50 , V_218 ) ;
if ( F_76 ( V_9 -> V_5 ) )
return F_77 ( V_9 -> V_5 ) ;
V_2 -> V_49 = F_108 ( & V_214 -> V_50 , NULL ) ;
if ( F_76 ( V_2 -> V_49 ) ) {
F_18 ( & V_214 -> V_50 , L_28 ) ;
return F_77 ( V_2 -> V_49 ) ;
}
V_2 -> V_160 = F_109 ( & V_214 -> V_50 , L_22 ) ;
if ( F_76 ( V_2 -> V_160 ) ) {
F_18 ( & V_214 -> V_50 , L_29 ) ;
return F_77 ( V_2 -> V_160 ) ;
}
V_9 -> V_229 = V_230 ;
V_9 -> V_141 = F_110 ( V_214 , 0 ) ;
V_9 -> V_6 = 2 ;
V_47 = F_111 ( & V_231 , V_9 ) ;
if ( V_47 < 0 ) {
F_18 ( & V_214 -> V_50 , L_30 , V_47 ) ;
return V_47 ;
}
return V_47 ;
}
static int F_112 ( struct V_213 * V_214 )
{
struct V_1 * V_2 = F_113 ( V_214 ) ;
struct V_8 * V_9 = & V_2 -> V_4 ;
F_114 ( & V_231 , V_9 ) ;
return 0 ;
}
static int F_115 ( struct V_232 * V_50 )
{
struct V_1 * V_2 = F_116 ( V_50 ) ;
struct V_8 * V_9 = & V_2 -> V_4 ;
return F_117 ( & V_231 , V_9 ) ;
}
static int F_118 ( struct V_232 * V_50 )
{
struct V_1 * V_2 = F_116 ( V_50 ) ;
struct V_8 * V_9 = & V_2 -> V_4 ;
return F_119 ( & V_231 , V_9 ) ;
}
