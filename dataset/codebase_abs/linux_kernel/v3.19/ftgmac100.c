...
V_11 -> V_184 = & V_185 ;
V_11 -> V_186 = & V_187 ;
V_11 -> V_188 = V_189 | V_190 ;
F_146 ( V_178 , V_11 ) ;
V_2 = F_103 ( V_11 ) ;
V_2 -> V_11 = V_11 ;
V_2 -> V_73 = & V_178 -> V_73 ;
F_147 ( & V_2 -> V_106 ) ;
F_148 ( V_11 , & V_2 -> V_85 , F_126 , 64 ) ;
V_2 -> V_180 = F_149 ( V_180 -> V_191 , F_150 ( V_180 ) ,
F_107 ( & V_178 -> V_73 ) ) ;
if ( ! V_2 -> V_180 ) {
F_151 ( & V_178 -> V_73 , L_26 ) ;
V_117 = - V_115 ;
goto V_192;
}
V_2 -> V_4 = F_152 ( V_180 -> V_191 , F_150 ( V_180 ) ) ;
if ( ! V_2 -> V_4 ) {
F_151 ( & V_178 -> V_73 , L_27 ) ;
V_117 = - V_16 ;
goto V_193;
}
V_2 -> V_150 = V_150 ;
...
snprintf ( V_2 -> V_125 -> V_195 , V_196 , L_29 ) ;
V_2 -> V_125 -> V_2 = V_11 ;
V_2 -> V_125 -> V_197 = F_110 ;
V_2 -> V_125 -> V_198 = F_114 ;
V_2 -> V_125 -> V_150 = V_2 -> V_199 ;
for ( V_12 = 0 ; V_12 < V_123 ; V_12 ++ )
V_2 -> V_125 -> V_150 [ V_12 ] = V_200 ;
V_117 = F_154 ( V_2 -> V_125 ) ;
if ( V_117 ) {
F_151 ( & V_178 -> V_73 , L_30 ) ;
goto V_201;
}
V_117 = F_105 ( V_2 ) ;
if ( V_117 ) {
F_151 ( & V_178 -> V_73 , L_31 ) ;
goto V_202;
}
V_117 = F_155 ( V_11 ) ;
if ( V_117 ) {
F_151 ( & V_178 -> V_73 , L_32 ) ;
goto V_203;
}
...
static int T_7 F_165 ( struct V_177 * V_178 )
{
struct V_10 * V_11 ;
struct V_1 * V_2 ;
V_11 = F_166 ( V_178 ) ;
