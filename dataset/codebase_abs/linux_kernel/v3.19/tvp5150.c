...
return - V_156 ;
F_22 ( V_3 , 0 ) ;
V_162 -> V_163 = V_95 -> V_145 . V_163 ;
V_162 -> V_146 = V_95 -> V_145 . V_146 ;
V_162 -> V_159 = V_160 ;
V_162 -> V_164 = V_165 ;
V_162 -> V_166 = V_167 ;
F_8 ( 1 , V_12 , V_3 , L_67 , V_162 -> V_163 ,
V_162 -> V_146 ) ;
return 0 ;
}
static int F_28 ( struct V_2 * V_3 , const struct V_168 * V_169 )
{
struct V_170 V_145 = V_169 -> V_10 ;
struct V_1 * V_95 = F_1 ( V_3 ) ;
T_2 V_124 ;
unsigned int V_171 ;
F_8 ( 1 , V_12 , V_3 , L_68 ,
V_104 , V_145 . V_172 , V_145 . V_173 , V_145 . V_163 , V_145 . V_146 ) ;
if ( V_169 -> type != V_174 )
return - V_156 ;
V_145 . V_172 = F_29 ( V_145 . V_172 , 0 , V_175 ) ;
V_145 . V_163 = F_30 (unsigned int, rect.width,
...
hmax - rect.top) ;
F_9 ( V_3 , V_40 , V_145 . V_173 ) ;
F_9 ( V_3 , V_41 ,
V_145 . V_173 + V_145 . V_146 - V_171 ) ;
F_9 ( V_3 , V_34 ,
V_145 . V_172 >> V_177 ) ;
F_9 ( V_3 , V_35 ,
V_145 . V_172 | ( 1 << V_177 ) ) ;
F_9 ( V_3 , V_36 ,
( V_145 . V_172 + V_145 . V_163 - V_175 ) >>
V_177 ) ;
F_9 ( V_3 , V_37 ,
V_145 . V_172 + V_145 . V_163 - V_175 ) ;
V_95 -> V_145 = V_145 ;
...
static int F_31 ( struct V_2 * V_3 , struct V_168 * V_169 )
{
struct V_1 * V_95 = F_1 ( V_3 ) ;
V_169 -> V_10 = V_95 -> V_145 ;
V_169 -> type = V_174 ;
return 0 ;
}
static int F_32 ( struct V_2 * V_3 , struct V_178 * V_169 )
{
struct V_1 * V_95 = F_1 ( V_3 ) ;
T_2 V_124 ;
if ( V_169 -> type != V_174 )
...
V_169 -> V_179 . V_172 = 0 ;
V_169 -> V_179 . V_173 = 0 ;
V_169 -> V_179 . V_163 = V_180 ;
if ( V_95 -> V_125 == V_127 )
V_124 = F_25 ( V_3 ) ;
else
V_124 = V_95 -> V_125 ;
if ( V_124 & V_144 )
V_169 -> V_179 . V_146 = V_147 ;
else
V_169 -> V_179 . V_146 = V_148 ;
V_169 -> V_181 = V_169 -> V_179 ;
V_169 -> V_182 . V_183 = 1 ;
V_169 -> V_182 . V_184 = 1 ;
return 0 ;
}
static int F_33 ( struct V_2 * V_3 ,
T_3 V_96 , T_3 V_98 , T_3 V_185 )
{
struct V_1 * V_95 = F_1 ( V_3 ) ;
V_95 -> V_96 = V_96 ;
V_95 -> V_98 = V_98 ;
...
static int F_34 ( struct V_2 * V_3 , struct V_186 * V_130 )
{
if ( V_130 -> V_187 == V_188 )
F_9 ( V_3 , V_25 , 0x70 ) ;
if ( V_130 -> V_189 [ 0 ] == 18 && V_130 -> V_189 [ 1 ] == 18 ) {
F_9 ( V_3 , V_40 , 0x00 ) ;
F_9 ( V_3 , V_41 , 0x01 ) ;
}
return 0 ;
}
static int F_35 ( struct V_2 * V_3 , struct V_190 * V_191 )
{
int V_18 ;
if ( V_191 -> V_121 != 0 ) {
for ( V_18 = 0 ; V_18 <= 23 ; V_18 ++ ) {
V_191 -> V_119 [ 1 ] [ V_18 ] = 0 ;
V_191 -> V_119 [ 0 ] [ V_18 ] =
F_18 ( V_3 , V_116 ,
V_191 -> V_119 [ 0 ] [ V_18 ] , 0xf0 , V_18 , 3 ) ;
}
F_9 ( V_3 , V_81 , 1 ) ;
} else {
F_9 ( V_3 , V_81 , 0 ) ;
...
static int F_36 ( struct V_2 * V_3 , struct V_190 * V_191 )
{
int V_18 , V_192 = 0 ;
memset ( V_191 -> V_119 , 0 , sizeof( V_191 -> V_119 ) ) ;
for ( V_18 = 0 ; V_18 <= 23 ; V_18 ++ ) {
V_191 -> V_119 [ 0 ] [ V_18 ] =
F_19 ( V_3 , V_116 , V_18 ) ;
V_192 |= V_191 -> V_119 [ 0 ] [ V_18 ] ;
}
V_191 -> V_121 = V_192 ;
return 0 ;
}
static int F_37 ( struct V_2 * V_3 , struct V_193 * V_107 )
{
int V_194 ;
V_194 = F_4 ( V_3 , V_107 -> V_107 & 0xff ) ;
if ( V_194 < 0 ) {
F_7 ( V_3 , L_63 , V_104 , V_194 ) ;
return V_194 ;
}
V_107 -> V_97 = V_194 ;
V_107 -> V_195 = 1 ;
...
static int F_38 ( struct V_2 * V_3 , const struct V_193 * V_107 )
{
F_9 ( V_3 , V_107 -> V_107 & 0xff , V_107 -> V_97 & 0xff ) ;
return 0 ;
}
static int F_39 ( struct V_2 * V_3 , struct V_196 * V_197 )
{
int V_198 = F_4 ( V_3 , 0x88 ) ;
V_197 -> signal = ( ( V_198 & 0x04 ) && ( V_198 & 0x02 ) ) ? 0xffff : 0x0 ;
return 0 ;
}
...
V_203 | V_204 ) )
return - V_205 ;
V_200 = F_42 ( & V_10 -> V_206 , sizeof( * V_200 ) , V_207 ) ;
if ( ! V_200 )
return - V_208 ;
V_3 = & V_200 -> V_3 ;
F_43 ( V_3 , V_10 , & V_209 ) ;
for ( V_18 = 0 ; V_18 < 4 ; V_18 ++ ) {
V_194 = F_4 ( V_3 , V_53 + V_18 ) ;
if ( V_194 < 0 )
return V_194 ;
V_201 [ V_18 ] = V_194 ;
}
F_44 ( V_10 , L_69 ,
V_10 -> V_8 << 1 , V_10 -> V_202 -> V_210 ) ;
if ( V_201 [ 2 ] == 4 && V_201 [ 3 ] == 0 ) {
F_45 ( V_3 , L_70 ,
V_201 [ 0 ] , V_201 [ 1 ] ) ;
F_9 ( V_3 , V_52 , 0 ) ;
} else {
if ( V_201 [ 2 ] == 3 || V_201 [ 3 ] == 0x21 ) {
F_45 ( V_3 , L_71 ,
V_201 [ 0 ] , V_201 [ 1 ] ) ;
} else {
F_45 ( V_3 , L_72 ,
...
V_200 -> V_145 . V_173 = 0 ;
if ( F_25 ( V_3 ) & V_144 )
V_200 -> V_145 . V_146 = V_147 ;
else
V_200 -> V_145 . V_146 = V_148 ;
V_200 -> V_145 . V_172 = 0 ;
V_200 -> V_145 . V_163 = V_180 ;
if ( V_12 > 1 )
F_13 ( V_3 ) ;
return 0 ;
}
