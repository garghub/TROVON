...
if ( V_32 -> V_129 )
( V_32 -> V_129 ) -> V_132 = V_32 ;
V_115 = F_65 ( V_112 -> V_133 . V_134 ) ;
V_32 -> V_135 = V_115 >> 8 ;
if ( V_32 -> V_11 -> V_136 ) {
...
if ( V_32 -> V_11 -> V_138 )
V_32 -> V_11 -> V_138 ( V_32 , & V_32 -> V_139 ) ;
F_55 ( V_35 , L_22 ,
V_10 -> V_140 , V_110 , V_32 -> V_139 ) ;
return 0 ;
V_137:
F_66 ( V_35 ) ;
V_131:
...
char V_140 [ V_141 ] ;
V_32 -> V_45 &= ~ V_118 ;
strncpy ( V_140 , V_35 -> V_140 , V_141 ) ;
F_69 ( V_35 ) ;
F_67 ( V_35 ) ;
F_40 ( V_32 -> V_116 ) ;
V_32 -> V_132 = NULL ;
if ( V_32 -> V_11 -> V_142 )
V_32 -> V_11 -> V_142 ( V_32 ) ;
F_70 ( & V_109 -> V_32 , L_23 , V_140 ) ;
}
F_62 ( V_109 , NULL ) ;
}
...
{
struct V_111 * V_112 = F_57 ( V_109 ) ;
const T_6 V_145 = F_65 ( V_112 -> V_133 . V_146 ) ;
struct V_10 * V_10 , * * V_147 ;
int V_73 , V_36 = - V_86 ;
V_112 = F_57 ( V_109 ) ;
for ( V_147 = V_148 ; * V_147 ; V_147 ++ )
if ( ( * V_147 ) -> V_149 == V_145 )
break;
V_10 = * V_147 ;
if ( ! V_10 ) {
F_72 ( L_24 ,
V_4 , V_112 -> V_133 . V_146 ) ;
return - V_54 ;
}
if ( V_10 -> V_150 ) {
V_36 = V_10 -> V_150 ( V_109 ) ;
if ( V_36 )
return V_36 ;
}
for ( V_73 = 0 ; V_73 < V_10 -> V_151 ; V_73 ++ ) {
...
static int F_75 ( struct V_153 * V_154 , void * V_155 )
{
struct V_108 * V_109 = F_76 ( V_154 ) ;
struct V_31 * V_32 ;
for ( V_32 = F_61 ( V_109 ) ; V_32 ; V_32 = V_32 -> V_129 ) {
struct V_34 * V_35 = V_32 -> V_35 ;
if ( F_12 ( V_35 ) )
if ( V_32 -> V_11 -> V_156 )
V_32 -> V_11 -> V_156 ( V_32 ) ;
}
return 0 ;
}
...
{
int V_36 ;
V_36 = F_78 ( & V_152 . V_157 . V_158 , NULL ,
NULL , F_75 ) ;
if ( V_36 )
F_72 ( L_26 ,
V_4 , V_36 ) ;
