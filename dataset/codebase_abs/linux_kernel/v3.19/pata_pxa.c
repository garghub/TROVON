...
struct V_60 * V_63 ;
struct V_60 * V_64 ;
struct V_65 * V_66 = F_21 ( & V_56 -> V_44 ) ;
int V_46 = 0 ;
if ( V_56 -> V_67 != 4 ) {
F_14 ( & V_56 -> V_44 , L_2 ) ;
return - V_68 ;
}
V_61 = F_22 ( V_56 , V_69 , 0 ) ;
if ( F_23 ( V_61 == NULL ) )
return - V_68 ;
V_62 = F_22 ( V_56 , V_69 , 1 ) ;
if ( F_23 ( V_62 == NULL ) )
return - V_68 ;
V_63 = F_22 ( V_56 , V_70 , 0 ) ;
if ( F_23 ( V_63 == NULL ) )
return - V_68 ;
V_64 = F_22 ( V_56 , V_71 , 0 ) ;
if ( F_23 ( V_64 == NULL ) )
return - V_68 ;
V_58 = F_24 ( & V_56 -> V_44 , 1 ) ;
if ( ! V_58 )
return - V_72 ;
V_7 = V_58 -> V_73 [ 0 ] ;
V_7 -> V_39 = & V_74 ;
V_7 -> V_75 = V_76 ;
V_7 -> V_77 = V_78 ;
V_7 -> V_79 . V_80 = F_25 ( & V_56 -> V_44 , V_61 -> V_81 ,
F_26 ( V_61 ) ) ;
V_7 -> V_79 . V_82 = F_25 ( & V_56 -> V_44 , V_62 -> V_81 ,
F_26 ( V_62 ) ) ;
V_7 -> V_79 . V_83 = F_25 ( & V_56 -> V_44 , V_63 -> V_81 ,
F_26 ( V_63 ) ) ;
V_7 -> V_79 . V_84 = V_7 -> V_79 . V_82 ;
V_7 -> V_79 . V_85 = V_7 -> V_79 . V_80 +
( V_86 << V_66 -> V_87 ) ;
V_7 -> V_79 . V_88 = V_7 -> V_79 . V_80 +
( V_89 << V_66 -> V_87 ) ;
V_7 -> V_79 . V_90 = V_7 -> V_79 . V_80 +
( V_91 << V_66 -> V_87 ) ;
V_7 -> V_79 . V_92 = V_7 -> V_79 . V_80 +
( V_93 << V_66 -> V_87 ) ;
V_7 -> V_79 . V_94 = V_7 -> V_79 . V_80 +
( V_95 << V_66 -> V_87 ) ;
V_7 -> V_79 . V_96 = V_7 -> V_79 . V_80 +
( V_97 << V_66 -> V_87 ) ;
V_7 -> V_79 . V_98 = V_7 -> V_79 . V_80 +
( V_99 << V_66 -> V_87 ) ;
V_7 -> V_79 . V_100 = V_7 -> V_79 . V_80 +
( V_101 << V_66 -> V_87 ) ;
V_7 -> V_79 . V_102 = V_7 -> V_79 . V_80 +
( V_103 << V_66 -> V_87 ) ;
V_7 -> V_79 . V_104 = V_7 -> V_79 . V_80 +
( V_105 << V_66 -> V_87 ) ;
V_59 = F_27 ( & V_56 -> V_44 , sizeof( struct V_5 ) ,
V_106 ) ;
if ( ! V_59 )
return - V_72 ;
V_7 -> V_8 = V_59 ;
V_59 -> V_32 = V_66 -> V_32 ;
V_59 -> V_26 = V_63 -> V_81 ;
V_59 -> V_12 = F_28 ( & V_56 -> V_44 , V_107 ,
& V_59 -> V_15 , V_106 ) ;
if ( ! V_59 -> V_12 )
return - V_68 ;
V_59 -> V_35 = F_29 ( V_108 , V_109 ,
F_18 , V_7 ) ;
if ( V_59 -> V_35 < 0 )
return - V_110 ;
F_5 ( V_59 -> V_35 ) = 0 ;
V_46 = F_30 ( V_58 , V_64 -> V_81 , V_111 ,
V_66 -> V_112 , & V_113 ) ;
if ( V_46 )
F_31 ( V_59 -> V_35 ) ;
return V_46 ;
...
{
struct V_57 * V_58 = F_33 ( V_56 ) ;
struct V_5 * V_59 = V_58 -> V_73 [ 0 ] -> V_8 ;
F_31 ( V_59 -> V_35 ) ;
F_34 ( V_58 ) ;
return 0 ;
}
