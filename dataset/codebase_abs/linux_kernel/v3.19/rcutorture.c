...
static void F_120 ( unsigned long V_119 )
{
int V_19 ;
int V_41 ;
int V_120 ;
...
V_135 [ V_21 ] += F_136 ( V_129 , V_40 ) [ V_21 ] ;
V_136 [ V_21 ] += F_136 ( V_130 , V_40 ) [ V_21 ] ;
}
}
...
static inline void
F_142 ( struct V_149 * V_31 , const char * V_150 )
{
F_64 ( L_30 V_43
L_40
L_41
...
F_144 ( & V_67 ) ;
F_83 ( L_49 ) ;
V_164 [ V_40 ] = F_147 ( F_82 , NULL ,
F_148 ( V_40 ) ,
L_6 ) ;
if ( F_149 ( V_164 [ V_40 ] ) ) {
V_165 = F_150 ( V_164 [ V_40 ] ) ;
F_83 ( L_50 ) ;
V_139 ++ ;
V_164 [ V_40 ] = NULL ;
F_92 ( & V_67 ) ;
...
F_151 ( V_164 [ V_40 ] , V_40 ) ;
F_152 ( V_164 [ V_40 ] ) ;
F_92 ( & V_67 ) ;
return 0 ;
}
static int F_153 ( void * args )
{
unsigned long V_166 ;
F_83 ( L_51 ) ;
if ( V_159 > 0 ) {
...
if ( V_158 <= 0 )
return 0 ;
return F_156 ( F_153 , NULL , V_167 ) ;
}
static void F_157 ( struct V_29 * V_34 )
{
F_7 ( & V_168 ) ;
}
static int F_158 ( void * V_51 )
{
...
F_164 ( & V_168 , 0 ) ;
V_177 =
F_166 ( V_160 * sizeof( V_177 [ 0 ] ) ,
V_178 ) ;
V_172 =
F_166 ( V_160 * sizeof( V_172 [ 0 ] ) ,
V_178 ) ;
if ( V_177 == NULL || ! V_172 )
return - V_179 ;
for ( V_21 = 0 ; V_21 < V_160 ; V_21 ++ ) {
...
static int F_170 ( struct V_181 * V_182 ,
...
if ( ! F_185 ( V_42 , V_151 , & V_206 ) )
return - V_207 ;
for ( V_21 = 0 ; V_21 < F_186 ( V_199 ) ; V_21 ++ ) {
V_31 = V_199 [ V_21 ] ;
...
F_142 ( V_31 , L_74 ) ;
F_37 ( & V_8 ) ;
for ( V_21 = 0 ; V_21 < F_186 ( V_211 ) ; V_21 ++ ) {
V_211 [ V_21 ] . V_25 = 0 ;
...
F_65 (cpu) {
for ( V_21 = 0 ; V_21 < V_23 + 1 ; V_21 ++ ) {
F_136 ( V_129 , V_40 ) [ V_21 ] = 0 ;
F_136 ( V_130 , V_40 ) [ V_21 ] = 0 ;
}
}
V_198 = F_156 ( F_105 , NULL ,
V_111 ) ;
if ( V_198 )
goto V_212;
V_190 = F_166 ( V_116 * sizeof( V_190 [ 0 ] ) ,
V_178 ) ;
if ( V_190 == NULL ) {
F_189 ( L_75 ) ;
V_198 = - V_179 ;
...
V_189 = F_166 ( V_18 * sizeof( V_189 [ 0 ] ) ,
V_178 ) ;
if ( V_189 == NULL ) {
F_189 ( L_75 ) ;
V_198 = - V_179 ;
...
for ( V_21 = 0 ; V_21 < V_18 ; V_21 ++ ) {
V_198 = F_156 ( F_129 , NULL ,
V_189 [ V_21 ] ) ;
if ( V_198 )
goto V_212;
}
if ( V_148 > 0 ) {
V_198 = F_156 ( F_141 , NULL ,
V_191 ) ;
if ( V_198 )
goto V_212;
}
if ( V_152 ) {
V_198 = F_190 ( V_153 * V_37 ) ;
if ( V_198 )
goto V_212;
}
if ( V_154 < 0 )
...
V_198 = F_194 ( V_157 , F_171 ) ;
if ( V_198 )
goto V_212;
V_198 = F_195 ( V_162 * V_37 , V_161 * V_37 ) ;
if ( V_198 )
goto V_212;
V_198 = F_155 () ;
if ( V_198 )
...
if ( V_78 > 0 ) {
V_193 = ( F_188 () + 3 ) / 4 ;
V_194 = F_196 ( V_193 , sizeof( * V_194 ) ,
V_178 ) ;
if ( ! V_194 ) {
F_189 ( L_75 ) ;
V_198 = - V_179 ;
