...
{
struct V_163 * V_124 = F_91 ( V_10 ) ;
struct V_164 * V_9 = F_92 ( V_10 ) ;
struct V_1 * V_2 = V_9 -> V_120 ;
unsigned char * V_165 , * V_166 ;
F_93 ( V_9 , V_167 ) ;
F_94 ( V_2 -> V_115 ) ;
for ( V_165 = V_168 , V_166 = V_2 -> V_168 ; * V_165 ; V_165 ++ , V_166 ++ )
* V_166 = F_79 ( V_2 , * V_165 ) ;
...
static int F_99 ( struct V_113 * V_10 )
{
struct V_163 * V_124 = F_91 ( V_10 ) ;
struct V_164 * V_9 = F_92 ( V_10 ) ;
struct V_1 * V_2 = V_9 -> V_120 ;
...
V_2 -> V_169 = V_124 -> V_169 ;
F_86 ( V_2 ) ;
for ( V_165 = V_168 , V_166 = V_2 -> V_168 ; * V_165 ; V_165 ++ , V_166 ++ ) {
if ( * V_165 < 0xa0 )
F_1 ( V_2 , * V_165 , * V_166 ) ;
else
F_13 ( V_2 , * V_165 , * V_166 ) ;
}
F_93 ( V_9 , V_176 ) ;
return 0 ;
}
...
F_106 ( V_178 , L_23 ) ;
F_107 ( V_178 , L_24 , F_108 ( V_2 -> V_124 ) ) ;
F_109 ( V_178 , & V_2 -> V_124 -> V_10 ) ;
...
static inline int F_104 ( struct V_1 * V_2 ) { return - V_182 ; }
static inline void F_111 ( struct V_1 * V_2 ) { }
static int F_113 ( struct V_1 * V_2 )
{
F_3 ( 0x00 , F_20 ( V_2 , V_162 ) ) ;
if ( V_2 -> V_183 )
F_9 ( V_2 , V_184 , 0x40 , 0 ) ;
F_111 ( V_2 ) ;
if ( V_2 -> V_169 >= 0 )
F_95 ( V_2 -> V_169 , V_2 ) ;
F_114 ( V_2 -> V_124 ) ;
...
static int F_116 ( struct V_185 * V_113 )
{
struct V_1 * V_2 = V_113 -> V_186 ;
return F_113 ( V_2 ) ;
}
static int F_117 ( struct V_164 * V_9 ,
struct V_163 * V_124 ,
struct V_1 * * V_187 )
{
struct V_1 * V_2 ;
...
* V_187 = NULL ;
if ( ( V_102 = F_101 ( V_124 ) ) < 0 )
return V_102 ;
if ( F_118 ( V_124 , F_119 ( 24 ) ) < 0 ||
F_120 ( V_124 , F_119 ( 24 ) ) < 0 ) {
F_11 ( V_9 -> V_10 ,
L_25 ) ;
F_96 ( V_124 ) ;
return - V_191 ;
}
V_2 = F_121 ( sizeof( * V_2 ) , V_192 ) ;
if ( V_2 == NULL ) {
F_96 ( V_124 ) ;
return - V_179 ;
}
...
V_2 -> V_124 = V_124 ;
V_2 -> V_169 = - 1 ;
if ( ( V_102 = F_123 ( V_124 , L_11 ) ) < 0 ) {
F_115 ( V_2 ) ;
F_96 ( V_124 ) ;
return V_102 ;
}
V_2 -> V_193 = F_124 ( V_124 , 0 ) ;
V_2 -> V_194 = F_124 ( V_124 , 1 ) ;
V_2 -> V_195 = F_124 ( V_124 , 2 ) ;
V_2 -> V_196 = F_124 ( V_124 , 3 ) ;
V_2 -> V_181 = F_124 ( V_124 , 4 ) ;
if ( F_103 ( V_124 -> V_169 , V_173 , V_174 ,
V_175 , V_2 ) ) {
F_11 ( V_9 -> V_10 , L_26 , V_124 -> V_169 ) ;
F_113 ( V_2 ) ;
return - V_197 ;
}
V_2 -> V_169 = V_124 -> V_169 ;
F_6 ( V_9 -> V_10 ,
L_27 ,
V_2 -> V_193 , V_2 -> V_194 , V_2 -> V_195 , V_2 -> V_196 , V_2 -> V_181 ) ;
V_2 -> V_160 = V_2 -> V_195 + 0x00 ;
F_86 ( V_2 ) ;
if ( ( V_102 = F_125 ( V_9 , V_198 , V_2 , & V_189 ) ) < 0 ) {
F_113 ( V_2 ) ;
return V_102 ;
}
* V_187 = V_2 ;
...
static T_4 V_173 ( int V_169 , void * V_199 )
{
struct V_1 * V_2 = V_199 ;
unsigned char V_200 , V_201 ;
int V_202 = 0 ;
V_200 = F_8 ( F_20 ( V_2 , V_162 ) ) ;
#if 0
...
if ( V_200 & 0x40 ) {
int V_203 = F_7 ( V_2 , 0x64 ) & 0x80 ;
V_202 = 1 ;
F_127 ( V_2 -> V_9 , V_204 , & V_2 -> V_143 -> V_205 ) ;
F_127 ( V_2 -> V_9 , V_204 , & V_2 -> V_142 -> V_205 ) ;
if ( ! V_203 ) {
F_127 ( V_2 -> V_9 , V_204 ,
& V_2 -> V_141 -> V_205 ) ;
F_127 ( V_2 -> V_9 , V_204 ,
...
int V_102 ;
V_9 = V_2 -> V_9 ;
strcpy ( V_9 -> V_207 , L_11 ) ;
for ( V_206 = 0 ; V_206 < F_131 ( V_208 ) ; V_206 ++ ) {
struct V_125 * V_209 ;
V_209 = F_132 ( & V_208 [ V_206 ] , V_2 ) ;
switch ( V_206 ) {
case 0 :
V_2 -> V_140 = V_209 ;
V_209 -> V_210 = F_77 ;
...
if ( ( V_102 = F_133 ( V_9 , V_209 ) ) < 0 )
return V_102 ;
}
return 0 ;
}
static int F_134 ( struct V_163 * V_124 ,
...
V_102 = F_135 ( & V_124 -> V_10 , V_218 [ V_10 ] , V_205 [ V_10 ] , V_219 ,
0 , & V_9 ) ;
if ( V_102 < 0 )
return V_102 ;
for ( V_206 = 0 ; V_206 < 5 ; V_206 ++ ) {
if ( F_124 ( V_124 , V_206 ) == 0 ||
! ( F_136 ( V_124 , V_206 ) & V_220 ) ) {
F_137 ( V_9 ) ;
return - V_25 ;
}
}
if ( ( V_102 = F_117 ( V_9 , V_124 , & V_2 ) ) < 0 ) {
F_137 ( V_9 ) ;
return V_102 ;
}
V_9 -> V_120 = V_2 ;
strcpy ( V_9 -> V_221 , L_23 ) ;
strcpy ( V_9 -> V_222 , L_28 ) ;
sprintf ( V_9 -> V_223 , L_29 ,
V_9 -> V_222 ,
V_2 -> V_224 ,
V_2 -> V_169 ) ;
...
if ( ( V_102 = F_139 ( V_214 , 0 , 1 ) ) < 0 ) {
F_137 ( V_9 ) ;
return V_102 ;
}
if ( ( V_102 = F_140 ( V_214 , 0 , 1 , NULL ) ) < 0 ) {
F_137 ( V_9 ) ;
return V_102 ;
}
}
if ( F_141 ( V_9 , 0 , V_228 ,
V_2 -> V_196 ,
V_229 | V_230 ,
- 1 , & V_2 -> V_183 ) < 0 ) {
F_11 ( V_9 -> V_10 , L_31 ) ;
} else {
F_9 ( V_2 , V_184 , 0x40 , 0x40 ) ;
}
F_104 ( V_2 ) ;
if ( ( V_102 = F_142 ( V_9 ) ) < 0 ) {
F_137 ( V_9 ) ;
return V_102 ;
}
F_143 ( V_124 , V_9 ) ;
...
static void F_144 ( struct V_163 * V_124 )
{
F_137 ( F_145 ( V_124 ) ) ;
}
