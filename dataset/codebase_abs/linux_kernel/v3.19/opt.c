...
if ( ! V_4 -> V_14 . V_38 )
return - V_60 ;
V_58 = ( long ) V_4 -> V_14 . V_38 - ( long ) V_4 -> V_6 . V_2 + V_9 ;
if ( abs ( V_58 ) > 0x7fffffff ) {
F_35 ( V_4 , 0 ) ;
return - V_61 ;
}
V_1 = ( T_2 * ) V_4 -> V_14 . V_38 ;
V_35 = F_18 ( V_1 + V_62 , V_4 -> V_6 . V_2 ) ;
if ( V_35 < 0 ) {
F_35 ( V_4 , 0 ) ;
return V_35 ;
}
V_4 -> V_14 . V_47 = V_35 ;
memcpy ( V_1 , & V_63 , V_62 ) ;
F_6 ( V_1 + V_64 , ( unsigned long ) V_4 ) ;
F_40 ( V_1 + V_65 , F_8 ) ;
F_41 ( V_1 + V_62 + V_4 -> V_14 . V_47 ,
( T_2 * ) V_4 -> V_6 . V_2 + V_4 -> V_14 . V_47 ) ;
F_42 ( ( unsigned long ) V_1 ,
( unsigned long ) V_1 + V_62 +
V_4 -> V_14 . V_47 + V_9 ) ;
return 0 ;
}
void F_43 ( struct V_66 * V_67 )
{
struct V_3 * V_4 , * V_68 ;
T_2 V_69 [ V_9 ] ;
F_44 (op, tmp, oplist, list) {
T_3 V_58 = ( T_3 ) ( ( long ) V_4 -> V_14 . V_38 -
...
T_2 V_69 [ V_9 ] ;
V_69 [ 0 ] = V_52 ;
memcpy ( V_69 + 1 , V_4 -> V_14 . V_15 , V_16 ) ;
F_46 ( V_4 -> V_6 . V_2 , V_69 , V_9 ,
V_4 -> V_14 . V_38 ) ;
}
extern void F_49 ( struct V_66 * V_67 ,
struct V_66 * V_71 )
{
struct V_3 * V_4 , * V_68 ;
F_44 (op, tmp, oplist, list) {
...
int F_51 ( struct V_5 * V_55 , struct V_18 * V_19 , int V_72 )
{
struct V_3 * V_4 ;
if ( V_55 -> V_22 & V_73 ) {
V_4 = F_4 ( V_55 , struct V_3 , V_6 ) ;
V_19 -> V_26 = ( unsigned long ) V_4 -> V_14 . V_38 + V_62 ;
if ( ! V_72 )
F_52 () ;
F_53 () ;
return 1 ;
