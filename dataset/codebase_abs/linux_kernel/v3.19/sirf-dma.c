...
T_5 V_108 , T_5 V_109 ,
enum V_110 V_111 , unsigned long V_47 )
{
struct V_1 * V_6 = F_1 ( V_4 ) ;
struct V_11 * V_12 = NULL ;
unsigned long V_95 ;
...
{
unsigned int V_112 = ( unsigned int ) V_8 ;
if ( V_112 == V_4 -> V_8 +
V_4 -> V_113 -> V_114 * V_115 )
return true ;
return false ;
}
static int F_53 ( struct V_2 * V_116 ,
struct V_117 * V_118 )
{
V_118 -> V_119 = V_120 ;
V_118 -> V_121 = V_120 ;
V_118 -> V_122 = F_54 ( V_97 ) | F_54 ( V_96 ) ;
V_118 -> V_123 = true ;
V_118 -> V_124 = true ;
return 0 ;
}
static struct V_2 * F_55 ( struct V_125 * V_126 ,
struct V_127 * V_128 )
{
struct V_5 * V_9 = V_128 -> V_129 ;
unsigned int V_130 = V_126 -> args [ 0 ] ;
if ( V_130 >= V_115 )
return NULL ;
return F_56 ( & V_9 -> V_7 [ V_130 ] . V_4 ) ;
}
static int F_57 ( struct V_131 * V_132 )
{
struct V_133 * V_134 = V_132 -> V_77 . V_135 ;
struct V_113 * V_77 = & V_132 -> V_77 ;
struct V_136 * V_50 ;
struct V_5 * V_9 ;
struct V_1 * V_6 ;
struct V_137 V_138 ;
...
if ( F_60 ( V_134 , L_5 ) )
V_9 -> V_64 = true ;
if ( F_61 ( V_134 , L_6 , & V_141 ) ) {
F_59 ( V_77 , L_7 ) ;
return - V_142 ;
}
V_9 -> V_35 = F_62 ( V_134 , 0 ) ;
if ( V_9 -> V_35 == V_143 ) {
F_59 ( V_77 , L_8 ) ;
return - V_62 ;
}
V_9 -> V_144 = F_63 ( V_77 , NULL ) ;
if ( F_64 ( V_9 -> V_144 ) ) {
F_59 ( V_77 , L_9 ) ;
return F_65 ( V_9 -> V_144 ) ;
}
V_88 = F_66 ( V_134 , 0 , & V_138 ) ;
if ( V_88 ) {
F_59 ( V_77 , L_10 ) ;
goto V_145;
}
V_139 = V_138 . V_146 ;
V_140 = F_67 ( & V_138 ) ;
V_9 -> V_17 = F_68 ( V_77 , V_139 , V_140 ) ;
if ( ! V_9 -> V_17 ) {
F_59 ( V_77 , L_11 ) ;
V_88 = - V_82 ;
goto V_145;
}
V_88 = F_69 ( V_9 -> V_35 , & F_10 , 0 , V_147 , V_9 ) ;
if ( V_88 ) {
F_59 ( V_77 , L_12 ) ;
V_88 = - V_62 ;
goto V_145;
...
V_50 -> V_155 = F_53 ;
F_70 ( & V_50 -> V_7 ) ;
F_71 ( V_156 , V_50 -> V_157 ) ;
F_71 ( V_158 , V_50 -> V_157 ) ;
F_71 ( V_159 , V_50 -> V_157 ) ;
F_71 ( V_160 , V_50 -> V_157 ) ;
...
static int F_87 ( struct V_113 * V_77 )
{
struct V_5 * V_9 = F_83 ( V_77 ) ;
F_88 ( V_9 -> V_144 ) ;
return 0 ;
}
static int F_89 ( struct V_113 * V_77 )
{
struct V_5 * V_9 = F_83 ( V_77 ) ;
int V_88 ;
V_88 = F_90 ( V_9 -> V_144 ) ;
...
static int F_91 ( struct V_113 * V_77 )
{
struct V_5 * V_9 = F_83 ( V_77 ) ;
struct V_163 * V_164 = & V_9 -> V_165 ;
struct V_11 * V_12 ;
struct V_1 * V_6 ;
int V_38 ;
int V_88 ;
...
struct V_11 ,
V_14 ) ;
V_164 -> V_166 [ V_38 ] = F_8 ( V_9 -> V_17 +
V_38 * 0x10 + V_23 ) ;
}
V_164 -> V_167 = F_8 ( V_9 -> V_17 + V_28 ) ;
F_87 ( V_77 ) ;
return 0 ;
}
static int F_92 ( struct V_113 * V_77 )
{
struct V_5 * V_9 = F_83 ( V_77 ) ;
struct V_163 * V_164 = & V_9 -> V_165 ;
struct V_11 * V_12 ;
