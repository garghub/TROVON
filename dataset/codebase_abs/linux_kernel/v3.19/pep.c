...
V_135 = F_74 ( F_75 ( V_13 ) , V_147 , V_32 , V_13 -> V_148 ) ;
if ( ! V_135 ) {
...
static int F_97 ( struct V_185 * V_186 , struct V_12 * V_13 ,
struct V_187 * V_188 , T_4 V_15 )
{
struct V_30 * V_31 = F_18 ( V_13 ) ;
struct V_1 * V_2 ;
long V_189 ;
int V_132 = V_188 -> V_190 ;
int V_68 , V_191 ;
if ( V_15 > V_192 )
return - V_193 ;
if ( ( V_188 -> V_190 & ~ ( V_194 | V_195 | V_196 |
V_197 ) ) ||
! ( V_188 -> V_190 & V_195 ) )
return - V_61 ;
...
if ( ! V_2 )
return V_68 ;
F_8 ( V_2 , V_198 + 3 + V_31 -> V_139 ) ;
V_68 = F_99 ( F_100 ( V_2 , V_15 ) , V_188 , V_15 ) ;
if ( V_68 < 0 )
goto V_199;
F_65 ( V_13 ) ;
V_189 = F_101 ( V_13 , V_132 & V_194 ) ;
...
F_107 ( F_108 ( V_13 ) , & V_203 ,
V_206 ) ;
V_191 = F_109 ( V_13 , & V_189 , F_103 ( & V_31 -> V_63 ) ) ;
F_110 ( F_108 ( V_13 ) , & V_203 ) ;
if ( V_13 -> V_50 != V_51 )
goto V_201;
}
V_68 = F_94 ( V_13 , V_2 ) ;
...
F_113 ( V_207 ) -> V_210 = V_2 ;
V_207 -> V_15 += V_2 -> V_15 ;
V_207 -> V_211 += V_207 -> V_15 ;
V_207 -> V_212 += V_207 -> V_15 ;
F_114 (skb, fs)
V_209 += V_208 -> V_15 ;
V_2 -> V_213 = F_113 ( V_2 ) -> V_210 ;
F_115 ( V_2 ) ;
V_2 -> V_15 -= V_209 ;
V_2 -> V_211 -= V_209 ;
V_2 -> V_212 -= V_209 ;
F_8 ( V_207 , V_198 + 3 ) ;
return F_94 ( V_13 , V_207 ) ;
}
...
static int F_118 ( struct V_185 * V_186 , struct V_12 * V_13 ,
struct V_187 * V_188 , T_4 V_15 , int V_214 ,
int V_132 , int * V_215 )
{
struct V_1 * V_2 ;
int V_68 ;
if ( V_132 & ~ ( V_216 | V_217 | V_218 | V_194 | V_219 |
V_196 | V_197 ) )
return - V_61 ;
if ( F_72 ( 1 << V_13 -> V_50 & ( V_123 | V_122 ) ) )
return - V_200 ;
if ( ( V_132 & V_216 ) || F_36 ( V_13 , V_163 ) ) {
struct V_30 * V_31 = F_18 ( V_13 ) ;
if ( V_132 & V_217 )
return - V_61 ;
V_2 = F_117 ( & V_31 -> V_84 ) ;
...
V_2 = F_70 ( V_13 , V_132 , V_214 , & V_68 ) ;
F_65 ( V_13 ) ;
if ( V_2 == NULL ) {
if ( V_68 == - V_200 && V_13 -> V_50 == V_69 )
V_68 = - V_202 ;
F_66 ( V_13 ) ;
return V_68 ;
}
...
V_15 = V_2 -> V_15 ;
V_68 = F_119 ( V_2 , 0 , V_188 , V_15 ) ;
if ( ! V_68 )
V_68 = ( V_132 & V_218 ) ? V_2 -> V_15 : V_15 ;
F_120 ( V_13 , V_2 ) ;
return V_68 ;
}
