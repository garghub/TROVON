...
V_38 -> V_54 = V_55 ;
V_38 -> V_56 = V_57 ;
if ( F_14 ( V_38 -> V_58 , V_38 , V_22 , V_31 , V_43 ) ) {
F_15 ( V_38 ) ;
return NULL ;
}
return V_38 ;
}
static int F_16 ( struct V_2 * V_3 , int V_59 ,
struct V_1 * V_20 )
{
...
static int F_20 ( struct V_2 * V_3 , struct V_36 * V_76 )
{
...
static int F_24 ( struct V_2 * V_3 , const char * V_89 )
{
struct V_1 * V_20 = F_1 ( V_3 ) ;
...
static struct V_4 * F_27 ( struct V_2 * V_3 )
{
struct V_1 * V_77 ;
int V_7 ;
V_77 = F_28 ( sizeof( * V_77 ) , V_100 ) ;
if ( ! V_77 )
return F_29 ( - V_101 ) ;
V_77 -> V_28 = V_95 ;
V_77 -> V_27 = V_102 ;
