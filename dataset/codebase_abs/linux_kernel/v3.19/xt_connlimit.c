...
unsigned int V_59 ;
V_59 = F_13 ( V_34 , & V_48 -> V_60 , V_29 , V_35 , & V_36 ) ;
F_23 ( V_44 , V_46 , V_47 ) ;
if ( ! V_36 )
return V_59 ;
...
continue;
F_13 ( V_34 , & V_48 -> V_60 , V_29 , V_35 , & V_36 ) ;
if ( F_27 ( & V_48 -> V_60 ) )
V_46 [ V_47 ++ ] = V_48 ;
}
if ( V_47 ) {
...
F_32 ( & V_67 [ V_63 % V_68 ] ) ;
V_59 = F_25 ( V_34 , V_44 , V_29 , V_1 , V_7 , V_21 , V_35 ) ;
F_33 ( & V_67 [ V_63 % V_68 ] ) ;
return V_59 ;
}
static bool
...
V_81 = F_36 ( V_70 , & V_80 ) ;
if ( V_81 != NULL ) {
V_78 = & V_81 -> V_84 [ V_85 ] . V_29 ;
V_35 = F_37 ( V_81 ) ;
} else if ( ! F_38 ( V_70 , F_39 ( V_70 ) ,
V_72 -> V_21 , & V_29 ) ) {
goto V_86;
}
if ( V_72 -> V_21 == V_64 ) {
const struct V_87 * V_88 = F_40 ( V_70 ) ;
memcpy ( & V_1 . V_10 , ( V_76 -> V_89 & V_90 ) ?
& V_88 -> V_91 : & V_88 -> V_92 , sizeof( V_1 . V_10 ) ) ;
} else {
const struct V_93 * V_88 = F_41 ( V_70 ) ;
V_1 . V_23 = ( V_76 -> V_89 & V_90 ) ?
V_88 -> V_91 : V_88 -> V_92 ;
}
V_82 = F_31 ( V_34 , V_76 -> V_62 , V_78 , & V_1 ,
& V_76 -> V_7 , V_72 -> V_21 , V_35 ) ;
if ( V_82 == 0 )
goto V_86;
return ( V_82 > V_76 -> V_94 ) ^
! ! ( V_76 -> V_89 & V_95 ) ;
V_86:
V_72 -> V_86 = true ;
return false ;
}
static int F_42 ( const struct V_96 * V_72 )
{
...
V_76 -> V_62 = F_48 ( sizeof( struct V_61 ) , V_98 ) ;
if ( V_76 -> V_62 == NULL ) {
F_49 ( V_72 -> V_21 ) ;
return - V_99 ;
}
for ( V_9 = 0 ; V_9 < F_4 ( V_76 -> V_62 -> V_66 ) ; ++ V_9 )
V_76 -> V_62 -> V_66 [ V_9 ] = V_100 ;
for ( V_9 = 0 ; V_9 < F_4 ( V_76 -> V_62 -> V_65 ) ; ++ V_9 )
V_76 -> V_62 -> V_65 [ V_9 ] = V_100 ;
return 0 ;
}
static void F_50 ( struct V_43 * V_101 )
{
struct V_30 * V_13 ;
struct V_45 * V_48 ;
struct V_39 * V_40 ;
struct V_51 * V_33 ;
while ( ( V_33 = F_51 ( V_101 ) ) != NULL ) {
...
static void F_52 ( const struct V_102 * V_72 )
{
const struct V_75 * V_76 = V_72 -> V_77 ;
unsigned int V_9 ;
F_49 ( V_72 -> V_21 ) ;
for ( V_9 = 0 ; V_9 < F_4 ( V_76 -> V_62 -> V_66 ) ; ++ V_9 )
F_50 ( & V_76 -> V_62 -> V_66 [ V_9 ] ) ;
for ( V_9 = 0 ; V_9 < F_4 ( V_76 -> V_62 -> V_65 ) ; ++ V_9 )
F_50 ( & V_76 -> V_62 -> V_65 [ V_9 ] ) ;
F_53 ( V_76 -> V_62 ) ;
}
