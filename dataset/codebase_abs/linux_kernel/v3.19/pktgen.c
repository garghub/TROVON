...
V_240 -> V_311 = V_315 ;
V_240 -> V_316 = 0 ;
F_150 ( V_240 , V_287 -> V_299 , V_287 -> V_300 ) ;
} else {
T_12 V_316 = F_151 ( V_240 ) ;
V_287 -> V_301 = F_152 ( V_287 -> V_299 , V_287 -> V_300 ,
V_266 + 8 , V_304 , V_316 ) ;
if ( V_287 -> V_301 == 0 )
V_287 -> V_301 = V_317 ;
}
...
static struct V_239 * F_153 ( struct V_164 * V_50 ,
struct V_21 * V_22 )
{
struct V_239 * V_240 = NULL ;
T_11 * V_256 ;
...
V_240 -> V_311 = V_315 ;
V_240 -> V_324 = F_155 ( V_240 ) - V_240 -> V_325 ;
V_240 -> V_326 = F_156 ( struct V_190 , V_301 ) ;
V_287 -> V_301 = ~ F_157 ( & V_257 -> V_305 , & V_257 -> V_306 , V_318 , V_304 , 0 ) ;
} else {
T_12 V_316 = F_151 ( V_240 ) ;
V_287 -> V_301 = F_157 ( & V_257 -> V_305 , & V_257 -> V_306 , V_318 , V_304 , V_316 ) ;
if ( V_287 -> V_301 == 0 )
V_287 -> V_301 = V_317 ;
}
F_129 ( V_22 , V_240 , V_266 ) ;
...
static struct V_239 * F_158 ( struct V_164 * V_50 ,
struct V_21 * V_22 )
{
if ( V_22 -> V_37 & V_38 )
...
static void F_159 ( struct V_149 * V_150 )
{
struct V_21 * V_22 ;
int V_328 = 0 ;
F_160 () ;
...
static int F_161 ( const struct V_149 * V_150 )
{
const struct V_21 * V_22 ;
F_44 () ;
F_45 (pkt_dev, &t->if_list, list)
...
static int F_162 ( struct V_149 * V_150 )
{
while ( F_161 ( V_150 ) ) {
F_163 ( 100 ) ;
if ( F_89 ( V_12 ) )
...
static void F_165 ( struct V_21 * V_22 , int V_278 )
{
T_13 V_332 , V_333 , V_334 ;
char * V_335 = V_22 -> V_108 ;
T_5 V_336 = F_91 ( V_22 -> V_91 ,
V_22 -> V_96 ) ;
T_5 V_25 = F_166 ( V_22 -> V_92 ) ;
...
static struct V_21 * F_169 ( struct V_149 * V_150 )
{
...
F_160 () ;
F_172 (q, n, &t->if_list) {
V_340 = F_173 ( V_339 , struct V_21 , V_341 ) ;
if ( ! V_340 -> V_159 )
continue;
F_126 ( V_340 -> V_240 ) ;
V_340 -> V_240 = NULL ;
...
static void F_175 ( struct V_149 * V_150 )
{
struct V_338 * V_339 , * V_117 ;
struct V_21 * V_340 ;
F_160 () ;
...
{
F_177 ( V_150 -> V_342 -> V_343 , V_150 -> V_179 -> V_167 ) ;
}
...
{
T_5 V_344 = F_19 () ;
while ( F_180 ( & ( V_22 -> V_240 -> V_345 ) ) != 1 ) {
if ( F_89 ( V_12 ) )
break;
if ( F_181 () )
F_178 ( V_22 ) ;
...
{
unsigned int V_70 = F_184 ( V_22 -> V_70 ) ;
...
V_347 = F_186 ( V_50 , V_22 -> V_240 ) ;
F_187 () ;
F_188 ( V_50 , V_347 , F_102 () ) ;
if ( F_131 ( F_189 ( V_347 ) ) ) {
V_151 = V_353 ;
V_22 -> V_349 = 0 ;
goto V_354;
}
F_190 ( V_70 , & V_22 -> V_240 -> V_345 ) ;
V_355:
V_151 = F_191 ( V_22 -> V_240 , V_50 , V_347 , -- V_70 > 0 ) ;
switch ( V_151 ) {
case V_356 :
V_22 -> V_349 = 1 ;
V_22 -> V_94 ++ ;
...
case V_360 :
case V_353 :
F_192 ( & ( V_22 -> V_240 -> V_345 ) ) ;
V_22 -> V_349 = 0 ;
}
if ( F_131 ( V_70 ) )
F_193 ( V_70 , & V_22 -> V_240 -> V_345 ) ;
V_354:
F_194 ( V_50 , V_347 ) ;
F_195 () ;
...
static int F_205 ( struct V_149 * V_150 ,
struct V_21 * V_22 )
{
int V_367 = 0 ;
F_206 ( V_150 ) ;
...
struct V_21 * V_22 ;
int V_180 ;
int V_71 = F_209 ( V_150 -> V_363 ) ;
V_22 = F_55 ( V_150 -> V_179 , V_156 , V_158 ) ;
if ( V_22 ) {
F_48 ( L_263 ) ;
return - V_369 ;
}
V_22 = F_210 ( sizeof( struct V_21 ) , V_274 , V_71 ) ;
if ( ! V_22 )
return - V_371 ;
strcpy ( V_22 -> V_31 , V_156 ) ;
V_22 -> V_220 = F_211 ( V_146 * sizeof( struct V_372 ) ,
V_71 ) ;
if ( V_22 -> V_220 == NULL ) {
F_212 ( V_22 ) ;
return - V_371 ;
...
static int T_14 F_215 ( int V_363 , struct V_10 * V_11 )
{
struct V_149 * V_150 ;
struct V_385 * V_386 ;
struct V_387 * V_335 ;
V_150 = F_210 ( sizeof( struct V_149 ) , V_274 ,
F_209 ( V_363 ) ) ;
if ( ! V_150 ) {
F_48 ( L_265 ) ;
return - V_371 ;
...
static void F_228 ( struct V_149 * V_150 ,
struct V_21 * V_22 )
{
struct V_338 * V_339 , * V_117 ;
struct V_21 * V_335 ;
F_206 ( V_150 ) ;
F_172 (q, n, &t->if_list) {
V_335 = F_173 ( V_339 , struct V_21 , V_341 ) ;
if ( V_335 == V_22 )
F_229 ( & V_335 -> V_341 ) ;
}
F_208 ( V_150 ) ;
}
static int F_174 ( struct V_149 * V_150 ,
struct V_21 * V_22 )
{
F_32 ( L_268 , V_22 ) ;
if ( V_22 -> V_90 ) {
...
static int T_14 F_231 ( struct V_179 * V_179 )
{
...
F_217 ( & V_11 -> V_389 ) ;
V_11 -> V_173 = false ;
V_11 -> V_167 = F_232 ( V_377 , V_11 -> V_179 -> V_392 ) ;
if ( ! V_11 -> V_167 ) {
F_10 ( L_270 , V_377 ) ;
return - V_181 ;
}
V_386 = F_233 ( V_393 , 0600 , V_11 -> V_167 , & V_394 ) ;
if ( V_386 == NULL ) {
F_48 ( L_271 , V_393 ) ;
V_151 = - V_18 ;
goto remove;
...
return 0 ;
V_395:
F_177 ( V_393 , V_11 -> V_167 ) ;
remove:
F_177 ( V_377 , V_11 -> V_179 -> V_392 ) ;
return V_151 ;
}
static void T_15 F_236 ( struct V_179 * V_179 )
{
struct V_10 * V_11 = F_4 ( V_179 , V_15 ) ;
struct V_149 * V_150 ;
struct V_338 * V_339 , * V_117 ;
...
V_11 -> V_173 = true ;
F_49 ( & V_153 ) ;
F_238 ( & V_11 -> V_389 , & V_341 ) ;
F_51 ( & V_153 ) ;
F_172 (q, n, &list) {
V_150 = F_173 ( V_339 , struct V_149 , V_388 ) ;
F_222 ( & V_150 -> V_388 ) ;
F_225 ( V_150 -> V_342 ) ;
F_212 ( V_150 ) ;
}
