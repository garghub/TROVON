...
static int F_89 ( struct V_69 * V_2 , struct V_88 * V_89 , int * V_44 , int V_114 )
{
struct V_91 * V_92 = (struct V_91 * ) V_89 ;
struct V_2 * V_3 = V_2 -> V_3 ;
F_2 ( L_18 , V_2 , V_3 ) ;
...
static int F_90 ( struct V_115 * V_116 , struct V_69 * V_2 ,
...
static void F_92 ( struct V_12 * V_16 , T_4 V_33 )
{
...
V_120 . V_122 = 0x00 ;
F_93 ( V_15 , V_123 , sizeof( V_120 ) , & V_120 ) ;
} else {
struct V_124 V_120 ;
F_33 ( & V_120 . V_121 , & V_16 -> V_28 ) ;
V_120 . V_125 = F_94 ( V_16 -> V_125 ) ;
V_120 . V_126 = F_95 ( 0x00001f40 ) ;
V_120 . V_127 = F_95 ( 0x00001f40 ) ;
V_120 . V_128 = F_94 ( V_33 ) ;
switch ( V_33 & V_129 ) {
case V_130 :
if ( V_16 -> V_125 & V_131 )
V_120 . V_132 = F_94 ( 0x0008 ) ;
else
V_120 . V_132 = F_94 ( 0x000D ) ;
V_120 . V_133 = 0x02 ;
break;
case V_134 :
V_120 . V_132 = F_94 ( 0xffff ) ;
V_120 . V_133 = 0xff ;
break;
}
F_93 ( V_15 , V_135 ,
...
static int F_96 ( struct V_115 * V_116 , struct V_69 * V_2 ,
...
F_58 ( V_3 ) ;
if ( V_3 -> V_4 == V_65 &&
F_97 ( V_138 , & F_61 ( V_3 ) -> V_67 ) ) {
F_92 ( V_137 -> V_16 -> V_13 , V_137 -> V_33 ) ;
V_3 -> V_4 = V_61 ;
F_59 ( V_3 ) ;
return 0 ;
}
F_59 ( V_3 ) ;
return F_98 ( V_116 , V_2 , V_43 , V_44 , V_67 ) ;
}
static int F_99 ( struct V_69 * V_2 , int V_139 , int V_140 , char T_5 * V_141 , unsigned int V_142 )
{
struct V_2 * V_3 = V_2 -> V_3 ;
int V_44 , V_22 = 0 ;
struct V_143 V_144 ;
...
if ( F_100 ( V_145 , ( T_6 T_5 * ) V_141 ) ) {
V_22 = - V_50 ;
break;
}
if ( V_145 )
F_101 ( V_138 , & F_61 ( V_3 ) -> V_67 ) ;
else
F_102 ( V_138 , & F_61 ( V_3 ) -> V_67 ) ;
break;
case V_147 :
if ( V_3 -> V_4 != V_78 && V_3 -> V_4 != V_97 &&
V_3 -> V_4 != V_65 ) {
...
V_44 = F_103 (unsigned int, sizeof(voice), optlen) ;
if ( F_104 ( ( char * ) & V_144 , V_141 , V_44 ) ) {
V_22 = - V_50 ;
break;
}
if ( V_144 . V_33 != V_34 &&
...
static int F_105 ( struct V_69 * V_2 , int V_140 , char T_5 * V_141 , int T_5 * V_142 )
{
struct V_2 * V_3 = V_2 -> V_3 ;
struct V_149 V_150 ;
struct V_151 V_152 ;
...
F_2 ( L_19 , V_150 . V_21 ) ;
V_44 = F_103 (unsigned int, len, sizeof(opts)) ;
if ( F_106 ( V_141 , ( char * ) & V_150 , V_44 ) )
V_22 = - V_50 ;
break;
case V_154 :
if ( V_3 -> V_4 != V_39 &&
...
V_44 = F_103 (unsigned int, len, sizeof(cinfo)) ;
if ( F_106 ( V_141 , ( char * ) & V_152 , V_44 ) )
V_22 = - V_50 ;
break;
default:
V_22 = - V_148 ;
...
static int F_107 ( struct V_69 * V_2 , int V_139 , int V_140 , char T_5 * V_141 , int T_5 * V_142 )
{
struct V_2 * V_3 = V_2 -> V_3 ;
int V_44 , V_22 = 0 ;
struct V_143 V_144 ;
F_2 ( L_9 , V_3 ) ;
if ( V_139 == V_158 )
return F_105 ( V_2 , V_140 , V_141 , V_142 ) ;
if ( F_100 ( V_44 , V_142 ) )
return - V_50 ;
F_58 ( V_3 ) ;
switch ( V_140 ) {
...
if ( F_108 ( F_97 ( V_138 , & F_61 ( V_3 ) -> V_67 ) ,
( T_6 T_5 * ) V_141 ) )
V_22 = - V_50 ;
break;
case V_147 :
V_144 . V_33 = F_15 ( V_3 ) -> V_33 ;
V_44 = F_103 (unsigned int, len, sizeof(voice)) ;
if ( F_106 ( V_141 , ( char * ) & V_144 , V_44 ) )
V_22 = - V_50 ;
break;
default:
V_22 = - V_148 ;
...
static int F_109 ( struct V_69 * V_2 , int V_159 )
{
struct V_2 * V_3 = V_2 -> V_3 ;
int V_22 = 0 ;
F_2 ( L_18 , V_2 , V_3 ) ;
...
static int F_110 ( struct V_69 * V_2 )
{
struct V_2 * V_3 = V_2 -> V_3 ;
int V_22 = 0 ;
F_2 ( L_18 , V_2 , V_3 ) ;
...
static void F_112 ( struct V_11 * V_16 )
{
struct V_2 * V_25 ;
...
int F_115 ( struct V_14 * V_15 , T_1 * V_121 , T_7 * V_67 )
{
struct V_2 * V_3 ;
int V_167 = 0 ;
...
void F_116 ( struct V_12 * V_13 , T_7 V_171 )
{
...
F_20 ( V_13 , F_117 ( V_171 ) ) ;
}
void F_118 ( struct V_12 * V_13 , T_7 V_172 )
{
F_2 ( L_22 , V_13 , V_172 ) ;
F_20 ( V_13 , F_117 ( V_172 ) ) ;
}
int F_119 ( struct V_12 * V_13 , struct V_45 * V_46 )
{
struct V_11 * V_16 = V_13 -> V_17 ;
if ( ! V_16 )
goto V_51;
...
static int F_120 ( struct V_173 * V_174 , void * V_175 )
{
struct V_2 * V_3 ;
F_48 ( & V_55 . V_19 ) ;
F_45 (sk, &sco_sk_list.head) {
F_121 ( V_174 , L_24 , & F_15 ( V_3 ) -> V_27 ,
& F_15 ( V_3 ) -> V_28 , V_3 -> V_4 ) ;
}
F_49 ( & V_55 . V_19 ) ;
return 0 ;
}
static int F_122 ( struct V_176 * V_176 , struct V_177 * V_177 )
{
return F_123 ( V_177 , F_120 , V_176 -> V_178 ) ;
}
int T_8 F_124 ( void )
{
int V_22 ;
...
if ( V_22 < 0 )
return V_22 ;
V_22 = F_126 ( V_165 , & V_179 ) ;
if ( V_22 < 0 ) {
F_127 ( L_25 ) ;
goto error;
}
V_22 = F_128 ( & V_180 , L_26 , & V_55 , NULL ) ;
if ( V_22 < 0 ) {
F_127 ( L_27 ) ;
F_129 ( V_165 ) ;
goto error;
