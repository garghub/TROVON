...
if ( V_56 -> V_64 & V_65 )
V_57 [ 1 ] |= V_70 ;
V_40 = F_19 ( V_32 , V_71 , V_57 , sizeof( V_57 ) ) ;
if ( V_40 < 0 )
return V_40 ;
return 0 ;
}
static T_4 F_26 ( struct V_72 * V_73 )
{
return V_74 | V_75 |
V_76 |
V_77 |
...
static int F_27 ( struct V_31 * V_32 , struct V_37 * V_38 )
{
unsigned int V_39 ;
int V_40 ;
...
static int F_29 ( struct V_72 * V_73 , struct V_86 * V_87 ,
int V_88 )
{
struct V_31 * V_32 = V_73 -> V_89 ;
unsigned int V_6 , V_90 ;
struct V_37 V_38 ;
int V_40 = 0 ;
memset ( & V_38 , 0 , sizeof( V_38 ) ) ;
for ( V_6 = 0 ; V_6 < V_88 ; V_6 ++ ) {
V_38 . V_41 = V_87 [ V_6 ] . V_91 ;
V_38 . V_33 = ( V_87 [ V_6 ] . V_92 & V_93 ) ?
V_94 :
V_95 ;
V_38 . V_33 |= V_96 ;
V_38 . V_35 = NULL ;
...
if ( V_40 < 0 )
break;
for ( V_90 = 0 ; V_90 < V_87 [ V_6 ] . V_97 ; V_90 ++ ) {
V_38 . V_35 = V_87 [ V_6 ] . V_98 + V_90 ;
V_38 . V_36 = 1 ;
V_40 = F_27 ( V_32 , & V_38 ) ;
if ( V_40 < 0 )
break;
...
{
F_31 ( & V_32 -> V_42 ) ;
V_32 -> V_99 . V_100 = & V_101 ;
V_32 -> V_99 . V_89 = V_32 ;
V_32 -> V_99 . V_102 = 3 ;
V_32 -> V_99 . V_103 = V_104 ;
V_32 -> V_99 . V_105 = V_106 ;
V_32 -> V_99 . V_107 . V_108 = V_32 -> V_107 ;
V_32 -> V_99 . V_107 . V_109 = V_32 -> V_107 -> V_109 ;
F_32 ( V_32 -> V_99 . V_110 , V_32 -> V_110 ? V_32 -> V_110 : F_33 ( V_32 -> V_107 ) ,
sizeof( V_32 -> V_99 . V_110 ) ) ;
return F_34 ( & V_32 -> V_99 ) ;
}
