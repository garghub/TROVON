...
if ( ( V_162 -> V_164 + 1 + V_162 -> V_93 ) >= V_151 -> V_24 ) {
F_11 ( L_23 ,
V_162 -> V_93 , V_162 -> type , V_162 -> V_164 , V_151 -> V_24 ) ;
return - V_51 ;
}
return 0 ;
}
...
struct V_161 V_172 ;
int V_20 ;
V_20 = F_59 ( V_12 , & V_172 , V_12 -> V_93 ) ;
if ( V_20 )
return false ;
if ( V_172 . type != V_169 )
return false ;
...
V_93 = V_162 -> V_93 ;
for ( V_3 = 0 ; V_3 <= ( V_162 -> V_164 + 1 ) ; V_3 ++ , V_93 ++ )
F_69 ( L_24 , V_93 , V_63 [ V_93 ] ) ;
}
...
* V_174 = V_12 -> V_25 ;
( * V_174 ) -> V_177 =
( V_178 ) V_176 -> V_32 [ V_93 + 3 ] << 32 ;
( * V_174 ) -> V_177 |= V_176 -> V_32 [ V_93 + 0 ] ;
} else
* V_174 = & V_12 -> V_25 [ ( V_93 / 4 ) ] ;
return 0 ;
}
