...
{
struct V_9 * V_10 = F_3 ( V_2 ) ;
T_4 V_151 , V_142 , V_145 ;
T_4 V_16 ;
V_151 = F_7 ( V_10 , V_156 ) ;
V_142 = F_7 ( V_10 , V_157 ) ;
V_145 = F_7 ( V_10 , V_158 ) ;
V_145 >>= ( V_3 * V_159 ) ;
V_145 &= V_160 ;
V_155 -> V_78 = 0 ;
if ( V_3 == 7 ) {
...
V_16 = F_46 ( V_10 , V_165 ) ;
V_16 |= V_166 ;
V_16 &= ~ ( V_167 | V_168 ) ;
F_53 ( V_10 , V_16 , V_165 ) ;
F_62 ( 21 ) ;
V_16 = F_46 ( V_10 , V_165 ) ;
V_16 &= ~ V_166 ;
F_53 ( V_10 , V_16 , V_165 ) ;
...
struct V_169 * V_170 )
{
struct V_171 * V_60 = V_2 -> V_49 [ V_2 -> V_50 ] . V_172 ;
struct V_9 * V_10 = F_3 ( V_2 ) ;
struct V_169 V_173 ;
V_60 -> V_174 -> V_175 ( V_60 , & V_173 ) ;
V_170 -> V_62 = V_173 . V_62 ;
memset ( & V_170 -> V_176 , 0 , sizeof( V_170 -> V_176 ) ) ;
if ( V_173 . V_177 & V_178 )
memcpy ( & V_170 -> V_176 , V_173 . V_176 , sizeof( V_170 -> V_176 ) ) ;
if ( V_10 -> V_57 & ( 1 << V_3 ) )
V_170 -> V_177 = V_173 . V_177 ;
else
V_170 -> V_177 = 0 ;
}
...
V_10 -> V_57 &= ~ ( 1 << V_21 ) ;
return V_60 -> V_174 -> V_180 ( V_60 , V_170 ) ;
}
