...
{
struct V_35 * V_32 = V_128 -> V_27 . V_133 ;
struct V_6 * V_7 ;
struct V_134 * V_26 ;
struct V_135 * V_69 , * V_136 , * V_137 , * V_30 , * V_138 ;
int V_103 , V_38 ;
if ( ! V_32 || ! V_32 -> V_104 )
return - V_123 ;
V_69 = F_51 ( V_128 , V_139 , 0 ) ;
V_136 = F_51 ( V_128 , V_139 , 1 ) ;
V_137 = F_51 ( V_128 , V_139 , 2 ) ;
V_30 = F_51 ( V_128 , V_139 , 3 ) ;
V_138 = F_51 ( V_128 , V_140 , 0 ) ;
if ( ! V_138 )
return - V_123 ;
...
if ( F_53 ( V_7 -> V_8 ) )
return F_54 ( V_7 -> V_8 ) ;
V_7 -> V_11 = F_52 ( & V_128 -> V_27 , V_136 ) ;
if ( F_53 ( V_7 -> V_11 ) )
return F_54 ( V_7 -> V_11 ) ;
V_7 -> V_24 = F_52 ( & V_128 -> V_27 , V_137 ) ;
if ( F_53 ( V_7 -> V_24 ) )
...
F_23 ( V_7 ) ;
F_58 ( & V_128 -> V_27 ) ;
F_59 ( V_141 , V_26 -> V_142 ) ;
F_59 ( V_143 , V_26 -> V_142 ) ;
V_7 -> V_25 . V_144 = & V_145 ;
V_7 -> V_25 . V_146 = sizeof( struct V_83 ) ;
