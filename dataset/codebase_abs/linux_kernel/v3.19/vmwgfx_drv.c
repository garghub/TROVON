...
V_22 -> V_155 = F_59 ( V_22 -> V_110 ,
V_22 -> V_120 ) ;
V_22 -> V_156 = F_60 ( V_22 -> V_110 ,
V_22 -> V_120 ) ;
if ( F_5 ( V_22 -> V_156 == NULL ) ) {
V_23 = - V_87 ;
F_14 ( L_46 ) ;
goto V_157;
}
...
V_22 -> V_159 = F_62
( V_22 -> V_160 . V_143 , 12 , & V_161 ) ;
if ( F_5 ( V_22 -> V_159 == NULL ) ) {
F_14 ( L_48 ) ;
V_23 = - V_87 ;
goto V_158;
}
V_70 -> V_162 = V_22 ;
V_23 = F_63 ( V_70 -> V_88 , L_49 ) ;
V_22 -> V_163 = ( V_23 != 0 ) ;
if ( V_22 -> V_163 ) {
F_2 ( L_50
L_51 ) ;
V_23 = F_64 ( V_70 -> V_88 , 2 , L_52 ) ;
if ( F_5 ( V_23 != 0 ) ) {
F_14 ( L_53 ) ;
goto V_164;
}
...
if ( V_22 -> V_1 & V_12 ) {
V_23 = F_65 ( V_70 , V_70 -> V_88 -> V_165 ) ;
if ( V_23 != 0 ) {
F_14 ( L_54 , V_23 ) ;
goto V_166;
}
...
F_81 ( V_22 -> V_155 ) ;
if ( V_22 -> V_41 )
( void ) F_82 ( & V_22 -> V_30 , V_154 ) ;
if ( V_22 -> V_152 )
( void ) F_82 ( & V_22 -> V_30 , V_153 ) ;
( void ) F_82 ( & V_22 -> V_30 , V_149 ) ;
V_151:
( void ) F_83 ( & V_22 -> V_30 ) ;
V_148:
F_84 ( V_22 ) ;
...
return V_23 ;
F_50 ( & V_180 -> V_181 ) ;
V_180 -> V_185 = F_100 ( V_22 -> V_159 , 10 ) ;
...
static int F_135 ( struct V_233 * V_88 , T_5 V_35 )
{
struct V_79 * V_70 = F_128 ( V_88 ) ;
struct V_21 * V_22 = F_88 ( V_70 ) ;
if ( V_22 -> V_47 != 0 ) {
