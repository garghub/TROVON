...
F_35 (jrpriv, &driver_data.jr_list, list_node) {
V_69 = F_16 ( & V_32 -> V_33 ) ;
if ( V_69 < V_67 ) {
V_67 = V_69 ;
V_66 = V_32 ;
...
void F_37 ( struct V_1 * V_72 )
{
struct V_3 * V_32 = F_2 ( V_72 ) ;
F_38 ( & V_32 -> V_33 ) ;
}
int F_39 ( struct V_1 * V_2 , T_3 * V_49 ,
void (* F_40)( struct V_1 * V_2 , T_3 * V_49 ,
T_3 V_50 , void * V_73 ) ,
void * V_73 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
...
int V_46 , error ;
V_4 = F_2 ( V_2 ) ;
F_48 ( & V_4 -> V_20 , F_26 , ( unsigned long ) V_2 ) ;
error = F_49 ( V_4 -> V_21 , F_21 , V_82 ,
F_50 ( V_2 ) , V_2 ) ;
if ( error ) {
F_7 ( V_2 , L_7 ,
V_4 -> V_15 , V_4 -> V_21 ) ;
...
if ( error )
return error ;
V_4 -> V_25 = F_51 ( V_2 , sizeof( T_1 ) * V_24 ,
& V_17 , V_84 ) ;
V_4 -> V_27 = F_51 ( V_2 , sizeof( struct V_26 ) *
V_24 , & V_18 , V_84 ) ;
V_4 -> V_28 = F_52 ( sizeof( struct V_74 ) * V_24 ,
V_84 ) ;
if ( ( V_4 -> V_25 == NULL ) || ( V_4 -> V_27 == NULL ) ||
( V_4 -> V_28 == NULL ) ) {
F_7 ( V_2 , L_8 ,
V_4 -> V_15 ) ;
return - V_85 ;
...
V_4 -> V_47 = 0 ;
V_4 -> V_48 = 0 ;
F_53 ( & V_4 -> V_6 -> V_22 , V_17 ) ;
F_53 ( & V_4 -> V_6 -> V_23 , V_18 ) ;
F_4 ( & V_4 -> V_6 -> V_86 , V_24 ) ;
F_4 ( & V_4 -> V_6 -> V_87 , V_24 ) ;
V_4 -> V_88 = V_24 ;
F_54 ( & V_4 -> V_78 ) ;
F_54 ( & V_4 -> V_56 ) ;
F_3 ( & V_4 -> V_6 -> V_7 , V_89 |
( V_90 << V_91 ) |
( V_92 << V_93 ) ) ;
return 0 ;
}
...
int error ;
V_31 = & V_30 -> V_2 ;
V_32 = F_56 ( V_31 , sizeof( struct V_3 ) ,
V_84 ) ;
if ( ! V_32 )
return - V_85 ;
F_57 ( V_31 , V_32 ) ;
...
V_32 -> V_6 = (struct V_96 V_100 * ) V_97 ;
if ( sizeof( T_1 ) == sizeof( V_101 ) )
if ( F_59 ( V_95 , L_10 ) )
F_60 ( V_31 , F_61 ( 40 ) ) ;
else
F_60 ( V_31 , F_61 ( 36 ) ) ;
...
F_60 ( V_31 , F_61 ( 32 ) ) ;
V_32 -> V_21 = F_62 ( V_95 , 0 ) ;
error = F_47 ( V_31 ) ;
if ( error )
return error ;
V_32 -> V_2 = V_31 ;
F_17 ( & V_35 . V_36 ) ;
F_63 ( & V_32 -> V_37 , & V_35 . V_70 ) ;
F_19 ( & V_35 . V_36 ) ;
F_64 ( & V_32 -> V_33 , 0 ) ;
return 0 ;
}
