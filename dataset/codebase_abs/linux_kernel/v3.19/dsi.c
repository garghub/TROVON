...
struct V_609 * V_611 ;
struct V_609 V_612 ;
V_16 = F_286 ( & V_3 -> V_4 , sizeof( * V_16 ) , V_613 ) ;
if ( ! V_16 )
return - V_614 ;
V_16 -> V_157 = V_3 ;
F_287 ( & V_3 -> V_4 , V_16 ) ;
...
V_16 -> V_141 . V_26 = 0 ;
#endif
V_611 = F_294 ( V_3 , V_615 , L_178 ) ;
if ( ! V_611 ) {
V_611 = F_295 ( V_3 , V_615 , 0 ) ;
if ( ! V_611 ) {
F_44 ( L_179 ) ;
return - V_153 ;
}
V_612 . T_9 = V_611 -> T_9 ;
V_612 . T_10 = V_612 . T_9 + V_616 - 1 ;
V_611 = & V_612 ;
}
V_610 = V_611 ;
V_16 -> V_19 = F_296 ( & V_3 -> V_4 , V_611 -> T_9 ,
F_297 ( V_611 ) ) ;
if ( ! V_16 -> V_19 ) {
F_44 ( L_180 ) ;
return - V_614 ;
}
V_611 = F_294 ( V_3 , V_615 , L_181 ) ;
if ( ! V_611 ) {
V_611 = F_295 ( V_3 , V_615 , 0 ) ;
if ( ! V_611 ) {
F_44 ( L_179 ) ;
...
V_612 . T_9 = V_611 -> T_9 + V_617 ;
V_612 . T_10 = V_612 . T_9 + V_618 - 1 ;
V_611 = & V_612 ;
}
V_16 -> V_21 = F_296 ( & V_3 -> V_4 , V_611 -> T_9 ,
F_297 ( V_611 ) ) ;
if ( ! V_16 -> V_19 ) {
F_44 ( L_182 ) ;
return - V_614 ;
}
V_611 = F_294 ( V_3 , V_615 , L_183 ) ;
if ( ! V_611 ) {
V_611 = F_295 ( V_3 , V_615 , 0 ) ;
if ( ! V_611 ) {
F_44 ( L_179 ) ;
...
V_612 . T_9 = V_611 -> T_9 + V_619 ;
V_612 . T_10 = V_612 . T_9 + V_620 - 1 ;
V_611 = & V_612 ;
}
V_16 -> V_23 = F_296 ( & V_3 -> V_4 , V_611 -> T_9 ,
F_297 ( V_611 ) ) ;
if ( ! V_16 -> V_19 ) {
F_44 ( L_184 ) ;
return - V_614 ;
...
V_621 , F_300 ( & V_3 -> V_4 ) , V_16 -> V_157 ) ;
if ( V_155 < 0 ) {
F_44 ( L_186 ) ;
return V_155 ;
}
...
V_623 = F_301 ( V_626 , V_3 -> V_4 . V_598 ) ;
if ( ! V_623 ) {
F_44 ( L_187 ) ;
return - V_202 ;
}
V_625 = V_623 -> V_26 ;
while ( V_625 -> V_627 != 0 && V_625 -> V_627 != V_610 -> T_9 )
V_625 ++ ;
if ( V_625 -> V_627 == 0 ) {
F_44 ( L_187 ) ;
return - V_202 ;
}
V_16 -> V_181 = V_625 -> V_10 ;
} else {
V_16 -> V_181 = V_3 -> V_10 ;
}
for ( V_109 = 0 ; V_109 < F_47 ( V_16 -> V_149 ) ; V_109 ++ ) {
...
V_608 = F_9 ( V_3 , V_232 ) ;
F_303 ( & V_3 -> V_4 , L_188 ,
F_101 ( V_608 , 7 , 4 ) , F_101 ( V_608 , 3 , 0 ) ) ;
if ( F_84 ( V_260 ) )
...
static int F_310 ( struct V_630 * V_4 )
{
...
static int F_314 ( struct V_630 * V_4 )
{
struct V_2 * V_157 = F_4 ( V_4 ) ;
struct V_1 * V_16 = F_1 ( V_157 ) ;
int V_155 ;
