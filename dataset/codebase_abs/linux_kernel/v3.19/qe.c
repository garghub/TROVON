...
if ( V_124 )
strncpy ( V_112 . V_81 , V_124 ,
sizeof( V_112 . V_81 ) - 1 ) ;
V_4 = F_37 ( V_123 , L_22 , NULL ) ;
if ( V_4 && ( V_4 -> V_96 == sizeof( V_126 ) ) ) {
const V_126 * V_127 = V_4 -> V_128 ;
V_112 . V_113 = * V_127 ;
}
V_4 = F_37 ( V_123 , L_23 , NULL ) ;
if ( V_4 && ( V_4 -> V_96 == 32 ) ) {
const T_2 * V_127 = V_4 -> V_128 ;
for ( V_48 = 0 ; V_48 < F_38 ( V_112 . V_114 ) ; V_48 ++ )
...
static int F_43 ( struct V_132 * V_133 )
{
return 0 ;
}
