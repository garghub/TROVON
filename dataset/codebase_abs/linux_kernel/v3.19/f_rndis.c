...
void F_60 ( struct V_131 * V_3 , struct V_70 * V_71 )
{
struct V_84 * V_132 ;
V_132 = F_2 ( V_3 , struct V_84 , V_87 ) ;
if ( V_132 -> V_95 )
F_61 ( F_62 ( V_132 -> V_71 ) ) ;
else
F_63 ( V_132 -> V_71 ) ;
V_132 -> V_133 = V_132 -> V_95 = true ;
V_132 -> V_71 = V_71 ;
}
static inline struct V_84 * F_64 ( struct V_134 * V_135 )
{
return F_2 ( F_65 ( V_135 ) , struct V_84 ,
V_87 . V_136 ) ;
}
static void F_66 ( struct V_131 * V_3 )
{
struct V_84 * V_132 ;
V_132 = F_2 ( V_3 , struct V_84 , V_87 ) ;
if ( ! V_132 -> V_133 ) {
...
F_58 ( V_132 -> V_94 . V_136 . V_137 ) ;
F_58 ( V_132 ) ;
}
static struct V_131 * F_67 ( void )
{
struct V_84 * V_132 ;
struct V_138 * V_139 [ 1 ] ;
char * V_140 [ 1 ] ;
V_132 = F_45 ( sizeof( * V_132 ) , V_90 ) ;
if ( ! V_132 )
return F_68 ( - V_91 ) ;
V_132 -> V_94 . V_141 = V_132 -> V_142 ;
F_69 ( & V_132 -> V_143 ) ;
V_132 -> V_87 . V_144 = F_66 ;
V_132 -> V_71 = F_70 () ;
if ( F_33 ( V_132 -> V_71 ) ) {
struct V_70 * V_71 = V_132 -> V_71 ;
F_58 ( V_132 ) ;
return F_71 ( V_71 ) ;
}
F_72 ( & V_132 -> V_94 . V_145 ) ;
V_139 [ 0 ] = & V_132 -> V_94 ;
V_140 [ 0 ] = L_20 ;
F_73 ( & V_132 -> V_87 . V_136 , 1 , V_139 ,
V_140 , V_146 ) ;
F_74 ( & V_132 -> V_87 . V_136 , L_21 ,
& V_147 ) ;
return & V_132 -> V_87 ;
}
...
V_17 = F_1 ( V_3 ) ;
F_76 ( V_17 -> V_23 ) ;
V_132 = F_2 ( V_3 -> V_86 , struct V_84 , V_87 ) ;
F_58 ( V_17 ) ;
F_77 ( & V_132 -> V_143 ) ;
V_132 -> V_148 -- ;
F_78 ( & V_132 -> V_143 ) ;
...
static struct V_2 * F_80 ( struct V_131 * V_86 )
{
struct V_1 * V_17 ;
struct V_84 * V_132 ;
int V_26 ;
...
if ( ! V_17 )
return F_68 ( - V_91 ) ;
V_132 = F_2 ( V_86 , struct V_84 , V_87 ) ;
F_77 ( & V_132 -> V_143 ) ;
V_132 -> V_148 ++ ;
F_81 ( V_132 -> V_71 , V_17 -> V_127 ) ;
V_17 -> V_129 = V_132 -> V_149 ;
V_17 -> V_128 = V_132 -> V_128 ;
V_17 -> V_4 . V_150 = F_62 ( V_132 -> V_71 ) ;
F_78 ( & V_132 -> V_143 ) ;
V_17 -> V_4 . V_75 = 0 ;
V_17 -> V_4 . V_151 = sizeof( struct V_15 ) ;
V_17 -> V_4 . V_152 = F_6 ;
V_17 -> V_4 . V_153 = V_154 ;
V_17 -> V_4 . V_5 . V_35 = L_20 ;
V_17 -> V_4 . V_5 . V_155 = F_44 ;
V_17 -> V_4 . V_5 . V_156 = F_79 ;
V_17 -> V_4 . V_5 . V_157 = F_27 ;
V_17 -> V_4 . V_5 . V_158 = F_22 ;
V_17 -> V_4 . V_5 . V_159 = F_36 ;
V_17 -> V_4 . V_5 . V_160 = F_75 ;
V_26 = F_82 ( F_10 , V_17 ) ;
if ( V_26 < 0 ) {
F_58 ( V_17 ) ;
return F_68 ( V_26 ) ;
