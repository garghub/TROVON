...
if ( V_197 > F_40 ( V_78 -> V_201 ) ) {
T_7 V_231 = V_197 - F_40 ( V_78 -> V_201 ) ;
F_38 ( V_78 , V_196 , V_231 ) ;
V_197 -= V_231 ;
}
V_78 -> V_232 = ( T_14 ) V_197 ;
return V_16 ;
}
static T_1 F_41 ( T_7 V_203 , struct V_62 * * V_196 ,
T_7 * V_200 )
{
T_1 V_8 ;
unsigned long V_26 ;
...
V_200 = 0 ;
V_240:
V_8 = F_43 ( V_17 , & V_236 , & V_233 , & V_235 ,
& V_238 , & V_234 ) ;
if ( V_8 != V_16 )
return V_8 ;
V_237 = V_203 ;
V_203 = V_233 / V_235 ;
if ( V_203 > V_237 &&
V_203 > F_40 ( V_77 -> V_201 ) ) {
T_7 V_231 = V_203 - F_40 ( V_77 -> V_201 ) ;
V_8 = F_41 ( V_231 , & V_196 , & V_200 ) ;
if ( V_8 != V_16 )
goto V_241;
F_4 ( V_23 , V_236 ) ;
goto V_240;
