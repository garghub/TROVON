...
void * V_51 ;
V_48 = V_5 - F_39 ( V_5 ) ;
V_49 = F_22 ( V_4 + F_39 ( V_5 ) , V_52 ) ;
if ( V_45 )
V_50 = F_40 ( V_53 ) ;
else
V_50 = F_41 ( V_53 ) ;
V_47 = F_42 ( V_49 , sizeof( struct V_46 * ) , V_41 ) ;
if ( ! V_47 ) {
F_23 ( L_11 ,
V_35 , V_49 ) ;
return NULL ;
...
T_6 V_54 = V_48 + V_14 * V_52 ;
V_47 [ V_14 ] = F_43 ( V_54 >> V_55 ) ;
}
V_51 = F_44 ( V_47 , V_49 , V_56 , V_50 ) ;
F_36 ( V_47 ) ;
return V_51 ;
}
static void * F_45 ( T_6 V_5 , T_1 V_4 ,
unsigned int V_45 )
{
void * V_57 ;
if ( ! F_46 ( V_5 , V_4 , L_12 ) ) {
F_23 ( L_13 ,
...
static int F_49 ( T_6 V_5 , T_6 V_4 ,
struct V_1 * V_2 , int V_45 )
{
V_2 -> V_58 = V_5 ;
V_2 -> V_4 = V_4 ;
if ( F_50 ( V_5 >> V_55 ) )
V_2 -> V_51 = F_38 ( V_5 , V_4 , V_45 ) ;
else
V_2 -> V_51 = F_45 ( V_5 , V_4 , V_45 ) ;
if ( ! V_2 -> V_51 ) {
F_23 ( L_14 , V_35 ,
( unsigned long long ) V_4 , ( unsigned long long ) V_5 ) ;
return - V_59 ;
}
V_2 -> V_3 = V_2 -> V_51 + F_39 ( V_5 ) ;
V_2 -> F_1 = V_4 - sizeof( struct V_20 ) ;
return 0 ;
}
static int F_51 ( struct V_1 * V_2 , T_8 V_60 ,
struct V_30 * V_16 )
{
int V_38 ;
V_38 = F_21 ( V_2 , V_16 ) ;
...
struct V_1 * F_57 ( T_6 V_5 , T_1 V_4 ,
T_8 V_60 , struct V_30 * V_16 ,
unsigned int V_45 )
{
struct V_1 * V_2 ;
int V_38 = - V_59 ;
V_2 = F_58 ( sizeof( struct V_1 ) , V_41 ) ;
if ( ! V_2 ) {
F_23 ( L_18 ) ;
goto V_62;
}
V_38 = F_49 ( V_5 , V_4 , V_2 , V_45 ) ;
if ( V_38 )
goto V_62;
V_38 = F_51 ( V_2 , V_60 , V_16 ) ;
if ( V_38 )
goto V_62;
return V_2 ;
V_62:
