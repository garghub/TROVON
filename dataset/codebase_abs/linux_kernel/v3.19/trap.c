...
V_8 -> V_65 . V_75 = ( void * ) V_1 ;
F_45 ( V_69 , 1 ) ;
}
else if ( V_8 -> V_65 . V_75 != NULL )
F_43 ( L_5 ) ;
else if ( ! V_4 && F_46 ( V_2 , V_48 ) )
goto V_25;
if ( ! V_4 ) {
F_42 ( F_40 ( V_48 , struct V_71 , V_48 ) ) ;
F_43 ( L_6 ,
...
void F_48 ( int V_67 , struct V_59 * V_60 , struct V_47 * V_48 )
{
struct V_51 * V_52 ;
struct V_59 V_79 ;
if ( ! F_36 ( V_48 ) ) {
...
void F_51 ( int V_67 , struct V_59 * V_60 , struct V_47 * V_48 )
{
if ( V_8 -> V_65 . V_74 != NULL )
F_45 ( V_8 -> V_65 . V_74 , 1 ) ;
else
F_48 ( V_67 , V_60 , V_48 ) ;
}
void F_52 ( int V_67 , struct V_59 * V_68 , struct V_47 * V_48 )
{
F_53 ( V_85 , V_48 ) ;
}
void F_54 ( void )
