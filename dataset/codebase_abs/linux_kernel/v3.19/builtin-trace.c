...
if ( V_267 < 0 )
goto V_379;
V_267 = F_144 ( V_30 , V_243 -> V_269 . V_380 , false ) ;
if ( V_267 < 0 )
goto V_381;
F_145 ( V_30 ) ;
if ( V_372 )
F_146 ( V_30 ) ;
V_243 -> V_255 = V_30 -> V_271 -> V_327 [ 0 ] == - 1 || V_30 -> V_271 -> V_382 > 1 ;
V_383:
V_371 = V_243 -> V_231 ;
for ( V_294 = 0 ; V_294 < V_30 -> V_384 ; V_294 ++ ) {
union V_258 * V_259 ;
...
if ( V_19 -> V_338 . type == V_387 &&
V_15 . V_16 == NULL ) {
fprintf ( V_243 -> V_262 , L_98 ,
F_105 ( V_19 ) , V_15 . V_240 ,
V_15 . V_388 , V_15 . V_389 ) ;
goto V_385;
}
V_22 = V_19 -> V_22 ;
V_22 ( V_243 , V_19 , V_259 , & V_15 ) ;
...
char V_394 [ V_395 ] ;
V_374:
F_156 ( V_30 , V_396 , V_394 , sizeof( V_394 ) ) ;
goto V_397;
V_381:
F_157 ( V_30 , V_396 , V_394 , sizeof( V_394 ) ) ;
goto V_397;
V_379:
F_158 ( V_30 , V_396 , V_394 , sizeof( V_394 ) ) ;
V_397:
fprintf ( V_243 -> V_262 , L_103 , V_394 ) ;
goto V_377;
}
}
...
V_243 -> V_255 = true ;
V_405 = F_160 ( & V_401 , false , & V_243 -> V_266 ) ;
if ( V_405 == NULL )
return - 1 ;
if ( F_94 ( & V_405 -> V_260 . V_422 ) < 0 )
goto V_36;
V_243 -> V_268 = & V_405 -> V_423 . V_268 ;
V_267 = F_161 ( V_405 , V_399 ) ;
if ( V_267 )
goto V_36;
V_19 = F_162 ( V_405 -> V_30 ,
L_82 ) ;
if ( V_19 == NULL )
V_19 = F_162 ( V_405 -> V_30 ,
L_84 ) ;
...
double V_426 = F_170 ( V_245 ) ;
double V_427 ;
T_5 T_2 = ( T_5 ) V_245 -> T_2 ;
V_427 = V_426 ? 100.0 * F_171 ( V_245 ) / V_426 : 0.0 ;
V_426 /= V_220 ;
V_273 = & V_243 -> V_284 . V_234 [ V_298 -> V_294 ] ;
V_52 += fprintf ( V_218 , L_114 , V_273 -> V_20 ) ;
V_52 += fprintf ( V_218 , L_115 V_263 L_116 ,
T_2 , V_425 , V_426 ) ;
V_52 += fprintf ( V_218 , L_117 , V_227 , V_427 ) ;
}
V_298 = F_172 ( V_298 ) ;
}
...
V_52 += fprintf ( V_218 , L_119 , F_87 ( V_229 ) , V_229 -> V_240 ) ;
V_52 += fprintf ( V_218 , L_120 , V_225 -> V_231 ) ;
V_52 += fprintf ( V_218 , L_121 , V_430 ) ;
if ( V_225 -> V_341 )
V_52 += fprintf ( V_218 , L_122 , V_225 -> V_341 ) ;
if ( V_225 -> V_342 )
V_52 += fprintf ( V_218 , L_123 , V_225 -> V_342 ) ;
V_52 += fprintf ( V_218 , L_124 , V_225 -> V_319 ) ;
...
V_429 . V_52 = F_167 ( V_218 ) ;
F_174 ( V_243 -> V_268 , F_173 , & V_429 ) ;
return V_429 . V_52 ;
}
static int F_175 ( const struct V_431 * V_432 , const char * V_433 ,
int T_9 V_300 )
{
...
static int F_176 ( struct V_243 * V_243 , const char * V_435 )
{
struct V_237 V_238 ;
if ( ! V_237 ( V_435 , & V_238 ) && V_238 . V_241 ) {
char V_436 [ V_236 ] ;
F_18 ( V_436 , sizeof( V_436 ) , L_125 , V_435 ) ;
F_177 ( V_436 ) ;
rename ( V_435 , V_436 ) ;
}
V_243 -> V_262 = fopen ( V_435 , L_126 ) ;
return V_243 -> V_262 == NULL ? - V_396 : 0 ;
}
static int F_178 ( const struct V_431 * V_432 , const char * V_433 ,
int T_9 V_300 )
{
int * V_364 = V_432 -> V_434 ;
if ( strcmp ( V_433 , L_127 ) == 0 )
* V_364 |= V_365 | V_366 ;
...
. V_283 = {
. V_257 = F_180 () ,
. V_307 = F_181 ( L_132 , V_243 . V_283 . V_257 ) ,
} ,
. V_284 = {
. V_227 = - 1 ,
} ,
...
L_133 ) ,
F_182 ( 0 , L_134 , & V_243 . V_393 , L_135 ) ,
F_183 ( 'e' , L_136 , & V_446 , L_136 ,
L_137 ) ,
F_183 ( 'o' , L_138 , & V_445 , L_139 , L_140 ) ,
F_183 ( 'i' , L_141 , & V_402 , L_139 , L_142 ) ,
F_183 ( 'p' , L_61 , & V_243 . V_269 . V_270 . V_302 , L_61 ,
L_143 ) ,
F_183 ( 't' , L_144 , & V_243 . V_269 . V_270 . V_240 , L_144 ,
L_145 ) ,
F_182 ( 'a' , L_146 , & V_243 . V_269 . V_270 . V_448 ,
L_147 ) ,
F_183 ( 'C' , L_148 , & V_243 . V_269 . V_270 . V_449 , L_148 ,
L_149 ) ,
F_182 ( 0 , L_150 , & V_243 . V_269 . V_450 ,
L_151 ) ,
F_184 ( 'm' , L_152 , & V_243 . V_269 . V_380 , L_153 ,
L_154 ,
V_451 ) ,
F_183 ( 'u' , L_155 , & V_243 . V_269 . V_270 . V_452 , L_156 ,
L_157 ) ,
F_184 ( 0 , L_158 , & V_243 , L_159 ,
L_160 ,
F_175 ) ,
F_182 ( 0 , L_90 , & V_243 . V_376 , L_161 ) ,
F_185 ( 'v' , L_162 , & V_295 , L_163 ) ,
F_182 ( 'T' , L_164 , & V_243 . V_349 ,
L_165 ) ,
F_182 ( 's' , L_166 , & V_243 . V_304 ,
L_167 ) ,
F_182 ( 'S' , L_168 , & V_243 . V_306 ,
L_169 ) ,
F_186 ( 'F' , L_170 , & V_243 . V_364 , L_171 ,
L_172 , F_178 , L_67 ) ,
F_182 ( 0 , L_2 , & V_243 . V_363 , L_173 ) ,
F_187 ()
} ;
int V_267 ;
char V_39 [ V_395 ] ;
V_351 = F_188 ( V_351 , V_352 , V_447 , V_437 ,
V_453 ) ;
if ( V_243 . V_364 ) {
