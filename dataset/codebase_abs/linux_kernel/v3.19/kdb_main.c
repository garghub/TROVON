...
if ( V_27 )
return V_27 ;
if ( ( V_249 > V_246 ) || ! V_247 [ V_249 ] . V_248 )
return V_203 ;
V_250 = V_249 ;
return V_158 ;
}
...
{
int V_251 = 0 , V_252 = 0 ;
unsigned long V_253 = F_100 ( L_131 ) ,
V_254 = F_100 ( L_132 ) ;
unsigned long V_2 ;
const struct V_1 * V_3 , * V_255 ;
F_101 (cpu) {
V_3 = F_1 ( V_2 ) ;
if ( F_102 ( V_3 , V_253 ) )
++ V_251 ;
...
int V_2 ;
unsigned long V_256 ;
if ( ! V_3 || F_106 ( & V_256 , ( char * ) V_3 , sizeof( unsigned long ) ) )
return;
V_2 = F_50 ( V_3 ) ;
F_17 ( L_139 ,
( void * ) V_3 , V_3 -> V_136 , V_3 -> V_257 -> V_136 ,
F_48 ( V_3 ) , F_50 ( V_3 ) ,
F_97 ( V_3 ) ,
( void * ) ( & V_3 -> V_258 ) ,
V_3 == F_1 ( F_52 () ) ? '*' : ' ' ,
...
{
struct V_1 * V_255 , * V_3 ;
unsigned long V_260 , V_2 ;
if ( V_31 == 0 )
F_99 () ;
F_17 ( L_143 ,
( int ) ( 2 * sizeof( void * ) ) + 2 , L_144 ,
( int ) ( 2 * sizeof( void * ) ) + 2 , L_145 ) ;
V_260 = F_100 ( V_31 ? V_32 [ 1 ] : NULL ) ;
F_101 (cpu) {
if ( F_33 ( V_102 ) )
return 0 ;
V_3 = F_1 ( V_2 ) ;
...
if ( V_27 )
return V_30 ;
V_3 = F_109 ( ( V_261 ) V_26 , & V_262 ) ;
if ( ! V_3 ) {
F_17 ( L_147 , ( V_261 ) V_26 ) ;
return 0 ;
}
}
F_47 ( V_3 ) ;
...
if ( ! V_263 -> V_106 )
continue;
if ( ! F_6 ( V_263 -> V_109 , V_56 , true ) )
continue;
if ( strlen ( V_263 -> V_265 ) > 20 )
V_264 = L_155 ;
F_17 ( L_156 , V_263 -> V_106 ,
V_263 -> V_265 , V_264 , V_263 -> V_266 ) ;
}
return 0 ;
}
...
static void F_114 ( struct V_277 * V_278 , struct V_279 * V_280 )
{
static int V_281 [] = { 31 , 29 , 31 , 30 , 31 , 30 , 31 ,
31 , 30 , 31 , 30 , 31 } ;
memset ( V_280 , 0 , sizeof( * V_280 ) ) ;
V_280 -> V_282 = V_278 -> V_283 % ( 24 * 60 * 60 ) ;
V_280 -> V_284 = V_278 -> V_283 / ( 24 * 60 * 60 ) +
( 2 * 365 + 1 ) ;
V_280 -> V_285 = V_280 -> V_282 / 60 % 60 ;
V_280 -> V_286 = V_280 -> V_282 / 60 / 60 ;
V_280 -> V_282 = V_280 -> V_282 % 60 ;
V_280 -> V_287 = 68 + 4 * ( V_280 -> V_284 / ( 4 * 365 + 1 ) ) ;
V_280 -> V_284 %= ( 4 * 365 + 1 ) ;
V_281 [ 1 ] = 29 ;
while ( V_280 -> V_284 >= V_281 [ V_280 -> V_288 ] ) {
V_280 -> V_284 -= V_281 [ V_280 -> V_288 ] ;
if ( ++ V_280 -> V_288 == 12 ) {
V_280 -> V_288 = 0 ;
++ V_280 -> V_287 ;
V_281 [ 1 ] = 28 ;
...
static void F_115 ( struct V_289 * V_26 )
{
struct V_277 V_290 ;
F_116 ( & V_290 ) ;
memset ( V_26 , 0 , sizeof( * V_26 ) ) ;
V_26 -> V_290 = V_290 . V_283 ;
V_26 -> V_291 [ 0 ] = V_292 [ 0 ] ;
V_26 -> V_291 [ 1 ] = V_292 [ 1 ] ;
V_26 -> V_291 [ 2 ] = V_292 [ 2 ] ;
V_26 -> V_293 = V_294 - 1 ;
F_117 ( V_26 ) ;
return;
}
...
if ( V_31 )
return V_35 ;
F_17 ( L_160 , V_296 . V_46 . V_297 ) ;
F_17 ( L_161 , V_296 . V_46 . V_298 ) ;
F_17 ( L_162 , V_296 . V_46 . V_299 ) ;
F_17 ( L_163 , V_296 . V_46 . V_300 ) ;
F_17 ( L_164 , V_296 . V_46 . V_301 ) ;
F_17 ( L_165 , V_296 . V_46 . V_302 ) ;
F_17 ( L_166 , F_119 ( V_303 ) ) ;
V_295 = F_120 () ;
F_114 ( & V_295 , & V_280 ) ;
F_17 ( L_167
L_168 ,
1900 + V_280 . V_287 , V_280 . V_288 + 1 , V_280 . V_284 ,
V_280 . V_286 , V_280 . V_285 , V_280 . V_282 ,
V_304 . V_305 ) ;
F_115 ( & V_26 ) ;
F_17 ( L_169 ) ;
if ( V_26 . V_290 > ( 24 * 60 * 60 ) ) {
int V_306 = V_26 . V_290 / ( 24 * 60 * 60 ) ;
V_26 . V_290 %= ( 24 * 60 * 60 ) ;
F_17 ( L_170 , V_306 , V_306 == 1 ? L_1 : L_171 ) ;
}
F_17 ( L_172 , V_26 . V_290 / ( 60 * 60 ) , ( V_26 . V_290 / 60 ) % 60 ) ;
#define F_121 ( T_11 ) ((x) >> FSHIFT)
#define F_122 ( T_11 ) LOAD_INT(((x) & (FIXED_1-1)) * 100)
F_17 ( L_173 ,
F_121 ( V_26 . V_291 [ 0 ] ) , F_122 ( V_26 . V_291 [ 0 ] ) ,
F_121 ( V_26 . V_291 [ 1 ] ) , F_122 ( V_26 . V_291 [ 1 ] ) ,
F_121 ( V_26 . V_291 [ 2 ] ) , F_122 ( V_26 . V_291 [ 2 ] ) ) ;
#undef F_121
#undef F_122
#define F_123 ( T_11 ) ((x) << (PAGE_SHIFT - 10))
F_17 ( L_174
L_175 ,
V_26 . V_307 , V_26 . V_308 , V_26 . V_309 ) ;
return 0 ;
}
...
char V_172 [ 64 ] ;
int V_2 , V_27 , V_44 = 1 ;
unsigned long V_47 , V_310 , V_26 , V_175 = 0 , V_311 = ~ 0UL ;
if ( V_31 < 1 || V_31 > 3 )
return V_35 ;
V_27 = F_19 ( V_31 , V_32 , & V_44 , & V_310 , NULL , NULL ) ;
if ( V_27 )
return V_27 ;
if ( V_31 >= 2 ) {
...
if ( F_33 ( V_102 ) )
return 0 ;
if ( V_311 != ~ 0UL && V_311 != V_2 )
continue;
V_47 = V_310 + F_126 ( V_2 ) ;
V_27 = F_65 ( & V_26 , V_47 , V_175 ) ;
if ( V_27 ) {
F_17 ( L_178 V_312 L_179
L_180 , V_2 , V_47 , V_27 ) ;
continue;
}
F_17 ( L_178 , V_2 ) ;
...
if ( V_16 >= V_108 ) {
T_5 * V_315 = F_30 ( ( V_108 - V_316 +
V_317 ) * sizeof( * V_315 ) , V_78 ) ;
if ( ! V_315 ) {
F_17 ( L_194
L_195 ) ;
return 1 ;
...
if ( V_318 ) {
memcpy ( V_315 , V_318 ,
( V_108 - V_316 ) * sizeof( * V_315 ) ) ;
F_27 ( V_318 ) ;
}
memset ( V_315 + V_108 - V_316 , 0 ,
V_317 * sizeof( * V_315 ) ) ;
V_318 = V_315 ;
V_241 = V_318 + V_108 - V_316 ;
V_108 += V_317 ;
}
V_241 -> V_106 = V_116 ;
V_241 -> V_111 = V_313 ;
...
short V_314 )
{
return F_24 ( V_116 , V_313 , V_76 , V_77 , V_314 , 0 ) ;
}
...
L_215 , 0 ,
V_54 ) ;
F_24 ( L_216 , V_323 , L_207 ,
L_217 , 1 ,
V_54 | V_324 ) ;
F_24 ( L_218 , V_323 , L_219 ,
L_220 , 0 ,
V_325 ) ;
F_24 ( L_221 , V_323 , L_222 ,
L_223 , 0 ,
V_325 ) ;
F_24 ( L_224 , V_323 , L_1 ,
L_225 , 0 ,
V_325 ) ;
F_24 ( L_226 , V_323 , L_196 ,
L_227 , 0 ,
V_54 | V_324 ) ;
F_24 ( L_228 , F_84 , L_1 ,
L_229 , 0 ,
...
{
int V_16 , V_27 ;
for ( V_16 = 0 ; V_331 [ V_16 ] ; ++ V_16 ) {
V_27 = F_31 ( V_331 [ V_16 ] ) ;
if ( V_27 )
F_17 ( L_270 ,
V_331 [ V_16 ] , V_27 ) ;
}
...
void T_13 F_132 ( int V_332 )
{
static int V_333 = V_334 ;
int V_16 ;
if ( V_333 == V_335 || V_332 <= V_333 )
return;
for ( V_16 = V_333 ; V_16 < V_332 ; V_16 ++ ) {
switch ( V_16 ) {
case V_334 :
F_130 () ;
F_133 () ;
