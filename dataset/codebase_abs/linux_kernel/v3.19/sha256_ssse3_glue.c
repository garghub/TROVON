...
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
unsigned int V_17 = V_4 -> V_14 % V_19 ;
int V_23 ;
if ( V_17 + V_16 < V_19 ) {
V_4 -> V_14 += V_16 ;
...
V_29 = F_11 ( V_4 -> V_14 << 3 ) ;
V_26 = V_4 -> V_14 % V_19 ;
V_27 = ( V_26 < 56 ) ? ( 56 - V_26 ) : ( ( V_19 + 56 ) - V_26 ) ;
if ( ! F_6 () ) {
F_7 ( V_2 , V_30 , V_27 ) ;
...
static int F_14 ( struct V_1 * V_2 , const void * V_31 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
...
static int F_16 ( struct V_1 * V_2 , T_1 * V_40 )
{
T_1 V_41 [ V_42 ] ;
F_10 ( V_2 , V_41 ) ;
