...
F_68 ( V_92 , & V_104 , & V_10 ) ;
* V_30 = ! ( ( V_10 & V_105 ) && ( V_10 & V_106 ) ) ;
return 0 ;
}
...
* V_30 = true ;
while ( V_107 != V_108 ) {
V_31 = F_88 ( V_24 , V_107 , V_30 ) ;
if ( V_31 )
return V_31 ;
if ( ! * V_30 ) {
F_9 ( L_15 ,
( unsigned long long ) F_65 ( V_107 ) ) ;
return 0 ;
}
V_107 = F_58 ( F_65 ( V_107 ) + 1 ) ;
}
return 0 ;
}
int F_91 ( struct V_23 * V_24 , T_8 V_109 )
{
int V_31 ;
bool V_110 ;
T_3 V_111 = F_66 ( 0 , 0 ) ;
F_92 ( & V_24 -> V_99 ) ;
F_93 ( & V_111 ) ;
if ( F_65 ( V_109 ) < F_65 ( V_24 -> V_66 ) ) {
V_31 = F_90 ( V_24 , V_109 , V_24 -> V_66 , & V_110 ) ;
if ( V_31 ) {
F_94 ( & V_111 ) ;
goto V_112;
}
...
T_9 V_115 , bool V_116 )
{
int V_31 ;
V_31 = ( V_116 ? F_99 : F_101 ) ( V_24 , V_115 ) ;
if ( V_31 )
return V_31 ;
V_24 -> V_90 = true ;
return 0 ;
...
int V_31 ;
F_92 ( & V_24 -> V_99 ) ;
V_31 = F_105 ( V_24 , V_115 , V_116 ) ;
F_96 ( & V_24 -> V_99 ) ;
return V_31 ;
}
static int F_107 ( struct V_23 * V_24 ,
T_10 V_117 , void * V_37 )
{
int V_31 = 0 ;
T_11 V_4 ;
bool V_116 ;
...
T_9 V_115 = F_57 ( V_4 ) ;
if ( V_24 -> V_73 ) {
V_31 = F_103 ( V_24 , V_115 , & V_116 ) ;
if ( V_31 )
return V_31 ;
} else
V_116 = false ;
V_31 = V_117 ( V_37 , V_24 -> V_61 , V_115 , V_116 ) ;
if ( V_31 )
break;
}
return V_31 ;
...
static int F_112 ( struct V_23 * V_24 , T_8 V_118 )
{
int V_31 ;
T_3 V_92 = F_66 ( 0 , 0 ) ;
F_93 ( & V_92 ) ;
V_31 = F_113 ( & V_24 -> V_42 , V_24 -> V_58 , F_65 ( V_118 ) ,
& V_92 , & V_24 -> V_58 ) ;
if ( V_31 )
return V_31 ;
V_24 -> V_90 = true ;
...
int F_114 ( struct V_23 * V_24 , T_8 V_118 )
{
int V_31 ;
F_92 ( & V_24 -> V_99 ) ;
V_31 = F_112 ( V_24 , V_118 ) ;
F_96 ( & V_24 -> V_99 ) ;
return V_31 ;
}
...
struct V_120 * V_121 )
{
const char * V_55 = F_118 ( V_121 ) ;
const unsigned * V_56 = F_119 ( V_121 ) ;
T_1 V_44 = F_120 ( V_121 ) ;
...
struct V_120 * V_121 )
{
return V_24 -> V_73 && F_117 ( V_24 , V_121 ) &&
F_121 ( V_24 ) ;
}
static int F_123 ( void * V_37 , T_7 V_118 , void * V_122 )
{
int V_31 = 0 ;
bool V_123 ;
T_3 V_92 ;
...
T_6 V_119 ;
unsigned V_10 ;
struct V_125 * V_125 = V_37 ;
struct V_23 * V_24 = V_125 -> V_24 ;
memcpy ( & V_92 , V_122 , sizeof( V_92 ) ) ;
F_68 ( V_92 , & V_119 , & V_10 ) ;
if ( V_10 & V_105 ) {
if ( V_125 -> V_126 ) {
...
V_123 = V_125 -> V_128 ? ( V_10 & V_106 ) : true ;
V_31 = V_125 -> V_117 ( V_125 -> V_37 , V_119 , F_58 ( V_118 ) ,
V_123 , F_8 ( V_124 ) , V_125 -> V_126 ) ;
}
return V_31 ;
}
static int F_124 ( struct V_23 * V_24 ,
struct V_120 * V_121 ,
T_12 V_117 , void * V_37 )
{
struct V_125 V_125 ;
V_125 . V_117 = V_117 ;
V_125 . V_37 = V_37 ;
V_125 . V_24 = V_24 ;
V_125 . V_128 = V_24 -> V_73 ;
V_125 . V_126 = F_122 ( V_24 , V_121 ) ;
return F_125 ( & V_24 -> V_42 , V_24 -> V_58 , F_123 , & V_125 ) ;
}
...
int V_31 ;
F_109 ( & V_24 -> V_99 ) ;
V_31 = F_124 ( V_24 , V_121 , V_117 , V_37 ) ;
F_110 ( & V_24 -> V_99 ) ;
return V_31 ;
}
static int F_127 ( void * V_37 , T_7 V_118 , void * V_122 )
{
int V_31 = 0 ;
T_3 V_92 ;
T_6 V_119 ;
...
static int F_131 ( struct V_23 * V_24 , T_8 V_118 , bool V_123 )
{
int V_31 ;
unsigned V_10 ;
T_6 V_119 ;
T_3 V_92 ;
V_31 = F_89 ( & V_24 -> V_42 , V_24 -> V_58 , F_65 ( V_118 ) , & V_92 ) ;
if ( V_31 )
return V_31 ;
F_68 ( V_92 , & V_119 , & V_10 ) ;
if ( ( ( V_10 & V_106 ) && V_123 ) || ( ! ( V_10 & V_106 ) && ! V_123 ) )
return 0 ;
V_92 = F_66 ( V_119 , ( V_10 & ~ V_106 ) | ( V_123 ? V_106 : 0 ) ) ;
F_93 ( & V_92 ) ;
V_31 = F_113 ( & V_24 -> V_42 , V_24 -> V_58 , F_65 ( V_118 ) ,
& V_92 , & V_24 -> V_58 ) ;
if ( V_31 )
...
T_8 V_118 , bool V_123 )
{
int V_31 ;
F_92 ( & V_24 -> V_99 ) ;
V_31 = F_131 ( V_24 , V_118 , V_123 ) ;
F_96 ( & V_24 -> V_99 ) ;
return V_31 ;
}
...
int F_135 ( struct V_23 * V_24 , bool V_130 )
{
int V_31 ;
T_5 V_88 = ( V_130 ? F_52 :
F_54 ) ;
...
int V_31 = - V_17 ;
F_109 ( & V_24 -> V_99 ) ;
V_31 = F_137 ( V_24 -> V_47 , V_30 ) ;
F_110 ( & V_24 -> V_99 ) ;
return V_31 ;
}
int F_138 ( struct V_23 * V_24 ,
T_11 * V_30 )
{
int V_31 = - V_17 ;
F_109 ( & V_24 -> V_99 ) ;
V_31 = F_139 ( V_24 -> V_47 , V_30 ) ;
F_110 ( & V_24 -> V_99 ) ;
return V_31 ;
}
static int F_140 ( struct V_23 * V_24 , struct V_120 * V_121 )
{
int V_31 ;
V_11 V_92 ;
T_1 V_131 ;
...
V_24 -> V_44 = V_131 ;
if ( V_24 -> V_59 ) {
V_31 = F_141 ( & V_24 -> V_45 , V_24 -> V_59 ) ;
if ( V_31 )
return V_31 ;
}
...
static int F_142 ( void * V_37 , T_8 V_118 , T_6 V_119 , T_2 V_132 )
{
...
F_65 ( V_118 ) , & V_92 , & V_24 -> V_59 ) ;
V_24 -> V_90 = true ;
return V_31 ;
}
static int F_143 ( struct V_23 * V_24 , struct V_120 * V_121 )
{
int V_31 ;
V_31 = F_140 ( V_24 , V_121 ) ;
if ( V_31 ) {
F_9 ( L_17 ) ;
return V_31 ;
}
return F_144 ( V_121 , F_142 , V_24 ) ;
}
int F_145 ( struct V_23 * V_24 , struct V_120 * V_121 )
{
int V_31 ;
F_92 ( & V_24 -> V_99 ) ;
V_31 = F_143 ( V_24 , V_121 ) ;
F_96 ( & V_24 -> V_99 ) ;
return V_31 ;
}
int F_146 ( struct V_23 * V_24 , bool * V_30 )
{
