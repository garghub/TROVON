...
V_30 = F_14 ( & ( V_2 -> V_8 ) , V_31 , V_28 ) ;
if ( ! V_30 ) {
F_13 ( L_5 , V_36 ) ;
goto V_37;
}
V_30 -> V_38 = F_15 ( V_34 , 0 ) ;
if ( V_30 -> V_38 <= 0 ) {
F_16 ( V_8 , L_6 ) ;
goto V_39;
}
if ( V_5 )
F_17 ( V_30 -> V_8 -> V_40 , V_5 ) ;
for ( V_23 = 0 , V_24 = 1 ; V_23 < V_41 ; V_23 ++ ) {
V_30 -> V_42 [ V_23 ] -> V_43 = F_15 ( V_34 , V_24 ++ ) ;
...
V_30 -> V_46 [ V_23 ] -> V_43 = F_15 ( V_34 , V_24 ++ ) ;
if ( V_30 -> V_46 [ V_23 ] -> V_43 <= 0 ) {
F_16 ( V_8 , L_8 ) ;
goto V_47;
}
}
V_30 -> V_48 = F_15 ( V_34 , V_24 ) ;
if ( V_30 -> V_48 <= 0 ) {
F_16 ( V_8 , L_9 ) ;
goto V_47;
}
