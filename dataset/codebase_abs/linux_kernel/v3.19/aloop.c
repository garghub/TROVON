...
static int F_21 ( struct V_52 * V_10 )
{
struct V_31 * V_32 = V_10 -> V_32 ;
struct V_1 * V_2 = V_32 -> V_54 ;
struct V_29 * V_30 = V_2 -> V_30 ;
...
return - V_67 ;
V_2 -> V_77 = 0 ;
V_2 -> V_78 = F_23 ( V_32 , V_32 -> V_79 ) ;
if ( V_10 -> V_13 == V_41 ) {
V_2 -> V_80 = V_2 -> V_78 ;
F_24 ( V_32 -> V_42 , V_32 -> V_81 ,
V_32 -> V_79 * V_32 -> V_44 ) ;
}
V_2 -> V_23 = 0 ;
V_2 -> V_24 = 0 ;
...
static void F_27 ( struct V_1 * V_2 , unsigned int V_84 )
{
...
static void F_29 ( struct V_1 * V_88 ,
struct V_1 * V_89 ,
unsigned int V_84 )
{
...
static inline unsigned int F_31 ( struct V_1 * V_2 ,
unsigned int V_99 )
{
unsigned long V_100 ;
unsigned int V_101 ;
...
static unsigned int F_33 ( struct V_29 * V_30 )
{
struct V_1 * V_102 =
V_30 -> V_40 [ V_14 ] ;
struct V_1 * V_103 =
...
goto V_108;
if ( V_104 > V_105 ) {
V_106 = F_31 ( V_102 , V_104 - V_105 ) ;
F_32 ( V_102 , V_106 ) ;
V_104 = V_105 ;
} else if ( V_104 < V_105 ) {
V_106 = F_31 ( V_103 , V_105 - V_104 ) ;
F_27 ( V_103 , V_106 ) ;
F_32 ( V_103 , V_106 ) ;
V_105 = V_104 ;
}
if ( V_104 == 0 && V_105 == 0 )
goto V_108;
V_106 = F_31 ( V_102 , V_104 ) ;
V_107 = F_31 ( V_103 , V_105 ) ;
if ( V_106 < V_107 ) {
...
F_29 ( V_102 , V_103 , V_106 ) ;
F_32 ( V_102 , V_106 ) ;
F_32 ( V_103 , V_106 ) ;
V_108:
return V_60 ;
}
static void F_34 ( unsigned long V_109 )
{
struct V_1 * V_2 = (struct V_1 * ) V_109 ;
unsigned long V_110 ;
F_35 ( & V_2 -> V_30 -> V_59 , V_110 ) ;
if ( F_33 ( V_2 -> V_30 ) & ( 1 << V_2 -> V_10 -> V_13 ) ) {
F_7 ( V_2 ) ;
if ( V_2 -> V_24 ) {
V_2 -> V_24 = 0 ;
F_36 ( & V_2 -> V_30 -> V_59 , V_110 ) ;
F_37 ( V_2 -> V_10 ) ;
return;
}
}
...
static T_1 F_38 ( struct V_52 * V_10 )
{
struct V_31 * V_32 = V_10 -> V_32 ;
struct V_1 * V_2 = V_32 -> V_54 ;
T_1 V_111 ;
...
static int F_41 ( struct V_52 * V_10 ,
struct V_112 * V_113 )
{
return F_42 ( V_10 ,
F_43 ( V_113 ) ) ;
...
static unsigned int F_46 ( struct V_52 * V_10 )
{
if ( ! V_10 -> V_12 -> V_9 )
return V_10 -> V_13 ;
else
...
struct V_118 * V_119 = F_48 ( V_113 , V_115 -> V_120 ) ;
...
V_125 . integer = 0 ;
return F_50 ( F_51 ( V_113 , V_115 -> V_120 ) , & V_125 ) ;
}
...
static int F_53 ( struct V_52 * V_10 )
{
struct V_31 * V_32 = V_10 -> V_32 ;
...
static int F_59 ( struct V_52 * V_10 )
{
struct V_15 * V_15 = V_10 -> V_54 ;
...
struct V_141 * V_12 ;
int V_55 ;
V_55 = F_61 ( V_15 -> V_35 , L_1 , V_9 ,
V_140 , V_140 , & V_12 ) ;
if ( V_55 < 0 )
return V_55 ;
F_62 ( V_12 , V_14 , & V_142 ) ;
F_62 ( V_12 , V_41 , & V_143 ) ;
V_12 -> V_54 = V_15 ;
V_12 -> V_144 = 0 ;
...
static int F_76 ( struct V_15 * V_15 , int V_18 )
{
...
V_16 -> V_43 = 48000 ;
V_16 -> V_44 = 2 ;
for ( V_164 = 0 ; V_164 < F_77 ( V_168 ) ;
V_164 ++ ) {
V_161 = F_78 ( & V_168 [ V_164 ] ,
V_15 ) ;
if ( ! V_161 )
return - V_132 ;
...
static void F_80 ( struct V_173 * V_174 ,
struct V_1 * V_2 ,
const char * V_156 )
{
F_81 ( V_174 , L_3 , V_156 ) ;
if ( V_2 == NULL ) {
F_81 ( V_174 , L_4 ) ;
return;
}
F_81 ( V_174 , L_5 , V_2 -> V_78 ) ;
F_81 ( V_174 , L_6 , V_2 -> V_77 ) ;
F_81 ( V_174 , L_7 , V_2 -> V_80 ) ;
F_81 ( V_174 , L_8 , V_2 -> V_22 ) ;
F_81 ( V_174 , L_9 , V_2 -> V_25 ) ;
F_81 ( V_174 , L_10 , V_2 -> V_7 ) ;
F_81 ( V_174 , L_11 , V_2 -> V_4 ) ;
F_81 ( V_174 , L_12 ,
V_2 -> V_24 ) ;
F_81 ( V_174 , L_13 , V_2 -> V_23 ) ;
F_81 ( V_174 , L_14 , V_2 -> V_21 ) ;
F_81 ( V_174 , L_15 ,
V_2 -> V_57 , V_28 ) ;
F_81 ( V_174 , L_16 , V_2 -> V_26 . V_27 ) ;
}
static void F_82 ( struct V_173 * V_174 ,
struct V_15 * V_15 ,
int V_175 ,
int V_176 )
{
struct V_29 * V_30 = V_15 -> V_133 [ V_175 ] [ V_176 ] ;
F_81 ( V_174 , L_17 , V_176 , V_175 ) ;
if ( V_30 == NULL ) {
F_81 ( V_174 , L_18 ) ;
return;
}
F_81 ( V_174 , L_19 , V_30 -> V_37 ) ;
F_81 ( V_174 , L_20 , V_30 -> V_60 ) ;
F_81 ( V_174 , L_21 , V_30 -> V_61 ) ;
F_80 ( V_174 , V_30 -> V_40 [ 0 ] , L_22 ) ;
F_80 ( V_174 , V_30 -> V_40 [ 1 ] , L_23 ) ;
}
static void F_83 ( struct V_177 * V_178 ,
struct V_173 * V_174 )
{
...
F_82 ( V_174 , V_15 , V_175 , V_176 ) ;
F_26 ( & V_15 -> V_83 ) ;
}
static int F_84 ( struct V_15 * V_15 , int V_180 )
{
char V_145 [ 32 ] ;
struct V_177 * V_178 ;
int V_55 ;
snprintf ( V_145 , sizeof( V_145 ) , L_24 , V_180 ) ;
V_55 = F_85 ( V_15 -> V_35 , V_145 , & V_178 ) ;
if ( V_55 < 0 )
return V_55 ;
F_86 ( V_178 , V_15 , F_83 ) ;
return 0 ;
}
static int F_87 ( struct V_181 * V_182 )
{
struct V_34 * V_35 ;
struct V_15 * V_15 ;
int V_130 = V_182 -> V_156 ;
int V_55 ;
V_55 = F_88 ( & V_182 -> V_130 , V_183 [ V_130 ] , V_156 [ V_130 ] , V_184 ,
...
V_15 -> V_35 = V_35 ;
F_89 ( & V_15 -> V_83 ) ;
V_55 = F_60 ( V_15 , 0 , V_185 [ V_130 ] ) ;
if ( V_55 < 0 )
goto V_186;
V_55 = F_60 ( V_15 , 1 , V_185 [ V_130 ] ) ;
if ( V_55 < 0 )
goto V_186;
V_55 = F_76 ( V_15 , V_187 [ V_130 ] ? 1 : 0 ) ;
if ( V_55 < 0 )
goto V_186;
F_84 ( V_15 , 0 ) ;
F_84 ( V_15 , 1 ) ;
...
static int F_93 ( struct V_181 * V_182 )
{
F_92 ( F_94 ( V_182 ) ) ;
return 0 ;
}
static int F_95 ( struct V_9 * V_191 )
{
struct V_34 * V_35 = F_96 ( V_191 ) ;
...
static int F_99 ( struct V_9 * V_191 )
{
struct V_34 * V_35 = F_96 ( V_191 ) ;
F_97 ( V_35 , V_193 ) ;
return 0 ;
...
{
int V_194 ;
for ( V_194 = 0 ; V_194 < F_77 ( V_195 ) ; ++ V_194 )
F_101 ( V_195 [ V_194 ] ) ;
F_102 ( & V_196 ) ;
}
