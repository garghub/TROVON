...
static void F_59 ( struct V_68 * V_69 , struct V_17 * V_18 )
{
struct V_1 * V_2 ;
char V_70 ;
int V_71 ;
...
V_70 = '0' + ( ( V_2 -> V_12 >> 1 ) & 0x7 ) ;
F_21 ( & V_2 -> V_20 ) ;
V_71 = V_2 -> V_22 -> V_72 ( V_2 , 0 , V_2 -> V_14 , F_60 ( V_2 -> V_14 ) ) ;
if ( V_71 < 0 ) {
F_61 ( V_69 , L_3 , V_71 ) ;
goto V_73;
}
for ( V_71 = 0 , V_26 = 1 ; V_71 < V_18 -> V_38 ; V_71 ++ , V_26 <<= 1 ) {
const char * V_74 ;
V_74 = F_62 ( V_18 , V_71 ) ;
if ( ! V_74 )
continue;
F_61 ( V_69 , L_4 ,
V_18 -> V_75 + V_71 , V_70 , V_71 , V_74 ,
( V_2 -> V_14 [ V_21 ] & V_26 ) ? L_5 : L_6 ,
( V_2 -> V_14 [ V_25 ] & V_26 ) ? L_7 : L_8 ,
( V_2 -> V_14 [ V_76 ] & V_26 ) ? L_9 : L_10 ) ;
F_63 ( V_69 , L_11 ) ;
}
V_73:
F_22 ( & V_2 -> V_20 ) ;
}
static int F_64 ( struct V_1 * V_2 , struct V_77 * V_52 ,
...
V_2 -> V_18 . V_75 = V_79 -> V_75 ;
V_2 -> V_18 . V_97 = true ;
V_2 -> V_18 . V_52 = V_52 ;
V_2 -> V_18 . V_98 = V_99 ;
V_11 = V_2 -> V_22 -> V_24 ( V_2 , V_100 ) ;
if ( V_11 < 0 )
goto V_101;
V_2 -> V_102 = V_79 -> V_102 ;
if ( V_2 -> V_30 && V_2 -> V_102 ) {
V_2 -> V_61 =
F_68 ( V_2 -> V_18 . V_52 -> V_58 ,
L_17 ) ;
if ( type == V_95 )
V_81 = V_79 -> V_81 ;
}
if ( ( V_11 & V_103 ) || ! ( V_11 & V_104 ) || V_81 ||
V_2 -> V_61 ) {
V_11 &= ~ ( V_103 | ( V_103 << 8 ) ) ;
V_11 |= V_104 | ( V_104 << 8 ) ;
if ( V_2 -> V_61 )
...
if ( V_81 )
V_11 |= V_106 | ( V_106 << 8 ) ;
V_11 = V_2 -> V_22 -> V_23 ( V_2 , V_100 , V_11 ) ;
if ( V_11 < 0 )
goto V_101;
}
V_11 = V_2 -> V_22 -> V_23 ( V_2 , V_76 , V_79 -> V_18 [ V_80 ] . V_107 ) ;
if ( V_11 < 0 )
goto V_101;
V_11 = V_2 -> V_22 -> V_72 ( V_2 , 0 , V_2 -> V_14 , F_60 ( V_2 -> V_14 ) ) ;
if ( V_11 < 0 )
goto V_101;
if ( V_2 -> V_14 [ V_108 ] != 0 ) {
V_2 -> V_14 [ V_108 ] = 0 ;
V_11 = V_2 -> V_22 -> V_23 ( V_2 , V_108 , 0 ) ;
if ( V_11 < 0 )
goto V_101;
}
if ( V_2 -> V_14 [ V_45 ] != 0 ) {
...
V_110 -> V_52 . V_58 ,
L_19 ) ;
V_79 -> V_81 = F_68 ( V_110 -> V_52 . V_58 ,
L_20 ) ;
V_110 -> V_30 = F_74 ( V_110 -> V_52 . V_58 , 0 ) ;
} else {
V_79 = F_75 ( & V_110 -> V_52 ) ;
if ( ! V_79 ) {
V_79 = F_76 ( & V_110 -> V_52 ,
sizeof( struct V_78 ) ,
V_117 ) ;
V_79 -> V_75 = - 1 ;
}
}
V_2 = F_77 ( sizeof( * V_2 ) , V_117 ) ;
if ( ! V_2 )
return - V_118 ;
V_2 -> V_30 = V_110 -> V_30 ;
V_11 = F_64 ( V_2 , & V_110 -> V_52 , V_110 , V_110 -> V_12 ,
V_112 -> V_119 , V_79 , 0 ) ;
if ( V_11 )
goto V_101;
F_78 ( V_110 , V_2 ) ;
...
static int F_80 ( struct V_109 * V_110 )
{
struct V_1 * V_2 = F_81 ( V_110 ) ;
if ( V_110 -> V_30 && V_2 -> V_102 )
F_56 ( V_2 ) ;
F_82 ( & V_2 -> V_18 ) ;
F_79 ( V_2 ) ;
return 0 ;
...
static int T_4 F_83 ( void ) { return 0 ; }
static void F_85 ( void ) { }
...
const struct V_114 * V_115 ;
T_5 V_125 = 0 ;
V_115 = F_72 ( F_73 ( V_126 ) , & V_122 -> V_52 ) ;
if ( V_115 ) {
type = ( int ) ( V_127 ) V_115 -> V_4 ;
V_11 = F_88 ( V_122 -> V_52 . V_58 ,
L_21 , & V_125 ) ;
if ( V_11 ) {
V_11 = F_88 ( V_122 -> V_52 . V_58 ,
L_22 , & V_125 ) ;
...
if ( ( V_125 <= 0 ) || ( V_125 >= 256 ) ) {
F_40 ( & V_122 -> V_52 , L_24 ) ;
return - V_60 ;
}
V_79 = & V_113 ;
V_79 -> V_75 = - 1 ;
for ( V_12 = 0 ; V_12 < F_60 ( V_79 -> V_18 ) ; V_12 ++ ) {
V_79 -> V_18 [ V_12 ] . V_107 = 0 ;
if ( V_125 & ( 1 << V_12 ) )
V_123 ++ ;
}
V_79 -> V_102 = F_68 (
V_122 -> V_52 . V_58 ,
L_19 ) ;
V_79 -> V_81 = F_68 ( V_122 -> V_52 . V_58 ,
L_20 ) ;
} else {
type = F_89 ( V_122 ) -> V_119 ;
V_79 = F_75 ( & V_122 -> V_52 ) ;
if ( ! V_79 ) {
V_79 = F_76 ( & V_122 -> V_52 ,
sizeof( struct V_78 ) ,
V_117 ) ;
V_79 -> V_75 = - 1 ;
}
for ( V_12 = 0 ; V_12 < F_60 ( V_79 -> V_18 ) ; V_12 ++ ) {
if ( ! V_79 -> V_18 [ V_12 ] . V_128 )
continue;
V_123 ++ ;
if ( ( type == V_88 ) && ( V_12 > 3 ) ) {
F_40 ( & V_122 -> V_52 ,
...
if ( ! V_123 )
return - V_60 ;
V_4 = F_77 ( sizeof( * V_4 ) + V_123 * sizeof( struct V_1 ) ,
V_117 ) ;
if ( ! V_4 )
return - V_118 ;
F_90 ( V_122 , V_4 ) ;
V_122 -> V_30 = F_74 ( V_122 -> V_52 . V_58 , 0 ) ;
for ( V_12 = 0 ; V_12 < F_60 ( V_79 -> V_18 ) ; V_12 ++ ) {
if ( ! ( V_125 & ( 1 << V_12 ) ) )
continue;
V_123 -- ;
V_4 -> V_2 [ V_12 ] = & V_4 -> V_18 [ V_123 ] ;
V_4 -> V_2 [ V_12 ] -> V_30 = V_122 -> V_30 ;
V_11 = F_64 ( V_4 -> V_2 [ V_12 ] , & V_122 -> V_52 , V_122 ,
0x40 | ( V_12 << 1 ) , type , V_79 ,
V_12 ) ;
if ( V_11 < 0 )
goto V_101;
if ( V_79 -> V_75 != - 1 )
V_79 -> V_75 += ( type == V_90 ) ? 16 : 8 ;
V_38 += ( type == V_90 ) ? 16 : 8 ;
}
V_4 -> V_38 = V_38 ;
return 0 ;
V_101:
for ( V_12 = 0 ; V_12 < F_60 ( V_4 -> V_2 ) ; V_12 ++ ) {
if ( ! V_4 -> V_2 [ V_12 ] )
continue;
F_82 ( & V_4 -> V_2 [ V_12 ] -> V_18 ) ;
}
F_79 ( V_4 ) ;
return V_11 ;
}
static int F_91 ( struct V_121 * V_122 )
{
struct V_124 * V_4 = F_92 ( V_122 ) ;
unsigned V_12 ;
for ( V_12 = 0 ; V_12 < F_60 ( V_4 -> V_2 ) ; V_12 ++ ) {
if ( ! V_4 -> V_2 [ V_12 ] )
continue;
if ( V_122 -> V_30 && V_4 -> V_2 [ V_12 ] -> V_102 )
F_56 ( V_4 -> V_2 [ V_12 ] ) ;
F_82 ( & V_4 -> V_2 [ V_12 ] -> V_18 ) ;
}
F_79 ( V_4 ) ;
...
static int T_4 F_93 ( void ) { return 0 ; }
static void F_95 ( void ) { }
