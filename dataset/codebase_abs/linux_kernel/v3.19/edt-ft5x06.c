...
if ( V_115 )
* V_115 ++ = '\0' ;
F_49 ( V_116 , V_27 + 1 , V_114 ) ;
F_49 ( V_113 , V_115 ? V_115 : L_26 , V_114 ) ;
} else {
V_19 -> V_34 = V_36 ;
...
static int F_56 ( struct V_25 * V_22 ,
struct V_18 * V_19 )
{
struct V_117 * V_118 = V_22 -> V_135 ;
V_19 -> V_136 = - V_51 ;
V_19 -> V_112 = F_57 ( V_118 , L_30 , 0 ) ;
V_19 -> V_110 = F_57 ( V_118 , L_31 , 0 ) ;
return 0 ;
}
static inline int F_56 ( struct V_25 * V_22 ,
struct V_18 * V_19 )
{
return - V_63 ;
}
...
char V_113 [ V_114 ] ;
F_34 ( & V_2 -> V_22 , L_32 ) ;
V_19 = F_60 ( & V_2 -> V_22 , sizeof( * V_19 ) , V_76 ) ;
if ( ! V_19 ) {
F_13 ( & V_2 -> V_22 , L_33 ) ;
return - V_77 ;
}
if ( ! V_120 ) {
error = F_56 ( & V_2 -> V_22 , V_19 ) ;
if ( error ) {
F_13 ( & V_2 -> V_22 ,
L_34 ) ;
return error ;
...
F_63 ( V_143 , V_43 -> V_144 ) ;
F_63 ( V_145 , V_43 -> V_144 ) ;
F_63 ( V_146 , V_43 -> V_144 ) ;
F_63 ( V_147 , V_43 -> V_148 ) ;
F_64 ( V_43 , V_149 , 0 , V_19 -> V_74 * 64 - 1 , 0 , 0 ) ;
F_64 ( V_43 , V_150 , 0 , V_19 -> V_75 * 64 - 1 , 0 , 0 ) ;
F_64 ( V_43 , V_45 ,
0 , V_19 -> V_74 * 64 - 1 , 0 , 0 ) ;
F_64 ( V_43 , V_46 ,
0 , V_19 -> V_75 * 64 - 1 , 0 , 0 ) ;
error = F_65 ( V_43 , V_38 , 0 ) ;
if ( error ) {
F_13 ( & V_2 -> V_22 , L_40 ) ;
return error ;
}
F_66 ( V_43 , V_19 ) ;
F_67 ( V_2 , V_19 ) ;
error = F_68 ( & V_2 -> V_22 , V_2 -> V_23 , NULL ,
F_5 ,
V_151 | V_152 ,
V_2 -> V_65 , V_19 ) ;
if ( error ) {
...
error = F_69 ( & V_2 -> V_22 . V_153 , & V_154 ) ;
if ( error )
return error ;
error = F_70 ( V_43 ) ;
if ( error )
goto V_155;
F_38 ( V_19 , F_71 ( & V_2 -> V_22 ) ) ;
F_72 ( & V_2 -> V_22 , 1 ) ;
F_34 ( & V_2 -> V_22 ,
L_42 ,
...
static int T_9 F_75 ( struct V_25 * V_22 )
{
struct V_1 * V_2 = F_15 ( V_22 ) ;
if ( F_76 ( V_22 ) )
F_77 ( V_2 -> V_23 ) ;
...
static int T_9 F_78 ( struct V_25 * V_22 )
{
struct V_1 * V_2 = F_15 ( V_22 ) ;
if ( F_76 ( V_22 ) )
F_79 ( V_2 -> V_23 ) ;
