...
int V_12 = 0 ;
F_24 ( & V_16 -> V_42 ) ;
if ( F_25 ( V_4 ) -> V_43 != F_23 )
goto V_44;
F_25 ( V_4 ) -> V_43 = F_9 ;
V_12 = F_26 ( V_45 , V_16 -> V_40 ,
F_6 ( V_4 ) ) ;
V_44:
F_27 ( & V_16 -> V_42 ) ;
if ( V_12 )
...
{
struct V_3 * V_4 = F_29 ( V_47 ) ;
struct V_15 * V_16 = F_10 ( V_4 ) ;
unsigned long V_48 ;
unsigned int V_49 ;
F_30 ( & V_16 -> V_42 ) ;
V_48 = F_31 () - 1 ;
V_49 = sizeof( struct V_5 ) ;
if ( V_48 & V_49 ) {
V_48 &= V_49 ;
V_48 -- ;
}
...
V_49 += F_6 ( V_4 ) ;
V_49 = F_32 ( V_49 , F_31 () ) ;
V_16 -> V_32 = V_49 - sizeof( struct V_5 ) ;
V_47 -> V_50 . V_49 = V_49 +
sizeof( struct V_17 ) ;
return F_33 ( V_47 ) ;
}
static struct V_51 * F_34 ( struct V_52 * * V_53 )
{
struct V_51 * V_54 ;
int V_12 ;
V_12 = F_35 () ;
if ( V_12 )
return F_36 ( V_12 ) ;
V_54 = F_37 ( & V_55 , V_53 , 0 , 0 ) ;
if ( F_38 ( V_54 ) )
goto V_56;
V_12 = - V_57 ;
if ( V_54 -> V_58 . V_59 . V_30 != V_54 -> V_58 . V_60 )
goto V_61;
V_54 -> V_58 . V_59 . V_43 = F_23 ;
V_54 -> V_58 . V_62 = F_28 ;
V_54 -> V_58 . V_63 = V_64 ;
V_54 -> V_58 . V_65 = sizeof( struct V_15 ) ;
V_54 -> V_58 . V_65 += V_54 -> V_58 . V_59 . V_30 ;
V_14:
return V_54 ;
V_61:
F_39 ( V_54 ) ;
...
static void F_41 ( struct V_51 * V_54 )
{
F_39 ( V_54 ) ;
F_40 () ;
}
