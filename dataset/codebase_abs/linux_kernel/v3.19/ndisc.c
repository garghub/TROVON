...
if ( ! V_56 -> V_135 . V_230 &&
F_77 ( F_32 ( V_56 -> V_5 ) , & F_41 ( V_2 ) -> V_99 ,
NULL , 0 ) ) {
F_9 ( 2 , V_215 ,
L_28 ,
V_2 -> V_5 -> V_183 ) ;
...
V_214 = V_235 ;
#endif
V_212 = F_119 ( & F_41 ( V_2 ) -> V_99 , V_2 -> V_5 ) ;
if ( V_212 ) {
V_53 = F_120 ( & V_212 -> V_107 , & F_41 ( V_2 ) -> V_99 ) ;
if ( ! V_53 ) {
F_9 ( 0 , V_96 ,
L_29 ,
V_28 ) ;
...
if ( V_212 == NULL && V_213 ) {
F_9 ( 3 , V_215 , L_31 ) ;
V_212 = F_123 ( & F_41 ( V_2 ) -> V_99 , V_2 -> V_5 , V_214 ) ;
if ( V_212 == NULL ) {
F_9 ( 0 , V_96 ,
L_32 ,
V_28 ) ;
...
V_212 -> V_236 = ( V_212 -> V_236 & ~ V_237 ) | F_124 ( V_214 ) ;
}
if ( V_212 )
F_125 ( V_212 , V_238 + ( V_239 * V_213 ) ) ;
if ( V_210 -> V_138 . V_240 ) {
V_56 -> V_135 . V_101 = V_210 -> V_138 . V_240 ;
if ( V_212 )
F_126 ( & V_212 -> V_107 , V_241 ,
V_210 -> V_138 . V_240 ) ;
}
V_229:
if ( V_56 -> V_60 ) {
unsigned long V_242 = F_127 ( V_210 -> V_243 ) ;
if ( V_242 && V_242 / 1000 < V_244 / V_239 ) {
V_242 = ( V_242 * V_239 ) / 1000 ;
if ( V_242 < V_239 / 10 )
V_242 = V_239 / 10 ;
F_128 ( V_56 -> V_60 , V_245 , V_242 ) ;
V_56 -> V_246 = V_238 ;
F_129 ( V_247 , V_56 ) ;
}
V_242 = F_127 ( V_210 -> V_248 ) ;
...
continue;
F_131 ( V_2 -> V_5 , ( T_1 * ) V_252 , ( V_252 -> V_14 ) << 3 ,
& F_41 ( V_2 ) -> V_99 ) ;
}
}
V_251:
...
F_9 ( 2 , V_27 , L_37 , V_260 ) ;
} else if ( V_56 -> V_135 . V_262 != V_260 ) {
V_56 -> V_135 . V_262 = V_260 ;
if ( V_212 )
F_126 ( & V_212 -> V_107 , V_263 , V_260 ) ;
F_133 ( V_2 -> V_5 , V_260 ) ;
}
}
if ( V_19 . V_35 ) {
...
T_1 * V_102 ;
struct V_17 V_19 ;
struct V_265 * V_132 = (struct V_265 * ) F_83 ( V_2 ) ;
T_2 V_164 = F_84 ( V_2 ) - ( F_83 ( V_2 ) +
F_85 ( struct V_265 , V_9 ) ) ;
#ifdef F_115
switch ( V_2 -> V_217 ) {
case V_218 :
case V_220 :
...
return;
if ( ! V_19 . V_264 ) {
F_135 ( V_2 , F_32 ( V_2 -> V_5 ) ,
V_2 -> V_5 -> V_115 , 0 ) ;
return;
}
V_102 = ( T_1 * ) V_19 . V_264 ;
V_102 += 8 ;
if ( ! F_136 ( V_2 , V_102 - F_83 ( V_2 ) ) )
return;
F_137 ( V_2 , V_266 , 0 , 0 ) ;
}
...
* ( V_9 ++ ) = ( V_268 >> 3 ) ;
V_9 += 6 ;
memcpy ( V_9 , F_41 ( V_267 ) , V_268 - 8 ) ;
}
void F_139 ( struct V_1 * V_2 , const struct V_37 * V_143 )
{
struct V_40 * V_5 = V_2 -> V_5 ;
struct V_108 * V_108 = F_32 ( V_5 ) ;
struct V_90 * V_91 = V_108 -> V_92 . V_93 ;
...
bool V_160 ;
if ( F_69 ( V_5 , & V_272 , V_150 ) ) {
F_9 ( 2 , V_27 , L_41 ,
V_5 -> V_183 ) ;
return;
}
if ( ! F_140 ( & F_41 ( V_2 ) -> V_100 , V_143 ) &&
F_114 ( V_143 ) != ( V_275 | V_216 ) ) {
F_9 ( 2 , V_27 ,
L_42 ) ;
return;
}
F_46 ( V_91 , & V_114 , V_266 ,
& V_272 , & F_41 ( V_2 ) -> V_99 , V_5 -> V_115 ) ;
V_107 = F_141 ( V_108 , NULL , & V_114 ) ;
if ( V_107 -> error ) {
F_142 ( V_107 ) ;
return;
}
V_107 = F_143 ( V_108 , V_107 , F_144 ( & V_114 ) , NULL , 0 ) ;
if ( F_48 ( V_107 ) )
return;
V_212 = (struct V_211 * ) V_107 ;
if ( V_212 -> V_236 & V_276 ) {
F_9 ( 2 , V_27 ,
L_43 ) ;
goto V_277;
}
V_270 = F_145 ( V_108 -> V_92 . V_278 , & V_212 -> V_279 . V_38 , 1 ) ;
V_160 = F_146 ( V_270 , 1 * V_239 ) ;
if ( V_270 )
F_147 ( V_270 ) ;
if ( ! V_160 )
goto V_277;
if ( V_5 -> V_7 ) {
struct V_52 * V_53 = F_120 ( F_44 ( V_2 ) , V_143 ) ;
if ( ! V_53 ) {
F_9 ( 2 , V_27 ,
L_44 ) ;
goto V_277;
...
V_268 = F_148 (unsigned int,
IPV6_MIN_MTU - sizeof(struct ipv6hdr) - sizeof(*msg) - optlen,
skb->len + 8 ) ;
V_268 &= ~ 0x7 ;
V_133 += V_268 ;
V_271 = F_30 ( V_5 , sizeof( * V_132 ) + V_133 ) ;
if ( ! V_271 )
goto V_277;
V_132 = (struct V_265 * ) F_4 ( V_271 , sizeof( * V_132 ) ) ;
* V_132 = (struct V_265 ) {
. V_138 = {
. V_112 = V_266 ,
} ,
. V_143 = * V_143 ,
. V_280 = F_41 ( V_2 ) -> V_100 ,
} ;
if ( V_70 )
F_1 ( V_271 , V_23 , V_70 ) ;
if ( V_268 )
F_138 ( V_271 , V_2 , V_268 ) ;
F_50 ( V_271 , V_107 ) ;
F_43 ( V_271 , & F_41 ( V_2 ) -> V_99 , & V_272 ) ;
return;
V_277:
F_142 ( V_107 ) ;
}
...
memset ( F_90 ( V_2 ) , 0 , sizeof( struct V_283 ) ) ;
...
static int F_156 ( struct V_285 * V_286 , unsigned long V_287 , void * V_288 )
{
struct V_40 * V_5 = F_157 ( V_288 ) ;
struct V_108 * V_108 = F_32 ( V_5 ) ;
struct V_55 * V_109 ;
switch ( V_287 ) {
case V_289 :
...
static void F_161 ( struct V_294 * V_295 ,
...
int F_163 ( struct V_294 * V_295 , int V_304 , void T_7 * V_305 , T_4 * V_306 , T_8 * V_307 )
{
struct V_40 * V_5 = V_295 -> V_308 ;
struct V_55 * V_109 ;
int V_160 ;
if ( ( strcmp ( V_295 -> V_303 , L_49 ) == 0 ) ||
( strcmp ( V_295 -> V_303 , L_50 ) == 0 ) )
F_161 ( V_295 , L_51 , V_5 ? V_5 -> V_183 : L_52 ) ;
if ( strcmp ( V_295 -> V_303 , L_49 ) == 0 )
V_160 = F_164 ( V_295 , V_304 , V_305 , V_306 , V_307 ) ;
else if ( strcmp ( V_295 -> V_303 , L_50 ) == 0 )
V_160 = F_165 ( V_295 , V_304 ,
V_305 , V_306 , V_307 ) ;
else if ( ( strcmp ( V_295 -> V_303 , L_53 ) == 0 ) ||
( strcmp ( V_295 -> V_303 , L_54 ) == 0 ) )
V_160 = F_166 ( V_295 , V_304 ,
V_305 , V_306 , V_307 ) ;
else
V_160 = - 1 ;
if ( V_304 && V_160 == 0 && V_5 && ( V_109 = F_20 ( V_5 ) ) != NULL ) {
if ( V_295 -> V_3 == & F_78 ( V_109 -> V_60 , V_249 ) )
V_109 -> V_60 -> V_248 =
F_130 ( F_78 ( V_109 -> V_60 , V_249 ) ) ;
V_109 -> V_246 = V_238 ;
F_129 ( V_247 , V_109 ) ;
F_23 ( V_109 ) ;
}
...
static int T_9 F_167 ( struct V_108 * V_108 )
{
struct V_309 * V_310 ;
struct V_90 * V_91 ;
int V_96 ;
V_96 = F_168 ( & V_91 , V_311 ,
V_312 , V_105 , V_108 ) ;
if ( V_96 < 0 ) {
F_9 ( 0 , V_96 ,
L_55 ,
...
static void T_10 F_169 ( struct V_108 * V_108 )
{
F_170 ( V_108 -> V_92 . V_93 ) ;
}
int T_11 F_171 ( void )
{
int V_96 ;
