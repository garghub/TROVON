...
{
if ( V_14 && ( V_67 & V_68 ) )
return F_16 ( V_14 , V_69 , V_52 , 0 ) ;
return 0 ;
}
int F_27 ( struct V_70 * V_71 )
{
return F_16 ( V_71 -> V_14 , V_69 , V_72 , 0 ) ;
}
int F_28 ( struct V_14 * V_14 , int V_39 , int V_41 )
{
return F_16 ( V_14 ,
V_39 & ( V_73 | V_63 | V_69 ) ,
V_51 , V_41 ) ;
...
return F_16 ( V_14 , V_69 , V_75 , 0 ) ;
}
int F_31 ( struct V_14 * V_14 , char * V_76 , T_3 V_77 )
{
if ( ! V_14 ) {
if ( ( V_65 & V_78 ) &&
( V_65 & V_66 ) )
