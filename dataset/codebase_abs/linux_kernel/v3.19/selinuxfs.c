...
struct V_143 * V_155 = F_94 ( V_151 , struct V_143 , V_156 ) ;
F_95 ( & V_155 -> V_152 , V_157 ) ;
F_96 ( V_151 ) ;
if ( V_155 -> V_158 ) {
F_97 ( V_155 ) ;
F_98 ( & V_149 -> V_152 ) ;
...
if ( ! V_23 )
goto V_27;
V_68 = F_102 ( & V_164 , & V_163 , & V_165 ) ;
if ( V_68 )
goto V_27;
for ( V_125 = 0 ; V_125 < V_164 ; V_125 ++ ) {
V_68 = - V_25 ;
V_143 = F_103 ( V_159 , V_163 [ V_125 ] ) ;
if ( ! V_143 )
goto V_27;
V_68 = - V_25 ;
V_40 = F_85 ( V_159 -> V_166 , V_167 | V_168 | V_169 ) ;
if ( ! V_40 )
goto V_27;
V_68 = - V_170 ;
V_67 = snprintf ( V_23 , V_26 , L_13 , V_171 , V_163 [ V_125 ] ) ;
if ( V_67 >= V_26 )
goto V_27;
V_162 = (struct V_161 * ) V_40 -> V_172 ;
V_68 = F_104 ( L_14 , V_23 , V_173 , & V_9 ) ;
if ( V_68 )
goto V_27;
V_162 -> V_9 = V_9 ;
V_162 -> V_174 = 1 ;
V_40 -> V_175 = & V_176 ;
V_40 -> V_37 = V_125 | V_177 ;
F_105 ( V_143 , V_40 ) ;
}
V_145 = V_164 ;
V_146 = V_163 ;
...
static struct V_180 * F_111 ( T_6 * V_181 )
{
int V_182 ;
...
continue;
* V_181 = V_182 + 1 ;
return & F_113 ( V_180 , V_182 ) ;
}
return NULL ;
}
static void * F_114 ( struct V_184 * V_185 , T_6 * V_95 )
{
T_6 V_186 = * V_95 - 1 ;
if ( * V_95 == 0 )
return V_187 ;
...
static void * F_115 ( struct V_184 * V_185 , void * V_188 , T_6 * V_95 )
{
return F_111 ( V_95 ) ;
}
static int F_116 ( struct V_184 * V_185 , void * V_188 )
{
...
F_117 ( V_185 , L_17 , V_190 ,
V_192 , V_191 , V_189 -> V_193 ,
V_189 -> V_194 , V_189 -> V_195 ) ;
}
return 0 ;
}
static void F_118 ( struct V_184 * V_185 , void * V_188 )
{ }
static int F_119 ( struct V_40 * V_40 , struct V_14 * V_14 )
{
return F_120 ( V_14 , & V_196 ) ;
}
static int F_121 ( struct V_143 * V_159 )
{
int V_125 ;
...
for ( V_125 = 0 ; V_125 < F_69 ( V_198 ) ; V_125 ++ ) {
struct V_40 * V_40 ;
struct V_143 * V_143 ;
V_143 = F_103 ( V_159 , V_198 [ V_125 ] . V_141 ) ;
if ( ! V_143 )
return - V_25 ;
V_40 = F_85 ( V_159 -> V_166 , V_167 | V_198 [ V_125 ] . V_131 ) ;
if ( ! V_40 )
return - V_25 ;
V_40 -> V_175 = V_198 [ V_125 ] . V_202 ;
V_40 -> V_37 = ++ V_203 ;
F_105 ( V_143 , V_40 ) ;
}
return 0 ;
...
static int F_124 ( struct V_143 * V_159 )
{
int V_125 ;
for ( V_125 = 1 ; V_125 <= V_204 ; V_125 ++ ) {
struct V_40 * V_40 ;
struct V_143 * V_143 ;
V_143 = F_103 ( V_159 , F_125 ( V_125 ) ) ;
if ( ! V_143 )
return - V_25 ;
V_40 = F_85 ( V_159 -> V_166 , V_167 | V_168 ) ;
if ( ! V_40 )
return - V_25 ;
V_40 -> V_175 = & V_205 ;
V_40 -> V_37 = V_125 | V_206 ;
F_105 ( V_143 , V_40 ) ;
}
return 0 ;
}
static inline unsigned long F_126 ( T_8 V_207 )
{
return ( V_207 * ( V_208 + 1 ) ) | V_209 ;
}
static inline T_8 F_127 ( unsigned long V_36 )
{
return ( V_36 & V_140 ) / ( V_208 + 1 ) ;
}
static inline unsigned long F_128 ( T_8 V_207 , T_2 V_210 )
{
return ( V_207 * ( V_208 + 1 ) + V_210 ) | V_209 ;
}
...
char V_211 [ V_20 ] ;
T_3 V_67 = snprintf ( V_211 , sizeof( V_211 ) , L_1 , F_127 ( V_36 ) ) ;
return F_10 ( V_16 , V_17 , V_18 , V_211 , V_67 ) ;
}
...
unsigned long V_36 = F_23 ( V_14 ) -> V_37 ;
char V_211 [ V_20 ] ;
T_3 V_67 = snprintf ( V_211 , sizeof( V_211 ) , L_1 , F_129 ( V_36 ) ) ;
return F_10 ( V_16 , V_17 , V_18 , V_211 , V_67 ) ;
}
...
V_212 = F_133 ( V_37 & V_140 ) ;
V_21 = F_9 ( V_19 , V_20 , L_1 , V_212 ) ;
return F_10 ( V_16 , V_17 , V_18 , V_19 , V_21 ) ;
}
static int F_134 ( char * V_213 , int V_214 ,
struct V_143 * V_159 )
{
int V_125 , V_59 , V_215 ;
char * * V_6 ;
V_59 = F_135 ( V_213 , & V_6 , & V_215 ) ;
if ( V_59 )
return V_59 ;
for ( V_125 = 0 ; V_125 < V_215 ; V_125 ++ ) {
struct V_40 * V_40 ;
struct V_143 * V_143 ;
V_59 = - V_25 ;
V_143 = F_103 ( V_159 , V_6 [ V_125 ] ) ;
if ( ! V_143 )
goto V_27;
V_59 = - V_25 ;
V_40 = F_85 ( V_159 -> V_166 , V_167 | V_168 ) ;
...
static int F_136 ( char * V_217 , int V_139 ,
struct V_143 * V_159 )
{
struct V_143 * V_143 = NULL ;
struct V_40 * V_40 = NULL ;
int V_59 ;
V_143 = F_103 ( V_159 , L_21 ) ;
if ( ! V_143 )
return - V_25 ;
V_40 = F_85 ( V_159 -> V_166 , V_167 | V_168 ) ;
if ( ! V_40 )
...
F_105 ( V_143 , V_40 ) ;
V_143 = F_137 ( V_159 , L_22 , & V_219 ) ;
if ( F_71 ( V_143 ) )
return F_72 ( V_143 ) ;
V_59 = F_134 ( V_217 , V_139 , V_143 ) ;
return V_59 ;
}
...
struct V_143 * V_221 = F_94 ( V_220 ,
struct V_143 , V_156 ) ;
struct V_150 * V_222 ;
F_139 (class_subdir_node, &class_subdir->d_subdirs) {
struct V_143 * V_155 = F_94 ( V_222 ,
struct V_143 , V_156 ) ;
if ( V_155 -> V_158 )
if ( V_155 -> V_158 -> V_132 & V_223 )
F_92 ( V_155 ) ;
}
F_92 ( V_221 ) ;
}
...
{
int V_59 , V_225 , V_125 ;
char * * V_226 ;
F_138 () ;
V_59 = F_140 ( & V_226 , & V_225 ) ;
if ( V_59 )
return V_59 ;
V_219 = F_126 ( V_225 + 2 ) ;
for ( V_125 = 0 ; V_125 < V_225 ; V_125 ++ ) {
struct V_143 * V_227 ;
V_227 = F_137 ( V_224 , V_226 [ V_125 ] ,
& V_219 ) ;
if ( F_71 ( V_227 ) ) {
V_59 = F_72 ( V_227 ) ;
goto V_27;
}
V_59 = F_136 ( V_226 [ V_125 ] , V_125 + 1 ,
V_227 ) ;
if ( V_59 )
goto V_27;
}
...
V_143 = F_103 ( V_229 , L_23 ) ;
if ( V_143 == NULL )
return - V_25 ;
V_40 = F_85 ( V_229 -> V_166 , V_167 | V_168 ) ;
if ( V_40 == NULL )
return - V_25 ;
V_40 -> V_175 = & V_232 ;
V_40 -> V_37 = V_228 | V_233 ;
F_105 ( V_143 , V_40 ) ;
}
return 0 ;
}
static struct V_143 * F_137 ( struct V_143 * V_159 , const char * V_141 ,
unsigned long * V_36 )
{
struct V_143 * V_143 = F_103 ( V_159 , V_141 ) ;
struct V_40 * V_40 ;
if ( ! V_143 )
return F_141 ( - V_25 ) ;
V_40 = F_85 ( V_159 -> V_166 , V_223 | V_168 | V_234 ) ;
if ( ! V_40 ) {
F_101 ( V_143 ) ;
return F_141 ( - V_25 ) ;
}
...
static int F_143 ( struct V_129 * V_130 , void * V_66 , int V_238 )
{
int V_68 ;
struct V_143 * V_143 ;
struct V_40 * V_40 ;
struct V_161 * V_162 ;
static struct V_197 V_239 [] = {
[ V_240 ] = { L_24 , & V_241 , V_242 | V_169 } ,
[ V_243 ] = { L_25 , & V_244 , V_168 | V_169 } ,
[ V_245 ] = { L_26 , & V_246 , V_168 | V_247 } ,
[ V_248 ] = { L_27 , & V_246 , V_168 | V_247 } ,
[ V_249 ] = { L_28 , & V_246 , V_168 | V_247 } ,
[ V_250 ] = { L_29 , & V_246 , V_168 | V_247 } ,
[ V_251 ] = { L_30 , & V_246 , V_168 | V_247 } ,
[ V_252 ] = { L_31 , & V_253 , V_168 } ,
[ V_254 ] = { L_32 , & V_255 , V_169 } ,
[ V_256 ] = { L_33 , & V_257 , V_168 } ,
[ V_258 ] = { L_34 , & V_259 , V_169 } ,
[ V_260 ] = { L_35 , & V_246 , V_168 | V_247 } ,
[ V_261 ] = { L_36 , & V_262 , V_168 | V_169 } ,
[ V_39 ] = { L_37 , & V_263 , V_168 } ,
[ V_264 ] = { L_38 , & V_263 , V_168 } ,
[ V_265 ] = { L_39 , & V_266 , V_168 } ,
[ V_267 ] = { L_40 , & V_268 , V_168 } ,
{ L_41 }
} ;
V_68 = F_144 ( V_130 , V_269 , V_239 ) ;
if ( V_68 )
goto V_62;
V_160 = F_137 ( V_130 -> V_270 , V_171 , & V_203 ) ;
if ( F_71 ( V_160 ) ) {
V_68 = F_72 ( V_160 ) ;
V_160 = NULL ;
goto V_62;
...
V_68 = - V_25 ;
V_143 = F_103 ( V_130 -> V_270 , V_271 ) ;
if ( ! V_143 )
goto V_62;
V_68 = - V_25 ;
V_40 = F_85 ( V_130 , V_272 | V_168 | V_247 ) ;
if ( ! V_40 )
goto V_62;
V_40 -> V_37 = ++ V_203 ;
V_162 = (struct V_161 * ) V_40 -> V_172 ;
...
V_162 -> V_274 = V_275 ;
V_162 -> V_174 = 1 ;
F_145 ( V_40 , V_272 | V_168 | V_247 , F_146 ( V_276 , 3 ) ) ;
F_105 ( V_143 , V_40 ) ;
V_277 . V_143 = V_143 ;
V_143 = F_137 ( V_130 -> V_270 , L_42 , & V_203 ) ;
if ( F_71 ( V_143 ) ) {
V_68 = F_72 ( V_143 ) ;
goto V_62;
}
...
if ( V_68 )
goto V_62;
V_143 = F_137 ( V_130 -> V_270 , L_43 , & V_203 ) ;
if ( F_71 ( V_143 ) ) {
V_68 = F_72 ( V_143 ) ;
goto V_62;
}
...
if ( V_68 )
goto V_62;
V_224 = F_137 ( V_130 -> V_270 , L_44 , & V_203 ) ;
if ( F_71 ( V_224 ) ) {
V_68 = F_72 ( V_224 ) ;
V_224 = NULL ;
goto V_62;
}
V_229 = F_137 ( V_130 -> V_270 , L_45 , & V_203 ) ;
if ( F_71 ( V_229 ) ) {
V_68 = F_72 ( V_229 ) ;
V_229 = NULL ;
goto V_62;
...
static struct V_143 * F_147 ( struct V_278 * V_279 ,
int V_73 , const char * V_280 , void * V_66 )
{
return F_148 ( V_279 , V_73 , V_66 , F_143 ) ;
}
