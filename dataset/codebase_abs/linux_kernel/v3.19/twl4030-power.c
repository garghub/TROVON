...
static void F_18 ( struct V_28 * V_73 ,
struct V_28 * V_74 )
{
while ( V_73 -> V_33 ) {
struct V_28 * V_75 = V_74 ;
while ( V_75 -> V_33 ) {
if ( V_75 -> V_33 == V_73 -> V_33 ) {
* V_73 = * V_75 ;
break;
}
V_75 ++ ;
...
static int
F_19 ( const struct V_67 * V_68 )
{
struct V_28 * V_76 = V_68 -> V_77 ;
struct V_28 * V_78 = V_68 -> V_79 ;
int V_3 ;
if ( V_76 ) {
if ( V_78 )
F_18 ( V_76 , V_78 ) ;
...
static int F_20 ( T_1 V_80 , T_1 V_81 )
{
T_1 V_82 [ 3 ] = { V_83 ,
V_84 ,
V_85 , } ;
...
if ( V_3 )
goto V_87;
for ( V_69 = 0 ; V_69 < sizeof( V_82 ) ; V_69 ++ ) {
V_3 = F_6 ( V_4 ,
& V_86 , V_82 [ V_69 ] ) ;
if ( V_3 )
break;
V_86 = ( ~ V_80 & V_86 ) | ( V_80 & V_81 ) ;
V_3 = F_2 ( V_4 ,
V_86 , V_82 [ V_69 ] ) ;
if ( V_3 )
break;
...
static bool F_22 ( const struct V_67 * V_68 ,
struct V_92 * V_93 )
{
if ( V_68 && V_68 -> V_94 )
return true ;
...
{
const struct V_67 * V_68 = F_25 ( & V_96 -> V_97 ) ;
struct V_92 * V_93 = V_96 -> V_97 . V_98 ;
