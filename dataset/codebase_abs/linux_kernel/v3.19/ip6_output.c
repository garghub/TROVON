...
int F_30 ( struct V_1 * V_2 , int (* F_94)( struct V_1 * ) )
{
struct V_1 * V_144 ;
...
V_154 = 0 ;
V_85 = 0 ;
V_144 = F_103 ( V_2 ) -> V_165 ;
F_104 ( V_2 ) ;
* V_155 = V_166 ;
V_145 = F_105 ( F_58 ( V_2 ) , V_148 , V_23 ) ;
if ( ! V_145 ) {
F_14 ( V_46 , F_6 ( F_2 ( V_2 ) ) ,
V_75 ) ;
return - V_167 ;
...
F_106 ( V_2 , V_148 ) ;
V_147 = (struct V_146 * ) F_107 ( V_2 , sizeof( struct V_146 ) ) ;
F_107 ( V_2 , V_148 ) ;
F_44 ( V_2 ) ;
...
V_144 -> V_172 = V_173 ;
F_111 ( V_144 ) ;
V_147 = (struct V_146 * ) F_107 ( V_144 , sizeof( struct V_146 ) ) ;
F_107 ( V_144 , V_148 ) ;
F_44 ( V_144 ) ;
...
V_144 = F_116 ( V_30 + V_148 + sizeof( struct V_146 ) +
V_150 + V_151 , V_23 ) ;
if ( ! V_144 ) {
F_14 ( V_46 , F_6 ( F_2 ( V_2 ) ) ,
V_75 ) ;
...
F_87 ( V_144 , V_2 ) ;
F_117 ( V_144 , V_150 ) ;
F_118 ( V_144 , V_30 + V_148 + sizeof( struct V_146 ) ) ;
F_44 ( V_144 ) ;
...
V_147 -> V_170 = V_152 ;
F_102 ( F_120 ( V_2 , V_153 , F_121 ( V_144 ) ,
V_30 ) ) ;
V_149 -= V_30 ;
V_147 -> V_84 = F_3 ( V_85 ) ;
if ( V_149 > 0 )
...
{
return ( V_182 -> V_185 != 128 || ! F_123 ( V_183 , & V_182 -> V_126 ) ) &&
...
V_120 = (struct V_32 * ) V_4 ;
if ( F_122 ( & V_120 -> V_125 , & V_42 -> V_14 , V_48 -> V_190 ) ||
#ifdef F_126
F_122 ( & V_120 -> V_191 , & V_42 -> V_21 , V_48 -> V_192 ) ||
#endif
...
V_154 = F_131 ( V_46 , V_120 , & V_42 -> V_14 ,
...
int F_142 ( void * V_142 , char * V_141 , int V_85 , int V_30 ,
int V_207 , struct V_1 * V_2 ) ,
void * V_142 , int V_208 , int V_209 , int V_210 ,
...
V_2 -> V_172 = V_176 ;
F_103 ( V_2 ) -> V_217 = ( V_56 - V_210 -
sizeof( struct V_146 ) ) & ~ 7 ;
F_103 ( V_2 ) -> V_218 = V_219 ;
F_108 ( & V_212 , V_120 ) ;
F_103 ( V_2 ) -> V_220 = V_212 . V_170 ;
V_216:
return F_146 ( V_19 , V_2 , F_142 , V_142 ,
( V_208 - V_211 ) ) ;
}
static inline struct V_221 * F_147 ( struct V_221 * V_222 ,
T_5 V_223 )
{
return V_222 ? F_105 ( V_222 , ( V_222 -> V_224 + 1 ) * 8 , V_223 ) : NULL ;
}
...
unsigned int V_227 )
{
if ( ! ( V_120 -> V_4 . V_17 & V_228 ) ) {
if ( V_2 == NULL ) {
* V_56 = V_227 - V_120 -> V_4 . V_229 ;
} else {
* V_56 = V_227 ;
}
* V_226 = ( ( * V_56 - V_210 ) & ~ 7 )
+ V_210 - sizeof( struct V_146 ) ;
}
}
int F_150 ( struct V_37 * V_19 , int F_142 ( void * V_142 , char * V_141 ,
int V_85 , int V_30 , int V_207 , struct V_1 * V_2 ) ,
void * V_142 , int V_208 , int V_211 ,
int V_55 , int V_45 , struct V_43 * V_44 , struct V_41 * V_42 ,
struct V_32 * V_120 , unsigned int V_17 , int V_230 )
{
...
if ( V_17 & V_241 )
return 0 ;
V_234 = & V_232 -> V_234 . V_242 ;
if ( F_152 ( & V_19 -> V_213 ) ) {
if ( V_44 ) {
if ( F_153 ( V_48 -> V_234 . V_44 ) )
return - V_35 ;
V_48 -> V_234 . V_44 = F_154 ( V_44 -> V_243 , V_19 -> V_244 ) ;
if ( F_21 ( V_48 -> V_234 . V_44 == NULL ) )
return - V_61 ;
V_48 -> V_234 . V_44 -> V_243 = V_44 -> V_243 ;
...
return - V_61 ;
V_48 -> V_234 . V_44 -> V_247 = F_147 ( V_44 -> V_247 ,
V_19 -> V_244 ) ;
if ( V_44 -> V_247 && ! V_48 -> V_234 . V_44 -> V_247 )
return - V_61 ;
V_48 -> V_234 . V_44 -> V_116 = F_148 ( V_44 -> V_116 ,
V_19 -> V_244 ) ;
if ( V_44 -> V_116 && ! V_48 -> V_234 . V_44 -> V_116 )
return - V_61 ;
}
F_110 ( & V_120 -> V_4 ) ;
V_234 -> V_4 = & V_120 -> V_4 ;
V_232 -> V_234 . V_248 . V_249 . V_250 = * V_42 ;
...
V_56 = V_48 -> V_251 >= V_252 ?
V_120 -> V_4 . V_6 -> V_56 : F_48 ( V_120 -> V_4 . V_253 ) ;
if ( V_48 -> V_157 < V_56 ) {
if ( V_48 -> V_157 )
V_56 = V_48 -> V_157 ;
}
V_234 -> V_254 = V_56 ;
if ( F_29 ( V_120 -> V_4 . V_253 ) )
V_234 -> V_17 |= V_255 ;
V_234 -> V_208 = 0 ;
V_236 = ( V_44 ? V_44 -> V_59 : 0 ) ;
V_208 += V_236 ;
V_211 += V_236 ;
V_237 = V_120 -> V_4 . V_229 - V_120 -> V_256 ;
} else {
V_120 = (struct V_32 * ) V_234 -> V_4 ;
V_42 = & V_232 -> V_234 . V_248 . V_249 . V_250 ;
...
V_227 = V_56 ;
V_209 = F_36 ( V_120 -> V_4 . V_6 ) ;
V_210 = sizeof( struct V_50 ) + V_120 -> V_256 +
( V_44 ? V_44 -> V_58 : 0 ) ;
V_226 = ( ( V_56 - V_210 ) & ~ 7 ) + V_210 -
sizeof( struct V_146 ) ;
if ( V_56 <= sizeof( struct V_50 ) + V_257 ) {
unsigned int V_258 , V_259 ;
V_259 = sizeof( struct V_50 ) +
( V_44 ? V_44 -> V_59 + V_44 -> V_58 : 0 ) +
( F_29 ( & V_120 -> V_4 ) ?
sizeof( struct V_146 ) : 0 ) +
V_120 -> V_256 ;
if ( F_155 ( V_19 ) )
V_258 = sizeof( struct V_50 ) + V_257 ;
else
V_258 = V_56 ;
if ( ( V_234 -> V_208 + V_208 > V_56 - V_259 ) && V_230 &&
( V_19 -> V_260 == V_261 ||
V_19 -> V_260 == V_262 ) ) {
F_156 ( V_19 , V_42 , V_56 - V_259 +
sizeof( struct V_50 ) ) ;
goto V_263;
}
if ( V_234 -> V_208 + V_208 > V_258 - V_259 ) {
V_263:
F_49 ( V_19 , V_74 , V_42 ,
V_56 - V_259 +
sizeof( struct V_50 ) ) ;
...
if ( V_19 -> V_264 == V_265 || V_19 -> V_264 == V_266 ) {
F_157 ( V_19 , & V_239 ) ;
if ( V_239 & V_267 &&
V_19 -> V_268 & V_269 )
V_240 = V_19 -> V_270 ++ ;
...
( V_2 && F_28 ( V_2 ) ) ) &&
( V_19 -> V_260 == V_261 ) &&
( V_120 -> V_4 . V_6 -> V_271 & V_272 ) ) {
V_154 = F_141 ( V_19 , F_142 , V_142 , V_208 ,
V_209 , V_210 ,
V_211 , V_56 , V_17 , V_120 ) ;
if ( V_154 )
goto error;
return 0 ;
}
...
goto V_273;
while ( V_208 > 0 ) {
V_238 = ( V_234 -> V_208 <= V_56 && ! ( V_234 -> V_17 & V_255 ) ? V_56 : V_226 ) - V_2 -> V_30 ;
if ( V_238 < V_208 )
...
V_235 = V_2 ;
V_274 = V_208 + V_276 ;
if ( V_274 > ( V_234 -> V_208 <= V_56 && ! ( V_234 -> V_17 & V_255 ) ? V_56 : V_226 ) - V_210 )
V_274 = V_226 - V_210 - V_120 -> V_4 . V_278 ;
if ( ( V_17 & V_279 ) &&
! ( V_120 -> V_4 . V_6 -> V_271 & V_280 ) )
V_277 = V_56 ;
else
V_277 = V_274 + V_210 ;
V_277 += V_237 ;
if ( V_274 != V_208 + V_276 ) {
V_274 += V_120 -> V_4 . V_278 ;
}
V_277 += V_120 -> V_4 . V_278 ;
V_275 = V_274 + V_210 ;
V_277 += sizeof( struct V_146 ) ;
if ( V_211 ) {
V_2 = F_144 ( V_19 ,
V_277 + V_209 ,
( V_17 & V_214 ) , & V_154 ) ;
...
V_2 -> V_172 = V_173 ;
V_2 -> V_215 = 0 ;
F_117 ( V_2 , V_209 + sizeof( struct V_146 ) +
V_237 ) ;
F_103 ( V_2 ) -> V_239 = V_239 ;
V_239 = 0 ;
F_103 ( V_2 ) -> V_240 = V_240 ;
V_240 = 0 ;
V_89 = F_118 ( V_2 , V_275 ) ;
F_160 ( V_2 , V_236 ) ;
V_89 += V_210 ;
V_2 -> V_179 = ( V_2 -> V_180 +
V_210 ) ;
...
V_238 = V_274 - V_211 - V_276 ;
if ( V_238 < 0 ) {
V_154 = - V_35 ;
F_15 ( V_2 ) ;
goto error;
} else if ( V_238 > 0 && F_142 ( V_142 , V_89 + V_211 , V_85 , V_238 , V_276 , V_2 ) < 0 ) {
V_154 = - V_283 ;
F_15 ( V_2 ) ;
goto error;
}
...
if ( V_238 > V_208 )
V_238 = V_208 ;
if ( ! ( V_120 -> V_4 . V_6 -> V_271 & V_280 ) ) {
unsigned int V_284 ;
V_284 = V_2 -> V_30 ;
if ( F_142 ( V_142 , F_118 ( V_2 , V_238 ) ,
V_85 , V_238 , V_284 , V_2 ) < 0 ) {
F_164 ( V_2 , V_284 ) ;
V_154 = - V_283 ;
goto error;
}
} else {
int V_285 = F_103 ( V_2 ) -> V_286 ;
struct V_287 * V_288 = F_165 ( V_19 ) ;
V_154 = - V_167 ;
if ( ! F_166 ( V_19 , V_288 ) )
goto error;
if ( ! F_167 ( V_2 , V_285 , V_288 -> V_289 ,
V_288 -> V_85 ) ) {
V_154 = - V_74 ;
if ( V_285 == V_290 )
goto error;
F_168 ( V_2 , V_285 , V_288 -> V_289 ,
V_288 -> V_85 , 0 ) ;
F_103 ( V_2 ) -> V_286 = ++ V_285 ;
F_169 ( V_288 -> V_289 ) ;
}
V_238 = F_170 ( int , V_238 , V_288 -> V_291 - V_288 -> V_85 ) ;
if ( F_142 ( V_142 ,
F_171 ( V_288 -> V_289 ) + V_288 -> V_85 ,
V_85 , V_238 , V_2 -> V_30 , V_2 ) < 0 )
goto V_292;
V_288 -> V_85 += V_238 ;
F_172 ( & F_103 ( V_2 ) -> V_293 [ V_285 - 1 ] , V_238 ) ;
V_2 -> V_30 += V_238 ;
V_2 -> V_171 += V_238 ;
V_2 -> V_164 += V_238 ;
F_173 ( V_238 , & V_19 -> V_281 ) ;
}
V_85 += V_238 ;
V_208 -= V_238 ;
}
...
error:
V_234 -> V_208 -= V_208 ;
F_14 ( F_34 ( V_19 ) , V_120 -> V_294 , V_28 ) ;
return V_154 ;
}
static void F_174 ( struct V_231 * V_232 , struct V_47 * V_48 )
{
if ( V_48 -> V_234 . V_44 ) {
F_112 ( V_48 -> V_234 . V_44 -> V_245 ) ;
F_112 ( V_48 -> V_234 . V_44 -> V_246 ) ;
F_112 ( V_48 -> V_234 . V_44 -> V_247 ) ;
F_112 ( V_48 -> V_234 . V_44 -> V_116 ) ;
F_112 ( V_48 -> V_234 . V_44 ) ;
V_48 -> V_234 . V_44 = NULL ;
}
if ( V_232 -> V_234 . V_242 . V_4 ) {
F_125 ( V_232 -> V_234 . V_242 . V_4 ) ;
V_232 -> V_234 . V_242 . V_4 = NULL ;
V_232 -> V_234 . V_242 . V_17 &= ~ V_255 ;
}
memset ( & V_232 -> V_234 . V_248 , 0 , sizeof( V_232 -> V_234 . V_248 ) ) ;
}
int F_175 ( struct V_37 * V_19 )
{
struct V_1 * V_2 , * V_295 ;
struct V_1 * * V_296 ;
struct V_9 V_297 , * V_205 = & V_297 ;
struct V_231 * V_232 = F_151 ( V_19 ) ;
struct V_47 * V_48 = F_35 ( V_19 ) ;
struct V_46 * V_46 = F_34 ( V_19 ) ;
struct V_50 * V_51 ;
struct V_43 * V_44 = V_48 -> V_234 . V_44 ;
struct V_32 * V_120 = (struct V_32 * ) V_232 -> V_234 . V_242 . V_4 ;
struct V_41 * V_42 = & V_232 -> V_234 . V_248 . V_249 . V_250 ;
unsigned char V_52 = V_42 -> V_53 ;
int V_154 = 0 ;
V_2 = F_176 ( & V_19 -> V_213 ) ;
if ( V_2 == NULL )
goto V_186;
V_296 = & ( F_103 ( V_2 ) -> V_165 ) ;
if ( V_2 -> V_89 < F_58 ( V_2 ) )
F_106 ( V_2 , F_177 ( V_2 ) ) ;
while ( ( V_295 = F_176 ( & V_19 -> V_213 ) ) != NULL ) {
F_106 ( V_295 , F_178 ( V_2 ) ) ;
* V_296 = V_295 ;
V_296 = & ( V_295 -> V_81 ) ;
V_2 -> V_30 += V_295 -> V_30 ;
V_2 -> V_171 += V_295 -> V_30 ;
V_2 -> V_164 += V_295 -> V_164 ;
V_295 -> V_162 = NULL ;
V_295 -> V_19 = NULL ;
}
V_2 -> V_70 = F_155 ( V_19 ) ;
...
F_16 ( V_46 , V_120 -> V_294 , V_71 , V_2 -> V_30 ) ;
if ( V_52 == V_86 ) {
struct V_15 * V_16 = F_6 ( F_2 ( V_2 ) ) ;
F_179 ( V_46 , V_16 , F_180 ( V_2 ) -> V_90 ) ;
F_181 ( V_46 , V_16 , V_298 ) ;
}
V_154 = F_182 ( V_2 ) ;
if ( V_154 ) {
if ( V_154 > 0 )
