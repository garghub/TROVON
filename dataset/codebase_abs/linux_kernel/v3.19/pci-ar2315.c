...
V_35 = F_39 ( V_76 , V_83 ,
L_1 ) ;
V_8 -> V_10 = F_40 ( V_20 , V_35 ) ;
if ( F_41 ( V_8 -> V_10 ) )
return F_42 ( V_8 -> V_10 ) ;
V_35 = F_39 ( V_76 , V_83 ,
L_2 ) ;
if ( ! V_35 )
return - V_82 ;
...
int F_51 ( const struct V_104 * V_20 , T_4 V_105 , T_4 V_106 )
{
struct V_1 * V_8 = F_1 ( V_20 -> V_3 ) ;
return V_105 ? 0 : V_8 -> V_73 ;
}
int F_52 ( struct V_104 * V_20 )
{
return 0 ;
}
