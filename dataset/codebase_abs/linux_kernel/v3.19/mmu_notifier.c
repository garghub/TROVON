...
F_8 (mn, &mm->mmu_notifier_mm->list, hlist) {
if ( V_7 -> V_9 -> V_21 ) {
V_18 = V_7 -> V_9 -> V_21 ( V_7 , V_5 , V_20 ) ;
if ( V_18 )
break;
}
}
...
void F_19 ( struct V_4 * V_5 , unsigned long V_20 ,
T_1 V_22 )
{
struct V_6 * V_7 ;
int V_8 ;
...
F_8 (mn, &mm->mmu_notifier_mm->list, hlist) {
if ( V_7 -> V_9 -> V_23 )
V_7 -> V_9 -> V_23 ( V_7 , V_5 , V_20 , V_22 ) ;
}
F_15 ( & V_3 , V_8 ) ;
}
...
F_25 ( ! V_3 . V_31 ) ;
V_29 = - V_32 ;
V_11 = F_27 ( sizeof( struct V_11 ) , V_33 ) ;
if ( F_10 ( ! V_11 ) )
goto V_34;
if ( V_28 )
F_28 ( & V_5 -> V_35 ) ;
