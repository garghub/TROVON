...
if ( V_30 >= 3 ) {
F_4 ( & V_2 -> V_39 ) ;
F_31 ( V_2 -> V_7 . V_33 , L_3
L_4 ) ;
break;
}
F_31 ( V_2 -> V_7 . V_33 , L_5
L_6 ) ;
F_32 ( V_40 ) ;
if ( F_29 () ) {
F_4 ( & V_2 -> V_39 ) ;
...
F_4 ( & V_2 -> V_39 ) ;
if ( V_29 != sizeof( V_27 ) ) {
F_31 ( V_2 -> V_7 . V_33 , L_7
L_8 , V_29 ) ;
} else {
V_15 -> V_43 [ 0 ] = V_27 [ 3 ] ;
V_15 -> V_43 [ 1 ] = V_27 [ 4 ] ;
V_15 -> V_43 [ 2 ] = V_27 [ 5 ] ;
F_28 ( V_2 -> V_7 . V_33 , L_9 ,
...
F_28 ( V_22 -> V_2 -> V_7 . V_33 , L_13 , 5 , V_52 ) ;
V_29 = F_30 ( V_22 -> V_37 , V_52 , V_75 + 1 ) ;
if ( V_29 != V_75 + 1 ) {
F_31 ( V_22 -> V_2 -> V_7 . V_33 , L_2 ,
V_29 ) ;
...
if ( V_29 != 4 ) {
F_31 ( V_22 -> V_2 -> V_7 . V_33 , L_14 , V_29 ) ;
return 0 ;
}
if ( ( V_52 [ 0 ] != 0x80 ) && ( V_52 [ 0 ] != 0xa0 ) ) {
F_31 ( V_22 -> V_2 -> V_7 . V_33 , L_15 ,
V_52 [ 0 ] ) ;
return 0 ;
}
F_48 ( V_22 -> V_2 -> V_7 . V_33 , L_16
L_17 , V_52 [ 1 ] , V_52 [ 2 ] , V_52 [ 3 ] ) ;
return 0 ;
}
...
V_29 = F_54 ( & V_82 , L_19 , V_22 -> V_2 -> V_7 . V_33 ) ;
if ( V_29 != 0 ) {
F_31 ( V_22 -> V_2 -> V_7 . V_33 , L_20 ,
V_29 ) ;
V_29 = V_29 < 0 ? V_29 : - V_72 ;
goto V_83;
}
F_28 ( V_22 -> V_2 -> V_7 . V_33 , L_21 , V_82 -> V_84 ) ;
...
unsigned int V_94 ;
F_58 ( V_95 , V_96 ) ;
F_28 ( V_2 -> V_7 . V_33 , L_25 ) ;
if ( V_89 % V_10 -> V_97 ) {
F_28 ( V_2 -> V_7 . V_33 , L_26 ) ;
return - V_98 ;
}
V_15 = F_14 ( V_2 ) ;
if ( V_15 == NULL )
...
if ( ! V_22 -> V_106 ) {
F_28 ( V_22 -> V_2 -> V_7 . V_33 , L_35 , V_25 , V_54 ) ;
return 0 ;
}
...
if ( V_29 == 1 )
break;
F_28 ( V_22 -> V_2 -> V_7 . V_33 , L_36
L_37 , V_29 , V_63 + 1 ) ;
}
if ( V_29 != 1 ) {
F_31 ( V_22 -> V_2 -> V_7 . V_33 , L_38
L_39 , V_29 ) ;
return V_29 < 0 ? V_29 : - V_72 ;
}
...
if ( V_29 != 0 ) {
F_31 ( V_22 -> V_2 -> V_7 . V_33 , L_41
L_42 ) ;
if ( V_30 >= 3 ) {
F_31 ( V_22 -> V_2 -> V_7 . V_33 , L_43
L_4 ) ;
F_4 ( & V_2 -> V_39 ) ;
F_4 ( & V_22 -> V_36 ) ;
F_25 ( V_22 , false ) ;
...
struct V_32 * V_10 = V_2 -> V_7 . V_10 ;
unsigned int V_29 ;
F_28 ( V_2 -> V_7 . V_33 , L_44 ) ;
V_15 = F_14 ( V_2 ) ;
if ( V_15 == NULL ) {
F_28 ( V_2 -> V_7 . V_33 , L_45 ) ;
return V_108 ;
}
F_70 ( V_87 , & V_10 -> V_20 , V_95 ) ;
V_29 = F_60 ( V_10 ) ? 0 : ( V_109 | V_110 ) ;
F_28 ( V_2 -> V_7 . V_33 , L_46 ,
V_29 ? L_47 : L_48 ) ;
return V_29 ;
}
...
{
if ( strncmp ( L_50 , V_131 -> V_132 , 8 ) == 0 ) {
...
} else if ( strncmp ( L_51 , V_131 -> V_132 , 8 ) == 0 ) {
...
return - V_35 ;
F_89 ( L_53 ,
V_137 ? L_54 : L_55 , V_136 -> V_132 , V_136 -> V_139 ) ;
F_3 ( & V_5 ) ;
V_2 = F_87 ( V_136 ) ;
if ( V_2 == NULL ) {
...
F_53 ( V_22 ) ;
if ( V_15 == NULL && ! V_143 ) {
F_99 ( V_22 -> V_2 -> V_7 . V_33 , L_56
L_57 , V_136 -> V_132 , V_136 -> V_139 ) ;
goto V_152;
}
} else {
V_22 = F_23 ( V_2 ) ;
...
if ( V_2 -> V_7 . V_8 < 0 || V_2 -> V_7 . V_8 >= V_9 ) {
F_31 ( V_22 -> V_2 -> V_7 . V_33 , L_63 ,
V_138 , V_9 - 1 , V_2 -> V_7 . V_8 ) ;
V_29 = - V_153 ;
goto V_150;
}
F_99 ( V_2 -> V_7 . V_33 , L_64 ,
...
F_12 ( V_2 , true ) ;
V_145:
F_31 ( & V_131 -> V_33 , L_66 ,
V_138 , V_137 ? L_54 : L_55 , V_136 -> V_132 , V_136 -> V_139 ,
V_29 ) ;
F_4 ( & V_5 ) ;
return V_29 ;
}
