...
static int F_35 ( struct V_227 * V_228 ,
const struct V_229 * V_230 )
{
struct V_96 * V_97 ;
unsigned int V_3 ;
int V_101 ;
V_97 = F_36 ( & V_228 -> V_2 , sizeof( struct V_96 ) ,
V_231 ) ;
if ( V_97 == NULL )
return - V_232 ;
F_37 ( V_228 , V_97 ) ;
V_97 -> V_59 = F_38 ( V_228 , & V_233 ) ;
if ( F_39 ( V_97 -> V_59 ) ) {
V_101 = F_40 ( V_97 -> V_59 ) ;
F_18 ( & V_228 -> V_2 , L_22 , V_101 ) ;
return V_101 ;
}
V_101 = F_41 ( V_97 -> V_59 , V_4 , & V_3 ) ;
if ( V_101 != 0 ) {
...
if ( F_42 ( & V_228 -> V_2 ) )
memcpy ( & V_97 -> V_203 , F_42 ( & V_228 -> V_2 ) ,
sizeof( V_97 -> V_203 ) ) ;
V_3 = 0 ;
if ( V_97 -> V_203 . V_234 )
V_3 |= V_235 ;
...
V_235 | V_237 , V_3 ) ;
F_23 ( V_97 -> V_59 , true ) ;
V_101 = F_44 ( & V_228 -> V_2 ,
& V_238 , & V_239 , 1 ) ;
if ( V_101 < 0 )
return V_101 ;
return 0 ;
}
static int F_45 ( struct V_227 * V_240 )
{
F_46 ( & V_240 -> V_2 ) ;
return 0 ;
}
