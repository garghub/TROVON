...
static int F_23 ( struct V_96 * V_13 )
{
int V_88 , V_97 = 0 ;
if ( V_13 -> V_98 == V_99 ) {
V_97 = V_100 * V_101 *
...
{
struct V_96 * V_13 = F_30 ( & V_113 -> V_79 ) ;
struct V_8 * V_9 ;
struct V_1 * V_2 ;
struct V_114 * V_115 ;
char * V_116 ;
...
if ( ! V_13 )
return - V_37 ;
V_9 = F_31 ( sizeof( struct V_1 ) , & V_113 -> V_79 ) ;
if ( ! V_9 )
return - V_110 ;
V_9 -> V_79 = & V_113 -> V_79 ;
F_32 ( V_113 , V_9 ) ;
V_2 = V_9 -> V_10 ;
V_2 -> V_13 = V_13 ;
V_72 = F_33 ( & V_9 -> V_117 , 256 , 0 ) ;
if ( V_72 )
goto V_118;
V_72 = F_24 ( V_9 ) ;
if ( V_72 )
goto V_119;
V_115 = F_34 ( V_113 , V_120 , 0 ) ;
if ( ! V_115 ) {
V_72 = - V_121 ;
goto V_122;
}
V_2 -> V_115 = V_115 ;
V_2 -> V_4 = F_35 ( & V_113 -> V_79 , V_115 -> V_41 ,
F_36 ( V_115 ) ) ;
if ( ! V_2 -> V_4 ) {
V_72 = - V_121 ;
goto V_122;
}
strcpy ( V_9 -> V_27 . V_123 , V_113 -> V_124 ) ;
V_9 -> V_125 = & V_126 ;
V_9 -> V_27 . type = V_127 ;
V_9 -> V_27 . V_128 = V_129 ;
V_9 -> V_16 . V_130 = V_131 ;
V_9 -> V_16 . V_132 = V_133 ;
V_9 -> V_14 = V_134 ;
V_9 -> V_135 = - 1 ;
V_9 -> V_136 = V_137 ;
V_9 -> V_86 = & V_2 -> V_86 ;
F_37 ( L_3 , & V_116 ) ;
V_72 = F_38 ( & V_9 -> V_16 , V_9 , V_116 ,
V_2 -> V_13 -> V_106 , V_2 -> V_13 -> V_98 ,
V_2 -> V_13 -> V_138 , V_2 -> V_13 -> V_102 ) ;
if ( V_72 == 0 ) {
F_26 ( V_9 -> V_79 , L_4 ) ;
V_72 = - V_37 ;
goto V_122;
