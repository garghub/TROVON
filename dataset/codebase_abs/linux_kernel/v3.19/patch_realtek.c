...
F_167 ( 0x1b , 0x0c0b ) ,
F_167 ( 0x45 , 0xd089 ) ,
F_168 ( 0x57 , 0x05 , 1 << 14 , 0 ) ,
F_167 ( 0x06 , 0x6104 ) ,
F_169 ( 0x57 , 0x03 , 0x8aa6 ) ,
{}
} ;
...
F_170 ( 0x10 , 7 << 8 , 6 << 8 ) ,
F_168 ( 0x57 , 0x05 , 1 << 15 | 1 << 13 , 0x0 ) ,
F_168 ( 0x57 , 0x03 , 1 << 10 , 1 << 10 ) ,
F_170 ( 0x1a , 1 << 3 , 1 << 3 ) ,
F_167 ( 0x45 , 0xc429 ) ,
F_170 ( 0x4a , 0x000f , 0x000e ) ,
{}
} ;
...
static void F_171 ( struct V_1 * V_2 , T_1 V_237 ,
T_1 V_228 )
{
static struct V_15 V_289 [] = {
F_169 ( 0x57 , 0x03 , 0x8aa6 ) ,
...
static struct V_15 V_292 [] = {
F_168 ( 0x57 , 0x05 , 0 , 1 << 15 | 1 << 13 ) ,
F_168 ( 0x57 , 0x03 , 1 << 10 , 0 ) ,
F_170 ( 0x1a , 1 << 3 , 0 ) ,
{}
} ;
...
F_29 ( 300 ) ;
V_5 = F_7 ( V_2 , 0xbe ) ;
V_296 = ( V_5 & 0x1c02 ) == 0x1c02 ;
break;
}
F_38 ( V_2 , L_24 ,
V_296 ? L_25 : L_26 ) ;
V_13 -> V_297 = V_296 ? V_298 : V_299 ;
}
static void F_176 ( struct V_1 * V_2 )
{
struct V_12 * V_13 = V_2 -> V_13 ;
T_1 V_300 = V_13 -> V_86 . V_301 [ V_13 -> V_86 . V_302 [ 0 ] ] ;
T_1 V_237 = V_13 -> V_86 . V_87 . V_88 [ 0 ] ;
int V_303 ;
if ( ! F_122 ( V_2 , V_237 ) )
V_303 = V_304 ;
else if ( V_300 == V_13 -> V_305 )
V_303 = V_306 ;
else if ( V_300 == V_13 -> V_307 )
V_303 = V_308 ;
else
V_303 = V_309 ;
if ( V_303 == V_13 -> V_310 ) {
...
if ( V_13 -> V_297 == V_298 )
F_173 ( V_2 ) ;
else if ( V_13 -> V_297 == V_299 )
F_174 ( V_2 ) ;
V_13 -> V_86 . V_144 = true ;
break;
case V_308 :
F_171 ( V_2 , V_237 , V_13 -> V_307 ) ;
V_13 -> V_86 . V_144 = false ;
break;
case V_309 :
F_172 ( V_2 ) ;
...
struct V_12 * V_13 = V_2 -> V_13 ;
struct V_123 * V_124 = & V_13 -> V_86 . V_87 ;
for ( V_67 = 0 ; V_67 < V_124 -> V_315 ; V_67 ++ ) {
if ( V_124 -> V_316 [ V_67 ] . V_317 && ! V_13 -> V_305 )
V_13 -> V_305 = V_124 -> V_316 [ V_67 ] . V_158 ;
if ( V_124 -> V_316 [ V_67 ] . V_318 && ! V_13 -> V_307 )
V_13 -> V_307 = V_124 -> V_316 [ V_67 ] . V_158 ;
}
V_13 -> V_86 . V_286 = F_177 ;
V_13 -> V_86 . V_145 = F_176 ;
V_13 -> V_86 . V_260 = F_178 ;
}
...
if ( V_57 == V_63 ) {
struct V_12 * V_13 = V_2 -> V_13 ;
struct V_321 * V_322 = & V_13 -> V_86 . V_323 ;
int V_67 ;
V_13 -> V_104 = F_186 ;
V_2 -> V_279 = F_189 ;
for ( V_67 = 0 ; V_67 < V_322 -> V_324 ; V_67 ++ ) {
if ( V_13 -> V_86 . V_301 [ V_67 ] == 0x12 ) {
V_13 -> V_86 . V_302 [ 0 ] = V_67 ;
break;
}
}
}
...
int V_67 ;
for ( V_67 = 0 ; V_67 < V_124 -> V_315 ; V_67 ++ ) {
if ( V_124 -> V_316 [ V_67 ] . type != V_326 )
continue;
V_3 = V_124 -> V_316 [ V_67 ] . V_158 ;
V_325 = F_36 ( V_2 , V_3 ) ;
if ( F_192 ( V_325 ) == V_327 )
continue;
return V_3 ;
}
return 0 ;
...
return;
for ( V_67 = 0 ; V_67 < V_124 -> V_315 ; V_67 ++ ) {
T_1 V_3 = V_124 -> V_316 [ V_67 ] . V_158 ;
unsigned int V_325 ;
if ( V_124 -> V_316 [ V_67 ] . type != V_326 )
continue;
V_325 = F_36 ( V_2 , V_3 ) ;
...
F_146 ( V_2 ) ;
if ( F_122 ( V_2 , 0x1b ) )
V_13 -> V_86 . V_328 |= ( 1ULL << 0x14 ) ;
}
static void F_201 ( struct V_1 * V_2 ,
const struct V_55 * V_56 , int V_57 )
{
struct V_12 * V_13 = V_2 -> V_13 ;
static const struct V_251 V_329 [] = {
{ 0x01 , V_167 , 0x04 } ,
{ 0x01 , V_168 , 0x04 } ,
{ 0x01 , V_143 , 0x04 } ,
{}
} ;
static const struct V_149 V_330 [] = {
{ 0x1b , 0x21114000 } ,
{}
} ;
struct V_28 * V_29 ;
...
V_29 = F_15 ( V_2 , L_27 ) ;
if ( V_29 )
strcpy ( V_29 -> V_331 . V_98 , L_28 ) ;
V_29 = F_15 ( V_2 , L_29 ) ;
if ( V_29 )
strcpy ( V_29 -> V_331 . V_98 , L_27 ) ;
break;
}
}
...
if ( F_3 ( V_2 , 0x51 , 0 , V_337 , 0 ) == 0x10ec5505 ) {
V_13 -> V_247 = 1 ;
V_13 -> V_102 = F_132 ;
}
V_94 = F_114 ( V_2 ) ;
...
V_2 -> V_106 = V_139 ;
#ifdef F_206
V_2 -> V_106 . V_338 = F_134 ;
V_2 -> V_106 . V_339 = F_136 ;
#endif
if ( ! V_13 -> V_104 )
V_13 -> V_104 = F_119 ;
F_50 ( V_2 , V_63 ) ;
...
{
static const T_1 V_340 [] = { 0x1d , 0 } ;
static const T_1 V_341 [] = { 0x0e , 0x0f , 0x0b , 0 } ;
return F_66 ( V_2 , V_340 , V_341 ) ;
}
...
F_75 ( V_2 , NULL , V_344 , V_345 ) ;
F_50 ( V_2 , V_58 ) ;
V_94 = F_207 ( V_2 ) ;
if ( V_94 < 0 )
goto error;
if ( ! V_13 -> V_86 . V_137 )
F_76 ( V_13 , 0x23 , 0 , V_346 ) ;
V_2 -> V_106 = V_139 ;
#ifdef F_206
V_13 -> V_105 = F_54 ;
#endif
...
return F_66 ( V_2 , V_347 , V_348 ) ;
}
static void F_212 ( struct V_1 * V_2 ,
const struct V_55 * V_56 , int V_57 )
{
if ( V_57 == V_58 ) {
F_213 ( V_2 , 0x18 , 0x00000734 ) ;
F_213 ( V_2 , 0x19 , 0x0000073c ) ;
}
}
...
static const T_1 V_352 [] = { 0x15 , 0x1b , 0x14 , 0x21 } ;
...
if ( V_57 == V_101 ) {
struct V_12 * V_13 = V_2 -> V_13 ;
V_13 -> V_86 . V_354 [ 0 ] . V_355 [ 0 ] . V_356 = V_357 ;
}
}
static unsigned int F_219 ( struct V_1 * V_2 ,
T_1 V_3 ,
unsigned int V_268 )
{
struct V_12 * V_13 = V_2 -> V_13 ;
...
static int T_2 F_225 ( void )
{
return F_226 ( & V_363 ) ;
}
static void T_3 F_227 ( void )
{
F_228 ( & V_363 ) ;
}
