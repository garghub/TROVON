...
V_11 -> V_42 = & V_39 -> V_42 ;
V_13 = F_20 ( & V_39 -> V_42 , sizeof( struct V_12 ) , V_48 ) ;
if ( V_13 == NULL )
return - V_49 ;
V_13 -> V_50 = F_21 ( - V_21 ) ;
if ( F_22 ( V_11 , L_6 ) ) {
...
if ( F_26 ( V_13 -> V_50 ) ) {
F_19 ( & V_39 -> V_42 , L_14 ) ;
return F_27 ( V_13 -> V_50 ) ;
}
} else {
V_46 = 1 ;
}
V_13 -> V_31 = F_28 ( V_41 , L_15 ) ;
F_29 ( V_41 , L_16 , & V_13 -> V_19 ) ;
if ( ! V_13 -> V_19 ) {
F_19 ( & V_39 -> V_42 , L_17 ) ;
V_16 = - V_21 ;
goto V_54;
