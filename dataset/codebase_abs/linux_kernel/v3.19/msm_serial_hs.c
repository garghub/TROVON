...
V_6 = & V_2 -> V_6 ;
V_6 -> V_19 = & V_17 -> V_19 ;
V_268 = F_95 ( V_17 , V_271 , 0 ) ;
if ( F_10 ( ! V_268 ) )
return - V_272 ;
V_6 -> V_11 = V_268 -> V_273 ;
V_6 -> V_4 = F_96 ( V_17 , 0 ) ;
if ( F_10 ( V_6 -> V_4 < 0 ) )
return - V_272 ;
if ( F_10 ( F_97 ( V_6 -> V_4 , 1 ) ) )
return - V_272 ;
if ( V_270 == NULL || V_270 -> V_274 < 0 )
V_2 -> V_3 . V_4 = - 1 ;
else {
V_2 -> V_3 . V_4 = V_270 -> V_274 ;
V_2 -> V_3 . V_208 = 1 ;
V_2 -> V_3 . V_224 = V_270 -> V_275 ;
V_2 -> V_3 . V_225 = V_270 -> V_225 ;
if ( F_10 ( V_2 -> V_3 . V_4 < 0 ) )
return - V_272 ;
if ( F_10 ( F_97 ( V_2 -> V_3 . V_4 , 1 ) ) )
return - V_272 ;
}
if ( V_270 == NULL )
V_2 -> V_47 = NULL ;
...
V_2 -> V_47 = V_270 -> V_47 ;
V_268 = F_98 ( V_17 , V_276 ,
L_17 ) ;
if ( F_10 ( ! V_268 ) )
return - V_272 ;
V_2 -> V_143 = V_268 -> V_273 ;
V_2 -> V_114 = V_268 -> V_277 ;
V_268 = F_98 ( V_17 , V_276 ,
L_18 ) ;
if ( F_10 ( ! V_268 ) )
return - V_272 ;
V_2 -> V_243 = V_268 -> V_273 ;
V_2 -> V_250 = V_268 -> V_277 ;
V_6 -> V_278 = V_279 ;
V_6 -> V_228 = V_280 ;
V_6 -> V_281 = & V_282 ;
V_6 -> V_74 = V_283 ;
V_6 -> V_41 = V_67 ;
V_2 -> V_115 = 0x0 ;
V_2 -> V_37 = F_99 ( & V_17 -> V_19 , L_19 ) ;
if ( F_100 ( V_2 -> V_37 ) )
return F_101 ( V_2 -> V_37 ) ;
V_40 = F_86 ( V_6 ) ;
if ( F_10 ( V_40 ) )
return V_40 ;
V_2 -> V_43 = V_222 ;
F_102 ( & V_2 -> V_150 , V_284 ,
V_152 ) ;
V_2 -> V_150 . V_285 = F_65 ;
V_2 -> V_151 = F_103 ( 0 , 1000000 ) ;
V_6 -> line = V_17 -> V_20 ;
return F_104 ( & V_36 , V_6 ) ;
}
static int T_3 F_105 ( void )
{
int V_40 , V_286 ;
for ( V_286 = 0 ; V_286 < V_21 ; V_286 ++ )
V_24 [ V_286 ] . V_6 . type = V_287 ;
V_180 = F_106 ( L_20 ) ;
if ( F_10 ( ! V_180 ) )
return - V_13 ;
V_40 = F_107 ( & V_36 ) ;
...
V_2 -> V_115 = 0 ;
F_4 ( V_6 , V_108 , V_2 -> V_115 ) ;
F_114 ( V_2 -> V_25 . V_262 , V_2 -> V_25 . V_111 == V_122 ) ;
F_23 ( V_2 -> V_37 ) ;
if ( V_2 -> V_43 != V_207 )
F_23 ( V_2 -> V_37 ) ;
V_2 -> V_43 = V_222 ;
...
V_135 , V_28 ) ;
F_32 ( & V_6 -> V_76 , V_74 ) ;
if ( F_115 ( & V_2 -> V_25 . V_181 ) )
F_53 ( & V_2 -> V_25 . V_181 ) ;
}
static void T_4 F_116 ( void )
{
F_117 ( V_180 ) ;
F_110 ( V_180 ) ;
F_118 ( & V_289 ) ;
