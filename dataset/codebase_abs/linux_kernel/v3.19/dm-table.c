...
static void F_130 ( struct V_6 * V_7 , enum V_169 V_27 )
{
int V_42 = V_7 -> V_28 ;
...
void F_135 ( struct V_6 * V_7 , struct V_178 * V_179 )
{
F_44 ( & V_179 -> V_39 , & V_7 -> V_33 ) ;
}
int F_136 ( struct V_6 * V_7 , int V_180 )
{
struct V_37 * V_38 ;
struct V_34 * V_32 = F_77 ( V_7 ) ;
struct V_178 * V_179 ;
...
for ( V_42 = 0 ; V_42 < V_7 -> V_28 ; V_42 ++ ) {
V_49 = V_7 -> V_26 + V_42 ;
if ( V_49 -> type -> V_183 && V_49 -> type -> V_183 ( V_49 ) )
return 1 ;
}
return 0 ;
}
...
V_184 = F_143 ( V_30 ) ;
if ( V_184 ) {
F_144 ( V_184 -> V_186 , V_185 ) ;
F_145 ( V_184 ) ;
F_146 ( V_184 -> V_186 , V_185 ) ;
}
}
