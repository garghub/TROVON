...
V_9 |= V_14 ;
F_1 ( V_8 , V_12 , V_9 ) ;
V_45 = F_22 ( & V_8 -> V_52 , V_8 -> V_35 . V_32 ) ;
if ( V_45 == 0 ) {
F_9 ( V_8 -> V_8 , L_8 ) ;
F_8 ( V_8 ) ;
F_14 ( V_8 ) ;
...
F_44 ( V_104 , V_8 ) ;
if ( ! V_8 -> V_11 && V_104 -> V_8 . V_112 ) {
T_2 V_113 ;
V_8 -> V_11 = F_41 ( & V_104 -> V_8 ,
sizeof( struct V_10 ) , V_110 ) ;
if ( ! V_8 -> V_11 )
return - V_111 ;
memcpy ( V_8 -> V_11 , & V_114 ,
sizeof( struct V_10 ) ) ;
if ( ! F_45 ( V_104 -> V_8 . V_112 , L_20 ,
& V_113 ) )
V_8 -> V_11 -> V_23 = V_113 / 1000 ;
} else if ( ! V_8 -> V_11 ) {
V_8 -> V_11 = & V_114 ;
}
...
return - V_115 ;
F_48 ( V_8 -> V_18 ) ;
V_106 = F_49 ( V_104 , V_116 , 0 ) ;
V_8 -> V_5 = F_50 ( & V_104 -> V_8 , V_106 ) ;
if ( F_47 ( V_8 -> V_5 ) ) {
V_45 = F_51 ( V_8 -> V_5 ) ;
goto V_117;
}
F_14 ( V_8 ) ;
V_45 = F_52 ( & V_104 -> V_8 , V_8 -> V_107 , F_31 , 0 ,
V_104 -> V_118 , V_8 ) ;
if ( V_45 ) {
...
V_41 -> V_119 = V_120 ;
V_41 -> V_121 = V_122 ;
F_54 ( V_41 -> V_118 , L_23 , sizeof( V_41 -> V_118 ) ) ;
V_41 -> V_123 = & V_124 ;
V_41 -> V_8 . V_125 = & V_104 -> V_8 ;
V_41 -> V_32 = V_126 ;
V_41 -> V_8 . V_112 = V_104 -> V_8 . V_112 ;
V_41 -> V_127 = V_104 -> V_128 ;
V_45 = F_55 ( V_41 ) ;
if ( V_45 ) {
F_9 ( & V_104 -> V_8 , L_24 ) ;
goto V_117;
...
static int F_60 ( struct V_129 * V_8 )
{
struct V_103 * V_104 = F_61 ( V_8 ) ;
struct V_1 * V_2 = F_58 ( V_104 ) ;
F_10 ( V_2 , 0 ) ;
F_56 ( V_2 -> V_18 ) ;
return 0 ;
}
static int F_62 ( struct V_129 * V_8 )
{
struct V_103 * V_104 = F_61 ( V_8 ) ;
struct V_1 * V_2 = F_58 ( V_104 ) ;
F_48 ( V_2 -> V_18 ) ;
