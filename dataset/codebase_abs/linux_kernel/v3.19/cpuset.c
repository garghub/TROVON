...
char * V_91 , * V_164 ;
int V_25 = 0 ;
V_163 = F_145 ( V_161 , & V_91 ) ;
V_164 = V_91 ;
F_79 ( & V_89 ) ;
switch ( type ) {
case V_158 :
V_164 += F_146 ( V_164 , V_163 , V_7 -> V_39 ) ;
break;
case V_159 :
V_164 += F_147 ( V_164 , V_163 , V_7 -> V_40 ) ;
break;
case V_165 :
V_164 += F_146 ( V_164 , V_163 , V_7 -> V_31 ) ;
break;
case V_166 :
V_164 += F_147 ( V_164 , V_163 , V_7 -> V_33 ) ;
break;
default:
V_25 = - V_53 ;
goto V_131;
}
if ( V_164 < V_91 + V_163 - 1 ) {
* V_164 ++ = '\n' ;
F_148 ( V_161 , V_164 - V_91 ) ;
} else {
F_148 ( V_161 , - 1 ) ;
}
V_131:
...
static T_6 F_149 ( struct V_2 * V_3 , struct V_138 * V_139 )
{
struct V_1 * V_7 = F_1 ( V_3 ) ;
T_7 type = V_139 -> V_140 ;
switch ( type ) {
...
static T_3 F_151 ( struct V_2 * V_3 , struct V_138 * V_139 )
{
struct V_1 * V_7 = F_1 ( V_3 ) ;
T_7 type = V_139 -> V_140 ;
switch ( type ) {
...
V_173 = ! F_66 ( & V_87 , V_7 -> V_31 ) ;
V_174 = ! F_103 ( V_109 , V_7 -> V_33 ) ;
if ( F_44 ( V_7 -> V_3 . V_52 ) )
F_170 ( V_7 , & V_87 , & V_109 ,
V_173 , V_174 ) ;
else
...
F_37 ( & V_87 , V_84 ) ;
V_109 = V_34 [ V_35 ] ;
V_173 = ! F_66 ( V_50 . V_31 , & V_87 ) ;
V_174 = ! F_103 ( V_50 . V_33 , V_109 ) ;
if ( V_173 ) {
F_79 ( & V_89 ) ;
if ( ! V_179 )
F_37 ( V_50 . V_39 , & V_87 ) ;
...
int V_191 ;
unsigned long V_11 ;
if ( F_189 () || ( V_190 & V_192 ) )
return 1 ;
if ( F_190 ( V_189 , V_97 -> V_40 ) )
return 1 ;
if ( F_88 ( F_89 ( V_101 ) ) )
return 1 ;
if ( V_190 & V_193 )
...
static int F_191 ( int * V_194 )
{
int V_189 ;
V_189 = F_192 ( * V_194 , V_97 -> V_40 ) ;
if ( V_189 == V_195 )
V_189 = F_193 ( V_97 -> V_40 ) ;
* V_194 = V_189 ;
return V_189 ;
}
int F_194 ( void )
...
V_97 -> V_198 =
F_195 ( & V_97 -> V_40 ) ;
return F_191 ( & V_97 -> V_198 ) ;
}
int F_197 ( const struct V_4 * V_199 ,
...
{
static char V_201 [ V_202 ] ;
static F_199 ( V_203 ) ;
struct V_52 * V_204 ;
F_120 ( & V_203 ) ;
F_42 () ;
V_204 = F_3 ( V_36 ) -> V_3 . V_52 ;
F_147 ( V_201 , V_202 ,
V_36 -> V_40 ) ;
F_200 ( L_7 , V_36 -> V_205 ) ;
F_167 ( V_204 ) ;
F_168 ( L_8 , V_201 ) ;
F_49 () ;
F_121 ( & V_203 ) ;
...
int F_202 ( struct V_160 * V_206 , struct V_207 * V_208 ,
...
int V_92 ;
V_92 = - V_117 ;
V_91 = F_57 ( V_210 , V_42 ) ;
if ( ! V_91 )
goto V_49;
V_92 = - V_211 ;
F_42 () ;
V_3 = F_4 ( V_36 , V_6 ) ;
V_37 = F_203 ( V_3 -> V_52 , V_91 , V_210 ) ;
F_49 () ;
if ( ! V_37 )
goto V_212;
F_204 ( V_206 , V_37 ) ;
...
void F_206 ( struct V_160 * V_206 , struct V_4 * V_5 )
{
F_204 ( V_206 , L_9 ) ;
F_207 ( V_206 , & V_5 -> V_40 ) ;
F_204 ( V_206 , L_6 ) ;
F_204 ( V_206 , L_10 ) ;
F_208 ( V_206 , & V_5 -> V_40 ) ;
F_204 ( V_206 , L_6 ) ;
}
