...
V_133 ;
if ( F_42 ( V_32 , V_144 ) )
V_135 = & V_32 -> V_42 -> V_110 ;
F_43 ( & V_32 -> V_145 , V_135 ,
V_32 -> V_132 ,
V_32 -> V_133 ,
F_42 ( V_32 , V_146 ) ) ;
...
{
return V_32 -> V_53 . V_54 && V_32 -> V_53 . V_54 -> V_151 &&
V_32 -> V_148 . V_152 && V_32 -> V_148 . V_152 -> V_151 ;
}
int F_52 ( struct V_31 * V_32 , unsigned long V_153 )
{
int V_65 ;
unsigned long V_154 = V_32 -> V_42 -> V_98 * V_155 ;
V_65 = F_53 ( & V_32 -> V_53 ) ;
if ( V_65 < 0 )
return V_65 ;
while ( ! F_51 ( V_32 ) ) {
V_65 = - V_156 ;
if ( V_154 && F_54 ( V_157 , V_153 + V_154 ) )
return V_65 ;
F_15 ( L_48 ) ;
V_65 = F_55 ( V_32 -> V_137 ,
F_51 ( V_32 ) || ( V_32 -> V_138 < 0 ) ,
V_154 ) ;
if ( V_65 == - V_158 || V_65 == - V_159 )
return V_65 ;
if ( V_32 -> V_138 < 0 )
return V_32 -> V_138 ;
}
