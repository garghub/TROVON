...
static int F_69 ( struct V_165 * V_20 )
{
struct V_166 * V_130 ;
struct V_2 * V_3 ;
struct V_167 * V_69 ;
...
if ( F_22 () ) {
V_171 = F_72 ( & V_20 -> V_21 , L_20 ) ;
} else {
V_171 = F_72 ( & V_20 -> V_21 , L_21 ) ;
}
if ( F_8 ( V_171 ) ) {
F_5 ( & V_20 -> V_21 , L_22 ) ;
return F_9 ( V_171 ) ;
...
V_3 -> V_171 = V_171 ;
V_3 -> V_20 = V_20 ;
V_3 -> V_69 = F_77 ( V_69 -> V_186 , F_78 ( V_69 ) ) ;
if ( ! V_3 -> V_69 ) {
F_5 ( & V_20 -> V_21 , L_28 ) ;
V_44 = - V_187 ;
goto V_188;
...
if ( F_67 ( V_169 -> V_163 ) ) {
if ( F_79 ( V_169 -> V_163 , L_29 ) ) {
F_5 ( & V_20 -> V_21 , L_30 ) ;
V_3 -> V_163 = - V_189 ;
} else {
F_80 ( V_169 -> V_163 , 1 ) ;
V_3 -> V_163 = V_169 -> V_163 ;
}
} else {
V_3 -> V_163 = - V_22 ;
}
...
if ( F_22 () ) {
if ( V_169 -> V_191 . V_158 ) {
T_4 V_192 ;
F_82 ( V_192 ) ;
F_83 ( V_193 , V_192 ) ;
V_3 -> V_24 . V_26 = F_84 ( V_192 , F_65 ,
& V_169 -> V_191 ) ;
if ( V_3 -> V_24 . V_26 ) {
struct V_194 V_195 = {
. V_196 = V_69 -> V_186 + V_197 +
2 ,
. V_198 =
V_199 ,
. V_200 = 1 ,
...
F_86 ( & V_3 -> V_24 . V_26 -> V_21 -> V_159 ) ) ;
F_10 ( V_126 , & V_3 -> V_30 ) ;
}
if ( V_169 -> V_203 . V_158 ) {
T_4 V_192 ;
F_82 ( V_192 ) ;
F_83 ( V_193 , V_192 ) ;
V_3 -> V_24 . V_25 = F_84 ( V_192 , F_65 ,
& V_169 -> V_203 ) ;
if ( V_3 -> V_24 . V_25 ) {
struct V_194 V_195 = {
. V_204 = V_69 -> V_186 + V_205 +
2 ,
. V_206 =
V_199 ,
. V_200 = 1 ,
...
static int F_97 ( struct V_159 * V_20 )
{
struct V_166 * V_130 = F_98 ( V_20 ) ;
...
static int F_99 ( struct V_159 * V_20 )
{
struct V_166 * V_130 = F_98 ( V_20 ) ;
struct V_2 * V_3 = V_130 -> V_140 ;
F_73 ( V_3 -> V_171 ) ;
...
static int F_100 ( struct V_165 * V_20 )
{
struct V_166 * V_130 = F_101 ( V_20 ) ;
