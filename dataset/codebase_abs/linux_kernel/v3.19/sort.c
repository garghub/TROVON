...
V_138 -> V_136 = V_147 -> V_148 ;
V_138 -> V_135 . V_44 = V_147 -> V_148 -> V_149 ;
V_138 -> V_135 . V_150 = F_74 ;
V_138 -> V_135 . V_17 = F_78 ;
V_138 -> V_135 . V_148 = F_79 ;
V_138 -> V_135 . V_151 = NULL ;
V_138 -> V_135 . V_152 = V_147 -> V_148 -> V_153 ;
V_138 -> V_135 . V_154 = V_147 -> V_148 -> V_155 ? : V_147 -> V_148 -> V_153 ;
V_138 -> V_135 . V_156 = V_147 -> V_148 -> V_157 ? : V_138 -> V_135 . V_154 ;
F_82 ( & V_138 -> V_135 . V_158 ) ;
F_82 ( & V_138 -> V_135 . V_159 ) ;
...
{
return V_161 -> V_150 == F_74 ;
}
static int F_83 ( struct V_146 * V_147 )
{
struct V_132 * V_138 = F_80 ( V_147 ) ;
if ( V_138 == NULL )
return - 1 ;
F_84 ( & V_138 -> V_135 ) ;
return 0 ;
...
if ( F_83 ( V_147 ) < 0 )
return - 1 ;
if ( V_147 -> V_148 -> V_155 )
V_163 = 1 ;
V_147 -> V_162 = 1 ;
return 0 ;
}
static int F_88 ( struct V_164 * V_165 )
{
if ( ! V_165 -> V_162 ) {
V_165 -> V_162 = 1 ;
F_84 ( V_165 -> V_3 ) ;
...
int F_91 ( const char * V_166 )
{
unsigned int V_83 ;
for ( V_83 = 0 ; V_83 < F_92 ( V_167 ) ; V_83 ++ ) {
struct V_146 * V_147 = & V_167 [ V_83 ] ;
if ( strncasecmp ( V_166 , V_147 -> V_44 , strlen ( V_166 ) ) )
continue;
if ( V_147 -> V_148 == & V_168 ) {
int V_40 = regcomp ( & V_169 , V_170 , V_171 ) ;
if ( V_40 ) {
char V_172 [ V_173 ] ;
regerror ( V_40 , & V_169 , V_172 , sizeof( V_172 ) ) ;
F_81 ( L_28 , V_170 , V_172 ) ;
return - V_174 ;
}
V_175 = 1 ;
} else if ( V_147 -> V_148 == & V_176 ) {
V_177 = 1 ;
} else if ( V_147 -> V_148 == & V_178 ) {
V_43 = 1 ;
}
return F_87 ( V_147 ) ;
}
for ( V_83 = 0 ; V_83 < F_92 ( V_179 ) ; V_83 ++ ) {
struct V_164 * V_165 = & V_179 [ V_83 ] ;
if ( strncasecmp ( V_166 , V_165 -> V_44 , strlen ( V_166 ) ) )
continue;
return F_88 ( V_165 ) ;
}
for ( V_83 = 0 ; V_83 < F_92 ( V_180 ) ; V_83 ++ ) {
struct V_146 * V_147 = & V_180 [ V_83 ] ;
if ( strncasecmp ( V_166 , V_147 -> V_44 , strlen ( V_166 ) ) )
continue;
if ( V_181 != V_182 )
return - V_174 ;
if ( V_147 -> V_148 == & V_183 || V_147 -> V_148 == & V_184 )
V_177 = 1 ;
F_87 ( V_147 ) ;
return 0 ;
}
for ( V_83 = 0 ; V_83 < F_92 ( V_185 ) ; V_83 ++ ) {
struct V_146 * V_147 = & V_185 [ V_83 ] ;
if ( strncasecmp ( V_166 , V_147 -> V_44 , strlen ( V_166 ) ) )
continue;
if ( V_181 != V_186 )
return - V_174 ;
if ( V_147 -> V_148 == & V_187 )
V_177 = 1 ;
F_87 ( V_147 ) ;
return 0 ;
}
...
for ( V_166 = strtok_r ( V_118 , L_33 , & V_198 ) ;
V_166 ; V_166 = strtok_r ( NULL , L_33 , & V_198 ) ) {
V_40 = F_91 ( V_166 ) ;
if ( V_40 == - V_174 ) {
error ( L_34 , V_166 ) ;
break;
...
void F_100 ( int V_201 , bool V_160 )
{
struct V_129 * V_3 ;
struct V_132 * V_138 ;
F_101 (fmt) {
...
continue;
V_138 = F_71 ( V_3 , struct V_132 , V_135 ) ;
if ( V_138 -> V_136 -> V_139 == V_201 ) {
V_3 -> V_160 = V_160 ;
break;
}
}
}
static bool F_102 ( struct V_202 * V_158 , const char * V_203 , T_6 * V_204 )
{
if ( V_158 && F_103 ( V_158 ) == 1 ) {
if ( V_204 != NULL )
...
static bool F_105 ( int V_201 , T_6 * V_206 )
{
switch ( V_201 ) {
case V_207 :
return F_102 ( V_6 . V_208 , L_37 , V_206 ) ;
case V_209 :
return F_102 ( V_6 . V_210 , L_38 , V_206 ) ;
case V_211 :
return F_102 ( V_6 . V_212 , L_39 , V_206 ) ;
default:
break;
}
if ( V_181 != V_182 )
...
switch ( V_201 ) {
case V_213 :
return F_102 ( V_6 . V_214 , L_40 , V_206 ) ;
case V_215 :
return F_102 ( V_6 . V_216 , L_41 , V_206 ) ;
case V_217 :
return F_102 ( V_6 . V_218 , L_42 , V_206 ) ;
case V_219 :
return F_102 ( V_6 . V_220 , L_43 , V_206 ) ;
default:
break;
}
return false ;
}
void F_106 ( T_6 * V_206 )
{
struct V_129 * V_3 ;
struct V_132 * V_138 ;
F_101 (fmt) {
...
continue;
V_138 = F_71 ( V_3 , struct V_132 , V_135 ) ;
V_3 -> V_160 = F_105 ( V_138 -> V_136 -> V_139 , V_206 ) ;
}
F_101 (fmt) {
if ( ! F_70 ( V_3 ) )
continue;
...
bool F_96 ( const char * V_221 )
{
return V_221 && ( * V_221 != '+' ) ;
}
static int F_109 ( void )
{
char * V_198 , * V_166 , * V_118 , * V_222 ;
int V_40 = - V_174 ;
if ( V_200 == NULL )
return 0 ;
F_108 () ;
V_222 = V_118 = F_99 ( V_200 ) ;
if ( V_118 == NULL ) {
error ( L_44 ) ;
return - V_197 ;
}
...
for ( V_166 = strtok_r ( V_222 , L_33 , & V_198 ) ;
V_166 ; V_166 = strtok_r ( NULL , L_33 , & V_198 ) ) {
V_40 = F_107 ( V_166 ) ;
if ( V_40 == - V_174 ) {
error ( L_46 , V_166 ) ;
