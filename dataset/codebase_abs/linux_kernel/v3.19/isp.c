...
V_153 = F_63 ( V_108 , V_181 , V_184 , 0 ) ;
...
unsigned long V_18 ;
F_12 ( & V_181 -> V_225 , V_18 ) ;
if ( V_181 -> V_226 & V_227 ) {
F_13 ( & V_181 -> V_225 , V_18 ) ;
F_40 ( V_223 , 0 ) ;
F_114 () ;
return 0 ;
}
...
int V_244 ;
unsigned long V_22 ;
V_244 = F_125 ( V_2 -> clock [ V_245 ] ) ;
if ( V_244 ) {
F_126 ( V_2 -> V_24 , L_45 ) ;
goto V_246;
}
V_244 = F_127 ( V_2 -> clock [ V_247 ] , V_248 ) ;
if ( V_244 ) {
F_126 ( V_2 -> V_24 , L_46 ) ;
goto V_249;
}
V_244 = F_125 ( V_2 -> clock [ V_247 ] ) ;
if ( V_244 ) {
F_126 ( V_2 -> V_24 , L_47 ) ;
goto V_249;
}
V_22 = F_128 ( V_2 -> clock [ V_247 ] ) ;
if ( V_22 != V_248 )
F_129 ( V_2 -> V_24 , L_48
L_49
L_50 , V_248 , V_22 ) ;
V_244 = F_125 ( V_2 -> clock [ V_250 ] ) ;
if ( V_244 ) {
F_126 ( V_2 -> V_24 , L_51 ) ;
goto V_251;
}
...
struct V_32 * V_32 ;
unsigned int V_30 ;
for ( V_30 = 0 ; V_30 < F_22 ( V_252 ) ; ++ V_30 ) {
V_32 = F_133 ( V_2 -> V_24 , V_252 [ V_30 ] ) ;
if ( F_26 ( V_32 ) ) {
F_126 ( V_2 -> V_24 , L_52 , V_252 [ V_30 ] ) ;
return F_27 ( V_32 ) ;
}
V_2 -> clock [ V_30 ] = V_32 ;
}
...
static void F_135 ( struct V_1 * V_2 , bool V_258 )
{
if ( V_2 == NULL )
return;
F_67 ( & V_2 -> V_254 ) ;
...
static int F_140 ( struct V_99 * V_24 )
{
struct V_1 * V_2 = F_141 ( V_24 ) ;
int V_276 ;
F_64 ( F_142 ( & V_2 -> V_254 ) ) ;
if ( V_2 -> V_255 == 0 )
return 0 ;
V_276 = F_92 ( V_2 ) ;
F_34 ( V_2 ) ;
...
static int F_144 ( struct V_99 * V_24 )
{
struct V_1 * V_2 = F_141 ( V_24 ) ;
if ( V_2 -> V_255 == 0 )
return 0 ;
...
static void F_145 ( struct V_99 * V_24 )
{
struct V_1 * V_2 = F_141 ( V_24 ) ;
if ( V_2 -> V_255 == 0 )
return;
...
struct V_279 * V_280 )
{
struct V_152 * V_281 = NULL ;
unsigned int V_158 ;
if ( V_280 -> V_280 == NULL )
return NULL ;
for ( V_158 = 1 ; V_280 -> V_280 ; ++ V_280 , V_158 = 0 ) {
struct V_152 * V_108 ;
struct V_282 * V_283 ;
V_283 = F_156 ( V_280 -> V_284 ) ;
if ( V_283 == NULL ) {
F_126 ( V_2 -> V_24 , L_55
L_56 , V_25 ,
V_280 -> V_284 ,
...
V_108 = F_157 ( & V_2 -> V_277 , V_283 ,
V_280 -> V_280 , NULL ) ;
if ( V_108 == NULL ) {
F_126 ( V_2 -> V_24 , L_57 ,
V_25 , V_280 -> V_280 -> type ) ;
continue;
}
if ( V_158 )
V_281 = V_108 ;
...
struct V_285 * V_286 ;
int V_153 ;
V_2 -> V_278 . V_24 = V_2 -> V_24 ;
F_159 ( V_2 -> V_278 . V_287 , L_58 ,
sizeof( V_2 -> V_278 . V_287 ) ) ;
V_2 -> V_278 . V_288 = V_2 -> V_64 ;
V_2 -> V_278 . V_289 = F_69 ;
V_153 = F_160 ( & V_2 -> V_278 ) ;
if ( V_153 < 0 ) {
F_126 ( V_2 -> V_24 , L_59 ,
V_25 , V_153 ) ;
return V_153 ;
}
V_2 -> V_277 . V_290 = & V_2 -> V_278 ;
V_153 = F_161 ( V_2 -> V_24 , & V_2 -> V_277 ) ;
if ( V_153 < 0 ) {
F_126 ( V_2 -> V_24 , L_60 ,
V_25 , V_153 ) ;
goto V_291;
}
V_153 = F_162 ( & V_2 -> V_107 , & V_2 -> V_277 ) ;
if ( V_153 < 0 )
goto V_291;
V_153 = F_163 ( & V_2 -> V_111 , & V_2 -> V_277 ) ;
if ( V_153 < 0 )
goto V_291;
V_153 = F_164 ( & V_2 -> V_94 , & V_2 -> V_277 ) ;
if ( V_153 < 0 )
goto V_291;
V_153 = F_165 ( & V_2 -> V_114 ,
& V_2 -> V_277 ) ;
if ( V_153 < 0 )
goto V_291;
V_153 = F_166 ( & V_2 -> V_119 , & V_2 -> V_277 ) ;
if ( V_153 < 0 )
goto V_291;
V_153 = F_167 ( & V_2 -> V_123 , & V_2 -> V_277 ) ;
if ( V_153 < 0 )
goto V_291;
V_153 = F_167 ( & V_2 -> V_121 , & V_2 -> V_277 ) ;
if ( V_153 < 0 )
goto V_291;
V_153 = F_167 ( & V_2 -> V_95 , & V_2 -> V_277 ) ;
if ( V_153 < 0 )
goto V_291;
for ( V_286 = V_27 -> V_286 ; V_286 && V_286 -> V_286 ; ++ V_286 ) {
struct V_152 * V_281 ;
struct V_145 * V_73 ;
unsigned int V_18 ;
unsigned int V_173 ;
unsigned int V_30 ;
V_281 = F_155 ( V_2 , V_286 -> V_286 ) ;
if ( V_281 == NULL )
continue;
V_281 -> V_292 = V_286 ;
switch ( V_286 -> V_293 ) {
...
for ( V_30 = 0 ; V_30 < V_281 -> V_109 . V_304 ; V_30 ++ ) {
if ( V_281 -> V_109 . V_182 [ V_30 ] . V_18 & V_305 )
break;
}
if ( V_30 == V_281 -> V_109 . V_304 ) {
F_126 ( V_2 -> V_24 ,
L_62 ,
V_25 ) ;
V_153 = - V_33 ;
...
V_153 = F_168 ( & V_281 -> V_109 , V_30 , V_73 , V_173 ,
V_18 ) ;
if ( V_153 < 0 )
goto V_291;
}
V_153 = F_169 ( & V_2 -> V_277 ) ;
V_291:
if ( V_153 < 0 )
F_146 ( V_2 ) ;
return V_153 ;
...
V_153 = F_168 (
& V_2 -> V_111 . V_108 . V_109 , V_315 ,
& V_2 -> V_94 . V_108 . V_109 , V_295 , 0 ) ;
if ( V_153 < 0 )
goto V_316;
V_153 = F_168 (
& V_2 -> V_107 . V_108 . V_109 , V_317 ,
& V_2 -> V_94 . V_108 . V_109 , V_295 , 0 ) ;
if ( V_153 < 0 )
goto V_316;
V_153 = F_168 (
& V_2 -> V_94 . V_108 . V_109 , V_318 ,
& V_2 -> V_114 . V_108 . V_109 , V_319 , 0 ) ;
if ( V_153 < 0 )
goto V_316;
V_153 = F_168 (
& V_2 -> V_94 . V_108 . V_109 , V_320 ,
& V_2 -> V_119 . V_108 . V_109 , V_321 , 0 ) ;
if ( V_153 < 0 )
goto V_316;
V_153 = F_168 (
& V_2 -> V_114 . V_108 . V_109 , V_322 ,
& V_2 -> V_119 . V_108 . V_109 , V_321 , 0 ) ;
if ( V_153 < 0 )
goto V_316;
V_153 = F_168 (
...
V_153 = F_194 ( V_326 , V_2 -> V_24 ) ;
F_195 ( V_326 ) ;
if ( V_153 < 0 ) {
F_126 ( V_2 -> V_24 , L_73 ) ;
return V_153 ;
}
V_323 = F_196 ( & V_327 , V_328 , V_329 ) ;
if ( F_26 ( V_323 ) ) {
F_126 ( V_2 -> V_24 , L_74 ) ;
V_153 = F_27 ( V_323 ) ;
goto error;
...
static int F_198 ( struct V_330 * V_331 )
{
struct V_1 * V_2 = F_199 ( V_331 ) ;
F_146 ( V_2 ) ;
F_170 ( V_2 ) ;
F_30 ( V_2 ) ;
F_134 ( V_2 , false ) ;
...
static int F_200 ( struct V_330 * V_331 ,
struct V_1 * V_2 ,
enum V_332 V_207 )
{
struct V_333 * V_334 ;
V_334 = F_201 ( V_331 , V_335 , V_207 ) ;
V_2 -> V_336 [ V_207 ] = F_202 ( V_2 -> V_24 , V_334 ) ;
if ( F_26 ( V_2 -> V_336 [ V_207 ] ) )
return F_27 ( V_2 -> V_336 [ V_207 ] ) ;
V_2 -> V_337 [ V_207 ] = V_334 -> V_338 ;
return 0 ;
}
static int F_203 ( struct V_330 * V_331 )
{
struct V_26 * V_27 = V_331 -> V_24 . V_339 ;
struct V_1 * V_2 ;
int V_153 ;
int V_30 , V_340 ;
if ( V_27 == NULL )
return - V_33 ;
V_2 = F_204 ( & V_331 -> V_24 , sizeof( * V_2 ) , V_43 ) ;
if ( ! V_2 ) {
F_126 ( & V_331 -> V_24 , L_76 ) ;
return - V_44 ;
}
V_2 -> V_68 = V_68 ;
F_205 ( & V_2 -> V_254 ) ;
...
V_2 -> V_27 = V_27 ;
V_2 -> V_255 = 0 ;
V_153 = F_206 ( V_2 -> V_24 , F_207 ( 32 ) ) ;
if ( V_153 )
return V_153 ;
F_208 ( V_331 , V_2 ) ;
V_2 -> V_342 . V_343 = F_209 ( & V_331 -> V_24 , L_77 ) ;
V_2 -> V_344 . V_343 = F_209 ( & V_331 -> V_24 , L_78 ) ;
V_153 = F_200 ( V_331 , V_2 , V_3 ) ;
if ( V_153 < 0 )
goto error;
V_153 = F_132 ( V_2 ) ;
if ( V_153 < 0 )
goto error;
V_153 = F_210 ( V_2 -> clock [ V_245 ] ) ;
if ( V_153 < 0 )
goto error;
V_2 -> V_64 = F_3 ( V_2 , V_3 , V_4 ) ;
F_82 ( V_2 -> V_24 , L_79 ,
( V_2 -> V_64 & 0xf0 ) >> 4 , V_2 -> V_64 & 0x0f ) ;
F_211 ( V_2 -> clock [ V_245 ] ) ;
...
if ( V_153 < 0 )
goto V_346;
for ( V_340 = 0 ; V_340 < F_22 ( V_347 ) ; V_340 ++ )
if ( V_2 -> V_64 == V_347 [ V_340 ] . V_348 )
break;
if ( V_340 == F_22 ( V_347 ) ) {
F_126 ( V_2 -> V_24 , L_80 ,
...
for ( V_30 = 1 ; V_30 < V_349 ; V_30 ++ ) {
if ( V_347 [ V_340 ] . V_350 & 1 << V_30 ) {
V_153 = F_200 ( V_331 , V_2 , V_30 ) ;
if ( V_153 )
goto V_346;
}
}
V_153 = F_192 ( V_2 ) ;
if ( V_153 < 0 ) {
F_126 ( & V_331 -> V_24 , L_81 ) ;
goto V_346;
}
V_2 -> V_351 = F_212 ( V_331 , 0 ) ;
if ( V_2 -> V_351 <= 0 ) {
F_126 ( V_2 -> V_24 , L_82 ) ;
V_153 = - V_345 ;
goto V_352;
}
if ( F_213 ( V_2 -> V_24 , V_2 -> V_351 , F_46 , V_353 ,
L_83 , V_2 ) ) {
F_126 ( V_2 -> V_24 , L_84 ) ;
V_153 = - V_33 ;
goto V_352;
