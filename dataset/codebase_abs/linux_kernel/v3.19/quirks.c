...
if ( F_189 ( V_2 ) != V_270 )
return;
V_268 = F_133 ( V_2 -> V_51 , 0x0 ) ;
if ( V_268 == V_2 )
goto V_226;
if ( ! V_268 || ! V_268 -> V_85 )
goto V_226;
V_269 = F_133 ( V_268 -> V_85 , 0x0 ) ;
if ( ! V_269 )
goto V_226;
if ( V_269 -> V_161 != V_7
|| ( V_269 -> V_89 != 0x1547 && V_269 -> V_89 != 0x156c )
|| V_269 -> V_112 != 0x2222
|| V_269 -> V_115 != 0x1111 )
goto V_226;
F_6 ( & V_2 -> V_2 , L_111 ) ;
...
( V_272 -> V_161 == V_2 -> V_161 ||
V_272 -> V_161 == ( T_2 ) V_274 ) &&
( V_272 -> V_89 == V_2 -> V_89 ||
V_272 -> V_89 == ( T_2 ) V_274 ) ) {
V_251 = F_170 ( V_2 , V_272 -> V_275 ) ;
V_272 -> V_275 ( V_2 ) ;
F_178 ( V_2 , V_251 , V_272 -> V_275 ) ;
}
}
...
{
if ( F_95 ( V_2 -> V_82 ) != 0 ) {
V_2 -> V_334 = F_134 ( F_62 ( V_2 -> V_82 ) , 0 ) ;
V_2 -> V_109 |= V_335 ;
}
}
...
{
if ( F_95 ( V_2 -> V_82 ) != 1 ) {
V_2 -> V_334 = F_134 ( F_62 ( V_2 -> V_82 ) , 1 ) ;
V_2 -> V_109 |= V_335 ;
}
}
static void F_216 ( struct V_1 * V_54 )
{
if ( ! F_217 ( V_54 -> V_51 ) &&
V_54 -> V_150 == V_336 &&
! F_218 ( V_54 ) && F_218 ( V_54 -> V_51 -> V_337 ) &&
F_189 ( V_54 -> V_51 -> V_337 ) != V_338 )
V_54 -> V_109 |= V_339 ;
}
static int F_219 ( struct V_1 * V_2 , T_2 V_340 )
{
#ifdef F_220
struct V_341 * V_342 = NULL ;
T_9 V_343 ;
if ( ! V_2 -> V_151 || ! F_217 ( V_2 -> V_51 ) )
return - V_344 ;
V_343 = F_221 ( L_117 , 0 , & V_342 ) ;
if ( F_191 ( V_343 ) )
return - V_344 ;
V_340 &= ( V_345 | V_346 | V_347 | V_348 ) ;
return V_340 & ~ ( V_345 | V_346 ) ? 0 : 1 ;
#else
return - V_344 ;
#endif
}
...
{
int V_29 ;
if ( ! F_218 ( V_2 ) || F_189 ( V_2 ) != V_349 )
return false ;
for ( V_29 = 0 ; V_29 < F_223 ( V_350 ) ; V_29 ++ )
if ( V_350 [ V_29 ] == V_2 -> V_89 )
return true ;
return false ;
}
static int F_224 ( struct V_1 * V_2 , T_2 V_340 )
{
T_2 V_33 = V_2 -> V_109 & V_351 ?
V_352 : 0 ;
if ( ! F_222 ( V_2 ) )
return - V_311 ;
return V_340 & ~ V_33 ? 0 : 1 ;
}
static int F_225 ( struct V_1 * V_2 , T_2 V_340 )
{
V_340 &= ~ ( V_353 | V_354 | V_345 |
V_346 | V_355 | V_348 ) ;
return V_340 ? 0 : 1 ;
}
int F_226 ( struct V_1 * V_2 , T_2 V_340 )
{
const struct V_356 * V_29 ;
int V_357 ;
for ( V_29 = V_356 ; V_29 -> V_358 ; V_29 ++ ) {
if ( ( V_29 -> V_161 == V_2 -> V_161 ||
V_29 -> V_161 == ( T_2 ) V_274 ) &&
( V_29 -> V_89 == V_2 -> V_89 ||
V_29 -> V_89 == ( T_2 ) V_274 ) ) {
V_357 = V_29 -> V_358 ( V_2 , V_340 ) ;
if ( V_357 >= 0 )
return V_357 ;
}
}
...
{
T_1 V_132 , V_359 , V_360 ;
void T_4 * V_361 ;
F_228 ( V_2 -> V_51 , F_134 ( 31 , 0 ) ,
V_362 , & V_132 ) ;
if ( ! ( V_132 & V_363 ) )
return - V_364 ;
V_361 = F_84 ( V_132 & V_365 ,
F_229 ( V_366 ) ) ;
if ( ! V_361 )
return - V_316 ;
V_359 = F_86 ( V_361 + V_367 ) ;
V_359 &= V_368 | V_369 ;
if ( V_359 != ( V_368 | V_369 ) ) {
V_360 = F_86 ( V_361 + V_366 ) ;
if ( V_360 & V_370 ) {
F_6 ( & V_2 -> V_2 , L_118 ) ;
V_360 &= ~ V_370 ;
F_87 ( V_360 , V_361 + V_366 ) ;
}
}
F_89 ( V_361 ) ;
return 0 ;
...
{
T_1 V_371 ;
F_10 ( V_2 , V_372 , & V_371 ) ;
if ( ! ( V_371 & V_373 ) ) {
F_6 ( & V_2 -> V_2 , L_119 ) ;
V_371 |= V_373 ;
F_53 ( V_2 , V_372 , V_371 ) ;
}
}
...
{
const struct V_374 * V_29 ;
int V_357 ;
for ( V_29 = V_374 ; V_29 -> V_375 ; V_29 ++ ) {
if ( ( V_29 -> V_161 == V_2 -> V_161 ||
V_29 -> V_161 == ( T_2 ) V_274 ) &&
( V_29 -> V_89 == V_2 -> V_89 ||
V_29 -> V_89 == ( T_2 ) V_274 ) ) {
V_357 = V_29 -> V_375 ( V_2 ) ;
if ( V_357 >= 0 )
return;
}
}
