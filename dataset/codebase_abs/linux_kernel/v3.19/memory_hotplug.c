...
int F_132 ( int V_60 , T_1 V_8 , T_1 V_9 , int V_124 )
{
...
{
return F_137 ( V_19 ) && F_138 ( V_19 ) >= V_127 ;
}
static struct V_19 * F_139 ( struct V_19 * V_19 )
{
F_19 ( F_140 ( V_19 ) & ( V_128 - 1 ) ) ;
if ( F_136 ( V_19 ) ) {
int V_129 ;
V_129 = F_138 ( V_19 ) ;
...
for (; V_19 < V_131 ; V_19 = F_139 ( V_19 ) ) {
if ( ! F_142 ( V_19 ) )
return 0 ;
F_143 () ;
}
...
V_42 += V_132 ) {
V_30 = 0 ;
while ( ( V_30 < V_132 ) && ! F_145 ( V_42 + V_30 ) )
V_30 ++ ;
if ( V_30 == V_132 )
continue;
V_19 = F_57 ( V_42 + V_30 ) ;
...
V_19 = F_57 ( V_42 ) ;
if ( F_148 ( V_19 ) ) {
struct V_19 * V_137 = F_154 ( V_19 ) ;
V_42 = F_140 ( V_137 ) + ( 1 << F_151 ( V_137 ) ) - 1 ;
if ( F_151 ( V_137 ) > V_77 ) {
V_66 = - V_138 ;
break;
}
...
{
return F_181 ( V_26 , V_26 + V_44 , 120 * V_163 ) ;
}
int F_193 ( unsigned long V_26 , unsigned long V_43 ,
void * V_92 , int (* F_194)( struct V_164 * , void * ) )
{
...
( V_29 <= V_165 -> V_168 ) )
continue;
V_165 = F_196 ( V_166 , V_165 ) ;
if ( ! V_165 )
continue;
V_66 = F_194 ( V_165 , V_92 ) ;
if ( V_66 ) {
F_197 ( & V_165 -> V_169 . V_170 ) ;
return V_66 ;
}
}
if ( V_165 )
...
static int F_198 ( struct V_164 * V_165 , void * V_92 )
{
int V_66 = ! F_199 ( V_165 ) ;
if ( F_8 ( V_66 ) ) {
T_8 V_171 , V_172 ;
V_171 = F_200 ( F_83 ( V_165 -> V_167 ) ) ;
V_172 = F_200 ( F_83 ( V_165 -> V_168 + 1 ) ) - 1 ;
F_87 ( L_12
L_13 ,
& V_171 , & V_172 ) ;
}
