...
{
struct V_3 * V_4 = F_15 ( V_15 ) ;
F_16 ( V_4 -> V_7 * V_15 -> V_16 ,
...
{
bool V_28 , V_29 ;
V_28 = F_18 ( V_4 -> V_22 ) & V_4 -> V_17 -> V_23 ;
V_29 = F_18 ( V_4 -> V_8 + V_9 ) & V_4 -> V_17 -> V_21 ;
return V_28 && V_29 ;
}
static int F_27 ( struct V_3 * V_4 )
{
bool V_30 , V_28 , V_29 ;
V_30 = F_18 ( V_4 -> V_24 ) & V_4 -> V_17 -> V_25 ;
V_28 = F_18 ( V_4 -> V_22 ) & V_4 -> V_17 -> V_23 ;
V_29 = F_18 ( V_4 -> V_8 + V_9 ) & V_4 -> V_17 -> V_21 ;
...
static unsigned int F_29 ( struct V_14 * V_15 )
{
struct V_3 * V_4 = F_15 ( V_15 ) ;
return F_18 ( V_4 -> V_8 + V_4 -> V_17 -> V_18 ) / V_4 -> V_7 ;
}
...
static T_2 F_31 ( int V_31 , void * V_32 )
{
F_32 ( L_2 ) ;
return V_33 ;
}
...
struct V_35 * V_36 ;
T_4 V_22 ;
V_36 = F_34 ( V_2 , V_37 , 1 ) ;
if ( V_36 )
return F_35 ( & V_2 -> V_4 , V_36 -> V_26 ,
F_36 ( V_36 ) ) ;
V_22 = V_34 + V_38 ;
F_37 ( 1 , V_39 L_3 , & V_22 ) ;
return F_35 ( & V_2 -> V_4 , V_22 , 0x4 ) ;
}
...
struct V_35 * V_36 ;
V_36 = F_34 ( V_2 , V_37 , 0 ) ;
if ( ! V_36 )
return - V_42 ;
V_4 -> V_8 = F_35 ( & V_2 -> V_4 , V_36 -> V_26 ,
F_36 ( V_36 ) ) ;
if ( ! V_4 -> V_8 )
return - V_43 ;
if ( F_39 ( V_41 , L_4 ) ) {
V_4 -> V_22 = F_33 ( V_2 , V_36 -> V_26 &
V_44 ) ;
if ( ! V_4 -> V_22 )
return - V_42 ;
} else if ( F_39 ( V_41 , L_5 ) ||
F_39 ( V_41 , L_6 ) ) {
V_36 = F_34 ( V_2 , V_37 , 1 ) ;
V_4 -> V_22 = F_40 ( & V_2 -> V_4 , V_36 ) ;
if ( F_3 ( V_4 -> V_22 ) )
return F_4 ( V_4 -> V_22 ) ;
} else if ( F_39 ( V_41 , L_7 ) ||
F_39 ( V_41 , L_8 ) ) {
V_36 = F_34 ( V_2 , V_37 , 1 ) ;
V_4 -> V_22 = F_40 ( & V_2 -> V_4 , V_36 ) ;
if ( F_3 ( V_4 -> V_22 ) )
return F_4 ( V_4 -> V_22 ) ;
V_36 = F_34 ( V_2 , V_37 , 2 ) ;
if ( ! V_36 )
return - V_42 ;
V_4 -> V_24 = F_35 ( & V_2 -> V_4 , V_36 -> V_26 ,
F_36 ( V_36 ) ) ;
if ( ! V_4 -> V_24 )
return - V_43 ;
} else {
...
unsigned int V_47 ;
int V_5 , V_31 ;
V_4 = F_42 ( & V_2 -> V_4 , sizeof( struct V_3 ) ,
V_48 ) ;
if ( ! V_4 )
return - V_43 ;
V_46 = F_43 ( V_49 , & V_2 -> V_4 ) ;
if ( ! V_46 )
V_46 = & V_49 [ 0 ] ;
V_4 -> V_50 . V_51 = & V_52 ;
V_4 -> V_50 . V_53 = & V_54 ;
