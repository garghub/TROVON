...
int error ;
struct V_54 V_26 ;
error = F_21 ( V_45 , V_2 , F_22 ( args -> V_55 , V_46 ) ,
- 1 , & V_4 , V_50 ) ;
if ( error )
return error ;
F_17 ( V_45 , V_4 , V_52 ) ;
...
V_2 = args -> V_2 ;
V_45 = args -> V_53 ;
if ( ( error = F_30 ( args , V_78 , & V_70 ) ) ) {
return error ;
}
ASSERT ( V_70 == F_31 ( args -> V_55 , V_79 ) ) ;
error = F_20 ( args , V_70 , & V_69 ) ;
if ( error )
return error ;
free = V_69 -> V_7 ;
V_2 -> V_10 -> V_80 ( & V_77 , free ) ;
V_6 = V_68 -> V_7 ;
V_73 = F_32 ( args -> V_55 , V_6 ) ;
ASSERT ( F_33 ( V_73 -> V_81 ) <=
( V_66 ) V_2 -> V_82 . V_83 / args -> V_55 -> V_84 ) ;
V_71 = F_34 ( V_73 ) ;
V_76 = V_2 -> V_10 -> V_65 ( free ) ;
for ( V_72 = V_74 = 0 ; V_72 < F_33 ( V_73 -> V_81 ) ; V_72 ++ , V_71 ++ , V_76 ++ ) {
if ( ( V_75 = F_35 ( * V_71 ) ) != V_85 )
V_74 ++ ;
* V_76 = F_36 ( V_75 ) ;
}
V_77 . V_86 = V_74 ;
V_77 . V_87 = F_33 ( V_73 -> V_81 ) ;
V_2 -> V_10 -> V_60 ( V_69 -> V_7 , & V_77 ) ;
F_24 ( args , V_69 , 0 , V_77 . V_87 - 1 ) ;
F_26 ( args , V_69 ) ;
if ( V_6 -> V_26 . V_16 . V_12 == F_36 ( V_88 ) )
...
V_92 = 0 ;
ASSERT ( V_91 == 0 || F_33 ( V_99 [ V_91 - 1 ] . V_105 ) <= args -> V_105 ) ;
ASSERT ( V_91 == V_9 . V_101 ||
F_33 ( V_99 [ V_91 ] . V_105 ) >= args -> V_105 ) ;
if ( args -> V_106 & V_107 )
return 0 ;
if ( V_92 )
F_41 ( & V_9 , V_99 , & V_91 , & V_97 ,
& V_93 , & V_96 , & V_95 ) ;
else if ( V_9 . V_103 ) {
V_96 = V_9 . V_101 ;
V_95 = - 1 ;
}
V_94 = F_42 ( & V_9 , V_99 , V_91 , V_92 , V_97 ,
V_93 , & V_96 , & V_95 ) ;
V_94 -> V_105 = F_6 ( args -> V_105 ) ;
V_94 -> V_108 = F_6 ( F_43 ( args -> V_55 ,
args -> V_17 , args -> V_91 ) ) ;
V_2 -> V_10 -> V_109 ( V_6 , & V_9 ) ;
F_37 ( args , V_4 ) ;
F_44 ( args , V_4 , V_96 , V_95 ) ;
F_38 ( V_2 , V_4 ) ;
return 0 ;
}
static void
...
return 0 ;
V_99 = V_2 -> V_10 -> V_100 ( V_6 ) ;
return F_33 ( V_99 [ V_9 . V_101 - 1 ] . V_105 ) ;
}
STATIC int
F_47 (
struct V_3 * V_4 ,
...
for ( V_94 = & V_99 [ V_91 ] ;
V_91 < V_9 . V_101 && F_33 ( V_94 -> V_105 ) == args -> V_105 ;
V_94 ++ , V_91 ++ ) {
if ( F_33 ( V_94 -> V_108 ) == V_127 )
continue;
V_121 = F_49 ( args -> V_55 ,
F_33 ( V_94 -> V_108 ) ) ;
if ( V_121 != V_117 ) {
T_6 * V_64 ;
V_117 = V_121 ;
...
{
if ( args -> V_106 & V_150 )
return F_47 ( V_4 , args , V_114 ,
V_115 ) ;
return F_53 ( V_4 , args , V_114 , V_115 ) ;
}
static void
F_58 (
T_3 * args ,
...
V_101 * sizeof( T_12 ) ) ;
F_44 ( args , V_155 , V_158 , V_158 + V_101 - 1 ) ;
if ( V_154 + V_101 < V_152 -> V_101 ) {
memmove ( & V_153 [ V_154 ] , & V_153 [ V_154 + V_101 ] ,
V_101 * sizeof( T_12 ) ) ;
F_44 ( args , V_151 , V_154 , V_154 + V_101 - 1 ) ;
}
V_152 -> V_101 -= V_101 ;
V_152 -> V_103 -= V_103 ;
V_156 -> V_101 += V_101 ;
...
( F_33 ( V_164 [ 0 ] . V_105 ) < F_33 ( V_163 [ 0 ] . V_105 ) ||
F_33 ( V_164 [ V_166 . V_101 - 1 ] . V_105 ) <
F_33 ( V_163 [ V_165 . V_101 - 1 ] . V_105 ) ) )
return 1 ;
return 0 ;
}
static void
...
args = V_115 -> args ;
if ( ( V_174 = F_60 ( V_2 , V_167 -> V_4 , V_168 -> V_4 ) ) ) {
T_17 * V_175 ;
V_175 = V_167 ;
V_167 = V_168 ;
V_168 = V_175 ;
...
V_176 = F_33 ( V_164 [ V_170 - V_165 . V_101 ] . V_105 ) ;
else
V_176 = F_33 ( V_163 [ V_170 ] . V_105 ) ;
...
if ( V_101 > 0 )
F_58 ( args , V_167 -> V_4 , & V_165 , V_163 ,
V_165 . V_101 - V_101 , V_168 -> V_4 ,
& V_166 , V_164 , 0 , V_101 ) ;
else if ( V_101 < 0 )
F_58 ( args , V_168 -> V_4 , & V_166 , V_164 , 0 ,
...
V_64 = V_2 -> V_10 -> V_65 ( free ) ;
if ( V_26 ) {
V_64 [ V_181 ] = F_36 ( V_182 ) ;
F_24 ( args , V_69 , V_181 , V_181 ) ;
return 0 ;
}
V_77 . V_86 -- ;
...
if ( V_64 [ V_72 ] != F_36 ( V_85 ) )
break;
}
V_77 . V_87 = V_72 + 1 ;
V_183 = 0 ;
} else {
V_64 [ V_181 ] = F_36 ( V_85 ) ;
V_183 = 1 ;
}
...
V_99 = V_2 -> V_10 -> V_100 ( V_6 ) ;
V_94 = & V_99 [ V_91 ] ;
V_110 = F_49 ( args -> V_55 , F_33 ( V_94 -> V_108 ) ) ;
ASSERT ( V_185 -> V_17 == V_110 ) ;
V_75 = F_56 ( args -> V_55 , F_33 ( V_94 -> V_108 ) ) ;
ASSERT ( V_185 -> V_91 == V_75 ) ;
V_9 . V_103 ++ ;
V_2 -> V_10 -> V_109 ( V_6 , & V_9 ) ;
F_37 ( args , V_4 ) ;
V_94 -> V_108 = F_6 ( V_127 ) ;
F_44 ( args , V_4 , V_91 , V_91 ) ;
V_187 = V_185 -> V_4 ;
V_26 = V_187 -> V_7 ;
V_134 = ( T_16 * ) ( ( char * ) V_26 + V_75 ) ;
V_191 = V_2 -> V_10 -> V_192 ( V_26 ) ;
V_182 = F_35 ( V_191 [ 0 ] . V_120 ) ;
V_188 = V_189 = 0 ;
F_68 ( args , V_187 , V_75 ,
...
error = F_72 ( args , & V_17 ) ;
if ( error ) {
return error ;
}
error = F_73 ( args , F_74 ( args -> V_55 , V_17 ) ,
& V_197 -> V_4 , V_19 ) ;
if ( error )
return error ;
V_197 -> V_17 = V_17 ;
V_197 -> V_12 = V_19 ;
F_61 ( V_115 , V_196 , V_197 ) ;
error = F_75 ( V_115 , V_196 , V_197 ) ;
if ( error ) {
return error ;
}
if ( V_115 -> V_177 )
error = F_39 ( V_196 -> V_4 , args , V_196 -> V_91 ) ;
else
error = F_39 ( V_197 -> V_4 , args , V_197 -> V_91 ) ;
V_196 -> V_105 = F_46 ( V_2 , V_196 -> V_4 , NULL ) ;
V_197 -> V_105 = F_46 ( V_2 , V_197 -> V_4 , NULL ) ;
F_38 ( V_2 , V_196 -> V_4 ) ;
F_38 ( V_2 , V_197 -> V_4 ) ;
return error ;
}
...
error = F_77 ( V_115 , & V_115 -> V_205 , V_201 , 0 ,
& V_186 ) ;
if ( error )
return error ;
* V_198 = V_186 ? 2 : 0 ;
...
if ( V_17 == 0 )
continue;
error = F_78 ( V_115 -> args -> V_53 , V_2 ,
V_17 , - 1 , & V_4 ) ;
if ( error )
return error ;
V_101 = V_9 . V_101 - V_9 . V_103 ;
...
error = F_77 ( V_115 , & V_115 -> V_202 , V_201 , 0 ,
& V_186 ) ;
if ( error ) {
return error ;
}
...
if ( V_212 . V_103 )
F_80 ( args , & V_212 , V_207 -> V_4 ) ;
if ( V_211 . V_103 )
F_80 ( args , & V_211 , V_208 -> V_4 ) ;
V_207 -> V_105 = F_33 ( V_157 [ V_212 . V_101 - 1 ] . V_105 ) ;
if ( F_60 ( V_2 , V_208 -> V_4 , V_207 -> V_4 ) )
F_58 ( args , V_207 -> V_4 , & V_212 , V_157 , 0 ,
...
V_208 -> V_105 = F_33 ( V_153 [ V_211 . V_101 - 1 ] . V_105 ) ;
...
V_186 = F_39 ( V_199 -> V_4 , args , V_199 -> V_91 ) ;
if ( V_186 == 0 ) {
if ( ! ( args -> V_106 & V_107 ) )
F_86 ( V_115 , & V_115 -> V_202 ) ;
} else {
if ( args -> V_184 == 0 ) {
ASSERT ( V_186 == - V_104 ) ;
goto V_213;
...
ASSERT ( F_35 ( V_64 [ V_181 ] ) != V_85 ) ;
ASSERT ( F_35 ( V_64 [ V_181 ] ) >= V_120 ) ;
...
if ( V_215 == - 1 ) {
T_20 V_220 ;
if ( ( error = F_89 ( V_2 , & V_220 , V_50 ) ) )
return error ;
V_218 = F_74 ( args -> V_55 , ( T_1 ) V_220 ) ;
V_46 = V_217 ;
}
while ( V_215 == - 1 ) {
if ( V_69 == NULL ) {
...
V_64 = V_2 -> V_10 -> V_65 ( free ) ;
V_2 -> V_10 -> V_80 ( & V_77 , free ) ;
if ( F_35 ( V_64 [ V_181 ] ) != V_85 &&
F_35 ( V_64 [ V_181 ] ) >= V_120 )
V_215 = V_77 . V_111 + V_181 ;
else {
if ( ++ V_181 == V_77 . V_87 ) {
F_50 ( V_45 , V_69 ) ;
...
return - V_104 ;
if ( F_51 ( ( error = F_30 ( args ,
V_221 ,
& V_215 ) ) ||
( error = F_90 ( args , V_215 , & V_187 ) ) ) )
return error ;
if ( V_69 )
F_50 ( V_45 , V_69 ) ;
if ( V_214 && V_214 -> V_4 )
...
ASSERT ( F_35 ( V_191 [ 0 ] . V_120 ) >= V_120 ) ;
V_216 = ( T_19 * )
( ( char * ) V_26 + F_35 ( V_191 [ 0 ] . V_222 ) ) ;
V_189 = V_188 = 0 ;
F_91 ( args , V_187 , V_216 ,
( V_223 ) ( ( char * ) V_216 - ( char * ) V_26 ) , V_120 ,
& V_188 , & V_189 ) ;
V_134 = ( T_16 * ) V_216 ;
V_134 -> V_142 = F_13 ( args -> V_142 ) ;
V_134 -> V_126 = args -> V_126 ;
memcpy ( V_134 -> V_141 , args -> V_141 , V_134 -> V_126 ) ;
V_2 -> V_10 -> V_224 ( V_134 , args -> V_143 ) ;
V_219 = V_2 -> V_10 -> V_225 ( V_134 ) ;
* V_219 = F_36 ( ( char * ) V_134 - ( char * ) V_26 ) ;
F_92 ( args , V_187 , V_134 ) ;
if ( V_189 )
F_69 ( V_2 , V_26 , & V_188 ) ;
if ( V_188 )
F_70 ( args , V_187 ) ;
V_64 = V_2 -> V_10 -> V_65 ( free ) ;
if ( F_35 ( V_64 [ V_181 ] ) != F_35 ( V_191 [ 0 ] . V_120 ) ) {
V_64 [ V_181 ] = V_191 [ 0 ] . V_120 ;
V_183 = 1 ;
}
if ( V_183 )
...
V_115 -> V_124 . V_91 ) ;
V_186 = F_95 ( args , V_134 -> V_141 , V_134 -> V_126 ) ;
}
for ( V_72 = 0 ; V_72 < V_115 -> V_202 . V_203 ; V_72 ++ ) {
F_50 ( args -> V_53 , V_115 -> V_202 . V_199 [ V_72 ] . V_4 ) ;
V_115 -> V_202 . V_199 [ V_72 ] . V_4 = NULL ;
}
if ( V_115 -> V_123 && V_115 -> V_124 . V_4 ) {
F_50 ( args -> V_53 , V_115 -> V_124 . V_4 ) ;
...
ASSERT ( V_199 -> V_12 == V_19 ) ;
ASSERT ( V_115 -> V_123 ) ;
error = F_66 ( args , V_199 -> V_4 , V_199 -> V_91 ,
& V_115 -> V_124 , & V_186 ) ;
if ( error )
goto V_229;
F_86 ( V_115 , & V_115 -> V_202 ) ;
...
V_134 -> V_142 = F_13 ( V_230 ) ;
args -> V_2 -> V_10 -> V_224 ( V_134 , args -> V_143 ) ;
F_92 ( args , V_115 -> V_124 . V_4 , V_134 ) ;
V_186 = 0 ;
}
else if ( V_115 -> V_123 ) {
F_50 ( args -> V_53 , V_115 -> V_124 . V_4 ) ;
