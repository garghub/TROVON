...
if ( V_36 )
goto V_123;
if ( V_13 -> V_87 && ( F_63 ( V_121 ) < 0 ) ) {
V_36 = - V_4 ;
goto V_124;
}
V_36 = F_75 ( & V_121 -> V_33 . V_125 ,
& V_126 ) ;
if ( V_36 )
goto V_127;
if ( ! V_13 -> V_38 ) {
if ( V_27 )
V_36 = F_76 ( & V_121 -> V_33 ,
& V_102 ) ;
if ( V_36 )
goto V_128;
} else {
...
F_31 ( L_15 V_130 L_16 ) ;
return 0 ;
V_128:
F_77 ( & V_121 -> V_33 . V_125 , & V_126 ) ;
V_127:
if ( V_13 -> V_87 ) {
F_78 ( F_45 ) ;
F_79 ( & V_71 ) ;
