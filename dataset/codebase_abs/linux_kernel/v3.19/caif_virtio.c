...
if ( F_75 ( V_4 -> V_104 ) )
return;
F_76 ( L_8 , V_105 , V_4 -> V_104 ,
& V_4 -> V_7 . V_62 ) ;
F_76 ( L_9 , V_105 , V_4 -> V_104 ,
& V_4 -> V_7 . V_60 ) ;
F_76 ( L_10 , V_105 , V_4 -> V_104 ,
& V_4 -> V_7 . V_63 ) ;
F_76 ( L_11 , V_105 , V_4 -> V_104 ,
& V_4 -> V_7 . V_66 ) ;
F_76 ( L_12 , V_105 , V_4 -> V_104 ,
& V_4 -> V_7 . V_88 ) ;
F_76 ( L_13 , V_105 , V_4 -> V_104 ,
& V_4 -> V_7 . V_89 ) ;
F_76 ( L_14 , V_105 , V_4 -> V_104 ,
& V_4 -> V_7 . V_8 ) ;
F_76 ( L_15 , V_105 , V_4 -> V_104 ,
& V_4 -> V_7 . V_22 ) ;
}
...
T_3 * V_106 = F_1 ;
T_4 * V_107 = F_40 ;
const char * V_108 = L_16 ;
const char * V_109 = L_17 ;
struct V_77 * V_78 ;
struct V_3 * V_4 ;
int V_24 = - V_75 ;
V_78 = F_78 ( sizeof( struct V_3 ) , V_109 ,
V_110 , F_71 ) ;
if ( ! V_78 )
return - V_35 ;
V_4 = F_54 ( V_78 ) ;
...
F_79 ( & V_4 -> V_16 ) ;
V_24 = - V_111 ;
if ( ! V_5 -> V_112 || ! V_5 -> V_112 -> V_113 )
goto V_24;
V_24 = V_5 -> V_112 -> V_113 ( V_5 , 1 , & V_4 -> V_49 , & V_107 ) ;
if ( V_24 )
goto V_24;
V_24 = V_5 -> V_114 -> V_115 ( V_5 , 1 , & V_4 -> V_2 , & V_106 , & V_108 ) ;
if ( V_24 )
goto V_24;
if ( V_5 -> V_114 -> V_116 ) {
F_80 ( V_5 , struct V_117 , V_118 ,
& V_4 -> V_72 ) ;
F_80 ( V_5 , struct V_117 , V_118 ,
& V_4 -> V_31 ) ;
F_80 ( V_5 , struct V_117 , V_119 ,
& V_4 -> V_73 ) ;
F_80 ( V_5 , struct V_117 , V_119 ,
& V_4 -> V_32 ) ;
F_80 ( V_5 , struct V_117 , V_74 ,
& V_4 -> V_74 ) ;
F_80 ( V_5 , struct V_117 , V_74 ,
& V_4 -> V_30 ) ;
} else {
...
if ( V_4 -> V_49 )
V_5 -> V_112 -> V_125 ( V_4 -> V_5 ) ;
if ( V_4 -> V_5 )
V_5 -> V_114 -> V_126 ( V_4 -> V_5 ) ;
V_103 ( V_78 ) ;
return V_24 ;
}
static void F_86 ( struct V_64 * V_5 )
{
struct V_3 * V_4 = V_5 -> V_6 ;
F_87 () ;
F_88 ( V_4 -> V_21 ) ;
