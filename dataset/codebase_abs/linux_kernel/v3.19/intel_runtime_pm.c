...
{
struct V_23 * V_24 = V_2 -> V_24 ;
struct V_78 * V_78 = & V_24 -> V_25 -> V_24 ;
if ( ! F_84 ( V_24 ) )
return;
if ( ! F_85 ( V_24 ) )
return;
...
struct V_3 * V_81 =
F_76 ( V_2 , V_46 ) ;
if ( V_80 -> V_67 -> V_12 ( V_2 , V_80 ) &&
V_81 -> V_67 -> V_12 ( V_2 , V_81 ) &&
F_2 ( V_53 ) & V_54 )
return;
F_21 ( L_8 ) ;
V_81 -> V_67 -> V_20 ( V_2 , V_81 ) ;
V_80 -> V_67 -> V_71 ( V_2 , V_80 ) ;
}
