...
static int F_76 ( struct V_177 * V_92 )
{
...
static void F_82 ( struct V_177 * V_92 )
{
struct V_76 * V_102 = F_75 ( V_92 -> V_167 ) ;
struct V_2 * V_3 = V_102 -> V_3 ;
struct V_4 * V_5 = V_3 -> V_5 ;
struct V_43 * V_44 = & V_3 -> V_44 ;
struct V_90 * V_179 = F_43 ( V_92 ,
struct V_90 , V_92 ) ;
unsigned long V_66 ;
unsigned long V_180 ;
unsigned long V_94 ;
F_83 ( & V_3 -> V_181 , V_66 ) ;
V_180 = F_36 ( & V_3 -> V_88 ) ;
F_84 ( & V_179 -> V_91 , & V_3 -> V_88 ) ;
F_85 ( & V_3 -> V_181 , V_66 ) ;
if ( V_180 && V_3 -> V_61 && V_44 -> V_55 ==
V_57 &&
V_3 -> V_55 == V_182 ) {
F_86 ( & V_3 -> V_181 ) ;
V_94 = F_31 ( V_3 ) ;
...
static int F_89 ( struct V_167 * V_168 , unsigned int V_183 )
{
struct V_76 * V_102 = F_75 ( V_168 ) ;
struct V_2 * V_3 = V_102 -> V_3 ;
struct V_4 * V_5 = V_3 -> V_5 ;
...
static int F_91 ( struct V_177 * V_92 )
{
struct V_90 * V_179 = F_43 ( V_92 ,
struct V_90 , V_92 ) ;
F_92 ( & V_179 -> V_91 ) ;
...
struct V_90 , V_91 ) ;
F_33 ( & V_3 -> V_87 -> V_91 ) ;
F_40 ( & V_3 -> V_87 -> V_92 , V_188 ) ;
}
}
static void F_94 ( struct V_177 * V_92 )
{
struct V_76 * V_102 = F_75 ( V_92 -> V_167 ) ;
struct V_2 * V_3 = V_102 -> V_3 ;
struct V_4 * V_5 = V_3 -> V_5 ;
...
V_191 -> V_95 = & V_198 ;
V_191 -> V_199 = & V_200 ;
V_191 -> V_201 = sizeof( struct V_90 ) ;
V_33 = F_100 ( V_191 ) ;
if ( V_33 ) {
F_59 ( & V_5 -> V_104 , L_40 ) ;
F_47 ( V_5 -> V_17 ) ;
...
{
int V_33 ;
V_3 -> V_39 . V_104 = V_223 ;
V_33 = F_117 ( & V_3 -> V_39 , V_224 , - 1 ) ;
if ( V_33 < 0 )
F_3 ( L_54 ,
V_225 , V_33 ) ;
return V_33 ;
