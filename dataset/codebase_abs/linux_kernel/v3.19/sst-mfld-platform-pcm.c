...
F_8 ( V_98 -> V_2 , L_13 ) ;
V_95 = V_96 ;
V_85 = V_15 -> V_82 -> V_131 ( V_8 -> V_2 , V_92 ) ;
break;
default:
return - V_3 ;
}
...
return 0 ;
V_133 = & V_15 -> V_91 ;
V_85 = V_15 -> V_82 -> V_134 ( V_8 -> V_2 , V_133 ) ;
if ( V_85 ) {
F_5 ( V_98 -> V_2 , L_14 , V_85 ) ;
return V_85 ;
}
V_22 -> V_32 -> V_135 = V_133 -> V_136 ;
return V_133 -> V_101 ;
}
static void F_51 ( struct V_137 * V_74 )
{
F_8 ( V_74 -> V_2 , L_15 ) ;
F_52 ( V_74 ) ;
}
...
{
struct V_12 * V_13 = V_98 -> V_138 ;
struct V_137 * V_74 = V_98 -> V_74 ;
int V_139 = 0 ;
if ( V_13 -> V_4 -> V_140 . V_141 ||
V_13 -> V_4 -> V_142 . V_141 ) {
V_139 = F_54 ( V_74 ,
V_143 ,
F_55 ( V_144 ) ,
V_145 , V_146 ) ;
...
static int F_56 ( struct V_147 * V_148 )
{
return F_57 ( V_148 ) ;
}
...
int V_118 ;
struct V_152 * V_69 ;
V_151 = F_59 ( & V_150 -> V_2 , sizeof( * V_151 ) , V_105 ) ;
if ( V_151 == NULL ) {
return - V_106 ;
}
V_69 = F_59 ( & V_150 -> V_2 , sizeof( * V_69 ) , V_105 ) ;
if ( V_69 == NULL ) {
return - V_106 ;
}
V_69 -> V_70 = V_153 ;
V_69 -> V_71 = F_60 ( V_153 ) ;
V_151 -> V_69 = V_69 ;
V_151 -> V_150 = V_150 ;
F_61 ( & V_151 -> V_154 ) ;
F_62 ( & V_150 -> V_2 , V_151 ) ;
V_118 = F_63 ( & V_150 -> V_2 , & V_155 ) ;
if ( V_118 ) {
F_5 ( & V_150 -> V_2 , L_17 ) ;
return V_118 ;
}
V_118 = F_64 ( & V_150 -> V_2 , & V_156 ,
V_157 , F_60 ( V_157 ) ) ;
if ( V_118 ) {
F_5 ( & V_150 -> V_2 , L_18 ) ;
F_65 ( & V_150 -> V_2 ) ;
...
static int F_66 ( struct V_149 * V_150 )
{
F_67 ( & V_150 -> V_2 ) ;
F_65 ( & V_150 -> V_2 ) ;
F_8 ( & V_150 -> V_2 , L_19 ) ;
