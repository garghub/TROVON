...
( V_28 ) sizeof( T_6 ) ;
if ( V_101 + ( V_100 ? 0 : V_16 ) > args -> V_19 -> V_102 )
return 0 ;
if ( V_78 )
return 2 ;
if ( V_101 + V_16 > args -> V_19 -> V_102 )
return 2 ;
* V_98 = V_40 ;
* V_99 = V_79 ;
return 1 ;
...
V_9 ++ , V_40 = V_1 -> V_32 -> V_56 ( V_41 , V_40 ) ) {
V_110 = V_1 -> V_20 -> V_116 -> V_117 ( args , V_40 -> V_25 ,
V_40 -> V_14 ) ;
if ( V_110 != V_118 && V_110 != args -> V_112 ) {
args -> V_112 = V_110 ;
args -> V_26 = V_1 -> V_32 -> V_104 ( V_41 , V_40 ) ;
args -> V_88 = V_1 -> V_32 -> V_105 ( V_40 ) ;
if ( V_110 == V_113 )
return - V_115 ;
V_111 = V_40 ;
}
...
if ( ! V_111 )
return - V_81 ;
error = F_36 ( args , V_111 -> V_25 , V_111 -> V_14 ) ;
return error ;
}
int
F_37 (
...
V_1 = args -> V_1 ;
ASSERT ( V_1 -> V_62 . V_63 & V_65 ) ;
V_122 = ( int ) V_1 -> V_66 . V_74 ;
if ( V_122 < F_24 ( T_3 , V_15 ) ) {
ASSERT ( F_25 ( V_1 -> V_20 ) ) ;
return - V_82 ;
}
ASSERT ( V_1 -> V_62 . V_69 == V_122 ) ;
ASSERT ( V_1 -> V_62 . V_72 . V_73 != NULL ) ;
V_41 = ( T_3 * ) V_1 -> V_62 . V_72 . V_73 ;
ASSERT ( V_122 >= F_8 ( V_41 -> V_10 ) ) ;
for ( V_9 = 0 , V_40 = F_13 ( V_41 ) ; V_9 < V_41 -> V_7 ;
V_9 ++ , V_40 = V_1 -> V_32 -> V_56 ( V_41 , V_40 ) ) {
if ( F_39 ( args , V_40 -> V_25 , V_40 -> V_14 ) ==
V_113 ) {
ASSERT ( V_1 -> V_32 -> V_104 ( V_41 , V_40 ) ==
args -> V_26 ) ;
break;
}
}
...
return - V_81 ;
V_87 = ( int ) ( ( char * ) V_40 - ( char * ) V_41 ) ;
V_120 = V_1 -> V_32 -> V_83 ( V_41 , args -> V_14 ) ;
V_121 = V_122 - V_120 ;
if ( V_87 + V_120 < V_122 )
memmove ( ( char * ) V_41 + V_87 , ( char * ) V_41 + V_87 + V_120 ,
V_122 - ( V_87 + V_120 ) ) ;
V_41 -> V_7 -- ;
V_1 -> V_66 . V_74 = V_121 ;
F_17 ( V_1 , V_121 - V_122 , V_70 ) ;
V_41 = ( T_3 * ) V_1 -> V_62 . V_72 . V_73 ;
if ( args -> V_26 > V_27 ) {
if ( V_41 -> V_10 == 1 )
F_40 ( args ) ;
...
V_1 = args -> V_1 ;
V_122 = V_1 -> V_62 . V_69 ;
V_90 = F_12 ( V_122 , V_44 ) ;
V_96 = ( T_3 * ) V_1 -> V_62 . V_72 . V_73 ;
ASSERT ( V_96 -> V_10 == 1 ) ;
memcpy ( V_90 , V_96 , V_122 ) ;
V_121 =
V_122 -
( V_96 -> V_7 + 1 ) *
...
V_1 -> V_32 -> V_53 ( V_41 , V_40 ,
V_1 -> V_32 -> V_104 ( V_96 , V_95 ) ) ;
V_1 -> V_32 -> V_54 ( V_40 , V_1 -> V_32 -> V_105 ( V_95 ) ) ;
}
F_20 ( V_90 ) ;
V_1 -> V_66 . V_74 = V_121 ;
F_19 ( args -> V_75 , V_1 , V_58 | V_71 ) ;
