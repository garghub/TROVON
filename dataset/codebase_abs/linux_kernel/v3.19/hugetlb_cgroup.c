...
F_32 () ;
V_30 = F_33 ( & V_8 -> V_13 [ V_11 ] , V_21 , & V_23 ) ;
F_34 ( & V_8 -> V_4 ) ;
V_31:
* V_29 = V_8 ;
return V_30 ;
...
{
if ( V_55 >= ( 1UL << 30 ) )
snprintf ( V_49 , V_54 , L_1 , V_55 >> 30 ) ;
else if ( V_55 >= ( 1UL << 20 ) )
snprintf ( V_49 , V_54 , L_2 , V_55 >> 20 ) ;
else
snprintf ( V_49 , V_54 , L_3 , V_55 >> 10 ) ;
return V_49 ;
}
...
V_37 = & V_27 -> V_56 [ 0 ] ;
snprintf ( V_37 -> V_57 , V_58 , L_4 , V_49 ) ;
