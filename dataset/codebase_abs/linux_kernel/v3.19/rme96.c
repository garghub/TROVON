...
{
static const char * const V_231 [ 5 ] = {
L_50 , L_51 , L_52 , L_53 , L_54
} ;
struct V_1 * V_1 = F_97 ( V_224 ) ;
const char * V_232 [ 5 ] = {
V_231 [ 0 ] , V_231 [ 1 ] , V_231 [ 2 ] , V_231 [ 3 ] , V_231 [ 4 ]
} ;
int V_233 ;
...
return F_100 ( V_230 , 1 , V_233 , V_232 ) ;
}
static int
F_101 ( struct V_223 * V_224 , struct V_225 * V_226 )
{
struct V_1 * V_1 = F_97 ( V_224 ) ;
unsigned int V_235 = 3 ;
F_37 ( & V_1 -> V_107 ) ;
V_226 -> V_227 . V_236 . V_237 [ 0 ] = F_24 ( V_1 ) ;
switch ( V_1 -> V_77 -> V_78 ) {
case V_204 :
case V_234 :
V_235 = 3 ;
...
case V_79 :
if ( V_1 -> V_65 > 4 ) {
if ( V_226 -> V_227 . V_236 . V_237 [ 0 ] == V_55 ) {
V_226 -> V_227 . V_236 . V_237 [ 0 ] = V_76 ;
}
V_235 = 4 ;
} else {
V_235 = 5 ;
...
if ( V_226 -> V_227 . V_236 . V_237 [ 0 ] >= V_235 ) {
V_226 -> V_227 . V_236 . V_237 [ 0 ] = V_235 - 1 ;
}
F_39 ( & V_1 -> V_107 ) ;
return 0 ;
}
static int
F_102 ( struct V_223 * V_224 , struct V_225 * V_226 )
{
struct V_1 * V_1 = F_97 ( V_224 ) ;
unsigned int V_17 ;
int V_228 , V_235 = 3 ;
...
V_17 = V_226 -> V_227 . V_236 . V_237 [ 0 ] % V_235 ;
...
static int
F_103 ( struct V_223 * V_224 , struct V_229 * V_230 )
{
static const char * const V_232 [ 3 ] = { L_55 , L_52 , L_56 } ;
return F_100 ( V_230 , 1 , 3 , V_232 ) ;
}
static int
...
struct V_1 * V_1 = F_97 ( V_224 ) ;
F_37 ( & V_1 -> V_107 ) ;
V_226 -> V_227 . V_236 . V_237 [ 0 ] = F_28 ( V_1 ) ;
F_39 ( & V_1 -> V_107 ) ;
return 0 ;
}
static int
F_105 ( struct V_223 * V_224 , struct V_225 * V_226 )
{
struct V_1 * V_1 = F_97 ( V_224 ) ;
unsigned int V_17 ;
int V_228 ;
V_17 = V_226 -> V_227 . V_236 . V_237 [ 0 ] % 3 ;
F_37 ( & V_1 -> V_107 ) ;
...
static int
F_106 ( struct V_223 * V_224 , struct V_229 * V_230 )
{
static const char * const V_232 [ 4 ] = {
L_57 , L_58 , L_59 , L_60
} ;
return F_100 ( V_230 , 1 , 4 , V_232 ) ;
}
static int
...
struct V_1 * V_1 = F_97 ( V_224 ) ;
F_37 ( & V_1 -> V_107 ) ;
V_226 -> V_227 . V_236 . V_237 [ 0 ] = F_20 ( V_1 ) ;
F_39 ( & V_1 -> V_107 ) ;
return 0 ;
}
static int
F_108 ( struct V_223 * V_224 , struct V_225 * V_226 )
{
struct V_1 * V_1 = F_97 ( V_224 ) ;
unsigned int V_17 ;
int V_228 ;
V_17 = V_226 -> V_227 . V_236 . V_237 [ 0 ] % 4 ;
F_37 ( & V_1 -> V_107 ) ;
...
static int
F_109 ( struct V_223 * V_224 , struct V_229 * V_230 )
{
static const char * const V_232 [ 4 ] = { L_61 , L_62 , L_63 , L_64 } ;
return F_100 ( V_230 , 1 , 4 , V_232 ) ;
}
static int
...
struct V_1 * V_1 = F_97 ( V_224 ) ;
F_37 ( & V_1 -> V_107 ) ;
V_226 -> V_227 . V_236 . V_237 [ 0 ] = F_18 ( V_1 ) ;
F_39 ( & V_1 -> V_107 ) ;
return 0 ;
}
static int
F_111 ( struct V_223 * V_224 , struct V_225 * V_226 )
{
struct V_1 * V_1 = F_97 ( V_224 ) ;
unsigned int V_17 ;
int V_228 ;
...
static T_6 F_112 ( struct V_238 * V_239 )
{
T_6 V_17 = 0 ;
...
static void F_113 ( struct V_238 * V_239 , T_6 V_17 )
{
...
static int F_114 ( struct V_223 * V_224 , struct V_229 * V_230 )
{
V_230 -> type = V_245 ;
V_230 -> V_12 = 1 ;
return 0 ;
...
{
struct V_1 * V_1 = F_97 ( V_224 ) ;
F_113 ( & V_226 -> V_227 . V_246 , V_1 -> V_151 ) ;
return 0 ;
}
static int F_116 ( struct V_223 * V_224 , struct V_225 * V_226 )
{
struct V_1 * V_1 = F_97 ( V_224 ) ;
int V_228 ;
T_6 V_17 ;
V_17 = F_112 ( & V_226 -> V_227 . V_246 ) ;
F_37 ( & V_1 -> V_107 ) ;
...
static int F_117 ( struct V_223 * V_224 , struct V_229 * V_230 )
{
V_230 -> type = V_245 ;
V_230 -> V_12 = 1 ;
return 0 ;
...
{
struct V_1 * V_1 = F_97 ( V_224 ) ;
F_113 ( & V_226 -> V_227 . V_246 , V_1 -> V_116 ) ;
return 0 ;
}
static int F_119 ( struct V_223 * V_224 , struct V_225 * V_226 )
{
struct V_1 * V_1 = F_97 ( V_224 ) ;
int V_228 ;
T_6 V_17 ;
...
static int F_120 ( struct V_223 * V_224 , struct V_229 * V_230 )
{
V_230 -> type = V_245 ;
V_230 -> V_12 = 1 ;
return 0 ;
}
static int F_121 ( struct V_223 * V_224 , struct V_225 * V_226 )
{
V_226 -> V_227 . V_246 . V_240 [ 0 ] = V_224 -> V_247 ;
return 0 ;
}
static int
F_122 ( struct V_223 * V_224 , struct V_229 * V_230 )
{
struct V_1 * V_1 = F_97 ( V_224 ) ;
V_230 -> type = V_248 ;
V_230 -> V_12 = 2 ;
V_230 -> V_227 . integer . V_249 = 0 ;
V_230 -> V_227 . integer . V_250 = F_123 ( V_1 ) ;
return 0 ;
}
static int
...
static int
F_125 ( struct V_223 * V_224 , struct V_225 * V_251 )
{
struct V_1 * V_1 = F_97 ( V_224 ) ;
int V_228 = 0 ;
...
if ( ( V_100 = F_126 ( V_156 , V_255 = F_127 ( & V_256 [ V_254 ] , V_1 ) ) ) < 0 )
return V_100 ;
if ( V_254 == 1 )
V_1 -> V_152 = V_255 ;
}
...
if ( ( V_100 = F_126 ( V_156 , F_127 ( & V_256 [ V_254 ] , V_1 ) ) ) < 0 )
return V_100 ;
}
return 0 ;
}
static int F_128 ( struct V_78 * V_193 )
{
struct V_191 * V_77 = F_129 ( V_193 ) ;
struct V_253 * V_156 = F_130 ( V_193 ) ;
...
static int F_135 ( struct V_78 * V_193 )
{
struct V_191 * V_77 = F_129 ( V_193 ) ;
struct V_253 * V_156 = F_130 ( V_193 ) ;
struct V_1 * V_1 = V_156 -> V_183 ;
...
static void F_140 ( struct V_253 * V_156 )
{
F_69 ( V_156 -> V_183 ) ;
}
static int
F_141 ( struct V_191 * V_77 ,
...
V_100 = F_142 ( & V_77 -> V_193 , V_269 [ V_193 ] , V_159 [ V_193 ] , V_270 ,
...
static void F_147 ( struct V_191 * V_77 )
{
F_143 ( F_148 ( V_77 ) ) ;
}
