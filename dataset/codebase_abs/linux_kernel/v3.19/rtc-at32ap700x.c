...
int V_33 ;
int V_9 ;
V_6 = F_19 ( & V_42 -> V_2 , sizeof( struct V_5 ) ,
V_45 ) ;
if ( ! V_6 )
return - V_46 ;
V_44 = F_20 ( V_42 , V_47 , 0 ) ;
if ( ! V_44 ) {
F_21 ( & V_42 -> V_2 , L_1 ) ;
return - V_48 ;
}
...
V_6 -> V_33 = V_33 ;
V_6 -> V_44 = F_23 ( & V_42 -> V_2 , V_44 -> V_49 , F_24 ( V_44 ) ) ;
if ( ! V_6 -> V_44 ) {
F_21 ( & V_42 -> V_2 , L_3 ) ;
return - V_46 ;
}
...
V_9 = F_27 ( & V_42 -> V_2 , V_33 , F_14 , V_53 ,
L_4 , V_6 ) ;
if ( V_9 ) {
F_21 ( & V_42 -> V_2 , L_5 , V_33 ) ;
return V_9 ;
}
F_28 ( V_42 , V_6 ) ;
V_6 -> V_6 = F_29 ( & V_42 -> V_2 , V_42 -> V_54 ,
& V_55 , V_56 ) ;
if ( F_30 ( V_6 -> V_6 ) ) {
F_21 ( & V_42 -> V_2 , L_6 ) ;
return F_31 ( V_6 -> V_6 ) ;
...
static int T_3 F_34 ( struct V_41 * V_42 )
{
F_32 ( & V_42 -> V_2 , 0 ) ;
return 0 ;
}
