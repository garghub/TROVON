...
F_11 ( V_13 , ' ' ) ;
V_45 = F_14 ( V_13 , & V_47 , & V_4 -> V_55 , L_10 ) ;
if ( V_45 )
goto V_53;
F_11 ( V_13 , ' ' ) ;
F_10 ( V_13 , V_19 ) ;
...
F_7 ( V_13 , V_30 ) ;
if ( V_19 -> V_51 -> V_56 )
V_45 = V_19 -> V_51 -> V_56 ( V_13 , V_47 . V_48 ) ;
F_5 ( V_13 , L_14 ) ;
V_53:
return V_45 ;
}
...
goto V_53;
if ( V_19 -> V_51 -> V_56 )
V_45 = V_19 -> V_51 -> V_56 ( V_13 , V_30 -> V_49 ) ;
F_11 ( V_13 , '\n' ) ;
V_53:
return V_45 ;
}
static int F_25 ( struct V_17 * V_13 , struct V_29 * V_30 )
{
struct V_3 * V_4 = V_3 ( V_13 ) ;
struct V_43 * V_44 = F_13 ( V_30 ) ;
struct V_46 V_47 = { . V_48 = V_30 -> V_49 , . V_30 = V_30 } ;
...
static int F_26 ( struct V_69 * V_69 , struct V_1 * V_1 ,
int (* F_27)( struct V_17 * , struct V_29 * ) )
{
struct V_70 * V_71 = F_28 ( V_69 ) ;
struct V_72 * V_73 ;
struct V_6 * V_7 = NULL ;
struct V_46 V_55 ;
struct V_3 * V_4 ;
...
F_31 ( V_71 ) ;
V_74 = - V_80 ;
V_4 = F_34 ( sizeof( struct V_3 ) , V_81 ) ;
if ( ! V_4 )
goto V_82;
V_1 -> V_5 = & V_4 -> V_13 ;
V_74 = F_35 ( V_1 , & V_83 ) ;
...
static int F_39 ( struct V_69 * V_69 , struct V_1 * V_1 )
{
struct V_3 * V_4 = V_3 ( V_1 -> V_5 ) ;
F_37 ( & V_4 -> V_55 ) ;
F_38 ( V_4 -> V_7 ) ;
return F_40 ( V_69 , V_1 ) ;
}
static int F_41 ( struct V_69 * V_69 , struct V_1 * V_1 )
{
return F_26 ( V_69 , V_1 , F_12 ) ;
}
static int F_42 ( struct V_69 * V_69 , struct V_1 * V_1 )
{
return F_26 ( V_69 , V_1 , F_16 ) ;
}
static int F_43 ( struct V_69 * V_69 , struct V_1 * V_1 )
{
return F_26 ( V_69 , V_1 , F_25 ) ;
}
