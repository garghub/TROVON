...
F_53 ( V_18 , NULL , V_76 ) ;
V_18 -> V_78 -> V_79 = & V_80 ;
V_18 -> V_81 = V_18 -> V_82 = V_18 -> V_83 = V_84 ;
F_54 ( V_18 ) ;
V_18 -> V_85 = & V_86 ;
V_18 -> V_87 = & V_88 ;
}
...
static struct V_18 * F_55 ( struct V_18 * V_89 ,
struct V_38 * V_38 ,
T_6 V_76 )
{
struct V_69 * V_70 = V_89 -> V_90 ;
struct V_18 * V_18 = F_51 ( V_70 ) ;
struct V_23 * V_24 ;
if ( ! V_18 )
return NULL ;
...
static int F_59 ( struct V_18 * V_97 ,
struct V_38 * V_38 ,
T_6 V_76 )
{
int V_20 ;
...
struct V_23 * V_24 ;
struct V_101 * V_102 ;
F_9 ( 0 , L_9 , V_99 -> V_103 , V_99 -> V_5 ) ;
if ( V_99 -> V_103 >= V_104 ) {
V_20 = - V_6 ;
F_9 ( V_105 , L_10 ) ;
goto V_28;
}
V_18 = F_55 ( V_97 , V_38 , V_76 | V_77 ) ;
if ( ! V_18 ) {
V_20 = - V_31 ;
F_47 ( V_20 ) ;
goto V_28;
...
static int F_65 ( struct V_18 * V_97 ,
struct V_38 * V_38 ,
T_6 V_76 ,
bool V_106 )
{
int V_20 = 0 ;
struct V_18 * V_18 ;
struct V_98 * V_5 = & V_38 -> V_100 ;
F_9 ( 0 , L_12 , V_5 -> V_103 , V_5 -> V_5 ) ;
if ( V_5 -> V_103 >= V_107 ||
V_5 -> V_5 [ 0 ] == '$' ) {
V_20 = - V_6 ;
F_9 ( V_105 , L_13 , V_5 -> V_103 ,
V_5 -> V_5 ) ;
goto V_28;
}
V_18 = F_55 ( V_97 , V_38 , V_76 | V_92 ) ;
if ( ! V_18 ) {
V_20 = - V_31 ;
F_47 ( V_20 ) ;
goto V_28;
...
static int F_66 ( struct V_18 * V_97 ,
struct V_38 * V_38 )
{
int V_20 ;
struct V_18 * V_18 = V_38 -> V_41 ;
...
V_70 -> V_116 = V_117 ;
V_70 -> V_118 = & V_119 ;
V_70 -> V_120 = F_69 ( F_50 ( V_70 ) ) ;
if ( ! V_70 -> V_120 )
return - V_31 ;
return 0 ;
}
static struct V_38 * F_70 ( struct V_121 * V_122 ,
int V_11 , const char * V_123 , void * V_108 )
{
return F_71 ( V_122 , V_11 , V_108 , F_68 ) ;
}
