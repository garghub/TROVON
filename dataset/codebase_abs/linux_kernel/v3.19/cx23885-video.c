...
F_104 ( & V_6 -> V_125 . V_12 ) ;
F_104 ( & V_6 -> V_251 . V_12 ) ;
F_32 ( V_6 , 0x01 ) ;
if ( ( V_163 != V_6 -> V_162 ) &&
( ( V_6 -> V_252 == 0 ) || ( V_6 -> V_252 == 1 ) ) ) {
struct V_253 * V_254 = NULL ;
if ( V_6 -> V_255 )
V_254 = F_105 ( & V_6 -> V_35 ,
...
F_20 ( V_295 L_47 ,
V_6 -> V_39 , F_112 ( V_6 -> V_245 ) ) ;
V_6 -> V_244 = F_14 ( V_6 , V_6 -> V_32 ,
& V_247 , L_48 ) ;
V_6 -> V_244 -> V_14 = & V_6 -> V_25 ;
V_149 = F_111 ( V_6 -> V_244 , V_166 ,
V_296 [ V_6 -> V_294 ] ) ;
if ( V_149 < 0 ) {
F_20 ( V_295 L_49 ,
V_6 -> V_39 ) ;
