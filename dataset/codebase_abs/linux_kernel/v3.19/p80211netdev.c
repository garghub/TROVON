...
static void F_30 ( T_1 * V_28 )
{
T_2 * V_3 = V_28 -> V_4 ;
if ( V_3 -> V_61 )
V_3 -> V_61 ( V_3 , V_28 ) ;
}
static int F_31 ( T_2 * V_3 , void T_3 * V_62 )
{
T_4 V_63 ;
struct V_64 V_65 ;
struct V_66 V_67 ;
...
static int F_35 ( T_1 * V_28 , struct V_78 * V_79 , int V_70 )
{
int V_2 = 0 ;
...
V_82 = F_37 ( V_81 -> V_34 , V_90 ) ;
if ( V_82 ) {
if ( F_32 ( V_82 , ( void T_3 * ) V_81 -> V_20 , V_81 -> V_34 ) )
V_2 = - V_68 ;
else
V_2 = F_38 ( V_3 , V_82 ) ;
if ( V_2 == 0 ) {
...
static int F_40 ( T_1 * V_28 , void * V_92 )
{
...
static int F_43 ( T_1 * V_28 , int V_120 )
{
...
int F_44 ( T_2 * V_3 , struct V_123 * V_124 )
{
int V_2 = 0 ;
T_1 * V_1 ;
struct V_125 * V_125 ;
...
V_125 = F_47 ( V_124 , V_3 ) ;
if ( V_125 == NULL ) {
F_48 ( V_124 , L_12 ) ;
return 1 ;
}
V_1 = F_49 ( sizeof( struct V_126 ) , L_13 ,
V_129 , V_130 ) ;
if ( V_1 == NULL ) {
F_48 ( V_124 , L_14 ) ;
F_50 ( V_125 ) ;
