...
{
F_19 ( & V_14 -> V_1 . V_56 -> V_57 . V_58 , & V_59 ) ;
F_20 ( V_14 -> V_18 ) ;
V_14 -> V_18 = NULL ;
}
...
int F_22 ( struct V_14 * V_14 , bool V_61 )
{
...
if ( ! V_61 )
return 0 ;
if ( F_4 ( & V_14 -> V_1 , V_63 , & V_62 ) ) {
F_23 ( V_14 , L_2 ) ;
V_62 = 0 ;
}
V_14 -> V_18 = F_24 ( sizeof( struct V_16 ) , V_64 ) ;
if ( ! V_14 -> V_18 )
return - V_65 ;
V_14 -> V_66 = L_3 ;
V_14 -> V_67 = L_4 ;
...
V_14 -> V_69 = F_18 ;
if ( ( V_62 & 0x0f ) >= 3 )
F_25 ( V_70 , V_14 -> V_57 -> V_71 ) ;
F_25 ( V_72 , V_14 -> V_57 -> V_73 ) ;
F_25 ( V_74 , V_14 -> V_57 -> V_73 ) ;
F_16 ( V_14 -> V_18 ) ;
error = F_1 ( & V_14 -> V_1 ) ;
if ( error )
F_14 ( V_14 , false ) ;
error = F_26 ( & V_1 -> V_56 -> V_57 . V_58 , & V_59 ) ;
if ( error ) {
F_27 ( V_14 ,
L_5 ,
error ) ;
