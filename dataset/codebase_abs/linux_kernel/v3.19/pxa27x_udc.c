...
static void F_49 ( struct V_4 * V_90 )
{
unsigned int V_48 ;
...
static struct V_137 *
F_51 ( struct V_138 * V_139 , T_2 V_140 )
{
struct V_46 * V_47 ;
...
F_67 ( V_145 ) ;
F_68 ( & V_47 -> V_91 -> V_138 , & V_47 -> V_47 ) ;
F_69 ( V_145 ) ;
if ( V_144 )
F_70 ( & V_45 -> V_148 , * V_144 ) ;
}
...
unsigned long * V_144 )
{
F_40 ( V_45 -> V_90 , V_150 ) ;
F_71 ( V_45 , V_47 , V_144 ) ;
F_43 ( V_45 -> V_90 ) ;
}
...
static void F_74 ( struct V_44 * V_45 , struct V_46 * V_47 ,
unsigned long * V_144 )
{
F_40 ( V_45 -> V_90 , V_151 ) ;
F_73 ( V_45 , V_47 , V_144 ) ;
}
static void F_75 ( struct V_44 * V_45 , int V_143 )
{
struct V_46 * V_47 ;
unsigned long V_145 ;
F_70 ( & V_45 -> V_148 , V_145 ) ;
while ( ! F_6 ( & V_45 -> V_52 ) ) {
V_47 = F_76 ( V_45 -> V_52 . V_152 , struct V_46 , V_52 ) ;
F_64 ( V_45 , V_47 , V_143 , & V_145 ) ;
}
F_66 ( & V_45 -> V_148 , V_145 ) ;
}
static int F_77 ( struct V_44 * V_45 , struct V_46 * V_47 )
{
T_1 * V_55 ;
int V_153 , V_154 , V_120 , V_48 ;
V_153 = F_36 ( V_45 ) ;
V_154 = V_47 -> V_47 . V_54 - V_47 -> V_47 . V_53 ;
V_55 = ( T_1 * ) ( V_47 -> V_47 . V_55 + V_47 -> V_47 . V_53 ) ;
F_78 ( V_55 ) ;
if ( F_65 ( ! F_37 ( V_45 ) ) )
V_120 = F_79 ( V_153 , V_154 ) ;
else
V_120 = 0 ;
...
static int F_80 ( struct V_44 * V_45 , struct V_46 * V_47 ,
unsigned int V_156 )
{
int V_54 , V_120 , V_157 , V_48 ;
T_1 * V_55 ;
T_3 * V_158 ;
V_55 = ( T_1 * ) ( V_47 -> V_47 . V_55 + V_47 -> V_47 . V_53 ) ;
F_81 ( V_55 ) ;
V_54 = F_79 ( V_47 -> V_47 . V_54 - V_47 -> V_47 . V_53 , V_156 ) ;
V_47 -> V_47 . V_53 += V_54 ;
V_157 = V_54 & 0x3 ;
V_120 = V_54 & ~ ( 0x3 ) ;
for ( V_48 = V_120 ; V_48 > 0 ; V_48 -= 4 )
F_35 ( V_45 , V_155 , * V_55 ++ ) ;
V_158 = ( T_3 * ) V_55 ;
for ( V_48 = V_157 ; V_48 > 0 ; V_48 -- )
F_82 ( V_45 , V_155 , * V_158 ++ ) ;
F_60 ( V_45 , L_46 , V_120 , V_157 ,
F_9 ( V_45 , V_56 ) ) ;
return V_54 ;
}
static int F_83 ( struct V_44 * V_45 , struct V_46 * V_47 )
{
int V_120 , V_159 , V_160 = 0 ;
while ( F_39 ( V_45 ) ) {
V_120 = F_77 ( V_45 , V_47 ) ;
F_45 ( V_45 , V_120 , ! V_149 ) ;
V_159 = ( V_120 < V_45 -> V_51 ) ;
F_42 ( V_45 , L_47 ,
F_9 ( V_45 , V_56 ) , V_120 , V_159 ? L_48 : L_7 ,
& V_47 -> V_47 , V_47 -> V_47 . V_53 , V_47 -> V_47 . V_54 ) ;
if ( V_159 || V_47 -> V_47 . V_53 == V_47 -> V_47 . V_54 ) {
V_160 = 1 ;
break;
}
}
...
{
unsigned V_156 ;
int V_120 , V_159 , V_161 = 0 , V_160 = 0 , V_162 = 0 ;
T_1 V_163 ;
V_156 = V_45 -> V_51 ;
do {
V_159 = 0 ;
...
F_42 ( V_45 , L_51 ,
V_162 , V_161 ? L_52 : L_7 , V_159 ? L_48 : L_7 ,
...
static int F_86 ( struct V_44 * V_45 , struct V_46 * V_47 )
{
unsigned V_120 ;
int V_161 , V_159 ;
V_120 = F_80 ( V_45 , V_47 , V_167 ) ;
F_45 ( V_45 , V_120 , V_149 ) ;
V_159 = ( V_120 < V_167 ) ;
V_161 = ( ( V_120 == 0 ) || ( V_120 < V_167 ) ) ;
if ( F_59 ( V_159 ) )
F_33 ( V_45 , V_62 ) ;
F_42 ( V_45 , L_53 ,
V_120 , V_159 ? L_48 : L_7 , V_161 ? L_52 : L_7 ,
V_47 -> V_47 . V_54 - V_47 -> V_47 . V_53 ,
& V_47 -> V_47 , F_9 ( V_45 , V_56 ) ) ;
return V_161 ;
}
static int F_87 ( struct V_138 * V_139 , struct V_137 * V_142 ,
T_2 V_140 )
{
struct V_91 * V_91 ;
struct V_44 * V_45 ;
...
if ( F_59 ( ! V_142 || ! V_142 -> V_171 || ! V_142 -> V_55 ) )
return - V_172 ;
if ( F_59 ( ! V_139 ) )
return - V_172 ;
V_90 = V_91 -> V_90 ;
...
static int F_91 ( struct V_138 * V_139 , struct V_137 * V_142 )
{
struct V_44 * V_45 ;
struct V_91 * V_91 ;
struct V_46 * V_47 ;
...
static int F_92 ( struct V_138 * V_139 , int V_184 )
{
struct V_44 * V_45 ;
struct V_91 * V_91 ;
unsigned long V_145 ;
...
static void F_99 ( struct V_4 * V_5 , int V_195 )
{
if ( V_5 -> V_196 ) {
F_100 ( V_5 -> V_196 , V_195 ) ;
} else if ( V_5 -> V_197 ) {
if ( V_195 )
V_5 -> V_197 ( V_198 ) ;
else
...
static int F_101 ( struct V_201 * V_202 )
{
struct V_4 * V_5 = F_102 ( V_202 ) ;
...
{
int V_204 ;
V_204 = ( ( V_5 -> V_200 ) && ( V_5 -> V_11 ) ) ;
V_204 &= ( ( V_5 -> V_205 ) || ( F_105 ( V_5 -> V_206 ) ) ) ;
return V_204 ;
}
static int F_106 ( struct V_4 * V_5 )
{
int V_207 ;
V_207 = ( ( ! V_5 -> V_200 ) || ( ! V_5 -> V_11 ) ) ;
V_207 |= ( ( ! V_5 -> V_205 ) && ( ! F_105 ( V_5 -> V_206 ) ) ) ;
return V_207 ;
}
static int F_107 ( struct V_201 * V_202 , int V_208 )
{
struct V_4 * V_5 = F_102 ( V_202 ) ;
if ( ! V_5 -> V_196 && ! V_5 -> V_197 )
return - V_112 ;
F_99 ( V_5 , V_208 ) ;
if ( F_104 ( V_5 ) )
F_108 ( V_5 ) ;
...
static int F_110 ( struct V_201 * V_202 , int V_208 )
{
struct V_4 * V_5 = F_102 ( V_202 ) ;
V_5 -> V_205 = V_208 ;
if ( F_104 ( V_5 ) )
...
static int F_111 ( struct V_201 * V_202 , unsigned V_209 )
{
struct V_4 * V_5 ;
V_5 = F_102 ( V_202 ) ;
if ( ! F_105 ( V_5 -> V_206 ) )
return F_112 ( V_5 -> V_206 , V_209 ) ;
return - V_112 ;
}
...
static void F_114 ( struct V_4 * V_90 )
{
int V_48 ;
struct V_44 * V_45 ;
F_53 ( & V_90 -> V_78 . V_211 ) ;
F_53 ( & V_90 -> V_78 . V_212 -> V_211 ) ;
...
for ( V_48 = 1 ; V_48 < V_104 ; V_48 ++ ) {
F_61 ( & V_90 -> V_91 [ V_48 ] . V_138 . V_211 ,
& V_90 -> V_78 . V_211 ) ;
F_116 ( & V_90 -> V_91 [ V_48 ] . V_138 ,
V_90 -> V_91 [ V_48 ] . V_138 . V_213 ) ;
}
}
...
static int F_120 ( struct V_201 * V_219 ,
struct V_220 * V_11 )
{
struct V_4 * V_5 = F_121 ( V_219 ) ;
int V_221 ;
V_5 -> V_11 = V_11 ;
F_99 ( V_5 , 1 ) ;
if ( ! F_105 ( V_5 -> V_206 ) ) {
V_221 = F_122 ( V_5 -> V_206 -> V_222 ,
& V_5 -> V_78 ) ;
if ( V_221 ) {
F_19 ( V_5 -> V_90 , L_72 ) ;
goto V_223;
...
static void F_123 ( struct V_4 * V_5 , struct V_220 * V_11 )
{
int V_48 ;
...
F_98 ( & V_5 -> V_91 [ V_48 ] . V_138 ) ;
}
static int F_124 ( struct V_201 * V_219 )
{
struct V_4 * V_5 = F_121 ( V_219 ) ;
F_123 ( V_5 , NULL ) ;
F_109 ( V_5 ) ;
...
V_5 -> V_11 = NULL ;
if ( ! F_105 ( V_5 -> V_206 ) )
return F_122 ( V_5 -> V_206 -> V_222 , NULL ) ;
return 0 ;
}
...
if ( F_59 ( F_37 ( V_45 ) ) )
goto V_230;
V_227 . V_226 [ V_48 ] = F_9 ( V_45 , V_155 ) ;
}
V_228 = ! F_37 ( V_45 ) ;
while ( ! F_37 ( V_45 ) ) {
V_48 = F_9 ( V_45 , V_155 ) ;
...
F_42 ( V_45 , L_74 ,
V_227 . V_225 . V_231 , V_227 . V_225 . V_232 ,
F_126 ( V_227 . V_225 . V_233 ) , F_126 ( V_227 . V_225 . V_234 ) ,
F_126 ( V_227 . V_225 . V_235 ) ) ;
if ( F_59 ( V_228 ) )
goto V_230;
if ( V_227 . V_225 . V_231 & V_149 )
F_40 ( V_5 , V_181 ) ;
else
F_40 ( V_5 , V_182 ) ;
F_33 ( V_45 , V_57 | V_63 ) ;
F_66 ( & V_45 -> V_148 , V_145 ) ;
V_48 = V_5 -> V_11 -> V_236 ( & V_5 -> V_78 , & V_227 . V_225 ) ;
F_70 ( & V_45 -> V_148 , V_145 ) ;
if ( V_48 < 0 )
goto V_230;
V_12:
...
F_42 ( V_45 , L_75 ,
F_9 ( V_45 , V_56 ) , V_48 ) ;
F_33 ( V_45 , V_59 | V_237 ) ;
F_40 ( V_5 , V_189 ) ;
goto V_12;
}
static void F_127 ( struct V_4 * V_5 , int V_238 , int V_239 )
{
T_1 V_240 ;
struct V_44 * V_45 = & V_5 -> V_44 [ 0 ] ;
...
V_240 = F_9 ( V_45 , V_56 ) ;
F_42 ( V_45 , L_76 ,
F_41 ( V_5 ) , V_47 , V_240 , F_9 ( V_45 , V_69 ) ,
( V_238 << 1 | V_239 ) ) ;
if ( V_240 & V_60 ) {
F_42 ( V_45 , L_77 ) ;
F_75 ( V_45 , - V_241 ) ;
...
F_33 ( V_45 , V_63 ) ;
if ( V_47 && ! F_38 ( V_45 ) )
V_160 = F_86 ( V_45 , V_47 ) ;
if ( V_160 )
F_74 ( V_45 , V_47 , NULL ) ;
break;
case V_182 :
if ( F_39 ( V_45 ) && V_47 )
V_160 = F_85 ( V_45 , V_47 ) ;
if ( V_160 )
F_72 ( V_45 , V_47 , NULL ) ;
break;
case V_189 :
...
V_47 = F_76 ( V_45 -> V_52 . V_152 ,
struct V_46 , V_52 ) ;
else
V_47 = NULL ;
F_42 ( V_45 , L_79 ,
V_47 , V_163 , V_244 ++ ) ;
if ( F_59 ( V_163 & ( V_190 | V_164 ) ) )
F_35 ( V_45 , V_56 ,
V_163 & ( V_190 | V_164 ) ) ;
if ( ! V_47 )
break;
if ( F_59 ( V_119 ) ) {
if ( F_65 ( ! F_38 ( V_45 ) ) )
V_160 = F_84 ( V_45 , V_47 ) ;
} else {
if ( F_65 ( F_39 ( V_45 ) ) )
V_160 = F_83 ( V_45 , V_47 ) ;
}
if ( V_160 ) {
if ( V_119 )
F_73 ( V_45 , V_47 , & V_145 ) ;
else
F_71 ( V_45 , V_47 , & V_145 ) ;
}
} while ( V_160 );
V_45 -> V_176 = 0 ;
V_170:
...
static void F_128 ( struct V_4 * V_5 , int V_92 )
{
struct V_224 V_47 ;
...
V_47 . V_235 = 0 ;
F_40 ( V_5 , V_179 ) ;
V_5 -> V_11 -> V_236 ( & V_5 -> V_78 , & V_47 ) ;
F_33 ( & V_5 -> V_44 [ 0 ] , V_246 ) ;
}
static void F_129 ( struct V_4 * V_5 , int V_100 , int V_102 )
{
struct V_224 V_47 ;
...
static void F_130 ( int V_249 , struct V_4 * V_5 )
{
int V_48 ;
struct V_44 * V_45 ;
T_1 V_250 = F_3 ( V_5 , V_36 ) & V_251 ;
T_1 V_252 = F_3 ( V_5 , V_37 ) & V_253 ;
if ( V_250 & V_254 ) {
V_5 -> V_44 [ 0 ] . V_39 . V_68 ++ ;
F_29 ( V_5 , V_36 , F_131 ( 0 , V_254 ) ) ;
F_127 ( V_5 , ! ! ( V_250 & V_255 ) ,
! ! ( V_250 & V_256 ) ) ;
}
V_250 >>= 2 ;
for ( V_48 = 1 ; V_250 != 0 && V_48 < 16 ; V_250 >>= 2 , V_48 ++ ) {
if ( ! ( V_250 & V_254 ) )
continue;
F_29 ( V_5 , V_36 , F_131 ( V_48 , V_254 ) ) ;
F_56 ( V_48 >= F_132 ( V_5 -> V_44 ) ) ;
if ( V_48 < F_132 ( V_5 -> V_44 ) ) {
V_45 = & V_5 -> V_44 [ V_48 ] ;
V_45 -> V_39 . V_68 ++ ;
F_90 ( V_45 ) ;
}
}
for ( V_48 = 16 ; V_252 != 0 && V_48 < 24 ; V_252 >>= 2 , V_48 ++ ) {
F_29 ( V_5 , V_37 , F_131 ( V_48 - 16 , V_254 ) ) ;
if ( ! ( V_252 & V_254 ) )
continue;
F_56 ( V_48 >= F_132 ( V_5 -> V_44 ) ) ;
if ( V_48 < F_132 ( V_5 -> V_44 ) ) {
...
V_5 -> V_39 . V_41 ++ ;
if ( V_5 -> V_78 . V_173 != V_174
&& V_5 -> V_11 && V_5 -> V_11 -> V_258 )
V_5 -> V_11 -> V_258 ( & V_5 -> V_78 ) ;
F_43 ( V_5 ) ;
}
...
V_5 -> V_39 . V_42 ++ ;
if ( V_5 -> V_78 . V_173 != V_174
&& V_5 -> V_11 && V_5 -> V_11 -> V_260 )
V_5 -> V_11 -> V_260 ( & V_5 -> V_78 ) ;
}
static void F_135 ( struct V_4 * V_5 )
{
unsigned V_92 , V_93 , V_98 , V_261 ;
T_1 V_109 = F_3 ( V_5 , V_17 ) ;
F_29 ( V_5 , V_37 , V_262 ) ;
V_5 -> V_39 . V_43 ++ ;
...
memset ( & V_5 -> V_39 , 0 , sizeof V_5 -> V_39 ) ;
F_75 ( V_45 , - V_229 ) ;
F_33 ( V_45 , V_237 | V_63 ) ;
F_43 ( V_5 ) ;
}
static T_4 F_138 ( int V_249 , void * V_264 )
{
struct V_4 * V_5 = V_264 ;
T_1 V_250 = F_3 ( V_5 , V_36 ) ;
T_1 V_252 = F_3 ( V_5 , V_37 ) ;
T_1 V_109 = F_3 ( V_5 , V_17 ) ;
T_1 V_265 ;
F_139 ( V_5 -> V_90 , L_84
L_85 , V_250 , V_252 , V_109 ) ;
V_265 = V_252 & 0xf8000000 ;
if ( F_59 ( V_265 & V_257 ) )
F_133 ( V_5 ) ;
if ( F_59 ( V_265 & V_259 ) )
F_134 ( V_5 ) ;
...
if ( F_59 ( V_265 & V_263 ) )
F_136 ( V_5 ) ;
if ( ( V_250 & V_251 ) | ( V_252 & V_253 ) )
F_130 ( V_249 , V_5 ) ;
return V_266 ;
}
static int F_140 ( struct V_267 * V_268 )
{
struct V_269 * V_270 ;
struct V_4 * V_5 = & V_271 ;
int V_221 = 0 , V_272 ;
struct V_273 * V_274 = F_141 ( & V_268 -> V_90 ) ;
unsigned long V_275 ;
if ( V_274 ) {
V_275 = V_274 -> V_276 ? V_277 : 0 ;
V_272 = V_274 -> V_278 ;
if ( F_142 ( V_272 ) ) {
V_221 = F_143 ( & V_268 -> V_90 , V_272 ,
V_275 ,
L_86 ) ;
if ( V_221 )
return V_221 ;
V_5 -> V_196 = F_144 ( V_274 -> V_278 ) ;
}
V_5 -> V_197 = V_274 -> V_197 ;
} else {
V_5 -> V_196 = F_145 ( & V_268 -> V_90 , NULL ) ;
}
V_270 = F_146 ( V_268 , V_279 , 0 ) ;
V_5 -> V_270 = F_147 ( & V_268 -> V_90 , V_270 ) ;
if ( F_16 ( V_5 -> V_270 ) )
return F_148 ( V_5 -> V_270 ) ;
V_5 -> V_249 = F_149 ( V_268 , 0 ) ;
if ( V_5 -> V_249 < 0 )
return V_5 -> V_249 ;
V_5 -> V_90 = & V_268 -> V_90 ;
V_5 -> V_206 = F_150 ( V_280 ) ;
if ( F_16 ( V_5 -> V_196 ) ) {
F_19 ( & V_268 -> V_90 , L_87 ,
F_148 ( V_5 -> V_196 ) ) ;
return F_148 ( V_5 -> V_196 ) ;
}
if ( V_5 -> V_196 )
F_151 ( V_5 -> V_196 , 0 ) ;
V_5 -> V_210 = F_152 ( & V_268 -> V_90 , NULL ) ;
if ( F_16 ( V_5 -> V_210 ) )
return F_148 ( V_5 -> V_210 ) ;
V_221 = F_153 ( V_5 -> V_210 ) ;
if ( V_221 )
return V_221 ;
V_5 -> V_205 = 0 ;
V_281 = V_5 ;
F_154 ( V_268 , V_5 ) ;
F_114 ( V_5 ) ;
V_221 = F_155 ( & V_268 -> V_90 , V_5 -> V_249 , F_138 ,
V_282 , V_14 , V_5 ) ;
if ( V_221 != 0 ) {
F_19 ( V_5 -> V_90 , L_88 ,
V_14 , V_5 -> V_249 , V_221 ) ;
goto V_283;
}
V_221 = F_156 ( & V_268 -> V_90 , & V_5 -> V_78 ) ;
if ( V_221 )
goto V_283;
F_14 ( V_5 ) ;
if ( F_104 ( V_5 ) )
...
static int F_158 ( struct V_267 * V_264 )
{
struct V_4 * V_5 = F_159 ( V_264 ) ;
F_160 ( & V_5 -> V_78 ) ;
F_20 ( V_5 ) ;
F_161 ( V_5 -> V_206 ) ;
V_5 -> V_206 = NULL ;
...
static void F_162 ( struct V_267 * V_264 )
{
struct V_4 * V_5 = F_159 ( V_264 ) ;
if ( F_3 ( V_5 , V_17 ) & V_27 )
F_109 ( V_5 ) ;
}
static int F_163 ( struct V_267 * V_264 , T_5 V_75 )
{
struct V_4 * V_5 = F_159 ( V_264 ) ;
struct V_44 * V_45 ;
V_45 = & V_5 -> V_44 [ 0 ] ;
V_5 -> V_240 = F_9 ( V_45 , V_56 ) ;
F_109 ( V_5 ) ;
V_5 -> V_284 = V_5 -> V_200 ;
F_99 ( V_5 , 0 ) ;
return 0 ;
}
static int F_164 ( struct V_267 * V_264 )
{
struct V_4 * V_5 = F_159 ( V_264 ) ;
struct V_44 * V_45 ;
V_45 = & V_5 -> V_44 [ 0 ] ;
F_35 ( V_45 , V_56 , V_5 -> V_240 & ( V_59 | V_61 ) ) ;
F_99 ( V_5 , V_5 -> V_284 ) ;
if ( F_104 ( V_5 ) )
F_108 ( V_5 ) ;
F_165 () ;
