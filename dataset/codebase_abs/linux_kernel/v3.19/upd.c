...
V_4 -> V_22 = 1 ;
V_4 -> V_34 = V_32 -> V_33 ;
V_4 -> V_23 = F_10 ( V_32 -> V_12 ) ;
if ( ! V_4 -> V_23 )
return - V_25 ;
return 0 ;
}
static int F_17 ( struct V_1 * V_2 , struct V_3 * V_4 , int V_33 ,
void * V_35 , int V_36 , int V_17 )
{
int V_5 ;
if ( V_4 -> V_13 == V_37 ) {
int V_38 = F_18 ( V_36 , V_2 -> V_39 ) ;
memset ( V_35 + V_36 , 0xFF , V_38 - V_36 ) ;
V_36 = F_19 ( V_2 , V_35 , V_38 ) ;
if ( V_36 == 0 ) {
F_2 ( L_6 , V_36 ) ;
return 0 ;
}
V_5 = F_20 ( V_2 , V_4 , V_33 , V_35 , 0 , V_36 ) ;
} else {
memset ( V_35 + V_36 , 0 , V_4 -> V_18 - V_36 ) ;
V_5 = F_21 ( V_2 , V_4 , V_33 , V_35 , V_36 , V_17 ) ;
}
return V_5 ;
}
...
if ( V_36 > V_40 )
V_36 = V_40 ;
V_5 = F_23 ( V_4 -> V_23 + V_41 , V_35 , V_36 ) ;
if ( V_5 )
return - V_45 ;
...
int V_46 = V_41 + V_36 ;
F_3 ( V_46 <= V_4 -> V_18 ) ;
V_5 = F_17 ( V_2 , V_4 , V_33 , V_4 -> V_23 , V_46 ,
V_4 -> V_28 ) ;
if ( V_5 )
return V_5 ;
}
...
V_36 = V_40 ;
V_5 = F_23 ( V_4 -> V_23 , V_35 , V_36 ) ;
if ( V_5 )
return - V_45 ;
if ( V_36 == V_4 -> V_18 ||
V_4 -> V_30 + V_36 == V_4 -> V_29 ) {
V_5 = F_17 ( V_2 , V_4 , V_33 , V_4 -> V_23 ,
V_36 , V_4 -> V_28 ) ;
if ( V_5 )
break;
}
...
if ( V_4 -> V_30 + V_40 > V_4 -> V_29 )
V_40 = V_4 -> V_29 - V_4 -> V_30 ;
V_5 = F_23 ( V_4 -> V_23 + V_4 -> V_30 , V_35 , V_40 ) ;
if ( V_5 )
return - V_45 ;
V_4 -> V_30 += V_40 ;
if ( V_4 -> V_30 == V_4 -> V_29 ) {
int V_36 = F_18 ( ( int ) V_4 -> V_29 , V_2 -> V_39 ) ;
memset ( V_4 -> V_23 + V_4 -> V_29 , 0xFF ,
V_36 - V_4 -> V_29 ) ;
V_36 = F_19 ( V_2 , V_4 -> V_23 , V_36 ) ;
