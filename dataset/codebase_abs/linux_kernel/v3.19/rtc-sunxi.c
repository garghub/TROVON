...
static int F_28 ( struct V_3 * V_4 , int V_55 ,
unsigned int V_39 , unsigned int V_56 )
{
const unsigned long V_57 = V_58 + F_29 ( V_56 ) ;
T_2 V_59 ;
do {
V_59 = F_2 ( V_4 -> V_6 + V_55 ) ;
V_59 &= V_39 ;
if ( V_59 == V_39 )
return 0 ;
} while ( F_30 ( V_58 , V_57 ) );
return - V_60 ;
}
...
int V_61 ;
V_61 = V_41 -> V_37 + 1900 ;
if ( V_61 < V_4 -> V_38 -> V_62 || V_61 > V_4 -> V_38 -> V_63 ) {
F_21 ( V_22 , L_4 ,
V_4 -> V_38 -> V_62 , V_4 -> V_38 -> V_63 ) ;
return - V_51 ;
}
V_41 -> V_37 -= F_14 ( V_4 -> V_38 ) ;
V_41 -> V_36 += 1 ;
...
int V_50 ;
V_4 = F_42 ( & V_69 -> V_22 , sizeof( * V_4 ) , V_74 ) ;
if ( ! V_4 )
return - V_75 ;
F_43 ( V_69 , V_4 ) ;
V_4 -> V_22 = & V_69 -> V_22 ;
V_71 = F_44 ( V_69 , V_76 , 0 ) ;
V_4 -> V_6 = F_45 ( & V_69 -> V_22 , V_71 ) ;
if ( F_46 ( V_4 -> V_6 ) )
return F_47 ( V_4 -> V_6 ) ;
V_4 -> V_1 = F_48 ( V_69 , 0 ) ;
if ( V_4 -> V_1 < 0 ) {
...
V_50 = F_49 ( & V_69 -> V_22 , V_4 -> V_1 , F_1 ,
0 , F_50 ( & V_69 -> V_22 ) , V_4 ) ;
if ( V_50 ) {
F_21 ( & V_69 -> V_22 , L_7 ) ;
return V_50 ;
}
V_73 = F_51 ( V_77 , & V_69 -> V_22 ) ;
if ( ! V_73 ) {
F_21 ( & V_69 -> V_22 , L_8 ) ;
return - V_78 ;
}
V_4 -> V_38 = (struct V_79 * ) V_73 -> V_80 ;
F_3 ( 0 , V_4 -> V_6 + V_30 ) ;
F_3 ( 0 , V_4 -> V_6 + V_17 ) ;
F_3 ( 0 , V_4 -> V_6 + V_19 ) ;
F_3 ( V_8 , V_4 -> V_6 +
V_7 ) ;
V_4 -> V_9 = F_52 ( L_9 , & V_69 -> V_22 ,
& V_81 , V_82 ) ;
if ( F_46 ( V_4 -> V_9 ) ) {
F_21 ( & V_69 -> V_22 , L_10 ) ;
return F_47 ( V_4 -> V_9 ) ;
