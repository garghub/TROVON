...
V_62 = F_34 ( V_59 , V_67 , L_21 ) ;
V_7 -> V_68 = F_35 ( V_13 , V_62 -> V_69 , F_36 ( V_62 ) ) ;
if ( ! V_7 -> V_68 )
return - V_70 ;
V_60 = F_37 ( V_7 ) ;
if ( V_60 ) {
...
struct V_1 * V_8 ;
struct V_33 * V_13 = & V_59 -> V_13 ;
struct V_34 * V_74 = V_13 -> V_36 ;
char V_75 [ 10 ] ;
V_8 = F_39 ( V_13 , sizeof( * V_8 ) , V_76 ) ;
if ( ! V_8 )
return - V_70 ;
V_27 = F_32 ( V_59 , 0 ) ;
if ( V_27 < 0 ) {
...
V_62 = F_34 ( V_59 , V_67 , L_24 ) ;
V_4 = F_40 ( V_13 , V_62 -> V_69 , F_36 ( V_62 ) ) ;
if ( ! V_4 )
return - V_70 ;
V_72 = F_41 ( V_74 , L_25 ) ;
if ( V_72 < 0 ) {
...
V_73 = F_39 ( V_13 , sizeof( * V_73 ) * V_72 , V_76 ) ;
if ( ! V_73 )
return - V_70 ;
for ( V_71 = 0 ; V_71 < V_72 ; V_71 ++ ) {
snprintf ( V_75 , sizeof( V_75 ) , L_27 , V_71 ) ;
V_73 [ V_71 ] = F_42 ( V_13 , V_75 ) ;
if ( F_43 ( V_73 [ V_71 ] ) )
return F_22 ( V_73 [ V_71 ] ) ;
V_60 = F_44 ( V_73 [ V_71 ] ) ;
if ( V_60 < 0 )
goto V_77;
V_60 = F_45 ( V_73 [ V_71 ] ) ;
