...
F_43 ( & V_34 -> V_2 , NULL ) ;
F_14 ( & V_34 -> V_2 ) ;
V_66 = F_45 ( V_34 -> V_75 , V_34 -> V_76 ,
(struct V_77 * ) V_34 ) ;
if ( V_66 ) {
F_17 ( & V_34 -> V_2 , L_24 ) ;
return;
}
if ( V_65 -> V_7 -> V_10 . V_81 == V_83 )
return;
V_74 ( V_65 ) ;
F_46 ( V_7 -> V_34 ) ;
V_65 -> V_7 = NULL ;
...
static int F_51 ( struct V_42 * V_34 , T_3 V_85 )
{
F_17 ( & V_34 -> V_2 , L_25 ) ;
return 0 ;
}
static int F_52 ( struct V_42 * V_34 , T_3 V_85 )
{
F_17 ( & V_34 -> V_2 , L_26 ) ;
return 0 ;
}
