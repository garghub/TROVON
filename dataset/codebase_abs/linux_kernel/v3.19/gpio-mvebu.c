...
static int F_55 ( struct V_69 * V_70 , T_3 V_71 )
{
struct V_1 * V_2 = F_56 ( V_70 ) ;
int V_53 ;
V_2 -> V_72 = F_57 ( F_1 ( V_2 ) ) ;
V_2 -> V_73 = F_57 ( F_3 ( V_2 ) ) ;
V_2 -> V_74 = F_57 ( F_2 ( V_2 ) ) ;
V_2 -> V_75 = F_57 ( F_4 ( V_2 ) ) ;
switch ( V_2 -> V_10 ) {
case V_11 :
V_2 -> V_76 [ 0 ] =
F_57 ( V_2 -> V_3 + V_16 ) ;
...
struct V_1 * V_2 = F_56 ( V_70 ) ;
int V_53 ;
F_59 ( V_2 -> V_72 , F_1 ( V_2 ) ) ;
F_59 ( V_2 -> V_73 , F_3 ( V_2 ) ) ;
F_59 ( V_2 -> V_74 , F_2 ( V_2 ) ) ;
F_59 ( V_2 -> V_75 , F_4 ( V_2 ) ) ;
switch ( V_2 -> V_10 ) {
case V_11 :
F_59 ( V_2 -> V_76 [ 0 ] ,
V_2 -> V_3 + V_16 ) ;
...
int V_10 ;
int V_53 , V_9 , V_88 ;
V_79 = F_61 ( V_89 , & V_70 -> V_82 ) ;
if ( V_79 )
V_10 = ( int ) V_79 -> V_90 ;
else
V_10 = V_11 ;
V_2 = F_62 ( & V_70 -> V_82 , sizeof( struct V_1 ) , V_91 ) ;
if ( ! V_2 )
return - V_92 ;
F_63 ( V_70 , V_2 ) ;
if ( F_64 ( V_70 -> V_82 . V_83 , L_14 , & V_87 ) ) {
F_65 ( & V_70 -> V_82 , L_15 ) ;
return - V_93 ;
}
V_88 = F_66 ( V_70 -> V_82 . V_83 , L_16 ) ;
if ( V_88 < 0 ) {
F_65 ( & V_70 -> V_82 , L_17 ) ;
return V_88 ;
}
V_86 = F_67 ( & V_70 -> V_82 , NULL ) ;
if ( ! F_68 ( V_86 ) )
F_69 ( V_86 ) ;
V_2 -> V_10 = V_10 ;
V_2 -> V_19 . V_66 = F_70 ( & V_70 -> V_82 ) ;
...
V_2 -> V_19 . V_98 = F_20 ;
V_2 -> V_19 . V_99 = F_32 ;
V_2 -> V_19 . V_21 = V_88 * V_100 ;
V_2 -> V_19 . V_54 = V_87 ;
V_2 -> V_19 . V_101 = false ;
V_2 -> V_19 . V_83 = V_81 ;
V_2 -> V_19 . V_102 = F_52 ;
F_71 ( & V_2 -> V_25 ) ;
V_85 = F_72 ( V_70 , V_103 , 0 ) ;
V_2 -> V_3 = F_73 ( & V_70 -> V_82 , V_85 ) ;
if ( F_68 ( V_2 -> V_3 ) )
return F_74 ( V_2 -> V_3 ) ;
if ( V_10 == V_14 ) {
V_85 = F_72 ( V_70 , V_103 , 1 ) ;
V_2 -> V_15 = F_73 ( & V_70 -> V_82 ,
V_85 ) ;
if ( F_68 ( V_2 -> V_15 ) )
return F_74 ( V_2 -> V_15 ) ;
}
switch ( V_10 ) {
case V_11 :
F_24 ( 0 , V_2 -> V_3 + V_13 ) ;
...
V_2 -> V_55 = F_80 ( - 1 , 0 , V_87 , - 1 ) ;
if ( V_2 -> V_55 < 0 ) {
F_65 ( & V_70 -> V_82 , L_18 ) ;
return V_2 -> V_55 ;
}
V_31 = F_81 ( L_19 , 2 , V_2 -> V_55 ,
V_2 -> V_3 , V_104 ) ;
if ( ! V_31 ) {
F_65 ( & V_70 -> V_82 , L_20 ) ;
return - V_92 ;
...
V_38 = & V_31 -> V_105 [ 0 ] ;
V_38 -> type = V_44 | V_46 ;
V_38 -> V_19 . V_106 = F_40 ;
V_38 -> V_19 . V_107 = F_41 ;
V_38 -> V_19 . V_108 = F_42 ;
V_38 -> V_19 . V_109 = V_2 -> V_19 . V_66 ;
V_38 = & V_31 -> V_105 [ 1 ] ;
V_38 -> type = V_43 | V_45 ;
V_38 -> V_19 . V_110 = F_34 ;
V_38 -> V_19 . V_106 = F_38 ;
V_38 -> V_19 . V_107 = F_39 ;
V_38 -> V_19 . V_108 = F_42 ;
V_38 -> V_111 = V_112 ;
V_38 -> V_19 . V_109 = V_2 -> V_19 . V_66 ;
F_82 ( V_31 , F_83 ( V_87 ) , 0 ,
V_113 , V_114 | V_115 ) ;
V_2 -> V_27 = F_84 ( V_81 , V_2 -> V_19 . V_54 ,
V_2 -> V_55 ,
& V_116 ,
V_2 ) ;
if ( ! V_2 -> V_27 ) {
