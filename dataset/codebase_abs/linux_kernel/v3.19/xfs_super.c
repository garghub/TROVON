...
F_120 ( & V_10 -> V_286 ) ;
F_60 ( & V_10 -> V_263 , 0 ) ;
F_121 ( & V_10 -> V_287 , V_288 ) ;
F_121 ( & V_10 -> V_289 , V_290 ) ;
...
V_13 -> V_320 = 1 ;
F_126 ( V_13 ) ;
if ( F_127 ( & V_10 -> V_141 ) == V_321 )
V_13 -> V_26 |= V_322 ;
error = F_128 ( V_10 ) ;
if ( error )
goto V_323;
V_277 = F_129 ( F_59 ( V_10 -> V_324 ) ) ;
if ( ! V_277 ) {
error = - V_325 ;
goto V_326;
}
V_13 -> V_327 = F_130 ( V_277 ) ;
if ( ! V_13 -> V_327 ) {
error = - V_24 ;
goto V_326;
}
...
void * V_284 )
{
return F_132 ( V_329 , V_265 , V_330 , V_284 , F_118 ) ;
}
static long
F_133 (
struct V_12 * V_13 ,
...
int V_331 )
{
return F_136 ( F_74 ( V_13 ) , V_332 ) ;
}
STATIC int T_14
F_137 ( void )
{
V_333 = F_138 ( sizeof( V_334 ) , L_44 ) ;
if ( ! V_333 )
goto V_173;
V_335 = F_139 ( 4 * V_336 ,
V_333 ) ;
if ( ! V_335 )
goto V_337;
V_338 = F_138 ( sizeof( V_339 ) ,
L_45 ) ;
if ( ! V_338 )
goto V_340;
V_341 = F_138 ( sizeof( V_342 ) ,
L_46 ) ;
if ( ! V_341 )
goto V_343;
V_344 = F_138 ( sizeof( V_345 ) ,
L_47 ) ;
if ( ! V_344 )
goto V_346;
V_347 = F_138 ( sizeof( V_348 ) ,
L_48 ) ;
if ( ! V_347 )
goto V_349;
V_350 = F_138 ( sizeof( V_351 ) , L_49 ) ;
if ( ! V_350 )
goto V_352;
V_353 = F_138 ( sizeof( V_354 ) , L_50 ) ;
if ( ! V_353 )
goto V_355;
V_356 =
F_138 ( sizeof( struct V_357 ) ,
L_51 ) ;
if ( ! V_356 )
goto V_358;
V_359 = F_138 ( sizeof( struct V_360 ) ,
L_52 ) ;
if ( ! V_359 )
goto V_361;
V_362 = F_138 ( ( sizeof( V_363 ) +
( ( V_364 - 1 ) *
sizeof( V_365 ) ) ) , L_53 ) ;
if ( ! V_362 )
goto V_366;
V_367 = F_138 ( ( sizeof( V_368 ) +
( ( V_369 - 1 ) *
sizeof( V_365 ) ) ) , L_54 ) ;
if ( ! V_367 )
goto V_370;
V_371 =
F_140 ( sizeof( T_10 ) , L_55 ,
V_372 | V_373 | V_374 ,
F_57 ) ;
if ( ! V_371 )
goto V_375;
V_376 =
F_140 ( sizeof( V_377 ) , L_56 ,
V_374 , NULL ) ;
if ( ! V_376 )
goto V_378;
V_379 = F_138 ( sizeof( struct V_380 ) ,
L_57 ) ;
if ( ! V_379 )
goto V_381;
return 0 ;
...
{
int error ;
F_148 (KERN_INFO XFS_VERSION_STRING L_59
...
if ( error )
goto V_387;
V_294 = F_154 ( L_61 , NULL , V_388 ) ;
if ( ! V_294 ) {
error = - V_24 ;
goto V_389; ;
}
#ifdef F_155
V_390 . V_292 . V_293 = V_294 ;
error = F_156 ( & V_390 , & V_391 , NULL , L_62 ) ;
if ( error )
goto V_392;
#endif
error = F_157 () ;
