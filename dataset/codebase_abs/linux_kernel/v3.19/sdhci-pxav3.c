...
static struct V_26 * F_24 ( struct V_69 * V_9 )
{
struct V_26 * V_27 ;
struct V_70 * V_71 = V_9 -> V_72 ;
T_4 V_30 ;
V_27 = F_25 ( V_9 , sizeof( * V_27 ) , V_73 ) ;
if ( ! V_27 )
return NULL ;
F_26 ( V_71 , L_8 , & V_30 ) ;
if ( V_30 > 0 )
...
static inline struct V_26 * F_24 ( struct V_69 * V_9 )
{
return NULL ;
}
...
struct V_38 * V_39 ;
struct V_26 * V_27 = V_2 -> V_9 . V_28 ;
struct V_69 * V_9 = & V_2 -> V_9 ;
struct V_70 * V_71 = V_2 -> V_9 . V_72 ;
struct V_22 * V_23 = NULL ;
struct V_40 * V_41 = NULL ;
const struct V_74 * V_75 ;
int V_76 ;
V_41 = F_25 ( & V_2 -> V_9 , sizeof( struct V_40 ) , V_73 ) ;
if ( ! V_41 )
return - V_13 ;
...
V_39 = F_17 ( V_23 ) ;
V_39 -> V_42 = V_41 ;
V_41 -> V_78 = F_31 ( V_9 , L_9 ) ;
if ( F_29 ( V_41 -> V_78 ) )
V_41 -> V_78 = F_31 ( V_9 , NULL ) ;
if ( F_29 ( V_41 -> V_78 ) ) {
F_2 ( V_9 , L_10 ) ;
V_76 = F_30 ( V_41 -> V_78 ) ;
goto V_79;
...
V_23 -> V_93 |= V_27 -> V_93 ;
if ( V_27 -> V_94 )
V_23 -> V_25 -> V_83 |= V_27 -> V_94 ;
if ( V_27 -> V_95 )
V_23 -> V_25 -> V_96 |= V_27 -> V_95 ;
if ( V_27 -> V_97 )
V_23 -> V_25 -> V_97 |= V_27 -> V_97 ;
if ( F_39 ( V_27 -> V_98 ) ) {
V_76 = F_40 ( V_23 -> V_25 , V_27 -> V_98 ,
0 ) ;
if ( V_76 ) {
F_2 ( F_12 ( V_23 -> V_25 ) ,
L_13 ) ;
...
F_47 ( V_2 , V_23 ) ;
if ( V_23 -> V_25 -> V_97 & V_102 ) {
F_48 ( & V_2 -> V_9 , 1 ) ;
V_23 -> V_25 -> V_103 |= V_104 ;
} else {
F_48 ( & V_2 -> V_9 , 0 ) ;
}
F_49 ( & V_2 -> V_9 ) ;
...
static int F_63 ( struct V_69 * V_9 )
{
struct V_22 * V_23 = F_58 ( V_9 ) ;
struct V_38 * V_39 = F_17 ( V_23 ) ;
struct V_40 * V_41 = V_39 -> V_42 ;
unsigned long V_87 ;
F_64 ( & V_23 -> V_105 , V_87 ) ;
V_23 -> V_106 = true ;
F_65 ( & V_23 -> V_105 , V_87 ) ;
F_52 ( V_41 -> V_78 ) ;
if ( ! F_29 ( V_41 -> V_81 ) )
F_52 ( V_41 -> V_81 ) ;
return 0 ;
}
static int F_66 ( struct V_69 * V_9 )
{
struct V_22 * V_23 = F_58 ( V_9 ) ;
struct V_38 * V_39 = F_17 ( V_23 ) ;
struct V_40 * V_41 = V_39 -> V_42 ;
