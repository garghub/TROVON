...
if ( V_146 == NULL )
return - V_40 ;
if ( F_84 ( V_146 , & V_147 ) == NULL )
return - V_40 ;
if ( F_85 ( V_146 , & V_147 , & V_148 , L_60 , NULL ) &&
V_148 . V_149 == V_150 ) {
V_81 -> V_100 = F_86 ( V_146 ) ;
} else {
V_81 -> V_100 = F_87 ( V_2 -> V_2 ) ;
}
#endif
V_142 = 0 ;
V_81 -> V_126 = F_88 ( NULL ) ;
if ( ! V_81 -> V_126 )
return - V_46 ;
if ( V_130 -> V_110 ) {
struct V_138 V_151 = {
...
& V_151 , 0 ) ;
if ( V_151 . V_42 ) {
V_36 = F_75 ( & V_81 -> V_27 , & V_152 ) ;
if ( V_36 )
goto V_42;
}
}
while ( ! F_90 ( V_2 -> V_2 , V_142 , & V_143 , & V_144 , NULL , NULL , NULL ) ) {
V_145 = F_81 ( V_2 -> V_2 , V_142 + V_144 , & V_81 -> V_86 ) ;
if ( ! V_145 )
continue;
if ( V_130 -> V_108 )
V_81 -> V_114 = F_91 ( & V_81 -> V_86 , V_130 -> V_108 ) ;
else
V_81 -> V_114 = NULL ;
...
static int F_93 ( T_1 * V_74 , void * V_105 )
{
struct V_153 * V_154 = V_105 ;
struct V_80 * V_81 = V_154 -> V_81 ;
int V_75 ;
V_75 = F_22 ( V_74 ) ;
if ( V_75 == V_41 ||
V_75 == V_155 ) {
if ( F_18 ( V_74 , V_154 -> V_81 -> V_25 ,
V_154 -> V_81 -> V_26 , & V_81 -> V_27 ,
NULL ) == 0 ) {
V_154 -> args [ V_154 -> V_156 ] . V_83 = ( char * ) F_24 ( V_74 ) ;
if ( V_154 -> args [ V_154 -> V_156 ] . V_83 == NULL ) {
V_154 -> V_36 = - V_46 ;
return V_157 ;
}
F_11 ( L_61 , V_154 -> args [ V_154 -> V_156 ] . V_83 ) ;
V_154 -> V_156 ++ ;
}
}
if ( F_94 ( V_74 , V_154 -> V_81 -> V_25 ) )
return V_158 ;
else
return V_159 ;
}
static int F_95 ( T_1 * V_84 , struct V_80 * V_81 ,
struct V_160 * args )
{
T_1 V_74 ;
int V_161 ;
int V_162 = 0 ;
struct V_153 V_154 = { . V_81 = V_81 , . args = args ,
. V_163 = V_164 , . V_36 = 0 } ;
for ( V_161 = 0 ; V_161 < V_81 -> V_112 -> V_156 ; V_161 ++ ) {
if ( strcmp ( V_81 -> V_112 -> args [ V_161 ] . V_83 , L_62 ) == 0 ) {
F_11 ( L_63 ) ;
V_154 . V_156 = V_162 ;
F_96 ( V_84 , F_93 , ( void * ) & V_154 ,
& V_74 ) ;
F_11 ( L_64 , V_154 . V_156 - V_162 ) ;
if ( V_154 . V_36 < 0 )
return V_154 . V_36 ;
V_162 = V_154 . V_156 ;
} else {
args [ V_162 ] = V_81 -> V_112 -> args [ V_161 ] ;
V_162 ++ ;
}
}
return V_162 ;
...
{
struct V_165 * V_166 =
F_98 ( V_81 , struct V_165 , V_81 ) ;
struct V_167 * V_168 ;
struct V_160 * args ;
int V_36 , V_161 ;
if ( V_166 -> V_169 == V_166 -> V_170 ) {
F_26 ( L_65 ,
V_166 -> V_170 ) ;
return - V_57 ;
}
V_168 = & V_166 -> V_171 [ V_166 -> V_169 ++ ] ;
V_36 = F_49 ( & V_81 -> V_27 , V_166 -> V_8 , V_81 -> V_25 ,
V_81 -> V_112 -> V_113 . V_88 , & V_168 -> V_113 ) ;
if ( V_36 < 0 )
return V_36 ;
F_11 ( L_66 , V_168 -> V_113 . V_94 ,
V_168 -> V_113 . V_23 ) ;
args = F_9 ( sizeof( struct V_160 ) * V_164 ) ;
if ( args == NULL )
return - V_46 ;
V_36 = F_95 ( V_84 , V_81 , args ) ;
if ( V_36 < 0 )
goto V_172;
V_168 -> V_156 = V_36 ;
V_168 -> args = F_9 ( sizeof( struct V_28 ) * V_168 -> V_156 ) ;
if ( V_168 -> args == NULL ) {
V_36 = - V_46 ;
goto V_172;
}
for ( V_161 = 0 ; V_161 < V_168 -> V_156 ; V_161 ++ ) {
V_81 -> V_82 = & args [ V_161 ] ;
V_81 -> V_29 = & V_168 -> args [ V_161 ] ;
V_36 = F_45 ( V_84 , V_81 ) ;
if ( V_36 != 0 )
break;
}
...
struct V_173 * V_112 ,
struct V_167 * * V_171 , int V_170 )
{
struct V_165 V_166 = {
. V_81 = { . V_112 = V_112 , . V_103 = F_97 } ,
. V_8 = V_2 -> V_8 , . V_170 = V_170 } ;
int V_36 ;
* V_171 = F_9 ( sizeof( struct V_167 ) * V_170 ) ;
if ( * V_171 == NULL )
return - V_46 ;
V_166 . V_171 = * V_171 ;
V_166 . V_169 = 0 ;
V_36 = F_82 ( V_2 , & V_166 . V_81 ) ;
if ( V_36 < 0 ) {
F_10 ( V_171 ) ;
return V_36 ;
}
return ( V_36 < 0 ) ? V_36 : V_166 . V_169 ;
}
static int F_100 ( T_1 * V_74 , void * V_105 )
{
struct V_174 * V_175 = V_105 ;
struct V_176 * V_177 ;
char V_12 [ V_178 ] ;
int V_75 , V_36 ;
V_177 = & V_175 -> V_179 [ V_175 -> V_180 - 1 ] ;
V_75 = F_22 ( V_74 ) ;
if ( V_75 == V_41 ||
V_75 == V_155 ) {
V_36 = F_18 ( V_74 , V_175 -> V_81 . V_25 ,
V_175 -> V_81 . V_26 , & V_175 -> V_81 . V_27 ,
NULL ) ;
if ( V_36 == 0 ) {
V_36 = F_101 ( V_74 , V_12 , V_178 ) ;
F_39 ( L_67 , V_12 ) ;
if ( V_36 > 0 )
F_102 ( V_177 -> V_181 , V_12 ) ;
}
}
if ( V_175 -> V_182 && F_94 ( V_74 , V_175 -> V_81 . V_25 ) )
return V_158 ;
else
return V_159 ;
}
static int F_103 ( T_1 * V_84 , struct V_80 * V_81 )
{
struct V_174 * V_175 =
F_98 ( V_81 , struct V_174 , V_81 ) ;
struct V_176 * V_177 ;
T_1 V_74 ;
int V_36 ;
if ( V_175 -> V_180 == V_175 -> V_183 ) {
F_26 ( L_65 , V_175 -> V_183 ) ;
return - V_57 ;
}
V_177 = & V_175 -> V_179 [ V_175 -> V_180 ++ ] ;
V_36 = F_49 ( & V_81 -> V_27 , V_175 -> V_8 , V_81 -> V_25 ,
V_81 -> V_112 -> V_113 . V_88 , & V_177 -> V_113 ) ;
if ( V_36 < 0 )
return V_36 ;
F_11 ( L_66 , V_177 -> V_113 . V_94 ,
V_177 -> V_113 . V_23 ) ;
V_177 -> V_181 = F_104 ( true , NULL ) ;
if ( V_177 -> V_181 == NULL )
return - V_46 ;
V_175 -> V_182 = true ;
F_96 ( V_84 , F_100 , ( void * ) V_175 , & V_74 ) ;
if ( ! V_175 -> V_184 )
goto V_17;
V_175 -> V_182 = false ;
F_96 ( & V_81 -> V_86 , F_100 , ( void * ) V_175 , & V_74 ) ;
V_17:
if ( F_105 ( V_177 -> V_181 ) ) {
F_106 ( V_177 -> V_181 ) ;
V_177 -> V_181 = NULL ;
}
return V_36 ;
...
struct V_173 * V_112 ,
struct V_176 * * V_179 ,
int V_183 , bool V_184 )
{
struct V_174 V_175 = {
. V_81 = { . V_112 = V_112 , . V_103 = F_103 } ,
. V_8 = V_2 -> V_8 ,
. V_183 = V_183 , . V_184 = V_184 } ;
int V_36 ;
* V_179 = F_9 ( sizeof( struct V_176 ) * V_183 ) ;
if ( * V_179 == NULL )
return - V_46 ;
V_175 . V_179 = * V_179 ;
V_175 . V_180 = 0 ;
V_36 = F_82 ( V_2 , & V_175 . V_81 ) ;
if ( V_36 < 0 ) {
while ( V_175 . V_180 -- ) {
F_10 ( & V_175 . V_179 [ V_175 . V_180 ] . V_113 . V_94 ) ;
F_106 ( V_175 . V_179 [ V_175 . V_180 ] . V_181 ) ;
}
F_10 ( V_179 ) ;
return V_36 ;
}
return ( V_36 < 0 ) ? V_36 : V_175 . V_180 ;
}
int F_108 ( struct V_1 * V_2 , unsigned long V_25 ,
struct V_129 * V_185 )
{
T_1 V_186 , V_187 , V_188 ;
T_2 V_189 = 0 , V_190 = 0 ;
const char * V_114 = NULL , * V_191 = NULL , * V_192 = NULL , * V_31 ;
int V_193 = 0 , V_116 = 0 , V_36 = 0 ;
V_25 += V_2 -> V_9 ;
if ( ! F_109 ( V_2 -> V_2 , ( T_2 ) V_25 - V_2 -> V_9 , & V_186 ) ) {
F_26 ( L_68 ,
V_25 ) ;
V_36 = - V_40 ;
goto V_172;
}
F_110 ( & V_186 , V_25 , & V_114 , & V_116 ) ;
if ( F_53 ( & V_186 , ( T_2 ) V_25 , & V_187 ) ) {
V_191 = V_192 = F_24 ( & V_187 ) ;
if ( ! V_191 ||
F_21 ( & V_187 , & V_190 ) != 0 ||
F_59 ( & V_187 , & V_193 ) != 0 ) {
V_116 = 0 ;
...
V_114 = F_58 ( & V_187 ) ;
if ( V_25 == ( unsigned long ) V_190 ) {
V_116 = V_193 ;
goto V_194;
}
while ( F_111 ( & V_187 , ( T_2 ) V_25 ,
& V_188 ) ) {
if ( F_21 ( & V_188 , & V_189 ) == 0 &&
V_189 == V_25 ) {
V_116 = F_112 ( & V_188 ) ;
V_114 = F_113 ( & V_188 ) ;
break;
...
V_194:
if ( V_116 )
V_185 -> line = V_116 - V_193 ;
else if ( V_192 ) {
V_185 -> V_23 = V_25 - ( unsigned long ) V_190 ;
V_191 = V_192 ;
}
if ( V_191 ) {
V_185 -> V_110 = F_27 ( V_191 ) ;
if ( V_185 -> V_110 == NULL ) {
V_36 = - V_46 ;
goto V_172;
}
...
V_172:
if ( V_36 == 0 && ( V_114 || V_191 ) )
V_36 = 1 ;
return V_36 ;
}
static int F_114 ( const char * V_195 , unsigned int V_116 ,
struct V_196 * V_197 )
{
if ( ! V_197 -> V_3 ) {
V_197 -> V_3 = F_27 ( V_195 ) ;
if ( V_197 -> V_3 == NULL )
return - V_46 ;
}
return F_69 ( V_197 -> V_198 , V_116 ) ;
}
static int F_115 ( const char * V_114 , int V_116 ,
T_2 V_25 V_199 ,
void * V_105 )
{
struct V_200 * V_201 = V_105 ;
int V_202 ;
if ( ( F_63 ( V_114 , V_201 -> V_114 ) != 0 ) ||
( V_201 -> V_203 > V_116 || V_201 -> V_204 < V_116 ) )
return 0 ;
V_202 = F_114 ( V_114 , V_116 , V_201 -> V_197 ) ;
if ( V_202 < 0 && V_202 != - V_205 )
return V_202 ;
return 0 ;
}
static int F_116 ( T_1 * V_27 , struct V_200 * V_201 )
{
int V_36 ;
V_36 = F_65 ( V_27 ? : & V_201 -> V_86 , F_115 , V_201 ) ;
if ( V_36 >= 0 )
if ( ! F_73 ( V_201 -> V_197 -> V_198 ) )
V_36 = V_201 -> V_42 = 1 ;
else
V_36 = 0 ;
else {
F_10 ( & V_201 -> V_197 -> V_3 ) ;
}
return V_36 ;
}
static int F_117 ( T_1 * V_128 , void * V_105 )
{
int V_36 = F_116 ( V_128 , V_105 ) ;
return V_36 < 0 ? V_36 : 0 ;
}
static int F_118 ( T_1 * V_27 , void * V_105 )
{
struct V_131 * V_132 = V_105 ;
struct V_200 * V_201 = V_132 -> V_105 ;
struct V_196 * V_197 = V_201 -> V_197 ;
if ( V_197 -> V_108 && F_63 ( V_197 -> V_108 , F_58 ( V_27 ) ) )
return V_133 ;
if ( F_52 ( V_27 ) &&
F_34 ( V_27 , V_197 -> V_110 ) ) {
V_201 -> V_114 = F_58 ( V_27 ) ;
F_59 ( V_27 , & V_197 -> V_23 ) ;
F_11 ( L_69 , V_201 -> V_114 , V_197 -> V_23 ) ;
V_201 -> V_203 = V_197 -> V_23 + V_197 -> V_206 ;
if ( V_201 -> V_203 < 0 )
V_201 -> V_203 = V_115 ;
V_201 -> V_204 = V_197 -> V_23 + V_197 -> V_172 ;
if ( V_201 -> V_204 < 0 )
V_201 -> V_204 = V_115 ;
F_11 ( L_70 , V_201 -> V_203 , V_201 -> V_204 ) ;
V_197 -> V_206 = V_201 -> V_203 ;
V_197 -> V_172 = V_201 -> V_204 ;
if ( F_76 ( V_27 ) )
V_132 -> V_134 = F_77 ( V_27 ,
F_117 , V_201 ) ;
else
V_132 -> V_134 = F_116 ( V_27 , V_201 ) ;
return V_135 ;
}
return V_133 ;
}
static int F_119 ( struct V_200 * V_201 )
{
struct V_131 V_132 = { . V_105 = ( void * ) V_201 , . V_134 = 0 } ;
F_79 ( & V_201 -> V_86 , F_118 , & V_132 , 0 ) ;
return V_132 . V_134 ;
}
int F_120 ( struct V_1 * V_2 , struct V_196 * V_197 )
{
struct V_200 V_201 = { . V_197 = V_197 , . V_42 = 0 } ;
int V_36 = 0 ;
T_14 V_142 = 0 , V_143 ;
T_5 V_144 ;
T_1 * V_145 ;
...
if ( V_197 -> V_110 ) {
struct V_138 V_151 = {
. V_110 = V_197 -> V_110 , . V_108 = V_197 -> V_108 ,
. V_86 = & V_201 . V_86 , . V_27 = & V_201 . V_27 , . V_42 = 0 } ;
struct V_131 V_208 = {
. V_105 = ( void * ) & V_201 , . V_134 = 0 } ;
F_89 ( V_2 -> V_2 , F_80 ,
& V_151 , 0 ) ;
if ( V_151 . V_42 ) {
F_118 ( & V_201 . V_27 , & V_208 ) ;
if ( V_201 . V_42 )
goto V_42;
}
}
while ( ! V_201 . V_42 && V_36 >= 0 ) {
if ( F_90 ( V_2 -> V_2 , V_142 , & V_143 , & V_144 ,
NULL , NULL , NULL ) != 0 )
break;
V_145 = F_81 ( V_2 -> V_2 , V_142 + V_144 , & V_201 . V_86 ) ;
if ( ! V_145 )
continue;
if ( V_197 -> V_108 )
V_201 . V_114 = F_91 ( & V_201 . V_86 , V_197 -> V_108 ) ;
else
V_201 . V_114 = 0 ;
if ( ! V_197 -> V_108 || V_201 . V_114 ) {
if ( V_197 -> V_110 )
V_36 = F_119 ( & V_201 ) ;
else {
V_201 . V_203 = V_197 -> V_206 ;
V_201 . V_204 = V_197 -> V_172 ;
V_36 = F_116 ( NULL , & V_201 ) ;
}
}
V_142 = V_143 ;
}
V_42:
if ( V_201 . V_42 ) {
V_207 = F_121 ( & V_201 . V_86 ) ;
if ( V_207 ) {
V_197 -> V_207 = F_27 ( V_207 ) ;
if ( ! V_197 -> V_207 )
V_36 = - V_46 ;
}
}
F_11 ( L_71 , V_197 -> V_3 ) ;
return ( V_36 < 0 ) ? V_36 : V_201 . V_42 ;
}
