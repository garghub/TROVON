...
* V_93 = 0 ;
F_35 (l, &sclp_reg_list) {
V_105 = F_28 ( V_65 , struct V_66 , V_22 ) ;
* V_71 |= V_105 -> V_71 ;
* V_93 |= V_105 -> V_93 ;
}
}
...
V_108 = 0 ;
V_109 = V_13 -> V_69 - sizeof( struct V_61 ) ;
while ( V_109 > 0 ) {
V_109 -= V_63 -> V_69 ;
if ( V_63 -> V_27 & 0x80 ) {
V_13 -> V_69 -= V_63 -> V_69 ;
...
V_51 . V_42 = NULL ;
V_51 . V_13 = V_13 ;
V_13 -> V_114 . V_69 = sizeof( struct V_110 ) ;
...
{
unsigned long V_27 ;
struct V_110 * V_13 = (struct V_110 * ) V_111 ;
T_5 V_71 ;
T_5 V_93 ;
int V_116 ;
int V_7 ;
...
V_7 = - V_16 ;
for ( V_116 = 0 ; V_116 <= V_122 ; V_116 ++ ) {
F_66 ( V_71 , V_93 ) ;
F_16 ( & V_28 , V_27 ) ;
if ( F_30 ( & V_51 ) ) {
V_117 = V_26 + V_32 * V_33 ;
while ( F_20 ( V_26 , V_117 ) )
F_44 () ;
F_15 ( & V_28 , V_27 ) ;
continue;
}
...
static int
F_77 ( struct V_128 * V_129 , unsigned long V_130 , void * V_131 )
{
F_67 () ;
return V_132 ;
}
static void F_78 ( enum F_78 F_78 , int V_133 )
{
struct V_66 * V_67 ;
unsigned long V_27 ;
if ( ! V_133 ) {
...
F_16 ( & V_28 , V_27 ) ;
if ( V_67 -> V_135 )
V_67 -> V_135 ( V_67 , F_78 ) ;
V_67 -> V_106 = V_133 ? 0 : 1 ;
} while ( 1 );
}
...
static int F_82 ( enum F_78 V_130 )
{
unsigned long V_27 ;
int V_7 ;
V_7 = F_68 () ;
...
static int F_84 ( struct V_136 * V_137 )
{
return F_82 ( V_142 ) ;
}
static T_7 F_85 ( struct V_143 * V_137 , char * V_144 )
{
return sprintf ( V_144 , L_2 , V_9 ) ;
}
static T_7 F_86 ( struct V_143 * V_137 , char * V_144 )
{
return sprintf ( V_144 , L_2 , V_11 ) ;
}
static T_7 F_87 ( struct V_143 * V_137 , char * V_144 )
{
return sprintf ( V_144 , L_3 , V_145 ) ;
}
static int
F_62 ( void )
{
...
static int F_92 ( struct V_128 * V_153 ,
unsigned long V_130 , void * V_3 )
{
if ( V_52 == V_139 )
F_82 ( V_141 ) ;
return V_154 ;
