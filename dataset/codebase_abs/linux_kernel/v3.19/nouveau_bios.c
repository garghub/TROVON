...
V_142 -> V_204 . V_207 = ( V_189 & 0x0f000000 ) >> 24 ;
if ( V_174 -> V_124 < 0x41 ) {
switch ( V_142 -> V_204 . V_207 ) {
case 0xf :
V_142 -> V_204 . V_207 = 4 ;
break;
case 0x3 :
...
static bool
F_57 ( struct V_15 * V_16 , struct V_183 * V_174 ,
T_3 V_188 , T_3 V_189 , struct V_17 * V_142 )
{
struct V_21 * V_22 = V_21 ( V_16 ) ;
...
static
void F_58 ( struct V_15 * V_16 , struct V_183 * V_174 )
{
struct V_21 * V_22 = V_21 ( V_16 ) ;
int V_3 , V_216 = 0 ;
...
static bool
F_59 ( struct V_15 * V_16 , int V_176 , T_5 * V_188 , T_5 * V_189 )
{
struct V_21 * V_22 = V_21 ( V_16 ) ;
struct V_183 * V_174 = & V_22 -> V_28 . V_174 ;
if ( F_60 ( V_16 , 0x040d , 0x1028 , 0x019b ) ) {
if ( * V_188 == 0x02026312 && * V_189 == 0x00000020 )
return false ;
}
if ( F_60 ( V_16 , 0x0201 , 0x1462 , 0x8851 ) ) {
if ( * V_188 == 0xf2005014 && * V_189 == 0xffffffff ) {
F_54 ( V_174 , V_208 , 1 , 1 , 1 ) ;
return false ;
}
}
if ( F_60 ( V_16 , 0x0ca3 , 0x1682 , 0x3003 ) ) {
if ( V_176 == 0 ) {
* V_188 = 0x02001300 ;
* V_189 = 0x00000028 ;
} else
...
if ( F_60 ( V_16 , 0x0615 , 0x1682 , 0x2605 ) ) {
if ( V_176 == 0 ) {
* V_188 = 0x02002300 ;
* V_189 = 0x00000028 ;
} else
...
if ( F_60 ( V_16 , 0x0421 , 0x3842 , 0xc793 ) ) {
...
static void
F_61 ( struct V_15 * V_16 , struct V_5 * V_6 )
{
struct V_183 * V_174 = & V_6 -> V_174 ;
int V_219 = ( F_62 ( V_16 ) ? 3 : 1 ) ;
#ifdef F_11
if ( F_63 ( L_45 ) ) {
...
if ( F_64 ( V_16 , V_6 -> V_111 . V_166 . V_168 ) >= 0 )
F_54 ( V_174 , V_200 ,
...
static int
F_65 ( struct V_15 * V_16 , void * V_1 , int V_176 , T_4 * V_179 )
{
struct V_21 * V_22 = V_21 ( V_16 ) ;
struct V_183 * V_174 = & V_22 -> V_28 . V_174 ;
...
T_4 V_221 [ 16 ] = { } ;
int V_3 , V_176 = 0 ;
if ( ! F_60 ( V_6 -> V_16 , 0x0392 , 0x107d , 0x20a2 ) ) {
...
F_5 ( V_22 , L_48 , V_176 ) ;
if ( F_51 ( V_16 ) [ 3 ] < 4 )
F_68 ( L_49 , F_3 ( V_188 [ 0 ] ) ) ;
else
F_68 ( L_50 , F_32 ( V_188 [ 0 ] ) ) ;
}
}
F_66 ( V_6 ) ;
return 0 ;
}
static int F_69 ( struct V_15 * V_16 , struct V_5 * V_6 , T_2 V_223 , int V_142 )
{
struct V_21 * V_22 = V_21 ( V_16 ) ;
struct V_55 * V_41 = & V_22 -> V_41 ;
T_1 V_224 ;
...
if ( ! V_223 )
return 0 ;
return F_69 ( V_16 , V_6 , V_223 + V_228 , 0 ) ;
}
T_1 * F_71 ( struct V_15 * V_16 )
{
struct V_21 * V_22 = V_21 ( V_16 ) ;
struct V_5 * V_6 = & V_22 -> V_28 ;
const T_1 V_229 [] = {
...
{
struct V_21 * V_22 = V_21 ( V_16 ) ;
struct V_235 * V_6 = F_73 ( & V_22 -> V_41 ) ;
...
return true ;
V_93 = F_77 ( V_16 , 0 , 0x06 ) ;
V_93 |= ( F_77 ( V_16 , 0 , 0x07 ) & 0x01 ) << 8 ;
V_93 |= ( F_77 ( V_16 , 0 , 0x07 ) & 0x20 ) << 4 ;
V_93 |= ( F_77 ( V_16 , 0 , 0x25 ) & 0x01 ) << 10 ;
V_93 |= ( F_77 ( V_16 , 0 , 0x41 ) & 0x01 ) << 11 ;
return ( V_93 != 0 ) ;
}
int
...
return V_59 ;
if ( V_6 -> V_12 < 5 )
V_6 -> V_82 = F_77 ( V_16 , 0 , V_245 ) & 0x40 ;
