...
V_53 = F_26 ( V_43 , V_60 , 0 ) ;
if ( ! V_53 ) {
V_54 = - V_59 ;
goto V_58;
}
V_53 = F_27 ( V_53 -> V_61 , F_28 ( V_53 ) , V_43 -> V_62 ) ;
if ( ! V_53 ) {
V_54 = - V_63 ;
goto V_58;
}
V_4 -> V_10 = F_29 ( V_53 -> V_61 , F_28 ( V_53 ) ) ;
if ( V_4 -> V_10 == NULL ) {
V_54 = - V_59 ;
goto V_64;
}
...
V_5 -> V_71 = F_8 ;
V_5 -> V_72 = F_11 ;
V_5 -> V_46 . V_73 = & V_43 -> V_46 ;
V_54 = F_35 ( V_51 , NULL ,
V_74 , V_75 ,
V_4 -> V_14 , V_5 ) ;
if ( V_54 )
goto V_76;
if ( V_4 -> V_21 -> V_23 & V_77 )
F_36 ( V_78 , V_5 -> V_79 ) ;
F_37 ( V_5 , V_4 ) ;
V_54 = F_38 ( V_4 -> V_1 , F_1 ,
0 , V_43 -> V_62 , V_4 ) ;
if ( V_54 )
goto V_76;
V_54 = F_39 ( V_5 ) ;
...
F_46 ( V_4 -> V_10 ) ;
V_64:
F_47 ( V_53 -> V_61 , F_28 ( V_53 ) ) ;
V_58:
F_48 ( V_4 ) ;
return V_54 ;
}
static int F_49 ( struct V_47 * V_43 )
{
struct V_3 * V_4 = F_15 ( V_43 ) ;
struct V_52 * V_53 ;
F_42 ( V_4 -> V_1 , V_4 ) ;
