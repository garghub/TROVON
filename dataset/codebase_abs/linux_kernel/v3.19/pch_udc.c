...
V_2 -> V_254 . V_259 = F_140 ( V_2 -> V_181 . V_84 ) ;
V_2 -> V_254 . V_260 = F_140 ( V_2 -> V_181 . V_82 ) ;
V_3 = F_16 ( V_2 , V_225 ) ;
V_3 = ( V_3 & ~ V_261 ) |
( V_2 -> V_181 . V_82 << V_83 ) ;
V_3 = ( V_3 & ~ V_262 ) |
...
V_2 -> V_254 . V_259 = F_140 ( V_2 -> V_181 . V_80 ) ;
V_3 = F_16 ( V_2 , V_225 ) ;
V_3 = ( V_3 & ~ V_267 ) |
( V_2 -> V_181 . V_80 << V_81 ) ;
F_14 ( V_2 , V_3 , V_225 ) ;
...
static void F_142 ( struct V_1 * V_2 , T_1 V_268 )
{
int V_111 ;
if ( V_268 & V_25 ) {
F_135 ( V_2 ) ;
...
static T_3 F_143 ( int V_123 , void * V_13 )
{
...
static void F_145 ( struct V_273 * V_13 )
{
...
F_148 ( & V_2 -> V_8 [ V_168 ] . V_8 , V_229 ) ;
F_148 ( & V_2 -> V_8 [ V_225 ] . V_8 , V_232 ) ;
F_149 ( & V_2 -> V_8 [ V_168 ] . V_8 . V_275 ) ;
F_149 ( & V_2 -> V_8 [ V_225 ] . V_8 . V_275 ) ;
...
static int F_155 ( struct V_104 * V_284 )
{
struct V_1 * V_2 = F_154 ( V_284 ) ;
F_42 ( V_2 , V_91 ) ;
V_2 -> V_29 = NULL ;
...
static void F_158 ( struct V_288 * V_13 )
{
struct V_1 * V_2 = F_157 ( V_13 ) ;
F_159 ( & V_2 -> V_32 ) ;
if ( V_2 -> V_29 )
...
if ( V_2 -> V_290 )
F_163 ( V_2 -> V_291 ,
F_164 ( V_13 , V_2 -> V_292 ) ) ;
if ( V_2 -> V_293 )
F_165 ( V_13 ) ;
F_113 ( V_2 ) ;
}
static int F_166 ( struct V_288 * V_13 , T_6 V_294 )
{
struct V_1 * V_2 = F_157 ( V_13 ) ;
F_42 ( V_2 , V_91 ) ;
F_44 ( V_2 , V_92 ) ;
...
F_169 ( V_13 , F_170 ( V_13 , V_294 ) ) ;
return 0 ;
}
static int F_171 ( struct V_288 * V_13 )
{
int V_195 ;
F_169 ( V_13 , V_296 ) ;
F_172 ( V_13 ) ;
...
static int F_174 ( struct V_288 * V_13 ,
...
V_2 -> V_293 = 1 ;
F_175 ( V_13 , V_2 ) ;
if ( V_298 -> V_273 == V_301 )
V_2 -> V_292 = V_302 ;
else
V_2 -> V_292 = V_303 ;
V_299 = F_176 ( V_13 , V_2 -> V_292 ) ;
V_150 = F_164 ( V_13 , V_2 -> V_292 ) ;
if ( ! F_177 ( V_299 , V_150 , V_304 ) ) {
...
if ( F_90 ( V_13 -> V_123 , F_143 , V_307 , V_304 ,
V_2 ) ) {
...
if ( V_161 )
goto V_306;
V_2 -> V_32 . V_174 = V_304 ;
V_2 -> V_32 . V_309 = V_241 ;
F_22 ( V_2 ) ;
V_161 = F_182 ( & V_13 -> V_2 , & V_2 -> V_32 ,
F_145 ) ;
if ( V_161 )
goto V_306;
return 0 ;
