...
F_2 ( F_32 ( V_16 -> V_28 , 0 , 0 , - 1 ) ) ;
F_2 ( F_33 ( V_16 -> V_28 , 0 ,
! ! F_34 ( V_16 -> V_17 ) ,
F_35 () ,
F_6 ( V_4 ) ,
false ) ) ;
...
F_14 ( V_10 ) ;
F_2 ( F_32 ( V_16 -> V_28 , 0 , V_16 -> V_29 , - 1 ) ) ;
V_27 = V_16 -> V_17 ;
V_16 -> V_17 = * V_16 -> V_18 ;
* V_16 -> V_18 = NULL ;
...
static void F_47 ( struct V_25 * V_36 ,
void (* F_48)( struct V_25 * V_37 ) ,
struct V_15 * V_16 )
{
unsigned long V_10 ;
F_49 ( V_36 ) ;
...
void F_50 ( struct V_25 * V_36 , void (* F_48)( struct V_25 * V_37 ) )
{
F_47 ( V_36 , F_48 , & V_20 ) ;
}
void F_51 ( struct V_25 * V_36 , void (* F_48)( struct V_25 * V_37 ) )
{
F_47 ( V_36 , F_48 , & V_21 ) ;
}
void T_3 F_52 ( void )
