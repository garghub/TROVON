...
if ( F_48 ( & V_86 , V_84 , V_88 ) ) {
V_72 = - V_93 ;
goto V_94;
} else if ( ( V_86 . V_9 != V_95 ) &&
( V_86 . V_9 != V_96 ) ) {
V_72 = - V_44 ;
goto V_94;
}
...
( V_86 . V_12 < V_31 -> V_45 ) ) {
V_86 . V_12 = V_31 -> V_45 ;
V_72 = F_49 ( V_84 , & V_86 , V_88 ) ;
V_72 = - V_97 ;
goto V_94;
}
V_72 = F_12 ( exp , & V_87 , V_31 ) ;
if ( V_72 < 0 )
goto V_94;
V_40 = V_72 ;
V_72 = 0 ;
F_50 ( sizeof( V_86 ) == sizeof( struct V_23 ) ) ;
F_50 ( sizeof( V_86 . V_22 [ 0 ] ) == sizeof( V_87 -> V_22 [ 0 ] ) ) ;
if ( ( F_21 ( V_43 ) != V_43 ) &&
( ( V_87 -> V_9 == F_21 ( V_27 ) ) ||
( V_87 -> V_9 == F_21 ( V_28 ) ) ) ) {
F_51 ( V_87 ) ;
