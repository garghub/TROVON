...
static int
F_19 ( struct V_7 * V_8 , int V_35 , int V_36 )
{
struct V_30 * V_31 = F_20 ( V_8 ) ;
int V_24 = F_18 ( V_35 ) ;
int V_6 ;
F_21 ( & V_31 -> V_34 ) ;
V_6 = F_22 ( V_8 , V_24 , V_36 ) ;
F_23 ( & V_31 -> V_34 ) ;
return V_6 ;
}
static int
F_24 ( struct V_7 * V_8 ,
int V_35 , int V_36 , T_1 V_25 )
{
struct V_30 * V_31 = F_20 ( V_8 ) ;
int V_24 = F_18 ( V_35 ) ;
int V_6 ;
F_21 ( & V_31 -> V_34 ) ;
V_6 = F_25 ( V_8 , V_24 , V_36 , V_25 ) ;
F_23 ( & V_31 -> V_34 ) ;
return V_6 ;
}
static void
