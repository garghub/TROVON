...
F_3 ( V_13 ) ;
if ( V_53 -> V_152 -> V_114 >= V_153 )
V_91 = V_53 -> V_152 -> V_502 . V_503 . V_504 ;
else
V_91 = V_53 -> V_152 -> V_502 . V_505 . V_504 ;
switch ( V_91 & 0xf ) {
case 0 :
V_13 -> V_76 = 1 ;
break;
...
} while ( V_53 -> V_105 < V_53 -> V_510 -> V_511 );
#if 0
...
{
struct V_512 * V_513 = V_53 -> V_510 ;
struct V_148 * V_514 , * V_515 , * V_516 ;
T_1 V_517 , V_518 , V_147 , V_519 ;
volatile T_1 * V_89 = V_53 -> V_89 . V_90 ;
T_1 V_105 ;
T_2 V_520 , V_521 , V_522 ;
int V_87 ;
do {
if ( V_53 -> V_105 >= V_513 -> V_511 ) {
F_64 ( L_120 ,
V_53 -> V_105 , V_513 -> V_511 ) ;
return - V_68 ;
}
V_105 = V_53 -> V_105 ;
V_517 = F_43 ( V_53 , V_105 ) ;
V_518 = F_105 ( V_517 ) ;
V_147 = F_106 ( V_517 ) ;
V_519 = F_107 ( V_517 ) ;
switch ( V_518 ) {
...
V_521 <<= 8 ;
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_515 -> V_188 >> 8 ) ;
V_53 -> V_105 += V_147 + 7 ;
break;
case 0 :
V_521 = F_43 ( V_53 , V_105 + 1 ) ;
V_521 |= ( ( T_2 ) ( F_43 ( V_53 , V_105 + 2 ) & 0xff ) ) << 32 ;
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_515 -> V_188 & 0xfffffffc ) ;
V_89 [ V_105 + 2 ] += F_91 ( V_515 -> V_188 ) & 0xff ;
V_53 -> V_105 += V_147 + 3 ;
break;
default:
F_64 ( L_122 , V_105 , V_517 ) ;
return - V_68 ;
}
if ( ( V_521 + ( V_147 * 4 ) ) > F_23 ( V_515 -> V_202 ) ) {
F_7 ( V_53 -> V_66 , L_123 ,
V_521 , F_23 ( V_515 -> V_202 ) ) ;
return - V_68 ;
}
break;
case V_524 :
V_87 = F_108 ( V_53 , & V_514 ) ;
if ( V_87 ) {
F_64 ( L_124 ) ;
return - V_68 ;
}
...
switch ( V_519 ) {
case 0x00 :
V_520 = F_43 ( V_53 , V_105 + 2 ) ;
V_520 |= ( ( T_2 ) ( F_43 ( V_53 , V_105 + 4 ) & 0xff ) ) << 32 ;
V_521 = F_43 ( V_53 , V_105 + 1 ) ;
V_521 |= ( ( T_2 ) ( F_43 ( V_53 , V_105 + 3 ) & 0xff ) ) << 32 ;
if ( ( V_520 + ( V_147 * 4 ) ) > F_23 ( V_514 -> V_202 ) ) {
F_7 ( V_53 -> V_66 , L_125 ,
V_520 + ( V_147 * 4 ) , F_23 ( V_514 -> V_202 ) ) ;
return - V_68 ;
}
if ( ( V_521 + ( V_147 * 4 ) ) > F_23 ( V_515 -> V_202 ) ) {
F_7 ( V_53 -> V_66 , L_126 ,
V_521 + ( V_147 * 4 ) , F_23 ( V_515 -> V_202 ) ) ;
return - V_68 ;
}
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_515 -> V_188 & 0xfffffffc ) ;
V_89 [ V_105 + 2 ] += ( T_1 ) ( V_514 -> V_188 & 0xfffffffc ) ;
V_89 [ V_105 + 3 ] += F_91 ( V_515 -> V_188 ) & 0xff ;
V_89 [ V_105 + 4 ] += F_91 ( V_514 -> V_188 ) & 0xff ;
V_53 -> V_105 += 5 ;
break;
case 0x08 :
if ( F_43 ( V_53 , V_105 + 2 ) & ( 1 << 31 ) ) {
V_520 = F_43 ( V_53 , V_105 + 1 ) ;
V_520 <<= 8 ;
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_514 -> V_188 >> 8 ) ;
V_521 = F_43 ( V_53 , V_105 + 7 ) ;
V_521 |= ( ( T_2 ) ( F_43 ( V_53 , V_105 + 8 ) & 0xff ) ) << 32 ;
V_89 [ V_105 + 7 ] += ( T_1 ) ( V_515 -> V_188 & 0xfffffffc ) ;
V_89 [ V_105 + 8 ] += F_91 ( V_515 -> V_188 ) & 0xff ;
} else {
V_520 = F_43 ( V_53 , V_105 + 7 ) ;
V_520 |= ( ( T_2 ) ( F_43 ( V_53 , V_105 + 8 ) & 0xff ) ) << 32 ;
V_89 [ V_105 + 7 ] += ( T_1 ) ( V_514 -> V_188 & 0xfffffffc ) ;
V_89 [ V_105 + 8 ] += F_91 ( V_514 -> V_188 ) & 0xff ;
V_521 = F_43 ( V_53 , V_105 + 1 ) ;
V_521 <<= 8 ;
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_515 -> V_188 >> 8 ) ;
}
...
V_521 = F_43 ( V_53 , V_105 + 1 ) ;
V_521 |= ( ( T_2 ) ( F_43 ( V_53 , V_105 + 3 ) & 0xff ) ) << 32 ;
if ( ( V_520 + V_147 ) > F_23 ( V_514 -> V_202 ) ) {
F_7 ( V_53 -> V_66 , L_129 ,
V_520 + V_147 , F_23 ( V_514 -> V_202 ) ) ;
return - V_68 ;
}
if ( ( V_521 + V_147 ) > F_23 ( V_515 -> V_202 ) ) {
F_7 ( V_53 -> V_66 , L_130 ,
V_521 + V_147 , F_23 ( V_515 -> V_202 ) ) ;
return - V_68 ;
}
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_515 -> V_188 & 0xffffffff ) ;
V_89 [ V_105 + 2 ] += ( T_1 ) ( V_514 -> V_188 & 0xffffffff ) ;
V_89 [ V_105 + 3 ] += F_91 ( V_515 -> V_188 ) & 0xff ;
V_89 [ V_105 + 4 ] += F_91 ( V_514 -> V_188 ) & 0xff ;
V_53 -> V_105 += 5 ;
break;
...
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_514 -> V_188 & 0xffffffff ) ;
V_89 [ V_105 + 2 ] += F_91 ( V_514 -> V_188 ) & 0xff ;
V_89 [ V_105 + 4 ] += ( T_1 ) ( V_515 -> V_188 & 0xffffffff ) ;
V_89 [ V_105 + 5 ] += F_91 ( V_515 -> V_188 ) & 0xff ;
V_53 -> V_105 += 9 ;
break;
case 0x44 :
...
V_522 = F_43 ( V_53 , V_105 + 2 ) ;
V_522 |= ( ( T_2 ) ( F_43 ( V_53 , V_105 + 5 ) & 0xff ) ) << 32 ;
V_520 = F_43 ( V_53 , V_105 + 3 ) ;
V_520 |= ( ( T_2 ) ( F_43 ( V_53 , V_105 + 6 ) & 0xff ) ) << 32 ;
if ( ( V_520 + ( V_147 * 4 ) ) > F_23 ( V_514 -> V_202 ) ) {
F_7 ( V_53 -> V_66 , L_133 ,
V_520 + ( V_147 * 4 ) , F_23 ( V_514 -> V_202 ) ) ;
return - V_68 ;
...
if ( ( V_522 + ( V_147 * 4 ) ) > F_23 ( V_516 -> V_202 ) ) {
F_7 ( V_53 -> V_66 , L_135 ,
V_522 + ( V_147 * 4 ) , F_23 ( V_516 -> V_202 ) ) ;
return - V_68 ;
}
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_515 -> V_188 & 0xfffffffc ) ;
V_89 [ V_105 + 2 ] += ( T_1 ) ( V_516 -> V_188 & 0xfffffffc ) ;
V_89 [ V_105 + 3 ] += ( T_1 ) ( V_514 -> V_188 & 0xfffffffc ) ;
V_89 [ V_105 + 4 ] += F_91 ( V_515 -> V_188 ) & 0xff ;
V_89 [ V_105 + 5 ] += F_91 ( V_516 -> V_188 ) & 0xff ;
V_89 [ V_105 + 6 ] += F_91 ( V_514 -> V_188 ) & 0xff ;
V_53 -> V_105 += 7 ;
break;
case 0x48 :
if ( F_43 ( V_53 , V_105 + 2 ) & ( 1 << 31 ) ) {
...
V_522 = F_43 ( V_53 , V_105 + 2 ) ;
V_522 <<= 8 ;
V_520 = F_43 ( V_53 , V_105 + 8 ) ;
V_520 |= ( ( T_2 ) ( F_43 ( V_53 , V_105 + 9 ) & 0xff ) ) << 32 ;
if ( ( V_520 + ( V_147 * 4 ) ) > F_23 ( V_514 -> V_202 ) ) {
F_7 ( V_53 -> V_66 , L_137 ,
V_520 + ( V_147 * 4 ) , F_23 ( V_514 -> V_202 ) ) ;
return - V_68 ;
...
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_515 -> V_188 >> 8 ) ;
V_89 [ V_105 + 2 ] += ( T_1 ) ( V_516 -> V_188 >> 8 ) ;
V_89 [ V_105 + 8 ] += ( T_1 ) ( V_514 -> V_188 & 0xfffffffc ) ;
V_89 [ V_105 + 9 ] += F_91 ( V_514 -> V_188 ) & 0xff ;
V_53 -> V_105 += 10 ;
break;
case 0x49 :
if ( V_53 -> V_114 < V_153 ) {
...
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_514 -> V_188 >> 8 ) ;
V_89 [ V_105 + 4 ] += ( T_1 ) ( V_515 -> V_188 >> 8 ) ;
V_53 -> V_105 += 13 ;
break;
case 0x4f :
if ( F_43 ( V_53 , V_105 + 2 ) & ( 1 << 31 ) ) {
...
V_521 = F_43 ( V_53 , V_105 + 1 ) ;
V_521 |= ( ( T_2 ) ( F_43 ( V_53 , V_105 + 3 ) & 0x00ff0000 ) ) << 16 ;
if ( ( V_521 + ( V_147 * 4 ) ) > F_23 ( V_515 -> V_202 ) ) {
F_7 ( V_53 -> V_66 , L_148 ,
V_521 , F_23 ( V_515 -> V_202 ) ) ;
return - V_68 ;
...
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_515 -> V_188 & 0xfffffffc ) ;
V_89 [ V_105 + 3 ] += ( F_91 ( V_515 -> V_188 ) << 16 ) & 0x00ff0000 ;
V_53 -> V_105 += 4 ;
break;
case V_526 :
V_53 -> V_105 += 1 ;
...
static int F_110 ( struct V_601 * V_152 ,
...
int F_111 ( struct V_601 * V_152 , struct V_615 * V_89 )
{
int V_616 = 0 ;
T_1 V_105 = 0 ;
struct V_143 V_144 ;
...
V_616 = F_110 ( V_152 , V_89 -> V_90 , & V_144 ) ;
V_105 += V_144 . V_147 + 2 ;
break;
default:
F_88 ( V_152 -> V_66 , L_119 , V_144 . type ) ;
V_616 = - V_68 ;
break;
}
if ( V_616 )
break;
} while ( V_105 < V_89 -> V_511 );
return V_616 ;
}
int F_115 ( struct V_601 * V_152 , struct V_615 * V_89 )
{
T_1 V_105 = 0 ;
T_1 V_517 , V_518 , V_147 , V_519 ;
do {
V_517 = V_89 -> V_90 [ V_105 ] ;
V_518 = F_105 ( V_517 ) ;
V_147 = F_106 ( V_517 ) ;
V_519 = F_107 ( V_517 ) ;
switch ( V_518 ) {
