...
static int F_25 ( struct V_2 * V_3 , int V_77 )
{
struct V_1 * V_24 = F_1 ( V_3 ) ;
int error ;
if ( V_24 -> V_78 == V_77 )
return 0 ;
error = F_10 ( V_3 , V_79 , V_77 ? 0x00 : 0x03 ) ;
if ( error ) {
F_19 ( 1 , V_52 , V_3 , L_7 ) ;
return error ;
}
...
V_26 = & V_32 [ V_80 ] . V_33 . V_26 ;
F_27 ( V_3 , L_10 ,
V_26 -> V_35 , V_26 -> V_45 ) ;
}
F_27 ( V_3 , L_11 ,
V_24 -> V_78 ? L_12 : L_13 ) ;
F_28 ( & V_24 -> V_7 , V_3 -> V_81 ) ;
return 0 ;
}
...
static struct V_90 *
F_33 ( struct V_10 * V_91 )
{
struct V_92 V_93 ;
struct V_90 * V_94 ;
struct V_95 * V_96 ;
unsigned int V_97 ;
if ( ! F_34 ( V_98 ) || ! V_91 -> V_99 . V_100 )
return V_91 -> V_99 . V_101 ;
V_96 = F_35 ( V_91 -> V_99 . V_100 , NULL ) ;
if ( ! V_96 )
return NULL ;
V_94 = F_36 ( & V_91 -> V_99 , sizeof( * V_94 ) , V_102 ) ;
if ( ! V_94 )
goto V_103;
F_37 ( V_96 , & V_93 ) ;
V_97 = V_93 . V_104 . V_105 . V_97 ;
if ( V_97 & V_106 )
V_94 -> V_107 = 1 ;
if ( V_97 & V_108 )
V_94 -> V_109 = 1 ;
...
static int F_39 ( struct V_10 * V_11 , const struct V_116 * V_38 )
{
struct V_90 * V_94 = F_33 ( V_11 ) ;
struct V_2 * V_3 ;
struct V_1 * V_24 ;
struct V_22 V_33 ;
int V_117 ;
...
V_121 | V_122 ) )
return - V_123 ;
V_24 = F_36 ( & V_11 -> V_99 , sizeof( struct V_1 ) , V_102 ) ;
if ( ! V_24 )
return - V_124 ;
V_3 = & V_24 -> V_3 ;
V_24 -> V_94 = V_94 ;
...
F_42 ( V_3 , V_11 , & V_125 ) ;
F_43 ( V_11 , L_15 ,
V_11 -> V_8 , V_11 -> V_120 -> V_81 ) ;
error = F_4 ( V_3 , V_126 , & V_119 ) ;
if ( error < 0 )
return error ;
F_27 ( V_3 , L_16 , V_119 ) ;
if ( V_119 != 0x02 )
F_27 ( V_3 , L_17 ) ;
error = F_14 ( V_3 , V_127 ) ;
if ( error < 0 )
return error ;
V_117 = 0x20 | V_24 -> V_94 -> V_107 << 5
| V_24 -> V_94 -> V_109 << 2 ;
error = F_10 ( V_3 , V_128 , V_117 ) ;
if ( error < 0 )
return error ;
V_118 = 0x01 | V_24 -> V_94 -> V_113 << 2
| V_24 -> V_94 -> V_115 << 1
| V_24 -> V_94 -> V_111 ;
...
error = F_15 ( V_3 , & V_33 ) ;
#if F_44 ( V_130 )
V_24 -> V_83 . V_97 = V_131 ;
V_24 -> V_3 . V_97 |= V_132 ;
V_24 -> V_3 . V_133 . V_97 |= V_134 ;
error = F_45 ( & V_24 -> V_3 . V_133 , 1 , & V_24 -> V_83 , 0 ) ;
if ( error < 0 )
return error ;
#endif
F_46 ( & V_24 -> V_7 , 1 ) ;
