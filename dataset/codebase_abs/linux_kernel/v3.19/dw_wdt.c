...
static T_2 F_22 ( struct V_30 * V_31 , const char T_3 * V_35 ,
T_4 V_36 , T_5 * V_37 )
{
if ( ! V_36 )
return 0 ;
...
static long F_25 ( struct V_30 * V_31 , unsigned int V_21 , unsigned long V_42 )
{
unsigned long V_22 ;
int V_43 ;
switch ( V_21 ) {
case V_44 :
return F_26 ( ( void T_3 * ) V_42 , & V_45 ,
sizeof( V_45 ) ) ? - V_40 : 0 ;
case V_46 :
case V_47 :
return F_27 ( 0 , ( int T_3 * ) V_42 ) ;
case V_48 :
F_6 () ;
return 0 ;
case V_49 :
if ( F_23 ( V_22 , ( int T_3 * ) V_42 ) )
return - V_40 ;
V_43 = F_7 ( V_22 ) ;
return F_27 ( V_43 , ( int T_3 * ) V_42 ) ;
case V_50 :
return F_27 ( F_5 () , ( int T_3 * ) V_42 ) ;
case V_51 :
if ( F_23 ( V_22 , ( int T_3 * ) V_42 ) )
return - V_40 ;
return F_27 ( F_24 () , ( int T_3 * ) V_42 ) ;
default:
return - V_52 ;
}
}
...
{
int V_58 ;
struct V_59 * V_60 = F_36 ( V_57 , V_61 , 0 ) ;
V_1 . V_2 = F_37 ( & V_57 -> V_54 , V_60 ) ;
if ( F_38 ( V_1 . V_2 ) )
return F_39 ( V_1 . V_2 ) ;
V_1 . V_6 = F_40 ( & V_57 -> V_54 , NULL ) ;
if ( F_38 ( V_1 . V_6 ) )
return F_39 ( V_1 . V_6 ) ;
V_58 = F_34 ( V_1 . V_6 ) ;
if ( V_58 )
