...
( V_3 -> V_7 . V_8 == V_9 ) &&
( V_3 -> V_4 . V_8 != V_9 ) ) {
F_3 ( V_3 , V_3 -> V_10 , V_3 -> V_11 ) ;
}
}
static void F_4 ( struct V_2 * V_3 , int V_12 )
{
F_5 ( & V_3 -> V_7 . V_13 , V_12 , ( void * ) V_3 ,
F_1 ) ;
}
void F_3 ( struct V_2 * V_3 , T_1 V_10 , T_1 V_11 )
{
F_2 (self != NULL, return;) ;
F_2 (self->magic == IRLAN_MAGIC, return;) ;
if ( ( V_3 -> V_7 . V_8 != V_9 ) ||
...
V_3 = F_12 () ;
if ( V_3 ) {
F_2 (self->magic == IRLAN_MAGIC, goto out;) ;
F_6 ( L_3 , V_15 ,
V_11 ) ;
F_3 ( V_3 , V_10 , V_11 ) ;
}
...
F_2 (tsap == self->client.tsap_ctrl, return;) ;
while ( ( V_27 = F_18 ( & V_3 -> V_7 . V_34 ) ) != NULL ) {
F_19 ( V_27 ) ;
}
V_3 -> V_7 . V_29 = FALSE ;
F_9 ( V_3 , V_35 , NULL ) ;
...
V_36 . V_41 = F_17 ;
V_36 . V_24 = V_3 ;
F_21 ( V_36 . V_42 , L_6 , sizeof( V_36 . V_42 ) ) ;
...
F_2 (self != NULL, return;) ;
F_2 (self->magic == IRLAN_MAGIC, return;) ;
if ( strcmp ( V_61 , L_24 ) == 0 ) {
if ( strcmp ( V_58 , L_25 ) == 0 )
V_3 -> V_64 = V_65 ;
else
V_3 -> V_64 = V_66 ;
return;
}
if ( strcmp ( V_61 , L_26 ) == 0 ) {
if ( strcmp ( V_58 , L_27 ) == 0 )
V_3 -> V_7 . V_67 |= V_68 ;
else if ( strcmp ( V_58 , L_28 ) == 0 )
V_3 -> V_7 . V_67 |= V_69 ;
...
if ( strcmp ( V_61 , L_34 ) == 0 ) {
if ( strcmp ( V_58 , L_35 ) == 0 )
V_3 -> V_7 . V_5 = V_14 ;
else if ( strcmp ( V_58 , L_36 ) == 0 )
V_3 -> V_7 . V_5 = V_6 ;
...
if ( strcmp ( V_61 , L_41 ) == 0 ) {
V_3 -> V_77 = V_58 [ 0 ] ;
F_6 ( L_42 , V_3 -> V_77 ) ;
return;
}
if ( strcmp ( V_61 , L_43 ) == 0 ) {
memcpy ( & V_62 , V_58 , 2 ) ;
F_32 ( & V_62 ) ;
V_3 -> V_7 . V_78 = V_62 ;
F_6 ( L_44 , V_15 ,
...
if ( strcmp ( V_61 , L_47 ) == 0 ) {
F_6 ( L_48 ) ;
memcpy ( V_3 -> V_7 . V_80 , V_58 , V_56 ) ;
V_3 -> V_7 . V_81 = V_56 ;
F_6 ( L_49 ) ;
}
if ( strcmp ( V_61 , L_50 ) == 0 ) {
V_63 = V_58 ;
F_6 ( L_51 , V_63 ) ;
