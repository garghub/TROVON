...
return V_13 == 1 ? 0 : ( V_13 < 0 ? V_13 : - V_15 ) ;
}
...
int error ;
T_2 V_4 [ 3 ] ;
error = F_5 ( V_2 , V_45 , V_4 ) ;
if ( error ) {
F_6 ( & V_2 -> V_18 , L_11 , error ) ;
return error ;
}
* V_42 = V_4 [ 0 ] ;
return 0 ;
}
static int F_20 ( struct V_1 * V_2 , T_2 * V_46 )
{
int error ;
T_2 V_4 [ 3 ] ;
error = F_5 ( V_2 , V_47 , V_4 ) ;
if ( error ) {
...
if ( error ) {
F_6 ( & V_2 -> V_18 , L_14 , error ) ;
return error ;
}
* V_51 = F_13 ( ( T_3 * ) V_4 ) & 0x0fff ;
...
static int F_25 ( struct V_1 * V_2 , enum V_61 * V_34 )
{
int error ;
T_1 V_62 ;
T_2 V_4 [ 3 ] ;
...
V_62 = F_13 ( ( T_3 * ) V_4 ) ;
F_26 ( & V_2 -> V_18 , L_19 , V_62 ) ;
* V_34 = ( V_62 & V_64 ) ? V_65 : V_66 ;
return 0 ;
}
...
const T_2 * V_72 , T_1 V_73 , int V_74 )
{
struct V_21 * V_18 = & V_2 -> V_18 ;
T_2 V_75 [ V_76 + 4 ] ;
T_2 V_4 [ 3 ] ;
...
V_75 [ 0 ] = V_78 ;
V_75 [ 1 ] = V_79 ;
memcpy ( & V_75 [ 2 ] , V_72 , V_76 ) ;
F_31 ( V_73 , & V_75 [ V_76 + 2 ] ) ;
V_13 = F_32 ( V_2 , V_75 , sizeof( V_75 ) ) ;
if ( V_13 != sizeof( V_75 ) ) {
error = V_13 < 0 ? V_13 : - V_15 ;
F_6 ( V_18 , L_25 , V_74 , error ) ;
return error ;
}
F_9 ( 20 ) ;
error = F_5 ( V_2 , V_63 , V_4 ) ;
...
static int F_39 ( struct V_1 * V_2 , T_2 * V_86 )
{
int V_5 ;
V_5 = F_10 ( V_2 , V_86 , V_87 ) ;
if ( V_5 < 0 ) {
F_6 ( & V_2 -> V_18 , L_31 , V_5 ) ;
return V_5 ;
}
if ( V_5 != V_87 ) {
F_6 ( & V_2 -> V_18 ,
