...
{
struct V_163 * V_24 = F_79 ( V_42 ) ;
struct V_164 * V_41 = F_80 ( V_42 ) ;
struct V_1 * V_2 = V_41 -> V_54 ;
int V_16 ;
F_81 ( V_41 , V_165 ) ;
for ( V_16 = 0 ; V_16 < V_166 ; V_16 ++ )
F_82 ( V_2 -> V_136 [ V_16 ] ) ;
for ( V_16 = 0 ; V_16 < V_105 ; V_16 ++ )
F_83 ( V_2 -> V_53 [ V_16 ] ) ;
F_25 ( V_2 ) ;
...
static int F_87 ( struct V_162 * V_42 )
{
struct V_163 * V_24 = F_79 ( V_42 ) ;
struct V_164 * V_41 = F_80 ( V_42 ) ;
struct V_1 * V_2 = V_41 -> V_54 ;
...
struct V_173 * V_174 )
{
struct V_1 * V_2 = V_172 -> V_54 ;
int V_16 ;
for ( V_16 = 0 ; V_16 < 256 ; V_16 += 4 )
F_94 ( V_174 , L_11 , V_16 , F_2 ( V_2 -> V_7 + V_16 ) ) ;
}
static void F_95 ( struct V_1 * V_2 )
{
struct V_171 * V_172 ;
if ( ! F_96 ( V_2 -> V_41 , L_12 , & V_172 ) )
F_97 ( V_172 , V_2 , F_93 ) ;
}
...
static int F_103 ( struct V_176 * V_162 )
{
struct V_1 * V_2 = V_162 -> V_177 ;
return F_98 ( V_2 ) ;
}
static int F_104 ( struct V_164 * V_41 ,
struct V_163 * V_24 ,
struct V_1 * * V_178 )
{
static struct V_179 V_27 = {
. V_180 = F_103 ,
} ;
struct V_1 * V_2 ;
int V_88 ;
...
V_2 -> V_24 = V_24 ;
V_2 -> V_137 = - 1 ;
if ( ( V_88 = F_108 ( V_24 , L_7 ) ) < 0 ) {
F_102 ( V_2 ) ;
F_84 ( V_24 ) ;
return V_88 ;
}
V_2 -> V_6 = F_109 ( V_24 , 0 ) ;
V_2 -> V_7 = F_110 ( V_24 , 0 ) ;
if ( V_2 -> V_7 == NULL ) {
F_24 ( V_41 -> V_42 , L_13 ) ;
F_98 ( V_2 ) ;
return - V_169 ;
}
if ( F_111 ( V_24 -> V_137 , F_75 , V_182 ,
V_183 , V_2 ) ) {
F_24 ( V_41 -> V_42 , L_14 , V_24 -> V_137 ) ;
F_98 ( V_2 ) ;
return - V_43 ;
}
...
F_91 ( V_24 ) ;
F_112 ( V_2 -> V_137 ) ;
if ( ( V_88 = F_113 ( V_41 , V_184 , V_2 , & V_27 ) ) < 0 ) {
F_98 ( V_2 ) ;
return V_88 ;
}
* V_178 = V_2 ;
...
struct V_1 * V_2 ;
int V_88 ;
V_88 = F_115 ( & V_24 -> V_42 , V_187 , V_188 , V_189 , 0 , & V_41 ) ;
if ( V_88 < 0 )
return V_88 ;
strcpy ( V_41 -> V_190 , L_15 ) ;
strcpy ( V_41 -> V_191 , L_16 ) ;
if ( ( V_88 = F_104 ( V_41 , V_24 , & V_2 ) ) < 0 )
goto V_192;
V_41 -> V_54 = V_2 ;
if ( ( V_88 = F_21 ( V_2 ) ) < 0 )
goto V_192;
if ( ( V_88 = F_76 ( V_2 , V_193 ) ) < 0 )
goto V_192;
if ( ( V_88 = F_71 ( V_2 ) ) < 0 )
goto V_192;
F_95 ( V_2 ) ;
F_27 ( V_2 ) ;
sprintf ( V_41 -> V_194 , L_17 ,
V_41 -> V_191 , V_24 -> V_195 , V_2 -> V_6 , V_2 -> V_137 ) ;
if ( ( V_88 = F_116 ( V_41 ) ) < 0 )
goto V_192;
F_117 ( V_24 , V_41 ) ;
return 0 ;
V_192:
...
static void F_119 ( struct V_163 * V_24 )
{
F_118 ( F_120 ( V_24 ) ) ;
}
