...
F_27 ( V_2 ) ;
#endif
} else if ( F_23 ( V_14 , V_54 ) ) {
F_24 ( L_3 ,
V_50 , V_2 -> V_51 -> V_52 ,
F_25 ( V_14 ) ) ;
} else {
F_24 ( L_4 , V_50 ,
V_2 -> V_51 -> V_52 , F_25 ( V_14 ) ) ;
}
}
static void F_28 ( struct V_1 * V_2 )
{
struct V_13 * V_55 = & V_2 -> V_14 ;
struct V_56 * V_57 = & V_2 -> V_47 ;
if ( V_2 == NULL )
return;
F_24 ( L_5 , V_50 , V_2 -> V_51 -> V_52 ) ;
if ( ! F_29 ( V_2 -> V_51 ) )
F_30 ( V_2 -> V_51 ) ;
F_31 ( V_2 ) ;
F_32 ( & V_57 -> V_58 ) ;
...
void F_40 ( struct V_1 * V_64 )
{
struct V_1 * V_2 = F_6 ( V_64 ) ;
struct V_3 * V_4 = F_2 ( V_2 ) ;
struct V_5 * V_6 = & V_4 -> V_7 ;
struct V_65 * V_66 = & V_2 -> V_67 ;
unsigned long V_68 = V_63 ;
F_24 ( L_6 , V_50 ) ;
F_41 ( & V_6 -> V_8 ) ;
V_6 -> V_9 = true ;
V_66 -> V_69 = V_70 ;
