...
static int F_36 ( struct V_91 * V_92 , T_6 V_136 )
{
struct V_1 * V_2 = V_92 -> V_131 ;
int V_98 ;
F_11 ( V_92 -> V_20 , L_10 ,
V_92 -> V_137 -> V_138 / 1024 , V_2 -> V_21 , ( T_1 ) V_136 ) ;
V_98 = F_18 ( V_2 , V_92 -> V_139 , V_136 , 0 ) ;
if ( V_98 )
return V_98 ;
F_24 ( V_2 ) ;
return 0 ;
}
static int F_37 ( struct V_91 * V_92 , enum V_140 V_141 )
{
struct V_1 * V_2 = V_92 -> V_131 ;
int V_98 ;
V_98 = F_38 ( V_2 -> V_142 ) ;
...
static void F_40 ( struct V_91 * V_92 , enum V_140 V_141 )
{
struct V_1 * V_2 = V_92 -> V_131 ;
F_39 ( V_2 -> V_117 ) ;
F_39 ( V_2 -> V_142 ) ;
...
{
struct V_145 * V_146 = V_144 -> V_20 . V_147 ;
struct V_148 V_149 ;
struct V_150 * V_20 = & V_144 -> V_20 ;
struct V_1 * V_2 ;
struct V_151 * V_152 ;
struct V_91 * V_92 ;
struct V_153 * V_137 ;
...
F_42 ( V_157 , & V_144 -> V_20 ) ;
V_2 = F_43 ( V_20 , sizeof( * V_2 ) , V_158 ) ;
if ( ! V_2 )
return - V_159 ;
V_2 -> V_160 = F_44 ( V_20 -> V_147 ) ;
if ( ! V_2 -> V_160 || V_2 -> V_160 > V_161 )
return - V_162 ;
V_152 = F_45 ( V_144 , V_163 , L_11 ) ;
V_2 -> V_9 = F_46 ( V_20 , V_152 ) ;
if ( F_47 ( V_2 -> V_9 ) ) {
V_98 = F_48 ( V_2 -> V_9 ) ;
goto V_164;
}
V_152 = F_45 ( V_144 , V_163 ,
L_12 ) ;
V_2 -> V_135 = F_46 ( V_20 , V_152 ) ;
if ( F_47 ( V_2 -> V_135 ) ) {
V_98 = F_48 ( V_2 -> V_135 ) ;
goto V_164;
}
V_2 -> V_74 = V_152 -> V_165 ;
V_2 -> V_142 = F_49 ( V_20 , L_13 ) ;
if ( F_47 ( V_2 -> V_142 ) ) {
V_98 = F_48 ( V_2 -> V_142 ) ;
goto V_164;
}
...
V_98 = F_52 ( V_20 , V_98 ,
F_8 , 0 , V_144 -> V_168 , V_2 ) ;
if ( V_98 ) {
F_17 ( V_20 , L_18 ) ;
goto V_167;
}
V_2 -> V_20 = V_20 ;
V_2 -> V_3 = (struct V_169 * ) V_156 -> V_170 ;
F_53 ( V_144 , V_2 ) ;
V_98 = F_28 ( V_2 ) ;
if ( V_98 )
goto V_167;
if ( F_54 ( V_146 , L_19 , NULL ) )
V_154 = true ;
F_55 (dev->of_node, np) {
char V_171 [ 40 ] ;
if ( ! V_154 )
...
V_92 -> V_177 = F_37 ;
V_92 -> V_178 = F_40 ;
V_98 = F_56 ( V_146 , V_171 , sizeof( V_171 ) ) ;
if ( V_98 < 0 )
goto V_164;
V_98 = F_57 ( V_146 , L_20 ,
& V_2 -> V_129 ) ;
if ( V_98 < 0 )
goto V_164;
F_31 ( V_2 , V_92 ) ;
V_98 = F_58 ( V_92 , V_171 , V_179 ) ;
if ( V_98 )
goto V_164;
V_149 . V_147 = V_146 ;
V_98 = F_59 ( V_137 , NULL , & V_149 , NULL , 0 ) ;
if ( V_98 )
goto V_164;
if ( V_2 -> V_33 == 0 ) {
V_2 -> V_33 = V_137 -> V_180 ;
F_26 ( V_2 ) ;
}
...
return 0 ;
V_183:
for ( V_29 = 0 ; V_29 < V_2 -> V_160 ; V_29 ++ )
F_61 ( & V_2 -> V_137 [ V_29 ] ) ;
V_167:
F_62 ( V_2 -> V_117 ) ;
V_166:
