...
static void F_57 ( struct V_172 * V_173 , const char * V_174 , unsigned V_175 )
{
struct V_176 * V_77 = V_173 -> V_8 ;
F_58 ( & V_77 -> V_4 , V_174 , V_175 , F_56 ) ;
}
...
return - V_139 ;
if ( ! V_4 -> V_144 ) {
F_63 ( L_3 , V_181 -> V_183 ) ;
return - V_179 ;
}
if ( V_186 )
F_64 ( V_186 , & V_45 , & V_27 , & V_187 , & V_188 ) ;
return F_65 ( V_4 , V_181 , V_45 , V_27 , V_187 , V_188 ) ;
}
...
return F_77 ( & V_194 , V_4 ) ;
}
static int F_78 ( struct V_197 * V_198 )
{
int V_199 , V_162 ;
struct V_3 * V_4 ;
struct V_200 * V_201 , * V_202 ;
struct V_59 * V_203 ;
V_203 = F_79 ( & V_198 -> V_77 , sizeof( * V_203 ) ,
V_204 ) ;
if ( ! V_203 )
return - V_146 ;
V_203 -> V_196 = F_80 ( & V_198 -> V_77 , L_4 ) ;
if ( F_81 ( V_203 -> V_196 ) ) {
V_203 -> V_196 = F_80 ( & V_198 -> V_77 , L_5 ) ;
if ( ! F_81 ( V_203 -> V_196 ) )
F_43 ( & V_198 -> V_77 , L_6 ) ;
}
if ( F_81 ( V_203 -> V_196 ) ) {
F_43 ( & V_198 -> V_77 , L_7 ) ;
return F_82 ( V_203 -> V_196 ) ;
}
V_203 -> V_61 = F_80 ( & V_198 -> V_77 , L_8 ) ;
if ( F_81 ( V_203 -> V_61 ) ) {
V_203 -> V_61 = F_80 ( & V_198 -> V_77 , L_9 ) ;
if ( ! F_81 ( V_203 -> V_61 ) )
F_43 ( & V_198 -> V_77 , L_10 ) ;
}
if ( F_81 ( V_203 -> V_61 ) ) {
F_43 ( & V_198 -> V_77 , L_11 ) ;
return F_82 ( V_203 -> V_61 ) ;
}
V_199 = F_83 ( V_203 -> V_196 ) ;
if ( V_199 ) {
F_43 ( & V_198 -> V_77 , L_12 ) ;
return V_199 ;
}
V_199 = F_83 ( V_203 -> V_61 ) ;
if ( V_199 ) {
F_43 ( & V_198 -> V_77 , L_13 ) ;
goto V_205;
}
V_201 = F_84 ( V_198 , V_206 , 0 ) ;
if ( ! V_201 ) {
V_199 = - V_179 ;
goto V_207;
}
V_202 = F_84 ( V_198 , V_208 , 0 ) ;
if ( ! V_202 ) {
V_199 = - V_179 ;
goto V_207;
}
...
if ( F_86 ( V_203 -> V_61 ,
& V_203 -> V_209 ) )
F_21 ( & V_198 -> V_77 , L_14 ) ;
#endif
V_162 = F_87 ( V_198 -> V_77 . V_211 , L_15 ) ;
if ( V_162 < 0 )
V_162 = 0 ;
V_4 = F_52 ( V_162 ) ;
if ( ! V_4 ) {
F_43 ( & V_198 -> V_77 , L_16 ) ;
V_199 = - V_179 ;
goto V_212;
} else {
V_4 -> V_144 = V_201 -> V_213 ;
V_4 -> V_1 = V_202 -> V_213 ;
V_4 -> V_77 = & V_198 -> V_77 ;
V_4 -> V_61 = F_88 ( V_203 -> V_61 ) ;
V_4 -> V_60 = V_203 ;
V_203 -> V_4 = V_4 ;
F_89 ( V_198 , V_4 ) ;
V_199 = F_90 ( & V_194 , V_4 ) ;
if ( V_199 ) {
F_43 ( & V_198 -> V_77 ,
L_17 , V_199 ) ;
goto V_212;
...
{
struct V_3 * V_4 = F_94 ( V_198 ) ;
struct V_59 * V_203 = V_4 -> V_60 ;
int V_199 ;
#ifdef F_85
F_91 ( V_203 -> V_61 ,
& V_203 -> V_209 ) ;
#endif
V_199 = F_95 ( & V_194 , V_4 ) ;
V_4 -> V_144 = 0 ;
F_92 ( V_203 -> V_61 ) ;
F_92 ( V_203 -> V_196 ) ;
return V_199 ;
