...
{
return V_114 -> V_115 && ! F_43 ( V_114 ) ;
}
static int F_44 ( struct V_116 * V_116 , int (* F_45)( struct V_1 * , void * ) ,
void * V_103 , struct V_93 * V_93 ,
void (* F_46)( struct V_93 * ) )
{
struct V_114 * V_117 ;
int V_118 = - V_102 ;
V_117 = V_116 -> V_119 . V_114 -> V_120 ;
if ( ! V_117 || ! V_117 -> V_115 )
goto V_121;
F_47 ( & V_117 -> V_115 -> V_122 ) ;
if ( F_42 ( V_116 -> V_119 . V_114 )
&& F_40 ( V_93 ) )
V_118 = 0 ;
F_48 ( & V_117 -> V_115 -> V_122 ) ;
if ( ! V_118 ) {
V_118 = F_49 ( V_116 , F_45 , V_103 ) ;
if ( V_118 )
F_37 ( V_93 , F_46 ) ;
}
V_121:
...
static int F_50 ( struct V_123 * V_123 , struct V_116 * V_116 )
{
struct V_45 * V_46 = V_123 -> V_124 ;
return F_44 ( V_116 , F_38 , V_46 ,
& V_46 -> V_93 , V_125 ) ;
}
static int F_51 ( struct V_123 * V_123 , struct V_116 * V_116 )
{
struct V_45 * V_46 = V_123 -> V_124 ;
F_37 ( & V_46 -> V_93 , V_125 ) ;
return F_52 ( V_123 , V_116 ) ;
}
...
if ( ! V_126 )
return;
V_114 = F_54 ( V_46 -> V_127 , V_126 ) ;
if ( F_55 ( V_114 ) )
goto V_128;
V_46 -> V_129 = V_114 ;
V_114 = F_54 ( L_59 , V_46 -> V_129 ) ;
if ( F_55 ( V_114 ) )
goto V_128;
V_46 -> V_130 = V_114 ;
V_114 = F_54 ( L_60 , V_46 -> V_129 ) ;
if ( F_55 ( V_114 ) )
goto V_128;
V_46 -> V_131 = V_114 ;
V_114 = F_56 ( L_61 , V_132 | V_133 ,
V_46 -> V_129 , V_46 ,
& V_134 ) ;
if ( F_55 ( V_114 ) )
goto V_128;
...
static void F_59 ( struct V_114 * * V_136 )
{
F_60 ( * V_136 ) ;
* V_136 = NULL ;
}
...
do {
V_139 = * V_138 ;
} while ( V_139 . V_140 != V_138 -> V_140 );
if ( ! V_139 . V_141 )
return;
F_2 ( V_2 , L_63 ,
V_139 . V_140 ,
F_3 ( V_30 - V_139 . V_36 ) ,
V_139 . V_142 , V_139 . line ,
V_139 . V_141 ) ;
}
static void F_62 ( struct V_1 * V_2 ,
const char * V_143 ,
unsigned int V_140 , struct V_137 * V_138 , unsigned long V_30 )
{
unsigned int V_144 ;
unsigned int V_32 ;
F_2 ( V_2 , L_32 , V_143 ) ;
V_144 = V_140 % V_145 ;
for ( V_32 = V_144 ; V_32 < V_145 ; V_32 ++ )
F_61 ( V_2 , V_138 + V_32 , V_30 ) ;
for ( V_32 = 0 ; V_32 < V_144 ; V_32 ++ )
F_61 ( V_2 , V_138 + V_32 , V_30 ) ;
}
static int F_63 ( struct V_1 * V_2 , void * V_146 )
{
struct V_87 * V_88 = V_2 -> V_100 ;
unsigned long V_54 = V_101 ;
F_2 ( V_2 , L_49 , 0 ) ;
F_6 ( V_2 , L_64 ) ;
F_62 ( V_2 , L_65 , V_88 -> V_147 , V_88 -> V_148 , V_54 ) ;
F_62 ( V_2 , L_66 , V_88 -> V_149 , V_88 -> V_150 , V_54 ) ;
return 0 ;
}
static int F_64 ( struct V_123 * V_123 , struct V_116 * V_116 )
{
struct V_87 * V_88 = V_123 -> V_124 ;
return F_44 ( V_116 , F_63 , V_88 ,
& V_88 -> V_93 , V_113 ) ;
}
static int F_65 ( struct V_123 * V_123 , struct V_116 * V_116 )
{
struct V_87 * V_88 = V_123 -> V_124 ;
F_37 ( & V_88 -> V_93 , V_113 ) ;
return F_52 ( V_123 , V_116 ) ;
}
static int F_66 ( struct V_1 * V_2 , void * V_146 )
{
struct V_87 * V_88 = V_2 -> V_100 ;
unsigned long V_30 = V_101 ;
struct V_9 * V_151 , * V_152 ;
F_2 ( V_2 , L_49 , 0 ) ;
F_22 ( & V_88 -> V_46 -> V_57 ) ;
V_151 = V_88 -> V_92 ;
if ( V_151 )
...
static int F_67 ( struct V_123 * V_123 , struct V_116 * V_116 )
{
struct V_87 * V_88 = V_123 -> V_124 ;
return F_44 ( V_116 , F_66 , V_88 ,
& V_88 -> V_93 , V_113 ) ;
}
static int F_68 ( struct V_123 * V_123 , struct V_116 * V_116 )
{
struct V_87 * V_88 = V_123 -> V_124 ;
F_37 ( & V_88 -> V_93 , V_113 ) ;
return F_52 ( V_123 , V_116 ) ;
...
{
struct V_114 * V_155 = V_88 -> V_46 -> V_131 ;
struct V_114 * V_114 ;
if ( ! V_155 )
return;
V_114 = F_54 ( L_67 , V_155 ) ;
if ( F_55 ( V_114 ) )
goto V_128;
V_88 -> V_156 = V_114 ;
V_114 = F_56 ( L_68 , V_132 | V_133 ,
V_88 -> V_156 , V_88 ,
& V_157 ) ;
if ( F_55 ( V_114 ) )
goto V_128;
V_88 -> V_158 = V_114 ;
V_114 = F_56 ( L_69 , V_132 | V_133 ,
V_88 -> V_156 , V_88 ,
& V_159 ) ;
if ( F_55 ( V_114 ) )
goto V_128;
...
static void F_71 ( struct V_1 * V_2 , struct V_161 * V_162 )
{
struct V_163 * V_164 = F_72 ( V_162 , struct V_163 , V_165 ) ;
F_2 ( V_2 , L_70 , V_164 -> V_166 ,
F_31 ( V_167 , & V_164 -> V_63 ) ? L_71 : L_72 ,
F_31 ( V_168 , & V_164 -> V_63 ) ? L_73 : L_74 ,
F_31 ( V_169 , & V_164 -> V_63 ) ? L_75 : L_76
) ;
}
static int F_73 ( struct V_1 * V_2 , void * V_146 )
{
struct V_47 * V_42 = V_2 -> V_100 ;
F_2 ( V_2 , L_49 , 0 ) ;
if ( F_74 ( V_42 , V_170 ) ) {
F_75 ( V_2 , V_42 -> V_171 ) ;
F_76 ( V_2 , V_42 -> V_171 , L_77 , F_71 ) ;
F_77 ( V_42 ) ;
}
return 0 ;
}
static int F_78 ( struct V_1 * V_2 , void * V_146 )
{
struct V_47 * V_42 = V_2 -> V_100 ;
F_2 ( V_2 , L_49 , 0 ) ;
if ( F_74 ( V_42 , V_170 ) ) {
F_75 ( V_2 , V_42 -> V_172 ) ;
F_76 ( V_2 , V_42 -> V_172 , L_78 , NULL ) ;
F_77 ( V_42 ) ;
}
return 0 ;
}
static int F_79 ( struct V_1 * V_2 , void * V_146 )
{
struct V_47 * V_42 = V_2 -> V_100 ;
...
V_151 = F_23 ( & V_42 -> V_58 [ V_32 ] ,
struct V_9 , V_59 ) ;
V_152 = F_23 ( & V_42 -> V_173 [ V_32 ] ,
struct V_9 , V_174 ) ;
if ( V_151 )
F_9 ( V_2 , V_151 , V_30 ) ;
if ( V_152 && V_152 != V_151 )
...
static int F_80 ( struct V_1 * V_2 , void * V_146 )
{
struct V_47 * V_42 = V_2 -> V_100 ;
struct V_175 * V_176 ;
enum V_177 V_178 ;
if ( ! F_74 ( V_42 , V_170 ) )
return - V_179 ;
V_176 = & V_42 -> V_180 -> V_176 ;
F_22 ( & V_176 -> V_181 ) ;
for ( V_178 = V_182 ; V_178 <= V_183 ; V_178 ++ ) {
F_2 ( V_2 , L_79 , V_176 -> V_184 [ V_178 ] ) ;
}
F_24 ( & V_176 -> V_181 ) ;
F_77 ( V_42 ) ;
return 0 ;
}
void F_81 ( struct V_47 * V_42 )
{
struct V_114 * V_185 = V_42 -> V_46 -> V_130 ;
char V_186 [ 8 ] ;
char V_187 [ 8 ] ;
char * V_188 = NULL ;
struct V_114 * V_114 ;
if ( ! V_185 || ! V_189 )
return;
snprintf ( V_187 , sizeof( V_187 ) , L_80 , V_42 -> V_44 ) ;
V_114 = F_54 ( V_187 , V_185 ) ;
if ( F_55 ( V_114 ) )
goto V_128;
V_42 -> V_190 = V_114 ;
snprintf ( V_186 , sizeof( V_186 ) , L_80 , V_42 -> V_43 ) ;
V_188 = F_82 ( V_191 , L_81 ,
V_42 -> V_46 -> V_127 , V_42 -> V_44 ) ;
if ( ! V_188 )
goto V_128;
V_114 = F_83 ( V_186 , V_189 , V_188 ) ;
F_84 ( V_188 ) ;
V_188 = NULL ;
if ( F_55 ( V_114 ) )
goto V_128;
V_42 -> V_192 = V_114 ;
#define F_85 ( V_127 ) do { \
...
void F_87 ( struct V_201 * V_202 )
{
struct V_114 * V_203 = V_202 -> V_88 -> V_156 ;
struct V_114 * V_114 ;
char V_187 [ 8 ] ;
if ( ! V_203 )
return;
snprintf ( V_187 , sizeof( V_187 ) , L_80 , V_202 -> V_42 -> V_44 ) ;
V_114 = F_54 ( V_187 , V_203 ) ;
if ( F_55 ( V_114 ) )
goto V_128;
V_202 -> V_204 = V_114 ;
return;
...
void F_88 ( struct V_201 * V_202 )
{
F_59 ( & V_202 -> V_204 ) ;
}
static int F_89 ( struct V_1 * V_2 , void * V_146 )
{
F_2 ( V_2 , L_83 , F_90 () ) ;
F_2 ( V_2 , L_84 , V_205 ) ;
F_2 ( V_2 , L_85 , V_206 ) ;
...
static int F_91 ( struct V_123 * V_123 , struct V_116 * V_116 )
{
return F_49 ( V_116 , F_89 , NULL ) ;
}
void F_92 ( void )
{
F_59 ( & V_126 ) ;
...
{
struct V_114 * V_114 ;
V_114 = F_54 ( L_88 , NULL ) ;
if ( F_55 ( V_114 ) )
goto V_128;
V_210 = V_114 ;
V_114 = F_56 ( L_89 , 0444 , V_210 , NULL , & V_211 ) ;
if ( F_55 ( V_114 ) )
goto V_128;
V_209 = V_114 ;
V_114 = F_54 ( L_90 , V_210 ) ;
if ( F_55 ( V_114 ) )
goto V_128;
V_126 = V_114 ;
V_114 = F_54 ( L_91 , V_210 ) ;
if ( F_55 ( V_114 ) )
goto V_128;
V_189 = V_114 ;
return 0 ;
