...
void F_15 ( struct V_1 * V_8 , unsigned char V_2 ,
...
F_13 ( V_8 ) ;
if ( F_19 ( & V_8 -> V_9 ) )
F_20 ( & V_8 -> V_10 , V_44 / 10 ) ;
}
static unsigned int F_21 ( unsigned char V_32 )
{
switch ( V_32 & ( V_45 | V_46 | V_47 | V_48 ) ) {
case V_49 :
return 8000 ;
case V_50 :
return 11025 ;
...
struct V_72 * V_73 )
{
struct V_1 * V_8 = F_24 ( V_63 ) ;
long * V_74 ;
F_25 ( & V_8 -> V_24 ) ;
V_74 = ( long * ) ( ( ( char * ) V_8 ) + V_63 -> V_75 ) ;
V_73 -> V_68 . integer . V_68 [ 0 ] = * V_74 ;
* V_74 = 0 ;
F_26 ( & V_8 -> V_24 ) ;
return 0 ;
}
...
F_25 ( & V_8 -> V_24 ) ;
V_80 = V_8 -> V_6 [ V_78 ] ;
V_79 = V_73 -> V_68 . integer . V_68 [ 0 ] != F_30 ( V_80 ) ;
if ( V_79 )
F_1 ( V_8 , V_78 ,
( V_80 & ( ~ F_30 ( 0xff ) ) ) |
( F_30 ( V_73 -> V_68 . integer . V_68 [ 0 ] ) ) ) ;
F_26 ( & V_8 -> V_24 ) ;
return V_79 ;
}
...
{
struct V_1 * V_8 = F_24 ( V_63 ) ;
V_73 -> V_68 . integer . V_68 [ 0 ] = F_21 ( F_2 ( V_8 ,
V_33 ) ) ;
return 0 ;
}
...
V_3 = F_2 ( V_1 , V_2 ) ;
F_43 ( V_100 , L_1 , V_2 , V_3 ) ;
}
}
static void F_44 ( struct V_1 * V_1 )
{
struct V_97 * V_98 ;
if ( ! F_45 ( V_1 -> V_15 , L_2 , & V_98 ) )
F_46 ( V_98 , V_1 , F_42 ) ;
}
...
int F_52 ( struct V_1 * V_1 , unsigned int V_114 )
{
struct V_115 * V_116 =
...
F_60 ( V_1 -> V_106 , V_117 ) ;
}
return V_118 ;
}
static void V_25 ( struct V_144 * V_10 )
{
struct V_1 * V_8 = F_61 ( V_10 , struct V_1 , V_10 . V_10 ) ;
if ( F_18 ( & V_8 -> V_9 ) == 1 )
F_52 ( V_8 , V_8 -> V_145 ) ;
if ( F_19 ( & V_8 -> V_9 ) )
F_20 ( & V_8 -> V_10 , V_44 / 10 ) ;
