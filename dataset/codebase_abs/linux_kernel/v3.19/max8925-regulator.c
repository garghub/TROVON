...
{
struct V_43 * V_44 = F_19 ( V_29 -> V_37 . V_38 ) ;
struct V_45 * V_46 = F_20 ( & V_29 -> V_37 ) ;
struct V_30 V_31 = { } ;
struct V_4 * V_47 ;
struct V_48 * V_49 ;
struct V_1 * V_2 ;
int V_50 , V_51 ;
V_49 = F_21 ( V_29 , V_52 , 0 ) ;
if ( ! V_49 ) {
F_15 ( & V_29 -> V_37 , L_3 ) ;
return - V_24 ;
}
for ( V_50 = 0 ; V_50 < F_22 ( V_4 ) ; V_50 ++ ) {
V_47 = & V_4 [ V_50 ] ;
if ( V_47 -> V_10 == V_49 -> V_53 ) {
V_51 = V_50 ;
break;
}
}
if ( V_50 == F_22 ( V_4 ) ) {
F_15 ( & V_29 -> V_37 , L_4 ,
( unsigned long long ) V_49 -> V_53 ) ;
return - V_24 ;
}
V_47 -> V_9 = V_44 -> V_9 ;
V_31 . V_37 = & V_29 -> V_37 ;
V_31 . V_54 = V_47 ;
if ( F_13 ( V_29 , & V_31 , V_51 ) )
if ( V_46 )
V_31 . V_42 = V_46 ;
V_2 = F_23 ( & V_29 -> V_37 , & V_47 -> V_7 , & V_31 ) ;
if ( F_24 ( V_2 ) ) {
F_15 ( & V_29 -> V_37 , L_5 ,
V_47 -> V_7 . V_55 ) ;
return F_25 ( V_2 ) ;
