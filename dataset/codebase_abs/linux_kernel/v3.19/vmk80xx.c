...
V_41 = & V_2 -> V_110 [ 0 ] ;
V_41 -> type = V_111 ;
V_41 -> V_112 = V_113 | V_114 ;
V_41 -> V_115 = V_107 -> V_116 ;
V_41 -> V_117 = V_107 -> V_118 ;
V_41 -> V_119 = V_107 -> V_120 ;
V_41 -> V_121 = F_15 ;
V_41 = & V_2 -> V_110 [ 1 ] ;
V_41 -> type = V_122 ;
V_41 -> V_112 = V_123 | V_114 ;
V_41 -> V_115 = V_107 -> V_124 ;
V_41 -> V_117 = 0x00ff ;
V_41 -> V_119 = V_107 -> V_120 ;
V_41 -> V_125 = F_19 ;
if ( V_4 -> V_34 == V_35 ) {
...
V_41 = & V_2 -> V_110 [ 5 ] ;
V_41 -> type = V_134 ;
V_41 -> V_112 = V_113 | V_123 ;
V_41 -> V_115 = V_107 -> V_135 ;
V_41 -> V_117 = V_107 -> V_136 ;
V_41 -> V_121 = F_28 ;
V_41 -> V_125 = F_29 ;
}
F_18 ( & V_4 -> V_48 ) ;
...
if ( V_4 -> V_34 == V_35 ) {
F_6 ( V_2 , V_19 ) ;
F_45 ( & V_94 -> V_2 , L_1 , V_4 -> V_20 . V_21 ) ;
if ( F_1 ( V_2 ) ) {
F_6 ( V_2 , V_141 ) ;
F_45 ( & V_94 -> V_2 , L_1 , V_4 -> V_20 . V_22 ) ;
}
}
if ( V_4 -> V_34 == V_50 )
F_14 ( V_2 ) ;
...
{
return F_48 ( V_94 , & V_144 , V_143 -> V_145 ) ;
}
