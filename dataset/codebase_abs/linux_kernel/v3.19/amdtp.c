...
F_8 ( V_32 > V_34 ) )
return;
for ( V_31 = 0 ; V_31 < F_18 ( V_35 ) ; ++ V_31 )
if ( V_35 [ V_31 ] == V_27 )
goto V_36;
F_8 ( 1 ) ;
return;
...
for ( V_30 = 0 ; V_30 < V_74 ; ++ V_30 ) {
for ( V_77 = 0 ; V_77 < V_75 ; ++ V_77 ) {
* V_81 = F_29 ( V_73 [ V_2 -> V_44 [ V_77 ] ] ) << 8 ;
V_81 ++ ;
}
V_73 += V_2 -> V_37 ;
if ( -- V_76 == 0 )
...
V_73 [ V_2 -> V_44 [ V_77 ] ] = F_28 ( 0x40000000 ) ;
V_73 += V_2 -> V_37 ;
}
}
static bool F_31 ( struct V_1 * V_2 , unsigned int V_82 )
{
int V_83 ;
V_83 = V_2 -> V_84 [ V_82 ] ;
if ( V_83 == 0 )
...
static void F_33 ( struct V_1 * V_2 , unsigned int V_82 )
{
...
F_37 ( V_2 -> V_89 [ V_82 ] , V_86 + 1 , V_90 ) ;
V_73 += V_2 -> V_37 ;
}
}
...
struct V_71 * V_72 = F_39 ( V_2 -> V_72 ) ;
if ( V_72 )
F_41 ( V_72 ) ;
}
...
if ( F_43 ( V_2 -> V_10 ) )
goto V_21;
V_99 . V_100 = F_44 ( V_2 -> V_14 + 1 , V_101 ) ;
V_99 . V_102 = V_103 ;
V_99 . V_95 = V_95 ;
V_99 . V_96 = ( ! V_97 ) ? V_96 : 0 ;
V_99 . V_97 = V_97 ;
V_20 = F_45 ( V_2 -> V_10 , & V_99 , & V_2 -> V_73 . V_104 ,
V_2 -> V_73 . V_105 [ V_2 -> V_14 ] . V_106 ) ;
if ( V_20 < 0 ) {
F_46 ( & V_2 -> V_4 -> V_107 , L_1 , V_20 ) ;
goto V_21;
}
if ( ++ V_2 -> V_14 >= V_108 )
V_2 -> V_14 = 0 ;
...
static void F_49 ( struct V_1 * V_2 , unsigned int V_66 )
{
T_2 * V_73 ;
...
V_73 [ 0 ] = F_28 ( F_39 ( V_2 -> V_111 ) |
( V_2 -> V_37 << V_112 ) |
V_2 -> V_87 ) ;
V_73 [ 1 ] = F_28 ( V_113 | V_114 | V_115 |
( V_2 -> V_31 << V_116 ) | V_66 ) ;
V_73 += 2 ;
V_72 = F_39 ( V_2 -> V_72 ) ;
if ( V_72 )
...
static void F_56 ( struct V_132 * V_10 , T_3 V_63 ,
T_6 V_95 , void * V_133 ,
void * V_134 )
{
struct V_1 * V_2 = V_134 ;
...
V_66 = F_29 ( V_73 [ 1 ] ) & V_69 ;
F_49 ( V_2 -> V_17 , V_66 ) ;
}
V_117 =
( F_29 ( V_135 [ V_99 ] ) >> V_136 ) / 4 ;
F_51 ( V_2 , V_117 , V_73 ) ;
}
if ( V_2 -> V_14 < 0 ) {
if ( V_2 -> V_17 ) {
...
static void F_57 ( struct V_132 * V_10 , T_3 V_63 ,
T_6 V_95 , void * V_133 ,
void * V_134 )
{
return;
}
static void F_58 ( struct V_132 * V_10 ,
T_3 V_63 , T_6 V_95 ,
...
V_20 = F_62 ( & V_2 -> V_73 , V_2 -> V_4 , V_108 ,
F_19 ( V_2 ) , V_6 ) ;
if ( V_20 < 0 )
goto V_154;
V_2 -> V_10 = F_63 ( F_64 ( V_2 -> V_4 ) -> V_160 ,
...
V_2 -> V_10 = F_3 ( - 1 ) ;
V_162:
F_70 ( & V_2 -> V_73 , V_2 -> V_4 ) ;
V_154:
F_68 ( & V_2 -> V_11 ) ;
return V_20 ;
}
unsigned long F_71 ( struct V_1 * V_2 )
{
if ( V_2 -> V_58 && F_9 ( V_2 ) )
F_72 ( V_2 -> V_10 ) ;
else
V_2 -> V_58 = true ;
return F_39 ( V_2 -> V_56 ) ;
}
void F_66 ( struct V_1 * V_2 )
{
F_39 ( V_2 -> V_111 ) =
( F_64 ( V_2 -> V_4 ) -> V_160 -> V_167 & 0x3f ) << 24 ;
}
