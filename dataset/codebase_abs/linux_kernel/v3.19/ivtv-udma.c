...
F_22 ( & V_45 -> V_46 -> V_47 ) ;
V_42 = F_23 ( V_45 , V_45 -> V_46 ,
V_41 . V_5 , V_41 . V_11 , 0 , 1 , V_13 -> V_19 , NULL ) ;
F_24 ( & V_45 -> V_46 -> V_47 ) ;
if ( V_41 . V_11 != V_42 ) {
F_21 ( L_4 ,
V_42 , V_41 . V_11 ) ;
...
V_13 -> V_29 = F_26 ( V_33 -> V_36 , V_13 -> V_23 , V_13 -> V_11 , V_37 ) ;
F_11 ( V_13 , V_38 , 0 , - 1 ) ;
...
return;
if ( V_13 -> V_29 ) {
F_30 ( V_33 -> V_36 , V_13 -> V_23 , V_13 -> V_11 , V_37 ) ;
V_13 -> V_29 = 0 ;
}
F_18 ( V_33 ) ;
for ( V_15 = 0 ; V_15 < V_13 -> V_11 ; V_15 ++ ) {
...
int V_15 ;
if ( V_33 -> V_34 . V_35 ) {
F_32 ( V_33 -> V_36 , V_33 -> V_34 . V_35 ,
sizeof( V_33 -> V_34 . V_30 ) , V_37 ) ;
}
if ( V_33 -> V_34 . V_29 ) {
F_30 ( V_33 -> V_36 , V_33 -> V_34 . V_23 , V_33 -> V_34 . V_11 , V_37 ) ;
}
for ( V_15 = 0 ; V_15 < V_49 ; V_15 ++ ) {
if ( V_33 -> V_34 . V_21 [ V_15 ] )
F_33 ( V_33 -> V_34 . V_21 [ V_15 ] ) ;
}
}
void F_34 ( struct V_32 * V_33 )
{
F_20 ( L_6 ) ;
F_35 ( V_33 -> V_34 . V_35 , V_50 ) ;
F_36 ( F_37 ( V_51 ) | 0x01 , V_51 ) ;
F_38 ( V_52 , & V_33 -> V_53 ) ;
F_38 ( V_54 , & V_33 -> V_53 ) ;
F_39 ( V_55 , & V_33 -> V_53 ) ;
}
