...
V_54 = F_67 ( V_150 , V_75 , V_174 , V_171 , & V_173 ) ;
if ( V_54 < 0 )
return 0 ;
V_37 = F_74 ( V_173 ) ;
if ( ! V_37 ) {
...
int V_54 = F_76 ( V_37 , & V_182 , & V_183 ) ;
F_77 ( V_54 < 0 ) ;
V_55 = V_55 * V_182 / V_183 ;
}
V_180 = V_55 - 1 ;
V_181 = V_58 - 1 ;
...
F_3 ( V_17 , V_180 | ( V_181 << 16 ) , V_110 ) ;
V_179 = F_1 ( V_17 , V_111 ) & 0xffff0000 ;
F_3 ( V_17 , V_179 | 0 | ( 0 << 8 ) , V_111 ) ;
}
...
struct V_198 V_199 ;
int V_54 ;
F_85 ( & V_196 -> V_200 , & V_196 -> V_55 , 0 , 2 , 4096 ) ;
F_85 ( & V_196 -> V_201 , & V_196 -> V_58 , 0 , 2 , 4096 ) ;
V_54 = F_67 ( V_150 , V_75 , V_202 , V_193 ) ;
if ( V_54 < 0 )
return V_54 ;
V_54 = F_67 ( V_150 , V_75 , V_203 , & V_199 ) ;
if ( V_54 < 0 )
return V_54 ;
if ( V_199 . V_173 != V_43 -> V_78 -> V_173 )
return - V_48 ;
if ( V_199 . V_55 & 7 ) {
F_82 ( & V_199 . V_55 ) ;
V_54 = F_67 ( V_150 , V_75 , V_204 , & V_199 ) ;
if ( V_54 < 0 )
return V_54 ;
}
if ( V_199 . V_55 != V_43 -> V_90 || V_199 . V_58 != V_43 -> V_88 )
F_75 ( V_17 , V_199 . V_55 , V_199 . V_58 ,
V_43 -> V_78 -> V_56 ) ;
F_10 ( V_43 -> V_46 , L_16 ,
V_199 . V_55 , V_199 . V_58 ) ;
V_43 -> V_90 = V_199 . V_55 ;
V_43 -> V_88 = V_199 . V_58 ;
return V_54 ;
}
...
V_199 . V_173 = V_50 -> V_173 ;
V_54 = F_67 ( V_150 , V_75 , V_204 , & V_199 ) ;
if ( V_54 < 0 )
return V_54 ;
if ( V_199 . V_173 != V_50 -> V_173 )
return - V_48 ;
if ( ! V_17 -> V_15 [ 0 ] ) {
V_54 = F_78 ( V_17 ) ;
if ( V_54 < 0 )
...
V_199 . V_207 = V_51 -> V_207 ;
V_199 . V_173 = V_50 -> V_173 ;
V_54 = F_67 ( V_150 , V_75 , V_209 , & V_199 ) ;
if ( V_54 < 0 )
return V_54 ;
V_51 -> V_55 = V_199 . V_55 ;
V_51 -> V_58 = V_199 . V_58 ;
...
static unsigned int F_89 ( struct V_214 * V_214 , T_7 * V_215 )
{
struct V_42 * V_43 = V_214 -> V_216 ;
return F_90 ( & V_43 -> V_217 , V_214 , V_215 ) ;
}
static int F_91 ( struct V_44 * V_45 ,
struct V_218 * V_219 )
{
F_92 ( V_219 -> V_220 , L_21 , sizeof( V_219 -> V_220 ) ) ;
V_219 -> V_221 = V_222 | V_223 ;
V_219 -> V_224 = V_219 -> V_221 | V_225 ;
return 0 ;
}
...
const struct V_49 * V_50 ;
struct V_19 * V_20 = V_43 -> V_46 ;
V_37 = F_74 ( V_43 -> V_78 -> V_173 ) ;
if ( ! V_37 )
return - V_48 ;
V_50 = F_22 ( V_43 , V_208 ) ;
if ( ! V_50 ) {
F_69 ( V_20 , L_17 , V_208 ) ;
return - V_48 ;
}
V_137 = V_37 -> V_168 ;
...
V_152 . V_93 = V_155 ;
V_54 = F_67 ( V_150 , V_75 , V_228 , & V_152 ) ;
if ( V_54 < 0 && V_54 != - V_157 ) {
F_10 ( V_20 , L_24 ,
V_155 , V_54 ) ;
return V_54 ;
}
V_227 = F_1 ( V_17 , V_131 ) &
~ ( ( 1 << V_130 ) |
( 1 << V_128 ) |
( 1 << V_124 ) |
( 1 << V_126 ) |
...
F_3 ( V_17 , V_227 | V_226 , V_131 ) ;
F_10 ( V_20 , L_25 , V_227 | V_226 ) ;
return 0 ;
}
static int F_94 ( struct V_230 * V_231 )
{
struct V_160 * V_161 = V_231 -> V_20 . V_162 ;
struct V_1 * V_17 ;
struct V_232 * V_233 ;
void T_8 * V_4 ;
int V_234 = 0 ;
struct V_44 * V_134 ;
V_233 = F_95 ( V_231 , V_235 , 0 ) ;
V_4 = F_96 ( & V_231 -> V_20 , V_233 ) ;
if ( F_97 ( V_4 ) )
return F_98 ( V_4 ) ;
if ( ! V_161 )
return - V_48 ;
V_17 = F_99 ( & V_231 -> V_20 , sizeof( * V_17 ) , V_236 ) ;
if ( ! V_17 ) {
F_29 ( & V_231 -> V_20 , L_26 ) ;
return - V_237 ;
}
V_17 -> V_132 = F_100 ( & V_231 -> V_20 , NULL ) ;
if ( F_97 ( V_17 -> V_132 ) )
return F_98 ( V_17 -> V_132 ) ;
V_17 -> V_161 = V_161 ;
V_17 -> V_114 = V_161 -> V_93 ;
if ( ! ( V_17 -> V_114 & V_238 ) ) {
F_69 ( & V_231 -> V_20 , L_27
L_28 ) ;
V_17 -> V_114 |= V_118 ;
}
if ( V_17 -> V_114 & V_239 )
...
V_134 -> V_101 = & V_243 ;
V_134 -> V_47 = V_17 ;
V_134 -> V_135 . V_20 = & V_231 -> V_20 ;
V_134 -> V_244 = V_231 -> V_163 ;
V_17 -> V_60 = F_102 ( & V_231 -> V_20 ) ;
if ( F_97 ( V_17 -> V_60 ) )
return F_98 ( V_17 -> V_60 ) ;
if ( V_161 -> V_245 ) {
V_134 -> V_246 = V_161 -> V_246 ;
...
{
struct V_44 * V_134 = F_21 ( & V_231 -> V_20 ) ;
