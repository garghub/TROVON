...
V_152 [ V_156 ] = & V_153 ;
F_25 ( V_156 + 1 > F_115 ( V_152 ) ) ;
F_116 ( V_19 -> V_159 , V_152 , V_156 , 1 , V_19 , V_56 ) ;
...
V_200 = F_137 ( V_22 ) ;
V_201 = F_138 ( V_22 ) ;
V_26 = F_139 ( ( ( V_200 + V_201 ) * V_208 ) +
( 2 * sizeof( V_197 -> V_209 ) ) , V_56 ) ;
V_197 = V_26 ;
if ( ! V_26 )
return;
F_53 ( V_96 , 2 ) ;
V_197 -> V_209 = F_140 ( V_19 -> V_20 , V_200 ) ;
V_99 = 0 ;
F_141 (ha, dev)
...
V_197 -> V_209 = F_140 ( V_19 -> V_20 , V_201 ) ;
V_99 = 0 ;
F_142 (ha, dev)
memcpy ( & V_197 -> V_210 [ V_99 ++ ] [ 0 ] , V_199 -> V_164 , V_208 ) ;
F_54 ( & V_96 [ 1 ] , V_197 ,
...
F_177 ( F_7 ( & V_19 -> V_11 [ V_99 ] , V_114 ) , 0 ) ;
}
}
...
const char * * V_263 ;
V_262 = V_19 -> V_127 * 2 +
F_114 ( V_19 -> V_20 , V_158 ) ;
V_261 = F_139 ( V_262 * sizeof( * V_261 ) , V_114 ) ;
if ( ! V_261 )
goto V_264;
V_260 = F_183 ( V_262 * sizeof( * V_260 ) , V_114 ) ;
if ( ! V_260 )
goto V_265;
V_263 = F_183 ( V_262 * sizeof( * V_263 ) , V_114 ) ;
if ( ! V_263 )
goto V_266;
if ( V_19 -> V_188 ) {
V_260 [ V_262 - 1 ] = NULL ;
...
if ( ! V_19 -> V_11 )
goto V_273;
F_185 ( & V_19 -> V_111 , F_74 ) ;
for ( V_99 = 0 ; V_99 < V_19 -> V_127 ; V_99 ++ ) {
V_19 -> V_11 [ V_99 ] . V_15 = NULL ;
F_186 ( V_19 -> V_22 , & V_19 -> V_11 [ V_99 ] . V_91 , F_80 ,
V_274 ) ;
F_187 ( & V_19 -> V_11 [ V_99 ] . V_91 ) ;
F_53 ( V_19 -> V_11 [ V_99 ] . V_96 , F_115 ( V_19 -> V_11 [ V_99 ] . V_96 ) ) ;
F_188 ( & V_19 -> V_11 [ V_99 ] . V_60 , 1 , V_275 ) ;
F_53 ( V_19 -> V_129 [ V_99 ] . V_96 , F_115 ( V_19 -> V_129 [ V_99 ] . V_96 ) ) ;
}
return 0 ;
V_273:
F_143 ( V_19 -> V_129 ) ;
...
static T_10 F_190 ( struct V_277 * V_278 ,
struct V_279 * V_280 , char * V_26 )
{
struct V_18 * V_19 = F_87 ( V_278 -> V_22 ) ;
unsigned int V_281 = F_191 ( V_278 ) ;
struct V_100 * V_282 ;
...
if ( F_114 ( V_20 , V_298 ) ) {
V_22 -> V_299 |= V_300 | V_301 | V_302 ;
if ( V_303 )
V_22 -> V_270 |= V_300 | V_301 | V_302 ;
if ( F_114 ( V_20 , V_304 ) ) {
V_22 -> V_299 |= V_305 | V_306
| V_307 | V_308 ;
}
if ( F_114 ( V_20 , V_309 ) )
V_22 -> V_299 |= V_305 ;
...
V_22 -> V_299 |= V_306 ;
if ( V_313 )
V_22 -> V_270 |= V_22 -> V_299 & ( V_314 | V_306 ) ;
}
if ( F_114 ( V_20 , V_315 ) )
V_22 -> V_270 |= V_316 ;
V_22 -> V_317 = V_22 -> V_270 ;
if ( F_114 ( V_20 , V_171 ) )
F_199 ( V_20 ,
F_122 ( struct V_173 , V_174 ) ,
V_22 -> V_318 , V_22 -> V_167 ) ;
else
F_200 ( V_22 ) ;
V_19 = F_87 ( V_22 ) ;
V_19 -> V_22 = V_22 ;
...
V_19 -> V_32 = sizeof( struct V_324 ) ;
if ( F_114 ( V_20 , V_325 ) )
V_19 -> V_139 = true ;
if ( F_114 ( V_20 , V_158 ) )
V_19 -> V_188 = true ;
if ( V_19 -> V_139 )
V_22 -> V_326 = V_19 -> V_32 ;
V_19 -> V_113 = 1 ;
V_19 -> V_127 = V_127 ;
V_43 = F_189 ( V_19 ) ;
if ( V_43 )
...
{
V_19 -> V_20 -> V_258 -> V_333 ( V_19 -> V_20 ) ;
F_179 ( V_19 ) ;
F_176 ( V_19 ) ;
F_178 ( V_19 ) ;
F_181 ( V_19 ) ;
...
static int F_219 ( struct V_161 * V_20 )
{
struct V_18 * V_19 = V_20 -> V_21 ;
int V_43 , V_99 ;
V_43 = F_189 ( V_19 ) ;
