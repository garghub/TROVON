...
F_112 ( V_74 -> V_179 , NULL ) ;
F_113 ( V_74 -> V_179 ) ;
}
if ( V_74 -> V_180 ) {
F_114 ( ( unsigned long ) V_74 -> V_180 -> V_181 ) ;
...
static inline void F_115 ( struct V_183 * V_180 )
{
...
static int F_116 ( struct V_145 * V_74 , int V_53 )
{
T_10 V_190 ;
int V_191 , V_192 ;
...
sizeof( struct V_201 ) ) ;
F_117 ( V_74 , & V_180 -> V_181 [ V_53 ] ,
sizeof( struct V_201 ) ) ;
F_118 ( V_196 , V_74 -> V_146 + V_195 ) ;
return - V_52 ;
}
}
if ( V_190 & V_202 ) {
...
if ( V_190 & V_205 )
F_118 ( V_205 , V_74 -> V_146 + V_195 ) ;
return 0 ;
}
int F_119 ( struct V_201 * V_181 , struct V_145 * V_74 )
{
int V_206 ;
struct V_183 * V_180 = V_74 -> V_180 ;
...
V_207 [ V_53 ] = * V_181 ;
V_208 . V_199 = F_123 ( V_185 ) |
V_212 | V_213 ;
V_208 . V_200 = F_124 ( & V_180 -> V_182 [ V_193 ] ) ;
V_207 [ V_193 ] = V_208 ;
F_117 ( V_74 , & V_207 [ V_53 ] , sizeof( struct V_201 ) ) ;
F_117 ( V_74 , & V_207 [ V_193 ] , sizeof( struct V_201 ) ) ;
V_180 -> V_211 = ( V_180 -> V_211 + 2 ) % V_188 ;
V_180 -> V_189 -= 2 ;
F_118 ( V_180 -> V_211 << V_198 , V_74 -> V_146 + V_203 ) ;
while ( V_180 -> V_182 [ V_193 ] != V_185 ) {
V_206 = F_116 ( V_74 , V_53 ) ;
if ( V_206 )
break;
F_125 ( & V_180 -> V_210 ) ;
F_122 () ;
...
void F_128 ( struct V_145 * V_74 , T_2 V_215 , T_2 V_216 , T_5 V_217 ,
T_7 type )
{
struct V_201 V_181 ;
V_181 . V_199 = F_129 ( V_217 ) | F_130 ( V_216 ) | F_131 ( V_215 )
| F_132 ( type ) | V_218 ;
V_181 . V_200 = 0 ;
F_119 ( & V_181 , V_74 ) ;
}
void F_133 ( struct V_145 * V_74 , T_2 V_215 , T_7 V_129 ,
...
if ( F_135 ( V_74 -> V_132 ) )
V_221 = 1 ;
V_181 . V_199 = F_136 ( V_215 ) | F_137 ( V_221 ) | F_138 ( V_220 )
| F_139 ( type ) | V_223 ;
V_181 . V_200 = F_140 ( V_129 ) | F_141 ( V_222 )
| F_142 ( V_219 ) ;
F_119 ( & V_181 , V_74 ) ;
}
void F_143 ( struct V_145 * V_74 , T_2 V_216 , T_2 V_224 ,
...
V_181 . V_200 = F_144 ( V_129 ) | V_227 ;
} else
V_181 . V_200 = F_144 ( V_129 ) ;
if ( V_224 >= V_228 )
V_224 = 0 ;
V_181 . V_199 = F_145 ( V_216 ) | F_146 ( V_224 ) |
V_229 ;
F_119 ( & V_181 , V_74 ) ;
}
void F_147 ( struct V_145 * V_74 )
{
unsigned long V_73 ;
T_10 V_160 ;
T_11 V_230 = F_148 () ;
...
F_122 () ;
V_74 -> V_169 &= ~ V_174 ;
F_118 ( V_74 -> V_169 , V_74 -> V_146 + V_232 ) ;
F_150 ( V_74 , V_167 , F_105 ,
! ( V_160 & V_173 ) , V_160 ) ;
V_7:
F_121 ( & V_74 -> V_175 , V_73 ) ;
}
static void F_151 ( struct V_145 * V_74 )
{
T_10 V_160 ;
unsigned long V_73 ;
struct V_183 * V_180 = V_74 -> V_180 ;
...
V_180 -> V_189 = V_188 ;
F_120 ( & V_74 -> V_175 , V_73 ) ;
F_118 ( 0 , V_74 -> V_146 + V_203 ) ;
F_152 ( V_74 -> V_146 + V_233 , F_124 ( V_180 -> V_181 ) ) ;
V_74 -> V_169 |= V_174 ;
F_118 ( V_74 -> V_169 , V_74 -> V_146 + V_232 ) ;
F_150 ( V_74 , V_167 , F_105 , ( V_160 & V_173 ) , V_160 ) ;
F_121 ( & V_74 -> V_175 , V_73 ) ;
}
int F_153 ( struct V_145 * V_74 )
{
struct V_183 * V_180 ;
struct V_234 * V_235 ;
if ( ! F_149 ( V_74 -> V_133 ) )
...
if ( V_74 -> V_180 )
return 0 ;
V_74 -> V_180 = F_154 ( sizeof( * V_180 ) , V_237 ) ;
if ( ! V_74 -> V_180 )
return - V_39 ;
V_180 = V_74 -> V_180 ;
V_235 = F_155 ( V_74 -> V_86 , V_237 | V_238 , 0 ) ;
if ( ! V_235 ) {
F_10 ( V_180 ) ;
V_74 -> V_180 = NULL ;
return - V_39 ;
}
V_180 -> V_181 = F_156 ( V_235 ) ;
V_180 -> V_182 = F_13 ( V_188 * sizeof( int ) , V_237 ) ;
if ( ! V_180 -> V_182 ) {
F_114 ( ( unsigned long ) V_180 -> V_181 ) ;
F_10 ( V_180 ) ;
V_74 -> V_180 = NULL ;
return - V_39 ;
}
...
static const char * F_157 ( T_5 V_239 , int * V_240 )
{
if ( V_239 >= 0x20 && ( V_239 - 0x20 <
F_158 ( V_241 ) ) ) {
* V_240 = V_242 ;
return V_241 [ V_239 - 0x20 ] ;
} else if ( V_239 < F_158 ( V_243 ) ) {
* V_240 = V_244 ;
return V_243 [ V_239 ] ;
} else {
* V_240 = V_245 ;
...
void F_159 ( struct V_246 * V_62 )
{
struct V_145 * V_74 = F_160 ( V_62 ) ;
unsigned long V_247 ;
F_120 ( & V_74 -> V_175 , V_247 ) ;
F_118 ( 0 , V_74 -> V_146 + V_248 ) ;
F_105 ( V_74 -> V_146 + V_248 ) ;
F_121 ( & V_74 -> V_175 , V_247 ) ;
}
void F_161 ( struct V_246 * V_62 )
{
unsigned long V_247 ;
struct V_145 * V_74 = F_160 ( V_62 ) ;
F_120 ( & V_74 -> V_175 , V_247 ) ;
F_118 ( V_249 , V_74 -> V_146 + V_248 ) ;
F_105 ( V_74 -> V_146 + V_248 ) ;
F_121 ( & V_74 -> V_175 , V_247 ) ;
}
void F_162 ( int V_179 , struct V_250 * V_251 )
{
struct V_145 * V_74 = F_163 ( V_179 ) ;
unsigned long V_247 ;
F_120 ( & V_74 -> V_175 , V_247 ) ;
F_118 ( V_251 -> V_62 , V_74 -> V_146 + V_252 ) ;
F_118 ( V_251 -> V_253 , V_74 -> V_146 + V_254 ) ;
F_118 ( V_251 -> V_255 , V_74 -> V_146 + V_256 ) ;
F_121 ( & V_74 -> V_175 , V_247 ) ;
}
void F_164 ( int V_179 , struct V_250 * V_251 )
{
struct V_145 * V_74 = F_163 ( V_179 ) ;
unsigned long V_247 ;
F_120 ( & V_74 -> V_175 , V_247 ) ;
...
static int F_165 ( struct V_145 * V_74 , int type ,
T_5 V_239 , T_2 V_257 , unsigned long long V_129 )
{
const char * V_258 ;
int V_240 ;
V_258 = F_157 ( V_239 , & V_240 ) ;
if ( V_240 == V_242 )
F_71 ( L_43
L_44
L_45 ,
...
T_12 F_166 ( int V_179 , void * V_259 )
{
...
V_260 * V_265 ) ;
V_264 = F_172 ( V_264 ) ;
F_118 ( V_266 , V_74 -> V_146 + V_146 +
V_260 * V_265 + 12 ) ;
F_121 ( & V_74 -> V_175 , V_247 ) ;
F_165 ( V_74 , type , V_239 ,
V_257 , V_264 ) ;
V_260 ++ ;
if ( V_260 >= F_173 ( V_74 -> V_132 ) )
V_260 = 0 ;
F_120 ( & V_74 -> V_175 , V_247 ) ;
}
F_118 ( V_267 | V_262 , V_74 -> V_146 + V_195 ) ;
V_263:
F_121 ( & V_74 -> V_175 , V_247 ) ;
return V_268 ;
}
int F_174 ( struct V_145 * V_74 )
{
int V_179 , V_54 ;
if ( V_74 -> V_179 )
return 0 ;
...
V_54 = F_177 ( V_179 , F_166 , V_269 , V_74 -> V_152 , V_74 ) ;
if ( V_54 )
F_71 ( L_53 ) ;
return V_54 ;
}
...
F_166 ( V_74 -> V_179 , V_74 ) ;
V_261 = F_105 ( V_74 -> V_146 + V_195 ) ;
F_118 ( V_261 , V_74 -> V_146 + V_195 ) ;
}
return 0 ;
}
int F_180 ( struct V_145 * V_74 )
{
if ( ! F_149 ( V_74 -> V_133 ) )
return - V_236 ;
if ( ! V_74 -> V_180 )
...
F_184 ( & V_126 , & V_127 ) ;
F_36 ( & V_66 ) ;
F_185 (dmaru, dmaru_n, &dmar_drhd_units, list) {
F_186 ( & V_55 -> V_4 ) ;
F_42 ( V_55 ) ;
}
F_37 ( & V_66 ) ;
...
static inline bool F_187 ( T_6 V_272 , int V_273 )
{
return F_188 ( V_272 , V_274 , V_275 , 1 << V_273 ) ;
}
static int F_189 ( T_6 V_272 , int V_273 ,
...
if ( ! F_187 ( V_272 , V_273 ) )
return 0 ;
V_278 = F_190 ( V_272 , V_274 , V_275 ,
V_273 , NULL , V_284 ) ;
if ( ! V_278 )
return - V_118 ;
...
static int F_192 ( struct V_70 * V_58 , void * V_71 )
{
int V_54 ;
struct V_1 * V_55 ;
...
if ( ! V_55 )
return - V_118 ;
V_54 = F_193 ( V_55 , true ) ;
if ( V_54 == 0 )
V_54 = F_194 ( V_55 , true ) ;
return V_54 ;
}
static int F_195 ( struct V_70 * V_58 , void * V_71 )
{
int V_21 , V_54 ;
struct V_22 * V_26 ;
struct V_1 * V_55 ;
...
return - V_153 ;
V_54 = F_193 ( V_55 , false ) ;
if ( V_54 == 0 )
V_54 = F_194 ( V_55 , false ) ;
return V_54 ;
}
static int F_196 ( struct V_70 * V_58 , void * V_71 )
{
struct V_1 * V_55 ;
V_55 = F_38 ( (struct V_56 * ) V_58 ) ;
if ( V_55 ) {
...
static int F_198 ( T_6 V_272 )
{
int V_54 ;
int V_115 = 0 ;
V_54 = F_189 ( V_272 , V_281 ,
& F_80 , ( void * ) 1 ) ;
if ( V_54 )
goto V_72;
V_54 = F_189 ( V_272 , V_281 ,
...
V_54 = F_189 ( V_272 , V_283 ,
& F_48 , NULL ) ;
if ( V_54 )
goto V_287;
V_54 = F_189 ( V_272 , V_282 ,
& V_117 , NULL ) ;
if ( V_54 )
goto V_288;
V_54 = F_189 ( V_272 , V_281 ,
...
& F_195 , NULL ) ;
if ( V_54 == 0 ) {
F_200 ( F_189 ( V_272 , V_282 ,
& V_289 , NULL ) ) ;
F_200 ( F_189 ( V_272 , V_281 ,
& F_196 , NULL ) ) ;
} else {
F_189 ( V_272 , V_281 ,
& F_192 , NULL ) ;
...
static T_4 F_201 ( T_6 V_272 , T_10 V_291 ,
void * V_292 , void * * V_293 )
{
T_6 * V_294 = V_293 ;
if ( F_187 ( V_272 , V_281 ) ) {
* V_294 = V_272 ;
return V_295 ;
}
return V_99 ;
}
static int F_202 ( T_6 V_272 , bool V_296 )
{
int V_54 ;
T_6 V_30 = NULL ;
T_4 V_98 ;
...
int F_205 ( T_6 V_272 )
{
return F_202 ( V_272 , true ) ;
}
int F_206 ( T_6 V_272 )
{
return F_202 ( V_272 , false ) ;
}
