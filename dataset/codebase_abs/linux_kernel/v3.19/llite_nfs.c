...
struct V_33 * V_64 )
{
struct V_8 * V_65 = V_33 -> V_66 ;
int V_23 ;
struct V_58 V_59 = {
. V_62 = V_1 ,
. V_61 = F_5 ( V_64 -> V_66 ) -> V_10 ,
. V_52 . V_67 = F_33 ,
} ;
if ( ! V_65 || ! F_38 ( V_65 -> V_37 ) ) {
V_23 = - V_68 ;
goto V_69;
}
if ( ! V_65 -> V_70 ) {
...
static struct V_33 * F_43 ( struct V_12 * V_13 , struct V_14 * V_14 ,
int V_74 , int V_75 )
{
struct V_45 * V_46 = (struct V_45 * ) V_14 ;
if ( V_75 != V_50 )
...
static struct V_33 * F_44 ( struct V_33 * V_77 )
{
struct V_17 * V_18 = NULL ;
struct V_8 * V_65 = V_77 -> V_66 ;
struct V_15 * V_16 ;
...
if ( V_23 != 0 )
return F_14 ( V_23 ) ;
V_22 = F_46 ( NULL , V_65 , NULL , V_80 ,
strlen ( V_80 ) , V_81 ,
V_83 , NULL ) ;
if ( F_23 ( V_22 ) )
return ( void * ) V_22 ;
V_23 = F_47 ( V_16 -> V_32 , V_22 , & V_18 ) ;
F_48 ( V_22 ) ;
if ( V_23 ) {
F_18 ( L_11 , V_23 , V_65 -> V_47 ) ;
return F_14 ( V_23 ) ;
}
V_79 = F_49 ( & V_18 -> V_84 , & V_85 ) ;
F_45 ( V_79 -> V_86 & V_87 ) ;
F_10 ( V_24 , L_12 V_25 L_13 V_25 L_6 ,
F_11 ( F_32 ( V_65 ) ) , F_11 ( & V_79 -> V_88 ) ) ;
V_35 = F_21 ( V_65 -> V_82 , & V_79 -> V_88 , NULL ) ;
F_20 ( V_18 ) ;
return V_35 ;
}
