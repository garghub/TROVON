...
static int F_56 ( struct V_44 * V_44 , struct V_78 * V_78 )
{
int V_5 ;
...
return F_57 ( V_78 , & V_83 ) ;
}
static T_2 F_58 ( struct V_78 * V_78 , const char V_7 * V_84 ,
T_3 V_85 , T_1 * V_86 )
{
return F_59 ( V_78 , V_84 , V_85 , V_86 , F_34 ) ;
}
static int F_60 ( struct V_72 * V_73 , void * V_75 )
{
struct V_23 * V_16 = V_75 ;
F_54 ( V_73 , L_23 , V_16 -> V_45 ,
F_24 ( & V_16 -> V_33 . V_34 ) , V_16 -> V_87 ) ;
return 0 ;
}
static int F_61 ( struct V_44 * V_44 , struct V_78 * V_78 )
{
return F_57 ( V_78 , & V_88 ) ;
}
static int F_62 ( void )
{
int V_89 , V_90 ;
V_91 = F_63 ( struct V_91 ) ;
if ( V_91 == NULL )
return - V_32 ;
F_64 (cpu) {
struct V_92 * V_93 = F_65 ( F_66 ( V_89 ) ,
V_31 , 0 ) ;
if ( V_93 == NULL ) {
V_90 = V_89 ;
goto V_94;
}
F_67 ( V_91 , V_89 ) -> V_53 = F_68 ( V_93 ) ;
F_69 ( & F_67 ( V_91 , V_89 ) -> V_95 ) ;
}
return 0 ;
V_94:
F_64 (cpu) {
if ( V_89 == V_90 )
break;
F_70 ( ( unsigned long ) F_67 ( V_91 , V_89 ) -> V_53 ) ;
}
F_71 ( V_91 ) ;
return - V_32 ;
}
...
if ( -- V_97 == 0 ) {
F_64 (cpu)
F_70 ( ( unsigned long ) F_67 ( V_91 ,
V_89 ) -> V_53 ) ;
F_71 ( V_91 ) ;
V_91 = NULL ;
}
}
static struct V_91 * F_76 ( void )
{
struct V_91 * V_98 ;
int V_89 ;
V_89 = F_77 () ;
...
static void F_78 ( struct V_91 * V_98 )
{
F_33 ( & V_98 -> V_95 ) ;
}
static void F_79 ( struct V_23 * V_16 ,
...
F_80 ( V_34 != V_102 -> V_110 ) ;
if ( F_81 ( V_16 -> V_33 . V_70 + V_100 > V_111 ) )
return;
if ( F_82 ( V_102 ) )
return;
V_108 = F_83 ( F_11 ( V_16 ) ) ;
V_70 = V_108 + V_16 -> V_33 . V_70 + V_100 ;
V_27 = F_84 ( & V_84 , V_102 ,
...
if ( F_11 ( V_16 ) ) {
V_104 -> V_14 [ 0 ] = V_99 ;
V_104 -> V_14 [ 1 ] = F_86 ( V_4 ) ;
V_107 = F_87 ( V_104 , true ) ;
} else {
V_104 -> V_14 [ 0 ] = F_86 ( V_4 ) ;
V_107 = F_87 ( V_104 , false ) ;
}
memcpy ( V_107 , V_98 -> V_53 , V_16 -> V_33 . V_70 + V_100 ) ;
F_88 ( V_102 , V_84 , V_27 , V_104 , 0 , 0 ) ;
}
static int F_89 ( struct V_23 * V_16 , struct V_3 * V_4 ,
struct V_91 * V_98 , int V_100 )
{
struct V_112 * V_113 ;
if ( F_11 ( V_16 ) )
return 0 ;
F_90 () ;
F_91 (link, &tu->tp.files, list)
F_79 ( V_16 , 0 , V_4 , V_98 , V_100 , V_113 -> V_78 ) ;
F_92 () ;
return 0 ;
}
static void F_93 ( struct V_23 * V_16 , unsigned long V_99 ,
struct V_3 * V_4 ,
struct V_91 * V_98 , int V_100 )
{
struct V_112 * V_113 ;
F_90 () ;
F_91 (link, &tu->tp.files, list)
F_79 ( V_16 , V_99 , V_4 , V_98 , V_100 , V_113 -> V_78 ) ;
F_92 () ;
}
static enum V_114
F_94 ( struct V_115 * V_116 , int V_117 , struct V_118 * V_27 )
{
struct V_103 * V_104 ;
...
V_16 = F_95 ( V_27 , struct V_23 , V_33 . V_34 . V_27 ) ;
if ( F_11 ( V_16 ) ) {
F_96 ( V_120 , L_24 ,
F_24 ( & V_16 -> V_33 . V_34 ) ,
...
for ( V_42 = 0 ; V_42 < V_16 -> V_33 . V_43 ; V_42 ++ ) {
struct V_68 * V_69 = & V_16 -> V_33 . args [ V_42 ] ;
if ( ! V_69 -> type -> V_123 ( V_120 , V_69 -> V_36 , V_107 + V_69 -> V_17 , V_104 ) )
goto V_124;
}
F_97 ( V_120 , '\n' ) ;
V_124:
...
static int
F_99 ( struct V_23 * V_16 , struct V_101 * V_78 ,
T_5 V_19 )
{
bool V_125 = F_100 ( & V_16 -> V_33 ) ;
struct V_112 * V_113 = NULL ;
int V_5 ;
if ( V_78 ) {
if ( V_16 -> V_33 . V_117 & V_126 )
return - V_127 ;
V_113 = F_101 ( sizeof( * V_113 ) , V_31 ) ;
if ( ! V_113 )
return - V_32 ;
V_113 -> V_78 = V_78 ;
F_102 ( & V_113 -> V_37 , & V_16 -> V_33 . V_38 ) ;
...
goto V_129;
V_16 -> V_24 . V_19 = V_19 ;
V_5 = F_103 ( V_16 -> V_44 , V_16 -> V_17 , & V_16 -> V_24 ) ;
if ( V_5 )
goto V_130;
return 0 ;
V_130:
...
static void
F_104 ( struct V_23 * V_16 , struct V_101 * V_78 )
{
if ( ! F_100 ( & V_16 -> V_33 ) )
return;
if ( V_78 ) {
struct V_112 * V_113 ;
V_113 = F_105 ( & V_16 -> V_33 , V_78 ) ;
if ( ! V_113 )
return;
F_106 ( & V_113 -> V_37 ) ;
F_107 () ;
...
F_80 ( ! F_9 ( & V_16 -> V_19 ) ) ;
F_108 ( V_16 -> V_44 , V_16 -> V_17 , & V_16 -> V_24 ) ;
...
if ( F_11 ( V_16 ) ) {
F_110 (unsigned long, vaddr[0], FIELD_STRING_FUNC, 0 ) ;
F_110 (unsigned long, vaddr[1], FIELD_STRING_RETIP, 0 ) ;
V_70 = F_83 ( true ) ;
} else {
F_110 (unsigned long, vaddr[0], FIELD_STRING_IP, 0 ) ;
V_70 = F_83 ( false ) ;
}
for ( V_42 = 0 ; V_42 < V_16 -> V_33 . V_43 ; V_42 ++ ) {
struct V_68 * V_69 = & V_16 -> V_33 . args [ V_42 ] ;
V_5 = F_111 ( V_110 , V_69 -> type -> V_132 ,
V_69 -> V_36 , V_70 + V_69 -> V_17 ,
V_69 -> type -> V_70 , V_69 -> type -> V_133 ,
V_134 ) ;
if ( V_5 )
return V_5 ;
}
...
static bool
F_112 ( struct V_18 * V_19 , struct V_135 * V_136 )
{
struct V_137 * V_27 ;
if ( V_19 -> V_21 )
return true ;
...
static inline bool
F_113 ( struct V_23 * V_16 , struct V_137 * V_27 )
{
return F_112 ( & V_16 -> V_19 , V_27 -> V_138 . V_139 -> V_136 ) ;
}
static int F_114 ( struct V_23 * V_16 , struct V_137 * V_27 )
{
bool V_140 ;
...
if ( ! V_140 )
return F_117 ( V_16 -> V_44 , V_16 -> V_17 , & V_16 -> V_24 , false ) ;
return 0 ;
}
static int F_118 ( struct V_23 * V_16 , struct V_137 * V_27 )
{
bool V_140 ;
int V_94 ;
F_115 ( & V_16 -> V_19 . V_20 ) ;
...
F_113 ( V_16 , V_27 ) ;
F_119 ( & V_27 -> V_138 . V_141 , & V_16 -> V_19 . V_22 ) ;
} else {
V_140 = V_16 -> V_19 . V_21 ;
V_16 -> V_19 . V_21 ++ ;
}
...
V_94 = 0 ;
if ( ! V_140 ) {
V_94 = F_117 ( V_16 -> V_44 , V_16 -> V_17 , & V_16 -> V_24 , true ) ;
if ( V_94 )
F_114 ( V_16 , V_27 ) ;
}
return V_94 ;
}
static bool F_120 ( struct V_146 * V_147 ,
enum V_148 V_149 , struct V_135 * V_136 )
{
struct V_23 * V_16 ;
int V_5 ;
V_16 = F_95 ( V_147 , struct V_23 , V_24 ) ;
F_121 ( & V_16 -> V_19 . V_20 ) ;
V_5 = F_112 ( & V_16 -> V_19 , V_136 ) ;
F_122 ( & V_16 -> V_19 . V_20 ) ;
return V_5 ;
}
static void F_123 ( struct V_23 * V_16 ,
unsigned long V_99 , struct V_3 * V_4 ,
struct V_91 * V_98 , int V_100 )
{
struct V_109 * V_34 = & V_16 -> V_33 . V_34 ;
...
V_108 = F_83 ( F_11 ( V_16 ) ) ;
V_70 = V_108 + V_16 -> V_33 . V_70 + V_100 ;
V_70 = F_124 ( V_70 + sizeof( V_153 ) , sizeof( V_154 ) ) - sizeof( V_153 ) ;
if ( F_125 ( V_70 > V_155 , L_26 ) )
return;
F_126 () ;
V_151 = F_127 ( V_34 -> V_22 ) ;
if ( F_128 ( V_151 ) )
goto V_124;
V_104 = F_129 ( V_70 , V_34 -> V_27 . type , V_4 , & V_152 ) ;
if ( ! V_104 )
goto V_124;
if ( F_11 ( V_16 ) ) {
V_104 -> V_14 [ 0 ] = V_99 ;
...
int V_156 = V_16 -> V_33 . V_70 + V_100 ;
memset ( V_107 + V_156 , 0 , V_70 - V_108 - V_156 ) ;
}
F_130 ( V_104 , V_70 , V_152 , 0 , 1 , V_4 , V_151 , NULL ) ;
V_124:
F_131 () ;
}
static int F_132 ( struct V_23 * V_16 , struct V_3 * V_4 ,
struct V_91 * V_98 , int V_100 )
{
if ( ! F_120 ( & V_16 -> V_24 , 0 , V_12 -> V_136 ) )
return V_157 ;
if ( ! F_11 ( V_16 ) )
F_123 ( V_16 , 0 , V_4 , V_98 , V_100 ) ;
return 0 ;
}
static void F_133 ( struct V_23 * V_16 , unsigned long V_99 ,
struct V_3 * V_4 ,
struct V_91 * V_98 , int V_100 )
{
F_123 ( V_16 , V_99 , V_4 , V_98 , V_100 ) ;
}
static int
F_134 ( struct V_109 * V_27 , enum V_158 type ,
void * V_107 )
{
...
switch ( type ) {
case V_159 :
return F_99 ( V_16 , V_78 , NULL ) ;
case V_160 :
F_104 ( V_16 , V_78 ) ;
return 0 ;
#ifdef F_135
case V_161 :
return F_99 ( V_16 , NULL , F_120 ) ;
case V_162 :
F_104 ( V_16 , NULL ) ;
return 0 ;
case V_163 :
return F_118 ( V_16 , V_107 ) ;
case V_164 :
return F_114 ( V_16 , V_107 ) ;
#endif
default:
return 0 ;
}
...
int V_100 , V_108 ;
int V_5 = 0 ;
V_16 = F_95 ( V_165 , struct V_23 , V_24 ) ;
V_16 -> V_87 ++ ;
V_11 . V_16 = V_16 ;
V_11 . V_15 = F_86 ( V_4 ) ;
...
if ( F_81 ( ! V_91 ) )
return 0 ;
V_100 = F_136 ( & V_16 -> V_33 , V_4 ) ;
V_108 = F_83 ( F_11 ( V_16 ) ) ;
V_98 = F_76 () ;
F_137 ( V_108 , & V_16 -> V_33 , V_4 , V_98 -> V_53 , V_100 ) ;
if ( V_16 -> V_33 . V_117 & V_128 )
V_5 |= F_89 ( V_16 , V_4 , V_98 , V_100 ) ;
#ifdef F_135
if ( V_16 -> V_33 . V_117 & V_126 )
V_5 |= F_132 ( V_16 , V_4 , V_98 , V_100 ) ;
#endif
F_78 ( V_98 ) ;
return V_5 ;
}
...
F_137 ( V_108 , & V_16 -> V_33 , V_4 , V_98 -> V_53 , V_100 ) ;
if ( V_16 -> V_33 . V_117 & V_128 )
F_93 ( V_16 , V_99 , V_4 , V_98 , V_100 ) ;
#ifdef F_135
if ( V_16 -> V_33 . V_117 & V_126 )
F_133 ( V_16 , V_99 , V_4 , V_98 , V_100 ) ;
#endif
F_78 ( V_98 ) ;
return 0 ;
}
...
V_34 -> V_35 -> V_169 = F_109 ;
if ( F_138 ( & V_16 -> V_33 , F_11 ( V_16 ) ) < 0 )
return - V_32 ;
V_5 = F_139 ( & V_34 -> V_27 ) ;
if ( ! V_5 ) {
F_18 ( V_34 -> V_170 ) ;
...
static T_6 int F_143 ( void )
{
struct V_62 * V_173 ;
V_173 = F_144 () ;
if ( ! V_173 )
return 0 ;
F_145 ( L_28 , 0644 , V_173 ,
NULL , & V_174 ) ;
F_145 ( L_29 , 0444 , V_173 ,
NULL , & V_175 ) ;
return 0 ;
}
