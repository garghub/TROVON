...
static int F_70 ( struct V_21 * V_22 , T_4 V_165 )
{
struct V_68 V_69 ;
int V_79 ;
memset ( & V_69 , 0 , sizeof( struct V_68 ) ) ;
...
static int F_80 ( struct V_6 * V_170 )
{
struct V_136 * V_137 ;
int V_171 = V_172 ;
V_137 = F_81 ( sizeof( struct V_136 ) , V_173 ) ;
if ( ! V_137 )
return - V_174 ;
V_137 -> V_175 =
F_82 ( F_83 ( & V_170 -> V_176 ) ,
sizeof( struct V_76 ) , 0 ,
V_177 , NULL ) ;
if ( ! V_137 -> V_175 )
goto V_178;
V_137 -> V_151 = F_84 ( V_171 , V_179 ,
V_180 ,
V_137 -> V_175 ) ;
if ( ! V_137 -> V_151 )
goto V_181;
...
static void F_86 ( struct V_6 * V_170 )
{
...
static int F_88 ( struct V_6 * V_170 )
{
F_89 ( V_170 , V_182 ) ;
F_90 ( V_170 -> V_183 , V_38 ) ;
F_91 ( V_170 -> V_183 , V_184 ) ;
F_92 ( V_170 -> V_183 , ( V_185 * V_90 ) ) ;
V_170 -> V_186 = 1 ;
V_170 -> V_187 |= V_188 ;
return 0 ;
}
static int F_93 ( struct V_6 * V_7 , struct V_189 * V_190 ,
T_6 V_191 , int * V_192 )
{
T_6 V_193 = V_191 ;
T_6 V_194 = V_193 ;
...
V_195 = 0xff ;
V_196 = 0x3f ;
F_94 ( V_194 , V_195 * V_196 ) ;
if ( ( T_6 ) ( V_194 + 1 ) * V_195 * V_196 < V_193 )
V_194 = 0xffff ;
V_192 [ 0 ] = V_195 ;
V_192 [ 1 ] = V_196 ;
V_192 [ 2 ] = ( int ) V_194 ;
...
static enum V_202 F_96 ( struct V_112 * V_113 )
{
return V_203 ;
}
...
{
bool V_204 = true ;
T_3 V_205 = V_113 -> V_120 [ 0 ] ;
switch ( V_205 ) {
case V_206 :
case V_207 :
V_113 -> V_142 = V_208 << 16 ;
V_204 = false ;
break;
default:
break;
...
V_209 = sizeof( struct V_76 ) ;
V_130 = F_99 ( V_137 -> V_151 ,
V_46 ) ;
if ( ! V_130 )
return V_211 ;
...
case V_218 :
V_111 -> V_140 = V_44 ;
V_111 -> V_212 . V_214 |= V_219 ;
break;
case V_220 :
V_111 -> V_140 = V_141 ;
V_111 -> V_212 . V_214 |= V_221 ;
break;
default:
V_111 -> V_140 = V_222 ;
V_111 -> V_212 . V_214 |= ( V_221 |
...
V_111 -> V_223 = V_133 -> V_224 ;
V_111 -> V_199 = V_113 -> V_22 -> V_82 ;
V_111 -> V_225 = V_113 -> V_22 -> V_11 ;
V_111 -> V_5 = V_113 -> V_22 -> V_5 ;
V_111 -> V_226 = V_113 -> V_227 ;
memcpy ( V_111 -> V_153 , V_113 -> V_120 , V_111 -> V_226 ) ;
V_130 -> V_144 = V_113 -> V_144 ;
V_130 -> V_147 . V_39 = F_100 ( V_113 ) ;
if ( F_59 ( V_113 ) ) {
...
struct V_114 * V_8 ;
struct V_132 * V_133 ;
bool V_234 = ( ( V_233 -> V_235 == V_236 ) ? true : false ) ;
int V_237 = 0 ;
struct V_20 * V_23 ;
switch ( V_105 ) {
case V_107 :
...
V_133 -> V_224 = V_8 -> V_248 ;
V_133 -> V_25 = V_22 ;
V_23 = F_81 ( sizeof( struct V_20 ) , V_173 ) ;
if ( ! V_23 ) {
V_79 = - V_174 ;
goto V_249;
}
...
V_23 -> V_8 = V_8 ;
F_74 ( V_22 , V_23 ) ;
V_23 -> V_223 = V_8 -> V_248 ;
V_79 = F_70 ( V_22 , V_71 ) ;
if ( V_79 )
goto V_250;
V_133 -> V_251 = V_23 -> V_199 ;
V_133 -> V_237 = V_23 -> V_225 ;
switch ( V_233 -> V_235 ) {
case V_244 :
V_8 -> V_252 = V_253 ;
V_8 -> V_13 = V_247 ;
...
V_237 = ( V_22 -> V_266 . V_267 [ 5 ] << 8 |
V_22 -> V_266 . V_267 [ 4 ] ) ;
V_79 = F_108 ( V_8 , 0 , V_237 , 0 ) ;
if ( V_79 ) {
F_109 ( V_8 ) ;
goto V_265;
}
