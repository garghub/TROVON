...
F_101 ( V_54 ) ;
F_102 ( V_54 , V_88 ) ;
V_165 = F_103 ( F_104 ( V_54 ) , V_206 , V_88 ) ;
if ( V_165 ) {
F_39 ( V_54 ) ;
return V_165 ;
}
...
V_209 [ 0 ] = ( ( V_25 -> V_49 >> 8 ) & 0x0F ) | V_223 ;
...
unsigned char V_226 [ V_222 ] ;
struct V_53 * V_227 ;
int V_228 ;
int V_229 ;
F_108 ( V_54 , V_226 , V_222 ) ;
F_105 ( V_54 , V_222 ) ;
V_228 = F_109 ( V_54 ) ;
while ( V_54 -> V_88 > 0 ) {
if ( ( V_227 = F_99 ( V_19 , V_228 + F_107 , 0 , & V_165 ) ) == NULL ) {
F_39 ( V_54 ) ;
return V_165 ;
}
V_227 -> V_19 = V_19 ;
...
V_227 -> V_230 = 1 ;
F_100 ( V_227 , V_228 ) ;
V_229 = ( F_107 > V_54 -> V_88 ) ? V_54 -> V_88 : F_107 ;
F_108 ( V_54 , F_102 ( V_227 , V_229 ) , V_229 ) ;
F_105 ( V_54 , V_229 ) ;
F_106 ( V_227 , V_222 ) ;
F_110 ( V_227 , V_226 , V_222 ) ;
if ( V_54 -> V_88 > 0 )
V_227 -> V_52 [ 2 ] |= F_55 ;
F_111 ( & V_19 -> V_231 , V_227 ) ;
}
V_54 -> free = 1 ;
F_39 ( V_54 ) ;
} else {
F_111 ( & V_19 -> V_231 , V_54 ) ;
}
#else
F_111 ( & V_19 -> V_231 , V_54 ) ;
#endif
...
unsigned char * V_209 ;
struct V_53 * V_54 ;
int V_146 , V_233 , V_211 ;
if ( V_19 -> V_45 != V_128 )
return - V_188 ;
if ( ( V_54 = F_114 ( V_19 , V_162 & ~ V_213 , V_162 & V_213 , & V_233 ) ) == NULL )
return V_233 ;
V_211 = ( V_54 -> V_52 [ 0 ] & V_225 ) == V_225 ;
F_105 ( V_54 , V_222 ) ;
if ( V_25 -> V_86 ) {
V_209 = F_106 ( V_54 , 1 ) ;
* V_209 = V_211 ;
...
F_115 ( V_54 , 0 , V_206 , V_232 ) ;
if ( V_206 -> V_208 ) {
struct V_143 * V_187 ;
F_97 ( struct V_148 * , V_235 ,
V_206 -> V_208 ) ;
...
V_187 -> V_151 = V_25 -> V_90 ;
for ( V_146 = 0 ; V_146 < V_25 -> V_90 ; V_146 ++ )
V_235 -> V_160 [ V_146 ] = V_25 -> V_95 [ V_146 ] ;
V_206 -> V_218 = sizeof( struct V_148 ) ;
}
F_116 ( V_19 , V_54 ) ;
return V_232 ;
}
static int F_117 ( struct V_63 * V_18 , unsigned int V_236 , unsigned long V_237 )
{
struct V_18 * V_19 = V_18 -> V_19 ;
struct V_24 * V_25 = F_14 ( V_19 ) ;
void T_3 * V_238 = ( void T_3 * ) V_237 ;
switch ( V_236 ) {
case V_239 : {
long V_240 ;
V_240 = V_19 -> V_127 - F_118 ( V_19 ) ;
if ( V_240 < 0 )
V_240 = 0 ;
return F_48 ( V_240 , ( unsigned int T_3 * ) V_238 ) ;
}
case V_241 : {
struct V_53 * V_54 ;
long V_240 = 0L ;
...
case V_242 :
return F_120 ( V_19 , (struct V_243 T_3 * ) V_238 ) ;
case V_244 :
return F_121 ( V_19 , (struct V_245 T_3 * ) V_238 ) ;
case V_246 :
case V_247 :
case V_248 :
case V_249 :
...
if ( ! F_74 ( V_259 ) )
return - V_260 ;
return F_122 ( V_236 , V_238 ) ;
case V_261 : {
struct V_262 V_263 ;
V_263 . V_163 = V_25 -> V_163 ;
V_263 . V_164 = V_25 -> V_164 ;
return F_49 ( V_238 , & V_263 , sizeof( struct V_262 ) ) ? - V_72 : 0 ;
}
case V_264 : {
struct V_262 V_263 ;
if ( F_123 ( & V_263 , V_238 , sizeof( struct V_262 ) ) )
return - V_72 ;
V_25 -> V_163 = V_263 . V_163 ;
V_25 -> V_164 = V_263 . V_164 ;
return 0 ;
}
case V_265 :
if ( ! F_74 ( V_259 ) ) return - V_260 ;
if ( F_26 ( & V_266 , & V_48 ) != 0 )
F_124 ( & V_266 , NULL ) ;
if ( F_123 ( & V_266 , V_238 , sizeof( T_2 ) ) )
return - V_72 ;
if ( F_26 ( & V_266 , & V_48 ) != 0 )
return F_125 ( & V_266 , NULL ) ;
return 0 ;
case V_267 :
return F_49 ( V_238 , & V_266 , sizeof( T_2 ) ) ? - V_72 : 0 ;
case V_268 :
if ( V_25 -> V_57 == V_133 ) {
F_66 ( V_19 , V_196 ) ;
F_94 ( V_19 ) ;
...
static void * F_126 ( struct V_270 * V_271 , T_6 * V_272 )
__acquires( V_20 )
{
F_9 ( & V_20 ) ;
return F_127 ( & V_40 , * V_272 ) ;
}
static void * F_128 ( struct V_270 * V_271 , void * V_273 , T_6 * V_272 )
{
return F_129 ( V_273 , & V_40 , V_272 ) ;
}
static void F_130 ( struct V_270 * V_271 , void * V_273 )
__releases( V_20 )
{
F_11 ( & V_20 ) ;
}
static int F_131 ( struct V_270 * V_271 , void * V_273 )
{
char V_10 [ 11 ] , V_274 [ 11 ] ;
if ( V_273 == V_275 )
F_132 ( V_271 ,
L_3 ) ;
else {
struct V_18 * V_23 = F_133 ( V_273 ) ;
struct V_24 * V_25 = F_14 ( V_23 ) ;
const char * V_276 , * V_277 ;
...
F_118 ( V_23 ) ,
F_137 ( V_23 ) ,
V_23 -> V_280 ? F_138 ( V_23 -> V_280 ) -> V_281 : 0L ) ;
}
return 0 ;
}
static int F_139 ( struct V_282 * V_282 , struct V_283 * V_283 )
{
return F_140 ( V_283 , & V_284 ) ;
}
static int T_7 F_141 ( void )
{
int V_15 ;
int V_285 ;
if ( V_286 > 0x7FFFFFFF / sizeof( struct V_1 * ) ) {
F_142 ( V_287 L_8 ) ;
V_285 = - V_71 ;
goto V_288;
}
...
goto V_288;
V_266 = V_48 ;
V_289 = F_144 ( V_286 * sizeof( struct V_1 * ) , V_290 ) ;
if ( V_289 == NULL ) {
F_142 ( V_287 L_9 ) ;
V_285 = - V_108 ;
goto V_291;
}
for ( V_15 = 0 ; V_15 < V_286 ; V_15 ++ ) {
struct V_1 * V_2 ;
char V_278 [ V_292 ] ;
sprintf ( V_278 , L_10 , V_15 ) ;
V_2 = F_145 ( 0 , V_278 , V_293 , V_294 ) ;
if ( ! V_2 ) {
F_142 ( V_287 L_11 ) ;
V_285 = - V_108 ;
goto V_295;
...
F_154 () ;
F_155 () ;
F_156 ( L_13 , V_300 , V_35 . V_301 , & V_302 ) ;
F_156 ( L_14 , V_300 , V_35 . V_301 ,
& V_303 ) ;
F_156 ( L_15 , V_300 , V_35 . V_301 ,
& V_304 ) ;
F_156 ( L_16 , V_300 , V_35 . V_301 ,
& V_305 ) ;
V_288:
return V_285 ;
V_295:
...
{
int V_15 ;
F_161 ( L_13 , V_35 . V_301 ) ;
F_161 ( L_14 , V_35 . V_301 ) ;
F_161 ( L_15 , V_35 . V_301 ) ;
F_161 ( L_16 , V_35 . V_301 ) ;
F_162 () ;
F_163 () ;
F_164 ( V_306 ) ;
F_165 ( & V_299 ) ;
