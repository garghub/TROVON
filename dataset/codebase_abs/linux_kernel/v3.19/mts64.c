...
static int F_75 ( struct V_110 * V_116 )
{
struct V_5 * V_6 ;
struct V_13 * V_14 ;
int V_117 = V_116 -> V_118 ;
struct V_3 * V_4 = NULL ;
struct V_1 * V_2 = NULL ;
int V_69 ;
V_14 = F_71 ( V_116 ) ;
...
if ( ( V_69 = F_61 ( V_14 ) ) < 0 )
return V_69 ;
V_69 = F_76 ( & V_116 -> V_117 , V_122 [ V_117 ] , V_118 [ V_117 ] , V_123 ,
0 , & V_4 ) ;
if ( V_69 < 0 ) {
F_43 ( L_9 ) ;
return V_69 ;
}
strcpy ( V_4 -> V_124 , V_109 ) ;
strcpy ( V_4 -> V_125 , L_10 V_92 ) ;
sprintf ( V_4 -> V_126 , L_11 ,
V_4 -> V_125 , V_14 -> V_127 , V_14 -> V_128 ) ;
V_6 = F_62 ( V_14 ,
V_109 ,
NULL ,
NULL ,
...
F_78 ( V_132 L_17 , V_14 -> V_127 ) ;
return 0 ;
V_130:
F_79 ( V_4 ) ;
return V_69 ;
}
static int F_80 ( struct V_110 * V_116 )
{
struct V_3 * V_4 = F_71 ( V_116 ) ;
if ( V_4 )
F_79 ( V_4 ) ;
return 0 ;
}
