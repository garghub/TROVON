...
unsigned long F_96 ( unsigned long V_19 ,
...
static inline struct V_1 * F_103 ( struct V_1 * V_2 ,
T_7 V_3 )
{
V_3 &= V_123 ;
F_104 ( V_3 ) ;
F_105 ( V_3 & V_124 ) ;
if ( F_106 ( V_2 -> V_19 , V_3 , V_2 -> V_3 ) )
return NULL ;
return F_107 ( V_2 , V_3 ) ;
}
static inline void F_108 ( struct V_1 * V_2 ,
T_7 V_3 , void * V_10 )
{
V_3 &= V_123 ;
F_109 ( V_2 , V_3 , V_10 , F_22 ( V_2 ) ) ;
F_110 ( V_10 , V_2 -> V_19 , 1 , V_2 -> V_3 , V_3 ) ;
F_111 ( V_2 ) ;
}
static inline void F_112 ( struct V_1 * V_2 , void * V_27 )
{
F_113 ( V_27 , V_2 -> V_3 ) ;
...
static inline struct V_9 * F_117 ( struct V_1 * V_2 ,
T_7 V_3 , int V_108 , struct V_26 V_128 )
{
struct V_9 * V_9 ;
int V_23 = F_25 ( V_128 ) ;
V_3 |= V_129 ;
if ( F_118 ( V_2 , V_3 , V_23 ) )
return NULL ;
if ( V_108 == V_130 )
V_9 = F_119 ( V_3 , V_23 ) ;
else
V_9 = F_120 ( V_108 , V_3 , V_23 ) ;
if ( ! V_9 )
F_121 ( V_2 , V_23 ) ;
return V_9 ;
}
static struct V_9 * F_122 ( struct V_1 * V_2 , T_7 V_3 , int V_108 )
{
struct V_9 * V_9 ;
...
V_9 = F_117 ( V_2 , V_131 , V_108 , V_128 ) ;
if ( F_3 ( ! V_9 ) ) {
V_128 = V_2 -> V_136 ;
V_131 = V_3 ;
V_9 = F_117 ( V_2 , V_131 , V_108 , V_128 ) ;
...
F_124 ( V_9 , F_25 ( V_128 ) , V_131 , V_108 ) ;
if ( V_2 -> F_97 )
F_125 ( V_9 , V_140 ) ;
else
F_126 ( V_9 , V_140 ) ;
...
static void F_130 ( struct V_1 * V_2 , struct V_9 * V_9 ,
void * V_10 )
{
F_93 ( V_2 , V_9 , V_10 ) ;
if ( F_3 ( V_2 -> F_97 ) )
...
static struct V_9 * F_131 ( struct V_1 * V_2 , T_7 V_3 , int V_108 )
{
struct V_9 * V_9 ;
void * V_89 ;
void * V_5 ;
...
F_137 (p, idx, s, start, page->objects) {
F_130 ( V_2 , V_9 , V_5 ) ;
...
static void F_145 ( struct V_152 * V_153 )
{
struct V_9 * V_9 ;
if ( V_154 )
V_9 = F_146 ( V_153 ) ;
else
V_9 = F_147 ( (struct V_155 * ) V_153 , struct V_9 , V_106 ) ;
F_138 ( V_9 -> V_148 , V_9 ) ;
}
static void F_148 ( struct V_1 * V_2 , struct V_9 * V_9 )
{
if ( F_3 ( V_2 -> V_3 & V_20 ) ) {
struct V_152 * V_156 ;
if ( V_154 ) {
...
{
F_90 ( V_2 , F_134 ( V_9 ) , V_9 -> V_12 ) ;
F_148 ( V_2 , V_9 ) ;
}
static inline void
F_151 ( struct V_104 * V_38 , struct V_9 * V_9 , int V_157 )
{
V_38 -> V_158 ++ ;
if ( V_157 == V_159 )
F_152 ( & V_9 -> V_106 , & V_38 -> V_160 ) ;
else
F_79 ( & V_9 -> V_106 , & V_38 -> V_160 ) ;
}
static inline void F_153 ( struct V_104 * V_38 ,
struct V_9 * V_9 , int V_157 )
{
F_78 ( & V_38 -> V_105 ) ;
F_151 ( V_38 , V_9 , V_157 ) ;
}
static inline void
F_154 ( struct V_104 * V_38 , struct V_9 * V_9 )
{
F_81 ( & V_9 -> V_106 ) ;
V_38 -> V_158 -- ;
}
static inline void F_155 ( struct V_104 * V_38 ,
struct V_9 * V_9 )
{
F_78 ( & V_38 -> V_105 ) ;
F_154 ( V_38 , V_9 ) ;
...
static void * F_158 ( struct V_1 * V_2 , struct V_104 * V_38 ,
...
return NULL ;
F_159 ( & V_38 -> V_105 ) ;
F_160 (page, page2, &n->partial, lru) {
void * V_70 ;
if ( ! F_161 ( V_9 , V_3 ) )
continue;
V_70 = F_156 ( V_2 , V_38 , V_9 , V_10 == NULL , & V_12 ) ;
if ( ! V_70 )
break;
V_166 += V_12 ;
if ( ! V_10 ) {
...
static void * F_164 ( struct V_1 * V_2 , T_7 V_3 ,
struct V_163 * V_164 )
{
#ifdef F_165
struct V_170 * V_170 ;
struct V_171 * V_172 ;
struct V_173 * V_173 ;
enum V_174 V_175 = F_166 ( V_3 ) ;
void * V_10 ;
unsigned int V_176 ;
if ( ! V_2 -> V_177 ||
F_167 () % 1024 > V_2 -> V_177 )
return NULL ;
do {
V_176 = F_168 () ;
V_170 = F_169 ( F_170 () , V_3 ) ;
F_171 (zone, z, zonelist, high_zoneidx) {
struct V_104 * V_38 ;
V_38 = F_83 ( V_2 , F_172 ( V_173 ) ) ;
if ( V_38 && F_173 ( V_173 , V_3 ) &&
V_38 -> V_158 > V_2 -> V_178 ) {
V_10 = F_158 ( V_2 , V_38 , V_164 , V_3 ) ;
if ( V_10 ) {
return V_10 ;
}
}
...
static void * F_175 ( struct V_1 * V_2 , T_7 V_3 , int V_108 ,
struct V_163 * V_164 )
{
void * V_10 ;
int V_179 = V_108 ;
...
V_179 = F_178 ( V_108 ) ;
V_10 = F_158 ( V_2 , F_83 ( V_2 , V_179 ) , V_164 , V_3 ) ;
if ( V_10 || V_108 != V_130 )
return V_10 ;
return F_164 ( V_2 , V_3 , V_164 ) ;
}
static inline unsigned long F_179 ( unsigned long V_180 )
{
return V_180 + V_181 ;
}
static inline unsigned int F_180 ( unsigned long V_180 )
{
return V_180 % V_181 ;
}
static inline unsigned long F_181 ( unsigned long V_180 )
{
return V_180 / V_181 ;
}
static inline unsigned int F_182 ( int V_63 )
{
return V_63 ;
}
static inline void F_183 ( const char * V_38 ,
const struct V_1 * V_2 , unsigned long V_180 )
{
#ifdef F_38
unsigned long V_182 = F_184 ( V_2 -> V_8 -> V_180 ) ;
F_39 ( L_46 , V_38 , V_2 -> V_44 ) ;
#ifdef F_185
if ( F_180 ( V_180 ) != F_180 ( V_182 ) )
F_186 ( L_47 ,
F_180 ( V_180 ) , F_180 ( V_182 ) ) ;
else
#endif
if ( F_181 ( V_180 ) != F_181 ( V_182 ) )
F_186 ( L_48 ,
F_181 ( V_180 ) , F_181 ( V_182 ) ) ;
else
F_186 ( L_49 ,
V_182 , V_180 , F_179 ( V_180 ) ) ;
#endif
F_9 ( V_2 , V_183 ) ;
}
...
int V_63 ;
F_188 (cpu)
F_189 ( V_2 -> V_8 , V_63 ) -> V_180 = F_182 ( V_63 ) ;
}
static void F_190 ( struct V_1 * V_2 , struct V_9 * V_9 ,
void * V_42 )
{
enum T_8 { V_184 , V_185 , V_186 , V_187 };
struct V_104 * V_38 = F_83 ( V_2 , F_134 ( V_9 ) ) ;
int V_188 = 0 ;
...
static void F_162 ( struct V_1 * V_2 , struct V_9 * V_9 , int V_204 )
{
#ifdef F_5
struct V_9 * V_205 ;
int V_140 ;
...
V_9 -> V_206 = V_206 ;
V_9 -> V_202 = V_205 ;
} while ( F_194 ( V_2 -> V_8 -> V_160 , V_205 , V_9 )
!= V_205 );
#endif
}
static inline void F_195 ( struct V_1 * V_2 , struct V_163 * V_164 )
{
F_9 ( V_2 , V_208 ) ;
F_190 ( V_2 , V_164 -> V_9 , V_164 -> V_42 ) ;
V_164 -> V_180 = F_179 ( V_164 -> V_180 ) ;
V_164 -> V_9 = NULL ;
V_164 -> V_42 = NULL ;
}
static inline void F_196 ( struct V_1 * V_2 , int V_63 )
{
struct V_163 * V_164 = F_189 ( V_2 -> V_8 , V_63 ) ;
if ( F_87 ( V_164 ) ) {
if ( V_164 -> V_9 )
F_195 ( V_2 , V_164 ) ;
F_191 ( V_2 , V_164 ) ;
...
static void F_197 ( void * V_209 )
{
struct V_1 * V_2 = V_209 ;
F_196 ( V_2 , F_51 () ) ;
}
static bool F_198 ( int V_63 , void * V_210 )
{
...
{
F_200 ( F_198 , F_197 , V_2 , 1 , V_211 ) ;
}
static inline int F_201 ( struct V_9 * V_9 , int V_108 )
{
#ifdef F_165
if ( ! V_9 || ( V_108 != V_130 && F_134 ( V_9 ) != V_108 ) )
return 0 ;
#endif
return 1 ;
}
static int F_202 ( struct V_9 * V_9 )
{
return V_9 -> V_12 - V_9 -> V_22 ;
}
static inline unsigned long F_203 ( struct V_104 * V_38 )
{
return F_84 ( & V_38 -> V_110 ) ;
}
static unsigned long F_204 ( struct V_104 * V_38 ,
int (* F_205)( struct V_9 * ) )
{
unsigned long V_3 ;
unsigned long V_27 = 0 ;
struct V_9 * V_9 ;
F_206 ( & V_38 -> V_105 , V_3 ) ;
F_207 (page, &n->partial, lru)
V_27 += F_205 ( V_9 ) ;
F_208 ( & V_38 -> V_105 , V_3 ) ;
return V_27 ;
}
static T_5 void
F_209 ( struct V_1 * V_2 , T_7 V_212 , int V_213 )
{
#ifdef F_2
static F_210 ( V_214 , V_215 ,
V_216 ) ;
int V_108 ;
struct V_104 * V_38 ;
if ( ( V_212 & V_133 ) || ! F_211 ( & V_214 ) )
return;
F_186 ( L_52 ,
V_213 , V_212 ) ;
F_186 ( L_53 ,
...
F_25 ( V_2 -> V_136 ) ) ;
if ( F_25 ( V_2 -> V_136 ) > F_212 ( V_2 -> V_19 ) )
F_186 ( L_54 ,
V_2 -> V_44 ) ;
F_213 (s, node, n) {
unsigned long V_109 ;
...
static inline void * F_214 ( struct V_1 * V_2 , T_7 V_3 ,
int V_108 , struct V_163 * * V_219 )
{
void * V_42 ;
struct V_163 * V_164 = * V_219 ;
struct V_9 * V_9 ;
V_42 = F_175 ( V_2 , V_3 , V_108 , V_164 ) ;
if ( V_42 )
return V_42 ;
V_9 = F_131 ( V_2 , V_3 , V_108 ) ;
if ( V_9 ) {
V_164 = F_215 ( V_2 -> V_8 ) ;
if ( V_164 -> V_9 )
F_195 ( V_2 , V_164 ) ;
...
static inline bool F_161 ( struct V_9 * V_9 , T_7 V_212 )
{
if ( F_3 ( F_216 ( V_9 ) ) )
return F_217 ( V_212 ) ;
return true ;
}
static inline void * F_218 ( struct V_1 * V_2 , struct V_9 * V_9 )
{
struct V_9 V_162 ;
unsigned long V_33 ;
void * V_42 ;
...
static void * F_219 ( struct V_1 * V_2 , T_7 V_212 , int V_108 ,
...
goto F_131;
V_196:
if ( F_3 ( ! F_201 ( V_9 , V_108 ) ) ) {
int V_179 = V_108 ;
if ( V_108 != V_130 && ! F_177 ( V_108 ) )
V_179 = F_178 ( V_108 ) ;
if ( F_3 ( ! F_201 ( V_9 , V_179 ) ) ) {
F_9 ( V_2 , V_221 ) ;
F_190 ( V_2 , V_9 , V_164 -> V_42 ) ;
V_164 -> V_9 = NULL ;
V_164 -> V_42 = NULL ;
goto F_131;
}
}
if ( F_3 ( ! F_161 ( V_9 , V_212 ) ) ) {
F_190 ( V_2 , V_9 , V_164 -> V_42 ) ;
V_164 -> V_9 = NULL ;
V_164 -> V_42 = NULL ;
goto F_131;
...
V_42 = F_214 ( V_2 , V_212 , V_108 , & V_164 ) ;
if ( F_3 ( ! V_42 ) ) {
F_209 ( V_2 , V_212 , V_108 ) ;
F_42 ( V_3 ) ;
return NULL ;
}
V_9 = V_164 -> V_9 ;
if ( F_87 ( ! F_1 ( V_2 ) && F_161 ( V_9 , V_212 ) ) )
goto V_222;
if ( F_1 ( V_2 ) &&
! F_94 ( V_2 , V_9 , V_42 , V_16 ) )
goto F_131;
F_190 ( V_2 , V_9 , F_14 ( V_2 , V_42 ) ) ;
V_164 -> V_9 = NULL ;
V_164 -> V_42 = NULL ;
F_42 ( V_3 ) ;
return V_42 ;
...
V_10 = V_164 -> V_42 ;
V_9 = V_164 -> V_9 ;
if ( F_3 ( ! V_10 || ! F_201 ( V_9 , V_108 ) ) ) {
V_10 = F_219 ( V_2 , V_212 , V_108 , V_16 , V_164 ) ;
F_9 ( V_2 , V_226 ) ;
} else {
...
F_108 ( V_2 , V_212 , V_10 ) ;
return V_10 ;
}
static T_2 void * F_224 ( struct V_1 * V_2 ,
T_7 V_212 , unsigned long V_16 )
{
return F_220 ( V_2 , V_212 , V_130 , V_16 ) ;
}
void * F_225 ( struct V_1 * V_2 , T_7 V_212 )
{
void * V_230 = F_224 ( V_2 , V_212 , V_231 ) ;
F_226 ( V_231 , V_230 , V_2 -> V_19 ,
V_2 -> V_13 , V_212 ) ;
return V_230 ;
}
void * F_227 ( struct V_1 * V_2 , T_7 V_212 , T_1 V_13 )
{
void * V_230 = F_224 ( V_2 , V_212 , V_231 ) ;
F_228 ( V_231 , V_230 , V_13 , V_2 -> V_13 , V_212 ) ;
return V_230 ;
}
void * F_229 ( struct V_1 * V_2 , T_7 V_212 , int V_108 )
{
void * V_230 = F_220 ( V_2 , V_212 , V_108 , V_231 ) ;
F_230 ( V_231 , V_230 ,
...
static void F_233 ( struct V_1 * V_2 , struct V_9 * V_9 ,
...
V_164 -> V_42 , V_180 ,
V_10 , F_179 ( V_180 ) ) ) ) {
F_183 ( L_59 , V_2 , V_180 ) ;
goto V_196;
}
F_9 ( V_2 , V_239 ) ;
} else
F_233 ( V_2 , V_9 , V_27 , V_16 ) ;
}
void F_235 ( struct V_1 * V_2 , void * V_27 )
{
V_2 = F_236 ( V_2 , V_27 ) ;
if ( ! V_2 )
return;
F_234 ( V_2 , F_146 ( V_27 ) , V_27 , V_231 ) ;
F_237 ( V_231 , V_27 ) ;
}
static inline int F_238 ( int V_13 , int V_240 ,
...
return F_212 ( V_13 * V_102 ) - 1 ;
for ( V_23 = F_239 ( V_244 ,
F_240 ( V_240 * V_13 - 1 ) - V_246 ) ;
V_23 <= V_241 ; V_23 ++ ) {
...
static inline int F_241 ( int V_13 , int V_24 )
{
int V_23 ;
int V_240 ;
int V_248 ;
...
V_23 = F_238 ( V_13 , 1 , V_251 , 1 , V_24 ) ;
if ( V_23 <= V_251 )
return V_23 ;
V_23 = F_238 ( V_13 , 1 , V_252 , 1 , V_24 ) ;
if ( V_23 < V_252 )
return V_23 ;
return - V_253 ;
}
static void
F_242 ( struct V_104 * V_38 )
{
V_38 -> V_158 = 0 ;
F_243 ( & V_38 -> V_105 ) ;
F_244 ( & V_38 -> V_160 ) ;
...
V_2 -> V_8 = F_248 ( sizeof( struct V_163 ) ,
2 * sizeof( void * ) ) ;
if ( ! V_2 -> V_8 )
return 0 ;
F_187 ( V_2 ) ;
...
static void F_249 ( int V_108 )
{
struct V_9 * V_9 ;
struct V_104 * V_38 ;
F_250 ( V_104 -> V_13 < sizeof( struct V_104 ) ) ;
V_9 = F_131 ( V_104 , V_256 , V_108 ) ;
F_250 ( ! V_9 ) ;
if ( F_134 ( V_9 ) != V_108 ) {
F_54 ( L_60 , V_108 ) ;
F_54 ( L_61 ) ;
...
static void F_254 ( struct V_1 * V_2 , unsigned long V_136 )
{
if ( V_136 < V_260 )
V_136 = V_260 ;
else if ( V_136 > V_261 )
...
static int F_255 ( struct V_1 * V_2 , int V_262 )
{
unsigned long V_3 = V_2 -> V_3 ;
unsigned long V_13 = V_2 -> V_19 ;
int V_23 ;
V_13 = F_256 ( V_13 , sizeof( void * ) ) ;
#ifdef F_2
...
V_13 += sizeof( void * ) ;
#endif
V_13 = F_256 ( V_13 , V_2 -> V_263 ) ;
V_2 -> V_13 = V_13 ;
if ( V_262 >= 0 )
V_23 = V_262 ;
else
V_23 = F_241 ( V_13 , V_2 -> V_24 ) ;
if ( V_23 < 0 )
return 0 ;
V_2 -> V_132 = 0 ;
if ( V_23 )
...
V_2 -> V_136 = F_24 ( F_212 ( V_13 ) , V_13 , V_2 -> V_24 ) ;
if ( F_26 ( V_2 -> V_128 ) > F_26 ( V_2 -> F_239 ) )
V_2 -> F_239 = V_2 -> V_128 ;
return ! ! F_26 ( V_2 -> V_128 ) ;
}
static int F_257 ( struct V_1 * V_2 , unsigned long V_3 )
{
...
goto error;
if ( V_118 ) {
if ( F_212 ( V_2 -> V_13 ) > F_212 ( V_2 -> V_19 ) ) {
V_2 -> V_3 &= ~ V_268 ;
V_2 -> V_14 = 0 ;
if ( ! F_255 ( V_2 , - 1 ) )
goto error;
...
#if F_35 ( V_39 ) && \
F_35 ( V_40 )
if ( F_258 () && ( V_2 -> V_3 & V_4 ) == 0 )
V_2 -> V_3 |= V_41 ;
#endif
F_254 ( V_2 , F_259 ( V_2 -> V_13 ) / 2 ) ;
if ( ! F_4 ( V_2 ) )
V_2 -> V_169 = 0 ;
...
static void F_261 ( struct V_1 * V_2 , struct V_9 * V_9 ,
const char * V_46 )
{
#ifdef F_2
void * V_16 = F_13 ( V_9 ) ;
void * V_5 ;
unsigned long * V_45 = F_262 ( F_263 ( V_9 -> V_12 ) *
sizeof( long ) , V_211 ) ;
if ( ! V_45 )
return;
...
F_27 ( V_9 ) ;
F_43 ( V_2 , V_9 , V_45 ) ;
F_139 (p, s, addr, page->objects) {
if ( ! F_264 ( F_21 ( V_5 , V_2 , V_16 ) , V_45 ) ) {
F_54 ( L_64 , V_5 , V_5 - V_16 ) ;
F_55 ( V_2 , V_5 ) ;
}
}
F_29 ( V_9 ) ;
...
static void F_266 ( struct V_1 * V_2 , struct V_104 * V_38 )
{
struct V_9 * V_9 , * V_153 ;
F_160 (page, h, &n->partial, lru) {
if ( ! V_9 -> V_22 ) {
F_154 ( V_38 , V_9 ) ;
F_150 ( V_2 , V_9 ) ;
} else {
...
static int T_6 F_270 ( char * V_113 )
{
F_271 ( & V_113 , & V_245 ) ;
return 1 ;
}
static int T_6 F_272 ( char * V_113 )
{
F_271 ( & V_113 , & V_251 ) ;
V_251 = V_136 ( V_251 , V_252 - 1 ) ;
return 1 ;
}
static int T_6 F_273 ( char * V_113 )
{
F_271 ( & V_113 , & V_249 ) ;
return 1 ;
}
void * F_274 ( T_1 V_13 , T_7 V_3 )
{
struct V_1 * V_2 ;
void * V_230 ;
if ( F_3 ( V_13 > V_271 ) )
return F_275 ( V_13 , V_3 ) ;
V_2 = F_276 ( V_13 , V_3 ) ;
if ( F_3 ( F_277 ( V_2 ) ) )
return V_2 ;
V_230 = F_224 ( V_2 , V_3 , V_231 ) ;
F_228 ( V_231 , V_230 , V_13 , V_2 -> V_13 , V_3 ) ;
return V_230 ;
}
static void * F_278 ( T_1 V_13 , T_7 V_3 , int V_108 )
{
struct V_9 * V_9 ;
void * V_122 = NULL ;
V_3 |= V_264 | V_129 ;
V_9 = F_279 ( V_108 , V_3 , F_212 ( V_13 ) ) ;
if ( V_9 )
V_122 = F_13 ( V_9 ) ;
F_99 ( V_122 , V_13 , V_3 ) ;
return V_122 ;
}
void * F_280 ( T_1 V_13 , T_7 V_3 , int V_108 )
{
struct V_1 * V_2 ;
void * V_230 ;
if ( F_3 ( V_13 > V_271 ) ) {
V_230 = F_278 ( V_13 , V_3 , V_108 ) ;
F_232 ( V_231 , V_230 ,
V_13 , V_25 << F_212 ( V_13 ) ,
V_3 , V_108 ) ;
return V_230 ;
}
V_2 = F_276 ( V_13 , V_3 ) ;
if ( F_3 ( F_277 ( V_2 ) ) )
return V_2 ;
V_230 = F_220 ( V_2 , V_3 , V_108 , V_231 ) ;
F_232 ( V_231 , V_230 , V_13 , V_2 -> V_13 , V_3 , V_108 ) ;
return V_230 ;
}
T_1 F_281 ( const void * V_10 )
{
struct V_9 * V_9 ;
if ( F_3 ( V_10 == V_272 ) )
return 0 ;
...
F_234 ( V_9 -> V_148 , V_9 , V_10 , V_231 ) ;
}
...
struct V_9 * V_9 ;
struct V_9 * V_70 ;
int V_12 = F_26 ( V_2 -> F_239 ) ;
struct V_155 * V_273 =
F_286 ( sizeof( struct V_155 ) * V_12 , V_259 ) ;
unsigned long V_3 ;
if ( ! V_273 )
return - V_274 ;
F_199 ( V_2 ) ;
...
F_244 ( V_273 + V_55 ) ;
F_206 ( & V_38 -> V_105 , V_3 ) ;
F_160 (page, t, &n->partial, lru) {
F_287 ( & V_9 -> V_106 , V_273 + V_9 -> V_22 ) ;
if ( ! V_9 -> V_22 )
V_38 -> V_158 -- ;
}
for ( V_55 = V_12 - 1 ; V_55 > 0 ; V_55 -- )
F_288 ( V_273 + V_55 , V_38 -> V_160 . V_275 ) ;
F_208 ( & V_38 -> V_105 , V_3 ) ;
F_160 (page, t, slabs_by_inuse, lru)
F_150 ( V_2 , V_9 ) ;
}
F_265 ( V_273 ) ;
return 0 ;
}
static int F_289 ( void * V_276 )
{
struct V_1 * V_2 ;
F_290 ( & V_277 ) ;
F_207 (s, &slab_caches, list)
F_285 ( V_2 ) ;
F_291 ( & V_277 ) ;
return 0 ;
}
static void F_292 ( void * V_276 )
{
struct V_104 * V_38 ;
struct V_1 * V_2 ;
struct V_278 * V_279 = V_276 ;
int V_280 ;
V_280 = V_279 -> V_281 ;
if ( V_280 < 0 )
return;
...
V_38 = F_83 ( V_2 , V_280 ) ;
if ( V_38 ) {
F_250 ( F_82 ( V_2 , V_280 ) ) ;
V_2 -> V_108 [ V_280 ] = NULL ;
F_235 ( V_104 , V_38 ) ;
}
}
F_291 ( & V_277 ) ;
}
static int F_293 ( void * V_276 )
{
struct V_104 * V_38 ;
struct V_1 * V_2 ;
struct V_278 * V_279 = V_276 ;
int V_213 = V_279 -> V_281 ;
int V_230 = 0 ;
if ( V_213 < 0 )
return 0 ;
F_290 ( & V_277 ) ;
F_207 (s, &slab_caches, list) {
V_38 = F_225 ( V_104 , V_259 ) ;
if ( ! V_38 ) {
V_230 = - V_274 ;
goto V_116;
}
...
static int F_294 ( struct V_282 * V_283 ,
unsigned long V_284 , void * V_276 )
{
int V_230 = 0 ;
switch ( V_284 ) {
case V_285 :
...
static struct V_1 * T_6 F_296 ( struct V_1 * V_292 )
{
int V_108 ;
struct V_1 * V_2 = F_297 ( V_1 , V_256 ) ;
struct V_104 * V_38 ;
memcpy ( V_2 , V_292 , V_1 -> V_19 ) ;
F_196 ( V_2 , F_51 () ) ;
F_213 (s, node, n) {
struct V_9 * V_5 ;
F_207 (p, &n->partial, lru)
V_5 -> V_148 = V_2 ;
#ifdef F_2
F_207 (p, &n->full, lru)
V_5 -> V_148 = V_2 ;
...
V_1 = & V_296 ;
F_300 ( V_104 , L_66 ,
sizeof( struct V_104 ) , V_298 ) ;
F_301 ( & V_299 ) ;
V_257 = V_300 ;
F_300 ( V_1 , L_67 ,
F_302 ( struct V_1 , V_108 ) +
V_301 * sizeof( struct V_104 * ) ,
V_298 ) ;
V_1 = F_296 ( & V_296 ) ;
V_104 = F_296 ( & V_297 ) ;
F_303 ( 0 ) ;
...
{
struct V_1 * V_2 ;
V_2 = F_309 ( V_13 , V_263 , V_3 , V_44 , F_97 ) ;
if ( V_2 ) {
int V_55 ;
struct V_1 * V_164 ;
V_2 -> V_303 ++ ;
V_2 -> V_19 = F_239 ( V_2 -> V_19 , ( int ) V_13 ) ;
V_2 -> V_22 = F_310 ( int , V_2 -> V_22 , F_256 ( V_13 , sizeof( void * ) ) ) ;
F_311 (i) {
V_164 = F_312 ( V_2 , V_55 ) ;
if ( ! V_164 )
continue;
V_164 -> V_19 = V_2 -> V_19 ;
V_164 -> V_22 = F_310 ( int , V_164 -> V_22 ,
F_256 ( V_13 , sizeof( void * ) ) ) ;
}
if ( F_7 ( V_2 , V_44 ) ) {
V_2 -> V_303 -- ;
V_2 = NULL ;
...
int F_313 ( struct V_1 * V_2 , unsigned long V_3 )
{
int V_304 ;
V_304 = F_257 ( V_2 , V_3 ) ;
if ( V_304 )
...
static int F_314 ( struct V_282 * V_306 ,
unsigned long V_284 , void * V_307 )
{
long V_63 = ( long ) V_307 ;
struct V_1 * V_2 ;
unsigned long V_3 ;
switch ( V_284 ) {
case V_308 :
...
void * F_315 ( T_1 V_13 , T_7 V_212 , unsigned long V_312 )
{
struct V_1 * V_2 ;
void * V_230 ;
if ( F_3 ( V_13 > V_271 ) )
return F_275 ( V_13 , V_212 ) ;
V_2 = F_276 ( V_13 , V_212 ) ;
if ( F_3 ( F_277 ( V_2 ) ) )
return V_2 ;
V_230 = F_224 ( V_2 , V_212 , V_312 ) ;
F_228 ( V_312 , V_230 , V_13 , V_2 -> V_13 , V_212 ) ;
return V_230 ;
}
void * F_316 ( T_1 V_13 , T_7 V_212 ,
int V_108 , unsigned long V_312 )
{
struct V_1 * V_2 ;
void * V_230 ;
if ( F_3 ( V_13 > V_271 ) ) {
V_230 = F_278 ( V_13 , V_212 , V_108 ) ;
F_232 ( V_312 , V_230 ,
V_13 , V_25 << F_212 ( V_13 ) ,
V_212 , V_108 ) ;
return V_230 ;
...
if ( F_3 ( F_277 ( V_2 ) ) )
return V_2 ;
V_230 = F_220 ( V_2 , V_212 , V_108 , V_312 ) ;
F_232 ( V_312 , V_230 , V_13 , V_2 -> V_13 , V_212 , V_108 ) ;
return V_230 ;
}
...
static int F_318 ( struct V_9 * V_9 )
{
return V_9 -> V_12 ;
}
static int F_319 ( struct V_1 * V_2 , struct V_9 * V_9 ,
unsigned long * V_45 )
{
void * V_5 ;
void * V_16 = F_13 ( V_9 ) ;
...
static void F_321 ( struct V_1 * V_2 , struct V_9 * V_9 ,
unsigned long * V_45 )
{
F_27 ( V_9 ) ;
F_319 ( V_2 , V_9 , V_45 ) ;
...
if ( V_313 != V_38 -> V_158 )
F_54 ( L_69 ,
V_2 -> V_44 , V_313 , V_38 -> V_158 ) ;
if ( ! ( V_2 -> V_3 & V_21 ) )
goto V_116;
F_207 (page, &n->full, lru) {
F_321 ( V_2 , V_9 , V_45 ) ;
V_313 ++ ;
}
if ( V_313 != F_84 ( & V_38 -> V_109 ) )
F_54 ( L_70 ,
V_2 -> V_44 , V_313 , F_84 ( & V_38 -> V_109 ) ) ;
V_116:
F_208 ( & V_38 -> V_105 , V_3 ) ;
return V_313 ;
}
static long F_323 ( struct V_1 * V_2 )
{
int V_108 ;
unsigned long V_313 = 0 ;
unsigned long * V_45 = F_286 ( F_263 ( F_26 ( V_2 -> F_239 ) ) *
...
F_199 ( V_2 ) ;
F_213 (s, node, n)
V_313 += F_322 ( V_2 , V_38 , V_45 ) ;
F_265 ( V_45 ) ;
return V_313 ;
}
static void F_324 ( struct V_314 * V_70 )
{
if ( V_70 -> F_239 )
F_325 ( ( unsigned long ) V_70 -> V_315 ,
F_212 ( sizeof( struct V_316 ) * V_70 -> F_239 ) ) ;
}
static int F_326 ( struct V_314 * V_70 , unsigned long F_239 , T_7 V_3 )
{
struct V_316 * V_189 ;
int V_23 ;
V_23 = F_212 ( sizeof( struct V_316 ) * F_239 ) ;
V_189 = ( void * ) F_327 ( V_3 , V_23 ) ;
if ( ! V_189 )
return 0 ;
if ( V_70 -> V_313 ) {
memcpy ( V_189 , V_70 -> V_315 , sizeof( struct V_316 ) * V_70 -> V_313 ) ;
F_324 ( V_70 ) ;
}
V_70 -> F_239 = F_239 ;
V_70 -> V_315 = V_189 ;
...
static int F_328 ( struct V_314 * V_70 , struct V_1 * V_2 ,
const struct V_50 * V_50 )
{
long V_89 , V_93 , V_317 ;
struct V_316 * V_189 ;
unsigned long V_318 ;
unsigned long V_319 = V_67 - V_50 -> V_66 ;
V_89 = - 1 ;
V_93 = V_70 -> V_313 ;
for ( ; ; ) {
...
if ( V_317 == V_93 )
break;
V_318 = V_70 -> V_315 [ V_317 ] . V_16 ;
if ( V_50 -> V_16 == V_318 ) {
V_189 = & V_70 -> V_315 [ V_317 ] ;
V_189 -> V_313 ++ ;
if ( V_50 -> V_66 ) {
V_189 -> V_320 += V_319 ;
if ( V_319 < V_189 -> V_321 )
V_189 -> V_321 = V_319 ;
if ( V_319 > V_189 -> V_322 )
V_189 -> V_322 = V_319 ;
if ( V_50 -> V_64 < V_189 -> V_323 )
V_189 -> V_323 = V_50 -> V_64 ;
if ( V_50 -> V_64 > V_189 -> V_324 )
V_189 -> V_324 = V_50 -> V_64 ;
F_329 ( V_50 -> V_63 ,
F_330 ( V_189 -> V_325 ) ) ;
}
F_331 ( F_134 ( F_332 ( V_50 ) ) , V_189 -> V_326 ) ;
return 1 ;
}
if ( V_50 -> V_16 < V_318 )
V_93 = V_317 ;
...
if ( V_70 -> V_313 >= V_70 -> F_239 && ! F_326 ( V_70 , 2 * V_70 -> F_239 , V_211 ) )
return 0 ;
V_189 = V_70 -> V_315 + V_317 ;
if ( V_317 < V_70 -> V_313 )
memmove ( V_189 + 1 , V_189 ,
( V_70 -> V_313 - V_317 ) * sizeof( struct V_316 ) ) ;
V_70 -> V_313 ++ ;
V_189 -> V_313 = 1 ;
...
V_189 -> V_323 = V_50 -> V_64 ;
V_189 -> V_324 = V_50 -> V_64 ;
F_333 ( F_330 ( V_189 -> V_325 ) ) ;
F_329 ( V_50 -> V_63 , F_330 ( V_189 -> V_325 ) ) ;
F_334 ( V_189 -> V_326 ) ;
F_331 ( F_134 ( F_332 ( V_50 ) ) , V_189 -> V_326 ) ;
return 1 ;
}
static void F_335 ( struct V_314 * V_70 , struct V_1 * V_2 ,
...
F_139 (p, s, addr, page->objects)
if ( ! F_264 ( F_21 ( V_5 , V_2 , V_16 ) , V_45 ) )
F_328 ( V_70 , V_2 , F_47 ( V_2 , V_5 , V_52 ) ) ;
}
static int F_336 ( struct V_1 * V_2 , char * V_79 ,
enum V_51 V_52 )
{
int V_327 = 0 ;
unsigned long V_55 ;
struct V_314 V_70 = { 0 , 0 , NULL } ;
int V_108 ;
unsigned long * V_45 = F_286 ( F_263 ( F_26 ( V_2 -> F_239 ) ) *
sizeof( unsigned long ) , V_259 ) ;
struct V_104 * V_38 ;
if ( ! V_45 || ! F_326 ( & V_70 , V_25 / sizeof( struct V_316 ) ,
V_328 ) ) {
F_265 ( V_45 ) ;
...
F_206 ( & V_38 -> V_105 , V_3 ) ;
F_207 (page, &n->partial, lru)
F_335 ( & V_70 , V_2 , V_9 , V_52 , V_45 ) ;
F_207 (page, &n->full, lru)
F_335 ( & V_70 , V_2 , V_9 , V_52 , V_45 ) ;
F_208 ( & V_38 -> V_105 , V_3 ) ;
}
for ( V_55 = 0 ; V_55 < V_70 . V_313 ; V_55 ++ ) {
struct V_316 * V_189 = & V_70 . V_315 [ V_55 ] ;
if ( V_327 > V_25 - V_329 - 100 )
break;
V_327 += sprintf ( V_79 + V_327 , L_72 , V_189 -> V_313 ) ;
if ( V_189 -> V_16 )
V_327 += sprintf ( V_79 + V_327 , L_73 , ( void * ) V_189 -> V_16 ) ;
else
V_327 += sprintf ( V_79 + V_327 , L_74 ) ;
if ( V_189 -> V_320 != V_189 -> V_321 ) {
V_327 += sprintf ( V_79 + V_327 , L_75 ,
V_189 -> V_321 ,
( long ) F_337 ( V_189 -> V_320 , V_189 -> V_313 ) ,
V_189 -> V_322 ) ;
} else
V_327 += sprintf ( V_79 + V_327 , L_76 ,
V_189 -> V_321 ) ;
if ( V_189 -> V_323 != V_189 -> V_324 )
V_327 += sprintf ( V_79 + V_327 , L_77 ,
V_189 -> V_323 , V_189 -> V_324 ) ;
else
V_327 += sprintf ( V_79 + V_327 , L_78 ,
V_189 -> V_323 ) ;
if ( F_338 () > 1 &&
! F_339 ( F_330 ( V_189 -> V_325 ) ) &&
V_327 < V_25 - 60 ) {
V_327 += sprintf ( V_79 + V_327 , L_79 ) ;
V_327 += F_340 ( V_79 + V_327 ,
V_25 - V_327 - 50 ,
F_330 ( V_189 -> V_325 ) ) ;
}
if ( V_330 > 1 && ! F_341 ( V_189 -> V_326 ) &&
V_327 < V_25 - 60 ) {
V_327 += sprintf ( V_79 + V_327 , L_80 ) ;
V_327 += F_342 ( V_79 + V_327 ,
V_25 - V_327 - 50 ,
V_189 -> V_326 ) ;
}
V_327 += sprintf ( V_79 + V_327 , L_81 ) ;
}
F_324 ( & V_70 ) ;
F_265 ( V_45 ) ;
if ( ! V_70 . V_313 )
V_327 += sprintf ( V_79 , L_82 ) ;
return V_327 ;
}
static void T_6 F_343 ( void )
{
T_3 * V_5 ;
F_247 ( V_331 > 16 || V_255 < 10 ) ;
F_54 ( L_83 ) ;
F_54 ( L_84 ) ;
F_54 ( L_85 ) ;
V_5 = F_262 ( 16 , V_259 ) ;
...
static T_9 F_344 ( struct V_1 * V_2 ,
...
int V_27 ;
unsigned long * V_326 ;
V_326 = F_262 ( sizeof( unsigned long ) * V_301 , V_259 ) ;
if ( ! V_326 )
return - V_274 ;
if ( V_3 & V_334 ) {
int V_63 ;
F_188 (cpu) {
struct V_163 * V_164 = F_189 ( V_2 -> V_8 ,
V_63 ) ;
int V_108 ;
struct V_9 * V_9 ;
V_9 = F_345 ( V_164 -> V_9 ) ;
...
F_213 (s, node, n) {
if ( V_3 & V_335 )
V_27 = F_204 ( V_38 , F_318 ) ;
else if ( V_3 & V_336 )
V_27 = F_204 ( V_38 , F_317 ) ;
else
V_27 = V_38 -> V_158 ;
V_333 += V_27 ;
V_326 [ V_108 ] += V_27 ;
...
V_27 = sprintf ( V_79 , L_94 , V_333 ) ;
#ifdef F_165
for ( V_108 = 0 ; V_108 < V_301 ; V_108 ++ )
if ( V_326 [ V_108 ] )
...
static T_9 F_353 ( struct V_1 * V_2 , char * V_79 )
{
return sprintf ( V_79 , L_96 , F_26 ( V_2 -> V_128 ) ) ;
}
static T_9 F_354 ( struct V_1 * V_2 ,
const char * V_79 , T_1 V_47 )
{
unsigned long V_23 ;
int V_304 ;
V_304 = F_355 ( V_79 , 10 , & V_23 ) ;
if ( V_304 )
return V_304 ;
...
static T_9 F_357 ( struct V_1 * V_2 , char * V_79 )
{
return sprintf ( V_79 , L_97 , V_2 -> V_178 ) ;
}
static T_9 F_358 ( struct V_1 * V_2 , const char * V_79 ,
T_1 V_47 )
{
unsigned long V_136 ;
int V_304 ;
V_304 = F_355 ( V_79 , 10 , & V_136 ) ;
if ( V_304 )
return V_304 ;
F_254 ( V_2 , V_136 ) ;
return V_47 ;
}
static T_9 F_359 ( struct V_1 * V_2 , char * V_79 )
{
return sprintf ( V_79 , L_98 , V_2 -> V_169 ) ;
}
static T_9 F_360 ( struct V_1 * V_2 , const char * V_79 ,
T_1 V_47 )
{
unsigned long V_12 ;
int V_304 ;
V_304 = F_355 ( V_79 , 10 , & V_12 ) ;
if ( V_304 )
return V_304 ;
if ( V_12 && ! F_4 ( V_2 ) )
return - V_270 ;
...
if ( ! V_2 -> F_97 )
return 0 ;
return sprintf ( V_79 , L_99 , V_2 -> F_97 ) ;
}
static T_9 F_362 ( struct V_1 * V_2 , char * V_79 )
{
return sprintf ( V_79 , L_96 , V_2 -> V_303 < 0 ? 0 : V_2 -> V_303 - 1 ) ;
}
static T_9 F_363 ( struct V_1 * V_2 , char * V_79 )
{
return F_344 ( V_2 , V_79 , V_338 ) ;
}
static T_9 F_364 ( struct V_1 * V_2 , char * V_79 )
{
return F_344 ( V_2 , V_79 , V_334 ) ;
}
static T_9 F_365 ( struct V_1 * V_2 , char * V_79 )
{
return F_344 ( V_2 , V_79 , V_337 | V_336 ) ;
}
static T_9 F_366 ( struct V_1 * V_2 , char * V_79 )
{
return F_344 ( V_2 , V_79 , V_338 | V_336 ) ;
}
static T_9 F_367 ( struct V_1 * V_2 , char * V_79 )
{
int V_12 = 0 ;
int V_140 = 0 ;
int V_63 ;
int V_327 ;
F_368 (cpu) {
struct V_9 * V_9 = F_189 ( V_2 -> V_8 , V_63 ) -> V_160 ;
if ( V_9 ) {
V_140 += V_9 -> V_140 ;
V_12 += V_9 -> V_206 ;
}
}
V_327 = sprintf ( V_79 , L_100 , V_12 , V_140 ) ;
#ifdef F_304
F_368 (cpu) {
struct V_9 * V_9 = F_189 ( V_2 -> V_8 , V_63 ) -> V_160 ;
if ( V_9 && V_327 < V_25 - 20 )
V_327 += sprintf ( V_79 + V_327 , L_101 , V_63 ,
V_9 -> V_206 , V_9 -> V_140 ) ;
}
#endif
return V_327 + sprintf ( V_79 + V_327 , L_81 ) ;
}
...
{
return sprintf ( V_79 , L_96 , ! ! ( V_2 -> V_3 & V_298 ) ) ;
}
...
{
return F_344 ( V_2 , V_79 , V_337 ) ;
}
static T_9 F_376 ( struct V_1 * V_2 , char * V_79 )
{
return F_344 ( V_2 , V_79 , V_337 | V_335 ) ;
}
...
static T_9 F_380 ( struct V_1 * V_2 , const char * V_79 ,
T_1 V_47 )
{
if ( V_2 -> V_303 > 1 )
return - V_270 ;
...
if ( ! ( V_2 -> V_3 & V_21 ) )
return - V_253 ;
return F_336 ( V_2 , V_79 , V_69 ) ;
}
static T_9 F_390 ( struct V_1 * V_2 , char * V_79 )
{
if ( ! ( V_2 -> V_3 & V_21 ) )
return - V_253 ;
return F_336 ( V_2 , V_79 , V_68 ) ;
}
static T_9 F_391 ( struct V_1 * V_2 , char * V_79 )
{
return sprintf ( V_79 , L_96 , ! ! ( V_2 -> V_3 & V_120 ) ) ;
}
static T_9 F_392 ( struct V_1 * V_2 , const char * V_79 ,
T_1 V_47 )
{
if ( V_2 -> V_303 > 1 )
return - V_270 ;
...
static T_9 F_394 ( struct V_1 * V_2 ,
const char * V_79 , T_1 V_47 )
{
if ( V_79 [ 0 ] == '1' ) {
int V_340 = F_395 ( V_2 ) ;
...
static int F_398 ( struct V_1 * V_2 , char * V_79 , enum V_6 V_7 )
{
unsigned long V_342 = 0 ;
int V_63 ;
int V_327 ;
int * V_85 = F_286 ( V_250 * sizeof( int ) , V_259 ) ;
if ( ! V_85 )
return - V_274 ;
F_368 (cpu) {
unsigned V_27 = F_189 ( V_2 -> V_8 , V_63 ) -> F_9 [ V_7 ] ;
V_85 [ V_63 ] = V_27 ;
V_342 += V_27 ;
}
V_327 = sprintf ( V_79 , L_94 , V_342 ) ;
#ifdef F_304
F_368 (cpu) {
if ( V_85 [ V_63 ] && V_327 < V_25 - 20 )
V_327 += sprintf ( V_79 + V_327 , L_102 , V_63 , V_85 [ V_63 ] ) ;
}
#endif
F_265 ( V_85 ) ;
return V_327 + sprintf ( V_79 + V_327 , L_81 ) ;
}
static void F_399 ( struct V_1 * V_2 , enum V_6 V_7 )
{
int V_63 ;
F_368 (cpu)
F_189 ( V_2 -> V_8 , V_63 ) -> F_9 [ V_7 ] = 0 ;
}
static T_9 F_400 ( struct V_343 * V_344 ,
struct V_345 * V_346 ,
char * V_79 )
{
struct V_347 * V_345 ;
...
if ( ! V_345 -> V_348 )
return - V_349 ;
V_304 = V_345 -> V_348 ( V_2 , V_79 ) ;
return V_304 ;
}
static T_9 F_403 ( struct V_343 * V_344 ,
struct V_345 * V_346 ,
const char * V_79 , T_1 V_327 )
{
struct V_347 * V_345 ;
struct V_1 * V_2 ;
int V_304 ;
...
if ( ! V_345 -> V_350 )
return - V_349 ;
V_304 = V_345 -> V_350 ( V_2 , V_79 , V_327 ) ;
#ifdef F_404
if ( V_257 >= V_351 && V_304 >= 0 && F_405 ( V_2 ) ) {
int V_55 ;
F_290 ( & V_277 ) ;
if ( V_2 -> V_352 < V_327 )
V_2 -> V_352 = V_327 ;
F_311 (i) {
struct V_1 * V_164 = F_312 ( V_2 , V_55 ) ;
if ( V_164 )
V_345 -> V_350 ( V_164 , V_79 , V_327 ) ;
}
F_291 ( & V_277 ) ;
}
#endif
...
if ( ! V_354 -> V_352 )
return;
for ( V_55 = 0 ; V_55 < F_406 ( V_356 ) ; V_55 ++ ) {
char V_357 [ 64 ] ;
char * V_79 ;
struct V_347 * V_346 = F_401 ( V_356 [ V_55 ] ) ;
if ( ! V_346 || ! V_346 -> V_350 || ! V_346 -> V_348 )
continue;
if ( V_353 )
V_79 = V_353 ;
else if ( V_354 -> V_352 < F_406 ( V_357 ) )
V_79 = V_357 ;
else {
V_353 = ( char * ) F_407 ( V_259 ) ;
if ( F_157 ( ! V_353 ) )
continue;
V_79 = V_353 ;
}
V_346 -> V_348 ( V_354 , V_79 ) ;
V_346 -> V_350 ( V_2 , V_79 , strlen ( V_79 ) ) ;
}
if ( V_353 )
F_408 ( ( unsigned long ) V_353 ) ;
#endif
}
static void F_409 ( struct V_343 * V_358 )
{
F_410 ( F_402 ( V_358 ) ) ;
}
static int F_411 ( struct V_359 * V_359 , struct V_343 * V_344 )
{
struct V_360 * V_361 = F_412 ( V_344 ) ;
if ( V_361 == & V_362 )
return 1 ;
return 0 ;
}
static inline struct V_359 * F_413 ( struct V_1 * V_2 )
{
#ifdef F_404
if ( ! F_405 ( V_2 ) )
...
static char * F_414 ( struct V_1 * V_2 )
{
char * V_44 = F_286 ( V_365 , V_259 ) ;
char * V_5 = V_44 ;
F_250 ( ! V_44 ) ;
* V_5 ++ = ':' ;
if ( V_2 -> V_3 & V_265 )
...
int V_366 = F_415 ( V_2 ) ;
if ( V_366 ) {
F_416 ( & V_364 -> V_344 , V_2 -> V_44 ) ;
V_44 = V_2 -> V_44 ;
} else {
V_44 = F_414 ( V_2 ) ;
}
V_2 -> V_344 . V_359 = F_413 ( V_2 ) ;
V_304 = F_417 ( & V_2 -> V_344 , & V_362 , NULL , L_16 , V_44 ) ;
if ( V_304 )
goto V_367;
V_304 = F_418 ( & V_2 -> V_344 , & V_368 ) ;
if ( V_304 )
goto V_369;
#ifdef F_404
if ( F_405 ( V_2 ) ) {
V_2 -> V_363 = F_419 ( L_104 , NULL , & V_2 -> V_344 ) ;
if ( ! V_2 -> V_363 ) {
V_304 = - V_274 ;
goto V_369;
}
...
struct V_372 * V_373 ;
if ( V_257 == V_351 ) {
F_416 ( & V_364 -> V_344 , V_44 ) ;
return F_425 ( & V_364 -> V_344 , & V_2 -> V_344 , V_44 ) ;
}
V_373 = F_286 ( sizeof( struct V_372 ) , V_259 ) ;
if ( ! V_373 )
return - V_274 ;
V_373 -> V_2 = V_2 ;
V_373 -> V_44 = V_44 ;
...
static int T_6 F_426 ( void )
{
struct V_1 * V_2 ;
int V_304 ;
F_290 ( & V_277 ) ;
V_364 = F_419 ( L_105 , & V_375 , V_376 ) ;
if ( ! V_364 ) {
F_291 ( & V_277 ) ;
F_54 ( L_106 ) ;
return - V_253 ;
...
V_374 = V_374 -> V_202 ;
V_304 = F_7 ( V_373 -> V_2 , V_373 -> V_44 ) ;
if ( V_304 )
F_54 ( L_108 ,
V_373 -> V_44 ) ;
F_265 ( V_373 ) ;
...
void F_427 ( struct V_1 * V_2 , struct V_377 * V_378 )
{
...
V_378 -> V_379 = V_217 - V_218 ;
V_378 -> V_380 = V_217 ;
V_378 -> V_381 = V_109 ;
V_378 -> V_382 = V_109 ;
V_378 -> V_383 = F_26 ( V_2 -> V_128 ) ;
V_378 -> V_384 = F_25 ( V_2 -> V_128 ) ;
}
void F_428 ( struct V_385 * V_190 , struct V_1 * V_2 )
{
}
T_9 F_429 ( struct V_386 * V_386 , const char T_10 * V_353 ,
T_1 V_313 , T_11 * V_387 )
{
return - V_349 ;
}
