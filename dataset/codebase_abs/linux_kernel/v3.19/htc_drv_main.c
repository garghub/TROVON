...
if ( V_127 -> V_155 [ V_149 -> V_153 ] & F_56 ( V_40 ) ) {
...
V_144 |= V_175 ;
else if ( F_57 ( & V_3 -> V_36 -> V_58 ) &&
( V_127 -> V_136 . V_168 & V_176 ) )
V_144 |= V_175 ;
}
V_147 -> V_117 = V_132 -> V_99 ;
V_147 -> V_177 = 1 ;
V_147 -> V_178 = F_54 ( V_144 ) ;
}
...
F_55 ( V_3 , V_127 , & V_147 ) ;
V_10 = F_58 ( V_3 , & V_147 ) ;
if ( ! V_10 )
F_43 ( V_45 , V_90 ,
L_17 ,
V_127 -> V_46 , F_60 ( V_147 . V_178 ) ) ;
}
...
{
struct V_44 * V_45 = F_20 ( V_3 -> V_12 ) ;
unsigned long V_195 = F_68 ( V_79 ) ;
V_45 -> V_196 . V_197 = V_195 ;
V_45 -> V_196 . V_198 = V_195 ;
V_45 -> V_196 . V_199 = V_195 ;
F_69 ( V_200 , & V_45 -> V_86 ) ;
F_70 ( V_45 -> V_36 , & V_3 -> V_201 ,
F_40 ( V_202 ) ) ;
}
...
V_211:
V_206 = V_212 ;
V_206 = F_77 ( V_206 , ( T_4 ) V_202 ) ;
if ( ! V_45 -> V_196 . V_214 )
V_206 = F_77 ( V_206 , ( T_4 ) V_207 ) ;
F_70 ( V_45 -> V_36 , & V_3 -> V_201 ,
F_40 ( V_206 ) ) ;
}
static void F_78 ( struct V_81 * V_36 ,
struct V_218 * V_219 ,
struct V_220 * V_221 )
{
struct V_222 * V_223 ;
...
V_224 = F_79 ( V_223 -> V_227 ) ;
V_225 = V_224 & 3 ;
if ( V_225 && V_221 -> V_228 > V_224 ) {
if ( F_80 ( V_221 ) < V_225 ) {
F_43 ( V_45 , V_229 , L_26 ) ;
goto V_230;
}
F_81 ( V_221 , V_225 ) ;
...
V_226 = F_82 ( V_3 ) ;
if ( V_226 < 0 ) {
F_43 ( V_45 , V_229 , L_27 ) ;
goto V_230;
}
V_10 = F_83 ( V_3 , V_219 -> V_127 , V_221 , V_226 , false ) ;
if ( V_10 != 0 ) {
F_43 ( V_45 , V_229 , L_28 ) ;
goto V_231;
}
F_84 ( V_3 ) ;
return;
...
static int F_87 ( struct V_81 * V_36 )
{
struct V_2 * V_3 = V_36 -> V_3 ;
struct V_55 * V_12 = V_3 -> V_12 ;
struct V_44 * V_45 = F_20 ( V_12 ) ;
...
F_3 ( V_3 , V_15 ) ;
F_29 ( V_233 ) ;
V_232 = F_88 ( V_36 , V_12 , & V_36 -> V_58 . V_59 ) ;
V_10 = F_31 ( V_12 , V_232 , V_12 -> V_62 , false ) ;
if ( V_10 ) {
F_32 ( V_45 ,
L_30 ,
V_10 , V_71 -> V_72 ) ;
...
static void F_90 ( struct V_81 * V_36 )
{
struct V_2 * V_3 = V_36 -> V_3 ;
struct V_55 * V_12 = V_3 -> V_12 ;
struct V_44 * V_45 = F_20 ( V_12 ) ;
...
static int F_97 ( struct V_81 * V_36 ,
struct V_26 * V_27 )
{
struct V_2 * V_3 = V_36 -> V_3 ;
...
V_129 -> V_99 = V_97 . V_99 = F_49 ( V_3 -> V_103 ) ;
V_97 . V_248 = F_35 ( 2304 ) ;
F_36 ( V_114 , & V_97 ) ;
if ( V_10 )
goto V_247;
V_10 = F_51 ( V_3 , V_27 , NULL ) ;
if ( V_10 ) {
F_36 ( V_101 , & V_97 ) ;
goto V_247;
}
...
static void F_101 ( struct V_81 * V_36 ,
struct V_26 * V_27 )
{
struct V_2 * V_3 = V_36 -> V_3 ;
struct V_44 * V_45 = F_20 ( V_3 -> V_12 ) ;
...
F_43 ( V_45 , V_90 , L_37 , V_129 -> V_99 ) ;
F_8 ( V_3 ) ;
F_6 ( & V_3 -> V_65 ) ;
}
static int F_104 ( struct V_81 * V_36 , T_4 V_249 )
{
struct V_2 * V_3 = V_36 -> V_3 ;
struct V_44 * V_45 = F_20 ( V_3 -> V_12 ) ;
...
if ( ( V_249 & V_255 ) || V_250 ) {
struct V_56 * V_71 = V_36 -> V_58 . V_59 . V_60 ;
int V_256 = V_71 -> V_257 ;
F_43 ( V_45 , V_90 , L_38 ,
V_71 -> V_72 ) ;
F_88 ( V_36 , V_3 -> V_12 , & V_36 -> V_58 . V_59 ) ;
if ( F_41 ( V_3 , V_36 , & V_3 -> V_12 -> V_258 [ V_256 ] ) < 0 ) {
F_32 ( V_45 , L_39 ) ;
V_10 = - V_186 ;
goto V_247;
}
...
static void F_105 ( struct V_81 * V_36 ,
unsigned int V_263 ,
unsigned int * V_264 ,
T_5 V_265 )
{
...
{
struct V_131 * V_132 =
F_12 ( V_22 , struct V_131 , V_269 ) ;
struct V_126 * V_127 =
F_12 ( ( void * ) V_132 , struct V_126 , V_130 ) ;
struct V_2 * V_3 = V_132 -> V_270 ;
struct V_44 * V_45 = F_20 ( V_3 -> V_12 ) ;
struct V_146 V_147 ;
F_4 ( & V_3 -> V_65 ) ;
F_7 ( V_3 ) ;
...
static int F_109 ( struct V_81 * V_36 ,
struct V_26 * V_27 ,
struct V_126 * V_127 )
{
struct V_2 * V_3 = V_36 -> V_3 ;
...
F_4 ( & V_3 -> V_65 ) ;
F_7 ( V_3 ) ;
V_10 = F_51 ( V_3 , V_27 , V_127 ) ;
if ( ! V_10 ) {
F_110 ( & V_132 -> V_269 , F_108 ) ;
V_132 -> V_270 = V_3 ;
F_59 ( V_3 , V_127 ) ;
}
F_8 ( V_3 ) ;
...
static int F_111 ( struct V_81 * V_36 ,
struct V_26 * V_27 ,
struct V_126 * V_127 )
{
struct V_2 * V_3 = V_36 -> V_3 ;
...
F_4 ( & V_3 -> V_65 ) ;
F_7 ( V_3 ) ;
F_112 ( V_3 -> V_78 , V_132 -> V_99 ) ;
V_10 = F_52 ( V_3 , V_27 , V_127 ) ;
F_8 ( V_3 ) ;
F_6 ( & V_3 -> V_65 ) ;
return V_10 ;
}
static void F_113 ( struct V_81 * V_36 ,
struct V_26 * V_27 ,
struct V_126 * V_127 , T_4 V_249 )
{
struct V_131 * V_132 = (struct V_131 * ) V_127 -> V_130 ;
if ( ! ( V_249 & V_271 ) )
return;
...
static int F_115 ( struct V_81 * V_36 ,
struct V_26 * V_27 , T_3 V_272 ,
...
static int F_119 ( struct V_81 * V_36 ,
enum V_289 V_290 ,
struct V_26 * V_27 ,
struct V_126 * V_127 ,
struct V_291 * V_292 )
...
switch ( V_290 ) {
case V_299 :
V_10 = F_120 ( V_45 , V_27 , V_127 , V_292 ) ;
if ( V_10 >= 0 ) {
V_292 -> V_300 = V_10 ;
V_292 -> V_88 |= V_301 ;
...
F_123 ( V_3 -> V_12 ) ;
F_43 ( V_45 , V_90 , L_47 ,
V_45 -> V_134 , V_45 -> V_306 ) ;
}
static void F_124 ( void * V_24 , T_1 * V_25 , struct V_26 * V_27 )
{
struct V_2 * V_3 = (struct V_2 * ) V_24 ;
struct V_44 * V_45 = F_20 ( V_3 -> V_12 ) ;
struct V_28 * V_29 = & V_27 -> V_29 ;
if ( ( V_27 -> type == V_54 ) && V_29 -> V_35 ) {
V_45 -> V_306 = V_29 -> V_307 ;
V_45 -> V_308 = V_309 ;
memcpy ( V_45 -> V_134 , V_29 -> V_133 , V_42 ) ;
F_69 ( V_310 , & V_45 -> V_86 ) ;
}
}
...
static void F_126 ( struct V_81 * V_36 ,
struct V_26 * V_27 ,
struct V_28 * V_29 ,
T_4 V_249 )
{
...
V_3 -> V_311 ++ : V_3 -> V_311 -- ;
if ( ! V_29 -> V_35 )
F_72 ( V_310 , & V_45 -> V_86 ) ;
if ( V_3 -> V_12 -> V_50 == V_54 ) {
F_125 ( V_3 ) ;
if ( V_29 -> V_35 && ( V_3 -> V_311 == 1 ) )
F_16 ( V_3 ) ;
else if ( V_3 -> V_311 == 0 )
F_25 ( V_3 ) ;
}
...
V_312 = 20 ;
if ( V_27 -> type == V_30 ) {
V_3 -> V_321 . V_312 = V_312 ;
V_3 -> V_321 . V_322 = V_323 ;
} else {
V_12 -> V_312 = V_312 ;
F_129 ( V_12 ) ;
}
...
static T_5 F_130 ( struct V_81 * V_36 ,
struct V_26 * V_27 )
{
struct V_2 * V_3 = V_36 -> V_3 ;
T_5 V_325 ;
F_4 ( & V_3 -> V_65 ) ;
F_7 ( V_3 ) ;
V_325 = F_131 ( V_3 -> V_12 ) ;
F_8 ( V_3 ) ;
F_6 ( & V_3 -> V_65 ) ;
return V_325 ;
}
static void F_132 ( struct V_81 * V_36 ,
struct V_26 * V_27 , T_5 V_325 )
{
struct V_2 * V_3 = V_36 -> V_3 ;
F_4 ( & V_3 -> V_65 ) ;
F_7 ( V_3 ) ;
F_133 ( V_3 -> V_12 , V_325 ) ;
F_8 ( V_3 ) ;
F_6 ( & V_3 -> V_65 ) ;
}
static void F_134 ( struct V_81 * V_36 ,
struct V_26 * V_27 )
{
struct V_2 * V_3 = V_36 -> V_3 ;
F_4 ( & V_3 -> V_65 ) ;
...
static int F_136 ( struct V_81 * V_36 ,
struct V_26 * V_27 ,
enum V_180 V_181 ,
struct V_126 * V_127 ,
T_3 V_182 , T_3 * V_326 , T_1 V_327 )
{
struct V_2 * V_3 = V_36 -> V_3 ;
struct V_131 * V_132 ;
int V_10 = 0 ;
...
break;
case V_189 :
V_10 = F_65 ( V_3 , V_27 , V_127 , V_181 , V_182 ) ;
if ( ! V_10 )
F_137 ( V_27 , V_127 -> V_46 , V_182 ) ;
break;
case V_330 :
case V_331 :
case V_332 :
F_65 ( V_3 , V_27 , V_127 , V_181 , V_182 ) ;
...
static int F_141 ( struct V_81 * V_36 , T_4 V_337 )
{
return 0 ;
}
static void F_142 ( struct V_81 * V_36 ,
T_6 V_338 )
{
struct V_2 * V_3 = V_36 -> V_3 ;
F_4 ( & V_3 -> V_65 ) ;
...
V_341 . V_153 = V_342 ;
V_341 . V_43 = F_54 ( V_43 -> V_219 [ V_342 ] . V_343 ) ;
F_36 ( V_344 , & V_341 ) ;
if ( V_10 ) {
F_32 ( V_45 ,
L_53
...
V_341 . V_153 = V_345 ;
V_341 . V_43 = F_54 ( V_43 -> V_219 [ V_345 ] . V_343 ) ;
F_36 ( V_344 , & V_341 ) ;
if ( V_10 ) {
F_32 ( V_45 ,
L_55
...
struct V_359 * F_145 ( struct V_2 * V_3 )
{
...
static int F_147 ( struct V_81 * V_36 , T_4 * V_370 ,
T_4 * V_371 )
{
struct V_2 * V_3 = V_36 -> V_3 ;
struct V_359 * V_360 = F_145 ( V_3 ) ;
if ( V_360 ) {
* V_370 = V_360 -> V_372 ;
* V_371 = V_360 -> V_373 ;
} else {
