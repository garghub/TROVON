...
int V_46 ;
int V_21 ;
V_43 = F_10 ( V_47 , & V_11 -> V_16 ) ;
if ( ! V_43 )
return - V_32 ;
if ( F_11 ( V_11 -> V_16 . V_17 , L_9 , NULL ) )
return - V_48 ;
V_45 = F_12 ( sizeof( * V_45 ) , V_49 ) ;
if ( V_45 == NULL )
return - V_50 ;
V_46 = ( unsigned long ) V_43 -> V_51 ;
V_21 = F_3 ( V_11 , V_46 , & V_12 ) ;
if ( V_21 )
goto V_52;
switch ( V_46 ) {
#ifdef F_13
...
{
struct V_44 * V_45 = F_22 ( & V_11 -> V_16 ) ;
switch ( V_45 -> type ) {
#ifdef F_13
case V_53 ... V_54 :
F_23 ( V_45 -> line ) ;
