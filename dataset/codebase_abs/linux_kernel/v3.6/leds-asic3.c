...
if ( V_33 < 0 )
return V_33 ;
V_31 -> V_2 = F_11 ( & V_6 -> V_7 , sizeof( struct V_1 ) ,
V_34 ) ;
if ( ! V_31 -> V_2 ) {
V_33 = - V_35 ;
goto V_36;
}
V_31 -> V_2 -> V_37 = V_31 -> V_37 ;
V_31 -> V_2 -> V_38 = V_39 ;
V_31 -> V_2 -> F_1 = F_1 ;
V_31 -> V_2 -> F_6 = F_6 ;
V_31 -> V_2 -> V_40 = V_31 -> V_40 ;
...
static int T_3 F_14 ( struct V_5 * V_6 )
{
struct V_30 * V_31 = V_6 -> V_7 . V_32 ;
F_15 ( V_31 -> V_2 ) ;
return F_13 ( V_6 ) ;
}
static int F_16 ( struct V_41 * V_7 )
{
...
static int F_17 ( struct V_41 * V_7 )
{
struct V_5 * V_6 = F_2 ( V_7 ) ;
const struct V_9 * V_10 = F_3 ( V_6 ) ;
int V_33 ;
