...
{
if ( V_54 )
return F_20 ( & V_53 -> V_54 , V_36 , V_37 ) ;
else
return F_20 ( & V_53 -> V_55 , V_36 , V_37 ) ;
}
int F_35 ( struct V_52 * V_56 ,
struct V_52 * V_57 )
{
int V_11 ;
...
static int F_36 ( T_6 V_36 , T_6 V_37 , void * V_29 )
{
...
V_61 = F_41 ( V_39 -> V_36 , V_39 -> V_30 - V_39 -> V_36 ,
V_58 ) ;
if ( ! V_61 ) {
F_42 ( V_65
L_2 ,
( unsigned long long ) V_39 -> V_36 ,
( unsigned long long ) V_39 -> V_30 - 1 , V_58 ) ;
V_59 = V_39 ;
goto V_66;
}
}
F_30 (res, &resources->ioport, list) {
V_61 = F_43 ( V_39 -> V_36 , V_39 -> V_30 - V_39 -> V_36 , V_58 ) ;
if ( ! V_61 ) {
F_42 ( V_65
L_3 ,
( unsigned long long ) V_39 -> V_36 ,
...
if ( V_39 == V_59 )
break;
F_44 ( V_39 -> V_36 , V_39 -> V_30 - V_39 -> V_36 ) ;
}
V_59 = NULL ;
V_66:
F_30 (res, &resources->iomem, list) {
if ( V_39 == V_59 )
break;
F_45 ( V_39 -> V_36 , V_39 -> V_30 - V_39 -> V_36 ) ;
}
V_64:
F_32 ( & V_62 ) ;
return V_11 ;
...
static int F_47 ( struct V_68 * V_69 , T_2 * V_70 ,
T_1 * V_71 )
{
T_1 V_72 , V_13 , V_73 , V_74 ;
V_72 = V_69 -> V_72 ;
V_13 = V_69 -> V_13 ;
V_73 = V_69 -> V_75 ;
V_74 = V_69 -> V_74 ;
memcpy ( V_70 , & V_69 -> V_76 , sizeof( * V_70 ) ) ;
if ( ! * V_70 ) {
...
int F_15 ( struct V_68 * V_69 )
{
int V_11 ;
T_1 V_71 ;
T_2 V_76 ;
V_11 = F_47 ( V_69 , & V_76 , & V_71 ) ;
if ( V_11 )
return V_11 ;
return F_48 ( V_69 ) ;
}
int F_3 ( T_2 * V_10 , struct V_68 * V_69 )
{
int V_11 ;
T_1 V_71 ;
T_2 V_76 ;
...
int F_7 ( T_2 V_10 , struct V_68 * V_69 )
{
int V_11 ;
T_1 V_71 ;
T_2 V_76 ;
...
if ( ! ( V_2 -> V_4 [ V_31 ] . V_16 & V_32 ) )
return 0 ;
V_11 = F_47 ( V_69 , & V_70 , & V_71 ) ;
if ( V_11 )
return V_11 ;
switch ( V_69 -> V_74 ) {
case V_77 :
return F_20 ( & V_53 -> V_54 , V_70 ,
V_71 / 8 ) ;
case V_78 :
return F_20 ( & V_53 -> V_55 , V_70 ,
V_71 / 8 ) ;
default:
return - V_26 ;
}
...
struct V_52 * V_53 )
{
return F_13 ( V_2 , F_54 ,
V_53 , NULL ) ;
}
struct V_82 * F_56 ( void )
{
...
int F_58 ( void )
{
static T_3 V_84 [] = L_11 ;
T_8 V_85 ;
T_1 V_86 [ 3 ] ;
struct V_87 V_88 = {
. V_89 = V_84 ,
. V_90 = 1 ,
. V_91 . V_92 = sizeof( V_86 ) ,
. V_91 . V_93 = V_86 ,
} ;
V_86 [ V_94 ] = V_95 ;
V_86 [ V_96 ] = 1 ;
V_86 [ V_97 ] = 0 ;
if ( F_50 ( F_59 ( NULL , L_12 , & V_85 ) )
|| F_50 ( F_60 ( V_85 , & V_88 ) ) )
return - V_81 ;
else {
F_22 ( V_88 . V_98 . V_93 ) ;
