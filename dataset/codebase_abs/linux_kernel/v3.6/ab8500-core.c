...
static T_3 F_33 ( int V_46 , void * V_5 )
{
struct V_1 * V_1 = V_5 ;
int V_24 ;
F_11 ( V_1 -> V_5 , L_9 ) ;
...
int F_34 ( struct V_1 * V_1 , int V_46 )
{
if ( ! V_1 )
return - V_8 ;
return F_35 ( V_1 -> V_52 , V_46 ) ;
}
static int F_36 ( struct V_53 * V_54 , unsigned int V_55 ,
T_4 V_33 )
{
struct V_1 * V_1 = V_54 -> V_56 ;
if ( ! V_1 )
return - V_8 ;
F_37 ( V_55 , V_1 ) ;
F_38 ( V_55 , & V_57 ,
