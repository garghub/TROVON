...
void T_4 F_13 ( T_1 (* F_14)( void ) , int V_17 ,
unsigned long V_18 )
{
F_15 ( F_14 , V_17 , V_18 ) ;
V_9 . V_19 = true ;
}
void T_4 F_15 ( T_1 (* F_14)( void ) , int V_17 , unsigned long V_18 )
{
...
F_6 = F_14 ;
V_14 = ( 1 << V_17 ) - 1 ;
F_19 ( & V_9 . V_4 , & V_9 . V_5 , V_18 , V_25 , 0 ) ;
V_20 = V_18 ;
if ( V_20 >= 4000000 ) {
V_20 /= 1000000 ;
V_24 = 'M' ;
...
V_24 = ' ' ;
V_23 = F_2 ( ( 1ULL << V_17 ) - 1 , V_9 . V_4 , V_9 . V_5 ) ;
F_20 ( V_23 , V_26 ) ;
V_21 = V_23 ;
V_22 = F_2 ( 1ULL , V_9 . V_4 , V_9 . V_5 ) ;
F_21 ( L_1 ,
V_17 , V_20 , V_24 , V_22 , V_21 ) ;
V_16 . V_27 = F_22 ( V_21 - ( V_21 / 10 ) ) ;
F_5 () ;
V_9 . V_7 = 0 ;
F_23 ( L_2 , F_14 ) ;
}
