...
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
F_17 ( V_32 -> V_33 , V_34 , sizeof( V_32 -> V_33 ) ) ;
F_17 ( V_32 -> V_35 , V_36 , sizeof( V_32 -> V_35 ) ) ;
F_17 ( V_32 -> V_37 , F_18 ( V_6 -> V_38 ) ,
sizeof( V_32 -> V_37 ) ) ;
V_32 -> V_39 = F_15 ( V_2 ) ;
}
...
struct V_5 * V_6 = F_2 ( V_2 ) ;
struct V_15 * V_16 = & V_6 -> V_16 ;
struct V_43 * V_38 = V_6 -> V_38 ;
T_1 * V_44 = V_42 ;
T_2 V_45 , V_46 ;
V_41 -> V_35 = 0x1000000 | ( V_47 ) V_38 -> V_48 << 16 | V_38 -> V_49 ;
for ( V_45 = 0 ; V_45 < V_50 ; V_45 ++ )
* V_44 ++ = F_20 ( & V_16 -> V_51 -> V_52 + V_45 ) ;
for ( V_45 = 0 ; V_45 < V_53 ; V_45 ++ ) {
F_21 ( & V_6 -> V_16 , V_45 , & V_46 ) ;
* V_44 ++ = V_46 ;
}
}
...
struct V_15 * V_16 = & V_6 -> V_16 ;
V_103 -> V_29 =
( ( V_16 -> V_24 . V_104 ) ? V_105 : V_106 ) ;
if ( V_16 -> V_24 . V_107 == V_108 ) {
V_103 -> V_109 = 1 ;
} else if ( V_16 -> V_24 . V_107 == V_110 ) {
V_103 -> V_111 = 1 ;
} else if ( V_16 -> V_24 . V_107 == V_112 ) {
V_103 -> V_109 = 1 ;
V_103 -> V_111 = 1 ;
}
}
...
struct V_15 * V_16 = & V_6 -> V_16 ;
int V_7 = 0 ;
V_16 -> V_24 . V_104 = V_103 -> V_29 ;
if ( ( V_103 -> V_109 ) && ( V_103 -> V_111 ) )
V_16 -> V_24 . V_107 = V_112 ;
else if ( ( V_103 -> V_109 ) && ( ! V_103 -> V_111 ) )
V_16 -> V_24 . V_107 = V_108 ;
else if ( ( ! V_103 -> V_109 ) && ( V_103 -> V_111 ) )
V_16 -> V_24 . V_107 = V_110 ;
else if ( ( ! V_103 -> V_109 ) && ( ! V_103 -> V_111 ) )
V_16 -> V_24 . V_107 = V_113 ;
if ( V_16 -> V_24 . V_104 == V_105 ) {
if ( ( F_11 ( V_6 -> V_2 ) ) ) {
F_12 ( V_6 ) ;
V_7 = F_13 ( V_6 ) ;
} else {
