...
unsigned int V_92 , unsigned int V_73 ,
enum V_93 V_67 )
{
unsigned int V_48 ;
int V_94 ;
...
struct V_96 * V_97 )
{
unsigned int V_89 , V_98 ;
int V_99 ;
if ( V_97 -> V_98 < 1 ) {
F_23 ( 1 , L_12 , V_97 -> V_98 ) ;
return - V_100 ;
}
if ( V_97 -> V_67 != V_68 &&
V_97 -> V_67 != V_74 &&
...
V_98 = V_52 ;
V_89 = 0 ;
V_3 -> V_31 -> V_41 ( V_3 , & V_98 , & V_89 ) ;
F_23 ( 1 , L_17 ,
V_98 , V_89 ,
( unsigned int ) ( ( V_98 * F_36 ( V_89 ) ) >> V_101 ) ) ;
V_99 = F_35 ( V_3 , V_98 , V_89 , V_97 -> V_67 ) ;
if ( V_99 < 0 ) {
F_23 ( 1 , L_18 , V_99 ) ;
goto V_9;
}
...
F_23 ( 1 , L_32 ) ;
V_36 = F_30 ( V_3 ) ;
V_99 = V_3 -> V_31 -> V_42 ( V_3 , V_28 , V_36 ) ;
if ( 0 != V_99 ) {
F_23 ( 1 , L_33 , V_99 ) ;
goto V_9;
}
...
F_34 ( V_3 ) ;
if ( V_65 -> V_67 == V_68 )
F_45 ( & V_102 -> V_103 -> V_104 ) ;
return V_99 ;
}
static int F_46 ( struct V_2 * V_3 , int V_108 )
{
int V_99 ;
V_109:
if ( ! V_3 -> V_49 ) {
...
if ( V_99 )
goto V_9;
V_28 = F_48 ( V_3 -> V_47 . V_111 , struct V_1 , V_47 ) ;
V_99 = F_9 ( V_3 , V_28 , V_110 , 1 ) ;
if ( V_99 < 0 )
goto V_9;
* V_4 = V_28 ;
V_9:
...
return - V_95 ;
V_3 -> V_51 -> V_67 = V_74 ;
V_3 -> V_51 -> V_76 = ( unsigned long ) V_113 ;
V_3 -> V_51 -> V_73 = V_98 ;
V_36 = F_30 ( V_3 ) ;
V_99 = V_3 -> V_31 -> V_42 ( V_3 , V_3 -> V_51 , V_36 ) ;
if ( 0 != V_99 )
goto V_9;
F_7 ( V_3 -> V_14 , V_12 ) ;
V_3 -> V_31 -> V_43 ( V_3 , V_3 -> V_51 ) ;
F_8 ( V_3 -> V_14 , V_12 ) ;
V_99 = F_9 ( V_3 , V_3 -> V_51 , 0 , 0 ) ;
if ( 0 == V_99 ) {
F_17 ( V_3 , V_112 , V_3 , V_3 -> V_51 ) ;
...
struct V_1 * V_28 ,
char T_3 * V_113 , T_4 V_98 ,
int V_110 )
{
void * V_29 = F_17 ( V_3 , V_29 , V_28 ) ;
if ( V_98 > V_28 -> V_89 - V_3 -> V_116 )
V_98 = V_28 -> V_89 - V_3 -> V_116 ;
if ( F_56 ( V_113 , V_29 + V_3 -> V_116 , V_98 ) )
return - V_117 ;
return V_98 ;
}
static int F_57 ( struct V_2 * V_3 ,
struct V_1 * V_28 ,
char T_3 * V_113 , T_4 V_98 , T_4 V_118 ,
int V_119 , int V_110 )
{
unsigned int * V_120 = F_17 ( V_3 , V_29 , V_28 ) ;
if ( V_119 ) {
V_120 += ( V_28 -> V_89 >> 2 ) - 1 ;
* V_120 = V_28 -> V_91 >> 1 ;
F_23 ( 1 , L_42 , * V_120 ) ;
}
V_98 = F_55 ( V_3 , V_28 , V_113 , V_98 , V_110 ) ;
if ( ( V_98 == - V_117 ) && ( V_118 == 0 ) )
return - V_117 ;
return V_98 ;
}
T_2 F_58 ( struct V_2 * V_3 ,
char T_3 * V_113 , T_4 V_98 , T_5 * V_114 ,
int V_110 )
{
enum V_35 V_36 ;
unsigned long V_12 = 0 ;
unsigned V_89 = 0 , V_121 = 1 ;
int V_99 ;
F_10 ( V_3 -> V_6 -> V_10 , V_26 ) ;
F_33 ( V_3 ) ;
V_3 -> V_31 -> V_41 ( V_3 , & V_121 , & V_89 ) ;
if ( NULL == V_3 -> V_51 &&
V_98 >= V_89 &&
! V_110 ) {
V_99 = F_54 ( V_3 , V_113 , V_98 , V_114 ) ;
if ( V_99 >= 0 || V_99 == - V_115 )
goto V_9;
}
if ( NULL == V_3 -> V_51 ) {
V_99 = - V_95 ;
...
V_99 = F_55 ( V_3 , V_3 -> V_51 , V_113 , V_98 , V_110 ) ;
if ( V_99 < 0 )
goto V_9;
V_3 -> V_116 += V_99 ;
if ( V_3 -> V_116 == V_3 -> V_51 -> V_89 ) {
V_3 -> V_31 -> V_44 ( V_3 , V_3 -> V_51 ) ;
F_25 ( V_3 -> V_51 ) ;
V_3 -> V_51 = NULL ;
}
...
V_98 = V_52 ;
V_89 = F_36 ( V_89 ) ;
V_94 = F_35 ( V_3 , V_98 , V_89 , V_74 ) ;
if ( V_94 < 0 )
return V_94 ;
V_98 = V_94 ;
for ( V_48 = 0 ; V_48 < V_98 ; V_48 ++ ) {
V_36 = F_30 ( V_3 ) ;
V_94 = V_3 -> V_31 -> V_42 ( V_3 , V_3 -> V_53 [ V_48 ] , V_36 ) ;
if ( V_94 )
return V_94 ;
...
while ( V_98 > 0 ) {
if ( NULL == V_3 -> V_51 ) {
V_3 -> V_51 = F_48 ( V_3 -> V_47 . V_111 ,
struct V_1 ,
V_47 ) ;
F_28 ( & V_3 -> V_51 -> V_47 ) ;
V_3 -> V_116 = 0 ;
}
V_13 = F_9 ( V_3 , V_3 -> V_51 , V_110 , 1 ) ;
if ( V_13 < 0 ) {
if ( 0 == V_99 )
V_99 = V_13 ;
break;
...
V_13 = F_57 ( V_3 , V_3 -> V_51 , V_113 + V_99 , V_98 ,
V_99 , V_119 , V_110 ) ;
if ( V_13 < 0 ) {
V_99 = V_13 ;
break;
...
unsigned int F_65 ( struct V_122 * V_122 ,
struct V_2 * V_3 ,
T_6 * V_46 )
{
unsigned long V_123 = F_66 ( V_46 ) ;
struct V_1 * V_28 = NULL ;
unsigned int V_13 = 0 ;
F_33 ( V_3 ) ;
if ( V_3 -> V_49 ) {
if ( ! F_39 ( & V_3 -> V_47 ) )
V_28 = F_48 ( V_3 -> V_47 . V_111 ,
struct V_1 , V_47 ) ;
} else if ( V_123 & ( V_124 | V_125 ) ) {
if ( ! V_3 -> V_50 )
F_59 ( V_3 ) ;
if ( ! V_3 -> V_50 ) {
V_13 = V_126 ;
...
int F_68 ( struct V_2 * V_3 , struct V_129 * V_130 )
{
int V_13 = - V_100 ;
int V_48 ;
F_10 ( V_3 -> V_6 -> V_10 , V_26 ) ;
if ( ! ( V_130 -> V_131 & V_132 ) || ! ( V_130 -> V_131 & V_133 ) ) {
F_23 ( 1 , L_44 ) ;
return - V_100 ;
}
F_33 ( V_3 ) ;
...
V_28 -> V_71 == ( V_130 -> V_134 << V_101 ) ) {
V_13 = F_17 ( V_3 , V_135 , V_3 , V_28 , V_130 ) ;
break;
}
}
F_34 ( V_3 ) ;
