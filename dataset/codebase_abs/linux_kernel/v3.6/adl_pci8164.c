...
static struct V_26 * F_15 ( struct V_1 * V_2 ,
struct V_27 * V_28 )
{
struct V_26 * V_29 = NULL ;
int V_30 = V_28 -> V_31 [ 0 ] ;
int V_32 = V_28 -> V_31 [ 1 ] ;
F_16 (pcidev) {
if ( V_29 -> V_33 != V_34 ||
V_29 -> V_35 != V_36 )
continue;
if ( V_30 || V_32 ) {
if ( V_29 -> V_30 -> V_37 != V_30 ||
F_17 ( V_29 -> V_38 ) != V_32 )
continue;
}
return V_29 ;
...
V_2 -> V_18 = F_22 ( V_29 , 2 ) ;
F_4 ( V_19 L_21 , V_2 -> V_18 ) ;
V_4 = V_2 -> V_45 + 0 ;
V_4 -> type = V_46 ;
V_4 -> V_47 = V_48 | V_49 ;
V_4 -> V_50 = 4 ;
...
static int T_1 F_27 ( struct V_26 * V_2 ,
const struct V_55 * V_56 )
{
return F_28 ( V_2 , & V_57 ) ;
}
static void T_2 F_29 ( struct V_26 * V_2 )
{
F_30 ( V_2 ) ;
}
