...
if ( ! V_50 )
goto V_84;
V_80 = F_34 ( sizeof( struct V_47 ) , V_65 ) ;
if ( ! V_80 )
goto V_85;
V_25 = & V_46 -> V_86 . V_79 ;
V_25 -> V_54 = V_55 ;
V_25 -> V_56 = V_87 ;
V_25 -> V_26 |= V_60 ;
V_46 -> V_88 . V_53 . V_89 = V_90 ;
V_46 -> V_88 . V_91 = 1 ;
V_46 -> V_88 . args [ 0 ] . V_61 = sizeof( struct V_79 ) ;
V_46 -> V_88 . args [ 0 ] . V_49 = V_25 ;
V_46 -> V_48 . V_91 = 2 ;
V_46 -> V_48 . args [ 0 ] . V_61 = sizeof( struct V_47 ) ;
V_46 -> V_48 . args [ 0 ] . V_49 = V_80 ;
V_46 -> V_48 . args [ 1 ] . V_61 = V_81 ;
V_46 -> V_48 . V_92 = 1 ;
V_46 -> V_48 . V_93 = 1 ;
V_46 -> V_51 [ 0 ] = V_50 ;
V_46 -> V_94 = 1 ;
...
static int F_58 ( struct V_13 * V_13 , struct V_8 * V_8 )
{
struct V_1 * V_16 ;
int V_17 ;
...
static int F_61 ( struct V_13 * V_13 , struct V_8 * V_8 )
{
...
struct V_97 * V_98 , char * V_9 )
{
struct V_1 * V_16 = F_66 ( V_15 ) ;
return sprintf ( V_9 , L_9 , F_67 ( & V_16 -> V_3 . V_99 ) ) ;
}
