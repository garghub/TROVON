...
{
if ( F_121 ( V_201 ) ) {
int V_202 = F_122 ( V_201 , 0 ) ;
if ( V_202 & V_203 ) {
char * V_28 = F_123 ( V_204 ) ;
...
V_200 = 0 ;
F_71 (c)
if ( ( V_60 -> V_9 & V_145 ) && V_60 -> V_212 )
V_60 -> V_212 () ;
F_95 () ;
}
struct V_213 * F_137 ( int * V_179 )
{
struct V_141 * V_60 ;
...
void F_141 ( struct V_141 * V_217 )
{
int V_29 ;
unsigned long V_9 ;
struct V_141 * V_218 = NULL ;
if ( V_143 && V_217 -> V_9 & V_219 ) {
F_71 (bcon) {
if ( ! ( V_218 -> V_9 & V_219 ) ) {
F_68 ( V_140 L_28 ,
V_217 -> V_174 , V_217 -> V_179 ) ;
return;
}
}
}
if ( V_143 && V_143 -> V_9 & V_219 )
V_218 = V_143 ;
if ( V_220 < 0 || V_218 || ! V_143 )
V_220 = V_180 ;
if ( V_217 -> V_221 )
V_217 -> V_221 () ;
if ( V_220 < 0 ) {
...
V_29 ++ ) {
if ( strcmp ( V_177 [ V_29 ] . V_174 , V_217 -> V_174 ) != 0 )
continue;
if ( V_217 -> V_179 >= 0 &&
V_217 -> V_179 != V_177 [ V_29 ] . V_179 )
continue;
if ( V_217 -> V_179 < 0 )
V_217 -> V_179 = V_177 [ V_29 ] . V_179 ;
#ifdef F_103
...
#endif
if ( V_217 -> V_222 &&
V_217 -> V_222 ( V_217 , V_177 [ V_29 ] . V_175 ) != 0 )
break;
V_217 -> V_9 |= V_145 ;
V_217 -> V_179 = V_177 [ V_29 ] . V_179 ;
if ( V_29 == V_180 ) {
...
if ( ! ( V_217 -> V_9 & V_145 ) )
return;
if ( V_218 && ( ( V_217 -> V_9 & ( V_223 | V_219 ) ) == V_223 ) )
V_217 -> V_9 &= ~ V_225 ;
F_110 () ;
if ( ( V_217 -> V_9 & V_223 ) || V_143 == NULL ) {
V_217 -> V_116 = V_143 ;
V_143 = V_217 ;
if ( V_217 -> V_116 )
V_217 -> V_116 -> V_9 &= ~ V_223 ;
} else {
V_217 -> V_116 = V_143 -> V_116 ;
V_143 -> V_116 = V_217 ;
}
if ( V_217 -> V_9 & V_225 ) {
F_44 ( & V_50 , V_9 ) ;
...
F_68 ( V_140 L_30 ,
( V_217 -> V_9 & V_219 ) ? L_31 : L_17 ,
V_217 -> V_174 , V_217 -> V_179 ) ;
}
}
int F_144 ( struct V_141 * V_141 )
{
struct V_141 * V_226 , * V_227 ;
int V_228 = 1 ;
#ifdef F_103
if ( V_141 -> V_9 & V_224 )
return F_145 ( V_141 ) ;
...
for ( V_226 = V_143 -> V_116 , V_227 = V_143 ;
V_226 ; V_227 = V_226 , V_226 = V_227 -> V_116 ) {
if ( V_226 == V_141 ) {
V_227 -> V_116 = V_226 -> V_116 ;
V_228 = 0 ;
break;
}
}
}
if ( V_143 != NULL && V_141 -> V_9 & V_223 )
V_143 -> V_9 |= V_223 ;
F_95 () ;
F_143 () ;
return V_228 ;
...
V_28 = F_123 ( V_204 ) ;
va_start ( args , V_159 ) ;
V_172 = vsnprintf ( V_28 , V_229 , V_159 , args ) ;
va_end ( args ) ;
F_149 ( V_201 , V_203 ) ;
F_97 ( V_9 ) ;
return V_172 ;
}
int F_150 ( const char * V_230 )
{
return F_151 ( & V_231 , V_230 ) ;
}
bool F_152 ( unsigned long * V_232 ,
unsigned int V_233 )
{
if ( * V_232 == 0
|| ! F_153 ( V_97 , * V_232 ,
...
if ( ! V_235 -> V_239 ) {
V_235 -> V_239 = 1 ;
F_156 ( & V_235 -> V_240 , & V_241 ) ;
V_76 = 0 ;
}
F_157 ( & V_238 , V_9 ) ;
return V_76 ;
}
int F_158 ( struct V_234 * V_235 )
{
unsigned long V_9 ;
int V_76 = - V_33 ;
F_155 ( & V_238 , V_9 ) ;
...
if ( V_235 -> V_246 && V_243 > V_235 -> V_246 )
continue;
V_235 -> V_247 = true ;
F_44 ( & V_50 , V_9 ) ;
V_235 -> V_248 = V_67 ;
...
V_235 -> V_250 = V_19 ;
F_45 ( & V_50 , V_9 ) ;
V_235 -> V_237 ( V_235 , V_243 ) ;
V_235 -> V_247 = false ;
}
F_164 () ;
}
bool F_165 ( struct V_234 * V_235 , bool V_111 ,
...
goto V_39;
V_1 = F_3 ( V_235 -> V_249 ) ;
V_251 = F_62 ( V_1 , 0 , V_111 , line , V_14 ) ;
V_235 -> V_249 = F_4 ( V_235 -> V_249 ) ;
V_235 -> V_248 ++ ;
V_31 = true ;
V_39:
if ( V_5 )
...
bool F_166 ( struct V_234 * V_235 , bool V_111 ,
char * line , T_6 V_14 , T_6 * V_5 )
{
unsigned long V_9 ;
bool V_31 ;
F_44 ( & V_50 , V_9 ) ;
V_31 = F_165 ( V_235 , V_111 , line , V_14 , V_5 ) ;
F_45 ( & V_50 , V_9 ) ;
return V_31 ;
}
bool F_167 ( struct V_234 * V_235 , bool V_111 ,
...
V_3 = V_235 -> V_249 ;
V_58 = 0 ;
while ( V_51 < V_235 -> V_125 ) {
struct log * V_1 = F_3 ( V_3 ) ;
V_251 += F_62 ( V_1 , V_58 , true , NULL , 0 ) ;
V_3 = F_4 ( V_3 ) ;
V_51 ++ ;
V_58 = V_1 -> V_9 ;
}
...
V_3 = V_235 -> V_249 ;
V_58 = 0 ;
while ( V_251 > V_14 && V_51 < V_235 -> V_125 ) {
struct log * V_1 = F_3 ( V_3 ) ;
V_251 -= F_62 ( V_1 , V_58 , true , NULL , 0 ) ;
V_3 = F_4 ( V_3 ) ;
V_51 ++ ;
...
while ( V_51 < V_235 -> V_125 ) {
struct log * V_1 = F_3 ( V_3 ) ;
V_251 += F_62 ( V_1 , V_58 , V_111 , V_28 + V_251 , V_14 - V_251 ) ;
V_3 = F_4 ( V_3 ) ;
V_51 ++ ;
V_58 = V_1 -> V_9 ;
}
