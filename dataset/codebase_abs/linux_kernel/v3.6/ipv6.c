...
if ( V_38 . V_222 == NULL )
return - V_223 ;
return F_135 ( & V_35 -> V_94 . V_95 , V_224 ,
V_225 , V_13 , V_35 ) ;
}
static void T_8 F_136 ( struct V_35 * V_35 )
{
F_137 ( V_35 -> V_94 . V_95 ) ;
}
static int T_9 F_138 ( void )
{
int V_33 = F_139 ( & V_226 , 1 ) ;
if ( V_33 != 0 )
goto V_41;
V_33 = F_140 ( & V_227 , V_13 ) ;
if ( V_33 != 0 )
goto V_228;
F_141 ( & V_229 ) ;
V_33 = F_142 ( & V_230 ) ;
