...
if ( ! V_4 -> V_100 )
return true ;
for ( V_99 = 0 ; V_99 < V_4 -> V_100 ; V_99 ++ ) {
struct V_101 * V_102 = V_4 -> V_103 + V_99 ;
...
V_69 = F_42 ( sizeof( struct V_69 ) ,
V_118 ) ;
if ( ! V_69 )
return;
V_110 = F_42 ( sizeof( struct V_110 ) ,
V_118 ) ;
if ( ! V_110 )
goto V_119;
V_112 = F_42 ( sizeof( struct V_111 ) , V_118 ) ;
if ( ! V_112 )
goto V_120;
V_69 -> V_4 = V_112 ;
V_29 = & V_110 -> V_121 ;
...
V_69 -> V_71 -> V_140 = 0x2C ;
V_4 -> V_141 = V_69 -> V_71 ;
V_69 -> V_142 = F_49 ( V_2 ,
V_143 ,
L_9 ) ;
if ( ! V_69 -> V_142 ) {
F_50 ( V_46 , & V_2 -> V_138 -> V_2 ,
L_10 L_11 ) ;
goto V_144;
}
F_23 ( V_29 ,
