...
static T_2 F_6 ( struct V_36 * V_33 , struct V_37 * V_38 ,
char * V_39 )
{
struct V_1 * V_2 = F_7 ( V_33 ) ;
return snprintf ( V_39 , V_40 , L_8 , V_2 -> V_41 ) ;
}
static int T_1 F_8 ( struct V_12 * V_33 ,
const struct V_42 * V_18 )
{
struct V_1 * V_2 ;
int V_43 ;
V_2 = F_9 ( sizeof( * V_2 ) , V_44 ) ;
if ( ! V_2 ) {
F_4 ( & V_33 -> V_33 , L_9 ) ;
V_43 = - V_45 ;
goto V_46;
...
V_2 -> V_50 = F_14 ( V_33 , 4 ) ;
if ( ! V_2 -> V_50 ) {
F_4 ( & V_33 -> V_33 , L_12 ) ;
V_43 = - V_45 ;
goto V_51;
}
V_2 -> V_41 = F_15 ( & V_2 -> V_50 -> V_52 ) ;
V_43 = F_16 ( & V_33 -> V_33 . V_53 , & V_54 ) ;
if ( V_43 ) {
F_4 ( & V_33 -> V_33 , L_13 ) ;
goto V_55;
}
F_17 ( 0xf , & V_2 -> V_50 -> V_56 ) ;
V_43 = F_2 ( V_2 ) ;
if ( V_43 ) {
F_4 ( & V_33 -> V_33 , L_14 ) ;
goto V_57;
...
static void T_3 F_23 ( struct V_12 * V_33 )
{
