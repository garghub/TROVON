...
static int T_2 F_6 ( struct V_13 * V_14 )
{
int V_10 ;
struct V_8 * V_9 ;
unsigned int V_15 ;
static T_3 V_16 = F_7 ( 32 ) ;
if ( F_8 () ) {
V_10 = - V_17 ;
goto V_18;
}
...
{
unsigned int V_41 ;
struct V_8 * V_9 = F_29 ( V_14 ) ;
F_12 ( ! V_9 ) ;
F_10 ( & V_14 -> V_19 , L_16 , V_20 , __LINE__ , V_9 -> V_7 ) ;
F_10 ( & V_14 -> V_19 , L_17 , V_20 , __LINE__ , V_9 -> V_42 ) ;
V_41 = V_9 -> V_42 ;
F_30 ( V_9 ) ;
F_31 ( V_9 ) ;
F_19 ( V_14 , NULL ) ;
...
static int T_4 F_32 ( struct V_43 * V_44 )
{
return F_33 ( V_45 )
? F_34 ( V_44 )
: 0 ;
