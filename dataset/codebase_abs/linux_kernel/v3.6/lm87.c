...
struct V_5 * V_8 = F_7 ( V_2 ) ;
if ( V_2 -> V_7 . V_79 ) {
V_8 -> V_16 = * ( T_1 * ) V_2 -> V_7 . V_79 ;
F_3 ( V_2 ,
V_80 , V_8 -> V_16 ) ;
} else {
V_8 -> V_16 = F_1 ( V_2 , V_80 ) ;
}
V_8 -> V_81 = F_1 ( V_2 , V_65 ) & 0x6F ;
if ( ! ( V_8 -> V_81 & 0x01 ) ) {
int V_14 ;
...
struct V_5 * V_8 ;
int V_52 ;
V_8 = F_67 ( & V_2 -> V_7 , sizeof( struct V_5 ) , V_84 ) ;
if ( ! V_8 )
return - V_85 ;
F_68 ( V_2 , V_8 ) ;
V_8 -> V_13 = 0 ;
...
V_8 -> V_49 [ 0 ] = 2500 ;
V_8 -> V_49 [ 1 ] = 2700 ;
V_8 -> V_49 [ 2 ] = ( V_8 -> V_16 & V_86 ) ? 5000 : 3300 ;
V_8 -> V_49 [ 3 ] = 5000 ;
V_8 -> V_49 [ 4 ] = 12000 ;
V_8 -> V_49 [ 5 ] = 2700 ;
V_8 -> V_49 [ 6 ] = 1875 ;
V_8 -> V_49 [ 7 ] = 1875 ;
V_52 = F_70 ( & V_2 -> V_7 . V_70 , & V_71 ) ;
if ( V_52 )
goto V_87;
if ( V_8 -> V_16 & F_14 ( 0 ) ) {
V_52 = F_70 ( & V_2 -> V_7 . V_70 , & V_72 ) ;
if ( V_52 )
goto V_88;
} else {
V_52 = F_70 ( & V_2 -> V_7 . V_70 , & V_73 ) ;
if ( V_52 )
goto V_88;
}
if ( V_8 -> V_16 & F_14 ( 1 ) ) {
V_52 = F_70 ( & V_2 -> V_7 . V_70 , & V_74 ) ;
if ( V_52 )
goto V_88;
} else {
V_52 = F_70 ( & V_2 -> V_7 . V_70 , & V_75 ) ;
if ( V_52 )
goto V_88;
}
if ( V_8 -> V_16 & V_17 ) {
V_52 = F_70 ( & V_2 -> V_7 . V_70 , & V_76 ) ;
if ( V_52 )
goto V_88;
} else {
V_52 = F_70 ( & V_2 -> V_7 . V_70 , & V_77 ) ;
if ( V_52 )
goto V_88;
}
if ( ! ( V_8 -> V_16 & V_89 ) ) {
V_8 -> V_54 = F_71 () ;
V_52 = F_70 ( & V_2 -> V_7 . V_70 , & V_78 ) ;
if ( V_52 )
goto V_88;
}
V_8 -> V_90 = F_72 ( & V_2 -> V_7 ) ;
if ( F_73 ( V_8 -> V_90 ) ) {
V_52 = F_74 ( V_8 -> V_90 ) ;
goto V_88;
}
