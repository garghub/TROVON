...
{
struct V_39 * V_40 = F_51 ( V_13 ) ;
return sprintf ( V_16 , L_13 , V_40 -> V_58 ) ;
}
...
{
struct V_39 * V_40 = F_51 ( V_13 ) ;
return sprintf ( V_16 , L_13 , V_40 -> V_59 ) ;
}
...
{
struct V_39 * V_40 = F_51 ( V_13 ) ;
return sprintf ( V_16 , L_13 , V_40 -> V_61 ) ;
}
...
{
struct V_39 * V_40 = F_51 ( V_13 ) ;
return sprintf ( V_16 , L_13 , V_40 -> V_60 ) ;
}
...
{
struct V_39 * V_40 = F_51 ( V_13 ) ;
return sprintf ( V_16 , L_14 , ( V_69 - V_40 -> V_68 ) / V_77 ) ;
}
...
char * V_82 = V_16 ;
for ( V_21 = 0 ; V_21 < V_40 -> V_63 ; V_21 ++ ) {
V_82 += sprintf ( V_82 , L_15 ,
V_83 [ V_40 -> V_64 [ V_21 ] . type ] ,
V_40 -> V_64 [ V_21 ] . V_65 - 1 ) ;
}
return V_82 - V_16 ;
}
static T_1 F_64 ( struct V_84 * V_84 ,
const char T_4 * V_16 ,
T_3 V_37 , T_5 * V_85 )
{
...
static int F_67 ( struct V_94 * V_94 , struct V_84 * V_84 )
{
V_84 -> V_86 = V_94 -> V_95 ;
return 0 ;
}
...
if ( ! V_96 )
return - V_44 ;
V_99 = F_70 ( V_40 -> V_13 . V_101 . V_100 , V_96 ) ;
if ( ! V_99 )
return - V_97 ;
V_47 = V_99 ;
for ( V_21 = 0 ; V_21 < V_40 -> V_63 ; V_21 ++ ) {
sprintf ( V_100 , L_24 ,
V_83 [ V_40 -> V_64 [ V_21 ] . type ] ) ;
V_99 = F_75 ( V_100 , V_102 | V_103 , V_47 ,
& V_40 -> V_93 [ V_21 ] ) ;
if ( ! V_99 )
goto V_104;
}
V_99 = F_76 ( L_25 , V_102 | V_103 , V_47 ,
& V_40 -> V_90 ) ;
if ( ! V_99 )
goto V_104;
V_99 = F_77 ( L_26 , V_102 | V_103 , V_47 ,
& V_40 -> V_89 ) ;
if ( ! V_99 )
goto V_104;
V_99 = F_78 ( L_27 , V_103 , V_47 ,
& V_40 -> V_13 ,
& V_105 ) ;
if ( ! V_99 )
goto V_104;
...
int F_79 ( struct V_39 * V_40 )
{
int V_21 , V_42 ;
V_40 -> V_46 . V_100 = F_80 ( V_107 , L_28 , V_40 -> V_108 ) ;
if ( ! V_40 -> V_46 . V_100 )
return - V_97 ;
F_23 ( 0 , L_29 , V_40 -> V_46 . V_100 ) ;
V_42 = F_81 ( & V_40 -> V_46 ) ;
if ( V_42 < 0 )
return V_42 ;
V_40 -> V_13 . type = & V_109 ;
F_28 ( & V_40 -> V_13 ) ;
V_40 -> V_13 . V_47 = V_110 ;
V_40 -> V_13 . V_46 = & V_40 -> V_46 ;
F_29 ( & V_40 -> V_13 , L_28 , V_40 -> V_108 ) ;
F_30 ( & V_40 -> V_13 , V_40 ) ;
F_49 ( & V_40 -> V_13 ) ;
F_23 ( 0 , L_30 , F_24 ( & V_40 -> V_13 ) ) ;
V_42 = F_31 ( & V_40 -> V_13 ) ;
if ( V_42 < 0 ) {
F_82 ( & V_40 -> V_46 ) ;
F_25 ( V_40 -> V_46 . V_100 ) ;
return V_42 ;
}
for ( V_21 = 0 ; V_21 < V_40 -> V_111 ; V_21 ++ ) {
struct V_52 * V_25 = V_40 -> V_112 [ V_21 ] ;
if ( V_25 -> V_22 == 0 )
continue;
#ifdef F_83
F_23 ( 1 , L_31 , V_21 ) ;
if ( V_113 >= 1 ) {
int V_114 ;
for ( V_114 = 0 ; V_114 < V_40 -> V_63 ; V_114 ++ )
F_65 ( V_115 L_15 ,
V_83 [ V_40 -> V_64 [ V_114 ] . type ] ,
V_25 -> V_116 [ V_114 ] ) ;
F_65 ( V_115 L_32 ) ;
}
#endif
...
if ( V_25 -> V_22 == 0 )
continue;
F_23 ( 0 , L_34 , F_24 ( & V_25 -> V_13 ) ) ;
F_34 ( & V_25 -> V_13 ) ;
F_37 ( & V_25 -> V_13 ) ;
}
}
void F_86 ( struct V_39 * V_40 )
{
F_23 ( 1 , L_35 , F_24 ( & V_40 -> V_13 ) ) ;
F_34 ( & V_40 -> V_13 ) ;
F_37 ( & V_40 -> V_13 ) ;
F_82 ( & V_40 -> V_46 ) ;
F_25 ( V_40 -> V_46 . V_100 ) ;
