...
if ( V_66 )
F_3 ( L_3 ) ;
while ( ( V_49 = F_21 ( V_68 << 8 , V_49 ) ) != NULL ) {
V_65 ++ ;
V_57 = F_15 ( V_49 ) ;
if ( V_57 & V_59 )
V_63 |= 1 ;
...
static int F_28 ( T_1 V_73 , T_5 * V_74 ,
int V_75 , int V_76 )
{
T_4 V_56 ;
...
if ( ! V_46 )
return false ;
V_56 = F_17 ( V_46 , L_7 , & V_73 ) ;
if ( F_18 ( V_56 ) )
return false ;
V_42 . V_73 = V_73 ;
return true ;
}
int F_31 ( T_5 * V_74 , int V_75 , int V_76 )
{
return F_28 ( V_42 . V_73 , V_74 , V_75 , V_76 ) ;
}
int
F_32 ( struct V_79 * V_58 , struct V_80 * V_81 )
{
...
V_1 = F_16 ( & V_58 -> V_49 -> V_58 ) ;
if ( ! V_1 )
return - V_25 ;
V_67 = F_33 ( V_1 , & V_85 ) ;
if ( V_67 )
return - V_25 ;
V_67 = F_34 ( V_85 , type , - 1 , & V_86 ) ;
if ( V_67 < 0 )
return V_67 ;
V_83 -> V_86 = F_35 ( V_86 , V_92 , V_93 ) ;
return 0 ;
}
