...
static T_7 T_5 F_18 ( T_2 V_5 , int V_40 )
{
T_6 V_29 = F_4 ( V_5 ) ;
return ( ( T_7 ) V_29 << V_41 ) | ( V_40 << V_42 ) ;
}
static T_7 T_5 F_19 ( T_2 V_43 , int V_40 )
{
T_6 V_29 ;
T_4 * V_14 ;
T_8 * V_44 ;
...
if ( ! V_59 )
continue;
if ( ( V_61 >> V_48 ) * ( sizeof( struct V_65 ) ) >
( V_60 << V_48 ) ) {
F_14 ( L_12 ,
V_40 , V_43 ) ;
V_40 = V_63 ;
...
{
T_7 V_66 = F_18 ( V_43 , 0 ) ;
T_7 V_67 = F_35 ( V_43 ) ;
unsigned long V_68 ;
T_7 V_69 , V_70 ;
F_36 ( V_43 , & V_69 , & V_70 ) ;
V_71 [ V_43 ] = F_37 ( V_67 << V_48 ) ;
memset ( V_71 [ V_43 ] , 0 , V_72 ) ;
F_38 ( V_43 ) -> V_73 = & V_74 [ V_43 ] ;
F_38 ( V_43 ) -> V_75 = V_69 ;
F_38 ( V_43 ) -> V_76 = V_70 - V_69 ;
F_39 ( F_40 ( V_43 ) -> V_77 ) ;
V_67 += F_41 ( sizeof( struct V_78 ) +
sizeof( struct F_40 ) ) ;
V_68 = F_42 ( F_38 ( V_43 ) , V_67 ,
V_69 , V_70 ) ;
F_43 ( V_43 , V_70 ) ;
F_44 ( F_38 ( V_43 ) , V_66 << V_48 ,
( ( V_67 - V_66 ) << V_48 ) + V_68 ,
V_79 ) ;
F_45 ( V_43 ) ;
}
...
void T_5 F_52 ( void )
{
unsigned long V_85 , V_86 , V_87 , V_88 ;
unsigned V_43 ;
V_89 = ( void * ) F_37 ( V_62 << V_48 ) ;
F_6 (node) {
V_90 += F_53 ( F_38 ( V_43 ) ) ;
}
V_90 -= F_54 () ;
V_85 = ( unsigned long ) & V_91 - ( unsigned long ) & V_92 ;
V_86 = ( unsigned long ) & V_93 - ( unsigned long ) & V_91 ;
V_87 = ( unsigned long ) & V_94 - ( unsigned long ) & V_95 ;
V_88 = F_55 () ;
F_14 ( V_96 L_13
L_14 ,
V_88 << ( V_48 - 10 ) ,
