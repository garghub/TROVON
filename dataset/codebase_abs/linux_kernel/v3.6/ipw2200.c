...
{
F_290 ( V_311 ) ;
T_4 V_15 = F_221 ( V_659 -> V_15 ) ;
F_284 ( L_229 , V_659 -> V_660 , V_15 ) ;
switch ( V_659 -> V_660 ) {
case V_661 : {
...
V_23 -> V_582 =
F_272 ( V_23 -> V_582 ,
( T_2 ) ( F_226 ( V_659 -> V_538 . V_736 . V_25 ) & 0xff ) ,
V_737 ) ;
break;
}
F_46
...
F_249 ( V_23 ) ;
V_155 = F_254 ( V_23 , & V_23 -> V_226 , V_739 ,
V_740 ,
V_741 ,
V_742 ,
V_743 ) ;
...
V_155 = F_254 ( V_23 , & V_23 -> V_230 [ 0 ] , V_738 ,
V_744 ,
V_745 ,
V_746 , V_747 ) ;
if ( V_155 ) {
...
V_155 = F_254 ( V_23 , & V_23 -> V_230 [ 1 ] , V_738 ,
V_748 ,
V_749 ,
V_750 , V_751 ) ;
if ( V_155 ) {
...
V_155 = F_254 ( V_23 , & V_23 -> V_230 [ 2 ] , V_738 ,
V_752 ,
V_753 ,
V_754 , V_755 ) ;
if ( V_155 ) {
...
V_155 = F_254 ( V_23 , & V_23 -> V_230 [ 3 ] , V_738 ,
V_756 ,
V_757 ,
V_758 , V_759 ) ;
if ( V_155 ) {
...
V_773 = F_212 ( V_438 , struct V_772 , V_442 ) ;
F_213 ( V_438 ) ;
...
F_213 ( V_438 ) ;
V_773 -> V_502 =
F_300 ( V_23 -> V_477 , V_773 -> V_501 -> V_3 ,
V_503 , V_504 ) ;
F_214 ( & V_773 -> V_442 , & V_496 -> V_497 ) ;
V_496 -> V_507 ++ ;
}
F_42 ( & V_496 -> V_98 , V_41 ) ;
F_297 ( V_23 ) ;
...
static void F_305 ( struct V_335 * V_801 ,
...
F_305 ( & V_808 -> V_336 , & V_336 ) ;
V_808 -> V_441 = V_441 ;
F_309 ( L_308 ,
F_291 ( V_311 , V_441 -> V_311 , V_441 -> V_809 ) ,
V_441 -> V_216 ) ;
return 1 ;
}
...
if ( V_23 -> V_59 & V_810 )
F_74 ( L_323 ,
F_291 ( V_311 , V_23 -> V_666 , V_23 -> V_667 ) ) ;
else
F_74 ( L_324 ) ;
if ( V_23 -> V_59 & V_818 )
...
V_865 . V_874 = F_179 ( F_331 ( V_23 -> V_163 ) ) ;
if ( type == V_875 ) {
F_326 ( L_337 ) ;
V_699 = V_868 ;
V_865 . V_876 [ V_868 ] =
F_173 ( F_329 ( V_23 ) ) ;
F_327 ( V_23 , & V_865 , V_699 ) ;
goto V_877;
}
if ( V_23 -> V_59 & V_195 )
V_865 . V_876 [ V_878 ] =
...
F_304 ( V_23 , V_23 -> V_117 , & V_808 . V_336 ) ;
F_371 ( V_23 , V_23 -> V_117 , & V_808 . V_336 , 1 ) ;
V_23 -> V_37 &= ~ V_652 ;
}
...
V_336 = & V_23 -> V_336 ;
F_213 ( V_438 ) ;
F_214 ( & V_441 -> V_442 , & V_23 -> V_163 -> V_1051 ) ;
}
F_42 ( & V_23 -> V_163 -> V_98 , V_41 ) ;
if ( ! V_441 ) {
F_324 ( V_23 ) ;
...
V_166 -> V_1062 = V_140 ;
if ( F_29 ( ( F_221 ( V_1061 -> V_538 . V_1063 . V_415 ) + V_1064 ) >
F_378 ( V_773 -> V_501 ) ) ) {
V_166 -> V_673 . V_1065 ++ ;
...
F_380 ( V_773 -> V_501 , F_381 ( struct V_1060 , V_538 . V_1063 . V_3 ) ) ;
F_382 ( V_773 -> V_501 , F_221 ( V_1061 -> V_538 . V_1063 . V_415 ) ) ;
F_383 ( L_387 , V_773 -> V_501 -> V_4 ) ;
V_1054 = (struct V_674 * ) V_773 -> V_501 -> V_3 ;
if ( V_23 -> V_163 -> V_513 != V_515 &&
( F_365 ( V_1054 -> V_1070 ) ?
! V_23 -> V_163 -> V_853 : ! V_23 -> V_163 -> V_845 ) )
F_375 ( V_23 , V_773 -> V_501 ) ;
if ( ! F_384 ( V_23 -> V_163 , V_773 -> V_501 , V_673 ) )
V_166 -> V_673 . V_1065 ++ ;
else {
V_773 -> V_501 = NULL ;
F_63 ( V_23 ) ;
...
unsigned short V_4 = F_221 ( V_1061 -> V_538 . V_1063 . V_415 ) ;
V_166 -> V_1062 = V_140 ;
if ( F_29 ( ( F_221 ( V_1061 -> V_538 . V_1063 . V_415 ) + V_1064 ) >
F_378 ( V_773 -> V_501 ) ) ) {
V_166 -> V_673 . V_1065 ++ ;
...
V_1078 -> V_1097 = ( T_7 ) F_221 ( V_1063 -> V_736 ) ;
V_1078 -> V_1098 = F_173 ( F_386 ( V_1072 ) ) ;
if ( V_1072 > 14 ) {
V_1078 -> V_1099 =
F_173 ( ( V_1100 | V_1101 ) ) ;
} else if ( V_1073 & 32 ) {
...
F_382 ( V_773 -> V_501 , V_4 + sizeof( struct V_1077 ) ) ;
F_383 ( L_387 , V_773 -> V_501 -> V_4 ) ;
if ( ! F_384 ( V_23 -> V_163 , V_773 -> V_501 , V_673 ) )
V_166 -> V_673 . V_1065 ++ ;
else {
...
T_7 V_736 = ( T_7 ) F_221 ( V_1063 -> V_736 ) ;
...
return;
V_166 -> V_1062 = V_140 ;
if ( F_29 ( ( V_4 + V_1064 ) > F_378 ( V_773 -> V_501 ) ) ) {
V_166 -> V_673 . V_1065 ++ ;
F_379 ( L_385 ) ;
return;
}
...
if ( F_388 ( F_221 ( V_1054 -> V_1056 ) ) ) {
if ( V_161 & V_1110 )
return;
if ( V_161 & V_1111 )
V_1108 = 1 ;
} else if ( F_389 ( F_221 ( V_1054 -> V_1056 ) ) ) {
if ( V_161 & V_1112 )
return;
if ( V_161 & V_1113 )
V_1108 = 1 ;
} else if ( F_390 ( F_221 ( V_1054 -> V_1056 ) ) ) {
if ( V_161 & V_1114 )
return;
if ( V_161 & V_1115 )
V_1108 = 1 ;
}
V_501 = F_391 ( V_773 -> V_501 , V_139 ) ;
if ( V_501 == NULL ) {
F_46 ( L_389 ) ;
return;
}
...
V_1078 -> V_1097 = V_736 ;
V_1078 -> V_1098 = F_173 ( F_386 ( V_197 ) ) ;
if ( V_197 > 14 ) {
V_1078 -> V_1099 =
F_173 ( ( V_1100 | V_1101 ) ) ;
} else if ( V_1107 & ( 1 << 5 ) ) {
...
if ( ! F_384 ( V_23 -> V_159 -> V_163 , V_501 , V_673 ) ) {
V_166 -> V_673 . V_1065 ++ ;
F_393 ( V_501 ) ;
}
}
...
struct V_674 * V_1116 )
{
T_4 V_1120 = F_221 ( V_1116 -> V_1121 ) ;
T_4 V_1122 = F_396 ( V_1120 ) ;
T_4 V_359 = F_397 ( V_1120 ) ;
T_4 * V_1123 , * V_1124 ;
...
( V_501 -> V_3 + V_1064 ) ;
F_295 ( V_23 -> V_163 , V_1116 , V_673 ) ;
if ( V_23 -> V_163 -> V_513 == V_514 &&
( ( F_401 ( F_221 ( V_1116 -> V_1136 ) ) ==
V_1137 ) ||
( F_401 ( F_221 ( V_1116 -> V_1136 ) ) ==
V_1138 ) ) ) {
if ( ! memcmp ( V_1116 -> V_1119 , V_23 -> V_216 , V_217 ) )
F_261 ( V_23 , V_1116 -> V_1117 ) ;
}
if ( V_23 -> V_59 & V_200 ) {
F_142 ( L_391 ) ;
F_382 ( V_501 , F_221 ( V_1061 -> V_538 . V_1063 . V_415 ) +
V_1064 ) ;
F_402 ( V_501 , V_1064 ) ;
memcpy ( F_403 ( V_501 , sizeof( * V_673 ) ) , V_673 , sizeof( * V_673 ) ) ;
V_501 -> V_166 = V_23 -> V_163 -> V_166 ;
F_404 ( V_501 ) ;
V_501 -> V_1139 = V_1140 ;
V_501 -> V_1141 = F_405 ( V_1142 ) ;
...
V_1045 + 0x100 ,
. V_736 =
F_221 ( V_1061 -> V_538 . V_1063 . V_736 ) ,
...
V_820 :
V_819 ,
. V_4 = F_221 ( V_1061 -> V_538 . V_1063 . V_415 ) ,
} ;
if ( V_673 . V_632 != 0 )
V_673 . V_36 |= V_1150 ;
if ( V_673 . signal != 0 )
...
F_383 ( L_394 ,
F_221 ( V_1061 -> V_538 . V_1063 . V_415 ) ) ;
if ( F_221 ( V_1061 -> V_538 . V_1063 . V_415 ) <
F_392 ( F_221 (
V_1116 -> V_1136 ) ) ) {
F_379
( L_395
...
F_221 ( V_1061 -> V_538 . V_1159 . V_15 ) ) ;
F_289 ( V_23 , & V_1061 -> V_538 . V_1159 ) ;
break;
}
default:
F_383 ( L_401 ,
...
F_238 ( V_23 -> V_477 , V_773 -> V_502 ,
V_503 , V_504 ) ;
F_214 ( & V_773 -> V_442 , & V_23 -> V_496 -> V_498 ) ;
V_7 = ( V_7 + 1 ) % V_500 ;
if ( V_1145 ) {
...
static int F_410 ( struct V_17 * V_23 , int V_1160 )
{
int V_881 , V_803 ;
...
if ( V_1183 -> V_1185 == 1 ) {
V_197 = F_413 ( V_23 -> V_163 , V_1183 -> V_1184 ) ;
if ( V_197 == 0 )
return - V_75 ;
} else
V_197 = V_1183 -> V_1184 ;
...
{
struct V_17 * V_23 = F_341 ( V_166 ) ;
return F_439 ( V_23 -> V_163 , V_902 , V_211 , V_903 ) ;
}
...
F_59 ( & V_23 -> V_109 ) ;
V_432 = F_441 ( V_23 -> V_163 , V_902 , V_211 , V_829 ) ;
...
{
struct V_17 * V_23 = F_341 ( V_166 ) ;
return F_443 ( V_23 -> V_163 , V_902 , V_211 , V_829 ) ;
}
...
if ( F_445 ( V_23 -> V_1180 ) == V_365 )
V_23 -> V_1180 = V_1253 | V_363 ;
else
V_23 -> V_1180 = V_1253 | V_23 -> V_1180 ;
V_557 = F_184 ( V_23 , F_445 ( V_23 -> V_1180 ) ) ;
if ( V_557 ) {
F_326 ( L_458 ) ;
F_60 ( & V_23 -> V_109 ) ;
return V_557 ;
}
F_326 ( L_461 , V_23 -> V_1180 ) ;
F_60 ( & V_23 -> V_109 ) ;
return 0 ;
}
...
F_60 ( & V_23 -> V_109 ) ;
F_441 ( V_23 -> V_163 , V_902 , & V_1261 , NULL ) ;
F_59 ( & V_23 -> V_109 ) ;
if ( ! ( V_23 -> V_37 & V_99 ) ) {
F_264 ( L_488
L_489 ) ;
...
static struct V_1264 * F_457 ( struct V_165 * V_166 )
{
struct V_17 * V_23 = F_341 ( V_166 ) ;
...
static int F_463 ( struct V_17 * V_23 , struct V_1290 * V_532 ,
int V_1291 )
{
...
if ( ! ( V_23 -> V_37 & V_103 ) )
goto V_1135;
V_1296 = F_392 ( F_221 ( V_1054 -> V_1136 ) ) ;
switch ( V_23 -> V_163 -> V_513 ) {
case V_514 :
V_1007 = ! F_365 ( V_1054 -> V_1070 ) ;
V_1295 = F_262 ( V_23 , V_1054 -> V_1070 ) ;
if ( V_1295 == V_552 ) {
...
#ifdef F_292
if ( V_1055 & V_1310 )
F_366 ( V_23 , V_1291 , & ( V_767 -> V_538 . V_3 ) ) ;
#endif
V_767 -> V_538 . V_3 . V_539 = F_179 ( F_3 ( ( T_2 ) ( V_540 - 2 ) ,
V_532 -> V_1311 ) ) ;
F_465 ( L_494 ,
V_532 -> V_1311 , F_226 ( V_767 -> V_538 . V_3 . V_539 ) ) ;
for ( V_7 = 0 ; V_7 < F_226 ( V_767 -> V_538 . V_3 . V_539 ) ; V_7 ++ ) {
F_465 ( L_495 ,
V_7 , F_226 ( V_767 -> V_538 . V_3 . V_539 ) ,
...
static int F_467 ( struct V_165 * V_166 , int V_1291 )
{
struct V_17 * V_23 = F_341 ( V_166 ) ;
#ifdef F_292
int V_1294 = F_363 ( V_23 , V_1291 ) ;
...
static void F_468 ( struct V_17 * V_23 ,
struct V_1290 * V_532 )
{
struct V_672 V_1316 ;
struct V_1053 * V_1054 ;
...
V_4 = V_802 -> V_4 ;
V_1318 = F_299 ( V_4 + sizeof( * V_1079 ) , V_139 ) ;
if ( ! V_1318 )
continue;
V_1079 = ( void * ) F_382 ( V_1318 , sizeof( * V_1079 ) ) ;
V_1079 -> V_1080 = V_1081 ;
V_1079 -> V_1082 = 0 ;
V_1079 -> V_1084 = 0 ;
V_1079 -> V_1084 |= F_179 ( 1 << V_1088 ) ;
* ( T_8 * ) F_382 ( V_1318 , sizeof( T_4 ) ) = F_173 (
F_386 ( V_23 -> V_197 ) ) ;
if ( V_23 -> V_197 > 14 )
* ( T_8 * ) F_382 ( V_1318 , sizeof( T_4 ) ) =
F_173 ( V_1100 |
V_1101 ) ;
...
F_469 ( V_802 , F_382 ( V_1318 , V_4 ) , V_4 ) ;
if ( ! F_384 ( V_23 -> V_159 -> V_163 , V_1318 , & V_1316 ) )
F_393 ( V_1318 ) ;
}
}
static T_12 F_470 ( struct V_1290 * V_532 ,
...
F_468 ( V_23 , V_532 ) ;
#endif
V_432 = F_463 ( V_23 , V_532 , V_1291 ) ;
if ( V_432 == V_1315 )
F_63 ( V_23 ) ;
F_42 ( & V_23 -> V_98 , V_41 ) ;
return V_432 ;
}
static void F_471 ( struct V_165 * V_166 )
{
}
static int F_472 ( struct V_165 * V_166 , void * V_134 )
{
struct V_17 * V_23 = F_341 ( V_166 ) ;
...
static void F_474 ( struct V_165 * V_166 ,
struct V_1323 * V_902 )
{
...
char V_1325 [ 32 ] ;
T_3 V_4 ;
F_475 ( V_902 -> V_1326 , V_1327 , sizeof( V_902 -> V_1326 ) ) ;
F_475 ( V_902 -> V_983 , V_1328 , sizeof( V_902 -> V_983 ) ) ;
V_4 = sizeof( V_1324 ) ;
...
V_1324 , V_1325 ) ;
F_475 ( V_902 -> V_1332 , F_476 ( V_134 -> V_477 ) ,
sizeof( V_902 -> V_1332 ) ) ;
V_902 -> V_1333 = V_386 ;
}
static T_3 F_477 ( struct V_165 * V_166 )
{
struct V_17 * V_23 = F_341 ( V_166 ) ;
...
static T_13 F_481 ( int V_1336 , void * V_3 )
{
struct V_17 * V_23 = V_3 ;
T_3 V_219 , V_220 ;
if ( ! V_23 )
...
static void F_489 ( struct V_106 * V_107 )
{
struct V_17 * V_23 =
...
static void F_490 ( struct V_17 * V_23 )
{
F_72 ( V_23 ) ;
F_266 ( V_23 -> V_167 ) ;
F_138 ( V_23 ) ;
...
static int T_14 F_492 ( struct V_17 * V_23 )
{
int V_432 = 0 ;
F_493 ( & V_23 -> V_228 ) ;
F_493 ( & V_23 -> V_486 ) ;
F_494 ( & V_23 -> V_668 , F_323 ) ;
F_495 ( & V_23 -> V_333 , F_374 ) ;
F_495 ( & V_23 -> V_558 , F_267 ) ;
F_495 ( & V_23 -> V_564 , F_268 ) ;
F_495 ( & V_23 -> V_779 , F_301 ) ;
F_495 ( & V_23 -> V_246 , F_164 ) ;
F_494 ( & V_23 -> V_191 , F_486 ) ;
F_495 ( & V_23 -> V_193 , V_1342 ) ;
F_495 ( & V_23 -> V_190 , V_1343 ) ;
F_494 ( & V_23 -> V_186 , F_333 ) ;
F_494 ( & V_23 -> V_187 , F_334 ) ;
F_494 ( & V_23 -> V_188 , F_332 ) ;
F_494 ( & V_23 -> V_189 , F_285 ) ;
F_494 ( & V_23 -> V_644 , F_281 ) ;
F_495 ( & V_23 -> V_653 , F_335 ) ;
F_495 ( & V_23 -> V_705 , F_373 ) ;
F_494 ( & V_23 -> V_322 , F_169 ) ;
F_495 ( & V_23 -> V_675 , F_489 ) ;
F_495 ( & V_23 -> V_241 , F_491 ) ;
F_494 ( & V_23 -> V_108 , F_57 ) ;
F_494 ( & V_23 -> V_104 , F_62 ) ;
F_494 ( & V_23 -> V_114 , F_66 ) ;
F_495 ( & V_23 -> V_815 , F_312 ) ;
#ifdef F_292
F_495 ( & V_23 -> V_961 , F_367 ) ;
#endif
F_496 ( & V_23 -> V_1339 , ( void (*) ( unsigned long ) )
F_140 , ( unsigned long ) V_23 ) ;
return V_432 ;
}
static void F_497 ( struct V_165 * V_166 ,
struct V_886 * V_244 )
{
struct V_17 * V_23 = F_341 ( V_166 ) ;
int V_7 ;
...
static int F_450 ( struct V_17 * V_23 ,
struct V_335 * V_336 )
{
memset ( V_336 , 0 , sizeof( * V_336 ) ) ;
switch ( V_23 -> V_163 -> V_860 ) {
...
static int F_498 ( struct V_17 * V_23 )
{
if ( F_181 ( V_23 ) )
goto error;
...
int V_155 , V_7 , V_8 ;
if ( V_23 -> V_1356 ) {
F_499 ( V_23 -> V_163 , V_23 -> V_1356 ) ;
V_23 -> V_1356 = 0 ;
}
if ( V_23 -> V_37 & V_700 )
return - V_306 ;
if ( V_149 && ! V_23 -> V_149 ) {
V_23 -> V_149 = F_500 ( V_149 , sizeof( * V_23 -> V_149 ) ,
V_148 ) ;
if ( V_23 -> V_149 == NULL ) {
F_46 ( L_509 ,
V_149 ) ;
...
for ( V_8 = 0 ; V_8 < F_222 ( V_1359 ) ; V_8 ++ ) {
...
if ( F_501 ( V_23 -> V_163 , & V_1359 [ V_8 ] ) ) {
F_93 ( L_511 ) ;
return 0 ;
}
if ( V_23 -> V_37 & V_184 ) {
...
static void F_502 ( struct V_17 * V_23 )
{
int V_7 ;
if ( V_23 -> V_37 & V_321 ) {
F_74 ( L_520 ) ;
...
V_1364 -> V_869 = F_500 ( V_202 -> V_203 ,
...
V_1378 -> V_869 = F_500 ( V_202 -> V_209 ,
sizeof( struct V_1367 ) ,
V_148 ) ;
if ( ! V_1378 -> V_869 ) {
V_155 = - V_476 ;
...
V_182 -> V_183 -> V_1384 = F_222 ( V_1383 ) ;
F_504 ( V_182 -> V_183 , & V_23 -> V_477 -> V_166 ) ;
if ( F_505 ( V_182 -> V_183 ) )
V_155 = - V_306 ;
V_6:
return V_155 ;
}
...
{
struct V_1385 * V_159 = F_341 ( V_166 ) ;
...
static int F_507 ( struct V_165 * V_166 )
{
struct V_1385 * V_159 = F_341 ( V_166 ) ;
struct V_17 * V_23 = V_159 -> V_23 ;
F_74 ( L_525 ) ;
...
static T_12 F_508 ( struct V_1005 * V_501 ,
struct V_165 * V_166 )
{
F_74 ( L_526 ) ;
F_239 ( V_501 ) ;
...
if ( V_23 -> V_157 )
return - V_160 ;
V_23 -> V_157 = F_509 ( sizeof( struct V_1385 ) , 1 ) ;
if ( V_23 -> V_157 == NULL )
return - V_476 ;
V_23 -> V_159 = F_341 ( V_23 -> V_157 ) ;
V_23 -> V_159 -> V_163 = F_510 ( V_23 -> V_157 ) ;
...
F_511 ( V_23 -> V_157 , & V_23 -> V_477 -> V_166 ) ;
V_155 = F_512 ( V_23 -> V_157 ) ;
if ( V_155 ) {
F_513 ( V_23 -> V_157 , 1 ) ;
V_23 -> V_157 = NULL ;
return V_155 ;
...
static int T_14 F_515 ( struct V_477 * V_1388 ,
...
struct V_17 * V_23 ;
int V_7 ;
V_167 = F_509 ( sizeof( struct V_17 ) , 0 ) ;
if ( V_167 == NULL ) {
V_557 = - V_476 ;
goto V_6;
}
V_23 = F_341 ( V_167 ) ;
V_23 -> V_163 = F_510 ( V_167 ) ;
V_23 -> V_167 = V_167 ;
V_23 -> V_477 = V_1388 ;
V_12 = V_1391 ;
F_302 ( & V_23 -> V_42 ) ;
...
F_518 ( V_1388 ) ;
V_557 = F_519 ( V_1388 , F_520 ( 32 ) ) ;
if ( ! V_557 )
V_557 = F_521 ( V_1388 , F_520 ( 32 ) ) ;
if ( V_557 ) {
F_4 (KERN_WARNING DRV_NAME L_528 ) ;
goto V_1394;
}
F_522 ( V_1388 , V_23 ) ;
V_557 = F_523 ( V_1388 , V_1327 ) ;
if ( V_557 )
goto V_1394;
F_524 ( V_1388 , 0x40 , & V_21 ) ;
if ( ( V_21 & 0x0000ff00 ) != 0 )
F_525 ( V_1388 , 0x40 , V_21 & 0xffff00ff ) ;
V_415 = F_526 ( V_1388 , 0 ) ;
V_23 -> V_1395 = V_415 ;
V_137 = F_527 ( V_1388 , 0 ) ;
if ( ! V_137 ) {
V_557 = - V_1392 ;
goto V_1396;
}
...
F_410 ( V_23 , 1 ) ;
V_557 = F_528 ( V_1388 -> V_1336 , F_481 , V_1398 , V_1327 , V_23 ) ;
if ( V_557 ) {
F_46 ( L_532 , V_1388 -> V_1336 ) ;
goto V_1397;
}
F_511 ( V_167 , & V_1388 -> V_166 ) ;
F_59 ( & V_23 -> V_109 ) ;
V_23 -> V_163 -> V_1399 = F_470 ;
V_23 -> V_163 -> V_896 = F_497 ;
V_23 -> V_163 -> V_1400 = F_467 ;
#ifdef F_292
V_23 -> V_163 -> V_1401 = F_364 ;
V_23 -> V_163 -> V_1402 = F_369 ;
V_23 -> V_163 -> V_1403 = F_368 ;
V_23 -> V_163 -> V_1404 = F_370 ;
#endif
V_23 -> V_163 -> V_642 = - 20 ;
V_23 -> V_163 -> V_643 = - 85 ;
V_167 -> V_1386 = & V_1405 ;
...
V_167 -> V_1408 = & V_1409 ;
V_167 -> V_1410 = & V_1411 ;
V_557 = F_529 ( & V_1388 -> V_166 . V_1412 , & V_1413 ) ;
if ( V_557 ) {
F_46 ( L_533 ) ;
F_60 ( & V_23 -> V_109 ) ;
goto V_1414;
...
return 0 ;
V_1416:
F_530 ( V_23 -> V_163 -> V_182 . V_183 ) ;
F_87 ( V_23 -> V_163 -> V_1378 . V_869 ) ;
F_87 ( V_23 -> V_163 -> V_1364 . V_869 ) ;
V_1415:
F_531 ( & V_1388 -> V_166 . V_1412 , & V_1413 ) ;
V_1414:
F_532 ( V_1388 -> V_1336 , V_23 ) ;
V_1397:
F_533 ( V_23 -> V_22 ) ;
V_1396:
F_534 ( V_1388 ) ;
...
static void T_16 F_536 ( struct V_477 * V_1388 )
{
struct V_17 * V_23 = F_537 ( V_1388 ) ;
...
static int F_540 ( struct V_477 * V_1388 , T_17 V_664 )
{
struct V_17 * V_23 = F_537 ( V_1388 ) ;
struct V_165 * V_166 = V_23 -> V_167 ;
...
F_542 ( V_1388 ) ;
F_535 ( V_1388 ) ;
F_543 ( V_1388 , F_544 ( V_1388 , V_664 ) ) ;
V_23 -> V_1417 = F_545 () ;
return 0 ;
}
static int F_546 ( struct V_477 * V_1388 )
{
struct V_17 * V_23 = F_537 ( V_1388 ) ;
struct V_165 * V_166 = V_23 -> V_167 ;
int V_557 ;
...
F_525 ( V_1388 , 0x40 , V_21 & 0xffff00ff ) ;
F_548 ( V_166 ) ;
V_23 -> V_1356 = F_545 () - V_23 -> V_1417 ;
F_128 ( & V_23 -> V_193 ) ;
return 0 ;
}
static void F_549 ( struct V_477 * V_1388 )
{
struct V_17 * V_23 = F_537 ( V_1388 ) ;
F_161 ( V_23 ) ;
F_535 ( V_1388 ) ;
}
static int T_18 F_550 ( void )
{
int V_432 ;
...
V_432 = F_552 ( & V_1419 . V_1326 , & V_1420 ) ;
if ( V_432 ) {
F_46 ( L_544 ) ;
F_553 ( & V_1419 ) ;
return V_432 ;
...
static void T_19 F_554 ( void )
{
F_555 ( & V_1419 . V_1326 , & V_1420 ) ;
F_553 ( & V_1419 ) ;
}
