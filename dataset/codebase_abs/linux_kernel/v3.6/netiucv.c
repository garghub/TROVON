...
static int F_126 ( struct V_3 * V_153 )
{
struct V_5 * V_6 = F_3 ( V_153 ) ;
struct V_152 * V_4 = F_127 ( sizeof( struct V_152 ) , V_128 ) ;
int V_181 ;
F_38 ( V_85 , 3 , V_86 ) ;
if ( V_4 ) {
F_128 ( V_4 , L_49 , V_153 -> V_8 ) ;
V_4 -> V_182 = & V_183 ;
V_4 -> V_184 = V_185 ;
V_4 -> V_186 = V_187 ;
V_4 -> V_188 = ( void ( * ) ( struct V_152 * ) ) F_69 ;
V_4 -> V_189 = & V_190 ;
} else
return - V_35 ;
V_181 = F_129 ( V_4 ) ;
...
static void F_132 ( struct V_152 * V_4 )
{
F_38 ( V_85 , 3 , V_86 ) ;
F_133 ( V_4 ) ;
}
static struct V_12 * F_134 ( struct V_3 * V_4 ,
char * V_169 ,
char * V_17 )
{
struct V_12 * V_13 ;
V_13 = F_127 ( sizeof( * V_13 ) , V_128 ) ;
if ( ! V_13 )
goto V_154;
F_135 ( & V_13 -> V_107 ) ;
F_135 ( & V_13 -> V_101 ) ;
...
if ( ! V_13 -> V_105 )
goto V_193;
V_13 -> V_48 = F_137 ( L_50 , V_194 ,
V_195 , V_196 ,
V_197 , V_198 , V_199 ,
V_128 ) ;
if ( ! V_13 -> V_48 )
goto V_200;
F_138 ( V_13 -> V_48 , & V_13 -> V_124 ) ;
F_51 ( V_13 -> V_48 , V_201 ) ;
if ( V_17 )
...
V_4 -> type = V_208 ;
V_4 -> V_122 = V_119 ;
V_4 -> V_120 = V_209 | V_210 ;
V_4 -> V_211 = & V_212 ;
}
static struct V_3 * F_149 ( char * V_169 , char * V_17 )
{
struct V_5 * V_69 ;
struct V_3 * V_4 ;
V_4 = F_150 ( sizeof( struct V_5 ) , L_51 ,
F_148 ) ;
if ( ! V_4 )
return NULL ;
if ( F_151 ( V_4 , V_4 -> V_8 ) < 0 )
goto V_213;
V_69 = F_3 ( V_4 ) ;
V_69 -> V_48 = F_137 ( L_52 , V_214 ,
V_215 , V_216 , V_217 ,
V_218 , V_219 , V_128 ) ;
if ( ! V_69 -> V_48 )
goto V_213;
V_69 -> V_13 = F_134 ( V_4 , V_169 , V_17 ) ;
if ( ! V_69 -> V_13 ) {
F_38 ( V_59 , 2 , L_53 ) ;
goto V_220;
}
...
static T_6 F_152 ( struct V_221 * V_222 ,
const char * V_16 , T_7 V_168 )
{
char V_169 [ 9 ] ;
char V_17 [ 17 ] ;
...
static T_6 F_155 ( struct V_221 * V_222 ,
const char * V_16 , T_7 V_168 )
{
struct V_12 * V_172 ;
struct V_3 * V_153 ;
...
V_227 = F_127 ( sizeof( struct V_152 ) , V_128 ) ;
if ( ! V_227 ) {
V_55 = - V_35 ;
goto V_231;
}
...
V_227 -> V_182 = & V_183 ;
V_227 -> V_184 = V_185 ;
V_227 -> V_188 = ( void ( * ) ( struct V_152 * ) ) F_69 ;
V_227 -> V_189 = & V_190 ;
V_55 = F_129 ( V_227 ) ;
if ( V_55 ) {
F_130 ( V_227 ) ;
