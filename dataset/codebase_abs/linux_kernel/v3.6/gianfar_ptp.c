...
static int F_16 ( struct V_43 * V_44 , struct V_54 * V_55 )
{
T_1 V_2 ;
T_2 V_56 ;
unsigned long V_53 ;
...
V_2 = F_1 ( V_1 ) ;
F_15 ( & V_1 -> V_34 , V_53 ) ;
V_55 -> V_57 = F_17 ( V_2 , 1000000000 , & V_56 ) ;
V_55 -> V_58 = V_56 ;
return 0 ;
}
...
static int F_20 ( struct V_71 * V_72 , char * V_73 , T_2 * V_19 )
{
int V_74 ;
const T_2 * V_75 = F_21 ( V_72 , V_73 , & V_74 ) ;
if ( ! V_75 || V_74 != sizeof( * V_75 ) )
return - 1 ;
* V_19 = * V_75 ;
return 0 ;
}
static int F_22 ( struct V_76 * V_77 )
{
struct V_71 * V_72 = V_77 -> V_77 . V_78 ;
struct V_1 * V_1 ;
struct V_54 V_52 ;
int V_79 = - V_80 ;
T_2 V_81 ;
unsigned long V_53 ;
V_1 = F_23 ( sizeof( * V_1 ) , V_82 ) ;
if ( ! V_1 )
goto V_83;
V_79 = - V_84 ;
V_1 -> V_50 = V_85 ;
V_1 -> V_86 = V_87 ;
if ( F_20 ( V_72 , L_1 , & V_1 -> V_8 ) ||
F_20 ( V_72 , L_2 , & V_1 -> V_88 ) ||
F_20 ( V_72 , L_3 , & V_1 -> V_48 ) ||
F_20 ( V_72 , L_4 , & V_1 -> V_11 ) ||
F_20 ( V_72 , L_5 , & V_1 -> V_12 ) ||
F_20 ( V_72 , L_6 , & V_1 -> V_50 . V_89 ) ) {
F_24 ( L_7 ) ;
goto V_90;
}
V_1 -> V_13 = F_25 ( V_77 , 0 ) ;
if ( V_1 -> V_13 == V_91 ) {
F_24 ( L_8 ) ;
goto V_90;
}
if ( F_26 ( V_1 -> V_13 , F_8 , 0 , V_92 , V_1 ) ) {
F_24 ( L_9 ) ;
goto V_90;
}
V_1 -> V_93 = F_27 ( V_77 , V_94 , 0 ) ;
if ( ! V_1 -> V_93 ) {
F_24 ( L_10 ) ;
goto V_95;
}
if ( F_28 ( & V_96 , V_1 -> V_93 ) ) {
F_24 ( L_11 ) ;
goto V_95;
}
F_29 ( & V_1 -> V_34 ) ;
V_1 -> V_5 = F_30 ( V_1 -> V_93 -> V_97 ,
F_31 ( V_1 -> V_93 ) ) ;
if ( ! V_1 -> V_5 ) {
F_24 ( L_12 ) ;
goto V_98;
...
V_81 =
( V_1 -> V_8 & V_99 ) << V_100 |
( V_1 -> V_86 & V_101 ) << V_102 ;
F_14 ( & V_1 -> V_34 , V_53 ) ;
F_4 ( & V_1 -> V_5 -> V_81 , V_81 ) ;
F_4 ( & V_1 -> V_5 -> V_48 , V_1 -> V_48 ) ;
F_4 ( & V_1 -> V_5 -> V_88 , V_1 -> V_88 ) ;
F_4 ( & V_1 -> V_5 -> V_11 , V_1 -> V_11 ) ;
F_4 ( & V_1 -> V_5 -> V_12 , V_1 -> V_12 ) ;
F_5 ( V_1 ) ;
F_4 ( & V_1 -> V_5 -> V_81 , V_81 | V_103 | V_104 | V_105 | V_106 ) ;
F_15 ( & V_1 -> V_34 , V_53 ) ;
V_1 -> clock = F_33 ( & V_1 -> V_50 ) ;
if ( F_34 ( V_1 -> clock ) ) {
V_79 = F_35 ( V_1 -> clock ) ;
goto V_107;
}
V_108 = F_36 ( V_1 -> clock ) ;
F_37 ( & V_77 -> V_77 , V_1 ) ;
return 0 ;
V_107:
V_98:
