...
V_27 , 0UL ) ;
memset ( V_48 , 0 , V_29 ) ;
V_49 = F_23 ( V_44 >> 3 , V_50 , 0UL ) ;
F_24 ( & V_28 , V_49 , V_44 ) ;
V_51 = F_11 ( V_52 , V_52 ) ;
memset ( F_25 ( V_51 ) , 0 , V_52 ) ;
V_53 . V_45 = V_51 ;
F_26 ( V_31 , V_34 ) ;
V_46 = F_27 ( ( unsigned long ) V_48 ) ;
V_33 = V_31 ;
while ( V_33 < V_34 ) {
V_45 = F_28 ( V_33 ) ;
V_1 = F_29 ( F_25 ( V_45 ) , V_33 ) ;
V_19 = F_9 ( F_25 ( V_1 ) , V_33 ) ;
V_47 = ( ( V_46 >> 4 ) | V_54 | V_55 ) ;
if ( V_56 )
V_47 |= V_57 ;
F_4 ( F_25 ( V_19 ) , F_30 ( V_47 ) ) ;
V_33 += V_43 ;
V_46 += V_43 ;
}
F_31 () ;
...
unsigned long V_61 ;
F_39 ( V_19 ) ;
V_61 = ( unsigned long ) F_40 ( V_19 ) ;
if ( V_61 == 0 )
F_17 () ;
V_61 = F_8 ( V_19 ) << V_16 ;
F_16 ( F_10 ( V_61 ) , V_62 ) ;
}
static inline void F_41 ( struct V_63 * V_64 )
{
V_64 -> V_65 -> V_66 = V_64 -> V_66 ;
V_64 -> V_66 -> V_65 = V_64 -> V_65 ;
}
static inline void F_42 ( struct V_63 * V_67 , struct V_63 * V_64 )
{
V_64 -> V_65 = V_67 ;
( V_64 -> V_66 = V_67 -> V_66 ) -> V_65 = V_64 ;
V_67 -> V_66 = V_64 ;
}
static inline void F_43 ( struct V_13 * V_68 , struct V_13 * V_14 )
{
struct V_63 * V_2 ;
V_2 = V_69 . V_65 ;
if ( V_2 != & V_69 ) {
...
static inline void F_48 ( int V_70 )
{
struct V_63 * V_75 ;
V_75 = V_76 + V_70 ;
F_41 ( V_75 ) ;
...
void F_51 ( struct V_13 * V_68 , struct V_13 * V_14 ,
struct V_80 * V_81 )
{
if ( V_14 -> V_70 == V_74 ) {
F_52 ( & V_82 ) ;
...
static inline void F_57 ( unsigned long V_87 ,
...
void F_59 ( unsigned int V_91 , unsigned long V_92 ,
...
static inline void F_60 ( unsigned long V_88 )
{
T_3 * V_3 ;
T_1 * V_6 ;
V_4 * V_7 ;
...
void F_62 ( unsigned long V_88 , unsigned int V_94 )
{
while ( V_94 != 0 ) {
V_94 -= V_43 ;
F_60 ( V_88 ) ;
...
static void T_4 F_63 ( char * type )
{
F_64 ( L_10 , type ) ;
F_65 () ;
}
static void T_4 F_26 ( unsigned long V_95 ,
unsigned long V_96 )
{
T_3 * V_3 ;
T_1 * V_6 ;
...
while ( V_95 < V_96 ) {
V_3 = F_28 ( V_95 ) ;
if ( F_66 ( * ( T_3 * ) F_25 ( V_3 ) ) ) {
V_6 = F_11 (
V_97 , V_97 ) ;
if ( V_6 == NULL )
F_63 ( L_11 ) ;
memset ( F_25 ( V_6 ) , 0 , V_97 ) ;
F_67 ( F_25 ( V_3 ) , V_6 ) ;
}
V_6 = F_29 ( F_25 ( V_3 ) , V_95 ) ;
if ( F_1 ( * ( T_1 * ) F_25 ( V_6 ) ) ) {
V_7 = F_11 ( V_62 , V_62 ) ;
if ( V_7 == NULL )
F_63 ( L_12 ) ;
memset ( F_25 ( V_7 ) , 0 , V_62 ) ;
F_6 ( F_25 ( V_6 ) , V_7 ) ;
}
...
static void T_4 F_68 ( unsigned long V_95 ,
unsigned long V_96 )
{
T_3 * V_3 ;
T_1 * V_6 ;
...
static inline unsigned long F_69 ( unsigned long V_33 )
{
unsigned long V_100 ;
if ( V_84 != V_85 ) {
V_33 &= V_90 ;
...
static void T_4 F_71 ( unsigned long V_95 ,
unsigned long V_96 )
{
unsigned long V_101 ;
unsigned long V_24 ;
...
V_24 = V_95 - V_43 ;
if ( ! ( V_95 & ~ ( V_104 ) ) ) {
if ( F_69 ( V_24 + V_105 ) == V_101 )
V_102 = 1 ;
}
if ( ! ( V_95 & ~ ( V_106 ) ) ) {
if ( F_69 ( V_24 + V_107 ) == V_101 )
V_102 = 2 ;
}
V_3 = F_28 ( V_95 ) ;
if ( V_102 == 2 ) {
* ( T_3 * ) F_25 ( V_3 ) = F_72 ( V_101 ) ;
V_95 += V_107 ;
continue;
}
if ( F_66 ( * ( T_3 * ) F_25 ( V_3 ) ) ) {
...
* ( unsigned long * ) F_25 ( V_109 ) = V_101 ;
V_95 += V_105 ;
continue;
}
V_7 = F_9 ( F_25 ( V_6 ) , V_95 ) ;
* ( V_4 * ) F_25 ( V_7 ) = F_30 ( V_101 ) ;
V_95 += V_43 ;
}
}
static void T_4 F_73 ( unsigned long V_33 , unsigned long V_111 )
{
T_3 * V_3 = F_28 ( V_33 ) ;
unsigned long V_112 ;
V_112 = F_74 ( V_111 >> 4 ) ;
* ( T_3 * ) F_25 ( V_3 ) = F_72 ( V_112 ) ;
}
static unsigned long T_4 F_75 ( unsigned long V_113 , int V_114 )
{
unsigned long V_115 = ( V_36 [ V_114 ] . V_116 & V_106 ) ;
unsigned long V_117 = ( V_113 & V_106 ) ;
unsigned long V_118 = F_76 ( V_113 + V_36 [ V_114 ] . V_37 ) ;
...
F_75 ( ( unsigned long ) F_78 ( V_36 [ V_9 ] . V_116 ) , V_9 ) ;
}
}
void T_4 F_79 ( void )
{
...
V_129 = 0 ;
while ( V_123 != 0 ) {
F_81 ( V_123 , L_13 , V_124 , sizeof( V_124 ) ) ;
if ( ! strcmp ( V_124 , L_14 ) ) {
V_129 = F_82 ( V_123 , L_15 , 0x8 ) ;
break;
}
V_123 = F_83 ( V_123 ) ;
}
...
V_147 = V_152 - V_149 ;
V_144 [ V_153 ] = V_147 ;
V_146 [ V_153 ] = V_147 - F_90 () ;
F_91 ( 0 , V_144 , V_150 , V_146 ) ;
}
}
void F_92 ( struct V_154 * V_155 )
{
F_93 ( V_155 ,
L_17
L_18
...
int F_94 ( struct V_80 * V_81 , struct V_13 * V_14 )
{
V_14 -> V_70 = V_74 ;
return 0 ;
}
void F_95 ( struct V_13 * V_14 )
{
if ( V_14 -> V_70 != V_74 ) {
F_46 ( V_14 ) ;
...
#endif
V_157 = F_80 ( V_130 ) ;
while ( ( V_157 = F_83 ( V_157 ) ) != 0 ) {
F_81 ( V_157 , L_13 , V_124 , sizeof( V_124 ) ) ;
if ( ! strcmp ( V_124 , L_14 ) ) {
V_162 = F_98 ( V_157 , L_22 ) ;
if ( V_162 == - 1 ) {
F_64 ( L_23 ) ;
F_65 () ;
}
V_158 = F_98 ( V_157 , L_24 ) ;
if ( V_158 == - 1 ) {
F_64 ( L_25 ) ;
F_65 () ;
}
...
static void F_117 ( struct V_190 * V_191 , unsigned long V_95 , unsigned long V_96 )
{
F_116 (vma->vm_mm)
F_113 () ;
F_114 () ;
...
static void F_118 ( struct V_190 * V_191 , unsigned long V_15 )
{
F_116 (vma->vm_mm)
F_113 () ;
...
static void F_121 ( unsigned long V_15 )
{
#ifdef F_122
volatile unsigned long V_165 ;
if ( F_69 ( V_15 ) )
...
static void F_124 ( struct V_13 * V_14 , unsigned long V_194 )
{
}
static void F_125 ( unsigned long V_15 )
{
F_120 () ;
}
...
static void F_129 ( struct V_190 * V_191 , unsigned long V_95 , unsigned long V_96 )
{
F_116 (vma->vm_mm)
F_127 () ;
V_189
}
static void F_130 ( struct V_190 * V_191 , unsigned long V_15 )
{
F_116 (vma->vm_mm)
F_127 () ;
V_189
...
char V_124 [ 128 ] ;
V_123 = F_80 ( V_130 ) ;
while ( ( V_123 = F_83 ( V_123 ) ) != 0 ) {
F_81 ( V_123 , L_13 , V_124 , sizeof( V_124 ) ) ;
if ( ! strcmp ( V_124 , L_14 ) ) {
if ( ! F_82 ( V_123 , L_35 , 1 ) &&
F_82 ( V_123 , L_36 , 1 ) == 5 ) {
F_134 () ;
return;
}
...
static void F_150 ( unsigned long V_15 )
{
F_151 ( ( V_237 ) V_134 -> V_228 , V_15 ) ;
V_134 -> V_228 ( V_15 ) ;
}
static void F_152 ( void )
{
F_153 ( ( V_237 ) V_134 -> V_238 ) ;
V_134 -> V_238 () ;
}
static void F_154 ( void )
{
F_153 ( ( V_237 ) V_134 -> V_135 ) ;
V_134 -> V_135 () ;
}
...
if ( V_14 -> V_70 != V_74 ) {
T_8 V_239 ;
F_156 ( & V_239 , F_157 ( V_14 ) ) ;
F_158 ( F_159 () , & V_239 ) ;
if ( ! F_160 ( & V_239 ) )
F_151 ( ( V_237 ) V_134 -> V_240 , ( unsigned long ) V_14 ) ;
V_134 -> V_240 ( V_14 ) ;
}
}
...
F_158 ( F_159 () , & V_239 ) ;
if ( ! F_160 ( & V_239 ) ) {
F_151 ( ( V_237 ) V_134 -> V_241 , ( unsigned long ) V_14 ) ;
if ( F_162 ( & V_14 -> V_242 ) == 1 && V_243 -> V_244 == V_14 )
F_156 ( F_157 ( V_14 ) ,
F_163 ( F_159 () ) ) ;
}
V_134 -> V_241 ( V_14 ) ;
...
static void F_164 ( struct V_190 * V_191 ,
unsigned long V_95 ,
unsigned long V_96 )
{
...
F_158 ( F_159 () , & V_239 ) ;
if ( ! F_160 ( & V_239 ) )
F_165 ( ( V_237 ) V_134 -> V_247 ,
( unsigned long ) V_191 , V_95 , V_96 ) ;
V_134 -> V_247 ( V_191 , V_95 , V_96 ) ;
}
}
static void F_167 ( struct V_190 * V_191 , unsigned long V_15 )
{
struct V_13 * V_14 = V_191 -> V_245 ;
if ( V_14 -> V_70 != V_74 ) {
T_8 V_239 ;
...
F_158 ( F_159 () , & V_239 ) ;
if ( ! F_160 ( & V_239 ) )
F_168 ( ( V_237 ) V_134 -> V_249 ,
( unsigned long ) V_191 , V_15 ) ;
V_134 -> V_249 ( V_191 , V_15 ) ;
}
}
static void F_170 ( unsigned long V_15 )
{
#if 1
F_151 ( ( V_237 ) V_134 -> V_250 , V_15 ) ;
#endif
V_134 -> V_250 ( V_15 ) ;
}
static void F_171 ( struct V_13 * V_14 , unsigned long V_194 )
{
T_8 V_239 ;
F_156 ( & V_239 , F_157 ( V_14 ) ) ;
F_158 ( F_159 () , & V_239 ) ;
if ( ! F_160 ( & V_239 ) )
F_168 ( ( V_237 ) V_134 -> V_251 ,
