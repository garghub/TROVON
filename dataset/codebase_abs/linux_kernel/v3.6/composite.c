...
static int F_27 ( struct V_11 * V_12 , unsigned V_82 )
{
...
if ( V_82 == 0 )
return F_23 ( V_69 , V_21 , V_12 -> V_86 -> V_67 , type ) ;
V_82 -- ;
}
return - V_44 ;
}
static int F_28 ( struct V_11 * V_12 , unsigned type )
{
struct V_5 * V_60 = V_12 -> V_60 ;
struct V_40 * V_69 ;
unsigned V_87 = 0 ;
...
V_97 -> V_81 = F_26 ( V_98 ) ;
V_97 -> V_100 = 0 ;
V_91 = V_12 -> V_86 -> V_67 + F_30 ( V_97 -> V_81 ) ;
V_97 -> V_100 ++ ;
F_31 ( & V_97 -> V_81 , V_101 ) ;
V_91 -> V_74 = V_101 ;
V_91 -> V_3 = V_102 ;
V_91 -> V_103 = V_104 ;
V_91 -> V_36 = F_32 ( V_105 ) ;
V_93 = V_12 -> V_86 -> V_67 + F_30 ( V_97 -> V_81 ) ;
V_97 -> V_100 ++ ;
F_31 ( & V_97 -> V_81 , V_106 ) ;
V_93 -> V_74 = V_106 ;
V_93 -> V_3 = V_102 ;
V_93 -> V_103 = V_107 ;
V_93 -> V_36 = 0 ;
V_93 -> V_108 = F_26 ( V_109 |
V_110 |
V_111 |
V_112 ) ;
V_93 -> V_113 = V_109 ;
...
struct V_7 * V_8 ;
F_10 ( V_12 , L_4 ) ;
F_25 (f, &cdev->config->functions, list) {
if ( V_8 -> V_48 )
V_8 -> V_48 ( V_8 ) ;
F_35 ( V_8 -> V_130 , 32 ) ;
}
...
int V_134 = - V_44 ;
unsigned V_135 = F_37 ( V_60 ) ? 8 : 100 ;
int V_136 ;
if ( V_133 ) {
F_25 (c, &cdev->configs, list) {
if ( V_69 -> V_76 == V_133 ) {
...
static void F_49 ( struct V_146 * * V_147 , T_2 * V_67 )
{
...
V_147 = V_154 -> V_155 ;
if ( V_147 )
F_49 ( V_147 , V_148 -> V_156 ) ;
F_25 (c, &cdev->configs, list) {
V_147 = V_69 -> V_155 ;
if ( V_147 )
F_49 ( V_147 , V_148 -> V_156 ) ;
F_25 (f, &c->functions, list) {
V_147 = V_8 -> V_155 ;
if ( V_147 )
F_49 ( V_147 , V_148 -> V_156 ) ;
}
...
return F_51 ( & V_155 , 0xff , V_67 ) ;
}
if ( V_154 -> V_155 ) {
V_72 = F_50 ( V_154 -> V_155 , V_67 , V_149 , V_61 ) ;
if ( V_72 > 0 )
return V_72 ;
}
F_25 (c, &cdev->configs, list) {
if ( V_69 -> V_155 ) {
V_72 = F_50 ( V_69 -> V_155 , V_67 , V_149 , V_61 ) ;
if ( V_72 > 0 )
return V_72 ;
}
F_25 (f, &c->functions, list) {
if ( ! V_8 -> V_155 )
continue;
V_72 = F_50 ( V_8 -> V_155 , V_67 , V_149 , V_61 ) ;
if ( V_72 > 0 )
return V_72 ;
}
}
...
int F_54 ( struct V_11 * V_12 , struct V_164 * V_151 )
{
int V_70 = V_12 -> V_165 ;
...
int F_56 ( struct V_11 * V_69 , unsigned V_166 )
{
unsigned V_70 = V_69 -> V_165 ;
if ( F_55 ( V_166 > 254 || ( unsigned ) V_70 + V_166 > 254 ) )
return - V_65 ;
V_69 -> V_165 += V_166 ;
return V_70 + 1 ;
}
static void F_57 ( struct V_9 * V_137 , struct V_167 * V_86 )
{
...
static int
F_58 ( struct V_5 * V_60 , const struct V_131 * V_132 )
{
struct V_11 * V_12 = F_3 ( V_60 ) ;
struct V_167 * V_86 = V_12 -> V_86 ;
int V_43 = - V_171 ;
int V_57 = 0 ;
T_3 V_172 = F_30 ( V_132 -> V_173 ) ;
T_1 V_174 = V_172 & 0xFF ;
T_3 V_82 = F_30 ( V_132 -> V_175 ) ;
T_3 V_176 = F_30 ( V_132 -> V_177 ) ;
struct V_7 * V_8 = NULL ;
T_1 V_178 ;
V_86 -> V_179 = 0 ;
V_86 -> V_180 = F_57 ;
...
if ( F_4 ( V_60 ) ) {
if ( V_60 -> V_21 >= V_22 ) {
V_12 -> V_31 . V_122 = F_26 ( 0x0300 ) ;
V_12 -> V_31 . V_126 = 9 ;
} else {
V_12 -> V_31 . V_122 = F_26 ( 0x0210 ) ;
}
}
V_43 = F_59 ( V_176 , ( T_3 ) sizeof V_12 -> V_31 ) ;
...
V_43 = F_27 ( V_12 , V_82 ) ;
if ( V_43 >= 0 )
V_43 = F_59 ( V_176 , ( T_3 ) V_43 ) ;
break;
case V_153 :
V_43 = F_52 ( V_12 , V_86 -> V_67 ,
V_172 , V_82 & 0xff ) ;
if ( V_43 >= 0 )
V_43 = F_59 ( V_176 , ( T_3 ) V_43 ) ;
break;
...
struct V_11 * V_12 = F_3 ( V_60 ) ;
F_19 ( V_12 -> V_41 ) ;
while ( ! F_44 ( & V_12 -> V_143 ) ) {
struct V_40 * V_69 ;
V_69 = F_45 ( & V_12 -> V_143 ,
struct V_40 , V_50 ) ;
F_47 ( V_12 , V_69 ) ;
}
if ( V_154 -> V_144 )
...
F_73 ( V_60 , V_12 ) ;
F_43 ( & V_12 -> V_143 ) ;
V_12 -> V_86 = F_79 ( V_60 -> V_127 , V_216 ) ;
if ( ! V_12 -> V_86 )
goto V_217;
V_12 -> V_86 -> V_67 = F_80 ( V_73 , V_216 ) ;
if ( ! V_12 -> V_86 -> V_67 )
goto V_217;
V_12 -> V_86 -> V_180 = F_57 ;
V_60 -> V_127 -> V_170 = V_12 ;
V_12 -> V_218 = V_73 ;
V_12 -> V_219 = V_154 ;
if ( V_80 <= V_220 )
...
if ( V_221 )
V_12 -> V_31 . V_221 = F_26 ( V_221 ) ;
else
V_221 = F_30 ( V_12 -> V_31 . V_221 ) ;
if ( V_222 )
V_12 -> V_31 . V_222 = F_26 ( V_222 ) ;
else
V_222 = F_30 ( V_12 -> V_31 . V_222 ) ;
if ( V_223 )
V_12 -> V_31 . V_223 = F_26 ( V_223 ) ;
else
V_223 = F_30 ( V_12 -> V_31 . V_223 ) ;
...
if ( V_154 -> V_226 && ! V_12 -> V_31 . V_163 )
F_75 ( V_12 , L_32 ) ;
V_57 = F_84 ( & V_60 -> V_209 , & V_213 ) ;
if ( V_57 )
goto V_217;
F_38 ( V_12 , L_33 , V_154 -> V_45 ) ;
return 0 ;
V_217:
F_69 ( V_60 ) ;
return V_57 ;
...
V_228 = V_12 -> V_41 -> V_79 ;
F_41 ( V_60 , V_228 ?
( 2 * V_228 ) : V_80 ) ;
}
V_12 -> V_212 = 0 ;
}
int F_87 ( struct V_230 * V_219 ,
int (* V_52)( struct V_11 * V_12 ) )
{
if ( ! V_219 || ! V_219 -> V_209 || ! V_52 || V_154 )
return - V_44 ;
if ( ! V_219 -> V_45 )
V_219 -> V_45 = L_36 ;
if ( ! V_219 -> V_161 )
V_219 -> V_161 = V_219 -> V_45 ;
V_231 . V_42 = ( char * ) V_219 -> V_45 ;
V_231 . V_219 . V_45 = V_219 -> V_45 ;
V_231 . V_232 =
F_60 ( T_1 , V_231 . V_232 , V_219 -> V_232 ) ;
V_154 = V_219 ;
F_82 = V_52 ;
return F_88 ( & V_231 , F_76 ) ;
}
void F_89 ( struct V_230 * V_219 )
{
if ( V_154 != V_219 )
return;
F_90 ( & V_231 ) ;
