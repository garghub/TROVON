...
{
int V_207 ;
V_207 = F_108 ( V_2 , V_291 ) ;
if ( ! V_207 )
return - V_290 ;
if ( V_287 )
return 0 ;
F_49 ( V_2 , V_207 + V_292 ,
V_293 ) ;
F_183 ( 100 ) ;
return 0 ;
}
static int F_185 ( struct V_1 * V_2 , int V_287 )
{
void T_5 * V_294 ;
unsigned long V_295 ;
T_2 V_64 ;
...
if ( ! V_294 )
return - V_296 ;
F_186 ( 0x00000002 , V_294 + V_297 ) ;
F_186 ( 0x00000005 , V_294 + V_298 ) ;
V_64 = F_187 ( V_294 + V_299 ) & 0xfffffffe ;
F_186 ( V_64 , V_294 + V_299 ) ;
V_295 = V_300 + F_188 ( V_301 ) ;
do {
V_64 = F_187 ( V_294 + V_302 ) ;
if ( ( V_64 & 0xb0000000 ) == 0 )
goto V_303;
F_183 ( 10 ) ;
} while ( F_189 ( V_300 , V_295 ) );
F_47 ( & V_2 -> V_2 , L_115 ) ;
V_303:
F_186 ( 0x00000002 , V_294 + V_304 ) ;
F_176 ( V_2 , V_294 ) ;
return 0 ;
}
int F_190 ( struct V_1 * V_2 , int V_287 )
{
const struct V_305 * V_148 ;
for ( V_148 = V_305 ; V_148 -> V_306 ; V_148 ++ ) {
if ( ( V_148 -> V_157 == V_2 -> V_157 ||
V_148 -> V_157 == ( T_3 ) V_256 ) &&
( V_148 -> V_83 == V_2 -> V_83 ||
V_148 -> V_83 == ( T_3 ) V_256 ) )
return V_148 -> V_306 ( V_2 , V_287 ) ;
}
return - V_290 ;
}
static struct V_1 * F_191 ( struct V_1 * V_2 )
{
if ( ! F_91 ( V_2 -> V_75 ) )
return F_192 ( V_2 ) ;
return F_129 ( V_2 -> V_76 , F_130 ( F_58 ( V_2 -> V_75 ) , 0 ) ) ;
}
struct V_1 * F_193 ( struct V_1 * V_2 )
{
const struct V_307 * V_148 ;
for ( V_148 = V_307 ; V_148 -> V_308 ; V_148 ++ ) {
if ( ( V_148 -> V_157 == V_2 -> V_157 ||
V_148 -> V_157 == ( T_3 ) V_256 ) &&
( V_148 -> V_83 == V_2 -> V_83 ||
V_148 -> V_83 == ( T_3 ) V_256 ) )
return V_148 -> V_308 ( V_2 ) ;
}
return F_192 ( V_2 ) ;
}
int F_194 ( struct V_1 * V_2 , T_3 V_309 )
{
const struct V_310 * V_148 ;
int V_311 ;
for ( V_148 = V_310 ; V_148 -> V_312 ; V_148 ++ ) {
if ( ( V_148 -> V_157 == V_2 -> V_157 ||
V_148 -> V_157 == ( T_3 ) V_256 ) &&
( V_148 -> V_83 == V_2 -> V_83 ||
V_148 -> V_83 == ( T_3 ) V_256 ) ) {
V_311 = V_148 -> V_312 ( V_2 , V_309 ) ;
if ( V_311 >= 0 )
return V_311 ;
}
}
