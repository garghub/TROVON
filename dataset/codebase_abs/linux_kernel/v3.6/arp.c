...
V_74 = F_42 ( F_43 ( V_51 ) , F_22 ( V_51 ) -> V_76 ) ;
if ( F_39 ( F_11 ( F_12 ( V_4 ) , V_74 ) , V_2 ,
V_74 , V_4 ) )
return 0 ;
V_75 = F_44 ( & V_77 , & V_74 , V_4 , 1 ) ;
if ( V_75 ) {
V_75 -> V_78 = V_79 ;
if ( V_75 -> V_25 & V_48 || F_45 ( V_75 , V_51 ) == 0 ) {
F_46 ( V_2 , V_75 , V_4 ) ;
F_47 ( V_75 ) ;
return 0 ;
}
...
static inline int F_51 ( struct V_19 * V_20 ,
struct V_3 * V_4 , struct V_67 * V_68 ,
T_1 V_63 , T_1 V_64 )
{
if ( V_68 -> V_71 . V_4 != V_4 )
...
struct V_50 * F_53 ( int type , int V_83 , T_1 V_84 ,
...
int V_92 = F_54 ( V_4 ) ;
int V_93 = V_4 -> V_94 ;
V_51 = F_55 ( F_56 ( V_4 ) + V_92 + V_93 , V_95 ) ;
if ( V_51 == NULL )
return NULL ;
F_57 ( V_51 , V_92 ) ;
F_58 ( V_51 ) ;
V_90 = (struct V_89 * ) F_59 ( V_51 , F_56 ( V_4 ) ) ;
V_51 -> V_4 = V_4 ;
V_51 -> V_96 = F_60 ( V_62 ) ;
if ( V_87 == NULL )
V_87 = V_4 -> V_42 ;
if ( V_86 == NULL )
V_86 = V_4 -> V_10 ;
if ( F_61 ( V_51 , V_4 , V_83 , V_86 , V_87 , V_51 -> V_97 ) < 0 )
goto V_98;
switch ( V_4 -> type ) {
default:
V_90 -> V_99 = F_60 ( V_4 -> type ) ;
V_90 -> V_100 = F_60 ( V_101 ) ;
break;
#if F_15 ( V_32 )
case V_33 :
V_90 -> V_99 = F_60 ( V_33 ) ;
V_90 -> V_100 = F_60 ( V_102 ) ;
break;
#if F_15 ( V_34 )
case V_35 :
V_90 -> V_99 = F_60 ( V_35 ) ;
...
{
F_63 ( V_107 , V_108 , V_51 , NULL , V_51 -> V_4 , V_109 ) ;
}
...
if ( V_4 -> V_39 & V_40 )
return;
V_51 = F_53 ( type , V_83 , V_84 , V_4 , V_85 ,
V_86 , V_87 , V_88 ) ;
if ( V_51 == NULL )
return;
F_62 ( V_51 ) ;
...
switch ( V_111 ) {
default:
if ( V_90 -> V_100 != F_60 ( V_101 ) ||
F_60 ( V_111 ) != V_90 -> V_99 )
goto V_98;
break;
case V_6 :
case V_7 :
case V_8 :
if ( ( V_90 -> V_99 != F_60 ( V_6 ) &&
V_90 -> V_99 != F_60 ( V_8 ) ) ||
V_90 -> V_100 != F_60 ( V_101 ) )
goto V_98;
break;
case V_33 :
if ( V_90 -> V_100 != F_60 ( V_102 ) ||
V_90 -> V_99 != F_60 ( V_33 ) )
goto V_98;
break;
case V_35 :
...
if ( V_90 -> V_106 != F_60 ( V_113 ) &&
V_90 -> V_106 != F_60 ( V_61 ) )
goto V_98;
V_91 = ( unsigned char * ) ( V_90 + 1 ) ;
V_110 = V_91 ;
V_91 += V_4 -> V_12 ;
...
if ( V_112 == V_117 &&
( F_48 ( V_20 , V_4 , V_68 ) ||
F_51 ( V_20 , V_4 , V_68 , V_63 , V_64 ) ||
( V_68 -> V_71 . V_4 != V_4 &&
F_73 ( & V_77 , V_70 , & V_64 , V_4 , 0 ) ) ) ) {
V_75 = F_71 ( & V_77 , V_110 , & V_63 , V_4 ) ;
if ( V_75 )
F_47 ( V_75 ) ;
if ( F_74 ( V_51 ) -> V_39 & V_118 ||
V_51 -> V_119 == V_120 ||
V_20 -> V_23 -> V_121 == 0 ) {
F_29 ( V_113 , V_62 , V_63 ,
V_4 , V_64 , V_110 , V_4 -> V_42 ,
...
V_75 = F_44 ( & V_77 , & V_63 , V_4 , 0 ) ;
if ( F_76 ( V_20 ) ) {
if ( V_75 == NULL &&
( V_90 -> V_106 == F_60 ( V_113 ) ||
( V_90 -> V_106 == F_60 ( V_61 ) && V_64 == V_63 ) ) &&
F_11 ( V_70 , V_63 ) == V_117 )
V_75 = F_44 ( & V_77 , & V_63 , V_4 , 1 ) ;
}
if ( V_75 ) {
int V_122 = V_123 ;
int V_124 ;
V_124 = F_77 ( V_79 , V_75 -> V_125 + V_75 -> V_22 -> V_126 ) ;
if ( V_90 -> V_106 != F_60 ( V_113 ) ||
V_51 -> V_119 != V_120 )
V_122 = V_127 ;
F_78 ( V_75 , V_110 , V_122 ,
V_124 ? V_128 : 0 ) ;
F_47 ( V_75 ) ;
}
V_98:
...
static int F_81 ( struct V_50 * V_51 , struct V_3 * V_4 ,
struct V_129 * V_130 , struct V_3 * V_131 )
{
struct V_89 * V_90 ;
if ( ! F_82 ( V_51 , F_56 ( V_4 ) ) )
goto V_132;
V_90 = F_65 ( V_51 ) ;
...
if ( V_51 == NULL )
goto V_135;
memset ( F_74 ( V_51 ) , 0 , sizeof( struct V_136 ) ) ;
return F_63 ( V_107 , V_137 , V_51 , V_4 , NULL , F_64 ) ;
V_132:
F_18 ( V_51 ) ;
V_135:
return 0 ;
}
static int F_84 ( struct V_70 * V_70 , struct V_3 * V_4 , int V_138 )
{
if ( V_4 == NULL ) {
F_85 ( V_70 , V_139 ) = V_138 ;
return 0 ;
}
if ( F_86 ( V_4 ) ) {
F_87 ( F_86 ( V_4 ) , V_139 , V_138 ) ;
return 0 ;
}
return - V_140 ;
}
static int F_88 ( struct V_70 * V_70 , struct V_141 * V_142 ,
struct V_3 * V_4 )
{
T_1 V_143 = ( (struct V_144 * ) & V_142 -> V_145 ) -> V_146 . V_147 ;
T_1 V_148 = ( (struct V_144 * ) & V_142 -> V_149 ) -> V_146 . V_147 ;
if ( V_148 && V_148 != F_89 ( 0xFFFFFFFF ) )
return - V_13 ;
if ( ! V_4 && ( V_142 -> V_150 & V_151 ) ) {
V_4 = F_90 ( V_70 , V_142 -> V_152 . V_153 ,
V_142 -> V_152 . V_154 ) ;
if ( ! V_4 )
return - V_155 ;
}
if ( V_148 ) {
if ( F_73 ( & V_77 , V_70 , & V_143 , V_4 , 1 ) == NULL )
return - V_156 ;
return 0 ;
}
return F_84 ( V_70 , V_4 , 1 ) ;
}
static int F_91 ( struct V_70 * V_70 , struct V_141 * V_142 ,
struct V_3 * V_4 )
{
T_1 V_143 ;
struct V_16 * V_17 ;
...
V_17 = F_93 ( & V_77 , & V_143 , V_4 ) ;
V_157 = F_92 ( V_17 ) ;
if ( ! F_36 ( V_17 ) ) {
unsigned int V_122 = V_127 ;
if ( V_142 -> V_150 & V_159 )
V_122 = V_161 ;
V_157 = F_78 ( V_17 , ( V_142 -> V_150 & V_151 ) ?
...
static unsigned int F_94 ( struct V_16 * V_17 )
{
if ( V_17 -> V_25 & V_161 )
return V_159 | V_151 ;
...
static int F_95 ( struct V_141 * V_142 , struct V_3 * V_4 )
{
T_1 V_143 = ( (struct V_144 * ) & V_142 -> V_145 ) -> V_146 . V_147 ;
struct V_16 * V_17 ;
int V_157 = - V_140 ;
V_17 = F_96 ( & V_77 , & V_143 , V_4 ) ;
if ( V_17 ) {
F_26 ( & V_17 -> V_59 ) ;
memcpy ( V_142 -> V_152 . V_154 , V_17 -> V_38 , V_4 -> V_12 ) ;
V_142 -> V_150 = F_94 ( V_17 ) ;
F_30 ( & V_17 -> V_59 ) ;
V_142 -> V_152 . V_153 = V_4 -> type ;
F_97 ( V_142 -> V_163 , V_4 -> V_164 , sizeof( V_142 -> V_163 ) ) ;
F_47 ( V_17 ) ;
V_157 = 0 ;
}
return V_157 ;
}
int F_98 ( struct V_3 * V_4 , T_1 V_143 )
{
struct V_16 * V_17 = F_96 ( & V_77 , & V_143 , V_4 ) ;
int V_157 = - V_140 ;
if ( V_17 ) {
if ( V_17 -> V_25 & ~ V_26 )
V_157 = F_78 ( V_17 , NULL , V_165 ,
V_128 |
V_162 ) ;
F_47 ( V_17 ) ;
}
...
T_1 V_143 = ( (struct V_144 * ) & V_142 -> V_145 ) -> V_146 . V_147 ;
T_1 V_148 = ( (struct V_144 * ) & V_142 -> V_149 ) -> V_146 . V_147 ;
if ( V_148 == F_89 ( 0xFFFFFFFF ) )
return F_100 ( & V_77 , V_70 , & V_143 , V_4 ) ;
if ( V_148 )
return - V_13 ;
return F_84 ( V_70 , V_4 , 0 ) ;
}
static int F_101 ( struct V_70 * V_70 , struct V_141 * V_142 ,
struct V_3 * V_4 )
{
T_1 V_143 ;
if ( V_142 -> V_150 & V_158 )
return F_99 ( V_70 , V_142 , V_4 ) ;
V_143 = ( (struct V_144 * ) & V_142 -> V_145 ) -> V_146 . V_147 ;
if ( V_4 == NULL ) {
struct V_67 * V_68 = F_35 ( V_70 , V_143 , 0 , V_160 , 0 ) ;
if ( F_36 ( V_68 ) )
...
return F_98 ( V_4 , V_143 ) ;
}
int F_102 ( struct V_70 * V_70 , unsigned int V_166 , void T_6 * V_167 )
{
int V_157 ;
struct V_141 V_142 ;
struct V_3 * V_4 = NULL ;
...
return - V_171 ;
case V_172 :
V_157 = F_104 ( & V_142 , V_167 , sizeof( struct V_141 ) ) ;
if ( V_157 )
return - V_173 ;
break;
default:
...
switch ( V_166 ) {
case V_168 :
V_157 = F_101 ( V_70 , & V_142 , V_4 ) ;
break;
case V_169 :
V_157 = F_91 ( V_70 , & V_142 , V_4 ) ;
break;
case V_172 :
V_157 = F_95 ( & V_142 , V_4 ) ;
break;
}
V_98:
F_107 () ;
if ( V_166 == V_172 && ! V_157 && F_108 ( V_167 , & V_142 , sizeof( V_142 ) ) )
V_157 = - V_173 ;
return V_157 ;
}
static int F_109 ( struct V_178 * V_179 , unsigned long V_180 ,
void * V_181 )
{
...
F_117 () ;
#ifdef F_118
F_119 ( NULL , & V_77 . V_22 , L_4 , NULL ) ;
#endif
F_120 ( & V_185 ) ;
}
static char * F_121 ( T_8 * V_186 , char * V_187 )
{
char V_188 , * V_189 ;
int V_75 ;
...
static void F_122 ( struct V_191 * V_192 ,
struct V_16 * V_75 )
{
char V_193 [ V_194 ] ;
int V_195 , V_196 ;
...
F_121 ( ( T_8 * ) V_75 -> V_38 , V_193 ) ;
else {
#endif
for ( V_195 = 0 , V_196 = 0 ; V_195 < V_194 - 3 && V_196 < V_4 -> V_12 ; V_196 ++ ) {
V_193 [ V_195 ++ ] = F_124 ( V_75 -> V_38 [ V_196 ] ) ;
V_193 [ V_195 ++ ] = F_125 ( V_75 -> V_38 [ V_196 ] ) ;
V_193 [ V_195 ++ ] = ':' ;
}
if ( V_195 != 0 )
-- V_195 ;
...
F_126 ( V_192 , L_7 ,
V_197 , V_198 , F_94 ( V_75 ) , V_193 , V_4 -> V_164 ) ;
F_127 ( & V_75 -> V_59 ) ;
}
...
static int F_129 ( struct V_191 * V_192 , void * V_201 )
{
if ( V_201 == V_202 ) {
F_130 ( V_192 , L_9
L_10 ) ;
...
static void * F_131 ( struct V_191 * V_192 , T_9 * V_206 )
{
return F_132 ( V_192 , V_206 , & V_77 , V_207 ) ;
}
static int F_133 ( struct V_208 * V_208 , struct V_209 * V_209 )
{
return F_134 ( V_208 , V_209 , & V_210 ,
sizeof( struct V_203 ) ) ;
}
static int T_10 F_135 ( struct V_70 * V_70 )
{
if ( ! F_136 ( V_70 , L_11 , V_211 , & V_212 ) )
return - V_213 ;
return 0 ;
}
static void T_11 F_137 ( struct V_70 * V_70 )
{
F_138 ( V_70 , L_11 ) ;
}
