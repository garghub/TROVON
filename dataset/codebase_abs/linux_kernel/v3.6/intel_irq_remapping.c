...
static void F_73 ( struct V_5 * V_5 , int V_125 ,
unsigned int V_126 )
{
...
V_5 -> V_129 = 0 ;
V_5 -> V_130 = V_40 -> V_131 ;
V_5 -> V_125 = V_125 ;
V_5 -> V_132 = F_74 ( V_126 ) ;
V_5 -> V_133 = 1 ;
}
static int F_75 ( int V_2 ,
struct V_134 * V_135 ,
unsigned int V_136 , int V_125 ,
struct V_137 * V_138 )
{
int V_123 = F_65 ( V_138 -> V_139 ) ;
struct V_16 * V_13 = F_20 ( V_123 ) ;
struct V_140 * V_6 ;
struct V_5 V_5 ;
int V_9 ;
if ( ! V_13 ) {
...
V_6 = (struct V_140 * ) V_135 ;
V_9 = F_5 ( V_13 , V_2 , 1 ) ;
if ( V_9 < 0 ) {
F_76 ( L_27 , V_123 ) ;
return - V_81 ;
}
F_73 ( & V_5 , V_125 , V_136 ) ;
F_26 ( & V_5 , V_123 ) ;
F_16 ( V_2 , & V_5 ) ;
F_77 ( V_142 , V_143 L_28
L_29
L_30
L_31
L_32 ,
V_138 -> V_139 , V_5 . V_24 , V_5 . V_144 , V_5 . V_127 ,
V_5 . V_133 , V_5 . V_129 , V_5 . V_130 ,
V_5 . V_145 , V_5 . V_125 , V_5 . V_132 ,
V_5 . V_51 , V_5 . V_50 , V_5 . V_49 ) ;
memset ( V_6 , 0 , sizeof( * V_6 ) ) ;
V_6 -> V_146 = ( V_9 >> 15 ) & 0x1 ;
V_6 -> V_147 = 0 ;
V_6 -> V_148 = 1 ;
V_6 -> V_9 = ( V_9 & 0x7fff ) ;
V_6 -> V_125 = V_138 -> V_149 ;
V_6 -> V_20 = 0 ;
V_6 -> V_150 = V_138 -> V_150 ;
V_6 -> V_151 = V_138 -> V_151 ;
if ( V_138 -> V_150 )
V_6 -> V_20 = 1 ;
return 0 ;
}
static int
F_78 ( struct V_152 * V_153 , const struct V_154 * V_20 ,
bool V_155 )
{
struct V_3 * V_4 = V_153 -> V_156 ;
unsigned int V_126 , V_2 = V_153 -> V_2 ;
struct V_5 V_5 ;
int V_157 ;
if ( ! F_79 ( V_158 ) )
return - V_159 ;
...
if ( F_2 ( V_2 , & V_5 ) )
return - V_161 ;
V_157 = F_81 ( V_2 , V_4 , V_20 ) ;
if ( V_157 )
return V_157 ;
V_157 = V_40 -> V_162 ( V_4 -> V_163 , V_20 , & V_126 ) ;
if ( V_157 ) {
if ( F_81 ( V_2 , V_4 , V_153 -> V_164 ) )
F_66 ( L_33 , V_2 ) ;
return V_157 ;
}
V_5 . V_125 = V_4 -> V_125 ;
...
if ( V_4 -> V_165 )
F_82 ( V_4 ) ;
F_83 ( V_153 -> V_164 , V_20 ) ;
return 0 ;
}
static void F_84 ( struct V_43 * V_166 ,
unsigned int V_2 , unsigned int V_126 ,
struct V_167 * V_168 , T_2 V_36 )
{
struct V_3 * V_4 ;
struct V_5 V_5 ;
T_1 V_12 = 0 ;
...
V_168 -> V_170 = V_171 ;
V_168 -> V_153 = V_12 ;
V_168 -> V_172 = V_173 | V_174 |
V_175 |
F_86 ( V_169 ) |
F_87 ( V_169 ) ;
}
static int F_88 ( struct V_43 * V_44 , int V_2 , int V_176 )
{
struct V_16 * V_13 ;
int V_9 ;
V_13 = F_21 ( V_44 ) ;
...
static int F_90 ( struct V_43 * V_166 , unsigned int V_2 ,
int V_9 , int V_12 )
{
struct V_16 * V_13 ;
V_13 = F_21 ( V_166 ) ;
...
static int F_91 ( unsigned int V_2 , unsigned int V_39 )
{
