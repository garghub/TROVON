...
F_12 ( V_120 , V_109 -> V_121 ) ;
switch ( V_2 -> V_5 & V_7 ) {
case 0x003 : F_30 ( V_326 ) ; break;
case 0x004 : F_30 ( V_327 ) ; break;
default: goto V_113;
}
break;
case V_328 :
...
V_117:
if ( V_110 -> V_115 -> V_336 && V_110 -> V_115 -> V_336 ( V_110 ,
...
int V_338 = V_24 -> V_42 ;
int V_339 = V_24 -> V_41 ;
if ( ( V_110 -> V_57 & V_340 ) && ( V_2 -> V_10 == V_47 || V_2 -> V_10 == V_48 ) ) {
V_338 = V_24 -> V_42 = 0 ;
V_339 = V_24 -> V_41 = 255 ;
}
if ( V_24 -> V_125 == V_132 || V_24 -> V_125 == V_129 )
F_39 ( V_109 , V_2 -> V_10 , V_338 , V_339 , ( V_339 - V_338 ) >> 8 , ( V_339 - V_338 ) >> 4 ) ;
else F_39 ( V_109 , V_2 -> V_10 , V_338 , V_339 , 0 , 0 ) ;
F_40 ( V_109 , V_2 -> V_10 ,
F_14 ( V_24 , V_2 -> V_10 ) ) ;
if ( V_2 -> V_10 == V_341 && V_109 -> V_342 == 0 )
F_41 ( V_109 , 60 ) ;
}
if ( V_2 -> type == V_337 &&
...
F_12 ( V_16 , V_109 -> V_343 ) ;
}
if ( V_2 -> V_160 && ! V_24 -> V_164 )
V_24 -> V_164 = V_2 -> V_10 ;
}
if ( ( V_2 -> type == V_337 ) && ( V_24 -> V_29 & V_175 ) &&
( V_2 -> V_10 == V_252 ) ) {
F_12 ( V_255 , V_109 -> V_37 ) ;
F_12 ( V_256 , V_109 -> V_37 ) ;
}
if ( V_2 -> type == V_9 ) {
F_12 ( V_344 , V_109 -> V_121 ) ;
F_12 ( V_345 , V_109 -> V_346 ) ;
}
V_113:
return;
}
...
F_43 ( V_109 , V_2 -> type , V_2 -> V_10 , V_347 [ V_160 ] . V_348 ) ;
F_43 ( V_109 , V_2 -> type , V_2 -> V_10 + 1 , V_347 [ V_160 ] . V_349 ) ;
return;
}
if ( V_2 -> V_5 == ( V_194 | 0x003c ) ) {
* V_57 = V_14 ? ( * V_57 | V_350 ) : ( * V_57 & ~ V_350 ) ;
return;
}
if ( V_2 -> V_5 == ( V_194 | 0x0032 ) ) {
if ( V_14 ) {
F_43 ( V_109 , V_2 -> type , ( * V_57 & V_350 ) ? V_201 : V_2 -> V_10 , 1 ) ;
return;
}
...
int V_338 = V_24 -> V_42 ;
int V_339 = V_24 -> V_41 ;
F_43 ( V_109 , V_9 , V_195 , V_14 > V_338 + ( ( V_339 - V_338 ) >> 3 ) ) ;
}
if ( V_2 -> V_5 == ( V_331 | 0x83UL ) ) {
F_13 ( L_5 , V_14 ) ;
return;
}
if ( V_2 -> V_5 == ( V_331 | 0x7fUL ) ) {
F_13 ( L_6 ) ;
return;
}
...
( V_2 -> V_10 == V_252 ) ) {
int V_351 = abs ( V_14 ) ;
int V_352 = V_14 > 0 ? V_255 : V_256 ;
int V_16 ;
for ( V_16 = 0 ; V_16 < V_351 ; V_16 ++ ) {
F_43 ( V_109 , V_9 , V_352 , 1 ) ;
F_44 ( V_109 ) ;
F_43 ( V_109 , V_9 , V_352 , 0 ) ;
F_44 ( V_109 ) ;
}
return;
}
...
if ( V_2 -> type == V_9 && ! ! F_35 ( V_2 -> V_10 , V_109 -> V_354 ) != V_14 )
F_43 ( V_109 , V_344 , V_345 , V_2 -> V_5 ) ;
...
{
struct V_357 * V_358 = V_5 -> V_115 ;
struct V_359 * V_360 ;
struct V_19 * V_361 ;
int V_16 , V_17 ;
V_360 = & V_5 -> V_362 [ V_105 ] ;
F_5 (rep, &rep_enum->report_list, list)
for ( V_16 = 0 ; V_16 < V_361 -> V_23 ; V_16 ++ )
for ( V_17 = 0 ; V_17 < V_361 -> V_24 [ V_16 ] -> V_25 ; V_17 ++ ) {
F_19 ( V_5 , V_105 , V_361 -> V_24 [ V_16 ] ) ;
if ( V_358 -> V_363 )
V_358 -> V_363 ( V_5 , V_361 -> V_24 [ V_16 ] ,
V_361 -> V_24 [ V_16 ] -> V_2 + V_17 ) ;
}
}
int F_54 ( struct V_12 * V_5 , unsigned int V_364 )
{
struct V_19 * V_20 ;
...
F_55 ( & V_5 -> V_365 ) ;
if ( ! V_364 ) {
for ( V_16 = 0 ; V_16 < V_5 -> V_366 ; V_16 ++ ) {
struct V_367 * V_368 = & V_5 -> V_369 [ V_16 ] ;
if ( V_368 -> type == V_370 ||
V_368 -> type == V_371 )
if ( F_56 ( V_368 -> V_2 ) )
break;
...
V_31 -> V_380 = F_8 ;
V_31 -> V_81 = V_5 -> V_81 ;
V_31 -> V_381 = V_5 -> V_381 ;
V_31 -> V_92 = V_5 -> V_92 ;
V_31 -> V_106 . V_382 = V_5 -> V_99 ;
V_31 -> V_106 . V_100 = V_5 -> V_100 ;
V_31 -> V_106 . V_101 = V_5 -> V_101 ;
V_31 -> V_106 . V_102 = V_5 -> V_102 ;
V_31 -> V_32 . V_383 = V_5 -> V_32 . V_383 ;
V_108 -> V_109 = V_31 ;
F_62 ( & V_108 -> V_384 , & V_5 -> V_365 ) ;
}
for ( V_16 = 0 ; V_16 < V_20 -> V_23 ; V_16 ++ )
for ( V_17 = 0 ; V_17 < V_20 -> V_24 [ V_16 ] -> V_25 ; V_17 ++ )
