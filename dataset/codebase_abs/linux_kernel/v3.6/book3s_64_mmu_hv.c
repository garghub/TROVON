...
V_184 = & V_41 -> V_184 [ V_72 - V_41 -> V_88 ] ;
F_79 ( V_184 ) ;
V_52 = V_176 ;
if ( F_80 ( V_39 , V_181 ) ) {
F_81 ( V_184 ) ;
...
static int F_86 ( struct V_1 * V_1 , unsigned long V_183 ,
int (* F_87)( struct V_1 * V_1 , unsigned long * V_202 ,
unsigned long V_72 ) )
{
int V_52 ;
int V_203 = 0 ;
...
V_205 = V_204 ( V_1 ) ;
F_88 (memslot, slots) {
unsigned long V_73 = V_41 -> V_101 ;
unsigned long V_206 ;
V_206 = V_73 + ( V_41 -> V_44 << V_15 ) ;
if ( V_183 >= V_73 && V_183 < V_206 ) {
T_5 V_207 = ( V_183 - V_73 ) >> V_15 ;
V_52 = F_87 ( V_1 , & V_41 -> V_184 [ V_207 ] ,
V_41 -> V_88 + V_207 ) ;
V_203 |= V_52 ;
}
}
...
static int F_89 ( struct V_1 * V_1 , unsigned long * V_202 ,
unsigned long V_72 )
{
struct V_4 * V_5 = V_1 -> V_18 . V_26 ;
unsigned long V_208 , V_43 , V_209 ;
unsigned long * V_143 ;
...
V_209 = V_5 [ V_43 ] . V_212 ;
if ( V_209 == V_43 ) {
* V_202 &= ~ ( V_210 | V_211 ) ;
} else {
V_208 = V_5 [ V_43 ] . V_213 ;
V_5 [ V_208 ] . V_212 = V_209 ;
V_5 [ V_209 ] . V_213 = V_208 ;
V_5 [ V_43 ] . V_212 = V_5 [ V_43 ] . V_213 = V_43 ;
* V_202 = ( * V_202 & ~ V_211 ) | V_209 ;
}
...
int F_90 ( struct V_1 * V_1 , unsigned long V_183 )
{
if ( V_1 -> V_18 . V_108 )
F_86 ( V_1 , V_183 , F_89 ) ;
return 0 ;
}
static int F_91 ( struct V_1 * V_1 , unsigned long * V_202 ,
unsigned long V_72 )
{
struct V_4 * V_5 = V_1 -> V_18 . V_26 ;
unsigned long V_214 , V_43 , V_209 ;
unsigned long * V_143 ;
int V_52 = 0 ;
V_215:
F_79 ( V_202 ) ;
...
V_143 [ 0 ] &= ~ V_111 ;
} while ( ( V_43 = V_209 ) != V_214 );
F_81 ( V_202 ) ;
return V_52 ;
}
int F_93 ( struct V_1 * V_1 , unsigned long V_183 )
{
if ( ! V_1 -> V_18 . V_108 )
return 0 ;
return F_86 ( V_1 , V_183 , F_91 ) ;
}
static int F_94 ( struct V_1 * V_1 , unsigned long * V_202 ,
unsigned long V_72 )
{
struct V_4 * V_5 = V_1 -> V_18 . V_26 ;
unsigned long V_214 , V_43 , V_209 ;
...
V_43 = V_214 = * V_202 & V_211 ;
do {
V_217 = ( unsigned long * ) ( V_1 -> V_18 . V_21 + ( V_43 << 4 ) ) ;
V_209 = V_5 [ V_43 ] . V_212 ;
if ( V_217 [ 1 ] & V_56 )
goto V_34;
} while ( ( V_43 = V_209 ) != V_214 );
...
int F_95 ( struct V_1 * V_1 , unsigned long V_183 )
{
if ( ! V_1 -> V_18 . V_108 )
return 0 ;
return F_86 ( V_1 , V_183 , F_94 ) ;
}
void F_96 ( struct V_1 * V_1 , unsigned long V_183 , T_4 V_196 )
{
if ( ! V_1 -> V_18 . V_108 )
return;
F_86 ( V_1 , V_183 , F_89 ) ;
}
static int F_97 ( struct V_1 * V_1 , unsigned long * V_202 )
{
struct V_4 * V_5 = V_1 -> V_18 . V_26 ;
unsigned long V_214 , V_43 , V_209 ;
unsigned long * V_143 ;
...
long F_98 ( struct V_1 * V_1 , struct V_40 * V_41 )
{
unsigned long V_43 ;
unsigned long * V_202 , * V_219 ;
F_66 () ;
V_202 = V_41 -> V_184 ;
V_219 = V_41 -> V_220 ;
...
void * F_100 ( struct V_1 * V_1 , unsigned long V_107 ,
unsigned long * V_221 )
{
struct V_40 * V_41 ;
...
struct V_75 * V_75 , * V_77 [ 1 ] ;
int V_44 ;
unsigned long V_183 , V_49 , V_222 ;
unsigned long V_223 ;
unsigned long * V_79 ;
V_41 = F_49 ( V_1 , V_72 ) ;
if ( ! V_41 || ( V_41 -> V_103 & V_115 ) )
...
if ( V_221 )
* V_221 = V_49 - V_222 ;
return F_102 ( V_75 ) + V_222 ;
}
void F_103 ( struct V_1 * V_1 , void * V_224 )
{
struct V_75 * V_75 = F_104 ( V_224 ) ;
F_43 ( V_75 ) ;
}
void F_105 ( struct V_38 * V_39 )
{
struct V_225 * V_226 = & V_39 -> V_18 . V_226 ;
if ( F_23 ( V_66 ) )
V_39 -> V_18 . V_123 = 32 ;
else
V_39 -> V_18 . V_123 = 64 ;
