...
F_2 ( & V_4 , V_2 ) ;
V_2 -> V_77 = F_23 ( V_2 ) ;
if ( ! V_58 -> V_78 ( V_42 , & V_4 ) ) {
V_75 = F_24 ( V_64 , V_2 ) ;
V_75 -> clock = V_4 . V_5 ;
V_75 -> V_77 = 0 ;
if ( V_2 -> V_77 == F_23 ( V_75 ) )
V_51 = V_79 ;
F_25 ( V_64 , V_75 ) ;
}
F_5 ( L_5
L_6 ,
( V_51 == V_79 ) ? L_7 : L_8 ,
V_2 -> V_80 . V_81 , V_2 -> V_44 , V_2 -> V_77 , V_2 -> clock ,
V_2 -> V_6 , V_2 -> V_8 ,
V_2 -> V_10 , V_2 -> V_12 ,
V_2 -> V_14 , V_2 -> V_16 ,
...
int V_93 , int V_94 , int V_95 , int V_96 )
{
struct V_40 * V_40 = F_4 ( V_39 ) ;
F_8 ( L_13 , V_40 -> V_42 -> V_44 , V_93 , V_94 , V_95 , V_96 ) ;
}
struct V_38 * F_33 ( struct V_63 * V_64 ,
int V_97 , struct V_41 * V_42 )
{
