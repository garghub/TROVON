...
{
struct V_68 * V_69 = F_20 ( V_45 -> V_2 ) ;
int V_100 ;
V_45 -> V_101 = V_69 -> V_99 ;
V_100 = F_21 ( V_45 , 8 , 16 , V_102 ) ;
if ( V_100 != 0 ) {
F_7 ( V_45 -> V_2 , L_4 , V_100 ) ;
return V_100 ;
}
F_9 ( V_45 , V_15 ,
V_103 | V_104 ,
...
unsigned int V_3 ;
int V_100 ;
V_69 = F_26 ( & V_116 -> V_2 , sizeof( * V_69 ) , V_119 ) ;
if ( V_69 == NULL ) {
F_7 ( & V_116 -> V_2 , L_5 ) ;
return - V_120 ;
}
V_69 -> V_99 = F_27 ( V_116 , & V_121 ) ;
if ( F_28 ( V_69 -> V_99 ) ) {
V_100 = F_29 ( V_69 -> V_99 ) ;
F_7 ( & V_116 -> V_2 , L_6 , V_100 ) ;
return V_100 ;
}
V_100 = F_30 ( V_69 -> V_99 , V_4 , & V_3 ) ;
if ( V_100 < 0 )
goto V_122;
if ( V_3 != 0x9093 ) {
F_7 ( & V_116 -> V_2 , L_7 , V_3 ) ;
V_100 = - V_123 ;
goto V_122;
}
V_100 = F_31 ( V_69 -> V_99 , V_4 , 0 ) ;
if ( V_100 < 0 )
goto V_122;
if ( V_116 -> V_2 . V_124 )
memcpy ( & V_69 -> V_76 , V_116 -> V_2 . V_124 ,
sizeof( V_69 -> V_76 ) ) ;
F_32 ( V_116 , V_69 ) ;
V_100 = F_33 ( & V_116 -> V_2 ,
& V_125 , NULL , 0 ) ;
if ( V_100 != 0 ) {
F_7 ( & V_116 -> V_2 , L_8 , V_100 ) ;
goto V_122;
}
return 0 ;
V_122:
...
static int T_1 F_35 ( struct V_115 * V_116 )
{
