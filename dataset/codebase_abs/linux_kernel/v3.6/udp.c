...
F_131 ( V_348 ) ,
F_226 ( V_348 ) ,
0 , 0L , 0 , F_227 ( V_348 ) , 0 , F_228 ( V_348 ) ,
F_229 ( & V_348 -> V_69 ) , V_348 ,
F_229 ( & V_348 -> V_234 ) , V_120 ) ;
}
int F_230 ( struct V_324 * V_325 , void * V_335 )
{
if ( V_335 == V_334 )
F_225 ( V_325 , L_11 ,
L_12
...
static int T_9 F_231 ( struct V_1 * V_1 )
{
return F_220 ( V_1 , & V_352 ) ;
}
static void T_10 F_232 ( struct V_1 * V_1 )
{
F_222 ( V_1 , & V_352 ) ;
}
int T_11 F_233 ( void )
...
static int T_11 F_237 ( char * V_354 )
{
T_12 V_228 ;
if ( ! V_354 )
return 0 ;
V_228 = F_238 ( V_354 , 0 , & V_355 ) ;
if ( V_228 )
return 0 ;
...
void T_11 F_239 ( struct V_20 * V_357 , const char * V_344 )
{
unsigned int V_282 ;
V_357 -> V_72 = F_240 ( V_344 ,
2 * sizeof( struct V_3 ) ,
V_355 ,
21 ,
0 ,
...
F_241 ( & V_357 -> V_72 [ V_282 ] . V_41 , V_282 ) ;
V_357 -> V_72 [ V_282 ] . V_34 = 0 ;
F_242 ( & V_357 -> V_72 [ V_282 ] . V_17 ) ;
}
for ( V_282 = 0 ; V_282 <= V_357 -> V_31 ; V_282 ++ ) {
F_241 ( & V_357 -> V_70 [ V_282 ] . V_41 , V_282 ) ;
V_357 -> V_70 [ V_282 ] . V_34 = 0 ;
F_242 ( & V_357 -> V_70 [ V_282 ] . V_17 ) ;
}
}
...
struct V_73 * F_247 ( struct V_73 * V_74 ,
T_13 V_363 )
{
struct V_73 * V_364 = F_248 ( - V_179 ) ;
unsigned int V_365 ;
int V_125 ;
T_4 V_127 ;
...
goto V_98;
if ( F_249 ( V_74 , V_363 | V_367 ) ) {
int type = F_70 ( V_74 ) -> V_368 ;
if ( F_40 ( type & ~ ( V_369 | V_370 ) ||
! ( type & ( V_369 ) ) ) )
goto V_98;
F_70 ( V_74 ) -> V_371 = F_250 ( V_74 -> V_120 , V_365 ) ;
V_364 = NULL ;
goto V_98;
}
V_125 = F_251 ( V_74 ) ;
...
V_125 += V_74 -> V_129 ;
* ( V_372 * ) ( V_74 -> V_84 + V_125 ) = F_252 ( V_127 ) ;
V_74 -> V_133 = V_134 ;
V_364 = F_253 ( V_74 , V_363 ) ;
V_98:
return V_364 ;
}
