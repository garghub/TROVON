...
F_28 ( & V_6 -> V_2 , & V_6 -> V_75 ) ;
}
}
static void F_29 ( struct V_19 * V_20 , T_1 V_36 , T_2 V_76 )
{
struct V_49 * V_50 ;
V_50 = F_24 ( V_20 -> V_51 . V_50 [ V_36 ] ) ;
if ( ! V_50 )
...
unsigned char * V_88 ;
T_2 V_89 ;
V_87 = (struct V_78 * ) F_32 ( V_4 , V_86 ) ;
memset ( V_87 , 0 , V_86 ) ;
V_87 -> V_90 = F_11 ( V_86 ) ;
V_87 -> V_91 =
F_33 ( ( 1 << V_92 ) |
...
void F_36 ( struct V_1 * V_2 , struct V_3 * V_4 )
{
struct V_3 * V_113 ;
struct V_21 * V_22 = (struct V_21 * ) V_4 -> V_23 ;
struct V_5 * V_6 = F_2 ( V_2 ) ;
...
V_114 = V_22 -> V_33 ;
F_38 (local, hdr->addr1, sta, tmp) {
if ( ! F_39 ( V_22 -> V_131 , V_20 -> V_28 -> V_27 . V_48 ) )
continue;
if ( V_8 -> V_12 & V_132 )
F_40 ( V_20 , V_133 ) ;
V_120 = ! ! ( V_8 -> V_12 & V_97 ) ;
...
V_57 = F_13 ( V_22 ) ;
V_36 = V_57 [ 0 ] & 0xf ;
V_76 = ( ( F_42 ( V_22 -> V_137 ) + 0x10 )
& V_138 ) ;
F_25 ( & V_20 -> V_28 -> V_27 , V_22 -> V_58 ,
V_36 , V_76 ) ;
}
if ( ! V_120 && F_43 ( V_114 ) ) {
T_2 V_36 , V_25 ;
V_122 = (struct V_121 * ) V_4 -> V_23 ;
V_25 = F_42 ( V_122 -> V_25 ) ;
if ( ! ( V_25 & V_139 ) ) {
T_2 V_76 = F_42 ( V_122 -> V_140 ) ;
V_36 = ( V_25 &
V_141 ) >>
V_142 ;
F_29 ( V_20 , V_36 , V_76 ) ;
...
F_44 ( V_6 , V_84 , V_20 , V_4 ) ;
if ( F_45 ( & V_20 -> V_28 -> V_27 ) )
F_46 ( V_6 , V_20 , V_4 ) ;
if ( ! ( V_8 -> V_12 & V_146 ) && V_120 )
F_26 ( V_20 , V_4 ) ;
if ( ( V_20 -> V_28 -> V_27 . type == V_59 ) &&
( V_6 -> V_2 . V_12 & V_147 ) )
F_47 ( V_20 -> V_28 , ( void * ) V_4 -> V_23 , V_120 ) ;
if ( V_6 -> V_2 . V_12 & V_147 ) {
if ( V_8 -> V_12 & V_97 ) {
if ( V_20 -> V_148 )
V_20 -> V_148 = 0 ;
} else if ( ++ V_20 -> V_148 >= V_149 ) {
F_48 ( V_20 -> V_28 -> V_150 ,
V_20 -> V_20 . V_48 ,
V_20 -> V_148 ,
V_151 ) ;
V_20 -> V_148 = 0 ;
...
if ( F_53 ( V_22 -> V_33 ) ||
F_56 ( V_22 -> V_33 ) )
F_57 ( V_4 -> V_150 , V_22 -> V_58 ,
V_163 , V_120 , V_151 ) ;
else
F_58 (
V_4 -> V_150 -> V_164 , V_163 , V_4 -> V_23 ,
...
! ( F_51 ( V_114 ) ) ;
if ( ! V_6 -> V_169 && ( ! V_119 || ! V_6 -> V_170 ) ) {
F_22 ( V_4 ) ;
return;
}
V_86 = F_30 ( V_8 ) ;
if ( F_66 ( F_67 ( V_4 ) < V_86 ) ) {
F_68 ( L_2 ) ;
F_22 ( V_4 ) ;
return;
}
F_31 ( V_84 , V_4 , V_85 , V_86 ) ;
F_69 ( V_4 , 0 ) ;
V_4 -> V_171 = V_172 ;
V_4 -> V_10 = V_173 ;
V_4 -> V_174 = F_70 ( V_175 ) ;
memset ( V_4 -> V_176 , 0 , sizeof( V_4 -> V_176 ) ) ;
F_37 () ;
F_71 (sdata, &local->interfaces, list) {
if ( V_28 -> V_27 . type == V_177 ) {
if ( ! F_72 ( V_28 ) )
continue;
if ( ( V_28 -> V_60 . V_178 & V_179 ) &&
! V_119 )
continue;
if ( V_116 ) {
...
void F_75 ( struct V_180 * V_181 , T_5 V_182 )
{
struct V_19 * V_20 = F_76 ( V_181 , struct V_19 , V_20 ) ;
F_48 ( V_20 -> V_28 -> V_150 , V_20 -> V_20 . V_48 ,
V_182 , V_151 ) ;
}
