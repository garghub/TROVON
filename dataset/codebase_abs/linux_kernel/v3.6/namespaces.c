...
struct V_1 * V_1 , unsigned int V_43 )
{
struct V_1 * error ;
struct V_4 * V_5 = F_12 ( V_3 ) ;
const struct V_7 * * V_32 , * * V_33 ;
unsigned int V_44 = V_1 -> V_45 . V_44 ;
error = F_2 ( - V_11 ) ;
if ( ! V_5 )
goto V_36;
error = F_2 ( - V_37 ) ;
...
if ( strlen ( ( * V_32 ) -> V_28 ) != V_44 )
continue;
if ( ! memcmp ( V_1 -> V_45 . V_28 , ( * V_32 ) -> V_28 , V_44 ) )
break;
}
error = F_2 ( - V_11 ) ;
if ( V_32 == V_33 )
