...
V_222 = F_79 ( V_16 , 2 + V_236 ) ;
if ( V_222 )
return V_222 ;
V_201 = V_16 -> V_219 + 0 ;
V_201 -> type = V_237 ;
V_201 = V_16 -> V_219 + V_238 ;
V_201 -> type = V_239 ;
V_201 -> V_240 = V_241 | V_242 ;
V_201 -> V_243 = V_223 ;
V_201 -> V_244 = 1 ;
V_201 -> V_245 = & V_246 ;
V_201 -> V_247 = V_248 ;
...
V_201 -> V_267 = V_268 ;
V_201 -> V_269 = & F_66 ;
V_201 -> F_13 = & F_13 ( V_16 ) -> V_183 -> V_270 [ V_215 ] ;
F_13 ( V_16 ) -> V_183 -> V_270 [ V_215 ] . V_169 =
V_215 / V_12 ;
F_13 ( V_16 ) -> V_183 -> V_270 [ V_215 ] . V_11 =
V_215 % V_12 ;
} else {
V_201 -> type = V_237 ;
}
...
F_81 ( V_16 , V_215 ) ;
for ( V_215 = 0 ; V_215 < F_25 ( V_16 ) ; ++ V_215 )
F_82 ( & F_13 ( V_16 ) -> V_183 -> V_270 [ V_215 ] ) ;
for ( V_215 = 0 ; V_215 < V_223 ; ++ V_215 ) {
if ( V_215 < V_271 )
F_83 ( V_16 , V_215 , V_272 ) ;
else
F_83 ( V_16 , V_215 ,
V_225 ) ;
F_84 ( V_16 , V_215 , V_273 ) ;
}
for ( V_215 = 0 ; V_215 < F_14 ( V_16 ) -> V_27 ; ++ V_215 )
F_57 ( V_16 , V_215 ) ;
...
static int
V_258 ( struct V_15 * V_16 , struct V_200 * V_201 ,
struct V_278 * V_279 , unsigned int * V_280 )
{
return F_91 ( F_50 ( V_201 ) , V_279 , V_280 ) ;
}
...
static int
V_261 ( struct V_15 * V_16 , struct V_200 * V_201 ,
struct V_278 * V_279 , unsigned int * V_280 )
{
return F_92 ( F_50 ( V_201 ) , V_279 , V_280 ) ;
}
static int V_260 ( struct V_15 * V_16 ,
struct V_200 * V_201 ,
struct V_278 * V_279 , unsigned int * V_280 )
{
return F_93 ( F_50 ( V_201 ) , V_279 , V_280 ) ;
}
static int F_76 ( struct V_15 * V_16 , int V_281 , int V_282 )
{
struct V_283 * V_172 ;
int V_215 ;
for ( V_172 = V_284 ; V_172 ; V_172 = V_172 -> V_285 ) {
if ( V_172 -> V_286 )
continue;
if ( V_281 || V_282 ) {
if ( V_281 != V_172 -> V_235 -> V_281 -> V_287 ||
V_282 != F_94 ( V_172 -> V_235 -> V_288 ) )
continue;
}
for ( V_215 = 0 ; V_215 < V_289 ; V_215 ++ ) {
if ( F_95 ( V_172 ) == V_290 [ V_215 ] . V_291 ) {
V_16 -> V_18 = V_290 + V_215 ;
...
static int V_248 ( struct V_15 * V_16 ,
struct V_200 * V_201 ,
struct V_278 * V_279 , unsigned int * V_280 )
{
unsigned V_293 = F_97 ( V_279 -> V_294 ) ;
if ( V_280 [ 0 ] ) {
V_201 -> V_295 &= ~ ( V_280 [ 0 ] << V_293 ) ;
V_201 -> V_295 |= ( V_280 [ 0 ] & V_280 [ 1 ] ) << V_293 ;
F_29 ( V_16 , 0 , V_201 -> V_295 , V_296 ) ;
}
V_280 [ 1 ] =
( F_32 ( V_16 , 0 ,
V_297 ) >> V_293 ) ;
...
static int V_250 ( struct V_15 * V_16 ,
struct V_200 * V_201 ,
struct V_278 * V_279 , unsigned int * V_280 )
{
int V_305 = F_97 ( V_279 -> V_294 ) ;
switch ( V_280 [ 0 ] ) {
case V_314 :
...
return 0 ;
case V_318 :
return F_83 ( V_16 , V_305 , V_280 [ 1 ] ) ;
break;
case V_319 :
V_280 [ 1 ] = F_98 ( V_16 , V_305 ) ;
break;
case V_320 :
F_99 ( V_16 , V_305 , V_280 [ 1 ] ) ;
break;
default:
return - V_308 ;
break;
