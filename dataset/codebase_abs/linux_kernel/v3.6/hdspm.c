...
switch ( V_3 -> V_31 ) {
case V_32 :
V_3 -> V_123 = V_3 -> V_125 = V_550 ;
V_3 -> V_132 = V_3 -> V_133 = V_550 ;
V_3 -> V_138 = V_3 -> V_139 = V_550 ;
V_3 -> V_119 = V_3 -> V_121 =
V_551 ;
V_3 -> V_130 = V_3 -> V_131 =
V_551 ;
...
V_586 ) {
V_3 -> V_209 ++ ;
V_3 -> V_224 = F_259 ( sizeof( struct V_587 ) ,
V_548 ) ;
if ( NULL != V_3 -> V_224 ) {
F_150 ( V_3 ) ;
}
...
V_3 -> V_352 = ( F_4 ( V_3 ,
V_182 ) >> 8 ) & 0xFFFFFF ;
if ( NULL == V_146 [ V_3 -> V_596 ] && V_3 -> V_352 != 0xFFFFFF ) {
...
V_173 = F_270 ( V_233 [ V_596 ] , V_146 [ V_596 ] ,
V_602 , sizeof( struct V_3 ) , & V_172 ) ;
if ( V_173 < 0 )
return V_173 ;
V_3 = V_172 -> V_165 ;
V_172 -> V_603 = F_268 ;
...
V_3 -> V_346 ,
V_3 -> V_352 ) ;
sprintf ( V_172 -> V_604 , L_192 ,
V_3 -> V_346 ,
V_3 -> V_352 ,
V_3 -> V_353 , V_3 -> V_179 ) ;
} else {
sprintf ( V_172 -> V_198 , L_193 , V_3 -> V_346 ) ;
sprintf ( V_172 -> V_604 , L_194 ,
