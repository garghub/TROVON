...
V_20 = F_72 ( V_102 , V_17 -> V_108 , ( const T_5 * ) & V_78 -> V_109 ,
V_22 -> V_66 , V_48 , V_110 ) ;
if ( ! V_20 )
return;
if ( F_71 ( V_17 ) -> type == V_104 )
F_73 ( V_17 , V_102 , V_101 , 0 , 0 , V_48 , 0 ) ;
else
F_74 ( V_17 , V_102 , 0 , 0 , V_48 , 0 ) ;
F_75 ( V_20 ) ;
}
...
V_116 -> V_139 = F_91 ( ( V_20 -> V_124 -> V_113 + 7 ) / 8 ) ;
