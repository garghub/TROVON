...
void F_50 ( struct V_4 * V_5 , struct V_50 * V_51 , int V_55 )
{
struct V_20 * V_21 = V_5 -> V_58 -> V_21 ;
struct V_25 * V_26 = F_51 ( V_21 ) ;
...
void F_62 ( struct V_77 * V_78 , T_1 V_79 , T_2 V_80 )
{
struct V_25 * V_26 = F_63 ( & V_78 -> V_81 ) ;
struct V_4 * V_5 ;
while ( V_80 ) {
V_5 = F_24 ( V_78 -> V_82 , V_79 , V_83 ) ;
if ( V_5 ) {
F_7 ( V_5 ) ;
F_64 ( V_26 ) ;
F_50 ( V_5 , V_52 -> V_53 , 1 ) ;
F_65 ( V_26 ) ;
F_12 ( V_5 ) ;
F_44 ( V_5 ) ;
}
...
int F_66 ( struct V_77 * V_78 , int V_84 , T_1 V_85 ,
struct V_4 * * V_42 )
{
struct V_25 * V_26 = F_63 ( & V_78 -> V_81 ) ;
struct V_18 * V_19 = V_78 -> V_82 ;
struct V_4 * V_5 ;
int V_86 = 0 ;
T_2 V_87 = V_84 ? V_88 : V_89 ;
V_86 = F_38 ( V_19 , V_85 , V_49 , & V_5 ) ;
if ( V_86 == 0 && F_67 ( V_26 , V_5 , V_87 ) ) {
F_44 ( V_5 ) ;
V_86 = - V_45 ;
}
* V_42 = V_5 ;
...
struct V_4 * F_68 ( struct V_18 * V_19 , T_1 V_90 , T_2 V_91 )
{
struct V_25 * V_26 = V_19 -> V_22 ;
struct V_4 * V_92 , * V_5 ;
T_2 V_93 = F_69 ( V_26 , V_94 ) >>
V_26 -> V_31 . V_32 ;
F_2 ( ! V_91 ) ;
if ( V_93 < 1 )
V_93 = 1 ;
if ( V_91 > V_93 )
V_91 = V_93 ;
V_92 = F_24 ( V_19 , V_90 , V_40 ) ;
if ( F_41 ( V_92 ) )
goto V_95;
if ( ! F_70 ( V_92 ) )
F_71 ( V_48 | V_9 , 1 , & V_92 ) ;
V_90 ++ ;
V_91 -- ;
while ( V_91 ) {
V_5 = F_24 ( V_19 , V_90 , V_40 ) ;
if ( ! F_41 ( V_5 ) && ! F_70 ( V_5 ) )
F_71 ( V_96 | V_9 , 1 , & V_5 ) ;
F_44 ( V_5 ) ;
V_90 ++ ;
V_91 -- ;
if ( ! F_70 ( V_92 ) && F_41 ( V_92 ) )
goto V_95;
}
F_42 ( V_92 ) ;
V_95:
