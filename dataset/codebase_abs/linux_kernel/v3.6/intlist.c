...
void F_8 ( struct V_10 * V_9 V_3 , struct V_7 * V_8 )
{
F_2 ( V_8 ) ;
}
struct V_7 * F_9 ( struct V_10 * V_9 , int V_5 )
{
struct V_7 * V_8 = NULL ;
struct V_1 * V_1 = F_10 ( & V_9 -> V_2 , ( void * ) ( ( long ) V_5 ) ) ;
if ( V_1 )
V_8 = F_4 ( V_1 , struct V_7 , V_1 ) ;
return V_8 ;
}
struct V_10 * F_11 ( void )
{
...
void F_13 ( struct V_10 * V_9 )
{
if ( V_9 != NULL )
F_14 ( & V_9 -> V_2 ) ;
}
struct V_7 * F_15 ( const struct V_10 * V_9 , unsigned int V_14 )
{
struct V_7 * V_8 = NULL ;
struct V_1 * V_1 ;
V_1 = F_16 ( & V_9 -> V_2 , V_14 ) ;
if ( V_1 )
V_8 = F_4 ( V_1 , struct V_7 , V_1 ) ;
return V_8 ;
}
