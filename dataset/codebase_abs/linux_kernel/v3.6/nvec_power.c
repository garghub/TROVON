...
struct V_62 * V_63 ;
struct V_5 * V_6 ;
struct V_96 * V_21 = F_9 ( V_95 -> V_68 . V_69 ) ;
V_6 = F_17 ( & V_95 -> V_68 , sizeof( struct V_5 ) , V_97 ) ;
if ( V_6 == NULL )
return - V_98 ;
F_18 ( & V_95 -> V_68 , V_6 ) ;
V_6 -> V_21 = V_21 ;
...
F_20 ( V_21 , & V_6 -> V_7 , V_10 ) ;
if ( V_95 -> V_99 == V_102 )
F_4 ( V_6 ) ;
return F_21 ( & V_95 -> V_68 , V_63 ) ;
}
static int T_2 F_22 ( struct V_94 * V_95 )
{
struct V_5 * V_6 = F_23 ( V_95 ) ;
F_24 ( & V_6 -> V_91 ) ;
switch ( V_95 -> V_99 ) {
case V_100 :
F_25 ( & V_15 ) ;
