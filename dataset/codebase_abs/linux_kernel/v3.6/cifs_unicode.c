...
T_1 *
F_17 ( const char * V_34 , const int V_35 , int * V_46 ,
const struct V_3 * V_15 , int V_47 )
{
int V_17 ;
T_1 * V_37 ;
V_17 = F_16 ( V_34 , V_35 , V_15 ) ;
V_17 += 2 ;
V_37 = F_10 ( V_17 , V_38 ) ;
if ( ! V_37 ) {
* V_46 = 0 ;
...
F_13 ( V_37 , V_34 , strlen ( V_34 ) , V_15 , V_47 ) ;
* V_46 = V_17 ;
return V_37 ;
}
