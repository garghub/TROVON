...
if ( ! V_89 || ( ! V_4 -> V_4 . V_56 && V_4 -> V_4 . V_14 != V_91 ) ) {
F_27 ( L_77 ) ;
return - V_94 ;
}
V_11 = V_4 -> V_11 ;
...
V_32 = F_80 & V_172 ;
V_4 = & V_11 -> V_4 [ V_32 ] ;
if ( V_32 >= V_122 || ( V_32 && ! V_4 -> V_4 . V_56 ) )
goto V_155;
if ( V_32 ) {
if ( ( F_80 & V_151 ) ) {
if ( ! V_4 -> V_16 )
...
static int F_99 ( struct V_118 * V_95 ,
struct V_124 * V_39 )
{
struct V_10 * V_11 ;
V_11 = F_38 ( V_95 , struct V_10 , V_95 ) ;
V_11 -> V_39 = V_39 ;
V_11 -> V_95 . V_189 . V_39 = & V_39 -> V_39 ;
V_11 -> V_95 . V_189 . V_198 = V_11 -> V_199 -> V_189 . V_198 ;
V_11 -> V_36 = 1 ;
V_11 -> V_37 = 1 ;
F_27 ( L_96 , V_39 -> V_39 . V_14 ) ;
return 0 ;
}
static int F_100 ( struct V_118 * V_95 ,
struct V_124 * V_39 )
{
struct V_10 * V_11 ;
unsigned long V_9 ;
...
static void F_101 ( struct V_200 * V_189 )
{
struct V_10 * V_11 = F_102 ( V_189 ) ;
unsigned long V_9 ;
F_2 ( & V_11 -> V_12 , V_9 ) ;
F_62 ( F_102 ( V_189 ) , 0 ) ;
F_7 ( & V_11 -> V_12 , V_9 ) ;
}
static void T_7 F_103 ( struct V_10 * V_11 ,
struct V_201 * V_202 )
{
struct V_203 * V_130 = & V_11 -> V_130 ;
T_1 V_204 ;
enum V_205 V_9 ;
if ( F_104 ( V_202 , L_98 , & V_204 ) == 0 )
V_130 -> V_206 = 1 ;
V_130 -> V_191 = F_105 ( V_202 , L_99 , 0 ,
& V_9 ) ;
V_130 -> V_190 = ( V_9 & V_207 ) ? 1 : 0 ;
V_130 -> V_135 = F_105 ( V_202 , L_100 , 0 ,
& V_9 ) ;
V_130 -> V_131 = ( V_9 & V_207 ) ? 1 : 0 ;
}
static int T_7 F_106 ( struct V_200 * V_199 )
{
struct V_188 * V_189 = & V_199 -> V_189 ;
struct V_10 * V_11 ;
int V_208 ;
struct V_209 * V_210 ;
if ( ! V_189 -> V_211 ) {
...
V_210 = F_107 ( V_199 , V_213 , 0 ) ;
if ( ! V_210 )
return - V_215 ;
if ( ! F_108 ( V_210 -> V_216 , F_109 ( V_210 ) , V_33 ) ) {
F_27 ( L_104 ) ;
return - V_217 ;
}
V_11 = & V_218 ;
V_11 -> V_95 . V_189 . V_219 = V_189 ;
if ( V_199 -> V_189 . V_198 )
F_103 ( V_11 , V_199 -> V_189 . V_198 ) ;
else
memcpy ( & V_11 -> V_130 , V_189 -> V_211 ,
sizeof( struct V_203 ) ) ;
V_11 -> V_199 = V_199 ;
V_11 -> V_36 = 0 ;
F_110 ( & V_11 -> V_12 ) ;
if ( F_63 () ) {
if ( F_111 ( V_11 -> V_130 . V_135 ) ) {
F_27 ( L_105 ) ;
V_208 = - V_174 ;
goto V_220;
}
V_208 = F_112 ( V_11 -> V_130 . V_135 , L_106 ) ;
if ( V_208 ) {
F_27 ( L_107 ) ;
goto V_220;
}
F_113 ( V_11 -> V_130 . V_135 ,
V_11 -> V_130 . V_131 ) ;
}
if ( F_65 () || F_67 () ) {
V_11 -> V_4 [ 0 ] . V_15 = 64 ;
...
V_11 -> V_123 = F_114 ( V_210 -> V_216 , F_109 ( V_210 ) ) ;
if ( ! V_11 -> V_123 ) {
V_208 = - V_221 ;
goto V_222;
}
F_56 ( V_11 ) ;
V_11 -> V_126 = F_115 ( V_189 , L_108 ) ;
V_11 -> V_127 = F_115 ( V_189 , L_109 ) ;
if ( F_116 ( V_11 -> V_126 ) || F_116 ( V_11 -> V_127 ) ) {
F_27 ( L_110 ) ;
V_208 = - V_174 ;
goto V_223;
}
V_208 = F_117 ( & V_11 -> V_95 . V_189 ) ;
if ( V_208 < 0 ) {
F_118 ( & V_11 -> V_95 . V_189 ) ;
goto V_223;
}
F_59 ( V_11 -> V_126 ) ;
F_23 ( V_11 , V_134 , V_141 ) ;
...
F_61 ( V_11 -> V_126 ) ;
V_11 -> V_224 = F_119 ( V_199 , 0 ) ;
V_208 = F_120 ( V_11 -> V_224 , F_85 ,
0 , V_33 , V_11 ) ;
if ( V_208 < 0 ) {
F_27 ( L_111 , V_11 -> V_224 ) ;
goto V_225;
}
if ( F_111 ( V_11 -> V_130 . V_191 ) ) {
V_208 = F_112 ( V_11 -> V_130 . V_191 , L_112 ) ;
if ( V_208 < 0 ) {
F_27 ( L_113 ) ;
goto V_226;
}
F_121 ( V_11 -> V_130 . V_191 ) ;
V_11 -> V_35 = F_93 ( V_11 -> V_130 . V_191 ) ^
V_11 -> V_130 . V_190 ;
if ( V_11 -> V_130 . V_206 ) {
F_122 ( & V_11 -> V_194 , F_92 ) ;
F_123 ( & V_11 -> V_195 , F_96 ,
( unsigned long ) V_11 ) ;
F_95 ( & V_11 -> V_195 ,
V_196 + V_197 ) ;
} else {
if ( F_120 ( F_124 ( V_11 -> V_130 . V_191 ) ,
F_89 , 0 , V_33 , V_11 ) ) {
F_27 ( L_114 ,
V_11 -> V_130 . V_191 ) ;
V_208 = - V_217 ;
...
V_208 = F_125 ( V_189 , & V_11 -> V_95 ) ;
if ( V_208 )
goto V_228;
F_126 ( V_189 , V_11 ) ;
F_127 ( V_189 , 1 ) ;
F_14 ( V_11 ) ;
F_128 ( L_116 , V_33 , V_34 ) ;
return 0 ;
V_228:
if ( F_111 ( V_11 -> V_130 . V_191 ) && ! V_11 -> V_130 . V_206 )
F_129 ( F_124 ( V_11 -> V_130 . V_191 ) , V_11 ) ;
V_227:
if ( F_111 ( V_11 -> V_130 . V_191 ) )
F_130 ( V_11 -> V_130 . V_191 ) ;
V_226:
F_129 ( V_11 -> V_224 , V_11 ) ;
V_225:
F_131 ( & V_11 -> V_95 . V_189 ) ;
V_223:
F_132 ( V_11 -> V_123 ) ;
V_222:
if ( F_63 () )
F_130 ( V_11 -> V_130 . V_135 ) ;
V_220:
F_133 ( V_210 -> V_216 , F_109 ( V_210 ) ) ;
F_27 ( L_117 , V_33 , V_208 ) ;
return V_208 ;
}
static int T_8 F_134 ( struct V_200 * V_199 )
{
struct V_10 * V_11 = F_102 ( V_199 ) ;
struct V_209 * V_210 ;
unsigned long V_9 ;
F_27 ( L_118 ) ;
F_135 ( & V_11 -> V_95 ) ;
...
static int F_137 ( struct V_200 * V_199 , T_9 V_229 )
{
struct V_10 * V_11 = F_102 ( V_199 ) ;
int V_230 = V_11 -> V_39 && F_138 ( & V_199 -> V_189 ) ;
unsigned long V_9 ;
...
F_140 ( V_11 -> V_224 ) ;
V_11 -> V_231 = V_230 ;
if ( F_111 ( V_11 -> V_130 . V_191 ) && ! V_11 -> V_130 . V_206 && V_230 )
F_140 ( V_11 -> V_130 . V_191 ) ;
return 0 ;
}
static int F_141 ( struct V_200 * V_199 )
{
struct V_10 * V_11 = F_102 ( V_199 ) ;
unsigned long V_9 ;
if ( F_111 ( V_11 -> V_130 . V_191 ) && ! V_11 -> V_130 . V_206 &&
V_11 -> V_231 )
F_142 ( V_11 -> V_130 . V_191 ) ;
if ( V_11 -> V_231 )
F_142 ( V_11 -> V_224 ) ;
else {
F_2 ( & V_11 -> V_12 , V_9 ) ;
