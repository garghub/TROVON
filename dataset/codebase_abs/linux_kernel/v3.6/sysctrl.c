...
static void F_19 ( const char * V_16 , const char * V_17 ,
unsigned int V_1 , unsigned int V_7 )
{
struct V_5 * V_5 = F_20 ( sizeof( struct V_5 ) , V_18 ) ;
V_5 -> V_19 . V_20 = V_16 ;
V_5 -> V_19 . V_21 = V_17 ;
V_5 -> V_19 . V_5 = V_5 ;
V_5 -> V_22 = F_10 ;
...
static void F_22 ( const char * V_16 , const char * V_17 ,
unsigned int V_7 )
{
struct V_5 * V_5 = F_20 ( sizeof( struct V_5 ) , V_18 ) ;
V_5 -> V_19 . V_20 = V_16 ;
...
{
struct V_5 * V_5 = F_20 ( sizeof( struct V_5 ) , V_18 ) ;
struct V_5 * V_24 = F_20 ( sizeof( struct V_5 ) , V_18 ) ;
V_5 -> V_19 . V_20 = L_4 ;
V_5 -> V_19 . V_21 = NULL ;
V_5 -> V_19 . V_5 = V_5 ;
V_5 -> V_10 = V_11 ;
...
F_19 ( L_24 , NULL , 0 , V_52 ) ;
}
if ( ! F_15 ( L_25 ) ) {
F_19 ( L_26 , NULL , 0 , V_53 ) ;
F_23 () ;
}
if ( F_15 ( L_25 ) ) {
if ( F_8 ( V_54 ) & ( 1 << 5 ) )
...
F_34 ( V_56 , V_56 , V_56 ) ;
F_22 ( L_24 , L_27 , V_57 ) ,
F_19 ( L_24 , L_28 , 0 , V_58 ) ;
} else if ( F_15 ( L_23 ) ) {
F_34 ( F_35 () , F_36 () ,
F_36 () ) ;
F_19 ( L_29 , L_30 , 1 , V_59 ) ;
F_19 ( L_29 , L_31 , 0 , V_60 ) ;
F_19 ( L_29 , L_32 , 1 , V_61 ) ;
F_19 ( L_29 , L_33 , 1 , V_62 ) ;
F_19 ( L_29 , L_34 , 1 , V_63 ) ;
F_19 ( L_29 , L_35 , 0 , V_64 | V_65 ) ;
} else if ( F_15 ( L_3 ) ) {
F_34 ( F_37 () , F_38 () ,
F_38 () ) ;
F_19 ( L_24 , L_36 , 0 , V_66 ) ;
} else {
F_34 ( F_39 () , F_40 () ,
F_40 () ) ;
}
