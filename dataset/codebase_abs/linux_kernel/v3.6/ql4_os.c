...
if ( V_730 == NULL )
memcpy ( & V_728 -> V_731 [ 0 ] , & V_350 -> V_731 [ 0 ] ,
sizeof( V_728 -> V_731 ) ) ;
else
memcpy ( & V_728 -> V_731 [ 0 ] , & V_730 [ 0 ] , sizeof( V_728 -> V_731 ) ) ;
}
...
T_2 V_734 )
{
if ( strcmp ( V_732 -> V_448 , V_733 -> V_448 ) )
return V_341 ;
if ( strcmp ( V_732 -> V_425 , V_733 -> V_425 ) )
return V_341 ;
if ( V_732 -> V_445 != V_733 -> V_445 )
return V_341 ;
if ( V_734 ) {
F_3 ( F_4 ( V_25 , V_10 , L_190
L_191 ,
V_26 , V_732 -> V_731 [ 5 ] , V_732 -> V_731 [ 4 ] ,
V_732 -> V_731 [ 3 ] , V_732 -> V_731 [ 2 ] , V_732 -> V_731 [ 1 ] ,
V_732 -> V_731 [ 0 ] , V_733 -> V_731 [ 5 ] , V_733 -> V_731 [ 4 ] ,
V_733 -> V_731 [ 3 ] , V_733 -> V_731 [ 2 ] , V_733 -> V_731 [ 1 ] ,
V_733 -> V_731 [ 0 ] ) ) ;
if ( memcmp ( & V_732 -> V_731 [ 0 ] , & V_733 -> V_731 [ 0 ] ,
sizeof( V_732 -> V_731 ) ) )
return V_341 ;
}
F_3 ( F_4 ( V_25 , V_10 ,
L_192 ,
V_732 -> V_445 , V_732 -> V_446 , V_732 -> V_425 ,
V_732 -> V_448 , V_733 -> V_445 , V_733 -> V_446 ,
V_733 -> V_425 , V_733 -> V_448 ) ) ;
return V_41 ;
}
...
F_291 ( V_350 , V_735 , NULL ) ;
for ( V_327 = 0 ; V_327 < V_340 ; V_327 ++ ) {
V_132 = F_94 ( V_10 , V_327 ) ;
if ( V_132 == NULL )
continue;
F_290 ( V_132 , V_736 ) ;
if ( ! F_292 ( V_10 , V_735 , V_736 , false ) ) {
V_100 = V_41 ;
goto V_737;
}
}
...
static int F_295 ( struct V_738 * V_739 , T_2 * V_731 )
{
struct V_740 * V_741 , * V_742 ;
struct V_378 * V_350 ;
F_237 (nt_ddb_idx, nt_ddb_idx_tmp, list_nt, list) {
V_350 = & V_741 -> V_743 ;
if ( memcmp ( & V_350 -> V_731 [ 0 ] , & V_731 [ 0 ] ,
sizeof( V_741 -> V_743 . V_731 ) ) == 0 ) {
return V_41 ;
}
}
return V_341 ;
...
{
T_2 V_744 , V_101 ;
V_744 = V_350 -> V_731 [ 1 ] & 0x1f ;
for ( V_101 = 0 ; V_101 < 8 ; V_101 ++ ) {
V_350 -> V_731 [ 1 ] = ( V_744 | ( V_101 << 5 ) ) ;
if ( F_295 ( V_739 , V_350 -> V_731 ) )
break;
}
if ( ! F_295 ( V_739 , V_350 -> V_731 ) )
return V_341 ;
...
struct V_727 * V_733 )
{
if ( strcmp ( V_732 -> V_425 , V_733 -> V_425 ) == 0 ) {
if ( V_732 -> V_445 == V_733 -> V_445 )
return V_341 ;
}
if ( strcmp ( V_732 -> V_448 , V_733 -> V_448 ) )
...
F_291 ( V_350 , V_735 , NULL ) ;
F_237 (nt_ddb_idx, nt_ddb_idx_tmp, list_nt, list) {
F_291 ( & V_741 -> V_743 , V_736 ,
V_741 -> V_730 ) ;
V_100 = F_292 ( V_10 , V_735 , V_736 , true ) ;
if ( V_100 == V_41 )
goto V_737;
}
F_237 (nt_ddb_idx, nt_ddb_idx_tmp, list_nt, list) {
F_291 ( & V_741 -> V_743 , V_736 , NULL ) ;
V_100 = F_297 ( V_10 , V_736 , V_735 ) ;
if ( V_100 == V_41 ) {
V_18 = F_296 ( V_10 , V_739 , V_350 ) ;
if ( V_18 == V_41 )
V_100 = V_341 ;
else
V_100 = V_41 ;
...
static void F_299 ( struct V_738 * V_745 )
{
struct V_740 * V_746 , * V_747 ;
F_237 (ddb_idx, ddb_idx_tmp, list_ddb, list) {
F_238 ( & V_746 -> V_613 ) ;
F_153 ( V_746 ) ;
}
}
static struct V_174 * F_300 ( struct V_9 * V_10 ,
struct V_378 * V_350 )
{
struct V_174 * V_176 ;
struct V_11 * V_12 ;
...
V_8 -> V_20 = V_31 ;
V_14 = (struct V_13 * ) V_8 ;
V_748 = ( char * ) & V_14 -> V_32 ;
memcpy ( V_748 , V_350 -> V_425 , V_17 ) ;
V_14 -> V_749 = F_301 ( F_127 ( V_350 -> V_445 ) ) ;
} else {
V_8 -> V_20 = V_21 ;
V_12 = (struct V_11 * ) V_8 ;
V_748 = ( char * ) & V_12 -> V_22 ;
memcpy ( V_748 , V_350 -> V_425 , V_24 ) ;
V_12 -> V_750 = F_301 ( F_127 ( V_350 -> V_445 ) ) ;
}
V_176 = F_27 ( V_10 -> V_180 , V_8 , 0 ) ;
F_153 ( V_8 ) ;
return V_176 ;
}
static int F_302 ( struct V_9 * V_10 , T_4 V_327 )
{
if ( V_717 )
return V_41 ;
...
{
T_1 V_327 = 0 ;
T_1 V_752 [ V_753 ] = { 0 , 1 , 2 , 3 } ;
T_1 V_399 [ V_316 ] ;
T_1 V_754 ;
unsigned long V_377 ;
int V_100 ;
V_377 = V_382 + ( V_326 * V_755 ) ;
do {
for ( V_327 = 0 ; V_327 < V_753 ; V_327 ++ ) {
if ( V_752 [ V_327 ] == - 1 )
continue;
V_100 = F_305 ( V_10 , 0 , V_752 [ V_327 ] , V_399 ) ;
if ( V_100 == V_341 ) {
V_752 [ V_327 ] = - 1 ;
continue;
}
V_754 = ( V_399 [ 1 ] & V_756 ) >> V_757 ;
F_3 ( F_4 ( V_25 , V_10 ,
L_194 ,
V_752 [ V_327 ] , V_754 ) ) ;
if ( V_754 == V_758 ||
...
V_353 = F_20 ( V_10 ) ? V_359 :
V_360 ;
V_765 = sizeof( struct V_740 ) ;
for ( V_327 = 0 ; V_327 < V_353 ; V_327 = V_767 ) {
V_100 = F_98 ( V_10 , V_327 , V_350 , V_766 ,
NULL , & V_767 , & V_242 ,
& V_768 , NULL , & V_769 ) ;
if ( V_100 == V_341 )
break;
...
int V_100 ;
F_237 (ddb_idx, ddb_idx_tmp, list_ddb, list) {
V_100 = F_98 ( V_10 , V_746 -> V_773 ,
NULL , 0 , NULL , & V_767 , & V_242 ,
& V_768 , NULL , NULL ) ;
if ( V_100 == V_341 )
continue;
if ( V_242 == V_368 ||
...
sizeof( struct V_378 ) ) ;
F_303 ( V_10 , V_132 ) ;
V_187 = F_105 ( V_190 , sizeof( struct V_334 ) , V_769 ) ;
if ( ! V_187 ) {
V_100 = V_341 ;
goto V_774;
}
V_132 -> V_333 = V_187 ;
V_176 = F_300 ( V_10 , V_350 ) ;
if ( V_176 ) {
V_176 -> V_333 = V_187 ;
V_187 -> V_176 = V_176 ;
} else {
...
break;
V_741 -> V_773 = V_327 ;
memcpy ( & V_741 -> V_730 [ 0 ] ,
& V_350 -> V_731 [ 0 ] ,
sizeof( V_741 -> V_730 ) ) ;
V_100 = F_298 ( V_10 , V_739 ,
V_350 ) ;
if ( V_100 == V_41 ) {
F_153 ( V_741 ) ;
goto V_777;
}
memcpy ( & V_741 -> V_743 , V_350 ,
sizeof( struct V_378 ) ) ;
F_231 ( & V_741 -> V_613 , V_739 ) ;
} else if ( V_628 == V_596 ) {
if ( F_293 ( V_10 , V_350 ) ==
V_41 )
goto V_777;
}
V_100 = F_308 ( V_10 , V_350 , V_628 ) ;
if ( V_100 == V_341 )
goto V_776;
V_777:
if ( V_767 == 0 )
...
{
T_4 V_779 = 0 ;
struct V_738 V_763 , V_739 ;
struct V_740 * V_764 , * V_780 ;
unsigned long V_377 ;
if ( ! F_34 ( V_261 , & V_10 -> V_119 ) ) {
...
F_111 ( V_10 , V_764 -> V_773 ) ;
}
V_779 = ( ( V_10 -> V_455 > V_456 ) &&
( V_10 -> V_455 < V_456 * 10 ) ?
V_10 -> V_455 : V_456 ) ;
F_3 ( F_4 ( V_25 , V_10 ,
L_198 , V_779 ) ) ;
V_377 = V_382 + ( V_326 * V_779 ) ;
do {
if ( F_183 ( & V_763 ) )
break;
F_307 ( V_10 , & V_763 ) ;
...
F_299 ( & V_763 ) ;
F_310 ( V_10 , & V_739 , V_628 ) ;
F_299 ( & V_739 ) ;
F_311 ( V_10 ) ;
}
static int T_10 F_312 ( struct V_636 * V_194 ,
const struct V_781 * V_782 )
{
int V_100 = - V_783 , V_349 ;
struct V_1 * V_180 ;
struct V_9 * V_10 ;
T_2 V_784 = 0 ;
char V_93 [ 34 ] ;
...
if ( F_313 ( V_194 ) )
return - 1 ;
V_180 = F_314 ( & V_787 , sizeof( * V_10 ) , 0 ) ;
if ( V_180 == NULL ) {
F_28 ( V_38
L_199 ) ;
goto V_788;
...
V_786 = & V_794 [ V_10 -> V_699 ] ;
V_10 -> V_786 . V_795 = V_786 -> V_795 ;
V_10 -> V_786 . V_796 =
V_786 -> V_796 ;
V_10 -> V_786 . V_797 = V_786 -> V_797 ;
V_10 -> V_786 . V_798 = V_786 -> V_798 ;
} else {
V_10 -> V_586 = & V_799 ;
}
if ( F_8 ( V_10 ) )
V_194 -> V_800 = 1 ;
V_100 = V_10 -> V_586 -> V_801 ( V_10 ) ;
if ( V_100 )
goto V_802;
F_4 ( V_25 , V_10 , L_200 ,
V_194 -> V_125 , V_194 -> V_803 , V_10 -> V_508 ) ;
F_317 ( V_10 ) ;
F_229 ( & V_10 -> V_804 ) ;
F_318 ( & V_10 -> V_805 ) ;
F_318 ( & V_10 -> V_107 ) ;
...
F_322 ( V_194 , V_10 ) ;
V_100 = F_323 ( V_180 , & V_194 -> V_126 ) ;
if ( V_100 )
goto V_807;
if ( F_8 ( V_10 ) )
( void ) F_324 ( V_10 ) ;
V_349 = F_209 ( V_10 , V_778 ) ;
...
L_216
L_217 ,
V_822 , V_10 -> V_194 -> V_125 , F_253 ( V_10 -> V_194 ) ,
V_10 -> V_452 , V_10 -> V_823 [ 0 ] , V_10 -> V_823 [ 1 ] ,
V_10 -> V_824 , V_10 -> V_825 ) ;
if ( F_281 ( V_10 ) )
F_4 ( V_147 , V_10 ,
L_218 , V_26 ) ;
F_246 ( V_10 , V_778 ) ;
...
{
struct V_9 * V_826 = NULL ;
struct V_636 * V_827 = NULL ;
int V_828 = V_829 ;
if ( F_274 ( V_10 -> V_194 -> V_642 ) & V_830 )
V_828 = V_831 ;
V_827 =
F_334 ( F_335 ( V_10 -> V_194 -> V_832 ) ,
V_10 -> V_194 -> V_832 -> V_833 , F_336 ( F_337 ( V_10 -> V_194 -> V_642 ) ,
V_828 ) ) ;
if ( V_827 ) {
if ( F_174 ( & V_827 -> V_834 ) ) {
V_826 = F_338 ( V_827 ) ;
if ( V_826 ) {
F_168 ( V_835 , & V_826 -> V_119 ) ;
F_3 ( F_4 ( V_25 , V_10 , L_219
L_220 , V_26 ,
F_339 ( & V_826 -> V_194 -> V_126 ) ) ) ;
}
}
F_340 ( V_827 ) ;
}
...
static void T_11 F_343 ( struct V_636 * V_194 )
{
struct V_9 * V_10 ;
V_10 = F_338 ( V_194 ) ;
if ( ! F_8 ( V_10 ) )
...
{
int V_836 ;
if ( F_345 ( V_10 -> V_194 , F_346 ( 64 ) ) == 0 ) {
if ( F_347 ( V_10 -> V_194 , F_346 ( 64 ) ) ) {
F_348 ( & V_10 -> V_194 -> V_126 ,
L_221
L_222 ) ;
V_836 = F_347 ( V_10 -> V_194 ,
F_346 ( 32 ) ) ;
}
} else
V_836 = F_345 ( V_10 -> V_194 , F_346 ( 32 ) ) ;
}
static int F_349 ( struct V_837 * V_838 )
{
struct V_128 * V_190 ;
struct V_130 * V_131 ;
struct V_132 * V_469 ;
int V_839 = V_840 ;
V_190 = F_48 ( V_838 -> V_841 ) ;
V_131 = V_190 -> V_134 ;
V_469 = V_131 -> V_134 ;
V_838 -> V_474 = V_469 ;
V_838 -> V_842 = 1 ;
if ( V_843 != 0 && V_843 <= 0xffffU )
V_839 = V_843 ;
F_350 ( V_838 , V_839 ) ;
return 0 ;
}
static int F_351 ( struct V_837 * V_838 )
{
V_838 -> V_842 = 1 ;
return 0 ;
}
static void F_352 ( struct V_837 * V_838 )
{
F_353 ( V_838 , 1 ) ;
}
static int F_354 ( struct V_837 * V_838 , int V_364 ,
int V_844 )
{
if ( ! V_845 )
return - V_846 ;
return F_355 ( V_838 , V_364 , V_844 ) ;
}
...
return V_465 ;
if ( V_465 -> V_119 & V_470 ) {
V_10 -> V_847 += V_465 -> V_848 ;
V_10 -> V_848 -= V_465 -> V_848 ;
if ( V_465 -> V_466 )
V_465 -> V_466 -> V_849 =
( unsigned char * ) ( unsigned long ) V_816 ;
}
return V_465 ;
}
...
do {
V_851 = (struct V_465 * ) F_145 ( V_466 ) ;
if ( V_851 == NULL ) {
V_850 ++ ;
break;
}
...
{
unsigned long V_854 ;
V_854 = V_382 + ( V_855 * V_326 ) ;
while ( F_205 ( V_382 , V_854 ) ) {
if ( F_33 ( V_10 ) )
return V_41 ;
F_187 ( 2000 ) ;
}
...
static int F_359 ( struct V_9 * V_10 ,
struct F_49 * V_856 ,
struct V_837 * V_838 )
{
int V_857 ;
int V_349 = 0 ;
struct V_237 * V_466 ;
for ( V_857 = 0 ; V_857 < V_10 -> V_180 -> V_571 ; V_857 ++ ) {
V_466 = F_186 ( V_10 -> V_180 , V_857 ) ;
if ( V_466 && V_856 == F_49 ( V_466 -> V_125 ) &&
( ! V_838 || V_838 == V_466 -> V_125 ) ) {
if ( ! F_356 ( V_10 , V_466 ) ) {
V_349 ++ ;
break;
}
...
unsigned int V_858 = V_466 -> V_125 -> V_858 ;
unsigned int V_859 = V_466 -> V_125 -> V_859 ;
unsigned long V_119 ;
struct V_465 * V_465 = NULL ;
int V_100 = V_853 ;
int V_584 = 0 ;
...
F_361 ( & V_465 -> V_468 ) ;
F_51 ( & V_10 -> V_385 , V_119 ) ;
if ( F_362 ( V_10 , V_465 ) != V_41 ) {
F_116 ( F_28 ( L_225 ,
V_10 -> V_452 , V_858 , V_859 ) ) ;
V_100 = V_860 ;
} else {
F_116 ( F_28 ( L_226 ,
V_10 -> V_452 , V_858 , V_859 ) ) ;
...
F_4 ( V_25 , V_10 ,
L_228 ,
V_10 -> V_452 , V_858 , V_859 , ( V_100 == V_853 ) ? L_229 : L_230 ) ;
return V_100 ;
}
static int F_363 ( struct V_237 * V_466 )
{
struct V_9 * V_10 = F_2 ( V_466 -> V_125 -> V_180 ) ;
struct V_132 * V_132 = V_466 -> V_125 -> V_474 ;
int V_100 = V_860 , V_861 ;
if ( ! V_132 )
return V_100 ;
V_100 = F_364 ( V_466 ) ;
if ( V_100 )
...
F_4 ( V_25 , V_10 ,
L_231 , V_10 -> V_452 ,
V_466 -> V_125 -> V_862 , V_466 -> V_125 -> V_858 , V_466 -> V_125 -> V_859 ) ;
F_3 ( F_28 ( V_25
L_232
L_233 , V_10 -> V_452 ,
V_466 , V_382 , V_466 -> V_863 -> V_864 / V_326 ,
V_10 -> V_483 , V_466 -> V_477 , V_466 -> V_865 ) ) ;
V_861 = F_365 ( V_10 , V_132 , V_466 -> V_125 -> V_859 ) ;
if ( V_861 != V_41 ) {
F_4 ( V_25 , V_10 , L_234 , V_861 ) ;
goto V_866;
}
if ( F_359 ( V_10 , F_49 ( V_466 -> V_125 ) ,
V_466 -> V_125 ) ) {
F_4 ( V_25 , V_10 ,
L_235
L_236 ) ;
...
if ( F_366 ( V_10 , V_132 , V_466 -> V_125 -> V_859 ,
V_867 ) != V_41 )
goto V_866;
F_4 ( V_25 , V_10 ,
L_237 ,
V_10 -> V_452 , V_466 -> V_125 -> V_862 , V_466 -> V_125 -> V_858 ,
V_466 -> V_125 -> V_859 ) ;
V_100 = V_853 ;
V_866:
return V_100 ;
}
static int F_367 ( struct V_237 * V_466 )
{
struct V_9 * V_10 = F_2 ( V_466 -> V_125 -> V_180 ) ;
struct V_132 * V_132 = V_466 -> V_125 -> V_474 ;
int V_861 , V_100 ;
...
if ( V_100 )
return V_100 ;
F_368 ( V_25 , F_49 ( V_466 -> V_125 ) ,
L_238 ) ;
F_3 ( F_28 ( V_25
L_239
L_240 ,
V_10 -> V_452 , V_466 , V_382 , V_466 -> V_863 -> V_864 / V_326 ,
V_10 -> V_483 , V_466 -> V_477 , V_466 -> V_865 ) ) ;
V_861 = F_369 ( V_10 , V_132 ) ;
if ( V_861 != V_41 ) {
F_368 ( V_25 , F_49 ( V_466 -> V_125 ) ,
L_241 ) ;
return V_860 ;
...
static int F_371 ( struct V_237 * V_466 )
{
int V_871 = V_860 ;
struct V_9 * V_10 ;
...
if ( F_358 ( V_10 ) != V_41 ) {
F_3 ( F_28 ( L_247
L_248 , V_10 -> V_452 , V_466 -> V_125 -> V_862 ,
V_26 ) ) ;
return V_860 ;
}
if ( ! F_34 ( V_485 , & V_10 -> V_483 ) ) {
...
memset ( V_298 , 0 , V_873 ) ;
V_18 = F_373 ( V_10 , V_874 , V_876 , V_873 ) ;
if ( V_18 != V_41 ) {
V_18 = - V_321 ;
goto V_877;
}
...
F_78 ( & V_10 -> V_324 ,
V_325 * V_326 ) ;
V_18 = F_79 ( V_10 , & V_315 [ 0 ] , & V_317 [ 0 ] , V_874 ) ;
if ( V_18 != V_41 ) {
V_18 = - V_321 ;
goto V_877;
}
...
static int F_374 ( struct V_1 * V_2 , int V_878 )
{
struct V_9 * V_10 = F_2 ( V_2 ) ;
int V_18 = V_41 ;
if ( V_549 ) {
...
static T_12
F_375 ( struct V_636 * V_194 , T_13 V_242 )
{
struct V_9 * V_10 = F_338 ( V_194 ) ;
F_4 ( V_38 , V_10 , L_256 ,
...
static T_1 F_378 ( struct V_9 * V_10 )
{
T_1 V_18 = V_341 ;
T_1 V_100 = 0 ;
int V_828 ;
...
V_828 = F_274 ( V_10 -> V_194 -> V_642 ) ;
while ( V_828 > 0 ) {
V_828 -- ;
F_4 ( V_25 , V_10 , L_258
L_259 , V_10 -> V_452 , V_26 , V_828 ) ;
V_827 =
F_334 ( F_335 ( V_10 -> V_194 -> V_832 ) ,
V_10 -> V_194 -> V_832 -> V_833 , F_336 ( F_337 ( V_10 -> V_194 -> V_642 ) ,
V_828 ) ) ;
...
static int T_14 F_384 ( void )
{
int V_100 ;
V_520 = F_385 ( L_281 , sizeof( struct V_465 ) , 0 ,
V_898 , NULL ) ;
if ( V_520 == NULL ) {
F_28 ( V_147
L_282
