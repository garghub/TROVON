...
struct V_98 * V_98 )
{
struct V_206 * V_207 = F_49 ( T_10 , struct V_206 , T_10 ) ;
struct V_208 * V_208 = V_207 -> V_209 -> V_208 ;
...
V_205 -> V_210 . V_211 . V_212 += V_186 -> V_213 ;
F_91 ( & V_205 -> V_210 , V_214 ) ;
if ( V_205 -> V_215 . V_216 != NULL ) {
T_11 V_217 = V_205 -> V_215 . V_216 ;
if ( V_205 -> V_215 . V_136 == NULL )
V_205 -> V_215 . V_136 = F_92 ( V_208 ,
V_205 -> V_64 . V_67 ) ;
V_217 ( T_10 , V_205 -> V_215 . V_136 , V_186 , V_98 , V_84 ) ;
}
return 0 ;
}
static void F_93 ( bool V_218 , struct V_219 * * V_220 )
{
int V_58 = - V_221 ;
...
struct V_219 * V_209 ;
V_209 = F_94 ( V_224 , V_225 , 0 , false ,
& V_206 . T_10 ) ;
if ( V_209 == NULL )
F_27 ( L_54 ) ;
V_206 . V_209 = V_209 ;
V_58 = F_95 ( V_209 , V_223 ) ;
assert ( V_58 == 0 ) ;
if ( F_96 ( V_209 , L_55 ) ) {
V_58 = F_97 ( V_209 , & V_206 . T_10 ) ;
if ( V_58 )
F_27 ( L_56 , V_58 ) ;
V_21 = V_209 -> V_210 . V_211 . V_21 [ 0 ] ;
V_226 = V_209 -> V_210 . V_211 . V_227 ;
V_228 = V_209 -> V_210 . V_211 . V_21 [ V_229 ] ;
}
if ( V_218 )
F_98 ( V_209 ) ;
if ( V_220 )
...
if ( V_226 && V_21 ) {
printf ( L_58 ,
( double ) V_226 / ( double ) V_21 * 100.0 ,
V_226 , V_21 , V_228 ) ;
}
if ( V_168 && V_169 ) {
printf ( L_59 ,
...
{
char * V_232 , * V_179 , * V_143 = F_107 ( V_233 ) ;
for ( V_179 = strtok_r ( V_143 , L_76 , & V_232 ) ;
V_179 ; V_179 = strtok_r ( NULL , L_76 , & V_232 ) ) {
...
static int F_109 ( int V_236 , const char * * V_237 )
{
unsigned int V_238 , V_12 , V_51 ;
const char * * V_239 ;
V_238 = F_110 ( V_240 ) + V_236 - 1 ;
V_239 = calloc ( V_238 + 1 , sizeof( char * ) ) ;
if ( V_239 == NULL )
return - V_241 ;
for ( V_12 = 0 ; V_12 < F_110 ( V_240 ) ; V_12 ++ )
V_239 [ V_12 ] = F_107 ( V_240 [ V_12 ] ) ;
for ( V_51 = 1 ; V_51 < ( unsigned int ) V_236 ; V_51 ++ , V_12 ++ )
V_239 [ V_12 ] = V_237 [ V_51 ] ;
F_11 ( V_12 != V_238 ) ;
return F_111 ( V_12 , V_239 , NULL ) ;
}
int F_112 ( int V_236 , const char * * V_237 , const char * T_12 V_39 )
{
V_236 = F_113 ( V_236 , V_237 , V_242 , V_243 ,
V_244 ) ;
if ( ! V_236 )
F_108 ( V_243 , V_242 ) ;
if ( ! strcmp ( V_237 [ 0 ] , L_79 ) )
return F_114 ( V_236 , V_237 , T_12 ) ;
F_115 () ;
if ( ! strncmp ( V_237 [ 0 ] , L_80 , 3 ) ) {
return F_109 ( V_236 , V_237 ) ;
} else if ( ! strncmp ( V_237 [ 0 ] , L_81 , 3 ) ) {
V_189 = & V_245 ;
if ( V_236 > 1 ) {
V_236 = F_113 ( V_236 , V_237 , V_235 , V_234 , 0 ) ;
if ( V_236 )
F_108 ( V_234 , V_235 ) ;
}
F_106 () ;
F_100 () ;
} else if ( ! strcmp ( V_237 [ 0 ] , L_82 ) ) {
V_189 = & V_246 ;
F_106 () ;
F_103 () ;
} else if ( ! strncmp ( V_237 [ 0 ] , L_83 , 3 ) ) {
V_189 = & V_247 ;
if ( V_236 ) {
V_236 = F_113 ( V_236 , V_237 , V_248 , V_249 , 0 ) ;
if ( V_236 )
F_108 ( V_249 , V_248 ) ;
}
F_105 () ;
