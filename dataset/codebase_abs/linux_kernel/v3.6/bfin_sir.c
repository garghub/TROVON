...
goto V_121;
F_16 ( V_28 , 9600 ) ;
V_49 -> V_122 = F_94 ( V_47 , & V_49 -> V_123 , V_124 ) ;
if ( ! V_49 -> V_122 )
goto V_125;
F_95 ( & V_49 -> V_99 , F_79 ) ;
V_49 -> V_98 = 1 ;
...
static int F_99 ( T_5 * V_127 , int V_128 )
{
...
V_119 = F_103 ( V_133 [ V_9 -> V_132 ] , V_124 ) ;
if ( V_119 )
return V_119 ;
} else {
F_104 ( & V_9 -> V_47 , L_11 ) ;
...
V_49 -> V_123 . V_149 . V_150 &= V_131 ;
V_49 -> V_123 . V_151 . V_150 = 1 ;
F_107 ( & V_49 -> V_123 ) ;
V_119 = F_108 ( V_47 ) ;
if ( V_119 ) {
