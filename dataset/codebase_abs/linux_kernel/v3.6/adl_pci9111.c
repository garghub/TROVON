...
static struct V_140 * F_58 ( struct V_14 * V_15 ,
struct V_141 * V_142 )
{
struct V_140 * V_143 = NULL ;
int V_144 = V_142 -> V_145 [ 0 ] ;
int V_146 = V_142 -> V_145 [ 1 ] ;
int V_56 ;
F_59 (pcidev) {
if ( V_143 -> V_147 != V_148 )
continue;
for ( V_56 = 0 ; V_56 < V_149 ; V_56 ++ ) {
if ( V_143 -> V_150 != V_151 [ V_56 ] . V_152 )
continue;
if ( V_144 || V_146 ) {
if ( V_143 -> V_144 -> V_153 != V_144 ||
F_60 ( V_143 -> V_154 ) != V_146 )
continue;
}
V_15 -> V_59 = V_151 + V_56 ;
F_19 ( V_155
L_24 ,
V_15 -> V_156 , V_151 [ V_56 ] . V_157 ,
V_143 -> V_144 -> V_153 , F_60 ( V_143 -> V_154 ) ,
F_61 ( V_143 -> V_154 ) , V_143 -> V_87 ) ;
return V_143 ;
}
}
F_19 ( V_155
L_25 ,
V_15 -> V_156 , V_144 , V_146 ) ;
return NULL ;
}
...
struct V_140 * V_143 ;
struct V_47 * V_84 ;
unsigned long V_1 , V_158 , V_49 , V_159 ;
int error ;
const struct V_57 * V_58 ;
if ( F_63 ( V_15 , sizeof( struct V_160 ) ) < 0 )
return - V_161 ;
F_19 ( V_155 L_26 V_50 L_27 ,
V_15 -> V_156 ) ;
V_143 = F_58 ( V_15 , V_142 ) ;
if ( ! V_143 )
return - V_162 ;
F_64 ( V_15 , & V_143 -> V_15 ) ;
V_58 = (struct V_57 * ) V_15 -> V_59 ;
V_49 = F_65 ( V_143 , 1 ) ;
V_159 = F_66 ( V_143 , 1 ) ;
F_19
( L_28 ,
V_15 -> V_156 , V_49 , V_159 ) ;
if ( F_67 ( V_143 , V_50 ) < 0 ) {
F_19
( L_29 ,
V_15 -> V_156 ) ;
return - V_162 ;
...
V_158 = F_66 ( V_143 , 2 ) ;
F_19 ( V_155 L_30 ,
V_15 -> V_156 , V_1 , V_158 ) ;
V_15 -> V_163 = V_1 ;
V_15 -> V_164 = V_58 -> V_157 ;
V_23 -> V_158 = V_158 ;
V_23 -> V_165 = 0 ;
V_23 -> V_49 = V_49 ;
V_23 -> V_159 = V_159 ;
...
V_15 -> V_87 = 0 ;
if ( V_143 -> V_87 > 0 ) {
V_15 -> V_87 = V_143 -> V_87 ;
if ( F_68 ( V_15 -> V_87 , F_31 ,
V_166 , V_50 , V_15 ) != 0 ) {
F_19 ( V_155
L_31 ,
V_15 -> V_156 , V_15 -> V_87 ) ;
return - V_167 ;
}
}
error = F_69 ( V_15 , 4 ) ;
...
static int T_2 F_75 ( struct V_140 * V_15 ,
const struct V_198 * V_199 )
{
return F_76 ( V_15 , & V_200 ) ;
}
static void T_3 F_77 ( struct V_140 * V_15 )
{
F_78 ( V_15 ) ;
}
