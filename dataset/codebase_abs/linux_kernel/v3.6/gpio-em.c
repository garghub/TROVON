...
V_2 -> V_30 = F_36 ( V_46 -> V_49 . V_54 ,
V_48 -> V_52 ,
V_2 -> V_51 , 0 ,
& V_55 , V_2 ) ;
if ( ! V_2 -> V_30 ) {
F_37 ( V_2 -> V_51 , V_48 -> V_52 ) ;
return - V_56 ;
}
return 0 ;
}
...
static int T_3 F_39 ( struct V_45 * V_46 )
{
struct V_47 * V_48 = V_46 -> V_49 . V_50 ;
struct V_1 * V_2 ;
...
struct V_33 * V_33 ;
struct V_10 * V_10 ;
const char * V_59 = F_40 ( & V_46 -> V_49 ) ;
int V_60 ;
V_2 = F_41 ( sizeof( * V_2 ) , V_61 ) ;
if ( ! V_2 ) {
F_35 ( & V_46 -> V_49 , L_5 ) ;
V_60 = - V_62 ;
goto V_63;
...
F_42 ( V_46 , V_2 ) ;
F_43 ( & V_2 -> V_22 ) ;
V_58 [ 0 ] = F_44 ( V_46 , V_64 , 0 ) ;
V_58 [ 1 ] = F_44 ( V_46 , V_64 , 1 ) ;
V_25 [ 0 ] = F_44 ( V_46 , V_65 , 0 ) ;
V_25 [ 1 ] = F_44 ( V_46 , V_65 , 1 ) ;
if ( ! V_58 [ 0 ] || ! V_58 [ 1 ] || ! V_25 [ 0 ] || ! V_25 [ 1 ] || ! V_48 ) {
F_35 ( & V_46 -> V_49 , L_6 ) ;
V_60 = - V_21 ;
goto V_66;
}
V_2 -> V_5 = F_45 ( V_58 [ 0 ] -> V_67 , F_46 ( V_58 [ 0 ] ) ) ;
if ( ! V_2 -> V_5 ) {
F_35 ( & V_46 -> V_49 , L_7 ) ;
V_60 = - V_56 ;
goto V_66;
}
V_2 -> V_6 = F_45 ( V_58 [ 1 ] -> V_67 , F_46 ( V_58 [ 1 ] ) ) ;
if ( ! V_2 -> V_6 ) {
F_35 ( & V_46 -> V_49 , L_8 ) ;
V_60 = - V_56 ;
goto V_68;
...
if ( F_47 ( V_25 [ 0 ] -> V_67 , F_17 , 0 , V_59 , V_2 ) ) {
F_35 ( & V_46 -> V_49 , L_10 ) ;
V_60 = - V_86 ;
goto V_87;
}
if ( F_47 ( V_25 [ 1 ] -> V_67 , F_17 , 0 , V_59 , V_2 ) ) {
F_35 ( & V_46 -> V_49 , L_11 ) ;
V_60 = - V_86 ;
goto V_88;
}
...
return 0 ;
V_89:
F_49 ( V_25 [ 1 ] -> V_67 , V_46 ) ;
V_88:
F_49 ( V_25 [ 0 ] -> V_67 , V_46 ) ;
V_87:
F_38 ( V_2 ) ;
V_85:
F_50 ( V_2 -> V_6 ) ;
...
static int T_4 F_52 ( struct V_45 * V_46 )
{
