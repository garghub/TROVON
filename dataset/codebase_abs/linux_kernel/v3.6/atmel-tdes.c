...
for ( V_139 = 0 ; V_139 < F_79 ( V_140 ) ; V_139 ++ ) {
F_82 ( & V_140 [ V_139 ] . V_142 ) ;
V_26 = F_83 ( & V_140 [ V_139 ] ) ;
if ( V_26 )
goto V_143;
}
return 0 ;
...
static int T_5 F_84 ( struct V_144 * V_145 )
{
struct V_11 * V_17 ;
struct V_146 * V_60 = & V_145 -> V_60 ;
struct V_147 * V_148 ;
unsigned long V_149 ;
int V_26 ;
V_17 = F_85 ( sizeof( struct V_11 ) , V_72 ) ;
if ( V_17 == NULL ) {
F_23 ( V_60 , L_13 ) ;
V_26 = - V_70 ;
goto V_150;
...
( unsigned long ) V_17 ) ;
F_88 ( & V_17 -> V_107 , V_152 ) ;
V_17 -> V_130 = - 1 ;
V_148 = F_89 ( V_145 , V_153 , 0 ) ;
if ( ! V_148 ) {
F_23 ( V_60 , L_14 ) ;
V_26 = - V_118 ;
goto V_154;
}
V_17 -> V_155 = V_148 -> V_156 ;
V_149 = F_90 ( V_148 ) ;
V_17 -> V_130 = F_91 ( V_145 , 0 ) ;
if ( V_17 -> V_130 < 0 ) {
F_23 ( V_60 , L_15 ) ;
V_26 = V_17 -> V_130 ;
goto V_154;
}
V_26 = F_92 ( V_17 -> V_130 , F_76 , V_157 ,
L_16 , V_17 ) ;
if ( V_26 ) {
F_23 ( V_60 , L_17 ) ;
goto V_158;
}
V_17 -> V_21 = F_93 ( & V_145 -> V_60 , NULL ) ;
if ( F_94 ( V_17 -> V_21 ) ) {
F_23 ( V_60 , L_18 ) ;
V_26 = F_95 ( V_17 -> V_21 ) ;
goto V_159;
}
V_17 -> V_13 = F_96 ( V_17 -> V_155 , V_149 ) ;
if ( ! V_17 -> V_13 ) {
F_23 ( V_60 , L_19 ) ;
V_26 = - V_70 ;
goto V_160;
...
static int T_6 F_107 ( struct V_144 * V_145 )
{
