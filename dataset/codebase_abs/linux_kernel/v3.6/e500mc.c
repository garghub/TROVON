...
V_2 -> V_15 . V_38 |= V_81 ;
#endif
V_2 -> V_15 . V_41 = V_82 | V_83 | V_84 ;
V_2 -> V_15 . V_43 = V_85 | ( V_2 -> V_14 -> V_15 . V_16 << V_86 ) ;
V_2 -> V_15 . V_45 = V_2 -> V_15 . V_43 ;
V_2 -> V_15 . V_87 = F_12 ( V_88 ) ;
V_19 -> V_89 = F_12 ( V_90 ) ;
V_2 -> V_15 . V_91 = V_92 ;
return 0 ;
}
void F_27 ( struct V_1 * V_2 , struct V_93 * V_94 )
{
struct V_18 * V_19 = F_19 ( V_2 ) ;
V_94 -> V_95 . V_96 . V_97 |= V_98 | V_99 |
V_100 ;
V_94 -> V_95 . V_96 . V_101 = V_102 ;
V_94 -> V_95 . V_96 . V_103 . V_104 . V_97 = 0 ;
V_94 -> V_95 . V_96 . V_103 . V_104 . V_89 = V_19 -> V_89 ;
V_94 -> V_95 . V_96 . V_103 . V_104 . V_105 = V_19 -> V_105 ;
V_94 -> V_95 . V_96 . V_103 . V_104 . V_106 = V_19 -> V_106 ;
F_28 ( V_2 , V_94 ) ;
V_94 -> V_95 . V_96 . V_107 [ 3 ] =
V_2 -> V_15 . V_49 [ V_108 ] ;
V_94 -> V_95 . V_96 . V_107 [ 4 ] = V_2 -> V_15 . V_49 [ V_109 ] ;
V_94 -> V_95 . V_96 . V_107 [ 5 ] = V_2 -> V_15 . V_49 [ V_110 ] ;
F_29 ( V_2 , V_94 ) ;
}
int F_30 ( struct V_1 * V_2 , struct V_93 * V_94 )
{
struct V_18 * V_19 = F_19 ( V_2 ) ;
int V_111 ;
if ( V_94 -> V_95 . V_96 . V_101 == V_102 ) {
V_19 -> V_89 = V_94 -> V_95 . V_96 . V_103 . V_104 . V_89 ;
V_19 -> V_105 = V_94 -> V_95 . V_96 . V_103 . V_104 . V_105 ;
V_19 -> V_106 = V_94 -> V_95 . V_96 . V_103 . V_104 . V_106 ;
}
V_111 = F_31 ( V_2 , V_94 ) ;
if ( V_111 < 0 )
return V_111 ;
if ( ! ( V_94 -> V_95 . V_96 . V_97 & V_112 ) )
return 0 ;
if ( V_94 -> V_95 . V_96 . V_97 & V_99 ) {
V_2 -> V_15 . V_49 [ V_108 ] =
V_94 -> V_95 . V_96 . V_107 [ 3 ] ;
}
if ( V_94 -> V_95 . V_96 . V_97 & V_100 ) {
V_2 -> V_15 . V_49 [ V_109 ] =
V_94 -> V_95 . V_96 . V_107 [ 4 ] ;
V_2 -> V_15 . V_49 [ V_110 ] =
V_94 -> V_95 . V_96 . V_107 [ 5 ] ;
}
return F_32 ( V_2 , V_94 ) ;
}
struct V_1 * F_33 ( struct V_14 * V_14 , unsigned int V_113 )
{
struct V_18 * V_19 ;
struct V_1 * V_2 ;
int V_114 ;
V_19 = F_34 ( V_115 , V_116 ) ;
if ( ! V_19 ) {
V_114 = - V_117 ;
goto V_118;
}
...
V_114 = F_35 ( V_2 , V_14 , V_113 ) ;
if ( V_114 )
goto V_119;
V_114 = F_36 ( V_19 ) ;
if ( V_114 )
goto V_120;
V_2 -> V_15 . V_54 = ( void * ) F_37 ( V_116 | V_121 ) ;
if ( ! V_2 -> V_15 . V_54 )
goto V_122;
return V_2 ;
V_122:
...
{
struct V_18 * V_19 = F_19 ( V_2 ) ;
F_43 ( ( unsigned long ) V_2 -> V_15 . V_54 ) ;
F_38 ( V_19 ) ;
F_39 ( V_2 ) ;
F_40 ( V_115 , V_19 ) ;
}
int F_44 ( struct V_14 * V_14 )
{
int V_16 ;
V_16 = F_45 () ;
if ( V_16 < 0 )
...
F_50 ( 64 ) ;
F_51 ( 0 ) ;
return F_52 ( NULL , sizeof( struct V_18 ) , 0 , V_123 ) ;
}
