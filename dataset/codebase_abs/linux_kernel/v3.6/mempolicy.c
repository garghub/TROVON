...
return F_149 ( V_10 , V_62 , V_167 ) ;
} else
return F_145 ( V_10 ) ;
}
int F_152 ( const T_1 * V_172 )
{
int V_32 , V_173 = - 1 ;
V_32 = F_7 ( * V_172 ) ;
if ( V_32 )
V_173 = F_153 ( V_172 -> V_174 ,
F_154 () % V_32 , V_51 ) ;
return V_173 ;
}
struct V_161 * F_155 ( struct V_61 * V_62 , unsigned long V_68 ,
...
V_177 = F_144 ( F_150 ( * V_176 , V_62 , V_68 ,
F_156 ( F_157 ( V_62 ) ) ) , V_175 ) ;
} else {
...
case V_113 :
case V_111 :
V_13 = F_161 ( V_9 -> V_19 . V_17 , * V_150 ) ;
break;
default:
F_30 () ;
}
...
static struct V_75 * F_162 ( T_11 V_160 , unsigned V_178 ,
unsigned V_76 )
{
struct V_161 * V_177 ;
struct V_75 * V_75 ;
V_177 = F_144 ( V_76 , V_160 ) ;
V_75 = F_163 ( V_160 , V_178 , V_177 ) ;
if ( V_75 && F_164 ( V_75 ) == F_165 ( & V_177 -> V_179 [ 0 ] ) )
F_101 ( V_75 , V_180 ) ;
return V_75 ;
}
struct V_75 *
F_166 ( T_11 V_160 , int V_178 , struct V_61 * V_62 ,
...
unsigned V_76 ;
V_76 = F_150 ( V_10 , V_62 , V_68 , V_101 + V_178 ) ;
F_97 ( V_10 ) ;
V_75 = F_162 ( V_160 , V_178 , V_76 ) ;
if ( F_140 ( ! F_168 ( V_181 ) && ! V_75 ) )
goto V_182;
return V_75 ;
}
V_177 = F_143 ( V_160 , V_10 , V_52 ) ;
if ( F_140 ( F_169 ( V_10 ) ) ) {
struct V_75 * V_75 = F_170 ( V_160 , V_178 ,
...
V_75 = F_170 ( V_160 , V_178 , V_177 ,
F_139 ( V_160 , V_10 ) ) ;
if ( F_140 ( ! F_168 ( V_181 ) && ! V_75 ) )
goto V_182;
return V_75 ;
}
struct V_75 * F_171 ( T_11 V_160 , unsigned V_178 )
{
struct V_9 * V_10 = V_49 -> V_9 ;
struct V_75 * V_75 ;
unsigned int V_181 ;
if ( ! V_10 || F_147 () || ( V_160 & V_162 ) )
V_10 = & V_112 ;
V_182:
V_181 = F_167 () ;
if ( V_10 -> V_28 == V_111 )
V_75 = F_162 ( V_160 , V_178 , F_145 ( V_10 ) ) ;
else
V_75 = F_170 ( V_160 , V_178 ,
