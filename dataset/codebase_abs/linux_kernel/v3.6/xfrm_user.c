...
F_153 ( V_247 , V_26 -> V_230 , V_80 -> V_303 , V_147 -> V_153 ) ;
V_45:
F_123 ( V_247 ) ;
return V_39 ;
}
...
if ( V_88 -> V_130 . V_137 != V_300 )
goto V_45;
F_155 ( V_88 , V_305 -> V_303 , V_147 -> V_153 ) ;
if ( V_305 -> V_303 ) {
T_3 V_146 = F_41 ( V_147 ) ;
T_4 V_148 = F_42 ( V_147 ) ;
T_4 V_149 ;
...
if ( V_140 == NULL )
return - V_68 ;
if ( F_186 ( V_140 , V_88 , V_375 , V_247 , V_230 ) < 0 )
F_88 () ;
...
V_214 = F_204 ( V_114 , V_409 , V_410 , & V_405 ) ;
if ( V_214 == NULL )
return - V_68 ;
