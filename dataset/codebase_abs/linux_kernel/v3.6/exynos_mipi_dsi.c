...
struct V_29 * F_25 ( struct V_13 * V_38 )
{
...
struct V_29 * F_31 ( struct V_6 * V_7 ,
const char * V_31 )
{
struct V_29 * V_30 , * V_39 ;
struct V_13 * V_38 ;
...
F_20 ( V_7 -> clock ) ;
V_46 = F_42 ( V_3 , V_52 , 0 ) ;
if ( ! V_46 ) {
F_35 ( & V_3 -> V_4 , L_16 ) ;
goto V_53;
}
V_7 -> V_46 = F_43 ( V_46 -> V_54 , F_44 ( V_46 ) ,
F_36 ( & V_3 -> V_4 ) ) ;
if ( ! V_7 -> V_46 ) {
F_35 ( & V_3 -> V_4 , L_17 ) ;
V_8 = - V_34 ;
...
V_7 -> V_56 = F_45 ( V_46 -> V_54 , F_44 ( V_46 ) ) ;
if ( ! V_7 -> V_56 ) {
F_35 ( & V_3 -> V_4 , L_18 ) ;
V_8 = - V_34 ;
goto V_57;
...
F_47 ( & V_63 ) ;
F_48 ( V_3 , V_7 ) ;
V_8 = F_49 ( V_7 -> V_60 , V_64 ,
V_65 , F_36 ( & V_3 -> V_4 ) , V_7 ) ;
if ( V_8 != 0 ) {
F_35 ( & V_3 -> V_4 , L_20 ) ;
V_8 = - V_49 ;
goto V_59;
...
V_68:
F_48 ( V_3 , V_7 ) ;
F_32 ( & V_3 -> V_4 , L_21 , V_69 ,
V_11 -> V_70 == V_71 ? L_22 : L_23 ) ;
return 0 ;
V_59:
F_50 ( V_7 -> V_56 ) ;
V_57:
F_51 ( V_7 -> V_46 -> V_54 , F_44 ( V_7 -> V_46 ) ) ;
V_55:
F_52 ( V_7 -> V_46 ) ;
V_53:
F_17 ( V_7 -> clock ) ;
...
static int F_57 ( struct V_72 * V_4 )
{
...
static int F_59 ( struct V_72 * V_4 )
{
struct V_2 * V_3 = F_19 ( V_4 ) ;
struct V_6 * V_7 = F_55 ( V_3 ) ;
struct V_13 * V_14 = V_7 -> V_15 ;
