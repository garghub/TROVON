...
const char * V_25 ;
T_1 V_26 ;
V_11 = F_4 ( V_5 , V_6 , sizeof( V_24 ) , & V_11 ) ;
F_8 ( V_11 == NULL ) ;
...
V_32:
if ( F_9 ( V_2 , V_44 ) )
F_10 ( F_11 ( V_21 ) , 0 , V_5 , NULL , NULL , NULL , V_25 ) ;
return false ;
}
...
F_24 ( & V_21 -> V_63 ) ;
if ( F_9 ( V_2 , V_44 ) )
F_10 ( V_52 , 0 , V_5 , NULL , NULL , NULL ,
L_3 ) ;
return V_62 ;
case V_34 :
F_24 ( & V_21 -> V_63 ) ;
...
V_32:
if ( F_9 ( V_2 , V_44 ) )
F_10 ( V_52 , 0 , V_5 , NULL , NULL , NULL , V_25 ) ;
return - V_62 ;
}
static int F_29 ( struct V_81 * V_82 ,
const struct V_7 * V_8 )
{
return F_30 ( V_82 , L_9 ,
F_14 ( V_8 -> V_12 . V_13 . V_14 . V_15 ) ,
F_14 ( V_8 -> V_17 . V_13 . V_14 . V_15 ) ) ;
}
static int F_31 ( struct V_81 * V_82 , struct V_20 * V_21 )
{
return F_30 ( V_82 , L_10 , V_83 [ V_21 -> V_35 . V_14 . V_26 ] ) ;
}
...
if ( ! V_109 -> V_117 ) {
V_23 -> V_31 = 1 ;
V_23 -> V_49 [ V_33 ] = 2 * V_118 ;
V_23 -> V_49 [ V_65 ] = 4 * V_118 ;
V_23 -> V_49 [ V_66 ] = 4 * V_118 ;
V_23 -> V_49 [ V_114 ] = 12 * 3600 * V_106 ;
V_23 -> V_49 [ V_115 ] = 64 * V_106 ;
V_23 -> V_49 [ V_116 ] = 64 * V_106 ;
V_23 -> V_49 [ V_64 ] = 2 * V_118 ;
}
return F_51 ( V_109 , V_23 ) ;
}
