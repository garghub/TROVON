...
V_2 -> V_34 . V_111 = 0 ;
if ( V_2 -> V_18 >= V_20 )
V_2 -> V_34 . V_110 = V_131 ;
else
V_2 -> V_34 . V_110 = V_132 ;
...
V_122 += V_134 * 4 ;
V_122 = F_2 ( V_122 , 256 ) ;
if ( V_2 -> V_34 . V_135 == NULL ) {
V_123 = F_53 ( V_2 , V_122 , V_136 , true ,
V_137 ,
NULL , & V_2 -> V_34 . V_135 ) ;
if ( V_123 ) {
F_54 ( L_1 ) ;
...
V_123 = F_55 ( V_2 -> V_34 . V_135 , false ) ;
if ( F_56 ( V_123 != 0 ) )
return V_123 ;
V_123 = F_57 ( V_2 -> V_34 . V_135 , V_137 ,
& V_2 -> V_34 . V_35 ) ;
F_58 ( V_2 -> V_34 . V_135 ) ;
if ( V_123 ) {
F_59 ( V_2 -> V_138 , L_2 , V_123 ) ;
return V_123 ;
}
}
F_60 ( L_3 ,
...
static unsigned F_68 ( unsigned V_146 ,
int * V_147 , int * V_148 , int V_130 )
{
unsigned V_149 ;
...
int F_71 ( struct V_1 * V_2 , unsigned V_146 ,
struct V_154 * * V_155 , struct V_156 * * V_157 ,
struct V_158 * * V_159 )
{
struct V_7 * V_8 = & V_2 -> V_8 [ V_9 ] ;
int V_123 ;
...
while ( V_146 ) {
V_146 -=
F_68 ( V_146 , NULL , NULL ,
V_2 -> V_34 . V_130 ) ;
V_161 ++ ;
}
V_123 = F_72 ( V_2 , & V_2 -> V_163 , V_157 ,
( V_161 * 48 ) + 256 , 256 , true ) ;
if ( V_123 ) {
return V_123 ;
}
V_123 = F_73 ( V_2 , V_159 ) ;
if ( V_123 ) {
F_74 ( V_2 , V_157 , NULL ) ;
return V_123 ;
}
...
void F_80 ( struct V_1 * V_2 , struct V_154 * * V_155 ,
struct V_156 * V_157 , struct V_158 * V_159 )
{
struct V_7 * V_8 = & V_2 -> V_8 [ V_9 ] ;
int V_123 ;
V_123 = F_81 ( V_2 , V_155 , V_9 ) ;
if ( V_123 ) {
F_82 ( V_2 , V_8 ) ;
return;
}
F_83 ( V_2 , V_8 ) ;
F_74 ( V_2 , & V_157 , * V_155 ) ;
F_76 ( V_2 , & V_159 , * V_155 ) ;
}
