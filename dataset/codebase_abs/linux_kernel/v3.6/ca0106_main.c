...
static int F_109 ( struct V_155 * V_225 )
{
struct V_227 * V_153 = F_110 ( V_225 ) ;
struct V_226 * V_147 = F_111 ( V_225 ) ;
struct V_1 * V_37 = V_147 -> V_36 ;
int V_93 ;
F_112 ( V_147 , V_283 ) ;
for ( V_93 = 0 ; V_93 < 4 ; V_93 ++ )
F_113 ( V_37 -> V_173 [ V_93 ] ) ;
if ( V_37 -> V_43 -> V_137 )
F_114 ( V_37 -> V_137 ) ;
F_115 ( V_37 ) ;
F_60 ( V_37 ) ;
...
static int F_118 ( struct V_155 * V_225 )
{
struct V_227 * V_153 = F_110 ( V_225 ) ;
struct V_226 * V_147 = F_111 ( V_225 ) ;
struct V_1 * V_37 = V_147 -> V_36 ;
