...
{
struct V_21 * V_22 = V_82 -> V_83 -> V_84 ;
struct V_85 * V_86 = F_15 ( V_20 ) ;
T_1 * V_9 = V_22 -> V_27 ;
struct V_87 V_88 ;
struct V_89 V_90 ;
struct V_91 * V_92 ;
...
V_88 . V_16 = V_101 ;
V_88 . V_102 . V_11 = V_103 ;
memset ( & V_88 . V_104 . V_11 . V_11 , 0xFF , sizeof( V_88 . V_104 . V_11 . V_11 ) ) ;
V_88 . V_104 . V_11 . V_19 = 6 ;
if ( V_82 -> V_105 > 0 ) {
V_88 . V_106 . V_11 = V_107 ;
V_88 . V_108 . V_11 . V_19 = V_82 -> V_109 -> V_110 ;
memcpy ( V_88 . V_108 . V_11 . V_11 ,
...
V_88 . V_111 . V_11 = 0 ;
for ( V_94 = 0 ;
( V_94 < V_82 -> V_112 ) && V_94 < F_16 ( V_113 ) ;
V_94 ++ )
V_88 . V_114 . V_11 . V_11 [ V_94 ] =
F_17 ( V_82 -> V_115 [ V_94 ] -> V_116 ) ;
V_88 . V_114 . V_11 . V_19 = V_82 -> V_112 ;
V_88 . V_117 . V_11 = 250 ;
V_88 . V_118 . V_11 = 200 ;
...
V_90 . V_16 = V_120 ;
V_90 . V_121 . V_11 = V_94 ;
V_28 = F_3 ( V_9 , ( V_18 * ) & V_90 ) ;
if ( ( V_28 != 0 ) ||
( V_90 . V_119 . V_11 != V_122 ) ) {
break;
}
V_95 [ 0 ] = V_123 ;
V_95 [ 1 ] = V_90 . V_108 . V_11 . V_19 ;
V_96 = V_95 [ 1 ] + 2 ;
memcpy ( & V_95 [ 2 ] , & ( V_90 . V_108 . V_11 . V_11 ) , V_90 . V_108 . V_11 . V_19 ) ;
V_92 = F_18 ( V_20 ,
F_19 ( V_20 , F_20 ( V_90 . V_124 . V_11 ) ) ,
( const V_18 * ) & ( V_90 . V_104 . V_11 . V_11 ) ,
V_90 . V_125 . V_11 , V_90 . V_126 . V_11 ,
V_90 . V_127 . V_11 ,
V_95 ,
V_96 ,
( V_90 . signal . V_11 - 65536 ) * 100 ,
V_128
) ;
if ( ! V_92 ) {
V_2 = - V_129 ;
...
T_5 V_71 = V_169 ?
V_170 : V_171 ;
F_32 ( V_9 -> V_84 , V_9 -> V_104 ,
NULL , 0 , NULL , 0 , V_71 , V_128 ) ;
}
void F_33 ( T_1 * V_9 )
{
F_34 ( V_9 -> V_84 , 0 , NULL ,
0 , V_128 ) ;
}
void F_35 ( T_1 * V_9 )
{
F_36 ( V_9 -> V_84 , NULL , V_9 -> V_104 ,
NULL , 0 , NULL , 0 , V_128 ) ;
}
...
struct V_20 * V_20 ;
struct V_85 * V_86 ;
V_20 = F_38 ( & V_173 , sizeof( * V_86 ) ) ;
if ( ! V_20 )
return NULL ;
V_86 = F_15 ( V_20 ) ;
V_86 -> V_9 = V_9 ;
memcpy ( V_86 -> V_115 , V_113 , sizeof( V_113 ) ) ;
memcpy ( V_86 -> V_174 , V_175 , sizeof( V_175 ) ) ;
V_86 -> V_176 . V_115 = V_86 -> V_115 ;
V_86 -> V_176 . V_112 = F_16 ( V_113 ) ;
V_86 -> V_176 . V_177 = V_86 -> V_174 ;
V_86 -> V_176 . V_178 = F_16 ( V_175 ) ;
V_86 -> V_176 . V_176 = V_179 ;
V_86 -> V_176 . V_180 . V_181 = false ;
V_20 -> V_182 [ V_179 ] = & V_86 -> V_176 ;
F_39 ( V_20 , V_22 ) ;
V_20 -> V_183 = V_184 ;
V_20 -> V_185 = 1 ;
