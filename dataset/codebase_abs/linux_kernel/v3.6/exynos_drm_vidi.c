...
return - V_101 ;
if ( ! V_4 -> V_10 )
V_4 -> V_10 = (struct V_8 * ) V_107 ;
if ( V_4 -> V_10 != (struct V_8 * ) V_107 ) {
F_3 ( L_14 ) ;
return - V_101 ;
}
F_3 ( L_15 ) ;
...
int F_45 ( struct V_71 * V_72 , void * V_108 ,
struct V_109 * V_92 )
{
struct V_3 * V_4 = NULL ;
struct V_110 * V_111 ;
...
V_10 = (struct V_8 * ) ( V_119 ) V_115 -> V_8 ;
V_116 = ( 1 + V_10 -> V_14 ) * V_15 ;
V_4 -> V_10 = F_5 ( V_116 , V_12 ) ;
if ( ! V_4 -> V_10 ) {
F_3 ( L_3 ) ;
return - V_13 ;
}
memcpy ( V_4 -> V_10 , V_10 , V_116 ) ;
} else {
...
int V_106 ;
F_3 ( L_1 , __FILE__ ) ;
V_4 = F_50 ( & V_121 -> V_2 , sizeof( * V_4 ) , V_12 ) ;
if ( ! V_4 )
return - V_13 ;
V_4 -> V_51 = 0 ;
F_51 ( & V_4 -> V_70 , F_34 ) ;
