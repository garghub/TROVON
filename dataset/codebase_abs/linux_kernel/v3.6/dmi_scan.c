...
static int T_1 F_11 ( const T_2 * V_11 )
{
T_2 V_19 = 0 ;
int V_20 ;
...
static void T_1 F_15 ( int type , const char * V_28 )
{
struct V_29 * V_30 ;
if ( F_16 ( type , V_28 , NULL ) )
return;
...
static void T_1 F_22 ( int V_38 , int V_39 , int V_40 ,
...
if ( ( * V_22 & 0x80 ) == 0 )
return;
F_22 ( * ( V_22 + 1 ) , * ( V_45 * ) ( V_22 + 2 ) , * ( V_22 + 4 ) , * ( V_22 + 5 ) ,
F_1 ( V_2 , * ( V_22 - 1 ) ) ) ;
F_15 ( * V_22 & 0x7f , F_1 ( V_2 , * ( V_22 - 1 ) ) ) ;
}
...
static void T_1 F_25 ( const char * V_65 )
{
const char * V_23 ;
if ( ! V_65 )
return;
...
T_2 V_11 [ 15 ] ;
F_29 ( V_11 , V_23 , 15 ) ;
if ( ( memcmp ( V_11 , L_17 , 5 ) == 0 ) && F_11 ( V_11 ) ) {
...
static bool F_31 ( const struct V_79 * V_80 )
{
int V_15 ;
F_32 ( ! V_78 , V_10 L_21 ) ;
for ( V_15 = 0 ; V_15 < F_33 ( V_80 -> V_81 ) ; V_15 ++ ) {
...
static bool F_34 ( const struct V_79 * V_80 )
{
return V_80 -> V_81 [ 0 ] . V_21 == V_82 ;
}
int F_35 ( const struct V_79 * V_32 )
{
int V_34 = 0 ;
const struct V_79 * V_22 ;
for ( V_22 = V_32 ; ! F_34 ( V_22 ) ; V_22 ++ )
if ( F_31 ( V_22 ) ) {
V_34 ++ ;
...
const struct V_79 * F_36 ( const struct V_79 * V_32 )
{
const struct V_79 * V_22 ;
for ( V_22 = V_32 ; ! F_34 ( V_22 ) ; V_22 ++ )
if ( F_31 ( V_22 ) )
...
int F_38 ( const char * V_9 )
{
static int V_87 [] = { V_50 , V_55 , V_82 } ;
int V_15 ;
...
const struct V_29 * F_16 ( int type , const char * V_28 ,
...
bool F_40 ( int V_85 , int * V_93 , int * V_94 , int * V_95 )
{
...
if ( V_96 > 9999 )
V_96 = 0 ;
V_97 = F_41 ( V_3 , & V_101 , 10 ) ;
if ( V_3 == V_101 || * V_101 != '/' || ! V_97 || V_97 > 12 ) {
V_97 = 0 ;
goto V_77;
}
V_3 = V_101 + 1 ;
V_98 = F_41 ( V_3 , & V_101 , 10 ) ;
...
int F_42 ( void (* F_6)( const struct V_1 * , void * ) ,
void * V_13 )
{
T_2 * V_11 ;
if ( ! V_76 )
...
bool F_45 ( enum V_102 V_86 , const char * V_9 )
{
const char * V_65 = F_27 ( V_86 ) ;
