...
int F_42 ( struct V_26 * V_12 , void * V_37 )
{
struct V_40 * V_41 = V_12 -> V_41 ;
unsigned long V_9 ;
int V_30 = 0 ;
...
F_10 ( & V_12 -> V_17 , V_9 ) ;
if ( ! V_12 -> V_42 && ( V_12 -> V_29 [ 0 ] . V_43 || V_12 -> V_38 ) )
F_41 ( V_41 -> V_44 ) ;
F_11 ( & V_12 -> V_17 , V_9 ) ;
return 0 ;
}
...
int F_72 ( struct V_26 * V_12 , T_8 V_9 ,
unsigned V_74 , unsigned V_70 , unsigned V_71 ,
void * V_13 )
{
int (* F_73)( struct V_26 * V_12 , unsigned V_74 ,
...
if ( ! F_73 )
return - V_78 ;
return F_73 ( V_12 , V_74 , V_70 , V_71 , V_9 , V_13 ) ;
}
