...
V_39 = V_4 -> V_6 -> V_177 ( V_2 , V_4 , V_135 -> V_131 [ 0 ] ) ;
if ( V_39 >= 0 )
V_39 = 1 ;
break;
default:
...
unsigned int V_88 ;
if ( V_135 -> V_113 >= V_2 -> V_60 ) {
F_2 ( L_18 , V_135 -> V_113 ) ;
V_39 = - V_15 ;
goto V_179;
}
V_4 = V_2 -> V_20 + V_135 -> V_113 ;
if ( V_4 -> type == V_180 ) {
F_2 ( L_14 , V_135 -> V_113 ) ;
V_39 = - V_181 ;
goto V_179;
}
if ( V_4 -> V_95 && V_4 -> V_95 != V_64 ) {
...
switch ( V_135 -> V_135 ) {
case V_183 :
V_39 = V_4 -> V_184 ( V_2 , V_4 , V_135 , V_131 ) ;
break;
case V_185 :
V_88 = V_4 -> V_98
? V_4 -> V_98 [ F_58 ( V_135 -> V_182 ) ]
: V_4 -> V_88 ;
...
if ( V_39 == 0 )
V_39 = V_4 -> V_186 ( V_2 , V_4 , V_135 , V_131 ) ;
break;
case V_187 :
if ( V_135 -> V_134 != 2 ) {
V_39 = - V_15 ;
...
if ( V_39 )
break;
V_39 = V_4 -> V_191 ( V_2 , V_4 , V_135 , V_131 ) ;
break;
default:
V_39 = - V_15 ;
break;
...
F_61 ( & V_4 -> V_194 , V_92 ) ;
V_4 -> V_195 &= ~ V_192 ;
V_4 -> V_195 |= ( V_193 & V_192 ) ;
F_62 ( & V_4 -> V_194 , V_92 ) ;
}
static int F_63 ( struct V_1 * V_2 ,
struct V_196 T_3 * V_197 , void * V_64 )
{
struct V_196 V_198 ;
struct V_3 * V_4 ;
struct V_5 * V_6 ;
int V_39 = 0 ;
unsigned int T_3 * V_199 = NULL ;
if ( F_23 ( & V_198 , V_197 , sizeof( struct V_196 ) ) ) {
F_2 ( L_22 ) ;
return - V_47 ;
}
V_199 = V_198 . V_200 ;
if ( V_198 . V_113 >= V_2 -> V_60 ) {
F_2 ( L_23 , V_198 . V_113 ) ;
return - V_201 ;
}
V_4 = V_2 -> V_20 + V_198 . V_113 ;
V_6 = V_4 -> V_6 ;
if ( V_4 -> type == V_180 ) {
F_2 ( L_24 , V_198 . V_113 ) ;
return - V_181 ;
}
if ( ! V_4 -> V_104 || ! V_4 -> V_202 || ! V_4 -> V_6 ) {
F_2 ( L_25 ,
V_198 . V_113 ) ;
return - V_181 ;
}
...
V_4 -> V_11 = V_64 ;
if ( V_198 . V_203 > V_4 -> V_87 ) {
F_2 ( L_28 ,
V_198 . V_203 , V_4 -> V_87 ) ;
V_39 = - V_15 ;
goto V_204;
}
if ( V_198 . V_203 < 1 ) {
...
F_39 ( V_6 -> V_197 . V_200 ) ;
V_6 -> V_197 = V_198 ;
V_6 -> V_197 . V_131 = NULL ;
V_6 -> V_197 . V_200 =
F_49 ( V_6 -> V_197 . V_203 * sizeof( int ) , V_81 ) ;
if ( ! V_6 -> V_197 . V_200 ) {
F_2 ( L_30 ) ;
V_39 = - V_53 ;
goto V_204;
}
if ( F_23 ( V_6 -> V_197 . V_200 , V_198 . V_200 ,
V_6 -> V_197 . V_203 * sizeof( int ) ) ) {
F_2 ( L_31 ) ;
V_39 = - V_47 ;
goto V_204;
}
...
V_39 = V_4 -> V_202 ( V_2 , V_4 , & V_6 -> V_197 ) ;
if ( V_6 -> V_197 . V_92 & V_205 || V_39 ) {
F_2 ( L_33 , V_39 ) ;
V_198 = V_6 -> V_197 ;
V_198 . V_200 = V_199 ;
V_198 . V_131 = NULL ;
if ( F_30 ( V_197 , & V_198 , sizeof( struct V_196 ) ) ) {
F_2 ( L_34 ) ;
V_39 = - V_47 ;
goto V_204;
}
...
V_207 | V_208 | V_209 |
V_210 ;
if ( V_6 -> V_197 . V_92 & V_211 )
V_6 -> V_206 |= V_212 ;
F_60 ( V_4 , ~ 0 , V_213 | V_84 ) ;
...
struct V_196 T_3 * V_37 , void * V_64 )
{
struct V_196 V_198 ;
struct V_3 * V_4 ;
int V_39 = 0 ;
unsigned int * V_200 = NULL ;
unsigned int T_3 * V_199 = NULL ;
if ( F_23 ( & V_198 , V_37 , sizeof( struct V_196 ) ) ) {
F_2 ( L_22 ) ;
return - V_47 ;
}
V_199 = V_198 . V_200 ;
...
if ( V_198 . V_200 ) {
V_200 =
F_49 ( V_198 . V_203 * sizeof( int ) , V_81 ) ;
if ( ! V_200 ) {
F_2 ( L_30 ) ;
V_39 = - V_53 ;
goto V_204;
}
if ( F_23 ( V_200 , V_198 . V_200 ,
V_198 . V_203 * sizeof( int ) ) ) {
F_2 ( L_31 ) ;
V_39 = - V_47 ;
goto V_204;
}
V_39 = F_57 ( V_4 , V_198 . V_203 , V_200 ) ;
if ( V_39 < 0 ) {
F_2 ( L_32 ) ;
goto V_204;
}
...
V_39 = V_4 -> V_202 ( V_2 , V_4 , & V_198 ) ;
V_198 . V_200 = V_199 ;
if ( F_30 ( V_37 , & V_198 , sizeof( struct V_196 ) ) ) {
F_2 ( L_22 ) ;
V_39 = - V_47 ;
goto V_204;
}
...
return - V_12 ;
if ( V_4 -> V_214 )
return V_4 -> V_214 ( V_2 , V_4 ) ;
return - V_15 ;
}
static long F_71 ( struct V_64 * V_64 , unsigned int V_197 ,
unsigned long V_37 )
{
const unsigned V_19 = F_32 ( V_64 -> V_66 -> V_67 ) ;
struct V_26 * V_68 =
...
break;
case V_219 :
V_215 = F_31 ( V_2 , (struct V_63 T_3 * ) V_37 ,
V_64 ) ;
break;
case V_220 :
V_215 = F_35 ( V_2 ,
...
break;
case V_221 :
V_215 = F_40 ( V_2 , ( void T_3 * ) V_37 ) ;
break;
case V_222 :
V_215 = F_72 ( V_2 , ( void T_3 * ) V_37 ) ;
break;
case V_223 :
V_215 = F_42 ( V_2 ,
...
break;
case V_224 :
V_215 = F_66 ( V_2 , V_37 , V_64 ) ;
break;
case V_225 :
V_215 = F_67 ( V_2 , V_37 , V_64 ) ;
break;
case V_226 :
V_215 = F_68 ( V_2 , V_37 , V_64 ) ;
break;
case V_227 :
V_215 = F_63 ( V_2 , (struct V_196 T_3 * ) V_37 , V_64 ) ;
break;
case V_228 :
V_215 = F_65 ( V_2 , (struct V_196 T_3 * ) V_37 ,
V_64 ) ;
break;
case V_229 :
V_215 = F_48 ( V_2 ,
...
break;
case V_230 :
V_215 = F_59 ( V_2 , (struct V_129 T_3 * ) V_37 ,
V_64 ) ;
break;
case V_231 :
V_215 = F_70 ( V_2 , V_37 , V_64 ) ;
break;
default:
V_215 = - V_232 ;
break;
...
{
int V_39 = 0 ;
if ( ( F_37 ( V_4 ) & V_84 ) && V_4 -> V_233 )
V_39 = V_4 -> V_233 ( V_2 , V_4 ) ;
F_45 ( V_2 , V_4 ) ;
return V_39 ;
}
static void F_73 ( struct V_234 * V_235 )
{
struct V_5 * V_6 ;
struct V_1 * V_2 ;
V_6 = V_235 -> V_236 ;
...
static void F_74 ( struct V_234 * V_235 )
{
struct V_5 * V_6 ;
struct V_1 * V_2 ;
V_6 = V_235 -> V_236 ;
...
static int F_75 ( struct V_64 * V_64 , struct V_234 * V_237 )
{
const unsigned V_19 = F_32 ( V_64 -> V_66 -> V_67 ) ;
struct V_5 * V_6 = NULL ;
unsigned long V_238 = V_237 -> V_239 ;
unsigned long V_28 ;
int V_240 ;
int V_78 ;
int V_8 ;
...
static unsigned int F_79 ( struct V_64 * V_64 , T_4 * V_251 )
{
...
V_69 = F_6 ( V_68 ) ;
if ( V_69 ) {
F_80 ( V_64 , & V_69 -> V_6 -> V_252 , V_251 ) ;
if ( ! V_69 -> V_11
|| F_81 ( V_69 -> V_6 ) > 0
|| ! ( F_37 ( V_69 ) &
V_84 ) ) {
...
V_70 = F_14 ( V_68 ) ;
if ( V_70 ) {
F_80 ( V_64 , & V_70 -> V_6 -> V_252 , V_251 ) ;
F_46 ( V_70 -> V_6 ,
V_70 -> V_6 -> V_21 ) ;
if ( ! V_70 -> V_11
|| ! ( F_37 ( V_70 ) &
...
V_134 = V_257 ;
V_259 = V_134 ;
if ( V_6 -> V_119 + V_259 > V_6 -> V_21 )
V_259 = V_6 -> V_21 - V_6 -> V_119 ;
F_46 ( V_6 , V_6 -> V_21 ) ;
if ( V_259 > F_82 ( V_6 ) )
V_259 = F_82 ( V_6 ) ;
if ( V_259 < V_134 )
...
F_87 ( V_266 ) ;
F_89 ( & V_6 -> V_252 , & V_251 ) ;
V_217:
return V_32 ? V_32 : V_8 ;
}
static T_1 F_90 ( struct V_64 * V_64 , char T_3 * V_25 , T_2 V_257 ,
T_5 * V_258 )
{
struct V_3 * V_4 ;
struct V_5 * V_6 ;
...
V_134 = V_257 ;
V_259 = F_81 ( V_6 ) ;
if ( V_6 -> V_120 + V_259 > V_6 -> V_21 )
V_259 = V_6 -> V_21 - V_6 -> V_120 ;
if ( V_259 < V_134 )
V_134 = V_259 ;
if ( V_134 == 0 ) {
if ( ! ( F_37 ( V_4 ) & V_84 ) ) {
...
static int F_91 ( struct V_268 * V_268 , struct V_64 * V_64 )
{
const unsigned V_19 = F_32 ( V_268 ) ;
struct V_26 * V_68 =
F_33 ( V_19 ) ;
struct V_1 * V_2 =
V_68 ? V_68 -> V_22 : NULL ;
...
#ifdef F_92
F_8 ( & V_2 -> V_29 ) ;
F_93 ( L_43 , V_272 , V_2 -> V_19 ) ;
F_7 ( & V_2 -> V_29 ) ;
#endif
V_2 -> V_271 = 0 ;
if ( ! V_2 -> V_43 && ! F_19 ( V_270 ) ) {
F_2 ( L_44 ) ;
F_8 ( & V_2 -> V_29 ) ;
return - V_201 ;
}
...
if ( V_2 -> V_43 && V_2 -> V_274 == 0 && V_2 -> V_275 ) {
int V_215 = V_2 -> V_275 ( V_2 ) ;
if ( V_215 < 0 ) {
F_22 ( V_2 -> V_46 -> V_44 ) ;
F_22 ( V_273 ) ;
F_8 ( & V_2 -> V_29 ) ;
...
static int F_95 ( struct V_268 * V_268 , struct V_64 * V_64 )
{
const unsigned V_19 = F_32 ( V_268 ) ;
struct V_3 * V_4 = NULL ;
int V_78 ;
...
if ( V_2 -> V_43 && V_2 -> V_274 == 1 && V_2 -> V_276 )
V_2 -> V_276 ( V_2 ) ;
F_22 ( V_273 ) ;
if ( V_2 -> V_43 )
F_22 ( V_2 -> V_46 -> V_44 ) ;
...
static int F_96 ( int V_278 , struct V_64 * V_64 , int V_279 )
{
const unsigned V_19 = F_32 ( V_64 -> V_66 -> V_67 ) ;
struct V_26 * V_68 ;
struct V_1 * V_2 ;
...
if ( V_2 == NULL )
return - V_201 ;
return F_97 ( V_278 , V_64 , V_279 , & V_2 -> V_280 ) ;
}
static void F_98 ( void )
{
unsigned V_78 ;
for ( V_78 = 0 ; V_78 < V_281 ; V_78 ++ )
F_99 ( V_78 ) ;
}
...
V_281 = 16 ;
memset ( V_286 , 0 ,
sizeof( struct V_26 * ) * V_287 ) ;
V_8 = F_101 ( F_102 ( V_272 , 0 ) ,
V_287 , L_50 ) ;
if ( V_8 )
return - V_181 ;
F_103 ( & V_288 , & V_289 ) ;
V_288 . V_290 = V_273 ;
F_104 ( & V_288 . V_291 , L_50 ) ;
if ( F_105 ( & V_288 , F_102 ( V_272 , 0 ) , V_287 ) ) {
F_106 ( F_102 ( V_272 , 0 ) ,
V_287 ) ;
return - V_181 ;
}
V_292 = F_107 ( V_273 , L_50 ) ;
if ( F_108 ( V_292 ) ) {
F_54 ( V_267 L_51 ) ;
F_109 ( & V_288 ) ;
F_106 ( F_102 ( V_272 , 0 ) ,
...
int V_78 ;
F_98 () ;
for ( V_78 = 0 ; V_78 < V_287 ; ++ V_78 )
F_114 ( V_286 [ V_78 ] ) ;
F_115 ( V_292 ) ;
F_109 ( & V_288 ) ;
F_106 ( F_102 ( V_272 , 0 ) , V_287 ) ;
F_116 () ;
}
void F_117 ( const struct V_1 * V_2 , const char * V_4 )
{
F_54 ( V_267 L_52 , V_2 -> V_19 ,
V_2 -> V_46 -> V_74 , V_4 ) ;
}
...
return;
if ( V_4 ->
V_6 -> V_296 & ( V_207 | V_209 |
V_210 ) ) {
V_295 |= V_84 ;
}
if ( V_4 -> V_6 -> V_296 & ( V_209 | V_210 ) ) {
V_295 |= V_126 ;
V_195 |= V_126 ;
}
if ( V_295 ) {
F_60 ( V_4 , V_295 , V_195 ) ;
}
if ( V_6 -> V_206 & V_4 -> V_6 -> V_296 ) {
if ( F_37 ( V_4 ) & V_213 ) {
F_119 ( & V_6 -> V_252 ) ;
if ( V_4 -> V_30 & V_31 )
F_120 ( & V_2 -> V_280 , V_297 , V_298 ) ;
if ( V_4 -> V_30 & V_35 )
F_120 ( & V_2 -> V_280 , V_297 , V_299 ) ;
} else {
if ( V_6 -> V_300 )
V_6 -> V_300 ( V_4 -> V_6 -> V_296 , V_6 -> V_301 ) ;
}
}
V_4 -> V_6 -> V_296 = 0 ;
}
...
int F_112 ( struct V_22 * V_303 )
{
struct V_26 * V_27 ;
struct V_22 * V_304 ;
unsigned V_78 ;
V_27 = F_126 ( sizeof( struct V_26 ) , V_81 ) ;
if ( V_27 == NULL )
return - V_53 ;
V_27 -> V_22 = F_126 ( sizeof( struct V_1 ) , V_81 ) ;
if ( V_27 -> V_22 == NULL ) {
F_39 ( V_27 ) ;
return - V_53 ;
}
...
V_27 -> V_22 -> V_19 = V_78 ;
V_304 = F_128 ( V_292 , V_303 ,
F_102 ( V_272 , V_78 ) , NULL , L_55 , V_78 ) ;
if ( ! F_108 ( V_304 ) )
V_27 -> V_22 -> V_306 = V_304 ;
F_129 ( V_304 , V_27 ) ;
return V_78 ;
}
...
int F_131 ( struct V_22 * V_303 )
{
int V_19 ;
struct V_26 * V_27 ;
for ( V_19 = 0 ; V_19 < V_284 ; V_19 ++ ) {
V_194 ( & V_305 ) ;
V_27 = V_286 [ V_19 ] ;
if ( V_27 && V_27 -> V_303 == V_303 ) {
F_127 ( & V_305 ) ;
return V_19 ;
}
F_127 ( & V_305 ) ;
...
V_27 -> V_76 = V_4 ;
V_194 ( & V_305 ) ;
for ( V_78 = V_307 ; V_78 < V_287 ; ++ V_78 ) {
if ( V_286 [ V_78 ] == NULL ) {
V_286 [ V_78 ] = V_27 ;
break;
}
...
V_4 -> V_19 = V_78 ;
V_304 = F_128 ( V_292 , V_2 -> V_306 ,
F_102 ( V_272 , V_78 ) , NULL , L_56 ,
...
if ( V_4 -> V_19 < 0 )
return;
F_114 ( V_4 -> V_19 >= V_287 ) ;
F_114 ( V_4 -> V_19 < V_307 ) ;
V_194 ( & V_305 ) ;
V_27 = V_286 [ V_4 -> V_19 ] ;
V_286 [ V_4 -> V_19 ] = NULL ;
F_127 ( & V_305 ) ;
if ( V_4 -> V_306 ) {
F_130 ( V_292 , F_102 ( V_272 , V_4 -> V_19 ) ) ;
V_4 -> V_306 = NULL ;
}
F_39 ( V_27 ) ;
}
