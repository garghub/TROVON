...
static T_3 F_49 ( struct V_60 * V_60 , const char T_4 * V_36 , T_1 V_61 ,
T_5 * V_62 )
{
int V_45 = 0 ;
char * V_63 ;
char * V_39 ;
if ( ! ( V_63 = F_8 ( V_61 + 1 , V_17 ) ) ) {
V_45 = - V_18 ;
goto V_46;
}
if ( F_50 ( V_63 , V_36 , V_61 ) ) {
V_45 = - V_64 ;
goto V_46;
}
V_63 [ V_61 ] = '\0' ;
...
V_39 ++ ;
if ( ! strcmp ( V_63 , L_8 ) )
V_45 = F_37 ( V_39 , V_61 - ( V_39 - V_63 ) ) ;
else if ( ! strcmp ( V_63 , L_9 ) )
V_45 = F_38 ( V_39 ) ;
else if ( ! strcmp ( V_63 , L_10 ) )
V_45 = F_41 ( V_39 , V_61 - ( V_39 - V_63 ) ) ;
else if ( ! strcmp ( V_63 , L_11 ) )
V_45 = F_43 ( V_39 , V_61 - ( V_39 - V_63 ) ) ;
else if ( ! strcmp ( V_63 , L_12 ) )
V_45 = F_46 ( V_39 , V_61 - ( V_39 - V_63 ) ) ;
else
V_45 = - V_16 ;
V_46:
F_11 ( V_63 ) ;
return V_45 ? V_45 : V_61 ;
}
