...
static V_37 F_63 ( int V_100 , int V_101 , T_1 * V_34 ,
T_2 V_35 , T_1 V_102 )
{
...
if ( ! ( V_103 -> V_2 & V_77 ) )
goto V_110;
V_26 = F_15 ( V_40 , V_103 , V_34 , V_35 ) ;
if ( V_26 < 0 )
goto V_110;
V_35 = V_26 ;
V_26 = - V_65 ;
...
goto V_111;
V_26 = - V_7 ;
V_105 = V_103 -> V_23 . V_24 -> V_25 ;
V_106 = V_104 -> V_23 . V_24 -> V_25 ;
V_26 = F_15 ( V_74 , V_104 , & V_104 -> V_8 , V_35 ) ;
if ( V_26 < 0 )
goto V_111;
V_35 = V_26 ;
if ( ! V_102 )
V_102 = F_64 ( V_105 -> V_20 -> V_21 , V_106 -> V_20 -> V_21 ) ;
V_36 = * V_34 ;
...
#endif
V_26 = F_65 ( V_103 , V_34 , V_104 , V_35 , V_109 ) ;
if ( V_26 > 0 ) {
F_32 ( V_69 , V_26 ) ;
F_37 ( V_69 , V_26 ) ;
}
