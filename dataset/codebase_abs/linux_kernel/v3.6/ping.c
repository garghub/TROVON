...
static int F_51 ( void * V_128 , char * V_129 ,
...
F_16 () ;
if ( F_52 ( V_129 + sizeof( struct V_96 ) ,
...
static int F_53 ( struct V_10 * V_11 , struct V_133 * V_134 ,
struct V_138 * V_139 )
{
struct V_91 * V_92 = F_54 ( & V_11 -> V_140 ) ;
V_134 -> V_136 = F_55 ( ( char * ) & V_134 -> V_97 ,
sizeof( struct V_96 ) , V_134 -> V_136 ) ;
V_134 -> V_97 . V_141 = F_56 ( V_134 -> V_136 ) ;
memcpy ( F_57 ( V_92 ) , & V_134 -> V_97 , sizeof( struct V_96 ) ) ;
V_92 -> V_142 = V_143 ;
return F_58 ( V_11 , V_139 ) ;
}
static int F_59 ( struct V_144 * V_145 , struct V_10 * V_11 , struct V_146 * V_147 ,
T_6 V_148 )
{
struct V_1 * V_1 = F_8 ( V_11 ) ;
struct V_138 V_139 ;
...
return - V_161 ;
if ( F_60 ( ( V_125 * ) & V_152 , V_147 -> V_162 ,
sizeof( struct V_96 ) ) )
return - V_137 ;
...
V_151 . V_171 = 0 ;
V_68 = F_61 ( V_11 , & V_151 . V_171 ) ;
if ( V_68 )
return V_68 ;
if ( V_147 -> V_172 ) {
V_68 = F_62 ( F_8 ( V_11 ) , V_147 , & V_151 ) ;
if ( V_68 )
return V_68 ;
if ( V_151 . V_169 )
free = 1 ;
...
F_69 ( & V_139 , V_151 . V_170 , V_11 -> V_184 , V_158 ,
V_185 , V_11 -> V_186 ,
F_70 ( V_11 ) , V_157 , V_31 , 0 , 0 ) ;
F_71 ( V_11 , F_72 ( & V_139 ) ) ;
V_154 = F_73 ( V_1 , & V_139 , V_11 ) ;
if ( F_74 ( V_154 ) ) {
V_68 = F_75 ( V_154 ) ;
V_154 = NULL ;
if ( V_68 == - V_187 )
...
V_134 . V_136 = 0 ;
V_68 = F_77 ( V_11 , & V_139 , F_51 , & V_134 , V_148 ,
0 , & V_151 , & V_154 , V_147 -> V_159 ) ;
if ( V_68 )
F_78 ( V_11 ) ;
else
V_68 = F_53 ( V_11 , & V_134 , & V_139 ) ;
F_44 ( V_11 ) ;
V_81:
F_79 ( V_154 ) ;
if ( free )
...
static int F_83 ( struct V_144 * V_145 , struct V_10 * V_11 , struct V_146 * V_147 ,
...
V_92 = F_85 ( V_11 , V_198 , V_197 , & V_68 ) ;
if ( ! V_92 )
goto V_81;
V_199 = V_92 -> V_148 ;
if ( V_199 > V_148 ) {
...
V_68 = F_86 ( V_92 , 0 , V_147 -> V_162 , V_199 ) ;
if ( V_68 )
goto V_202;
F_87 ( V_147 , V_11 , V_92 ) ;
if ( sin ) {
sin -> V_166 = V_167 ;
sin -> V_72 = 0 ;
sin -> V_70 . V_71 = F_88 ( V_92 ) -> V_31 ;
...
static int F_91 ( struct V_10 * V_11 , struct V_91 * V_92 )
{
F_3 ( L_20 ,
...
void F_94 ( struct V_91 * V_92 )
{
struct V_10 * V_11 ;
struct V_1 * V_1 = F_47 ( V_92 -> V_99 ) ;
struct V_94 * V_95 = F_88 ( V_92 ) ;
struct V_96 * V_97 = F_57 ( V_92 ) ;
T_3 V_31 = V_95 -> V_31 ;
T_3 V_32 = V_95 -> V_32 ;
F_3 ( L_22 ,
V_92 , F_38 ( V_97 -> V_101 . V_102 . V_103 ) , F_38 ( V_97 -> V_101 . V_102 . V_104 ) ) ;
F_95 ( V_92 , V_92 -> V_40 - ( V_125 * ) V_97 ) ;
...
static struct V_10 * F_97 ( struct V_205 * V_43 , int V_206 )
{
struct V_10 * V_11 ;
struct V_207 * V_208 = V_43 -> V_209 ;
struct V_1 * V_1 = F_98 ( V_43 ) ;
...
static struct V_10 * F_102 ( struct V_205 * V_43 , struct V_10 * V_11 )
{
struct V_207 * V_208 = V_43 -> V_209 ;
struct V_1 * V_1 = F_98 ( V_43 ) ;
do {
V_11 = F_103 ( V_11 ) ;
} while ( V_11 && ( ! F_101 ( F_8 ( V_11 ) , V_1 ) ) );
if ( ! V_11 )
return F_97 ( V_43 , V_208 -> V_210 + 1 ) ;
return V_11 ;
}
static struct V_10 * F_104 ( struct V_205 * V_43 , T_7 V_213 )
{
struct V_10 * V_11 = F_97 ( V_43 , 0 ) ;
if ( V_11 )
while ( V_213 && ( V_11 = F_102 ( V_43 , V_11 ) ) != NULL )
-- V_213 ;
return V_213 ? NULL : V_11 ;
}
static void * F_105 ( struct V_205 * V_43 , T_7 * V_213 )
{
struct V_207 * V_208 = V_43 -> V_209 ;
V_208 -> V_210 = 0 ;
F_22 ( & V_6 . V_20 ) ;
return * V_213 ? F_104 ( V_43 , * V_213 - 1 ) : V_214 ;
}
static void * F_106 ( struct V_205 * V_43 , void * V_215 , T_7 * V_213 )
{
struct V_10 * V_11 ;
if ( V_215 == V_214 )
V_11 = F_104 ( V_43 , 0 ) ;
else
V_11 = F_102 ( V_43 , V_215 ) ;
++ * V_213 ;
return V_11 ;
}
static void F_107 ( struct V_205 * V_43 , void * V_215 )
{
F_23 ( & V_6 . V_20 ) ;
}
static void F_108 ( struct V_10 * V_216 , struct V_205 * V_217 ,
int V_210 , int * V_148 )
{
...
F_110 ( V_216 ) ,
F_111 ( V_216 ) ,
0 , 0L , 0 , F_112 ( V_216 ) , 0 , F_113 ( V_216 ) ,
F_114 ( & V_216 -> V_59 ) , V_216 ,
F_114 ( & V_216 -> V_222 ) , V_148 ) ;
}
static int F_115 ( struct V_205 * V_43 , void * V_215 )
{
if ( V_215 == V_214 )
F_109 ( V_43 , L_26 ,
L_27
...
struct V_207 * V_208 = V_43 -> V_209 ;
int V_148 ;
F_108 ( V_215 , V_43 , V_208 -> V_210 , & V_148 ) ;
F_109 ( V_43 , L_30 , 127 - V_148 , L_31 ) ;
}
return 0 ;
}
static int F_116 ( struct V_223 * V_223 , struct V_224 * V_224 )
{
return F_117 ( V_223 , V_224 , & V_225 ,
sizeof( struct V_207 ) ) ;
}
...
struct V_226 * V_227 ;
int V_228 = 0 ;
V_227 = F_119 ( V_1 , L_32 , V_229 , & V_230 ) ;
if ( ! V_227 )
V_228 = - V_231 ;
return V_228 ;
}
...
static int T_9 F_122 ( struct V_1 * V_1 )
{
return F_118 ( V_1 ) ;
}
static void T_10 F_123 ( struct V_1 * V_1 )
{
F_120 ( V_1 ) ;
}
int T_11 F_124 ( void )
...
void T_11 F_128 ( void )
{
int V_21 ;
for ( V_21 = 0 ; V_21 < V_211 ; V_21 ++ )
F_129 ( & V_6 . V_8 [ V_21 ] , V_21 ) ;
F_130 ( & V_6 . V_20 ) ;
}
