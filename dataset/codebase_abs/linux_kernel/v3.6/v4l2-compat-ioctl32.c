...
case V_78 :
if ( F_5 ( V_9 -> V_89 , & V_11 -> V_89 ) ||
F_5 ( V_9 -> V_75 . V_91 , & V_11 -> V_75 . V_91 ) )
return - V_17 ;
break;
case V_74 :
{
T_3 V_92 ;
if ( F_5 ( V_9 -> V_89 , & V_11 -> V_89 ) ||
F_5 ( V_92 , & V_11 -> V_75 . V_76 ) )
return - V_17 ;
V_9 -> V_75 . V_76 = ( unsigned long ) F_6 ( V_92 ) ;
}
break;
case V_93 :
if ( F_5 ( V_9 -> V_75 . V_91 , & V_11 -> V_75 . V_91 ) )
return - V_17 ;
break;
}
}
...
F_9 ( V_9 -> V_75 . V_91 , & V_11 -> V_75 . V_91 ) )
return - V_17 ;
break;
case V_74 :
if ( F_9 ( V_9 -> V_89 , & V_11 -> V_89 ) ||
...
break;
case V_93 :
if ( F_9 ( V_9 -> V_75 . V_91 , & V_11 -> V_75 . V_91 ) )
return - V_17 ;
break;
}
}
...
break;
default:
if ( V_186 -> V_247 -> V_248 )
V_4 = V_186 -> V_247 -> V_248 ( V_1 , V_2 , V_3 ) ;
if ( V_4 == - V_5 )
F_21 ( V_249 L_2
L_3 ,
F_50 ( V_2 ) , F_51 ( V_2 ) , F_52 ( V_2 ) ,
V_2 ) ;
break;
}
return V_4 ;
