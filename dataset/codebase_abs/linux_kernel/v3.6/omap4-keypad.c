...
static int T_3 F_20 ( struct V_41 * V_32 ,
struct V_1 * V_2 )
{
...
F_22 ( V_43 , L_2 , & V_2 -> V_22 ) ;
F_22 ( V_43 , L_3 , & V_2 -> V_23 ) ;
if ( ! V_2 -> V_22 || ! V_2 -> V_23 ) {
F_21 ( V_32 , L_4 ) ;
return - V_45 ;
}
if ( F_23 ( V_43 , L_5 , NULL ) )
V_2 -> V_46 = true ;
return 0 ;
}
...
static int T_3 F_24 ( struct V_48 * V_49 )
{
...
V_55 = F_29 ( V_55 -> V_61 , F_30 ( V_55 ) , V_49 -> V_62 ) ;
if ( ! V_55 ) {
F_21 ( & V_49 -> V_32 , L_9 ) ;
error = - V_63 ;
goto V_64;
}
V_2 -> V_4 = F_31 ( V_55 -> V_61 , F_30 ( V_55 ) ) ;
if ( ! V_2 -> V_4 ) {
F_21 ( & V_49 -> V_32 , L_10 ) ;
error = - V_60 ;
goto V_65;
...
V_10 -> V_71 . V_72 = V_73 ;
V_10 -> V_71 . V_74 = 0x0001 ;
V_10 -> V_71 . V_75 = 0x0001 ;
V_10 -> V_71 . V_76 = 0x0001 ;
V_10 -> V_77 = F_13 ;
V_10 -> V_78 = F_18 ;
F_34 ( V_10 , V_25 , V_26 ) ;
if ( ! V_2 -> V_46 )
...
F_46 ( V_2 -> V_4 ) ;
V_65:
F_47 ( V_55 -> V_61 , F_30 ( V_55 ) ) ;
V_64:
F_44 ( V_2 ) ;
return error ;
}
static int T_4 F_48 ( struct V_48 * V_49 )
{
