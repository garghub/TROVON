...
static T_1 int F_15 ( struct V_28 * V_46 ,
...
int V_30 = V_48 -> V_53 ;
V_49 = F_16 ( & V_46 -> V_2 ) ;
if ( ! V_49 && V_46 -> V_2 . V_33 ) {
V_49 = F_9 ( V_46 , & V_30 ) ;
V_50 = V_49 ;
}
if ( ! V_49 )
return - V_54 ;
V_52 = F_11 ( & V_46 -> V_2 , sizeof( * V_52 ) , V_40 ) ;
if ( V_52 == NULL )
return - V_55 ;
V_4 = F_11 ( & V_46 -> V_2 , sizeof( * V_4 ) , V_40 ) ;
if ( V_4 == NULL )
return - V_55 ;
V_4 -> V_56 = V_50 ;
F_17 ( V_46 , V_4 ) ;
...
V_4 -> V_48 = V_30 ;
F_18 ( & V_4 -> V_57 ) ;
V_4 -> V_58 = F_19 ( V_46 , & V_59 ) ;
if ( F_20 ( V_4 -> V_58 ) ) {
V_12 = F_21 ( V_4 -> V_58 ) ;
F_6 ( & V_46 -> V_2 , L_13 , V_12 ) ;
return V_12 ;
}
V_12 = F_22 ( V_4 -> V_2 , - 1 ,
V_60 , F_23 ( V_60 ) ,
NULL , 0 , NULL ) ;
if ( V_12 < 0 ) {
F_6 ( & V_46 -> V_2 , L_14 , V_12 ) ;
return V_12 ;
}
V_52 -> V_44 = V_49 -> V_44 ;
V_52 -> V_45 = V_49 -> V_45 ;
F_24 ( V_4 , V_52 -> V_44 , V_52 ) ;
F_4 ( V_4 , V_49 ) ;
F_7 ( V_4 , V_49 ) ;
return V_12 ;
}
static T_2 int F_25 ( struct V_28 * V_46 )
{
struct V_4 * V_4 = F_26 ( V_46 ) ;
F_27 ( V_4 ) ;
F_28 ( V_4 -> V_2 ) ;
return 0 ;
}
