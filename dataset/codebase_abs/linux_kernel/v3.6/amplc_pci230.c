...
V_13 ^= 1 << ( V_4 -> V_15 - 1 ) ;
V_13 <<= ( 16 - V_4 -> V_15 ) ;
return ( unsigned short ) V_13 ;
}
static inline void F_5 ( struct V_1 * V_2 ,
short V_13 , unsigned int V_16 )
{
struct V_5 * V_6 = V_2 -> V_7 ;
V_6 -> V_17 [ V_16 ] = V_13 ;
...
static inline void F_7 ( struct V_1 * V_2 , short V_13 ,
unsigned int V_16 )
{
struct V_5 * V_6 = V_2 -> V_7 ;
V_6 -> V_17 [ V_16 ] = V_13 ;
...
F_29 ( L_1
L_2
L_3 , V_2 -> V_69 , ( V_56 -> V_68 / 2 ) - 1 ) ;
return - V_70 ;
}
}
V_64 = V_71 | V_72 ;
F_20 ( V_6 -> V_51 + V_52 , 0 , 2 , V_73 ) ;
V_6 -> V_12 = V_74 [ V_60 ] ;
if ( V_61 == V_67 ) {
V_62 = V_16 * 2 ;
if ( V_6 -> V_75 == 0 ) {
...
V_6 -> V_78 = ( V_6 -> V_78 & ~ ( 3 << V_62 ) )
| ( V_79 [ V_60 ] << V_62 ) ;
if ( V_6 -> V_12 )
V_64 |= V_80 ;
else
V_64 |= V_81 ;
F_6 ( V_65 , V_2 -> V_9 + V_82 ) ;
F_6 ( V_6 -> V_78 , V_2 -> V_9 + V_83 ) ;
V_6 -> V_64 = V_64 ;
F_6 ( V_64 | V_84 , V_2 -> V_9 + V_85 ) ;
...
V_94 = V_92 -> V_95 ;
V_92 -> V_95 &= V_96 ;
if ( ! V_92 -> V_95 || V_94 != V_92 -> V_95 )
V_93 ++ ;
V_94 = V_92 -> V_97 ;
if ( ( V_4 -> V_98 > 0 ) && ( V_6 -> V_75 >= 2 ) ) {
V_92 -> V_97 &= V_99 | V_96 | V_100 ;
} else {
V_92 -> V_97 &= V_99 | V_96 ;
}
if ( ! V_92 -> V_97 || V_94 != V_92 -> V_97 )
V_93 ++ ;
V_94 = V_92 -> V_101 ;
V_92 -> V_101 &= V_102 ;
if ( ! V_92 -> V_101 || V_94 != V_92 -> V_101 )
V_93 ++ ;
V_94 = V_92 -> V_103 ;
V_92 -> V_103 &= V_104 ;
if ( ! V_92 -> V_103 || V_94 != V_92 -> V_103 )
V_93 ++ ;
V_94 = V_92 -> V_105 ;
V_92 -> V_105 &= V_104 | V_106 ;
if ( ! V_92 -> V_105 || V_94 != V_92 -> V_105 )
V_93 ++ ;
if ( V_93 )
return 1 ;
if ( ( V_92 -> V_95 & ( V_92 -> V_95 - 1 ) ) != 0 )
V_93 ++ ;
if ( ( V_92 -> V_97 & ( V_92 -> V_97 - 1 ) ) != 0 )
V_93 ++ ;
if ( ( V_92 -> V_101 & ( V_92 -> V_101 - 1 ) ) != 0 )
V_93 ++ ;
if ( ( V_92 -> V_103 & ( V_92 -> V_103 - 1 ) ) != 0 )
V_93 ++ ;
if ( ( V_92 -> V_105 & ( V_92 -> V_105 - 1 ) ) != 0 )
V_93 ++ ;
if ( V_93 )
return 2 ;
if ( V_92 -> V_107 != 0 ) {
...
if ( V_92 -> V_112 != V_92 -> V_113 ) {
V_92 -> V_112 = V_92 -> V_113 ;
V_93 ++ ;
}
if ( V_92 -> V_105 == V_106 ) {
if ( V_92 -> V_114 != 0 ) {
...
static int F_53 ( struct V_1 * V_2 , struct V_55 * V_56 )
{
struct V_5 * V_6 = V_2 -> V_7 ;
...
unsigned int V_94 ;
V_94 = V_92 -> V_95 ;
V_92 -> V_95 &= V_102 | V_96 ;
if ( ! V_92 -> V_95 || V_94 != V_92 -> V_95 )
V_93 ++ ;
V_94 = V_92 -> V_97 ;
if ( ( V_4 -> V_192 ) || ( V_4 -> V_98 > 0 ) ) {
V_92 -> V_97 &= V_193 | V_99 | V_96
| V_100 ;
} else {
V_92 -> V_97 &= V_193 | V_99 | V_96 ;
}
...
} else if ( V_92 -> V_101 == V_100 ) {
if ( ( V_92 -> V_191 & V_109 ) != 0 ) {
if ( ( V_92 -> V_191 & ~ V_109 ) != 0 ) {
V_92 -> V_191 = F_38 ( V_92 -> V_191 , 0 ,
~ V_109 ) ;
V_93 ++ ;
}
...
if ( V_237 == 0 ) {
V_235 = F_3 ( V_2 -> V_9 + V_85 ) ;
if ( ( V_235 & V_238 ) != 0 ) {
F_43 ( V_2 , L_23 ) ;
V_146 |= V_147 | V_157 ;
break;
} else if ( ( V_235 & V_86 ) != 0 ) {
break;
...
static int F_70 ( struct V_1 * V_2 , struct V_55 * V_56 )
{
struct V_5 * V_6 = V_2 -> V_7 ;
...
static T_2 F_72 ( int V_244 , void * V_245 )
{
...
static bool F_74 ( const struct V_3 * V_254 ,
struct V_255 * V_255 )
{
...
static const struct V_3 * F_76 ( struct V_255 * V_255 )
{
unsigned int V_24 ;
for ( V_24 = 0 ; V_24 < F_77 ( V_258 ) ; V_24 ++ )
if ( F_74 ( & V_258 [ V_24 ] , V_255 ) )
return & V_258 [ V_24 ] ;
return NULL ;
}
static struct V_255 * F_78 ( struct V_1 * V_2 ,
struct V_259 * V_260 )
{
const struct V_3 * V_4 = F_2 ( V_2 ) ;
...
struct V_5 * V_6 ;
int V_93 ;
V_93 = F_82 ( V_2 , sizeof( struct V_5 ) ) ;
if ( V_93 ) {
F_32 ( V_2 -> V_87 , L_26 ) ;
return V_93 ;
}
...
struct V_5 * V_6 = V_2 -> V_7 ;
struct V_55 * V_56 ;
unsigned long V_51 , V_271 ;
int V_272 , V_273 ;
F_85 ( V_2 , & V_255 -> V_2 ) ;
V_2 -> V_274 = V_4 -> V_275 ;
if ( F_86 ( V_255 , L_27 ) < 0 ) {
F_32 ( V_2 -> V_87 ,
L_28 ) ;
return - V_276 ;
}
...
F_88 ( V_2 -> V_87 ,
L_29 ,
V_2 -> V_274 , V_51 , V_271 ) ;
V_6 -> V_51 = V_51 ;
V_2 -> V_9 = V_271 ;
V_6 -> V_137 = F_3 ( V_2 -> V_9 + V_90 ) & V_138 ;
if ( F_75 ( V_255 , 3 ) >= 32 ) {
unsigned short V_277 = 0 ;
V_6 -> V_75 = F_3 ( V_2 -> V_9 + V_278 ) ;
if ( V_6 -> V_75 < V_4 -> V_98 ) {
F_32 ( V_2 -> V_87 ,
L_30 ,
V_2 -> V_274 , V_6 -> V_75 ,
V_4 -> V_98 ) ;
...
V_6 -> V_64 = V_226 | V_77
| V_80 ;
F_6 ( 1 << 0 , V_2 -> V_9 + V_82 ) ;
F_6 ( V_6 -> V_78 , V_2 -> V_9 + V_83 ) ;
F_6 ( V_6 -> V_64 | V_84 ,
V_2 -> V_9 + V_85 ) ;
V_272 = F_89 ( V_255 -> V_244 , F_72 ,
V_283 , L_27 , V_2 ) ;
if ( V_272 < 0 ) {
F_90 ( V_2 -> V_87 ,
L_31 ,
...
F_88 ( V_2 -> V_87 , L_32 , V_255 -> V_244 ) ;
}
V_273 = F_91 ( V_2 , 3 ) ;
if ( V_273 )
return V_273 ;
...
static int F_93 ( struct V_1 * V_2 , struct V_259 * V_260 )
{
const struct V_3 * V_4 = F_2 ( V_2 ) ;
struct V_255 * V_255 ;
int V_273 ;
...
if ( V_273 )
return V_273 ;
V_255 = F_78 ( V_2 , V_260 ) ;
if ( ! V_255 )
return - V_276 ;
return F_84 ( V_2 , V_255 ) ;
}
static int T_3 F_94 ( struct V_1 * V_2 ,
struct V_255 * V_255 )
{
int V_273 ;
F_61 ( V_2 -> V_87 , L_35 ,
...
{
const struct V_3 * V_4 = F_2 ( V_2 ) ;
struct V_255 * V_307 = F_98 ( V_2 ) ;
if ( V_2 -> V_284 && V_4 -> V_192 )
F_99 ( V_2 , V_2 -> V_284 + 2 ) ;
if ( V_2 -> V_244 )
F_100 ( V_2 -> V_244 , V_2 ) ;
if ( V_307 ) {
if ( V_2 -> V_9 )
...
static int T_3 F_103 ( struct V_255 * V_2 ,
const struct V_308 * V_309 )
{
return F_104 ( V_2 , & V_310 ) ;
}
static void T_4 F_105 ( struct V_255 * V_2 )
{
F_106 ( V_2 ) ;
}
