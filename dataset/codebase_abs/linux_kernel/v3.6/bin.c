...
static int F_19 ( struct V_40 * V_41 , unsigned long V_51 ,
...
static int F_20 ( struct V_40 * V_41 , struct V_56 * V_57 )
{
struct V_1 * V_1 = V_41 -> V_42 ;
struct V_24 * V_25 = V_1 -> V_26 ;
struct V_5 * V_6 = V_1 -> V_7 . V_8 -> V_9 ;
...
static struct V_56 * F_21 ( struct V_40 * V_41 ,
unsigned long V_51 )
{
struct V_1 * V_1 = V_41 -> V_42 ;
struct V_24 * V_25 = V_1 -> V_26 ;
...
static int F_22 ( struct V_40 * V_41 , const T_5 * V_62 ,
...
static int F_23 ( struct V_1 * V_1 , struct V_40 * V_41 )
{
struct V_24 * V_25 = V_1 -> V_26 ;
struct V_5 * V_6 = V_1 -> V_7 . V_8 -> V_9 ;
struct V_10 * V_11 = V_6 -> V_12 . V_13 ;
...
if ( ! V_11 -> F_23 )
goto V_67;
V_18 = V_11 -> F_23 ( V_1 , V_15 , V_11 , V_41 ) ;
if ( V_18 )
goto V_67;
if ( V_41 -> V_42 != V_1 )
goto V_67;
...
return - V_19 ;
error = - V_72 ;
if ( ( V_1 -> V_73 & V_74 ) && ! ( V_11 -> V_39 || V_11 -> F_23 ) )
goto V_75;
if ( ( V_1 -> V_73 & V_76 ) && ! ( V_11 -> V_21 || V_11 -> F_23 ) )
goto V_75;
error = - V_34 ;
V_25 = F_24 ( sizeof( * V_25 ) , V_33 ) ;
if ( ! V_25 )
goto V_75;
...
static int F_27 ( struct V_71 * V_71 , struct V_1 * V_1 )
{
struct V_24 * V_25 = V_1 -> V_26 ;
F_6 ( & V_77 ) ;
F_28 ( & V_25 -> V_78 ) ;
...
return;
F_6 ( & V_77 ) ;
F_31 (bb, tmp, &attr_sd->s_bin_attr.buffers, list) {
struct V_71 * V_71 = V_25 -> V_1 -> V_7 . V_8 -> V_28 ;
F_32 ( V_71 -> V_83 , 0 , 0 , 1 ) ;
}
F_7 ( & V_77 ) ;
}
int F_33 ( struct V_14 * V_15 ,
const struct V_10 * V_11 )
{
F_34 ( ! V_15 || ! V_15 -> V_84 || ! V_11 ) ;
return F_35 ( V_15 -> V_84 , & V_11 -> V_11 , V_82 ) ;
}
void F_36 ( struct V_14 * V_15 ,
const struct V_10 * V_11 )
{
F_37 ( V_15 -> V_84 , NULL , V_11 -> V_11 . V_85 ) ;
}
