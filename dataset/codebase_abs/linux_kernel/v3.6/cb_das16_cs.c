...
V_35 = V_33 -> V_36 ;
V_33 -> V_36 &= V_37 ;
if ( ! V_33 -> V_36 || V_35 != V_33 -> V_36 )
V_34 ++ ;
V_35 = V_33 -> V_38 ;
V_33 -> V_38 &= V_39 | V_40 ;
if ( ! V_33 -> V_38 || V_35 != V_33 -> V_38 )
V_34 ++ ;
V_35 = V_33 -> V_41 ;
V_33 -> V_41 &= V_39 | V_40 ;
if ( ! V_33 -> V_41 || V_35 != V_33 -> V_41 )
V_34 ++ ;
V_35 = V_33 -> V_42 ;
V_33 -> V_42 &= V_43 ;
if ( ! V_33 -> V_42 || V_35 != V_33 -> V_42 )
V_34 ++ ;
V_35 = V_33 -> V_44 ;
V_33 -> V_44 &= V_43 | V_45 ;
if ( ! V_33 -> V_44 || V_35 != V_33 -> V_44 )
V_34 ++ ;
if ( V_34 )
return 1 ;
if ( V_33 -> V_38 != V_39 &&
V_33 -> V_38 != V_40 )
V_34 ++ ;
if ( V_33 -> V_41 != V_39 && V_33 -> V_41 != V_40 )
V_34 ++ ;
if ( V_33 -> V_44 != V_43 && V_33 -> V_44 != V_45 )
V_34 ++ ;
if ( V_34 )
return 2 ;
if ( V_33 -> V_46 != 0 ) {
...
static const struct V_68 * F_20 ( struct V_4 * V_5 ,
struct V_69 * V_70 )
{
int V_18 ;
for ( V_18 = 0 ; V_18 < F_21 ( V_71 ) ; V_18 ++ ) {
...
if ( ! V_70 )
return - V_79 ;
V_5 -> V_80 = F_20 ( V_5 , V_70 ) ;
if ( ! V_5 -> V_80 )
return - V_79 ;
V_76 = F_23 ( V_5 ) ;
V_5 -> V_81 = V_76 -> V_82 ;
V_5 -> V_20 = V_70 -> V_83 [ 0 ] -> V_84 ;
V_77 = F_24 ( V_70 -> V_1 , F_1 ,
V_85 , L_3 , V_5 ) ;
if ( V_77 < 0 )
return V_77 ;
V_5 -> V_1 = V_70 -> V_1 ;
if ( F_25 ( V_5 , sizeof( struct V_11 ) ) < 0 )
return - V_86 ;
V_77 = F_26 ( V_5 , 3 ) ;
if ( V_77 )
return V_77 ;
...
static int F_30 ( struct V_69 * V_115 ,
void * V_116 )
{
if ( V_115 -> V_117 == 0 )
return - V_31 ;
