...
char * V_36 = NULL ;
char * V_37 = NULL ;
struct V_38 * V_39 = F_32 ( V_91 -> V_94 ) ;
struct V_78 * V_79 ;
struct V_34 * V_80 ;
struct V_95 * V_96 ;
V_79 = F_28 ( V_39 ) ;
...
if ( V_80 -> V_98 )
V_4 = F_35 ( V_33 , V_80 , V_36 , V_37 ,
V_39 -> V_50 ,
V_39 -> V_51 &
V_52 ) ;
else {
V_4 = F_36 ( V_33 , V_80 , V_36 , V_37 ,
V_39 -> V_50 ,
V_39 -> V_51 &
V_52 ) ;
...
F_37 ( V_92 ) ;
if ( V_90 -> V_100 ) {
V_96 = F_38 ( V_90 -> V_100 ) ;
if ( V_4 == 0 ) {
F_39 ( & V_90 -> V_100 -> V_101 ) ;
F_40 ( V_90 -> V_100 ) ;
F_41 ( & V_90 -> V_100 -> V_101 ) ;
}
V_96 -> time = 0 ;
}
V_97:
...
void *
F_43 ( struct V_89 * V_92 , struct V_102 * V_103 )
{
struct V_91 * V_91 = V_92 -> V_100 ;
int V_4 = - V_13 ;
unsigned int V_33 ;
char * V_104 = NULL ;
char * V_105 = NULL ;
...
if ( ! V_104 )
goto V_81;
F_14 ( 1 , L_8 , V_104 , V_91 ) ;
V_4 = - V_93 ;
if ( V_39 -> V_51 & V_106 )
V_4 = F_23 ( V_33 , V_35 , V_104 , & V_105 ,
V_39 -> V_50 ,
V_39 -> V_51 &
V_52 ) ;
if ( ( V_4 != 0 ) && F_44 ( V_35 -> V_107 ) )
V_4 = F_45 ( V_33 , V_35 , V_104 , & V_105 ,
V_39 -> V_50 ) ;
F_12 ( V_104 ) ;
V_81:
if ( V_4 != 0 ) {
...
int
F_48 ( struct V_91 * V_91 , struct V_89 * V_92 , const char * V_108 )
{
int V_4 = - V_99 ;
unsigned int V_33 ;
struct V_38 * V_39 = F_32 ( V_91 -> V_94 ) ;
...
F_14 ( 1 , L_10 , V_108 ) ;
if ( V_39 -> V_51 & V_106 )
V_4 = F_18 ( V_33 , V_80 , V_104 , V_108 ,
V_39 ) ;
else if ( V_80 -> V_98 )
V_4 = F_49 ( V_33 , V_80 , V_104 , V_108 ,
V_39 -> V_50 ) ;
if ( V_4 == 0 ) {
if ( V_80 -> V_98 )
V_4 = F_50 ( & V_109 , V_104 ,
V_91 -> V_94 , V_33 ) ;
else
V_4 = F_51 ( & V_109 , V_104 , NULL ,
V_91 -> V_94 , V_33 , NULL ) ;
if ( V_4 != 0 ) {
F_14 ( 1 , L_11 ,
V_4 ) ;
...
void F_53 ( struct V_89 * V_92 , struct V_102 * V_103 , void * V_111 )
{
char * V_112 = F_54 ( V_103 ) ;
if ( ! F_3 ( V_112 ) )
F_12 ( V_112 ) ;
}
