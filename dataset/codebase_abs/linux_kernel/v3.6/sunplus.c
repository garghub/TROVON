...
struct V_31 * V_31 = (struct V_31 * ) V_1 ;
int V_62 ;
F_30 ( V_31 -> V_63 , V_1 -> V_64 , V_1 -> V_65 ,
0x22 ) ;
F_31 ( V_31 -> V_63 , V_66 ) ;
if ( V_31 -> V_37 == V_50 )
F_21 ( V_1 ) ;
...
V_62 = ( V_31 -> V_71 ? 0x04 : 0x01 ) ;
F_8 ( V_1 , 0x0c , 0x0000 , V_62 ) ;
F_8 ( V_1 , 0xb0 , 0x0000 , V_62 ) ;
...
F_34 ( V_1 , V_81 , V_19 , V_4 ) ;
}
static int F_35 ( struct V_82 * V_83 )
{
struct V_1 * V_1 =
F_36 ( V_83 -> V_84 , struct V_1 , V_85 ) ;
struct V_31 * V_31 = (struct V_31 * ) V_1 ;
V_1 -> V_7 = 0 ;
if ( ! V_1 -> V_86 )
return 0 ;
...
const struct V_47 * V_48 )
{
return F_41 ( V_96 , V_48 , & V_97 , sizeof( struct V_31 ) ,
V_98 ) ;
}
