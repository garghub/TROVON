...
if ( V_282 -> V_118 < 0 || V_282 -> V_118 >= F_97 )
return - V_102 ;
switch ( V_282 -> V_16 ) {
case 640 :
...
L_59 ) ;
F_103 ( V_25 , 1 ) ;
F_75 ( V_25 -> V_287 -> V_35 ,
( ( F_102 ( & V_25 -> V_287 -> V_33 )
== V_290 ) ||
( F_102 ( & V_25 -> V_287 -> V_33 )
== V_288 ) ) ,
F_76 ( V_291 ) ) ;
...
L_64 ,
V_29 ) ;
F_15 ( & V_25 -> V_287 -> V_33 ,
V_34 ) ;
F_58 ( & V_25 -> V_286 ) ;
return - V_294 ;
default:
F_14 ( V_293 L_65 , V_29 ) ;
F_58 ( & V_25 -> V_286 ) ;
return - V_214 ;
}
F_58 ( & V_25 -> V_286 ) ;
...
static unsigned int F_105 ( struct V_110 * V_110 ,
struct V_299 * V_300 )
{
struct V_90 * V_91 = V_110 -> V_122 ;
int V_56 ;
...
if ( V_223 != V_91 -> type )
return V_301 ;
V_56 = F_106 ( V_110 , & V_91 -> V_135 , V_300 ) ;
return V_56 ;
}
...
F_109 ( & V_25 -> V_302 ) ;
if ( V_25 -> V_287 -> V_30 ) {
F_110 ( V_25 -> V_287 -> V_30 ) ;
F_111 ( V_25 -> V_287 -> V_30 ) ;
V_25 -> V_287 -> V_30 = NULL ;
}
F_112 ( V_25 -> V_287 -> V_45 ) ;
F_74 ( V_25 -> V_287 -> V_44 ) ;
F_74 ( V_25 -> V_287 ) ;
F_8 ( V_25 ) ;
F_113 ( & V_25 -> V_286 ) ;
F_113 ( & V_25 -> V_298 ) ;
...
static int F_116 ( struct V_110 * V_110 )
{
struct V_90 * V_91 = V_110 -> V_122 ;
struct V_1 * V_25 = V_91 -> V_25 ;
struct V_4 * V_5 = F_99 ( V_110 ) ;
...
static int F_118 ( struct V_110 * V_110 , struct V_303 * V_304 )
{
struct V_90 * V_91 = V_110 -> V_122 ;
int V_151 ;
if ( ! V_91 )
...
int V_308 = V_309 ;
struct V_47 * V_48 ;
V_151 = F_123 ( & V_25 -> V_310 -> V_25 , & V_25 -> V_3 ) ;
if ( V_151 )
return V_151 ;
...
V_48 -> V_52 . V_25 = V_25 ;
V_48 -> V_5 = V_312 ;
V_48 -> V_5 . V_298 = & V_25 -> V_298 ;
F_125 ( V_313 , & V_48 -> V_5 . V_55 ) ;
V_48 -> V_5 . V_3 = & V_25 -> V_3 ;
F_126 ( & V_48 -> V_5 , V_48 ) ;
if ( V_309 == - 1 )
V_151 = F_127 ( & V_48 -> V_5 ,
V_314 ,
V_309 ) ;
else
V_151 = F_127 ( & V_48 -> V_5 ,
...
static int F_130 ( struct V_1 * V_25 , struct V_317 * V_318 )
{
char * V_319 ;
T_1 V_320 = 0 ;
int V_321 = 0 ;
...
V_108 = V_48 -> V_225 ;
V_325 = & V_48 -> V_76 . V_77 [ V_108 ] ;
if ( V_325 -> V_227 == V_228 ) {
int V_328 ;
unsigned int V_327 ;
T_2 * V_329 ;
int V_330 ;
V_326 = ( unsigned char * ) V_318 -> V_331 ;
V_329 = ( T_2 * ) V_326 ;
for ( V_328 = 0 ; V_328 < ( V_318 -> V_332 - 12 ) ; V_328 ++ ) {
switch ( * V_329 ) {
case V_333 :
F_12 ( 4 , L_79
L_80 , V_328 , V_326 [ 0 ] ,
...
V_48 -> V_334 = V_330 ;
V_48 -> V_335 = F_131 ( V_329 [ 4 ] ) ;
break;
case V_336 :
V_326 += V_196 ;
V_328 += V_196 ;
if ( F_131 ( V_329 [ 1 ] ) >= V_311 )
break;
V_327 = V_203 [ F_131 ( V_329 [ 1 ] ) ] ;
if ( V_327 >= V_311 )
break;
...
F_15 ( & V_25 -> V_287 -> V_33 ,
V_290 ) ;
F_16 ( & V_25 -> V_287 -> V_35 ) ;
break;
case V_340 :
V_48 -> V_220 = F_131 ( V_329 [ 3 ] ) ;
V_48 -> V_217 = 1 ;
F_16 ( & V_48 -> V_218 ) ;
F_12 ( 5 , L_84 ,
F_131 ( V_329 [ 3 ] ) , V_327 ) ;
...
V_322 = ( V_342 * ) V_318 -> V_331 + V_320 ;
if ( V_325 -> V_78 == NULL ) {
F_12 ( 1 , L_86 ,
V_325 , V_25 , V_25 -> V_327 , V_108 ) ;
return - V_207 ;
}
V_319 = V_325 -> V_78 + V_325 -> V_229 ;
V_323 = ( V_318 -> V_332 - V_320 ) ;
V_22 = V_48 -> V_334 - V_195 ;
if ( ( V_323 + V_325 -> V_229 ) < V_48 -> V_205 )
memcpy ( V_319 , V_322 , V_323 ) ;
V_325 -> V_229 += V_323 ;
F_12 ( 4 , L_87 , V_325 -> V_229 , V_22 ) ;
if ( V_325 -> V_229 >= V_22 ) {
F_12 ( 2 , L_88 ,
V_25 -> V_327 , V_108 ) ;
...
static void F_132 ( struct V_1 * V_25 ,
struct V_317 * V_318 )
{
int V_201 ;
F_12 ( 50 , L_89 ) ;
...
int V_350 ;
if ( ! V_349 ) {
V_350 = F_133 ( V_25 -> V_39 , F_134 ( V_25 -> V_39 , 0 ) ,
V_344 ,
V_351 | V_352 |
V_353 ,
V_346 , V_345 , V_347 ,
...
V_350 = F_133 ( V_25 -> V_39 , F_135 ( V_25 -> V_39 , 0 ) ,
V_344 , V_351 | V_352 ,
V_346 , V_345 , V_347 ,
V_348 , V_354 * 5 ) ;
}
...
static int F_136 ( struct V_1 * V_25 )
{
int V_45 ;
int V_151 ;
unsigned char V_355 [ 64 ] ;
V_151 = F_9 ( V_25 , V_356 , 0 , 0 , V_355 , 2 ,
V_357 ) ;
if ( V_151 < 0 )
F_12 ( 2 , L_93 , V_151 ) ;
...
F_12 ( 1 , L_99 ,
V_48 -> V_76 . V_77 [ V_23 ] . V_78 ) ;
F_140 ( V_48 -> V_76 . V_77 [ V_23 ] . V_78 ) ;
}
V_48 -> V_76 . V_77 [ V_23 ] . V_78 = NULL ;
}
return 0 ;
}
static int F_141 ( struct V_1 * V_25 )
{
struct V_149 V_360 = V_361 ;
int V_362 ;
int V_222 ;
struct V_317 * V_179 = & V_25 -> V_179 ;
F_12 ( 4 , L_100 , V_25 ) ;
memset ( V_179 , 0 , sizeof( * V_179 ) ) ;
V_179 -> V_25 = V_25 ;
V_179 -> V_332 = V_363 ;
V_179 -> V_364 = V_363 ;
V_179 -> V_331 = F_72 ( V_179 -> V_364 ,
V_206 ) ;
if ( V_179 -> V_331 == NULL ) {
F_12 ( 1 , L_101 ) ;
return - V_207 ;
...
V_48 -> V_167 . V_168 = V_366 ;
V_48 -> V_16 = V_8 ;
V_48 -> V_17 = V_190 * 2 ;
V_48 -> V_18 = & V_67 [ 0 ] ;
V_48 -> V_150 . V_171 = 1 ;
V_48 -> V_205 = F_69 ( & V_360 ) ;
V_48 -> V_84 = 0 ;
F_137 ( V_48 ) ;
}
F_142 ( V_25 ) ;
...
F_143 ( V_25 ) ;
for ( V_23 = 0 ; V_23 < V_311 ; V_23 ++ )
F_139 ( & V_25 -> V_48 [ V_23 ] ) ;
F_74 ( V_25 -> V_179 . V_331 ) ;
return 0 ;
}
static void F_144 ( struct V_36 * V_367 )
{
struct V_317 * V_318 ;
struct V_1 * V_25 ;
int V_41 ;
...
V_179 = F_145 ( V_25 -> V_39 , V_25 -> V_370 ) ;
F_21 ( V_318 -> V_371 , V_25 -> V_39 ,
V_179 ,
V_318 -> V_331 ,
V_318 -> V_332 ,
F_144 , V_318 ) ;
if ( V_318 -> V_85 != 0 ) {
if ( F_13 ( V_318 -> V_371 , V_31 ) ) {
...
int V_179 ;
int V_180 ;
struct V_317 * V_318 = & V_25 -> V_179 ;
V_179 = F_145 ( V_25 -> V_39 , V_25 -> V_370 ) ;
F_12 ( 2 , L_113 , V_29 , V_25 -> V_370 ) ;
V_318 -> V_85 = 1 ;
V_318 -> V_369 = 0 ;
V_318 -> V_371 = F_146 ( 0 , V_206 ) ;
if ( ! V_318 -> V_371 ) {
F_18 ( & V_25 -> V_39 -> V_25 ,
L_114 ) ;
return - V_207 ;
...
static void F_143 ( struct V_1 * V_25 )
{
struct V_317 * V_179 = & V_25 -> V_179 ;
V_179 -> V_85 = 0 ;
if ( V_179 -> V_371 ) {
...
if ( V_374 )
F_8 ( V_25 ) ;
V_25 -> V_287 -> V_43 = V_25 -> V_287 -> V_45 -> V_22 ;
F_15 ( & V_25 -> V_287 -> V_33 , V_292 ) ;
memcpy ( V_25 -> V_287 -> V_44 ,
V_25 -> V_287 -> V_45 -> V_28 , F_20 ) ;
V_25 -> V_287 -> V_42 = F_20 ;
F_21 ( V_25 -> V_287 -> V_30 , V_25 -> V_39 ,
F_22 ( V_25 -> V_39 , 2 ) ,
V_25 -> V_287 -> V_44 ,
F_20 , F_17 ,
V_25 -> V_287 ) ;
F_147 ( & V_25 -> V_302 , V_375 + V_354 ) ;
}
static int F_148 ( struct V_376 * V_310 ,
const struct V_377 * V_115 )
{
...
F_15 ( & V_25 -> V_307 , 0 ) ;
V_25 -> V_242 = V_115 -> V_382 ;
V_25 -> V_287 = F_72 ( sizeof( struct V_27 ) , V_206 ) ;
if ( ! V_25 -> V_287 )
goto V_383;
F_149 ( & V_25 -> V_298 ) ;
F_149 ( & V_25 -> V_286 ) ;
V_25 -> V_39 = F_150 ( F_151 ( V_310 ) ) ;
if ( V_25 -> V_39 == NULL ) {
...
F_153 ( & V_25 -> V_302 ) ;
V_25 -> V_302 . V_390 = F_11 ;
V_25 -> V_302 . V_28 = ( unsigned long ) V_25 -> V_287 ;
F_154 ( & V_25 -> V_287 -> V_35 ) ;
for ( V_23 = 0 ; V_23 < V_311 ; V_23 ++ ) {
...
V_25 -> V_287 -> V_30 = F_146 ( 0 , V_206 ) ;
if ( ! V_25 -> V_287 -> V_30 ) {
F_18 ( & V_310 -> V_25 , L_101 ) ;
goto V_391;
}
V_25 -> V_287 -> V_44 = F_72 ( F_20 , V_206 ) ;
if ( ! V_25 -> V_287 -> V_44 ) {
F_18 ( & V_310 -> V_25 , L_101 ) ;
goto V_392;
}
if ( F_155 ( & V_25 -> V_287 -> V_45 ,
V_393 , & V_25 -> V_39 -> V_25 ) ) {
F_14 ( V_32 L_125 ) ;
goto V_394;
}
V_43 = V_25 -> V_287 -> V_45 -> V_22 ;
V_326 = ( T_2 * ) & V_25 -> V_287 -> V_45 -> V_28 [ V_43 - 8 ] ;
if ( * V_326 != V_395 ) {
F_14 ( V_293 L_126 ) ;
V_180 = - V_289 ;
goto V_396;
...
T_2 * V_397 ;
V_397 = ( T_2 * ) & V_25 -> V_287 -> V_45 -> V_28 [ V_43 - 4 ] ;
F_14 ( V_293 L_127 , * V_397 ) ;
V_25 -> V_239 = F_131 ( * V_397 ) ;
if ( V_25 -> V_239 < V_398 )
F_14 ( V_293 L_128 ) ;
...
V_383:
F_74 ( V_25 ) ;
F_14 ( V_316 L_132 , V_180 ) ;
return V_180 ;
}
static void F_158 ( struct V_376 * V_310 )
{
struct V_1 * V_25 = F_1 ( F_159 ( V_310 ) ) ;
int V_23 ;
int V_400 = F_102 ( & V_25 -> V_307 ) ;
F_55 ( & V_25 -> V_298 ) ;
F_160 ( & V_25 -> V_3 ) ;
F_58 ( & V_25 -> V_298 ) ;
F_128 ( & V_25 -> V_307 ) ;
for ( V_23 = 0 ; V_23 < V_400 ; V_23 ++ )
F_161 ( & V_25 -> V_48 [ V_23 ] . V_5 ) ;
F_15 ( & V_25 -> V_287 -> V_33 , V_288 ) ;
F_16 ( & V_25 -> V_287 -> V_35 ) ;
for ( V_23 = 0 ; V_23 < V_311 ; V_23 ++ ) {
