...
F_52 ( V_42 ) ;
F_41 ( & V_65 ) ;
V_64 = F_95 ( & V_119 , V_100 ) ?
F_96 ( & V_119 , V_42 , & V_124 ) :
- V_53 ;
F_42 ( & V_65 ) ;
if ( V_64 < 0 )
goto error;
...
V_42 -> V_42 . V_118 = F_97 ( V_159 , V_124 ) ;
...
V_89 = F_32 ( V_42 , V_55 , V_16 , & V_163 ) ;
if ( V_89 != V_102 )
return V_89 ;
if ( V_16 == 0 && V_163 == 0 )
return V_92 ;
if ( V_163 != V_42 -> V_29 [ V_16 ] ) {
* V_162 = true ;
return V_102 ;
}
}
...
bool V_162 ;
V_64 = F_99 ( V_42 , V_42 -> V_55 , & V_162 ) ;
if ( V_64 != V_102 )
goto V_164;
if ( ! V_162 ) {
if ( F_64 ( & V_42 -> V_128 ,
...
void F_103 ( struct V_93 * V_56 , struct V_138 * V_104 , int V_168 )
{
struct V_54 * V_42 ;
switch ( V_168 ) {
case V_169 :
V_170:
V_42 = F_47 ( sizeof( * V_42 ) , V_171 ) ;
if ( V_42 == NULL )
break;
