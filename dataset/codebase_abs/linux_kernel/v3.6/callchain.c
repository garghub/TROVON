...
static int F_7 ( void T_1 * V_23 , void * V_24 , int V_25 )
{
T_2 * V_26 ;
T_3 * V_27 , V_28 ;
unsigned V_29 ;
...
static int F_14 ( unsigned long T_1 * V_23 , unsigned long * V_24 )
{
...
F_17 () ;
return F_7 ( V_23 , V_24 , 8 ) ;
}
static int F_18 ( unsigned int T_1 * V_23 , unsigned int * V_24 )
{
...
F_17 () ;
return F_7 ( V_23 , V_24 , 4 ) ;
}
static inline int F_19 ( unsigned long V_1 , int V_40 )
{
if ( ! V_1 || ( V_1 & 7 ) || V_1 > ( V_40 ? V_39 : 0x100000000UL ) - 32 )
return 0 ;
return 1 ;
}
static int F_20 ( unsigned long V_20 , unsigned long V_14 )
{
if ( V_20 == V_14 + F_21 ( struct V_41 , V_42 ) )
return 1 ;
if ( V_43 && V_3 -> V_34 -> V_44 . V_45 &&
V_20 == V_3 -> V_34 -> V_44 . V_45 + V_43 )
return 1 ;
return 0 ;
}
...
if ( F_14 ( ( unsigned long T_1 * ) & V_46 -> V_47 , & V_47 ) ||
F_14 ( ( unsigned long T_1 * ) & V_46 -> V_48 , & V_48 ) )
return 0 ;
...
if ( ! F_19 ( V_1 , 1 ) || F_14 ( V_14 , & V_10 ) )
return;
if ( V_13 > 0 && F_14 ( & V_14 [ 2 ] , & V_11 ) )
return;
if ( V_10 - V_1 >= sizeof( struct V_41 ) &&
( F_20 ( V_11 , V_1 ) ||
( V_13 <= 1 && F_20 ( V_12 , V_1 ) ) ) &&
F_22 ( V_1 ) ) {
V_51 = (struct V_41 T_1 * ) V_1 ;
V_52 = V_51 -> V_50 . V_53 . V_54 ;
if ( F_14 ( & V_52 [ V_55 ] , & V_11 ) ||
F_14 ( & V_52 [ V_56 ] , & V_12 ) ||
F_14 ( & V_52 [ V_57 ] , & V_1 ) )
return;
V_13 = 0 ;
...
static int F_27 ( unsigned int V_20 , unsigned int V_14 )
{
if ( V_20 == V_14 + F_21 ( struct V_61 , V_62 . V_63 ) )
return 1 ;
if ( V_64 && V_3 -> V_34 -> V_44 . V_45 &&
V_20 == V_3 -> V_34 -> V_44 . V_45 + V_64 )
return 1 ;
return 0 ;
}
static int F_28 ( unsigned int V_20 , unsigned int V_14 )
{
if ( V_20 == V_14 + F_21 ( struct V_65 ,
V_50 . V_53 . V_63 ) )
return 1 ;
if ( V_66 && V_3 -> V_34 -> V_44 . V_45 &&
V_20 == V_3 -> V_34 -> V_44 . V_45 + V_66 )
return 1 ;
return 0 ;
}
...
if ( F_18 ( ( unsigned int T_1 * ) & V_46 -> V_67 . V_9 , & V_9 ) )
return 0 ;
...
if ( F_18 ( ( unsigned int T_1 * ) & V_46 -> V_50 . V_68 , & V_9 ) )
return 0 ;
...
if ( ! F_19 ( V_1 , 0 ) || F_18 ( V_14 , & V_10 ) )
return;
if ( V_13 > 0 && F_18 ( & V_14 [ 1 ] , & V_11 ) )
return;
V_52 = F_31 ( V_1 , V_10 , V_11 ) ;
if ( ! V_52 && V_13 <= 1 )
V_52 = F_31 ( V_1 , V_10 , V_12 ) ;
if ( V_52 ) {
if ( F_18 ( & V_52 [ V_55 ] , & V_11 ) ||
F_18 ( & V_52 [ V_56 ] , & V_12 ) ||
F_18 ( & V_52 [ V_57 ] , & V_1 ) )
return;
V_13 = 0 ;
...
void
F_33 ( struct V_6 * V_7 , struct V_8 * V_9 )
{
if ( F_24 () )
F_23 ( V_7 , V_9 ) ;
else
