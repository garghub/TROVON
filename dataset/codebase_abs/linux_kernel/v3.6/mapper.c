...
V_57 ++ ;
V_58 ++ ;
if ( V_63 && V_58 <= V_2 -> V_69 )
V_60 = 1 ;
else if ( V_2 -> V_65 > 0 &&
V_58 <= V_42 -> V_4 + V_2 -> V_65 )
V_60 = 1 ;
else if ( V_57 <= V_2 -> V_70 )
V_59 = 1 ;
else
V_61 = 1 ;
F_3 ( L_17
...
int V_71 , int V_13 , int * V_72 , int V_73 ,
const T_1 * V_48 )
{
int V_74 ;
int V_75 [ V_76 ] ;
...
struct V_88 * V_89 = & V_84 -> V_90 [ V_85 ] ;
V_53 = 0 ;
switch ( V_89 -> V_91 ) {
case V_92 :
V_29 [ 0 ] = V_89 -> V_93 ;
...
if ( V_54 )
memcpy ( V_80 , V_78 , V_81 * sizeof( * V_80 ) ) ;
V_82 = V_80 ;
V_80 = V_29 ;
V_29 = V_82 ;
V_79 = V_81 ;
break;
case V_99 :
for ( V_5 = 0 ; V_5 < V_79 && V_74 < V_73 ; V_5 ++ ) {
V_72 [ V_74 ] = V_29 [ V_5 ] ;
V_74 ++ ;
}
V_79 = 0 ;
