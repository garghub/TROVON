...
int V_155 ;
const T_3 * V_156 = & F_61 ( V_148 ) -> V_157 [ V_152 ] ;
F_62 ( V_150 > V_149 + V_145 ) ;
V_155 = V_150 + F_63 ( V_156 ) ;
if ( ( V_153 = V_155 - V_149 ) > 0 ) {
T_4 * V_158 ;
if ( V_153 > V_145 )
V_153 = V_145 ;
V_158 = F_64 ( F_65 ( V_156 ) ) ;
V_146 = F_57 ( V_158 + V_156 -> V_159 +
...
static T_1 F_69 ( const struct V_147 * V_148 , int V_145 )
{
unsigned long V_146 ;
V_146 = F_59 ( V_148 , 4 , V_145 - 4 , 0 ) ;
return V_146 ? F_28 ( ( unsigned short ) V_146 ) : F_28 ( 0xFFFF ) ;
}
static int F_70 ( struct V_65 * V_65 , struct V_160 * V_1 , int V_161 ,
int V_162 )
{
struct V_1 * V_2 ;
int V_163 = - V_164 ;
if ( ! F_45 ( V_65 , & V_100 ) )
return - V_165 ;
if ( V_1 -> type != V_166 && V_1 -> type != V_167 )
goto V_44;
V_163 = - V_130 ;
V_2 = F_71 ( V_65 , V_168 , V_43 , & V_169 ) ;
if ( ! V_2 )
goto V_44;
V_163 = 0 ;
V_1 -> V_170 = & V_171 ;
...
static int F_74 ( struct V_160 * V_1 )
{
...
static int F_79 ( struct V_1 * V_2 , struct V_5 * V_26 )
{
int V_60 ;
F_4 ( & V_4 ) ;
for ( V_26 -> V_14 = V_173 ;
...
struct V_5 V_26 ;
struct V_41 * V_176 = F_33 () ;
int V_177 = - V_133 ;
if ( ! V_176 || V_176 -> V_17 == F_28 ( V_18 ) )
goto V_44;
V_13 -> V_22 = V_26 . V_16 . V_17 = V_176 -> V_17 ;
V_13 -> V_23 = V_26 . V_16 . V_19 = V_176 -> V_19 ;
V_177 = F_79 ( V_2 , & V_26 ) ;
if ( ! V_177 )
F_81 ( V_2 , V_172 ) ;
V_44:
...
static int F_82 ( struct V_160 * V_1 , struct V_178 * V_179 , int V_180 )
{
struct V_5 * V_93 = (struct V_5 * ) V_179 ;
struct V_1 * V_2 = V_1 -> V_2 ;
struct V_12 * V_13 = F_10 ( V_2 ) ;
int V_181 ;
if ( ! F_83 ( V_2 , V_172 ) ||
V_180 != sizeof( struct V_5 ) )
return - V_85 ;
if ( V_93 -> V_86 != V_87 )
return - V_165 ;
F_76 ( V_2 ) ;
...
if ( ! V_176 )
goto V_44;
V_13 -> V_22 = V_93 -> V_16 . V_17 = V_176 -> V_17 ;
V_13 -> V_23 = V_93 -> V_16 . V_19 = V_176 -> V_19 ;
} else {
V_181 = - V_133 ;
...
static int F_84 ( struct V_160 * V_1 , struct V_178 * V_179 ,
int V_180 , int V_61 )
{
struct V_1 * V_2 = V_1 -> V_2 ;
struct V_12 * V_13 = F_10 ( V_2 ) ;
...
V_2 -> V_183 = V_184 ;
V_1 -> V_185 = V_186 ;
if ( V_180 != sizeof( * V_93 ) )
return - V_85 ;
V_93 = (struct V_5 * ) V_179 ;
if ( V_93 -> V_86 != V_87 )
return - V_165 ;
...
if ( ! F_37 ( & V_93 -> V_16 ) )
goto V_44;
V_13 -> V_191 = V_93 -> V_14 ;
V_13 -> V_192 = V_93 -> V_16 . V_17 ;
V_13 -> V_193 = V_93 -> V_16 . V_19 ;
V_1 -> V_185 = V_194 ;
V_2 -> V_183 = V_195 ;
V_181 = 0 ;
V_44:
...
static int F_86 ( struct V_160 * V_1 , struct V_178 * V_179 ,
int * V_196 , int V_197 )
{
struct V_5 V_26 ;
struct V_1 * V_2 = V_1 -> V_2 ;
...
if ( F_80 ( V_2 ) < 0 )
goto V_44;
* V_196 = sizeof( struct V_5 ) ;
memset ( & V_26 . V_126 , 0 , sizeof( V_26 . V_126 ) ) ;
if ( V_197 ) {
V_181 = - V_198 ;
if ( V_2 -> V_183 != V_195 )
goto V_44;
V_26 . V_16 . V_17 = V_13 -> V_192 ;
V_26 . V_16 . V_19 = V_13 -> V_193 ;
V_26 . V_14 = V_13 -> V_191 ;
} else {
...
V_181 = 0 ;
V_26 . V_86 = V_87 ;
memcpy ( V_179 , & V_26 , sizeof( V_26 ) ) ;
V_44:
F_78 ( V_2 ) ;
return V_181 ;
}
static T_5 int F_87 ( struct V_147 * V_148 )
{
return V_148 -> V_27 [ 12 ] == 22 ;
}
static int F_88 ( struct V_147 * V_148 )
{
struct V_33 * V_34 = F_49 ( & V_100 , L_7 ) ;
struct V_199 * V_200 ;
if ( ! V_34 ) {
F_89 ( V_148 ) ;
return V_201 ;
}
V_148 -> V_161 = F_28 ( V_202 ) ;
F_90 ( V_148 , 13 ) ;
V_148 -> V_34 = V_34 ;
F_91 ( V_148 ) ;
V_200 = F_92 ( V_34 ) ;
V_200 -> V_203 ++ ;
V_200 -> V_204 += V_148 -> V_145 + 13 ;
return F_93 ( V_148 ) ;
}
static int F_94 ( struct V_147 * V_148 , struct V_33 * V_34 ,
struct V_205 * V_206 , T_6 V_207 , int V_208 )
{
struct V_66 * V_83 ;
struct V_41 V_79 ;
if ( V_148 -> V_209 != V_210 || ! V_206 -> V_211 ) {
if ( V_34 -> type == V_124 )
F_52 ( V_127 L_8
L_9 ) ;
goto V_212;
}
V_79 . V_17 = V_206 -> V_211 ;
V_79 . V_19 = V_206 -> V_213 ;
V_83 = F_36 ( & V_79 ) ;
V_207 += 1 << 10 ;
if ( ! V_83 || ! ( V_207 & ( 15 << 10 ) ) )
goto V_212;
...
F_95 ( V_148 , F_96 (unsigned int, origlen,
(rt->dev->hard_header_len +
ddp_dl->header_length + (len_hops & 1023))) ) ;
V_206 -> V_214 = F_28 ( V_207 ) ;
if ( F_97 ( V_148 ) < 22 ) {
struct V_147 * V_215 = F_98 ( V_148 , 32 ) ;
F_89 ( V_148 ) ;
V_148 = V_215 ;
} else
V_148 = F_99 ( V_148 , V_91 ) ;
if ( V_148 == NULL )
goto V_216;
if ( F_100 ( V_83 -> V_34 , V_148 , & V_79 , NULL ) == V_217 )
return V_201 ;
return V_218 ;
V_212:
F_89 ( V_148 ) ;
...
static int F_101 ( struct V_147 * V_148 , struct V_33 * V_34 ,
struct V_219 * V_220 , struct V_33 * V_221 )
{
struct V_205 * V_206 ;
struct V_1 * V_1 ;
struct V_7 * V_8 ;
...
if ( ! F_45 ( F_46 ( V_34 ) , & V_100 ) )
goto V_216;
if ( ! ( V_148 = F_102 ( V_148 , V_91 ) ) )
goto V_44;
if ( ! F_103 ( V_148 , sizeof( * V_206 ) ) )
goto V_216;
V_206 = F_104 ( V_148 ) ;
V_207 = F_27 ( V_206 -> V_214 ) ;
V_208 = V_148 -> V_145 ;
F_95 ( V_148 , F_96 (unsigned int, skb->len, len_hops & 1023 ) ) ;
if ( V_148 -> V_145 < sizeof( * V_206 ) || V_148 -> V_145 < ( V_207 & 1023 ) ) {
F_105 ( L_10
L_11 , V_207 & 1023 , V_148 -> V_145 ) ;
goto V_216;
}
if ( V_206 -> V_223 &&
F_69 ( V_148 , V_207 & 1023 ) != V_206 -> V_223 )
goto V_216;
if ( ! V_206 -> V_211 )
V_8 = F_34 ( V_206 -> V_213 , V_34 ) ;
else
V_8 = F_35 ( V_206 -> V_211 , V_206 -> V_213 ) ;
if ( ! V_8 ) {
return F_94 ( V_148 , V_34 , V_206 , V_207 , V_208 ) ;
}
if ( F_87 ( V_148 ) )
return F_88 ( V_148 ) ;
V_222 . V_16 . V_17 = V_206 -> V_211 ;
V_222 . V_16 . V_19 = V_206 -> V_213 ;
V_222 . V_14 = V_206 -> V_224 ;
V_1 = F_7 ( & V_222 , V_8 ) ;
if ( ! V_1 )
goto V_216;
V_148 -> V_2 = V_1 ;
if ( F_106 ( V_1 , V_148 ) < 0 )
goto V_216;
return V_218 ;
V_216:
F_89 ( V_148 ) ;
...
static int F_107 ( struct V_147 * V_148 , struct V_33 * V_34 ,
struct V_219 * V_220 , struct V_33 * V_221 )
{
if ( ! F_45 ( F_46 ( V_34 ) , & V_100 ) )
goto V_225;
if ( F_108 ( V_148 ) [ 2 ] == 1 ) {
struct V_205 * V_206 ;
struct V_41 * V_176 = F_32 ( V_34 ) ;
if ( ! V_176 || V_148 -> V_145 < sizeof( T_1 ) || V_148 -> V_145 > 1023 )
goto V_225;
if ( ! ( V_148 = F_102 ( V_148 , V_91 ) ) )
return 0 ;
V_206 = (struct V_205 * ) F_109 ( V_148 , sizeof( * V_206 ) - 4 ) ;
V_206 -> V_213 = F_108 ( V_148 ) [ 0 ] ;
V_206 -> V_226 = F_108 ( V_148 ) [ 1 ] ;
V_206 -> V_211 = V_176 -> V_17 ;
V_206 -> V_227 = V_176 -> V_17 ;
V_206 -> V_223 = 0 ;
V_206 -> V_214 = F_28 ( V_148 -> V_145 + ( V_228 << 10 ) ) ;
}
F_91 ( V_148 ) ;
return F_101 ( V_148 , V_34 , V_220 , V_221 ) ;
V_225:
F_89 ( V_148 ) ;
return 0 ;
}
static int F_110 ( struct V_229 * V_230 , struct V_160 * V_1 , struct V_231 * V_232 ,
T_7 V_145 )
{
struct V_1 * V_2 = V_1 -> V_2 ;
struct V_12 * V_13 = F_10 ( V_2 ) ;
struct V_5 * V_233 = (struct V_5 * ) V_232 -> V_234 ;
int V_61 = V_232 -> V_235 ;
int V_236 = 0 ;
struct V_5 V_237 , V_238 ;
struct V_147 * V_148 ;
struct V_33 * V_34 ;
struct V_205 * V_206 ;
int V_239 ;
...
goto V_44;
V_181 = - V_85 ;
if ( V_232 -> V_244 < sizeof( * V_233 ) ||
V_233 -> V_86 != V_87 )
goto V_44;
V_181 = - V_120 ;
if ( V_233 -> V_16 . V_19 == V_20 &&
! F_83 ( V_2 , V_187 ) ) {
goto V_44;
}
} else {
...
V_233 = & V_237 ;
V_233 -> V_86 = V_87 ;
V_233 -> V_14 = V_13 -> V_191 ;
V_233 -> V_16 . V_19 = V_13 -> V_193 ;
V_233 -> V_16 . V_17 = V_13 -> V_192 ;
}
F_111 ( V_2 , L_12 , V_2 ) ;
V_239 = sizeof( struct V_205 ) + V_145 + V_245 -> V_246 ;
if ( V_233 -> V_16 . V_17 || V_233 -> V_16 . V_19 == V_24 ) {
V_83 = F_36 ( & V_233 -> V_16 ) ;
} else {
struct V_41 V_247 ;
V_247 . V_19 = 0 ;
...
V_34 = V_83 -> V_34 ;
F_111 ( V_2 , L_13 ,
V_2 , V_239 , V_34 -> V_143 ) ;
V_239 += V_34 -> V_248 ;
F_78 ( V_2 ) ;
V_148 = F_112 ( V_2 , V_239 , ( V_61 & V_240 ) , & V_181 ) ;
F_76 ( V_2 ) ;
if ( ! V_148 )
goto V_44;
V_148 -> V_2 = V_2 ;
F_113 ( V_148 , V_245 -> V_246 ) ;
F_113 ( V_148 , V_34 -> V_248 ) ;
V_148 -> V_34 = V_34 ;
F_111 ( V_2 , L_14 , V_2 ) ;
V_206 = (struct V_205 * ) F_114 ( V_148 , sizeof( struct V_205 ) ) ;
V_206 -> V_214 = F_28 ( V_145 + sizeof( * V_206 ) ) ;
V_206 -> V_211 = V_233 -> V_16 . V_17 ;
V_206 -> V_227 = V_13 -> V_22 ;
V_206 -> V_213 = V_233 -> V_16 . V_19 ;
V_206 -> V_226 = V_13 -> V_23 ;
V_206 -> V_224 = V_233 -> V_14 ;
V_206 -> V_249 = V_13 -> V_15 ;
F_111 ( V_2 , L_15 , V_2 , V_145 ) ;
V_181 = F_115 ( F_114 ( V_148 , V_145 ) , V_232 -> V_250 , V_145 ) ;
if ( V_181 ) {
F_89 ( V_148 ) ;
V_181 = - V_114 ;
goto V_44;
...
V_206 -> V_223 = F_69 ( V_148 , V_145 + sizeof( * V_206 ) ) ;
if ( V_206 -> V_213 == V_20 &&
! ( V_83 -> V_61 & V_94 ) && ! ( V_34 -> V_61 & V_62 ) ) {
struct V_147 * V_252 = F_116 ( V_148 , V_43 ) ;
if ( V_252 ) {
V_236 = 1 ;
F_111 ( V_2 , L_16 , V_2 ) ;
F_100 ( V_34 , V_252 , & V_233 -> V_16 , NULL ) ;
}
}
if ( V_34 -> V_61 & V_62 || V_236 ) {
F_111 ( V_2 , L_17 , V_2 ) ;
F_117 ( V_148 ) ;
if ( V_206 -> V_213 == V_20 ) {
struct V_41 V_253 ;
...
F_111 ( V_2 , L_18 , V_2 ) ;
if ( V_83 -> V_61 & V_94 ) {
V_238 . V_16 = V_83 -> V_76 ;
V_233 = & V_238 ;
}
F_100 ( V_34 , V_148 , & V_233 -> V_16 , NULL ) ;
}
F_111 ( V_2 , L_19 , V_2 , V_145 ) ;
V_44:
F_78 ( V_2 ) ;
return V_181 ? : V_145 ;
}
static int F_118 ( struct V_229 * V_230 , struct V_160 * V_1 , struct V_231 * V_232 ,
T_7 V_239 , int V_61 )
{
struct V_1 * V_2 = V_1 -> V_2 ;
struct V_5 * V_26 = (struct V_5 * ) V_232 -> V_234 ;
struct V_205 * V_206 ;
int V_256 = 0 ;
int V_149 = 0 ;
int V_181 = 0 ;
struct V_147 * V_148 ;
V_148 = F_119 ( V_2 , V_61 & ~ V_240 ,
V_61 & V_240 , & V_181 ) ;
F_76 ( V_2 ) ;
if ( ! V_148 )
goto V_44;
V_206 = F_104 ( V_148 ) ;
V_256 = F_27 ( V_206 -> V_214 ) & 1023 ;
if ( V_2 -> V_257 != V_166 ) {
V_149 = sizeof( * V_206 ) ;
V_256 -= V_149 ;
}
...
V_181 = F_120 ( V_148 , V_149 , V_232 -> V_250 , V_256 ) ;
if ( ! V_181 ) {
if ( V_26 ) {
V_26 -> V_86 = V_87 ;
V_26 -> V_14 = V_206 -> V_249 ;
V_26 -> V_16 . V_19 = V_206 -> V_226 ;
V_26 -> V_16 . V_17 = V_206 -> V_227 ;
}
V_232 -> V_244 = sizeof( * V_26 ) ;
}
F_121 ( V_2 , V_148 ) ;
V_44:
F_78 ( V_2 ) ;
...
static int F_122 ( struct V_160 * V_1 , unsigned int V_103 , unsigned long V_104 )
{
int V_163 = - V_259 ;
struct V_1 * V_2 = V_1 -> V_2 ;
...
switch ( V_103 ) {
case V_261 : {
long V_262 = V_2 -> V_263 - F_123 ( V_2 ) ;
if ( V_262 < 0 )
V_262 = 0 ;
V_163 = F_124 ( V_262 , ( int T_2 * ) V_260 ) ;
break;
}
case V_264 : {
struct V_147 * V_148 = F_125 ( & V_2 -> V_32 ) ;
long V_262 = 0 ;
if ( V_148 )
V_262 = V_148 -> V_145 - sizeof( struct V_205 ) ;
V_163 = F_124 ( V_262 , ( int T_2 * ) V_260 ) ;
break;
}
case V_265 :
V_163 = F_126 ( V_2 , V_260 ) ;
break;
case V_266 :
V_163 = F_127 ( V_2 , V_260 ) ;
break;
case V_141 :
case V_139 :
V_163 = - V_120 ;
if ( F_51 ( V_119 ) )
V_163 = F_56 ( V_103 , V_260 ) ;
break;
case V_132 :
case V_118 :
case V_134 :
...
case V_138 :
F_128 () ;
V_163 = F_47 ( V_103 , V_260 ) ;
F_129 () ;
break;
}
return V_163 ;
}
static int F_130 ( struct V_160 * V_1 , unsigned int V_103 , unsigned long V_104 )
{
if ( V_103 == V_135 )
return F_122 ( V_1 , V_103 , ( unsigned long ) F_131 ( V_104 ) ) ;
return - V_259 ;
}
static int T_8 F_132 ( void )
{
int V_163 = F_133 ( & V_169 , 0 ) ;
if ( V_163 != 0 )
goto V_44;
( void ) F_134 ( & V_267 ) ;
V_245 = F_135 ( V_268 , F_101 ) ;
if ( ! V_245 )
F_52 ( V_269 ) ;
F_136 ( & V_270 ) ;
F_136 ( & V_271 ) ;
