...
unsigned char * V_40 = V_8 -> V_9 ;
V_8 -> V_7 = V_5 -> V_6 -> V_7 ;
switch ( V_5 -> type ) {
case V_24 :
if ( V_5 -> V_41 ) {
V_5 -> V_41 ( V_5 -> V_36 , V_8 ) ;
} else {
unsigned int V_42 = 0 ;
for ( V_39 = 0 ; V_39 < V_38 -> V_43 ; ++ V_39 ) {
int V_44 ;
if ( V_38 -> V_45 [ V_39 ] )
V_44 = V_38 -> V_45 [ V_39 ] ;
else
V_44 = F_9 ( V_5 ) ;
V_8 -> V_46 [ V_39 ] . V_47 = V_42 * V_5 -> V_48 ;
V_8 -> V_46 [ V_39 ] . V_49 = V_44 * V_5 -> V_48 ;
V_42 += V_44 ;
}
V_8 -> V_50 = V_38 -> V_43 ;
V_8 -> V_51 = V_42 * V_5 -> V_48 ;
memset ( V_8 -> V_9 , V_5 -> V_52 ,
V_42 * V_5 -> V_48 ) ;
}
break;
case V_53 :
if ( F_17 ( V_5 -> V_6 -> V_7 ) >= V_54 ) {
V_8 -> V_46 [ 0 ] . V_49 = 4 ;
V_8 -> V_46 [ 0 ] . V_47 = 0 ;
V_40 [ 0 ] = V_5 -> V_55 ;
V_40 [ 1 ] = V_5 -> V_55 >> 8 ;
...
static inline void F_18 ( struct V_22 * V_5 ,
struct V_2 * V_34 )
{
int V_39 , V_42 ;
struct V_8 * V_8 = V_34 -> V_8 ;
...
case V_24 :
V_42 = 0 ;
for ( V_39 = 0 ; V_39 < V_34 -> V_43 ; V_39 ++ ) {
V_8 -> V_46 [ V_39 ] . V_47 = V_42 ;
...
F_23 ( & V_38 -> V_67 ) ;
V_8 = V_38 -> V_8 ;
for ( V_39 = 0 ; V_39 < V_61 -> V_43 ; V_39 ++ )
V_38 -> V_45 [ V_39 ] = V_61 -> V_45 [ V_39 ] ;
F_16 ( V_5 , V_38 ) ;
V_11 = F_24 ( V_38 -> V_8 , V_68 ) ;
if ( V_11 < 0 )
F_25 ( V_69 L_9 ,
V_38 -> V_70 , V_11 , V_38 -> V_8 ) ;
else
F_26 ( V_38 -> V_70 , & V_5 -> V_71 ) ;
}
}
...
if ( F_8 ( V_5 -> V_25 ) ) {
F_13 ( V_5 , V_38 ) ;
if ( F_28 ( ! F_20 ( V_58 , & V_5 -> V_26 ) ) )
goto V_76;
if ( F_7 ( V_5 ) ) {
unsigned long V_26 ;
F_10 ( & V_5 -> V_30 , V_26 ) ;
F_29 ( & V_38 -> V_67 , & V_5 -> V_66 ) ;
F_12 ( & V_5 -> V_30 , V_26 ) ;
F_19 ( V_5 ) ;
goto V_76;
}
...
F_32 ( & V_6 -> V_86 ) ;
F_33 (p, &chip->ep_list) {
V_5 = F_34 ( V_83 , struct V_22 , V_87 ) ;
if ( V_5 -> V_80 == V_80 &&
...
if ( type == V_53 ) {
if ( F_41 ( V_79 , 1 ) -> V_97 >= V_98 &&
F_41 ( V_79 , 1 ) -> V_99 >= 1 &&
F_41 ( V_79 , 1 ) -> V_99 <= 9 )
V_5 -> V_100 = F_41 ( V_79 , 1 ) -> V_99 ;
else if ( F_17 ( V_6 -> V_7 ) == V_101 )
V_5 -> V_100 = 1 ;
else if ( F_41 ( V_79 , 1 ) -> V_102 >= 1 &&
F_41 ( V_79 , 1 ) -> V_102 <= 16 )
V_5 -> V_100 = F_41 ( V_79 , 1 ) -> V_102 - 1 ;
else
V_5 -> V_100 = 3 ;
V_5 -> V_57 = F_42 ( F_41 ( V_79 , 1 ) -> V_103 ) ;
}
F_29 ( & V_5 -> V_87 , & V_6 -> V_104 ) ;
V_94:
F_43 ( & V_6 -> V_86 ) ;
return V_5 ;
}
...
{
unsigned long V_105 = V_106 + F_45 ( 1000 ) ;
unsigned int V_39 ;
int V_107 ;
do {
V_107 = 0 ;
for ( V_39 = 0 ; V_39 < V_5 -> V_108 ; V_39 ++ )
if ( F_20 ( V_39 , & V_5 -> V_71 ) )
V_107 ++ ;
if ( ! V_107 )
break;
F_46 ( 1 ) ;
} while ( F_47 ( V_106 , V_105 ) );
if ( V_107 )
F_25 ( V_69 L_17 ,
V_107 , V_5 -> V_80 ) ;
return 0 ;
}
static int F_48 ( struct V_22 * V_5 , int V_109 , int V_110 )
{
unsigned int V_39 ;
int V_111 ;
...
int V_127 = F_55 ( V_119 ) ;
int V_128 = F_56 ( V_119 ) ;
int V_84 = F_8 ( V_5 -> V_25 ) ;
int V_129 = F_57 ( F_56 ( V_119 ) ) *
F_58 ( V_119 ) ;
V_5 -> V_33 = V_121 -> V_33 ;
V_5 -> V_48 = V_129 >> 3 ;
...
V_5 -> V_56 = V_123 ;
if ( F_17 ( V_5 -> V_6 -> V_7 ) != V_101 )
V_126 = 8 >> V_5 -> V_33 ;
else
V_126 = 1 ;
if ( V_84 && ! F_7 ( V_5 ) ) {
V_124 = F_59 ( V_5 -> V_6 -> V_133 , 1 ) ;
...
V_136 = F_59 ( V_137 * V_126 , V_124 * 2 ) ;
...
V_3 -> V_70 = V_39 ;
V_3 -> V_5 = V_5 ;
V_3 -> V_43 = ( V_39 + 1 ) * V_125 / V_5 -> V_108
- V_39 * V_125 / V_5 -> V_108 ;
V_3 -> V_4 = V_123 * V_3 -> V_43 ;
if ( V_121 -> V_138 == V_139 )
V_3 -> V_43 ++ ;
V_3 -> V_8 = F_60 ( V_3 -> V_43 , V_95 ) ;
if ( ! V_3 -> V_8 )
goto V_140;
V_3 -> V_8 -> V_9 =
...
{
int V_39 ;
V_5 -> V_115 = F_61 ( V_5 -> V_6 -> V_7 , V_116 * 4 ,
V_95 , & V_5 -> V_117 ) ;
if ( ! V_5 -> V_115 )
return - V_146 ;
...
if ( F_17 ( V_5 -> V_6 -> V_7 ) == V_101 )
V_5 -> V_55 = F_1 ( F_64 ( V_119 ) ) ;
else
V_5 -> V_55 = F_2 ( F_64 ( V_119 ) ) ;
V_5 -> V_32 = V_5 -> V_55 ;
V_5 -> V_152 = V_153 ;
V_5 -> V_31 = 0 ;
switch ( V_5 -> type ) {
case V_24 :
V_11 = F_54 ( V_5 , V_119 , V_121 , V_122 ) ;
break;
case V_53 :
V_11 = F_62 ( V_5 , V_119 , V_121 ) ;
break;
default:
V_11 = - V_18 ;
}
...
int F_65 ( struct V_22 * V_5 , int V_110 )
{
int V_11 ;
unsigned int V_39 ;
if ( V_5 -> V_6 -> V_75 )
...
void F_69 ( struct V_82 * V_157 )
{
struct V_22 * V_5 ;
V_5 = F_34 ( V_157 , struct V_22 , V_87 ) ;
F_53 ( V_5 , 1 ) ;
F_70 ( V_5 ) ;
}
...
struct V_59 * V_163 ;
V_162 = V_8 -> V_72 ;
for ( V_39 = 0 ; V_39 < V_162 -> V_43 ; V_39 ++ )
...
V_160 >>= - V_5 -> V_152 ;
if ( F_72 ( V_160 >= V_5 -> V_55 - V_5 -> V_55 / 8 && V_160 <= V_5 -> V_132 ) ) {
F_10 ( & V_5 -> V_30 , V_26 ) ;
V_5 -> V_32 = V_160 ;
F_12 ( & V_5 -> V_30 , V_26 ) ;
} else {
