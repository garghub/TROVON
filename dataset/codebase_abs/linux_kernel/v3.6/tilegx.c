...
V_2 = F_116 ( V_32 , & V_39 -> V_155 , L_32 ) ;
if ( V_2 < 0 )
goto V_138;
V_39 -> V_51 = V_2 ;
V_2 = F_116 ( V_32 , & V_39 -> V_161 , L_33 ) ;
if ( V_2 < 0 )
goto V_138;
V_39 -> V_162 = V_2 ;
V_39 -> V_88 = V_2 ;
...
unsigned int V_174 = V_15 -> V_174 + V_15 -> V_175 - V_173 ;
unsigned int V_176 = V_172 -> V_177 ;
long V_178 = - 1 ;
long V_179 = V_15 -> V_175 ;
long V_180 = V_173 ;
long V_65 ;
int V_169 = 0 ;
int V_181 ;
for ( V_181 = 0 ; V_181 < V_172 -> V_182 ; V_181 ++ ) {
unsigned int V_183 = 0 ;
for ( V_169 ++ ; V_183 < V_176 ; V_169 ++ ) {
while ( V_180 >= V_179 ) {
V_178 ++ ;
V_179 = V_172 -> V_184 [ V_178 ] . V_48 ;
V_180 = 0 ;
}
V_65 = V_176 - V_183 ;
if ( V_65 > V_179 - V_180 )
...
static void F_138 ( struct V_14 * V_15 , unsigned char * V_143 ,
T_13 V_170 )
{
struct V_171 * V_172 = F_135 ( V_15 ) ;
struct V_185 * V_186 ;
...
( 0xFFFF - V_186 -> V_196 ) +
( 0xFFFF - V_186 -> V_193 ) ) ;
V_192 = V_188 -> V_195 + ( 0xFFFF ^ F_142 ( V_173 + V_174 ) ) ;
V_193 = F_143 ( V_186 -> V_193 ) ;
V_194 = F_144 ( V_188 -> V_194 ) ;
for ( V_181 = 0 ; V_181 < V_172 -> V_182 ; V_181 ++ ) {
unsigned char * V_1 ;
unsigned int V_183 = 0 ;
...
V_186 -> V_196 = F_142 ( V_173 + V_176 - V_189 ) ;
V_186 -> V_193 = F_142 ( V_193 ) ;
V_186 -> V_195 = F_145 ( V_191 + V_186 -> V_196 +
V_186 -> V_193 ) ^ 0xffff ;
V_188 = (struct V_187 * ) ( V_1 + V_190 ) ;
V_188 -> V_194 = F_146 ( V_194 ) ;
V_188 -> V_195 = F_145 ( V_192 + F_142 ( V_173 + V_176 ) ) ;
if ( V_181 != V_172 -> V_182 - 1 ) {
V_188 -> V_197 = 0 ;
V_188 -> V_198 = 0 ;
}
V_170 ++ ;
...
static void F_147 ( struct V_31 * V_32 , T_5 * V_72 ,
...
V_180 += V_65 ;
V_183 += V_65 ;
V_200 . V_21 = F_16 ( V_201 ) + V_180 ;
V_200 . V_208 = V_65 ;
V_200 . V_210 = ! ( V_183 < V_176 ) ;
F_149 ( V_72 , V_200 , V_170 ) ;
V_170 ++ ;
}
V_202 ++ ;
V_203 += V_173 + V_176 ;
...
static int F_150 ( struct V_14 * V_15 , struct V_31 * V_32 )
{
struct V_24 * V_25 = & F_24 ( V_26 ) ;
struct V_38 * V_39 = F_30 ( V_32 ) ;
int V_51 = V_39 -> V_88 ;
...
V_169 = F_134 ( V_15 ) ;
F_57 ( V_99 ) ;
V_170 = F_132 ( V_32 , V_15 -> V_211 , V_74 ,
V_72 , V_169 ) ;
if ( V_170 < 0 ) {
F_58 ( V_99 ) ;
return V_212 ;
}
F_138 ( V_15 , V_103 -> V_143 , V_170 ) ;
F_147 ( V_32 , V_72 , V_15 , V_103 -> V_143 , V_170 ) ;
F_47 ( V_72 , V_74 , V_170 + V_169 - 1 , V_15 ) ;
F_58 ( V_99 ) ;
F_55 () ;
return V_213 ;
}
static unsigned int F_151 ( struct V_214 * V_184 ,
struct V_14 * V_15 ,
...
for ( V_64 = 0 ; V_64 < V_172 -> V_218 ; V_64 ++ ) {
T_12 * V_166 = & V_172 -> V_184 [ V_64 ] ;
V_184 [ V_65 ] . V_1 = F_130 ( V_166 ) ;
V_184 [ V_65 ++ ] . V_217 = F_152 ( V_166 ) ;
}
return V_65 ;
}
static int F_153 ( struct V_14 * V_15 , struct V_31 * V_32 )
{
struct V_24 * V_25 = & F_24 ( V_26 ) ;
struct V_38 * V_39 = F_30 ( V_32 ) ;
...
T_13 V_170 ;
if ( F_154 ( V_15 ) )
return F_150 ( V_15 , V_32 ) ;
V_169 = F_151 ( V_184 , V_15 , V_19 , F_155 ( V_15 ) ) ;
V_220 . V_209 = V_12 ;
...
V_142 [ V_169 - 1 ] . V_210 = 1 ;
if ( V_15 -> V_43 == V_221 ) {
unsigned int V_204 = F_148 ( V_15 ) ;
V_142 [ 0 ] . V_205 = 1 ;
V_142 [ 0 ] . V_204 = V_204 ;
V_142 [ 0 ] . V_206 = V_204 + V_15 -> V_207 ;
}
F_57 ( V_99 ) ;
V_170 = F_132 ( V_32 , V_15 -> V_211 , V_74 ,
V_72 , V_169 ) ;
...
static void F_168 ( const char * V_160 , const T_3 * V_242 )
{
int V_243 ;
int V_64 ;
int V_244 = 0 ;
...
F_176 ( & V_158 ) ;
F_177 ( F_174 , NULL , 1 ) ;
for ( V_64 = 0 ; F_178 ( V_64 , V_160 , V_242 ) >= 0 ; V_64 ++ )
F_168 ( V_160 , V_242 ) ;
if ( ! F_1 () )
V_4 = * V_247 ;
return 0 ;
