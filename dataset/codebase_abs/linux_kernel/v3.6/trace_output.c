...
static int
F_43 ( struct V_3 * V_4 , T_4 V_86 ,
unsigned long V_87 )
{
return F_8 ( V_4 , L_19 , V_86 ,
V_87 > V_88 ? '!' :
V_87 > 1 ? '+' : ' ' ) ;
}
...
struct V_3 * V_4 = & V_11 -> V_12 ;
struct V_13 * V_14 = V_11 -> V_15 ;
unsigned long long V_89 = F_45 ( V_11 -> V_90 ) ;
unsigned long V_91 = F_46 ( V_89 , V_92 ) ;
unsigned long V_93 = ( unsigned long ) V_89 ;
char V_83 [ V_84 ] ;
int V_7 ;
F_42 ( V_14 -> V_85 , V_83 ) ;
V_7 = F_8 ( V_4 , L_20 ,
...
* V_97 = F_48 ( V_11 , NULL ,
& V_95 ) ;
unsigned long V_98 = ( V_62 & V_99 ) ;
unsigned long V_86 = F_45 ( V_11 -> V_90 - V_11 -> V_100 -> V_101 ) ;
unsigned long V_87 ;
V_11 -> V_96 = V_96 ;
if ( ! V_97 )
V_95 = V_11 -> V_90 ;
V_87 = F_45 ( V_95 - V_11 -> V_90 ) ;
if ( V_98 ) {
char V_83 [ V_84 ] ;
F_42 ( V_14 -> V_85 , V_83 ) ;
V_7 = F_8 ( V_4 , L_22
L_23 , V_83 ,
V_14 -> V_85 , V_11 -> V_82 , V_14 -> V_32 ,
V_14 -> V_81 , V_11 -> V_102 ,
F_45 ( V_11 -> V_90 ) ,
V_86 / V_103 ,
V_86 % V_103 ,
V_87 / V_103 ,
...
if ( V_7 )
V_7 = F_43 ( V_4 , V_86 , V_87 ) ;
}
return V_7 ;
}
static int F_49 ( unsigned long V_104 )
{
int V_105 = V_104 ? F_50 ( V_104 ) + 1 : 0 ;
return V_105 < sizeof( V_106 ) - 1 ? V_106 [ V_105 ] : '?' ;
}
struct V_107 * F_51 ( int type )
{
struct V_107 * V_108 ;
struct V_109 * V_110 ;
unsigned V_111 ;
...
if ( F_60 ( F_51 ( V_108 -> type ) ) )
goto V_121;
F_62 ( & V_108 -> V_114 , V_114 ) ;
} else if ( V_108 -> type > V_117 ) {
F_63 ( V_124 L_24 ) ;
F_60 ( 1 ) ;
goto V_121;
} else {
...
if ( V_108 -> V_122 -> V_125 == NULL )
V_108 -> V_122 -> V_125 = V_126 ;
if ( V_108 -> V_122 -> V_127 == NULL )
V_108 -> V_122 -> V_127 = V_126 ;
if ( V_108 -> V_122 -> V_128 == NULL )
V_108 -> V_122 -> V_128 = V_126 ;
if ( V_108 -> V_122 -> V_25 == NULL )
V_108 -> V_122 -> V_25 = V_126 ;
V_111 = V_108 -> type & ( V_112 - 1 ) ;
F_64 ( & V_108 -> V_129 , & V_130 [ V_111 ] ) ;
V_7 = V_108 -> type ;
V_121:
F_65 ( & V_120 ) ;
return V_7 ;
}
int F_66 ( struct V_107 * V_108 )
{
F_67 ( & V_108 -> V_129 ) ;
F_68 ( & V_108 -> V_114 ) ;
return 0 ;
...
enum V_9 V_126 ( struct V_10 * V_11 , int V_32 ,
struct V_107 * V_108 )
{
...
int V_136 , V_137 ;
F_5 ( V_17 , V_11 -> V_15 ) ;
V_137 = F_49 ( V_17 -> V_138 ) ;
V_136 = F_49 ( V_17 -> V_139 ) ;
F_42 ( V_17 -> V_140 , V_83 ) ;
if ( ! F_8 ( & V_11 -> V_12 ,
L_28 ,
V_17 -> V_141 ,
V_17 -> V_142 ,
...
int V_32 , struct V_107 * V_108 )
{
return F_76 ( V_11 , L_30 ) ;
}
static int F_79 ( struct V_10 * V_11 , char V_136 )
{
struct V_135 * V_17 ;
int V_137 ;
F_5 ( V_17 , V_11 -> V_15 ) ;
...
static int F_82 ( struct V_10 * V_11 , char V_136 )
{
struct V_135 * V_17 ;
struct V_3 * V_4 = & V_11 -> V_12 ;
int V_137 ;
...
unsigned long * V_146 ;
F_5 ( V_17 , V_11 -> V_15 ) ;
V_146 = ( unsigned long * ) ( ( long ) V_11 -> V_15 + V_11 -> V_96 ) ;
if ( ! F_11 ( V_4 , L_32 ) )
goto V_132;
for ( V_30 = V_17 -> V_68 ; V_30 && * V_30 != V_69 && V_30 < V_146 ; V_30 ++ ) {
if ( ! F_11 ( V_4 , L_13 ) )
goto V_132;
...
struct V_22 * V_17 ;
F_5 ( V_17 , V_11 -> V_15 ) ;
if ( ! F_8 ( & V_11 -> V_12 , L_37 , V_17 -> V_49 , V_17 -> V_19 ) )
goto V_132;
return V_21 ;
V_132:
return V_20 ;
