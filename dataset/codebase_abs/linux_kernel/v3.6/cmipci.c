...
static int F_184 ( struct V_222 * V_317 )
{
struct V_346 * V_232 = F_185 ( V_317 ) ;
struct V_282 * V_149 = F_186 ( V_317 ) ;
...
V_2 -> V_390 [ V_10 ] = F_101 ( V_2 , V_390 [ V_10 ] ) ;
F_1 ( V_2 , V_103 , 0 ) ;
F_155 ( V_232 ) ;
F_189 ( V_232 ) ;
F_190 ( V_232 , V_391 ) ;
...
static int F_191 ( struct V_222 * V_317 )
{
struct V_346 * V_232 = F_185 ( V_317 ) ;
struct V_282 * V_149 = F_186 ( V_317 ) ;
struct V_1 * V_2 = V_149 -> V_185 ;
...
for ( V_10 = 0 ; V_10 < F_18 ( V_390 ) ; V_10 ++ )
F_100 ( V_2 , V_390 [ V_10 ] , V_2 -> V_390 [ V_10 ] ) ;
F_187 ( V_149 , V_393 ) ;
return 0 ;
}
