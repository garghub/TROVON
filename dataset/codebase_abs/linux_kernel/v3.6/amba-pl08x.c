...
F_56 ( & V_9 -> V_4 , & V_136 ) ;
while ( ! F_57 ( & V_136 ) ) {
V_28 = F_58 ( & V_136 , struct V_5 , V_8 . V_31 ) ;
F_11 ( & V_28 -> V_8 . V_31 ) ;
F_53 ( & V_28 -> V_8 ) ;
}
}
...
static T_1 F_68 ( T_4 V_37 , T_4 V_38 )
{
T_1 V_39 = 0 ;
...
static T_1 F_70 ( enum V_151 V_124 )
{
switch ( V_124 ) {
case V_152 :
return V_56 ;
...
static T_1 F_71 ( T_1 V_155 )
{
int V_66 ;
for ( V_66 = 0 ; V_66 < F_72 ( V_156 ) ; V_66 ++ )
...
{
struct V_5 * V_28 = F_78 ( sizeof( * V_28 ) , V_111 ) ;
if ( V_28 ) {
F_79 ( & V_28 -> V_171 ) ;
V_28 -> V_40 = V_49 |
V_50 ;
...
V_109 = F_78 ( sizeof( struct V_108 ) , V_111 ) ;
if ( ! V_109 ) {
F_46 ( V_25 , V_28 ) ;
...
return F_82 ( & V_9 -> V_4 , & V_28 -> V_8 , V_65 ) ;
}
...
V_28 -> V_39 = V_39 | F_68 ( V_187 , V_188 ) ;
if ( V_9 -> V_170 . V_194 )
...
F_81 ( & V_109 -> V_31 , & V_28 -> V_171 ) ;
V_109 -> V_101 = F_84 ( V_184 ) ;
if ( V_182 == V_189 ) {
V_109 -> V_116 = F_86 ( V_184 ) ;
V_109 -> V_117 = V_185 ;
} else {
V_109 -> V_116 = V_185 ;
V_109 -> V_117 = F_86 ( V_184 ) ;
}
}
V_13 = F_40 ( V_9 -> V_12 , V_28 ) ;
if ( ! V_13 ) {
...
static int F_87 ( struct V_2 * V_3 , enum V_201 V_202 ,
unsigned long V_203 )
{
struct V_1 * V_9 = F_1 ( V_3 ) ;
struct V_24 * V_25 = V_9 -> V_12 ;
...
bool F_88 ( struct V_2 * V_3 , void * V_209 )
{
struct V_1 * V_9 ;
char * V_72 = V_209 ;
...
static T_6 F_90 ( int V_215 , void * V_35 )
{
...
static void F_92 ( struct V_1 * V_3 )
{
V_3 -> V_134 = true ;
...
static const char * F_98 ( enum V_231 V_73 )
{
switch ( V_73 ) {
case V_80 :
return L_49 ;
...
static int F_99 ( struct V_232 * V_233 , void * V_234 )
{
...
static int F_101 ( struct V_236 * V_236 , struct V_237 * V_237 )
{
return F_102 ( V_237 , F_99 , V_236 -> V_238 ) ;
}
static void F_103 ( struct V_24 * V_25 )
{
( void ) F_104 ( F_105 ( & V_25 -> V_34 -> V_35 ) ,
V_239 | V_240 , NULL , V_25 ,
& V_241 ) ;
}
static inline void F_103 ( struct V_24 * V_25 )
{
}
static int F_106 ( struct V_242 * V_34 , const struct V_243 * V_36 )
{
struct V_24 * V_25 ;
const struct V_244 * V_8 = V_36 -> V_234 ;
int V_13 = 0 ;
int V_66 ;
V_13 = F_107 ( V_34 , NULL ) ;
if ( V_13 )
return V_13 ;
V_25 = F_78 ( sizeof( * V_25 ) , V_226 ) ;
if ( ! V_25 ) {
V_13 = - V_227 ;
goto V_245;
}
F_108 ( V_246 , V_25 -> memcpy . V_247 ) ;
V_25 -> memcpy . V_35 = & V_34 -> V_35 ;
V_25 -> memcpy . V_248 = F_59 ;
V_25 -> memcpy . V_249 = F_60 ;
V_25 -> memcpy . V_250 = F_80 ;
V_25 -> memcpy . V_251 = F_63 ;
V_25 -> memcpy . V_252 = F_64 ;
V_25 -> memcpy . V_253 = F_75 ;
V_25 -> memcpy . V_254 = F_87 ;
F_108 ( V_255 , V_25 -> V_134 . V_247 ) ;
V_25 -> V_134 . V_35 = & V_34 -> V_35 ;
V_25 -> V_134 . V_248 = F_59 ;
V_25 -> V_134 . V_249 = F_60 ;
V_25 -> V_134 . V_251 = F_63 ;
V_25 -> V_134 . V_252 = F_64 ;
V_25 -> V_134 . V_253 = F_75 ;
V_25 -> V_134 . V_256 = F_83 ;
V_25 -> V_134 . V_254 = F_87 ;
V_25 -> V_11 = F_109 ( & V_34 -> V_35 ) ;
if ( ! V_25 -> V_11 ) {
F_42 ( & V_34 -> V_35 , L_65 ) ;
goto V_257;
}
...
V_25 -> V_110 = F_110 ( V_258 , & V_25 -> V_34 -> V_35 ,
V_259 , V_260 , 0 ) ;
if ( ! V_25 -> V_110 ) {
V_13 = - V_227 ;
goto V_261;
}
V_25 -> V_21 = F_111 ( V_34 -> V_262 . V_263 , F_112 ( & V_34 -> V_262 ) ) ;
if ( ! V_25 -> V_21 ) {
V_13 = - V_227 ;
goto V_264;
}
...
V_13 = F_113 ( V_34 -> V_215 [ 0 ] , F_90 , V_265 ,
V_258 , V_25 ) ;
if ( V_13 ) {
F_42 ( & V_34 -> V_35 , L_66 ,
V_112 , V_34 -> V_215 [ 0 ] ) ;
...
V_25 -> V_68 = F_78 ( ( V_8 -> V_67 * sizeof( * V_25 -> V_68 ) ) ,
V_226 ) ;
if ( ! V_25 -> V_68 ) {
F_42 ( & V_34 -> V_35 , L_67
L_68 ,
...
V_19 -> V_36 = V_66 ;
V_19 -> V_21 = V_25 -> V_21 + F_114 ( V_66 ) ;
F_115 ( & V_19 -> V_69 ) ;
if ( V_8 -> V_213 ) {
T_1 V_20 ;
V_20 = F_8 ( V_19 -> V_21 + V_22 ) ;
if ( V_20 & ( V_268 | V_269 ) ) {
F_96 ( & V_34 -> V_35 , L_69 , V_66 ) ;
V_19 -> V_70 = true ;
}
}
F_28 ( & V_34 -> V_35 , L_70 ,
...
V_13 = F_93 ( V_25 , & V_25 -> memcpy ,
V_25 -> V_8 -> V_67 , false ) ;
if ( V_13 <= 0 ) {
F_116 ( & V_25 -> V_34 -> V_35 ,
L_73 ,
V_112 , V_13 ) ;
goto V_270;
}
V_25 -> memcpy . V_271 = V_13 ;
V_13 = F_93 ( V_25 , & V_25 -> V_134 ,
...
F_118 ( V_34 , V_25 ) ;
F_103 ( V_25 ) ;
F_96 ( & V_25 -> V_34 -> V_35 , L_77 ,
F_119 ( V_34 ) , F_120 ( V_34 ) ,
...
V_137 = F_127 ( & V_211 ) ;
if ( V_137 )
F_128 (KERN_WARNING DRIVER_NAME
L_78 ,
retval) ;
return V_137 ;
}
