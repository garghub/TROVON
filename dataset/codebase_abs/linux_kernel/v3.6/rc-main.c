...
if ( ! V_89 && ! V_90 && ! strncasecmp ( V_80 , V_94 , sizeof( V_94 ) ) ) {
V_80 += sizeof( V_94 ) ;
V_91 = 0 ;
V_92 ++ ;
} else {
...
static int F_61 ( struct V_73 * V_73 , struct V_96 * V_97 )
{
struct V_25 * V_26 = F_53 ( V_73 ) ;
if ( ! V_26 || ! V_26 -> V_35 )
return - V_86 ;
