...
static T_4 int F_41 ( struct V_22 * V_22 , char * V_95 )
{
struct V_54 T_5 * V_55 ;
int V_36 ;
...
V_25 . V_39 |= V_34 ;
F_41 ( & V_25 , L_2 ) ;
F_46 ( V_99 , F_39 , 0 , L_3 ) ;
F_47 ( V_100 L_4 , V_48 ) ;
return 0 ;
}
static T_4 int F_45 ( void ) { return 0 ; }
static T_4 V_91 F_48 ( void )
{
V_91 V_84 ;
unsigned int V_101 ;
if ( ! F_49 ( V_102 ) )
return 0 ;
V_101 = F_50 ( 0x80000000 ) ;
if ( V_101 < V_103 )
return V_104 ;
V_84 = F_50 ( V_103 ) ;
if ( ! ( V_84 & V_105 ) )
...
break;
++ V_116 ;
F_62 ( V_115 , V_120 , V_113
| V_111 ) ;
F_63 ( V_115 , V_120 , & V_117 ) ;
if ( V_117 != ( V_113 | V_111 ) ) {
F_64 ( V_115 ) ;
F_47 ( V_121 L_7
L_8 , V_117 ) ;
return - V_38 ;
...
static void F_68 ( void * V_125 )
{
int V_77 ;
V_77 = F_67 () ;
if ( V_77 < 0 )
goto V_126;
if ( ! F_53 ( V_77 , 0 , V_106 , 0 ) )
return;
V_126:
F_69 ( L_12 ,
F_58 () ) ;
}
static void F_70 ( void * V_125 )
{
int V_77 ;
V_77 = F_67 () ;
if ( V_77 >= 0 )
...
static int T_6
F_71 ( struct V_128 * V_129 , unsigned long V_130 , void * V_131 )
{
switch ( V_130 & ~ V_132 ) {
case V_133 :
F_68 ( NULL ) ;
