...
if ( V_20 < 0 )
return V_20 ;
return F_7 ( V_19 , V_21 , V_83 , V_20 ) ;
}
...
switch ( V_35 ) {
case V_31 :
V_29 = F_7 ( V_19 , V_27 , V_84 , 0 ) ;
if ( V_29 < 0 )
return V_29 ;
break;
case V_34 :
V_29 = F_7 ( V_19 , V_27 , V_84 ,
V_84 ) ;
if ( V_29 < 0 )
return V_29 ;
break;
...
struct V_3 * V_4 = F_6 ( V_9 ) ;
struct V_19 * V_19 = V_4 -> V_19 ;
int V_20 , V_21 = V_4 -> V_22 + V_86 ;
V_20 = F_41 ( V_9 , V_18 , V_18 ) ;
if ( V_20 < 0 )
return V_20 ;
return F_7 ( V_19 , V_21 , V_87 , V_20 ) ;
}
...
V_4 -> V_63 . V_53 = V_53 ;
V_4 -> V_63 . type = V_65 ;
V_4 -> V_63 . V_66 = V_89 + 1 ;
V_4 -> V_63 . V_67 = & V_90 ;
V_4 -> V_63 . V_69 = V_70 ;
V_4 -> V_63 . V_71 = V_4 -> V_22 + V_91 ;
V_4 -> V_63 . V_72 = V_87 ;
V_4 -> V_63 . V_73 = V_74 ;
V_4 -> V_63 . V_75 = 1 << V_53 ;
