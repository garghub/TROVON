...
{
const struct V_200 * V_201 = & V_202 [ V_199 -> V_203 ] ;
const struct V_200 * V_204 [ V_205 ] ;
struct V_105 * V_5 ;
void T_1 * V_110 ;
int V_161 , V_25 , V_8 ;
int V_103 ;
F_84 ( & V_197 -> V_4 , V_206 ) ;
V_8 = F_85 ( V_197 ) ;
if ( V_8 )
return V_8 ;
V_8 = F_86 ( V_197 , 1 << V_112 , V_207 ) ;
if ( V_8 == - V_208 )
F_87 ( V_197 ) ;
if ( V_8 )
return V_8 ;
...
V_5 = F_89 ( & V_197 -> V_4 , V_204 , V_161 ) ;
if ( ! V_5 ) {
F_90 ( & V_197 -> V_4 , L_12 ) ;
return - V_10 ;
}
V_5 -> V_111 = F_88 ( V_197 ) ;
V_103 = F_36 ( V_201 -> V_14 ) ;
for ( V_25 = 0 ; V_25 < V_5 -> V_161 ; V_25 ++ ) {
struct V_1 * V_2 = V_5 -> V_107 [ V_25 ] ;
unsigned int V_115 = F_37 ( V_25 , V_103 ) ;
unsigned int V_210 = 0x200 + V_115 * 0x80 ;
unsigned int V_211 = 0x400 + V_115 * 0x100 ;
F_80 ( V_2 , V_110 + V_210 , V_110 + V_211 ) ;
F_91 ( V_2 , V_112 , - 1 , L_13 ) ;
F_91 ( V_2 , V_112 , V_210 , L_14 ) ;
}
F_81 ( V_5 ) ;
V_8 = F_92 ( V_197 , V_212 ) ;
if ( V_8 )
return V_8 ;
V_8 = F_93 ( V_197 , V_212 ) ;
if ( V_8 )
return V_8 ;
F_94 ( V_197 ) ;
return F_95 ( V_5 , V_197 -> V_156 , F_64 , V_213 ,
& V_214 ) ;
}
