...
if ( V_41 )
goto V_69;
V_5 = F_33 ( sizeof( struct V_4 ) , V_70 ) ;
if ( ! V_5 ) {
V_41 = - V_71 ;
goto V_72;
}
V_5 -> V_65 = V_65 ;
V_5 -> V_8 = F_34 ( V_61 -> V_73 . V_74 , F_35 ( & V_61 -> V_73 ) ) ;
if ( ! V_5 -> V_8 ) {
V_41 = - V_71 ;
goto V_75;
}
F_25 ( V_61 , V_5 ) ;
F_36 ( & V_61 -> V_2 , L_2 , F_37 ( V_61 ) ) ;
F_36 ( & V_61 -> V_2 , L_3 , F_38 ( V_61 ) ) ;
if ( V_65 -> V_76 )
F_3 ( F_4 ( V_5 -> V_8 + V_77 ) | V_78 ,
V_5 -> V_8 + V_77 ) ;
if ( V_65 -> V_79 ) {
...
V_5 -> V_57 = F_39 ( L_4 , & V_61 -> V_2 , V_68 ,
V_80 ) ;
if ( F_40 ( V_5 -> V_57 ) ) {
V_41 = F_41 ( V_5 -> V_57 ) ;
goto V_81;
}
if ( F_42 ( V_61 -> V_50 [ 0 ] , F_18 ,
V_65 -> V_82 , L_5 , V_5 ) ) {
V_41 = - V_83 ;
goto V_84;
}
