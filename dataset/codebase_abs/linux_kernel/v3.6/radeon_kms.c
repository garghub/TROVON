...
int F_28 ( struct V_1 * V_2 , struct V_16 * V_95 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
V_95 -> V_96 = NULL ;
if ( V_4 -> V_37 >= V_65 ) {
struct V_97 * V_98 ;
int V_7 ;
V_98 = F_6 ( sizeof( * V_98 ) , V_9 ) ;
if ( F_29 ( ! V_98 ) ) {
return - V_10 ;
}
V_7 = F_30 ( V_4 , & V_98 -> V_99 ) ;
if ( V_7 ) {
F_31 ( V_4 , & V_98 -> V_99 ) ;
F_4 ( V_98 ) ;
return V_7 ;
...
T_3 F_34 ( struct V_1 * V_2 , int V_32 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
...
return F_35 ( V_4 , V_32 ) ;
}
int F_36 ( struct V_1 * V_2 , int V_32 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
unsigned long V_100 ;
int V_7 ;
...
F_37 ( & V_4 -> V_101 . V_102 , V_100 ) ;
V_4 -> V_101 . V_103 [ V_32 ] = true ;
V_7 = F_38 ( V_4 ) ;
F_39 ( & V_4 -> V_101 . V_102 , V_100 ) ;
return V_7 ;
}
void F_40 ( struct V_1 * V_2 , int V_32 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
unsigned long V_100 ;
if ( V_32 < 0 || V_32 >= V_4 -> V_54 ) {
...
F_37 ( & V_4 -> V_101 . V_102 , V_100 ) ;
V_4 -> V_101 . V_103 [ V_32 ] = false ;
F_38 ( V_4 ) ;
F_39 ( & V_4 -> V_101 . V_102 , V_100 ) ;
}
int F_41 ( struct V_1 * V_2 , int V_32 ,
int * V_104 ,
struct V_105 * V_106 ,
unsigned V_6 )
{
struct V_31 * V_107 ;
struct V_3 * V_4 = V_2 -> V_5 ;
if ( V_32 < 0 || V_32 >= V_2 -> V_108 ) {
F_21 ( L_12 , V_32 ) ;
return - V_42 ;
}
V_107 = & V_4 -> V_27 . V_55 [ V_32 ] -> V_56 ;
return F_42 ( V_2 , V_32 , V_104 ,
V_106 , V_6 ,
V_107 ) ;
}
int F_43 ( struct V_1 * V_2 , void * V_21 ,
struct V_16 * V_95 )
{
return - V_42 ;
}
