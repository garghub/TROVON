...
struct V_1 * F_38 ( enum V_44 V_52 )
{
return F_39 ( V_49 [ V_52 ] -> V_6 ) ;
}
struct V_1 * F_40 ( void )
{
struct V_1 * V_6 = F_38 ( V_53 ) ;
if ( V_6 && ! F_41 ( V_6 -> V_2 , 1 , 1 , 1 ) )
return NULL ;
return V_6 ;
}
void F_42 ( void )
...
static struct V_1 * F_47 ( enum V_44 V_45 , int V_55 )
{
struct V_22 * V_2 ;
struct V_1 * V_6 ;
...
static struct V_1 * F_51 ( T_2 * V_60 , struct V_22 * V_3 ,
T_5 V_61 , void * V_62 )
{
struct V_1 * V_6 ;
if ( ! F_15 ( V_3 , V_60 ) ) {
...
struct V_1 * F_54 ( T_2 * V_60 , T_5 V_61 , void * V_62 )
{
struct V_22 * V_2 , * V_64 ;
struct V_1 * V_6 = NULL ;
int V_12 ;
F_5 ( & V_13 ) ;
F_55 (device, _d, &dma_device_list, global_node) {
V_6 = F_51 ( V_60 , V_2 , V_61 , V_62 ) ;
if ( V_6 ) {
F_56 ( V_34 , V_2 -> V_26 ) ;
V_2 -> V_65 ++ ;
V_12 = F_21 ( V_6 ) ;
...
static bool F_64 ( struct V_22 * V_2 )
{
#ifdef F_65
if ( ! F_24 ( V_47 , V_2 -> V_26 ) )
return false ;
#endif
#if F_66 ( V_67 ) || F_66 ( V_68 )
if ( ! F_24 ( V_53 , V_2 -> V_26 ) )
return false ;
#endif
#if F_66 ( V_69 ) || F_66 ( V_70 )
if ( ! F_24 ( V_71 , V_2 -> V_26 ) )
return false ;
#endif
#if F_66 ( V_72 ) || F_66 ( V_73 )
...
static int F_69 ( struct V_22 * V_2 )
{
int V_80 ;
V_81:
if ( ! F_70 ( & V_20 , V_82 ) )
...
if ( ! V_2 )
return - V_16 ;
F_63 ( F_24 ( V_53 , V_2 -> V_26 ) &&
! V_2 -> V_84 ) ;
F_63 ( F_24 ( V_74 , V_2 -> V_26 ) &&
! V_2 -> V_85 ) ;
F_63 ( F_24 ( V_75 , V_2 -> V_26 ) &&
! V_2 -> V_86 ) ;
F_63 ( F_24 ( V_78 , V_2 -> V_26 ) &&
! V_2 -> V_87 ) ;
F_63 ( F_24 ( V_79 , V_2 -> V_26 ) &&
! V_2 -> V_88 ) ;
F_63 ( F_24 ( V_71 , V_2 -> V_26 ) &&
! V_2 -> V_89 ) ;
F_63 ( F_24 ( V_47 , V_2 -> V_26 ) &&
! V_2 -> V_90 ) ;
F_63 ( F_24 ( V_91 , V_2 -> V_26 ) &&
! V_2 -> V_92 ) ;
F_63 ( F_24 ( V_93 , V_2 -> V_26 ) &&
! V_2 -> V_94 ) ;
F_63 ( F_24 ( V_48 , V_2 -> V_26 ) &&
! V_2 -> V_95 ) ;
F_63 ( F_24 ( V_96 , V_2 -> V_26 ) &&
! V_2 -> V_97 ) ;
F_63 ( ! V_2 -> V_33 ) ;
F_63 ( ! V_2 -> V_35 ) ;
F_63 ( ! V_2 -> V_98 ) ;
...
if ( V_6 -> V_14 == NULL )
goto V_100;
V_6 -> V_3 = F_75 ( sizeof( * V_6 -> V_3 ) , V_82 ) ;
if ( V_6 -> V_3 == NULL ) {
F_37 ( V_6 -> V_14 ) ;
V_6 -> V_14 = NULL ;
goto V_100;
...
F_76 ( V_19 ) ;
F_77 ( & V_6 -> V_3 -> V_2 , L_14 ,
V_2 -> V_21 , V_6 -> V_101 ) ;
V_80 = F_78 ( & V_6 -> V_3 -> V_2 ) ;
if ( V_80 ) {
F_37 ( V_6 -> V_14 ) ;
V_6 -> V_14 = NULL ;
F_14 ( V_6 -> V_3 ) ;
...
T_3
F_84 ( struct V_1 * V_6 , void * V_106 ,
...
T_3 V_37 ;
unsigned long V_113 ;
V_112 = F_85 ( V_3 -> V_3 , V_107 , V_108 , V_114 ) ;
V_111 = F_85 ( V_3 -> V_3 , V_106 , V_108 , V_115 ) ;
V_113 = V_116 |
V_117 |
V_118 ;
V_110 = V_3 -> V_84 ( V_6 , V_111 , V_112 , V_108 , V_113 ) ;
if ( ! V_110 ) {
F_86 ( V_3 -> V_3 , V_112 , V_108 , V_114 ) ;
F_86 ( V_3 -> V_3 , V_111 , V_108 , V_115 ) ;
return - V_51 ;
}
V_110 -> V_119 = NULL ;
V_37 = V_110 -> V_120 ( V_110 ) ;
F_87 () ;
F_88 ( V_6 -> V_14 -> V_17 , V_108 ) ;
F_89 ( V_6 -> V_14 -> V_15 ) ;
F_90 () ;
return V_37 ;
}
T_3
F_91 ( struct V_1 * V_6 , struct V_121 * V_121 ,
...
T_3 V_37 ;
unsigned long V_113 ;
V_112 = F_85 ( V_3 -> V_3 , V_123 , V_108 , V_114 ) ;
V_111 = F_92 ( V_3 -> V_3 , V_121 , V_122 , V_108 , V_115 ) ;
V_113 = V_116 | V_117 ;
V_110 = V_3 -> V_84 ( V_6 , V_111 , V_112 , V_108 , V_113 ) ;
if ( ! V_110 ) {
F_86 ( V_3 -> V_3 , V_112 , V_108 , V_114 ) ;
F_93 ( V_3 -> V_3 , V_111 , V_108 , V_115 ) ;
return - V_51 ;
}
V_110 -> V_119 = NULL ;
V_37 = V_110 -> V_120 ( V_110 ) ;
...
T_3
F_94 ( struct V_1 * V_6 , struct V_121 * V_124 ,
...
T_3 V_37 ;
unsigned long V_113 ;
V_112 = F_92 ( V_3 -> V_3 , V_126 , V_127 , V_108 , V_114 ) ;
V_111 = F_92 ( V_3 -> V_3 , V_124 , V_125 , V_108 ,
V_115 ) ;
V_113 = V_116 ;
V_110 = V_3 -> V_84 ( V_6 , V_111 , V_112 , V_108 , V_113 ) ;
if ( ! V_110 ) {
F_93 ( V_3 -> V_3 , V_112 , V_108 , V_114 ) ;
F_93 ( V_3 -> V_3 , V_111 , V_108 , V_115 ) ;
return - V_51 ;
}
V_110 -> V_119 = NULL ;
...
void F_100 ( struct V_109 * V_110 )
{
struct V_109 * V_131 = F_101 ( V_110 ) ;
struct V_109 * V_132 ;
struct V_1 * V_6 ;
if ( ! V_131 )
return;
