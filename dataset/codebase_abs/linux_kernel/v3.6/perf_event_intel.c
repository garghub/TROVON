...
struct V_126 * F_87 ( int V_127 )
{
struct V_126 * V_56 ;
int V_22 ;
V_56 = F_88 ( sizeof( struct V_126 ) ,
V_128 , F_89 ( V_127 ) ) ;
if ( V_56 ) {
for ( V_22 = 0 ; V_22 < V_129 ; V_22 ++ )
F_90 ( & V_56 -> V_56 [ V_22 ] . V_95 ) ;
V_56 -> V_130 = - 1 ;
}
return V_56 ;
}
static int F_91 ( int V_127 )
{
struct V_10 * V_11 = & F_92 ( V_10 , V_127 ) ;
if ( ! ( V_5 . V_131 || V_5 . V_132 ) )
return V_133 ;
V_11 -> V_94 = F_87 ( V_127 ) ;
if ( ! V_11 -> V_94 )
return V_134 ;
return V_133 ;
}
static void F_93 ( int V_127 )
{
struct V_10 * V_11 = & F_92 ( V_10 , V_127 ) ;
int V_130 = F_94 ( V_127 ) ;
int V_22 ;
F_95 ( V_127 ) ;
F_96 () ;
V_11 -> V_135 = NULL ;
...
return;
if ( ! ( V_5 . V_79 & V_136 ) ) {
F_97 (i, topology_thread_cpumask(cpu)) {
struct V_126 * V_137 ;
V_137 = F_92 ( V_10 , V_22 ) . V_94 ;
if ( V_137 && V_137 -> V_130 == V_130 ) {
V_11 -> V_138 = V_11 -> V_94 ;
V_11 -> V_94 = V_137 ;
break;
}
}
V_11 -> V_94 -> V_130 = V_130 ;
V_11 -> V_94 -> V_139 ++ ;
}
if ( V_5 . V_132 )
V_11 -> V_135 = & V_11 -> V_94 -> V_56 [ V_140 ] ;
}
static void F_98 ( int V_127 )
{
struct V_10 * V_11 = & F_92 ( V_10 , V_127 ) ;
struct V_126 * V_137 ;
V_137 = V_11 -> V_94 ;
if ( V_137 ) {
if ( V_137 -> V_130 == - 1 || -- V_137 -> V_139 == 0 )
F_99 ( V_137 ) ;
V_11 -> V_94 = NULL ;
}
F_100 ( V_127 ) ;
...
static int F_104 ( int V_127 )
{
T_3 V_144 = V_145 ;
switch ( F_105 ( V_127 ) . V_146 ) {
case 42 :
V_144 = 0x28 ;
break;
case 45 :
switch ( F_105 ( V_127 ) . V_147 ) {
case 6 : V_144 = 0x618 ; break;
case 7 : V_144 = 0x70c ; break;
}
}
return ( F_105 ( V_127 ) . V_148 < V_144 ) ;
}
...
static T_2 void F_110 ( void )
{
V_5 . V_150 = F_106 ;
F_106 () ;
}
static T_2 void F_111 ( void )
{
int V_59 ;
F_52 (bit, x86_pmu.events_mask, ARRAY_SIZE(intel_arch_events_map)) {
V_2 [ V_151 [ V_59 ] . V_152 ] = 0 ;
F_103 ( L_6 ,
V_151 [ V_59 ] . V_153 ) ;
}
}
static T_2 void F_112 ( void )
{
union V_154 V_155 ;
V_155 . V_156 = V_5 . V_157 ;
if ( V_155 . V_158 . V_159 ) {
V_2 [ V_160 ] = 0x7f89 ;
V_155 . V_158 . V_159 = 0 ;
V_5 . V_157 = V_155 . V_156 ;
F_39 ( L_7 ) ;
}
}
T_2 int F_113 ( void )
...
F_117 ( 10 , & V_164 . V_156 , & V_155 . V_156 , & V_165 , & V_162 . V_156 ) ;
if ( V_164 . V_158 . V_170 < V_171 )
return - V_169 ;
V_42 = V_164 . V_158 . V_172 ;
if ( V_42 < 2 )
V_5 = V_173 ;
else
V_5 = V_174 ;
V_5 . V_42 = V_42 ;
V_5 . V_50 = V_164 . V_158 . V_50 ;
V_5 . V_175 = V_164 . V_158 . V_176 ;
V_5 . V_177 = ( 1ULL << V_164 . V_158 . V_176 ) - 1 ;
V_5 . V_157 = V_155 . V_156 ;
V_5 . V_178 = V_164 . V_158 . V_170 ;
V_5 . V_179 = F_118 ( unsigned , V_180 , V_5 . V_50 ) ;
if ( V_42 > 1 )
V_5 . V_51 = F_119 ( ( int ) V_162 . V_158 . V_51 , 3 ) ;
if ( V_42 > 1 ) {
T_1 V_181 ;
F_22 ( V_182 , V_181 ) ;
V_5 . V_6 . V_181 = V_181 ;
