...
static void F_68 ( struct V_5 * V_6 , int V_30 , int V_161 ,
int V_162 )
{
int V_163 , V_164 ;
T_1 V_165 ;
if ( V_161 != 0 ) {
V_164 = V_162 / V_161 ;
V_163 = ( V_162 - ( V_164 * V_161 ) ) ;
V_163 = ( V_163 * ( 1 << V_166 ) ) / V_161 ;
V_165 = V_167 ;
V_165 |= ( ( V_164 << V_166 ) &
V_168 ) ;
V_165 |= ( V_163 & V_169 ) ;
...
for ( V_8 = 0 ; V_8 < V_2 -> V_13 ; V_8 ++ ) {
if ( V_174 )
V_2 -> V_32 [ V_8 ] . V_161 = 0 ;
F_68 ( & V_2 -> V_6 , V_8 ,
V_2 -> V_32 [ V_8 ] . V_161 ,
V_173 ) ;
}
}
int F_70 ( struct V_150 * V_108 , int V_30 , int V_161 )
{
struct V_1 * V_2 = F_63 ( V_108 ) ;
struct V_5 * V_6 = & V_2 -> V_6 ;
int V_173 ;
V_173 = F_67 ( V_2 -> V_162 ) ;
if ( ( V_30 >= V_2 -> V_13 ) || ( ! V_2 -> V_176 ) ||
( V_161 > V_173 ) || ( V_173 != 10000 ) ||
( ( V_161 != 0 ) && ( V_161 <= 10 ) ) )
return - V_151 ;
V_2 -> V_175 = V_173 ;
V_2 -> V_32 [ V_30 ] . V_161 = ( T_2 ) V_161 ;
F_68 ( V_6 , V_30 , V_161 , V_173 ) ;
return 0 ;
}
int F_54 ( struct V_150 * V_108 , int V_30 , bool V_177 )
{
struct V_1 * V_2 = F_63 ( V_108 ) ;
int V_178 = V_30 >> 3 ;
int V_179 = V_30 % 8 ;
struct V_5 * V_6 = & V_2 -> V_6 ;
T_1 V_180 ;
V_2 -> V_32 [ V_30 ] . V_49 = V_177 ;
V_180 = F_21 ( V_6 , F_71 ( V_178 ) ) ;
V_180 &= ~ ( 1 << V_179 ) ;
V_180 |= ( V_177 << V_179 ) ;
F_20 ( V_6 , F_71 ( V_178 ) , V_180 ) ;
if ( V_2 -> V_32 [ V_30 ] . V_142 ) {
V_179 += V_181 ;
V_180 = F_21 ( V_6 , F_71 ( V_178 ) ) ;
V_180 &= ~ ( 1 << V_179 ) ;
...
int F_72 ( struct V_150 * V_108 ,
int V_30 , struct V_182 * V_183 )
{
struct V_1 * V_2 = F_63 ( V_108 ) ;
if ( V_30 >= V_2 -> V_13 )
return - V_151 ;
V_183 -> V_30 = V_30 ;
memcpy ( & V_183 -> V_24 , V_2 -> V_32 [ V_30 ] . V_111 , V_115 ) ;
V_183 -> V_161 = V_2 -> V_32 [ V_30 ] . V_161 ;
V_183 -> V_154 = V_2 -> V_32 [ V_30 ] . V_105 ;
V_183 -> V_155 = V_2 -> V_32 [ V_30 ] . V_106 ;
V_183 -> V_184 = V_2 -> V_32 [ V_30 ] . V_49 ;
return 0 ;
}
