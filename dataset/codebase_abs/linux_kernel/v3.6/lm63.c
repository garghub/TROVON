...
int V_12 ;
if ( F_9 ( V_13 , V_2 -> V_14 + 5 * V_15 ) ||
! V_2 -> V_16 ) {
for ( V_12 = 0 ; V_12 < V_2 -> V_17 ; V_12 ++ ) {
V_2 -> V_18 [ 1 + V_12 ] = F_10 ( V_11 ,
F_11 ( V_12 ) ) ;
V_2 -> V_6 [ 3 + V_12 ] = F_10 ( V_11 ,
F_12 ( V_12 ) ) ;
}
V_2 -> V_19 = F_10 ( V_11 ,
V_20 ) ;
...
{
struct V_10 * V_11 = F_14 ( V_22 ) ;
struct V_1 * V_2 = F_8 ( V_11 ) ;
unsigned long V_23 ;
F_15 ( & V_2 -> V_24 ) ;
V_23 = V_2 -> V_25
+ F_16 ( V_2 -> V_26 ) + 1 ;
if ( F_9 ( V_13 , V_23 ) || ! V_2 -> V_27 ) {
if ( V_2 -> V_28 & 0x04 ) {
V_2 -> V_29 [ 0 ] = F_10 ( V_11 ,
V_30 ) & 0xFC ;
V_2 -> V_29 [ 0 ] |= F_10 ( V_11 ,
V_31 ) << 8 ;
V_2 -> V_29 [ 1 ] = ( F_10 ( V_11 ,
V_32 ) & 0xFC )
| ( F_10 ( V_11 ,
V_33 ) << 8 ) ;
}
...
if ( V_2 -> V_34 == 0 )
V_2 -> V_34 = 1 ;
V_2 -> V_18 [ 0 ] = F_10 ( V_11 ,
V_36 ) ;
V_2 -> V_6 [ 0 ] = F_10 ( V_11 ,
V_37 ) ;
V_2 -> V_6 [ 1 ] = F_10 ( V_11 ,
V_38 ) ;
V_2 -> V_39 [ 0 ] = F_10 ( V_11 ,
V_40 ) << 8 ;
V_2 -> V_39 [ 0 ] |= F_10 ( V_11 ,
V_41 ) ;
V_2 -> V_39 [ 1 ] = ( F_10 ( V_11 ,
V_42 ) << 8 )
| F_10 ( V_11 ,
V_43 ) ;
V_2 -> V_39 [ 2 ] = ( F_10 ( V_11 ,
V_44 ) << 8 )
| F_10 ( V_11 ,
V_45 ) ;
V_2 -> V_39 [ 3 ] = ( F_10 ( V_11 ,
V_46 ) << 8 )
| F_10 ( V_11 ,
V_47 ) ;
if ( V_2 -> V_48 == V_49 )
...
static T_1 F_20 ( struct V_21 * V_22 , struct V_58 * V_59 ,
char * V_60 )
{
struct V_61 * V_62 = F_21 ( V_59 ) ;
struct V_1 * V_2 = F_13 ( V_22 ) ;
return sprintf ( V_60 , L_2 , F_22 ( V_2 -> V_29 [ V_62 -> V_63 ] ) ) ;
}
static T_1 F_23 ( struct V_21 * V_22 , struct V_58 * V_64 ,
...
static T_1 F_28 ( struct V_21 * V_22 , struct V_58 * V_59 ,
const char * V_60 , T_2 V_65 )
{
struct V_61 * V_62 = F_21 ( V_59 ) ;
struct V_10 * V_11 = F_14 ( V_22 ) ;
...
if ( V_66 )
return V_66 ;
V_69 = V_3 ? F_11 ( V_3 - 1 ) : V_36 ;
V_8 = F_6 ( V_8 , 0 , 255 ) ;
F_15 ( & V_2 -> V_24 ) ;
V_2 -> V_18 [ V_3 ] = V_2 -> V_68 ? V_8 :
( V_8 * V_2 -> V_34 * 2 + 127 ) / 255 ;
F_26 ( V_11 , V_69 , V_2 -> V_18 [ V_3 ] ) ;
F_17 ( & V_2 -> V_24 ) ;
return V_65 ;
}
...
static T_1 F_34 ( struct V_21 * V_22 , struct V_58 * V_59 ,
const char * V_60 , T_2 V_65 )
{
struct V_61 * V_62 = F_21 ( V_59 ) ;
struct V_10 * V_11 = F_14 ( V_22 ) ;
...
static T_1 F_38 ( struct V_21 * V_22 , struct V_58 * V_59 ,
char * V_60 )
{
struct V_61 * V_62 = F_21 ( V_59 ) ;
struct V_1 * V_2 = F_13 ( V_22 ) ;
...
V_74 = F_39 ( V_2 -> V_39 [ V_3 ] ) ;
} else {
if ( V_2 -> V_4 && V_3 == 2 )
V_74 = F_39 ( ( V_75 ) V_2 -> V_39 [ V_3 ] ) ;
else
V_74 = F_39 ( V_2 -> V_39 [ V_3 ] ) ;
}
return sprintf ( V_60 , L_2 , V_74 + V_2 -> V_9 ) ;
}
static T_1 F_40 ( struct V_21 * V_22 , struct V_58 * V_59 ,
const char * V_60 , T_2 V_65 )
{
...
V_2 -> V_39 [ V_3 ] = F_42 ( V_8 - V_2 -> V_9 ) ;
F_26 ( V_11 , V_69 [ ( V_3 - 1 ) * 2 ] ,
V_2 -> V_39 [ V_3 ] >> 8 ) ;
F_26 ( V_11 , V_69 [ ( V_3 - 1 ) * 2 + 1 ] ,
V_2 -> V_39 [ V_3 ] & 0xff ) ;
F_17 ( & V_2 -> V_24 ) ;
return V_65 ;
}
...
static T_1 F_45 ( struct V_21 * V_22 ,
struct V_58 * V_64 ,
const char * V_60 , T_2 V_65 )
{
struct V_10 * V_11 = F_14 ( V_22 ) ;
...
static void F_47 ( struct V_10 * V_11 , struct V_1 * V_2 ,
unsigned int V_77 )
{
int V_12 ;
unsigned int V_26 ;
...
return V_66 ;
F_15 ( & V_2 -> V_24 ) ;
F_47 ( V_11 , V_2 , F_6 ( V_8 , 0 , 100000 ) ) ;
F_17 ( & V_2 -> V_24 ) ;
return V_65 ;
}
static T_1 F_52 ( struct V_21 * V_22 , struct V_58 * V_62 ,
char * V_60 )
{
struct V_10 * V_11 = F_14 ( V_22 ) ;
struct V_1 * V_2 = F_8 ( V_11 ) ;
...
static T_1 F_53 ( struct V_21 * V_22 , struct V_58 * V_62 ,
const char * V_60 , T_2 V_65 )
{
struct V_10 * V_11 = F_14 ( V_22 ) ;
struct V_1 * V_2 = F_8 ( V_11 ) ;
...
static T_1 F_54 ( struct V_21 * V_22 , struct V_58 * V_64 ,
char * V_60 )
{
struct V_1 * V_2 = F_13 ( V_22 ) ;
return sprintf ( V_60 , L_3 , V_2 -> V_56 ) ;
}
static T_1 F_55 ( struct V_21 * V_22 , struct V_58 * V_59 ,
char * V_60 )
{
struct V_61 * V_62 = F_21 ( V_59 ) ;
struct V_1 * V_2 = F_13 ( V_22 ) ;
...
static T_3 F_56 ( struct V_85 * V_86 ,
struct V_87 * V_62 , int V_63 )
{
struct V_21 * V_22 = F_57 ( V_86 , struct V_21 , V_86 ) ;
struct V_10 * V_11 = F_14 ( V_22 ) ;
struct V_1 * V_2 = F_8 ( V_11 ) ;
...
if ( ! F_59 ( V_96 , V_105 ) )
return - V_106 ;
V_97 = F_10 ( V_11 , V_107 ) ;
V_98 = F_10 ( V_11 , V_108 ) ;
V_99 = F_10 ( V_11 , V_109 ) ;
V_100 = F_10 ( V_11 , V_110 ) ;
V_101 = F_10 ( V_11 ,
V_57 ) ;
V_102 = F_10 ( V_11 , V_111 ) ;
if ( V_97 != 0x01
|| ( V_99 & 0x18 ) != 0x00
|| ( V_100 & 0xF8 ) != 0x00
|| ( V_101 & 0x20 ) != 0x00
...
F_61 ( V_94 -> type , L_7 , V_112 ) ;
else if ( V_98 == 0x51 && ( V_103 == 0x18 || V_103 == 0x4e ) )
F_61 ( V_94 -> type , L_8 , V_112 ) ;
else if ( V_98 == 0x49 && V_103 == 0x4c )
F_61 ( V_94 -> type , L_9 , V_112 ) ;
else
return - V_106 ;
return 0 ;
}
...
V_113 = F_10 ( V_11 , V_80 ) ;
if ( F_63 ( V_113 > V_78 ) )
V_113 = V_78 ;
V_2 -> V_26 = F_48 ( V_2 -> V_79 ,
V_113 ) ;
if ( V_2 -> V_48 == V_49 ) {
V_5 V_117
= F_10 ( V_11 ,
...
struct V_1 * V_2 ;
int V_66 ;
V_2 = F_65 ( & V_11 -> V_22 , sizeof( struct V_1 ) , V_121 ) ;
if ( ! V_2 )
return - V_122 ;
F_66 ( V_11 , V_2 ) ;
V_2 -> V_27 = 0 ;
F_67 ( & V_2 -> V_24 ) ;
V_2 -> V_48 = V_120 -> V_123 ;
if ( V_2 -> V_48 == V_90 )
V_2 -> V_9 = 16000 ;
F_62 ( V_11 ) ;
V_66 = F_68 ( & V_11 -> V_22 . V_86 , & V_124 ) ;
if ( V_66 )
return V_66 ;
if ( V_2 -> V_28 & 0x04 ) {
V_66 = F_68 ( & V_11 -> V_22 . V_86 , & V_125 ) ;
if ( V_66 )
goto V_126;
}
if ( V_2 -> V_48 == V_49 ) {
V_66 = F_69 ( & V_11 -> V_22 , & V_127 ) ;
if ( V_66 )
goto V_126;
V_66 = F_68 ( & V_11 -> V_22 . V_86 ,
& V_128 ) ;
if ( V_66 )
goto V_126;
}
V_2 -> V_129 = F_70 ( & V_11 -> V_22 ) ;
if ( F_71 ( V_2 -> V_129 ) ) {
V_66 = F_72 ( V_2 -> V_129 ) ;
goto V_126;
}
return 0 ;
V_126:
F_73 ( & V_11 -> V_22 . V_86 , & V_124 ) ;
F_73 ( & V_11 -> V_22 . V_86 , & V_125 ) ;
if ( V_2 -> V_48 == V_49 ) {
F_74 ( & V_11 -> V_22 , & V_127 ) ;
F_73 ( & V_11 -> V_22 . V_86 , & V_128 ) ;
}
return V_66 ;
}
