...
V_5 -> V_18 . V_24 [ V_17 ] = false ;
for ( V_17 = 0 ; V_17 < V_25 ; V_17 ++ ) {
V_5 -> V_18 . V_26 [ V_17 ] = false ;
F_10 ( & V_5 -> V_18 . V_27 [ V_17 ] , 0 ) ;
V_5 -> V_18 . V_28 [ V_17 ] = false ;
}
F_11 ( V_5 ) ;
...
return false ;
if ( ( V_5 -> V_35 -> V_36 == 0x791f ) &&
( V_5 -> V_35 -> V_37 == 0x103c ) &&
( V_5 -> V_35 -> V_38 == 0x30c2 ) )
return true ;
if ( ( V_5 -> V_35 -> V_36 == 0x791f ) &&
( V_5 -> V_35 -> V_37 == 0x1028 ) &&
( V_5 -> V_35 -> V_38 == 0x01fc ) )
return true ;
if ( ( V_5 -> V_35 -> V_36 == 0x791f ) &&
( V_5 -> V_35 -> V_37 == 0x1028 ) &&
( V_5 -> V_35 -> V_38 == 0x01fd ) )
return true ;
if ( V_5 -> V_30 == V_39 )
return false ;
if ( V_5 -> V_32 & V_40 ) {
...
F_9 ( & V_5 -> V_18 . V_19 , V_16 ) ;
for ( V_17 = 0 ; V_17 < V_23 ; ++ V_17 )
V_5 -> V_18 . V_24 [ V_17 ] |= ! ! ( V_53 & ( 1 << V_17 ) ) ;
F_11 ( V_5 ) ;
F_12 ( & V_5 -> V_18 . V_19 , V_16 ) ;
}
...
F_11 ( V_5 ) ;
F_12 ( & V_5 -> V_18 . V_19 , V_16 ) ;
V_42 = F_40 ( V_5 -> V_18 . V_54 , F_41 ( V_5 ) ,
F_42 ( V_55 ) ) ;
F_9 ( & V_5 -> V_18 . V_19 , V_16 ) ;
V_5 -> V_18 . V_22 = false ;
F_11 ( V_5 ) ;
