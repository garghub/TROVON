...
F_13 ( V_36 -> V_37 != V_38 ) ;
V_20 = F_14 ( V_18 , V_38 ) ;
memcpy ( V_20 , V_36 -> V_39 , V_38 ) ;
}
static int F_15 ( struct V_17 * V_18 , struct V_35 * V_36 )
{
T_2 * V_20 ;
V_20 = F_6 ( V_18 , V_38 ) ;
if ( F_7 ( V_20 == NULL ) )
goto V_25;
V_36 -> V_37 = V_38 ;
memcpy ( V_36 -> V_39 , V_20 , V_38 ) ;
return 0 ;
V_25:
F_3 ( V_29 , V_18 ) ;
return - V_30 ;
}
static T_2 * F_16 ( T_2 * V_20 , const struct V_40 * V_41 )
{
* V_20 ++ = F_17 ( V_41 -> V_42 ) ;
if ( V_41 -> V_43 != 0 )
* V_20 ++ = F_17 ( V_41 -> V_43 / V_44 ) ;
else
* V_20 ++ = F_17 ( 0 ) ;
return V_20 ;
}
static T_2 * F_18 ( T_2 * V_20 ,
...
static T_2 * F_19 ( T_2 * V_20 , struct V_40 * V_41 )
{
V_41 -> V_42 = F_8 ( V_20 ++ ) ;
V_41 -> V_43 = F_8 ( V_20 ++ ) * V_44 ;
return V_20 ;
}
static int F_20 ( struct V_17 * V_18 , struct V_45 * V_46 )
{
T_1 V_47 , type ;
T_2 * V_20 ;
...
V_46 -> V_63 . V_65 = 0 ;
V_46 -> V_66 = F_8 ( V_20 ++ ) ;
V_20 = F_19 ( V_20 , & V_46 -> V_67 ) ;
V_20 = F_19 ( V_20 , & V_46 -> V_68 ) ;
F_19 ( V_20 , & V_46 -> ctime ) ;
V_46 -> V_69 = F_22 ( & V_46 -> ctime ) ;
return 0 ;
V_25:
F_3 ( V_29 , V_18 ) ;
return - V_30 ;
}
static T_2 * F_23 ( T_2 * V_20 )
{
* V_20 ++ = F_17 ( V_70 ) ;
* V_20 ++ = F_17 ( V_70 ) ;
return V_20 ;
}
static void F_24 ( struct V_17 * V_18 , const struct V_71 * V_72 )
{
T_2 * V_20 ;
V_20 = F_14 ( V_18 , V_73 << 2 ) ;
if ( V_72 -> V_74 & V_75 )
* V_20 ++ = F_17 ( V_72 -> V_76 ) ;
else
* V_20 ++ = F_17 ( V_70 ) ;
...
* V_20 ++ = F_17 ( V_70 ) ;
if ( V_72 -> V_74 & V_81 )
* V_20 ++ = F_17 ( ( T_1 ) V_72 -> V_82 ) ;
else
* V_20 ++ = F_17 ( V_70 ) ;
if ( V_72 -> V_74 & V_83 )
V_20 = F_16 ( V_20 , & V_72 -> V_84 ) ;
else if ( V_72 -> V_74 & V_85 )
V_20 = F_18 ( V_20 , & V_72 -> V_84 ) ;
else
V_20 = F_23 ( V_20 ) ;
if ( V_72 -> V_74 & V_86 )
F_16 ( V_20 , & V_72 -> V_87 ) ;
...
goto V_25;
V_90 = F_8 ( V_20 ) ;
if ( F_7 ( V_90 >= V_18 -> V_96 -> V_97 || V_90 > V_98 ) )
goto V_99;
V_23 = F_9 ( V_18 , V_90 ) ;
if ( F_7 ( V_90 > V_23 ) )
goto V_26;
...
static int F_35 ( struct V_17 * V_18 , struct V_102 * V_22 )
{
int error ;
error = F_15 ( V_18 , V_22 -> V_36 ) ;
if ( F_7 ( error ) )
goto V_27;
error = F_20 ( V_18 , V_22 -> V_46 ) ;
V_27:
return error ;
}
static int F_36 ( struct V_17 * V_18 , struct V_102 * V_22 )
{
enum V_31 V_32 ;
int error ;
error = F_10 ( V_18 , & V_32 ) ;
...
struct V_17 * V_18 ,
const struct V_103 * args )
{
F_12 ( V_18 , args -> V_36 ) ;
F_24 ( V_18 , args -> V_104 ) ;
}
...
* V_20 ++ = F_17 ( V_24 ) ;
* V_20 = F_17 ( V_24 ) ;
F_29 ( V_18 , args -> V_4 , args -> V_107 , V_24 ) ;
}
...
{
const struct V_120 * V_121 = args -> V_122 ;
const struct V_120 * V_123 = args -> V_124 ;
F_34 ( V_18 , args -> V_125 , V_121 -> V_89 , V_121 -> V_6 ) ;
F_34 ( V_18 , args -> V_126 , V_123 -> V_89 , V_123 -> V_6 ) ;
}
static void F_48 ( struct V_1 * V_2 ,
struct V_17 * V_18 ,
const struct V_127 * args )
{
F_12 ( V_18 , args -> V_128 ) ;
F_34 ( V_18 , args -> V_129 , args -> V_130 , args -> V_131 ) ;
}
static void F_49 ( struct V_1 * V_2 ,
struct V_17 * V_18 ,
const struct V_132 * args )
{
F_34 ( V_18 , args -> V_128 , args -> V_133 , args -> V_134 ) ;
F_28 ( V_18 , args -> V_4 , args -> V_135 ) ;
F_24 ( V_18 , args -> V_104 ) ;
}
...
int F_58 ( struct V_17 * V_18 , struct V_144 * V_145 ,
int V_146 )
{
T_2 * V_20 ;
int error ;
...
if ( F_7 ( V_20 == NULL ) )
goto V_25;
V_145 -> V_150 = F_8 ( V_20 ) ;
error = F_27 ( V_18 , & V_145 -> V_89 , & V_145 -> V_6 ) ;
if ( F_7 ( error ) )
return error ;
V_145 -> V_151 = V_145 -> V_137 ;
V_20 = F_6 ( V_18 , 4 ) ;
if ( F_7 ( V_20 == NULL ) )
goto V_25;
V_145 -> V_137 = F_8 ( V_20 ) ;
V_145 -> V_152 = V_153 ;
return 0 ;
V_25:
F_3 ( V_29 , V_18 ) ;
...
{
return F_9 ( V_18 , V_18 -> V_96 -> V_97 ) ;
}
...
static int F_61 ( struct V_17 * V_18 , struct V_154 * V_22 )
{
T_2 * V_20 ;
V_20 = F_6 ( V_18 , V_155 << 2 ) ;
if ( F_7 ( V_20 == NULL ) )
goto V_25;
V_22 -> V_156 = F_8 ( V_20 ++ ) ;
V_22 -> V_157 = F_8 ( V_20 ++ ) ;
...
{
int V_160 ;
for ( V_160 = 0 ; V_161 [ V_160 ] . V_162 != - 1 ; V_160 ++ ) {
if ( V_161 [ V_160 ] . V_162 == ( int ) V_32 )
return V_161 [ V_160 ] . V_163 ;
}
F_4 ( L_9 , V_32 ) ;
return V_161 [ V_160 ] . V_163 ;
}
