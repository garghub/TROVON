...
F_24 (itd, n, &ehci->cached_itd_list, itd_list) {
F_25 ( & V_58 -> V_53 ) ;
F_26 ( V_2 -> V_62 , V_58 , V_58 -> V_63 ) ;
if ( V_58 == V_2 -> V_49 )
break;
}
F_24 (sitd, sn, &ehci->cached_sitd_list, sitd_list) {
F_25 ( & V_60 -> V_57 ) ;
F_26 ( V_2 -> V_64 , V_60 , V_60 -> V_65 ) ;
if ( V_60 == V_2 -> V_54 )
break;
}
if ( ! F_27 ( & V_2 -> V_50 ) ||
...
static enum V_76 F_32 ( struct V_13 * V_77 )
{
struct V_1 * V_2 = F_33 ( V_77 , struct V_1 , V_13 ) ;
T_2 V_78 ;
unsigned long V_79 ;
unsigned long V_80 ;
unsigned V_81 ;
...
V_2 -> V_12 = V_83 ;
V_78 = F_7 () ;
F_35 (e, &events, EHCI_HRTIMER_NUM_EVENTS) {
