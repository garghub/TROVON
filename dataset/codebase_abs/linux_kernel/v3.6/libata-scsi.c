...
F_185 ( V_450 , & V_10 -> V_451 ,
F_186 ( V_116 ) ) ;
}
int F_187 ( struct V_25 * V_2 )
{
if ( V_2 -> V_22 ) {
F_188 ( V_2 -> V_22 , V_452 ) ;
return 1 ;
}
return 0 ;
}
static void F_189 ( struct V_25 * V_2 )
{
struct V_9 * V_10 = V_2 -> V_24 -> V_10 ;
struct V_21 * V_22 ;
unsigned long V_13 ;
F_190 ( & V_10 -> V_433 -> V_453 ) ;
F_5 ( V_10 -> V_18 , V_13 ) ;
F_191 ( V_2 ) ;
V_22 = V_2 -> V_22 ;
V_2 -> V_22 = NULL ;
...
void F_199 ( struct V_25 * V_2 )
{
if ( V_2 -> V_22 )
F_200 ( V_2 -> V_22 , V_205 ,
V_456 ) ;
}
void F_201 ( struct V_457 * V_458 )
{
struct V_9 * V_10 =
F_202 ( V_458 , struct V_9 , V_451 . V_458 ) ;
int V_158 ;
if ( V_10 -> V_36 & V_459 ) {
F_97 ( L_54 ) ;
return;
...
F_198 ( & V_10 -> V_354 [ V_158 ] ) ;
F_175 ( V_10 , 0 ) ;
F_194 ( & V_10 -> V_460 ) ;
F_97 ( L_36 ) ;
}
int F_203 ( struct V_7 * V_8 , unsigned int V_355 ,
...
void F_204 ( struct V_457 * V_458 )
{
struct V_9 * V_10 =
F_202 ( V_458 , struct V_9 , V_467 ) ;
struct V_23 * V_24 ;
struct V_25 * V_2 ;
unsigned long V_13 ;
F_190 ( & V_10 -> V_460 ) ;
...
struct V_9 * F_206 ( struct V_425 * V_30 ,
struct V_468 * V_469 ,
struct V_7 * V_8 )
{
struct V_9 * V_10 ;
...
int F_217 ( struct V_21 * V_22 , struct V_9 * V_10 )
{
F_61 ( V_22 ) ;
F_66 ( V_22 , V_10 -> V_24 . V_1 ) ;
return 0 ;
}
int F_218 ( struct V_52 * V_53 , struct V_9 * V_10 )
{
int V_29 = 0 ;
F_163 ( V_10 , V_53 ) ;
