...
if ( V_69 && V_69 -> V_99 ) {
int V_100 = sizeof( struct V_101 ) + V_69 -> V_99 ;
V_15 -> V_69 = F_31 ( V_100 , V_102 ) ;
...
V_13 -> V_103 = 0UL ;
V_13 -> V_104 = 0 ;
F_35 ( & V_81 , 0 , V_34 -> V_105 , F_36 ( V_34 ) ,
V_106 , V_107 ,
F_37 ( V_34 ) ,
( V_69 && V_69 -> V_108 ) ? V_69 -> V_109 : V_15 -> V_94 ,
...
V_13 -> V_110 = V_74 -> V_110 ? : F_42 ( & V_78 -> V_53 , V_111 ) ;
F_43 ( F_44 ( V_34 ) , V_13 -> V_43 ,
& V_13 -> V_112 , & V_13 -> V_110 ,
V_15 -> V_20 , & V_79 ,
F_42 ( & V_78 -> V_53 , V_113 ) ) ;
V_15 -> V_79 = V_79 ;
V_76 = F_19 ( V_34 , V_36 , V_13 , & V_78 -> V_53 ) ;
if ( V_76 )
F_45 ( V_76 ) -> V_114 . V_115 . V_116 . V_117 = V_81 ;
V_85: return V_76 ;
}
