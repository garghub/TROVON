...
V_23 -> V_32 [ V_30 ] = F_30 ( V_36 , V_42 ) ;
if ( F_31 ( V_23 -> V_32 [ V_30 ] ) ) {
V_23 -> V_32 [ V_30 ] = NULL ;
F_10 ( V_36 ,
L_10 , V_30 ) ;
} else {
