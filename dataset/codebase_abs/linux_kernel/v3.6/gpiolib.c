...
static int F_101 ( struct V_116 * V_117 , void * V_120 )
{
struct V_6 * V_7 = NULL ;
unsigned V_8 ;
int V_121 = 0 ;
...
if ( V_29 )
F_100 ( V_117 , L_39 ,
V_29 -> V_122 ? V_29 -> V_122 -> V_69 : L_40 ,
F_102 ( V_29 ) ) ;
if ( V_7 -> V_3 )
...
static int F_103 ( struct V_124 * V_124 , struct V_125 * V_125 )
{
return F_104 ( V_125 , F_101 , NULL ) ;
}
static int T_1 F_105 ( void )
{
( void ) F_106 ( L_44 , V_126 | V_127 ,
NULL , NULL , & V_128 ) ;
return 0 ;
}
