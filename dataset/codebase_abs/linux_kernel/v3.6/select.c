...
if ( ! ( V_78 & V_95 ) )
continue;
V_42 = F_43 ( V_28 , & V_100 ) ;
if ( V_42 ) {
V_99 = V_42 -> V_99 ;
V_96 = V_101 ;
if ( V_99 && V_99 -> V_102 ) {
F_39 ( V_24 , V_76 , V_77 , V_78 ) ;
V_96 = (* V_99 -> V_102 )( V_42 , V_24 ) ;
}
F_44 ( V_42 , V_100 ) ;
...
V_106 = F_49 ( V_65 ) ;
V_104 = V_107 ;
if ( V_106 > sizeof( V_107 ) / 6 ) {
V_10 = - V_36 ;
V_104 = F_50 ( 6 * V_106 , V_35 ) ;
if ( ! V_104 )
goto V_109;
}
V_66 . V_76 = V_104 ;
V_66 . V_77 = V_104 + V_106 ;
V_66 . V_91 = V_104 + 2 * V_106 ;
V_66 . V_92 = V_104 + 3 * V_106 ;
V_66 . V_93 = V_104 + 4 * V_106 ;
V_66 . V_94 = V_104 + 5 * V_106 ;
...
T_7 T_5 * exp , struct V_1 T_5 * V_111 ,
const T_8 T_5 * V_112 , T_9 V_113 )
{
T_8 V_114 , V_115 ;
struct V_1 V_53 , V_55 , * V_50 = NULL ;
int V_10 ;
if ( V_111 ) {
if ( F_56 ( & V_53 , V_111 , sizeof( V_53 ) ) )
return - V_110 ;
V_50 = & V_55 ;
...
if ( V_113 != sizeof( T_8 ) )
return - V_54 ;
if ( F_56 ( & V_114 , V_112 , sizeof( V_114 ) ) )
return - V_110 ;
F_57 ( & V_114 , V_112 ( V_116 ) | V_112 ( V_117 ) ) ;
F_58 ( V_118 , & V_114 , & V_115 ) ;
}
V_10 = F_48 ( V_65 , V_89 , V_90 , exp , V_50 ) ;
V_10 = F_34 ( & V_55 , V_111 , 0 , V_10 ) ;
if ( V_10 == - V_64 ) {
if ( V_112 ) {
memcpy ( & V_6 -> V_119 , & V_115 ,
sizeof( V_115 ) ) ;
F_59 () ;
}
} else if ( V_112 )
F_58 ( V_118 , & V_115 , NULL ) ;
return V_10 ;
}
static inline unsigned int F_60 ( struct V_120 * V_120 , T_3 * V_121 )
{
unsigned int V_96 ;
int V_122 ;
V_96 = 0 ;
...
int V_100 ;
struct V_42 * V_42 ;
V_42 = F_43 ( V_122 , & V_100 ) ;
V_96 = V_123 ;
if ( V_42 != NULL ) {
V_96 = V_101 ;
if ( V_42 -> V_99 && V_42 -> V_99 -> V_102 ) {
V_121 -> V_43 = V_120 -> V_124 | V_125 | V_126 ;
V_96 = V_42 -> V_99 -> V_102 ( V_42 , V_121 ) ;
}
V_96 &= V_120 -> V_124 | V_125 | V_126 ;
F_44 ( V_42 , V_100 ) ;
}
}
V_120 -> V_127 = V_96 ;
...
if ( ! F_26 ( V_24 , V_103 , V_50 , V_3 ) )
V_84 = 1 ;
}
return V_131 ;
}
int F_62 ( struct V_120 T_5 * V_136 , unsigned int V_128 ,
struct V_1 * V_55 )
{
struct V_13 V_19 ;
int V_137 = - V_110 , V_138 , V_135 , V_106 ;
...
sizeof( struct V_120 ) * V_132 -> V_135 ) )
goto V_144;
V_142 -= V_132 -> V_135 ;
if ( ! V_142 )
break;
V_135 = F_65 ( V_142 , V_145 ) ;
V_106 = sizeof( struct V_129 ) + sizeof( struct V_120 ) * V_135 ;
V_132 = V_132 -> V_32 = F_50 ( V_106 , V_35 ) ;
if ( ! V_132 ) {
V_137 = - V_36 ;
goto V_144;
}
...
{
struct V_120 T_5 * V_136 = V_147 -> V_102 . V_136 ;
int V_128 = V_147 -> V_102 . V_128 ;
struct V_1 * V_50 = NULL , V_55 ;
int V_10 ;
if ( V_147 -> V_102 . V_148 ) {
V_55 . V_5 = V_147 -> V_102 . V_5 ;
V_55 . V_9 = V_147 -> V_102 . V_9 ;
V_50 = & V_55 ;
}
