...
static int F_108 ( struct V_72 * V_172 )
{
struct V_118 * V_93 = F_109 ( V_172 ) ;
struct V_48 * V_49 = V_93 -> V_22 ;
F_110 ( V_93 , V_173 ) ;
F_111 ( V_49 -> V_71 ) ;
return 0 ;
}
static int F_112 ( struct V_72 * V_172 )
{
struct V_118 * V_93 = F_109 ( V_172 ) ;
F_110 ( V_93 , V_174 ) ;
return 0 ;
...
{
int V_82 ;
for ( V_82 = 0 ; V_82 < F_82 ( V_175 ) ; ++ V_82 )
F_114 ( V_175 [ V_82 ] ) ;
F_115 ( & V_176 ) ;
F_60 () ;
}
