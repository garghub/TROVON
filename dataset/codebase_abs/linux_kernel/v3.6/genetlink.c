...
static int F_93 ( struct V_67 * V_68 , T_4 V_69 , unsigned long V_149 ,
T_8 V_46 )
{
struct V_67 * V_40 ;
struct V_33 * V_33 , * V_150 = NULL ;
int V_21 ;
F_21 (net) {
if ( V_150 ) {
V_40 = F_94 ( V_68 , V_46 ) ;
...
return F_95 ( V_150 -> V_34 , V_68 , V_69 , V_149 , V_46 ) ;
error:
F_96 ( V_68 ) ;
return V_21 ;
}
int F_84 ( struct V_67 * V_68 , T_4 V_69 , unsigned int V_149 ,
T_8 V_46 )
{
return F_93 ( V_68 , V_69 , V_149 , V_46 ) ;
}
void F_97 ( struct V_67 * V_68 , struct V_33 * V_33 , T_4 V_69 , T_4 V_149 ,
struct V_71 * V_72 , T_8 V_46 )
{
struct V_151 * V_79 = V_33 -> V_34 ;
int V_152 = 0 ;
if ( V_72 )
V_152 = F_98 ( V_72 ) ;
F_99 ( V_79 , V_68 , V_69 , V_149 , V_152 , V_46 ) ;
}
