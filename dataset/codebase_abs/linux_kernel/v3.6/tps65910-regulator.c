...
struct V_134 * V_135 = V_129 -> V_48 . V_133 -> V_136 ;
struct V_134 * V_137 ;
struct V_130 * V_138 ;
unsigned int V_139 ;
int V_140 = 0 , V_62 , V_141 ;
...
V_62 = V_130 ( V_129 -> V_48 . V_133 , V_137 , V_138 , V_141 ) ;
if ( V_62 < 0 ) {
...
if ( ! V_138 [ V_140 ] . V_145 || ! V_138 [ V_140 ] . V_136 )
continue;
V_132 -> V_146 [ V_140 ] =
V_138 [ V_140 ] . V_145 ;
V_62 = F_30 ( V_138 [ V_140 ] . V_136 ,
L_13 , & V_139 ) ;
if ( ! V_62 )
V_132 -> V_147 [ V_140 ] = V_139 ;
}
return V_132 ;
}
...
static T_2 int F_31 ( struct V_128 * V_129 )
{
struct V_52 * V_52 = F_26 ( V_129 -> V_48 . V_133 ) ;
struct V_148 V_149 = { } ;
struct V_150 * V_103 ;
...
int V_154 , V_155 ;
V_132 = F_32 ( V_52 -> V_48 ) ;
if ( ! V_132 && V_52 -> V_48 -> V_136 )
V_132 = F_25 ( V_129 ,
& V_131 ) ;
if ( ! V_132 ) {
...
V_51 = F_27 ( & V_129 -> V_48 , sizeof( * V_51 ) , V_142 ) ;
if ( ! V_51 ) {
...
case V_119 :
V_51 -> V_56 = & F_1 ;
V_51 -> V_159 = F_29 ( V_160 ) ;
V_51 -> V_108 = V_161 ;
V_103 = V_160 ;
break;
case V_123 :
V_51 -> V_56 = & F_2 ;
V_51 -> V_159 = F_29 ( V_162 ) ;
V_51 -> V_108 = V_163 ;
V_103 = V_162 ;
break;
default:
...
if ( V_131 )
V_149 . V_136 = V_131 [ V_154 ] . V_136 ;
V_153 = F_35 ( & V_51 -> V_89 [ V_154 ] , & V_149 ) ;
if ( F_36 ( V_153 ) ) {
F_23 ( V_52 -> V_48 ,
L_20 ,
V_129 -> V_167 ) ;
...
V_188:
while ( -- V_154 >= 0 )
F_38 ( V_51 -> V_153 [ V_154 ] ) ;
return V_155 ;
}
static int T_3 F_39 ( struct V_128 * V_129 )
{
struct V_50 * V_51 = F_40 ( V_129 ) ;
int V_154 ;
