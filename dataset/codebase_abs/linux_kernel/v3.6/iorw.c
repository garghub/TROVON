...
V_91 . V_103 = V_5 -> V_44 . V_46 ;
V_91 . V_104 = V_5 -> V_44 . V_38 ;
V_91 . V_105 = 0 ;
V_5 -> V_106 += V_91 . V_67 ;
if ( F_34 ( V_5 , & V_91 ,
...
L_41 ) ;
F_15 ( & V_7 -> V_25 , & V_5 -> V_110 . V_56 . V_25 ) ;
}
return 0 ;
}
...
F_11 ( & V_63 -> V_25 ) ;
V_111 = (struct V_10 * ) V_63 -> V_54 ;
if ( V_111 && V_111 == & V_5 -> V_44 ) {
V_50 = F_31 ( V_5 , V_63 ) ;
if ( V_50 ) {
F_3 ( & V_5 -> V_21 -> V_5 ,
L_43 ,
