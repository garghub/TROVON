...
for ( V_91 = 0 ; V_91 < V_93 ; V_91 ++ ) {
struct V_9 * V_10 ;
V_10 = F_45 ( V_11 -> V_71 , V_112 ) ;
if ( ! V_10 )
goto V_67;
V_10 -> V_38 = F_23 ;
V_11 -> V_94 [ V_91 ] = V_10 ;
}
V_11 -> V_34 = F_45 ( V_11 -> V_40 , V_112 ) ;
if ( ! V_11 -> V_34 )
goto V_67;
F_46 ( V_87 , L_1 ) ;
F_46 ( V_87 , L_2 , V_87 -> V_85 -> V_113 ,
V_11 -> V_71 -> V_113 , V_11 -> V_40 -> V_113 ) ;
return 0 ;
V_67:
if ( V_11 -> V_71 )
V_11 -> V_71 -> V_12 = NULL ;
...
static void
F_47 ( struct V_95 * V_96 , struct V_2 * V_3 )
{
struct V_1 * V_11 = F_1 ( V_3 ) ;
int V_91 ;
if ( V_11 -> V_34 )
...
int T_3 F_50 ( struct V_95 * V_96 )
{
struct V_1 * V_11 ;
int V_67 , V_114 ;
V_114 = sizeof( * V_11 ) + ( V_93 * sizeof( struct V_9 * ) ) ;
V_11 = F_51 ( V_114 , V_112 ) ;
if ( ! V_11 )
return - V_69 ;
V_11 -> V_6 = V_6 ;
V_11 -> V_4 . V_113 = L_4 ;
...
V_11 -> V_4 . V_119 = F_41 ;
F_52 ( & V_11 -> V_72 . V_31 ) ;
V_67 = F_53 ( V_96 , & V_11 -> V_4 ) ;
if ( V_67 )
F_49 ( V_11 ) ;
return V_67 ;
}
int T_3 F_54 ( struct V_84 * V_85 )
{
struct V_25 * V_26 ;
int V_67 ;
F_55 ( V_6 ) ;
