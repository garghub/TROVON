...
enum V_24 V_56 ;
if ( V_6 -> V_64 . V_46 )
F_11 ( L_16 , V_6 -> V_64 . V_46 ) ;
while ( ( V_8 = F_15 ( & V_6 -> V_64 ) ) != NULL ) {
V_63 = V_8 -> V_16 [ 0 ] ;
F_27 ( V_8 , 1 ) ;
switch ( V_63 & V_65 ) {
case V_66 :
...
{
struct V_5 * V_6 = F_47 ( V_78 , struct V_5 , V_76 ) ;
int V_19 ;
F_11 ( L_14 ) ;
F_48 ( & V_6 -> V_79 ) ;
switch ( V_6 -> V_35 ) {
...
void F_57 ( struct V_5 * V_6 , struct V_4 * V_8 )
{
if ( V_8 == NULL ) {
F_39 ( L_28 ) ;
V_6 -> V_59 = - V_82 ;
...
static int F_59 ( struct V_83 * V_41 )
{
struct V_5 * V_6 = F_60 ( V_41 ) ;
int V_19 ;
F_11 ( L_14 ) ;
if ( V_6 -> V_22 -> V_84 ) {
V_19 = V_6 -> V_22 -> V_84 ( V_6 ) ;
if ( V_19 < 0 )
return V_19 ;
}
V_19 = F_53 ( V_6 ) ;
if ( V_19 < 0 && V_6 -> V_22 -> V_85 )
V_6 -> V_22 -> V_85 ( V_6 ) ;
return V_19 ;
}
static void F_61 ( struct V_83 * V_41 )
{
struct V_5 * V_6 = F_60 ( V_41 ) ;
F_11 ( L_14 ) ;
F_56 ( V_6 ) ;
...
static int F_62 ( struct V_83 * V_41 )
{
struct V_5 * V_6 = F_60 ( V_41 ) ;
int V_19 = 0 ;
F_11 ( L_14 ) ;
if ( V_6 -> V_22 -> V_86 )
V_19 = V_6 -> V_22 -> V_86 ( V_6 ) ;
return V_19 ;
}
static int F_63 ( struct V_83 * V_41 , struct V_4 * V_8 )
{
struct V_5 * V_6 = F_60 ( V_41 ) ;
F_58 ( L_30 , V_8 ) ;
F_32 ( & V_6 -> V_42 , V_8 ) ;
...
static int F_64 ( struct V_83 * V_41 ,
T_3 V_87 , T_3 V_88 )
{
struct V_5 * V_6 = F_60 ( V_41 ) ;
F_11 ( L_14 ) ;
if ( V_6 -> V_22 -> V_89 )
return V_6 -> V_22 -> V_89 ( V_6 ,
V_87 , V_88 ) ;
return 0 ;
}
static int F_65 ( struct V_83 * V_41 , T_2 V_90 ,
struct V_91 * V_92 )
{
struct V_5 * V_6 = F_60 ( V_41 ) ;
if ( V_6 -> V_22 -> V_93 )
return V_6 -> V_22 -> V_93 ( V_6 , V_90 , V_92 ) ;
return - V_94 ;
}
static int F_66 ( struct V_83 * V_41 ,
T_2 V_90 ,
struct V_91 * V_92 )
{
struct V_5 * V_6 = F_60 ( V_41 ) ;
F_11 ( L_14 ) ;
if ( V_6 -> V_22 -> V_95 )
return V_6 -> V_22 -> V_95 ( V_6 , V_90 ,
V_92 ) ;
return 0 ;
}
static int F_67 ( struct V_83 * V_41 ,
struct V_91 * V_92 ,
struct V_4 * V_8 ,
struct V_4 * * V_96 )
{
struct V_5 * V_6 = F_60 ( V_41 ) ;
if ( V_6 -> V_22 -> V_97 )
return V_6 -> V_22 -> V_97 ( V_6 , V_92 , V_8 , V_96 ) ;
return - V_94 ;
}
static int F_68 ( struct V_83 * V_41 ,
struct V_91 * V_92 )
{
struct V_5 * V_6 = F_60 ( V_41 ) ;
if ( V_6 -> V_22 -> V_98 )
return V_6 -> V_22 -> V_98 ( V_6 , V_92 ) ;
return 0 ;
}
struct V_5 * F_69 ( struct V_99 * V_22 ,
struct V_100 * V_101 ,
T_3 V_102 ,
int V_103 , int V_104 ,
int V_105 , const char * V_106 )
{
struct V_5 * V_6 ;
int V_19 ;
char V_107 [ 32 ] ;
if ( V_22 -> V_23 == NULL )
return NULL ;
V_6 = F_70 ( sizeof( struct V_5 ) , V_13 ) ;
if ( V_6 == NULL )
return NULL ;
F_71 ( & V_6 -> V_79 ) ;
V_6 -> V_22 = V_22 ;
...
F_73 ( & V_6 -> V_28 ) ;
F_74 ( & V_6 -> V_76 , F_46 ) ;
snprintf ( V_107 , sizeof( V_107 ) , L_31 , V_106 ) ;
V_6 -> V_75 = F_75 ( V_107 , V_109 | V_110 |
V_111 , 1 ) ;
if ( V_6 -> V_75 == NULL )
goto V_112;
V_6 -> V_9 = V_103 ;
V_6 -> V_11 = V_104 ;
V_6 -> V_41 = F_76 ( & V_113 , V_101 , V_102 ,
V_103 + V_10 ,
V_104 + V_12 ,
V_105 ) ;
if ( V_6 -> V_41 == NULL )
...
void F_84 ( struct V_5 * V_6 , void * V_116 )
{
F_11 ( L_14 ) ;
V_6 -> V_116 = V_116 ;
}
...
struct V_83 * F_86 ( struct V_5 * V_6 )
{
return V_6 -> V_41 ;
}
