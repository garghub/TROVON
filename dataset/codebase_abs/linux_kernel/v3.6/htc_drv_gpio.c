...
struct V_1 ,
V_51 ) ;
F_33 ( V_2 -> V_6 , V_2 -> V_6 -> V_52 ,
( V_2 -> V_53 == V_54 ) ) ;
}
static void F_34 ( struct V_55 * V_56 ,
enum V_57 V_53 )
{
struct V_1 * V_2 = F_10 ( V_56 ,
struct V_1 ,
V_56 ) ;
V_2 -> V_53 = V_53 ;
F_35 ( V_2 -> V_30 , & V_2 -> V_51 ) ;
}
...
if ( F_40 ( V_2 -> V_6 ) )
V_2 -> V_6 -> V_52 = V_59 ;
else if ( F_41 ( V_2 -> V_6 ) )
V_2 -> V_6 -> V_52 = V_60 ;
else if ( F_42 ( V_2 -> V_6 ) )
V_2 -> V_6 -> V_52 = V_61 ;
else
V_2 -> V_6 -> V_52 = V_62 ;
F_43 ( V_2 -> V_6 , V_2 -> V_6 -> V_52 ,
V_63 ) ;
F_33 ( V_2 -> V_6 , V_2 -> V_6 -> V_52 , 1 ) ;
snprintf ( V_2 -> V_64 , sizeof( V_2 -> V_64 ) ,
L_6 , F_44 ( V_2 -> V_30 -> V_65 ) ) ;
V_2 -> V_56 . V_66 = V_2 -> V_64 ;
V_2 -> V_56 . V_67 = F_34 ;
V_25 = F_45 ( F_46 ( V_2 -> V_30 -> V_65 ) , & V_2 -> V_56 ) ;
if ( V_25 < 0 )
return;
F_47 ( & V_2 -> V_51 , F_32 ) ;
V_2 -> V_58 = true ;
...
bool V_68 ;
F_49 ( V_2 ) ;
V_68 = F_2 ( V_2 -> V_6 , V_2 -> V_6 -> V_69 ) ==
V_2 -> V_6 -> V_70 ;
F_50 ( V_2 ) ;
return V_68 ;
}
void F_51 ( struct V_71 * V_30 )
{
