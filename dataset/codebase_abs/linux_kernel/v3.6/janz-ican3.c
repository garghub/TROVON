...
{
struct V_32 V_33 ;
void T_3 * V_62 = V_2 -> V_15 + ( V_2 -> V_48 * sizeof( V_33 ) ) ;
F_1 ( V_2 , V_47 ) ;
...
{
struct V_32 V_33 ;
void T_3 * V_62 = V_2 -> V_15 + ( V_2 -> V_38 * sizeof( V_33 ) ) ;
F_1 ( V_2 , V_40 ) ;
F_7 ( & V_33 , V_62 , sizeof( V_33 ) ) ;
if ( ! ( V_33 . V_42 & V_49 ) ) {
...
static int T_2 F_27 ( struct V_1 * V_2 , bool V_73 )
{
struct V_7 V_8 ;
int V_64 ;
memset ( & V_8 , 0 , sizeof( V_8 ) ) ;
...
static T_5 F_70 ( int V_201 , void * V_202 )
{
...
static void T_4 F_75 ( struct V_1 * V_2 )
{
F_22 ( V_2 ) ;
F_72 ( V_2 ) ;
}
...
static T_6 F_92 ( struct V_238 * V_19 ,
struct V_239 * V_240 ,
char * V_241 )
{
...
static T_6 F_94 ( struct V_238 * V_19 ,
struct V_239 * V_240 ,
const char * V_241 , T_7 V_243 )
{
struct V_1 * V_2 = F_78 ( F_93 ( V_19 ) ) ;
unsigned long V_244 ;
int V_64 ;
...
static int T_2 F_96 ( struct V_245 * V_246 )
{
struct V_247 * V_248 ;
struct V_105 * V_106 ;
struct V_1 * V_2 ;
...
static int T_4 F_115 ( struct V_245 * V_246 )
{
