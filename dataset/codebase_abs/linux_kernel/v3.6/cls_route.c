...
static int F_35 ( struct V_15 * V_16 , unsigned long V_44 ,
T_1 V_33 ,
struct V_45 * * V_63 ,
unsigned long * V_39 )
{
struct V_5 * V_6 = V_16 -> V_19 ;
struct V_9 * V_10 , * V_64 , * * V_40 ;
struct V_22 * V_23 ;
struct V_45 * V_65 = V_63 [ V_66 ] ;
struct V_45 * V_46 [ V_67 + 1 ] ;
unsigned int V_11 , V_68 ;
T_1 V_69 = 0 ;
int V_49 ;
if ( V_65 == NULL )
return V_33 ? - V_42 : 0 ;
V_49 = F_36 ( V_46 , V_67 , V_65 , V_70 ) ;
if ( V_49 < 0 )
return V_49 ;
...
for ( V_40 = & V_10 -> V_43 -> V_31 [ V_11 ] ; ( V_64 = * V_40 ) != NULL ; V_40 = & V_64 -> V_32 )
if ( V_10 -> V_33 < V_64 -> V_33 )
break;
V_10 -> V_32 = V_64 ;
F_27 ( V_16 ) ;
* V_40 = V_10 ;
if ( V_69 && V_10 -> V_33 != V_69 ) {
V_68 = F_16 ( V_69 ) ;
V_11 = F_17 ( V_69 >> 16 ) ;
V_23 = V_6 -> V_30 [ V_68 ] ;
if ( V_23 ) {
...
static void F_37 ( struct V_15 * V_16 , struct V_73 * V_39 )
{
struct V_5 * V_6 = V_16 -> V_19 ;
...
if ( V_39 -> V_75 < V_39 -> V_76 ) {
V_39 -> V_75 ++ ;
continue;
}
if ( V_39 -> V_77 ( V_16 , ( unsigned long ) V_10 , V_39 ) < 0 ) {
V_39 -> V_74 = 1 ;
return;
}
V_39 -> V_75 ++ ;
...
static int F_38 ( struct V_15 * V_16 , unsigned long V_78 ,
struct V_13 * V_14 , struct V_79 * V_80 )
{
struct V_9 * V_10 = (struct V_9 * ) V_78 ;
