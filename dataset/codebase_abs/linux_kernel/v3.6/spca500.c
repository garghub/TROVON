...
T_2 V_37 ;
T_2 V_25 , V_26 ;
F_24 ( V_41 -> V_48 , V_1 -> V_49 , V_1 -> V_50 ,
0x22 ) ;
F_25 ( V_41 -> V_48 , V_51 ) ;
if ( V_41 -> V_42 == V_44 ) {
V_25 = 0x16 ;
...
F_28 ( V_1 , V_76 , V_17 , V_70 ) ;
}
static void F_29 ( struct V_1 * V_1 , T_4 V_77 )
{
F_4 ( V_1 , 0x00 , 0x8167 ,
( T_2 ) ( V_77 - 128 ) ) ;
}
...
{
struct V_1 * V_1 =
F_33 ( V_79 -> V_80 , struct V_1 , V_81 ) ;
V_1 -> V_82 = 0 ;
if ( ! V_1 -> V_83 )
return 0 ;
switch ( V_79 -> V_40 ) {
...
const struct V_39 * V_40 )
{
return F_38 ( V_92 , V_40 , & V_93 , sizeof( struct V_41 ) ,
V_94 ) ;
}
