...
{
struct V_159 * V_167 ;
if ( strlen ( V_50 ) > V_168 ) {
F_3 ( L_53
L_54 , V_164 , V_168 ) ;
return - 1 ;
}
V_167 = F_12 ( sizeof( struct V_159 ) , V_56 ) ;
if ( ! V_167 ) {
F_3 ( L_38
L_55 ) ;
return - 1 ;
...
F_13 ( & V_167 -> V_162 ) ;
strncpy ( V_167 -> V_164 , V_164 , strlen ( V_164 ) + 1 ) ;
strncpy ( V_167 -> V_50 , V_169 ,
strlen ( V_169 ) + 1 ) ;
F_14 ( & V_167 -> V_162 ,
& V_46 -> V_83 ) ;
return 0 ;
...
{
if ( strcmp ( V_50 , V_171 ) && strcmp ( V_50 , V_170 ) ) {
F_3 ( L_69
L_70 , V_48 -> V_49 , V_171 , V_170 ) ;
return - 1 ;
}
return 0 ;
}
static int F_39 ( struct V_47 * V_48 , char * V_172 )
{
char * V_173 ;
int V_50 = 0 ;
V_50 = F_40 ( V_172 , & V_173 , 0 ) ;
if ( F_41 ( V_48 ) ) {
if ( ( V_50 < 0 ) || ( V_50 > 2 ) ) {
F_3 ( L_71
L_72 , V_48 -> V_49 ) ;
...
* V_176 = '\0' ;
V_174 = V_50 ;
V_175 = V_50 + strlen ( V_174 ) + 1 ;
if ( F_39 ( V_48 , V_174 ) < 0 )
return - 1 ;
if ( F_39 ( V_48 , V_175 ) < 0 )
return - 1 ;
V_177 = F_40 ( V_174 , NULL , 0 ) ;
V_178 = F_40 ( V_175 , NULL , 0 ) ;
* V_176 = '~' ;
if ( V_178 < V_177 ) {
F_3 ( L_83
L_84 ,
...
* V_176 = '\0' ;
V_174 = V_48 -> V_50 ;
V_175 = V_48 -> V_50 + strlen ( V_174 ) + 1 ;
V_179 = F_40 ( V_174 , NULL , 0 ) ;
* V_176 = '~' ;
if ( V_48 -> V_158 ) {
if ( ( V_177 < V_179 ) ||
( V_178 < V_179 ) ) {
...
return 0 ;
if ( F_52 ( V_48 ) ) {
if ( strcmp ( V_50 , V_181 ) && strcmp ( V_50 , V_182 ) &&
strcmp ( V_50 , V_183 ) && strcmp ( V_50 , V_184 ) &&
strcmp ( V_50 , V_185 ) && strcmp ( V_50 , V_186 ) ) {
F_3 ( L_71
L_91
L_92 , V_48 -> V_49 , V_181 ,
V_182 , V_183 , V_184 , V_185 , V_186 ) ;
return - 1 ;
}
}
if ( F_53 ( V_48 ) ) {
if ( strcmp ( V_50 , V_187 ) && strcmp ( V_50 , V_186 ) ) {
F_3 ( L_71
L_70 , V_48 -> V_49 ,
V_187 , V_186 ) ;
return - 1 ;
...
if ( F_54 ( V_48 ) ) {
if ( strcmp ( V_50 , V_188 ) && strcmp ( V_50 , V_189 ) ) {
F_3 ( L_71
L_70 , V_48 -> V_49 ,
V_188 , V_189 ) ;
return - 1 ;
...
char * V_50 )
{
char * V_190 , * V_191 = NULL , * V_192 = NULL ;
T_3 V_193 , V_194 ;
V_191 = strchr ( V_50 , '~' ) ;
if ( ! V_191 )
return NULL ;
* V_191 ++ = '\0' ;
V_194 = F_40 ( V_191 , & V_190 , 0 ) ;
V_192 = strchr ( V_48 -> V_50 , '~' ) ;
if ( ! V_192 )
return NULL ;
* V_192 ++ = '\0' ;
V_193 = F_40 ( V_192 , & V_190 , 0 ) ;
return ( V_193 >= V_194 ) ?
V_191 : V_192 ;
}
static char * F_56 (
...
char * V_173 , V_3 [ 10 ] ;
T_3 V_202 = F_40 ( V_48 -> V_50 , & V_173 , 0 ) ;
T_3 V_203 = F_40 ( V_50 , & V_173 , 0 ) ;
memset ( V_3 , 0 , 10 ) ;
if ( ! strcmp ( V_48 -> V_49 , V_95 ) ||
...
if ( F_60 ( V_48 ) ) {
T_3 V_177 = 0 , V_178 = 0 , V_204 = 0 ;
char * V_174 = NULL , * V_175 = NULL ;
char * V_176 = NULL ;
if ( ! strcmp ( V_50 , V_205 ) || ! strcmp ( V_50 , V_180 ) ) {
if ( F_29 ( V_48 , V_50 ) < 0 )
return - 1 ;
return 0 ;
}
...
if ( ! strcmp ( V_50 , V_205 ) ) {
F_7 ( L_104 , V_48 -> V_49 , V_50 ) ;
F_65 ( V_48 ) ;
return 0 ;
}
if ( ! strcmp ( V_50 , V_169 ) ) {
if ( ! F_49 ( V_48 ) ) {
F_3 ( L_105 ,
V_48 -> V_49 , V_50 ) ;
return - 1 ;
...
F_3 ( L_113
L_54 , V_48 -> V_49 ,
( V_53 & V_209 ) ? L_114 : L_115 ) ;
return NULL ;
}
if ( ( V_53 & V_111 ) && ! F_69 ( V_48 ) ) {
F_3 ( L_113
L_54 , V_48 -> V_49 ,
( V_53 & V_209 ) ? L_115 : L_114 ) ;
return NULL ;
}
return V_48 ;
}
...
if ( ! strcmp ( V_48 -> V_49 , V_142 ) && V_210 ) {
if ( F_29 ( V_48 , V_170 ) < 0 )
return - 1 ;
V_23 = 0 ;
F_7 ( L_122 ,
...
if ( ! strcmp ( V_48 -> V_49 , V_144 ) && V_211 ) {
if ( F_29 ( V_48 , V_170 ) < 0 )
return - 1 ;
V_22 = 0 ;
F_7 ( L_122 ,
...
struct V_45 * V_46 )
{
char * V_212 , * V_213 = NULL , * V_214 = NULL ;
V_212 = F_12 ( V_4 + 1 , V_56 ) ;
if ( ! V_212 ) {
F_3 ( L_123 ) ;
return - 1 ;
}
memcpy ( V_212 , V_165 , V_4 ) ;
V_212 [ V_4 ] = '\0' ;
V_213 = V_212 ;
V_214 = ( V_213 + V_4 ) ;
while ( V_213 < V_214 ) {
...
V_213 += strlen ( V_164 ) + strlen ( V_50 ) + 2 ;
continue;
}
if ( F_64 ( V_48 , V_50 ) < 0 ) {
F_15 ( V_212 ) ;
...
* V_4 += sprintf ( V_215 , L_125 , V_160 -> V_164 , V_160 -> V_50 ) ;
* V_4 += 1 ;
V_215 = V_165 + * V_4 ;
...
struct V_47 * V_48 ;
int V_53 = 0 ;
if ( F_28 ( V_217 , & V_164 , & V_50 ) < 0 )
return - 1 ;
if ( ! V_218 ) {
V_48 = F_67 ( V_217 , V_53 , V_46 ) ;
if ( ! V_48 )
return - 1 ;
} else {
V_48 = F_70 ( V_217 , 0 , V_53 , V_46 ) ;
if ( ! V_48 )
return - 1 ;
V_48 -> V_158 = 1 ;
if ( F_64 ( V_48 , V_50 ) < 0 ) {
...
V_219 -> V_19 = ! strcmp ( V_48 -> V_50 , V_187 ) ;
F_7 ( L_131 ,
V_48 -> V_50 ) ;
} else if ( ! strcmp ( V_48 -> V_49 , V_93 ) ) {
V_219 -> V_20 = ! strcmp ( V_48 -> V_50 , V_187 ) ;
F_7 ( L_132 ,
V_48 -> V_50 ) ;
} else if ( ! strcmp ( V_48 -> V_49 , V_122 ) ) {
V_219 -> V_21 =
F_40 ( V_48 -> V_50 , & V_173 , 0 ) ;
F_7 ( L_133 ,
V_48 -> V_50 ) ;
} else if ( ! strcmp ( V_48 -> V_49 , V_144 ) ) {
V_219 -> V_22 = ! strcmp ( V_48 -> V_50 , V_171 ) ;
F_7 ( L_134 ,
V_48 -> V_50 ) ;
} else if ( ! strcmp ( V_48 -> V_49 , V_142 ) ) {
V_219 -> V_23 = ! strcmp ( V_48 -> V_50 , V_171 ) ;
F_7 ( L_135 ,
V_48 -> V_50 ) ;
} else if ( ! strcmp ( V_48 -> V_49 , V_148 ) ) {
V_219 -> V_24 =
...
if ( ! V_48 -> V_50 )
continue;
snprintf ( V_219 -> V_31 , sizeof( V_219 -> V_31 ) ,
L_140 , V_48 -> V_50 ) ;
F_7 ( L_144 ,
V_48 -> V_50 ) ;
} else if ( ! strcmp ( V_48 -> V_49 , V_116 ) ) {
...
V_219 -> V_34 = ! strcmp ( V_48 -> V_50 , V_171 ) ;
F_7 ( L_147 ,
V_48 -> V_50 ) ;
} else if ( ! strcmp ( V_48 -> V_49 , V_120 ) ) {
V_219 -> V_35 = ! strcmp ( V_48 -> V_50 , V_171 ) ;
F_7 ( L_148 ,
V_48 -> V_50 ) ;
} else if ( ! strcmp ( V_48 -> V_49 , V_124 ) ) {
V_219 -> V_36 =
...
V_219 -> V_41 = ! strcmp ( V_48 -> V_50 , V_171 ) ;
F_7 ( L_154 ,
V_48 -> V_50 ) ;
} else if ( ! strcmp ( V_48 -> V_49 , V_136 ) ) {
V_219 -> V_42 = ! strcmp ( V_48 -> V_50 , V_171 ) ;
F_7 ( L_155 ,
V_48 -> V_50 ) ;
} else if ( ! strcmp ( V_48 -> V_49 , V_138 ) ) {
V_219 -> V_43 =
...
V_219 -> V_44 = ! strcmp ( V_48 -> V_50 , V_188 ) ;
F_7 ( L_157 ,
V_48 -> V_50 ) ;
}
}
