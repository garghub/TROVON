...
V_42 = F_7 ( L_5 , V_64 | V_60 , V_2 , & V_41 ,
& V_65 [ 0 ] , V_37 ) ;
if ( V_42 ) {
F_35 ( L_6 ,
V_57 , V_42 ) ;
...
V_42 = F_7 ( L_7 , V_64 | V_60 , V_2 , & V_41 ,
& V_65 [ 1 ] , V_37 ) ;
if ( V_42 ) {
F_35 ( L_8 ,
V_57 , V_42 ) ;
...
V_42 = F_7 ( L_9 , V_64 | V_60 , V_2 , & V_41 ,
& V_66 [ 0 ] , V_37 ) ;
if ( V_42 ) {
F_35 ( L_10 ,
V_57 , L_9 , V_42 ) ;
...
V_42 = F_7 ( V_67 , V_64 | V_60 , V_2 , & V_41 ,
& V_66 [ V_58 ] , V_37 ) ;
if ( V_42 ) {
F_35 ( L_10 ,
V_57 , V_67 , V_42 ) ;
...
V_42 = F_7 ( L_13 , V_64 | V_71 | V_60 , V_2 , & V_41 ,
& V_72 , V_37 ) ;
if ( V_42 )
F_35 ( L_14 ,
V_57 , V_42 ) ;
...
F_36 ( V_2 , L_13 ) ;
F_45 ( V_2 ) ;
V_42 = F_46 ( V_74 -> V_26 , V_2 ) ;
V_10:
F_12 ( & V_74 -> V_26 -> V_27 ) ;
F_47 ( V_74 ) ;
return V_42 ;
}
static int F_48 ( struct V_55 * V_56 , void * V_7 , int V_75 )
{
...
static struct V_3 * F_53 ( struct V_81 * V_82 , int V_68 ,
const char * V_83 , void * V_7 )
{
struct V_3 * V_42 ;
V_42 = F_54 ( V_82 , V_68 , V_7 , F_48 ) ;
if ( ! F_10 ( V_42 ) )
V_84 = V_42 -> V_85 ;
return V_42 ;
}
static void F_55 ( struct V_55 * V_86 )
{
F_56 ( V_86 ) ;
V_84 = NULL ;
}
