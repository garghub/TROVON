...
static inline void F_25 ( struct V_65 * V_66 , void T_2 * V_11 )
{
F_26 ( V_11 ) ;
F_24 ( V_66 -> V_72 , F_22 ( V_66 ) ) ;
}
static int T_5 F_27 ( struct V_62 * V_63 , struct V_1 * V_5 , unsigned char V_75 , T_6 V_4 , T_3 * V_76 , T_3 * V_77 ) {
int V_67 ;
int V_78 ;
char V_79 [ 9 ] ;
char V_80 [ 6 ] ;
...
static int T_5 F_35 ( struct V_62 * V_63 )
{
int V_67 ;
struct V_1 * V_5 ;
struct V_6 * V_7 ;
...
static int T_7 F_43 ( struct V_62 * V_63 )
{
