...
static int F_59 ( struct V_88 * V_21 )
{
int V_113 ;
...
F_11 ( L_15 ,
F_60 ( V_21 -> V_109 -> V_119 . V_120 ) ,
F_60 ( V_21 -> V_109 -> V_119 . V_121 ) ) ;
if ( ( F_60 ( V_21 -> V_109 -> V_119 . V_120 ) & 0x8000 )
!= 0x8000 ) {
F_11 ( L_16 ) ;
return 1 ;
}
switch ( F_60 ( V_21 -> V_109 -> V_119 . V_121 ) ) {
case V_122 :
V_116 = L_17 ;
break;
case V_123 :
...
break;
default:
F_61 ( & V_21 -> V_109 -> V_109 , L_29 ,
F_60 ( V_21 -> V_109 -> V_119 . V_121 ) ) ;
return 1 ;
}
if ( F_62 ( & V_118 , V_116 , & V_21 -> V_109 -> V_109 ) ) {
F_61 ( & V_21 -> V_109 -> V_109 , L_30 , V_116 ) ;
return 1 ;
}
F_11 ( L_31 , V_116 ) ;
V_113 = F_63 ( V_21 , 1 ) ;
V_115 = ( const struct V_114 * ) V_118 -> V_74 ;
while ( V_115 ) {
V_113 = F_64 ( V_21 , F_65 ( V_115 -> V_134 ) ,
( unsigned char * ) V_115 -> V_74 ,
F_66 ( V_115 -> V_102 ) , 0xa0 ) ;
if ( V_113 < 0 ) {
F_61 ( & V_21 -> V_109 -> V_109 , L_32 ,
V_113 , F_65 ( V_115 -> V_134 ) ,
V_115 -> V_74 , F_66 ( V_115 -> V_102 ) ) ;
break;
}
V_115 = F_67 ( V_115 ) ;
}
...
static struct V_135 const * F_69 ( struct V_88 const * V_21 ,
int V_73 )
{
struct V_136 * V_137 ;
struct V_135 * V_138 ;
int V_72 ;
V_137 = V_21 -> V_139 -> V_140 ;
for ( V_72 = 0 ; V_72 < V_137 -> V_141 . V_142 ; ++ V_72 ) {
V_138 = & V_137 -> V_73 [ V_72 ] . V_141 ;
if ( V_138 -> V_143 == V_73 )
return V_138 ;
}
F_70 ( & V_21 -> V_139 -> V_109 , L_33
L_34 , V_73 ) ;
return NULL ;
}
static struct V_52 * F_71 ( struct V_88 * V_21 , int V_73 ,
int V_144 , void * V_145 , char * V_47 , int V_102 ,
void (* F_72)( struct V_52 * ) )
{
struct V_52 * V_52 ;
struct V_135 const * V_146 ;
char const * V_147 ;
if ( V_73 == - 1 )
return NULL ;
F_11 ( L_35 , V_59 , V_73 ) ;
...
V_146 = F_69 ( V_21 , V_73 ) ;
if ( ! V_146 ) {
return V_52 ;
}
if ( F_74 ( V_146 ) ) {
V_147 = L_37 ;
F_75 ( V_52 , V_21 -> V_109 ,
F_76 ( V_21 -> V_109 , V_73 ) | V_144 ,
V_47 , V_102 , F_72 , V_145 ,
V_146 -> V_148 ) ;
} else if ( F_77 ( V_146 ) ) {
V_147 = L_38 ;
F_78 ( V_52 , V_21 -> V_109 ,
F_79 ( V_21 -> V_109 , V_73 ) | V_144 ,
V_47 , V_102 , F_72 , V_145 ) ;
} else {
F_70 ( & V_21 -> V_139 -> V_109 ,
L_39 ,
F_80 ( V_146 ) ) ;
F_81 ( V_52 ) ;
return NULL ;
...
F_11 ( L_40 ,
V_59 , V_52 , V_147 , V_73 ) ;
return V_52 ;
}
static void F_82 ( struct V_88 * V_21 )
{
int V_72 , V_149 ;
struct V_150 * V_151 ;
const struct V_14 * V_15 ;
...
V_21 , V_151 -> V_159 , V_160 ,
V_153 -> V_161 ) ;
V_151 -> V_162 = F_71
( V_21 , V_15 -> V_163 , V_158 ,
V_21 , V_151 -> V_164 , V_165 ,
F_42 ) ;
V_151 -> V_166 = F_71
( V_21 , V_15 -> V_167 , V_168 ,
V_21 , V_151 -> V_169 , V_170 ,
V_153 -> V_171 ) ;
for ( V_72 = 0 ; V_72 < V_15 -> V_90 ; V_72 ++ ) {
V_5 = V_21 -> V_5 [ V_72 ] ;
V_8 = F_2 ( V_5 ) ;
V_154 = V_15 -> V_172 [ V_72 ] ;
for ( V_149 = 0 ; V_149 <= V_15 -> V_173 ; ++ V_149 , ++ V_154 ) {
V_8 -> V_95 [ V_149 ] = F_71
...
for ( V_149 = 0 ; V_149 <= V_15 -> V_71 ; ++ V_149 , ++ V_154 ) {
V_8 -> V_61 [ V_149 ] = F_71
...
V_8 -> V_85 = 0 ;
if ( V_15 -> V_258 == V_259 ) {
V_253 = ( void * ) ( V_151 -> V_260 ) ;
V_253 -> V_261 = V_262 | V_168 ;
V_253 -> V_263 = 0xB0 ; ;
V_253 -> V_264 = 0 ;
V_253 -> V_265 = 0 ;
V_253 -> V_266 = F_88 ( sizeof( V_87 ) ) ;
memcpy ( V_151 -> V_169 , & V_87 , sizeof( V_87 ) ) ;
F_89 ( V_53 , V_21 -> V_109 ,
F_90 ( V_21 -> V_109 , 0 ) ,
( unsigned char * ) V_253 , V_151 -> V_169 ,
...
break;
if ( V_15 == NULL ) {
F_61 ( & V_21 -> V_109 -> V_109 , L_54 ,
V_59 , F_60 ( V_21 -> V_109 -> V_119 . V_121 ) ) ;
return 1 ;
}
V_151 = F_92 ( sizeof( struct V_150 ) , V_110 ) ;
if ( ! V_151 ) {
F_11 ( L_55 ,
V_59 ) ;
return - V_290 ;
...
F_82 ( V_21 ) ;
if ( V_151 -> V_156 != NULL ) {
V_54 = F_15 ( V_151 -> V_156 , V_110 ) ;
if ( V_54 != 0 )
F_11 ( L_57 , V_59 ,
V_54 ) ;
}
if ( V_151 -> V_162 != NULL ) {
V_54 = F_15 ( V_151 -> V_162 , V_110 ) ;
if ( V_54 != 0 )
F_11 ( L_58 , V_59 ,
V_54 ) ;
}
