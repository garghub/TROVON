...
int T_10 F_110 ( struct V_26 * V_27 )
{
int V_110 = 0 ;
T_7 V_198 ;
T_6 V_199 ;
unsigned long V_17 ;
struct V_11 * V_12 ;
V_27 -> V_193 = ( ( void V_200 * ) V_27 -> V_201 ) + 4096 ;
V_12 = F_100 ( V_27 , 0 , 64 , 0 ) ;
if ( ! V_12 )
return - V_100 ;
V_198 = V_12 -> V_14 - 1 ;
V_198 |= V_198 << 16 ;
V_27 -> V_202 = V_203 | V_204 ;
V_27 -> V_202 |= ( V_205 - 12 ) << V_206 ;
V_27 -> V_202 |= V_207 | V_208 ;
V_27 -> V_202 |= V_209 | V_210 ;
F_22 ( 0 , & V_27 -> V_201 -> V_211 ) ;
F_22 ( V_198 , & V_27 -> V_201 -> V_198 ) ;
F_111 ( V_12 -> V_171 , & V_27 -> V_201 -> V_212 ) ;
F_111 ( V_12 -> V_162 , & V_27 -> V_201 -> V_213 ) ;
F_22 ( V_27 -> V_202 , & V_27 -> V_201 -> V_211 ) ;
V_199 = F_112 ( & V_27 -> V_201 -> V_199 ) ;
V_17 = ( ( F_113 ( V_199 ) + 1 ) * V_214 / 2 ) + V_23 ;
V_27 -> V_143 = F_114 ( V_199 ) ;
while ( ! V_110 && ! ( F_115 ( & V_27 -> V_201 -> V_215 ) & V_216 ) ) {
F_116 ( 100 ) ;
if ( F_117 ( V_151 ) )
V_110 = - V_25 ;
if ( F_92 ( V_23 , V_17 ) ) {
F_118 ( & V_27 -> V_33 -> V_27 ,
L_5 ) ;
V_110 = - V_217 ;
}
}
...
V_110 = F_107 ( V_27 , V_12 , L_6 ) ;
V_27 -> V_37 [ 0 ] = V_12 ;
return V_110 ;
}
static struct V_45 * F_119 ( struct V_26 * V_27 , int V_218 ,
unsigned long V_219 , unsigned V_57 )
{
int V_59 , V_220 , V_221 , V_73 , V_47 ;
struct V_54 * V_55 ;
struct V_222 * * V_223 ;
struct V_45 * V_46 ;
if ( V_219 & 3 )
...
return F_120 ( - V_224 ) ;
V_47 = F_46 ( V_219 ) ;
V_221 = F_26 ( V_47 + V_57 , V_50 ) ;
V_223 = F_121 ( V_221 , sizeof( * V_223 ) , V_190 ) ;
if ( ! V_223 )
return F_120 ( - V_100 ) ;
V_220 = F_122 ( V_219 , V_221 , 1 , V_223 ) ;
if ( V_220 < V_221 ) {
V_221 = V_220 ;
V_220 = - V_225 ;
goto V_226;
}
V_46 = F_27 ( V_221 , V_57 , V_190 ) ;
V_55 = V_46 -> V_55 ;
F_52 ( V_55 , V_221 ) ;
for ( V_59 = 0 ; V_59 < V_221 ; V_59 ++ ) {
F_56 ( & V_55 [ V_59 ] , V_223 [ V_59 ] ,
F_123 ( int , V_57 , V_50 - V_47 ) , V_47 ) ;
V_57 -= ( V_50 - V_47 ) ;
V_47 = 0 ;
}
F_57 ( & V_55 [ V_59 - 1 ] ) ;
V_46 -> V_73 = V_221 ;
V_220 = - V_100 ;
V_73 = F_58 ( & V_27 -> V_33 -> V_27 , V_55 , V_221 ,
V_218 ? V_74 : V_75 ) ;
if ( ! V_73 )
goto V_119;
F_33 ( V_223 ) ;
...
static void F_125 ( struct V_26 * V_27 , int V_218 ,
struct V_45 * V_46 )
{
int V_59 ;
F_40 ( & V_27 -> V_33 -> V_27 , V_46 -> V_55 , V_46 -> V_73 ,
...
F_124 ( F_126 ( & V_46 -> V_55 [ V_59 ] ) ) ;
}
static int F_127 ( struct V_101 * V_102 , struct V_227 T_11 * V_228 )
{
...
int V_72 ;
struct V_45 * V_46 ;
if ( F_128 ( & V_229 , V_228 , sizeof( V_229 ) ) )
return - V_225 ;
V_57 = ( V_229 . V_230 + 1 ) << V_102 -> V_132 ;
switch ( V_229 . V_105 ) {
case V_127 :
case V_128 :
case V_231 :
V_46 = F_119 ( V_27 , V_229 . V_105 & 1 , V_229 . V_219 , V_57 ) ;
break;
default:
return - V_224 ;
}
...
return F_130 ( V_46 ) ;
memset ( & V_155 , 0 , sizeof( V_155 ) ) ;
V_155 . V_126 . V_105 = V_229 . V_105 ;
V_155 . V_126 . V_39 = V_229 . V_39 ;
V_155 . V_126 . V_107 = F_60 ( V_102 -> V_108 ) ;
V_155 . V_126 . V_130 = F_47 ( V_229 . V_130 ) ;
V_155 . V_126 . V_57 = F_65 ( V_229 . V_230 ) ;
V_155 . V_126 . V_111 = F_65 ( V_229 . V_111 ) ;
V_155 . V_126 . V_112 = F_65 ( V_229 . V_112 ) ;
V_155 . V_126 . V_232 = V_229 . V_232 ;
V_155 . V_126 . V_233 = V_229 . V_233 ;
V_155 . V_126 . V_234 = V_229 . V_234 ;
V_57 = F_43 ( V_27 , & V_155 . V_104 , V_46 , V_57 , V_190 ) ;
V_12 = F_16 ( V_27 ) ;
F_18 ( V_12 ) ;
if ( V_57 != ( V_229 . V_230 + 1 ) << V_102 -> V_132 )
V_72 = - V_100 ;
else
V_72 = F_78 ( V_12 , & V_155 , NULL , V_109 ) ;
F_125 ( V_27 , V_229 . V_105 & 1 , V_46 ) ;
F_30 ( V_27 , V_46 ) ;
return V_72 ;
}
static int F_131 ( struct V_26 * V_27 ,
struct V_235 T_11 * V_236 )
{
struct V_235 V_38 ;
struct V_6 V_155 ;
int V_72 , V_57 ;
struct V_45 * V_237 ( V_46 ) ;
if ( ! F_132 ( V_238 ) )
return - V_239 ;
if ( F_128 ( & V_38 , V_236 , sizeof( V_38 ) ) )
return - V_225 ;
memset ( & V_155 , 0 , sizeof( V_155 ) ) ;
V_155 . V_104 . V_105 = V_38 . V_105 ;
V_155 . V_104 . V_39 = V_38 . V_39 ;
V_155 . V_104 . V_107 = F_60 ( V_38 . V_107 ) ;
V_155 . V_104 . V_240 [ 0 ] = F_60 ( V_38 . V_240 ) ;
V_155 . V_104 . V_240 [ 1 ] = F_60 ( V_38 . V_241 ) ;
V_155 . V_104 . V_242 [ 0 ] = F_60 ( V_38 . V_242 ) ;
V_155 . V_104 . V_242 [ 1 ] = F_60 ( V_38 . V_243 ) ;
V_155 . V_104 . V_242 [ 2 ] = F_60 ( V_38 . V_244 ) ;
V_155 . V_104 . V_242 [ 3 ] = F_60 ( V_38 . V_245 ) ;
V_155 . V_104 . V_242 [ 4 ] = F_60 ( V_38 . V_246 ) ;
V_155 . V_104 . V_242 [ 5 ] = F_60 ( V_38 . V_247 ) ;
V_57 = V_38 . V_248 ;
if ( V_38 . V_248 ) {
V_46 = F_119 ( V_27 , V_38 . V_105 & 1 , V_38 . V_219 ,
V_57 ) ;
if ( F_129 ( V_46 ) )
return F_130 ( V_46 ) ;
...
V_72 = F_81 ( V_27 , & V_155 , NULL ) ;
if ( V_38 . V_248 ) {
F_125 ( V_27 , V_38 . V_105 & 1 , V_46 ) ;
F_30 ( V_27 , V_46 ) ;
}
return V_72 ;
}
static int F_133 ( struct V_249 * V_250 , T_12 V_251 , unsigned int V_38 ,
unsigned long V_252 )
{
struct V_101 * V_102 = V_250 -> V_253 -> V_254 ;
switch ( V_38 ) {
case V_255 :
return V_102 -> V_108 ;
case V_256 :
return F_131 ( V_102 -> V_27 , ( void T_11 * ) V_252 ) ;
case V_257 :
return F_127 ( V_102 , ( void T_11 * ) V_252 ) ;
default:
return - V_258 ;
}
}
...
{
while ( F_135 ( & V_12 -> V_68 ) ) {
struct V_67 * V_67 = F_136 ( & V_12 -> V_68 ) ;
struct V_101 * V_102 = V_67 -> V_259 -> V_253 -> V_254 ;
if ( F_63 ( V_12 , V_102 , V_67 ) ) {
F_137 ( & V_12 -> V_68 , V_67 ) ;
break;
}
if ( F_35 ( & V_12 -> V_68 ) )
F_138 ( & V_12 -> V_24 ,
...
static int F_139 ( void * V_146 )
{
struct V_26 * V_27 ;
while ( ! F_140 () ) {
F_141 ( V_260 ) ;
F_72 ( & V_261 ) ;
F_142 (dev, &dev_list, node) {
int V_59 ;
for ( V_59 = 0 ; V_59 < V_27 -> V_262 ; V_59 ++ ) {
...
int V_264 , error ;
do {
if ( ! F_146 ( & V_265 , V_190 ) )
return - 1 ;
F_72 ( & V_261 ) ;
error = F_147 ( & V_265 , & V_264 ) ;
F_73 ( & V_261 ) ;
} while ( error == - V_266 );
if ( error )
V_264 = - 1 ;
...
static void F_148 ( int V_264 )
{
F_72 ( & V_261 ) ;
F_149 ( & V_265 , V_264 ) ;
F_73 ( & V_261 ) ;
}
static struct V_101 * F_150 ( struct V_26 * V_27 , int V_107 ,
struct V_8 * V_154 , struct V_9 * V_267 )
{
struct V_101 * V_102 ;
struct V_268 * V_269 ;
int V_270 ;
...
if ( ! V_102 )
return NULL ;
V_102 -> V_113 = F_151 ( V_190 ) ;
if ( ! V_102 -> V_113 )
goto V_273;
V_102 -> V_113 -> V_274 = V_275 ;
F_152 ( V_276 , V_102 -> V_113 ) ;
F_152 ( V_277 , V_102 -> V_113 ) ;
F_153 ( V_102 -> V_113 , F_66 ) ;
V_102 -> V_27 = V_27 ;
...
V_102 -> V_108 = V_107 ;
V_102 -> V_269 = V_269 ;
V_270 = V_154 -> V_280 & 0xf ;
V_102 -> V_132 = V_154 -> V_270 [ V_270 ] . V_281 ;
F_155 ( V_102 -> V_113 , 1 << V_102 -> V_132 ) ;
if ( V_27 -> V_282 )
F_156 ( V_102 -> V_113 , V_27 -> V_282 ) ;
V_269 -> V_283 = V_284 ;
V_269 -> V_285 = V_278 ;
V_269 -> V_286 = V_278 * F_145 () ;
V_269 -> V_287 = & V_288 ;
V_269 -> V_254 = V_102 ;
V_269 -> V_113 = V_102 -> V_113 ;
V_269 -> V_289 = & V_27 -> V_33 -> V_27 ;
sprintf ( V_269 -> V_290 , L_8 , V_27 -> V_291 , V_107 ) ;
F_157 ( V_269 , F_158 ( & V_154 -> V_292 ) << ( V_102 -> V_132 - 9 ) ) ;
return V_102 ;
V_279:
F_159 ( V_102 -> V_113 ) ;
V_273:
...
static void F_160 ( struct V_101 * V_102 )
{
int V_264 = V_102 -> V_269 -> V_286 / V_278 ;
F_161 ( V_102 -> V_269 ) ;
F_148 ( V_264 ) ;
F_159 ( V_102 -> V_113 ) ;
F_33 ( V_102 ) ;
}
static int F_162 ( struct V_26 * V_27 , int V_221 )
{
int V_72 ;
T_7 V_110 ;
T_7 V_293 = ( V_221 - 1 ) | ( ( V_221 - 1 ) << 16 ) ;
V_72 = F_89 ( V_27 , V_294 , V_293 , 0 ,
& V_110 ) ;
if ( V_72 )
return - V_76 ;
return F_163 ( V_110 & 0xffff , V_110 >> 16 ) + 1 ;
}
static int T_10 F_164 ( struct V_26 * V_27 )
{
int V_110 , V_295 , V_59 , V_296 , V_297 , V_14 ;
V_296 = F_165 () ;
V_110 = F_162 ( V_27 , V_296 ) ;
if ( V_110 < 0 )
return V_110 ;
if ( V_110 < V_296 )
V_296 = V_110 ;
F_99 ( V_27 -> V_187 [ 0 ] . V_186 , V_27 -> V_37 [ 0 ] ) ;
V_297 = 4096 + ( ( V_296 + 1 ) << ( V_27 -> V_143 + 3 ) ) ;
if ( V_297 > 8192 ) {
F_166 ( V_27 -> V_201 ) ;
V_27 -> V_201 = F_167 ( F_168 ( V_27 -> V_33 , 0 ) ,
V_297 ) ;
V_27 -> V_193 = ( ( void V_200 * ) V_27 -> V_201 ) + 4096 ;
V_27 -> V_37 [ 0 ] -> V_44 = V_27 -> V_193 ;
}
for ( V_59 = 0 ; V_59 < V_296 ; V_59 ++ )
V_27 -> V_187 [ V_59 ] . V_187 = V_59 ;
for (; ; ) {
V_110 = F_169 ( V_27 -> V_33 , V_27 -> V_187 ,
V_296 ) ;
if ( V_110 == 0 ) {
break;
} else if ( V_110 > 0 ) {
...
V_110 = F_107 ( V_27 , V_27 -> V_37 [ 0 ] , L_6 ) ;
V_295 = F_170 ( V_298 ) ;
for ( V_59 = 0 ; V_59 < V_296 ; V_59 ++ ) {
F_98 ( V_27 -> V_187 [ V_59 ] . V_186 , F_171 ( V_295 ) ) ;
V_295 = F_172 ( V_295 , V_298 ) ;
}
V_14 = F_123 ( int , F_173 ( F_112 ( & V_27 -> V_201 -> V_199 ) ) + 1 ,
V_299 ) ;
for ( V_59 = 0 ; V_59 < V_296 ; V_59 ++ ) {
V_27 -> V_37 [ V_59 + 1 ] = F_174 ( V_27 , V_59 + 1 , V_14 , V_59 ) ;
if ( F_129 ( V_27 -> V_37 [ V_59 + 1 ] ) )
return F_130 ( V_27 -> V_37 [ V_59 + 1 ] ) ;
V_27 -> V_262 ++ ;
}
for (; V_59 < F_175 () ; V_59 ++ ) {
int V_300 = V_59 % F_176 ( V_27 -> V_262 - 1 ) ;
V_27 -> V_37 [ V_59 + 1 ] = V_27 -> V_37 [ V_300 + 1 ] ;
}
return 0 ;
}
...
{
int V_59 ;
for ( V_59 = V_27 -> V_262 - 1 ; V_59 >= 0 ; V_59 -- )
F_97 ( V_27 , V_59 ) ;
}
static int T_10 F_178 ( struct V_26 * V_27 )
{
int V_301 , V_302 , V_59 ;
struct V_101 * V_102 , * V_303 ;
struct V_7 * V_304 ;
struct V_8 * V_305 ;
void * V_306 ;
T_5 V_84 ;
...
if ( V_301 )
return V_301 ;
V_306 = F_102 ( & V_27 -> V_33 -> V_27 , 8192 , & V_84 ,
V_190 ) ;
V_301 = F_87 ( V_27 , 0 , 1 , V_84 ) ;
if ( V_301 ) {
V_301 = - V_76 ;
goto V_307;
}
V_304 = V_306 ;
V_302 = F_77 ( & V_304 -> V_302 ) ;
memcpy ( V_27 -> V_308 , V_304 -> V_309 , sizeof( V_304 -> V_309 ) ) ;
memcpy ( V_27 -> V_310 , V_304 -> V_311 , sizeof( V_304 -> V_311 ) ) ;
memcpy ( V_27 -> V_312 , V_304 -> V_313 , sizeof( V_304 -> V_313 ) ) ;
if ( V_304 -> V_314 ) {
int V_315 = F_179 ( F_112 ( & V_27 -> V_201 -> V_199 ) ) + 12 ;
V_27 -> V_282 = 1 << ( V_304 -> V_314 + V_315 - 9 ) ;
}
V_305 = V_306 ;
for ( V_59 = 1 ; V_59 <= V_302 ; V_59 ++ ) {
V_301 = F_87 ( V_27 , V_59 , 0 , V_84 ) ;
if ( V_301 )
continue;
if ( V_305 -> V_316 == 0 )
continue;
V_301 = F_88 ( V_27 , V_317 , V_59 ,
V_84 + 4096 ) ;
if ( V_301 )
continue;
V_102 = F_150 ( V_27 , V_59 , V_306 , V_306 + 4096 ) ;
if ( V_102 )
F_180 ( & V_102 -> V_60 , & V_27 -> V_318 ) ;
}
F_142 (ns, &dev->namespaces, list)
F_181 ( V_102 -> V_269 ) ;
goto V_319;
V_307:
...
V_319:
F_94 ( & V_27 -> V_33 -> V_27 , 8192 , V_306 , V_84 ) ;
return V_301 ;
}
...
{
struct V_88 * V_188 = & V_27 -> V_33 -> V_27 ;
V_27 -> V_66 = F_187 ( L_9 , V_188 ,
V_50 , V_50 , 0 ) ;
if ( ! V_27 -> V_66 )
return - V_100 ;
V_27 -> V_63 = F_187 ( L_10 , V_188 ,
256 , 256 , 0 ) ;
if ( ! V_27 -> V_63 ) {
F_188 ( V_27 -> V_66 ) ;
return - V_100 ;
...
int V_291 , error ;
do {
if ( ! F_146 ( & V_321 , V_190 ) )
return - V_217 ;
F_72 ( & V_261 ) ;
error = F_147 ( & V_321 , & V_291 ) ;
F_73 ( & V_261 ) ;
} while ( error == - V_266 );
if ( error )
return - V_217 ;
...
{
F_72 ( & V_261 ) ;
F_149 ( & V_321 , V_27 -> V_291 ) ;
F_73 ( & V_261 ) ;
}
static int T_10 F_192 ( struct V_33 * V_322 ,
const struct V_323 * V_154 )
{
int V_324 , V_110 = - V_100 ;
struct V_26 * V_27 ;
V_27 = F_101 ( sizeof( * V_27 ) , V_190 ) ;
if ( ! V_27 )
return - V_100 ;
V_27 -> V_187 = F_121 ( F_175 () , sizeof( * V_27 -> V_187 ) ,
V_190 ) ;
if ( ! V_27 -> V_187 )
goto free;
V_27 -> V_37 = F_121 ( F_175 () + 1 , sizeof( void * ) ,
V_190 ) ;
if ( ! V_27 -> V_37 )
goto free;
if ( F_193 ( V_322 ) )
goto free;
F_194 ( V_322 ) ;
V_324 = F_195 ( V_322 , V_325 ) ;
if ( F_196 ( V_322 , V_324 , L_11 ) )
goto V_326;
F_197 ( & V_27 -> V_318 ) ;
V_27 -> V_33 = V_322 ;
F_198 ( V_322 , V_27 ) ;
F_199 ( & V_322 -> V_27 , F_200 ( 64 ) ) ;
F_201 ( & V_322 -> V_27 , F_200 ( 64 ) ) ;
V_110 = F_190 ( V_27 ) ;
if ( V_110 )
goto V_326;
V_27 -> V_187 [ 0 ] . V_186 = V_322 -> V_145 ;
V_110 = F_186 ( V_27 ) ;
if ( V_110 )
goto V_327;
V_27 -> V_201 = F_167 ( F_168 ( V_322 , 0 ) , 8192 ) ;
if ( ! V_27 -> V_201 ) {
V_110 = - V_100 ;
goto V_327;
}
...
static void T_13 F_206 ( struct V_33 * V_322 )
{
struct V_26 * V_27 = F_207 ( V_322 ) ;
F_184 ( V_27 ) ;
F_203 ( V_322 ) ;
F_166 ( V_27 -> V_201 ) ;
F_191 ( V_27 ) ;
...
{
int V_110 ;
V_70 = F_209 ( F_139 , NULL , L_11 ) ;
if ( F_129 ( V_70 ) )
return F_130 ( V_70 ) ;
V_110 = F_210 ( V_284 , L_11 ) ;
if ( V_110 < 0 )
goto V_331;
else if ( V_110 > 0 )
V_284 = V_110 ;
