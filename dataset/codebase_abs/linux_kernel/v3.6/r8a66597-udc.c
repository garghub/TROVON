...
F_140 ( & V_1 -> V_15 . V_299 ) ;
F_118 ( V_1 ) ;
return 0 ;
}
static void F_141 ( struct V_278 * V_21 , struct V_281 * V_303 )
{
}
...
{
struct V_304 * V_305 ;
V_305 = F_143 ( V_298 , V_306 , L_20 ) ;
if ( ! V_305 ) {
F_17 ( & V_298 -> V_299 , L_21 ) ;
return - V_111 ;
}
V_1 -> V_301 = F_144 ( V_305 -> V_307 , F_145 ( V_305 ) ) ;
if ( V_1 -> V_301 == NULL ) {
...
static int T_7 F_146 ( struct V_297 * V_298 )
{
char V_308 [ 8 ] ;
...
int V_54 ;
unsigned long V_310 ;
V_305 = F_147 ( V_298 , V_306 , 0 ) ;
if ( ! V_305 ) {
V_31 = - V_111 ;
F_17 ( & V_298 -> V_299 , L_23 ) ;
goto V_311;
}
V_309 = F_147 ( V_298 , V_312 , 0 ) ;
V_255 = V_309 -> V_307 ;
...
V_5 = F_144 ( V_305 -> V_307 , F_145 ( V_305 ) ) ;
if ( V_5 == NULL ) {
V_31 = - V_81 ;
...
V_1 -> V_302 = F_153 ( & V_298 -> V_299 , V_308 ) ;
if ( F_154 ( V_1 -> V_302 ) ) {
F_17 ( & V_298 -> V_299 , L_30 ,
V_308 ) ;
V_31 = F_155 ( V_1 -> V_302 ) ;
goto V_326;
}
F_156 ( V_1 -> V_302 ) ;
}
if ( V_1 -> V_46 -> V_300 ) {
V_31 = F_142 ( V_1 , V_298 ) ;
if ( V_31 < 0 )
goto V_327;
}
F_12 ( V_1 ) ;
V_31 = F_157 ( V_255 , F_106 , V_328 ,
V_322 , V_1 ) ;
if ( V_31 < 0 ) {
...
if ( V_1 -> V_213 == NULL )
goto V_332;
V_1 -> V_213 -> V_187 = F_141 ;
V_31 = F_158 ( & V_298 -> V_299 , & V_1 -> V_15 ) ;
if ( V_31 )
goto V_333;
F_159 ( & V_298 -> V_299 , L_32 , V_334 ) ;
return 0 ;
V_333:
F_117 ( & V_1 -> V_21 [ 0 ] . V_21 , V_1 -> V_213 ) ;
V_332:
