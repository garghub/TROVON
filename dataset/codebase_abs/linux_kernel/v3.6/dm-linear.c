...
int V_35 = 0 ;
if ( V_6 -> V_13 ||
V_2 -> V_36 != F_15 ( V_15 -> V_22 -> V_37 ) >> V_38 )
V_35 = F_16 ( NULL , V_32 ) ;
return V_35 ? : F_17 ( V_15 -> V_22 , V_15 -> V_39 , V_32 , V_33 ) ;
}
static int F_18 ( struct V_1 * V_2 , struct V_40 * V_41 ,
struct V_42 * V_43 , int V_44 )
{
struct V_5 * V_6 = V_2 -> V_18 ;
struct V_45 * V_46 = F_19 ( V_6 -> V_15 -> V_22 ) ;
if ( ! V_46 -> V_47 )
return V_44 ;
V_41 -> V_21 = V_6 -> V_15 -> V_22 ;
V_41 -> V_19 = F_8 ( V_2 , V_41 -> V_19 ) ;
