...
static int F_28 ( struct V_39 * V_40 , int V_28 )
{
struct V_26 * V_27 = V_40 -> V_70 ;
return F_8 ( V_27 , V_28 ) ;
}
static int V_26 ( struct V_71 * V_72 , const struct V_39 * V_40 ,
struct V_73 * V_74 )
{
int V_9 = 0 , V_75 = 0 ;
struct V_26 * V_27 = V_40 -> V_70 ;
...
static int F_35 ( struct V_71 * V_72 , struct V_39 * V_40 , int V_28 , int V_96 )
{
unsigned char * V_97 = F_36 ( V_72 ) ;
struct V_26 * V_27 = V_40 -> V_70 ;
struct V_1 * V_2 ;
struct V_98 V_99 ;
struct V_100 V_101 ;
V_2 = F_22 ( V_27 -> V_31 , V_27 -> V_31 -> V_11 . V_12 . V_22 , V_77 ) ;
if ( F_20 ( ! V_2 ) )
goto V_102;
V_101 . V_103 = V_27 -> V_29 - V_28 ;
V_101 . V_104 = V_27 -> V_30 - V_96 ;
strcpy ( V_2 -> V_11 . V_12 . V_13 , V_27 -> V_31 -> V_11 . V_15 . V_8 -> V_13 ) ;
if ( F_37 ( V_72 , V_53 , V_27 -> V_31 -> V_11 . V_12 . V_22 , V_2 ) ||
F_38 ( V_72 , V_54 , V_27 -> V_105 ) ||
F_38 ( V_72 , V_52 , V_27 -> V_66 ) ||
F_37 ( V_72 , V_106 , sizeof( struct V_100 ) , & V_101 ) ||
F_39 ( V_72 , V_62 , V_27 -> V_32 ) )
goto V_102;
V_99 . V_107 = F_40 ( V_81 - V_27 -> V_79 . V_107 ) ;
V_99 . V_80 = F_40 ( V_81 - V_27 -> V_79 . V_80 ) ;
V_99 . V_108 = F_40 ( V_27 -> V_79 . V_108 ) ;
if ( F_37 ( V_72 , V_109 , sizeof ( V_99 ) , & V_99 ) )
goto V_102;
F_9 ( V_2 ) ;
return V_72 -> V_110 ;
V_102:
