...
T_4 int T_3 F_79 ( char * V_101 )
{
if ( V_101 && strncmp ( V_101 , L_58 , 1 ) != 0 )
V_102 = 1 ;
return 0 ;
}
int T_3 F_80 ( char * V_101 )
{
unsigned long V_71 ;
if ( V_101 ) {
if ( ! F_81 ( V_101 , 0 , & V_71 ) )
V_103 = V_71 ;
}
return 0 ;
}
void F_82 ( char * V_104 , unsigned short V_105 )
{
F_83 ( L_59 , V_104 ) ;
}
void F_84 ( struct V_69 * V_106 )
{
