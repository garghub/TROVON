...
static void T_4 F_27 ( struct V_1 * V_25 )
{
int V_26 ;
if ( ( V_25 -> V_29 >> 8 ) != V_30 )
return;
...
static void T_4 F_28 ( struct V_1 * V_25 )
{
int V_26 ;
F_17 ( L_9 , F_26 ( V_25 ) ) ;
for( V_26 = 0 ; V_26 < 4 ; V_26 ++ )
...
struct V_35 * V_36 ;
struct V_1 * V_2 ;
for ( V_36 = V_4 -> V_37 . V_38 ; V_36 != & V_4 -> V_37 ; V_36 = V_36 -> V_38 ) {
V_2 = F_33 ( V_36 ) ;
if ( V_2 -> V_5 == 0 ) {
V_2 -> V_27 [ 0 ] . V_32 = 0 ;
V_2 -> V_27 [ 0 ] . V_33 = 0 ;
...
return - V_42 ;
V_43 |= V_44 | V_45 ;
F_36 ( 1 ) = ( ( V_46 + 0x01000000 ) >> 9 ) | 0x08000000 ;
F_36 ( 2 ) = ( ( V_46 + 0x00000000 ) >> 9 ) | 0x08000000 ;
* ( volatile V_47 * ) ( V_48 + 0x848 ) = 0xe0000000 ;
* ( volatile V_47 * ) ( V_48 + 0x8b8 ) = 0x00000000 ;
V_49 = ( V_46 + 0x04000000 ) >> 9 ;
V_50 = ( V_46 + 0x08000000 ) >> 9 ;
V_51 = V_46 + 0x04000000 ;
V_52 = V_46 + 0x08000000 ;
F_37 () ;
V_53 = V_54 ;
V_55 . V_32 = ( V_49 << 9 ) & 0xfffffc00 ;
V_55 . V_33 = ( V_56 << 9 ) | 0x3ff ;
V_55 . V_33 += V_55 . V_32 ;
F_17 ( L_11 ,
( unsigned long long ) V_55 . V_32 ,
( unsigned long long ) V_55 . V_33 ) ;
V_57 . V_32 = ( V_50 << 9 ) & 0xfffffc00 ;
V_57 . V_33 = ( V_58 << 9 ) | 0x3ff ;
V_57 . V_33 += V_57 . V_32 ;
V_57 . V_32 += 0x400 ;
F_17 ( L_12 ,
( unsigned long long ) V_57 . V_32 ,
( unsigned long long ) V_57 . V_33 ) ;
F_17 ( L_13 ,
V_59 , V_60 ) ;
if ( F_38 ( & V_61 , & V_57 ) < 0 )
F_39 ( L_14 ) ;
...
char * T_2 F_45 ( char * V_65 )
{
if ( ! strcmp ( V_65 , L_18 ) ) {
V_63 = 0 ;
return NULL ;
} else if ( ! strncmp ( V_65 , L_19 , 8 ) ) {
V_22 = F_46 ( V_65 + 8 , NULL , 0 ) ;
return NULL ;
}
return V_65 ;
}
