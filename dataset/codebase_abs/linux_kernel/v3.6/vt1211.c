...
if ( ! F_66 ( V_10 , V_52 -> V_96 , F_67 ( V_52 ) ,
V_97 ) ) {
F_64 ( V_10 , L_12 ,
...
static int T_5 F_75 ( struct V_83 * V_84 )
{
...
static int T_6 F_78 ( unsigned short V_103 )
{
struct V_92 V_52 = {
. V_96 = V_103 ,
. V_98 = V_103 + 0x7f ,
...
static int T_6 F_85 ( int V_1 , unsigned short * V_103 )
{
int V_59 = - V_106 ;
int V_107 ;
F_6 ( V_1 ) ;
