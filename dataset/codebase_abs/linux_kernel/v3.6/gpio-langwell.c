...
static int F_36 ( struct V_59 * V_28 )
{
return 0 ;
}
static int F_37 ( struct V_59 * V_28 )
{
int V_60 = F_38 ( V_28 , 500 ) ;
if ( ! V_60 )
return 0 ;
return - V_61 ;
}
static int T_5 F_39 ( struct V_62 * V_27 ,
...
V_65 = F_43 ( V_27 , 0 ) ;
V_66 = F_44 ( V_27 , 0 ) ;
V_46 = F_47 ( & V_27 -> V_28 , V_65 , V_66 ) ;
if ( ! V_46 ) {
F_42 ( & V_27 -> V_28 , L_5 ) ;
V_68 = - V_71 ;
goto V_72;
}
V_7 = F_48 ( & V_27 -> V_28 , sizeof( struct V_6 ) , V_73 ) ;
if ( ! V_7 ) {
F_42 ( & V_27 -> V_28 , L_6 ) ;
V_68 = - V_74 ;
goto V_72;
}
V_7 -> V_30 = F_49 ( V_27 -> V_28 . V_75 , V_9 ,
& V_76 , V_7 ) ;
if ( ! V_7 -> V_30 ) {
V_68 = - V_74 ;
goto V_72;
...
static int T_5 F_60 ( struct V_85 * V_27 )
{
struct V_6 * V_7 ;
struct V_1 * V_86 ;
struct V_87 * V_88 ;
int V_68 = 0 ;
V_88 = F_61 ( V_27 , V_89 , 0 ) ;
if ( ! V_88 )
return - V_38 ;
V_7 = F_62 ( sizeof( struct V_6 ) , V_73 ) ;
if ( ! V_7 ) {
F_42 ( & V_27 -> V_28 ,
L_8 ) ;
return - V_74 ;
}
V_7 -> V_12 = F_45 ( V_88 -> V_65 , F_63 ( V_88 ) ) ;
if ( V_7 -> V_12 == NULL ) {
V_68 = - V_38 ;
goto V_90;
}
...
static int T_7 F_66 ( struct V_85 * V_27 )
{
struct V_6 * V_7 = F_67 ( V_27 ) ;
int V_60 ;
V_60 = F_68 ( & V_7 -> V_2 ) ;
if ( V_60 )
F_42 ( & V_27 -> V_28 , L_10 ) ;
