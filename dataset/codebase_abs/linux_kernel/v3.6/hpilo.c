...
F_81 ( V_64 , V_113 ) ;
F_40 ( V_113 ) ;
error = F_82 ( V_64 -> V_134 , F_61 , V_155 , L_7 , V_113 ) ;
if ( error )
goto V_156;
F_41 ( V_113 ) ;
F_83 ( & V_113 -> V_125 , & V_157 ) ;
...
int error ;
T_12 V_73 ;
V_142 = F_88 ( V_159 , L_11 ) ;
if ( F_86 ( V_142 ) ) {
error = F_89 ( V_142 ) ;
goto V_130;
}
error = F_90 ( & V_73 , 0 , V_162 , V_152 ) ;
if ( error )
goto V_163;
V_143 = F_91 ( V_73 ) ;
error = F_92 ( & V_164 ) ;
