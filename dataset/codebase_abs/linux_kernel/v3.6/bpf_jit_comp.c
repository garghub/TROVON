...
break;
case V_46 :
F_23 ( F_24 ( struct V_40 , V_87 ) != 2 ) ;
if ( F_3 ( F_14 ( struct V_40 , V_87 ) ) ) {
F_12 ( 0x0f , 0xb7 , 0x47 , F_14 ( struct V_40 , V_87 ) ) ;
} else {
F_15 ( 0x0f , 0xb7 , 0x87 ) ;
...
break;
case V_47 :
if ( F_3 ( F_14 ( struct V_40 , V_88 ) ) ) {
F_12 ( 0x48 , 0x8b , 0x47 , F_14 ( struct V_40 , V_88 ) ) ;
} else {
F_15 ( 0x48 , 0x8b , 0x87 ) ;
F_16 ( F_14 ( struct V_40 , V_88 ) , 4 ) ;
}
F_15 ( 0x48 , 0x85 , 0xc0 ) ;
F_20 ( V_64 , V_28 - ( V_29 [ V_18 ] - 6 ) ) ;
F_23 ( F_24 ( struct V_89 , V_90 ) != 4 ) ;
F_18 ( 0x8b , 0x80 ) ;
F_16 ( F_14 ( struct V_89 , V_90 ) , 4 ) ;
break;
case V_48 :
...
break;
case V_49 :
F_23 ( F_24 ( struct V_40 , V_92 ) != 4 ) ;
if ( F_3 ( F_14 ( struct V_40 , V_92 ) ) ) {
F_15 ( 0x8b , 0x47 , F_14 ( struct V_40 , V_92 ) ) ;
} else {
F_18 ( 0x8b , 0x87 ) ;
...
F_21 ( V_19 ) ;
break;
F_27 ( V_106 , V_107 , V_108 ) ;
F_27 ( V_109 , V_110 , V_111 ) ;
F_27 ( V_112 , V_64 , V_65 ) ;
F_27 ( V_113 , V_65 , V_64 ) ;
F_27 ( V_114 , V_107 , V_108 ) ;
F_27 ( V_115 , V_110 , V_111 ) ;
F_27 ( V_116 , V_64 , V_65 ) ;
F_27 ( V_117 , V_65 , V_64 ) ;
V_118: V_20 = V_29 [ V_18 + V_31 [ V_18 ] . V_119 ] - V_29 [ V_18 ] ;
V_19 = V_29 [ V_18 + V_31 [ V_18 ] . V_120 ] - V_29 [ V_18 ] ;
if ( V_31 [ V_18 ] . V_120 == V_31 [ V_18 ] . V_119 ) {
F_21 ( V_19 ) ;
break;
}
switch ( V_31 [ V_18 ] . V_43 ) {
...
if ( V_31 [ V_18 ] . V_120 != 0 ) {
if ( V_31 [ V_18 ] . V_119 && V_20 )
V_19 += F_4 ( V_20 ) ? 2 : 5 ;
F_20 ( V_21 , V_19 ) ;
if ( V_31 [ V_18 ] . V_119 )
F_21 ( V_20 ) ;
...
if ( V_25 ) {
if ( V_34 > 1 )
F_34 ( V_122 , L_4 , V_123 ,
16 , 1 , V_25 , V_15 , false ) ;
F_5 ( V_25 , V_25 + V_15 ) ;
V_12 -> V_124 = ( void * ) V_25 ;
}
V_121:
F_30 ( V_29 ) ;
return;
...
{
if ( V_12 -> V_124 != V_127 ) {
struct V_125 * V_128 = (struct V_125 * ) V_12 -> V_124 ;
F_37 ( V_128 , F_35 ) ;
F_38 ( V_128 ) ;
}
}
