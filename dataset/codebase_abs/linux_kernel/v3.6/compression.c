...
V_18 = F_38 ( V_2 , V_105 , V_96 , V_31 , 0 ) ;
F_36 ( V_18 ) ;
F_22 ( V_96 ) ;
return 0 ;
V_104:
for ( V_65 = 0 ; V_65 < V_27 ; V_65 ++ )
F_64 ( ( unsigned long ) V_16 -> V_28 [ V_65 ] ) ;
F_21 ( V_16 -> V_28 ) ;
V_102:
F_21 ( V_16 ) ;
V_39:
...
if ( F_80 ( V_112 ) )
return - 1 ;
V_18 = V_124 [ type - 1 ] -> F_89 ( V_112 , V_48 ,
V_43 , V_63 , V_56 ,
V_126 , V_127 ,
V_128 , V_129 ,
V_130 ) ;
...
struct V_50 * V_51 , int V_132 , T_6 V_133 )
{
struct V_111 * V_112 ;
int V_18 ;
V_112 = F_69 ( type ) ;
if ( F_80 ( V_112 ) )
return - V_68 ;
V_18 = V_124 [ type - 1 ] -> F_90 ( V_112 , V_131 ,
V_17 ,
V_51 , V_132 , V_133 ) ;
F_83 ( type , V_112 ) ;
return V_18 ;
}
int F_91 ( int type , unsigned char * V_134 , struct V_19 * V_135 ,
...
if ( F_80 ( V_112 ) )
return - V_68 ;
V_18 = V_124 [ type - 1 ] -> F_92 ( V_112 , V_134 ,
V_135 , V_136 ,
V_133 , V_137 ) ;
F_83 ( type , V_112 ) ;
return V_18 ;
...
int F_94 ( char * V_138 , unsigned long V_139 ,
unsigned long V_129 , T_2 V_17 ,
struct V_50 * V_51 , int V_132 ,
unsigned long * V_65 ,
unsigned long * V_140 )
{
unsigned long V_141 ;
...
unsigned long V_144 ;
char * V_21 ;
struct V_19 * V_145 = V_51 [ * V_65 ] . V_52 ;
...
V_142 = V_139 ;
while ( V_143 > 0 ) {
V_144 = F_95 ( V_29 - * V_140 ,
V_29 - V_141 ) ;
V_144 = F_95 ( V_144 , V_143 ) ;
V_21 = F_8 ( V_145 ) ;
