...
struct V_58 V_59 ;
if ( F_30 ( V_2 , V_43 , sizeof( V_54 ) , & V_54 ) ||
F_31 ( V_2 , V_44 , V_8 -> V_15 ) )
goto V_60;
V_59 . V_61 = F_32 ( V_13 - V_8 -> V_11 . V_61 ) ;
V_59 . V_12 = F_32 ( V_13 - V_8 -> V_11 . V_12 ) ;
V_59 . V_62 = F_32 ( V_8 -> V_11 . V_62 ) ;
if ( F_30 ( V_2 , V_63 , sizeof( V_59 ) , & V_59 ) )
goto V_60;
return V_2 -> V_64 ;
V_60:
F_33 ( V_2 , V_53 ) ;
