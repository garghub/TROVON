...
static void F_4 ( void * V_1 , T_1 * V_2 , const T_1 * V_3 , T_1 * V_8 )
{
T_2 V_9 ;
F_5 ( & V_9 , V_8 ) ;
F_6 ( V_8 ) ;
...
if ( V_31 )
return V_31 ;
return F_30 ( & V_1 -> V_49 , V_28 + V_29 / 2 , V_29 / 2 ) ;
}
static int F_39 ( struct V_12 * V_13 , struct V_14 * V_2 ,
struct V_14 * V_3 , unsigned int V_15 )
{
...
int V_42 ;
V_13 -> V_43 &= ~ V_44 ;
V_42 = F_41 ( V_13 , V_2 , V_3 , V_15 , & V_37 ) ;
F_22 ( V_35 . V_20 ) ;
return V_42 ;
}
static int F_42 ( struct V_12 * V_13 , struct V_14 * V_2 ,
struct V_14 * V_3 , unsigned int V_15 )
{
struct V_45 * V_1 = F_33 ( V_13 -> V_27 ) ;
T_2 V_34 [ V_5 ] ;
