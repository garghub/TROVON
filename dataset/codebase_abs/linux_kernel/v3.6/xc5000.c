...
if ( V_141 -> V_95 > V_59 )
V_8 -> V_57 = V_59 ;
V_8 -> V_61 = V_141 -> V_115 * 62500 ;
if ( V_141 -> V_142 & V_143 ) {
V_8 -> V_53 = V_144 ;
goto V_145;
}
if ( V_141 -> V_142 & V_146 ) {
V_8 -> V_53 = V_147 ;
goto V_145;
}
if ( V_141 -> V_142 & V_148 ) {
V_8 -> V_53 = V_149 ;
goto V_145;
}
...
if ( V_141 -> V_142 & V_152 ) {
V_8 -> V_53 = V_153 ;
goto V_145;
}
if ( V_141 -> V_142 & V_154 ) {
V_8 -> V_53 = V_155 ;
goto V_145;
}
if ( V_141 -> V_142 & V_156 ) {
V_8 -> V_53 = V_157 ;
goto V_145;
}
V_145:
...
V_8 -> V_61 = V_141 -> V_115 * 125 / 2 ;
V_8 -> V_57 = V_58 ;
V_30 = F_13 ( V_8 , V_52 [ V_158 ] . V_50 ,
V_52 [ V_158 ] . V_51 ) ;
if ( V_30 != V_19 ) {
F_4 ( V_17 L_38 ) ;
return - V_25 ;
...
switch ( V_141 -> V_95 ) {
case V_166 :
V_30 = F_36 ( V_28 , V_141 ) ;
break;
case V_167 :
case V_168 :
V_30 = F_35 ( V_28 , V_141 ) ;
break;
}
return V_30 ;
}
...
static int F_41 ( struct V_27 * V_28 , T_3 * V_169 )
{
struct V_7 * V_8 = V_28 -> V_29 ;
T_2 V_77 = 0 ;
F_19 ( V_8 , & V_77 ) ;
...
static int F_48 ( struct V_27 * V_28 , void * V_172 )
{
struct V_7 * V_8 = V_28 -> V_29 ;
struct V_173 * V_174 = V_172 ;
F_9 ( 1 , L_3 , V_31 ) ;
if ( V_174 -> V_131 )
V_8 -> V_131 = V_174 -> V_131 ;
if ( V_174 -> V_158 )
V_8 -> V_158 = V_174 -> V_158 ;
return 0 ;
}
struct V_27 * F_49 ( struct V_27 * V_28 ,
struct V_175 * V_176 ,
const struct V_173 * V_177 )
{
struct V_7 * V_8 = NULL ;
int V_178 ;
T_2 V_137 = 0 ;
...
V_177 ? V_177 -> V_179 : - 1 ) ;
F_45 ( & V_171 ) ;
V_178 = F_51 ( struct V_7 , V_8 ,
V_180 ,
V_176 , V_177 -> V_179 , L_51 ) ;
switch ( V_178 ) {
case 0 :
goto V_181;
break;
...
if ( V_8 -> V_131 == 0 ) {
V_8 -> V_131 = V_177 -> V_131 ;
}
if ( V_8 -> V_98 == 0 )
V_8 -> V_98 = V_177 -> V_98 ;
if ( V_8 -> V_158 == 0 )
V_8 -> V_158 = V_177 -> V_158 ;
if ( ( V_8 -> V_2 == 0 ) || ( V_177 -> V_2 ) )
V_8 -> V_2 = ( V_177 -> V_2 ) ? V_177 -> V_2 : 0 ;
if ( F_5 ( V_8 , V_138 , & V_137 ) != V_19 )
goto V_181;
switch ( V_137 ) {
case V_182 :
F_4 ( V_102
