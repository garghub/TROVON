...
static int F_40 ( struct V_1 * V_2 , const struct V_41 * V_42 ,
struct V_23 * V_12 )
{
unsigned int V_6 ;
int V_30 ;
...
bool V_173 = ! F_75 ( V_174 , & V_165 -> V_52 ) && V_172 ;
int V_98 = - V_72 ;
if ( V_173 && F_106 ( V_172 ) )
return - V_175 ;
if ( F_93 ( V_165 , V_128 ) )
goto exit;
...
struct V_130 * V_165 = F_73 ( V_128 ) ;
struct V_171 * V_172 = V_165 -> V_166 -> V_172 ? V_165 -> V_166 -> V_172 : V_165 -> V_172 ;
bool V_173 = ! F_75 ( V_174 , & V_165 -> V_52 ) && V_165 -> V_172 ;
int V_98 = - V_72 ;
if ( V_173 && F_106 ( V_172 ) )
return - V_175 ;
if ( F_93 ( V_165 , V_128 ) )
...
unsigned V_133 ;
void * V_71 ;
bool V_176 = F_75 ( V_174 , & V_165 -> V_52 ) ;
bool V_173 = false ;
if ( V_4 -> V_22 == 0 && V_4 -> V_71 == NULL ) {
if ( ! F_41 ( V_4 -> type ) && ( V_4 -> V_64 & V_139 ) &&
( V_132 & ( V_140 | V_141 ) ) )
...
F_110 ( V_173 && ! V_176 && ! V_172 ) ;
if ( V_173 && ! V_176 && V_172 && F_106 ( V_172 ) )
return V_142 ;
V_71 = V_4 -> V_71 ;
V_133 = F_72 ( V_165 -> V_166 , V_128 , V_129 ) ;
if ( V_173 && ! V_71 && V_4 -> V_71 )
V_4 -> V_167 = V_128 -> V_137 ;
if ( V_173 && ! V_176 && V_172 )
F_107 ( V_172 ) ;
return V_133 ;
}
unsigned long F_111 ( struct V_128 * V_128 , unsigned long V_125 ,
unsigned long V_126 , unsigned long V_127 , unsigned long V_52 )
{
struct V_130 * V_165 = F_73 ( V_128 ) ;
return F_71 ( V_165 -> V_166 , V_125 , V_126 , V_127 , V_52 ) ;
}
void F_112 ( struct V_3 * V_177 )
{
F_107 ( V_177 -> V_172 ) ;
}
void F_113 ( struct V_3 * V_177 )
{
F_114 ( V_177 -> V_172 ) ;
}
