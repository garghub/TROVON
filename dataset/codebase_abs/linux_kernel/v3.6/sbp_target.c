...
if ( F_109 ( & V_3 -> V_160 , V_20 -> V_19 , V_3 -> V_143 ,
...
V_164 = 4 << F_111 ( F_3 ( V_3 -> V_62 . V_63 ) ) ;
V_11 = F_112 ( F_3 ( V_3 -> V_62 . V_63 ) ) ;
V_165 = F_113 ( F_3 ( V_3 -> V_62 . V_63 ) ) ;
if ( V_165 ) {
F_17 ( L_42 ) ;
V_165 = 0x100 << V_165 ;
}
...
F_114 ( & V_170 , V_3 -> V_160 . V_174 , V_3 -> V_160 . V_175 ,
V_163 ) ;
while ( V_80 || V_166 ) {
if ( ! V_80 ) {
V_82 = ( T_1 ) F_108 ( V_168 -> V_176 ) << 32 |
F_3 ( V_168 -> V_177 ) ;
V_80 = F_108 ( V_168 -> V_157 ) ;
V_168 ++ ;
V_166 -- ;
}
F_115 ( & V_170 ) ;
V_167 = F_116 ( V_80 , V_164 , ( int ) V_170 . V_80 ) ;
...
static void F_138 ( struct V_160 * V_160 )
{
struct V_124 * V_3 = F_71 ( V_160 ,
struct V_124 , V_160 ) ;
F_87 ( V_3 ) ;
}
...
static int F_142 ( struct V_160 * V_160 )
{
struct V_124 * V_3 = F_71 ( V_160 ,
struct V_124 , V_160 ) ;
int V_4 ;
...
static int F_144 ( struct V_160 * V_160 )
{
return 0 ;
}
static void F_145 ( struct V_43 * V_206 )
{
return;
}
static T_4 F_146 ( struct V_160 * V_160 )
{
struct V_124 * V_3 = F_71 ( V_160 ,
struct V_124 , V_160 ) ;
return ( T_4 ) V_3 -> V_110 ;
}
static int F_147 ( struct V_160 * V_160 )
{
return 0 ;
}
...
static T_6 F_151 ( struct V_160 * V_160 , T_4 V_207 )
{
return 0 ;
}
...
static int F_153 ( struct V_160 * V_160 )
{
struct V_124 * V_3 = F_71 ( V_160 ,
struct V_124 , V_160 ) ;
F_154 ( & V_3 -> V_160 , 0 ) ;
...
{
int V_218 , V_219 , V_153 = 0 , V_220 , V_4 , V_216 ;
T_4 * V_99 ;
if ( V_58 -> V_221 . V_99 ) {
F_162 ( & V_58 -> V_221 ) ;
F_21 ( V_58 -> V_221 . V_99 ) ;
V_58 -> V_221 . V_99 = NULL ;
}
if ( ! V_58 -> V_199 || ! V_58 -> V_17 )
return 0 ;
V_218 = F_160 ( & V_58 -> V_17 -> V_22 ) ;
V_219 = F_163 ( V_222 ) + 4 + V_218 ;
if ( V_58 -> V_223 != - 1 )
V_219 ++ ;
V_99 = F_164 ( ( V_219 + 4 ) , sizeof( T_4 ) , V_45 ) ;
if ( ! V_99 )
return - V_46 ;
V_99 [ V_153 ++ ] = V_219 << 16 ;
if ( V_58 -> V_223 != - 1 )
V_99 [ V_153 ++ ] = ( V_224 << 24 ) | V_58 -> V_223 ;
memcpy ( & V_99 [ V_153 ] , V_222 ,
sizeof( V_222 ) ) ;
V_153 += F_163 ( V_222 ) ;
V_220 = ( V_58 -> V_225 -> V_81 . V_82 - V_12 ) / 4 ;
V_99 [ V_153 ++ ] = 0x54000000 | ( V_220 & 0x00ffffff ) ;
V_99 [ V_153 ++ ] = 0x3a000000 |
( ( ( V_58 -> V_226 * 2 ) << 8 ) & 0xff00 ) |
V_227 ;
V_99 [ V_153 ++ ] = 0x3d000000 | ( V_58 -> V_77 & 0xffff ) ;
V_99 [ V_153 ++ ] = 0x8d000000 | ( V_218 + 1 ) ;
F_13 ( & V_58 -> V_17 -> V_22 . V_37 ) ;
for ( V_216 = 0 ; V_216 < V_35 ; V_216 ++ ) {
struct V_27 * V_27 = V_58 -> V_17 -> V_22 . V_38 [ V_216 ] ;
struct V_228 * V_229 ;
int type ;
if ( V_27 -> V_39 == V_217 )
continue;
...
V_99 [ V_153 ++ ] = V_58 -> V_1 ;
V_58 -> V_221 . V_80 = V_153 ;
V_58 -> V_221 . V_233 = ( V_234 | V_235 ) << 24 ;
V_58 -> V_221 . V_99 = V_99 ;
V_4 = F_165 ( & V_58 -> V_221 ) ;
if ( V_4 < 0 ) {
F_21 ( V_58 -> V_221 . V_99 ) ;
V_58 -> V_221 . V_99 = NULL ;
}
...
static T_7 F_166 ( const char * V_236 , T_1 * V_237 , int V_238 )
{
const char * V_239 ;
char V_240 , V_241 ;
int V_242 = 0 , V_159 ;
* V_237 = 0 ;
for ( V_239 = V_236 ; V_239 < & V_236 [ V_243 - 1 ] ; V_239 ++ ) {
V_240 = * V_239 ;
if ( V_240 == '\n' && V_239 [ 1 ] == '\0' )
continue;
if ( V_240 == '\0' ) {
...
if ( isdigit ( V_240 ) )
V_241 = V_240 - '0' ;
else if ( isxdigit ( V_240 ) && ( islower ( V_240 ) || ! V_238 ) )
V_241 = tolower ( V_240 ) - 'a' + 10 ;
else
goto V_244;
* V_237 = ( * V_237 << 4 ) | V_241 ;
V_242 ++ ;
...
V_244:
F_167 ( V_245 L_60 ,
V_159 , V_239 - V_236 , V_242 ) ;
return - 1 ;
}
static T_7 F_168 ( char * V_212 , T_3 V_246 , T_1 V_237 )
{
return snprintf ( V_212 , V_246 , L_3 , V_237 ) ;
}
...
V_206 = F_71 ( V_44 , struct V_205 , V_43 ) ;
V_206 -> V_1 = V_1 ;
F_168 ( V_206 -> V_251 , V_243 , V_1 ) ;
return V_44 ;
}
static void F_171 ( struct V_43 * V_252 )
{
struct V_205 * V_206 =
F_71 ( V_252 , struct V_205 , V_43 ) ;
...
{
struct V_57 * V_58 =
F_71 ( V_237 , struct V_57 , V_254 ) ;
struct V_16 * V_17 ;
unsigned long V_255 ;
int V_4 ;
if ( strstr ( V_236 , L_62 ) != V_236 )
return F_12 ( - V_36 ) ;
if ( F_176 ( V_236 + 5 , 10 , & V_255 ) || V_255 > V_256 )
return F_12 ( - V_36 ) ;
if ( V_58 -> V_17 ) {
F_17 ( L_63 ) ;
return F_12 ( - V_257 ) ;
...
V_58 -> V_1 = V_1 ;
F_168 ( V_58 -> V_203 , V_243 , V_1 ) ;
return & V_58 -> V_254 ;
}
static void F_181 ( struct V_253 * V_237 )
{
struct V_57 * V_58 =
F_71 ( V_237 , struct V_57 , V_254 ) ;
F_21 ( V_58 ) ;
...
return sprintf ( V_263 , L_68 , V_58 -> V_223 ) ;
}
static T_7 F_184 (
struct V_34 * V_22 ,
const char * V_263 ,
...
struct V_16 * V_17 = F_71 ( V_22 , struct V_16 , V_22 ) ;
struct V_57 * V_58 = V_17 -> V_58 ;
return sprintf ( V_263 , L_71 , V_58 -> V_226 ) ;
}
static T_7 F_188 (
struct V_34 * V_22 ,
const char * V_263 ,
