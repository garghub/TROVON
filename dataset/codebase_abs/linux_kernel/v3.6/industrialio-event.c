...
F_44 ( & V_2 -> V_7 -> V_70 ) ;
F_39 ( V_2 -> V_7 ) ;
if ( V_2 -> V_47 -> V_82 != NULL ) {
V_42 = V_2 -> V_47 -> V_82 -> V_83 ;
while ( * V_42 ++ != NULL )
V_79 ++ ;
}
V_56 = V_79 ;
...
V_2 -> V_7 -> V_85 . V_74 = V_86 ;
V_2 -> V_7 -> V_85 . V_83 = F_45 ( V_56 + 1 ,
sizeof( V_2 -> V_7 -> V_85 . V_83 [ 0 ] ) ,
V_60 ) ;
if ( V_2 -> V_7 -> V_85 . V_83 == NULL ) {
V_27 = - V_64 ;
goto V_84;
}
if ( V_2 -> V_47 -> V_82 )
memcpy ( V_2 -> V_7 -> V_85 . V_83 ,
V_2 -> V_47 -> V_82 -> V_83 ,
sizeof( V_2 -> V_7 -> V_85 . V_83 [ 0 ] )
* V_79 ) ;
V_80 = V_79 ;
