...
struct V_69 * V_70 ;
struct V_65 * V_66 = F_26 ( V_41 ) ;
struct V_105 * V_106 = V_66 -> V_84 . V_106 ;
...
if ( F_111 ( V_217 != V_218 ) )
V_241 -> V_244 . V_265 = F_112 ( V_217 ,
V_268 ) ;
if ( V_241 -> V_244 . V_265 < 0 )
V_241 -> V_244 . V_265 = 0 ;
if ( F_113 ( V_121 ) )
V_8 -> V_30 -> V_269 . V_270 = V_241 -> V_244 . V_265 ;
V_242 -> V_271 = F_114 ( V_241 -> V_244 . V_272 ) ;
V_242 -> V_155 = V_15 -> V_123 . V_154 -> V_155 ;
V_242 -> V_273 = V_15 -> V_123 . V_154 -> V_274 ;
V_242 -> signal = V_241 -> V_244 . V_265 + V_275 ;
V_242 -> V_276 = V_241 -> V_244 . V_277 ;
V_242 -> V_227 |= V_278 ;
return true ;
V_249:
return false ;
...
{
struct V_7 * V_8 = (struct V_7 * ) V_46 ;
struct V_240 * V_241 = NULL , * V_279 = NULL ;
struct V_220 V_242 ;
struct V_40 * V_41 ;
unsigned long V_13 ;
struct V_69 * V_70 ;
do {
F_64 ( & V_8 -> V_216 . V_280 , V_13 ) ;
...
memcpy ( F_117 ( V_241 -> V_41 ) , & V_242 ,
sizeof( struct V_220 ) ) ;
V_41 = V_241 -> V_41 ;
V_70 = (struct V_69 * ) V_41 -> V_46 ;
if ( F_113 ( V_70 -> V_72 ) && V_8 -> V_283 )
F_118 ( V_8 -> V_15 , & V_8 -> V_284 ) ;
F_67 ( & V_8 -> V_216 . V_280 , V_13 ) ;
F_119 ( V_8 -> V_15 , V_41 ) ;
F_64 ( & V_8 -> V_216 . V_280 , V_13 ) ;
V_282:
V_241 -> V_281 = false ;
V_241 -> V_41 = NULL ;
F_120 ( & V_241 -> V_166 , & V_8 -> V_216 . V_241 ) ;
V_241 = NULL ;
F_67 ( & V_8 -> V_216 . V_280 , V_13 ) ;
} while ( 1 );
}
...
F_72 ( & V_8 -> V_216 . V_280 ) ;
if ( V_241 == NULL ) {
F_37 ( V_29 , V_285 , L_11 ) ;
goto V_286;
}
F_70 ( & V_8 -> V_216 . V_280 ) ;
V_241 -> V_41 = V_41 ;
...
struct V_240 * V_241 ;
int V_174 = 0 ;
F_124 ( & V_8 -> V_216 . V_241 ) ;
F_125 ( & V_8 -> V_216 . V_280 ) ;
for ( V_174 = 0 ; V_174 < V_289 ; V_174 ++ ) {
V_241 = F_69 ( sizeof( struct V_240 ) , V_290 ) ;
if ( V_241 == NULL ) {
F_17 ( V_29 , L_12 ) ;
goto V_286;
}
