...
struct V_84 * V_85 , char * V_89 )
{
return snprintf ( V_89 , V_86 , L_19 , V_113 ) ;
}
...
for ( V_118 = V_116 -> V_119 ; V_118 -> V_120 . V_121 . V_85 . V_122 ; V_118 ++ )
F_73 ( & V_123 -> V_69 . V_124 ,
& V_118 -> V_120 . V_121 . V_85 ) ;
F_36 ( V_116 -> V_119 ) ;
V_116 -> V_119 = NULL ;
}
}
...
V_116 -> V_119 = F_32 ( V_125 + 1 , sizeof( * V_118 ) , V_50 ) ;
if ( ! V_116 -> V_119 ) {
V_17 = - V_51 ;
goto V_31;
}
...
V_118 -> V_120 . V_27 = ( V_116 -> V_128 << 16 ) | ( V_11 & 0xffff ) ;
V_118 -> V_120 . V_121 . V_129 = V_116 -> V_129 ;
V_118 -> V_120 . V_121 . V_130 = V_116 -> V_130 ;
V_85 = & V_118 -> V_120 . V_121 . V_85 ;
F_75 ( V_85 ) ;
V_85 -> V_122 = V_118 -> V_122 ;
V_85 -> V_131 = V_132 | ( V_116 -> V_130 ? V_133 : 0 ) ;
V_17 = F_76 ( & V_123 -> V_69 . V_124 , V_85 ) ;
if ( V_17 ) {
V_85 -> V_122 = NULL ;
goto V_31;
}
...
V_78 = V_135 -> V_79 ;
V_78 -> V_122 = L_22 ;
V_78 -> V_140 . V_141 = V_142 ;
V_78 -> V_69 . V_143 = & V_123 -> V_69 ;
V_78 -> V_144 [ 0 ] = F_79 ( V_145 ) ;
F_80 ( V_78 , V_82 ,
- 256 , 256 , V_146 , V_147 ) ;
F_80 ( V_78 , V_83 ,
- 256 , 256 , V_146 , V_147 ) ;
...
if ( V_17 )
goto V_160;
V_17 = F_74 ( V_161 , V_24 . V_61 ) ;
if ( V_17 )
goto V_162;
V_17 = F_74 ( V_163 , V_24 . V_55 ) ;
if ( V_17 )
goto V_164;
V_17 = F_77 () ;
if ( V_17 )
