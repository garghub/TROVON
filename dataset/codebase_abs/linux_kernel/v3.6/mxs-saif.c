...
static int T_3 F_32 ( struct V_86 * V_87 )
{
...
struct V_96 * V_96 ;
int V_14 = 0 ;
if ( ! V_89 && V_87 -> V_17 >= F_33 ( V_6 ) )
return - V_10 ;
V_7 = F_34 ( & V_87 -> V_16 , sizeof( * V_7 ) , V_97 ) ;
if ( ! V_7 )
return - V_98 ;
if ( V_89 ) {
struct V_88 * V_99 ;
V_7 -> V_17 = F_35 ( V_89 , L_14 ) ;
if ( V_7 -> V_17 < 0 )
return V_7 -> V_17 ;
V_99 = F_36 ( V_89 , L_15 , 0 ) ;
if ( ! V_99 ) {
V_7 -> V_11 = V_7 -> V_17 ;
} else {
V_7 -> V_11 = F_35 ( V_99 , L_14 ) ;
if ( V_7 -> V_11 < 0 )
return V_7 -> V_11 ;
}
} else {
V_7 -> V_17 = V_87 -> V_17 ;
V_95 = V_87 -> V_16 . V_100 ;
if ( V_95 && ! V_95 -> V_101 )
V_7 -> V_11 = V_95 -> V_11 ;
else
V_7 -> V_11 = V_7 -> V_17 ;
}
if ( V_7 -> V_11 < 0 || V_7 -> V_11 >= F_33 ( V_6 ) ) {
F_6 ( & V_87 -> V_16 , L_16 ) ;
return - V_10 ;
}
V_6 [ V_7 -> V_17 ] = V_7 ;
...
static int T_4 F_51 ( struct V_86 * V_87 )
{
struct V_6 * V_7 = F_52 ( V_87 ) ;
F_53 ( & V_87 -> V_16 ) ;
F_49 ( & V_87 -> V_16 ) ;
F_50 ( V_7 -> V_24 ) ;
return 0 ;
