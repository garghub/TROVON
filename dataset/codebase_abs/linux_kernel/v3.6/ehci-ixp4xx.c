...
V_2 -> V_27 = V_17 -> V_22 ;
V_2 -> V_28 = F_11 ( V_17 ) ;
if ( ! F_12 ( V_2 -> V_27 , V_2 -> V_28 ,
V_14 -> V_29 ) ) {
F_13 ( & V_12 -> V_21 , L_3 ) ;
V_5 = - V_30 ;
goto V_26;
}
V_2 -> V_9 = F_14 ( V_2 -> V_27 , V_2 -> V_28 ) ;
if ( V_2 -> V_9 == NULL ) {
F_13 ( & V_12 -> V_21 , L_4 ) ;
V_5 = - V_31 ;
goto V_32;
}
V_5 = F_15 ( V_2 , V_18 , V_33 ) ;
if ( V_5 )
goto V_34;
return V_5 ;
V_34:
F_16 ( V_2 -> V_9 ) ;
V_32:
F_17 ( V_2 -> V_27 , V_2 -> V_28 ) ;
V_26:
F_18 ( V_2 ) ;
V_24:
F_8 ( & V_12 -> V_21 , L_5 , F_9 ( & V_12 -> V_21 ) , V_5 ) ;
return V_5 ;
}
static int F_19 ( struct V_11 * V_12 )
{
struct V_1 * V_2 = F_20 ( V_12 ) ;
F_21 ( V_2 ) ;
F_16 ( V_2 -> V_9 ) ;
F_17 ( V_2 -> V_27 , V_2 -> V_28 ) ;
F_18 ( V_2 ) ;
