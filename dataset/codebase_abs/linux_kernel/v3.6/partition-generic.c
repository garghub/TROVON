...
F_77 ( V_38 , V_7 ) ;
V_7 -> V_90 = 0 ;
if ( ! F_78 ( V_38 ) || ! ( V_86 = F_79 ( V_38 , V_7 ) ) )
return 0 ;
if ( F_76 ( V_86 ) ) {
if ( F_80 ( V_86 ) == - V_91 ) {
F_69 ( V_92 L_16 ,
...
int F_83 ( struct V_1 * V_38 , struct V_6 * V_7 )
{
int V_82 ;
if ( ! V_7 -> V_90 )
return 0 ;
