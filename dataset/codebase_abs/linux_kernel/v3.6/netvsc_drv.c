...
V_27 -> V_48 ) ;
V_29 -> V_67 = F_39 ( V_29 , V_20 ) ;
V_29 -> V_68 = V_69 ;
V_29 -> V_46 = V_27 -> V_46 ;
V_20 -> V_43 . V_70 ++ ;
V_20 -> V_43 . V_71 += V_27 -> V_48 ;
F_40 ( V_29 ) ;
return 0 ;
}
...
static int F_42 ( struct V_19 * V_11 , int V_79 )
{
struct V_3 * V_4 = F_6 ( V_11 ) ;
struct V_22 * V_80 = V_4 -> V_10 ;
struct V_6 * V_7 = F_3 ( V_80 ) ;
struct V_81 V_82 ;
int V_83 = V_84 ;
if ( V_7 == NULL || V_7 -> V_85 )
return - V_86 ;
if ( V_7 -> V_87 == V_88 )
V_83 = V_89 ;
...
static int F_47 ( struct V_19 * V_11 , void * V_93 )
{
struct V_3 * V_4 = F_6 ( V_11 ) ;
struct V_22 * V_80 = V_4 -> V_10 ;
...
unsigned char V_97 ;
int V_98 ;
memcpy ( V_96 , V_11 -> V_99 , V_100 ) ;
V_97 = V_11 -> V_101 ;
V_98 = F_48 ( V_11 , V_93 ) ;
if ( V_98 != 0 )
return V_98 ;
V_98 = F_49 ( V_80 , V_95 -> V_102 ) ;
if ( V_98 != 0 ) {
memcpy ( V_11 -> V_99 , V_96 , V_100 ) ;
V_11 -> V_101 = V_97 ;
}
return V_98 ;
}
...
static int F_52 ( struct V_22 * V_103 ,
...
V_20 -> V_107 = & V_108 ;
V_20 -> V_109 = V_110 ;
V_20 -> V_111 = V_110 | V_112 ;
F_56 ( V_20 , & V_113 ) ;
F_57 ( V_20 , & V_103 -> V_114 ) ;
V_24 = F_58 ( V_20 ) ;
if ( V_24 != 0 ) {
F_59 ( L_9 ) ;
F_60 ( V_20 ) ;
...
memcpy ( V_20 -> V_99 , V_82 . V_116 , V_100 ) ;
F_30 ( V_20 ) ;
V_115:
return V_24 ;
}
static int F_62 ( struct V_22 * V_103 )
{
struct V_19 * V_20 ;
struct V_3 * V_64 ;
struct V_6 * V_19 ;
