...
V_64 = - V_186 ;
if ( F_85 ( V_2 , & V_14 -> V_15 , V_167 ) )
goto V_160;
V_64 = F_86 ( V_14 , V_163 , V_91 ) ;
if ( V_64 )
goto V_160;
V_169 = V_14 -> V_42 -> V_44 ;
F_87 ( & V_169 ) ;
V_14 -> V_16 ++ ;
V_93 = F_88 ( V_169 . V_45 -> V_46 ) ;
F_6 ( V_14 ) ;
V_64 = - V_100 ;
V_35 = F_89 ( sizeof( * V_35 ) , V_187 ) ;
if ( ! V_35 )
goto V_188;
V_32 = F_90 ( & V_169 , V_170 ,
F_28 ( V_14 -> V_42 ) ?
& V_88 :
& V_189 ) ;
if ( ! V_32 )
...
V_168 = F_94 ( V_32 , V_66 , V_93 , V_166 , V_86 , 0 ) ;
* V_164 = V_168 ;
V_64 = 0 ;
if ( F_95 ( V_168 ) )
V_64 = ( long ) V_168 ;
