...
static int F_77 ( struct V_190 * V_190 , int * V_266 )
{
struct V_1 * V_5 = F_73 ( V_190 ) ;
struct V_2 * V_115 = V_5 -> V_115 ;
* V_266 = F_2 ( V_5 ) ;
F_15 ( V_115 -> V_104 , L_58 , V_105 , * V_266 ) ;
return 0 ;
}
static int F_78 ( struct V_190 * V_190 ,
struct V_267 * V_268 )
{
struct V_253 * V_3 = V_268 -> V_189 -> V_269 ;
...
if ( V_5 -> V_273 == V_274 )
V_270 = V_275 ;
F_81 ( V_5 -> V_276 , & V_5 -> V_277 , V_270 ) ;
}
return V_70 ;
}
...
V_141 -> V_139 . V_149 , V_141 -> V_289 , F_9 ( V_141 -> V_148 ) ) ;
V_287 = F_9 ( V_141 -> V_148 ) ;
if ( V_287 < sizeof( struct V_278 ) +
sizeof( struct V_284 ) )
return NULL ;
V_285 = (struct V_284 * ) V_141 -> V_290 ;
V_288 = ( void * ) ( V_141 -> V_290 + sizeof( struct V_284 ) ) ;
V_286 = F_83 ( V_287 - ( int ) sizeof( * V_141 ) ,
( int ) F_9 ( V_141 -> V_291 ) ) ;
V_286 -= sizeof( struct V_284 ) ;
if ( V_286 < 0 )
return NULL ;
V_182 = F_50 ( V_5 -> V_189 . V_190 ,
...
if ( ! V_182 )
return NULL ;
signal = F_25 ( F_9 ( V_141 -> V_292 ) ) ;
V_281 = F_84 ( * ( V_293 * ) V_285 -> V_281 ) ;
V_282 = F_85 ( V_285 -> V_294 ) ;
V_283 = F_85 ( V_285 -> V_283 ) ;
V_280 = F_86 ( V_5 -> V_189 . V_190 , V_182 , V_141 -> V_289 ,
V_281 , V_282 , V_283 , V_288 , V_286 , signal ,
V_96 ) ;
F_87 ( V_280 ) ;
return ( V_280 != NULL ) ;
}
...
struct V_278 * V_141 ,
int * V_287 , void * V_82 , int V_81 )
{
void * V_295 , * V_296 ;
V_295 = ( char * ) V_82 + V_81 ;
V_296 = ( char * ) V_141 + * V_287 ;
if ( ( int ) ( V_295 - V_296 ) < sizeof( V_141 -> V_148 ) ) {
* V_287 = 0 ;
return NULL ;
} else {
V_141 = ( void * ) ( ( char * ) V_141 + * V_287 ) ;
* V_287 = F_9 ( V_141 -> V_148 ) ;
return V_141 ;
}
}
static bool F_89 ( struct V_278 * V_141 ,
int V_287 , void * V_82 , int V_81 )
{
void * V_295 , * V_296 ;
if ( ! V_141 || V_287 <= 0 || V_287 > V_81 )
return false ;
V_295 = ( char * ) V_82 + V_81 ;
V_296 = ( char * ) V_141 + V_287 ;
return ( int ) ( V_295 - V_296 ) >= 0 && ( int ) ( V_296 - V_82 ) >= 0 ;
}
static int F_80 ( struct V_2 * V_115 , T_2 * V_297 ,
bool * V_298 )
{
void * V_82 = NULL ;
struct V_299 * V_300 ;
struct V_278 * V_141 ;
int V_70 = - V_71 , V_81 , V_238 , V_287 , V_301 , V_302 ;
...
V_82 , & V_302 ) ;
if ( V_70 != 0 || V_302 < sizeof( struct V_299 ) )
goto V_304;
if ( V_302 > V_81 ) {
V_81 = V_302 ;
F_17 ( V_82 ) ;
...
V_81 = V_302 ;
V_300 = V_82 ;
V_238 = F_9 ( V_300 -> V_305 ) ;
V_301 = 0 ;
F_15 ( V_115 -> V_104 , L_62 , V_105 , V_81 ) ;
V_287 = 0 ;
V_141 = F_88 ( V_300 -> V_141 , & V_287 , V_82 , V_81 ) ;
while ( F_89 ( V_141 , V_287 , V_82 , V_81 ) ) {
if ( F_82 ( V_115 , V_141 ) && V_297 &&
V_298 ) {
if ( F_69 ( V_141 -> V_289 , V_297 ) )
* V_298 = true ;
}
V_301 ++ ;
V_141 = F_88 ( V_141 , & V_287 , V_82 , V_81 ) ;
}
F_15 ( V_115 -> V_104 , L_63
L_64 , V_105 , V_238 , V_301 ) ;
V_304:
F_17 ( V_82 ) ;
return V_70 ;
}
static void F_90 ( struct V_306 * V_307 )
{
struct V_1 * V_5 =
F_91 ( V_307 , struct V_1 , V_277 . V_307 ) ;
struct V_2 * V_115 = V_5 -> V_115 ;
int V_70 ;
...
struct V_1 * V_5 = F_73 ( V_190 ) ;
struct V_2 * V_115 = V_5 -> V_115 ;
struct V_187 * V_182 = V_309 -> V_182 ;
struct V_138 V_139 ;
int V_171 = V_16 ;
int V_172 = V_16 ;
int V_153 = V_23 ;
int V_148 , V_126 , V_70 , V_310 = - 1 ;
if ( V_182 )
V_310 = F_94 ( V_182 -> V_311 ) ;
V_172 = F_4 ( V_309 -> V_312 . V_313 ) ;
for ( V_126 = 0 ; V_126 < V_309 -> V_312 . V_314 ; V_126 ++ )
V_171 |=
F_4 ( V_309 -> V_312 . V_315 [ V_126 ] ) ;
if ( V_309 -> V_312 . V_314 > 0 &&
V_171 == V_16 ) {
F_95 ( V_115 -> V_104 , L_66 ) ;
return - V_168 ;
}
for ( V_126 = 0 ; V_126 < V_309 -> V_312 . V_316 ; V_126 ++ )
V_153 |=
F_5 ( V_309 -> V_312 . V_317 [ V_126 ] ) ;
if ( V_309 -> V_312 . V_316 > 0 &&
V_153 == V_23 ) {
F_95 ( V_115 -> V_104 , L_67 ) ;
return - V_168 ;
}
F_15 ( V_115 -> V_104 , L_68 ,
V_309 -> V_139 , V_309 -> V_141 , V_310 ,
V_309 -> V_318 , V_309 -> V_312 . V_319 , V_309 -> V_152 ,
V_172 , V_171 , V_153 ) ;
if ( F_33 ( V_115 ) )
F_35 ( V_115 , false ) ;
...
V_70 = F_39 ( V_115 , V_309 -> V_312 . V_319 , V_309 -> V_152 ,
V_153 ) ;
if ( V_70 < 0 ) {
...
if ( V_309 -> V_191 && ( ( V_172 | V_171 ) & V_19 ) ) {
V_5 -> V_199 = V_309 -> V_212 ;
V_70 = F_52 ( V_115 , V_309 -> V_191 , V_309 -> V_192 , V_309 -> V_212 ) ;
if ( V_70 < 0 ) {
F_15 ( V_115 -> V_104 , L_73 ,
V_70 , V_309 -> V_192 , V_309 -> V_212 ) ;
goto V_320;
}
}
if ( V_309 -> V_141 && ! F_34 ( V_309 -> V_141 ) &&
! F_54 ( V_309 -> V_141 ) ) {
V_70 = F_29 ( V_115 , V_309 -> V_141 ) ;
if ( V_70 < 0 ) {
...
memcpy ( V_139 . V_149 , V_309 -> V_139 , V_148 ) ;
F_96 ( V_115 ) ;
F_97 ( V_115 ) ;
V_70 = F_27 ( V_115 , & V_139 ) ;
if ( V_70 < 0 )
...
struct V_1 * V_5 = F_73 ( V_190 ) ;
struct V_2 * V_115 = V_5 -> V_115 ;
struct V_187 * V_182 = V_256 -> V_182 ;
struct V_138 V_139 ;
enum V_151 V_152 ;
int V_70 , V_326 , V_148 , V_310 = - 1 ;
if ( V_182 )
V_310 = F_94 ( V_182 -> V_311 ) ;
if ( V_256 -> V_318 ) {
V_152 = V_162 ;
...
V_256 -> V_139 , V_256 -> V_141 , V_310 , V_256 -> V_318 ) ;
if ( F_33 ( V_115 ) )
F_35 ( V_115 , false ) ;
...
static int F_102 ( struct V_190 * V_190 , struct V_253 * V_269 ,
T_2 V_327 , bool V_171 , const T_2 * V_328 ,
struct V_329 * V_256 )
{
struct V_1 * V_5 = F_73 ( V_190 ) ;
struct V_2 * V_115 = V_5 -> V_115 ;
...
case V_14 :
V_204 = 0 ;
if ( V_256 -> V_330 && V_256 -> V_203 > 0 )
V_204 |= V_207 ;
if ( V_328 )
V_204 |= V_209 |
V_210 ;
return F_53 ( V_115 , V_256 -> V_191 , V_256 -> V_192 ,
V_327 , V_328 , V_256 -> V_330 ,
...
static int F_103 ( struct V_190 * V_190 , struct V_253 * V_269 ,
T_2 V_327 , bool V_171 , const T_2 * V_328 )
{
struct V_1 * V_5 = F_73 ( V_190 ) ;
struct V_2 * V_115 = V_5 -> V_115 ;
F_15 ( V_115 -> V_104 , L_87 , V_105 , V_327 , V_328 ) ;
return F_57 ( V_115 , V_327 , V_328 ) ;
}
static int F_104 ( struct V_190 * V_190 , struct V_253 * V_269 ,
T_2 V_327 , bool V_331 , bool V_332 )
{
struct V_1 * V_5 = F_73 ( V_190 ) ;
struct V_2 * V_115 = V_5 -> V_115 ;
struct V_213 V_191 ;
F_15 ( V_115 -> V_104 , L_88 , V_105 , V_327 ) ;
if ( V_327 >= V_196 )
return - V_217 ;
V_5 -> V_199 = V_327 ;
if ( F_3 ( V_5 , V_327 ) )
return 0 ;
V_191 = V_5 -> V_13 [ V_327 ] ;
return F_52 ( V_115 , V_191 . V_198 , V_191 . V_81 , V_327 ) ;
}
...
V_81 = sizeof( V_335 ) ;
V_70 = F_10 ( V_115 , V_33 , & V_335 , & V_81 ) ;
if ( V_70 == 0 ) {
V_334 -> V_336 . V_337 = F_9 ( V_335 ) / 1000 ;
V_334 -> V_338 |= V_339 ;
}
V_81 = sizeof( V_292 ) ;
...
& V_292 , & V_81 ) ;
if ( V_70 == 0 ) {
V_334 -> signal = F_25 ( F_9 ( V_292 ) ) ;
V_334 -> V_338 |= V_340 ;
}
}
static int F_106 ( struct V_190 * V_190 , struct V_253 * V_3 ,
T_2 * V_289 , struct V_333 * V_334 )
{
struct V_1 * V_5 = F_73 ( V_190 ) ;
struct V_2 * V_115 = V_5 -> V_115 ;
if ( ! F_69 ( V_5 -> V_141 , V_289 ) )
return - V_217 ;
F_105 ( V_115 , V_334 ) ;
return 0 ;
}
static int F_107 ( struct V_190 * V_190 , struct V_253 * V_3 ,
int V_11 , T_2 * V_289 , struct V_333 * V_334 )
{
struct V_1 * V_5 = F_73 ( V_190 ) ;
struct V_2 * V_115 = V_5 -> V_115 ;
if ( V_11 != 0 )
return - V_217 ;
memcpy ( V_289 , V_5 -> V_141 , V_142 ) ;
F_105 ( V_115 , V_334 ) ;
return 0 ;
}
static int F_108 ( struct V_190 * V_190 , struct V_253 * V_269 ,
struct V_246 * V_247 )
{
struct V_1 * V_5 = F_73 ( V_190 ) ;
struct V_2 * V_115 = V_5 -> V_115 ;
...
static int F_111 ( struct V_190 * V_190 , struct V_253 * V_269 ,
struct V_246 * V_247 )
{
struct V_1 * V_5 = F_73 ( V_190 ) ;
struct V_2 * V_115 = V_5 -> V_115 ;
...
static int F_112 ( struct V_190 * V_190 , struct V_253 * V_269 )
{
struct V_1 * V_5 = F_73 ( V_190 ) ;
struct V_2 * V_115 = V_5 -> V_115 ;
struct V_235 V_244 ;
...
V_70 = F_10 ( V_115 , V_61 ,
& V_292 , & V_81 ) ;
signal = F_25 ( F_9 ( V_292 ) ) ;
F_15 ( V_115 -> V_104 , L_94
L_95 , V_105 , V_70 , F_9 ( V_292 ) ,
F_25 ( F_9 ( V_292 ) ) ) ;
if ( V_145 ) {
V_282 = F_85 ( V_145 -> V_353 . V_354 ) ;
} else {
V_282 = ( V_5 -> V_179 == V_147 ) ?
V_355 : V_356 ;
}
...
V_139 . V_148 = F_13 ( 32 ) ;
V_352 [ 0 ] = V_357 ;
V_352 [ 1 ] = F_9 ( V_139 . V_148 ) ;
memcpy ( & V_352 [ 2 ] , V_139 . V_149 , F_9 ( V_139 . V_148 ) ) ;
V_286 = F_9 ( V_139 . V_148 ) + 2 ;
V_281 = 0 ;
F_15 ( V_115 -> V_104 , L_99
L_100
L_101 , V_105 , ( V_182 ? V_182 -> V_311 : - 1 ) ,
V_141 , ( T_1 ) V_281 , V_282 , V_188 , V_286 ,
V_139 . V_149 , signal ) ;
V_280 = F_86 ( V_5 -> V_189 . V_190 , V_182 , V_141 ,
V_281 , V_282 , V_188 , V_352 , V_286 ,
signal , V_96 ) ;
F_87 ( V_280 ) ;
}
...
if ( ! V_145 ) {
F_117 ( V_363 , & V_5 -> V_364 ) ;
F_118 ( V_5 -> V_276 , & V_5 -> V_307 ) ;
return;
}
V_70 = F_32 ( V_115 , V_145 , V_94 ) ;
if ( ! V_70 ) {
V_359 = F_9 ( V_145 -> V_365 ) ;
if ( V_359 > V_94 )
V_359 = V_94 ;
if ( V_359 != 0 ) {
V_107 = F_9 ( V_145 -> V_366 ) ;
if ( V_107 > V_94 )
V_107 = V_94 ;
V_360 = ( T_2 * ) V_145 + V_107 ;
if ( V_107 + V_359 > V_94 )
V_359 =
V_94 - V_107 ;
}
V_358 = F_9 ( V_145 -> V_367 ) ;
if ( V_358 > V_94 )
V_358 = V_94 ;
if ( V_358 != 0 ) {
...
V_141 , V_361 ? L_103 : L_104 ) ;
V_362 = false ;
F_80 ( V_115 , V_141 , & V_362 ) ;
if ( ! F_34 ( V_141 ) && ! V_362 ) {
F_115 ( V_115 , V_141 , V_145 ) ;
}
if ( V_5 -> V_179 == V_147 ) {
if ( ! V_361 )
F_120 ( V_115 -> V_104 , V_141 , V_360 ,
V_359 , V_353 ,
V_358 , 0 , V_96 ) ;
else
F_121 ( V_115 -> V_104 ,
...
static void F_127 ( struct V_306 * V_307 )
{
struct V_1 * V_5 =
F_91 ( V_307 , struct V_1 , V_307 ) ;
struct V_2 * V_115 = V_5 -> V_115 ;
if ( F_128 ( V_363 , & V_5 -> V_364 ) )
F_116 ( V_115 ) ;
if ( F_128 ( V_369 , & V_5 -> V_364 ) )
F_124 ( V_115 ) ;
if ( F_128 ( V_370 , & V_5 -> V_364 ) )
F_58 ( V_115 ) ;
}
...
struct V_2 * V_115 = F_79 ( V_3 ) ;
struct V_1 * V_5 = F_1 ( V_115 ) ;
if ( F_130 ( V_370 , & V_5 -> V_364 ) )
return;
F_117 ( V_370 , & V_5 -> V_364 ) ;
F_118 ( V_5 -> V_276 , & V_5 -> V_307 ) ;
}
...
T_2 * V_82 ;
const char * type ;
int V_204 , V_90 , V_373 ;
bool V_374 , V_375 ;
struct V_376 * V_377 ;
enum V_378 V_379 ;
if ( V_81 < F_132 ( struct V_371 , V_89 ) +
sizeof( struct V_376 ) ) {
...
V_90 = V_81 - F_132 ( struct V_371 , V_89 ) ;
while ( V_90 >= sizeof( * V_377 ) ) {
V_377 = ( void * ) V_82 ;
type = L_106 ;
V_204 = F_9 ( V_377 -> V_204 ) ;
V_374 = false ;
V_375 = false ;
if ( V_204 & 0x1 )
type = L_107 ;
...
V_90 -= F_9 ( V_377 -> V_148 ) ;
V_82 += F_9 ( V_377 -> V_148 ) ;
}
}
...
V_385 = F_9 ( V_372 -> V_89 . V_384 . V_387 ) *
sizeof( struct V_388 ) ;
V_386 = sizeof( struct V_383 ) + V_385 +
F_132 ( struct V_371 , V_89 ) ;
if ( V_81 < V_386 ) {
...
F_9 ( V_384 -> V_389 ) ,
F_9 ( V_384 -> V_387 ) ) ;
if ( F_9 ( V_384 -> V_389 ) != 1 )
return;
for ( V_126 = 0 ; V_126 < F_9 ( V_384 -> V_387 ) ; V_126 ++ ) {
struct V_388 * V_390 =
& V_384 -> V_391 [ V_126 ] ;
bool V_392 = ! ! ( V_390 -> V_204 & V_393 ) ;
F_15 ( V_115 -> V_104 , L_115 ,
V_126 , F_9 ( V_390 -> V_204 ) , V_392 , V_390 -> V_141 ) ;
F_136 ( V_115 -> V_104 , V_126 , V_390 -> V_141 ,
V_392 , V_233 ) ;
}
}
static void F_137 ( struct V_2 * V_115 ,
struct V_394 * V_395 , int V_90 )
{
struct V_371 * V_372 ;
unsigned int V_81 , V_107 ;
V_107 = F_132 ( struct V_394 , V_106 ) +
F_9 ( V_395 -> V_107 ) ;
V_81 = F_9 ( V_395 -> V_148 ) ;
if ( V_81 < 8 ) {
...
V_372 = ( void * ) ( ( T_2 * ) V_395 + V_107 ) ;
switch ( F_9 ( V_372 -> V_396 ) ) {
case V_397 :
F_133 ( V_115 -> V_104 , L_118 ,
F_9 ( V_372 -> V_89 . V_398 ) ) ;
return;
case V_399 :
F_133 ( V_115 -> V_104 , L_119 ,
F_9 ( V_372 -> V_89 . V_400 ) ) ;
return;
case V_401 :
F_131 ( V_115 , V_372 , V_81 ) ;
return;
case V_402 :
F_135 ( V_115 , V_372 , V_81 ) ;
return;
default:
...
static void F_138 ( struct V_2 * V_115 , void * V_403 , int V_90 )
{
struct V_1 * V_5 = F_1 ( V_115 ) ;
struct V_394 * V_395 = V_403 ;
switch ( F_9 ( V_395 -> V_106 ) ) {
case V_404 :
if ( V_5 -> V_103 == V_53 ) {
...
F_117 ( V_369 , & V_5 -> V_364 ) ;
F_118 ( V_5 -> V_276 , & V_5 -> V_307 ) ;
break;
case V_406 :
F_137 ( V_115 , V_395 , V_90 ) ;
break;
default:
...
struct V_409 * V_410 ;
T_2 V_411 [ sizeof( * V_410 ) + sizeof( V_410 -> V_412 ) * 16 ] ;
int V_81 , V_413 , V_126 , V_414 ;
struct V_1 * V_5 = F_1 ( V_115 ) ;
V_81 = sizeof( V_408 ) ;
V_413 = F_10 ( V_115 ,
V_58 ,
& V_408 , & V_81 ) ;
if ( V_413 >= 0 ) {
V_414 = F_9 ( V_408 . V_305 ) ;
if ( V_414 > 8 )
V_414 = 8 ;
for ( V_126 = 0 ; V_126 < V_414 ; V_126 ++ ) {
switch ( F_9 ( V_408 . V_407 [ V_126 ] ) ) {
case V_415 :
case V_416 :
V_5 -> V_410 |= V_417 ;
break;
...
F_9 ( V_410 -> V_245 ) ,
F_9 ( V_410 -> V_422 ) ) ;
V_190 -> V_241 = F_9 ( V_410 -> V_245 ) ;
} else
V_190 -> V_241 = 0 ;
return V_413 ;
}
static void F_140 ( struct V_2 * V_115 , T_5 V_292 )
{
struct V_1 * V_5 = F_1 ( V_115 ) ;
enum V_423 V_424 ;
int V_425 , V_426 , V_427 ;
if ( V_5 -> V_349 >= 0 || V_292 >= 0 )
return;
if ( V_5 -> V_179 != V_147 )
return;
V_427 = V_5 -> V_351 ;
V_425 = V_5 -> V_349 ;
V_426 = V_5 -> V_350 ;
if ( V_292 < V_425 && ( V_427 == 0 || V_292 < V_427 - V_426 ) )
V_424 = V_428 ;
else if ( V_292 > V_425 && ( V_427 == 0 || V_292 > V_427 + V_426 ) )
V_424 = V_429 ;
else
return;
V_5 -> V_351 = V_292 ;
F_141 ( V_115 -> V_104 , V_424 , V_96 ) ;
}
static void F_142 ( struct V_306 * V_307 )
{
struct V_1 * V_5 =
F_91 ( V_307 , struct V_1 ,
V_430 . V_307 ) ;
struct V_2 * V_115 = V_5 -> V_115 ;
T_3 V_292 , V_133 ;
int V_81 , V_70 , V_431 ;
...
& V_292 , & V_81 ) ;
if ( V_70 == 0 ) {
V_5 -> V_435 = F_25 ( F_9 ( V_292 ) ) ;
F_140 ( V_115 , F_9 ( V_292 ) ) ;
}
F_15 ( V_115 -> V_104 , L_127 ,
V_70 , F_9 ( V_292 ) , F_25 ( F_9 ( V_292 ) ) ) ;
if ( V_5 -> V_436 > 0 && V_5 -> V_435 <= 25 ) {
V_431 = F_143 ( V_5 -> V_436 ) ;
if ( V_431 > V_433 )
V_431 = V_433 ;
else if ( V_431 <= 0 )
V_431 = 1 ;
...
V_431 = F_144 ( V_432 ) ;
if ( abs ( V_431 - V_432 ) <= 10 )
V_432 = V_431 ;
}
F_81 ( V_5 -> V_276 , & V_5 -> V_430 ,
V_432 ) ;
}
static void F_145 ( struct V_2 * V_115 , int V_273 )
{
struct V_1 * V_5 = F_1 ( V_115 ) ;
V_5 -> V_273 = V_273 ;
V_5 -> V_437 [ 0 ] = V_438 [ 0 ] ;
...
V_5 -> V_446 = V_447 ;
V_5 -> V_448 = V_449 ;
V_5 -> V_437 [ 0 ] = toupper ( V_5 -> V_437 [ 0 ] ) ;
V_5 -> V_437 [ 1 ] = toupper ( V_5 -> V_437 [ 1 ] ) ;
if ( ! strcmp ( V_5 -> V_437 , L_128 ) )
strcpy ( V_5 -> V_437 , L_129 ) ;
if ( V_5 -> V_443 < 0 )
V_5 -> V_443 = 0 ;
else if ( V_5 -> V_443 > 2 )
V_5 -> V_443 = 2 ;
...
char V_82 [ 8 ] ;
F_145 ( V_115 , V_344 ) ;
F_24 ( V_115 , L_130 , V_5 -> V_437 ) ;
F_24 ( V_115 , L_131 ,
V_5 -> V_439 ? L_132 : L_133 ) ;
F_24 ( V_115 , L_134 ,
V_5 -> V_441 ? L_132 : L_133 ) ;
sprintf ( V_82 , L_135 , V_5 -> V_443 ) ;
F_24 ( V_115 , L_136 , V_82 ) ;
sprintf ( V_82 , L_135 , V_5 -> V_6 ) ;
F_24 ( V_115 , L_137 , V_82 ) ;
sprintf ( V_82 , L_135 , V_5 -> V_446 ) ;
F_24 ( V_115 , L_138 , V_82 ) ;
sprintf ( V_82 , L_135 , V_5 -> V_448 ) ;
F_24 ( V_115 , L_139 , V_82 ) ;
return 0 ;
}
static int F_149 ( struct V_2 * V_115 , struct V_452 * V_453 )
{
struct V_190 * V_190 ;
struct V_1 * V_5 ;
int V_413 , V_81 ;
T_3 V_133 ;
V_190 = F_150 ( & V_454 , sizeof( struct V_1 ) ) ;
if ( ! V_190 )
return - V_97 ;
V_5 = F_73 ( V_190 ) ;
V_115 -> V_104 -> V_455 = & V_5 -> V_189 ;
V_5 -> V_189 . V_190 = V_190 ;
V_5 -> V_189 . V_259 = V_258 ;
V_115 -> V_4 = V_5 ;
V_5 -> V_115 = V_115 ;
F_151 ( & V_5 -> V_99 ) ;
V_5 -> V_276 = F_152 ( L_140 ) ;
F_153 ( & V_5 -> V_307 , F_127 ) ;
F_154 ( & V_5 -> V_430 , F_142 ) ;
F_154 ( & V_5 -> V_277 , F_90 ) ;
V_413 = F_155 ( V_115 , V_453 , V_456 ) ;
if ( V_413 < 0 )
goto V_457;
V_115 -> V_104 -> V_458 = & V_459 ;
...
& V_133 , & V_81 ) ;
V_5 -> V_232 = F_9 ( V_133 ) ;
if ( V_413 < 0 || V_5 -> V_232 < 0 )
V_5 -> V_232 = 0 ;
if ( V_5 -> V_232 > 0 )
V_115 -> V_104 -> V_204 |= V_460 ;
else
V_115 -> V_104 -> V_204 &= ~ V_460 ;
memcpy ( V_190 -> V_461 , V_115 -> V_104 -> V_462 , V_142 ) ;
V_190 -> V_463 = V_464 ;
V_190 -> V_465 = F_156 ( V_258 )
| F_156 ( V_257 ) ;
V_190 -> V_466 = 1 ;
F_139 ( V_115 , V_190 ) ;
memcpy ( V_5 -> V_467 , V_468 , sizeof( V_468 ) ) ;
memcpy ( V_5 -> V_469 , V_470 , sizeof( V_470 ) ) ;
V_5 -> V_471 . V_467 = V_5 -> V_467 ;
V_5 -> V_471 . V_472 = F_157 ( V_468 ) ;
V_5 -> V_471 . V_473 = V_5 -> V_469 ;
V_5 -> V_471 . V_474 = F_157 ( V_470 ) ;
V_190 -> V_475 [ V_476 ] = & V_5 -> V_471 ;
V_190 -> V_477 = V_478 ;
memcpy ( V_5 -> V_479 , V_480 ,
sizeof( V_480 ) ) ;
V_190 -> V_479 = V_5 -> V_479 ;
V_190 -> V_481 = F_157 ( V_480 ) ;
F_158 ( V_190 , & V_115 -> V_482 -> V_3 ) ;
if ( F_159 ( V_190 ) ) {
V_413 = - V_483 ;
goto V_457;
}
...
static void F_165 ( struct V_2 * V_115 , struct V_452 * V_453 )
{
struct V_1 * V_5 = F_1 ( V_115 ) ;
F_35 ( V_115 , false ) ;
F_160 ( & V_5 -> V_430 ) ;
