...
V_41 = F_26 ( V_47 , V_47 -> V_7 . V_14 , type ) ;
if ( F_27 ( V_41 ) ) {
V_42 = F_28 ( V_41 ) ;
F_15 ( V_40 , V_45 . V_21 ) ;
goto V_48;
...
F_32 ( & V_50 ) ;
while ( ! F_10 ( & V_45 ) ) {
V_41 = F_17 ( & V_45 , struct V_1 , V_49 ) ;
F_33 ( V_41 , 0 , & V_46 ) ;
}
F_34 ( & V_50 ) ;
F_35 ( & V_46 ) ;
...
static inline int F_36 ( struct V_1 * V_7 , int V_51 )
{
int V_52 = F_37 ( V_7 ) - V_7 -> V_53 ;
return ( V_52 > V_51 ) ;
}
int F_38 ( struct V_1 * V_7 , int V_54 )
{
struct V_1 * V_12 , * V_41 ;
struct V_1 * V_55 = V_7 -> V_56 ;
int V_42 = 0 ;
if ( V_7 == V_55 )
return F_36 ( V_7 , V_54 ) ;
if ( ! F_10 ( & V_7 -> V_57 ) || F_36 ( V_7 , V_54 ) )
return 1 ;
for ( V_12 = F_21 ( V_55 , V_55 ) ; V_12 ;
V_12 = F_21 ( V_12 , V_55 ) ) {
V_41 = F_39 ( & V_12 -> V_7 , V_7 -> V_58 , 0 ) ;
if ( V_41 && F_10 ( & V_41 -> V_57 ) &&
( V_42 = F_36 ( V_41 , 1 ) ) )
break;
}
return V_42 ;
...
for ( V_12 = F_21 ( V_55 , V_55 ) ; V_12 ;
V_12 = F_21 ( V_12 , V_55 ) ) {
struct V_1 * V_41 = F_39 ( & V_12 -> V_7 ,
V_7 -> V_58 , 0 ) ;
if ( V_41 && F_10 ( & V_41 -> V_57 ) )
F_42 ( & V_41 -> V_49 , & V_7 -> V_49 ) ;
}
}
int F_43 ( struct V_22 * V_59 )
{
struct V_1 * V_7 ;
