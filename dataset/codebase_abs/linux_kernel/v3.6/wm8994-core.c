...
static T_2 int F_23 ( struct V_1 * V_1 , int V_52 )
{
struct V_45 * V_46 = V_1 -> V_10 -> V_53 ;
struct V_54 * V_54 ;
...
switch ( V_1 -> type ) {
case V_28 :
for ( V_58 = 0 ; V_58 < F_26 ( V_63 ) ; V_58 ++ )
V_1 -> V_43 [ V_58 ] . V_70 = V_63 [ V_58 ] ;
break;
case V_64 :
for ( V_58 = 0 ; V_58 < F_26 ( V_65 ) ; V_58 ++ )
V_1 -> V_43 [ V_58 ] . V_70 = V_65 [ V_58 ] ;
break;
case V_27 :
for ( V_58 = 0 ; V_58 < F_26 ( V_66 ) ; V_58 ++ )
V_1 -> V_43 [ V_58 ] . V_70 = V_66 [ V_58 ] ;
break;
default:
F_27 () ;
goto V_62;
}
V_4 = F_29 ( V_1 -> V_10 , V_1 -> V_42 ,
V_1 -> V_43 ) ;
if ( V_4 != 0 ) {
...
V_1 -> V_85 = V_46 -> V_85 ;
V_1 -> V_86 = V_46 -> V_86 ;
for ( V_58 = 0 ; V_58 < F_26 ( V_46 -> V_87 ) ; V_58 ++ ) {
if ( V_46 -> V_87 [ V_58 ] ) {
F_9 ( V_1 , V_38 + V_58 ,
0xffff ,
V_46 -> V_87 [ V_58 ] ) ;
...
V_1 -> V_43 ) ;
V_71:
F_38 ( V_1 -> V_42 , V_1 -> V_43 ) ;
V_62:
F_39 ( V_1 -> V_10 ) ;
return V_4 ;
}
static T_3 void F_40 ( struct V_1 * V_1 )
{
F_41 ( V_1 -> V_10 ) ;
F_39 ( V_1 -> V_10 ) ;
F_37 ( V_1 ) ;
...
static T_2 int F_42 ( struct V_96 * V_97 ,
const struct V_98 * V_99 )
{
struct V_1 * V_1 ;
int V_4 ;
V_1 = F_28 ( & V_97 -> V_10 , sizeof( struct V_1 ) , V_68 ) ;
if ( V_1 == NULL )
return - V_69 ;
F_43 ( V_97 , V_1 ) ;
V_1 -> V_10 = & V_97 -> V_10 ;
...
return F_23 ( V_1 , V_97 -> V_52 ) ;
}
static T_3 int F_47 ( struct V_96 * V_97 )
{
struct V_1 * V_1 = F_48 ( V_97 ) ;
F_40 ( V_1 ) ;
return 0 ;
}
