...
static void F_115 ( struct V_263 * V_23 , struct V_266 * V_291 )
{
}
...
V_1 -> V_5 = V_5 ;
V_33 = F_126 ( V_294 -> V_299 , F_81 , V_311 ,
V_308 , V_1 ) ;
if ( V_33 < 0 ) {
F_16 ( L_27 , V_33 ) ;
goto V_297;
...
if ( V_1 -> V_205 == NULL )
goto V_317;
V_1 -> V_205 -> V_176 = F_115 ;
F_56 ( V_1 ) ;
V_33 = F_131 ( & V_289 -> V_281 , & V_1 -> V_18 ) ;
if ( V_33 )
goto V_318;
F_132 ( & V_289 -> V_281 , L_30 , V_319 ) ;
return 0 ;
V_318:
F_92 ( & V_1 -> V_23 [ 0 ] . V_23 , V_1 -> V_205 ) ;
V_317:
