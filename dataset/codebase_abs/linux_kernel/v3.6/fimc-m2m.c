...
static int F_94 ( struct V_66 * V_66 , void * V_67 , struct V_123 * V_116 )
{
struct V_5 * V_6 = F_57 ( V_67 ) ;
struct V_12 * V_15 = V_6 -> V_12 ;
struct V_30 * V_55 ;
...
static int F_96 ( void * V_28 , struct V_21 * V_131 ,
struct V_21 * V_132 )
{
struct V_5 * V_6 = V_28 ;
int V_16 ;
...
V_132 -> V_136 = & V_137 ;
V_132 -> V_138 = & V_139 ;
V_132 -> V_140 = sizeof( struct V_141 ) ;
return F_97 ( V_132 ) ;
}
...
int V_16 = - V_105 ;
F_50 ( L_10 ,
F_100 ( V_142 ) , V_15 -> V_36 , V_15 -> V_143 . V_144 ) ;
if ( F_101 ( & V_15 -> V_65 ) )
return - V_145 ;
if ( V_15 -> V_143 . V_144 > 0 )
goto V_146;
V_6 = F_102 ( sizeof *V_6 , V_147 ) ;
if ( ! V_6 ) {
V_16 = - V_148 ;
goto V_146;
}
...
if ( V_16 )
goto V_149;
V_6 -> V_67 . V_150 = & V_6 -> V_151 . V_152 ;
V_66 -> V_153 = & V_6 -> V_67 ;
F_106 ( & V_6 -> V_67 ) ;
V_6 -> V_36 = V_44 ;
V_6 -> V_33 = 0 ;
...
if ( V_15 -> V_13 . V_144 ++ == 0 )
F_19 ( V_158 , & V_15 -> V_36 ) ;
F_55 ( & V_15 -> V_65 ) ;
return 0 ;
V_157:
F_108 ( V_6 ) ;
...
struct V_12 * V_15 = V_6 -> V_12 ;
F_50 ( L_11 ,
F_100 ( V_142 ) , V_15 -> V_36 , V_15 -> V_13 . V_144 ) ;
if ( F_101 ( & V_15 -> V_65 ) )
return - V_145 ;
F_113 ( V_6 -> V_11 ) ;
F_108 ( V_6 ) ;
...
if ( F_101 ( & V_15 -> V_65 ) )
return - V_145 ;
V_16 = F_116 ( V_66 , V_6 -> V_11 , V_160 ) ;
F_55 ( & V_15 -> V_65 ) ;
return V_16 ;
}
static int F_117 ( struct V_66 * V_66 , struct V_161 * V_162 )
{
struct V_5 * V_6 = F_57 ( V_66 -> V_153 ) ;
struct V_12 * V_15 = V_6 -> V_12 ;
int V_16 ;
if ( F_101 ( & V_15 -> V_65 ) )
return - V_145 ;
V_16 = F_118 ( V_66 , V_6 -> V_11 , V_162 ) ;
F_55 ( & V_15 -> V_65 ) ;
return V_16 ;
}
...
snprintf ( V_104 -> V_71 , sizeof( V_104 -> V_71 ) , L_13 , V_15 -> V_175 ) ;
F_121 ( V_104 , V_15 ) ;
V_15 -> V_13 . V_104 = V_104 ;
V_15 -> V_13 . V_14 = F_122 ( & V_176 ) ;
if ( F_45 ( V_15 -> V_13 . V_14 ) ) {
F_73 ( V_164 , L_14 ) ;
V_16 = F_46 ( V_15 -> V_13 . V_14 ) ;
goto V_177;
}
V_16 = F_123 ( & V_104 -> V_178 , 0 , NULL , 0 ) ;
if ( V_16 )
goto V_179;
V_16 = F_124 ( V_104 , V_180 , - 1 ) ;
if ( V_16 )
goto V_181;
F_125 ( V_164 , L_15 ,
V_104 -> V_71 , F_126 ( V_104 ) ) ;
return 0 ;
V_181:
F_127 ( & V_104 -> V_178 ) ;
V_179:
F_128 ( V_15 -> V_13 . V_14 ) ;
V_177:
V_174 ( V_15 -> V_13 . V_104 ) ;
return V_16 ;
}
void F_129 ( struct V_12 * V_15 )
{
if ( ! V_15 )
return;
if ( V_15 -> V_13 . V_14 )
