...
switch ( V_17 ) {
case V_304 :
if ( F_42 ( V_22 ) || F_43 ( V_22 ) ) {
if ( ! V_41 )
V_103 -> V_161 = V_313 ;
else
V_103 -> V_161 = F_44 ( V_2 , V_41 ) ;
F_26 ( V_2 , V_314 , 0 ) ;
F_26 ( V_2 ,
V_173 ,
V_103 -> V_161 ) ;
if ( V_265 ) {
if ( F_42 ( V_22 ) || F_45 ( V_22 ) )
F_35 ( V_2 , V_265 ,
V_315 ) ;
}
F_30 ( V_2 , V_316 , 0 , 0 ) ;
...
F_30 ( V_2 , V_318 , 0 , 0 ) ;
F_30 ( V_2 , V_316 , 0 , 0 ) ;
if ( ( V_22 -> V_85 != V_319 ) || ( V_22 -> V_85 != V_320 ) )
F_30 ( V_2 , V_317 , 0 , 0 ) ;
}
...
if ( V_265 )
F_47 ( V_2 , V_265 , V_17 ) ;
F_50 ( V_2 , ( V_17 == V_304 ) ? true : false ) ;
}
static void
F_51 ( struct V_1 * V_2 )
{
...
case V_6 :
case V_7 :
args . V_111 . V_334 = V_96 ;
break;
case V_5 :
case V_8 :
if ( V_3 -> V_109 & V_335 )
args . V_111 . V_334 = V_336 ;
else
args . V_111 . V_334 = V_337 ;
break;
case V_9 :
case V_11 :
case V_10 :
args . V_111 . V_334 = V_338 ;
break;
case V_45 :
case V_46 :
if ( V_3 -> V_28 & ( V_30 ) )
args . V_111 . V_334 = V_339 ;
else if ( V_3 -> V_28 & ( V_56 ) )
args . V_111 . V_334 = V_340 ;
else
args . V_111 . V_334 = V_341 ;
break;
case V_49 :
case V_50 :
if ( V_3 -> V_28 & ( V_30 ) )
...
struct V_40 * V_41 = F_10 ( V_2 ) ;
if ( V_41 -> V_137 == V_147 )
args . V_117 . V_343 = V_148 ;
else if ( V_41 -> V_137 == V_156 )
args . V_117 . V_343 = V_144 ;
else
args . V_117 . V_343 = F_22 ( V_2 ) ;
} else
args . V_117 . V_343 = F_22 ( V_2 ) ;
switch ( V_3 -> V_4 ) {
case V_12 :
...
switch ( V_103 -> V_169 ) {
case 0 :
args . V_117 . V_344 = V_345 ;
break;
case 1 :
args . V_117 . V_344 = V_346 ;
break;
case 2 :
args . V_117 . V_344 = V_347 ;
break;
case 3 :
args . V_117 . V_344 = V_348 ;
break;
case 4 :
args . V_117 . V_344 = V_349 ;
break;
case 5 :
args . V_117 . V_344 = V_350 ;
break;
}
break;
case V_10 :
args . V_117 . V_344 = V_351 ;
break;
case V_46 :
if ( V_3 -> V_28 & ( V_30 ) )
args . V_117 . V_344 = V_352 ;
else if ( V_3 -> V_28 & ( V_56 ) )
args . V_117 . V_344 = V_352 ;
else
args . V_117 . V_344 = V_353 ;
break;
case V_50 :
if ( V_3 -> V_28 & ( V_30 ) )
args . V_117 . V_344 = V_352 ;
...
struct V_3 * V_3 = F_2 ( V_2 ) ;
struct V_210 * V_210 = F_31 ( V_2 -> V_209 ) ;
if ( ( V_20 -> V_355 -> V_356 == 0x71C5 ) &&
( V_20 -> V_355 -> V_357 == 0x106b ) &&
( V_20 -> V_355 -> V_358 == 0x0080 ) ) {
if ( V_3 -> V_109 & V_335 ) {
V_69 V_359 = F_37 ( V_360 ) ;
V_359 &= ~ V_361 ;
V_359 &= ~ V_362 ;
F_38 ( V_360 , V_359 ) ;
}
...
if ( F_28 ( V_22 ) ) {
if ( V_17 -> V_24 & V_25 )
F_38 ( V_363 + V_210 -> V_364 ,
V_365 ) ;
else
F_38 ( V_363 + V_210 -> V_364 , 0 ) ;
} else {
if ( V_17 -> V_24 & V_25 )
F_38 ( V_366 + V_210 -> V_364 ,
V_367 ) ;
else
F_38 ( V_366 + V_210 -> V_364 , 0 ) ;
}
}
}
...
F_58 (test_encoder, &dev->mode_config.encoder_list, head) {
struct V_3 * V_371 ;
if ( V_2 == V_368 )
continue;
if ( ! F_1 ( V_368 ) )
...
{
struct V_19 * V_20 = V_22 -> V_372 ;
struct V_1 * V_2 ;
F_58 (encoder, &dev->mode_config.encoder_list, head) {
struct V_3 * V_3 = F_2 ( V_2 ) ;
struct V_1 * V_265 = F_41 ( V_2 ) ;
switch ( V_3 -> V_4 ) {
case V_12 :
...
struct V_1 * V_404 ;
struct V_3 * V_405 ;
F_58 (other_encoder, &dev->mode_config.encoder_list, head) {
V_405 = F_2 ( V_404 ) ;
