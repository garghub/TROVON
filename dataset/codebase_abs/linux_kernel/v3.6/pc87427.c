...
struct V_4 * V_5 = F_24 ( V_49 ) ;
int V_11 = F_30 ( V_60 ) -> V_62 ;
return sprintf ( V_61 , L_8 , F_22 ( V_5 -> V_32 [ V_11 ] ) ) ;
}
...
struct V_4 * V_5 = F_24 ( V_49 ) ;
int V_11 = F_30 ( V_60 ) -> V_62 ;
return sprintf ( V_61 , L_8 , F_23 ( V_5 -> V_36 [ V_11 ] ) ) ;
}
...
struct V_4 * V_5 = F_24 ( V_49 ) ;
int V_11 = F_30 ( V_60 ) -> V_62 ;
return sprintf ( V_61 , L_8 , F_23 ( V_5 -> V_34 [ V_11 ] ) ) ;
}
...
struct V_4 * V_5 = F_24 ( V_49 ) ;
int V_11 = F_30 ( V_60 ) -> V_62 ;
return sprintf ( V_61 , L_8 , F_23 ( V_5 -> V_38 [ V_11 ] ) ) ;
}
...
struct V_4 * V_5 = F_24 ( V_49 ) ;
int V_11 = F_30 ( V_60 ) -> V_62 ;
return sprintf ( V_61 , L_9 , F_21 ( V_5 -> V_40 [ V_11 ] ) ) ;
}
...
{
struct V_4 * V_5 = F_25 ( V_49 ) ;
return sprintf ( V_61 , L_10 , V_5 -> V_75 ) ;
}
static int T_7 F_54 ( struct V_76 * V_77 ,
int V_65 )
{
struct V_78 * V_79 ;
int V_50 ;
...
static void T_7 F_59 ( struct V_48 * V_49 )
{
struct V_86 * V_87 = V_49 -> V_88 ;
struct V_4 * V_5 = F_25 ( V_49 ) ;
int V_50 ;
T_1 V_2 ;
...
if ( ! ( V_5 -> V_56 & ( 1 << V_50 ) ) )
continue;
F_63 ( & V_49 -> V_94 , & V_95 [ V_50 ] ) ;
}
for ( V_50 = 0 ; V_50 < 4 ; V_50 ++ ) {
if ( ! ( V_5 -> V_57 & ( 1 << V_50 ) ) )
continue;
F_63 ( & V_49 -> V_94 , & V_96 [ V_50 ] ) ;
}
for ( V_50 = 0 ; V_50 < 6 ; V_50 ++ ) {
if ( ! ( V_5 -> V_58 & ( 1 << V_50 ) ) )
continue;
F_63 ( & V_49 -> V_94 , & V_97 [ V_50 ] ) ;
}
}
static int T_7 F_64 ( struct V_76 * V_77 )
{
struct V_86 * V_87 = V_77 -> V_49 . V_88 ;
struct V_4 * V_5 ;
int V_50 , V_98 , V_99 ;
V_5 = F_65 ( & V_77 -> V_49 , sizeof( struct V_4 ) ,
V_100 ) ;
if ( ! V_5 ) {
F_66 ( L_18 ) ;
return - V_101 ;
...
F_68 ( V_77 , V_5 ) ;
F_59 ( & V_77 -> V_49 ) ;
V_98 = F_69 ( & V_77 -> V_49 , & V_93 ) ;
if ( V_98 )
return V_98 ;
for ( V_50 = 0 ; V_50 < 8 ; V_50 ++ ) {
if ( ! ( V_5 -> V_56 & ( 1 << V_50 ) ) )
continue;
V_98 = F_70 ( & V_77 -> V_49 . V_94 ,
& V_95 [ V_50 ] ) ;
if ( V_98 )
goto V_102;
}
...
V_5 -> V_103 = F_71 ( & V_77 -> V_49 ) ;
if ( F_72 ( V_5 -> V_103 ) ) {
V_98 = F_73 ( V_5 -> V_103 ) ;
F_56 ( & V_77 -> V_49 , L_20 , V_98 ) ;
goto V_102;
}
return 0 ;
V_102:
...
static int T_8 F_74 ( struct V_76 * V_77 )
{
struct V_4 * V_5 = F_75 ( V_77 ) ;
F_76 ( V_5 -> V_103 ) ;
F_61 ( & V_77 -> V_49 ) ;
return 0 ;
}
static int T_9 F_77 ( const struct V_86 * V_87 )
{
struct V_78 V_79 [ 2 ] = {
{ . V_104 = V_80 } ,
{ . V_104 = V_80 } ,
...
if ( ! V_87 -> V_7 [ V_50 ] )
continue;
V_79 [ V_99 ] . V_82 = V_87 -> V_7 [ V_50 ] ;
V_79 [ V_99 ] . V_84 = V_87 -> V_7 [ V_50 ] + V_105 - 1 ;
V_79 [ V_99 ] . V_75 = V_106 [ V_50 ] ;
V_98 = F_78 ( & V_79 [ V_99 ] ) ;
if ( V_98 )
goto exit;
V_99 ++ ;
}
V_77 = F_79 ( V_83 , V_79 [ 0 ] . V_82 ) ;
if ( ! V_77 ) {
V_98 = - V_101 ;
F_66 ( L_21 ) ;
goto exit;
}
V_98 = F_80 ( V_77 , V_79 , V_99 ) ;
if ( V_98 ) {
F_66 ( L_22 , V_98 ) ;
goto V_107;
}
...
static int T_9 F_84 ( int V_1 , struct V_86 * V_87 )
{
T_2 V_3 ;
T_1 V_108 , V_109 ;
int V_50 , V_98 = 0 ;
V_3 = V_110 ? V_110 : F_3 ( V_1 , V_111 ) ;
if ( V_3 != 0xf2 ) {
V_98 = - V_112 ;
goto exit;
}
...
V_87 -> V_89 |= ( 1 << 7 ) ;
V_109 = F_3 ( V_1 , V_121 ) ;
if ( ! ( V_108 & ( 1 << 1 ) ) && ( V_109 & ( 1 << 3 ) ) )
V_87 -> V_89 |= ( 1 << 5 ) ;
V_108 = F_3 ( V_1 , V_122 ) ;
if ( ( V_108 & ( 1 << 3 ) ) && ! ( V_109 & ( 1 << 5 ) ) )
V_87 -> V_89 |= ( 1 << 6 ) ;
V_87 -> V_90 = ( 1 << 0 ) ;
if ( V_109 & ( 1 << 0 ) )
V_87 -> V_90 |= ( 1 << 3 ) ;
