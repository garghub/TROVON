...
void F_188 ( struct V_44 * V_256 , int V_73 )
{
...
void F_196 ( struct V_1 * V_2 , T_6 V_80 )
{
if ( ! V_80 )
return;
F_146 ( L_29 ,
...
F_31 ( V_2 ) ;
V_4 = F_37 ( V_2 ) ;
V_12 = F_198 ( V_2 -> V_46 , V_4 ) ;
if ( V_12 && V_12 != - V_212 &&
V_12 != - V_232 ) {
V_12 = F_178 ( V_2 , V_12 ) ;
goto V_22;
}
memset ( V_2 -> V_46 -> V_266 . V_267 , 0 , V_268 ) ;
V_12 = F_35 ( V_2 , V_4 ) ;
if ( V_12 ) {
F_146 ( L_30 ,
...
F_31 ( V_2 ) ;
V_269 = & V_2 -> V_46 -> V_50 ;
V_71 = F_116 ( V_269 -> V_273 * sizeof( struct V_270 ) ,
V_96 ) ;
if ( ! V_71 )
return - V_156 ;
F_11 ( & V_269 -> V_53 ) ;
for ( V_272 = 0 ; V_272 < V_269 -> V_273 ; V_272 ++ )
V_71 [ V_272 ] . V_274 = V_269 -> V_275 [ V_272 ] . V_274 ;
V_271 = V_269 -> V_275 ;
V_269 -> V_275 = V_71 ;
V_269 -> V_49 = V_269 -> V_273 ;
V_269 -> V_273 = 0 ;
V_2 -> V_46 -> V_276 . V_277 = V_269 -> V_49 ;
F_12 ( & V_269 -> V_53 ) ;
F_65 ( V_271 ) ;
return 0 ;
}
...
static int F_197 ( struct V_1 * V_2 ) { return 0 ; }
static int F_25 ( struct V_1 * V_2 ) { return 0 ; }
static int F_199 ( struct V_1 * V_2 ) { return 0 ; }
static int F_200 ( struct V_1 * V_2 )
{
return 0 ;
}
...
{
int V_12 = 0 ;
const char * V_278 = L_33 , * V_279 = L_33 ;
do {
