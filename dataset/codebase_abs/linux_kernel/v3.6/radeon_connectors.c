...
struct V_22 * F_20 ( struct V_1 * V_2 , int V_64 )
{
struct V_55 * V_56 ;
struct V_22 * V_23 ;
int V_58 ;
...
struct V_22 * F_21 ( struct V_1 * V_2 )
{
int V_65 = V_2 -> V_60 [ 0 ] ;
struct V_55 * V_56 ;
struct V_22 * V_23 ;
...
int F_32 ( struct V_1 * V_2 , struct V_87 * V_88 ,
T_1 V_89 )
{
struct V_3 * V_4 = V_2 -> V_4 ;
struct V_5 * V_6 = V_4 -> V_7 ;
...
struct V_22 * F_61 ( struct V_1 * V_2 )
{
int V_65 = V_2 -> V_60 [ 0 ] ;
struct V_8 * V_8 = F_2 ( V_2 ) ;
struct V_55 * V_56 ;
...
if ( V_193 ) {
V_170 = F_78 ( sizeof( struct V_15 ) , V_203 ) ;
if ( ! V_170 )
goto V_206;
V_170 -> V_187 = V_187 ;
V_8 -> V_17 = V_170 ;
...
if ( V_13 == V_41 ) {
struct V_22 * V_22 ;
F_23 (drm_encoder, &dev->mode_config.encoder_list, head) {
struct V_46 * V_46 ;
V_46 = F_14 ( V_22 ) ;
if ( V_46 -> V_176 == V_227 )
F_88 ( V_46 , V_2 ) ;
