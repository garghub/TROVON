...
return F_54 ( V_22 , V_77 , V_49 ) ;
F_55 ( & V_14 . V_39 ) ;
F_56 ( & V_22 -> V_18 . V_99 , & V_22 -> V_18 . V_3 -> V_99 ) ;
F_57 ( & V_14 . V_39 ) ;
return - V_100 ;
V_48:
F_12 ( V_30 ) ;
...
static int F_54 ( struct V_19 * V_22 , struct V_29 * V_77 ,
struct V_78 * V_49 )
{
...
V_22 -> V_18 . V_76 = V_66 ;
V_77 -> V_73 = V_66 ;
F_59 ( V_46 , V_22 -> V_18 . V_45 ) ;
V_46 -> V_73 = V_22 -> V_18 . V_45 -> V_73 ;
F_60 ( V_22 -> V_18 . V_45 ) ;
V_22 -> V_18 . V_45 = V_46 ;
}
F_61 ( V_46 == NULL ) ;
F_61 ( F_52 ( V_46 ) -> V_80 != 0 ) ;
V_101 = F_49 ( V_46 ) ;
V_74 = V_101 + V_22 -> V_18 . V_74 ;
V_48 = - V_106 ;
if ( V_74 > 65535 )
goto V_107;
if ( F_62 ( V_46 ) && F_63 ( V_46 , 0 , 0 , V_105 ) )
goto V_59;
if ( F_64 ( V_46 ) ) {
struct V_29 * V_108 ;
int V_94 , V_109 = 0 ;
if ( ( V_108 = F_65 ( 0 , V_105 ) ) == NULL )
goto V_59;
V_108 -> V_73 = V_46 -> V_73 ;
V_46 -> V_73 = V_108 ;
F_66 ( V_108 ) -> V_110 = F_66 ( V_46 ) -> V_110 ;
F_67 ( V_46 ) ;
for ( V_94 = 0 ; V_94 < F_66 ( V_46 ) -> V_111 ; V_94 ++ )
V_109 += F_68 ( & F_66 ( V_46 ) -> V_5 [ V_94 ] ) ;
V_108 -> V_74 = V_108 -> V_112 = V_46 -> V_112 - V_109 ;
V_46 -> V_112 -= V_108 -> V_74 ;
V_46 -> V_74 -= V_108 -> V_74 ;
V_108 -> V_113 = 0 ;
V_108 -> V_89 = V_46 -> V_89 ;
F_53 ( V_108 -> V_31 , & V_22 -> V_18 . V_3 -> V_7 ) ;
}
F_69 ( V_46 , V_46 -> V_114 - F_70 ( V_46 ) ) ;
V_102 = V_46 -> V_31 ;
...
V_46 -> V_89 = V_91 ;
else if ( V_46 -> V_89 == V_117 )
V_46 -> V_113 = F_71 ( V_46 -> V_113 , V_66 -> V_113 ) ;
if ( F_72 ( V_46 , V_66 , & V_115 , & V_116 ) ) {
F_73 ( V_66 , V_115 ) ;
} else {
if ( ! F_66 ( V_46 ) -> V_110 )
F_66 ( V_46 ) -> V_110 = V_66 ;
V_46 -> V_112 += V_66 -> V_74 ;
V_46 -> V_74 += V_66 -> V_74 ;
V_46 -> V_31 += V_66 -> V_31 ;
}
V_66 = V_73 ;
}
F_11 ( V_102 , & V_22 -> V_18 . V_3 -> V_7 ) ;
V_46 -> V_73 = NULL ;
V_46 -> V_49 = V_49 ;
V_46 -> V_98 = V_22 -> V_18 . V_97 ;
V_25 = F_30 ( V_46 ) ;
V_25 -> V_84 = 0 ;
V_25 -> V_118 = F_74 ( V_74 ) ;
V_25 -> V_1 |= V_33 ;
F_26 ( V_3 , V_119 ) ;
V_22 -> V_18 . V_45 = NULL ;
V_22 -> V_18 . V_76 = NULL ;
...
F_26 ( V_3 , V_120 ) ;
if ( F_4 ( & V_3 -> V_4 . V_5 . V_7 ) > V_3 -> V_4 . V_5 . V_121 )
F_21 ( V_3 ) ;
if ( ( V_22 = F_36 ( V_3 , F_30 ( V_30 ) , V_26 ) ) != NULL ) {
int V_122 ;
F_25 ( & V_22 -> V_18 . V_39 ) ;
V_122 = F_45 ( V_22 , V_30 ) ;
F_35 ( & V_22 -> V_18 . V_39 ) ;
F_17 ( V_22 ) ;
return V_122 ;
}
...
const struct V_47 * V_25 ;
V_13 V_74 ;
if ( V_30 -> V_20 != F_74 ( V_123 ) )
return V_30 ;
if ( ! F_80 ( V_30 , sizeof( struct V_47 ) ) )
return V_30 ;
V_25 = F_30 ( V_30 ) ;
if ( V_25 -> V_81 < 5 || V_25 -> V_124 != 4 )
return V_30 ;
if ( ! F_80 ( V_30 , V_25 -> V_81 * 4 ) )
return V_30 ;
V_25 = F_30 ( V_30 ) ;
V_74 = F_48 ( V_25 -> V_118 ) ;
if ( V_30 -> V_74 < V_74 || V_74 < ( V_25 -> V_81 * 4 ) )
return V_30 ;
if ( F_81 ( F_30 ( V_30 ) ) ) {
V_30 = F_82 ( V_30 , V_105 ) ;
if ( V_30 ) {
if ( F_51 ( V_30 , V_74 ) )
return V_30 ;
memset ( F_46 ( V_30 ) , 0 , sizeof( struct V_125 ) ) ;
if ( F_76 ( V_30 , V_26 ) )
return NULL ;
V_30 -> V_126 = 0 ;
}
...
if ( V_128 == NULL )
goto V_134;
V_128 [ 0 ] . V_114 = & V_3 -> V_4 . V_5 . V_121 ;
V_128 [ 1 ] . V_114 = & V_3 -> V_4 . V_5 . V_135 ;
V_128 [ 2 ] . V_114 = & V_3 -> V_4 . V_5 . V_69 ;
}
V_130 = F_86 ( V_3 , L_4 , V_128 ) ;
if ( V_130 == NULL )
goto V_136;
V_3 -> V_4 . V_137 = V_130 ;
return 0 ;
...
{
struct V_127 * V_128 ;
V_128 = V_3 -> V_4 . V_137 -> V_138 ;
F_89 ( V_3 -> V_4 . V_137 ) ;
F_87 ( V_128 ) ;
}
static void F_90 ( void )
{
F_86 ( & V_132 , L_4 , V_139 ) ;
}
...
{
V_3 -> V_4 . V_5 . V_121 = 256 * 1024 ;
V_3 -> V_4 . V_5 . V_135 = 192 * 1024 ;
V_3 -> V_4 . V_5 . V_69 = V_140 ;
F_92 ( & V_3 -> V_4 . V_5 ) ;
return F_83 ( V_3 ) ;
}
...
V_14 . V_144 = F_15 ;
V_14 . V_145 = NULL ;
V_14 . V_146 = sizeof( struct V_19 ) ;
V_14 . V_147 = F_9 ;
V_14 . V_148 = F_24 ;
V_14 . V_149 = 10 * 60 * V_150 ;
F_97 ( & V_14 ) ;
}
