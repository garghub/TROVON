...
static int F_138 ( struct V_197 * V_2 )
{
struct V_5 * V_6 = F_139 ( V_2 ) ;
struct V_321 * V_183 = F_140 ( V_2 ) ;
struct V_13 * V_14 = V_183 -> V_47 ;
int V_9 ;
F_141 ( V_183 , V_322 ) ;
for ( V_9 = 0 ; V_9 < 2 ; V_9 ++ )
F_142 ( V_14 -> V_207 [ V_9 ] ) ;
for ( V_9 = 0 ; V_9 < V_14 -> V_76 ; V_9 ++ )
F_26 ( V_14 , & V_14 -> V_77 [ V_9 ] ) ;
F_143 ( V_14 -> V_68 ) ;
F_144 ( V_14 -> V_46 ) ;
if ( V_14 -> V_92 != V_93 ) {
F_91 ( V_14 -> V_6 , V_233 , & V_14 -> V_323 ) ;
V_14 -> V_324 [ 0 ] = F_29 ( V_14 -> V_199 + V_230 ) ;
V_14 -> V_324 [ 1 ] = F_29 ( V_14 -> V_199 + V_230 + 0x10 ) ;
}
F_145 ( V_6 ) ;
F_146 ( V_6 ) ;
F_147 ( V_6 , V_325 ) ;
...
static int F_148 ( struct V_197 * V_2 )
{
struct V_5 * V_6 = F_139 ( V_2 ) ;
struct V_321 * V_183 = F_140 ( V_2 ) ;
struct V_13 * V_14 = V_183 -> V_47 ;
...
F_93 ( V_14 -> V_6 , V_233 , V_14 -> V_323 ) ;
F_27 ( V_14 -> V_324 [ 0 ] , V_14 -> V_199 + V_230 ) ;
F_27 ( V_14 -> V_324 [ 1 ] , V_14 -> V_199 + V_230 + 0x10 ) ;
}
F_153 ( V_14 -> V_46 ) ;
for ( V_9 = 0 ; V_9 < V_14 -> V_76 ; V_9 ++ )
F_26 ( V_14 , & V_14 -> V_77 [ V_9 ] ) ;
...
static int T_3 F_158 ( struct V_321 * V_183 ,
struct V_5 * V_6 ,
int V_92 ,
int V_110 ,
unsigned int V_253 ,
...
static void T_5 F_174 ( struct V_5 * V_6 )
{
F_172 ( F_175 ( V_6 ) ) ;
F_173 ( V_6 , NULL ) ;
}
