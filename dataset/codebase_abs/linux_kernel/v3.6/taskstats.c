...
if ( ! F_66 ( & V_50 , V_9 ) )
return - V_10 ;
V_17 = F_47 ( V_2 -> V_76 [ V_82 ] , V_50 ) ;
if ( V_17 < 0 )
goto V_44;
V_17 = F_40 ( V_2 -> V_83 , V_50 , REGISTER ) ;
V_44:
F_67 ( V_50 ) ;
return V_17 ;
}
...
if ( ! F_66 ( & V_50 , V_9 ) )
return - V_10 ;
V_17 = F_47 ( V_2 -> V_76 [ V_84 ] , V_50 ) ;
if ( V_17 < 0 )
goto V_44;
V_17 = F_40 ( V_2 -> V_83 , V_50 , V_85 ) ;
V_44:
F_67 ( V_50 ) ;
return V_17 ;
}
...
int V_17 ;
V_6 = F_69 () ;
V_17 = F_1 ( V_2 , V_86 , & V_71 , V_6 ) ;
if ( V_17 < 0 )
return V_17 ;
V_17 = - V_14 ;
V_29 = F_60 ( V_2 -> V_76 [ V_87 ] ) ;
...
return V_17 ;
V_17 = - V_14 ;
V_41 = F_60 ( V_2 -> V_76 [ V_88 ] ) ;
V_35 = F_52 ( V_71 , V_89 , V_41 ) ;
if ( ! V_35 )
goto V_69;
V_17 = F_35 ( V_41 , V_35 ) ;
if ( V_17 < 0 )
...
if ( V_2 -> V_76 [ V_82 ] )
return F_65 ( V_2 ) ;
else if ( V_2 -> V_76 [ V_84 ] )
return F_68 ( V_2 ) ;
else if ( V_2 -> V_76 [ V_87 ] )
return F_70 ( V_2 ) ;
else if ( V_2 -> V_76 [ V_88 ] )
return F_71 ( V_2 ) ;
else
return - V_14 ;
}
...
{
struct V_90 * V_91 = V_33 -> signal ;
struct V_34 * V_35 ;
if ( V_91 -> V_35 || F_74 ( V_33 ) )
goto V_48;
V_35 = F_75 ( V_92 , V_9 ) ;
F_76 ( & V_33 -> V_46 -> V_47 ) ;
if ( ! V_91 -> V_35 ) {
...
void F_79 ( struct V_32 * V_33 , int V_93 )
{
int V_17 ;
struct V_18 * V_19 ;
struct V_34 * V_35 ;
...
V_92 = F_83 ( V_34 , V_98 ) ;
F_84 (i) {
F_85 ( & ( F_45 ( V_56 , V_97 ) . V_27 ) ) ;
F_86 ( & ( F_45 ( V_56 , V_97 ) . V_26 ) ) ;
}
}
