...
V_61 [ 0 ] = V_63 ;
V_61 [ 1 ] = V_63 ;
F_24 ( V_61 , V_62 , V_64 | V_65 ) ;
* V_60 = V_62 [ 0 ] ;
}
static void F_25 ( T_1 * V_1 , T_1 V_60 )
{
T_1 V_66 = * V_1 ;
T_1 V_67 = V_66 & ~ V_68 ;
T_1 V_69 = V_66 & V_68 ;
...
unsigned long V_138 )
{
unsigned long register T_2 V_139 ( L_5 ) ;
unsigned long register T_3 V_139 ( L_6 ) = V_61 [ 0 ] ;
unsigned long register T_4 V_139 ( L_7 ) = V_61 [ 1 ] ;
unsigned long register T_5 V_139 ( L_8 ) = V_61 [ 2 ] ;
unsigned long register T_6 V_139 ( L_9 ) = V_61 [ 3 ] ;
unsigned long register T_7 V_139 ( L_10 ) = V_61 [ 4 ] ;
unsigned long register T_8 V_139 ( L_11 ) = V_61 [ 5 ] ;
unsigned long register T_9 V_139 ( L_12 ) = V_61 [ 6 ] ;
unsigned long register T_10 V_139 ( L_13 ) = V_61 [ 7 ] ;
unsigned long register T_11 V_139 ( L_14 ) = V_138 ;
unsigned long register T_12 V_139 ( L_15 ) ;
...
static T_13 void F_36 ( void )
{
unsigned long V_130 , V_131 ;
V_130 = ( V_3 ) & V_19 [ V_18 + ( V_140 - 1 ) ] & V_141 ;
V_131 = ( V_3 ) & V_19 [ F_13 ( V_19 ) ] & V_141 ;
for (; V_130 < V_131 ; V_130 += V_140 ) {
F_37 ( F_38 ( V_130 ) ) ;
F_39 ( F_38 ( V_130 ) ) ;
F_40 ( V_130 ) ;
V_142 ++ ;
