...
F_182 ( 0 , V_90 -> V_457 , V_448 , 0x10 , V_447 ) ;
V_90 -> V_348 = V_458 << 24 | ( V_449 << 16 ) |
V_459 ;
}
static inline T_6
F_183 ( struct V_5 * V_6 , T_4 V_88 )
{
return V_6 -> V_89 [ V_88 - 1 ] . V_460 ;
}
static inline void
F_184 ( struct V_5 * V_6 , T_4 V_88 , T_6 V_460 )
{
V_6 -> V_89 [ V_88 - 1 ] . V_460 = V_460 ;
}
static void
...
T_4 V_88 )
{
T_10 V_461 , V_462 , V_463 , V_464 , V_465 , V_466 ;
T_10 V_239 , V_241 ;
T_6 V_227 , * V_467 , V_92 ;
T_6 V_468 = V_90 -> V_469 [ 0 ] ;
T_1 V_470 ;
if ( V_468 == V_471 || V_468 == V_472 ||
V_468 == V_473 || V_468 == V_474 ) {
V_467 = V_103 -> V_440 . V_475 ;
if ( ( V_468 < V_471 ) || ! ( V_467 [ 2 ] | V_467 [ 3 ] | V_467 [ 4 ]
| V_467 [ 5 ] ) ) {
V_466 = F_52 ( V_90 ) >>
V_48 -> V_253 ;
V_92 = ( V_468 < V_471 ) ? 2 : 6 ;
V_461 = F_186 ( * ( V_476 * ) ( & V_467 [ V_92 ] ) ) ;
if ( ( ( T_1 ) V_461 + ( T_1 ) V_466 - 1 ) <=
( T_10 ) V_48 -> V_254 ) {
V_239 = V_48 -> V_239 ;
V_241 = V_48 -> V_252 ;
V_463 = V_461 & ( V_239 - 1 ) ;
if ( ( V_463 + V_466 ) <= V_239 ) {
V_227 = V_48 -> V_227 ;
V_462 = V_461 >> V_241 ;
V_464 = V_462 / V_227 ;
V_465 = V_462 % V_227 ;
...
V_466 = F_52 ( V_90 ) >>
V_48 -> V_253 ;
V_470 = F_187 ( * ( V_477 * ) ( & V_467 [ 2 ] ) ) ;
if ( ( V_470 + ( T_1 ) V_466 - 1 ) <=
V_48 -> V_254 ) {
V_239 = V_48 -> V_239 ;
V_241 = V_48 -> V_252 ;
V_463 = ( T_10 ) ( V_470 & ( V_239 - 1 ) ) ;
if ( ( V_463 + V_466 ) <= V_239 ) {
V_227 = V_48 -> V_227 ;
V_462 = ( T_10 ) ( V_470 >> V_241 ) ;
V_464 = V_462 / V_227 ;
V_465 = V_462 % V_227 ;
V_462 = ( V_464 << V_241 ) +
V_463 ;
...
F_96 ( V_90 -> V_43 ) && V_90 -> V_488 != 32 )
V_478 |= V_489 ;
V_88 = F_190 ( V_6 , V_6 -> V_490 , V_90 ) ;
if ( ! V_88 ) {
F_3 ( V_34 L_69 ,
V_6 -> V_35 , V_36 ) ;
goto V_75;
...
V_103 -> V_494 = F_180 ( F_52 ( V_90 ) ) ;
V_103 -> V_495 = F_180 ( V_478 ) ;
V_103 -> V_496 = F_119 ( V_90 -> V_488 ) ;
V_103 -> V_497 = V_498 ;
V_103 -> V_499 = V_500 ;
V_103 -> V_501 =
F_191 ( V_6 , V_88 ) ;
V_103 -> V_502 = F_53 ( T_11 , V_127 ) / 4 ;
V_103 -> V_503 = F_119 ( V_504 +
V_505 ) ;
V_103 -> V_506 = 0 ;
V_103 -> V_507 = 0 ;
F_120 ( V_146 -> V_95 , (struct V_333 * )
V_103 -> V_334 ) ;
memcpy ( V_103 -> V_440 . V_475 , V_90 -> V_469 , V_90 -> V_488 ) ;
if ( ! V_103 -> V_494 ) {
...
T_6 V_512 = V_29 -> V_513 ;
char * V_514 = NULL ;
char * V_515 = NULL ;
char * V_516 = V_6 -> V_517 ;
T_10 V_518 = F_76 ( V_29 -> V_337 ) ;
struct V_45 * V_46 = NULL ;
unsigned long V_65 ;
struct V_168 * V_70 = V_90 -> V_43 -> V_345 ;
struct V_147 * V_346 = V_70 -> V_150 ;
...
V_514 , V_30 , V_88 ) ;
F_3 ( V_99 L_169
L_170 , V_6 -> V_35 , F_52 ( V_90 ) , V_90 -> V_548 ,
F_195 ( V_90 ) ) ;
F_3 ( V_99 L_171
L_172 , V_6 -> V_35 , F_9 ( V_29 -> V_549 ) ,
F_76 ( V_29 -> V_550 ) , V_90 -> V_348 ) ;
F_3 ( V_99 L_173
L_174 , V_6 -> V_35 , V_515 ,
V_512 , V_516 , V_510 ) ;
if ( V_510 & V_547 ) {
struct V_551 V_552 ;
F_196 ( V_90 -> V_457 , & V_552 ) ;
F_3 ( V_99 L_175
L_176 , V_6 -> V_35 , V_552 . V_553 ,
V_552 . V_554 , V_552 . V_447 , F_76 ( V_29 -> V_555 ) ) ;
}
if ( V_510 & V_543 ) {
V_508 = F_76 ( V_29 -> V_556 ) ;
V_509 = ( T_6 * ) & V_508 ;
F_103 ( V_6 , V_509 [ 0 ] ) ;
}
}
...
F_128 ( V_566 , V_70 , L_179 ) ;
F_21 ( & V_6 -> V_66 , V_65 ) ;
if ( V_6 -> V_567 -> V_568 == V_569 )
F_199 ( V_6 , V_27 ) ;
V_226 = F_53 ( T_31 , V_570 ) +
sizeof( T_32 ) ;
V_565 = F_69 ( V_226 , V_361 ) ;
if ( ! V_565 ) {
F_3 ( V_34 L_2 ,
V_6 -> V_35 , __FILE__ , __LINE__ , V_36 ) ;
return;
...
V_577 = F_76 ( V_29 -> V_550 ) ;
F_205 ( V_90 , F_52 ( V_90 ) - V_577 ) ;
if ( V_30 & V_579 )
V_518 = F_76 ( V_29 -> V_337 ) ;
else
V_518 = 0 ;
V_30 &= V_39 ;
V_512 = V_29 -> V_513 ;
if ( V_30 == V_524 && V_577 == 0 &&
( V_512 == V_535 ||
V_512 == V_538 ||
V_512 == V_540 ) ) {
V_30 = V_40 ;
...
if ( V_510 & V_547 ) {
struct V_551 V_552 ;
const void * V_580 = F_206 ( V_6 ,
V_88 ) ;
T_10 V_226 = F_207 ( T_10 , V_500 ,
F_76 ( V_29 -> V_555 ) ) ;
memcpy ( V_90 -> V_457 , V_580 , V_226 ) ;
F_196 ( V_90 -> V_457 , & V_552 ) ;
if ( V_552 . V_554 == 0x5D )
F_200 ( V_6 ,
F_9 ( V_29 -> V_233 ) ) ;
...
break;
case V_528 :
if ( ( V_577 == 0 ) || ( V_90 -> V_548 > V_577 ) )
V_90 -> V_348 = V_585 << 16 ;
else
V_90 -> V_348 = ( V_456 << 16 ) | V_512 ;
break;
case V_524 :
V_90 -> V_348 = ( V_456 << 16 ) | V_512 ;
if ( ( V_510 & V_547 ) )
...
V_90 -> V_348 = V_351 << 16 ;
else if ( ! V_577 && V_90 -> V_469 [ 0 ] == V_586 ) {
V_29 -> V_511 = V_547 ;
V_29 -> V_513 = V_459 ;
V_90 -> V_348 = ( V_458 << 24 ) |
V_459 ;
...
V_226 = F_53 ( T_34 , V_595 ) + ( V_6 -> V_31 . V_32
* sizeof( V_596 ) ) ;
V_592 = F_69 ( V_226 , V_172 ) ;
if ( ! V_592 ) {
F_3 ( V_34 L_2 ,
V_6 -> V_35 , __FILE__ , __LINE__ , V_36 ) ;
return;
...
V_594 = V_592 -> V_595 [ V_92 ] . V_597 >> 4 ;
if ( V_92 == 0 )
V_6 -> V_31 . V_27 = F_9 ( V_592 ->
V_595 [ 0 ] . V_598 ) ;
V_6 -> V_31 . V_274 [ V_92 ] . V_27 = V_6 -> V_31 . V_27 ;
V_593 = F_9 ( V_592 -> V_595 [ V_92 ] .
V_381 ) ;
if ( V_593 && V_594 < V_599 )
V_594 = V_599 ;
...
V_226 = F_53 ( T_35 , V_595 ) + ( V_6 -> V_31 . V_32 *
sizeof( V_604 ) ) ;
V_600 = F_69 ( V_226 , V_172 ) ;
if ( ! V_600 ) {
F_3 ( V_34 L_2 ,
V_6 -> V_35 , __FILE__ , __LINE__ , V_36 ) ;
goto V_75;
...
V_6 -> V_603 = V_603 &
V_609 ;
V_6 -> V_31 . V_610 = & V_6 -> V_142 -> V_611 ;
V_6 -> V_31 . V_274 = F_215 ( V_6 -> V_31 . V_32 ,
sizeof( struct V_612 ) , V_172 ) ;
if ( ! V_6 -> V_31 . V_274 ) {
F_3 ( V_34 L_2 ,
V_6 -> V_35 , __FILE__ , __LINE__ , V_36 ) ;
goto V_75;
...
V_595 [ 0 ] . V_598 ) ;
V_6 -> V_31 . V_274 [ V_92 ] . V_27 = V_6 -> V_31 . V_27 ;
V_6 -> V_31 . V_274 [ V_92 ] . V_613 = V_92 ;
F_217 ( V_6 , & V_6 -> V_31 . V_274 [ V_92 ] ,
V_601 , V_6 -> V_31 . V_610 ) ;
}
if ( ( F_12 ( V_6 , & V_29 , & V_28 ,
V_33 , V_6 -> V_31 . V_27 ) ) ) {
F_3 ( V_34 L_2 ,
...
V_619 = F_9 ( V_617 . V_621 ) ;
if ( F_11 ( V_6 , V_619 , & V_69 )
!= 0 ) {
F_3 ( V_34 L_2 ,
V_6 -> V_35 , __FILE__ , __LINE__ , V_36 ) ;
return - 1 ;
...
V_79 -> V_27 = V_27 ;
V_79 -> V_32 = V_617 . V_622 ;
V_79 -> V_69 = V_69 ;
V_79 -> V_9 = V_9 ;
F_3 ( V_58 L_184
L_185 , V_6 -> V_35 ,
V_27 , V_619 , ( unsigned long long )
V_79 -> V_9 , V_79 -> V_32 ) ;
if ( ! V_79 -> V_32 )
goto V_623;
...
V_79 -> V_274 [ V_92 ] . V_613 = V_92 ;
if ( ( F_222 ( V_6 ,
& V_79 -> V_274 [ V_92 ] , V_618 ,
V_79 -> V_610 ) ) ) {
F_3 ( V_34 L_2 ,
V_6 -> V_35 , __FILE__ , __LINE__ , V_36 ) ;
V_20 = - 1 ;
...
T_18 * V_29 ;
V_29 = F_106 ( V_6 , V_293 ) ;
if ( V_6 -> V_625 . V_295 == V_296 )
return 1 ;
if ( V_6 -> V_625 . V_88 != V_88 )
return 1 ;
V_6 -> V_625 . V_295 |= V_297 ;
if ( V_29 ) {
memcpy ( V_6 -> V_625 . V_293 , V_29 ,
V_29 -> V_298 * 4 ) ;
V_6 -> V_625 . V_295 |= V_299 ;
}
V_6 -> V_625 . V_295 &= ~ V_300 ;
F_107 ( & V_6 -> V_625 . V_301 ) ;
return 1 ;
}
void
...
static int
F_228 ( struct V_5 * V_6 , T_4 V_27 , T_6 V_648 , T_6 V_649 )
{
T_9 V_29 ;
T_8 V_28 ;
T_37 V_602 ;
...
V_46 -> V_82 = V_82 ;
V_46 -> V_9 = V_9 ;
V_46 -> V_274 = V_28 . V_651 ;
if ( V_46 -> V_614 && ! ( F_218 (
V_6 , & V_29 , & V_602 , V_616 ,
V_46 -> V_614 ) ) )
V_46 -> V_14 =
F_6 ( V_602 . V_16 ) ;
...
V_594 = V_360 -> V_380 [ V_92 ] . V_659 >> 4 ;
V_655 = V_360 -> V_380 [ V_92 ] . V_659 & 0xF ;
F_3 ( V_7 L_216
L_217 , V_378 ,
V_27 , V_654 , V_594 , V_655 ) ;
}
}
static void
...
V_619 = F_9 ( V_360 -> V_403 ) ;
if ( V_360 -> V_404 == V_411 )
if ( F_219 ( V_6 , V_619 ) != 0 )
return;
F_18 ( & V_6 -> V_80 , V_65 ) ;
V_79 = F_33 ( V_6 ,
V_619 ) ;
...
F_3 ( V_58 L_236
L_237 ,
V_6 -> V_35 , V_663 , F_9 ( V_360 -> V_233 ) ,
( unsigned long long ) F_6 ( V_360 -> V_11 ) ,
F_9 ( V_360 -> V_549 ) ) ;
if ( V_360 -> V_417 == V_575 )
F_3 ( V_58 L_238 , V_6 -> V_35 ,
V_360 -> V_576 , V_360 -> V_676 ) ;
F_3 ( V_7 L_239 ) ;
}
static void
...
L_246 , V_6 -> V_35 , V_36 , V_360 -> V_651 ,
V_360 -> V_686 ) ) ;
F_147 ( V_6 ) ;
F_18 ( & V_6 -> V_91 , V_65 ) ;
V_29 = V_6 -> V_294 . V_293 ;
...
V_619 = F_9 ( V_28 . V_621 ) ;
if ( ! F_11 ( V_6 , V_619 , & V_9 ) )
F_211 ( V_6 , V_9 , V_27 ,
V_28 . V_651 , V_599 ) ;
F_228 ( V_6 , V_27 , 0 , 1 ) ;
}
...
if ( V_30 == V_41 )
break;
V_27 = F_9 ( V_730 . V_233 ) ;
if ( F_80 ( V_6 , & V_29 ,
& V_731 , V_194 , V_27 ,
sizeof( T_13 ) ) )
continue;
if ( V_731 . V_203 == V_204 ||
V_731 . V_203 == V_205 ||
V_731 . V_203 == V_207 )
F_260 ( V_6 ,
F_6 ( V_730 . V_734 ) , V_27 ) ;
}
if ( ! V_6 -> V_175 ) {
V_732 = 0xFF ;
memset ( V_6 -> V_178 , 0 , V_6 -> V_735 ) ;
while ( ! ( F_88 ( V_6 , & V_29 ,
& V_225 , V_736 ,
V_732 ) ) ) {
V_30 = F_9 ( V_29 . V_38 ) &
...
goto V_75;
V_27 = 0xFFFF ;
while ( ! ( F_220 ( V_6 , & V_29 , & V_617 ,
V_737 , V_27 ) ) ) {
V_30 = F_9 ( V_29 . V_38 ) &
V_39 ;
if ( V_30 == V_41 )
break;
V_27 = F_9 ( V_617 . V_233 ) ;
V_9 = F_6 ( V_617 . V_11 ) ;
F_3 ( V_7 L_304
L_305 , V_27 ,
( unsigned long long ) V_9 ) ;
...
{
struct V_45 * V_46 , * V_738 ;
struct V_78 * V_79 , * V_739 ;
struct V_47 * V_48 , * V_740 ;
struct V_741 V_742 ;
unsigned long V_65 ;
F_3 ( V_58 L_307 ,
V_6 -> V_35 ) ;
...
void
F_268 ( struct V_5 * V_6 , int V_745 )
{
switch ( V_745 ) {
case V_746 :
...
F_118 ( V_6 , F_3 ( V_58 L_53
L_316 , V_6 -> V_35 , V_36 ) ) ;
if ( V_6 -> V_625 . V_295 & V_300 ) {
V_6 -> V_625 . V_295 |= V_336 ;
F_164 ( V_6 , V_6 -> V_625 . V_88 ) ;
F_107 ( & V_6 -> V_625 . V_301 ) ;
}
...
{
struct V_353 * V_354 = F_269 ( V_750 ,
...
memcpy ( V_354 -> V_360 , V_29 -> V_570 ,
V_226 ) ;
V_354 -> V_6 = V_6 ;
V_354 -> V_506 = V_29 -> V_506 ;
V_354 -> V_507 = V_29 -> V_507 ;
V_354 -> V_362 = V_362 ;
F_134 ( V_6 , V_354 ) ;
return 1 ;
}
...
F_121 ( & V_6 -> V_625 . V_301 ) ;
F_163 ( V_6 , V_88 ) ;
F_123 ( & V_6 -> V_625 . V_301 , 10 * V_335 ) ;
if ( ! ( V_6 -> V_625 . V_295 & V_297 ) ) {
F_3 ( V_34 L_72 ,
V_6 -> V_35 , V_36 ) ;
goto V_75;
}
if ( V_6 -> V_625 . V_295 & V_299 ) {
V_29 = V_6 -> V_625 . V_293 ;
if ( ! V_6 -> V_273 )
F_3 ( V_58 L_337
L_338 ,
V_6 -> V_35 , F_9 ( V_29 -> V_38 ) ,
...
V_75:
V_6 -> V_625 . V_295 = V_296 ;
F_125 ( & V_6 -> V_625 . V_314 ) ;
}
static void
F_274 ( struct V_775 * V_567 )
{
struct V_141 * V_142 = F_275 ( V_567 ) ;
struct V_5 * V_6 = F_58 ( V_142 ) ;
struct V_776 * V_777 ;
unsigned long V_65 ;
V_6 -> V_318 = 1 ;
...
static void T_50
F_278 ( struct V_775 * V_567 )
{
struct V_141 * V_142 = F_275 ( V_567 ) ;
struct V_5 * V_6 = F_58 ( V_142 ) ;
struct V_368 * V_369 , * V_778 ;
...
static int
F_291 ( struct V_775 * V_567 , const struct V_790 * V_72 )
{
struct V_5 * V_6 ;
struct V_141 * V_142 ;
V_142 = F_292 ( & V_791 ,
...
V_6 -> V_142 = V_142 ;
V_6 -> V_72 = V_794 ++ ;
sprintf ( V_6 -> V_35 , L_345 , V_795 , V_6 -> V_72 ) ;
V_6 -> V_567 = V_567 ;
if ( V_72 -> V_43 == V_796 ) {
V_6 -> V_175 = 1 ;
V_6 -> V_273 = 1 ;
...
F_3 ( V_58 L_350
L_351 , V_6 -> V_35 , V_142 -> V_810 ) ;
}
}
if ( ( F_295 ( V_142 , & V_567 -> V_169 ) ) ) {
F_3 ( V_34 L_2 ,
V_6 -> V_35 , __FILE__ , __LINE__ , V_36 ) ;
F_19 ( & V_6 -> V_67 ) ;
goto V_811;
...
static int
F_301 ( struct V_775 * V_567 , T_51 V_200 )
{
struct V_141 * V_142 = F_275 ( V_567 ) ;
struct V_5 * V_6 = F_58 ( V_142 ) ;
T_52 V_820 ;
F_302 ( V_6 ) ;
F_303 ( V_142 ) ;
V_820 = F_304 ( V_567 , V_200 ) ;
F_3 ( V_58 L_353
L_354 , V_6 -> V_35 , V_567 ,
F_305 ( V_567 ) , V_820 ) ;
F_306 ( V_6 ) ;
F_307 ( V_567 ) ;
F_308 ( V_567 ) ;
...
static int
F_310 ( struct V_775 * V_567 )
{
struct V_141 * V_142 = F_275 ( V_567 ) ;
struct V_5 * V_6 = F_58 ( V_142 ) ;
T_52 V_820 = V_567 -> V_821 ;
int V_74 ;
F_3 ( V_58 L_355
L_354 , V_6 -> V_35 , V_567 ,
F_305 ( V_567 ) , V_820 ) ;
...
if ( V_74 )
return V_74 ;
F_115 ( V_6 , V_321 , V_823 ) ;
F_314 ( V_142 ) ;
F_290 ( V_6 ) ;
return 0 ;
}
static T_53
F_315 ( struct V_775 * V_567 , T_54 V_200 )
{
struct V_141 * V_142 = F_275 ( V_567 ) ;
struct V_5 * V_6 = F_58 ( V_142 ) ;
F_3 ( V_58 L_356 ,
