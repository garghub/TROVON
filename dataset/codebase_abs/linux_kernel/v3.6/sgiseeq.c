...
F_21 ( V_179 L_14 , V_2 -> V_98 , V_119 , V_2 -> V_28 ) ;
return 0 ;
V_178:
F_69 ( ( unsigned long ) V_18 -> V_151 ) ;
V_154:
F_70 ( V_2 ) ;
V_150:
return V_65 ;
}
static int T_4 F_71 ( struct V_140 * V_141 )
{
struct V_1 * V_2 = F_72 ( V_141 ) ;
struct V_17 * V_18 = F_9 ( V_2 ) ;
F_73 ( V_2 ) ;
F_74 ( & V_141 -> V_2 , sizeof( * V_18 -> V_151 ) , V_18 -> V_151 ,
V_18 -> V_152 ) ;
F_70 ( V_2 ) ;
F_64 ( V_141 , NULL ) ;
return 0 ;
