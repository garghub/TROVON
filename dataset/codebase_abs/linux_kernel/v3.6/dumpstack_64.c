...
unsigned long V_32 ;
const int V_1 = F_11 () ;
struct V_17 * V_43 = V_31 ;
V_32 = V_20 -> V_32 ;
F_17 ( L_7 , V_1 ) ;
F_18 ( V_20 , 1 ) ;
F_17 ( V_44 L_8 ,
V_43 -> V_45 , V_43 -> V_46 , F_7 ( V_43 ) , V_43 ) ;
if ( ! F_19 ( V_20 ) ) {
...
if ( V_51 < ( T_1 * ) V_52 || F_20 ( V_51 , V_50 ) ) {
V_51 = ( T_1 * ) V_20 -> V_51 ;
V_49 = V_49 - V_47 + 1 ;
}
...
{
unsigned short V_53 ;
if ( F_22 ( & V_53 , ( const void V_54 * ) V_51 , sizeof( V_53 ) ) )
return 0 ;
return V_53 == 0x0b0f ;
}
