...
int V_31 ;
unsigned long V_71 ;
V_36 = ( T_1 ) ( V_5 -> V_72 - V_5 -> V_2 -> V_73 ) ;
V_2 = V_5 -> V_2 ;
V_26 = F_4 ( V_5 ) ;
V_31 = F_9 ( V_2 -> V_11 , V_74 ,
V_75 , V_36 ) ;
if ( V_31 < 0 ) {
F_17 ( & V_5 -> V_11 ,
L_7 ,
...
{
struct V_89 * V_90 = F_3 ( V_2 ) ;
struct V_25 * V_26 ;
int V_3 ;
if ( V_90 -> V_91 -> V_31 == - V_86 )
F_31 ( V_90 -> V_91 ) ;
F_33 ( V_90 -> V_91 ) ;
for ( V_3 = 0 ; V_3 < V_2 -> V_4 ; V_3 ++ ) {
...
unsigned long V_71 ;
F_28 ( & V_106 -> V_79 , V_71 ) ;
V_108 = V_106 -> V_110 ;
F_29 ( & V_106 -> V_79 , V_71 ) ;
while ( 1 ) {
F_37 ( V_106 -> V_111 ,
...
V_156 = V_2 -> V_5 [ 0 ] ;
V_90 = F_3 ( V_2 ) ;
V_90 -> V_91 = F_60 ( 0 , V_76 ) ;
if ( ! V_90 -> V_91 ) {
F_17 ( & V_2 -> V_11 -> V_11 , L_20 ) ;
return - V_77 ;
}
F_61 ( V_90 -> V_91 , V_2 -> V_11 ,
F_62 ( V_2 -> V_11 ,
V_156 -> V_158 ) ,
V_90 -> V_159 ,
sizeof( V_90 -> V_159 ) ,
...
V_85 -> V_197 = V_193 + V_191 ;
V_31 = F_58 ( V_85 , V_155 ) ;
if ( V_31 == 0 ) {
V_26 -> V_87 = true ;
V_194 += V_193 ;
}
