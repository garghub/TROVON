...
return V_256 >= F_221 ( & V_175 -> V_149 ) ;
}
return 1 ;
}
...
static struct V_46 * F_236 ( struct V_266 * V_149 ,
struct V_55 * V_56 ,
unsigned long V_267 , V_31 V_256 )
{
struct V_174 * V_175 = F_237 ( V_149 ) ;
struct V_46 * V_46 = NULL ;
V_256 = F_238 ( V_31 , F_239 ( V_56 -> V_109 ) , V_256 ) ;
if ( ! V_37 && V_256 > F_240 ( 32 ) ) {
V_46 = F_241 ( & V_56 -> V_188 , V_267 ,
F_157 ( F_240 ( 32 ) ) , 1 ) ;
if ( V_46 )
return V_46 ;
}
V_46 = F_241 ( & V_56 -> V_188 , V_267 , F_157 ( V_256 ) , 1 ) ;
if ( F_172 ( ! V_46 ) ) {
F_42 ( V_143 L_49 ,
V_267 , F_200 ( V_175 ) ) ;
return NULL ;
...
static struct V_55 * F_242 ( struct V_174 * V_175 )
{
struct V_55 * V_56 ;
int V_88 ;
V_56 = F_198 ( V_175 ,
...
static inline struct V_55 * F_243 ( struct V_174 * V_149 )
{
struct V_144 * V_146 ;
...
static int F_244 ( struct V_174 * V_175 )
{
return V_175 -> V_149 . V_225 . V_49 == V_241 ;
}
static int F_245 ( struct V_266 * V_149 )
{
struct V_174 * V_175 ;
int V_145 ;
...
static V_219 F_247 ( struct V_266 * V_269 , T_6 V_270 ,
T_5 V_84 , int V_271 , V_23 V_256 )
{
struct V_174 * V_175 = F_237 ( V_269 ) ;
struct V_55 * V_56 ;
T_6 V_272 ;
struct V_46 * V_46 ;
int V_30 = 0 ;
...
V_46 = F_236 ( V_269 , V_56 , F_10 ( V_84 ) , V_256 ) ;
if ( ! V_46 )
goto error;
...
error:
if ( V_46 )
F_249 ( & V_56 -> V_188 , V_46 ) ;
F_42 ( V_143 L_54 ,
F_200 ( V_175 ) , V_84 , ( unsigned long long ) V_270 , V_271 ) ;
return 0 ;
}
static V_219 F_250 ( struct V_266 * V_149 , struct V_12 * V_12 ,
unsigned long V_94 , T_5 V_84 ,
enum V_279 V_271 ,
struct V_280 * V_281 )
{
return F_247 ( V_149 , F_183 ( V_12 ) + V_94 , V_84 ,
V_271 , F_237 ( V_149 ) -> V_256 ) ;
}
...
F_249 ( & V_259 [ V_64 ] . V_56 [ V_282 ] -> V_188 , V_46 ) ;
}
V_259 [ V_64 ] . V_226 = 0 ;
}
V_285 = 0 ;
...
static void F_252 ( struct V_55 * V_288 , struct V_46 * V_46 )
{
unsigned long V_58 ;
int V_226 , V_57 ;
struct V_48 * V_49 ;
...
static void F_255 ( struct V_266 * V_149 , V_219 V_292 ,
...
F_62 ( ! V_56 ) ;
V_49 = F_61 ( V_56 ) ;
V_46 = F_256 ( & V_56 -> V_188 , F_157 ( V_292 ) ) ;
if ( F_257 ( ! V_46 , L_55 ,
...
static void * F_258 ( struct V_266 * V_269 , T_5 V_84 ,
...
if ( V_269 -> V_257 < F_240 ( 32 ) )
V_58 |= V_294 ;
else
V_58 |= V_295 ;
}
V_41 = ( void * ) F_260 ( V_58 , V_107 ) ;
if ( ! V_41 )
return NULL ;
memset ( V_41 , 0 , V_84 ) ;
* V_293 = F_247 ( V_269 , F_261 ( V_41 ) , V_84 ,
V_276 ,
V_269 -> V_257 ) ;
if ( * V_293 )
return V_41 ;
F_262 ( ( unsigned long ) V_41 , V_107 ) ;
return NULL ;
}
static void F_263 ( struct V_266 * V_269 , T_5 V_84 , void * V_41 ,
V_219 V_293 , struct V_280 * V_281 )
{
int V_107 ;
V_84 = F_180 ( V_84 ) ;
V_107 = F_259 ( V_84 ) ;
F_255 ( V_269 , V_293 , V_84 , V_276 , NULL ) ;
F_262 ( ( unsigned long ) V_41 , V_107 ) ;
}
static void F_264 ( struct V_266 * V_269 , struct V_209 * V_296 ,
...
F_62 ( ! V_56 ) ;
V_49 = F_61 ( V_56 ) ;
V_46 = F_256 ( & V_56 -> V_188 , F_157 ( V_296 [ 0 ] . V_218 ) ) ;
if ( F_257 ( ! V_46 , L_57 ,
...
static int F_265 ( struct V_266 * V_298 ,
...
static int F_267 ( struct V_266 * V_269 , struct V_209 * V_296 , int V_297 ,
...
F_62 ( V_271 == V_274 ) ;
if ( F_245 ( V_269 ) )
return F_265 ( V_269 , V_296 , V_297 , V_271 ) ;
V_56 = F_243 ( V_175 ) ;
if ( ! V_56 )
return 0 ;
V_49 = F_61 ( V_56 ) ;
...
V_46 = F_236 ( V_269 , V_56 , F_10 ( V_84 ) ,
V_175 -> V_256 ) ;
if ( ! V_46 ) {
V_296 -> V_220 = 0 ;
return 0 ;
...
static int F_268 ( struct V_266 * V_149 , V_219 V_300 )
{
return ! V_300 ;
}
...
static void F_276 ( struct V_174 * V_175 )
{
struct V_68 * V_69 ;
T_3 V_303 ;
int V_304 ;
V_304 = F_277 ( V_175 -> V_73 , F_278 ( 0 , 0 ) , 0xb0 , & V_303 ) ;
if ( V_304 ) {
F_279 ( & V_175 -> V_149 , L_64 ) ;
return;
}
V_303 &= 0xffff0000 ;
V_69 = F_199 ( V_175 ) ;
if ( F_280 ( ! V_69 || V_69 -> V_261 - V_303 != 0xa000 ,
V_305 ,
L_65 ) )
...
unsigned long V_113 ;
F_70 (iommu, drhd) {
V_49 -> V_307 = F_226 ( sizeof( T_3 ) * V_308 ,
V_42 ) ;
if ( ! V_49 -> V_307 )
goto V_309;
}
...
static void T_1 F_291 ( struct V_239 * V_240 )
{
F_201 ( & V_240 -> V_319 , & V_320 ) ;
}
int T_1 F_292 ( struct V_321 * V_322 )
{
struct V_323 * V_240 ;
struct V_239 * V_324 ;
V_324 = F_226 ( sizeof( * V_324 ) , V_168 ) ;
if ( ! V_324 )
return - V_110 ;
V_324 -> V_325 = V_322 ;
...
static int T_1
F_293 ( struct V_239 * V_324 )
{
struct V_323 * V_240 ;
int V_88 ;
V_240 = (struct V_323 * ) V_324 -> V_325 ;
V_88 = F_294 ( ( void * ) ( V_240 + 1 ) ,
...
int T_1 F_295 ( struct V_321 * V_325 )
{
struct V_326 * V_327 ;
struct V_328 * V_329 ;
V_327 = F_296 ( V_325 , struct V_326 , V_322 ) ;
V_329 = F_226 ( sizeof( * V_329 ) , V_168 ) ;
if ( ! V_329 )
return - V_110 ;
V_329 -> V_325 = V_325 ;
...
static int T_1 F_297 ( struct V_328 * V_329 )
{
int V_304 ;
struct V_326 * V_327 ;
if ( V_329 -> V_82 )
return 0 ;
V_327 = F_296 ( V_329 -> V_325 , struct V_326 , V_322 ) ;
V_304 = F_294 ( ( void * ) ( V_327 + 1 ) ,
...
static int F_301 ( struct V_336 * V_337 ,
...
static int F_316 ( struct V_354 * V_56 )
{
struct V_55 * V_55 ;
V_55 = F_314 () ;
if ( ! V_55 ) {
...
V_56 -> V_355 = V_55 ;
V_56 -> V_356 . V_357 = 0 ;
V_56 -> V_356 . V_358 = F_317 ( V_55 -> V_109 ) ;
V_56 -> V_356 . V_359 = true ;
return 0 ;
}
static void F_318 ( struct V_354 * V_56 )
{
struct V_55 * V_55 = V_56 -> V_355 ;
V_56 -> V_355 = NULL ;
F_143 ( V_55 ) ;
}
static int F_319 ( struct V_354 * V_56 ,
struct V_266 * V_149 )
{
struct V_55 * V_55 = V_56 -> V_355 ;
struct V_174 * V_175 = F_237 ( V_149 ) ;
...
static T_5 F_322 ( struct V_354 * V_56 ,
...
static T_6 F_323 ( struct V_354 * V_56 ,
unsigned long V_46 )
{
struct V_55 * V_55 = V_56 -> V_355 ;
struct V_25 * V_26 ;
...
static int F_324 ( struct V_354 * V_56 ,
unsigned long V_52 )
{
struct V_55 * V_55 = V_56 -> V_355 ;
if ( V_52 == V_368 )
...
static void F_325 ( struct V_174 * * V_371 , struct V_174 * V_372 )
{
F_326 ( * V_371 ) ;
* V_371 = V_372 ;
}
static int F_327 ( struct V_266 * V_149 )
{
struct V_174 * V_175 = F_237 ( V_149 ) ;
struct V_174 * V_332 , * V_373 ;
struct V_374 * V_375 ;
int V_88 ;
...
V_373 = F_329 ( V_175 ) ;
F_325 ( & V_373 , F_330 ( V_373 ) ) ;
if ( V_373 -> V_376 &&
! F_331 ( V_373 , V_377 ) )
F_325 ( & V_373 ,
F_332 ( V_373 -> V_73 ,
F_278 ( F_170 ( V_373 -> V_74 ) ,
0 ) ) ) ;
while ( ! F_220 ( V_373 -> V_73 ) ) {
...
if ( F_333 ( V_73 -> V_200 , NULL , V_377 ) )
break;
F_325 ( & V_373 , F_329 ( V_73 -> V_200 ) ) ;
}
V_378:
V_375 = F_334 ( & V_373 -> V_149 ) ;
F_326 ( V_373 ) ;
if ( ! V_375 ) {
V_375 = F_335 () ;
if ( F_336 ( V_375 ) )
...
V_88 = F_338 ( V_375 , V_149 ) ;
F_339 ( V_375 ) ;
return V_88 ;
}
static void F_340 ( struct V_266 * V_149 )
{
F_341 ( V_149 ) ;
}
static void T_8 F_342 ( struct V_174 * V_149 )
{
F_42 ( V_35 L_81 ) ;
V_123 = 1 ;
if ( V_149 -> V_379 == 0x07 ) {
...
struct V_174 * V_175 ;
T_9 V_383 ;
V_175 = F_345 ( V_384 , 0x3a3e , NULL ) ;
if ( ! V_175 )
return;
F_326 ( V_175 ) ;
V_175 = F_345 ( V_384 , 0x342e , NULL ) ;
if ( ! V_175 )
return;
if ( F_346 ( V_175 , 0x188 , & V_383 ) ) {
F_326 ( V_175 ) ;
return;
}
F_326 ( V_175 ) ;
