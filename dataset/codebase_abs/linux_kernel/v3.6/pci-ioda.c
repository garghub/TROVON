...
V_83 = V_88 ;
V_80 = V_3 -> V_9 -> V_36 ;
V_86 = V_3 -> V_9 -> V_89 . V_21 - V_3 -> V_9 -> V_89 . V_16 + 1 ;
switch( V_86 ) {
case 1 : V_81 = V_90 ; break;
case 2 : V_81 = V_91 ; break;
case 4 : V_81 = V_92 ; break;
case 8 : V_81 = V_93 ; break;
case 16 : V_81 = V_94 ; break;
case 32 : V_81 = V_95 ; break;
default:
F_32 ( L_21
L_22 ,
...
V_40 -> V_50 . V_102 [ V_85 ] = V_3 -> V_11 ;
if ( V_40 -> type == V_103 ) {
V_3 -> V_104 = V_3 -> V_11 ;
V_66 = F_50 ( V_40 -> V_70 , V_3 -> V_104 ,
V_3 -> V_11 ) ;
if ( V_66 ) {
F_47 ( V_3 , L_24 ,
V_66 , V_3 -> V_104 ) ;
...
if ( V_107 -> V_108 < V_3 -> V_108 ) {
F_13 ( & V_3 -> V_33 , & V_107 -> V_33 ) ;
return;
}
}
F_13 ( & V_3 -> V_33 , & V_40 -> V_50 . V_109 ) ;
}
...
V_3 -> V_119 = - 1 ;
V_3 -> V_104 = - 1 ;
V_3 -> V_85 = V_8 -> V_28 -> V_10 << 8 | V_60 -> V_120 ;
F_57 ( V_3 , L_28 ) ;
if ( F_45 ( V_40 , V_3 ) ) {
if ( V_117 )
F_41 ( V_40 , V_117 ) ;
...
struct V_2 * V_3 ;
if ( V_40 -> V_50 . V_121 > V_40 -> V_50 . V_147 )
V_144 = 0 ;
else
...
F_80 ( L_39 ,
V_40 -> V_50 . V_121 , V_40 -> V_50 . V_108 ) ;
V_145 = V_40 -> V_50 . V_147 ;
V_146 = V_40 -> V_50 . V_108 ;
V_127 = 0 ;
...
V_128 = 1 ;
if ( V_144 ) {
V_128 += ( ( V_3 -> V_108 * V_144 ) + ( V_146 / 2 ) ) / V_146 ;
if ( V_128 > V_145 )
V_128 = V_145 ;
}
F_57 ( V_3 , L_41 ,
...
if ( V_150 ) {
V_66 = F_84 ( V_40 -> V_70 , V_3 -> V_104 , V_153 , 1 ,
& V_155 , & V_157 ) ;
if ( V_66 ) {
F_60 ( L_43 ,
F_8 ( V_8 ) , V_66 ) ;
...
V_66 = F_85 ( V_40 -> V_70 , V_3 -> V_104 , V_153 , 1 ,
& V_156 , & V_157 ) ;
if ( V_66 ) {
F_60 ( L_44 ,
F_8 ( V_8 ) , V_66 ) ;
...
T_9 V_120 )
{
return V_40 -> V_50 . V_102 [ ( V_28 -> V_10 << 8 ) | V_120 ] ;
}
