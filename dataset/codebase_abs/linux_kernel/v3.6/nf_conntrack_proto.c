...
static struct V_47 * F_43 ( struct V_1 * V_1 ,
struct V_9 * V_11 )
{
if ( V_11 -> V_48 ) {
return V_11 -> V_48 ( V_1 ) ;
} else if ( V_11 -> V_49 ) {
return F_44 ( V_1 , * V_11 -> V_49 ) ;
}
return NULL ;
}
static
