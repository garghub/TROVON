...
struct V_1 * V_2 = V_48 -> V_2 ;
F_2 ( V_11 , L_54 ) ;
V_27 = V_48 -> V_170 ( V_63 ) ;
if ( V_27 != 0 ) {
F_2 ( ERROR , L_55 , V_27 ) ;
return V_27 ;
}
F_12 ( L_56 , V_2 -> V_171 , V_169 ,
V_168 , sizeof( V_168 ) ) ;
F_88 ( V_2 , 0 , V_107 , V_168 ,
sizeof( V_168 ) ) ;
memcpy ( V_2 -> V_171 , V_168 , V_169 ) ;
F_89 ( V_2 -> V_171 , V_172 ) ;
F_89 ( V_2 -> V_171 , V_173 ) ;
F_89 ( V_2 -> V_171 , V_174 ) ;
F_89 ( V_2 -> V_171 , V_175 ) ;
F_89 ( V_2 -> V_171 , V_176 ) ;
F_89 ( V_2 -> V_171 , V_177 ) ;
F_89 ( V_2 -> V_171 , V_178 ) ;
F_89 ( V_2 -> V_171 , V_179 ) ;
F_89 ( V_2 -> V_171 , V_180 ) ;
F_89 ( V_2 -> V_171 , V_181 ) ;
F_89 ( V_2 -> V_171 , V_182 ) ;
F_89 ( V_2 -> V_171 , V_183 ) ;
F_89 ( V_2 -> V_171 , V_184 ) ;
F_89 ( V_2 -> V_171 , V_185 ) ;
F_89 ( V_2 -> V_171 , V_186 ) ;
F_89 ( V_2 -> V_171 , V_187 ) ;
F_89 ( V_2 -> V_171 , V_188 ) ;
F_89 ( V_2 -> V_171 , V_189 ) ;
V_2 -> V_190 = 1 ;
V_2 -> V_191 [ 0 ] = L_57 ;
V_27 = F_90 ( V_2 ) ;
if ( V_27 < 0 )
...
if ( V_2 ) {
F_92 ( V_2 ) ;
V_2 -> V_48 -> V_192 ( V_2 -> V_63 ) ;
}
}
void F_86 ( struct V_75 * V_63 )
{
int V_4 ;
struct V_76 * V_48 = F_30 ( V_63 ) ;
struct V_1 * V_2 = V_48 -> V_2 ;
...
{
return F_97 ( & V_2 -> V_61 ) ;
}
int F_59 ( struct V_15 * V_9 )
{
struct V_6 * V_7 = F_16 ( V_9 ) ;
struct V_1 * V_2 = V_7 -> V_2 ;
int V_194 = 10 * V_195 / 1000 ;
int V_196 = V_197 ;
int V_198 = F_96 ( V_2 ) ;
while ( V_196 && V_198 ) {
if ( V_198 ) {
...
int F_100 ( struct V_1 * V_2 , const T_4 * V_24 , int V_201 )
{
int V_27 = 0 ;
struct V_202 * V_203 ;
T_8 V_204 ;
...
V_204 = F_101 () ;
F_102 ( V_206 ) ;
V_203 = F_103 ( L_59 , V_207 | V_208 , 0640 ) ;
if ( ! V_203 ) {
F_2 ( ERROR , L_60 ) ;
V_27 = - 1 ;
goto exit;
}
V_203 -> V_209 -> V_210 ( V_203 , ( char T_6 * ) V_24 , V_201 , & V_205 ) ;
exit:
F_11 ( V_24 ) ;
if ( V_203 )
F_104 ( V_203 , NULL ) ;
