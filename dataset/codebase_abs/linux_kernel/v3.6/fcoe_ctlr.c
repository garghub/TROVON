...
const struct V_363 * V_313 , int V_364 )
{
memcpy ( & V_129 -> V_313 , V_313 , sizeof( * V_313 ) ) ;
if ( V_364 && F_157 ( V_129 ) )
return - V_51 ;
F_158 ( V_129 ) ;
F_159 ( V_129 ) ;
F_160 ( V_129 ) ;
if ( V_6 -> V_13 == V_14 )
V_129 -> V_365 = sizeof( struct V_277 ) ;
F_161 ( V_129 ) ;
if ( V_6 -> V_13 == V_14 ) {
V_129 -> V_154 = 1 ;
V_129 -> V_313 . V_366 = F_149 ;
V_129 -> V_313 . V_367 = F_151 ;
V_129 -> V_313 . V_368 = F_127 ;
V_129 -> V_313 . V_369 = F_128 ;
F_11 ( & V_129 -> V_304 . V_315 ) ;
F_10 ( & V_129 -> V_304 . V_370 ) ;
V_129 -> V_304 . V_53 = V_6 ;
} else {
F_162 ( V_129 ) ;
}
return 0 ;
