...
if ( ! V_149 && V_63 -> V_150 ) {
F_54 ( V_63 , V_10 ) ;
if ( V_10 -> V_144 > V_10 -> V_145 ||
! V_10 -> V_146 || ! V_10 -> V_147 )
return - V_142 ;
}
V_95 -> V_151 . V_144 = V_10 -> V_144 ;
V_95 -> V_151 . V_145 = V_10 -> V_145 ;
V_95 -> V_151 . V_147 = V_10 -> V_147 ;
V_95 -> V_151 . V_146 = V_10 -> V_146 ;
F_55 ( V_92 -> V_95 , 0 ,
V_152 , 2 ) ;
return 0 ;
}
...
static void F_43 ( struct V_93 * V_94 , int V_155 )
{
struct V_21 * V_22 = V_94 -> V_22 ;
struct V_62 * V_63 = & V_94 -> V_26 ;
T_1 V_3 = V_94 -> V_3 ;
int V_156 = F_58 ( V_22 , V_3 ) ;
bool V_150 = false ;
memset ( V_63 , 0 , F_59 ( struct V_62 , V_33 ) ) ;
V_63 -> V_98 = ! ! ( V_156 & V_157 ) ;
if ( V_63 -> V_98 )
V_150 = ! ! ( V_156 & V_158 ) ;
F_42 ( V_115 ,
L_24 ,
V_22 -> V_116 , V_3 , V_63 -> V_98 , V_150 ) ;
if ( V_150 ) {
if ( ! F_60 ( V_63 , V_22 , V_3 ) )
F_61 ( V_63 ) ;
else if ( V_155 ) {
F_62 ( V_22 -> V_159 -> V_160 ,
& V_94 -> V_161 ,
F_63 ( 300 ) ) ;
}
}
}
static void F_64 ( struct V_162 * V_161 )
{
struct V_93 * V_94 =
F_65 ( F_66 ( V_161 ) , struct V_93 , V_161 ) ;
if ( V_94 -> V_163 ++ > 6 )
V_94 -> V_163 = 0 ;
F_43 ( V_94 , V_94 -> V_163 ) ;
}
...
struct V_93 * V_94 ;
int V_37 ;
V_164 = F_68 ( V_22 , V_3 , V_166 ) ;
if ( ! ( V_164 & ( V_167 | V_168 ) ) )
return 0 ;
V_165 = F_12 ( V_22 , V_3 , 0 ,
V_169 , 0 ) ;
if ( F_69 ( V_165 ) == V_170 )
return 0 ;
if ( F_52 ( V_2 -> V_5 >= V_171 ) )
return - V_172 ;
V_4 = V_2 -> V_5 ;
V_94 = & V_2 -> V_6 [ V_4 ] ;
V_94 -> V_3 = V_3 ;
...
unsigned int V_173 ;
int V_37 ;
if ( F_52 ( V_2 -> V_15 >= V_174 ) )
return - V_172 ;
V_173 = F_17 ( V_22 , V_13 ) ;
V_173 = F_71 ( V_173 ) ;
V_14 = V_2 -> V_15 ;
V_138 = & V_2 -> V_16 [ V_14 ] ;
V_138 -> V_13 = V_13 ;
...
T_1 V_113 ;
int V_54 , V_175 ;
V_175 = F_74 ( V_22 , V_22 -> V_176 , & V_113 ) ;
if ( ! V_113 || V_175 < 0 ) {
F_2 ( V_7 L_25 ) ;
return - V_8 ;
}
for ( V_54 = 0 ; V_54 < V_175 ; V_54 ++ , V_113 ++ ) {
unsigned int V_164 ;
unsigned int type ;
V_164 = F_68 ( V_22 , V_113 , V_177 ) ;
type = F_75 ( V_164 ) ;
if ( ! ( V_164 & V_178 ) )
continue;
switch ( type ) {
...
#ifdef F_76
if ( ! ( F_68 ( V_22 , V_22 -> V_176 , V_181 ) &
V_182 ) )
V_22 -> V_159 -> V_183 = 1 ;
#endif
return 0 ;
}
static char * F_77 ( int V_184 )
{
static char V_185 [ V_171 ] [ 8 ] ;
sprintf ( & V_185 [ V_184 ] [ 0 ] , L_26 , V_184 ) ;
return & V_185 [ V_184 ] [ 0 ] ;
}
...
static int F_84 ( struct V_21 * V_22 , int V_4 )
{
char V_199 [ 32 ] = L_27 ;
struct V_1 * V_2 = V_22 -> V_2 ;
struct V_93 * V_94 = & V_2 -> V_6 [ V_4 ] ;
...
return F_85 ( V_22 , V_94 -> V_3 , V_199 , 0 ) ;
}
...
F_96 ( V_22 -> V_159 -> V_160 ) ;
F_97 ( V_2 ) ;
}
static int F_98 ( struct V_21 * V_22 )
{
struct V_1 * V_2 ;
V_2 = F_99 ( sizeof( * V_2 ) , V_201 ) ;
if ( V_2 == NULL )
return - V_39 ;
V_22 -> V_2 = V_2 ;
if ( F_73 ( V_22 ) < 0 ) {
...
V_22 -> V_197 = 1 ;
V_22 -> V_198 = V_188 ;
V_173 = F_17 ( V_22 , V_2 -> V_16 [ 0 ] . V_13 ) ;
V_173 = F_71 ( V_173 ) ;
V_188 -> V_190 = F_77 ( 0 ) ;
V_188 -> V_191 = V_192 ;
V_189 = & V_188 -> V_12 [ V_193 ] ;
* V_189 = V_2 -> V_204 ;
V_189 -> V_113 = V_2 -> V_16 [ 0 ] . V_13 ;
if ( V_189 -> V_145 <= 2 && V_173 && V_173 <= 16 )
V_189 -> V_145 = V_173 ;
return 0 ;
}
...
{
struct V_1 * V_2 = V_22 -> V_2 ;
T_1 V_205 = V_2 -> V_6 [ 0 ] . V_3 ;
F_14 ( V_22 , V_205 , 0 ,
V_50 , V_186 ) ;
if ( F_17 ( V_22 , V_205 ) & V_47 )
F_14 ( V_22 , V_205 , 0 , V_48 ,
V_49 ) ;
F_92 ( V_22 , V_205 , V_205 ) ;
F_44 ( V_22 ) ;
return 0 ;
}
...
struct V_229 * V_230 ;
F_120 ( & V_22 -> V_231 ) ;
V_230 = F_121 ( V_22 , V_2 -> V_16 [ 0 ] . V_13 ) ;
V_52 = V_92 -> V_95 -> V_59 ;
V_227 = 0x2 ;
if ( V_22 -> V_232 && ( V_230 -> V_233 & V_234 ) )
F_14 ( V_22 ,
V_223 ,
0 ,
V_235 ,
V_230 -> V_233 & ~ V_234 & 0xff ) ;
F_14 ( V_22 , V_223 , 0 ,
V_224 , ( V_126 << 4 ) | 0x0 ) ;
F_14 ( V_22 , V_223 , 0 ,
V_226 , V_127 ) ;
...
{
struct V_1 * V_2 ;
int V_37 = F_116 ( V_22 , V_223 ,
V_237 ) ;
if ( V_37 < 0 )
return V_37 ;
V_22 -> V_202 . V_238 = F_107 ;
V_2 = V_22 -> V_2 ;
V_2 -> V_204 . V_146 = V_239 ;
V_2 -> V_204 . V_148 = V_240 ;
V_2 -> V_204 . V_147 = V_241 ;
return 0 ;
}
...
{
struct V_1 * V_2 = V_22 -> V_2 ;
int V_173 = V_92 -> V_95 -> V_59 ;
int V_54 , V_37 ;
V_37 = F_114 ( V_10 , V_22 , V_126 , V_127 ,
V_92 ) ;
if ( V_37 < 0 )
return V_37 ;
...
{
struct V_1 * V_2 ;
int V_37 = F_116 ( V_22 , V_243 , V_244 ) ;
if ( V_37 < 0 )
return V_37 ;
V_2 = V_22 -> V_2 ;
V_2 -> V_204 . V_195 . V_245 = F_125 ;
return 0 ;
}
static int F_127 ( struct V_21 * V_22 )
{
return F_116 ( V_22 , V_246 , V_247 ) ;
}
