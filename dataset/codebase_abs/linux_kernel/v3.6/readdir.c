...
static int F_23 ( const unsigned int V_76 , struct V_1 * V_1 )
{
T_3 V_77 ;
int V_78 = 0 ;
char * V_79 = NULL ;
...
static int F_50 ( const unsigned int V_76 , struct V_85 * V_143 ,
struct V_1 * V_1 , char * * V_144 , int * V_145 )
{
T_3 V_77 ;
int V_78 = 0 ;
int V_146 = 0 ;
...
if ( F_31 ( V_29 ) )
V_77 |= V_104 ;
while ( ( V_148 >= V_80 -> V_7 . V_150 ) &&
( V_78 == 0 ) && ! V_80 -> V_7 . V_8 ) {
F_2 ( 1 , L_16 ) ;
V_78 = F_56 ( V_76 , V_143 , V_80 -> V_106 , V_77 ,
& V_80 -> V_7 ) ;
if ( V_80 -> V_7 . V_155 )
F_49 ( V_80 -> V_7 . V_155 ,
V_80 ) ;
...
int V_156 ;
char * V_138 ;
char * V_113 = V_80 -> V_7 . V_153 +
F_57 ( (struct V_157 * )
V_80 -> V_7 . V_153 ) ;
V_138 = V_80 -> V_7 . V_158 ;
V_147 = V_80 -> V_7 . V_150
- V_80 -> V_7 . V_151 ;
V_146 = V_148 - V_147 ;
F_2 ( 1 , L_17 , V_146 ) ;
for ( V_156 = 0 ; ( V_156 < ( V_146 ) ) && ( V_138 != NULL ) ; V_156 ++ ) {
V_138 = F_37 ( V_138 , V_113 ,
V_80 -> V_7 . V_93 ) ;
}
if ( ( V_138 == NULL ) && ( V_156 < V_146 ) ) {
F_38 ( 1 , L_18
L_19 ,
V_146 , V_148 , V_78 ) ;
}
...
if ( V_146 >= V_80 -> V_7 . V_151 ) {
F_2 ( 1 , L_21 ) ;
* V_145 = 0 ;
} else
* V_145 = V_80 -> V_7 . V_151 - V_146 ;
return V_78 ;
}
static int F_58 ( char * V_159 , struct V_1 * V_1 , T_11 V_160 ,
void * V_161 , char * V_162 , unsigned int V_163 )
{
...
int V_78 = 0 ;
T_12 V_127 ;
V_78 = F_46 ( & V_121 , V_159 , V_139 -> V_7 . V_93 ,
V_139 -> V_7 . V_140 ) ;
if ( V_78 )
return V_78 ;
if ( V_121 . V_124 > V_163 ) {
F_38 ( 1 , L_22 ,
V_121 . V_124 ) ;
return - V_133 ;
}
...
return 0 ;
if ( V_139 -> V_7 . V_140 ) {
struct V_164 * V_165 = V_29 -> V_105 ;
V_13 . V_13 = V_162 ;
V_13 . V_25 =
F_59 ( ( char * ) V_13 . V_13 , ( T_4 * ) V_121 . V_13 ,
V_166 ,
F_60 ( V_167 , V_121 . V_124 ,
( V_167 ) V_163 ) , V_165 ,
V_29 -> V_46 &
V_107 ) ;
V_13 . V_25 -= F_61 ( V_165 ) ;
} else {
...
V_10 = F_3 ( V_1 -> V_170 , & V_13 , & V_15 ) ;
V_78 = V_160 ( V_161 , V_13 . V_13 , V_13 . V_25 , V_1 -> V_90 , V_127 ,
V_15 . V_39 ) ;
F_9 ( V_10 ) ;
return V_78 ;
}
int F_67 ( struct V_1 * V_1 , void * V_171 , T_11 V_160 )
{
int V_78 = 0 ;
unsigned int V_76 ;
int V_156 ;
...
switch ( ( int ) V_1 -> V_90 ) {
case 0 :
if ( V_160 ( V_171 , L_24 , 1 , V_1 -> V_90 ,
V_1 -> V_81 . V_10 -> V_20 -> V_175 , V_40 ) < 0 ) {
F_38 ( 1 , L_25 ) ;
V_78 = - V_88 ;
break;
}
V_1 -> V_90 ++ ;
case 1 :
if ( V_160 ( V_171 , L_26 , 2 , V_1 -> V_90 ,
...
V_143 = F_29 ( V_80 -> V_84 ) ;
V_78 = F_50 ( V_76 , V_143 , V_1 ,
& V_138 , & V_172 ) ;
if ( V_78 ) {
F_2 ( 1 , L_29 , V_78 ) ;
goto V_174;
...
F_2 ( 1 , L_32 ,
V_172 , V_80 -> V_7 . V_153 ) ;
V_163 = F_57 ( (struct V_157 * )
V_80 -> V_7 . V_153 ) ;
V_113 = V_80 -> V_7 . V_153 + V_163 ;
V_173 = F_71 ( V_166 , V_87 ) ;
if ( V_173 == NULL ) {
V_78 = - V_88 ;
break;
}
for ( V_156 = 0 ; ( V_156 < V_172 ) && ( V_78 == 0 ) ; V_156 ++ ) {
if ( V_138 == NULL ) {
F_38 ( 1 , L_33 ,
V_172 , V_156 ) ;
break;
