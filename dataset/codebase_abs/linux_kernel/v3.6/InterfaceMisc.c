...
INT F_9 ( struct V_28 * V_29 )
{
T_1 V_1 = ( T_1 ) ( V_29 -> V_30 ) ;
INT V_31 = V_26 ;
F_10 ( V_1 ) ;
V_31 = F_11 ( V_1 -> V_22 , V_1 -> V_32 . V_33 ) ;
if ( V_31 != V_26 )
F_2 ( V_29 , V_15 , V_34 , V_17 , L_11 , V_31 ) ;
V_31 = F_11 ( V_1 -> V_22 , V_1 -> V_35 . V_36 ) ;
if ( V_31 != V_26 )
F_2 ( V_29 , V_15 , V_34 , V_17 , L_12 , V_31 ) ;
V_31 = F_11 ( V_1 -> V_22 , V_1 -> V_37 . V_38 ) ;
if ( V_31 != V_26 )
F_2 ( V_29 , V_15 , V_34 , V_17 , L_13 , V_31 ) ;
return V_31 ;
}
VOID F_10 ( T_1 V_1 )
{
...
T_2 V_41 ;
if ( V_1 -> V_42 != NULL ) {
if ( V_1 -> V_42 -> V_31 == - V_43 )
F_12 ( V_1 -> V_42 ) ;
}
for ( V_41 = 0 ; V_41 < V_44 ; V_41 ++ ) {
V_40 = V_1 -> V_45 [ V_41 ] . V_39 ;
if ( V_40 ) {
if ( V_40 -> V_31 == - V_43 )
F_12 ( V_40 ) ;
}
...
VOID F_14 ( struct V_52 * V_53 )
{
T_1 V_1 = NULL ;
struct V_54 * V_55 = NULL ;
V_1 = F_15 ( V_53 , V_56 , V_57 ) ;
V_55 = V_1 -> V_58 ;
if ( V_1 -> V_19 == FALSE )
F_16 ( V_55 ) ;
}
