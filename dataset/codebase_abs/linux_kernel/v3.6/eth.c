...
int F_25 ( struct V_3 * V_4 , int V_51 )
{
...
struct V_3 * F_28 ( int V_64 , unsigned int V_65 ,
unsigned int V_66 )
{
return F_29 ( V_64 , L_2 , F_27 , V_65 , V_66 ) ;
}
static T_2 F_30 ( char * V_67 , int V_68 ,
const unsigned char * V_43 , int V_7 )
{
int V_69 ;
char * V_70 = V_67 ;
for ( V_69 = 0 ; V_69 < V_7 ; V_69 ++ ) {
V_70 += F_31 ( V_70 , V_68 - ( V_70 - V_67 ) , L_3 , V_43 [ V_69 ] ) ;
if ( V_69 == V_7 - 1 )
break;
V_70 += F_31 ( V_70 , V_68 - ( V_70 - V_67 ) , L_4 ) ;
}
return V_70 - V_67 ;
}
T_3 F_32 ( char * V_67 , const unsigned char * V_43 , int V_7 )
{
T_2 V_71 ;
V_71 = F_30 ( V_67 , V_72 , V_43 , V_7 ) ;
V_71 += F_31 ( V_67 + V_71 , V_72 - V_71 , L_5 ) ;
return ( T_3 ) V_71 ;
}
