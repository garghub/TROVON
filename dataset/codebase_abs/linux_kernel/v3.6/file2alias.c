...
break;
case 0xf :
V_241 += sprintf ( V_241 , L_17 , V_239 ) ;
break;
default:
* V_241 ++ = '[' ;
for ( V_8 = 0 ; V_8 < 0x10 ; V_8 ++ )
if ( ( V_8 & V_240 ) == V_239 )
V_241 += sprintf ( V_241 , L_17 , V_8 ) ;
* V_241 ++ = ']' ;
}
* V_241 = '\0' ;
* V_238 = V_241 ;
}
static int F_44 ( const char * V_59 ,
struct V_242 * V_13 , char * V_21 )
{
unsigned int V_243 ;
char * V_241 = V_21 ;
if ( ( V_13 -> V_13 & V_13 -> V_240 ) != V_13 -> V_13 )
F_3 ( L_104
L_105 ,
V_59 , V_13 -> V_13 , V_13 -> V_240 ) ;
V_241 += sprintf ( V_21 , L_106 ) ;
for ( V_243 = 0 ; V_243 < 8 ; V_243 ++ )
F_43 ( & V_241 ,
( V_13 -> V_13 >> ( 4 * ( 7 - V_243 ) ) ) & 0xf ,
( V_13 -> V_240 >> ( 4 * ( 7 - V_243 ) ) ) & 0xf ) ;
return 1 ;
}
static int F_45 ( const char * V_59 , struct V_244 * V_13 ,
char * V_21 )
{
V_13 -> V_245 = F_9 ( V_13 -> V_245 ) ;
V_13 -> V_246 = F_9 ( V_13 -> V_246 ) ;
V_13 -> V_247 = F_9 ( V_13 -> V_247 ) ;
V_13 -> V_63 = F_9 ( V_13 -> V_63 ) ;
strcpy ( V_21 , L_107 ) ;
F_5 ( V_21 , L_108 , V_13 -> V_63 != V_248 , V_13 -> V_63 ) ;
F_5 ( V_21 , L_109 , V_13 -> V_246 != V_249 , V_13 -> V_246 ) ;
F_5 ( V_21 , L_110 , V_13 -> V_247 != V_250 , V_13 -> V_247 ) ;
strcat ( V_21 , L_111 ) ;
if ( V_13 -> V_245 != V_251 )
sprintf ( V_21 + strlen ( V_21 ) , L_112 , V_13 -> V_245 ) ;
return 1 ;
}
static bool F_46 ( const char * V_58 , unsigned V_252 , const char * V_253 )
{
if ( V_252 != strlen ( V_253 ) )
return false ;
return memcmp ( V_58 , V_253 , V_252 ) == 0 ;
}
...
unsigned int V_8 ;
char V_21 [ 500 ] ;
int (* F_48)( const char * , void * V_254 , char * V_21 ) = V_124 ;
F_2 ( V_20 -> V_58 , V_4 , V_5 , V_6 , V_7 ) ;
V_5 -= V_6 ;
for ( V_8 = 0 ; V_8 < V_5 ; V_8 += V_6 ) {
if ( F_48 ( V_20 -> V_58 , V_7 + V_8 , V_21 ) ) {
F_6 ( & V_20 -> V_42 ,
L_30 , V_21 ) ;
}
}
}
void F_49 ( struct V_19 * V_20 , struct V_255 * V_256 ,
T_3 * V_257 , const char * V_258 )
{
void * V_7 ;
char * V_259 = NULL ;
const char * V_58 ;
unsigned int V_252 ;
if ( ! V_257 -> V_260 || F_50 ( V_256 , V_257 ) >= V_256 -> V_261 )
return;
if ( F_51 ( V_257 -> V_262 ) != V_263 )
return;
V_58 = strstr ( V_258 , L_113 ) ;
if ( ! V_58 )
return;
V_58 += strlen ( L_113 ) ;
V_252 = strlen ( V_58 ) ;
if ( V_252 < strlen ( L_114 ) )
return;
if ( strcmp ( V_58 + V_252 - strlen ( L_114 ) , L_114 ) )
return;
V_252 -= strlen ( L_114 ) ;
if ( V_256 -> V_264 [ F_50 ( V_256 , V_257 ) ] . V_265 & V_266 ) {
V_259 = calloc ( 1 , V_257 -> V_267 ) ;
V_7 = V_259 ;
} else {
V_7 = ( void * ) V_256 -> V_268
+ V_256 -> V_264 [ F_50 ( V_256 , V_257 ) ] . V_269
+ V_257 -> V_270 ;
}
if ( F_46 ( V_58 , V_252 , L_31 ) )
F_10 ( V_7 , V_257 -> V_267 , V_20 ) ;
else if ( F_46 ( V_58 , V_252 , L_60 ) )
F_20 ( V_7 , V_257 -> V_267 , V_20 ) ;
else if ( F_46 ( V_58 , V_252 , L_115 ) )
F_21 ( V_7 , V_257 -> V_267 , V_20 ) ;
else {
struct V_271 * * V_241 ;
F_52 ( V_272 ) ;
for ( V_241 = V_273 ; V_241 < V_274 ; V_241 ++ ) {
if ( F_46 ( V_58 , V_252 , ( * V_241 ) -> V_4 ) ) {
F_47 ( V_7 , V_257 -> V_267 , ( * V_241 ) -> V_6 ,
( * V_241 ) -> V_4 , ( * V_241 ) -> V_124 , V_20 ) ;
break;
}
}
}
...
void F_53 ( struct V_275 * V_276 , struct V_19 * V_20 )
{
F_6 ( V_276 , L_9 ) ;
F_54 ( V_276 , V_20 -> V_42 . V_241 , V_20 -> V_42 . V_277 ) ;
free ( V_20 -> V_42 . V_241 ) ;
}
