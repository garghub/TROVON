...
static int
F_139 ( struct V_1 * V_4 , T_6 V_201 , struct V_31 * V_32 )
{
bool V_213 = false ;
int V_12 ;
struct V_59 * V_161 ;
...
V_12 = F_80 ( V_4 , V_32 , V_201 , V_214 ) ;
if ( V_12 < 0 ) {
F_37 ( & V_67 ) ;
F_96 ( V_161 ) ;
F_78 ( V_32 ) ;
...
F_141 ( & V_4 -> V_163 ) ;
F_142 ( & V_161 -> V_49 , & V_4 -> V_55 ) ;
F_107 ( V_4 ) ;
}
if ( V_161 -> V_94 . V_164 . V_165 . V_215 > 3 ) {
F_78 ( V_32 ) ;
V_12 = - V_187 ;
} else {
F_143 ( & V_161 -> V_94 . V_164 . V_165 , V_32 ) ;
V_12 = 0 ;
}
F_37 ( & V_67 ) ;
return V_12 ;
}
static int F_144 ( struct V_1 * V_4 , struct V_216 * V_63 )
{
int line ;
struct V_59 * V_161 , * V_48 ;
line = F_116 ( & V_63 -> V_217 . V_218 , & V_63 -> V_219 . V_218 ) ;
F_21 (c, next, &mrt->mfc6_cache_array[line], list) {
if ( F_117 ( & V_161 -> V_92 , & V_63 -> V_219 . V_218 ) &&
F_117 ( & V_161 -> V_91 , & V_63 -> V_217 . V_218 ) ) {
F_91 ( & V_64 ) ;
F_22 ( & V_161 -> V_49 ) ;
F_92 ( & V_64 ) ;
F_96 ( V_161 ) ;
...
static int F_145 ( struct V_220 * V_221 ,
unsigned long V_222 , void * V_223 )
{
struct V_105 * V_81 = V_223 ;
struct V_2 * V_2 = F_61 ( V_81 ) ;
struct V_1 * V_4 ;
struct V_68 * V_78 ;
int V_65 ;
...
static int T_2 F_148 ( struct V_2 * V_2 )
{
int V_12 ;
V_12 = F_11 ( V_2 ) ;
if ( V_12 < 0 )
...
#ifdef F_149
V_12 = - V_45 ;
if ( ! F_150 ( V_2 , L_13 , 0 , & V_227 ) )
goto V_228;
if ( ! F_150 ( V_2 , L_14 , 0 , & V_229 ) )
goto V_230;
#endif
return 0 ;
#ifdef F_149
...
static void T_3 F_152 ( struct V_2 * V_2 )
{
#ifdef F_149
F_151 ( V_2 , L_14 ) ;
F_151 ( V_2 , L_13 ) ;
...
goto V_235;
#ifdef F_27
if ( F_157 ( & V_236 , V_119 ) < 0 ) {
F_158 ( L_16 , V_237 ) ;
V_12 = - V_30 ;
goto V_238;
}
#endif
F_159 ( V_239 , V_240 , NULL ,
V_241 , NULL ) ;
return 0 ;
#ifdef F_27
V_238:
...
if ( ! F_69 ( & V_63 -> V_217 . V_218 ) )
return - V_27 ;
V_161 = F_118 () ;
if ( V_161 == NULL )
return - V_45 ;
V_161 -> V_92 = V_63 -> V_219 . V_218 ;
V_161 -> V_91 = V_63 -> V_217 . V_218 ;
V_161 -> V_93 = V_63 -> V_242 ;
F_112 ( V_4 , V_161 , V_99 ) ;
if ( ! V_183 )
V_161 -> V_245 |= V_246 ;
F_91 ( & V_64 ) ;
F_142 ( & V_161 -> V_49 , & V_4 -> V_54 [ line ] ) ;
F_92 ( & V_64 ) ;
V_213 = false ;
F_36 ( & V_67 ) ;
...
static int F_166 ( struct V_1 * V_4 , struct V_247 * V_248 )
{
int V_12 = 0 ;
struct V_2 * V_2 = F_167 ( V_248 ) ;
F_88 () ;
F_91 ( & V_64 ) ;
if ( F_168 ( V_4 -> V_212 == NULL ) ) {
V_4 -> V_212 = V_248 ;
V_2 -> V_13 . V_249 -> V_159 ++ ;
}
else
V_12 = - V_185 ;
F_92 ( & V_64 ) ;
...
struct V_247 * F_170 ( struct V_2 * V_2 , struct V_31 * V_32 )
{
struct V_1 * V_4 ;
struct V_5 V_107 = {
. V_108 = V_32 -> V_133 ,
...
int F_171 ( struct V_247 * V_248 , int V_250 , char T_8 * V_251 , unsigned int V_252 )
{
int V_204 ;
struct V_181 V_79 ;
struct V_216 V_63 ;
...
struct V_2 * V_2 = F_167 ( V_248 ) ;
struct V_1 * V_4 ;
V_4 = F_1 ( V_2 , F_172 ( V_248 ) -> V_253 ? : V_44 ) ;
if ( V_4 == NULL )
return - V_76 ;
if ( V_250 != V_254 ) {
if ( V_248 != V_4 -> V_212 && ! F_173 ( V_255 ) )
return - V_25 ;
}
switch ( V_250 ) {
case V_254 :
if ( V_248 -> V_256 != V_257 ||
F_174 ( V_248 ) -> V_258 != V_259 )
return - V_260 ;
if ( V_252 < sizeof( int ) )
return - V_27 ;
return F_166 ( V_4 , V_248 ) ;
case V_261 :
return F_169 ( V_248 ) ;
case V_262 :
if ( V_252 < sizeof( V_79 ) )
return - V_27 ;
if ( F_175 ( & V_79 , V_251 , sizeof( V_79 ) ) )
return - V_263 ;
if ( V_79 . V_184 >= V_180 )
return - V_243 ;
F_88 () ;
V_204 = F_113 ( V_2 , V_4 , & V_79 , V_248 == V_4 -> V_212 ) ;
F_87 () ;
return V_204 ;
case V_264 :
if ( V_252 < sizeof( T_6 ) )
return - V_27 ;
if ( F_175 ( & V_201 , V_251 , sizeof( T_6 ) ) )
return - V_263 ;
F_88 () ;
...
case V_265 :
case V_266 :
if ( V_252 < sizeof( V_63 ) )
return - V_27 ;
if ( F_175 ( & V_63 , V_251 , sizeof( V_63 ) ) )
return - V_263 ;
F_88 () ;
if ( V_250 == V_266 )
V_204 = F_144 ( V_4 , & V_63 ) ;
else
V_204 = F_164 ( V_2 , V_4 , & V_63 , V_248 == V_4 -> V_212 ) ;
F_87 () ;
return V_204 ;
case V_267 :
{
int V_78 ;
if ( F_176 ( V_78 , ( int T_8 * ) V_251 ) )
return - V_263 ;
V_4 -> V_268 = ! ! V_78 ;
return 0 ;
}
...
int F_177 ( struct V_247 * V_248 , int V_250 , char T_8 * V_251 ,
int T_8 * V_252 )
{
int V_274 ;
int V_275 ;
...
if ( F_176 ( V_274 , V_252 ) )
return - V_263 ;
V_274 = F_178 ( int , V_274 , sizeof( int ) ) ;
if ( V_274 < 0 )
return - V_27 ;
if ( F_179 ( V_274 , V_252 ) )
return - V_263 ;
if ( F_180 ( V_251 , & V_275 , V_274 ) )
return - V_263 ;
return 0 ;
}
int F_181 ( struct V_247 * V_248 , int V_277 , void T_8 * V_10 )
{
struct V_278 V_279 ;
struct V_280 V_281 ;
struct V_68 * V_79 ;
...
switch ( V_277 ) {
case V_282 :
if ( F_175 ( & V_281 , V_10 , sizeof( V_281 ) ) )
return - V_263 ;
if ( V_281 . V_201 >= V_4 -> V_71 )
return - V_27 ;
F_33 ( & V_64 ) ;
V_79 = & V_4 -> V_72 [ V_281 . V_201 ] ;
if ( F_39 ( V_4 , V_281 . V_201 ) ) {
V_281 . V_283 = V_79 -> V_83 ;
V_281 . V_284 = V_79 -> V_85 ;
V_281 . V_285 = V_79 -> V_82 ;
V_281 . V_286 = V_79 -> V_84 ;
F_35 ( & V_64 ) ;
if ( F_180 ( V_10 , & V_281 , sizeof( V_281 ) ) )
return - V_263 ;
return 0 ;
}
F_35 ( & V_64 ) ;
return - V_156 ;
case V_287 :
if ( F_175 ( & V_279 , V_10 , sizeof( V_279 ) ) )
return - V_263 ;
F_33 ( & V_64 ) ;
V_161 = F_115 ( V_4 , & V_279 . V_288 . V_218 , & V_279 . V_289 . V_218 ) ;
if ( V_161 ) {
V_279 . V_290 = V_161 -> V_94 . V_8 . V_95 ;
V_279 . V_291 = V_161 -> V_94 . V_8 . V_96 ;
V_279 . V_97 = V_161 -> V_94 . V_8 . V_97 ;
F_35 ( & V_64 ) ;
if ( F_180 ( V_10 , & V_279 , sizeof( V_279 ) ) )
return - V_263 ;
return 0 ;
}
F_35 ( & V_64 ) ;
...
int F_182 ( struct V_247 * V_248 , unsigned int V_277 , void T_8 * V_10 )
{
struct V_293 V_279 ;
struct V_294 V_281 ;
struct V_68 * V_79 ;
...
V_295 ) ;
F_186 ( F_61 ( F_136 ( V_32 ) -> V_81 ) , F_185 ( F_136 ( V_32 ) ) ,
V_296 , V_32 -> V_120 ) ;
return F_187 ( V_32 ) ;
}
...
V_79 -> V_85 ++ ;
V_79 -> V_84 += V_32 -> V_120 ;
if ( F_192 ( V_32 , sizeof( * V_297 ) + F_193 ( V_81 ) ) )
goto V_300;
V_297 = F_65 ( V_32 ) ;
V_297 -> V_301 -- ;
F_194 ( V_32 ) -> V_19 |= V_302 ;
return F_195 ( V_303 , V_304 , V_32 , V_32 -> V_81 , V_81 ,
F_183 ) ;
V_300:
F_78 ( V_32 ) ;
return 0 ;
}
static int F_196 ( struct V_1 * V_4 , struct V_105 * V_81 )
{
int V_65 ;
...
int V_306 ;
V_66 -> V_94 . V_8 . V_97 ++ ;
V_306 = F_196 ( V_4 , V_32 -> V_81 ) ;
if ( V_306 >= 0 && V_4 -> V_268 &&
( V_4 -> V_270 ||
...
if ( V_305 != - 1 ) {
struct V_31 * V_311 = F_197 ( V_32 , V_198 ) ;
if ( V_311 )
...
if ( V_66 == NULL ) {
int V_79 ;
V_79 = F_196 ( V_4 , V_32 -> V_81 ) ;
if ( V_79 >= 0 ) {
int V_12 = F_139 ( V_4 , V_79 , V_32 ) ;
F_35 ( & V_64 ) ;
return V_12 ;
}
F_35 ( & V_64 ) ;
...
F_199 ( V_32 , V_320 , V_4 -> V_72 [ V_161 -> V_93 ] . V_81 -> V_109 ) < 0 )
return - V_200 ;
V_319 = (struct V_318 * ) F_132 ( V_32 , F_200 ( 0 ) ) ;
for ( V_65 = V_161 -> V_94 . V_8 . V_98 ; V_65 < V_161 -> V_94 . V_8 . V_71 ; V_65 ++ ) {
if ( F_39 ( V_4 , V_65 ) && V_161 -> V_94 . V_8 . V_99 [ V_65 ] < 255 ) {
if ( F_201 ( V_32 ) < F_202 ( F_202 ( sizeof( * V_316 ) ) + 4 ) )
goto V_321;
V_316 = (struct V_315 * ) F_132 ( V_32 , F_202 ( sizeof( * V_316 ) ) ) ;
V_316 -> V_322 = 0 ;
...
V_81 = V_32 -> V_81 ;
if ( V_81 == NULL || ( V_79 = F_196 ( V_4 , V_81 ) ) < 0 ) {
F_35 ( & V_64 ) ;
return - V_312 ;
}
...
static int F_205 ( struct V_1 * V_4 , struct V_31 * V_32 ,
T_1 V_174 , T_1 V_74 , struct V_59 * V_161 )
{
struct V_167 * V_168 ;
struct V_313 * V_314 ;
V_168 = F_206 ( V_32 , V_174 , V_74 , V_345 , sizeof( * V_314 ) , V_346 ) ;
if ( V_168 == NULL )
return - V_200 ;
V_314 = F_207 ( V_168 ) ;
V_314 -> V_347 = V_348 ;
...
V_314 -> V_351 = 0 ;
V_314 -> V_352 = V_4 -> V_3 ;
if ( F_199 ( V_32 , V_353 , V_4 -> V_3 ) )
goto V_354;
V_314 -> V_355 = V_356 ;
V_314 -> V_357 = V_358 ;
V_314 -> V_342 = 0 ;
if ( F_208 ( V_32 , V_359 , 16 , & V_161 -> V_92 ) ||
F_208 ( V_32 , V_360 , 16 , & V_161 -> V_91 ) )
goto V_354;
...
static int V_241 ( struct V_31 * V_32 , struct V_361 * V_362 )
{
struct V_2 * V_2 = F_167 ( V_32 -> V_248 ) ;
struct V_1 * V_4 ;
struct V_59 * V_63 ;
