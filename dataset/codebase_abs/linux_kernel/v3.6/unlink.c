...
{
struct V_60 * V_2 = V_19 ;
F_14 ( V_2 -> V_61 ) -> F_60 ( V_18 , V_2 ) ;
}
static struct V_17 *
F_61 ( struct V_12 * V_61 , struct V_12 * V_62 ,
...
F_27 ( V_61 -> V_22 ) ;
F_14 ( V_2 -> V_61 ) -> F_66 ( & V_25 , V_61 ) ;
return F_32 ( & V_31 ) ;
}
int
F_67 ( struct V_12 * V_3 , struct V_6 * V_6 )
{
static unsigned int V_71 ;
const int V_72 = sizeof( F_68 ( V_6 -> V_43 ) ) * 2 ;
...
sprintf ( V_75 , L_3 ,
V_72 , V_72 ,
( unsigned long long ) F_68 ( V_6 -> V_43 ) ) ;
