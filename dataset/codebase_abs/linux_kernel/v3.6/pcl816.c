...
V_83 = V_67 -> V_69 ;
V_67 -> V_69 &= V_86 ;
if ( ! V_67 -> V_69 || V_83 != V_67 -> V_69 )
V_82 ++ ;
V_83 = V_67 -> V_70 ;
V_67 -> V_70 &= V_87 ;
if ( ! V_67 -> V_70 || V_83 != V_67 -> V_70 )
V_82 ++ ;
V_83 = V_67 -> V_71 ;
V_67 -> V_71 &= V_88 | V_89 ;
if ( ! V_67 -> V_71 || V_83 != V_67 -> V_71 )
V_82 ++ ;
V_83 = V_67 -> V_76 ;
V_67 -> V_76 &= V_90 ;
if ( ! V_67 -> V_76 || V_83 != V_67 -> V_76 )
V_82 ++ ;
V_83 = V_67 -> V_75 ;
V_67 -> V_75 &= V_90 | V_91 ;
if ( ! V_67 -> V_75 || V_83 != V_67 -> V_75 )
V_82 ++ ;
if ( V_82 )
return 1 ;
if ( V_67 -> V_71 != V_88 && V_67 -> V_71 != V_89 ) {
V_67 -> V_71 = V_89 ;
V_82 ++ ;
}
if ( V_67 -> V_75 != V_91 && V_67 -> V_75 != V_90 )
V_82 ++ ;
if ( V_82 )
return 2 ;
if ( V_67 -> V_72 != 0 ) {
...
F_31 ( V_2 , - 1 , 0 , 0 ) ;
V_99 = F_29 ( V_2 , V_4 , V_67 -> V_96 , V_67 -> V_79 ) ;
if ( V_99 < 1 )
return - V_100 ;
F_32 ( V_2 , V_4 , V_67 -> V_96 , V_99 ) ;
F_7 ( 1 ) ;
V_31 -> V_35 = V_67 -> V_79 ;
V_31 -> V_36 = 0 ;
V_4 -> V_26 -> V_34 = 0 ;
...
V_103 = F_36 ( V_31 -> V_46 ) ;
V_104 = F_36 ( V_31 -> V_46 ) ;
if ( V_103 == V_104 )
break;
}
if ( V_103 != V_104 ) {
...
static int F_41 ( unsigned long V_10 )
{
F_3 ( 0x00 , V_10 + V_14 ) ;
F_7 ( 1 ) ;
...
static void
F_31 ( struct V_1 * V_2 , int V_113 , unsigned int V_84 ,
unsigned int V_85 )
{
...
static int F_39 ( unsigned char V_124 )
{
unsigned char V_125 ;
unsigned long V_94 ;
if ( V_124 == 1 ) {
...
static int F_49 ( struct V_1 * V_2 , struct V_130 * V_131 )
{
const struct V_80 * V_81 = F_26 ( V_2 ) ;
int V_132 ;
unsigned long V_10 ;
...
V_132 = F_51 ( V_2 , sizeof( struct V_138 ) ) ;
if ( V_132 < 0 )
return V_132 ;
...
F_24 ( V_68 L_40 , V_46 ) ;
V_133 = 2 ;
V_31 -> V_53 [ 0 ] = F_57 ( V_152 , V_133 ) ;
if ( ! V_31 -> V_53 [ 0 ] ) {
F_24 ( L_41 ) ;
return - V_101 ;
}
V_31 -> V_153 [ 0 ] = V_133 ;
V_31 -> V_50 [ 0 ] = F_58 ( ( void * ) V_31 -> V_53 [ 0 ] ) ;
V_31 -> V_51 [ 0 ] = ( 1 << V_133 ) * V_154 ;
if ( V_31 -> V_141 == 0 ) {
V_31 -> V_53 [ 1 ] = F_57 ( V_152 , V_133 ) ;
if ( ! V_31 -> V_53 [ 1 ] ) {
F_24 ( V_137
L_42
L_43 ) ;
...
F_61 ( V_31 -> V_46 ) ;
if ( V_31 -> V_53 [ 0 ] )
F_62 ( V_31 -> V_53 [ 0 ] , V_31 -> V_153 [ 0 ] ) ;
if ( V_31 -> V_53 [ 1 ] )
F_62 ( V_31 -> V_53 [ 1 ] , V_31 -> V_153 [ 1 ] ) ;
#ifdef F_38
if ( V_31 -> V_149 )
F_63 ( V_31 -> V_149 , V_2 ) ;
