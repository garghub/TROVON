...
struct V_3 * F_76 ( unsigned int V_66 )
{
struct V_3 * V_3 ;
struct V_67 * V_68 = V_62 -> V_68 ;
F_77 () ;
V_3 = F_78 ( V_68 , V_66 ) ;
if ( V_3 ) {
if ( V_3 -> V_39 & V_52 ||
...
struct V_3 * F_81 ( unsigned int V_66 )
{
struct V_3 * V_3 ;
struct V_67 * V_68 = V_62 -> V_68 ;
F_77 () ;
...
struct V_3 * F_82 ( unsigned int V_66 , int * V_69 )
{
struct V_3 * V_3 ;
struct V_67 * V_68 = V_62 -> V_68 ;
* V_69 = 0 ;
...
struct V_3 * F_84 ( unsigned int V_66 , int * V_69 )
{
struct V_3 * V_3 ;
struct V_67 * V_68 = V_62 -> V_68 ;
* V_69 = 0 ;
...
static inline int F_86 ( struct V_3 * V_3 )
{
#ifdef F_87
return V_3 -> V_71 ;
#else
...
static inline void F_89 ( struct V_3 * V_3 , struct V_72 * V_73 )
{
struct V_74 * V_75 ;
#ifdef F_87
int V_76 ;
V_76 = F_88 () ;
V_3 -> V_71 = V_76 ;
V_75 = F_90 ( V_73 -> V_77 , V_76 ) ;
#else
V_75 = & V_73 -> V_77 ;
#endif
F_69 ( & V_3 -> V_5 . V_25 , V_75 ) ;
}
void F_91 ( struct V_3 * V_3 , struct V_72 * V_73 )
{
F_92 ( & V_78 ) ;
F_89 ( V_3 , V_73 ) ;
F_93 ( & V_78 ) ;
...
void F_96 ( struct V_72 * V_73 )
{
struct V_3 * V_4 ;
F_97 ( & V_78 ) ;
F_98 (sb, f) {
if ( ! F_99 ( V_4 -> V_34 . V_36 -> V_37 -> V_42 ) )
continue;
if ( ! F_100 ( V_4 ) )
continue;
if ( ! ( V_4 -> V_39 & V_41 ) )
...
void T_6 F_105 ( unsigned long V_80 )
{
unsigned long V_81 ;
V_8 = F_106 ( L_2 , sizeof( struct V_3 ) , 0 ,
V_82 | V_83 , NULL ) ;
V_81 = ( V_80 * ( V_84 / 1024 ) ) / 10 ;
V_10 . V_11 = F_107 (unsigned long, n, NR_FILE) ;
F_108 () ;
F_109 ( & V_78 , L_3 ) ;
F_110 ( & V_9 , 0 ) ;
}
