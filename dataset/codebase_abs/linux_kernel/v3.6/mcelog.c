...
V_24 . V_61 = V_60 [ V_15 ] . V_62 ;
V_24 . V_63 = V_24 . V_64 = V_60 [ V_15 ] . V_65 ;
V_24 . V_66 = ( V_67 ) V_60 [ V_15 ] . V_68 ;
V_24 . V_69 = V_60 [ V_15 ] . V_70 [ V_71 ] . V_72 ;
V_47 = NULL ;
F_19 ( & V_47 , V_45 , V_73 ) ;
if ( F_20 ( ! V_47 ) ) {
F_21 ( V_53 L_3 ) ;
...
V_88 . V_32 = V_90 ;
V_88 . V_91 = V_92 ;
F_24 ( V_88 . V_93 . V_94 . V_95 , & V_96 ) ;
do {
V_88 . V_93 . V_94 . V_40 = V_40 ;
V_89 = F_25 ( & V_88 ) ;
if ( V_89 ) {
F_26 ( V_53 L_4 ,
( V_40 == V_97 ) ?
...
if ( V_88 . V_93 . V_94 . V_40 & V_98 ||
V_88 . V_93 . V_94 . V_40 & V_99 )
break;
else {
V_89 = F_18 ( & V_96 ) ;
if ( V_89 )
...
L_7
L_8 ) ;
V_88 . V_93 . V_94 . V_40 = V_40 | V_100 ;
V_89 = F_25 ( & V_88 ) ;
if ( V_89 ) {
F_26 ( V_53
L_9 ) ;
...
static T_7 F_29 ( int V_104 , void * V_105 )
{
F_30 ( & V_106 ) ;
return V_107 ;
}
...
V_88 . V_32 = V_108 ;
V_88 . V_91 = V_92 ;
F_24 ( V_88 . V_93 . V_109 . V_110 , V_60 ) ;
V_89 = F_25 ( & V_88 ) ;
if ( V_89 ) {
F_26 ( V_53 L_13 ) ;
return V_89 ;
}
V_59 = V_88 . V_93 . V_109 . V_59 ;
V_60 = F_32 ( V_59 , sizeof( struct V_111 ) ,
V_112 ) ;
if ( ! V_60 )
return - V_113 ;
F_24 ( V_88 . V_93 . V_109 . V_110 , V_60 ) ;
