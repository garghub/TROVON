...
struct V_129 * F_98 ( struct V_6 * V_7 )
{
return V_7 -> V_46 ;
}
...
static struct V_134 * F_101 ( struct V_6 * V_7 ,
bool V_135 )
{
...
F_34 (dd, devices, list) {
V_137 = V_39 -> V_41 . V_48 -> V_138 ;
if ( ! F_102 ( V_137 ) )
goto V_139;
if ( ! V_135 && ! F_103 ( V_137 ) )
continue;
else if ( V_136 &&
F_104 ( V_136 , V_137 ) < 0 )
goto V_139;
...
struct V_21 * F_115 ( struct V_6 * V_7 , T_1 V_145 )
{
...
{
struct V_21 * V_76 ( V_55 ) ;
unsigned V_43 = 0 , V_146 = 0 ;
while ( V_43 < F_74 ( V_71 ) ) {
V_55 = F_75 ( V_71 , V_43 ++ ) ;
if ( ! V_55 -> type -> V_101 )
return false ;
V_55 -> type -> V_101 ( V_55 , F_116 , & V_146 ) ;
if ( V_146 )
return false ;
}
return true ;
...
T_1 V_56 , T_1 V_57 , void * V_58 )
{
unsigned V_149 = ( * ( unsigned * ) V_58 ) ;
struct V_59 * V_60 = F_47 ( V_47 -> V_48 ) ;
return V_60 && ( V_60 -> V_150 & V_149 ) ;
}
static bool F_122 ( struct V_6 * V_7 , unsigned V_149 )
{
struct V_21 * V_55 ;
unsigned V_43 = 0 ;
while ( V_43 < F_74 ( V_7 ) ) {
...
return 1 ;
if ( V_55 -> type -> V_101 &&
V_55 -> type -> V_101 ( V_55 , F_121 , & V_149 ) )
return 1 ;
}
return 0 ;
}
...
V_55 = F_75 ( V_7 , V_43 ++ ) ;
if ( ! V_55 -> type -> V_101 ||
! V_55 -> type -> V_101 ( V_55 , V_154 , NULL ) )
return 0 ;
}
return 1 ;
}
void F_129 ( struct V_6 * V_7 , struct V_59 * V_60 ,
struct V_61 * V_62 )
{
unsigned V_149 = 0 ;
V_60 -> V_62 = * V_62 ;
...
T_2 F_134 ( struct V_6 * V_7 )
{
return V_7 -> V_28 ;
}
static void F_135 ( struct V_6 * V_7 , unsigned V_162 )
{
int V_43 = V_7 -> V_23 ;
...
if ( V_162 ) {
if ( V_55 -> type -> V_162 )
V_55 -> type -> V_162 ( V_55 ) ;
} else if ( V_55 -> type -> V_163 )
V_55 -> type -> V_163 ( V_55 ) ;
V_55 ++ ;
}
}
...
void F_139 ( struct V_6 * V_7 , struct V_166 * V_167 )
{
F_59 ( & V_167 -> V_40 , & V_7 -> V_33 ) ;
}
int F_140 ( struct V_6 * V_7 , int V_168 )
{
struct V_38 * V_39 ;
struct V_35 * V_32 = F_90 ( V_7 ) ;
struct V_166 * V_167 ;
...
if ( V_167 -> V_170 )
V_53 |= V_167 -> V_170 ( V_167 , V_168 ) ;
return V_53 ;
}
int F_144 ( struct V_6 * V_7 )
{
unsigned V_43 ;
struct V_21 * V_55 ;
for ( V_43 = 0 ; V_43 < V_7 -> V_23 ; V_43 ++ ) {
V_55 = V_7 -> V_26 + V_43 ;
if ( V_55 -> type -> V_171 && V_55 -> type -> V_171 ( V_55 ) )
return 1 ;
}
return 0 ;
}
struct V_29 * F_145 ( struct V_6 * V_7 )
{
return V_7 -> V_30 ;
}
static int F_146 ( struct V_21 * V_55 , struct V_41 * V_47 ,
T_1 V_56 , T_1 V_57 , void * V_58 )
{
struct V_59 * V_60 = F_47 ( V_47 -> V_48 ) ;
return V_60 && F_147 ( V_60 ) ;
}
bool F_130 ( struct V_6 * V_7 )
{
struct V_21 * V_55 ;
unsigned V_43 = 0 ;
while ( V_43 < F_74 ( V_7 ) ) {
...
return 1 ;
if ( V_55 -> type -> V_101 &&
V_55 -> type -> V_101 ( V_55 , F_146 , NULL ) )
return 1 ;
}
return 0 ;
}
