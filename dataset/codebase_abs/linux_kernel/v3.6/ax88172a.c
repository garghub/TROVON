...
{
struct V_19 * V_6 = V_18 -> V_20 ;
F_19 ( V_18 -> V_7 , L_8 , V_6 -> V_34 -> V_39 ) ;
F_23 ( V_6 -> V_34 ) ;
F_20 ( V_6 -> V_34 -> V_44 ) ;
F_21 ( V_6 -> V_34 ) ;
}
int F_24 ( struct V_9 * V_7 , struct V_50 * V_12 )
{
if ( ! V_7 -> V_14 )
return - V_15 ;
return F_25 ( V_7 -> V_14 , V_12 ) ;
}
int F_26 ( struct V_9 * V_7 , struct V_50 * V_12 )
{
if ( ! V_7 -> V_14 )
return - V_15 ;
return F_27 ( V_7 -> V_14 , V_12 ) ;
}
int F_28 ( struct V_9 * V_7 )
{
if ( ! V_7 -> V_14 )
return - V_15 ;
...
F_32 ( 150 ) ;
V_80 = F_42 ( V_18 ) ;
F_11 ( V_18 -> V_7 , L_18 , V_80 ) ;
V_32 = F_43 ( V_18 , 0x0000 ) ;
if ( V_32 < 0 )
goto V_81;
V_80 = F_42 ( V_18 ) ;
F_11 ( V_18 -> V_7 , L_19 , V_80 ) ;
F_32 ( 150 ) ;
V_32 = F_44 ( V_18 , V_82 ,
V_83 | V_84 ,
V_85 , 0 , NULL ) ;
if ( V_32 < 0 ) {
F_16 ( V_18 -> V_7 , L_20 , V_32 ) ;
goto V_81;
}
