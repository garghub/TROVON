...
static void F_85 ( struct V_2 * V_3 , int V_120 )
{
struct V_14 * V_15 = (struct V_14 * ) V_3 -> V_121 ;
T_2 * V_122 = F_40 ( V_3 ) ;
F_8 ( L_22 ,
...
static struct V_151 * F_86 ( struct V_151 * V_152 )
{
struct V_14 * V_15 = F_7 ( V_152 , struct V_14 , V_17 ) ;
struct V_171 V_172 ;
...
L_27 ,
V_96 -> V_178 ,
F_90 ( sin , V_85 , sizeof( V_85 ) ) ) ;
}
F_8 ( L_28 , V_96 -> V_178 ,
F_90 ( sin , V_85 , sizeof( V_85 ) ) ) ;
V_173 -> V_3 -> V_180 = V_181 * 30 ;
if ( ! ( V_174 = F_91 ( V_96 , V_173 , & V_104 ,
( V_182 | V_183 ) ) ) )
goto V_179;
F_92 ( & V_174 -> V_17 , sin , V_58 ) ;
V_104 = F_93 ( V_173 , sin , & V_58 ) ;
if ( F_94 ( V_104 < 0 ) ) {
F_8 ( L_29 , - V_104 ) ;
V_58 = F_95 ( struct V_156 , V_184 ) ;
}
F_96 ( & V_174 -> V_17 , sin , V_58 ) ;
if ( V_96 -> V_147 )
V_96 -> V_147 -> V_185 ++ ;
return & V_174 -> V_17 ;
V_179:
...
static unsigned int F_98 ( struct V_14 * V_15 , struct V_9 * V_10 )
{
unsigned int V_113 , V_59 , V_186 ;
if ( V_15 -> V_187 <= sizeof( V_188 ) )
return 0 ;
V_59 = V_15 -> V_187 - sizeof( V_188 ) ;
V_186 = ( V_59 + V_63 - 1 ) >> V_189 ;
for ( V_113 = 0 ; V_113 < V_186 ; V_113 ++ ) {
if ( V_10 -> V_146 [ V_113 ] != NULL )
F_99 ( V_10 -> V_146 [ V_113 ] ) ;
F_2 ( V_15 -> V_190 [ V_113 ] == NULL ) ;
V_10 -> V_146 [ V_113 ] = V_15 -> V_190 [ V_113 ] ;
V_15 -> V_190 [ V_113 ] = NULL ;
}
V_10 -> V_142 . V_60 [ 0 ] . V_83 = F_100 ( V_10 -> V_146 [ 0 ] ) ;
return V_59 ;
}
...
V_186 = ( V_59 + V_63 - 1 ) >> V_189 ;
for ( V_113 = 0 ; V_113 < V_186 ; V_113 ++ ) {
V_15 -> V_190 [ V_113 ] = V_10 -> V_146 [ V_113 ] ;
...
if ( V_15 -> V_187 < sizeof( V_188 ) ) {
struct V_106 V_107 ;
V_191 = sizeof( V_188 ) - V_15 -> V_187 ;
V_107 . V_83 = ( ( char * ) & V_15 -> V_192 ) + V_15 -> V_187 ;
V_107 . V_61 = V_191 ;
if ( ( V_59 = F_33 ( V_10 , & V_107 , 1 , V_191 ) ) < 0 )
goto error;
V_15 -> V_187 += V_59 ;
if ( V_59 < V_191 ) {
F_8 ( L_30
...
V_15 -> V_192 &= V_195 ;
F_8 ( L_33 , V_15 -> V_192 ) ;
if ( V_15 -> V_192 > V_96 -> V_134 ) {
F_105 ( L_34 ,
( unsigned long ) V_15 -> V_192 ) ;
goto V_194;
}
}
if ( V_15 -> V_192 < 8 )
...
memcpy ( & V_200 -> V_208 , & V_200 -> V_209 , sizeof( struct V_41 ) ) ;
V_202 = & V_200 -> V_208 . V_60 [ 0 ] ;
V_201 = & V_10 -> V_142 . V_60 [ 0 ] ;
if ( V_202 -> V_61 < V_201 -> V_61 )
return - V_136 ;
memcpy ( V_202 -> V_83 , V_201 -> V_83 , V_201 -> V_61 ) ;
F_108 ( V_200 -> V_210 , V_15 -> V_192 ) ;
V_10 -> V_142 . V_59 = 0 ;
return 0 ;
}
static int F_109 ( struct V_106 * V_211 , struct V_43 * * V_51 , int V_59 )
{
int V_113 = 0 ;
int V_212 = 0 ;
while ( V_212 < V_59 ) {
V_211 [ V_113 ] . V_83 = F_100 ( V_51 [ V_113 ] ) ;
V_211 [ V_113 ] . V_61 = V_63 ;
V_113 ++ ;
V_212 += V_63 ;
}
return V_113 ;
...
goto error;
V_52 = F_98 ( V_15 , V_10 ) ;
V_191 = V_15 -> V_192 - V_52 ;
V_211 = V_10 -> V_214 ;
V_213 = F_109 ( & V_211 [ 0 ] , & V_10 -> V_146 [ 0 ] ,
V_15 -> V_192 ) ;
V_10 -> V_84 = & V_10 -> V_146 [ V_213 ] ;
V_59 = F_35 ( V_10 , V_211 , V_213 , V_191 , V_52 ) ;
if ( V_59 >= 0 )
V_15 -> V_187 += V_59 ;
if ( V_59 != V_191 ) {
F_101 ( V_15 , V_10 ) ;
...
goto V_215;
F_8 ( L_39 ,
V_15 -> V_187 , V_15 -> V_192 ) ;
goto V_216;
}
V_10 -> V_142 . V_59 = V_15 -> V_192 ;
V_10 -> V_142 . V_53 = 0 ;
...
V_15 -> V_192 = 0 ;
V_15 -> V_187 = 0 ;
if ( F_31 ( V_15 ) > sizeof( V_188 ) )
F_42 ( V_125 , & V_15 -> V_17 . V_124 ) ;
if ( V_59 < 0 )
goto error;
F_111 ( V_10 , & V_15 -> V_17 ) ;
if ( V_96 -> V_147 )
V_96 -> V_147 -> V_218 ++ ;
...
{
struct V_41 * V_219 = & V_10 -> V_149 ;
int V_220 ;
T_3 V_221 ;
V_221 = F_113 ( 0x80000000 | ( ( V_219 -> V_59 ) - 4 ) ) ;
memcpy ( V_219 -> V_60 [ 0 ] . V_83 , & V_221 , 4 ) ;
V_220 = F_17 ( V_10 , & V_10 -> V_149 ) ;
if ( V_220 != V_219 -> V_59 ) {
F_82 ( V_206
L_43
L_44 ,
V_10 -> V_16 -> V_131 -> V_178 ,
( V_220 < 0 ) ? L_45 : L_46 ,
V_220 , V_219 -> V_59 ) ;
...
{
struct V_106 * V_222 = & V_10 -> V_149 . V_60 [ 0 ] ;
F_115 ( V_222 , 0 ) ;
}
...
int V_56 )
{
return F_76 ( V_96 , V_217 , V_155 , V_157 , V_158 , V_56 ) ;
}
static struct V_151 * F_118 ( struct V_95 * V_96 ,
struct V_155 * V_155 ,
struct V_156 * V_157 , int V_158 ,
int V_56 )
{
return F_119 ( V_96 , V_217 , V_155 , V_157 , V_158 , V_56 ) ;
}
...
static void F_127 ( struct V_14 * V_15 , struct V_95 * V_96 )
{
struct V_2 * V_3 = V_15 -> V_18 ;
F_78 ( F_79 ( V_15 -> V_65 -> V_3 ) , & V_225 ,
& V_15 -> V_17 , V_96 ) ;
F_42 ( V_163 , & V_15 -> V_17 . V_124 ) ;
if ( V_3 -> V_167 == V_168 ) {
F_8 ( L_47 ) ;
F_42 ( V_223 , & V_15 -> V_17 . V_124 ) ;
V_3 -> V_164 = F_81 ;
F_42 ( V_169 , & V_15 -> V_17 . V_124 ) ;
} else {
F_8 ( L_48 ) ;
...
V_15 -> V_192 = 0 ;
V_15 -> V_187 = 0 ;
memset ( & V_15 -> V_190 [ 0 ] , 0 , sizeof( V_15 -> V_190 ) ) ;
F_128 ( V_3 ) -> V_227 |= V_228 ;
F_42 ( V_125 , & V_15 -> V_17 . V_124 ) ;
if ( V_3 -> V_167 != V_229 )
F_42 ( V_170 , & V_15 -> V_17 . V_124 ) ;
}
}
void F_129 ( struct V_95 * V_96 )
{
struct V_14 * V_15 ;
F_25 ( & V_96 -> V_100 ) ;
F_26 (svsk, &serv->sv_permsocks, sk_xprt.xpt_list)
...
static struct V_14 * F_91 ( struct V_95 * V_96 ,
struct V_1 * V_2 ,
int * V_230 , int V_56 )
{
struct V_14 * V_15 ;
struct V_2 * V_231 ;
int V_232 = ! ( V_56 & V_182 ) ;
F_8 ( L_49 , V_2 ) ;
if ( ! ( V_15 = F_130 ( sizeof( * V_15 ) , V_233 ) ) ) {
* V_230 = - V_176 ;
return NULL ;
}
V_231 = V_2 -> V_3 ;
if ( * V_230 >= 0 && V_232 )
* V_230 = F_131 ( V_96 , F_79 ( V_2 -> V_3 ) , V_231 -> V_4 ,
V_231 -> V_88 ,
F_132 ( F_22 ( V_231 ) -> V_234 ) ) ;
if ( * V_230 < 0 ) {
F_133 ( V_15 ) ;
return NULL ;
}
...
V_15 -> V_65 = V_2 ;
V_15 -> V_18 = V_231 ;
V_15 -> V_235 = V_231 -> V_226 ;
V_15 -> V_236 = V_231 -> V_164 ;
V_15 -> V_237 = V_231 -> V_119 ;
if ( V_2 -> type == V_238 )
F_77 ( V_15 , V_96 ) ;
else {
...
int F_134 ( struct V_95 * V_96 , const int V_239 , char * V_240 ,
const T_1 V_59 )
{
int V_104 = 0 ;
struct V_1 * V_241 = F_135 ( V_239 , & V_104 ) ;
struct V_14 * V_15 = NULL ;
if ( ! V_241 )
return V_104 ;
if ( ( V_241 -> V_3 -> V_4 != V_89 ) && ( V_241 -> V_3 -> V_4 != V_92 ) )
V_104 = - V_137 ;
else if ( V_241 -> V_3 -> V_88 != V_217 &&
V_241 -> V_3 -> V_88 != V_73 )
V_104 = - V_242 ;
else if ( V_241 -> V_243 > V_244 )
V_104 = - V_245 ;
else {
if ( ! F_136 ( V_246 ) )
V_104 = - V_102 ;
else
V_15 = F_91 ( V_96 , V_241 , & V_104 ,
V_247 ) ;
if ( V_15 ) {
struct V_171 V_172 ;
struct V_156 * sin = (struct V_156 * ) & V_172 ;
int V_158 ;
if ( F_93 ( V_15 -> V_65 , sin , & V_158 ) == 0 )
F_96 ( & V_15 -> V_17 , sin , V_158 ) ;
F_50 ( V_248 , & V_15 -> V_17 . V_124 ) ;
F_25 ( & V_96 -> V_100 ) ;
F_137 ( & V_15 -> V_17 . V_249 , & V_96 -> V_250 ) ;
F_28 ( & V_96 -> V_100 ) ;
F_138 ( & V_15 -> V_17 ) ;
V_104 = 0 ;
} else
...
int type ;
struct V_171 V_172 ;
struct V_156 * V_252 = (struct V_156 * ) & V_172 ;
int V_253 ;
int V_254 ;
int V_255 ;
F_18 (char buf[RPC_MAX_ADDRBUFLEN]) ;
F_8 ( L_51 ,
V_96 -> V_256 -> V_257 , V_251 ,
F_90 ( sin , V_85 , sizeof( V_85 ) ) ) ;
if ( V_251 != V_73 && V_251 != V_217 ) {
F_82 ( V_177 L_52
L_53 ) ;
return F_141 ( - V_258 ) ;
}
type = ( V_251 == V_73 ) ? V_238 : V_259 ;
switch ( sin -> V_260 ) {
case V_8 :
V_254 = V_92 ;
break;
...
error = F_142 ( V_155 , V_254 , type , V_251 , & V_2 , 1 ) ;
if ( error < 0 )
return F_141 ( error ) ;
F_1 ( V_2 ) ;
V_255 = 1 ;
...
if ( type == V_259 )
V_2 -> V_3 -> V_262 = V_263 ;
error = F_143 ( V_2 , sin , V_59 ) ;
if ( error < 0 )
goto V_264;
V_253 = V_59 ;
error = F_93 ( V_2 , V_252 , & V_253 ) ;
if ( error < 0 )
goto V_264;
if ( V_251 == V_217 ) {
if ( ( error = F_144 ( V_2 , 64 ) ) < 0 )
goto V_264;
}
if ( ( V_15 = F_91 ( V_96 , V_2 , & error , V_56 ) ) != NULL ) {
F_96 ( & V_15 -> V_17 , V_252 , V_253 ) ;
...
static void F_145 ( struct V_151 * V_152 )
{
struct V_14 * V_15 = F_7 ( V_152 , struct V_14 , V_17 ) ;
struct V_2 * V_3 = V_15 -> V_18 ;
T_2 * V_122 ;
F_8 ( L_55 , V_15 ) ;
V_3 -> V_226 = V_15 -> V_235 ;
V_3 -> V_164 = V_15 -> V_236 ;
V_3 -> V_119 = V_15 -> V_237 ;
V_122 = F_40 ( V_3 ) ;
if ( V_122 && F_44 ( V_122 ) )
F_45 ( V_122 ) ;
}
...
if ( ! F_41 ( V_223 , & V_152 -> V_124 ) ) {
F_102 ( V_15 ) ;
F_147 ( V_15 -> V_65 , V_265 ) ;
}
}
static void F_148 ( struct V_151 * V_152 )
{
struct V_14 * V_15 = F_7 ( V_152 , struct V_14 , V_17 ) ;
F_8 ( L_57 , V_15 ) ;
if ( V_15 -> V_65 -> V_266 )
...
static struct V_151 * F_119 ( struct V_95 * V_96 ,
int V_251 ,
struct V_155 * V_155 ,
struct V_156 * sin , int V_59 ,
int V_56 )
...
V_15 = F_130 ( sizeof( * V_15 ) , V_233 ) ;
if ( ! V_15 )
return F_141 ( - V_176 ) ;
V_152 = & V_15 -> V_17 ;
F_78 ( V_155 , & V_224 , V_152 , V_96 ) ;
V_96 -> V_267 = V_152 ;
return V_152 ;
}
static void F_149 ( struct V_151 * V_152 )
{
if ( V_152 )
F_133 ( F_7 ( V_152 , struct V_14 , V_17 ) ) ;
}
