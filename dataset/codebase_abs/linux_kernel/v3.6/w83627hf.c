...
if ( ! F_87 ( V_18 , V_97 -> V_99 , V_100 , V_88 ) ) {
F_79 ( V_18 , L_22 ,
( unsigned long ) V_97 -> V_99 ,
( unsigned long ) ( V_97 -> V_99 + V_100 - 1 ) ) ;
return - V_101 ;
}
V_25 = F_88 ( V_18 , sizeof( struct V_24 ) , V_102 ) ;
if ( ! V_25 )
return - V_103 ;
V_25 -> V_76 = V_97 -> V_99 ;
V_25 -> type = V_77 -> type ;
...
V_25 -> V_47 = F_95 () ;
if ( ( V_30 = F_94 ( V_18 , & V_136 ) )
|| ( V_30 = F_94 ( V_18 , & V_137 ) ) )
goto error;
}
if ( V_25 -> type == V_34 || V_25 -> type == V_35
|| V_25 -> type == V_36 ) {
V_30 = F_94 ( V_18 , & V_138 . V_108 ) ;
if ( V_30 )
goto error;
}
...
V_25 -> V_143 = F_96 ( V_18 ) ;
if ( F_97 ( V_25 -> V_143 ) ) {
V_30 = F_98 ( V_25 -> V_143 ) ;
goto error;
}
return 0 ;
error:
F_99 ( & V_18 -> V_105 , & V_106 ) ;
F_99 ( & V_18 -> V_105 , & V_144 ) ;
return V_30 ;
}
static int T_9 F_100 ( struct V_93 * V_94 )
{
struct V_24 * V_25 = F_101 ( V_94 ) ;
F_102 ( V_25 -> V_143 ) ;
F_99 ( & V_94 -> V_18 . V_105 , & V_106 ) ;
F_99 ( & V_94 -> V_18 . V_105 , & V_144 ) ;
return 0 ;
}
static inline void F_103 ( struct V_24 * V_25 , T_4 V_3 )
{
if ( ( V_3 & 0x00f0 ) == 0x50 ) {
F_104 ( V_145 , V_25 -> V_76 + V_146 ) ;
F_104 ( V_3 >> 8 , V_25 -> V_76 + V_147 ) ;
}
}
...
int V_97 , V_148 ;
F_26 ( & V_25 -> V_104 ) ;
V_148 = ( ( ( V_3 & 0xff00 ) == 0x100 )
|| ( ( V_3 & 0xff00 ) == 0x200 ) )
&& ( ( ( V_3 & 0x00ff ) == 0x50 )
|| ( ( V_3 & 0x00ff ) == 0x53 )
|| ( ( V_3 & 0x00ff ) == 0x55 ) ) ;
F_103 ( V_25 , V_3 ) ;
F_104 ( V_3 & 0xff , V_25 -> V_76 + V_146 ) ;
V_97 = F_106 ( V_25 -> V_76 + V_147 ) ;
if ( V_148 ) {
F_104 ( ( V_3 & 0xff ) + 1 ,
V_25 -> V_76 + V_146 ) ;
V_97 =
( V_97 << 8 ) + F_106 ( V_25 -> V_76 +
V_147 ) ;
}
F_105 ( V_25 , V_3 ) ;
F_30 ( & V_25 -> V_104 ) ;
...
static int T_8 F_107 ( struct V_93 * V_94 )
{
struct V_1 * V_77 = V_94 -> V_18 . V_95 ;
int V_97 = 0xff , V_149 ;
F_6 ( V_77 ) ;
F_5 ( V_77 , V_150 ) ;
if ( ! ( F_3 ( V_77 , V_151 ) & ( 1 << 3 ) ) ) {
F_108 ( & V_94 -> V_18 , L_23 ) ;
goto exit;
}
V_149 = F_3 ( V_77 , V_152 ) & 0x3f ;
if ( ( V_149 & 0x1f ) != 0x1f ) {
F_108 ( & V_94 -> V_18 , L_24
L_25 ) ;
goto exit;
}
F_109 ( & V_94 -> V_18 , L_26 ) ;
V_97 = F_3 ( V_77 , V_153 ) & V_149 ;
exit:
F_7 ( V_77 ) ;
return V_97 ;
}
static int T_8 F_110 ( struct V_93 * V_94 )
{
struct V_1 * V_77 = V_94 -> V_18 . V_95 ;
int V_97 = 0xff ;
F_6 ( V_77 ) ;
F_5 ( V_77 , V_89 ) ;
if ( ! ( F_3 ( V_77 , V_154 ) & ( 1 << 2 ) ) ) {
F_108 ( & V_94 -> V_18 , L_27 ) ;
goto exit;
}
if ( ! ( F_3 ( V_77 , V_155 ) & ( 1 << 4 ) ) ) {
F_108 ( & V_94 -> V_18 , L_28
L_29 ) ;
goto exit;
}
V_97 = F_3 ( V_77 , V_156 ) & 0x3f ;
exit:
F_7 ( V_77 ) ;
return V_97 ;
}
static int F_28 ( struct V_24 * V_25 , T_4 V_3 , T_4 V_157 )
{
int V_148 ;
F_26 ( & V_25 -> V_104 ) ;
V_148 = ( ( ( V_3 & 0xff00 ) == 0x100 )
...
struct V_24 * V_25 = F_101 ( V_94 ) ;
int V_16 ;
enum V_158 type = V_25 -> type ;
T_1 V_41 ;
F_28 ( V_25 , V_159 , 0x89 ) ;
F_28 ( V_25 , V_160 , V_161 ) ;
if ( type == V_64 || type == V_35 ) {
int V_162 = F_65 ( V_25 , V_58 ) ;
int V_163 = F_65 ( V_25 , V_164 ) ;
V_25 -> V_46 = ( V_162 & 0x0f ) | ( ( V_163 & 0x01 ) << 4 ) ;
} else if ( type == V_34 ) {
V_25 -> V_46 = F_107 ( V_94 ) ;
} else if ( type == V_36 ) {
V_25 -> V_46 = F_110 ( V_94 ) ;
}
...
{
struct V_24 * V_25 = F_24 ( V_18 ) ;
int V_16 , V_170 = ( V_25 -> type == V_85 ) ? 2 : 3 ;
int V_171 = ( V_25 -> type == V_85 ) ? 2 : 3 ;
F_26 ( & V_25 -> V_31 ) ;
if ( F_111 ( V_172 , V_25 -> V_173 + V_174 + V_174 / 2 )
|| ! V_25 -> V_175 ) {
...
static int T_6 F_114 ( unsigned short V_180 ,
const struct V_1 * V_77 )
{
struct V_96 V_97 = {
. V_99 = V_180 + V_181 ,
. V_182 = V_180 + V_181 + V_100 - 1 ,
. V_75 = V_88 ,
. V_183 = V_98 ,
} ;
int V_30 ;
...
if ( V_30 )
goto exit;
V_94 = F_116 ( V_88 , V_180 ) ;
if ( ! V_94 ) {
V_30 = - V_103 ;
F_117 ( L_34 ) ;
goto exit;
}
V_30 = F_118 ( V_94 , & V_97 , 1 ) ;
if ( V_30 ) {
F_117 ( L_35 , V_30 ) ;
goto V_184;
}
V_30 = F_119 ( V_94 , V_77 ,
sizeof( struct V_1 ) ) ;
if ( V_30 ) {
F_117 ( L_36 ) ;
goto V_184;
...
struct V_1 V_77 ;
if ( F_81 ( 0x2e , & V_180 , & V_77 )
&& F_81 ( 0x4e , & V_180 , & V_77 ) )
return - V_78 ;
V_30 = F_123 ( & V_185 ) ;
if ( V_30 )
goto exit;
V_30 = F_114 ( V_180 , & V_77 ) ;
if ( V_30 )
goto V_186;
return 0 ;
V_186:
