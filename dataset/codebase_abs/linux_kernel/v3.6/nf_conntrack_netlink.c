...
{
F_114 (nfnetlink_parse_nat_setup_hook) V_201 ;
V_201 = F_21 ( V_202 ) ;
if ( ! V_201 ) {
#ifdef F_115
F_11 () ;
...
V_203 = V_23 -> V_25 ^ V_25 ;
if ( V_203 & ( V_72 | V_204 | V_205 ) )
return - V_206 ;
if ( V_203 & V_207 && ! ( V_25 & V_207 ) )
return - V_206 ;
if ( V_203 & V_208 && ! ( V_25 & V_208 ) )
return - V_206 ;
V_23 -> V_25 |= V_25 & ~ ( V_209 | V_210 ) ;
return 0 ;
}
static int
...
if ( V_23 -> V_216 )
return - V_206 ;
V_124 = F_96 ( V_171 [ V_40 ] , & V_215 , & V_177 ) ;
if ( V_124 < 0 )
return V_124 ;
if ( ! strcmp ( V_215 , L_2 ) ) {
if ( V_36 && V_36 -> V_38 ) {
...
V_38 = F_124 ( V_215 , F_17 ( V_23 ) ,
F_18 ( V_23 ) ) ;
if ( V_38 == NULL ) {
#ifdef F_115
F_85 ( & V_156 ) ;
if ( F_117 ( L_3 , V_215 ) < 0 ) {
F_78 ( & V_156 ) ;
return - V_175 ;
}
F_78 ( & V_156 ) ;
...
struct V_8 * V_164 [ V_219 + 1 ] ;
struct V_5 * V_6 ;
int V_124 = 0 ;
F_87 ( V_164 , V_219 , V_163 , V_220 ) ;
F_8 () ;
V_6 = F_10 ( F_17 ( V_23 ) , F_18 ( V_23 ) ) ;
if ( V_6 -> V_217 )
V_124 = V_6 -> V_217 ( V_164 , V_23 ) ;
F_11 () ;
return V_124 ;
}
static inline int
F_128 ( struct V_74 * V_75 , const struct V_8 * const V_163 )
{
struct V_8 * V_171 [ V_221 + 1 ] ;
F_87 ( V_171 , V_221 , V_163 , V_222 ) ;
if ( ! V_171 [ V_76 ] )
return - V_170 ;
V_75 -> V_77 =
...
{
int V_124 ;
if ( V_171 [ V_213 ] || V_171 [ V_211 ] || V_171 [ V_73 ] )
return - V_175 ;
if ( V_171 [ V_40 ] ) {
...
static struct V_22 *
F_132 ( struct V_122 * V_122 , T_4 V_174 ,
const struct V_8 * const V_171 [] ,
struct V_3 * V_223 ,
struct V_3 * V_224 ,
T_5 V_183 )
...
struct V_37 * V_38 ;
struct V_57 * V_58 ;
V_23 = F_133 ( V_122 , V_174 , V_223 , V_224 , V_135 ) ;
if ( F_134 ( V_23 ) )
return F_135 ( - V_195 ) ;
if ( ! V_171 [ V_30 ] )
goto V_225;
...
#endif
memset ( & V_23 -> V_227 , 0 , sizeof( V_23 -> V_227 ) ) ;
if ( V_171 [ V_33 ] ) {
V_124 = F_127 ( V_23 , V_171 ) ;
if ( V_124 < 0 )
goto V_226;
...
struct V_149 * V_228 ;
struct V_22 * V_229 ;
V_124 = F_91 ( V_171 , & V_216 , V_73 , V_183 ) ;
if ( V_124 < 0 )
goto V_226;
V_228 = F_101 ( V_122 , V_174 , & V_216 ) ;
if ( V_228 == NULL ) {
V_124 = - V_184 ;
goto V_226;
}
V_229 = F_81 ( V_228 ) ;
F_141 ( V_230 , & V_23 -> V_25 ) ;
V_23 -> V_216 = V_229 ;
}
V_58 = F_31 ( V_23 ) ;
if ( V_58 )
...
static int
F_146 ( struct V_181 * V_182 , struct V_1 * V_2 ,
const struct V_95 * V_96 ,
const struct V_8 * const V_171 [] )
{
struct V_122 * V_122 = F_77 ( V_182 ) ;
struct V_3 V_223 , V_224 ;
...
return V_124 ;
if ( V_171 [ V_109 ] ) {
V_124 = F_91 ( V_171 , & V_223 , V_109 , V_183 ) ;
if ( V_124 < 0 )
return V_124 ;
}
if ( V_171 [ V_110 ] ) {
V_124 = F_91 ( V_171 , & V_224 , V_110 , V_183 ) ;
if ( V_124 < 0 )
return V_124 ;
}
if ( V_171 [ V_109 ] )
V_150 = F_101 ( V_122 , V_174 , & V_223 ) ;
else if ( V_171 [ V_110 ] )
V_150 = F_101 ( V_122 , V_174 , & V_224 ) ;
if ( V_150 == NULL ) {
V_124 = - V_184 ;
if ( V_96 -> V_188 & V_130 ) {
enum V_231 V_119 ;
V_23 = F_132 ( V_122 , V_174 , V_171 , & V_223 ,
& V_224 , V_183 ) ;
if ( F_134 ( V_23 ) )
return F_147 ( V_23 ) ;
V_124 = 0 ;
if ( F_148 ( V_230 , & V_23 -> V_25 ) )
V_119 = V_129 ;
else
V_119 = V_128 ;
F_149 ( ( 1 << V_232 ) |
...
static int
F_150 ( struct V_1 * V_2 , T_2 V_94 , T_2 V_85 ,
T_6 V_235 , const struct V_236 * V_237 )
{
struct V_95 * V_96 ;
struct V_97 * V_98 ;
unsigned int V_99 = V_94 ? V_100 : 0 , V_101 ;
...
V_98 -> V_105 = V_239 ;
V_98 -> V_106 = V_107 ;
V_98 -> V_108 = F_50 ( V_235 ) ;
if ( F_13 ( V_2 , V_240 , F_14 ( V_237 -> V_241 ) ) ||
F_13 ( V_2 , V_242 , F_14 ( V_237 -> V_243 ) ) ||
F_13 ( V_2 , V_244 , F_14 ( V_237 -> V_245 ) ) ||
F_13 ( V_2 , V_246 , F_14 ( V_237 -> V_247 ) ) ||
F_13 ( V_2 , V_248 , F_14 ( V_237 -> V_249 ) ) ||
F_13 ( V_2 , V_250 , F_14 ( V_237 -> V_251 ) ) ||
F_13 ( V_2 , V_252 , F_14 ( V_237 -> V_253 ) ) ||
F_13 ( V_2 , V_254 , F_14 ( V_237 -> V_255 ) ) ||
F_13 ( V_2 , V_256 ,
F_14 ( V_237 -> V_257 ) ) ||
F_13 ( V_2 , V_258 , F_14 ( V_237 -> V_259 ) ) ||
F_13 ( V_2 , V_260 , F_14 ( V_237 -> V_261 ) ) ||
F_13 ( V_2 , V_262 , F_14 ( V_237 -> error ) ) ||
F_13 ( V_2 , V_263 ,
F_14 ( V_237 -> V_264 ) ) )
goto V_12;
F_51 ( V_2 , V_96 ) ;
...
static int
F_151 ( struct V_1 * V_2 , struct V_144 * V_145 )
{
int V_235 ;
struct V_122 * V_122 = F_77 ( V_2 -> V_147 ) ;
if ( V_145 -> args [ 0 ] == V_265 )
return 0 ;
for ( V_235 = V_145 -> args [ 0 ] ; V_235 < V_265 ; V_235 ++ ) {
const struct V_236 * V_237 ;
if ( ! F_152 ( V_235 ) )
continue;
V_237 = F_153 ( V_122 -> V_23 . V_266 , V_235 ) ;
if ( F_150 ( V_2 ,
F_82 ( V_145 -> V_2 ) . V_94 ,
V_145 -> V_96 -> V_161 ,
V_235 , V_237 ) < 0 )
...
static int
F_154 ( struct V_181 * V_182 , struct V_1 * V_2 ,
const struct V_95 * V_96 ,
const struct V_8 * const V_171 [] )
{
if ( V_96 -> V_188 & V_189 ) {
...
static int
F_155 ( struct V_1 * V_2 , T_2 V_94 , T_2 V_85 , T_2 type ,
struct V_122 * V_122 )
{
struct V_95 * V_96 ;
struct V_97 * V_98 ;
unsigned int V_99 = V_94 ? V_100 : 0 , V_101 ;
unsigned int V_267 = F_43 ( & V_122 -> V_23 . V_268 ) ;
V_101 = ( V_102 << 8 | V_269 ) ;
V_96 = F_45 ( V_2 , V_94 , V_85 , V_101 , sizeof( * V_98 ) , V_99 ) ;
if ( V_96 == NULL )
goto V_104;
...
static int
F_156 ( struct V_181 * V_182 , struct V_1 * V_2 ,
const struct V_95 * V_96 ,
const struct V_8 * const V_171 [] )
{
struct V_1 * V_187 ;
...
if ( V_187 == NULL )
return - V_195 ;
V_124 = F_155 ( V_187 , F_82 ( V_2 ) . V_94 ,
V_96 -> V_161 ,
F_83 ( V_96 -> V_162 ) ,
F_77 ( V_2 -> V_147 ) ) ;
if ( V_124 <= 0 )
...
static int
F_158 ( struct V_1 * V_2 , struct V_22 * V_23 )
{
struct V_8 * V_9 ;
F_8 () ;
V_9 = F_2 ( V_2 , V_109 | V_11 ) ;
...
static int
F_159 ( const struct V_8 * V_171 [] , struct V_22 * V_23 )
{
int V_124 ;
if ( V_171 [ V_30 ] ) {
V_124 = F_125 ( V_23 , V_171 ) ;
...
static int
F_160 ( const struct V_8 * V_163 , struct V_22 * V_23 )
{
struct V_8 * V_171 [ V_272 + 1 ] ;
int V_7 ;
F_87 ( V_171 , V_272 , V_163 , V_273 ) ;
F_78 ( & V_156 ) ;
V_7 = F_159 ( ( const struct V_8 * * ) V_171 , V_23 ) ;
F_85 ( & V_156 ) ;
return V_7 ;
}
static inline int
...
memcpy ( & V_276 . V_20 . V_183 , & V_159 -> V_20 . V_183 , sizeof( V_276 . V_20 . V_183 ) ) ;
V_276 . V_20 . V_277 . V_278 = V_159 -> V_20 . V_277 . V_278 ;
V_276 . V_14 . V_15 = V_4 -> V_14 . V_15 ;
V_9 = F_2 ( V_2 , V_279 | V_11 ) ;
if ( ! V_9 )
goto V_12;
F_8 () ;
V_18 = F_9 ( V_4 -> V_20 . V_21 ) ;
V_7 = F_6 ( V_2 , & V_276 , V_18 ) ;
if ( V_7 >= 0 ) {
V_6 = F_10 ( V_4 -> V_20 . V_21 ,
V_4 -> V_14 . V_15 ) ;
V_7 = F_1 ( V_2 , & V_276 , V_6 ) ;
}
F_11 () ;
if ( F_163 ( V_7 < 0 ) )
goto V_12;
...
const struct V_280 * exp )
{
struct V_22 * V_216 = exp -> V_216 ;
...
if ( V_26 < 0 )
V_26 = 0 ;
if ( F_161 ( V_2 , & exp -> V_4 , V_284 ) < 0 )
goto V_12;
if ( F_162 ( V_2 , & exp -> V_4 , & exp -> V_159 ) < 0 )
goto V_12;
if ( F_161 ( V_2 ,
& V_216 -> V_285 [ V_86 ] . V_4 ,
V_286 ) < 0 )
goto V_12;
#ifdef F_63
if ( exp -> V_287 || exp -> V_288 . V_278 ) {
V_9 = F_2 ( V_2 , V_289 | V_11 ) ;
if ( ! V_9 )
goto V_12;
if ( F_13 ( V_2 , V_290 , F_14 ( exp -> V_46 ) ) )
goto V_12;
V_281 . V_20 . V_21 = F_17 ( V_216 ) ;
V_281 . V_20 . V_183 . V_291 = exp -> V_287 ;
V_281 . V_14 . V_15 = F_18 ( V_216 ) ;
V_281 . V_20 . V_277 = exp -> V_288 ;
if ( F_161 ( V_2 , & V_281 ,
V_292 ) < 0 )
goto V_12;
F_5 ( V_2 , V_9 ) ;
...
#endif
if ( F_13 ( V_2 , V_293 , F_14 ( V_26 ) ) ||
F_13 ( V_2 , V_294 , F_14 ( ( unsigned long ) exp ) ) ||
F_13 ( V_2 , V_295 , F_14 ( exp -> V_99 ) ) ||
F_13 ( V_2 , V_296 , F_14 ( exp -> V_297 ) ) )
goto V_12;
V_36 = F_20 ( V_216 ) ;
if ( V_36 ) {
struct V_37 * V_38 ;
V_38 = F_21 ( V_36 -> V_38 ) ;
if ( V_38 &&
F_22 ( V_2 , V_298 , V_38 -> V_42 ) )
goto V_12;
}
V_283 = F_165 ( exp -> V_299 ) ;
if ( V_283 != NULL &&
F_22 ( V_2 , V_300 , V_283 -> V_42 ) )
goto V_12;
return 0 ;
V_12:
return - 1 ;
...
static int
F_166 ( struct V_1 * V_2 , T_2 V_94 , T_2 V_85 ,
int V_101 , const struct V_280 * exp )
{
struct V_95 * V_96 ;
struct V_97 * V_98 ;
...
static int
F_167 ( unsigned int V_119 , struct V_302 * V_121 )
{
struct V_280 * exp = V_121 -> exp ;
struct V_122 * V_122 = F_168 ( exp ) ;
struct V_95 * V_96 ;
struct V_97 * V_98 ;
struct V_1 * V_2 ;
...
static int F_169 ( struct V_144 * V_145 )
{
if ( V_145 -> args [ 1 ] )
F_170 ( (struct V_280 * ) V_145 -> args [ 1 ] ) ;
return 0 ;
}
static int
F_171 ( struct V_1 * V_2 , struct V_144 * V_145 )
{
struct V_122 * V_122 = F_77 ( V_2 -> V_147 ) ;
struct V_280 * exp , * V_148 ;
struct V_97 * V_98 = F_46 ( V_145 -> V_96 ) ;
struct V_309 * V_152 ;
V_116 V_18 = V_98 -> V_105 ;
F_8 () ;
V_148 = (struct V_280 * ) V_145 -> args [ 1 ] ;
for (; V_145 -> args [ 0 ] < V_310 ; V_145 -> args [ 0 ] ++ ) {
V_158:
F_172 (exp, n, &net->ct.expect_hash[cb->args[0]],
hnode) {
...
static int
F_174 ( struct V_181 * V_182 , struct V_1 * V_2 ,
const struct V_95 * V_96 ,
const struct V_8 * const V_171 [] )
{
struct V_122 * V_122 = F_77 ( V_182 ) ;
...
V_124 = F_92 ( V_171 [ V_311 ] , & V_174 ) ;
if ( V_124 < 0 )
return V_124 ;
if ( V_171 [ V_284 ] )
V_124 = F_91 ( V_171 , & V_4 , V_284 , V_183 ) ;
else if ( V_171 [ V_286 ] )
V_124 = F_91 ( V_171 , & V_4 , V_286 , V_183 ) ;
else
return - V_170 ;
if ( V_124 < 0 )
return V_124 ;
exp = F_175 ( V_122 , V_174 , & V_4 ) ;
if ( ! exp )
return - V_184 ;
if ( V_171 [ V_294 ] ) {
T_7 V_185 = F_103 ( V_171 [ V_294 ] ) ;
...
F_8 () ;
V_124 = F_166 ( V_187 , F_82 ( V_2 ) . V_94 ,
V_96 -> V_161 , V_307 , exp ) ;
F_11 () ;
F_170 ( exp ) ;
if ( V_124 <= 0 )
goto free;
...
static int
F_176 ( struct V_181 * V_182 , struct V_1 * V_2 ,
const struct V_95 * V_96 ,
const struct V_8 * const V_171 [] )
{
struct V_122 * V_122 = F_77 ( V_182 ) ;
...
hnode) {
V_314 = F_20 ( exp -> V_216 ) ;
if ( ! strcmp ( V_314 -> V_38 -> V_42 , V_42 ) &&
F_104 ( & exp -> V_26 ) ) {
F_177 ( exp ,
F_82 ( V_2 ) . V_94 ,
F_100 ( V_96 ) ) ;
...
static int
F_179 ( struct V_280 * V_315 ,
const struct V_8 * const V_171 [] )
{
if ( V_171 [ V_293 ] ) {
if ( ! F_104 ( & V_315 -> V_26 ) )
return - V_218 ;
V_315 -> V_26 . V_27 = V_28 +
F_102 ( F_103 ( V_171 [ V_293 ] ) ) * V_29 ;
F_126 ( & V_315 -> V_26 ) ;
}
return 0 ;
}
static int
F_180 ( const struct V_8 * V_163 ,
struct V_280 * exp ,
V_116 V_183 )
{
#ifdef F_63
struct V_8 * V_164 [ V_316 + 1 ] ;
struct V_3 V_281 = {} ;
int V_124 ;
F_87 ( V_164 , V_316 , V_163 , V_317 ) ;
if ( ! V_164 [ V_290 ] || ! V_164 [ V_292 ] )
return - V_170 ;
V_124 = F_91 ( ( const struct V_8 * const * ) V_164 ,
& V_281 , V_292 , V_183 ) ;
if ( V_124 < 0 )
return V_124 ;
exp -> V_287 = V_281 . V_20 . V_183 . V_291 ;
exp -> V_288 = V_281 . V_20 . V_277 ;
exp -> V_46 = F_102 ( F_103 ( V_164 [ V_290 ] ) ) ;
return 0 ;
#else
return - V_175 ;
#endif
...
static int
F_181 ( struct V_122 * V_122 , T_4 V_174 ,
const struct V_8 * const V_171 [] ,
V_116 V_183 ,
T_2 V_94 , int V_134 )
{
...
if ( V_124 < 0 )
return V_124 ;
V_124 = F_91 ( V_171 , & V_159 , V_279 , V_183 ) ;
if ( V_124 < 0 )
return V_124 ;
V_124 = F_91 ( V_171 , & F_37 , V_286 , V_183 ) ;
if ( V_124 < 0 )
return V_124 ;
...
V_23 = F_81 ( V_150 ) ;
if ( V_171 [ V_298 ] ) {
const char * V_215 = F_97 ( V_171 [ V_298 ] ) ;
V_38 = F_124 ( V_215 , F_17 ( V_23 ) ,
F_18 ( V_23 ) ) ;
if ( V_38 == NULL ) {
#ifdef F_115
...
exp -> V_26 . V_27 =
V_28 + F_102 ( F_103 ( V_171 [ V_293 ] ) ) * V_29 ;
exp -> V_99 = V_319 ;
if ( V_171 [ V_295 ] ) {
exp -> V_99 |=
F_102 ( F_103 ( V_171 [ V_295 ] ) ) ;
}
} else {
if ( V_171 [ V_295 ] ) {
exp -> V_99 = F_102 ( F_103 ( V_171 [ V_295 ] ) ) ;
exp -> V_99 &= ~ V_319 ;
} else
exp -> V_99 = 0 ;
}
if ( V_171 [ V_300 ] ) {
const char * V_42 = F_97 ( V_171 [ V_300 ] ) ;
struct V_282 * V_283 ;
V_283 = F_183 ( V_42 ) ;
if ( V_283 == NULL ) {
V_124 = - V_170 ;
...
exp -> V_159 . V_20 . V_277 . V_278 = V_159 . V_20 . V_277 . V_278 ;
if ( V_171 [ V_289 ] ) {
V_124 = F_180 ( V_171 [ V_289 ] ,
exp , V_183 ) ;
if ( V_124 < 0 )
goto V_320;
}
V_124 = F_184 ( exp , V_94 , V_134 ) ;
V_320:
F_170 ( exp ) ;
V_39:
F_74 ( F_81 ( V_150 ) ) ;
...
static int
F_185 ( struct V_181 * V_182 , struct V_1 * V_2 ,
const struct V_95 * V_96 ,
const struct V_8 * const V_171 [] )
{
struct V_122 * V_122 = F_77 ( V_182 ) ;
...
return V_124 ;
F_78 ( & V_156 ) ;
exp = F_186 ( V_122 , V_174 , & V_4 ) ;
if ( ! exp ) {
F_85 ( & V_156 ) ;
V_124 = - V_184 ;
if ( V_96 -> V_188 & V_130 ) {
V_124 = F_181 ( V_122 , V_174 , V_171 ,
V_183 ,
F_82 ( V_2 ) . V_94 ,
F_100 ( V_96 ) ) ;
}
...
V_124 = - V_234 ;
if ( ! ( V_96 -> V_188 & V_131 ) )
V_124 = F_179 ( exp , V_171 ) ;
F_85 ( & V_156 ) ;
return V_124 ;
}
static int
F_187 ( struct V_1 * V_2 , T_2 V_94 , T_2 V_85 , int V_235 ,
const struct V_236 * V_237 )
{
struct V_95 * V_96 ;
struct V_97 * V_98 ;
...
V_98 -> V_106 = V_107 ;
V_98 -> V_108 = F_50 ( V_235 ) ;
if ( F_13 ( V_2 , V_322 , F_14 ( V_237 -> V_323 ) ) ||
F_13 ( V_2 , V_324 , F_14 ( V_237 -> V_325 ) ) ||
F_13 ( V_2 , V_326 , F_14 ( V_237 -> V_327 ) ) )
goto V_12;
F_51 ( V_2 , V_96 ) ;
return V_2 -> V_67 ;
V_12:
...
static int
F_188 ( struct V_1 * V_2 , struct V_144 * V_145 )
{
int V_235 ;
struct V_122 * V_122 = F_77 ( V_2 -> V_147 ) ;
if ( V_145 -> args [ 0 ] == V_265 )
...
continue;
V_237 = F_153 ( V_122 -> V_23 . V_266 , V_235 ) ;
if ( F_187 ( V_2 , F_82 ( V_145 -> V_2 ) . V_94 ,
V_145 -> V_96 -> V_161 ,
V_235 , V_237 ) < 0 )
break;
}
...
static int
F_189 ( struct V_181 * V_182 , struct V_1 * V_2 ,
const struct V_95 * V_96 ,
const struct V_8 * const V_171 [] )
{
if ( V_96 -> V_188 & V_189 ) {
...
static int T_8 F_190 ( struct V_122 * V_122 )
{
#ifdef F_191
int V_7 ;
V_7 = F_192 ( V_122 , & V_328 ) ;
if ( V_7 < 0 ) {
F_193 ( L_4 ) ;
goto V_320;
}
V_7 = F_194 ( V_122 , & V_329 ) ;
if ( V_7 < 0 ) {
F_193 ( L_5 ) ;
goto V_330;
}
...
static void F_196 ( struct V_122 * V_122 )
{
#ifdef F_191
F_197 ( V_122 , & V_329 ) ;
F_195 ( V_122 , & V_328 ) ;
...
static void T_9 F_198 ( struct V_331 * V_332 )
{
struct V_122 * V_122 ;
F_199 (net, net_exit_list, exit_list)
F_196 ( V_122 ) ;
}
