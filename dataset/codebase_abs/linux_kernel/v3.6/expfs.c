...
V_43 = 2 ;
V_64 -> V_67 . V_45 = V_16 -> V_40 ;
V_64 -> V_67 . V_68 = V_16 -> V_69 ;
if ( V_21 ) {
V_64 -> V_67 . V_70 = V_21 -> V_40 ;
V_64 -> V_67 . V_71 = V_21 -> V_69 ;
V_43 = 4 ;
type = V_72 ;
}
* V_65 = V_43 ;
...
int F_28 ( struct V_3 * V_3 , struct V_64 * V_64 , int * V_65 ,
int V_73 )
{
...
if ( V_73 && ! F_23 ( V_16 -> V_55 ) ) {
V_18 = F_11 ( V_3 ) ;
V_21 = V_18 -> V_19 ;
}
if ( V_8 -> V_74 )
error = V_8 -> V_74 ( V_16 , V_64 -> V_75 , V_65 , V_21 ) ;
else
error = F_27 ( V_16 , V_64 , V_65 , V_21 ) ;
F_8 ( V_18 ) ;
return error ;
}
struct V_3 * F_29 ( struct V_1 * V_2 , struct V_64 * V_64 ,
int V_76 , int V_77 ,
int (* F_3)( void * , struct V_3 * ) , void * V_14 )
{
const struct V_7 * V_8 = V_2 -> V_31 -> V_10 ;
struct V_3 * V_13 , * V_78 ;
char V_25 [ V_79 + 1 ] ;
int V_27 ;
if ( ! V_8 || ! V_8 -> V_80 )
return F_14 ( - V_28 ) ;
V_13 = V_8 -> V_80 ( V_2 -> V_31 , V_64 , V_76 , V_77 ) ;
if ( ! V_13 )
V_13 = F_14 ( - V_28 ) ;
if ( F_17 ( V_13 ) )
return V_13 ;
...
struct V_3 * V_24 , * V_82 ;
V_78 = F_2 ( V_13 , F_3 , V_14 ) ;
if ( V_78 )
return V_78 ;
V_27 = - V_28 ;
if ( ! V_8 -> V_83 )
goto V_81;
V_24 = V_8 -> V_83 ( V_2 -> V_31 , V_64 ,
V_76 , V_77 ) ;
if ( ! V_24 )
goto V_81;
V_27 = F_18 ( V_24 ) ;
