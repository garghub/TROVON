...
int F_81 ( struct V_9 * V_10 , V_62 * V_213 , int type )
{
int V_83 = - V_84 ;
T_1 V_214 = 0xffff ;
struct V_14 * V_15 = F_3 ( V_10 ) ;
struct V_215 * V_216 = & V_15 -> V_20 . V_216 ;
switch ( type ) {
case V_217 :
V_214 = V_216 -> V_218 ;
break;
...
F_82 ( V_216 -> V_221 ) ) {
* V_213 = ( ( V_62 ) V_214 << 48 ) |
( ( V_62 ) V_216 -> V_221 [ 0 ] << 40 ) |
( ( V_62 ) V_216 -> V_221 [ 1 ] << 32 ) |
( ( V_62 ) V_216 -> V_221 [ 2 ] << 24 ) |
( ( V_62 ) V_216 -> V_221 [ 3 ] << 16 ) |
( ( V_62 ) V_216 -> V_221 [ 4 ] << 8 ) |
( ( V_62 ) V_216 -> V_221 [ 5 ] ) ;
V_83 = 0 ;
}
return V_83 ;
...
if ( ! V_223 )
return - V_84 ;
if ( V_20 -> V_216 . type != V_226 &&
V_20 -> V_216 . type != V_227 )
return - V_84 ;
snprintf ( V_223 -> V_228 , sizeof( V_223 -> V_228 ) ,
L_17 ) ;
V_224 = F_84 ( V_15 -> V_29 , V_229 ) ;
if ( V_224 ) {
V_224 += 4 ;
for ( V_39 = 0 ; V_39 < 8 ; V_39 ++ )
F_85 ( V_15 -> V_29 , V_224 + V_39 , & V_225 [ V_39 ] ) ;
snprintf ( V_223 -> V_230 , sizeof( V_223 -> V_230 ) ,
L_18 ,
V_225 [ 7 ] , V_225 [ 6 ] , V_225 [ 5 ] , V_225 [ 4 ] ,
V_225 [ 3 ] , V_225 [ 2 ] , V_225 [ 1 ] , V_225 [ 0 ] ) ;
} else
snprintf ( V_223 -> V_230 , sizeof( V_223 -> V_230 ) ,
L_19 ) ;
snprintf ( V_223 -> V_231 ,
sizeof( V_223 -> V_231 ) ,
L_20 , V_20 -> V_232 ) ;
snprintf ( V_223 -> V_233 ,
sizeof( V_223 -> V_233 ) ,
L_21 ,
V_234 ,
V_235 ) ;
snprintf ( V_223 -> V_236 ,
sizeof( V_223 -> V_236 ) ,
L_22 ,
( V_15 -> V_237 << 16 ) |
V_15 -> V_238 ) ;
if ( V_20 -> V_216 . type == V_226 ) {
snprintf ( V_223 -> V_239 ,
sizeof( V_223 -> V_239 ) ,
L_23 ) ;
} else {
snprintf ( V_223 -> V_239 ,
...
{
#ifdef F_87
return F_88 ( V_15 -> V_10 , V_15 -> V_13 . V_242 ) ;
#else
return 0 ;
#endif
}
