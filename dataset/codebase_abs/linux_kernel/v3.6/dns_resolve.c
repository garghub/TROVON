...
struct V_26 * V_27 ;
struct V_11 * * V_68 ;
V_27 = F_44 ( sizeof( struct V_26 ) , V_21 ) ;
if ( V_27 == NULL )
goto V_69;
V_68 = F_44 ( V_70 * sizeof( struct V_11 * ) ,
V_21 ) ;
if ( V_68 == NULL )
goto V_71;
V_27 -> V_72 = V_73 ,
...
static int F_50 ( struct V_84 * V_85 , unsigned long V_86 ,
void * V_87 )
{
struct V_88 * V_89 = V_87 ;
struct V_1 * V_1 = V_89 -> V_90 ;
struct V_62 * V_63 = F_42 ( V_1 , V_64 ) ;
struct V_26 * V_27 = V_63 -> V_65 ;
int V_7 = 0 ;
if ( V_27 == NULL )
