...
F_119 ( V_20 -> V_35 , V_196 , V_11 ) ;
F_120 ( V_20 -> V_35 -> V_204 . V_205 ,
F_121 ( & V_20 -> V_35 -> V_38 ) , V_196 ,
V_11 ) ;
...
F_122 ( & V_20 -> F_12 -> V_37 -> V_38 . V_208 ,
V_209 ) ;
return ;
}
F_106 ( V_20 , V_196 ) ;
}
static T_6 F_123 ( struct V_210 * V_208 ,
struct V_211 * V_118 ,
int V_212 )
{
struct V_35 * V_38 = F_26 ( V_208 , struct V_35 , V_208 ) ;
struct V_59 * V_213 = F_124 ( V_38 ) ;
struct V_19 * V_20 = F_125 ( V_213 ) ;
T_1 V_1 = V_20 -> V_1 ;
bool V_214 ;
if ( V_20 -> V_50 ) {
if ( V_118 == & V_215 . V_118 )
V_214 = true ;
else if ( V_118 == & V_216 . V_118 )
V_214 = false ;
else
goto V_217;
return V_214 ;
...
V_214 = ! F_4 ( V_1 , V_96 , NULL ) ;
} else if ( V_118 == & V_219 . V_118 ) {
V_214 = ! F_4 ( V_1 , V_98 , NULL ) ;
} else if ( V_118 == & V_220 . V_118 ) {
V_214 = ! F_4 ( V_1 , V_149 , NULL ) ;
} else if ( V_118 == & V_221 . V_118 ) {
V_214 =
! F_4 ( V_20 -> V_1 , V_145 , NULL ) ;
} else if ( V_118 == & V_222 . V_118 ) {
V_214 = ! F_4 ( V_20 -> V_1 , V_147 , NULL ) ;
} else if ( V_118 == & V_223 . V_118 ) {
V_214 = ! F_4 ( V_1 , V_137 , NULL ) ;
} else if ( V_118 == & V_215 . V_118 ||
V_118 == & V_216 . V_118 ) {
V_214 = ! F_4 ( V_1 , V_152 , NULL ) &&
! F_4 ( V_1 , V_154 , NULL ) ;
} else if ( V_118 == & V_224 . V_118 ) {
V_214 = V_20 -> V_50 ;
} else if ( V_118 == & V_225 . V_118 ) {
V_214 = ! F_4 ( V_1 , V_167 , NULL ) &&
! F_4 ( V_1 , V_168 , NULL ) &&
! F_4 ( V_1 , V_165 , NULL ) ;
} else {
V_214 = true ;
}
return V_214 ? V_118 -> V_226 : 0 ;
}
static int F_126 ( struct V_19 * V_20 )
{
int V_157 ;
V_20 -> V_59 = F_127 ( V_113 , - 1 ) ;
if ( ! V_20 -> V_59 )
return - V_51 ;
F_128 ( V_20 -> V_59 , V_20 ) ;
V_157 = F_129 ( V_20 -> V_59 ) ;
if ( V_157 )
goto V_227;
V_157 = F_130 ( & V_20 -> V_59 -> V_38 . V_208 ,
& V_228 ) ;
if ( V_157 )
goto V_229;
return 0 ;
...
{
F_134 ( & V_20 -> V_59 -> V_38 . V_208 , & V_228 ) ;
F_135 ( V_20 -> V_59 ) ;
}
static int F_136 ( struct V_19 * V_20 )
{
struct V_4 V_158 = { V_159 , NULL } ;
union V_8 * V_230 = NULL ;
unsigned long long V_231 , V_232 ;
char * string = NULL ;
T_2 V_10 ;
V_10 = F_137 ( V_233 , 1 , & V_20 -> V_126 ) ;
if ( F_31 ( V_10 ) )
F_6 ( L_63 ) ;
if ( F_1 ( V_20 -> V_1 , L_64 , 0 , & V_158 ) ) {
F_54 ( L_65 ) ;
return - V_17 ;
}
V_10 =
F_10 ( V_20 -> V_1 , L_66 , NULL , & V_231 ) ;
if ( F_31 ( V_10 ) )
F_6 ( L_67 ) ;
else if ( V_231 )
F_138 ( L_68 ,
( V_125 ) V_231 ) ;
if ( F_3 ( V_20 -> V_1 , L_69 , V_234 ) )
F_54 ( L_70 , V_234 ) ;
if ( V_158 . V_12 ) {
V_230 = V_158 . V_12 ;
switch ( V_230 -> type ) {
case V_235 :
string = V_230 -> string . V_12 ;
break;
case V_236 :
string = V_230 -> V_158 . V_12 ;
break;
default:
string = L_71 ;
break;
...
F_138 ( L_72 , string ) ;
V_10 =
F_10 ( V_20 -> V_1 , L_22 , NULL , & V_232 ) ;
if ( ! F_31 ( V_10 ) )
F_138 ( L_73 , ( int ) V_232 ) ;
if ( ! F_4 ( V_20 -> V_1 , V_142 , NULL ) )
V_20 -> V_140 = true ;
F_140 ( V_230 ) ;
return V_15 ;
}
static int T_7 F_141 ( struct V_19 * V_20 )
{
int V_157 = 0 ;
V_157 = F_142 ( V_20 -> V_35 ) ;
if ( V_157 )
return V_157 ;
if ( ! V_20 -> V_35 -> V_10 . V_238 ) {
F_54 ( L_74 ) ;
return - V_17 ;
}
V_157 = F_136 ( V_20 ) ;
...
if ( ! strcmp ( V_97 , L_75 ) )
V_20 -> V_97 = V_95 ;
else if ( ! strcmp ( V_97 , L_76 ) )
V_20 -> V_97 = V_183 ;
if ( ! strcmp ( V_94 , L_75 ) )
V_20 -> V_94 = V_95 ;
else if ( ! strcmp ( V_94 , L_76 ) )
V_20 -> V_94 = V_183 ;
if ( V_239 >= 0 )
F_68 ( V_20 , ! ! V_239 ) ;
if ( V_240 >= 0 )
...
if ( ! V_230 )
return;
if ( strncmp ( V_230 , L_77 , 6 ) == 0 ) {
V_240 = - 1 ;
}
}
static int T_7 F_145 ( struct V_202 * V_35 )
{
struct V_19 * V_20 ;
int V_157 ;
F_138 ( L_78 ,
V_124 ) ;
V_20 = F_146 ( sizeof( struct V_19 ) , V_237 ) ;
if ( ! V_20 )
return - V_51 ;
V_20 -> V_1 = V_35 -> V_1 ;
strcpy ( F_147 ( V_35 ) , V_245 ) ;
strcpy ( F_148 ( V_35 ) , V_246 ) ;
V_35 -> V_247 = V_20 ;
V_20 -> V_35 = V_35 ;
F_143 () ;
V_157 = F_141 ( V_20 ) ;
...
static int F_150 ( struct V_202 * V_35 , int type )
{
struct V_19 * V_20 = F_118 ( V_35 ) ;
F_57 ( V_20 ) ;
F_98 ( V_20 ) ;
