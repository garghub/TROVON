...
void F_208 ( int V_234 , struct V_74 * V_75 )
{
...
T_8 int F_211 ( int V_234 , struct V_74 * V_96 )
{
struct V_255 * V_256 = F_212 () ;
...
F_213 ( 1 ) ;
#endif
F_214 ( V_263 ) . V_264 = V_96 -> V_264 ;
F_214 ( V_263 ) . V_265 = V_96 -> V_265 ;
if ( V_258 != V_266 )
F_214 ( V_263 ) . V_264 &= ~ 0x10 ;
else
F_214 ( V_263 ) . V_264 |= 0x10 ;
}
if ( V_258 == V_266 ) {
