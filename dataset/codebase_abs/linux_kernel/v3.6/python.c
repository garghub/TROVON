...
if ( V_124 == NULL )
return F_3 () ;
V_28 = F_59 ( V_109 , V_6 , & V_2 -> V_125 , false ) ;
if ( V_28 )
return F_60 ( V_103 ,
L_73 , V_28 ) ;
return V_124 ;
...
if ( V_55 -- == 0 )
break;
return F_23 ( L_70 , F_66 ( V_126 , struct V_64 , V_98 ) ) ;
}
...
T_1 * V_53 ;
int V_55 ;
T_1 * V_128 , * V_129 = F_69 ( L_69 , V_130 ) ;
if ( V_129 == NULL ||
F_12 () < 0 ||
F_67 () < 0 ||
F_40 () < 0 ||
...
return;
F_39 ( & V_127 ) ;
F_70 ( V_129 , L_74 , ( T_1 * ) & V_127 ) ;
F_39 ( & V_105 ) ;
F_70 ( V_129 , L_75 , ( T_1 * ) & V_105 ) ;
F_39 ( & V_63 ) ;
F_70 ( V_129 , L_76 , ( T_1 * ) & V_63 ) ;
F_39 ( & V_57 ) ;
F_70 ( V_129 , L_77 , ( T_1 * ) & V_57 ) ;
V_128 = F_71 ( V_129 ) ;
if ( V_128 == NULL )
goto error;
for ( V_55 = 0 ; V_131 [ V_55 ] . V_132 != NULL ; V_55 ++ ) {
V_53 = F_72 ( V_131 [ V_55 ] . V_133 ) ;
if ( V_53 == NULL )
goto error;
F_73 ( V_128 , V_131 [ V_55 ] . V_132 , V_53 ) ;
F_54 ( V_53 ) ;
}
error:
if ( F_74 () )
