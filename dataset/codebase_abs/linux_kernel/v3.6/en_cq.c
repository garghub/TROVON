...
NULL ;
#endif
V_2 -> V_20 = V_13 -> V_30 [ V_6 -> V_31 ] ;
V_2 -> V_32 . V_33 = V_2 -> V_21 . V_34 . V_34 ;
V_2 -> V_32 . V_35 = V_2 -> V_21 . V_34 . V_34 + 1 ;
* V_2 -> V_32 . V_33 = 0 ;
* V_2 -> V_32 . V_35 = 0 ;
memset ( V_2 -> V_23 , 0 , V_2 -> V_16 ) ;
if ( V_2 -> V_18 == V_36 ) {
if ( V_13 -> V_20 -> V_37 . V_38 ) {
if ( ! V_2 -> V_39 ) {
sprintf ( V_26 , L_1 , V_6 -> V_20 -> V_26 ,
V_2 -> V_9 ) ;
if ( F_9 ( V_13 -> V_20 , V_26 , V_28 ,
& V_2 -> V_39 ) ) {
V_2 -> V_39 = ( V_2 -> V_9 + 1 + V_6 -> V_31 )
% V_13 -> V_20 -> V_37 . V_40 ;
F_10 ( V_13 , L_2
L_3 ,
V_26 ) ;
...
if ( ! V_2 -> V_18 )
V_2 -> V_15 = V_6 -> V_43 [ V_2 -> V_9 ] . V_44 ;
V_14 = F_11 ( V_13 -> V_20 , V_2 -> V_15 , & V_2 -> V_21 . V_45 , & V_13 -> V_46 ,
V_2 -> V_21 . V_34 . V_47 , & V_2 -> V_32 , V_2 -> V_39 , 0 ) ;
if ( V_14 )
return V_14 ;
V_2 -> V_32 . V_48 = V_2 -> V_18 ? V_49 : V_50 ;
V_2 -> V_32 . V_4 = F_1 ;
if ( ! V_2 -> V_18 ) {
F_12 ( V_2 -> V_20 , & V_2 -> V_51 , V_52 , 64 ) ;
F_13 ( & V_2 -> V_51 ) ;
}
return 0 ;
}
...
F_15 ( & V_2 -> V_21 . V_23 ) ;
F_6 ( V_13 -> V_20 , & V_2 -> V_21 , V_2 -> V_16 ) ;
if ( V_6 -> V_13 -> V_20 -> V_37 . V_38 && V_2 -> V_39 )
F_16 ( V_6 -> V_13 -> V_20 , V_2 -> V_39 ) ;
V_2 -> V_39 = 0 ;
V_2 -> V_16 = 0 ;
V_2 -> V_23 = NULL ;
}
...
F_20 ( V_6 -> V_13 -> V_20 , & V_2 -> V_32 ) ;
}
int F_21 ( struct V_5 * V_6 , struct V_7 * V_2 )
{
return F_22 ( V_6 -> V_13 -> V_20 , & V_2 -> V_32 ,
V_2 -> V_53 , V_2 -> V_54 ) ;
}
int F_23 ( struct V_5 * V_6 , struct V_7 * V_2 )
{
F_24 ( & V_2 -> V_32 , V_55 , V_6 -> V_13 -> V_56 ,
& V_6 -> V_13 -> V_57 ) ;
return 0 ;
}
