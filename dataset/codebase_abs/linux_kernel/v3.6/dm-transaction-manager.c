...
if ( V_4 < 0 )
return V_4 ;
V_4 = F_24 ( V_2 -> V_21 , V_36 , V_32 , V_33 ) ;
if ( V_4 ) {
F_28 ( V_37 ) ;
return V_4 ;
}
memcpy ( F_29 ( * V_33 ) , F_29 ( V_37 ) ,
F_30 ( V_2 -> V_21 ) ) ;
F_28 ( V_37 ) ;
return V_4 ;
}
...
return F_33 ( V_2 -> V_21 , V_35 , V_32 , V_33 ) ;
...
{
if ( V_2 -> V_26 )
return F_36 ( V_2 -> V_27 -> V_21 , V_3 , V_32 , V_39 ) ;
return F_27 ( V_2 -> V_21 , V_3 , V_32 , V_39 ) ;
}
int F_37 ( struct V_1 * V_2 , struct V_29 * V_3 )
{
return F_28 ( V_3 ) ;
}
...
if ( V_2 -> V_26 )
return - V_28 ;
return F_43 ( V_2 -> V_23 , V_3 , V_33 ) ;
}
struct V_20 * F_44 ( struct V_1 * V_2 )
{
return V_2 -> V_21 ;
}
...
int F_54 ( struct V_20 * V_21 , T_1 V_40 ,
struct V_1 * * V_2 ,
struct V_22 * * V_23 )
{
return F_45 ( V_21 , V_40 , V_2 , V_23 , 1 , NULL , 0 ) ;
}
...
struct V_22 * * V_23 )
{
return F_45 ( V_21 , V_40 , V_2 , V_23 , 0 , V_42 , V_45 ) ;
}
