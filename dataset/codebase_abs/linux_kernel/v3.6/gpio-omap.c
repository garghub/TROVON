...
static void F_68 ( struct V_72 * V_5 , unsigned V_20 , int V_95 )
{
struct V_1 * V_2 ;
unsigned long V_55 ;
V_2 = F_39 ( V_5 , struct V_1 , V_5 ) ;
...
static int F_69 ( struct V_72 * V_5 , unsigned V_20 )
{
struct V_1 * V_2 ;
V_2 = F_39 ( V_5 , struct V_1 , V_5 ) ;
return V_2 -> V_4 + V_20 ;
}
static void T_3 F_70 ( struct V_1 * V_2 )
{
static bool V_96 ;
T_2 V_97 ;
if ( V_96 || V_2 -> V_11 -> V_98 == V_99 )
return;
V_97 = F_71 ( V_2 -> V_6 + V_2 -> V_11 -> V_98 ) ;
F_72 ( L_2 ,
