...
V_72 = V_70 -> V_79 ;
V_70 -> V_79 &= V_80 ;
if ( ! V_70 -> V_79 || V_72 != V_70 -> V_79 )
V_71 ++ ;
V_72 = V_70 -> V_81 ;
V_70 -> V_81 &= V_80 | V_82 ;
if ( ! V_70 -> V_81 || V_72 != V_70 -> V_81 )
V_71 ++ ;
if ( V_71 )
return 1 ;
if ( V_70 -> V_75 != V_76 &&
V_70 -> V_75 != V_77 )
V_71 ++ ;
if ( V_70 -> V_78 != V_74 && V_70 -> V_78 != V_76 )
V_71 ++ ;
if ( V_70 -> V_75 == V_77 && V_70 -> V_78 == V_74 )
V_71 ++ ;
if ( V_70 -> V_81 != V_80 && V_70 -> V_81 != V_82 )
V_71 ++ ;
if ( V_71 )
return 2 ;
if ( V_70 -> V_83 != 0 ) {
...
if ( V_70 -> V_78 == V_76 && V_70 -> V_85 < F_21 ) {
V_70 -> V_85 = F_21 ;
V_71 ++ ;
}
...
static int F_30 ( struct V_142 * V_114 )
{
struct V_14 * V_15 ;
int V_11 ;
F_31 ( & V_114 -> V_2 , L_16 ) ;
...
V_15 = F_32 ( sizeof( struct V_14 ) , V_145 ) ;
if ( ! V_15 )
return - V_146 ;
V_15 -> V_147 = V_11 ;
V_109 [ V_11 ] = V_15 ;
...
static void F_34 ( struct V_142 * V_114 )
{
...
static int F_37 ( struct V_142 * V_149 , void * V_150 )
{
if ( V_149 -> V_151 == 0 )
return - V_152 ;
return F_38 ( V_149 ) ;
}
static void F_33 ( struct V_142 * V_114 )
{
int V_108 ;
F_31 ( & V_114 -> V_2 , L_18 ) ;
V_114 -> V_153 |= V_154 | V_155 ;
V_108 = F_39 ( V_114 , F_37 , NULL ) ;
if ( V_108 ) {
F_40 ( & V_114 -> V_2 , L_19 ) ;
goto V_156;
}
V_108 = F_41 ( V_114 , F_7 ) ;
if ( V_108 )
goto V_156;
V_108 = F_42 ( V_114 ) ;
if ( V_108 )
...
static int F_44 ( struct V_142 * V_114 )
{
struct V_14 * V_15 = V_114 -> V_148 ;
V_15 -> V_17 = 1 ;
return 0 ;
}
static int F_45 ( struct V_142 * V_114 )
{
struct V_14 * V_15 = V_114 -> V_148 ;
V_15 -> V_17 = 0 ;
return 0 ;
