...
if ( V_97 == V_99 && F_51 ( V_92 ) ) {
T_3 V_100 = 0 ;
if ( V_92 -> V_101 == V_82 + F_52 ( 0 ) )
V_100 = V_102 ;
else if ( V_92 -> V_101 == V_82 + F_52 ( 1 ) )
V_100 = V_103 ;
if ( V_100 ) {
if ( F_47 ( V_92 ) == 100 )
F_38 ( & V_1 -> V_24 , V_100 ) ;
...
void T_1 F_53 ( unsigned char * V_105 , unsigned char * V_106 )
{
T_2 V_24 = F_43 ( & V_1 -> V_24 ) ;
if ( V_105 && ( V_24 & V_71 ) )
F_54 ( V_82 + F_52 ( 0 ) , V_105 ) ;
if ( V_106 && ( V_24 & V_72 ) )
F_54 ( V_82 + F_52 ( 1 ) , V_106 ) ;
F_55 ( & V_107 ) ;
}
void T_1 F_53 ( unsigned char * V_105 , unsigned char * V_106 )
{
}
void T_1 F_56 ( int V_108 )
{
struct V_109 V_110 = {
. V_111 = F_57 ( V_108 ) / 8 ,
} ;
...
void T_1 F_65 ( unsigned int V_127 , unsigned int V_128 ,
...
F_66 ( V_137 & 0xfffffffffULL , & V_131 ) ;
}
void T_1 F_67 ( int V_138 , int V_139 )
{
struct V_140 V_131 = {
. V_141 = true ,
} ;
