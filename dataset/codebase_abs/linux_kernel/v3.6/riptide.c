...
static void T_4 F_145 ( struct V_102 * V_103 )
{
struct V_256 * V_257 ;
if ( ! F_146 ( V_103 -> V_134 , L_61 , & V_257 ) )
F_147 ( V_257 , V_103 , F_142 ) ;
}
static int T_4 F_148 ( struct V_102 * V_103 )
{
struct V_261 * V_262 ;
struct V_263 V_138 ;
int V_21 = 0 ;
...
static void T_6 F_155 ( struct V_131 * V_132 )
{
...
static void T_6 F_168 ( struct V_131 * V_132 )
{
F_167 ( F_156 ( V_132 ) ) ;
F_154 ( V_132 , NULL ) ;
}
