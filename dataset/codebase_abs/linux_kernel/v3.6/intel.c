...
static void T_1 F_54 ( const unsigned char V_90 )
{
unsigned char V_91 ;
if ( V_90 == 0 )
return;
...
case V_108 :
case V_109 :
if ( V_110 [ V_97 ] < V_92 [ V_91 ] . V_98 )
V_110 [ V_97 ] = V_92 [ V_91 ] . V_98 ;
break;
case V_111 :
case V_112 :
if ( V_113 [ V_97 ] < V_92 [ V_91 ] . V_98 )
V_113 [ V_97 ] = V_92 [ V_91 ] . V_98 ;
if ( V_110 [ V_97 ] < V_92 [ V_91 ] . V_98 )
V_110 [ V_97 ] = V_92 [ V_91 ] . V_98 ;
break;
case V_114 :
...
static void T_1 F_56 ( struct V_1 * V_2 )
{
int V_117 , V_118 , V_119 ;
unsigned int V_120 [ 4 ] ;
unsigned char * V_90 = ( unsigned char * ) V_120 ;
V_119 = F_4 ( 2 ) & 0xFF ;
for ( V_117 = 0 ; V_117 < V_119 ; V_117 ++ ) {
F_57 ( 2 , & V_120 [ 0 ] , & V_120 [ 1 ] , & V_120 [ 2 ] , & V_120 [ 3 ] ) ;
for ( V_118 = 0 ; V_118 < 3 ; V_118 ++ )
if ( V_120 [ V_118 ] & ( 1 << 31 ) )
V_120 [ V_118 ] = 0 ;
for ( V_118 = 1 ; V_118 < 16 ; V_118 ++ )
F_54 ( V_90 [ V_118 ] ) ;
}
F_55 ( V_2 ) ;
}
