...
if ( V_90 ) {
V_47 -> V_101 = V_64 -> V_98 ;
memcpy ( V_47 -> V_100 , V_64 -> V_102 , V_91 ) ;
} else if ( V_87 ) {
V_47 -> V_101 = V_87 -> V_98 ;
memcpy ( V_47 -> V_100 , V_87 -> V_102 , V_91 ) ;
} else {
V_47 -> V_101 = 0 ;
memset ( V_47 -> V_100 , 0 , V_91 ) ;
}
V_20:
return;
}
