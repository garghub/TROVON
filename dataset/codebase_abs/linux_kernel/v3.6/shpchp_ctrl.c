...
int V_32 = 0 ;
F_6 ( V_13 , L_15 , V_31 ) ;
if ( ( V_32 = V_2 -> V_15 -> V_33 ( V_2 , V_31 ) ) ) {
F_11 ( V_13 , L_16
L_17 , V_34 ) ;
return V_35 ;
}
...
if ( ( V_32 = V_2 -> V_15 -> V_33 ( V_2 , V_49 ) ) ) {
F_11 ( V_13 , L_22
L_23 , V_34 ) ;
return V_35 ;
}
if ( ( V_32 = V_2 -> V_15 -> V_50 ( V_2 ) ) ) {
F_11 ( V_13 , L_24 ) ;
return V_32 ;
}
}
...
V_39 = V_13 -> V_44 -> V_52 -> V_53 ;
V_40 = V_13 -> V_44 -> V_52 -> V_54 ;
if ( ! F_17 ( & V_13 -> V_44 -> V_45 -> V_55 ) )
V_41 = 1 ;
F_6 ( V_13 , L_27
L_28 , V_34 , V_41 , V_38 ,
V_39 , V_40 ) ;
...
if ( ! V_5 )
return - V_7 ;
V_1 -> V_15 -> V_77 ( V_1 , & ( V_5 -> V_78 ) ) ;
V_1 -> V_15 -> V_79 ( V_1 , & ( V_5 -> V_80 ) ) ;
V_1 -> V_15 -> V_20 ( V_1 , & ( V_5 -> V_81 ) ) ;
V_1 -> V_15 -> V_16 ( V_1 , & ( V_5 -> V_82 ) ) ;
V_76 = F_32 ( V_1 -> V_83 , V_5 ) ;
F_29 ( V_5 ) ;
return V_76 ;
}
...
if ( V_32 || ! V_19 ) {
F_8 ( V_13 , L_44 , F_9 ( V_2 ) ) ;
goto V_73;
}
V_32 = V_2 -> V_15 -> V_20 ( V_2 , & V_19 ) ;
if ( V_32 || V_19 ) {
F_8 ( V_13 , L_45 , F_9 ( V_2 ) ) ;
goto V_73;
}
V_32 = V_2 -> V_15 -> V_77 ( V_2 , & V_19 ) ;
if ( V_32 || V_19 ) {
F_8 ( V_13 , L_46 ,
F_9 ( V_2 ) ) ;
goto V_73;
...
V_2 -> V_58 = 1 ;
V_2 -> V_15 -> V_16 ( V_2 , & ( V_2 -> V_17 ) ) ;
V_2 -> V_15 -> V_77 ( V_2 , & ( V_2 -> V_21 ) ) ;
F_6 ( V_13 , L_47 , V_34 , V_2 -> V_21 ) ;
V_2 -> V_15 -> V_20 ( V_2 , & V_19 ) ;
if( ( ( V_2 -> V_13 -> V_44 -> V_48 == V_89 ) ||
( V_2 -> V_13 -> V_44 -> V_46 == V_90 ) )
&& V_2 -> V_13 -> V_91 == 1 ) {
F_37 ( V_2 ) ;
V_86 = F_16 ( V_2 ) ;
F_38 ( V_2 ) ;
