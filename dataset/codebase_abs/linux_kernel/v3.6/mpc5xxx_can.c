...
static T_1 T_2 F_11 ( struct V_1 * V_2 ,
const char * V_3 ,
int * V_4 )
{
...
F_16 ( & V_21 -> V_36 [ V_27 ] , 0x0 ) ;
if ( V_28 >= 0 ) {
V_11 = ( V_28 << 14 ) | ( ( V_30 - 1 ) << 17 ) ;
F_16 ( & V_21 -> V_36 [ V_27 ] , V_11 ) ;
F_16 ( & V_21 -> V_36 [ V_27 ] , V_11 | 0x10000 ) ;
}
V_11 = F_8 ( & V_21 -> V_37 [ 1 ] ) ;
if ( ! ( V_11 & ( 1 << 25 ) ) )
F_16 ( & V_21 -> V_37 [ 1 ] , V_11 | ( 1 << 25 ) ) ;
F_17 ( & V_2 -> V_15 , L_12 ,
* V_4 == V_34 ? L_13 :
...
{
struct V_43 * V_15 = F_30 ( & V_2 -> V_15 ) ;
struct V_44 * V_45 = F_22 ( V_15 ) ;
F_25 ( & V_2 -> V_15 , NULL ) ;
F_31 ( V_15 ) ;
F_10 ( V_45 -> V_55 ) ;
F_28 ( V_15 -> V_47 ) ;
...
static int F_32 ( struct V_1 * V_2 , T_5 V_60 )
{
struct V_43 * V_15 = F_30 ( & V_2 -> V_15 ) ;
struct V_44 * V_45 = F_22 ( V_15 ) ;
struct V_61 * V_62 = (struct V_61 * ) V_45 -> V_55 ;
F_33 ( & V_63 , V_62 , sizeof( * V_62 ) ) ;
return 0 ;
}
...
struct V_61 * V_62 = (struct V_61 * ) V_45 -> V_55 ;
V_62 -> V_64 |= V_65 ;
while ( ! ( V_62 -> V_66 & V_67 ) )
F_35 ( 10 ) ;
V_62 -> V_66 = V_63 . V_66 ;
V_62 -> V_68 = V_63 . V_68 ;
V_62 -> V_69 = V_63 . V_69 ;
V_62 -> V_70 = V_63 . V_70 ;
F_36 ( & V_62 -> V_71 , ( void * ) & V_63 . V_71 ,
sizeof( * V_62 ) - F_37 ( struct V_61 , V_71 ) ) ;
V_62 -> V_64 &= ~ V_65 ;
V_62 -> V_72 = V_63 . V_72 ;
V_62 -> V_73 = V_63 . V_73 ;
V_62 -> V_74 = V_63 . V_74 ;
