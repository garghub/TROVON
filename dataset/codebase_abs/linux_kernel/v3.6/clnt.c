...
F_4 ( & V_2 -> V_81 ) ;
F_85 ( & V_145 -> V_147 , & V_2 -> V_80 ) ;
F_6 ( & V_2 -> V_81 ) ;
}
}
void F_86 ( struct V_134 * V_145 , struct V_1 * V_2 )
{
F_82 ( V_145 ) ;
F_83 ( V_145 , V_2 ) ;
}
static void
F_87 ( struct V_134 * V_145 , const struct V_151 * V_152 )
{
if ( V_152 != NULL ) {
...
if ( V_152 -> V_157 != NULL )
V_145 -> V_153 . V_157 = F_88 ( V_152 -> V_157 ) ;
}
}
static void
F_89 ( struct V_134 * V_145 , void * V_158 )
{
}
struct V_134 * F_90 ( const struct V_159 * V_160 )
{
struct V_134 * V_145 ;
V_145 = F_91 ( V_160 ) ;
if ( F_18 ( V_145 ) )
goto V_144;
F_83 ( V_145 , V_160 -> V_161 ) ;
F_87 ( V_145 , V_160 -> V_151 ) ;
if ( V_145 -> V_162 == NULL )
F_92 ( V_145 ) ;
F_66 ( & V_145 -> V_163 ) ;
F_93 ( V_145 ) ;
...
int F_94 ( struct V_1 * V_2 , const struct V_151 * V_152 , int V_120 )
{
struct V_134 * V_145 ;
struct V_159 V_160 = {
. V_161 = V_2 ,
...
int
F_96 ( struct V_1 * V_2 , const struct V_151 * V_152 , int V_120 ,
...
struct V_134 * F_97 ( struct V_172 * V_173 ,
...
void
F_92 ( struct V_134 * V_145 )
{
V_145 -> V_162 = V_183 ;
}
T_3 F_100 ( struct V_1 * V_2 , struct V_184 * V_185 , T_3 V_186 )
{
T_3 V_187 ;
struct V_50 * V_51 ;
F_62 () ;
...
const char * F_101 ( struct V_1 * V_2 ,
enum V_189 V_190 )
{
struct V_50 * V_51 ;
V_51 = F_64 ( V_2 -> V_66 ) ;
...
static int F_102 ( struct V_3 * V_3 , struct V_184 * V_192 , T_3 V_193 ,
struct V_184 * V_185 , int V_194 )
{
struct V_195 * V_196 ;
int V_31 ;
V_31 = F_103 ( V_3 , V_192 -> V_111 ,
V_197 , V_198 , & V_196 , 1 ) ;
if ( V_31 < 0 ) {
F_38 ( L_18 , V_31 ) ;
goto V_144;
...
V_31 = F_105 ( V_196 , V_192 , V_193 , 0 ) ;
if ( V_31 < 0 ) {
F_38 ( L_20 , V_31 ) ;
goto V_202;
}
V_31 = F_106 ( V_196 , V_185 , & V_194 ) ;
if ( V_31 < 0 ) {
F_38 ( L_21 , V_31 ) ;
goto V_202;
}
...
static int F_108 ( int V_204 , struct V_184 * V_185 , T_3 V_194 )
{
switch ( V_204 ) {
case V_114 :
...
int F_109 ( struct V_1 * V_2 , struct V_184 * V_185 , T_3 V_194 )
{
struct V_205 V_102 ;
...
V_3 = F_110 ( V_51 -> V_206 ) ;
F_65 () ;
F_111 ( V_192 , 0 ) ;
V_31 = F_102 ( V_3 , V_192 , V_193 , V_185 , V_194 ) ;
F_112 ( V_3 ) ;
if ( V_31 != 0 )
return F_108 ( V_192 -> V_111 , V_185 , V_194 ) ;
return 0 ;
}
void
F_113 ( struct V_1 * V_2 , unsigned int V_207 , unsigned int V_208 )
{
struct V_50 * V_51 ;
F_62 () ;
V_51 = F_64 ( V_2 -> V_66 ) ;
...
struct V_3 * V_212 ;
F_62 () ;
V_212 = F_64 ( V_2 -> V_66 ) -> V_206 ;
F_65 () ;
return V_212 ;
}
T_3 F_115 ( struct V_1 * V_2 )
{
T_3 V_212 ;
F_62 () ;
V_212 = F_64 ( V_2 -> V_66 ) -> V_213 ;
F_65 () ;
return V_212 ;
}
...
static const char * F_121 ( const struct V_134 * V_145 )
{
...
static inline void
F_132 ( struct V_174 * V_185 , void * V_251 , T_3 V_24 )
{
...
if ( V_253 == NULL )
return;
V_145 -> V_168 = F_135 ( V_145 , V_253 , V_173 , V_254 ,
V_145 -> V_153 . V_155 ) ;
}
static void
...
struct V_1 * V_2 = V_145 -> V_146 ;
struct V_172 * V_173 = V_145 -> V_177 ;
T_6 V_292 = V_145 -> V_153 . V_154 -> V_241 ;
T_5 * V_254 ;
F_123 ( V_145 ) ;
if ( V_145 -> V_136 & V_290 ) {
if ( V_2 -> V_129 ) {
...
F_151 ( memcmp ( & V_173 -> V_255 , & V_173 -> V_293 ,
...
V_145 -> V_162 = V_280 ;
if ( V_292 ) {
V_145 -> V_168 = F_153 ( V_145 , V_292 , V_173 , V_254 ,
V_145 -> V_153 . V_156 ) ;
}
...
struct V_1 * V_2 = V_145 -> V_146 ;
struct V_172 * V_173 = V_145 -> V_177 ;
T_5 * V_254 = V_173 -> V_295 [ 0 ] . V_252 ;
V_254 = F_154 ( V_145 -> V_236 , V_254 ) ;
* V_254 ++ = V_173 -> V_296 ;
* V_254 ++ = F_155 ( V_297 ) ;
* V_254 ++ = F_155 ( V_298 ) ;
* V_254 ++ = F_155 ( V_2 -> V_72 ) ;
* V_254 ++ = F_155 ( V_2 -> V_75 ) ;
* V_254 ++ = F_155 ( V_145 -> V_153 . V_154 -> V_239 ) ;
V_254 = F_156 ( V_145 , V_254 ) ;
V_173 -> V_299 = F_157 ( & V_173 -> V_295 [ 0 ] , V_254 ) ;
return V_254 ;
}
static T_5 *
F_152 ( struct V_134 * V_145 )
{
struct V_1 * V_2 = V_145 -> V_146 ;
struct V_300 * V_301 = & V_145 -> V_177 -> V_255 . V_178 [ 0 ] ;
int V_24 = V_145 -> V_177 -> V_255 . V_24 >> 2 ;
T_5 * V_254 = V_301 -> V_252 ;
T_2 V_302 ;
int error = - V_230 ;
...
goto V_304;
V_254 += 1 ;
if ( ( V_302 = F_158 ( * V_254 ++ ) ) != V_305 ) {
F_38 ( L_60 ,
V_145 -> V_219 , V_36 , V_302 ) ;
goto V_306;
}
if ( ( V_302 = F_158 ( * V_254 ++ ) ) != V_307 ) {
if ( -- V_24 < 0 )
goto V_304;
switch ( ( V_302 = F_158 ( * V_254 ++ ) ) ) {
case V_308 :
break;
case V_309 :
F_38 ( L_61 ,
...
if ( ! ( V_254 = F_159 ( V_145 , V_254 ) ) ) {
F_38 ( L_70 ,
V_145 -> V_219 , V_36 ) ;
goto V_306;
}
V_24 = V_254 - ( T_5 * ) V_301 -> V_252 - 1 ;
if ( V_24 < 0 )
goto V_304;
switch ( ( V_302 = F_158 ( * V_254 ++ ) ) ) {
case V_318 :
...
static void F_160 ( void * V_324 , struct V_325 * V_326 , void * V_327 )
{
}
static int F_161 ( void * V_324 , struct V_325 * V_326 , void * V_327 )
{
return 0 ;
}
...
V_31 = F_94 ( V_2 , & V_152 , V_148 | V_331 ) ;
F_162 ( V_152 . V_157 ) ;
return V_31 ;
}
struct V_134 * F_163 ( struct V_1 * V_2 , struct V_157 * V_332 , int V_120 )
{
struct V_151 V_152 = {
. V_154 = & V_328 ,
. V_157 = V_332 ,
