...
switch ( type ) {
case V_58 :
V_28 = F_120 ( V_227 , V_226 , V_45 -> V_67 , true ) ;
if ( ! V_28 )
F_114 ( V_45 ) ;
break;
case V_33 :
...
static inline int F_124 ( int V_244 )
{
return V_244 == V_245
|| V_244 == V_246 ;
}
...
V_28 = F_137 ( V_282 , V_279 , V_283 , V_280 ) ;
if ( ! V_28 ) {
V_28 = F_36 ( V_268 ) ;
if ( ! V_28 )
V_28 = F_36 ( V_267 ) ;
...
goto V_291;
if ( type != V_33 )
V_28 = F_141 ( V_227 , V_289 ) ;
else
V_28 = F_142 ( V_227 , V_289 ) ;
if ( ! V_28 )
V_28 = F_36 ( V_23 ) ;
V_291:
F_15 ( V_289 ) ;
...
static int F_143 ( void * V_292 , const char * V_24 , int V_293 ,
T_9 V_180 , T_12 V_143 , unsigned int V_294 )
{
struct V_295 * V_85 = V_292 ;
struct V_296 * V_297 = ( void * ) ( V_85 -> V_298 + V_85 -> V_299 ) ;
unsigned int V_300 ;
V_300 = F_144 ( sizeof( struct V_296 ) + V_293 , sizeof( T_12 ) ) ;
if ( V_85 -> V_299 + V_300 > V_301 ) {
V_85 -> V_302 = 1 ;
return - V_99 ;
}
V_297 -> V_293 = V_293 ;
...
static T_1 F_145 ( struct V_131 * V_131 , T_13 V_303 ,
...
int V_176 ;
T_9 V_180 ;
V_85 . V_298 = ( void * ) F_146 ( V_88 ) ;
if ( ! V_85 . V_298 )
return F_28 ( - V_89 ) ;
V_180 = * V_306 ;
while ( 1 ) {
struct V_36 * V_307 = V_131 -> V_197 . V_3 -> V_21 ;
unsigned int V_300 ;
V_305 -> V_11 = V_308 ;
V_85 . V_299 = 0 ;
V_85 . V_302 = 0 ;
...
if ( ! V_176 )
break;
V_28 = F_148 ( & V_307 -> V_196 ) ;
if ( V_28 )
break;
V_297 = (struct V_296 * ) V_85 . V_298 ;
while ( V_176 > 0 ) {
V_180 = V_297 -> V_180 ;
if ( V_303 ( V_305 , V_297 -> V_24 , V_297 -> V_293 , V_297 -> V_180 ,
V_297 -> V_143 , V_297 -> V_294 ) )
break;
if ( V_305 -> V_11 != V_123 )
break;
V_300 = F_144 ( sizeof( * V_297 ) + V_297 -> V_293 ,
sizeof( T_12 ) ) ;
V_176 -= V_300 ;
...
if ( V_176 > 0 )
break;
V_180 = F_149 ( V_131 , 0 , V_309 ) ;
}
F_150 ( ( unsigned long ) ( V_85 . V_298 ) ) ;
if ( V_28 )
return F_28 ( V_28 ) ;
* V_306 = V_180 ;
return V_305 -> V_11 ;
...
T_1
F_151 ( struct V_1 * V_2 , struct V_22 * V_23 , T_9 * V_306 ,
...
if ( V_11 )
goto V_12;
V_180 = F_149 ( V_131 , V_180 , V_310 ) ;
if ( V_180 < 0 ) {
V_11 = F_28 ( ( int ) V_180 ) ;
goto V_311;
}
V_11 = F_145 ( V_131 , V_303 , V_305 , V_306 ) ;
if ( V_11 == V_308 || V_11 == V_312 )
V_11 = V_123 ;
V_311:
F_78 ( V_131 ) ;
V_12:
