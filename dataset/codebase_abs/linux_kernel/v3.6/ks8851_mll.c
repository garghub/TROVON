...
T_1 * V_141 ;
V_23 -> V_142 &= ~ V_143 ;
memcpy ( V_23 -> V_144 , V_132 -> V_145 , V_23 -> V_146 ) ;
V_141 = ( T_1 * ) V_23 -> V_144 ;
F_68 ( V_2 , V_141 ) ;
return 0 ;
}
static int F_70 ( struct V_53 * V_23 , struct V_147 * V_148 , int V_149 )
{
struct V_1 * V_2 = F_38 ( V_23 ) ;
if ( ! F_71 ( V_23 ) )
return - V_150 ;
return F_72 ( & V_2 -> V_151 , F_73 ( V_148 ) , V_149 , NULL ) ;
}
static void F_74 ( struct V_53 * V_23 ,
struct V_152 * V_153 )
{
F_75 ( V_153 -> V_154 , V_88 , sizeof( V_153 -> V_154 ) ) ;
F_75 ( V_153 -> V_155 , L_10 , sizeof( V_153 -> V_155 ) ) ;
F_75 ( V_153 -> V_156 , F_76 ( V_23 -> V_157 . V_158 ) ,
sizeof( V_153 -> V_156 ) ) ;
}
...
static void F_78 ( struct V_53 * V_23 , T_3 V_160 )
{
struct V_1 * V_2 = F_38 ( V_23 ) ;
V_2 -> V_159 = V_160 ;
}
static int F_79 ( struct V_53 * V_23 , struct V_161 * V_149 )
{
struct V_1 * V_2 = F_38 ( V_23 ) ;
return F_80 ( & V_2 -> V_151 , V_149 ) ;
}
static int F_81 ( struct V_53 * V_23 , struct V_161 * V_149 )
{
struct V_1 * V_2 = F_38 ( V_23 ) ;
return F_82 ( & V_2 -> V_151 , V_149 ) ;
}
static T_3 F_83 ( struct V_53 * V_23 )
{
struct V_1 * V_2 = F_38 ( V_23 ) ;
return F_84 ( & V_2 -> V_151 ) ;
}
...
static int F_88 ( struct V_53 * V_23 , int V_175 , int V_162 )
{
struct V_1 * V_2 = F_38 ( V_23 ) ;
int V_176 ;
int V_177 ;
...
F_6 ( V_2 , V_187 , V_188 ) ;
F_6 ( V_2 , V_49 , V_50 ) ;
F_6 ( V_2 , V_61 , 1 & V_189 ) ;
V_2 -> V_51 = V_190 ;
F_6 ( V_2 , V_42 , V_2 -> V_51 ) ;
V_39 = F_4 ( V_2 , V_164 ) ;
V_39 &= ~ V_191 ;
F_6 ( V_2 , V_164 , V_39 ) ;
V_39 = V_192 | V_193 | V_194 | V_195 ;
F_6 ( V_2 , V_40 , V_39 ) ;
V_39 = V_196 | V_197 | V_198 | V_199 | V_200 ;
if ( V_2 -> V_117 )
V_39 |= ( V_119 | V_120 ) ;
else if ( V_2 -> V_123 )
...
V_2 -> V_123 = 0 ;
V_2 -> V_112 = 0 ;
V_2 -> V_57 = F_98 ( F_97 , V_201 ) ;
if ( ! V_2 -> V_57 )
return false ;
F_68 ( V_2 , V_202 ) ;
return true ;
}
static int T_5 F_99 ( struct V_203 * V_204 )
{
int V_86 = - V_205 ;
...
T_2 V_209 , V_4 ;
struct V_210 * V_93 ;
V_207 = F_100 ( V_204 , V_211 , 0 ) ;
V_208 = F_100 ( V_204 , V_211 , 1 ) ;
if ( ! F_101 ( V_207 -> V_212 , F_102 ( V_207 ) , V_88 ) )
goto V_213;
if ( ! F_101 ( V_208 -> V_212 , F_102 ( V_208 ) , V_88 ) )
goto V_214;
V_23 = F_103 ( sizeof( struct V_1 ) ) ;
if ( ! V_23 )
goto V_215;
F_104 ( V_23 , & V_204 -> V_157 ) ;
V_2 = F_38 ( V_23 ) ;
V_2 -> V_23 = V_23 ;
V_2 -> V_10 = F_105 ( V_207 -> V_212 , F_102 ( V_207 ) ) ;
if ( ! V_2 -> V_10 )
goto V_216;
V_2 -> V_9 = F_105 ( V_208 -> V_212 , F_102 ( V_208 ) ) ;
if ( ! V_2 -> V_9 )
goto V_217;
V_23 -> V_74 = F_106 ( V_204 , 0 ) ;
if ( ( int ) V_23 -> V_74 < 0 ) {
V_86 = V_23 -> V_74 ;
goto V_218;
}
...
V_23 -> V_219 = & V_220 ;
V_23 -> V_221 = & V_222 ;
V_2 -> V_151 . V_157 = V_23 ;
V_2 -> V_151 . V_223 = 1 ,
V_2 -> V_151 . V_224 = 1 ;
V_2 -> V_151 . V_225 = 0xf ;
V_2 -> V_151 . V_226 = F_88 ;
V_2 -> V_151 . V_227 = F_89 ;
F_93 ( V_23 , L_15 , V_159 ) ;
V_2 -> V_159 = F_109 ( V_159 , ( V_228 |
V_229 |
V_230 ) ) ;
F_16 ( V_2 ) ;
if ( ( F_4 ( V_2 , V_231 ) & ~ V_232 ) != V_233 ) {
F_92 ( V_23 , L_16 ) ;
V_86 = - V_234 ;
goto V_235;
}
...
F_95 ( V_2 ) ;
V_4 = F_4 ( V_2 , V_237 ) ;
F_6 ( V_2 , V_237 , V_4 | V_238 ) ;
V_93 = V_204 -> V_157 . V_239 ;
if ( ! V_93 ) {
F_92 ( V_23 , L_17 ) ;
V_86 = - V_234 ;
goto V_240;
}
memcpy ( V_2 -> V_138 , V_93 -> V_138 , 6 ) ;
if ( ! F_112 ( V_2 -> V_138 ) ) {
F_113 ( V_2 -> V_138 ) ;
F_93 ( V_23 , L_18 ) ;
}
F_93 ( V_23 , L_19 , V_2 -> V_138 ) ;
memcpy ( V_23 -> V_144 , V_2 -> V_138 , 6 ) ;
F_68 ( V_2 , V_23 -> V_144 ) ;
V_209 = F_4 ( V_2 , V_231 ) ;
F_93 ( V_23 , L_20 ,
( V_209 >> 8 ) & 0xff , ( V_209 >> 4 ) & 0xf , ( V_209 >> 1 ) & 0x7 ) ;
return 0 ;
V_240:
F_114 ( V_23 ) ;
V_235:
...
F_116 ( V_23 ) ;
V_215:
F_117 ( V_208 -> V_212 , F_102 ( V_208 ) ) ;
V_214:
F_117 ( V_207 -> V_212 , F_102 ( V_207 ) ) ;
V_213:
return V_86 ;
}
static int T_6 F_118 ( struct V_203 * V_204 )
{
struct V_53 * V_23 = F_119 ( V_204 ) ;
struct V_1 * V_2 = F_38 ( V_23 ) ;
struct V_206 * V_241 = F_100 ( V_204 , V_211 , 0 ) ;
F_120 ( V_2 -> V_57 ) ;
F_114 ( V_23 ) ;
F_115 ( V_2 -> V_10 ) ;
F_116 ( V_23 ) ;
F_117 ( V_241 -> V_212 , F_102 ( V_241 ) ) ;
F_111 ( V_204 , NULL ) ;
return 0 ;
}
