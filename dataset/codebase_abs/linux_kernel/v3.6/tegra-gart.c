...
void T_4 * V_54 ;
int V_30 ;
struct V_26 * V_8 = & V_50 -> V_8 ;
if ( V_31 )
return - V_55 ;
F_38 ( V_56 != V_57 ) ;
V_52 = F_39 ( V_50 , V_58 , 0 ) ;
V_53 = F_39 ( V_50 , V_58 , 1 ) ;
if ( ! V_52 || ! V_53 ) {
F_17 ( V_8 , L_13 ) ;
return - V_59 ;
}
...
V_54 = F_40 ( V_8 , V_52 -> V_60 , F_41 ( V_52 ) ) ;
if ( ! V_54 ) {
F_17 ( V_8 , L_15 ) ;
V_30 = - V_59 ;
goto V_41;
...
F_43 ( & V_2 -> V_28 ) ;
V_2 -> V_5 = V_54 ;
V_2 -> V_21 = ( V_61 ) V_53 -> V_60 ;
V_2 -> V_22 = ( F_41 ( V_53 ) >> V_57 ) ;
V_2 -> V_48 = F_44 ( sizeof( T_1 ) * V_2 -> V_22 ) ;
if ( ! V_2 -> V_48 ) {
F_17 ( V_8 , L_16 ) ;
V_30 = - V_39 ;
goto V_41;
