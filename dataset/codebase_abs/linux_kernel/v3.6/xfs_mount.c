...
error = F_116 ( V_2 , NULL , V_32 -> V_111 , 0 , V_248 , & V_230 ) ;
if ( error ) {
F_3 ( V_2 , L_36 ) ;
goto V_249;
}
ASSERT ( V_230 != NULL ) ;
if ( F_34 ( ! F_117 ( V_230 -> V_250 . V_251 ) ) ) {
F_3 ( V_2 , L_37 ,
...
F_143 ( T_3 * V_2 )
{
return ! ( V_2 -> V_261 -> V_262 . V_263 || F_144 ( V_2 ) ||
( V_2 -> V_8 & V_224 ) ) ;
}
int
F_138 ( T_3 * V_2 )
...
return;
V_2 = V_222 -> V_269 ;
V_153 = F_148 ( V_222 , V_2 , 0 ) ;
V_23 = sizeof( T_4 ) ;
V_268 = 0 ;
F_55 ( F_64 ( V_153 ) , & V_2 -> V_4 , V_139 ) ;
V_142 = ( T_12 ) F_149 ( ( T_5 ) V_139 ) ;
ASSERT ( ( 1LL << V_142 ) & V_270 ) ;
V_268 = V_144 [ V_142 + 1 ] . V_145 - 1 ;
V_142 = ( T_12 ) F_56 ( ( T_5 ) V_139 ) ;
ASSERT ( ( 1LL << V_142 ) & V_270 ) ;
V_23 = V_144 [ V_142 ] . V_145 ;
F_150 ( V_222 , V_153 , V_23 , V_268 ) ;
}
STATIC int
F_151 (
T_3 * V_2 ,
...
int V_274 ;
long long V_275 ;
long long V_276 , V_277 ;
switch ( V_271 ) {
case V_278 :
V_275 = ( long long ) V_2 -> V_4 . V_121 ;
V_275 += V_272 ;
if ( V_275 < 0 ) {
ASSERT ( 0 ) ;
return F_4 ( V_10 ) ;
...
case V_280 :
V_275 = ( long long )
V_2 -> V_4 . V_123 - F_152 ( V_2 ) ;
V_276 = ( long long ) ( V_2 -> V_281 - V_2 -> V_282 ) ;
if ( V_272 > 0 ) {
if ( V_276 > V_272 ) {
V_2 -> V_282 += V_272 ;
} else {
...
if ( ! V_273 )
return F_4 ( V_283 ) ;
V_275 = ( long long ) V_2 -> V_282 + V_272 ;
if ( V_275 >= 0 ) {
V_2 -> V_282 = V_275 ;
return 0 ;
}
...
V_2 -> V_4 . V_123 = V_275 + F_152 ( V_2 ) ;
return 0 ;
case V_286 :
V_275 = ( long long ) V_2 -> V_4 . V_124 ;
V_275 += V_272 ;
if ( V_275 < 0 ) {
return F_4 ( V_283 ) ;
}
...
int V_295 ;
#ifdef F_155
ASSERT ( V_271 < V_278 || V_271 > V_280 ) ;
#endif
F_27 ( & V_2 -> V_194 ) ;
V_295 = F_151 ( V_2 , V_271 , V_272 , V_273 ) ;
F_29 ( & V_2 -> V_194 ) ;
return V_295 ;
}
int
...
int error = 0 ;
F_27 ( & V_2 -> V_194 ) ;
for ( V_298 = V_296 ; V_298 < ( V_296 + V_297 ) ; V_298 ++ ) {
ASSERT ( V_298 -> V_299 < V_278 ||
V_298 -> V_299 > V_280 ) ;
error = F_151 ( V_2 , V_298 -> V_299 ,
V_298 -> V_300 , V_273 ) ;
if ( error )
goto V_301;
}
...
T_18 * V_222 ;
int error ;
ASSERT ( V_139 & ( V_199 | V_200 | V_304 |
V_233 | V_234 |
V_237 ) ) ;
V_222 = F_92 ( V_2 , V_305 ) ;
error = F_93 ( V_222 , 0 , V_2 -> V_4 . V_51 + 128 , 0 , 0 ,
V_226 ) ;
if ( error ) {
F_94 ( V_222 , 0 ) ;
...
if ( F_163 ( V_2 -> V_50 ) ||
F_163 ( V_2 -> V_49 ) ||
( V_2 -> V_307 && F_163 ( V_2 -> V_307 ) ) ) {
F_124 ( V_2 , L_49 , V_306 ) ;
F_124 ( V_2 , L_50 ) ;
return V_308 ;
}
return 0 ;
...
T_21 * V_313 ;
T_3 * V_2 ;
V_2 = ( T_3 * ) F_24 ( V_310 , T_3 , V_314 ) ;
V_313 = ( T_21 * )
F_165 ( V_2 -> V_315 , ( unsigned long ) V_312 ) ;
switch ( V_311 ) {
case V_316 :
case V_317 :
memset ( V_313 , 0 , sizeof( T_21 ) ) ;
break;
case V_318 :
case V_319 :
F_166 ( V_2 ) ;
...
F_169 ( V_2 , V_279 ) ;
F_169 ( V_2 , V_280 ) ;
V_2 -> V_4 . V_121 += V_313 -> V_322 ;
V_2 -> V_4 . V_122 += V_313 -> V_323 ;
V_2 -> V_4 . V_123 += V_313 -> V_324 ;
memset ( V_313 , 0 , sizeof( T_21 ) ) ;
F_170 ( V_2 , V_278 , 0 ) ;
F_170 ( V_2 , V_279 , 0 ) ;
F_170 ( V_2 , V_280 , 0 ) ;
...
T_21 * V_313 ;
int V_7 ;
V_2 -> V_315 = F_172 ( T_21 ) ;
if ( V_2 -> V_315 == NULL )
return - V_87 ;
#ifdef F_173
V_2 -> V_314 . V_326 = F_164 ;
V_2 -> V_314 . V_327 = 0 ;
F_174 ( & V_2 -> V_314 ) ;
#endif
F_175 (i) {
V_313 = ( T_21 * ) F_165 ( V_2 -> V_315 , V_7 ) ;
memset ( V_313 , 0 , sizeof( T_21 ) ) ;
}
F_42 ( & V_2 -> V_328 ) ;
V_2 -> V_329 = - 1 ;
...
F_175 (i) {
V_313 = ( T_21 * ) F_165 ( V_2 -> V_315 , V_7 ) ;
V_333 -> V_322 += V_313 -> V_322 ;
V_333 -> V_323 += V_313 -> V_323 ;
V_333 -> V_324 += V_313 -> V_324 ;
}
if ( ! ( V_42 & V_334 ) )
F_186 ( V_2 ) ;
}
...
return;
F_185 ( V_2 ) ;
if ( ! F_181 ( V_271 , & V_2 -> V_329 ) ) {
F_187 ( V_2 , & V_333 , V_334 ) ;
switch( V_271 ) {
case V_278 :
V_2 -> V_4 . V_121 = V_333 . V_322 ;
break;
case V_279 :
V_2 -> V_4 . V_122 = V_333 . V_323 ;
break;
case V_280 :
V_2 -> V_4 . V_123 = V_333 . V_324 ;
break;
default:
F_46 () ;
}
...
F_185 ( V_2 ) ;
F_175 (i) {
V_313 = F_165 ( V_2 -> V_315 , V_7 ) ;
switch ( V_271 ) {
case V_278 :
V_313 -> V_322 = V_335 + V_336 ;
break;
case V_279 :
V_313 -> V_323 = V_335 + V_336 ;
break;
case V_280 :
V_313 -> V_324 = V_335 + V_336 ;
break;
default:
F_46 () ;
break;
...
T_14 V_335 , V_336 ;
int V_338 = F_192 () ;
T_14 V_339 = ( T_14 ) V_337 ;
F_169 ( V_2 , V_271 ) ;
switch ( V_271 ) {
case V_278 :
V_335 = V_2 -> V_4 . V_121 ;
V_336 = F_50 ( V_335 , V_338 ) ;
if ( V_335 < F_193 ( V_339 , V_340 ) )
return;
break;
case V_279 :
V_335 = V_2 -> V_4 . V_122 ;
...
V_335 = V_2 -> V_4 . V_123 ;
V_336 = F_50 ( V_335 , V_338 ) ;
if ( V_335 < F_193 ( V_339 , F_194 ( V_2 ) ) )
return;
break;
default:
F_46 () ;
...
V_342:
F_197 () ;
V_330 = F_198 ( V_2 -> V_315 ) ;
if ( F_34 ( F_188 ( V_2 , V_271 ) ) )
goto V_343;
F_180 ( V_330 ) ;
if ( F_34 ( F_188 ( V_2 , V_271 ) ) ) {
F_183 ( V_330 ) ;
...
break;
case V_280 :
F_199 ( ( V_2 -> V_281 - V_2 -> V_282 ) != 0 ) ;
V_275 = V_330 -> V_324 - F_152 ( V_2 ) ;
V_275 += V_272 ;
if ( F_34 ( V_275 < 0 ) )
goto V_344;
V_330 -> V_324 = V_275 + F_152 ( V_2 ) ;
break;
default:
F_46 () ;
break;
...
F_27 ( & V_2 -> V_194 ) ;
V_341 = F_151 ( V_2 , V_271 , V_272 , V_273 ) ;
F_29 ( & V_2 -> V_194 ) ;
if ( V_341 != V_283 )
F_167 ( V_2 , V_271 , 0 ) ;
F_168 ( V_2 ) ;
