...
T_2 * V_1 ;
int V_31 ;
V_1 = ( T_2 * ) V_78 -> V_140 [ 0 ] ;
if ( V_1 == NULL )
return - V_200 ;
if ( V_203 == 0 ) {
V_147 = sprintf ( V_197 , L_47 ,
V_1 -> V_26 , V_78 -> V_205 ) ;
for ( V_31 = 0 ; V_31 < V_49 [ V_1 -> V_26 ] . V_50 ; V_31 ++ ) {
struct V_52 * V_58 =
& V_49 [ V_1 -> V_26 ] . V_30 [ V_31 ] ;
V_147 += sprintf ( & V_197 [ V_147 ] , L_48
L_49 ,
V_78 -> V_205 , V_58 -> V_42 , V_58 -> V_43 , V_58 -> V_44 ,
V_58 -> V_65 ,
...
V_209 = 1 ;
V_210 = 0 ;
V_211 = V_5 -> V_34 [ V_3 -> V_16 ] ;
}
V_149 = ( V_18 ) F_69 ( V_207 ) ;
V_194 = F_70 ( V_207 ) ;
V_211 [ V_210 ] . V_20 . V_21 =
( V_41 ) ( V_149 & 0x0FFFFFFFFULL ) ;
V_211 [ V_210 ] . V_20 . V_23 =
( V_41 ) ( ( V_149 >> 32 ) & 0x0FFFFFFFFULL ) ;
V_211 [ V_210 ] . V_24 = V_194 ;
V_211 [ V_210 ] . V_212 = 0 ;
++ V_210 ;
}
if ( V_209 )
...
if ( V_208 > V_1 -> V_213 )
V_1 -> V_213 = V_208 ;
V_3 -> V_97 . V_98 = ( V_214 ) V_208 + V_209 ;
if ( V_208 > V_1 -> V_99 )
...
T_1 * V_3 ;
unsigned long V_69 ;
V_1 = ( T_2 * ) V_13 -> V_53 -> V_215 -> V_140 [ 0 ] ;
V_83 = F_31 ( V_1 , V_13 -> V_53 -> V_216 , V_13 -> V_53 -> V_217 ,
V_13 -> V_53 -> V_44 , V_61 ) ;
if ( V_83 != 0 ) {
V_13 -> V_100 = V_111 << 16 ;
F_73 ( V_13 ) ;
...
V_13 -> V_126 = F_73 ;
V_13 -> V_218 = ( unsigned char * ) V_3 ;
V_3 -> V_93 = V_219 ;
V_3 -> V_95 = V_13 ;
V_3 -> V_97 . V_162 = 0 ;
memcpy ( & V_3 -> V_97 . V_163 . V_220 [ 0 ] , & V_61 [ 0 ] , 8 ) ;
V_3 -> V_97 . V_164 . V_21 = V_3 -> V_15 ;
V_3 -> V_91 . V_166 = 0 ;
memset ( V_3 -> V_91 . V_165 , 0 , sizeof( V_3 -> V_91 . V_165 ) ) ;
F_65 ( V_13 -> V_221 > sizeof( V_3 -> V_91 . V_165 ) ) ;
V_3 -> V_91 . V_167 = V_13 -> V_221 ;
memcpy ( V_3 -> V_91 . V_165 , V_13 -> V_222 , V_13 -> V_221 ) ;
V_3 -> V_91 . Type . Type = V_168 ;
V_3 -> V_91 . Type . V_169 = V_170 ;
switch( V_13 -> V_223 )
{
...
static void
F_75 ( struct V_231 * V_232 , T_2 * V_1 )
{
unsigned long V_69 ;
F_21 ( V_1 , V_69 ) ;
F_76 ( V_232 ,
...
if ( V_235 < ( V_236 * 30 ) )
V_235 = V_235 * 2 ;
V_83 = F_80 ( V_1 , V_3 , V_238 , NULL , 0 , 0 ,
V_233 , V_168 ) ;
if ( V_83 == 0 )
V_83 = F_81 ( V_1 , V_3 , 0 ) ;
( void ) F_82 ( V_1 , V_3 ) ;
if ( V_83 != 0 )
goto V_239;
if ( V_3 -> V_27 -> V_109 == V_240 )
break;
if ( V_3 -> V_27 -> V_109 == V_110 &&
V_3 -> V_27 -> V_103 == V_241 ) {
if ( V_3 -> V_27 -> V_105 [ 2 ] == V_242 )
break;
if ( V_3 -> V_27 -> V_105 [ 2 ] == V_243 ) {
unsigned char V_244 ;
V_244 = V_3 -> V_27 -> V_105 [ 12 ] ;
F_83 ( V_1 , V_3 ) ;
if ( V_244 == V_245 )
break;
}
...
static int F_85 ( struct V_89 * V_246 )
{
int V_83 ;
T_1 * V_247 ;
unsigned char V_233 [ 8 ] ;
T_2 * V_1 ;
V_1 = ( T_2 * ) V_246 -> V_53 -> V_215 -> V_140 [ 0 ] ;
if ( V_1 == NULL )
return V_248 ;
F_13 ( & V_1 -> V_29 -> V_30 , L_60 ) ;
V_247 = ( T_1 * ) V_246 -> V_218 ;
if ( V_247 == NULL )
return V_248 ;
memcpy ( V_233 , & V_247 -> V_97 . V_163 . V_220 [ 0 ] , 8 ) ;
V_83 = F_86 ( V_1 , V_249 , NULL , 0 , 0 , V_233 ,
V_92 ) ;
if ( V_83 == 0 && F_77 ( V_1 , V_233 ) == 0 )
return V_250 ;
F_13 ( & V_1 -> V_29 -> V_30 , L_61 ) ;
return V_248 ;
}
static int F_87 ( struct V_89 * V_246 )
{
int V_83 ;
T_1 * V_251 ;
unsigned char V_233 [ 8 ] ;
...
V_251 = ( T_1 * ) V_246 -> V_218 ;
if ( V_251 == NULL )
return V_248 ;
memcpy ( V_233 , & V_251 -> V_97 . V_163 . V_220 [ 0 ] , 8 ) ;
V_83 = F_86 ( V_1 , V_252 , & V_251 -> V_97 . V_164 ,
0 , 0 , V_233 , V_92 ) ;
if ( V_83 == 0 )
return V_250 ;
return V_248 ;
