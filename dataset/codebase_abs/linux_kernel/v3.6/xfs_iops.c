...
error = F_98 ( V_6 , V_6 -> V_73 . V_172 , V_156 , 0 ,
V_173 ) ;
if ( error )
goto V_171;
}
...
int error ;
F_108 ( V_6 ) ;
V_104 = F_75 ( V_67 , V_186 ) ;
error = F_76 ( V_104 , 0 , F_109 ( V_67 ) , 0 , 0 , 0 ) ;
if ( error ) {
F_93 ( V_104 , 0 ) ;
return - error ;
}
...
if ( V_27 & V_187 ) {
V_1 -> V_87 = * V_185 ;
V_6 -> V_73 . V_147 . V_141 = ( V_188 ) V_185 -> V_142 ;
V_6 -> V_73 . V_147 . V_143 = ( V_188 ) V_185 -> V_144 ;
}
if ( V_27 & V_189 ) {
V_1 -> V_86 = * V_185 ;
V_6 -> V_73 . V_150 . V_141 = ( V_188 ) V_185 -> V_142 ;
V_6 -> V_73 . V_150 . V_143 = ( V_188 ) V_185 -> V_144 ;
}
if ( V_27 & V_190 ) {
V_1 -> V_84 = * V_185 ;
V_6 -> V_73 . V_140 . V_141 = ( V_188 ) V_185 -> V_142 ;
V_6 -> V_73 . V_140 . V_143 = ( V_188 ) V_185 -> V_144 ;
}
F_82 ( V_104 , V_6 , V_125 ) ;
F_86 ( V_104 , V_6 , V_191 ) ;
return - F_89 ( V_104 , 0 ) ;
}
STATIC int
F_110 (
...
{
int error ;
struct V_196 * V_197 = * V_192 ;
T_9 V_198 = 0 ;
T_10 V_199 , V_200 , V_201 ;
if ( V_194 -> V_202 == - 1LL )
return 0 ;
V_199 = F_111 ( V_194 -> V_203 ) ;
V_200 = F_111 ( V_194 -> V_202 ) ;
V_201 = F_111 ( V_194 -> V_204 ) ;
if ( V_194 -> V_205 & V_206 )
V_198 |= V_207 ;
else if ( V_194 -> V_205 & V_208 ) {
V_198 |= V_209 ;
V_200 = 0 ;
}
if ( V_194 -> V_205 & V_210 )
V_198 |= V_211 ;
error = F_112 ( V_197 , V_199 , V_200 ,
V_201 , V_198 ) ;
if ( error > 0 ) {
error = 0 ;
* V_195 = 1 ;
...
struct V_193 V_213 ;
int error ;
error = F_114 ( V_197 , V_214 ) ;
if ( error )
return error ;
V_213 . V_203 = F_115 ( V_212 ) ;
if ( V_201 == V_215 )
V_213 . V_204 = - 1LL ;
else
V_213 . V_204 = F_115 ( V_201 ) ;
V_213 . V_216 = ! V_197 -> V_217 ? V_218 :
V_197 -> V_217 + 1 ;
V_213 . V_216 = F_116 ( V_219 , V_213 . V_216 ,
( V_220 * 16 / sizeof( struct V_193 ) ) ) ;
V_213 . V_221 = V_222 | V_223 ;
if ( V_197 -> V_224 & V_225 )
V_213 . V_221 |= V_226 ;
if ( ! ( V_197 -> V_224 & V_227 ) )
V_213 . V_221 |= V_228 ;
error = F_117 ( V_6 , & V_213 , F_110 , V_197 ) ;
if ( error )
return - error ;
return 0 ;
}
...
struct V_5 * V_6 )
{
if ( V_6 -> V_73 . V_229 & V_230 )
V_1 -> V_231 |= V_232 ;
else
V_1 -> V_231 &= ~ V_232 ;
if ( V_6 -> V_73 . V_229 & V_233 )
V_1 -> V_231 |= V_234 ;
else
V_1 -> V_231 &= ~ V_234 ;
if ( V_6 -> V_73 . V_229 & V_235 )
V_1 -> V_231 |= V_236 ;
else
V_1 -> V_231 &= ~ V_236 ;
if ( V_6 -> V_73 . V_229 & V_237 )
V_1 -> V_231 |= V_238 ;
else
V_1 -> V_231 &= ~ V_238 ;
}
...
struct V_5 * V_6 )
{
struct V_1 * V_1 = & V_6 -> V_239 ;
V_1 -> V_82 = V_6 -> V_82 ;
V_1 -> V_240 = V_241 ;
F_120 ( V_1 ) ;
F_121 ( & V_1 -> V_242 ) ;
V_1 -> V_91 = V_6 -> V_73 . V_74 ;
F_122 ( V_1 , V_6 -> V_73 . V_76 ) ;
...
V_1 -> V_244 = V_6 -> V_73 . V_245 ;
F_123 ( V_1 , V_6 -> V_73 . V_172 ) ;
...
case V_41 :
V_1 -> V_247 = & V_256 ;
if ( ! ( V_6 -> V_97 . V_257 & V_258 ) )
V_1 -> V_174 -> V_251 = & V_252 ;
break;
default:
V_1 -> V_247 = & V_248 ;
F_124 ( V_1 , V_1 -> V_91 , V_1 -> V_243 ) ;
break;
}
if ( ! F_125 ( V_6 ) ) {
F_126 ( V_1 ) ;
