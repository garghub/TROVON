...
if ( V_17 -> V_24 < 0 )
return V_17 -> V_24 ;
V_17 -> V_27 = F_13 ( V_20 , V_17 -> V_25 ) ;
#elif V_22 V_28 || V_22 V_29
if ( strcmp ( V_19 , V_30 ) == 0 )
V_17 -> V_24 = V_31 ;
else if ( strcmp ( V_19 , V_32 ) == 0 )
V_17 -> V_24 = V_33 ;
else
return - V_34 ;
V_17 -> V_27 = ( unsigned long ) F_14 ( V_18 ) << 32 | V_17 -> V_24 ;
F_15 ( V_20 , V_17 -> V_25 , V_17 -> V_27 ) ;
#else
...
int V_20 = F_11 ( V_17 -> V_21 ) ;
V_35 = F_19 ( V_20 , ( void * ) F_20 ( V_17 -> V_36 ) ,
V_17 -> V_37 , & V_17 -> V_25 ) ;
if ( V_35 < 0 ) {
F_21 ( V_38 , L_1 ,
V_35 ) ;
...
int V_20 = F_11 ( V_17 -> V_21 ) ;
#if V_22 V_23
V_35 = F_24 ( V_20 , V_17 -> V_40 ) ;
F_25 ( V_35 != V_41 ) ;
#elif V_22 V_28 || V_22 V_29
V_35 = F_26 ( V_20 , V_17 -> V_40 ) ;
F_25 ( V_35 != V_42 ) ;
#else
#error not a supported configuration
#endif
...
if ( V_35 != 0 )
goto V_62;
V_35 = F_10 ( V_17 , V_18 , V_19 ) ;
if ( V_35 != 0 )
goto V_63;
V_35 = F_35 ( V_17 -> V_24 , V_44 , 0 , V_19 , NULL ) ;
if ( V_35 != 0 ) {
F_21 ( V_38 , L_9 ,
V_17 -> V_24 , - V_35 ) ;
goto V_64;
...
V_48 = F_36 ( F_37 ( V_18 ) ) ;
V_27 = (struct V_51 * ) & V_17 -> V_27 ;
V_35 = F_38 ( V_17 -> V_55 , V_17 -> V_36 , V_43 ,
V_48 , V_27 -> V_65 , V_27 -> V_66 ) ;
if ( V_35 != 0 ) {
F_21 ( V_38 , L_10
L_11 , V_35 ) ;
V_35 = - V_34 ;
...
F_23 ( V_17 ) ;
V_62:
F_42 ( ( unsigned long ) V_17 -> V_36 , V_49 ) ;
V_61:
F_8 ( V_17 -> V_55 ) ;
V_57:
F_8 ( V_17 ) ;
...
static enum V_45
F_67 ( struct V_56 * V_55 ,
unsigned long V_139 )
{
enum V_45 V_35 ;
V_35 = F_68 ( F_20 ( V_55 ) , V_139 ,
sizeof( struct V_56 ) ) ;
if ( V_35 == V_68 )
V_55 -> V_17 = NULL ;
return V_35 ;
...
static enum V_45
F_69 ( struct V_77 * V_78 , void * V_70 , T_2 V_71 ,
int V_140 )
{
...
static void
F_71 ( struct V_77 * V_78 , void * V_70 ,
T_2 V_71 , int V_140 )
{
enum V_45 V_35 ;
V_35 = F_69 ( V_78 , V_70 , V_71 , V_140 ) ;
if ( F_72 ( V_35 != V_68 ) )
F_53 ( V_78 , V_35 ) ;
}
static void
F_73 ( struct V_148 * V_149 , unsigned long * V_12 ,
...
static void
F_74 ( struct V_77 * V_78 , int V_79 )
{
unsigned long V_12 ;
struct V_2 * V_3 = & V_78 -> V_6 . V_7 ;
F_6 ( & V_81 , V_12 ) ;
...
static enum V_45
F_75 ( void * V_151 , T_5 * V_152 , unsigned long * V_153 ,
T_2 * V_154 )
{
T_6 V_155 ;
enum V_45 V_35 ;
#if V_22 V_23
V_155 = F_76 ( ( T_5 ) V_151 , V_152 , ( T_5 * ) V_153 ,
( T_5 * ) V_154 ) ;
if ( V_155 == V_41 )
V_35 = V_68 ;
else if ( V_155 == V_156 )
...
V_35 = V_158 ;
#elif V_22 V_28 || V_22 V_29
V_155 = F_77 ( ( T_5 ) V_151 , V_152 , V_153 , V_154 ) ;
if ( V_155 == V_42 )
V_35 = V_68 ;
else if ( V_155 == V_159 )
V_35 = V_157 ;
...
static int
F_78 ( struct V_143 * V_161 )
{
V_162 =
& V_5 [ V_163 ] . V_6 . V_7 . V_164 ;
V_161 -> V_6 . V_7 . V_102 = F_20 ( V_162 ) ;
V_161 -> V_6 . V_7 . V_103 =
F_20 ( V_136 -> V_55 ) ;
return 0 ;
}
...
V_70 . V_99 = F_20 ( V_143 ) ;
V_70 . V_102 = V_143 -> V_6 . V_7 . V_102 ;
V_70 . V_103 =
V_143 -> V_6 . V_7 . V_103 ;
F_71 ( V_78 , & V_70 , sizeof( V_70 ) ,
V_95 ) ;
}
if ( V_78 -> V_83 == V_11 )
F_74 ( V_78 , V_82 ) ;
...
static enum V_45
F_102 ( struct V_148 * V_149 )
{
static enum V_45 V_35 ;
struct V_179 * V_180 = & V_149 -> V_6 . V_7 ;
...
static void
F_103 ( struct V_148 * V_149 )
{
struct V_179 * V_180 = & V_149 -> V_6 . V_7 ;
F_51 ( ! F_104 ( & V_149 -> V_150 ) ) ;
F_8 ( V_180 -> V_200 ) ;
V_180 -> V_200 = NULL ;
if ( V_149 -> V_14 & V_199 ) {
F_92 ( & V_180 -> V_183 ) ;
...
F_73 ( V_149 , V_12 , & V_70 , sizeof( V_70 ) ,
V_106 ) ;
}
static void
...
static void
F_108 ( struct V_148 * V_149 , unsigned long * V_12 )
{
struct V_122 V_70 ;
V_70 . V_109 = V_149 -> V_201 ;
V_70 . V_119 = V_149 -> V_119 ;
V_70 . V_123 = V_149 -> V_123 ;
V_70 . V_125 = F_20 ( V_202 -> V_55 ) ;
F_73 ( V_149 , V_12 , & V_70 , sizeof( V_70 ) ,
V_121 ) ;
}
static void
F_109 ( struct V_148 * V_149 , unsigned long * V_12 )
{
struct V_128 V_70 ;
V_70 . V_109 = V_149 -> V_201 ;
F_73 ( V_149 , V_12 , & V_70 , sizeof( V_70 ) ,
...
static void
F_110 ( struct V_77 * V_78 , int V_109 )
{
unsigned long V_12 ;
F_6 ( & V_78 -> V_110 , V_12 ) ;
...
static enum V_45
F_111 ( struct V_148 * V_149 ,
unsigned long V_139 )
{
struct V_179 * V_180 = & V_149 -> V_6 . V_7 ;
F_51 ( V_180 -> V_200 == NULL ) ;
return F_67 ( V_180 -> V_200 ,
V_139 ) ;
}
static void
F_112 ( struct V_77 * V_78 )
{
struct V_185 V_70 ;
F_71 ( V_78 , & V_70 , sizeof( V_70 ) ,
V_130 ) ;
...
static enum V_45
F_117 ( struct V_148 * V_149 , T_7 V_14 ,
struct V_190 * * V_204 )
{
enum V_45 V_35 ;
struct V_190 * V_191 ;
struct V_177 * V_193 ;
while ( 1 ) {
V_193 = F_93 ( & V_149 -> V_6 . V_7 . V_183 ) ;
if ( V_193 != NULL )
break;
if ( V_14 & V_205 )
return V_206 ;
V_35 = F_118 ( V_149 ) ;
if ( V_35 != V_207 && V_35 != V_208 )
return V_35 ;
}
...
static void
F_119 ( struct V_148 * V_149 ,
struct V_190 * V_191 )
{
F_94 ( & V_149 -> V_6 . V_7 . V_183 , & V_191 -> V_178 ) ;
if ( F_120 ( & V_149 -> V_209 ) > 0 )
F_121 ( & V_149 -> V_210 ) ;
}
static void
F_122 ( struct V_148 * V_149 ,
struct V_190 * V_191 ,
enum V_45 V_88 )
{
T_8 V_211 = V_191 -> V_211 ;
if ( V_211 != NULL && F_123 ( & V_191 -> V_211 , V_211 , NULL ) == V_211 ) {
F_124 ( & V_149 -> V_212 ) ;
F_48 ( V_74 , L_21
L_22 , V_191 ,
...
if ( V_191 -> V_211 != NULL )
F_122 ( V_149 , V_191 , V_214 ) ;
F_119 ( V_149 , V_191 ) ;
}
static void
F_126 ( struct V_77 * V_78 ,
struct V_197 * V_70 )
{
struct V_2 * V_3 = & V_78 -> V_6 . V_7 ;
struct V_148 * V_149 ;
...
F_94 ( & V_180 -> V_184 , & V_191 -> V_97 . V_218 . V_178 ) ;
if ( V_149 -> V_14 & V_219 ) {
if ( F_120 ( & V_149 -> V_220 ) > 0 )
F_129 ( & V_149 -> V_221 , 1 ) ;
else
F_110 ( V_78 , V_149 -> V_201 ) ;
}
F_128 ( V_149 ) ;
}
static T_4
F_130 ( int V_24 , void * V_134 )
{
struct V_197 * V_70 ;
short V_1 ;
struct V_77 * V_78 ;
while ( ( V_70 = F_62 ( V_202 -> V_55 ) ) !=
NULL ) {
V_1 = V_70 -> V_97 . V_1 ;
if ( V_1 < 0 || V_1 >= V_4 ) {
F_21 ( V_38 , L_26
...
{
return F_95 ( & V_149 -> V_6 . V_7 . V_184 ) ;
}
static void
F_132 ( struct V_77 * V_78 , int V_109 )
{
...
static enum V_45
F_134 ( struct V_148 * V_149 , T_7 V_14 , void * V_223 ,
...
V_35 = F_46 ( V_149 -> V_6 . V_7 . V_200 , V_70 ,
V_71 ) ;
if ( V_35 == V_68 )
goto V_57;
F_53 ( & V_5 [ V_149 -> V_1 ] , V_35 ) ;
V_61:
if ( V_211 != NULL ) {
if ( F_123 ( & V_191 -> V_211 , V_211 , NULL ) != V_211 ) {
V_35 = V_68 ;
goto V_57;
}
V_191 -> V_213 = NULL ;
...
if ( F_120 ( & V_149 -> V_212 ) == 0 )
break;
V_191 = & V_149 -> V_6 . V_7 . V_195 [ V_193 ] ;
if ( V_191 -> V_211 != NULL )
F_122 ( V_149 , V_191 , V_149 -> V_88 ) ;
}
}
static void *
F_138 ( struct V_148 * V_149 )
{
struct V_177 * V_193 ;
struct V_197 * V_70 ;
void * V_223 = NULL ;
if ( ! ( V_149 -> V_14 & V_231 ) ) {
V_193 = F_93 ( & V_149 -> V_6 . V_7 . V_184 ) ;
if ( V_193 != NULL ) {
...
static void
F_139 ( struct V_148 * V_149 , void * V_223 )
{
struct V_197 * V_70 ;
enum V_45 V_35 ;
