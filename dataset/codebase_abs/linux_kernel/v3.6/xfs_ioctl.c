...
V_7 . V_51 = V_43 -> V_13 . V_51 ;
V_7 . V_14 = V_14 ;
V_58 = F_30 ( & V_7 , V_2 -> V_64 , V_56 ) ;
F_31 ( V_14 ) ;
if ( F_24 ( V_58 ) ) {
F_32 ( V_11 ) ;
return F_25 ( V_58 ) ;
...
error = - F_42 ( F_4 ( V_14 -> V_15 ) , V_87 . V_91 ,
V_87 . V_92 ) ;
V_79:
F_41 ( V_43 ) ;
F_31 ( V_14 ) ;
...
if ( F_24 ( V_14 ) )
return F_25 ( V_14 ) ;
V_95 = F_44 ( V_94 . V_76 , V_82 ) ;
if ( ! V_95 )
goto V_62;
V_93 = ( T_7 * ) & V_94 . V_100 ;
error = - F_45 ( F_4 ( V_14 -> V_15 ) , V_95 , V_94 . V_76 ,
V_94 . V_97 , V_93 ) ;
if ( error )
goto V_84;
...
if ( * V_78 > V_103 )
return V_17 ;
V_95 = F_47 ( * V_78 , V_104 | V_105 ) ;
if ( ! V_95 ) {
V_95 = F_48 ( * V_78 ) ;
if ( ! V_95 )
return V_83 ;
}
error = F_49 ( F_4 ( V_5 ) , V_101 , V_95 , ( int * ) V_78 , V_97 ) ;
if ( error )
goto V_84;
...
if ( V_78 > V_103 )
return V_17 ;
V_95 = F_54 ( V_102 , V_78 ) ;
if ( F_24 ( V_95 ) )
return F_25 ( V_95 ) ;
error = F_55 ( F_4 ( V_5 ) , V_101 , V_95 , V_78 , V_97 ) ;
return error ;
}
int
F_56 (
...
if ( F_28 ( V_5 ) || F_27 ( V_5 ) )
return V_61 ;
return F_57 ( F_4 ( V_5 ) , V_101 , V_97 ) ;
}
STATIC int
F_58 (
struct V_6 * V_43 ,
...
goto V_62;
V_106 = F_54 ( V_107 . V_106 , V_109 ) ;
if ( F_24 ( V_106 ) ) {
error = F_25 ( V_106 ) ;
goto V_62;
}
V_110 = F_36 ( V_115 , V_82 ) ;
if ( ! V_110 )
goto V_116;
error = 0 ;
for ( V_108 = 0 ; V_108 < V_107 . V_111 ; V_108 ++ ) {
V_106 [ V_108 ] . V_117 = F_59 ( ( char * ) V_110 ,
...
case V_121 :
V_106 [ V_108 ] . V_117 = F_46 (
V_14 -> V_15 , V_110 ,
V_106 [ V_108 ] . V_122 , & V_106 [ V_108 ] . V_123 ,
V_106 [ V_108 ] . V_124 ) ;
break;
case V_125 :
V_106 [ V_108 ] . V_117 = F_40 ( V_43 ) ;
if ( V_106 [ V_108 ] . V_117 )
break;
V_106 [ V_108 ] . V_117 = F_53 (
V_14 -> V_15 , V_110 ,
V_106 [ V_108 ] . V_122 , V_106 [ V_108 ] . V_123 ,
V_106 [ V_108 ] . V_124 ) ;
F_41 ( V_43 ) ;
...
if ( error )
return error ;
error = F_62 ( V_9 , V_1 , V_128 , V_58 -> V_141 , V_129 ) ;
F_41 ( V_58 ) ;
return - error ;
}
STATIC int
...
return - F_23 ( V_17 ) ;
if ( V_1 == V_152 )
error = F_65 ( V_142 , & V_145 , & V_144 ,
V_143 . V_151 , V_153 ) ;
else if ( V_1 == V_154 )
error = F_66 ( V_142 , & V_145 ,
V_143 . V_151 , & V_146 ) ;
else
error = F_67 ( V_142 , & V_145 , & V_144 , V_155 ,
...
struct V_8 * V_9 )
{
struct V_5 * V_5 = F_80 ( V_9 ) ;
unsigned int V_161 = F_75 ( V_9 ) ;
if ( V_161 & V_163 )
V_5 -> V_131 |= V_132 ;
else
V_5 -> V_131 &= ~ V_132 ;
...
! F_83 ( & V_9 -> V_24 -> V_130 ) )
return F_23 ( V_17 ) ;
if ( F_84 ( V_142 ) && ( V_216 & V_229 ) ) {
V_225 = F_85 ( V_9 , V_9 -> V_34 . V_230 ,
V_9 -> V_34 . V_231 , V_180 -> V_186 ,
V_232 , & V_222 , & V_223 ) ;
if ( V_225 )
return V_225 ;
}
V_219 = F_86 ( V_142 , V_233 ) ;
V_225 = F_87 ( V_219 , 0 , F_88 ( V_142 ) , 0 , 0 , 0 ) ;
if ( V_225 )
goto V_234;
V_220 = V_235 ;
F_74 ( V_9 , V_220 ) ;
if ( F_89 () != V_9 -> V_34 . V_230 && ! F_22 ( V_236 ) ) {
V_225 = F_23 ( V_61 ) ;
goto V_234;
}
if ( V_216 & V_229 ) {
if ( F_90 ( V_142 ) &&
F_91 ( V_142 ) &&
F_76 ( V_9 ) != V_180 -> V_186 ) {
ASSERT ( V_219 ) ;
V_225 = F_92 ( V_219 , V_9 , V_222 , V_223 ,
F_22 ( V_236 ) ?
V_237 : 0 ) ;
if ( V_225 )
goto V_234;
...
if ( F_76 ( V_9 ) != V_180 -> V_186 ) {
if ( F_90 ( V_142 ) && F_91 ( V_142 ) ) {
V_224 = F_96 ( V_219 , V_9 ,
& V_9 -> V_251 , V_223 ) ;
}
F_97 ( V_9 , V_180 -> V_186 ) ;
if ( V_9 -> V_34 . V_252 == 1 )
F_98 ( V_219 , V_9 ) ;
}
}
...
if ( V_216 & V_241 ) {
F_78 ( V_9 , V_180 -> V_182 ) ;
F_79 ( V_9 ) ;
}
F_99 ( V_219 , V_9 , V_253 ) ;
F_100 ( V_219 , V_9 , V_254 ) ;
F_101 ( V_255 ) ;
...
if ( V_58 -> V_71 & ( V_134 | V_135 ) )
V_216 |= V_257 ;
V_180 . V_182 = F_71 ( V_97 , F_75 ( V_9 ) ) ;
error = F_40 ( V_58 ) ;
if ( error )
return error ;
error = F_81 ( V_9 , & V_180 , V_216 ) ;
...
STATIC int
F_109 ( void * * V_259 , struct V_260 * V_261 , int * V_262 )
{
...
STATIC int
F_112 ( void * * V_259 , struct V_260 * V_261 , int * V_262 )
{
...
return - F_23 ( V_38 ) ;
return F_60 ( V_9 , V_5 , V_58 , V_127 , V_1 , & V_128 ) ;
}
case V_283 : {
struct V_284 V_285 ;
T_21 * V_286 =
...
case V_293 :
case V_152 :
return F_63 ( V_142 , V_1 , V_85 ) ;
case V_294 :
return F_68 ( V_142 , V_85 ) ;
case V_295 :
return F_70 ( V_142 , V_85 ) ;
case V_296 :
return F_117 ( V_5 -> V_297 , ( int V_16 * ) V_85 ) ;
case V_298 :
return F_73 ( V_9 , 0 , V_85 ) ;
case V_299 :
return F_73 ( V_9 , 1 , V_85 ) ;
case V_300 :
return F_106 ( V_9 , V_58 , V_85 ) ;
case V_301 :
return F_107 ( V_9 , V_85 ) ;
case V_302 :
return F_108 ( V_9 , V_58 , V_85 ) ;
case V_303 : {
struct V_86 V_304 ;
...
case V_305 :
case V_268 :
return F_110 ( V_9 , V_127 , V_1 , V_85 ) ;
case V_306 :
return F_113 ( V_9 , V_85 ) ;
case V_10 :
case V_307 :
case V_27 : {
T_1 V_2 ;
...
case V_311 :
return F_43 ( V_58 , V_85 ) ;
case V_312 :
return F_58 ( V_58 , V_85 ) ;
case V_313 : {
struct V_314 V_315 ;
...
if ( ! F_22 ( V_60 ) )
return - V_61 ;
if ( F_123 ( V_320 , ( T_9 V_16 * ) V_85 ) )
return - F_23 ( V_38 ) ;
error = F_124 ( V_142 , V_320 ) ;
return - error ;
}
case V_327 : {
T_28 V_320 ;
