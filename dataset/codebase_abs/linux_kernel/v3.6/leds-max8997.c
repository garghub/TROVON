...
static int T_4 F_13 ( struct V_56 * V_57 )
{
...
if ( V_61 -> V_70 ) {
T_1 V_4 = 0 , V_69 = 0 ;
V_4 = V_61 -> V_70 -> V_4 [ V_2 -> V_15 ] ;
V_69 = V_61 -> V_70 -> V_69 [ V_2 -> V_15 ] ;
F_1 ( V_2 , V_61 -> V_70 -> V_4 [ V_2 -> V_15 ] ) ;
...
static int T_5 F_21 ( struct V_56 * V_57 )
{
struct V_1 * V_2 = F_22 ( V_57 ) ;
F_23 ( V_2 -> V_16 . V_31 , & V_71 ) ;
F_20 ( & V_2 -> V_16 ) ;
return 0 ;
}
