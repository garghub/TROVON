...
struct V_5 * V_6 = F_2 ( V_2 ) ;
int V_26 ;
if ( V_149 -> V_161 != V_6 -> V_146 . V_187 )
return - V_102 ;
...
sizeof( struct V_245 ) ) ;
for ( V_63 = 0 ; V_63 < F_72 ( V_242 -> V_246 ) ; V_63 ++ ) {
T_1 V_247 = F_72 ( V_242 -> V_248 [ V_63 ] . V_247 ) ;
for ( V_74 = 0 ; V_74 < V_247 ; V_74 ++ ) {
if ( V_242 -> V_248 [ V_63 ] . V_249 [ V_74 ] . V_250 ==
V_251 )
V_242 -> V_248 [ V_63 ] . V_249 [ V_74 ] . V_252 =
F_73 ( V_239 ) ;
}
}
V_26 = F_74 ( V_6 , & V_240 ,
...
static void F_75 ( struct V_1 * V_2 , T_1 V_239 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
if ( F_16 ( V_6 ) ) {
F_10 ( & V_6 -> V_16 -> V_37 , L_10 ) ;
