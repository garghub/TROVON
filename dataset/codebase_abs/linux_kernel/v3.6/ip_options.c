...
error:
if ( V_2 ) {
F_21 ( V_2 , V_67 , 0 , F_6 ( ( V_50 - V_9 ) << 24 ) ) ;
}
return - V_33 ;
}
...
static struct V_68 * F_23 ( const int V_12 )
{
return F_24 ( sizeof( struct V_68 ) + ( ( V_12 + 3 ) & ~ 3 ) ,
V_69 ) ;
}
static int F_25 ( struct V_49 * V_49 , struct V_68 * * V_70 ,
struct V_68 * V_4 , int V_12 )
{
while ( V_12 & 3 )
...
int F_27 ( struct V_49 * V_49 , struct V_68 * * V_70 ,
unsigned char T_3 * V_71 , int V_12 )
{
struct V_68 * V_4 = F_23 ( V_12 ) ;
if ( ! V_4 )
return - V_72 ;
if ( V_12 && F_28 ( V_4 -> V_4 . V_11 , V_71 , V_12 ) ) {
F_26 ( V_4 ) ;
return - V_73 ;
}
return F_25 ( V_49 , V_70 , V_4 , V_12 ) ;
}
int F_29 ( struct V_49 * V_49 , struct V_68 * * V_70 ,
unsigned char * V_71 , int V_12 )
{
struct V_68 * V_4 = F_23 ( V_12 ) ;
if ( ! V_4 )
return - V_72 ;
if ( V_12 )
memcpy ( V_4 -> V_4 . V_11 , V_71 , V_12 ) ;
return F_25 ( V_49 , V_70 , V_4 , V_12 ) ;
}
...
unsigned char * V_74 = F_2 ( V_2 ) ;
if ( V_4 -> V_14 ) {
V_44 = ( unsigned char * ) V_74 + V_4 -> V_15 ;
...
int V_76 , V_77 ;
V_44 = V_74 + V_4 -> V_13 ;
for ( V_76 = V_44 [ 2 ] , V_77 = V_44 [ 1 ] ;
V_76 <= V_77 ;
V_76 += 4
) {
if ( V_76 + 3 > V_77 )
break;
if ( memcmp ( & V_4 -> V_78 , & V_44 [ V_76 - 1 ] , 4 ) == 0 )
break;
}
if ( V_76 + 3 <= V_77 ) {
V_4 -> V_51 = 1 ;
F_11 ( V_2 ) -> V_5 = V_4 -> V_78 ;
F_4 ( & V_44 [ V_76 - 1 ] , V_2 , V_7 ) ;
V_44 [ 2 ] = V_76 + 4 ;
} else {
F_31 ( L_1 ,
V_79 ) ;
...
if ( ! V_4 -> V_41 )
return 0 ;
F_21 ( V_2 , V_67 , 0 , F_6 ( 16 << 24 ) ) ;
return - V_33 ;
}
if ( V_7 -> V_85 != V_86 )
return - V_33 ;
for ( V_76 = V_44 [ 2 ] , V_77 = V_44 [ 1 ] ; V_76 <= V_77 ; V_76 += 4 ) {
if ( V_76 + 3 > V_77 ) {
F_21 ( V_2 , V_67 , 0 , F_6 ( ( V_4 -> V_13 + 2 ) << 24 ) ) ;
return - V_33 ;
}
memcpy ( & V_78 , & V_44 [ V_76 - 1 ] , 4 ) ;
V_81 = V_2 -> V_87 ;
F_34 ( V_2 , NULL ) ;
V_82 = F_35 ( V_2 , V_78 , V_9 -> V_40 , V_9 -> V_88 , V_2 -> V_36 ) ;
V_80 = F_17 ( V_2 ) ;
if ( V_82 || ( V_80 -> V_85 != V_37 && V_80 -> V_85 != V_86 ) ) {
F_36 ( V_2 ) ;
V_2 -> V_87 = V_81 ;
return - V_33 ;
}
