...
struct V_2 * V_3 ;
struct V_31 * V_32 ;
error = F_10 ( V_33 [ V_1 ] , V_7 [ V_1 ] , V_34 ,
...
F_12 ( V_5 , & V_26 -> V_5 -> V_1 ) ;
if ( V_27 -> V_16 == V_17 )
V_19 [ V_1 ] = - 1 ;
error = F_13 ( V_5 , V_15 [ V_1 ] , V_20 [ V_1 ] ,
V_36 ,
V_18 [ V_1 ] , V_19 [ V_1 ] ,
V_27 -> V_16 ,
& V_29 ) ;
...
if ( ( error = F_14 ( V_29 , 0 , & V_29 -> V_41 ) ) < 0 ) {
F_11 ( V_5 ) ;
return error ;
}
if ( ( error = F_15 ( V_29 ) ) < 0 ) {
F_11 ( V_5 ) ;
return error ;
}
if ( V_22 [ V_1 ] > 0 && V_22 [ V_1 ] != V_42 ) {
int V_43 = V_44 ;
if ( V_23 [ V_1 ] == V_45 )
V_23 [ V_1 ] = - 1 ;
if ( V_27 -> V_16 == V_17 )
...
if ( ( error = F_18 ( V_32 , 0 , 1 ) ) < 0 ) {
F_11 ( V_5 ) ;
return error ;
}
if ( ( error = F_19 ( V_32 , 0 , 1 , NULL ) ) < 0 ) {
F_11 ( V_5 ) ;
return error ;
}
}
...
static void T_2 F_23 ( struct V_4 * V_26 )
{
F_11 ( F_24 ( V_26 ) ) ;
F_21 ( V_26 , NULL ) ;
}
static int F_25 ( struct V_4 * V_26 , T_3 V_52 )
{
struct V_30 * V_5 = F_24 ( V_26 ) ;
...
static int F_29 ( struct V_4 * V_26 )
{
struct V_30 * V_5 = F_24 ( V_26 ) ;
struct V_2 * V_3 = V_5 -> V_35 ;
struct V_28 * V_29 = V_3 -> V_29 ;
