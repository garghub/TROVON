...
T_2 V_96 , enum V_66 V_19 , void * V_68 )
{
struct V_5 * V_7 = F_3 ( V_9 ) ;
enum V_69 V_70 ;
struct V_10 * V_3 ;
...
return F_54 ( & V_7 -> V_8 , & V_3 -> V_13 , V_102 | V_103 ) ;
}
...
static int F_70 ( struct V_6 * V_9 , enum V_107 V_108 ,
unsigned long V_109 )
{
struct V_5 * V_7 = F_3 ( V_9 ) ;
int V_58 ;
switch ( V_108 ) {
case V_110 :
V_58 = F_62 ( V_7 , (struct V_104 * ) V_109 ) ;
break;
case V_111 :
V_58 = F_63 ( V_7 ) ;
break;
...
static int F_71 ( struct V_1 * V_115 , int V_29 )
{
struct V_5 * V_7 ;
V_7 = F_50 ( sizeof( * V_7 ) , V_116 ) ;
if ( ! V_7 )
return - V_117 ;
V_7 -> V_29 = V_29 ;
V_7 -> V_8 . V_118 = F_5 ;
F_72 ( & V_7 -> V_8 , & V_115 -> V_4 ) ;
F_73 ( & V_7 -> V_32 ) ;
V_115 -> V_4 . V_119 ++ ;
return 0 ;
}
static void F_74 ( struct V_1 * V_115 )
{
F_75 ( & V_115 -> V_63 ) ;
while ( ! F_25 ( & V_115 -> V_4 . V_120 ) ) {
struct V_5 * V_7 = F_26 ( & V_115 -> V_4 . V_120 ,
struct V_5 , V_8 . V_9 . V_121 ) ;
F_14 ( & V_7 -> V_8 . V_9 . V_121 ) ;
F_75 ( & V_7 -> V_8 . V_63 ) ;
F_6 ( V_7 ) ;
}
F_6 ( V_115 ) ;
...
struct V_1 * V_115 ;
int V_124 , V_49 ;
V_115 = F_50 ( sizeof( * V_115 ) , V_116 ) ;
if ( ! V_115 )
return - V_117 ;
F_77 ( V_125 , V_115 -> V_4 . V_126 ) ;
F_77 ( V_127 , V_115 -> V_4 . V_126 ) ;
V_115 -> V_4 . V_128 = F_28 ;
V_115 -> V_4 . V_129 = F_31 ;
V_115 -> V_4 . V_130 = F_37 ;
V_115 -> V_4 . V_131 = F_42 ;
V_115 -> V_4 . V_132 = F_48 ;
V_115 -> V_4 . V_133 = F_55 ;
V_115 -> V_4 . V_134 = F_70 ;
V_115 -> V_4 . V_48 = & V_123 -> V_48 ;
F_73 ( & V_115 -> V_4 . V_120 ) ;
F_73 ( & V_115 -> V_46 ) ;
F_78 ( & V_115 -> V_42 ) ;
F_79 ( & V_115 -> V_63 , F_20 , ( unsigned long ) V_115 ) ;
for ( V_49 = 0 ; V_49 < 127 ; V_49 ++ ) {
V_124 = F_71 ( V_115 , V_49 ) ;
if ( V_124 ) {
F_74 ( V_115 ) ;
return V_124 ;
}
}
V_124 = F_80 ( & V_115 -> V_4 ) ;
if ( V_124 ) {
F_81 ( L_5 ,
V_124 ) ;
F_74 ( V_115 ) ;
...
static int F_83 ( struct V_122 * V_123 )
{
struct V_1 * V_115 = F_84 ( V_123 ) ;
F_85 ( & V_115 -> V_4 ) ;
F_74 ( V_115 ) ;
return 0 ;
}
bool F_86 ( struct V_6 * V_9 , void * V_135 )
{
if ( V_9 -> V_47 -> V_48 -> V_136 == & V_137 . V_136 ) {
struct V_5 * V_7 = F_3 ( V_9 ) ;
unsigned V_138 = * ( unsigned * ) V_135 ;
return V_138 == V_7 -> V_29 ;
}
return false ;
}
static int F_87 ( void )
{
int V_124 = F_88 ( & V_137 ) ;
if ( V_124 == 0 ) {
V_123 = F_89 ( & V_139 ) ;
if ( F_90 ( V_123 ) ) {
F_91 ( & V_137 ) ;
