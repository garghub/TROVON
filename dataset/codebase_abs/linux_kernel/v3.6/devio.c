...
static long F_194 ( struct V_13 * V_13 , unsigned int V_303 ,
void T_3 * V_115 )
{
struct V_7 * V_8 = V_13 -> V_25 ;
struct V_162 * V_162 = V_13 -> V_304 . V_305 -> V_18 ;
struct V_26 * V_10 = V_8 -> V_10 ;
int V_16 = - V_290 ;
if ( ! ( V_13 -> V_306 & V_307 ) )
return - V_308 ;
...
switch ( V_303 ) {
case V_309 :
F_56 ( & V_10 -> V_10 , L_30 , V_310 ) ;
V_16 = F_105 ( V_8 , V_115 ) ;
if ( V_16 >= 0 )
V_162 -> V_311 = V_312 ;
break;
case V_313 :
F_56 ( & V_10 -> V_10 , L_31 , V_310 ) ;
V_16 = F_116 ( V_8 , V_115 ) ;
if ( V_16 >= 0 )
V_162 -> V_311 = V_312 ;
break;
case V_314 :
F_56 ( & V_10 -> V_10 , L_32 , V_310 ) ;
V_16 = F_121 ( V_8 , V_115 ) ;
if ( V_16 >= 0 )
V_162 -> V_311 = V_312 ;
break;
case V_315 :
F_56 ( & V_10 -> V_10 , L_33 , V_310 ) ;
V_16 = F_128 ( V_8 ) ;
break;
case V_316 :
F_56 ( & V_10 -> V_10 , L_34 , V_310 ) ;
V_16 = F_124 ( V_8 , V_115 ) ;
if ( V_16 >= 0 )
V_162 -> V_311 = V_312 ;
break;
case V_317 :
F_56 ( & V_10 -> V_10 , L_35 , V_310 ) ;
V_16 = F_126 ( V_8 , V_115 ) ;
break;
case V_318 :
F_56 ( & V_10 -> V_10 , L_36 , V_310 ) ;
V_16 = F_127 ( V_8 , V_115 ) ;
break;
case V_319 :
F_56 ( & V_10 -> V_10 , L_37 , V_310 ) ;
V_16 = F_130 ( V_8 , V_115 ) ;
break;
case V_320 :
F_56 ( & V_10 -> V_10 , L_38 , V_310 ) ;
V_16 = F_132 ( V_8 , V_115 ) ;
break;
case V_321 :
F_56 ( & V_10 -> V_10 , L_39 , V_310 ) ;
...
#ifdef F_195
case V_322 :
F_56 ( & V_10 -> V_10 , L_40 , V_310 ) ;
V_16 = F_165 ( V_8 , V_115 ) ;
if ( V_16 >= 0 )
V_162 -> V_311 = V_312 ;
break;
case V_323 :
F_56 ( & V_10 -> V_10 , L_41 , V_310 ) ;
V_16 = F_169 ( V_8 , V_115 ) ;
if ( V_16 >= 0 )
V_162 -> V_311 = V_312 ;
break;
case V_324 :
F_56 ( & V_10 -> V_10 , L_42 , V_310 ) ;
V_16 = F_170 ( V_8 , V_115 ) ;
break;
case V_325 :
F_56 ( & V_10 -> V_10 , L_43 , V_310 ) ;
V_16 = F_173 ( V_8 , V_115 ) ;
if ( V_16 >= 0 )
V_162 -> V_311 = V_312 ;
break;
case V_326 :
F_56 ( & V_10 -> V_10 , L_44 , V_310 ) ;
V_16 = F_176 ( V_8 , V_115 ) ;
break;
case V_327 :
F_56 ( & V_10 -> V_10 , L_45 , V_310 ) ;
V_16 = F_177 ( V_8 , V_115 ) ;
break;
case V_328 :
F_56 ( & V_10 -> V_10 , L_46 , V_310 ) ;
V_16 = F_188 ( V_8 , F_175 ( V_115 ) ) ;
break;
#endif
case V_329 :
F_56 ( & V_10 -> V_10 , L_47 , V_310 ) ;
V_16 = F_152 ( V_8 , V_115 ) ;
break;
case V_330 :
F_56 ( & V_10 -> V_10 , L_48 , V_310 ) ;
V_16 = F_163 ( V_8 , V_115 ) ;
break;
case V_331 :
F_56 ( & V_10 -> V_10 , L_49 , V_310 ) ;
V_16 = F_164 ( V_8 , V_115 ) ;
break;
case V_332 :
F_56 ( & V_10 -> V_10 , L_50 , V_310 ) ;
V_16 = F_178 ( V_8 , V_115 ) ;
break;
case V_333 :
F_56 ( & V_10 -> V_10 , L_51 , V_310 ) ;
V_16 = F_179 ( V_8 , V_115 ) ;
break;
case V_334 :
F_56 ( & V_10 -> V_10 , L_52 , V_310 ) ;
V_16 = F_180 ( V_8 , V_115 ) ;
break;
case V_335 :
F_56 ( & V_10 -> V_10 , L_53 , V_310 ) ;
V_16 = F_187 ( V_8 , V_115 ) ;
break;
case V_336 :
F_56 ( & V_10 -> V_10 , L_54 , V_310 ) ;
V_16 = F_189 ( V_8 , V_115 ) ;
break;
case V_337 :
F_56 ( & V_10 -> V_10 , L_55 , V_310 ) ;
...
static long F_196 ( struct V_13 * V_13 , unsigned int V_303 ,
unsigned long V_172 )
{
int V_16 ;
V_16 = F_194 ( V_13 , V_303 , ( void T_3 * ) V_172 ) ;
return V_16 ;
}
static long F_197 ( struct V_13 * V_13 , unsigned int V_303 ,
unsigned long V_172 )
{
int V_16 ;
V_16 = F_194 ( V_13 , V_303 , F_168 ( V_172 ) ) ;
return V_16 ;
}
static unsigned int F_198 ( struct V_13 * V_13 ,
struct V_340 * V_112 )
{
struct V_7 * V_8 = V_13 -> V_25 ;
unsigned int V_341 = 0 ;
F_199 ( V_13 , & V_8 -> V_112 , V_112 ) ;
if ( V_13 -> V_306 & V_307 && ! F_8 ( & V_8 -> V_64 ) )
V_341 |= V_342 | V_343 ;
if ( ! F_7 ( V_8 ) )
V_341 |= V_344 | V_345 ;
return V_341 ;
}
static void F_200 ( struct V_26 * V_67 )
{
struct V_7 * V_8 ;
struct V_96 V_97 ;
...
static int F_202 ( struct V_346 * V_347 ,
unsigned long V_348 , void * V_10 )
{
switch ( V_348 ) {
case V_349 :
break;
