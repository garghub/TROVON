...
return - V_74 ;
if ( V_20 != V_95 ) {
struct V_96 * V_96 = F_66 ( V_3 , V_20 ) ;
char V_97 [ 64 ] ;
if ( V_96 == NULL )
return - V_74 ;
snprintf ( V_97 , sizeof( V_97 ) , L_23 , V_20 ) ;
F_67 ( V_96 , V_97 ) ;
}
return 0 ;
}
static void F_68 ( struct V_17 * V_3 )
{
...
struct V_62 * F_73 ( struct V_27 * V_3 , T_6 V_20 )
{
struct V_13 * * V_84 = & V_3 -> V_13 ;
struct V_13 * V_77 = NULL ;
struct V_62 * V_62 ;
...
struct V_62 * F_74 ( struct V_27 * V_3 , T_6 V_20 )
{
char V_99 [ V_22 ] ;
const char * V_88 = L_24 ;
struct V_62 * V_62 = F_73 ( V_3 , V_20 ) ;
if ( V_62 && ( V_62 -> V_20 == V_20 ) )
goto V_100;
if ( ( V_20 != V_95 ) &&
( V_20 != V_101 ) &&
( V_50 . V_102 ) ) {
sprintf ( V_99 , L_25 , V_50 . V_102 , V_20 ) ;
if ( F_75 ( V_99 , V_103 ) ) {
static struct V_104 * V_105 ;
if ( ! V_105 )
V_105 = F_76 ( true , NULL ) ;
if ( ! F_77 ( V_105 , V_99 ) ) {
F_78 ( L_26 , V_99 ) ;
F_79 ( V_105 , V_99 ) ;
}
...
V_62 = F_72 ( V_3 , V_20 , V_88 ) ;
V_100:
return V_62 ;
}
void F_80 ( struct V_27 * V_3 , T_7 V_106 , void * V_107 )
{
struct V_13 * V_29 ;
...
char * F_81 ( struct V_62 * V_3 , char * V_108 , T_4 V_109 )
{
if ( F_82 ( V_3 ) )
snprintf ( V_108 , V_109 , L_27 , L_28 ) ;
else if ( F_83 ( V_3 ) )
snprintf ( V_108 , V_109 , L_27 , L_29 ) ;
else
snprintf ( V_108 , V_109 , L_30 , L_29 , V_3 -> V_20 ) ;
return V_108 ;
}
void F_84 ( struct V_27 * V_110 , T_8 V_111 )
{
struct V_13 * V_66 ;
struct V_62 * V_62 ;
for ( V_66 = F_10 ( V_110 ) ; V_66 ; V_66 = F_35 ( V_66 ) ) {
V_62 = F_11 ( V_66 , struct V_62 , V_13 ) ;
V_62 -> V_111 = V_111 ;
}
return;
}
