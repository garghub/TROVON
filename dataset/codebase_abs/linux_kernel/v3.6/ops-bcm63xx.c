...
static void T_2 F_24 ( struct V_70 * V_71 )
{
static int V_72 = - 1 ;
int V_73 , V_74 , V_75 ;
T_1 V_6 ;
...
static int F_28 ( struct V_25 * V_26 , int V_8 )
{
switch ( V_26 -> V_29 ) {
case V_82 :
return ( F_4 ( V_8 ) == 0 ) ;
...
static int F_30 ( struct V_25 * V_26 , unsigned int V_8 ,
int V_2 , int V_3 , T_1 * V_6 )
{
T_1 V_1 ;
T_1 V_11 = V_2 & ~ 3 ;
...
static int F_31 ( struct V_25 * V_26 , unsigned int V_8 ,
int V_2 , int V_3 , T_1 V_6 )
{
T_1 V_1 ;
T_1 V_11 = V_2 & ~ 3 ;
