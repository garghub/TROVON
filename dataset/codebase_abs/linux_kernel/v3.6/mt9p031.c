...
V_1 -> V_4 . V_194 = & V_1 -> V_56 ;
if ( V_1 -> V_56 . error ) {
F_60 ( V_195 L_8 ,
V_196 , V_1 -> V_56 . error ) ;
V_13 = V_1 -> V_56 . error ;
goto V_197;
}
...
V_154 ) ;
F_62 ( & V_1 -> V_155 ) ;
F_63 ( & V_1 -> V_4 , V_6 , & V_198 ) ;
V_1 -> V_4 . V_199 = & V_200 ;
V_1 -> V_85 . V_201 = V_202 ;
V_13 = F_64 ( & V_1 -> V_4 . V_203 , 1 , & V_1 -> V_85 , 0 ) ;
if ( V_13 < 0 )
goto V_197;
V_1 -> V_4 . V_201 |= V_204 ;
V_1 -> V_60 . V_72 = V_91 ;
