...
F_32 ( V_5 , V_131 ) ;
F_83 ( V_5 ) ;
V_79 = F_138 ( V_5 -> V_225 , & V_5 -> V_36 . V_38 . V_39 ) ;
if ( ! V_79 ) {
...
int F_146 ( struct V_133 * V_44 )
{
int V_241 ;
if ( V_242 > V_243 )
V_242 = V_243 ;
V_241 = F_147 ( V_44 , V_244 ,
V_242 ) ;
if ( V_241 < 0 )
return V_241 ;
V_44 -> V_245 = F_132 ;
...
static inline void F_148 ( struct V_252 * V_13 ,
unsigned int V_253 , unsigned int V_108 ,
unsigned int V_254 )
{
struct V_255 * V_256 = (struct V_255 * ) ( V_13 + 1 ) ;
F_149 ( V_13 , V_253 , 0 , 0 ) ;
V_13 -> V_58 = F_35 ( F_150 ( V_257 ) | ( 1 << 23 ) ) ;
V_13 -> V_108 = F_35 ( F_151 ( V_108 >> 5 ) ) ;
V_13 -> V_258 = F_35 ( F_152 ( V_254 >> 5 ) ) ;
V_13 -> V_259 = F_35 ( F_45 ( V_253 - sizeof( V_13 -> V_260 ) , 16 ) ) ;
V_256 -> V_261 = F_35 ( F_150 ( V_262 ) ) ;
V_256 -> V_7 = F_35 ( V_108 ) ;
}
static int F_153 ( struct V_133 * V_44 , unsigned int V_29 ,
...
unsigned int V_253 = F_154 ( sizeof( struct V_252 ) +
...
F_156 ( V_272 , V_264 , V_267 , V_268 ) ;
}
F_28 ( V_44 -> V_45 [ V_29 ] , V_2 ) ;
return 0 ;
}
static int F_157 ( struct V_4 * V_5 , struct V_263 * V_264 ,
...
if ( V_81 > V_277 )
V_81 = V_277 ;
V_187 = F_153 ( V_5 -> V_44 , V_5 -> V_29 , V_264 ,
...
static void F_158 ( struct V_278 * V_279 , unsigned int V_280 ,
unsigned int V_22 , unsigned int V_265 )
{
unsigned int V_88 , V_81 ;
int V_187 ;
...
if ( V_81 > V_277 )
V_81 = V_277 ;
V_187 = F_153 ( V_279 -> V_44 , V_279 -> V_29 , NULL ,
V_22 , V_81 , NULL , 0 ) ;
if ( V_187 < 0 )
break;
}
}
static int F_159 ( struct V_4 * V_5 , unsigned int V_48 ,
...
V_13 -> V_286 = F_160 ( F_161 ( V_282 ) | F_162 ( V_5 -> V_20 ) ) ;
V_13 -> V_287 = F_160 ( 0 ) ;
...
static int F_163 ( struct V_4 * V_5 , unsigned int V_48 ,
...
static int F_164 ( struct V_133 * V_44 )
{
struct V_129 * V_130 = F_72 ( V_44 ) ;
struct V_269 * V_270 = V_44 -> V_270 ;
...
V_187 = F_167 ( V_44 , V_130 -> V_298 -> V_299 . V_300 ,
...
F_168 ( V_295 ) ;
F_169 ( V_130 -> V_45 [ 0 ] , V_294 , V_295 ) ;
V_44 -> V_305 = F_163 ;
V_44 -> V_306 = F_159 ;
V_44 -> V_307 = F_157 ;
V_44 -> V_308 = F_158 ;
...
static void * F_170 ( const struct V_129 * V_130 )
{
struct V_133 * V_44 ;
struct V_228 * V_229 ;
int V_88 , V_241 ;
V_44 = F_171 ( sizeof( * V_130 ) , V_130 -> V_321 ) ;
if ( ! V_44 ) {
F_40 ( L_56 , V_130 ) ;
return NULL ;
}
...
V_44 -> V_335 = & V_336 ;
V_44 -> V_96 = F_172 ( F_143 ( V_130 -> V_45 [ 0 ] ) ) << 8 ;
F_40 ( L_59 ,
...
static int F_176 ( void * V_55 , const T_2 * V_343 ,
...
if ( ! V_2 )
goto V_348;
F_177 ( V_2 , & V_343 [ 1 ] , V_7 ) ;
} else {
if ( F_30 ( * ( V_349 * ) V_343 != * ( V_349 * ) V_345 -> V_350 ) ) {
F_40 ( L_62 ,
V_345 -> V_350 , F_178 ( * V_343 ) ,
F_178 ( * ( V_351 * ) V_345 -> V_350 ) ,
V_345 -> V_352 ) ;
return 0 ;
}
V_2 = F_179 ( V_345 , V_353 , V_353 ) ;
if ( F_30 ( ! V_2 ) )
goto V_348;
}
...
static int F_180 ( void * V_55 , enum V_358 V_49 )
{
struct V_133 * V_44 = V_55 ;
switch ( V_49 ) {
case V_359 :
...
{
int V_241 ;
F_182 ( V_363 L_71 , V_364 ) ;
V_241 = F_183 ( & V_336 , & V_341 ) ;
if ( V_241 < 0 )
return V_241 ;
F_184 ( V_365 , & V_366 ) ;
return 0 ;
