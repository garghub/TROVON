...
V_91 = V_89 -> V_94 ;
V_89 -> V_94 &= V_95 | V_96 ;
if ( ! V_89 -> V_94 || V_91 != V_89 -> V_94 )
V_90 ++ ;
V_91 = V_89 -> V_97 ;
V_89 -> V_97 &= V_98 | V_99 | V_96 ;
if ( ! V_89 -> V_97 || V_91 != V_89 -> V_97 )
V_90 ++ ;
V_91 = V_89 -> V_100 ;
V_89 -> V_100 &= V_99 | V_95 | V_96 ;
if ( ! V_89 -> V_100 || V_91 != V_89 -> V_100 )
V_90 ++ ;
V_91 = V_89 -> V_101 ;
V_89 -> V_101 &= V_102 ;
if ( ! V_89 -> V_101 || V_91 != V_89 -> V_101 )
V_90 ++ ;
V_91 = V_89 -> V_103 ;
V_89 -> V_103 &= V_102 | V_104 ;
if ( ! V_89 -> V_103 || V_91 != V_89 -> V_103 )
V_90 ++ ;
if ( V_90 )
return 1 ;
if ( V_89 -> V_94 != V_95 && V_89 -> V_94 != V_96 )
V_90 ++ ;
if ( V_89 -> V_97 != V_98 &&
V_89 -> V_97 != V_99 &&
V_89 -> V_97 != V_96 )
V_90 ++ ;
if ( V_89 -> V_100 != V_99 &&
V_89 -> V_100 != V_96 && V_89 -> V_100 != V_95 )
V_90 ++ ;
if ( V_89 -> V_103 != V_102 && V_89 -> V_103 != V_104 )
V_90 ++ ;
...
static void F_45 ( struct V_3 * V_4 , unsigned int * V_122 ,
int V_123 )
{
struct V_5 * V_6 = V_4 -> V_7 ;
F_44 ( V_116 , & ( V_6 -> V_117 ) ,
& ( V_6 -> V_118 ) , V_122 ,
V_123 & V_119 ) ;
F_46 ( V_6 -> V_124 + V_125 , 0 , 1 ,
V_6 -> V_117 , 2 ) ;
F_46 ( V_6 -> V_124 + V_125 , 0 , 2 ,
V_6 -> V_118 , 2 ) ;
}
...
V_156 = V_6 -> V_158 ;
V_155 = F_51 ( V_11 , V_6 -> V_159 ,
V_156 * sizeof( short ) ) ;
V_156 = V_155 / sizeof( short ) ;
if ( V_89 -> V_103 == V_102 )
V_6 -> V_158 -= V_156 ;
F_52 ( V_6 -> V_46 + V_50 , V_6 -> V_159 , V_155 ) ;
F_19 ( & V_4 -> V_40 , V_39 ) ;
...
& ( V_89 -> V_110 ) ,
V_89 -> V_39 ) ;
F_46 ( V_6 -> V_124 + V_166 , 0 , 1 ,
V_6 -> V_151 , 2 ) ;
F_46 ( V_6 -> V_124 + V_166 , 0 , 2 ,
V_6 -> V_152 , 2 ) ;
}
if ( V_89 -> V_103 == V_102 )
...
static void F_55 ( struct V_3 * V_4 , unsigned int V_169 )
{
const struct V_82 * V_83 = F_40 ( V_4 ) ;
struct V_5 * V_6 = V_4 -> V_7 ;
...
static T_2 F_57 ( int V_175 , void * V_176 )
{
...
V_127 = V_11 -> V_127 ;
V_127 -> V_172 = 0 ;
V_178 = F_58 ( V_6 -> V_57 + V_182 ) ;
if ( ( V_183 & V_178 ) == 0 )
return V_181 ;
F_59 ( V_6 -> V_57 + V_184 ) ;
F_60 ( V_6 -> V_185 | V_186 ,
V_6 -> V_57 + V_182 ) ;
...
static struct V_193 * F_64 ( struct V_3 * V_4 ,
struct V_194 * V_195 )
{
const struct V_82 * V_83 ;
struct V_193 * V_196 = NULL ;
int V_197 = V_195 -> V_198 [ 0 ] ;
int V_199 = V_195 -> V_198 [ 1 ] ;
int V_20 ;
F_65 (pcidev) {
if ( V_196 -> V_200 != V_201 )
continue;
for ( V_20 = 0 ; V_20 < F_66 ( V_202 ) ; V_20 ++ ) {
V_83 = & V_202 [ V_20 ] ;
if ( V_83 -> V_203 != V_196 -> V_204 )
continue;
if ( V_197 || V_199 ) {
if ( V_196 -> V_197 -> V_205 != V_197 ||
F_67 ( V_196 -> V_206 ) != V_199 ) {
continue;
}
}
F_68 ( V_4 -> V_37 ,
L_12 ,
V_83 -> V_207 ,
V_196 -> V_197 -> V_205 , F_67 ( V_196 -> V_206 ) ) ;
V_4 -> V_208 = V_83 ;
return V_196 ;
}
}
...
int V_20 ;
int V_209 ;
if ( F_70 ( V_4 , sizeof( struct V_5 ) ) < 0 )
return - V_210 ;
V_6 = V_4 -> V_7 ;
V_196 = F_64 ( V_4 , V_195 ) ;
if ( ! V_196 )
return - V_211 ;
F_71 ( V_4 , & V_196 -> V_4 ) ;
V_83 = F_40 ( V_4 ) ;
if ( F_72 ( V_196 , V_4 -> V_212 -> V_213 ) ) {
F_17 ( V_4 -> V_37 ,
L_14 ) ;
return - V_211 ;
}
V_6 -> V_57 = F_73 ( V_196 , 0 ) ;
V_6 -> V_22 = F_73 ( V_196 , 1 ) ;
V_6 -> V_29 = F_73 ( V_196 , 2 ) ;
V_6 -> V_124 = F_73 ( V_196 , 3 ) ;
if ( V_83 -> V_214 )
V_6 -> V_46 = F_73 ( V_196 , 4 ) ;
F_60 ( V_186 ,
V_6 -> V_57 + V_182 ) ;
if ( F_74 ( V_196 -> V_175 , F_57 ,
V_215 , V_4 -> V_212 -> V_213 , V_4 ) ) {
F_68 ( V_4 -> V_37 , L_15 ,
V_196 -> V_175 ) ;
return - V_38 ;
}
V_4 -> V_175 = V_196 -> V_175 ;
V_4 -> V_216 = V_83 -> V_207 ;
V_209 = F_75 ( V_4 , 7 ) ;
if ( V_209 )
return V_209 ;
V_11 = V_4 -> V_217 + 0 ;
V_4 -> V_177 = V_11 ;
V_11 -> type = V_218 ;
V_11 -> V_219 = V_220 | V_221 | V_222 | V_223 ;
V_11 -> V_121 = V_83 -> V_224 ;
V_11 -> V_225 = V_83 -> V_224 ;
V_11 -> V_226 = ( 1 << V_83 -> V_227 ) - 1 ;
V_11 -> V_228 = V_83 -> V_229 ;
V_11 -> V_230 = F_7 ;
V_11 -> V_231 = F_16 ;
V_11 -> V_232 = F_47 ;
V_11 -> V_233 = F_43 ;
...
V_11 = V_4 -> V_217 + 2 ;
V_209 = F_76 ( V_4 , V_11 , NULL ,
V_6 -> V_124 + V_242 ) ;
if ( V_209 )
return V_209 ;
V_11 = V_4 -> V_217 + 3 ;
V_11 -> type = V_243 ;
V_11 -> V_219 = V_220 | V_244 ;
V_11 -> V_121 = 256 ;
V_11 -> V_226 = 0xff ;
V_11 -> V_230 = F_28 ;
V_11 = V_4 -> V_217 + 4 ;
V_11 -> type = V_245 ;
V_11 -> V_219 = V_220 | V_236 | V_244 ;
V_11 -> V_121 = V_246 ;
V_11 -> V_226 = 0xff ;
V_11 -> V_230 = F_33 ;
V_11 -> V_240 = F_32 ;
for ( V_20 = 0 ; V_20 < V_11 -> V_121 ; V_20 ++ )
F_30 ( V_4 , V_20 , V_11 -> V_226 / 2 ) ;
V_11 = V_4 -> V_217 + 5 ;
V_11 -> type = V_245 ;
V_11 -> V_219 = V_220 | V_236 | V_244 ;
if ( V_83 -> V_85 == V_86 ) {
