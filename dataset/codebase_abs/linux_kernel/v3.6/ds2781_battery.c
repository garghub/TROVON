...
static int T_7 F_46 ( struct V_92 * V_93 )
{
int V_14 = 0 ;
struct V_1 * V_7 ;
V_7 = F_47 ( sizeof( * V_7 ) , V_94 ) ;
if ( ! V_7 ) {
V_14 = - V_95 ;
goto V_96;
}
F_48 ( V_93 , V_7 ) ;
V_7 -> V_6 = & V_93 -> V_6 ;
V_7 -> V_12 = V_93 -> V_6 . V_97 ;
V_7 -> V_4 . V_98 = F_49 ( & V_93 -> V_6 ) ;
V_7 -> V_4 . type = V_99 ;
V_7 -> V_4 . V_100 = V_101 ;
V_7 -> V_4 . V_102 = F_50 ( V_101 ) ;
V_7 -> V_4 . V_103 = F_30 ;
...
V_14 = F_52 ( & V_7 -> V_4 . V_6 -> V_84 , & V_105 ) ;
if ( V_14 ) {
F_22 ( V_7 -> V_6 , L_7 ) ;
goto V_106;
}
...
static int T_8 F_58 ( struct V_92 * V_93 )
{
struct V_1 * V_7 = F_59 ( V_93 ) ;
F_55 ( & V_7 -> V_4 . V_6 -> V_84 , & V_105 ) ;
F_56 ( & V_7 -> V_4 ) ;
F_57 ( V_7 ) ;
return 0 ;
