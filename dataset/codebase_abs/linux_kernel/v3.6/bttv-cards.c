...
static int T_1 F_55 ( struct V_1 * V_2 , const T_3 * V_188 ,
T_2 V_189 )
{
T_2 V_190 ;
T_3 V_191 ;
...
static void T_1 F_40 ( struct V_1 * V_2 , const T_3 V_202 [ 256 ] )
{
int V_4 ;
T_2 V_203 = 0 ;
int V_5 = - 1 ;
...
static void T_1 F_30 ( struct V_1 * V_2 , int V_219 )
{
int V_220 = ( 1 << V_219 ) ;
F_8 ( V_220 , V_220 ) ;
F_15 ( V_220 , 0 ) ;
...
{
static int V_223 [] V_224 = { 0x08 , 0x09 , 0x0a , 0x0b , 0x0d , 0x0d ,
...
V_225 = F_64 ( V_2 , 0x1E , 0 , V_223 [ V_4 ] , 1 ) ;
if ( V_225 != - 1 ) {
F_2 ( L_75 ,
V_223 [ V_4 ] , V_225 , F_12 ( V_2 , 0x1F , NULL ) ) ;
}
}
F_2 ( L_76 ) ;
}
...
{
static const T_3 V_239 [] = { 0x3 , 0x1 , 0x2 , 0x4 , 0xf , 0x7 , 0xe , 0x0 ,
...
unsigned char V_200 ) {
unsigned int V_242 ;
V_242 = ( V_200 << 7 ) | ( ( V_241 & 3 ) << 4 ) | ( V_240 & 0xf ) ;
F_15 ( 0x1ff , V_242 ) ;
...
V_265 [ 0 ] = 0 ;
V_265 [ 1 ] = 0 ;
V_198 = F_64 ( V_2 , ( V_266 << 1 ) , V_265 [ 0 ] , V_265 [ 1 ] , 1 ) ;
if ( V_198 ) {
F_3 ( L_91 ,
V_2 -> V_6 . V_12 , V_198 ) ;
return;
}
V_198 = F_12 ( V_2 , ( V_266 << 1 ) , NULL ) ;
if ( ! ( V_198 & V_267 ) ) {
F_3 ( L_92 ,
V_2 -> V_6 . V_12 , V_198 ) ;
return;
...
unsigned char V_241 ,
unsigned char V_200 ) {
const T_2 V_270 = ( ( V_240 & 0xf ) | ( V_241 & 3 ) << 4 ) ;
const T_2 V_271 = 1 << 16 ;
const T_2 V_272 = 1 << 17 ;
const T_2 V_273 = V_200 << 18 ;
...
if ( V_18 != V_285 )
F_2 ( L_99 , V_285 ) ;
while ( ( V_199 = F_89 ( V_287 ,
V_288 , V_199 ) ) ) {
unsigned char V_289 ;
F_90 ( V_199 , 0x53 , & V_289 ) ;
if ( V_70 )
F_2 ( L_100 ,
V_289 ) ;
}
