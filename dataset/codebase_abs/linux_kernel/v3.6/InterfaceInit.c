...
int V_24 ;
V_23 = F_10 ( V_25 ) ;
F_11 ( V_22 , ( V_26 ) & V_23 , 0x128 , 4 , TRUE ) ;
V_23 = F_10 ( V_27 ) ;
F_11 ( V_22 , ( V_26 ) & V_23 , 0x12C , 4 , TRUE ) ;
V_23 = F_10 ( V_28 ) ;
F_11 ( V_22 , ( V_26 ) & V_23 , 0x132 , 4 , TRUE ) ;
if ( ( ( T_1 ) ( V_22 -> V_29 ) ) -> V_30 == TRUE ) {
V_23 = F_10 ( V_31 ) ;
F_11 ( V_22 , ( V_26 ) & V_23 , 0x136 , 4 , TRUE ) ;
} else {
V_23 = F_10 ( V_32 ) ;
F_11 ( V_22 , ( V_26 ) & V_23 , 0x136 , 4 , TRUE ) ;
}
V_23 = F_10 ( V_33 ) ;
F_11 ( V_22 , ( V_26 ) & V_23 , 0x13C , 4 , TRUE ) ;
V_23 = F_10 ( V_34 ) ;
F_11 ( V_22 , ( V_26 ) & V_23 , 0x140 , 4 , TRUE ) ;
V_24 = F_12 ( V_22 , 0x0F0110F8 , ( V_35 * ) & V_23 , sizeof( V_35 ) ) ;
if ( V_24 < 0 ) {
F_4 ( V_22 , V_11 , V_12 , V_13 ,
L_2 ) ;
return;
}
V_23 |= 0x6 ;
V_23 = F_10 ( V_23 ) ;
F_11 ( V_22 , ( V_26 ) & V_23 , 0x1CC , 4 , TRUE ) ;
V_23 = F_10 ( V_36 ) ;
F_11 ( V_22 , ( V_26 ) & V_23 , 0x1C8 , 4 , TRUE ) ;
V_23 = F_10 ( V_37 ) ;
F_11 ( V_22 , ( V_26 ) & V_23 , 0x1D2 , 4 , TRUE ) ;
V_23 = F_10 ( V_38 ) ;
F_11 ( V_22 , ( V_26 ) & V_23 , 0x1D6 , 4 , TRUE ) ;
F_13 ( V_22 , 0x1FC , ( V_39 ) & V_23 ) ;
V_23 &= 0x0101FFFF ;
F_11 ( V_22 , ( V_26 ) & V_23 , 0x1FC , 4 , TRUE ) ;
F_13 ( V_22 , 0xA8 , ( V_39 ) & V_23 ) ;
if ( ( V_23 & 0x00FF0000 ) >> 16 > 0x30 ) {
V_23 = ( V_23 & 0xFF00FFFF ) | ( 0x30 << 16 ) ;
F_11 ( V_22 , ( V_26 ) & V_23 , 0xA8 , 4 , TRUE ) ;
}
F_13 ( V_22 , 0x148 , ( V_39 ) & V_23 ) ;
if ( ( V_23 & 0x00FF0000 ) >> 16 > 0x30 ) {
V_23 = ( V_23 & 0xFF00FFFF ) | ( 0x30 << 16 ) ;
F_11 ( V_22 , ( V_26 ) & V_23 , 0x148 , 4 , TRUE ) ;
}
V_23 = 0 ;
F_11 ( V_22 , ( V_26 ) & V_23 , 0x122 , 4 , TRUE ) ;
V_23 = 0 ;
F_11 ( V_22 , ( V_26 ) & V_23 , 0x1C2 , 4 , TRUE ) ;
}
...
T_1 V_1 ;
struct V_47 * V_48 ;
V_48 = F_16 ( sizeof( struct V_21 ) , V_49 + 1 ) ;
if ( V_48 == NULL ) {
...
if ( V_3 -> V_65 > V_66 ) {
T_2 V_67 = 4 ;
V_46 = F_27 ( V_3 , V_68 , & V_67 , sizeof( V_67 ) ) ;
if ( V_46 )
return V_46 ;
}
if ( V_69 & V_45 -> V_70 -> V_71 . V_72 ) {
if ( V_3 -> V_73 ) {
#ifdef F_28
F_29 ( & V_45 -> V_50 , 0 ) ;
V_41 -> V_74 = 1 ;
...
T_3 V_106 = 0 ;
int V_24 ;
V_1 -> V_45 = F_60 ( F_15 ( V_1 -> V_62 ) ) ;
V_1 -> V_30 = ( V_1 -> V_45 -> V_107 == V_108 ) ;
V_1 -> V_3 -> V_109 = V_110 ;
V_1 -> V_3 -> V_111 = V_112 ;
V_24 = F_12 ( V_1 -> V_3 , V_113 ,
( V_35 * ) & ( V_1 -> V_3 -> V_65 ) , sizeof( V_35 ) ) ;
if ( V_24 < 0 ) {
V_46 = V_24 ;
...
if ( V_106 == V_116 )
V_105 = TRUE ;
F_61 ( & V_1 -> V_45 -> V_50 , L_19 ,
V_1 -> V_62 -> V_117 ) ;
if ( V_105 == TRUE ) {
if ( V_1 -> V_30 )
V_46 = F_63 ( V_1 -> V_45 , V_118 , V_119 ) ;
F_4 ( V_1 -> V_3 , V_11 , V_12 , V_13 ,
L_20 ) ;
if ( V_46 || ( V_1 -> V_30 == FALSE ) ) {
V_104 = V_120 ;
V_102 = & V_101 -> V_102 [ V_120 ] . V_71 ;
F_4 ( V_1 -> V_3 , V_11 , V_12 , V_13 ,
L_21 ) ;
if ( ( ( V_1 -> V_30 == TRUE ) && ( F_57 ( V_102 ) == FALSE ) )
|| ( ( V_1 -> V_30 == FALSE ) && ( F_55 ( V_102 ) == FALSE ) ) ) {
F_4 ( V_1 -> V_3 , V_11 , V_12 , V_13 ,
L_22 ) ;
F_9 ( V_1 -> V_3 ) ;
V_46 = F_64 ( V_1 -> V_45 ) ;
...
if ( ( V_1 -> V_30 == FALSE ) && F_55 ( V_102 ) ) {
T_3 V_121 = F_10 ( V_31 ) ;
F_4 ( V_1 -> V_3 , V_11 , V_12 , V_13 ,
L_24 ) ;
F_11 ( V_1 -> V_3 , ( V_26 ) & V_121 , 0x136 , 4 , TRUE ) ;
}
} else {
V_104 = V_122 ;
...
static int F_70 ( struct V_40 * V_41 , T_5 V_152 )
{
T_1 V_1 = F_35 ( V_41 ) ;
V_1 -> V_153 = TRUE ;
if ( TRUE == V_1 -> V_154 ) {
