...
F_38 (ln, &bus->devices) {
int V_4 ;
struct V_62 * V_63 = F_39 ( V_46 ) ;
F_29 ( L_21 , F_40 ( V_63 ) ) ;
for ( V_4 = 0 ; V_4 < V_50 ; V_4 ++ ) {
struct V_1 * V_64 = & V_63 -> V_1 [ V_4 ] ;
if ( ! V_64 -> V_7 )
continue;
F_34 ( V_63 , V_4 ) ;
}
#ifdef F_32
( void ) F_41 ( V_63 , V_65 , & V_47 ) ;
V_12 -> V_66 &= ~ ( V_47 & V_67 ) ;
#endif
if ( ( V_63 -> V_68 >> 8 ) == V_69 )
continue;
...
if ( V_12 -> V_6 ) {
T_1 V_72 ;
( void ) F_43 ( V_12 -> V_52 , V_73 , & V_72 ) ;
( void ) F_44 ( V_12 -> V_52 , V_73 , V_72 | V_67 ) ;
} else {
}
V_71 = V_74 ;
}
F_38 (ln, &bus->devices) {
( void ) F_41 ( V_63 , V_75 , & V_47 ) ;
V_47 |= V_76 | V_77 | V_71 ;
( void ) F_45 ( V_63 , V_75 , V_47 ) ;
}
#endif
}
static void
F_46 ( struct V_78 * V_79 , struct V_14 * V_80 )
{
unsigned long V_81 ;
long V_82 ;
long V_47 ;
...
T_5 * V_85 ;
int V_4 ;
V_84 = F_47 ( sizeof( T_5 ) , V_86 ) ;
if ( ! V_84 )
return;
V_85 = F_47 ( sizeof( T_5 ) , V_86 ) ;
if ( ! V_85 ) {
F_48 ( V_84 ) ;
return;
}
V_47 = F_49 ( & V_81 , V_79 -> V_87 , V_79 -> V_88 ,
V_89 , V_84 ) ;
V_83 = V_84 -> V_90 [ 1 ] ;
V_47 |= F_49 ( & V_81 , V_79 -> V_87 , V_79 -> V_88 ,
V_91 , V_85 ) ;
...
struct V_1 * V_2 ;
V_95 = ( void * ) & ( V_84 -> V_90 [ 2 + V_4 * 3 ] ) ;
V_96 = ( void * ) & ( V_85 -> V_90 [ 2 + V_4 * 3 ] ) ;
switch( V_95 -> type & 0xff ) {
case V_97 :
V_80 -> V_16 . V_98 . V_7 = V_95 -> V_7 ;
V_80 -> V_16 . V_98 . V_8 = V_95 -> V_8 ;
V_80 -> V_16 . V_98 . V_9 = V_99 ;
break;
case V_100 :
if ( ! V_80 -> V_16 . V_56 . V_7 ) {
sprintf ( V_80 -> V_16 . V_101 ,
L_24 ,
( int ) V_80 -> V_16 . V_98 . V_7 ) ;
V_80 -> V_16 . V_102 = V_95 -> V_7 -
V_96 -> V_7 ;
V_2 = & V_80 -> V_16 . V_56 ;
V_2 -> V_55 = V_80 -> V_16 . V_101 ;
} else if ( ! V_80 -> V_16 . V_58 . V_7 ) {
sprintf ( V_80 -> V_16 . V_103 ,
L_25 ,
( int ) V_80 -> V_16 . V_98 . V_7 ) ;
V_2 = & V_80 -> V_16 . V_58 ;
V_2 -> V_55 = V_80 -> V_16 . V_103 ;
} else {
...
break;
case V_105 :
sprintf ( V_80 -> V_16 . V_106 , L_27 ,
( int ) V_80 -> V_16 . V_98 . V_7 ) ;
V_2 = & V_80 -> V_16 . V_61 ;
V_2 -> V_55 = V_80 -> V_16 . V_106 ;
V_2 -> V_7 = V_95 -> V_7 ;
V_2 -> V_8 = V_95 -> V_8 ;
V_2 -> V_9 = V_104 ;
V_2 -> V_6 = V_2 -> V_11 = V_2 -> V_10 = NULL ;
...
break;
case V_108 :
V_80 -> V_109 = F_52 ( V_95 -> V_7 , 64 * 1024 * 1024 ) ;
sprintf ( V_80 -> V_16 . V_110 , L_29 ,
( int ) V_80 -> V_16 . V_98 . V_7 ) ;
V_2 = & V_80 -> V_16 . V_54 ;
V_2 -> V_55 = V_80 -> V_16 . V_110 ;
V_2 -> V_7 = F_53 ( V_80 -> V_16 . V_111 ) ;
...
static void
F_54 ( struct V_78 * V_79 , struct V_14 * V_80 )
{
struct V_1 * V_2 ;
int V_114 ;
V_80 -> V_16 . V_102 = V_115 ;
V_114 = F_11 ( V_80 -> V_16 . V_28 + V_116 ) ;
V_2 = & ( V_80 -> V_16 . V_98 ) ;
V_2 -> V_55 = L_31 ;
V_2 -> V_7 = V_114 & 0xff ;
V_2 -> V_8 = ( V_114 >> 8 ) & 0xff ;
V_2 = & ( V_80 -> V_16 . V_56 ) ;
sprintf ( V_80 -> V_16 . V_101 , L_24 ,
( int ) V_80 -> V_16 . V_98 . V_7 ) ;
V_2 -> V_55 = V_80 -> V_16 . V_101 ;
#if 1
F_55 ( V_79 , V_2 ) ;
#else
V_2 -> V_7 = F_11 ( V_80 -> V_16 . V_28 + V_117 ) ;
if ( V_2 -> V_7 & 1 ) {
unsigned long V_118 ;
V_2 -> V_9 = V_104 ;
V_2 -> V_7 &= V_119 ;
V_2 -> V_7 = F_56 ( F_57 ( V_80 ) , V_2 -> V_7 ) ;
V_118 = ~ F_11 ( V_80 -> V_16 . V_28 + V_120 ) ;
V_118 /= V_121 ;
V_2 -> V_7 += ( V_118 + 1 ) * F_58 ( V_79 -> V_122 . V_7 ) ;
...
#endif
V_2 = & ( V_80 -> V_16 . V_58 ) ;
sprintf ( V_80 -> V_16 . V_103 , L_25 ,
( int ) V_80 -> V_16 . V_98 . V_7 ) ;
V_2 -> V_55 = V_80 -> V_16 . V_103 ;
#if 1
F_59 ( V_79 , V_2 ) ;
#else
V_2 -> V_7 = F_11 ( V_80 -> V_16 . V_28 + V_123 ) ;
if ( V_2 -> V_7 & 1 ) {
unsigned long V_118 ;
V_2 -> V_9 = V_104 ;
V_2 -> V_7 &= V_119 ;
V_2 -> V_7 = F_56 ( F_57 ( V_80 ) , V_2 -> V_7 ) ;
V_118 = F_11 ( V_80 -> V_16 . V_28 + V_124 ) ;
V_2 -> V_8 = V_2 -> V_7 + ~ V_118 ;
}
#endif
V_2 = & ( V_80 -> V_16 . V_54 ) ;
...
V_2 -> V_55 = V_80 -> V_16 . V_110 ;
V_2 -> V_9 = V_113 ;
V_2 -> V_7 = F_11 ( V_80 -> V_16 . V_28 + V_125 ) & ~ 1L ;
V_2 -> V_8 = V_2 -> V_7 + ( F_11 ( V_80 -> V_16 . V_28 + V_126 ) ^ ( V_112 - 1 ) ) ;
V_114 = F_53 ( V_80 -> V_16 . V_111 ) ;
V_2 -> V_7 |= V_114 ;
V_2 -> V_8 |= V_114 ;
}
static int T_6
...
#ifdef F_37
#endif
V_128 = F_11 ( V_3 -> V_16 . V_28 + V_129 + 4 ) & 1 ;
if ( V_128 ) {
F_2 ( V_5 L_32 ) ;
}
V_127 = F_11 ( V_3 -> V_16 . V_28 + V_130 ) ;
if ( V_127 & V_131 ) {
F_2 ( V_5 L_33 ) ;
V_127 &= ~ V_131 ;
F_22 ( V_127 , V_3 -> V_16 . V_28 + V_130 ) ;
}
V_127 = F_11 ( V_3 -> V_16 . V_28 + V_129 ) ;
F_22 ( V_127 | V_132 , V_3 -> V_16 . V_28 + V_129 ) ;
if ( V_128 )
F_61 ( V_133 ) ;
if ( 0 == F_11 ( V_3 -> V_16 . V_28 + V_134 ) ) {
F_2 ( V_5 L_34 ) ;
F_22 ( 0x3 , V_3 -> V_16 . V_28 + V_134 ) ;
}
return 0 ;
}
static int T_6
F_62 ( struct V_78 * V_63 )
{
struct V_14 * V_80 ;
F_63 ( V_135 ) ;
struct V_31 * V_136 ;
...
void * V_140 ;
char * V_141 ;
void T_3 * V_142 = F_52 ( V_63 -> V_122 . V_7 , 4096 ) ;
int V_143 ;
V_139 = F_11 ( V_142 + V_144 ) ;
if ( F_64 ( V_63 ) ) {
V_139 &= 0xf ;
switch ( V_139 ) {
...
F_2 ( V_145 L_42 ,
V_141 , V_139 & 0xf , ( long ) V_63 -> V_122 . V_7 ) ;
if ( V_139 < 2 ) {
F_2 ( V_44 L_43
L_44 ) ;
}
...
} else if ( F_65 ( V_63 ) || F_66 ( V_63 ) ) {
int V_147 , V_148 ;
V_139 &= 0xff ;
V_147 = V_139 >> 4 , V_148 = V_139 & 0xf ;
F_2 ( V_145 L_45 ,
F_65 ( V_63 ) ? L_46 : L_47 , V_147 ,
V_148 , V_139 , ( long ) V_63 -> V_122 . V_7 ) ;
V_138 = & V_149 ;
} else {
F_2 ( V_60 L_48 ,
( long ) V_63 -> V_122 . V_7 ) ;
...
V_140 = F_67 ( V_63 -> V_122 . V_7 + V_151 ) ;
V_80 = F_47 ( sizeof( struct V_14 ) , V_86 ) ;
if ( ! V_80 ) {
F_2 ( V_60 L_49 ) ;
return ( 1 ) ;
}
V_80 -> V_152 = V_139 ;
V_80 -> V_16 . V_28 = V_142 ;
V_80 -> V_16 . V_63 = V_63 ;
V_80 -> V_70 = V_140 ;
V_80 -> V_16 . V_153 = F_68 ( V_63 ) ;
F_69 ( V_63 , V_80 ) ;
V_154 = & V_155 ;
F_70 ( F_57 ( V_80 ) ) ;
F_71 ( & V_80 -> V_156 ) ;
...
if ( ! V_159 ) {
V_159 = F_52 ( V_160 , 64 * 1024 ) ;
V_157 = & V_161 ;
}
F_54 ( V_63 , V_80 ) ;
}
if ( V_80 -> V_16 . V_98 . V_7 < V_162 )
V_80 -> V_16 . V_98 . V_7 = V_162 ;
if ( F_30 ( & V_59 ,
& ( V_80 -> V_16 . V_56 ) ) ) {
F_2 ( V_44 L_50 ,
( long ) V_80 -> V_16 . V_56 . V_7 ,
( long ) V_80 -> V_16 . V_56 . V_8 ) ;
V_80 -> V_16 . V_56 . V_9 = 0 ;
}
F_73 ( & V_135 , & V_80 -> V_16 . V_54 ,
F_53 ( V_80 -> V_16 . V_111 ) ) ;
if ( V_80 -> V_16 . V_58 . V_7 )
F_73 ( & V_135 , & V_80 -> V_16 . V_58 ,
V_80 -> V_16 . V_102 ) ;
if ( V_80 -> V_16 . V_56 . V_9 )
F_73 ( & V_135 , & V_80 -> V_16 . V_56 ,
V_80 -> V_16 . V_102 ) ;
if ( V_80 -> V_16 . V_61 . V_9 )
F_74 ( & V_135 , & V_80 -> V_16 . V_61 ) ;
F_74 ( & V_135 , & V_80 -> V_16 . V_98 ) ;
V_63 -> V_63 . V_49 = V_80 ;
V_136 = V_80 -> V_16 . V_17 =
F_75 ( & V_63 -> V_63 , V_80 -> V_16 . V_98 . V_7 ,
V_138 , NULL , & V_135 ) ;
if ( ! V_136 ) {
F_76 ( & V_135 ) ;
return 0 ;
...
#ifdef F_81
F_78 ( L_53 ) ;
F_1 ( & V_80 -> V_16 . V_54 , 2 ) ;
F_78 ( L_54 ) ;
F_1 ( & V_80 -> V_16 . V_56 , 2 ) ;
#endif
}
F_82 ( V_136 ) ;
if ( V_138 == & V_146 ) {
...
void F_86 ( struct V_78 * V_165 , T_2 V_166 , T_2 V_167 )
{
void T_3 * V_28 = F_52 ( V_165 -> V_122 . V_7 , 4096 ) ;
V_167 <<= 2 ;
F_87 ( ( V_166 & 0x001fffff ) != 0 ) ;
F_87 ( ( V_167 & 0x001fffff ) != 0 ) ;
F_29 ( L_55 , V_37 , V_166 , V_167 ) ;
F_22 ( V_167 , V_28 + V_168 ) ;
F_22 ( V_166 , V_28 + V_169 ) ;
F_88 ( V_28 ) ;
}
