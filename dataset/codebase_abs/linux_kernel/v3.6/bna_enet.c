...
F_130 ( & V_38 -> V_81 , V_210 ) ;
F_128 (
& V_208 [ V_219 ] . V_215 . V_216 . V_217 [ 0 ] . V_209 , V_209 ) ;
V_210 = V_208 [ V_219 ] . V_215 . V_216 . V_217 [ 0 ] . V_210 ;
F_131 ( & V_4 -> V_220 , & V_38 -> V_81 , V_4 ) ;
F_132 ( & V_4 -> V_220 , V_210 , V_209 ) ;
V_210 += F_133 () ;
V_209 += F_133 () ;
F_134 ( & V_4 -> V_221 , & V_38 -> V_81 , V_4 ) ;
F_135 ( & V_4 -> V_221 , V_210 , V_209 ) ;
V_210 += F_136 () ;
V_209 += F_136 () ;
F_137 ( & V_4 -> V_126 , & V_38 -> V_81 ) ;
F_138 ( & V_4 -> V_126 , V_210 , V_209 ) ;
F_139 ( & V_4 -> V_126 , V_122 , F_25 , V_4 ) ;
V_210 += F_140 () ;
V_209 += F_140 () ;
V_38 -> V_149 = NULL ;
V_38 -> V_174 = NULL ;
...
if ( V_38 -> V_180 == ( V_222 ) F_102 )
F_3 ( V_38 , V_186 ) ;
}
void
F_144 ( struct V_37 * V_38 , enum V_182 type )
{
if ( type == V_183 ) {
F_145 ( V_38 -> V_4 -> V_31 ) ;
return;
...
static void
F_146 ( struct V_223 * V_224 , struct V_4 * V_4 ,
struct V_207 * V_208 )
{
int V_61 ;
...
F_148 ( & V_224 -> V_225 [ V_61 ] . V_229 ) ;
F_149 ( & V_224 -> V_225 [ V_61 ] . V_229 , & V_224 -> V_228 ) ;
}
V_224 -> V_4 = V_4 ;
}
static void
F_150 ( struct V_223 * V_224 )
{
struct V_230 * V_229 ;
int V_61 = 0 ;
F_151 (qe, &ucam_mod->free_q)
V_61 ++ ;
V_224 -> V_4 = NULL ;
}
static void
F_152 ( struct V_231 * V_232 , struct V_4 * V_4 ,
struct V_207 * V_208 )
{
int V_61 ;
V_232 -> V_233 = (struct V_226 * )
V_208 [ V_234 ] . V_215 . V_216 . V_217 [ 0 ] . V_210 ;
F_147 ( & V_232 -> V_228 ) ;
for ( V_61 = 0 ; V_61 < V_4 -> V_38 . V_40 . V_47 ; V_61 ++ ) {
F_148 ( & V_232 -> V_233 [ V_61 ] . V_229 ) ;
F_149 ( & V_232 -> V_233 [ V_61 ] . V_229 , & V_232 -> V_228 ) ;
}
V_232 -> V_235 = (struct V_236 * )
V_208 [ V_237 ] . V_215 . V_216 . V_217 [ 0 ] . V_210 ;
F_147 ( & V_232 -> V_238 ) ;
for ( V_61 = 0 ; V_61 < V_4 -> V_38 . V_40 . V_47 ; V_61 ++ ) {
F_148 ( & V_232 -> V_235 [ V_61 ] . V_229 ) ;
F_149 ( & V_232 -> V_235 [ V_61 ] . V_229 ,
& V_232 -> V_238 ) ;
}
V_232 -> V_4 = V_4 ;
}
static void
F_153 ( struct V_231 * V_232 )
{
struct V_230 * V_229 ;
int V_61 ;
V_61 = 0 ;
F_151 (qe, &mcam_mod->free_q) V_61 ++ ;
V_61 = 0 ;
F_151 (qe, &mcam_mod->free_handle_q) V_61 ++ ;
V_232 -> V_4 = NULL ;
}
static void
...
V_53 -> V_240 = F_37 ( V_241 ) ;
V_53 -> V_58 = F_155 ( V_4 -> V_119 . V_242 ) ;
V_53 -> V_59 = F_155 ( V_4 -> V_243 . V_242 ) ;
V_53 -> V_244 . V_245 . V_246 = V_4 -> V_68 . V_247 . V_248 ;
V_53 -> V_244 . V_245 . V_249 = V_4 -> V_68 . V_247 . V_250 ;
F_39 ( & V_4 -> V_54 . V_251 , NULL , NULL ,
sizeof( struct V_52 ) , & V_53 -> V_121 ) ;
F_40 ( & V_4 -> V_126 , & V_4 -> V_54 . V_251 ) ;
}
void
F_156 ( struct V_207 * V_208 )
{
V_208 [ V_219 ] . V_252 = V_253 ;
V_208 [ V_219 ] . V_215 . V_216 . V_254 = V_255 ;
V_208 [ V_219 ] . V_215 . V_216 . V_256 = 1 ;
V_208 [ V_219 ] . V_215 . V_216 . V_257 = F_157 (
( F_133 () +
F_136 () +
F_140 () ) , V_258 ) ;
V_208 [ V_214 ] . V_252 = V_253 ;
V_208 [ V_214 ] . V_215 . V_216 . V_254 = V_255 ;
V_208 [ V_214 ] . V_215 . V_216 . V_256 = 1 ;
V_208 [ V_214 ] . V_215 . V_216 . V_257 =
F_157 ( F_158 () , V_258 ) ;
V_208 [ V_218 ] . V_252 = V_253 ;
V_208 [ V_218 ] . V_215 . V_216 . V_254 = V_259 ;
V_208 [ V_218 ] . V_215 . V_216 . V_256 = 1 ;
V_208 [ V_218 ] . V_215 . V_216 . V_257 = V_260 ;
V_208 [ V_261 ] . V_252 = V_253 ;
V_208 [ V_261 ] . V_215 . V_216 . V_254 = V_255 ;
V_208 [ V_261 ] . V_215 . V_216 . V_256 = 1 ;
V_208 [ V_261 ] . V_215 . V_216 . V_257 =
F_157 ( sizeof( struct V_262 ) ,
V_258 ) ;
}
void
F_159 ( struct V_4 * V_4 , struct V_207 * V_208 )
{
struct V_263 * V_40 = & V_4 -> V_38 . V_40 ;
V_208 [ V_264 ] . V_252 = V_253 ;
V_208 [ V_264 ] . V_215 . V_216 . V_254 =
V_259 ;
V_208 [ V_264 ] . V_215 . V_216 . V_256 = 1 ;
V_208 [ V_264 ] . V_215 . V_216 . V_257 =
V_40 -> V_42 * sizeof( struct V_83 ) ;
V_208 [ V_265 ] . V_252 = V_253 ;
V_208 [ V_265 ] . V_215 . V_216 . V_254 =
V_259 ;
V_208 [ V_265 ] . V_215 . V_216 . V_256 = 1 ;
V_208 [ V_265 ] . V_215 . V_216 . V_257 =
V_40 -> V_42 * sizeof( struct V_266 ) ;
V_208 [ V_267 ] . V_252 = V_253 ;
V_208 [ V_267 ] . V_215 . V_216 . V_254 =
V_259 ;
V_208 [ V_267 ] . V_215 . V_216 . V_256 = 1 ;
V_208 [ V_267 ] . V_215 . V_216 . V_257 =
V_40 -> V_44 * sizeof( struct V_85 ) ;
V_208 [ V_268 ] . V_252 = V_253 ;
V_208 [ V_268 ] . V_215 . V_216 . V_254 =
V_259 ;
V_208 [ V_268 ] . V_215 . V_216 . V_256 = 1 ;
V_208 [ V_268 ] . V_215 . V_216 . V_257 =
V_40 -> V_44 * sizeof( struct V_269 ) ;
V_208 [ V_270 ] . V_252 = V_253 ;
V_208 [ V_270 ] . V_215 . V_216 . V_254 =
V_259 ;
V_208 [ V_270 ] . V_215 . V_216 . V_256 = 1 ;
V_208 [ V_270 ] . V_215 . V_216 . V_257 =
( V_40 -> V_44 * 2 ) * sizeof( struct V_271 ) ;
V_208 [ V_227 ] . V_252 = V_253 ;
V_208 [ V_227 ] . V_215 . V_216 . V_254 =
V_259 ;
V_208 [ V_227 ] . V_215 . V_216 . V_256 = 1 ;
V_208 [ V_227 ] . V_215 . V_216 . V_257 =
V_40 -> V_45 * sizeof( struct V_226 ) ;
V_208 [ V_234 ] . V_252 = V_253 ;
V_208 [ V_234 ] . V_215 . V_216 . V_254 =
V_259 ;
V_208 [ V_234 ] . V_215 . V_216 . V_256 = 1 ;
V_208 [ V_234 ] . V_215 . V_216 . V_257 =
V_40 -> V_47 * sizeof( struct V_226 ) ;
V_208 [ V_237 ] . V_252 = V_253 ;
V_208 [ V_237 ] . V_215 . V_216 . V_254 =
V_259 ;
V_208 [ V_237 ] . V_215 . V_216 . V_256 = 1 ;
V_208 [ V_237 ] . V_215 . V_216 . V_257 =
V_40 -> V_47 * sizeof( struct V_236 ) ;
}
void
F_160 ( struct V_4 * V_4 , struct V_31 * V_31 ,
struct V_272 * V_212 , struct V_207 * V_208 )
{
V_4 -> V_31 = V_31 ;
V_4 -> V_212 = * V_212 ;
V_4 -> V_68 . V_69 = (struct V_262 * )
V_208 [ V_261 ] . V_215 . V_216 . V_217 [ 0 ] . V_210 ;
V_4 -> V_68 . V_247 . V_248 =
V_208 [ V_261 ] . V_215 . V_216 . V_217 [ 0 ] . V_209 . V_248 ;
V_4 -> V_68 . V_247 . V_250 =
V_208 [ V_261 ] . V_215 . V_216 . V_217 [ 0 ] . V_209 . V_250 ;
F_161 ( V_4 , & V_4 -> V_212 ) ;
...
void
F_162 ( struct V_4 * V_4 , struct V_207 * V_208 )
{
F_163 ( & V_4 -> V_119 , V_4 , V_208 ) ;
F_164 ( & V_4 -> V_243 , V_4 , V_208 ) ;
F_146 ( & V_4 -> V_224 , V_4 , V_208 ) ;
F_152 ( & V_4 -> V_232 , V_4 , V_208 ) ;
V_4 -> V_273 = V_274 ;
V_4 -> V_275 = V_274 ;
V_4 -> V_276 |= V_277 ;
}
...
struct V_226 *
F_171 ( struct V_223 * V_224 )
{
struct V_230 * V_229 ;
if ( F_172 ( & V_224 -> V_228 ) )
return NULL ;
F_173 ( & V_224 -> V_228 , & V_229 ) ;
return (struct V_226 * ) V_229 ;
}
void
F_174 ( struct V_223 * V_224 , struct V_226 * V_62 )
{
F_149 ( & V_62 -> V_229 , & V_224 -> V_228 ) ;
}
struct V_226 *
F_175 ( struct V_231 * V_232 )
{
struct V_230 * V_229 ;
if ( F_172 ( & V_232 -> V_228 ) )
return NULL ;
F_173 ( & V_232 -> V_228 , & V_229 ) ;
return (struct V_226 * ) V_229 ;
}
void
F_176 ( struct V_231 * V_232 , struct V_226 * V_62 )
{
F_149 ( & V_62 -> V_229 , & V_232 -> V_228 ) ;
}
struct V_236 *
F_177 ( struct V_231 * V_232 )
{
struct V_230 * V_229 ;
if ( F_172 ( & V_232 -> V_238 ) )
return NULL ;
F_173 ( & V_232 -> V_238 , & V_229 ) ;
return (struct V_236 * ) V_229 ;
}
void
F_178 ( struct V_231 * V_232 ,
struct V_236 * V_278 )
{
F_149 ( & V_278 -> V_229 , & V_232 -> V_238 ) ;
}
void
