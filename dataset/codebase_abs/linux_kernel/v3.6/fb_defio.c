...
F_16 ( V_11 -> V_19 ) ;
F_11 ( & V_35 -> V_40 ) ;
if ( V_35 -> V_41 && F_17 ( & V_35 -> V_42 ) )
V_35 -> V_41 ( V_3 ) ;
F_18 ( V_1 ) ;
F_19 (cur, &fbdefio->pagelist, lru) {
if ( F_20 ( V_39 == V_1 ) )
goto V_43;
else if ( V_39 -> V_23 > V_1 -> V_23 )
break;
}
F_21 ( & V_1 -> V_44 , & V_39 -> V_44 ) ;
V_43:
F_14 ( & V_35 -> V_40 ) ;
...
static int F_25 ( struct V_2 * V_3 , struct V_10 * V_11 )
{
V_11 -> V_47 = & V_48 ;
V_11 -> V_49 |= ( V_50 | V_51 ) ;
if ( ! ( V_3 -> V_52 & V_53 ) )
...
{
struct V_2 * V_3 = F_27 ( V_56 , struct V_2 ,
V_37 . V_56 ) ;
...
F_30 (node, next, &fbdefio->pagelist) {
F_31 ( V_58 ) ;
}
F_14 ( & V_35 -> V_40 ) ;
}
