...
V_34 -> V_6 = F_64 ( V_108 , 4096 ) ;
V_34 -> V_43 = V_108 ;
V_34 -> V_110 = F_60 ( V_34 ) ;
V_34 -> V_111 = F_65 ( V_34 -> V_110 ) + 1 ;
V_109 = V_34 -> V_101 = F_66 ( V_34 -> V_111 ,
sizeof( struct V_59 ) , V_11 ) ;
if ( V_109 == NULL ) {
F_67 ( V_34 ) ;
return NULL ;
}
for ( V_37 = 0 ; V_37 < V_34 -> V_111 ; V_37 ++ , V_109 ++ ) {
V_109 -> V_65 = ( unsigned char ) V_37 ;
V_109 -> V_1 = V_34 ;
}
return V_34 ;
}
static void
F_68 ( void * V_13 , long V_112 )
{
unsigned int V_19 , * V_113 = ( unsigned int * ) V_13 ;
F_14 (KERN_DEBUG MODULE_NAME L_32 , num_entry) ;
for ( V_19 = 0 ; V_19 < V_112 ; V_19 ++ , V_113 += 4 ) {
F_14 ( V_88 L_33 ,
V_113 , V_19 , V_113 [ 0 ] , V_113 [ 1 ] , V_113 [ 2 ] , V_113 [ 3 ] ) ;
}
}
static void
F_69 ( struct V_59 * V_60 )
{
F_14 (KERN_DEBUG MODULE_NAME L_34 , vi->irqline, vi) ;
F_14 ( V_88 L_35 , V_60 -> V_14 ) ;
F_14 ( V_88 L_36 , V_60 -> V_84 ) ;
F_14 ( V_88 L_37 , V_60 -> V_76 ) ;
F_14 ( V_88 L_38 , V_60 -> V_75 ) ;
F_14 ( V_88 L_39 , V_60 -> V_87 ) ;
F_14 ( V_88 L_40 , V_60 -> V_90 ) ;
}
static void
F_70 ( struct V_33 * V_34 )
{
F_14 (KERN_DEBUG MODULE_NAME L_41 , isi) ;
F_14 ( V_88 L_42 , V_34 -> V_43 ) ;
F_14 ( V_88 L_43 , V_34 -> V_114 ) ;
F_14 ( V_88 L_44 , V_34 -> V_110 ) ;
F_14 ( V_88 L_45 , V_34 -> V_101 ) ;
}
