...
static int F_157 ( struct V_221 * V_218 )
{
struct V_115 * V_21 = F_158 ( V_218 ) ;
struct V_331 * V_206 = F_159 ( V_218 ) ;
...
static int F_164 ( struct V_221 * V_218 )
{
struct V_115 * V_21 = F_158 ( V_218 ) ;
struct V_331 * V_206 = F_159 ( V_218 ) ;
struct V_1 * V_2 = V_206 -> V_55 ;
...
static bool F_181 ( struct V_115 * V_21 )
{
struct V_331 * V_206 = F_176 ( V_21 ) ;
struct V_1 * V_2 = V_206 -> V_55 ;
if ( V_2 -> V_344 )
...
static void T_6 F_182 ( struct V_1 * V_2 )
{
struct V_115 * V_188 = F_183 ( V_2 -> V_21 ) ;
if ( V_188 ) {
F_10 (KERN_INFO SFX
L_45 ,
pci_name(chip->pci)) ;
...
static int T_6 F_185 ( struct V_1 * V_2 )
{
if ( ! V_2 -> V_346 )
return 0 ;
return F_186 ( V_2 -> V_21 , & V_347 ,
V_348 ,
V_2 -> V_53 != NULL ) ;
}
...
static int F_192 ( struct V_350 * V_221 )
{
return F_187 ( V_221 -> V_351 ) ;
}
static struct V_115 T_6 * F_183 ( struct V_115 * V_21 )
{
struct V_115 * V_188 ;
switch ( V_21 -> V_352 ) {
case V_353 :
...
static bool T_6 F_195 ( struct V_115 * V_21 )
{
bool V_359 = false ;
struct V_115 * V_188 = F_183 ( V_21 ) ;
if ( V_188 ) {
if ( F_196 ( V_188 ) == V_345 )
V_359 = true ;
F_184 ( V_188 ) ;
}
return V_359 ;
}
static int T_6 F_197 ( struct V_1 * V_2 , int V_360 )
{
...
static void T_6 F_199 ( struct V_1 * V_2 , int V_218 )
{
const struct V_361 * V_362 ;
V_2 -> V_211 = V_372 [ V_218 ] ;
if ( V_2 -> V_211 == - 1 ) {
V_362 = F_198 ( V_2 -> V_21 , V_373 ) ;
if ( V_362 ) {
F_132 ( V_365
L_51
L_47 ,
...
static void T_6 F_201 ( struct V_1 * V_2 )
{
...
if ( ! ( V_54 & 0x80 ) && V_2 -> V_21 -> V_379 == 0x30 )
V_131 = false ;
}
break;
case V_380 :
...
if ( V_131 != V_2 -> V_131 ) {
F_10 (KERN_INFO SFX L_55 ,
snoop ? L_56 : L_57 ) ;
V_2 -> V_131 = V_131 ;
}
}
static int T_6 F_202 ( struct V_331 * V_206 , struct V_115 * V_21 ,
int V_218 , unsigned int V_43 ,
struct V_1 * * V_381 )
{
static struct V_382 V_197 = {
. V_383 = F_192 ,
} ;
struct V_1 * V_2 ;
int V_19 ;
...
F_200 ( V_2 ) ;
V_2 -> V_167 = V_218 ;
F_205 ( & V_2 -> V_145 , F_136 ) ;
F_206 ( & V_2 -> V_318 ) ;
F_182 ( V_2 ) ;
V_2 -> V_180 [ 0 ] = V_2 -> V_180 [ 1 ] =
F_197 ( V_2 , V_180 [ V_218 ] ) ;
...
V_19 = F_207 ( V_206 , V_387 , V_2 , & V_197 ) ;
if ( V_19 < 0 ) {
...
struct V_331 * V_206 = V_2 -> V_206 ;
int V_99 , V_19 ;
unsigned short V_388 ;
#if V_389 != 64
if ( V_2 -> V_209 == V_390 ) {
T_8 V_391 ;
F_63 ( V_21 , 0x40 , & V_391 ) ;
F_64 ( V_21 , 0x40 , V_391 | 0x10 ) ;
F_208 ( V_21 , V_392 , 0 ) ;
}
#endif
V_19 = F_209 ( V_21 , L_63 ) ;
if ( V_19 < 0 )
return V_19 ;
V_2 -> V_349 = 1 ;
V_2 -> V_3 = F_210 ( V_21 , 0 ) ;
V_2 -> V_288 = F_211 ( V_21 , 0 ) ;
if ( V_2 -> V_288 == NULL ) {
...
F_167 ( V_21 ) ;
F_212 ( V_2 -> V_72 ) ;
V_388 = F_42 ( V_2 , V_393 ) ;
F_36 ( V_69 L_65 , V_388 ) ;
...
if ( V_2 -> V_43 & V_398 )
V_2 -> V_244 = 0 ;
else if ( V_2 -> V_43 & V_399 )
V_2 -> V_244 = 1 ;
else
V_2 -> V_244 = 1 ;
}
if ( ( V_388 & V_396 ) && ! F_214 ( V_21 , F_215 ( 64 ) ) )
F_216 ( V_21 , F_215 ( 64 ) ) ;
else {
F_214 ( V_21 , F_215 ( 32 ) ) ;
F_216 ( V_21 , F_215 ( 32 ) ) ;
}
V_2 -> V_228 = ( V_388 >> 8 ) & 0x0f ;
V_2 -> V_226 = ( V_388 >> 12 ) & 0x0f ;
...
V_2 -> V_13 = F_217 ( V_2 -> V_100 , sizeof( * V_2 -> V_13 ) ,
V_311 ) ;
if ( ! V_2 -> V_13 ) {
...
F_153 ( V_2 ) ;
F_62 ( V_2 ) ;
F_58 ( V_2 , ( V_409 [ V_218 ] & 2 ) == 0 ) ;
if ( ! V_2 -> V_95 ) {
F_10 (KERN_ERR SFX L_70 ) ;
return - V_410 ;
}
strcpy ( V_206 -> V_411 , L_71 ) ;
F_146 ( V_206 -> V_412 , V_413 [ V_2 -> V_209 ] ,
sizeof( V_206 -> V_412 ) ) ;
snprintf ( V_206 -> V_414 , sizeof( V_206 -> V_414 ) ,
L_72 ,
V_206 -> V_412 , V_2 -> V_3 , V_2 -> V_72 ) ;
return 0 ;
}
...
static int T_6 F_219 ( struct V_115 * V_21 ,
...
V_19 = F_220 ( V_109 [ V_218 ] , V_420 [ V_218 ] , V_421 , 0 , & V_206 ) ;
if ( V_19 < 0 ) {
F_10 (KERN_ERR SFX L_73 ) ;
return V_19 ;
}
F_221 ( V_206 , & V_21 -> V_218 ) ;
V_19 = F_202 ( V_206 , V_21 , V_218 , V_416 -> V_422 , & V_2 ) ;
if ( V_19 < 0 )
goto V_423;
V_206 -> V_55 = V_2 ;
if ( ! V_2 -> V_87 ) {
...
static int T_5 F_178 ( struct V_1 * V_2 )
{
int V_218 = V_2 -> V_167 ;
int V_19 ;
#ifdef F_224
...
goto V_423;
#ifdef F_225
if ( V_424 [ V_218 ] && * V_424 [ V_218 ] ) {
F_10 (KERN_ERR SFX L_74 ,
patch[dev]) ;
V_19 = F_226 ( V_2 -> V_53 , V_424 [ V_218 ] ) ;
if ( V_19 < 0 )
goto V_423;
}
#endif
...
static void T_9 F_229 ( struct V_115 * V_21 )
{
struct V_331 * V_206 = F_176 ( V_21 ) ;
if ( V_206 )
F_223 ( V_206 ) ;
