...
if ( V_131 && ! F_127 ( V_133 , & V_18 -> V_60 ) )
F_77 ( V_144 , V_18 ) ;
V_75:
if ( V_114 ) {
if ( V_33 == V_145 )
...
if ( V_18 -> V_50 || ( V_80 && ! F_131 ( & V_80 -> V_147 ) ) )
return;
F_9 () ;
...
V_152 = F_134 ( V_18 ) ;
if ( V_152 ) {
F_135 ( & V_152 [ F_73 ( V_82 ) ] . V_156 ) ;
F_136 ( V_21 -> V_157 , & V_152 [ F_73 ( V_82 ) ] . V_158 ) ;
}
}
}
...
static struct V_39 *
F_145 ( struct V_17 * V_17 , int (* F_146)( struct V_39 * V_94 , void * V_150 ) ,
...
int (* F_146)( struct V_39 * V_94 , void * V_150 ) ,
void * V_150 )
{
struct V_39 * V_18 ;
unsigned int V_68 = 0 ;
while ( ( V_18 = F_145 ( V_17 , F_146 , V_150 , & V_68 ) ) != NULL ) {
if ( F_84 ( & V_18 -> V_46 ) )
F_47 ( ( unsigned long ) V_18 ) ;
F_31 ( V_18 ) ;
}
...
static int F_150 ( struct V_39 * V_94 , void * V_150 )
{
return 1 ;
}
...
F_170 ( V_17 ) ;
F_171 ( V_17 ) ;
F_172 ( V_17 -> V_18 . V_104 ) ;
F_173 ( V_17 -> V_18 . V_182 ) ;
F_174 ( V_17 -> V_18 . V_183 ) ;
}
void F_175 ( struct V_17 * V_17 )
{
if ( F_176 ( V_17 , & V_184 ) )
F_177 ( V_185 , NULL ) ;
F_178 () ;
...
while ( ! F_190 ( & V_184 . V_18 . V_14 [ V_94 ] ) ) {
V_66 = F_191 ( V_184 . V_18 . V_14 [ V_94 ] . V_208 ,
struct V_65 , V_41 ) ;
V_18 = F_58 ( V_66 ) ;
F_16 ( & V_66 -> V_41 ) ;
...
static int F_195 ( struct V_17 * V_17 )
{
int V_33 ;
F_100 ( & V_17 -> V_18 . V_101 , 0 ) ;
F_186 ( & V_17 -> V_18 . V_129 , V_217 ) ;
F_186 ( & V_17 -> V_18 . V_61 , V_218 ) ;
V_17 -> V_18 . V_183 = F_196 ( struct V_219 ) ;
if ( ! V_17 -> V_18 . V_183 ) {
V_33 = - V_103 ;
goto V_220;
}
V_17 -> V_18 . V_182 = F_197 ( V_193 , L_18 , V_17 ) ;
if ( ! V_17 -> V_18 . V_182 ) {
V_33 = - V_103 ;
goto V_221;
}
V_17 -> V_18 . V_104 = F_198 ( V_17 -> V_18 . V_182 ,
