...
static long F_66 ( struct V_19 * V_19 , unsigned int V_66 ,
unsigned long V_67 )
{
int V_4 = 0 ;
struct V_38 * V_7 ;
...
if ( ! F_40 ( V_72 ) )
return - V_60 ;
V_7 = F_67 ( F_10 ( V_19 -> V_120 -> V_121 ) ) ;
if ( ! V_7 )
return - V_119 ;
switch ( V_66 ) {
case V_122 :
...
if ( V_4 )
break;
V_4 = F_69 ( V_78 . V_12 , ( T_3 T_6 * ) V_68 ) ;
if ( V_4 )
V_4 = - V_58 ;
break;
}
...
V_125 = F_71 ( V_78 . V_70 + V_2 -> V_6 -> V_55 - 1 ,
V_2 -> V_6 -> V_55 ) ;
F_21 ( & V_7 -> V_89 ) ;
V_4 = F_72 ( V_2 , V_125 ) ;
F_23 ( & V_7 -> V_89 ) ;
...
struct V_104 * V_78 ;
F_58 ( L_29 ) ;
V_78 = F_73 ( sizeof( struct V_104 ) , V_113 ) ;
if ( ! V_78 ) {
V_4 = - V_57 ;
break;
} ;
...
static long F_75 ( struct V_19 * V_19 , unsigned int V_66 ,
unsigned long V_67 )
{
int V_4 = 0 ;
void T_3 * V_68 = ( void T_3 * ) V_67 ;
...
V_130 = F_76 ( NULL , V_78 . V_131 ) ;
if ( F_13 ( V_130 ) ) {
V_4 = F_14 ( V_130 ) ;
break;
}
F_21 ( & V_133 ) ;
V_4 = F_77 ( V_130 , V_78 . V_20 , V_78 . V_134 ) ;
F_23 ( & V_133 ) ;
if ( V_4 < 0 )
F_78 ( V_130 ) ;
else
V_4 = F_69 ( V_4 , ( T_3 T_6 * ) V_68 ) ;
break;
}
case V_135 :
{
...
static long F_80 ( struct V_19 * V_19 , unsigned int V_66 ,
unsigned long V_67 )
{
unsigned long V_136 = ( unsigned long ) F_81 ( V_67 ) ;
return F_39 ( V_19 , V_66 , V_136 ) ;
}
static long F_82 ( struct V_19 * V_19 , unsigned int V_66 ,
unsigned long V_67 )
{
unsigned long V_136 = ( unsigned long ) F_81 ( V_67 ) ;
return F_66 ( V_19 , V_66 , V_136 ) ;
}
static long F_83 ( struct V_19 * V_19 , unsigned int V_66 ,
unsigned long V_67 )
{
unsigned long V_136 = ( unsigned long ) F_81 ( V_67 ) ;
return F_75 ( V_19 , V_66 , V_136 ) ;
}
