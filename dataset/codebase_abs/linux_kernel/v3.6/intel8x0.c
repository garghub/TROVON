...
static int F_119 ( struct V_192 * V_288 )
{
struct V_289 * V_205 = F_120 ( V_288 ) ;
struct V_290 * V_198 = F_121 ( V_288 ) ;
...
static int F_126 ( struct V_192 * V_288 )
{
struct V_289 * V_205 = F_120 ( V_288 ) ;
struct V_290 * V_198 = F_121 ( V_288 ) ;
struct V_1 * V_2 = V_198 -> V_22 ;
...
F_137 ( V_2 -> V_20 [ 0 ] , V_309 , 0 ) ;
}
static int T_4 F_138 ( struct V_1 * V_2 )
{
struct V_289 * V_205 = V_2 -> V_205 ;
...
static void F_139 ( struct V_322 * V_323 ,
struct V_324 * V_325 )
{
...
F_140 ( V_325 , L_27 , F_5 ( V_2 , F_16 ( V_145 ) ) ) ;
F_140 ( V_325 , L_28 , V_26 ) ;
if ( V_2 -> V_137 == V_155 )
F_140 ( V_325 , L_29 , F_5 ( V_2 , F_16 ( V_238 ) ) ) ;
F_140 ( V_325 , L_30 ) ;
if ( V_26 & V_2 -> V_10 ) {
int V_78 ;
...
static void T_4 F_141 ( struct V_1 * V_2 )
{
struct V_322 * V_323 ;
if ( ! F_142 ( V_2 -> V_198 , L_38 , & V_323 ) )
F_143 ( V_323 , V_2 , F_139 ) ;
}
static int F_144 ( struct V_326 * V_192 )
{
struct V_1 * V_2 = V_192 -> V_327 ;
return F_112 ( V_2 ) ;
}
static int T_4 F_145 ( struct V_289 * V_205 )
{
int V_328 = V_162 ;
char * V_329 = NULL ;
if ( V_328 >= 0 ) {
...
static int T_4 F_149 ( struct V_290 * V_198 ,
struct V_289 * V_205 ,
unsigned long V_137 ,
struct V_1 * * V_331 )
{
...
struct V_335 * V_209 ;
* V_331 = NULL ;
if ( ( V_123 = F_129 ( V_205 ) ) < 0 )
return V_123 ;
V_2 = F_150 ( sizeof( * V_2 ) , V_348 ) ;
if ( V_2 == NULL ) {
F_117 ( V_205 ) ;
return - V_349 ;
}
...
if ( V_235 )
V_2 -> V_235 = 1 ;
V_2 -> V_162 = F_145 ( V_205 ) ;
if ( V_205 -> V_350 == V_351 &&
V_205 -> V_192 == V_352 )
V_2 -> V_124 = 1 ;
if ( ( V_123 = F_152 ( V_205 , V_198 -> V_203 ) ) < 0 ) {
F_118 ( V_2 ) ;
F_117 ( V_205 ) ;
return V_123 ;
}
if ( V_137 == V_138 ) {
V_2 -> V_4 = F_153 ( V_205 , 0 , 0 ) ;
goto V_353;
}
if ( F_154 ( V_205 , 2 ) & V_354 )
V_2 -> V_6 = F_153 ( V_205 , 2 , 0 ) ;
else
V_2 -> V_6 = F_153 ( V_205 , 0 , 0 ) ;
if ( ! V_2 -> V_6 ) {
F_18 ( V_17 L_45 ) ;
F_112 ( V_2 ) ;
return - V_8 ;
}
if ( F_154 ( V_205 , 3 ) & V_354 )
V_2 -> V_4 = F_153 ( V_205 , 3 , 0 ) ;
else
V_2 -> V_4 = F_153 ( V_205 , 1 , 0 ) ;
if ( ! V_2 -> V_4 ) {
F_18 ( V_17 L_46 ) ;
F_112 ( V_2 ) ;
return - V_8 ;
...
V_2 -> V_83 = V_205 -> V_83 ;
if ( ( V_123 = F_156 ( V_198 , V_365 , V_2 , & V_226 ) ) < 0 ) {
F_112 ( V_2 ) ;
return V_123 ;
}
F_157 ( V_198 , & V_205 -> V_288 ) ;
* V_331 = V_2 ;
return 0 ;
}
static int T_4 F_158 ( struct V_289 * V_205 )
{
const struct V_316 * V_366 ;
V_366 = F_101 ( V_205 , V_367 ) ;
if ( V_366 ) {
if ( V_366 -> V_321 )
F_159 ( V_314 L_49
L_50 , V_366 -> V_196 ) ;
...
static int T_4 F_160 ( struct V_289 * V_205 ,
...
int V_123 ;
struct V_370 * V_196 ;
V_123 = F_161 ( V_371 , V_372 , V_373 , 0 , & V_198 ) ;
if ( V_123 < 0 )
return V_123 ;
if ( V_211 < 0 )
V_211 = F_158 ( V_205 ) ;
strcpy ( V_198 -> V_374 , L_53 ) ;
if ( ! V_211 ) {
switch ( V_369 -> V_375 ) {
case V_154 :
strcpy ( V_198 -> V_374 , L_54 ) ;
break;
case V_155 :
strcpy ( V_198 -> V_374 , L_55 ) ;
}
}
strcpy ( V_198 -> V_203 , L_8 ) ;
for ( V_196 = V_376 ; V_196 -> V_372 ; V_196 ++ ) {
if ( V_205 -> V_192 == V_196 -> V_372 ) {
strcpy ( V_198 -> V_203 , V_196 -> V_377 ) ;
break;
}
}
if ( V_88 < 0 ) {
if ( V_369 -> V_375 == V_154 )
V_88 = 1 ;
else
V_88 = 0 ;
}
if ( ( V_123 = F_149 ( V_198 , V_205 , V_369 -> V_375 ,
& V_2 ) ) < 0 ) {
F_162 ( V_198 ) ;
return V_123 ;
}
V_198 -> V_22 = V_2 ;
if ( ( V_123 = F_93 ( V_2 , V_219 , V_378 ) ) < 0 ) {
F_162 ( V_198 ) ;
return V_123 ;
}
if ( ( V_123 = F_89 ( V_2 ) ) < 0 ) {
...
F_141 ( V_2 ) ;
snprintf ( V_198 -> V_379 , sizeof( V_198 -> V_379 ) ,
L_56 , V_198 -> V_203 ,
F_163 ( V_2 -> V_20 [ 0 ] ) , V_2 -> V_83 ) ;
if ( V_219 == 0 || V_219 == 1 ) {
if ( V_219 == 0 ) {
if ( F_138 ( V_2 ) == 0 )
F_135 ( V_2 ) ;
...
static void T_8 F_166 ( struct V_289 * V_205 )
{
F_162 ( F_167 ( V_205 ) ) ;
F_165 ( V_205 , NULL ) ;
}
