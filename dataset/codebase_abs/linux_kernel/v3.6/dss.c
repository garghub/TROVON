...
V_49 = V_48 == 0 ? 1 : 10 ;
F_16 ( V_38 , V_41 , V_49 , V_49 ) ;
V_4 . V_52 [ V_48 ] = V_23 ;
}
void F_42 ( enum V_53 V_54 ,
enum V_22 V_23 )
{
struct V_39 * V_40 ;
int V_41 , V_55 , V_49 ;
...
{
return V_4 . V_52 [ V_48 ] ;
}
enum V_22 F_46 ( enum V_53 V_54 )
{
if ( F_43 ( V_56 ) ) {
int V_55 = V_54 == V_7 ? 0 :
( V_54 == V_57 ? 1 : 2 ) ;
...
return - V_65 ;
V_62 = F_28 ( F_29 ( V_4 . V_34 ) ) ;
V_61 -> V_66 = V_62 / V_61 -> V_64 ;
} else {
if ( V_61 -> V_64 != 0 )
return - V_65 ;
V_61 -> V_66 = F_28 ( V_4 . V_33 ) ;
}
return 0 ;
}
int F_48 ( struct V_60 * V_61 )
{
if ( V_4 . V_34 ) {
unsigned long V_62 ;
int T_3 ;
V_62 = F_28 ( F_29 ( V_4 . V_34 ) ) ;
F_6 ( L_13 , V_62 ) ;
T_3 = F_49 ( V_4 . V_34 , V_62 / V_61 -> V_64 ) ;
if ( T_3 )
return T_3 ;
} else {
if ( V_61 -> V_64 != 0 )
...
int F_52 ( unsigned long V_67 , struct V_60 * V_68 ,
struct V_69 * V_70 )
{
unsigned long V_62 ;
struct V_60 V_71 ;
struct V_69 V_72 ;
unsigned long V_66 , V_73 ;
T_4 V_64 , V_63 = 16 ;
int V_74 = 0 ;
int V_75 ;
V_62 = F_51 () ;
...
F_68 ( T_3 < 0 && T_3 != - V_101 && T_3 != - V_102 ) ;
}
...
static int T_5 F_74 ( struct V_39 * V_98 )
{
struct V_103 * V_104 ;
T_1 V_105 ;
int T_3 ;
V_4 . V_98 = V_98 ;
V_104 = F_75 ( V_4 . V_98 , V_106 , 0 ) ;
if ( ! V_104 ) {
F_20 ( L_30 ) ;
return - V_65 ;
}
V_4 . V_5 = F_76 ( & V_98 -> V_99 , V_104 -> V_42 ,
F_77 ( V_104 ) ) ;
if ( ! V_4 . V_5 ) {
F_20 ( L_31 ) ;
return - V_107 ;
...
static int T_6 F_84 ( struct V_39 * V_98 )
{
F_83 ( & V_98 -> V_99 ) ;
F_66 () ;
return 0 ;
}
static int F_85 ( struct V_110 * V_99 )
{
F_5 () ;
F_86 ( V_99 , 0 ) ;
return 0 ;
}
static int F_87 ( struct V_110 * V_99 )
{
int T_3 ;
T_3 = F_86 ( V_99 , 1000000000 ) ;
if ( T_3 )
return T_3 ;
F_9 () ;
return 0 ;
