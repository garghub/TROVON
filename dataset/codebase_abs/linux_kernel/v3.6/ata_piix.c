...
{
struct V_99 * V_10 = F_37 ( & V_9 -> V_11 ) ;
unsigned long V_3 ;
int V_100 = 0 ;
...
static int T_6 F_55 ( struct V_8 * V_116 )
{
struct V_8 * V_9 = NULL ;
T_2 V_117 ;
int V_118 = 0 ;
...
static void T_6 F_58 ( struct V_99 * V_10 ,
...
static const int * T_6 F_61 ( struct V_8 * V_9 ,
struct V_128 * V_129 ,
const struct V_122 * V_123 )
{
const int * V_130 ;
...
static int T_6 F_66 ( struct V_99 * V_10 )
{
struct V_8 * V_9 = F_4 ( V_10 -> V_11 ) ;
...
const struct V_84 * V_154 = F_73 ( V_158 ) ;
if ( V_154 && V_159 ) {
V_10 -> V_3 |= V_160 ;
F_62 ( V_10 -> V_11 , L_50 ,
V_154 -> V_86 ) ;
...
static int T_6 F_77 ( struct V_8 * V_9 ,
const struct V_161 * V_162 )
{
struct V_18 * V_11 = & V_9 -> V_11 ;
struct V_128 V_163 [ 2 ] ;
const struct V_128 * V_164 [] = { & V_163 [ 0 ] , & V_163 [ 1 ] } ;
...
int V_100 ;
F_78 ( & V_9 -> V_11 , V_169 ) ;
if ( ! V_170 && V_162 -> V_153 >= V_171 )
return - V_172 ;
if ( F_72 ( V_9 ) ) {
V_137 [ V_162 -> V_153 ] . V_3 |=
V_173 |
V_174 ;
F_62 ( & V_9 -> V_11 , L_51
L_52 ) ;
}
V_163 [ 0 ] = V_137 [ V_162 -> V_153 ] ;
V_163 [ 1 ] = V_137 [ V_162 -> V_153 ] ;
V_168 = V_163 [ 0 ] . V_3 ;
V_100 = F_79 ( V_9 ) ;
if ( V_100 )
return V_100 ;
V_13 = F_80 ( V_11 , sizeof( * V_13 ) , V_175 ) ;
if ( ! V_13 )
return - V_112 ;
...
if ( V_168 & V_176 )
V_13 -> V_130 = F_61 ( V_9 , V_163 ,
V_177 [ V_162 -> V_153 ] ) ;
V_100 = F_82 ( V_9 , V_164 , & V_10 ) ;
if ( V_100 )
return V_100 ;
V_10 -> V_14 = V_13 ;
if ( V_168 & V_176 ) {
F_58 ( V_10 , V_177 [ V_162 -> V_153 ] ) ;
V_100 = F_66 ( V_10 ) ;
if ( V_100 )
return V_100 ;
...
F_83 ( V_9 , 1 ) ;
if ( F_55 ( V_9 ) ) {
V_10 -> V_143 [ 0 ] -> V_180 = 0 ;
V_10 -> V_143 [ 0 ] -> V_52 = 0 ;
V_10 -> V_143 [ 1 ] -> V_180 = 0 ;
V_10 -> V_143 [ 1 ] -> V_52 = 0 ;
}
V_10 -> V_3 |= V_181 ;
F_75 ( V_10 ) ;
F_84 ( V_9 ) ;
return F_85 ( V_10 , V_182 , V_166 ) ;
}
