...
return sprintf ( V_76 , L_23 , V_2 -> V_18 ) ;
}
static T_5 F_43 ( struct V_73 * V_16 ,
struct V_74 * V_75 , char * V_76 )
{
struct V_1 * V_2 = F_42 ( V_16 ) ;
return sprintf ( V_76 , L_24 , V_2 -> V_40 ) ;
}
static T_5 F_44 ( struct V_73 * V_16 ,
struct V_74 * V_75 , char * V_76 )
{
struct V_1 * V_2 = F_42 ( V_16 ) ;
return sprintf ( V_76 , L_24 , V_2 -> V_60 == V_66 ? 1 : 0 ) ;
}
static T_5 F_45 ( struct V_73 * V_16 ,
struct V_74 * V_75 , char * V_76 )
{
struct V_1 * V_2 = F_42 ( V_16 ) ;
return sprintf ( V_76 , L_24 , V_2 -> V_37 ) ;
}
static T_5 F_46 ( struct V_73 * V_16 ,
struct V_74 * V_75 , char * V_76 )
{
return sprintf ( V_76 , L_24 , V_26 ) ;
}
...
V_123 . V_84 = V_2 -> V_34 ;
V_2 -> V_124 = F_70 ( L_32 , & V_118 -> V_16 ,
V_2 , & V_125 , & V_123 ) ;
if ( F_71 ( V_2 -> V_124 ) ) {
F_7 ( & V_5 -> V_16 , L_33 ,
F_72 ( V_2 -> V_124 ) ) ;
