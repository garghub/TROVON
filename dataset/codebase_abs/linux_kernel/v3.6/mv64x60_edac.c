...
static int T_5 F_32 ( struct V_22 * V_23 )
{
struct V_54 * V_55 ;
struct V_56 * V_4 ;
struct V_24 * V_25 ;
...
static int T_5 F_40 ( struct V_22 * V_23 )
{
struct V_54 * V_55 ;
struct V_24 * V_25 ;
struct V_65 * V_4 ;
...
static void F_45 ( struct V_77 * V_4 )
{
...
static int T_5 F_49 ( struct V_22 * V_23 )
{
struct V_75 * V_76 ;
...
V_117 [ 1 ] . V_119 = 1 ;
V_117 [ 1 ] . V_120 = false ;
V_76 = F_50 ( V_122 , F_51 ( V_117 ) , V_117 ,
sizeof( struct V_77 ) ) ;
if ( ! V_76 ) {
F_3 ( V_9 L_46 , V_28 ) ;
F_26 ( & V_23 -> V_33 , F_49 ) ;
