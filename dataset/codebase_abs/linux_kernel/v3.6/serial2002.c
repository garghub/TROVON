...
struct V_125 * V_126 )
{
const struct V_127 * V_128 = F_35 ( V_78 ) ;
struct V_109 * V_110 ;
int V_129 ;
F_36 ( V_78 -> V_130 , L_4 ) ;
V_78 -> V_131 = V_128 -> V_132 ;
if ( F_37 ( V_78 , sizeof( struct V_133 ) ) < 0 )
return - V_92 ;
V_78 -> V_134 = F_19 ;
V_78 -> V_135 = F_26 ;
V_80 -> V_79 = V_126 -> V_136 [ 0 ] ;
V_80 -> V_37 = V_126 -> V_136 [ 1 ] ;
F_36 ( V_78 -> V_130 , L_5 , V_80 -> V_79 ,
V_80 -> V_37 ) ;
V_129 = F_38 ( V_78 , 5 ) ;
if ( V_129 )
return V_129 ;
...
static void F_39 ( struct V_77 * V_78 )
{
struct V_109 * V_110 ;
int V_76 ;
