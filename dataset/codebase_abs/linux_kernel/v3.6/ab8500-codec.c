...
int V_11 ;
F_6 ( V_14 , L_10 , V_16 ) ;
V_176 = (struct V_175 * ) F_42 ( V_14 -> V_177 ) ;
V_9 -> V_178 = ( void * ) true ;
V_11 = F_33 ( V_9 , & V_176 -> V_9 -> V_91 ) ;
if ( V_11 < 0 ) {
F_43 ( L_62 , V_16 , V_11 ) ;
return V_11 ;
}
V_11 = F_35 ( V_9 , V_176 -> V_9 -> V_111 ) ;
if ( V_11 < 0 ) {
F_43 ( L_63 ,
V_16 , V_11 ) ;
return V_11 ;
...
static int T_2 F_47 ( struct V_187 * V_188 )
{
int V_11 ;
struct V_33 * V_34 ;
F_6 ( & V_188 -> V_14 , L_10 , V_16 ) ;
V_34 = F_48 ( & V_188 -> V_14 , sizeof( struct V_33 ) ,
V_189 ) ;
V_34 -> V_44 = V_190 ;
V_34 -> V_63 = V_191 ;
F_49 ( & V_188 -> V_14 , V_34 ) ;
F_6 ( & V_188 -> V_14 , L_66 , V_16 ) ;
V_11 = F_50 ( & V_188 -> V_14 , & V_192 ,
V_193 ,
F_45 ( V_193 ) ) ;
if ( V_11 < 0 )
F_5 ( & V_188 -> V_14 ,
...
static int T_3 F_51 ( struct V_187 * V_188 )
{
F_52 ( & V_188 -> V_14 , L_68 , V_16 ) ;
F_53 ( & V_188 -> V_14 ) ;
return 0 ;
}
