...
static void F_27 ( struct V_12 * V_12 )
{
struct V_6 * V_9 = V_12 -> V_39 ;
struct V_7 * V_8 = V_9 -> V_7 ;
unsigned long V_47 ;
...
static int F_30 ( void * V_48 , void * V_2 , int V_3 ,
void (* F_31)( void * V_2 ) , void * V_45 )
{
...
static void F_44 ( struct V_12 * V_12 )
{
struct V_15 * V_18 = V_12 -> V_39 ;
struct V_16 * V_17 = V_18 -> V_16 ;
struct V_25 * V_26 = F_45 ( V_18 -> V_16 , struct V_25 , V_17 ) ;
struct V_7 * V_8 = & V_26 -> V_8 ;
struct V_6 * V_9 ;
T_2 V_41 ;
unsigned long V_47 ;
...
if ( ! V_12 -> V_42 && V_18 -> V_44 )
V_18 -> V_44 ( V_18 -> V_45 , V_18 -> V_13 , V_12 -> V_67 ) ;
F_39 ( & V_17 -> V_33 ) ;
F_19 ( V_17 , V_18 ) ;
F_40 ( & V_17 -> V_33 ) ;
F_29 ( & V_8 -> V_33 , V_47 ) ;
...
static int F_46 ( void * V_48 ,
void (* F_31)( void * V_45 , void * V_2 , int V_3 ) ,
void * V_45 )
{
struct V_25 * V_26 = V_48 ;
struct V_49 * V_50 = V_26 -> V_50 ;
...
F_44 ,
V_18 ) ;
return F_42 ( V_18 -> V_12 , V_10 ) ;
}
static void F_48 ( struct V_69 * V_70 )
{
struct V_25 * V_26 = F_45 ( V_70 , struct V_25 , V_59 ) ;
struct V_7 * V_8 = & V_26 -> V_8 ;
int V_27 ;
unsigned long V_47 ;
V_27 = F_49 ( V_26 -> V_71 ) ;
...
static int F_51 ( struct V_73 * V_71 ,
...
T_2 V_78 , V_79 , V_80 ;
struct V_49 * V_50 = F_52 ( V_71 ) ;
F_53 ( V_50 ) ;
V_76 = V_50 -> V_81 -> V_82 . V_76 ;
V_78 = F_54 ( V_50 -> V_83 . V_78 ) ;
V_79 = F_54 ( V_50 -> V_83 . V_79 ) ;
V_80 = F_54 ( V_50 -> V_83 . V_80 ) ;
F_2 ( V_84 L_9 ,
V_78 , V_79 ) ;
F_2 ( V_84 L_10 , V_85 ) ;
if ( V_79 == V_86 ) {
...
V_77 = F_57 ( sizeof( * V_77 ) , V_89 ) ;
if ( V_77 == NULL ) {
V_27 = - V_35 ;
goto V_11;
}
V_26 = F_57 ( sizeof( * V_26 ) , V_89 ) ;
if ( V_26 == NULL ) {
V_27 = - V_35 ;
goto V_11;
}
...
V_71 -> V_93 = 1 ;
F_58 ( & V_71 -> V_66 , 1 ) ;
F_59 ( & V_50 -> V_66 , 10 * 1000 ) ;
F_60 ( & V_26 -> V_59 , F_48 ) ;
#endif
V_27 = F_61 ( V_77 , & V_71 -> V_66 ) ;
V_11:
if ( V_27 ) {
F_7 ( V_77 ) ;
F_7 ( V_26 ) ;
...
static void F_63 ( struct V_73 * V_71 )
{
T_1 V_76 ;
struct V_77 * V_77 ;
struct V_25 * V_26 ;
...
static int F_67 ( struct V_73 * V_71 , T_3 V_94 )
{
struct V_77 * V_77 ;
struct V_25 * V_26 ;
struct V_16 * V_17 ;
...
static int F_68 ( struct V_73 * V_71 )
{
struct V_77 * V_77 ;
struct V_25 * V_26 ;
struct V_16 * V_17 ;
