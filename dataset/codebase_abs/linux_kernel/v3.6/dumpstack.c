...
int T_1 F_38 ( const char * V_48 , struct V_30 * V_31 , long V_49 )
{
#ifdef F_39
unsigned short V_50 ;
unsigned long V_34 ;
...
void F_50 ( const char * V_48 , struct V_30 * V_31 , long V_49 )
{
unsigned long V_41 = F_20 () ;
int V_61 = V_56 ;
if ( ! F_46 ( V_31 ) )
F_51 ( V_31 -> V_59 , V_31 ) ;
if ( F_38 ( V_48 , V_31 , V_49 ) )
V_61 = 0 ;
F_28 ( V_41 , V_31 , V_61 ) ;
}
...
if ( ! V_62 )
return - V_64 ;
V_17 = F_53 ( V_62 , 0 , & V_63 ) ;
if ( V_17 )
return V_17 ;
V_65 = V_63 ;
return 0 ;
}
static int T_2 F_54 ( char * V_62 )
{
T_3 V_17 ;
unsigned long V_63 ;
if ( ! V_62 )
