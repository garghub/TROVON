...
static int T_2 F_15 ( struct V_28 * V_29 )
{
struct V_8 * V_9 = NULL ;
struct V_30 * V_31 ;
int V_32 = - V_33 ;
...
V_9 = F_2 ( V_34 ) ;
V_9 -> V_17 = F_19 ( V_31 -> V_40 , V_31 -> V_41 - V_31 -> V_40 + 1 ) ;
if ( ! V_9 -> V_17 ) {
F_17 ( & V_29 -> V_36 , L_3 ) ;
V_32 = - V_37 ;
goto V_42;
}
V_9 -> V_12 = F_20 ( & V_29 -> V_36 , NULL ) ;
if ( F_21 ( V_9 -> V_12 ) ) {
F_17 ( & V_29 -> V_36 , L_4 ) ;
goto V_43;
}
...
V_32 = F_23 ( V_24 , F_11 , 0 , V_46 , V_9 ) ;
if ( V_32 < 0 ) {
F_17 ( & V_29 -> V_36 , L_6 ) ;
goto V_45;
}
...
{
struct V_1 * V_34 = F_34 ( V_29 ) ;
struct V_8 * V_9 = F_2 ( V_34 ) ;
int V_24 = F_22 ( V_29 , 0 ) ;
F_35 ( V_34 ) ;
F_29 ( V_24 , V_9 ) ;
F_24 ( V_29 , NULL ) ;
F_30 ( V_9 -> V_12 ) ;
