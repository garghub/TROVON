...
if ( V_5 -> V_51 -> V_132 )
V_5 -> V_117 += V_133 ;
V_5 -> V_102 = F_55 ( sizeof( * V_5 -> V_102 ) * V_5 -> V_103 ,
V_134 ) ;
if ( ! V_5 -> V_102 ) {
F_56 ( & V_2 -> V_118 , L_3 ) ;
V_25 = - V_135 ;
...
V_5 -> V_104 = F_55 ( sizeof( * V_5 -> V_104 ) * V_5 -> V_105 ,
V_134 ) ;
if ( ! V_5 -> V_104 ) {
F_56 ( & V_2 -> V_118 , L_4 ) ;
V_25 = - V_135 ;
...
V_5 -> V_116 = F_57 ( NULL , V_110 , & V_5 -> V_124 ,
V_134 ) ;
if ( ! V_5 -> V_116 ) {
F_56 ( & V_2 -> V_118 , L_5 ,
V_110 ) ;
...
V_5 -> V_126 = F_57 ( NULL , V_111 , & V_5 -> V_128 ,
V_134 ) ;
if ( ! V_5 -> V_126 ) {
F_56 ( & V_2 -> V_118 , L_6 ,
V_111 ) ;
...
if ( ! V_5 -> V_51 -> V_238 && ( V_189 & V_239 ) ) {
V_2 -> V_186 . V_234 ++ ;
if ( F_75 ( V_5 ) )
F_56 ( & V_2 -> V_118 , L_13 ) ;
}
V_215 = V_228 | V_229 | V_239 | V_233 | V_235 ;
if ( V_5 -> V_51 -> V_238 )
V_215 &= ~ V_239 ;
if ( V_189 & V_215 ) {
T_1 V_240 = F_6 ( V_2 , V_241 ) ;
F_56 ( & V_2 -> V_118 , L_14 ,
V_189 , V_5 -> V_113 ) ;
F_56 ( & V_2 -> V_118 , L_15 ,
V_5 -> V_115 , ( T_1 ) V_2 -> V_242 , V_240 ) ;
F_62 ( V_2 ) ;
if ( V_240 ^ F_36 ( V_5 ) ) {
F_4 ( V_2 , F_36 ( V_5 ) , V_241 ) ;
}
F_77 ( V_2 ) ;
}
}
static T_4 F_78 ( int V_243 , void * V_244 )
{
...
{
struct V_4 * V_5 = F_2 ( V_2 ) ;
struct V_256 * V_257 = V_5 -> V_257 ;
int V_258 = 0 ;
if ( V_257 -> V_222 != V_223 ) {
if ( V_257 -> V_11 != V_5 -> V_11 ) {
V_258 = 1 ;
V_5 -> V_11 = V_257 -> V_11 ;
if ( V_5 -> V_51 -> V_259 )
V_5 -> V_51 -> V_259 ( V_2 ) ;
}
if ( V_257 -> V_18 != V_5 -> V_18 ) {
V_258 = 1 ;
V_5 -> V_18 = V_257 -> V_18 ;
if ( V_5 -> V_51 -> V_168 )
V_5 -> V_51 -> V_168 ( V_2 ) ;
...
unsigned long V_272 ;
int V_25 ;
F_93 ( & V_5 -> V_246 , V_272 ) ;
V_25 = F_94 ( V_5 -> V_257 , V_271 ) ;
F_95 ( & V_5 -> V_246 , V_272 ) ;
return V_25 ;
}
...
static int F_102 ( struct V_1 * V_244 , int V_276 )
{
switch ( V_276 ) {
case V_277 :
return V_278 ;
...
V_25 = F_54 ( V_2 ) ;
if ( V_25 < 0 ) {
F_56 ( & V_2 -> V_118 , L_18 , V_296 ) ;
return V_25 ;
}
V_25 = F_60 ( V_2 , false ) ;
if ( V_25 < 0 ) {
F_56 ( & V_2 -> V_118 , L_19 , V_296 ) ;
return V_25 ;
}
if ( F_107 ( V_2 ) ) {
F_4 ( V_2 , V_5 -> V_51 -> V_164 , V_143 ) ;
...
if ( F_117 ( V_5 ) )
F_56 ( & V_2 -> V_118 , L_21
L_22 , V_2 -> V_267 , ( int ) F_6 ( V_2 , V_163 ) ) ;
V_2 -> V_186 . V_303 ++ ;
for ( V_20 = 0 ; V_20 < V_5 -> V_103 ; V_20 ++ ) {
V_107 = & V_5 -> V_116 [ V_20 ] ;
V_107 -> V_120 = 0 ;
...
if ( ! V_257 )
return - V_320 ;
return F_126 ( V_257 , V_318 , V_319 ) ;
}
...
V_5 -> V_264 -> V_267 = L_25 ;
V_5 -> V_264 -> V_387 = & V_2 -> V_118 ;
snprintf ( V_5 -> V_264 -> V_265 , V_262 , L_26 ,
V_5 -> V_297 -> V_267 , V_265 ) ;
V_5 -> V_264 -> V_243 = F_55 ( sizeof( int ) * V_388 , V_134 ) ;
if ( ! V_5 -> V_264 -> V_243 ) {
V_25 = - V_135 ;
goto V_389;
}
for ( V_20 = 0 ; V_20 < V_388 ; V_20 ++ )
V_5 -> V_264 -> V_243 [ V_20 ] = V_390 ;
V_25 = F_161 ( V_5 -> V_264 ) ;
if ( V_25 )
goto V_302;
F_156 ( & V_2 -> V_118 , V_5 -> V_264 ) ;
return 0 ;
V_302:
F_47 ( V_5 -> V_264 -> V_243 ) ;
V_389:
F_157 ( V_5 -> V_264 ) ;
V_386:
F_47 ( V_96 ) ;
...
static const T_3 * F_162 ( int V_391 )
{
const T_3 * V_86 = NULL ;
switch ( V_391 ) {
case V_392 :
...
break;
default:
F_25 ( V_70 L_27 , V_391 ) ;
break;
}
return V_86 ;
}
static int F_163 ( struct V_397 * V_297 )
{
int V_25 , V_398 = 0 ;
struct V_399 * V_400 ;
struct V_1 * V_2 = NULL ;
struct V_4 * V_5 = NULL ;
struct V_380 * V_381 ;
V_400 = F_164 ( V_297 , V_401 , 0 ) ;
if ( F_144 ( V_400 == NULL ) ) {
F_56 ( & V_297 -> V_118 , L_28 ) ;
V_25 = - V_293 ;
goto V_29;
}
...
V_2 -> V_243 = V_25 ;
F_167 ( V_2 , & V_297 -> V_118 ) ;
F_168 ( V_2 ) ;
V_5 = F_2 ( V_2 ) ;
V_5 -> V_105 = V_405 ;
V_5 -> V_103 = V_406 ;
V_5 -> V_90 = F_169 ( V_400 -> V_139 , F_170 ( V_400 ) ) ;
if ( V_5 -> V_90 == NULL ) {
V_25 = - V_135 ;
F_56 ( & V_297 -> V_118 , L_29 ) ;
goto V_404;
}
F_171 ( & V_5 -> V_246 ) ;
V_5 -> V_297 = V_297 ;
...
V_5 -> V_226 = V_381 -> V_226 ;
V_5 -> V_86 = F_162 ( V_381 -> V_391 ) ;
#if F_8 ( V_409 )
V_5 -> V_51 = F_20 ( V_5 ) ;
#else
V_5 -> V_51 = & V_42 ;
...
if ( V_5 -> V_51 -> V_339 ) {
struct V_399 * V_417 ;
V_417 = F_164 ( V_297 , V_401 , 1 ) ;
if ( ! V_417 ) {
F_56 ( & V_297 -> V_118 , L_30 ) ;
goto V_404;
}
V_5 -> V_418 = F_169 ( V_417 -> V_139 ,
F_170 ( V_417 ) ) ;
V_5 -> V_322 = V_398 % 2 ;
V_2 -> V_419 = V_420 ;
}
...
goto V_423;
F_176 ( L_31 ,
( T_1 ) V_2 -> V_402 , V_2 -> V_82 , V_2 -> V_243 ) ;
F_177 ( V_297 , V_2 ) ;
return V_25 ;
V_423:
F_178 ( V_2 ) ;
...
static int F_181 ( struct V_397 * V_297 )
{
struct V_1 * V_2 = F_182 ( V_297 ) ;
struct V_4 * V_5 = F_2 ( V_2 ) ;
if ( V_5 -> V_51 -> V_339 )
F_179 ( V_5 -> V_418 ) ;
F_153 ( V_2 ) ;
...
static int F_184 ( struct V_424 * V_118 )
{
return 0 ;
}
