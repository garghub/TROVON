...
#if F_32 ( V_84 ) || F_32 ( V_85 )
if ( V_11 [ 0 ] & 0x20 ) {
F_33 ( V_10 -> V_86 , V_87 , 1 ) ;
F_34 ( V_10 -> V_86 ) ;
F_33 ( V_10 -> V_86 , V_87 , 0 ) ;
F_34 ( V_10 -> V_86 ) ;
}
#endif
if ( V_11 [ 1 ] & 0x10 ) {
...
F_31 ( V_10 , V_89 , V_11 , V_16 ) ;
}
static int F_35 ( struct V_90 * V_91 )
{
struct V_10 * V_10 =
F_36 ( V_91 -> V_92 , struct V_10 , V_93 ) ;
struct V_26 * V_26 = (struct V_26 * ) V_10 ;
V_10 -> V_94 = 0 ;
if ( ! V_10 -> V_95 )
return 0 ;
...
break;
case V_97 :
F_21 ( V_10 , V_26 -> V_66 -> V_52 , V_91 -> V_52 ) ;
break;
case V_98 :
F_21 ( V_10 , V_91 -> V_52 , 0 ) ;
break;
case V_99 :
F_22 ( V_10 , V_91 -> V_52 ) ;
break;
...
{
struct V_102 * V_103 = & V_10 -> V_93 ;
V_10 -> V_104 . V_93 = V_103 ;
F_38 ( V_103 , 3 ) ;
F_39 ( V_103 , & V_105 ,
V_98 , 1 , 0x7f , 1 , 0x40 ) ;
F_39 ( V_103 , & V_105 ,
...
V_10 -> V_104 . V_93 = V_103 ;
F_38 ( V_103 , 4 ) ;
V_26 -> V_54 = F_39 ( V_103 , & V_105 ,
V_97 , 0 , 0x3f , 1 , 0x20 ) ;
V_26 -> V_66 = F_39 ( V_103 , & V_105 ,
V_98 , 1 , 0x7f , 1 , 0x40 ) ;
F_39 ( V_103 , & V_105 ,
V_96 , 0 , 0x3f , 1 , 0x20 ) ;
V_26 -> V_67 = F_39 ( V_103 , & V_105 ,
V_101 , 0 , 1 , 1 , 1 ) ;
if ( V_103 -> error ) {
F_5 ( L_7 ) ;
return V_103 -> error ;
