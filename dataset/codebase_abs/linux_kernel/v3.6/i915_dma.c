...
static int F_71 ( struct V_7 * V_4 , void * V_63 ,
struct V_64 * V_65 )
{
T_2 * V_2 = V_4 -> V_8 ;
T_10 * V_133 = V_63 ;
...
F_15 ( L_27 , ( T_1 ) V_168 -> V_16 ) ;
V_27 -> V_28 . V_29 = V_168 -> V_16 & ( 0x1ffff << 12 ) ;
V_2 -> V_5 . V_6 =
F_74 ( V_2 -> V_161 . V_169 + V_168 -> V_16 , 4096 ) ;
if ( V_2 -> V_5 . V_6 == NULL ) {
F_23 ( V_4 ) ;
V_27 -> V_28 . V_29 = 0 ;
F_13 ( L_7
...
{
T_2 * V_2 = V_4 -> V_8 ;
int V_3 = F_9 ( V_4 ) -> V_19 >= 4 ? V_171 : V_172 ;
T_1 V_173 , V_174 = 0 ;
T_12 V_175 ;
int V_44 ;
if ( F_9 ( V_4 ) -> V_19 >= 4 )
F_79 ( V_2 -> V_170 , V_3 + 4 , & V_174 ) ;
F_79 ( V_2 -> V_170 , V_3 , & V_173 ) ;
V_175 = ( ( T_12 ) V_174 << 32 ) | V_173 ;
#ifdef F_80
if ( V_175 &&
F_81 ( V_175 , V_175 + V_176 ) )
return 0 ;
#endif
V_2 -> V_177 . V_178 = L_32 ;
V_2 -> V_177 . V_179 = V_180 ;
V_44 = F_82 ( V_2 -> V_170 -> V_181 ,
& V_2 -> V_177 ,
V_176 , V_176 ,
V_182 ,
0 , V_183 ,
...
{
T_2 * V_2 = V_4 -> V_8 ;
int V_184 = F_9 ( V_4 ) -> V_19 >= 4 ? V_171 : V_172 ;
T_1 V_185 ;
bool V_186 ;
V_2 -> V_187 = false ;
if ( F_87 ( V_4 ) || F_88 ( V_4 ) ) {
F_79 ( V_2 -> V_170 , V_188 , & V_185 ) ;
V_186 = ! ! ( V_185 & V_189 ) ;
} else {
F_79 ( V_2 -> V_170 , V_184 , & V_185 ) ;
V_186 = V_185 & 1 ;
}
if ( V_186 )
return;
...
V_2 -> V_187 = true ;
if ( F_87 ( V_4 ) || F_88 ( V_4 ) ) {
F_83 ( V_2 -> V_170 , V_188 ,
V_185 | V_189 ) ;
} else {
F_79 ( V_2 -> V_170 , V_184 , & V_185 ) ;
F_83 ( V_2 -> V_170 , V_184 , V_185 | 1 ) ;
}
}
static void
F_89 ( struct V_7 * V_4 )
...
F_79 ( V_2 -> V_170 , V_188 , & V_185 ) ;
V_185 &= ~ V_189 ;
F_83 ( V_2 -> V_170 , V_188 , V_185 ) ;
} else {
F_79 ( V_2 -> V_170 , V_184 , & V_185 ) ;
V_185 &= ~ 1 ;
F_83 ( V_2 -> V_170 , V_184 , V_185 ) ;
}
}
if ( V_2 -> V_177 . V_96 )
F_90 ( & V_2 -> V_177 ) ;
}
static unsigned int F_91 ( void * V_190 , bool V_191 )
{
struct V_7 * V_4 = V_190 ;
F_92 ( V_4 , V_191 ) ;
if ( V_191 )
return V_192 | V_193 |
V_194 | V_195 ;
...
static void F_93 ( struct V_196 * V_136 , enum V_197 V_191 )
{
struct V_7 * V_4 = F_94 ( V_136 ) ;
T_13 V_198 = { . V_199 = V_200 } ;
if ( V_191 == V_201 ) {
F_95 ( L_34 ) ;
V_4 -> V_202 = V_203 ;
F_96 ( V_4 -> V_136 , V_204 ) ;
F_97 ( V_4 ) ;
V_4 -> V_202 = V_205 ;
} else {
F_98 ( L_35 ) ;
...
static bool F_100 ( struct V_196 * V_136 )
{
struct V_7 * V_4 = F_94 ( V_136 ) ;
bool V_207 ;
F_101 ( & V_4 -> V_208 ) ;
...
if ( V_44 )
F_105 ( L_36 ) ;
V_44 = F_106 ( V_4 -> V_136 , V_4 , NULL , F_91 ) ;
if ( V_44 && V_44 != - V_67 )
goto V_210;
F_107 () ;
V_44 = F_108 ( V_4 -> V_136 , & V_211 ) ;
if ( V_44 )
goto V_212;
V_44 = F_109 ( V_4 ) ;
if ( V_44 )
...
F_119 ( V_4 -> V_136 ) ;
V_212:
F_106 ( V_4 -> V_136 , NULL , NULL , NULL ) ;
V_210:
return V_44 ;
}
int F_120 ( struct V_7 * V_4 , struct V_219 * V_12 )
{
struct V_9 * V_10 ;
V_10 = F_121 ( sizeof( * V_10 ) , V_111 ) ;
if ( ! V_10 )
return - V_22 ;
V_12 -> V_13 = V_10 ;
return 0 ;
}
void F_122 ( struct V_7 * V_4 , struct V_219 * V_12 )
{
...
static void
F_123 ( struct V_1 * V_2 , unsigned long V_220 ,
unsigned long V_36 )
{
V_2 -> V_161 . V_221 = - 1 ;
#if F_124 ( V_222 )
...
return;
#endif
V_2 -> V_161 . V_221 = F_125 ( V_220 , V_36 , V_224 , 1 ) ;
if ( V_2 -> V_161 . V_221 < 0 ) {
F_105 ( L_37
L_38 ) ;
}
}
...
{
struct V_225 * V_226 ;
struct V_196 * V_136 = V_2 -> V_4 -> V_136 ;
bool V_11 ;
V_226 = F_127 ( 1 ) ;
if ( ! V_226 )
return;
V_226 -> V_227 [ 0 ] . V_220 = V_2 -> V_161 . V_228 -> V_229 ;
V_226 -> V_227 [ 0 ] . V_36 =
V_2 -> V_161 . V_228 -> V_230 << V_231 ;
V_11 =
V_136 -> V_232 [ V_233 ] . V_179 & V_234 ;
F_128 ( V_226 , L_39 , V_11 ) ;
F_55 ( V_226 ) ;
}
int F_129 ( struct V_7 * V_4 , unsigned long V_179 )
{
struct V_1 * V_2 ;
struct V_235 * V_236 ;
int V_44 = 0 , V_237 ;
T_14 V_238 ;
V_236 = (struct V_235 * ) V_179 ;
if ( V_236 -> V_19 >= 6 && ! F_20 ( V_4 , V_30 ) )
return - V_67 ;
V_4 -> V_239 += 4 ;
V_4 -> V_240 [ 6 ] = V_241 ;
V_4 -> V_240 [ 7 ] = V_242 ;
...
V_44 = F_130 ( V_2 -> V_170 , V_4 -> V_136 , NULL ) ;
if ( ! V_44 ) {
F_13 ( L_40 ) ;
V_44 = - V_245 ;
goto V_247;
}
V_2 -> V_161 . V_228 = F_131 () ;
if ( ! V_2 -> V_161 . V_228 ) {
F_13 ( L_41 ) ;
V_44 = - V_67 ;
goto V_248;
...
F_132 ( V_4 -> V_136 ) ;
if ( F_133 ( V_4 ) )
F_134 ( & V_4 -> V_136 -> V_4 , F_135 ( 30 ) ) ;
if ( F_136 ( V_4 ) || F_137 ( V_4 ) )
F_134 ( & V_4 -> V_136 -> V_4 , F_135 ( 32 ) ) ;
V_237 = F_133 ( V_4 ) ? 1 : 0 ;
V_2 -> V_249 = F_138 ( V_4 -> V_136 , V_237 , 0 ) ;
if ( ! V_2 -> V_249 ) {
F_13 ( L_42 ) ;
V_44 = - V_245 ;
goto V_248;
}
V_238 = V_2 -> V_161 . V_228 -> V_230 << V_231 ;
V_2 -> V_161 . V_169 = V_2 -> V_161 . V_228 -> V_229 ;
V_2 -> V_161 . V_250 =
F_139 ( V_2 -> V_161 . V_169 ,
V_238 ) ;
if ( V_2 -> V_161 . V_250 == NULL ) {
V_44 = - V_245 ;
goto V_251;
}
F_123 ( V_2 , V_2 -> V_161 . V_169 ,
V_238 ) ;
V_2 -> V_252 = F_140 ( L_43 ,
V_253 | V_254 ,
1 ) ;
if ( V_2 -> V_252 == NULL ) {
F_13 ( L_44 ) ;
...
V_2 -> V_261 = 3 ;
else if ( F_154 ( V_4 ) || ! F_133 ( V_4 ) )
V_2 -> V_261 = 2 ;
else
V_2 -> V_261 = 1 ;
V_44 = F_155 ( V_4 , V_2 -> V_261 ) ;
if ( V_44 )
goto V_256;
V_2 -> V_161 . V_218 = 1 ;
if ( F_20 ( V_4 , V_30 ) ) {
...
F_157 ( V_4 ) ;
F_158 () ;
F_159 ( & V_2 -> V_262 , V_263 ,
( unsigned long ) V_4 ) ;
if ( F_46 ( V_4 ) )
F_160 ( V_2 ) ;
return 0 ;
V_256:
if ( V_2 -> V_161 . V_264 . V_265 )
F_161 ( & V_2 -> V_161 . V_264 ) ;
if ( V_4 -> V_136 -> V_266 )
F_162 ( V_4 -> V_136 ) ;
F_163 ( V_4 ) ;
F_89 ( V_4 ) ;
...
V_255:
if ( V_2 -> V_161 . V_221 >= 0 ) {
F_165 ( V_2 -> V_161 . V_221 ,
V_2 -> V_161 . V_169 ,
V_238 ) ;
V_2 -> V_161 . V_221 = - 1 ;
}
F_166 ( V_2 -> V_161 . V_250 ) ;
V_251:
F_167 ( V_4 -> V_136 , V_2 -> V_249 ) ;
V_248:
F_168 () ;
V_247:
F_169 ( V_2 -> V_170 ) ;
...
F_174 ( V_4 ) ;
F_27 ( & V_4 -> V_41 ) ;
F_175 ( & V_2 -> V_161 . V_267 ) ;
F_166 ( V_2 -> V_161 . V_250 ) ;
if ( V_2 -> V_161 . V_221 >= 0 ) {
F_165 ( V_2 -> V_161 . V_221 ,
V_2 -> V_161 . V_169 ,
V_2 -> V_161 . V_228 -> V_230 * V_21 ) ;
V_2 -> V_161 . V_221 = - 1 ;
}
F_176 () ;
if ( F_20 ( V_4 , V_30 ) ) {
...
int F_188 ( struct V_7 * V_4 , struct V_64 * V_272 )
{
struct V_273 * V_65 ;
F_15 ( L_18 ) ;
...
return - V_22 ;
V_272 -> V_13 = V_65 ;
F_151 ( & V_65 -> V_161 . V_274 ) ;
F_189 ( & V_65 -> V_161 . V_275 ) ;
F_190 ( & V_65 -> V_276 ) ;
return 0 ;
}
void F_191 ( struct V_7 * V_4 )
{
T_2 * V_2 = V_4 -> V_8 ;
if ( ! V_2 )
return;
...
void F_195 ( struct V_7 * V_4 , struct V_64 * V_65 )
{
F_196 ( V_4 , V_65 ) ;
F_197 ( V_4 , V_65 ) ;
}
void F_198 ( struct V_7 * V_4 , struct V_64 * V_272 )
{
struct V_273 * V_65 = V_272 -> V_13 ;
F_55 ( V_65 ) ;
}
int F_199 ( struct V_7 * V_4 )
{
return 1 ;
}
