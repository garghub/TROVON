...
V_35 = F_12 ( V_33 -> V_41 ) ;
if ( ( V_35 & V_42 ) == 0 )
F_13 ( V_33 -> V_41 , V_35 | V_42 ) ;
V_35 = F_12 ( V_33 -> V_43 ) ;
if ( ( V_35 & V_44 ) == 0 ) {
F_13 ( V_33 -> V_43 ,
V_35 | V_44 ) ;
F_13 ( V_33 -> V_45 , F_12 ( V_33 -> V_45 ) ) ;
}
F_15 ( V_3 ) ;
break;
case V_46 :
...
F_13 ( V_49 , 0x3FFF ) ;
F_13 ( V_50 , 0x3F88080A ) ;
F_13 ( V_51 , 0x0b060808 ) ;
F_13 ( V_52 , 0x0 ) ;
F_13 ( V_53 , 0x08030404 ) ;
F_13 ( V_54 , 0x04040404 ) ;
F_13 ( V_55 , 0x78 ) ;
...
V_89 = ( V_60 -> V_85 -
V_29 -> V_85 ) / 2 ;
F_13 ( V_33 -> V_90 , ( V_29 -> V_84 - 1 ) |
( ( V_60 -> V_91 - 1 ) << 16 ) ) ;
F_13 ( V_33 -> V_92 , ( V_29 -> V_85 - 1 ) |
( ( V_60 -> V_93 - 1 ) << 16 ) ) ;
F_13 ( V_33 -> V_94 ,
( V_60 -> V_95 - V_88 - 1 ) |
( ( V_60 -> V_96 - V_88 - 1 ) << 16 ) ) ;
...
F_13 ( V_33 -> V_90 , ( V_60 -> V_84 - 1 ) |
( ( V_60 -> V_91 - 1 ) << 16 ) ) ;
F_13 ( V_33 -> V_92 , ( V_60 -> V_85 - 1 ) |
( ( V_60 -> V_93 - 1 ) << 16 ) ) ;
F_13 ( V_33 -> V_94 , ( V_60 -> V_95 - 1 ) |
( ( V_60 -> V_96 - 1 ) << 16 ) ) ;
F_13 ( V_33 -> V_97 , ( V_60 -> V_98 - 1 ) |
( ( V_60 -> V_99 - 1 ) << 16 ) ) ;
F_13 ( V_33 -> V_100 , ( V_60 -> V_101 - 1 ) |
( ( V_60 -> V_102 - 1 ) << 16 ) ) ;
F_13 ( V_33 -> V_103 , ( V_60 -> V_104 - 1 ) |
( ( V_60 -> V_105 - 1 ) << 16 ) ) ;
}
{
struct V_106 * V_107 =
...
F_5 ( L_7 , & clock ) ;
if ( V_39 & V_40 ) {
F_13 ( V_33 -> V_122 , V_65 ) ;
F_13 ( V_33 -> V_39 , V_39 & ~ V_40 ) ;
F_12 ( V_33 -> V_39 ) ;
F_14 ( 150 ) ;
}
F_13 ( V_33 -> V_122 , V_65 ) ;
...
struct V_7 * V_8 = V_6 -> V_9 ;
struct V_30 * V_30 = F_10 ( V_3 ) ;
struct V_123 * V_124 = F_25 ( V_3 -> V_125 ) ;
int V_31 = V_30 -> V_31 ;
const struct V_32 * V_33 = & V_8 -> V_34 [ V_31 ] ;
...
F_13 ( V_33 -> V_132 , V_3 -> V_125 -> V_130 [ 0 ] ) ;
V_66 = F_12 ( V_33 -> V_43 ) ;
V_66 &= ~ V_133 ;
...
F_13 ( V_33 -> V_43 , V_66 ) ;
F_13 ( V_33 -> V_45 , V_127 ) ;
F_12 ( V_33 -> V_45 ) ;
F_13 ( V_33 -> V_141 , V_126 ) ;
F_12 ( V_33 -> V_141 ) ;
V_140:
F_17 ( V_6 ) ;
return V_128 ;
