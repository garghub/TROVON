...
if ( V_80 )
return V_80 ;
F_79 ( V_167 , & V_4 -> V_168 ) ;
F_79 ( V_169 , & V_4 -> V_168 ) ;
F_79 ( V_170 , & V_4 -> V_168 ) ;
F_79 ( V_171 , & V_4 -> V_168 ) ;
if ( ! V_172 )
F_79 ( V_173 , & V_4 -> V_168 ) ;
F_79 ( V_174 , & V_4 -> V_168 ) ;
F_79 ( V_175 , & V_4 -> V_168 ) ;
F_79 ( V_176 , & V_4 -> V_168 ) ;
F_79 ( V_177 , & V_4 -> V_168 ) ;
V_4 -> V_33 . V_178 = F_26 ,
V_4 -> V_179 = V_180 ;
F_80 ( & V_4 -> V_32 , F_65 ) ;
return 0 ;
}
static int F_81 ( struct V_181 * V_182 ,
const struct V_183 * V_184 )
{
return F_82 ( V_182 , & V_185 ) ;
}
