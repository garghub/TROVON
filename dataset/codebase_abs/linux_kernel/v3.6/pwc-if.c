...
V_3 -> V_60 = V_60 ;
V_3 -> V_138 = V_137 ;
memset ( & V_3 -> V_150 , 0 , sizeof( V_3 -> V_150 ) ) ;
...
F_73 ( & V_3 -> V_150 ) ;
memcpy ( & V_3 -> V_162 , & V_163 , sizeof( V_163 ) ) ;
strcpy ( V_3 -> V_162 . V_140 , V_140 ) ;
V_3 -> V_162 . V_164 = & V_3 -> V_150 ;
V_3 -> V_162 . V_164 -> V_165 = & V_3 -> V_149 ;
F_74 ( V_166 , & V_3 -> V_162 . V_4 ) ;
F_75 ( & V_3 -> V_162 , V_3 ) ;
V_3 -> V_167 = F_24 ( V_60 -> V_141 . V_168 ) ;
F_64 ( L_107 , V_3 -> V_167 ) ;
V_3 -> V_107 = F_76 ( sizeof( V_3 -> V_169 ) , V_87 ) ;
if ( ! V_3 -> V_107 ) {
F_17 ( L_106 ) ;
V_135 = - V_88 ;
goto V_170;
...
V_3 -> V_162 . V_105 = & V_3 -> V_105 ;
V_3 -> V_162 . V_165 = & V_3 -> V_127 ;
V_135 = F_81 ( & V_3 -> V_162 , V_173 , - 1 ) ;
if ( V_135 < 0 ) {
F_17 ( L_111 , V_135 ) ;
goto V_174;
}
F_65 ( L_112 , F_82 ( & V_3 -> V_162 ) ) ;
#ifdef F_9
V_3 -> V_12 = F_83 () ;
if ( ! V_3 -> V_12 ) {
F_17 ( L_113 ) ;
...
F_85 ( V_3 -> V_176 , L_114 , sizeof( V_3 -> V_176 ) ) ;
V_3 -> V_12 -> V_140 = L_115 ;
