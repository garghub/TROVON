...
memcpy ( & V_4 -> V_363 [ V_6 ] , & V_4 -> V_40 [ V_6 ] ,
sizeof( struct V_364 ) ) ;
...
V_4 -> V_97 = NULL ;
for ( V_6 = 0 ; V_6 < V_13 -> V_95 ; V_6 ++ ) {
for ( V_374 = 0 ; V_374 < V_4 -> V_92 ; V_374 ++ ) {
if ( strcmp ( V_13 -> V_96 [ V_6 ] . V_55 ,
V_4 -> V_97 [ V_374 ] ) == 0 )
break;
}
...
F_5 ( V_2 -> V_29 , L_53 ,
V_4 -> V_92 ) ;
V_4 -> V_373 . V_377 = V_4 -> V_92 ;
V_4 -> V_373 . V_378 = V_4 -> V_97 ;
V_64 = F_86 ( V_4 -> V_2 , V_372 ,
F_4 ( V_372 ) ) ;
if ( V_64 != 0 )
F_57 ( V_4 -> V_2 -> V_29 ,
L_54 , V_64 ) ;
...
V_4 -> V_388 = F_89 ( V_4 -> V_2 -> V_29 ,
sizeof( char * ) * V_13 -> V_85 , V_376 ) ;
if ( ! V_4 -> V_388 ) {
F_57 ( V_4 -> V_2 -> V_29 ,
L_56 ,
V_13 -> V_85 ) ;
...
V_4 -> V_388 [ V_6 ] = V_13 -> V_81 [ V_6 ] . V_55 ;
V_4 -> V_387 . V_377 = V_13 -> V_85 ;
V_4 -> V_387 . V_378 = V_4 -> V_388 ;
V_64 = F_86 ( V_4 -> V_2 , V_372 ,
F_4 ( V_372 ) ) ;
if ( V_64 != 0 )
F_57 ( V_4 -> V_2 -> V_29 ,
L_57 , V_64 ) ;
for ( V_6 = 0 ; V_6 < V_389 ; V_6 ++ )
F_14 ( V_2 , V_6 ) ;
}
F_5 ( V_2 -> V_29 , L_58 ,
V_13 -> V_95 ) ;
...
F_86 ( V_4 -> V_2 , V_390 ,
F_4 ( V_390 ) ) ;
for ( V_6 = 0 ; V_6 < F_4 ( V_13 -> V_391 ) ; V_6 ++ ) {
if ( V_13 -> V_391 [ V_6 ] ) {
F_39 ( V_2 , V_272 + V_6 ,
V_13 -> V_391 [ V_6 ] & 0xffff ) ;
}
}
}
int F_90 ( struct V_1 * V_2 , struct V_392 * V_393 ,
int V_391 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
struct V_394 * V_395 ;
...
V_395 -> V_393 = V_393 ;
V_395 -> V_396 = true ;
if ( V_4 -> V_395 [ 0 ] . V_393 || V_4 -> V_395 [ 1 ] . V_393 )
V_53 = V_397 ;
else
V_53 = 0 ;
F_6 ( V_2 , V_398 , V_397 , V_53 ) ;
F_9 ( & V_2 -> V_49 ) ;
return 0 ;
}
static void F_91 ( struct V_399 * V_400 )
{
struct V_3 * V_401 = F_92 ( V_400 ,
struct V_3 ,
V_402 . V_400 ) ;
struct V_365 * V_365 = V_401 -> V_4 -> V_365 ;
struct V_403 * V_29 = V_401 -> V_4 -> V_29 ;
unsigned int V_53 ;
int V_64 ;
int V_404 ;
F_29 ( V_29 ) ;
V_64 = F_82 ( V_365 , V_405 , & V_53 ) ;
if ( V_64 < 0 ) {
F_57 ( V_29 , L_64 ,
V_64 ) ;
F_34 ( V_29 ) ;
...
if ( V_404 )
V_401 -> V_395 [ 0 ] . V_396 = false ;
else
V_401 -> V_395 [ 0 ] . V_396 = true ;
F_93 ( V_401 -> V_395 [ 0 ] . V_393 , V_404 ,
V_407 | V_410 ) ;
V_404 = 0 ;
if ( V_53 & V_411 ) {
if ( V_401 -> V_395 [ 1 ] . V_396 )
V_404 = V_407 ;
}
if ( V_53 & V_412 ) {
if ( V_401 -> V_395 [ 1 ] . V_396 )
...
if ( V_404 )
V_401 -> V_395 [ 1 ] . V_396 = false ;
else
V_401 -> V_395 [ 1 ] . V_396 = true ;
F_93 ( V_401 -> V_395 [ 1 ] . V_393 , V_404 ,
V_407 | V_410 ) ;
F_34 ( V_29 ) ;
}
static T_3 F_94 ( int V_252 , void * V_253 )
{
struct V_3 * V_401 = V_253 ;
struct V_1 * V_2 = V_401 -> V_2 ;
#ifndef F_95
F_96 ( F_97 ( V_2 -> V_29 ) ) ;
#endif
F_98 ( V_2 -> V_29 , 300 ) ;
F_99 ( & V_401 -> V_402 , F_60 ( 250 ) ) ;
return V_255 ;
}
static void V_16 ( T_1 V_413 , void * V_253 )
{
struct V_1 * V_2 = V_253 ;
struct V_3 * V_4 = F_2 ( V_2 ) ;
int V_404 ;
F_5 ( V_2 -> V_29 , L_66 , V_413 ) ;
if ( ! ( V_413 & V_414 ) ) {
if ( ! V_4 -> V_22 ) {
F_5 ( V_2 -> V_29 , L_67 ) ;
V_4 -> V_17 = false ;
...
int F_101 ( struct V_1 * V_2 , struct V_392 * V_393 ,
...
int V_64 , V_6 ;
V_4 -> V_2 = V_2 ;
V_2 -> V_152 = V_151 -> V_365 ;
F_109 ( V_2 , 16 , 16 , V_444 ) ;
V_4 -> V_2 = V_2 ;
F_110 ( & V_4 -> V_108 ) ;
F_111 ( & V_4 -> V_402 , F_91 ) ;
...
F_115 ( V_4 -> V_4 , V_459 ,
F_105 , L_86 , V_2 ) ;
V_64 = F_115 ( V_4 -> V_4 , V_460 ,
V_461 , L_87 ,
& V_4 -> V_132 ) ;
if ( V_64 == 0 )
V_4 -> V_132 . V_462 = true ;
switch ( V_151 -> type ) {
case V_157 :
if ( V_4 -> V_445 ) {
...
F_29 ( V_2 -> V_29 ) ;
V_64 = F_82 ( V_151 -> V_365 , V_469 , & V_53 ) ;
if ( V_64 < 0 ) {
...
V_64 = F_82 ( V_151 -> V_365 , V_475 , & V_53 ) ;
if ( V_64 < 0 ) {
...
F_123 ( V_4 -> V_4 , V_465 , V_4 ) ;
F_123 ( V_4 -> V_4 , V_464 , V_4 ) ;
if ( V_4 -> V_445 )
F_124 ( V_4 -> V_445 , V_4 ) ;
for ( V_6 = 0 ; V_6 < F_4 ( V_4 -> V_248 ) ; V_6 ++ )
F_123 ( V_4 -> V_4 , V_468 + V_6 ,
& V_4 -> V_248 [ V_6 ] ) ;
F_123 ( V_4 -> V_4 , V_460 ,
& V_4 -> V_132 ) ;
F_123 ( V_4 -> V_4 , V_457 , V_2 ) ;
F_123 ( V_4 -> V_4 , V_459 , V_2 ) ;
F_123 ( V_4 -> V_4 , V_458 , V_2 ) ;
return V_64 ;
}
...
static int T_5 F_129 ( struct V_504 * V_505 )
{
struct V_3 * V_4 ;
V_4 = F_89 ( & V_505 -> V_29 , sizeof( struct V_3 ) ,
V_376 ) ;
if ( V_4 == NULL )
return - V_506 ;
F_130 ( V_505 , V_4 ) ;
V_4 -> V_4 = F_108 ( V_505 -> V_29 . V_442 ) ;
V_4 -> V_13 = F_131 ( V_505 -> V_29 . V_442 ) ;
return F_132 ( & V_505 -> V_29 , & V_507 ,
V_473 , F_4 ( V_473 ) ) ;
}
static int T_6 F_133 ( struct V_504 * V_505 )
{
F_134 ( & V_505 -> V_29 ) ;
return 0 ;
}
static int F_135 ( struct V_403 * V_29 )
{
struct V_3 * V_4 = F_108 ( V_29 ) ;
if ( V_4 -> V_22 && ! V_4 -> V_102 )
F_136 ( V_4 -> V_4 -> V_365 , V_106 ,
V_107 ,
V_4 -> V_104 ) ;
return 0 ;
}
static int F_137 ( struct V_403 * V_29 )
{
struct V_3 * V_4 = F_108 ( V_29 ) ;
if ( V_4 -> V_22 && V_4 -> V_15 )
F_136 ( V_4 -> V_4 -> V_365 , V_106 ,
