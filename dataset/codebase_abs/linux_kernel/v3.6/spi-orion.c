...
V_17 -> V_77 = V_70 -> V_76 ;
if ( V_70 -> V_38 . V_78 ) {
V_74 = F_42 ( V_70 -> V_38 . V_78 , L_12 ,
& V_7 ) ;
if ( V_74 && V_7 == sizeof( * V_74 ) )
V_17 -> V_77 = * V_74 ;
}
V_17 -> V_79 = 0 ;
V_17 -> V_80 = F_33 ;
...
V_73 = F_49 ( V_70 , V_84 , 0 ) ;
if ( V_73 == NULL ) {
V_53 = - V_85 ;
goto V_86;
}
if ( ! F_50 ( V_73 -> V_87 , F_51 ( V_73 ) ,
F_52 ( & V_70 -> V_38 ) ) ) {
V_53 = - V_88 ;
goto V_86;
}
V_12 -> V_3 = F_53 ( V_73 -> V_87 , V_89 ) ;
F_54 ( & V_12 -> V_47 , F_25 ) ;
F_55 ( & V_12 -> V_48 ) ;
F_56 ( & V_12 -> V_49 ) ;
if ( F_32 ( V_12 ) < 0 )
goto V_90;
V_17 -> V_38 . V_78 = V_70 -> V_38 . V_78 ;
V_53 = F_57 ( V_17 ) ;
if ( V_53 < 0 )
goto V_90;
return V_53 ;
V_90:
F_58 ( V_73 -> V_87 , F_51 ( V_73 ) ) ;
V_86:
F_59 ( V_12 -> V_18 ) ;
F_60 ( V_12 -> V_18 ) ;
V_45:
...
static int T_6 F_62 ( struct V_69 * V_70 )
{
struct V_71 * V_17 ;
struct V_1 * V_12 ;
struct V_72 * V_73 ;
