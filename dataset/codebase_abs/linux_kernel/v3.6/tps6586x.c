...
if ( ! V_62 )
return NULL ;
V_65 = F_52 ( & V_56 -> V_3 , V_62 , V_58 , V_57 ) ;
if ( V_65 < 0 ) {
F_53 ( V_62 ) ;
return NULL ;
}
F_53 ( V_62 ) ;
V_63 = V_65 ;
V_61 = F_54 ( & V_56 -> V_3 , V_63 * sizeof( * V_61 ) , V_66 ) ;
if ( ! V_61 )
return NULL ;
for ( V_24 = 0 , V_64 = 0 ; V_24 < V_57 && V_64 < V_63 ; V_24 ++ ) {
if ( ! V_58 [ V_24 ] . V_67 )
continue;
V_61 [ V_64 ] . V_33 = L_5 ;
V_61 [ V_64 ] . V_53 = V_58 [ V_24 ] . V_67 ;
V_61 [ V_64 ] . V_49 = ( int ) V_58 [ V_24 ] . V_68 ;
V_61 [ V_64 ] . V_54 = V_58 [ V_24 ] . V_54 ;
V_64 ++ ;
}
V_42 = F_54 ( & V_56 -> V_3 , sizeof( * V_42 ) , V_66 ) ;
if ( ! V_42 )
return NULL ;
V_42 -> V_47 = V_63 ;
V_42 -> V_48 = V_61 ;
...
static bool F_55 ( struct V_2 * V_3 , unsigned int V_4 )
{
if ( ( V_4 >= V_25 ) && ( V_4 <= V_70 ) )
return false ;
return true ;
}
static int T_4 F_56 ( struct V_55 * V_56 ,
const struct V_71 * V_49 )
{
...
V_9 = F_57 ( V_56 , V_73 ) ;
if ( V_9 < 0 ) {
F_31 ( & V_56 -> V_3 , L_7 , V_9 ) ;
return - V_74 ;
}
F_58 ( & V_56 -> V_3 , L_8 , V_9 ) ;
V_1 = F_54 ( & V_56 -> V_3 , sizeof( * V_1 ) , V_66 ) ;
if ( V_1 == NULL ) {
F_31 ( & V_56 -> V_3 , L_9 ) ;
return - V_50 ;
}
...
static int T_6 F_66 ( struct V_55 * V_56 )
{
