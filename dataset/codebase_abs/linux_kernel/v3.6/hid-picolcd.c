...
F_124 ( V_4 , V_237 ) ;
if ( V_13 [ 2 ] < F_128 ( V_247 ) )
snprintf ( V_237 , F_122 , L_69 ,
V_13 [ 2 ] , V_247 [ V_13 [ 2 ] ] , V_13 [ 1 ] ) ;
else
...
struct V_1 * V_250 , struct V_1 * V_251 ,
struct V_1 * V_252 , struct V_1 * V_253 ,
struct V_1 * V_254 )
{
struct V_3 * V_4 = V_16 -> V_4 ;
F_130 ( & V_16 -> V_232 ) ;
if ( V_254 )
V_16 -> V_255 = F_131 ( L_89 , 0600 ,
V_4 -> V_256 , V_16 , & V_257 ) ;
if ( V_250 || V_251 )
V_16 -> V_258 = F_131 ( L_90 ,
( V_251 ? V_259 : 0 ) | ( V_250 ? V_260 : 0 ) ,
V_4 -> V_256 , V_16 , & V_261 ) ;
if ( V_252 && V_252 -> V_31 == 1 && V_252 -> V_32 [ 0 ] -> V_149 == 8 )
V_16 -> V_220 = V_252 -> V_32 [ 0 ] -> V_33 - 1 ;
else
V_16 -> V_220 = - 1 ;
if ( V_16 -> V_220 == 2 || V_16 -> V_220 == 3 ) {
V_16 -> V_262 = F_131 ( L_91 ,
( V_253 ? V_259 : 0 ) | ( V_252 ? V_260 : 0 ) ,
V_4 -> V_256 , V_16 , & V_263 ) ;
} else if ( V_252 || V_253 )
F_3 ( V_4 , L_92 ) ;
}
...
static inline void F_132 ( struct V_15 * V_16 )
{
}
...
V_16 -> V_34 -> V_27 = V_10 ;
F_136 ( & V_16 -> V_34 -> V_25 ) ;
}
F_13 ( & V_16 -> V_30 , V_18 ) ;
}
F_127 ( V_16 , V_4 , V_10 , V_13 , V_14 ) ;
return 1 ;
}
static int F_137 ( struct V_3 * V_4 , T_8 V_267 )
{
if ( F_138 ( V_267 ) )
return 0 ;
F_72 ( F_5 ( V_4 ) ) ;
...
F_143 ( V_269 , V_4 ) ;
memcpy ( V_16 -> V_187 , V_270 , sizeof( V_270 ) ) ;
V_269 -> V_176 = V_4 -> V_176 ;
V_269 -> V_271 = V_4 -> V_271 ;
V_269 -> V_272 = V_4 -> V_272 ;
V_269 -> V_2 . V_273 = V_4 -> V_274 ;
V_269 -> V_2 . V_275 = V_4 -> V_275 ;
V_269 -> V_2 . V_196 = V_4 -> V_196 ;
V_269 -> V_2 . V_193 = V_4 -> V_193 ;
V_269 -> V_114 . V_172 = V_4 -> V_114 . V_172 ;
V_269 -> V_187 = & V_16 -> V_187 ;
V_269 -> V_276 = V_186 ;
V_269 -> V_277 = sizeof( V_16 -> V_187 [ 0 ] ) ;
F_144 ( V_269 , V_184 , V_185 ) ;
F_145 ( V_278 , V_269 -> V_279 ) ;
for ( V_19 = 0 ; V_19 < V_186 ; V_19 ++ )
F_144 ( V_269 , V_280 , V_16 -> V_187 [ V_19 ] ) ;
error = F_146 ( V_269 ) ;
if ( error ) {
F_97 ( V_4 , L_100 ) ;
F_147 ( V_269 ) ;
...
F_98 ( V_4 , L_101 ,
F_66 ( & V_4 -> V_114 ) ) ;
error = F_141 ( V_16 , F_153 ( V_248 , V_4 ) ) ;
if ( error )
goto V_177;
error = F_150 ( V_16 , F_153 ( V_249 , V_4 ) ) ;
if ( error )
goto V_177;
error = F_49 ( V_16 ) ;
if ( error )
...
F_98 ( V_4 , L_102 ,
F_66 ( & V_4 -> V_114 ) ) ;
F_129 ( V_16 , NULL , NULL ,
F_6 ( V_224 , V_4 ) ,
F_6 ( V_227 , V_4 ) , NULL ) ;
return 0 ;
}
static int F_155 ( struct V_3 * V_4 ,
const struct V_281 * V_2 )
{
struct V_15 * V_16 ;
int error = - V_96 ;
F_92 ( V_189 L_103 ) ;
...
error = F_53 ( & V_4 -> V_114 , & V_285 ) ;
if ( error ) {
F_97 ( V_4 , L_9 ) ;
goto V_286;
}
error = F_53 ( & V_4 -> V_114 , & V_287 ) ;
if ( error ) {
F_97 ( V_4 , L_9 ) ;
goto V_288;
}
...
return 0 ;
V_289:
F_56 ( & V_4 -> V_114 , & V_287 ) ;
V_288:
F_56 ( & V_4 -> V_114 , & V_285 ) ;
V_286:
F_161 ( V_4 ) ;
V_284:
F_162 ( V_4 ) ;
