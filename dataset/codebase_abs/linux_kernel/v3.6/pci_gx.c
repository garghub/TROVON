...
void T_2 F_64 ( struct V_82 * V_83 , int V_7 )
{
F_65 ( V_83 , V_156 , V_7 ) ;
}
int F_66 ( struct V_82 * V_83 , int V_157 )
{
return F_67 ( V_83 , V_157 ) ;
}
static void T_5
F_68 ( struct V_82 * V_158 )
{
F_69 ( & V_158 -> V_83 , V_159 ) ;
F_70 ( & V_158 -> V_83 , V_154 ) ;
V_158 -> V_83 . V_160 . V_161 =
V_162 ;
}
void T_13 * F_71 ( T_1 V_163 , unsigned long V_4 )
{
...
return NULL ;
V_167:
V_166 = V_32 -> V_34 -> V_23 ;
V_6 = V_163 - V_32 -> V_72 ;
V_108 = F_53 ( V_32 -> V_145 ) + V_6 ;
return F_49 ( V_166 , V_108 , V_4 ) +
( V_163 & ( V_168 - 1 ) ) ;
}
void F_72 ( struct V_82 * V_83 , void T_13 * V_169 )
{
F_73 ( V_169 ) ;
}
static int T_2 F_74 ( struct V_87 * V_115 ,
unsigned int V_141 ,
int V_108 ,
int V_4 ,
T_14 * V_170 )
...
T_3 * V_33 = V_32 -> V_34 ;
int V_171 = V_115 -> V_172 & 0xff ;
int V_84 = F_58 ( V_141 ) ;
int V_173 = F_75 ( V_141 ) ;
int V_174 = 1 ;
T_15 V_175 ;
void * V_176 ;
if ( F_76 ( V_115 ) ) {
...
( V_32 -> V_36 <<
V_43 ) ;
V_176 = V_33 -> V_45 + V_37 ;
goto V_178;
} else {
goto V_179;
}
}
if ( V_171 == ( V_32 -> V_135 + 1 ) ) {
if ( V_84 != 0 )
goto V_179;
V_174 = 0 ;
}
V_175 . V_95 = 0 ;
V_175 . V_180 = ( V_108 & 0xFFF ) ;
V_175 . V_181 = V_173 ;
V_175 . V_83 = V_84 ;
V_175 . V_115 = V_171 ;
V_175 . type = V_174 ;
V_176 = V_33 -> V_134 [ V_32 -> V_36 ] +
V_175 . V_95 ;
V_178:
switch ( V_4 ) {
case 4 :
...
F_79 ( V_4 , * V_170 , V_171 , V_84 , V_173 , V_108 ) ;
return 0 ;
V_179:
switch ( V_4 ) {
case 4 :
...
static int T_2 F_80 ( struct V_87 * V_115 ,
unsigned int V_141 ,
int V_108 ,
int V_4 ,
T_14 V_170 )
...
T_15 V_175 ;
void * V_176 ;
T_14 V_183 = ( T_14 ) V_170 ;
T_16 V_184 = ( T_16 ) V_170 ;
T_6 V_185 = ( T_6 ) V_170 ;
if ( F_76 ( V_115 ) ) {
if ( V_84 == 0 ) {
unsigned int V_37 ;
...
case 4 :
F_41 ( V_176 , V_183 ) ;
F_81 ( V_4 , V_183 , V_171 , V_84 , V_173 , V_108 ) ;
break;
case 2 :
F_82 ( V_176 , V_184 ) ;
F_81 ( V_4 , V_184 , V_171 , V_84 , V_173 , V_108 ) ;
break;
case 1 :
F_83 ( V_176 , V_185 ) ;
F_81 ( V_4 , V_185 , V_171 , V_84 , V_173 , V_108 ) ;
break;
default:
return V_182 ;
}
...
int F_90 ( struct V_82 * V_158 , struct V_186 * V_30 )
{
struct V_31 * V_32 ;
T_3 * V_33 ;
struct V_187 V_188 ;
...
if ( V_7 < 0 )
return V_7 ;
if ( V_30 -> V_194 . V_195 == 0 ) {
F_91 ( V_196 , & V_158 -> V_83 ,
L_34
L_35 ) ;
V_17 = - V_197 ;
goto V_198;
}
V_189 = V_30 -> V_194 . V_189 ;
V_32 = F_92 ( V_189 ) ;
F_93 ( ! V_32 ) ;
V_33 = V_32 -> V_34 ;
V_193 = F_60 ( V_33 , 1 , 0 , 0 ) ;
if ( V_193 < 0 ) {
F_91 ( V_196 , & V_158 -> V_83 ,
L_36
L_37
L_38 ,
V_30 -> V_194 . V_199 ? L_39 : L_40 ) ;
V_17 = - V_197 ;
goto V_200;
}
V_10 = F_2 ( V_7 ) ;
...
V_193 * V_202 ;
V_191 = V_190 + V_202 - 1 ;
V_17 = F_94 ( V_33 , F_28 ( V_10 ) , F_29 ( V_10 ) ,
V_51 , V_7 , V_32 -> V_36 ,
V_193 , V_190 , V_191 ,
V_33 -> V_19 ) ;
if ( V_17 < 0 ) {
F_91 ( V_196 , & V_158 -> V_83 , L_41 ) ;
goto V_203;
}
F_95 ( V_7 , V_30 ) ;
V_192 = V_190 + V_204 - V_205 ;
V_188 . V_206 = V_192 >> 32 ;
V_188 . V_207 = V_192 & 0xffffffff ;
V_188 . V_1 = V_193 ;
F_96 ( V_7 , & V_188 ) ;
F_30 ( V_7 , & V_208 , F_22 ) ;
F_32 ( V_7 , V_32 ) ;
