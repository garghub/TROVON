...
struct V_34 * F_23 ( struct V_23 * V_42 ,
struct V_43 * V_44 , int V_45 )
{
struct V_19 * V_35 = F_24 ( V_44 ) ;
return F_25 ( V_35 , & V_46 ,
V_35 -> V_25 . V_33 , 0600 ) ;
}
struct V_43 * F_26 ( struct V_23 * V_42 ,
struct V_34 * V_34 )
{
struct V_15 * V_16 ;
struct V_1 * V_6 ;
...
V_8 = V_6 -> V_8 ;
if ( V_6 -> V_29 == 1 ) {
V_31 -> V_55 = F_35 ( V_6 -> V_8 ) ;
V_31 -> V_33 = F_36 ( V_6 -> V_8 ) ;
V_35 -> V_45 |= V_56 ;
} else {
unsigned int V_9 = 0 ;
V_31 -> V_55 = F_35 ( V_8 ) ;
while ( V_9 < V_6 -> V_29 ) {
V_31 -> V_3 [ V_9 ] = F_37 ( V_8 ) ;
V_31 -> V_33 += F_36 ( V_8 ) ;
V_8 = F_38 ( V_8 ) ;
V_9 ++ ;
}
