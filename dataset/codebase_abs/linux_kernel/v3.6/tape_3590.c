...
static int
F_63 ( struct V_1 * V_2 , struct V_22 * V_23 )
{
...
static inline int
F_67 ( struct V_1 * V_2 , struct V_22 * V_23 ,
struct V_130 * V_130 )
{
...
static int
F_68 ( struct V_1 * V_2 , struct V_130 * V_130 )
{
...
static int
F_69 ( struct V_1 * V_2 , struct V_22 * V_23 ,
struct V_130 * V_130 , int V_28 )
{
struct V_138 * V_97 ;
...
switch ( V_97 -> V_140 ) {
case V_141 :
return F_65 ( V_2 , V_23 , V_130 , V_28 ) ;
case V_142 :
return F_64 ( V_2 , V_23 ) ;
case V_143 :
return F_67 ( V_2 , V_23 , V_130 ) ;
case V_144 :
return F_65 ( V_2 , V_23 , V_130 , V_28 ) ;
default:
F_13 () ;
...
{
return F_69 ( V_2 , V_23 , V_130 , - V_146 ) ;
}
static int
F_71 ( struct V_1 * V_2 , struct V_22 * V_23 ,
struct V_130 * V_130 )
{
F_72 ( & V_2 -> V_147 -> V_148 , L_24
L_25 ) ;
return F_69 ( V_2 , V_23 , V_130 , - V_146 ) ;
}
static int
...
return F_67 ( V_2 , V_23 , V_130 ) ;
case V_78 :
return F_65 ( V_2 , V_23 , V_130 , - V_146 ) ;
break;
default:
return F_65 ( V_2 , V_23 , V_130 , - V_146 ) ;
}
...
static void
F_77 ( struct V_1 * V_2 , struct V_130 * V_130 )
{
struct V_138 * V_97 ;
char * V_152 , * V_153 ;
...
return F_69 ( V_2 , V_23 , V_130 , - V_178 ) ;
if ( ( V_176 == 1 ) || ( V_176 == 2 ) )
return F_69 ( V_2 , V_23 , V_130 , - V_179 ) ;
F_82 ( & V_2 -> V_147 -> V_148 , L_98
L_99 ) ;
return F_69 ( V_2 , V_23 , V_130 , - V_180 ) ;
}
static int
F_83 ( struct V_1 * V_2 , struct V_22 * V_23 ,
struct V_130 * V_130 )
{
struct V_138 * V_97 ;
V_97 = (struct V_138 * ) V_130 -> V_139 ;
...
case 0x2240 :
return F_81 ( V_2 , V_23 , V_130 ) ;
case 0x3010 :
F_17 ( 2 , L_101 ,
V_2 -> V_136 ) ;
return F_69 ( V_2 , V_23 , V_130 , - V_182 ) ;
case 0x3012 :
F_17 ( 2 , L_102 ,
V_2 -> V_136 ) ;
return F_69 ( V_2 , V_23 , V_130 , - V_182 ) ;
...
F_62 ( V_2 , V_101 ) ;
F_56 ( V_2 , V_54 ) ;
return F_69 ( V_2 , V_23 , V_130 , 0 ) ;
case 0x4010 :
F_62 ( V_2 , V_101 ) ;
F_56 ( V_2 , V_54 ) ;
return F_69 ( V_2 , V_23 , V_130 , - V_183 ) ;
case 0x4012 :
F_17 ( 6 , L_106 , V_2 -> V_136 ) ;
F_80 ( V_2 , V_130 ) ;
return F_69 ( V_2 , V_23 , V_130 , - V_184 ) ;
case 0x4014 :
F_17 ( 6 , L_107 , V_2 -> V_136 ) ;
return F_73 ( V_2 , V_23 , V_130 ) ;
case 0x5010 :
if ( V_97 -> V_185 == 0xd0 ) {
F_80 ( V_2 , V_130 ) ;
...
case 0x5110 :
case 0x5111 :
return F_69 ( V_2 , V_23 , V_130 , - V_186 ) ;
case 0x5120 :
case 0x1120 :
F_62 ( V_2 , V_101 ) ;
F_56 ( V_2 , V_54 ) ;
...
return F_69 ( V_2 , V_23 , V_130 , - V_186 ) ;
case 0x8011 :
return F_69 ( V_2 , V_23 , V_130 , - V_187 ) ;
case 0x8013 :
F_72 ( & V_2 -> V_147 -> V_148 , L_108
L_109 ) ;
return F_69 ( V_2 , V_23 , V_130 , - V_187 ) ;
default:
return F_69 ( V_2 , V_23 , V_130 , - V_146 ) ;
...
static int
F_92 ( struct V_200 * V_147 )
{
return F_93 ( F_94 ( & V_147 -> V_148 ) ,
& V_201 ) ;
}
static int
F_95 ( void )
{
int V_28 ;
V_202 = F_96 ( L_119 , 2 , 2 , 4 * sizeof( long ) ) ;
F_97 ( V_202 , & V_203 ) ;
#ifdef F_98
F_99 ( V_202 , 6 ) ;
#endif
F_17 ( 3 , L_120 ) ;
V_95 = F_100 ( L_119 , 0 , 0 ) ;
if ( ! V_95 )
return - V_31 ;
V_28 = F_101 ( & V_204 ) ;
if ( V_28 ) {
