...
F_9 ( F_10 ( & V_1 ) , ( V_17 * ) & V_9 -> V_18 ) ;
V_9 -> V_19 = V_62 ;
V_9 -> V_22 . V_63 . V_38 = V_5 -> V_25 ;
V_9 -> V_22 . V_63 . V_39 = V_5 -> V_27 ;
F_21 ( V_9 -> V_22 . V_63 . V_63 , V_5 ) ;
memcpy ( & V_7 -> V_30 , & V_31 , sizeof( V_7 -> V_30 ) ) ;
V_7 -> V_32 = 0 ;
V_7 -> V_33 = sizeof( * V_9 ) ;
F_14 ( V_7 , V_34 , V_35 ) ;
...
static void F_23 ( int V_67 , int V_68 , int V_69 )
{
struct V_6 * V_7 ;
struct V_8 * V_9 ;
T_2 V_10 [ V_11 ] ;
...
enum V_73 * V_74 = NULL ;
int V_67 = 0 ;
if ( V_7 -> V_33 != sizeof( * V_74 ) )
return;
V_74 = (enum V_73 * ) V_7 -> V_15 ;
switch ( * V_74 ) {
case V_75 :
F_25 ( & V_14 ) ;
break;
