...
int V_16 = 0 , V_84 = 0 ;
V_16 = F_92 ( V_130 , sizeof( struct V_117 ) , V_149 , V_89 , NULL ) ;
if ( V_16 < 0 )
return V_16 ;
if ( V_149 [ V_126 ] == NULL ) {
F_93 ( L_7 ) ;
...
static struct V_30 *
F_95 ( const struct V_119 * V_130 )
{
struct V_30 * V_153 , * V_154 [ V_89 + 1 ] ;
struct V_30 * V_88 [ V_36 + 1 ] ;
struct V_30 * V_82 [ V_155 + 1 ] ;
struct V_30 * V_40 ;
if ( F_92 ( V_130 , sizeof( struct V_117 ) , V_82 , V_155 , NULL ) < 0 )
return NULL ;
V_153 = V_82 [ V_126 ] ;
if ( V_153 == NULL )
return NULL ;
if ( F_96 ( V_88 , V_36 , F_97 ( V_153 ) ,
F_98 ( F_78 ( V_153 ) ) , NULL ) < 0 )
return NULL ;
if ( V_88 [ 1 ] == NULL )
return NULL ;
if ( F_96 ( V_154 , V_89 , F_97 ( V_88 [ 1 ] ) ,
F_78 ( V_88 [ 1 ] ) , NULL ) < 0 )
return NULL ;
V_40 = V_154 [ V_91 ] ;
return V_40 ;
...
static int
F_99 ( struct V_19 * V_20 , struct V_21 * V_22 )
{
struct V_119 * V_120 ;
unsigned char * V_79 = F_51 ( V_20 ) ;
struct V_30 * V_31 ;
...
struct V_30 * V_40 = F_95 ( V_22 -> V_120 ) ;
if ( V_40 == NULL ) {
F_100 ( L_8 ) ;
return 0 ;
}
...
{
F_102 ( V_157 , V_146 , F_90 , NULL , NULL ) ;
F_102 ( V_157 , V_45 , F_90 , NULL , NULL ) ;
F_102 ( V_157 , V_46 , F_90 , F_99 ,
NULL ) ;
return 0 ;
}
