...
* V_79 = V_84 ;
V_36 -> V_85 ++ ;
V_69 . V_65 = F_5 ( F_10 ( V_69 . V_65 ) - 1 ) ;
...
V_36 -> V_85 -- ;
V_69 . V_65 = F_5 ( F_10 ( V_69 . V_65 ) + 1 ) ;
V_69 . V_66 = F_5 ( F_40 ( F_10 ( V_69 . V_66 ) , V_80 ) ) ;
}
return V_36 -> V_67 ( V_36 , V_68 , & V_69 ) ;
}
int F_41 ( struct V_35 * V_36 , T_4 V_4 , enum V_78 * V_79 )
{
int V_57 ;
V_48 V_87 ;
...
static int F_44 ( struct V_35 * V_36 , T_4 V_68 ,
struct V_43 * V_89 )
{
