...
goto V_86;
if ( F_34 ( V_10 ) )
F_43 ( & V_45 , F_16 , ( unsigned long ) V_10 ) ;
F_9 ( V_11 , V_88 , V_89 ) ;
F_1 () ;
F_44 ( 5 ) ;
F_45 ( L_16 ,
...
static int T_5 F_50 ( struct V_92 * V_93 )
{
...
V_10 -> V_96 . V_107 = & V_93 -> V_96 ;
V_10 -> V_96 . V_108 = & V_109 ;
V_10 -> V_96 . V_110 = V_109 ;
V_99 -> V_96 = & V_93 -> V_96 ;
V_99 -> V_10 = V_10 ;
V_99 -> V_100 = V_100 ;
V_95 -> V_111 = & V_112 ;
F_58 ( V_93 , V_99 ) ;
V_59 = F_59 ( V_10 , V_93 -> V_113 ,
V_93 -> V_114 ) ;
if ( V_59 ) {
F_52 ( & V_93 -> V_96 , L_23 ) ;
goto V_115;
}
V_59 = F_60 ( V_10 , V_95 , sizeof( * V_95 ) ) ;
if ( V_59 ) {
F_52 ( & V_93 -> V_96 , L_24 ) ;
goto V_115;
}
...
static int T_6 F_66 ( struct V_92 * V_93 )
{
struct V_98 * V_99 = F_67 ( V_93 ) ;
F_68 ( V_99 -> V_10 ) ;
F_64 ( V_99 -> V_10 ) ;
F_62 ( V_99 -> V_100 ) ;
F_63 ( V_99 -> V_100 ) ;
