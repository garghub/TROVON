...
V_68 = F_2 ( V_8 -> V_20 . V_68 ,
struct V_67 , V_68 ) ;
V_104 . V_109 = V_68 -> V_109 ;
V_104 . V_110 = V_8 -> V_26 ;
V_103 = F_62 ( & V_104 , V_111 | V_112 , V_68 -> V_113 ) ;
if ( F_63 ( V_103 ) ) {
V_32 = F_64 ( V_103 ) ;
} else {
V_32 = - V_36 ;
if ( V_103 -> V_114 -> V_115 ) {
V_105 = ( T_5 ) V_11 -> V_14 << V_79 ;
V_106 = V_8 -> V_20 . V_116 ;
V_107 = V_78 ;
if ( V_106 & ~ V_117 ) {
F_65 ( V_105 , < , V_106 ) ;
if ( V_106 - V_105 < V_78 ) {
...
V_105 , V_106 ) ;
V_107 = V_106 - V_105 ;
F_65 ( V_105 + V_107 , == , V_106 ) ;
}
}
V_108 = F_66 ( V_11 ) ;
V_102 = F_67 () ;
F_68 ( V_118 ) ;
V_32 = V_103 -> V_114 -> V_115 (
V_103 , ( const void V_119 * ) V_108 , V_107 , & V_105 ) ;
F_68 ( V_102 ) ;
F_69 ( V_11 ) ;
if ( V_32 != V_107 )
V_32 = - V_36 ;
...
void F_71 ( struct V_120 * V_121 , struct V_11 * V_11 )
{
struct V_7 * V_8 ;
struct V_67 * V_68 ;
