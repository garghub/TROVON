...
{
const struct V_68 * V_69 = F_18 ( V_2 ) ;
struct V_3 * V_4 ;
int V_70 ;
int V_8 , V_13 ;
int V_71 ;
union V_20 V_20 ;
F_3 ( V_25 L_15 , V_2 -> V_72 ) ;
V_70 = V_67 -> V_73 [ 0 ] ;
if ( ! V_70 || ! F_19 ( V_70 , V_74 , V_69 -> V_75 ) ) {
F_20 ( V_2 , L_16 ) ;
return - V_76 ;
}
V_2 -> V_70 = V_70 ;
F_3 ( L_17 , V_2 -> V_70 ) ;
V_2 -> V_77 = V_69 -> V_75 ;
if ( F_21 ( V_2 , sizeof( struct V_78 ) ) < 0 )
return - V_79 ;
V_71 = F_22 ( V_2 , 4 ) ;
if ( V_71 )
return V_71 ;
...
F_3 ( V_25 L_22 ,
F_10 ( V_111 [ V_8 ] ) , F_4 ( F_10 ( V_111 [ V_8 ] ) ) ) ;
}
return 1 ;
}
