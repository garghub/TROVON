...
struct V_274 * V_275 ;
struct V_326 * V_646 , * V_3 ;
F_276 (req, pos, n, h, collision) {
F_154 ( & V_275 -> V_54 ) ;
F_277 ( & V_275 -> V_54 ) ;
}
}
...
V_648 = V_653 ;
if ( F_106 ( V_10 ) ) {
V_648 = V_10 -> V_210 -> V_239 . V_654 ;
F_109 ( V_10 ) ;
}
if ( V_10 -> V_67 . V_436 == V_411 && V_648 >= V_655 && V_10 -> V_67 . V_344 >= V_656 )
F_284 ( V_10 ) ;
F_21 ( & V_10 -> V_26 ) ;
V_575 = V_10 -> V_67 ;
if ( V_575 . V_68 >= V_657 ) {
...
F_22 ( & V_10 -> V_26 ) ;
if ( V_575 . V_68 == V_146 ) {
F_126 ( V_10 -> V_658 , F_27 ( & V_10 -> V_659 ) == 0 ) ;
F_213 ( V_10 -> V_192 ) ;
V_10 -> V_192 = NULL ;
F_45 ( V_10 -> V_30 ) ;
V_10 -> V_30 = NULL ;
...
F_126 ( V_10 -> V_335 , ! F_112 ( V_660 , & V_10 -> V_59 ) ) ;
...
{
struct V_661 * V_260 = & V_10 -> V_104 . V_156 . V_662 ;
int V_66 ;
if ( F_286 ( & V_10 -> V_104 . V_663 ) ) {
F_40 ( V_35 , L_166 ) ;
return 0 ;
}
if ( V_10 -> V_104 . V_75 == NULL ) {
F_287 ( & V_10 -> V_104 . V_663 ) ;
return 0 ;
}
memset ( V_260 , 0 , sizeof( * V_260 ) ) ;
V_260 -> V_664 = F_288 ( V_665 ) ;
V_260 -> V_666 = F_288 ( V_667 ) ;
V_66 = F_77 ( V_10 , V_10 -> V_104 . V_75 , V_668 ,
...
{
struct V_661 * V_260 = & V_10 -> V_104 . V_159 . V_662 ;
const int V_278 = sizeof( struct V_661 ) - sizeof( struct V_154 ) ;
unsigned int V_205 ;
enum V_152 V_153 ;
int V_102 ;
V_102 = F_285 ( V_10 ) ;
...
if ( V_102 != V_278 ) {
if ( ! F_29 ( V_34 ) )
F_30 ( V_35 , L_169 , V_102 ) ;
return 0 ;
}
V_260 -> V_664 = F_104 ( V_260 -> V_664 ) ;
V_260 -> V_666 = F_104 ( V_260 -> V_666 ) ;
if ( V_260 -> V_666 == 0 )
V_260 -> V_666 = V_260 -> V_664 ;
if ( V_667 < V_260 -> V_664 ||
V_665 > V_260 -> V_666 )
goto V_669;
V_10 -> V_270 = F_72 ( int , V_667 , V_260 -> V_666 ) ;
F_65 ( V_35 , L_170
L_171 , V_10 -> V_270 ) ;
return 1 ;
V_669:
...
char * V_675 = NULL ;
char * V_676 = NULL ;
unsigned int V_677 = strlen ( V_10 -> V_30 -> V_678 ) ;
unsigned int V_679 ;
struct V_680 V_681 ;
enum V_152 V_153 ;
unsigned int V_205 ;
int V_102 ;
V_681 . V_497 = V_10 -> V_192 ;
V_681 . V_59 = 0 ;
V_102 = F_289 ( V_10 -> V_192 ,
( V_682 * ) V_10 -> V_30 -> V_678 , V_677 ) ;
if ( V_102 ) {
F_40 ( V_35 , L_176 , V_102 ) ;
V_102 = - 1 ;
goto V_53;
}
F_290 ( V_670 , V_671 ) ;
V_102 = F_291 ( V_10 , V_683 , V_670 , V_671 ) ;
if ( ! V_102 )
goto V_53;
V_102 = F_101 ( V_10 , & V_153 , & V_205 ) ;
if ( ! V_102 )
...
V_676 = F_125 ( V_205 , V_181 ) ;
if ( V_676 == NULL ) {
F_40 ( V_35 , L_179 ) ;
V_102 = - 1 ;
goto V_53;
}
V_102 = F_64 ( V_10 , V_676 , V_205 ) ;
if ( V_102 != V_205 ) {
if ( ! F_29 ( V_34 ) )
F_30 ( V_35 , L_180 , V_102 ) ;
V_102 = 0 ;
goto V_53;
}
V_679 = F_130 ( V_10 -> V_192 ) ;
V_674 = F_125 ( V_679 , V_181 ) ;
if ( V_674 == NULL ) {
F_40 ( V_35 , L_181 ) ;
V_102 = - 1 ;
goto V_53;
...
F_292 ( & V_673 , 1 ) ;
F_293 ( & V_673 , V_676 , V_205 ) ;
V_102 = F_294 ( & V_681 , & V_673 , V_673 . V_205 , V_674 ) ;
if ( V_102 ) {
F_40 ( V_35 , L_182 , V_102 ) ;
V_102 = - 1 ;
goto V_53;
}
V_102 = F_291 ( V_10 , V_684 , V_674 , V_679 ) ;
if ( ! V_102 )
goto V_53;
V_102 = F_101 ( V_10 , & V_153 , & V_205 ) ;
if ( ! V_102 )
...
V_102 = F_64 ( V_10 , V_674 , V_679 ) ;
if ( V_102 != V_679 ) {
if ( ! F_29 ( V_34 ) )
F_30 ( V_35 , L_185 , V_102 ) ;
V_102 = 0 ;
goto V_53;
}
V_675 = F_125 ( V_679 , V_181 ) ;
if ( V_675 == NULL ) {
F_40 ( V_35 , L_186 ) ;
V_102 = - 1 ;
goto V_53;
}
F_293 ( & V_673 , V_670 , V_671 ) ;
V_102 = F_294 ( & V_681 , & V_673 , V_673 . V_205 , V_675 ) ;
if ( V_102 ) {
F_40 ( V_35 , L_182 , V_102 ) ;
V_102 = - 1 ;
goto V_53;
}
V_102 = ! memcmp ( V_674 , V_675 , V_679 ) ;
if ( V_102 )
F_65 ( V_35 , L_187 ,
V_679 , V_10 -> V_30 -> V_685 ) ;
else
V_102 = - 1 ;
V_53:
F_45 ( V_676 ) ;
...
int F_295 ( struct V_686 * V_687 )
{
struct V_9 * V_10 = V_687 -> V_10 ;
unsigned int V_688 = F_296 ( V_10 ) ;
int V_155 ;
sprintf ( V_34 -> V_336 , L_188 , V_688 ) ;
F_65 ( V_35 , L_189 ) ;
do {
V_155 = F_81 ( V_10 ) ;
if ( V_155 == 0 ) {
...
{
struct V_689 * V_260 = (struct V_689 * ) V_155 ;
int V_690 = F_104 ( V_260 -> V_690 ) ;
if ( V_690 >= V_172 ) {
F_85 ( V_691 , & V_10 -> V_59 ) ;
} else {
F_85 ( V_692 , & V_10 -> V_59 ) ;
F_40 ( V_35 , L_192 ,
F_298 ( V_690 ) , V_690 ) ;
}
F_36 ( & V_10 -> V_693 ) ;
...
if ( ! F_302 ( V_694 , & V_10 -> V_59 ) )
F_36 ( & V_10 -> V_335 ) ;
return true ;
}
static int F_303 ( struct V_9 * V_10 , struct V_154 * V_155 )
{
struct V_695 * V_260 = (struct V_695 * ) V_155 ;
T_3 V_43 = F_147 ( V_260 -> V_43 ) ;
int V_383 = F_104 ( V_260 -> V_383 ) ;
F_46 ( V_10 -> V_270 >= 89 ) ;
F_304 ( V_10 , F_104 ( V_260 -> V_323 ) ) ;
if ( F_106 ( V_10 ) ) {
F_305 ( V_10 , V_43 ) ;
F_141 ( V_10 , V_43 , V_383 ) ;
V_10 -> V_696 += ( V_383 >> V_697 ) ;
F_109 ( V_10 ) ;
}
F_145 ( V_10 ) ;
...
static struct V_274 * F_306 ( struct V_9 * V_10 ,
T_2 V_42 , T_3 V_43 )
{
...
T_2 V_42 , T_3 V_43 , T_9 V_698 ,
const char * V_699 , enum V_700 V_74 )
{
struct V_274 * V_275 ;
struct V_701 V_702 ;
F_21 ( & V_10 -> V_26 ) ;
V_275 = V_698 ( V_10 , V_42 , V_43 ) ;
if ( F_102 ( ! V_275 ) ) {
F_22 ( & V_10 -> V_26 ) ;
F_40 ( V_35 , L_195 , V_699 ,
( void * ) ( unsigned long ) V_42 , ( unsigned long long ) V_43 ) ;
return false ;
}
F_308 ( V_275 , V_74 , & V_702 ) ;
F_22 ( & V_10 -> V_26 ) ;
if ( V_702 . V_244 )
F_309 ( V_10 , & V_702 ) ;
return true ;
...
return F_307 ( V_10 , V_260 -> V_60 , V_43 ,
F_306 , V_601 , V_74 ) ;
}
...
F_21 ( & V_10 -> V_26 ) ;
V_275 = F_306 ( V_10 , V_260 -> V_60 , V_43 ) ;
if ( ! V_275 ) {
F_22 ( & V_10 -> V_26 ) ;
...
static int F_314 ( struct V_9 * V_10 , struct V_154 * V_155 )
{
T_3 V_43 ;
int V_58 ;
struct V_695 * V_260 = (struct V_695 * ) V_155 ;
...
static int F_315 ( struct V_9 * V_10 , struct V_154 * V_155 )
{
struct V_709 * V_260 = (struct V_709 * ) V_155 ;
F_316 ( V_10 , V_260 -> V_261 , F_104 ( V_260 -> V_710 ) ) ;
if ( V_10 -> V_67 . V_68 == V_581 &&
F_27 ( & V_10 -> V_711 ) == 0 &&
! F_302 ( V_712 , & V_10 -> V_59 ) ) {
V_10 -> V_713 . V_714 = V_189 + V_126 ;
F_317 ( & V_10 -> V_713 ) ;
}
return true ;
}
static int F_318 ( struct V_9 * V_10 , struct V_154 * V_155 )
{
struct V_695 * V_260 = (struct V_695 * ) V_155 ;
struct V_283 * V_22 ;
T_3 V_43 ;
...
V_58 = F_104 ( V_260 -> V_383 ) ;
F_304 ( V_10 , F_104 ( V_260 -> V_323 ) ) ;
if ( F_147 ( V_260 -> V_60 ) == V_715 )
F_319 ( V_10 , V_43 , V_58 ) ;
else
F_320 ( V_10 ) ;
if ( ! F_106 ( V_10 ) )
return true ;
...
F_321 ( V_10 , V_10 -> V_373 ) ;
if ( V_10 -> V_373 == 0 ) {
V_22 = F_125 ( sizeof( * V_22 ) , V_181 ) ;
if ( V_22 ) {
V_22 -> V_71 = V_716 ;
F_322 ( & V_10 -> V_104 . V_642 , V_22 ) ;
} else {
F_40 ( V_35 , L_197 ) ;
F_320 ( V_10 ) ;
F_237 ( V_10 ) ;
...
static int F_323 ( struct V_9 * V_10 , struct V_154 * V_155 )
{
return true ;
}
static struct V_717 * F_324 ( int V_153 )
{
static struct V_717 V_718 [] = {
[ V_719 ] = { sizeof( struct V_154 ) , F_299 } ,
[ V_720 ] = { sizeof( struct V_154 ) , F_301 } ,
[ V_342 ] = { sizeof( struct V_695 ) , F_310 } ,
[ V_304 ] = { sizeof( struct V_695 ) , F_310 } ,
[ V_286 ] = { sizeof( struct V_695 ) , F_310 } ,
[ V_306 ] = { sizeof( struct V_695 ) , F_310 } ,
[ V_287 ] = { sizeof( struct V_695 ) , F_312 } ,
[ V_386 ] = { sizeof( struct V_695 ) , F_313 } ,
[ V_390 ] = { sizeof( struct V_695 ) , F_314 } ,
[ V_392 ] = { sizeof( struct V_695 ) , F_318 } ,
[ V_721 ] = { sizeof( struct V_709 ) , F_315 } ,
[ V_722 ] = { sizeof( struct V_689 ) , F_297 } ,
[ V_723 ] = { sizeof( struct V_695 ) , F_303 } ,
[ V_724 ] = { sizeof( struct V_725 ) , F_323 } ,
[ V_708 ] = { sizeof( struct V_695 ) , F_314 } ,
[ V_633 ] = { 0 , NULL } ,
} ;
if ( V_153 > V_633 || V_718 [ V_153 ] . V_726 == NULL )
return NULL ;
return & V_718 [ V_153 ] ;
}
int F_325 ( struct V_686 * V_687 )
{
struct V_9 * V_10 = V_687 -> V_10 ;
struct V_154 * V_155 = & V_10 -> V_187 . V_159 . V_157 . V_158 ;
struct V_717 * V_153 = NULL ;
int V_102 , V_5 ;
void * V_88 = V_155 ;
int V_727 = 0 ;
...
int V_728 ;
int V_729 = 0 ;
sprintf ( V_34 -> V_336 , L_198 , F_296 ( V_10 ) ) ;
V_34 -> V_730 = V_731 ;
V_34 -> V_732 = 2 ;
while ( F_88 ( V_687 ) == V_631 ) {
F_270 ( V_10 ) ;
if ( F_226 ( V_733 , & V_10 -> V_59 ) ) {
F_131 (!drbd_send_ping(mdev)) goto V_734;
...
if ( ! V_10 -> V_30 -> V_735 &&
3 < F_27 ( & V_10 -> V_736 ) )
F_326 ( V_10 -> V_187 . V_75 ) ;
while ( 1 ) {
F_83 ( V_737 , & V_10 -> V_59 ) ;
F_86 ( V_34 ) ;
if ( ! F_50 ( V_10 ) )
goto V_734;
F_85 ( V_737 , & V_10 -> V_59 ) ;
F_21 ( & V_10 -> V_26 ) ;
V_728 = F_53 ( & V_10 -> V_70 ) ;
F_22 ( & V_10 -> V_26 ) ;
if ( V_728 )
break;
}
if ( ! V_10 -> V_30 -> V_735 )
F_327 ( V_10 -> V_187 . V_75 ) ;
if ( F_29 ( V_34 ) )
continue;
...
V_10 -> V_188 = V_189 ;
F_46 ( V_153 != NULL ) ;
if ( ! V_153 -> V_726 ( V_10 , V_155 ) )
goto V_734;
if ( V_153 == F_324 ( V_720 ) )
V_729 = 0 ;
V_88 = V_155 ;
V_727 = 0 ;
