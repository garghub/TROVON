...
V_9 = F_92 ( V_107 , V_36 , V_37 , V_131 ) ;
F_66 ( & V_4 ( V_2 ) -> V_111 ) ;
if ( V_9 ) {
F_43 ( V_71 L_13 , V_22 ) ;
goto V_132;
...
struct V_29 * V_30 = V_5 -> V_31 -> V_32 ;
struct V_26 * V_26 ;
V_16 V_22 , V_134 , V_135 ;
V_134 = F_7 ( V_2 , V_3 , 0 ) ;
V_135 = F_7 ( V_2 , V_3 + 1 , 0 ) ;
for ( V_22 = V_134 ; V_22 < V_135 ; V_22 += V_40 ) {
...
struct V_4 * V_5 = V_4 ( V_2 ) ;
int V_9 , V_136 = 0 ;
if ( V_20 -> V_137 && V_20 -> V_23 + V_21 <= V_5 -> V_18 )
return 0 ;
if ( V_20 -> V_137 ) {
V_16 V_22 = F_7 ( V_2 , V_20 -> V_25 , V_20 -> V_138 ) ;
T_1 V_37 = V_5 -> V_18 - V_20 -> V_138 ;
F_100 ( L_17 , V_20 -> V_25 ) ;
F_26 ( V_20 , 1 ) ;
V_5 -> V_14 -> V_139 ( V_20 -> V_24 , V_22 , V_37 ) ;
F_98 ( V_2 , V_20 -> V_25 ) ;
V_136 = 1 ;
}
V_20 -> V_23 = 0 ;
V_20 -> V_138 = 0 ;
V_140:
V_20 -> V_141 -> V_142 ( V_20 ) ;
V_20 -> V_141 -> V_143 ( V_20 ) ;
F_100 ( L_18 , V_20 -> V_25 , V_20 -> V_144 ) ;
V_9 = V_20 -> V_141 -> V_145 ( V_20 ) ;
if ( V_9 ) {
F_43 ( V_146 L_19 ,
V_20 -> V_25 ) ;
F_1 ( V_2 , V_20 -> V_25 ) ;
...
struct V_4 * V_5 = V_4 ( V_2 ) ;
V_16 V_22 = F_7 ( V_2 , V_20 -> V_25 , V_20 -> V_138 ) ;
T_1 V_37 = ( V_20 -> V_23 - V_20 -> V_138 ) ;
if ( V_5 -> V_147 )
V_37 &= ~ ( V_5 -> V_147 - 1 ) ;
if ( V_37 == 0 )
return;
F_26 ( V_20 , 0 ) ;
V_5 -> V_14 -> V_139 ( V_2 , V_22 , V_37 ) ;
V_20 -> V_138 += V_37 ;
}
...
V_20 -> V_25 = F_105 ( V_2 , & V_5 -> V_149 , NULL ) ;
}
static void F_106 ( struct V_19 * V_20 )
{
struct V_150 V_151 ;
T_1 V_152 ;
F_107 ( V_20 -> V_24 , V_20 -> V_25 , & V_151 ) ;
F_6 ( V_151 . V_152 == F_108 ( V_153 ) ||
V_151 . V_154 == F_108 ( V_155 ) ) ;
V_152 = F_77 ( V_151 . V_152 ) ;
V_20 -> V_156 = ( V_152 >> 4 ) + 1 ;
}
...
V_158 . V_159 = 0 ;
V_158 . type = V_160 ;
V_158 . V_49 = ( V_161 V_162 ) V_20 -> V_144 ;
V_158 . V_3 = F_108 ( V_20 -> V_25 ) ;
V_158 . V_163 = F_108 ( V_20 -> V_156 ) ;
V_158 . V_164 = F_60 ( V_4 ( V_2 ) -> V_13 ) ;
V_158 . V_103 = F_61 ( & V_158 , sizeof( V_158 ) , 4 ) ;
F_110 ( V_2 , V_20 -> V_25 , V_20 -> V_156 ,
V_20 -> V_144 ) ;
V_22 = F_7 ( V_2 , V_20 -> V_25 , 0 ) ;
V_20 -> V_23 = sizeof( V_158 ) ;
F_62 ( V_20 , V_22 , & V_158 , sizeof( V_158 ) ) ;
return 0 ;
}
...
int V_62 ;
F_103 (i)
F_111 ( V_5 -> V_148 [ V_62 ] ) ;
F_111 ( V_5 -> V_165 ) ;
}
static struct V_19 * F_114 ( struct V_1 * V_2 )
{
struct V_19 * V_20 ;
V_20 = F_115 ( sizeof( * V_20 ) , V_166 ) ;
if ( ! V_20 )
return NULL ;
V_20 -> V_24 = V_2 ;
return V_20 ;
}
static void F_116 ( struct V_26 * V_26 , unsigned long V_167 )
{
return;
}
static int F_117 ( struct V_26 * V_26 , T_13 V_168 )
{
return 0 ;
}
...
goto V_9;
F_103 (i) {
V_5 -> V_148 [ V_62 ] = F_114 ( V_2 ) ;
if ( ! V_5 -> V_148 [ V_62 ] )
goto V_9;
V_5 -> V_148 [ V_62 ] -> V_144 = F_123 ( V_62 ) ;
V_5 -> V_148 [ V_62 ] -> V_141 = & V_171 ;
}
F_124 ( & V_5 -> V_51 ,
V_5 -> V_172 ) ;
return 0 ;
