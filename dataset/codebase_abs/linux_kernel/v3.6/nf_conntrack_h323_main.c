...
( V_49 = F_15 ( V_57 ) ) &&
V_5 -> V_58 & V_59 ) {
V_43 = V_49 ( V_2 , V_5 , V_7 , V_8 , V_10 ,
...
( V_60 = F_15 ( V_64 ) ) &&
V_5 -> V_58 & V_59 ) {
V_43 = V_60 ( V_2 , V_5 , V_7 , V_8 , V_10 , V_28 ,
V_31 , exp ) ;
} else {
if ( F_16 ( exp ) == 0 ) {
F_6 ( L_10 ) ;
...
int V_43 ;
F_6 ( L_11 ) ;
if ( V_71 -> V_72 . V_73 . V_33 ==
V_74 )
{
V_43 = F_20 ( V_2 , V_5 , V_7 , V_8 , V_10 ,
& V_71 ->
V_72 .
V_73 .
V_75 ) ;
...
V_71 -> V_72 . V_81 . V_33 ==
V_82 &&
V_71 -> V_72 . V_81 . V_8 . V_83 .
V_33 == V_84 &&
V_71 -> V_72 . V_81 . V_8 . V_83 .
V_85 . V_33 == V_86 &&
V_71 -> V_87 . V_88 . V_33 ==
V_89 ) {
V_43 = F_19 ( V_2 , V_5 , V_7 , V_8 , V_10 ,
& V_71 -> V_87 . V_88 .
V_90 ) ;
if ( V_43 < 0 )
return - 1 ;
...
if ( F_23 ( V_2 , V_5 , V_7 , & V_8 , V_10 , & V_103 ) < 0 )
goto V_117;
}
F_27 ( & V_115 ) ;
return V_114 ;
...
if ( F_8 ( V_5 ) != V_37 )
return 0 ;
V_32 = V_8 + V_28 -> V_120 . V_121 ;
V_23 = 4 ;
break;
case V_122 :
if ( F_8 ( V_5 ) != V_41 )
return 0 ;
V_32 = V_8 + V_28 -> V_123 . V_121 ;
V_23 = 16 ;
break;
default:
return 0 ;
...
( V_124 = F_15 ( V_127 ) ) &&
V_5 -> V_58 & V_59 ) {
V_43 = V_124 ( V_2 , V_5 , V_7 , V_8 , V_10 , V_28 ,
V_31 , exp ) ;
} else {
if ( F_16 ( exp ) == 0 ) {
F_6 ( L_22 ) ;
...
V_132 . V_137 = V_52 -> V_121 ;
memset ( & V_133 , 0 , sizeof( V_133 ) ) ;
V_133 . V_137 = V_55 -> V_121 ;
if ( ! V_130 -> V_138 ( & V_139 , (struct V_140 * * ) & V_135 ,
F_33 ( & V_132 ) , false ) ) {
if ( ! V_130 -> V_138 ( & V_139 , (struct V_140 * * ) & V_136 ,
F_33 ( & V_133 ) , false ) ) {
if ( V_135 -> V_141 == V_136 -> V_141 &&
V_135 -> V_55 . V_142 == V_136 -> V_55 . V_142 )
V_43 = 1 ;
F_34 ( & V_136 -> V_55 ) ;
}
F_34 ( & V_135 -> V_55 ) ;
...
#if F_35 ( V_143 )
case V_41 : {
struct V_144 V_132 , V_133 ;
struct V_145 * V_135 , * V_136 ;
memset ( & V_132 , 0 , sizeof( V_132 ) ) ;
V_132 . V_137 = V_52 -> V_146 ;
memset ( & V_133 , 0 , sizeof( V_133 ) ) ;
V_133 . V_137 = V_55 -> V_146 ;
if ( ! V_130 -> V_138 ( & V_139 , (struct V_140 * * ) & V_135 ,
F_36 ( & V_132 ) , false ) ) {
if ( ! V_130 -> V_138 ( & V_139 , (struct V_140 * * ) & V_136 ,
F_36 ( & V_133 ) , false ) ) {
if ( ! memcmp ( & V_135 -> V_147 , & V_136 -> V_147 ,
sizeof( V_135 -> V_147 ) ) &&
V_135 -> V_55 . V_142 == V_136 -> V_55 . V_142 )
V_43 = 1 ;
F_34 ( & V_136 -> V_55 ) ;
...
( V_148 = F_15 ( V_151 ) ) &&
V_5 -> V_58 & V_59 ) {
V_43 = V_148 ( V_2 , V_5 , V_7 , V_8 , V_10 ,
V_28 , V_31 , exp ) ;
} else {
if ( F_16 ( exp ) == 0 ) {
F_6 ( L_24 ) ;
...
F_6 ( L_25 ) ;
if ( V_152 -> V_66 & V_155 ) {
V_43 = F_30 ( V_2 , V_5 , V_7 , V_8 , V_10 ,
& V_152 -> V_156 ) ;
if ( V_43 < 0 )
return - 1 ;
}
...
memcmp ( & V_30 , & V_5 -> V_50 [ ! V_13 ] . V_51 . V_52 . V_53 , sizeof( V_30 ) ) ) {
F_6 ( L_26 ,
& V_30 , F_39 ( V_31 ) , & V_5 -> V_50 [ ! V_13 ] . V_51 . V_52 . V_53 ,
F_39 ( V_5 -> V_50 [ ! V_13 ] . V_51 . V_52 . V_160 . V_161 . V_31 ) ) ;
V_43 = V_154 ( V_2 , V_8 , V_10 ,
& V_152 -> V_159 ,
& V_5 -> V_50 [ ! V_13 ] . V_51 . V_52 . V_53 ,
...
F_6 ( L_27 ,
& V_30 , F_39 ( V_31 ) , & V_5 -> V_50 [ ! V_13 ] . V_51 . V_55 . V_53 ,
F_39 ( V_5 -> V_50 [ ! V_13 ] . V_51 . V_55 . V_160 . V_161 . V_31 ) ) ;
V_43 = V_154 ( V_2 , V_8 , V_10 ,
& V_152 -> V_163 ,
& V_5 -> V_50 [ ! V_13 ] . V_51 . V_55 . V_53 ,
...
V_43 = F_21 ( V_2 , V_5 , V_7 , V_8 , V_10 ,
...
enum V_6 V_7 ,
unsigned char * * V_8 , int V_10 , T_16 * V_187 )
{
...
case V_192 :
V_43 = F_38 ( V_2 , V_5 , V_7 , V_8 , V_10 ,
& V_188 -> V_191 . V_152 ) ;
break;
case V_193 :
V_43 = F_40 ( V_2 , V_5 , V_7 , V_8 , V_10 ,
& V_188 -> V_191 .
V_194 ) ;
break;
case V_195 :
V_43 = F_41 ( V_2 , V_5 , V_7 , V_8 , V_10 ,
& V_188 -> V_191 . V_171 ) ;
break;
case V_196 :
V_43 = F_42 ( V_2 , V_5 , V_7 , V_8 , V_10 ,
& V_188 -> V_191 . V_197 ) ;
break;
case V_198 :
V_43 = F_43 ( V_2 , V_5 , V_7 , V_8 , V_10 ,
& V_188 -> V_191 . V_177 ) ;
break;
case V_199 :
V_43 = F_44 ( V_2 , V_5 , V_7 , V_8 , V_10 ,
& V_188 -> V_191 . V_184 ) ;
break;
default:
F_6 ( L_33 ,
...
V_43 = F_23 ( V_2 , V_5 , V_7 , V_8 , V_10 ,
...
if ( F_45 ( V_2 , V_5 , V_7 , & V_8 , V_10 , & V_187 ) < 0 )
goto V_117;
}
F_27 ( & V_115 ) ;
return V_114 ;
...
static struct V_46 * F_49 ( struct V_4 * V_5 ,
union V_29 * V_30 ,
T_2 V_31 )
{
struct V_205 * V_205 = F_50 ( V_5 ) ;
struct V_46 * exp ;
struct V_206 V_51 ;
...
V_51 . V_55 . V_207 = V_61 ;
exp = F_51 ( V_205 , F_52 ( V_5 ) , & V_51 ) ;
if ( exp && exp -> V_208 == V_5 )
return exp ;
return NULL ;
}
static int F_53 ( struct V_46 * exp ,
unsigned int V_209 )
{
if ( ! exp || ! F_54 ( & exp -> V_209 ) )
return 0 ;
...
exp -> V_62 = V_63 ;
V_213 = F_15 ( V_215 ) ;
if ( V_213 && V_5 -> V_58 & V_59 ) {
V_43 = V_213 ( V_2 , V_5 , V_7 , V_8 , V_28 , V_153 , V_31 , exp ) ;
} else {
if ( F_16 ( exp ) == 0 ) {
F_6 ( L_38 ) ;
F_17 ( & exp -> V_51 ) ;
...
F_6 ( L_39 ) ;
V_218 = F_15 ( V_219 ) ;
if ( V_218 && V_5 -> V_58 & V_59 )
return V_218 ( V_2 , V_5 , V_7 , V_8 ,
& V_217 -> V_220 , 1 ) ;
return 0 ;
}
...
F_6 ( L_44 ) ;
V_231 = F_15 ( V_232 ) ;
if ( V_231 && V_5 -> V_58 & V_59 ) {
V_43 = V_231 ( V_2 , V_5 , V_7 , V_8 ,
V_230 -> V_226 . V_167 ,
V_230 -> V_226 . V_166 ) ;
if ( V_43 < 0 )
return - 1 ;
...
F_6 ( L_46
L_47 , V_12 -> V_209 ) ;
F_62 ( V_5 , V_2 , V_12 -> V_209 * V_212 ) ;
F_25 ( & V_234 ) ;
exp = F_49 ( V_5 , & V_5 -> V_50 [ V_13 ] . V_51 . V_55 . V_53 ,
V_12 -> V_216 [ ! V_13 ] ) ;
if ( exp ) {
F_6 ( L_48
L_49 ,
...
if ( F_70 ( V_2 , V_5 , V_7 , & V_8 , & V_245 ) < 0 )
goto V_117;
V_266:
F_27 ( & V_115 ) ;
return V_114 ;
