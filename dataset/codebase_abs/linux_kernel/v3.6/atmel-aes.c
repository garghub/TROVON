...
for ( V_165 = 0 ; V_165 < F_86 ( V_166 ) ; V_165 ++ ) {
F_89 ( & V_166 [ V_165 ] . V_169 ) ;
V_31 = F_90 ( & V_166 [ V_165 ] ) ;
if ( V_31 )
goto V_170;
}
F_17 ( V_12 ) ;
...
struct V_11 * V_23 ;
struct V_130 * V_131 ;
struct V_127 * V_47 = & V_173 -> V_47 ;
struct V_174 * V_175 ;
unsigned long V_176 ;
int V_31 ;
V_131 = V_173 -> V_47 . V_134 ;
if ( ! V_131 ) {
V_31 = - V_177 ;
goto V_178;
}
V_23 = F_92 ( sizeof( struct V_11 ) , V_179 ) ;
if ( V_23 == NULL ) {
F_93 ( V_47 , L_3 ) ;
V_31 = - V_129 ;
goto V_178;
...
( unsigned long ) V_23 ) ;
F_96 ( & V_23 -> V_113 , V_181 ) ;
V_23 -> V_157 = - 1 ;
V_175 = F_97 ( V_173 , V_182 , 0 ) ;
if ( ! V_175 ) {
F_93 ( V_47 , L_4 ) ;
V_31 = - V_121 ;
goto V_183;
}
V_23 -> V_142 = V_175 -> V_184 ;
V_176 = F_98 ( V_175 ) ;
V_23 -> V_157 = F_99 ( V_173 , 0 ) ;
if ( V_23 -> V_157 < 0 ) {
F_93 ( V_47 , L_5 ) ;
V_31 = V_23 -> V_157 ;
goto V_185;
}
V_31 = F_100 ( V_23 -> V_157 , F_83 , V_186 , L_6 ,
V_23 ) ;
if ( V_31 ) {
F_93 ( V_47 , L_7 ) ;
goto V_185;
}
V_23 -> V_27 = F_101 ( & V_173 -> V_47 , NULL ) ;
if ( F_102 ( V_23 -> V_27 ) ) {
F_93 ( V_47 , L_8 ) ;
V_31 = F_103 ( V_23 -> V_27 ) ;
goto V_187;
}
V_23 -> V_14 = F_104 ( V_23 -> V_142 , V_176 ) ;
if ( ! V_23 -> V_14 ) {
F_93 ( V_47 , L_9 ) ;
V_31 = - V_129 ;
goto V_188;
...
static int T_6 F_115 ( struct V_172 * V_173 )
{
