...
{
int V_13 ;
V_2 -> V_51 = F_93 ( V_2 -> V_64 , sizeof( struct V_24 ) ,
& V_2 -> V_23 , V_101 ) ;
if ( ! V_2 -> V_51 )
return - V_100 ;
...
strcpy ( V_113 -> V_118 , F_101 ( & V_12 -> V_64 ) ) ;
}
static int F_102 ( struct V_11 * V_12 , struct V_119 * V_120 )
{
struct V_1 * V_2 = F_95 ( V_12 ) ;
return F_103 ( & V_2 -> V_121 , V_120 ) ;
}
static int F_104 ( struct V_11 * V_12 , struct V_119 * V_120 )
{
struct V_1 * V_2 = F_95 ( V_12 ) ;
return F_105 ( & V_2 -> V_121 , V_120 ) ;
}
static int F_106 ( struct V_11 * V_12 )
{
struct V_1 * V_2 = F_95 ( V_12 ) ;
return F_107 ( & V_2 -> V_121 ) ;
}
static T_3 F_108 ( struct V_11 * V_12 )
{
struct V_1 * V_2 = F_95 ( V_12 ) ;
return F_109 ( & V_2 -> V_121 ) ;
}
static T_4 F_110 ( int V_122 , void * V_123 )
{
...
static int F_114 ( struct V_126 * V_124 , int V_127 )
{
struct V_1 * V_2 = F_115 ( V_124 , struct V_1 , V_124 ) ;
struct V_11 * V_12 = V_2 -> V_12 ;
unsigned int V_128 ;
bool V_129 = true ;
int V_130 = 0 ;
...
V_102 = F_119 ( V_2 -> V_122 , F_110 , 0 , V_12 -> V_143 , V_12 ) ;
if ( V_102 ) {
...
static int F_125 ( struct V_59 * V_60 , struct V_11 * V_12 )
{
struct V_1 * V_2 = F_95 ( V_12 ) ;
T_1 V_61 ;
...
V_61 = F_126 ( V_2 -> V_64 , V_60 -> V_109 , F_78 ( V_60 ) , V_95 ) ;
if ( F_41 ( F_88 ( V_2 -> V_64 , V_61 ) ) ) {
if ( F_42 () )
F_10 ( V_12 , L_22 ) ;
V_12 -> V_52 . V_147 ++ ;
...
static int F_127 ( struct V_11 * V_12 , struct V_148 * V_149 , int V_120 )
{
struct V_1 * V_2 = F_95 ( V_12 ) ;
struct V_150 * V_109 = F_128 ( V_149 ) ;
return F_129 ( & V_2 -> V_121 , V_109 , V_120 , NULL ) ;
}
static int F_130 ( struct V_151 * V_152 )
{
struct V_153 * V_154 ;
int V_122 ;
struct V_11 * V_12 ;
...
if ( ! V_152 )
return - V_155 ;
V_154 = F_131 ( V_152 , V_156 , 0 ) ;
if ( ! V_154 )
return - V_157 ;
V_122 = F_132 ( V_152 , 0 ) ;
if ( V_122 < 0 )
return V_122 ;
V_12 = F_133 ( sizeof( * V_2 ) ) ;
if ( ! V_12 ) {
V_102 = - V_100 ;
goto V_158;
}
F_134 ( V_12 , & V_152 -> V_64 ) ;
F_135 ( V_12 , & V_159 ) ;
V_12 -> V_160 = & V_161 ;
F_136 ( V_152 , V_12 ) ;
V_2 = F_95 ( V_12 ) ;
...
V_2 -> V_64 = & V_152 -> V_64 ;
F_137 ( & V_2 -> V_96 ) ;
F_138 ( V_12 , & V_2 -> V_124 , F_114 , 64 ) ;
V_2 -> V_154 = F_139 ( V_154 -> V_162 , F_140 ( V_154 ) ,
F_101 ( & V_152 -> V_64 ) ) ;
if ( ! V_2 -> V_154 ) {
...
V_2 -> V_4 = F_142 ( V_154 -> V_162 , F_140 ( V_154 ) ) ;
if ( ! V_2 -> V_4 ) {
...
V_2 -> V_122 = V_122 ;
V_2 -> V_121 . V_103 = 0 ;
V_2 -> V_121 . V_165 = 0x1f ;
V_2 -> V_121 . V_166 = 0x1f ;
V_2 -> V_121 . V_64 = V_12 ;
V_2 -> V_121 . V_167 = F_94 ;
V_2 -> V_121 . V_168 = F_98 ;
V_102 = F_143 ( V_12 ) ;
if ( V_102 ) {
...
static int T_5 F_150 ( struct V_151 * V_152 )
{
struct V_11 * V_12 ;
struct V_1 * V_2 ;
V_12 = F_151 ( V_152 ) ;
