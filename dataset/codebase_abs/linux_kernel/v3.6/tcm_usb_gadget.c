...
static int F_105 ( struct V_44 * V_44 )
{
return 0 ;
}
static T_2 F_106 ( struct V_44 * V_44 , T_3 V_242 )
{
return 0 ;
}
...
static const char * F_108 ( const char * V_243 )
{
const char * V_244 ;
unsigned int V_118 ;
...
static void F_113 ( struct V_228 * V_254 )
{
struct V_236 * V_237 = F_2 ( V_254 ,
struct V_236 , V_228 ) ;
F_114 ( V_254 -> V_189 , V_254 , 1 ) ;
F_29 ( V_237 ) ;
}
static struct V_220 * F_115 (
struct V_255 * V_256 ,
struct V_246 * V_247 ,
const char * V_243 )
{
...
return F_110 ( - V_61 ) ;
if ( F_116 ( V_243 + 5 , 0 , & V_258 ) || V_258 > V_259 )
return F_110 ( - V_61 ) ;
if ( V_260 ) {
F_8 ( L_25 ) ;
F_8 ( L_26 ) ;
...
static void F_122 ( struct V_220 * V_189 )
{
struct V_184 * V_97 = F_2 ( V_189 ,
struct V_184 , V_189 ) ;
F_123 ( V_189 ) ;
...
static int F_134 ( struct V_184 * V_97 , char * V_243 )
{
struct V_220 * V_189 ;
struct V_182 * V_183 ;
int V_10 ;
...
V_183 -> V_188 = F_136 () ;
if ( F_112 ( V_183 -> V_188 ) )
goto V_278;
V_183 -> V_188 -> V_228 = F_137 (
V_189 , V_243 ) ;
...
static int F_140 ( struct V_184 * V_97 )
{
struct V_240 * V_241 ;
struct V_182 * V_183 ;
int V_10 = - V_274 ;
...
V_10 = F_134 ( V_97 , & V_281 [ 4 ] ) ;
if ( V_10 < 0 )
return V_10 ;
return V_272 ;
}
static int F_143 ( struct V_220 * V_189 , struct V_283 * V_209 )
{
struct V_184 * V_97 = F_2 ( V_189 , struct V_184 , V_189 ) ;
F_144 ( & V_97 -> V_98 ) ;
F_145 () ;
...
static void F_146 ( struct V_220 * V_189 ,
struct V_283 * V_283 )
{
struct V_184 * V_97 = F_2 ( V_189 , struct V_184 , V_189 ) ;
F_147 ( & V_97 -> V_98 ) ;
...
static int F_149 ( struct V_44 * V_44 )
{
struct V_5 * V_6 = F_2 ( V_44 , struct V_5 ,
V_44 ) ;
F_4 ( & V_6 -> V_7 , V_8 ) ;
...
struct V_266 * V_284 ;
int V_10 ;
V_284 = F_151 ( V_285 , L_20 ) ;
if ( F_112 ( V_284 ) ) {
F_93 ( V_238 L_44 ) ;
return F_152 ( V_284 ) ;
}
V_284 -> V_264 = V_286 ;
F_153 ( V_284 ) -> V_287 . V_288 = V_289 ;
F_153 ( V_284 ) -> V_290 . V_288 = V_291 ;
F_153 ( V_284 ) -> V_292 . V_288 = NULL ;
F_153 ( V_284 ) -> V_293 . V_288 = NULL ;
F_153 ( V_284 ) -> V_294 . V_288 = NULL ;
F_153 ( V_284 ) -> V_295 . V_288 = NULL ;
F_153 ( V_284 ) -> V_296 . V_288 = NULL ;
F_153 ( V_284 ) -> V_297 . V_288 = NULL ;
F_153 ( V_284 ) -> V_298 . V_288 = NULL ;
V_10 = F_154 ( V_284 ) ;
if ( V_10 < 0 ) {
F_93 ( V_238 L_45
L_46 ) ;
...
static int F_157 ( struct V_83 * V_76 )
{
return 0 ;
}
static void F_158 ( struct V_16 * * V_299 )
{
...
static int F_159 ( struct V_301 * V_302 , struct V_2 * V_3 )
{
struct V_1 * V_9 = F_1 ( V_3 ) ;
struct V_49 * V_50 = V_302 -> V_76 -> V_50 ;
struct V_16 * V_17 ;
int V_303 ;
V_303 = F_160 ( V_302 , V_3 ) ;
if ( V_303 < 0 )
return V_303 ;
V_304 . V_305 = V_303 ;
V_306 . V_305 = V_303 ;
V_9 -> V_303 = V_303 ;
V_17 = F_161 ( V_50 , & V_307 ,
& V_308 ) ;
if ( ! V_17 )
goto V_309;
V_17 -> V_300 = V_9 ;
V_9 -> V_32 = V_17 ;
V_17 = F_161 ( V_50 , & V_310 ,
& V_311 ) ;
if ( ! V_17 )
goto V_309;
V_17 -> V_300 = V_9 ;
V_9 -> V_13 = V_17 ;
V_17 = F_161 ( V_50 , & V_312 ,
& V_313 ) ;
if ( ! V_17 )
goto V_309;
V_17 -> V_300 = V_9 ;
V_9 -> V_105 = V_17 ;
V_17 = F_161 ( V_50 , & V_314 ,
& V_315 ) ;
if ( ! V_17 )
goto V_309;
V_17 -> V_300 = V_9 ;
...
static void F_162 ( struct V_301 * V_302 , struct V_2 * V_3 )
{
struct V_1 * V_9 = F_1 ( V_3 ) ;
F_29 ( V_9 ) ;
}
static void F_163 ( struct V_180 * V_325 )
{
...
static int F_165 ( struct V_2 * V_3 , unsigned V_330 , unsigned V_327 )
{
struct V_1 * V_9 = F_1 ( V_3 ) ;
...
static int F_169 ( struct V_301 * V_302 )
{
struct V_1 * V_9 ;
int V_10 ;
...
{
int V_10 ;
V_10 = F_172 ( V_76 , & V_344 ,
F_169 ) ;
return 0 ;
}
static int F_129 ( struct V_184 * V_97 )
{
return F_173 ( & V_345 , F_171 ) ;
}
static void F_130 ( struct V_184 * V_97 )
{
F_174 ( & V_345 ) ;
}
