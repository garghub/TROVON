...
V_35 = F_51 ( V_79 , V_32 -> V_85 , ( const V_86 * ) & V_14 -> V_15 ,
V_41 -> V_61 , V_53 , V_87 ) ;
if ( ! V_35 )
return;
if ( F_50 ( V_32 ) -> type == V_81 )
F_52 ( V_32 , V_79 , V_78 , 0 , 0 , V_53 , 0 ) ;
else
F_53 ( V_32 , V_79 , 0 , 0 , V_53 , 0 ) ;
F_54 ( V_35 ) ;
}
