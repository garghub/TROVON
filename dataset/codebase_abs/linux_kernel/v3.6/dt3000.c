...
V_55 = V_3 -> V_56 ;
V_3 -> V_56 &= V_57 ;
if ( ! V_3 -> V_56 || V_55 != V_3 -> V_56 )
V_54 ++ ;
V_55 = V_3 -> V_58 ;
V_3 -> V_58 &= V_59 ;
if ( ! V_3 -> V_58 || V_55 != V_3 -> V_58 )
V_54 ++ ;
V_55 = V_3 -> V_60 ;
V_3 -> V_60 &= V_59 ;
if ( ! V_3 -> V_60 || V_55 != V_3 -> V_60 )
V_54 ++ ;
V_55 = V_3 -> V_61 ;
V_3 -> V_61 &= V_62 ;
if ( ! V_3 -> V_61 || V_55 != V_3 -> V_61 )
V_54 ++ ;
V_55 = V_3 -> V_63 ;
V_3 -> V_63 &= V_62 ;
if ( ! V_3 -> V_63 || V_55 != V_3 -> V_63 )
V_54 ++ ;
if ( V_54 )
return 1 ;
if ( V_54 )
...
static int F_18 ( unsigned int V_73 , unsigned int * V_74 ,
unsigned int V_75 )
{
int V_76 , V_77 , V_78 ;
...
static int F_19 ( struct V_1 * V_2 , struct V_24 * V_25 )
{
...
V_16 = F_20 ( V_3 -> V_87 [ V_4 ] ) ;
V_82 = F_21 ( V_3 -> V_87 [ V_4 ] ) ;
F_2 ( ( V_82 << 6 ) | V_16 ,
V_6 -> V_7 + V_51 + V_4 ) ;
}
V_83 = F_22 ( V_3 -> V_87 [ 0 ] ) ;
F_2 ( V_3 -> V_69 , V_6 -> V_7 + F_7 ( 0 ) ) ;
F_5 ( V_2 -> V_13 , L_7 , V_3 -> V_69 ) ;
if ( V_3 -> V_60 == V_59 ) {
V_76 = F_18 ( 50 , & V_3 -> V_68 ,
V_3 -> V_40 & V_72 ) ;
...
static int F_23 ( struct V_1 * V_2 , struct V_24 * V_25 ,
...
static void F_26 ( struct V_1 * V_2 , int V_101 )
{
...
{
int V_103 ;
V_103 = ( F_20 ( V_96 -> V_97 ) < 4 ) ? 0x0f : 0xf0 ;
switch ( V_20 [ 0 ] ) {
case V_104 :
V_25 -> V_105 |= V_103 ;
break;
...
struct V_95 * V_96 , unsigned int * V_20 )
{
unsigned int V_113 = F_20 ( V_96 -> V_97 ) ;
int V_4 ;
for ( V_4 = 0 ; V_4 < V_96 -> V_98 ; V_4 ++ ) {
...
static struct V_116 * F_30 ( struct V_1 * V_2 ,
struct V_117 * V_118 )
{
...
V_122 != F_32 ( V_119 -> V_124 ) )
continue;
}
if ( V_119 -> V_125 != V_126 )
continue;
for ( V_4 = 0 ; V_4 < F_33 ( V_127 ) ; V_4 ++ ) {
...
int V_85 = 0 ;
F_5 ( V_2 -> V_13 , L_16 ) ;
V_85 = F_36 ( V_2 , sizeof( struct V_132 ) ) ;
if ( V_85 < 0 )
return V_85 ;
V_119 = F_30 ( V_2 , V_118 ) ;
if ( ! V_119 )
return - V_133 ;
F_37 ( V_2 , & V_119 -> V_2 ) ;
V_85 = F_38 ( V_119 , L_17 ) ;
if ( V_85 < 0 )
return V_85 ;
V_2 -> V_134 = 1 ;
V_131 = F_39 ( V_119 , 0 ) ;
V_6 -> V_7 = F_40 ( V_131 , V_135 ) ;
if ( ! V_6 -> V_7 )
return - V_136 ;
V_2 -> V_137 = V_66 -> V_138 ;
if ( F_41 ( V_119 -> V_22 , F_9 , V_139 ,
L_17 , V_2 ) ) {
F_34 ( V_2 -> V_13 , L_18 ,
V_119 -> V_22 ) ;
return - V_110 ;
...
static int T_3 F_49 ( struct V_116 * V_2 ,
const struct V_169 * V_170 )
{
return F_50 ( V_2 , & V_171 ) ;
}
static void T_4 F_51 ( struct V_116 * V_2 )
{
F_52 ( V_2 ) ;
}
