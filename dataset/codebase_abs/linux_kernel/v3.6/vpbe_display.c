...
F_91 ( V_256 , & V_246 -> V_79 ) ;
V_246 -> V_257 = & V_244 -> V_248 ;
if ( V_2 -> V_4 -> V_107 . V_190 &
V_191 ) {
V_246 -> V_258 = ( V_118 | V_119 ) ;
V_246 -> V_203 =
V_2 -> V_4 ->
V_107 . V_108 . V_109 ;
} else
...
V_244 -> V_86 = V_46 ;
V_244 -> V_38 . V_39 =
( ( V_46 == V_87 ) ? V_259 : V_260 ) ;
F_92 ( & V_244 -> V_152 ) ;
return 0 ;
}
static T_4 int F_93 ( struct V_13 * V_244 ,
struct V_1 * V_2 ,
struct V_241 * V_221 ) {
int V_227 ;
F_94 ( & V_2 -> V_4 -> V_11 ,
...
static T_4 int F_98 ( struct V_241 * V_221 )
{
struct V_13 * V_244 ;
struct V_1 * V_2 ;
...
F_89 ( & V_2 -> V_30 ) ;
V_227 = F_99 ( & V_267 , NULL , V_2 ,
F_83 ) ;
if ( V_227 < 0 )
return V_227 ;
if ( NULL != V_2 -> V_4 -> V_36 . V_268 ) {
V_227 = V_2 -> V_4 -> V_36 . V_268 ( & V_221 -> V_47 ,
V_2 -> V_4 ) ;
if ( V_227 ) {
F_3 ( & V_2 -> V_4 -> V_11 ,
L_70 ) ;
...
V_41 = V_264 -> V_271 ;
if ( F_101 ( V_41 , F_14 , V_272 , V_161 ,
V_2 ) ) {
F_3 ( & V_2 -> V_4 -> V_11 ,
L_72 ) ;
V_227 = - V_262 ;
...
for ( V_46 = 0 ; V_46 < V_52 ; V_46 ++ ) {
if ( F_93 ( V_2 -> V_47 [ V_46 ] , V_2 , V_221 ) ) {
V_227 = - V_262 ;
goto V_273;
}
}
...
return 0 ;
V_273:
F_102 ( V_264 -> V_271 , V_2 ) ;
V_269:
for ( V_265 = 0 ; V_265 < V_52 ; V_265 ++ ) {
V_244 = V_2 -> V_47 [ V_265 ] ;
if ( V_244 ) {
F_103 (
& V_244 -> V_202 ) ;
F_75 ( V_2 -> V_47 [ V_265 ] ) ;
...
static int F_104 ( struct V_241 * V_221 )
{
struct V_13 * V_244 ;
...
V_264 = F_100 ( V_221 , V_270 , 0 ) ;
F_102 ( V_264 -> V_271 , V_2 ) ;
if ( NULL != V_4 -> V_36 . V_274 )
V_4 -> V_36 . V_274 ( & V_221 -> V_47 , V_4 ) ;
for ( V_46 = 0 ; V_46 < V_52 ; V_46 ++ ) {
V_244 = V_2 -> V_47 [ V_46 ] ;
F_103 ( & V_244 -> V_202 ) ;
}
