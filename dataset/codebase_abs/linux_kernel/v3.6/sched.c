...
void * F_116 ( struct V_3 * V_4 , T_5 V_99 )
{
struct V_100 * V_101 ;
T_6 V_102 = V_103 ;
if ( F_20 ( V_4 ) )
...
if ( V_99 <= V_105 )
V_101 = F_117 ( V_106 , V_102 ) ;
else
V_101 = F_118 ( V_99 , V_102 ) ;
if ( ! V_101 )
return NULL ;
V_101 -> V_107 = V_99 ;
F_2 ( L_16 ,
...
void F_119 ( void * V_108 )
{
T_5 V_99 ;
struct V_100 * V_101 ;
if ( ! V_108 )
return;
V_101 = F_115 ( V_108 , struct V_100 , V_66 ) ;
V_99 = V_101 -> V_107 ;
F_2 ( L_17 ,
V_99 , V_101 ) ;
if ( V_99 <= V_105 )
...
static void F_122 ( struct V_3 * V_4 , const struct V_109 * V_110 )
{
...
F_125 ( void )
{
return (struct V_3 * ) F_117 ( V_117 , V_118 ) ;
}
struct V_3 * F_126 ( const struct V_109 * V_119 )
{
...
static void F_134 ( struct V_3 * V_4 , struct V_125 * V_17 )
{
if ( F_54 ( & V_4 -> V_51 ) ) {
F_130 ( V_4 ) ;
F_133 ( V_4 , V_17 ) ;
...
struct V_125 * V_46 ;
F_2 ( L_22 ) ;
V_46 = F_143 ( L_23 , V_128 , 0 ) ;
V_56 = V_46 ;
return V_56 != NULL ;
}
static void F_144 ( void )
{
struct V_125 * V_46 = NULL ;
if ( V_56 == NULL )
return;
F_2 ( L_24 ) ;
V_46 = V_56 ;
