...
static void F_78 ( struct V_21 * V_21 , unsigned long V_52 )
{
F_20 ( L_49 , V_21 -> V_34 , V_52 ) ;
F_77 ( 1 ) ;
}
static inline int F_79 ( struct V_9 * V_9 )
{
struct V_44 * V_45 = F_36 ( V_9 ) ;
return F_80 ( V_9 -> V_91 ) && ( V_45 -> V_92 [ 0 ] != 0 ) ;
}
static int F_81 ( struct V_9 * V_9 , T_2 V_93 )
{
struct V_44 * V_45 = F_36 ( V_9 ) ;
struct V_10 * V_11 = V_9 -> V_12 -> V_13 ;
int V_25 ;
V_9 -> V_94 = V_9 -> V_95 = V_96 ;
V_25 = F_82 ( & V_11 -> V_2 , & V_45 -> V_47 , ( T_1 ) V_93 ) ;
if ( F_8 ( ! V_25 ) )
F_83 ( V_9 , V_93 ) ;
F_20 ( L_50 ,
V_9 -> V_31 , V_93 , V_25 ) ;
...
int F_84 ( struct V_97 * V_97 , struct V_98 * V_98 )
{
struct V_9 * V_9 = V_97 -> V_99 ;
int error ;
error = F_62 ( F_36 ( V_9 ) ) ;
if ( F_14 ( error ) )
return error ;
...
static int F_87 ( struct V_103 * V_104 , struct V_44 * V_45 ,
struct V_105 * V_9 )
{
struct V_10 * V_11 = V_104 -> V_13 ;
struct V_106 V_107 [] = {
[ 0 ] = V_108 ,
[ 1 ] = V_109 ,
[ 2 ] = V_110 ,
...
struct V_111 * V_2 ;
int V_25 ;
V_25 = F_88 ( & V_11 -> V_2 , & V_45 -> V_47 , & V_14 ) ;
if ( F_14 ( V_25 ) ) {
F_9 ( L_51 , V_112 ) ;
return V_25 ;
}
V_107 [ 1 ] . V_24 = F_89 ( V_11 -> V_47 . V_113 ) ;
V_107 [ 2 ] . V_24 = F_89 ( V_11 -> V_47 . V_113 ) ;
V_14 -> V_114 = V_107 ;
V_14 -> V_115 = F_90 ( V_107 ) ;
V_25 = F_38 ( V_14 ) ;
if ( F_14 ( V_25 ) ) {
F_9 ( L_52 ,
F_28 ( V_45 -> V_116 . V_117 . V_118 ) , V_25 ) ;
memset ( V_9 , 0 , sizeof( * V_9 ) ) ;
V_9 -> V_91 = 0040000 | ( 0777 & ~ 022 ) ;
if ( ( V_25 == - V_119 ) || ( V_25 == - V_120 ) )
V_25 = 0 ;
goto V_87;
}
V_25 = F_91 ( V_14 , & V_107 [ 0 ] ) ;
if ( V_25 ) {
F_9 ( L_53 , V_112 ) ;
goto V_87;
}
F_77 ( V_107 [ 0 ] . V_24 != V_121 ) ;
memcpy ( V_9 , V_107 [ 0 ] . V_122 , V_121 ) ;
V_25 = F_91 ( V_14 , & V_107 [ 1 ] ) ;
if ( V_25 ) {
F_9 ( L_53 , V_112 ) ;
goto V_87;
}
...
struct V_9 * F_95 ( struct V_103 * V_104 , unsigned long V_128 )
{
struct V_44 * V_45 ;
struct V_105 V_129 ;
struct V_9 * V_9 ;
int V_25 ;
V_9 = F_96 ( V_104 , V_128 ) ;
if ( ! V_9 )
return F_97 ( - V_23 ) ;
if ( ! ( V_9 -> V_130 & V_131 ) )
return V_9 ;
V_45 = F_36 ( V_9 ) ;
F_93 ( V_45 ) ;
F_98 ( & V_45 -> V_47 , & V_45 -> V_116 , V_104 -> V_13 ,
F_99 ( V_45 ) ) ;
V_25 = F_87 ( V_104 , V_45 , & V_129 ) ;
if ( V_25 )
goto V_132;
F_100 ( V_45 ) ;
V_9 -> V_91 = F_101 ( V_129 . V_91 ) ;
V_9 -> V_133 = F_102 ( V_129 . V_133 ) ;
V_9 -> V_134 = F_102 ( V_129 . V_134 ) ;
F_103 ( V_9 , F_101 ( V_129 . V_135 ) ) ;
V_9 -> V_95 . V_136 = ( signed ) F_102 ( V_129 . V_95 ) ;
V_9 -> V_137 . V_136 = ( signed ) F_102 ( V_129 . V_137 ) ;
V_9 -> V_94 . V_136 = ( signed ) F_102 ( V_129 . V_94 ) ;
V_9 -> V_95 . V_138 =
V_9 -> V_137 . V_138 = V_9 -> V_94 . V_138 = 0 ;
V_45 -> V_139 = F_104 ( V_129 . V_54 ) ;
F_105 ( V_9 , V_45 -> V_139 ) ;
V_9 -> V_140 = V_141 ;
V_9 -> V_142 = F_102 ( V_129 . V_142 ) ;
V_45 -> V_143 = 0 ;
if ( ( V_9 -> V_144 == 0 ) && ( V_9 -> V_91 == 0 ) ) {
V_25 = - V_145 ;
goto V_132;
}
if ( F_106 ( V_9 -> V_91 ) || F_107 ( V_9 -> V_91 ) ) {
if ( V_129 . V_92 [ 0 ] )
V_9 -> V_146 =
F_108 ( F_102 ( V_129 . V_92 [ 0 ] ) ) ;
else
V_9 -> V_146 =
F_109 ( F_102 ( V_129 . V_92 [ 1 ] ) ) ;
} else {
memcpy ( V_45 -> V_92 , V_129 . V_92 , sizeof( V_129 . V_92 ) ) ;
}
V_9 -> V_65 -> V_147 = V_104 -> V_148 ;
if ( F_110 ( V_9 -> V_91 ) ) {
V_9 -> V_149 = & V_150 ;
V_9 -> V_151 = & V_152 ;
V_9 -> V_65 -> V_153 = & V_154 ;
} else if ( F_111 ( V_9 -> V_91 ) ) {
V_9 -> V_149 = & V_155 ;
V_9 -> V_151 = & V_156 ;
V_9 -> V_65 -> V_153 = & V_154 ;
} else if ( F_80 ( V_9 -> V_91 ) ) {
if ( F_79 ( V_9 ) )
V_9 -> V_149 = & V_157 ;
else {
V_9 -> V_149 = & V_158 ;
...
int F_115 ( struct V_44 * V_45 )
{
if ( ! F_44 ( V_45 ) ) {
F_20 ( L_56 ) ;
F_34 ( ! F_116 ( V_45 ) ) ;
F_117 ( V_45 -> V_126 , F_44 ( V_45 ) ) ;
F_20 ( L_57 ) ;
}
return F_14 ( F_118 ( & V_45 -> V_160 ) ) ? - V_161 : 0 ;
}
static void F_119 ( struct V_35 * V_14 , void * V_36 )
{
struct V_9 * V_9 = V_36 ;
struct V_44 * V_45 = F_36 ( V_9 ) ;
struct V_10 * V_11 = V_9 -> V_12 -> V_13 ;
...
F_9 ( L_58 ,
F_28 ( F_99 ( V_45 ) ) ,
F_28 ( V_45 -> V_116 . V_117 . V_162 ) ) ;
}
F_100 ( V_45 ) ;
F_120 ( & V_45 -> V_126 ) ;
}
struct V_9 * F_121 ( struct V_9 * V_163 , T_6 V_164 )
{
struct V_103 * V_104 = V_163 -> V_12 ;
struct V_10 * V_11 = V_104 -> V_13 ;
struct V_9 * V_9 ;
struct V_44 * V_45 ;
struct V_35 * V_14 ;
...
F_123 ( V_45 ) ;
V_9 -> V_65 -> V_147 = V_104 -> V_148 ;
F_124 ( V_9 , V_163 , V_164 ) ;
V_9 -> V_31 = V_11 -> V_165 ++ ;
V_9 -> V_140 = V_141 ;
V_9 -> V_94 = V_9 -> V_137 = V_9 -> V_95 = V_96 ;
V_45 -> V_139 = V_9 -> V_54 = 0 ;
F_125 ( & V_11 -> V_166 ) ;
V_9 -> V_142 = V_11 -> V_167 ++ ;
F_126 ( & V_11 -> V_166 ) ;
F_127 ( V_9 ) ;
F_98 ( & V_45 -> V_47 , & V_45 -> V_116 , V_104 -> V_13 ,
F_99 ( V_45 ) ) ;
...
static void F_130 ( struct V_35 * V_14 , void * V_36 )
{
...
static int F_131 ( struct V_9 * V_9 , int V_169 )
{
struct V_44 * V_45 = F_36 ( V_9 ) ;
struct V_103 * V_104 = V_9 -> V_12 ;
struct V_10 * V_11 = V_104 -> V_13 ;
struct V_35 * V_14 ;
struct V_106 V_170 ;
struct V_105 * V_129 ;
struct V_168 * args ;
int V_25 ;
args = F_132 ( sizeof( * args ) , V_22 ) ;
if ( ! args ) {
F_20 ( L_60 ) ;
return - V_23 ;
}
V_129 = & args -> V_129 ;
V_129 -> V_91 = F_92 ( V_9 -> V_91 ) ;
V_129 -> V_133 = F_133 ( V_9 -> V_133 ) ;
V_129 -> V_134 = F_133 ( V_9 -> V_134 ) ;
V_129 -> V_135 = F_92 ( V_9 -> V_144 ) ;
V_129 -> V_95 = F_133 ( V_9 -> V_95 . V_136 ) ;
V_129 -> V_137 = F_133 ( V_9 -> V_137 . V_136 ) ;
V_129 -> V_94 = F_133 ( V_9 -> V_94 . V_136 ) ;
V_45 -> V_139 = F_41 ( V_9 ) ;
V_129 -> V_54 = F_134 ( V_45 -> V_139 ) ;
V_129 -> V_142 = F_133 ( V_9 -> V_142 ) ;
if ( F_106 ( V_9 -> V_91 ) || F_107 ( V_9 -> V_91 ) ) {
if ( F_135 ( V_9 -> V_146 ) ) {
V_129 -> V_92 [ 0 ] =
F_133 ( F_136 ( V_9 -> V_146 ) ) ;
V_129 -> V_92 [ 1 ] = 0 ;
} else {
V_129 -> V_92 [ 0 ] = 0 ;
V_129 -> V_92 [ 1 ] =
F_133 ( F_137 ( V_9 -> V_146 ) ) ;
V_129 -> V_92 [ 2 ] = 0 ;
}
} else
memcpy ( V_129 -> V_92 , V_45 -> V_92 , sizeof( V_129 -> V_92 ) ) ;
V_25 = F_88 ( & V_11 -> V_2 , & V_45 -> V_47 , & V_14 ) ;
if ( F_14 ( V_25 ) ) {
F_9 ( L_51 , V_112 ) ;
goto V_171;
...
int F_138 ( struct V_9 * V_9 , struct V_70 * V_74 )
{
return F_131 ( V_9 , 1 ) ;
}
static void F_139 ( struct V_35 * V_14 , void * V_36 )
{
struct V_10 * V_11 = V_36 ;
F_12 ( V_14 ) ;
F_31 ( & V_11 -> V_37 ) ;
}
void F_140 ( struct V_9 * V_9 )
{
struct V_44 * V_45 = F_36 ( V_9 ) ;
struct V_103 * V_104 = V_9 -> V_12 ;
struct V_10 * V_11 = V_104 -> V_13 ;
