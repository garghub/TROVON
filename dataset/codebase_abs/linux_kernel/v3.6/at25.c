...
static int F_25 ( struct V_58 * V_27 )
{
struct V_1 * V_2 = NULL ;
struct V_59 V_18 ;
...
strncpy ( V_18 . V_66 , V_61 -> V_66 , 10 ) ;
V_63 = F_26 ( V_61 , L_7 , & V_65 ) ;
if ( V_63 ) {
F_7 ( & V_27 -> V_28 , L_8 ) ;
goto V_67;
}
V_18 . V_68 = V_65 ;
V_63 = F_26 ( V_61 , L_9 , & V_65 ) ;
if ( V_63 ) {
F_7 ( & V_27 -> V_28 , L_8 ) ;
goto V_67;
}
V_18 . V_19 = ( V_69 ) V_65 ;
V_63 = F_26 ( V_61 , L_10 , & V_65 ) ;
if ( V_63 ) {
F_7 ( & V_27 -> V_28 , L_8 ) ;
goto V_67;
}
...
V_18 = * (struct V_59 * ) V_27 -> V_28 . V_64 ;
if ( V_18 . V_19 & V_71 )
V_21 = 1 ;
else if ( V_18 . V_19 & V_72 )
V_21 = 2 ;
else if ( V_18 . V_19 & V_73 )
V_21 = 3 ;
else {
F_7 ( & V_27 -> V_28 , L_12 ) ;
V_63 = - V_74 ;
...
V_2 -> V_21 = V_21 ;
F_31 ( & V_2 -> V_15 ) ;
V_2 -> V_15 . V_76 . V_66 = L_13 ;
V_2 -> V_15 . V_76 . V_77 = V_78 ;
V_2 -> V_15 . V_79 = F_9 ;
V_2 -> V_57 . V_79 = F_23 ;
V_2 -> V_15 . V_16 = V_2 -> V_18 . V_68 ;
if ( ! ( V_18 . V_19 & V_80 ) ) {
V_2 -> V_15 . V_81 = F_22 ;
V_2 -> V_15 . V_76 . V_77 |= V_82 ;
V_2 -> V_57 . V_81 = F_24 ;
}
V_63 = F_32 ( & V_27 -> V_28 . V_32 , & V_2 -> V_15 ) ;
if ( V_63 )
goto V_67;
if ( V_18 . V_83 )
V_18 . V_83 ( & V_2 -> V_57 , V_18 . V_84 ) ;
F_33 ( & V_27 -> V_28 , L_14 ,
( V_2 -> V_15 . V_16 < 1024 )
? V_2 -> V_15 . V_16
: ( V_2 -> V_15 . V_16 / 1024 ) ,
( V_2 -> V_15 . V_16 < 1024 ) ? L_15 : L_16 ,
V_2 -> V_18 . V_66 ,
( V_18 . V_19 & V_80 ) ? L_17 : L_18 ,
V_2 -> V_18 . V_41 ) ;
return 0 ;
V_67:
F_7 ( & V_27 -> V_28 , L_19 , V_63 ) ;
F_21 ( V_2 ) ;
return V_63 ;
}
static int T_7 F_34 ( struct V_58 * V_27 )
{
struct V_1 * V_2 ;
V_2 = F_11 ( & V_27 -> V_28 ) ;
F_35 ( & V_27 -> V_28 . V_32 , & V_2 -> V_15 ) ;
F_21 ( V_2 ) ;
return 0 ;
}
