...
strcpy ( V_142 -> V_147 , F_106 ( & V_11 -> V_73 ) ) ;
}
static int F_117 ( struct V_10 * V_11 ,
struct V_148 * V_149 )
{
struct V_1 * V_2 = F_102 ( V_11 ) ;
return F_118 ( V_2 -> V_119 , V_149 ) ;
}
...
static T_6 F_121 ( int V_150 , void * V_151 )
{
...
static int F_125 ( struct V_153 * V_85 , int V_154 )
{
struct V_1 * V_2 = F_126 ( V_85 , struct V_1 , V_85 ) ;
struct V_10 * V_11 = V_2 -> V_11 ;
unsigned int V_155 ;
bool V_156 = true ;
int V_157 = 0 ;
...
V_117 = F_129 ( V_2 -> V_150 , F_121 , 0 , V_11 -> V_127 , V_11 ) ;
if ( V_117 ) {
...
static int F_136 ( struct V_67 * V_68 ,
struct V_10 * V_11 )
{
struct V_1 * V_2 = F_102 ( V_11 ) ;
T_1 V_72 ;
...
V_72 = F_137 ( V_2 -> V_73 , V_68 -> V_137 , F_83 ( V_68 ) , V_105 ) ;
if ( F_45 ( F_95 ( V_2 -> V_73 , V_72 ) ) ) {
if ( F_46 () )
F_10 ( V_11 , L_25 ) ;
V_11 -> V_60 . V_174 ++ ;
...
static int F_138 ( struct V_10 * V_11 , struct V_175 * V_176 , int V_149 )
{
struct V_1 * V_2 = F_102 ( V_11 ) ;
return F_139 ( V_2 -> V_119 , V_176 , V_149 ) ;
}
static int F_140 ( struct V_177 * V_178 )
{
struct V_179 * V_180 ;
int V_150 ;
struct V_10 * V_11 ;
...
if ( ! V_178 )
return - V_128 ;
V_180 = F_141 ( V_178 , V_181 , 0 ) ;
if ( ! V_180 )
return - V_182 ;
V_150 = F_142 ( V_178 , 0 ) ;
if ( V_150 < 0 )
return V_150 ;
V_11 = F_143 ( sizeof( * V_2 ) ) ;
if ( ! V_11 ) {
V_117 = - V_115 ;
goto V_183;
}
F_144 ( V_11 , & V_178 -> V_73 ) ;
F_145 ( V_11 , & V_184 ) ;
V_11 -> V_185 = & V_186 ;
...
V_2 -> V_73 = & V_178 -> V_73 ;
F_147 ( & V_2 -> V_106 ) ;
F_148 ( V_11 , & V_2 -> V_85 , F_125 , 64 ) ;
V_2 -> V_180 = F_149 ( V_180 -> V_190 , F_150 ( V_180 ) ,
F_106 ( & V_178 -> V_73 ) ) ;
if ( ! V_2 -> V_180 ) {
...
V_2 -> V_4 = F_152 ( V_180 -> V_190 , F_150 ( V_180 ) ) ;
if ( ! V_2 -> V_4 ) {
