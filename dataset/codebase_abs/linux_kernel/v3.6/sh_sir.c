...
V_27 = 0xffffffff ;
V_40 = 0 ;
for ( V_29 = 0 ; V_29 < F_20 ( V_43 ) ; V_29 ++ ) {
...
static int F_23 ( T_4 * V_51 , int V_52 )
{
V_51 -> V_53 = F_24 ( V_52 , V_54 ) ;
if ( ! V_51 -> V_53 )
return - V_55 ;
V_51 -> V_56 = V_52 ;
V_51 -> V_57 = FALSE ;
...
static int F_27 ( struct V_1 * V_2 , int V_62 , int V_63 )
{
int V_64 = - V_55 ;
if ( V_2 -> V_60 . V_53 ||
V_2 -> V_61 . V_53 ) {
...
V_64 = F_23 ( & V_2 -> V_60 , V_62 ) ;
if ( V_64 )
goto V_65;
V_64 = F_23 ( & V_2 -> V_61 , V_63 ) ;
V_65:
if ( V_64 )
F_25 ( V_2 ) ;
return V_64 ;
...
static void F_29 ( struct V_1 * V_2 , int V_68 )
{
T_2 V_69 = 0 ;
T_2 V_70 = 0 ;
switch ( V_68 ) {
...
static void F_31 ( struct V_1 * V_2 , int V_68 )
{
switch ( V_68 ) {
case V_71 :
if ( 0 >= V_2 -> V_61 . V_83 ) {
...
static T_5 F_37 ( int V_98 , void * V_99 )
{
struct V_1 * V_2 = V_99 ;
struct V_14 * V_15 = & V_2 -> V_16 -> V_15 ;
int V_68 = F_30 ( V_2 ) ;
...
static int F_38 ( struct V_102 * V_103 , struct V_104 * V_16 )
{
struct V_1 * V_2 = F_39 ( V_16 ) ;
int V_105 = F_40 ( V_103 ) ;
if ( ( 0 < V_105 ) &&
( 9600 != V_105 ) ) {
...
V_2 -> V_61 . V_83 = 0 ;
if ( V_103 -> V_83 )
V_2 -> V_61 . V_83 = F_42 ( V_103 , V_2 -> V_61 . V_4 ,
V_2 -> V_61 . V_56 ) ;
F_29 ( V_2 , V_71 ) ;
F_43 ( V_103 ) ;
return 0 ;
}
static int F_44 ( struct V_104 * V_16 , struct V_106 * V_106 , int V_107 )
{
return 0 ;
}
static struct V_108 * F_45 ( struct V_104 * V_16 )
{
struct V_1 * V_2 = F_39 ( V_16 ) ;
return & V_2 -> V_16 -> V_93 ;
}
static int F_46 ( struct V_104 * V_16 )
{
struct V_1 * V_2 = F_39 ( V_16 ) ;
int V_64 ;
F_47 ( V_2 -> V_21 ) ;
...
goto V_109;
F_16 ( V_2 , 9600 ) ;
V_2 -> V_110 = F_48 ( V_16 , & V_2 -> V_111 , V_112 ) ;
if ( ! V_2 -> V_110 ) {
V_64 = - V_113 ;
goto V_109;
}
...
F_29 ( V_2 , V_77 ) ;
F_49 ( V_16 ) ;
F_50 ( & V_2 -> V_16 -> V_15 , L_19 ) ;
return 0 ;
V_109:
F_51 ( V_2 -> V_21 ) ;
return V_64 ;
}
static int F_52 ( struct V_104 * V_16 )
{
struct V_1 * V_2 = F_39 ( V_16 ) ;
if ( V_2 -> V_110 ) {
F_53 ( V_2 -> V_110 ) ;
...
static int T_6 F_54 ( struct V_115 * V_116 )
{
struct V_104 * V_16 ;
struct V_1 * V_2 ;
struct V_117 * V_118 ;
...
int V_98 ;
int V_64 = - V_55 ;
V_118 = F_55 ( V_116 , V_120 , 0 ) ;
V_98 = F_56 ( V_116 , 0 ) ;
if ( ! V_118 || V_98 < 0 ) {
F_11 ( & V_116 -> V_15 , L_21 ) ;
goto exit;
}
V_16 = F_57 ( sizeof( * V_2 ) ) ;
if ( ! V_16 )
goto exit;
V_2 = F_39 ( V_16 ) ;
V_2 -> V_5 = F_58 ( V_118 -> V_121 , F_59 ( V_118 ) ) ;
if ( ! V_2 -> V_5 ) {
V_64 = - V_122 ;
F_11 ( & V_116 -> V_15 , L_22 ) ;
goto V_123;
}
V_64 = F_27 ( V_2 , V_124 , V_125 ) ;
if ( V_64 )
goto V_126;
...
goto V_135;
F_63 ( V_116 , V_16 ) ;
if ( F_64 ( V_98 , F_37 , V_136 , L_25 , V_2 ) ) {
F_22 ( & V_116 -> V_15 , L_26 ) ;
goto V_135;
}
F_50 ( & V_116 -> V_15 , L_27 ) ;
goto exit;
V_135:
F_15 ( V_2 -> V_21 ) ;
V_128:
