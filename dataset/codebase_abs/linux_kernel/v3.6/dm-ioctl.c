...
static int F_124 ( struct V_36 T_6 * V_171 , struct V_36 * * V_37 )
{
struct V_36 V_136 , * V_176 ;
int V_177 ;
if ( F_122 ( & V_136 , V_171 , sizeof( V_136 ) - sizeof( V_136 . V_88 ) ) )
return - V_172 ;
if ( V_136 . V_49 < ( sizeof( V_136 ) - sizeof( V_136 . V_88 ) ) )
return - V_44 ;
V_177 = V_136 . V_41 & V_178 ;
V_176 = F_125 ( V_136 . V_49 ) ;
if ( ! V_176 ) {
if ( V_177 && F_126 ( V_171 , V_136 . V_49 ) )
return - V_172 ;
return - V_23 ;
}
if ( F_122 ( V_176 , V_171 , V_136 . V_49 ) )
goto V_25;
if ( V_177 && F_126 ( V_171 , V_136 . V_49 ) )
goto V_25;
* V_37 = V_176 ;
...
V_25:
if ( V_177 )
memset ( V_176 , 0 , V_136 . V_49 ) ;
F_127 ( V_176 ) ;
return - V_172 ;
}
static int F_128 ( T_7 V_152 , struct V_36 * V_37 )
{
V_37 -> V_41 &= ~ V_60 ;
V_37 -> V_41 &= ~ V_47 ;
V_37 -> V_41 &= ~ V_178 ;
...
static int F_129 ( T_7 V_179 , struct V_36 T_6 * V_171 )
{
int V_82 = 0 ;
int V_180 ;
unsigned int V_152 ;
struct V_36 * V_181 ( V_37 ) ;
T_5 V_153 = NULL ;
T_2 V_182 ;
if ( ! F_130 ( V_183 ) )
return - V_184 ;
if ( F_131 ( V_179 ) != V_185 )
return - V_186 ;
V_152 = F_132 ( V_179 ) ;
...
V_187 -> V_41 |= V_188 ;
V_82 = F_124 ( V_171 , & V_37 ) ;
V_187 -> V_41 &= ~ V_188 ;
if ( V_82 )
return V_82 ;
V_182 = V_37 -> V_49 ;
V_180 = V_37 -> V_41 & V_178 ;
V_82 = F_128 ( V_152 , V_37 ) ;
if ( V_82 )
goto V_61;
V_37 -> V_49 = sizeof( * V_37 ) ;
V_82 = V_153 ( V_37 , V_182 ) ;
...
static long F_133 ( struct V_189 * V_189 , T_7 V_179 , T_8 V_190 )
{
return ( long ) F_129 ( V_179 , (struct V_36 T_6 * ) V_190 ) ;
}
static long F_134 ( struct V_189 * V_189 , T_7 V_179 , T_8 V_190 )
{
return ( long ) F_133 ( V_189 , V_179 , ( T_8 ) F_135 ( V_190 ) ) ;
}
int T_9 F_136 ( void )
{
int V_82 ;
