...
static void T_14 * F_182 ( T_15 V_431 , T_15 V_424 )
{
T_15 V_432 = ( ( T_15 ) V_431 ) & V_433 ;
T_15 V_434 = ( ( T_15 ) V_431 ) - V_432 ;
void T_14 * V_435 = F_183 ( V_432 , V_434 + V_424 ) ;
...
F_21 ( & V_8 -> V_50 , V_49 ) ;
while ( ! F_41 ( & V_8 -> V_90 ) ) {
V_10 = F_184 ( V_8 -> V_90 . V_436 , struct V_9 , V_61 ) ;
...
static inline int F_188 ( struct V_1 * V_8 , T_3 V_442 ,
T_3 V_443 )
{
...
struct V_9 * V_10 ;
V_442 = F_191 ( V_443 ) ;
if ( ! F_188 ( V_8 , V_442 , V_443 ) ) {
V_10 = V_8 -> V_356 + V_442 ;
F_157 ( V_10 ) ;
}
}
...
static struct V_1 * F_198 ( T_4 * V_445 )
{
return F_199 ( ( V_445 - * V_445 ) , struct V_1 , V_62 [ 0 ] ) ;
}
static T_16 F_200 ( int V_314 , void * V_445 )
{
struct V_1 * V_8 = F_198 ( V_445 ) ;
T_4 V_62 = * ( T_4 * ) V_445 ;
T_3 V_443 ;
if ( F_197 ( V_8 ) )
return V_446 ;
...
V_8 -> V_447 = F_201 () ;
while ( F_186 ( V_8 ) ) {
V_443 = F_185 ( V_8 , V_62 ) ;
while ( V_443 != V_72 )
V_443 = F_27 ( V_8 , V_62 ) ;
}
return V_448 ;
}
static T_16 F_202 ( int V_314 , void * V_445 )
{
struct V_1 * V_8 = F_198 ( V_445 ) ;
T_3 V_443 ;
T_4 V_62 = * ( T_4 * ) V_445 ;
...
static T_16 F_203 ( int V_314 , void * V_445 )
{
struct V_1 * V_8 = F_198 ( ( T_4 * ) V_445 ) ;
T_3 V_443 ;
T_4 V_62 = * ( T_4 * ) V_445 ;
if ( F_187 ( V_8 ) )
return V_446 ;
...
static T_16 F_204 ( int V_314 , void * V_445 )
{
struct V_1 * V_8 = F_198 ( V_445 ) ;
T_3 V_443 ;
T_4 V_62 = * ( T_4 * ) V_445 ;
...
static T_13 int F_205 ( struct V_192 * V_15 , unsigned char V_449 ,
unsigned char type )
{
struct V_450 {
struct V_451 V_452 ;
...
memset ( & V_154 -> V_452 . V_249 . V_273 , 0 , 8 ) ;
V_154 -> V_84 . V_279 = 16 ;
...
F_210 ( V_458 , V_459 + V_461 ) ;
for ( V_41 = 0 ; V_41 < V_462 ; V_41 ++ ) {
V_332 = F_211 ( V_459 + V_463 ) ;
if ( ( V_332 & ~ F_194 ) == V_458 )
break;
F_98 ( V_464 ) ;
}
F_209 ( V_459 ) ;
...
void * T_14 V_459 , T_3 V_468 )
{
V_199 V_469 ;
int V_470 ;
if ( V_468 ) {
F_52 ( & V_15 -> V_16 , L_148 ) ;
F_210 ( V_468 , V_459 + V_471 ) ;
} else {
V_470 = F_213 ( V_15 , V_472 ) ;
if ( V_470 == 0 ) {
F_51 ( & V_15 -> V_16 ,
L_149
L_150 ) ;
...
static T_13 void F_216 ( char * V_477 , int V_259 )
{
memset ( V_477 , 0 , V_259 ) ;
strncpy ( V_477 , V_17 L_152 V_405 , V_259 - 1 ) ;
}
static T_13 int F_217 (
struct V_478 T_14 * V_479 )
{
char * V_477 ;
int V_41 , V_424 = sizeof( V_479 -> V_477 ) ;
V_477 = F_81 ( V_424 , V_126 ) ;
if ( ! V_477 )
return - V_132 ;
F_216 ( V_477 , V_424 ) ;
for ( V_41 = 0 ; V_41 < V_424 ; V_41 ++ )
F_218 ( V_477 [ V_41 ] , & V_479 -> V_477 [ V_41 ] ) ;
F_59 ( V_477 ) ;
return 0 ;
}
static T_13 void F_219 (
struct V_478 T_14 * V_479 , unsigned char * V_480 )
{
int V_41 ;
for ( V_41 = 0 ; V_41 < sizeof( V_479 -> V_477 ) ; V_41 ++ )
V_480 [ V_41 ] = F_220 ( & V_479 -> V_477 [ V_41 ] ) ;
}
static T_13 int F_221 (
struct V_478 T_14 * V_479 )
{
char * V_480 , * V_481 ;
int V_209 , V_424 = sizeof( V_479 -> V_477 ) ;
V_481 = F_81 ( 2 * V_424 , V_126 ) ;
if ( ! V_481 )
return - V_132 ;
V_480 = V_481 + V_424 ;
F_216 ( V_481 , V_424 ) ;
F_219 ( V_479 , V_480 ) ;
V_209 = ! memcmp ( V_480 , V_481 , V_424 ) ;
F_59 ( V_481 ) ;
return V_209 ;
}
...
F_224 ( V_15 ) ;
F_225 ( V_15 ) ;
V_209 = F_226 ( V_15 , & V_485 ) ;
if ( V_209 )
return V_209 ;
V_459 = F_182 ( V_485 , 0x250 ) ;
if ( ! V_459 )
return - V_132 ;
V_209 = F_227 ( V_15 , V_459 , & V_483 ,
& V_484 , & V_482 ) ;
if ( V_209 )
goto V_488;
V_479 = F_182 ( F_228 ( V_15 ,
...
static void F_232 ( struct V_28 * V_16 , struct V_478 * V_496 )
{
#ifdef F_233
int V_41 ;
char V_497 [ 17 ] ;
...
V_497 [ V_41 ] = F_220 ( & ( V_496 -> V_498 [ V_41 ] ) ) ;
V_497 [ 4 ] = '\0' ;
F_52 ( V_16 , L_167 , V_497 ) ;
F_52 ( V_16 , L_168 , F_211 ( & ( V_496 -> V_499 ) ) ) ;
F_52 ( V_16 , L_169 ,
F_211 ( & ( V_496 -> V_500 ) ) ) ;
F_52 ( V_16 , L_170 ,
F_211 ( & ( V_496 -> V_501 ) ) ) ;
F_52 ( V_16 , L_171 ,
F_211 ( & ( V_496 -> V_502 . V_503 ) ) ) ;
F_52 ( V_16 , L_172 ,
F_211 ( & ( V_496 -> V_502 . V_504 ) ) ) ;
F_52 ( V_16 , L_173 ,
F_211 ( & ( V_496 -> V_502 . V_505 ) ) ) ;
F_52 ( V_16 , L_174 ,
F_211 ( & ( V_496 -> V_506 ) ) ) ;
F_52 ( V_16 , L_175 , F_211 ( & ( V_496 -> V_507 ) ) ) ;
for ( V_41 = 0 ; V_41 < 16 ; V_41 ++ )
V_497 [ V_41 ] = F_220 ( & ( V_496 -> V_508 [ V_41 ] ) ) ;
V_497 [ 16 ] = '\0' ;
...
static int F_234 ( struct V_192 * V_15 , unsigned long V_510 )
{
...
V_513 = F_235 ( V_15 , V_41 ) & V_516 ;
if ( V_513 == V_517 )
V_511 += 4 ;
else {
V_512 = F_235 ( V_15 , V_41 ) &
V_518 ;
switch ( V_512 ) {
case V_519 :
case V_520 :
...
goto V_526;
if ( F_213 ( V_8 -> V_15 , V_527 ) ) {
F_52 ( & V_8 -> V_15 -> V_16 , L_179 ) ;
V_367 = F_238 ( V_8 -> V_15 , V_523 ,
V_524 ) ;
if ( ! V_367 ) {
for ( V_41 = 0 ; V_41 < V_524 ; V_41 ++ )
...
int V_41 ;
for ( V_41 = 0 ; V_41 < V_515 ; V_41 ++ )
if ( F_235 ( V_15 , V_41 ) & V_539 ) {
* V_538 = F_228 ( V_15 , V_41 ) ;
...
void T_14 * V_459 , T_3 * V_483 , T_5 * V_484 ,
T_5 * V_482 )
{
* V_483 = F_211 ( V_459 + V_548 ) ;
* V_482 = F_211 ( V_459 + V_549 ) ;
* V_483 &= ( T_3 ) 0x0000ffff ;
* V_484 = F_234 ( V_15 , * V_483 ) ;
if ( * V_484 == - 1 ) {
F_5 ( & V_15 -> V_16 , L_190 ) ;
return - V_52 ;
}
...
T_3 V_550 ;
int V_209 ;
V_209 = F_227 ( V_8 -> V_15 , V_8 -> V_459 , & V_483 ,
& V_484 , & V_482 ) ;
if ( V_209 )
return V_209 ;
V_8 -> V_479 = F_182 ( F_228 ( V_8 -> V_15 ,
V_484 ) + V_482 , sizeof( * V_8 -> V_479 ) ) ;
if ( ! V_8 -> V_479 )
return - V_132 ;
V_209 = F_217 ( V_8 -> V_479 ) ;
if ( V_209 )
return V_209 ;
V_550 = F_211 ( & V_8 -> V_479 -> V_551 ) ;
V_8 -> V_552 = F_182 ( F_228 ( V_8 -> V_15 ,
V_484 ) + V_482 + V_550 ,
sizeof( * V_8 -> V_552 ) ) ;
if ( ! V_8 -> V_552 )
return - V_132 ;
...
{
V_8 -> V_73 = F_211 ( & ( V_8 -> V_479 -> V_553 ) ) ;
...
V_8 -> V_266 = F_211 ( & ( V_8 -> V_479 -> V_554 ) ) ;
V_8 -> V_139 = 31 ;
if ( V_8 -> V_266 > 512 ) {
V_8 -> V_139 = 32 ;
...
V_8 -> V_346 = F_211 ( & ( V_8 -> V_479 -> V_346 ) ) ;
}
static inline bool F_243 ( struct V_1 * V_8 )
{
if ( ! F_244 ( V_8 -> V_479 -> V_498 , L_194 , 4 ) ) {
...
#ifdef F_246
T_3 V_555 ;
V_555 = F_211 ( & ( V_8 -> V_479 -> V_556 ) ) ;
V_555 |= 0x100 ;
F_210 ( V_555 , & ( V_8 -> V_479 -> V_556 ) ) ;
#endif
}
...
return;
V_557 = F_211 ( V_8 -> V_459 + V_558 ) ;
V_557 |= 0x8000 ;
F_210 ( V_557 , V_8 -> V_459 + V_558 ) ;
}
...
{
T_3 V_562 ;
V_562 = F_211 ( & ( V_8 -> V_479 -> V_500 ) ) ;
if ( ! ( V_562 & V_563 ) )
return - V_299 ;
V_8 -> V_73 = F_211 ( & ( V_8 -> V_479 -> V_506 ) ) ;
F_210 ( V_564 , & ( V_8 -> V_479 -> V_502 . V_503 ) ) ;
F_210 ( V_561 , V_8 -> V_459 + V_471 ) ;
F_248 ( V_8 ) ;
F_232 ( & V_8 -> V_15 -> V_16 , V_8 -> V_479 ) ;
if ( ! ( F_211 ( & ( V_8 -> V_479 -> V_501 ) ) & V_564 ) ) {
F_5 ( & V_8 -> V_15 -> V_16 ,
L_196 ) ;
return - V_52 ;
}
...
F_236 ( V_8 ) ;
V_367 = F_226 ( V_8 -> V_15 , & V_8 -> V_485 ) ;
if ( V_367 )
goto V_570;
V_8 -> V_459 = F_182 ( V_8 -> V_485 , 0x250 ) ;
if ( ! V_8 -> V_459 ) {
V_367 = - V_132 ;
goto V_570;
}
V_367 = F_231 ( V_8 -> V_15 , V_8 -> V_459 , V_495 ) ;
if ( V_367 )
goto V_570;
V_367 = F_240 ( V_8 ) ;
if ( V_367 )
...
if ( F_231 ( V_8 -> V_15 , V_8 -> V_459 , V_494 ) ) {
F_5 ( & V_8 -> V_15 -> V_16 , L_207 ) ;
return - 1 ;
}
F_52 ( & V_8 -> V_15 -> V_16 , L_208 ) ;
if ( F_231 ( V_8 -> V_15 , V_8 -> V_459 , V_495 ) ) {
...
F_275 ( & V_8 -> V_50 ) ;
while ( ! F_41 ( V_61 ) ) {
V_10 = F_184 ( V_61 -> V_436 , struct V_9 , V_61 ) ;
V_10 -> V_11 -> V_23 = V_183 ;
F_157 ( V_10 ) ;
}
}
...
F_21 ( & V_8 -> V_50 , V_49 ) ;
V_8 -> V_202 = F_211 ( V_8 -> V_459 + V_545 ) ;
F_22 ( & V_8 -> V_50 , V_49 ) ;
...
V_8 = F_184 ( V_590 , struct V_1 , V_582 ) ;
F_279 ( V_8 ) ;
}
F_22 ( & V_580 , V_49 ) ;
}
...
F_102 ( V_10 , V_427 , V_8 , V_606 , 4 , 0 ,
V_92 , V_212 ) ;
F_97 ( V_8 , V_10 , V_145 ) ;
if ( V_10 -> V_11 -> V_23 != 0 )
F_5 ( & V_8 -> V_15 -> V_16 ,
...
static void F_304 ( int V_608 [] , int V_609 ,
int V_610 , int * V_611 )
{
int V_41 , V_113 , V_612 , V_424 ;
#define F_305 4
#define F_306 8
...
int V_41 ;
unsigned long V_614 ;
int V_615 [ 8 ] = { 5 , 6 , 8 , 10 , 12 , 20 , 28 , V_420 + 4 } ;
F_294 ( 28 > V_420 + 4 ) ;
memset ( V_8 -> V_64 , 0 , V_8 -> V_578 ) ;
V_615 [ 7 ] = V_420 + 4 ;
F_304 ( V_615 , F_14 ( V_615 ) ,
V_420 , V_8 -> V_75 ) ;
for ( V_41 = 0 ; V_41 < 8 ; V_41 ++ )
F_210 ( V_615 [ V_41 ] , & V_8 -> V_552 -> V_616 [ V_41 ] ) ;
F_210 ( V_8 -> V_73 , & V_8 -> V_552 -> V_617 ) ;
F_210 ( V_8 -> V_80 , & V_8 -> V_552 -> V_618 ) ;
F_210 ( 0 , & V_8 -> V_552 -> V_619 ) ;
F_210 ( 0 , & V_8 -> V_552 -> V_620 ) ;
for ( V_41 = 0 ; V_41 < V_8 -> V_80 ; V_41 ++ ) {
F_210 ( 0 , & V_8 -> V_552 -> V_621 [ V_41 ] . V_148 ) ;
F_210 ( V_8 -> V_579 +
...
V_8 -> V_64 = F_161 ( V_8 -> V_15 , V_8 -> V_578 ,
& ( V_8 -> V_579 ) ) ;
for ( V_41 = 0 ; V_41 < V_8 -> V_80 ; V_41 ++ ) {
