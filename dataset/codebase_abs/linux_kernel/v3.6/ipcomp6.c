...
type != V_20 )
return;
V_10 = F_3 ( F_4 ( V_15 -> V_21 ) ) ;
V_17 = F_5 ( V_8 , V_2 -> V_22 , ( const V_23 * ) & V_12 -> V_24 ,
V_10 , V_25 , V_26 ) ;
if ( ! V_17 )
return;
if ( type == V_20 )
...
goto V_28;
V_27 -> V_29 . V_30 = V_31 ;
V_27 -> V_29 . V_10 = F_12 ( V_8 , ( V_23 * ) & V_17 -> V_32 . V_33 ) ;
if ( ! V_27 -> V_29 . V_10 )
goto error;
memcpy ( V_27 -> V_29 . V_24 . V_34 , V_17 -> V_29 . V_24 . V_34 , sizeof( struct V_35 ) ) ;
...
memcpy ( & V_27 -> V_22 , & V_17 -> V_22 , sizeof( V_27 -> V_22 ) ) ;
if ( F_13 ( V_27 ) )
goto error;
F_14 ( & V_27 -> V_39 , 1 ) ;
V_28:
...
struct V_16 * V_27 = NULL ;
T_2 V_10 ;
T_3 V_22 = V_17 -> V_22 . V_44 & V_17 -> V_22 . V_45 ;
V_10 = F_16 ( V_8 , ( V_23 * ) & V_17 -> V_32 . V_33 ) ;
if ( V_10 )
V_27 = F_5 ( V_8 , V_22 , ( V_23 * ) & V_17 -> V_29 . V_24 ,
V_10 , V_31 , V_26 ) ;
if ( ! V_27 ) {
V_27 = F_9 ( V_17 ) ;
if ( ! V_27 ) {
