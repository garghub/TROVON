...
V_92 = V_52 -> V_93 ;
V_52 -> V_93 &= V_94 | V_59 ;
if ( ! V_52 -> V_93 || V_92 != V_52 -> V_93 )
V_91 ++ ;
V_92 = V_52 -> V_81 ;
V_52 -> V_81 &= V_59 | V_82 ;
if ( ! V_52 -> V_81 || V_92 != V_52 -> V_81 )
V_91 ++ ;
V_92 = V_52 -> V_95 ;
V_52 -> V_95 &= V_96 ;
if ( ! V_52 -> V_95 || V_92 != V_52 -> V_95 )
V_91 ++ ;
V_92 = V_52 -> V_97 ;
V_52 -> V_97 &= V_98 ;
if ( ! V_52 -> V_97 || V_92 != V_52 -> V_97 )
V_91 ++ ;
V_92 = V_52 -> V_58 ;
V_52 -> V_58 &= V_98 | V_59 | V_99 ;
if ( ! V_52 -> V_58 || V_92 != V_52 -> V_58 )
V_91 ++ ;
if ( V_91 )
return 1 ;
if ( ( V_52 -> V_93 & ( V_52 -> V_93 - 1 ) ) != 0 )
V_91 ++ ;
if ( ( V_52 -> V_81 & ( V_52 -> V_81 - 1 ) ) != 0 )
V_91 ++ ;
if ( ( V_52 -> V_95 & ( V_52 -> V_95 - 1 ) ) != 0 )
V_91 ++ ;
if ( ( V_52 -> V_97 & ( V_52 -> V_97 - 1 ) ) != 0 )
V_91 ++ ;
if ( ( V_52 -> V_58 & ( V_52 -> V_58 - 1 ) ) != 0 )
V_91 ++ ;
V_92 = 0 ;
if ( V_52 -> V_93 & V_59 )
V_92 ++ ;
...
if ( V_52 -> V_107 != V_52 -> V_66 ) {
V_52 -> V_107 = V_52 -> V_66 ;
V_91 ++ ;
}
switch ( V_52 -> V_58 ) {
case V_98 :
...
static int F_27 ( struct V_1 * V_2 , struct V_25 * V_26 )
{
struct V_8 * V_9 = V_2 -> V_10 ;
struct V_51 * V_52 = & V_26 -> V_53 -> V_52 ;
int V_4 ;
...
F_15 ( F_29 ( 2 , V_133 ) ,
V_9 -> V_42 + V_134 ) ;
F_30 ( V_9 -> V_42 + V_135 , 0 ,
2 , V_109 , 2 ) ;
F_15 ( F_29 ( 0 , V_136 ) ,
V_9 -> V_42 + V_134 ) ;
}
F_30 ( V_9 -> V_42 + V_135 , 0 , 0 , V_110 , 2 ) ;
}
switch ( V_52 -> V_58 ) {
case V_98 :
V_9 -> V_54 = 0 ;
...
static void
F_32 ( struct V_1 * V_2 , struct V_25 * V_26 ,
...
static T_1 F_33 ( int V_145 , void * V_146 )
{
...
* F_36 ( struct V_152 * V_152 )
{
int V_29 ;
for ( V_29 = 0 ; V_29 < F_37 ( V_153 ) ; V_29 ++ )
if ( V_152 -> V_154 == V_153 [ V_29 ] . V_155 )
return & V_153 [ V_29 ] ;
return NULL ;
}
static struct V_152 * F_38 ( struct V_1 * V_2 ,
struct V_156 * V_157 )
{
const struct V_6 * V_7 = F_2 ( V_2 ) ;
...
static void F_41 ( struct V_1 * V_2 , unsigned int V_145 )
{
struct V_152 * V_168 = F_42 ( V_2 ) ;
char V_169 [ 30 ] ;
if ( V_145 )
...
F_48 ( & V_9 -> V_40 ) ;
V_9 -> V_42 = F_49 ( V_152 , 2 ) ;
V_2 -> V_13 = F_49 ( V_152 , 3 ) ;
V_145 = V_152 -> V_145 ;
V_9 -> V_12 = F_50 ( sizeof( V_9 -> V_12 [ 0 ] ) *
V_7 -> V_172 , V_173 ) ;
if ( ! V_9 -> V_12 )
return - V_174 ;
V_9 -> V_77 = F_50 ( sizeof( V_9 -> V_77 [ 0 ] ) *
V_7 -> V_172 , V_173 ) ;
if ( ! V_9 -> V_77 )
return - V_174 ;
V_9 -> V_78 = F_50 ( sizeof( V_9 -> V_78 [ 0 ] ) *
V_7 -> V_172 , V_173 ) ;
if ( ! V_9 -> V_78 )
return - V_174 ;
V_9 -> V_41 = 0 ;
...
V_26 -> V_195 = V_195 =
F_50 ( sizeof( struct V_194 * ) * V_26 -> V_183 ,
V_173 ) ;
if ( ! V_26 -> V_195 )
return - V_174 ;
if ( V_159 ) {
...
static int F_54 ( struct V_1 * V_2 , struct V_156 * V_157 )
{
struct V_152 * V_152 ;
int V_171 ;
F_43 ( V_2 -> V_76 , V_124 L_18 ) ;
V_171 = F_55 ( V_2 , sizeof( struct V_8 ) ) ;
if ( V_171 < 0 ) {
F_22 ( V_2 -> V_76 , L_19 ) ;
return V_171 ;
}
V_152 = F_38 ( V_2 , V_157 ) ;
if ( ! V_152 )
return - V_209 ;
return F_45 ( V_2 , V_152 , V_157 -> V_159 ) ;
}
static int T_2
F_56 ( struct V_1 * V_2 , struct V_152 * V_152 )
{
int V_171 ;
F_43 ( V_2 -> V_76 , V_124 L_20 ,
F_44 ( V_152 ) ) ;
V_171 = F_55 ( V_2 , sizeof( struct V_8 ) ) ;
if ( V_171 < 0 ) {
F_22 ( V_2 -> V_76 , L_19 ) ;
...
static int T_2 F_63 ( struct V_152 * V_2 ,
const struct V_210
* V_211 )
{
return F_64 ( V_2 , & V_212 ) ;
}
static void T_3 F_65 ( struct V_152 * V_2 )
{
F_66 ( V_2 ) ;
}
