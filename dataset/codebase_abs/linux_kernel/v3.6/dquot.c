...
int F_70 ( struct V_1 * V_2 , int type )
{
struct V_82 * V_83 ;
struct V_27 * V_27 ;
...
F_75 ( & V_59 -> V_92 [ V_54 ] -> V_94 , 0 ) ;
F_33 ( & V_59 -> V_92 [ V_54 ] -> V_93 ) ;
}
F_33 ( & V_59 -> V_79 ) ;
return 0 ;
}
static void F_76 ( int V_95 )
{
struct V_82 * V_29 ;
struct V_27 * V_27 ;
V_29 = V_39 . V_96 ;
...
static int F_95 ( struct V_116 * V_116 , int type )
{
int V_54 ;
if ( F_96 ( V_116 ) )
return 0 ;
...
static void F_105 ( struct V_82 * V_127 )
{
struct V_82 * V_129 ;
struct V_27 * V_27 ;
V_129 = V_127 -> V_130 ;
while ( V_129 != V_127 ) {
V_27 = F_77 ( V_129 , struct V_27 , V_38 ) ;
V_129 = V_129 -> V_130 ;
F_26 ( & V_27 -> V_38 ) ;
F_43 ( V_27 ) ;
}
...
F_106 ( V_2 , type , & V_127 ) ;
F_110 ( & F_40 ( V_2 ) -> V_132 ) ;
F_105 ( & V_127 ) ;
}
}
...
static inline void F_113 ( struct V_27 * V_27 , T_2 V_133 )
{
V_27 -> V_134 . V_137 += V_133 ;
}
static void F_114 ( struct V_27 * V_27 , T_2 V_133 )
{
...
static inline
void F_116 ( struct V_27 * V_27 , T_2 V_133 )
{
if ( V_27 -> V_134 . V_137 >= V_133 )
V_27 -> V_134 . V_137 -= V_133 ;
else {
...
static void F_118 ( struct V_27 * V_27 , T_2 V_133 )
{
if ( F_40 ( V_27 -> V_31 ) -> V_87 & V_138 ||
V_27 -> V_134 . V_136 >= V_133 )
V_27 -> V_134 . V_136 -= V_133 ;
...
static int F_119 ( struct V_27 * V_27 , const int V_146 )
{
...
static int F_120 ( struct V_152 * V_153 )
{
if ( ! V_154 )
return 0 ;
switch ( V_153 -> V_155 ) {
...
case V_158 :
return F_122 ( V_153 -> V_157 ) ;
}
return 0 ;
}
static void F_123 ( struct V_152 * V_153 )
{
char * V_159 = NULL ;
struct V_160 * V_161 ;
...
V_146 == V_164 ||
V_146 == V_165 ||
V_146 == V_166 || ! F_120 ( V_153 ) )
return;
V_161 = F_124 () ;
if ( ! V_161 )
return;
F_125 ( V_161 , V_153 -> V_167 -> V_9 ) ;
if ( V_146 == V_168 || V_146 == V_169 )
F_125 ( V_161 , L_13 ) ;
else
F_125 ( V_161 , L_14 ) ;
F_125 ( V_161 , V_106 [ V_153 -> V_155 ] ) ;
switch ( V_146 ) {
case V_150 :
V_159 = L_15 ;
break;
...
static void F_127 ( struct V_152 * V_153 , struct V_27 * V_27 ,
int V_146 )
{
if ( F_119 ( V_27 , V_146 ) )
return;
...
F_123 ( & V_153 [ V_170 ] ) ;
#endif
F_130 ( V_153 [ V_170 ] . V_155 , V_153 [ V_170 ] . V_157 ,
...
static int F_133 ( struct V_27 * V_27 , T_2 V_178 ,
struct V_152 * V_153 )
{
...
! F_131 ( V_27 ) ) {
F_127 ( V_153 , V_27 , V_150 ) ;
return - V_182 ;
}
if ( V_27 -> V_134 . V_139 &&
V_179 > V_27 -> V_134 . V_139 &&
V_27 -> V_134 . V_140 &&
F_135 () >= V_27 -> V_134 . V_140 &&
! F_131 ( V_27 ) ) {
F_127 ( V_153 , V_27 , V_151 ) ;
return - V_182 ;
}
if ( V_27 -> V_134 . V_139 &&
V_179 > V_27 -> V_134 . V_139 &&
V_27 -> V_134 . V_140 == 0 ) {
F_127 ( V_153 , V_27 , V_168 ) ;
V_27 -> V_134 . V_140 = F_135 () +
F_40 ( V_27 -> V_31 ) -> V_51 [ V_27 -> V_33 ] . V_183 ;
}
return 0 ;
}
static int F_136 ( struct V_27 * V_27 , T_2 V_184 , int V_185 ,
struct V_152 * V_153 )
{
T_2 V_186 ;
...
! F_131 ( V_27 ) ) {
if ( ! V_185 )
F_127 ( V_153 , V_27 , V_148 ) ;
return - V_182 ;
}
if ( V_27 -> V_134 . V_143 &&
V_186 > V_27 -> V_134 . V_143 &&
V_27 -> V_134 . V_144 &&
F_135 () >= V_27 -> V_134 . V_144 &&
! F_131 ( V_27 ) ) {
if ( ! V_185 )
F_127 ( V_153 , V_27 , V_149 ) ;
return - V_182 ;
}
if ( V_27 -> V_134 . V_143 &&
V_186 > V_27 -> V_134 . V_143 &&
V_27 -> V_134 . V_144 == 0 ) {
if ( ! V_185 ) {
F_127 ( V_153 , V_27 , V_169 ) ;
V_27 -> V_134 . V_144 = F_135 () +
...
static int F_137 ( struct V_27 * V_27 , T_2 V_178 )
{
T_2 V_179 ;
...
static int F_138 ( struct V_27 * V_27 , T_2 V_184 )
{
if ( F_35 ( V_180 , & V_27 -> V_46 ) ||
...
static int F_139 ( const struct V_116 * V_116 )
{
...
static void F_102 ( struct V_116 * V_116 , int type )
{
unsigned int V_15 = 0 ;
int V_54 ;
...
void F_142 ( struct V_116 * V_116 )
{
F_102 ( V_116 , - 1 ) ;
}
static void F_143 ( struct V_116 * V_116 )
{
int V_54 ;
...
F_110 ( & F_40 ( V_116 -> V_128 ) -> V_132 ) ;
F_42 ( V_194 ) ;
}
void F_144 ( struct V_116 * V_116 )
{
int V_54 ;
if ( F_96 ( V_116 ) )
return;
...
static T_2 * F_145 ( struct V_116 * V_116 )
{
F_85 ( ! V_116 -> V_128 -> V_47 -> V_195 ) ;
...
void F_147 ( struct V_116 * V_116 , T_2 V_133 )
{
F_5 ( & V_116 -> V_121 ) ;
* F_145 ( V_116 ) -= V_133 ;
F_148 ( V_116 , V_133 ) ;
...
void F_149 ( struct V_116 * V_116 , T_2 V_133 )
{
F_5 ( & V_116 -> V_121 ) ;
* F_145 ( V_116 ) -= V_133 ;
F_6 ( & V_116 -> V_121 ) ;
}
static T_2 F_100 ( struct V_116 * V_116 )
{
T_2 V_49 ;
...
static void F_150 ( struct V_116 * V_116 , T_2 V_133 ,
int V_196 )
{
if ( V_196 )
F_146 ( V_116 , V_133 ) ;
...
static void F_152 ( struct V_116 * V_116 , T_2 V_133 , int V_196 )
{
if ( V_196 )
F_149 ( V_116 , V_133 ) ;
else
...
int F_154 ( struct V_116 * V_116 , T_2 V_133 , int V_87 )
{
int V_54 , V_49 = 0 ;
...
F_41 ( V_197 ) ;
V_202:
F_156 ( & F_40 ( V_116 -> V_128 ) -> V_132 ) ;
F_128 ( V_153 ) ;
V_81:
return V_49 ;
}
int F_157 ( const struct V_116 * V_116 )
{
int V_54 , V_49 = 0 ;
struct V_152 V_153 [ V_24 ] ;
...
if ( ! V_197 [ V_54 ] )
continue;
V_49 = F_133 ( V_197 [ V_54 ] , 1 , & V_153 [ V_54 ] ) ;
if ( V_49 )
goto V_203;
}
for ( V_54 = 0 ; V_54 < V_24 ; V_54 ++ ) {
...
int F_158 ( struct V_116 * V_116 , T_2 V_133 )
{
int V_54 ;
if ( ! F_139 ( V_116 ) ) {
F_147 ( V_116 , V_133 ) ;
...
void F_159 ( struct V_116 * V_116 , T_2 V_133 , int V_87 )
{
unsigned int V_54 ;
struct V_152 V_153 [ V_24 ] ;
struct V_27 * * V_197 = V_116 -> V_117 ;
...
if ( ! V_197 [ V_54 ] )
continue;
V_204 = F_138 ( V_197 [ V_54 ] , V_133 ) ;
if ( V_204 != V_171 )
F_127 ( & V_153 [ V_54 ] , V_197 [ V_54 ] , V_204 ) ;
if ( V_196 )
F_116 ( V_197 [ V_54 ] , V_133 ) ;
else
F_118 ( V_197 [ V_54 ] , V_133 ) ;
}
F_152 ( V_116 , V_133 , V_196 ) ;
F_6 ( & V_199 ) ;
if ( V_196 )
...
void F_160 ( const struct V_116 * V_116 )
{
unsigned int V_54 ;
struct V_152 V_153 [ V_24 ] ;
struct V_27 * const * V_197 = V_116 -> V_117 ;
...
int F_161 ( struct V_116 * V_116 , struct V_27 * * V_206 )
{
T_2 V_184 , V_207 ;
T_2 V_208 = 0 ;
...
V_49 = F_133 ( V_206 [ V_54 ] , 1 , & V_211 [ V_54 ] ) ;
if ( V_49 )
goto V_214;
V_49 = F_136 ( V_206 [ V_54 ] , V_184 , 0 , & V_211 [ V_54 ] ) ;
if ( V_49 )
goto V_214;
}
for ( V_54 = 0 ; V_54 < V_24 ; V_54 ++ ) {
...
if ( V_209 [ V_54 ] ) {
int V_204 ;
V_204 = F_137 ( V_209 [ V_54 ] , 1 ) ;
if ( V_204 != V_171 )
F_127 ( & V_212 [ V_54 ] ,
V_209 [ V_54 ] , V_204 ) ;
V_204 = F_138 ( V_209 [ V_54 ] , V_184 ) ;
if ( V_204 != V_171 )
F_127 ( & V_213 [ V_54 ] ,
V_209 [ V_54 ] , V_204 ) ;
F_117 ( V_209 [ V_54 ] , 1 ) ;
F_118 ( V_209 [ V_54 ] , V_207 ) ;
F_116 ( V_209 [ V_54 ] ,
V_208 ) ;
}
F_111 ( V_206 [ V_54 ] , 1 ) ;
F_112 ( V_206 [ V_54 ] , V_207 ) ;
F_113 ( V_206 [ V_54 ] , V_208 ) ;
...
int F_163 ( struct V_116 * V_116 , struct V_215 * V_215 )
{
...
V_206 [ V_156 ] = F_94 ( V_2 , V_215 -> V_218 , V_156 ) ;
if ( V_215 -> V_216 & V_219 && V_215 -> V_220 != V_116 -> V_192 )
V_206 [ V_158 ] = F_94 ( V_2 , V_215 -> V_220 , V_158 ) ;
V_49 = F_161 ( V_116 , V_206 ) ;
F_42 ( V_206 ) ;
return V_49 ;
}
...
int F_165 ( struct V_116 * V_116 , struct V_221 * V_221 )
{
int error ;
error = F_166 ( V_116 , V_221 ) ;
...
static int F_174 ( struct V_116 * V_116 , int type , int V_237 ,
unsigned int V_87 )
{
...
V_59 -> V_92 [ V_54 ] = NULL ;
F_5 ( & V_113 ) ;
V_87 = V_59 -> V_87 & F_169 ( V_225 |
V_226 ,
V_54 ) ;
V_59 -> V_87 &= ~ F_169 ( V_252 , V_54 ) ;
F_6 ( & V_113 ) ;
F_33 ( & V_59 -> V_79 ) ;
V_87 = F_181 ( V_87 , V_54 ) ;
V_49 = F_174 ( V_116 , V_54 ,
V_59 -> V_51 [ V_54 ] . V_250 , V_87 ) ;
F_101 ( V_116 ) ;
}
return V_49 ;
}
int F_182 ( struct V_1 * V_2 , int type , int V_237 ,
struct V_253 * V_253 )
{
int error = F_183 ( V_253 -> V_254 ) ;
if ( error )
return error ;
if ( V_253 -> V_254 -> V_255 != V_2 )
error = - V_256 ;
else
error = F_174 ( V_253 -> V_254 -> V_257 , type ,
V_237 , V_225 |
V_226 ) ;
return error ;
}
int F_184 ( struct V_116 * V_116 , int type , int V_237 ,
unsigned int V_87 )
{
int V_49 = 0 ;
struct V_1 * V_2 = V_116 -> V_128 ;
...
V_258:
return F_174 ( V_116 , type , V_237 , V_87 ) ;
}
int F_186 ( struct V_1 * V_2 , char * V_259 ,
int V_237 , int type )
{
struct V_254 * V_254 ;
int error ;
F_32 ( & V_2 -> V_260 -> V_257 -> V_93 ) ;
V_254 = F_187 ( V_259 , V_2 -> V_260 , strlen ( V_259 ) ) ;
...
error = F_183 ( V_254 ) ;
if ( ! error )
error = F_174 ( V_254 -> V_257 , type , V_237 ,
V_225 | V_226 ) ;
V_81:
F_190 ( V_254 ) ;
return error ;
}
static inline T_2 F_191 ( T_2 V_262 )
{
return V_262 << V_263 ;
}
static inline T_2 F_192 ( T_2 V_184 )
{
return ( V_184 + V_264 - 1 ) >> V_263 ;
}
static void F_193 ( struct V_27 * V_27 , struct V_265 * V_266 )
{
...
F_5 ( & V_199 ) ;
V_266 -> V_275 = F_192 ( V_268 -> V_187 ) ;
V_266 -> V_276 = F_192 ( V_268 -> V_143 ) ;
...
static int F_195 ( struct V_27 * V_27 , struct V_265 * V_266 )
{
struct V_267 * V_268 = & V_27 -> V_134 ;
int V_283 = 0 , V_284 = 0 ;
...
if ( V_266 -> V_286 & V_288 )
V_268 -> V_143 = F_191 ( V_266 -> V_276 ) ;
if ( V_266 -> V_286 & V_290 )
V_268 -> V_187 = F_191 ( V_266 -> V_275 ) ;
...
int F_198 ( struct V_1 * V_2 , int type , struct V_307 * V_308 )
{
struct V_173 * V_309 ;
int V_53 = 0 ;
F_32 ( & F_40 ( V_2 ) -> V_79 ) ;
...
static int F_199 ( struct V_317 * V_318 , int V_319 ,
void T_4 * V_320 , T_5 * V_321 , T_6 * V_322 )
{
unsigned int type = ( int * ) V_318 -> V_323 - V_103 . V_324 ;
V_103 . V_324 [ type ] =
F_200 ( & V_103 . V_104 [ type ] ) ;
return F_201 ( V_318 , V_319 , V_320 , V_321 , V_322 ) ;
}
...
NULL ) ;
V_326 = 0 ;
V_30 = (struct V_28 * ) F_205 ( V_334 , V_326 ) ;
if ( ! V_30 )
F_206 ( L_23 ) ;
for ( V_170 = 0 ; V_170 < V_335 ; V_170 ++ ) {
V_49 = F_207 ( & V_103 . V_104 [ V_170 ] , 0 ) ;
if ( V_49 )
F_206 ( L_24 ) ;
}
