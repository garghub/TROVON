...
if ( V_20 )
return V_20 ;
if ( V_2 -> V_6 . V_21 . V_22 . V_12 == V_13 ) {
V_20 = F_9 ( V_5 ) ;
if ( V_20 )
return V_20 ;
F_10 ( V_5 ) ;
...
F_28 ( & V_30 -> V_47 , V_30 -> V_6 -> V_54 -> V_55 , 1 , V_31 ) ;
if ( V_46 ) {
memset ( V_31 + V_56 , 0 , 32 ) ;
memcpy ( V_31 + V_56 , V_30 -> V_57 , V_30 -> V_6 -> V_58 ) ;
}
V_51 = 0 ;
if ( V_30 -> V_14 & V_59 )
V_51 = F_20 ( V_30 , V_31 ) ;
V_49 = V_50 | ( V_30 -> V_6 -> V_54 -> V_55 << 12 ) ;
if ( V_30 -> V_47 . V_14 & V_60 )
V_49 |= V_61 ;
if ( V_46 )
V_49 |= V_62 | V_63 ;
...
{
struct V_44 * V_45 = V_30 -> V_43 -> V_9 ;
T_6 * V_64 = V_45 -> V_64 ;
if ( V_45 -> V_65 )
V_64 += V_30 -> V_6 -> V_54 -> V_55 * V_66 ;
...
{
struct V_7 * V_8 = V_43 -> V_5 -> V_9 ;
struct V_75 * V_6 = V_43 -> V_5 -> V_6 ;
struct V_44 * V_45 ;
void * V_76 ;
T_5 V_77 ;
T_7 V_78 , V_79 ;
V_45 = F_33 ( V_6 , sizeof( * V_45 ) , V_80 ) ;
if ( ! V_45 )
return - V_81 ;
if ( ( V_8 -> V_82 & V_83 ) && F_34 ( V_43 ) ) {
void T_2 * V_84 = F_35 ( V_43 ) ;
T_3 V_85 = F_4 ( V_84 + V_86 ) ;
if ( V_85 & V_87 )
V_45 -> V_88 = true ;
else if ( V_8 -> V_14 & V_89 ) {
F_36 ( V_6 , L_10 ,
V_43 -> V_90 ) ;
V_45 -> V_88 = true ;
} else
...
if ( V_20 )
return V_20 ;
V_8 = F_33 ( V_6 , sizeof( * V_8 ) , V_80 ) ;
if ( ! V_8 )
return - V_81 ;
V_8 -> V_14 |= ( unsigned long ) V_105 . V_9 ;
if ( ! ( V_8 -> V_14 & V_116 ) )
F_46 ( V_2 ) ;
V_8 -> V_10 = F_47 ( V_2 ) [ V_113 ] ;
F_48 ( & V_2 -> V_6 , V_8 , 0 , 0 ) ;
if ( V_8 -> V_82 & V_117 )
V_105 . V_14 |= V_118 ;
if ( V_8 -> V_82 & V_119 )
V_105 . V_14 |= V_120 ;
F_49 ( V_8 , & V_105 ) ;
V_108 = F_50 ( F_51 ( V_8 -> V_82 ) , F_52 ( V_8 -> V_121 ) ) ;
V_5 = F_53 ( & V_2 -> V_6 , V_107 , V_108 ) ;
if ( ! V_5 )
return - V_81 ;
V_5 -> V_9 = V_8 ;
if ( ! ( V_8 -> V_82 & V_122 ) || V_123 )
V_5 -> V_14 |= V_124 ;
else
F_54 ( V_125 L_12 ) ;
...
if ( ! ( V_8 -> V_121 & ( 1 << V_109 ) ) )
V_43 -> V_127 = & V_128 ;
}
V_20 = F_12 ( V_2 , V_8 -> V_82 & V_129 ) ;
if ( V_20 )
return V_20 ;
V_20 = F_9 ( V_5 ) ;
if ( V_20 )
