...
static int F_69 ( struct V_170 * V_39 ,
int (* F_70)( struct V_128 * ) )
{
...
static int F_76 ( struct V_170 * V_39 )
{
struct V_24 * V_25 = V_3 ;
if ( ! V_25 )
return - V_125 ;
...
F_78 () ;
if ( ! F_62 ( V_25 -> V_141 ) )
( void ) F_73 ( V_25 -> V_141 -> V_177 , NULL ) ;
V_39 -> V_178 ( & V_25 -> V_40 ) ;
V_25 -> V_40 . V_25 . V_39 = NULL ;
V_25 -> V_39 = NULL ;
F_72 ( & V_25 -> V_40 . V_25 ) ;
...
static void F_83 ( unsigned long V_182 )
{
...
F_86 ( V_193 . V_190 . V_201 ) ,
F_86 ( V_193 . V_190 . V_202 ) ,
F_86 ( V_193 . V_190 . V_203 ) ) ;
...
static void F_91 ( struct V_225 * V_25 )
{
F_13 ( L_93 , V_31 , F_92 ( V_25 ) ) ;
}
static int T_6 F_93 ( struct V_226 * V_227 )
{
...
if ( V_181 < 0 )
return - V_125 ;
V_25 -> V_139 = F_97 ( & V_227 -> V_25 , NULL ) ;
if ( F_98 ( V_25 -> V_139 ) ) {
V_171 = F_99 ( V_25 -> V_139 ) ;
goto V_249;
}
F_100 ( L_96 , V_232 , V_181 ,
V_25 -> V_106 ? L_11 : L_97 ,
V_250 L_38
) ;
V_25 -> V_25 = & V_227 -> V_25 ;
V_25 -> V_2 = V_227 -> V_25 . V_251 ;
V_25 -> V_141 = F_101 ( V_252 ) ;
if ( F_2 ( V_25 -> V_2 -> V_6 ) ) {
if ( ( V_171 = F_102 ( V_25 -> V_2 -> V_6 ,
L_98 ) ) ) {
F_103 ( & V_227 -> V_25 ,
L_99 ,
V_25 -> V_2 -> V_6 , V_171 ) ;
...
F_104 ( V_25 -> V_2 -> V_6 , 0 ) ;
}
F_105 ( & V_25 -> V_180 ) ;
V_25 -> V_180 . V_254 = F_83 ;
V_25 -> V_180 . V_255 = ( unsigned long ) V_25 ;
F_106 ( & V_25 -> V_40 . V_25 ) ;
V_25 -> V_40 . V_25 . V_256 = & V_227 -> V_25 ;
V_25 -> V_40 . V_25 . V_257 = V_227 -> V_25 . V_257 ;
V_3 = V_25 ;
F_107 ( V_227 , V_25 ) ;
F_57 ( V_25 ) ;
F_68 ( V_25 ) ;
V_25 -> V_136 = 0 ;
V_171 = F_108 ( V_181 , F_89 ,
0 , V_232 , V_25 ) ;
if ( V_171 != 0 ) {
F_94 ( L_100 ,
V_232 , V_181 , V_171 ) ;
...
#endif
F_111 ( V_25 ) ;
V_171 = F_112 ( & V_227 -> V_25 , & V_25 -> V_40 ) ;
if ( ! V_171 )
return V_171 ;
F_113 ( V_25 ) ;
#ifdef F_109
...
static void F_118 ( struct V_226 * V_182 )
{
F_1 () ;
}
static int T_7 F_119 ( struct V_226 * V_227 )
{
struct V_24 * V_25 = F_120 ( V_227 ) ;
F_121 ( & V_25 -> V_40 ) ;
if ( V_25 -> V_39 )
return - V_175 ;
V_25 -> F_53 = 0 ;
...
static int F_122 ( struct V_226 * V_25 , T_8 V_262 )
{
...
static int F_123 ( struct V_226 * V_25 )
{
struct V_24 * V_134 = F_120 ( V_25 ) ;
unsigned long V_48 ;
V_134 -> V_137 = 0 ;
...
{
F_125 ( L_103 , V_232 , V_263 ) ;
return F_126 ( & V_264 , F_93 ) ;
}
