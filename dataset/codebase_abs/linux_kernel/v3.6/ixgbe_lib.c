...
F_35 ( V_105 , & V_77 -> V_106 ) ;
#ifdef F_2
if ( V_2 -> V_12 -> V_107 & V_108 ) {
struct V_3 * V_54 ;
V_54 = & V_2 -> V_5 [ V_6 ] ;
if ( ( V_87 >= V_54 -> V_15 ) &&
( V_87 < V_54 -> V_15 + V_54 -> V_22 ) )
F_35 ( V_109 , & V_77 -> V_106 ) ;
}
#endif
V_77 -> V_81 = V_2 -> V_110 ;
V_77 -> V_104 = V_87 ;
...
V_2 -> V_20 [ V_77 -> V_104 ] = NULL ;
F_37 (ring, q_vector->rx)
V_2 -> V_18 [ V_77 -> V_104 ] = NULL ;
V_2 -> V_89 [ V_83 ] = NULL ;
F_38 ( & V_89 -> V_99 ) ;
F_39 ( V_89 , V_111 ) ;
}
...
for (; V_83 < V_112 ; V_83 ++ ) {
int V_116 = F_41 ( V_113 , V_112 - V_83 ) ;
int V_117 = F_41 ( V_114 , V_112 - V_83 ) ;
V_67 = F_27 ( V_2 , V_112 , V_83 ,
V_117 , V_85 ,
V_116 , V_87 ) ;
if ( V_67 )
...
{
struct V_30 * V_31 = & V_2 -> V_31 ;
int V_119 , V_120 , V_67 ;
V_120 = F_47 ( V_2 -> V_17 , V_2 -> V_19 ) ;
V_120 = F_13 ( int , V_120 , F_14 () ) ;
V_120 += V_73 ;
V_120 = F_13 ( int , V_120 , V_31 -> V_33 . V_121 ) ;
V_2 -> V_71 = F_48 ( V_120 ,
sizeof( struct V_122 ) , V_94 ) ;
if ( V_2 -> V_71 ) {
for ( V_119 = 0 ; V_119 < V_120 ; V_119 ++ )
V_2 -> V_71 [ V_119 ] . V_123 = V_119 ;
F_21 ( V_2 , V_120 ) ;
if ( V_2 -> V_13 & V_62 )
return;
}
...
F_50 ( V_2 -> V_12 ) ;
if ( V_2 -> V_31 . V_33 . type == V_34 )
V_2 -> V_31 . V_125 . V_126 = V_2 -> V_127 ;
V_2 -> V_13 &= ~ V_128 ;
V_2 -> V_129 . V_130 = false ;
V_2 -> V_131 . V_130 = false ;
}
V_2 -> V_131 . V_32 . V_132 = 1 ;
V_2 -> V_131 . V_32 . V_133 = 1 ;
F_51 ( V_2 ) ;
V_2 -> V_5 [ V_40 ] . V_45 = 1 ;
F_20 ( V_2 ) ;
V_2 -> V_74 = 1 ;
...
void F_57 ( struct V_76 * V_20 , T_3 V_136 ,
T_3 V_137 , T_3 V_138 , T_3 V_139 )
{
struct V_140 * V_141 ;
T_1 V_9 = V_20 -> V_142 ;
V_141 = F_58 ( V_20 , V_9 ) ;
V_9 ++ ;
V_20 -> V_142 = ( V_9 < V_20 -> V_81 ) ? V_9 : 0 ;
V_138 |= V_143 | V_144 ;
V_141 -> V_136 = F_59 ( V_136 ) ;
V_141 -> V_145 = F_59 ( V_137 ) ;
V_141 -> V_146 = F_59 ( V_138 ) ;
V_141 -> V_139 = F_59 ( V_139 ) ;
}
