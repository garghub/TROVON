...
F_14 ( V_6 , V_2 ) ;
} else if ( ( V_10 = F_23 ( V_6 , V_7 ) ) != NULL )
F_24 ( V_10 -> V_10 , V_2 ) ;
else
F_14 ( V_6 , V_2 ) ;
V_26:
...
struct V_5 * V_6 = F_2 ( V_4 ) ;
struct V_62 * V_41 ;
F_57 (p, &br->port_list, list)
F_58 ( V_41 ) ;
}
static int F_59 ( struct V_3 * V_4 , struct V_63 * V_64 ,
T_3 V_65 )
{
struct V_5 * V_6 = F_2 ( V_4 ) ;
struct V_62 * V_41 ;
...
int F_60 ( struct V_62 * V_41 , T_3 V_65 )
{
struct V_68 * V_69 ;
int V_66 = 0 ;
V_69 = F_61 ( sizeof( * V_41 -> V_69 ) , V_65 ) ;
V_66 = - V_27 ;
if ( ! V_69 )
goto V_26;
V_66 = F_62 ( V_69 , V_41 -> V_4 , V_65 ) ;
if ( V_66 ) {
F_63 ( V_69 ) ;
goto V_26;
}
...
static int F_65 ( struct V_3 * V_4 , struct V_3 * V_70 )
{
struct V_5 * V_6 = F_2 ( V_4 ) ;
return F_66 ( V_6 , V_70 ) ;
}
static int F_67 ( struct V_3 * V_4 , struct V_3 * V_70 )
{
struct V_5 * V_6 = F_2 ( V_4 ) ;
return F_68 ( V_6 , V_70 ) ;
}
...
V_4 -> V_76 = 0 ;
V_4 -> V_77 = V_78 ;
V_4 -> V_60 = V_79 | V_80 | V_81 |
V_82 | V_83 | V_84 |
V_85 | V_86 ;
V_4 -> V_87 = V_79 | V_80 | V_81 |
V_82 | V_83 |
V_86 ;
V_6 -> V_4 = V_4 ;
F_77 ( & V_6 -> V_46 ) ;
F_78 ( & V_6 -> V_88 ) ;
F_77 ( & V_6 -> V_89 ) ;
V_6 -> V_90 . V_91 [ 0 ] = 0x80 ;
V_6 -> V_90 . V_91 [ 1 ] = 0x00 ;
memcpy ( V_6 -> V_92 , V_93 , V_50 ) ;
V_6 -> V_94 = V_95 ;
V_6 -> V_96 = V_97 ;
V_6 -> V_98 = V_6 -> V_90 ;
