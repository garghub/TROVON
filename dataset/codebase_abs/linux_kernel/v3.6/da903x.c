...
V_27 = F_17 ( V_7 - V_6 -> V_9 . V_7 , V_6 -> V_9 . V_28 ) ;
V_27 = ( V_27 >= 20 ) ? V_27 - 12 : ( ( V_27 > 7 ) ? 8 : V_27 ) ;
return V_27 ;
}
...
int V_29 ;
if ( V_11 >= 8 )
V_29 = 2700000 + V_3 -> V_9 -> V_28 * ( V_11 - 8 ) ;
else
V_29 = V_3 -> V_9 -> V_7 + V_3 -> V_9 -> V_28 * V_11 ;
if ( V_29 > V_6 -> V_8 )
return - V_10 ;
return V_29 ;
}
static inline struct V_5 * F_22 ( int V_32 )
{
struct V_5 * V_33 ;
int V_34 ;
for ( V_34 = 0 ; V_34 < F_23 ( V_5 ) ; V_34 ++ ) {
V_33 = & V_5 [ V_34 ] ;
...
if ( V_33 -> V_9 . V_32 == V_43 )
V_33 -> V_9 . V_41 = & V_44 ;
if ( V_33 -> V_9 . V_32 == V_45 || V_33 -> V_9 . V_32 == V_46 )
V_33 -> V_9 . V_41 = & V_47 ;
V_38 . V_39 = & V_36 -> V_39 ;
V_38 . V_48 = V_36 -> V_39 . V_49 ;
V_38 . V_50 = V_33 ;
V_3 = F_26 ( & V_33 -> V_9 , & V_38 ) ;
if ( F_27 ( V_3 ) ) {
F_25 ( & V_36 -> V_39 , L_3 ,
V_33 -> V_9 . V_51 ) ;
return F_28 ( V_3 ) ;
...
static int T_3 F_30 ( struct V_35 * V_36 )
{
