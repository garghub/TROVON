...
& V_121 [ 0 ] , V_4 -> V_19 , NULL ) ;
if ( V_32 < 0 )
F_9 ( V_4 -> V_29 , L_16 ) ;
V_117 [ 2 ] . V_87 = & V_122 ;
V_117 [ 2 ] . V_88 = sizeof( struct V_99 ) ;
V_117 [ 2 ] . V_92 = F_2 ( V_123 ) ;
V_117 [ 2 ] . V_93 = & V_123 [ 0 ] ,
V_32 = F_36 ( V_4 -> V_29 , 0 , & V_117 [ 2 ] , 1 ,
& V_123 [ 0 ] , V_4 -> V_19 , NULL ) ;
if ( V_32 < 0 )
F_9 ( V_4 -> V_29 , L_17 ) ;
}
...
{
int V_32 ;
V_126 [ 0 ] . V_92 = F_2 ( V_127 ) ;
V_126 [ 0 ] . V_93 = & V_127 [ 0 ] ,
V_32 = F_36 ( V_4 -> V_29 , 0 , & V_126 [ 0 ] ,
F_2 ( V_126 ) , & V_127 [ 0 ] , 0 ,
NULL ) ;
if ( V_32 < 0 )
F_9 ( V_4 -> V_29 , L_19 ) ;
...
if ( V_31 && ( V_31 -> V_133 == V_134 ) )
V_2 = V_135 ;
else
V_2 = 0 ;
V_32 = F_15 ( V_8 , V_63 , V_135 , V_2 ) ;
if ( V_32 < 0 ) {
F_9 ( V_4 -> V_29 , L_26 , V_32 ) ;
goto V_44;
}
V_32 = F_14 ( V_4 , V_31 ) ;
if ( V_32 < 0 )
