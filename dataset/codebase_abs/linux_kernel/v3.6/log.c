...
F_12 ( L_6
L_7 , V_7 -> V_4 , V_7 -> V_32 ,
F_13 ( V_7 -> V_14 ) , V_16 -> V_33 - V_7 -> V_32 ,
V_3 -> V_56 ) ;
V_7 -> V_32 = V_16 -> V_33 ;
} else {
...
F_12 ( L_8
L_7 , V_7 -> V_4 , V_7 -> V_32 ,
F_13 ( V_7 -> V_14 ) , V_3 -> V_20 - V_7 -> V_32 ,
V_3 -> V_56 ) ;
F_31 ( V_57 , & V_3 -> V_9 ) ;
...
V_75 = F_3 ( V_76 , struct V_74 , V_10 ) ;
V_76 = F_47 ( V_76 ) ;
if ( V_76 ) {
if ( V_76 -> V_11 == & V_75 -> V_10 )
V_76 -> V_11 = NULL ;
else
V_76 -> V_12 = NULL ;
}
