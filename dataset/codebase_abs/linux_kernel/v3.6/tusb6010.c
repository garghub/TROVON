...
return - V_182 ;
V_184 = F_74 ( V_1 -> V_21 ) ;
V_186 = F_75 ( V_184 , V_189 , 0 ) ;
V_1 -> V_190 = V_186 -> V_191 ;
V_186 = F_75 ( V_184 , V_189 , 1 ) ;
if ( ! V_186 ) {
F_76 ( L_42 ) ;
V_60 = - V_182 ;
goto V_76;
}
V_1 -> V_187 = V_186 -> V_191 ;
V_187 = F_77 ( V_186 -> V_191 , F_78 ( V_186 ) ) ;
if ( ! V_187 ) {
F_76 ( L_43 ) ;
V_60 = - V_192 ;
goto V_76;
...
F_79 ( & V_84 , F_27 , ( unsigned long ) V_1 ) ;
V_76:
if ( V_60 < 0 ) {
if ( V_187 )
F_80 ( V_187 ) ;
...
static int T_6 F_85 ( struct V_183 * V_184 )
{
struct V_197 * V_198 = V_184 -> V_199 . V_200 ;
struct V_183 * V_1 ;
struct V_201 * V_202 ;
int V_60 = - V_192 ;
V_202 = F_86 ( sizeof( * V_202 ) , V_203 ) ;
if ( ! V_202 ) {
F_87 ( & V_184 -> V_199 , L_45 ) ;
goto V_204;
}
V_1 = F_88 ( L_46 , - 1 ) ;
if ( ! V_1 ) {
F_87 ( & V_184 -> V_199 , L_47 ) ;
goto V_205;
}
V_1 -> V_199 . V_206 = & V_184 -> V_199 ;
V_1 -> V_199 . V_207 = & V_208 ;
V_1 -> V_199 . V_209 = V_208 ;
V_202 -> V_199 = & V_184 -> V_199 ;
V_202 -> V_1 = V_1 ;
V_198 -> V_210 = & V_211 ;
F_89 ( V_184 , V_202 ) ;
V_60 = F_90 ( V_1 , V_184 -> V_185 ,
V_184 -> V_212 ) ;
if ( V_60 ) {
F_87 ( & V_184 -> V_199 , L_48 ) ;
goto V_213;
}
V_60 = F_91 ( V_1 , V_198 , sizeof( * V_198 ) ) ;
if ( V_60 ) {
F_87 ( & V_184 -> V_199 , L_49 ) ;
goto V_213;
}
V_60 = F_92 ( V_1 ) ;
if ( V_60 ) {
F_87 ( & V_184 -> V_199 , L_50 ) ;
goto V_213;
}
return 0 ;
V_213:
...
static int T_7 F_95 ( struct V_183 * V_184 )
{
struct V_201 * V_202 = F_96 ( V_184 ) ;
F_97 ( V_202 -> V_1 ) ;
F_93 ( V_202 -> V_1 ) ;
F_94 ( V_202 ) ;
return 0 ;
