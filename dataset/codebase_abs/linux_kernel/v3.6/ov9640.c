...
static void F_17 ( enum V_58 V_59 ,
struct V_60 * V_61 )
{
switch ( V_59 ) {
default:
...
static int F_19 ( struct V_1 * V_2 , T_2 V_46 ,
...
{
int V_48 , V_5 ;
for ( V_48 = 0 ; V_48 < F_16 ( V_100 ) ; V_48 ++ ) {
...
int V_5 ;
F_15 ( & V_102 -> V_46 , & V_102 -> V_47 ) ;
F_17 ( V_102 -> V_59 , & V_75 ) ;
F_6 ( V_2 ) ;
V_5 = F_20 ( V_2 ) ;
if ( V_5 )
return V_5 ;
...
V_5 = F_19 ( V_2 , V_102 -> V_46 , V_59 , & V_75 ) ;
if ( ! V_5 ) {
V_102 -> V_59 = V_59 ;
V_102 -> V_107 = V_104 ;
}
...
static int F_24 ( struct V_22 * V_23 , unsigned int V_110 ,
enum V_58 * V_59 )
{
if ( V_110 >= F_16 ( V_111 ) )
return - V_38 ;
...
static int F_25 ( struct V_22 * V_23 , struct V_112 * V_113 )
{
V_113 -> V_114 . V_115 = 0 ;
V_113 -> V_114 . V_116 = 0 ;
...
static int F_26 ( struct V_22 * V_23 , struct V_119 * V_113 )
{
V_113 -> V_120 . V_115 = 0 ;
V_113 -> V_120 . V_116 = 0 ;
...
return F_31 ( & V_28 -> V_30 ) ;
}
static int F_32 ( struct V_22 * V_23 ,
struct V_138 * V_139 )
{
struct V_1 * V_2 = F_10 ( V_23 ) ;
struct V_140 * V_141 = F_33 ( V_2 ) ;
V_139 -> V_10 = V_142 | V_143 |
V_144 | V_145 |
V_146 ;
V_139 -> type = V_147 ;
V_139 -> V_10 = F_34 ( V_141 , V_139 ) ;
return 0 ;
}
...
V_28 = F_36 ( sizeof( struct V_27 ) , V_150 ) ;
if ( ! V_28 ) {
F_3 ( & V_2 -> V_16 ,
L_12 ) ;
return - V_151 ;
}
F_37 ( & V_28 -> V_31 , V_2 , & V_152 ) ;
F_38 ( & V_28 -> V_30 , 2 ) ;
F_39 ( & V_28 -> V_30 , & V_153 ,
V_33 , 0 , 1 , 1 , 0 ) ;
F_39 ( & V_28 -> V_30 , & V_153 ,
V_36 , 0 , 1 , 1 , 0 ) ;
V_28 -> V_31 . V_154 = & V_28 -> V_30 ;
if ( V_28 -> V_30 . error ) {
int V_14 = V_28 -> V_30 . error ;
F_40 ( V_28 ) ;
return V_14 ;
}
V_5 = F_27 ( V_2 ) ;
