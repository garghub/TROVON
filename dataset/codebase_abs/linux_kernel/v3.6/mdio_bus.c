...
static int F_8 ( struct V_11 * V_14 , void * V_15 )
{
...
while ( -- V_19 >= 0 ) {
if ( V_3 -> V_37 [ V_19 ] )
F_20 ( & V_3 -> V_37 [ V_19 ] -> V_14 ) ;
}
F_21 ( & V_3 -> V_14 ) ;
return V_20 ;
}
void F_22 ( struct V_1 * V_3 )
{
int V_19 ;
F_6 ( V_3 -> V_8 != V_36 ) ;
V_3 -> V_8 = V_25 ;
...
struct V_34 * F_16 ( struct V_1 * V_3 , int V_38 )
{
struct V_34 * V_35 ;
int V_20 ;
V_35 = F_25 ( V_3 , V_38 , false ) ;
if ( F_17 ( V_35 ) || V_35 == NULL )
return V_35 ;
V_20 = F_26 ( V_35 ) ;
if ( V_20 ) {
F_27 ( V_35 ) ;
