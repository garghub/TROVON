...
static struct V_1 * F_62 ( struct V_1 * V_2 , struct V_76 * V_77 )
{
...
V_64 -> V_47 , V_64 -> V_14 ) ;
if ( V_114 != NULL )
return F_63 ( V_2 , V_77 , V_114 , V_115 ) ;
V_140 = F_64 ( F_60 ( V_2 ) , & V_92 ,
V_64 -> V_47 , V_85 -> V_94 ,
V_64 -> V_14 , V_85 -> V_93 ,
F_32 ( V_77 ) ) ;
if ( V_140 != NULL ) {
...
static struct V_66 * F_65 ( struct V_88 * V_88 , struct V_1 * V_2 ,
struct V_76 * V_77 )
{
struct V_18 * V_19 ;
const struct V_63 * V_64 = F_52 ( V_77 ) ;
...
static int F_70 ( struct V_1 * V_2 , struct V_113 * V_114 ,
struct V_148 * V_149 )
{
int V_20 = - 1 ;
struct V_76 * V_77 ;
struct V_66 * V_56 ;
struct V_16 V_17 ;
V_56 = F_71 ( V_2 , & V_17 , V_114 ) ;
if ( V_56 == NULL )
goto V_60;
V_77 = F_72 ( V_2 , V_56 , V_114 ) ;
if ( V_77 != NULL ) {
const struct V_126 * V_127 = F_56 ( V_114 ) ;
struct V_84 * V_85 = V_84 ( V_77 ) ;
V_85 -> V_125 = F_47 ( V_77 , V_127 -> V_133 ,
V_127 -> V_132 ) ;
V_20 = F_73 ( V_77 , V_2 , V_127 -> V_133 ,
V_127 -> V_132 ,
V_127 -> V_31 ) ;
V_20 = F_74 ( V_20 ) ;
}
...
static void F_75 ( struct V_1 * V_2 , struct V_76 * V_150 )
{
int V_20 ;
const struct V_63 * V_151 ;
struct V_76 * V_77 ;
struct V_66 * V_56 ;
struct V_88 * V_88 = F_28 ( F_76 ( V_150 ) -> V_89 ) ;
struct V_1 * V_152 = V_88 -> V_153 . V_154 ;
if ( V_84 ( V_150 ) -> V_155 == V_156 )
return;
if ( F_77 ( V_150 ) -> V_157 != V_158 )
return;
V_56 = F_65 ( V_88 , V_152 , V_150 ) ;
if ( V_56 == NULL )
return;
V_77 = F_78 ( V_152 , V_150 ) ;
if ( V_77 == NULL )
goto V_60;
V_151 = F_52 ( V_150 ) ;
...
{
F_82 ( & F_41 ( V_114 ) -> V_161 ) ;
F_83 ( F_56 ( V_114 ) -> V_31 ) ;
}
void F_84 ( struct V_1 * V_2 , struct V_113 * V_114 )
{
}
int F_85 ( struct V_1 * V_2 , struct V_76 * V_77 )
{
struct V_126 * V_127 ;
struct V_113 * V_114 ;
struct V_162 * V_163 ;
const T_2 V_164 = F_86 ( V_77 ) -> V_165 ;
struct V_166 * V_167 = F_87 ( V_77 ) ;
if ( F_77 ( V_77 ) -> V_43 & ( V_45 | V_44 ) )
return 0 ;
if ( F_88 ( V_2 , V_164 ) ) {
V_167 -> V_168 = V_169 ;
goto V_170;
...
if ( F_89 ( V_2 ) )
goto V_170;
if ( F_54 ( V_2 ) && F_90 ( V_2 ) > 1 )
goto V_170;
V_114 = F_91 ( & V_172 ) ;
if ( V_114 == NULL )
goto V_170;
if ( F_92 ( V_114 , F_3 ( V_2 ) , V_77 ) )
goto V_173;
V_163 = F_41 ( V_114 ) ;
if ( F_93 ( V_2 , V_163 , V_77 ) )
goto V_173;
if ( F_94 ( V_2 , V_77 , V_114 ) )
goto V_173;
V_127 = F_56 ( V_114 ) ;
...
V_163 -> V_177 = V_164 ;
if ( F_70 ( V_2 , V_114 , NULL ) )
goto V_173;
F_95 ( V_2 , V_114 , V_178 ) ;
return 0 ;
V_173:
F_96 ( V_114 ) ;
V_170:
...
int F_97 ( struct V_1 * V_2 , struct V_76 * V_77 )
{
struct V_84 * V_85 = V_84 ( V_77 ) ;
if ( V_2 -> V_67 == V_179 ) {
if ( F_98 ( V_2 , V_77 , V_85 , V_77 -> V_90 ) )
goto V_180;
return 0 ;
}
if ( V_2 -> V_67 == V_68 ) {
struct V_1 * V_140 = F_62 ( V_2 , V_77 ) ;
if ( V_140 == NULL )
goto V_181;
if ( V_140 != V_2 ) {
if ( F_99 ( V_2 , V_140 , V_77 ) )
goto V_180;
return 0 ;
}
}
...
int F_102 ( struct V_76 * V_77 )
{
const struct V_84 * V_85 ;
unsigned int V_182 ;
if ( V_77 -> V_183 != V_184 )
return 1 ;
if ( ! F_103 ( V_77 , sizeof( struct V_84 ) ) ) {
F_104 ( L_1 ) ;
return 1 ;
}
V_85 = V_84 ( V_77 ) ;
...
if ( V_85 -> V_186 < F_105 ( V_77 ) / sizeof( T_3 ) ) {
F_104 ( L_3 , V_85 -> V_186 ) ;
return 1 ;
}
if ( ! F_103 ( V_77 , V_85 -> V_186 * sizeof( T_3 ) ) ) {
F_104 ( L_4 , V_85 -> V_186 ) ;
return 1 ;
}
if ( ( V_85 -> V_155 < V_187 ||
...
V_77 -> V_124 = F_108 ( V_77 , 0 , V_182 , 0 ) ;
return 0 ;
}
...
V_85 = V_84 ( V_77 ) ;
F_87 ( V_77 ) -> V_175 = F_37 ( V_85 ) ;
F_87 ( V_77 ) -> V_193 = V_85 -> V_155 ;
F_110 ( L_8 ,
F_106 ( V_85 -> V_155 ) ,
& V_64 -> V_47 , F_111 ( V_85 -> V_94 ) ,
& V_64 -> V_14 , F_111 ( V_85 -> V_93 ) ,
( unsigned long long ) F_87 ( V_77 ) -> V_175 ) ;
if ( F_112 ( V_77 ) ) {
F_87 ( V_77 ) -> V_194 = V_195 ;
F_113 ( L_9 ) ;
} else {
F_87 ( V_77 ) -> V_194 = F_114 ( V_77 ) ;
F_113 ( L_10 , ( unsigned long long )
F_87 ( V_77 ) -> V_194 ) ;
}
V_2 = F_115 ( & V_92 , V_77 ,
V_85 -> V_94 , V_85 -> V_93 ) ;
...
if ( ! F_116 ( V_2 , V_199 , V_77 ) )
goto V_198;
F_117 ( V_77 ) ;
return F_118 ( V_2 , V_77 , 1 ) ;
V_196:
if ( ! F_116 ( NULL , V_199 , V_77 ) )
goto V_192;
if ( V_85 -> V_155 != V_156 ) {
F_87 ( V_77 ) -> V_168 =
V_200 ;
...
static int T_9 F_122 ( struct V_88 * V_88 )
{
if ( V_92 . V_204 == NULL )
return - V_205 ;
return F_123 ( & V_88 -> V_153 . V_154 , V_206 ,
V_207 , V_42 , V_88 ) ;
}
static void T_10 F_124 ( struct V_88 * V_88 )
{
F_125 ( V_88 -> V_153 . V_154 ) ;
}
static int T_11 F_126 ( void )
{
int V_20 = F_127 ( & V_208 , 1 ) ;
if ( V_20 != 0 )
goto V_60;
V_20 = F_128 ( & V_209 , V_42 ) ;
if ( V_20 != 0 )
goto V_210;
F_129 ( & V_211 ) ;
V_20 = F_130 ( & V_212 ) ;
