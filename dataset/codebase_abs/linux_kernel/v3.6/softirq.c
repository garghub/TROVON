...
void F_122 ( struct V_32 * V_33 , unsigned int V_17 )
{
struct V_32 * * V_68 ;
F_74 ( F_99 ( V_17 ) ) ;
F_74 ( F_88 ( V_76 , & V_33 -> V_4 ) ) ;
...
static int T_3 F_125 ( struct V_63 * V_77 ,
unsigned long V_26 ,
void * V_65 )
{
int V_78 = ( unsigned long ) V_65 ;
struct V_1 * V_79 ;
switch ( V_26 ) {
case V_80 :
case V_81 :
...
static T_4 int F_136 ( void )
{
void * V_17 = ( void * ) ( long ) F_38 () ;
int V_92 = F_125 ( & V_93 , V_80 , V_17 ) ;
F_74 ( V_92 != V_71 ) ;
F_125 ( & V_93 , V_82 , V_17 ) ;
F_137 ( & V_93 ) ;
return 0 ;
}
