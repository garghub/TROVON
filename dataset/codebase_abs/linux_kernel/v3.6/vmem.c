...
int T_6 F_31 ( struct V_28 * V_13 , unsigned long V_29 , int V_30 )
{
...
{
F_38 ( V_37 ) ;
F_28 ( V_37 -> V_13 , V_37 -> V_14 ) ;
}
int F_41 ( unsigned long V_13 , unsigned long V_14 )
{
struct V_36 * V_37 ;
int V_20 ;
F_42 ( & V_44 ) ;
V_20 = - V_45 ;
F_36 (seg, &mem_segs, list) {
