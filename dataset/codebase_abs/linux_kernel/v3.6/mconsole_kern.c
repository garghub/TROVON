...
V_116 , L_43 , ( void * ) V_110 ) ;
if ( V_60 ) {
F_21 ( V_39 L_46 ) ;
goto V_40;
}
if ( V_117 != NULL ) {
V_117 = F_84 ( V_117 , V_42 ) ;
if ( V_117 != NULL )
F_85 ( V_117 , V_118 ,
V_113 ,
strlen ( V_113 ) + 1 ) ;
...
const char T_4 * V_121 , V_95 V_122 , T_5 * V_123 )
{
char * V_37 ;
V_37 = F_12 ( V_122 + 1 , V_42 ) ;
if ( V_37 == NULL )
return - V_124 ;
if ( F_88 ( V_37 , V_121 , V_122 ) ) {
V_122 = - V_125 ;
goto V_40;
}
V_37 [ V_122 ] = '\0' ;
F_85 ( V_117 , V_126 , V_37 , V_122 ) ;
V_40:
F_9 ( V_37 ) ;
return V_122 ;
}
...
if ( V_117 == NULL )
return 0 ;
V_128 = F_90 ( L_43 , 0200 , NULL , & V_129 ) ;
if ( V_128 == NULL ) {
F_21 ( V_119 L_50
L_51 ) ;
return 0 ;
...
{
if ( ! strncmp ( V_57 , V_131 , strlen ( V_131 ) ) ) {
V_57 += strlen ( V_131 ) ;
V_117 = V_57 ;
}
...
static int F_94 ( struct V_1 * V_132 , unsigned long V_133 ,
void * V_34 )
{
char * V_134 = V_34 ;
if ( V_117 == NULL )
return 0 ;
F_85 ( V_117 , V_135 , V_134 ,
strlen ( V_134 ) + 1 ) ;
return 0 ;
}
