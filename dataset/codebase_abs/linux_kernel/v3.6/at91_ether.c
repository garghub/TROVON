...
if ( F_89 ( V_2 -> V_150 ) ) {
V_136 = F_90 ( V_2 -> V_150 ) ;
goto V_245;
}
F_61 ( V_2 -> V_150 ) ;
V_21 -> V_50 = F_91 ( V_233 , 0 ) ;
if ( F_23 ( V_21 -> V_50 , F_75 , 0 , V_21 -> V_31 , V_21 ) ) {
V_136 = - V_246 ;
goto V_247;
}
V_2 -> V_139 = (struct V_138 * ) F_92 ( NULL , sizeof( struct V_138 ) , ( V_248 * ) & V_2 -> V_140 , V_249 ) ;
if ( V_2 -> V_139 == NULL ) {
V_136 = - V_240 ;
goto V_250;
}
...
V_21 -> V_253 = & V_254 ;
F_94 ( V_233 , V_21 ) ;
F_95 ( V_21 , & V_233 -> V_21 ) ;
F_35 ( V_21 ) ;
F_36 ( V_21 ) ;
F_3 ( V_2 , V_7 , 0 ) ;
if ( V_72 -> V_255 )
F_3 ( V_2 , V_47 , V_256 | V_257 | V_258 ) ;
else
F_3 ( V_2 , V_47 , V_256 | V_257 ) ;
if ( ! F_82 ( V_2 ) ) {
F_9 ( V_76 L_13 ) ;
V_136 = - V_259 ;
goto V_260;
...
V_260:
F_94 ( V_233 , NULL ) ;
F_99 ( NULL , sizeof( struct V_138 ) , V_2 -> V_139 , ( V_248 ) V_2 -> V_140 ) ;
V_250:
F_28 ( V_21 -> V_50 , V_21 ) ;
V_247:
F_65 ( V_2 -> V_150 ) ;
...
static int T_4 F_103 ( struct V_232 * V_233 )
{
struct V_20 * V_21 = F_104 ( V_233 ) ;
struct V_1 * V_2 = F_14 ( V_21 ) ;
if ( F_20 ( V_2 -> V_72 . V_73 ) )
F_105 ( V_2 -> V_72 . V_73 ) ;
F_106 ( V_21 ) ;
...
static int F_107 ( struct V_232 * V_233 , T_5 V_265 )
{
struct V_20 * V_266 = F_104 ( V_233 ) ;
