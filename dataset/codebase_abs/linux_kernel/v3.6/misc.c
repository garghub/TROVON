...
V_123 ) ;
if ( V_93 -> V_124 != V_101 -> V_125 )
continue;
F_3 ( 1 , L_21 ) ;
V_99 = F_43 ( V_101 -> V_126 -> V_127 ) ;
F_44 ( V_99 ,
V_93 -> V_116 ? V_128 : 0 ) ;
F_45 ( V_129 ,
& V_101 -> V_130 ) ;
...
if ( V_135 == 0 )
return;
for ( V_132 = 0 , V_133 = 0 ; V_132 < V_45 ; V_132 ++ , V_133 ++ ) {
if ( V_132 % 8 == 0 ) {
F_47 ( V_136 L_24 ) ;
V_133 = 0 ;
}
F_47 ( L_25 , V_40 [ V_132 ] ) ;
V_134 [ 2 * V_133 ] = ' ' ;
if ( isprint ( V_40 [ V_132 ] ) )
V_134 [ 1 + ( 2 * V_133 ) ] = V_40 [ V_132 ] ;
else
V_134 [ 1 + ( 2 * V_133 ) ] = '_' ;
if ( V_132 % 8 == 7 ) {
V_134 [ 16 ] = 0 ;
...
void F_44 ( struct V_98 * V_142 , T_2 V_143 )
{
V_143 &= 0xF ;
if ( V_143 == V_144 ) {
V_142 -> V_145 = true ;
...
bool
F_50 ( struct V_137 * V_138 )
{
if ( V_138 -> V_139 & V_148 ) {
if ( V_138 -> V_149 == F_51 () )
return true ;
}
