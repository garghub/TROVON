...
static void F_84 ( struct V_113 * V_42 , unsigned char V_208 )
{
struct V_1 * V_2 = (struct V_1 * ) V_42 ;
while ( ( F_2 ( V_2 , V_27 ) & V_83 ) == 0 )
F_3 ( 5 ) ;
...
return - V_221 ;
V_2 -> V_42 . V_222 = V_218 . V_223 ;
V_2 -> V_42 . V_224 = F_87 ( V_2 -> V_42 . V_222 , 0x1000 ) ;
V_2 -> V_225 = V_2 -> V_42 . V_224 ;
...
V_2 -> V_42 . V_241 = V_242 ;
V_2 -> V_42 . V_94 = F_91 ( V_210 , 0 ) ;
V_2 -> V_42 . V_243 = V_166 ;
V_2 -> V_42 . V_244 = 1 ;
V_2 -> V_42 . V_245 = & V_246 ;
V_2 -> V_42 . type = V_247 ;
V_2 -> V_42 . V_30 = 0 ;
if ( V_2 -> V_42 . V_94 == 0 &&
...
V_2 = & V_254 [ V_4 ] ;
V_2 -> V_256 = V_250 ;
V_2 -> V_42 . V_256 = & V_250 -> V_255 . V_256 ;
...
V_254 [ V_213 ] . V_42 . line = V_213 ;
V_254 [ V_213 + 1 ] . V_42 . line = V_213 + 1 ;
V_98 = F_85 ( & V_254 [ V_213 ] ) ;
if ( V_98 == 0 && V_264 != NULL )
V_98 = F_85 ( & V_254 [ V_213 + 1 ] ) ;
if ( V_98 != 0 ) {
F_96 ( V_263 ) ;
F_96 ( V_264 ) ;
...
V_94 = F_115 ( V_2 -> V_270 , 0 ) ;
if ( ! V_218 || ! V_94 )
return - V_221 ;
V_2 -> V_42 . V_222 = V_218 -> V_223 ;
V_2 -> V_42 . V_224 = ( unsigned char V_272 * ) V_218 -> V_223 ;
V_2 -> V_42 . V_241 = V_242 ;
V_2 -> V_42 . V_94 = V_94 ;
V_2 -> V_42 . V_243 = V_166 ;
V_2 -> V_42 . V_244 = 1 ;
...
F_130 ( & V_2 -> V_42 , V_284 , V_213 , F_128 ) ;
F_7 ( V_2 , V_6 , V_2 -> V_32 [ 1 ] ) ;
F_45 ( & V_2 -> V_42 . V_57 , V_30 ) ;
}
...
F_71 ( V_150 ) ;
if ( V_287 )
F_134 ( V_287 , & V_161 , & V_63 , & V_288 , & V_289 ) ;
return F_135 ( V_42 , V_286 , V_161 , V_63 , V_288 , V_289 ) ;
}
