...
volatile struct V_13 * V_55 = V_5 -> V_13 ;
F_15 ( V_2 ) ;
if ( F_22 ( V_2 -> V_38 , V_84 , 0 , V_2 -> V_54 , V_2 ) ) {
F_13 ( V_59 L_3 , V_2 -> V_54 , V_2 -> V_38 ) ;
return - V_85 ;
}
if ( F_22 ( V_5 -> V_40 , V_86 , 0 , V_2 -> V_54 , V_2 ) ) {
F_13 ( V_59 L_3 , V_2 -> V_54 , V_5 -> V_40 ) ;
F_23 ( V_2 -> V_38 , V_2 ) ;
return - V_85 ;
}
V_5 -> V_87 = F_24 ( V_5 -> V_35 ,
V_25 * V_88 ,
& V_5 -> V_89 , V_90 ) ;
if ( V_5 -> V_87 == NULL ) {
F_13 ( V_59 L_4 , V_2 -> V_54 ) ;
goto V_91;
}
V_5 -> V_92 = F_24 ( V_5 -> V_35 ,
V_11 * V_88 ,
& V_5 -> V_9 , V_90 ) ;
if ( V_5 -> V_92 == NULL ) {
F_13 ( V_59 L_5 , V_2 -> V_54 ) ;
goto V_93;
}
F_7 ( V_2 ) ;
F_3 ( V_20 , 0x9000 ) ;
...
static int F_27 ( struct V_95 * V_96 , struct V_1 * V_2 )
{
struct V_4 * V_5 = F_2 ( V_2 ) ;
unsigned long V_83 ;
F_19 ( V_83 ) ;
...
static void F_34 ( struct V_1 * V_2 , int V_112 )
{
struct V_4 * V_5 = F_2 ( V_2 ) ;
volatile struct V_13 * V_55 = V_5 -> V_13 ;
...
static T_3 V_84 ( int V_38 , void * V_126 )
{
...
static void F_37 ( struct V_1 * V_2 , struct V_140 * V_141 )
{
struct V_95 * V_96 ;
...
V_96 = F_38 ( V_2 , V_153 + 2 ) ;
if ( ! V_96 ) {
V_2 -> V_98 . V_155 ++ ;
return;
}
F_39 ( V_96 , 2 ) ;
memcpy ( F_40 ( V_96 , V_153 ) , V_141 -> V_156 , V_153 ) ;
V_96 -> V_157 = F_41 ( V_96 , V_2 ) ;
F_42 ( V_96 ) ;
V_2 -> V_98 . V_158 ++ ;
V_2 -> V_98 . V_159 += V_153 ;
}
}
static T_3 V_86 ( int V_38 , void * V_126 )
{
struct V_1 * V_2 = (struct V_1 * ) V_126 ;
struct V_4 * V_5 = F_2 ( V_2 ) ;
int V_160 , V_161 ;
T_4 V_162 ;
V_8 V_163 ;
while ( ( V_163 = F_43 ( V_164 ) ) != F_43 ( V_164 ) ) ;
...
V_160 = F_43 ( V_10 + V_5 -> V_17 ) ;
V_161 = V_11 - V_160 ;
while ( V_5 -> V_12 < V_161 ) {
F_37 ( V_2 , (struct V_140 * ) ( V_5 -> V_92
+ ( V_5 -> V_12 * V_88 ) ) ) ;
V_5 -> V_12 ++ ;
}
if ( ! V_160 ) {
