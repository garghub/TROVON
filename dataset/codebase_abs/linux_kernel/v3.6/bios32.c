...
static void T_3 F_20 ( struct V_5 * V_6 )
{
int V_21 ;
if ( ( V_6 -> V_22 >> 8 ) == V_23 ||
V_6 -> V_22 == 0x68000 ||
...
static T_5 T_3 F_24 ( struct V_5 * V_6 , T_5 * V_65 )
{
...
static int F_26 ( const struct V_5 * V_6 , T_5 V_69 , T_5 V_65 )
{
struct V_66 * V_67 = V_6 -> V_68 ;
int V_32 = - 1 ;
if ( V_67 -> V_72 )
...
static void T_6 F_27 ( struct V_73 * V_74 , struct V_12 * V_75 )
{
struct V_66 * V_67 = NULL ;
int V_76 ;
int V_77 , V_78 ;
for ( V_77 = V_78 = 0 ; V_77 < V_74 -> V_79 ; V_77 ++ ) {
V_67 = F_28 ( sizeof( struct V_66 ) , V_80 ) ;
if ( ! V_67 )
F_29 ( L_8 ) ;
#ifdef F_30
V_67 -> V_81 = V_74 -> V_81 ;
...
if ( V_74 -> V_88 )
V_67 -> V_2 = V_74 -> V_88 ( V_77 , V_67 ) ;
else
V_67 -> V_2 = F_34 ( NULL , V_67 -> V_78 ,
V_74 -> V_89 , V_67 , & V_67 -> V_82 ) ;
if ( ! V_67 -> V_2 )
F_29 ( L_9 ) ;
V_78 = V_67 -> V_2 -> V_90 . V_19 + 1 ;
F_35 ( & V_67 -> V_91 , V_75 ) ;
} else {
F_36 ( V_67 ) ;
if ( V_76 < 0 )
...
void T_6 F_37 ( struct V_73 * V_74 )
{
struct V_66 * V_67 ;
F_38 ( V_75 ) ;
F_39 ( V_92 ) ;
...
char * T_6 F_47 ( char * V_96 )
{
if ( ! strcmp ( V_96 , L_10 ) ) {
V_33 = 1 ;
return NULL ;
} else if ( ! strcmp ( V_96 , L_11 ) ) {
F_39 ( V_95 ) ;
return NULL ;
}
return V_96 ;
}
T_7 F_48 ( void * V_97 , const struct V_18 * V_98 ,
T_7 V_99 , T_7 V_100 )
{
T_7 V_20 = V_98 -> V_20 ;
if ( V_98 -> V_25 & V_101 && V_20 & 0x300 )
V_20 = ( V_20 + 0x3ff ) & ~ 0x3ff ;
V_20 = ( V_20 + V_100 - 1 ) & ~ ( V_100 - 1 ) ;
return V_20 ;
}
int F_49 ( struct V_5 * V_6 , int V_102 )
{
T_2 V_57 , V_103 ;
int V_104 ;
struct V_18 * V_26 ;
...
int F_50 ( struct V_5 * V_6 , struct V_110 * V_111 ,
enum V_112 V_113 , int V_114 )
{
struct V_66 * V_115 = V_6 -> V_68 ;
unsigned long V_116 ;
if ( V_113 == V_117 ) {
return - V_106 ;
} else {
V_116 = V_111 -> V_118 + ( V_115 -> V_87 >> V_119 ) ;
}
V_111 -> V_120 = F_51 ( V_111 -> V_120 ) ;
if ( F_52 ( V_111 , V_111 -> V_121 , V_116 ,
V_111 -> V_122 - V_111 -> V_121 ,
V_111 -> V_120 ) )
return - V_123 ;
return 0 ;
}
