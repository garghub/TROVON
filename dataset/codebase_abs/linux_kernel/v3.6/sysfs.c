...
{
if ( F_21 ( F_2 ( V_2 ) ) )
return sprintf ( V_5 , L_1 , L_13 ) ;
return sprintf ( V_5 , L_1 , L_14 ) ;
}
static T_1
...
int V_45 ;
if ( V_7 -> V_31 != V_46 )
V_45 = F_30 ( V_43 + V_7 -> V_47 ) ;
else
V_45 = F_30 ( V_7 -> V_47 ) ;
return sprintf ( V_5 , L_15 , V_45 ) ;
}
static T_1
F_32 ( struct V_1 * V_2 , struct V_3 * V_4 , char * V_5 )
{
...
static T_1
F_37 ( struct V_1 * V_2 , struct V_3 * V_4 , char * V_5 )
{
struct V_6 * V_7 = F_2 ( V_2 ) ;
...
return snprintf ( V_5 , V_65 , L_15 , V_64 -> V_66 ) ;
}
...
static T_4 F_55 ( struct V_71 * V_40 ,
struct V_72 * V_73 , int V_74 )
{
struct V_1 * V_2 = F_56 ( V_40 , struct V_1 , V_40 ) ;
struct V_6 * V_7 = F_2 ( V_2 ) ;
if ( V_73 == & V_75 . V_4 ) {
if ( V_7 -> V_76 == NULL )
return 0 ;
...
static T_1
F_57 ( struct V_82 * V_83 , struct V_71 * V_40 ,
struct V_84 * V_4 ,
...
V_89 = V_7 -> V_92 [ V_88 ] ;
V_87 = F_58 ( V_7 -> V_11 [ V_88 ] . V_93 .
V_94 ) ;
}
if ( V_85 < V_87 ) {
V_74 = F_59 ( V_86 , V_87 - ( T_2 ) V_85 ) ;
...
F_4 ( V_7 ) ;
if ( ! V_98 -> V_2 . V_111 ||
F_70 ( V_98 -> V_2 . V_111 ) -> V_112 )
V_60 = sprintf ( V_5 , L_15 , 1 ) ;
else
V_60 = sprintf ( V_5 , L_15 , 0 ) ;
F_6 ( V_7 ) ;
return V_60 ;
}
static T_4 F_71 ( struct V_71 * V_40 ,
struct V_72 * V_73 , int V_74 )
{
struct V_1 * V_2 = F_56 ( V_40 , struct V_1 , V_40 ) ;
struct V_97 * V_98 = F_65 ( V_2 ) ;
if ( V_98 -> V_113 == NULL )
return 0 ;
return V_73 -> V_81 ;
}
...
{
struct V_6 * V_7 = F_68 ( V_98 ) ;
struct V_100 * V_101 = V_98 -> V_99 ;
if ( V_98 -> V_114 || V_98 -> V_115 )
return;
if ( ! V_101 -> string && ! ( V_7 -> V_28 & V_116 ) )
V_101 -> string = F_73 ( V_7 , V_101 -> V_93 . V_117 ) ;
if ( V_101 -> string && F_74 ( & V_98 -> V_2 , & V_118 ) )
;
V_98 -> V_114 = 1 ;
}
