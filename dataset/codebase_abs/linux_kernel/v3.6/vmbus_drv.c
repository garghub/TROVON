...
if ( V_54 )
goto V_107;
V_54 = F_38 ( V_94 , F_31 , 0 , V_108 , V_1 ) ;
if ( V_54 != 0 ) {
F_16 ( L_33 ,
V_94 ) ;
goto V_109;
...
int F_45 ( struct V_66 * V_66 , struct V_113 * V_114 , const char * V_115 )
{
int V_54 ;
F_46 ( L_34 , V_66 -> V_57 ) ;
V_54 = F_1 () ;
...
V_66 -> V_65 . V_114 = V_114 ;
V_66 -> V_65 . V_115 = V_115 ;
V_66 -> V_65 . V_116 = & V_106 ;
V_54 = F_47 ( & V_66 -> V_65 ) ;
F_41 () ;
return V_54 ;
}
...
{
struct V_3 * V_119 ;
V_119 = F_7 ( sizeof( struct V_3 ) , V_55 ) ;
if ( ! V_119 ) {
F_16 ( L_36 ) ;
return NULL ;
}
V_119 -> V_9 = V_9 ;
memcpy ( & V_119 -> V_47 , type , sizeof( V_16 ) ) ;
memcpy ( & V_119 -> V_120 , V_117 ,
sizeof( V_16 ) ) ;
return V_119 ;
}
int F_51 ( struct V_3 * V_119 )
{
int V_54 = 0 ;
static T_4 V_121 = F_52 ( 0 ) ;
F_53 ( & V_119 -> V_4 , L_37 ,
F_54 ( & V_121 ) ) ;
V_119 -> V_4 . V_116 = & V_106 ;
V_119 -> V_4 . V_122 = & V_1 -> V_49 ;
V_119 -> V_4 . V_123 = F_20 ;
V_54 = F_55 ( & V_119 -> V_4 ) ;
if ( V_54 )
F_16 ( L_38 ) ;
else
...
void F_56 ( struct V_3 * V_124 )
{
F_57 ( & V_124 -> V_4 ) ;
F_46 ( L_40 ,
F_17 ( & V_124 -> V_4 ) ) ;
}
static T_5 F_58 ( struct V_125 * V_126 , void * V_94 )
{
if ( V_126 -> type == V_127 ) {
struct V_128 * V_129 ;
V_129 = & V_126 -> V_78 . V_94 ;
* ( ( unsigned int * ) V_94 ) = V_129 -> V_130 [ 0 ] ;
}
return V_131 ;
}
static int F_59 ( struct V_132 * V_4 )
{
T_5 V_133 ;
V_1 = V_4 ;
V_133 = F_60 ( V_4 -> V_134 , V_135 ,
F_58 , & V_94 ) ;
if ( F_61 ( V_133 ) ) {
F_62 ( & V_136 ) ;
return - V_2 ;
