...
static int F_43 ( struct V_74 * V_75 , struct V_76 * V_77 , void * V_56 )
{
...
static int F_60 ( struct V_74 * V_75 , struct V_76 * V_77 , void * V_56 )
{
struct V_22 * V_22 = F_44 ( V_75 -> V_78 ) ;
struct V_65 * V_66 = F_45 ( V_77 ) ;
struct V_1 * V_2 = NULL ;
...
T_1 V_102 , T_1 V_109 , int type , int V_5 ,
struct V_1 * V_2 )
{
struct V_76 * V_77 ;
struct V_65 * V_66 ;
V_77 = F_66 ( V_75 , V_102 , V_109 , type , sizeof( * V_66 ) , V_5 ) ;
if ( V_77 == NULL )
return - V_110 ;
V_66 = F_45 ( V_77 ) ;
V_66 -> V_23 = V_2 -> V_23 ;
V_66 -> V_4 = V_20 -> V_4 ;
if ( F_67 ( V_75 , V_111 , V_20 -> V_4 ) )
goto V_112;
V_66 -> V_113 = 0 ;
V_66 -> V_114 = 0 ;
V_66 -> V_12 = V_20 -> V_12 ;
...
static int F_72 ( struct V_74 * V_75 , struct V_118 * V_119 ,
struct V_1 * V_2 )
{
int V_120 = 0 ;
struct V_6 * V_20 ;
F_10 () ;
F_11 (rule, &ops->rules_list, list) {
if ( V_120 < V_119 -> args [ 1 ] )
goto V_121;
if ( F_65 ( V_75 , V_20 , F_59 ( V_119 -> V_75 ) . V_102 ,
V_119 -> V_77 -> V_122 , V_101 ,
V_123 , V_2 ) < 0 )
break;
V_121:
V_120 ++ ;
...
static int F_73 ( struct V_74 * V_75 , struct V_118 * V_119 )
{
struct V_22 * V_22 = F_44 ( V_75 -> V_78 ) ;
struct V_1 * V_2 ;
int V_120 = 0 , V_23 ;
V_23 = F_74 ( V_119 -> V_77 ) ;
if ( V_23 != V_125 ) {
V_2 = F_9 ( V_22 , V_23 ) ;
if ( V_2 == NULL )
return - V_83 ;
return F_72 ( V_75 , V_119 , V_2 ) ;
}
F_10 () ;
F_11 (ops, &net->rules_ops, list) {
if ( V_120 < V_119 -> args [ 0 ] || ! F_12 ( V_2 -> V_24 ) )
goto V_121;
if ( F_72 ( V_75 , V_119 , V_2 ) < 0 )
break;
V_119 -> args [ 1 ] = 0 ;
V_121:
V_120 ++ ;
...
static void F_58 ( int V_126 , struct V_6 * V_20 ,
...
if ( V_75 == NULL )
goto V_35;
V_26 = F_65 ( V_75 , V_20 , V_102 , V_77 -> V_122 , V_126 , 0 , V_2 ) ;
if ( V_26 < 0 ) {
F_76 ( V_26 == - V_110 ) ;
F_77 ( V_75 ) ;
goto V_35;
}
F_78 ( V_75 , V_22 , V_102 , V_2 -> V_128 , V_77 , V_9 ) ;
return;
V_35:
if ( V_26 < 0 )
F_79 ( V_22 , V_2 -> V_128 , V_26 ) ;
}
static void F_80 ( struct V_18 * V_129 , struct V_87 * V_88 )
{
struct V_6 * V_20 ;
F_19 (rule, rules, list) {
if ( V_20 -> V_46 == - 1 &&
strcmp ( V_88 -> V_130 , V_20 -> V_89 ) == 0 )
V_20 -> V_46 = V_88 -> V_91 ;
if ( V_20 -> V_49 == - 1 &&
strcmp ( V_88 -> V_130 , V_20 -> V_93 ) == 0 )
V_20 -> V_49 = V_88 -> V_91 ;
}
}
static void F_81 ( struct V_18 * V_129 , struct V_87 * V_88 )
{
struct V_6 * V_20 ;
F_19 (rule, rules, list) {
...
static int F_82 ( struct V_131 * V_132 , unsigned long V_126 ,
void * V_133 )
{
struct V_87 * V_88 = V_133 ;
...
{
int V_26 ;
F_88 ( V_137 , V_101 , F_43 , NULL , NULL ) ;
F_88 ( V_137 , V_105 , F_60 , NULL , NULL ) ;
F_88 ( V_137 , V_138 , NULL , F_73 , NULL ) ;
V_26 = F_89 ( & V_139 ) ;
if ( V_26 < 0 )
goto V_140;
V_26 = F_90 ( & V_141 ) ;
