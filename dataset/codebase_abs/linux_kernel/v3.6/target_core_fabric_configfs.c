...
struct V_12 , V_107 ) ;
struct V_53 * V_54 = V_13 -> V_55 -> V_56 ;
struct V_48 * V_108 = NULL , * V_109 = NULL ;
unsigned long V_37 ;
int V_110 ;
...
return F_19 ( - V_23 ) ;
V_108 = & V_7 -> V_8 ;
V_108 -> V_65 = F_22 ( sizeof( struct V_48 ) * 2 ,
V_61 ) ;
if ( ! V_108 -> V_65 ) {
F_4 ( L_32 ) ;
return F_19 ( - V_62 ) ;
...
& F_25 ( V_54 ) -> V_111 ) ;
F_24 ( & V_7 -> V_112 . V_68 ,
L_18 , & F_25 ( V_54 ) -> V_113 ) ;
V_108 -> V_65 [ 0 ] = & V_7 -> V_112 . V_68 ;
V_108 -> V_65 [ 1 ] = NULL ;
V_109 = & V_7 -> V_112 . V_68 ;
V_109 -> V_65 = F_22 ( sizeof( struct V_48 ) * 3 ,
V_61 ) ;
if ( ! V_109 -> V_65 ) {
F_4 ( L_33 ) ;
V_110 = - V_62 ;
...
F_27 ( V_109 -> V_65 ) ;
V_108 = & V_7 -> V_8 ;
for ( V_71 = 0 ; V_108 -> V_65 [ V_71 ] ; V_71 ++ ) {
V_70 = & V_108 -> V_65 [ V_71 ] -> V_26 ;
V_108 -> V_65 [ V_71 ] = NULL ;
F_29 ( V_70 ) ;
}
F_27 ( V_108 -> V_65 ) ;
F_29 ( V_47 ) ;
...
struct V_12 , V_101 ) ;
struct V_114 * V_115 = V_13 -> V_55 ;
struct V_53 * V_54 = V_115 -> V_56 ;
V_54 -> V_72 . V_116 ( V_13 ) ;
}
static struct V_48 * F_66 (
struct V_48 * V_49 ,
const char * V_50 )
{
struct V_114 * V_115 = F_2 ( V_49 , struct V_114 , V_117 ) ;
struct V_53 * V_54 = V_115 -> V_56 ;
struct V_12 * V_13 ;
if ( ! V_54 -> V_72 . V_118 ) {
F_4 ( L_34 ) ;
...
V_13 = V_54 -> V_72 . V_118 ( V_115 , V_49 , V_50 ) ;
if ( ! V_13 || F_32 ( V_13 ) )
return F_19 ( - V_23 ) ;
V_13 -> V_101 . V_65 = V_13 -> V_119 ;
V_13 -> V_101 . V_65 [ 0 ] = & V_13 -> V_107 ;
V_13 -> V_101 . V_65 [ 1 ] = & V_13 -> V_88 ;
V_13 -> V_101 . V_65 [ 2 ] = & V_13 -> V_74 ;
V_13 -> V_101 . V_65 [ 3 ] = & V_13 -> V_120 ;
V_13 -> V_101 . V_65 [ 4 ] = & V_13 -> V_121 ;
V_13 -> V_101 . V_65 [ 5 ] = NULL ;
F_24 ( & V_13 -> V_101 , V_50 ,
& F_25 ( V_54 ) -> V_122 ) ;
F_24 ( & V_13 -> V_107 , L_35 ,
& F_25 ( V_54 ) -> V_123 ) ;
F_24 ( & V_13 -> V_88 , L_36 ,
& F_25 ( V_54 ) -> V_124 ) ;
F_24 ( & V_13 -> V_74 , L_37 ,
& F_25 ( V_54 ) -> V_125 ) ;
F_24 ( & V_13 -> V_120 , L_21 ,
& F_25 ( V_54 ) -> V_126 ) ;
F_24 ( & V_13 -> V_121 , L_23 ,
& F_25 ( V_54 ) -> V_127 ) ;
return & V_13 -> V_101 ;
}
static void F_67 (
...
struct V_12 * V_13 = F_2 ( F_3 ( V_47 ) ,
struct V_12 , V_101 ) ;
struct V_48 * V_128 = & V_13 -> V_101 ;
struct V_1 * V_70 ;
int V_71 ;
for ( V_71 = 0 ; V_128 -> V_65 [ V_71 ] ; V_71 ++ ) {
V_70 = & V_128 -> V_65 [ V_71 ] -> V_26 ;
V_128 -> V_65 [ V_71 ] = NULL ;
F_29 ( V_70 ) ;
}
F_29 ( V_47 ) ;
}
...
{
struct V_114 * V_115 = F_2 ( F_3 ( V_47 ) ,
struct V_114 , V_117 ) ;
struct V_53 * V_54 = V_115 -> V_56 ;
V_54 -> V_72 . V_129 ( V_115 ) ;
}
...
V_115 = V_54 -> V_72 . V_131 ( V_54 , V_49 , V_50 ) ;
if ( ! V_115 || F_32 ( V_115 ) )
return F_19 ( - V_23 ) ;
V_115 -> V_56 = V_54 ;
V_115 -> V_117 . V_65 = V_115 -> V_132 ;
V_115 -> V_117 . V_65 [ 0 ] = & V_115 -> V_133 ;
V_115 -> V_117 . V_65 [ 1 ] = NULL ;
F_24 ( & V_115 -> V_117 , V_50 ,
& F_25 ( V_54 ) -> V_134 ) ;
F_24 ( & V_115 -> V_133 , L_24 ,
& F_25 ( V_54 ) -> V_135 ) ;
return & V_115 -> V_117 ;
}
static void F_70 (
...
struct V_114 , V_117 ) ;
struct V_1 * V_70 ;
struct V_48 * V_136 = & V_115 -> V_117 ;
int V_71 ;
for ( V_71 = 0 ; V_136 -> V_65 [ V_71 ] ; V_71 ++ ) {
V_70 = & V_136 -> V_65 [ V_71 ] -> V_26 ;
V_136 -> V_65 [ V_71 ] = NULL ;
F_29 ( V_70 ) ;
}
F_29 ( V_47 ) ;
}
