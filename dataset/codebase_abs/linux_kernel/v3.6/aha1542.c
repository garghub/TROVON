...
V_133 [ V_138 ] = F_56 ( V_143 , 0 ) ;
F_10 ( V_120 L_47 , V_133 [ V_138 ] ) ;
}
}
for ( V_138 = 0 ; V_138 < F_46 ( V_133 ) ; V_138 ++ )
if ( V_133 [ V_138 ] != 0 && F_57 ( V_133 [ V_138 ] , 4 , L_46 ) ) {
V_18 = F_58 ( V_136 ,
sizeof( struct V_144 ) ) ;
if( V_18 == NULL ) {
F_59 ( V_133 [ V_138 ] , 4 ) ;
...
goto V_145;
F_10 ( V_120 L_49 , V_110 , V_107 , V_108 ) ;
if ( V_109 != 0xFF )
F_10 ( L_50 , V_109 ) ;
F_10 ( L_20 ) ;
F_15 ( F_1 () ) ;
F_60 ( V_107 , V_18 ) ;
F_15 ( F_1 () ) ;
F_15 ( F_10 ( L_51 , V_108 ) ) ;
F_5 ( & V_7 , V_4 ) ;
if ( F_61 ( V_108 , F_21 , 0 ,
L_46 , V_18 ) ) {
F_10 ( V_9 L_52 ) ;
F_7 ( & V_7 , V_4 ) ;
goto V_145;
...
static int F_67 ( struct V_17 * V_35 )
{
if ( V_35 -> V_157 )
F_63 ( V_35 -> V_157 , V_35 ) ;
if ( V_35 -> V_156 != 0xff )
F_68 ( V_35 -> V_156 ) ;
if ( V_35 -> V_49 && V_35 -> V_155 )
F_59 ( V_35 -> V_49 , V_35 -> V_155 ) ;
F_66 ( V_35 ) ;
return 0 ;
}
...
! ( F_24 ( V_35 ) -> V_62 [ V_70 ] -> V_79 -> V_159 ) ) {
#if 0
HOSTDATA(shost)->mb[i].status = 1;
#endif
V_134 ++ ;
}
F_10 ( V_50 L_55 , V_134 ) ;
#if 0
if (count)
...
static int F_72 ( T_4 * V_72 )
{
int V_70 ;
F_8 ( V_162 , F_18 ( V_72 -> V_79 -> V_83 -> V_49 ) ) ;
F_73 ( 4 ) ;
F_74 ( V_72 -> V_79 -> V_83 -> V_36 ) ;
F_3 ( F_4 ( V_72 -> V_79 -> V_83 -> V_49 ) ,
V_25 , V_26 | V_27 , V_28 | V_29 | V_30 | V_10 | V_6 ) ;
F_10 ( V_58 L_58 , V_72 -> V_79 -> V_83 -> V_163 ) ;
for ( V_70 = 0 ; V_70 < V_56 ; V_70 ++ ) {
...
F_75 ( V_72 -> V_79 -> V_83 -> V_36 ) ;
return V_160 ;
V_8:
F_75 ( V_72 -> V_79 -> V_83 -> V_36 ) ;
return V_161 ;
}
static int F_76 ( T_4 * V_72 )
{
int V_70 ;
F_8 ( V_164 | V_162 , F_18 ( V_72 -> V_79 -> V_83 -> V_49 ) ) ;
F_73 ( 4 ) ;
F_74 ( V_72 -> V_79 -> V_83 -> V_36 ) ;
F_3 ( F_4 ( V_72 -> V_79 -> V_83 -> V_49 ) ,
V_25 , V_26 | V_27 , V_28 | V_29 | V_30 | V_10 | V_6 ) ;
F_60 ( V_72 -> V_79 -> V_83 -> V_49 , V_72 -> V_79 -> V_83 ) ;
F_10 ( V_58 L_58 , V_72 -> V_79 -> V_83 -> V_163 ) ;
for ( V_70 = 0 ; V_70 < V_56 ; V_70 ++ ) {
if ( F_24 ( V_72 -> V_79 -> V_83 ) -> V_62 [ V_70 ] != NULL ) {
T_4 * V_43 ;
...
static int F_77 ( struct V_165 * V_166 ,
struct V_167 * V_168 , T_5 V_169 , int * V_170 )
{
int V_171 ;
int V_172 = V_169 ;
V_171 = F_24 ( V_166 -> V_83 ) -> V_158 ;
if ( ( V_172 >> 11 ) > 1024 && V_171 == V_118 ) {
V_170 [ 0 ] = 255 ;
V_170 [ 1 ] = 63 ;
V_170 [ 2 ] = V_172 / 255 / 63 ;
} else {
V_170 [ 0 ] = 64 ;
V_170 [ 1 ] = 32 ;
V_170 [ 2 ] = V_172 >> 11 ;
