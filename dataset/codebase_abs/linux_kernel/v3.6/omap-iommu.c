...
V_102 -> V_137 = V_136 ;
V_102 -> V_152 . V_153 = 0 ;
V_102 -> V_152 . V_154 = ( 1ULL << 32 ) - 1 ;
V_102 -> V_152 . V_155 = true ;
return 0 ;
V_151:
F_35 ( V_136 ) ;
V_46:
...
T_1 * V_156 , * V_157 ;
T_7 V_141 = 0 ;
F_69 ( V_138 , V_28 , & V_156 , & V_157 ) ;
if ( V_157 ) {
if ( F_118 ( * V_157 ) )
V_141 = F_119 ( * V_157 , V_28 , V_158 ) ;
else if ( F_120 ( * V_157 ) )
V_141 = F_119 ( * V_157 , V_28 , V_83 ) ;
else
F_62 ( V_7 , L_27 , * V_157 , V_28 ) ;
} else {
if ( F_121 ( * V_156 ) )
V_141 = F_119 ( * V_156 , V_28 , V_75 ) ;
else if ( F_122 ( * V_156 ) )
V_141 = F_119 ( * V_156 , V_28 , V_78 ) ;
else
F_62 ( V_7 , L_28 , * V_156 , V_28 ) ;
}
return V_141 ;
}
...
{
struct V_160 * V_58 ;
const unsigned long V_142 = V_161 ;
T_3 V_162 = 1 << 10 ;
V_58 = F_125 ( L_29 , V_134 , V_162 , V_142 ,
F_105 ) ;
if ( ! V_58 )
return - V_71 ;
V_67 = V_58 ;
