...
break;
case V_101 :
V_54 = F_10 ( V_77 [ 0 ] . V_96 , & V_57 -> V_31 ) ;
if ( V_54 == 0 )
V_57 -> V_81 |= V_102 ;
break;
case V_103 :
V_57 -> V_44 = F_31 ( V_77 [ 0 ] . V_96 ,
...
V_54 = F_32 ( V_57 -> V_45 , V_77 [ 0 ] . V_96 ) ;
if ( V_54 < 0 )
goto V_68;
break;
case V_105 :
...
V_54 = F_15 ( V_57 -> V_45 , V_77 [ 0 ] . V_96 ) ;
if ( V_54 < 0 )
goto V_68;
break;
case V_106 :
...
V_29 -> V_132 . V_136 && V_29 -> V_132 . V_136 -> V_135 ;
}
int F_48 ( struct V_28 * V_29 , unsigned long V_137 )
{
int V_54 ;
unsigned long V_138 = V_29 -> V_39 -> V_87 * V_139 ;
V_54 = F_49 ( & V_29 -> V_50 ) ;
if ( V_54 < 0 )
return V_54 ;
while ( ! F_47 ( V_29 ) ) {
V_54 = - V_140 ;
if ( V_138 && F_50 ( V_141 , V_137 + V_138 ) )
return V_54 ;
F_11 ( L_46 ) ;
V_54 = F_51 ( V_29 -> V_123 ,
F_47 ( V_29 ) || ( V_29 -> V_124 < 0 ) ,
V_138 ) ;
