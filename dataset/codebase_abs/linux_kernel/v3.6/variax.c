...
unsigned long V_70 ;
int V_71 ;
V_71 = F_30 ( V_35 , 10 , & V_70 ) ;
if ( V_71 )
return V_71 ;
if ( F_31 ( & V_5 -> V_9 , V_70 ) == 0 )
V_5 -> V_45 = V_70 ;
return V_69 ;
}
...
static T_1 F_35 ( struct V_65 * V_66 ,
struct V_67 * V_68 ,
const char * V_35 , T_2 V_69 )
{
struct V_4 * V_5 =
...
static T_1 F_36 ( char * V_35 , const char * V_2 , int V_72 )
{
int V_73 ;
...
static T_1 F_37 ( struct V_65 * V_66 ,
struct V_67 * V_68 , char * V_35 )
{
struct V_4 * V_5 =
F_23 ( F_24 ( V_66 ) ) ;
F_38 ( & V_5 -> V_27 ) ;
return F_36 ( V_35 , V_5 -> V_53 . V_54 ,
...
F_23 ( F_24 ( V_66 ) ) ;
F_38 ( & V_5 -> V_27 ) ;
return F_36 ( V_35 , V_5 -> V_59 , sizeof( V_5 -> V_59 ) ) ;
}
...
static T_1 F_41 ( struct V_65 * V_66 ,
struct V_67 * V_68 , char * V_35 )
{
struct V_4 * V_5 =
F_23 ( F_24 ( V_66 ) ) ;
...
static char * F_42 ( struct V_4 * V_5 ,
int V_76 , int V_77 )
{
return F_43 ( & V_5 -> V_9 , V_78 , V_76 ,
V_77 ) ;
}
static T_1 F_44 ( struct V_65 * V_66 ,
struct V_67 * V_68 ,
const char * V_35 , T_2 V_69 )
{
struct V_4 * V_5 =
...
return - V_97 ;
V_86 = F_59 ( & V_5 -> V_27 , V_48 ,
sizeof( V_48 ) ) ;
if ( V_86 < 0 ) {
F_20 ( & V_85 -> V_66 , L_6 ) ;
return V_86 ;
}
V_86 = F_60 ( & V_5 -> V_27 , V_98 ,
sizeof( V_98 ) , 1 ) ;
if ( V_86 < 0 ) {
F_20 ( & V_85 -> V_66 , L_6 ) ;
return V_86 ;
}
V_86 = F_60 ( & V_5 -> V_27 , V_58 ,
sizeof( V_58 ) , 2 ) ;
if ( V_86 < 0 ) {
F_20 ( & V_85 -> V_66 , L_6 ) ;
return V_86 ;
