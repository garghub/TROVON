...
V_50 = F_35 ( V_2 ) ;
V_48 = & ( F_36 ( V_2 ) -> V_48 ) ;
if ( V_50 -> V_51 < 5 || V_50 -> V_52 != 4 )
goto V_53;
if ( ! F_37 ( V_2 , V_50 -> V_51 * 4 ) )
goto V_53;
V_50 = F_35 ( V_2 ) ;
if ( F_38 ( F_39 ( ( V_54 * ) V_50 , V_50 -> V_51 ) ) )
goto V_53;
V_39 = F_40 ( V_50 -> V_55 ) ;
if ( V_2 -> V_39 < V_39 ) {
F_41 ( F_42 ( V_16 ) , V_56 ) ;
goto V_57;
} else if ( V_39 < ( V_50 -> V_51 * 4 ) )
goto V_53;
if ( F_43 ( V_2 , V_39 ) ) {
F_41 ( F_42 ( V_16 ) , V_58 ) ;
goto V_57;
}
memset ( F_36 ( V_2 ) , 0 , sizeof( struct V_59 ) ) ;
if ( V_50 -> V_51 == 5 )
return 0 ;
V_48 -> V_60 = V_50 -> V_51 * 4 - sizeof( struct V_49 ) ;
...
return V_108 ;
if ( ! F_37 ( V_2 , sizeof( struct V_103 ) ) )
return V_108 ;
V_107 = F_76 ( V_2 ) ;
if ( V_107 -> V_52 != 6 )
return V_108 ;
