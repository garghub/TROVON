...
static int T_4 F_21 ( struct V_51 * V_25 ,
...
case 6 :
snprintf ( V_60 , sizeof( V_60 ) , L_15 ) ;
break;
case 11 :
snprintf ( V_60 , sizeof( V_60 ) , L_16 ) ;
break;
default:
snprintf ( V_60 , sizeof( V_60 ) , L_17 ) ;
break;
}
...
static T_5 void F_37 ( struct V_51 * V_25 )
{
...
static int F_41 ( struct V_51 * V_25 , T_6 V_89 )
{
struct V_10 * V_11 = F_38 ( V_25 ) ;
int V_54 ;
if ( V_11 ) {
...
F_15 ( & V_25 -> V_25 , L_26 ) ;
V_54 = F_18 ( V_11 , V_90 , sizeof( V_90 ) ) ;
if ( V_54 < 0 ) {
F_12 ( & V_25 -> V_25 , L_27 ) ;
return V_54 ;
}
