...
struct V_7 * F_11 ( struct V_6 * V_12 , const char * V_3 )
{
struct V_7 * V_8 = NULL ;
struct V_1 * V_1 = F_12 ( & V_12 -> V_2 , V_3 ) ;
if ( V_1 )
V_8 = F_2 ( V_1 , struct V_7 , V_1 ) ;
return V_8 ;
}
static int F_13 ( struct V_6 * V_11 , const char * V_4 )
{
if ( strncmp ( V_4 , L_2 , 7 ) == 0 )
return F_9 ( V_11 , V_4 + 7 ) ;
return F_7 ( V_11 , V_4 ) ;
}
int F_14 ( struct V_6 * V_11 , const char * V_4 )
{
char * V_21 ;
int V_16 ;
...
return * V_4 ? F_13 ( V_11 , V_4 ) : 0 ;
}
struct V_6 * F_15 ( bool V_9 , const char * V_12 )
{
...
void F_17 ( struct V_6 * V_11 )
{
if ( V_11 != NULL )
F_18 ( & V_11 -> V_2 ) ;
}
struct V_7 * F_19 ( const struct V_6 * V_12 , unsigned int V_26 )
{
struct V_7 * V_8 = NULL ;
struct V_1 * V_1 ;
V_1 = F_20 ( & V_12 -> V_2 , V_26 ) ;
if ( V_1 )
V_8 = F_2 ( V_1 , struct V_7 , V_1 ) ;
return V_8 ;
}
