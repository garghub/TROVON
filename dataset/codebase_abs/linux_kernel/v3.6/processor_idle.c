...
struct V_15 * V_16 ;
struct V_119 * V_120 ;
struct V_113 * V_41 = & V_14 -> V_19 . V_41 ;
if ( ! V_14 -> V_51 . V_133 )
return - V_47 ;
if ( V_14 -> V_51 . V_19 == 0 ) {
return - V_47 ;
...
struct V_15 * V_16 ;
struct V_137 * V_12 ;
struct V_114 * V_115 = & V_138 ;
if ( ! V_14 -> V_51 . V_133 )
return - V_47 ;
if ( V_14 -> V_51 . V_19 == 0 )
return - V_47 ;
V_115 -> V_127 = - 1 ;
for ( V_66 = 0 ; V_66 < V_135 ; V_66 ++ ) {
V_115 -> V_33 [ V_66 ] . V_139 [ 0 ] = '\0' ;
...
snprintf ( V_12 -> V_139 , V_140 , L_21 , V_66 ) ;
strncpy ( V_12 -> V_94 , V_16 -> V_94 , V_141 ) ;
V_12 -> V_142 = V_16 -> V_54 ;
V_12 -> V_143 = V_16 -> V_54 * V_144 ;
V_12 -> V_51 = 0 ;
switch ( V_16 -> type ) {
case V_25 :
if ( V_16 -> V_61 == V_93 )
...
if ( ! V_14 -> V_51 . V_133 )
return - V_49 ;
if ( V_14 -> V_6 == 0 && F_79 () == & V_138 ) {
F_74 () ;
F_80 () ;
F_81 (cpu) {
V_148 = F_82 ( V_122 , V_134 ) ;
if ( ! V_148 || ! V_148 -> V_51 . V_133 )
continue;
F_75 ( & V_148 -> V_19 . V_41 ) ;
}
F_72 ( V_14 ) ;
F_81 (cpu) {
V_148 = F_82 ( V_122 , V_134 ) ;
