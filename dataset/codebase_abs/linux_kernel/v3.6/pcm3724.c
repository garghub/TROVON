...
struct V_53 * V_54 )
{
const struct V_55 * V_56 = F_10 ( V_19 ) ;
unsigned long V_5 ;
unsigned int V_57 ;
int V_58 , V_59 , V_60 ;
V_5 = V_54 -> V_61 [ 0 ] ;
V_57 = V_56 -> V_62 ;
V_58 = F_11 ( V_19 , sizeof( struct V_32 ) ) ;
if ( V_58 < 0 )
return - V_63 ;
( (struct V_32 * ) ( V_19 -> V_34 ) ) -> V_35 = 0 ;
( (struct V_32 * ) ( V_19 -> V_34 ) ) -> V_36 = 0 ;
F_12 ( V_64 L_1 , V_19 -> V_65 ,
V_56 -> V_66 , V_5 ) ;
if ( ! V_5 || ! F_13 ( V_5 , V_57 , L_2 ) ) {
F_12 ( L_3 ) ;
return - V_67 ;
}
V_19 -> V_5 = V_5 ;
...
if ( V_58 )
return V_58 ;
for ( V_59 = 0 ; V_59 < V_19 -> V_60 ; V_59 ++ ) {
F_15 ( V_19 , V_19 -> V_27 + V_59 , F_1 ,
( unsigned long ) ( V_19 -> V_5 + V_29 * V_59 ) ) ;
( ( V_19 -> V_27 ) + V_59 ) -> V_70 = F_8 ;
}
return 0 ;
}
...
if ( V_19 -> V_27 ) {
for ( V_59 = 0 ; V_59 < V_19 -> V_60 ; V_59 ++ )
F_17 ( V_19 , V_19 -> V_27 + V_59 ) ;
}
if ( V_19 -> V_5 )
F_18 ( V_19 -> V_5 , V_56 -> V_62 ) ;
}
