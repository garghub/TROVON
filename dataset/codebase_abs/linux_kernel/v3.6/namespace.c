...
struct V_46 * V_47 )
{
return F_29 ( & V_48 , 0 , V_45 , V_47 ) ;
}
struct V_20 * F_30 ( struct V_2 * V_2 , struct V_26 * V_27 ,
struct V_28 * V_29 , T_2 V_49 )
{
struct V_46 V_47 = {
. V_50 = V_2 -> V_51 ,
. V_2 = V_2 ,
...
if ( V_52 == NULL )
goto V_33;
V_45 = F_32 ( V_2 , V_52 , V_54 ) ;
V_22 = (struct V_20 * ) V_45 ;
if ( F_16 ( V_45 ) )
goto V_55;
V_22 = F_28 ( F_33 ( V_2 -> V_51 ) , V_45 , & V_47 ) ;
V_55:
...
struct V_20 * F_34 ( struct V_23 * V_24 , struct V_2 * V_2 ,
struct V_26 * V_27 , struct V_28 * V_29 )
{
int V_56 ;
struct V_2 * V_57 = F_35 ( V_2 ) ;
V_56 = V_24 -> V_35 -> V_36 -> V_58 ( V_57 -> V_25 , & V_2 -> V_12 , V_27 , V_29 ) ;
F_36 ( V_57 ) ;
if ( V_56 != 0 )
return F_10 ( V_56 ) ;
return F_30 ( V_2 , V_27 , V_29 , V_24 -> V_59 -> V_60 -> V_61 ) ;
}
