...
V_5 -> V_12 , V_44 , V_14 ) ;
#endif
if ( ( V_5 -> V_12 >= ( unsigned long ) V_82 &&
V_5 -> V_12 < ( unsigned long ) V_83 ) ||
( V_5 -> V_12 >= ( unsigned long ) V_84 &&
V_5 -> V_12 < ( unsigned long ) V_85 ) ) {
V_5 -> V_24 [ V_86 ] = V_1 ;
V_5 -> V_24 [ V_87 ] = V_5 -> V_12 ;
}
V_5 -> V_24 [ V_81 ] = V_14 ;
V_5 -> V_12 = V_44 ;
V_5 -> V_17 = V_5 -> V_12 + 4 ;
...
V_59:
F_27 ( & V_8 -> V_57 ) ;
F_11 ( V_20 , V_80 , V_3 -> V_96 . V_97 , V_1 ) ;
return;
V_73:
F_27 ( & V_8 -> V_57 ) ;
F_11 ( V_89 , V_90 , V_3 -> V_96 . V_97 , V_1 ) ;
}
static void F_37 ( unsigned long V_98 )
{
if ( V_98 & 0x7UL )
F_38 ( V_99 , V_18 ) ;
}
...
unsigned long V_98 ;
V_98 = F_40 () -> V_100 [ 0 ] ;
if ( ( ( V_98 + 0x38 ) & V_101 ) != ( V_98 & V_101 ) )
F_36 ( V_98 + 0x38 , 1 ) ;
F_36 ( V_98 , 1 ) ;
F_37 ( V_98 ) ;
}
void F_41 ( unsigned long V_98 )
{
if ( ( ( V_98 + 0x38 ) & V_101 ) != ( V_98 & V_101 ) )
F_36 ( V_98 + 0x38 , 0 ) ;
F_36 ( V_98 , 0 ) ;
