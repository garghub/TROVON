...
int T_2 F_26 ( struct V_2 * V_3 ,
struct V_41 * V_42 )
{
int V_45 ;
F_16 ( V_3 , V_3 -> V_10 -> V_4 , V_42 ) ;
if ( V_42 && ( V_42 -> V_60 || V_42 -> V_61 ) ) {
F_27 ( V_3 -> V_10 , V_62 , 1 , 1 ) ;
F_27 ( V_3 -> V_19 , V_63 , 3 , 2 ) ;
do {
V_45 = F_4 ( V_3 -> V_19 , V_53 ) ;
} while ( V_45 & V_64 );
F_27 ( V_3 -> V_19 , V_65 , 3 , 2 ) ;
}
F_27 ( V_3 -> V_17 , V_66 , 1 << 4 , 1 << 4 ) ;
V_45 = F_28 ( V_3 -> V_39 , 0 , & V_67 [ 0 ] ,
F_3 ( V_67 ) ,
& V_68 [ 0 ] , V_3 -> V_6 , NULL ) ;
if ( V_45 < 0 ) {
F_11 ( V_3 -> V_39 , L_9 ) ;
