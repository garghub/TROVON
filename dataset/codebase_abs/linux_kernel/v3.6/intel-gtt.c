...
T_1 V_163 ;
int V_164 ;
V_164 = V_15 . V_50 -> V_165 () ;
if ( V_164 != 0 )
return V_164 ;
V_15 . V_66 . V_153 = F_57 () ;
V_15 . V_66 . V_166 = F_55 () ;
V_15 . V_167 =
F_29 ( V_15 . V_34 + V_36 )
& ~ V_35 ;
if ( V_168 )
...
if ( V_83 <= 2 )
F_24 ( V_15 . V_16 , V_170 ,
& V_162 ) ;
else
F_24 ( V_15 . V_16 , V_171 ,
& V_162 ) ;
V_15 . V_66 . V_172 = ( V_162 & V_173 ) ;
return 0 ;
}
...
unsigned int V_176 ;
int V_10 ;
V_176 = ( V_15 . V_66 . V_153 << V_49 )
/ F_49 ( 1 ) ;
for ( V_10 = 0 ; V_10 < V_174 ; V_10 ++ ) {
if ( V_176 == V_175 [ V_10 ] . V_133 ) {
V_27 -> V_177 =
( void * ) ( V_175 + V_10 ) ;
return V_176 ;
}
...
F_70 () ;
F_27 ( F_29 ( V_15 . V_34 + V_180 ) | ( 1 << 31 ) ,
V_15 . V_34 + V_180 ) ;
while ( F_29 ( V_15 . V_34 + V_180 ) & ( 1 << 31 ) ) {
if ( F_71 ( V_179 , V_178 ) )
break;
F_72 ( 50 ) ;
}
...
V_181 = V_15 . V_34 + V_36 ;
F_27 ( V_15 . V_167 , V_181 ) ;
if ( V_168 && ( F_29 ( V_181 ) & V_35 ) == 0 ) {
F_76 ( & V_15 . V_16 -> V_42 ,
L_12 ,
F_29 ( V_181 ) , V_15 . V_167 ) ;
return false ;
}
if ( V_83 >= 3 )
F_27 ( 0 , V_15 . V_34 + V_183 ) ;
...
if ( V_19 -> V_20 == 0 )
goto V_200;
if ( V_45 + V_19 -> V_20 > V_15 . V_66 . V_166 )
goto V_201;
if ( type != V_19 -> type )
goto V_201;
...
{
int V_164 ;
V_164 = F_92 ( V_15 . V_84 -> V_203 , & V_15 . V_204 , V_14 ,
V_14 , V_205 , 0 ,
V_206 , V_15 . V_84 ) ;
return V_164 ;
}
...
static void F_107 ( T_3 V_48 , unsigned int V_70 ,
unsigned int V_71 )
{
unsigned int V_218 = V_71 & ~ V_219 ;
unsigned int V_220 = V_71 & V_219 ;
...
{
#ifdef F_110
const unsigned short V_228 = V_15 . V_16 -> V_86 ;
if ( ( V_228 == V_229 ||
V_228 == V_230 ) &&
V_231 )
return 1 ;
...
T_1 V_29 ;
int V_133 = F_26 ( 512 ) ;
F_24 ( V_15 . V_16 , V_232 , & V_29 ) ;
V_29 &= 0xfff80000 ;
if ( V_83 >= 7 )
V_133 = F_49 ( 2 ) ;
V_15 . V_34 = F_25 ( V_29 , V_133 ) ;
if ( ! V_15 . V_34 )
return - V_18 ;
if ( V_83 == 3 ) {
T_1 V_233 ;
...
static int F_112 ( T_5 V_86 )
{
struct V_236 * V_237 ;
V_237 = F_113 ( V_238 , V_86 , NULL ) ;
if ( V_237 && F_114 ( V_237 -> V_239 ) != 0 ) {
V_237 = F_113 ( V_238 ,
V_86 , V_237 ) ;
}
if ( ! V_237 )
...
int F_115 ( struct V_236 * V_240 , struct V_236 * V_241 ,
struct V_23 * V_24 )
{
int V_10 , V_242 ;
if ( V_15 . V_50 ) {
...
for ( V_10 = 0 ; V_244 [ V_10 ] . V_215 != NULL ; V_10 ++ ) {
if ( V_241 ) {
if ( V_241 -> V_86 ==
V_244 [ V_10 ] . V_245 ) {
V_15 . V_16 = F_116 ( V_241 ) ;
V_15 . V_50 =
V_244 [ V_10 ] . V_246 ;
break;
}
} else if ( F_112 ( V_244 [ V_10 ] . V_245 ) ) {
V_15 . V_50 =
V_244 [ V_10 ] . V_246 ;
break;
}
...
V_15 . V_84 = F_116 ( V_240 ) ;
F_30 ( & V_240 -> V_42 , L_15 , V_244 [ V_10 ] . V_215 ) ;
V_242 = V_15 . V_50 -> V_249 ;
if ( F_117 ( V_15 . V_16 , F_118 ( V_242 ) ) )
F_76 ( & V_15 . V_16 -> V_42 ,
L_16 , V_242 ) ;
else
F_119 ( V_15 . V_16 ,
