...
V_5 -> V_10 [ 2 ] , V_5 -> V_10 [ 3 ] ,
V_5 -> V_10 [ 4 ] , V_5 -> V_10 [ 5 ] ,
V_5 -> V_10 [ 6 ] ) ;
V_8 = F_3 ( V_5 -> V_14 ,
F_4 ( V_5 -> V_14 , V_15 ) ,
V_5 -> V_10 , V_11 ,
...
{
struct V_39 * V_13 = F_25 ( V_38 ) ;
struct V_4 * V_5 = F_26 ( V_13 ) ;
F_27 ( & V_5 -> V_2 . V_40 ) ;
F_28 ( & V_5 -> V_13 ) ;
F_29 ( & V_5 -> V_2 ) ;
F_30 ( & V_5 -> V_2 . V_40 ) ;
...
static void F_32 ( struct V_39 * V_13 )
{
struct V_4 * V_5 = F_26 ( V_13 ) ;
F_33 ( & V_5 -> V_13 ) ;
F_34 ( V_5 -> V_10 ) ;
...
struct V_4 * V_5 ;
int V_33 = - V_43 ;
V_5 = F_36 ( sizeof( struct V_4 ) , V_44 ) ;
if ( ! V_5 )
return V_33 ;
V_5 -> V_10 = F_37 ( V_11 , V_44 ) ;
if ( ! V_5 -> V_10 )
goto V_45;
F_38 ( & V_5 -> V_13 , V_46 , & V_47 ) ;
V_33 = F_17 ( V_5 , & V_38 -> V_32 ) ;
if ( V_33 )
goto V_48;
V_5 -> V_13 . V_49 = F_32 ;
V_33 = F_39 ( & V_38 -> V_32 , & V_5 -> V_13 ) ;
if ( V_33 ) {
F_5 ( & V_5 -> V_13 , L_9 ) ;
goto V_50;
}
...
V_5 -> V_2 . V_53 = true ;
V_5 -> V_2 . V_54 = true ;
F_41 ( V_5 -> V_2 . V_55 , L_10 ,
sizeof( V_5 -> V_2 . V_55 ) ) ;
F_42 ( V_5 -> V_14 , V_5 -> V_2 . V_56 ,
sizeof( V_5 -> V_2 . V_56 ) ) ;
V_33 = F_43 ( & V_5 -> V_2 , V_57 ) ;
if ( V_33 ) {
F_5 ( & V_5 -> V_13 , L_11 ) ;
goto V_58;
}
