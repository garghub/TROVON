...
struct V_126 * V_4 =
(struct V_126 * ) V_3 -> V_127 -> V_4 ;
F_21 ( & V_3 -> V_41 -> V_3 , L_3 , V_49 ) ;
V_116 = V_115 -> V_128 -> V_129 . V_130 ;
V_117 = V_115 -> V_128 -> V_129 . V_131 ;
if ( V_117 != 3 ) {
...
V_5 -> V_2 = V_3 ;
V_5 -> V_46 = V_116 ;
V_3 -> V_10 -> V_132 = & V_133 ;
V_3 -> V_10 -> V_134 [ V_135 - 2 ] = F_56 ( & V_136 ) ;
V_3 -> V_10 -> V_134 [ V_135 - 1 ] = V_116 ;
V_120 = (struct V_119 * ) V_5 -> V_137 ;
memcpy ( & V_120 -> V_138 , V_3 -> V_10 -> V_134 , V_135 ) ;
V_120 -> V_12 = F_4 ( V_9 ) ;
memcpy ( V_5 -> V_124 , V_123 , sizeof( V_5 -> V_124 ) ) ;
F_22 ( V_5 , 0 ) ;
V_3 -> V_139 = V_4 -> V_139 ;
if ( V_3 -> V_41 -> V_140 != V_141 )
V_3 -> V_139 = F_57 ( V_142 , 4096 , V_4 -> V_139 ) ;
V_3 -> V_10 -> V_143 += V_32 ;
...
F_64 ( V_7 , V_22 . V_33 ) ;
memcpy ( V_7 -> V_4 , F_1 ( V_3 ) -> V_137 ,
V_11 ) ;
if ( V_22 . V_27 . V_17 == V_7 -> V_53 )
return 1 ;
V_151 = F_62 ( V_3 , V_7 , V_22 . V_27 . V_17 ) ;
if ( V_151 )
F_69 ( V_3 , V_151 ) ;
}
return 0 ;
