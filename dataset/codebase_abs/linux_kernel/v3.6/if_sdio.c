...
V_4 = F_47 ( V_2 -> V_19 , & V_2 -> V_6 -> V_76 , V_2 -> V_11 ,
V_77 , F_42 ) ;
V_25:
F_12 ( V_22 , L_2 , V_4 ) ;
return V_4 ;
...
F_7 ( L_24 ) ;
if ( F_49 ( V_19 , V_84 , & V_83 , sizeof( V_83 ) ,
...
T_2 V_96 ;
V_6 -> V_2 -> V_97 |= V_98 ;
V_96 = F_58 ( V_6 , V_99 , & V_4 ) ;
if ( V_4 )
goto V_100;
V_96 |= V_101 ;
F_59 ( V_6 , V_96 , V_99 , & V_4 ) ;
if ( V_4 )
goto V_100;
}
...
memset ( & V_83 , 0 , sizeof( V_83 ) ) ;
F_7 ( L_28 ) ;
V_4 = F_49 ( V_19 , V_110 , & V_83 , sizeof( V_83 ) ,
V_85 , ( unsigned long ) & V_83 ) ;
if ( V_4 )
F_65 ( V_19 -> V_76 , L_29 ) ;
F_22 ( 200 ) ;
...
static int F_83 ( struct V_78 * V_6 ,
...
F_86 ( & V_2 -> V_56 , F_27 ) ;
F_87 ( & V_2 -> V_87 ) ;
for ( V_21 = 0 ; V_21 < F_88 ( V_77 ) ; V_21 ++ ) {
...
static void F_93 ( struct V_78 * V_6 )
{
struct V_1 * V_2 ;
struct V_54 * V_55 ;
F_6 ( V_22 ) ;
...
static int F_97 ( struct V_131 * V_76 )
{
struct V_78 * V_6 = F_98 ( V_76 ) ;
int V_4 ;
struct V_1 * V_2 = F_81 ( V_6 ) ;
T_5 V_20 = F_99 ( V_6 ) ;
if ( ! F_100 ( V_2 -> V_19 ) )
return - V_142 ;
F_101 ( V_76 , L_44 ,
...
if ( V_4 )
return V_4 ;
return F_104 ( V_6 , V_146 ) ;
}
static int F_106 ( struct V_131 * V_76 )
{
struct V_78 * V_6 = F_98 ( V_76 ) ;
struct V_1 * V_2 = F_81 ( V_6 ) ;
int V_4 ;
F_101 ( V_76 , L_47 , F_102 ( V_6 ) ) ;
V_4 = F_107 ( V_2 -> V_19 ) ;
return V_4 ;
}
