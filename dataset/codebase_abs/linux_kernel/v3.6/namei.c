...
static struct V_1 * F_6 ( struct V_2 * V_4 , struct V_1 * V_1 , unsigned int V_5 )
{
struct V_2 * V_2 = NULL ;
T_1 V_6 ;
if ( V_1 -> V_7 . V_8 > V_9 )
...
static int F_13 ( struct V_2 * V_4 , struct V_1 * V_1 , T_2 V_12 ,
bool V_13 )
{
struct V_2 * V_2 ;
int V_3 ;
...
static int F_19 ( struct V_2 * V_4 , struct V_1 * V_1 , T_2 V_12 , T_3 V_21 )
{
struct V_2 * V_2 ;
int V_3 ;
if ( ! F_20 ( V_21 ) )
