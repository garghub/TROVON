...
static int F_169 ( struct V_191 * V_296 )
{
struct V_289 * V_143 = F_170 ( V_296 ) ;
struct V_288 * V_111 = F_171 ( V_296 ) ;
...
F_173 ( V_2 -> V_205 ) ;
F_174 ( V_2 -> V_15 ) ;
for ( V_25 = 0 ; V_25 < V_351 ; V_25 ++ )
V_2 -> V_344 [ V_25 ] = F_9 ( V_2 , V_352 [ V_25 ] ) ;
V_2 -> V_353 = F_9 ( V_2 , V_33 ) ;
F_175 ( V_2 -> V_143 , V_354 ,
& V_2 -> V_355 ) ;
...
static int F_178 ( struct V_191 * V_296 )
{
struct V_289 * V_143 = F_170 ( V_296 ) ;
struct V_288 * V_111 = F_171 ( V_296 ) ;
struct V_1 * V_2 = V_111 -> V_16 ;
...
F_184 ( 100 ) ;
for ( V_25 = 0 ; V_25 < V_351 ; V_25 ++ )
F_11 ( V_2 , V_352 [ V_25 ] , V_2 -> V_344 [ V_25 ] ) ;
F_185 ( V_2 -> V_15 ) ;
F_151 ( V_2 -> V_143 , V_354 ,
V_2 -> V_355 ) ;
F_151 ( V_2 -> V_143 , V_356 ,
V_2 -> V_357 ) ;
if ( V_2 -> V_31 > 0 ) {
F_52 ( & V_2 -> V_30 ) ;
F_11 ( V_2 , V_33 , V_2 -> V_353 ) ;
...
#ifdef F_160
V_2 -> V_344 = F_193 ( V_351 * sizeof( T_2 ) ) ;
if ( V_2 -> V_344 == NULL ) {
F_159 ( V_2 ) ;
return - V_56 ;
}
