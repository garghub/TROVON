...
static void F_37 ( struct V_19 * V_20 , int V_183 )
{
char V_180 [ 32 ] ;
int V_181 ;
T_4 V_184 ;
...
int V_25 ;
struct V_191 * V_192 ;
struct V_193 * V_194 , * V_10 ;
F_39 ( & V_20 -> V_195 ) ;
if ( V_20 -> V_196 [ 0 ] != 0 ) {
if ( F_32 ( V_20 , 0 , V_197 ,
V_20 -> V_196 ,
sizeof( V_20 -> V_196 ) ) < 0 )
F_11 ( ERROR , L_131 ) ;
}
...
F_40 ( V_20 , 0 , V_198 , V_4 , sizeof( V_4 ) ) ;
F_30 ( & V_186 , L_95 ) ;
F_11 ( ERROR , L_133 , V_4 ) ;
F_1 ( L_134 , ( char * ) & V_188 , 4 , V_180 ,
sizeof( V_180 ) ) ;
F_32 ( V_20 , 0 , V_165 , V_180 ,
sizeof( V_180 ) ) ;
F_1 ( L_135 , ( char * ) & V_187 , 4 ,
V_180 , sizeof( V_180 ) ) ;
F_32 ( V_20 , 0 , V_165 , V_180 ,
sizeof( V_180 ) ) ;
F_1 ( L_136 , V_20 -> V_199 , V_185 ,
V_180 , sizeof( V_180 ) ) ;
F_32 ( V_20 , 0 , V_165 , V_180 ,
sizeof( V_180 ) ) ;
F_32 ( V_20 , 0 , V_200 ,
( char * ) & V_189 , sizeof( V_189 ) ) ;
F_32 ( V_20 , 0 , V_201 ,
( char * ) & V_190 , sizeof( V_190 ) ) ;
F_36 ( V_20 , V_202 ) ;
F_37 ( V_20 , true ) ;
for ( V_25 = 0 ; V_25 < V_20 -> V_203 ; V_25 ++ ) {
F_34 ( V_20 , V_20 -> V_204 [ V_25 ] ) ;
F_28 ( V_20 , V_20 -> V_204 [ V_25 ] ,
0 , true ) ;
}
F_41 (cur, q, &drvr->bus_if->dcmd_list) {
V_192 = F_42 ( V_194 , struct V_191 , V_205 ) ;
if ( V_192 -> V_1 && V_192 -> V_206 && V_192 -> V_207 ) {
F_1 ( V_192 -> V_1 , V_192 -> V_206 ,
V_192 -> V_207 , V_180 ,
sizeof( V_180 ) ) ;
F_32 ( V_20 , 0 , V_165 ,
V_180 , sizeof( V_180 ) ) ;
