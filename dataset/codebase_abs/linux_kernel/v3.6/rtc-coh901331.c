...
static int T_3 F_21 ( struct V_26 * V_27 )
{
int V_28 ;
struct V_3 * V_4 ;
struct V_29 * V_30 ;
...
if ( ! V_4 )
return - V_32 ;
V_30 = F_23 ( V_27 , V_33 , 0 ) ;
if ( ! V_30 )
return - V_34 ;
V_4 -> V_35 = V_30 -> V_36 ;
V_4 -> V_37 = F_24 ( V_30 ) ;
if ( F_25 ( & V_27 -> V_13 , V_4 -> V_35 , V_4 -> V_37 ,
L_1 ) == NULL )
return - V_38 ;
V_4 -> V_6 = F_26 ( & V_27 -> V_13 , V_4 -> V_35 , V_4 -> V_37 ) ;
if ( ! V_4 -> V_6 )
return - V_32 ;
V_4 -> V_1 = F_27 ( V_27 , 0 ) ;
if ( F_28 ( & V_27 -> V_13 , V_4 -> V_1 , F_1 , 0 ,
L_2 , V_4 ) )
return - V_39 ;
V_4 -> V_5 = F_29 ( & V_27 -> V_13 , NULL ) ;
if ( F_30 ( V_4 -> V_5 ) ) {
V_28 = F_31 ( V_4 -> V_5 ) ;
F_32 ( & V_27 -> V_13 , L_3 ) ;
return V_28 ;
...
F_4 ( V_4 -> V_5 ) ;
F_20 ( V_27 , V_4 ) ;
V_4 -> V_9 = F_34 ( L_5 , & V_27 -> V_13 , & V_41 ,
V_42 ) ;
if ( F_30 ( V_4 -> V_9 ) ) {
V_28 = F_31 ( V_4 -> V_9 ) ;
goto V_43;
...
static int F_35 ( struct V_26 * V_27 , T_4 V_44 )
{
struct V_3 * V_4 = F_7 ( & V_27 -> V_13 ) ;
if ( F_36 ( & V_27 -> V_13 ) ) {
F_37 ( V_4 -> V_1 ) ;
