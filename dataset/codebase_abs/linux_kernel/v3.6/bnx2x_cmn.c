...
memcpy ( & V_2 -> V_25 [ V_19 ] ,
& V_2 -> V_25 [ V_20 ] ,
sizeof( struct V_26 ) ) ;
V_8 -> V_27 [ 0 ] = & V_2 -> V_25 [ V_20 ] ;
}
static T_1 F_4 ( struct V_1 * V_2 , struct V_26 * V_28 ,
T_1 V_29 , unsigned int * V_30 ,
unsigned int * V_31 )
{
struct V_32 * V_33 = & V_28 -> V_34 [ V_29 ] ;
struct V_35 * V_36 ;
struct V_37 * V_38 ;
struct V_39 * V_40 = V_33 -> V_40 ;
T_1 V_41 = F_5 ( V_33 -> V_42 ) , V_43 ;
int V_44 ;
F_6 ( & V_40 -> V_45 ) ;
F_7 ( V_46 , L_1 ,
V_28 -> V_47 , V_29 , V_33 , V_40 ) ;
V_36 = & V_28 -> V_48 [ V_41 ] . V_49 ;
F_8 ( & V_2 -> V_50 -> V_51 , F_9 ( V_36 ) ,
F_10 ( V_36 ) , V_52 ) ;
V_44 = F_11 ( V_36 -> V_44 ) - 1 ;
#ifdef F_12
if ( ( V_44 - 1 ) > ( V_53 + 2 ) ) {
F_13 ( L_2 ) ;
F_14 () ;
...
while ( V_44 > 0 ) {
V_38 = & V_28 -> V_48 [ V_41 ] . V_56 ;
F_16 ( & V_2 -> V_50 -> V_51 , F_9 ( V_38 ) ,
F_10 ( V_38 ) , V_52 ) ;
if ( -- V_44 )
V_41 = F_5 ( F_15 ( V_41 ) ) ;
}
...
int F_20 ( struct V_1 * V_2 , struct V_26 * V_28 )
{
struct V_58 * V_59 ;
T_1 V_60 , V_61 , V_62 = V_28 -> V_63 ;
unsigned int V_30 = 0 , V_31 = 0 ;
#ifdef F_12
if ( F_21 ( V_2 -> V_64 ) )
return - 1 ;
#endif
V_59 = F_22 ( V_2 -> V_51 , V_28 -> V_47 ) ;
V_60 = F_11 ( * V_28 -> V_65 ) ;
V_61 = V_28 -> V_66 ;
while ( V_61 != V_60 ) {
T_1 V_67 ;
...
F_7 ( V_46 ,
L_3 ,
V_28 -> V_47 , V_60 , V_61 , V_67 ) ;
V_62 = F_4 ( V_2 , V_28 , V_67 ,
& V_30 , & V_31 ) ;
V_61 ++ ;
}
F_23 ( V_59 , V_30 , V_31 ) ;
...
static inline void F_31 ( struct V_5 * V_7 ,
T_1 V_29 )
{
T_1 V_71 = V_7 -> V_72 ;
if ( F_32 ( V_29 , V_71 ) > 0 )
...
static inline void F_33 ( struct V_5 * V_7 ,
T_1 V_73 ,
struct V_74 * V_75 )
{
...
if ( ! V_73 )
return;
for ( V_79 = 0 ; V_79 < V_73 ; V_79 ++ )
F_34 ( V_7 -> V_80 ,
F_35 ( F_11 ( V_75 -> V_81 . V_82 [ V_79 ] ) ) ) ;
F_7 ( V_83 , L_4 ,
V_73 - 1 , F_11 ( V_75 -> V_81 . V_82 [ V_73 - 1 ] ) ) ;
F_6 ( ( void * ) ( V_7 -> V_80 ) ) ;
F_31 ( V_7 ,
F_11 ( V_75 -> V_81 . V_82 [ V_73 - 1 ] ) ) ;
V_71 = F_35 ( V_7 -> V_72 ) ;
V_76 = V_71 >> V_84 ;
V_77 = F_35 ( V_7 -> V_85 ) >> V_84 ;
if ( V_76 + 1 != V_77 )
V_76 ++ ;
for ( V_79 = V_77 ; V_79 != V_76 ; V_79 = F_36 ( V_79 ) ) {
if ( F_18 ( V_7 -> V_80 [ V_79 ] ) )
break;
V_7 -> V_80 [ V_79 ] = V_86 ;
V_78 += V_87 ;
}
...
static T_2 F_38 ( const struct V_1 * V_2 ,
const struct V_88 * V_75 ,
bool * V_89 )
{
if ( ( V_2 -> V_51 -> V_90 & V_91 ) &&
( V_75 -> V_92 & V_93 ) ) {
enum V_94 V_95 ;
V_95 = V_75 -> V_92 & V_96 ;
* V_89 = ( V_95 == V_97 ) ||
( V_95 == V_98 ) ;
return F_39 ( V_75 -> V_99 ) ;
}
* V_89 = false ;
return 0 ;
}
static void F_40 ( struct V_5 * V_7 , T_1 V_100 ,
T_1 V_101 , T_1 V_102 ,
struct V_88 * V_75 )
{
struct V_1 * V_2 = V_7 -> V_2 ;
struct V_103 * V_104 = & V_7 -> V_105 [ V_101 ] ;
struct V_103 * V_106 = & V_7 -> V_105 [ V_102 ] ;
struct V_107 * V_108 = & V_7 -> V_109 [ V_102 ] ;
T_3 V_110 ;
struct V_111 * V_112 = & V_7 -> V_112 [ V_100 ] ;
struct V_103 * V_113 = & V_112 -> V_113 ;
if ( V_112 -> V_114 != V_115 )
F_13 ( L_6 , V_100 ) ;
V_110 = F_41 ( & V_2 -> V_50 -> V_51 ,
V_113 -> V_116 + V_117 ,
V_7 -> V_118 , V_119 ) ;
if ( F_21 ( F_42 ( & V_2 -> V_50 -> V_51 , V_110 ) ) ) {
F_43 ( V_7 , V_101 , V_102 ) ;
V_112 -> V_114 = V_120 ;
return;
}
V_106 -> V_116 = V_113 -> V_116 ;
F_44 ( V_106 , V_110 , V_110 ) ;
V_108 -> V_121 = F_45 ( F_46 ( V_110 ) ) ;
V_108 -> V_122 = F_45 ( F_47 ( V_110 ) ) ;
* V_113 = * V_104 ;
V_112 -> V_123 =
F_11 ( V_75 -> V_124 . V_54 ) ;
V_112 -> V_125 = F_11 ( V_75 -> V_125 ) ;
V_112 -> V_114 = V_126 ;
V_112 -> V_127 = F_11 ( V_75 -> V_127 ) ;
V_112 -> V_128 = V_75 -> V_128 ;
V_112 -> V_129 = F_38 ( V_2 , V_75 , & V_112 -> V_89 ) ;
if ( V_7 -> V_130 == V_131 ) {
T_1 V_132 = F_11 ( V_75 -> V_133 ) ;
V_112 -> V_134 =
V_135 * V_136 / V_132 * V_132 ;
V_112 -> V_132 = V_132 ;
}
#ifdef F_12
V_7 -> V_137 |= ( 1 << V_100 ) ;
#ifdef F_48
F_7 (NETIF_MSG_RX_STATUS, L_7 ,
#else
DP(NETIF_MSG_RX_STATUS, L_8,
#endif
fp->tpa_queue_used);
#endif
}
...
DP(NETIF_MSG_IFUP,
L_34, bp->dev->mtu, fp->rx_buf_size);
if (!fp->disable_tpa) {
...
int diff = req_cnt - rc;
BNX2X_DEV_INFO(L_43, rc);
rc = pci_enable_msix(bp->pdev, &bp->msix_table[0], rc);
if (rc) {
BNX2X_DEV_INFO(L_44, rc);
goto no_msix;
}
bp->num_queues -= diff;
BNX2X_DEV_INFO(L_45,
...
for_each_eth_queue(bp, i) {
struct bnx2x_fastpath *fp = &bp->fp[i];
snprintf(fp->name, sizeof(fp->name), L_50,
bp->dev->name, i);
rc = request_irq(bp->msix_table[offset].vector,
...
netdev_info(bp->dev, L_55,
bp->dev->irq);
}
if (bp->flags & USING_MSIX_FLAG) {
bp->dev->irq = bp->msix_table[0].vector;
netdev_info(bp->dev, L_56,
bp->dev->irq);
}
}
return 0;
...
BNX2X_DEV_INFO(L_57, bp->num_queues);
}
...
DP(NETIF_MSG_IFUP, L_65, loaded_fw, my_fw);
if (loaded_fw != my_fw) {
if (is_err)
BNX2X_ERR(L_66,
loaded_fw, my_fw);
...
DP(NETIF_MSG_IFUP, L_68, bp->num_queues);
for_each_queue(bp, i)
bnx2x_bz_fp(bp, i);
...
BNX2X_DEV_INFO(L_70, bp->fw_seq);
bp->fw_drv_pulse_wr_seq =
(SHMEM_RD(bp, func_mb[BP_FW_MB_IDX(bp)].drv_pulse_mb) &
DRV_PULSE_SEQ_MASK);
BNX2X_DEV_INFO(L_71, bp->fw_drv_pulse_wr_seq);
...
int path = BP_PATH(bp);
DP(NETIF_MSG_IFUP, L_74,
path, load_count[path][0], load_count[path][1],
load_count[path][2]);
load_count[path][0]++;
load_count[path][1 + port]++;
DP(NETIF_MSG_IFUP, L_75,
path, load_count[path][0], load_count[path][1],
load_count[path][2]);
...
bp->port.pmf = 0;
DP(NETIF_MSG_IFUP, L_76, bp->port.pmf);
...
break;
default:
dev_err(&bp->pdev->dev, L_88, state);
return -EINVAL;
}
return 0;
}
...
DP(NETIF_MSG_TX_QUEUED, L_106, tx_data_bd);
first_bd->nbd = cpu_to_le16(nbd);
bd_prod = TX_BD(NEXT_TX_IDX(bd_prod));
...
pbd_e2->parsing_data);
DP(NETIF_MSG_TX_QUEUED, L_109, nbd, bd_prod);
...
BNX2X_DEV_INFO(L_121, fp_array_size);
