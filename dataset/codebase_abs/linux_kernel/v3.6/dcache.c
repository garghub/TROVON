...
struct V_1 * V_1 ;
F_9 ( & V_8 -> V_33 ) ;
F_19 (dentry, p, &inode->i_dentry, d_alias) {
F_9 ( & V_1 -> V_34 ) ;
...
int V_9 ;
struct V_1 * V_35 ;
struct V_36 * V_37 = V_1 -> V_6 ;
F_23 ( V_1 -> V_15 . V_16 , V_1 -> V_15 . V_17 ,
( unsigned long long ) V_28 , V_37 ) ;
if ( ! V_8 )
return 0 ;
if ( ! V_1 -> V_4 && V_1 -> V_6 ) {
V_1 -> V_6 = V_37 = NULL ;
...
static void F_35 ( struct V_10 * V_11 , int V_47 )
{
struct V_36 * V_37 ;
F_9 ( & V_48 ) ;
while ( V_11 -> V_49 && ( V_47 < 0 || V_47 -- ) ) {
V_37 = V_11 -> V_49 ;
V_11 -> V_49 = V_37 -> V_50 ;
F_10 ( & V_48 ) ;
F_33 ( V_37 -> V_45 ) ;
...
{
struct V_10 * V_11 = F_37 ( V_52 , struct V_10 ,
V_53 ) ;
F_35 ( V_11 , V_54 ) ;
F_9 ( & V_48 ) ;
if ( V_11 -> V_49 &&
...
if ( ! ( V_1 -> V_58 & V_59 ) &&
! F_17 ( V_1 ) ) {
unsigned long long V_60 = 0ULL ;
if ( V_8 )
V_60 = ( unsigned long long ) F_2 ( V_8 ) -> V_25 ;
F_45 ( V_61 , L_3
L_4 ,
V_60 , V_1 -> V_58 , V_1 -> V_15 . V_16 ,
V_1 -> V_15 . V_17 ) ;
}
goto V_62;
}
F_24 ( V_37 -> V_44 == 0 , L_5 ,
V_1 -> V_15 . V_16 , V_1 -> V_15 . V_17 ,
V_37 -> V_44 ) ;
F_43 ( F_5 ( V_1 -> V_14 ) , V_37 ) ;
V_62:
F_33 ( V_8 ) ;
}
void F_46 ( struct V_1 * V_1 , struct V_1 * V_63 ,
struct V_8 * V_64 , struct V_8 * V_65 )
{
int V_9 ;
struct V_10 * V_11 = F_5 ( V_64 -> V_66 ) ;
struct V_8 * V_8 = V_1 -> V_4 ;
if ( V_64 == V_65 )
goto V_67;
F_43 ( V_11 , V_1 -> V_6 ) ;
V_1 -> V_6 = NULL ;
V_9 = F_22 ( V_1 , V_8 , F_2 ( V_65 ) -> V_25 ) ;
if ( V_9 )
F_27 ( V_9 ) ;
V_67:
F_47 ( V_1 , V_63 ) ;
