...
V_4 = F_79 ( & V_161 -> V_2 , sizeof( * V_4 ) , V_167 ) ;
if ( ! V_4 )
return - V_168 ;
...
V_4 -> V_35 = F_84 ( & V_161 -> V_2 , V_165 ) ;
if ( ! V_4 -> V_35 ) {
F_30 ( V_2 , L_21 ) ;
V_158 = - V_172 ;
goto V_173;
}
V_165 = F_83 ( V_161 , V_174 , 0 ) ;
if ( ! V_165 ) {
F_30 ( V_2 , L_22 ) ;
goto V_173;
}
V_4 -> V_141 = V_165 -> V_175 ;
V_158 = F_85 ( & V_161 -> V_2 , V_4 -> V_141 , F_68 ,
0 , L_23 , V_4 ) ;
if ( V_158 ) {
F_30 ( V_2 , L_22 ) ;
goto V_173;
...
V_5 -> V_6 . V_178 = F_73 ( V_4 -> V_150 ) / V_4 -> V_51 ;
F_2 ( L_24 ,
V_5 -> V_6 . V_178 , V_4 -> V_51 ) ;
...
static int T_4 F_91 ( struct V_160 * V_161 )
{
struct V_1 * V_2 = & V_161 -> V_2 ;
struct V_3 * V_4 = F_92 ( V_161 ) ;
F_2 ( L_1 , __FILE__ ) ;
F_93 ( & V_4 -> V_17 ) ;
if ( V_4 -> V_11 )
goto V_146;
