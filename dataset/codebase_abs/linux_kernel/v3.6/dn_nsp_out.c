...
F_51 ( V_4 , V_97 , V_113 , V_48 , V_4 -> V_22 , V_114 ,
V_6 -> V_119 . V_111 , V_6 -> V_67 , V_6 -> V_68 ) ;
}
void F_55 ( struct V_1 * V_2 , unsigned char V_97 ,
unsigned short V_113 )
{
struct V_49 * V_50 = F_20 ( V_2 ) ;
int V_114 = 0 ;
T_1 V_48 = V_56 ;
F_51 ( NULL , V_97 , V_113 , V_48 , F_56 ( V_2 ) , V_114 ,
NULL , V_50 -> V_121 , V_50 -> V_122 ) ;
}
void F_57 ( struct V_3 * V_4 , unsigned char V_123 , char V_124 )
{
struct V_5 * V_6 = F_2 ( V_4 ) ;
struct V_1 * V_2 ;
unsigned char * V_66 ;
...
void F_59 ( struct V_3 * V_4 , unsigned char V_97 )
{
struct V_5 * V_6 = F_2 ( V_4 ) ;
struct V_101 * V_95 ;
unsigned char V_128 ;
...
if ( V_6 -> V_19 . V_132 )
type = 0 ;
F_46 ( V_2 , F_60 ( & V_6 -> V_19 ,
F_61 ( V_2 ) , type ) ) ;
F_46 ( V_2 , F_60 ( & V_6 -> V_17 ,
F_61 ( V_2 ) , 2 ) ) ;
V_129 = V_133 | V_134 ;
