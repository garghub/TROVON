...
static int F_184 ( struct V_22 * V_141 )
{
...
static void F_185 ( struct V_22 * V_22 , struct V_40 * V_144 )
{
...
static void
F_196 ( struct V_22 * V_22 , struct V_40 * V_56 , int V_148 )
{
if ( ! V_56 -> V_137 )
return;
if ( V_22 -> V_33 == V_56 ) {
...
V_149 = F_198 ( V_56 , V_151 ) ;
V_150 = F_199 ( V_56 , V_151 ) ;
if ( V_149 != V_152 ) {
unsigned long V_34 ;
V_56 -> V_43 . V_116 ++ ;
V_34 = F_200 ( F_103 ( V_149 , V_150 ) , V_153 / V_154 ) ;
if ( V_56 -> V_43 . V_116 > V_34 )
V_56 -> V_155 . V_156 = V_56 -> V_104 . V_108 ;
}
}
static void F_201 ( struct V_22 * V_22 , struct V_40 * V_56 , int V_157 )
{
struct V_41 * V_42 = & V_56 -> V_43 ;
F_108 ( V_22 ) ;
F_197 ( V_22 , V_56 ) ;
...
static unsigned int F_204 ( struct V_22 * V_22 , struct V_40 * V_126 )
{
...
void F_205 ( struct V_162 * V_163 , int V_46 )
{
T_4 V_75 ;
struct V_21 * V_21 ;
F_145 () ;
F_91 (rt_rq, iter, cpu_rq(cpu))
F_206 ( V_163 , V_46 , V_21 ) ;
F_149 () ;
}
