...
int V_135 ;
int V_150 = V_151 ;
V_149 = V_152 + sizeof( struct V_153 ) +
V_128 + V_146 ;
V_147 = F_94 ( V_26 ) ;
if ( F_95 ( V_26 , V_149 ) ) {
F_38 ( V_26 ) ;
...
V_148 = F_94 ( V_26 ) ;
F_37 ( V_26 ) ;
V_26 -> V_155 += V_148 - V_147 ;
V_12 -> V_156 ( V_12 , F_72 ( V_26 , V_146 ) ) ;
memset ( & ( F_96 ( V_26 ) -> V_157 ) , 0 , sizeof( F_96 ( V_26 ) -> V_157 ) ) ;
F_96 ( V_26 ) -> V_117 &= ~ ( V_158 | V_159 |
V_160 ) ;
F_97 ( V_26 ) ;
F_98 ( V_57 ) ;
if ( F_99 ( V_57 ) ) {
...
F_100 ( V_26 ) ;
F_101 ( V_26 , F_102 ( F_103 ( V_57 , 0 ) ) ) ;
V_77 = F_51 ( V_57 ) ;
V_126 = & V_77 -> V_162 . V_126 ;
switch ( V_5 -> V_120 ) {
case V_121 :
F_72 ( V_26 , sizeof( * V_59 ) ) ;
F_104 ( V_26 ) ;
V_59 = F_43 ( V_26 ) ;
V_59 -> V_163 = V_77 -> V_164 ;
V_59 -> V_165 = V_77 -> V_166 ;
...
( ! ( F_89 ( V_26 ) -> V_138 -> V_139 & V_169 ) ) ) {
V_26 -> V_69 = V_70 ;
V_74 = F_90 ( V_26 , 0 , V_135 , 0 ) ;
V_59 -> V_67 = F_105 ( V_77 -> V_78 ,
V_77 -> V_79 ,
V_135 , V_73 , V_74 ) ;
if ( V_59 -> V_67 == 0 )
V_59 -> V_67 = V_141 ;
...
if ( V_5 == NULL )
goto V_172;
F_59 ( V_5 , V_173 , L_26 , V_5 -> V_36 ) ;
F_108 ( V_5 ) ;
switch ( V_5 -> V_120 ) {
case V_121 :
( F_109 ( V_57 ) ) -> V_174 = 0 ;
( F_109 ( V_57 ) ) -> V_175 = NULL ;
break;
case V_170 :
break;
}
V_5 -> V_56 = NULL ;
V_57 -> V_176 = V_5 -> V_177 ;
V_57 -> V_171 = NULL ;
if ( V_57 -> V_176 )
(* V_57 -> V_176 )( V_57 ) ;
F_110 ( V_5 ) ;
...
for ( V_19 = 0 ; V_19 < V_21 ; V_19 ++ ) {
V_178:
F_112 (walk, tmp, &tunnel->session_hlist[hash]) {
V_12 = F_113 ( V_14 , struct V_7 , V_179 ) ;
F_59 ( V_12 , V_173 ,
L_28 , V_12 -> V_36 ) ;
F_114 ( & V_12 -> V_179 ) ;
if ( V_12 -> V_84 != NULL )
...
static int F_122 ( T_1 V_24 , T_1 V_118 , struct V_187 * V_188 , struct V_189 * * V_190 )
{
int V_191 = - V_192 ;
struct V_193 V_194 ;
#if F_46 ( V_64 )
...
#endif
struct V_199 V_200 ;
struct V_189 * V_56 = NULL ;
switch ( V_188 -> V_120 ) {
case V_121 :
#if F_46 ( V_64 )
if ( V_188 -> V_201 && V_188 -> V_202 ) {
V_191 = F_123 ( V_203 , V_204 , 0 , V_190 ) ;
if ( V_191 < 0 )
goto V_39;
V_56 = * V_190 ;
memset ( & V_196 , 0 , sizeof( V_196 ) ) ;
V_196 . V_205 = V_203 ;
memcpy ( & V_196 . V_206 , V_188 -> V_201 ,
sizeof( V_196 . V_206 ) ) ;
V_196 . V_207 = F_77 ( V_188 -> V_208 ) ;
V_191 = F_124 ( V_56 , (struct V_209 * ) & V_196 ,
sizeof( V_196 ) ) ;
if ( V_191 < 0 )
goto V_39;
V_196 . V_205 = V_203 ;
memcpy ( & V_196 . V_206 , V_188 -> V_202 ,
sizeof( V_196 . V_206 ) ) ;
V_196 . V_207 = F_77 ( V_188 -> V_210 ) ;
V_191 = F_125 ( V_56 ,
(struct V_209 * ) & V_196 ,
sizeof( V_196 ) , 0 ) ;
if ( V_191 < 0 )
...
#endif
{
V_191 = F_123 ( V_211 , V_204 , 0 , V_190 ) ;
if ( V_191 < 0 )
goto V_39;
V_56 = * V_190 ;
memset ( & V_194 , 0 , sizeof( V_194 ) ) ;
V_194 . V_212 = V_211 ;
V_194 . V_213 = V_188 -> V_214 ;
V_194 . V_215 = F_77 ( V_188 -> V_208 ) ;
V_191 = F_124 ( V_56 , (struct V_209 * ) & V_194 ,
sizeof( V_194 ) ) ;
if ( V_191 < 0 )
goto V_39;
V_194 . V_212 = V_211 ;
V_194 . V_213 = V_188 -> V_216 ;
V_194 . V_215 = F_77 ( V_188 -> V_210 ) ;
V_191 = F_125 ( V_56 ,
(struct V_209 * ) & V_194 ,
sizeof( V_194 ) , 0 ) ;
if ( V_191 < 0 )
...
if ( ! V_188 -> V_217 )
V_56 -> V_57 -> V_63 = V_167 ;
break;
case V_170 :
#if F_46 ( V_64 )
if ( V_188 -> V_201 && V_188 -> V_202 ) {
V_191 = F_123 ( V_203 , V_204 , V_218 ,
V_190 ) ;
if ( V_191 < 0 )
goto V_39;
V_56 = * V_190 ;
...
V_198 . V_219 = V_203 ;
memcpy ( & V_198 . V_220 , V_188 -> V_201 ,
sizeof( V_198 . V_220 ) ) ;
V_198 . V_221 = V_24 ;
V_191 = F_124 ( V_56 , (struct V_209 * ) & V_198 ,
sizeof( V_198 ) ) ;
if ( V_191 < 0 )
goto V_39;
V_198 . V_219 = V_203 ;
memcpy ( & V_198 . V_220 , V_188 -> V_202 ,
sizeof( V_198 . V_220 ) ) ;
V_198 . V_221 = V_118 ;
V_191 = F_125 ( V_56 ,
(struct V_209 * ) & V_198 ,
...
V_200 . V_219 = V_211 ;
V_200 . V_220 = V_188 -> V_214 ;
V_200 . V_221 = V_24 ;
V_191 = F_124 ( V_56 , (struct V_209 * ) & V_200 ,
sizeof( V_200 ) ) ;
if ( V_191 < 0 )
goto V_39;
V_200 . V_219 = V_211 ;
V_200 . V_220 = V_188 -> V_216 ;
V_200 . V_221 = V_118 ;
V_191 = F_125 ( V_56 , (struct V_209 * ) & V_200 ,
sizeof( V_200 ) , 0 ) ;
if ( V_191 < 0 )
goto V_39;
}
...
int F_127 ( struct V_2 * V_2 , int V_222 , int V_46 , T_1 V_24 , T_1 V_118 , struct V_187 * V_188 , struct V_4 * * V_223 )
{
struct V_4 * V_5 = NULL ;
int V_191 ;
struct V_189 * V_56 = NULL ;
...
struct V_1 * V_9 ;
enum V_224 V_120 = V_121 ;
if ( V_222 < 0 ) {
V_191 = F_122 ( V_24 , V_118 , V_188 , & V_56 ) ;
if ( V_191 < 0 )
goto V_191;
} else {
V_191 = - V_225 ;
V_56 = F_128 ( V_222 , & V_191 ) ;
if ( ! V_56 ) {
F_129 ( L_30 ,
V_24 , V_222 , V_191 ) ;
goto V_191;
...
if ( V_57 -> V_227 != V_218 ) {
F_129 ( L_31 ,
V_24 , V_222 , V_57 -> V_227 , V_218 ) ;
goto V_191;
}
break;
}
V_5 = (struct V_4 * ) V_57 -> V_171 ;
if ( V_5 != NULL ) {
V_191 = - V_228 ;
goto V_191;
}
V_5 = F_130 ( sizeof( struct V_4 ) , V_229 ) ;
if ( V_5 == NULL ) {
V_191 = - V_230 ;
goto V_191;
}
...
V_9 = F_1 ( V_2 ) ;
if ( V_188 != NULL )
V_5 -> V_105 = V_188 -> V_105 ;
V_5 -> V_120 = V_120 ;
if ( V_120 == V_121 ) {
F_109 ( V_57 ) -> V_174 = V_234 ;
F_109 ( V_57 ) -> V_175 = F_73 ;
#if F_46 ( V_64 )
if ( V_57 -> V_65 == V_66 )
F_132 () ;
else
...
V_57 -> V_171 = V_5 ;
V_5 -> V_177 = V_57 -> V_176 ;
V_57 -> V_176 = & F_107 ;
V_5 -> V_56 = V_57 ;
F_134 ( & V_57 -> V_235 . V_236 , & V_237 , L_33 ) ;
V_57 -> V_238 = V_239 ;
F_135 ( & V_5 -> V_184 ) ;
F_5 ( & V_186 ) ;
F_136 ( V_5 ) ;
F_27 ( & V_9 -> V_183 ) ;
F_137 ( & V_5 -> V_184 , & V_9 -> V_240 ) ;
F_35 ( & V_9 -> V_183 ) ;
V_191 = 0 ;
V_191:
if ( V_223 )
...
{
int V_191 = 0 ;
struct V_189 * V_56 = V_5 -> V_56 ? V_5 -> V_56 -> V_242 : NULL ;
if ( V_56 != NULL ) {
V_191 = F_140 ( V_56 , 2 ) ;
if ( V_56 -> V_241 == NULL )
V_191 = F_141 ( V_56 ) ;
...
struct V_7 * F_145 ( int V_244 , struct V_4 * V_5 , T_1 V_8 , T_1 V_119 , struct V_245 * V_188 )
{
struct V_7 * V_12 ;
V_12 = F_130 ( sizeof( struct V_7 ) + V_244 , V_229 ) ;
if ( V_12 != NULL ) {
V_12 -> V_232 = V_246 ;
V_12 -> V_5 = V_5 ;
V_12 -> V_8 = V_8 ;
...
if ( V_188 ) {
V_12 -> V_247 = V_188 -> V_248 ;
V_12 -> V_105 = V_188 -> V_105 ;
V_12 -> V_249 = V_188 -> V_249 ;
V_12 -> V_250 = V_188 -> V_250 ;
V_12 -> V_98 = V_188 -> V_98 ;
V_12 -> V_99 = V_188 -> V_99 ;
V_12 -> V_97 = V_188 -> V_97 ;
V_12 -> V_101 = V_188 -> V_101 ;
V_12 -> V_83 = V_188 -> V_83 ;
V_12 -> V_92 = V_188 -> V_92 ;
V_12 -> V_96 = V_188 -> V_96 ;
V_12 -> V_123 = V_188 -> V_123 ;
memcpy ( & V_12 -> V_124 [ 0 ] , & V_188 -> V_124 [ 0 ] , V_188 -> V_123 ) ;
V_12 -> V_85 = V_188 -> V_85 ;
memcpy ( & V_12 -> V_86 [ 0 ] , & V_188 -> V_86 [ 0 ] , V_188 -> V_85 ) ;
}
if ( V_5 -> V_46 == V_47 )
V_12 -> V_156 = F_76 ;
else
...
static T_5 int F_150 ( struct V_2 * V_2 )
{
