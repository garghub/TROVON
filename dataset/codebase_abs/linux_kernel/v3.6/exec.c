...
break;
case V_328 :
F_233 ( V_326 , & V_12 -> V_189 ) ;
F_232 () ;
F_233 ( V_325 , & V_12 -> V_189 ) ;
break;
}
}
static int F_234 ( unsigned long V_329 )
{
int V_20 ;
V_20 = V_329 & V_330 ;
return ( V_20 > V_327 ) ? V_328 : V_20 ;
}
...
{
struct V_331 * V_332 ;
V_332 = V_105 -> V_121 . V_122 -> V_123 -> V_333 ;
F_236 ( V_332 ) ;
V_332 -> V_334 ++ ;
V_332 -> V_335 -- ;
while ( ( V_332 -> V_334 > 1 ) && ( ! F_237 ( V_13 ) ) ) {
F_238 ( & V_332 -> V_336 ) ;
F_239 ( & V_332 -> V_337 , V_338 , V_339 ) ;
F_240 ( V_332 ) ;
}
V_332 -> V_334 -- ;
V_332 -> V_335 ++ ;
...
static int F_242 ( struct V_340 * V_341 , struct V_203 * V_269 )
{
struct V_105 * V_171 [ 2 ] ;
struct V_173 * V_174 ;
struct V_342 * V_343 = (struct V_342 * ) V_341 -> V_344 ;
struct V_170 * V_345 = V_13 -> V_171 ;
int V_32 = F_243 ( V_171 , 0 ) ;
if ( V_32 )
return V_32 ;
V_343 -> V_105 = V_171 [ 1 ] ;
F_128 ( 0 ) ;
...
void F_247 ( long V_291 , int V_305 , struct V_240 * V_241 )
{
struct V_135 V_135 ;
struct V_271 V_272 ;
struct V_11 * V_12 = V_13 -> V_12 ;
struct V_1 * V_270 ;
const struct V_203 * V_346 ;
struct V_203 * V_203 ;
int V_186 = 0 ;
int V_347 = 0 ;
int V_294 ;
bool V_348 = false ;
static T_10 V_349 = F_248 ( 0 ) ;
struct V_342 V_350 = {
. V_291 = V_291 ,
. V_241 = V_241 ,
. V_351 = V_25 ( V_302 ) ,
...
F_249 ( V_291 ) ;
V_270 = V_12 -> V_270 ;
if ( ! V_270 || ! V_270 -> V_352 )
goto V_353;
if ( ! F_234 ( V_350 . V_329 ) )
goto V_353;
V_203 = F_250 () ;
if ( ! V_203 )
goto V_353;
if ( F_234 ( V_350 . V_329 ) == V_328 ) {
V_347 = V_354 ;
V_203 -> V_355 = V_356 ;
V_348 = true ;
}
...
V_350 . V_351 = V_364 ;
V_359 = F_204 ( & V_349 ) ;
if ( V_365 && ( V_365 < V_359 ) ) {
F_253 ( V_361 L_12 ,
F_213 ( V_13 ) , V_13 -> V_181 ) ;
F_253 ( V_361 L_13 ) ;
goto V_366;
}
V_360 = F_254 ( V_35 , V_272 . V_274 + 1 , NULL ) ;
if ( ! V_360 ) {
F_253 ( V_361 L_14 ,
V_367 ) ;
goto V_366;
}
V_186 = F_255 ( V_360 [ 0 ] , V_360 ,
NULL , V_368 , F_242 ,
NULL , & V_350 ) ;
F_256 ( V_360 ) ;
if ( V_186 ) {
...
struct V_224 * V_224 ;
if ( V_350 . V_351 < V_270 -> V_371 )
goto V_363;
if ( V_348 && V_272 . V_274 [ 0 ] != '/' ) {
F_253 ( V_361 L_16\
L_17 ,
F_213 ( V_13 ) , V_13 -> V_181 ) ;
F_253 ( V_361 L_13 ) ;
...
V_350 . V_105 = F_257 ( V_272 . V_274 ,
V_372 | 2 | V_373 | V_110 | V_347 ,
0600 ) ;
if ( F_48 ( V_350 . V_105 ) )
goto V_363;
V_224 = V_350 . V_105 -> V_121 . V_122 -> V_123 ;
if ( V_224 -> V_374 > 1 )
goto V_370;
if ( F_258 ( V_350 . V_105 -> V_121 . V_122 ) )
goto V_370;
if ( ! F_76 ( V_224 -> V_124 ) )
goto V_370;
if ( ! F_142 ( V_224 -> V_231 , F_259 () ) )
goto V_370;
if ( ! V_350 . V_105 -> V_225 || ! V_350 . V_105 -> V_225 -> V_19 )
goto V_370;
if ( F_260 ( V_350 . V_105 -> V_121 . V_122 , 0 , 0 , V_350 . V_105 ) )
goto V_370;
}
V_186 = V_270 -> V_352 ( & V_350 ) ;
if ( V_186 )
...
int F_265 ( struct V_105 * V_105 , const void * V_128 , int V_55 )
{
return F_266 ( V_375 , V_128 , V_55 ) && V_105 -> V_225 -> V_19 ( V_105 , V_128 , V_55 , & V_105 -> V_376 ) == V_55 ;
}
int F_267 ( struct V_105 * V_105 , T_4 V_377 )
{
int V_20 = 1 ;
if ( V_105 -> V_225 -> V_378 && V_105 -> V_225 -> V_378 != V_379 ) {
if ( V_105 -> V_225 -> V_378 ( V_105 , V_377 , V_380 ) < 0 )
return 0 ;
} else {
char * V_180 = ( char * ) F_268 ( V_35 ) ;
if ( ! V_180 )
return 0 ;
while ( V_377 > 0 ) {
unsigned long V_381 = V_377 ;
if ( V_381 > V_27 )
V_381 = V_27 ;
if ( ! F_265 ( V_105 , V_180 , V_381 ) ) {
V_20 = 0 ;
break;
}
V_377 -= V_381 ;
}
F_269 ( ( unsigned long ) V_180 ) ;
}
return V_20 ;
}
