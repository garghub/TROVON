...
F_8 ( V_83 ) ;
F_8 ( F_82 ( V_71 ) || V_71 -> V_249 ) ;
F_53 ( V_71 ) ;
F_123 ( V_23 , V_147 ) ;
}
int F_205 ( struct V_23 * V_23 , const void * V_250 , T_10 V_251 ,
...
{
struct V_73 * V_74 = V_73 ( V_65 ) ;
int V_254 = 3 * V_74 -> V_255 ;
F_87 ( & V_74 -> V_197 ) ;
F_87 ( & V_74 -> V_163 ) ;
F_209 ( & V_74 -> V_76 ) ;
V_74 -> V_120 = F_210 ( V_254 ,
sizeof( struct V_97 ) ) ;
V_74 -> V_186 = F_210 ( V_254 ,
sizeof( struct V_183 ) ) ;
return 0 ;
}
