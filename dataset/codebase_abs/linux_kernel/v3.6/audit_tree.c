...
goto V_43;
F_39 ( & V_37 -> V_24 , V_23 ) ;
if ( F_40 ( & V_37 -> V_24 , V_37 -> V_24 . V_44 , V_37 -> V_24 . V_16 . V_31 , NULL , 1 ) ) {
F_41 ( & V_37 -> V_24 ) ;
goto V_43;
}
V_15 -> V_41 = 1 ;
...
F_39 ( V_49 , V_48 ) ;
if ( F_40 ( V_49 , V_49 -> V_44 , V_49 -> V_16 . V_31 , NULL , 1 ) ) {
F_34 ( & V_48 -> V_40 ) ;
F_41 ( V_49 ) ;
F_41 ( V_48 ) ;
return - V_47 ;
...
int F_75 ( struct V_52 * V_53 , char * V_12 , T_2 V_78 )
{
if ( V_12 [ 0 ] != '/' ||
V_53 -> V_61 != V_79 ||
V_78 != V_80 ||
...
static int F_77 ( struct V_67 * V_68 , void * V_69 )
{
return F_47 ( V_68 -> V_70 -> V_71 , V_69 ) ;
}
int F_78 ( struct V_52 * V_53 )
{
...
static int F_87 ( struct V_97 * V_44 ,
struct V_22 * V_98 ,
struct V_22 * V_99 ,
struct V_100 * V_101 )
{
...
static void F_89 ( struct V_22 * V_23 , struct V_97 * V_44 )
{
struct V_14 * V_15 = F_16 ( V_23 , struct V_14 , V_24 ) ;
F_85 ( V_15 ) ;
F_90 ( F_91 ( & V_23 -> V_103 ) < 1 ) ;
}
static bool F_92 ( struct V_97 * V_44 , struct V_31 * V_31 ,
struct V_22 * V_98 ,
struct V_22 * V_104 ,
