...
int V_50 = 0 ;
char V_105 [] = L_57 ;
V_4 = F_38 ( & V_39 -> V_4 , sizeof( struct V_3 ) , V_106 ) ;
if ( ! V_4 ) {
F_8 ( & V_39 -> V_4 , L_58 ) ;
return - V_107 ;
}
...
V_50 = F_45 ( & V_39 -> V_4 , V_4 -> V_40 , F_9 , 0 , V_111 , V_4 ) ;
if ( V_50 < 0 )
return V_50 ;
V_4 -> V_65 = V_112 ;
F_46 ( V_4 -> V_43 ) ;
...
V_83 -> V_115 = V_116 ;
V_83 -> V_117 = V_118 ;
F_48 ( V_83 -> V_119 , L_63 ,
sizeof( V_83 -> V_119 ) ) ;
V_83 -> V_120 = V_104 ;
V_83 -> V_121 = & V_122 ;
V_83 -> V_4 . V_123 = & V_39 -> V_4 ;
F_49 ( V_83 , V_4 ) ;
V_50 = F_50 ( V_83 ) ;
if ( V_50 ) {
F_8 ( & V_39 -> V_4 , L_64
...
static int F_52 ( struct V_124 * V_124 )
{
struct V_3 * V_4 = F_53 ( V_124 ) ;
F_1 ( 0x00 , V_4 -> V_6 + V_7 ) ;
return 0 ;
}
static int F_54 ( struct V_124 * V_124 )
{
int V_50 = 0 ;
struct V_3 * V_4 = F_53 ( V_124 ) ;
F_10 ( V_4 -> V_43 ) ;
...
static int T_6
F_55 ( struct V_102 * V_39 )
{
struct V_3 * V_4 = F_56 ( V_39 ) ;
F_57 ( & V_4 -> V_114 ) ;
F_1 ( 0x00 , V_4 -> V_6 + V_7 ) ;
F_51 ( V_39 , NULL ) ;
return 0 ;
