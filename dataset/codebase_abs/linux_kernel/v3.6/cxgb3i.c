...
V_4 -> V_142 = (struct V_143 * ) V_2 ;
F_32 ( V_4 , F_17 ) ;
V_2 -> V_109 = V_2 -> V_101 = F_122 ( V_167 ) -> V_213 - 1 ;
V_2 -> V_107 = 0 ;
...
unsigned int V_81 ;
int V_218 ;
if ( V_167 -> V_219 ( V_167 , V_220 , & V_81 ) < 0 ||
V_167 -> V_219 ( V_167 , V_221 , & V_215 ) < 0 ||
V_167 -> V_219 ( V_167 , V_222 , & V_217 ) < 0 ) {
F_126 ( L_31 , V_167 ) ;
return - V_211 ;
}
if ( V_223 > V_224 )
V_223 = V_224 ;
V_218 = F_127 ( V_39 , V_225 ,
V_223 ) ;
if ( V_218 < 0 )
return V_218 ;
F_40 ( V_81 ) ;
...
static inline void F_128 ( struct V_3 * V_4 , unsigned int V_233 )
{
struct V_234 * V_10 = (struct V_234 * ) V_4 -> V_11 ;
memset ( V_10 , 0 , sizeof( * V_10 ) ) ;
V_10 -> V_14 . V_15 = F_3 ( F_4 ( V_235 ) ) ;
V_10 -> V_236 = F_3 ( F_129 ( V_233 >> 5 ) |
F_130 ( V_237 ) ) ;
V_10 -> V_87 = F_3 ( F_131 ( V_238 >> 5 ) |
F_132 ( ( V_238 >> 3 ) + 1 ) ) ;
}
static int F_133 ( struct V_1 * V_2 , struct V_239 * V_197 ,
unsigned int V_31 , unsigned int V_240 ,
struct V_241 * V_242 )
{
struct V_208 * V_39 = V_2 -> V_39 ;
struct V_243 * V_244 = V_39 -> V_244 ;
unsigned int V_245 = ( V_31 << V_246 ) + V_244 -> V_247 ;
int V_82 ;
F_14 ( 1 << V_192 ,
L_33 ,
V_2 , V_31 , V_240 , V_242 ) ;
for ( V_82 = 0 ; V_82 < V_240 ; V_82 ++ , V_31 ++ , V_245 += V_238 ) {
struct V_3 * V_4 = F_37 ( sizeof( struct V_234 ) +
V_238 , 0 , V_77 ) ;
if ( ! V_4 )
return - V_137 ;
F_128 ( V_4 , V_245 ) ;
F_134 ( (struct V_248 * ) ( V_4 -> V_11 +
sizeof( struct V_234 ) ) ,
V_197 , V_242 , V_82 * V_249 ) ;
V_4 -> V_12 = V_250 ;
F_26 ( V_39 -> V_40 , V_4 ) ;
}
return 0 ;
}
static void F_135 ( struct V_202 * V_203 , unsigned int V_251 ,
unsigned int V_31 , unsigned int V_240 )
{
...
F_14 ( 1 << V_192 ,
L_34 ,
V_39 , V_31 , V_240 , V_251 ) ;
for ( V_82 = 0 ; V_82 < V_240 ; V_82 ++ , V_31 ++ , V_245 += V_238 ) {
struct V_3 * V_4 = F_37 ( sizeof( struct V_234 ) +
V_238 , 0 , V_77 ) ;
if ( ! V_4 ) {
F_98 ( L_35 ,
V_251 , V_31 , V_82 , V_240 ) ;
continue;
}
F_128 ( V_4 , V_245 ) ;
V_4 -> V_12 = V_250 ;
...
unsigned int V_46 , int V_252 , bool V_253 )
{
struct V_3 * V_4 = F_37 ( sizeof( struct V_254 ) , 0 ,
V_199 ) ;
struct V_254 * V_10 ;
T_2 V_255 = V_252 < V_256 ? V_252 : 0 ;
F_14 ( 1 << V_192 ,
L_36 , V_2 , V_46 , V_252 ) ;
if ( ! V_4 )
return - V_137 ;
V_10 = (struct V_254 * ) V_4 -> V_11 ;
V_10 -> V_14 . V_15 = F_3 ( F_4 ( V_16 ) ) ;
F_5 ( V_10 ) = F_3 ( F_6 ( V_257 , V_46 ) ) ;
V_10 -> V_253 = F_137 ( V_253 ? 0 : 1 ) ;
V_10 -> V_258 = 0 ;
V_10 -> V_259 = F_138 ( 31 ) ;
V_10 -> V_260 = F_139 ( 0xF0000000 ) ;
V_10 -> V_255 = F_139 ( V_255 << 28 ) ;
V_4 -> V_12 = V_250 ;
F_26 ( V_2 -> V_39 -> V_40 , V_4 ) ;
return 0 ;
}
static int F_140 ( struct V_1 * V_2 , unsigned int V_46 ,
int V_261 , int V_262 , int V_253 )
{
struct V_3 * V_4 = F_37 ( sizeof( struct V_254 ) , 0 ,
V_199 ) ;
struct V_254 * V_10 ;
T_2 V_255 = ( V_261 ? 1 : 0 ) | ( V_262 ? 2 : 0 ) ;
F_14 ( 1 << V_192 ,
L_37 , V_2 , V_46 , V_261 , V_262 ) ;
if ( ! V_4 )
return - V_137 ;
V_10 = (struct V_254 * ) V_4 -> V_11 ;
V_10 -> V_14 . V_15 = F_3 ( F_4 ( V_16 ) ) ;
...
V_10 -> V_258 = 0 ;
V_10 -> V_259 = F_138 ( 31 ) ;
V_10 -> V_260 = F_139 ( 0x0F000000 ) ;
V_10 -> V_255 = F_139 ( V_255 << 24 ) ;
V_4 -> V_12 = V_250 ;
F_26 ( V_2 -> V_39 -> V_40 , V_4 ) ;
return 0 ;
}
...
{
struct V_42 * V_53 = (struct V_42 * ) V_39 -> V_40 ;
struct V_243 * V_244 = V_53 -> V_263 ;
struct V_264 V_265 ;
unsigned int V_266 [ 4 ] ;
int V_82 , V_163 ;
if ( V_244 ) {
F_144 ( & V_244 -> V_267 ) ;
F_126 ( L_39 ,
...
V_163 = V_53 -> V_219 ( V_53 , V_269 , & V_265 ) ;
if ( V_163 < 0 ) {
F_98 ( L_40 ,
V_53 -> V_181 , V_163 ) ;
return V_163 ;
}
V_163 = F_145 ( V_39 , V_265 . V_247 , V_265 . V_270 ,
V_265 . V_271 , V_265 . V_272 ) ;
if ( V_163 < 0 )
return V_163 ;
V_244 = V_39 -> V_244 ;
V_265 . V_273 = V_244 -> V_274 << V_275 ;
F_146 ( V_266 ) ;
for ( V_82 = 0 ; V_82 < 4 ; V_82 ++ )
V_265 . V_266 [ V_82 ] = V_266 [ V_82 ] ;
V_265 . V_270 = V_265 . V_247 + ( V_244 -> V_276 << V_246 ) ;
V_163 = V_53 -> V_219 ( V_53 , V_277 , & V_265 ) ;
if ( V_163 < 0 ) {
F_126 ( L_41 ,
V_53 -> V_181 , V_163 ) ;
F_142 ( V_39 ) ;
...
F_38 ( L_42
L_43 ,
V_53 , V_244 -> V_276 , V_244 -> V_282 , V_244 -> V_274 ,
V_244 -> V_283 , V_244 -> V_271 , V_265 . V_271 ,
V_244 -> V_272 , V_265 . V_272 ) ;
return 0 ;
}
static void F_147 ( struct V_42 * V_167 )
{
struct V_208 * V_39 = F_148 ( V_167 ) ;
if ( ! V_39 || V_39 -> V_38 & V_284 ) {
...
{
struct V_208 * V_39 = F_148 ( V_167 ) ;
struct V_285 * V_285 = F_151 ( V_167 ) ;
int V_82 , V_163 ;
if ( V_39 ) {
F_38 ( L_45 , V_39 ) ;
return;
}
V_39 = F_152 ( 0 , V_285 -> V_286 . V_287 ) ;
if ( ! V_39 ) {
F_126 ( L_46 , V_167 ) ;
return;
}
V_39 -> V_38 = V_288 | V_289 ;
V_39 -> V_40 = V_167 ;
V_39 -> V_290 = V_285 -> V_290 ;
V_39 -> V_179 = V_285 -> V_215 ;
V_39 -> V_287 = V_285 -> V_286 . V_287 ;
V_39 -> V_291 = V_285 -> V_286 . V_291 ;
V_39 -> V_292 = V_293 ;
V_39 -> V_294 = V_97 ;
V_39 -> V_295 = V_8 ;
V_39 -> V_296 = V_297 ;
...
V_163 = F_153 ( V_39 , V_305 , V_224 ,
& V_306 , V_307 ) ;
if ( V_163 )
goto V_304;
for ( V_82 = 0 ; V_82 < V_39 -> V_287 ; V_82 ++ )
...
static void F_154 ( struct V_42 * V_167 , T_1 V_308 , T_1 V_215 )
{
struct V_208 * V_39 = F_148 ( V_167 ) ;
F_14 ( 1 << V_35 ,
L_50 ,
V_167 , V_39 , V_308 , V_215 ) ;
if ( ! V_39 )
return;
switch ( V_308 ) {
case V_309 :
