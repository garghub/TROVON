...
static void T_5 F_96 ( struct V_2 * V_2 )
{
int V_156 ;
F_97 (i)
F_98 ( V_2 -> V_3 . F_1 [ V_156 ] ) ;
F_99 ( V_2 -> V_3 . F_1 ) ;
V_2 -> V_3 . F_1 = NULL ;
}
static int T_6 F_100 ( struct V_2 * V_2 )
{
int V_156 , V_75 ;
V_2 -> V_3 . F_1 =
F_101 ( V_157 * sizeof( struct V_1 * ) , V_158 ) ;
if ( V_2 -> V_3 . F_1 == NULL )
return - V_159 ;
F_97 (i) {
struct V_1 * V_4 ;
V_75 = F_102 ( & V_4 , V_160 ,
V_161 , V_67 , V_2 ) ;
if ( V_75 < 0 )
goto V_162;
V_2 -> V_3 . F_1 [ V_156 ] = V_4 ;
V_4 -> V_163 = 2 * F_103 ( 64 * 1024 ) ;
F_104 ( V_4 , V_164 ) ;
F_37 ( V_4 ) -> V_165 = V_166 ;
}
V_2 -> V_3 . V_131 = 0 ;
V_2 -> V_3 . V_153 = 1 ;
V_2 -> V_3 . V_127 = 1 ;
V_2 -> V_3 . V_27 = 1 * V_167 ;
V_2 -> V_3 . V_22 = 0x1818 ;
V_2 -> V_3 . V_104 = 0 ;
return 0 ;
V_162:
