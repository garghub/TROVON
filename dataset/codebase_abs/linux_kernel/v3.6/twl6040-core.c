...
F_10 ( V_6 , V_105 , V_106 ) ;
V_31 = V_6 -> V_102 + V_107 ;
V_84 = & V_6 -> V_108 [ V_85 ] ;
V_84 -> V_109 = L_21 ;
V_110 [ 0 ] . V_111 = V_31 ;
V_110 [ 0 ] . V_112 = V_31 ;
V_84 -> V_113 = V_110 ;
V_84 -> V_114 = F_49 ( V_110 ) ;
if ( V_2 && V_2 -> V_115 ) {
V_84 -> V_81 = V_2 -> V_115 ;
V_84 -> V_116 = sizeof( * V_2 -> V_115 ) ;
}
V_85 ++ ;
if ( F_1 ( V_2 , V_4 ) ) {
V_31 = V_6 -> V_102 + V_117 ;
V_84 = & V_6 -> V_108 [ V_85 ] ;
V_84 -> V_109 = L_22 ;
V_118 [ 0 ] . V_111 = V_31 ;
V_118 [ 0 ] . V_112 = V_31 ;
V_84 -> V_113 = V_118 ;
V_84 -> V_114 = F_49 ( V_118 ) ;
if ( V_2 && V_2 -> V_5 ) {
V_84 -> V_81 = V_2 -> V_5 ;
V_84 -> V_116 = sizeof( * V_2 -> V_5 ) ;
}
V_85 ++ ;
}
V_8 = F_50 ( & V_78 -> V_41 , - 1 , V_6 -> V_108 , V_85 ,
NULL , 0 , NULL ) ;
if ( V_8 )
goto V_119;
return 0 ;
