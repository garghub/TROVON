...
static void F_59 ( struct V_1 * V_1 , unsigned long V_32 )
{
}
...
static void F_71 ( struct V_1 * V_76 , unsigned long * V_52 )
{
struct V_1 * V_89 ;
unsigned long V_32 ;
if ( ! V_52 )
...
int T_3 F_75 ( struct V_91 * V_91 , unsigned long V_20 ,
int V_32 )
{
unsigned long V_3 = F_22 ( V_20 ) ;
struct V_43 * V_44 = V_91 -> V_92 ;
struct V_5 * V_15 ;
struct V_1 * V_76 ;
unsigned long * V_52 ;
unsigned long V_93 ;
int V_12 ;
V_12 = F_11 ( V_3 , V_44 -> V_94 ) ;
if ( V_12 < 0 && V_12 != - V_13 )
return V_12 ;
V_76 = F_57 ( V_3 , V_44 -> V_94 , V_32 ) ;
if ( ! V_76 )
return - V_14 ;
V_52 = F_33 () ;
if ( ! V_52 ) {
...
void F_79 ( struct V_91 * V_91 , struct V_5 * V_15 )
{
