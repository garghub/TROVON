...
int V_38 ;
int V_18 ;
V_13 = F_24 ( & V_41 -> V_45 , sizeof( * V_13 ) , V_46 ) ;
if ( ! V_13 )
return - V_47 ;
V_13 -> V_45 = & V_41 -> V_45 ;
V_43 = F_25 ( V_41 , V_48 , 0 ) ;
if ( ! V_43 )
return - V_49 ;
V_13 -> V_50 = V_43 -> V_51 ;
V_13 -> V_52 = F_26 ( V_43 ) ;
if ( F_27 ( V_13 -> V_50 , V_13 -> V_52 ,
V_11 ) == NULL ) {
V_38 = - V_47 ;
goto V_53;
}
V_13 -> V_24 = F_28 ( V_13 -> V_50 , V_13 -> V_52 ) ;
if ( ! V_13 -> V_24 ) {
V_38 = - V_47 ;
goto V_54;
}
V_13 -> V_55 = F_29 ( & V_56 , & V_41 -> V_45 , V_13 ) ;
if ( ! V_13 -> V_55 ) {
F_30 ( & V_41 -> V_45 , L_2 ) ;
V_38 = - V_39 ;
goto V_57;
...
F_32 ( V_41 , NULL ) ;
V_53:
F_35 ( V_13 -> V_50 , V_13 -> V_52 ) ;
return V_38 ;
}
static int T_3 F_36 ( struct V_40 * V_41 )
{
struct V_12 * V_13 = F_37 ( V_41 ) ;
F_38 ( V_13 -> V_55 ) ;
F_34 ( V_13 -> V_24 ) ;
F_35 ( V_13 -> V_50 , V_13 -> V_52 ) ;
F_32 ( V_41 , NULL ) ;
