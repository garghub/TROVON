...
struct V_2 * V_63 ;
int V_21 ;
args -> V_114 = args -> V_95 * ( ( args -> V_100 + 7 ) / 8 ) ;
args -> V_35 = args -> V_114 * args -> V_96 ;
V_204 = F_95 ( sizeof( * V_204 ) , V_22 ) ;
if ( V_204 == NULL )
return - V_23 ;
V_21 = F_47 ( & V_65 -> V_67 , true ) ;
...
V_21 = F_101 ( V_12 , & V_204 -> V_7 , args -> V_35 ,
& V_208 , true ,
& F_105 ) ;
if ( V_21 != 0 )
goto V_209;
...
if ( F_15 ( V_21 != 0 ) )
goto V_211;
args -> V_169 = V_204 -> V_4 . V_60 . V_61 ;
V_211:
F_62 ( & V_63 ) ;
V_209:
F_50 ( & V_65 -> V_67 ) ;
...
int F_124 ( struct V_50 * V_51 ,
struct V_47 * V_48 , T_4 V_169 ,
T_13 * V_112 )
{
struct V_54 * V_55 = F_43 ( V_51 ) -> V_55 ;
struct V_1 * V_171 ;
...
if ( V_21 != 0 )
return - V_56 ;
* V_112 = V_171 -> V_4 . V_213 ;
F_125 ( & V_171 ) ;
return 0 ;
}
int F_126 ( struct V_50 * V_51 ,
struct V_47 * V_48 ,
T_4 V_169 )
{
return F_44 ( F_43 ( V_51 ) -> V_55 ,
