...
static int F_29 ( struct V_76 * V_74 , enum V_93 V_94 ,
unsigned long V_95 )
{
struct V_1 * V_2 = F_19 ( V_74 ) ;
struct V_96 * V_97 = ( void * ) V_95 ;
int V_59 = 0 ;
switch ( V_94 ) {
case V_98 :
F_5 ( V_2 ) ;
...
static enum V_107 F_30 ( struct V_76 * V_74 ,
T_4 V_108 , struct V_109 * V_110 )
{
struct V_1 * V_2 = F_19 ( V_74 ) ;
F_31 ( V_110 , V_2 -> V_52 - V_2 -> V_50 ) ;
return V_2 -> V_11 ;
}
...
{
struct V_56 * V_57 = F_34 ( V_112 ) ;
F_35 ( & V_57 -> V_113 ) ;
return 0 ;
}
static int T_7 F_36 ( struct V_56 * V_57 ,
int V_114 , int V_48 , int type )
{
struct V_1 * V_2 ;
if ( V_114 >= V_61 ) {
F_9 ( V_57 -> V_32 , L_6 ) ;
...
V_2 = F_37 ( V_57 -> V_32 , sizeof( * V_2 ) , V_115 ) ;
if ( ! V_2 ) {
F_9 ( V_57 -> V_32 , L_7 ) ;
return - V_116 ;
}
...
V_2 -> V_48 = V_48 + V_114 ;
V_2 -> V_32 = V_57 -> V_32 ;
V_2 -> V_74 . V_113 = & V_57 -> V_113 ;
V_2 -> V_114 = V_114 ;
V_2 -> type = type ;
V_2 -> V_4 = ( unsigned long ) V_57 -> V_117 + V_114 * 4 ;
V_2 -> V_11 = V_13 ;
V_57 -> V_2 [ V_2 -> V_114 ] = V_2 ;
F_38 ( & V_2 -> V_53 , F_14 , ( unsigned long ) V_2 ) ;
F_39 ( & V_2 -> V_74 . V_118 ,
& V_57 -> V_113 . V_119 ) ;
return 0 ;
}
static int T_7 F_40 ( struct V_111 * V_112 )
{
const struct V_120 * V_121 = F_41 ( V_112 ) ;
enum V_122 type = V_121 -> V_123 ;
struct V_56 * V_57 ;
struct V_124 * V_125 ;
int V_58 , V_59 ;
int V_48 = 0 ;
int V_126 = V_61 ;
V_57 = F_37 ( & V_112 -> V_32 , sizeof( * V_57 ) , V_115 ) ;
if ( ! V_57 )
return - V_116 ;
V_57 -> V_32 = & V_112 -> V_32 ;
V_125 = F_42 ( V_112 , V_127 , 0 ) ;
if ( ! V_125 )
return - V_33 ;
if ( F_43 ( V_125 ) != V_126 )
V_57 -> V_48 = V_125 -> V_128 ;
else
V_48 = V_125 -> V_128 ;
V_125 = F_42 ( V_112 , V_129 , 0 ) ;
if ( ! V_125 )
return - V_33 ;
V_57 -> V_117 = F_44 ( & V_112 -> V_32 , V_125 ) ;
if ( ! V_57 -> V_117 )
return - V_130 ;
if ( V_57 -> V_48 ) {
V_59 = F_22 ( & V_112 -> V_32 , V_57 -> V_48 ,
F_13 , V_78 , L_4 , V_57 ) ;
if ( V_59 )
return V_59 ;
}
F_45 ( V_131 , V_57 -> V_113 . V_132 ) ;
F_45 ( V_133 , V_57 -> V_113 . V_132 ) ;
F_46 ( & V_57 -> V_113 . V_119 ) ;
for ( V_58 = 0 ; V_58 < V_126 ; V_58 ++ ) {
V_59 = F_36 ( V_57 , V_58 , V_48 , type ) ;
if ( V_59 )
return V_59 ;
}
V_57 -> V_113 . V_32 = & V_112 -> V_32 ;
V_57 -> V_113 . V_134 =
F_20 ;
V_57 -> V_113 . V_135 =
F_23 ;
V_57 -> V_113 . V_136 = F_28 ;
V_57 -> V_113 . V_137 = F_30 ;
V_57 -> V_113 . V_138 = F_32 ;
V_57 -> V_113 . V_139 = F_29 ;
V_57 -> V_113 . V_140 = V_141 ;
F_47 ( & V_112 -> V_32 , F_48 ( 64 ) ) ;
F_49 ( V_112 , V_57 ) ;
V_59 = F_50 ( & V_57 -> V_113 ) ;
if ( V_59 ) {
F_9 ( V_57 -> V_113 . V_32 , L_8 ) ;
return V_59 ;
}
F_51 ( V_57 -> V_113 . V_32 , L_9 ) ;
return 0 ;
}
