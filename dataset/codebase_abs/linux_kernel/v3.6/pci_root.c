...
if ( V_57 )
goto V_35;
V_36 = F_21 ( V_10 -> V_11 , V_103 , & V_11 ) ;
if ( F_17 ( V_36 ) )
V_57 = F_46 ( V_10 -> V_11 , V_5 -> V_13 ) ;
F_2 (child, &device->children, node)
F_14 ( V_39 ) ;
if ( F_47 ( V_5 -> V_13 -> V_104 ) )
V_40 |= V_105 ;
if ( F_48 () )
V_40 |= V_106 |
V_107 ;
...
F_57 ( V_10 , V_5 -> V_13 ) ;
if ( V_10 -> V_119 . V_40 . V_120 )
F_58 ( V_5 -> V_13 -> V_109 , true ) ;
return 0 ;
V_35:
if ( ! F_59 ( & V_5 -> V_77 ) )
F_60 ( & V_5 -> V_77 ) ;
...
static int F_61 ( struct V_19 * V_10 )
{
struct V_4 * V_5 = F_62 ( V_10 ) ;
F_63 ( V_5 -> V_13 ) ;
return 0 ;
}
static int F_64 ( struct V_19 * V_10 , int type )
{
struct V_4 * V_5 = F_62 ( V_10 ) ;
F_58 ( V_5 -> V_13 -> V_109 , false ) ;
F_65 ( V_10 ) ;
F_18 ( V_5 ) ;
return 0 ;
}
