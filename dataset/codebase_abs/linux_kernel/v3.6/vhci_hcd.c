...
F_51 (unlink, tmp, &vdev->unlink_rx, list) {
struct V_80 * V_80 ;
F_14 ( L_50 , V_120 -> V_122 ) ;
V_80 = F_52 ( V_63 , V_120 -> V_122 ) ;
if ( ! V_80 ) {
F_14 ( L_51 ,
V_120 -> V_122 ) ;
F_48 ( & V_120 -> V_90 ) ;
...
{
struct V_77 * V_63 = F_54 ( V_71 , struct V_77 , V_71 ) ;
if ( V_71 -> V_117 ) {
F_2 ( L_52 , V_71 -> V_117 ) ;
...
static void F_60 ( struct V_77 * V_63 )
{
...
F_61 ( & V_63 -> V_86 ) ;
F_63 ( & V_63 -> V_92 ) ;
V_63 -> V_71 . V_134 . V_135 = F_53 ;
V_63 -> V_71 . V_134 . V_136 = F_58 ;
V_63 -> V_71 . V_134 . V_137 = F_59 ;
F_64 ( & V_63 -> V_71 ) ;
}
...
V_23 -> V_32 = V_140 ;
V_23 -> V_141 = 1 ;
V_138 = F_67 ( & F_68 ( V_26 ) -> V_142 , & V_143 ) ;
if ( V_138 ) {
F_19 ( L_57 ) ;
return V_138 ;
}
...
{
struct V_25 * V_26 = F_12 ( V_23 ) ;
F_74 ( & V_23 -> V_145 . V_146 -> V_81 , L_60 , V_147 ) ;
F_75 ( & V_26 -> V_14 ) ;
V_23 -> V_32 = V_33 ;
F_76 ( & V_26 -> V_14 ) ;
return 0 ;
...
struct V_22 * V_23 ;
int V_95 ;
F_35 ( L_61 , V_151 -> V_152 , V_151 -> V_153 ) ;
if ( V_151 -> V_81 . V_154 ) {
F_31 ( & V_151 -> V_81 , L_62 ) ;
return - V_109 ;
}
V_23 = F_79 ( & V_155 , & V_151 -> V_81 , F_80 ( & V_151 -> V_81 ) ) ;
if ( ! V_23 ) {
F_19 ( L_63 ) ;
return - V_121 ;
}
...
static int F_86 ( struct V_150 * V_151 , T_4 V_32 )
{
struct V_22 * V_23 ;
int V_9 = 0 ;
int V_157 = 0 ;
...
F_38 ( & V_13 -> V_14 ) ;
if ( V_157 > 0 ) {
F_31 ( & V_151 -> V_81 , L_66
L_67 , V_157 , ( V_157 == 1 ? L_68 : L_69 ) ) ;
V_95 = - V_158 ;
} else {
F_31 ( & V_151 -> V_81 , L_70 ) ;
...
{
struct V_22 * V_23 ;
F_74 ( & V_151 -> V_81 , L_60 , V_147 ) ;
V_23 = F_84 ( V_151 ) ;
F_89 ( V_159 , & V_23 -> V_12 ) ;
F_7 ( V_23 ) ;
return 0 ;
}
static void F_90 ( struct V_94 * V_81 )
{
return;
}
