...
struct V_3 * V_4 = V_2 -> V_4 ;
unsigned int V_66 ;
T_8 V_107 , V_108 , V_109 , V_110 , V_111 ;
int V_5 ;
V_66 = V_106 -> V_112 >> ( V_113 - V_114 ) ;
if ( V_106 -> V_115 < V_106 -> V_116 )
return - V_57 ;
if ( ( V_106 -> V_117 & V_118 ) == 0 )
return - V_57 ;
if ( V_66 >= V_77 )
return - V_57 ;
...
V_106 -> V_119 = V_2 ;
V_106 -> V_117 |= ( V_120 | V_121 ) ;
V_106 -> V_122 = F_54 ( V_106 -> V_122 ) ;
V_111 = ( F_55 ( V_4 , V_66 ) >> V_114 ) + V_109 ;
return F_56 ( V_106 , V_106 -> V_116 , V_111 ,
V_108 , V_106 -> V_122 ) ;
}
