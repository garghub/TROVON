...
static int T_6
F_102 ( struct V_150 * V_151 , unsigned long V_152 , void * V_153 )
{
F_23 () ;
return V_154 ;
}
...
do {
F_108 ( & V_114 -> V_159 ) ;
V_158 = F_109 ( & V_114 -> V_160 ,
& V_156 , V_157 , F_107 ,
V_161 , V_162 ) ;
F_110 ( & V_114 -> V_159 ) ;
F_111 ( V_158 > F_107 ) ;
F_112 () ;
} while ( V_158 >= F_107 && V_156 );
}
int F_113 ( struct V_113 * V_114 ,
struct V_163 * V_164 , T_9 V_165 ,
void * V_143 )
{
int V_38 = 0 ;
int V_166 = 0 ;
...
V_170 = V_164 -> V_176 >> V_177 ;
V_157 = V_164 -> V_178 >> V_177 ;
if ( V_164 -> V_176 == 0 && V_164 -> V_178 == V_179 )
V_173 = 1 ;
V_172 = 1 ;
}
if ( V_164 -> V_180 == V_181 || V_164 -> V_182 )
V_174 = V_162 ;
else
V_174 = V_161 ;
V_183:
if ( V_164 -> V_180 == V_181 || V_164 -> V_182 )
F_106 ( V_114 , V_170 , V_157 ) ;
V_171 = V_170 ;
while ( ! V_166 && ( V_170 <= V_157 ) ) {
int V_184 ;
V_146 = F_115 ( & V_168 , V_114 , & V_170 , V_174 ,
F_7 ( V_157 - V_170 , ( T_8 ) V_185 - 1 ) + 1 ) ;
if ( V_146 == 0 )
break;
for ( V_184 = 0 ; V_184 < V_146 ; V_184 ++ ) {
struct V_129 * V_129 = V_168 . V_111 [ V_184 ] ;
if ( V_129 -> V_170 > V_157 ) {
V_166 = 1 ;
break;
}
V_171 = V_129 -> V_170 ;
...
if ( ! F_122 ( V_129 ) )
goto V_186;
F_123 ( V_164 , V_114 -> V_43 ) ;
V_38 = (* V_165)( V_129 , V_164 , V_143 ) ;
if ( F_29 ( V_38 ) ) {
if ( V_38 == V_188 ) {
F_117 ( V_129 ) ;
V_38 = 0 ;
...
if ( V_164 -> V_175 || ( V_173 && V_164 -> V_189 > 0 ) )
V_114 -> V_169 = V_171 ;
return V_38 ;
}
static int F_125 ( struct V_129 * V_129 , struct V_163 * V_164 ,
void * V_143 )
{
struct V_113 * V_114 = V_143 ;
int V_38 = V_114 -> V_190 -> V_165 ( V_129 , V_164 ) ;
F_126 ( V_114 , V_38 ) ;
return V_38 ;
}
...
struct V_191 V_192 ;
int V_38 ;
if ( ! V_114 -> V_190 -> V_165 )
return 0 ;
F_128 ( & V_192 ) ;
V_38 = F_113 ( V_114 , V_164 , F_125 , V_114 ) ;
F_129 ( & V_192 ) ;
return V_38 ;
}
int F_130 ( struct V_113 * V_114 , struct V_163 * V_164 )
{
int V_38 ;
if ( V_164 -> V_189 <= 0 )
return 0 ;
if ( V_114 -> V_190 -> V_193 )
V_38 = V_114 -> V_190 -> V_193 ( V_114 , V_164 ) ;
else
V_38 = F_127 ( V_114 , V_164 ) ;
return V_38 ;
}
int F_131 ( struct V_129 * V_129 , int V_194 )
{
...
if ( F_122 ( V_129 ) ) {
F_133 ( V_129 ) ;
V_38 = V_114 -> V_190 -> V_165 ( V_129 , & V_164 ) ;
if ( V_38 == 0 && V_194 ) {
F_120 ( V_129 ) ;
if ( F_134 ( V_129 ) )
V_38 = - V_195 ;
...
int F_154 ( struct V_163 * V_164 , struct V_129 * V_129 )
{
V_164 -> V_201 ++ ;
F_151 ( V_129 ) ;
return F_145 ( V_129 ) ;
...
struct V_113 * V_114 = F_81 ( V_129 ) ;
if ( F_155 ( V_114 ) ) {
int (* F_156)( struct V_129 * ) = V_114 -> V_190 -> F_80 ;
F_157 ( V_129 ) ;
#ifdef F_158
if ( ! F_156 )
F_156 = V_202 ;
...
int F_171 ( struct V_113 * V_114 , int V_174 )
{
return F_172 ( & V_114 -> V_160 , V_174 ) ;
}
