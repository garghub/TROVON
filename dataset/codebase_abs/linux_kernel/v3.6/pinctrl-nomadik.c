...
if ( V_142 ) {
V_139 = F_99 ( & V_52 -> V_52 , sizeof( * V_139 ) , V_148 ) ;
if ( ! V_139 )
return - V_149 ;
...
V_46 = F_104 ( & V_52 -> V_52 , V_145 ) ;
if ( ! V_46 ) {
V_77 = - V_149 ;
goto V_152;
}
V_73 = F_105 ( & V_52 -> V_52 , NULL ) ;
if ( F_106 ( V_73 ) ) {
V_77 = F_107 ( V_73 ) ;
goto V_152;
}
F_108 ( V_73 ) ;
V_2 = F_99 ( & V_52 -> V_52 , sizeof( * V_2 ) , V_148 ) ;
if ( ! V_2 ) {
V_77 = - V_149 ;
goto V_152;
}
...
V_45 -> V_123 = V_139 -> V_158 ? : F_110 ( & V_52 -> V_52 ) ;
V_45 -> V_52 = & V_52 -> V_52 ;
V_45 -> V_159 = V_160 ;
F_30 ( V_2 -> V_73 ) ;
V_2 -> V_28 = F_111 ( V_2 -> V_8 + V_30 ) ;
F_32 ( V_2 -> V_73 ) ;
#ifdef F_112
V_45 -> V_143 = V_142 ;
#endif
...
if ( V_77 )
goto V_152;
F_114 ( V_2 -> V_68 >= F_115 ( V_71 ) ) ;
V_71 [ V_2 -> V_68 ] = V_2 ;
F_116 ( V_52 , V_2 ) ;
V_2 -> V_111 = F_117 ( V_142 , V_79 ,
F_14 ( V_139 -> V_153 ) ,
0 , & V_161 , V_2 ) ;
if ( ! V_2 -> V_111 ) {
F_98 ( & V_52 -> V_52 , L_44 ) ;
...
static int F_119 ( struct V_163 * V_164 )
{
struct V_165 * V_166 = F_120 ( V_164 ) ;
return V_166 -> V_167 -> V_168 ;
}
static const char * F_121 ( struct V_163 * V_164 ,
unsigned V_169 )
{
struct V_165 * V_166 = F_120 ( V_164 ) ;
return V_166 -> V_167 -> V_170 [ V_169 ] . V_158 ;
}
static int F_122 ( struct V_163 * V_164 , unsigned V_169 ,
const unsigned * * V_171 ,
unsigned * V_172 )
{
struct V_165 * V_166 = F_120 ( V_164 ) ;
* V_171 = V_166 -> V_167 -> V_170 [ V_169 ] . V_171 ;
* V_172 = V_166 -> V_167 -> V_170 [ V_169 ] . V_173 ;
return 0 ;
}
static struct V_174 *
F_123 ( struct V_163 * V_164 , unsigned V_3 )
{
struct V_165 * V_166 = F_120 ( V_164 ) ;
int V_69 ;
for ( V_69 = 0 ; V_69 < V_166 -> V_167 -> V_175 ; V_69 ++ ) {
struct V_174 * V_176 ;
V_176 = & V_166 -> V_167 -> V_177 [ V_69 ] ;
if ( V_3 >= V_176 -> V_178 &&
V_3 <= ( V_176 -> V_178 + V_176 -> V_173 - 1 ) )
return V_176 ;
}
return NULL ;
}
static void F_124 ( struct V_163 * V_164 , struct V_121 * V_122 ,
unsigned V_3 )
{
struct V_174 * V_176 ;
struct V_118 * V_45 ;
V_176 = F_123 ( V_164 , V_3 ) ;
if ( ! V_176 || ! V_176 -> V_179 ) {
F_83 ( V_122 , L_47 ) ;
return;
}
V_45 = V_176 -> V_179 ;
...
{
struct V_165 * V_166 = F_120 ( V_164 ) ;
return V_166 -> V_167 -> V_180 ;
}
static const char * F_126 ( struct V_163 * V_164 ,
unsigned V_181 )
{
struct V_165 * V_166 = F_120 ( V_164 ) ;
return V_166 -> V_167 -> V_182 [ V_181 ] . V_158 ;
}
static int F_127 ( struct V_163 * V_164 ,
unsigned V_181 ,
const char * const * * V_170 ,
unsigned * const V_183 )
{
struct V_165 * V_166 = F_120 ( V_164 ) ;
* V_170 = V_166 -> V_167 -> V_182 [ V_181 ] . V_170 ;
* V_183 = V_166 -> V_167 -> V_182 [ V_181 ] . V_168 ;
return 0 ;
}
static int F_128 ( struct V_163 * V_164 , unsigned V_181 ,
unsigned V_184 )
{
struct V_165 * V_166 = F_120 ( V_164 ) ;
...
int V_77 = - V_80 ;
int V_69 ;
V_186 = & V_166 -> V_167 -> V_170 [ V_184 ] ;
if ( V_186 -> V_187 < 0 )
return - V_80 ;
F_17 ( V_166 -> V_52 , L_48 , V_186 -> V_158 , V_186 -> V_173 ) ;
V_34 = ( V_186 -> V_187 == V_58 ) ;
if ( V_34 ) {
F_34 ( & V_78 , V_76 ) ;
memset ( V_15 , 0xff , sizeof( V_15 ) ) ;
for ( V_69 = 0 ; V_69 < V_186 -> V_173 ; V_69 ++ )
V_15 [ V_186 -> V_171 [ V_69 ] / V_79 ] &= ~ F_7 ( V_186 -> V_171 [ V_69 ] ) ;
F_29 ( V_15 ) ;
}
for ( V_69 = 0 ; V_69 < V_186 -> V_173 ; V_69 ++ ) {
struct V_174 * V_176 ;
...
struct V_118 * V_45 ;
unsigned V_5 ;
V_176 = F_123 ( V_164 , V_186 -> V_171 [ V_69 ] ) ;
if ( ! V_176 ) {
F_98 ( V_166 -> V_52 ,
L_49 ,
V_186 -> V_171 [ V_69 ] , V_186 -> V_158 , V_69 ) ;
goto V_188;
}
if ( ! V_176 -> V_179 ) {
F_98 ( V_166 -> V_52 , L_50 ,
V_186 -> V_171 [ V_69 ] , V_186 -> V_158 , V_69 ) ;
goto V_188;
}
V_45 = V_176 -> V_179 ;
V_2 = F_75 ( V_45 , struct V_1 , V_45 ) ;
F_17 ( V_166 -> V_52 , L_51 , V_186 -> V_171 [ V_69 ] , V_186 -> V_187 ) ;
F_30 ( V_2 -> V_73 ) ;
V_5 = V_186 -> V_171 [ V_69 ] % V_79 ;
F_13 ( V_2 , V_5 ) ;
F_12 ( V_2 , V_5 , V_186 -> V_187 , V_34 ) ;
F_32 ( V_2 -> V_73 ) ;
}
V_77 = 0 ;
V_188:
...
static void F_129 ( struct V_163 * V_164 ,
unsigned V_181 , unsigned V_184 )
{
struct V_165 * V_166 = F_120 ( V_164 ) ;
const struct V_185 * V_186 ;
V_186 = & V_166 -> V_167 -> V_170 [ V_184 ] ;
if ( V_186 -> V_187 < 0 )
return;
F_17 ( V_166 -> V_52 , L_52 , V_186 -> V_158 , V_186 -> V_173 ) ;
}
int F_130 ( struct V_163 * V_164 ,
struct V_174 * V_176 ,
unsigned V_3 )
{
struct V_165 * V_166 = F_120 ( V_164 ) ;
...
unsigned V_5 ;
if ( ! V_176 ) {
F_98 ( V_166 -> V_52 , L_53 ) ;
return - V_80 ;
}
if ( ! V_176 -> V_179 ) {
F_98 ( V_166 -> V_52 , L_54 ) ;
return - V_80 ;
}
V_45 = V_176 -> V_179 ;
V_2 = F_75 ( V_45 , struct V_1 , V_45 ) ;
F_17 ( V_166 -> V_52 , L_55 , V_3 ) ;
F_30 ( V_2 -> V_73 ) ;
V_5 = V_3 % V_79 ;
F_1 ( V_2 , V_5 , V_57 ) ;
F_32 ( V_2 -> V_73 ) ;
...
void F_131 ( struct V_163 * V_164 ,
struct V_174 * V_176 ,
unsigned V_3 )
{
struct V_165 * V_166 = F_120 ( V_164 ) ;
F_17 ( V_166 -> V_52 , L_56 , V_3 ) ;
}
int F_132 ( struct V_163 * V_164 ,
unsigned V_62 ,
unsigned long * V_189 )
{
return - V_80 ;
}
int F_133 ( struct V_163 * V_164 ,
unsigned V_62 ,
unsigned long V_189 )
{
static const char * V_59 [] = {
...
int V_32 = F_24 ( V_53 ) ;
bool V_28 = F_28 ( V_53 ) ;
bool V_190 = F_134 ( V_53 ) ;
bool V_54 = F_135 ( V_53 ) ;
V_176 = F_123 ( V_164 , V_62 ) ;
if ( ! V_176 ) {
F_98 ( V_166 -> V_52 , L_57 , V_62 ) ;
return - V_80 ;
}
if ( ! V_176 -> V_179 ) {
F_98 ( V_166 -> V_52 , L_58 ,
V_62 ) ;
return - V_80 ;
}
V_45 = V_176 -> V_179 ;
...
static int T_4 F_136 ( struct V_137 * V_191 )
{
const struct V_192 * V_193 = F_137 ( V_191 ) ;
struct V_141 * V_142 = V_191 -> V_52 . V_143 ;
struct V_165 * V_166 ;
unsigned int V_194 = 0 ;
int V_69 ;
V_166 = F_99 ( & V_191 -> V_52 , sizeof( * V_166 ) , V_148 ) ;
if ( ! V_166 )
return - V_149 ;
if ( V_193 )
V_194 = V_193 -> V_195 ;
...
V_194 = ( unsigned int )
F_138 ( V_196 , & V_191 -> V_52 ) -> V_197 ;
if ( V_194 == V_198 )
F_139 ( & V_166 -> V_167 ) ;
for ( V_69 = 0 ; V_69 < V_166 -> V_167 -> V_175 ; V_69 ++ ) {
if ( ! V_71 [ V_69 ] ) {
F_140 ( & V_191 -> V_52 , L_62 , V_69 ) ;
return - V_199 ;
}
V_166 -> V_167 -> V_177 [ V_69 ] . V_179 = & V_71 [ V_69 ] -> V_45 ;
}
V_200 . V_171 = V_166 -> V_167 -> V_171 ;
V_200 . V_173 = V_166 -> V_167 -> V_173 ;
V_166 -> V_52 = & V_191 -> V_52 ;
V_166 -> V_201 = F_141 ( & V_200 , & V_191 -> V_52 , V_166 ) ;
if ( ! V_166 -> V_201 ) {
F_98 ( & V_191 -> V_52 , L_63 ) ;
return - V_80 ;
}
for ( V_69 = 0 ; V_69 < V_166 -> V_167 -> V_175 ; V_69 ++ )
F_142 ( V_166 -> V_201 , & V_166 -> V_167 -> V_177 [ V_69 ] ) ;
F_116 ( V_191 , V_166 ) ;
F_118 ( & V_191 -> V_52 , L_64 ) ;
return 0 ;
}
