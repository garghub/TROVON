...
static int
F_43 ( struct V_41 * V_42 , struct V_66 * V_67 )
{
struct V_16 * V_17 = F_8 ( V_42 ) ;
return F_44 ( V_17 -> V_68 , V_67 ) ;
}
static int
F_45 ( struct V_41 * V_42 , struct V_66 * V_67 )
{
struct V_16 * V_17 = F_8 ( V_42 ) ;
...
V_68 = F_54 ( V_42 , F_55 ( & V_68 -> V_42 ) , & F_52 ,
0 , V_17 -> V_46 -> V_47 ) ;
if ( F_56 ( V_68 ) ) {
F_10 ( V_42 , L_8 ) ;
return F_57 ( V_68 ) ;
...
F_55 ( & V_68 -> V_42 ) , V_68 -> V_37 ) ;
return 0 ;
}
static int
F_59 ( struct V_41 * V_42 )
{
struct V_16 * V_17 = F_8 ( V_42 ) ;
int V_43 ;
int V_98 ;
...
V_17 -> V_69 -> V_37 = F_61 ( sizeof( int ) * V_84 , V_105 ) ;
if ( ! V_17 -> V_69 -> V_37 ) {
V_98 = - V_8 ;
goto V_106;
}
...
static int
F_82 ( struct V_41 * V_42 , int V_121 )
{
int V_122 = F_83 ( V_42 , V_121 ) ;
if ( ! V_122 ) {
struct V_16 * V_17 = F_8 ( V_42 ) ;
unsigned long V_23 ;
F_9 ( & V_17 -> V_24 , V_23 ) ;
...
static int
F_84 ( struct V_41 * V_42 , struct V_125 * V_126 , int V_67 )
{
struct V_16 * V_17 = F_8 ( V_42 ) ;
return F_85 ( V_17 -> V_68 , V_126 , V_67 ) ;
}
static int
F_86 ( struct V_41 * V_42 , void * V_127 )
{
int V_122 = F_87 ( V_42 , V_127 ) ;
if ( ! V_122 ) {
struct V_16 * V_17 = F_8 ( V_42 ) ;
unsigned long V_23 ;
F_9 ( & V_17 -> V_24 , V_23 ) ;
...
if ( ! V_147 ) {
F_101 ( & V_104 -> V_42 , L_16 ) ;
V_98 = - V_149 ;
goto V_99;
}
V_147 = F_102 ( & V_104 -> V_42 , V_147 -> V_150 ,
F_103 ( V_147 ) , F_55 ( & V_104 -> V_42 ) ) ;
if ( ! V_147 ) {
F_101 ( & V_104 -> V_42 , L_17 ) ;
V_98 = - V_151 ;
goto V_99;
}
V_152 = F_104 ( & V_104 -> V_42 ,
V_147 -> V_150 , F_103 ( V_147 ) ) ;
if ( ! V_152 ) {
F_101 ( & V_104 -> V_42 , L_18 ,
V_104 -> V_102 ) ;
V_98 = - V_8 ;
goto V_99;
}
