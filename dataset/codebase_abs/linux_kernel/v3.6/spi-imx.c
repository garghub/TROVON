...
static int T_4 F_55 ( struct V_124 * V_125 )
{
...
V_92 -> V_141 = V_139 ;
V_18 = F_40 ( V_92 ) ;
V_18 -> V_145 . V_92 = F_62 ( V_92 ) ;
for ( V_11 = 0 ; V_11 < V_92 -> V_141 ; V_11 ++ ) {
int V_146 = F_63 ( V_127 , L_6 , V_11 ) ;
if ( ! F_41 ( V_146 ) && V_133 )
V_146 = V_133 -> V_56 [ V_11 ] ;
V_18 -> V_56 [ V_11 ] = V_146 ;
if ( ! F_41 ( V_146 ) )
continue;
V_138 = F_64 ( V_18 -> V_56 [ V_11 ] , V_147 ) ;
if ( V_138 ) {
...
V_138 = F_70 ( V_18 -> V_102 , F_44 , 0 , V_147 , V_18 ) ;
if ( V_138 ) {
F_58 ( & V_125 -> V_123 , L_10 , V_18 -> V_102 , V_138 ) ;
goto V_163;
}
V_137 = F_71 ( & V_125 -> V_123 ) ;
if ( F_72 ( V_137 ) ) {
V_138 = F_73 ( V_137 ) ;
goto V_164;
}
V_18 -> V_165 = F_74 ( & V_125 -> V_123 , L_11 ) ;
if ( F_72 ( V_18 -> V_165 ) ) {
V_138 = F_73 ( V_18 -> V_165 ) ;
goto V_164;
}
V_18 -> V_166 = F_74 ( & V_125 -> V_123 , L_12 ) ;
if ( F_72 ( V_18 -> V_166 ) ) {
V_138 = F_73 ( V_18 -> V_166 ) ;
goto V_164;
}
F_75 ( V_18 -> V_166 ) ;
F_75 ( V_18 -> V_165 ) ;
...
V_138 = F_77 ( & V_18 -> V_145 ) ;
if ( V_138 ) {
F_58 ( & V_125 -> V_123 , L_13 , V_138 ) ;
goto V_168;
}
...
static int T_5 F_86 ( struct V_124 * V_125 )
{
struct V_134 * V_92 = F_87 ( V_125 ) ;
struct V_135 * V_136 = F_65 ( V_125 , V_158 , 0 ) ;
