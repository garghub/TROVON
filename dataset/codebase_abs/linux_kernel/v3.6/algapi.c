...
if ( V_43 )
goto V_43;
V_16 -> V_2 . V_74 = V_18 -> V_75 ;
V_16 -> V_2 . V_29 |= V_76 ;
F_34 ( & V_54 ) ;
V_40 = F_21 ( & V_16 -> V_2 ) ;
if ( F_28 ( V_40 ) )
goto V_57;
F_65 ( & V_16 -> V_26 , & V_18 -> V_72 ) ;
V_16 -> V_18 = V_18 ;
V_57:
F_37 ( & V_54 ) ;
V_43 = F_47 ( V_40 ) ;
...
{
int V_43 = - V_11 ;
if ( ( V_2 -> V_29 ^ V_78 -> type ) & V_78 -> V_79 )
goto V_47;
V_24 -> V_78 = V_78 ;
V_43 = F_68 ( V_24 , V_2 , V_16 , V_78 -> V_79 ) ;
V_47:
return V_43 ;
}
...
struct V_81 * F_74 ( struct V_23 * V_24 , T_1 type ,
T_1 V_37 )
{
struct V_1 * V_2 ;
struct V_81 * V_82 ;
...
struct V_87 * F_84 ( struct V_88 * * V_89 )
{
struct V_88 * V_90 = V_89 [ 0 ] ;
struct V_87 * V_91 ;
if ( ! V_90 )
return F_32 ( - V_48 ) ;
if ( F_85 ( V_90 ) < sizeof( * V_91 ) )
return F_32 ( - V_11 ) ;
if ( V_90 -> V_92 != V_93 )
return F_32 ( - V_11 ) ;
V_91 = F_86 ( V_90 ) ;
...
int F_87 ( struct V_88 * * V_89 , T_1 type )
{
struct V_87 * V_91 ;
V_91 = F_84 ( V_89 ) ;
if ( F_28 ( V_91 ) )
return F_47 ( V_91 ) ;
if ( ( V_91 -> type ^ type ) & V_91 -> V_37 )
return - V_11 ;
return 0 ;
}
const char * F_88 ( struct V_88 * V_90 )
{
struct V_94 * V_95 ;
if ( ! V_90 )
return F_32 ( - V_48 ) ;
if ( F_85 ( V_90 ) < sizeof( * V_95 ) )
return F_32 ( - V_11 ) ;
if ( V_90 -> V_92 != V_96 )
return F_32 ( - V_11 ) ;
V_95 = F_86 ( V_90 ) ;
...
struct V_1 * F_89 ( struct V_88 * V_90 ,
const struct V_77 * V_78 ,
T_1 type , T_1 V_37 )
{
const char * V_52 ;
...
if ( F_28 ( V_52 ) )
return F_32 ( V_43 ) ;
return F_90 ( V_52 , V_78 , type , V_37 ) ;
}
int F_91 ( struct V_88 * V_90 , T_1 * V_97 )
{
struct F_91 * V_98 ;
if ( ! V_90 )
return - V_48 ;
if ( F_85 ( V_90 ) < sizeof( * V_98 ) )
return - V_11 ;
if ( V_90 -> V_92 != V_99 )
return - V_11 ;
V_98 = F_86 ( V_90 ) ;
...
char * V_69 ;
int V_43 ;
V_69 = F_93 ( V_100 + sizeof( * V_16 ) + sizeof( struct V_23 ) ,
V_101 ) ;
if ( ! V_69 )
return F_32 ( - V_102 ) ;
V_16 = ( void * ) ( V_69 + V_100 ) ;
V_43 = - V_9 ;
...
int F_101 ( struct V_106 * V_107 , struct V_81 * V_82 )
{
struct V_111 * V_118 ;
