...
T_3 * V_40 = V_25 ;
F_22 (mod, &smp_alt_modules, next) {
if ( V_45 -> V_39 > V_40 || V_45 -> V_40 < V_59 )
continue;
for ( V_41 = V_45 -> V_47 ; V_41 < V_45 -> V_48 ; V_41 ++ ) {
const T_3 * V_43 = ( const T_3 * ) V_41 + * V_41 ;
if ( V_59 <= V_43 && V_40 > V_43 )
return 1 ;
}
}
return 0 ;
}
void T_2 F_33 ( struct V_60 * V_24 ,
struct V_60 * V_25 )
{
struct V_60 * V_61 ;
char V_29 [ V_30 ] ;
if ( V_5 )
return;
for ( V_61 = V_24 ; V_61 < V_25 ; V_61 ++ ) {
unsigned int V_62 ;
F_11 ( V_61 -> V_20 > V_30 ) ;
memcpy ( V_29 , V_61 -> V_27 , V_61 -> V_20 ) ;
V_62 = V_63 . V_64 ( V_61 -> V_65 , V_61 -> V_66 , V_29 ,
( unsigned long ) V_61 -> V_27 , V_61 -> V_20 ) ;
F_11 ( V_62 > V_61 -> V_20 ) ;
F_8 ( V_29 + V_62 , V_61 -> V_20 - V_62 ) ;
F_12 ( V_61 -> V_27 , V_29 , V_61 -> V_20 ) ;
}
}
void T_1 F_34 ( void )
{
...
void * T_2 F_12 ( void * V_76 , const void * V_77 ,
T_4 V_20 )
{
unsigned long V_78 ;
F_42 ( V_78 ) ;
memcpy ( V_76 , V_77 , V_20 ) ;
F_43 () ;
F_44 ( V_78 ) ;
return V_76 ;
}
void * T_5 F_15 ( void * V_76 , const void * V_77 , T_4 V_20 )
{
unsigned long V_78 ;
char * V_79 ;
struct V_80 * V_81 [ 2 ] ;
int V_82 ;
if ( ! F_45 ( ( unsigned long ) V_76 ) ) {
V_81 [ 0 ] = F_46 ( V_76 ) ;
V_81 [ 1 ] = F_46 ( V_76 + V_83 ) ;
} else {
V_81 [ 0 ] = F_47 ( V_76 ) ;
F_48 ( ! F_49 ( V_81 [ 0 ] ) ) ;
V_81 [ 1 ] = F_47 ( V_76 + V_83 ) ;
}
F_11 ( ! V_81 [ 0 ] ) ;
F_42 ( V_78 ) ;
F_50 ( V_84 , F_51 ( V_81 [ 0 ] ) ) ;
if ( V_81 [ 1 ] )
F_50 ( V_85 , F_51 ( V_81 [ 1 ] ) ) ;
V_79 = ( char * ) F_52 ( V_84 ) ;
memcpy ( & V_79 [ ( unsigned long ) V_76 & ~ V_86 ] , V_77 , V_20 ) ;
F_53 ( V_84 ) ;
if ( V_81 [ 1 ] )
F_53 ( V_85 ) ;
F_54 () ;
F_43 () ;
for ( V_82 = 0 ; V_82 < V_20 ; V_82 ++ )
F_11 ( ( ( char * ) V_76 ) [ V_82 ] != ( ( char * ) V_77 ) [ V_82 ] ) ;
F_44 ( V_78 ) ;
return V_76 ;
}
static int T_5 F_55 ( void * V_87 )
{
...
V_61 = & V_89 -> V_93 [ V_82 ] ;
F_15 ( V_61 -> V_76 , V_61 -> V_77 , V_61 -> V_20 ) ;
}
F_57 () ;
V_94 = 1 ;
} else {
...
for ( V_82 = 0 ; V_82 < V_89 -> V_92 ; V_82 ++ ) {
V_61 = & V_89 -> V_93 [ V_82 ] ;
F_60 ( ( unsigned long ) V_61 -> V_76 ,
( unsigned long ) V_61 -> V_76 + V_61 -> V_20 ) ;
}
F_43 () ;
return 0 ;
}
void * T_5 F_61 ( void * V_76 , const void * V_77 , T_4 V_20 )
{
struct V_88 V_89 ;
struct V_90 V_61 ;
V_61 . V_76 = V_76 ;
...
F_62 ( & V_91 , 1 ) ;
V_94 = 0 ;
F_63 ( F_55 , ( void * ) & V_89 , V_95 ) ;
return V_76 ;
}
void T_5 F_64 ( struct V_90 * V_93 , int V_96 )
{
