...
V_63 = V_106 -> V_139 ;
V_106 -> V_139 &= V_140 ;
if ( ! V_106 -> V_139 || V_63 != V_106 -> V_139 )
V_138 ++ ;
V_63 = V_106 -> V_141 ;
V_106 -> V_141 &= V_142 ;
if ( ! V_106 -> V_141 || V_63 != V_106 -> V_141 )
V_138 ++ ;
V_63 = V_106 -> V_143 ;
V_106 -> V_143 &= V_144 | V_145 ;
if ( ! V_106 -> V_143 || V_63 != V_106 -> V_143 )
V_138 ++ ;
V_63 = V_106 -> V_146 ;
V_106 -> V_146 &= V_147 ;
if ( ! V_106 -> V_146 || V_63 != V_106 -> V_146 )
V_138 ++ ;
V_63 = V_106 -> V_148 ;
V_106 -> V_148 &= V_147 | V_149 ;
if ( ! V_106 -> V_148 || V_63 != V_106 -> V_148 )
V_138 ++ ;
if ( V_138 )
return 1 ;
if ( V_106 -> V_143 != V_144 && V_106 -> V_143 != V_145 )
V_138 ++ ;
if ( V_106 -> V_148 != V_149 && V_106 -> V_148 != V_147 )
V_138 ++ ;
if ( V_138 )
return 2 ;
if ( V_106 -> V_150 != 0 ) {
...
static int F_55 ( unsigned long V_10 )
{
F_2 ( 0x00 , V_10 + V_14 ) ;
F_6 ( 1 ) ;
...
static int F_61 ( struct V_1 * V_2 , struct V_176 * V_122 )
{
const struct V_136 * V_137 = F_52 ( V_2 ) ;
int V_177 ;
unsigned long V_10 ;
...
unsigned long V_178 ;
struct V_3 * V_4 ;
V_177 = F_62 ( V_2 , sizeof( struct V_179 ) ) ;
if ( V_177 < 0 )
return V_177 ;
V_10 = V_122 -> V_180 [ 0 ] ;
F_16
...
V_177 = F_67 ( V_55 , L_27 ) ;
if ( V_177 )
return - V_113 ;
V_23 -> V_55 = V_55 ;
V_178 = 2 ;
V_23 -> V_62 [ 0 ] = F_68 ( V_198 , V_178 ) ;
if ( ! V_23 -> V_62 [ 0 ] )
return - V_113 ;
V_23 -> V_199 [ 0 ] = V_178 ;
V_23 -> V_59 [ 0 ] = F_69 ( ( void * ) V_23 -> V_62 [ 0 ] ) ;
V_23 -> V_60 [ 0 ] = ( 1 << V_178 ) * V_200 ;
if ( V_23 -> V_111 == 0 ) {
V_23 -> V_62 [ 1 ] = F_68 ( V_198 , V_178 ) ;
if ( ! V_23 -> V_62 [ 1 ] )
return - V_113 ;
V_23 -> V_199 [ 1 ] = V_178 ;
V_23 -> V_59 [ 1 ] =
F_69 ( ( void * ) V_23 -> V_62 [ 1 ] ) ;
...
F_72 ( V_23 -> V_55 ) ;
if ( V_23 -> V_62 [ 0 ] )
F_73 ( V_23 -> V_62 [ 0 ] , V_23 -> V_199 [ 0 ] ) ;
if ( V_23 -> V_62 [ 1 ] )
F_73 ( V_23 -> V_62 [ 1 ] , V_23 -> V_199 [ 1 ] ) ;
#ifdef F_36
if ( V_23 -> V_194 )
F_74 ( V_23 -> V_194 , V_2 ) ;
