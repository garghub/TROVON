...
static struct V_32 * F_26 ( T_2 V_5 , bool V_7 )
{
struct V_3 * V_4 ;
struct V_32 * V_33 ;
...
static struct V_32 * F_28 ( T_2 V_5 )
{
return F_26 ( V_5 , false ) ;
}
static struct V_32 * F_29 ( T_2 V_5 )
{
...
V_59 = F_37 ( V_15 , V_15 -> V_21 ,
V_4 -> V_11 >> V_47 ,
V_5 , V_15 -> V_65 ) ;
if ( V_59 ) {
F_5 ( V_19 -> V_2 , L_13 ,
V_59 ) ;
F_11 ( V_19 -> V_2 , V_4 -> V_5 ,
V_4 -> V_8 , V_4 -> V_11 ) ;
goto error;
}
} else {
...
struct V_78 * V_79 )
{
F_41 ( V_19 , V_72 , V_2 , V_73 , type , V_76 , V_77 ,
V_28 , & V_80 , V_79 ) ;
}
void F_42 ( struct V_23 * V_19 ,
const struct V_71 * V_72 ,
struct V_1 * V_2 ,
T_3 * V_73 ,
enum V_74 type ,
