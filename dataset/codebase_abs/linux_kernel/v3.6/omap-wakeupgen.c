...
static int T_3 F_29 ( struct V_54 * V_55 ,
unsigned long V_56 , void * V_57 )
{
unsigned int V_2 = ( unsigned int ) V_57 ;
switch ( V_56 ) {
case V_58 :
F_19 ( V_2 , 0 ) ;
break;
...
static void T_4 F_30 ( void )
{}
static int F_32 ( struct V_54 * V_55 , unsigned long V_62 , void * V_63 )
{
switch ( V_62 ) {
case V_64 :
if ( F_33 () == V_65 )
