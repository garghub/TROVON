...
static void F_32 ( struct V_1 * V_26 )
{
struct V_44 * V_45 = F_33 ( & V_26 -> V_46 , NULL ) ;
if ( V_45 )
V_46 ( V_45 ) ;
else
F_31 ( V_26 ) ;
}
static int F_34 ( void * V_25 )
{
struct V_1 * V_26 = V_25 ;
T_3 V_47 ;
F_18 ( & V_30 -> V_31 -> V_32 ) ;
...
F_20 ( & V_30 -> V_31 -> V_32 ) ;
V_47 = F_35 ( F_17 , V_26 , V_49 ) ;
if ( V_47 < 0 ) {
V_26 -> V_29 = V_47 ;
} else {
int V_16 = - V_53 ;
F_36 ( V_47 , ( int V_54 * ) & V_16 , 0 , NULL ) ;
if ( V_16 )
V_26 -> V_29 = V_16 ;
}
F_32 ( V_26 ) ;
...
static
struct V_1 * F_60 ( char * V_41 , char * * V_3 ,
char * * V_6 , T_4 V_76 )
{
struct V_1 * V_26 ;
V_26 = F_61 ( sizeof( struct V_1 ) , V_76 ) ;
if ( ! V_26 )
goto V_8;
F_62 ( & V_26 -> V_56 , F_37 ) ;
V_26 -> V_41 = V_41 ;
...
static
int F_64 ( struct V_1 * V_26 , int V_5 )
{
F_65 ( V_77 ) ;
int V_29 = 0 ;
F_56 () ;
...
V_2 = F_60 ( V_41 , V_3 , V_6 , V_76 ) ;
if ( V_2 == NULL )
return - V_12 ;
F_63 ( V_2 , V_40 , V_43 , V_25 ) ;
return F_64 ( V_2 , V_5 ) ;
}
static int F_69 ( struct V_83 * V_84 , int V_85 ,
...
V_89 = * V_84 ;
V_89 . V_25 = & V_90 ;
V_93 = F_72 ( & V_89 , V_85 , V_86 , V_87 , V_88 ) ;
if ( V_93 < 0 )
return V_93 ;
for ( V_94 = 0 ; V_94 < V_91 ; V_94 ++ )
