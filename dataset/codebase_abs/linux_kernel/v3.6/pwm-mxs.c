...
struct V_37 * V_37 ;
int V_9 ;
V_8 = F_14 ( & V_30 -> V_33 , sizeof( * V_8 ) , V_38 ) ;
if ( ! V_8 )
return - V_39 ;
V_36 = F_15 ( V_30 , V_40 , 0 ) ;
...
if ( F_18 ( V_37 ) )
return F_19 ( V_37 ) ;
V_8 -> V_14 = F_20 ( & V_30 -> V_33 , NULL ) ;
if ( F_18 ( V_8 -> V_14 ) )
return F_19 ( V_8 -> V_14 ) ;
V_8 -> V_2 . V_33 = & V_30 -> V_33 ;
V_8 -> V_2 . V_42 = & V_43 ;
V_8 -> V_2 . V_20 = - 1 ;
V_9 = F_21 ( V_32 , L_1 , & V_8 -> V_2 . V_44 ) ;
if ( V_9 < 0 ) {
F_22 ( & V_30 -> V_33 , L_2 , V_9 ) ;
return V_9 ;
}
V_9 = F_23 ( & V_8 -> V_2 ) ;
if ( V_9 < 0 ) {
F_22 ( & V_30 -> V_33 , L_3 , V_9 ) ;
return V_9 ;
}
V_8 -> V_33 = & V_30 -> V_33 ;
F_24 ( V_30 , V_8 ) ;
...
static int T_1 F_26 ( struct V_29 * V_30 )
{
