...
static struct V_158 * F_80 ( const struct V_2 * V_3 )
{
struct V_2 * V_92 = V_1 ( V_3 ) -> V_92 ;
return F_81 ( V_92 ) -> F_82 ( V_92 ) ;
}
static T_2 F_83 ( const struct V_2 * V_3 )
{
struct V_2 * V_92 = V_1 ( V_3 ) -> V_92 ;
return F_81 ( V_92 ) -> F_84 ( V_92 ) ;
}
static T_2 F_85 ( const struct V_2 * V_3 )
{
struct V_2 * V_92 = V_1 ( V_3 ) -> V_92 ;
return F_81 ( V_92 ) -> F_86 ( V_92 ) ;
}
...
static int F_88 ( struct V_175 * V_176 [] , struct V_175 * V_30 [] )
{
if ( V_176 [ V_177 ] ) {
if ( F_89 ( V_176 [ V_177 ] ) != V_7 )
return - V_31 ;
}
return 0 ;
}
static int F_90 ( struct V_23 * V_24 , struct V_2 * V_3 ,
struct V_178 * V_179 , struct V_2 * V_180 )
{
if ( ! F_69 ( V_3 ) )
goto V_118;
if ( V_3 -> type != V_160 )
...
static int F_91 ( struct V_182 * V_183 , struct V_2 * V_3 ,
struct V_175 * V_176 [] , struct V_175 * V_30 [] )
{
struct V_2 * V_92 ;
struct V_94 * V_95 ;
F_5 ( L_49 ) ;
if ( ! V_176 [ V_184 ] )
return - V_31 ;
V_92 = F_92 ( V_183 , F_93 ( V_176 [ V_184 ] ) ) ;
if ( ! V_92 )
return - V_185 ;
V_1 ( V_3 ) -> V_92 = V_92 ;
F_94 ( & V_1 ( V_3 ) -> V_186 ) ;
...
F_95 ( & V_1 ( V_3 ) -> V_186 ) ;
F_53 ( & V_95 -> V_106 ) ;
F_59 ( & V_95 -> V_106 , & V_187 ) ;
F_96 ( & V_1 ( V_3 ) -> V_186 ) ;
F_97 ( V_3 ) ;
return 0 ;
}
static void F_98 ( struct V_2 * V_3 , struct V_188 * V_56 )
{
struct V_1 * V_189 = V_1 ( V_3 ) ;
struct V_2 * V_92 = V_189 -> V_92 ;
