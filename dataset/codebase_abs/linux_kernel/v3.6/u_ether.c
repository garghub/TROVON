...
const struct V_121 * V_104 ;
const struct V_121 * V_42 ;
if ( V_91 -> V_122 )
V_91 -> V_122 ( V_91 ) ;
V_104 = V_91 -> V_93 -> V_123 ;
V_42 = V_91 -> V_43 -> V_123 ;
F_60 ( V_91 -> V_93 ) ;
F_60 ( V_91 -> V_43 ) ;
if ( F_44 ( V_9 ) ) {
F_13 ( V_12 , L_16 ) ;
V_91 -> V_93 -> V_123 = V_104 ;
V_91 -> V_43 -> V_123 = V_42 ;
F_61 ( V_91 -> V_93 ) ;
F_61 ( V_91 -> V_43 ) ;
}
}
...
static int F_62 ( const char * V_124 , T_5 * V_125 )
{
if ( V_124 ) {
unsigned V_87 ;
...
int F_66 ( struct V_1 * V_127 , T_5 V_128 [ V_129 ] ,
const char * V_130 )
{
struct V_11 * V_12 ;
struct V_8 * V_9 ;
...
F_71 ( & V_12 -> V_68 ) ;
V_12 -> V_9 = V_9 ;
snprintf ( V_9 -> V_28 , sizeof( V_9 -> V_28 ) , L_17 , V_130 ) ;
if ( F_62 ( V_125 , V_9 -> V_125 ) )
F_72 ( & V_127 -> V_12 ,
L_18 , L_19 ) ;
...
V_14 = F_76 ( V_9 ) ;
if ( V_14 < 0 ) {
F_77 ( & V_127 -> V_12 , L_21 , V_14 ) ;
F_78 ( V_9 ) ;
} else {
F_79 ( V_12 , L_22 , V_9 -> V_125 ) ;
F_79 ( V_12 , L_23 , V_12 -> V_133 ) ;
V_131 = V_12 ;
F_80 ( V_9 ) ;
}
return V_14 ;
...
{
struct V_11 * V_12 = V_131 ;
int V_138 = 0 ;
if ( ! V_12 )
return F_85 ( - V_139 ) ;
V_91 -> V_93 -> V_65 = V_12 ;
V_138 = F_61 ( V_91 -> V_93 ) ;
if ( V_138 != 0 ) {
F_13 ( V_12 , L_24 ,
V_91 -> V_93 -> V_28 , V_138 ) ;
goto V_140;
}
V_91 -> V_43 -> V_65 = V_12 ;
V_138 = F_61 ( V_91 -> V_43 ) ;
if ( V_138 != 0 ) {
F_13 ( V_12 , L_24 ,
V_91 -> V_43 -> V_28 , V_138 ) ;
goto V_141;
}
if ( V_138 == 0 )
V_138 = F_37 ( V_12 , V_91 , F_1 ( V_12 -> V_2 ) ) ;
if ( V_138 == 0 ) {
V_12 -> V_114 = V_91 -> V_142 ;
