...
V_118 = F_68 ( V_119 , V_133 , V_134 , L_15 , NULL ) ;
if ( V_118 )
F_50 ( L_16 ,
V_119 , V_118 ) ;
return V_118 ;
...
int F_72 ( int V_4 , int V_156 , int V_157 , int V_158 )
{
unsigned int V_2 ;
if ( V_159 != - V_70 )
return - V_70 ;
...
int F_73 ( int V_4 , const T_6 * V_169 , T_6 * V_170 )
{
...
int F_74 ( int V_4 , int V_172 , int V_173 )
{
if ( V_159 != - V_70 )
return - V_70 ;
if ( ! F_21 () ) {
...
int F_77 ( int V_4 , int V_156 , int V_157 , int V_172 ,
int V_173 )
{
unsigned int V_2 ;
if ( V_159 != - V_70 )
...
int F_79 ( int V_4 , const T_6 * V_169 , T_6 * V_174 )
{
int V_138 ;
