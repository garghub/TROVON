...
V_82 -> V_132 = V_126 << 8 ;
V_82 -> V_133 = 8 ;
V_82 -> V_134 = F_42 ( V_83 ) ? V_135 : V_136 ;
V_82 -> V_137 = V_138 ;
V_82 -> V_139 = F_42 ( V_83 ) ?
V_140 : V_141 ;
V_124 ++ ;
}
}
...
V_12 -> V_164 = L_76 ;
V_12 -> V_165 = V_166 ;
V_12 -> V_167 = V_147 [ V_62 ] . V_167 ;
V_12 -> V_168 = F_37 ( V_64 ) ;
V_12 -> V_169 = NULL ;
V_12 -> V_170 = F_30 ;
if ( F_56 ( V_12 ) ) {
F_21 ( 0 , L_77 ) ;
...
static int T_3 F_66 ( struct V_63 * V_64 ,
...
if ( V_177 )
return V_177 ;
return F_59 ( V_64 , V_176 -> V_178 ) ;
}
static void T_4 F_68 ( struct V_63 * V_64 )
{
struct V_11 * V_12 ;
F_21 ( 0 , L_83 ) ;
if ( V_172 )
