...
static void F_30 ( void T_1 * V_1 , int V_83 )
{
T_2 V_2 ;
V_2 = F_2 ( V_1 + V_72 ) ;
if ( V_83 )
...
static void F_31 ( void T_1 * V_1 , int V_85 , int V_86 )
{
int V_2 = ( ( V_86 & 0xffff ) ) | ( ( V_85 & 0x7ff ) << 16 ) ;
F_3 ( V_2 , V_1 + V_87 ) ;
}
struct V_88 * F_32 ( void T_1 * V_1 )
{
struct V_88 * V_89 ;
T_2 V_90 = F_2 ( V_1 + V_91 ) ;
V_89 = F_33 ( sizeof( const struct V_88 ) , V_92 ) ;
if ( ! V_89 )
return NULL ;
V_89 -> V_89 = & V_93 ;
V_89 -> V_94 = & V_95 ;
V_89 -> V_83 . V_96 = V_97 ;
V_89 -> V_83 . V_37 = V_98 ;
V_89 -> V_83 . V_99 = V_100 ;
V_89 -> V_101 . V_10 = V_102 ;
V_89 -> V_101 . V_103 = V_104 ;
V_89 -> V_105 = V_90 ;
return V_89 ;
}
