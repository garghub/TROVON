...
if ( V_4 -> V_7 == V_26 ) {
int V_53 ;
for ( V_53 = 0 ; V_53 < V_4 -> V_27 . V_265 ; V_53 ++ )
F_39 ( V_3 , V_4 -> V_27 . V_28 [ V_53 ] , 0 ) ;
}
return 0 ;
}
...
V_142 -> type = V_361 ;
V_142 -> V_145 = 1 ;
V_142 -> V_146 . integer . V_362 = 0 ;
V_142 -> V_146 . integer . V_363 = 1 ;
return 0 ;
}
...
F_52 ( V_3 , 0x25 , V_127 ) ;
F_52 ( V_3 , 0x16 , V_344 ? V_139 : V_127 ) ;
F_52 ( V_3 , 0x10 , V_365 ? V_139 : V_127 ) ;
}
