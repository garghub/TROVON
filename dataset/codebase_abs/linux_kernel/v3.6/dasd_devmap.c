...
static T_2 F_73 ( struct V_62 * V_71 ,
...
if ( V_62 -> V_91 && V_62 -> V_91 -> V_102 &&
! V_62 -> V_91 -> V_102 ( V_62 , & V_101 ) ) {
if ( V_101 . type == V_103 ||
V_101 . type == V_104 ) {
F_45 ( V_62 ) ;
...
static T_2 F_74 ( struct V_62 * V_71 ,
struct V_79 * V_80 , char * V_81 )
{
struct V_68 * V_62 ;
struct V_100 V_101 ;
...
V_105 = L_42 ;
if ( F_15 ( V_62 ) )
return snprintf ( V_81 , V_41 , L_32 , V_105 ) ;
if ( V_62 -> V_91 && V_62 -> V_91 -> V_102 &&
! V_62 -> V_91 -> V_102 ( V_62 , & V_101 ) )
V_105 = V_101 . V_105 ;
F_45 ( V_62 ) ;
...
static T_2
F_75 ( struct V_62 * V_71 , struct V_79 * V_80 , char * V_81 )
{
struct V_68 * V_62 ;
struct V_100 V_101 ;
char V_106 [ V_107 ] ;
...
V_106 [ 0 ] = 0 ;
if ( F_15 ( V_62 ) )
return snprintf ( V_81 , V_41 , L_32 , V_106 ) ;
if ( V_62 -> V_91 && V_62 -> V_91 -> V_102 &&
! V_62 -> V_91 -> V_102 ( V_62 , & V_101 ) ) {
switch ( V_101 . type ) {
case V_109 :
snprintf ( V_108 , sizeof( V_108 ) , L_43 ,
V_101 . V_110 ) ;
break;
case V_103 :
snprintf ( V_108 , sizeof( V_108 ) , L_43 ,
...
break;
case V_104 :
snprintf ( V_108 , sizeof( V_108 ) , L_44 ) ;
break;
default:
snprintf ( V_108 , sizeof( V_108 ) , L_43 ,
V_101 . V_110 ) ;
...
if ( strlen ( V_101 . V_112 ) > 0 )
snprintf ( V_106 , sizeof( V_106 ) ,
L_45 ,
V_101 . V_105 , V_101 . V_113 , V_101 . V_20 , V_108 ,
V_101 . V_112 ) ;
else
snprintf ( V_106 , sizeof( V_106 ) ,
L_46 ,
...
static T_2
F_76 ( struct V_62 * V_71 , struct V_79 * V_80 , char * V_81 )
{
struct V_45 * V_46 ;
int V_114 ;
V_46 = F_25 ( F_34 ( V_71 ) ) ;
if ( ! F_15 ( V_46 ) && V_46 -> V_62 )
V_114 = F_77 ( V_46 -> V_62 ) ;
else
V_114 = 0 ;
return snprintf ( V_81 , V_41 , V_114 ? L_30 : L_31 ) ;
}
static T_2
F_78 ( struct V_62 * V_71 , struct V_79 * V_80 ,
const char * V_81 , T_3 V_6 )
{
struct V_45 * V_46 ;
int V_11 , V_24 ;
...
if ( F_15 ( V_62 ) )
return - V_65 ;
V_23 = snprintf ( V_81 , V_41 , L_47 , V_62 -> V_115 ) ;
F_45 ( V_62 ) ;
return V_23 ;
}
static T_2
...
static T_2 F_84 ( struct V_62 * V_71 ,
struct V_79 * V_80 ,
const char * V_81 , T_3 V_6 )
{
struct V_45 * V_46 ;
...
if ( F_62 ( V_118 , & V_62 -> V_72 ) )
V_24 = snprintf ( V_81 , V_41 , L_52 ) ;
else if ( F_62 ( V_119 , & V_62 -> V_72 ) )
...
int
F_89 ( struct V_69 * V_70 , int V_120 )
{
struct V_45 * V_46 ;
V_46 = F_25 ( F_34 ( & V_70 -> V_71 ) ) ;
if ( F_15 ( V_46 ) )
return F_18 ( V_46 ) ;
return ( ( V_46 -> V_22 & V_120 ) != 0 ) ;
}
int
F_90 ( struct V_69 * V_70 , int V_120 , int V_121 )
{
struct V_45 * V_46 ;
V_46 = F_25 ( F_34 ( & V_70 -> V_71 ) ) ;
if ( F_15 ( V_46 ) )
...
int
F_91 ( struct V_69 * V_70 )
{
return F_92 ( & V_70 -> V_71 . V_122 , & V_123 ) ;
}
void
F_93 ( struct V_69 * V_70 )
{
F_94 ( & V_70 -> V_71 . V_122 , & V_123 ) ;
}
int
F_95 ( void )
{
