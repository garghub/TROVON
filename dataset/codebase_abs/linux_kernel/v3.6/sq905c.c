...
L_10 ,
V_1 -> V_14 [ 3 ] ,
V_1 -> V_14 [ 14 ] , V_1 -> V_14 [ 15 ] ,
V_1 -> V_14 [ 16 ] , V_1 -> V_14 [ 17 ] ,
V_1 -> V_14 [ 18 ] , V_1 -> V_14 [ 19 ] ) ;
V_39 -> V_45 = V_46 ;
V_39 -> V_47 = 2 ;
if ( V_1 -> V_14 [ 15 ] == 0 )
V_39 -> V_47 = 1 ;
...
V_5 -> V_50 = F_24 ( V_56 ) ;
F_25 ( V_5 -> V_50 , & V_5 -> V_15 ) ;
return 0 ;
}
static int F_26 ( struct V_57 * V_58 ,
const struct V_37 * V_38 )
{
return F_27 ( V_58 , V_38 ,
& V_59 ,
sizeof( struct V_17 ) ,
V_60 ) ;
}
