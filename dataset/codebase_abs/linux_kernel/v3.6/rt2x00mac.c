...
V_99 . V_119 = F_48 ( V_2 , V_26 ) ;
V_99 . V_120 = F_49 ( V_100 ) ;
if ( V_99 . V_120 == V_121 )
return - V_115 ;
V_99 . V_108 = V_108 ;
if ( V_94 ) {
V_99 . V_122 = V_94 -> V_68 ;
V_113 = F_50 ( V_94 ) ;
V_99 . V_123 = V_113 -> V_123 ;
} else
V_99 . V_122 = V_110 ;
if ( V_99 . V_120 == V_124 )
F_45 ( & V_99 , & V_100 -> V_100 [ 0 ] , V_100 -> V_117 ) ;
else
memcpy ( V_99 . V_100 , & V_100 -> V_100 [ 0 ] , V_100 -> V_117 ) ;
if ( V_108 == V_125 )
V_100 -> V_126 = 0 ;
if ( V_100 -> V_15 & V_116 )
...
if ( V_113 -> V_123 < 0 )
return 0 ;
return V_2 -> V_39 -> V_88 -> V_130 ( V_2 , V_113 -> V_123 ) ;
}
