...
static int F_111 ( struct V_107 * V_213 )
{
struct V_201 * V_118 = F_112 ( V_213 ) ;
struct V_200 * V_110 = F_113 ( V_213 ) ;
...
F_116 ( V_2 -> V_13 ) ;
F_116 ( V_2 -> V_162 ) ;
for ( V_164 = 0 ; V_164 < F_12 ( V_240 ) ; V_164 ++ )
V_2 -> V_240 [ V_164 ] = F_3 ( V_2 -> V_11 + V_240 [ V_164 ] ) ;
F_83 ( V_118 ) ;
F_117 ( V_118 ) ;
F_118 ( V_118 , V_241 ) ;
return 0 ;
}
static int F_119 ( struct V_107 * V_213 )
{
struct V_201 * V_118 = F_112 ( V_213 ) ;
struct V_200 * V_110 = F_113 ( V_213 ) ;
struct V_1 * V_2 = V_110 -> V_15 ;
...
F_123 ( V_2 -> V_162 ) ;
for ( V_164 = 0 ; V_164 < F_12 ( V_240 ) ; V_164 ++ )
F_4 ( V_2 -> V_240 [ V_164 ] , V_2 -> V_11 + V_240 [ V_164 ] ) ;
F_114 ( V_110 , V_243 ) ;
return 0 ;
}
