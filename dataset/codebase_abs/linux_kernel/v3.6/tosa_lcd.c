...
F_6 ( V_4 ) ;
F_9 ( V_4 ) ;
V_4 -> V_36 = F_24 ( L_3 , & V_2 -> V_44 , V_4 ,
& V_49 ) ;
if ( F_25 ( V_4 -> V_36 ) ) {
V_43 = F_26 ( V_4 -> V_36 ) ;
V_4 -> V_36 = NULL ;
...
static int T_4 F_27 ( struct V_1 * V_2 )
{
struct V_15 * V_4 = F_28 ( & V_2 -> V_44 ) ;
F_29 ( V_4 -> V_36 ) ;
if ( V_4 -> V_27 )
F_30 ( V_4 -> V_27 ) ;
F_12 ( V_4 ) ;
...
static int F_31 ( struct V_1 * V_2 , T_5 V_51 )
{
struct V_15 * V_4 = F_28 ( & V_2 -> V_44 ) ;
F_12 ( V_4 ) ;
return 0 ;
