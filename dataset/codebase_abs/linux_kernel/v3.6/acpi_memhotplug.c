...
( void ) F_32 ( V_28 , V_58 , V_60 , NULL ) ;
return;
}
static int F_33 ( struct V_32 * V_27 )
{
int V_34 ;
struct V_4 * V_5 = NULL ;
if ( ! V_27 )
...
F_6 ( & V_5 -> V_25 ) ;
V_5 -> V_27 = V_27 ;
sprintf ( F_34 ( V_27 ) , L_19 , V_68 ) ;
sprintf ( F_35 ( V_27 ) , L_19 , V_69 ) ;
V_27 -> V_70 = V_5 ;
V_34 = F_8 ( V_5 ) ;
if ( V_34 ) {
F_12 ( V_5 ) ;
...
static int F_36 ( struct V_32 * V_27 , int type )
{
struct V_4 * V_5 = NULL ;
if ( ! V_27 || ! F_19 ( V_27 ) )
return - V_30 ;
