...
F_4 ( L_2 , V_20 ) ;
F_31 ( V_23 , & V_102 ) ;
V_100 = V_71 -> V_103 - V_2 -> V_104 ;
if ( ( V_100 > - V_102 . V_105 ) &&
( V_100 < V_102 . V_105 ) &&
( V_100 != 0 ) &&
( V_2 -> V_88 == V_71 -> V_88 ) &&
( V_2 -> V_73 == V_71 -> V_73 ) ) {
if ( V_23 -> V_106 . V_107 . V_108 ) {
V_23 -> V_106 . V_107 . V_108 ( V_23 ) ;
if ( V_23 -> V_106 . V_109 ) V_23 -> V_106 . V_109 ( V_23 , 0 ) ;
}
if ( V_23 -> V_106 . V_107 . V_110 ) {
T_6 V_59 ;
V_23 -> V_106 . V_107 . V_110 ( V_23 , & V_59 ) ;
if ( V_23 -> V_106 . V_109 ) V_23 -> V_106 . V_109 ( V_23 , 0 ) ;
F_25 ( V_2 , V_71 -> V_103 - V_59 ) ;
} else {
F_25 ( V_2 , 0 ) ;
}
F_4 ( L_10 ) ;
...
V_2 -> V_61 = 44000000 ;
F_4 ( L_12 , V_2 -> V_61 / 1000000 - 8 , ( V_2 -> V_61 + ( V_111 * 32 ) - 1 ) / ( V_111 * 32 ) ) ;
F_3 ( V_2 , V_112 , V_2 -> V_61 / 1000000 - 8 ) ;
F_3 ( V_2 , V_113 , 0x40 ) ;
F_3 ( V_2 , V_114 , ( V_2 -> V_61 + ( V_111 * 32 ) - 1 ) / ( V_111 * 32 ) ) ;
if ( V_71 -> V_73 > 29000000 )
...
F_3 ( V_2 , V_120 , ( 0 << 6 ) | 0x10 ) ;
else if ( V_71 -> V_73 >= 4000000 )
F_3 ( V_2 , V_120 , ( 1 << 6 ) | 0x10 ) ;
else
F_3 ( V_2 , V_120 , ( 3 << 6 ) | 0x10 ) ;
F_3 ( V_2 , V_121 , 0x00 ) ;
F_3 ( V_2 , V_122 , 0x33 ) ;
F_3 ( V_2 , V_123 , V_2 -> V_9 -> V_124 ) ;
F_3 ( V_2 , V_63 , 0x3d ) ;
F_3 ( V_2 , V_125 , 0x03 ) ;
F_3 ( V_2 , V_126 , 0x6e ) ;
F_3 ( V_2 , V_127 , 0x00 ) ;
...
V_102 -> V_129 = 200 ;
V_102 -> V_130 = ( V_71 -> V_73 / 8000 ) ;
V_102 -> V_105 = 14 * V_102 -> V_130 ;
} else {
V_102 -> V_129 = 200 ;
V_102 -> V_130 = ( V_71 -> V_73 / 8000 ) ;
V_102 -> V_105 = 18 * V_102 -> V_130 ;
}
return 0 ;
}
static int F_33 ( struct V_22 * V_23 , int V_131 )
{
struct V_1 * V_2 = V_23 -> V_25 ;
if ( V_131 )
return F_3 ( V_2 , 0x02 , V_2 -> V_132 | 1 ) ;
else
return F_3 ( V_2 , 0x02 , V_2 -> V_132 & 0xfe ) ;
}
static int F_34 ( struct V_22 * V_23 )
{
struct V_1 * V_2 = V_23 -> V_25 ;
V_2 -> V_132 = V_2 -> V_9 -> V_133 << 4 ;
F_3 ( V_2 , 0x02 , V_2 -> V_132 ) ;
F_8 ( 10 ) ;
F_21 ( V_2 ) ;
return 0 ;
}
...
static T_6 F_39 ( struct V_135 * V_136 )
{
return V_137 ;
}
static int F_40 ( struct V_135 * V_138 , struct V_6 V_7 [] , int V_139 )
{
struct V_1 * V_2 = F_41 ( V_138 ) ;
struct V_6 V_140 [ 1 + V_139 ] ;
T_1 V_141 [ 2 ] = { V_115 , V_2 -> V_132 | 1 } ;
memset ( V_140 , 0 , sizeof( struct V_6 ) * ( 1 + V_139 ) ) ;
V_140 [ 0 ] . V_8 = V_2 -> V_9 -> V_10 ;
V_140 [ 0 ] . V_12 = V_141 ;
V_140 [ 0 ] . V_13 = 2 ;
memcpy ( & V_140 [ 1 ] , V_7 , sizeof( struct V_6 ) * V_139 ) ;
return F_2 ( V_2 -> V_17 , V_140 , 1 + V_139 ) == 1 + V_139 ? V_139 : - V_46 ;
}
struct V_135 * F_42 ( struct V_22 * V_23 )
{
struct V_1 * V_2 = V_23 -> V_25 ;
return & V_2 -> V_134 ;
}
struct V_22 * F_43 ( const struct V_142 * V_9 ,
struct V_135 * V_17 )
{
struct V_1 * V_2 = F_44 ( sizeof( struct V_1 ) , V_143 ) ;
T_1 V_35 ;
if ( V_2 == NULL )
goto error;
V_2 -> V_9 = V_9 ;
...
memcpy ( & V_2 -> V_145 . V_106 , & V_146 , sizeof( struct V_147 ) ) ;
V_2 -> V_145 . V_25 = V_2 ;
F_45 ( V_2 -> V_134 . V_148 , L_13 ,
sizeof( V_2 -> V_134 . V_148 ) ) ;
V_2 -> V_134 . V_149 = & V_150 ;
V_2 -> V_134 . V_151 = NULL ;
F_46 ( & V_2 -> V_134 , V_2 ) ;
if ( F_47 ( & V_2 -> V_134 ) < 0 ) {
F_17 ( V_60 L_14 ) ;
goto error;
