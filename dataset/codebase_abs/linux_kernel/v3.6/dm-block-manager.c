...
F_10 ( L_5 ,
V_36 -> V_37 -> V_54 , V_52 ? V_52 -> V_54 : L_6 ,
( unsigned long long )
F_38 ( V_34 ) ) ;
return - V_18 ;
}
...
int F_60 ( struct V_39 * V_45 , T_2 V_31 ,
struct V_51 * V_52 ,
struct V_33 * * V_55 )
{
struct V_35 * V_36 ;
void * V_56 ;
int V_28 ;
V_56 = F_61 ( V_45 -> V_49 , V_31 , (struct V_32 * * ) V_55 ) ;
if ( F_59 ( F_49 ( V_56 ) ) )
return F_50 ( V_56 ) ;
V_36 = F_42 ( F_36 ( * V_55 ) ) ;
V_28 = F_26 ( & V_36 -> V_2 ) ;
...
void * V_56 ;
int V_28 ;
V_56 = F_65 ( V_45 -> V_49 , V_31 , (struct V_32 * * ) V_55 ) ;
if ( F_59 ( F_49 ( V_56 ) ) )
return F_50 ( V_56 ) ;
if ( F_59 ( ! V_56 ) )
return - V_30 ;
...
F_68 ( V_59 ) ;
return F_71 ( V_45 -> V_49 ) ;
}
void F_72 ( struct V_39 * V_45 )
{
V_45 -> V_50 = true ;
}
T_3 F_73 ( const void * V_60 , T_4 V_61 , T_3 V_62 )
{
return F_74 ( ~ ( T_3 ) 0 , V_60 , V_61 ) ^ V_62 ;
}
