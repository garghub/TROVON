...
return 0 ;
V_81 = ( V_78 - V_77 ) * V_80 -> V_85 ;
if ( V_81 > 0 )
return V_81 / ( ( V_30 & 0x0f ) + 1 ) ;
return 0 ;
}
static T_2 int F_24 ( struct V_86 * V_87 )
{
struct V_88 * V_28 = F_25 ( V_87 -> V_63 . V_89 ) ;
...
int V_92 , V_29 , V_93 ;
if ( ! V_62 ) {
F_26 ( V_87 -> V_63 . V_89 , L_8 ) ;
return - V_94 ;
}
V_25 = F_27 ( & V_87 -> V_63 , sizeof( struct V_24 ) ,
V_95 ) ;
if ( ! V_25 )
return - V_96 ;
V_93 = sizeof( struct V_1 * ) * V_62 -> V_97 ;
V_25 -> V_2 = F_27 ( & V_87 -> V_63 , V_93 , V_95 ) ;
if ( ! V_25 -> V_2 )
return - V_96 ;
V_2 = V_25 -> V_2 ;
V_25 -> V_63 = & V_87 -> V_63 ;
...
V_116 [ V_117 ] . V_123 = V_80 -> V_104 * 1000 ;
V_116 [ V_117 ] . V_124 = V_80 -> V_85 * 1000 ;
}
V_91 . V_63 = V_25 -> V_63 ;
V_91 . V_125 = V_62 -> V_116 [ V_92 ] . V_126 ;
V_91 . V_127 = V_25 ;
V_2 [ V_92 ] = F_33 ( & V_116 [ V_117 ] , & V_91 ) ;
if ( F_34 ( V_2 [ V_92 ] ) ) {
V_29 = F_35 ( V_2 [ V_92 ] ) ;
F_26 ( V_25 -> V_63 , L_15 ) ;
V_2 [ V_92 ] = NULL ;
