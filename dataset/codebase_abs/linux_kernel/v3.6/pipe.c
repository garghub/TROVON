...
{
T_1 V_25 = F_8 ( V_2 ) & V_22 ;
return ( int ) ( V_25 == V_27 || V_25 == V_26 ) ;
}
...
{
struct V_6 * V_7 = F_4 ( V_2 ) ;
struct V_53 * V_54 = F_30 ( V_7 ) ;
struct V_55 * V_56 = F_31 ( V_7 ) ;
int V_57 = F_16 ( V_2 ) ;
int V_46 = F_25 ( V_2 ) ;
T_1 V_58 ;
T_1 V_59 ;
...
void F_33 ( struct V_1 * V_2 , T_1 V_63 ,
T_1 V_39 , T_1 V_64 )
{
if ( V_63 > 0xA ) {
struct V_6 * V_7 = F_4 ( V_2 ) ;
...
void F_39 ( struct V_1 * V_2 , int V_65 )
{
T_1 V_4 = ( V_66 | V_67 ) ;
T_1 V_5 ;
switch ( V_65 ) {
...
static struct V_1 * F_41 ( struct V_6 * V_7 , T_2 type )
{
struct V_1 * V_69 , * V_2 ;
int V_70 ;
V_2 = NULL ;
...
int (* F_45)( struct V_72 * V_73 , int V_74 ) )
{
struct V_53 * V_54 = F_30 ( V_7 ) ;
struct V_1 * V_2 ;
int V_70 ;
...
struct V_1 * F_47 ( struct V_6 * V_7 ,
int V_78 ,
int V_34 )
{
struct V_55 * V_56 = F_31 ( V_7 ) ;
...
V_79 = F_17 ( V_2 ) ;
if ( V_79 < 0 ) {
F_34 ( V_56 , L_4 , F_16 ( V_2 ) ) ;
return NULL ;
}
V_80 = F_27 ( V_2 , V_33 , V_34 ) ;
V_81 = F_29 ( V_2 ) ;
F_14 ( V_2 ) ;
...
void F_50 ( struct V_1 * V_2 , struct V_82 * V_75 )
{
if ( V_2 -> V_75 )
V_2 -> V_75 -> V_2 = NULL ;
V_2 -> V_75 = V_75 ;
...
struct V_1 * V_2 ;
struct V_55 * V_56 = F_31 ( V_7 ) ;
T_2 * V_85 = F_56 ( V_7 , V_85 ) ;
int V_86 = F_56 ( V_7 , V_86 ) ;
int V_70 ;
if ( V_85 [ 0 ] != V_61 ) {
F_34 ( V_56 , L_8 ) ;
return - V_47 ;
}
V_54 -> V_2 = F_57 ( sizeof( struct V_1 ) * V_86 , V_87 ) ;
if ( ! V_54 -> V_2 ) {
F_34 ( V_56 , L_9 ) ;
return - V_88 ;
}
