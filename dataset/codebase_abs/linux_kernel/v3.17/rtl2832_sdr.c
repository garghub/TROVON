...
* V_109 = 8 - V_106 -> V_113 ;
* V_110 = 1 ;
V_111 [ 0 ] = F_60 ( V_2 -> V_114 ) ;
F_23 ( & V_2 -> V_44 -> V_16 , L_19 ,
V_48 , * V_109 , V_111 [ 0 ] ) ;
return 0 ;
}
static int F_61 ( struct V_115 * V_60 )
{
...
static void F_62 ( struct V_115 * V_60 )
{
struct V_1 * V_2 = F_59 ( V_60 -> V_105 ) ;
struct V_24 * V_7 =
...
T_3 V_121 ;
T_4 V_122 ;
F_23 ( & V_2 -> V_44 -> V_16 , L_20 , V_48 , V_2 -> V_123 ) ;
if ( ! F_66 ( V_124 , & V_2 -> V_13 ) )
return 0 ;
if ( V_2 -> V_123 == 0 )
return 0 ;
V_117 = V_2 -> V_123 ;
...
V_121 *= 0x400000 ;
V_121 = F_67 ( V_121 , V_2 -> V_11 -> V_129 ) ;
V_121 = - V_121 ;
...
if ( V_6 )
goto V_125;
V_122 = F_67 ( V_2 -> V_11 -> V_129 * 0x400000ULL , V_117 * 4U ) ;
V_122 <<= 2 ;
V_7 [ 0 ] = ( V_122 >> 24 ) & 0xff ;
V_7 [ 1 ] = ( V_122 >> 16 ) & 0xff ;
V_7 [ 2 ] = ( V_122 >> 8 ) & 0xff ;
...
if ( V_2 -> V_141 == 0 )
return 0 ;
V_139 = F_71 ( & V_2 -> V_142 ,
V_143 ) ;
V_140 = F_71 ( & V_2 -> V_142 , V_144 ) ;
if ( F_72 ( V_139 ) ) {
V_136 -> V_145 = V_2 -> V_123 ;
F_73 ( V_140 , V_2 -> V_123 ) ;
} else {
V_136 -> V_145 = F_72 ( V_140 ) ;
}
V_136 -> V_146 = V_2 -> V_141 ;
V_136 -> V_147 = V_148 ;
F_23 ( & V_2 -> V_44 -> V_16 , L_69 ,
V_48 , V_136 -> V_146 , V_136 -> V_145 ) ;
if ( ! F_66 ( V_124 , & V_2 -> V_13 ) )
return 0 ;
...
static int F_76 ( struct V_105 * V_106 , unsigned int V_152 )
{
struct V_1 * V_2 = F_59 ( V_106 ) ;
int V_6 ;
F_23 ( & V_2 -> V_44 -> V_16 , L_17 , V_48 ) ;
...
static int F_81 ( struct V_90 * V_90 , void * V_157 ,
struct V_158 * V_159 )
{
struct V_1 * V_2 = F_55 ( V_90 ) ;
F_23 ( & V_2 -> V_44 -> V_16 , L_70 ,
V_48 , V_159 -> V_160 , V_159 -> type ) ;
if ( V_159 -> V_160 == 0 ) {
F_56 ( V_159 -> V_96 , L_71 , sizeof( V_159 -> V_96 ) ) ;
V_159 -> type = V_161 ;
V_159 -> V_162 = V_163 | V_164 ;
V_159 -> V_165 = 300000 ;
V_159 -> V_166 = 3200000 ;
} else if ( V_159 -> V_160 == 1 ) {
F_56 ( V_159 -> V_96 , L_72 , sizeof( V_159 -> V_96 ) ) ;
V_159 -> type = V_167 ;
V_159 -> V_162 = V_163 | V_164 ;
...
V_48 , V_169 -> V_130 , V_169 -> type , V_169 -> V_160 ) ;
if ( V_169 -> V_130 == 0 ) {
if ( V_169 -> V_160 >= F_84 ( V_170 ) )
return - V_14 ;
* V_169 = V_170 [ V_169 -> V_160 ] ;
} else if ( V_169 -> V_130 == 1 ) {
if ( V_169 -> V_160 >= F_84 ( V_171 ) )
return - V_14 ;
...
static int F_85 ( struct V_90 * V_90 , void * V_157 ,
struct V_172 * V_173 )
{
struct V_1 * V_2 = F_55 ( V_90 ) ;
int V_6 = 0 ;
F_23 ( & V_2 -> V_44 -> V_16 , L_74 ,
V_48 , V_173 -> V_130 , V_173 -> type ) ;
if ( V_173 -> V_130 == 0 ) {
...
V_48 , V_173 -> V_130 , V_173 -> type , V_173 -> V_146 ) ;
...
if ( V_173 -> V_146 < F_87 )
V_169 = 0 ;
else if ( V_173 -> V_146 < F_88 )
V_169 = 1 ;
else
V_169 = 2 ;
V_2 -> V_123 = F_89 (unsigned int, f->frequency,
...
V_2 -> V_141 = F_89 (unsigned int, f->frequency,
bands_fm[0].rangelow,
...
static int F_90 ( struct V_90 * V_90 , void * V_157 ,
struct V_174 * V_173 )
{
struct V_1 * V_2 = F_55 ( V_90 ) ;
F_23 ( & V_2 -> V_44 -> V_16 , L_17 , V_48 ) ;
...
return - V_14 ;
F_56 ( V_173 -> V_176 , V_177 [ V_173 -> V_160 ] . V_96 , sizeof( V_173 -> V_176 ) ) ;
...
static int F_94 ( struct V_90 * V_90 , void * V_157 ,
struct V_107 * V_173 )
{
struct V_1 * V_2 = F_55 ( V_90 ) ;
int V_37 ;
...
static int F_95 ( struct V_138 * V_183 )
{
struct V_1 * V_2 =
F_63 ( V_183 -> V_184 , struct V_1 ,
V_142 ) ;
struct V_83 * V_84 = V_2 -> V_84 ;
struct V_135 * V_136 = & V_84 -> V_137 ;
int V_6 ;
F_23 ( & V_2 -> V_44 -> V_16 ,
L_79 ,
V_48 , V_183 -> V_185 , V_183 -> V_96 , V_183 -> V_4 ,
V_183 -> V_186 , V_183 -> V_187 , V_183 -> V_188 ) ;
switch ( V_183 -> V_185 ) {
case V_143 :
case V_144 :
if ( V_2 -> V_139 -> V_4 ) {
T_5 V_4 = V_2 -> V_123 + F_67 ( V_2 -> V_140 -> V_188 , 2 ) ;
T_4 V_189 ;
V_4 = F_89 ( T_5 , V_4 , V_2 -> V_140 -> V_186 ,
V_2 -> V_140 -> V_187 ) ;
V_189 = V_4 - V_2 -> V_140 -> V_186 ;
V_189 = V_2 -> V_140 -> V_188 *
F_67 ( V_189 , V_2 -> V_140 -> V_188 ) ;
...
static void F_96 ( struct V_190 * V_159 )
{
struct V_1 * V_2 =
F_63 ( V_159 , struct V_1 , V_88 ) ;
F_97 ( & V_2 -> V_142 ) ;
F_98 ( & V_2 -> V_88 ) ;
F_99 ( V_2 ) ;
}
struct V_83 * F_100 ( struct V_83 * V_84 ,
...
struct V_197 * V_154 = F_101 ( V_15 ) ;
V_2 = F_102 ( sizeof( struct V_1 ) , V_198 ) ;
if ( V_2 == NULL ) {
F_6 ( & V_154 -> V_44 -> V_16 ,
L_80 ) ;
return NULL ;
...
F_107 ( & V_2 -> V_142 , 9 ) ;
if ( V_194 )
F_108 ( & V_2 -> V_142 , V_194 -> V_214 , NULL ) ;
break;
case V_134 :
F_107 ( & V_2 -> V_142 , 2 ) ;
V_2 -> V_139 = F_109 ( & V_2 -> V_142 , V_126 ,
V_143 ,
0 , 1 , 1 , 1 ) ;
V_2 -> V_140 = F_109 ( & V_2 -> V_142 , V_126 ,
V_144 ,
0 , 8000000 , 100000 , 0 ) ;
F_110 ( 2 , & V_2 -> V_139 , 0 , false ) ;
break;
case V_132 :
case V_133 :
F_107 ( & V_2 -> V_142 , 2 ) ;
...
F_111 ( & V_2 -> V_89 , V_2 ) ;
V_2 -> V_88 . V_219 = F_96 ;
V_6 = F_112 ( & V_2 -> V_44 -> V_16 , & V_2 -> V_88 ) ;
if ( V_6 ) {
F_6 ( & V_2 -> V_44 -> V_16 ,
L_84 , V_6 ) ;
goto V_215;
...
F_114 ( & V_2 -> V_44 -> V_16 , L_86 ,
F_115 ( & V_2 -> V_89 ) ) ;
V_84 -> V_85 = V_2 ;
V_84 -> V_126 . V_224 = F_48 ;
F_114 ( & V_2 -> V_15 -> V_16 , L_87 ,
V_17 ) ;
F_68 ( & V_2 -> V_44 -> V_16 ,
L_88 ,
V_17 ) ;
