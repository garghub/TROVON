...
{
const struct V_3 * V_3 ;
struct V_1 * V_2 = F_24 ( V_51 ) ;
int V_20 ;
F_2 ( L_18 , V_51 , V_53 ) ;
if ( V_51 -> V_54 -> V_55 . V_56 != 0 )
return - V_57 ;
if ( ! V_53 -> V_58 ) {
