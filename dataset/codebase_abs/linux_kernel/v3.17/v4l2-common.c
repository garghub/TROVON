...
void F_37 ( T_4 * V_84 , unsigned int V_85 , unsigned int V_86 ,
unsigned int V_87 ,
...
V_91 = F_38 ( * V_88 ) ;
if ( V_87 + V_91 < V_92 ) {
unsigned int V_93 = F_39 ( V_86 ^ ( V_85 - 1 ) ) ;
unsigned int V_94 = F_39 ( V_90 ^ ( V_89 - 1 ) ) ;
do {
if ( V_91 >= V_94 ||
( V_87 <= V_91 && V_87 < V_93 ) ) {
