...
static void F_67 ( struct V_1 * V_2 , struct V_146 * V_147 )
{
struct V_4 * V_5 = V_2 -> V_5 ;
...
static void F_70 ( struct V_1 * V_2 , unsigned int V_149 )
{
int V_150 = V_149 >> V_151 ;
struct V_146 * V_147 ;
int V_152 = ( V_149 & V_153 ) >> V_154 ;
V_147 = F_71 ( V_2 , V_150 ) ;
if ( ! V_147 )
return;
V_147 -> V_155 = 1 ;
F_40 ( V_2 ,
...
static void F_72 ( struct V_1 * V_2 , unsigned int V_149 )
{
int V_150 = V_149 >> V_151 ;
...
static void F_74 ( struct V_1 * V_2 , unsigned int V_149 )
{
int V_150 = V_149 >> V_151 ;
int V_159 = ( V_149 & V_160 ) >> V_161 ;
if ( ! F_71 ( V_2 , V_150 ) ) {
...
{
int V_166 ;
if ( ! F_76 ( V_2 , V_12 , V_167 ) )
F_21 ( V_2 , V_12 , 0 , V_168 , V_167 ) ;
if ( ! F_76 ( V_2 , V_148 , V_167 ) ) {
F_21 ( V_2 , V_148 , 0 , V_168 ,
V_167 ) ;
F_77 ( 40 ) ;
V_166 = F_19 ( V_2 , V_148 , 0 , V_169 , 0 ) ;
V_166 = ( V_166 & V_170 ) >> V_171 ;
F_40 ( V_2 , L_17 , V_148 , V_166 ) ;
}
}
static int F_78 ( struct V_1 * V_2 , T_1 V_3 ,
bool V_172 )
{
int V_173 , V_174 ;
if ( F_79 ( V_2 , V_3 ) & V_175 ) {
...
static int F_80 ( struct V_1 * V_2 , T_1 V_12 ,
...
if ( F_66 ( V_2 ) )
F_75 ( V_2 , V_12 , V_3 ) ;
V_38 = V_5 -> V_92 . V_182 ( V_2 , V_3 , F_81 ( V_181 ) ) ;
if ( V_38 ) {
F_40 ( V_2 , L_21 ) ;
return V_38 ;
}
F_82 ( V_2 , V_12 , V_180 , 0 , V_181 ) ;
return 0 ;
}
...
V_194 ,
V_187 ) ;
if ( F_66 ( V_2 ) || F_90 ( V_2 ) )
F_86 ( V_2 , V_20 -> V_3 , V_187 ) ;
F_91 ( V_2 , V_6 , V_186 -> V_12 ) ;
...
static int F_95 ( struct V_1 * V_2 , int V_6 )
{
struct V_4 * V_5 = V_2 -> V_5 ;
...
V_20 -> V_189 = F_96 ( V_2 , V_3 ,
V_20 -> V_190 ,
V_214 ) ;
return 0 ;
}
static bool F_68 ( struct V_19 * V_20 , int V_215 )
{
struct V_146 * V_147 ;
struct V_1 * V_2 = V_20 -> V_2 ;
struct V_4 * V_5 = V_2 -> V_5 ;
...
if ( F_99 ( V_2 , & V_22 -> V_89 , V_22 -> V_35 ,
V_22 -> V_29 ) < 0 )
V_22 -> V_28 = false ;
}
if ( V_22 -> V_28 ) {
...
static void F_106 ( struct V_235 * V_228 )
{
struct V_19 * V_20 =
F_107 ( F_108 ( V_228 ) , struct V_19 , V_228 ) ;
if ( V_20 -> V_236 ++ > 6 )
V_20 -> V_236 = 0 ;
...
return 0 ;
V_238 = F_110 ( V_2 , V_3 ) ;
if ( F_111 ( V_238 ) == V_241 )
return 0 ;
if ( F_66 ( V_2 ) )
F_112 ( V_2 , V_3 ) ;
V_6 = V_5 -> V_7 ;
V_20 = F_113 ( & V_5 -> V_242 ) ;
if ( ! V_20 )
return - V_40 ;
V_20 -> V_3 = V_3 ;
V_20 -> V_94 = false ;
...
static int F_114 ( struct V_1 * V_2 , T_1 V_12 )
{
struct V_4 * V_5 = V_2 -> V_5 ;
struct V_185 * V_186 ;
unsigned int V_243 ;
...
T_1 V_148 ;
int V_76 , V_246 ;
V_246 = F_118 ( V_2 , V_2 -> V_247 , & V_148 ) ;
if ( ! V_148 || V_246 < 0 ) {
F_3 ( V_2 , L_25 ) ;
return - V_8 ;
}
...
static bool F_119 ( struct V_1 * V_2 , T_1 V_12 )
{
struct V_250 * V_251 ;
bool V_94 ;
F_10 ( & V_2 -> V_252 ) ;
V_251 = F_120 ( V_2 , V_12 ) ;
...
static int F_126 ( struct V_78 * V_261 ,
int V_81 )
{
if ( V_261 -> V_81 != V_81 )
return - 1 ;
...
static void F_127 ( struct V_78 * V_261 ,
...
static int F_128 ( struct V_15 * V_16 , int V_263 ,
...
if ( F_130 ( V_265 , V_270 , V_268 ) )
return - V_267 ;
V_265 += V_57 ;
}
}
if ( F_129 ( V_27 , V_264 + 1 ) )
return - V_267 ;
return 0 ;
}
...
V_272 = F_133 ( V_16 , & V_31 -> V_41 ) ;
V_202 = F_134 ( V_89 , V_272 ) ;
...
static int F_136 ( struct V_1 * V_2 , int V_6 )
{
char V_293 [ 32 ] = L_27 ;
struct V_4 * V_5 = V_2 -> V_5 ;
struct V_19 * V_20 = F_2 ( V_5 , V_6 ) ;
...
if ( ! F_137 ( V_2 , V_20 -> V_3 ) )
strncat ( V_293 , L_29 ,
sizeof( V_293 ) - strlen ( V_293 ) - 1 ) ;
return F_138 ( V_2 , V_20 -> V_3 , V_293 , 0 ) ;
}
...
break;
V_38 = F_141 ( V_2 -> V_291 [ V_6 ] . V_295 ,
V_287 ,
NULL , 0 , V_6 , & V_144 ) ;
if ( V_38 < 0 )
return V_38 ;
...
F_23 ( V_2 , V_3 ) ;
F_146 ( V_2 , V_3 , V_3 ,
V_2 -> V_301 > 0 ? F_67 : NULL ) ;
}
return 0 ;
}
static void F_147 ( struct V_4 * V_5 , int V_302 )
{
F_148 ( & V_5 -> V_242 , sizeof( struct V_19 ) , V_302 ) ;
F_148 ( & V_5 -> V_244 , sizeof( struct V_185 ) , V_302 ) ;
F_148 ( & V_5 -> V_283 , sizeof( struct V_280 ) , V_302 ) ;
}
...
T_1 V_305 [ 4 ] ;
int V_306 ;
V_306 = F_96 ( V_2 , V_148 , V_305 , F_13 ( V_305 ) ) ;
if ( V_306 == V_5 -> V_14 &&
! memcmp ( V_305 , V_5 -> V_245 , V_5 -> V_14 * sizeof( T_1 ) ) )
return;
F_40 ( V_2 , L_30 , V_148 ) ;
F_158 ( V_2 , V_148 , V_5 -> V_14 , V_5 -> V_245 ) ;
}
...
static void F_162 ( struct V_1 * V_2 , T_1 V_314 ,
unsigned int V_315 )
{
if ( V_315 == V_167 ) {
F_159 ( V_2 , false ) ;
...
F_163 ( V_2 , V_314 , V_315 ) ;
}
static int F_164 ( struct V_1 * V_2 )
{
struct V_4 * V_5 ;
V_5 = F_165 ( sizeof( * V_5 ) , V_316 ) ;
if ( V_5 == NULL )
return - V_40 ;
V_5 -> V_92 = V_317 ;
V_2 -> V_5 = V_5 ;
...
{
struct V_4 * V_5 ;
int V_38 = F_183 ( V_2 , V_341 ,
V_352 ) ;
if ( V_38 < 0 )
return V_38 ;
V_2 -> V_303 . V_304 = F_174 ;
V_5 = V_2 -> V_5 ;
...
V_2 -> V_303 . V_359 = F_188 ;
V_2 -> V_303 . V_360 = F_189 ;
F_184 ( V_2 , 8 ) ;
return 0 ;
}
static int F_191 ( struct V_78 * V_261 ,
int V_81 )
{
if ( V_261 -> V_85 == 0x00 && V_81 == 2 )
return V_361 ;
return F_126 ( V_261 , V_81 ) ;
}
static int F_192 ( int V_84 , int V_57 , unsigned char * V_105 )
{
...
V_5 -> V_92 . V_269 =
F_191 ;
V_5 -> V_92 . V_279 = F_192 ;
return 0 ;
}
static int F_194 ( struct V_1 * V_2 , T_1 V_148 ,
unsigned char * V_86 , int * V_29 )
{
return F_195 ( V_2 , V_148 , V_86 , V_29 ,
F_196 ( V_2 ) ) ;
}
static void F_197 ( struct V_1 * V_2 , T_1 V_3 , int V_84 ,
int V_132 , int V_133 )
{
F_21 ( V_2 , V_3 , 0 , V_364 , V_84 ) ;
}
static int F_198 ( int V_107 )
{
switch ( V_107 ) {
case 2 : return 3 ;
case 3 : return 2 ;
...
static int F_199 ( int V_84 , int V_57 , unsigned char * V_105 )
{
struct V_78 * V_261 ;
int V_76 , V_77 ;
...
int V_367 = 7 - F_198 ( V_77 ) ;
if ( V_261 -> V_83 [ V_367 ] == V_108 ) {
V_365 = true ;
if ( V_76 % 2 == 0 && V_76 + 1 < V_57 ) {
int V_368 = 7 - F_198 ( V_77 + 1 ) ;
int V_369 = F_45 ( V_105 [ V_76 + 1 ] ) ;
...
static int F_200 ( struct V_1 * V_2 , T_1 V_3 ,
int V_99 , int V_371 )
{
int V_372 ;
int V_373 = 0 ;
...
static int F_203 ( struct V_78 * V_261 ,
int V_81 )
{
int V_69 ;
int V_379 = 0 ;
...
static void F_204 ( struct V_78 * V_261 ,
unsigned int * V_144 , int V_81 )
{
int V_27 = 0 ;
int V_69 ;
for ( V_69 = 7 ; V_69 >= 0 ; V_69 -- ) {
int V_338 = 7 - F_198 ( 7 - V_69 ) ;
...
static int F_205 ( struct V_1 * V_2 , T_1 V_3 ,
bool V_172 )
{
int V_382 , V_383 ;
...
static int F_206 ( struct V_1 * V_2 , T_1 V_12 ,
T_1 V_3 , T_3 V_180 , int V_181 )
{
if ( F_196 ( V_2 ) ) {
int V_388 = 180 ;
...
return F_80 ( V_2 , V_12 , V_3 , V_180 , V_181 ) ;
}
...
if ( V_38 )
return V_38 ;
V_2 -> V_303 . V_304 = F_207 ;
V_5 = V_2 -> V_5 ;
V_5 -> V_92 . V_225 = F_194 ;
V_5 -> V_92 . V_93 = F_202 ;
V_5 -> V_92 . V_101 = F_200 ;
V_5 -> V_92 . V_145 = F_197 ;
V_5 -> V_92 . V_182 = F_205 ;
V_5 -> V_92 . V_255 = F_206 ;
if ( ! F_201 ( V_2 ) ) {
V_5 -> V_92 . V_269 =
F_203 ;
V_5 -> V_92 . V_271 = F_204 ;
V_5 -> V_92 . V_279 = F_199 ;
}
for ( V_13 = 0 ; V_13 < V_5 -> V_14 ; V_13 ++ ) {
V_186 = F_7 ( V_5 , V_13 ) ;
