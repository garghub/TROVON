...
F_43 ( & V_73 ) ;
V_71 = F_44 ( V_49 , & V_73 ) ;
V_39 -> V_36 = V_71 ? V_71 -> V_75 : 0 ;
V_39 -> V_42 = V_71 ?
(struct V_8 * ) ( V_76 ) V_71 -> V_77 : NULL ;
while ( ( V_71 = F_44 ( V_49 , & V_73 ) ) ) {
V_69 = F_21 ( V_28 ,
V_14 ) ;
if ( ! V_69 ) {
V_25 = - V_15 ;
...
memcpy ( V_69 , V_39 , sizeof( * V_39 ) ) ;
V_69 -> V_36 = V_71 -> V_75 ;
V_69 -> V_42 = (struct V_8 * )
( V_76 ) V_71 -> V_77 ;
F_45 ( & V_69 -> V_43 , & V_39 -> V_43 ) ;
}
F_46 ( V_49 ) ;
}
V_63:
...
struct V_94 * V_95 = & V_33 -> V_71 . V_94 ;
struct V_1 V_2 ;
struct V_1 V_96 = { 0 } ;
int V_97 ;
int V_25 = 0 ;
...
* V_51 += ( V_71 -> V_107 * V_97 ) ;
switch ( V_71 -> type ) {
case V_108 : {
struct V_109 * V_39 ;
V_39 = F_68 ( V_71 ) ;
V_25 = F_20 ( V_91 , V_39 -> V_45 , & V_96 ,
V_39 -> V_35 + 1 , 0 , V_71 -> V_110 ,
V_71 -> V_107 * V_97 , V_111 ) ;
break;
}
case V_112 : {
struct V_109 * V_39 ;
...
struct V_72 V_73 ;
F_43 ( & V_73 ) ;
while ( ( V_71 = F_44 ( V_138 , & V_73 ) ) ) {
if ( ! V_71 -> V_77 )
continue;
V_9 = (struct V_8 * ) ( V_76 ) V_71 -> V_77 ;
F_8 ( V_9 ) ;
V_71 -> V_77 = 0 ;
}
F_47 ( V_138 ) ;
...
if ( ! V_140 )
F_92 ( & V_57 -> V_144 ) ;
V_25 = F_89 ( V_140 , V_57 , V_110 , V_50 , V_142 ) ;
if ( ! V_140 )
F_93 ( & V_57 -> V_144 ) ;
return V_25 ;
}
...
int F_110 ( struct V_56 * V_57 , T_1 V_167 ,
...
V_2 . V_18 = V_167 ;
V_2 . V_10 = ( T_1 ) - 1 ;
V_25 = F_99 ( NULL , V_57 -> V_137 , & V_2 , V_47 , 0 , 0 ) ;
if ( V_25 < 0 )
return V_25 ;
V_25 = F_112 ( V_57 -> V_137 , V_47 , 0 ) ;
if ( V_25 ) {
if ( V_25 > 0 )
V_25 = - V_74 ;
return V_25 ;
...
struct V_70 * V_178 = NULL ;
struct V_70 * V_179 = NULL ;
struct V_180 V_181 = {} ;
struct V_72 V_182 ;
struct V_72 V_183 ;
F_37 ( L_10 ,
...
V_25 = F_89 ( V_140 , V_57 , V_178 -> V_75 ,
V_181 . V_90 , & V_142 ) ;
if ( V_25 )
break;
F_43 ( & V_183 ) ;
...
if ( ! V_64 ) {
F_119 ( V_57 , & V_181 ) ;
F_120 ( V_140 , V_57 -> V_137 ) ;
} else {
F_93 ( & V_57 -> V_144 ) ;
}
return V_25 ;
}
int F_121 ( T_1 V_167 , struct V_56 * V_57 ,
struct V_46 * V_47 ,
T_7 * V_176 , void * V_177 )
{
int V_25 ;
...
struct V_1 V_118 ;
int V_64 = V_47 -> V_64 ;
V_25 = F_110 ( V_57 , V_167 , V_47 , & V_118 , & V_123 ) ;
F_39 ( V_47 ) ;
if ( V_25 < 0 )
return V_25 ;
if ( V_123 & V_126 )
...
V_196 = ( char * ) V_194 -> V_195 -> V_75 + ( V_197 + 1 ) * V_199 ;
V_195 = F_103 ( V_194 -> V_146 , V_194 -> V_46 , V_156 ,
V_157 , V_4 , V_17 , V_196 , V_162 ) ;
if ( F_31 ( V_195 ) )
return F_33 ( V_195 ) ;
if ( V_195 > V_196 ) {
V_194 -> V_195 -> V_75 [ V_197 ] = ( T_1 ) ( unsigned long ) V_195 ;
++ V_194 -> V_195 -> V_198 ;
