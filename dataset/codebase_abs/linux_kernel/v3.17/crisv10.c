...
int V_29 ;
int V_387 = 0 ;
if ( V_9 -> V_11 . V_36 & V_368 ) {
F_162 ( V_12 , V_9 -> V_11 . V_375 ,
! ( V_9 -> V_11 . V_36 & V_368 ) ) ;
#ifdef F_163
if ( V_9 -> V_11 . V_36 & V_388 )
return - V_389 ;
else
return - V_390 ;
#else
...
if ( ( V_364 -> V_391 & V_392 ) ||
( V_12 -> V_36 & ( 1 << V_254 ) ) ) {
V_9 -> V_11 . V_36 |= V_369 ;
return 0 ;
}
if ( V_12 -> V_13 . V_14 & V_393 ) {
V_387 = 1 ;
}
V_29 = 0 ;
...
int V_29 ;
int V_395 = 0 ;
V_9 = V_195 + V_12 -> V_396 ;
if ( ! V_9 -> V_196 )
return - V_397 ;
#ifdef F_103
F_5 ( L_104 , V_365 -> V_366 , V_12 -> V_398 ,
V_9 -> V_11 . V_92 ) ;
#endif
V_9 -> V_11 . V_92 ++ ;
V_12 -> V_77 = V_9 ;
...
if ( ( V_9 -> V_11 . V_92 == 1 ) && ( V_9 -> V_11 . V_36 & V_403 ) ) {
V_12 -> V_13 = V_9 -> V_370 ;
F_105 ( V_9 ) ;
}
#ifdef F_103
...
static void F_174 ( struct V_405 * V_406 , struct V_8 * V_9 )
{
unsigned long V_305 ;
F_175 ( V_406 , L_111 ,
V_9 -> line , ( unsigned long ) V_9 -> V_40 , V_9 -> V_51 ) ;
if ( ! V_9 -> V_40 || ( V_9 -> type == V_407 ) ) {
F_175 ( V_406 , L_112 ) ;
return;
}
F_175 ( V_406 , L_113 , V_9 -> V_21 ) ;
F_175 ( V_406 , L_114 ,
...
#endif
if ( V_9 -> V_129 . V_221 )
F_175 ( V_406 , L_119 , ( unsigned long ) V_9 -> V_129 . V_221 ) ;
if ( V_9 -> V_129 . V_220 )
F_175 ( V_406 , L_120 , ( unsigned long ) V_9 -> V_129 . V_220 ) ;
if ( V_9 -> V_129 . V_224 )
F_175 ( V_406 , L_121 , ( unsigned long ) V_9 -> V_129 . V_224 ) ;
if ( V_9 -> V_129 . V_215 )
F_175 ( V_406 , L_122 , ( unsigned long ) V_9 -> V_129 . V_215 ) ;
if ( ! F_141 ( V_9 ) )
F_176 ( V_406 , L_123 ) ;
if ( ! F_145 ( V_9 ) )
F_176 ( V_406 , L_124 ) ;
...
static int F_177 ( struct V_405 * V_406 , void * V_408 )
{
int V_187 ;
F_175 ( V_406 , L_129 , V_409 ) ;
for ( V_187 = 0 ; V_187 < V_194 ; V_187 ++ ) {
if ( ! V_195 [ V_187 ] . V_196 )
continue;
F_174 ( V_406 , & V_195 [ V_187 ] ) ;
}
#ifdef F_178
...
F_179 ( V_4 [ V_187 ] . V_6 ) ) ;
F_175 ( V_406 , V_4 [ V_187 ] . string , V_4 [ V_187 ] . V_1 ) ;
}
F_175 ( V_406 , L_131 , V_187 , V_3 ) ;
V_2 = 0 ;
#endif
return 0 ;
}
static int F_180 ( struct V_410 * V_410 , struct V_363 * V_363 )
{
...
int V_187 ;
struct V_8 * V_9 ;
struct V_412 * V_413 = F_184 ( V_194 ) ;
if ( ! V_413 )
return - V_250 ;
F_182 () ;
#if ! F_38 ( V_414 )
...
V_413 -> V_423 = V_424 ;
V_413 -> V_423 . V_14 =
V_425 | V_426 | V_427 | V_257 | V_393 ;
V_413 -> V_423 . V_428 = 115200 ;
V_413 -> V_423 . V_429 = 115200 ;
V_413 -> V_36 = V_430 ;
F_188 ( V_413 , & V_431 ) ;
V_432 = V_413 ;
...
if ( V_9 -> V_196 ) {
F_5 ( V_411 L_141 ,
V_432 -> V_398 , V_9 -> line , V_9 -> V_40 ) ;
}
F_192 ( & V_9 -> V_11 , V_413 , V_187 ) ;
}
if ( F_193 ( V_413 ) )
F_62 ( L_142 ) ;
#ifdef V_134
