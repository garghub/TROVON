...
int F_31 ( struct V_56 * V_14 , unsigned long V_63 ,
unsigned long V_57 )
{
struct V_1 * V_2 = F_23 ( V_14 ) ;
struct V_2 * V_64 = NULL ;
unsigned long V_65 ;
T_3 V_37 = 0 ;
struct V_4 * V_5 ;
int V_11 ;
...
V_6 = F_2 ( V_2 , V_5 -> V_66 ) ;
V_6 &= ~ V_5 -> V_67 ;
V_6 |= V_68 << F_3 ( V_5 -> V_67 ) ;
F_4 ( V_6 , V_2 , V_5 -> V_66 ) ;
}
...
V_6 = F_2 ( V_2 , V_5 -> V_66 ) ;
V_6 &= ~ V_5 -> V_67 ;
V_6 |= V_69 << F_3 ( V_5 -> V_67 ) ;
F_4 ( V_6 , V_2 , V_5 -> V_66 ) ;
}
static struct V_1 * F_40 ( struct V_56 * V_14 )
{
...
unsigned long F_43 ( struct V_56 * V_14 ,
unsigned long V_57 )
{
const struct V_4 * V_5 ;
unsigned long V_63 ;
...
V_5 = V_70 -> V_4 ;
F_28 ( ! V_5 -> V_8 ) ;
V_6 = F_2 ( V_70 , V_5 -> V_7 ) & V_5 -> V_8 ;
V_6 >>= F_3 ( V_5 -> V_8 ) ;
if ( ( V_6 != V_72 ) || ( V_5 -> V_39 & V_73 ) )
V_63 = V_57 ;
else
V_63 = V_57 * 2 ;
return V_63 ;
}
int F_44 ( struct V_56 * V_14 , unsigned long V_63 ,
unsigned long V_57 )
{
return 0 ;
}
long F_45 ( struct V_56 * V_14 , unsigned long V_63 ,
unsigned long * V_74 )
{
const struct V_4 * V_5 ;
T_2 V_6 ;
...
V_5 = V_70 -> V_4 ;
if ( V_5 -> V_39 & V_73 ) {
* V_74 = F_36 ( F_19 ( V_70 -> V_14 . V_2 ) , V_63 ) ;
return * V_74 ;
}
F_28 ( ! V_5 -> V_8 ) ;
V_6 = F_2 ( V_70 , V_5 -> V_7 ) & V_5 -> V_8 ;
...
if ( V_6 != V_72 )
return * V_74 ;
if ( F_42 ( V_14 -> V_2 ) & V_75 ) {
unsigned long V_76 ;
V_76 = ( V_63 / 2 ) ;
* V_74 = F_36 ( F_19 ( V_14 -> V_2 ) ,
V_76 ) ;
}
return * V_74 * 2 ;
}
