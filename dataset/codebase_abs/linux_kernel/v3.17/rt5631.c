...
static int F_38 ( struct V_116 * V_129 ,
unsigned int V_130 )
{
...
static int F_39 ( struct V_116 * V_129 ,
int V_147 , unsigned int V_148 , int V_149 )
{
struct V_1 * V_2 = V_129 -> V_2 ;
struct V_61 * V_62 = F_10 ( V_2 ) ;
F_33 ( V_2 -> V_9 , L_4 , V_120 , V_148 ) ;
if ( ( V_148 >= ( 256 * 8000 ) ) && ( V_148 <= ( 512 * 96000 ) ) ) {
V_62 -> V_123 = V_148 ;
return 0 ;
}
return - V_105 ;
}
static int F_40 ( struct V_116 * V_129 , int V_150 ,
int V_65 , unsigned int V_151 , unsigned int V_152 )
{
struct V_1 * V_2 = V_129 -> V_2 ;
struct V_61 * V_62 = F_10 ( V_2 ) ;
int V_109 , V_153 = - V_105 ;
F_33 ( V_2 -> V_9 , L_1 , V_120 ) ;
if ( ! V_151 || ! V_152 ) {
F_33 ( V_2 -> V_9 , L_5 ) ;
F_21 ( V_2 , V_41 ,
...
if ( V_62 -> V_122 ) {
for ( V_109 = 0 ; V_109 < F_31 ( V_156 ) ; V_109 ++ )
if ( V_151 == V_156 [ V_109 ] . V_157 &&
V_152 == V_156 [ V_109 ] . V_158 ) {
F_41 ( V_2 -> V_9 ,
L_6 ) ;
F_2 ( V_2 , V_42 ,
V_156 [ V_109 ] . V_128 ) ;
...
for ( V_109 = 0 ; V_109 < F_31 ( V_161 ) ; V_109 ++ )
if ( V_151 == V_161 [ V_109 ] . V_157 &&
V_152 == V_161 [ V_109 ] . V_158 ) {
F_41 ( V_2 -> V_9 ,
L_7 ) ;
F_2 ( V_2 , V_42 ,
V_161 [ V_109 ] . V_128 ) ;
...
static int F_49 ( struct V_187 * V_188 ,
const struct V_189 * V_190 )
{
struct V_61 * V_62 ;
int V_153 ;
V_62 = F_50 ( & V_188 -> V_9 , sizeof( struct V_61 ) ,
V_191 ) ;
if ( NULL == V_62 )
return - V_192 ;
F_51 ( V_188 , V_62 ) ;
V_62 -> V_176 = F_52 ( V_188 , & V_193 ) ;
if ( F_53 ( V_62 -> V_176 ) )
return F_54 ( V_62 -> V_176 ) ;
V_153 = F_55 ( & V_188 -> V_9 , & V_194 ,
V_195 , F_31 ( V_195 ) ) ;
return V_153 ;
}
static int F_56 ( struct V_187 * V_196 )
{
F_57 ( & V_196 -> V_9 ) ;
return 0 ;
}
