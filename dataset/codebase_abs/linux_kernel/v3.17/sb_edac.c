...
V_209 -> V_124 >> V_228 , V_209 -> V_124 & ~ V_229 , 0 ,
V_90 , V_65 , - 1 ,
V_212 , V_129 ) ;
return;
V_227:
...
struct V_208 * V_209 ;
F_91 () ;
V_230 = ( V_23 -> V_231 + V_232 - V_23 -> V_233 )
% V_232 ;
if ( ! V_230 )
return;
V_209 = V_23 -> V_234 ;
if ( V_23 -> V_233 + V_230 > V_232 ) {
unsigned V_235 = V_232 - V_23 -> V_233 ;
memcpy ( V_209 , & V_23 -> V_236 [ V_23 -> V_233 ] , sizeof( * V_209 ) * V_235 ) ;
F_92 () ;
V_23 -> V_233 = 0 ;
V_230 -= V_235 ;
V_209 += V_235 ;
}
memcpy ( V_209 , & V_23 -> V_236 [ V_23 -> V_233 ] , sizeof( * V_209 ) * V_230 ) ;
F_92 () ;
V_23 -> V_233 += V_230 ;
F_91 () ;
if ( V_23 -> V_237 ) {
...
for ( V_66 = 0 ; V_66 < V_230 ; V_66 ++ )
F_87 ( V_62 , & V_23 -> V_234 [ V_66 ] ) ;
}
static int F_93 ( struct V_238 * V_239 , unsigned long V_240 ,
void * V_241 )
{
struct V_208 * V_208 = (struct V_208 * ) V_241 ;
struct V_61 * V_62 ;
struct V_22 * V_23 ;
char * type ;
if ( F_94 () == V_242 )
return V_243 ;
V_62 = F_68 ( V_208 -> V_244 ) ;
if ( ! V_62 )
return V_245 ;
V_23 = V_62 -> V_63 ;
if ( ( V_208 -> V_216 & 0xefff ) >> 7 != 1 )
return V_243 ;
if ( V_208 -> V_214 & V_246 )
type = L_81 ;
else
type = L_82 ;
F_95 ( V_62 , V_160 , L_83 ) ;
F_95 ( V_62 , V_160 , L_84
L_85 , V_208 -> V_247 , type ,
V_208 -> V_214 , V_208 -> V_248 , V_208 -> V_216 ) ;
F_95 ( V_62 , V_160 , L_86 , V_208 -> V_249 ) ;
F_95 ( V_62 , V_160 , L_87 , V_208 -> V_124 ) ;
F_95 ( V_62 , V_160 , L_88 , V_208 -> V_250 ) ;
F_95 ( V_62 , V_160 , L_89
L_90 , V_208 -> V_251 , V_208 -> V_252 ,
V_208 -> time , V_208 -> V_244 , V_208 -> V_253 ) ;
F_91 () ;
if ( ( V_23 -> V_231 + 1 ) % V_232 == V_23 -> V_233 ) {
F_92 () ;
V_23 -> V_237 ++ ;
return V_243 ;
}
memcpy ( & V_23 -> V_236 [ V_23 -> V_231 ] , V_208 , sizeof( * V_208 ) ) ;
F_92 () ;
V_23 -> V_231 = ( V_23 -> V_231 + 1 ) % V_232 ;
if ( V_208 -> V_214 & 1 )
F_90 ( V_62 ) ;
return V_254 ;
}
...
F_7 ( 0 , L_91 , & V_14 -> V_18 [ 0 ] -> V_255 ) ;
F_40 ( V_59 , L_92 ) ;
return;
}
V_23 = V_62 -> V_63 ;
F_7 ( 0 , L_93 ,
V_62 , & V_14 -> V_18 [ 0 ] -> V_255 ) ;
F_97 ( V_62 -> V_18 ) ;
F_7 ( 1 , L_94 , V_62 -> V_256 ) ;
F_16 ( V_62 -> V_256 ) ;
F_98 ( V_62 ) ;
V_14 -> V_62 = NULL ;
}
...
V_62 -> V_267 = L_95 ;
V_62 -> V_268 = V_269 ;
V_62 -> V_270 = F_101 ( V_18 ) ;
V_62 -> V_271 = NULL ;
V_62 -> V_272 = F_90 ;
V_23 -> V_31 . type = type ;
switch ( type ) {
case V_55 :
V_23 -> V_31 . V_32 = V_273 ;
V_23 -> V_31 . V_110 = F_25 ;
V_23 -> V_31 . V_112 = F_26 ;
V_23 -> V_31 . V_115 = V_274 ;
V_23 -> V_31 . F_28 = F_28 ;
V_23 -> V_31 . F_30 = F_30 ;
V_23 -> V_31 . F_27 = F_27 ;
V_23 -> V_31 . V_113 = F_47 ( V_274 ) ;
V_23 -> V_31 . V_116 = V_275 ;
V_23 -> V_31 . V_140 = F_47 ( V_275 ) ;
V_23 -> V_31 . V_2 = V_276 ;
V_62 -> V_256 = F_102 ( V_17 , L_96 , V_62 -> V_277 ) ;
V_46 = F_84 ( V_62 , V_14 ) ;
if ( F_79 ( V_46 < 0 ) )
goto V_278;
break;
case V_147 :
V_23 -> V_31 . V_32 = V_279 ;
V_23 -> V_31 . V_110 = F_20 ;
V_23 -> V_31 . V_112 = F_23 ;
V_23 -> V_31 . V_115 = V_280 ;
V_23 -> V_31 . F_28 = F_28 ;
V_23 -> V_31 . F_30 = F_30 ;
V_23 -> V_31 . F_27 = F_27 ;
V_23 -> V_31 . V_113 = F_47 ( V_280 ) ;
V_23 -> V_31 . V_116 = V_281 ;
V_23 -> V_31 . V_140 = F_47 ( V_281 ) ;
V_23 -> V_31 . V_2 = V_282 ;
V_62 -> V_256 = F_102 ( V_17 , L_97 , V_62 -> V_277 ) ;
V_46 = F_83 ( V_62 , V_14 ) ;
if ( F_79 ( V_46 < 0 ) )
goto V_278;
break;
...
V_23 -> V_31 . V_140 = F_47 ( V_275 ) ;
V_23 -> V_31 . V_2 = V_276 ;
V_62 -> V_256 = F_102 ( V_17 , L_98 , V_62 -> V_277 ) ;
V_46 = F_86 ( V_62 , V_14 ) ;
if ( F_79 ( V_46 < 0 ) )
goto V_278;
break;
...
static int F_104 ( struct V_50 * V_18 , const struct V_283 * V_51 )
{
int V_46 = - V_60 ;
T_2 V_76 , V_155 = 0 ;
struct V_14 * V_14 ;
