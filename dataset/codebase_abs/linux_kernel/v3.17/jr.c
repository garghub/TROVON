...
F_31 ( F_29 ( V_47 , V_48 + V_46 , V_24 ) <= 0 ) ;
F_32 ( V_2 , V_4 -> V_27 [ V_44 ] . V_49 ,
V_4 -> V_28 [ V_45 ] . V_59 ,
V_60 ) ;
...
int V_46 , error ;
V_4 = F_2 ( V_2 ) ;
F_49 ( & V_4 -> V_20 , F_26 , ( unsigned long ) V_2 ) ;
error = F_50 ( V_4 -> V_21 , F_21 , V_82 ,
F_51 ( V_2 ) , V_2 ) ;
if ( error ) {
F_7 ( V_2 , L_7 ,
V_4 -> V_15 , V_4 -> V_21 ) ;
...
if ( error )
return error ;
V_4 -> V_25 = F_52 ( V_2 , sizeof( T_1 ) * V_24 ,
& V_17 , V_84 ) ;
V_4 -> V_27 = F_52 ( V_2 , sizeof( struct V_26 ) *
V_24 , & V_18 , V_84 ) ;
V_4 -> V_28 = F_53 ( sizeof( struct V_74 ) * V_24 ,
V_84 ) ;
...
V_4 -> V_47 = 0 ;
V_4 -> V_48 = 0 ;
F_54 ( & V_4 -> V_6 -> V_22 , V_17 ) ;
F_54 ( & V_4 -> V_6 -> V_23 , V_18 ) ;
...
int error ;
V_31 = & V_30 -> V_2 ;
V_32 = F_57 ( V_31 , sizeof( struct V_3 ) ,
V_84 ) ;
if ( ! V_32 )
return - V_85 ;
F_58 ( V_31 , V_32 ) ;
...
F_61 ( V_31 , F_62 ( 32 ) ) ;
V_32 -> V_21 = F_63 ( V_95 , 0 ) ;
error = F_48 ( V_31 ) ;
if ( error )
return error ;
V_32 -> V_2 = V_31 ;
F_17 ( & V_35 . V_36 ) ;
F_64 ( & V_32 -> V_37 , & V_35 . V_70 ) ;
F_19 ( & V_35 . V_36 ) ;
F_65 ( & V_32 -> V_33 , 0 ) ;
return 0 ;
}
