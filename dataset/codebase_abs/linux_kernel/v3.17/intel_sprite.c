...
if ( V_58 )
F_20 ( V_6 , V_8 ) ;
F_32 ( V_38 , V_7 , 0 , 0 , 0 , false , false ) ;
}
static int
...
F_20 ( V_6 , V_8 ) ;
F_62 ( V_10 , V_14 ) ;
F_32 ( V_34 , V_7 , 0 , 0 , 0 , false , false ) ;
}
static int
...
static void F_115 ( struct V_37 * V_34 )
{
struct V_52 * V_52 = F_27 ( V_34 ) ;
F_114 ( V_34 ) ;
F_116 ( V_34 ) ;
...
int F_118 ( struct V_9 * V_10 , void * V_172 ,
struct V_173 * V_174 )
{
...
return - V_93 ;
F_120 ( V_10 ) ;
V_34 = F_121 ( V_10 , V_175 -> V_178 ) ;
if ( ! V_34 ) {
V_117 = - V_179 ;
goto V_180;
}
V_52 = F_27 ( V_34 ) ;
V_117 = V_52 -> V_181 ( V_34 , V_175 ) ;
V_180:
F_122 ( V_10 ) ;
return V_117 ;
}
int F_123 ( struct V_9 * V_10 , void * V_172 ,
struct V_173 * V_174 )
{
struct V_90 * V_182 = V_172 ;
struct V_37 * V_34 ;
struct V_52 * V_52 ;
int V_117 = 0 ;
if ( ! F_119 ( V_10 , V_176 ) )
return - V_177 ;
F_120 ( V_10 ) ;
V_34 = F_121 ( V_10 , V_182 -> V_178 ) ;
if ( ! V_34 ) {
V_117 = - V_179 ;
goto V_180;
}
V_52 = F_27 ( V_34 ) ;
V_52 -> V_142 ( V_34 , V_182 ) ;
V_180:
F_122 ( V_10 ) ;
return V_117 ;
}
void F_124 ( struct V_37 * V_34 )
{
struct V_52 * V_52 = F_27 ( V_34 ) ;
...
int
F_126 ( struct V_9 * V_10 , enum V_14 V_14 , int V_34 )
{
struct V_52 * V_52 ;
unsigned long V_183 ;
const T_1 * V_184 ;
int V_185 ;
int V_117 ;
if ( F_127 ( V_10 ) -> V_186 < 5 )
return - V_177 ;
V_52 = F_128 ( sizeof( * V_52 ) , V_187 ) ;
if ( ! V_52 )
return - V_188 ;
switch ( F_127 ( V_10 ) -> V_186 ) {
case 5 :
case 6 :
V_52 -> V_116 = true ;
V_52 -> V_167 = 16 ;
...
V_52 -> V_34 = V_34 ;
V_183 = ( 1 << V_14 ) ;
V_117 = F_132 ( V_10 , & V_52 -> V_11 , V_183 ,
& V_192 ,
V_184 , V_185 ,
false ) ;
if ( V_117 )
