...
int V_24 ;
F_29 ( & V_34 -> V_60 ) ;
V_24 = F_48 ( V_21 , false , true , false , NULL ) ;
F_29 ( & V_7 -> V_99 ) ;
...
static int F_54 ( struct V_6 * V_7 , bool V_106 )
{
...
V_109 = F_55 ( & V_107 -> V_45 ,
struct V_20 , V_45 ) ;
F_21 ( & V_109 -> V_38 ) ;
}
V_24 = F_48 ( V_107 , false , true , false , NULL ) ;
if ( V_106 && V_24 ) {
F_30 ( & V_34 -> V_60 ) ;
...
{
return F_63 ( & V_7 -> V_103 ) ;
}
void F_64 ( struct V_6 * V_7 , int V_117 )
{
if ( V_117 )
F_51 ( & V_7 -> V_103 ,
( ( V_104 / 100 ) < 1 ) ? 1 : V_104 / 100 ) ;
}
static int F_65 ( struct V_20 * V_21 , bool V_79 ,
bool V_80 )
{
struct V_6 * V_7 = V_21 -> V_7 ;
struct V_77 V_118 ;
...
V_24 = F_66 ( V_21 , & V_23 , & V_118 , V_79 ,
V_80 ) ;
if ( V_24 ) {
if ( V_24 != - V_119 ) {
F_3 ( L_14 ,
...
int V_24 ;
do {
V_24 = (* V_9 -> V_17 -> V_129 )( V_9 , V_21 , V_23 , 0 , V_25 ) ;
if ( F_33 ( V_24 != 0 ) )
return V_24 ;
if ( V_25 -> V_43 )
break;
...
static T_1 F_71 ( struct V_8 * V_9 ,
T_1 V_97 ,
T_1 V_130 )
{
...
if ( ! V_140 )
continue;
V_137 = F_71 ( V_9 , V_21 -> V_25 . V_23 ,
V_137 ) ;
F_73 ( & V_137 , V_23 -> V_23 [ V_3 ] ,
~ V_142 ) ;
if ( V_2 == V_16 )
break;
if ( V_9 -> V_10 && V_9 -> V_11 ) {
V_139 = true ;
V_24 = (* V_9 -> V_17 -> V_129 )( V_9 , V_21 , V_23 ,
V_137 , V_25 ) ;
if ( F_33 ( V_24 ) )
return V_24 ;
}
...
static bool F_75 ( struct V_22 * V_23 ,
struct V_77 * V_25 ,
T_1 * V_145 )
{
int V_3 ;
...
return - V_5 ;
if ( ! F_75 ( V_23 , & V_21 -> V_25 , & V_145 ) ) {
V_24 = F_74 ( V_21 , V_23 , V_79 ,
V_80 ) ;
if ( V_24 )
return V_24 ;
} else {
F_73 ( & V_21 -> V_25 . V_23 , V_145 ,
~ V_142 ) ;
}
...
bool V_151 ;
V_24 = F_79 ( V_51 , V_39 , false , false ) ;
if ( V_24 ) {
F_3 ( L_16 ) ;
if ( V_50 )
(* V_50)( V_21 ) ;
...
( V_21 -> type == V_66 ||
V_21 -> type == V_74 ) )
V_24 = F_88 ( & V_7 -> V_114 , & V_21 -> V_115 ,
V_21 -> V_25 . V_26 ) ;
V_151 = F_89 ( & V_21 -> V_47 -> V_52 ) ;
F_53 ( ! V_151 ) ;
if ( F_87 ( ! V_24 ) )
V_24 = F_76 ( V_21 , V_23 , V_79 , false ) ;
F_69 ( V_21 ) ;
if ( F_33 ( V_24 ) )
F_61 ( & V_21 ) ;
return V_24 ;
...
unsigned V_156 )
{
unsigned V_157 = ( F_91 ( V_155 ) ) >> V_71 ;
T_3 V_13 = 0 ;
V_13 += F_92 ( V_156 ) ;
V_13 += F_91 ( V_157 * sizeof( void * ) ) ;
V_13 += F_92 ( sizeof( struct V_158 ) ) ;
return V_13 ;
}
T_3 F_93 ( struct V_6 * V_7 ,
unsigned long V_155 ,
unsigned V_156 )
{
unsigned V_157 = ( F_91 ( V_155 ) ) >> V_71 ;
...
V_13 += F_92 ( V_156 ) ;
V_13 += F_91 ( V_157 * sizeof( void * ) ) ;
V_13 += F_91 ( V_157 * sizeof( V_159 ) ) ;
V_13 += F_92 ( sizeof( struct V_160 ) ) ;
return V_13 ;
}
...
T_3 V_39 ;
int V_24 ;
V_21 = F_95 ( sizeof( * V_21 ) , V_161 ) ;
if ( F_33 ( V_21 == NULL ) )
return - V_73 ;
V_39 = F_90 ( V_7 , V_13 , sizeof( struct V_20 ) ) ;
V_24 = F_78 ( V_7 , V_21 , V_13 , type , V_23 , V_144 ,
V_79 , V_148 , V_39 ,
NULL , NULL ) ;
if ( F_87 ( V_24 == 0 ) )
* V_116 = V_21 ;
...
V_24 = F_110 ( V_34 -> V_51 , & V_34 -> V_171 ) ;
if ( F_33 ( V_24 != 0 ) ) {
F_3 ( L_23 ) ;
goto V_183;
}
...
V_24 = F_99 ( V_7 , V_16 , 0 ) ;
if ( F_33 ( V_24 != 0 ) )
goto V_188;
F_120 ( & V_7 -> V_114 , V_187 ,
0x10000000 ) ;
F_121 ( & V_7 -> V_103 , F_57 ) ;
F_82 ( & V_7 -> V_45 ) ;
V_7 -> V_189 = V_186 ;
V_7 -> V_34 = V_34 ;
V_7 -> V_64 = V_64 ;
...
bool V_192 , bool V_79 , bool V_193 )
{
struct V_98 * V_69 = V_21 -> V_7 -> V_69 ;
struct V_6 * V_7 = V_21 -> V_7 ;
void * V_42 ;
int V_24 = 0 ;
if ( F_87 ( V_21 -> V_42 == NULL ) )
return 0 ;
while ( V_21 -> V_42 ) {
if ( V_69 -> V_194 ( V_21 -> V_42 ) ) {
void * V_195 = V_21 -> V_42 ;
V_21 -> V_42 = NULL ;
F_124 ( V_196 , & V_21 -> V_153 ) ;
F_30 ( & V_7 -> V_99 ) ;
V_69 -> V_102 ( & V_195 ) ;
F_29 ( & V_7 -> V_99 ) ;
continue;
...
int F_125 ( struct V_20 * V_21 , bool V_193 )
{
struct V_6 * V_7 = V_21 -> V_7 ;
int V_24 = 0 ;
V_24 = F_126 ( V_21 , true , V_193 , false , NULL ) ;
if ( F_33 ( V_24 != 0 ) )
return V_24 ;
F_29 ( & V_7 -> V_99 ) ;
V_24 = F_49 ( V_21 , false , true , V_193 ) ;
F_30 ( & V_7 -> V_99 ) ;
if ( F_87 ( V_24 == 0 ) )
F_85 ( & V_21 -> V_41 ) ;
F_69 ( V_21 ) ;
...
static int V_182 ( struct V_197 * V_171 )
{
struct V_33 * V_34 =
...
int V_24 = - V_127 ;
int V_57 ;
T_1 V_198 = ( V_133 | V_154 ) ;
F_29 ( & V_34 -> V_60 ) ;
F_68 (bo, &glob->swap_lru, swap) {
V_24 = F_48 ( V_21 , false , true , false , NULL ) ;
if ( ! V_24 )
break;
}
...
F_123 ( V_21 ) ;
if ( V_21 -> V_7 -> V_69 -> V_199 )
V_21 -> V_7 -> V_69 -> V_199 ( V_21 ) ;
V_24 = F_128 ( V_21 -> V_46 , V_21 -> V_148 ) ;
V_111:
F_50 ( V_21 ) ;
F_56 ( & V_21 -> V_38 , F_9 ) ;
return V_24 ;
...
{
int V_24 ;
V_24 = F_131 ( & V_21 -> V_49 ) ;
if ( F_33 ( V_24 != 0 ) )
return - V_119 ;
if ( ! F_132 ( & V_21 -> V_47 -> V_52 ) )
goto V_108;
