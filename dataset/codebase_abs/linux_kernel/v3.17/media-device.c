...
F_34 ( & V_19 -> V_65 ) ;
V_19 -> V_61 . V_81 = & V_82 ;
V_19 -> V_61 . V_83 = V_19 -> V_4 ;
V_19 -> V_61 . V_84 = F_29 ;
V_57 = F_35 ( & V_19 -> V_61 , V_78 ) ;
if ( V_57 < 0 )
return V_57 ;
V_57 = F_36 ( & V_19 -> V_61 . V_4 , & V_85 ) ;
if ( V_57 < 0 ) {
F_37 ( & V_19 -> V_61 ) ;
return V_57 ;
}
...
V_19 -> V_79 = F_43 ( V_21 -> V_20 + 1 , V_19 -> V_79 ) ;
F_44 ( & V_21 -> V_86 , & V_19 -> V_80 ) ;
F_9 ( & V_19 -> V_24 ) ;
return 0 ;
}
void F_40 ( struct V_18 * V_21 )
{
struct V_3 * V_19 = V_21 -> V_83 ;
if ( V_19 == NULL )
return;
F_7 ( & V_19 -> V_24 ) ;
F_45 ( & V_21 -> V_86 ) ;
