...
struct V_126 * V_127 , struct V_128 * * V_129 ,
T_1 V_3 )
{
struct V_130 * V_131 ;
struct V_132 V_133 ;
...
V_21 = & V_26 ;
V_133 . V_21 = V_21 ;
memcpy ( & V_133 . V_134 , V_127 , sizeof( * V_127 ) ) ;
V_133 . V_135 = V_136 ;
V_133 . V_21 = & V_26 ;
V_133 . V_82 = 0 ;
V_133 . V_137 = V_30 ;
V_133 . V_138 = 0 ;
V_133 . V_139 = V_30 ;
V_32 = F_62 ( F_63 ( V_12 -> V_140 ) , & V_133 ,
V_12 -> V_141 ) ;
F_5 ( L_24 , V_8 , V_32 ) ;
if ( V_32 )
goto V_142;
V_99 = F_15 ( V_26 ) ;
V_131 = F_2 ( sizeof( * V_131 ) , V_3 ) ;
if ( ! V_131 ) {
V_32 = - V_16 ;
goto V_142;
}
F_64 ( & V_131 -> V_143 , V_99 ) ;
V_131 -> V_26 = V_26 ;
* V_129 = & V_131 -> V_143 ;
return 0 ;
V_142:
...
F_5 ( L_29 , V_8 , V_145 -> V_151 ) ;
F_5 ( L_30 , V_8 , V_145 -> V_152 ) ;
F_5 ( L_31 , V_8 , V_145 -> V_153 ) ;
V_147 [ 0 ] = ( char * ) V_149 ;
V_147 [ 1 ] = L_32 ;
V_147 [ 2 ] = V_145 -> V_151 ;
V_147 [ 3 ] = L_33 ;
...
V_147 [ 6 ] = V_145 -> V_153 ;
V_147 [ 7 ] = NULL ;
V_148 = F_67 ( V_147 [ 0 ] , V_147 , V_146 , V_154 ) ;
if ( V_148 == - V_155 || V_148 == - V_150 ) {
F_56 ( V_121 L_35
L_36 ,
V_149 ) ;
V_149 [ 0 ] = '\0' ;
}
F_5 ( L_37 , V_8 , V_149 , V_148 ) ;
return V_148 ;
}
static void F_68 ( struct V_156 V_157 ,
char * V_158 , int V_159 ,
const char * V_160 )
{
if ( ! V_157 . V_24 )
return;
...
F_69 (
L_38 ,
V_160 , V_157 . V_24 , V_159 ) ;
V_157 . V_24 = V_159 - 1 ;
}
memcpy ( V_158 , V_157 . V_161 , V_157 . V_24 ) ;
}
...
V_164 = V_162 ;
for ( V_120 = 0 ; V_120 < V_157 . V_24 ; V_120 ++ )
V_164 = F_71 ( V_164 , V_157 . V_161 [ V_120 ] ) ;
}
int F_72 ( struct V_128 * V_129 )
{
int V_166 ;
struct V_144 V_145 ;
if ( ! V_129 -> V_167 . V_168 . V_169 . V_24 )
return - V_170 ;
memset ( & V_145 , 0 , sizeof( V_145 ) ) ;
F_68 (
V_129 -> V_167 . V_168 . V_169 ,
V_145 . V_151 , sizeof( V_145 . V_151 ) , L_40 ) ;
F_68 (
V_129 -> V_171 ,
V_145 . V_152 , sizeof( V_145 . V_152 ) , L_41 ) ;
F_70 ( V_129 -> V_172 , V_145 . V_153 ) ;
V_166 = F_66 ( & V_145 ) ;
if ( V_166 > 0 )
V_166 = - V_170 ;
return V_166 ;
