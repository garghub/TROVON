...
return F_15 ( V_2 , V_48 , V_174 , V_142 ,
V_142 , V_15 -> V_173 ) ;
}
...
V_156 ;
V_2 -> V_15 -> V_256 |= V_149 | V_153 |
V_156 ;
* V_147 = V_158 | V_159 | V_160 |
V_161 | V_162 ;
F_15 ( V_2 , V_48 , V_157 , 1 , 1 , V_147 ) ;
* V_147 = V_257 | V_151 | V_152 |
V_154 | V_155 ;
F_15 ( V_2 , V_48 , V_150 , 1 , 1 , V_147 ) ;
* V_39 = V_62 | V_63 | V_64 |
V_65 | V_66 | V_67 ;
...
static void
F_79 ( struct V_264 * V_265 , T_3 * V_266 )
{
V_265 -> V_267 = V_268 ;
if ( ( * V_266 & V_269 ) ||
( * V_266 & V_270 ) )
...
static int F_80 ( struct V_1 * V_2 , struct V_264 * V_265 )
{
struct V_264 * V_275 ;
int V_276 ;
T_3 V_277 ;
T_2 V_278 ;
T_3 * V_266 ;
if ( V_265 -> V_86 < V_2 -> V_15 -> V_166 )
return 0 ;
F_81 ( V_265 , V_265 -> V_86 - 4 ) ;
memcpy ( & V_277 , F_82 ( V_265 ) , 4 ) ;
F_12 ( & V_277 ) ;
V_276 = ( T_2 ) V_277 ;
V_278 = ( T_2 ) ( V_277 >> 16 ) ;
V_266 = ( T_3 * ) ( V_265 -> V_7 + V_278 ) ;
while ( V_276 -- ) {
T_2 V_279 ;
F_12 ( V_266 ) ;
V_279 = ( * V_266 >> 16 ) & 0x1fff ;
if ( ( * V_266 & V_280 ) ||
( * V_266 & V_281 ) ) {
F_83 ( V_265 , ( V_279 + 7 ) & 0xFFF8 ) ;
V_266 ++ ;
continue;
}
if ( V_276 == 0 ) {
...
V_265 -> V_86 = V_279 ;
F_84 ( V_265 , V_279 ) ;
V_265 -> V_282 = V_279 + sizeof( struct V_264 ) ;
F_79 ( V_265 , V_266 ) ;
return 1 ;
}
V_275 = F_85 ( V_265 , V_283 ) ;
if ( V_275 ) {
V_275 -> V_86 = V_279 ;
V_275 -> V_7 = V_265 -> V_7 + 2 ;
F_84 ( V_275 , V_279 ) ;
V_275 -> V_282 = V_279 + sizeof( struct V_264 ) ;
F_79 ( V_275 , V_266 ) ;
F_86 ( V_2 , V_275 ) ;
} else {
return 0 ;
...
static struct V_264 *
F_87 ( struct V_1 * V_2 , struct V_264 * V_265 , T_6 V_133 )
{
T_3 V_284 , V_285 ;
int V_286 = V_2 -> V_287 ;
int V_288 = F_88 ( V_265 ) -> V_289 ;
int V_290 ;
V_284 = V_265 -> V_86 ;
V_285 = V_288 ;
if ( ( ( V_265 -> V_86 + 8 ) % V_286 ) == 0 )
V_285 |= 0x80008000 ;
V_290 = F_89 ( V_265 ) - 8 ;
if ( ( F_90 ( V_265 ) || V_290 < 0 ) &&
F_91 ( V_265 , V_290 < 0 ? 8 : 0 , 0 , V_283 ) ) {
F_92 ( V_265 ) ;
return NULL ;
}
F_93 ( V_265 , 4 ) ;
...
struct V_105 * V_238 = (struct V_105 * ) V_2 -> V_7 ;
T_1 V_147 [ 5 ] , V_291 ;
T_2 V_292 , V_39 , V_176 = V_177 / 10 ;
T_3 V_293 = 0x40000000 ;
unsigned long V_178 ;
V_178 = V_182 + V_176 ;
while ( V_293 & 0x40000000 ) {
V_292 = 0 ;
F_15 ( V_2 , V_48 , V_56 , 2 , 2 , & V_292 ) ;
F_15 ( V_2 , V_48 , V_56 , 2 , 2 ,
& V_238 -> V_132 ) ;
F_14 ( V_2 , 0x81 , 0x8c , 0 , 4 , & V_293 ) ;
if ( F_72 ( V_182 , V_178 ) )
return 0 ;
}
V_292 = V_50 | V_260 |
