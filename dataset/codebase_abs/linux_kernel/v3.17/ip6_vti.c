...
sprintf ( V_33 , L_1 ) ;
V_17 = F_26 ( sizeof( * V_10 ) , V_33 , V_37 , V_38 ) ;
if ( V_17 == NULL )
goto V_39;
F_27 ( V_17 , V_7 ) ;
V_10 = F_19 ( V_17 ) ;
...
{
struct V_6 * V_10 ;
const struct V_45 * V_46 = F_33 ( V_44 ) ;
F_34 () ;
...
if ( ! F_36 ( NULL , V_52 , V_44 ) ) {
F_35 () ;
return 0 ;
}
if ( ! F_37 ( V_10 , & V_46 -> V_48 , & V_46 -> V_47 ) ) {
V_10 -> V_17 -> V_53 . V_54 ++ ;
F_35 () ;
goto V_51;
}
F_38 ( V_44 ) -> V_55 . V_56 = V_10 ;
V_44 -> V_57 = F_39 ( V_10 -> V_14 . V_58 ) ;
F_35 () ;
return F_40 ( V_44 ) ;
}
F_35 () ;
...
static int F_42 ( struct V_43 * V_44 , int V_31 )
{
unsigned short V_60 ;
struct V_29 * V_17 ;
struct V_61 * V_30 ;
struct V_62 * V_63 ;
struct V_6 * V_10 = F_38 ( V_44 ) -> V_55 . V_56 ;
if ( ! V_10 )
return 1 ;
V_17 = V_10 -> V_17 ;
if ( V_31 ) {
...
if ( ! F_44 ( NULL , V_52 , V_44 , V_60 ) )
return - V_67 ;
F_45 ( V_44 , ! F_46 ( V_10 -> V_7 , F_20 ( V_44 -> V_17 ) ) ) ;
V_44 -> V_17 = V_17 ;
V_30 = F_47 ( V_17 -> V_30 ) ;
F_48 ( & V_30 -> V_68 ) ;
V_30 -> V_69 ++ ;
...
static inline bool
F_50 ( const struct V_6 * V_10 , const struct V_45 * V_72 )
{
return F_7 ( & V_10 -> V_14 . V_16 , & V_72 -> V_47 ) ;
}
static bool F_51 ( const struct V_62 * V_63 ,
...
return false ;
if ( F_10 ( V_73 ) )
return F_52 ( V_47 , & V_63 -> V_75 . V_47 , V_78 ) ;
if ( ! F_53 ( V_63 , V_48 , V_47 , V_78 ) )
return false ;
return true ;
}
static int
F_54 ( struct V_43 * V_44 , struct V_29 * V_17 , struct V_79 * V_80 )
{
struct V_6 * V_10 = F_19 ( V_17 ) ;
struct V_81 * V_53 = & V_10 -> V_17 -> V_53 ;
struct V_82 * V_73 = F_55 ( V_44 ) ;
struct V_29 * V_83 ;
int V_31 = - 1 ;
if ( ! V_73 )
goto V_84;
F_56 ( V_73 ) ;
V_73 = F_57 ( V_10 -> V_7 , V_73 , V_80 , NULL , 0 ) ;
if ( F_58 ( V_73 ) ) {
V_31 = F_59 ( V_73 ) ;
V_73 = NULL ;
goto V_84;
}
if ( ! F_51 ( V_73 -> V_85 , & V_10 -> V_14 . V_16 , & V_10 -> V_14 . V_15 ) )
goto V_84;
V_83 = V_73 -> V_17 ;
if ( V_83 == V_17 ) {
V_53 -> V_86 ++ ;
...
F_45 ( V_44 , ! F_46 ( V_10 -> V_7 , F_20 ( V_17 ) ) ) ;
F_61 ( V_44 , V_73 ) ;
V_44 -> V_17 = F_55 ( V_44 ) -> V_17 ;
V_31 = F_62 ( V_44 ) ;
if ( F_63 ( V_31 ) == 0 ) {
struct V_61 * V_30 = F_47 ( V_17 -> V_30 ) ;
F_48 ( & V_30 -> V_68 ) ;
V_30 -> V_88 += V_44 -> V_71 ;
V_30 -> V_89 ++ ;
F_49 ( & V_30 -> V_68 ) ;
...
static T_4
F_66 ( struct V_43 * V_44 , struct V_29 * V_17 )
{
struct V_6 * V_10 = F_19 ( V_17 ) ;
struct V_81 * V_53 = & V_10 -> V_17 -> V_53 ;
struct V_45 * V_46 ;
...
V_44 -> V_57 = F_39 ( V_10 -> V_14 . V_94 ) ;
switch ( V_44 -> V_95 ) {
case F_67 ( V_96 ) :
V_46 = F_33 ( V_44 ) ;
if ( ( V_10 -> V_14 . V_49 != V_50 && V_10 -> V_14 . V_49 != 0 ) ||
! F_68 ( V_10 ) || F_50 ( V_10 , V_46 ) )
goto V_97;
F_69 ( V_44 , & V_80 , V_78 ) ;
...
case F_67 ( V_98 ) :
F_69 ( V_44 , & V_80 , V_99 ) ;
memset ( F_71 ( V_44 ) , 0 , sizeof( * F_71 ( V_44 ) ) ) ;
break;
default:
goto V_97;
}
V_93 = F_54 ( V_44 , V_17 , & V_80 ) ;
if ( V_93 < 0 )
goto V_97;
return V_100 ;
V_97:
...
static int F_72 ( struct V_43 * V_44 , struct V_102 * V_103 ,
...
type != V_122 )
return 0 ;
V_63 = F_75 ( V_7 , V_57 , ( const T_3 * ) & V_114 -> V_48 ,
V_107 , V_95 , V_78 ) ;
if ( ! V_63 )
return 0 ;
if ( type == V_122 )
F_76 ( V_44 , V_7 , V_44 -> V_17 -> V_123 , 0 ) ;
else
F_77 ( V_44 , V_7 , V_106 , 0 , 0 ) ;
F_78 ( V_63 ) ;
return 0 ;
}
...
static void
F_86 ( struct V_21 * V_22 , const struct V_132 * V_133 )
{
...
static void
F_87 ( struct V_132 * V_133 , const struct V_21 * V_22 )
{
...
static int
F_88 ( struct V_29 * V_17 , struct V_134 * V_135 , int V_136 )
{
int V_31 = 0 ;
struct V_132 V_22 ;
struct V_21 V_137 ;
...
case V_138 :
if ( V_17 == V_12 -> V_42 ) {
if ( F_89 ( & V_22 , V_135 -> V_139 . V_140 , sizeof( V_22 ) ) ) {
V_31 = - V_141 ;
break;
}
F_86 ( & V_137 , & V_22 ) ;
V_10 = F_28 ( V_7 , & V_137 , 0 ) ;
} else {
...
V_10 = F_19 ( V_17 ) ;
F_87 ( & V_22 , & V_10 -> V_14 ) ;
if ( F_90 ( V_135 -> V_139 . V_140 , & V_22 , sizeof( V_22 ) ) )
V_31 = - V_141 ;
break;
case V_142 :
case V_143 :
V_31 = - V_67 ;
if ( ! F_91 ( V_7 -> V_144 , V_145 ) )
break;
V_31 = - V_141 ;
if ( F_89 ( & V_22 , V_135 -> V_139 . V_140 , sizeof( V_22 ) ) )
break;
...
break;
F_86 ( & V_137 , & V_22 ) ;
V_10 = F_28 ( V_7 , & V_137 , V_136 == V_142 ) ;
...
static int F_93 ( struct V_29 * V_17 , int V_150 )
{
if ( V_150 < V_151 )
return - V_59 ;
V_17 -> V_152 = V_150 ;
...
static int F_97 ( struct V_165 * V_166 [] , struct V_165 * V_115 [] )
{
return 0 ;
}
static void F_98 ( struct V_165 * V_115 [] ,
struct V_21 * V_14 )
{
...
return;
if ( V_115 [ V_167 ] )
V_14 -> V_131 = F_99 ( V_115 [ V_167 ] ) ;
if ( V_115 [ V_168 ] )
F_100 ( & V_14 -> V_15 , V_115 [ V_168 ] ,
sizeof( struct V_1 ) ) ;
if ( V_115 [ V_169 ] )
F_100 ( & V_14 -> V_16 , V_115 [ V_169 ] ,
sizeof( struct V_1 ) ) ;
if ( V_115 [ V_170 ] )
V_14 -> V_58 = F_101 ( V_115 [ V_170 ] ) ;
if ( V_115 [ V_171 ] )
V_14 -> V_94 = F_101 ( V_115 [ V_171 ] ) ;
}
static int F_102 ( struct V_7 * V_172 , struct V_29 * V_17 ,
struct V_165 * V_166 [] , struct V_165 * V_115 [] )
{
struct V_7 * V_7 = F_20 ( V_17 ) ;
struct V_6 * V_173 ;
V_173 = F_19 ( V_17 ) ;
F_98 ( V_115 , & V_173 -> V_14 ) ;
V_173 -> V_14 . V_49 = V_50 ;
if ( F_28 ( V_7 , & V_173 -> V_14 , 0 ) )
return - V_146 ;
return F_18 ( V_17 ) ;
}
static int F_103 ( struct V_29 * V_17 , struct V_165 * V_166 [] ,
struct V_165 * V_115 [] )
{
struct V_6 * V_10 ;
struct V_21 V_22 ;
...
static int F_106 ( struct V_43 * V_44 , const struct V_29 * V_17 )
{
struct V_6 * V_55 = F_19 ( V_17 ) ;
struct V_21 * V_174 = & V_55 -> V_14 ;
if ( F_107 ( V_44 , V_167 , V_174 -> V_131 ) ||
F_108 ( V_44 , V_168 , sizeof( struct V_1 ) ,
& V_174 -> V_15 ) ||
F_108 ( V_44 , V_169 , sizeof( struct V_1 ) ,
& V_174 -> V_16 ) ||
F_109 ( V_44 , V_170 , V_174 -> V_58 ) ||
F_109 ( V_44 , V_171 , V_174 -> V_94 ) )
goto V_175;
return 0 ;
V_175:
return - V_176 ;
...
V_31 = - V_164 ;
V_12 -> V_42 = F_26 ( sizeof( struct V_6 ) , L_3 ,
V_37 , V_38 ) ;
if ( ! V_12 -> V_42 )
goto V_180;
F_27 ( V_12 -> V_42 , V_7 ) ;
...
if ( V_31 < 0 )
goto V_186;
V_31 = F_121 ( & V_187 , V_118 ) ;
if ( V_31 < 0 )
goto V_188;
V_31 = F_121 ( & V_189 , V_119 ) ;
if ( V_31 < 0 )
goto V_190;
V_182 = L_6 ;
V_31 = F_122 ( & V_35 ) ;
