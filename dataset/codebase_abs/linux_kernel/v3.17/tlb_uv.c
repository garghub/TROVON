...
static T_7 F_95 ( struct V_236 * V_236 , char T_8 * V_241 ,
T_9 V_221 , T_6 * V_242 )
{
char * V_243 ;
int V_244 ;
V_243 = F_96 ( V_245 , L_16 ,
L_17 ,
L_18 ,
L_19 ,
V_131 , V_125 , V_127 ,
...
if ( ! V_243 )
return - V_248 ;
V_244 = F_97 ( V_241 , V_221 , V_242 , V_243 , strlen ( V_243 ) ) ;
F_98 ( V_243 ) ;
return V_244 ;
}
static T_7 F_99 ( struct V_236 * V_236 , const char T_8 * V_249 ,
T_9 V_221 , T_6 * V_77 )
{
int V_3 ;
int V_21 ;
...
return - V_253 ;
if ( F_100 ( V_252 , V_249 , V_221 ) )
return - V_254 ;
V_252 [ V_221 - 1 ] = '\0' ;
if ( ! strcmp ( V_252 , L_20 ) ) {
F_2 () ;
return V_221 ;
} else if ( ! strcmp ( V_252 , L_21 ) ) {
F_6 () ;
return V_221 ;
}
if ( F_101 ( V_252 , 10 , & V_251 ) < 0 ) {
F_102 ( V_255 L_22 , V_252 ) ;
return - V_253 ;
}
if ( V_251 == 0 ) {
V_250 = F_103 ( V_256 ) ;
...
static int F_104 ( const char * V_258 )
{
int V_259 = 0 ;
for (; ; V_258 ++ ) {
switch ( * V_258 ) {
...
static int F_105 ( struct V_4 * V_5 , char * V_260 ,
int V_221 )
{
char * V_261 ;
char * V_262 ;
...
static T_7 F_106 ( struct V_236 * V_236 , const char T_8 * V_249 ,
T_9 V_221 , T_6 * V_77 )
{
int V_3 ;
int V_244 ;
...
return - V_253 ;
if ( F_100 ( V_260 , V_249 , V_221 ) )
return - V_254 ;
V_260 [ V_221 ] = '\0' ;
V_3 = F_107 () ;
V_5 = & F_5 ( V_4 , V_3 ) ;
V_244 = F_105 ( V_5 , V_260 , V_221 ) ;
F_108 () ;
if ( V_244 )
return V_244 ;
F_4 (cpu) {
...
static int F_109 ( struct V_271 * V_271 , struct V_236 * V_236 )
{
return F_110 ( V_236 , & V_272 ) ;
}
static int F_111 ( struct V_271 * V_271 , struct V_236 * V_236 )
{
return 0 ;
}
...
V_278 = F_115 ( V_279 , NULL ) ;
if ( ! V_278 ) {
F_102 ( V_277 L_29 ,
V_279 ) ;
return - V_253 ;
}
V_280 = F_116 ( V_281 , 0600 ,
V_278 , NULL , & V_282 ) ;
if ( ! V_280 ) {
F_102 ( V_277 L_30 ,
V_281 ) ;
...
static void F_117 ( int V_8 , int V_57 , int V_283 )
{
int V_21 ;
int V_3 ;
int V_170 = 0 ;
...
static void F_126 ( int V_8 , int V_57 )
{
int V_3 ;
T_9 V_298 ;
char * V_299 ;
...
V_301 = F_121 ( F_120 ( V_305 ) ) ;
V_302 = F_127 ( V_305 ) ;
V_303 = ( ( unsigned long ) V_301 << V_306 ) | V_302 ;
V_304 = F_127 ( V_305 + ( V_30 - 1 ) ) ;
F_128 ( V_57 , V_303 ) ;
F_129 ( V_57 , V_302 ) ;
F_130 ( V_57 , V_304 ) ;
F_131 ( V_57 , 0xffffUL ) ;
...
static void T_1 F_132 ( int V_7 , int V_307 , int V_283 )
{
int V_8 ;
int V_57 ;
unsigned long V_308 ;
V_8 = F_7 ( V_7 ) ;
V_57 = F_81 ( V_7 ) ;
F_117 ( V_8 , V_57 , V_283 ) ;
F_126 ( V_8 , V_57 ) ;
V_308 = F_10 ( V_7 ) | V_309 ;
F_133 ( V_57 , ( ( V_308 << 32 ) | V_307 ) ) ;
}
...
static int T_1 F_137 ( int V_283 ,
struct V_327 * V_328 ,
unsigned char * V_329 )
{
int V_3 ;
...
static void F_140 ( struct V_4 * V_42 )
{
int V_3 ;
T_9 V_341 = sizeof( struct V_58 ) * F_87 () ;
V_42 -> V_60 = F_118 ( V_341 , V_245 , V_42 -> V_335 ) ;
memset ( V_42 -> V_60 , 0 , V_341 ) ;
F_4 (cpu) {
V_42 -> V_60 [ V_3 ] . V_57 = F_138 ( V_3 ) -> V_57 ;
V_42 -> V_60 [ V_3 ] . V_7 = F_138 ( V_3 ) -> V_336 ;
}
}
static void F_141 ( struct V_4 * V_85 )
{
int V_342 = sizeof( T_2 ) ;
V_85 -> V_72 = F_142 ( V_342 , V_245 , V_85 -> V_335 ) ;
}
static int F_143 ( struct V_332 * V_333 , struct V_327 * V_331 ,
struct V_4 * * V_343 ,
struct V_4 * * V_344 )
{
int V_21 ;
...
static int T_1 F_144 ( int V_228 ,
struct V_327 * V_328 ,
unsigned char * V_329 )
{
int V_330 ;
...
if ( ( V_338 & 1 ) ) {
V_333 = & V_331 -> V_330 [ V_330 ] ;
if ( F_143 ( V_333 , V_331 , & V_42 , & V_85 ) )
return 1 ;
F_140 ( V_42 ) ;
}
V_330 ++ ;
...
static int T_1 F_145 ( int V_228 , int V_347 )
{
unsigned char * V_329 ;
void * V_300 ;
struct V_327 * V_328 ;
V_101 = F_134 () ;
V_300 = F_146 ( V_228 * sizeof( struct V_327 ) , V_245 ) ;
V_328 = (struct V_327 * ) V_300 ;
memset ( V_328 , 0 , V_228 * sizeof( struct V_327 ) ) ;
V_329 = F_147 ( ( V_228 + 7 ) / 8 , V_245 ) ;
if ( F_137 ( V_347 , V_328 , V_329 ) )
goto V_348;
if ( F_144 ( V_228 , V_328 , V_329 ) )
goto V_348;
F_98 ( V_328 ) ;
F_98 ( V_329 ) ;
F_135 () ;
