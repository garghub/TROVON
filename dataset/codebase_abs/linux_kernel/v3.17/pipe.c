...
static struct V_1 * F_50 ( struct V_6 * V_7 , T_3 type )
{
struct V_1 * V_82 , * V_2 ;
int V_83 ;
V_2 = NULL ;
...
int (* F_55)( struct V_85 * V_86 , int V_87 ) )
{
struct V_67 * V_68 = F_40 ( V_7 ) ;
struct V_1 * V_2 ;
int V_83 ;
...
void F_61 ( struct V_1 * V_2 , struct V_95 * V_88 )
{
if ( V_2 -> V_88 )
V_2 -> V_88 -> V_2 = NULL ;
V_2 -> V_88 = V_88 ;
...
void F_65 ( struct V_1 * V_2 , int V_97 )
{
F_11 ( V_2 , V_64 ,
V_97 ? V_64 : 0 ) ;
}
...
struct V_1 * V_2 ;
struct V_15 * V_16 = F_13 ( V_7 ) ;
T_3 * V_98 = F_67 ( V_7 , V_98 ) ;
int V_99 = F_67 ( V_7 , V_99 ) ;
int V_83 ;
if ( V_98 [ 0 ] != V_73 ) {
F_16 ( V_16 , L_9 ) ;
return - V_61 ;
}
V_68 -> V_2 = F_68 ( sizeof( struct V_1 ) * V_99 , V_100 ) ;
if ( ! V_68 -> V_2 ) {
F_16 ( V_16 , L_10 ) ;
return - V_101 ;
}
