...
static void F_136 ( struct V_278 * V_21 , struct V_281 * V_300 )
{
}
...
{
struct V_301 * V_302 ;
V_302 = F_138 ( V_298 , V_303 , L_20 ) ;
V_1 -> V_304 = F_139 ( & V_298 -> V_305 , V_302 ) ;
if ( F_140 ( V_1 -> V_304 ) ) {
F_17 ( & V_298 -> V_305 , L_21 ) ;
return F_141 ( V_1 -> V_304 ) ;
}
return 0 ;
}
static int F_142 ( struct V_297 * V_298 )
{
struct V_306 * V_305 = & V_298 -> V_305 ;
char V_307 [ 8 ] ;
struct V_301 * V_302 , * V_308 ;
int V_255 ;
void T_7 * V_5 = NULL ;
struct V_1 * V_1 = NULL ;
int V_31 = 0 ;
int V_54 ;
unsigned long V_309 ;
V_302 = F_143 ( V_298 , V_303 , 0 ) ;
V_5 = F_139 ( & V_298 -> V_305 , V_302 ) ;
if ( F_140 ( V_5 ) )
return F_141 ( V_5 ) ;
V_308 = F_143 ( V_298 , V_310 , 0 ) ;
V_255 = V_308 -> V_311 ;
V_309 = V_308 -> V_277 & V_312 ;
if ( V_255 < 0 ) {
F_17 ( V_305 , L_22 ) ;
return - V_111 ;
}
V_1 = F_144 ( V_305 , sizeof( struct V_1 ) , V_215 ) ;
if ( V_1 == NULL )
return - V_81 ;
F_145 ( & V_1 -> V_14 ) ;
F_146 ( V_298 , V_1 ) ;
V_1 -> V_46 = F_147 ( V_305 ) ;
V_1 -> V_160 = V_309 == V_313 ;
V_1 -> V_15 . V_314 = & V_315 ;
V_1 -> V_15 . V_291 = V_231 ;
V_1 -> V_15 . V_316 = V_317 ;
F_148 ( & V_1 -> V_272 ) ;
V_1 -> V_272 . V_318 = F_109 ;
V_1 -> V_272 . V_319 = ( unsigned long ) V_1 ;
V_1 -> V_5 = V_5 ;
if ( V_1 -> V_46 -> V_47 ) {
snprintf ( V_307 , sizeof( V_307 ) , L_23 , V_298 -> V_320 ) ;
V_1 -> V_299 = F_149 ( V_305 , V_307 ) ;
if ( F_140 ( V_1 -> V_299 ) ) {
F_17 ( V_305 , L_24 , V_307 ) ;
return F_141 ( V_1 -> V_299 ) ;
}
F_150 ( V_1 -> V_299 ) ;
}
if ( V_1 -> V_46 -> V_321 ) {
V_31 = F_137 ( V_1 , V_298 ) ;
if ( V_31 < 0 )
goto V_322;
}
F_12 ( V_1 ) ;
V_31 = F_151 ( V_305 , V_255 , F_106 , V_323 ,
V_317 , V_1 ) ;
if ( V_31 < 0 ) {
F_17 ( V_305 , L_25 , V_31 ) ;
goto V_322;
}
F_14 ( & V_1 -> V_15 . V_324 ) ;
...
V_21 -> V_1 = V_1 ;
F_14 ( & V_21 -> V_22 ) ;
V_21 -> V_21 . V_316 = V_325 [ V_54 ] ;
V_21 -> V_21 . V_314 = & V_326 ;
F_152 ( & V_21 -> V_21 , 512 ) ;
}
F_152 ( & V_1 -> V_21 [ 0 ] . V_21 , 64 ) ;
V_1 -> V_21 [ 0 ] . V_4 = 0 ;
...
V_1 -> V_213 -> V_187 = F_136 ;
V_31 = F_153 ( V_305 , & V_1 -> V_15 ) ;
if ( V_31 )
goto V_327;
F_154 ( V_305 , L_26 , V_328 ) ;
return 0 ;
V_327:
F_117 ( & V_1 -> V_21 [ 0 ] . V_21 , V_1 -> V_213 ) ;
V_322:
