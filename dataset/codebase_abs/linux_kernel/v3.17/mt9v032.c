...
{
struct V_1 * V_1 = F_1 ( V_4 ) ;
V_14 -> V_85 = * F_17 ( V_1 , V_38 , V_14 -> V_39 ,
V_14 -> V_5 ) ;
return 0 ;
}
...
struct V_13 * V_83 ;
struct V_13 V_85 ;
V_85 . V_56 = F_31 ( F_32 ( V_14 -> V_85 . V_56 + 1 , 2 ) - 1 ,
V_86 ,
V_87 ) ;
V_85 . V_58 = F_31 ( F_32 ( V_14 -> V_85 . V_58 + 1 , 2 ) - 1 ,
V_88 ,
V_89 ) ;
V_85 . V_23 = F_35 (unsigned int, ALIGN(crop->rect.width, 2),
MT9V032_WINDOW_WIDTH_MIN,
MT9V032_WINDOW_WIDTH_MAX) ;
V_85 . V_61 = F_35 (unsigned int, ALIGN(crop->rect.height, 2),
MT9V032_WINDOW_HEIGHT_MIN,
MT9V032_WINDOW_HEIGHT_MAX) ;
V_85 . V_23 = F_36 (unsigned int,
rect.width, MT9V032_PIXEL_ARRAY_WIDTH - rect.left) ;
V_85 . V_61 = F_36 (unsigned int,
rect.height, MT9V032_PIXEL_ARRAY_HEIGHT - rect.top) ;
V_83 = F_17 ( V_1 , V_38 , V_14 -> V_39 , V_14 -> V_5 ) ;
if ( V_85 . V_23 != V_83 -> V_23 || V_85 . V_61 != V_83 -> V_61 ) {
V_82 = F_15 ( V_1 , V_38 , V_14 -> V_39 ,
V_14 -> V_5 ) ;
V_82 -> V_23 = V_85 . V_23 ;
V_82 -> V_61 = V_85 . V_61 ;
if ( V_14 -> V_5 == V_42 ) {
...
V_91 -> V_97 ) ;
case V_98 :
return F_4 ( V_8 , V_99 , V_91 -> V_97 ) ;
case V_100 :
return F_3 ( V_1 , V_101 ,
! V_91 -> V_97 ) ;
case V_102 :
return F_4 ( V_8 , V_103 ,
V_91 -> V_97 ) ;
case V_104 :
V_1 -> V_18 = V_91 -> V_97 ;
return F_5 ( V_1 ) ;
case V_105 :
return F_4 ( V_8 , V_106 ,
V_91 -> V_97 ) ;
case V_107 :
case V_108 :
if ( V_1 -> V_109 == NULL )
break;
V_93 = V_1 -> V_30 -> V_110 [ V_1 -> V_109 -> V_97 ] ;
* V_1 -> V_78 -> V_111 . V_112 = V_93 ;
V_1 -> V_26 = V_93 ;
break;
case V_113 :
switch ( V_1 -> V_114 -> V_97 ) {
case 0 :
V_17 = 0 ;
break;
case 1 :
...
V_11 = F_45 ( V_1 -> V_7 , V_129 , & V_19 ) ;
if ( V_11 < 0 ) {
F_44 ( & V_77 -> V_79 , L_4 ) ;
return V_11 ;
}
for ( V_127 = 0 ; V_127 < F_46 ( V_130 ) ; ++ V_127 ) {
if ( V_130 [ V_127 ] . V_19 == V_19 ) {
V_1 -> V_19 = & V_130 [ V_127 ] ;
break;
}
}
if ( V_1 -> V_19 == NULL ) {
...
{
struct V_143 * V_30 = V_77 -> V_79 . V_144 ;
struct V_1 * V_1 ;
unsigned int V_127 ;
int V_11 ;
if ( ! F_50 ( V_77 -> V_145 ,
V_146 ) ) {
F_28 ( & V_77 -> V_145 -> V_79 ,
L_7 ) ;
return - V_147 ;
}
V_1 = F_51 ( & V_77 -> V_79 , sizeof( * V_1 ) , V_148 ) ;
if ( ! V_1 )
return - V_149 ;
V_1 -> V_7 = F_52 ( V_77 , & V_150 ) ;
if ( F_53 ( V_1 -> V_7 ) )
return F_54 ( V_1 -> V_7 ) ;
...
F_56 ( & V_1 -> V_124 ) ;
V_1 -> V_30 = V_30 ;
V_1 -> V_16 = ( const void * ) V_142 -> V_151 ;
F_57 ( & V_1 -> V_35 , 10 ) ;
F_58 ( & V_1 -> V_35 , & V_152 ,
V_95 , 0 , 1 , 1 , 1 ) ;
F_58 ( & V_1 -> V_35 , & V_152 ,
...
V_157 ) ;
F_58 ( & V_1 -> V_35 , & V_152 ,
V_102 , V_1 -> V_16 -> V_17 -> V_158 ,
V_1 -> V_16 -> V_17 -> V_159 , 1 ,
V_160 ) ;
F_58 ( & V_1 -> V_35 , & V_152 ,
V_104 , V_1 -> V_16 -> V_17 -> V_15 ,
V_161 , 1 ,
V_162 ) ;
F_58 ( & V_1 -> V_35 , & V_152 ,
V_105 , V_1 -> V_16 -> V_17 -> V_163 ,
V_1 -> V_16 -> V_17 -> V_164 , 1 ,
V_165 ) ;
V_1 -> V_114 = F_60 ( & V_1 -> V_35 ,
& V_152 , V_113 ,
F_46 ( V_166 ) - 1 , 0 , 0 ,
V_166 ) ;
V_1 -> V_119 = F_61 ( & V_1 -> V_35 ,
& V_167 , NULL ) ;
F_62 ( 2 , & V_1 -> V_114 ) ;
V_1 -> V_78 =
F_58 ( & V_1 -> V_35 , & V_152 ,
...
for ( V_127 = 0 ; V_30 -> V_110 [ V_127 ] ; ++ V_127 ) {
if ( V_30 -> V_110 [ V_127 ] == V_30 -> V_170 )
V_169 = V_127 ;
}
V_1 -> V_109 =
F_63 ( & V_1 -> V_35 ,
...
V_1 -> V_4 . V_171 = & V_1 -> V_35 ;
if ( V_1 -> V_35 . error )
F_64 ( V_172 L_8 ,
V_173 , V_1 -> V_35 . error ) ;
V_1 -> V_14 . V_56 = V_133 ;
V_1 -> V_14 . V_58 = V_134 ;
V_1 -> V_14 . V_23 = V_70 ;
V_1 -> V_14 . V_61 = V_73 ;
...
V_1 -> V_43 . V_23 = V_70 ;
V_1 -> V_43 . V_61 = V_73 ;
V_1 -> V_43 . V_137 = V_138 ;
V_1 -> V_43 . V_139 = V_140 ;
V_1 -> V_21 = 1 ;
V_1 -> V_50 = 1 ;
V_1 -> V_10 = V_101 | V_96 ;
V_1 -> V_18 = V_162 ;
V_1 -> V_26 = V_174 ;
F_65 ( & V_1 -> V_4 , V_77 , & V_175 ) ;
V_1 -> V_4 . V_176 = & V_177 ;
V_1 -> V_4 . V_178 |= V_179 ;
V_1 -> V_39 . V_178 = V_180 ;
V_11 = F_66 ( & V_1 -> V_4 . V_181 , 1 , & V_1 -> V_39 , 0 ) ;
if ( V_11 < 0 )
goto V_182;
