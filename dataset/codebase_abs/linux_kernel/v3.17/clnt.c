...
return;
if ( V_292 )
V_151 -> V_152 -> V_86 -> V_295 ++ ;
V_294 ( V_151 ) ;
if ( F_160 ( V_151 ) )
return;
V_151 -> V_170 = V_296 ;
F_83 ( & V_151 -> V_185 -> V_247 -> V_297 , V_151 ) ;
}
static void
V_294 ( struct V_142 * V_151 )
{
V_151 -> V_170 = V_293 ;
if ( V_151 -> V_177 == 0 ) {
F_161 ( V_151 ) ;
...
struct V_180 * V_181 = V_151 -> V_185 ;
int V_174 ;
if ( V_181 -> V_300 > 0 && ! V_181 -> V_261 )
V_151 -> V_177 = V_181 -> V_300 ;
F_137 ( V_151 ) ;
V_174 = V_151 -> V_177 ;
if ( V_174 >= 0 ) {
V_151 -> V_170 = V_301 ;
...
static void
V_301 ( struct V_142 * V_151 )
{
struct V_1 * V_2 = V_151 -> V_152 ;
struct V_180 * V_181 = V_151 -> V_185 ;
T_7 V_306 = V_151 -> V_161 . V_162 -> V_252 ;
T_6 * V_265 ;
F_137 ( V_151 ) ;
if ( V_151 -> V_144 & V_305 ) {
if ( V_2 -> V_105 ) {
...
F_167 () ;
V_181 -> V_266 . V_186 = V_181 -> V_307 . V_186 ;
F_168 ( memcmp ( & V_181 -> V_266 , & V_181 -> V_307 ,
...
V_151 -> V_170 = V_296 ;
if ( V_306 ) {
V_151 -> V_177 = F_170 ( V_151 , V_306 , V_181 , V_265 ,
V_151 -> V_161 . V_164 ) ;
}
...
V_181 -> V_300 = V_181 -> V_266 . V_186 = 0 ;
...
V_181 -> V_313 = F_174 ( & V_181 -> V_309 [ 0 ] , V_265 ) ;
return V_265 ;
}
static T_6 *
...
{
struct V_1 * V_2 = V_151 -> V_152 ;
struct V_314 * V_315 = & V_151 -> V_185 -> V_266 . V_187 [ 0 ] ;
int V_186 = V_151 -> V_185 -> V_266 . V_186 >> 2 ;
T_6 * V_265 = V_315 -> V_263 ;
T_3 V_316 ;
int error = - V_240 ;
...
goto V_317;
V_265 += 1 ;
if ( ( V_316 = F_175 ( * V_265 ++ ) ) != V_318 ) {
F_43 ( L_64 ,
V_151 -> V_228 , V_31 , V_316 ) ;
error = - V_146 ;
goto V_319;
}
if ( ( V_316 = F_175 ( * V_265 ++ ) ) != V_320 ) {
if ( -- V_186 < 0 )
goto V_317;
switch ( ( V_316 = F_175 ( * V_265 ++ ) ) ) {
case V_321 :
break;
case V_322 :
F_43 ( L_65 ,
...
static void F_177 ( void * V_337 , struct V_338 * V_339 , void * V_340 )
{
}
static int F_178 ( void * V_337 , struct V_338 * V_339 , void * V_340 )
{
return 0 ;
}
...
int V_28 ;
V_160 . V_165 = V_342 . V_343 ( NULL , NULL , 0 ) ;
V_28 = F_106 ( V_2 , & V_160 , V_154 | V_344 ) ;
F_179 ( V_160 . V_165 ) ;
return V_28 ;
}
struct V_142 * F_180 ( struct V_1 * V_2 , struct V_165 * V_345 , int V_97 )
{
struct V_159 V_160 = {
. V_162 = & V_341 ,
. V_165 = V_345 ,
...
{
const char * V_346 = L_87 ;
if ( F_82 ( V_151 ) )
V_346 = F_183 ( V_151 -> V_147 ) ;
F_20 ( V_21 L_88 ,
