...
struct V_9 * V_10 = F_2 ( V_7 , struct V_9 , V_7 ) ;
...
T_2 V_35 = 0 ;
T_2 V_21 ;
struct V_11 * V_12 = F_2 ( V_16 , struct V_11 , V_16 ) ;
F_9 ( & V_12 -> V_27 ) ;
for ( V_5 = 0 ; V_5 < V_13 ; V_5 ++ ) {
if ( V_12 -> V_15 [ V_5 ] )
V_35 |= F_19 ( V_5 ) ;
...
char * V_45 ;
struct V_11 * V_12 ;
V_12 = F_21 ( & V_10 -> V_7 , sizeof( * V_12 ) , V_37 ) ;
if ( ! V_12 )
return - V_38 ;
F_22 ( & V_12 -> V_27 ) ;
F_23 ( & V_12 -> V_16 , F_18 ) ;
