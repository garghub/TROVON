...
static void F_41 ( struct V_1 * V_2 , struct V_131 * V_19 )
{
struct V_7 * V_8 = F_4 ( V_2 , struct V_7 , V_2 ) ;
unsigned long V_20 ;
unsigned char V_42 , V_43 ;
...
static int F_42 ( struct V_1 * V_2 , unsigned int V_132 ,
unsigned long V_133 )
{
switch ( V_132 ) {
case V_134 : {
struct V_131 V_19 ;
if ( F_43 ( & V_19 , (struct V_131 * ) V_133 ,
sizeof( struct V_131 ) ) )
return - V_135 ;
F_41 ( V_2 , & V_19 ) ;
break;
...
case V_136 : {
struct V_7 * V_8 = F_4 ( V_2 , struct V_7 , V_2 ) ;
if ( F_44 ( (struct V_131 * ) V_133 , & V_8 -> V_19 ,
sizeof( struct V_131 ) ) )
return - V_135 ;
break;
}
...
int T_2 F_45 ( struct V_138 * V_139 )
{
struct V_1 * V_2 ;
int V_140 ;
...
static void F_46 ( struct V_151 * V_152 , const char V_153 )
{
...
static void F_47 ( struct V_151 * V_152 , const char * V_155 , unsigned int V_156 )
{
...
static int T_2 F_48 ( struct V_151 * V_152 , char * V_157 )
{
struct V_1 * V_2 ;
int V_38 = V_158 ;
int V_159 = 8 ;
...
return - V_161 ;
if ( V_157 )
F_49 ( V_157 , & V_38 , & V_94 , & V_159 , & V_160 ) ;
return F_50 ( V_2 , V_152 , V_38 , V_94 , V_159 , V_160 ) ;
}
...
{
struct V_138 * V_139 = F_54 ( & V_164 -> V_71 ) ;
struct V_1 * V_2 ;
int V_140 ;
for ( V_140 = 0 ; ( ( V_140 < V_141 ) && ( V_139 [ V_140 ] . V_142 ) ) ; V_140 ++ ) {
V_2 = & V_143 [ V_140 ] . V_2 ;
