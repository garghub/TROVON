...
static void F_245 ( struct V_408 * V_409 , enum V_5 V_6 )
{
int V_405 , V_406 ;
enum V_410 V_411 ;
F_246 ( V_409 , L_44 , V_11 [ V_6 ] . V_53 ) ;
V_411 = F_243 ( V_6 ) ;
F_246 ( V_409 , L_45 , V_11 [ V_6 ] . V_53 ,
F_247 ( V_411 ) ,
F_248 ( V_411 ) ) ;
F_238 ( V_6 , & V_405 , & V_406 ) ;
F_246 ( V_409 , L_46 ,
F_196 ( V_6 ) , V_405 ) ;
F_246 ( V_409 , L_47 ,
F_195 ( V_6 ) , V_406 ) ;
}
void F_249 ( struct V_408 * V_409 )
{
int V_405 ;
T_2 V_242 ;
enum V_410 V_412 = F_239 () ;
if ( F_59 () )
return;
F_246 ( V_409 , L_48 ) ;
F_246 ( V_409 , L_49 ,
...
static void F_250 ( struct V_408 * V_409 )
{
int V_16 , V_17 ;
const char * V_414 [] = {
[ V_140 ] = L_52 ,
...
struct V_436 * V_437 )
{
if ( V_437 -> V_397 > 255 || V_437 -> V_397 == 0 )
return - V_280 ;
if ( V_437 -> V_398 < 1 || V_437 -> V_398 > 255 )
return - V_280 ;
V_437 -> V_438 = F_237 / V_437 -> V_397 ;
V_437 -> V_439 = V_437 -> V_438 / V_437 -> V_398 ;
return 0 ;
}
bool F_254 ( unsigned long V_3 ,
unsigned long V_440 , unsigned long V_441 ,
T_9 V_442 , void * V_443 )
{
int V_444 , V_445 , V_446 ;
int V_447 , V_448 , V_449 ;
unsigned long V_439 , V_438 ;
unsigned long V_450 ;
...
V_450 = F_187 ( V_456 ) ;
V_440 = V_440 ? V_440 : 1 ;
V_441 = V_441 ? V_441 : V_457 ;
V_445 = F_179 ( F_177 ( V_3 , V_450 ) , 1ul ) ;
V_446 = F_150 ( V_3 / V_440 , 255ul ) ;
for ( V_444 = V_445 ; V_444 <= V_446 ; ++ V_444 ) {
V_438 = V_3 / V_444 ;
V_448 = F_179 ( F_177 ( V_438 , V_441 ) , V_451 ) ;
V_449 = F_150 ( V_438 / V_440 , V_452 ) ;
...
V_454 = V_438 ;
if ( V_454 < V_439 * V_453 )
continue;
if ( V_442 ( V_444 , V_447 , V_438 , V_439 , V_443 ) )
return true ;
}
}
return false ;
...
{
F_10 ( L_60 , V_437 -> V_438 , V_437 -> V_397 ) ;
F_10 ( L_61 , V_437 -> V_439 , V_437 -> V_398 ) ;
F_235 ( V_6 , V_437 -> V_397 , V_437 -> V_398 ) ;
}
...
unsigned long V_454 ;
V_454 = F_237 () ;
V_437 -> V_397 = F_6 ( F_236 ( V_6 ) , 23 , 16 ) ;
V_437 -> V_398 = F_6 ( F_236 ( V_6 ) , 7 , 0 ) ;
V_437 -> V_438 = V_454 / V_437 -> V_397 ;
V_437 -> V_439 = V_437 -> V_438 / V_437 -> V_398 ;
return 0 ;
}
T_2 F_258 ( void )
...
void F_260 ( T_2 V_458 )
{
T_2 V_459 = F_3 ( V_421 ) ;
F_58 ( ( V_458 ^ V_459 ) & V_458 ) ;
F_1 ( V_421 , V_458 ) ;
}
void F_261 ( void )
{
...
static int T_10 F_264 ( struct V_400 * V_43 )
{
const struct V_464 * V_465 ;
struct V_464 * V_466 ;
V_466 = F_265 ( & V_43 -> V_44 , sizeof( * V_466 ) , V_467 ) ;
if ( ! V_466 ) {
...
memcpy ( V_466 , V_465 , sizeof( * V_466 ) ) ;
V_3 . V_47 = V_466 ;
return 0 ;
}
static T_11 F_268 ( int V_485 , void * V_486 )
{
if ( ! V_3 . V_487 )
return V_488 ;
return V_3 . V_489 ( V_485 , V_3 . V_490 ) ;
}
int F_269 ( T_12 V_491 , void * V_492 )
{
int V_42 ;
if ( V_3 . V_489 != NULL )
return - V_493 ;
...
V_3 . V_490 = V_492 ;
F_270 () ;
V_42 = F_271 ( & V_3 . V_43 -> V_44 , V_3 . V_485 , F_268 ,
V_494 , L_63 , & V_3 ) ;
if ( V_42 ) {
V_3 . V_489 = NULL ;
V_3 . V_490 = NULL ;
...
void F_272 ( void * V_492 )
{
F_273 ( & V_3 . V_43 -> V_44 , V_3 . V_485 , & V_3 ) ;
V_3 . V_489 = NULL ;
V_3 . V_490 = NULL ;
}
static int T_10 F_274 ( struct V_400 * V_43 )
{
T_2 V_495 ;
int V_42 = 0 ;
struct V_496 * V_497 ;
...
if ( V_42 )
return V_42 ;
V_497 = F_275 ( V_3 . V_43 , V_498 , 0 ) ;
if ( ! V_497 ) {
F_74 ( L_64 ) ;
return - V_280 ;
}
V_3 . V_4 = F_276 ( & V_43 -> V_44 , V_497 -> V_169 ,
F_277 ( V_497 ) ) ;
if ( ! V_3 . V_4 ) {
F_74 ( L_65 ) ;
return - V_468 ;
}
V_3 . V_485 = F_278 ( V_3 . V_43 , 0 ) ;
if ( V_3 . V_485 < 0 ) {
F_74 ( L_66 ) ;
return - V_484 ;
}
...
F_124 ( V_495 , 7 , 4 ) , F_124 ( V_495 , 3 , 0 ) ) ;
F_62 () ;
F_281 () ;
F_282 ( L_68 , F_250 ) ;
return 0 ;
...
static int T_13 F_284 ( struct V_400 * V_43 )
{
F_283 ( & V_43 -> V_44 ) ;
F_285 () ;
return 0 ;
}
static int F_286 ( struct V_500 * V_44 )
{
V_3 . V_487 = false ;
F_270 () ;
F_287 ( V_3 . V_485 ) ;
...
static int F_288 ( struct V_500 * V_44 )
{
if ( F_6 ( V_148 , 2 , 1 ) != V_461 ) {
F_263 () ;
F_56 () ;
}
V_3 . V_487 = true ;
