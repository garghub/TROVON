...
{
struct V_201 * V_202 = & V_70 -> V_130 ;
struct V_288 * V_289 = & V_70 -> V_290 ;
struct V_119 * V_129 = & V_202 -> V_131 ;
T_2 * V_291 = F_92 ( V_289 ) ;
memcpy ( V_129 -> V_51 , V_291 , V_52 ) ;
memcpy ( & V_129 -> V_83 , & V_202 -> V_292 ,
sizeof( struct V_23 ) ) ;
V_129 -> V_85 . V_104 =
sizeof( struct V_64 ) ;
...
switch ( V_202 -> V_294 ) {
case V_295 :
V_129 -> V_112 = F_93 ( V_296 ) ;
break;
case V_297 :
case V_298 :
V_129 -> V_112 = F_93 ( V_299 ) ;
break;
case V_300 :
V_129 -> V_112 = F_93 ( V_301 ) ;
break;
default:
break;
}
...
struct V_303 * V_304 = & V_8 -> V_305 ;
V_304 -> V_308 = 0 ;
V_312 = F_98 ( V_248 + 12 , V_320 , & V_310 , V_250 - 12 ) ;
if ( V_312 && ( V_310 > 0 ) ) {
if ( V_318 -> V_162 == 0 ) {
V_311 = * V_309 ;
V_313 = F_99 ( V_249 + V_311 ,
V_321 ,
V_322 ,
V_316 , V_309 ) ;
V_318 -> V_162 = 1 ;
...
static void F_67 ( struct V_1 * V_2 , T_2 * V_333 , T_4 V_334 )
{
T_2 * V_312 , V_335 ;
int V_3 , V_111 ;
struct V_138 * V_336 , * V_139 ;
struct V_314 * V_337 ;
struct V_338 * V_339 ;
struct V_193 * V_340 ;
struct V_7 * V_8 = & V_2 -> V_9 ;
...
V_304 -> V_306 = true ;
V_111 = 0 ;
V_312 = F_98 ( V_333 + sizeof( struct V_101 ) ,
V_320 ,
& V_111 , V_334 -
sizeof( struct V_101 ) ) ;
if ( V_312 && V_111 > 0 ) {
...
V_312 = F_98 ( V_333 + sizeof( struct V_101 ) ,
V_344 , & V_111 ,
V_334 - sizeof( struct V_101 ) ) ;
if ( V_312 && V_111 > 0 )
V_339 = (struct V_338 * ) ( V_312 + 2 ) ;
}
void F_101 ( struct V_1 * V_2 , int V_345 )
{
struct V_7 * V_8 = & V_2 -> V_9 ;
struct V_303 * V_304 = & V_8 -> V_305 ;
