...
static void F_47 ( struct V_95 * V_70 )
{
struct V_96 * V_97 = F_42 ( V_70 ) ;
F_5 ( V_97 ) ;
F_44 ( V_70 , NULL ) ;
}
...
F_48 ( V_6 ) ;
if ( V_6 -> V_63 && V_6 -> V_63 -> V_157 ) {
V_9 = V_6 -> V_63 -> V_157 ( V_6 ) ;
if ( V_9 ) {
F_54 ( & V_71 -> V_72 , L_25 ) ;
V_6 -> V_60 = 0 ;
}
