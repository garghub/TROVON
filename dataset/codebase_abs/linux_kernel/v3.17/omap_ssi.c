...
V_79 = F_57 ( V_74 , V_82 , V_75 ) ;
if ( ! V_79 ) {
F_58 ( & V_74 -> V_65 , L_25 , V_75 ) ;
return - V_83 ;
}
V_80 = F_59 ( & V_5 -> V_10 , V_79 -> V_84 ,
F_60 ( V_79 ) , F_24 ( & V_74 -> V_65 ) ) ;
if ( ! V_80 ) {
F_58 ( & V_74 -> V_65 , L_26 ,
V_79 -> V_75 ) ;
return - V_83 ;
}
V_81 = F_61 ( & V_5 -> V_10 , V_79 -> V_84 , F_60 ( V_79 ) ) ;
if ( ! V_81 ) {
F_58 ( & V_74 -> V_65 , L_27 , V_79 -> V_75 ) ;
return - V_83 ;
}
* V_76 = V_81 ;
if ( V_77 )
...
static int T_3 F_62 ( struct V_4 * V_5 ,
struct V_73 * V_74 )
{
struct V_7 * V_8 ;
int V_85 ;
V_8 = F_63 ( & V_5 -> V_10 , sizeof( * V_8 ) , V_86 ) ;
if ( ! V_8 ) {
F_58 ( & V_74 -> V_65 , L_28 ) ;
return - V_30 ;
}
V_5 -> V_87 = F_64 ( & V_88 , 0 , 0 , V_86 ) ;
if ( V_5 -> V_87 < 0 ) {
V_85 = V_5 -> V_87 ;
goto V_89;
}
...
F_65 ( & V_5 -> V_10 , L_29 , V_5 -> V_87 ) ;
F_66 ( V_5 , V_8 ) ;
V_8 -> V_65 = & V_5 -> V_10 ;
V_85 = F_55 ( V_74 , L_30 , & V_8 -> V_9 , NULL ) ;
if ( V_85 < 0 )
goto V_89;
V_85 = F_55 ( V_74 , L_23 , & V_8 -> V_15 , NULL ) ;
if ( V_85 < 0 )
goto V_89;
V_85 = F_67 ( V_74 , L_31 ) ;
if ( V_85 < 0 ) {
...
F_68 ( & V_8 -> V_67 , F_48 ,
( unsigned long ) V_5 ) ;
V_85 = F_69 ( & V_5 -> V_10 , V_8 -> V_68 , F_51 ,
0 , L_31 , V_5 ) ;
if ( V_85 < 0 ) {
F_58 ( & V_5 -> V_10 , L_33 ,
V_8 -> V_68 , V_85 ) ;
...
V_8 -> V_39 = F_63 ( & V_5 -> V_10 ,
sizeof( struct V_40 * ) * V_5 -> V_92 , V_86 ) ;
if ( ! V_8 -> V_39 ) {
V_85 = - V_30 ;
goto V_89;
}
V_8 -> V_72 = F_70 ( & V_5 -> V_10 , L_34 ) ;
if ( F_71 ( V_8 -> V_72 ) ) {
F_58 ( & V_74 -> V_65 , L_35 ,
F_72 ( V_8 -> V_72 ) ) ;
V_85 = - V_93 ;
...
T_4 V_48 ;
int V_85 ;
V_85 = F_3 ( V_5 -> V_10 . V_11 ) ;
if ( V_85 < 0 ) {
F_58 ( & V_5 -> V_10 , L_36 , V_85 ) ;
return V_85 ;
}
F_32 ( V_98 , V_8 -> V_9 + V_13 ) ;
V_48 = F_5 ( V_8 -> V_9 + V_14 ) ;
for ( V_97 = 0 ; ( ( V_97 < 20 ) && ! ( V_48 & V_99 ) ) ; V_97 ++ ) {
F_77 ( 20 ) ;
V_48 = F_5 ( V_8 -> V_9 + V_14 ) ;
}
if ( ! ( V_48 & V_99 ) ) {
...
F_32 ( V_101 , V_8 -> V_15 + V_102 ) ;
V_8 -> V_103 = F_78 ( F_53 ( V_5 ) , 1000 ) ;
F_43 ( & V_5 -> V_10 , L_38 , V_8 -> V_103 ) ;
V_48 = V_104 | V_105 | V_106 ;
F_32 ( V_48 , V_8 -> V_9 + V_13 ) ;
V_8 -> V_107 = V_48 ;
F_32 ( V_108 , V_8 -> V_9 + V_23 ) ;
V_8 -> V_109 = V_108 ;
F_6 ( V_5 -> V_10 . V_11 ) ;
return 0 ;
}
...
static int F_85 ( struct V_10 * V_65 , void * V_113 )
{
struct V_73 * V_114 = F_86 ( V_65 ) ;
F_87 ( V_114 ) ;
return 0 ;
}
static int T_3 F_88 ( struct V_73 * V_74 )
{
struct V_73 * V_115 ;
struct V_110 * V_111 = V_74 -> V_65 . V_116 ;
struct V_110 * V_112 ;
struct V_4 * V_5 ;
int V_85 ;
int V_92 ;
...
if ( ! F_84 ( V_112 , L_39 ) )
continue;
V_115 = F_94 ( V_112 , NULL , & V_74 -> V_65 ) ;
if ( ! V_115 ) {
V_85 = - V_93 ;
F_58 ( & V_74 -> V_65 , L_42 ) ;
goto V_120;
...
static int T_7 F_98 ( struct V_73 * V_74 )
{
struct V_4 * V_5 = F_56 ( V_74 ) ;
#ifdef F_93
F_27 ( V_5 ) ;
...
static int F_101 ( struct V_10 * V_65 )
{
struct V_4 * V_5 = F_100 ( V_65 ) ;
struct V_7 * V_8 = F_2 ( V_5 ) ;
F_43 ( V_65 , L_45 ) ;
