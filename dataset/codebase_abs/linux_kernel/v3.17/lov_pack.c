...
V_99 = F_55 () ;
F_56 ( V_100 ) ;
V_111 = sizeof( struct V_88 ) ;
if ( F_60 ( & V_109 , V_85 , V_111 ) )
GOTO ( V_113 , V_72 = - V_114 ) ;
else if ( ( V_109 . V_9 != V_115 ) &&
( V_109 . V_9 != V_95 ) )
GOTO ( V_113 , V_72 = - V_44 ) ;
if ( V_109 . V_12 &&
( V_109 . V_12 < V_31 -> V_45 ) ) {
V_109 . V_12 = V_31 -> V_45 ;
V_72 = F_61 ( V_85 , & V_109 , V_111 ) ;
GOTO ( V_113 , V_72 = - V_116 ) ;
}
V_72 = F_12 ( exp , & V_110 , V_31 ) ;
if ( V_72 < 0 )
GOTO ( V_113 , V_72 ) ;
V_40 = V_72 ;
V_72 = 0 ;
F_62 ( sizeof( V_109 ) == sizeof( struct V_23 ) ) ;
F_62 ( sizeof( V_109 . V_22 [ 0 ] ) == sizeof( V_110 -> V_22 [ 0 ] ) ) ;
if ( ( F_21 ( V_43 ) != V_43 ) &&
( ( V_110 -> V_9 == F_21 ( V_27 ) ) ||
( V_110 -> V_9 == F_21 ( V_28 ) ) ) ) {
F_63 ( V_110 ) ;
F_64 (
(struct V_117 * ) V_110 -> V_22 ,
V_110 -> V_12 ) ;
}
if ( V_109 . V_9 == V_115 ) {
if ( V_110 -> V_9 == V_28 ) {
memmove ( ( char * ) ( & V_110 -> V_12 ) +
sizeof( V_110 -> V_12 ) ,
( (struct V_23 * ) V_110 ) -> V_22 ,
V_110 -> V_12 *
sizeof( struct V_39 ) ) ;
V_40 -= V_118 ;
}
...
if ( V_109 . V_12 == 0 )
V_40 = V_111 ;
else if ( V_109 . V_12 < V_110 -> V_12 )
GOTO ( V_113 , V_72 = - V_116 ) ;
V_109 . V_12 = V_110 -> V_12 ;
V_109 . V_13 = V_110 -> V_13 ;
( (struct V_84 * ) V_110 ) -> V_13 = V_109 . V_13 ;
( (struct V_84 * ) V_110 ) -> V_12 = V_109 . V_12 ;
if ( F_61 ( V_85 , V_110 , V_40 ) )
V_72 = - V_114 ;
F_65 ( exp , & V_110 ) ;
V_113:
F_56 ( V_99 ) ;
