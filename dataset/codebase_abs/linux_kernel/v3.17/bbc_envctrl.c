...
static void F_28 ( struct V_62 * V_63 , struct V_64 * V_65 ,
int V_80 )
{
struct V_1 * V_2 ;
...
{
struct V_1 * V_2 , * V_84 ;
F_32 (fp, fpos, &bp->fans, bp_list) {
F_33 ( & V_2 -> V_68 ) ;
F_33 ( & V_2 -> V_69 ) ;
F_34 ( V_2 ) ;
}
}
int F_36 ( struct V_62 * V_63 )
{
struct V_64 * V_65 ;
int V_85 = 0 ;
int V_86 = 0 ;
int V_87 = 0 ;
while ( ( V_65 = F_37 ( V_63 , V_87 ++ ) ) != NULL ) {
