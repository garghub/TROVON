...
#if F_11 ( V_43 ) && ( V_43 & V_44 )
F_6 ( L_11 , V_34 -> V_51 , V_34 -> V_5 ) ;
#endif
F_6 ( L_12 , V_34 -> V_51 , ( int )
V_34 -> V_4 ) ;
if ( V_34 -> V_5 == V_49 )
F_6 ( L_13 ) ;
else
...
int F_17 ( struct V_55 * V_56 , struct V_57 * V_58 ,
T_2 V_59 , int * V_60 )
{
int V_61 = V_59 ;
V_60 [ 0 ] = 64 ;
...
static inline int F_18 ( struct V_33 * V_34 , unsigned char * V_62 ,
int V_63 ) {
register unsigned char * V_64 = V_62 ;
register unsigned short V_65 = ( unsigned short ) ( V_34 -> V_4 +
V_66 ) ;
register int V_24 = V_63 ;
int V_67 = 0 ;
while ( ! ( F_5 ( V_34 -> V_4 + V_68 ) & V_69 ) )
++ V_67 ;
F_19 ( V_65 , V_64 , V_24 ) ;
if ( F_5 ( V_34 -> V_4 + V_10 ) & V_70 ) {
F_2 ( V_71 , V_34 -> V_4 + V_10 ) ;
F_6 ( L_17 ,
V_34 -> V_51 ) ;
return - 1 ;
}
...
static inline int F_20 ( struct V_33 * V_34 , unsigned char * V_73 ,
int V_63 ) {
register unsigned char * V_74 = V_73 ;
register unsigned short V_65 = ( V_34 -> V_4 + V_66 ) ;
register int V_24 = V_63 ;
int V_67 = 0 ;
while ( ! ( ( F_5 ( V_34 -> V_4 + V_68 ) ) & V_69 ) )
++ V_67 ;
...
static int F_22 ( struct V_33 * V_76 )
{
if ( V_76 -> V_5 )
F_23 ( V_76 -> V_5 , V_76 ) ;
F_24 ( V_76 ) ;
if ( V_76 -> V_4 && V_76 -> V_77 )
F_25 ( V_76 -> V_4 , V_76 -> V_77 ) ;
F_26 ( V_76 ) ;
return 0 ;
}
