...
( long ) ( V_100 -> V_2 -> V_105 . V_106 ) ,
V_100 -> V_57 ) ;
F_65 ( V_99 , L_6 ) ;
V_103 = 0 ;
F_66 (attach_obj, &buf_obj->attachments, node) {
F_65 ( V_99 , L_7 ) ;
F_67 ( V_99 , L_8 , F_68 ( V_101 -> V_72 ) ) ;
V_103 ++ ;
}
F_67 ( V_99 , L_9 ,
V_103 ) ;
...
static int F_69 ( struct V_98 * V_99 , void * V_107 )
{
void (* F_70)( struct V_98 * ) = V_99 -> V_108 ;
F_70 ( V_99 ) ;
return 0 ;
}
static int F_71 ( struct V_1 * V_1 , struct V_2 * V_2 )
{
return F_72 ( V_2 , F_69 , V_1 -> V_109 ) ;
}
static int F_73 ( void )
{
int V_110 = 0 ;
V_111 = F_74 ( L_11 , NULL ) ;
if ( F_35 ( V_111 ) ) {
V_110 = F_75 ( V_111 ) ;
V_111 = NULL ;
return V_110 ;
}
V_110 = F_76 ( L_12 , F_63 ) ;
if ( V_110 )
F_77 ( L_13 ) ;
return V_110 ;
}
...
int F_76 ( const char * V_112 ,
int (* F_80)( struct V_98 * ) )
{
struct V_113 * V_114 ;
V_114 = F_81 ( V_112 , V_115 , V_111 ,
F_80 , & V_116 ) ;
return F_82 ( V_114 ) ;
}
