...
static void F_73 ( struct V_26 * V_29 )
{
struct V_28 * V_27 ;
F_36 (dev, &bus->devices, bus_list)
F_91 ( V_27 ) ;
...
F_15 () ;
F_49 ( & V_75 ) ;
F_104 ( & V_12 -> V_76 , & V_125 ) ;
F_51 ( & V_75 ) ;
V_50 = F_105 ( V_126 , V_45 , 1 ,
F_28 , NULL , V_12 , NULL ) ;
if ( F_30 ( V_50 ) ) {
F_33 ( V_45 , L_15 ) ;
F_46 ( V_12 ) ;
...
static void F_106 ( struct V_14 * V_12 )
{
if ( F_103 ( V_12 -> V_26 ) ) {
struct V_122 * V_123 ;
struct V_2 * V_3 ;
