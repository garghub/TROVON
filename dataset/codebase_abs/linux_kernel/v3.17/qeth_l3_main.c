...
if ( ! V_28 -> V_125 )
return - V_409 ;
V_28 -> V_125 -> V_58 |= V_546 ;
V_28 -> V_125 -> V_539 = & V_547 ;
F_99 ( V_28 ) ;
...
V_28 -> V_125 -> V_187 |= V_556 |
V_557 |
V_558 ;
V_28 -> V_125 -> V_559 &= ~ V_560 ;
V_28 -> V_125 -> V_561 = 15 * V_562 ;
F_249 ( V_28 -> V_125 , & V_28 -> V_124 -> V_125 ) ;
F_250 ( V_28 -> V_125 , & V_28 -> V_305 , F_146 , V_563 ) ;
return F_251 ( V_28 -> V_125 ) ;
}
static int F_252 ( struct V_564 * V_124 )
{
...
static void F_255 ( struct V_564 * V_566 )
{
struct V_27 * V_28 = F_253 ( & V_566 -> V_125 ) ;
F_256 ( & V_566 -> V_125 ) ;
F_163 ( V_28 , 0 , 1 ) ;
F_257 ( V_28 -> V_567 , F_173 ( V_28 , 0xffffffff ) == 0 ) ;
if ( V_566 -> V_71 == V_568 )
F_258 ( V_566 ) ;
if ( V_28 -> V_125 ) {
F_259 ( V_28 -> V_125 ) ;
...
static int F_260 ( struct V_564 * V_124 , int V_332 )
{
struct V_27 * V_28 = F_253 ( & V_124 -> V_125 ) ;
int V_4 = 0 ;
enum V_569 V_570 ;
...
V_28 -> V_99 . V_565 = 0 ;
V_28 -> V_71 = V_336 ;
memset ( & V_28 -> V_296 , 0 , sizeof( struct V_576 ) ) ;
F_266 ( V_28 ) ;
F_65 ( V_139 , 2 , L_180 ) ;
V_4 = F_267 ( V_28 ) ;
if ( V_4 ) {
...
static int F_280 ( struct V_564 * V_124 )
{
return F_260 ( V_124 , 0 ) ;
}
static int F_281 ( struct V_564 * V_566 ,
int V_332 )
{
struct V_27 * V_28 = F_253 ( & V_566 -> V_125 ) ;
int V_4 = 0 , V_580 = 0 , V_581 = 0 ;
enum V_569 V_570 ;
F_261 ( & V_28 -> V_571 ) ;
F_261 ( & V_28 -> V_572 ) ;
F_65 ( V_139 , 3 , L_187 ) ;
...
F_270 ( V_28 -> V_125 ) ;
V_570 = V_28 -> V_71 ;
if ( ( ! V_332 && V_28 -> V_99 . V_565 ) || V_28 -> V_99 . V_565 == 2 ) {
F_265 ( V_28 , V_582 ) ;
V_28 -> V_99 . V_565 = 1 ;
}
F_162 ( V_28 , V_332 ) ;
...
F_90 () ;
F_283 ( V_583 , V_28 -> V_125 ) ;
F_92 () ;
}
V_4 = F_275 ( F_276 ( V_28 ) ) ;
V_580 = F_275 ( F_277 ( V_28 ) ) ;
V_581 = F_275 ( F_278 ( V_28 ) ) ;
if ( ! V_4 )
V_4 = ( V_580 ) ? V_580 : V_581 ;
if ( V_4 )
F_263 ( V_139 , 2 , L_181 , V_4 ) ;
F_279 ( F_276 ( V_28 ) ) ;
if ( V_570 == V_72 )
V_28 -> V_71 = V_526 ;
F_273 ( & V_566 -> V_125 . V_578 , V_579 ) ;
F_274 ( & V_28 -> V_572 ) ;
F_274 ( & V_28 -> V_571 ) ;
return 0 ;
}
static int F_258 ( struct V_564 * V_566 )
{
return F_281 ( V_566 , 0 ) ;
}
static int F_284 ( void * V_584 )
{
struct V_27 * V_28 ;
int V_4 = 0 ;
...
static void F_291 ( struct V_564 * V_124 )
{
struct V_27 * V_28 = F_253 ( & V_124 -> V_125 ) ;
F_163 ( V_28 , 0 , 1 ) ;
if ( ( V_124 -> V_71 == V_568 ) && V_28 -> V_99 . V_565 )
F_265 ( V_28 , V_582 ) ;
F_167 ( V_28 , 0 ) ;
F_168 ( V_28 ) ;
F_279 ( F_276 ( V_28 ) ) ;
}
static int F_292 ( struct V_564 * V_124 )
{
struct V_27 * V_28 = F_253 ( & V_124 -> V_125 ) ;
if ( V_28 -> V_125 )
F_293 ( V_28 -> V_125 ) ;
...
static int F_294 ( struct V_564 * V_124 )
{
struct V_27 * V_28 = F_253 ( & V_124 -> V_125 ) ;
int V_4 = 0 ;
if ( V_124 -> V_71 == V_585 )
...
static int F_297 ( struct V_586 * V_587 ,
unsigned long V_588 , void * V_584 )
{
struct V_240 * V_241 = (struct V_240 * ) V_584 ;
struct V_218 * V_125 = (struct V_218 * ) V_241 -> V_589 -> V_125 ;
struct V_29 * V_2 ;
struct V_27 * V_28 ;
if ( F_298 ( V_125 ) != & V_590 )
return V_591 ;
V_28 = F_161 ( V_125 ) ;
if ( ! V_28 )
return V_591 ;
...
static int F_299 ( struct V_586 * V_587 ,
unsigned long V_588 , void * V_584 )
{
struct V_246 * V_241 = (struct V_246 * ) V_584 ;
struct V_218 * V_125 = (struct V_218 * ) V_241 -> V_594 -> V_125 ;
struct V_29 * V_2 ;
struct V_27 * V_28 ;
V_28 = F_161 ( V_125 ) ;
if ( ! V_28 )
