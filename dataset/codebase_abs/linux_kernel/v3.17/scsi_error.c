...
if ( ! F_43 ( V_18 , & V_65 ) )
return V_34 ;
if ( V_18 -> V_80 [ 0 ] == V_81 && V_18 -> V_82 != V_83 )
return V_26 ;
F_39 ( V_21 , & V_65 ) ;
if ( F_44 ( & V_65 ) )
return V_84 ;
if ( V_21 -> V_85 && V_21 -> V_85 -> V_86 &&
V_21 -> V_85 -> V_86 -> V_87 ) {
int V_88 ;
V_88 = V_21 -> V_85 -> V_86 -> V_87 ( V_21 , & V_65 ) ;
if ( V_88 != V_89 )
return V_88 ;
}
if ( V_65 . V_90 == 0x70 ) {
...
static void V_83 ( struct V_17 * V_18 )
{
struct V_138 * V_139 ;
F_5 ( 3 , F_15 ( V_6 , V_18 ,
L_31 ,
...
V_18 -> V_160 = V_161 ;
V_18 -> V_32 = 0 ;
V_18 -> V_80 = V_151 -> V_162 ;
memset ( V_18 -> V_80 , 0 , V_163 ) ;
...
V_18 -> V_80 [ 0 ] = V_171 ;
V_18 -> V_80 [ 4 ] = V_18 -> V_157 . V_164 ;
V_18 -> V_154 = F_66 ( V_18 -> V_80 [ 0 ] ) ;
} else {
V_18 -> V_156 = V_172 ;
if ( V_80 ) {
F_23 ( V_152 > V_163 ) ;
memcpy ( V_18 -> V_80 , V_80 , V_152 ) ;
V_18 -> V_154 = F_66 ( V_18 -> V_80 [ 0 ] ) ;
}
}
V_18 -> V_159 = 0 ;
if ( V_21 -> V_173 <= V_174 && V_21 -> V_173 != V_175 )
V_18 -> V_80 [ 1 ] = ( V_18 -> V_80 [ 1 ] & 0x1f ) |
( V_21 -> V_176 << 5 & 0xe0 ) ;
...
static int F_68 ( struct V_17 * V_18 , unsigned char * V_80 ,
...
int V_23 ;
V_181:
F_63 ( V_18 , & V_151 , V_80 , V_152 , V_153 ) ;
V_2 -> V_139 = & V_178 ;
F_71 ( V_18 ) ;
V_18 -> V_82 = V_83 ;
...
if ( V_18 -> V_22 -> V_98 ) {
int V_202 , V_23 = V_84 ;
for ( V_202 = 0 ; V_23 == V_84 && V_202 < 2 ; V_202 ++ )
...
void F_126 ( struct V_1 * V_2 , int V_121 , int V_255 )
{
struct V_20 * V_21 ;
F_124 (sdev, shost) {
if ( V_121 == F_125 ( V_21 ) &&
...
int
F_129 ( struct V_20 * V_256 , int V_257 )
{
struct V_17 * V_18 ;
...
if ( F_121 ( V_2 ) < 0 )
return V_34 ;
if ( ! F_130 ( & V_256 -> V_258 ) ) {
V_23 = V_34 ;
goto V_259;
}
V_18 = F_131 ( V_256 , V_237 ) ;
if ( ! V_18 ) {
V_23 = V_34 ;
F_132 ( & V_256 -> V_258 ) ;
goto V_259;
...
int F_135 ( const T_1 * V_91 , int V_266 ,
struct V_64 * V_65 )
{
if ( ! V_91 || ! V_266 )
return 0 ;
...
struct V_64 * V_65 )
{
return F_135 ( V_238 -> V_91 ,
V_165 , V_65 ) ;
}
const T_1 * F_137 ( const T_1 * V_91 , int V_266 ,
int V_267 )
{
...
int F_138 ( const T_1 * V_91 , int V_266 ,
T_2 * V_273 )
{
int V_274 ;
const T_1 * V_275 ;
...
void F_139 ( int V_277 , T_1 * V_278 , T_1 V_279 , T_1 V_71 , T_1 V_72 )
{
if ( V_277 ) {
V_278 [ 0 ] = 0x72 ;
V_278 [ 1 ] = V_279 ;
