...
return - V_124 ;
if ( V_7 . V_105 && V_199 -> V_202 == V_133 ) {
return 0 ;
}
F_63 ( & V_7 . V_128 ) ;
if ( V_7 . V_105 ) {
...
V_133 = F_82 ( 2 , F_83 ( ( int ) V_199 -> V_202 , V_119 ) ) ;
V_199 -> V_202 = V_133 ;
...
static int F_84 ( struct V_115 * V_115 , void * V_135 , struct V_205 * V_17 )
{
unsigned int V_155 = V_17 -> V_155 ;
if ( V_155 >= V_133 )
return - V_124 ;
V_17 -> V_206 = V_7 . V_107 [ V_155 ] . V_1 ;
V_17 -> V_181 = V_207 | V_208 ;
...
V_17 -> V_200 = V_201 ;
V_17 -> V_211 . V_212 = V_155 * V_106 ;
V_17 -> V_20 = V_106 ;
return 0 ;
}
static int F_85 ( struct V_115 * V_115 , void * V_135 , struct V_205 * V_17 )
{
if ( V_17 -> V_200 != V_201 )
return - V_124 ;
if ( V_17 -> V_155 >= V_133 )
...
static int F_86 ( struct V_115 * V_115 , void * V_135 , struct V_205 * V_17 )
{
int V_97 ;
if ( V_17 -> V_200 != V_201 )
return - V_124 ;
...
V_17 -> V_155 = V_97 ;
V_17 -> V_206 = V_7 . V_107 [ V_97 ] . V_1 ;
V_17 -> V_181 = V_207 | V_208 ;
V_17 -> V_190 = V_192 ;
V_17 -> V_110 = V_7 . V_107 [ V_97 ] . V_110 ;
V_17 -> V_98 = V_7 . V_107 [ V_97 ] . V_98 ;
V_17 -> V_200 = V_201 ;
V_17 -> V_211 . V_212 = V_97 * V_106 ;
V_17 -> V_20 = V_106 ;
V_7 . V_107 [ V_97 ] . V_108 = V_120 ;
F_65 ( & V_7 . V_128 ) ;
return 0 ;
}
static int F_88 ( struct V_115 * V_115 , void * V_135 , enum V_213 V_6 )
{
F_63 ( & V_7 . V_128 ) ;
switch ( V_7 . V_71 ) {
case V_91 :
...
static int F_89 ( struct V_115 * V_115 , void * V_135 , enum V_213 V_6 )
{
F_63 ( & V_7 . V_128 ) ;
F_37 () ;
F_57 ( & V_7 . V_103 ) ;
...
static long F_90 ( struct V_115 * V_115 , void * V_135 , bool V_214 ,
unsigned int V_215 , void * V_216 )
{
switch ( V_215 ) {
case V_217 :
return F_61 ( (struct V_121 * ) V_216 ) ;
case V_218 :
return F_62 ( (struct V_121 * ) V_216 ) ;
case V_219 :
return F_66 ( ( int * ) V_216 ) ;
case V_220 :
return F_67 ( V_115 , V_135 , ( int * ) V_216 ) ;
case V_221 :
return F_69 () ;
case V_222 :
return F_70 ( ( int * ) V_216 ) ;
default:
return - V_223 ;
}
}
static unsigned int F_91 ( struct V_115 * V_115 , T_6 * V_224 )
{
unsigned int V_225 = F_92 ( V_115 , V_224 ) ;
F_63 ( & V_7 . V_128 ) ;
F_93 ( V_115 , & V_7 . V_113 , V_224 ) ;
if ( F_87 ( & V_7 . V_111 ) )
V_225 |= V_226 | V_227 ;
F_65 ( & V_7 . V_128 ) ;
return V_225 ;
}
static void F_94 ( struct V_228 * V_229 )
{
long V_230 = ( long ) V_229 -> V_231 ;
V_7 . V_203 [ V_230 ] ++ ;
}
static void F_95 ( struct V_228 * V_229 )
{
long V_230 = ( long ) V_229 -> V_231 ;
V_7 . V_203 [ V_230 ] -- ;
}
static int F_96 ( struct V_115 * V_115 , struct V_228 * V_229 )
{
unsigned long V_18 = V_229 -> V_232 ;
unsigned long V_1 = V_229 -> V_233 - V_229 -> V_232 ;
unsigned long V_212 = V_229 -> V_234 << V_235 ;
...
V_237 = ( unsigned long ) V_7 . V_105 + V_212 ;
while ( V_1 > 0 ) {
V_236 = F_97 ( ( void * ) V_237 ) ;
if ( F_98 ( V_229 , V_18 , V_236 , V_4 , V_238 ) ) {
F_65 ( & V_7 . V_128 ) ;
return - V_139 ;
}
V_18 += V_4 ;
...
V_229 -> V_239 = & V_240 ;
V_229 -> V_241 &= ~ V_242 ;
V_229 -> V_241 |= V_243 | V_244 ;
V_229 -> V_231 = ( void * ) ( V_212 / V_106 ) ;
F_94 ( V_229 ) ;
F_65 ( & V_7 . V_128 ) ;
return 0 ;
}
static int F_99 ( struct V_245 * V_246 , T_7 V_108 )
{
F_100 ( V_246 ) ;
V_7 . V_247 = V_7 . V_71 ;
F_37 () ;
...
static int F_101 ( struct V_245 * V_246 )
{
F_102 ( V_246 ) ;
F_103 ( V_7 . V_9 , V_248 , 1 ) ;
F_28 ( V_74 , 0 ) ;
F_28 ( V_38 , V_46 ) ;
F_38 ( 1 ) ;
F_25 ( V_249 , 1 ) ;
...
static int F_104 ( struct V_245 * V_252 , const struct V_253 * V_254 )
{
static const struct V_255 V_256 = {
. V_160 = V_174 ,
. type = V_257 ,
. V_258 = & V_259 ,
. V_156 = L_16 ,
...
static const struct V_255 V_263 = {
. V_160 = V_176 ,
. type = V_257 ,
. V_258 = & V_259 ,
. V_156 = L_17 ,
...
static const struct V_255 V_264 = {
. V_160 = V_178 ,
. type = V_257 ,
. V_258 = & V_259 ,
. V_156 = L_18 ,
...
memcpy ( V_7 . V_270 , & V_274 , sizeof( V_274 ) ) ;
V_7 . V_270 -> V_266 = & V_7 . V_266 ;
V_267 = - V_275 ;
if ( ( V_267 = F_64 ( V_276 , 1 ) ) ) {
F_106 ( V_266 , L_24 ) ;
F_106 ( V_266 , L_25
L_26 ) ;
goto V_277;
}
if ( ( V_267 = F_111 ( V_7 . V_9 ) ) ) {
F_106 ( V_266 , L_27 ) ;
goto V_278;
}
V_268 = F_112 ( V_7 . V_9 , 0 ) ;
if ( ! V_268 ) {
F_106 ( V_266 , L_28 ) ;
goto V_279;
}
...
V_7 . V_31 = F_115 ( V_268 , V_280 ) ;
if ( ! V_7 . V_31 ) {
F_106 ( V_266 , L_30 ) ;
goto V_281;
}
V_7 . V_282 = V_252 -> V_95 ;
if ( F_116 ( V_7 . V_282 , F_49 ,
V_283 , L_8 , F_49 ) ) {
F_106 ( V_266 , L_31 ) ;
goto V_284;
}
F_117 ( V_7 . V_9 , V_285 , 8 ) ;
F_117 ( V_7 . V_9 , V_286 , 64 ) ;
F_118 ( V_7 . V_9 ) ;
F_103 ( V_7 . V_9 , V_248 , 1 ) ;
F_28 ( V_74 , 0 ) ;
F_28 ( V_38 , V_46 ) ;
...
F_122 ( & V_7 . V_287 , & V_259 ,
V_171 , 0 , 63 , 1 , 32 ) ;
F_123 ( & V_7 . V_287 , & V_256 , NULL ) ;
F_122 ( & V_7 . V_287 , & V_259 ,
V_175 , 0 , 63 , 1 , 32 ) ;
F_123 ( & V_7 . V_287 , & V_263 , NULL ) ;
F_122 ( & V_7 . V_287 , & V_259 ,
V_177 , 0 , 10 , 1 , 8 ) ;
F_123 ( & V_7 . V_287 , & V_264 , NULL ) ;
if ( V_7 . V_287 . error ) {
F_106 ( V_266 , L_32 ) ;
goto V_288;
}
F_124 ( & V_7 . V_287 ) ;
V_7 . V_270 -> V_289 = & V_7 . V_287 ;
if ( F_125 ( V_7 . V_270 , V_290 ,
V_291 ) < 0 ) {
F_106 ( V_266 , L_33 ) ;
goto V_288;
}
...
V_292 ) ;
F_126 ( V_266 , L_35 ,
V_7 . V_9 -> V_293 , V_268 , V_7 . V_282 ) ;
return 0 ;
V_288:
F_127 ( & V_7 . V_287 ) ;
F_128 ( V_7 . V_282 , F_49 ) ;
V_284:
F_129 ( V_7 . V_31 ) ;
V_281:
F_130 ( F_112 ( V_7 . V_9 , 0 ) ,
F_114 ( V_7 . V_9 , 0 ) ) ;
V_279:
F_131 ( V_7 . V_9 ) ;
V_278:
...
static void F_134 ( struct V_245 * V_252 )
{
F_135 ( V_7 . V_270 ) ;
F_37 () ;
F_36 () ;
