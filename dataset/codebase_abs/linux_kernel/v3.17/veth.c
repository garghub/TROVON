...
static int F_45 ( struct V_95 * V_96 [] , struct V_95 * V_33 [] )
{
if ( V_96 [ V_97 ] ) {
if ( F_46 ( V_96 [ V_97 ] ) != V_98 )
return - V_75 ;
if ( ! F_47 ( F_48 ( V_96 [ V_97 ] ) ) )
return - V_99 ;
}
if ( V_96 [ V_100 ] ) {
if ( ! F_35 ( F_49 ( V_96 [ V_100 ] ) ) )
return - V_75 ;
}
return 0 ;
}
...
struct V_110 * V_111 ;
struct V_101 * V_101 ;
if ( V_33 != NULL && V_33 [ V_112 ] != NULL ) {
struct V_95 * V_113 ;
V_113 = V_33 [ V_112 ] ;
V_111 = F_48 ( V_113 ) ;
V_103 = F_51 ( V_106 ,
F_48 ( V_113 ) + sizeof( struct V_110 ) ,
F_46 ( V_113 ) - sizeof( struct V_110 ) ) ;
if ( V_103 < 0 )
return V_103 ;
V_103 = F_45 ( V_106 , NULL ) ;
if ( V_103 < 0 )
return V_103 ;
V_108 = V_106 ;
} else {
...
if ( V_108 [ V_114 ] ) {
F_52 ( V_104 , V_108 [ V_114 ] , V_105 ) ;
V_109 = V_115 ;
} else {
snprintf ( V_104 , V_105 , V_22 L_1 ) ;
V_109 = V_116 ;
}
V_101 = F_53 ( V_102 , V_108 ) ;
if ( F_54 ( V_101 ) )
return F_55 ( V_101 ) ;
V_36 = F_56 ( V_101 , V_104 , V_109 ,
& V_117 , V_108 ) ;
if ( F_54 ( V_36 ) ) {
F_57 ( V_101 ) ;
return F_55 ( V_36 ) ;
...
goto V_119;
F_34 ( V_36 ) ;
V_103 = F_60 ( V_36 , V_111 ) ;
if ( V_103 < 0 )
goto V_120;
if ( V_96 [ V_97 ] == NULL )
F_58 ( V_2 ) ;
if ( V_96 [ V_114 ] )
F_52 ( V_2 -> V_121 , V_96 [ V_114 ] , V_105 ) ;
else
snprintf ( V_2 -> V_121 , V_105 , V_22 L_1 ) ;
V_103 = F_59 ( V_2 ) ;
if ( V_103 < 0 )
goto V_122;
F_34 ( V_2 ) ;
