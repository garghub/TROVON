...
if ( V_201 ) {
V_92 = F_36 ( V_201 , V_205 ) ;
if ( V_92 == NULL ) {
V_126 = - V_206 ;
goto exit;
}
memcpy ( V_92 , V_200 , V_201 ) ;
{
int V_37 ;
F_23 ( L_36 , V_201 ) ;
...
V_331 = F_64 ( V_2 , V_333 , V_334 ) ;
} else {
V_331 = F_64 ( V_2 , NULL , 0 ) ;
}
}
if ( ! V_331 )
V_126 = - 1 ;
...
static int F_65 ( struct V_124 * V_125 , struct V_20 * V_233 ,
union V_3 * V_4 , char * V_225 )
{
...
if ( F_67 ( V_2 -> V_231 . V_289 , V_23 -> V_15 . V_66 . V_67 ) >= 0 )
...
{
T_1 V_34 = 0 ;
V_34 = F_74 ( (struct V_1 * ) F_22 ( V_125 ) ) ;
if ( V_34 == 0 )
return - V_237 ;
V_4 -> V_87 . V_88 = 0 ;
...
static int F_90 ( struct V_124 * V_125 ,
struct V_20 * V_21 ,
union V_3 * V_4 , char * V_225 )
{
if ( V_225 ) {
...
static int F_91 ( struct V_124 * V_125 , struct V_20 * V_233 ,
union V_3 * V_4 , char * V_234 )
{
return - 1 ;
}
static int F_92 ( struct V_124 * V_125 , T_4 V_64 , T_3 V_90 )
{
T_5 V_126 = 0 ;
struct V_1 * V_2 = (struct V_1 * ) F_22 ( V_125 ) ;
switch ( V_64 ) {
...
static int F_93 ( struct V_124 * V_125 , T_3 V_437 , T_3 V_324 )
{
int V_126 = 0 ;
struct V_1 * V_2 = (struct V_1 * ) F_22 ( V_125 ) ;
switch ( V_437 ) {
...
static int F_94 ( struct V_124 * V_125 , struct V_389 * V_33 )
{
struct V_143 * V_144 ;
T_5 V_126 = 0 ;
...
if ( F_95 ( V_144 , V_33 -> V_440 , V_33 -> V_49 ) ) {
F_33 ( V_144 ) ;
V_126 = - V_442 ;
goto V_441;
}
switch ( V_144 -> V_43 ) {
case V_443 :
V_126 = F_92 ( V_125 , V_144 -> V_44 . V_444 . V_64 , V_144 -> V_44 . V_444 . V_90 ) ;
break;
case V_445 :
...
break;
case V_446 :
V_126 = F_93 ( V_125 , V_144 -> V_44 . V_326 . V_437 , V_144 -> V_44 . V_326 . V_328 ) ;
break;
default:
...
if ( V_126 == 0 && F_96 ( V_33 -> V_440 , V_144 , V_33 -> V_49 ) )
V_126 = - V_442 ;
F_33 ( V_144 ) ;
V_441:
return V_126 ;
}
static T_4 F_97 ( struct V_1 * V_2 , struct V_179 * V_180 )
{
struct V_447 * V_448 ;
struct V_449 * V_450 ;
struct V_451 * V_452 = & V_2 -> V_453 ;
T_4 V_454 = V_208 ;
V_448 = F_36 ( sizeof( struct V_447 ) , V_205 ) ;
if ( V_448 == NULL ) {
V_454 = V_173 ;
goto exit;
}
V_450 = F_36 ( sizeof( struct V_449 ) , V_205 ) ;
if ( V_450 == NULL ) {
F_33 ( V_448 ) ;
V_454 = V_173 ;
goto exit;
...
int V_454 = V_208 ;
F_23 ( L_57 , V_327 ) ;
V_461 = F_36 ( sizeof( struct V_447 ) , V_205 ) ;
if ( V_461 == NULL ) {
V_454 = V_173 ;
goto exit;
}
V_463 = F_36 ( sizeof( struct V_462 ) , V_205 ) ;
if ( V_463 == NULL ) {
F_33 ( V_461 ) ;
V_454 = V_173 ;
goto exit;
...
if ( ! V_542 )
return - V_206 ;
if ( F_95 ( V_542 , V_543 -> V_440 , V_345 ) ) {
F_132 ( V_542 ) ;
return - V_442 ;
}
...
switch ( V_43 ) {
case V_562 :
V_126 = F_94 ( V_125 , & V_561 -> V_44 . V_47 ) ;
break;
#ifdef F_136
case V_563 :
