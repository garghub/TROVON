...
static void F_85 ( struct V_278 * V_4 )
{
struct V_2 * V_3 = F_86 ( V_4 ) ;
F_87 ( V_3 -> V_29 , 0 ) ;
}
static int F_88 ( struct V_278 * V_4 )
{
struct V_28 * V_29 ;
struct V_2 * V_3 ;
struct V_10 * V_6 ;
struct V_279 * V_280 = V_4 -> V_5 . V_281 ;
if ( ! V_280 )
return - V_282 ;
V_6 = V_280 -> V_6 ;
if ( ! V_6 )
...
F_92 ( & V_3 -> V_159 , F_48 ) ;
F_93 ( V_4 , V_3 ) ;
V_6 -> V_284 [ V_164 ] . V_285 = V_4 ;
V_6 -> V_284 [ V_164 ] . V_286 = F_85 ;
F_94 ( & V_3 -> V_174 ) ;
F_84 ( V_3 ) ;
F_95 ( V_29 ) ;
return 0 ;
}
static int F_96 ( struct V_278 * V_4 )
{
struct V_2 * V_3 = F_86 ( V_4 ) ;
struct V_10 * V_6 ;
struct V_28 * V_29 ;
...
return 0 ;
V_6 = V_3 -> V_6 ;
V_6 -> V_284 [ V_164 ] . V_285 = NULL ;
V_6 -> V_284 [ V_164 ] . V_286 = NULL ;
V_29 = V_3 -> V_29 ;
F_97 ( & V_3 -> V_159 ) ;
F_51 ( & V_3 -> V_174 ) ;
if ( V_3 -> V_31 ) {
