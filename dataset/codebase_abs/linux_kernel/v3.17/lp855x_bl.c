...
static int F_25 ( struct V_76 * V_9 , struct V_82 * V_83 )
{
struct V_35 * V_37 ;
int V_84 ;
if ( ! V_83 ) {
...
V_37 = F_26 ( V_9 , sizeof( * V_37 ) , V_85 ) ;
if ( ! V_37 )
return - V_86 ;
...
struct V_82 * V_89 ;
int V_34 = 0 ;
V_88 = F_26 ( V_9 , sizeof( * V_88 ) * V_84 , V_85 ) ;
if ( ! V_88 )
return - V_86 ;
F_31 (node, child) {
F_28 ( V_89 , L_12 , & V_88 [ V_34 ] . V_10 ) ;
F_28 ( V_89 , L_13 , & V_88 [ V_34 ] . V_33 ) ;
V_34 ++ ;
}
V_37 -> V_48 = V_84 ;
V_37 -> V_49 = & V_88 [ 0 ] ;
...
{
struct V_1 * V_2 ;
struct V_35 * V_37 = F_33 ( & V_92 -> V_9 ) ;
struct V_82 * V_83 = V_92 -> V_9 . V_95 ;
int V_7 ;
if ( ! V_37 ) {
V_7 = F_25 ( & V_92 -> V_9 , V_83 ) ;
if ( V_7 < 0 )
return V_7 ;
V_37 = F_33 ( & V_92 -> V_9 ) ;
}
if ( ! F_34 ( V_92 -> V_96 , V_97 ) )
return - V_98 ;
V_2 = F_26 ( & V_92 -> V_9 , sizeof( struct V_1 ) , V_85 ) ;
if ( ! V_2 )
return - V_86 ;
if ( V_37 -> V_54 > 0 )
V_2 -> V_66 = V_67 ;
