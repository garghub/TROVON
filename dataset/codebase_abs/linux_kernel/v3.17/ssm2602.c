...
static bool F_26 ( struct V_90 * V_80 , unsigned int V_91 )
{
return V_91 == V_79 ;
}
int F_27 ( struct V_90 * V_80 , enum V_92 type ,
struct V_19 * V_19 )
{
struct V_15 * V_16 ;
if ( F_28 ( V_19 ) )
return F_29 ( V_19 ) ;
V_16 = F_30 ( V_80 , sizeof( * V_16 ) , V_93 ) ;
if ( V_16 == NULL )
return - V_94 ;
F_31 ( V_80 , V_16 ) ;
V_16 -> type = type ;
V_16 -> V_19 = V_19 ;
return F_32 ( V_80 , & V_95 ,
& V_96 , 1 ) ;
}
