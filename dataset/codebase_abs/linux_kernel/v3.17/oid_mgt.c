...
memcpy ( V_4 -> V_69 -> V_92 , V_76 -> V_16 , V_93 ) ;
else
V_58 = - V_73 ;
if ( V_76 )
F_21 ( V_76 ) ;
...
if ( F_19 ( V_4 ) < V_95 )
return 0 ;
V_94 = F_29 ( V_4 , V_96 , F_34 ( V_96 ) ) ;
if ( V_4 -> V_97 != V_98 )
V_94 |= F_29 ( V_4 , V_99 , F_34 ( V_99 ) ) ;
V_82 = V_100 ;
V_94 |= F_29 ( V_4 , & V_82 , 1 ) ;
V_94 |= F_32 ( V_4 ) ;
if ( V_94 ) {
...
F_25 ( & V_4 -> V_15 ) ;
V_101 =
F_10 ( * ( V_18 * ) V_4 -> V_6 [ V_102 ] ) ;
F_27 ( & V_4 -> V_15 ) ;
return ( ( V_4 -> V_97 == V_103 ) &&
( V_101 >= V_104 ) ) ;
}
enum V_55
F_36 ( V_18 V_66 )
...
int
F_37 ( enum V_55 V_56 , union V_75 * V_88 , char * V_105 )
{
switch ( V_10 [ V_56 ] . V_11 & V_67 ) {
case V_17 :
return snprintf ( V_105 , V_106 , L_8 , V_88 -> V_82 ) ;
case V_19 : {
struct V_20 * V_21 = V_88 -> V_79 ;
return snprintf ( V_105 , V_106 ,
L_9 , V_21 -> V_13 ,
V_21 -> V_22 ) ;
}
break;
...
int V_5 , V_107 ;
V_107 = snprintf ( V_105 , V_106 , L_13 , V_33 -> V_34 ) ;
for ( V_5 = 0 ; V_5 < V_33 -> V_34 ; V_5 ++ )
V_107 += snprintf ( V_105 + V_107 , V_106 - V_107 ,
L_14
L_11
L_12 ,
...
int V_5 , V_86 ;
F_28 ( L_15 , V_38 -> V_34 ) ;
V_86 = snprintf ( V_105 , V_106 , L_13 , V_38 -> V_34 ) ;
for ( V_5 = 0 ; V_5 < V_38 -> V_34 ; V_5 ++ )
V_86 += snprintf ( V_105 + V_86 , V_106 - V_86 ,
...
break;
case V_51 : {
struct V_108 * V_109 = V_88 -> V_79 ;
return snprintf ( V_105 , V_106 ,
L_21 ,
V_109 -> V_81 , V_109 -> V_81 ,
V_109 -> V_110 ) ;
}
break;
case V_52 : {
struct V_111 * V_112 = V_88 -> V_79 ;
int V_86 , V_5 ;
V_86 = snprintf ( V_105 , V_106 ,
L_22 ,
V_112 -> type , V_112 -> V_81 ) ;
for ( V_5 = 0 ; V_5 < V_112 -> V_81 ; V_5 ++ )
V_86 += snprintf ( V_105 + V_86 , V_106 - V_86 ,
L_23 , V_112 -> V_112 [ V_5 ] ) ;
V_86 += snprintf ( V_105 + V_86 , V_106 - V_86 , L_24 ) ;
return V_86 ;
}
break;
case V_54 :
...
int V_86 , V_5 ;
V_86 = snprintf ( V_105 , V_106 , L_25 ) ;
