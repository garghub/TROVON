...
V_135 = 0 ;
if ( F_75 ( ( V_24 & ( V_139 | V_140 ) ) != 0 ) ) {
if ( F_75 ( ( V_24 & V_140 ) == 0 ) )
F_76 ( V_2 -> V_141 . V_142 ) ;
else
F_76 ( V_2 -> V_141 . error ) ;
V_135 = 1 ;
}
if ( V_24 & V_143 ) {
V_2 -> V_57 &= ~ F_77 ( V_144 ) ;
...
if ( V_151 & V_152 )
continue;
if ( ! ( F_80 ( V_148 , & V_2 -> V_41 ) &&
( ( V_151 & V_153 ) ||
! ( V_151 & V_154 ) ) &&
( V_151 & V_155 ) &&
V_2 -> V_156 [ V_148 ] == 0 ) )
continue;
V_2 -> V_156 [ V_148 ] = V_33 + F_81 ( 25 ) ;
F_82 ( V_148 , & V_2 -> V_42 ) ;
F_34 ( V_2 , L_12 , V_148 + 1 ) ;
F_83 ( & V_54 -> V_116 , V_148 ) ;
F_84 ( & V_54 -> V_157 , V_2 -> V_156 [ V_148 ] ) ;
}
}
if ( F_3 ( ( V_24 & V_158 ) != 0 ) ) {
F_85 ( V_2 , L_13 ) ;
...
struct V_162 V_163 ;
F_44 ( & V_163 ) ;
switch ( F_90 ( V_160 -> V_164 ) ) {
case V_165 :
if ( V_160 -> V_166 > ( 16 * 1024 ) )
return - V_167 ;
default:
if ( ! F_91 ( V_2 , V_160 , & V_163 , V_161 ) )
return - V_168 ;
return F_92 ( V_2 , V_160 , & V_163 , V_161 ) ;
case V_169 :
if ( ! F_91 ( V_2 , V_160 , & V_163 , V_161 ) )
return - V_168 ;
...
return F_94 ( V_2 , V_160 , V_161 ) ;
else
return F_95 ( V_2 , V_160 , V_161 ) ;
}
}
static int F_96 ( struct V_53 * V_54 , struct V_160 * V_160 , int V_24 )
{
struct V_1 * V_2 = F_26 ( V_54 ) ;
struct V_174 * V_93 ;
unsigned long V_114 ;
int V_175 ;
F_73 ( & V_2 -> V_18 , V_114 ) ;
V_175 = F_97 ( V_54 , V_160 , V_24 ) ;
if ( V_175 )
goto V_9;
if ( F_90 ( V_160 -> V_164 ) == V_170 ) {
} else {
V_93 = (struct V_174 * ) V_160 -> V_176 ;
V_93 -> V_177 = 1 ;
switch ( V_93 -> V_103 ) {
case V_104 :
if ( F_90 ( V_160 -> V_164 ) == V_169 )
F_98 ( V_2 , V_93 ) ;
else
F_99 ( V_2 , V_93 ) ;
break;
...
static void
F_101 ( struct V_53 * V_54 , struct V_183 * V_184 )
{
struct V_1 * V_2 = F_26 ( V_54 ) ;
unsigned long V_114 ;
struct V_174 * V_93 ;
...
switch ( V_93 -> V_103 ) {
case V_104 :
F_105 ( ! F_102 ( & V_93 -> V_163 ) ) ;
if ( F_106 ( & V_184 -> V_189 ) != V_190 )
F_99 ( V_2 , V_93 ) ;
else
F_98 ( V_2 , V_93 ) ;
case V_178 :
...
static void
F_110 ( struct V_53 * V_54 , struct V_183 * V_184 )
{
struct V_1 * V_2 = F_26 ( V_54 ) ;
struct V_174 * V_93 ;
int V_195 = F_106 ( & V_184 -> V_189 ) ;
int V_196 = F_111 ( & V_184 -> V_189 ) ;
int V_197 = F_112 ( & V_184 -> V_189 ) ;
unsigned long V_114 ;
...
F_114 ( V_93 -> V_192 . V_199 , V_196 , V_197 , 0 ) ;
V_93 -> V_177 = 1 ;
if ( V_195 == V_198 )
F_99 ( V_2 , V_93 ) ;
else
...
static void F_116 ( struct V_53 * V_54 , struct V_200 * V_199 )
{
struct V_1 * V_2 = F_26 ( V_54 ) ;
F_9 ( & V_2 -> V_18 ) ;
F_117 ( V_199 ) ;
...
int F_118 ( struct V_53 * V_54 , bool V_201 )
{
struct V_1 * V_2 = F_26 ( V_54 ) ;
if ( F_119 ( V_33 , V_2 -> V_32 ) )
F_61 ( 10 ) ;
F_120 ( V_2 , V_201 ) ;
F_9 ( & V_2 -> V_18 ) ;
F_10 ( V_2 , 0 , & V_2 -> V_4 -> V_19 ) ;
( void ) F_2 ( V_2 , & V_2 -> V_4 -> V_19 ) ;
F_121 ( V_202 , & V_54 -> V_114 ) ;
F_12 ( & V_2 -> V_18 ) ;
F_13 ( V_54 -> V_23 ) ;
if ( V_201 && F_122 ( V_54 ) ) {
F_123 ( V_54 , false ) ;
...
int F_123 ( struct V_53 * V_54 , bool V_204 )
{
struct V_1 * V_2 = F_26 ( V_54 ) ;
if ( F_119 ( V_33 , V_2 -> V_32 ) )
F_61 ( 100 ) ;
F_82 ( V_202 , & V_54 -> V_114 ) ;
if ( V_2 -> V_55 )
return 0 ;
...
if ( F_128 () )
return - V_12 ;
F_129 ( V_216 L_18 V_217 L_19 , V_218 ) ;
F_82 ( V_219 , & V_220 ) ;
if ( F_80 ( V_221 , & V_220 ) ||
F_80 ( V_222 , & V_220 ) )
F_129 ( V_223 L_20
