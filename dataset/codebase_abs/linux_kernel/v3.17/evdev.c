...
static int F_81 ( struct V_62 * V_53 , void T_4 * V_91 )
{
struct V_124 V_125 = {
...
int error ;
if ( F_82 ( V_125 . V_127 , V_91 , sizeof( unsigned int ) ) )
return - V_76 ;
error = F_83 ( V_53 , & V_125 ) ;
if ( error )
return error ;
if ( F_84 ( V_125 . V_128 , V_126 + 1 ) )
return - V_76 ;
return 0 ;
}
static int F_85 ( struct V_62 * V_53 , void T_4 * V_91 )
{
struct V_124 V_125 ;
int error ;
if ( F_82 ( & V_125 , V_91 , sizeof( V_125 ) ) )
return - V_76 ;
error = F_83 ( V_53 , & V_125 ) ;
if ( error )
return error ;
if ( F_77 ( V_91 , & V_125 , sizeof( V_125 ) ) )
return - V_76 ;
return 0 ;
}
...
if ( F_82 ( V_125 . V_127 , V_91 , sizeof( unsigned int ) ) )
return - V_76 ;
if ( F_87 ( V_125 . V_128 , V_126 + 1 ) )
return - V_76 ;
return F_88 ( V_53 , & V_125 ) ;
}
static int F_89 ( struct V_62 * V_53 , void T_4 * V_91 )
{
struct V_124 V_125 ;
if ( F_82 ( & V_125 , V_91 , sizeof( V_125 ) ) )
return - V_76 ;
...
int V_129 ;
unsigned long * V_130 ;
V_130 = F_91 ( sizeof( unsigned long ) * F_56 , V_70 ) ;
if ( ! V_130 )
return - V_72 ;
F_68 ( & V_53 -> V_131 ) ;
F_13 ( & V_2 -> V_22 ) ;
memcpy ( V_130 , V_88 , sizeof( unsigned long ) * F_56 ) ;
F_14 ( & V_53 -> V_131 ) ;
F_1 ( V_2 , type ) ;
F_69 ( & V_2 -> V_22 ) ;
V_129 = F_75 ( V_130 , F_56 , V_69 , V_91 , V_92 ) ;
if ( V_129 < 0 )
F_3 ( V_2 ) ;
F_32 ( V_130 ) ;
return V_129 ;
}
static int F_92 ( struct V_62 * V_53 ,
unsigned int V_69 ,
int T_4 * V_126 )
{
...
int V_134 ;
int V_3 ;
if ( F_87 ( V_15 , & V_126 [ 0 ] ) )
return - V_76 ;
if ( ! V_133 || ! F_93 ( V_15 ) )
return - V_55 ;
V_134 = ( V_69 - sizeof( V_135 ) ) / sizeof( V_136 ) ;
for ( V_3 = 0 ; V_3 < V_133 -> V_137 && V_3 < V_134 ; V_3 ++ ) {
int V_17 = F_94 ( & V_133 -> V_138 [ V_3 ] , V_15 ) ;
if ( F_84 ( V_17 , & V_126 [ 1 + V_3 ] ) )
return - V_76 ;
}
return 0 ;
}
static int F_95 ( struct V_32 * V_32 , struct V_1 * V_2 ,
struct V_44 * V_44 )
{
V_2 -> V_35 = true ;
F_36 ( V_32 , V_2 ) ;
...
static long F_96 ( struct V_44 * V_44 , unsigned int V_139 ,
void T_4 * V_91 , int V_97 )
{
struct V_1 * V_2 = V_44 -> V_46 ;
struct V_32 * V_32 = V_2 -> V_32 ;
...
switch ( V_139 ) {
case V_145 :
return F_84 ( V_146 , V_126 ) ;
case V_147 :
if ( F_77 ( V_91 , & V_53 -> V_47 , sizeof( struct V_148 ) ) )
return - V_76 ;
return 0 ;
case V_149 :
if ( ! F_97 ( V_150 , V_53 -> V_98 ) )
return - V_151 ;
if ( F_84 ( V_53 -> V_152 [ V_153 ] , V_126 ) )
return - V_76 ;
if ( F_84 ( V_53 -> V_152 [ V_154 ] , V_126 + 1 ) )
return - V_76 ;
return 0 ;
case V_155 :
if ( ! F_97 ( V_150 , V_53 -> V_98 ) )
...
if ( F_87 ( V_144 , V_126 ) )
return - V_76 ;
if ( F_87 ( V_33 , V_126 + 1 ) )
return - V_76 ;
F_66 ( & V_32 -> V_38 , V_150 , V_153 , V_144 ) ;
F_66 ( & V_32 -> V_38 , V_150 , V_154 , V_33 ) ;
return 0 ;
case V_156 :
return F_98 ( V_53 , ( int ) ( unsigned long ) V_91 , V_44 ) ;
case V_157 :
V_3 = F_97 ( V_118 , V_53 -> V_98 ) ?
V_53 -> V_158 -> V_159 : 0 ;
if ( F_84 ( V_3 , V_126 ) )
return - V_76 ;
return 0 ;
...
return F_95 ( V_32 , V_2 , V_44 ) ;
case V_162 :
if ( F_82 ( & V_3 , V_91 , sizeof( unsigned int ) ) )
return - V_76 ;
...
return 0 ;
case V_164 :
return F_81 ( V_53 , V_91 ) ;
case V_165 :
return F_86 ( V_53 , V_91 ) ;
case V_166 :
return F_85 ( V_53 , V_91 ) ;
case V_167 :
return F_89 ( V_53 , V_91 ) ;
}
V_69 = F_99 ( V_139 ) ;
#define F_100 ( T_8 ) ((nr) & ~(_IOC_SIZEMASK << _IOC_SIZESHIFT))
switch ( F_100 ( V_139 ) ) {
case F_101 ( 0 ) :
return F_75 ( V_53 -> V_168 , V_169 ,
V_69 , V_91 , V_97 ) ;
case F_102 ( 0 ) :
return F_92 ( V_53 , V_69 , V_126 ) ;
case F_103 ( 0 ) :
return F_90 ( V_2 , V_53 , V_100 , V_53 -> V_170 ,
V_102 , V_69 , V_91 , V_97 ) ;
case F_104 ( 0 ) :
return F_90 ( V_2 , V_53 , V_112 , V_53 -> V_171 ,
V_114 , V_69 , V_91 , V_97 ) ;
case F_105 ( 0 ) :
return F_90 ( V_2 , V_53 , V_115 , V_53 -> V_172 ,
V_117 , V_69 , V_91 , V_97 ) ;
case F_106 ( 0 ) :
return F_90 ( V_2 , V_53 , V_121 , V_53 -> V_173 ,
V_123 , V_69 , V_91 , V_97 ) ;
case F_107 ( 0 ) :
return F_79 ( V_53 -> V_174 , V_69 , V_91 ) ;
case F_108 ( 0 ) :
return F_79 ( V_53 -> V_175 , V_69 , V_91 ) ;
case F_109 ( 0 ) :
return F_79 ( V_53 -> V_176 , V_69 , V_91 ) ;
case F_100 ( V_177 ) :
if ( F_110 ( V_91 , V_69 , & V_142 ) )
return - V_76 ;
error = F_111 ( V_53 , & V_142 , V_44 ) ;
if ( error )
return error ;
if ( F_84 ( V_142 . V_47 , & ( ( (struct V_141 T_4 * ) V_91 ) -> V_47 ) ) )
return - V_76 ;
return 0 ;
}
if ( F_112 ( V_139 ) != 'E' )
return - V_55 ;
if ( F_113 ( V_139 ) == V_178 ) {
if ( ( F_114 ( V_139 ) & ~ V_99 ) == F_114 ( F_115 ( 0 , 0 ) ) )
return F_80 ( V_53 ,
F_114 ( V_139 ) & V_99 , V_69 ,
V_91 , V_97 ) ;
if ( ( F_114 ( V_139 ) & ~ V_108 ) == F_114 ( F_116 ( 0 ) ) ) {
if ( ! V_53 -> V_179 )
return - V_55 ;
V_143 = F_114 ( V_139 ) & V_108 ;
abs = V_53 -> V_179 [ V_143 ] ;
if ( F_77 ( V_91 , & abs , F_117 ( T_5 ,
V_69 , sizeof( struct V_140 ) ) ) )
return - V_76 ;
return 0 ;
}
}
if ( F_113 ( V_139 ) == V_180 ) {
if ( ( F_114 ( V_139 ) & ~ V_108 ) == F_114 ( F_118 ( 0 ) ) ) {
if ( ! V_53 -> V_179 )
return - V_55 ;
V_143 = F_114 ( V_139 ) & V_108 ;
if ( F_82 ( & abs , V_91 , F_117 ( T_5 ,
V_69 , sizeof( struct V_140 ) ) ) )
return - V_76 ;
...
static long F_119 ( struct V_44 * V_44 , unsigned int V_139 ,
void T_4 * V_91 , int V_97 )
{
struct V_1 * V_2 = V_44 -> V_46 ;
struct V_32 * V_32 = V_2 -> V_32 ;
...
V_48 = F_96 ( V_44 , V_139 , V_91 , V_97 ) ;
V_75:
F_28 ( & V_32 -> V_49 ) ;
return V_48 ;
}
static long F_120 ( struct V_44 * V_44 , unsigned int V_139 , unsigned long V_183 )
{
return F_119 ( V_44 , V_139 , ( void T_4 * ) V_183 , 0 ) ;
}
static long F_121 ( struct V_44 * V_44 ,
unsigned int V_139 , unsigned long V_183 )
{
return F_119 ( V_44 , V_139 , F_122 ( V_183 ) , 1 ) ;
}
...
static int F_126 ( struct V_184 * V_185 , struct V_62 * V_53 ,
...
V_188 -= V_189 ;
F_132 ( & V_32 -> V_53 , L_2 , V_188 ) ;
V_32 -> V_38 . V_53 = F_133 ( V_53 ) ;
V_32 -> V_38 . V_174 = F_134 ( & V_32 -> V_53 ) ;
V_32 -> V_38 . V_185 = V_185 ;
V_32 -> V_38 . V_39 = V_32 ;
V_32 -> V_53 . V_192 = F_135 ( V_193 , V_187 ) ;
V_32 -> V_53 . V_194 = & V_195 ;
V_32 -> V_53 . V_196 = & V_53 -> V_53 ;
V_32 -> V_53 . V_197 = F_29 ;
F_136 ( & V_32 -> V_53 ) ;
error = F_137 ( & V_32 -> V_38 ) ;
if ( error )
goto V_198;
F_138 ( & V_32 -> V_68 , & V_199 ) ;
V_32 -> V_68 . V_200 . V_196 = & V_32 -> V_53 . V_200 ;
error = F_139 ( & V_32 -> V_68 , V_32 -> V_53 . V_192 , 1 ) ;
if ( error )
goto V_201;
error = F_140 ( & V_32 -> V_53 ) ;
if ( error )
goto V_202;
return 0 ;
V_202:
