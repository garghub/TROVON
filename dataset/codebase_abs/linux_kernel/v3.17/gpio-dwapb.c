...
int V_55 ;
unsigned int V_11 = 0 ;
V_9 = F_52 ( & V_99 -> V_38 , sizeof( * V_9 ) , V_103 ) ;
if ( ! V_9 )
return - V_104 ;
V_9 -> V_38 = & V_99 -> V_38 ;
V_9 -> V_97 = F_53 ( V_99 -> V_38 . V_50 ) ;
if ( ! V_9 -> V_97 ) {
V_55 = - V_39 ;
goto V_105;
}
V_9 -> V_15 = F_52 ( & V_99 -> V_38 , V_9 -> V_97 *
sizeof( * V_9 -> V_15 ) , V_103 ) ;
if ( ! V_9 -> V_15 ) {
V_55 = - V_104 ;
goto V_105;
}
V_101 = F_54 ( V_99 , V_106 , 0 ) ;
V_9 -> V_13 = F_55 ( & V_99 -> V_38 , V_101 ) ;
if ( F_56 ( V_9 -> V_13 ) ) {
V_55 = F_57 ( V_9 -> V_13 ) ;
goto V_105;
}
F_58 (pdev->dev.of_node, np) {
