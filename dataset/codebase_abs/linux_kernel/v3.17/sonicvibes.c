...
return - V_56 ;
V_67 = V_2 -> V_67 ;
strcpy ( V_67 -> V_159 , L_3 ) ;
for ( V_158 = 0 ; V_158 < F_74 ( V_160 ) ; V_158 ++ ) {
if ( ( V_115 = F_75 ( V_67 , V_157 = F_76 ( & V_160 [ V_158 ] , V_2 ) ) ) < 0 )
return V_115 ;
switch ( V_158 ) {
case 0 :
...
F_84 ( V_172 , L_30 ) ;
F_85 ( V_172 , L_31 , F_86 ( V_2 -> V_123 ) ) ;
F_87 ( V_172 , & V_2 -> V_123 -> V_68 ) ;
V_172 -> V_174 = V_2 -> V_175 ;
F_88 ( V_172 ) ;
F_75 ( V_2 -> V_67 , F_76 ( & V_176 , V_2 ) ) ;
return 0 ;
}
...
static inline int F_82 ( struct V_1 * V_2 ) { return - V_177 ; }
static inline void F_89 ( struct V_1 * V_2 ) { }
static int F_91 ( struct V_1 * V_2 )
{
F_89 ( V_2 ) ;
F_92 ( V_2 -> V_123 , 0x40 , V_2 -> V_5 ) ;
F_92 ( V_2 -> V_123 , 0x48 , V_2 -> V_9 ) ;
if ( V_2 -> V_57 >= 0 )
F_93 ( V_2 -> V_57 , V_2 ) ;
F_94 ( V_2 -> V_178 ) ;
F_94 ( V_2 -> V_179 ) ;
...
static int F_98 ( struct V_180 * V_112 )
{
struct V_1 * V_2 = V_112 -> V_181 ;
return F_91 ( V_2 ) ;
}
static int F_99 ( struct V_156 * V_67 ,
struct V_182 * V_123 ,
int V_183 ,
int V_184 ,
struct V_1 * * V_185 )
...
* V_185 = NULL ;
if ( ( V_115 = F_100 ( V_123 ) ) < 0 )
return V_115 ;
if ( F_101 ( V_123 , F_102 ( 24 ) ) < 0 ||
F_103 ( V_123 , F_102 ( 24 ) ) < 0 ) {
F_29 ( V_67 -> V_68 ,
L_32 ) ;
F_96 ( V_123 ) ;
return - V_191 ;
}
V_2 = F_104 ( sizeof( * V_2 ) , V_192 ) ;
if ( V_2 == NULL ) {
F_96 ( V_123 ) ;
return - V_173 ;
}
...
V_2 -> V_123 = V_123 ;
V_2 -> V_57 = - 1 ;
if ( ( V_115 = F_106 ( V_123 , L_3 ) ) < 0 ) {
F_97 ( V_2 ) ;
F_96 ( V_123 ) ;
return V_115 ;
}
V_2 -> V_193 = F_107 ( V_123 , 0 ) ;
V_2 -> V_194 = F_107 ( V_123 , 1 ) ;
V_2 -> V_195 = F_107 ( V_123 , 2 ) ;
V_2 -> V_196 = F_107 ( V_123 , 3 ) ;
V_2 -> V_175 = F_107 ( V_123 , 4 ) ;
if ( F_108 ( V_123 -> V_57 , F_28 , V_197 ,
V_198 , V_2 ) ) {
...
V_2 -> V_57 = V_123 -> V_57 ;
F_109 ( V_123 , 0x40 , & V_186 ) ;
F_109 ( V_123 , 0x48 , & V_187 ) ;
V_200 &= ~ 0x0f ;
V_186 &= ~ 0x0f ;
V_187 &= ~ 0x0f ;
if ( ! V_186 ) {
...
F_92 ( V_123 , 0x40 , V_186 ) ;
F_92 ( V_123 , 0x48 , V_187 ) ;
if ( ( V_2 -> V_178 = F_111 ( V_186 , 0x10 , L_36 ) ) == NULL ) {
F_91 ( V_2 ) ;
F_29 ( V_67 -> V_68 ,
L_37 ,
V_186 , V_186 + 0x10 - 1 ) ;
...
if ( ( V_2 -> V_179 = F_111 ( V_187 , 0x10 , L_38 ) ) == NULL ) {
F_91 ( V_2 ) ;
F_29 ( V_67 -> V_68 ,
L_39 ,
V_187 , V_187 + 0x10 - 1 ) ;
...
F_109 ( V_123 , 0x40 , & V_2 -> V_5 ) ;
F_109 ( V_123 , 0x48 , & V_2 -> V_9 ) ;
V_2 -> V_5 &= ~ 0x0f ;
V_2 -> V_9 &= ~ 0x0f ;
F_92 ( V_123 , 0x40 , V_2 -> V_5 | 9 ) ;
F_92 ( V_123 , 0x48 , V_2 -> V_9 | 9 ) ;
F_3 ( V_201 , F_9 ( V_2 , V_202 ) ) ;
F_10 ( 100 ) ;
F_3 ( 0 , F_9 ( V_2 , V_202 ) ) ;
F_10 ( 100 ) ;
F_3 ( V_203 | V_204 | ( V_183 ? V_205 : 0 ) , F_9 ( V_2 , V_202 ) ) ;
F_15 ( F_9 ( V_2 , V_60 ) ) ;
#if 1
F_11 ( V_2 , V_206 , 0 ) ;
#else
...
F_3 ( V_2 -> V_65 = ~ ( V_207 | V_208 | V_209 ) , F_9 ( V_2 , V_66 ) ) ;
F_15 ( F_9 ( V_2 , V_60 ) ) ;
F_11 ( V_2 , V_36 , 0 ) ;
F_11 ( V_2 , V_210 , 0 ) ;
F_11 ( V_2 , V_211 , 0 ) ;
F_19 ( V_2 , V_34 , 8000 ) ;
F_11 ( V_2 , V_212 , V_2 -> V_167 = 0x80 ) ;
F_11 ( V_2 , V_213 , V_2 -> V_168 = 0x00 ) ;
F_11 ( V_2 , V_214 , V_2 -> V_170 = 0x05 ) ;
F_11 ( V_2 , V_215 , V_2 -> V_169 = 0x00 ) ;
F_11 ( V_2 , V_48 , ( 8000 * 65536 / V_46 ) & 0xff ) ;
F_11 ( V_2 , V_47 , ( ( 8000 * 65536 / V_46 ) >> 8 ) & 0xff ) ;
F_11 ( V_2 , V_135 , V_184 ? 0xd0 : 0xc0 ) ;
F_11 ( V_2 , V_137 , 0xc0 ) ;
F_11 ( V_2 , V_216 , 0x9f ) ;
F_11 ( V_2 , V_217 , 0x9f ) ;
F_11 ( V_2 , V_218 , 0x9f ) ;
...
#endif
V_2 -> V_230 = F_16 ( V_2 , V_231 ) ;
if ( ( V_115 = F_112 ( V_67 , V_232 , V_2 , & V_189 ) ) < 0 ) {
F_91 ( V_2 ) ;
return V_115 ;
}
F_79 ( V_2 ) ;
...
static int F_113 ( struct V_233 * V_234 )
{
struct V_1 * V_2 = V_234 -> V_74 ;
F_3 ( V_2 -> V_65 &= ~ V_235 , F_9 ( V_2 , V_66 ) ) ;
return 0 ;
}
static void F_114 ( struct V_233 * V_234 )
{
struct V_1 * V_2 = V_234 -> V_74 ;
F_3 ( V_2 -> V_65 |= V_235 , F_9 ( V_2 , V_66 ) ) ;
}
...
struct V_236 * V_73 )
{
struct V_233 * V_234 = V_73 -> V_74 ;
struct V_156 * V_67 = V_2 -> V_67 ;
struct V_237 * V_238 ;
unsigned int V_158 ;
int V_115 ;
V_234 -> V_74 = V_2 ;
V_234 -> V_239 = F_113 ;
V_234 -> V_240 = F_114 ;
V_238 = & V_73 -> V_241 [ V_242 ] ;
for ( V_158 = 0 ; V_158 < F_74 ( V_243 ) ; V_158 ++ )
if ( ( V_115 = F_75 ( V_67 , F_76 ( & V_243 [ V_158 ] , V_2 ) ) ) < 0 )
return V_115 ;
return 0 ;
}
static int F_116 ( struct V_182 * V_123 ,
...
V_115 = F_117 ( & V_123 -> V_68 , V_252 [ V_68 ] , V_87 [ V_68 ] , V_253 ,
0 , & V_67 ) ;
if ( V_115 < 0 )
return V_115 ;
for ( V_158 = 0 ; V_158 < 5 ; V_158 ++ ) {
if ( F_107 ( V_123 , V_158 ) == 0 ||
! ( F_118 ( V_123 , V_158 ) & V_254 ) ) {
F_119 ( V_67 ) ;
return - V_250 ;
}
}
if ( ( V_115 = F_99 ( V_67 , V_123 ,
V_183 [ V_68 ] ? 1 : 0 ,
V_184 [ V_68 ] ? 1 : 0 ,
& V_2 ) ) < 0 ) {
F_119 ( V_67 ) ;
...
strcpy ( V_67 -> V_255 , L_40 ) ;
strcpy ( V_67 -> V_256 , L_3 ) ;
sprintf ( V_67 -> V_257 , L_41 ,
V_67 -> V_256 ,
V_2 -> V_230 ,
( unsigned long long ) F_107 ( V_123 , 1 ) ,
V_2 -> V_57 ) ;
...
F_115 ( V_2 , V_246 ) ;
if ( ( V_115 = F_121 ( V_67 , V_2 -> V_195 ,
V_2 -> V_195 + 2 ,
V_261 , 1 , & V_248 ) ) < 0 ) {
F_119 ( V_67 ) ;
return V_115 ;
}
if ( ( V_115 = F_122 ( V_248 , 0 , 1 , NULL ) ) < 0 ) {
F_119 ( V_67 ) ;
return V_115 ;
}
F_82 ( V_2 ) ;
if ( ( V_115 = F_123 ( V_67 ) ) < 0 ) {
F_119 ( V_67 ) ;
return V_115 ;
}
F_124 ( V_123 , V_67 ) ;
...
static void F_125 ( struct V_182 * V_123 )
{
F_119 ( F_126 ( V_123 ) ) ;
}
