...
static int F_428 ( struct V_1405 * V_1406 )
{
V_1406 -> V_1410 = 1 ;
return 0 ;
}
static void F_429 ( struct V_1405 * V_1406 )
{
F_430 ( V_1406 , 1 ) ;
}
static int F_431 ( struct V_1405 * V_1406 , int V_759 ,
int V_1412 )
{
if ( ! V_1413 )
return - V_1414 ;
return F_432 ( V_1406 , V_759 , V_1412 ) ;
}
...
do {
V_1418 = (struct V_954 * ) F_174 ( V_955 ) ;
if ( V_1418 == NULL ) {
V_1417 ++ ;
break;
}
...
static int F_436 ( struct V_9 * V_10 ,
struct F_65 * V_1423 ,
...
int V_746 = 0 ;
struct V_628 * V_955 ;
for ( V_1424 = 0 ; V_1424 < V_10 -> V_574 -> V_1069 ; V_1424 ++ ) {
V_955 = F_223 ( V_10 -> V_574 , V_1424 ) ;
if ( V_955 && V_1423 == F_65 ( V_955 -> V_295 ) &&
...
static int F_437 ( struct V_628 * V_955 )
{
struct V_9 * V_10 = F_2 ( V_955 -> V_295 -> V_574 ) ;
unsigned int V_1425 = V_955 -> V_295 -> V_1425 ;
T_7 V_1426 = V_955 -> V_295 -> V_1426 ;
unsigned long V_289 ;
struct V_954 * V_954 = NULL ;
int V_277 = V_1420 ;
int V_1082 = 0 ;
F_4 ( V_25 , V_10 , L_266 ,
V_10 -> V_576 , V_1425 , V_1426 , V_955 , V_955 -> V_1427 [ 0 ] ) ;
F_66 ( & V_10 -> V_781 , V_289 ) ;
V_954 = (struct V_954 * ) F_174 ( V_955 ) ;
if ( ! V_954 ) {
F_67 ( & V_10 -> V_781 , V_289 ) ;
F_4 ( V_25 , V_10 , L_267 ,
V_10 -> V_576 , V_1425 , V_1426 ) ;
return V_1420 ;
}
F_438 ( & V_954 -> V_957 ) ;
F_67 ( & V_10 -> V_781 , V_289 ) ;
if ( F_439 ( V_10 , V_954 ) != V_41 ) {
F_137 ( F_113 ( L_268 ,
V_10 -> V_576 , V_1425 , V_1426 ) ) ;
V_277 = V_1428 ;
} else {
...
F_4 ( V_25 , V_10 ,
L_271 ,
V_10 -> V_576 , V_1425 , V_1426 , ( V_277 == V_1420 ) ? L_272 : L_273 ) ;
return V_277 ;
}
static int F_440 ( struct V_628 * V_955 )
{
struct V_9 * V_10 = F_2 ( V_955 -> V_295 -> V_574 ) ;
struct V_301 * V_301 = V_955 -> V_295 -> V_963 ;
...
V_1429 = F_442 ( V_10 , V_301 , V_955 -> V_295 -> V_1426 ) ;
if ( V_1429 != V_41 ) {
F_4 ( V_25 , V_10 , L_277 , V_1429 ) ;
goto V_1434;
}
if ( F_436 ( V_10 , F_65 ( V_955 -> V_295 ) ,
V_955 -> V_295 ) ) {
F_4 ( V_25 , V_10 ,
L_278
L_279 ) ;
...
if ( F_443 ( V_10 , V_301 , V_955 -> V_295 -> V_1426 ,
V_1435 ) != V_41 )
goto V_1434;
F_4 ( V_25 , V_10 ,
L_280 ,
V_10 -> V_576 , V_955 -> V_295 -> V_1430 , V_955 -> V_295 -> V_1425 ,
V_955 -> V_295 -> V_1426 ) ;
V_277 = V_1420 ;
V_1434:
return V_277 ;
}
static int F_444 ( struct V_628 * V_955 )
{
struct V_9 * V_10 = F_2 ( V_955 -> V_295 -> V_574 ) ;
struct V_301 * V_301 = V_955 -> V_295 -> V_963 ;
int V_1429 , V_277 ;
...
if ( V_277 )
return V_277 ;
F_445 ( V_25 , F_65 ( V_955 -> V_295 ) ,
L_281 ) ;
F_3 ( F_113 ( V_25
L_282
L_283 ,
V_10 -> V_576 , V_955 , V_778 , V_955 -> V_1431 -> V_1432 / V_722 ,
V_10 -> V_972 , V_955 -> V_966 , V_955 -> V_1433 ) ) ;
V_1429 = F_446 ( V_10 , V_301 ) ;
if ( V_1429 != V_41 ) {
F_445 ( V_25 , F_65 ( V_955 -> V_295 ) ,
L_284 ) ;
return V_1428 ;
...
static int F_448 ( struct V_628 * V_955 )
{
int V_1439 = V_1428 ;
struct V_9 * V_10 ;
...
F_3 ( F_113 ( L_163 ,
V_10 -> V_576 , V_26 ) ) ;
if ( F_447 ( V_955 -> V_295 -> V_574 ) )
F_232 ( V_10 , V_1440 << 16 ) ;
return V_1428 ;
}
F_4 ( V_25 , V_10 ,
L_289 , V_10 -> V_576 ,
...
if ( F_435 ( V_10 ) != V_41 ) {
F_3 ( F_113 ( L_290
L_291 , V_10 -> V_576 , V_955 -> V_295 -> V_1430 ,
V_26 ) ) ;
return V_1428 ;
}
if ( ! F_55 ( V_974 , & V_10 -> V_972 ) ) {
...
T_1 V_1441 = sizeof( struct V_697 ) ;
int V_18 = V_41 ;
T_4 V_1442 ;
...
memset ( V_698 , 0 , V_1441 ) ;
V_18 = F_450 ( V_10 , V_1442 , V_1444 , V_1441 ) ;
if ( V_18 != V_41 ) {
V_18 = - V_336 ;
goto V_1445;
}
...
F_93 ( & V_10 -> V_720 ,
V_721 * V_722 ) ;
V_18 = F_94 ( V_10 , & V_715 [ 0 ] , & V_717 [ 0 ] , V_1442 ) ;
if ( V_18 != V_41 ) {
V_18 = - V_336 ;
goto V_1445;
}
...
static int F_451 ( struct V_1 * V_2 , int V_1446 )
{
struct V_9 * V_10 = F_2 ( V_2 ) ;
int V_18 = V_41 ;
T_1 V_1039 ;
...
static T_10
F_453 ( struct V_1144 * V_249 , T_11 V_633 )
{
...
static T_1 F_456 ( struct V_9 * V_10 )
{
T_1 V_18 = V_261 ;
int V_1395 ;
struct V_1144 * V_1394 = NULL ;
...
static int T_12 F_464 ( void )
{
int V_277 ;
V_1015 = F_465 ( L_316 , sizeof( struct V_954 ) , 0 ,
V_1464 , NULL ) ;
if ( V_1015 == NULL ) {
F_113 ( V_252
L_317
