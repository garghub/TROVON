...
struct V_281 T_3 * V_282 )
{
struct V_187 T_3 * V_113 ;
T_8 V_283 ;
V_113 = F_171 ( sizeof( * V_113 ) ) ;
if ( F_172 ( V_113 , V_282 , ( sizeof( * V_282 ) - sizeof( V_284 ) ) ) ||
F_90 ( V_283 , & V_282 -> V_70 ) ||
F_159 ( F_173 ( V_283 ) , & V_113 -> V_70 ) )
return - V_37 ;
return F_109 ( V_8 , V_113 ) ;
}
static int F_174 ( struct V_7 * V_8 ,
struct V_285 T_3 * V_282 )
{
struct V_202 T_3 * V_113 ;
T_9 V_286 ;
V_284 V_272 ;
V_113 = F_171 ( sizeof( * V_113 ) ) ;
if ( F_90 ( V_286 , & V_282 -> V_74 ) || F_159 ( V_286 , & V_113 -> V_74 ) ||
F_90 ( V_286 , & V_282 -> V_25 ) || F_159 ( V_286 , & V_113 -> V_25 ) ||
F_90 ( V_286 , & V_282 -> V_198 ) || F_159 ( V_286 , & V_113 -> V_198 ) ||
F_90 ( V_272 , & V_282 -> V_70 ) || F_159 ( F_173 ( V_272 ) , & V_113 -> V_70 ) )
return - V_37 ;
...
{
struct V_287 V_288 ;
if ( F_110 ( & V_288 , V_186 , sizeof( V_288 ) ) )
return - V_37 ;
V_8 -> V_182 = V_288 . V_97 ;
V_8 -> V_184 = F_173 ( V_288 . V_93 ) ;
return 0 ;
}
static int F_176 ( struct V_227 * V_289 ,
struct V_290 T_3 * V_228 )
{
T_8 V_291 ;
if ( ! F_112 ( V_256 , V_228 , sizeof( * V_228 ) ) ||
F_177 ( V_289 -> type , & V_228 -> type ) ||
F_177 ( V_289 -> V_141 , & V_228 -> V_141 ) ||
F_177 ( V_289 -> V_98 , & V_228 -> V_98 ) ||
F_177 ( V_289 -> V_58 , & V_228 -> V_58 ) ||
F_177 ( V_289 -> V_243 , & V_228 -> V_243 ) ||
F_177 ( V_289 -> V_86 , & V_228 -> V_86 ) ||
F_177 ( V_289 -> V_265 , & V_228 -> V_265 ) ||
F_177 ( V_289 -> V_84 , & V_228 -> V_84 ) ||
F_177 ( V_289 -> V_274 , & V_228 -> V_274 ) ||
F_177 ( V_289 -> V_97 , & V_228 -> V_97 ) )
return - V_37 ;
if ( F_177 ( V_291 , & V_228 -> V_244 ) )
return - V_37 ;
V_289 -> V_244 = F_173 ( V_291 ) ;
if ( F_177 ( V_291 , & V_228 -> V_292 ) )
return - V_37 ;
V_289 -> V_292 = F_173 ( V_291 ) ;
return 0 ;
}
static int F_178 ( struct V_7 * V_8 , void T_3 * V_186 )
{
struct V_227 V_228 ;
if ( F_176 ( & V_228 , (struct V_290 T_3 * ) V_186 ) )
return - V_37 ;
return F_140 ( V_8 , & V_228 ,
( (struct V_290 T_3 * ) V_186 ) -> V_230 ,
V_186 ) ;
}
static int F_179 ( struct V_46 * V_48 , void T_3 * T_3 * V_186 )
{
struct V_50 * V_50 = V_48 -> V_50 ;
struct V_290 T_3 * V_64 = V_48 -> V_64 ;
void T_3 * V_272 = V_48 -> V_64 ;
unsigned int V_27 ;
if ( V_48 -> V_83 && V_50 -> V_86 ) {
if ( F_47 ( V_48 -> V_83 , V_50 ) )
...
static int F_186 ( struct V_7 * V_8 , struct V_294 * V_295 )
{
int V_81 ;
void * V_20 = NULL ;
int V_277 = 0 ;
struct V_116 * V_117 = NULL ;
struct V_296 * V_211 = NULL ;
if ( ( V_81 = F_187 ( V_295 -> V_297 ) ) > 0 ) {
V_20 = F_91 ( V_81 , V_49 ) ;
if ( V_20 == NULL )
return - V_6 ;
if ( ( F_188 ( V_295 -> V_297 ) & V_298 ) ) {
if ( F_110 ( V_20 , V_295 -> V_70 , V_81 ) ) {
F_23 ( V_20 ) ;
return - V_37 ;
}
} else {
...
if ( V_8 -> V_10 -> V_11 != V_125 )
V_277 = - V_126 ;
else if ( ! ( V_117 = F_77 ( V_8 -> V_10 , V_295 -> V_299 ) ) )
V_277 = - V_19 ;
else switch ( V_295 -> V_297 ) {
case V_300 :
if ( V_117 -> V_10 . V_211 ) {
...
if ( V_117 -> V_10 . V_211 )
V_211 = F_189 ( V_117 -> V_10 . V_211 ) ;
if ( V_211 == NULL || V_211 -> V_302 == NULL ) {
V_277 = - V_303 ;
} else {
V_277 = V_211 -> V_302 ( V_117 , V_295 -> V_297 , V_20 ) ;
if ( V_277 == - V_304 )
V_277 = - V_303 ;
}
}
if ( V_277 >= 0
&& ( F_188 ( V_295 -> V_297 ) & V_305 ) != 0
&& V_81 > 0
&& F_16 ( V_295 -> V_70 , V_20 , V_81 ) != 0 )
V_277 = - V_37 ;
F_23 ( V_20 ) ;
return V_277 ;
}
...
{
struct V_306 T_3 * V_307 ;
struct V_294 V_188 ;
T_6 V_283 ;
V_307 = F_173 ( ( long ) V_186 ) ;
if ( ! F_112 ( V_256 , V_307 , sizeof( * V_307 ) ) ||
F_177 ( V_188 . V_299 , & V_307 -> V_299 ) ||
F_177 ( V_188 . V_297 , & V_307 -> V_297 ) ||
F_177 ( V_283 , & V_307 -> V_70 ) )
return - V_37 ;
V_188 . V_70 = F_173 ( V_283 ) ;
return F_186 ( V_8 , & V_188 ) ;
}
...
unsigned V_308 ;
int V_309 ;
if ( F_90 ( V_308 , ( unsigned T_3 * ) V_186 ) )
return - V_37 ;
V_309 = F_195 ( V_8 -> V_10 , V_308 , V_8 ) ;
if ( V_309 == 0 )
F_57 ( & V_8 -> V_10 -> V_10 , L_33 ,
V_308 , F_84 ( V_127 ) , V_127 -> V_128 ) ;
return V_309 ;
}
...
if ( F_90 ( V_308 , ( unsigned T_3 * ) V_186 ) )
return - V_37 ;
return F_197 ( V_8 -> V_10 , V_308 , V_8 ) ;
}
...
return - V_19 ;
if ( V_117 -> V_10 . V_211 ) {
struct V_296 * V_211 = F_189 ( V_117 -> V_10 . V_211 ) ;
if ( ( V_317 . V_58 & V_318 ) &&
