...
V_2 = F_51 ( & V_130 -> V_15 , sizeof( * V_2 ) , V_146 ) ;
if ( ! V_2 ) {
...
V_2 = F_51 ( & V_162 -> V_15 , sizeof( * V_2 ) , V_146 ) ;
if ( ! V_2 ) {
...
V_2 -> V_15 = & V_162 -> V_15 ;
V_2 -> V_5 = V_163 ;
V_2 -> V_61 . V_141 = V_155 -> V_141 ? : F_65 ( & V_162 -> V_15 ) ;
V_2 -> V_7 . V_8 = & F_62 ;
return F_36 ( V_2 ) ;
}
static int F_66 ( struct V_161 * V_162 )
{
struct V_1 * V_2 = F_67 ( V_162 ) ;
F_41 ( V_2 ) ;
return 0 ;
}
