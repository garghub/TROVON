...
static int F_40 ( struct V_218 * V_219 , int V_244 ,
...
static int F_41 ( struct V_218 * V_219 , unsigned int V_248 )
{
struct V_107 * V_108 = V_219 -> V_108 ;
unsigned int V_221 = 0 ;
unsigned int V_223 = 0 ;
...
static int F_42 ( struct V_218 * V_219 , unsigned int V_270 ,
...
static int F_43 ( struct V_279 * V_280 , unsigned int V_281 ,
unsigned int V_282 )
{
T_1 V_283 ;
...
static int F_47 ( struct V_218 * V_219 , int V_297 , int V_298 ,
...
static int F_48 ( struct V_218 * V_318 , int V_319 )
{
...
break;
case V_330 :
if ( V_108 -> V_198 . V_331 == V_332 ) {
V_162 = F_51 ( F_17 ( V_110 -> V_333 ) ,
V_110 -> V_333 ) ;
if ( V_162 != 0 ) {
F_8 ( V_108 -> V_2 ,
L_30 ,
...
F_6 ( V_108 , V_13 ,
V_335 , 0 ) ;
F_52 ( V_110 -> V_334 , true ) ;
F_54 ( V_110 -> V_334 ) ;
F_55 ( F_17 ( V_110 -> V_333 ) ,
V_110 -> V_333 ) ;
F_56 ( V_110 -> V_324 ) ;
break;
}
V_108 -> V_198 . V_331 = V_322 ;
return 0 ;
}
...
F_15 ,
F_14 ) ;
int V_162 , V_129 , V_340 ;
const char * * V_341 ;
V_110 -> V_147 = 0 ;
V_110 -> V_153 = NULL ;
for ( V_129 = 0 ; V_129 < V_127 -> V_150 ; V_129 ++ ) {
for ( V_340 = 0 ; V_340 < V_110 -> V_147 ; V_340 ++ ) {
if ( strcmp ( V_127 -> V_151 [ V_129 ] . V_152 ,
V_110 -> V_153 [ V_340 ] ) == 0 )
break;
}
if ( V_340 != V_110 -> V_147 )
continue;
V_341 = F_59 ( V_110 -> V_153 ,
sizeof( char * ) *
( V_110 -> V_147 + 1 ) ,
V_342 ) ;
if ( V_341 == NULL )
...
F_7 ( V_108 -> V_2 , L_32 ,
V_110 -> V_147 ) ;
V_110 -> V_339 . V_343 = V_110 -> V_147 ;
V_110 -> V_339 . V_344 = V_110 -> V_153 ;
V_162 = F_34 ( V_108 , & V_338 , 1 ) ;
if ( V_162 != 0 )
F_8 ( V_108 -> V_2 ,
L_33 , V_162 ) ;
}
...
if ( V_127 -> V_141 ) {
struct V_337 V_338 =
F_58 ( L_35 , V_110 -> V_346 ,
F_12 , F_10 ) ;
V_110 -> V_347 = F_61 ( sizeof( char * )
* V_127 -> V_141 , V_342 ) ;
if ( ! V_110 -> V_347 )
return;
for ( V_129 = 0 ; V_129 < V_127 -> V_141 ; V_129 ++ )
V_110 -> V_347 [ V_129 ] = V_127 -> V_131 [ V_129 ] . V_152 ;
V_110 -> V_346 . V_343 = V_127 -> V_141 ;
V_110 -> V_346 . V_344 = V_110 -> V_347 ;
V_162 = F_34 ( V_108 , & V_338 , 1 ) ;
if ( V_162 != 0 )
F_8 ( V_108 -> V_2 ,
L_36 , V_162 ) ;
...
break;
case V_212 :
memset ( & V_348 . V_349 , 0 , sizeof( V_348 . V_349 ) ) ;
break;
default:
F_8 ( V_108 -> V_2 , L_38 ,
V_110 -> V_201 ) ;
...
static int F_65 ( struct V_350 * V_351 ,
const struct V_352 * V_353 )
{
struct V_109 * V_110 ;
unsigned int V_157 ;
int V_162 , V_129 ;
V_110 = F_66 ( & V_351 -> V_2 , sizeof( struct V_109 ) ,
V_342 ) ;
if ( V_110 == NULL )
return - V_354 ;
V_110 -> V_324 = F_67 ( & V_351 -> V_2 , L_39 ) ;
if ( F_68 ( V_110 -> V_324 ) ) {
V_162 = F_69 ( V_110 -> V_324 ) ;
F_8 ( & V_351 -> V_2 , L_40 ) ;
return V_162 ;
}
V_110 -> V_334 = F_70 ( V_351 , & V_355 ) ;
if ( F_68 ( V_110 -> V_334 ) ) {
V_162 = F_69 ( V_110 -> V_334 ) ;
F_8 ( & V_351 -> V_2 , L_41 ,
V_162 ) ;
return V_162 ;
}
V_110 -> V_201 = V_353 -> V_356 ;
F_71 ( V_351 , V_110 ) ;
V_110 -> V_127 = V_351 -> V_2 . V_357 ;
for ( V_129 = 0 ; V_129 < F_17 ( V_110 -> V_333 ) ; V_129 ++ )
V_110 -> V_333 [ V_129 ] . V_358 = V_359 [ V_129 ] ;
V_162 = F_72 ( & V_351 -> V_2 , F_17 ( V_110 -> V_333 ) ,
V_110 -> V_333 ) ;
if ( V_162 != 0 ) {
F_8 ( & V_351 -> V_2 , L_42 , V_162 ) ;
return V_162 ;
}
V_162 = F_51 ( F_17 ( V_110 -> V_333 ) ,
V_110 -> V_333 ) ;
if ( V_162 != 0 ) {
F_8 ( & V_351 -> V_2 , L_30 , V_162 ) ;
return V_162 ;
}
V_162 = F_73 ( V_110 -> V_334 , V_4 , & V_157 ) ;
if ( V_162 < 0 ) {
F_8 ( & V_351 -> V_2 , L_43 , V_162 ) ;
goto V_360;
}
if ( V_157 != 0x8904 ) {
F_8 ( & V_351 -> V_2 , L_44 , V_157 ) ;
V_162 = - V_122 ;
goto V_360;
}
V_162 = F_73 ( V_110 -> V_334 , V_5 , & V_157 ) ;
if ( V_162 < 0 ) {
F_8 ( & V_351 -> V_2 , L_45 ,
V_162 ) ;
goto V_360;
}
F_74 ( & V_351 -> V_2 , L_46 , V_157 + 'A' ) ;
V_162 = F_75 ( V_110 -> V_334 , V_4 , 0 ) ;
if ( V_162 < 0 ) {
F_8 ( & V_351 -> V_2 , L_47 , V_162 ) ;
goto V_360;
}
F_76 ( V_110 -> V_334 , V_35 ,
V_361 , V_361 ) ;
F_76 ( V_110 -> V_334 , V_36 ,
V_361 , V_361 ) ;
F_76 ( V_110 -> V_334 , V_31 ,
V_362 , V_362 ) ;
F_76 ( V_110 -> V_334 , V_32 ,
V_362 , V_362 ) ;
F_76 ( V_110 -> V_334 , V_47 ,
V_363 | V_364 ,
V_363 | V_364 ) ;
F_76 ( V_110 -> V_334 , V_48 ,
V_363 | V_365 ,
V_363 | V_365 ) ;
F_76 ( V_110 -> V_334 , V_49 ,
V_366 | V_367 ,
V_366 | V_367 ) ;
F_76 ( V_110 -> V_334 , V_50 ,
V_366 | V_368 ,
V_366 | V_368 ) ;
F_76 ( V_110 -> V_334 , V_24 ,
V_369 , 0 ) ;
if ( V_110 -> V_127 ) {
for ( V_129 = 0 ; V_129 < V_370 ; V_129 ++ ) {
if ( ! V_110 -> V_127 -> V_371 [ V_129 ] )
continue;
F_76 ( V_110 -> V_334 ,
V_70 + V_129 ,
0xffff ,
V_110 -> V_127 -> V_371 [ V_129 ] ) ;
}
for ( V_129 = 0 ; V_129 < V_372 ; V_129 ++ )
F_76 ( V_110 -> V_334 ,
V_15 + V_129 ,
0xffff ,
V_110 -> V_127 -> V_373 [ V_129 ] ) ;
}
F_76 ( V_110 -> V_334 , V_59 ,
V_374 , V_374 ) ;
F_76 ( V_110 -> V_334 , V_13 ,
V_375 , 0 ) ;
F_52 ( V_110 -> V_334 , true ) ;
F_55 ( F_17 ( V_110 -> V_333 ) , V_110 -> V_333 ) ;
V_162 = F_77 ( & V_351 -> V_2 ,
& V_376 , & V_348 , 1 ) ;
if ( V_162 != 0 )
return V_162 ;
return 0 ;
...
static int F_78 ( struct V_350 * V_377 )
{
F_79 ( & V_377 -> V_2 ) ;
return 0 ;
}
