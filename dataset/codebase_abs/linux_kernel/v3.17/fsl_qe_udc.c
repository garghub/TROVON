...
if ( V_237 )
goto V_329;
V_7 -> V_191 = F_141 ( & V_300 -> V_13 , 256 , V_261 ) ;
if ( V_7 -> V_191 == NULL ) {
F_39 ( V_7 -> V_13 , L_44 ) ;
V_237 = - V_97 ;
goto V_330;
}
V_7 -> V_262 = F_141 ( & V_300 -> V_13 , 2 , V_261 ) ;
if ( V_7 -> V_262 == NULL ) {
V_237 = - V_97 ;
goto V_330;
}
V_7 -> V_331 = F_43 ( ( void * ) V_7 -> V_191 ) ;
if ( V_7 -> V_331 == V_19 ) {
V_7 -> V_331 = F_44 (
V_7 -> V_12 . V_13 . V_14 ,
V_7 -> V_191 ,
...
( unsigned long ) V_7 ) ;
V_7 -> V_333 = F_143 ( V_302 , 0 ) ;
if ( ! V_7 -> V_333 ) {
V_237 = - V_104 ;
goto V_334;
}
V_237 = F_144 ( V_7 -> V_333 , F_125 , 0 ,
V_327 , V_7 ) ;
if ( V_237 ) {
F_39 ( V_7 -> V_13 , L_45 ,
V_7 -> V_333 , V_237 ) ;
...
V_237 = F_145 ( & V_300 -> V_13 , & V_7 -> V_12 ,
F_136 ) ;
if ( V_237 )
goto V_336;
F_146 ( V_300 , V_7 ) ;
...
static int F_150 ( struct V_299 * V_13 , T_9 V_44 )
{
return - V_338 ;
}
static int F_151 ( struct V_299 * V_13 )
{
return - V_338 ;
}
static int F_152 ( struct V_299 * V_300 )
{
struct V_6 * V_7 = F_153 ( V_300 ) ;
struct V_1 * V_2 ;
unsigned int V_102 ;
F_154 ( F_1 ) ;
F_155 ( & V_7 -> V_12 ) ;
