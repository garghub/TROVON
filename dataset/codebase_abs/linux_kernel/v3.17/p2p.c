...
struct V_134 * V_313 = F_96 ( V_107 ) ;
struct V_40 * V_41 = F_74 ( V_313 ) ;
...
V_48 -> V_51 [ V_76 ] . V_53 = V_293 ;
memcpy ( V_292 -> V_55 , V_48 -> V_49 , V_46 ) ;
memcpy ( & V_293 -> V_139 . V_317 , V_48 -> V_49 , sizeof( V_48 -> V_49 ) ) ;
V_133 = F_85 ( V_50 , L_89 , & V_295 ) ;
if ( V_133 < 0 ) {
F_10 ( L_90 ) ;
goto V_315;
...
struct V_177 * F_103 ( struct V_159 * V_159 , const char * V_318 ,
...
strncpy ( V_41 -> V_277 -> V_318 , V_318 , sizeof( V_41 -> V_277 -> V_318 ) - 1 ) ;
