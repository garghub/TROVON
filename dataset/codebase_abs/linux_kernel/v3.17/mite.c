...
int V_99 ;
int V_100 ;
V_100 = F_15 ( V_4 -> V_14 + F_59 ( V_57 -> V_10 ) ) ;
V_99 = F_15 ( V_4 -> V_14 + F_67 ( V_57 -> V_10 ) ) ;
return V_99 ;
}
...
T_1 V_111 = V_110 -> V_112 * F_73 ( V_61 ) ;
unsigned int V_103 = V_63 -> V_113 ;
T_1 V_114 , V_115 ;
int V_67 ;
F_74 ( V_61 , V_63 -> V_64 ) ;
V_115 = F_64 ( V_57 ) ;
if ( V_110 -> V_116 == V_117 && ( int ) ( V_115 - V_111 ) > 0 )
V_115 = V_111 ;
V_114 = F_65 ( V_57 ) ;
if ( V_110 -> V_116 == V_117 && ( int ) ( V_114 - V_111 ) > 0 )
V_114 = V_111 ;
if ( ( int ) ( V_114 - V_103 ) > 0 ) {
F_26 ( V_61 -> V_66 -> V_22 , L_12 ) ;
V_63 -> V_105 |= V_106 ;
return - 1 ;
}
V_67 = V_115 - V_63 -> V_118 ;
if ( V_67 <= 0 )
return 0 ;
if ( V_67 ) {
F_75 ( V_61 , V_67 ) ;
...
unsigned long V_55 ;
F_39 ( & V_4 -> V_7 , V_55 ) ;
V_119 = F_15 ( V_4 -> V_14 + F_77 ( V_57 -> V_10 ) ) ;
if ( V_119 & V_120 ) {
V_57 -> V_11 = 1 ;
F_23 ( V_121 ,
