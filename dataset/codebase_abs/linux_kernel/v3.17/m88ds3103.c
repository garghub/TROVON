...
if ( V_119 )
* V_118 = F_32 ( ( V_123 ) 100 * F_33 ( V_119 ) , F_33 ( 10 ) ) ;
else
* V_118 = 0 ;
break;
case V_47 :
...
if ( signal > V_120 ) {
V_119 = signal / V_120 ;
* V_118 = F_32 ( ( V_123 ) 100 * F_34 ( V_119 ) , ( 1 << 24 ) ) ;
} else {
* V_118 = 0 ;
}
break;
...
static int F_35 ( struct V_31 * V_32 , T_4 * V_124 )
{
struct V_1 * V_2 = V_32 -> V_34 ;
struct V_35 * V_36 = & V_32 -> V_37 ;
int V_6 ;
...
if ( V_6 )
goto V_29;
V_125 = ( V_7 [ 2 ] << 16 ) | ( V_7 [ 1 ] << 8 ) | ( V_7 [ 0 ] << 0 ) ;
if ( V_125 > 3000 ) {
...
V_22 = V_127 << 7 | V_2 -> V_11 -> V_131 << 5 ;
V_6 = F_14 ( V_2 , 0xa2 , V_22 , 0xe0 ) ;
if ( V_6 )
goto V_29;
V_22 = 1 << 2 ;
V_6 = F_14 ( V_2 , 0xa1 , V_22 , V_128 ) ;
if ( V_6 )
goto V_29;
return 0 ;
V_29:
...
V_133 -> V_134 , V_133 -> V_9 ) ;
if ( ! V_2 -> V_38 ) {
V_6 = - V_39 ;
goto V_29;
}
if ( V_133 -> V_134 < 3 || V_133 -> V_134 > 6 ) {
V_6 = - V_14 ;
goto V_29;
}
V_22 = V_2 -> V_11 -> V_131 << 5 ;
V_6 = F_14 ( V_2 , 0xa2 , V_22 , 0xe0 ) ;
if ( V_6 )
goto V_29;
V_6 = F_1 ( V_2 , 0xa3 , V_133 -> V_9 ,
V_133 -> V_134 ) ;
if ( V_6 )
goto V_29;
V_6 = F_12 ( V_2 , 0xa1 ,
( V_133 -> V_134 - 1 ) << 3 | 0x07 ) ;
if ( V_6 )
goto V_29;
F_38 ( 40000 , 60000 ) ;
...
static int F_44 ( struct V_143 * V_144 , void * V_145 , T_4 V_146 )
{
...
static int F_46 ( struct V_143 * V_144 , void * V_145 ,
T_4 V_146 )
{
struct V_1 * V_2 = V_145 ;
F_7 ( & V_2 -> V_15 ) ;
...
struct V_31 * F_47 ( const struct V_148 * V_11 ,
struct V_143 * V_16 , struct V_143 * * V_149 )
{
int V_6 ;
struct V_1 * V_2 ;
T_1 V_150 , V_22 ;
V_2 = F_48 ( sizeof( * V_2 ) , V_151 ) ;
if ( ! V_2 ) {
V_6 = - V_152 ;
...
V_2 -> V_16 = V_16 ;
F_49 ( & V_2 -> V_15 ) ;
V_6 = F_13 ( V_2 , 0x01 , & V_150 ) ;
if ( V_6 )
goto V_29;
F_17 ( & V_2 -> V_16 -> V_17 , L_33 , V_28 , V_150 ) ;
switch ( V_150 ) {
case 0xd0 :
break;
default:
...
if ( V_6 )
goto V_29;
V_2 -> V_143 = F_50 ( V_16 , & V_16 -> V_17 , V_2 , 0 , 0 , 0 ,
F_44 , F_46 ) ;
if ( V_2 -> V_143 == NULL )
goto V_29;
* V_149 = V_2 -> V_143 ;
memcpy ( & V_2 -> V_32 . V_64 , & V_88 , sizeof( struct V_157 ) ) ;
V_2 -> V_32 . V_34 = V_2 ;
return & V_2 -> V_32 ;
V_29:
