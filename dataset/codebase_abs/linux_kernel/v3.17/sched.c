...
void * F_117 ( struct V_3 * V_4 , T_6 V_101 )
{
struct V_102 * V_103 ;
...
if ( V_101 <= V_108 )
V_103 = F_118 ( V_109 , V_104 ) ;
else
V_103 = F_119 ( V_101 , V_104 ) ;
if ( ! V_103 )
return NULL ;
V_103 -> V_110 = V_101 ;
F_2 ( L_16 ,
...
if ( ! V_111 )
return;
V_103 = F_116 ( V_111 , struct V_102 , V_68 ) ;
V_101 = V_103 -> V_110 ;
F_2 ( L_17 ,
V_101 , V_103 ) ;
if ( V_101 <= V_108 )
...
F_126 ( void )
{
return (struct V_3 * ) F_118 ( V_120 , V_121 ) ;
}
struct V_3 * F_127 ( const struct V_112 * V_122 )
{
struct V_3 * V_4 = V_122 -> V_4 ;
...
F_107 ( V_4 ) ;
if ( V_4 -> V_125 . V_126 ) {
F_132 ( V_4 -> V_125 . V_126 ) ;
V_4 -> V_125 . V_126 = NULL ;
}
F_133 ( V_4 ) ;
}
...
static void F_135 ( struct V_3 * V_4 , struct V_127 * V_16 )
{
if ( F_58 ( & V_4 -> V_50 ) ) {
F_131 ( V_4 ) ;
F_134 ( V_4 , V_16 ) ;
...
struct V_127 * V_46 ;
F_2 ( L_22 ) ;
V_46 = F_143 ( L_23 , V_130 , 1 ) ;
V_57 = V_46 ;
return V_57 != NULL ;
}
static void F_144 ( void )
{
struct V_127 * V_46 = NULL ;
if ( V_57 == NULL )
return;
F_2 ( L_24 ) ;
V_46 = V_57 ;
