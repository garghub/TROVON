...
{
struct V_42 * V_90 ;
int V_28 = 0 , V_91 = 0 , V_68 , V_92 ;
struct V_93 * * V_43 ;
if ( ! ( V_2 -> V_22 -> V_94 ||
F_43 ( V_2 ) ) )
return 0 ;
V_2 -> V_7 =
F_49 ( sizeof( struct V_5 ) , V_72 ) ;
if ( V_2 -> V_7 == NULL )
return - V_75 ;
F_50 ( & V_2 -> V_7 -> V_77 ) ;
F_44 ( V_2 -> V_7 ) ;
if ( V_2 -> V_22 -> V_94 != NULL ) {
V_43 = V_2 -> V_22 -> V_94 -> V_95 ;
while ( * V_43 ++ != NULL )
V_91 ++ ;
}
V_68 = V_91 ;
