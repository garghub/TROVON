...
break;
case V_120 :
V_63 -> V_74 . V_212 = V_41 [ 2 ] ;
break;
case V_94 :
if ( V_2 -> V_17 -> V_119 )
memcpy ( & V_63 -> V_74 . V_213 , V_41 ,
sizeof( struct V_75 ) ) ;
break;
case V_56 :
if ( V_2 -> V_17 -> V_119 ) {
...
V_63 = F_32 ( V_2 , V_122 ) ;
if ( ! V_63 || V_63 -> V_218 == V_219 ) {
F_25 ( V_2 -> V_17 -> V_18 ,
L_9 , V_122 ) ;
return - V_158 ;
}
memcpy ( & V_217 . V_220 , V_122 , V_136 ) ;
V_217 . V_221 = V_222 ;
return F_68 ( V_2 , V_223 ,
V_224 , 0 , & V_217 , true ) ;
}
static int
...
L_11 , V_122 ) ;
V_63 -> V_218 = V_25 ;
V_230 = V_63 -> V_74 . V_206 . V_230 ;
if ( V_230 . V_231 [ 0 ] != 0xff )
V_63 -> V_207 = true ;
if ( V_63 -> V_207 ) {
if ( F_28 ( V_63 -> V_74 . V_206 . V_232 ) &
V_233 )
V_63 -> V_234 =
V_235 ;
else
...
for ( V_37 = 0 ; V_37 < V_38 ; V_37 ++ )
V_63 -> V_237 [ V_37 ] =
V_2 -> V_238 [ V_37 ] . V_239 ;
} else {
for ( V_37 = 0 ; V_37 < V_38 ; V_37 ++ )
V_63 -> V_237 [ V_37 ] = V_240 ;
}
memset ( V_63 -> V_241 , 0xff , sizeof( V_63 -> V_241 ) ) ;
F_1 ( V_2 , V_122 , V_25 ) ;
} else {
F_2 ( V_2 -> V_17 -> V_18 ,
L_12 , V_122 ) ;
...
F_1 ( V_2 , V_63 -> V_245 ,
V_227 ) ;
memcpy ( & V_217 . V_220 , V_63 -> V_245 , V_136 ) ;
V_217 . V_221 = V_228 ;
if ( F_68 ( V_2 , V_223 ,
V_224 , 0 , & V_217 , false ) )
F_34 ( V_2 -> V_17 -> V_18 ,
