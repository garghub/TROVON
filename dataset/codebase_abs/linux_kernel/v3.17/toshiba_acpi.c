...
{
T_2 V_11 [ V_12 ] = { V_34 , V_95 , 0 , 0 , 0 , 0 } ;
T_2 V_13 [ V_12 ] ;
T_3 V_6 ;
if ( V_10 -> V_93 ) {
bool V_92 = ! V_3 ;
...
F_46 ( V_100 , L_28 , V_116 ) ;
F_46 ( V_100 , L_29 , V_118 ) ;
F_46 ( V_100 , L_30 , V_120 ) ;
}
return V_94 ;
}
...
V_122 = V_111 ;
while ( V_123 ) {
if ( sscanf ( V_122 , L_31 , & V_3 ) == 1 )
V_124 = V_3 & 1 ;
else if ( sscanf ( V_122 , L_32 , & V_3 ) == 1 )
V_125 = V_3 & 1 ;
else if ( sscanf ( V_122 , L_33 , & V_3 ) == 1 )
V_126 = V_3 & 1 ;
do {
++ V_122 ;
-- V_123 ;
...
V_94 = F_62 ( V_10 , & V_3 ) ;
if ( ! V_94 ) {
F_46 ( V_100 , L_34 , ( V_3 > 0 ) ) ;
F_46 ( V_100 , L_35 , V_10 -> V_133 ) ;
}
return V_94 ;
}
...
F_46 ( V_100 , L_39 , V_10 -> V_134 ) ;
F_46 ( V_100 , L_40 , V_10 -> V_137 ) ;
return 0 ;
}
...
return - V_113 ;
V_111 [ V_112 ] = '\0' ;
if ( sscanf ( V_111 , L_41 , & V_3 ) == 1 && V_3 == 0 ) {
V_10 -> V_134 = 0 ;
} else {
return - V_114 ;
}
...
{
F_46 ( V_100 , L_42 , V_139 ) ;
F_46 ( V_100 , L_43 , V_140 ) ;
return 0 ;
}
...
& V_148 , V_10 ) ;
if ( V_10 -> V_149 )
F_73 ( L_47 , V_141 | V_142 , V_143 ,
& V_150 , V_10 ) ;
F_73 ( L_48 , V_141 , V_143 ,
& V_151 , V_10 ) ;
}
...
int time ;
int V_94 ;
V_94 = F_78 ( V_109 , 0 , & V_156 ) ;
if ( V_94 )
return V_94 ;
if ( V_156 != V_157 && V_156 != V_158 )
return - V_114 ;
if ( V_155 -> V_159 != V_156 ) {
time = V_155 -> V_160 << V_161 ;
time = time + V_155 -> V_159 ;
V_94 = F_22 ( V_155 , time ) ;
if ( V_94 )
return V_94 ;
V_155 -> V_159 = V_156 ;
}
...
struct V_9 * V_155 = F_77 ( V_10 ) ;
int time = - 1 ;
if ( sscanf ( V_109 , L_50 , & time ) != 1 && ( time < 0 || time > 60 ) )
return - V_114 ;
if ( time != - 1 && V_155 -> V_160 != time ) {
time = time << V_161 ;
time = ( V_155 -> V_159 == V_158 ) ?
time + 1 : time + 2 ;
if ( F_22 ( V_155 , time ) < 0 )
return - V_8 ;
V_155 -> V_160 = time >> V_161 ;
}
return V_22 ;
}
...
if ( F_23 ( V_155 , & time ) < 0 )
return - V_8 ;
return sprintf ( V_109 , L_49 , time >> V_161 ) ;
}
...
struct V_9 * V_155 = F_77 ( V_10 ) ;
int V_55 ;
if ( sscanf ( V_109 , L_50 , & V_55 ) == 1 && ( V_55 == 0 || V_55 == 1 ) ) {
...
static T_4 F_84 ( struct V_152 * V_10 ,
struct V_153 * V_154 , char * V_109 )
{
struct V_9 * V_155 = F_77 ( V_10 ) ;
T_2 V_162 , V_163 , V_164 ;
T_8 V_165 , V_166 , V_70 ;
int V_94 ;
V_162 = V_163 = 0 ;
V_94 = F_32 ( V_155 , & V_162 , & V_163 ) ;
if ( V_94 < 0 )
return V_94 ;
V_165 = V_162 & V_167 ;
V_164 = V_162 >> V_161 ;
V_166 = V_164 & V_167 ;
V_70 = V_163 & V_167 ;
return sprintf ( V_109 , L_51 , V_165 , V_166 , V_70 ) ;
}
static T_9 F_85 ( struct V_168 * V_169 ,
struct V_170 * V_154 , int V_171 )
{
struct V_152 * V_10 = F_20 ( V_169 , struct V_152 , V_169 ) ;
struct V_9 * V_172 = F_77 ( V_10 ) ;
bool V_173 = true ;
if ( V_154 == & V_174 . V_154 )
V_173 = ( V_172 -> V_175 ) ? true : false ;
else if ( V_154 == & V_176 . V_154 )
V_173 = ( V_172 -> V_159 == V_158 ) ? true : false ;
else if ( V_154 == & V_177 . V_154 )
V_173 = ( V_172 -> V_178 ) ? true : false ;
else if ( V_154 == & V_179 . V_154 )
V_173 = ( V_172 -> V_180 ) ? true : false ;
return V_173 ? V_154 -> V_156 : 0 ;
}
static bool F_86 ( unsigned char V_80 , unsigned char V_181 ,
struct V_182 * V_183 )
{
if ( V_181 & 0x20 )
return false ;
...
if ( V_190 & 0x80 )
return;
if ( ! F_94 ( V_10 -> V_149 , V_190 , 1 , true ) )
F_13 ( L_56 , V_190 ) ;
}
...
int error ;
T_2 V_73 ;
const struct V_191 * V_192 = V_193 ;
V_10 -> V_149 = F_96 () ;
if ( ! V_10 -> V_149 )
return - V_129 ;
V_10 -> V_149 -> V_194 = L_57 ;
V_10 -> V_149 -> V_195 = L_58 ;
V_10 -> V_149 -> V_196 . V_197 = V_198 ;
if ( F_97 ( V_199 ) )
V_192 = V_200 ;
error = F_98 ( V_10 -> V_149 , V_192 , NULL ) ;
if ( error )
goto V_201;
V_6 = V_202 ;
V_189 = F_90 () ;
if ( V_189 && F_99 ( V_189 , L_52 ) ) {
F_100 ( & V_10 -> V_186 , F_89 ) ;
error = F_101 ( F_86 ) ;
if ( error ) {
F_12 ( L_59 ) ;
goto V_203;
...
if ( ! V_10 -> V_205 && ! V_10 -> V_135 ) {
F_102 ( L_60 ) ;
goto V_206;
}
V_6 = F_5 ( V_10 -> V_26 -> V_27 , L_61 , NULL , NULL ) ;
if ( F_11 ( V_6 ) ) {
F_13 ( L_62 ) ;
error = - V_60 ;
goto V_206;
}
error = F_103 ( V_10 -> V_149 ) ;
if ( error ) {
F_13 ( L_63 ) ;
goto V_206;
}
F_6 ( V_10 , V_207 , V_208 , & V_73 ) ;
return 0 ;
V_206:
if ( V_10 -> V_204 )
F_104 ( F_86 ) ;
...
if ( V_10 -> V_93 )
V_105 . V_106 ++ ;
V_10 -> V_104 = F_109 ( L_65 ,
& V_10 -> V_26 -> V_10 ,
V_10 ,
& V_212 ,
& V_105 ) ;
if ( F_110 ( V_10 -> V_104 ) ) {
V_94 = F_111 ( V_10 -> V_104 ) ;
F_12 ( L_66 ) ;
V_10 -> V_104 = NULL ;
return V_94 ;
}
...
static int F_112 ( struct V_213 * V_26 )
{
struct V_9 * V_10 = F_113 ( V_26 ) ;
F_74 ( V_10 ) ;
if ( V_10 -> V_214 )
F_114 ( & V_10 -> V_26 -> V_10 . V_169 ,
& V_215 ) ;
if ( V_10 -> V_204 ) {
F_104 ( F_86 ) ;
F_115 ( & V_10 -> V_186 ) ;
...
static const char * F_121 ( T_10 V_27 )
{
if ( F_99 ( V_27 , L_67 ) )
return L_67 ;
if ( F_99 ( V_27 , L_68 ) )
...
static int F_122 ( struct V_213 * V_26 )
{
struct V_9 * V_10 ;
const char * V_220 ;
T_2 V_221 ;
...
if ( V_94 )
goto error;
if ( F_33 ( V_10 , & V_222 ) == V_76 && V_222 ) {
V_10 -> V_216 = F_126 ( L_72 ,
& V_26 -> V_10 ,
V_225 ,
& V_226 ,
V_10 ) ;
...
if ( F_18 ( V_10 ) ) {
V_10 -> V_54 . V_194 = L_75 ;
V_10 -> V_54 . V_106 = 1 ;
V_10 -> V_54 . V_227 = F_19 ;
V_10 -> V_54 . V_228 = F_21 ;
if ( ! F_128 ( & V_26 -> V_10 , & V_10 -> V_54 ) )
V_10 -> V_217 = 1 ;
}
if ( F_28 ( V_10 ) ) {
V_10 -> V_65 . V_194 = L_76 ;
V_10 -> V_65 . V_106 = 1 ;
V_10 -> V_65 . V_227 = F_30 ;
V_10 -> V_65 . V_228 = F_29 ;
if ( ! F_128 ( & V_10 -> V_26 -> V_10 , & V_10 -> V_65 ) )
V_10 -> V_219 = 1 ;
}
V_94 = F_23 ( V_10 , & V_221 ) ;
if ( ! V_94 ) {
V_10 -> V_160 = V_221 >> V_161 ;
V_10 -> V_159 = V_221 & 0x07 ;
}
V_10 -> V_175 = ! V_94 ;
if ( V_10 -> V_175 && V_10 -> V_159 == V_157 ) {
V_10 -> V_61 . V_194 = L_77 ;
V_10 -> V_61 . V_106 = 1 ;
V_10 -> V_61 . V_227 = F_25 ;
V_10 -> V_61 . V_228 = F_24 ;
if ( ! F_128 ( & V_10 -> V_26 -> V_10 , & V_10 -> V_61 ) )
V_10 -> V_218 = 1 ;
}
V_94 = F_27 ( V_10 , & V_221 ) ;
V_10 -> V_178 = ! V_94 ;
V_94 = F_31 ( V_10 ) ;
V_10 -> V_180 = ! V_94 ;
V_94 = F_56 ( V_10 , & V_221 ) ;
V_10 -> V_145 = ! V_94 ;
V_94 = F_62 ( V_10 , & V_221 ) ;
V_10 -> V_147 = ! V_94 ;
V_94 = F_129 ( & V_10 -> V_26 -> V_10 . V_169 ,
& V_215 ) ;
if ( V_94 ) {
V_10 -> V_214 = 0 ;
goto error;
...
static void F_130 ( struct V_213 * V_26 , T_2 V_229 )
{
struct V_9 * V_10 = F_113 ( V_26 ) ;
T_2 V_73 , V_3 ;
int V_230 = 3 ;
...
} while ( V_230 && V_73 != V_138 );
}
}
static int F_131 ( struct V_152 * V_152 )
{
struct V_9 * V_10 = F_113 ( F_132 ( V_152 ) ) ;
T_2 V_33 ;
if ( V_10 -> V_149 )
F_6 ( V_10 , V_207 , V_231 , & V_33 ) ;
return 0 ;
}
static int F_133 ( struct V_152 * V_152 )
{
struct V_9 * V_10 = F_113 ( F_132 ( V_152 ) ) ;
T_2 V_33 ;
T_3 V_6 ;
if ( V_10 -> V_149 ) {
V_6 = F_5 ( V_10 -> V_26 -> V_27 , L_61 ,
NULL , NULL ) ;
if ( F_11 ( V_6 ) )
F_13 ( L_79 ) ;
F_6 ( V_10 , V_207 , V_208 , & V_33 ) ;
}
return 0 ;
}
...
if ( F_135 ( V_232 ) )
return - V_60 ;
V_143 = F_136 ( V_233 , V_234 ) ;
if ( ! V_143 ) {
F_12 ( L_80 V_233 L_81 ) ;
return - V_60 ;
}
V_94 = F_137 ( & V_235 ) ;
if ( V_94 ) {
