...
struct V_164 * V_165 ;
struct V_5 * V_6 ;
V_162 = F_50 ( V_153 , V_166 , 0 ) ;
V_163 = F_51 ( V_153 , 0 ) ;
if ( ! V_162 || V_163 < 0 )
return - V_167 ;
V_2 = F_52 ( sizeof( struct V_3 ) , & V_153 -> V_157 ) ;
if ( ! V_2 )
return - V_168 ;
V_4 = F_2 ( V_2 ) ;
V_6 = & V_4 -> V_6 ;
...
V_6 -> V_170 = (enum V_171 ) V_155 -> V_39 ;
V_4 -> V_2 = V_2 ;
V_4 -> V_32 = 0 ;
...
V_6 -> V_172 = F_59 ( & V_153 -> V_157 , NULL ) ;
if ( F_54 ( V_6 -> V_172 ) ) {
V_8 = F_55 ( V_6 -> V_172 ) ;
goto V_169;
}
...
V_2 -> V_189 = F_64 ( V_6 -> V_78 -> V_190 -> V_157 ) ;
F_65 ( V_153 , V_2 ) ;
...
static int F_76 ( struct V_190 * V_157 )
{
struct V_1 * V_2 = F_77 ( V_157 ) ;
struct V_3 * V_4 = F_2 ( V_2 ) ;
struct V_5 * V_6 = & V_4 -> V_6 ;
F_71 ( V_6 -> V_172 ) ;
return 0 ;
}
static int F_78 ( struct V_190 * V_157 )
{
struct V_1 * V_2 = F_77 ( V_157 ) ;
struct V_3 * V_4 = F_2 ( V_2 ) ;
struct V_5 * V_6 = & V_4 -> V_6 ;
