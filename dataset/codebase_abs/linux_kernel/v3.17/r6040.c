...
F_75 ( V_171 -> V_173 , V_174 , sizeof( V_171 -> V_173 ) ) ;
F_75 ( V_171 -> V_175 , V_176 , sizeof( V_171 -> V_175 ) ) ;
F_75 ( V_171 -> V_177 , F_76 ( V_172 -> V_27 ) , sizeof( V_171 -> V_177 ) ) ;
}
static int F_77 ( struct V_16 * V_17 , struct V_178 * V_6 )
{
struct V_19 * V_172 = F_7 ( V_17 ) ;
return F_78 ( V_172 -> V_92 , V_6 ) ;
}
static int F_79 ( struct V_16 * V_17 , struct V_178 * V_6 )
{
struct V_19 * V_172 = F_7 ( V_17 ) ;
return F_80 ( V_172 -> V_92 , V_6 ) ;
}
...
if ( V_180 ) {
F_83 ( L_4 , V_17 -> V_140 , V_92 -> V_182 ?
L_5 : L_6 ) ;
if ( V_92 -> V_182 )
F_84 ( L_7 , V_92 -> V_187 ,
...
L_14 ,
V_92 -> V_199 -> V_140 , F_89 ( & V_92 -> V_17 ) ) ;
return 0 ;
}
static int F_93 ( struct V_93 * V_27 , const struct V_200 * V_201 )
{
struct V_16 * V_17 ;
struct V_19 * V_20 ;
void T_1 * V_1 ;
...
V_20 = F_7 ( V_17 ) ;
V_104 = F_102 ( V_27 , V_174 ) ;
if ( V_104 ) {
F_87 ( & V_27 -> V_17 , L_19 ) ;
goto V_209;
}
V_1 = F_103 ( V_27 , V_205 , V_202 ) ;
if ( ! V_1 ) {
F_87 ( & V_27 -> V_17 , L_20 ) ;
V_104 = - V_208 ;
goto V_210;
...
F_89 ( & V_27 -> V_17 ) , V_204 ) ;
V_20 -> V_14 -> V_95 = F_109 ( V_213 , sizeof( int ) , V_228 ) ;
if ( ! V_20 -> V_14 -> V_95 ) {
V_104 = - V_52 ;
goto V_229;
}
