...
if ( V_15 -> V_81 % V_78 && V_77 + 1 < V_15 -> V_81 / V_78 )
...
if ( ! F_50 ( V_79 -> V_91 , V_79 -> V_82 ) ) {
F_14 ( & V_9 -> V_2 , L_28 ,
& V_79 -> V_91 ) ;
F_45 ( V_15 , V_89 ) ;
return - V_27 ;
}
F_51 ( V_15 -> V_31 , V_89 , V_79 -> V_91 ) ;
return 0 ;
}
...
static void F_64 ( void * V_104 , enum V_105 V_106 )
{
...
V_11 = F_67 ( V_31 , V_111 + ( V_24 * 2 ) ,
F_68 ( V_31 , V_24 ) >> 32 ) ;
if ( V_11 ) {
F_14 ( & V_9 -> V_2 , L_30 ,
( T_7 ) ( F_68 ( V_31 , V_24 ) >> 32 ) ,
V_111 + ( V_24 * 2 ) ) ;
goto V_72;
}
V_11 = F_67 ( V_31 , V_112 + ( V_24 * 2 ) ,
( T_7 ) F_68 ( V_31 , V_24 ) ) ;
if ( V_11 ) {
F_14 ( & V_9 -> V_2 , L_30 ,
( T_7 ) F_68 ( V_31 , V_24 ) ,
...
V_11 = F_67 ( V_31 , V_113 , F_41 ( V_31 ) ) ;
if ( V_11 ) {
F_14 ( & V_9 -> V_2 , L_31 ,
F_41 ( V_31 ) , V_113 ) ;
goto V_72;
}
V_11 = F_67 ( V_31 , V_114 , V_15 -> V_81 ) ;
if ( V_11 ) {
F_14 ( & V_9 -> V_2 , L_31 ,
V_15 -> V_81 , V_114 ) ;
goto V_72;
}
V_11 = F_67 ( V_31 , V_115 , V_116 ) ;
if ( V_11 ) {
F_14 ( & V_9 -> V_2 , L_31 ,
V_116 , V_115 ) ;
goto V_72;
}
V_11 = F_69 ( V_31 , V_115 , & V_110 ) ;
if ( V_11 ) {
F_14 ( & V_9 -> V_2 , L_32 , V_115 ) ;
goto V_72;
}
if ( V_110 != V_116 )
goto V_72;
F_70 ( & V_9 -> V_2 , L_33 , V_110 ) ;
V_11 = F_69 ( V_31 , V_114 , & V_110 ) ;
if ( V_11 ) {
F_14 ( & V_9 -> V_2 , L_32 , V_114 ) ;
goto V_72;
}
if ( V_110 != V_15 -> V_81 )
goto V_72;
F_70 ( & V_9 -> V_2 , L_34 , V_110 ) ;
V_11 = F_69 ( V_31 , V_113 , & V_110 ) ;
if ( V_11 ) {
F_14 ( & V_9 -> V_2 , L_32 , V_113 ) ;
goto V_72;
}
if ( V_110 != F_41 ( V_31 ) )
goto V_72;
F_70 ( & V_9 -> V_2 , L_35 , V_110 ) ;
for ( V_24 = 0 ; V_24 < F_41 ( V_31 ) ; V_24 ++ ) {
T_8 V_117 ;
V_11 = F_69 ( V_31 , V_111 + ( V_24 * 2 ) , & V_110 ) ;
if ( V_11 ) {
F_14 ( & V_9 -> V_2 , L_32 ,
V_111 + ( V_24 * 2 ) ) ;
goto V_118;
...
V_117 = ( T_8 ) V_110 << 32 ;
V_11 = F_69 ( V_31 , V_112 + ( V_24 * 2 ) , & V_110 ) ;
if ( V_11 ) {
F_14 ( & V_9 -> V_2 , L_32 ,
V_112 + ( V_24 * 2 ) ) ;
goto V_118;
...
V_11 = F_73 ( V_15 -> V_31 , V_120 , & V_110 ) ;
if ( V_11 ) {
F_14 ( & V_9 -> V_2 , L_37 , V_120 ) ;
return;
}
V_11 = F_67 ( V_15 -> V_31 , V_120 , V_110 | 1 << V_39 -> V_73 ) ;
if ( V_11 )
F_14 ( & V_9 -> V_2 , L_31 ,
V_110 | 1 << V_39 -> V_73 , V_120 ) ;
V_11 = F_69 ( V_15 -> V_31 , V_120 , & V_110 ) ;
if ( V_11 )
F_14 ( & V_9 -> V_2 , L_32 , V_120 ) ;
F_70 ( & V_9 -> V_2 , L_38 , V_110 ) ;
if ( 1 << V_39 -> V_73 & V_110 ) {
V_39 -> V_65 = V_66 ;
F_54 ( & V_9 -> V_2 , L_39 , V_39 -> V_73 ) ;
if ( V_39 -> V_95 )
...
V_76 = V_15 -> V_81 / V_78 ;
V_121 = ( unsigned int ) F_68 ( V_39 -> V_31 , V_77 ) / V_76 ;
V_122 = V_73 / V_78 * V_121 ;
V_39 -> V_62 = F_75 ( V_15 -> V_31 , V_77 ) + V_122 ;
if ( ! V_39 -> V_62 )
return - V_12 ;
V_39 -> V_123 = F_76 ( V_39 -> V_31 , V_77 ) + V_122 ;
if ( ! V_39 -> V_123 )
return - V_12 ;
...
if ( F_77 ( V_15 -> V_31 ) ) {
char V_126 [ 4 ] ;
snprintf ( V_126 , 4 , L_40 , V_73 ) ;
V_39 -> V_127 = F_78 ( V_126 ,
F_77 ( V_15 -> V_31 ) ) ;
V_39 -> V_128 = F_79 ( L_41 , V_129 ,
V_39 -> V_127 , V_39 ,
& V_130 ) ;
}
F_80 ( & V_39 -> V_94 , F_72 ) ;
...
if ( ! V_15 )
return - V_27 ;
V_15 -> V_31 = F_85 ( V_9 , V_15 ) ;
if ( ! V_15 -> V_31 ) {
V_11 = - V_137 ;
goto V_28;
}
V_15 -> V_79 = F_86 ( F_41 ( V_15 -> V_31 ) , sizeof( struct V_90 ) ,
V_26 ) ;
if ( ! V_15 -> V_79 ) {
V_11 = - V_27 ;
goto V_138;
...
if ( V_139 )
V_15 -> V_81 = F_44 ( F_87 ( V_15 -> V_31 ) , V_139 ) ;
else
V_15 -> V_81 = F_44 ( F_87 ( V_15 -> V_31 ) , F_41 ( V_15 -> V_31 ) ) ;
V_15 -> V_74 = F_86 ( V_15 -> V_81 , sizeof( struct V_38 ) ,
V_26 ) ;
if ( ! V_15 -> V_74 ) {
V_11 = - V_27 ;
goto V_140;
...
F_95 () ;
V_144 -> V_70 = 0 ;
F_96 ( V_18 -> V_146 , & V_39 -> V_124 -> V_18 ) ;
...
static void F_98 ( struct V_71 * V_18 , void * V_87 ,
T_3 V_143 )
{
struct V_148 * V_149 ;
struct V_38 * V_39 = V_18 -> V_39 ;
...
if ( ! F_99 ( V_1 , V_153 , V_154 , V_143 ) )
goto V_159;
V_156 = F_100 ( V_1 -> V_2 , 2 , V_161 ) ;
if ( ! V_156 )
goto V_159;
V_156 -> V_143 = V_143 ;
V_156 -> V_162 [ 0 ] = F_101 ( V_1 -> V_2 , F_102 ( V_87 ) ,
V_153 , V_143 , V_163 ) ;
if ( F_103 ( V_1 -> V_2 , V_156 -> V_162 [ 0 ] ) )
goto V_164;
V_156 -> V_165 = 1 ;
V_156 -> V_162 [ 1 ] = F_101 ( V_1 -> V_2 , F_102 ( V_40 ) ,
V_154 , V_143 , V_166 ) ;
if ( F_103 ( V_1 -> V_2 , V_156 -> V_162 [ 1 ] ) )
goto V_164;
V_156 -> V_167 = 1 ;
...
F_95 () ;
V_144 -> V_70 = 0 ;
F_96 ( V_39 -> V_54 , & V_39 -> V_124 -> V_18 ) ;
goto V_72;
}
static int F_110 ( void * V_104 , int V_178 )
{
struct V_38 * V_39 = V_104 ;
int V_11 , V_24 ;
F_70 ( & F_25 ( V_39 -> V_31 ) -> V_2 , L_46 ,
V_179 , V_178 ) ;
for ( V_24 = 0 ; V_24 < V_39 -> V_55 ; V_24 ++ ) {
V_11 = F_109 ( V_39 ) ;
if ( V_11 )
...
static void F_112 ( void * V_104 )
{
struct V_71 * V_18 = V_104 ;
struct V_38 * V_39 = V_18 -> V_39 ;
struct V_88 T_10 * V_144 = V_18 -> V_180 ;
F_95 () ;
F_96 ( V_18 -> V_70 | V_175 , & V_144 -> V_70 ) ;
F_113 ( V_39 -> V_31 , V_39 -> V_73 ) ;
if ( V_18 -> V_143 > 0 ) {
...
static void F_114 ( struct V_71 * V_18 , void T_10 * V_87 )
{
F_115 ( V_87 , V_18 -> V_40 , V_18 -> V_143 ) ;
F_112 ( V_18 ) ;
}
...
V_18 -> V_180 = V_144 ;
F_96 ( V_18 -> V_143 , & V_144 -> V_143 ) ;
F_96 ( ( T_7 ) V_39 -> V_57 , & V_144 -> V_174 ) ;
if ( ! V_151 )
goto V_28;
if ( V_143 < V_158 )
goto V_28;
...
if ( ! F_99 ( V_1 , V_154 , V_182 , V_143 ) )
goto V_28;
V_156 = F_100 ( V_1 -> V_2 , 1 , V_161 ) ;
if ( ! V_156 )
goto V_28;
V_156 -> V_143 = V_143 ;
V_156 -> V_162 [ 0 ] = F_101 ( V_1 -> V_2 , F_102 ( V_40 ) ,
V_154 , V_143 , V_163 ) ;
if ( F_103 ( V_1 -> V_2 , V_156 -> V_162 [ 0 ] ) )
goto V_164;
V_156 -> V_165 = 1 ;
...
V_18 -> V_143 = 0 ;
V_18 -> V_70 = V_177 ;
V_11 = F_117 ( V_39 , V_18 ) ;
if ( V_11 )
F_14 ( & V_9 -> V_2 , L_48 ,
V_39 -> V_73 ) ;
}
struct V_38 *
F_120 ( void * V_104 , struct V_8 * V_9 ,
...
if ( ! V_15 )
goto V_28;
V_186 = F_122 ( V_15 -> V_102 ) ;
if ( ! V_186 )
goto V_28;
V_186 -- ;
F_123 ( V_186 , & V_15 -> V_102 ) ;
...
V_11 = F_127 ( V_39 -> V_31 , V_186 , V_39 ,
F_110 ) ;
if ( V_11 )
goto V_140;
F_54 ( & V_9 -> V_2 , L_50 , V_39 -> V_73 ) ;
return V_39 ;
V_140:
...
while ( ( V_18 = F_38 ( & V_39 -> V_133 , & V_39 -> V_136 ) ) )
F_19 ( V_18 ) ;
F_128 ( V_39 -> V_73 , & V_39 -> V_92 -> V_102 ) ;
F_54 ( & V_9 -> V_2 , L_52 , V_39 -> V_73 ) ;
}
void * F_132 ( struct V_38 * V_39 , unsigned int * V_143 )
{
struct V_71 * V_18 ;
void * V_40 ;
...
int F_134 ( struct V_38 * V_39 , void * V_190 , void * V_104 ,
unsigned int V_143 )
{
struct V_71 * V_18 ;
int V_11 ;
...
V_9 = F_25 ( V_39 -> V_31 ) ;
V_39 -> V_119 = V_93 ;
V_11 = F_73 ( V_39 -> V_31 , V_120 , & V_110 ) ;
if ( V_11 ) {
F_14 ( & V_9 -> V_2 , L_37 , V_120 ) ;
return;
}
V_11 = F_67 ( V_39 -> V_31 , V_120 ,
V_110 & ~ ( 1 << V_39 -> V_73 ) ) ;
if ( V_11 )
F_14 ( & V_9 -> V_2 , L_31 ,
V_110 & ~ ( 1 << V_39 -> V_73 ) , V_120 ) ;
...
bool F_137 ( struct V_38 * V_39 )
{
if ( ! V_39 )
return false ;
return V_39 -> V_65 == V_66 ;
}
unsigned char F_138 ( struct V_38 * V_39 )
{
if ( ! V_39 )
return 0 ;
return V_39 -> V_73 ;
}
unsigned int F_139 ( struct V_38 * V_39 )
{
unsigned int V_191 ;
if ( ! V_39 )
return 0 ;
