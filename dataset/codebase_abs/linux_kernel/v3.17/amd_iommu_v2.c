...
V_8 = V_17 -> V_7 ;
V_47 = ! V_17 -> V_32 ;
if ( V_47 && V_17 -> V_7 -> V_48 )
V_8 -> V_48 ( V_8 -> V_2 , V_17 -> V_18 ) ;
F_28 ( V_17 ) ;
}
...
unsigned long V_9 ;
F_5 ( & V_17 -> V_28 , V_9 ) ;
if ( F_13 ( & V_17 -> V_51 [ V_49 ] . V_52 ) &&
V_17 -> V_51 [ V_49 ] . V_53 ) {
F_52 ( V_8 -> V_2 , V_17 -> V_18 ,
V_17 -> V_51 [ V_49 ] . V_50 , V_49 ) ;
V_17 -> V_51 [ V_49 ] . V_53 = false ;
V_17 -> V_51 [ V_49 ] . V_50 = V_54 ;
}
F_7 ( & V_17 -> V_28 , V_9 ) ;
}
static void F_53 ( struct V_55 * V_56 )
{
struct V_57 * V_57 = F_39 ( V_56 , struct V_57 , V_56 ) ;
int V_58 , V_59 ;
struct V_60 * V_60 ;
V_59 = ! ! ( V_57 -> V_9 & V_61 ) ;
F_54 ( & V_57 -> V_62 -> V_38 -> V_63 ) ;
V_58 = F_55 ( NULL , V_57 -> V_62 -> V_38 ,
V_57 -> V_40 , 1 , V_59 , 0 , & V_60 , NULL ) ;
F_56 ( & V_57 -> V_62 -> V_38 -> V_63 ) ;
if ( V_58 == 1 ) {
F_57 ( V_60 ) ;
} else if ( V_57 -> V_8 -> V_64 ) {
int V_50 ;
V_50 = V_57 -> V_8 -> V_64 ( V_57 -> V_8 -> V_2 ,
V_57 -> V_18 ,
V_57 -> V_40 ,
V_57 -> V_9 ) ;
switch ( V_50 ) {
case V_65 :
F_50 ( V_57 -> V_62 , V_57 -> V_49 , V_54 ) ;
break;
case V_66 :
F_50 ( V_57 -> V_62 , V_57 -> V_49 , V_67 ) ;
break;
case V_68 :
F_50 ( V_57 -> V_62 , V_57 -> V_49 , V_69 ) ;
break;
default:
F_37 () ;
}
...
F_51 ( V_57 -> V_8 , V_57 -> V_62 , V_57 -> V_49 ) ;
F_26 ( V_57 -> V_62 ) ;
F_11 ( V_57 ) ;
}
static int F_58 ( struct V_70 * V_71 , unsigned long V_72 , void * V_73 )
{
struct V_74 * V_75 ;
struct V_17 * V_17 ;
struct V_7 * V_8 ;
...
F_52 ( V_8 -> V_2 , V_75 -> V_18 ,
V_67 , V_49 ) ;
goto V_78;
}
F_5 ( & V_17 -> V_28 , V_9 ) ;
F_6 ( & V_17 -> V_51 [ V_49 ] . V_52 ) ;
if ( V_53 )
V_17 -> V_51 [ V_49 ] . V_53 = true ;
F_7 ( & V_17 -> V_28 , V_9 ) ;
V_57 = F_59 ( sizeof( * V_57 ) , V_26 ) ;
if ( V_57 == NULL ) {
F_51 ( V_8 , V_17 , V_49 ) ;
goto V_78;
}
...
int F_71 ( struct V_1 * V_2 , int V_90 )
{
struct V_7 * V_8 ;
unsigned long V_9 ;
int V_27 , V_91 ;
...
V_8 -> V_3 = V_3 ;
V_91 = V_90 ;
for ( V_8 -> V_24 = 0 ; ( V_91 - 1 ) & ~ 0x1ff ; V_91 >>= 9 )
V_8 -> V_24 += 1 ;
F_64 ( & V_8 -> V_11 , 1 ) ;
V_8 -> V_36 = V_90 ;
V_27 = - V_29 ;
