...
static int F_34 ( struct V_2 * V_3 , struct V_60 * V_61 ,
struct V_66 * V_67 )
{
struct V_1 * V_8 = F_1 ( V_3 ) ;
struct V_32 * V_33 ;
...
static int F_44 ( struct V_2 * V_3 , struct V_60 * V_61 )
{
struct V_32 * V_33 = F_35 ( V_61 , 0 ) ;
...
V_13 = F_8 ( V_10 , V_82 ) ;
if ( V_13 < 0 )
F_46 ( & V_10 -> V_83 , L_6 , V_13 ) ;
F_28 ( V_8 ) ;
return V_13 == V_84 ? 0 : - V_85 ;
}
static int F_47 ( struct V_9 * V_10 ,
const struct V_86 * V_52 )
{
struct V_1 * V_8 ;
struct V_2 * V_3 ;
...
V_8 = F_48 ( & V_10 -> V_83 , sizeof( * V_8 ) , V_91 ) ;
if ( ! V_8 )
return - V_92 ;
F_49 ( & V_8 -> V_53 ) ;
V_3 = & V_8 -> V_3 ;
F_50 ( V_3 , V_10 , & V_93 ) ;
F_51 ( V_3 -> V_81 , V_94 , sizeof( V_3 -> V_81 ) ) ;
V_3 -> V_95 = & V_96 ;
V_3 -> V_97 |= V_98 ;
F_52 ( & V_8 -> V_7 , 3 ) ;
F_53 ( & V_8 -> V_7 , & V_99 ,
...
V_8 -> V_28 = & V_38 [ 0 ] ;
if ( F_23 ( V_88 -> V_48 ) ) {
V_13 = F_54 ( & V_10 -> V_83 , V_88 -> V_48 ,
V_102 ,
L_8 ) ;
if ( V_13 ) {
F_46 ( & V_10 -> V_83 , L_9 , V_13 ) ;
goto V_101;
}
V_8 -> V_48 = V_88 -> V_48 ;
F_55 ( V_8 -> V_48 , 0 ) ;
...
V_8 -> V_50 [ V_37 ] . V_50 = V_103 [ V_37 ] ;
V_13 = F_56 ( & V_10 -> V_83 , V_49 ,
V_8 -> V_50 ) ;
if ( V_13 )
goto V_101;
V_8 -> V_104 . V_97 = V_105 ;
V_3 -> V_106 . type = V_107 ;
V_13 = F_57 ( & V_3 -> V_106 , 1 , & V_8 -> V_104 , 0 ) ;
if ( V_13 < 0 )
goto V_101;
V_13 = F_45 ( V_10 , V_8 ) ;
if ( ! V_13 )
