...
static void F_36 ( struct V_2 * V_3 , int V_64 )
{
}
static int F_37 ( struct V_2 * V_3 )
{
if ( F_38 ( V_3 -> V_55 , F_27 , V_65 ,
F_13 ( V_3 ) , V_3 ) ) {
F_39 ( V_3 -> V_14 , L_1 ) ;
return - V_66 ;
}
...
static void F_42 ( struct V_2 * V_3 , unsigned int V_21 ,
unsigned int V_67 )
{
...
static void F_47 ( struct V_2 * V_3 , struct V_76 * V_77 ,
struct V_76 * V_78 )
{
struct V_1 * V_68 = F_1 ( V_3 ) ;
unsigned int V_79 ;
...
V_77 -> V_82 &= ~ ( V_83 |
( V_68 -> V_84 ? 0 : V_85 ) ) ;
V_3 -> V_86 = F_48 ( V_68 -> V_72 ) ;
V_79 = F_49 ( V_3 , V_77 , V_78 , 0 , V_3 -> V_86 / 16 ) ;
V_81 = V_77 -> V_82 ;
F_44 ( & V_3 -> V_57 , V_69 ) ;
V_80 = F_3 ( V_3 , V_74 ) ;
...
return - V_159 ;
if ( V_156 )
F_90 ( V_156 , & V_79 , & V_48 , & V_157 , & V_158 ) ;
return F_91 ( & V_68 -> V_3 , V_149 , V_79 , V_48 , V_157 , V_158 ) ;
}
