...
F_78 ( V_7 ) ;
V_93 = F_79 ( V_7 , 0 , V_149 -> V_172 , V_168 ) ;
switch ( F_3 ( V_5 ) -> V_35 ) {
case V_36 :
F_72 ( V_5 , V_149 , V_7 ) ;
break;
...
if ( ! V_7 )
goto V_112;
if ( F_85 ( F_24 ( V_7 , V_29 ) , V_149 -> V_172 , V_29 ) ) {
V_93 = - V_94 ;
goto V_177;
}
...
static int F_92 ( struct V_86 * V_4 , int V_191 , int V_192 ,
...
static int F_94 ( struct V_86 * V_4 , int V_191 , int V_192 ,
...
static int F_97 ( struct V_204 * V_204 , struct V_86 * V_4 , int V_205 ,
int V_206 )
{
struct V_4 * V_5 ;
F_8 ( L_8 , V_4 ) ;
...
return - V_208 ;
V_4 -> V_209 = & V_210 ;
V_5 = F_98 ( V_204 , V_211 , V_41 , & V_212 ) ;
if ( ! V_5 )
return - V_213 ;
F_99 ( V_4 , V_5 ) ;
F_100 ( V_5 , V_214 ) ;
...
if ( V_93 < 0 )
return V_93 ;
V_93 = F_104 ( V_218 , & V_219 ) ;
if ( V_93 < 0 ) {
F_105 ( L_9 ) ;
goto error;
}
V_93 = F_106 ( & V_220 , L_10 , & V_30 , NULL ) ;
if ( V_93 < 0 ) {
F_105 ( L_11 ) ;
F_107 ( V_218 ) ;
goto error;
