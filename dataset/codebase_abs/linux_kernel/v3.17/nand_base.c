...
F_128 ( L_33 ,
* V_335 , * V_342 ) ;
F_128 ( L_34 , V_349 [ V_343 ] . V_304 , V_2 -> V_304 ) ;
F_105 ( L_35 ,
( V_6 -> V_43 & V_44 ) ? 16 : 8 ,
V_166 ? 16 : 8 ) ;
return F_146 ( - V_11 ) ;
...
int F_148 ( struct V_1 * V_2 , int V_352 ,
struct V_334 * V_353 )
{
...
! ( V_6 -> V_34 & V_364 ) ) ;
if ( ! ( V_6 -> V_43 & V_365 ) ) {
V_363 = F_154 ( sizeof( * V_363 ) + V_2 -> V_37
+ V_2 -> V_129 * 3 , V_277 ) ;
if ( ! V_363 )
return - V_278 ;
...
V_131 -> V_361 = V_131 -> V_133 * 8 / F_130 ( 8 * V_131 -> V_120 ) ;
break;
case V_379 :
F_105 ( L_49
L_50 ) ;
...
V_2 -> type = F_138 ( V_6 ) ? V_383 : V_384 ;
...
V_2 -> V_404 = F_109 ;
V_2 -> V_405 = V_2 -> V_37 ;
V_2 -> V_406 = V_131 -> V_145 ;
V_2 -> V_407 = V_131 -> V_361 ;
V_2 -> V_408 = V_131 -> V_120 ;
if ( ! V_2 -> V_409 )
V_2 -> V_409 = V_2 -> V_407 ;
if ( V_6 -> V_43 & V_410 )
return 0 ;
...
int F_158 ( struct V_1 * V_2 , int V_352 )
{
int V_8 ;
if ( ! V_2 -> V_411 && F_159 () ) {
F_160 ( L_54 , V_10 ) ;
...
F_162 ( (struct V_412 * ) V_6 -> V_131 . V_7 ) ;
F_163 ( V_2 ) ;
F_124 ( V_6 -> V_66 ) ;
if ( ! ( V_6 -> V_43 & V_365 ) )
F_124 ( V_6 -> V_140 ) ;
if ( V_6 -> V_413 && V_6 -> V_413 -> V_43
& V_414 )
F_124 ( V_6 -> V_413 ) ;
}
