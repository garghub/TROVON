...
for ( V_25 = 0 ; V_25 < F_9 ( V_7 -> V_8 ) ; V_25 ++ ) {
V_19 = F_10 ( V_7 -> V_8 , V_25 ) ;
if ( ! V_19 )
continue;
V_12 = F_8 ( V_19 ) ;
...
static long F_12 ( struct V_1 * V_2 , unsigned long V_16 ,
unsigned long * V_29 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
const struct V_5 * V_13 = V_4 -> V_13 ;
...
struct V_8 * F_17 ( struct V_36 * V_37 , const char * V_38 ,
