...
{
struct V_25 * V_26 = F_11 ( V_13 -> V_19 . V_20 ) ;
struct V_4 * V_5 = NULL ;
struct V_27 * V_28 = F_12 ( & V_13 -> V_19 ) ;
struct V_14 V_15 = { } ;
struct V_29 * V_30 ;
int V_31 ;
V_30 = F_13 ( V_13 , V_32 , 0 ) ;
if ( V_30 ) {
for ( V_31 = 0 ; V_31 < F_14 ( V_4 ) ; V_31 ++ ) {
V_5 = & V_4 [ V_31 ] ;
...
V_15 . V_45 = V_26 -> V_46 ;
V_5 -> V_47 = F_15 ( & V_13 -> V_19 , & V_5 -> V_9 ,
& V_15 ) ;
if ( F_16 ( V_5 -> V_47 ) ) {
F_5 ( & V_13 -> V_19 , L_4 ,
V_5 -> V_9 . V_23 ) ;
return F_17 ( V_5 -> V_47 ) ;
}
F_18 ( V_13 , V_5 ) ;
return 0 ;
}
