...
struct V_4 * F_58 ( struct V_26 * V_27 , int V_59 )
{
...
static int F_64 ( struct V_1 * V_2 , const void * V_117 )
{
struct V_4 * V_118 ;
const unsigned short * V_119 = V_117 ;
V_118 = F_3 ( V_2 ) ;
return V_118 -> V_47 == * V_119 ;
}
struct V_4 * F_65 ( unsigned short V_119 )
{
struct V_1 * V_120 ;
struct V_4 * V_5 = NULL ;
V_120 = F_66 ( & V_106 , NULL , & V_119 ,
F_64 ) ;
if ( V_120 ) {
V_5 = F_67 ( F_3 ( V_120 ) ) ;
F_2 ( V_120 ) ;
...
int F_73 ( struct V_4 * V_5 , struct V_121 * V_122 )
{
if ( F_74 ( ! V_5 -> V_48 ) ) {
F_6 ( V_18 , V_5 ,
L_14
