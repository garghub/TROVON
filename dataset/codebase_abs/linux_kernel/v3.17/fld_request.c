...
V_68 -> V_84 = 1 ;
if ( V_66 != V_81 )
F_56 ( exp -> V_31 -> V_85 . V_2 . V_86 , NULL ) ;
F_5 ( & exp -> V_31 -> V_85 . V_2 ) ;
V_5 = F_57 ( V_68 ) ;
F_9 ( & exp -> V_31 -> V_85 . V_2 ) ;
if ( V_66 != V_81 )
F_58 ( exp -> V_31 -> V_85 . V_2 . V_86 , NULL ) ;
if ( V_5 )
GOTO ( V_87 , V_5 ) ;
...
int F_61 ( struct V_17 * V_18 , T_1 V_19 , T_4 * V_89 ,
T_3 V_90 , const struct V_91 * V_92 )
{
struct V_64 V_93 = { 0 } ;
struct V_21 * V_22 ;
int V_5 ;
V_18 -> V_40 |= V_94 ;
V_5 = F_62 ( V_18 -> V_60 , V_19 , & V_93 ) ;
if ( V_5 == 0 ) {
* V_89 = V_93 . V_95 ;
return 0 ;
}
