...
return ! ! ( F_1 ( F_20 ( V_44 ) , V_48 ) & V_6 ) ;
else
return ! ! ( F_1 ( F_20 ( V_44 ) , V_49 ) & V_6 ) ;
}
...
F_48 ( V_26 ) ;
F_49 ( V_26 ) ;
V_74 = F_50 ( V_25 , V_80 , 0 ) ;
V_34 = F_50 ( V_25 , V_81 , 0 ) ;
if ( ! V_74 || ! V_34 ) {
F_51 ( V_26 , L_5 ) ;
V_61 = - V_33 ;
goto V_79;
}
V_2 -> V_4 = F_52 ( V_26 , V_74 -> V_82 , F_53 ( V_74 ) ) ;
if ( ! V_2 -> V_4 ) {
F_51 ( V_26 , L_6 ) ;
V_61 = - V_83 ;
goto V_79;
...
if ( V_2 -> V_20 . V_105 ) {
V_61 = F_58 ( V_43 , V_2 -> V_20 . V_105 , 0 ,
V_43 -> V_4 , V_43 -> V_93 ) ;
if ( V_61 < 0 )
F_42 ( V_26 , L_12 ) ;
}
...
static int F_62 ( struct V_72 * V_25 )
{
struct V_1 * V_2 = F_63 ( V_25 ) ;
F_64 ( & V_2 -> V_43 ) ;
F_59 ( V_2 -> V_40 ) ;
F_60 ( & V_25 -> V_26 ) ;
F_61 ( & V_25 -> V_26 ) ;
