...
struct V_1 , V_60 ) ;
F_38 ( & V_5 -> V_103 -> V_60 ) ;
F_49 ( & V_5 -> V_103 -> V_3 , V_105 ) ;
}
}
static int F_50 ( struct V_25 * V_25 , void * V_106 ,
struct V_107 * V_108 )
{
struct V_4 * V_5 = F_9 ( V_25 ) ;
...
return - V_109 ;
V_29 -> V_34 = true ;
return F_52 ( V_49 , V_108 ) ;
}
static int F_53 ( struct V_25 * V_25 , void * V_106 ,
struct V_110 * V_59 )
{
struct V_4 * V_5 = F_9 ( V_25 ) ;
...
static int F_64 ( struct V_25 * V_25 , void * V_106 ,
enum V_122 V_123 )
{
struct V_4 * V_5 = F_9 ( V_25 ) ;
...
static int F_67 ( struct V_25 * V_25 , void * V_106 ,
enum V_122 V_123 )
{
struct V_4 * V_5 = F_9 ( V_25 ) ;
struct V_29 * V_32 = V_25 -> V_33 ;
if ( ! V_32 -> V_34 )
return - V_109 ;
return F_66 ( & V_5 -> V_36 , V_123 ) ;
}
static int F_68 ( struct V_25 * V_25 , void * V_106 , T_4 * V_93 )
{
struct V_4 * V_5 = F_9 ( V_25 ) ;
...
static int F_71 ( struct V_25 * V_25 , void * V_106 ,
struct V_126 * V_127 )
{
struct V_4 * V_5 = F_9 ( V_25 ) ;
V_127 -> V_128 = 0 ;
...
static int F_76 ( struct V_25 * V_25 , void * V_106 , unsigned int * V_138 )
{
struct V_4 * V_5 = F_9 ( V_25 ) ;
* V_138 = V_5 -> V_79 ;
return 0 ;
...
static int F_78 ( struct V_4 * V_146 ,
struct V_147 * V_148 ,
struct V_8 * V_149 )
{
...
static int F_81 ( struct V_25 * V_25 , void * V_106 ,
struct V_155 * V_51 )
{
struct V_4 * V_5 = F_9 ( V_25 ) ;
...
if ( F_51 ( & V_5 -> V_36 ) )
return - V_109 ;
V_39 = F_78 ( V_5 , V_148 , & V_149 ) ;
if ( V_39 < 0 )
return V_39 ;
F_79 ( & V_151 , V_148 , V_149 . V_21 ) ;
...
F_82 ( V_162 -> V_165 , V_166 , sizeof( V_162 -> V_165 ) ) ;
F_82 ( V_162 -> V_167 , L_10 , sizeof( V_162 -> V_167 ) ) ;
F_82 ( V_162 -> V_168 , V_5 -> V_76 -> V_169 , sizeof( V_162 -> V_168 ) ) ;
return 0 ;
}
...
static int F_89 ( struct V_25 * V_25 , void * V_106 )
{
struct V_4 * V_5 = F_9 ( V_25 ) ;
F_90 ( & V_5 -> V_30 , 0 , V_174 , V_175 ) ;
return 0 ;
}
static int F_91 ( struct V_176 * V_177 )
{
struct V_4 * V_5 ;
struct V_26 * V_27 ;
struct V_178 * V_179 ;
...
V_5 -> V_76 = V_136 ;
V_5 -> V_66 = F_92 ( V_177 , V_136 -> V_183 ) ;
if ( ! V_5 -> V_66 ) {
...
V_5 -> V_28 = V_27 ;
V_39 = F_97 ( & V_177 -> V_181 , & V_5 -> V_30 ) ;
if ( V_39 ) {
...
T_4 V_93 ;
V_39 = F_4 ( V_5 -> V_13 , V_14 , V_212 , & V_93 ) ;
if ( V_39 ) {
F_10 ( & V_5 -> V_30 ,
L_23 ) ;
goto V_210;
...
static int F_114 ( struct V_176 * V_177 )
{
struct V_214 * V_30 = F_115 ( V_177 ) ;
