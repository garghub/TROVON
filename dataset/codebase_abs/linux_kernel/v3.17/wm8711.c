...
F_17 ( V_16 , V_56 ) ;
F_24 ( V_16 , V_62 , 0x0100 , 0x0100 ) ;
F_24 ( V_16 , V_63 , 0x0100 , 0x0100 ) ;
return V_61 ;
}
...
struct V_17 * V_18 ;
int V_61 ;
V_18 = F_27 ( & V_65 -> V_2 , sizeof( struct V_17 ) ,
V_66 ) ;
if ( V_18 == NULL )
return - V_67 ;
V_18 -> V_60 = F_28 ( V_65 , & V_68 ) ;
if ( F_29 ( V_18 -> V_60 ) )
return F_30 ( V_18 -> V_60 ) ;
F_31 ( V_65 , V_18 ) ;
V_61 = F_32 ( & V_65 -> V_2 ,
& V_69 , & V_70 , 1 ) ;
return V_61 ;
...
struct V_17 * V_18 ;
int V_61 ;
V_18 = F_27 ( & V_72 -> V_2 , sizeof( struct V_17 ) ,
V_66 ) ;
if ( V_18 == NULL )
return - V_67 ;
V_18 -> V_60 = F_36 ( V_72 , & V_68 ) ;
if ( F_29 ( V_18 -> V_60 ) )
return F_30 ( V_18 -> V_60 ) ;
F_37 ( V_72 , V_18 ) ;
V_61 = F_32 ( & V_72 -> V_2 ,
