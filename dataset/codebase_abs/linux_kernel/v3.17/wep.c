...
struct V_45 * V_46 = F_37 ( V_14 ) ;
struct V_15 * V_16 = (struct V_15 * ) V_14 -> V_17 ;
T_6 V_47 = V_16 -> V_22 ;
if ( ! F_38 ( V_47 ) && ! F_39 ( V_47 ) )
return V_48 ;
if ( ! ( V_46 -> V_49 & V_50 ) ) {
if ( F_40 ( V_44 -> V_14 ) )
return V_51 ;
if ( F_33 ( V_44 -> V_2 , V_44 -> V_14 , V_44 -> V_30 ) )
return V_51 ;
} else if ( ! ( V_46 -> V_49 & V_52 ) ) {
if ( ! F_41 ( V_44 -> V_14 , F_17 ( V_47 ) +
V_4 ) )
return V_51 ;
F_21 ( V_44 -> V_2 , V_44 -> V_14 , V_44 -> V_30 ) ;
if ( F_42 ( V_44 -> V_14 , V_44 -> V_14 -> V_38 - V_24 ) )
return V_51 ;
}
return V_48 ;
}
static int F_43 ( struct V_53 * V_54 , struct V_13 * V_14 )
{
struct V_18 * V_19 = F_12 ( V_14 ) ;
struct V_55 * V_26 = V_19 -> V_25 . V_26 ;
if ( ! V_26 ) {
if ( F_29 ( V_54 -> V_2 , V_14 , V_54 -> V_30 -> V_42 . V_30 ,
V_54 -> V_30 -> V_42 . V_10 ,
V_54 -> V_30 -> V_42 . V_12 ) )
return - 1 ;
