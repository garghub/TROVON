...
static void F_29 ( struct V_142 * V_143 )
{
struct V_3 * V_144 = F_30 ( V_143 , struct V_3 ,
V_143 ) ;
...
int V_13 ;
T_1 V_12 ;
V_144 = F_33 ( V_2 -> V_42 , sizeof( struct V_3 ) ,
V_145 ) ;
if ( V_144 == NULL )
return - V_146 ;
F_34 ( V_2 , V_144 ) ;
...
F_8 ( V_2 , V_149 ,
V_12 & V_148 ) ;
F_8 ( V_2 , V_150 , 0x50 | ( 1 << 8 ) ) ;
F_8 ( V_2 , V_151 , 0x50 | ( 1 << 8 ) ) ;
if ( ! F_37 ( & V_144 -> V_143 ) )
return - V_43 ;
return 0 ;
}
...
static struct V_152 * F_39 ( struct V_153 * V_42 )
{
