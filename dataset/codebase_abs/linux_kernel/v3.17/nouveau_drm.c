...
static int
F_120 ( struct V_10 * V_11 , bool V_112 )
{
struct V_25 * V_26 = V_25 ( V_11 ) ;
struct V_15 * V_16 ;
F_104 ( V_26 , L_18 ) ;
...
static int F_126 ( struct V_36 * V_11 )
{
struct V_1 * V_2 = F_115 ( V_11 ) ;
struct V_10 * V_119 = F_102 ( V_2 ) ;
return F_120 ( V_119 , false ) ;
...
static int
F_127 ( struct V_10 * V_11 , struct V_125 * V_126 )
{
struct V_25 * V_26 = V_25 ( V_11 ) ;
struct V_15 * V_16 ;
...
return V_18 ;
F_128 ( V_127 , V_130 ) ;
snprintf ( V_3 , sizeof( V_3 ) , L_22 , V_127 , F_129 ( V_126 -> V_131 ) ) ;
...
V_126 -> V_134 = V_16 ;
F_130 ( & V_26 -> V_92 . V_22 ) ;
F_131 ( & V_16 -> V_135 , & V_26 -> V_94 ) ;
F_132 ( & V_26 -> V_92 . V_22 ) ;
V_132:
F_85 ( V_11 -> V_11 ) ;
F_133 ( V_11 -> V_11 ) ;
return V_18 ;
...
static void
F_134 ( struct V_10 * V_11 , struct V_125 * V_126 )
{
...
static void
F_137 ( struct V_10 * V_11 , struct V_125 * V_126 )
{
struct V_15 * V_16 = V_15 ( V_126 ) ;
F_12 ( V_16 ) ;
F_85 ( V_11 -> V_11 ) ;
...
long
F_138 ( struct V_137 * V_137 , unsigned int V_138 , unsigned long V_139 )
{
...
if ( V_18 < 0 && V_18 != - V_129 )
return V_18 ;
switch ( F_139 ( V_138 ) - V_143 ) {
case V_144 :
V_18 = F_140 ( V_140 , ( void V_145 * ) V_139 , F_141 ( V_138 ) ) ;
break;
default:
V_18 = F_142 ( V_137 , V_138 , V_139 ) ;
break;
}
F_85 ( V_11 -> V_11 ) ;
F_133 ( V_11 -> V_11 ) ;
...
static int F_143 ( struct V_36 * V_11 )
{
struct V_1 * V_2 = F_115 ( V_11 ) ;
struct V_10 * V_119 = F_102 ( V_2 ) ;
int V_18 ;
...
struct V_10 *
F_156 ( struct V_7 * V_2 , int V_13 ,
void * * V_157 )
{
struct V_10 * V_26 ;
int V_158 ;
V_158 = F_157 ( V_2 , V_159 ,
F_5 ( V_2 ) ,
F_158 ( & V_2 -> V_11 ) , V_19 ,
V_20 , V_13 , V_157 ) ;
if ( V_158 )
return F_159 ( V_158 ) ;
V_26 = F_160 ( & V_86 , & V_2 -> V_11 ) ;
if ( ! V_26 ) {
V_158 = - V_23 ;
goto V_160;
}
V_158 = F_161 ( V_26 , L_26 , F_158 ( & V_2 -> V_11 ) ) ;
if ( V_158 < 0 )
goto V_160;
V_26 -> V_8 = V_2 ;
F_162 ( V_2 , V_26 ) ;
