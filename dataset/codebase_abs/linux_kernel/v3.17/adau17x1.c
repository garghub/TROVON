...
if ( V_6 -> V_157 )
V_6 -> V_157 ( V_7 -> V_132 ) ;
V_7 -> V_154 -> V_155 ( V_7 , V_158 ) ;
F_40 ( V_6 -> V_10 ) ;
return 0 ;
}
int F_41 ( struct V_131 * V_132 , struct V_10 * V_10 ,
enum V_159 type , void (* V_157)( struct V_131 * V_132 ) )
{
struct V_6 * V_6 ;
if ( F_42 ( V_10 ) )
return F_43 ( V_10 ) ;
V_6 = F_44 ( V_132 , sizeof( * V_6 ) , V_160 ) ;
if ( ! V_6 )
return - V_161 ;
V_6 -> V_10 = V_10 ;
V_6 -> V_157 = V_157 ;
