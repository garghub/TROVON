...
V_23 |= V_35 ;
F_113 ( F_6 ( V_23 ) ,
& V_83 . V_151 . V_18 , & V_83 . V_151 . V_11 ) ;
V_12 = F_114 ( F_6 ( V_23 ) ,
V_83 . V_151 . V_18 , V_83 . V_151 . V_11 ) ;
} else {
V_12 = F_56 ( V_83 . V_86 ) ;
...
V_8 -> V_23 = V_23 ;
if ( V_23 & V_24 ) {
V_8 -> V_18 = V_83 . V_151 . V_18 ;
V_8 -> V_11 = V_83 . V_151 . V_11 ;
}
if ( V_23 & ( V_55 | V_148 ) ) {
F_117 ( V_20 , V_2 , V_12 ) ;
} else {
...
if ( V_33 )
goto V_67;
V_150 = F_119 ( V_2 -> V_26 ) -> V_22 ;
F_120 ( V_150 , V_153 | V_154 ) ;
}
return V_2 ;
V_67:
if ( V_2 )
...
void F_121 ( struct V_29 * V_20 )
{
struct V_96 * V_97 = V_20 -> V_98 ;
const enum V_3 V_155 [] = {
V_156 , V_157 , V_158
} ;
int V_19 , V_159 ;
if ( ! F_122 () ) {
F_123 ( V_20 -> V_20 , L_25 ) ;
return;
}
V_10 = F_124 ( 3 , sizeof( * V_10 ) , V_37 ) ;
if ( ! V_10 )
return;
for ( V_19 = 0 ; V_19 < F_42 ( V_155 ) ; V_19 ++ ) {
T_6 V_45 = 1 , V_44 = V_13 >> V_19 ;
F_113 ( V_155 [ V_19 ] , & V_44 , & V_45 ) ;
V_10 [ V_19 ] . V_11 = V_45 ;
V_10 [ V_19 ] . V_61 = F_125 ( V_45 ) ;
V_10 [ V_19 ] . V_65 = F_73 ( V_155 [ V_19 ] , 0 ) >> V_16 ;
V_10 [ V_19 ] . V_62 = F_125 ( ( V_13 / V_45 ) >> V_19 ) ;
for ( V_159 = 0 ; V_159 < V_25 ; V_159 ++ ) {
struct V_5 * V_6 = & V_10 [ V_19 ] . V_6 [ V_159 ] ;
struct V_101 * V_64 =
F_64 ( V_155 [ V_19 ] , V_44 , V_45 ,
V_13 ) ;
if ( F_12 ( V_64 ) ) {
F_13 ( V_20 -> V_20 ,
L_26 ,
V_19 , V_159 , F_14 ( V_64 ) ) ;
return;
}
V_6 -> V_56 = F_67 ( V_64 ) ;
V_6 -> V_64 = V_64 ;
F_47 ( L_27 , V_19 , V_159 , V_44 , V_45 ,
& V_6 -> V_56 ,
V_10 [ V_19 ] . V_65 << V_16 ) ;
}
}
