...
if ( V_43 -> type == V_122 )
V_43 -> V_181 -> V_216 |= V_217 ;
else
V_43 -> V_181 -> V_216 |= V_218 ;
F_73 ( & V_35 -> V_207 ) ;
return 0 ;
}
...
const struct V_219 * V_36 )
{
struct V_143 * V_65 = F_86 ( V_53 ) ;
struct V_34 * V_35 ;
int V_112 ;
if ( V_36 -> V_147 && V_36 -> V_220 )
F_16 ( V_183 , L_97
L_98 , V_65 -> V_221 , V_36 -> V_147 ,
V_36 -> V_220 ) ;
else
F_16 ( V_183 , L_99 ,
V_65 -> V_221 ) ;
...
? V_36 -> V_225 : V_224 ;
if ( V_65 -> V_226 != NULL )
F_17 ( V_35 -> V_69 , V_65 -> V_226 , sizeof V_35 -> V_69 ) ;
else
snprintf ( V_35 -> V_69 , sizeof V_35 -> V_69 ,
L_100 ,
F_31 ( V_65 -> V_146 . V_147 ) ,
F_31 ( V_65 -> V_146 . V_220 ) ) ;
if ( F_42 ( V_35 ) < 0 ) {
F_16 ( V_183 , L_101
L_102 ) ;
goto error;
...
V_65 -> V_226 ? V_65 -> V_226 : L_104 ,
F_31 ( V_65 -> V_146 . V_147 ) ,
F_31 ( V_65 -> V_146 . V_220 ) ) ;
if ( V_35 -> V_97 != V_36 -> V_225 ) {
F_18 ( V_71 , L_105
L_106 , V_35 -> V_97 ) ;
F_18 ( V_71 , L_107
L_108 ) ;
...
F_17 ( V_35 -> V_204 . V_227 , V_35 -> V_69 , sizeof( V_35 -> V_204 . V_227 ) ) ;
if ( V_65 -> V_228 )
F_17 ( V_35 -> V_204 . V_228 , V_65 -> V_228 ,
sizeof( V_35 -> V_204 . V_228 ) ) ;
strcpy ( V_35 -> V_204 . V_229 , V_65 -> V_221 ) ;
V_35 -> V_204 . V_230 = F_31 ( V_65 -> V_146 . V_231 ) ;
V_35 -> V_204 . V_232 = V_233 ;
if ( F_89 ( & V_35 -> V_204 ) < 0 )
goto error;
V_35 -> V_203 . V_204 = & V_35 -> V_204 ;
#endif
if ( F_90 ( & V_53 -> V_35 , & V_35 -> V_203 ) < 0 )
goto error;
if ( F_91 ( V_35 ) < 0 )
goto error;
if ( F_54 ( V_35 ) < 0 )
...
static int F_97 ( struct V_52 * V_53 , T_7 V_237 )
{
struct V_34 * V_35 = F_96 ( V_53 ) ;
struct V_42 * V_43 ;
F_16 ( V_238 , L_113 ,
...
static int F_102 ( struct V_52 * V_53 , int V_241 )
{
struct V_34 * V_35 = F_96 ( V_53 ) ;
struct V_42 * V_43 ;
F_16 ( V_238 , L_116 ,
...
F_98 ( & V_35 -> V_223 ) ;
if ( V_35 -> V_240 )
V_112 = F_104 ( V_35 , V_242 ) ;
F_100 ( & V_35 -> V_223 ) ;
return V_112 ;
}
F_10 (stream, &dev->streams, list) {
if ( V_43 -> V_53 == V_53 )
return F_105 ( V_43 , V_241 ) ;
}
F_16 ( V_238 , L_117
L_115 ) ;
return - V_68 ;
...
static int F_108 ( char * V_50 , struct V_243 * V_244 )
{
if ( V_245 == V_246 )
...
static int F_109 ( const char * V_247 , struct V_243 * V_244 )
{
if ( strncasecmp ( V_247 , L_120 , strlen ( L_120 ) ) == 0 )
V_247 += strlen ( L_120 ) ;
if ( strcasecmp ( V_247 , L_121 ) == 0 )
V_245 = V_246 ;
else if ( strcasecmp ( V_247 , L_122 ) == 0 )
V_245 = V_248 ;
else
return - V_68 ;
return 0 ;
