...
{
struct V_79 * V_80 = V_13 -> V_44 -> V_81 ;
if ( ! V_13 -> V_60 )
return false ;
if ( ! V_80 -> V_82 . V_83 )
return false ;
...
static bool F_36 ( const struct V_12 * V_13 ,
const struct V_23 * V_24 ,
const T_1 * V_26 ,
const bool V_86 ,
bool * V_87 )
...
if ( ( V_24 -> V_64 & V_89 ) && ! V_86 ) {
F_2 ( L_11 ,
* V_26 ) ;
return false ;
}
if ( V_24 -> V_64 & V_90 ) {
T_1 V_91 = V_26 [ V_24 -> V_92 . V_93 ] & V_24 -> V_92 . V_28 ;
if ( V_91 == V_94 ) {
if ( V_24 -> V_26 . V_27 == V_95 )
return false ;
if ( V_24 -> V_26 . V_27 == F_37 ( 1 ) )
* V_87 = ( V_26 [ 2 ] != 0 ) ;
}
if ( ! F_28 ( V_13 -> V_31 ,
V_13 -> V_32 , V_91 ) ) {
...
T_1 V_98 ;
if ( V_24 -> V_99 [ V_17 ] . V_28 == 0 )
break;
if ( V_24 -> V_99 [ V_17 ] . V_100 != 0 ) {
T_1 V_93 =
V_24 -> V_99 [ V_17 ] . V_101 ;
T_1 V_102 = V_26 [ V_93 ] &
V_24 -> V_99 [ V_17 ] . V_100 ;
if ( V_102 == 0 )
continue;
}
V_98 = V_26 [ V_24 -> V_99 [ V_17 ] . V_93 ] &
V_24 -> V_99 [ V_17 ] . V_28 ;
if ( V_98 != V_24 -> V_99 [ V_17 ] . V_103 ) {
F_2 ( L_13 ,
* V_26 ,
V_24 -> V_99 [ V_17 ] . V_28 ,
V_24 -> V_99 [ V_17 ] . V_103 ,
V_98 , V_13 -> V_29 ) ;
return false ;
}
}
...
{
int V_18 = 0 ;
T_1 * V_26 , * V_106 , * V_107 ;
struct V_23 V_63 = { 0 } ;
int V_108 = 0 ;
bool V_87 = false ;
V_18 = F_39 ( V_104 , & V_108 ) ;
if ( V_18 ) {
F_2 ( L_14 ) ;
return V_18 ;
}
...
if ( V_108 )
F_41 ( ( char * ) V_106 , V_104 -> V_74 . V_75 ) ;
V_26 = V_106 + ( V_105 / sizeof( * V_26 ) ) ;
V_107 = V_26 + ( V_104 -> V_74 . V_75 / sizeof( * V_107 ) ) ;
while ( V_26 < V_107 ) {
const struct V_23 * V_24 ;
T_1 V_66 ;
if ( * V_26 == V_109 )
...
if ( V_24 -> V_64 & V_111 )
V_66 = V_24 -> V_66 . V_112 ;
else
V_66 = ( ( * V_26 & V_24 -> V_66 . V_28 ) + V_113 ) ;
if ( ( V_107 - V_26 ) < V_66 ) {
F_2 ( L_17 ,
* V_26 ,
V_66 ,
...
if ( ! F_36 ( V_13 , V_24 , V_26 , V_86 , & V_87 ) ) {
V_18 = - V_110 ;
break;
}
V_26 += V_66 ;
