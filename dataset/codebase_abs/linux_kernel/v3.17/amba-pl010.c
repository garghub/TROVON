...
if ( V_152 == F_66 ( V_141 ) )
return - V_129 ;
V_4 = F_67 ( & V_79 -> V_79 , sizeof( struct V_3 ) ,
V_153 ) ;
if ( ! V_4 )
return - V_154 ;
V_151 = F_68 ( & V_79 -> V_79 , V_79 -> V_155 . V_156 ,
F_69 ( & V_79 -> V_155 ) ) ;
if ( ! V_151 )
return - V_154 ;
V_4 -> V_86 = F_70 ( & V_79 -> V_79 , NULL ) ;
if ( F_71 ( V_4 -> V_86 ) )
return F_72 ( V_4 -> V_86 ) ;
...
V_141 [ V_152 ] = V_4 ;
F_74 ( V_79 , V_4 ) ;
V_133 = F_75 ( & V_162 , & V_4 -> V_2 ) ;
if ( V_133 )
V_141 [ V_152 ] = NULL ;
return V_133 ;
}
static int F_76 ( struct V_148 * V_79 )
{
struct V_3 * V_4 = F_77 ( V_79 ) ;
int V_152 ;
F_78 ( & V_162 , & V_4 -> V_2 ) ;
for ( V_152 = 0 ; V_152 < F_66 ( V_141 ) ; V_152 ++ )
if ( V_141 [ V_152 ] == V_4 )
...
static int F_79 ( struct V_163 * V_79 )
{
...
static int F_82 ( struct V_163 * V_79 )
{
struct V_3 * V_4 = F_80 ( V_79 ) ;
if ( V_4 )
F_83 ( & V_162 , & V_4 -> V_2 ) ;
