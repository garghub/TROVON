...
return V_30 ;
if ( V_41 -> V_48 != V_49 )
* V_32 = V_30 & F_26 ( V_41 -> V_50 . V_51 - 1 , 0 ) ;
return V_52 ;
case V_53 :
switch ( V_41 -> type ) {
case V_54 :
...
static int F_27 ( struct V_60 * V_25 )
{
struct V_61 * V_62 = V_25 -> V_63 . V_64 ;
struct V_4 * V_5 ;
struct V_1 * V_2 ;
int V_30 ;
V_2 = F_28 ( & V_25 -> V_63 , sizeof( * V_5 ) ) ;
if ( V_2 == NULL )
return - V_65 ;
V_5 = F_2 ( V_2 ) ;
if ( V_62 && V_62 -> V_12 )
...
F_33 ( V_25 , V_2 ) ;
V_5 -> V_25 = V_25 ;
V_2 -> V_67 = F_34 ( V_25 ) -> V_67 ;
V_2 -> V_63 . V_68 = & V_25 -> V_63 ;
V_2 -> V_69 = V_70 ;
V_2 -> V_71 = V_72 ;
V_2 -> V_73 = F_35 ( V_72 ) ;
V_2 -> V_74 = & V_75 ;
V_5 -> V_76 [ 0 ] . V_14 = & V_5 -> V_14 [ 0 ] ;
V_5 -> V_76 [ 0 ] . V_16 = 2 ;
V_5 -> V_76 [ 0 ] . V_17 = 1 ;
V_5 -> V_76 [ 1 ] . V_14 = & V_5 -> V_14 [ 1 ] ;
V_5 -> V_76 [ 1 ] . V_16 = 2 ;
V_5 -> V_76 [ 1 ] . V_17 = 1 ;
V_5 -> V_76 [ 2 ] . V_19 = & V_5 -> V_19 [ 0 ] ;
V_5 -> V_76 [ 2 ] . V_16 = 2 ;
F_7 ( & V_5 -> V_31 ) ;
F_8 ( & V_5 -> V_76 [ 0 ] , & V_5 -> V_31 ) ;
F_8 ( & V_5 -> V_76 [ 1 ] , & V_5 -> V_31 ) ;
F_8 ( & V_5 -> V_76 [ 2 ] , & V_5 -> V_31 ) ;
V_30 = F_36 ( V_2 , NULL ,
& F_9 , NULL ) ;
if ( V_30 )
goto V_77;
...
static int F_40 ( struct V_60 * V_25 )
{
