...
V_149 = & V_20 -> V_149 [ V_36 ] ;
V_143 = F_59 ( F_60 ( F_61 () , V_152 ) ) ;
if ( V_149 -> V_154 < V_143 )
V_149 -> V_154 = V_143 ;
V_149 -> V_155 ++ ;
V_149 -> V_156 += V_143 ;
if ( ! V_149 -> V_157 )
...
static void F_62 ( struct V_19 * V_20 , struct V_3 * V_4 )
{
struct V_7 * V_8 = F_3 ( V_4 ) ;
if ( ( V_8 -> V_12 & V_160 ) &&
! ( V_8 -> V_12 & V_161 ) )
...
if ( ++ V_20 -> V_162 < V_163 )
return;
F_63 ( V_20 -> V_28 -> V_135 , V_20 -> V_20 . V_48 ,
V_20 -> V_162 , V_137 ) ;
V_20 -> V_162 = 0 ;
}
...
int V_92 ;
int V_93 = 0 ;
for ( V_144 = 0 ; V_144 < V_171 ; V_144 ++ ) {
if ( ( V_8 -> V_12 & V_160 ) &&
! ( V_8 -> V_12 & V_161 ) ) {
V_8 -> V_84 . V_85 [ V_144 ] . V_86 = - 1 ;
V_8 -> V_84 . V_85 [ V_144 ] . V_172 = 0 ;
break;
} else if ( V_8 -> V_84 . V_85 [ V_144 ] . V_86 < 0 ) {
break;
} else if ( V_144 >= V_2 -> V_173 ) {
V_8 -> V_84 . V_85 [ V_144 ] . V_86 = - 1 ;
V_8 -> V_84 . V_85 [ V_144 ] . V_172 = 0 ;
break;
}
V_91 += V_8 -> V_84 . V_85 [ V_144 ] . V_172 ;
}
V_167 = V_144 - 1 ;
if ( V_91 < 0 )
V_91 = 0 ;
F_41 () ;
V_90 = V_6 -> V_2 . V_174 -> V_175 [ V_8 -> V_176 ] ;
V_147 = V_22 -> V_33 ;
F_65 (local, hdr->addr1, sta, tmp) {
if ( ! F_66 ( V_22 -> V_177 , V_20 -> V_28 -> V_27 . V_48 ) )
continue;
V_93 = F_67 ( & V_20 -> V_28 -> V_27 ) ;
if ( V_8 -> V_12 & V_178 )
F_68 ( V_20 , V_179 ) ;
...
if ( F_69 ( & V_20 -> V_28 -> V_27 ) &&
F_12 ( V_147 ) )
F_70 (
F_13 ( V_22 ) ,
V_20 , true , V_130 ) ;
if ( ( V_6 -> V_2 . V_12 & V_180 ) &&
( F_58 ( V_22 -> V_33 ) ) &&
( V_167 != - 1 ) )
V_20 -> V_181 = V_8 -> V_84 . V_85 [ V_167 ] ;
if ( ( V_8 -> V_12 & V_182 ) &&
( F_12 ( V_147 ) ) ) {
T_2 V_36 , V_81 ;
T_1 * V_59 ;
...
if ( ! V_130 && F_72 ( V_147 ) ) {
T_2 V_36 , V_25 ;
V_170 = (struct V_169 * ) V_4 -> V_23 ;
V_25 = F_71 ( V_170 -> V_25 ) ;
if ( ! ( V_25 & V_185 ) ) {
T_2 V_81 = F_71 ( V_170 -> V_186 ) ;
V_36 = ( V_25 &
V_187 ) >>
V_188 ;
F_29 ( V_20 , V_36 , V_81 ) ;
...
F_73 ( V_6 , V_90 , V_20 , V_4 ) ;
if ( F_69 ( & V_20 -> V_28 -> V_27 ) )
F_74 ( V_6 , V_20 , V_4 ) ;
if ( ! ( V_8 -> V_12 & V_192 ) && V_130 )
F_25 ( V_20 , V_4 ) ;
if ( ( V_20 -> V_28 -> V_27 . type == V_76 ) &&
( V_6 -> V_2 . V_12 & V_57 ) )
F_75 ( V_20 -> V_28 , ( void * ) V_4 -> V_23 , V_130 ) ;
if ( V_6 -> V_2 . V_12 & V_57 ) {
if ( V_8 -> V_12 & V_105 ) {
if ( V_20 -> V_162 )
V_20 -> V_162 = 0 ;
...
if ( F_44 ( V_147 ) && F_79 ( V_147 ) &&
( V_6 -> V_2 . V_12 & V_57 ) &&
! ( V_8 -> V_12 & V_192 ) &&
V_6 -> V_201 && ! ( V_6 -> V_202 ) ) {
if ( V_8 -> V_12 & V_105 ) {
V_6 -> V_201 -> V_61 . V_203 . V_12 |=
V_204 ;
} else
F_18 ( & V_6 -> V_205 , V_26 +
F_80 ( 10 ) ) ;
...
F_40 ( V_6 , V_4 , false ) ;
F_81 ( V_4 ) ;
V_168 = ! ! ( V_8 -> V_12 & V_192 ) ||
! ( F_58 ( V_147 ) ) ;
if ( ! V_6 -> V_206 && ( ! V_168 || ! V_6 -> V_207 ) ) {
F_82 ( V_4 ) ;
return;
}
V_92 = F_30 ( V_8 ) ;
...
V_4 -> V_208 = V_209 ;
V_4 -> V_10 = V_210 ;
V_4 -> V_211 = F_87 ( V_212 ) ;
memset ( V_4 -> V_213 , 0 , sizeof( V_4 -> V_213 ) ) ;
F_41 () ;
F_42 (sdata, &local->interfaces, list) {
if ( V_28 -> V_27 . type == V_214 ) {
if ( ! F_27 ( V_28 ) )
continue;
if ( ( V_28 -> V_61 . V_215 & V_216 ) &&
! V_168 )
continue;
if ( V_166 ) {
V_164 = F_88 ( V_4 , V_137 ) ;
if ( V_164 ) {
V_164 -> V_135 = V_166 ;
F_89 ( V_164 ) ;
}
...
void F_90 ( struct V_217 * V_218 , T_4 V_219 )
{
struct V_19 * V_20 = F_91 ( V_218 , struct V_19 , V_20 ) ;
F_63 ( V_20 -> V_28 -> V_135 , V_20 -> V_20 . V_48 ,
V_219 , V_137 ) ;
}
