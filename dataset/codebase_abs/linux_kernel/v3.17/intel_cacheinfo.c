...
int type , char * V_60 )
{
T_4 V_131 = F_61 ( V_60 + V_132 - 1 , V_132 ) - V_60 ;
int V_104 = 0 ;
if ( V_131 > 1 ) {
const struct V_133 * V_134 ;
V_134 = F_24 ( V_54 -> V_73 ) ;
V_104 = type ?
F_62 ( V_60 , V_131 - 2 , V_134 ) :
F_63 ( V_60 , V_131 - 2 , V_134 ) ;
V_60 [ V_104 ++ ] = '\n' ;
V_60 [ V_104 ] = '\0' ;
}
return V_104 ;
...
if ( F_16 ( V_74 ) )
V_104 += 1 ;
V_137 = F_57 ( V_104 * sizeof ( struct V_136 * ) , V_129 ) ;
if ( V_137 == NULL )
return V_137 = V_138 ;
for ( V_104 = 0 ; V_138 [ V_104 ] ; V_104 ++ )
V_137 [ V_104 ] = V_138 [ V_104 ] ;
if ( F_16 ( V_62 ) ) {
V_137 [ V_104 ++ ] = & V_139 . V_140 ;
V_137 [ V_104 ++ ] = & V_141 . V_140 ;
}
if ( F_16 ( V_74 ) )
V_137 [ V_104 ++ ] = & V_49 . V_140 ;
return V_137 ;
}
static T_2 F_69 ( struct V_142 * V_143 , struct V_136 * V_140 , char * V_60 )
{
struct V_144 * V_145 = F_70 ( V_140 ) ;
struct V_146 * V_54 = F_71 ( V_143 ) ;
T_2 V_67 ;
V_67 = V_145 -> F_69 ?
V_145 -> F_69 ( F_42 ( V_54 -> V_64 , V_54 -> V_55 ) ,
V_60 , V_54 -> V_64 ) :
0 ;
return V_67 ;
}
static T_2 F_72 ( struct V_142 * V_143 , struct V_136 * V_140 ,
const char * V_60 , T_3 V_69 )
{
struct V_144 * V_145 = F_70 ( V_140 ) ;
struct V_146 * V_54 = F_71 ( V_143 ) ;
T_2 V_67 ;
V_67 = V_145 -> F_72 ?
V_145 -> F_72 ( F_42 ( V_54 -> V_64 , V_54 -> V_55 ) ,
V_60 , V_69 , V_54 -> V_64 ) :
0 ;
return V_67 ;
}
...
F_53 ( F_40 ( V_148 , V_64 ) ) ;
F_40 ( V_147 , V_64 ) = NULL ;
F_40 ( V_148 , V_64 ) = NULL ;
F_52 ( V_64 ) ;
}
...
return V_70 ;
F_40 ( V_147 , V_64 ) =
F_57 ( sizeof( struct V_142 ) , V_129 ) ;
if ( F_55 ( F_40 ( V_147 , V_64 ) == NULL ) )
goto V_149;
F_40 ( V_148 , V_64 ) = F_57 (
sizeof( struct V_146 ) * V_86 , V_129 ) ;
if ( F_55 ( F_40 ( V_148 , V_64 ) == NULL ) )
goto V_149;
return 0 ;
V_149:
F_73 ( V_64 ) ;
...
if ( F_55 ( V_99 < 0 ) )
return V_99 ;
V_99 = F_76 ( F_40 ( V_147 , V_64 ) ,
& V_154 ,
& V_151 -> V_143 , L_10 , L_11 ) ;
if ( V_99 < 0 ) {
F_73 ( V_64 ) ;
return V_99 ;
}
for ( V_66 = 0 ; V_66 < V_86 ; V_66 ++ ) {
V_153 = F_77 ( V_64 , V_66 ) ;
V_153 -> V_64 = V_64 ;
V_153 -> V_55 = V_66 ;
V_54 = F_42 ( V_64 , V_66 ) ;
V_155 . V_138 = V_138 ;
...
V_155 . V_138 = F_67 () ;
#endif
V_99 = F_76 ( & ( V_153 -> V_143 ) ,
& V_155 ,
F_40 ( V_147 , V_64 ) ,
L_12 , V_66 ) ;
if ( F_55 ( V_99 ) ) {
for ( V_103 = 0 ; V_103 < V_66 ; V_103 ++ )
F_79 ( & ( F_77 ( V_64 , V_103 ) -> V_143 ) ) ;
F_79 ( F_40 ( V_147 , V_64 ) ) ;
F_73 ( V_64 ) ;
return V_99 ;
}
F_80 ( & ( V_153 -> V_143 ) , V_156 ) ;
}
F_49 ( V_64 , F_24 ( V_157 ) ) ;
F_80 ( F_40 ( V_147 , V_64 ) , V_156 ) ;
return 0 ;
}
...
if ( F_40 ( V_125 , V_64 ) == NULL )
return;
if ( ! F_82 ( V_64 , F_24 ( V_157 ) ) )
return;
F_51 ( V_64 , F_24 ( V_157 ) ) ;
for ( V_66 = 0 ; V_66 < V_86 ; V_66 ++ )
F_79 ( & ( F_77 ( V_64 , V_66 ) -> V_143 ) ) ;
F_79 ( F_40 ( V_147 , V_64 ) ) ;
F_73 ( V_64 ) ;
}
...
{
unsigned int V_64 = ( unsigned long ) V_161 ;
struct V_150 * V_151 ;
V_151 = F_84 ( V_64 ) ;
switch ( V_160 ) {
case V_162 :
