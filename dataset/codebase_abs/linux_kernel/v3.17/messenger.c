...
void F_81 ( struct V_7 * V_8 , void * V_128 ,
const struct V_129 * V_74 ,
struct V_29 * V_30 )
{
F_39 ( L_25 , V_8 ) ;
...
V_142 -> V_149 = V_142 -> V_92 + V_142 -> V_145 <= V_95 ;
}
static struct V_91 *
...
static int F_176 ( struct V_7 * V_8 , unsigned long V_127 )
{
if ( ! V_8 -> V_74 -> V_315 ( V_8 ) ) {
F_39 ( L_111 , V_45 , V_8 ) ;
return - V_316 ;
}
if ( ! F_177 ( V_39 , & V_8 -> V_130 , V_127 ) ) {
F_39 ( L_112 , V_45 , V_8 ) ;
V_8 -> V_74 -> V_108 ( V_8 ) ;
return - V_317 ;
}
...
if ( ! F_9 ( V_8 , V_6 ) )
return false ;
V_67 = F_176 ( V_8 , F_181 ( V_8 -> V_127 ) ) ;
if ( V_67 ) {
F_39 ( L_117 , V_45 ,
V_8 , V_8 -> V_127 ) ;
F_3 ( V_67 == - V_316 ) ;
...
static void V_131 ( struct V_326 * V_130 )
{
struct V_7 * V_8 = F_183 ( V_130 , struct V_7 ,
V_130 . V_130 ) ;
bool V_325 ;
F_75 ( & V_8 -> V_118 ) ;
while ( true ) {
...
F_188 ( & V_30 -> V_32 . V_33 . V_275 , sizeof( V_30 -> V_32 . V_33 . V_275 ) ) ;
F_16 ( V_30 ) ;
V_30 -> V_233 = V_233 ;
F_189 ( & V_30 -> V_52 , 0 ) ;
F_39 ( L_114 , V_45 , V_30 ) ;
}
...
void F_191 ( struct V_7 * V_8 , struct V_35 * V_85 )
{
...
F_3 ( V_85 -> V_8 == NULL ) ;
F_3 ( ! F_71 ( & V_85 -> V_107 ) ) ;
F_192 ( & V_85 -> V_107 , & V_8 -> V_110 ) ;
F_39 ( L_132 , V_85 ,
F_165 ( V_8 -> V_125 ) , F_119 ( V_85 -> V_189 . type ) ,
F_173 ( F_119 ( V_85 -> V_189 . type ) ) ,
F_118 ( V_85 -> V_189 . V_191 ) ,
...
static struct V_38 * F_196 ( enum V_332 type )
{
struct V_38 * V_139 ;
if ( F_37 ( ! F_197 ( type ) ) )
return NULL ;
V_139 = F_198 ( V_37 , V_71 ) ;
if ( V_139 )
V_139 -> type = type ;
F_83 ( & V_139 -> V_174 ) ;
return V_139 ;
}
static void F_199 ( struct V_38 * V_139 )
{
if ( ! V_139 )
return;
...
void F_202 ( struct V_35 * V_85 , struct V_91 * * V_158 ,
T_1 V_93 , T_1 V_159 )
{
struct V_38 * V_139 ;
F_3 ( ! V_158 ) ;
...
F_192 ( & V_139 -> V_174 , & V_85 -> V_139 ) ;
V_85 -> V_172 += V_93 ;
}
void F_203 ( struct V_35 * V_85 ,
struct V_165 * V_166 )
{
struct V_38 * V_139 ;
F_3 ( ! V_166 ) ;
...
void F_204 ( struct V_35 * V_85 , struct V_143 * V_143 ,
T_1 V_93 )
{
struct V_38 * V_139 ;
F_3 ( ! V_143 ) ;
...
struct V_35 * F_205 ( int type , int V_191 , T_6 V_9 ,
bool V_333 )
{
struct V_35 * V_177 ;
V_177 = F_198 ( V_34 , V_9 ) ;
if ( V_177 == NULL )
goto V_231;
V_177 -> V_189 . type = F_206 ( type ) ;
V_177 -> V_189 . V_334 = F_206 ( V_335 ) ;
V_177 -> V_189 . V_191 = F_122 ( V_191 ) ;
F_83 ( & V_177 -> V_107 ) ;
F_207 ( & V_177 -> V_336 ) ;
F_83 ( & V_177 -> V_139 ) ;
if ( V_191 ) {
V_177 -> V_193 . V_102 = F_208 ( V_191 , V_9 ) ;
...
static int F_209 ( struct V_7 * V_8 , struct V_35 * V_85 )
{
...
static void F_211 ( struct V_35 * V_177 )
{
F_39 ( L_114 , V_45 , V_177 ) ;
F_212 ( V_177 -> V_193 . V_102 ) ;
F_201 ( V_34 , V_177 ) ;
}
static void F_213 ( struct V_336 * V_336 )
{
struct V_35 * V_177 = F_183 ( V_336 , struct V_35 , V_336 ) ;
F_214 ( V_139 ) ;
struct V_107 * V_174 ;
struct V_107 * V_340 ;
F_39 ( L_114 , V_45 , V_177 ) ;
...
F_185 ( & V_177 -> V_139 , & V_139 ) ;
F_216 (links, next, &data) {
struct V_38 * V_139 ;
V_139 = F_217 ( V_174 , struct V_38 , V_174 ) ;
F_68 ( V_174 ) ;
F_199 ( V_139 ) ;
}
V_177 -> V_172 = 0 ;
if ( V_177 -> V_341 )
F_218 ( V_177 -> V_341 , V_177 ) ;
else
F_211 ( V_177 ) ;
}
struct V_35 * F_116 ( struct V_35 * V_85 )
{
F_39 ( L_144 , V_45 , V_85 ,
F_45 ( & V_85 -> V_336 . V_342 ) ) ;
F_219 ( & V_85 -> V_336 ) ;
return V_85 ;
}
void F_69 ( struct V_35 * V_85 )
{
F_39 ( L_144 , V_45 , V_85 ,
F_45 ( & V_85 -> V_336 . V_342 ) ) ;
F_220 ( & V_85 -> V_336 , F_213 ) ;
}
void F_221 ( struct V_35 * V_85 )
{
F_222 ( L_145 , V_85 ,
