...
unsigned int V_10 ;
V_2 -> V_6 . V_11 ++ ;
F_3 ( V_2 -> V_3 . V_12 . V_10 ) ;
V_10 = V_2 -> V_3 . V_12 . V_10 ;
if ( ! ( V_10 & V_13 ) )
return 0 ;
if ( V_10 & V_14 ) {
V_9 = F_4 ( V_2 ,
...
V_9 = F_16 ( V_2 , V_81 , V_75 , sizeof( * V_75 ) ) ;
if ( V_9 )
return V_9 ;
...
F_21 ( V_2 , V_2 -> V_3 . V_4 -> V_28 ) ;
if ( V_2 -> V_3 . V_4 -> V_28 == V_84 ) {
V_9 = F_22 ( V_2 , V_85 , & V_82 , sizeof( T_2 ) ) ;
if ( V_9 )
return V_9 ;
if ( ! F_23 ( & V_82 ) )
return - V_17 ;
...
int V_9 ;
V_2 -> V_6 . V_92 ++ ;
V_9 = F_22 ( V_2 , V_93 , & V_91 , sizeof( T_2 ) ) ;
if ( V_9 )
return V_9 ;
...
int V_107 , V_108 , V_9 ;
F_30 ( V_2 , & V_107 , & V_108 ) ;
V_105 = F_31 ( V_2 , V_2 -> V_109 -> V_110 . V_111 . V_112 [ V_108 ] ) ;
if ( F_32 ( V_2 -> V_16 , V_105 ) )
return F_33 ( V_2 , V_113 ) ;
V_9 = F_34 ( V_2 , V_105 , 0 ) ;
if ( V_9 != 0 )
return V_9 ;
V_106 = F_31 ( V_2 , V_2 -> V_109 -> V_110 . V_111 . V_112 [ V_107 ] ) ;
if ( F_32 ( V_2 -> V_16 , V_106 ) )
return F_33 ( V_2 , V_113 ) ;
V_9 = F_34 ( V_2 , V_106 , 1 ) ;
if ( V_9 != 0 )
return V_9 ;
V_82 -> V_114 = F_35 ( * V_82 , 4 ) ;
return 0 ;
}
