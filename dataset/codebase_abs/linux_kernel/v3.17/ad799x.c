...
static T_2 F_7 ( int V_9 , void * V_10 )
{
...
struct V_1 * V_2 = F_8 ( V_14 ) ;
F_14 ( V_2 -> V_29 ) ;
V_2 -> V_29 = F_15 ( V_14 -> V_34 , V_35 ) ;
if ( ! V_2 -> V_29 )
return - V_36 ;
V_2 -> V_28 = F_16 ( V_33 , V_14 -> V_37 ) * 2 ;
switch ( V_2 -> V_4 ) {
case V_23 :
case V_24 :
case V_25 :
case V_5 :
case V_6 :
V_2 -> V_20 &= ~ ( F_17 ( 7 , 0 ) << V_22 ) ;
V_2 -> V_20 |= ( * V_33 << V_22 ) ;
return F_1 ( V_2 , V_2 -> V_20 ) ;
default:
return 0 ;
}
}
...
if ( ! ( V_2 -> V_20 & V_71 ) )
return 0 ;
if ( ( V_2 -> V_20 >> V_22 ) & F_19 ( V_42 -> V_49 ) )
return 1 ;
return 0 ;
}
...
static T_2 F_38 ( int V_9 , void * V_80 )
{
...
& V_90 [ V_4 -> V_91 ] ;
V_14 = F_42 ( & V_7 -> V_58 , sizeof( * V_2 ) ) ;
if ( V_14 == NULL )
return - V_36 ;
V_2 = F_8 ( V_14 ) ;
F_43 ( V_7 , V_14 ) ;
V_2 -> V_4 = V_4 -> V_91 ;
if ( V_7 -> V_9 > 0 && V_89 -> V_92 . V_75 )
V_2 -> V_93 = & V_89 -> V_92 ;
else
V_2 -> V_93 = & V_89 -> V_94 ;
...
goto V_96;
V_2 -> V_7 = V_7 ;
V_14 -> V_58 . V_97 = & V_7 -> V_58 ;
V_14 -> V_98 = V_4 -> V_98 ;
V_14 -> V_75 = V_2 -> V_93 -> V_75 ;
V_14 -> V_99 = V_100 ;
V_14 -> V_101 = V_2 -> V_93 -> V_78 ;
V_14 -> V_102 = V_89 -> V_102 ;
