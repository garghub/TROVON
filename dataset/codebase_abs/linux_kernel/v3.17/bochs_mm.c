...
{
int V_78 ;
F_66 ( & V_133 -> V_63 , V_135 ) ;
V_133 -> V_117 = V_117 ;
V_78 = F_67 ( V_80 , & V_133 -> V_63 , & V_136 ) ;
if ( V_78 ) {
F_9 ( L_9 , V_78 ) ;
return V_78 ;
}
...
return F_70 ( - V_127 ) ;
V_117 = F_58 ( V_80 , V_53 , V_135 -> V_139 [ 0 ] ) ;
if ( V_117 == NULL )
return F_70 ( - V_127 ) ;
...
V_78 = F_65 ( V_80 , V_132 , V_135 , V_117 ) ;
if ( V_78 ) {
F_51 ( V_117 ) ;
F_14 ( V_132 ) ;
return F_70 ( V_78 ) ;
