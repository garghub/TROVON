...
static int F_19 ( struct V_41 * V_75 , int V_87 )
{
struct V_5 * V_6 = V_75 -> V_6 ;
F_9 ( V_6 -> V_2 , L_12 , V_33 , V_87 ) ;
if ( V_87 )
F_10 ( V_6 , V_88 , 0x40 , 0x40 ) ;
else
F_10 ( V_6 , V_88 , 0x40 , 0 ) ;
return 0 ;
}
static int F_20 ( struct V_5 * V_6 ,
enum V_89 V_90 )
{
T_2 V_91 = F_15 ( V_6 , V_36 ) & ~ 3 ;
switch ( V_90 ) {
case V_92 :
case V_93 :
V_91 |= 1 ;
...
F_9 ( V_6 -> V_2 , L_13 , V_33 , V_90 , V_91 ) ;
V_6 -> V_95 . V_96 = V_90 ;
return 0 ;
}
...
int V_21 ;
V_27 -> V_51 = V_52 ;
for ( V_21 = 0 ; V_21 < F_6 ( V_101 ) ; V_21 ++ )
F_10 ( V_6 , V_101 [ V_21 ] , 0x100 , 0x100 ) ;
F_20 ( V_6 , V_94 ) ;
return 0 ;
}
...
struct V_26 * V_27 ;
int V_44 ;
V_27 = F_29 ( & V_103 -> V_2 , sizeof( struct V_26 ) ,
V_106 ) ;
if ( V_27 == NULL )
return - V_107 ;
V_27 -> V_100 = F_30 ( V_103 , & V_108 ) ;
if ( F_31 ( V_27 -> V_100 ) ) {
V_44 = F_32 ( V_27 -> V_100 ) ;
F_33 ( & V_103 -> V_2 , L_14 , V_44 ) ;
return V_44 ;
}
F_34 ( V_103 , V_27 ) ;
V_44 = F_35 ( V_27 -> V_100 , V_4 , 0 ) ;
if ( V_44 != 0 ) {
F_33 ( & V_103 -> V_2 , L_15 , V_44 ) ;
return V_44 ;
}
V_44 = F_36 ( & V_103 -> V_2 ,
& V_109 , & V_110 , 1 ) ;
if ( V_44 != 0 ) {
F_33 ( & V_103 -> V_2 , L_16 , V_44 ) ;
return V_44 ;
}
return 0 ;
}
static int F_37 ( struct V_102 * V_111 )
{
F_38 ( & V_111 -> V_2 ) ;
return 0 ;
}
