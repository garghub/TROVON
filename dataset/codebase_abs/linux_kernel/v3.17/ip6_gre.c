...
static inline int F_96 ( struct V_56 * V_57 , struct V_6 * V_7 )
{
struct V_5 * V_17 = F_12 ( V_7 ) ;
const struct V_160 * V_161 = F_97 ( V_57 ) ;
int V_82 = - 1 ;
struct V_128 V_129 ;
T_8 V_127 ;
T_6 V_76 ;
...
if ( V_92 != 0 ) {
if ( V_92 == - V_147 )
F_99 ( V_57 , V_174 , V_175 ,
F_91 ( V_76 ) ) ;
return - 1 ;
}
return 0 ;
}
static inline int F_100 ( struct V_56 * V_57 , struct V_6 * V_7 )
{
struct V_5 * V_17 = F_12 ( V_7 ) ;
...
return - 1 ;
V_61 = F_34 ( V_57 , F_101 ( V_57 ) ) ;
if ( V_61 > 0 ) {
struct V_74 * V_75 ;
V_75 = (struct V_74 * ) & F_101 ( V_57 ) [ V_61 ] ;
if ( V_75 -> V_82 == 0 ) {
F_57 ( V_57 , V_80 ,
V_81 , V_61 + 2 ) ;
return - 1 ;
...
const struct V_63 * V_178 )
{
return F_10 ( & V_17 -> V_28 . V_30 , & V_178 -> V_72 ) ;
}
static int F_104 ( struct V_56 * V_57 , struct V_6 * V_7 )
{
struct V_5 * V_17 = F_12 ( V_7 ) ;
int V_82 = - 1 ;
struct V_128 V_129 ;
...
static T_9 F_105 ( struct V_56 * V_57 ,
struct V_6 * V_7 )
{
struct V_5 * V_17 = F_12 ( V_7 ) ;
...
break;
case F_8 ( V_181 ) :
V_179 = F_100 ( V_57 , V_7 ) ;
break;
default:
V_179 = F_104 ( V_57 , V_7 ) ;
break;
}
if ( V_179 < 0 )
goto V_180;
...
int V_186 = sizeof( struct V_63 ) + 4 ;
if ( V_7 -> type != V_24 ) {
...
V_129 -> V_189 = V_36 -> V_13 ;
V_129 -> V_153 = 0 ;
if ( ! ( V_36 -> V_32 & V_168 ) )
V_129 -> V_153 |= V_171 & V_36 -> V_190 ;
if ( ! ( V_36 -> V_32 & V_177 ) )
V_129 -> V_153 |= V_191 & V_36 -> V_190 ;
...
V_17 -> V_141 = V_186 ;
if ( V_36 -> V_32 & V_192 ) {
int V_197 = ( F_108 ( & V_36 -> V_30 ) &
( V_198 | V_199 ) ) ;
struct V_200 * V_201 = F_109 ( V_17 -> V_12 ,
& V_36 -> V_30 , & V_36 -> V_29 ,
V_36 -> V_13 , V_197 ) ;
if ( V_201 == NULL )
return;
if ( V_201 -> V_135 . V_7 ) {
V_7 -> V_202 = V_201 -> V_135 . V_7 -> V_202 + V_186 ;
if ( V_185 ) {
V_7 -> V_76 = V_201 -> V_135 . V_7 -> V_76 - V_186 ;
if ( ! ( V_17 -> V_28 . V_32 & V_162 ) )
V_7 -> V_76 -= 8 ;
if ( V_7 -> V_76 < V_84 )
V_7 -> V_76 = V_84 ;
...
static void F_114 ( struct V_203 * V_164 ,
const struct V_35 * V_36 )
{
V_164 -> V_138 = V_204 ;
...
case V_209 :
if ( V_7 == V_20 -> V_34 ) {
if ( F_116 ( & V_36 , V_206 -> V_210 . V_211 , sizeof( V_36 ) ) ) {
V_92 = - V_212 ;
break;
}
F_113 ( & V_208 , & V_36 ) ;
V_17 = F_21 ( V_12 , & V_208 , 0 ) ;
if ( V_17 == NULL )
V_17 = F_12 ( V_7 ) ;
}
memset ( & V_36 , 0 , sizeof( V_36 ) ) ;
F_114 ( & V_36 , & V_17 -> V_28 ) ;
if ( F_117 ( V_206 -> V_210 . V_211 , & V_36 , sizeof( V_36 ) ) )
V_92 = - V_212 ;
break;
case V_213 :
case V_214 :
V_92 = - V_215 ;
if ( ! F_118 ( V_12 -> V_216 , V_217 ) )
goto V_218;
V_92 = - V_212 ;
if ( F_116 ( & V_36 , V_206 -> V_210 . V_211 , sizeof( V_36 ) ) )
goto V_218;
...
V_36 . V_158 = 0 ;
F_113 ( & V_208 , & V_36 ) ;
V_17 = F_21 ( V_12 , & V_208 , V_207 == V_213 ) ;
if ( V_7 != V_20 -> V_34 && V_207 == V_214 ) {
if ( V_17 != NULL ) {
if ( V_17 -> V_7 != V_7 ) {
V_92 = - V_220 ;
break;
...
static int F_122 ( struct V_6 * V_7 , int V_224 )
{
if ( V_224 < 68 ||
V_224 > 0xFFF8 - V_7 -> V_202 )
return - V_219 ;
V_7 -> V_76 = V_224 ;
return 0 ;
}
static int F_123 ( struct V_56 * V_57 , struct V_6 * V_7 ,
unsigned short type ,
...
V_7 -> V_227 = F_124 ;
V_7 -> type = V_25 ;
V_7 -> V_202 = V_228 + sizeof( struct V_63 ) + 4 ;
V_7 -> V_76 = V_229 - sizeof( struct V_63 ) - 4 ;
V_17 = F_12 ( V_7 ) ;
if ( ! ( V_17 -> V_28 . V_32 & V_162 ) )
V_7 -> V_76 -= 8 ;
V_7 -> V_32 |= V_230 ;
V_7 -> V_196 = 0 ;
V_7 -> V_231 = sizeof( struct V_1 ) ;
V_7 -> V_232 &= ~ V_233 ;
}
...
memcpy ( V_7 -> V_187 , & V_91 -> V_28 . V_29 , sizeof( struct V_1 ) ) ;
memcpy ( V_7 -> V_188 , & V_91 -> V_28 . V_30 , sizeof( struct V_1 ) ) ;
if ( F_14 ( & V_91 -> V_28 . V_30 ) )
V_7 -> V_140 = & V_235 ;
V_7 -> V_95 = F_127 ( struct V_94 ) ;
if ( ! V_7 -> V_95 )
return - V_236 ;
F_128 (i) {
struct V_94 * V_237 ;
V_237 = F_129 ( V_7 -> V_95 , V_234 ) ;
F_130 ( & V_237 -> V_114 ) ;
}
return 0 ;
}
...
static void F_132 ( struct V_12 * V_12 , struct V_238 * V_239 )
{
struct V_19 * V_20 = F_7 ( V_12 , V_21 ) ;
struct V_6 * V_7 , * V_240 ;
int V_38 ;
F_133 (net, dev, aux)
if ( V_7 -> V_49 == & V_50 ||
V_7 -> V_49 == & V_241 )
...
static int F_142 ( struct V_248 * V_249 [] , struct V_248 * V_65 [] )
{
T_3 V_32 ;
if ( ! V_65 )
return 0 ;
V_32 = 0 ;
if ( V_65 [ V_250 ] )
V_32 |= F_143 ( V_65 [ V_250 ] ) ;
if ( V_65 [ V_251 ] )
V_32 |= F_143 ( V_65 [ V_251 ] ) ;
if ( V_32 & ( V_70 | V_69 ) )
return - V_219 ;
return 0 ;
}
static int F_144 ( struct V_248 * V_249 [] , struct V_248 * V_65 [] )
{
struct V_1 V_71 ;
if ( V_249 [ V_252 ] ) {
if ( F_145 ( V_249 [ V_252 ] ) != V_253 )
return - V_219 ;
if ( ! F_146 ( F_147 ( V_249 [ V_252 ] ) ) )
return - V_254 ;
}
if ( ! V_65 )
goto V_255;
if ( V_65 [ V_256 ] ) {
F_148 ( & V_71 , V_65 [ V_256 ] , sizeof( struct V_1 ) ) ;
if ( F_14 ( & V_71 ) )
return - V_219 ;
}
V_255:
return F_142 ( V_249 , V_65 ) ;
}
static void F_149 ( struct V_248 * V_65 [] ,
struct V_35 * V_28 )
{
...
return;
if ( V_65 [ V_257 ] )
V_28 -> V_13 = F_150 ( V_65 [ V_257 ] ) ;
if ( V_65 [ V_250 ] )
V_28 -> V_104 = F_143 ( V_65 [ V_250 ] ) ;
if ( V_65 [ V_251 ] )
V_28 -> V_52 = F_143 ( V_65 [ V_251 ] ) ;
if ( V_65 [ V_258 ] )
V_28 -> V_31 = F_151 ( V_65 [ V_258 ] ) ;
if ( V_65 [ V_259 ] )
V_28 -> V_158 = F_151 ( V_65 [ V_259 ] ) ;
if ( V_65 [ V_260 ] )
F_148 ( & V_28 -> V_29 , V_65 [ V_260 ] , sizeof( struct V_1 ) ) ;
if ( V_65 [ V_256 ] )
F_148 ( & V_28 -> V_30 , V_65 [ V_256 ] , sizeof( struct V_1 ) ) ;
if ( V_65 [ V_261 ] )
V_28 -> V_154 = F_152 ( V_65 [ V_261 ] ) ;
if ( V_65 [ V_262 ] )
V_28 -> V_82 = F_152 ( V_65 [ V_262 ] ) ;
if ( V_65 [ V_263 ] )
V_28 -> V_190 = F_150 ( V_65 [ V_263 ] ) ;
if ( V_65 [ V_264 ] )
V_28 -> V_32 = F_150 ( V_65 [ V_264 ] ) ;
}
...
static int F_157 ( struct V_12 * V_266 , struct V_6 * V_7 ,
struct V_248 * V_249 [] , struct V_248 * V_65 [] )
{
struct V_5 * V_44 ;
struct V_12 * V_12 = F_5 ( V_7 ) ;
struct V_19 * V_20 = F_7 ( V_12 , V_21 ) ;
...
static int F_159 ( struct V_6 * V_7 , struct V_248 * V_249 [] ,
struct V_248 * V_65 [] )
{
...
static void F_160 ( struct V_6 * V_7 , struct V_238 * V_239 )
{
struct V_12 * V_12 = F_5 ( V_7 ) ;
struct V_19 * V_20 = F_7 ( V_12 , V_21 ) ;
if ( V_7 != V_20 -> V_34 )
...
static T_13 F_161 ( const struct V_6 * V_7 )
{
return
F_162 ( 4 ) +
F_162 ( 2 ) +
...
static int F_163 ( struct V_56 * V_57 , const struct V_6 * V_7 )
{
struct V_5 * V_17 = F_12 ( V_7 ) ;
struct V_35 * V_36 = & V_17 -> V_28 ;
if ( F_164 ( V_57 , V_257 , V_36 -> V_13 ) ||
F_165 ( V_57 , V_250 , V_36 -> V_104 ) ||
F_165 ( V_57 , V_251 , V_36 -> V_52 ) ||
F_166 ( V_57 , V_258 , V_36 -> V_31 ) ||
F_166 ( V_57 , V_259 , V_36 -> V_158 ) ||
F_167 ( V_57 , V_260 , sizeof( struct V_1 ) , & V_36 -> V_29 ) ||
F_167 ( V_57 , V_256 , sizeof( struct V_1 ) , & V_36 -> V_30 ) ||
F_168 ( V_57 , V_261 , V_36 -> V_154 ) ||
F_168 ( V_57 , V_262 , V_36 -> V_82 ) ||
F_166 ( V_57 , V_263 , V_36 -> V_190 ) ||
F_164 ( V_57 , V_264 , V_36 -> V_32 ) )
goto V_268;
return 0 ;
V_268:
return - V_147 ;
}
static int T_14 F_169 ( void )
{
int V_92 ;
F_170 ( L_9 ) ;
V_92 = F_171 ( & V_269 ) ;
