...
struct V_10 * V_11 = F_9 ( V_6 ) ;
int V_4 , V_14 ;
if ( sscanf ( V_9 , L_7 , & V_4 ) != 1 || V_4 < 0 || V_4 > 3 )
return - V_15 ;
...
static T_3 F_11 ( struct V_5 * V_6 ,
struct V_7 * V_8 ,
const char * V_9 , T_4 V_13 )
{
struct V_10 * V_11 = F_9 ( V_6 ) ;
int V_17 , V_14 ;
if ( sscanf ( V_9 , L_7 , & V_17 ) != 1 || V_17 != 1 )
return - V_15 ;
...
static void F_12 ( struct V_18 * V_5 , T_5 V_19 )
{
F_7 ( L_8 , V_19 ) ;
F_13 ( V_5 -> V_20 . V_21 ,
F_14 ( & V_5 -> V_6 ) ,
...
static int F_15 ( struct V_18 * V_5 )
{
F_16 ( & V_5 -> V_6 . V_22 , & V_23 ) ;
if ( V_24 )
V_24 = NULL ;
return 0 ;
}
...
static int F_19 ( struct V_18 * V_16 )
{
struct V_10 * V_11 ;
int V_14 ;
if ( V_24 )
...
return - V_27 ;
F_7 ( L_11 ) ;
V_11 = F_20 ( sizeof( struct V_10 ) , V_28 ) ;
if ( ! V_11 )
return - V_29 ;
V_11 -> V_16 = V_16 ;
V_11 -> V_12 = 2 ;
