...
static struct V_20 * F_71 ( struct V_39 * V_14 ,
T_1 V_88 )
{
struct V_3 * V_4 ;
...
static void F_74 ( struct V_39 * V_14 ,
struct V_20 * V_12 )
{
struct V_3 * V_4 = F_35 ( V_12 ) ;
F_16 ( ! F_75 ( & V_4 -> V_18 . V_89 ) ) ;
F_36 ( V_4 ) ;
}
static int F_76 ( struct V_39 * V_14 , struct V_20 * V_12 ,
T_1 V_88 )
{
struct V_1 * V_2 = F_60 ( V_14 ) ;
struct V_6 * V_7 = F_2 ( V_2 ) ;
...
static int F_79 ( struct V_39 * V_14 , struct V_20 * V_12 )
{
struct V_1 * V_2 = F_60 ( V_14 ) ;
struct V_3 * V_4 = F_35 ( V_12 ) ;
struct V_8 * V_9 = F_3 ( V_2 ) ;
...
static int F_80 ( struct V_39 * V_14 , int V_91 , int V_92 )
{
struct V_1 * V_2 = F_60 ( V_14 ) ;
struct V_8 * V_9 = F_3 ( V_2 ) ;
struct V_6 * V_7 = F_2 ( V_2 ) ;
...
static int F_85 ( struct V_39 * V_14 , int V_94 )
{
return F_80 ( V_14 , V_94 , 0 ) ;
}
static int F_86 ( struct V_39 * V_14 )
{
return F_80 ( V_14 , 1 , 1 ) ;
}
static int F_87 ( struct V_15 * V_16 , T_2 V_5 )
{
struct V_6 * V_7 = F_20 ( V_16 ) ;
struct V_1 * V_34 = F_21 ( V_7 ) ;
struct V_95 * V_96 = F_88 ( V_16 ) ;
struct V_10 * V_11 = F_89 ( V_16 ) ;
unsigned long V_93 ;
int V_28 = 0 ;
F_81 ( V_16 , V_93 ) ;
F_82 ( V_7 , V_5 ) ;
...
static int F_95 ( struct V_15 * V_16 , T_2 V_5 )
{
struct V_6 * V_7 = F_20 ( V_16 ) ;
struct V_95 * V_96 = F_88 ( V_16 ) ;
struct V_1 * V_34 = F_21 ( V_7 ) ;
...
static int F_97 ( struct V_102 * V_30 ,
struct V_103 * V_79 )
{
struct V_6 * V_7 = F_98 ( V_30 ) ;
struct V_15 * V_16 = F_61 ( V_7 ) ;
if ( ! V_79 ||
! V_79 -> V_80 ||
V_79 -> V_104 < V_105 )
...
static int F_100 ( struct V_102 * V_30 )
{
struct V_6 * V_7 = F_98 ( V_30 ) ;
struct V_15 * V_16 = F_61 ( V_7 ) ;
return F_101 ( V_16 ) ;
}
static int F_102 ( struct V_102 * V_30 , int V_106 )
{
struct V_6 * V_7 = F_98 ( V_30 ) ;
struct V_15 * V_16 = F_61 ( V_7 ) ;
F_103 ( V_16 , V_106 ) ;
...
static int F_104 ( struct V_102 * V_30 , int V_107 )
{
struct V_6 * V_7 = F_98 ( V_30 ) ;
if ( V_107 )
F_82 ( V_7 , V_43 ) ;
...
if ( V_7 -> V_79 &&
V_7 -> V_79 -> V_108 )
V_7 -> V_79 -> V_108 ( & V_7 -> V_30 ) ;
return F_95 ( V_16 , V_97 ) ;
}
...
struct V_1 * V_2 ;
struct V_10 * V_11 = F_89 ( V_16 ) ;
int V_109 = F_108 ( V_16 , V_109 ) ;
int V_110 ;
int V_28 ;
V_7 = F_72 ( sizeof( struct V_6 ) , V_111 ) ;
if ( ! V_7 ) {
F_40 ( V_11 , L_16 ) ;
return - V_112 ;
}
V_2 = F_72 ( sizeof( struct V_1 ) * V_109 , V_111 ) ;
if ( ! V_2 ) {
F_40 ( V_11 , L_17 ) ;
V_28 = - V_112 ;
goto V_113;
}
F_109 ( V_16 , & V_7 -> V_96 , V_114 ) ;
V_7 -> V_96 . V_59 = L_18 ;
V_7 -> V_96 . V_115 = F_105 ;
V_7 -> V_96 . V_116 = F_106 ;
V_7 -> V_2 = V_2 ;
V_7 -> V_117 = V_109 ;
F_110 ( V_7 ) ;
V_7 -> V_30 . V_11 . V_118 = V_11 ;
V_7 -> V_30 . V_59 = L_19 ;
V_7 -> V_30 . V_119 = & V_120 ;
V_7 -> V_30 . V_104 = V_121 ;
F_111 ( & V_7 -> V_30 . V_122 ) ;
F_112 (uep, gpriv, i) {
V_2 -> V_7 = V_7 ;
V_2 -> V_9 = NULL ;
snprintf ( V_2 -> V_123 , V_124 , L_20 , V_110 ) ;
V_2 -> V_14 . V_59 = V_2 -> V_123 ;
V_2 -> V_14 . V_119 = & V_125 ;
F_111 ( & V_2 -> V_14 . V_122 ) ;
if ( F_113 ( V_2 ) ) {
V_7 -> V_30 . V_126 = & V_2 -> V_14 ;
F_114 ( & V_2 -> V_14 , 64 ) ;
}
else {
F_114 ( & V_2 -> V_14 , 512 ) ;
F_115 ( & V_2 -> V_14 . V_122 , & V_7 -> V_30 . V_122 ) ;
}
}
