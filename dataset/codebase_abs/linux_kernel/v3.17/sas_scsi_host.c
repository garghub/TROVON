...
static int F_58 ( struct V_47 * V_33 , int V_140 ,
T_2 V_57 , int V_135 )
{
struct V_48 * V_35 = V_33 -> V_34 -> V_35 ;
...
F_30 ( V_109 -> V_179 ) ;
F_5 ( L_37 ,
V_113 , F_83 ( & V_109 -> V_181 ) , V_109 -> V_182 ) ;
F_61 ( V_51 , & V_35 -> V_52 ) ;
F_68 ( V_109 , & V_178 ) ;
F_80 ( V_51 , & V_35 -> V_52 ) ;
if ( F_72 ( & V_178 ) )
goto V_173;
F_84 ( V_109 , & V_178 , & V_35 -> V_97 ) ;
if ( ! F_85 ( & V_178 , & V_35 -> V_97 ) )
F_86 ( V_109 , & V_178 , & V_35 -> V_97 ) ;
V_173:
if ( V_35 -> V_93 > 1 )
F_23 ( V_35 -> V_74 . V_79 ) ;
F_71 ( V_109 ) ;
...
goto V_136;
F_5 ( L_38 ,
V_113 , F_83 ( & V_109 -> V_181 ) ,
V_109 -> V_182 , V_142 ) ;
}
enum V_184 F_89 ( struct V_1 * V_54 )
{
F_90 ( V_54 , L_39 , V_54 ) ;
return V_185 ;
}
int F_91 ( struct V_186 * V_187 , int V_54 , void T_3 * V_188 )
{
struct V_47 * V_33 = F_92 ( V_187 ) ;
if ( F_27 ( V_33 ) )
return F_93 ( V_33 -> V_88 . V_89 , V_187 , V_54 , V_188 ) ;
return - V_189 ;
}
struct V_47 * F_94 ( struct V_190 * V_150 )
{
struct V_80 * V_109 = F_95 ( V_150 -> V_33 . V_191 ) ;
struct V_48 * V_35 = F_32 ( V_109 ) ;
...
struct V_47 * V_33 ;
F_96 ( & V_34 -> V_195 ) ;
F_97 (dev, &port->dev_list, dev_list_node) {
if ( V_150 == V_33 -> V_150 ) {
V_192 = V_33 ;
F_98 ( & V_34 -> V_195 ) ;
goto V_196;
...
int F_99 ( struct V_197 * V_198 )
{
struct V_190 * V_150 = F_100 ( V_198 -> V_33 . V_191 ) ;
struct V_47 * V_192 = F_94 ( V_150 ) ;
if ( ! V_192 )
return - V_155 ;
F_76 ( & V_192 -> V_177 ) ;
V_198 -> V_199 = V_192 ;
...
int F_101 ( struct V_186 * V_200 )
{
struct V_47 * V_33 = F_92 ( V_200 ) ;
struct V_48 * V_72 ;
F_48 ( V_33 -> V_150 -> V_201 . V_202 != V_203 ) ;
if ( F_27 ( V_33 ) ) {
F_102 ( V_200 , V_33 -> V_88 . V_89 ) ;
return 0 ;
}
V_72 = V_33 -> V_34 -> V_35 ;
F_103 ( V_200 ) ;
...
int F_107 ( struct V_186 * V_187 , int V_208 , int V_209 )
{
struct V_47 * V_33 = F_92 ( V_187 ) ;
if ( F_27 ( V_33 ) )
return F_108 ( V_33 -> V_88 . V_89 , V_187 , V_208 ,
V_209 ) ;
switch ( V_209 ) {
case V_210 :
case V_211 :
...
int F_112 ( struct V_186 * V_200 , int V_214 )
{
struct V_47 * V_33 = F_92 ( V_200 ) ;
if ( F_27 ( V_33 ) )
return - V_189 ;
...
F_106 ( V_200 , 1 ) ;
F_104 ( V_200 , V_214 ) ;
F_105 ( V_200 , V_200 -> V_215 ) ;
return V_214 ;
}
int F_113 ( struct V_186 * V_200 ,
struct V_216 * V_217 ,
T_4 V_218 , int * V_219 )
{
V_219 [ 0 ] = 255 ;
...
static void F_115 ( struct V_48 * V_72 )
{
struct V_73 * V_74 = & V_72 -> V_74 ;
unsigned long V_49 ;
F_21 ( V_220 ) ;
...
V_223 ) ;
if ( F_14 ( V_85 ) )
F_118 ( & V_220 , V_4 -> V_45 . V_224 , & V_4 -> V_45 ) ;
}
F_11 ( & V_74 -> V_75 , V_49 ) ;
if ( V_85 ) {
...
V_74 -> V_77 = 0 ;
F_124 ( & V_74 -> V_78 ) ;
V_74 -> V_79 = F_125 ( F_119 , V_72 ,
L_42 , V_74 -> V_109 -> V_227 ) ;
if ( F_126 ( V_74 -> V_79 ) )
return F_127 ( V_74 -> V_79 ) ;
return 0 ;
}
void F_128 ( struct V_48 * V_72 )
{
unsigned long V_49 ;
struct V_73 * V_74 = & V_72 -> V_74 ;
...
static void F_135 ( T_5 * V_127 , const char * V_237 )
{
int V_83 ;
...
int F_136 ( struct V_80 * V_109 , T_5 * V_241 )
{
int V_85 ;
const struct V_242 * V_243 ;
V_85 = F_137 ( & V_243 , L_44 , & V_109 -> V_244 ) ;
if ( V_85 )
return V_85 ;
