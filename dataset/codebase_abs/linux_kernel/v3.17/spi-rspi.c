...
{
const struct V_146 * V_147 = F_78 ( V_51 ) ;
if ( ! V_147 || ! V_147 -> V_148 || ! V_147 -> V_149 )
return 0 ;
V_50 -> V_64 = F_70 ( V_51 , V_150 ,
V_147 -> V_148 ,
V_145 -> V_151 + V_7 ) ;
if ( ! V_50 -> V_64 )
return - V_152 ;
V_50 -> V_74 = F_70 ( V_51 , V_141 ,
V_147 -> V_149 ,
V_145 -> V_151 + V_7 ) ;
if ( ! V_50 -> V_74 ) {
F_76 ( V_50 -> V_64 ) ;
...
T_3 V_155 ;
int error ;
error = F_85 ( V_51 -> V_156 , L_9 , & V_155 ) ;
if ( error ) {
F_27 ( V_51 , L_10 , error ) ;
return error ;
}
V_50 -> V_157 = V_155 ;
return 0 ;
...
T_8 V_158 , const char * V_159 ,
void * V_160 )
{
const char * V_161 = F_43 ( V_51 ) ;
T_9 V_83 = strlen ( V_161 ) + strlen ( V_159 ) + 2 ;
char * V_162 = F_87 ( V_51 , V_83 , V_163 ) ;
if ( ! V_162 )
return - V_164 ;
snprintf ( V_162 , V_83 , L_11 , V_161 , V_159 ) ;
return F_88 ( V_51 , V_123 , V_158 , 0 , V_162 , V_160 ) ;
}
...
const struct V_167 * V_84 ;
V_50 = F_90 ( & V_154 -> V_51 , sizeof( struct V_1 ) ) ;
if ( V_50 == NULL ) {
F_27 ( & V_154 -> V_51 , L_12 ) ;
return - V_164 ;
}
V_166 = F_91 ( V_168 , & V_154 -> V_51 ) ;
if ( V_166 ) {
V_84 = V_166 -> V_3 ;
V_40 = F_84 ( & V_154 -> V_51 , V_50 ) ;
if ( V_40 )
goto V_169;
} else {
V_84 = (struct V_167 * ) V_154 -> V_170 -> V_171 ;
V_147 = F_78 ( & V_154 -> V_51 ) ;
if ( V_147 && V_147 -> V_157 )
V_50 -> V_157 = V_147 -> V_157 ;
else
V_50 -> V_157 = 2 ;
} ;
if ( ! V_84 -> F_58 ) {
F_27 ( & V_154 -> V_51 , L_13 ) ;
V_40 = - V_152 ;
goto V_169;
}
V_2 = F_49 ( V_50 ) ;
...
V_2 -> V_84 = V_84 ;
V_2 -> V_50 = V_50 ;
V_145 = F_93 ( V_154 , V_172 , 0 ) ;
V_2 -> V_5 = F_94 ( & V_154 -> V_51 , V_145 ) ;
if ( F_95 ( V_2 -> V_5 ) ) {
V_40 = F_96 ( V_2 -> V_5 ) ;
goto V_169;
}
V_2 -> V_12 = F_97 ( & V_154 -> V_51 , NULL ) ;
if ( F_95 ( V_2 -> V_12 ) ) {
F_27 ( & V_154 -> V_51 , L_14 ) ;
V_40 = F_96 ( V_2 -> V_12 ) ;
goto V_169;
}
F_98 ( & V_154 -> V_51 ) ;
F_99 ( & V_2 -> V_43 ) ;
V_50 -> V_173 = V_154 -> V_131 ;
V_50 -> V_174 = F_57 ;
V_50 -> V_175 = true ;
V_50 -> V_176 = V_84 -> V_176 ;
V_50 -> V_177 = F_64 ;
V_50 -> V_178 = F_65 ;
V_50 -> V_179 = V_84 -> V_179 ;
V_50 -> V_180 = V_84 -> V_180 ;
V_50 -> V_51 . V_156 = V_154 -> V_51 . V_156 ;
V_40 = F_100 ( V_154 , L_15 ) ;
if ( V_40 < 0 ) {
V_40 = F_100 ( V_154 , L_16 ) ;
if ( V_40 < 0 )
V_40 = F_101 ( V_154 , 0 ) ;
if ( V_40 >= 0 )
...
V_2 -> V_78 = V_40 ;
V_40 = F_100 ( V_154 , L_17 ) ;
if ( V_40 >= 0 )
V_2 -> V_77 = V_40 ;
}
if ( V_40 < 0 ) {
F_27 ( & V_154 -> V_51 , L_18 ) ;
goto V_181;
}
if ( V_2 -> V_78 == V_2 -> V_77 ) {
V_40 = F_86 ( & V_154 -> V_51 , V_2 -> V_78 , F_66 ,
L_16 , V_2 ) ;
} else {
V_40 = F_86 ( & V_154 -> V_51 , V_2 -> V_78 , F_68 ,
L_15 , V_2 ) ;
if ( ! V_40 )
V_40 = F_86 ( & V_154 -> V_51 , V_2 -> V_77 ,
F_69 , L_17 , V_2 ) ;
}
if ( V_40 < 0 ) {
F_27 ( & V_154 -> V_51 , L_19 ) ;
goto V_181;
}
V_40 = F_77 ( & V_154 -> V_51 , V_50 , V_145 ) ;
if ( V_40 < 0 )
F_74 ( & V_154 -> V_51 , L_20 ) ;
V_40 = F_102 ( & V_154 -> V_51 , V_50 ) ;
if ( V_40 < 0 ) {
F_27 ( & V_154 -> V_51 , L_21 ) ;
goto V_182;
}
F_79 ( & V_154 -> V_51 , L_22 ) ;
return 0 ;
V_182:
F_80 ( V_50 ) ;
V_181:
