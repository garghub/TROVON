...
V_6 -> V_181 = F_56 ( V_12 [ 12 ] ,
V_12 [ 14 ] ) ;
} else {
V_6 -> V_181 = F_57 ( V_12 [ 12 ] << 8 |
V_12 [ 13 ] ,
V_12 [ 14 ] ) ;
}
} else {
V_6 -> V_181 = F_58 ( V_12 [ 12 ] << 24 |
V_12 [ 13 ] << 16 |
V_12 [ 14 ] << 8 |
V_12 [ 15 ] ) ;
}
F_59 ( V_2 -> V_180 , V_182 , V_6 -> V_181 , 0 ) ;
} else {
...
static int F_61 ( struct V_1 * V_2 , struct V_184 * V_185 )
{
struct V_5 * V_6 = F_4 ( V_2 ) ;
T_2 V_186 = F_30 ( V_2 -> V_31 -> V_112 . V_113 ) ;
if ( V_6 -> V_79 == V_187 )
return 0 ;
if ( ! V_185 -> V_188 )
V_185 -> V_188 = F_54 ( V_189 ,
V_190 ) ;
if ( ! V_185 -> V_188 )
V_185 -> V_188 = F_54 ( V_6 -> V_75 ,
V_191 ) ;
if ( ! V_185 -> V_188 && V_186 == V_192 ) {
char V_193 [ 10 ] ;
memset ( V_193 , 0 , sizeof( V_193 ) ) ;
F_62 ( V_2 -> V_31 , V_2 -> V_31 -> V_112 . V_194 ,
V_193 , sizeof( V_193 ) ) ;
if ( ! strcmp ( L_44 , V_193 ) ) {
V_185 -> V_188 = F_54 (
V_195 ,
V_190 ) ;
}
...
static int F_63 ( struct V_201 * V_202 ,
const struct V_203 * V_123 )
{
struct V_204 * V_31 = F_64 ( V_202 ) ;
char V_193 [ sizeof( L_45 ) ] ;
memset ( V_193 , 0 , sizeof( V_193 ) ) ;
F_62 ( V_31 , V_31 -> V_112 . V_194 ,
V_193 , sizeof( V_193 ) ) ;
if ( ( F_30 ( V_31 -> V_112 . V_113 ) == V_205 ) &&
( F_30 ( V_31 -> V_112 . V_115 ) == 0x0099 ) ) {
if ( ! strcmp ( L_45 , V_193 ) ) {
F_23 ( & V_31 -> V_32 , L_46 , V_62 ) ;
return - V_110 ;
}
}
return F_65 ( V_202 , V_123 ) ;
}
