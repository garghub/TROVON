...
if ( V_9 )
goto V_33;
if ( (enum V_3 ) F_8 ( V_25 . V_34 . V_36 ) !=
V_22 ) {
...
memcpy ( V_2 -> V_43 , V_25 . V_28 , F_13 ( V_25 . V_26 , V_6 ) ) ;
F_14 ( V_8 , V_2 -> V_43 ) ;
V_33:
F_10 ( V_25 . V_28 ) ;
V_31:
...
F_20 (f, &adapter->mac_filter_list, list) {
if ( V_109 -> V_110 ) {
F_22 ( V_107 -> V_115 [ V_51 ] . V_116 , V_109 -> V_117 ) ;
V_51 ++ ;
V_109 -> V_110 = false ;
}
}
...
break;
case V_147 :
F_9 ( & V_2 -> V_12 -> V_13 , L_10 ) ;
if ( ! ( V_2 -> V_10 & V_148 ) ) {
V_2 -> V_10 |= V_148 ;
F_9 ( & V_2 -> V_12 -> V_13 , L_11 ) ;
F_37 ( & V_2 -> V_149 ) ;
}
break;
default:
