...
struct V_8 * V_19 , struct V_80 * V_81 )
{
F_27 ( V_46 ) ;
}
static void F_41 ( struct V_45 * V_46 , int V_82 )
{
struct V_8 * V_19 = V_46 -> V_50 ;
F_42 ( V_19 , V_82 ) ;
}
static void V_38 ( struct V_83 * V_83 )
{
int V_84 = V_83 -> V_84 ;
if ( V_84 ) {
F_43 ( & V_83 -> V_6 -> V_6 , L_12 , V_84 ) ;
return;
}
}
static void V_40 ( struct V_83 * V_83 )
{
struct V_8 * V_9 = V_83 -> V_85 ;
struct V_10 * V_11 ;
int V_84 = V_83 -> V_84 ;
unsigned char * V_86 = V_83 -> V_87 ;
int V_18 ;
V_11 = F_17 ( V_9 ) ;
if ( ! V_11 ) {
F_43 ( & V_83 -> V_6 -> V_6 , L_13 , V_88 ) ;
return;
}
if ( ! V_83 -> V_89 ) {
F_43 ( & V_83 -> V_6 -> V_6 , L_14 , V_88 ) ;
return;
}
if ( V_84 ) {
F_43 ( & V_83 -> V_6 -> V_6 , L_15 , V_88 , V_84 ) ;
if ( V_84 != - V_7 )
V_11 -> V_90 = V_91 ;
F_44 ( & V_11 -> V_35 ) ;
return;
}
F_45 ( & V_9 -> V_6 , V_88 , V_83 -> V_89 , V_86 ) ;
if ( V_86 [ 0 ] == V_92 ) {
V_11 -> V_90 = V_92 ;
F_44 ( & V_11 -> V_35 ) ;
} else if ( V_86 [ 0 ] == V_91 ) {
...
F_43 ( & V_83 -> V_6 -> V_6 , L_16 , V_88 ) ;
} else if ( ( V_86 [ 0 ] == V_94 ) &&
( V_83 -> V_89 - 1 <= sizeof( V_11 -> V_95 ) ) ) {
memcpy ( V_11 -> V_95 , & V_86 [ 1 ] ,
V_83 -> V_89 - 1 ) ;
V_11 -> V_90 = V_92 ;
F_44 ( & V_11 -> V_35 ) ;
} else
F_43 ( & V_83 -> V_6 -> V_6 , L_17 , V_88 ) ;
V_18 = F_46 ( V_9 -> V_39 , V_96 ) ;
if ( V_18 )
F_43 ( & V_83 -> V_6 -> V_6 , L_18 ,
V_88 , V_18 ) ;
}
...
int V_47 = 0 ;
int V_99 ;
F_43 ( V_6 , L_19 , V_88 , V_17 ) ;
V_9 = V_19 -> V_2 -> V_19 [ V_20 ] ;
V_11 = F_17 ( V_9 ) ;
F_48 ( & V_11 -> V_33 ) ;
V_11 -> V_90 = false ;
V_87 = ( T_1 * ) V_9 -> V_36 -> V_87 ;
V_87 [ 0 ] = V_17 ;
memcpy ( & V_87 [ 1 ] , V_86 , V_97 ) ;
...
F_43 ( V_6 , L_24 , V_88 , V_112 . V_118 ) ;
if ( V_113 & V_122 )
if ( V_113 & V_123 )
if ( V_113 & V_124 )
V_112 . V_125 = V_126 ;
...
V_112 . V_125 = V_130 ;
F_43 ( V_6 , L_25 , V_88 , V_112 . V_125 ) ;
if ( V_113 & V_131 )
V_112 . V_132 = 2 ;
else
V_112 . V_132 = 1 ;
F_43 ( V_6 , L_26 , V_88 , V_112 . V_132 ) ;
if ( V_113 & V_133 )
V_112 . V_134 = ( V_135 |
V_136 ) ;
else
V_112 . V_134 = V_137 ;
F_43 ( V_6 , L_27 , V_88 ,
( V_112 . V_134 & V_135 ) ? L_28 : L_29 ,
( V_112 . V_134 & V_136 ) ? L_30 : L_29 ,
( V_112 . V_134 & V_138 ) ? L_31 : L_29 ,
( V_112 . V_134 & V_139 ) ? L_32 : L_29 ) ;
if ( F_52 ( V_46 ) )
V_112 . V_140 = V_141 ;
else
V_112 . V_140 = V_142 ;
F_43 ( V_6 , L_33 , V_88 , V_112 . V_140 ) ;
V_112 . V_143 = F_53 ( V_46 ) ;
V_112 . V_144 = F_54 ( V_46 ) ;
F_43 ( V_6 , L_34 , V_88 , V_112 . V_143 , V_112 . V_144 ) ;
V_112 . V_145 = F_55 ( V_46 ) ;
F_43 ( V_6 , L_35 , V_88 , V_112 . V_145 ) ;
...
{
struct V_149 V_153 ;
V_153 . V_19 = V_19 -> V_67 + 1 ;
V_153 . V_151 = V_148 ;
return F_47 ( V_19 , V_154 ,
( T_1 * ) & V_153 , sizeof( V_153 ) ) ;
}
static int F_42 ( struct V_8 * V_19 , T_1 V_148 )
{
struct V_149 V_155 ;
V_155 . V_19 = V_19 -> V_67 + 1 ;
V_155 . V_151 = V_148 ;
