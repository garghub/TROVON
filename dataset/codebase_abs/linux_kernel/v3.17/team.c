...
V_130 = V_14 -> V_3 -> V_133 & ~ V_132 ;
V_14 -> V_3 -> V_133 = V_130 | V_131 ;
F_119 ( V_14 -> V_3 ) ;
}
...
F_76 ( V_14 ) ;
F_82 ( V_14 ) ;
V_29 = F_33 ( V_14 , V_178 , F_181 ( V_178 ) ) ;
if ( V_29 )
goto V_179;
F_182 ( V_3 ) ;
F_174 ( V_3 ) ;
...
static T_6 F_189 ( struct V_67 * V_68 , struct V_2 * V_3 )
{
struct V_14 * V_14 = F_177 ( V_3 ) ;
bool V_180 ;
...
static T_3 F_190 ( struct V_2 * V_3 , struct V_67 * V_68 ,
void * V_185 , T_7 V_186 )
{
T_3 V_167 = F_191 ( V_68 ) ? F_192 ( V_68 ) : 0 ;
F_193 ( V_68 ) -> V_187 = V_68 -> V_114 ;
if ( F_194 ( V_167 >= V_3 -> V_165 ) ) {
do {
V_167 -= V_3 -> V_165 ;
...
static void F_195 ( struct V_2 * V_3 , int V_188 )
{
struct V_14 * V_14 = F_177 ( V_3 ) ;
struct V_1 * V_4 ;
int V_189 ;
...
if ( V_188 & V_190 ) {
V_189 = V_3 -> V_130 & V_190 ? 1 : - 1 ;
F_197 ( V_4 -> V_3 , V_189 ) ;
}
if ( V_188 & V_191 ) {
V_189 = V_3 -> V_130 & V_191 ? 1 : - 1 ;
F_198 ( V_4 -> V_3 , V_189 ) ;
}
}
F_199 () ;
...
static int F_203 ( struct V_2 * V_3 , void * V_192 )
{
struct V_8 * V_9 = V_192 ;
struct V_14 * V_14 = F_177 ( V_3 ) ;
struct V_1 * V_4 ;
if ( V_3 -> type == V_193 && ! F_204 ( V_9 -> V_10 ) )
return - V_194 ;
memcpy ( V_3 -> V_7 , V_9 -> V_10 , V_3 -> V_11 ) ;
F_196 () ;
F_96 (port, &team->port_list, list)
if ( V_14 -> V_73 . V_195 )
V_14 -> V_73 . V_195 ( V_14 , V_4 ) ;
F_199 () ;
return 0 ;
}
static int F_205 ( struct V_2 * V_3 , int V_196 )
{
struct V_14 * V_14 = F_177 ( V_3 ) ;
struct V_1 * V_4 ;
int V_29 ;
...
return 0 ;
V_198:
F_206 (port, &team->port_list, list)
...
static struct V_199 *
F_207 ( struct V_2 * V_3 , struct V_199 * V_200 )
{
struct V_14 * V_14 = F_177 ( V_3 ) ;
struct V_96 * V_192 ;
...
int V_28 ;
F_208 (i) {
V_192 = F_209 ( V_14 -> V_97 , V_28 ) ;
do {
V_201 = F_210 ( & V_192 -> V_98 ) ;
V_99 = V_192 -> V_99 ;
V_100 = V_192 -> V_100 ;
V_104 = V_192 -> V_104 ;
V_181 = V_192 -> V_181 ;
V_182 = V_192 -> V_182 ;
} while ( F_211 ( & V_192 -> V_98 , V_201 ) );
V_200 -> V_99 += V_99 ;
V_200 -> V_100 += V_100 ;
V_200 -> V_202 += V_104 ;
V_200 -> V_181 += V_181 ;
...
static int F_212 ( struct V_2 * V_3 , T_9 V_203 , T_3 V_204 )
{
struct V_14 * V_14 = F_177 ( V_3 ) ;
struct V_1 * V_4 ;
int V_29 ;
F_121 ( & V_14 -> V_135 ) ;
F_14 (port, &team->port_list, list) {
V_29 = F_213 ( V_4 -> V_3 , V_203 , V_204 ) ;
if ( V_29 )
goto V_198;
}
F_122 ( & V_14 -> V_135 ) ;
...
V_198:
F_206 (port, &team->port_list, list)
F_214 ( V_4 -> V_3 , V_203 , V_204 ) ;
F_122 ( & V_14 -> V_135 ) ;
return V_29 ;
}
static int F_215 ( struct V_2 * V_3 , T_9 V_203 , T_3 V_204 )
{
struct V_14 * V_14 = F_177 ( V_3 ) ;
struct V_1 * V_4 ;
F_196 () ;
...
static void F_217 ( struct V_14 * V_14 )
{
struct V_1 * V_4 ;
F_14 (port, &team->port_list, list)
F_129 ( V_4 ) ;
...
static T_10 F_222 ( struct V_2 * V_3 ,
T_10 V_145 )
{
struct V_1 * V_4 ;
struct V_14 * V_14 = F_177 ( V_3 ) ;
...
static int F_223 ( struct V_2 * V_3 , bool V_209 )
{
struct V_14 * V_14 = F_177 ( V_3 ) ;
V_14 -> V_71 = true ;
if ( V_209 )
...
struct V_210 * V_211 )
{
F_226 ( V_211 -> V_212 , V_213 , sizeof( V_211 -> V_212 ) ) ;
F_226 ( V_211 -> V_214 , V_215 , sizeof( V_211 -> V_214 ) ) ;
}
...
V_3 -> V_11 = V_6 -> V_11 ;
V_3 -> V_150 = V_6 -> V_150 ;
memcpy ( V_3 -> V_217 , V_6 -> V_217 , V_6 -> V_11 ) ;
F_228 ( V_3 , V_6 ) ;
}
...
V_3 -> V_225 = 0 ;
V_3 -> V_130 |= V_226 ;
V_3 -> V_133 &= ~ ( V_132 | V_227 ) ;
V_3 -> V_133 |= V_228 | V_229 ;
V_3 -> V_145 |= V_230 ;
V_3 -> V_145 |= V_231 ;
V_3 -> V_145 |= V_232 ;
V_3 -> V_233 = V_126 |
...
V_235 |
V_236 ;
V_3 -> V_233 &= ~ ( V_237 & ~ V_238 ) ;
V_3 -> V_145 |= V_3 -> V_233 ;
}
static int F_234 ( struct V_239 * V_240 , struct V_2 * V_3 ,
struct V_241 * V_242 [] , struct V_241 * V_160 [] )
{
if ( V_242 [ V_243 ] == NULL )
F_235 ( V_3 ) ;
return F_236 ( V_3 ) ;
}
static int F_237 ( struct V_241 * V_242 [] , struct V_241 * V_160 [] )
{
if ( V_242 [ V_243 ] ) {
if ( F_238 ( V_242 [ V_243 ] ) != V_244 )
return - V_62 ;
if ( ! F_204 ( F_239 ( V_242 [ V_243 ] ) ) )
return - V_194 ;
}
return 0 ;
}
...
static int F_242 ( struct V_67 * V_68 , struct V_247 * V_32 )
{
struct V_67 * V_248 ;
void * V_249 ;
int V_29 ;
V_248 = F_243 ( V_250 , V_30 ) ;
if ( ! V_248 )
return - V_31 ;
V_249 = F_244 ( V_248 , V_32 -> V_251 , V_32 -> V_252 ,
& V_253 , 0 , V_254 ) ;
if ( ! V_249 ) {
V_29 = - V_255 ;
goto V_256;
...
F_245 ( V_248 , V_249 ) ;
return F_246 ( F_247 ( V_32 ) , V_248 , V_32 -> V_251 ) ;
V_256:
F_248 ( V_248 ) ;
return V_29 ;
}
static struct V_14 * F_249 ( struct V_247 * V_32 )
{
struct V_239 * V_239 = F_247 ( V_32 ) ;
int V_257 ;
struct V_2 * V_3 ;
struct V_14 * V_14 ;
if ( ! V_32 -> V_258 [ V_259 ] )
return NULL ;
V_257 = F_250 ( V_32 -> V_258 [ V_259 ] ) ;
V_3 = F_251 ( V_239 , V_257 ) ;
if ( ! V_3 || V_3 -> V_220 != & V_221 ) {
if ( V_3 )
F_125 ( V_3 ) ;
return NULL ;
}
...
static void F_252 ( struct V_14 * V_14 )
{
F_122 ( & V_14 -> V_135 ) ;
F_125 ( V_14 -> V_3 ) ;
}
static int F_253 ( struct V_67 * V_68 , struct V_14 * V_14 , T_4 V_260 )
{
return F_246 ( F_254 ( V_14 -> V_3 ) , V_68 , V_260 ) ;
}
static int F_255 ( struct V_67 * V_68 , struct V_14 * V_14 ,
struct V_23 * V_24 )
{
struct V_241 * V_261 ;
...
if ( V_29 )
return V_29 ;
V_261 = F_256 ( V_68 , V_262 ) ;
if ( ! V_261 )
return - V_255 ;
if ( F_257 ( V_68 , V_263 , V_21 -> V_22 ) )
goto V_264;
if ( V_54 -> V_4 &&
F_258 ( V_68 , V_265 ,
V_54 -> V_4 -> V_3 -> V_257 ) )
...
switch ( V_21 -> type ) {
case V_267 :
if ( F_259 ( V_68 , V_268 , V_269 ) )
goto V_264;
if ( F_258 ( V_68 , V_270 , V_49 . V_160 . V_162 ) )
goto V_264;
break;
case V_271 :
if ( F_259 ( V_68 , V_268 , V_272 ) )
goto V_264;
if ( F_257 ( V_68 , V_270 ,
V_49 . V_160 . V_161 ) )
goto V_264;
break;
case V_273 :
if ( F_259 ( V_68 , V_268 , V_274 ) )
goto V_264;
if ( F_260 ( V_68 , V_270 , V_49 . V_160 . V_275 . V_101 ,
V_49 . V_160 . V_275 . V_276 ) )
goto V_264;
break;
case V_277 :
if ( F_259 ( V_68 , V_268 , V_278 ) )
goto V_264;
if ( V_49 . V_160 . V_163 &&
F_261 ( V_68 , V_270 ) )
goto V_264;
break;
case V_279 :
if ( F_259 ( V_68 , V_268 , V_280 ) )
goto V_264;
if ( F_262 ( V_68 , V_270 , V_49 . V_160 . V_164 ) )
goto V_264;
break;
default:
F_263 () ;
}
if ( V_24 -> V_35 && F_261 ( V_68 , V_281 ) )
goto V_264;
if ( V_24 -> V_34 ) {
if ( F_261 ( V_68 , V_282 ) )
goto V_264;
...
static int F_266 ( struct V_67 * * V_91 ,
struct V_14 * V_14 , T_4 V_260 ,
T_11 * V_283 )
{
int V_29 ;
if ( * V_91 ) {
V_29 = V_283 ( * V_91 , V_14 , V_260 ) ;
if ( V_29 )
return V_29 ;
}
* V_91 = F_267 ( V_284 , V_30 ) ;
if ( ! * V_91 )
return - V_31 ;
return 0 ;
}
static int F_268 ( struct V_14 * V_14 , T_4 V_260 , T_4 V_285 ,
int V_130 , T_11 * V_283 ,
struct V_106 * V_286 )
{
struct V_241 * V_46 ;
struct V_287 * V_288 ;
...
struct V_23 , V_290 ) ;
V_291:
V_29 = F_266 ( & V_68 , V_14 , V_260 , V_283 ) ;
if ( V_29 )
return V_29 ;
V_249 = F_244 ( V_68 , V_260 , V_285 , & V_253 , V_130 | V_292 ,
V_293 ) ;
if ( ! V_249 )
return - V_255 ;
if ( F_258 ( V_68 , V_259 , V_14 -> V_3 -> V_257 ) )
goto V_294;
V_46 = F_256 ( V_68 , V_295 ) ;
if ( ! V_46 )
goto V_294;
V_28 = 0 ;
V_289 = false ;
F_270 (opt_inst, sel_opt_inst_list, tmp_list) {
V_29 = F_255 ( V_68 , V_14 , V_24 ) ;
if ( V_29 ) {
if ( V_29 == - V_255 ) {
if ( ! V_28 )
goto V_296;
...
goto V_291;
V_297:
V_288 = F_271 ( V_68 , V_260 , V_285 , V_298 , 0 , V_130 | V_292 ) ;
if ( ! V_288 ) {
V_29 = F_266 ( & V_68 , V_14 , V_260 , V_283 ) ;
if ( V_29 )
goto V_296;
...
static int F_273 ( struct V_67 * V_68 , struct V_247 * V_32 )
{
struct V_14 * V_14 ;
struct V_23 * V_24 ;
int V_29 ;
...
return - V_62 ;
F_14 (opt_inst, &team->option_inst_list, list)
F_22 ( & V_24 -> V_290 , & V_286 ) ;
V_29 = F_268 ( V_14 , V_32 -> V_251 , V_32 -> V_252 ,
V_299 , F_253 ,
& V_286 ) ;
F_252 ( V_14 ) ;
return V_29 ;
}
static int F_275 ( struct V_67 * V_68 , struct V_247 * V_32 )
{
struct V_14 * V_14 ;
int V_29 = 0 ;
int V_28 ;
...
F_276 (nl_option, info->attrs[TEAM_ATTR_LIST_OPTION], i) {
struct V_241 * V_303 [ V_304 + 1 ] ;
struct V_241 * V_305 ;
struct V_241 * V_306 ;
enum V_307 V_308 ;
int V_309 = 0 ;
...
char * V_20 ;
bool V_312 = false ;
if ( F_277 ( V_300 ) != V_262 ) {
V_29 = - V_62 ;
goto V_302;
}
V_29 = F_278 ( V_303 , V_304 ,
V_300 , V_313 ) ;
if ( V_29 )
goto V_302;
if ( ! V_303 [ V_263 ] ||
...
V_306 = V_303 [ V_270 ] ;
if ( V_308 != V_277 && ! V_306 ) {
V_29 = - V_62 ;
goto V_302;
}
V_20 = F_239 ( V_303 [ V_263 ] ) ;
V_305 = V_303 [ V_265 ] ;
if ( V_305 )
V_309 = F_250 ( V_305 ) ;
V_305 = V_303 [ V_266 ] ;
...
switch ( V_308 ) {
case V_267 :
V_49 . V_160 . V_162 = F_250 ( V_306 ) ;
break;
case V_271 :
if ( F_238 ( V_306 ) > V_315 ) {
V_29 = - V_62 ;
goto V_302;
}
V_49 . V_160 . V_161 = F_239 ( V_306 ) ;
break;
case V_273 :
V_49 . V_160 . V_275 . V_101 = F_238 ( V_306 ) ;
V_49 . V_160 . V_275 . V_276 = F_239 ( V_306 ) ;
break;
case V_277 :
V_49 . V_160 . V_163 = V_306 ? true : false ;
break;
case V_279 :
V_49 . V_160 . V_164 = F_280 ( V_306 ) ;
break;
default:
F_263 () ;
}
...
V_29 = F_282 ( V_14 , & V_301 ) ;
V_302:
F_252 ( V_14 ) ;
return V_29 ;
}
static int F_283 ( struct V_67 * V_68 ,
struct V_1 * V_4 )
{
struct V_241 * V_316 ;
V_316 = F_256 ( V_68 , V_317 ) ;
if ( ! V_316 )
goto V_264;
if ( F_258 ( V_68 , V_318 , V_4 -> V_3 -> V_257 ) )
goto V_264;
if ( V_4 -> V_34 ) {
if ( F_261 ( V_68 , V_319 ) )
goto V_264;
...
( V_4 -> V_18 . V_15 &&
F_261 ( V_68 , V_321 ) ) ||
F_258 ( V_68 , V_322 , V_4 -> V_18 . V_323 ) ||
F_259 ( V_68 , V_324 , V_4 -> V_18 . V_325 ) )
goto V_264;
F_264 ( V_68 , V_316 ) ;
return 0 ;
V_264:
...
static int F_284 ( struct V_14 * V_14 , T_4 V_260 , T_4 V_285 ,
int V_130 , T_11 * V_283 ,
struct V_1 * V_326 )
{
struct V_241 * V_79 ;
...
if ( F_258 ( V_68 , V_259 , V_14 -> V_3 -> V_257 ) )
goto V_294;
V_79 = F_256 ( V_68 , V_328 ) ;
if ( ! V_79 )
goto V_294;
V_28 = 0 ;
V_289 = false ;
if ( V_326 ) {
V_29 = F_283 ( V_68 , V_326 ) ;
if ( V_29 )
goto V_296;
} else if ( V_4 ) {
F_270 (port, &team->port_list, list) {
V_29 = F_283 ( V_68 , V_4 ) ;
if ( V_29 ) {
if ( V_29 == - V_255 ) {
if ( ! V_28 )
...
if ( ! V_14 )
return - V_62 ;
V_29 = F_284 ( V_14 , V_32 -> V_251 , V_32 -> V_252 ,
V_299 , F_253 , NULL ) ;
F_252 ( V_14 ) ;
return V_29 ;
}
...
struct V_14 * V_14 , T_4 V_260 )
{
return F_288 ( & V_253 , F_254 ( V_14 -> V_3 ) ,
V_68 , 0 , 0 , V_30 ) ;
}
static int F_282 ( struct V_14 * V_14 ,
struct V_106 * V_286 )
{
return F_268 ( V_14 , 0 , 0 , 0 , F_287 ,
V_286 ) ;
}
static int F_289 ( struct V_14 * V_14 ,
struct V_1 * V_4 )
{
return F_284 ( V_14 , 0 , 0 , 0 , F_287 ,
V_4 ) ;
}
static int F_290 ( void )
{
return F_291 ( & V_253 , V_329 ,
V_330 ) ;
}
...
if ( V_15 ) {
struct V_332 V_333 ;
V_29 = F_296 ( V_4 -> V_3 , & V_333 ) ;
if ( ! V_29 ) {
V_4 -> V_18 . V_323 = F_297 ( & V_333 ) ;
V_4 -> V_18 . V_325 = V_333 . V_325 ;
goto V_334;
}
}
V_4 -> V_18 . V_323 = 0 ;
...
static void F_298 ( struct V_1 * V_4 , bool V_15 )
{
...
static int F_300 ( struct V_336 * V_168 ,
unsigned long V_337 , void * V_276 )
{
struct V_2 * V_3 = F_301 ( V_276 ) ;
struct V_1 * V_4 ;
V_4 = F_4 ( V_3 ) ;
if ( ! V_4 )
return V_338 ;
...
return V_345 ;
case V_90 :
F_69 ( V_337 , V_4 -> V_14 -> V_3 ) ;
break;
}
return V_338 ;
}
static int T_12 F_302 ( void )
{
int V_29 ;
F_303 ( & V_346 ) ;
V_29 = F_304 ( & V_347 ) ;
