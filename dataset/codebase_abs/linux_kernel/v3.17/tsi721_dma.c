...
static int F_69 ( struct V_2 * V_4 , enum V_157 V_158 ,
unsigned long V_159 )
{
struct V_1 * V_14 = F_1 ( V_4 ) ;
struct V_11 * V_78 , * V_143 ;
...
F_40 ( & V_14 -> V_15 , & V_160 ) ;
F_40 ( & V_14 -> V_115 , & V_160 ) ;
...
int V_165 = 0 ;
int V_108 ;
struct V_8 * V_166 = V_10 -> V_166 ;
F_60 ( & V_166 -> V_9 . V_167 ) ;
for ( V_104 = 0 ; V_104 < V_168 ; V_104 ++ ) {
struct V_1 * V_14 = & V_10 -> V_169 [ V_104 ] ;
if ( V_104 == V_170 )
continue;
V_14 -> V_38 = V_10 -> V_38 + F_72 ( V_104 ) ;
V_14 -> V_4 . V_20 = & V_166 -> V_9 ;
V_14 -> V_4 . V_127 = 1 ;
V_14 -> V_4 . V_171 = V_104 ;
V_14 -> V_26 = V_104 ;
V_14 -> V_71 = false ;
F_73 ( & V_14 -> V_123 ) ;
F_60 ( & V_14 -> V_15 ) ;
...
V_166 -> V_9 . V_173 = V_165 ;
F_75 ( V_166 -> V_9 . V_174 ) ;
F_76 ( V_175 , V_166 -> V_9 . V_174 ) ;
F_76 ( V_176 , V_166 -> V_9 . V_174 ) ;
V_166 -> V_9 . V_21 = & V_10 -> V_135 -> V_21 ;
V_166 -> V_9 . V_177 = F_50 ;
V_166 -> V_9 . V_178 = F_57 ;
V_166 -> V_9 . V_179 = F_62 ;
V_166 -> V_9 . V_180 = F_64 ;
V_166 -> V_9 . V_181 = F_65 ;
V_166 -> V_9 . V_182 = F_69 ;
V_108 = F_77 ( & V_166 -> V_9 ) ;
if ( V_108 )
