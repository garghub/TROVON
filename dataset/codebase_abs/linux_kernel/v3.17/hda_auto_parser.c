...
unsigned int V_34 = F_11 ( V_21 , V_1 ) ;
int V_33 = F_12 ( V_34 ) ;
const char * V_111 , * V_115 = L_36 ;
if ( ! strcmp ( V_112 , L_39 ) && V_33 == V_93 )
V_112 = L_40 ;
V_111 = F_30 ( V_21 , V_1 ) ;
if ( V_14 ) {
...
snprintf ( V_113 , V_114 , L_41 , V_111 , V_112 , V_115 ) ;
return 1 ;
}
...
switch ( F_21 ( V_34 ) ) {
case V_24 :
return F_32 ( V_21 , V_1 , V_14 , L_39 ,
V_113 , V_114 , V_107 ) ;
case V_25 :
return F_32 ( V_21 , V_1 , V_14 , L_40 ,
V_113 , V_114 , V_107 ) ;
case V_26 :
return F_32 ( V_21 , V_1 , V_14 , L_42 ,
V_113 , V_114 , V_107 ) ;
case V_27 :
case V_28 :
V_116 = F_34 ( V_34 ) ;
V_112 = V_116 ? L_43 : L_44 ;
if ( V_14 && V_107 )
...
break;
case V_138 :
if ( V_126 != V_139 || ! V_131 -> V_119 . V_120 )
break;
F_24 ( V_21 , L_46 ,
V_21 -> V_137 , V_128 ) ;
...
break;
case V_140 :
if ( ! V_131 -> V_119 . V_141 )
break;
F_24 ( V_21 , L_47 ,
V_21 -> V_137 , V_128 ) ;
V_131 -> V_119 . V_141 ( V_21 , V_131 , V_126 ) ;
break;
case V_142 :
if ( V_126 != V_139 || ! V_131 -> V_119 . V_9 )
break;
F_24 ( V_21 , L_48 ,
V_21 -> V_137 , V_128 ) ;
...
default:
F_46 ( V_21 , L_49 ,
V_21 -> V_137 , V_131 -> type ) ;
break;
}
if ( ! V_131 -> V_143 || V_131 -> V_133 )
break;
if ( ++ V_127 > 10 )
break;
V_125 = V_131 -> V_134 ;
...
{
if ( V_21 -> V_132 )
F_45 ( V_21 , V_21 -> V_144 , V_126 , 0 ) ;
}
static bool F_48 ( struct V_20 * V_21 ,
const struct V_123 * V_9 )
{
for (; V_9 -> V_1 ; V_9 ++ ) {
T_2 V_34 = F_11 ( V_21 , V_9 -> V_1 ) ;
if ( V_9 -> V_124 != V_34 )
return false ;
}
return true ;
...
const struct V_130 * V_147 )
{
const struct V_145 * V_148 ;
if ( V_21 -> V_144 != V_149 )
return;
for ( V_148 = V_146 ; V_148 -> V_150 ; V_148 ++ ) {
if ( ( V_21 -> V_151 & 0xffff0000 ) != ( V_148 -> V_150 << 16 ) )
continue;
if ( V_21 -> V_152 != V_148 -> V_21 )
continue;
if ( F_48 ( V_21 , V_148 -> V_9 ) ) {
V_21 -> V_144 = V_148 -> V_153 ;
#ifdef F_50
V_21 -> V_129 = V_148 -> V_112 ;
#endif
V_21 -> V_132 = V_147 ;
return;
}
...
if ( V_21 -> V_144 != V_149 )
return;
if ( V_21 -> V_128 && ! strcmp ( V_21 -> V_128 , L_50 ) ) {
V_21 -> V_132 = NULL ;
V_21 -> V_129 = NULL ;
V_21 -> V_144 = V_159 ;
return;
...
if ( V_21 -> V_128 && V_155 ) {
while ( V_155 -> V_112 ) {
if ( ! strcmp ( V_21 -> V_128 , V_155 -> V_112 ) ) {
V_21 -> V_144 = V_155 -> V_125 ;
V_21 -> V_129 = V_155 -> V_112 ;
V_21 -> V_132 = V_147 ;
return;
}
V_155 ++ ;
...
if ( V_157 ) {
V_158 = F_52 ( V_21 -> V_160 -> V_161 , V_157 ) ;
if ( V_158 ) {
V_125 = V_158 -> V_153 ;
#ifdef F_50
V_112 = V_158 -> V_112 ;
...
if ( V_125 < 0 && V_157 ) {
for ( V_158 = V_157 ; V_158 -> V_150 || V_158 -> V_162 ; V_158 ++ ) {
unsigned int V_163 =
V_158 -> V_162 | ( V_158 -> V_150 << 16 ) ;
unsigned int V_164 = 0xffff0000 | V_158 -> V_165 ;
if ( ( V_21 -> V_151 & V_164 ) == ( V_163 & V_164 ) ) {
V_125 = V_158 -> V_153 ;
#ifdef F_50
V_112 = V_158 -> V_112 ;
#endif
