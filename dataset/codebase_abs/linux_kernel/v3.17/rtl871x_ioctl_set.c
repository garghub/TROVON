...
T_2 V_78 ;
struct V_70 * V_71 = & V_7 -> V_56 ;
V_76 = ( V_75 -> V_79 & 0x40000000 ) > 0 ? false : true ;
V_77 = ( V_75 -> V_79 & 0x80000000 ) > 0 ? true : false ;
V_78 = V_75 -> V_79 & 0x3fffffff ;
if ( V_78 >= V_80 )
return false ;
switch ( V_75 -> V_81 ) {
case 5 :
...
memcpy ( V_71 -> V_86 [ V_78 ] . V_87 , & V_75 -> V_88 ,
V_75 -> V_81 ) ;
V_71 -> V_89 [ V_78 ] = V_75 -> V_81 ;
V_71 -> V_90 = V_78 ;
if ( F_30 ( V_7 , V_71 , V_78 ) == V_91 )
return false ;
return V_30 ;
}
