...
F_60 ( V_259 ) ;
V_199 = F_53 ( V_259 , struct V_198 , V_194 ) ;
F_33 ( V_199 ) ;
}
return 0 ;
}
static int F_63 ( struct V_261 * V_262 ,
...
static int F_64 ( struct V_261 * V_262 ,
unsigned long long * V_263 , T_1 * V_75 , T_1 * V_76 )
{
T_1 V_265 , V_71 = 0 ;
struct V_1 * V_2 ;
...
static int F_65 ( struct V_261 * V_262 , int V_278 ,
void (* F_66)( int ) )
{
T_1 V_265 , V_45 ;
struct V_1 * V_2 ;
...
static void * F_69 ( struct V_185 * V_21 , T_5 V_73 ,
T_3 * V_283 )
{
struct V_46 * V_47 ;
V_47 = F_16 ( V_21 , struct V_46 , V_48 ) ;
return F_70 ( V_47 , V_73 , V_283 ) ;
}
...
F_74 ( & V_47 -> V_48 , L_36 , V_279 ) ;
if ( V_279 == 0 ) {
F_8 ( & V_47 -> V_48 , L_37
L_38 ) ;
return - V_66 ;
}
V_2 -> V_286 = F_75 ( V_47 , V_287 ,
& V_2 -> V_288 ) ;
if ( V_2 -> V_286 == NULL ) {
F_8 ( & V_47 -> V_48 , L_39
L_40 ) ;
...
F_72 ( V_47 , V_287 , V_2 -> V_286 ,
V_2 -> V_288 ) ;
}
static int F_77 ( struct V_46 * V_47 , const struct V_292 * V_293 )
{
int V_116 , V_6 ;
T_1 V_294 ;
...
struct V_239 * V_299 ;
struct V_261 * V_262 ;
V_16 = F_78 ( sizeof( struct V_15 ) , V_206 ) ;
if ( V_16 == NULL ) {
F_8 ( & V_47 -> V_48 , L_41
L_23 ) ;
V_116 = - V_125 ;
...
V_296 = F_78 ( sizeof( struct V_1 ) , V_206 ) ;
if ( V_296 == NULL ) {
F_8 ( & V_47 -> V_48 , L_41
L_23 ) ;
V_116 = - V_125 ;
...
V_116 = F_80 ( V_47 , V_53 ) ;
if ( V_116 ) {
F_8 ( & V_47 -> V_48 , L_43 ) ;
goto V_131;
}
V_296 -> V_19 = F_37 ( F_81 ( V_47 , 0 ) ,
4096 ) ;
if ( ! V_296 -> V_19 ) {
F_8 ( & V_47 -> V_48 , L_44 ) ;
V_116 = - V_303 ;
...
V_262 = F_53 ( V_259 , struct V_261 , V_194 ) ;
F_60 ( V_259 ) ;
F_33 ( V_262 ) ;
}
V_320:
F_62 (pos, n, &ca91cx42_bridge->dma_resources) {
V_299 = F_53 ( V_259 , struct V_239 , V_194 ) ;
F_60 ( V_259 ) ;
F_33 ( V_299 ) ;
}
V_317:
F_62 (pos, n, &ca91cx42_bridge->slave_resources) {
V_298 = F_53 ( V_259 , struct V_69 , V_194 ) ;
F_60 ( V_259 ) ;
F_33 ( V_298 ) ;
}
V_310:
F_62 (pos, n, &ca91cx42_bridge->master_resources) {
V_297 = F_53 ( V_259 , struct V_114 ,
V_194 ) ;
F_60 ( V_259 ) ;
F_33 ( V_297 ) ;
}
