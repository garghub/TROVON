...
break;
case V_169 :
if ( V_64 -> V_170 . V_171 == V_172 ) {
V_152 = F_25 ( F_17 ( V_117 -> V_173 ) ,
V_117 -> V_173 ) ;
if ( V_152 ) {
F_11 ( V_64 -> V_2 ,
L_15 ,
...
F_7 ( V_64 , V_7 , 0 ) ;
F_28 ( V_117 -> V_174 ) ;
F_29 ( F_17 ( V_117 -> V_173 ) ,
V_117 -> V_173 ) ;
break;
}
V_64 -> V_170 . V_171 = V_164 ;
return 0 ;
}
...
int V_152 ;
V_117 = F_13 ( V_64 ) ;
for ( V_115 = 0 ; V_115 < F_17 ( V_117 -> V_173 ) ; V_115 ++ )
V_117 -> V_173 [ V_115 ] . V_183 = V_184 [ V_115 ] ;
V_152 = F_34 ( V_64 -> V_2 , F_17 ( V_117 -> V_173 ) ,
V_117 -> V_173 ) ;
if ( V_152 ) {
...
for ( V_115 = 0 ; V_115 < F_17 ( V_186 ) ; ++ V_115 )
F_6 ( V_64 , V_186 [ V_115 ] ,
0x100 , 0x100 ) ;
F_6 ( V_64 , V_58 , V_187 ,
V_187 ) ;
F_24 ( V_64 , V_169 ) ;
return 0 ;
V_185:
F_29 ( F_17 ( V_117 -> V_173 ) , V_117 -> V_173 ) ;
return V_152 ;
}
...
struct V_116 * V_117 ;
int V_152 ;
V_117 = F_36 ( & V_189 -> V_2 , sizeof *V_117 , V_190 ) ;
if ( ! V_117 )
return - V_191 ;
F_37 ( V_189 , V_117 ) ;
V_117 -> V_174 = F_38 ( V_189 , & V_192 ) ;
if ( F_39 ( V_117 -> V_174 ) ) {
V_152 = F_40 ( V_117 -> V_174 ) ;
F_11 ( & V_189 -> V_2 , L_18 ,
V_152 ) ;
return V_152 ;
}
V_152 = F_41 ( & V_189 -> V_2 ,
& V_193 , & V_194 , 1 ) ;
return V_152 ;
}
static int F_42 ( struct V_188 * V_189 )
{
F_43 ( & V_189 -> V_2 ) ;
return 0 ;
}
static int F_44 ( struct V_195 * V_196 ,
const struct V_197 * V_198 )
{
struct V_116 * V_117 ;
int V_152 ;
V_117 = F_36 ( & V_196 -> V_2 , sizeof *V_117 , V_190 ) ;
if ( ! V_117 )
return - V_191 ;
F_45 ( V_196 , V_117 ) ;
V_117 -> V_174 = F_46 ( V_196 , & V_192 ) ;
if ( F_39 ( V_117 -> V_174 ) ) {
V_152 = F_40 ( V_117 -> V_174 ) ;
F_11 ( & V_196 -> V_2 , L_18 ,
V_152 ) ;
...
V_152 = F_41 ( & V_196 -> V_2 ,
& V_193 , & V_194 , 1 ) ;
return V_152 ;
}
static int F_47 ( struct V_195 * V_196 )
{
F_43 ( & V_196 -> V_2 ) ;
return 0 ;
}
