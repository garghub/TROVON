...
static int F_91 ( struct V_14 * V_2 , int V_209 , int V_196 ,
...
static int F_95 ( struct V_14 * V_2 , int V_209 , int V_196 ,
...
if ( V_43 == NULL )
goto V_149;
V_19 = F_92 ( V_3 , V_43 , V_196 , & V_180 ) ;
F_3 ( V_30 -> V_49 ) ;
} else
V_19 = F_93 ( V_3 , V_4 , V_196 , & V_180 ) ;
V_19 = - V_183 ;
if ( F_82 ( V_17 , V_211 ) )
goto V_149;
...
static void F_97 ( struct V_72 * V_72 , struct V_213 * V_214 )
{
for (; ; ) {
V_214 -> V_43 = F_98 ( V_72 , V_214 -> V_215 ) ;
V_214 -> V_215 ++ ;
if ( V_214 -> V_43 == NULL )
break;
...
static void F_99 ( struct V_72 * V_72 , struct V_213 * V_214 )
{
V_214 -> V_4 = F_100 ( V_214 -> V_43 , V_214 -> V_216 ) ;
V_214 -> V_216 ++ ;
if ( V_214 -> V_4 == NULL ) {
V_214 -> V_216 = 0 ;
F_97 ( V_72 , V_214 ) ;
...
static void * F_101 ( struct V_87 * V_39 , T_4 * V_217 )
{
...
static void * F_103 ( struct V_87 * V_39 , void * V_220 , T_4 * V_219 )
{
( * V_219 ) ++ ;
return NULL ;
}
static void F_104 ( struct V_87 * V_221 , void * V_220 )
{
}
static void F_105 ( struct V_87 * V_39 , void * V_220 )
{
...
static void F_107 ( struct V_87 * V_39 , void * V_220 )
{
...
V_223 = F_108 ( V_147 -> V_225 ) ;
V_224 = F_109 ( V_147 -> V_226 ) ;
}
F_60 ( V_39 , L_28
L_29 ,
...
static int F_110 ( struct V_87 * V_39 , void * V_220 )
{
struct V_213 * V_214 = V_220 ;
if ( V_220 == V_218 ) {
F_111 ( V_39 , L_34 V_229 L_35 ) ;
F_111 ( V_39 , L_36 ) ;
F_111 ( V_39 , L_37 ) ;
F_111 ( V_39 , L_38
L_39 ) ;
...
if ( V_214 -> V_4 == NULL )
F_105 ( V_39 , V_214 -> V_43 ) ;
else
F_107 ( V_39 , V_214 -> V_4 ) ;
V_6:
return 0 ;
}
static int F_112 ( struct V_230 * V_230 , struct V_231 * V_231 )
{
return F_113 ( V_230 , V_231 , & V_232 ,
sizeof( struct V_213 ) ) ;
}
static T_6 int F_114 ( struct V_72 * V_72 )
{
struct V_233 * V_234 ;
int V_19 = 0 ;
V_234 = F_115 ( L_42 , V_235 , V_72 -> V_236 ,
& V_237 ) ;
if ( ! V_234 ) {
V_19 = - V_54 ;
goto V_6;
...
static T_7 void F_116 ( struct V_72 * V_72 )
{
F_117 ( L_42 , V_72 -> V_236 ) ;
}
...
if ( V_19 )
goto V_239;
V_19 = F_121 ( V_81 , & V_240 ) ;
if ( V_19 )
goto V_241;
#ifdef F_122
V_19 = F_123 ( V_242 , & V_243 ) ;
if ( V_19 )
goto V_244;
#endif
F_124 ( L_43 , V_229 ) ;
