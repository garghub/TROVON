...
V_5 -> V_7 = (struct V_101 * ) F_33 ( V_96 . V_97 ) ;
F_3 ( L_16 , V_5 -> V_7 ) ;
F_3 ( L_17 , V_5 -> V_102 , V_5 -> V_103 ) ;
V_90 = F_34 ( NULL , L_18 ) ;
if ( ! F_35 ( V_90 ) ) {
V_5 -> V_104 = V_90 ;
F_36 ( V_90 , 48000000 ) ;
...
V_5 -> V_74 = V_5 -> V_17 -> V_105 * V_5 -> V_17 -> V_53 *
( V_5 -> V_17 -> V_106 >> 3 ) * V_107 ;
V_5 -> V_108 = F_38 ( & V_85 -> V_85 ,
F_39 ( V_5 -> V_74 ) ,
& V_5 -> V_52 , V_91 ) ;
if ( ! V_5 -> V_108 ) {
F_22 ( L_19 ,
...
V_96 . V_109 = V_5 -> V_52 ;
V_96 . V_110 = V_5 -> V_74 ;
for ( V_88 = ( unsigned long ) V_5 -> V_108 ;
V_88 < F_39 ( ( unsigned long ) V_5 -> V_108 + V_5 -> V_74 ) ;
V_88 += V_111 ) {
#ifdef F_40
F_41 ( F_42 ( F_43 ( ( void * ) V_88 ) ) ) ;
#else
F_41 ( F_42 ( V_88 ) ) ;
#endif
}
F_3 ( L_20 , V_5 -> V_108 ) ;
F_3 ( L_21 , V_5 -> V_52 , V_5 -> V_74 / 1024 ) ;
V_112 . V_19 = V_5 -> V_17 -> V_106 ;
V_112 . V_105 = V_5 -> V_17 -> V_105 ;
V_112 . V_31 = V_112 . V_105 ;
V_112 . V_53 = V_5 -> V_17 -> V_53 ;
V_112 . V_39 = V_112 . V_53 ;
V_5 -> V_13 . V_113 = V_5 -> V_108 ;
V_5 -> V_13 . V_114 = & V_115 ;
V_5 -> V_13 . V_27 = V_96 ;
V_5 -> V_13 . V_64 =
F_28 ( & V_85 -> V_85 , sizeof( T_1 ) * 16 , V_91 ) ;
if ( ! V_5 -> V_13 . V_64 )
return - V_92 ;
if ( F_44 ( & V_5 -> V_13 . V_116 , V_62 , 0 ) < 0 ) {
F_22 ( L_22 ,
V_62 ) ;
return - V_95 ;
}
...
if ( V_5 -> V_108 ) {
F_48 ( & V_85 -> V_85 , V_5 -> V_74 , V_5 -> V_108 ,
V_5 -> V_52 ) ;
}
if ( V_5 -> V_13 . V_116 . V_117 != 0 ) {
F_49 ( & V_5 -> V_13 . V_116 ) ;
}
return - V_79 ;
}
...
int F_54 ( struct V_84 * V_85 , T_2 V_120 )
{
struct V_4 * V_5 = F_51 ( V_85 ) ;
if ( ! V_5 )
return 0 ;
F_1 ( V_12 , & V_5 -> V_13 ) ;
if ( V_5 -> V_104 )
F_55 ( V_5 -> V_104 ) ;
memcpy ( & V_121 , V_5 -> V_7 , sizeof( struct V_101 ) ) ;
return 0 ;
}
int F_56 ( struct V_84 * V_85 )
{
struct V_4 * V_5 = F_51 ( V_85 ) ;
if ( ! V_5 )
return 0 ;
memcpy ( V_5 -> V_7 , & V_121 , sizeof( struct V_101 ) ) ;
if ( V_5 -> V_104 )
F_57 ( V_5 -> V_104 ) ;
F_1 ( V_6 , & V_5 -> V_13 ) ;
return 0 ;
