...
int F_67 ( struct V_144 * V_7 , enum V_145 V_146 )
{
struct V_141 * V_111 = F_68 ( V_7 -> V_9 ) ;
struct V_107 * V_108 = V_7 -> V_9 -> V_147 ;
struct V_1 * V_1 ;
int V_6 ;
if ( ! V_111 ) {
if ( ! V_108 )
return - V_36 ;
V_111 = F_69 ( V_7 -> V_9 , sizeof( * V_111 ) , V_148 ) ;
if ( ! V_111 )
return - V_149 ;
F_63 ( V_111 , V_108 ) ;
if ( F_70 ( V_108 , L_24 , NULL ) == NULL )
V_7 -> V_69 = - 1 ;
}
V_1 = F_69 ( V_7 -> V_9 , sizeof( struct V_1 ) , V_148 ) ;
if ( ! V_1 )
return - V_149 ;
F_71 ( & V_1 -> V_91 ) ;
F_71 ( & V_1 -> V_17 ) ;
...
V_1 -> V_151 = F_72 ( V_7 -> V_9 , L_25 ) ;
if ( ! F_73 ( V_1 -> V_151 ) ) {
V_6 = F_74 ( V_1 -> V_151 ) ;
if ( V_6 )
F_62 ( V_7 -> V_9 , L_26 ) ;
}
V_1 -> V_152 = F_72 ( V_7 -> V_9 , L_27 ) ;
if ( ! F_73 ( V_1 -> V_152 ) ) {
V_6 = F_74 ( V_1 -> V_152 ) ;
if ( V_6 )
F_62 ( V_7 -> V_9 , L_28 ) ;
...
V_1 -> V_3 = V_157 [ V_1 -> V_146 ] ;
} else if ( V_111 -> V_110 == V_143 ) {
V_111 -> V_110 = F_78 ( V_1 -> V_69 ) ;
}
V_6 = F_57 ( V_1 ) ;
if ( V_6 )
return V_6 ;
...
static int F_83 ( struct V_160 * V_9 )
{
...
static int F_87 ( struct V_160 * V_9 )
{
struct V_1 * V_1 = F_84 ( V_9 ) ;
if ( V_1 -> V_69 >= 0 && F_85 ( V_9 ) )
F_88 ( V_1 -> V_69 ) ;
