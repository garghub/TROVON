...
static T_6 T_3 * F_115 ( int V_60 , T_1 V_8 )
{
struct V_40 * V_41 ;
...
static int F_129 ( int V_60 , T_1 V_8 , T_1 V_9 )
{
unsigned long V_26 = V_8 >> V_36 ;
T_6 * V_41 = F_117 ( V_60 ) ;
struct V_47 * V_123 = V_41 -> V_49 + V_99 ;
if ( F_50 ( V_123 ) )
return 0 ;
if ( V_123 -> V_56 <= V_26 )
return 1 ;
...
int F_130 ( int V_60 , T_1 V_8 , T_1 V_9 , int V_124 )
{
if ( F_129 ( V_60 , V_8 , V_9 ) )
return V_99 ;
return V_124 ;
}
int T_3 F_131 ( int V_60 , T_1 V_8 , T_1 V_9 )
{
T_6 * V_41 = NULL ;
bool V_125 ;
bool V_126 ;
...
static inline int F_134 ( struct V_19 * V_19 )
{
return F_135 ( V_19 ) && F_136 ( V_19 ) >= V_127 ;
}
static struct V_19 * F_137 ( struct V_19 * V_19 )
{
F_19 ( F_138 ( V_19 ) & ( V_128 - 1 ) ) ;
if ( F_134 ( V_19 ) ) {
int V_129 ;
V_129 = F_136 ( V_19 ) ;
if ( ( V_129 < V_130 ) && ( V_129 >= V_127 ) )
return V_19 + ( 1 << V_129 ) ;
}
return V_19 + V_128 ;
}
int F_139 ( unsigned long V_26 , unsigned long V_44 )
{
struct V_19 * V_19 = F_57 ( V_26 ) ;
struct V_19 * V_131 = V_19 + V_44 ;
for (; V_19 < V_131 ; V_19 = F_137 ( V_19 ) ) {
if ( ! F_140 ( V_19 ) )
return 0 ;
F_141 () ;
}
...
static int F_142 ( unsigned long V_26 , unsigned long V_43 )
{
unsigned long V_42 ;
...
V_42 += V_132 ) {
V_30 = 0 ;
while ( ( V_30 < V_132 ) && ! F_143 ( V_42 + V_30 ) )
V_30 ++ ;
if ( V_30 == V_132 )
continue;
V_19 = F_57 ( V_42 + V_30 ) ;
...
static unsigned long F_144 ( unsigned long V_8 , unsigned long V_13 )
{
unsigned long V_42 ;
struct V_19 * V_19 ;
...
static int
F_150 ( unsigned long V_26 , unsigned long V_43 )
{
unsigned long V_42 ;
struct V_19 * V_19 ;
int V_133 = V_134 ;
...
int V_66 = 0 ;
F_151 ( V_136 ) ;
for ( V_42 = V_26 ; V_42 < V_43 && V_133 > 0 ; V_42 ++ ) {
if ( ! F_41 ( V_42 ) )
continue;
V_19 = F_57 ( V_42 ) ;
if ( F_146 ( V_19 ) ) {
struct V_19 * V_137 = F_152 ( V_19 ) ;
V_42 = F_138 ( V_137 ) + ( 1 << F_149 ( V_137 ) ) - 1 ;
if ( F_149 ( V_137 ) > V_77 ) {
V_66 = - V_138 ;
break;
}
...
static int
F_166 ( unsigned long V_8 , unsigned long V_44 ,
void * V_144 )
{
F_167 ( V_8 , V_8 + V_44 ) ;
return 0 ;
...
static void
F_168 ( unsigned long V_26 , unsigned long V_43 )
{
F_107 ( V_26 , V_43 - V_26 , NULL ,
F_166 ) ;
}
static int
F_169 ( unsigned long V_26 , unsigned long V_44 ,
void * V_144 )
{
int V_66 ;
long V_145 = * ( long * ) V_144 ;
V_66 = F_170 ( V_26 , V_26 + V_44 , true ) ;
V_145 = V_44 ;
if ( ! V_66 )
* ( long * ) V_144 += V_145 ;
return V_66 ;
...
static long
F_171 ( unsigned long V_26 , unsigned long V_43 )
{
long V_145 = 0 ;
int V_66 ;
V_66 = F_107 ( V_26 , V_43 - V_26 , & V_145 ,
F_169 ) ;
if ( V_66 < 0 )
V_145 = ( long ) V_66 ;
return V_145 ;
}
static bool F_172 ( struct V_47 * V_47 , unsigned long V_44 )
{
return true ;
}
static bool F_172 ( struct V_47 * V_47 , unsigned long V_44 )
...
enum V_58 V_146 ;
for ( V_146 = 0 ; V_146 <= V_97 ; V_146 ++ )
V_114 += V_41 -> V_49 [ V_146 ] . V_114 ;
if ( V_114 > V_44 )
return true ;
V_114 = 0 ;
for (; V_146 <= V_99 ; V_146 ++ )
V_114 += V_41 -> V_49 [ V_146 ] . V_114 ;
return V_114 == 0 ;
}
static int T_7 F_173 ( char * V_80 )
{
#ifdef F_174
F_175 ( true ) ;
V_147 = true ;
...
static void F_176 ( unsigned long V_44 ,
struct V_47 * V_47 , struct V_95 * V_92 )
{
struct V_40 * V_41 = V_47 -> V_61 ;
unsigned long V_114 = 0 ;
enum V_58 V_146 , V_96 = V_97 ;
if ( V_98 == V_94 )
V_96 = V_99 ;
for ( V_146 = 0 ; V_146 <= V_96 ; V_146 ++ )
V_114 += V_41 -> V_49 [ V_146 ] . V_114 ;
...
static void F_177 ( int V_45 , struct V_95 * V_92 )
{
if ( V_92 -> V_100 >= 0 )
F_178 ( V_45 , V_94 ) ;
if ( ( V_98 != V_94 ) &&
...
static int T_3 F_179 ( unsigned long V_26 ,
unsigned long V_43 , unsigned long V_148 )
{
unsigned long V_42 , V_44 , V_149 ;
long V_150 ;
int V_66 , V_151 , V_152 , V_45 ;
unsigned long V_14 ;
struct V_47 * V_47 ;
struct V_95 V_92 ;
if ( ! F_180 ( V_26 , V_128 ) )
...
V_44 = V_43 - V_26 ;
V_66 = - V_82 ;
if ( F_55 ( V_47 ) <= V_97 && ! F_172 ( V_47 , V_44 ) )
goto V_108;
V_66 = F_181 ( V_26 , V_43 ,
V_153 , true ) ;
if ( V_66 )
goto V_108;
V_92 . V_26 = V_26 ;
V_92 . V_44 = V_44 ;
F_176 ( V_44 , V_47 , & V_92 ) ;
V_66 = V_95 ( V_154 , & V_92 ) ;
V_66 = F_104 ( V_66 ) ;
if ( V_66 )
goto V_155;
V_42 = V_26 ;
...
V_42 = F_144 ( V_26 , V_43 ) ;
if ( V_42 ) {
V_66 = F_150 ( V_42 , V_43 ) ;
if ( ! V_66 ) {
V_151 = 1 ;
goto V_157;
} else {
...
F_185 () ;
F_187 ( V_26 , V_43 ) ;
V_150 = F_171 ( V_26 , V_43 ) ;
if ( V_150 < 0 ) {
V_66 = - V_138 ;
goto V_155;
}
F_109 ( V_160 L_10 , V_150 ) ;
F_168 ( V_26 , V_43 ) ;
F_188 ( V_26 , V_43 , V_153 ) ;
F_92 ( F_57 ( V_26 ) , - V_150 ) ;
V_47 -> V_114 -= V_150 ;
F_61 ( V_47 -> V_61 , & V_14 ) ;
V_47 -> V_61 -> V_115 -= V_150 ;
F_62 ( V_47 -> V_61 , & V_14 ) ;
F_111 () ;
if ( ! F_105 ( V_47 ) ) {
F_108 ( V_47 ) ;
...
int F_190 ( unsigned long V_26 , unsigned long V_44 )
{
return F_179 ( V_26 , V_26 + V_44 , 120 * V_163 ) ;
}
int F_191 ( unsigned long V_26 , unsigned long V_43 ,
void * V_92 , int (* F_192)( struct V_164 * , void * ) )
{
...
( V_29 <= V_165 -> V_168 ) )
continue;
V_165 = F_194 ( V_166 , V_165 ) ;
if ( ! V_165 )
continue;
V_66 = F_192 ( V_165 , V_92 ) ;
if ( V_66 ) {
F_195 ( & V_165 -> V_169 . V_170 ) ;
return V_66 ;
}
}
if ( V_165 )
...
static int F_196 ( struct V_164 * V_165 , void * V_92 )
{
int V_66 = ! F_197 ( V_165 ) ;
if ( F_8 ( V_66 ) ) {
T_8 V_171 , V_172 ;
V_171 = F_198 ( F_83 ( V_165 -> V_167 ) ) ;
V_172 = F_198 ( F_83 ( V_165 -> V_168 + 1 ) ) - 1 ;
F_87 ( L_12
L_13 ,
& V_171 , & V_172 ) ;
}
...
static int F_199 ( T_6 * V_41 )
{
int V_173 ;
F_200 (cpu) {
if ( F_201 ( V_173 ) == V_41 -> V_46 )
return - V_138 ;
}
return 0 ;
}
static void F_202 ( T_6 * V_41 )
{
#ifdef F_203
int V_173 ;
F_204 (cpu)
...
F_19 ( F_128 ( V_8 , V_9 ) ) ;
F_11 () ;
V_66 = F_191 ( F_116 ( V_8 ) , F_215 ( V_8 + V_9 - 1 ) , NULL ,
F_196 ) ;
if ( V_66 )
F_216 () ;
