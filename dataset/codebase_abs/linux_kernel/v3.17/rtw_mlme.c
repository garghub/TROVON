...
F_60 ( V_8 , V_147 ) ;
if ( F_61 ( V_8 ) == V_11 ) {
F_62 ( & V_8 -> V_153 , V_154 ) ;
} else {
struct V_88 * V_155 = & ( V_1 -> V_142 . V_156 ) ;
T_1 * V_85 = V_1 -> V_142 . V_156 . V_81 ;
F_58 ( V_8 , V_150 ) ;
F_21 ( V_60 , V_132 , ( L_10 ) ) ;
memset ( & V_155 -> V_101 , 0 , sizeof( struct V_25 ) ) ;
memcpy ( & V_155 -> V_101 , & V_8 -> V_24 , sizeof( struct V_25 ) ) ;
F_63 ( V_1 ) ;
F_30 ( V_85 ) ;
V_8 -> V_14 = V_74 ;
if ( F_64 ( V_1 ) != V_11 )
...
if ( V_8 -> V_158 != 0 ) {
if ( -- V_8 -> V_158 == 0 ||
V_11 != F_66 ( V_1 , & V_8 -> V_24 , 1 , NULL , 0 ) ) {
V_8 -> V_158 = 0 ;
F_67 ( V_1 , 1 ) ;
F_68 ( V_1 ) ;
} else {
...
{
struct V_55 * V_56 = & V_8 -> V_22 ;
struct V_55 * V_160 = & V_8 -> V_23 ;
struct V_57 * V_58 , * V_78 , * V_161 ;
F_21 ( V_60 , V_162 , ( L_13 ) ) ;
F_17 ( & V_160 -> V_21 ) ;
F_17 ( & V_56 -> V_21 ) ;
V_78 = F_26 ( V_160 ) ;
V_58 = V_78 -> V_59 ;
...
void F_67 ( struct V_1 * V_1 , int V_163 )
{
struct V_5 * V_111 = NULL ;
struct V_7 * V_8 = & V_1 -> V_9 ;
struct V_164 * V_165 = & V_1 -> V_166 ;
struct V_5 * V_167 = & V_8 -> V_15 ;
F_21 ( V_60 , V_162 , ( L_14 ) ) ;
F_21 ( V_60 , V_61 ,
( L_15 ,
V_167 -> V_16 . V_81 , V_167 -> V_16 . V_101 . V_101 ) ) ;
if ( F_24 ( V_8 , V_168 | V_169 ) ) {
struct V_170 * V_171 ;
V_171 = F_74 ( & V_1 -> V_166 , V_167 -> V_16 . V_81 ) ;
F_17 ( & ( V_165 -> V_172 ) ) ;
F_75 ( V_1 , V_171 ) ;
F_22 ( & V_165 -> V_172 ) ;
}
if ( F_24 ( V_8 , V_75 | V_74 | V_169 ) ) {
struct V_170 * V_171 ;
F_76 ( V_1 ) ;
V_171 = F_77 ( V_1 ) ;
F_17 ( & ( V_165 -> V_172 ) ) ;
...
if ( V_163 )
F_17 ( & ( V_8 -> V_23 . V_21 ) ) ;
V_111 = F_27 ( & V_8 -> V_23 , V_167 -> V_16 . V_81 ) ;
if ( V_111 )
V_111 -> V_63 = false ;
else
F_21 ( V_60 , V_132 , ( L_16 ) ) ;
if ( ( F_24 ( V_8 , V_74 ) && ( V_1 -> V_166 . V_173 == 1 ) ) )
F_36 ( V_8 , V_111 ) ;
if ( V_163 )
F_22 ( & V_8 -> V_23 . V_21 ) ;
V_8 -> V_174 = 0 ;
...
inline void F_84 ( struct V_1 * V_2 , bool V_178 )
{
F_85 ( V_2 , V_178 ) ;
}
...
T_2 V_179 ;
struct V_7 * V_8 = & ( V_1 -> V_9 ) ;
struct V_148 * V_149 = & ( V_1 -> V_159 ) ;
V_179 = V_65 ;
V_149 -> V_180 = true ;
while ( F_24 ( V_8 , V_150 ) &&
F_87 ( V_179 ) <= 200 ) {
if ( V_1 -> V_82 || V_1 -> V_83 )
break;
F_52 ( V_181 L_20 , F_88 ( V_1 -> V_182 ) ) ;
F_89 ( 20 ) ;
}
if ( F_24 ( V_8 , V_150 ) ) {
if ( ! V_1 -> V_82 && ! V_1 -> V_83 )
F_52 ( V_181 L_21 , F_88 ( V_1 -> V_182 ) ) ;
F_84 ( V_1 , true ) ;
}
V_149 -> V_180 = false ;
}
static struct V_170 * F_90 ( struct V_1 * V_2 , struct V_5 * V_6 )
{
int V_3 ;
struct V_170 * V_183 , * V_171 = NULL ;
struct V_184 * V_185 ;
struct V_164 * V_165 = & V_2 -> V_166 ;
V_171 = F_74 ( V_165 , V_6 -> V_16 . V_81 ) ;
if ( V_171 == NULL )
V_171 = F_91 ( V_165 , V_6 -> V_16 . V_81 ) ;
if ( V_171 ) {
F_52 ( L_22 , V_186 ) ;
V_171 -> V_66 = V_6 -> V_67 ;
V_171 -> V_187 = 0 ;
F_92 ( V_2 , V_188 , V_171 , true ) ;
if ( V_2 -> V_95 . V_189 == V_190 ) {
V_2 -> V_95 . V_191 = false ;
V_2 -> V_95 . V_192 = false ;
V_2 -> V_95 . V_193 = false ;
V_171 -> V_194 = true ;
V_171 -> V_195 = V_2 -> V_95 . V_96 ;
memset ( ( T_1 * ) & V_171 -> V_196 , 0 , sizeof( union V_197 ) ) ;
memset ( ( T_1 * ) & V_171 -> V_198 , 0 , sizeof( union V_197 ) ) ;
memset ( ( T_1 * ) & V_171 -> V_199 , 0 , sizeof( union V_197 ) ) ;
memset ( ( T_1 * ) & V_171 -> V_200 , 0 , sizeof( union V_201 ) ) ;
memset ( ( T_1 * ) & V_171 -> V_202 , 0 , sizeof( union V_201 ) ) ;
}
if ( V_2 -> V_95 . V_203 != 0 ) {
V_171 -> V_194 = true ;
V_2 -> V_95 . V_203 = 0 ;
...
static void F_94 ( struct V_1 * V_2 , struct V_5 * V_209 , struct V_5 * V_6 )
{
struct V_7 * V_8 = & ( V_2 -> V_9 ) ;
...
V_2 -> V_122 . V_211 = F_95 ( V_209 -> V_16 . V_117 . V_125 ) ;
F_59 ( & V_2 -> V_122 ) ;
switch ( V_6 -> V_16 . V_17 ) {
case V_212 :
if ( V_8 -> V_14 & V_140 )
V_8 -> V_14 = V_168 | V_140 ;
else
V_8 -> V_14 = V_168 ;
break;
case V_213 :
...
sizeof( struct V_126 ) ,
( V_15 -> V_16 . V_127 ) ) ;
F_96 ( V_2 , V_15 -> V_16 . V_91 , V_15 -> V_16 . V_127 ) ;
}
void F_97 ( struct V_1 * V_1 , T_1 * V_4 )
{
struct V_170 * V_215 = NULL , * V_216 = NULL ;
struct V_164 * V_165 = & V_1 -> V_166 ;
struct V_7 * V_8 = & ( V_1 -> V_9 ) ;
...
if ( V_217 )
V_217 -> V_63 = false ;
V_216 = F_74 ( V_165 , V_15 -> V_16 . V_81 ) ;
if ( V_216 ) {
F_17 ( & ( V_165 -> V_172 ) ) ;
F_75 ( V_1 , V_216 ) ;
F_22 ( & V_165 -> V_172 ) ;
...
struct V_164 * V_165 = & V_2 -> V_166 ;
#endif
struct V_148 * V_149 = & ( V_2 -> V_159 ) ;
struct V_221 * V_222 = & ( V_149 -> V_223 ) ;
#if F_103 ( V_220 )
if ( F_24 ( V_8 , V_169 ) ) {
for ( V_66 = ( V_165 -> V_224 ) ; V_66 > 0 ; V_66 -- ) {
if ( V_165 -> V_225 [ V_66 - 1 ] != NULL )
break;
}
V_187 = V_66 + 1 ;
} else
...
void F_104 ( struct V_1 * V_1 , struct V_170 * V_171 )
{
T_3 V_230 ;
T_1 V_231 ;
if ( V_171 == NULL )
return;
V_231 = F_102 ( V_1 ) ;
F_105 ( V_1 , V_232 , ( T_1 * ) & V_231 ) ;
V_230 = ( V_171 -> V_187 << 8 ) | 1 ;
F_105 ( V_1 , V_233 , ( T_1 * ) & V_230 ) ;
}
void F_106 ( struct V_1 * V_1 , T_1 * V_4 )
{
struct V_170 * V_171 ;
struct V_7 * V_8 = & ( V_1 -> V_9 ) ;
...
if ( F_107 ( V_1 , V_235 -> V_236 ) == false )
return;
#if F_103 ( V_220 )
if ( F_24 ( V_8 , V_169 ) ) {
V_171 = F_74 ( & V_1 -> V_166 , V_235 -> V_236 ) ;
if ( V_171 ) {
F_108 ( V_1 , V_171 ) ;
F_104 ( V_1 , V_171 ) ;
}
...
V_171 = F_91 ( & V_1 -> V_166 , V_235 -> V_236 ) ;
if ( V_171 == NULL ) {
F_21 ( V_60 , V_132 , ( L_37 ) ) ;
return;
}
V_171 -> V_237 = 0 ;
V_171 -> V_187 = ( T_5 ) V_235 -> V_238 ;
F_52 ( L_22 , V_186 ) ;
F_92 ( V_1 , V_188 , V_171 , true ) ;
F_104 ( V_1 , V_171 ) ;
if ( V_1 -> V_95 . V_189 == V_190 )
V_171 -> V_195 = V_1 -> V_95 . V_96 ;
V_171 -> V_194 = false ;
F_17 ( & V_8 -> V_21 ) ;
if ( ( F_24 ( V_8 , V_74 ) ) ||
( F_24 ( V_8 , V_75 ) ) ) {
if ( V_1 -> V_166 . V_173 == 2 ) {
F_17 ( & ( V_8 -> V_23 . V_21 ) ) ;
V_209 = F_27 ( & V_8 -> V_23 , V_15 -> V_16 . V_81 ) ;
if ( V_209 )
V_209 -> V_63 = true ;
...
struct V_170 * V_171 ;
struct V_5 * V_111 = NULL ;
struct V_88 * V_155 = NULL ;
T_1 * V_85 = NULL ;
struct V_7 * V_8 = & ( V_1 -> V_9 ) ;
struct V_239 * V_240 = (struct V_239 * ) V_4 ;
struct V_164 * V_165 = & V_1 -> V_166 ;
struct V_5 * V_167 = & ( V_8 -> V_15 ) ;
V_171 = F_74 ( & V_1 -> V_166 , V_240 -> V_236 ) ;
if ( V_171 )
V_187 = V_171 -> V_187 ;
else
V_187 = V_240 -> V_187 ;
...
F_22 ( & V_8 -> V_23 . V_21 ) ;
V_155 = & ( V_1 -> V_142 . V_156 ) ;
V_85 = V_1 -> V_142 . V_156 . V_81 ;
memcpy ( V_155 , & V_167 -> V_16 , F_44 ( & V_167 -> V_16 ) ) ;
memset ( & V_155 -> V_101 , 0 , sizeof( struct V_25 ) ) ;
memcpy ( & V_155 -> V_101 , & V_8 -> V_24 , sizeof( struct V_25 ) ) ;
F_63 ( V_1 ) ;
F_30 ( V_85 ) ;
...
void F_114 ( struct V_1 * V_2 , T_1 * V_4 )
{
F_21 ( V_60 , V_132 , ( L_40 ) ) ;
}
void F_115 ( void * V_245 )
{
...
void F_117 ( void * V_245 )
{
struct V_1 * V_1 = (struct V_1 * ) V_245 ;
struct V_7 * V_8 = & V_1 -> V_9 ;
F_52 ( V_247 L_45 , F_118 ( V_1 ) , F_56 ( V_8 ) ) ;
F_17 ( & V_8 -> V_21 ) ;
F_58 ( V_8 , V_150 ) ;
F_22 ( & V_8 -> V_21 ) ;
F_84 ( V_1 , true ) ;
...
V_92 = F_125 ( V_1 , V_255 ) ;
exit:
F_22 ( & V_8 -> V_23 . V_21 ) ;
return V_92 ;
}
int F_126 ( struct V_1 * V_1 , struct V_93 * V_94 )
{
struct V_266 * V_267 ;
struct V_268 * V_269 ;
struct V_270 * V_271 = & ( V_1 -> V_272 ) ;
int V_10 = V_11 ;
V_267 = F_127 ( sizeof( struct V_266 ) , V_273 ) ;
if ( V_267 == NULL ) {
V_10 = V_27 ;
goto exit;
}
V_269 = F_127 ( sizeof( struct V_268 ) , V_273 ) ;
if ( V_269 == NULL ) {
F_11 ( V_267 ) ;
V_10 = V_27 ;
goto exit;
...
( L_55 ,
V_94 -> V_189 ) ) ;
V_10 = F_128 ( V_271 , V_267 ) ;
exit:
return V_10 ;
}
int F_129 ( struct V_1 * V_1 , struct V_93 * V_94 , int V_281 , T_1 V_282 )
{
T_1 V_283 ;
struct V_266 * V_267 ;
struct V_284 * V_285 ;
...
if ( V_267 == NULL )
return V_27 ;
V_285 = F_127 ( sizeof( struct V_284 ) , V_273 ) ;
if ( V_285 == NULL ) {
V_10 = V_27 ;
goto V_286;
}
...
V_285 -> V_282 = V_282 ;
V_8 -> V_174 |= F_130 ( V_285 -> V_281 ) ;
F_52 ( L_58 ,
V_285 -> V_287 , V_285 -> V_281 , V_8 -> V_174 ) ;
F_21 ( V_60 , V_132 ,
( L_59 ,
V_285 -> V_287 , V_281 ) ) ;
switch ( V_285 -> V_287 ) {
...
int F_131 ( struct V_1 * V_1 , T_1 * V_300 , T_1 * V_301 , T_5 V_302 , T_5 V_303 )
{
...
static int F_132 ( struct V_1 * V_306 , T_1 * V_307 )
{
...
static int F_133 ( struct V_1 * V_306 , int V_312 , T_1 * V_87 , T_5 V_313 )
{
struct V_93 * V_94 = & V_306 -> V_95 ;
if ( V_87 [ 13 ] <= 20 ) {
V_87 [ V_313 ] = 1 ;
...
int F_134 ( struct V_1 * V_1 , T_1 * V_300 , T_1 * V_301 , T_5 V_302 )
{
T_1 V_315 ;
T_5 V_304 ;
int V_312 ;
...
F_135 ( V_1 , V_315 , V_94 -> V_326 ) ;
}
V_312 = F_132 ( V_1 , V_8 -> V_259 ) ;
if ( V_312 < 0 ) {
return V_304 ;
} else {
if ( V_315 == V_324 )
V_304 = F_133 ( V_1 , V_312 , V_301 , V_304 ) ;
}
return V_304 ;
}
...
struct V_88 * V_155 = & V_251 -> V_156 ;
T_1 * V_330 = F_137 ( V_328 ) ;
memcpy ( V_155 -> V_81 , V_330 , V_80 ) ;
memcpy ( & V_155 -> V_101 , & V_251 -> V_331 , sizeof( struct V_25 ) ) ;
V_155 -> V_262 . V_133 = sizeof( struct V_332 ) ;
V_155 -> V_262 . V_333 = 100 ;
V_155 -> V_262 . V_334 . V_133 = 0 ;
V_155 -> V_262 . V_334 . V_335 = 0 ;
V_155 -> V_262 . V_334 . V_336 = 0 ;
V_155 -> V_262 . V_334 . V_337 = 0 ;
}
...
V_155 -> V_262 . V_263 = ( V_251 -> V_353 ) ;
F_21 ( V_60 , V_61 ,
( L_62 ,
V_251 -> V_353 , V_155 -> V_262 . V_263 ) ) ;
if ( V_15 -> V_16 . V_17 == V_213 )
V_155 -> V_262 . V_354 = ( 0 ) ;
V_155 -> V_17 = ( V_15 -> V_16 . V_17 ) ;
V_338 = F_138 ( V_251 ) ;
V_155 -> V_127 = V_338 ;
V_155 -> V_133 = F_44 ( (struct V_88 * ) V_155 ) ;
}
...
V_355 = 0 ;
F_105 ( V_2 , V_363 , ( T_1 * ) ( & V_355 ) ) ;
} else {
V_355 = 1 ;
F_105 ( V_2 , V_363 , ( T_1 * ) ( & V_355 ) ) ;
}
}
unsigned int F_140 ( struct V_1 * V_2 , T_1 * V_300 , T_1 * V_301 , T_5 V_302 , T_5 * V_364 )
{
T_2 V_365 , V_366 ;
enum V_367 V_368 ;
unsigned char * V_369 ;
...
T_2 V_376 , V_377 ;
V_357 -> V_362 = false ;
V_369 = F_141 ( V_300 + 12 , V_378 , & V_365 , V_302 - 12 ) ;
if ( V_369 && V_365 > 0 ) {
if ( V_374 -> V_237 == 0 ) {
V_366 = * V_364 ;
F_142 ( V_301 + V_366 , V_379 ,
V_380 , V_372 , V_364 ) ;
V_374 -> V_237 = 1 ;
}
V_366 = * V_364 ;
...
F_142 ( V_301 + V_366 , V_378 ,
sizeof( struct V_370 ) , ( unsigned char * ) & V_371 , V_364 ) ;
V_357 -> V_362 = true ;
V_369 = F_141 ( V_300 + 12 , V_392 , & V_365 , V_302 - 12 ) ;
if ( V_369 && ( V_365 == sizeof( struct V_393 ) ) ) {
V_366 = * V_364 ;
F_142 ( V_301 + V_366 , V_392 , V_365 , V_369 + 2 , V_364 ) ;
}
}
return V_357 -> V_362 ;
}
void F_96 ( struct V_1 * V_2 , T_1 * V_394 , T_5 V_313 )
{
T_1 * V_369 , V_395 ;
int V_145 ;
struct V_370 * V_396 ;
...
V_145 = 0 ;
V_369 = F_141 ( V_394 + sizeof( struct V_126 ) , V_378 , & V_145 , V_313 - sizeof( struct V_126 ) ) ;
if ( V_369 && V_145 > 0 ) {
...
V_145 = 0 ;
V_369 = F_141 ( V_394 + sizeof( struct V_126 ) , V_392 , & V_145 , V_313 - sizeof( struct V_126 ) ) ;
if ( ( V_251 -> V_401 ) &&
( F_33 ( V_222 -> V_402 . V_403 . V_404 . V_405 ) & F_130 ( 1 ) ) &&
( V_222 -> V_406 . V_407 [ 0 ] & F_130 ( 2 ) ) ) {
int V_3 ;
T_1 V_408 ;
...
void F_143 ( struct V_1 * V_2 , struct V_428 * V_429 )
{
T_1 V_430 ;
int V_431 ;
...
V_171 = F_74 ( & V_2 -> V_166 , V_433 -> V_436 ) ;
if ( V_171 == NULL )
return;
V_357 = & V_171 -> V_358 ;
...
if ( 0 == V_430 ) {
F_52 ( L_65 , V_431 ) ;
V_171 -> V_358 . V_440 |= F_130 ( ( T_1 ) V_431 ) ;
F_145 ( V_2 , ( T_1 ) V_431 , V_433 -> V_436 ) ;
}
}
}
void F_146 ( struct V_1 * V_2 , struct V_5 * V_167 )
{
struct V_7 * V_8 = & V_2 -> V_9 ;
F_17 ( & V_8 -> V_21 ) ;
F_113 ( V_2 , V_167 ) ;
...
void F_113 ( struct V_1 * V_2 , struct V_5 * V_167 )
{
struct V_7 * V_8 = & V_2 -> V_9 ;
int V_246 ;
struct V_5 * V_6 ;
