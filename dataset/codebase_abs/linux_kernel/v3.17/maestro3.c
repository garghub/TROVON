...
if ( ( V_45 = V_196 ( V_2 -> V_107 , 0 , & V_202 , NULL , & V_197 ) ) < 0 )
return V_45 ;
memset ( & V_126 , 0 , sizeof( V_126 ) ) ;
V_126 . V_44 = V_2 ;
if ( ( V_45 = F_81 ( V_197 , & V_126 , & V_2 -> V_126 ) ) < 0 )
return V_45 ;
F_82 ( V_2 -> V_126 , V_205 , 0x8000 | ( 15 << 8 ) | 15 ) ;
F_77 ( F_78 ( 100 ) ) ;
F_82 ( V_2 -> V_126 , V_205 , 0 ) ;
#ifndef F_50
memset ( & V_200 , 0 , sizeof( V_200 ) ) ;
V_200 . V_206 = V_207 ;
strcpy ( V_200 . V_167 , L_4 ) ;
V_2 -> V_124 = F_83 ( V_2 -> V_107 , & V_200 ) ;
memset ( & V_200 , 0 , sizeof( V_200 ) ) ;
V_200 . V_206 = V_207 ;
strcpy ( V_200 . V_167 , L_5 ) ;
V_2 -> V_125 = F_83 ( V_2 -> V_107 , & V_200 ) ;
#endif
return 0 ;
}
...
V_224 , V_223 ) ;
V_2 -> V_152 . V_22 = 0 ;
V_2 -> V_152 . V_21 = V_225 ;
V_2 -> V_152 . V_226 = V_227 ;
V_2 -> V_153 . V_22 = 0 ;
V_2 -> V_153 . V_21 = V_228 ;
V_2 -> V_153 . V_226 = V_229 ;
V_2 -> V_155 . V_22 = 0 ;
V_2 -> V_155 . V_21 = V_213 ;
V_2 -> V_155 . V_226 = V_230 ;
V_2 -> V_154 . V_22 = 0 ;
V_2 -> V_154 . V_21 = V_231 ;
V_2 -> V_154 . V_226 = V_232 ;
}
...
F_84 ( V_2 ) ;
F_6 ( V_277 , V_2 -> V_5 + V_142 ) ;
F_6 ( 0x00 , V_174 + V_278 ) ;
F_6 ( 0x88 , V_174 + V_119 ) ;
F_6 ( 0x88 , V_174 + V_120 ) ;
F_6 ( 0x88 , V_174 + V_121 ) ;
F_6 ( 0x88 , V_174 + V_122 ) ;
return 0 ;
}
static void
F_95 ( struct V_1 * V_2 )
...
{
struct V_245 * V_169 = F_107 ( V_108 ) ;
struct V_284 * V_107 = F_108 ( V_108 ) ;
...
F_11 ( V_2 ) ;
V_285 = 0 ;
for ( V_91 = V_217 ; V_91 <= V_287 ; V_91 ++ )
V_2 -> V_283 [ V_285 ++ ] =
F_9 ( V_2 , V_216 , V_91 ) ;
for ( V_91 = V_288 ; V_91 <= V_289 ; V_91 ++ )
V_2 -> V_283 [ V_285 ++ ] =
F_9 ( V_2 , V_20 , V_91 ) ;
F_105 ( V_169 ) ;
F_112 ( V_169 ) ;
...
static int F_114 ( struct V_159 * V_108 )
{
struct V_245 * V_169 = F_107 ( V_108 ) ;
struct V_284 * V_107 = F_108 ( V_108 ) ;
struct V_1 * V_2 = V_107 -> V_44 ;
...
if ( ! V_130 )
return - V_151 ;
snprintf ( V_2 -> V_295 , sizeof( V_2 -> V_295 ) , L_8 ,
F_122 ( V_2 -> V_169 ) ) ;
V_130 -> V_167 = V_2 -> V_107 -> V_161 ;
V_130 -> V_295 = V_2 -> V_295 ;
V_130 -> V_129 . V_296 = V_297 ;
V_130 -> V_129 . V_298 = V_2 -> V_169 -> V_298 ;
V_130 -> V_129 . V_299 = V_2 -> V_169 -> V_159 ;
V_130 -> V_108 . V_300 = & V_2 -> V_169 -> V_108 ;
F_123 ( V_301 , V_130 -> V_302 ) ;
F_123 ( V_131 , V_130 -> V_303 ) ;
F_123 ( V_133 , V_130 -> V_303 ) ;
F_123 ( V_132 , V_130 -> V_303 ) ;
V_45 = F_124 ( V_130 ) ;
if ( V_45 ) {
F_125 ( V_130 ) ;
return V_45 ;
...
static int F_126 ( struct V_304 * V_159 )
{
struct V_1 * V_2 = V_159 -> V_305 ;
return F_96 ( V_2 ) ;
}
static int
F_127 ( struct V_284 * V_107 , struct V_245 * V_169 ,
int V_306 ,
int V_240 ,
struct V_1 * * V_307 )
{
...
static struct V_310 V_202 = {
. V_311 = F_126 ,
} ;
* V_307 = NULL ;
if ( F_116 ( V_169 ) )
return - V_292 ;
if ( F_128 ( V_169 , F_129 ( 28 ) ) < 0 ||
F_130 ( V_169 , F_129 ( 28 ) ) < 0 ) {
F_37 ( V_107 -> V_108 ,
L_9 ) ;
F_105 ( V_169 ) ;
return - V_46 ;
}
V_2 = F_131 ( sizeof( * V_2 ) , V_312 ) ;
if ( V_2 == NULL ) {
F_105 ( V_169 ) ;
return - V_151 ;
}
...
V_2 -> V_169 = V_169 ;
V_2 -> V_134 = - 1 ;
F_133 ( & V_2 -> V_118 , F_48 ) ;
V_2 -> V_239 = V_306 ;
if ( V_240 >= 0 && V_240 <= 0x0f )
V_2 -> V_240 = V_240 ;
else {
V_309 = F_134 ( V_169 , V_317 ) ;
if ( V_309 ) {
F_135 ( V_107 -> V_108 , L_10 ,
F_136 ( V_309 ) ) ;
V_2 -> V_240 = V_309 -> V_3 ;
} else if ( V_2 -> V_187 )
V_2 -> V_240 = V_318 ;
...
V_309 = F_134 ( V_169 , V_320 ) ;
if ( V_309 ) {
F_135 ( V_107 -> V_108 , L_11 ,
F_136 ( V_309 ) ) ;
V_2 -> V_189 = 1 ;
}
V_309 = F_134 ( V_169 , V_321 ) ;
if ( V_309 )
V_2 -> V_261 = V_309 -> V_3 ;
if ( F_134 ( V_169 , V_322 ) )
V_2 -> V_244 = 1 ;
V_2 -> V_146 = V_323 ;
V_2 -> V_147 = F_137 ( V_2 -> V_146 , sizeof( struct V_29 ) ,
V_312 ) ;
if ( V_2 -> V_147 == NULL ) {
F_99 ( V_2 ) ;
F_105 ( V_169 ) ;
...
if ( ( V_45 = F_139 ( V_169 , V_107 -> V_161 ) ) < 0 ) {
F_96 ( V_2 ) ;
return V_45 ;
}
...
F_88 ( V_2 , 1 ) ;
F_89 ( V_2 ) ;
if ( F_141 ( V_169 -> V_134 , F_56 , V_324 ,
V_325 , V_2 ) ) {
F_37 ( V_107 -> V_108 , L_14 , V_169 -> V_134 ) ;
F_96 ( V_2 ) ;
return - V_151 ;
}
V_2 -> V_134 = V_169 -> V_134 ;
#ifdef F_100
V_2 -> V_283 = F_142 ( sizeof( T_1 ) * ( V_326 + V_327 ) ) ;
if ( V_2 -> V_283 == NULL )
F_143 ( V_107 -> V_108 , L_15 ) ;
#endif
if ( ( V_45 = F_144 ( V_107 , V_328 , V_2 , & V_202 ) ) < 0 ) {
F_96 ( V_2 ) ;
return V_45 ;
}
if ( ( V_45 = F_80 ( V_2 ) ) < 0 )
...
static int
F_145 ( struct V_245 * V_169 , const struct V_329 * V_330 )
{
static int V_108 ;
struct V_284 * V_107 ;
struct V_1 * V_2 ;
int V_45 ;
if ( ( ( V_169 -> V_331 >> 8 ) & 0xffff ) != V_332 )
return - V_333 ;
if ( V_108 >= V_334 )
return - V_333 ;
if ( ! V_236 [ V_108 ] ) {
...
V_45 = F_146 ( & V_169 -> V_108 , V_7 [ V_108 ] , V_129 [ V_108 ] , V_336 ,
0 , & V_107 ) ;
if ( V_45 < 0 )
return V_45 ;
switch ( V_169 -> V_159 ) {
...
break;
default:
strcpy ( V_107 -> V_161 , L_19 ) ;
break;
}
if ( ( V_45 = F_127 ( V_107 , V_169 ,
V_239 [ V_108 ] ,
V_240 [ V_108 ] ,
& V_2 ) ) < 0 ) {
F_147 ( V_107 ) ;
...
V_107 -> V_44 = V_2 ;
sprintf ( V_107 -> V_337 , L_20 , V_107 -> V_161 ) ;
sprintf ( V_107 -> V_338 , L_21 ,
V_107 -> V_337 , V_2 -> V_5 , V_2 -> V_134 ) ;
if ( ( V_45 = F_148 ( V_107 ) ) < 0 ) {
F_147 ( V_107 ) ;
return V_45 ;
}
#if 0
