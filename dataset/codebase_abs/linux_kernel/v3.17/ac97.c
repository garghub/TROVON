...
{
struct V_55 * V_56 , * V_57 , * V_58 , * V_59 , * V_60 ;
struct V_61 * V_62 ;
int V_63 ;
V_62 = V_54 -> V_64 . V_65 ;
if ( ! V_62 || ! V_62 -> V_66 ) {
...
V_57 = F_27 ( V_54 , V_68 , 0 ) ;
if ( ! V_57 ) {
F_26 ( & V_54 -> V_64 , L_8 ) ;
return - V_69 ;
}
V_58 = F_27 ( V_54 , V_68 , 1 ) ;
if ( ! V_58 ) {
F_26 ( & V_54 -> V_64 , L_9 ) ;
return - V_69 ;
}
V_59 = F_27 ( V_54 , V_68 , 2 ) ;
if ( ! V_59 ) {
F_26 ( & V_54 -> V_64 , L_10 ) ;
return - V_69 ;
}
V_60 = F_27 ( V_54 , V_70 , 0 ) ;
if ( ! V_60 ) {
F_26 ( & V_54 -> V_64 , L_11 ) ;
return - V_69 ;
}
V_56 = F_27 ( V_54 , V_71 , 0 ) ;
V_5 . V_6 = F_28 ( & V_54 -> V_64 , V_56 ) ;
if ( F_29 ( V_5 . V_6 ) )
return F_30 ( V_5 . V_6 ) ;
V_50 . V_72 = V_57 -> V_73 ;
V_50 . V_74 = V_56 -> V_73 + V_75 ;
V_51 . V_72 = V_58 -> V_73 ;
V_51 . V_74 = V_56 -> V_73 + V_75 ;
V_52 . V_72 = V_59 -> V_73 ;
V_52 . V_74 = V_56 -> V_73 + V_76 ;
F_31 ( & V_5 . V_9 ) ;
F_32 ( & V_5 . V_19 ) ;
V_5 . V_77 = F_33 ( & V_54 -> V_64 , L_12 ) ;
if ( F_29 ( V_5 . V_77 ) ) {
F_26 ( & V_54 -> V_64 , L_13 ) ;
V_63 = - V_78 ;
goto V_79;
...
V_63 = F_36 ( & V_82 ) ;
if ( V_63 != 0 ) {
F_26 ( & V_54 -> V_64 , L_17 , V_63 ) ;
goto V_81;
}
V_63 = F_37 ( & V_54 -> V_64 , & V_83 ,
V_84 , F_38 ( V_84 ) ) ;
if ( V_63 )
goto V_85;
V_63 = F_39 ( & V_54 -> V_64 ) ;
if ( V_63 ) {
F_26 ( & V_54 -> V_64 , L_18 , V_63 ) ;
goto V_85;
}
return 0 ;
V_85:
