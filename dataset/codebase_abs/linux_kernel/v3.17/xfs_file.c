...
V_190 = F_41 ( V_24 , V_18 ) ;
V_19 = F_46 ( V_24 , V_73 ) ;
for (; ; ) {
struct V_78 V_176 [ 2 ] ;
int V_193 = 2 ;
unsigned int V_184 ;
error = F_43 ( V_2 , V_190 , V_19 - V_190 , V_176 , & V_193 ,
V_194 ) ;
if ( error )
goto V_129;
if ( V_193 == 0 ) {
...
for ( V_184 = 0 ; V_184 < V_193 ; V_184 ++ ) {
V_12 = F_110 ( T_1 , V_18 ,
F_47 ( V_24 , V_176 [ V_184 ] . V_93 ) ) ;
if ( V_176 [ V_184 ] . V_81 == V_195 ||
( V_176 [ V_184 ] . V_91 == V_196 &&
...
ASSERT ( V_184 > 1 ) ;
V_190 = V_176 [ V_184 - 1 ] . V_93 + V_176 [ V_184 - 1 ] . V_94 ;
V_18 = F_47 ( V_24 , V_190 ) ;
if ( V_18 >= V_73 ) {
error = - V_192 ;
goto V_129;
}
...
case V_199 :
case V_200 :
return F_117 ( V_17 , V_12 , V_197 ) ;
case V_201 :
return F_112 ( V_17 , V_12 ) ;
case V_202 :
return F_115 ( V_17 , V_12 ) ;
default:
return - V_61 ;
}
}
