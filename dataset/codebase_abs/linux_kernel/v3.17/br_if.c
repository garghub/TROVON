...
struct V_1 * V_2 ;
int V_53 ;
V_2 = F_64 ( sizeof( struct V_12 ) , V_9 , V_54 ,
V_55 ) ;
if ( ! V_2 )
return - V_45 ;
F_65 ( V_2 , V_52 ) ;
...
if ( V_20 )
goto V_84;
V_20 = F_83 ( & V_11 -> V_29 , & V_85 , & ( V_2 -> V_2 . V_29 ) ,
V_86 ) ;
if ( V_20 )
goto V_87;
V_20 = F_84 ( V_11 ) ;
...
if ( V_20 )
goto V_90;
V_20 = F_87 ( V_2 , V_91 , V_11 ) ;
if ( V_20 )
goto V_92;
V_2 -> V_22 |= V_36 ;
F_88 ( V_2 ) ;
F_89 ( & V_11 -> V_35 , & V_13 -> V_65 ) ;
F_21 ( V_13 ) ;
F_90 ( V_13 -> V_2 ) ;
if ( V_13 -> V_2 -> V_93 < V_2 -> V_93 )
V_13 -> V_2 -> V_93 = V_2 -> V_93 ;
if ( F_91 ( V_13 , V_11 , V_2 -> V_75 , 0 ) )
F_92 ( V_2 , L_3 ) ;
F_7 ( & V_13 -> V_17 ) ;
V_70 = F_93 ( V_13 ) ;
if ( F_5 ( V_2 ) && F_6 ( V_2 ) &&
...
void F_97 ( struct V_10 * V_11 , unsigned long V_68 )
{
struct V_12 * V_13 = V_11 -> V_13 ;
if ( V_68 & V_97 )
F_21 ( V_13 ) ;
