...
V_141 . V_133 = V_132 ;
V_141 . V_177 = V_19 -> V_107 . V_136 . V_178 ;
F_54 ( & V_134 -> V_116 ) ;
if ( V_138 & V_145 )
...
if ( V_134 -> V_180 ) {
F_58 ( & V_134 -> V_116 ) ;
V_39 = V_19 -> V_181 = V_134 -> V_115 ;
}
if ( V_39 == 0 ) {
if ( V_13 -> V_100 ) {
struct V_91 * V_182 = F_32 ( V_66 -> V_93 . V_94 ) ;
F_8 ( F_51 ( V_19 ) ) ;
V_182 -> V_183 . V_184 ++ ;
}
}
...
F_63 ( V_188 , 1 ) ;
F_27 ( V_66 ) ;
V_73 -> V_147 = V_73 -> V_155 = F_61 ( V_187 ) ;
...
V_132 -> V_169 = V_105 -> V_191 ;
V_132 -> V_170 = V_105 -> V_192 ;
V_132 -> V_163 |= V_172 | V_173 ;
F_65 ( V_132 , V_105 -> V_193 ) ;
memset ( V_141 , 0 , sizeof( * V_141 ) ) ;
V_141 -> V_133 = V_132 ;
V_141 -> V_177 = V_105 -> V_194 ;
F_54 ( & V_134 -> V_116 ) ;
...
{
struct V_31 * V_19 = V_3 -> V_106 ;
struct V_189 * V_105 = & V_19 -> V_107 . V_195 ;
struct V_65 * V_66 = V_3 -> V_45 ;
struct V_28 * V_29 = F_14 ( V_66 ) ;
T_1 V_119 = F_48 ( V_66 , V_105 -> V_191 ) ;
T_1 V_196 = F_48 ( V_66 , V_105 -> V_192 ) ;
int V_39 = 0 ;
if ( V_105 -> V_192 == V_171 )
V_196 = V_130 ;
V_39 = F_68 ( V_11 , V_29 , V_119 , V_196 , 0 ,
V_105 -> V_197 == V_198 ) ;
if ( V_39 > 0 ) {
V_105 -> V_199 += V_39 ;
V_39 = 0 ;
}
if ( V_105 -> V_197 == V_200 ) {
int V_113 ;
V_113 = F_69 ( V_11 , V_29 , V_119 , V_196 ) ;
if ( V_39 == 0 )
V_39 = V_113 ;
...
const struct V_12 * V_3 )
{
struct V_189 * V_105 = & V_3 -> V_106 -> V_107 . V_195 ;
struct V_65 * V_66 = V_3 -> V_45 ;
T_1 V_119 = F_48 ( V_66 , V_105 -> V_191 ) ;
T_1 V_196 = F_48 ( V_66 , V_105 -> V_192 ) ;
int V_39 = 0 ;
if ( V_105 -> V_197 == V_201 ) {
V_39 = F_69 ( V_11 , F_14 ( V_66 ) , V_119 , V_196 ) ;
} else if ( V_105 -> V_197 == V_200 ) {
struct V_9 * V_13 = F_4 ( V_11 , V_3 ) ;
struct V_114 * V_134 = & V_13 -> V_135 ;
F_58 ( & V_134 -> V_116 ) ;
if ( V_39 == 0 )
...
cll_linkage)
F_84 ( V_121 , V_11 , V_224 ,
L_10 ) ;
F_44 ( V_121 , V_11 , V_210 ,
L_11 ) ;
F_85 () ;
F_86 () ;
}
...
int F_93 ( const struct V_10 * V_11 , struct V_230 * V_92 ,
struct V_208 * V_231 )
{
struct V_1 * V_204 ;
int V_39 ;
...
if ( V_204 != NULL ) {
F_95 ( V_231 , & V_204 -> V_8 , V_92 , & V_233 ) ;
V_39 = 0 ;
} else
V_39 = - V_234 ;
return V_39 ;
