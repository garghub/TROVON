...
F_31 ( V_2 -> V_5 , V_179 , V_127 ) ;
V_2 -> V_95 = V_180 ;
F_52 ( & V_2 -> V_181 , V_2 -> V_86 ) ;
}
...
V_8 -> V_184 -> error = F_32 ( V_2 ) ;
return;
}
V_2 -> V_95 = V_185 ;
}
static void F_54 ( struct V_186 * V_187 , struct V_7 * V_8 )
{
struct V_1 * V_2 = F_55 ( V_187 ) ;
unsigned long V_119 ;
F_56 ( & V_2 -> V_188 , V_119 ) ;
if ( V_2 -> V_94 != V_189 ) {
F_6 ( & V_2 -> V_9 -> V_10 , L_24 , V_35 , V_2 -> V_94 ) ;
F_57 ( & V_2 -> V_188 , V_119 ) ;
...
V_2 -> V_187 -> V_197 = V_2 -> V_64 / 2 ;
V_2 -> V_187 -> V_198 = V_2 -> V_64 / 512 ;
}
return V_23 ;
}
...
if ( ! F_63 ( V_187 -> V_201 . V_202 ) )
F_64 ( V_187 , V_187 -> V_201 . V_202 ,
V_200 -> V_203 ? V_200 -> V_204 : 0 ) ;
}
static void F_65 ( struct V_186 * V_187 , struct V_199 * V_200 )
{
struct V_1 * V_2 = F_55 ( V_187 ) ;
unsigned long V_119 ;
F_56 ( & V_2 -> V_188 , V_119 ) ;
...
V_39 ) ;
if ( V_2 -> V_87 ) {
F_34 ( V_2 -> V_187 -> V_215 ,
L_26 ) ;
V_11 -> error = F_32 ( V_2 ) ;
} else if ( ! time ) {
F_34 ( V_2 -> V_187 -> V_215 , L_27 ) ;
V_11 -> error = - V_97 ;
} else if ( time < 0 ) {
F_34 ( V_2 -> V_187 -> V_215 ,
L_28 , time ) ;
...
if ( V_2 -> V_87 ) {
V_8 -> V_184 -> error = F_32 ( V_2 ) ;
F_6 ( & V_2 -> V_9 -> V_10 , L_19 , V_35 , V_8 -> V_184 -> error ) ;
break;
}
F_47 ( V_2 , V_8 -> V_184 ) ;
V_8 -> V_184 -> error = 0 ;
...
if ( V_8 -> V_184 && ! V_8 -> V_118 -> error && ( ! V_11 || ! V_11 -> error ) ) {
F_53 ( V_2 , V_8 ) ;
if ( ! V_8 -> V_184 -> error ) {
F_52 ( & V_2 -> V_181 , V_2 -> V_86 ) ;
F_79 ( & V_2 -> V_220 ) ;
...
F_4 ( V_2 , V_106 , V_94 & V_223 ) ;
if ( V_94 & ~ V_223 )
F_6 ( & V_2 -> V_9 -> V_10 , L_30 ,
V_94 ) ;
if ( V_94 & V_224 || V_94 & ~ V_225 ) {
V_2 -> V_87 = true ;
...
{
struct V_231 * V_232 = F_83 ( V_230 , struct V_231 , V_230 ) ;
struct V_1 * V_2 = F_83 ( V_232 , struct V_1 , V_181 ) ;
struct V_7 * V_8 = V_2 -> V_8 ;
unsigned long V_119 ;
if ( V_2 -> V_233 )
return;
...
return;
if ( ! V_187 -> V_235 )
V_187 -> V_235 = V_9 -> V_236 ;
else if ( V_9 -> V_236 )
F_16 ( F_86 ( V_187 ) , L_35 ) ;
}
static int F_87 ( struct V_237 * V_238 )
{
int V_23 = 0 , V_217 [ 2 ] ;
struct V_186 * V_187 ;
struct V_1 * V_2 ;
struct V_41 * V_9 = V_238 -> V_10 . V_66 ;
struct V_48 * V_49 ;
void T_5 * V_3 ;
const char * V_239 ;
V_217 [ 0 ] = F_88 ( V_238 , 0 ) ;
V_217 [ 1 ] = F_88 ( V_238 , 1 ) ;
if ( V_217 [ 0 ] < 0 ) {
F_34 ( & V_238 -> V_10 , L_36 ) ;
return - V_240 ;
}
V_49 = F_22 ( V_238 , V_55 , 0 ) ;
V_3 = F_89 ( & V_238 -> V_10 , V_49 ) ;
if ( F_63 ( V_3 ) )
return F_90 ( V_3 ) ;
V_187 = F_91 ( sizeof( struct V_1 ) , & V_238 -> V_10 ) ;
if ( ! V_187 )
return - V_241 ;
V_23 = F_92 ( V_187 ) ;
if ( V_23 < 0 )
...
V_2 -> V_5 = V_3 ;
V_2 -> V_86 = F_93 ( 1000 ) ;
V_2 -> V_76 = ! V_9 || ! V_9 -> V_243 ;
V_2 -> V_78 = V_9 && V_9 -> V_244 ;
V_2 -> V_9 = V_238 ;
F_94 ( & V_2 -> V_188 ) ;
V_187 -> V_245 = & V_246 ;
F_84 ( V_2 ) ;
V_187 -> V_247 |= V_248 | V_249 ;
if ( V_9 && V_9 -> V_247 )
V_187 -> V_247 |= V_9 -> V_247 ;
V_187 -> V_250 = 32 ;
V_187 -> V_251 = 512 ;
V_187 -> V_252 = V_253 * V_187 -> V_250 ;
V_187 -> V_254 = V_187 -> V_252 / V_187 -> V_251 ;
V_187 -> V_255 = V_187 -> V_252 ;
F_95 ( V_238 , V_2 ) ;
F_96 ( & V_238 -> V_10 ) ;
V_2 -> V_209 = false ;
V_2 -> V_196 = F_97 ( & V_238 -> V_10 , NULL ) ;
if ( F_63 ( V_2 -> V_196 ) ) {
V_23 = F_90 ( V_2 -> V_196 ) ;
F_34 ( & V_238 -> V_10 , L_37 , V_23 ) ;
goto V_256;
}
V_23 = F_59 ( V_2 ) ;
if ( V_23 < 0 )
goto V_256;
V_23 = F_98 ( & V_238 -> V_10 ) ;
if ( V_23 < 0 )
goto V_257;
F_99 ( & V_2 -> V_181 , F_82 ) ;
F_29 ( V_2 ) ;
F_31 ( V_2 -> V_5 , V_106 , V_258 ) ;
V_239 = V_217 [ 1 ] < 0 ? F_8 ( & V_238 -> V_10 ) : L_38 ;
V_23 = F_100 ( & V_238 -> V_10 , V_217 [ 0 ] , F_81 ,
F_76 , 0 , V_239 , V_2 ) ;
if ( V_23 ) {
F_34 ( & V_238 -> V_10 , L_39 , V_239 ) ;
goto V_257;
}
if ( V_217 [ 1 ] >= 0 ) {
V_23 = F_100 ( & V_238 -> V_10 , V_217 [ 1 ] ,
F_81 , F_76 ,
0 , L_40 , V_2 ) ;
if ( V_23 ) {
F_34 ( & V_238 -> V_10 , L_41 ) ;
goto V_257;
}
}
if ( V_9 && V_9 -> V_259 ) {
V_23 = F_101 ( V_187 , V_9 -> V_260 , 0 ) ;
if ( V_23 < 0 )
goto V_257;
}
F_102 ( & V_2 -> V_220 ) ;
...
if ( V_23 < 0 )
goto V_257;
F_104 ( & V_238 -> V_10 , 100 ) ;
F_105 ( & V_238 -> V_10 , L_42 ,
