...
return 0 ;
V_155:
F_30 ( F_11 ( V_15 -> V_153 ) , V_15 -> V_153 ) ;
V_154:
return V_18 ;
}
...
static int F_32 ( struct V_156 * V_157 ,
const struct V_158 * V_75 )
{
struct V_14 * V_15 ;
int V_18 , V_28 ;
V_15 = F_33 ( & V_157 -> V_2 , sizeof( struct V_14 ) ,
V_159 ) ;
if ( V_15 == NULL )
return - V_160 ;
V_15 -> V_19 = F_34 ( V_157 , & V_161 ) ;
if ( F_35 ( V_15 -> V_19 ) )
return F_36 ( V_15 -> V_19 ) ;
for ( V_28 = 0 ; V_28 < F_11 ( V_15 -> V_153 ) ; V_28 ++ )
V_15 -> V_153 [ V_28 ] . V_162 = V_163 [ V_28 ] ;
V_18 = F_37 ( & V_157 -> V_2 , F_11 ( V_15 -> V_153 ) ,
V_15 -> V_153 ) ;
if ( V_18 != 0 ) {
F_20 ( & V_157 -> V_2 , L_14 , V_18 ) ;
return V_18 ;
}
F_38 ( V_157 , V_15 ) ;
V_18 = F_39 ( & V_157 -> V_2 ,
& V_164 , V_165 , F_11 ( V_165 ) ) ;
return V_18 ;
}
static int F_40 ( struct V_156 * V_166 )
{
F_41 ( & V_166 -> V_2 ) ;
return 0 ;
}
