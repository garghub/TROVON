...
#endif
#if F_63 ( V_103 ) || F_63 ( V_104 )
if ( V_92 & V_38 )
V_93 = F_64 ( V_93 ) ;
else
V_93 = F_65 ( V_93 ) ;
#endif
#if F_63 ( V_105 ) || F_63 ( V_106 )
if ( ! ( V_92 & V_99 ) )
V_93 = F_65 ( V_93 ) ;
#endif
return V_93 ;
...
V_108 -> V_109 = V_110 ;
V_108 -> V_35 = ( void * ) ( ( ( V_111 * ) V_2 -> V_3 . V_30 . V_36 ) + V_40 ) ;
} else {
V_108 -> V_109 = V_112 ;
if ( V_3 -> V_14 & V_38 )
V_108 -> V_35 = F_26 ( V_2 -> V_3 . V_30 . V_39 + V_2 -> V_3 . V_30 . V_40 + V_40 ,
V_41 ) ;
else
V_108 -> V_35 = F_27 ( V_2 -> V_3 . V_30 . V_39 + V_2 -> V_3 . V_30 . V_40 + V_40 ,
V_41 ) ;
}
return ( ! V_108 -> V_35 ) ? - V_42 : 0 ;
}
...
V_108 -> V_109 = V_114 ;
V_108 -> V_45 = V_9 -> V_53 [ V_113 ] ;
V_108 -> V_35 = F_38 ( V_108 -> V_45 ) ;
} else {
V_51 = ( V_3 -> V_14 & V_99 ) ?
V_54 :
F_47 ( V_3 -> V_14 , V_54 ) ;
V_108 -> V_109 = V_115 ;
V_108 -> V_35 = F_37 ( V_9 -> V_53 + V_113 , V_67 ,
0 , V_51 ) ;
}
return ( ! V_108 -> V_35 ) ? - V_42 : 0 ;
}
int F_69 ( struct V_1 * V_2 ,
unsigned long V_113 , unsigned long V_67 ,
struct V_107 * V_108 )
{
struct V_18 * V_19 =
...
return F_67 ( V_2 , V_113 , V_67 , V_108 ) ;
} else {
V_40 = V_113 << V_47 ;
V_41 = V_67 << V_47 ;
return F_66 ( V_2 , V_40 , V_41 , V_108 ) ;
}
}
void F_70 ( struct V_107 * V_108 )
{
...
( void ) F_9 ( V_19 , false ) ;
F_21 ( V_108 -> V_2 -> V_27 , & V_108 -> V_2 -> V_3 ) ;
F_13 ( V_19 ) ;
V_108 -> V_35 = NULL ;
V_108 -> V_45 = NULL ;
}
