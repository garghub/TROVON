...
V_213 = F_133 ( V_195 ) ;
if ( V_213 ) {
int V_214 = F_134 ( V_195 ) ;
int V_215 = F_135 ( V_195 ) ;
int V_216 = F_136 ( V_195 ) ;
V_212 = true ;
if ( V_214 )
V_19 = V_214 - 1 ;
if ( V_215 )
...
L_57 ,
V_70 ,
V_214 ? V_208 [ V_19 ] : L_58 ,
V_215 ? ( V_211 ? L_59 : L_60 )
: L_58 ,
V_216 ? ( V_32 ? L_61 : L_62 ) : L_58 ) ;
}
F_17 ( V_2 -> V_45 . V_53 ,
L_63 ,
V_70 , V_195 , V_208 [ V_19 ] , V_209 [ V_15 ] ,
V_211 ? L_64 : L_60 ,
V_211 ? ( V_32 ? L_61 : L_62 ) : L_30 ,
V_28 ? L_65 : L_66 ) ;
F_23 ( V_2 -> V_79 ) ;
V_5 = V_70 % V_83 ;
if ( V_212 )
...
static int F_137 ( struct V_217 * V_53 )
{
struct V_57 * V_58 ;
V_58 = F_138 ( V_53 ) ;
if ( ! V_58 )
return - V_84 ;
return F_139 ( V_58 -> V_218 ) ;
}
static int F_140 ( struct V_217 * V_53 )
{
struct V_57 * V_58 ;
V_58 = F_138 ( V_53 ) ;
if ( ! V_58 )
return - V_84 ;
return F_141 ( V_58 -> V_218 ) ;
}
static int F_142 ( struct V_133 * V_219 )
{
...
if ( V_223 == V_227 )
F_146 ( & V_58 -> V_67 ) ;
V_222 = F_114 ( V_135 , L_67 , 0 ) ;
if ( V_222 )
V_58 -> V_65 = F_147 ( V_222 , 0 ) ;
if ( ! V_58 -> V_65 ) {
if ( V_223 == V_225 ) {
F_96 ( & V_219 -> V_53 ,
L_68
...
F_20 ( & V_219 -> V_53 , L_70 ) ;
return - V_84 ;
}
}
for ( V_60 = 0 ; V_60 < V_58 -> V_67 -> V_162 ; V_60 ++ ) {
if ( ! V_77 [ V_58 -> V_67 -> V_164 [ V_60 ] . V_142 ] ) {
F_21 ( & V_219 -> V_53 , L_71 , V_60 ) ;
return - V_228 ;
}
...
V_58 -> V_218 = F_148 ( & V_229 , & V_219 -> V_53 , V_58 ) ;
if ( ! V_58 -> V_218 ) {
F_20 ( & V_219 -> V_53 , L_72 ) ;
return - V_84 ;
}
for ( V_60 = 0 ; V_60 < V_58 -> V_67 -> V_162 ; V_60 ++ )
F_149 ( V_58 -> V_218 , & V_58 -> V_67 -> V_164 [ V_60 ] ) ;
F_92 ( V_219 , V_58 ) ;
F_96 ( & V_219 -> V_53 , L_73 ) ;
return 0 ;
}
