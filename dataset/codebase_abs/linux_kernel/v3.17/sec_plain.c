...
V_68 , 0 ) ;
if ( V_39 -> V_148 )
F_69 ( & V_39 -> V_148 -> V_149 ) ;
}
F_70 ( V_39 -> V_40 , V_68 ,
V_145 ) ;
F_70 ( V_39 -> V_137 , V_141 , V_142 ) ;
V_39 -> V_147 = V_145 ;
return 0 ;
}
static
...
V_39 -> V_155 = & V_156 ;
F_34 ( & V_39 -> V_155 -> V_157 ) ;
return V_158 ;
}
static
int F_76 ( struct V_38 * V_39 , int V_130 )
{
struct V_159 * V_160 ;
T_2 V_131 [ V_64 ] = { 0 , } ;
int V_161 = sizeof( * V_160 ) ;
F_27 ( V_130 % 8 == 0 ) ;
V_131 [ V_46 ] = sizeof( struct V_41 ) ;
V_131 [ V_68 ] = V_130 ;
if ( V_39 -> V_57 && ( V_39 -> V_79 || V_39 -> V_83 ) )
V_131 [ V_10 ] = V_12 ;
V_161 += F_18 ( V_64 , V_131 ) ;
V_160 = V_39 -> V_162 ;
if ( V_160 ) {
F_27 ( V_160 -> V_161 >= V_161 ) ;
} else {
F_60 ( V_160 , V_161 ) ;
if ( V_160 == NULL )
return - V_135 ;
...
V_160 -> V_163 = V_39 -> V_155 ;
F_34 ( & V_39 -> V_155 -> V_157 ) ;
V_160 -> V_164 = (struct V_5 * ) ( V_160 + 1 ) ;
V_160 -> V_165 = V_161 - sizeof( * V_160 ) ;
F_61 ( V_160 -> V_164 , V_64 , V_131 , NULL ) ;
V_160 -> V_166 = F_77 ( V_160 -> V_164 , V_68 , 0 ) ;
V_39 -> V_162 = V_160 ;
return 0 ;
}
static
void F_78 ( struct V_159 * V_160 )
{
F_27 ( F_41 ( & V_160 -> V_163 -> V_157 ) > 1 ) ;
F_54 ( & V_160 -> V_163 -> V_157 ) ;
if ( ! V_160 -> V_167 )
F_64 ( V_160 , V_160 -> V_161 ) ;
}
static
int F_79 ( struct V_38 * V_39 )
{
struct V_159 * V_160 = V_39 -> V_162 ;
struct V_168 * V_6 = V_160 -> V_164 ;
struct V_41 * V_42 ;
int V_169 ;
F_27 ( V_160 ) ;
F_27 ( V_6 ) ;
...
{
struct V_159 * V_160 = V_39 -> V_162 ;
struct V_8 * V_174 , * V_81 ;
struct V_19 * V_23 ;
int V_25 ;
F_27 ( V_39 -> V_83 ) ;
F_27 ( V_39 -> V_57 ) ;
V_174 = F_5 ( V_39 -> V_40 , V_10 , 0 ) ;
V_23 = (struct V_19 * ) V_174 -> V_74 ;
V_81 = F_5 ( V_160 -> V_164 , V_10 , 0 ) ;
V_81 -> V_75 = 0 ;
V_81 -> V_77 = V_78 ;
V_81 -> V_13 = V_174 -> V_13 ;
V_81 -> V_76 = 0 ;
if ( V_174 -> V_13 == V_14 )
return 0 ;
V_25 = F_10 ( V_17 , V_39 -> V_44 . V_53 . V_54 . V_18 ,
