...
( ( V_2 -> V_4 . V_29 & V_30 ) ?
V_31 : V_32 ) ) ;
F_9 ( V_2 , F_18 ( V_4 , 9600 ) ) ;
F_4 ( V_2 , V_33 , V_34 ) ;
F_4 ( V_2 , V_17 , 0 ) ;
}
static inline void
F_19 ( struct V_1 * V_2 , unsigned int * V_35 )
{
unsigned char V_36 ;
...
goto V_52;
F_23 ( & V_2 -> V_4 , V_37 , V_50 , V_36 , V_39 ) ;
V_52:
V_2 -> V_4 . V_45 = V_40 ;
V_37 = F_1 ( V_2 , V_59 ) ;
} while ( ! ( V_37 & V_60 ) && ( V_38 -- > 0 ) );
F_24 ( & V_2 -> V_4 . V_61 ) ;
F_25 ( & V_2 -> V_4 . V_62 -> V_4 ) ;
F_26 ( & V_2 -> V_4 . V_61 ) ;
* V_35 = V_37 ;
}
...
static unsigned int F_33 ( struct V_16 * V_4 )
{
struct V_1 * V_2 = F_10 ( V_4 ) ;
unsigned long V_29 ;
unsigned int V_82 ;
F_34 ( & V_2 -> V_4 . V_61 , V_29 ) ;
V_82 = ( F_1 ( V_2 , V_83 ) & V_84 ) ? V_85 : 0 ;
F_35 ( & V_2 -> V_4 . V_61 , V_29 ) ;
return V_82 ;
}
static unsigned int F_36 ( struct V_16 * V_4 )
{
struct V_1 * V_2 = F_10 ( V_4 ) ;
unsigned int V_82 ;
V_82 = V_86 | V_87 ;
...
static void F_37 ( struct V_16 * V_4 , unsigned int V_92 )
{
struct V_1 * V_2 = F_10 ( V_4 ) ;
if ( V_92 & V_89 )
F_7 ( V_2 , V_33 , V_88 ) ;
...
static void F_38 ( struct V_16 * V_4 , int V_93 )
{
struct V_1 * V_2 = F_10 ( V_4 ) ;
unsigned long V_29 ;
F_34 ( & V_2 -> V_4 . V_61 , V_29 ) ;
...
static int F_40 ( struct V_16 * V_4 )
{
unsigned int V_96 ;
unsigned char V_97 ;
struct V_1 * V_2 = F_10 ( V_4 ) ;
...
static void F_41 ( struct V_16 * V_4 , unsigned char V_97 )
{
unsigned int V_96 ;
struct V_1 * V_2 = F_10 ( V_4 ) ;
V_96 = F_1 ( V_2 , V_17 ) ;
...
F_4 ( V_2 , V_17 , 0 ) ;
F_4 ( V_2 , V_59 , 0 ) ;
V_98 = F_43 ( V_2 -> V_4 . V_74 , F_32 ,
V_102 , L_1 , V_2 ) ;
if ( V_98 )
return V_98 ;
F_34 ( & V_2 -> V_4 . V_61 , V_29 ) ;
F_37 ( & V_2 -> V_4 , V_2 -> V_4 . V_92 ) ;
F_35 ( & V_2 -> V_4 . V_61 , V_29 ) ;
F_7 ( V_2 , V_33 , V_103 | V_104 ) ;
F_8 ( V_2 , V_17 , V_105 ) ;
return 0 ;
}
static void F_44 ( struct V_16 * V_4 )
{
struct V_1 * V_2 = F_10 ( V_4 ) ;
unsigned long V_29 ;
F_4 ( V_2 , V_17 , 0 ) ;
...
static void
F_47 ( struct V_16 * V_4 , struct V_108 * V_109 ,
struct V_108 * V_110 )
{
struct V_1 * V_2 = F_10 ( V_4 ) ;
...
V_111 |= V_129 ;
V_113 = F_48 ( V_4 , V_109 , V_110 , 0 , V_4 -> V_132 / 16 / 2 ) ;
V_10 = F_18 ( V_4 , V_113 ) ;
V_112 = V_24 | V_25 ;
F_34 ( & V_2 -> V_4 . V_61 , V_29 ) ;
F_49 ( V_4 , V_109 -> V_114 , V_113 ) ;
V_2 -> V_4 . V_19 = V_50 |
V_77 | V_20 ;
if ( V_109 -> V_133 & V_134 )
V_2 -> V_4 . V_19 |= V_49 | V_48 ;
if ( V_109 -> V_133 & ( V_135 | V_136 | V_137 ) )
V_2 -> V_4 . V_19 |= V_47 ;
V_2 -> V_4 . V_45 = 0 ;
if ( V_109 -> V_133 & V_138 )
V_2 -> V_4 . V_45 |= V_48 | V_49 ;
if ( V_109 -> V_133 & V_135 ) {
V_2 -> V_4 . V_45 |= V_47 ;
if ( V_109 -> V_133 & V_138 )
V_2 -> V_4 . V_45 |= V_50 ;
}
...
static void
F_50 ( struct V_16 * V_4 , unsigned int V_62 ,
unsigned int V_144 )
{
if ( V_62 == 0 && V_144 != - 1 )
F_15 ( V_4 ) ;
...
if ( ! V_2 -> V_4 . V_147 )
break;
if ( ! F_52 ( V_2 -> V_4 . V_147 , V_145 , L_1 ) ) {
V_82 = - V_148 ;
break;
}
if ( V_2 -> V_4 . V_29 & V_149 ) {
V_2 -> V_4 . V_6 = F_53 ( V_2 -> V_4 . V_147 , V_145 ) ;
if ( ! V_2 -> V_4 . V_6 ) {
F_54 ( V_2 -> V_4 . V_147 , V_145 ) ;
V_82 = - V_150 ;
}
}
break;
case V_7 :
if ( ! F_55 ( V_2 -> V_4 . V_8 , V_145 , L_1 ) )
V_82 = - V_148 ;
break;
}
return V_82 ;
...
break;
case V_7 :
F_58 ( V_2 -> V_4 . V_8 , V_145 ) ;
break;
}
}
static void F_59 ( struct V_16 * V_4 )
{
struct V_1 * V_2 = F_10 ( V_4 ) ;
F_56 ( V_2 ) ;
}
static int F_60 ( struct V_16 * V_4 )
{
struct V_1 * V_2 = F_10 ( V_4 ) ;
return F_51 ( V_2 ) ;
}
static void F_61 ( struct V_16 * V_4 , int V_151 )
{
struct V_1 * V_2 = F_10 ( V_4 ) ;
int V_82 ;
V_82 = F_51 ( V_2 ) ;
...
static const char *
F_62 ( struct V_16 * V_4 )
{
return L_2 ;
}
static void T_2 F_63 ( struct V_154 * V_155 ,
struct V_156 * V_157 )
{
int V_158 ;
...
static void F_65 ( struct V_16 * V_4 , int V_36 )
{
struct V_1 * V_2 = F_10 ( V_4 ) ;
F_39 ( V_2 ) ;
F_4 ( V_2 , V_67 , V_36 ) ;
...
static void
F_66 ( struct V_163 * V_164 , const char * V_165 , unsigned int V_65 )
{
...
F_67 ( & V_2 -> V_4 , V_165 , V_65 , F_65 ) ;
F_39 ( V_2 ) ;
F_4 ( V_2 , V_33 , V_166 ) ;
F_4 ( V_2 , V_17 , V_96 ) ;
}
static int T_2 F_68 ( struct V_163 * V_164 , char * V_167 )
{
struct V_16 * V_4 ;
struct V_1 * V_2 ;
int V_113 = 9600 ;
...
F_15 ( & V_2 -> V_4 ) ;
if ( V_167 )
F_69 ( V_167 , & V_113 , & V_53 , & V_168 , & V_169 ) ;
return F_70 ( V_4 , V_164 , V_113 , V_53 , V_168 , V_169 ) ;
}
...
int T_2 F_73 ( struct V_16 * V_4 )
{
if ( V_4 -> line >= F_74 ( V_160 ) )
return - V_170 ;
...
static int F_75 ( struct V_16 * V_4 )
{
int V_158 ;
struct V_1 * V_174 ;
int V_82 = - V_175 ;
...
for ( V_158 = 0 ; V_158 < V_159 ; V_158 ++ ) {
V_174 = & V_160 [ V_158 ] ;
if ( F_77 ( & V_174 -> V_4 , V_4 ) ) {
F_78 ( & V_177 , & V_174 -> V_4 ) ;
break;
}
}
if ( V_158 == V_159 ) {
...
static int F_81 ( struct V_179 * V_157 )
{
struct V_16 * V_180 = F_82 ( & V_157 -> V_157 ) ;
struct V_16 V_4 ;
int V_82 , V_158 ;
...
static int F_84 ( struct V_179 * V_157 )
{
int V_158 ;
for ( V_158 = 0 ; V_158 < V_159 ; V_158 ++ ) {
struct V_1 * V_2 = & V_160 [ V_158 ] ;
...
static int F_85 ( struct V_179 * V_157 , T_3 V_62 )
{
int V_158 ;
for ( V_158 = 0 ; V_158 < V_159 ; V_158 ++ ) {
struct V_1 * V_2 = & V_160 [ V_158 ] ;
...
static int F_87 ( struct V_179 * V_157 )
{
int V_158 ;
for ( V_158 = 0 ; V_158 < V_159 ; V_158 ++ ) {
struct V_1 * V_2 = & V_160 [ V_158 ] ;
...
static int
F_89 ( struct V_181 * V_157 , const struct V_182 * V_183 )
{
struct V_16 V_4 ;
int line ;
int V_184 ;
...
V_4 . V_74 = V_157 -> V_74 ;
V_4 . V_5 = V_7 ;
V_4 . V_8 = F_91 ( V_157 , 1 ) ;
V_4 . V_157 = & V_157 -> V_157 ;
line = F_75 ( & V_4 ) ;
if ( line < 0 ) {
F_92 ( V_185 L_5 , F_93 ( V_157 ) , line ) ;
F_94 ( V_157 ) ;
return line ;
}
F_95 ( V_157 , & V_160 [ line ] ) ;
return 0 ;
}
static void F_96 ( struct V_181 * V_157 )
{
struct V_1 * V_2 = F_97 ( V_157 ) ;
if ( V_2 ) {
F_80 ( V_2 -> V_4 . line ) ;
F_94 ( V_157 ) ;
}
}
static int F_98 ( struct V_181 * V_157 , T_3 V_62 )
{
struct V_1 * V_2 = F_97 ( V_157 ) ;
if ( V_2 )
F_86 ( & V_177 , & V_2 -> V_4 ) ;
F_99 ( V_157 ) ;
F_100 ( V_157 , F_101 ( V_157 , V_62 ) ) ;
return 0 ;
}
static int F_102 ( struct V_181 * V_157 )
{
struct V_1 * V_2 = F_97 ( V_157 ) ;
F_100 ( V_157 , V_186 ) ;
F_103 ( V_157 ) ;
