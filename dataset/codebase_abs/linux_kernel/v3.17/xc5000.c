...
int V_27 , V_109 ;
struct V_7 * V_8 = V_25 -> V_26 ;
T_3 V_110 = V_25 -> V_111 . V_112 ;
T_3 V_113 = V_25 -> V_111 . V_114 ;
T_3 V_115 = V_25 -> V_111 . V_116 ;
if ( F_32 ( V_25 , 0 ) != 0 ) {
F_7 ( 1 , L_28 ) ;
return - V_34 ;
}
F_7 ( 1 , L_29 , V_28 , V_113 ) ;
switch ( V_115 ) {
case V_117 :
F_7 ( 1 , L_30 , V_28 ) ;
V_8 -> V_55 = V_56 ;
...
if ( V_141 -> V_96 > V_57 )
V_8 -> V_55 = V_57 ;
V_8 -> V_59 = V_141 -> V_114 * 62500 ;
if ( V_141 -> V_143 & V_144 ) {
V_8 -> V_52 = V_145 ;
goto V_146;
}
if ( V_141 -> V_143 & V_147 ) {
V_8 -> V_52 = V_148 ;
goto V_146;
}
if ( V_141 -> V_143 & V_149 ) {
V_8 -> V_52 = V_150 ;
goto V_146;
}
if ( V_141 -> V_143 & V_151 ) {
V_8 -> V_52 = V_152 ;
goto V_146;
}
if ( V_141 -> V_143 & V_153 ) {
V_8 -> V_52 = V_154 ;
goto V_146;
}
if ( V_141 -> V_143 & V_155 ) {
V_8 -> V_52 = V_156 ;
goto V_146;
}
if ( V_141 -> V_143 & V_157 ) {
V_8 -> V_52 = V_158 ;
goto V_146;
}
V_146:
...
if ( V_8 -> V_159 == V_161 )
V_159 = V_162 ;
else if ( V_8 -> V_159 == V_163 )
V_159 = V_164 ;
else if ( V_8 -> V_159 == V_165 )
V_159 = V_166 ;
else {
F_7 ( 1 , L_48 , V_28 ,
V_8 -> V_159 ) ;
...
V_8 -> V_59 = V_141 -> V_114 * 125 / 2 ;
V_8 -> V_55 = V_56 ;
V_27 = F_12 ( V_8 , V_50 [ V_159 ] . V_47 ,
V_50 [ V_159 ] . V_48 , V_159 ) ;
if ( V_27 != 0 ) {
F_4 ( V_17 L_38 ) ;
return - V_18 ;
}
...
switch ( V_141 -> V_96 ) {
case V_167 :
V_27 = F_35 ( V_25 , V_141 ) ;
break;
case V_168 :
case V_169 :
V_27 = F_34 ( V_25 , V_141 ) ;
break;
}
return V_27 ;
}
static int F_37 ( struct V_24 * V_25 , T_3 * V_113 )
{
struct V_7 * V_8 = V_25 -> V_26 ;
F_7 ( 1 , L_3 , V_28 ) ;
* V_113 = V_8 -> V_59 + V_8 -> V_118 ;
return 0 ;
}
static int F_38 ( struct V_24 * V_25 , T_3 * V_113 )
{
struct V_7 * V_8 = V_25 -> V_26 ;
F_7 ( 1 , L_3 , V_28 ) ;
* V_113 = V_8 -> V_130 * 1000 ;
return 0 ;
}
static int F_39 ( struct V_24 * V_25 , T_3 * V_110 )
{
struct V_7 * V_8 = V_25 -> V_26 ;
F_7 ( 1 , L_3 , V_28 ) ;
* V_110 = V_8 -> V_135 ;
...
static int F_40 ( struct V_24 * V_25 , T_3 * V_170 )
{
struct V_7 * V_8 = V_25 -> V_26 ;
T_2 V_74 = 0 ;
F_18 ( V_8 , & V_74 ) ;
...
static int F_32 ( struct V_24 * V_25 , int V_171 )
{
struct V_7 * V_8 = V_25 -> V_26 ;
...
T_2 V_172 ;
F_41 ( & V_8 -> V_173 ) ;
if ( ! V_171 && F_33 ( V_25 ) == 0 )
return 0 ;
V_27 = F_42 ( & V_102 , V_100 -> V_51 ,
...
static void F_44 ( struct V_182 * V_173 )
{
struct V_7 * V_8 = F_45 ( V_173 , struct V_7 ,
V_173 . V_183 ) ;
...
F_7 ( 1 , L_3 , V_28 ) ;
if ( V_189 -> V_130 )
V_8 -> V_130 = V_189 -> V_130 ;
if ( V_189 -> V_159 )
V_8 -> V_159 = V_189 -> V_159 ;
return 0 ;
}
...
if ( V_8 -> V_130 == 0 ) {
V_8 -> V_130 = V_192 -> V_130 ;
}
if ( V_8 -> V_99 == 0 )
V_8 -> V_99 = V_192 -> V_99 ;
if ( V_8 -> V_159 == 0 )
V_8 -> V_159 = V_192 -> V_159 ;
if ( ( V_8 -> V_2 == 0 ) || ( V_192 -> V_2 ) )
V_8 -> V_2 = ( V_192 -> V_2 ) ? V_192 -> V_2 : 0 ;
if ( F_5 ( V_8 , V_137 , & V_136 ) != 0 )
goto V_196;
switch ( V_136 ) {
case V_197 :
F_4 ( V_181
