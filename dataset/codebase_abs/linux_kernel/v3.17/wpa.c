...
if ( ! memcmp ( V_17 -> V_43 [ V_18 ] . V_28 , V_29 , 4 ) )
V_1 -> V_7 [ V_19 ++ ] = V_8 ;
else if ( ! memcmp ( V_17 -> V_43 [ V_18 ] . V_28 , V_33 , 4 ) )
V_1 -> V_7 [ V_19 ++ ] = V_44 ;
else
;
} else
...
V_22 = ( unsigned char * ) V_17 -> V_43 [ V_21 ] . V_28 ;
V_1 -> V_10 = ( * V_22 ) & V_45 ;
V_1 -> V_11 = 2 << ( ( * V_22 >> V_46 ) & V_47 ) ;
V_1 -> V_12 . V_13 = true ;
...
if ( V_1 -> V_5 [ V_2 ] == V_37 )
V_50 = V_37 ;
else if ( ( V_1 -> V_5 [ V_2 ] == V_4 ) && ( V_50 != V_37 ) )
V_50 = V_4 ;
else if ( ( V_1 -> V_5 [ V_2 ] == V_32 ) && ( V_50 != V_37 ) && ( V_50 != V_4 ) )
V_50 = V_32 ;
else if ( ( V_1 -> V_5 [ V_2 ] == V_39 ) && ( V_50 != V_37 ) && ( V_50 != V_4 ) )
V_50 = V_39 ;
}
if ( V_49 != V_50 )
return false ;
