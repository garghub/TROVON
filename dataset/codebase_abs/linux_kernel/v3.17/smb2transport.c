...
static int
F_35 ( struct V_18 * V_21 , struct V_19 * V_93 ,
struct V_76 * * V_81 )
{
...
return - V_11 ;
F_12 ( & V_101 ) ;
F_36 ( & ( * V_81 ) -> V_102 , & V_21 -> V_2 -> V_103 ) ;
F_14 ( & V_101 ) ;
return 0 ;
}
int
F_37 ( struct V_76 * V_81 , struct V_1 * V_2 ,
bool V_104 )
{
unsigned int V_105 = F_38 ( V_81 -> V_106 ) ;
struct V_31 V_32 ;
struct V_25 V_26 = { . V_33 = & V_32 ,
. V_35 = 1 } ;
V_32 . V_37 = ( char * ) V_81 -> V_106 ;
V_32 . V_43 = F_38 ( V_81 -> V_106 ) + 4 ;
F_39 ( V_81 -> V_106 , F_40 ( V_107 , 80 , V_105 ) ) ;
...
return F_41 ( V_81 -> V_106 , V_104 ) ;
}
struct V_76 *
F_42 ( struct V_18 * V_21 , struct V_25 * V_26 )
{
int V_3 ;
struct V_19 * V_72 = (struct V_19 * ) V_26 -> V_33 [ 0 ] . V_37 ;
struct V_76 * V_81 ;
F_28 ( V_21 -> V_2 , V_72 ) ;
V_3 = F_35 ( V_21 , V_72 , & V_81 ) ;
if ( V_3 )
return F_43 ( V_3 ) ;
...
struct V_76 *
F_45 ( struct V_1 * V_2 , struct V_25 * V_26 )
{
int V_3 ;
struct V_19 * V_72 = (struct V_19 * ) V_26 -> V_33 [ 0 ] . V_37 ;
struct V_76 * V_81 ;
