...
F_47 ( V_52 , ( V_35 >> V_60 ) ) ) ;
V_10 = F_48 ( V_61 , V_51 , V_11 -> V_2 -> V_9 ) ;
V_10 -> V_45 . V_62 = V_50 -> V_63 + ( V_50 -> V_22 - V_52 ) ;
V_10 -> V_64 = V_50 -> V_55 ;
V_10 -> V_65 = F_23 ;
F_11 ( V_10 , V_11 , V_12 ) ;
if ( V_48 & V_58 ) {
V_57 = F_45 ( T_2 , V_54 -> V_66 . V_67 , V_52 ) ;
V_10 -> V_45 . V_68 = V_57 << V_60 ;
V_52 -= V_57 ;
} else if ( V_48 & V_59 ) {
V_25 -> V_37 ( V_25 , & V_26 , & V_28 , & V_29 ) ;
F_49 ( V_10 , V_26 , V_56 , V_29 ) ;
V_57 = F_45 ( T_2 , V_54 -> V_66 . V_69 , V_52 ) ;
V_10 -> V_45 . V_68 = V_57 << V_60 ;
V_29 = 0 ;
V_52 -= V_57 ;
V_25 -> V_38 ( V_25 ) ;
...
static void F_55 ( int V_48 , unsigned int V_70 ,
struct V_49 * V_50 , struct V_24 * V_25 ,
struct V_11 * V_11 , int V_71 )
{
int V_72 ;
struct V_24 V_73 = * V_25 ;
F_56 ( V_70 > V_13 ) ;
if ( V_71 )
V_48 |= V_74 ;
for ( V_72 = 0 ; V_72 < V_70 ; V_72 ++ ) {
* V_25 = V_73 ;
if ( V_50 [ V_72 ] . V_22 || ( V_48 & V_75 ) )
F_42 ( V_48 , V_72 , V_50 + V_72 , V_25 , V_11 ) ;
}
F_20 ( V_11 , 0 , 0 ) ;
}
static void F_57 ( unsigned long error , void * V_19 )
{
struct V_76 * V_77 = V_19 ;
V_77 -> V_16 = error ;
F_58 ( & V_77 -> V_78 ) ;
}
static int V_76 ( struct V_1 * V_2 , unsigned int V_70 ,
struct V_49 * V_50 , int V_48 , struct V_24 * V_25 ,
unsigned long * V_16 )
{
struct V_11 * V_11 ;
struct V_76 V_77 ;
if ( V_70 > 1 && ( V_48 & V_79 ) != V_80 ) {
F_59 ( 1 ) ;
return - V_81 ;
}
F_60 ( & V_77 . V_78 ) ;
V_11 = F_61 ( V_2 -> V_6 , V_61 ) ;
V_11 -> V_16 = 0 ;
F_62 ( & V_11 -> V_22 , 1 ) ;
V_11 -> V_2 = V_2 ;
V_11 -> V_18 = F_57 ;
...
V_11 -> V_21 = V_25 -> V_21 ;
V_11 -> V_20 = V_25 -> V_20 ;
F_55 ( V_48 , V_70 , V_50 , V_25 , V_11 , 1 ) ;
F_63 ( & V_77 . V_78 ) ;
if ( V_16 )
* V_16 = V_77 . V_16 ;
return V_77 . V_16 ? - V_81 : 0 ;
}
static int F_64 ( struct V_1 * V_2 , unsigned int V_70 ,
struct V_49 * V_50 , int V_48 , struct V_24 * V_25 ,
T_1 V_17 , void * V_19 )
{
struct V_11 * V_11 ;
...
V_11 -> V_21 = V_25 -> V_21 ;
V_11 -> V_20 = V_25 -> V_20 ;
F_55 ( V_48 , V_70 , V_50 , V_25 , V_11 , 0 ) ;
return 0 ;
}
static int F_65 ( struct V_82 * V_83 , struct V_24 * V_25 ,
unsigned long V_84 )
{
V_25 -> V_21 = NULL ;
V_25 -> V_20 = 0 ;
...
case V_86 :
F_29 ( V_25 , V_83 -> V_85 . V_87 . V_33 , V_83 -> V_85 . V_29 ) ;
break;
case V_88 :
F_32 ( V_25 , V_83 -> V_85 . V_87 . V_10 ) ;
break;
case V_89 :
F_66 ( V_83 -> V_85 . V_87 . V_90 , V_84 ) ;
if ( ( V_83 -> V_91 & V_79 ) == V_23 ) {
V_25 -> V_21 = V_83 -> V_85 . V_87 . V_90 ;
V_25 -> V_20 = V_84 ;
}
F_37 ( V_25 , V_83 -> V_85 . V_87 . V_90 ) ;
break;
case V_92 :
F_41 ( V_25 , V_83 -> V_85 . V_87 . V_93 ) ;
break;
default:
return - V_94 ;
}
...
int F_67 ( struct V_82 * V_83 , unsigned V_70 ,
struct V_49 * V_50 , unsigned long * V_95 )
{
int V_96 ;
struct V_24 V_25 ;
V_96 = F_65 ( V_83 , & V_25 , ( unsigned long ) V_50 -> V_22 << V_60 ) ;
if ( V_96 )
return V_96 ;
if ( ! V_83 -> V_97 . V_17 )
return V_76 ( V_83 -> V_2 , V_70 , V_50 ,
V_83 -> V_91 , & V_25 , V_95 ) ;
return F_64 ( V_83 -> V_2 , V_70 , V_50 , V_83 -> V_91 ,
& V_25 , V_83 -> V_97 . V_17 , V_83 -> V_97 . V_19 ) ;
}
int T_3 F_68 ( void )
{
V_7 = F_69 ( V_11 , 0 ) ;
