...
int F_128 ( struct V_7 * V_4 , struct V_233 * V_13 )
{
struct V_9 * V_10 ;
...
void F_130 ( struct V_7 * V_4 , struct V_233 * V_13 )
{
...
if ( ! V_235 )
return - V_61 ;
V_235 -> V_236 [ 0 ] . V_237 = V_2 -> V_179 . V_180 ;
V_235 -> V_236 [ 0 ] . V_35 = V_2 -> V_179 . V_238 ;
V_12 =
V_135 -> V_239 [ V_240 ] . V_191 & V_241 ;
V_43 = F_133 ( V_235 , L_36 , V_12 ) ;
F_52 ( V_235 ) ;
return V_43 ;
}
static int F_131 ( struct V_1 * V_2 )
...
{
const struct V_245 * V_246 = & V_2 -> V_246 ;
...
{
struct V_1 * V_2 ;
struct V_245 * V_246 , * V_260 ;
int V_43 = 0 , V_261 , V_262 ;
T_13 V_263 ;
V_246 = (struct V_245 * ) V_191 ;
if ( V_246 -> V_20 >= 6 && ! F_7 ( V_4 , V_11 ) ) {
F_108 ( L_41 ) ;
F_108 ( L_42 ) ;
return - V_67 ;
}
if ( ! F_7 ( V_4 , V_11 ) && ! V_4 -> V_264 )
return - V_51 ;
...
V_4 -> V_8 = V_2 ;
V_2 -> V_4 = V_4 ;
V_260 = (struct V_245 * ) & V_2 -> V_246 ;
* V_260 = * V_246 ;
F_150 ( & V_2 -> V_265 ) ;
F_150 ( & V_2 -> V_266 . V_267 ) ;
F_150 ( & V_2 -> V_268 ) ;
F_150 ( & V_2 -> V_269 . V_267 ) ;
F_150 ( & V_2 -> V_163 . V_270 ) ;
F_150 ( & V_2 -> V_271 ) ;
F_151 ( & V_2 -> V_272 ) ;
F_151 ( & V_2 -> V_273 ) ;
F_152 ( V_4 ) ;
...
V_262 = 2 * 1024 * 1024 ;
V_2 -> V_276 = F_156 ( V_4 -> V_135 , V_261 , V_262 ) ;
if ( ! V_2 -> V_276 ) {
F_26 ( L_45 ) ;
V_43 = - V_274 ;
goto V_277;
...
V_263 = V_2 -> V_179 . V_238 ;
V_2 -> V_179 . V_280 =
F_165 ( V_2 -> V_179 . V_180 ,
V_263 ) ;
if ( V_2 -> V_179 . V_280 == NULL ) {
V_43 = - V_274 ;
goto V_279;
}
V_2 -> V_179 . V_281 = F_166 ( V_2 -> V_179 . V_180 ,
V_263 ) ;
V_2 -> V_282 = F_167 ( L_48 , 0 ) ;
if ( V_2 -> V_282 == NULL ) {
F_26 ( L_49 ) ;
V_43 = - V_61 ;
goto V_283;
}
V_2 -> V_284 = F_167 ( L_50 , 0 ) ;
if ( V_2 -> V_284 == NULL ) {
F_26 ( L_51 ) ;
V_43 = - V_61 ;
goto V_285;
...
F_185 ( V_4 ) ;
V_286:
F_125 ( F_186 ( & V_2 -> V_163 . V_290 ) ) ;
F_187 ( & V_2 -> V_163 . V_291 ) ;
if ( V_4 -> V_135 -> V_292 )
F_188 ( V_4 -> V_135 ) ;
F_189 ( V_4 ) ;
F_94 ( V_4 ) ;
...
F_191 ( V_2 -> V_282 ) ;
V_283:
F_192 ( V_2 -> V_179 . V_281 ) ;
F_193 ( V_2 -> V_179 . V_280 ) ;
V_279:
V_2 -> V_179 . V_237 . V_294 ( & V_2 -> V_179 . V_237 ) ;
V_278:
F_194 ( V_4 ) ;
F_195 ( V_4 -> V_135 , V_2 -> V_276 ) ;
V_277:
F_196 ( V_2 -> V_182 ) ;
V_275:
if ( V_2 -> V_295 )
...
F_206 ( V_4 ) ;
F_207 ( & V_2 -> V_228 ) ;
if ( V_2 -> V_296 . V_297 && V_2 -> V_296 . V_298 ) {
F_52 ( V_2 -> V_296 . V_297 ) ;
...
F_208 ( & V_2 -> V_266 . V_299 ) ;
F_207 ( & V_2 -> V_266 . V_300 ) ;
F_209 ( V_4 ) ;
if ( V_4 -> V_135 -> V_292 )
F_188 ( V_4 -> V_135 ) ;
F_210 ( V_4 ) ;
...
int F_213 ( struct V_7 * V_4 , struct V_64 * V_302 )
{
int V_43 ;
V_43 = F_214 ( V_4 , V_302 ) ;
if ( V_43 )
return V_43 ;
return 0 ;
}
...
void F_219 ( struct V_7 * V_4 , struct V_64 * V_302 )
{
F_20 ( & V_4 -> V_40 ) ;
F_220 ( V_4 , V_302 ) ;
F_221 ( V_4 , V_302 ) ;
...
void F_222 ( struct V_7 * V_4 , struct V_64 * V_302 )
{
struct V_303 * V_65 = V_302 -> V_14 ;
if ( V_65 && V_65 -> V_304 )
V_65 -> V_304 = NULL ;
F_52 ( V_65 ) ;
}
