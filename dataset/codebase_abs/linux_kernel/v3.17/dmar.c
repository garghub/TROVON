...
F_103 ( V_70 -> V_162 ) ;
if ( V_70 -> V_164 ) {
F_104 ( V_70 -> V_164 , V_70 ) ;
F_105 ( V_70 -> V_164 , NULL ) ;
F_106 ( V_70 -> V_164 ) ;
}
if ( V_70 -> V_165 ) {
F_107 ( ( unsigned long ) V_70 -> V_165 -> V_166 ) ;
F_10 ( V_70 -> V_165 -> V_167 ) ;
F_10 ( V_70 -> V_165 ) ;
}
if ( V_70 -> V_134 )
F_86 ( V_70 ) ;
...
static inline void F_108 ( struct V_168 * V_165 )
{
while ( V_165 -> V_167 [ V_165 -> V_169 ] == V_170 ||
V_165 -> V_167 [ V_165 -> V_169 ] == V_171 ) {
V_165 -> V_167 [ V_165 -> V_169 ] = V_172 ;
V_165 -> V_169 = ( V_165 -> V_169 + 1 ) % V_173 ;
V_165 -> V_174 ++ ;
}
}
static int F_109 ( struct V_133 * V_70 , int V_51 )
{
T_9 V_175 ;
int V_176 , V_177 ;
struct V_168 * V_165 = V_70 -> V_165 ;
int V_178 = ( V_51 + 1 ) % V_173 ;
if ( V_165 -> V_167 [ V_178 ] == V_171 )
return - V_179 ;
V_175 = F_98 ( V_70 -> V_134 + V_180 ) ;
if ( V_175 & V_181 ) {
V_176 = F_98 ( V_70 -> V_134 + V_182 ) ;
if ( ( V_176 >> V_183 ) == V_51 ) {
F_68 ( L_36
L_37 ,
( unsigned long long ) V_165 -> V_166 [ V_51 ] . V_184 ,
( unsigned long long ) V_165 -> V_166 [ V_51 ] . V_185 ) ;
memcpy ( & V_165 -> V_166 [ V_51 ] , & V_165 -> V_166 [ V_178 ] ,
sizeof( struct V_186 ) ) ;
F_110 ( V_70 , & V_165 -> V_166 [ V_51 ] ,
sizeof( struct V_186 ) ) ;
F_111 ( V_181 , V_70 -> V_134 + V_180 ) ;
return - V_50 ;
}
}
if ( V_175 & V_187 ) {
V_176 = F_98 ( V_70 -> V_134 + V_182 ) ;
V_176 = ( ( V_176 >> V_183 ) - 1 + V_173 ) % V_173 ;
V_176 |= 1 ;
V_177 = F_98 ( V_70 -> V_134 + V_188 ) ;
V_177 = ( ( V_177 >> V_183 ) - 1 + V_173 ) % V_173 ;
F_111 ( V_187 , V_70 -> V_134 + V_180 ) ;
do {
if ( V_165 -> V_167 [ V_176 ] == V_189 )
V_165 -> V_167 [ V_176 ] = V_171 ;
V_176 = ( V_176 - 2 + V_173 ) % V_173 ;
} while ( V_176 != V_177 );
if ( V_165 -> V_167 [ V_178 ] == V_171 )
return - V_179 ;
}
if ( V_175 & V_190 )
F_111 ( V_190 , V_70 -> V_134 + V_180 ) ;
return 0 ;
}
int F_112 ( struct V_186 * V_166 , struct V_133 * V_70 )
{
int V_191 ;
struct V_168 * V_165 = V_70 -> V_165 ;
struct V_186 * V_192 , V_193 ;
int V_178 , V_51 ;
unsigned long V_69 ;
if ( ! V_165 )
return 0 ;
...
V_194:
V_191 = 0 ;
F_113 ( & V_165 -> V_195 , V_69 ) ;
while ( V_165 -> V_174 < 3 ) {
F_114 ( & V_165 -> V_195 , V_69 ) ;
F_115 () ;
F_113 ( & V_165 -> V_195 , V_69 ) ;
}
V_51 = V_165 -> V_196 ;
V_178 = ( V_51 + 1 ) % V_173 ;
V_165 -> V_167 [ V_51 ] = V_165 -> V_167 [ V_178 ] = V_189 ;
V_192 [ V_51 ] = * V_166 ;
V_193 . V_184 = F_116 ( V_170 ) |
V_197 | V_198 ;
V_193 . V_185 = F_117 ( & V_165 -> V_167 [ V_178 ] ) ;
V_192 [ V_178 ] = V_193 ;
F_110 ( V_70 , & V_192 [ V_51 ] , sizeof( struct V_186 ) ) ;
F_110 ( V_70 , & V_192 [ V_178 ] , sizeof( struct V_186 ) ) ;
V_165 -> V_196 = ( V_165 -> V_196 + 2 ) % V_173 ;
V_165 -> V_174 -= 2 ;
F_111 ( V_165 -> V_196 << V_183 , V_70 -> V_134 + V_188 ) ;
while ( V_165 -> V_167 [ V_178 ] != V_170 ) {
V_191 = F_109 ( V_70 , V_51 ) ;
if ( V_191 )
break;
F_118 ( & V_165 -> V_195 ) ;
F_115 () ;
...
void F_121 ( struct V_133 * V_70 , T_3 V_200 , T_3 V_201 , T_5 V_202 ,
T_7 type )
{
struct V_186 V_166 ;
V_166 . V_184 = F_122 ( V_202 ) | F_123 ( V_201 ) | F_124 ( V_200 )
| F_125 ( type ) | V_203 ;
V_166 . V_185 = 0 ;
F_112 ( & V_166 , V_70 ) ;
}
void F_126 ( struct V_133 * V_70 , T_3 V_200 , T_7 V_118 ,
unsigned int V_204 , T_7 type )
{
T_5 V_205 = 0 , V_206 = 0 ;
struct V_186 V_166 ;
int V_207 = 0 ;
...
if ( F_128 ( V_70 -> V_120 ) )
V_206 = 1 ;
V_166 . V_184 = F_129 ( V_200 ) | F_130 ( V_206 ) | F_131 ( V_205 )
| F_132 ( type ) | V_208 ;
V_166 . V_185 = F_133 ( V_118 ) | F_134 ( V_207 )
| F_135 ( V_204 ) ;
F_112 ( & V_166 , V_70 ) ;
}
void F_136 ( struct V_133 * V_70 , T_3 V_201 , T_3 V_209 ,
T_7 V_118 , unsigned V_210 )
{
struct V_186 V_166 ;
if ( V_210 ) {
F_12 ( V_118 & ( ( 1 << ( V_211 + V_210 ) ) - 1 ) ) ;
V_118 |= ( 1 << ( V_211 + V_210 - 1 ) ) - 1 ;
V_166 . V_185 = F_137 ( V_118 ) | V_212 ;
} else
V_166 . V_185 = F_137 ( V_118 ) ;
if ( V_209 >= V_213 )
V_209 = 0 ;
V_166 . V_184 = F_138 ( V_201 ) | F_139 ( V_209 ) |
V_214 ;
F_112 ( & V_166 , V_70 ) ;
}
void F_140 ( struct V_133 * V_70 )
{
unsigned long V_69 ;
T_9 V_145 ;
T_10 V_215 = F_141 () ;
if ( ! F_142 ( V_70 -> V_121 ) )
return;
F_113 ( & V_70 -> V_160 , V_69 ) ;
V_145 = F_80 ( V_70 -> V_134 + V_152 ) ;
if ( ! ( V_145 & V_158 ) )
goto V_7;
while ( ( F_98 ( V_70 -> V_134 + V_188 ) !=
F_98 ( V_70 -> V_134 + V_182 ) ) &&
( V_216 > ( F_141 () - V_215 ) ) )
F_115 () ;
V_70 -> V_154 &= ~ V_159 ;
F_111 ( V_70 -> V_154 , V_70 -> V_134 + V_217 ) ;
F_143 ( V_70 , V_152 , F_98 ,
! ( V_145 & V_158 ) , V_145 ) ;
V_7:
F_114 ( & V_70 -> V_160 , V_69 ) ;
}
static void F_144 ( struct V_133 * V_70 )
{
T_9 V_145 ;
unsigned long V_69 ;
struct V_168 * V_165 = V_70 -> V_165 ;
V_165 -> V_196 = V_165 -> V_169 = 0 ;
V_165 -> V_174 = V_173 ;
F_113 ( & V_70 -> V_160 , V_69 ) ;
F_111 ( 0 , V_70 -> V_134 + V_188 ) ;
F_145 ( V_70 -> V_134 + V_218 , F_117 ( V_165 -> V_166 ) ) ;
V_70 -> V_154 |= V_159 ;
F_111 ( V_70 -> V_154 , V_70 -> V_134 + V_217 ) ;
F_143 ( V_70 , V_152 , F_98 , ( V_145 & V_158 ) , V_145 ) ;
F_114 ( & V_70 -> V_160 , V_69 ) ;
}
int F_146 ( struct V_133 * V_70 )
{
struct V_168 * V_165 ;
struct V_219 * V_220 ;
if ( ! F_142 ( V_70 -> V_121 ) )
...
if ( V_70 -> V_165 )
return 0 ;
V_70 -> V_165 = F_147 ( sizeof( * V_165 ) , V_222 ) ;
if ( ! V_70 -> V_165 )
return - V_39 ;
V_165 = V_70 -> V_165 ;
V_220 = F_148 ( V_70 -> V_82 , V_222 | V_223 , 0 ) ;
if ( ! V_220 ) {
F_10 ( V_165 ) ;
V_70 -> V_165 = NULL ;
return - V_39 ;
}
V_165 -> V_166 = F_149 ( V_220 ) ;
V_165 -> V_167 = F_13 ( V_173 * sizeof( int ) , V_222 ) ;
if ( ! V_165 -> V_167 ) {
F_107 ( ( unsigned long ) V_165 -> V_166 ) ;
F_10 ( V_165 ) ;
V_70 -> V_165 = NULL ;
return - V_39 ;
}
...
static const char * F_150 ( T_5 V_224 , int * V_225 )
{
if ( V_224 >= 0x20 && ( V_224 - 0x20 <
F_151 ( V_226 ) ) ) {
* V_225 = V_227 ;
return V_226 [ V_224 - 0x20 ] ;
} else if ( V_224 < F_151 ( V_228 ) ) {
* V_225 = V_229 ;
return V_228 [ V_224 ] ;
} else {
* V_225 = V_230 ;
...
void F_152 ( struct V_231 * V_60 )
{
struct V_133 * V_70 = F_153 ( V_60 ) ;
unsigned long V_232 ;
F_113 ( & V_70 -> V_160 , V_232 ) ;
F_111 ( 0 , V_70 -> V_134 + V_233 ) ;
F_98 ( V_70 -> V_134 + V_233 ) ;
F_114 ( & V_70 -> V_160 , V_232 ) ;
}
void F_154 ( struct V_231 * V_60 )
{
unsigned long V_232 ;
struct V_133 * V_70 = F_153 ( V_60 ) ;
F_113 ( & V_70 -> V_160 , V_232 ) ;
F_111 ( V_234 , V_70 -> V_134 + V_233 ) ;
F_98 ( V_70 -> V_134 + V_233 ) ;
F_114 ( & V_70 -> V_160 , V_232 ) ;
}
void F_155 ( int V_164 , struct V_235 * V_236 )
{
struct V_133 * V_70 = F_156 ( V_164 ) ;
unsigned long V_232 ;
F_113 ( & V_70 -> V_160 , V_232 ) ;
F_111 ( V_236 -> V_60 , V_70 -> V_134 + V_237 ) ;
F_111 ( V_236 -> V_238 , V_70 -> V_134 + V_239 ) ;
F_111 ( V_236 -> V_240 , V_70 -> V_134 + V_241 ) ;
F_114 ( & V_70 -> V_160 , V_232 ) ;
}
void F_157 ( int V_164 , struct V_235 * V_236 )
{
struct V_133 * V_70 = F_156 ( V_164 ) ;
unsigned long V_232 ;
F_113 ( & V_70 -> V_160 , V_232 ) ;
V_236 -> V_60 = F_98 ( V_70 -> V_134 + V_237 ) ;
V_236 -> V_238 = F_98 ( V_70 -> V_134 + V_239 ) ;
V_236 -> V_240 = F_98 ( V_70 -> V_134 + V_241 ) ;
F_114 ( & V_70 -> V_160 , V_232 ) ;
}
static int F_158 ( struct V_133 * V_70 , int type ,
T_5 V_224 , T_3 V_242 , unsigned long long V_118 )
{
const char * V_243 ;
int V_225 ;
V_243 = F_150 ( V_224 , & V_225 ) ;
if ( V_225 == V_227 )
F_68 ( L_39
L_40
L_41 ,
( V_242 >> 8 ) , F_16 ( V_242 & 0xFF ) ,
F_17 ( V_242 & 0xFF ) , V_118 >> 48 ,
V_224 , V_243 ) ;
else
F_68 ( L_42
L_43
...
( type ? L_45 : L_46 ) ,
( V_242 >> 8 ) , F_16 ( V_242 & 0xFF ) ,
F_17 ( V_242 & 0xFF ) , V_118 , V_224 , V_243 ) ;
return 0 ;
}
T_11 F_159 ( int V_164 , void * V_244 )
{
struct V_133 * V_70 = V_244 ;
int V_134 , V_245 ;
T_9 V_246 ;
unsigned long V_232 ;
F_113 ( & V_70 -> V_160 , V_232 ) ;
V_246 = F_98 ( V_70 -> V_134 + V_180 ) ;
if ( V_246 )
F_68 ( L_47 , V_246 ) ;
if ( ! ( V_246 & V_247 ) )
goto V_248;
V_245 = F_160 ( V_246 ) ;
V_134 = F_161 ( V_70 -> V_120 ) ;
while ( 1 ) {
T_5 V_224 ;
T_3 V_242 ;
T_7 V_249 ;
...
V_245 * V_250 + 8 ) ;
V_242 = F_164 ( V_60 ) ;
V_249 = F_80 ( V_70 -> V_134 + V_134 +
V_245 * V_250 ) ;
V_249 = F_165 ( V_249 ) ;
F_111 ( V_251 , V_70 -> V_134 + V_134 +
V_245 * V_250 + 12 ) ;
F_114 ( & V_70 -> V_160 , V_232 ) ;
F_158 ( V_70 , type , V_224 ,
V_242 , V_249 ) ;
V_245 ++ ;
if ( V_245 >= F_166 ( V_70 -> V_120 ) )
V_245 = 0 ;
F_113 ( & V_70 -> V_160 , V_232 ) ;
}
F_111 ( V_252 | V_247 , V_70 -> V_134 + V_180 ) ;
V_248:
F_114 ( & V_70 -> V_160 , V_232 ) ;
return V_253 ;
}
int F_167 ( struct V_133 * V_70 )
{
int V_164 , V_52 ;
if ( V_70 -> V_164 )
return 0 ;
...
V_52 = F_170 ( V_164 , F_159 , V_254 , V_70 -> V_140 , V_70 ) ;
if ( V_52 )
F_68 ( L_49 ) ;
return V_52 ;
}
...
F_159 ( V_70 -> V_164 , V_70 ) ;
V_246 = F_98 ( V_70 -> V_134 + V_180 ) ;
F_111 ( V_246 , V_70 -> V_134 + V_180 ) ;
}
return 0 ;
}
int F_173 ( struct V_133 * V_70 )
{
if ( ! F_142 ( V_70 -> V_121 ) )
return - V_221 ;
if ( ! V_70 -> V_165 )
...
{
struct V_1 * V_53 , * V_255 ;
if ( V_256 || V_161 )
return 0 ;
if ( V_38 != 1 && ! F_71 ( & V_5 ) )
F_176 ( & V_115 , & V_116 ) ;
F_34 ( & V_64 ) ;
F_177 (dmaru, dmaru_n, &dmar_drhd_units, list) {
F_178 ( & V_53 -> V_4 ) ;
F_38 ( V_53 ) ;
}
F_35 ( & V_64 ) ;
