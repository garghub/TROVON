...
F_86 ( struct V_8 * V_9 )
{
static signed int V_213 ;
unsigned long V_43 ;
signed int V_214 = 255 ;
* V_215 = 0x00ffffff ;
F_21 ( & V_47 , V_43 ) ;
F_3 ( 0xFF , 0x201 ) ;
* V_216 = V_217 | V_218 ;
while ( V_214 && ( F_2 ( 0x201 ) & 0x01 ) )
V_214 -- ;
* V_216 = 0 ;
F_22 ( & V_47 , V_43 ) ;
V_214 = 0x00ffffff - * V_219 ;
#ifndef F_87
V_214 = 150 - ( V_214 >> 5 ) ;
#else
V_214 = ( V_214 >> 6 ) - 25 ;
...
if ( V_214 > 100 )
V_214 = 100 ;
if ( abs ( V_214 - V_213 ) > 7 ) {
V_213 = V_214 ;
if ( V_26 & V_168 )
F_11 ( V_220 L_45 , V_214 ) ;
}
return V_213 ;
}
static unsigned int
...
unsigned char * V_126 , unsigned char * V_127 )
{
unsigned int V_221 = V_129 , V_222 = V_129 ;
if ( V_125 & V_130 ) {
V_125 = V_130 ;
V_221 = V_131 ;
V_222 = V_131 ;
...
F_77 ( V_9 , V_9 -> V_125 ) ;
V_228 = F_86 ( V_9 ) ;
if ( abs ( V_9 -> V_231 - V_228 ) > 20 )
V_9 -> V_232 = 1 ;
V_37 = V_104 [ V_106 ] & 0xFF ;
if ( V_228 != V_37 && V_9 -> V_232 ) {
V_9 -> V_231 = V_228 ;
F_52 ( V_9 , V_106 ,
V_228 | V_228 << 8 ) ;
return 1 ;
...
V_236 = V_9 -> V_211 ;
V_237 = V_9 -> V_212 ;
V_9 -> V_207 = ( V_153 & V_241 ) ? 1 : 0 ;
V_9 -> V_211 = ( V_153 & V_239 ) ? 1 : 0 ;
V_9 -> V_212 = ( V_153 & V_240 ) ? 1 : 0 ;
if ( V_236 != V_9 -> V_211 )
F_81 ( V_9 ) ;
if ( V_237 != V_9 -> V_212 )
F_85 ( V_9 ) ;
...
{
unsigned long V_43 ;
int V_244 [ 15 ] , V_25 , V_153 ;
if ( F_57 ( V_153 , V_32 ) )
return - V_157 ;
if ( F_95 ( V_244 , ( void * ) V_153 , sizeof( V_244 ) ) )
return - V_157 ;
switch ( V_244 [ 14 ] ) {
case V_245 :
F_59 ( V_9 ) ;
break;
case V_246 :
F_18 ( V_9 , V_117 , V_244 [ 0 ] , V_244 [ 4 ] ) ;
F_18 ( V_9 , V_117 , V_244 [ 1 ] , V_244 [ 5 ] ) ;
F_18 ( V_9 , V_117 , V_244 [ 2 ] , V_244 [ 6 ] ) ;
F_18 ( V_9 , V_117 , V_244 [ 3 ] , V_244 [ 7 ] ) ;
F_18 ( V_9 , V_117 , V_244 [ 8 ] , V_244 [ 9 ] ) ;
F_18 ( V_9 , V_119 , V_244 [ 10 ] , V_244 [ 11 ] ) ;
F_18 ( V_9 , V_119 , V_244 [ 12 ] , V_244 [ 13 ] ) ;
break;
case V_247 :
F_21 ( & V_47 , V_43 ) ;
for ( V_25 = 0x30 ; V_25 < 14 << 8 ; V_25 += 1 << 8 )
F_12 ( V_9 , 1 , & V_25 , 1 , V_244 + ( V_25 >> 8 ) ) ;
F_22 ( & V_47 , V_43 ) ;
if ( F_96 ( ( void * ) V_153 , V_244 , sizeof( V_244 ) ) )
return - V_157 ;
break;
default:
return - V_70 ;
...
V_9 -> V_232 = 0 ;
if ( ( V_21 & 0xff ) == V_251 ) {
unsigned int V_153 , V_252 , V_253 ;
if ( F_57 ( V_153 , V_32 ) )
return - V_157 ;
V_252 = V_153 & 0x7f ;
V_253 = ( V_153 & 0x7f00 ) >> 8 ;
V_153 = ( V_252 + V_253 ) / 2 ;
V_9 -> V_104 [ V_251 ] = V_153 | ( V_153 << 8 ) ;
V_9 -> V_211 = ( V_153 <= 50 ) ;
F_81 ( V_9 ) ;
return 0 ;
}
...
static int T_5 F_99 ( char * V_259 )
{
int V_260 [ 5 ] ;
V_259 = F_100 ( V_259 , F_101 ( V_260 ) , V_260 ) ;
V_254 = V_260 [ 1 ] ;
V_94 = V_260 [ 2 ] ;
V_175 = V_260 [ 3 ] ;
V_176 = V_260 [ 4 ] ;
