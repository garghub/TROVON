...
V_14 -> V_62 = V_16 -> V_17 . V_18 . V_55 . V_63 ;
V_14 -> V_64 = V_16 -> V_17 . V_18 . V_55 . V_64 ;
F_19 ( V_16 -> V_45 , & V_14 -> V_65 ) ;
V_14 -> V_66 = L_4 ;
V_14 -> V_67 = V_16 -> V_44 ;
...
V_16 -> V_17 . V_18 . V_69 = V_70 ;
else if ( V_16 -> V_17 . V_18 . V_55 . V_60 )
V_16 -> V_17 . V_18 . V_69 = V_71 ;
else
return 0 ;
...
break;
case V_74 :
if ( ( T_2 ) ~ V_72 [ 1 ] != V_72 [ 2 ] ||
( T_2 ) ~ V_72 [ 3 ] != V_72 [ 4 ] ) {
F_39 ( L_10 ) ;
break;
}
for ( V_39 = 0 ; V_39 < V_16 -> V_17 . V_18 . V_19 . V_20 ; V_39 ++ )
if ( F_40 ( & V_4 [ V_39 ] ) == V_72 [ 1 ] &&
F_41 ( & V_4 [ V_39 ] ) == V_72 [ 3 ] ) {
* V_28 = V_4 [ V_39 ] . V_10 ;
* V_29 = V_34 ;
return 0 ;
}
