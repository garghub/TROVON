...
static int F_230 ( struct V_5 * V_6 , int V_287 )
{
struct V_56 V_57 = {
. V_56 = V_514 ,
. V_88 = 0 ,
...
static int F_231 ( struct V_5 * V_6 , T_1 V_516 ,
int V_287 )
{
struct V_56 V_57 = {
. V_56 = V_517 ,
...
static int F_233 ( struct V_5 * V_6 , int V_287 )
{
struct V_56 V_57 = {
. V_56 = V_524 ,
. V_88 = 0 ,
...
static int F_235 ( struct V_5 * V_6 , T_1 V_538 ,
int V_287 )
{
struct V_56 V_57 = {
. V_56 = V_539 ,
...
static int F_236 ( struct V_5 * V_6 , int V_544 )
{
struct V_56 V_57 = {
. V_56 = V_545 ,
. V_88 = 0 ,
...
static int F_239 ( struct V_5 * V_6 , T_1 V_553 )
{
struct V_56 V_57 = {
. V_56 = V_554 ,
. V_88 = 0 ,
...
static int F_241 ( struct V_5 * V_6 , T_1 V_558 )
{
struct V_56 V_57 = {
. V_56 = V_561 ,
. V_88 = 0 ,
...
static int F_246 ( struct V_5 * V_6 , T_1 V_587 )
{
struct V_56 V_57 = {
. V_56 = V_552 ,
. V_88 = 0 ,
...
static int F_256 ( struct V_5 * V_6 , int V_287 )
{
...
F_255 ( V_6 , V_6 -> V_150 -> V_492 . V_494 , 1 ) ;
}
V_63 =
F_250 ( V_6 ,
V_6 -> V_150 -> V_190 .
...
#ifdef F_154
if ( V_6 -> V_150 -> V_198 == V_199 ) {
V_63 = F_232 ( V_6 , V_6 -> V_245 , V_287 ) ;
if ( V_63 )
return V_63 ;
F_31 ( L_45 ) ;
return 0 ;
...
if ( V_63 )
return - V_70 ;
V_63 = F_230 ( V_6 , V_287 ) ;
if ( V_63 )
return V_63 ;
V_63 = F_231 ( V_6 , V_6 -> V_150 -> V_198 , V_287 ) ;
if ( V_63 )
return V_63 ;
if ( V_6 -> V_150 -> V_198 == V_433 ) {
V_63 = F_232 ( V_6 , V_6 -> V_245 , V_287 ) ;
...
V_63 = F_233 ( V_6 , V_287 ) ;
if ( V_63 )
return V_63 ;
V_63 = F_235 ( V_6 , V_6 -> V_543 , V_287 ) ;
if ( V_63 )
return V_63 ;
V_63 = F_236 ( V_6 , V_546 ) ;
if ( V_63 )
return V_63 ;
V_63 = F_239 ( V_6 , V_6 -> V_557 ) ;
if ( V_63 )
return V_63 ;
if ( V_6 -> V_187 & V_627 )
V_273 = V_6 -> V_273 ;
...
static int F_259 ( struct V_1 * V_2 , void * V_468 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
...
F_282 ( & V_6 -> V_294 , F_257 ) ;
F_282 ( & V_6 -> V_285 , V_688 ) ;
F_282 ( & V_6 -> V_182 , F_274 ) ;
F_282 ( & V_6 -> V_216 , F_275 ) ;
F_282 ( & V_6 -> V_296 , F_118 ) ;
F_283 ( & V_6 -> V_459 , ( void (*) ( unsigned long ) )
...
V_691 = 2 ;
F_84 ( & V_6 -> V_265 ) ;
F_31 ( L_261 , V_2 -> V_51 , F_272 ( V_260 ) ) ;
V_63 = F_298 ( & V_260 -> V_2 . V_695 , & V_696 ) ;
if ( V_63 )
goto V_71;
if ( ! ( V_6 -> V_49 & V_486 ) ) {
if ( F_83 ( V_6 ) ) {
...
F_325 ( L_271 , V_710 -> V_711 ) ;
V_63 = F_232 ( V_6 , V_710 -> V_711 , 0 ) ;
}
V_622:
F_85 ( & V_6 -> V_265 ) ;
return V_63 ;
...
if ( F_333 ( V_218 -> V_219 . V_630 ) ||
F_334 ( V_218 -> V_219 . V_630 ) ) {
F_325 ( L_276 ) ;
V_6 -> V_187 &= ~ V_627 ;
...
V_63 = F_242 ( V_6 , V_218 -> V_219 . V_630 , 0 ) ;
F_325 ( L_277 , V_218 -> V_219 . V_630 ) ;
V_622:
F_85 ( & V_6 -> V_265 ) ;
return V_63 ;
}
...
V_63 = F_241 ( V_6 , V_218 -> V_558 . V_147 ) ;
F_325 ( L_296 ,
V_218 -> V_558 . V_147 ) ;
goto V_622;
}
...
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
return F_352 ( V_6 -> V_150 , V_81 , V_218 , V_707 ) ;
}
...
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
return F_354 ( V_6 -> V_150 , V_81 , V_218 , V_595 ) ;
}
...
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
return F_356 ( V_6 -> V_150 , V_81 , V_218 , V_595 ) ;
}
...
V_63 = F_236 ( V_6 , F_237 ( V_6 -> V_547 ) ) ;
F_325 ( L_303 , V_6 -> V_547 ) ;
V_622:
F_85 ( & V_6 -> V_265 ) ;
return V_63 ;
}
...
return - V_31 ;
if ( V_218 -> V_37 . V_286 ) {
V_15 = F_360 ( V_707 , V_218 -> V_37 . V_286 , V_239 ) ;
if ( V_15 == NULL )
return - V_240 ;
F_129 ( V_150 -> V_642 ) ;
V_150 -> V_642 = V_15 ;
...
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
return F_365 ( V_6 -> V_150 , V_81 , V_218 , V_707 ) ;
}
...
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
return F_367 ( V_6 -> V_150 , V_81 , V_218 , V_707 ) ;
}
...
V_314 = V_672 ;
if ( F_237 ( V_6 -> V_547 ) != V_314 )
V_63 = F_236 ( V_6 , V_314 ) ;
V_622:
F_85 ( & V_6 -> V_265 ) ;
return V_63 ;
}
...
static struct V_819 * F_377 ( struct V_1 * V_2 )
{
enum {
V_820 = 30 ,
V_821 = 60 ,
...
static int F_378 ( struct V_119 * V_844 )
{
struct V_845 * V_846 =
(struct V_845 * ) V_844 -> V_847 -> V_37 ;
if ( F_379 ( V_846 -> V_121 ) != V_848 ) {
...
V_202 = F_381 ( & V_844 -> V_847 , V_852 , & V_6 -> V_260 -> V_2 ) ;
if ( V_202 < 0 ) {
F_27 (KERN_ERR DRV_NAME L_67
L_327 ,
