...
static int F_31 ( struct V_8 * V_8 , struct V_42 * V_43 )
{
int V_44 ;
struct V_1 * V_1 ;
V_44 = - V_45 ;
V_1 = F_18 ( F_32 ( V_8 ) ) ;
if ( V_1 != NULL ) {
V_44 = F_33 ( V_1 -> V_35 , V_8 , V_43 ) ;
F_8 ( V_1 ) ;
}
return V_44 ;
}
static T_1 int F_34 ( struct V_1 * V_1 )
{
struct V_2 * V_46 , * V_47 ;
int V_18 ;
V_18 = - V_16 ;
V_46 = F_35 ( sizeof( * V_46 ) + 4 , V_48 ) ;
if ( ! V_46 )
goto V_49;
V_46 -> V_5 = V_1 ;
V_46 -> V_41 = 2 ;
...
static T_2 void F_38 ( struct V_1 * V_1 )
{
F_39 ( L_2 , V_1 -> V_35 ) ;
F_37 ( V_1 -> V_35 ) ;
}
