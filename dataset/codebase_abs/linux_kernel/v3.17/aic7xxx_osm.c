...
V_20 -> V_43 -> V_65 , ( V_365 ) V_20 -> V_43 -> V_219 ) ;
V_168 = V_108 ;
goto V_151;
}
...
struct V_3 * V_372 ;
V_372 = F_174 ( V_2 , F_8 ( V_2 , V_373 ) ) ;
if ( V_372 == V_355 )
V_364 = FALSE ;
else if ( V_156 != V_105
&& F_8 ( V_2 , V_374 ) == V_355 -> V_229 -> V_240
&& F_8 ( V_2 , V_375 ) == F_5 ( V_355 ) )
V_364 = FALSE ;
}
V_358 = F_8 ( V_2 , V_376 ) ;
V_356 = F_8 ( V_2 , V_377 ) ;
...
F_12 ( V_2 , V_379 , V_380 ) ;
F_12 ( V_2 , V_381 , V_358 | V_382 ) ;
F_166 ( V_91 , V_20 , L_60 ) ;
V_363 = TRUE ;
} else if ( V_364 ) {
V_355 -> V_229 -> V_239 |= V_249 | V_383 ;
V_355 -> V_31 |= V_308 | V_156 ;
...
FALSE ) ;
if ( ( V_2 -> V_31 & V_384 ) == 0 ) {
F_12 ( V_2 , V_377 , V_355 -> V_229 -> V_10 ) ;
F_12 ( V_2 , V_385 ,
F_8 ( V_2 , V_385 ) | V_249 ) ;
}
...
{
struct V_34 * V_387 = F_32 ( V_50 -> V_42 . V_109 ) ;
struct V_1 * V_2 = * ( (struct V_1 * * ) V_387 -> V_38 ) ;
struct V_56 V_57 ;
unsigned long V_31 ;
F_40 ( & V_57 , V_387 -> V_172 , V_50 -> V_65 , 0 ,
V_50 -> V_62 + 'A' , V_82 ) ;
F_28 ( V_2 , & V_31 ) ;
...
V_389 = F_184 ( V_2 , & V_286 , & V_289 , V_68 ) ;
F_28 ( V_2 , & V_31 ) ;
F_41 ( V_2 , & V_57 , V_389 , V_286 , V_243 ,
V_289 , V_83 , FALSE ) ;
F_30 ( V_2 , & V_31 ) ;
}
...
static void F_186 ( struct V_49 * V_50 , int V_391 )
{
struct V_34 * V_387 = F_32 ( V_50 -> V_42 . V_109 ) ;
struct V_1 * V_2 = * ( (struct V_1 * * ) V_387 -> V_38 ) ;
struct V_60 * V_61 ;
...
V_389 = F_184 ( V_2 , & V_286 , & V_289 , V_68 ) ;
F_28 ( V_2 , & V_31 ) ;
F_41 ( V_2 , & V_57 , V_389 , V_286 , V_59 -> V_287 . V_243 ,
V_289 , V_83 , FALSE ) ;
F_30 ( V_2 , & V_31 ) ;
}
static void F_187 ( struct V_34 * V_387 )
{
struct V_1 * V_2 = * (struct V_1 * * ) V_387 -> V_38 ;
unsigned long V_31 ;
V_365 V_392 ;
