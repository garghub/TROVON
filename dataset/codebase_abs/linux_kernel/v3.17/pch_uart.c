...
F_51 ( V_136 ) , ( unsigned long ) V_6 -> V_105 &
~ V_156 ) ;
F_64 ( V_136 ) = V_6 -> V_103 ;
V_155 = F_65 ( V_6 -> V_102 ,
V_136 , 1 , V_157 ,
V_158 | V_159 ) ;
if ( ! V_155 )
return 0 ;
...
int V_163 ;
if ( ! V_6 -> V_164 ) {
F_68 ( V_6 -> V_14 . V_43 , L_26 ,
V_50 , V_51 ) ;
F_10 ( V_6 , V_145 ) ;
V_6 -> V_163 = 1 ;
return 0 ;
}
V_60 = F_69 ( V_6 -> V_60 , 1 ) ;
V_163 = 1 ;
...
V_167 = F_57 ( ( int ) F_72 ( V_134 -> V_148 , V_134 -> V_139 ,
...
V_136 = V_6 -> V_137 ;
V_138 = F_73 ( V_14 -> V_43 , V_136 , V_166 , V_143 ) ;
if ( ! V_138 ) {
...
F_74 ( V_14 -> V_43 , V_6 -> V_137 , V_138 , V_143 ) ;
V_6 -> V_142 = V_155 ;
V_155 -> V_160 = F_50 ;
V_155 -> V_161 = V_6 ;
V_155 -> V_162 ( V_155 ) ;
...
static void F_75 ( struct V_5 * V_6 , unsigned int V_80 )
{
struct V_81 * V_14 = & V_6 -> V_14 ;
struct V_172 * V_173 = F_76 ( & V_14 -> V_96 -> V_14 ) ;
char * V_174 [ 5 ] = {} ;
int V_75 = 0 ;
if ( V_80 & V_175 )
V_174 [ V_75 ++ ] = L_33 ;
...
static T_8 F_78 ( int V_181 , void * V_182 )
{
...
static void F_84 ( struct V_81 * V_14 , unsigned int V_208 )
{
T_5 V_209 = 0 ;
...
static void F_89 ( struct V_81 * V_14 , int V_218 )
{
struct V_5 * V_6 ;
unsigned long V_185 ;
V_6 = F_35 ( V_14 , struct V_5 , V_14 ) ;
...
static int F_90 ( struct V_81 * V_14 )
{
struct V_5 * V_6 ;
int V_10 ;
int V_60 ;
...
if ( V_10 < 0 )
return V_10 ;
V_10 = F_91 ( V_6 -> V_14 . V_181 , F_78 , V_233 ,
V_6 -> V_234 , V_6 ) ;
if ( V_10 < 0 )
return V_10 ;
if ( V_6 -> V_192 )
...
F_9 ( V_6 , V_131 |
V_132 ) ;
F_92 ( V_14 , V_235 , V_220 ) ;
return 0 ;
}
static void F_93 ( struct V_81 * V_14 )
{
struct V_5 * V_6 ;
int V_10 ;
V_6 = F_35 ( V_14 , struct V_5 , V_14 ) ;
...
L_39 , V_10 ) ;
F_34 ( V_14 ) ;
F_94 ( V_6 -> V_14 . V_181 , V_6 ) ;
}
static void F_95 ( struct V_81 * V_14 ,
...
V_6 -> V_209 &= ~ V_216 ;
V_238 -> V_241 &= ~ V_256 ;
V_35 = F_96 ( V_14 , V_238 , V_239 , 0 , V_14 -> V_41 / 16 ) ;
F_79 ( & V_6 -> V_187 , V_185 ) ;
F_97 ( & V_14 -> V_187 ) ;
F_92 ( V_14 , V_238 -> V_241 , V_35 ) ;
V_240 = F_11 ( V_6 , V_35 , V_36 , V_37 , V_38 ) ;
if ( V_240 )
goto V_257;
F_84 ( & V_6 -> V_14 , V_6 -> V_14 . V_208 ) ;
if ( F_98 ( V_238 ) )
F_99 ( V_238 , V_35 , V_35 ) ;
V_257:
F_100 ( & V_14 -> V_187 ) ;
F_80 ( & V_6 -> V_187 , V_185 ) ;
}
static const char * F_101 ( struct V_81 * V_14 )
{
return V_258 ;
}
static void F_102 ( struct V_81 * V_14 )
{
struct V_5 * V_6 ;
V_6 = F_35 ( V_14 , struct V_5 , V_14 ) ;
F_103 ( V_6 -> V_118 , V_6 -> V_15 ) ;
F_104 ( V_6 -> V_118 ) ;
}
static int F_105 ( struct V_81 * V_14 )
{
struct V_5 * V_6 ;
int V_10 ;
void T_9 * V_15 ;
V_6 = F_35 ( V_14 , struct V_5 , V_14 ) ;
V_10 = F_106 ( V_6 -> V_118 , V_258 ) ;
if ( V_10 < 0 )
return - V_259 ;
V_15 = F_107 ( V_6 -> V_118 , 1 , 0 ) ;
if ( ! V_15 ) {
F_104 ( V_6 -> V_118 ) ;
return - V_259 ;
}
...
static void F_108 ( struct V_81 * V_14 , int type )
{
struct V_5 * V_6 ;
V_6 = F_35 ( V_14 , struct V_5 , V_14 ) ;
if ( type & V_260 ) {
...
static int F_109 ( struct V_81 * V_14 ,
struct V_262 * V_263 )
{
struct V_5 * V_6 ;
V_6 = F_35 ( V_14 , struct V_5 , V_14 ) ;
if ( V_263 -> V_185 & V_264 ) {
F_68 ( V_6 -> V_14 . V_43 ,
L_40 ) ;
V_6 -> V_192 = 0 ;
V_263 -> V_185 &= ~ V_264 ;
...
F_68 ( V_6 -> V_14 . V_43 , L_42 ,
V_6 -> V_192 ?
L_43 : L_44 ) ;
}
return 0 ;
}
static void F_111 ( struct V_5 * V_266 , int V_37 )
{
unsigned int V_267 , V_268 = 10000 ;
for (; ; ) {
V_267 = F_3 ( V_266 -> V_15 + V_20 ) ;
if ( ( V_267 & V_37 ) == V_37 )
break;
if ( -- V_268 == 0 )
break;
...
if ( V_266 -> V_14 . V_185 & V_269 ) {
unsigned int V_268 ;
for ( V_268 = 1000000 ; V_268 ; V_268 -- ) {
unsigned int V_71 = F_3 ( V_266 -> V_15 + V_21 ) ;
if ( V_71 & V_206 )
break;
F_112 ( 1 ) ;
F_113 () ;
...
static int F_114 ( struct V_81 * V_14 )
{
struct V_5 * V_6 =
F_35 ( V_14 , struct V_5 , V_14 ) ;
...
static void F_115 ( struct V_81 * V_14 ,
unsigned char V_271 )
{
unsigned int V_33 ;
struct V_5 * V_6 =
...
F_10 ( V_6 , V_219 ) ;
F_111 ( V_6 , V_272 ) ;
F_4 ( V_271 , V_6 -> V_15 + V_77 ) ;
F_111 ( V_6 , V_273 ) ;
F_4 ( V_33 , V_6 -> V_15 + V_16 ) ;
}
static void F_116 ( struct V_81 * V_14 , int V_274 )
{
struct V_5 * V_6 =
F_35 ( V_14 , struct V_5 , V_14 ) ;
F_111 ( V_6 , V_272 ) ;
F_4 ( V_274 , V_6 -> V_15 + V_77 ) ;
}
static void
F_117 ( struct V_275 * V_276 , const char * V_277 , unsigned int V_3 )
{
struct V_5 * V_6 ;
unsigned long V_185 ;
int V_278 = 1 ;
...
V_278 = F_119 ( & V_6 -> V_187 ) ;
V_279 = F_119 ( & V_6 -> V_14 . V_187 ) ;
} else {
F_97 ( & V_6 -> V_187 ) ;
F_97 ( & V_6 -> V_14 . V_187 ) ;
}
V_33 = F_3 ( V_6 -> V_15 + V_16 ) ;
F_10 ( V_6 , V_219 ) ;
F_120 ( & V_6 -> V_14 , V_277 , V_3 , F_116 ) ;
F_111 ( V_6 , V_273 ) ;
F_4 ( V_33 , V_6 -> V_15 + V_16 ) ;
if ( V_279 )
F_100 ( & V_6 -> V_14 . V_187 ) ;
if ( V_278 )
F_100 ( & V_6 -> V_187 ) ;
F_121 ( V_185 ) ;
}
static int T_10 F_122 ( struct V_275 * V_276 , char * V_283 )
{
struct V_81 * V_14 ;
int V_35 = V_220 ;
int V_37 = 8 ;
...
if ( ! V_14 || ( ! V_14 -> V_286 && ! V_14 -> V_15 ) )
return - V_287 ;
V_14 -> V_41 = F_7 () ;
if ( V_283 )
F_123 ( V_283 , & V_35 , & V_36 , & V_37 , & V_284 ) ;
return F_124 ( V_14 , V_276 , V_35 , V_36 , V_37 , V_284 ) ;
}
static struct V_5 * F_125 ( struct V_116 * V_118 ,
...
char V_292 [ 32 ] ;
#endif
V_291 = & V_293 [ V_289 -> V_30 ] ;
V_261 = V_291 -> V_261 ;
V_6 = F_2 ( sizeof( struct V_5 ) , V_13 ) ;
if ( V_6 == NULL )
goto V_294;
V_152 = ( unsigned char * ) F_127 ( V_13 ) ;
if ( ! V_152 )
goto V_295;
switch ( V_261 ) {
case V_296 :
...
V_6 -> V_163 = 1 ;
V_6 -> V_152 . V_8 = V_152 ;
V_6 -> V_152 . V_93 = V_299 ;
V_6 -> V_60 = V_104 ;
V_6 -> V_41 = F_7 () ;
V_6 -> V_261 = V_300 + V_261 + 1 ;
V_6 -> V_14 . V_43 = & V_118 -> V_43 ;
V_6 -> V_14 . V_286 = V_286 ;
V_6 -> V_14 . V_15 = NULL ;
V_6 -> V_14 . V_123 = V_123 ;
V_6 -> V_14 . V_181 = V_118 -> V_181 ;
V_6 -> V_14 . V_301 = V_302 ;
V_6 -> V_14 . V_303 = & V_304 ;
V_6 -> V_14 . V_185 = V_305 ;
V_6 -> V_14 . V_104 = V_104 ;
V_6 -> V_14 . line = V_291 -> V_306 ;
V_6 -> V_61 = V_230 ;
snprintf ( V_6 -> V_234 , V_307 ,
V_258 L_46 V_308 L_47 ,
V_6 -> V_14 . line ) ;
F_130 ( & V_6 -> V_14 . V_187 ) ;
F_132 ( V_118 , V_6 ) ;
V_6 -> V_65 = 1 ;
V_6 -> V_57 = 0 ;
#ifdef F_133
V_280 [ V_291 -> V_306 ] = V_6 ;
#endif
V_10 = F_134 ( & V_309 , & V_6 -> V_14 ) ;
if ( V_10 < 0 )
goto V_298;
#ifdef F_126
snprintf ( V_292 , sizeof( V_292 ) , L_48 , V_291 -> V_306 ) ;
V_6 -> V_310 = F_135 ( V_292 , V_311 | V_312 ,
NULL , V_6 , & V_313 ) ;
#endif
return V_6 ;
V_298:
#ifdef F_133
V_280 [ V_291 -> V_306 ] = NULL ;
#endif
F_136 ( ( unsigned long ) V_152 ) ;
V_295:
F_6 ( V_6 ) ;
V_294:
return NULL ;
...
F_138 ( V_6 -> V_310 ) ;
#endif
F_139 ( & V_309 , & V_6 -> V_14 ) ;
F_136 ( ( unsigned long ) V_6 -> V_152 . V_8 ) ;
}
static void F_140 ( struct V_116 * V_118 )
{
struct V_5 * V_6 = F_141 ( V_118 ) ;
F_142 ( V_118 ) ;
#ifdef F_133
...
static int F_144 ( struct V_116 * V_118 , T_11 V_96 )
{
struct V_5 * V_6 = F_141 ( V_118 ) ;
F_145 ( & V_309 , & V_6 -> V_14 ) ;
F_146 ( V_118 ) ;
F_147 ( V_118 , F_148 ( V_118 , V_96 ) ) ;
return 0 ;
}
static int F_149 ( struct V_116 * V_118 )
{
struct V_5 * V_6 = F_141 ( V_118 ) ;
int V_10 ;
F_147 ( V_118 , V_314 ) ;
...
F_152 ( & V_309 , & V_6 -> V_14 ) ;
return 0 ;
}
static int F_153 ( struct V_116 * V_118 ,
const struct V_288 * V_289 )
{
int V_10 ;
struct V_5 * V_6 ;
