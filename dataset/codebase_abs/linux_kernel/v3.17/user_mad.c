...
* V_103 = F_52 ( ( ( V_126 ) V_13 -> V_127 ) << 32 |
( F_53 ( V_103 ) & 0xffffffff ) ) ;
V_106 -> V_79 . V_103 = * V_103 ;
}
if ( ! F_49 ( V_13 )
&& F_48 ( V_106 -> V_79 . V_80 )
&& ( F_50 ( & V_106 -> V_120 ) & V_121 ) ) {
F_12 ( & V_6 -> V_24 ) ;
...
static unsigned int F_55 ( struct V_6 * V_85 , struct V_130 * V_131 )
{
struct V_5 * V_6 = V_85 -> V_87 ;
unsigned int V_132 = V_133 | V_134 ;
F_56 ( V_85 , & V_6 -> V_23 , V_131 ) ;
if ( ! F_31 ( & V_6 -> V_22 ) )
V_132 |= V_135 | V_136 ;
return V_132 ;
}
static int F_57 ( struct V_5 * V_6 , void T_2 * V_137 ,
int V_138 )
{
struct V_139 V_140 ;
struct V_141 V_142 ;
...
int V_153 ;
for ( V_153 = 0 ; V_153 < F_59 ( V_154 ) ; ++ V_153 )
V_142 . V_152 [ V_153 ] =
...
V_13 = F_60 ( V_6 -> V_114 -> V_145 , V_6 -> V_114 -> V_58 ,
...
if ( F_61 ( V_143 ,
( T_6 T_2 * ) ( V_137 + F_62 ( struct V_139 , V_11 ) ) ) ) {
V_16 = - V_77 ;
goto V_147;
}
if ( ! V_6 -> V_158 ) {
...
static int F_65 ( struct V_5 * V_6 , void T_2 * V_137 )
{
struct V_161 V_140 ;
struct V_141 V_142 ;
struct V_10 * V_13 = NULL ;
...
if ( V_140 . V_162 & ~ V_163 ) {
F_58 ( V_6 -> V_114 -> V_4 ,
L_8 ,
V_140 . V_162 , V_163 ) ;
V_16 = - V_76 ;
if ( F_61 ( ( T_6 ) V_163 ,
( T_6 T_2 * ) ( V_137 + F_62 ( struct
V_161 , V_162 ) ) ) )
V_16 = - V_77 ;
goto V_147;
}
...
V_142 . V_150 [ 2 ] = V_140 . V_150 & 0x0000ff ;
V_142 . V_150 [ 1 ] = ( V_140 . V_150 & 0x00ff00 ) >> 8 ;
V_142 . V_150 [ 0 ] = ( V_140 . V_150 & 0xff0000 ) >> 16 ;
memcpy ( V_142 . V_152 , V_140 . V_152 ,
sizeof( V_142 . V_152 ) ) ;
}
V_13 = F_60 ( V_6 -> V_114 -> V_145 , V_6 -> V_114 -> V_58 ,
...
static int F_66 ( struct V_5 * V_6 , T_6 T_2 * V_137 )
{
struct V_10 * V_13 = NULL ;
T_6 V_11 ;
int V_16 = 0 ;
...
static long F_69 ( struct V_6 * V_85 , unsigned int V_164 ,
unsigned long V_137 )
{
switch ( V_164 ) {
case V_165 :
return F_57 ( V_85 -> V_87 , ( void T_2 * ) V_137 , 0 ) ;
case V_166 :
return F_66 ( V_85 -> V_87 , ( V_167 T_2 * ) V_137 ) ;
case V_168 :
return F_68 ( V_85 -> V_87 ) ;
case V_169 :
return F_65 ( V_85 -> V_87 , ( void T_2 * ) V_137 ) ;
default:
return - V_170 ;
}
}
static long F_70 ( struct V_6 * V_85 , unsigned int V_164 ,
unsigned long V_137 )
{
switch ( V_164 ) {
case V_165 :
return F_57 ( V_85 -> V_87 , F_71 ( V_137 ) , 1 ) ;
case V_166 :
return F_66 ( V_85 -> V_87 , F_71 ( V_137 ) ) ;
case V_168 :
return F_68 ( V_85 -> V_87 ) ;
case V_169 :
return F_65 ( V_85 -> V_87 , F_71 ( V_137 ) ) ;
default:
return - V_170 ;
}
}
static int F_72 ( struct V_171 * V_171 , struct V_6 * V_85 )
{
struct V_172 * V_114 ;
struct V_5 * V_6 ;
int V_16 = - V_173 ;
V_114 = F_2 ( V_171 -> V_174 , struct V_172 , V_175 ) ;
F_7 ( & V_114 -> V_144 ) ;
if ( ! V_114 -> V_145 )
goto V_147;
V_16 = - V_109 ;
...
V_6 -> V_114 = V_114 ;
V_85 -> V_87 = V_6 ;
F_8 ( & V_6 -> V_176 , & V_114 -> V_177 ) ;
V_16 = F_77 ( V_171 , V_85 ) ;
if ( V_16 ) {
F_13 ( & V_6 -> V_176 ) ;
F_3 ( V_6 ) ;
goto V_147;
}
F_78 ( & V_114 -> V_178 -> V_2 ) ;
V_147:
F_10 ( & V_114 -> V_144 ) ;
return V_16 ;
}
static int F_79 ( struct V_171 * V_171 , struct V_6 * V_85 )
{
struct V_5 * V_6 = V_85 -> V_87 ;
struct V_3 * V_4 = V_6 -> V_114 -> V_178 ;
...
static int F_82 ( struct V_171 * V_171 , struct V_6 * V_85 )
{
struct V_172 * V_114 ;
struct V_181 V_182 = {
. V_183 = V_184
...
int V_16 ;
V_114 = F_2 ( V_171 -> V_174 , struct V_172 , V_185 ) ;
if ( V_85 -> V_88 & V_89 ) {
if ( F_83 ( & V_114 -> V_186 ) ) {
V_16 = - V_90 ;
goto V_187;
...
V_16 = F_85 ( V_114 -> V_145 , V_114 -> V_58 , 0 , & V_182 ) ;
if ( V_16 )
goto V_188;
V_85 -> V_87 = V_114 ;
V_16 = F_77 ( V_171 , V_85 ) ;
...
return 0 ;
V_189:
F_86 ( V_182 . V_183 , V_182 . V_190 ) ;
F_85 ( V_114 -> V_145 , V_114 -> V_58 , 0 , & V_182 ) ;
V_188:
F_87 ( & V_114 -> V_186 ) ;
V_187:
return V_16 ;
}
static int F_88 ( struct V_171 * V_171 , struct V_6 * V_85 )
{
struct V_172 * V_114 = V_85 -> V_87 ;
struct V_181 V_182 = {
. V_190 = V_184
} ;
int V_16 = 0 ;
...
F_10 ( & V_114 -> V_144 ) ;
F_87 ( & V_114 -> V_186 ) ;
F_81 ( & V_114 -> V_178 -> V_2 ) ;
return V_16 ;
}
static T_1 F_89 ( struct V_57 * V_4 , struct V_191 * V_192 ,
char * V_69 )
{
struct V_172 * V_114 = F_90 ( V_4 ) ;
if ( ! V_114 )
return - V_193 ;
return sprintf ( V_69 , L_11 , V_114 -> V_145 -> V_194 ) ;
}
static T_1 F_91 ( struct V_57 * V_4 , struct V_191 * V_192 ,
char * V_69 )
{
struct V_172 * V_114 = F_90 ( V_4 ) ;
if ( ! V_114 )
return - V_193 ;
return sprintf ( V_69 , L_12 , V_114 -> V_58 ) ;
}
static int F_92 ( struct V_195 * V_57 )
{
int V_16 ;
if ( ! V_196 ) {
V_16 = F_93 ( & V_196 , 0 , V_197 * 2 ,
L_13 ) ;
if ( V_16 ) {
F_94 ( & V_57 -> V_4 ,
L_14 ) ;
...
V_16 = F_95 ( V_198 , V_197 ) ;
if ( V_16 >= V_197 )
return - 1 ;
return V_16 ;
}
static int F_96 ( struct V_195 * V_57 , int V_58 ,
struct V_3 * V_178 ,
struct V_172 * V_114 )
{
int V_199 ;
...
F_73 ( & V_114 -> V_144 ) ;
F_75 ( & V_114 -> V_177 ) ;
F_101 ( & V_114 -> V_175 , & V_205 ) ;
V_114 -> V_175 . V_206 = V_207 ;
V_114 -> V_175 . V_2 . V_208 = & V_178 -> V_2 ;
F_102 ( & V_114 -> V_175 . V_2 , L_15 , V_114 -> V_203 ) ;
if ( F_103 ( & V_114 -> V_175 , V_200 , 1 ) )
goto V_209;
V_114 -> V_4 = F_104 ( V_210 , V_57 -> V_211 ,
V_114 -> V_175 . V_4 , V_114 ,
L_15 , V_114 -> V_203 ) ;
if ( F_46 ( V_114 -> V_4 ) )
goto V_209;
if ( F_105 ( V_114 -> V_4 , & V_212 ) )
goto V_213;
if ( F_105 ( V_114 -> V_4 , & V_214 ) )
goto V_213;
V_200 += V_197 ;
F_101 ( & V_114 -> V_185 , & V_215 ) ;
V_114 -> V_185 . V_206 = V_207 ;
V_114 -> V_185 . V_2 . V_208 = & V_178 -> V_2 ;
F_102 ( & V_114 -> V_185 . V_2 , L_16 , V_114 -> V_203 ) ;
if ( F_103 ( & V_114 -> V_185 , V_200 , 1 ) )
goto V_216;
V_114 -> V_217 = F_104 ( V_210 , V_57 -> V_211 ,
V_114 -> V_185 . V_4 , V_114 ,
L_16 , V_114 -> V_203 ) ;
if ( F_46 ( V_114 -> V_217 ) )
goto V_216;
if ( F_105 ( V_114 -> V_217 , & V_212 ) )
goto V_218;
if ( F_105 ( V_114 -> V_217 , & V_214 ) )
goto V_218;
return 0 ;
V_218:
F_106 ( V_210 , V_114 -> V_185 . V_4 ) ;
V_216:
F_107 ( & V_114 -> V_185 ) ;
V_213:
F_106 ( V_210 , V_114 -> V_175 . V_4 ) ;
V_209:
F_107 ( & V_114 -> V_175 ) ;
if ( V_114 -> V_203 < V_197 )
F_108 ( V_199 , V_202 ) ;
else
F_108 ( V_199 , V_198 ) ;
return - 1 ;
}
static void F_109 ( struct V_172 * V_114 )
{
struct V_5 * V_6 ;
int V_11 ;
F_110 ( V_114 -> V_4 , NULL ) ;
F_110 ( V_114 -> V_217 , NULL ) ;
F_106 ( V_210 , V_114 -> V_175 . V_4 ) ;
F_106 ( V_210 , V_114 -> V_185 . V_4 ) ;
F_107 ( & V_114 -> V_175 ) ;
F_107 ( & V_114 -> V_185 ) ;
...
F_10 ( & V_114 -> V_144 ) ;
if ( V_114 -> V_203 < V_197 )
F_108 ( V_114 -> V_203 , V_202 ) ;
else
F_108 ( V_114 -> V_203 - V_197 , V_198 ) ;
}
static void F_111 ( struct V_195 * V_57 )
{
struct V_3 * V_178 ;
int V_219 , V_220 , V_153 ;
if ( F_112 ( V_57 -> V_221 ) != V_222 )
return;
if ( V_57 -> V_221 == V_223 )
V_219 = V_220 = 0 ;
else {
...
V_178 = F_19 ( sizeof *V_178 +
( V_220 - V_219 + 1 ) * sizeof ( struct V_172 ) ,
V_41 ) ;
if ( ! V_178 )
return;
F_113 ( & V_178 -> V_2 , & V_225 ) ;
V_178 -> V_226 = V_219 ;
V_178 -> V_227 = V_220 ;
for ( V_153 = V_219 ; V_153 <= V_220 ; ++ V_153 ) {
V_178 -> V_114 [ V_153 - V_219 ] . V_178 = V_178 ;
if ( F_96 ( V_57 , V_153 , V_178 ,
& V_178 -> V_114 [ V_153 - V_219 ] ) )
goto V_110;
}
F_114 ( V_57 , & V_228 , V_178 ) ;
return;
V_110:
while ( -- V_153 >= V_219 )
F_109 ( & V_178 -> V_114 [ V_153 - V_219 ] ) ;
F_81 ( & V_178 -> V_2 ) ;
}
static void F_115 ( struct V_195 * V_57 )
{
struct V_3 * V_178 = F_116 ( V_57 , & V_228 ) ;
int V_153 ;
if ( ! V_178 )
return;
for ( V_153 = 0 ; V_153 <= V_178 -> V_227 - V_178 -> V_226 ; ++ V_153 )
F_109 ( & V_178 -> V_114 [ V_153 ] ) ;
F_81 ( & V_178 -> V_2 ) ;
}
static char * F_117 ( struct V_57 * V_4 , T_8 * V_229 )
{
return F_118 ( V_41 , L_17 , F_119 ( V_4 ) ) ;
}
static int T_9 F_120 ( void )
{
int V_16 ;
V_16 = F_121 ( V_204 , V_197 * 2 ,
L_13 ) ;
if ( V_16 ) {
F_122 ( L_18 ) ;
goto V_147;
}
V_210 = F_123 ( V_207 , L_13 ) ;
if ( F_46 ( V_210 ) ) {
V_16 = F_47 ( V_210 ) ;
F_122 ( L_19 ) ;
goto V_230;
