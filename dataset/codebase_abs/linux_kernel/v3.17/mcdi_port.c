...
static void F_31 ( struct V_1 * V_2 , struct V_231 * V_232 )
{
struct V_3 * V_113 = V_2 -> V_114 ;
F_2 ( V_5 , V_149 ) ;
int V_8 ;
V_232 -> V_117 =
F_15 ( V_113 -> V_27 , V_113 -> V_18 ) ;
V_232 -> V_233 = V_2 -> V_164 ;
F_32 ( V_232 , V_2 -> V_134 . V_135 ) ;
V_232 -> V_234 = V_2 -> V_134 . V_147 ;
V_232 -> V_22 = F_18 ( V_113 -> V_27 ) ;
V_232 -> V_235 = V_113 -> V_22 ;
V_232 -> V_236 = V_237 ;
V_232 -> V_238 = ! ! ( V_2 -> V_164 & V_239 ) ;
V_232 -> V_240 = ( V_2 -> V_156 . V_159 &
( V_161 | V_160 ) ) ;
F_3 ( V_153 != 0 ) ;
V_8 = F_4 ( V_2 , V_154 , NULL , 0 ,
V_5 , sizeof( V_5 ) , NULL ) ;
...
static int F_33 ( struct V_1 * V_2 , struct V_231 * V_232 )
{
struct V_3 * V_113 = V_2 -> V_114 ;
T_2 V_150 ;
int V_8 ;
if ( V_232 -> V_238 ) {
V_150 = ( F_16 ( V_232 -> V_233 ) |
1 << V_111 ) ;
} else if ( V_232 -> V_234 ) {
switch ( F_34 ( V_232 ) ) {
...
switch ( F_34 ( V_232 ) ) {
case 10 : V_150 = 1 << V_95 ; break;
case 100 : V_150 = 1 << V_99 ; break;
case 1000 : V_150 = 1 << V_103 ; break;
default: return - V_243 ;
}
}
...
V_8 = F_4 ( V_2 , V_355 , V_39 , sizeof( V_39 ) ,
NULL , 0 , NULL ) ;
return V_8 ;
}
void F_58 ( struct V_1 * V_2 )
{
T_8 * V_356 = V_2 -> V_340 . V_56 ;
V_356 [ V_357 ] = V_358 ;
F_55 ( V_2 , V_337 , 0 ) ;
}
...
V_2 -> V_362 = & V_363 ;
V_2 -> V_156 . V_159 = V_161 | V_162 ;
V_2 -> V_156 . V_364 = F_12 ;
V_2 -> V_156 . V_365 = F_14 ;
V_8 = V_2 -> V_362 -> V_366 ( V_2 ) ;
if ( V_8 != 0 )
return V_8 ;
V_8 = F_63 ( V_2 , & V_2 -> V_340 ,
V_343 * sizeof( T_3 ) , V_151 ) ;
if ( V_8 )
return V_8 ;
F_64 ( V_2 , V_366 , V_2 -> V_34 ,
L_5 ,
( T_3 ) V_2 -> V_340 . V_339 ,
V_2 -> V_340 . V_56 ,
( T_3 ) F_65 ( V_2 -> V_340 . V_56 ) ) ;
F_55 ( V_2 , V_342 , 1 ) ;
return 0 ;
}
void F_66 ( struct V_1 * V_2 )
{
V_2 -> V_362 -> remove ( V_2 ) ;
F_67 ( V_2 , & V_2 -> V_340 ) ;
}
...
F_2 ( V_5 , V_367 ) ;
int V_8 ;
V_8 = F_4 ( V_2 , V_368 , NULL , 0 ,
V_5 , sizeof( V_5 ) , NULL ) ;
if ( V_8 )
return V_8 ;
return F_5 ( V_5 , V_369 ) ;
}
