...
static int F_11 ( struct V_2 * V_3 , T_2 V_24 )
{
struct V_1 * V_5 = F_1 ( V_3 ) ;
T_1 V_6 = F_4 ( V_5 -> V_7 ) ;
if ( V_24 >= V_25 )
...
static int F_14 ( struct V_2 * V_3 , unsigned long V_13 ,
unsigned long V_4 )
{
...
int V_16 ;
int V_19 ;
V_39 = F_16 ( & V_29 -> V_33 , sizeof( * V_39 ) , V_42 ) ;
if ( ! V_39 )
return - V_43 ;
V_41 = F_17 ( V_29 , V_44 , 0 ) ;
V_39 -> V_7 = F_18 ( & V_29 -> V_33 , V_41 ) ;
if ( F_19 ( V_39 -> V_7 ) )
return F_20 ( V_39 -> V_7 ) ;
V_16 = F_21 ( V_32 ) ;
if ( V_16 > V_25 )
V_16 = V_25 ;
for ( V_19 = 0 ; V_19 < V_16 ; V_19 ++ )
V_30 [ V_19 ] = F_22 ( V_32 , V_19 ) ;
F_23 ( V_32 , L_1 , & V_35 ) ;
V_38 . V_36 = V_35 ;
V_38 . V_45 = & V_46 ;
V_38 . V_47 = V_30 ;
...
V_38 . V_49 = 0 ;
V_39 -> V_3 . V_38 = & V_38 ;
V_5 = F_24 ( & V_29 -> V_33 , & V_39 -> V_3 ) ;
if ( F_19 ( V_5 ) )
return F_20 ( V_5 ) ;
return F_25 ( V_32 , V_50 , V_5 ) ;
}
