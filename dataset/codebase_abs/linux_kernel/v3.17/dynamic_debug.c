...
int F_31 ( struct V_3 * V_70 , const char * V_71 , ... )
{
T_2 args ;
int V_72 ;
struct V_73 V_74 ;
...
V_74 . V_75 = & args ;
if ( ! V_78 ) {
V_72 = F_32 ( V_76 L_42 , & V_74 ) ;
} else {
char V_5 [ V_61 ] ;
V_72 = F_34 ( 7 , V_78 , L_43 ,
F_28 ( V_70 , V_5 ) ,
F_35 ( V_78 ) , F_36 ( V_78 ) ,
& V_74 ) ;
}
...
V_72 = F_32 ( V_76 L_45 , F_38 ( V_78 ) ,
F_39 ( V_78 ) , & V_74 ) ;
} else {
V_72 = F_32 ( V_76 L_46 , & V_74 ) ;
}
va_end ( args ) ;
return V_72 ;
}
...
int V_108 ;
F_6 ( L_57 ) ;
V_95 = F_60 ( sizeof( * V_95 ) , V_91 ) ;
if ( V_95 == NULL )
return - V_92 ;
V_108 = F_61 ( V_83 , & V_109 ) ;
if ( V_108 ) {
F_46 ( V_95 ) ;
return V_108 ;
}
...
int F_62 ( struct V_3 * V_111 , unsigned int V_104 ,
const char * V_45 )
{
struct V_24 * V_25 ;
char * V_112 ;
V_25 = F_60 ( sizeof( * V_25 ) , V_91 ) ;
if ( V_25 == NULL )
return - V_92 ;
V_112 = F_63 ( V_45 , V_91 ) ;
if ( V_112 == NULL ) {
F_46 ( V_25 ) ;
return - V_92 ;
}
...
static int F_65 ( char * V_113 , char * V_42 ,
...
static int F_66 ( char * V_113 , char * V_42 ,
const char * V_116 )
{
F_6 ( L_61 , V_113 , V_42 ) ;
return F_65 ( V_113 , V_42 , NULL , 0 ) ;
}
int F_67 ( char * V_113 , char * V_42 , const char * V_20 )
{
F_6 ( L_62 , V_20 , V_113 , V_42 ) ;
return F_65 ( V_113 , V_42 , V_20 , - V_117 ) ;
}
...
int F_70 ( const char * V_30 )
{
struct V_24 * V_25 , * V_118 ;
int V_88 = - V_117 ;
F_6 ( L_63 , V_30 ) ;
F_8 ( & V_29 ) ;
F_71 (dt, nextdt, &ddebug_tables, link) {
...
if ( ! V_121 )
return - V_122 ;
V_120 = F_74 ( L_64 , NULL ) ;
if ( ! V_120 )
return - V_92 ;
V_83 = F_75 ( L_65 , 0644 , V_120 , NULL ,
& V_123 ) ;
if ( ! V_83 ) {
F_76 ( V_120 ) ;
return - V_92 ;
...
V_125 = F_63 ( V_132 , V_91 ) ;
F_78 ( L_71 , V_125 , NULL ,
0 , 0 , 0 , & F_66 ) ;
F_46 ( V_125 ) ;
return 0 ;
V_131:
