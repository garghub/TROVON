...
void F_25 ( struct V_1 * V_10 , unsigned int V_29 )
{
...
unsigned int F_44 ( struct V_49 * V_30 )
{
struct V_1 * V_10 ;
T_1 V_31 ;
unsigned int type = V_50 ;
unsigned int V_36 ;
V_10 = V_30 -> V_51 ? F_23 ( V_30 -> V_51 ) : V_20 ;
if ( ! V_10 ) {
F_45 ( L_20 ,
F_36 ( V_30 -> V_51 ) ) ;
return 0 ;
}
if ( V_10 -> V_8 -> V_52 == NULL )
V_31 = V_30 -> args [ 0 ] ;
else {
if ( V_10 -> V_8 -> V_52 ( V_10 , V_30 -> V_51 , V_30 -> args ,
V_30 -> V_53 , & V_31 , & type ) )
return 0 ;
}
V_36 = F_41 ( V_10 , V_31 ) ;
