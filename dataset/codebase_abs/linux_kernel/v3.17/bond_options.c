...
goto V_111;
V_108 = F_30 ( F_31 ( V_29 -> V_38 ) , V_50 -> string ) ;
if ( ! V_108 )
goto V_111;
V_107 = NULL ;
F_54 (bond, slave, iter) {
...
switch ( V_114 [ 0 ] ) {
case '+' :
F_24 ( V_29 -> V_38 , L_59 , V_38 -> V_2 ) ;
V_21 = F_85 ( V_29 -> V_38 , V_38 ) ;
break;
case '-' :
F_24 ( V_29 -> V_38 , L_60 , V_38 -> V_2 ) ;
