...
{
struct V_195 * V_158 = & V_53 -> V_97 . V_158 ;
struct V_136 * V_196 ;
...
if ( F_26 ( V_53 ) == false )
return V_208 ;
if ( F_56 ( ! F_57 ( V_193 -> V_209 ) ) ) {
F_58 ( V_210 L_4 ,
V_185 ) ;
return V_100 ;
}
if ( ! F_59 ( V_158 -> V_159 . V_77 , V_193 -> V_211 ) ) {
F_43 ( L_5
MAC_FMT MAC_FMT L_6 , __func__, MAC_ARG(mgmt->bssid),
MAC_ARG(cur_network->network.MacAddress)) ;
return V_100 ;
}
V_204 = V_194 - F_60 ( struct V_192 , V_212 . V_213 . V_214 ) ;
V_94 = F_61 ( V_215 , V_193 -> V_212 . V_213 . V_214 ,
V_204 ) ;
if ( V_94 )
V_199 = V_94 [ 2 ] ;
else {
...
V_94 = F_61 ( V_219 , V_193 -> V_212 . V_213 . V_214 , V_204 ) ;
if ( V_94 && V_94 [ 1 ] ) {
V_207 = V_94 + 2 ;
V_205 = V_94 [ 1 ] ;
} else {
...
( L_11
L_12 , V_185 ,
V_207 , V_205 , V_158 -> V_159 . V_222 . V_207 ,
V_158 -> V_159 . V_222 . V_205 ) ) ;
if ( V_205 != V_158 -> V_159 . V_222 . V_205 || V_205 > 32 ||
( V_205 &&
memcmp ( V_207 , V_158 -> V_159 . V_222 . V_207 , V_205 ) ) ) {
F_43 ( L_13 , V_185 ) ;
goto V_218;
}
V_197 = F_37 ( V_193 -> V_212 . V_213 . V_223 ) ;
if ( V_197 & V_224 )
V_206 = 1 ;
else
V_206 = 0 ;
F_62 ( V_220 , V_221 ,
( L_14
L_15 , V_185 , V_158 -> V_159 . V_225 , V_206 ) ) ;
if ( V_158 -> V_159 . V_225 != V_206 ) {
F_43 ( L_16 , V_185 ) ;
goto V_218;
}
V_94 = F_61 ( V_226 , V_193 -> V_212 . V_213 . V_214 , V_204 ) ;
if ( V_94 && V_94 [ 1 ] ) {
V_198 = V_227 ;
if ( V_94 && V_94 [ 1 ] ) {
V_203 = F_63 ( V_94 , V_94 [ 1 ] + 2 , & V_200 ,
& V_201 , & V_202 ) ;
if ( V_203 == V_208 )
F_62 ( V_220 , V_221 ,
( L_17
...
if ( V_94 && V_94 [ 1 ] ) {
V_198 = V_230 ;
V_203 = F_65 ( V_94 , V_94 [ 1 ] + 2 , & V_200 ,
& V_201 , & V_202 ) ;
if ( V_203 == V_208 )
F_62 ( V_220 , V_221 ,
( L_17
...
F_62 ( V_220 , V_235 ,
( L_23 , V_185 ,
V_158 -> V_233 . V_200 , V_200 ) ) ;
if ( V_201 != V_158 -> V_233 . V_201 ||
V_200 != V_158 -> V_233 . V_200 ) {
F_43 ( L_24
L_25 ,
V_185 , V_201 ,
V_158 -> V_233 . V_201 ,
...
struct V_192 * V_193 ,
T_4 V_194 , struct V_156 * V_157 )
{
unsigned int V_47 ;
const T_1 * V_94 ;
V_47 = V_194 - F_60 ( struct V_192 , V_212 . V_213 . V_214 ) ;
V_94 = F_61 ( V_216 , V_193 -> V_212 . V_213 . V_214 ,
V_47 ) ;
if ( V_94 )
F_45 ( V_22 , V_94 ) ;
V_94 = F_61 ( V_236 , V_193 -> V_212 . V_213 . V_214 , V_47 ) ;
if ( V_94 ) {
F_53 ( V_22 , V_94 ) ;
F_54 ( V_22 , V_157 ) ;
}
...
struct V_75 * V_158 = & V_27 -> V_159 ;
const T_1 * V_94 ;
if ( V_158 -> V_237 & V_224 ) {
for ( V_3 = 0 ; V_3 < V_27 -> V_159 . V_238 ; ) {
V_94 = V_27 -> V_159 . V_239 + V_3 ;
switch ( V_94 [ 0 ] ) {
case V_240 :
...
const T_1 * V_94 ;
if ( V_158 -> V_237 & V_224 ) {
for ( V_3 = 0 ; V_3 < V_158 -> V_238 ; ) {
V_94 = V_158 -> V_239 + V_3 ;
switch ( V_94 [ 0 ] ) {
case V_240 :
if ( ! memcmp ( V_94 + 2 , V_241 , 4 ) &&
( ! memcmp ( V_94 + 2 + 12 ,
...
if ( ( * ( V_246 + V_3 ) ) & 0x80 )
V_249 |= 0x1 << F_70 ( * ( V_246 + V_3 ) ) ;
}
return V_249 ;
}
unsigned int F_72 ( unsigned char * V_246 , unsigned int V_247 )
{
unsigned int V_3 , V_248 ;
unsigned int V_249 = 0 ;
V_248 = ( V_247 > V_44 ) ? V_44 : V_247 ;
...
unsigned int F_73 ( struct V_168 * V_250 )
{
unsigned int V_249 = 0 ;
V_249 = V_250 -> V_179 . V_180 [ 0 ] << 12 |
V_250 -> V_179 . V_180 [ 1 ] << 20 ;
return V_249 ;
}
...
if ( V_27 -> V_252 == V_253 )
return V_100 ;
V_251 = ( V_24 -> V_153 & V_148 ) ? 6 : 5 ;
if ( V_250 -> V_254 & F_75 ( 0x1 << V_251 ) )
return V_208 ;
else
return V_100 ;
}
unsigned char F_76 ( T_2 V_249 )
{
int V_3 ;
...
void F_81 ( struct V_21 * V_22 , T_1 V_256 )
{
...
unsigned char F_84 ( T_1 * V_261 , T_4 V_47 )
{
int V_3 ;
T_1 V_262 ;
T_1 V_263 ;
...
void F_87 ( struct V_21 * V_53 , T_3 V_285 )
{
...
struct V_26 * V_27 = & V_24 -> V_28 ;
struct V_75 * V_158 = & V_27 -> V_159 ;
unsigned char * V_1 = V_158 -> V_294 ;
V_2 = F_91 ( V_158 -> V_294 ) ;
if ( ( V_27 -> V_183 ) && ( V_27 -> V_171 ) )
V_27 -> V_30 = 1 ;
if ( V_24 -> V_29 > 14 ) {
if ( V_27 -> V_30 )
...
int F_94 ( struct V_21 * V_22 , T_1 * V_296 ,
T_4 V_297 , int V_298 )
{
int V_299 = 0 ;
struct V_23 * V_24 = & V_22 -> V_25 ;
struct V_26 * V_27 = & V_24 -> V_28 ;
const T_1 * V_94 ;
V_94 = F_61 ( V_300 , V_296 , V_297 ) ;
if ( ! V_94 )
return V_100 ;
memcpy ( V_27 -> V_84 [ V_298 ] . V_294 , V_94 + 2 , V_94 [ 1 ] ) ;
V_299 = V_94 [ 1 ] ;
V_94 = F_61 ( V_301 , V_296 , V_297 ) ;
if ( V_94 )
...
struct V_23 * V_24 = & V_22 -> V_25 ;
struct V_26 * V_27 = & V_24 -> V_28 ;
V_157 = F_47 ( V_161 , V_303 ) ;
if ( V_157 ) {
V_305 = F_37 ( V_310 -> V_311 ) >> 4 ;
V_306 = F_37 ( V_310 -> V_312 ) ;
V_304 = ( V_306 >> 2 ) & 0x0f ;
V_308 = & V_157 -> V_313 [ V_304 ] ;
V_308 -> V_314 = 0xffff ;
