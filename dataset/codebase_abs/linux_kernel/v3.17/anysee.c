...
V_115 [ 1 ] ) ;
F_38 ( V_2 -> V_116 , V_117 ,
F_39 ( 0x08 , V_115 [ 1 ] ) , 0 ) ;
}
return 0 ;
}
static int F_40 ( struct V_1 * V_2 , struct V_118 * V_119 )
{
V_119 -> V_120 = V_121 ;
V_119 -> V_122 = F_37 ;
V_119 -> V_35 = 250 ;
...
static int F_41 ( struct V_123 * V_124 , int V_125 ,
int V_50 )
{
struct V_1 * V_2 = V_124 -> V_126 ;
int V_10 ;
T_1 V_13 [] = { V_127 , 0x02 , 0x40 | V_50 >> 8 , V_50 & 0xff , 0x00 , 1 } ;
T_1 V_23 ;
V_10 = F_1 ( V_2 , V_13 , sizeof( V_13 ) , & V_23 , 1 ) ;
if ( V_10 )
return V_10 ;
...
static int F_42 ( struct V_123 * V_124 , int V_125 ,
int V_50 , T_1 V_23 )
{
struct V_1 * V_2 = V_124 -> V_126 ;
int V_10 ;
T_1 V_13 [] = { V_127 , 0x03 , 0x40 | V_50 >> 8 , V_50 & 0xff , 0x00 , 1 , V_23 } ;
V_10 = F_1 ( V_2 , V_13 , sizeof( V_13 ) , NULL , 0 ) ;
if ( V_10 )
return V_10 ;
return 0 ;
}
static int F_43 ( struct V_123 * V_124 , int V_125 ,
T_1 V_50 )
{
struct V_1 * V_2 = V_124 -> V_126 ;
int V_10 ;
T_1 V_13 [] = { V_127 , 0x04 , 0x40 , V_50 , 0x00 , 1 } ;
T_1 V_23 ;
V_10 = F_1 ( V_2 , V_13 , sizeof( V_13 ) , & V_23 , 1 ) ;
if ( V_10 )
return V_10 ;
...
static int F_44 ( struct V_123 * V_124 , int V_125 ,
T_1 V_50 , T_1 V_23 )
{
struct V_1 * V_2 = V_124 -> V_126 ;
int V_10 ;
T_1 V_13 [] = { V_127 , 0x05 , 0x40 , V_50 , 0x00 , 1 , V_23 } ;
V_10 = F_1 ( V_2 , V_13 , sizeof( V_13 ) , NULL , 0 ) ;
if ( V_10 )
return V_10 ;
return 0 ;
}
static int F_45 ( struct V_123 * V_124 , int V_125 )
{
struct V_1 * V_2 = V_124 -> V_126 ;
int V_10 ;
struct V_7 * V_8 = F_2 ( V_2 ) ;
V_8 -> V_128 = V_129 + F_46 ( 1000 ) ;
V_10 = F_12 ( V_2 , V_84 , ( 0 << 7 ) , 0x80 ) ;
if ( V_10 )
return V_10 ;
F_47 ( 300 ) ;
...
static int F_48 ( struct V_123 * V_124 , int V_125 )
{
struct V_1 * V_2 = V_124 -> V_126 ;
int V_10 ;
V_10 = F_12 ( V_2 , V_84 , ( 0 << 7 ) , 0x80 ) ;
...
static int F_50 ( struct V_123 * V_124 , int V_125 ,
int V_130 )
{
struct V_1 * V_2 = V_124 -> V_126 ;
struct V_7 * V_8 = F_2 ( V_2 ) ;
int V_10 ;
T_1 V_27 = 0 ;
V_10 = F_13 ( V_2 , V_131 , & V_27 , 0x40 ) ;
if ( V_10 )
return V_10 ;
if ( V_27 == 0 ) {
V_10 = V_132 ;
if ( F_51 ( V_129 , V_8 -> V_128 ) )
V_10 |= V_133 ;
}
return V_10 ;
}
...
struct V_7 * V_8 = F_2 ( V_2 ) ;
int V_10 ;
V_8 -> V_124 . V_134 = V_135 ;
V_8 -> V_124 . V_136 = F_41 ;
V_8 -> V_124 . V_137 = F_42 ;
V_8 -> V_124 . V_138 = F_43 ;
V_8 -> V_124 . V_139 = F_44 ;
V_8 -> V_124 . V_140 = F_45 ;
V_8 -> V_124 . V_141 = F_48 ;
V_8 -> V_124 . V_142 = F_49 ;
V_8 -> V_124 . V_143 = F_50 ;
V_8 -> V_124 . V_126 = V_2 ;
V_10 = F_12 ( V_2 , V_84 , ( 1 << 7 ) , 0x80 ) ;
if ( V_10 )
return V_10 ;
...
if ( V_10 )
return V_10 ;
V_10 = F_53 ( & V_2 -> V_52 [ 0 ] . V_144 , & V_8 -> V_124 , 0 , 1 ) ;
if ( V_10 )
return V_10 ;
V_8 -> V_145 = true ;
return 0 ;
