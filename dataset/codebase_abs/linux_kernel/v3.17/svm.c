...
static void F_144 ( struct V_8 * V_9 , struct V_116 * V_337 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
V_337 -> V_338 = V_10 -> V_1 -> V_58 . V_256 . V_188 ;
V_337 -> V_129 = V_10 -> V_1 -> V_58 . V_256 . V_88 ;
}
static void F_145 ( struct V_8 * V_9 , struct V_116 * V_337 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
V_10 -> V_1 -> V_58 . V_256 . V_188 = V_337 -> V_338 ;
V_10 -> V_1 -> V_58 . V_256 . V_88 = V_337 -> V_129 ;
F_3 ( V_10 -> V_1 , V_339 ) ;
}
static void F_146 ( struct V_8 * V_9 , struct V_116 * V_337 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
V_337 -> V_338 = V_10 -> V_1 -> V_58 . V_255 . V_188 ;
V_337 -> V_129 = V_10 -> V_1 -> V_58 . V_255 . V_88 ;
}
static void F_147 ( struct V_8 * V_9 , struct V_116 * V_337 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
V_10 -> V_1 -> V_58 . V_255 . V_188 = V_337 -> V_338 ;
V_10 -> V_1 -> V_58 . V_255 . V_88 = V_337 -> V_129 ;
F_3 ( V_10 -> V_1 , V_339 ) ;
}
...
{
T_9 V_340 = V_10 -> V_9 . V_39 . V_264 ;
T_2 * V_341 = & V_10 -> V_1 -> V_58 . V_264 ;
if ( ! V_10 -> V_9 . V_208 )
* V_341 |= V_342 ;
else
* V_341 = ( * V_341 & ~ V_342 )
...
{
unsigned long V_346 = F_155 () & V_347 ;
unsigned long V_348 = F_4 ( V_9 ) -> V_1 -> V_58 . V_268 ;
if ( V_268 & V_349 )
return 1 ;
if ( V_55 && ( ( V_348 ^ V_268 ) & V_350 ) )
F_156 ( V_9 ) ;
...
V_320 -> V_184 |= ( V_322 -> V_15 & 1 ) << V_351 ;
}
if ( V_182 == V_317 )
V_10 -> V_1 -> V_58 . V_336 = ( V_320 -> V_184 >> V_326 ) & 3 ;
F_3 ( V_10 -> V_1 , V_352 ) ;
}
...
T_2 V_402 ;
int V_65 ;
V_65 = F_198 ( V_9 -> V_279 , F_199 ( V_272 ) , & V_402 ,
...
V_97 = 0 ;
if ( F_222 ( V_10 -> V_9 . V_279 , V_426 , & V_97 , V_428 ) )
return V_420 ;
...
V_70 = 1 << ( ( 2 * ( V_42 & 0xf ) ) + V_150 ) ;
if ( V_43 == V_49 )
return V_420 ;
V_43 *= 4 ;
if ( F_222 ( V_10 -> V_9 . V_279 , V_10 -> V_17 . V_433 + V_43 , & V_363 , 4 ) )
return V_420 ;
...
static inline void F_226 ( struct V_1 * V_444 , struct V_1 * V_445 )
{
...
V_1 -> V_2 . V_450 ,
V_452 ) ;
V_451 = F_213 ( V_10 , V_10 -> V_17 . V_1 , & V_164 ) ;
if ( ! V_451 )
return 1 ;
F_228 ( & V_10 -> V_9 ) ;
V_10 -> V_17 . V_1 = 0 ;
...
V_451 -> V_58 . V_264 = F_229 ( & V_10 -> V_9 ) ;
V_451 -> V_58 . V_272 = F_137 ( & V_10 -> V_9 ) ;
V_451 -> V_58 . V_419 = V_1 -> V_58 . V_419 ;
V_451 -> V_58 . V_268 = V_10 -> V_9 . V_39 . V_268 ;
V_451 -> V_58 . V_306 = F_230 ( & V_10 -> V_9 ) ;
...
F_152 ( & V_10 -> V_9 , V_18 -> V_58 . V_264 | V_456 ) ;
...
return false ;
V_10 -> V_17 . V_148 [ V_459 ] = V_10 -> V_148 [ V_459 ] | V_363 ;
}
...
V_451 = F_213 ( V_10 , V_10 -> V_1 -> V_58 . V_454 , & V_164 ) ;
if ( ! V_451 )
return false ;
if ( ! F_237 ( V_451 ) ) {
...
F_239 ( V_10 -> V_1 -> V_58 . V_84 , V_460 ,
V_451 -> V_58 . V_84 ,
V_451 -> V_2 . V_246 ,
V_451 -> V_2 . V_90 ,
V_451 -> V_2 . V_270 ) ;
F_240 ( V_451 -> V_2 . V_19 & 0xffff ,
V_451 -> V_2 . V_19 >> 16 ,
V_451 -> V_2 . V_21 ,
V_451 -> V_2 . V_22 ) ;
F_231 ( & V_10 -> V_9 ) ;
...
F_152 ( & V_10 -> V_9 , V_451 -> V_58 . V_264 ) ;
F_154 ( & V_10 -> V_9 , V_451 -> V_58 . V_268 ) ;
if ( V_55 ) {
V_10 -> V_1 -> V_58 . V_272 = V_451 -> V_58 . V_272 ;
V_10 -> V_9 . V_39 . V_272 = V_451 -> V_58 . V_272 ;
} else
( void ) F_233 ( & V_10 -> V_9 , V_451 -> V_58 . V_272 ) ;
F_234 ( & V_10 -> V_9 ) ;
...
static void F_243 ( struct V_1 * V_445 , struct V_1 * V_463 )
{
...
{
struct V_8 * V_9 = & V_10 -> V_9 ;
F_250 ( V_10 -> V_1 -> V_58 . V_84 , V_9 -> V_39 . V_262 [ V_432 ] ,
V_9 -> V_39 . V_262 [ V_457 ] ) ;
F_251 ( V_9 , V_9 -> V_39 . V_262 [ V_457 ] ) ;
V_10 -> V_71 = F_34 ( & V_10 -> V_9 ) + 3 ;
F_31 ( & V_10 -> V_9 ) ;
return 1 ;
}
...
{
F_253 ( V_10 -> V_1 -> V_58 . V_84 , V_10 -> V_9 . V_39 . V_262 [ V_457 ] ) ;
F_175 ( & V_10 -> V_9 , V_217 ) ;
return 1 ;
}
static int F_254 ( struct V_7 * V_10 )
{
T_2 V_476 = F_255 ( & V_10 -> V_9 ) ;
T_1 V_146 = F_256 ( & V_10 -> V_9 , V_432 ) ;
if ( F_257 ( & V_10 -> V_9 , V_146 , V_476 ) == 0 ) {
V_10 -> V_71 = F_34 ( & V_10 -> V_9 ) + 3 ;
F_31 ( & V_10 -> V_9 ) ;
}
return 1 ;
...
if ( V_479 != V_496 )
V_481 = - 1 ;
if ( F_259 ( & V_10 -> V_9 , V_477 , V_481 , V_478 ,
V_79 , V_80 ) == V_498 ) {
...
if ( V_513 >= 16 ) {
V_97 = F_256 ( & V_10 -> V_9 , V_308 ) ;
F_275 ( & V_10 -> V_9 , V_513 - 16 , V_97 ) ;
} else {
V_96 = F_276 ( & V_10 -> V_9 , V_513 , & V_97 ) ;
if ( ! V_96 )
F_113 ( & V_10 -> V_9 , V_308 , V_97 ) ;
}
F_31 ( & V_10 -> V_9 ) ;
...
struct V_376 * V_376 = V_10 -> V_9 . V_377 ;
int V_142 ;
T_4 V_514 = F_273 ( & V_10 -> V_9 ) ;
V_142 = F_269 ( V_10 ) ;
if ( F_278 ( V_10 -> V_9 . V_279 ) )
return V_142 ;
if ( V_514 <= F_273 ( & V_10 -> V_9 ) )
return V_142 ;
V_376 -> V_380 = V_515 ;
return 0 ;
}
T_2 F_279 ( struct V_8 * V_9 , T_2 V_516 )
{
...
static int F_286 ( struct V_8 * V_9 , struct V_542 * V_42 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
...
L_81 , V_58 -> V_471 ) ;
F_55 ( L_63 ,
L_82 , V_58 -> V_271 , L_83 , V_58 -> V_528 ) ;
F_55 ( L_63 ,
...
static void F_303 ( struct V_8 * V_9 , T_2 * V_552 , T_2 * V_553 )
{
...
V_407 ) ;
if ( V_407 >= F_307 ( V_558 )
|| ! V_558 [ V_407 ] ) {
V_376 -> V_380 = V_559 ;
V_376 -> V_560 . V_561 = V_407 ;
return 0 ;
}
...
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
V_10 -> V_1 -> V_2 . V_90 = V_63 | V_562 ;
V_9 -> V_39 . V_40 |= V_563 ;
F_16 ( V_10 , V_505 ) ;
++ V_9 -> V_301 . V_564 ;
}
static inline void F_312 ( struct V_7 * V_10 , int V_565 )
{
struct V_11 * V_2 ;
V_2 = & V_10 -> V_1 -> V_2 ;
V_2 -> V_448 = V_565 ;
...
struct V_7 * V_10 = F_4 ( V_9 ) ;
F_72 ( ! ( F_20 ( V_10 ) ) ) ;
F_314 ( V_9 -> V_39 . V_568 . V_78 ) ;
++ V_9 -> V_301 . V_569 ;
V_10 -> V_1 -> V_2 . V_90 = V_9 -> V_39 . V_568 . V_78 |
V_63 | V_64 ;
}
static void F_315 ( struct V_8 * V_9 , int V_570 , int V_571 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
...
static void F_316 ( struct V_8 * V_9 , bool V_572 )
{
return;
}
...
static void F_318 ( struct V_8 * V_9 , T_2 * V_573 )
{
return;
}
static void F_319 ( struct V_279 * V_279 , int V_574 )
{
return;
}
...
! ( V_10 -> V_9 . V_39 . V_40 & V_563 ) ;
V_65 = V_65 && F_20 ( V_10 ) && F_212 ( V_10 ) ;
return V_65 ;
}
static bool F_322 ( struct V_8 * V_9 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
return ! ! ( V_10 -> V_9 . V_39 . V_40 & V_563 ) ;
}
static void F_323 ( struct V_8 * V_9 , bool V_575 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
if ( V_575 ) {
V_10 -> V_9 . V_39 . V_40 |= V_563 ;
...
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
if ( ( V_10 -> V_9 . V_39 . V_40 & ( V_563 | V_506 ) )
== V_563 )
return;
V_10 -> V_354 = true ;
...
return;
if ( ! F_11 ( V_10 , V_215 ) ) {
int V_578 = V_10 -> V_1 -> V_2 . V_246 & V_579 ;
F_271 ( V_9 , V_578 ) ;
}
}
...
return;
V_578 = F_273 ( V_9 ) ;
V_10 -> V_1 -> V_2 . V_246 &= ~ V_579 ;
V_10 -> V_1 -> V_2 . V_246 |= V_578 & V_579 ;
}
static void F_306 ( struct V_7 * V_10 )
{
T_4 V_580 ;
int type ;
T_1 V_581 = V_10 -> V_1 -> V_2 . V_449 ;
unsigned V_89 = V_10 -> V_89 ;
V_10 -> V_89 = 0 ;
if ( ( V_10 -> V_9 . V_39 . V_40 & V_506 )
&& F_34 ( & V_10 -> V_9 ) != V_10 -> V_507 ) {
V_10 -> V_9 . V_39 . V_40 &= ~ ( V_563 | V_506 ) ;
F_184 ( V_473 , & V_10 -> V_9 ) ;
}
V_10 -> V_9 . V_39 . V_492 = false ;
F_231 ( & V_10 -> V_9 ) ;
...
F_333 ( & V_10 -> V_9 , V_580 , V_96 ) ;
} else
F_334 ( & V_10 -> V_9 , V_580 ) ;
break;
case V_495 :
F_335 ( & V_10 -> V_9 , V_580 , false ) ;
break;
default:
break;
}
...
F_338 ( V_10 -> V_1 -> V_2 . V_407 , V_9 , V_452 ) ;
...
F_329 ( V_9 ) ;
V_10 -> V_71 = 0 ;
V_10 -> V_1 -> V_2 . V_360 = V_584 ;
if ( V_10 -> V_1 -> V_2 . V_407 == V_418 + V_216 )
V_10 -> V_370 = F_341 () ;
if ( V_55 ) {
V_9 -> V_39 . V_585 &= ~ ( 1 << V_309 ) ;
V_9 -> V_39 . V_586 &= ~ ( 1 << V_309 ) ;
}
...
static void
F_345 ( struct V_8 * V_9 , unsigned char * V_589 )
{
V_589 [ 0 ] = 0x0f ;
V_589 [ 1 ] = 0x01 ;
V_589 [ 2 ] = 0xd9 ;
}
static void F_346 ( void * V_590 )
{
* ( int * ) V_590 = 0 ;
}
...
static T_2 F_348 ( struct V_8 * V_9 , T_11 V_591 , bool V_592 )
{
return 0 ;
}
...
static void F_350 ( T_1 V_593 , struct V_594 * V_595 )
{
switch ( V_593 ) {
case 0x80000001 :
if ( V_17 )
...
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
int V_417 , V_65 = V_604 ;
struct V_605 V_606 ;
struct V_1 * V_1 = V_10 -> V_1 ;
if ( V_61 -> V_22 >= F_307 ( V_607 ) )
goto V_285;
V_606 = V_607 [ V_61 -> V_22 ] ;
if ( V_603 != V_606 . V_603 )
goto V_285;
switch ( V_606 . V_407 ) {
case V_437 :
if ( V_61 -> V_22 == V_608 )
V_606 . V_407 += V_61 -> V_609 ;
break;
case V_610 : {
...
if ( V_61 -> V_22 == V_611 )
V_606 . V_407 += V_61 -> V_609 ;
if ( V_606 . V_407 != V_610 ||
V_61 -> V_22 == V_612 )
break;
V_22 = V_10 -> V_17 . V_22 ;
if ( ! ( V_22 & ( 1ULL << V_222 ) ) )
break;
V_264 = V_9 -> V_39 . V_264 & ~ V_342 ;
V_97 = V_61 -> V_613 & ~ V_342 ;
if ( V_61 -> V_22 == V_614 ) {
V_264 &= 0xfUL ;
V_97 &= 0xfUL ;
if ( V_264 & V_456 )
...
V_1 -> V_2 . V_407 = V_606 . V_407 ;
V_417 = F_225 ( V_10 ) ;
V_65 = ( V_417 == V_420 ) ? V_631
: V_604 ;
V_285:
return V_65 ;
}
...
{
return F_360 ( & V_632 , sizeof( struct V_7 ) ,
F_361 ( struct V_7 ) , V_633 ) ;
}
