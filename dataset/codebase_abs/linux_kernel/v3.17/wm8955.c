...
static int F_38 ( struct V_168 * V_169 ,
const struct V_170 * V_171 )
{
struct V_48 * V_49 ;
int V_51 ;
V_49 = F_39 ( & V_169 -> V_2 , sizeof( struct V_48 ) ,
V_172 ) ;
if ( V_49 == NULL )
return - V_173 ;
V_49 -> V_143 = F_40 ( V_169 , & V_174 ) ;
if ( F_41 ( V_49 -> V_143 ) ) {
V_51 = F_42 ( V_49 -> V_143 ) ;
F_12 ( & V_169 -> V_2 , L_12 ,
V_51 ) ;
return V_51 ;
}
...
static int F_45 ( struct V_168 * V_177 )
{
F_46 ( & V_177 -> V_2 ) ;
return 0 ;
}
