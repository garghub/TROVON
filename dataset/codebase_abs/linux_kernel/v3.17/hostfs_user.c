...
int F_59 ( char * V_108 , char * V_109 , unsigned int V_112 )
{
int V_90 ;
#ifndef F_60
# ifdef F_61
...
#endif
#ifdef F_60
V_90 = F_63 ( F_60 , V_113 , V_108 , V_113 , V_109 , V_112 ) ;
if ( V_90 < 0 ) {
if ( V_33 != V_114 )
return - V_33 ;
else
...
int F_64 ( char * V_116 , long * V_117 , long long * V_118 ,
long long * V_119 , long long * V_120 ,
long long * V_121 , long long * V_122 ,
void * V_123 , int V_124 , long * V_125 )
{
struct V_126 V_2 ;
int V_90 ;
V_90 = V_126 ( V_116 , & V_2 ) ;
if ( V_90 < 0 )
return - V_33 ;
* V_117 = V_2 . V_127 ;
* V_118 = V_2 . V_128 ;
...
* V_121 = V_2 . V_131 ;
* V_122 = V_2 . V_132 ;
memcpy ( V_123 , & V_2 . V_133 ,
sizeof( V_2 . V_133 ) > V_124 ? V_124 :
sizeof( V_2 . V_133 ) ) ;
* V_125 = V_2 . V_134 ;
return 0 ;
}
