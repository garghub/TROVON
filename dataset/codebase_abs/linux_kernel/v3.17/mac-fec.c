...
F_2 ( V_2 , V_93 , V_94 | V_95 |
V_96 | V_97 ) ;
F_2 ( V_2 , V_4 , V_5 | V_98 ) ;
F_2 ( V_2 , V_99 , 0x01000000 ) ;
}
...
const struct V_30 * V_31 = V_9 -> V_31 ;
struct V_1 T_1 * V_2 = V_9 -> V_1 . V_2 ;
struct V_69 * V_100 = V_9 -> V_67 -> V_68 -> V_71 ;
int V_3 ;
if ( ( F_3 ( V_2 , V_4 ) & V_98 ) == 0 )
return;
F_2 ( V_2 , V_91 , 0x01 ) ;
...
V_88 :
V_86 ) ;
F_17 ( V_2 , V_4 , V_5 | V_98 ) ;
F_2 ( V_2 , V_84 , V_102 ) ;
F_2 ( V_2 , V_83 , V_100 -> V_83 ) ;
}
}
...
struct V_8 * V_9 = F_10 ( V_12 ) ;
struct V_1 T_1 * V_2 = V_9 -> V_1 . V_2 ;
F_2 ( V_2 , V_103 , 0x01000000 ) ;
}
static T_3 F_38 ( struct V_19 * V_12 )
{
struct V_8 * V_9 = F_10 ( V_12 ) ;
struct V_1 T_1 * V_2 = V_9 -> V_1 . V_2 ;
return F_3 ( V_2 , V_84 ) & F_3 ( V_2 , V_93 ) ;
}
static void F_39 ( struct V_19 * V_12 , T_3 V_104 )
{
struct V_8 * V_9 = F_10 ( V_12 ) ;
struct V_1 T_1 * V_2 = V_9 -> V_1 . V_2 ;
F_2 ( V_2 , V_84 , V_104 ) ;
}
static void F_40 ( struct V_19 * V_12 , T_3 V_104 )
{
struct V_8 * V_9 = F_10 ( V_12 ) ;
F_31 ( V_9 -> V_12 , L_3 , V_104 ) ;
}
static int F_41 ( struct V_19 * V_12 , void * V_105 , int * V_106 )
{
struct V_8 * V_9 = F_10 ( V_12 ) ;
if ( * V_106 < sizeof( struct V_1 ) )
return - V_16 ;
F_42 ( V_105 , V_9 -> V_1 . V_2 , sizeof( struct V_1 ) ) ;
return 0 ;
}
