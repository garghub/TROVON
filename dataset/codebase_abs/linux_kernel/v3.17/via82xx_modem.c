...
int V_49 ;
static unsigned int V_108 [] = { 8000 , 9600 , 12000 , 16000 } ;
...
{
struct V_5 * V_6 = F_79 ( V_2 ) ;
struct V_171 * V_40 = F_80 ( V_2 ) ;
...
static int F_88 ( struct V_121 * V_2 )
{
struct V_5 * V_6 = F_79 ( V_2 ) ;
struct V_171 * V_40 = F_80 ( V_2 ) ;
struct V_13 * V_14 = V_40 -> V_48 ;
...
static int F_97 ( struct V_177 * V_121 )
{
struct V_13 * V_14 = V_121 -> V_178 ;
return F_94 ( V_14 ) ;
}
static int F_98 ( struct V_171 * V_40 ,
struct V_5 * V_6 ,
int V_179 ,
int V_180 ,
unsigned int V_148 ,
...
struct V_13 * V_14 ;
int V_49 ;
static struct V_182 V_143 = {
. V_183 = F_97 ,
} ;
if ( ( V_49 = F_90 ( V_6 ) ) < 0 )
return V_49 ;
if ( ( V_14 = F_99 ( sizeof( * V_14 ) , V_21 ) ) == NULL ) {
F_85 ( V_6 ) ;
return - V_19 ;
}
F_100 ( & V_14 -> V_75 ) ;
...
V_14 -> V_6 = V_6 ;
V_14 -> V_69 = - 1 ;
if ( ( V_49 = F_101 ( V_6 , V_40 -> V_184 ) ) < 0 ) {
F_12 ( V_14 ) ;
F_85 ( V_6 ) ;
return V_49 ;
}
V_14 -> V_124 = F_102 ( V_6 , 0 ) ;
if ( F_103 ( V_6 -> V_69 , F_29 , V_185 ,
V_186 , V_14 ) ) {
F_7 ( V_40 -> V_2 , L_13 , V_6 -> V_69 ) ;
F_94 ( V_14 ) ;
return - V_187 ;
}
V_14 -> V_69 = V_6 -> V_69 ;
...
if ( ( V_49 = F_104 ( V_40 , V_188 , V_14 , & V_143 ) ) < 0 ) {
F_94 ( V_14 ) ;
return V_49 ;
}
F_92 ( V_6 ) ;
...
unsigned int V_9 ;
int V_49 ;
V_49 = F_106 ( & V_6 -> V_2 , V_192 , V_193 , V_194 , 0 , & V_40 ) ;
if ( V_49 < 0 )
return V_49 ;
V_191 = V_190 -> V_195 ;
switch ( V_191 ) {
case V_196 :
strcpy ( V_40 -> V_184 , L_14 ) ;
sprintf ( V_40 -> V_126 , L_15 ) ;
break;
default:
F_7 ( V_40 -> V_2 , L_16 , V_191 ) ;
V_49 = - V_25 ;
goto V_197;
}
if ( ( V_49 = F_98 ( V_40 , V_6 , V_179 , V_6 -> V_180 ,
V_148 , & V_14 ) ) < 0 )
goto V_197;
V_40 -> V_48 = V_14 ;
if ( ( V_49 = F_65 ( V_14 ) ) < 0 )
...
for ( V_9 = 0 ; V_9 < V_14 -> V_76 ; V_9 ++ )
F_25 ( V_14 , & V_14 -> V_77 [ V_9 ] ) ;
sprintf ( V_40 -> V_156 , L_17 ,
V_40 -> V_126 , V_14 -> V_124 , V_14 -> V_69 ) ;
F_69 ( V_14 ) ;
if ( ( V_49 = F_107 ( V_40 ) ) < 0 ) {
F_108 ( V_40 ) ;
return V_49 ;
}
F_109 ( V_6 , V_40 ) ;
