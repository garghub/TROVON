...
static int
F_61 ( struct V_1 * V_2 , unsigned long V_194 )
{
struct V_138 * V_138 = F_62 ( V_2 ) ;
struct V_8 * V_9 ;
F_59 ( V_2 -> V_69 , L_9 , F_63 ( V_138 ) ) ;
V_9 = F_60 ( V_2 , sizeof( * V_9 ) ) ;
if ( ! V_9 )
return - V_157 ;
