...
{
struct V_45 * V_46 = F_28 ( F_115 ( V_259 ) , V_47 ) ;
F_2 ( & V_46 -> V_54 ) ;
return F_116 ( & V_46 -> V_89 , * V_260 ) ;
}
static void * F_117 ( struct V_258 * V_261 , void * V_262 , T_2 * V_263 )
{
struct V_45 * V_46 = F_28 ( F_115 ( V_261 ) , V_47 ) ;
return F_118 ( V_262 , & V_46 -> V_89 , V_263 ) ;
}
static void F_119 ( struct V_258 * V_261 , void * V_262 )
{
struct V_45 * V_46 = F_28 ( F_115 ( V_261 ) , V_47 ) ;
F_4 ( & V_46 -> V_54 ) ;
}
static int F_120 ( struct V_258 * V_259 , void * V_262 )
{
struct V_14 * V_17 ;
struct V_45 * V_46 = F_28 ( F_115 ( V_259 ) , V_47 ) ;
if ( V_262 == & V_46 -> V_89 ) {
...
V_17 = F_122 ( V_262 , struct V_14 , V_55 ) ;
if ( V_17 -> V_28 != V_81 )
return 0 ;
F_123 () ;
F_124 ( V_259 , L_32 ,
V_17 -> V_5 -> V_2 ,
F_125 ( V_17 -> V_38 , V_264 ) ,
F_125 ( V_17 -> V_38 , V_265 ) ,
F_41 ( & V_17 -> V_27 ) ,
V_17 -> V_35 ) ;
F_126 () ;
return 0 ;
}
static int F_127 ( struct V_254 * V_254 , struct V_255 * V_255 )
{
return F_113 ( V_254 , V_255 , & V_256 ,
sizeof( struct V_257 ) ) ;
}
static void * F_128 ( struct V_258 * V_259 , T_2 * V_260 )
{
struct V_45 * V_46 = F_28 ( F_115 ( V_259 ) , V_47 ) ;
F_2 ( & V_46 -> V_54 ) ;
return F_116 ( & V_46 -> V_221 , * V_260 ) ;
}
static void * F_129 ( struct V_258 * V_261 , void * V_262 , T_2 * V_263 )
{
struct V_45 * V_46 = F_28 ( F_115 ( V_261 ) , V_47 ) ;
return F_118 ( V_262 , & V_46 -> V_221 , V_263 ) ;
}
static void F_130 ( struct V_258 * V_261 , void * V_262 )
{
struct V_45 * V_46 = F_28 ( F_115 ( V_261 ) , V_47 ) ;
F_4 ( & V_46 -> V_54 ) ;
}
static int F_131 ( struct V_258 * V_259 , void * V_262 )
{
struct V_50 * V_51 ;
struct V_14 * V_17 ;
char V_266 [ 8 ] , V_242 [ 17 ] ;
struct V_45 * V_46 = F_28 ( F_115 ( V_259 ) , V_47 ) ;
if ( V_262 == & V_46 -> V_221 ) {
F_121 ( V_259 , L_33 ) ;
return 0 ;
}
V_51 = F_122 ( V_262 , struct V_50 , V_220 ) ;
V_17 = V_51 -> V_14 ;
snprintf ( V_266 , 8 , L_34 ,
F_132 ( V_51 -> V_267 ) , F_133 ( V_51 -> V_267 ) ) ;
...
int F_135 ( struct V_43 * V_43 )
{
struct V_45 * V_46 = F_28 ( V_43 , V_47 ) ;
struct V_268 * V_261 ;
V_46 -> V_269 = F_136 ( V_43 , L_37 , V_43 -> V_270 ) ;
if ( ! V_46 -> V_269 )
goto V_23;
V_261 = F_137 ( L_38 , V_271 | V_272 ,
V_46 -> V_269 , & V_273 ) ;
if ( ! V_261 )
goto V_274;
V_261 = F_137 ( L_39 , V_271 | V_272 ,
V_46 -> V_269 , & V_275 ) ;
if ( ! V_261 )
goto V_274;
return 0 ;
V_274:
F_138 ( L_37 , V_43 -> V_270 ) ;
V_23:
return - V_21 ;
}
void F_139 ( struct V_43 * V_43 )
{
F_138 ( L_37 , V_43 -> V_270 ) ;
}
int T_3 F_140 ( void )
{
struct V_268 * V_261 ;
V_276 = F_141 ( L_40 , NULL ) ;
if ( ! V_276 )
goto V_23;
V_261 = F_142 ( L_38 , V_276 , L_41 ) ;
if ( ! V_261 )
goto V_274;
V_261 = F_142 ( L_39 , V_276 , L_42 ) ;
if ( ! V_261 )
goto V_277;
return 0 ;
V_277:
