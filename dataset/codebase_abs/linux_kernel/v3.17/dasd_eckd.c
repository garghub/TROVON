...
V_168 = F_106 ( V_283 , V_327 , V_245 ) ;
F_111 ( & V_168 -> V_348 , & V_343 ) ;
V_327 -> V_339 = V_344 ;
V_327 -> V_340 ++ ;
if ( V_327 -> V_340 > V_327 -> V_339 )
goto V_349;
...
struct V_32 * V_33 ;
V_33 = (struct V_32 * ) V_31 -> V_33 ;
V_66 = V_355 | V_356 | V_357 ;
if ( ( F_120 ( & V_307 -> V_358 ) & V_66 ) == V_66 ) {
if ( ! V_31 -> V_178 && V_33 -> V_359 &&
V_31 -> V_256 == V_257 &&
...
if ( ! V_303 )
return;
if ( ( V_303 [ 27 ] & V_360 ) && ( V_303 [ 7 ] == 0x0D ) &&
( F_120 ( & V_307 -> V_358 ) & V_361 ) ) {
F_123 ( V_31 , V_307 ) ;
return;
}
if ( ! V_168 && ! ( V_303 [ 27 ] & V_360 ) &&
( ( V_303 [ 6 ] & V_362 ) == V_362 ) ) {
F_124 ( V_31 , V_303 ) ;
return;
}
if ( V_31 -> V_178 && ( V_303 [ 27 ] & V_360 ) &&
( V_303 [ 7 ] == 0x3F ) &&
( F_120 ( & V_307 -> V_358 ) & V_361 ) &&
F_58 ( V_363 , & V_31 -> V_43 ) ) {
if ( V_31 -> V_238 & V_364 )
F_34 ( V_365 , & V_31 -> V_43 ) ;
F_39 ( V_363 , & V_31 -> V_43 ) ;
F_15 ( & V_31 -> V_2 -> V_82 ,
L_74 ) ;
}
}
...
char * V_379 ;
unsigned int V_380 ;
int V_42 , V_381 , V_299 , V_300 ;
T_6 V_146 ;
unsigned char V_48 , V_382 ;
int V_338 ;
struct V_30 * V_118 ;
V_118 = V_178 -> V_283 ;
V_33 = (struct V_32 * ) V_118 -> V_33 ;
if ( F_126 ( V_367 ) == V_383 )
V_48 = V_60 ;
else if ( F_126 ( V_367 ) == V_384 )
V_48 = V_72 ;
else
return F_108 ( - V_128 ) ;
V_42 = 0 ;
V_381 = 0 ;
F_127 (bv, req, iter) {
if ( V_378 . V_385 & ( V_121 - 1 ) )
return F_108 ( - V_128 ) ;
V_42 += V_378 . V_385 >> ( V_178 -> V_316 + 9 ) ;
#if F_77 ( V_258 )
if ( F_128 ( F_129 ( V_378 . V_386 ) , V_378 . V_385 ) )
V_381 += V_378 . V_385 >> ( V_178 -> V_316 + 9 ) ;
#endif
}
if ( V_42 != V_369 - V_368 + 1 )
return F_108 ( - V_128 ) ;
...
V_45 = V_168 -> V_171 ;
if ( V_338 ) {
if ( F_21 ( V_45 ++ , V_168 -> V_29 , V_370 ,
V_371 , V_48 , V_118 , V_119 ) == - V_230 ) {
F_46 ( V_168 , V_119 ) ;
return F_108 ( - V_230 ) ;
}
V_374 = ( unsigned long * ) ( V_168 -> V_29 +
sizeof( struct V_93 ) ) ;
} else {
if ( F_13 ( V_45 ++ , V_168 -> V_29 , V_370 ,
V_371 , V_48 , V_118 ) == - V_230 ) {
F_46 ( V_168 , V_119 ) ;
return F_108 ( - V_230 ) ;
}
V_374 = ( unsigned long * ) ( V_168 -> V_29 +
...
V_298 = (struct V_140 * ) ( V_374 + V_381 ) ;
V_146 = V_368 ;
if ( V_33 -> V_85 == 0 || V_146 > 2 * V_145 ) {
V_45 [ - 1 ] . V_43 |= V_243 ;
V_126 ( V_45 ++ , V_298 ++ , V_370 , V_372 + 1 ,
V_369 - V_146 + 1 , V_48 , V_118 , V_121 ) ;
}
F_127 (bv, req, iter) {
V_379 = F_129 ( V_378 . V_386 ) + V_378 . V_387 ;
if ( V_388 ) {
char * V_389 = F_130 ( V_388 ,
V_196 | V_390 ) ;
if ( V_389 && F_126 ( V_367 ) == V_384 )
memcpy ( V_389 + V_378 . V_387 , V_379 , V_378 . V_385 ) ;
if ( V_389 )
V_379 = V_389 + V_378 . V_387 ;
}
for ( V_380 = 0 ; V_380 < V_378 . V_385 ; V_380 += V_121 ) {
T_6 V_391 = V_146 ;
unsigned int V_392 = F_131 ( V_391 , V_145 ) ;
V_382 = V_48 ;
V_42 = V_121 ;
...
V_45 -> V_54 = V_382 ;
V_45 -> V_42 = V_42 ;
if ( F_128 ( V_379 , V_121 ) ) {
V_45 -> V_56 = ( T_1 ) ( V_173 ) V_374 ;
V_45 -> V_43 = V_393 ;
V_374 = F_132 ( V_374 , V_379 , V_121 ) ;
} else {
V_45 -> V_56 = ( T_1 ) ( V_173 ) V_379 ;
V_45 -> V_43 = 0 ;
}
V_45 ++ ;
V_379 += V_121 ;
...
struct V_377 V_378 ;
char * V_379 , * V_395 ;
unsigned int V_381 , V_299 , V_300 ;
unsigned int V_100 ;
T_6 V_146 ;
unsigned char V_48 ;
struct V_30 * V_118 ;
unsigned int V_396 , V_42 , V_397 ;
unsigned int V_398 , V_399 , V_400 , V_401 ;
unsigned char V_402 , V_403 ;
T_6 V_391 ;
unsigned int V_392 ;
V_118 = V_178 -> V_283 ;
if ( F_126 ( V_367 ) == V_383 )
...
V_299 = 1 + V_396 ;
V_300 = sizeof( struct V_93 ) +
V_381 * sizeof( unsigned long long ) ;
V_168 = F_43 ( V_176 , V_299 , V_300 ,
V_119 ) ;
if ( F_44 ( V_168 ) )
return V_168 ;
...
V_100 = V_373 + 1 ;
V_100 *= V_121 ;
if ( F_20 ( V_45 ++ , V_168 -> V_29 , V_370 ,
V_371 , V_48 , V_118 , V_119 ,
1 , V_372 + 1 ,
V_396 , V_121 ,
V_100 ) == - V_230 ) {
F_46 ( V_168 , V_119 ) ;
...
V_374 = ( unsigned long * ) ( V_168 -> V_29 + sizeof( struct V_93 ) ) ;
V_146 = V_368 ;
V_402 = 1 ;
V_403 = 0 ;
V_401 = 0 ;
...
if ( V_402 ) {
V_391 = V_146 ;
V_392 = F_131 ( V_391 , V_145 ) ;
V_397 = V_145 - V_392 ;
V_42 = F_135 ( ( V_369 - V_146 + 1 ) ,
( T_6 ) V_397 ) ;
V_401 = V_42 * V_121 ;
V_45 [ - 1 ] . V_43 |= V_243 ;
V_45 -> V_54 = V_48 ;
...
if ( ! V_395 ) {
if ( F_14 ( V_379 ) & ( V_404 - 1 ) ) {
F_46 ( V_168 , V_119 ) ;
return F_108 ( - V_405 ) ;
} else
V_395 = V_379 ;
}
if ( ( V_395 + V_398 ) != V_379 ) {
F_46 ( V_168 , V_119 ) ;
return F_108 ( - V_405 ) ;
}
V_400 = F_135 ( V_399 , V_401 ) ;
V_399 -= V_400 ;
V_379 += V_400 ;
V_398 += V_400 ;
V_401 -= V_400 ;
if ( ! ( F_14 ( V_395 + V_398 ) & ( V_404 - 1 ) ) )
V_403 = 1 ;
if ( ! V_401 ) {
V_402 = 1 ;
V_403 = 1 ;
...
static int F_136 ( struct V_406 * V_406 ,
unsigned int V_46 , unsigned int V_47 , int V_48 ,
struct V_30 * V_118 ,
struct V_30 * V_119 ,
...
V_408 = F_137 ( V_406 , V_409 , 0 ,
& V_94 , sizeof( V_94 ) , V_407 ) ;
return F_138 ( V_408 ) ;
}
...
T_8 V_421 ;
T_7 V_422 ;
unsigned int V_399 , V_400 , V_401 ;
unsigned char V_402 ;
T_6 V_146 , V_391 ;
unsigned int V_423 ;
unsigned int V_42 , V_397 ;
int V_3 ;
V_118 = V_178 -> V_283 ;
if ( F_126 ( V_367 ) == V_383 ) {
V_48 = V_113 ;
...
if ( F_126 ( V_367 ) == V_384 )
V_417 += ( V_371 - V_370 ) ;
V_421 = F_140 ( 0 , V_417 , 0 ) ;
V_168 = F_43 ( V_176 , 0 , V_421 , V_119 ) ;
if ( F_44 ( V_168 ) )
return V_168 ;
if ( V_370 == V_371 )
V_100 = V_373 - V_372 + 1 ;
...
V_100 = V_373 + 1 ;
V_100 *= V_121 ;
V_406 = F_141 ( V_168 -> V_29 , V_421 , V_420 , 0 , V_417 , 0 ) ;
if ( F_44 ( V_406 ) ) {
V_3 = - V_128 ;
goto V_194;
}
V_168 -> V_171 = F_142 ( V_406 ) ;
if ( F_136 ( V_406 , V_370 , V_371 ,
V_48 , V_118 , V_119 ,
V_372 + 1 ,
V_396 , V_121 ,
( V_369 - V_368 + 1 ) * V_121 ,
...
if ( V_145 == 0 )
return F_108 ( - V_128 ) ;
V_368 = V_370 = F_146 ( V_367 ) >> V_178 -> V_316 ;
V_372 = F_131 ( V_370 , V_145 ) ;
V_369 = V_371 =
( F_146 ( V_367 ) + F_147 ( V_367 ) - 1 ) >> V_178 -> V_316 ;
V_373 = F_131 ( V_371 , V_145 ) ;
V_432 = ( V_33 -> V_85 && V_368 < 2 * V_145 ) ;
V_431 = V_33 -> V_238 . V_267 [ 40 ] & 0x20 ;
V_433 = F_148 ( V_367 ) ;
if ( V_433 % V_121 )
return F_108 ( - V_128 ) ;
if ( F_126 ( V_367 ) == V_384 )
V_433 += ( V_371 - V_370 ) * 4 ;
V_429 = V_33 -> V_238 . V_267 [ 9 ] & 0x20 ;
V_430 = V_33 -> V_238 . V_267 [ 12 ] & 0x40 ;
V_338 = V_33 -> V_238 . V_267 [ 8 ] & 0x01 ;
V_168 = NULL ;
if ( V_432 || V_388 ) {
} else if ( ( V_433 <= V_33 -> V_219 )
&& ( V_431 || ( V_370 == V_371 ) ) ) {
V_168 = F_139 ( V_119 , V_178 , V_367 ,
V_368 , V_369 ,
V_370 , V_371 ,
V_372 , V_373 ,
V_145 , V_121 ) ;
...
( ( ( F_126 ( V_367 ) == V_383 ) && V_429 ) ||
( ( F_126 ( V_367 ) == V_384 ) && V_430 ) ) ) {
V_168 = F_134 ( V_119 , V_178 , V_367 ,
V_368 , V_369 ,
V_370 , V_371 ,
V_372 , V_373 ,
V_145 , V_121 ) ;
...
unsigned char V_48 ;
unsigned int V_396 ;
unsigned int V_399 , V_401 ;
unsigned int V_372 ;
unsigned int V_381 , V_299 , V_300 ;
T_6 V_370 , V_371 , V_324 ;
T_6 V_434 , V_435 , V_436 ;
unsigned int V_437 ;
V_434 = F_146 ( V_367 ) % V_438 ;
V_435 = ( F_146 ( V_367 ) + F_147 ( V_367 ) ) %
V_438 ;
V_436 = ( V_438 - V_435 ) %
V_438 ;
V_118 = V_178 -> V_283 ;
...
V_370 = F_146 ( V_367 ) / V_438 ;
V_371 = ( F_146 ( V_367 ) + F_147 ( V_367 ) - 1 ) /
V_438 ;
V_396 = V_371 - V_370 + 1 ;
V_372 = 0 ;
if ( F_126 ( V_367 ) == V_383 )
...
V_381 = V_396 * V_315 ;
V_299 = 1 + V_396 ;
V_437 = sizeof( struct V_93 ) + 8 ;
V_300 = V_437 + V_381 * sizeof( unsigned long long ) ;
V_168 = F_43 ( V_176 , V_299 ,
V_300 , V_119 ) ;
if ( F_44 ( V_168 ) )
goto V_439;
V_45 = V_168 -> V_171 ;
if ( F_20 ( V_45 ++ , V_168 -> V_29 , V_370 , V_371 , V_48 ,
V_118 , V_119 , 1 , V_372 + 1 ,
V_396 , 0 , 0 ) == - V_230 ) {
F_46 ( V_168 , V_119 ) ;
V_168 = F_108 ( - V_230 ) ;
goto V_439;
}
V_374 = ( unsigned long * ) ( V_168 -> V_29 + V_437 ) ;
V_401 = 0 ;
if ( V_434 ) {
V_45 [ - 1 ] . V_43 |= V_243 ;
V_45 -> V_54 = V_48 ;
V_45 -> V_42 = 57326 ;
V_401 = 65536 - V_434 * 512 ;
V_45 -> V_56 = ( T_1 ) ( V_173 ) V_374 ;
V_45 -> V_43 |= V_393 ;
V_45 -> V_43 |= V_44 ;
V_45 ++ ;
for ( V_324 = 0 ; V_324 < V_434 ; V_324 += 8 )
V_374 = F_132 ( V_374 , V_440 , V_441 ) ;
}
F_127 (bv, req, iter) {
V_379 = F_129 ( V_378 . V_386 ) + V_378 . V_387 ;
V_399 = V_378 . V_385 ;
if ( V_48 == V_112 )
memset ( V_379 , 0 , V_399 ) ;
if ( ! V_401 ) {
V_45 [ - 1 ] . V_43 |= V_243 ;
V_45 -> V_54 = V_48 ;
V_45 -> V_42 = 57326 ;
...
V_401 -= V_399 ;
V_374 = F_132 ( V_374 , V_379 , V_399 ) ;
}
for ( V_324 = 0 ; V_324 < V_436 ; V_324 += 8 )
V_374 = F_132 ( V_374 , V_440 , V_441 ) ;
if ( F_133 ( V_367 ) ||
V_178 -> V_283 -> V_238 & V_394 )
F_34 ( V_254 , & V_168 -> V_43 ) ;
...
static int
F_150 ( struct V_167 * V_168 , struct V_366 * V_367 )
{
struct V_32 * V_33 ;
struct V_26 * V_45 ;
struct V_375 V_376 ;
struct V_377 V_378 ;
char * V_379 , * V_56 ;
unsigned int V_121 , V_145 , V_380 ;
T_6 V_146 ;
int V_183 ;
if ( ! V_388 )
goto V_439;
...
V_145 = F_9 ( & V_33 -> V_35 , 0 , V_121 ) ;
V_146 = F_146 ( V_367 ) >> V_168 -> V_178 -> V_316 ;
V_45 = V_168 -> V_171 ;
V_45 ++ ;
if ( V_33 -> V_85 == 0 || V_146 > 2 * V_145 )
V_45 ++ ;
...
if ( V_379 != V_56 ) {
if ( F_126 ( V_367 ) == V_383 )
memcpy ( V_379 , V_56 , V_378 . V_385 ) ;
F_151 ( V_388 ,
( void * ) ( ( V_173 ) V_56 & V_442 ) ) ;
}
V_379 = NULL ;
}
V_45 ++ ;
...
V_443 = V_168 -> V_171 ;
V_444 = F_152 ( V_443 ) ;
V_408 = (struct V_408 * ) & V_444 -> V_445 [ 0 ] ;
V_94 = (struct V_93 * ) & V_408 -> V_446 [ 0 ] ;
V_94 -> V_95 . V_136 = 0 ;
V_94 -> V_95 . V_138 = 0 ;
} else {
V_45 = V_168 -> V_171 ;
...
V_168 = F_149 ( V_119 , V_178 , V_367 ) ;
else
V_168 = F_145 ( V_119 , V_178 , V_367 ) ;
if ( F_44 ( V_168 ) )
V_33 -> V_42 -- ;
...
V_33 = (struct V_32 * ) V_31 -> V_33 ;
V_450 -> V_451 = 2 ;
V_450 -> V_452 = V_33 -> V_85 ? 0 : 1 ;
V_450 -> V_120 = V_33 -> V_85 ? V_453 : V_454 ;
V_450 -> V_455 = sizeof( struct V_14 ) ;
memcpy ( V_450 -> V_456 , & V_33 -> V_35 ,
sizeof( struct V_14 ) ) ;
V_450 -> V_457 = F_135 ( ( unsigned long ) V_33 -> V_200 ,
sizeof( V_450 -> V_458 ) ) ;
memcpy ( V_450 -> V_458 , V_33 -> V_201 ,
V_450 -> V_457 ) ;
return 0 ;
}
static int
...
memset ( & V_462 -> V_45 , 0 ,
sizeof( V_462 -> V_45 ) ) ;
V_168 -> V_171 = & V_462 -> V_45 ;
V_168 -> V_29 = & V_462 -> V_29 ;
V_168 -> V_175 = V_176 ;
}
V_45 = V_168 -> V_171 ;
V_45 -> V_54 = V_463 ;
...
if ( ! F_157 ( V_460 ) )
return - V_41 ;
if ( F_162 ( & V_468 , V_466 , sizeof( V_468 ) ) )
return - V_469 ;
V_459 = 0 ;
V_168 = F_43 ( V_176 , 1 ,
sizeof( struct V_470 ) , V_31 ) ;
if ( F_44 ( V_168 ) ) {
F_158 ( & V_461 ) ;
V_459 = 1 ;
V_168 = & V_462 -> V_168 ;
...
V_168 -> V_182 = F_33 () ;
V_168 -> V_183 = V_184 ;
V_168 -> V_170 = V_468 . V_472 ;
V_34 = F_40 ( V_168 ) ;
if ( ! V_34 && V_468 . V_472 && ( V_168 -> V_170 != V_468 . V_472 ) )
V_34 = - V_272 ;
if ( ! V_34 ) {
V_468 . V_29 = * ( (struct V_470 * ) V_168 -> V_29 ) ;
if ( F_163 ( V_466 , & V_468 , sizeof( V_468 ) ) )
V_34 = - V_469 ;
}
if ( V_459 )
F_62 ( & V_461 ) ;
...
static int
F_164 ( struct V_30 * V_31 , void T_9 * V_466 )
{
struct V_235 * V_236 ;
struct V_473 * V_474 ;
struct V_167 * V_168 ;
...
V_45 -> V_43 |= V_243 ;
V_45 -> V_56 = ( T_1 ) ( V_173 ) V_236 ;
V_474 = (struct V_473 * ) ( V_236 + 1 ) ;
memset ( V_474 , 0 , sizeof( struct V_473 ) ) ;
V_45 ++ ;
V_45 -> V_54 = V_244 ;
V_45 -> V_42 = sizeof( struct V_473 ) ;
V_45 -> V_56 = ( T_1 ) ( V_173 ) V_474 ;
V_168 -> V_182 = F_33 () ;
V_168 -> V_183 = V_184 ;
V_34 = F_45 ( V_168 ) ;
if ( V_34 == 0 ) {
...
static int
F_165 ( struct V_30 * V_31 , void T_9 * V_466 )
{
struct V_32 * V_33 =
(struct V_32 * ) V_31 -> V_33 ;
struct V_476 V_70 = V_33 -> V_70 ;
int V_34 ;
if ( ! F_157 ( V_460 ) )
return - V_41 ;
if ( ! V_466 )
return - V_128 ;
V_34 = 0 ;
if ( F_163 ( V_466 , ( long * ) & V_70 ,
sizeof( struct V_476 ) ) )
V_34 = - V_469 ;
return V_34 ;
}
static int
F_166 ( struct V_30 * V_31 , void T_9 * V_466 )
{
struct V_32 * V_33 =
(struct V_32 * ) V_31 -> V_33 ;
struct V_476 V_70 ;
...
if ( ! V_466 )
return - V_128 ;
if ( F_162 ( & V_70 , V_466 , sizeof( struct V_476 ) ) )
return - V_469 ;
V_33 -> V_70 = V_70 ;
F_81 ( & V_31 -> V_2 -> V_82 ,
L_78 ,
...
static int F_167 ( struct V_30 * V_31 , void T_9 * V_466 )
{
struct V_477 V_468 ;
char * V_478 , * V_479 ;
struct V_167 * V_168 ;
...
if ( ( V_468 . V_479 >> 32 ) != 0 )
goto V_439;
V_468 . V_478 &= 0x7fffffffULL ;
V_468 . V_479 &= 0x7fffffffULL ;
}
V_478 = F_42 ( V_468 . V_483 , V_195 | V_196 ) ;
V_479 = F_42 ( V_468 . V_484 , V_195 | V_196 ) ;
if ( ! V_478 || ! V_479 ) {
V_34 = - V_197 ;
goto V_485;
}
V_34 = - V_469 ;
if ( F_162 ( V_478 ,
( void T_9 * ) ( unsigned long ) V_468 . V_478 ,
V_468 . V_483 ) )
goto V_485;
V_480 = V_478 [ 0 ] ;
V_481 = V_478 [ 1 ] ;
...
V_45 = V_168 -> V_171 ;
V_45 -> V_54 = V_242 ;
V_45 -> V_42 = V_468 . V_483 ;
V_45 -> V_43 |= V_243 ;
V_45 -> V_56 = ( T_1 ) ( V_173 ) V_478 ;
V_45 ++ ;
V_45 -> V_54 = V_244 ;
V_45 -> V_42 = V_468 . V_484 ;
V_45 -> V_43 = V_44 ;
V_45 -> V_56 = ( T_1 ) ( V_173 ) V_479 ;
V_34 = F_45 ( V_168 ) ;
if ( V_34 )
goto V_486;
V_34 = - V_469 ;
if ( F_163 ( ( void T_9 * ) ( unsigned long ) V_468 . V_479 ,
V_479 , V_468 . V_484 ) )
goto V_486;
V_34 = 0 ;
V_486:
...
F_18 ( V_7 , V_31 ,
L_79 ,
( int ) V_480 , ( int ) V_481 , V_34 ) ;
return V_34 ;
}
static int
F_169 ( struct V_268 * V_178 , unsigned int V_48 , void T_9 * V_466 )
{
struct V_30 * V_31 = V_178 -> V_283 ;
switch ( V_48 ) {
case V_487 :
return F_165 ( V_31 , V_466 ) ;
case V_488 :
return F_166 ( V_31 , V_466 ) ;
case V_489 :
return F_164 ( V_31 , V_466 ) ;
case V_490 :
return F_156 ( V_31 ) ;
case V_491 :
return F_159 ( V_31 ) ;
...
return F_160 ( V_31 ) ;
case V_493 :
return F_161 ( V_31 , V_466 ) ;
case V_494 :
return F_167 ( V_31 , V_466 ) ;
default:
return - V_495 ;
}
}
static int
F_170 ( struct V_26 * V_496 , struct V_26 * V_497 , char * V_498 )
{
int V_499 , V_42 ;
char * V_500 ;
V_499 = 0 ;
while ( V_496 <= V_497 ) {
V_499 += sprintf ( V_498 + V_499 , V_501
L_80 ,
V_496 , ( ( int * ) V_496 ) [ 0 ] , ( ( int * ) V_496 ) [ 1 ] ) ;
if ( V_496 -> V_43 & V_393 )
V_500 = ( char * ) * ( ( V_173 * ) ( V_173 ) V_496 -> V_56 ) ;
else
V_500 = ( char * ) ( ( V_173 ) V_496 -> V_56 ) ;
for ( V_42 = 0 ; V_42 < V_496 -> V_42 && V_42 < 32 ; V_42 ++ ) {
if ( V_42 % 8 == 0 ) V_499 += sprintf ( V_498 + V_499 , L_81 ) ;
if ( V_42 % 4 == 0 ) V_499 += sprintf ( V_498 + V_499 , L_81 ) ;
V_499 += sprintf ( V_498 + V_499 , L_11 , V_500 [ V_42 ] ) ;
}
V_499 += sprintf ( V_498 + V_499 , L_82 ) ;
V_496 ++ ;
}
return V_499 ;
}
...
V_503 = ( T_10 * ) & V_307 -> V_358 ;
if ( V_303 ) {
F_18 ( V_504 , V_31 , L_83
L_84 ,
V_502 , * V_503 , * ( ( T_3 * ) ( V_503 + 1 ) ) ,
V_303 [ 0 ] , V_303 [ 1 ] , V_303 [ 2 ] , V_303 [ 3 ] ) ;
} else {
F_18 ( V_504 , V_31 , L_85 ,
V_502 , * V_503 , * ( ( T_3 * ) ( V_503 + 1 ) ) ,
L_86 ) ;
}
}
static void F_172 ( struct V_30 * V_31 ,
struct V_167 * V_367 , struct V_307 * V_307 )
{
char * V_498 ;
struct V_26 * V_505 , * V_506 , * V_507 , * V_496 , * V_497 ;
int V_499 , V_508 , V_509 ;
V_498 = ( char * ) F_173 ( V_233 ) ;
if ( V_498 == NULL ) {
F_18 ( V_7 , V_31 , L_1 ,
L_87 ) ;
return;
}
V_499 = sprintf ( V_498 , V_501
L_88 ,
F_174 ( & V_31 -> V_2 -> V_82 ) ) ;
V_499 += sprintf ( V_498 + V_499 , V_501
L_89
L_90 ,
V_367 , F_175 ( & V_307 -> V_358 ) , F_176 ( & V_307 -> V_358 ) ,
F_177 ( & V_307 -> V_358 ) , F_178 ( & V_307 -> V_358 ) ,
F_120 ( & V_307 -> V_358 ) , F_179 ( & V_307 -> V_358 ) ,
V_367 ? V_367 -> V_250 : 0 ) ;
V_499 += sprintf ( V_498 + V_499 , V_501
L_91 ,
F_174 ( & V_31 -> V_2 -> V_82 ) ,
( void * ) ( V_173 ) V_307 -> V_358 . V_48 . V_510 ) ;
if ( V_307 -> V_511 . V_512 . V_513 . V_514 ) {
for ( V_508 = 0 ; V_508 < 4 ; V_508 ++ ) {
V_499 += sprintf ( V_498 + V_499 , V_501
L_92 ,
( 8 * V_508 ) , ( ( 8 * V_508 ) + 7 ) ) ;
for ( V_509 = 0 ; V_509 < 8 ; V_509 ++ ) {
V_499 += sprintf ( V_498 + V_499 , L_93 ,
V_307 -> V_515 [ 8 * V_508 + V_509 ] ) ;
}
V_499 += sprintf ( V_498 + V_499 , L_82 ) ;
}
if ( V_307 -> V_515 [ 27 ] & V_360 ) {
sprintf ( V_498 + V_499 , V_501
L_94
L_95 ,
V_307 -> V_515 [ 7 ] >> 4 , V_307 -> V_515 [ 7 ] & 0x0f ,
V_307 -> V_515 [ 1 ] & 0x10 ? L_59 : L_96 ) ;
} else {
sprintf ( V_498 + V_499 , V_501
L_97
L_98 ,
V_307 -> V_515 [ 6 ] & 0x0f , V_307 -> V_515 [ 22 ] >> 4 ) ;
}
} else {
sprintf ( V_498 + V_499 , V_501
L_99 ) ;
}
F_180 ( V_516 L_1 , V_498 ) ;
if ( V_367 ) {
V_505 = V_367 -> V_171 ;
for ( V_506 = V_505 ; V_506 -> V_43 & ( V_243 | V_517 ) ; V_506 ++ ) ;
V_497 = F_135 ( V_505 + 6 , V_506 ) ;
V_499 = sprintf ( V_498 , V_501
L_100 , V_367 ) ;
F_170 ( V_505 , V_497 , V_498 + V_499 ) ;
F_180 ( V_516 L_1 , V_498 ) ;
V_499 = 0 ;
V_496 = ++ V_497 ;
V_507 = (struct V_26 * ) ( V_173 )
V_307 -> V_358 . V_48 . V_510 ;
if ( V_496 < V_507 - 2 ) {
V_496 = V_507 - 2 ;
V_499 += sprintf ( V_498 , V_501 L_101 ) ;
}
V_497 = F_135 ( V_507 + 1 , V_506 ) ;
V_499 += F_170 ( V_496 , V_497 , V_498 + V_499 ) ;
V_496 = F_181 ( V_496 , ++ V_497 ) ;
if ( V_496 < V_506 - 1 ) {
V_496 = V_506 - 1 ;
V_499 += sprintf ( V_498 + V_499 , V_501 L_101 ) ;
}
V_499 += F_170 ( V_496 , V_506 , V_498 + V_499 ) ;
if ( V_499 > 0 )
F_180 ( V_516 L_1 , V_498 ) ;
}
F_182 ( ( unsigned long ) V_498 ) ;
}
static void F_183 ( struct V_30 * V_31 ,
struct V_167 * V_367 , struct V_307 * V_307 )
{
char * V_498 ;
int V_499 , V_508 , V_509 , V_518 ;
struct V_519 * V_519 ;
T_7 * V_303 , * V_520 ;
V_498 = ( char * ) F_173 ( V_233 ) ;
if ( V_498 == NULL ) {
...
F_177 ( & V_307 -> V_358 ) , F_178 ( & V_307 -> V_358 ) ,
F_120 ( & V_307 -> V_358 ) , F_179 ( & V_307 -> V_358 ) ,
V_307 -> V_358 . V_521 . V_522 , V_307 -> V_358 . V_521 . V_523 ,
V_367 ? V_367 -> V_250 : 0 ) ;
V_499 += sprintf ( V_498 + V_499 , V_501
L_105 ,
F_174 ( & V_31 -> V_2 -> V_82 ) ,
( void * ) ( V_173 ) V_307 -> V_358 . V_521 . V_443 ) ;
V_519 = NULL ;
V_303 = NULL ;
if ( V_307 -> V_358 . V_521 . V_443 && ( V_307 -> V_358 . V_521 . V_522 & 0x01 ) )
V_519 = F_184 (
(struct V_443 * ) ( unsigned long ) V_307 -> V_358 . V_521 . V_443 ) ;
if ( V_519 ) {
V_499 += sprintf ( V_498 + V_499 , V_501
L_106 , V_519 -> V_106 ) ;
V_499 += sprintf ( V_498 + V_499 , V_501
...
V_499 += sprintf ( V_498 + V_499 , V_501
L_110 , V_518 ) ;
switch ( V_519 -> V_43 & 0x07 ) {
case 1 :
V_499 += sprintf ( V_498 + V_499 , V_501
L_111 ,
V_519 -> V_525 . V_526 . V_527 ) ;
V_499 += sprintf ( V_498 + V_499 , V_501
L_112 ,
V_519 -> V_525 . V_526 . V_528 ) ;
V_499 += sprintf ( V_498 + V_499 , V_501
L_113 ,
V_519 -> V_525 . V_526 . V_529 ) ;
V_499 += sprintf ( V_498 + V_499 , V_501
L_114 ,
V_519 -> V_525 . V_526 . V_530 ) ;
V_499 += sprintf ( V_498 + V_499 , V_501
L_115 ,
V_519 -> V_525 . V_526 . V_531 ) ;
V_303 = V_519 -> V_525 . V_526 . V_303 ;
break;
case 2 :
V_499 += sprintf ( V_498 + V_499 , V_501
L_116 , V_519 -> V_525 . V_532 . V_34 ) ;
for ( V_508 = 0 ; V_508 < 2 ; V_508 ++ ) {
V_499 += sprintf ( V_498 + V_499 , V_501
L_117 ,
( 8 * V_508 ) , ( ( 8 * V_508 ) + 7 ) ) ;
V_520 = V_519 -> V_525 . V_532 . V_520 ;
for ( V_509 = 0 ; V_509 < 8 ; V_509 ++ ) {
V_499 += sprintf ( V_498 + V_499 , L_93 ,
V_520 [ 8 * V_508 + V_509 ] ) ;
}
...
struct V_167 * V_367 , struct V_307 * V_307 )
{
if ( F_186 ( & V_307 -> V_358 ) )
F_183 ( V_31 , V_367 , V_307 ) ;
else
F_172 ( V_31 , V_367 , V_307 ) ;
}
...
F_27 ( F_28 ( V_31 -> V_2 ) , V_43 ) ;
memcpy ( & V_33 -> V_35 , & V_533 , sizeof( V_533 ) ) ;
F_29 ( F_28 ( V_31 -> V_2 ) , V_43 ) ;
F_100 ( V_31 ) ;
return 0 ;
V_535:
