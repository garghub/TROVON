...
V_33 = 1 ;
if ( F_12 ( V_32 -> V_35 , 1 , V_33 , F_13 ( & V_32 -> V_32 ) ) )
return - V_36 ;
if ( F_14 ( V_32 -> V_35 , V_37 ) < 0 )
return - V_36 ;
return 0 ;
}
static void F_15 ( struct V_31 * V_32 )
{
if ( ! F_16 ( & V_32 -> V_32 ) && V_32 -> V_35 > 0 )
F_17 ( V_32 -> V_35 ) ;
}
int T_2 F_18 ( void )
{
...
if ( ! V_42 )
return;
if ( F_6 ( V_32 -> V_2 -> V_10 , V_32 -> V_3 , V_43 ) )
return;
V_32 -> V_44 = 0 ;
}
...
F_25 ( V_32 , V_16 + 8 + ( V_46 * 4 ) , & V_17 ) ;
V_32 -> V_49 [ V_46 ] . V_50 = V_32 -> V_49 [ V_46 ] . V_51 + V_17 - 1 ;
V_32 -> V_49 [ V_46 ] . V_52 |= V_53 ;
}
}
