...
struct V_150 * V_151 = V_110 -> V_114 . V_104 ;
struct V_159 * V_160 = V_151 -> V_152 -> V_161 ;
T_6 V_162 = V_102 / V_117 ;
struct V_99 * V_99 ;
T_3 V_163 = F_53 ( V_151 -> V_152 ) ;
if ( V_102 >= V_163 ) {
* V_158 = true ;
F_3 ( L_13 , V_6 , V_162 ) ;
return F_54 ( 0 ) ;
}
V_99 = F_55 ( V_160 , V_162 ) ;
if ( ! V_99 ) {
V_99 = F_56 ( V_160 , V_162 , V_164 ) ;
if ( F_16 ( ! V_99 ) ) {
F_3 ( L_14 ,
V_6 , V_162 ) ;
return NULL ;
...
* V_158 = F_60 ( V_99 ) ;
F_3 ( L_15 , V_6 , V_162 , * V_158 ) ;
return V_99 ;
}
static void F_61 ( void * V_157 , struct V_99 * V_99 )
{
F_3 ( L_16 , V_6 ,
( V_99 == F_54 ( 0 ) ) ? - 1UL : V_99 -> V_162 ) ;
if ( F_54 ( 0 ) != V_99 )
F_62 ( V_99 ) ;
return;
}
int F_63 ( struct V_150 * V_151 , int V_165 )
{
struct V_105 * V_110 ;
int V_108 ;
V_108 = F_35 ( F_48 ( V_151 -> V_152 ) -> V_77 , false ,
V_151 -> V_19 , V_151 -> args . V_100 , V_151 -> args . V_101 ,
V_151 -> args . V_102 , V_151 -> args . V_103 , V_151 , V_164 ,
& V_110 ) ;
if ( F_16 ( V_108 ) )
return V_108 ;
V_110 -> V_119 = 0 != ( V_165 & V_166 ) ;
V_110 -> V_107 -> V_167 = & V_168 ;
if ( ! V_110 -> V_119 )
...
static T_2 F_65 ( struct V_169 * V_170 ,
struct V_171 * V_172 , struct V_171 * V_173 )
{
unsigned int V_174 ;
V_174 = F_66 ( V_170 , V_172 , V_173 ) ;
if ( ! V_174 || V_170 -> V_175 + V_173 -> V_176 >
( unsigned long ) V_170 -> V_177 )
return 0 ;
return F_67 ( V_174 , V_173 -> V_176 ) ;
}
static void F_68 ( struct V_169 * V_170 , struct V_171 * V_173 )
{
F_69 ( V_170 , V_173 ) ;
if ( F_16 ( V_170 -> V_178 == NULL ) )
return;
V_170 -> V_177 = ( void * )
F_12 ( V_170 -> V_178 ) -> V_77 . V_179 ;
}
static bool F_70 ( T_4 V_102 , struct V_180 * V_77 ,
unsigned long * V_181 )
{
T_7 V_182 ;
unsigned V_183 ;
...
return true ;
V_183 = V_77 -> V_80 *
( V_77 -> V_83 - V_77 -> V_185 ) ;
F_71 ( V_102 , V_183 , & V_182 ) ;
if ( ! V_182 )
return true ;
* V_181 = V_183 - V_182 ;
return false ;
}
static void F_72 ( struct V_169 * V_170 , struct V_171 * V_173 )
{
unsigned long V_181 = 0 ;
T_4 V_186 ;
if ( V_170 -> V_187 == NULL )
V_186 = F_53 ( V_170 -> V_188 ) - F_73 ( V_173 ) ;
else
V_186 = F_74 ( V_170 -> V_187 ) ;
F_75 ( V_170 , V_173 , V_186 ) ;
if ( F_16 ( V_170 -> V_178 == NULL ) )
return;
if ( V_173 -> V_189 ||
! F_70 ( V_173 -> V_190 * V_117 ,
& F_12 ( V_170 -> V_178 ) -> V_77 ,
& V_181 ) ) {
V_170 -> V_177 = ( void * ) V_181 ;
} else {
V_170 -> V_177 = ( void * )
F_12 ( V_170 -> V_178 ) -> V_77 . V_179 ;
}
