...
static inline T_1 * F_3 ( struct V_1 * V_1 )
{
return & V_1 -> V_5 -> V_6 -> V_7 [ V_1 -> V_8 ] ;
}
static inline T_2 F_4 ( struct V_9 * V_10 , void * V_11 ,
T_3 V_12 , int V_13 )
{
T_2 V_14 = F_5 ( V_10 , V_11 , V_12 , V_13 ) ;
...
while ( 1 ) {
T_5 * V_31 = & F_3 ( V_1 ) -> V_32 [ V_1 -> V_33 ] ;
struct V_34 * V_35 = V_1 -> V_36 [ V_1 -> V_33 ] ;
switch ( V_31 -> V_37 ) {
case V_38 :
case V_39 :
F_13 ( V_3 ) ;
...
default:
V_3 -> V_41 . V_44 ++ ;
V_3 -> V_41 . V_45 += V_35 -> V_46 ;
}
V_31 -> V_37 = V_39 ;
F_14 ( V_1 -> V_5 -> V_10 , V_31 -> V_47 , V_35 -> V_46 ,
V_48 ) ;
F_15 ( V_35 ) ;
V_1 -> V_33 = ( V_1 -> V_33 + 1 ) % V_49 ;
}
}
static inline void F_16 ( struct V_5 * V_5 )
{
T_5 * V_31 ;
...
struct V_1 * V_1 = & V_5 -> V_55 [ V_31 -> V_37 &
V_52 ] ;
struct V_2 * V_3 = V_1 -> V_3 ;
if ( ! V_35 )
V_3 -> V_41 . V_56 ++ ;
...
F_17 ( V_35 , V_31 -> V_59 ) ;
#ifdef F_18
F_19 ( V_60 L_19 , V_3 -> V_61 ,
V_35 -> V_46 ) ;
F_20 ( V_35 ) ;
#endif
V_3 -> V_41 . V_62 ++ ;
V_3 -> V_41 . V_63 += V_35 -> V_46 ;
V_35 -> V_64 = F_21 ( V_35 , V_3 ) ;
F_22 ( V_35 ) ;
V_35 = NULL ;
}
if ( ! V_35 ) {
...
static T_6 F_24 ( int V_67 , void * V_68 )
{
struct V_5 * V_5 = V_68 ;
int V_69 ;
T_4 V_37 ;
...
static T_7 F_28 ( struct V_34 * V_35 , struct V_2 * V_3 )
{
struct V_1 * V_1 = F_1 ( V_3 ) ;
T_5 * V_31 ;
F_29 ( & V_1 -> V_76 ) ;
V_31 = & F_3 ( V_1 ) -> V_32 [ V_1 -> V_77 ] ;
if ( V_31 -> V_37 != V_39 ) {
#ifdef F_18
F_19 ( V_60 L_20 , V_3 -> V_61 ) ;
#endif
F_30 ( V_3 ) ;
F_31 ( & V_1 -> V_76 ) ;
return V_78 ;
...
#ifdef F_18
F_19 ( V_60 L_21 , V_3 -> V_61 , V_35 -> V_46 ) ;
F_20 ( V_35 ) ;
#endif
V_1 -> V_36 [ V_1 -> V_77 ] = V_35 ;
V_31 -> V_47 = F_5 ( V_1 -> V_5 -> V_10 , V_35 -> V_65 , V_35 -> V_46 ,
V_48 ) ;
V_31 -> V_59 = V_35 -> V_46 ;
V_31 -> V_37 = V_38 ;
F_26 ( 1 << ( V_79 + V_1 -> V_8 ) ,
V_1 -> V_5 -> V_71 + V_80 ) ;
V_1 -> V_77 = ( V_1 -> V_77 + 1 ) % V_49 ;
if ( F_3 ( V_1 ) -> V_32 [ V_1 -> V_77 ] . V_37 != V_39 ) {
F_30 ( V_3 ) ;
#ifdef F_18
F_19 ( V_60 L_20 , V_3 -> V_61 ) ;
#endif
...
static int F_32 ( struct V_2 * V_3 , unsigned short V_82 ,
unsigned short V_83 )
{
struct V_1 * V_1 = F_1 ( V_3 ) ;
if ( V_82 != V_84 &&
...
static int F_33 ( struct V_2 * V_3 , struct V_92 * V_93 , int V_94 )
{
const T_3 V_12 = sizeof( V_95 ) ;
V_95 line ;
struct V_1 * V_1 = F_1 ( V_3 ) ;
if ( V_94 != V_96 )
return F_34 ( V_3 , V_93 , V_94 ) ;
...
{
struct V_1 * V_1 = F_1 ( V_3 ) ;
T_8 T_9 * V_115 = V_1 -> V_5 -> V_71 + V_80 ;
unsigned long V_116 ;
int V_69 ;
if ( F_3 ( V_1 ) -> V_117 ) {
F_39 ( V_3 , L_22 ) ;
...
F_3 ( V_1 ) -> V_32 [ V_69 ] . V_37 = V_39 ;
F_26 ( 1 << ( V_119 + V_1 -> V_8 ) , V_115 ) ;
V_116 = V_120 + V_121 ;
do {
if ( F_3 ( V_1 ) -> V_117 ) {
F_41 ( V_3 ) ;
...
F_30 ( V_3 ) ;
for ( V_69 = 0 ; V_69 < V_49 ; V_69 ++ ) {
T_5 * V_31 = & F_3 ( V_1 ) -> V_32 [ V_69 ] ;
if ( V_31 -> V_37 != V_39 ) {
V_31 -> V_37 = V_39 ;
F_14 ( V_1 -> V_5 -> V_10 , V_31 -> V_47 ,
V_1 -> V_36 [ V_69 ] -> V_46 ,
V_48 ) ;
F_45 ( V_1 -> V_36 [ V_69 ] ) ;
}
...
static struct V_123 * F_46 ( struct V_2 * V_3 )
{
struct V_1 * V_1 = F_1 ( V_3 ) ;
V_3 -> V_41 . V_124 = F_3 ( V_1 ) -> V_125 ;
V_3 -> V_41 . V_126 = F_3 ( V_1 ) -> V_126 ;
V_3 -> V_41 . V_127 = V_3 -> V_41 . V_124 +
V_3 -> V_41 . V_126 ;
return & V_3 -> V_41 ;
}
static int F_47 ( struct V_5 * V_5 , T_4 V_94 )
{
...
{
T_4 V_129 = F_25 ( V_5 -> V_71 + V_130 ) & ~ V_131 ;
...
{
struct V_5 * V_5 = F_52 ( V_10 ) ;
int V_69 ;
for ( V_69 = 0 ; V_69 < V_5 -> V_53 ; V_69 ++ ) {
F_53 ( V_5 -> V_55 [ V_69 ] . V_3 ) ;
F_54 ( V_5 -> V_55 [ V_69 ] . V_3 ) ;
}
if ( V_5 -> V_67 )
F_55 ( V_5 -> V_67 , V_5 ) ;
F_49 ( V_5 ) ;
...
V_141 = sizeof( struct V_5 ) + V_55 * sizeof( struct V_1 ) ;
V_5 = F_70 ( V_141 , V_146 ) ;
if ( V_5 == NULL ) {
F_58 ( V_10 ) ;
F_59 ( V_10 ) ;
return - V_100 ;
...
for ( V_69 = 0 ; V_69 < V_55 ; V_69 ++ ) {
T_10 * V_161 ;
struct V_1 * V_1 = & V_5 -> V_55 [ V_69 ] ;
struct V_2 * V_3 = F_81 ( V_1 ) ;
if ( ! V_3 ) {
F_68 ( L_39 ,
F_7 ( V_10 ) ) ;
F_51 ( V_10 ) ;
...
for ( V_69 = 0 ; V_69 < V_55 ; V_69 ++ )
F_84 ( L_42 ,
V_69 ? L_43 : L_2 , V_69 , V_5 -> V_55 [ V_69 ] . V_3 -> V_61 ) ;
F_84 ( L_44 ) ;
for ( V_69 = 0 ; V_69 < V_55 ; V_69 ++ )
F_8 ( & V_5 -> V_55 [ V_69 ] ) ;
return 0 ;
