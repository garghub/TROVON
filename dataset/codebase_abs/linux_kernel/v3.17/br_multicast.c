...
return;
if ( V_61 ) {
F_102 ( V_29 , sizeof( struct V_72 ) ) ;
V_29 -> V_51 = V_61 -> V_51 ;
F_103 ( V_149 , V_150 , V_29 , NULL , V_29 -> V_51 ,
V_151 ) ;
} else {
...
{
struct V_122 * V_61 = ( void * ) V_49 ;
F_106 ( V_61 , & V_61 -> V_145 ) ;
}
static void F_108 ( unsigned long V_49 )
{
struct V_122 * V_61 = ( void * ) V_49 ;
F_106 ( V_61 , & V_61 -> V_146 ) ;
}
...
F_108 , ( unsigned long ) V_61 ) ;
#endif
}
void F_110 ( struct V_122 * V_61 )
{
F_111 ( & V_61 -> V_141 ) ;
}
static void F_112 ( struct V_143 * V_144 )
{
V_144 -> V_158 = 0 ;
if ( F_113 ( & V_144 -> V_52 ) >= 0 ||
F_40 ( & V_144 -> V_52 ) )
...
int V_65 = 0 ;
T_1 V_69 ;
if ( ! F_118 ( V_29 , sizeof( * V_71 ) ) )
return - V_46 ;
V_71 = F_119 ( V_29 ) ;
V_168 = F_120 ( V_71 -> V_169 ) ;
V_42 = sizeof( * V_71 ) ;
...
int V_168 ;
int V_65 = 0 ;
if ( ! F_118 ( V_29 , sizeof( * V_180 ) ) )
return - V_46 ;
V_180 = F_69 ( V_29 ) ;
V_168 = F_120 ( V_180 -> V_182 . V_183 [ 1 ] ) ;
V_42 = sizeof( * V_180 ) ;
for ( V_43 = 0 ; V_43 < V_168 ; V_43 ++ ) {
T_5 * V_184 , V_185 ;
V_184 = F_122 ( V_29 ,
V_42 + F_123 ( struct V_181 ,
V_172 ) ,
sizeof( V_185 ) , & V_185 ) ;
if ( ! V_184 )
return - V_46 ;
if ( ! F_118 ( V_29 ,
V_42 + sizeof( * V_167 ) +
sizeof( struct V_19 ) * F_120 ( * V_184 ) ) )
return - V_46 ;
...
static bool F_124 ( struct V_26 * V_27 ,
struct V_122 * V_61 ,
T_1 V_89 )
{
...
goto V_192;
if ( F_125 ( V_89 ) <= F_125 ( V_27 -> V_147 . V_24 . V_7 . V_8 ) )
goto V_192;
return false ;
V_192:
...
goto V_192;
if ( F_127 ( V_89 , & V_27 -> V_148 . V_24 . V_7 . V_11 ) <= 0 )
goto V_192;
return false ;
V_192:
...
switch ( V_89 -> V_4 ) {
case F_2 ( V_6 ) :
return F_124 ( V_27 , V_61 , V_89 -> V_7 . V_8 ) ;
#if F_3 ( V_9 )
case F_2 ( V_10 ) :
return F_126 ( V_27 , V_61 , & V_89 -> V_7 . V_11 ) ;
#endif
}
return false ;
}
static void
F_129 ( struct V_26 * V_27 ,
struct V_153 * V_144 ,
unsigned long V_193 )
{
if ( ! F_31 ( & V_144 -> V_52 ) )
...
unsigned long V_193 )
{
if ( ! F_128 ( V_27 , V_61 , V_89 ) )
return;
F_129 ( V_27 , V_144 , V_193 ) ;
F_132 ( V_27 , V_61 ) ;
}
...
if ( ! F_118 ( V_29 , sizeof( struct V_198 ) ) ) {
V_65 = - V_46 ;
goto V_53;
}
V_199 = F_135 ( V_29 ) ;
...
if ( V_23 -> V_54 &&
( F_31 ( & V_23 -> V_52 ) ?
F_137 ( V_23 -> V_52 . V_201 , V_133 + V_193 ) :
F_113 ( & V_23 -> V_52 ) >= 0 ) )
...
V_58 = & V_48 -> V_59 ) {
if ( F_31 ( & V_48 -> V_52 ) ?
F_137 ( V_48 -> V_52 . V_201 , V_133 + V_193 ) :
F_113 ( & V_48 -> V_52 ) >= 0 )
...
( V_61 && V_61 -> V_62 == V_134 ) )
goto V_53;
if ( ! ( F_139 ( & V_103 -> V_89 ) & V_206 ) ) {
V_65 = - V_46 ;
goto V_53;
}
if ( V_29 -> V_42 == sizeof( * V_202 ) ) {
if ( ! F_118 ( V_29 , sizeof( * V_202 ) ) ) {
V_65 = - V_46 ;
goto V_53;
}
V_202 = (struct V_104 * ) F_69 ( V_29 ) ;
V_193 = F_140 ( F_120 ( V_202 -> V_119 ) ) ;
if ( V_193 )
V_69 = & V_202 -> V_121 ;
} else {
if ( ! F_118 ( V_29 , sizeof( * V_204 ) ) ) {
V_65 = - V_46 ;
goto V_53;
}
...
unsigned int V_213 ;
int V_65 ;
if ( ! F_118 ( V_29 , sizeof( * V_75 ) ) )
return - V_46 ;
V_75 = F_18 ( V_29 ) ;
if ( V_75 -> V_81 < 5 || V_75 -> V_80 != 4 )
return - V_46 ;
if ( ! F_118 ( V_29 , F_146 ( V_29 ) ) )
return - V_46 ;
V_75 = F_18 ( V_29 ) ;
if ( F_76 ( F_147 ( ( V_93 * ) V_75 , V_75 -> V_81 ) ) )
return - V_46 ;
if ( V_75 -> V_32 != V_88 ) {
if ( ! F_90 ( V_75 -> V_33 ) )
F_17 ( V_29 ) -> V_214 = 1 ;
...
V_42 = F_120 ( V_75 -> V_83 ) ;
if ( V_29 -> V_42 < V_42 || V_42 < F_146 ( V_29 ) )
return - V_46 ;
if ( V_29 -> V_42 > V_42 ) {
V_212 = F_148 ( V_29 , V_66 ) ;
if ( ! V_212 )
return - V_67 ;
V_65 = F_149 ( V_212 , V_42 ) ;
if ( V_65 )
goto V_215;
}
V_42 -= F_146 ( V_212 ) ;
V_213 = F_150 ( V_212 ) + F_146 ( V_212 ) ;
F_62 ( V_212 , V_213 ) ;
F_151 ( V_212 ) ;
V_65 = - V_46 ;
if ( ! F_118 ( V_212 , sizeof( * V_71 ) ) )
goto V_53;
switch ( V_212 -> V_216 ) {
case V_217 :
if ( ! F_152 ( V_212 -> V_101 ) )
break;
case V_218 :
V_212 -> V_101 = 0 ;
if ( F_153 ( V_212 ) )
...
break;
case V_221 :
V_65 = F_117 ( V_27 , V_61 , V_212 , V_5 ) ;
break;
case V_95 :
V_65 = F_134 ( V_27 , V_61 , V_212 , V_5 ) ;
break;
case V_222 :
F_143 ( V_27 , V_61 , V_71 -> V_69 , V_5 ) ;
break;
}
V_53:
F_102 ( V_212 , V_213 ) ;
...
V_103 -> V_108 == 0 )
return 0 ;
V_42 = F_120 ( V_103 -> V_108 ) + sizeof( * V_103 ) ;
if ( V_29 -> V_42 < V_42 )
return - V_46 ;
V_109 = V_103 -> V_109 ;
...
return - V_67 ;
V_65 = - V_46 ;
if ( ! F_118 ( V_212 , V_213 + sizeof( struct V_179 ) ) )
goto V_53;
V_42 -= V_213 - F_150 ( V_212 ) ;
F_62 ( V_212 , V_213 ) ;
F_151 ( V_212 ) ;
...
case V_226 :
V_65 = F_121 ( V_27 , V_61 , V_212 , V_5 ) ;
break;
case V_116 :
V_65 = F_138 ( V_27 , V_61 , V_212 , V_5 ) ;
break;
case V_225 :
{
struct V_104 * V_202 ;
...
V_202 = (struct V_104 * ) F_161 ( V_212 ) ;
F_144 ( V_27 , V_61 , & V_202 -> V_121 , V_5 ) ;
}
}
V_53:
F_67 ( V_212 ) ;
...
F_83 ( & V_27 -> V_145 . V_52 , F_164 ,
( unsigned long ) V_27 ) ;
#if F_3 ( V_9 )
F_83 ( & V_27 -> V_157 . V_52 ,
F_99 , ( unsigned long ) V_27 ) ;
F_83 ( & V_27 -> V_146 . V_52 , F_165 ,
( unsigned long ) V_27 ) ;
#endif
}
static void F_168 ( struct V_26 * V_27 ,
struct V_143 * V_144 )
{
V_144 -> V_158 = 0 ;
if ( V_27 -> V_30 )
...
{
F_168 ( V_27 , & V_27 -> V_145 ) ;
#if F_3 ( V_9 )
F_168 ( V_27 , & V_27 -> V_146 ) ;
#endif
}
...
int V_43 ;
F_111 ( & V_27 -> V_141 ) ;
F_111 ( & V_27 -> V_156 . V_52 ) ;
F_111 ( & V_27 -> V_145 . V_52 ) ;
#if F_3 ( V_9 )
F_111 ( & V_27 -> V_157 . V_52 ) ;
F_111 ( & V_27 -> V_146 . V_52 ) ;
#endif
F_171 ( & V_27 -> V_50 ) ;
V_13 = F_32 ( V_27 -> V_13 , V_27 ) ;
if ( ! V_13 )
...
int F_174 ( struct V_26 * V_27 , unsigned long V_229 )
{
int V_65 = - V_230 ;
F_171 ( & V_27 -> V_50 ) ;
if ( ! F_30 ( V_27 -> V_51 ) )
...
int F_175 ( struct V_122 * V_48 , unsigned long V_229 )
{
...
int F_177 ( struct V_26 * V_27 , unsigned long V_229 )
{
int V_65 = 0 ;
struct V_12 * V_13 ;
F_171 ( & V_27 -> V_50 ) ;
...
bool F_188 ( struct V_233 * V_51 , int V_4 )
{
struct V_26 * V_27 ;
struct V_122 * V_61 ;
struct V_72 V_73 ;
...
V_73 . V_79 = F_2 ( V_4 ) ;
V_238 = F_189 ( V_27 , & V_73 ) ;
V_231:
F_187 () ;
return V_238 ;
}
bool F_190 ( struct V_233 * V_51 , int V_4 )
{
struct V_26 * V_27 ;
struct V_122 * V_61 ;
bool V_238 = false ;
