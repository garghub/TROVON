...
( (struct V_225 * ) V_195 -> V_225 ) -> V_224 ) ;
type = L_36 ;
for ( V_48 = 0 ; V_48 < V_195 -> V_34 ; V_48 ++ ) {
struct V_28 * V_226 = & V_195 -> V_29 [ V_48 ] ;
if ( V_226 -> type == V_39 &&
( V_226 -> V_23 & V_227 ) == V_228 &&
( V_226 -> V_23 & 0xffff ) < F_76 ( V_211 ) ) {
...
V_102 = F_77 ( & V_195 -> V_116 , & V_230 ) ;
if ( V_102 )
F_42 ( V_195 ,
L_53 , V_102 ) ;
F_78 ( V_195 , L_54 ,
V_141 , V_197 , V_195 -> V_231 >> 8 , V_195 -> V_231 & 0xff ,
type , V_195 -> V_167 , V_195 -> V_232 ) ;
return 0 ;
}
void F_79 ( struct V_2 * V_195 )
{
F_80 ( & V_195 -> V_116 , & V_230 ) ;
if ( V_195 -> V_168 & V_169 )
F_81 ( V_195 ) ;
if ( V_195 -> V_168 & V_170 )
V_195 -> V_233 ( V_195 ) ;
...
static T_6 F_83 ( struct V_234 * V_235 , const char * V_141 ,
T_8 V_172 )
{
struct V_163 * V_164 = F_26 ( V_235 , struct V_163 , V_152 ) ;
struct V_236 * V_237 ;
V_53 V_197 , V_200 , V_201 ;
unsigned long V_238 = 0 ;
int V_102 ;
V_102 = sscanf ( V_141 , L_55 ,
& V_197 , & V_200 , & V_201 , & V_238 ) ;
if ( V_102 < 3 )
return - V_33 ;
V_237 = F_2 ( sizeof( * V_237 ) , V_10 ) ;
if ( ! V_237 )
return - V_36 ;
V_237 -> V_4 . V_197 = V_197 ;
V_237 -> V_4 . V_129 = V_199 ;
V_237 -> V_4 . V_200 = V_200 ;
V_237 -> V_4 . V_201 = V_201 ;
V_237 -> V_4 . V_238 = V_238 ;
F_84 ( & V_164 -> V_239 ) ;
F_3 ( & V_237 -> V_13 , & V_164 -> V_240 ) ;
F_85 ( & V_164 -> V_239 ) ;
...
if ( F_69 ( V_195 , & V_237 -> V_4 ) ) {
F_85 ( & V_164 -> V_239 ) ;
return & V_237 -> V_4 ;
}
}
F_85 ( & V_164 -> V_239 ) ;
return F_70 ( V_195 , V_164 -> V_241 ) ;
}
static int F_92 ( struct V_3 * V_116 , struct V_234 * V_235 )
{
struct V_163 * V_164 = F_26 ( V_235 , struct V_163 , V_152 ) ;
struct V_2 * V_195 = F_26 ( V_116 , struct V_2 , V_116 ) ;
...
V_195 -> V_152 = V_164 ;
if ( V_164 -> V_246 ) {
V_102 = V_164 -> V_246 ( V_195 , V_4 ) ;
} else {
V_102 = F_38 ( V_195 ) ;
if ( ! V_102 )
V_102 = F_95 ( V_195 , V_247 ) ;
}
if ( V_102 ) {
F_23 ( V_195 ) ;
V_195 -> V_152 = NULL ;
...
static T_6 F_98 ( struct V_3 * V_116 , struct V_248 * V_144 ,
char * V_141 )
{
struct V_2 * V_195 = F_26 ( V_116 , struct V_2 , V_116 ) ;
int V_178 ;
V_178 = snprintf ( V_141 , V_249 , L_56 ,
V_195 -> V_197 , V_195 -> V_129 , V_195 -> V_200 , V_195 -> V_201 ) ;
return ( V_178 >= V_249 ) ? ( V_249 - 1 ) : V_178 ;
}
static int F_99 ( struct V_3 * V_116 , struct V_250 * V_251 )
{
struct V_2 * V_195 = F_26 ( V_116 , struct V_2 , V_116 ) ;
if ( F_100 ( V_251 , L_57 ,
V_195 -> V_197 , V_195 -> V_200 , V_195 -> V_201 ) )
return - V_36 ;
if ( F_100 ( V_251 , L_58 , V_195 -> V_167 ) )
return - V_36 ;
if ( F_100 ( V_251 , L_59 , V_195 -> V_232 ) )
return - V_36 ;
if ( F_100 ( V_251 , L_60 , V_195 -> V_252 ) )
return - V_36 ;
if ( F_100 ( V_251 , L_61 ,
V_195 -> V_197 , V_195 -> V_129 , V_195 -> V_200 , V_195 -> V_201 ) )
return - V_36 ;
...
{
if ( V_195 -> V_212 & V_253 )
return false ;
if ( V_195 -> V_212 & V_254 )
return true ;
switch ( V_195 -> V_200 ) {
case V_255 :
if ( V_195 -> V_201 >= V_256 &&
V_195 -> V_201 <= V_257 )
return true ;
break;
case V_258 :
if ( V_195 -> V_201 >= V_259 &&
V_195 -> V_201 <= V_260 )
return true ;
...
break;
case V_265 :
if ( V_195 -> V_201 >= V_266 &&
V_195 -> V_201 <= V_267 )
return true ;
break;
case V_268 :
if ( V_195 -> V_201 == V_269 &&
V_195 -> type == V_270 )
return true ;
break;
case V_271 :
if ( ( V_195 -> V_201 >= V_272 &&
V_195 -> V_201 <= V_273 ) ||
( V_195 -> V_201 >= V_274 &&
V_195 -> V_201 <= V_275 ) )
return true ;
...
F_70 ( V_195 , V_279 ) )
return true ;
return ! ! F_70 ( V_195 , V_280 ) ;
}
int F_102 ( struct V_2 * V_195 )
{
static T_9 V_4 = F_103 ( 0 ) ;
int V_102 ;
if ( F_45 ( V_195 -> V_114 & V_281 ) )
return - V_192 ;
if ( F_101 ( V_195 ) )
return - V_190 ;
...
return F_111 ( V_102 ) ;
F_112 ( & V_195 -> V_116 ) ;
V_195 -> V_116 . V_285 = F_25 ;
V_195 -> V_116 . V_197 = & V_286 ;
F_23 ( V_195 ) ;
F_113 ( & V_195 -> V_287 ) ;
F_24 ( & V_195 -> V_165 ) ;
F_114 ( & V_195 -> V_288 ) ;
...
int F_120 ( struct V_163 * V_164 , struct V_289 * V_290 ,
const char * V_291 )
{
int V_102 ;
V_164 -> V_152 . V_167 = V_164 -> V_167 ;
V_164 -> V_152 . V_197 = & V_286 ;
V_164 -> V_152 . V_290 = V_290 ;
V_164 -> V_152 . V_291 = V_291 ;
F_24 ( & V_164 -> V_240 ) ;
F_114 ( & V_164 -> V_239 ) ;
V_102 = F_121 ( & V_164 -> V_152 ) ;
if ( V_102 )
return V_102 ;
V_102 = F_122 ( & V_164 -> V_152 , & V_292 ) ;
if ( V_102 )
F_123 ( & V_164 -> V_152 ) ;
return V_102 ;
}
...
for ( V_48 = 0 ; V_48 < F_127 ( V_295 ) ; V_48 ++ )
if ( V_294 -> V_296 -> V_297 [ V_48 ] )
return 1 ;
}
return 0 ;
}
