...
while ( V_511 -> V_508 ) {
if ( F_192 ( V_508 , V_511 -> V_508 ) ) {
if ( V_511 -> V_509 == NULL )
return V_511 -> V_48 ;
if ( F_192 ( V_509 , V_511 -> V_509 ) )
return V_511 -> V_48 ;
}
V_511 ++ ;
}
...
int F_360 ( const struct V_4 * V_5 , const char * V_697 ,
const char * V_698 , ... )
{
struct V_699 V_700 ;
T_12 args ;
...
V_700 . V_698 = V_698 ;
V_700 . V_702 = & args ;
V_701 = F_345 ( L_225 , V_697 , V_5 -> V_31 , & V_700 ) ;
va_end ( args ) ;
return V_701 ;
}
int F_361 ( const struct V_2 * V_3 , const char * V_697 ,
const char * V_698 , ... )
{
struct V_699 V_700 ;
T_12 args ;
...
int F_362 ( const struct V_14 * V_15 , const char * V_697 ,
const char * V_698 , ... )
{
struct V_699 V_700 ;
T_12 args ;
...
void F_363 ( const struct V_21 * V_15 , const char * V_703 )
{
F_364 ( V_271 , V_15 , L_227 , V_703 ) ;
}
