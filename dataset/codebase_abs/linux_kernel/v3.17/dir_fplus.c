...
static int
F_12 ( struct V_5 * V_6 , unsigned int V_38 )
{
struct V_7 * V_8 =
...
static void
F_13 ( struct V_5 * V_6 , unsigned int V_42 , void * V_43 , int V_44 )
{
...
static int
F_14 ( struct V_5 * V_6 , struct V_49 * V_50 )
{
struct V_7 * V_8 =
(struct V_7 * ) V_6 -> V_18 [ 0 ] -> V_21 ;
struct V_51 V_52 ;
...
goto V_20;
V_42 = F_15 ( struct V_7 , V_53 ) ;
V_42 += ( ( F_5 ( V_8 -> V_54 ) + 4 ) & ~ 3 ) ;
V_42 += V_6 -> V_41 * sizeof( struct V_51 ) ;
F_13 ( V_6 , V_42 , & V_52 , sizeof( struct V_51 ) ) ;
...
V_42 += F_5 ( V_52 . V_66 ) ;
F_13 ( V_6 , V_42 , V_50 -> V_67 , V_50 -> V_64 ) ;
