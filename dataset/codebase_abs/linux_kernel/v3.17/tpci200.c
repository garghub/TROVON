...
static int F_54 ( struct V_86 * V_15 ,
...
V_89 = F_57 ( V_4 -> V_14 -> V_18 + V_96 ) ;
V_89 |= 1 << V_97 ;
F_58 ( V_89 , V_4 -> V_14 -> V_18 + V_96 ) ;
V_89 = F_57 ( V_4 -> V_14 -> V_18 + V_98 ) ;
V_89 |= 1 << V_97 ;
F_58 ( V_89 , V_4 -> V_14 -> V_18 + V_98 ) ;
V_4 -> V_14 -> V_15 = V_15 ;
...
static void F_64 ( struct V_86 * V_3 )
{
struct V_1 * V_4 = F_65 ( V_3 ) ;
F_62 ( V_4 ) ;
}
