...
static int F_112 ( struct V_248 * V_167 )
{
struct V_13 * V_251 ;
struct V_1 * V_2 ;
...
int V_42 ;
F_104 ( V_273 L_70 ) ;
V_2 = F_113 ( & V_167 -> V_48 , sizeof( struct V_1 ) ,
V_242 ) ;
if ( ! V_2 )
return - V_243 ;
F_105 ( & V_2 -> V_30 ) ;
V_239 = F_114 ( & V_274 , NULL , V_2 ,
F_99 ) ;
if ( V_239 < 0 )
return V_239 ;
if ( NULL != V_2 -> V_4 -> V_37 . V_275 ) {
V_239 = V_2 -> V_4 -> V_37 . V_275 ( & V_167 -> V_48 ,
V_2 -> V_4 ) ;
if ( V_239 ) {
F_3 ( & V_2 -> V_4 -> V_11 ,
L_71 ) ;
...
V_42 = V_271 -> V_278 ;
V_239 = F_116 ( & V_167 -> V_48 , V_42 , F_14 , 0 ,
V_279 , V_2 ) ;
if ( V_239 ) {
F_3 ( & V_2 -> V_4 -> V_11 ,
L_73 ) ;
...
static int F_118 ( struct V_248 * V_167 )
{
struct V_13 * V_251 ;
