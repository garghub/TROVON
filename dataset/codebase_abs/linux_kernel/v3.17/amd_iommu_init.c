...
case V_284 :
V_119 = F_100 () ;
V_275 = V_119 ? V_279 : V_285 ;
F_120 () ;
break;
case V_285 :
V_119 = F_124 () ;
V_275 = V_119 ? V_279 : V_286 ;
break;
case V_286 :
V_119 = F_143 () ;
V_275 = V_119 ? V_279 : V_287 ;
break;
case V_287 :
V_275 = V_288 ;
break;
...
static int T_6 F_151 ( enum V_289 V_290 )
{
int V_119 = 0 ;
while ( V_275 != V_290 ) {
V_119 = F_148 () ;
...
V_263 = true ;
V_293 = 1 ;
V_296 . V_7 . V_297 = F_158 ;
return 0 ;
}
static int T_6 F_160 ( char * V_298 )
{
V_299 = true ;
return 1 ;
}
static int T_6 F_161 ( char * V_298 )
{
for (; * V_298 ; ++ V_298 ) {
if ( strncmp ( V_298 , L_63 , 9 ) == 0 )
V_300 = true ;
if ( strncmp ( V_298 , L_64 , 3 ) == 0 )
V_295 = true ;
if ( strncmp ( V_298 , L_65 , 15 ) == 0 )
V_301 = true ;
}
return 1 ;
}
static int T_6 F_162 ( char * V_298 )
{
unsigned int V_39 , V_11 , V_40 ;
int V_119 , V_108 , V_55 ;
T_1 V_1 ;
V_119 = sscanf ( V_298 , L_66 , & V_108 , & V_39 , & V_11 , & V_40 ) ;
if ( V_119 != 4 ) {
F_24 ( L_67 , V_298 ) ;
return 1 ;
}
...
static int T_6 F_163 ( char * V_298 )
{
unsigned int V_39 , V_11 , V_40 ;
int V_119 , V_108 , V_55 ;
T_1 V_1 ;
...
int F_84 ( T_1 V_1 , T_3 V_303 , T_3 V_304 , T_3 V_305 ,
T_4 * V_148 , bool V_306 )
{
struct V_6 * V_7 ;
T_2 V_307 ;
T_2 V_308 ;
...
return - V_57 ;
V_7 = V_93 [ V_1 ] ;
if ( F_39 ( ( V_7 == NULL ) || ( V_305 > 0x28 ) || ( V_305 & 7 ) ) )
return - V_57 ;
V_307 = ( T_2 ) ( ( ( 0x40 | V_303 ) << 12 ) | ( V_304 << 8 ) | V_305 ) ;
V_308 = ( T_2 ) ( ( ( 0x40 | V_7 -> V_168 ) << 12 ) |
( V_7 -> V_169 << 8 ) | 0x28 ) ;
if ( ( V_307 < V_309 ) ||
( V_307 > V_308 ) )
return - V_117 ;
if ( V_306 ) {
F_17 ( ( T_2 ) * V_148 , V_7 -> V_19 + V_307 ) ;
F_17 ( ( * V_148 >> 32 ) , V_7 -> V_19 + V_307 + 4 ) ;
} else {
* V_148 = F_16 ( V_7 -> V_19 + V_307 + 4 ) ;
* V_148 <<= 32 ;
* V_148 = F_16 ( V_7 -> V_19 + V_307 ) ;
}
return 0 ;
}
