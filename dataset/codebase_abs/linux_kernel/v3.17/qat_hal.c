...
struct V_140 * V_141 = & V_135 -> V_142 [ V_143 ] ;
...
void F_41 ( struct V_1 * V_2 , unsigned char V_3 ,
unsigned int V_4 )
{
F_22 ( V_2 , V_3 , ( ~ V_4 ) &
V_85 , 0x10000 ) ;
...
void F_42 ( struct V_1 * V_2 , unsigned char V_3 ,
unsigned int V_4 )
{
F_29 ( V_2 , V_3 , V_4 ) ;
}
...
V_113 |= ( F_46 ( V_168 [ V_109 ] & 0xffff ) & 0x1 ) << 8 ;
V_114 = ( ( V_168 [ V_109 ] >> 0x10 ) & 0xffff ) ;
V_113 |= ( F_46 ( V_114 ) & 0x1 ) << 9 ;
F_6 ( V_2 , V_3 , V_115 , V_112 ) ;
F_6 ( V_2 , V_3 , V_116 , V_113 ) ;
}
F_6 ( V_2 , V_3 , V_110 , V_108 ) ;
...
return F_47 ( V_2 , V_3 , V_13 , V_198 , V_206 ,
...
F_52 ( V_169 [ V_215 ] , ( V_211 ) ) ;
V_215 ++ ;
F_52 ( V_169 [ V_215 ] , 0 ) ;
V_215 ++ ;
F_53 ( V_169 [ V_215 ] , ( V_213 >> 0 ) ) ;
V_215 ++ ;
F_53 ( V_169 [ V_215 ] , ( V_213 >> 0x10 ) ) ;
return V_170 - V_217 ;
}
...
if ( * V_218 ) {
F_48 ( V_2 , V_3 , V_13 , V_45 , 0 , & V_220 ) ;
F_48 ( V_2 , V_3 , V_13 , V_45 , 0x1 , & V_221 ) ;
F_48 ( V_2 , V_3 , V_13 , V_45 , 0x2 , & V_222 ) ;
F_48 ( V_2 , V_3 , V_13 , V_46 , 0 , & V_223 ) ;
F_48 ( V_2 , V_3 , V_13 , V_46 , 0x1 , & V_224 ) ;
* V_218 = 0 ;
}
V_219 = F_47 ( V_2 , V_3 , V_13 , V_169 , V_170 , 1 ,
V_170 * 0x5 , NULL ) ;
if ( V_219 != 0 )
return - V_12 ;
F_49 ( V_2 , V_3 , V_13 , V_45 , 0 , V_220 ) ;
F_49 ( V_2 , V_3 , V_13 , V_45 , 0x1 , V_221 ) ;
F_49 ( V_2 , V_3 , V_13 , V_45 , 0x2 , V_222 ) ;
F_49 ( V_2 , V_3 , V_13 , V_46 , 0 , V_223 ) ;
F_49 ( V_2 , V_3 , V_13 , V_46 , 0x1 , V_224 ) ;
return 0 ;
}
...
case V_47 :
case V_49 :
F_58 ( V_2 , V_3 , V_42 , V_233 ) ;
break;
case V_51 :
case V_53 :
F_58 ( V_2 , V_3 , ( V_42 + V_235 ) , V_233 ) ;
break;
default:
V_197 = - V_30 ;
break;
...
F_48 ( V_2 , V_3 , V_13 , V_46 , V_241 , & V_236 ) ;
...
V_197 = F_47 ( V_2 , V_3 , V_13 , V_169 , V_206 ,
V_171 , V_242 , NULL ) ;
F_49 ( V_2 , V_3 , V_13 , V_46 , V_241 , V_236 ) ;
return V_197 ;
}
...
V_219 = F_59 ( V_2 , V_3 , V_13 , V_55 , V_243 , V_233 ) ;
F_6 ( V_2 , V_3 , V_31 , V_188 ) ;
return V_219 ;
}
static int F_61 ( struct V_1
...
do {
if ( V_4 == 0 ) {
F_61 ( V_2 , V_3 , V_41 , & V_118 ,
& V_13 ) ;
type = V_195 - 1 ;
} else {
V_118 = V_41 ;
type = V_195 ;
if ( ! F_63 ( V_13 , ( unsigned long * ) & V_4 ) )
continue;
}
V_219 = F_49 ( V_2 , V_3 , V_13 , type , V_118 , V_246 ) ;
if ( V_219 ) {
F_5 ( L_17 ) ;
return - V_30 ;
}
...
V_219 = F_57 ( V_2 , V_3 , V_13 , type , V_118 ,
V_246 ) ;
if ( V_219 ) {
F_5 ( L_19 ) ;
return - V_30 ;
...
if ( ! F_63 ( V_13 , ( unsigned long * ) & V_4 ) )
continue;
V_219 = F_60 ( V_2 , V_3 , V_13 , V_41 , V_246 ) ;
if ( V_219 ) {
F_5 ( L_20 ) ;
return - V_30 ;
}
