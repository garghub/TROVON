...
static int F_52 ( struct V_98 * V_79 , unsigned int * V_128 ,
unsigned long V_129 )
{
struct V_72 * V_68 = V_79 -> V_68 ;
struct V_35 * V_36 = V_68 -> V_7 ;
...
static void F_56 ( struct V_72 * V_68 )
{
F_5 ( L_56 ) ;
F_57 ( V_68 ) ;
}
...
static void F_59 ( struct V_72 * V_68 )
{
struct V_5 * V_6 = V_68 -> V_2 -> V_7 ;
void T_1 * V_8 = V_6 -> V_8 ;
...
static void F_69 ( struct V_72 * V_68 )
{
struct V_5 * V_6 = V_68 -> V_2 -> V_7 ;
void T_1 * V_8 = V_6 -> V_8 ;
T_4 V_148 , V_169 = 0 ;
...
F_70 ( V_68 , V_68 -> V_178 ^ V_169 ) ;
return;
} else if ( ( V_68 -> V_178 & ( 1 << V_179 ) ) ) {
F_3 ( 1 , V_8 + V_92 ) ;
V_49 = F_65 ( V_68 , V_179 ) ;
F_5 ( L_68 ,
F_6 ( V_8 + V_92 ) ) ;
if ( V_49 ) {
F_71 ( V_49 ) ;
...
static T_7 F_72 ( int V_180 , void * V_181 )
{
...
struct V_1 * V_2 = NULL ;
T_4 V_31 ;
struct F_51 V_191 = V_192 [ 0 ] ;
const struct F_51 * V_193 [] = { & V_191 , NULL } ;
F_79 ( & V_188 -> V_20 , L_73 ) ;
V_8 = F_80 ( V_188 -> V_20 . V_194 , 0 ) ;
if ( ! V_8 )
goto V_195;
V_101 = V_8 + 0x100 ;
V_29 = V_8 + 0x140 ;
if ( ! F_81 ( V_188 -> V_20 . V_194 , L_74 ) ) {
V_31 = F_6 ( V_29 + V_30 ) ;
...
V_6 -> V_101 = V_101 ;
V_6 -> V_29 = V_29 ;
V_180 = F_82 ( V_188 -> V_20 . V_194 , 0 ) ;
if ( V_180 < 0 ) {
F_83 ( & V_188 -> V_20 , L_78 ) ;
goto V_195;
}
V_6 -> V_180 = V_180 ;
if ( F_81 ( V_188 -> V_20 . V_194 , L_79 ) )
V_6 -> V_52 = V_197 ;
else
V_6 -> V_52 = V_198 ;
V_2 = F_84 ( & V_188 -> V_20 , V_193 , V_199 ) ;
if ( ! V_2 ) {
V_189 = - V_114 ;
goto V_195;
}
