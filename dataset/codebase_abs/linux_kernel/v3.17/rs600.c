...
void F_85 ( struct V_1 * V_2 , unsigned V_10 ,
T_4 V_164 , T_3 V_95 )
{
...
if ( F_92 ( & V_2 -> V_180 . V_183 [ V_184 ] ) ) {
V_19 |= F_93 ( 1 ) ;
}
if ( V_2 -> V_180 . V_185 [ 0 ] ||
F_92 ( & V_2 -> V_180 . V_186 [ 0 ] ) ) {
V_175 |= F_94 ( 1 ) ;
}
if ( V_2 -> V_180 . V_185 [ 1 ] ||
F_92 ( & V_2 -> V_180 . V_186 [ 1 ] ) ) {
V_175 |= F_95 ( 1 ) ;
}
if ( V_2 -> V_180 . V_107 [ 0 ] ) {
V_176 |= F_88 ( 1 ) ;
}
if ( V_2 -> V_180 . V_107 [ 1 ] ) {
V_177 |= F_89 ( 1 ) ;
}
if ( V_2 -> V_180 . V_187 [ 0 ] ) {
V_178 |= F_91 ( 1 ) ;
}
F_6 ( V_182 , V_19 ) ;
F_6 ( V_188 , V_175 ) ;
...
T_1 V_19 ;
if ( F_98 ( V_189 ) ) {
V_2 -> V_180 . V_192 . V_193 . V_194 = F_2 ( V_195 ) ;
if ( F_99 ( V_2 -> V_180 . V_192 . V_193 . V_194 ) ) {
F_6 ( V_196 ,
F_100 ( 1 ) ) ;
}
if ( F_101 ( V_2 -> V_180 . V_192 . V_193 . V_194 ) ) {
F_6 ( V_197 ,
F_102 ( 1 ) ) ;
}
if ( F_103 ( V_2 -> V_180 . V_192 . V_193 . V_194 ) ) {
V_19 = F_2 ( V_113 ) ;
V_19 |= F_104 ( 1 ) ;
F_6 ( V_113 , V_19 ) ;
}
if ( F_105 ( V_2 -> V_180 . V_192 . V_193 . V_194 ) ) {
V_19 = F_2 ( V_114 ) ;
V_19 |= F_106 ( 1 ) ;
F_6 ( V_114 , V_19 ) ;
}
} else {
V_2 -> V_180 . V_192 . V_193 . V_194 = 0 ;
}
if ( F_90 ( V_2 ) ) {
V_2 -> V_180 . V_192 . V_193 . V_198 = F_2 ( V_199 ) &
F_107 ( 1 ) ;
if ( F_108 ( V_2 -> V_180 . V_192 . V_193 . V_198 ) ) {
V_19 = F_2 ( V_179 ) ;
V_19 |= F_109 ( 1 ) ;
F_6 ( V_179 , V_19 ) ;
}
} else
V_2 -> V_180 . V_192 . V_193 . V_198 = 0 ;
if ( V_189 ) {
F_6 ( V_190 , V_189 ) ;
}
return V_189 & V_191 ;
...
V_121 = F_96 ( V_2 ) ;
if ( ! V_121 &&
! V_2 -> V_180 . V_192 . V_193 . V_194 &&
! V_2 -> V_180 . V_192 . V_193 . V_198 ) {
return V_203 ;
}
while ( V_121 ||
V_2 -> V_180 . V_192 . V_193 . V_194 ||
...
F_114 ( V_2 -> V_102 , 0 ) ;
V_2 -> V_57 . V_204 = true ;
F_115 ( & V_2 -> V_180 . V_205 ) ;
}
if ( F_92 ( & V_2 -> V_180 . V_186 [ 0 ] ) )
F_116 ( V_2 , 0 ) ;
}
if ( F_101 ( V_2 -> V_180 . V_192 . V_193 . V_194 ) ) {
if ( V_2 -> V_180 . V_185 [ 1 ] ) {
...
case V_211 :
case V_212 :
V_200 = F_2 ( V_141 ) & ~ V_213 ;
F_6 ( V_141 , V_200 ) ;
F_6 ( V_141 , V_200 | V_213 ) ;
break;
default:
F_6 ( V_214 , V_215 ) ;
break;
...
{
T_2 V_220 ;
V_2 -> V_151 . V_221 = F_125 ( V_2 -> V_130 , 0 ) ;
V_2 -> V_151 . V_222 = F_126 ( V_2 -> V_130 , 0 ) ;
V_2 -> V_151 . V_223 = true ;
V_2 -> V_151 . V_224 = 128 ;
V_2 -> V_151 . V_225 = F_2 ( V_226 ) ;
V_2 -> V_151 . V_227 = V_2 -> V_151 . V_225 ;
V_2 -> V_151 . V_228 = V_2 -> V_151 . V_222 ;
V_2 -> V_151 . V_229 = F_127 ( V_2 ) ;
V_220 = F_57 ( V_230 ) ;
V_220 = F_128 ( V_220 ) << 16 ;
F_129 ( V_2 , & V_2 -> V_151 , V_220 ) ;
V_2 -> V_151 . V_231 = 0 ;
F_130 ( V_2 , & V_2 -> V_151 ) ;
F_131 ( V_2 ) ;
}
...
T_1 V_235 , V_236 ;
F_133 ( V_2 ) ;
if ( V_2 -> V_17 . V_18 [ 0 ] -> V_220 . V_104 )
V_233 = & V_2 -> V_17 . V_18 [ 0 ] -> V_220 . V_237 ;
if ( V_2 -> V_17 . V_18 [ 1 ] -> V_220 . V_104 )
V_234 = & V_2 -> V_17 . V_18 [ 1 ] -> V_220 . V_237 ;
F_134 ( V_2 , V_233 , V_234 ) ;
if ( V_2 -> V_238 == 2 ) {
V_235 = F_2 ( V_239 ) ;
V_236 = F_2 ( V_240 ) ;
V_235 |= F_135 ( 1 ) ;
...
T_3 F_137 ( struct V_1 * V_2 , T_3 V_74 )
{
unsigned long V_95 ;
T_1 V_135 ;
F_138 ( & V_2 -> V_243 , V_95 ) ;
F_6 ( V_244 , F_139 ( V_74 ) |
F_140 ( 1 ) ) ;
V_135 = F_2 ( V_245 ) ;
F_141 ( & V_2 -> V_243 , V_95 ) ;
return V_135 ;
}
void F_142 ( struct V_1 * V_2 , T_3 V_74 , T_3 V_246 )
{
unsigned long V_95 ;
F_138 ( & V_2 -> V_243 , V_95 ) ;
F_6 ( V_244 , F_139 ( V_74 ) |
...
{
V_2 -> V_247 . V_248 . V_249 = V_250 ;
V_2 -> V_247 . V_248 . V_251 = F_148 ( V_250 ) ;
}
...
if ( F_119 ( V_2 ) )
F_123 ( V_2 -> V_30 , L_13 ) ;
F_58 ( V_252 , 0x0FFFFFFF ) ;
F_58 ( V_253 , 0 ) ;
F_58 ( V_254 , 0 ) ;
F_58 ( V_230 ,
F_150 ( V_2 -> V_151 . V_157 >> 16 ) |
F_151 ( V_2 -> V_151 . V_159 >> 16 ) ) ;
F_6 ( V_255 ,
...
F_87 ( V_2 ) ;
V_2 -> V_247 . V_248 . V_256 = F_2 ( V_257 ) ;
V_135 = F_158 ( V_2 , 1024 * 1024 ) ;
if ( V_135 ) {
