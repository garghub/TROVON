...
V_119 -> V_68 . V_145 . V_146 . V_138 = F_57 ( T_3 ,
V_152 . V_153 . V_154 ) ;
...
struct V_168 * V_169 )
{
T_5 V_170 = F_64 ( V_171 , V_169 ) ;
T_5 V_172 = F_64 ( V_173 , V_169 ) ;
struct V_31 * V_116 , * V_164 ;
unsigned long V_165 = 0 ;
struct V_174 * V_175 ;
int V_47 ;
...
int V_294 = 0 ;
T_2 V_406 = V_404 -> V_406 ;
T_2 V_407 = V_404 -> V_407 ;
T_1 V_408 = 0 ;
F_60 ( & V_409 ) ;
if ( ! V_410 ) {
...
T_2 V_424 = V_423 -> V_425 ;
T_2 V_426 = V_423 -> V_427 ;
T_2 V_249 = V_422 -> V_119 . V_68 . V_248 . V_249 ;
...
V_47 += sizeof( T_2 ) , V_523 ++ ) {
( ( T_2 * ) V_131 ) [ V_523 ] = F_100 ( ( ( T_2 * ) V_127 ) [ V_523 ] ) ;
}
}
static void
...
V_14 -> V_26 ? V_14 -> V_26 -> V_63 : ( V_597 ) - 1 ,
...
struct V_31 * V_32 ;
T_3 * V_41 , * V_601 ;
int V_294 = V_602 , V_161 = 0 ;
struct V_177 * V_603 ;
int V_604 , V_605 ;
unsigned long V_43 , V_606 ;
F_169 ( V_522 ) ;
V_161 = F_170 ( V_14 ) ;
if ( V_161 != 0 && V_161 != V_602 )
return V_161 ;
F_20 ( & V_8 -> V_85 , V_43 ) ;
if ( V_8 -> V_607 & V_608 ) {
F_21 ( & V_8 -> V_85 , V_43 ) ;
...
L_105
L_106 ,
V_602 , V_14 -> V_26 -> V_462 , V_14 -> V_26 -> V_63 ) ;
return V_602 ;
}
V_119 = & V_32 -> V_134 ;
if ( ! ( V_119 -> V_135 & V_610 ) ) {
F_21 ( & V_8 -> V_85 , V_43 ) ;
F_31 ( V_5 , V_96 , V_97 ,
L_107
L_108 ) ;
...
V_41 = & V_119 -> V_119 ;
V_601 = & V_600 -> V_119 ;
V_601 -> V_68 . V_614 . V_615 = V_616 ;
V_601 -> V_68 . V_614 . V_617 = V_41 -> V_488 ;
if ( V_8 -> V_148 == V_487 )
V_601 -> V_68 . V_614 . V_618 = V_119 -> V_182 ;
else
V_601 -> V_68 . V_614 . V_618 = V_41 -> V_489 ;
V_601 -> V_156 = 1 ;
V_601 -> V_159 = V_41 -> V_159 ;
V_600 -> V_619 = V_119 -> V_619 ;
V_600 -> V_135 |= V_620 ;
if ( F_172 ( V_8 ) )
V_601 -> V_539 = V_621 ;
else
...
V_600 -> V_5 = V_5 ;
if ( V_8 -> V_148 == V_487 ) {
V_604 = V_624 + V_119 -> V_619 ;
V_603 = & V_8 -> V_179 . V_180 [ V_604 ] ;
F_20 ( & V_603 -> V_625 , V_606 ) ;
V_605 = F_173 ( V_8 , V_603 -> V_626 ,
V_600 , 0 ) ;
F_21 ( & V_603 -> V_625 , V_606 ) ;
} else {
V_605 = F_173 ( V_8 , V_585 ,
V_600 , 0 ) ;
}
F_21 ( & V_8 -> V_85 , V_43 ) ;
if ( V_605 == V_627 ) {
...
if ( V_32 == NULL )
return V_609 ;
V_32 -> V_561 = V_8 -> V_645 ;
V_32 -> V_38 = V_38 ;
V_161 = F_155 ( V_5 , V_32 , V_643 ,
V_562 ) ;
if ( ! V_161 ) {
F_91 ( V_8 , V_32 ) ;
return V_609 ;
...
L_135
L_136 ,
F_176 ( V_562 ) , V_642 , V_643 ,
V_40 -> V_554 , V_40 -> V_544 , V_175 -> V_182 ,
V_175 -> V_135 ) ;
V_161 = F_180 ( V_8 , V_585 ,
V_175 , V_644 , V_32 -> V_561 ) ;
if ( ( V_161 != V_646 ) ||
( V_644 -> V_119 . V_476 != V_162 ) ) {
F_31 ( V_5 , V_20 , V_97 ,
L_137
L_138 ,
F_176 ( V_562 ) ,
V_642 , V_643 , V_644 -> V_119 . V_476 ,
V_644 -> V_119 . V_68 . V_474 [ 4 ] ,
V_175 -> V_135 ) ;
if ( V_161 == V_646 ) {
if ( V_644 -> V_119 . V_476 == V_485 )
...
V_40 = V_38 -> V_40 ;
V_649 = F_149 ( 2 * V_5 -> V_628 * 1000 ) + V_49 ;
while ( F_148 ( V_649 , V_49 ) ) {
if ( ! V_40 || ! F_24 ( V_40 ) )
return V_609 ;
if ( V_40 -> V_509 == V_510 )
return V_602 ;
...
static int
F_183 ( struct V_4 * V_5 , T_5 V_642 ,
T_1 V_643 , T_8 V_650 )
{
struct V_12 * V_8 = V_5 -> V_8 ;
unsigned long V_649 ;
int V_651 ;
V_651 = F_184 ( V_5 , V_642 , V_643 , V_650 ) ;
if ( V_651 )
F_185 ( V_5 ,
& V_8 -> V_179 . V_180 [ V_8 -> V_179 . V_652 ] ,
V_642 , V_643 , V_650 ) ;
V_649 = F_149 ( 2 * V_5 -> V_628 * 1000 ) + V_49 ;
while ( F_148 ( V_649 , V_49 ) && V_651 ) {
F_182 ( F_149 ( 20 ) ) ;
V_651 = F_184 ( V_5 , V_642 , V_643 , V_650 ) ;
}
if ( V_651 ) {
...
struct V_1 * V_38 ;
struct V_39 * V_40 ;
unsigned V_642 = V_14 -> V_26 -> V_462 ;
T_1 V_643 = V_14 -> V_26 -> V_63 ;
struct V_656 V_70 ;
int V_161 ;
V_38 = F_1 ( V_14 -> V_26 ) ;
if ( ! V_38 ) {
...
F_187 ( V_45 , F_188 () ,
sizeof( V_70 ) , ( char * ) & V_70 , V_658 ) ;
V_161 = F_178 ( V_5 , V_38 , V_642 , V_643 ,
V_632 ) ;
F_31 ( V_5 , V_20 , V_97 ,
L_147
L_148 , V_642 , V_643 , V_161 ) ;
if ( V_161 == V_602 )
V_161 = F_183 ( V_5 , V_642 , V_643 ,
V_653 ) ;
return V_161 ;
}
static int
...
struct V_656 V_70 ;
int V_660 ;
int V_294 = V_602 , V_161 , V_47 ;
V_70 . V_71 = V_72 ;
V_70 . V_73 = V_661 ;
V_70 . V_63 = 0 ;
memcpy ( V_70 . V_75 , & V_5 -> V_662 , sizeof( struct V_77 ) ) ;
memcpy ( V_70 . V_78 , & V_5 -> V_663 , sizeof( struct V_77 ) ) ;
F_187 ( V_45 , F_188 () ,
sizeof( V_70 ) , ( char * ) & V_70 , V_658 ) ;
V_161 = F_170 ( V_14 ) ;
if ( V_161 != 0 && V_161 != V_602 )
return V_161 ;
for ( V_47 = 0 ; V_47 < V_664 ; V_47 ++ ) {
V_660 = 0 ;
F_79 ( V_45 -> V_51 ) ;
...
if ( ! V_660 )
continue;
V_161 = F_178 ( V_5 , V_62 -> V_114 -> V_667 ,
V_47 , 0 , V_633 ) ;
if ( V_161 != V_602 ) {
F_31 ( V_5 , V_20 , V_97 ,
L_152 ,
...
return - V_674 ;
if ( V_8 -> V_9 ) {
F_200 ( V_114 -> V_675 , V_673 . V_266 . V_267 ) ;
F_20 ( & V_8 -> V_676 , V_43 ) ;
V_672 = F_201 ( V_8 ,
& V_8 -> V_677 ,
& V_5 -> V_662 ,
...
return - V_678 ;
F_20 ( & V_8 -> V_676 , V_43 ) ;
F_25 ( & V_672 -> V_679 , & V_8 -> V_677 ) ;
}
V_672 -> V_11 = V_114 -> V_667 ;
V_672 -> V_680 = true ;
F_21 ( & V_8 -> V_676 , V_43 ) ;
V_3 -> V_7 = V_672 ;
} else {
...
V_671 = F_203 ( & V_8 -> V_671 ) ;
V_669 = V_8 -> V_681 ;
V_115 = V_5 -> V_682 + 2 ;
if ( ( V_671 * ( V_5 -> V_682 + 2 ) ) < V_669 )
return 0 ;
if ( V_669 >= V_8 -> V_683 - V_684 ) {
F_31 ( V_5 , V_96 , V_97 ,
L_156
L_157 , V_669 ) ;
return 0 ;
...
V_115 , V_8 -> V_683 ,
( V_8 -> V_683 - V_669 ) ) ;
V_115 = V_8 -> V_683 - V_669 ;
}
V_670 = F_85 ( V_5 , V_115 ) ;
if ( V_115 != V_670 ) {
F_31 ( V_5 , V_20 , V_97 ,
L_161
L_162
...
struct V_10 *
F_202 ( struct V_12 * V_8 , struct V_77 * V_685 ,
struct V_77 * V_673 , T_1 V_63 ,
bool V_686 )
{
struct V_10 * V_687 ;
int V_688 ;
if ( F_95 ( ! V_8 ) || ! V_685 || ! V_673 ||
! ( V_8 -> V_9 ) )
return NULL ;
if ( V_686 )
V_688 = V_689 ;
...
V_688 = V_130 ;
V_687 = F_207 ( V_8 -> V_690 , V_688 ) ;
if ( ! V_687 )
return NULL ;
F_87 ( & V_687 -> V_679 ) ;
V_687 -> V_11 = NULL ;
memcpy ( & V_687 -> V_691 . V_685 , V_685 ,
sizeof( struct V_77 ) ) ;
memcpy ( & V_687 -> V_691 . V_673 , V_673 ,
sizeof( struct V_77 ) ) ;
V_687 -> V_691 . V_63 = V_63 ;
V_687 -> V_417 = false ;
V_687 -> V_680 = false ;
return V_687 ;
}
...
{
struct V_10 * V_687 ;
if ( F_95 ( ! V_8 ) || ! V_183 || ! V_685 || ! V_673 ||
! V_8 -> V_9 )
return NULL ;
F_191 (lun_info, list, listentry) {
if ( ( memcmp ( & V_687 -> V_691 . V_685 , V_685 ,
sizeof( struct V_77 ) ) == 0 ) &&
( memcmp ( & V_687 -> V_691 . V_673 , V_673 ,
sizeof( struct V_77 ) ) == 0 ) &&
( V_687 -> V_691 . V_63 == V_63 ) )
return V_687 ;
}
...
bool
F_209 ( struct V_12 * V_8 , struct V_77 * V_685 ,
struct V_77 * V_673 , T_1 * V_692 ,
struct V_77 * V_693 ,
struct V_77 * V_694 ,
T_1 * V_695 ,
T_2 * V_696 )
...
if ( ( ( F_210 ( V_685 -> V_266 . V_267 ) == 0 ) ||
( memcmp ( & V_687 -> V_691 . V_685 , V_685 ,
sizeof( struct V_77 ) ) == 0 ) ) &&
( ( F_210 ( V_673 -> V_266 . V_267 ) == 0 ) ||
( memcmp ( & V_687 -> V_691 . V_673 , V_673 ,
sizeof( struct V_77 ) ) == 0 ) ) &&
( V_687 -> V_417 ) ) {
V_691 = & V_687 -> V_691 ;
...
* V_692 = V_691 -> V_63 ;
memcpy ( V_685 , & V_691 -> V_685 ,
sizeof( struct V_77 ) ) ;
memcpy ( V_673 , & V_691 -> V_673 ,
sizeof( struct V_77 ) ) ;
break;
}
}
...
bool
F_211 ( struct V_12 * V_8 , struct V_77 * V_685 ,
struct V_77 * V_673 , T_1 V_63 )
{
struct V_10 * V_687 ;
unsigned long V_43 ;
...
return false ;
F_20 ( & V_8 -> V_676 , V_43 ) ;
V_687 = F_201 ( V_8 , & V_8 -> V_677 , V_685 ,
V_673 , V_63 ) ;
if ( V_687 ) {
if ( ! V_687 -> V_417 )
V_687 -> V_417 = true ;
...
V_687 = F_202 ( V_8 , V_685 , V_673 , V_63 ,
false ) ;
if ( V_687 ) {
V_687 -> V_417 = true ;
V_687 -> V_680 = false ;
F_25 ( & V_687 -> V_679 , & V_8 -> V_677 ) ;
F_21 ( & V_8 -> V_676 , V_43 ) ;
return true ;
}
F_21 ( & V_8 -> V_676 , V_43 ) ;
...
bool
F_212 ( struct V_12 * V_8 , struct V_77 * V_685 ,
struct V_77 * V_673 , T_1 V_63 )
{
struct V_10 * V_687 ;
unsigned long V_43 ;
