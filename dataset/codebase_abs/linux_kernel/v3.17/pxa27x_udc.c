...
static int F_120 ( struct V_203 * V_221 ,
struct V_222 * V_11 )
{
struct V_4 * V_5 = F_121 ( V_221 ) ;
int V_223 ;
V_5 -> V_11 = V_11 ;
F_98 ( V_5 , 1 ) ;
if ( ! F_105 ( V_5 -> V_208 ) ) {
V_223 = F_122 ( V_5 -> V_208 -> V_224 ,
& V_5 -> V_78 ) ;
if ( V_223 ) {
F_19 ( V_5 -> V_90 , L_72 ) ;
goto V_225;
...
static void F_123 ( struct V_4 * V_5 , struct V_222 * V_11 )
{
int V_48 ;
...
static int F_124 ( struct V_203 * V_221 ,
struct V_222 * V_11 )
{
struct V_4 * V_5 = F_121 ( V_221 ) ;
F_123 ( V_5 , V_11 ) ;
...
V_5 -> V_11 = NULL ;
if ( ! F_105 ( V_5 -> V_208 ) )
return F_122 ( V_5 -> V_208 -> V_224 , NULL ) ;
return 0 ;
}
...
if ( F_59 ( F_37 ( V_45 ) ) )
goto V_232;
V_229 . V_228 [ V_48 ] = F_9 ( V_45 , V_156 ) ;
}
V_230 = ! F_37 ( V_45 ) ;
while ( ! F_37 ( V_45 ) ) {
V_48 = F_9 ( V_45 , V_156 ) ;
...
F_42 ( V_45 , L_74 ,
V_229 . V_227 . V_233 , V_229 . V_227 . V_234 ,
F_126 ( V_229 . V_227 . V_235 ) , F_126 ( V_229 . V_227 . V_236 ) ,
F_126 ( V_229 . V_227 . V_237 ) ) ;
if ( F_59 ( V_230 ) )
goto V_232;
if ( V_229 . V_227 . V_233 & V_150 )
F_40 ( V_5 , V_181 ) ;
else
F_40 ( V_5 , V_182 ) ;
F_33 ( V_45 , V_57 | V_63 ) ;
F_66 ( & V_45 -> V_148 , V_145 ) ;
V_48 = V_5 -> V_11 -> V_238 ( & V_5 -> V_78 , & V_229 . V_227 ) ;
F_69 ( & V_45 -> V_148 , V_145 ) ;
if ( V_48 < 0 )
goto V_232;
V_12:
...
F_42 ( V_45 , L_75 ,
F_9 ( V_45 , V_56 ) , V_48 ) ;
F_33 ( V_45 , V_59 | V_239 ) ;
F_40 ( V_5 , V_189 ) ;
goto V_12;
}
static void F_127 ( struct V_4 * V_5 , int V_240 , int V_241 )
{
T_1 V_242 ;
struct V_44 * V_45 = & V_5 -> V_44 [ 0 ] ;
...
V_242 = F_9 ( V_45 , V_56 ) ;
F_42 ( V_45 , L_76 ,
F_41 ( V_5 ) , V_47 , V_242 , F_9 ( V_45 , V_69 ) ,
( V_240 << 1 | V_241 ) ) ;
if ( V_242 & V_60 ) {
F_42 ( V_45 , L_77 ) ;
F_74 ( V_45 , - V_243 ) ;
...
V_47 . V_237 = 0 ;
F_40 ( V_5 , V_179 ) ;
V_5 -> V_11 -> V_238 ( & V_5 -> V_78 , & V_47 ) ;
F_33 ( & V_5 -> V_44 [ 0 ] , V_248 ) ;
}
...
static void F_130 ( int V_251 , struct V_4 * V_5 )
{
int V_48 ;
struct V_44 * V_45 ;
T_1 V_252 = F_3 ( V_5 , V_36 ) & V_253 ;
T_1 V_254 = F_3 ( V_5 , V_37 ) & V_255 ;
if ( V_252 & V_256 ) {
V_5 -> V_44 [ 0 ] . V_39 . V_68 ++ ;
F_29 ( V_5 , V_36 , F_131 ( 0 , V_256 ) ) ;
F_127 ( V_5 , ! ! ( V_252 & V_257 ) ,
! ! ( V_252 & V_258 ) ) ;
}
V_252 >>= 2 ;
for ( V_48 = 1 ; V_252 != 0 && V_48 < 16 ; V_252 >>= 2 , V_48 ++ ) {
if ( ! ( V_252 & V_256 ) )
continue;
F_29 ( V_5 , V_36 , F_131 ( V_48 , V_256 ) ) ;
...
for ( V_48 = 16 ; V_254 != 0 && V_48 < 24 ; V_254 >>= 2 , V_48 ++ ) {
F_29 ( V_5 , V_37 , F_131 ( V_48 - 16 , V_256 ) ) ;
if ( ! ( V_254 & V_256 ) )
continue;
F_56 ( V_48 >= F_132 ( V_5 -> V_44 ) ) ;
if ( V_48 < F_132 ( V_5 -> V_44 ) ) {
...
V_5 -> V_39 . V_42 ++ ;
if ( V_5 -> V_78 . V_173 != V_174
&& V_5 -> V_11 && V_5 -> V_11 -> V_262 )
V_5 -> V_11 -> V_262 ( & V_5 -> V_78 ) ;
}
static void F_135 ( struct V_4 * V_5 )
{
unsigned V_92 , V_93 , V_98 , V_263 ;
T_1 V_109 = F_3 ( V_5 , V_17 ) ;
F_29 ( V_5 , V_37 , V_264 ) ;
V_5 -> V_39 . V_43 ++ ;
...
memset ( & V_5 -> V_39 , 0 , sizeof V_5 -> V_39 ) ;
F_74 ( V_45 , - V_231 ) ;
F_33 ( V_45 , V_239 | V_63 ) ;
F_43 ( V_5 ) ;
}
static T_4 F_138 ( int V_251 , void * V_266 )
{
struct V_4 * V_5 = V_266 ;
T_1 V_252 = F_3 ( V_5 , V_36 ) ;
T_1 V_254 = F_3 ( V_5 , V_37 ) ;
T_1 V_109 = F_3 ( V_5 , V_17 ) ;
T_1 V_267 ;
F_139 ( V_5 -> V_90 , L_84
L_85 , V_252 , V_254 , V_109 ) ;
V_267 = V_254 & 0xf8000000 ;
if ( F_59 ( V_267 & V_259 ) )
F_133 ( V_5 ) ;
if ( F_59 ( V_267 & V_261 ) )
F_134 ( V_5 ) ;
...
if ( F_59 ( V_267 & V_265 ) )
F_136 ( V_5 ) ;
if ( ( V_252 & V_253 ) | ( V_254 & V_255 ) )
F_130 ( V_251 , V_5 ) ;
return V_268 ;
}
static int F_140 ( struct V_269 * V_270 )
{
struct V_271 * V_272 ;
struct V_4 * V_5 = & V_273 ;
int V_223 = 0 , V_274 ;
V_272 = F_141 ( V_270 , V_275 , 0 ) ;
if ( ! V_272 )
return - V_276 ;
V_5 -> V_251 = F_142 ( V_270 , 0 ) ;
if ( V_5 -> V_251 < 0 )
return V_5 -> V_251 ;
V_5 -> V_90 = & V_270 -> V_90 ;
V_5 -> V_196 = F_143 ( & V_270 -> V_90 ) ;
V_5 -> V_208 = F_144 ( V_277 ) ;
V_274 = V_5 -> V_196 -> V_197 ;
if ( F_99 ( V_274 ) ) {
V_223 = F_145 ( V_274 , L_86 ) ;
if ( V_223 == 0 )
F_146 ( V_274 ,
V_5 -> V_196 -> V_198 ) ;
}
if ( V_223 ) {
F_19 ( & V_270 -> V_90 , L_87 ,
V_274 , V_223 ) ;
return V_223 ;
}
V_5 -> V_212 = F_147 ( & V_270 -> V_90 , NULL ) ;
if ( F_16 ( V_5 -> V_212 ) ) {
V_223 = F_148 ( V_5 -> V_212 ) ;
goto V_278;
}
V_223 = F_149 ( V_5 -> V_212 ) ;
if ( V_223 )
goto V_279;
V_223 = - V_280 ;
V_5 -> V_272 = F_150 ( V_272 -> V_281 , F_151 ( V_272 ) ) ;
if ( ! V_5 -> V_272 ) {
F_19 ( & V_270 -> V_90 , L_88 ) ;
goto V_282;
}
V_5 -> V_207 = 0 ;
V_283 = V_5 ;
...
F_114 ( V_5 ) ;
F_49 ( V_5 ) ;
V_223 = F_153 ( V_5 -> V_251 , F_138 ,
V_284 , V_14 , V_5 ) ;
if ( V_223 != 0 ) {
F_19 ( V_5 -> V_90 , L_89 ,
V_14 , V_5 -> V_251 , V_223 ) ;
goto V_285;
}
V_223 = F_154 ( & V_270 -> V_90 , & V_5 -> V_78 ) ;
if ( V_223 )
goto V_286;
F_14 ( V_5 ) ;
return 0 ;
...
static int F_159 ( struct V_269 * V_266 )
{
struct V_4 * V_5 = F_160 ( V_266 ) ;
int V_274 = V_5 -> V_196 -> V_197 ;
F_161 ( & V_5 -> V_78 ) ;
F_162 ( V_5 -> V_11 ) ;
F_155 ( V_5 -> V_251 , V_5 ) ;
F_20 ( V_5 ) ;
...
static void F_165 ( struct V_269 * V_266 )
{
struct V_4 * V_5 = F_160 ( V_266 ) ;
if ( F_3 ( V_5 , V_17 ) & V_27 )
F_109 ( V_5 ) ;
}
static int F_166 ( struct V_269 * V_266 , T_5 V_75 )
{
int V_48 ;
struct V_4 * V_5 = F_160 ( V_266 ) ;
struct V_44 * V_45 ;
V_45 = & V_5 -> V_44 [ 0 ] ;
V_5 -> V_242 = F_9 ( V_45 , V_56 ) ;
for ( V_48 = 1 ; V_48 < V_50 ; V_48 ++ ) {
V_45 = & V_5 -> V_44 [ V_48 ] ;
V_45 -> V_287 = F_9 ( V_45 , V_56 ) ;
V_45 -> V_288 = F_9 ( V_45 , V_17 ) ;
F_42 ( V_45 , L_90 ,
V_45 -> V_287 , V_45 -> V_288 ) ;
}
F_109 ( V_5 ) ;
V_5 -> V_289 = V_5 -> V_202 ;
F_98 ( V_5 , 0 ) ;
...
static int F_167 ( struct V_269 * V_266 )
{
int V_48 ;
struct V_4 * V_5 = F_160 ( V_266 ) ;
struct V_44 * V_45 ;
V_45 = & V_5 -> V_44 [ 0 ] ;
F_35 ( V_45 , V_56 , V_5 -> V_242 & ( V_59 | V_61 ) ) ;
for ( V_48 = 1 ; V_48 < V_50 ; V_48 ++ ) {
V_45 = & V_5 -> V_44 [ V_48 ] ;
F_35 ( V_45 , V_56 , V_45 -> V_287 ) ;
F_35 ( V_45 , V_17 , V_45 -> V_288 ) ;
F_42 ( V_45 , L_90 ,
V_45 -> V_287 , V_45 -> V_288 ) ;
}
F_98 ( V_5 , V_5 -> V_289 ) ;
