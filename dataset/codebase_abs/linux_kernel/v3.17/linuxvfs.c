...
F_6 ( V_12 , L_56 ,
V_70 -> V_86 . V_159 ) ;
V_70 -> V_34 = F_90 ( V_70 -> V_86 . V_159 ) ;
if ( ! V_70 -> V_34 ) {
F_17 ( V_12 , L_57
L_58 ,
V_70 -> V_86 . V_159 ) ;
...
static int
F_92 ( struct V_11 * V_12 , int * V_27 , char * V_111 )
{
F_93 ( V_12 ) ;
if ( ! ( * V_27 & V_178 ) )
return - V_145 ;
...
static int
F_94 ( struct V_25 * V_25 , struct V_189 * V_190 )
{
struct V_11 * V_12 = V_25 -> V_130 ;
...
static struct V_25 *
F_96 ( struct V_207 * V_208 , int V_27 , const char * V_209 ,
void * V_111 )
{
return F_97 ( V_208 , V_27 , V_209 , V_111 , F_79 ) ;
}
static int T_9
F_98 ( void )
{
