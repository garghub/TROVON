...
unsigned long V_103 = ( ( V_89 -> V_81 - ( V_104 ) V_89 -> V_95 ) *
48 + V_91 / 2 ) / V_91 + 16 ;
if ( V_103 >= 32 )
V_103 &= ~ 1 ;
...
unsigned long V_106 = ( ( exp -> V_81 - ( V_104 ) exp -> V_95 ) *
479 + V_91 / 2 ) / V_91 + 1 ;
...
V_7 -> V_27 = V_12 ;
V_7 -> V_11 = F_16 ( V_12 ) ? & V_111 :
& V_112 ;
V_13 = F_7 ( V_9 , V_113 , 1 ) ;
if ( V_13 < 0 )
goto V_110;
F_37 ( 200 ) ;
if ( F_5 ( V_9 , V_113 ) ) {
...
if ( V_114 && ( ! strcmp ( L_6 , V_114 ) ||
! strcmp ( L_7 , V_114 ) ) ) {
V_13 = F_7 ( V_9 , V_115 , 4 | 0x11 ) ;
V_7 -> V_71 = V_76 ;
V_7 -> V_37 = V_38 ;
} else {
V_13 = F_7 ( V_9 , V_115 , 0x11 ) ;
V_7 -> V_71 = V_72 ;
V_7 -> V_37 = V_116 ;
}
if ( V_13 < 0 )
...
static int F_39 ( struct V_24 * V_25 , T_3 * V_120 )
{
struct V_8 * V_9 = F_14 ( V_25 ) ;
struct V_7 * V_7 = F_2 ( V_9 ) ;
* V_120 = V_7 -> V_49 ;
...
static int F_40 ( struct V_24 * V_25 , unsigned int V_121 ,
enum V_2 * V_3 )
{
struct V_8 * V_9 = F_14 ( V_25 ) ;
struct V_7 * V_7 = F_2 ( V_9 ) ;
...
struct V_8 * V_9 = F_14 ( V_25 ) ;
struct V_83 * V_84 = F_31 ( V_9 ) ;
V_123 -> V_107 = V_124 | V_125 |
V_126 | V_127 |
V_128 | V_129 |
V_130 | V_131 |
V_132 ;
V_123 -> type = V_133 ;
V_123 -> V_107 = F_42 ( V_84 , V_123 ) ;
return 0 ;
}
...
struct V_83 * V_84 = F_31 ( V_9 ) ;
struct V_7 * V_7 = F_2 ( V_9 ) ;
unsigned long V_107 = F_42 ( V_84 , V_123 ) ;
unsigned int V_134 = F_44 ( V_7 -> V_4 -> V_3 ) -> V_135 ;
int V_13 ;
T_2 V_136 = 0 ;
if ( V_84 -> V_137 ) {
V_13 = V_84 -> V_137 ( V_84 , 1 << ( V_134 - 1 ) ) ;
if ( V_13 )
return V_13 ;
} else if ( V_134 != 10 ) {
return - V_73 ;
...
if ( ! ( V_107 & V_130 ) )
V_136 |= 0x2 ;
V_13 = F_7 ( V_9 , V_7 -> V_11 -> V_138 , V_136 ) ;
if ( V_13 < 0 )
return V_13 ;
if ( ! ( V_107 & V_124 ) )
V_7 -> V_14 &= ~ 0x8 ;
...
struct V_7 * V_7 ;
struct V_83 * V_84 = F_31 ( V_9 ) ;
struct V_141 * V_142 = F_46 ( V_9 -> V_56 . V_143 ) ;
struct V_144 * V_145 ;
int V_13 ;
if ( ! V_84 ) {
F_38 ( & V_9 -> V_56 , L_12 ) ;
...
V_7 = F_49 ( & V_9 -> V_56 , sizeof( struct V_7 ) , V_147 ) ;
if ( ! V_7 )
return - V_148 ;
V_145 = V_84 -> V_149 ;
F_50 ( & V_7 -> V_10 , V_9 , & V_150 ) ;
F_51 ( & V_7 -> V_23 , 6 ) ;
F_52 ( & V_7 -> V_23 , & V_151 ,
V_101 , 0 , 1 , 1 , 0 ) ;
F_52 ( & V_7 -> V_23 , & V_151 ,
V_102 , 0 , 1 , 1 , 0 ) ;
V_7 -> V_152 = F_52 ( & V_7 -> V_23 , & V_151 ,
V_93 , 0 , 1 , 1 , 1 ) ;
V_7 -> V_89 = F_52 ( & V_7 -> V_23 , & V_151 ,
V_153 , 0 , 127 , 1 , 64 ) ;
V_7 -> V_154 = F_53 ( & V_7 -> V_23 ,
& V_151 , V_96 , 1 , 0 ,
V_105 ) ;
V_7 -> V_90 = F_52 ( & V_7 -> V_23 , & V_151 ,
V_155 , 1 , 255 , 1 , 255 ) ;
V_7 -> V_52 = F_52 ( & V_7 -> V_23 , & V_151 ,
V_97 , V_156 ,
V_157 , 1 ,
V_158 ) ;
V_7 -> V_53 = F_52 ( & V_7 -> V_23 , & V_151 ,
V_99 , V_159 ,
V_160 , 1 ,
V_161 ) ;
V_7 -> V_10 . V_162 = & V_7 -> V_23 ;
if ( V_7 -> V_23 . error ) {
int V_163 = V_7 -> V_23 . error ;
F_38 ( & V_9 -> V_56 , L_14 , V_163 ) ;
return V_163 ;
}
F_54 ( 2 , & V_7 -> V_154 ,
V_164 , true ) ;
F_54 ( 2 , & V_7 -> V_152 , 0 , true ) ;
V_7 -> V_14 = V_165 ;
V_7 -> V_49 = V_145 ? V_145 -> V_49 : 0 ;
V_7 -> V_33 . V_41 = V_42 ;
V_7 -> V_33 . V_45 = V_46 ;
V_7 -> V_33 . V_39 = V_44 ;
V_7 -> V_33 . V_40 = V_48 ;
