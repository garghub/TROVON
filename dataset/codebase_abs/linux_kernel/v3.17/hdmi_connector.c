...
V_7 = F_1 ( V_1 , true ) ;
if ( V_7 ) {
F_3 ( V_4 -> V_4 , L_10 , V_7 ) ;
goto V_26;
}
for ( V_25 = 0 ; V_25 < V_6 -> V_27 ; V_25 ++ ) {
if ( V_6 -> V_28 && V_6 -> V_28 [ V_25 ] ) {
V_7 = F_9 ( V_1 -> V_29 [ V_25 ] ,
V_6 -> V_28 [ V_25 ] ) ;
if ( V_7 )
F_10 ( V_4 -> V_4 , L_11 ,
V_6 -> V_30 [ V_25 ] , V_7 ) ;
}
V_7 = F_11 ( V_1 -> V_29 [ V_25 ] ) ;
if ( V_7 ) {
F_3 ( V_4 -> V_4 , L_12 ,
V_6 -> V_30 [ V_25 ] , V_7 ) ;
goto V_26;
...
static int F_17 ( struct V_20 * V_20 )
{
struct V_1 * V_1 = V_20 -> V_1 ;
const struct V_5 * V_6 = V_1 -> V_6 ;
struct V_3 * V_4 = V_20 -> V_21 . V_4 ;
...
struct V_45 * F_43 ( struct V_1 * V_1 )
{
struct V_45 * V_46 = NULL ;
struct V_20 * V_20 ;
int V_7 ;
V_20 = F_44 ( sizeof( * V_20 ) , V_82 ) ;
if ( ! V_20 ) {
V_7 = - V_83 ;
goto V_26;
}
