...
static int F_82 ( char * V_93 , int V_63 ,
struct V_94 * V_95 ,
struct V_94 * V_96 )
{
int V_97 ;
...
union V_102 V_103 ;
V_103 . V_100 = * V_100 ;
* V_101 = F_85 ( V_103 . V_104 ) ;
}
static void F_86 ( T_2 V_101 ,
struct V_99 * V_100 )
{
union V_102 V_103 ;
V_103 . V_104 = F_87 ( V_101 ) ;
* V_100 = V_103 . V_100 ;
}
static int F_88 ( struct V_59 * V_60 , T_2 V_21 , void * V_61 ,
void * * V_62 )
{
struct V_105 * V_106 ;
struct V_99 V_100 = {
...
static int F_91 ( struct V_59 * V_60 , T_2 V_21 , void * V_61 ,
void * * V_62 )
{
struct V_127 * assert ;
struct V_14 * V_15 = NULL ;
...
V_136 = F_94 ( V_145 , V_131 / V_144 ) ;
V_136 = F_95 ( V_130 , ( T_1 ) V_136 ) ;
V_134 = V_130 ;
...
static int F_96 ( struct V_14 * V_15 , unsigned long * V_114 )
{
...
goto V_143;
V_129 = F_97 ( sizeof( struct V_128 ) , V_9 ) ;
if ( ! V_129 ) {
V_33 = - V_147 ;
F_98 ( V_33 ) ;
goto V_143;
...
static int F_99 ( struct V_59 * V_60 , T_2 V_21 ,
void * V_61 , void * * V_62 )
{
struct V_128 * V_129 ;
struct V_14 * V_15 = NULL ;
...
V_76 = F_92 ( V_15 , V_129 , V_130 , sizeof( V_129 -> V_133 ) ) ;
V_152:
F_26 ( & V_15 -> V_26 ) ;
V_151:
F_26 ( & V_32 ) ;
...
static int F_100 ( struct V_14 * V_15 , struct V_153 * V_154 )
{
struct V_155 * V_130 ;
struct V_156 * V_132 ;
int V_10 , V_137 ;
...
static int F_104 ( struct V_14 * V_15 , unsigned long * V_114 )
{
...
if ( F_66 ( V_114 , V_73 , 0 ) >= V_73 )
goto V_143;
V_154 = F_97 ( sizeof( struct V_153 ) , V_9 ) ;
if ( ! V_154 ) {
V_33 = - V_147 ;
F_98 ( V_33 ) ;
goto V_143;
...
static int F_105 ( struct V_59 * V_60 , T_2 V_21 ,
void * V_61 , void * * V_62 )
{
struct V_153 * V_154 ;
struct V_14 * V_15 = NULL ;
...
static int F_106 ( struct V_59 * V_60 , T_2 V_21 , void * V_61 ,
void * * V_62 )
{
struct V_171 * V_172 ;
struct V_14 * V_15 = NULL ;
...
V_76 = 0 ;
* V_103 = V_111 ;
} else if ( V_100 . V_107 == V_108 ||
V_100 . V_107 == V_111 ) {
* V_103 = V_100 . V_107 ;
} else if ( V_100 . V_107 == V_121 ) {
F_11 ( V_89 ,
L_81
L_82
L_83
...
F_11 ( 0 , L_94 , V_15 ) ;
V_187 = F_97 ( sizeof( * V_187 ) , V_9 ) ;
if ( ! V_187 ) {
V_76 = - V_147 ;
F_98 ( V_76 ) ;
goto V_143;
}
F_115 ( V_15 -> V_180 , sizeof( V_15 -> V_180 ) ) ;
F_25 ( & V_15 -> V_26 ) ;
...
if ( V_15 -> V_81 . V_82 > 1 ||
V_15 -> V_81 . V_83 > 0 ) {
V_76 = F_104 ( V_15 , V_187 -> V_189 ) ;
if ( V_76 ) {
F_98 ( V_76 ) ;
goto V_143;
}
V_76 = F_96 ( V_15 , V_187 -> V_189 ) ;
if ( V_76 ) {
F_98 ( V_76 ) ;
goto V_143;
}
}
F_112 ( V_15 , V_187 -> V_189 ) ;
F_25 ( & V_32 ) ;
V_15 -> V_34 = V_35 ;
V_15 -> V_40 ++ ;
F_26 ( & V_32 ) ;
...
{
F_116 ( V_15 -> V_19 , & V_15 -> V_190 ) ;
F_116 ( V_15 -> V_19 , & V_15 -> V_191 ) ;
F_117 ( & V_15 -> V_192 ) ;
}
...
int V_76 ;
F_11 ( 0 , L_98 ) ;
F_119 ( & V_15 -> V_191 , V_193 ,
V_194 , V_15 , V_195 ) ;
V_76 = F_120 ( V_15 -> V_19 , & V_15 -> V_191 ) ;
if ( V_76 )
goto V_143;
F_119 ( & V_15 -> V_190 , V_196 ,
V_197 , V_15 , V_198 ) ;
V_76 = F_120 ( V_15 -> V_19 , & V_15 -> V_190 ) ;
if ( V_76 )
goto V_143;
V_76 = F_121 ( V_199 , V_15 -> V_79 ,
sizeof( struct V_200 ) ,
V_201 ,
V_15 , NULL , & V_15 -> V_192 ) ;
if ( V_76 )
goto V_143;
V_76 = F_121 ( V_202 , V_15 -> V_79 ,
sizeof( struct V_203 ) ,
V_204 ,
V_15 , V_205 ,
& V_15 -> V_192 ) ;
if ( V_76 )
goto V_143;
V_76 = F_121 ( V_206 , V_15 -> V_79 ,
sizeof( struct V_207 ) ,
V_208 ,
V_15 , NULL , & V_15 -> V_192 ) ;
if ( V_76 )
goto V_143;
V_76 = F_121 ( V_209 , V_15 -> V_79 ,
V_210 ,
V_211 ,
V_15 , NULL , & V_15 -> V_192 ) ;
if ( V_76 )
goto V_143;
V_76 = F_121 ( V_212 , V_15 -> V_79 ,
V_213 ,
V_214 ,
V_15 , NULL , & V_15 -> V_192 ) ;
if ( V_76 )
goto V_143;
V_76 = F_121 ( V_215 , V_15 -> V_79 ,
V_216 ,
V_217 ,
V_15 , NULL , & V_15 -> V_192 ) ;
if ( V_76 )
goto V_143;
V_76 = F_121 ( V_86 , V_15 -> V_79 ,
sizeof( struct V_64 ) ,
F_67 ,
V_15 , NULL , & V_15 -> V_192 ) ;
if ( V_76 )
goto V_143;
V_76 = F_121 ( V_218 , V_15 -> V_79 ,
sizeof( struct V_219 ) ,
V_220 ,
V_15 , NULL , & V_15 -> V_192 ) ;
if ( V_76 )
goto V_143;
V_76 = F_121 ( V_221 , V_15 -> V_79 ,
sizeof( struct V_222 ) ,
V_223 ,
V_15 , NULL , & V_15 -> V_192 ) ;
if ( V_76 )
goto V_143;
V_76 = F_121 ( V_224 , V_15 -> V_79 ,
V_225 ,
V_226 ,
V_15 , NULL , & V_15 -> V_192 ) ;
if ( V_76 )
goto V_143;
V_76 = F_121 ( V_227 , V_15 -> V_79 ,
sizeof( struct V_228 ) ,
V_229 ,
V_15 , NULL , & V_15 -> V_192 ) ;
if ( V_76 )
goto V_143;
V_76 = F_121 ( V_230 , V_15 -> V_79 ,
sizeof( struct V_231 ) ,
V_232 ,
V_15 , NULL , & V_15 -> V_192 ) ;
if ( V_76 )
goto V_143;
V_76 = F_121 ( V_233 , V_15 -> V_79 ,
sizeof( struct V_234 ) ,
V_235 ,
V_15 , NULL , & V_15 -> V_192 ) ;
if ( V_76 )
goto V_143;
V_76 = F_121 ( V_236 , V_15 -> V_79 ,
sizeof( struct V_237 ) ,
V_238 ,
V_15 , NULL , & V_15 -> V_192 ) ;
if ( V_76 )
goto V_143;
V_76 = F_121 ( V_239 , V_15 -> V_79 ,
sizeof( struct V_240 ) ,
V_241 ,
V_15 , NULL , & V_15 -> V_192 ) ;
if ( V_76 )
goto V_143;
V_76 = F_121 ( V_84 , V_15 -> V_79 ,
sizeof( struct V_64 ) ,
F_60 ,
V_15 , NULL , & V_15 -> V_192 ) ;
if ( V_76 )
...
static struct V_14 * F_129 ( const char * V_30 ,
T_2 V_79 )
{
int V_10 ;
int V_33 ;
struct V_14 * V_15 = NULL ;
V_15 = F_97 ( sizeof( * V_15 ) , V_9 ) ;
if ( ! V_15 ) {
F_98 ( - V_147 ) ;
goto V_91;
}
V_15 -> V_19 = F_130 ( V_30 , V_9 ) ;
if ( V_15 -> V_19 == NULL ) {
F_98 ( - V_147 ) ;
F_7 ( V_15 ) ;
V_15 = NULL ;
...
F_136 ( & V_15 -> V_41 ) ;
F_136 ( & V_15 -> V_250 ) ;
F_136 ( & V_15 -> V_117 . V_251 ) ;
F_136 ( & V_15 -> V_117 . V_252 ) ;
F_136 ( & V_15 -> V_253 ) ;
F_136 ( & V_15 -> V_192 ) ;
F_136 ( & V_15 -> V_92 ) ;
V_15 -> V_117 . V_28 = 0 ;
...
F_137 ( & V_15 -> V_55 ) ;
F_137 ( & V_15 -> V_258 ) ;
F_137 ( & V_15 -> V_117 . V_259 ) ;
F_137 ( & V_15 -> V_260 ) ;
F_137 ( & V_15 -> V_261 ) ;
F_136 ( & V_15 -> V_262 ) ;
V_15 -> V_57 = V_58 ;
F_137 ( & V_15 -> V_70 ) ;
V_15 -> V_117 . V_263 = V_264 ;
V_15 -> V_117 . V_265 = V_264 ;
F_138 ( & V_15 -> V_266 , 0 ) ;
F_138 ( & V_15 -> V_267 , 0 ) ;
for ( V_10 = 0 ; V_10 < V_268 ; ++ V_10 ) {
F_138 ( & V_15 -> V_269 [ V_10 ] , 0 ) ;
F_138 ( & V_15 -> V_270 [ V_10 ] , 0 ) ;
}
F_135 ( & V_15 -> V_271 ) ;
F_136 ( & V_15 -> V_272 ) ;
F_139 ( & V_15 -> V_273 , V_274 ) ;
F_140 ( & V_15 -> V_39 ) ;
V_15 -> V_34 = V_116 ;
F_136 ( & V_15 -> V_275 ) ;
F_11 ( 0 , L_105 ,
F_141 ( & V_15 -> V_39 . V_276 ) ) ;
V_91:
return V_15 ;
}
static int F_83 ( struct V_94 * V_277 ,
struct V_94 * V_96 )
{
if ( V_277 -> V_82 != V_96 -> V_82 )
return 1 ;
if ( V_277 -> V_83 > V_96 -> V_83 )
return 1 ;
if ( V_277 -> V_83 < V_96 -> V_83 )
V_96 -> V_83 = V_277 -> V_83 ;
return 0 ;
}
struct V_14 * F_142 ( const char * V_30 ,
T_2 V_79 ,
struct V_94 * V_123 )
{
int V_33 ;
...
{
int V_76 = 0 ;
V_76 = F_121 ( V_181 , V_150 ,
sizeof( struct V_105 ) ,
F_88 ,
NULL , NULL , & V_284 ) ;
if ( V_76 )
goto V_143;
V_76 = F_121 ( V_184 , V_150 ,
sizeof( struct V_127 ) ,
F_91 ,
NULL , NULL , & V_284 ) ;
if ( V_76 )
goto V_143;
V_76 = F_121 ( V_174 , V_150 ,
sizeof( struct V_171 ) ,
F_106 ,
NULL , NULL , & V_284 ) ;
if ( V_76 )
goto V_143;
V_76 = F_121 ( V_149 , V_150 ,
sizeof( struct V_128 ) ,
F_99 ,
NULL , NULL , & V_284 ) ;
if ( V_76 )
goto V_143;
V_76 = F_121 ( V_169 , V_150 ,
sizeof( struct V_153 ) ,
F_105 ,
NULL , NULL , & V_284 ) ;
V_143:
...
V_286 -> V_288 ( V_78 , V_286 -> V_289 ) ;
}
F_150 ( & V_287 ) ;
}
void F_151 ( struct V_285 * V_286 ,
T_3 * V_290 ,
void * V_61 )
{
F_136 ( & V_286 -> V_291 ) ;
...
{
F_153 ( & V_287 ) ;
F_144 ( & V_286 -> V_291 , & V_15 -> V_275 ) ;
F_154 ( & V_287 ) ;
}
void F_155 ( struct V_285 * V_286 )
{
F_153 ( & V_287 ) ;
F_38 ( & V_286 -> V_291 ) ;
F_154 ( & V_287 ) ;
