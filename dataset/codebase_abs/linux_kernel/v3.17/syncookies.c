...
struct V_14 * V_15 ;
struct V_69 * V_70 ;
struct V_71 * V_72 = F_27 ( V_45 ) ;
const struct V_35 * V_36 = F_15 ( V_47 ) ;
T_4 V_30 = F_12 ( V_36 -> V_73 ) - 1 ;
struct V_44 * V_74 = V_45 ;
struct V_12 * V_13 ;
int V_39 ;
struct V_75 * V_76 ;
V_11 V_77 ;
...
V_15 = F_6 ( V_13 ) ;
V_70 = F_31 ( V_13 ) ;
V_70 -> V_87 = F_12 ( V_36 -> V_43 ) - 1 ;
V_70 -> V_88 = V_30 ;
V_13 -> V_39 = V_39 ;
V_15 -> V_89 = F_32 ( V_36 -> V_42 ) ;
V_15 -> V_90 = V_36 -> V_41 ;
V_15 -> V_91 = F_14 ( V_47 ) -> V_2 ;
V_15 -> V_92 = F_14 ( V_47 ) -> V_1 ;
V_15 -> V_93 = F_33 ( V_45 , V_47 ) ;
V_15 -> V_23 = V_23 ;
V_15 -> V_21 = V_57 . V_21 ;
V_15 -> V_22 = V_57 . V_22 ;
V_15 -> V_20 = V_57 . V_20 ;
V_15 -> V_94 = V_57 . V_60 ;
V_13 -> V_95 = V_57 . V_60 ? V_57 . V_96 : 0 ;
V_70 -> V_97 = V_57 . V_60 ? V_57 . V_59 : 0 ;
V_70 -> V_98 = NULL ;
if ( V_68 && V_68 -> V_99 ) {
int V_100 = sizeof( struct V_101 ) + V_68 -> V_99 ;
V_15 -> V_68 = F_34 ( V_100 , V_102 ) ;
if ( V_15 -> V_68 != NULL && F_35 ( & V_15 -> V_68 -> V_68 , V_47 ) ) {
F_36 ( V_15 -> V_68 ) ;
V_15 -> V_68 = NULL ;
}
}
if ( F_37 ( V_45 , V_47 , V_13 ) ) {
F_23 ( V_13 ) ;
goto V_83;
}
V_13 -> V_103 = 0UL ;
V_13 -> V_104 = 0 ;
F_38 ( & V_79 , V_45 -> V_105 , V_15 -> V_93 ,
F_39 ( V_45 ) , V_106 , V_107 ,
F_40 ( V_45 ) ,
( V_68 && V_68 -> V_108 ) ? V_68 -> V_109 : V_15 -> V_92 ,
V_15 -> V_91 , V_36 -> V_41 , V_36 -> V_42 ) ;
F_41 ( V_13 , F_42 ( & V_79 ) ) ;
V_76 = F_43 ( F_18 ( V_45 ) , & V_79 ) ;
if ( F_44 ( V_76 ) ) {
F_23 ( V_13 ) ;
goto V_83;
}
V_13 -> V_110 = V_72 -> V_110 ? : F_45 ( & V_76 -> V_50 , V_111 ) ;
F_46 ( F_47 ( V_45 ) , V_13 -> V_39 ,
& V_13 -> V_112 , & V_13 -> V_110 ,
V_15 -> V_20 , & V_77 ,
F_45 ( & V_76 -> V_50 , V_113 ) ) ;
V_15 -> V_77 = V_77 ;
V_74 = F_20 ( V_45 , V_47 , V_13 , & V_76 -> V_50 ) ;
if ( V_74 )
F_48 ( V_74 ) -> V_114 . V_115 . V_116 . V_117 = V_79 ;
V_83: return V_74 ;
}
