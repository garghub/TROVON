...
if ( V_7 ) {
V_31 = * F_4 ( V_7 , V_8 ) ;
F_30 ( 0x8000001e , & V_77 , & V_78 , & V_79 , & V_80 ) ;
V_31 -> V_74 = V_79 & 0xff ;
V_31 = F_27 ( V_31 , V_7 ) ;
* F_4 ( V_7 , V_8 ) = V_31 ;
}
if ( V_9 ) {
unsigned int V_81 = F_31 ( V_8 ) . V_81 ;
unsigned int V_82 ;
V_31 = * F_4 ( V_9 , V_8 ) ;
F_32 ( 0x8000001d , 2 , & V_77 , & V_78 , & V_79 , & V_80 ) ;
V_82 = ( ( V_77 >> 14 ) & 0xfff ) + 1 ;
V_31 -> V_74 = V_81 - ( V_81 % V_82 ) ;
V_31 = F_27 ( V_31 , V_9 ) ;
* F_4 ( V_9 , V_8 ) = V_31 ;
}
}
...
{
unsigned int V_30 ;
struct V_6 * V_71 = * F_4 ( V_72 , V_8 ) ;
if ( V_71 -> V_8 != V_8 )
return;
F_28 (i) {
struct V_6 * V_73 = * F_4 ( V_72 , V_30 ) ;
if ( V_8 == V_30 )
continue;
if ( V_71 == V_73 ) {
F_37 ( V_71 -> V_3 , V_8 , V_30 ) ;
F_38 ( V_8 , V_73 -> V_56 ) ;
F_34 ( V_30 , V_73 -> V_56 ) ;
V_73 -> V_8 = V_30 ;
break;
...
static void F_40 ( unsigned int V_8 , struct V_6 * T_5 * V_72 )
{
struct V_6 * V_31 = * F_4 ( V_72 , V_8 ) ;
if ( V_8 == V_31 -> V_8 )
F_38 ( V_8 , V_31 -> V_56 ) ;
...
static int
F_42 ( struct V_83 * V_84 , unsigned long V_85 ,
void * V_86 )
{
unsigned int V_8 = ( long ) V_86 ;
switch ( V_85 & ~ V_87 ) {
case V_88 :
if ( F_25 ( V_8 ) )
return F_43 ( - V_70 ) ;
...
static void T_6 F_44 ( void * V_95 )
{
