...
struct V_10 * F_76 ( struct V_121 * V_14 ,
const struct V_122 * V_123 )
{
struct V_10 * V_11 ;
struct V_4 * V_5 ;
V_11 = F_77 ( sizeof( struct V_10 ) +
sizeof( struct V_4 ) , V_124 ) ;
if ( ! V_11 )
return NULL ;
F_78 ( V_11 , V_123 ) ;
V_5 = F_13 ( V_11 ) ;
...
int F_80 ( struct V_10 * V_11 , T_6 V_127 , T_1 V_128 )
{
struct V_4 * V_5 = F_13 ( V_11 ) ;
T_1 V_129 = F_81 ( V_127 ) ;
T_1 V_130 = F_82 ( V_127 ) ;
T_1 V_131 ;
if ( V_130 & ~ 0xF )
return - V_85 ;
if ( V_129 & 0xF )
...
V_131 = V_133 ;
V_131 |= V_130 << V_134 ;
F_11 ( V_5 , V_135 , V_128 ) ;
F_11 ( V_5 , V_136 , V_129 ) ;
F_11 ( V_5 , V_137 , V_131 ) ;
