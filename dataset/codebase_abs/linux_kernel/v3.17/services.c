...
static inline int F_114 ( const char * V_326 ,
char * V_327 ,
T_1 V_328 ,
T_3 * V_206 )
{
...
int V_335 ;
F_39 ( & V_180 ) ;
V_335 = F_114 ( V_326 , V_327 , V_328 , V_206 ) ;
F_41 ( & V_180 ) ;
return V_335 ;
}
int F_116 ( struct V_336 * V_337 )
{
int V_178 = 0 ;
struct V_165 * V_48 ;
struct V_338 * V_339 = V_337 -> V_340 ;
const char * V_326 = V_337 -> V_341 -> V_15 ;
F_39 ( & V_180 ) ;
V_48 = V_1 . V_268 [ V_342 ] ;
while ( V_48 ) {
...
V_339 -> V_206 = V_48 -> V_206 [ 0 ] ;
} else {
V_178 = F_114 ( V_326 , L_42 , V_344 ,
& V_339 -> V_206 ) ;
if ( V_178 ) {
V_339 -> V_343 = V_345 ;
V_178 = 0 ;
...
int F_117 ( int * V_201 , char * * * V_91 , int * * V_347 )
{
int V_10 , V_178 ;
F_39 ( & V_180 ) ;
* V_91 = NULL ;
...
goto V_24;
V_178 = - V_17 ;
* V_347 = F_2 ( * V_201 , sizeof( int ) , V_16 ) ;
if ( ! * V_347 )
goto V_24;
for ( V_10 = 0 ; V_10 < * V_201 ; V_10 ++ ) {
T_2 V_349 ;
( * V_347 ) [ V_10 ] = V_1 . V_350 [ V_10 ] -> V_351 ;
V_349 = strlen ( F_20 ( & V_1 , V_352 , V_10 ) ) + 1 ;
V_178 = - V_17 ;
( * V_91 ) [ V_10 ] = F_48 ( sizeof( char ) * V_349 , V_16 ) ;
if ( ! ( * V_91 ) [ V_10 ] )
goto V_24;
strncpy ( ( * V_91 ) [ V_10 ] , F_20 ( & V_1 , V_352 , V_10 ) , V_349 ) ;
( * V_91 ) [ V_10 ] [ V_349 - 1 ] = 0 ;
}
V_178 = 0 ;
V_114:
...
F_102 ( & V_180 ) ;
V_178 = - V_356 ;
V_353 = V_1 . V_348 . V_144 ;
if ( V_201 != V_353 )
goto V_114;
for ( V_10 = 0 ; V_10 < V_201 ; V_10 ++ ) {
if ( ! ! V_347 [ V_10 ] != V_1 . V_350 [ V_10 ] -> V_351 ) {
F_37 ( V_115 -> V_116 , V_16 ,
V_357 ,
L_43 ,
F_20 ( & V_1 , V_352 , V_10 ) ,
! ! V_347 [ V_10 ] ,
V_1 . V_350 [ V_10 ] -> V_351 ,
F_119 ( & V_358 , F_120 ( V_115 ) ) ,
F_121 ( V_115 ) ) ;
}
if ( V_347 [ V_10 ] )
V_1 . V_350 [ V_10 ] -> V_351 = 1 ;
else
V_1 . V_350 [ V_10 ] -> V_351 = 0 ;
}
for ( V_355 = V_1 . V_359 ; V_355 ; V_355 = V_355 -> V_59 ) {
V_178 = F_122 ( & V_1 , V_355 ) ;
if ( V_178 )
goto V_114;
}
V_191 = ++ V_192 ;
...
{
int V_178 , V_360 = 0 , * V_361 = NULL , V_10 ;
char * * V_362 = NULL ;
struct V_363 * V_364 ;
struct V_354 * V_355 ;
V_178 = F_117 ( & V_360 , & V_362 , & V_361 ) ;
if ( V_178 )
goto V_114;
for ( V_10 = 0 ; V_10 < V_360 ; V_10 ++ ) {
V_364 = F_57 ( V_217 -> V_348 . V_113 , V_362 [ V_10 ] ) ;
if ( V_364 )
V_364 -> V_351 = V_361 [ V_10 ] ;
}
for ( V_355 = V_217 -> V_359 ; V_355 ; V_355 = V_355 -> V_59 ) {
V_178 = F_122 ( V_217 , V_355 ) ;
if ( V_178 )
goto V_114;
}
V_114:
...
int F_124 ( T_3 V_206 , T_3 V_365 , T_3 * V_186 )
{
struct V_40 * V_366 ;
struct V_40 * V_367 ;
struct V_40 V_368 ;
...
V_178 = - V_14 ;
V_367 = F_40 ( & V_183 , V_365 ) ;
if ( ! V_367 ) {
F_4 ( V_181 L_17 ,
V_182 , V_365 ) ;
goto V_210;
}
V_368 . V_67 = V_366 -> V_67 ;
V_368 . V_70 = V_366 -> V_70 ;
V_368 . type = V_366 -> type ;
V_178 = F_125 ( & V_368 , V_367 ) ;
if ( V_178 )
goto V_210;
if ( ! F_59 ( & V_1 , & V_368 ) ) {
V_178 = F_78 ( & V_368 ) ;
if ( V_178 ) {
if ( ! F_22 ( & V_368 , & V_56 , & V_201 ) ) {
F_37 ( V_115 -> V_116 , V_16 , V_117 ,
L_44 , V_56 ) ;
F_6 ( V_56 ) ;
}
...
V_178 = - V_14 ;
V_374 = F_40 ( & V_183 , V_371 ) ;
if ( ! V_374 ) {
F_4 ( V_181 L_17 ,
V_182 , V_371 ) ;
goto V_114;
}
V_178 = ( F_127 ( V_373 , V_374 ) ? 0 : - V_231 ) ;
if ( V_178 )
goto V_114;
* V_372 = V_371 ;
V_114:
...
char * V_15 = V_12 , * * V_376 = args ;
int V_21 = V_155 -> V_21 - 1 ;
V_376 [ V_21 ] = F_46 ( V_15 , V_16 ) ;
if ( ! V_376 [ V_21 ] )
return - V_17 ;
return 0 ;
}
int F_129 ( char * * * V_376 , int * V_377 )
{
int V_178 ;
F_39 ( & V_180 ) ;
V_178 = - V_17 ;
* V_377 = V_1 . V_143 . V_144 ;
* V_376 = F_2 ( * V_377 , sizeof( * * V_376 ) , V_16 ) ;
if ( ! * V_376 )
goto V_114;
V_178 = F_21 ( V_1 . V_143 . V_113 , F_128 ,
* V_376 ) ;
if ( V_178 ) {
int V_10 ;
...
static int F_130 ( void * V_12 , void * V_92 , void * args )
{
...
int F_131 ( char * V_378 , char * * * V_25 , int * V_379 )
{
int V_178 , V_10 ;
struct V_100 * V_380 ;
F_39 ( & V_180 ) ;
V_178 = - V_14 ;
V_380 = F_57 ( V_1 . V_143 . V_113 , V_378 ) ;
if ( ! V_380 ) {
F_4 ( V_181 L_45 ,
V_182 , V_378 ) ;
goto V_114;
...
V_178 = - V_17 ;
* V_379 = V_380 -> V_96 . V_144 ;
* V_25 = F_2 ( * V_379 , sizeof( * * V_25 ) , V_16 ) ;
if ( ! * V_25 )
goto V_114;
if ( V_380 -> V_112 ) {
V_178 = F_21 ( V_380 -> V_112 -> V_96 . V_113 ,
F_130 , * V_25 ) ;
if ( V_178 )
goto V_24;
}
V_178 = F_21 ( V_380 -> V_96 . V_113 , F_130 ,
* V_25 ) ;
if ( V_178 )
goto V_24;
V_114:
...
int F_134 ( unsigned int V_381 )
{
int V_178 ;
F_39 ( & V_180 ) ;
V_178 = F_13 ( & V_1 . V_272 , V_381 ) ;
F_41 ( & V_180 ) ;
return V_178 ;
}
void F_135 ( void * V_382 )
{
struct V_383 * V_384 = V_382 ;
if ( V_384 ) {
F_60 ( & V_384 -> V_385 ) ;
F_6 ( V_384 ) ;
}
}
int F_136 ( T_3 V_386 , T_3 V_72 , char * V_387 , void * * V_382 )
{
struct V_383 * V_388 ;
struct V_49 * V_389 ;
struct V_122 * V_390 ;
...
V_388 = F_86 ( sizeof( struct V_383 ) , V_228 ) ;
if ( ! V_388 )
return - V_17 ;
F_56 ( & V_388 -> V_385 ) ;
F_39 ( & V_180 ) ;
...
case V_396 :
V_178 = - V_14 ;
V_391 = F_57 ( V_1 . V_219 . V_113 , V_387 ) ;
if ( ! V_391 )
goto V_114;
V_388 -> V_385 . V_67 = V_391 -> V_21 ;
break;
case V_394 :
case V_397 :
V_178 = - V_14 ;
V_389 = F_57 ( V_1 . V_220 . V_113 , V_387 ) ;
if ( ! V_389 )
goto V_114;
V_388 -> V_385 . V_70 = V_389 -> V_21 ;
break;
case V_395 :
case V_398 :
V_178 = - V_14 ;
V_390 = F_57 ( V_1 . V_221 . V_113 , V_387 ) ;
if ( ! V_390 )
goto V_114;
V_388 -> V_385 . type = V_390 -> V_21 ;
break;
case V_401 :
case V_402 :
case V_403 :
case V_404 :
V_178 = F_137 ( V_387 , & V_388 -> V_385 , V_16 ) ;
if ( V_178 )
goto V_114;
break;
}
...
int F_138 ( struct V_406 * V_384 )
{
int V_10 ;
for ( V_10 = 0 ; V_10 < V_384 -> V_407 ; V_10 ++ ) {
struct V_408 * V_409 = & V_384 -> V_410 [ V_10 ] ;
switch ( V_409 -> type ) {
case V_393 :
case V_394 :
case V_395 :
...
int F_139 ( T_3 V_206 , T_3 V_386 , T_3 V_72 , void * V_382 ,
struct V_116 * V_411 )
{
struct V_40 * V_412 ;
struct V_52 * V_79 ;
...
F_39 ( & V_180 ) ;
if ( V_384 -> V_405 < V_192 ) {
V_380 = - V_413 ;
goto V_114;
}
V_412 = F_40 ( & V_183 , V_206 ) ;
if ( F_29 ( ! V_412 ) ) {
F_140 ( 1 , L_47 ,
V_206 ) ;
V_380 = - V_332 ;
...
switch ( V_72 ) {
case V_399 :
V_380 = ( V_412 -> V_67 == V_384 -> V_385 . V_67 ) ;
break;
case V_400 :
V_380 = ( V_412 -> V_67 != V_384 -> V_385 . V_67 ) ;
break;
...
switch ( V_72 ) {
case V_399 :
V_380 = ( V_412 -> V_70 == V_384 -> V_385 . V_70 ) ;
break;
case V_400 :
V_380 = ( V_412 -> V_70 != V_384 -> V_385 . V_70 ) ;
break;
...
switch ( V_72 ) {
case V_399 :
V_380 = ( V_412 -> type == V_384 -> V_385 . type ) ;
break;
case V_400 :
V_380 = ( V_412 -> type != V_384 -> V_385 . type ) ;
break;
...
V_79 = ( ( V_386 == V_401 ||
V_386 == V_403 ) ?
& V_412 -> V_78 . V_79 [ 0 ] : & V_412 -> V_78 . V_79 [ 1 ] ) ;
switch ( V_72 ) {
case V_399 :
V_380 = F_14 ( & V_384 -> V_385 . V_78 . V_79 [ 0 ] ,
V_79 ) ;
break;
case V_400 :
V_380 = ! F_14 ( & V_384 -> V_385 . V_78 . V_79 [ 0 ] ,
...
break;
case V_414 :
V_380 = ( F_15 ( & V_384 -> V_385 . V_78 . V_79 [ 0 ] ,
V_79 ) &&
! F_14 ( & V_384 -> V_385 . V_78 . V_79 [ 0 ] ,
V_79 ) ) ;
break;
case V_415 :
V_380 = F_15 ( & V_384 -> V_385 . V_78 . V_79 [ 0 ] ,
...
{
int V_24 ;
V_24 = F_143 ( F_141 , V_419 ) ;
if ( V_24 )
F_144 ( L_48 , V_24 ) ;
return V_24 ;
}
static void F_145 ( struct V_421 * V_422 ,
T_3 V_206 )
{
T_3 * V_423 ;
V_423 = F_48 ( sizeof( * V_423 ) , V_16 ) ;
if ( V_423 == NULL )
return;
V_422 -> V_424 = F_146 ( V_16 ) ;
if ( V_422 -> V_424 == NULL ) {
F_6 ( V_423 ) ;
return;
}
* V_423 = V_206 ;
V_422 -> V_424 -> free = F_6 ;
V_422 -> V_424 -> V_156 = V_423 ;
V_422 -> V_193 |= V_425 ;
}
int F_147 ( struct V_421 * V_422 ,
T_3 * V_206 )
{
int V_178 ;
struct V_40 * V_212 ;
...
F_39 ( & V_180 ) ;
if ( V_422 -> V_193 & V_425 )
* V_206 = * ( T_3 * ) V_422 -> V_424 -> V_156 ;
else if ( V_422 -> V_193 & V_427 )
* V_206 = V_422 -> V_65 . V_428 ;
else if ( V_422 -> V_193 & V_429 ) {
V_178 = - V_430 ;
V_212 = F_40 ( & V_183 , V_431 ) ;
if ( V_212 == NULL )
goto V_114;
F_56 ( & V_426 ) ;
V_426 . V_67 = V_212 -> V_67 ;
V_426 . V_70 = V_212 -> V_70 ;
V_426 . type = V_212 -> type ;
F_148 ( & V_426 , V_422 ) ;
if ( V_422 -> V_193 & V_432 ) {
V_178 = F_149 ( & V_426 . V_78 . V_79 [ 0 ] . V_433 ,
V_422 -> V_65 . V_434 . V_433 ) ;
if ( V_178 )
goto V_114;
memcpy ( & V_426 . V_78 . V_79 [ 1 ] . V_433 ,
& V_426 . V_78 . V_79 [ 0 ] . V_433 ,
sizeof( V_426 . V_78 . V_79 [ 0 ] . V_433 ) ) ;
}
V_178 = - V_430 ;
if ( ! F_150 ( & V_1 , & V_426 ) )
goto V_435;
V_178 = F_62 ( & V_183 , & V_426 , V_206 ) ;
if ( V_178 )
goto V_435;
F_145 ( V_422 , * V_206 ) ;
F_151 ( & V_426 . V_78 . V_79 [ 0 ] . V_433 ) ;
} else
* V_206 = V_226 ;
F_41 ( & V_180 ) ;
return 0 ;
...
int F_152 ( T_3 V_206 , struct V_421 * V_422 )
{
int V_178 ;
struct V_40 * V_212 ;
if ( ! V_179 )
...
goto V_114;
V_178 = - V_17 ;
V_422 -> V_301 = F_46 ( F_20 ( & V_1 , V_205 , V_212 -> type - 1 ) ,
V_16 ) ;
if ( V_422 -> V_301 == NULL )
goto V_114;
V_422 -> V_65 . V_428 = V_206 ;
V_422 -> V_193 |= V_436 | V_427 ;
F_153 ( V_212 , V_422 ) ;
V_178 = F_154 ( V_212 , V_422 ) ;
V_114:
F_41 ( & V_180 ) ;
return V_178 ;
}
int F_155 ( void * * V_156 , T_2 * V_201 )
{
int V_178 ;
struct V_284 V_286 ;
if ( ! V_179 )
