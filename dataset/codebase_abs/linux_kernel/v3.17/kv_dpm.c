...
T_2 V_262 ;
if ( V_421 >= V_425 ) {
F_146 ( V_420 , L_22 , V_421 ) ;
} else {
V_60 = F_122 ( V_9 -> V_64 [ V_421 ] . V_67 ) ;
V_42 = ( F_4 ( V_426 ) & V_427 ) >>
V_428 ;
...
T_1 F_155 ( struct V_7 * V_8 , bool V_429 )
{
struct V_6 * V_9 = F_2 ( V_8 ) ;
struct V_1 * V_430 = F_1 ( & V_9 -> V_181 ) ;
if ( V_429 )
return V_430 -> V_241 [ 0 ] . V_60 ;
else
return V_430 -> V_241 [ V_430 -> V_243 - 1 ] . V_60 ;
}
T_1 F_156 ( struct V_7 * V_8 , bool V_429 )
{
struct V_6 * V_9 = F_2 ( V_8 ) ;
