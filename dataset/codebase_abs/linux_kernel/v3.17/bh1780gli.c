...
if ( ! F_17 ( V_33 , V_35 ) )
return - V_36 ;
V_2 = F_18 ( & V_7 -> V_8 , sizeof( struct V_1 ) ,
V_37 ) ;
if ( V_2 == NULL )
return - V_38 ;
V_2 -> V_7 = V_7 ;
F_19 ( V_7 , V_2 ) ;
V_6 = F_4 ( V_2 , V_39 , L_7 ) ;
if ( V_6 < 0 )
return V_6 ;
F_20 ( & V_7 -> V_8 , L_8 ,
( V_6 & V_40 ) ) ;
F_21 ( & V_2 -> V_26 ) ;
return F_22 ( & V_7 -> V_8 . V_41 , & V_42 ) ;
}
static int F_23 ( struct V_29 * V_7 )
{
F_24 ( & V_7 -> V_8 . V_41 , & V_42 ) ;
return 0 ;
}
static int F_25 ( struct V_9 * V_8 )
{
struct V_1 * V_2 ;
int V_19 , V_6 ;
struct V_29 * V_7 = F_26 ( V_8 ) ;
V_2 = F_27 ( V_7 ) ;
V_19 = F_4 ( V_2 , V_20 , L_6 ) ;
if ( V_19 < 0 )
return V_19 ;
