...
static int F_28 ( T_1 * V_1 , T_7 V_95 ,
V_64 V_96 , V_64 V_97 )
{
V_43 V_98 , V_99 ;
V_64 V_21 ;
...
static int F_29 ( T_1 * V_1 , V_43 V_98 ,
V_43 V_101 )
{
...
static int F_30 ( T_1 * V_1 , T_7 V_95 ,
V_64 V_96 , V_64 V_97 )
{
...
static int F_31 ( struct V_105 * V_106 , struct V_107 * V_108 )
{
T_1 * V_1 = ( void * ) V_106 ;
V_64 V_109 ;
...
{
return F_28 ( ( void * ) V_106 , V_76 , V_113 , 1 ) ;
}
static int F_33 ( struct V_105 * V_106 ,
unsigned long V_113 , char * V_76 )
{
return F_30 ( ( void * ) V_106 , V_76 , V_113 , 1 ) ;
}
...
static void F_36 ( struct V_115 * V_116 , struct V_117 * V_9 )
{
T_1 * V_118 ;
V_118 = F_37 ( sizeof( T_1 ) , V_29 ) ;
if ( ! V_118 ) {
F_3 ( V_82 L_63 ,
V_9 -> V_119 ) ;
return;
