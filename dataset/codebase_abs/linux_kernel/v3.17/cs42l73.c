...
static int F_36 ( struct V_188 * V_188 ,
const struct V_189 * V_134 )
{
struct V_107 * V_171 ;
struct V_190 * V_185 = F_37 ( & V_188 -> V_2 ) ;
int V_191 ;
...
if ( ! V_171 )
return - V_195 ;
V_171 -> V_180 = F_39 ( V_188 , & V_196 ) ;
if ( F_40 ( V_171 -> V_180 ) ) {
V_191 = F_41 ( V_171 -> V_180 ) ;
F_15 ( & V_188 -> V_2 , L_7 , V_191 ) ;
return V_191 ;
}
if ( V_185 ) {
V_171 -> V_185 = * V_185 ;
} else {
V_185 = F_38 ( & V_188 -> V_2 ,
sizeof( struct V_190 ) ,
V_194 ) ;
if ( ! V_185 ) {
F_15 ( & V_188 -> V_2 , L_8 ) ;
...
if ( V_188 -> V_2 . V_197 ) {
if ( F_42 ( V_188 -> V_2 . V_197 ,
L_9 , & V_193 ) >= 0 )
V_185 -> V_186 = V_193 ;
}
V_185 -> V_198 = F_43 ( V_188 -> V_2 . V_197 ,
L_10 , 0 ) ;
V_171 -> V_185 = * V_185 ;
}
F_44 ( V_188 , V_171 ) ;
if ( V_171 -> V_185 . V_198 ) {
V_191 = F_45 ( & V_188 -> V_2 ,
V_171 -> V_185 . V_198 ,
V_199 ,
L_11 ) ;
if ( V_191 < 0 ) {
F_15 ( & V_188 -> V_2 , L_12 ,
V_171 -> V_185 . V_198 , V_191 ) ;
return V_191 ;
}
F_46 ( V_171 -> V_185 . V_198 , 0 ) ;
F_46 ( V_171 -> V_185 . V_198 , 1 ) ;
}
F_47 ( V_171 -> V_180 , true ) ;
V_191 = F_48 ( V_171 -> V_180 , V_6 , & V_3 ) ;
V_192 = ( V_3 & 0xFF ) << 12 ;
V_191 = F_48 ( V_171 -> V_180 , V_7 , & V_3 ) ;
V_192 |= ( V_3 & 0xFF ) << 4 ;
V_191 = F_48 ( V_171 -> V_180 , V_8 , & V_3 ) ;
V_192 |= ( V_3 & 0xF0 ) >> 4 ;
if ( V_192 != V_200 ) {
V_191 = - V_201 ;
F_15 ( & V_188 -> V_2 ,
...
V_191 = F_48 ( V_171 -> V_180 , V_9 , & V_3 ) ;
if ( V_191 < 0 ) {
F_15 ( & V_188 -> V_2 , L_14 ) ;
return V_191 ; ;
}
F_49 ( & V_188 -> V_2 ,
L_15 , V_3 & 0xFF ) ;
F_47 ( V_171 -> V_180 , false ) ;
V_191 = F_50 ( & V_188 -> V_2 ,
& V_202 , V_203 ,
F_9 ( V_203 ) ) ;
if ( V_191 < 0 )
return V_191 ;
...
static int F_51 ( struct V_188 * V_204 )
{
F_52 ( & V_204 -> V_2 ) ;
return 0 ;
}
