...
F_81 ( L_14 , V_154 ) ;
F_82 ( & V_66 , L_15 , V_136 ) ;
F_83 ( & V_160 ) ;
return 0 ;
}
void F_84 ( struct V_161 * V_162 ,
struct V_149 * V_150 )
{
...
#endif
F_86 () ;
F_87 ( V_162 , V_150 -> V_166 ) ;
V_163 = V_150 -> V_167 [ V_168 ] ;
V_164 = V_163 + V_169 ;
do {
struct V_170 * V_171 ;
struct V_149 * V_150 ;
...
if ( ! F_88 ( F_89 () , V_164 ) )
break;
V_171 = (struct V_170 * ) V_164 ;
V_150 = (struct V_149 * ) ( V_171 + 1 ) ;
if ( F_90 ( F_89 () , V_150 ) ) {
if ( F_91 ( V_150 ) )
break;
V_172 = V_150 -> V_166 ;
V_164 = V_150 -> V_167 [ V_168 ] + V_169 ;
} else {
V_172 = V_171 -> V_173 ;
V_164 = ( unsigned long ) V_171 -> V_164 + V_169 ;
}
F_87 ( V_162 , V_172 ) ;
#ifdef F_85
if ( ( V_172 + 8UL ) == ( unsigned long ) & V_174 ) {
int V_175 = V_176 -> V_177 ;
if ( V_176 -> V_178 && V_175 >= V_165 ) {
V_172 = V_176 -> V_178 [ V_175 - V_165 ] . V_51 ;
F_87 ( V_162 , V_172 ) ;
V_165 ++ ;
}
}
#endif
} while ( V_162 -> V_179 < V_180 );
}
static void F_92 ( struct V_161 * V_162 ,
struct V_149 * V_150 )
{
unsigned long V_181 ;
V_181 = V_150 -> V_167 [ V_168 ] + V_169 ;
do {
struct V_170 T_7 * V_182 ;
struct V_170 V_171 ;
unsigned long V_172 ;
V_182 = (struct V_170 T_7 * ) V_181 ;
if ( F_93 ( & V_171 , V_182 , sizeof( V_171 ) ) )
break;
V_172 = V_171 . V_173 ;
V_181 = ( unsigned long ) V_171 . V_164 + V_169 ;
F_87 ( V_162 , V_172 ) ;
} while ( V_162 -> V_179 < V_180 );
}
...
{
unsigned long V_181 ;
V_181 = V_150 -> V_167 [ V_168 ] & 0xffffffffUL ;
do {
unsigned long V_172 ;
if ( F_95 ( V_181 ) ) {
struct V_170 T_7 * V_182 ;
...
if ( F_93 ( & V_171 , V_182 , sizeof( V_171 ) ) )
break;
V_172 = V_171 . V_173 & 0xffffffff ;
V_181 = ( ( unsigned long ) V_171 . V_164 ) & 0xffffffff ;
} else {
struct V_183 T_7 * V_182 ;
struct V_183 V_171 ;
V_182 = (struct V_183 T_7 * ) V_181 ;
if ( F_93 ( & V_171 , V_182 , sizeof( V_171 ) ) )
break;
V_172 = V_171 . V_173 ;
V_181 = ( unsigned long ) V_171 . V_164 ;
}
F_87 ( V_162 , V_172 ) ;
} while ( V_162 -> V_179 < V_180 );
}
void
F_96 ( struct V_161 * V_162 , struct V_149 * V_150 )
{
F_87 ( V_162 , V_150 -> V_166 ) ;
if ( ! V_176 -> V_184 )
return;
