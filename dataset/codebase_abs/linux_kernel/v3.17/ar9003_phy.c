...
F_38 ( V_2 , V_409 , V_410 ) ;
V_407 = V_205 -> V_407 ;
if ( V_205 -> V_411 )
V_407 = 0 ;
else if ( V_205 -> V_407 == 0 )
V_407 = 1 ;
if ( V_205 -> V_412 )
F_38 ( V_2 , V_409 ,
V_413 ) ;
...
static void F_90 ( struct V_1 * V_2 , T_2 V_420 )
{
F_38 ( V_2 , V_421 , V_422 ) ;
F_38 ( V_2 , 0x9864 , 0x7f000 ) ;
F_38 ( V_2 , 0x9924 , 0x7f00fe ) ;
F_49 ( V_2 , V_124 , V_125 ) ;
F_11 ( V_2 , V_423 , V_424 ) ;
F_11 ( V_2 , F_91 ( V_420 ) , 0 ) ;
F_11 ( V_2 , V_425 , 20 ) ;
F_11 ( V_2 , V_426 , 20 ) ;
F_11 ( V_2 , V_427 , 0x00000400 ) ;
F_11 ( V_2 , F_92 ( V_420 ) , 0xffffffff ) ;
F_38 ( V_2 , F_93 ( V_420 ) , V_428 ) ;
}
static void F_94 ( struct V_1 * V_2 )
{
F_49 ( V_2 , V_421 , V_422 ) ;
F_38 ( V_2 , V_124 , V_125 ) ;
}
static void F_95 ( struct V_1 * V_2 , T_3 V_429 )
{
static T_6 V_430 [ V_431 ] = { 0 } ;
unsigned int V_26 ;
if ( V_429 <= V_432 ) {
...
F_75 ( V_2 ) ;
F_78 ( V_2 ) ;
memcpy ( V_2 -> V_300 , V_473 , sizeof( V_2 -> V_300 ) ) ;
}
...
~ ( V_512 |
V_513 ) ) ;
F_65 ( V_207 , V_514 , L_15 ) ;
return;
}
V_123 = F_32 ( V_2 , V_508 ) & V_515 ;
F_11 ( V_2 , V_508 ,
( V_123 | V_510 ) &
~ V_509 ) ;
if ( V_505 > 10000 )
...
V_516 |
( V_517 & ( V_507 << 2 ) ) ) ;
F_65 ( V_207 , V_514 , L_16 ,
V_505 ) ;
}
void F_103 ( struct V_1 * V_2 )
{
V_2 -> V_503 = F_32 ( V_2 , V_518 ) ;
F_11 ( V_2 , V_518 ,
V_2 -> V_503 & ~ V_519 ) ;
}
...
F_73 ( V_520 , V_530 ) ,
F_73 ( V_520 , V_531 ) ) ;
F_65 ( V_207 , V_514 , L_19 ,
F_32 ( V_2 , V_511 ) ,
F_32 ( V_2 , V_508 ) ) ;
F_65 ( V_207 , V_514 , L_20 ,
F_32 ( V_2 , V_31 ) ) ;
#define F_106 ( T_7 ) (common->cc_survey._field * 100 / common->cc_survey.cycles)
if ( V_207 -> V_532 . V_533 )
F_65 ( V_207 , V_514 ,
L_21 ,
F_106 ( V_534 ) , F_106 ( V_535 ) , F_106 ( V_536 ) ) ;
F_65 ( V_207 , V_514 , L_22 ) ;
}
void F_107 ( struct V_1 * V_2 )
{
T_3 V_537 ;
T_2 V_123 ;
V_537 = F_73 ( V_2 -> V_503 , V_526 ) ;
