...
V_16 -> V_30 = V_281 ;
if ( V_16 -> type == V_197 )
F_160 ( V_2 , & V_16 -> V_338 , V_16 -> type ,
...
static void F_161 ( struct V_1 * V_2 , T_5 * V_136 )
{
struct V_379 V_156 ;
...
V_367 -> V_368 ) ;
V_384 |= F_163 ( V_2 , & V_367 -> V_136 , V_367 -> V_368 ,
& V_9 ) ;
if ( ! ( V_384 & V_387 ) ) {
F_161 ( V_2 , & V_367 -> V_136 ) ;
return;
}
if ( F_164 ( & V_2 -> V_388 , & V_367 -> V_136 ,
V_389 ) ) {
F_161 ( V_2 , & V_367 -> V_136 ) ;
return;
}
if ( ! F_25 ( V_390 , & V_2 -> V_12 ) &&
! F_164 ( & V_2 -> V_391 , & V_367 -> V_136 ,
V_389 ) ) {
F_161 ( V_2 , & V_367 -> V_136 ) ;
return;
}
F_6 ( V_2 ) ;
V_386 = F_165 ( V_2 , & V_367 -> V_136 ) ;
if ( V_386 )
...
F_50 ( & V_156 . V_136 , & V_367 -> V_136 ) ;
V_156 . V_92 = F_159 ( V_16 -> V_92 ) ;
V_156 . V_398 = F_167 ( 0x00001f40 ) ;
V_156 . V_399 = F_167 ( 0x00001f40 ) ;
V_156 . V_400 = F_159 ( 0xffff ) ;
V_156 . V_401 = F_159 ( V_2 -> V_65 ) ;
V_156 . V_402 = 0xff ;
...
F_170 ( V_2 , & V_16 -> V_338 , V_16 -> type , V_16 -> V_339 ,
V_380 , V_417 ) ;
if ( V_16 -> type == V_197 &&
F_25 ( V_418 , & V_16 -> V_9 ) )
F_171 ( V_2 , & V_16 -> V_338 ) ;
V_416 = F_172 ( V_2 , & V_16 -> V_338 , V_16 -> V_339 ) ;
if ( V_416 ) {
switch ( V_416 -> V_419 ) {
case V_420 :
...
F_179 ( V_2 , & V_16 -> V_338 , V_16 -> type , V_16 -> V_339 ,
V_367 -> V_5 ) ;
}
F_3 ( V_321 , & V_16 -> V_9 ) ;
F_3 ( V_426 , & V_16 -> V_9 ) ;
...
F_181 ( V_16 , V_367 -> V_5 , V_367 -> V_428 ) ;
V_159:
F_8 ( V_2 ) ;
}
...
struct V_3 * V_4 )
{
struct V_438 * V_367 = ( void * ) V_4 -> V_6 ;
struct V_15 * V_16 ;
F_2 ( L_1 , V_2 -> V_7 , V_367 -> V_5 ) ;
F_6 ( V_2 ) ;
V_16 = F_15 ( V_2 , F_16 ( V_367 -> V_17 ) ) ;
...
struct V_3 * V_4 )
{
struct V_440 * V_367 = ( void * ) V_4 -> V_6 ;
struct V_15 * V_16 ;
F_2 ( L_1 , V_2 -> V_7 , V_367 -> V_5 ) ;
F_6 ( V_2 ) ;
V_16 = F_15 ( V_2 , F_16 ( V_367 -> V_17 ) ) ;
...
if ( V_16 -> V_30 != V_291 )
goto V_159;
if ( ! V_367 -> V_5 && F_188 ( V_2 ) && F_188 ( V_16 ) ) {
struct V_326 V_156 ;
V_156 . V_17 = V_367 -> V_17 ;
V_156 . V_119 = 0x01 ;
F_127 ( V_2 , V_327 ,
...
T_2 V_442 ;
F_190 ( V_4 , sizeof( * V_367 ) ) ;
V_442 = F_16 ( V_367 -> V_442 ) ;
switch ( V_442 ) {
case V_443 :
F_1 ( V_2 , V_4 ) ;
break;
...
break;
default:
F_2 ( L_19 , V_2 -> V_7 , V_442 ) ;
break;
}
if ( V_442 != V_483 )
F_97 ( & V_2 -> V_484 ) ;
F_191 ( V_2 , V_442 , V_5 ) ;
if ( V_367 -> V_485 && ! F_25 ( V_27 , & V_2 -> V_9 ) ) {
F_192 ( & V_2 -> V_486 , 1 ) ;
if ( ! F_193 ( & V_2 -> V_487 ) )
F_194 ( V_2 -> V_224 , & V_2 -> V_488 ) ;
}
}
static void F_195 ( struct V_1 * V_2 , struct V_3 * V_4 )
{
struct V_489 * V_367 = ( void * ) V_4 -> V_6 ;
T_2 V_442 ;
F_190 ( V_4 , sizeof( * V_367 ) ) ;
V_442 = F_16 ( V_367 -> V_442 ) ;
switch ( V_442 ) {
...
F_97 ( & V_2 -> V_484 ) ;
if ( V_367 -> V_5 ||
( V_2 -> V_491 && ! F_196 ( V_2 -> V_491 ) -> V_492 . V_493 ) )
F_191 ( V_2 , V_442 , V_367 -> V_5 ) ;
if ( V_367 -> V_485 && ! F_25 ( V_27 , & V_2 -> V_9 ) ) {
F_192 ( & V_2 -> V_486 , 1 ) ;
if ( ! F_193 ( & V_2 -> V_487 ) )
F_194 ( V_2 -> V_224 , & V_2 -> V_488 ) ;
...
{
struct V_494 * V_367 = ( void * ) V_4 -> V_6 ;
struct V_15 * V_16 ;
F_2 ( L_1 , V_2 -> V_7 , V_367 -> V_5 ) ;
F_6 ( V_2 ) ;
V_16 = F_69 ( V_2 , V_197 , & V_367 -> V_136 ) ;
...
F_3 ( V_495 , & V_16 -> V_9 ) ;
F_198 ( V_16 , V_367 -> V_5 , V_367 -> V_18 ) ;
}
F_8 ( V_2 ) ;
}
static void F_199 ( struct V_1 * V_2 , struct V_3 * V_4 )
{
struct V_496 * V_367 = ( void * ) V_4 -> V_6 ;
int V_497 ;
if ( V_2 -> V_122 != V_498 ) {
...
V_367 -> V_499 * sizeof( struct V_500 ) ) {
F_2 ( L_21 , V_2 -> V_7 ) ;
return;
}
F_2 ( L_22 , V_2 -> V_7 , V_367 -> V_499 ) ;
for ( V_497 = 0 ; V_497 < V_367 -> V_499 ; V_497 ++ ) {
struct V_500 * V_362 = & V_367 -> V_501 [ V_497 ] ;
struct V_15 * V_16 ;
T_2 V_17 , V_502 ;
V_17 = F_16 ( V_362 -> V_17 ) ;
V_502 = F_16 ( V_362 -> V_502 ) ;
V_16 = F_15 ( V_2 , V_17 ) ;
if ( ! V_16 )
continue;
V_16 -> V_23 -= V_502 ;
...
F_194 ( V_2 -> V_224 , & V_2 -> V_503 ) ;
}
static struct V_15 * F_200 ( struct V_1 * V_2 ,
T_2 V_17 )
{
struct V_504 * V_505 ;
switch ( V_2 -> V_506 ) {
...
case V_508 :
V_505 = F_201 ( V_2 , V_17 ) ;
if ( V_505 )
return V_505 -> V_16 ;
break;
default:
F_100 ( L_24 , V_2 -> V_7 , V_2 -> V_506 ) ;
break;
}
return NULL ;
}
...
{
struct V_509 * V_367 = ( void * ) V_4 -> V_6 ;
int V_497 ;
if ( V_2 -> V_122 != V_510 ) {
F_100 ( L_20 , V_2 -> V_122 ) ;
return;
...
if ( V_4 -> V_157 < sizeof( * V_367 ) || V_4 -> V_157 < sizeof( * V_367 ) +
V_367 -> V_499 * sizeof( struct V_511 ) ) {
F_2 ( L_21 , V_2 -> V_7 ) ;
return;
}
...
V_367 -> V_499 ) ;
for ( V_497 = 0 ; V_497 < V_367 -> V_499 ; V_497 ++ ) {
struct V_511 * V_362 = & V_367 -> V_501 [ V_497 ] ;
struct V_15 * V_16 = NULL ;
T_2 V_17 , V_512 ;
V_17 = F_16 ( V_362 -> V_17 ) ;
V_512 = F_16 ( V_362 -> V_513 ) ;
V_16 = F_200 ( V_2 , V_17 ) ;
if ( ! V_16 )
continue;
V_16 -> V_23 -= V_512 ;
...
{
struct V_515 * V_367 = ( void * ) V_4 -> V_6 ;
struct V_15 * V_16 ;
F_2 ( L_1 , V_2 -> V_7 , V_367 -> V_5 ) ;
F_6 ( V_2 ) ;
V_16 = F_15 ( V_2 , F_16 ( V_367 -> V_17 ) ) ;
...
{
struct V_518 * V_367 = ( void * ) V_4 -> V_6 ;
struct V_15 * V_16 ;
F_2 ( L_2 , V_2 -> V_7 ) ;
F_6 ( V_2 ) ;
V_16 = F_69 ( V_2 , V_197 , & V_367 -> V_136 ) ;
...
{
struct V_521 * V_367 = ( void * ) V_4 -> V_6 ;
struct V_522 V_156 ;
struct V_15 * V_16 ;
struct V_523 * V_524 ;
F_2 ( L_2 , V_2 -> V_7 ) ;
...
return;
F_6 ( V_2 ) ;
V_524 = F_157 ( V_2 , & V_367 -> V_136 ) ;
if ( ! V_524 ) {
F_2 ( L_26 , V_2 -> V_7 ,
& V_367 -> V_136 ) ;
goto V_525;
}
F_2 ( L_27 , V_2 -> V_7 , V_524 -> type ,
& V_367 -> V_136 ) ;
V_16 = F_69 ( V_2 , V_197 , & V_367 -> V_136 ) ;
if ( V_16 ) {
if ( ( V_524 -> type == V_526 ||
...
if ( V_524 -> type == V_528 && V_524 -> V_199 < 16 &&
( V_16 -> V_295 == V_299 ||
V_16 -> V_295 == V_298 ) ) {
F_2 ( L_29 ,
V_2 -> V_7 ) ;
...
V_16 -> V_433 = V_524 -> type ;
V_16 -> V_198 = V_524 -> V_199 ;
}
F_50 ( & V_156 . V_136 , & V_367 -> V_136 ) ;
memcpy ( V_156 . V_523 , V_524 -> V_529 , V_530 ) ;
F_127 ( V_2 , V_531 , sizeof( V_156 ) , & V_156 ) ;
F_8 ( V_2 ) ;
return;
V_525:
F_127 ( V_2 , V_532 , 6 , & V_367 -> V_136 ) ;
F_8 ( V_2 ) ;
}
static void F_207 ( struct V_1 * V_2 , struct V_3 * V_4 )
{
struct V_533 * V_367 = ( void * ) V_4 -> V_6 ;
struct V_15 * V_16 ;
struct V_523 * V_524 ;
bool V_534 ;
T_3 V_199 = 0 ;
...
V_16 -> V_371 = V_373 ;
V_199 = V_16 -> V_198 ;
if ( V_367 -> V_433 != V_535 )
V_16 -> V_433 = V_367 -> V_433 ;
F_122 ( V_16 ) ;
}
if ( ! F_25 ( V_42 , & V_2 -> V_12 ) )
goto V_159;
V_524 = F_208 ( V_2 , V_16 , & V_367 -> V_136 , V_367 -> V_523 ,
V_367 -> V_433 , V_199 , & V_534 ) ;
if ( ! V_524 )
goto V_159;
F_209 ( V_2 , V_524 , V_534 ) ;
if ( V_524 -> type == V_536 &&
! F_25 ( V_537 , & V_2 -> V_12 ) ) {
F_134 ( & V_524 -> V_318 ) ;
F_210 ( V_524 ) ;
...
{
struct V_538 * V_367 = ( void * ) V_4 -> V_6 ;
struct V_15 * V_16 ;
F_2 ( L_1 , V_2 -> V_7 , V_367 -> V_5 ) ;
F_6 ( V_2 ) ;
V_16 = F_15 ( V_2 , F_16 ( V_367 -> V_17 ) ) ;
...
{
struct V_541 * V_367 = ( void * ) V_4 -> V_6 ;
struct V_15 * V_16 ;
F_2 ( L_1 , V_2 -> V_7 , V_367 -> V_5 ) ;
F_6 ( V_2 ) ;
V_16 = F_15 ( V_2 , F_16 ( V_367 -> V_17 ) ) ;
...
return;
F_6 ( V_2 ) ;
if ( ( V_4 -> V_157 - 1 ) / V_363 != sizeof( struct V_543 ) ) {
struct V_544 * V_362 ;
...
struct V_543 * V_362 = ( void * ) ( V_4 -> V_6 + 1 ) ;
for (; V_363 ; V_363 -- , V_362 ++ ) {
T_7 V_9 ;
F_50 ( & V_6 . V_136 , & V_362 -> V_136 ) ;
V_6 . V_304 = V_362 -> V_304 ;
...
struct V_3 * V_4 )
{
struct V_545 * V_367 = ( void * ) V_4 -> V_6 ;
struct V_15 * V_16 ;
F_2 ( L_2 , V_2 -> V_7 ) ;
F_6 ( V_2 ) ;
V_16 = F_15 ( V_2 , F_16 ( V_367 -> V_17 ) ) ;
...
struct V_3 * V_4 )
{
struct V_548 * V_367 = ( void * ) V_4 -> V_6 ;
struct V_15 * V_16 ;
F_2 ( L_1 , V_2 -> V_7 , V_367 -> V_5 ) ;
F_6 ( V_2 ) ;
V_16 = F_69 ( V_2 , V_367 -> V_368 , & V_367 -> V_136 ) ;
...
case 0x20 :
if ( V_16 -> V_294 ) {
V_16 -> V_92 = ( V_2 -> V_100 & V_549 ) |
( V_2 -> V_100 & V_550 ) ;
if ( F_217 ( V_16 , V_16 -> V_288 -> V_17 ) )
goto V_159;
}
default:
V_16 -> V_30 = V_281 ;
...
static inline T_4 F_218 ( T_3 * V_551 , T_4 V_552 )
{
T_4 V_553 = 0 ;
while ( V_553 < V_552 ) {
T_3 V_554 = V_551 [ 0 ] ;
...
{
struct V_360 V_6 ;
struct V_555 * V_362 = ( void * ) ( V_4 -> V_6 + 1 ) ;
int V_363 = * ( ( T_1 * ) V_4 -> V_6 ) ;
T_4 V_552 ;
F_2 ( L_16 , V_2 -> V_7 , V_363 ) ;
if ( ! V_363 )
...
V_6 . V_365 = 0x01 ;
if ( F_25 ( V_42 , & V_2 -> V_12 ) )
V_556 = F_220 ( V_362 -> V_6 ,
sizeof( V_362 -> V_6 ) ,
V_557 ) ;
else
V_556 = true ;
V_9 = F_154 ( V_2 , & V_6 , V_556 ) ;
V_552 = F_218 ( V_362 -> V_6 , sizeof( V_362 -> V_6 ) ) ;
F_96 ( V_2 , & V_362 -> V_136 , V_197 , 0x00 ,
V_362 -> V_61 , V_362 -> V_235 ,
V_9 , V_362 -> V_6 , V_552 , NULL , 0 ) ;
}
F_8 ( V_2 ) ;
}
...
struct V_3 * V_4 )
{
struct V_558 * V_367 = ( void * ) V_4 -> V_6 ;
struct V_15 * V_16 ;
...
static T_3 F_222 ( struct V_15 * V_16 )
{
if ( V_16 -> V_559 == V_560 ||
V_16 -> V_559 == V_561 )
return V_16 -> V_559 | ( V_16 -> V_297 & 0x01 ) ;
if ( V_16 -> V_562 != V_563 &&
V_16 -> V_564 != V_563 )
return V_16 -> V_559 | 0x01 ;
return ( V_16 -> V_559 & ~ 0x01 ) | ( V_16 -> V_297 & 0x01 ) ;
}
static void F_223 ( struct V_1 * V_2 , struct V_3 * V_4 )
{
struct V_565 * V_367 = ( void * ) V_4 -> V_6 ;
struct V_15 * V_16 ;
F_2 ( L_2 , V_2 -> V_7 ) ;
F_6 ( V_2 ) ;
V_16 = F_69 ( V_2 , V_197 , & V_367 -> V_136 ) ;
...
if ( F_25 ( V_519 , & V_2 -> V_12 ) ||
F_25 ( V_323 , & V_16 -> V_9 ) ||
( V_16 -> V_559 & ~ 0x01 ) == V_560 ) {
struct V_566 V_156 ;
F_50 ( & V_156 . V_136 , & V_367 -> V_136 ) ;
V_156 . V_567 = ( V_16 -> V_564 == 0x04 ) ?
V_568 : V_16 -> V_564 ;
if ( V_16 -> V_559 == 0xff ) {
if ( V_16 -> V_564 != V_563 &&
V_16 -> V_297 != V_560 )
...
V_16 -> V_297 = F_222 ( V_16 ) ;
}
if ( ! F_25 ( V_519 , & V_2 -> V_12 ) )
V_16 -> V_297 &= V_561 ;
V_156 . V_569 = V_16 -> V_297 ;
if ( F_224 ( V_2 , & V_16 -> V_338 ) &&
( V_16 -> V_294 || F_25 ( V_570 , & V_16 -> V_9 ) ) )
V_156 . V_571 = 0x01 ;
else
V_156 . V_571 = 0x00 ;
F_127 ( V_2 , V_572 ,
...
{
struct V_576 * V_367 = ( void * ) V_4 -> V_6 ;
struct V_15 * V_16 ;
F_2 ( L_2 , V_2 -> V_7 ) ;
F_6 ( V_2 ) ;
V_16 = F_69 ( V_2 , V_197 , & V_367 -> V_136 ) ;
if ( ! V_16 )
goto V_159;
V_16 -> V_562 = V_367 -> V_567 ;
V_16 -> V_559 = V_367 -> V_569 ;
if ( V_367 -> V_571 )
F_11 ( V_570 , & V_16 -> V_9 ) ;
V_159:
F_8 ( V_2 ) ;
...
if ( ! V_16 )
goto V_159;
V_578 = ( V_16 -> V_297 & 0x01 ) ;
V_579 = ( V_16 -> V_559 & 0x01 ) ;
if ( V_16 -> V_295 > V_300 &&
V_16 -> V_562 == V_563 ) {
F_2 ( L_31 ) ;
F_127 ( V_2 , V_475 ,
...
if ( ( ! V_578 || V_16 -> V_562 == V_563 ) &&
( ! V_579 || V_16 -> V_564 == V_563 ) ) {
...
V_581:
F_228 ( V_2 , & V_367 -> V_136 , V_197 , 0 ,
F_57 ( V_367 -> V_585 ) , V_580 ) ;
V_159:
F_8 ( V_2 ) ;
}
...
struct V_3 * V_4 )
{
struct V_586 * V_367 = ( void * ) V_4 -> V_6 ;
F_2 ( L_2 , V_2 -> V_7 ) ;
if ( F_25 ( V_42 , & V_2 -> V_12 ) )
F_230 ( V_2 , & V_367 -> V_136 , V_197 , 0 ) ;
}
...
if ( ! V_16 )
return;
V_16 -> V_588 = F_60 ( V_367 -> V_585 ) ;
V_16 -> V_589 = 0 ;
if ( F_25 ( V_42 , & V_2 -> V_12 ) )
F_232 ( V_2 , & V_16 -> V_338 , V_16 -> type ,
V_16 -> V_339 , V_16 -> V_588 ,
V_16 -> V_589 ) ;
}
static void F_233 ( struct V_1 * V_2 , struct V_3 * V_4 )
{
struct V_590 * V_367 = ( void * ) V_4 -> V_6 ;
struct V_15 * V_16 ;
F_2 ( L_2 , V_2 -> V_7 ) ;
V_16 = F_69 ( V_2 , V_197 , & V_367 -> V_136 ) ;
if ( ! V_16 )
...
struct V_3 * V_4 )
{
struct V_596 * V_367 = ( void * ) V_4 -> V_6 ;
struct V_15 * V_16 ;
F_2 ( L_2 , V_2 -> V_7 ) ;
F_6 ( V_2 ) ;
V_16 = F_69 ( V_2 , V_197 , & V_367 -> V_136 ) ;
...
struct V_3 * V_4 )
{
struct V_605 * V_367 = ( void * ) V_4 -> V_6 ;
struct V_15 * V_342 , * V_606 ;
...
V_606 = V_342 -> V_607 -> V_608 -> V_342 ;
V_342 -> V_30 = V_358 ;
F_50 ( & V_342 -> V_338 , & V_606 -> V_338 ) ;
F_156 ( V_342 ) ;
V_342 -> V_371 = V_373 ;
F_122 ( V_342 ) ;
F_158 ( V_342 ) ;
...
{
struct V_609 * V_367 = ( void * ) V_4 -> V_6 ;
struct V_15 * V_342 ;
struct V_504 * V_610 ;
struct V_607 * V_611 ;
F_2 ( L_35 ,
...
if ( ! V_610 )
return;
V_610 -> V_17 = F_58 ( V_367 -> V_17 ) ;
F_2 ( L_36 , V_342 , V_342 -> V_607 , V_610 ) ;
V_611 = V_342 -> V_607 ;
if ( V_611 && V_611 -> V_612 ) {
struct V_613 * V_612 = V_611 -> V_612 ;
F_241 ( V_612 ) ;
V_612 -> V_16 -> V_614 = V_2 -> V_149 ;
F_242 ( V_612 , V_610 , 0 ) ;
F_156 ( V_342 ) ;
F_243 ( V_612 ) ;
}
...
struct V_3 * V_4 )
{
struct V_615 * V_367 = ( void * ) V_4 -> V_6 ;
struct V_504 * V_610 ;
F_2 ( L_37 , V_2 -> V_7 ,
...
return;
F_6 ( V_2 ) ;
V_610 = F_201 ( V_2 , F_58 ( V_367 -> V_17 ) ) ;
if ( ! V_610 )
goto V_159;
F_245 ( V_610 , V_367 -> V_380 ) ;
V_159:
F_8 ( V_2 ) ;
}
...
if ( F_25 ( V_621 , & V_2 -> V_12 ) ) {
V_16 -> V_348 = V_349 ;
F_50 ( & V_16 -> V_350 , & V_2 -> V_622 ) ;
} else {
F_248 ( V_2 ,
& V_16 -> V_350 ,
& V_16 -> V_348 ) ;
...
V_16 -> V_623 = V_2 -> V_623 ;
V_16 -> V_624 = V_2 -> V_624 ;
}
V_619 = F_249 ( V_2 , & V_16 -> V_338 , V_16 -> V_339 ) ;
if ( V_619 ) {
F_50 ( & V_16 -> V_338 , & V_619 -> V_136 ) ;
V_16 -> V_339 = V_619 -> V_620 ;
}
if ( V_16 -> V_339 == V_625 )
V_620 = V_626 ;
else
V_620 = V_627 ;
if ( V_367 -> V_5 ) {
F_250 ( V_16 , V_367 -> V_5 ) ;
goto V_159;
}
if ( F_164 ( & V_2 -> V_388 , & V_16 -> V_338 , V_620 ) ) {
F_122 ( V_16 ) ;
goto V_159;
}
...
V_16 -> V_17 = F_16 ( V_367 -> V_17 ) ;
V_16 -> V_30 = V_358 ;
V_16 -> V_629 = F_58 ( V_367 -> V_140 ) ;
V_16 -> V_630 = F_58 ( V_367 -> V_631 ) ;
V_16 -> V_632 = F_58 ( V_367 -> V_633 ) ;
F_158 ( V_16 ) ;
F_117 ( V_16 , V_367 -> V_5 ) ;
V_416 = F_172 ( V_2 , & V_16 -> V_338 , V_16 -> V_339 ) ;
if ( V_416 ) {
...
struct V_3 * V_4 )
{
struct V_634 * V_367 = ( void * ) V_4 -> V_6 ;
struct V_15 * V_16 ;
F_2 ( L_1 , V_2 -> V_7 , V_367 -> V_5 ) ;
if ( V_367 -> V_5 )
return;
...
static void F_252 ( struct V_1 * V_2 , T_5 * V_635 ,
T_3 V_620 , T_3 V_636 )
{
struct V_15 * V_16 ;
struct V_415 * V_416 ;
if ( V_636 != V_637 && V_636 != V_638 )
return;
if ( F_164 ( & V_2 -> V_388 , V_635 , V_620 ) )
return;
if ( V_2 -> V_639 . V_640 > 0 )
return;
V_416 = F_253 ( & V_2 -> V_424 ,
V_635 , V_620 ) ;
if ( ! V_416 )
return;
switch ( V_416 -> V_419 ) {
...
V_16 = F_254 ( V_2 , V_635 , V_620 , V_628 ,
V_641 , V_283 ) ;
if ( ! F_255 ( V_16 ) ) {
V_416 -> V_16 = V_16 ;
return;
...
static void F_257 ( struct V_1 * V_2 , T_3 type , T_5 * V_136 ,
...
bool V_643 ;
T_7 V_9 ;
V_619 = F_249 ( V_2 , V_136 , V_234 ) ;
if ( V_619 ) {
V_136 = & V_619 -> V_136 ;
V_234 = V_619 -> V_620 ;
}
F_252 ( V_2 , V_136 , V_234 , type ) ;
if ( V_2 -> V_38 == V_39 ) {
if ( type == V_638 )
return;
if ( ! F_253 ( & V_2 -> V_644 ,
...
{
T_3 V_649 = V_4 -> V_6 [ 0 ] ;
void * V_650 = & V_4 -> V_6 [ 1 ] ;
F_6 ( V_2 ) ;
while ( V_649 -- ) {
struct V_651 * V_367 = V_650 ;
T_6 V_235 ;
V_235 = V_367 -> V_6 [ V_367 -> V_652 ] ;
F_257 ( V_2 , V_367 -> V_653 , & V_367 -> V_136 ,
V_367 -> V_234 , V_235 , V_367 -> V_6 , V_367 -> V_652 ) ;
V_650 += sizeof( * V_367 ) + V_367 -> V_652 + 1 ;
}
F_8 ( V_2 ) ;
}
static void F_259 ( struct V_1 * V_2 , struct V_3 * V_4 )
{
struct V_654 * V_367 = ( void * ) V_4 -> V_6 ;
struct V_655 V_156 ;
struct V_656 V_657 ;
struct V_15 * V_16 ;
struct V_658 * V_659 ;
...
if ( V_16 == NULL )
goto V_525;
V_659 = F_260 ( V_2 , V_367 -> V_660 , V_367 -> rand , V_16 -> V_18 ) ;
if ( V_659 == NULL )
goto V_525;
memcpy ( V_156 . V_659 , V_659 -> V_529 , sizeof( V_659 -> V_529 ) ) ;
V_156 . V_17 = F_159 ( V_16 -> V_17 ) ;
if ( V_659 -> V_661 )
V_16 -> V_295 = V_299 ;
else
V_16 -> V_295 = V_300 ;
V_16 -> V_662 = V_659 -> V_663 ;
...
return;
V_525:
V_657 . V_17 = V_367 -> V_17 ;
F_127 ( V_2 , V_667 , sizeof( V_657 ) , & V_657 ) ;
F_8 ( V_2 ) ;
}
static void F_261 ( struct V_1 * V_2 , T_8 V_17 ,
T_3 V_380 )
{
struct V_668 V_156 ;
V_156 . V_17 = F_159 ( V_17 ) ;
V_156 . V_380 = V_380 ;
...
F_8 ( V_2 ) ;
F_264 ( V_2 , & V_342 -> V_338 , V_342 -> V_339 ,
V_679 , V_672 , V_673 , V_631 , V_674 ) ;
}
V_156 . V_17 = V_367 -> V_17 ;
V_156 . V_675 = V_367 -> V_675 ;
V_156 . V_676 = V_367 -> V_676 ;
V_156 . V_631 = V_367 -> V_631 ;
...
void F_268 ( struct V_1 * V_2 , struct V_3 * V_4 )
{
struct V_695 * V_696 = ( void * ) V_4 -> V_6 ;
T_1 V_493 = V_696 -> V_697 ;
F_6 ( V_2 ) ;
if ( F_269 ( V_2 ) ) {
F_270 ( V_2 -> V_698 ) ;
V_2 -> V_698 = F_271 ( V_4 , V_699 ) ;
}
F_8 ( V_2 ) ;
F_190 ( V_4 , V_700 ) ;
if ( V_2 -> V_491 && F_196 ( V_2 -> V_491 ) -> V_492 . V_493 == V_493 ) {
struct V_701 * V_702 = ( void * ) V_2 -> V_491 -> V_6 ;
T_8 V_442 = F_16 ( V_702 -> V_442 ) ;
F_191 ( V_2 , V_442 , 0 ) ;
}
switch ( V_493 ) {
case V_703 :
