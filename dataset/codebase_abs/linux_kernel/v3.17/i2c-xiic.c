...
F_19 ( V_2 -> V_30 . V_31 . V_32 , L_2 ,
V_33 , V_40 , V_39 ) ;
while ( V_40 -- ) {
T_2 V_41 = V_2 -> V_42 -> V_35 [ V_2 -> V_43 ++ ] ;
if ( ( F_23 ( V_2 ) == 0 ) && ( V_2 -> V_44 == 1 ) ) {
V_41 |= V_45 ;
F_19 ( V_2 -> V_30 . V_31 . V_32 , L_3 , V_33 ) ;
}
F_5 ( V_2 , V_46 , V_41 ) ;
}
}
...
( ( V_50 & V_52 ) &&
! ( V_50 & V_53 ) ) ) {
F_19 ( V_2 -> V_30 . V_31 . V_32 , L_6 , V_33 ) ;
F_16 ( V_2 ) ;
if ( V_2 -> V_42 )
F_24 ( V_2 , V_54 ) ;
} else if ( V_50 & V_53 ) {
...
F_28 ( V_2 -> V_30 . V_31 . V_32 , L_13 ,
V_33 ) ;
V_51 = V_50 ;
}
V_55:
F_19 ( V_2 -> V_30 . V_31 . V_32 , L_14 , V_33 , V_51 ) ;
F_7 ( V_2 , V_10 , V_51 ) ;
}
...
F_35 ( & V_2 -> V_75 ) ;
F_7 ( V_2 , V_22 , 0 ) ;
F_19 ( V_2 -> V_30 . V_31 . V_32 , L_17 , V_33 ) ;
F_26 ( V_2 ) ;
F_7 ( V_2 , V_22 , V_23 ) ;
F_36 ( & V_2 -> V_75 ) ;
return V_76 ;
...
int V_94 , V_73 ;
T_1 V_28 ;
V_2 = F_45 ( & V_89 -> V_31 , sizeof( * V_2 ) , V_95 ) ;
if ( ! V_2 )
return - V_96 ;
V_93 = F_46 ( V_89 , V_97 , 0 ) ;
V_2 -> V_5 = F_47 ( & V_89 -> V_31 , V_93 ) ;
if ( F_48 ( V_2 -> V_5 ) )
return F_49 ( V_2 -> V_5 ) ;
V_73 = F_50 ( V_89 , 0 ) ;
if ( V_73 < 0 )
...
V_2 -> V_30 . V_31 . V_99 = V_89 -> V_31 . V_99 ;
F_54 ( & V_2 -> V_75 ) ;
F_55 ( & V_2 -> V_49 ) ;
V_94 = F_56 ( & V_89 -> V_31 , V_73 , F_34 , 0 , V_89 -> V_100 , V_2 ) ;
if ( V_94 < 0 ) {
F_28 ( & V_89 -> V_31 , L_20 ) ;
return V_94 ;
}
...
if ( V_91 ) {
for ( V_28 = 0 ; V_28 < V_91 -> V_101 ; V_28 ++ )
F_58 ( & V_2 -> V_30 , V_91 -> V_102 + V_28 ) ;
}
return 0 ;
}
static int F_59 ( struct V_88 * V_89 )
{
struct V_1 * V_2 = F_60 ( V_89 ) ;
F_61 ( & V_2 -> V_30 ) ;
F_17 ( V_2 ) ;
return 0 ;
}
