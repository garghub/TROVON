...
static T_4 F_71 ( struct V_19 * V_20 , struct V_10 * V_5 ,
void * V_99 , T_5 V_100 )
{
unsigned int V_67 = V_20 -> V_68 ;
T_6 V_101 ;
...
static int F_73 ( struct V_10 * V_5 , struct V_19 * V_20 )
{
unsigned short V_3 ;
struct V_65 * V_66 = F_44 ( V_20 ) ;
struct V_103 * V_104 = F_74 ( V_66 -> V_104 ) ;
struct V_85 * V_25 ;
char * V_23 = V_5 -> V_23 ;
T_1 V_14 ;
T_2 V_16 ;
...
F_80 ( & V_12 -> V_109 , V_91 ) ;
if ( F_15 ( ! F_21 ( V_20 ) ||
( V_105 > 1 && ! F_9 ( V_20 ) ) ||
F_81 ( V_5 , F_82 ( V_5 ) ) ) ) {
F_83 ( & V_12 -> V_109 , V_91 ) ;
goto V_107;
}
V_14 = V_12 -> V_25 . V_26 ;
V_3 = F_5 ( & V_12 -> V_84 , V_12 -> V_78 ) ;
...
static int F_96 ( struct V_10 * V_5 ,
struct V_116 * V_117 )
{
...
if ( F_93 () )
F_97 ( L_11 , V_117 -> V_119 . V_117 . type ) ;
return - V_140 ;
}
...
static T_1 F_98 ( struct V_11 * V_12 ,
struct V_10 * V_5 ,
struct V_144 * V_2 )
{
...
if ( V_157 -> V_87 == V_29 ) {
unsigned int V_160 = F_99 ( V_5 ) -> V_160 ;
F_31 ( V_160 <= F_62 ( V_5 ) ) ;
F_100 ( V_5 , V_160 - F_62 ( V_5 ) ) ;
}
...
static int F_101 ( struct V_19 * V_20 , struct V_10 * V_5 )
{
bool V_161 = false ;
if ( V_5 -> V_110 != V_111 && F_102 ( V_5 ) ) {
struct V_65 * V_66 = F_44 ( V_20 ) ;
F_103 ( & V_66 -> V_162 ) ;
V_5 -> V_110 = V_111 ;
V_161 = true ;
...
if ( V_5 -> V_110 != V_111 )
return 0 ;
return F_104 ( V_5 , V_161 ) ;
}
static int F_105 ( struct V_11 * V_12 ,
struct V_144 * V_163 )
{
struct V_103 * V_104 = F_74 ( V_12 -> V_30 -> V_104 ) ;
int V_164 = 0 ;
struct V_10 * V_5 ;
while ( ( V_5 = F_30 ( V_163 ) ) != NULL ) {
int V_160 = F_99 ( V_5 ) -> V_160 ;
if ( V_160 > F_62 ( V_5 ) )
F_100 ( V_5 , V_160 - F_62 ( V_5 ) ) ;
V_5 -> V_165 = F_106 ( V_5 , V_12 -> V_30 -> V_31 ) ;
F_107 ( V_5 ) ;
if ( F_101 ( V_12 -> V_30 -> V_31 , V_5 ) ) {
F_26 ( V_5 ) ;
V_164 ++ ;
...
static int F_109 ( struct V_169 * V_24 , int V_170 )
{
struct V_11 * V_12 = F_110 ( V_24 , struct V_11 , V_24 ) ;
struct V_19 * V_20 = V_12 -> V_30 -> V_31 ;
struct V_10 * V_5 ;
struct V_142 V_143 ;
struct V_145 * V_38 = & V_143 . V_38 ;
...
V_137 = F_95 ( V_12 , & V_143 , V_134 , & V_173 ) ;
if ( F_15 ( V_137 ) ) {
V_137:
...
struct V_116 * V_117 ;
V_117 = & V_133 [ V_125 - 1 ] ;
if ( F_15 ( F_96 ( V_5 , V_117 ) ) ) {
F_113 ( & V_173 , V_5 ) ;
V_12 -> V_38 . V_27 += F_22 ( & V_173 ) ;
goto V_137;
}
}
F_99 ( V_5 ) -> V_160 = V_38 -> V_76 ;
if ( F_99 ( V_5 ) -> V_160 > V_45 )
F_99 ( V_5 ) -> V_160 = V_45 ;
F_35 ( V_5 ) -> V_60 [ 0 ] . V_94 = V_38 -> V_88 ;
F_114 ( & F_35 ( V_5 ) -> V_60 [ 0 ] , V_38 -> V_76 ) ;
V_5 -> V_174 = V_38 -> V_76 ;
V_5 -> V_89 += V_38 -> V_76 ;
V_14 = F_98 ( V_12 , V_5 , & V_173 ) ;
if ( V_38 -> V_91 & V_175 )
V_5 -> V_110 = V_111 ;
...
static int F_122 ( struct V_19 * V_20 , int V_179 )
{
int V_146 = F_9 ( V_20 ) ?
V_108 - V_180 : V_181 ;
if ( V_179 > V_146 )
...
static struct V_182 * F_123 ( struct V_19 * V_20 ,
struct V_182 * V_183 )
{
struct V_65 * V_66 = F_44 ( V_20 ) ;
int V_184 ;
F_124 (cpu) {
struct V_103 * V_104 = F_125 ( V_66 -> V_104 , V_184 ) ;
T_7 V_167 , V_168 , V_129 , V_128 ;
unsigned int V_185 ;
do {
V_185 = F_126 ( & V_104 -> V_127 ) ;
V_167 = V_104 -> V_167 ;
V_129 = V_104 -> V_129 ;
V_168 = V_104 -> V_168 ;
V_128 = V_104 -> V_128 ;
} while ( F_127 ( & V_104 -> V_127 , V_185 ) );
V_183 -> V_167 += V_167 ;
V_183 -> V_129 += V_129 ;
V_183 -> V_168 += V_168 ;
V_183 -> V_128 += V_128 ;
...
F_129 ( V_12 -> V_83 [ V_14 ] ) ;
F_130 ( V_12 -> V_79 [ V_14 ] ,
V_81 ,
...
int V_187 ;
if ( V_21 & V_22 ) {
if ( F_133 ( V_188 , V_66 -> V_61 -> V_189 , L_12 ,
L_13 , & V_187 ) < 0 )
V_187 = 0 ;
if ( ! V_187 )
V_21 &= ~ V_22 ;
...
if ( V_21 & V_190 ) {
if ( F_133 ( V_188 , V_66 -> V_61 -> V_189 ,
L_14 , L_13 , & V_187 ) < 0 )
V_187 = 0 ;
if ( ! V_187 )
V_21 &= ~ V_190 ;
...
static T_9 F_138 ( int V_193 , void * V_194 )
{
F_136 ( V_193 , V_194 ) ;
F_137 ( V_193 , V_194 ) ;
return V_195 ;
...
unsigned int V_14 ;
for ( V_14 = 0 ; V_14 < V_67 ; ++ V_14 )
F_138 ( 0 , & V_30 -> V_69 [ V_14 ] ) ;
}
static struct V_19 * F_140 ( struct V_196 * V_20 )
{
int V_137 ;
struct V_19 * V_31 ;
struct V_65 * V_66 ;
V_31 = F_141 ( sizeof( struct V_65 ) , V_197 ) ;
if ( ! V_31 )
return F_142 ( - V_198 ) ;
V_66 = F_44 ( V_31 ) ;
V_66 -> V_61 = V_20 ;
...
static int F_149 ( struct V_196 * V_20 ,
...
if ( V_137 ) {
F_97 ( L_19 , V_80 , V_137 ) ;
goto V_208;
}
V_137 = F_155 ( V_30 -> V_31 ) ;
if ( V_137 ) {
F_156 ( V_30 -> V_31 ) ;
F_97 ( L_20 , V_80 , V_137 ) ;
goto V_208;
}
return 0 ;
V_208:
...
static void F_158 ( struct V_65 * V_30 )
{
unsigned int V_14 = 0 ;
...
F_159 ( V_12 -> V_126 , V_12 ) ;
if ( V_12 -> V_126 && ( V_12 -> V_126 != V_12 -> V_64 ) ) {
F_159 ( V_12 -> V_126 , V_12 ) ;
F_159 ( V_12 -> V_64 , V_12 ) ;
}
...
F_161 ( V_12 -> V_82 ) ;
F_161 ( V_12 -> V_59 ) ;
F_157 ( V_12 -> V_211 , V_12 -> V_25 . V_55 ) ;
F_157 ( V_12 -> V_212 , V_12 -> V_38 . V_55 ) ;
V_12 -> V_211 = V_18 ;
V_12 -> V_212 = V_18 ;
V_12 -> V_25 . V_55 = NULL ;
V_12 -> V_38 . V_55 = NULL ;
...
static int F_162 ( struct V_196 * V_20 )
{
struct V_65 * V_30 = F_163 ( & V_20 -> V_20 ) ;
F_164 ( & V_20 -> V_20 , L_21 , V_20 -> V_213 ) ;
F_158 ( V_30 ) ;
return 0 ;
}
static int F_165 ( struct V_196 * V_20 , T_10 V_214 [] )
{
char * V_215 , * V_216 , * V_217 ;
int V_14 ;
V_217 = V_215 = F_166 ( V_188 , V_20 -> V_213 , L_22 , NULL ) ;
if ( F_150 ( V_217 ) )
return F_151 ( V_217 ) ;
for ( V_14 = 0 ; V_14 < V_218 ; V_14 ++ ) {
V_214 [ V_14 ] = F_167 ( V_215 , & V_216 , 16 ) ;
...
{
int V_137 ;
V_137 = F_170 ( V_12 -> V_30 -> V_61 , & V_12 -> V_209 ) ;
if ( V_137 < 0 )
goto V_208;
V_137 = F_171 ( V_12 -> V_209 ,
F_138 ,
...
return 0 ;
V_220:
F_172 ( V_12 -> V_30 -> V_61 , V_12 -> V_209 ) ;
V_12 -> V_209 = 0 ;
V_208:
return V_137 ;
}
...
if ( V_137 < 0 )
goto V_208;
V_137 = F_170 ( V_12 -> V_30 -> V_61 , & V_12 -> V_210 ) ;
if ( V_137 < 0 )
goto V_221;
...
V_12 -> V_126 = 0 ;
V_223:
F_172 ( V_12 -> V_30 -> V_61 , V_12 -> V_210 ) ;
V_12 -> V_210 = 0 ;
V_221:
F_172 ( V_12 -> V_30 -> V_61 , V_12 -> V_209 ) ;
V_12 -> V_209 = 0 ;
...
static int F_174 ( struct V_196 * V_20 ,
...
V_12 -> V_38 . V_55 = NULL ;
V_12 -> V_25 . V_55 = NULL ;
V_228 = (struct V_227 * ) F_175 ( V_231 | V_232 ) ;
if ( ! V_228 ) {
V_137 = - V_198 ;
F_152 ( V_20 , V_137 , L_25 ) ;
goto V_208;
}
F_176 ( V_228 ) ;
F_177 ( & V_12 -> V_25 , V_228 , V_54 ) ;
V_137 = F_178 ( V_20 , F_64 ( V_228 ) ) ;
if ( V_137 < 0 )
goto V_233;
V_12 -> V_211 = V_137 ;
V_230 = (struct V_229 * ) F_175 ( V_231 | V_232 ) ;
if ( ! V_230 ) {
V_137 = - V_198 ;
F_152 ( V_20 , V_137 , L_26 ) ;
goto V_234;
}
F_176 ( V_230 ) ;
F_177 ( & V_12 -> V_38 , V_230 , V_54 ) ;
V_137 = F_178 ( V_20 , F_64 ( V_230 ) ) ;
if ( V_137 < 0 )
goto V_235;
V_12 -> V_212 = V_137 ;
if ( V_226 )
...
F_56 ( V_12 -> V_212 , 0 ) ;
V_235:
F_179 ( ( unsigned long ) V_230 ) ;
V_234:
F_56 ( V_12 -> V_211 , 0 ) ;
V_233:
F_179 ( ( unsigned long ) V_228 ) ;
V_208:
return V_137 ;
}
...
V_137 = F_186 ( * V_242 , V_245 , L_32 , L_33 ,
V_12 -> V_211 ) ;
if ( V_137 ) {
V_244 = L_34 ;
goto error;
}
V_137 = F_186 ( * V_242 , V_245 , L_35 , L_33 ,
V_12 -> V_212 ) ;
if ( V_137 ) {
V_244 = L_36 ;
goto error;
...
if ( V_243 )
F_168 ( V_245 ) ;
F_152 ( V_20 , V_137 , L_43 , V_244 ) ;
return V_137 ;
}
static void F_187 ( struct V_65 * V_30 )
{
unsigned int V_14 ;
F_188 () ;
...
static int F_191 ( struct V_65 * V_30 ,
unsigned int V_67 )
{
unsigned int V_14 ;
int V_147 ;
V_30 -> V_69 = F_192 ( V_67 , sizeof( struct V_11 ) ,
V_247 ) ;
if ( ! V_30 -> V_69 )
return - V_198 ;
F_188 () ;
...
F_143 ( V_30 -> V_31 , V_67 ) ;
F_190 () ;
if ( V_67 == 0 ) {
F_194 ( & V_30 -> V_31 -> V_20 , L_45 ) ;
return - V_140 ;
}
return 0 ;
}
static int F_195 ( struct V_196 * V_20 ,
struct V_65 * V_30 )
{
const char * V_244 ;
struct V_241 V_242 ;
...
unsigned int V_67 = 1 ;
V_30 -> V_31 -> V_193 = 0 ;
V_137 = F_133 ( V_188 , V_30 -> V_61 -> V_189 ,
L_46 , L_33 , & V_248 ) ;
if ( V_137 < 0 )
V_248 = 1 ;
V_67 = F_196 ( V_248 , V_197 ) ;
V_137 = F_133 ( V_188 , V_30 -> V_61 -> V_189 ,
L_47 , L_33 ,
& V_226 ) ;
if ( V_137 < 0 )
V_226 = 0 ;
V_137 = F_165 ( V_20 , V_30 -> V_31 -> V_249 ) ;
if ( V_137 ) {
F_152 ( V_20 , V_137 , L_48 , V_20 -> V_213 ) ;
goto V_250;
}
if ( V_30 -> V_69 )
F_187 ( V_30 ) ;
V_137 = F_191 ( V_30 , V_67 ) ;
if ( V_137 < 0 )
goto V_251;
for ( V_14 = 0 ; V_14 < V_67 ; ++ V_14 ) {
V_12 = & V_30 -> V_69 [ V_14 ] ;
V_137 = F_174 ( V_20 , V_12 , V_226 ) ;
if ( V_137 ) {
if ( V_14 > 0 ) {
F_188 () ;
...
V_137 = F_197 ( & V_242 ) ;
if ( V_137 ) {
F_152 ( V_20 , V_137 , L_49 ) ;
goto V_251;
}
if ( V_67 == 1 ) {
V_137 = F_184 ( & V_30 -> V_69 [ 0 ] , & V_242 , 0 ) ;
if ( V_137 )
goto V_253;
} else {
V_137 = F_186 ( V_242 , V_20 -> V_213 , L_50 ,
L_33 , V_67 ) ;
if ( V_137 ) {
V_244 = L_51 ;
goto V_253;
...
for ( V_14 = 0 ; V_14 < V_67 ; ++ V_14 ) {
V_12 = & V_30 -> V_69 [ V_14 ] ;
V_137 = F_184 ( V_12 , & V_242 , 1 ) ;
if ( V_137 )
goto V_253;
}
}
V_137 = F_186 ( V_242 , V_20 -> V_213 , L_52 , L_33 ,
1 ) ;
if ( V_137 ) {
V_244 = L_53 ;
goto V_254;
}
V_137 = F_186 ( V_242 , V_20 -> V_213 , L_54 , L_13 , 1 ) ;
if ( V_137 ) {
V_244 = L_55 ;
goto V_254;
}
V_137 = F_186 ( V_242 , V_20 -> V_213 , L_12 , L_13 , 1 ) ;
if ( V_137 ) {
V_244 = L_56 ;
goto V_254;
}
V_137 = F_186 ( V_242 , V_20 -> V_213 , L_15 , L_13 , 1 ) ;
if ( V_137 ) {
V_244 = L_57 ;
goto V_254;
}
V_137 = F_198 ( V_242 , V_20 -> V_213 , L_16 , L_58 ) ;
if ( V_137 ) {
V_244 = L_59 ;
goto V_254;
}
V_137 = F_198 ( V_242 , V_20 -> V_213 , L_14 ,
L_58 ) ;
if ( V_137 ) {
V_244 = L_60 ;
goto V_254;
...
struct V_11 * V_12 = NULL ;
V_137 = F_133 ( V_188 , V_66 -> V_61 -> V_189 ,
L_62 , L_33 , & V_256 ) ;
if ( V_137 != 1 )
V_256 = 0 ;
if ( ! V_256 ) {
...
static void F_206 ( struct V_196 * V_20 ,
enum V_259 V_260 )
{
struct V_65 * V_66 = F_163 ( & V_20 -> V_20 ) ;
struct V_19 * V_31 = V_66 -> V_31 ;
F_164 ( & V_20 -> V_20 , L_21 , F_207 ( V_260 ) ) ;
switch ( V_260 ) {
case V_261 :
case V_262 :
case V_263 :
...
static int F_211 ( struct V_19 * V_20 , int V_271 )
{
switch ( V_271 ) {
case V_272 :
return F_212 ( V_273 ) ;
...
void * V_66 = F_44 ( V_20 ) ;
int V_14 ;
for ( V_14 = 0 ; V_14 < F_212 ( V_273 ) ; V_14 ++ )
V_23 [ V_14 ] = F_214 ( ( V_275 * ) ( V_66 + V_273 [ V_14 ] . V_88 ) ) ;
}
static void F_215 ( struct V_19 * V_20 , T_6 V_276 , T_10 * V_23 )
{
int V_14 ;
switch ( V_276 ) {
case V_272 :
...
static T_12 F_216 ( struct V_136 * V_20 ,
struct V_278 * V_279 , char * V_280 )
{
struct V_19 * V_31 = F_217 ( V_20 ) ;
...
static T_12 F_218 ( struct V_136 * V_20 ,
struct V_278 * V_279 ,
...
static T_12 F_222 ( struct V_136 * V_20 ,
struct V_278 * V_279 , char * V_280 )
{
struct V_19 * V_31 = F_217 ( V_20 ) ;
struct V_65 * V_30 = F_44 ( V_31 ) ;
...
static int F_155 ( struct V_19 * V_31 )
{
int V_14 ;
int V_137 ;
for ( V_14 = 0 ; V_14 < F_212 ( V_287 ) ; V_14 ++ ) {
V_137 = F_223 ( & V_31 -> V_20 ,
& V_287 [ V_14 ] ) ;
if ( V_137 )
goto V_208;
}
...
V_208:
while ( -- V_14 >= 0 )
F_224 ( & V_31 -> V_20 , & V_287 [ V_14 ] ) ;
return V_137 ;
}
static void F_225 ( struct V_19 * V_31 )
{
int V_14 ;
for ( V_14 = 0 ; V_14 < F_212 ( V_287 ) ; V_14 ++ )
F_224 ( & V_31 -> V_20 , & V_287 [ V_14 ] ) ;
}
static int F_226 ( struct V_196 * V_20 )
{
struct V_65 * V_30 = F_163 ( & V_20 -> V_20 ) ;
unsigned int V_67 = V_30 -> V_31 -> V_68 ;
struct V_11 * V_12 = NULL ;
