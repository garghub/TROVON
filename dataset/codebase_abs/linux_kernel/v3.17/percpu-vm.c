...
F_10 (cpu) {
for ( V_18 = V_16 ; V_18 < V_17 ; V_18 ++ ) {
struct V_1 * * V_24 = & V_9 [ F_11 ( V_4 , V_18 ) ] ;
* V_24 = F_14 ( F_15 ( V_4 ) , V_19 , 0 ) ;
if ( ! * V_24 )
goto V_25;
}
}
...
V_25:
while ( -- V_18 >= V_16 )
F_12 ( V_9 [ F_11 ( V_4 , V_18 ) ] ) ;
F_10 (tcpu) {
if ( V_23 == V_4 )
break;
for ( V_18 = V_16 ; V_18 < V_17 ; V_18 ++ )
F_12 ( V_9 [ F_11 ( V_23 , V_18 ) ] ) ;
}
return - V_26 ;
}
...
static void F_18 ( unsigned long V_29 , int V_30 )
{
F_19 ( V_29 , V_30 << V_31 ) ;
}
...
static int F_24 ( unsigned long V_29 , struct V_1 * * V_9 ,
int V_30 )
{
return F_25 ( V_29 , V_30 << V_31 ,
V_32 , V_9 ) ;
}
...
static struct V_1 * F_46 ( void * V_29 )
{
return F_3 ( V_29 ) ;
}
