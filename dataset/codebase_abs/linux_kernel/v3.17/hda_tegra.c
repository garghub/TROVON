...
static int F_35 ( struct V_54 * V_44 )
{
int V_55 ;
struct V_1 * V_2 = V_44 -> V_56 ;
F_36 ( V_2 ) ;
if ( V_2 -> V_51 ) {
for ( V_55 = 0 ; V_55 < V_2 -> V_57 ; V_55 ++ )
F_37 ( V_2 , & V_2 -> V_10 [ V_55 ] ) ;
F_30 ( V_2 ) ;
}
F_38 ( V_2 ) ;
return 0 ;
}
static int F_39 ( struct V_1 * V_2 , struct V_58 * V_59 )
{
struct V_19 * V_20 = F_25 ( V_2 , struct V_19 , V_2 ) ;
struct V_44 * V_7 = V_20 -> V_7 ;
struct V_60 * V_61 ;
int V_62 ;
V_20 -> V_39 = F_40 ( V_7 , L_1 ) ;
if ( F_41 ( V_20 -> V_39 ) )
return F_42 ( V_20 -> V_39 ) ;
V_20 -> V_40 = F_40 ( V_7 , L_2 ) ;
if ( F_41 ( V_20 -> V_40 ) )
return F_42 ( V_20 -> V_40 ) ;
V_20 -> V_42 = F_40 ( V_7 , L_3 ) ;
if ( F_41 ( V_20 -> V_42 ) )
return F_42 ( V_20 -> V_42 ) ;
V_61 = F_43 ( V_59 , V_63 , 0 ) ;
V_20 -> V_21 = F_44 ( V_7 , V_61 ) ;
if ( F_41 ( V_2 -> V_64 ) )
return F_42 ( V_2 -> V_64 ) ;
V_2 -> V_64 = V_20 -> V_21 + V_65 ;
V_2 -> V_15 = V_61 -> V_66 + V_65 ;
V_62 = F_19 ( V_20 ) ;
if ( V_62 )
return V_62 ;
F_18 ( V_20 ) ;
...
static int F_47 ( struct V_1 * V_2 , struct V_58 * V_59 )
{
struct V_45 * V_6 = V_2 -> V_6 ;
int V_62 ;
unsigned short V_69 ;
int V_70 = F_48 ( V_59 , 0 ) ;
V_62 = F_39 ( V_2 , V_59 ) ;
if ( V_62 )
return V_62 ;
V_62 = F_49 ( V_2 -> V_6 -> V_7 , V_70 , V_71 ,
V_72 , V_73 , V_2 ) ;
if ( V_62 ) {
F_50 ( V_2 -> V_6 -> V_7 ,
L_4 ,
...
F_51 ( V_2 -> V_74 ) ;
V_69 = F_52 ( V_2 , V_75 ) ;
F_53 ( V_6 -> V_7 , L_5 , V_69 ) ;
V_2 -> V_76 = ( V_69 >> 8 ) & 0x0f ;
V_2 -> V_77 = ( V_69 >> 12 ) & 0x0f ;
...
V_2 -> V_80 = 0 ;
V_2 -> V_81 = V_2 -> V_76 ;
V_2 -> V_57 = V_2 -> V_77 + V_2 -> V_76 ;
V_2 -> V_10 = F_54 ( V_6 -> V_7 , V_2 -> V_57 ,
sizeof( * V_2 -> V_10 ) , V_82 ) ;
if ( ! V_2 -> V_10 )
return - V_83 ;
V_62 = F_55 ( V_2 ) ;
if ( V_62 < 0 )
...
strcpy ( V_6 -> V_86 , L_7 ) ;
strcpy ( V_6 -> V_87 , L_7 ) ;
snprintf ( V_6 -> V_88 , sizeof( V_6 -> V_88 ) ,
L_8 ,
V_6 -> V_87 , V_2 -> V_15 , V_2 -> V_74 ) ;
return 0 ;
}
static int F_57 ( struct V_45 * V_6 ,
unsigned int V_89 ,
...
struct V_19 * V_20 ;
int V_62 ;
const unsigned int V_104 = V_105 ;
V_20 = F_63 ( & V_59 -> V_7 , sizeof( * V_20 ) , V_82 ) ;
if ( ! V_20 )
return - V_83 ;
V_20 -> V_7 = & V_59 -> V_7 ;
V_2 = & V_20 -> V_2 ;
V_62 = F_64 ( & V_59 -> V_7 , V_106 , V_107 ,
V_108 , 0 , & V_6 ) ;
if ( V_62 < 0 ) {
F_50 ( & V_59 -> V_7 , L_10 ) ;
return V_62 ;
}
V_62 = F_57 ( V_6 , V_104 , & V_109 , V_20 ) ;
if ( V_62 < 0 )
goto V_110;
V_6 -> V_46 = V_2 ;
F_65 ( & V_59 -> V_7 , V_6 ) ;
...
static int F_73 ( struct V_58 * V_59 )
{
return F_72 ( F_24 ( & V_59 -> V_7 ) ) ;
}
