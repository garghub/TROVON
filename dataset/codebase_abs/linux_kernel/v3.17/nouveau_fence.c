...
{
struct F_19 * V_32 =
F_12 ( V_31 , F_13 ( * V_32 ) , V_31 ) ;
F_28 ( & V_32 -> V_33 -> V_34 ) ;
return V_35 ;
}
static int
F_29 ( struct V_1 * V_2 , bool V_36 )
{
struct V_19 * V_20 = V_2 -> V_8 ;
struct V_37 * V_33 = V_20 -> V_38 -> V_2 ;
struct F_19 V_32 = { . V_33 = V_33 } ;
int V_24 = 0 ;
V_24 = F_30 (chan->object, NULL,
...
int
F_19 ( struct V_1 * V_2 , bool V_40 , bool V_36 )
{
struct V_19 * V_20 = V_2 -> V_8 ;
struct V_37 * V_33 = V_20 ? V_20 -> V_38 -> V_2 : NULL ;
unsigned long V_41 = V_42 / 1000 ;
T_1 V_43 ;
int V_24 = 0 ;
while ( V_33 && V_33 -> V_44 && V_40 && ! F_16 ( V_2 ) ) {
V_24 = F_29 ( V_2 , V_36 ) ;
if ( V_24 < 0 )
return V_24 ;
}
...
struct V_19 * V_51 ;
int V_24 = 0 ;
V_51 = V_2 ? V_2 -> V_8 : NULL ;
if ( V_51 ) {
if ( F_39 ( V_51 != V_20 && ! F_16 ( V_2 ) ) ) {
V_24 = V_10 -> V_52 ( V_2 , V_51 , V_20 ) ;
if ( F_39 ( V_24 ) )
...
int
F_48 ( struct V_19 * V_20 , bool V_54 ,
struct V_1 * * V_53 )
{
struct V_1 * V_2 ;
int V_24 = 0 ;
