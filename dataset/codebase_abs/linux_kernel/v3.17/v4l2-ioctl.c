...
case V_71 :
case V_72 : {
struct V_327 * V_78 = V_19 -> V_57 . V_52 . V_78 ;
T_2 V_77 = V_19 -> V_57 . V_52 . V_77 ;
void * V_79 = V_19 -> V_57 . V_52 . V_79 ;
...
static int F_143 ( unsigned int V_189 , void * V_468 , T_3 * V_469 ,
void T_4 * * V_470 , void * * * V_471 )
{
int V_303 = 0 ;
switch ( V_189 ) {
case V_472 :
...
* V_470 = ( void T_4 * ) V_476 -> V_124 . V_125 ;
...
if ( F_147 ( V_468 , ( void T_4 * ) V_16 , V_491 ) )
goto V_493;
...
case V_452 :
case ( V_453 | V_452 ) :
if ( F_150 ( ( void T_4 * ) V_16 , V_468 , F_145 ( V_189 ) ) )
V_352 = - V_490 ;
break;
}
V_493:
