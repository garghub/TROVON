...
if ( V_2 -> V_45 ) {
V_4 -> V_46 |= V_47 ;
F_16 ( V_48 , 0x33F286 * V_49 ) ;
F_16 ( V_50 , 0x5 ) ;
}
return 0 ;
}
static void F_17 ( void * V_40 )
{
struct V_3 * V_4 = V_40 ;
struct V_1 * V_2 ;
if ( ! V_4 || ! V_4 -> V_2 )
...
int F_23 ( struct V_3 * V_4 , struct V_54 * V_55 )
{
struct V_1 * V_2 ;
struct V_52 * V_27 ;
char * V_56 = NULL ;
...
if ( V_61 && ! V_2 -> V_21 )
V_2 -> V_21 = V_61 ;
snprintf ( V_2 -> V_126 , sizeof( V_2 -> V_126 ) , L_8 , V_4 -> V_127 . V_126 ) ;
snprintf ( V_2 -> V_128 , sizeof( V_2 -> V_128 ) , L_9 , F_26 ( V_55 ) ) ;
V_27 -> V_129 = V_2 -> V_126 ;
V_27 -> V_130 = V_2 -> V_128 ;
V_27 -> V_131 . V_132 = V_133 ;
V_27 -> V_131 . V_134 = 1 ;
if ( V_55 -> V_135 ) {
V_27 -> V_131 . V_136 = V_55 -> V_135 ;
V_27 -> V_131 . V_137 = V_55 -> V_138 ;
} else {
V_27 -> V_131 . V_136 = V_55 -> V_136 ;
V_27 -> V_131 . V_137 = V_55 -> V_139 ;
}
V_27 -> V_27 . V_140 = & V_55 -> V_27 ;
V_27 -> V_141 = V_56 ;
V_27 -> V_142 = V_143 ;
V_27 -> V_40 = V_4 ;
V_27 -> V_144 = F_21 ;
...
V_154 = F_34 ( V_153 , 32U - F_35 ( V_156 . V_159 ? V_152 : ~ V_152 ) ) ;
...
static int F_38 ( struct V_162 * V_2 , enum V_57 * V_163 ,
T_1 * V_33 , T_3 * V_164 )
{
int V_165 , V_166 ;
V_165 = F_39 ( V_2 -> V_167 , 0x10 ) ;
if ( V_165 < 0 ) {
F_40 ( L_10 ) ;
return 0 ;
}
...
F_42 ( V_169 . type , L_12 , V_176 ) ;
switch ( V_4 -> V_9 ) {
case V_177 :
V_173 = V_172 ;
V_4 -> V_178 . V_126 = L_13 ;
V_4 -> V_178 . type = V_179 ;
V_4 -> V_178 . V_180 = F_38 ;
...
if ( * V_174 == 0x71 ) {
V_4 -> V_178 . V_126 = L_14 ;
V_4 -> V_178 . V_56 = V_81 ;
V_4 -> V_178 . type = V_183 ;
V_4 -> V_178 . V_184 = V_185 ;
V_169 . V_182 = & V_4 -> V_178 ;
}
if ( F_43 ( & V_4 -> V_186 , * V_174 , 0 ,
V_187 , 0 ,
V_188 , NULL ) >= 0 ) {
V_169 . V_31 = * V_174 ;
F_44 ( & V_4 -> V_186 , & V_169 ) ;
break;
}
}
}
