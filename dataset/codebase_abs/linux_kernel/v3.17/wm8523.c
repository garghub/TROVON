...
unsigned int V_35 ;
int V_62 , V_21 ;
V_13 = F_26 ( & V_79 -> V_2 , sizeof( struct V_12 ) ,
V_82 ) ;
if ( V_13 == NULL )
return - V_83 ;
V_13 -> V_72 = F_27 ( V_79 , & V_84 ) ;
if ( F_28 ( V_13 -> V_72 ) ) {
V_62 = F_29 ( V_13 -> V_72 ) ;
...
V_62 = F_30 ( & V_79 -> V_2 , F_8 ( V_13 -> V_71 ) ,
V_13 -> V_71 ) ;
if ( V_62 != 0 ) {
...
F_32 ( & V_79 -> V_2 , L_11 ,
( V_35 & V_88 ) + 'A' ) ;
V_62 = F_33 ( V_13 -> V_72 , V_4 , 0x8523 ) ;
if ( V_62 != 0 ) {
...
static int F_36 ( struct V_78 * V_91 )
{
F_37 ( & V_91 -> V_2 ) ;
return 0 ;
}
