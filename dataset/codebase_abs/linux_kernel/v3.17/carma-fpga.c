...
V_81 = V_44 ;
V_78 = V_76 -> V_85 -> V_88 ( V_76 , V_80 , V_81 ,
V_41 ,
V_82 ) ;
if ( ! V_78 ) {
F_21 ( V_4 -> V_21 , L_13 ) ;
...
static T_5 F_45 ( int V_91 , void * V_92 )
{
struct V_3 * V_4 = V_92 ;
bool V_93 = false ;
struct V_6 * V_7 ;
...
V_94 = F_32 ( V_4 , V_24 , V_64 ) ;
if ( ! ( V_94 & ( V_95 | V_96 ) ) ) {
F_21 ( V_4 -> V_21 , L_15 ) ;
return V_97 ;
}
}
V_94 = F_33 ( V_4 -> V_51 + V_98 ) ;
if ( V_94 & V_99 ) {
F_21 ( V_4 -> V_21 , L_16 ) ;
return V_97 ;
}
...
F_36 ( V_4 ) ;
V_11 = F_54 ( V_4 -> V_91 , F_45 , V_106 , V_107 , V_4 ) ;
if ( V_11 ) {
F_21 ( V_4 -> V_21 , L_22 ) ;
goto V_105;
}
...
F_52 ( & V_4 -> V_67 ) ;
F_62 ( V_111 , L_23 , V_4 -> V_69 ) ;
F_62 ( V_111 , L_24 , V_4 -> V_23 ) ;
F_62 ( V_111 , L_25 , V_4 -> V_22 ) ;
F_62 ( V_111 , L_26 , F_59 ( & V_4 -> free ) ) ;
F_62 ( V_111 , L_27 , V_4 -> V_20 != NULL ) ;
F_62 ( V_111 , L_28 , F_59 ( & V_4 -> V_68 ) ) ;
F_62 ( V_111 , L_29 , V_4 -> V_100 ) ;
F_53 ( & V_4 -> V_67 ) ;
return 0 ;
}
static int F_63 ( struct V_114 * V_114 , struct V_115 * V_115 )
{
return F_64 ( V_115 , F_61 , V_114 -> V_116 ) ;
}
static int F_65 ( struct V_3 * V_4 )
{
V_4 -> V_117 = F_66 ( V_107 , V_118 , NULL , V_4 ,
& V_119 ) ;
return F_67 ( V_4 -> V_117 ) ;
}
...
static T_6 F_70 ( struct V_85 * V_21 , struct V_120 * V_121 ,
char * V_7 )
{
struct V_3 * V_4 = F_71 ( V_21 ) ;
int V_11 ;
F_52 ( & V_4 -> V_67 ) ;
...
static T_6 F_72 ( struct V_85 * V_21 , struct V_120 * V_121 ,
const char * V_7 , T_1 V_122 )
{
struct V_3 * V_4 = F_71 ( V_21 ) ;
unsigned long V_123 ;
int V_11 ;
V_11 = F_73 ( V_7 , 0 , & V_123 ) ;
if ( V_11 ) {
F_21 ( V_4 -> V_21 , L_31 ) ;
return V_11 ;
}
...
static int F_76 ( struct V_114 * V_114 , struct V_115 * V_125 )
{
...
static int F_79 ( struct V_114 * V_114 , struct V_115 * V_125 )
{
...
static T_6 F_81 ( struct V_115 * V_125 , char T_7 * V_130 , T_1 V_122 ,
T_8 * V_131 )
{
struct V_128 * V_129 = V_125 -> V_126 ;
struct V_3 * V_4 = V_129 -> V_4 ;
...
static unsigned int F_85 ( struct V_115 * V_125 , struct V_142 * V_143 )
{
struct V_128 * V_129 = V_125 -> V_126 ;
struct V_3 * V_4 = V_129 -> V_4 ;
unsigned int V_144 = 0 ;
F_86 ( V_125 , & V_4 -> V_70 , V_143 ) ;
if ( ! F_47 ( & V_4 -> V_68 ) )
V_144 |= V_145 | V_146 ;
return V_144 ;
}
static int F_87 ( struct V_115 * V_125 , struct V_147 * V_148 )
{
struct V_128 * V_129 = V_125 -> V_126 ;
struct V_3 * V_4 = V_129 -> V_4 ;
...
V_148 -> V_158 = F_88 ( V_148 -> V_158 ) ;
return F_89 ( V_148 , V_148 -> V_155 , V_151 , V_149 ,
V_148 -> V_158 ) ;
}
static bool F_90 ( struct V_75 * V_76 , void * V_65 )
{
if ( V_76 -> V_159 == 0 && V_76 -> V_85 -> V_92 == 0 )
return false ;
return true ;
}
static int F_91 ( struct V_160 * V_161 )
{
struct V_162 * V_163 = V_161 -> V_21 . V_163 ;
struct V_85 * V_164 ;
struct V_3 * V_4 ;
struct V_165 V_166 ;
T_9 V_144 ;
...
F_10 ( & V_4 -> V_68 ) ;
F_97 ( & V_4 -> V_70 ) ;
V_4 -> V_127 . V_167 = V_168 ;
V_4 -> V_127 . V_169 = V_107 ;
V_4 -> V_127 . V_170 = & V_171 ;
V_11 = F_98 ( V_163 , 0 , & V_166 ) ;
if ( V_11 ) {
F_21 ( & V_161 -> V_21 , L_39 ) ;
V_11 = - V_172 ;
goto V_173;
}
V_4 -> V_29 = V_166 . V_174 ;
V_4 -> V_156 = F_99 ( & V_166 ) ;
V_4 -> V_51 = F_100 ( V_163 , 0 ) ;
if ( ! V_4 -> V_51 ) {
F_21 ( & V_161 -> V_21 , L_40 ) ;
V_11 = - V_27 ;
goto V_173;
}
F_101 ( V_144 ) ;
...
F_102 ( V_177 , V_144 ) ;
F_102 ( V_178 , V_144 ) ;
V_4 -> V_76 = F_103 ( V_144 , F_90 , NULL ) ;
if ( ! V_4 -> V_76 ) {
F_21 ( & V_161 -> V_21 , L_41 ) ;
V_11 = - V_172 ;
goto V_179;
}
V_4 -> V_91 = F_104 ( V_163 , 0 ) ;
if ( V_4 -> V_91 == V_180 ) {
F_21 ( & V_161 -> V_21 , L_42 ) ;
V_11 = - V_172 ;
goto V_181;
}
F_31 ( V_99 , V_4 -> V_51 + V_182 ) ;
V_11 = F_105 ( & V_4 -> V_127 ) ;
if ( V_11 ) {
F_21 ( & V_161 -> V_21 , L_43 ) ;
goto V_183;
}
V_11 = F_65 ( V_4 ) ;
if ( V_11 ) {
F_21 ( & V_161 -> V_21 , L_44 ) ;
goto V_184;
}
V_164 = V_4 -> V_127 . V_164 ;
F_95 ( V_164 , V_4 ) ;
V_11 = F_106 ( & V_164 -> V_185 , & V_186 ) ;
if ( V_11 ) {
F_21 ( & V_161 -> V_21 , L_45 ) ;
goto V_187;
}
F_107 ( & V_161 -> V_21 , L_46 ) ;
return 0 ;
V_187:
F_68 ( V_4 ) ;
V_184:
...
static int F_112 ( struct V_160 * V_161 )
{
struct V_3 * V_4 = F_113 ( V_161 ) ;
struct V_85 * V_164 = V_4 -> V_127 . V_164 ;
F_114 ( & V_164 -> V_185 , & V_186 ) ;
F_68 ( V_4 ) ;
F_56 ( V_4 ) ;
F_108 ( & V_4 -> V_127 ) ;
F_109 ( V_4 -> V_91 ) ;
