...
static int F_24 ( struct V_1 * V_2 , unsigned int V_112 ,
unsigned long V_113 )
{
struct V_58 * V_59 = & V_2 -> V_59 ;
F_13 ( L_6 , V_2 -> V_89 ) ;
...
F_25 ( 20 ) ;
F_3 ( V_59 -> V_65 , V_2 -> V_63 ) ;
return F_21 ( & V_2 -> V_111 , V_112 , V_113 ) ;
}
...
struct V_1 * V_2 = V_96 -> V_2 ;
void T_1 * V_8 = V_2 -> V_9 -> V_10 [ V_11 ] ;
void T_1 * V_126 = V_2 -> V_9 -> V_10 [ V_127 ] ;
T_3 V_18 ;
while ( 1 ) {
V_18 = F_2 ( V_126 + V_128 ) ;
if ( V_18 & V_129 ) {
F_6 ( V_130 L_11 , V_55 ) ;
F_3 ( V_126 + V_128 , V_129 | V_131 ) ;
F_3 ( V_126 + V_104 ,
F_2 ( V_126 + V_104 ) & ~ V_106 ) ;
continue;
}
if ( V_18 & V_132 ) {
T_3 V_133 , V_134 ;
V_133 = F_2 ( V_8 + V_135 ) ;
V_134 = F_2 ( V_8 + V_136 ) ;
F_6 ( V_130 L_12 , V_55 , V_133 , V_134 ) ;
F_3 ( V_126 + V_128 , V_132 | V_131 ) ;
F_3 ( V_126 + V_104 ,
F_2 ( V_126 + V_104 ) & ~ V_106 ) ;
continue;
}
...
F_2 ( V_126 + V_104 ) & ~ V_106 ) ;
F_6 ( V_130 L_14 , V_55 ) ;
F_3 ( V_126 + V_128 , V_138 | V_131 ) ;
continue;
}
if ( V_18 & V_131 ) {
unsigned int V_121 ;
unsigned long V_113 = F_30 ( V_139 , V_140 ) ;
F_6 ( V_130 L_15 , V_55 ) ;
F_3 ( V_126 + V_128 , V_131 ) ;
F_26 ( & V_2 -> V_111 , & V_121 , V_113 ) ;
continue;
}
if ( V_18 & V_141 ) {
F_3 ( V_126 + V_128 , V_141 ) ;
continue;
}
if ( V_18 & V_142 ) {
F_3 ( V_126 + V_128 , V_142 ) ;
continue;
}
if ( V_18 & V_143 ) {
F_3 ( V_126 + V_128 , V_143 ) ;
continue;
}
break;
}
...
{
void T_1 * V_100 = V_2 -> V_59 . V_101 ;
T_2 V_144 = F_2 ( V_100 + V_145 ) ;
T_3 V_146 = F_2 ( V_100 + V_128 ) ;
struct V_95 * V_96 = F_33 ( V_2 , V_2 -> V_111 . V_147 ) ;
static int V_148 = 0 ;
...
static unsigned int F_34 ( struct V_3 * V_154 , unsigned char * V_159 ,
unsigned int V_160 , int V_97 )
{
struct V_1 * V_2 = V_154 -> V_111 -> V_2 ;
unsigned int V_161 = V_160 >> 1 ;
unsigned int V_118 ;
T_4 * V_162 = ( T_4 * ) V_159 ;
void T_1 * V_100 = V_2 -> V_59 . V_163 ;
if ( V_97 == V_164 )
for ( V_118 = 0 ; V_118 < V_161 ; V_118 ++ )
V_162 [ V_118 ] = F_35 ( F_2 ( V_100 ) ) ;
else
for ( V_118 = 0 ; V_118 < V_161 ; V_118 ++ )
F_3 ( V_100 , F_36 ( V_162 [ V_118 ] ) ) ;
if ( F_37 ( V_160 & 0x01 ) ) {
T_4 V_165 [ 1 ] = { 0 } ;
unsigned char * V_166 = V_159 + V_160 - 1 ;
if ( V_97 == V_164 ) {
V_165 [ 0 ] = F_35 ( F_2 ( V_100 ) ) ;
memcpy ( V_166 , V_165 , 1 ) ;
} else {
memcpy ( V_165 , V_166 , 1 ) ;
F_3 ( V_100 , F_36 ( V_165 [ 0 ] ) ) ;
}
V_161 ++ ;
}
return V_161 << 1 ;
...
if ( V_121 [ 1 ] != V_167 )
V_2 -> V_107 -> V_109 ( V_2 , 0 ) ;
if ( V_121 [ 0 ] == V_167 && V_121 [ 1 ] == V_167 ) {
F_13 ( L_17 ) ;
return;
}
...
if ( ! V_100 )
return;
F_3 ( V_100 + V_145 , F_2 ( V_100 + V_145 ) ) ;
}
...
static int F_43 ( struct V_169 * V_9 )
{
void T_1 * V_8 = V_9 -> V_10 [ V_11 ] ;
void T_1 * V_126 = V_9 -> V_10 [ V_127 ] ;
void T_1 * V_12 = V_8 + V_13 ;
void T_1 * V_170 = V_8 + V_171 ;
void T_1 * V_172 = V_8 + V_173 ;
void T_1 * V_174 = V_126 + V_175 ;
void T_1 * V_176 = V_126 + V_145 ;
T_3 V_18 = 0 ;
F_3 ( V_12 , V_18 ) ;
V_18 |= V_20 ;
F_3 ( V_12 , V_18 ) ;
...
static void F_44 ( struct V_58 * V_59 , void T_1 * V_185 )
{
V_59 -> V_186 = V_185 + V_187 ;
V_59 -> V_91 = V_59 -> V_186 + V_188 ;
V_59 -> V_65 = V_59 -> V_186 + V_188 ;
V_59 -> V_101 = V_185 ;
V_59 -> V_163 = V_59 -> V_186 + V_189 ;
V_59 -> V_87 = V_59 -> V_186 + V_190 ;
V_59 -> V_67 = V_59 -> V_186 + V_191 ;
V_59 -> V_69 = V_59 -> V_186 + V_192 ;
V_59 -> V_71 = V_59 -> V_186 + V_193 ;
V_59 -> V_73 = V_59 -> V_186 + V_194 ;
V_59 -> V_75 = V_59 -> V_186 + V_195 ;
V_59 -> V_83 = V_59 -> V_186 + V_196 ;
V_59 -> V_85 = V_59 -> V_186 + V_197 ;
V_59 -> V_90 = V_59 -> V_186 + V_198 ;
}
static int F_45 ( struct V_169 * V_9 )
{
struct V_199 * V_200 = F_46 ( V_9 -> V_154 ) ;
int V_116 ;
V_116 = F_43 ( V_9 ) ;
if ( V_116 )
return V_116 ;
V_116 = F_47 ( V_200 , V_201 ) ;
if ( V_116 )
return V_116 ;
V_116 = F_48 ( V_200 , V_201 ) ;
if ( V_116 )
return V_116 ;
F_44 ( & V_9 -> V_202 [ 0 ] -> V_59 , V_9 -> V_10 [ V_127 ] ) ;
F_49 ( V_200 ) ;
return 0 ;
}
static int F_50 ( struct V_199 * V_200 , const struct V_203 * V_204 )
{
unsigned int V_205 = ( unsigned int ) V_204 -> V_206 ;
const struct V_207 * V_208 [] = { & V_209 [ V_205 ] , NULL } ;
struct V_169 * V_9 ;
int V_116 ;
F_51 ( & V_200 -> V_154 , V_210 ) ;
V_9 = F_52 ( & V_200 -> V_154 , V_208 , 1 ) ;
if ( ! V_9 )
return - V_211 ;
V_116 = F_53 ( V_200 ) ;
if ( V_116 )
return V_116 ;
V_116 = F_54 ( V_200 , ( 1 << V_11 ) | ( 1 << V_127 ) , V_55 ) ;
if ( V_116 == - V_212 )
F_55 ( V_200 ) ;
if ( V_116 )
return V_116 ;
V_9 -> V_10 = F_56 ( V_200 ) ;
F_57 ( V_9 -> V_202 [ 0 ] , V_11 , - 1 , L_20 ) ;
F_57 ( V_9 -> V_202 [ 0 ] , V_127 , - 1 , L_21 ) ;
V_116 = F_45 ( V_9 ) ;
if ( V_116 )
return V_116 ;
return F_58 ( V_9 , V_200 -> V_213 , V_214 ,
V_215 , & V_216 ) ;
}
