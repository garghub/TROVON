...
{
int V_63 ;
for ( V_63 = 1 ; V_63 <= V_35 -> V_28 . V_37 ; V_63 ++ ) {
if ( F_8 ( & V_35 -> V_56 [ V_63 ] ) )
continue;
if ( V_35 -> V_56 [ V_63 ] . V_57 )
F_25 ( V_35 -> V_56 [ V_63 ] . V_57 -> V_35 ) ;
V_35 -> V_56 [ V_63 ] . V_57 = NULL ;
}
if ( ! V_35 -> V_64 )
F_22 ( V_35 , false ) ;
F_26 ( V_35 -> V_56 ) ;
...
int V_32 ;
struct V_54 * V_35 ;
int V_66 = F_28 ( V_4 -> V_51 , V_47 ) ;
if ( V_66 < 0 )
return NULL ;
V_35 = F_29 ( sizeof( * V_35 ) , V_67 ) ;
if ( ! V_35 )
return NULL ;
V_35 -> V_4 = V_4 ;
if ( F_30 ( V_4 -> V_51 , & V_35 -> V_28 , V_47 , 0 , 2 , 0 , 5 ) )
goto V_50;
F_3 ( V_4 ,
L_32 ,
V_47 , F_31 ( V_47 ) , V_66 ) ;
...
F_32 ( V_35 , L_34 ,
V_35 -> V_28 . V_6 ) ;
if ( V_35 -> V_28 . V_7 != 0x1547 && V_35 -> V_28 . V_7 != 0x1549 )
F_32 ( V_35 , L_35 ,
V_35 -> V_28 . V_7 ) ;
...
if ( ! V_35 -> V_56 )
goto V_50;
for ( V_63 = 0 ; V_63 <= V_35 -> V_28 . V_37 ; V_63 ++ ) {
V_35 -> V_56 [ V_63 ] . V_35 = V_35 ;
V_35 -> V_56 [ V_63 ] . V_2 = V_63 ;
}
V_32 = F_16 ( & V_35 -> V_56 [ 0 ] , V_61 , V_68 ) ;
if ( V_32 < 0 ) {
F_32 ( V_35 , L_36 ) ;
goto V_50;
}
...
if ( F_34 ( V_35 ) )
F_32 ( V_35 , L_37 ) ;
F_35 ( V_35 , L_38 , V_35 -> V_69 ) ;
for ( V_63 = 0 ; V_63 <= V_35 -> V_28 . V_37 ; V_63 ++ ) {
if ( V_35 -> V_56 [ V_63 ] . V_70 ) {
F_9 ( & V_35 -> V_56 [ V_63 ] , L_39 ) ;
continue;
}
if ( F_15 ( & V_35 -> V_56 [ V_63 ] ) )
goto V_50;
}
if ( F_22 ( V_35 , true ) )
goto V_50;
...
V_35 -> V_64 = true ;
for ( V_63 = 0 ; V_63 <= V_35 -> V_28 . V_37 ; V_63 ++ ) {
if ( ! F_8 ( & V_35 -> V_56 [ V_63 ] ) && V_35 -> V_56 [ V_63 ] . V_57 )
F_36 ( V_35 -> V_56 [ V_63 ] . V_57 -> V_35 ) ;
}
}
...
return V_50 ;
for ( V_63 = 1 ; V_63 <= V_35 -> V_28 . V_37 ; V_63 ++ ) {
struct V_14 * V_2 = & V_35 -> V_56 [ V_63 ] ;
if ( F_8 ( V_2 ) )
continue;
if ( ! V_2 -> V_57 )
continue;
