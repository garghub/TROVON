...
static void F_35 ( struct V_3 * V_4 , unsigned int V_75 )
{
struct V_5 * V_6 = V_4 -> V_7 ;
unsigned long V_80 ;
if ( V_6 -> V_81 != V_75 ) {
...
static int F_38 ( struct V_3 * V_4 , T_1 V_75 )
{
struct V_5 * V_6 = V_4 -> V_7 ;
...
static int F_39 ( struct V_3 * V_4 , unsigned int V_1 ,
T_1 V_75 )
{
struct V_5 * V_6 = V_4 -> V_7 ;
...
{
const struct V_86 * V_87 = F_41 ( V_4 ) ;
struct V_5 * V_6 = V_4 -> V_7 ;
...
struct V_92 * V_93 )
{
unsigned int V_94 = F_10 ( V_93 -> V_95 [ 0 ] ) ;
unsigned int V_96 = F_11 ( V_93 -> V_95 [ 0 ] ) ;
int V_55 ;
for ( V_55 = 1 ; V_55 < V_93 -> V_97 ; V_55 ++ ) {
unsigned int V_21 = F_10 ( V_93 -> V_95 [ V_55 ] ) ;
unsigned int V_2 = F_11 ( V_93 -> V_95 [ V_55 ] ) ;
if ( V_21 != ( V_94 + V_55 ) % V_11 -> V_98 ) {
F_45 ( V_4 -> V_39 ,
L_4 ) ;
return - V_40 ;
}
...
int V_99 = 0 ;
unsigned int V_100 ;
V_99 |= F_47 ( & V_93 -> V_101 , V_102 | V_103 ) ;
V_99 |= F_47 ( & V_93 -> V_104 ,
V_105 | V_106 | V_103 ) ;
V_99 |= F_47 ( & V_93 -> V_107 ,
V_106 | V_102 | V_103 ) ;
V_99 |= F_47 ( & V_93 -> V_108 , V_109 ) ;
V_99 |= F_47 ( & V_93 -> V_110 , V_109 | V_111 ) ;
if ( V_99 )
return 1 ;
V_99 |= F_48 ( V_93 -> V_101 ) ;
V_99 |= F_48 ( V_93 -> V_104 ) ;
V_99 |= F_48 ( V_93 -> V_107 ) ;
V_99 |= F_48 ( V_93 -> V_110 ) ;
if ( V_93 -> V_104 == V_105 && V_93 -> V_107 == V_102 )
V_99 |= - V_40 ;
if ( V_93 -> V_104 != V_105 && V_93 -> V_107 != V_102 )
V_99 |= - V_40 ;
if ( V_93 -> V_101 == V_103 &&
( V_93 -> V_107 == V_103 || V_93 -> V_104 == V_103 ) )
V_99 |= - V_40 ;
if ( V_99 )
return 2 ;
switch ( V_93 -> V_101 ) {
case V_102 :
V_99 |= F_49 ( & V_93 -> V_112 , 0 ) ;
break;
case V_103 :
if ( ( V_93 -> V_112
& ( V_113 & ~ ( V_114 | V_115 ) ) ) != 0 ) {
...
if ( ! V_87 -> V_116 && ( V_93 -> V_112 & V_115 ) ) {
V_93 -> V_112 &= ( V_113 & ~ V_115 ) ;
V_99 |= - V_40 ;
}
break;
}
if ( V_93 -> V_104 == V_106 )
V_99 |= F_50 ( & V_93 -> V_117 ,
V_87 -> V_118 * V_93 -> V_97 ) ;
if ( V_93 -> V_107 == V_106 )
V_99 |= F_50 ( & V_93 -> V_119 ,
V_87 -> V_118 ) ;
V_99 |= F_49 ( & V_93 -> V_120 , V_93 -> V_97 ) ;
if ( V_93 -> V_110 == V_111 )
V_99 |= F_49 ( & V_93 -> V_121 , 0 ) ;
if ( V_99 )
return 3 ;
if ( V_93 -> V_104 == V_106 ) {
V_100 = V_93 -> V_117 ;
...
& V_6 -> V_124 ,
& V_100 , V_93 -> V_41 ) ;
V_99 |= F_49 ( & V_93 -> V_119 , V_100 ) ;
}
if ( V_99 )
return 4 ;
if ( V_93 -> V_95 && V_93 -> V_97 > 0 )
V_99 |= F_44 ( V_4 , V_11 , V_93 ) ;
if ( V_99 )
return 5 ;
return 0 ;
}
...
{
struct V_5 * V_6 = V_4 -> V_7 ;
unsigned long V_125 = V_6 -> V_126 + V_127 ;
F_53 ( V_125 , 0 , 1 , V_128 | V_129 ) ;
F_53 ( V_125 , 0 , 2 , V_128 | V_129 ) ;
F_54 ( V_125 , 0 , 1 , V_6 -> V_123 ) ;
F_54 ( V_125 , 0 , 2 , V_6 -> V_124 ) ;
}
...
F_13 ( 0 , V_6 -> V_33 + V_34 ) ;
V_24 = F_14 ( F_10 ( V_93 -> V_95 [ 0 ] ) ) |
F_15 ( F_10 ( V_93 -> V_95 [ V_93 -> V_97 - 1 ] ) ) |
F_16 ( F_11 ( V_93 -> V_95 [ 0 ] ) ) ;
if ( F_11 ( V_93 -> V_95 [ 0 ] ) & V_29 )
V_24 |= V_30 ;
if ( F_12 ( V_93 -> V_95 [ 0 ] ) != V_31 )
V_24 |= V_32 ;
if ( V_93 -> V_107 == V_103 || V_93 -> V_104 == V_103 )
V_24 |= V_133 ;
else
V_24 |= V_134 ;
F_13 ( V_24 , V_6 -> V_16 + V_17 ) ;
if ( V_93 -> V_104 == V_106 || V_93 -> V_107 == V_106 )
F_52 ( V_4 ) ;
if ( V_93 -> V_110 == V_109 )
V_6 -> V_135 = V_93 -> V_97 * V_93 -> V_121 ;
F_21 ( & V_4 -> V_42 , V_41 ) ;
V_6 -> V_136 |= V_137 ;
V_6 -> V_136 &= ~ V_138 ;
if ( V_93 -> V_41 & V_139 ) {
if ( V_93 -> V_107 == V_102 && V_93 -> V_97 > 1 ) {
V_6 -> V_136 |= V_140 ;
} else {
V_6 -> V_136 |= V_141 ;
}
...
unsigned int V_94 = F_10 ( V_93 -> V_95 [ 0 ] ) ;
if ( V_93 -> V_97 > 1 ) {
unsigned int V_153 = F_10 ( V_93 -> V_95 [ 1 ] ) ;
if ( V_94 != 0 || V_153 != 1 ) {
F_45 ( V_4 -> V_39 ,
L_6 ) ;
return - V_40 ;
...
int V_99 = 0 ;
unsigned int V_100 ;
V_99 |= F_47 ( & V_93 -> V_101 , V_154 ) ;
V_99 |= F_47 ( & V_93 -> V_104 ,
V_106 | V_103 ) ;
V_99 |= F_47 ( & V_93 -> V_107 , V_102 ) ;
V_99 |= F_47 ( & V_93 -> V_108 , V_109 ) ;
V_99 |= F_47 ( & V_93 -> V_110 , V_109 | V_111 ) ;
if ( V_99 )
return 1 ;
...
struct V_130 * V_131 = V_11 -> V_131 ;
struct V_92 * V_93 = & V_11 -> V_131 -> V_93 ;
unsigned long V_41 ;
if ( V_159 != V_93 -> V_112 )
return - V_40 ;
if ( V_93 -> V_110 == V_109 && V_6 -> V_163 < V_161 )
V_161 = V_6 -> V_163 ;
V_160 = F_60 ( V_11 , V_6 -> V_164 ,
V_161 * sizeof( short ) ) ;
V_161 = V_160 / sizeof( short ) ;
if ( V_93 -> V_110 == V_109 )
V_6 -> V_163 -= V_161 ;
F_61 ( V_6 -> V_48 + V_52 , V_6 -> V_164 , V_160 ) ;
F_21 ( & V_4 -> V_42 , V_41 ) ;
...
{
struct V_5 * V_6 = V_4 -> V_7 ;
unsigned long V_125 = V_6 -> V_126 + V_171 ;
F_53 ( V_125 , 0 , 1 , V_128 | V_129 ) ;
F_53 ( V_125 , 0 , 2 , V_128 | V_129 ) ;
F_54 ( V_125 , 0 , 1 , V_6 -> V_156 ) ;
F_54 ( V_125 , 0 , 2 , V_6 -> V_157 ) ;
}
...
unsigned long V_41 ;
F_21 ( & V_4 -> V_42 , V_41 ) ;
for ( V_55 = 0 ; V_55 < V_93 -> V_97 ; V_55 ++ ) {
V_6 -> V_43 |=
F_3 ( F_10 ( V_93 -> V_95 [ V_55 ] ) ) ;
V_6 -> V_43 |= F_1 ( F_10 ( V_93 -> V_95 [ V_55 ] ) ,
F_11 ( V_93 ->
V_95 [ V_55 ] ) ) ;
}
F_13 ( V_6 -> V_43 , V_6 -> V_16 + V_46 ) ;
...
F_62 ( V_4 ) ;
if ( V_93 -> V_110 == V_109 )
V_6 -> V_163 = V_93 -> V_97 * V_93 -> V_121 ;
F_21 ( & V_4 -> V_42 , V_41 ) ;
switch ( V_93 -> V_104 ) {
case V_106 :
V_6 -> V_43 |= V_172 ;
...
static void F_65 ( struct V_3 * V_4 , unsigned int V_15 )
{
const struct V_86 * V_87 = F_41 ( V_4 ) ;
struct V_5 * V_6 = V_4 -> V_7 ;
...
static T_2 F_67 ( int V_179 , void * V_180 )
{
...
F_71 ( V_6 -> V_33 + V_35 , V_6 -> V_192 ,
V_183 ) ;
F_72 ( V_11 , V_6 -> V_192 ,
V_183 * sizeof( short ) ) ;
V_6 -> V_135 -= V_183 ;
if ( V_93 -> V_110 == V_109 && V_6 -> V_135 == 0 )
V_131 -> V_176 |= V_178 ;
F_21 ( & V_4 -> V_42 , V_41 ) ;
F_13 ( V_6 -> V_136 | INT ,
V_6 -> V_16 + V_145 ) ;
...
return - V_200 ;
V_4 -> V_201 = V_87 ;
V_4 -> V_202 = V_87 -> V_203 ;
V_6 = F_77 ( V_4 , sizeof( * V_6 ) ) ;
if ( ! V_6 )
return - V_204 ;
V_25 = F_78 ( V_4 ) ;
if ( V_25 )
return V_25 ;
V_6 -> V_60 = F_79 ( V_198 , 0 ) ;
V_6 -> V_16 = F_79 ( V_198 , 1 ) ;
V_6 -> V_33 = F_79 ( V_198 , 2 ) ;
V_6 -> V_126 = F_79 ( V_198 , 3 ) ;
if ( V_87 -> V_205 )
V_6 -> V_48 = F_79 ( V_198 , 4 ) ;
F_70 ( V_190 ,
V_6 -> V_60 + V_186 ) ;
V_25 = F_80 ( V_198 -> V_179 , F_67 , V_206 ,
V_4 -> V_202 , V_4 ) ;
if ( V_25 ) {
F_45 ( V_4 -> V_39 , L_11 ,
V_198 -> V_179 ) ;
...
V_11 -> V_98 = V_87 -> V_214 ;
V_11 -> V_215 = V_87 -> V_214 ;
V_11 -> V_216 = ( 1 << V_87 -> V_217 ) - 1 ;
V_11 -> V_218 = V_87 -> V_219 ;
V_11 -> V_220 = F_9 ;
V_11 -> V_221 = F_18 ;
V_11 -> V_222 = F_55 ;
V_11 -> V_223 = F_46 ;
...
V_11 -> V_220 = F_34 ;
V_11 -> V_230 = F_33 ;
for ( V_55 = 0 ; V_55 < V_11 -> V_98 ; V_55 ++ )
F_32 ( V_4 , V_55 , V_11 -> V_216 / 2 ) ;
V_11 = & V_4 -> V_207 [ 5 ] ;
V_11 -> type = V_235 ;
V_11 -> V_209 = V_210 | V_226 | V_234 ;
if ( V_87 -> V_89 == V_90 ) {
...
static int F_88 ( struct V_197 * V_4 ,
const struct V_242 * V_36 )
{
return F_89 ( V_4 , & V_243 ,
V_36 -> V_244 ) ;
}
