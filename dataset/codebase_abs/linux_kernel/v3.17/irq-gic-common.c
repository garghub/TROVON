...
F_4 ( 0 , V_2 + V_9 + V_15 / 4 ) ;
for ( V_15 = 32 ; V_15 < V_14 ; V_15 += 4 )
F_4 ( 0xa0a0a0a0 , V_2 + V_16 + V_15 ) ;
for ( V_15 = 32 ; V_15 < V_14 ; V_15 += 32 )
F_4 ( 0xffffffff , V_2 + V_13 + V_15 / 8 ) ;
if ( F_2 )
F_2 () ;
}
...
{
int V_15 ;
F_4 ( 0xffff0000 , V_2 + V_13 ) ;
F_4 ( 0x0000ffff , V_2 + V_12 ) ;
for ( V_15 = 0 ; V_15 < 32 ; V_15 += 4 )
F_4 ( 0xa0a0a0a0 , V_2 + V_16 + V_15 * 4 / 4 ) ;
if ( F_2 )
F_2 () ;
}
