...
static T_5 F_153 ( struct V_220 * V_221 ,
const char * V_14 , T_6 V_166 )
{
char V_167 [ 9 ] ;
char V_15 [ 17 ] ;
...
static T_5 F_156 ( struct V_220 * V_221 ,
const char * V_14 , T_6 V_166 )
{
struct V_10 * V_170 ;
struct V_1 * V_151 ;
...
V_226 = F_126 ( sizeof( struct V_150 ) , V_126 ) ;
if ( ! V_226 ) {
V_53 = - V_33 ;
goto V_230;
}
...
V_226 -> V_180 = & V_181 ;
V_226 -> V_182 = V_183 ;
V_226 -> V_186 = ( void ( * ) ( struct V_150 * ) ) F_68 ;
V_226 -> V_187 = & V_188 ;
V_53 = F_128 ( V_226 ) ;
if ( V_53 ) {
F_129 ( V_226 ) ;
