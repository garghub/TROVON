...
F_134 ( V_7 -> V_2 , & V_7 -> V_151 , F_69 , V_238 ) ;
...
F_143 ( V_7 ) ;
V_7 -> V_13 = V_120 ;
memset ( & V_7 -> V_128 , 0 , sizeof( struct V_248 ) ) ;
F_144 ( V_7 ) ;
F_48 ( V_114 , 2 , L_56 ) ;
V_11 = F_145 ( V_7 ) ;
if ( V_11 ) {
...
V_253 = F_153 ( F_155 ( V_7 ) ) ;
V_254 = F_153 ( F_13 ( V_7 ) ) ;
if ( ! V_11 )
V_11 = ( V_253 ) ? V_253 : V_254 ;
if ( V_11 )
F_87 ( V_114 , 2 , L_40 , V_11 ) ;
F_156 ( F_154 ( V_7 ) ) ;
if ( V_240 == V_14 )
V_7 -> V_13 = V_250 ;
F_151 ( & V_220 -> V_2 . V_251 , V_252 ) ;
F_152 ( & V_7 -> V_242 ) ;
F_152 ( & V_7 -> V_241 ) ;
return 0 ;
}
...
static int F_160 ( void * V_256 )
{
struct V_6 * V_7 ;
int V_11 = 0 ;
V_7 = (struct V_6 * ) V_256 ;
F_15 ( V_7 , 2 , L_60 ) ;
if ( ! F_161 ( V_7 , V_108 ) )
return 0 ;
F_15 ( V_7 , 2 , L_61 ) ;
...
F_15 ( V_7 , 5 , L_68 ) ;
F_127 ( V_7 -> V_221 ,
F_179 ( & V_7 -> V_117 . V_262 , 0 , 1 ) == 0 ) ;
F_180 ( V_7 , V_87 , V_100 ) ;
F_15 ( V_7 , 6 , L_69 ) ;
F_181 ( F_182 ( V_7 -> V_117 . V_162 ) , V_35 ) ;
V_11 = F_183 ( V_7 -> V_117 . V_162 , & V_7 -> V_117 . V_263 ,
( V_264 ) V_100 , 0 , 0 ) ;
...
L_71 , V_11 ) ;
F_6 ( V_7 , 2 , L_72 , V_11 ) ;
F_185 ( V_100 -> V_265 , V_100 ) ;
F_186 ( & V_7 -> V_117 . V_262 , 0 ) ;
F_187 ( & V_7 -> V_221 ) ;
}
return V_11 ;
}
static int F_188 ( struct V_6 * V_7 ,
struct V_99 * V_100 , int V_266 )
{
T_4 V_267 , V_268 ;
F_15 ( V_7 , 4 , L_73 ) ;
F_189 ( V_7 , V_100 , V_269 ) ;
V_267 = ( T_4 ) ( V_102 + V_266 ) ;
V_268 = ( T_4 ) V_266 ;
memcpy ( F_190 ( V_100 -> V_47 ) , & V_267 , 2 ) ;
memcpy ( F_191 ( V_100 -> V_47 ) , & V_268 , 2 ) ;
memcpy ( F_192 ( V_100 -> V_47 ) , & V_268 , 2 ) ;
memcpy ( F_193 ( V_100 -> V_47 ) , & V_268 , 2 ) ;
return F_178 ( V_7 , V_267 , V_100 ) ;
}
int F_194 ( struct V_1 * V_2 , void * V_47 , int V_266 )
{
struct V_99 * V_100 ;
struct V_6 * V_7 ;
int V_11 ;
...
memcpy ( V_100 -> V_47 + V_102 , V_47 , V_266 ) ;
V_11 = F_188 ( V_7 , V_100 , V_266 ) ;
return V_11 ;
}
...
enum V_270 V_271 ,
T_7 V_272 , struct V_273 * V_274 , struct V_275 * V_276 )
{
char V_277 [ 7 ] [ 32 ] ;
char * V_278 [ 8 ] ;
int V_96 = 0 ;
switch ( V_271 ) {
case V_279 :
snprintf ( V_277 [ V_96 ] , sizeof( V_277 [ V_96 ] ) , L_77 ,
( V_272 & V_280 )
? L_78 : L_79 ) ;
V_278 [ V_96 ] = V_277 [ V_96 ] ; V_96 ++ ;
if ( V_272 & V_281 ) {
snprintf ( V_277 [ V_96 ] , sizeof( V_277 [ V_96 ] ) , L_80 ,
V_276 -> V_282 ) ;
V_278 [ V_96 ] = V_277 [ V_96 ] ; V_96 ++ ;
}
if ( V_272 & V_283 ) {
snprintf ( V_277 [ V_96 ] , sizeof( V_277 [ V_96 ] ) , L_81 ,
& V_276 -> V_49 ) ;
V_278 [ V_96 ] = V_277 [ V_96 ] ; V_96 ++ ;
}
snprintf ( V_277 [ V_96 ] , sizeof( V_277 [ V_96 ] ) , L_82 ,
V_274 -> V_284 , V_274 -> V_285 , V_274 -> V_286 ) ;
V_278 [ V_96 ] = V_277 [ V_96 ] ; V_96 ++ ;
snprintf ( V_277 [ V_96 ] , sizeof( V_277 [ V_96 ] ) , L_83 , V_274 -> V_287 ) ;
V_278 [ V_96 ] = V_277 [ V_96 ] ; V_96 ++ ;
snprintf ( V_277 [ V_96 ] , sizeof( V_277 [ V_96 ] ) , L_84 ,
V_274 -> V_288 ) ;
V_278 [ V_96 ] = V_277 [ V_96 ] ; V_96 ++ ;
snprintf ( V_277 [ V_96 ] , sizeof( V_277 [ V_96 ] ) , L_85 , V_274 -> V_289 ) ;
V_278 [ V_96 ] = V_277 [ V_96 ] ; V_96 ++ ;
break;
case V_290 :
snprintf ( V_277 [ V_96 ] , sizeof( V_277 [ V_96 ] ) , L_86 ) ;
V_278 [ V_96 ] = V_277 [ V_96 ] ; V_96 ++ ;
break;
case V_291 :
snprintf ( V_277 [ V_96 ] , sizeof( V_277 [ V_96 ] ) , L_87 ) ;
V_278 [ V_96 ] = V_277 [ V_96 ] ; V_96 ++ ;
break;
}
V_278 [ V_96 ] = NULL ;
F_200 ( & V_7 -> V_171 -> V_2 . V_251 , V_252 , V_278 ) ;
}
static void F_201 ( struct V_292 * V_293 )
{
struct V_294 * V_47 =
F_70 ( V_293 , struct V_294 , V_295 ) ;
struct V_296 * V_297 = & V_47 -> V_298 . V_297 [ 0 ] ;
char V_299 [ 32 ] ;
char V_300 [ 32 ] ;
char V_301 [ 32 ] ;
char * V_278 [] = {
...
F_137 ( & V_47 -> V_7 -> V_242 ) ;
V_47 -> V_7 -> V_155 . V_244 . V_302 = V_297 -> V_302 ;
F_152 ( & V_47 -> V_7 -> V_242 ) ;
snprintf ( V_299 , sizeof( V_299 ) , L_88 ) ;
snprintf ( V_300 , sizeof( V_300 ) , L_89 ,
( V_297 -> V_302 == V_303 ) ? L_90 :
( V_297 -> V_302 == V_304 ) ? L_91 :
( V_297 -> V_302 == V_305 ) ? L_92 :
L_93 ) ;
snprintf ( V_301 , sizeof( V_301 ) , L_94 ,
( V_297 -> V_13 == V_306 ) ? L_95 :
( V_297 -> V_13 == V_307 ) ? L_96 :
( V_297 -> V_13 == V_308 ) ? L_97 :
L_93 ) ;
F_200 ( & V_47 -> V_7 -> V_171 -> V_2 . V_251 ,
V_252 , V_278 ) ;
F_25 ( V_47 ) ;
}
...
{
struct V_309 * V_298 =
& V_5 -> V_47 . V_244 . V_47 . V_310 ;
struct V_294 * V_47 ;
int V_311 ;
F_15 ( V_7 , 2 , L_98 ) ;
if ( V_298 -> V_312 != sizeof( struct V_296 ) ) {
F_6 ( V_7 , 2 , L_99 , V_298 -> V_312 ) ;
return;
}
V_311 = sizeof( struct V_296 ) * V_298 -> V_313 ;
V_47 = F_202 ( sizeof( struct V_294 ) + V_311 ,
V_59 ) ;
if ( ! V_47 ) {
F_15 ( V_7 , 2 , L_100 ) ;
return;
}
F_203 ( & V_47 -> V_295 , F_201 ) ;
V_47 -> V_7 = V_7 ;
memcpy ( & V_47 -> V_298 , V_298 ,
sizeof( struct V_309 ) + V_311 ) ;
F_204 ( V_314 , & V_47 -> V_295 ) ;
}
static void F_205 ( struct V_292 * V_293 )
{
struct V_315 * V_47 =
F_70 ( V_293 , struct V_315 , V_295 ) ;
int V_96 ;
if ( V_47 -> V_316 . V_317 ) {
F_82 ( & V_47 -> V_7 -> V_171 -> V_2 ,
L_101 ,
V_47 -> V_7 -> V_2 -> V_175 ,
( V_47 -> V_316 . V_317 == 0x01 )
? L_102
: ( V_47 -> V_316 . V_317 == 0x02 )
? L_103
: L_104 ) ;
F_137 ( & V_47 -> V_7 -> V_242 ) ;
V_47 -> V_7 -> V_155 . V_244 . V_318 = 0 ;
F_152 ( & V_47 -> V_7 -> V_242 ) ;
F_199 ( V_47 -> V_7 , V_290 ,
0 , NULL , NULL ) ;
} else
for ( V_96 = 0 ; V_96 < V_47 -> V_316 . V_313 ; V_96 ++ ) {
struct V_319 * V_297 =
& V_47 -> V_316 . V_297 [ V_96 ] ;
F_199 ( V_47 -> V_7 ,
V_279 ,
V_297 -> V_320 ,
& V_297 -> V_274 , & V_297 -> V_276 ) ;
}
F_25 ( V_47 ) ;
}
...
V_311 = sizeof( struct V_319 ) *
V_316 -> V_313 ;
V_47 = F_202 ( sizeof( struct V_315 ) + V_311 ,
V_59 ) ;
if ( ! V_47 ) {
F_15 ( V_7 , 2 , L_107 ) ;
return;
}
F_203 ( & V_47 -> V_295 , F_205 ) ;
V_47 -> V_7 = V_7 ;
memcpy ( & V_47 -> V_316 , V_316 ,
sizeof( struct V_321 ) + V_311 ) ;
F_204 ( V_314 , & V_47 -> V_295 ) ;
}
static int F_206 ( struct V_6 * V_7 ,
struct V_323 * V_324 , enum V_325 V_326 )
{
int V_11 ;
switch ( V_324 -> V_327 ) {
case V_328 :
...
if ( V_11 ) {
F_6 ( V_7 , 2 , L_114 , V_324 -> V_327 ) ;
F_6 ( V_7 , 2 , L_115 , V_324 -> V_329 ) ;
}
return V_11 ;
}
...
struct V_323 * V_324 = (struct V_323 * ) V_46 -> V_337 ;
F_15 ( V_7 , 2 , L_116 ) ;
V_324 -> V_327 = V_5 -> V_51 . V_52 ;
V_324 -> V_329 = V_5 -> V_47 . V_244 . V_51 . V_52 ;
if ( ( V_324 -> V_327 == 0 ) && ( V_324 -> V_329 == 0 ) ) {
V_324 -> V_47 . V_338 =
V_5 -> V_47 . V_244 . V_47 . V_339 . V_340 ;
} else {
V_324 -> V_47 . V_338 = 0 ;
}
return 0 ;
...
struct V_323 V_324 ;
F_15 ( V_7 , 2 , L_117 ) ;
V_100 = F_40 ( V_7 , V_258 , 0 ) ;
V_5 = (struct V_48 * ) ( V_100 -> V_47 + V_102 ) ;
V_5 -> V_47 . V_244 . V_51 . V_341 =
sizeof( struct V_342 ) +
sizeof( struct V_343 ) ;
V_5 -> V_47 . V_244 . V_51 . V_259 =
V_344 ;
V_5 -> V_47 . V_244 . V_51 . V_345 = 1 ;
V_5 -> V_47 . V_244 . V_51 . V_346 = 1 ;
if ( F_41 ( V_7 , V_100 , F_208 ,
( void * ) & V_324 ) ||
F_206 ( V_7 , & V_324 ,
V_344 ) ) {
V_7 -> V_155 . V_244 . V_302 = V_303 ;
return;
}
V_7 -> V_155 . V_244 . V_245 = V_324 . V_47 . V_338 ;
}
static int F_209 ( struct V_6 * V_7 ,
struct V_45 * V_46 , unsigned long V_47 )
{
struct V_48 * V_5 = (struct V_48 * ) V_47 ;
struct V_347 * V_298 = & V_5 -> V_47 . V_244 . V_47 . V_348 ;
struct V_323 * V_324 = (struct V_323 * ) V_46 -> V_337 ;
F_15 ( V_7 , 2 , L_118 ) ;
V_324 -> V_327 = V_5 -> V_51 . V_52 ;
V_324 -> V_329 = V_5 -> V_47 . V_244 . V_51 . V_52 ;
...
if ( V_298 -> V_312 != sizeof( struct V_296 ) ) {
V_324 -> V_329 = 0xffff ;
F_6 ( V_7 , 2 , L_119 , V_298 -> V_312 ) ;
return 0 ;
}
if ( V_298 -> V_313 > 0 ) {
if ( V_324 -> V_47 . V_298 . V_302 )
* V_324 -> V_47 . V_298 . V_302 = V_298 -> V_297 [ 0 ] . V_302 ;
if ( V_324 -> V_47 . V_298 . V_13 )
* V_324 -> V_47 . V_298 . V_13 = V_298 -> V_297 [ 0 ] . V_13 ;
}
return 0 ;
}
int F_210 ( struct V_6 * V_7 ,
enum V_349 * V_302 , enum V_350 * V_13 )
{
int V_11 = 0 ;
struct V_99 * V_100 ;
struct V_48 * V_5 ;
...
F_15 ( V_7 , 2 , L_120 ) ;
if ( ! ( V_7 -> V_155 . V_244 . V_245 & V_351 ) )
return - V_34 ;
V_100 = F_40 ( V_7 , V_258 , 0 ) ;
V_5 = (struct V_48 * ) ( V_100 -> V_47 + V_102 ) ;
V_5 -> V_47 . V_244 . V_51 . V_341 =
...
int F_212 ( struct V_6 * V_7 , enum V_349 V_302 )
{
int V_11 = 0 ;
int V_341 ;
struct V_99 * V_100 ;
...
if ( ! ( V_7 -> V_155 . V_244 . V_245 & V_326 ) )
return - V_34 ;
V_100 = F_40 ( V_7 , V_258 , 0 ) ;
V_5 = (struct V_48 * ) ( V_100 -> V_47 + V_102 ) ;
V_5 -> V_47 . V_244 . V_51 . V_341 = V_341 ;
V_5 -> V_47 . V_244 . V_51 . V_259 = V_326 ;
V_5 -> V_47 . V_244 . V_51 . V_345 = 1 ;
V_5 -> V_47 . V_244 . V_51 . V_346 = 1 ;
...
if ( V_11 )
return V_11 ;
V_11 = F_206 ( V_7 , & V_324 , V_326 ) ;
return V_11 ;
}
static int F_213 ( struct V_6 * V_7 , int V_356 , T_4 V_357 )
{
int V_11 ;
if ( V_356 == 0 )
switch ( V_357 ) {
...
V_11 = - V_216 ;
if ( V_11 ) {
F_6 ( V_7 , 2 , L_124 , V_356 ) ;
F_6 ( V_7 , 2 , L_125 , V_357 ) ;
}
return V_11 ;
}
static void F_214 ( void * V_359 ,
enum V_360 type , void * V_297 )
{
struct V_6 * V_7 = (struct V_6 * ) V_359 ;
struct V_361 * V_362 ;
T_7 V_272 ;
if ( type != V_363 ) {
F_61 ( 1 ) ;
...
V_362 = (struct V_361 * ) V_297 ;
V_272 = V_283 ;
if ( V_362 -> V_276 . V_282 )
V_272 |= V_281 ;
F_199 ( V_7 , V_279 , V_272 ,
(struct V_273 * ) & V_362 -> V_364 ,
(struct V_275 * ) & V_362 -> V_276 ) ;
}
int F_215 ( struct V_6 * V_7 , int V_365 )
{
int V_11 ;
T_4 V_357 ;
struct V_366 * V_367 ;
...
F_216 ( V_367 , & V_369 ) ;
if ( V_365 ) {
F_199 ( V_7 , V_291 , 0 , NULL , NULL ) ;
V_11 = F_217 ( V_369 , 1 , & V_357 ,
F_214 , V_7 ) ;
} else
V_11 = F_217 ( V_369 , 0 , & V_357 , NULL , NULL ) ;
return F_213 ( V_7 , V_11 , V_357 ) ;
}
