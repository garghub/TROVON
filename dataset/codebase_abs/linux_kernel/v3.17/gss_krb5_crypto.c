...
struct V_27 * V_80 , struct V_63 * * V_76 )
{
T_1 V_33 ;
struct V_31 V_92 ;
T_2 * V_30 ;
...
return V_40 ;
F_43 ( V_80 -> V_70 [ 0 ] . V_88 + V_78 , V_24 -> V_42 -> V_109 ) ;
V_78 -= V_108 ;
...
memcpy ( V_93 , V_80 -> V_70 [ 0 ] . V_88 + V_78 , V_108 ) ;
...
if ( V_33 )
goto V_111;
V_33 = F_49 ( V_89 , V_121 , V_24 -> V_42 -> V_50 ) ;
if ( V_33 )
goto V_111;
V_33 = 0 ;
V_111:
...
if ( V_33 )
goto V_111;
V_33 = F_49 ( V_89 , V_126 , V_24 -> V_42 -> V_50 ) ;
if ( V_33 )
goto V_111;
V_33 = 0 ;
V_111:
