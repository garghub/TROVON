...
static bool F_41 ( struct V_127 * V_61 , unsigned int V_128 )
{
switch ( V_128 ) {
case V_39 ... V_129 :
case V_130 ... V_131 :
...
struct V_23 * V_24 ;
int V_95 , V_15 ;
V_24 = F_43 ( & V_133 -> V_61 , sizeof( struct V_23 ) ,
V_136 ) ;
if ( ! V_24 )
return - V_137 ;
for ( V_15 = 0 ; V_15 < F_22 ( V_24 -> V_105 ) ; V_15 ++ )
V_24 -> V_105 [ V_15 ] . V_138 = V_139 [ V_15 ] ;
V_95 = F_44 ( & V_133 -> V_61 , F_22 ( V_24 -> V_105 ) ,
V_24 -> V_105 ) ;
if ( V_95 != 0 ) {
F_24 ( & V_133 -> V_61 , L_12 , V_95 ) ;
return V_95 ;
}
V_24 -> V_33 = F_45 ( V_133 , & V_140 ) ;
if ( F_46 ( V_24 -> V_33 ) ) {
V_95 = F_47 ( V_24 -> V_33 ) ;
...
F_48 ( V_133 , V_24 ) ;
V_95 = F_49 ( & V_133 -> V_61 , & V_141 , & V_142 , 1 ) ;
if ( V_95 != 0 )
F_24 ( & V_133 -> V_61 , L_14 , V_95 ) ;
return V_95 ;
}
static int F_50 ( struct V_132 * V_143 )
{
F_51 ( & V_143 -> V_61 ) ;
return 0 ;
}
