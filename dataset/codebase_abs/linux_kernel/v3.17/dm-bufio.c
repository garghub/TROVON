...
static struct V_37 * F_80 ( struct V_1 * V_2 , enum V_104 V_105 )
{
struct V_37 * V_38 ;
while ( 1 ) {
if ( V_19 != 1 ) {
...
{
struct V_37 * V_38 = F_80 ( V_2 , V_105 ) ;
if ( ! V_38 )
return NULL ;
if ( V_2 -> V_112 )
V_2 -> V_112 ( V_38 ) ;
...
static void F_84 ( struct V_1 * V_2 , int V_113 ,
struct V_91 * V_92 )
{
...
if ( V_105 == V_109 )
return NULL ;
if ( V_105 == V_125 && F_55 ( F_56 ( V_99 , & V_38 -> V_90 ) ) )
return NULL ;
V_38 -> V_98 ++ ;
...
F_94 ( V_92 ) ;
F_4 ( V_2 ) ;
V_38 = F_91 ( V_2 , V_40 , V_105 , & V_122 , & V_92 ) ;
F_9 ( V_2 ) ;
F_64 ( & V_92 ) ;
if ( ! V_38 )
return V_38 ;
if ( V_122 )
F_52 ( V_38 , V_129 , V_38 -> V_40 , F_92 ) ;
F_71 ( & V_38 -> V_90 , V_99 , V_94 ) ;
if ( V_38 -> V_126 ) {
...
struct V_37 * * V_128 )
{
return F_93 ( V_2 , V_40 , V_125 , V_128 ) ;
}
void * F_98 ( struct V_1 * V_2 , T_2 V_40 ,
struct V_37 * * V_128 )
{
F_2 ( F_6 () ) ;
return F_93 ( V_2 , V_40 , V_130 , V_128 ) ;
}
void * F_99 ( struct V_1 * V_2 , T_2 V_40 ,
struct V_37 * * V_128 )
{
F_2 ( F_6 () ) ;
return F_93 ( V_2 , V_40 , V_127 , V_128 ) ;
}
...
int V_122 ;
struct V_37 * V_38 ;
V_38 = F_91 ( V_2 , V_40 , V_109 , & V_122 ,
& V_92 ) ;
if ( F_55 ( ! F_66 ( & V_92 ) ) ) {
F_9 ( V_2 ) ;
F_69 ( & V_96 ) ;
...
void F_107 ( struct V_37 * V_38 , T_2 V_140 )
{
struct V_1 * V_2 = V_38 -> V_2 ;
struct V_37 * V_141 ;
F_2 ( F_6 () ) ;
...
void F_111 ( struct V_1 * V_2 , unsigned V_144 )
{
V_2 -> V_119 = V_144 ;
}
...
F_121 ( L_2 ,
( unsigned long long ) V_38 -> V_40 , V_38 -> V_98 , V_146 ) ;
for ( V_146 = 0 ; V_146 < V_147 ; V_146 ++ )
F_2 ( ! F_66 ( & V_2 -> V_45 [ V_146 ] ) ) ;
F_9 ( V_2 ) ;
}
static int F_122 ( struct V_37 * V_38 , T_1 V_148 ,
unsigned long V_149 )
{
if ( V_49 - V_38 -> V_48 < V_149 )
return 0 ;
if ( ! ( V_148 & V_150 ) ) {
...
static long F_123 ( struct V_1 * V_2 , unsigned long V_151 ,
T_1 V_23 )
{
int V_152 ;
struct V_37 * V_38 , * V_114 ;
...
F_124 ( struct V_154 * V_155 , struct V_156 * V_157 )
{
struct V_1 * V_2 ;
unsigned long V_153 ;
V_2 = F_54 ( V_155 , struct V_1 , V_154 ) ;
if ( V_157 -> V_23 & V_150 )
F_4 ( V_2 ) ;
else if ( ! F_7 ( V_2 ) )
return V_158 ;
V_153 = F_123 ( V_2 , V_157 -> V_151 , V_157 -> V_23 ) ;
F_9 ( V_2 ) ;
return V_153 ;
}
static unsigned long
F_125 ( struct V_154 * V_155 , struct V_156 * V_157 )
{
struct V_1 * V_2 ;
unsigned long V_69 ;
V_2 = F_54 ( V_155 , struct V_1 , V_154 ) ;
...
struct V_1 * F_126 ( struct V_159 * V_66 , unsigned V_26 ,
...
F_2 ( V_26 < 1 << V_70 ||
( V_26 & ( V_26 - 1 ) ) ) ;
V_2 = F_127 ( sizeof( * V_2 ) , V_160 ) ;
if ( ! V_2 ) {
V_56 = - V_161 ;
goto V_162;
}
V_2 -> V_47 = F_128 ( sizeof( struct V_163 ) << V_164 ) ;
if ( ! V_2 -> V_47 ) {
V_56 = - V_161 ;
goto V_165;
}
...
V_2 -> V_32 = ( F_129 ( V_26 ) - 1 >= V_166 ) ?
F_129 ( V_26 ) - 1 - V_166 : 0 ;
V_2 -> V_4 = ( F_129 ( V_26 ) - 1 < V_166 ?
V_166 - ( F_129 ( V_26 ) - 1 ) : 0 ) ;
V_2 -> V_39 = V_39 ;
V_2 -> V_112 = V_112 ;
V_2 -> V_86 = V_86 ;
for ( V_146 = 0 ; V_146 < V_147 ; V_146 ++ ) {
F_130 ( & V_2 -> V_45 [ V_146 ] ) ;
V_2 -> V_42 [ V_146 ] = 0 ;
}
for ( V_146 = 0 ; V_146 < 1 << V_164 ; V_146 ++ )
F_131 ( & V_2 -> V_47 [ V_146 ] ) ;
F_132 ( & V_2 -> V_6 ) ;
F_130 ( & V_2 -> V_110 ) ;
V_2 -> V_111 = V_110 ;
V_2 -> V_119 = V_167 ;
...
if ( V_2 -> V_4 ) {
if ( ! F_137 ( V_2 ) ) {
F_137 ( V_2 ) = F_138 ( V_160 , L_3 , V_2 -> V_26 ) ;
if ( ! F_137 ( V_2 ) ) {
V_56 = - V_161 ;
F_10 ( & V_17 ) ;
goto V_169;
...
F_10 ( & V_17 ) ;
while ( V_2 -> V_111 ) {
struct V_37 * V_38 = F_31 ( V_2 , V_160 ) ;
if ( ! V_38 ) {
V_56 = - V_161 ;
goto V_170;
}
...
F_14 () ;
F_10 ( & V_17 ) ;
V_2 -> V_154 . V_173 = F_125 ;
V_2 -> V_154 . V_174 = F_124 ;
V_2 -> V_154 . V_175 = 1 ;
V_2 -> V_154 . V_176 = 0 ;
F_140 ( & V_2 -> V_154 ) ;
return V_2 ;
V_170:
V_169:
while ( ! F_66 ( & V_2 -> V_110 ) ) {
struct V_37 * V_38 = F_67 ( V_2 -> V_110 . V_97 ,
struct V_37 , V_44 ) ;
F_41 ( & V_38 -> V_44 ) ;
F_34 ( V_38 ) ;
}
...
for ( V_146 = 0 ; V_146 < V_147 ; V_146 ++ )
if ( V_2 -> V_42 [ V_146 ] )
F_121 ( L_4 , V_146 , V_2 -> V_42 [ V_146 ] ) ;
for ( V_146 = 0 ; V_146 < V_147 ; V_146 ++ )
F_2 ( V_2 -> V_42 [ V_146 ] ) ;
F_141 ( V_2 -> V_63 ) ;
F_28 ( V_2 -> V_47 ) ;
...
{
unsigned long V_177 = F_16 ( V_178 ) ;
struct V_1 * V_2 ;
...
if ( ! F_7 ( V_2 ) )
continue;
while ( ! F_66 ( & V_2 -> V_45 [ V_115 ] ) ) {
struct V_37 * V_38 ;
V_38 = F_67 ( V_2 -> V_45 [ V_115 ] . V_181 ,
struct V_37 , V_44 ) ;
if ( ! F_122 ( V_38 , 0 , V_177 * V_180 ) )
break;
F_68 () ;
}
F_9 ( V_2 ) ;
...
static void F_146 ( struct V_182 * V_183 )
{
F_145 () ;
F_147 ( V_184 , & V_185 ,
V_186 * V_180 ) ;
...
V_71 = ( T_5 ) ( ( V_188 - V_189 ) *
V_190 / 100 ) << V_166 ;
if ( V_71 > V_179 )
V_71 = V_179 ;
#ifdef F_149
if ( V_71 > ( V_191 - V_192 ) * V_193 / 100 )
V_71 = ( V_191 - V_192 ) * V_193 / 100 ;
#endif
V_21 = V_71 ;
F_87 ( & V_17 ) ;
F_14 () ;
...
F_153 ( & V_185 ) ;
F_154 ( V_184 ) ;
for ( V_146 = 0 ; V_146 < F_3 ( V_5 ) ; V_146 ++ ) {
struct V_195 * V_196 = V_5 [ V_146 ] ;
if ( V_196 )
F_155 ( V_196 ) ;
}
for ( V_146 = 0 ; V_146 < F_3 ( V_187 ) ; V_146 ++ )
F_33 ( V_187 [ V_146 ] ) ;
if ( V_18 ) {
F_29 ( L_6 ,
V_197 , V_18 ) ;
