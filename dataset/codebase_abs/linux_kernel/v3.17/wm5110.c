...
static struct V_11 * F_16 ( struct V_38 * V_9 )
{
...
struct V_25 * V_26 ;
int V_14 , V_34 ;
V_26 = F_18 ( & V_40 -> V_9 , sizeof( struct V_25 ) ,
V_41 ) ;
if ( V_26 == NULL )
return - V_42 ;
F_19 ( V_40 , V_26 ) ;
...
= F_3 ( V_54 ) ;
V_34 = F_20 ( & V_26 -> V_35 . V_45 [ V_14 ] , false ) ;
if ( V_34 != 0 )
return V_34 ;
}
...
F_22 ( V_8 -> V_11 , V_67 [ V_14 ] ,
V_68 , V_68 ) ;
F_24 ( & V_40 -> V_9 ) ;
F_25 ( & V_40 -> V_9 ) ;
return F_26 ( & V_40 -> V_9 , & V_69 ,
V_66 , F_3 ( V_66 ) ) ;
}
