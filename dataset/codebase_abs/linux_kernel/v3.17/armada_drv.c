...
void F_41 ( struct V_54 * V_23 ,
struct V_55 * V_56 )
{
unsigned long V_15 ;
F_11 ( & V_23 -> V_57 , V_15 ) ;
if ( F_42 ( & V_56 -> V_58 ) ) {
F_43 ( & V_56 -> V_58 , & V_23 -> V_59 ) ;
F_44 ( V_23 -> V_60 . V_2 , V_23 -> V_61 ) ;
}
F_12 ( & V_23 -> V_57 , V_15 ) ;
}
void F_45 ( struct V_54 * V_23 ,
struct V_55 * V_56 )
{
if ( ! F_42 ( & V_56 -> V_58 ) ) {
F_46 ( & V_56 -> V_58 ) ;
F_47 ( V_23 -> V_60 . V_2 , V_23 -> V_61 ) ;
}
}
void F_48 ( struct V_54 * V_23 ,
struct V_55 * V_56 )
{
unsigned long V_15 ;
F_11 ( & V_23 -> V_57 , V_15 ) ;
...
static int F_49 ( struct V_13 * V_2 , int V_60 )
{
struct V_7 * V_8 = V_2 -> V_14 ;
F_50 ( V_8 -> V_23 [ V_60 ] , V_62 ) ;
return 0 ;
}
static void F_51 ( struct V_13 * V_2 , int V_60 )
{
struct V_7 * V_8 = V_2 -> V_14 ;
F_52 ( V_8 -> V_23 [ V_60 ] , V_62 ) ;
}
...
{
return F_56 ( & V_63 , F_57 ( V_2 ) ) ;
}
static void F_58 ( struct V_1 * V_2 )
{
F_59 ( F_60 ( V_2 ) ) ;
}
static int F_61 ( struct V_1 * V_2 , void * V_64 )
{
return V_2 -> V_3 == V_64 ;
}
static int F_62 ( struct V_1 * V_2 , void * V_64 )
{
const char * V_65 = V_64 ;
return ! strcmp ( F_63 ( V_2 ) , V_65 ) ;
}
static void F_64 ( struct V_1 * V_2 ,
struct V_66 * * V_67 , struct V_68 * V_69 )
{
...
F_68 ( V_71 ) ;
continue;
} else if ( ! F_67 ( V_71 -> V_72 ) ) {
F_69 ( V_2 , L_3 ,
V_71 -> V_73 ) ;
F_68 ( V_71 ) ;
continue;
}
F_70 ( V_2 , V_67 , F_61 , V_71 ) ;
F_68 ( V_71 ) ;
}
}
...
int V_27 ;
if ( V_2 -> V_3 ) {
struct V_68 * V_74 = V_2 -> V_3 ;
for ( V_27 = 0 ; ; V_27 ++ ) {
V_69 = F_72 ( V_74 , L_4 , V_27 ) ;
if ( ! V_69 )
break;
F_70 ( V_2 , V_67 , F_61 , V_69 ) ;
F_68 ( V_69 ) ;
}
if ( V_27 == 0 ) {
F_73 ( V_2 , L_5 ) ;
...
int V_25 ;
V_25 = F_71 ( & V_80 -> V_2 , & V_67 ) ;
if ( V_25 < 0 )
return V_25 ;
return F_77 ( & V_80 -> V_2 ,
& V_81 , V_67 ) ;
} else {
return F_56 ( & V_63 , V_80 ) ;
}
}
static int F_78 ( struct V_79 * V_80 )
{
if ( F_1 ( & V_80 -> V_2 ) )
F_79 ( & V_80 -> V_2 , & V_81 ) ;
else
