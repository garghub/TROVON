...
V_291 . V_304 =
F_127 ( V_3 , 1 , 0 , type ) ;
sprintf ( V_286 , L_91 , V_285 , V_305 [ V_103 ] ) ;
...
if ( V_35 < 0 )
goto exit;
F_20 ( V_2 , V_23 -> V_317 [ 1 ] , 0 ,
V_321 , 0x02 ) ;
F_20 ( V_2 , V_23 -> V_317 [ 0 ] , 0 ,
V_322 , 0x00 ) ;
F_20 ( V_2 , V_23 -> V_317 [ 0 ] , 0 ,
V_321 , 0x00 ) ;
F_20 ( V_2 , V_23 -> V_317 [ 0 ] , 0 ,
V_322 , 0x02 ) ;
V_310 = F_2 ( V_2 , V_23 -> V_317 [ 1 ] , 0 ,
V_323 , 0 ) ;
F_134 ( V_2 , V_23 -> V_317 [ 1 ] ,
V_310 & ~ V_324 ) ;
V_310 = F_2 ( V_2 , V_23 -> V_317 [ 0 ] , 0 ,
V_323 , 0 ) ;
F_134 ( V_2 , V_23 -> V_317 [ 0 ] ,
V_310 | V_325 ) ;
} else {
F_12 ( V_2 , L_94 ) ;
V_313 = V_326 ;
...
static void F_135 ( struct V_327 * V_328 )
{
struct V_22 * V_23 = F_136 (
F_137 ( V_328 ) , struct V_22 , V_329 ) ;
F_132 ( V_23 -> V_2 ) ;
F_138 ( V_23 -> V_2 ) ;
}
static int F_139 ( struct V_1 * V_2 , int V_40 )
{
struct V_22 * V_23 = V_2 -> V_23 ;
unsigned int V_313 ;
if ( V_23 -> V_240 != V_250 )
...
( V_40 == 0 ) ) {
F_21 ( V_2 , V_330 , 0 ) ;
F_22 ( V_2 , V_331 , V_332 ) ;
F_22 ( V_2 , V_333 , V_332 ) ;
if ( V_23 -> V_334 == V_335 )
V_313 = V_336 ;
else
V_313 = V_320 ;
...
F_22 ( V_2 , V_331 , V_337 ) ;
F_22 ( V_2 , V_333 , V_337 ) ;
if ( V_23 -> V_334 == V_335 )
V_313 = V_336 ;
else
V_313 = V_320 ;
...
F_12 ( V_2 , L_95 ) ;
F_113 ( V_2 ) ;
V_312 = V_23 -> V_314 [ V_338 - V_316 ] ;
if ( V_312 )
V_311 = F_133 ( V_2 , V_23 -> V_339 [ 0 ] ) ;
else
V_311 =
V_23 -> V_314 [ V_340 - V_316 ] ;
if ( V_311 )
V_23 -> V_334 = V_341 ;
else
V_23 -> V_334 = V_335 ;
if ( V_23 -> V_334 == V_335 ) {
F_22 ( V_2 , V_342 , V_343 ) ;
F_141 ( V_2 , 1 ) ;
F_142 ( V_2 , 0 ) ;
F_143 ( V_2 , V_297 ,
V_23 -> V_242
...
F_22 ( V_2 , V_342 , V_332 ) ;
F_141 ( V_2 , 0 ) ;
F_142 ( V_2 , V_23 -> V_344 ) ;
F_143 ( V_2 , V_297 , 0 ) ;
}
F_114 ( V_2 ) ;
return 0 ;
...
static int F_145 ( struct V_1 * V_2 , int V_351 )
{
struct V_22 * V_23 = V_2 -> V_23 ;
unsigned int V_313 ;
if ( V_351 ) {
...
F_38 ( V_2 , V_352 . V_266 ,
V_352 . V_353 [ 0 ] , V_313 ) ;
return 1 ;
}
static int F_143 ( struct V_1 * V_2 , T_1 V_3 , long V_40 )
{
struct V_22 * V_23 = V_2 -> V_23 ;
unsigned int V_354 ;
...
int V_35 = 0 ;
int V_262 = V_3 - V_244 ;
if ( ( V_262 < 0 ) || ( V_262 >= V_355 ) )
return 0 ;
if ( ( V_3 >= V_358 ) && ( V_3 < V_359 ) ) {
if ( ! V_23 -> V_242 [ V_243 - V_244 ] )
V_40 = 0 ;
}
...
if ( ! V_23 -> V_242 [ V_259 - V_244 ] )
V_40 = 0 ;
if ( ( V_3 == V_297 ) && ( V_23 -> V_334 != V_335 ) )
V_40 = 0 ;
}
F_12 ( V_2 , L_96 ,
V_3 , V_40 ) ;
V_354 = ( V_40 == 0 ) ? V_326 : V_320 ;
V_35 = F_38 ( V_2 , V_362 [ V_262 ] . V_266 ,
V_362 [ V_262 ] . V_353 [ 0 ] , V_354 ) ;
if ( V_35 < 0 )
return 0 ;
return 1 ;
}
...
V_263 = V_358 - V_244 ;
V_3 = V_358 ;
for (; V_3 < V_359 ; V_3 ++ , V_263 ++ )
V_363 |= F_143 ( V_2 , V_3 , V_23 -> V_242 [ V_263 ] ) ;
return V_363 ;
}
static int F_147 ( struct V_1 * V_2 )
{
struct V_22 * V_23 = V_2 -> V_23 ;
unsigned int V_364 = F_2 ( V_2 , V_23 -> V_365 [ 0 ] , 0 ,
V_366 , 0 ) ;
if ( V_364 != 0 )
F_20 ( V_2 , V_23 -> V_365 [ 0 ] , 0 ,
V_13 ,
0 ) ;
return V_364 ;
}
static void F_148 ( struct V_1 * V_2 , unsigned int V_364 )
{
struct V_22 * V_23 = V_2 -> V_23 ;
if ( V_364 != 0 )
F_20 ( V_2 , V_23 -> V_365 [ 0 ] , 0 ,
...
V_263 = V_360 - V_244 ;
V_3 = V_360 ;
for (; V_3 < V_361 ; V_3 ++ , V_263 ++ )
V_363 |= F_143 ( V_2 , V_3 , V_23 -> V_242 [ V_263 ] ) ;
V_363 |= F_145 ( V_2 , ( V_23 -> V_367 ? 1 : 0 ) ) ;
V_364 = F_147 ( V_2 ) ;
V_363 |= F_139 ( V_2 , 1 ) ;
F_148 ( V_2 , V_364 ) ;
return V_363 ;
}
static int F_142 ( struct V_1 * V_2 , long V_40 )
{
struct V_22 * V_23 = V_2 -> V_23 ;
int V_363 = 0 ;
if ( V_40 )
V_363 = F_150 ( V_2 , V_23 -> V_339 [ 0 ] , 0 ,
V_288 , 0 , V_368 , 3 ) ;
else
V_363 = F_150 ( V_2 , V_23 -> V_339 [ 0 ] , 0 ,
V_288 , 0 , V_368 , 0 ) ;
...
static int F_151 ( struct V_267 * V_268 ,
struct V_269 * V_270 )
{
struct V_1 * V_2 = F_116 ( V_268 ) ;
T_1 V_3 = F_117 ( V_268 ) ;
...
V_369 = F_144 ( V_2 , V_3 , & V_346 ) ;
if ( V_369 ) {
int V_103 = F_152 ( V_268 ) ;
int V_370 = F_119 ( V_268 ) ;
unsigned long V_371 ;
F_15 ( & V_2 -> V_372 ) ;
V_371 = V_268 -> V_304 ;
V_268 -> V_304 = F_127 ( V_346 , V_370 ,
0 , V_103 ) ;
V_363 = F_153 ( V_268 , V_270 ) ;
V_268 -> V_304 = V_371 ;
F_16 ( & V_2 -> V_372 ) ;
}
return V_363 ;
...
struct V_275 * V_276 )
{
unsigned int V_373 = sizeof( V_374 )
/ sizeof( struct V_375 ) ;
V_276 -> type = V_376 ;
V_276 -> V_29 = 1 ;
V_276 -> V_272 . V_377 . V_373 = V_373 ;
if ( V_276 -> V_272 . V_377 . V_378 >= V_373 )
V_276 -> V_272 . V_377 . V_378 = V_373 - 1 ;
strcpy ( V_276 -> V_272 . V_377 . V_285 ,
V_374 [ V_276 -> V_272 . V_377 . V_378 ] . V_285 ) ;
return 0 ;
}
...
struct V_1 * V_2 = F_116 ( V_268 ) ;
struct V_22 * V_23 = V_2 -> V_23 ;
V_270 -> V_272 . V_377 . V_378 [ 0 ] = V_23 -> V_367 ;
return 0 ;
}
static int F_156 ( struct V_267 * V_268 ,
struct V_269 * V_270 )
{
struct V_1 * V_2 = F_116 ( V_268 ) ;
struct V_22 * V_23 = V_2 -> V_23 ;
int V_263 , V_35 = 0 ;
int V_379 = V_270 -> V_272 . V_377 . V_378 [ 0 ] ;
unsigned int V_373 = sizeof( V_374 )
/ sizeof( struct V_375 ) ;
if ( V_379 >= V_373 )
return 0 ;
F_12 ( V_2 , L_99 ,
V_379 , V_374 [ V_379 ] . V_285 ) ;
for ( V_263 = 0 ; V_263 < V_380 ; V_263 ++ ) {
V_35 = F_38 ( V_2 , V_352 . V_266 ,
V_352 . V_353 [ V_263 ] ,
V_374 [ V_379 ] . V_381 [ V_263 ] ) ;
if ( V_35 < 0 )
break;
}
if ( V_35 >= 0 ) {
...
int V_370 = F_119 ( V_268 ) ;
long * V_271 = V_270 -> V_272 . integer . V_272 ;
if ( ( V_3 >= V_316 ) && ( V_3 < V_382 ) ) {
if ( V_370 & 1 ) {
* V_271 = V_23 -> V_314 [ V_3 - V_316 ] ;
V_271 ++ ;
}
if ( V_370 & 2 ) {
* V_271 = V_23 -> V_383 [ V_3 - V_316 ] ;
V_271 ++ ;
}
return 0 ;
}
if ( ( V_3 >= V_244 ) && ( V_3 < V_384 ) ) {
...
if ( V_370 & 2 ) {
V_23 -> V_383 [ V_3 - V_316 ] = * V_271 ;
V_271 ++ ;
}
V_385 = F_151 ( V_268 , V_270 ) ;
goto exit;
}
if ( V_3 == V_243 ) {
...
( ( V_3 >= V_360 ) && ( V_3 < V_361 ) ) ) {
V_23 -> V_242 [ V_3 - V_244 ] = * V_271 ;
V_385 = F_143 ( V_2 , V_3 , * V_271 ) ;
goto exit;
}
if ( V_3 == V_23 -> V_339 [ 0 ] ) {
V_23 -> V_344 = * V_271 ;
if ( V_23 -> V_334 != V_335 )
V_385 = F_142 ( V_2 , * V_271 ) ;
goto exit;
}
exit:
F_114 ( V_2 ) ;
...
F_15 ( & V_2 -> V_372 ) ;
V_371 = V_268 -> V_304 ;
V_268 -> V_304 = F_127 ( V_3 , V_370 , 0 , V_103 ) ;
V_35 = F_160 ( V_268 , V_276 ) ;
V_268 -> V_304 = V_371 ;
F_16 ( & V_2 -> V_372 ) ;
break;
case V_349 :
...
long * V_271 = V_270 -> V_272 . integer . V_272 ;
if ( V_370 & 1 ) {
* V_271 = V_23 -> V_386 [ V_3 - V_316 ] ;
V_271 ++ ;
}
if ( V_370 & 2 ) {
* V_271 = V_23 -> V_387 [ V_3 - V_316 ] ;
V_271 ++ ;
}
return 0 ;
}
...
int V_385 = 1 ;
if ( V_370 & 1 ) {
V_23 -> V_386 [ V_3 - V_316 ] = * V_271 ;
V_271 ++ ;
}
if ( V_370 & 2 ) {
V_23 -> V_387 [ V_3 - V_316 ] = * V_271 ;
V_271 ++ ;
}
V_369 = F_144 ( V_2 , V_3 , & V_346 ) ;
if ( V_369 ) {
...
static int F_164 ( struct V_267 * V_268 , int V_388 ,
...
V_371 = V_268 -> V_304 ;
V_268 -> V_304 = F_127 ( V_3 , V_370 , 0 , V_103 ) ;
V_35 = F_165 ( V_268 , V_388 , V_66 , V_295 ) ;
V_268 -> V_304 = V_371 ;
F_16 ( & V_2 -> V_372 ) ;
break;
case V_349 :
...
const char * V_389 , int V_103 )
{
char V_286 [ V_287 ] ;
int type = V_103 ? V_288 : V_289 ;
struct V_290 V_291 =
F_167 ( V_286 , V_3 , 1 , type ) ;
sprintf ( V_286 , L_101 , V_389 , V_305 [ V_103 ] ) ;
return F_128 ( V_2 , V_3 , F_129 ( & V_291 , V_2 ) ) ;
}
...
V_291 . V_298 = F_155 ;
V_291 . V_299 = F_156 ;
return F_128 ( V_2 , V_390 , F_129 ( & V_291 , V_2 ) ) ;
}
...
int V_263 , V_355 ;
int V_35 = 0 ;
for ( V_263 = 0 ; V_263 < V_23 -> V_391 ; V_263 ++ ) {
V_35 = F_171 ( V_2 , V_23 -> V_392 [ V_263 ] ) ;
if ( V_35 < 0 )
return V_35 ;
}
V_355 = V_356 + V_357 ;
for ( V_263 = 0 ; V_263 < V_355 ; V_263 ++ ) {
V_35 = F_166 ( V_2 , V_362 [ V_263 ] . V_3 ,
V_362 [ V_263 ] . V_285 ,
V_362 [ V_263 ] . V_307 ) ;
if ( V_35 < 0 )
return V_35 ;
}
V_35 = F_166 ( V_2 , V_243 , L_102 , 0 ) ;
if ( V_35 < 0 )
return V_35 ;
V_35 = F_166 ( V_2 , V_259 , L_103 , 1 ) ;
if ( V_35 < 0 )
return V_35 ;
F_168 ( V_2 ) ;
#ifdef F_172
F_130 ( V_2 ) ;
#endif
V_35 = F_173 ( V_2 , & V_23 -> V_393 ) ;
if ( V_35 < 0 )
return V_35 ;
if ( V_23 -> V_394 ) {
V_35 = F_174 ( V_2 , V_23 -> V_394 ,
V_23 -> V_394 ) ;
if ( V_35 < 0 )
return V_35 ;
V_35 = F_175 ( V_2 , & V_23 -> V_257 ) ;
if ( V_35 < 0 )
return V_35 ;
}
if ( V_23 -> V_395 ) {
V_35 = F_176 ( V_2 , V_23 -> V_395 ) ;
if ( V_35 < 0 )
return V_35 ;
}
return 0 ;
...
{
struct V_22 * V_23 = V_2 -> V_23 ;
struct V_396 * V_245 = V_23 -> V_397 ;
V_2 -> V_398 = V_245 ;
V_2 -> V_399 = 0 ;
V_245 -> V_285 = L_104 ;
V_245 -> V_10 [ V_400 ] = V_401 ;
V_245 -> V_10 [ V_400 ] . V_3 = V_23 -> V_239 [ 0 ] ;
V_245 -> V_10 [ V_400 ] . V_402 =
V_23 -> V_257 . V_403 ;
V_245 -> V_10 [ V_404 ] = V_405 ;
V_245 -> V_10 [ V_404 ] . V_406 = 1 ;
V_245 -> V_10 [ V_404 ] . V_3 = V_23 -> V_365 [ 0 ] ;
V_2 -> V_399 ++ ;
V_245 ++ ;
V_245 -> V_285 = L_105 ;
V_245 -> V_10 [ V_404 ] = V_405 ;
V_245 -> V_10 [ V_404 ] . V_406 = 1 ;
V_245 -> V_10 [ V_404 ] . V_3 = V_23 -> V_365 [ 1 ] ;
V_2 -> V_399 ++ ;
V_245 ++ ;
V_245 -> V_285 = L_106 ;
V_245 -> V_10 [ V_404 ] = V_405 ;
V_245 -> V_10 [ V_404 ] . V_406 = 1 ;
V_245 -> V_10 [ V_404 ] . V_3 = V_23 -> V_365 [ 2 ] ;
V_2 -> V_399 ++ ;
if ( ! V_23 -> V_394 && ! V_23 -> V_395 )
return 0 ;
V_245 ++ ;
V_245 -> V_285 = L_107 ;
V_245 -> V_407 = V_408 ;
...
V_245 -> V_10 [ V_400 ] =
V_409 ;
V_245 -> V_10 [ V_400 ] . V_3 = V_23 -> V_394 ;
}
if ( V_23 -> V_395 ) {
V_245 -> V_10 [ V_404 ] =
V_410 ;
V_245 -> V_10 [ V_404 ] . V_3 = V_23 -> V_395 ;
}
V_2 -> V_399 ++ ;
return 0 ;
}
static void F_178 ( struct V_1 * V_2 , T_1 V_411 , T_1 V_412 )
{
if ( V_411 ) {
F_134 ( V_2 , V_411 , V_324 ) ;
if ( F_179 ( V_2 , V_411 ) & V_413 )
F_20 ( V_2 , V_411 , 0 ,
V_414 ,
V_415 ) ;
}
if ( V_412 && ( F_179 ( V_2 , V_412 ) & V_413 ) )
F_20 ( V_2 , V_412 , 0 ,
V_414 , V_416 ) ;
}
static void F_180 ( struct V_1 * V_2 , T_1 V_411 , T_1 V_417 )
{
if ( V_411 ) {
F_134 ( V_2 , V_411 , V_418 ) ;
if ( F_179 ( V_2 , V_411 ) & V_419 )
F_20 ( V_2 , V_411 , 0 ,
V_414 ,
F_181 ( 0 ) ) ;
}
if ( V_417 && ( F_179 ( V_2 , V_417 ) & V_419 ) ) {
F_20 ( V_2 , V_417 , 0 , V_414 ,
F_181 ( 0 ) ) ;
F_182 ( V_2 , V_417 , V_288 , 0 ,
V_368 , 0x5a ) ;
F_182 ( V_2 , V_417 , V_288 , 0 ,
V_420 , 0 ) ;
}
...
{
F_184 ( V_2 , V_421 , V_421 ) ;
F_184 ( V_2 , V_422 , V_422 ) ;
}
static void F_185 ( struct V_1 * V_2 , T_1 V_3 , int V_103 )
{
unsigned int V_423 ;
V_423 = F_186 ( V_2 , V_3 , V_103 == V_289 ?
V_424 : V_425 ) ;
F_187 ( V_2 , V_3 , V_103 , V_423 ) ;
}
static void F_141 ( struct V_1 * V_2 , int V_351 )
{
struct V_22 * V_23 = V_2 -> V_23 ;
unsigned int V_313 ;
T_3 V_40 ;
unsigned int V_364 ;
F_12 ( V_2 , L_108 , V_351 ) ;
V_364 = F_147 ( V_2 ) ;
F_139 ( V_2 , 0 ) ;
if ( V_351 ) {
V_313 = V_336 ;
...
F_12 ( V_2 , L_109 ) ;
V_3 = V_2 -> V_433 ;
for ( V_263 = 0 ; V_263 < V_2 -> V_434 ; V_263 ++ , V_3 ++ )
V_2 -> V_435 [ V_263 ] = F_186 ( V_2 , V_3 ,
V_436 ) ;
for ( V_263 = 0 ; V_263 < V_23 -> V_257 . V_437 ; V_263 ++ )
F_185 ( V_2 , V_23 -> V_239 [ V_263 ] , V_289 ) ;
for ( V_263 = 0 ; V_263 < V_23 -> V_438 ; V_263 ++ )
F_185 ( V_2 , V_23 -> V_317 [ V_263 ] , V_289 ) ;
for ( V_263 = 0 ; V_263 < V_23 -> V_439 ; V_263 ++ ) {
F_185 ( V_2 , V_23 -> V_365 [ V_263 ] , V_288 ) ;
F_185 ( V_2 , V_23 -> V_339 [ V_263 ] , V_288 ) ;
}
}
...
return;
V_355 = V_356 + V_357 + 1 ;
for ( V_262 = 0 ; V_262 < V_355 ; V_262 ++ ) {
for ( V_263 = 0 ; V_263 <= V_362 [ V_262 ] . V_440 ; V_263 ++ ) {
F_38 ( V_2 , V_362 [ V_262 ] . V_266 ,
V_362 [ V_262 ] . V_353 [ V_263 ] ,
V_362 [ V_262 ] . V_441 [ V_263 ] ) ;
}
}
V_313 = V_326 ;
...
static void F_194 ( struct V_1 * V_2 , bool V_450 )
{
F_19 ( V_2 , V_451 , V_450 ) ;
F_19 ( V_2 , V_452 , V_450 ) ;
F_19 ( V_2 , V_453 , V_450 ) ;
F_19 ( V_2 , V_454 , V_450 ) ;
F_19 ( V_2 , V_455 , V_450 ) ;
F_19 ( V_2 , V_456 , V_450 ) ;
F_22 ( V_2 , V_331 , V_332 ) ;
F_22 ( V_2 , V_333 , V_332 ) ;
F_22 ( V_2 , V_457 , V_458 ) ;
}
static bool F_195 ( struct V_1 * V_2 )
{
bool V_459 = false ;
const struct V_204 * V_460 ;
const struct V_461 * V_462 ;
if ( F_196 ( & V_462 , V_463 , V_2 -> V_464 -> V_465 -> V_466 ) != 0 )
return false ;
V_460 = (struct V_204 * ) ( V_462 -> V_15 ) ;
if ( F_91 ( V_2 , V_460 , 0 , 0 , true , 0 ) ) {
F_95 ( L_110 ) ;
goto V_467;
}
V_459 = F_93 ( V_2 ) ;
...
V_23 -> V_334 = V_335 ;
V_23 -> V_344 = 0 ;
for ( V_263 = 0 ; V_263 < V_472 ; V_263 ++ ) {
V_23 -> V_386 [ V_263 ] = 0x5a ;
V_23 -> V_387 [ V_263 ] = 0x5a ;
V_23 -> V_314 [ V_263 ] = 0 ;
V_23 -> V_383 [ V_263 ] = 0 ;
}
V_355 = V_356 + V_357 ;
for ( V_263 = 0 ; V_263 < V_355 ; V_263 ++ ) {
V_354 = ( unsigned int ) V_362 [ V_263 ] . V_353 [ 0 ] ;
V_23 -> V_242 [ V_263 ] = V_354 ? 1 : 0 ;
}
V_23 -> V_367 = 0 ;
...
F_188 ( V_2 ) ;
for ( V_263 = 0 ; V_263 < V_23 -> V_438 ; V_263 ++ )
F_178 ( V_2 , V_23 -> V_317 [ V_263 ] , V_23 -> V_239 [ 0 ] ) ;
F_178 ( V_2 , V_474 -> V_477 [ 0 ] , V_23 -> V_394 ) ;
for ( V_263 = 0 ; V_263 < V_23 -> V_439 ; V_263 ++ )
F_180 ( V_2 , V_23 -> V_339 [ V_263 ] , V_23 -> V_365 [ V_263 ] ) ;
F_180 ( V_2 , V_474 -> V_478 , V_23 -> V_395 ) ;
for ( V_263 = 0 ; V_263 < V_23 -> V_479 ; V_263 ++ )
F_209 ( V_2 , V_23 -> V_480 [ V_263 ] ) ;
F_183 ( V_2 ) ;
F_132 ( V_2 ) ;
F_140 ( V_2 ) ;
F_138 ( V_2 ) ;
...
V_23 -> V_480 [ 1 ] = V_491 ;
V_23 -> V_479 = 2 ;
F_213 ( & V_23 -> V_329 , F_135 ) ;
F_205 ( V_2 ) ;
F_211 ( V_2 ) ;
V_35 = F_214 ( V_2 , & V_23 -> V_393 , NULL ) ;
if ( V_35 < 0 )
return V_35 ;
V_2 -> V_492 = V_493 ;
V_2 -> V_494 = 1 ;
