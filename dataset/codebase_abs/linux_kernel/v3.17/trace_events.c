...
& V_158 ) ;
F_137 ( L_25 , 0644 , V_44 -> V_81 , V_44 ,
& V_159 ) ;
F_137 ( L_26 , 0444 , V_44 -> V_81 , V_14 ,
& V_160 ) ;
return 0 ;
}
...
static int
F_145 ( struct V_5 * V_14 , struct V_164 * V_165 )
{
int V_25 ;
V_25 = F_144 ( V_14 ) ;
if ( V_25 < 0 )
...
static int
F_149 ( struct V_5 * V_14 , struct V_58 * V_59 )
{
struct V_35 * V_44 ;
V_44 = F_146 ( V_14 , V_59 ) ;
if ( ! V_44 )
return - V_22 ;
return F_138 ( V_59 -> V_169 , V_44 ) ;
}
static T_5 int
F_150 ( struct V_5 * V_14 ,
struct V_58 * V_59 )
{
struct V_35 * V_44 ;
V_44 = F_146 ( V_14 , V_59 ) ;
...
int F_151 ( struct V_5 * V_14 )
{
int V_25 ;
F_34 ( & V_137 ) ;
F_34 ( & V_60 ) ;
V_25 = F_145 ( V_14 , NULL ) ;
if ( V_25 >= 0 )
F_152 ( V_14 ) ;
F_41 ( & V_60 ) ;
F_41 ( & V_137 ) ;
...
static int F_154 ( struct V_5 * V_14 )
{
struct V_58 * V_59 ;
struct V_35 * V_44 ;
#ifdef F_32
...
static void F_158 ( struct V_164 * V_165 )
{
...
F_161 (call, start, end) {
F_145 ( * V_14 , V_165 ) ;
F_152 ( * V_14 ) ;
}
}
static void F_162 ( struct V_164 * V_165 )
{
...
static int F_164 ( struct V_178 * V_179 ,
...
static void
F_165 ( struct V_58 * V_59 )
{
struct V_5 * V_14 ;
int V_25 ;
F_6 (call, &ftrace_events, list) {
V_25 = F_149 ( V_14 , V_59 ) ;
if ( V_25 < 0 )
F_135 ( L_29 ,
F_46 ( V_14 ) ) ;
}
...
struct V_35 *
F_166 ( struct V_58 * V_59 , const char * system , const char * V_31 )
{
struct V_35 * V_44 ;
struct V_5 * V_14 ;
const char * V_12 ;
...
static void
F_167 ( unsigned long V_182 , unsigned long V_183 , void * * V_184 )
{
...
static void
F_168 ( unsigned long V_182 , unsigned long V_183 , void * * V_184 )
{
struct V_185 * * V_186 = (struct V_185 * * ) V_184 ;
struct V_185 * V_43 = * V_186 ;
if ( ! V_43 )
...
if ( V_43 -> V_187 != - 1 )
( V_43 -> V_187 ) -- ;
F_167 ( V_182 , V_183 , V_184 ) ;
}
static int
F_169 ( struct V_101 * V_102 , unsigned long V_182 ,
struct V_188 * V_189 , void * V_184 )
{
struct V_185 * V_43 = V_184 ;
F_82 ( V_102 , L_30 , ( void * ) V_182 ) ;
F_82 ( V_102 , L_31 ,
...
F_82 ( V_102 , L_33 , V_43 -> V_187 ) ;
return 0 ;
}
static int
F_170 ( struct V_188 * V_189 , unsigned long V_182 ,
void * * V_184 )
{
struct V_185 * * V_186 = (struct V_185 * * ) V_184 ;
struct V_185 * V_43 = * V_186 ;
...
static void
F_171 ( struct V_188 * V_189 , unsigned long V_182 ,
void * * V_184 )
{
struct V_185 * * V_186 = (struct V_185 * * ) V_184 ;
struct V_185 * V_43 = * V_186 ;
...
if ( ! V_43 -> V_192 ) {
F_42 ( V_43 -> V_44 , 0 , 1 ) ;
F_172 ( V_43 -> V_44 -> V_6 -> V_165 ) ;
F_52 ( V_43 ) ;
}
* V_186 = NULL ;
}
static int
F_173 ( struct V_193 * V_194 ,
...
if ( ! strlen ( V_199 ) )
goto V_147;
V_25 = F_175 ( V_199 , 0 , & V_43 -> V_187 ) ;
if ( V_25 )
goto V_147;
V_204:
V_25 = F_176 ( V_44 -> V_6 -> V_165 ) ;
if ( ! V_25 ) {
V_25 = - V_171 ;
goto V_147;
}
...
F_42 ( V_44 , 0 , 1 ) ;
V_108:
F_172 ( V_44 -> V_6 -> V_165 ) ;
V_147:
F_52 ( V_43 ) ;
goto V_118;
}
static T_5 int F_178 ( void )
{
int V_25 ;
V_25 = F_179 ( & V_207 ) ;
if ( F_13 ( V_25 < 0 ) )
...
static inline int F_178 ( void ) { return 0 ; }
static T_5 void
F_181 ( struct V_58 * V_59 )
{
struct V_35 * V_44 ;
int V_25 ;
F_6 (file, &tr->events, list) {
...
static void F_152 ( struct V_5 * V_14 )
{
struct V_58 * V_59 ;
F_6 (tr, &ftrace_trace_arrays, list)
F_149 ( V_14 , V_59 ) ;
}
static T_5 int F_184 ( char * V_209 )
{
F_185 ( V_210 , V_209 , V_211 ) ;
V_212 = true ;
V_213 = true ;
return 1 ;
}
static int
F_186 ( struct V_84 * V_149 , struct V_58 * V_59 )
{
struct V_84 * V_154 ;
struct V_84 * V_41 ;
V_41 = F_136 ( L_35 , 0644 , V_149 ,
V_59 , & V_214 ) ;
if ( ! V_41 ) {
F_135 ( L_36 ) ;
return - V_22 ;
}
V_154 = F_134 ( L_37 , V_149 ) ;
if ( ! V_154 ) {
F_135 ( L_38 ) ;
return - V_22 ;
}
F_137 ( L_39 , 0444 , V_154 ,
V_215 ,
& V_216 ) ;
...
int F_187 ( struct V_84 * V_149 , struct V_58 * V_59 )
{
int V_25 ;
F_34 ( & V_60 ) ;
V_25 = F_186 ( V_149 , V_59 ) ;
if ( V_25 )
goto V_219;
F_156 ( & V_172 ) ;
F_165 ( V_59 ) ;
...
{
V_20 = F_193 ( V_10 , V_220 ) ;
V_89 = F_193 ( V_35 , V_220 ) ;
return 0 ;
}
...
if ( ! V_59 )
return - V_32 ;
F_161 (iter, __start_ftrace_events, __stop_ftrace_events) {
V_14 = * V_221 ;
V_25 = F_144 ( V_14 ) ;
if ( ! V_25 )
F_11 ( & V_14 -> V_78 , & V_166 ) ;
...
if ( ! V_223 )
return 0 ;
V_41 = F_136 ( L_43 , 0444 , V_223 ,
V_59 , & V_224 ) ;
if ( ! V_41 )
F_135 ( L_44 ) ;
if ( F_14 () )
F_135 ( L_45 ) ;
V_25 = F_188 ( V_223 , V_59 ) ;
if ( V_25 )
return V_25 ;
#ifdef F_199
V_25 = F_200 ( & V_225 ) ;
...
static T_5 void F_201 ( struct V_226 * V_227 )
{
F_60 ( & V_228 ) ;
F_202 ( & V_229 ) ;
F_203 ( 1 ) ;
...
static T_5 int F_206 ( void * V_231 )
{
void * V_232 ;
...
static T_5 void F_211 ( void )
{
struct V_234 * V_235 ;
V_235 = F_212 ( F_206 , NULL , L_48 ) ;
F_205 ( 1 ) ;
F_213 ( V_235 ) ;
}
...
static void
F_217 ( unsigned long V_182 , unsigned long V_183 ,
...
V_41 -> V_182 = V_182 ;
V_41 -> V_183 = V_183 ;
F_222 ( V_40 , V_31 , V_38 , V_39 ) ;
V_118:
F_223 ( & F_220 ( V_244 , V_243 ) ) ;
F_224 () ;
}
static T_5 void F_225 ( void )
{
int V_25 ;
V_25 = F_226 ( & V_246 ) ;
if ( F_13 ( V_25 < 0 ) ) {
