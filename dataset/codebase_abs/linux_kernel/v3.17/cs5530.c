...
V_19 = F_24 ( V_2 -> V_31 , 0 , & V_2 -> V_31 -> V_32 ) ;
if ( V_19 < 0 ) {
F_22 ( V_11 -> V_27 , L_11 ) ;
F_1 ( V_2 ) ;
return V_19 ;
...
V_19 = F_28 ( & V_3 -> V_27 , V_39 [ V_27 ] , V_40 [ V_27 ] , V_41 ,
0 , & V_11 ) ;
if ( V_19 < 0 )
return V_19 ;
...
strcpy ( V_11 -> V_42 , L_1 ) ;
strcpy ( V_11 -> V_43 , L_13 ) ;
sprintf ( V_11 -> V_44 , L_14 , V_11 -> V_43 , V_2 -> V_25 ) ;
V_19 = F_29 ( V_11 ) ;
if ( V_19 < 0 ) {
F_7 ( V_11 ) ;
return V_19 ;
