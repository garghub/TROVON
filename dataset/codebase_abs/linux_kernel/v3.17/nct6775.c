...
struct V_18 * V_239 ;
int V_240 = 0 ;
V_65 = F_127 ( V_225 , V_241 , 0 ) ;
if ( ! F_128 ( & V_225 -> V_19 , V_65 -> V_242 , V_243 ,
V_6 ) )
return - V_7 ;
...
V_53 -> V_62 = V_65 -> V_242 ;
F_129 ( & V_53 -> V_113 ) ;
V_53 -> V_41 = V_244 [ V_53 -> V_54 ] ;
V_53 -> V_60 = 0xff ;
F_130 ( V_225 , V_53 ) ;
switch ( V_53 -> V_54 ) {
case V_55 :
...
F_8 ( V_227 -> V_198 ) ;
F_40 ( V_19 , V_53 ) ;
V_23 = F_23 ( V_19 , & V_387 ,
V_53 -> V_79 ) ;
if ( F_133 ( V_23 ) )
return F_134 ( V_23 ) ;
V_53 -> V_388 [ V_240 ++ ] = V_23 ;
...
return F_134 ( V_23 ) ;
V_53 -> V_388 [ V_240 ++ ] = V_23 ;
V_53 -> V_388 [ V_240 ++ ] = & V_392 ;
V_239 = F_136 ( V_19 , V_53 -> V_41 ,
V_53 , V_53 -> V_388 ) ;
return F_137 ( V_239 ) ;
}
static void F_138 ( int V_393 )
{
int V_3 ;
V_3 = F_3 ( V_393 , V_394 ) ;
if ( V_3 & 0x10 ) {
...
if ( V_53 -> V_54 == V_56 ) {
V_53 -> V_395 = F_29 ( V_53 , V_68 ) ;
V_53 -> V_396 = F_29 ( V_53 , V_70 ) ;
}
F_51 ( & V_53 -> V_113 ) ;
return 0 ;
}
...
{
struct V_52 * V_53 = F_44 ( V_19 ) ;
int V_34 , V_76 , V_149 = 0 ;
F_49 ( & V_53 -> V_113 ) ;
V_53 -> V_60 = 0xff ;
if ( V_53 -> V_54 == V_59 ) {
V_149 = F_6 ( V_53 -> V_198 ) ;
if ( V_149 )
goto abort;
F_138 ( V_53 -> V_198 ) ;
F_8 ( V_53 -> V_198 ) ;
...
if ( V_53 -> V_54 == V_56 ) {
F_31 ( V_53 , V_68 , V_53 -> V_395 ) ;
F_31 ( V_53 , V_70 , V_53 -> V_396 ) ;
}
abort:
V_53 -> V_117 = false ;
F_51 ( & V_53 -> V_113 ) ;
...
static int T_7 F_142 ( int V_393 , struct V_226 * V_227 )
{
T_2 V_3 ;
int V_149 ;
int V_62 ;
...
if ( ! ( V_3 & 0x01 ) ) {
F_145 ( L_17 ) ;
F_1 ( V_393 , V_219 , V_3 | 0x01 ) ;
}
if ( V_227 -> V_54 == V_59 )
F_138 ( V_393 ) ;
F_8 ( V_393 ) ;
F_139 ( L_18 ,
V_407 [ V_227 -> V_54 ] , V_393 , V_62 ) ;
V_227 -> V_198 = V_393 ;
return V_62 ;
}
...
struct V_228 V_65 ;
struct V_226 V_227 ;
int V_393 [ 2 ] = { 0x2e , 0x4e } ;
V_149 = F_147 ( & V_410 ) ;
if ( V_149 )
return V_149 ;
for ( V_34 = 0 ; V_34 < F_39 ( V_225 ) ; V_34 ++ ) {
V_409 = F_142 ( V_393 [ V_34 ] , & V_227 ) ;
if ( V_409 <= 0 )
continue;
V_408 = true ;
V_225 [ V_34 ] = F_148 ( V_6 , V_409 ) ;
if ( ! V_225 [ V_34 ] ) {
V_149 = - V_39 ;
goto V_411;
}
V_149 = F_149 ( V_225 [ V_34 ] , & V_227 ,
sizeof( struct V_226 ) ) ;
if ( V_149 )
goto V_412;
memset ( & V_65 , 0 , sizeof( V_65 ) ) ;
V_65 . V_41 = V_6 ;
V_65 . V_242 = V_409 + V_413 ;
V_65 . V_414 = V_409 + V_413 + V_243 - 1 ;
V_65 . V_415 = V_241 ;
V_149 = F_150 ( & V_65 ) ;
if ( V_149 ) {
F_151 ( V_225 [ V_34 ] ) ;
...
V_149 = F_152 ( V_225 [ V_34 ] , & V_65 , 1 ) ;
if ( V_149 )
goto V_412;
V_149 = F_153 ( V_225 [ V_34 ] ) ;
if ( V_149 )
goto V_412;
}
if ( ! V_408 ) {
