...
V_3 -> V_34 = & V_35 ;
V_3 -> V_36 = 0 ;
V_3 -> V_37 = V_38 | V_39 | V_40 |
V_41 | V_42 |
V_43 | V_44 ;
V_3 -> V_45 = V_3 -> V_37 ;
V_3 -> V_46 = V_3 -> V_37 ;
V_3 -> V_37 |= V_47 ;
V_3 -> V_48 = V_3 -> V_37 & ~ V_38 ;
F_22 ( V_3 ) ;
}
static struct V_6 * F_23 ( const struct V_49 * V_50 )
{
struct V_6 * V_6 ;
struct V_51 * V_51 ;
struct V_1 * V_1 ;
int V_52 ;
V_6 = F_24 ( sizeof( struct V_51 ) ,
& V_53 , V_50 ) ;
if ( F_25 ( V_6 ) ) {
V_52 = F_26 ( V_6 ) ;
goto error;
...
V_51 = F_27 ( V_6 ) ;
V_51 -> V_25 = F_28 ( sizeof( struct V_1 ) ,
V_50 -> V_54 , V_55 ,
F_20 ) ;
if ( ! V_51 -> V_25 ) {
V_52 = - V_56 ;
...
V_18 -> V_25 = V_3 ;
V_18 -> V_64 = V_65 ;
V_18 -> V_66 = F_42 ( V_18 , V_3 ) ;
F_43 ( V_18 , F_44 ( V_18 ) , V_67 ) ;
F_45 ( V_18 ) ;
return V_63 ;
}
