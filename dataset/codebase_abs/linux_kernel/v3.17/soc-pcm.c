...
int F_85 ( struct V_1 * V_33 , int V_3 )
{
struct V_36 * V_37 ;
F_7 (dpcm, &fe->dpcm[stream].be_clients, list_be) {
struct V_1 * V_38 = V_37 -> V_38 ;
...
int F_87 ( struct V_1 * V_33 , int V_3 )
{
struct V_36 * V_37 ;
F_7 (dpcm, &fe->dpcm[stream].be_clients, list_be) {
struct V_1 * V_38 = V_37 -> V_38 ;
...
if ( ! F_80 ( V_33 , V_38 , V_3 ) )
continue;
if ( ! F_88 ( V_33 , V_38 , V_3 ) )
continue;
if ( ( V_38 -> V_37 [ V_3 ] . V_132 != V_177 ) &&
( V_38 -> V_37 [ V_3 ] . V_132 != V_178 ) &&
( V_38 -> V_37 [ V_3 ] . V_132 != V_176 ) &&
...
V_33 -> V_17 -> V_40 ) ;
V_162 = F_87 ( V_33 , V_3 ) ;
V_33 -> V_37 [ V_3 ] . V_132 = V_176 ;
V_33 -> V_37 [ V_3 ] . V_159 = V_167 ;
F_37 ( & V_33 -> V_112 -> V_181 ) ;
return 0 ;
}
int F_90 ( struct V_1 * V_33 , int V_3 )
{
struct V_36 * V_37 ;
int V_43 ;
F_7 (dpcm, &fe->dpcm[stream].be_clients, list_be) {
...
if ( ! F_80 ( V_33 , V_38 , V_3 ) )
continue;
if ( ! F_91 ( V_33 , V_38 , V_3 ) )
continue;
if ( ( V_38 -> V_37 [ V_3 ] . V_132 != V_168 ) &&
( V_38 -> V_37 [ V_3 ] . V_132 != V_177 ) &&
( V_38 -> V_37 [ V_3 ] . V_132 != V_176 ) )
continue;
F_8 ( V_38 -> V_39 , L_68 ,
V_37 -> V_33 -> V_17 -> V_40 ) ;
...
( V_38 -> V_37 [ V_3 ] . V_132 != V_180 ) )
continue;
V_43 = F_93 ( V_37 , V_141 , V_123 ) ;
if ( V_43 )
return V_43 ;
V_38 -> V_37 [ V_3 ] . V_132 = V_185 ;
break;
case V_186 :
...
static int F_95 ( struct V_19 * V_20 , int V_123 )
{
struct V_1 * V_33 = V_20 -> V_42 ;
int V_3 = V_20 -> V_3 , V_43 ;
enum V_192 V_124 = V_33 -> V_17 -> V_124 [ V_3 ] ;
V_33 -> V_37 [ V_3 ] . V_159 = V_174 ;
switch ( V_124 ) {
case V_193 :
F_8 ( V_33 -> V_39 , L_75 ,
...
int F_96 ( struct V_1 * V_33 , int V_3 )
{
struct V_36 * V_37 ;
int V_43 = 0 ;
F_7 (dpcm, &fe->dpcm[stream].be_clients, list_be) {
...
V_33 -> V_37 [ V_3 ] . V_159 = V_174 ;
if ( F_98 ( & V_33 -> V_37 [ V_3 ] . V_135 ) ) {
F_12 ( V_33 -> V_39 , L_83 ,
V_33 -> V_17 -> V_40 ) ;
V_43 = - V_57 ;
goto V_89;
}
V_43 = F_96 ( V_33 , V_20 -> V_3 ) ;
if ( V_43 < 0 )
goto V_89;
V_43 = F_45 ( V_20 ) ;
if ( V_43 < 0 ) {
...
unsigned int V_123 , void * V_196 )
{
struct V_1 * V_2 = V_20 -> V_42 ;
struct V_83 * V_84 = V_2 -> V_84 ;
if ( V_84 -> V_45 -> V_87 && V_84 -> V_45 -> V_87 -> V_197 )
return V_84 -> V_45 -> V_87 -> V_197 ( V_20 , V_123 , V_196 ) ;
return F_100 ( V_20 , V_123 , V_196 ) ;
}
static int F_101 ( struct V_1 * V_33 , int V_3 )
{
struct V_19 * V_20 =
F_63 ( V_33 , V_3 ) ;
enum V_192 V_124 = V_33 -> V_17 -> V_124 [ V_3 ] ;
...
F_8 ( V_33 -> V_39 , L_86 ,
V_33 -> V_17 -> V_40 ) ;
V_162 = F_55 ( V_20 , V_189 ) ;
if ( V_162 < 0 )
F_12 ( V_33 -> V_39 , L_76 , V_162 ) ;
} else {
F_8 ( V_33 -> V_39 , L_87 ,
V_33 -> V_17 -> V_40 ) ;
V_162 = F_94 ( V_33 , V_3 , V_189 ) ;
if ( V_162 < 0 )
F_12 ( V_33 -> V_39 , L_76 , V_162 ) ;
}
V_162 = F_87 ( V_33 , V_3 ) ;
...
static int F_102 ( struct V_1 * V_33 , int V_3 )
{
struct V_19 * V_20 =
F_63 ( V_33 , V_3 ) ;
struct V_36 * V_37 ;
...
static int F_103 ( struct V_1 * V_33 , int V_3 )
{
int V_43 ;
...
static int F_104 ( struct V_1 * V_33 , int V_3 )
{
int V_43 ;
V_33 -> V_37 [ V_3 ] . V_159 = V_160 ;
V_43 = F_101 ( V_33 , V_3 ) ;
...
int F_105 ( struct V_145 * V_112 )
{
int V_6 , V_200 , V_161 , V_157 ;
F_33 ( & V_112 -> V_181 , V_182 ) ;
for ( V_6 = 0 ; V_6 < V_112 -> V_201 ; V_6 ++ ) {
struct V_152 * V_153 ;
...
int F_107 ( struct V_1 * V_33 , int V_202 )
{
struct V_36 * V_37 ;
struct V_203 * V_204 =
& V_33 -> V_37 [ V_8 ] . V_135 ;
...
struct V_58 * V_206 = V_117 -> V_45 ;
F_8 ( V_38 -> V_39 , L_98 ,
V_38 -> V_17 -> V_40 ) ;
if ( V_206 -> V_87 && V_206 -> V_87 -> V_207 &&
V_117 -> V_9 )
V_206 -> V_87 -> V_207 ( V_117 , V_202 ) ;
}
}
return 0 ;
}
static int F_108 ( struct V_19 * V_140 )
{
struct V_1 * V_33 = V_140 -> V_42 ;
struct V_36 * V_37 ;
struct V_152 * V_153 ;
...
static int F_109 ( struct V_19 * V_140 )
{
struct V_1 * V_33 = V_140 -> V_42 ;
struct V_36 * V_37 ;
...
int F_110 ( struct V_1 * V_2 , int V_208 )
{
struct V_83 * V_84 = V_2 -> V_84 ;
struct V_4 * V_64 ;
struct V_4 * V_5 = V_2 -> V_5 ;
...
if ( V_2 -> V_17 -> V_97 ) {
snprintf ( V_211 , sizeof( V_211 ) , L_100 ,
V_2 -> V_17 -> V_106 ) ;
V_43 = F_111 ( V_2 -> V_112 -> V_216 , V_211 , V_208 ,
V_66 , V_68 , & V_210 ) ;
} else {
if ( V_2 -> V_17 -> V_96 )
snprintf ( V_211 , sizeof( V_211 ) , L_101 ,
V_2 -> V_17 -> V_106 ) ;
else
snprintf ( V_211 , sizeof( V_211 ) , L_102 ,
V_2 -> V_17 -> V_106 ,
( V_2 -> V_10 > 1 ) ?
L_12 : V_2 -> V_64 -> V_40 , V_208 ) ;
V_43 = F_112 ( V_2 -> V_112 -> V_216 , V_211 , V_208 , V_66 ,
V_68 , & V_210 ) ;
}
if ( V_43 < 0 ) {
...
F_8 ( V_2 -> V_112 -> V_39 , L_104 , V_208 , V_211 ) ;
F_113 ( & V_2 -> V_105 , F_40 ) ;
V_2 -> V_210 = V_210 ;
V_210 -> V_42 = V_2 ;
if ( V_2 -> V_17 -> V_97 ) {
if ( V_66 )
V_210 -> V_217 [ V_8 ] . V_20 -> V_42 = V_2 ;
if ( V_68 )
V_210 -> V_217 [ V_110 ] . V_20 -> V_42 = V_2 ;
goto V_89;
}
if ( V_2 -> V_17 -> V_96 ) {
V_2 -> V_87 . V_90 = F_108 ;
...
if ( V_84 -> V_45 -> V_87 ) {
V_2 -> V_87 . V_218 = V_84 -> V_45 -> V_87 -> V_218 ;
V_2 -> V_87 . V_219 = V_84 -> V_45 -> V_87 -> V_219 ;
V_2 -> V_87 . V_220 = V_84 -> V_45 -> V_87 -> V_220 ;
V_2 -> V_87 . V_221 = V_84 -> V_45 -> V_87 -> V_221 ;
V_2 -> V_87 . V_222 = V_84 -> V_45 -> V_87 -> V_222 ;
}
if ( V_66 )
F_114 ( V_210 , V_8 , & V_2 -> V_87 ) ;
if ( V_68 )
F_114 ( V_210 , V_110 , & V_2 -> V_87 ) ;
if ( V_84 -> V_45 -> V_223 ) {
V_43 = V_84 -> V_45 -> V_223 ( V_2 ) ;
if ( V_43 < 0 ) {
F_12 ( V_84 -> V_39 ,
L_105 ,
V_43 ) ;
...
V_210 -> V_224 = V_84 -> V_45 -> V_225 ;
V_89:
F_115 ( V_2 -> V_112 -> V_39 , L_106 ,
( V_2 -> V_10 > 1 ) ? L_12 : V_2 -> V_64 -> V_40 ,
V_5 -> V_40 ) ;
return V_43 ;
}
int F_116 ( struct V_1 * V_33 , int V_3 )
{
if ( V_33 -> V_37 [ V_3 ] . V_159 == V_174 )
return 1 ;
return 0 ;
}
...
{
return V_38 -> V_210 -> V_217 [ V_3 ] . V_20 ;
}
enum V_226
F_117 ( struct V_1 * V_38 , int V_3 )
{
return V_38 -> V_37 [ V_3 ] . V_132 ;
}
void F_118 ( struct V_1 * V_38 ,
int V_3 , enum V_226 V_132 )
{
V_38 -> V_37 [ V_3 ] . V_132 = V_132 ;
}
int F_88 ( struct V_1 * V_33 ,
struct V_1 * V_38 , int V_3 )
{
struct V_36 * V_37 ;
int V_132 ;
...
static char * F_120 ( enum V_226 V_132 )
{
switch ( V_132 ) {
case V_172 :
return L_107 ;
...
static T_4 F_121 ( struct V_1 * V_33 ,
int V_3 , char * V_227 , T_5 V_228 )
{
struct V_54 * V_55 = & V_33 -> V_37 [ V_3 ] . V_118 ;
struct V_36 * V_37 ;
T_4 V_126 = 0 ;
V_126 += snprintf ( V_227 + V_126 , V_228 - V_126 ,
L_118 , V_33 -> V_17 -> V_40 ,
V_3 ? L_119 : L_120 ) ;
V_126 += snprintf ( V_227 + V_126 , V_228 - V_126 , L_121 ,
F_120 ( V_33 -> V_37 [ V_3 ] . V_132 ) ) ;
if ( ( V_33 -> V_37 [ V_3 ] . V_132 >= V_177 ) &&
( V_33 -> V_37 [ V_3 ] . V_132 <= V_180 ) )
V_126 += snprintf ( V_227 + V_126 , V_228 - V_126 ,
L_122
...
F_15 ( V_55 ) ,
F_14 ( V_55 ) ) ;
V_126 += snprintf ( V_227 + V_126 , V_228 - V_126 , L_124 ) ;
if ( F_98 ( & V_33 -> V_37 [ V_3 ] . V_135 ) ) {
V_126 += snprintf ( V_227 + V_126 , V_228 - V_126 ,
L_125 ) ;
goto V_89;
...
static T_4 F_123 ( struct V_229 * V_229 , char T_6 * V_230 ,
T_5 V_170 , T_7 * V_231 )
{
struct V_1 * V_33 = V_229 -> V_42 ;
T_4 V_232 = V_233 , V_126 = 0 , V_43 = 0 ;
char * V_227 ;
V_227 = F_124 ( V_232 , V_130 ) ;
if ( ! V_227 )
return - V_131 ;
if ( V_33 -> V_5 -> V_45 -> V_66 . V_81 )
V_126 += F_121 ( V_33 , V_8 ,
V_227 + V_126 , V_232 - V_126 ) ;
if ( V_33 -> V_5 -> V_45 -> V_68 . V_81 )
V_126 += F_121 ( V_33 , V_110 ,
V_227 + V_126 , V_232 - V_126 ) ;
V_43 = F_125 ( V_230 , V_170 , V_231 , V_227 , V_126 ) ;
F_68 ( V_227 ) ;
return V_43 ;
}
