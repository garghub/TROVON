...
{
struct V_289 * V_281 ;
V_281 = F_197 ( V_2 -> V_17 , V_2 -> V_305 , F_195 , 0 ,
V_2 -> V_306 ) ;
if ( ! V_281 ) {
F_73 ( V_2 -> V_17 , L_24 ) ;
return - V_307 ;
...
if ( V_282 )
goto V_311;
V_282 = F_201 ( V_2 -> V_17 -> V_265 , F_151 , 0 ,
V_312 , V_2 ) ;
if ( V_282 ) {
F_73 ( V_2 -> V_17 , L_25 , V_2 -> V_17 -> V_265 ) ;
goto V_313;
}
F_183 ( V_2 -> V_17 ) ;
V_282 = F_196 ( V_2 ) ;
...
F_180 ( V_2 ) ;
F_198 ( V_2 ) ;
F_202 ( V_17 -> V_265 , V_2 ) ;
F_173 ( V_2 ) ;
F_172 ( V_2 ) ;
return 0 ;
}
static int F_204 ( struct V_16 * V_17 , struct V_315 * V_316 , int V_317 )
{
struct V_1 * V_2 = F_9 ( V_17 ) ;
int V_282 ;
if ( ! V_2 -> V_281 )
return - V_318 ;
V_282 = F_205 ( V_2 -> V_281 , V_316 , V_317 ) ;
if ( ! V_282 )
F_195 ( V_17 ) ;
return V_282 ;
}
int F_206 ( struct V_16 * V_17 , struct V_319 * V_317 )
{
struct V_1 * V_2 = F_9 ( V_17 ) ;
if ( ! V_2 -> V_281 )
return - V_307 ;
return F_207 ( V_2 -> V_281 , V_317 ) ;
}
int F_208 ( struct V_16 * V_17 , struct V_319 * V_317 )
{
struct V_1 * V_2 = F_9 ( V_17 ) ;
if ( ! V_2 -> V_281 )
return - V_307 ;
return F_209 ( V_2 -> V_281 , V_317 ) ;
}
static int F_210 ( struct V_16 * V_17 ,
struct V_320 * V_321 )
{
struct V_1 * V_2 = F_9 ( V_17 ) ;
int V_61 ;
...
struct V_325 * V_326 )
{
F_213 ( V_326 -> V_327 , V_312 ,
sizeof( V_326 -> V_327 ) ) ;
F_213 ( V_326 -> V_328 , V_329 ,
sizeof( V_326 -> V_328 ) ) ;
F_213 ( V_326 -> V_330 , F_214 ( & V_17 -> V_17 ) ,
sizeof( V_326 -> V_330 ) ) ;
}
static void F_215 ( struct V_16 * V_331 ,
struct V_332 * V_333 )
{
...
static int F_216 ( struct V_16 * V_17 ,
struct V_332 * V_333 )
{
struct V_1 * V_2 = F_9 ( V_17 ) ;
...
V_333 -> V_338 : V_335 ;
V_2 -> V_279 = F_217 ( T_7 , V_333 -> V_339 ,
V_280 * 2 , V_337 ) ;
...
static int F_218 ( struct V_340 * V_17 , struct V_1 * V_2 )
{
int V_61 ;
F_40 ( V_2 ) ;
F_44 ( V_2 ) ;
V_2 -> V_64 = F_219 ( V_17 , V_63 , sizeof( struct V_6 ) ,
V_277 ) ;
if ( ! V_2 -> V_64 )
return - V_189 ;
for ( V_61 = 0 ; V_61 < V_63 ; V_61 ++ ) {
...
V_2 -> V_67 = F_219 ( V_17 , V_66 , sizeof( struct V_33 ) ,
V_277 ) ;
if ( ! V_2 -> V_67 )
return - V_189 ;
for ( V_61 = 0 ; V_61 < V_66 ; V_61 ++ ) {
...
F_1 ( V_2 , F_221 ( V_11 ) , ( V_350 -> V_5 & 0xffff0000 ) |
...
static int F_224 ( struct V_1 * V_2 , int V_354 )
{
T_1 V_355 ;
F_1 ( V_2 , V_356 , 0 ) ;
V_355 = F_3 ( V_2 , V_357 ) ;
...
static int F_225 ( struct V_368 * V_369 )
{
...
int V_205 ;
if ( V_103 != 0 ) {
F_226 ( & V_369 -> V_17 , L_29 , V_103 ) ;
return - V_253 ;
}
V_17 = F_227 ( sizeof( struct V_1 ) , V_63 , V_66 ) ;
if ( ! V_17 )
return - V_189 ;
V_17 -> V_265 = F_228 ( V_374 , 0 ) ;
if ( V_17 -> V_265 == 0 ) {
V_205 = - V_253 ;
goto V_379;
}
V_305 = F_229 ( V_374 , L_30 , 0 ) ;
if ( ! V_305 ) {
if ( ! F_230 ( V_374 ) ) {
F_226 ( & V_369 -> V_17 , L_31 ) ;
V_205 = - V_307 ;
goto V_314;
}
V_205 = F_231 ( V_374 ) ;
if ( V_205 < 0 ) {
F_226 ( & V_369 -> V_17 , L_32 ) ;
goto V_314;
}
V_305 = F_232 ( V_374 ) ;
}
...
V_2 -> V_305 = V_305 ;
V_2 -> V_306 = V_354 ;
V_2 -> V_136 = F_234 ( & V_369 -> V_17 , NULL ) ;
if ( F_235 ( V_2 -> V_136 ) ) {
V_205 = F_236 ( V_2 -> V_136 ) ;
goto V_380;
}
F_237 ( V_2 -> V_136 ) ;
V_372 = F_238 ( V_369 , V_388 , 0 ) ;
V_2 -> V_5 = F_239 ( & V_369 -> V_17 , V_372 ) ;
if ( F_235 ( V_2 -> V_5 ) ) {
V_205 = F_236 ( V_2 -> V_5 ) ;
goto V_389;
}
V_2 -> V_18 = F_240 ( struct V_21 ) ;
if ( ! V_2 -> V_18 ) {
V_205 = - V_189 ;
goto V_389;
}
...
V_2 -> V_274 = V_335 ;
V_2 -> V_17 = V_17 ;
F_244 ( V_17 , & V_369 -> V_17 ) ;
V_205 = F_218 ( & V_369 -> V_17 , V_2 ) ;
if ( V_205 < 0 )
goto V_390;
V_205 = F_224 ( V_2 , V_354 ) ;
if ( V_205 < 0 ) {
F_226 ( & V_369 -> V_17 , L_37 ) ;
goto V_390;
}
V_370 = F_245 () ;
if ( V_370 )
F_220 ( V_2 , V_370 ) ;
F_246 ( V_17 , & V_2 -> V_211 , F_153 , V_391 ) ;
...
V_205 = F_247 ( V_17 ) ;
if ( V_205 < 0 ) {
F_226 ( & V_369 -> V_17 , L_38 ) ;
goto V_390;
}
F_146 ( V_17 , L_39 , V_378 ,
V_17 -> V_263 ) ;
F_248 ( V_369 , V_2 -> V_17 ) ;
return 0 ;
V_390:
F_249 ( V_2 -> V_18 ) ;
V_389:
...
static int F_254 ( struct V_368 * V_369 )
{
struct V_16 * V_17 = F_255 ( V_369 ) ;
struct V_1 * V_2 = F_9 ( V_17 ) ;
F_256 ( V_17 ) ;
F_250 ( V_2 -> V_136 ) ;
F_249 ( V_2 -> V_18 ) ;
