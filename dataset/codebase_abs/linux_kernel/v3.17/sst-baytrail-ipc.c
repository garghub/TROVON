...
int F_72 ( struct V_128 * V_29 , struct V_129 * V_73 )
{
struct V_13 * V_14 = V_73 -> V_20 ;
int V_48 ;
F_42 ( V_14 -> V_29 , L_14 ) ;
F_70 ( V_14 -> V_20 ) ;
V_48 = F_73 ( V_14 -> V_130 ) ;
if ( V_48 < 0 ) {
F_13 ( V_29 , L_15 ) ;
return V_48 ;
}
...
int F_75 ( struct V_128 * V_29 , struct V_129 * V_73 )
{
struct V_13 * V_14 = V_73 -> V_20 ;
int V_131 ;
F_42 ( V_14 -> V_29 , L_17 ) ;
...
int V_131 ;
F_42 ( V_29 , L_20 ) ;
V_14 = F_77 ( V_29 , sizeof( * V_14 ) , V_83 ) ;
if ( V_14 == NULL )
return - V_127 ;
V_14 -> V_29 = V_29 ;
F_78 ( & V_14 -> V_85 ) ;
...
return - V_127 ;
F_79 ( & V_14 -> V_57 ) ;
V_14 -> V_139 = F_80 ( V_140 ,
& V_14 -> V_57 , L_21 ,
F_81 ( V_14 -> V_29 ) ) ;
if ( F_82 ( V_14 -> V_139 ) ) {
V_131 = F_83 ( V_14 -> V_139 ) ;
F_13 ( V_14 -> V_29 , L_22 ) ;
goto V_141;
}
F_84 ( & V_14 -> V_36 , F_18 ) ;
V_142 . V_143 = V_14 ;
V_14 -> V_20 = F_85 ( V_29 , & V_142 , V_73 ) ;
if ( V_14 -> V_20 == NULL ) {
V_131 = - V_144 ;
goto V_145;
}
F_70 ( V_14 -> V_20 ) ;
V_135 = F_86 ( V_14 -> V_20 , V_73 -> V_130 , V_14 ) ;
if ( V_135 == NULL ) {
V_131 = - V_144 ;
F_13 ( V_29 , L_23 ) ;
goto V_146;
...
F_40 ( V_14 -> V_20 , & V_137 , sizeof( V_137 ) ) ;
F_87 ( V_14 -> V_29 , L_24 ,
V_137 . V_148 . V_149 , V_137 . V_148 . V_150 ,
V_137 . V_148 . V_151 , V_137 . V_148 . type ) ;
F_87 ( V_14 -> V_29 , L_25 , V_137 . V_148 . type ) ;
F_87 ( V_14 -> V_29 , L_26 ,
V_137 . V_152 . V_153 , V_137 . V_152 . time ) ;
V_73 -> V_20 = V_14 ;
V_14 -> V_130 = V_135 ;
return 0 ;
V_147:
