...
struct V_66 * V_67 )
{
struct V_5 * V_6 = (struct V_5 * ) V_33 ;
...
V_75 . V_81 [ 0 ] = F_36 ( V_75 . V_81 [ 0 ] , 256 ) ;
V_75 . V_83 = F_37 ( V_67 -> V_82 ,
V_67 -> V_84 ) ;
V_78 = V_75 . V_81 [ 0 ] * V_75 . V_61 ;
V_78 = F_36 ( V_78 , V_85 ) ;
V_13 = F_38 ( V_10 , V_78 , 0 , V_86 ,
0 , 0x0000 , & V_73 ) ;
if ( V_13 ) {
F_39 ( V_9 , L_1 ) ;
goto V_87;
...
F_43 ( & V_10 -> V_94 ) ;
V_2 = F_44 ( 0 , & V_77 -> V_10 ) ;
if ( ! V_2 ) {
V_13 = - V_95 ;
goto V_96;
}
V_13 = F_45 ( & V_2 -> V_97 , 256 , 0 ) ;
if ( V_13 ) {
V_13 = - V_95 ;
F_46 ( V_2 ) ;
goto V_96;
...
V_2 -> V_99 . V_112 = V_78 ;
V_2 -> V_113 = F_48 ( V_71 -> V_73 ) ;
V_2 -> V_114 = V_78 ;
F_49 ( V_2 , V_69 -> V_81 [ 0 ] , V_69 -> V_115 ) ;
F_50 ( V_2 , & V_6 -> V_33 , V_67 -> V_116 , V_67 -> V_117 ) ;
F_7 ( & V_10 -> V_94 ) ;
if ( V_28 )
F_28 ( V_10 ) ;
F_34 ( V_10 , V_6 ) ;
...
static int
F_59 ( struct V_31 * V_10 , struct V_5 * V_6 )
{
...
if ( V_71 -> V_73 ) {
F_54 ( V_71 -> V_73 ) ;
F_53 ( V_71 -> V_73 , & V_71 -> V_93 ) ;
F_55 ( V_71 -> V_73 ) ;
F_62 ( & V_71 -> V_73 -> V_119 ) ;
V_71 -> V_73 = NULL ;
}
F_63 ( & V_6 -> V_33 ) ;
F_64 ( & V_71 -> V_98 ) ;
...
{
struct V_5 * V_6 = F_67 ( V_121 , F_68 ( * V_6 ) , V_121 ) ;
F_25 () ;
F_23 ( V_6 -> V_10 ) ;
F_34 ( V_6 -> V_10 , V_6 ) ;
