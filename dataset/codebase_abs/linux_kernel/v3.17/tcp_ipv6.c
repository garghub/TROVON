...
V_41 -> V_84 = & V_85 ;
#endif
V_47 = F_28 ( V_3 , (struct V_29 * ) & sin , sizeof( sin ) ) ;
if ( V_47 ) {
V_37 -> V_74 = V_73 ;
V_37 -> V_20 = & V_86 ;
V_3 -> V_82 = V_87 ;
...
V_42 = F_30 ( & V_45 , V_39 -> V_101 , & V_43 ) ;
F_31 ( V_3 , F_32 ( & V_45 ) ) ;
V_9 = F_33 ( V_3 , & V_45 , V_42 ) ;
if ( F_34 ( V_9 ) ) {
V_47 = F_35 ( V_9 ) ;
goto V_89;
}
...
V_171 -> V_220 = F_67 ( V_7 ) ;
if ( ! F_113 ( V_7 ) -> V_221 &&
( F_114 ( V_3 , V_7 ) || V_39 -> V_222 . V_223 . V_224 ||
V_39 -> V_222 . V_223 . V_225 || V_39 -> V_222 . V_223 . V_226 ||
V_39 -> V_222 . V_223 . V_227 || V_39 -> V_178 ) ) {
F_115 ( & V_7 -> V_228 ) ;
V_171 -> V_179 = V_7 ;
}
}
static struct V_8 * F_116 ( struct V_2 * V_3 , struct V_165 * V_166 ,
const struct V_130 * V_157 ,
bool * V_229 )
{
if ( V_229 )
...
static void F_117 ( struct V_6 * V_7 , T_2 V_132 , T_2 V_230 , T_2 V_231 ,
T_2 V_232 , T_2 V_233 , int V_234 ,
struct V_1 * V_206 , int V_235 , T_3 V_180 ,
T_2 V_236 )
{
const struct V_112 * V_129 = F_15 ( V_7 ) ;
struct V_112 * V_237 ;
...
struct V_2 * V_239 = V_134 -> V_240 . F_17 ;
unsigned int V_241 = sizeof( struct V_112 ) ;
struct V_8 * V_9 ;
T_4 * V_242 ;
if ( V_233 )
V_241 += V_243 ;
...
V_241 += V_244 ;
#endif
V_238 = F_118 ( V_245 + sizeof( struct V_113 ) + V_241 ,
V_246 ) ;
if ( V_238 == NULL )
return;
F_119 ( V_238 , V_245 + sizeof( struct V_113 ) + V_241 ) ;
V_237 = (struct V_112 * ) F_120 ( V_238 , V_241 ) ;
F_121 ( V_238 ) ;
memset ( V_237 , 0 , sizeof( * V_237 ) ) ;
V_237 -> V_27 = V_129 -> V_28 ;
V_237 -> V_28 = V_129 -> V_27 ;
V_237 -> V_211 = V_241 / 4 ;
V_237 -> V_132 = F_122 ( V_132 ) ;
V_237 -> V_247 = F_122 ( V_230 ) ;
V_237 -> V_230 = ! V_235 || ! V_129 -> V_230 ;
V_237 -> V_235 = V_235 ;
V_237 -> V_248 = F_123 ( V_231 ) ;
V_242 = ( T_4 * ) ( V_237 + 1 ) ;
if ( V_233 ) {
* V_242 ++ = F_122 ( ( V_249 << 24 ) | ( V_249 << 16 ) |
( V_250 << 8 ) | V_251 ) ;
* V_242 ++ = F_122 ( V_232 ) ;
* V_242 ++ = F_122 ( V_233 ) ;
}
...
V_238 -> V_254 = V_255 ;
V_238 -> V_256 = 0 ;
F_78 ( V_238 , & V_45 . V_26 , & V_45 . V_24 ) ;
V_45 . V_93 = V_94 ;
if ( F_124 ( & V_45 . V_24 ) && ! V_234 )
V_45 . V_95 = F_67 ( V_7 ) ;
else
V_45 . V_95 = V_234 ;
V_45 . V_96 = F_125 ( V_134 , V_7 -> V_257 ) ;
V_45 . V_98 = V_237 -> V_27 ;
V_45 . V_99 = V_237 -> V_28 ;
F_126 ( V_7 , F_32 ( & V_45 ) ) ;
V_9 = F_33 ( V_239 , & V_45 , NULL ) ;
if ( ! F_34 ( V_9 ) ) {
F_127 ( V_238 , V_9 ) ;
F_80 ( V_239 , V_238 , & V_45 , NULL , V_180 ) ;
F_128 ( V_134 , V_258 ) ;
if ( V_235 )
F_128 ( V_134 , V_259 ) ;
return;
...
V_213 = F_106 ( V_129 ) ;
if ( ! V_3 && V_213 ) {
V_261 = F_131 ( F_49 ( F_3 ( V_7 ) -> V_135 ) ,
& V_136 , & V_260 -> V_26 ,
V_129 -> V_28 , & V_260 -> V_24 ,
F_108 ( V_129 -> V_28 ) , F_67 ( V_7 ) ) ;
if ( ! V_261 )
return;
F_110 () ;
V_206 = F_1 ( V_261 , & V_260 -> V_26 ) ;
if ( ! V_206 )
goto V_262;
...
V_206 = V_3 ? F_1 ( V_3 , & V_260 -> V_26 ) : NULL ;
}
#endif
if ( V_129 -> V_230 )
V_132 = F_58 ( V_129 -> V_247 ) ;
else
V_247 = F_58 ( V_129 -> V_132 ) + V_129 -> V_263 + V_129 -> V_264 + V_7 -> V_203 -
( V_129 -> V_211 << 2 ) ;
V_234 = V_3 ? V_3 -> V_65 : 0 ;
F_117 ( V_7 , V_132 , V_247 , 0 , 0 , 0 , V_234 , V_206 , 1 , 0 , 0 ) ;
#ifdef F_27
V_262:
if ( V_261 ) {
F_111 () ;
...
static void F_132 ( struct V_6 * V_7 , T_2 V_132 , T_2 V_230 ,
T_2 V_231 , T_2 V_232 , T_2 V_233 , int V_234 ,
struct V_1 * V_206 , T_3 V_180 ,
T_2 V_236 )
{
F_117 ( V_7 , V_132 , V_230 , V_231 , V_232 , V_233 , V_234 , V_206 , 0 , V_180 ,
V_236 ) ;
}
static void F_133 ( struct V_2 * V_3 , struct V_6 * V_7 )
{
struct V_265 * V_266 = F_54 ( V_3 ) ;
struct V_267 * V_268 = F_134 ( V_3 ) ;
F_132 ( V_7 , V_268 -> V_269 , V_268 -> V_270 ,
V_268 -> V_271 >> V_266 -> V_272 ,
V_273 + V_268 -> V_274 ,
V_268 -> V_275 , V_266 -> V_276 , F_135 ( V_268 ) ,
V_266 -> V_277 , ( V_266 -> V_278 << 12 ) ) ;
F_53 ( V_266 ) ;
}
static void F_136 ( struct V_2 * V_3 , struct V_6 * V_7 ,
struct V_130 * V_157 )
{
F_132 ( V_7 , ( V_3 -> V_18 == V_148 ) ?
F_59 ( V_157 ) -> V_147 + 1 : F_17 ( V_3 ) -> V_149 ,
F_59 ( V_157 ) -> V_279 ,
V_157 -> V_280 , V_273 , V_157 -> V_69 , V_3 -> V_65 ,
...
& F_14 ( V_7 ) -> V_26 ,
& F_14 ( V_7 ) -> V_24 , F_67 ( V_7 ) ) ;
if ( V_157 )
return F_138 ( V_3 , V_7 , V_157 , V_158 , false ) ;
V_281 = F_139 ( F_70 ( V_3 ) , & V_136 ,
& F_14 ( V_7 ) -> V_26 , V_129 -> V_28 ,
& F_14 ( V_7 ) -> V_24 , F_108 ( V_129 -> V_27 ) , F_67 ( V_7 ) ) ;
if ( V_281 ) {
if ( V_281 -> V_18 != V_139 ) {
F_55 ( V_281 ) ;
return V_281 ;
...
static struct V_2 * F_145 ( struct V_2 * V_3 , struct V_6 * V_7 ,
struct V_130 * V_157 ,
struct V_8 * V_9 )
{
struct V_170 * V_171 ;
struct V_38 * V_286 , * V_39 = F_6 ( V_3 ) ;
struct V_287 * V_288 ;
struct V_34 * V_289 ;
struct V_40 * V_290 ;
struct V_2 * V_291 ;
...
struct V_44 V_45 ;
if ( V_7 -> V_202 == F_123 ( V_282 ) ) {
V_291 = F_146 ( V_3 , V_7 , V_157 , V_9 ) ;
if ( V_291 == NULL )
return NULL ;
V_288 = (struct V_287 * ) V_291 ;
F_5 ( V_291 ) -> V_292 = & V_288 -> V_293 ;
V_289 = F_5 ( V_291 ) ;
V_286 = F_6 ( V_291 ) ;
V_290 = F_17 ( V_291 ) ;
memcpy ( V_286 , V_39 , sizeof( struct V_38 ) ) ;
F_29 ( V_289 -> V_294 , & V_291 -> V_68 ) ;
F_29 ( V_289 -> V_90 , & V_286 -> V_26 ) ;
V_291 -> V_92 = V_286 -> V_26 ;
F_8 ( V_291 ) -> V_20 = & V_21 ;
V_291 -> V_82 = V_83 ;
#ifdef F_27
V_290 -> V_84 = & V_85 ;
...
V_286 -> V_297 = NULL ;
V_286 -> V_101 = NULL ;
V_286 -> V_298 = F_67 ( V_7 ) ;
V_286 -> V_299 = F_14 ( V_7 ) -> V_143 ;
V_286 -> V_300 = F_147 ( F_14 ( V_7 ) ) ;
if ( V_39 -> V_178 )
V_286 -> V_71 = V_58 ( F_14 ( V_7 ) ) ;
F_46 ( V_291 , F_8 ( V_291 ) -> V_122 ) ;
return V_291 ;
}
V_171 = F_75 ( V_157 ) ;
if ( F_148 ( V_3 ) )
...
V_291 = F_149 ( V_3 , V_157 , V_7 ) ;
if ( V_291 == NULL )
goto V_302;
V_291 -> V_103 = V_104 ;
F_36 ( V_291 , V_9 , NULL , NULL ) ;
F_2 ( V_291 , V_7 ) ;
V_288 = (struct V_287 * ) V_291 ;
F_5 ( V_291 ) -> V_292 = & V_288 -> V_293 ;
V_290 = F_17 ( V_291 ) ;
...
V_286 = F_6 ( V_291 ) ;
memcpy ( V_286 , V_39 , sizeof( struct V_38 ) ) ;
V_291 -> V_68 = V_171 -> V_177 ;
V_286 -> V_26 = V_171 -> V_176 ;
V_291 -> V_92 = V_171 -> V_176 ;
V_291 -> V_65 = V_171 -> V_220 ;
F_24 ( V_291 ) ;
V_289 -> V_303 = NULL ;
V_286 -> V_295 = NULL ;
V_286 -> V_296 = NULL ;
V_286 -> V_222 . V_304 = V_39 -> V_222 . V_304 ;
V_286 -> V_297 = NULL ;
if ( V_171 -> V_179 != NULL ) {
V_286 -> V_297 = F_150 ( V_171 -> V_179 ,
F_151 ( V_3 , V_246 ) ) ;
F_152 ( V_171 -> V_179 ) ;
V_171 -> V_179 = NULL ;
if ( V_286 -> V_297 )
F_153 ( V_286 -> V_297 , V_291 ) ;
}
V_286 -> V_101 = NULL ;
V_286 -> V_298 = F_67 ( V_7 ) ;
V_286 -> V_299 = F_14 ( V_7 ) -> V_143 ;
...
V_286 -> V_71 = V_58 ( F_14 ( V_7 ) ) ;
if ( V_39 -> V_101 )
V_286 -> V_101 = F_154 ( V_291 , V_39 -> V_101 ) ;
F_8 ( V_291 ) -> V_74 = 0 ;
if ( V_286 -> V_101 )
F_8 ( V_291 ) -> V_74 = ( V_286 -> V_101 -> V_109 +
V_286 -> V_101 -> V_108 ) ;
F_46 ( V_291 , F_45 ( V_9 ) ) ;
V_290 -> V_305 = F_155 ( V_9 ) ;
if ( F_17 ( V_3 ) -> V_66 . V_306 &&
F_17 ( V_3 ) -> V_66 . V_306 < V_290 -> V_305 )
V_290 -> V_305 = F_17 ( V_3 ) -> V_66 . V_306 ;
F_156 ( V_291 ) ;
V_289 -> V_294 = V_289 -> V_90 = V_102 ;
V_289 -> V_91 = V_102 ;
#ifdef F_27
V_206 = F_1 ( V_3 , & V_291 -> V_68 ) ;
if ( V_206 != NULL ) {
F_91 ( V_291 , (union V_181 * ) & V_291 -> V_68 ,
V_51 , V_206 -> V_206 , V_206 -> V_307 ,
F_151 ( V_3 , V_246 ) ) ;
}
#endif
if ( F_157 ( V_3 , V_291 ) < 0 ) {
F_158 ( V_291 ) ;
F_71 ( V_291 ) ;
goto V_142;
}
...
goto V_310;
if ( V_39 -> V_222 . V_304 )
V_309 = F_150 ( V_7 , F_151 ( V_3 , V_246 ) ) ;
if ( V_3 -> V_18 == V_311 ) {
struct V_8 * V_9 = V_3 -> V_12 ;
F_161 ( V_3 , V_7 ) ;
if ( V_9 ) {
if ( F_5 ( V_3 ) -> V_13 != V_7 -> V_14 ||
V_9 -> V_153 -> V_312 ( V_9 , V_39 -> V_16 ) == NULL ) {
F_159 ( V_9 ) ;
V_3 -> V_12 = NULL ;
}
}
F_162 ( V_3 , V_7 , F_15 ( V_7 ) , V_7 -> V_203 ) ;
if ( V_309 )
goto V_313;
return 0 ;
}
if ( V_7 -> V_203 < F_163 ( V_7 ) || F_164 ( V_7 ) )
goto V_314;
if ( V_3 -> V_18 == V_148 ) {
struct V_2 * V_281 = F_137 ( V_3 , V_7 ) ;
if ( ! V_281 )
goto V_310;
if ( V_281 != V_3 ) {
F_161 ( V_281 , V_7 ) ;
if ( F_165 ( V_3 , V_281 , V_7 ) )
goto V_315;
if ( V_309 )
F_166 ( V_309 ) ;
return 0 ;
...
F_161 ( V_3 , V_7 ) ;
if ( F_167 ( V_3 , V_7 , F_15 ( V_7 ) , V_7 -> V_203 ) )
goto V_315;
if ( V_309 )
goto V_313;
return 0 ;
...
return 0 ;
V_314:
F_128 ( F_70 ( V_3 ) , V_316 ) ;
F_128 ( F_70 ( V_3 ) , V_317 ) ;
goto V_310;
V_313:
V_41 = F_17 ( V_3 ) ;
if ( F_113 ( V_309 ) -> V_318 == V_41 -> V_279 &&
! ( ( 1 << V_3 -> V_18 ) & ( V_120 | V_119 ) ) ) {
if ( V_39 -> V_222 . V_223 . V_224 || V_39 -> V_222 . V_223 . V_225 )
V_39 -> V_298 = F_67 ( V_309 ) ;
if ( V_39 -> V_222 . V_223 . V_226 || V_39 -> V_222 . V_223 . V_227 )
V_39 -> V_299 = F_14 ( V_309 ) -> V_143 ;
if ( V_39 -> V_222 . V_223 . V_319 || V_39 -> V_222 . V_223 . V_320 )
V_39 -> V_300 = F_147 ( F_14 ( V_309 ) ) ;
if ( V_39 -> V_178 )
V_39 -> V_71 = V_58 ( F_14 ( V_309 ) ) ;
if ( F_114 ( V_3 , V_309 ) ) {
F_153 ( V_309 , V_3 ) ;
V_309 = F_168 ( & V_39 -> V_297 , V_309 ) ;
} else {
F_166 ( V_309 ) ;
V_309 = F_168 ( & V_39 -> V_297 , NULL ) ;
}
}
F_83 ( V_309 ) ;
return 0 ;
...
goto V_323;
F_128 ( V_134 , V_324 ) ;
if ( ! F_170 ( V_7 , sizeof( struct V_112 ) ) )
goto V_323;
V_129 = F_15 ( V_7 ) ;
if ( V_129 -> V_211 < sizeof( struct V_112 ) / 4 )
goto V_325;
if ( ! F_170 ( V_7 , V_129 -> V_211 * 4 ) )
goto V_323;
if ( F_171 ( V_7 , V_94 , V_326 ) )
goto V_327;
V_129 = F_15 ( V_7 ) ;
V_127 = F_14 ( V_7 ) ;
F_113 ( V_7 ) -> V_132 = F_58 ( V_129 -> V_132 ) ;
F_113 ( V_7 ) -> V_318 = ( F_113 ( V_7 ) -> V_132 + V_129 -> V_263 + V_129 -> V_264 +
V_7 -> V_203 - V_129 -> V_211 * 4 ) ;
F_113 ( V_7 ) -> V_247 = F_58 ( V_129 -> V_247 ) ;
F_113 ( V_7 ) -> V_221 = 0 ;
F_113 ( V_7 ) -> V_328 = F_172 ( V_127 ) ;
F_113 ( V_7 ) -> V_329 = 0 ;
V_3 = F_173 ( & V_136 , V_7 , V_129 -> V_28 , V_129 -> V_27 ) ;
if ( ! V_3 )
goto V_330;
V_331:
if ( V_3 -> V_18 == V_139 )
...
#ifdef F_177
struct V_40 * V_41 = F_17 ( V_3 ) ;
if ( ! V_41 -> V_335 . V_336 && V_41 -> V_335 . V_337 )
V_41 -> V_335 . V_336 = F_178 () ;
if ( V_41 -> V_335 . V_336 )
V_219 = V_87 ( V_3 , V_7 ) ;
else
#endif
...
return V_219 ? - 1 : 0 ;
V_330:
if ( ! F_174 ( NULL , V_334 , V_7 ) )
goto V_323;
if ( V_7 -> V_203 < ( V_129 -> V_211 << 2 ) || F_164 ( V_7 ) ) {
V_327:
F_128 ( V_134 , V_316 ) ;
V_325:
F_128 ( V_134 , V_317 ) ;
...
switch ( F_182 ( F_54 ( V_3 ) , V_7 , V_129 ) ) {
case V_341 :
{
struct V_2 * V_342 ;
V_342 = F_131 ( F_49 ( V_7 -> V_135 ) , & V_136 ,
& F_14 ( V_7 ) -> V_26 , V_129 -> V_28 ,
& F_14 ( V_7 ) -> V_24 ,
F_108 ( V_129 -> V_27 ) , F_67 ( V_7 ) ) ;
if ( V_342 != NULL ) {
struct V_265 * V_266 = F_54 ( V_3 ) ;
F_183 ( V_266 , & V_105 ) ;
F_53 ( V_266 ) ;
...
if ( V_7 -> V_321 != V_322 )
return;
if ( ! F_170 ( V_7 , F_185 ( V_7 ) + sizeof( struct V_112 ) ) )
return;
V_127 = F_14 ( V_7 ) ;
V_129 = F_15 ( V_7 ) ;
if ( V_129 -> V_211 < sizeof( struct V_112 ) / 4 )
return;
V_3 = F_139 ( F_49 ( V_7 -> V_135 ) , & V_136 ,
...
static void F_193 ( struct V_348 * V_132 ,
...
F_195 ( V_351 ) ,
V_157 -> V_357 ,
F_196 ( F_197 ( V_132 ) , V_350 ) ,
0 ,
0 ,
0 , V_157 ) ;
}
static void F_198 ( struct V_348 * V_132 , struct V_2 * V_358 , int V_349 )
{
...
( V_358 -> V_18 == V_148 ) ? V_358 -> V_371 : ( V_41 -> V_279 - V_41 -> V_372 ) ,
V_361 ,
F_200 ( V_362 - V_353 ) ,
V_37 -> V_373 ,
F_196 ( F_197 ( V_132 ) , F_201 ( V_358 ) ) ,
V_37 -> V_374 ,
F_202 ( V_358 ) ,
F_203 ( & V_358 -> V_375 ) , V_358 ,
F_195 ( V_37 -> V_376 ) ,
F_195 ( V_37 -> V_377 . V_378 ) ,
( V_37 -> V_377 . V_379 << 1 ) | V_37 -> V_377 . V_380 ,
V_41 -> V_381 ,
V_358 -> V_18 == V_148 ?
( V_364 ? V_364 -> V_382 : 0 ) :
( F_204 ( V_41 ) ? - 1 : V_41 -> V_383 )
) ;
}
static void F_205 ( struct V_348 * V_132 ,
struct V_265 * V_266 , int V_349 )
{
const struct V_4 * V_27 , * V_354 ;
T_9 V_359 , V_360 ;
T_10 V_384 = V_266 -> V_385 - F_206 () ;
V_27 = & V_266 -> V_386 ;
V_354 = & V_266 -> V_387 ;
V_359 = F_108 ( V_266 -> V_388 ) ;
V_360 = F_108 ( V_266 -> V_389 ) ;
F_194 ( V_132 ,
L_5
L_8 ,
V_349 ,
...
V_27 -> V_25 [ 2 ] , V_27 -> V_25 [ 3 ] , V_359 ,
V_266 -> V_390 , 0 , 0 ,
3 , F_200 ( V_384 ) , 0 , 0 , 0 , 0 ,
F_203 ( & V_266 -> V_391 ) , V_266 ) ;
}
static int F_207 ( struct V_348 * V_132 , void * V_392 )
{
struct V_393 * V_394 ;
...
F_198 ( V_132 , V_392 , V_394 -> V_400 ) ;
break;
case V_401 :
F_193 ( V_132 , V_394 -> V_402 , V_392 , V_394 -> V_400 , V_394 -> V_350 ) ;
break;
}
V_142:
return 0 ;
}
int T_11 F_209 ( struct V_134 * V_134 )
{
return F_210 ( V_134 , & V_403 ) ;
}
void F_211 ( struct V_134 * V_134 )
{
F_212 ( V_134 , & V_403 ) ;
}
static void F_213 ( struct V_2 * V_3 , int V_404 )
{
struct V_34 * V_35 = F_5 ( V_3 ) ;
F_214 ( V_3 , F_215 ( struct V_34 , V_292 ) ) ;
V_404 -= F_215 ( struct V_34 , V_292 ) + sizeof( V_35 -> V_292 ) ;
memset ( & V_35 -> V_292 + 1 , 0 , V_404 ) ;
}
static int T_11 F_216 ( struct V_134 * V_134 )
{
return F_217 ( & V_134 -> V_240 . F_17 , V_405 ,
V_406 , V_94 , V_134 ) ;
}
static void T_12 F_218 ( struct V_134 * V_134 )
{
F_219 ( V_134 -> V_240 . F_17 ) ;
}
static void T_12 F_220 ( struct V_407 * V_408 )
{
F_221 ( & V_136 , & V_105 , V_51 ) ;
}
int T_13 F_222 ( void )
{
int V_219 ;
V_219 = F_223 ( & V_409 , V_94 ) ;
if ( V_219 )
goto V_142;
V_219 = F_224 ( & V_410 ) ;
if ( V_219 )
