...
struct V_2 * V_3 = & V_277 [ V_271 -> V_111 ] . V_3 ;
struct V_1 * V_5 = F_1 ( V_3 ) ;
struct V_6 * V_7 = & V_5 -> V_8 -> V_8 ;
if ( V_271 -> V_111 < 0 || V_271 -> V_111 >= V_278 )
return - V_279 ;
if ( ! V_3 -> V_265 )
return - V_89 ;
if ( V_5 -> V_8 -> V_18 == V_253 )
...
V_5 -> V_109 [ V_287 ] . V_45 . V_53 ,
V_5 -> V_109 [ V_287 ] . V_113 ) ;
F_136 ( V_5 -> V_71 ) ;
V_314:
F_137 ( V_5 -> V_245 ) ;
V_299:
