...
{
struct V_45 * V_46 = F_36 ( & V_2 -> V_33 ) ;
struct V_47 * V_48 = V_2 -> V_33 . V_34 ;
struct V_10 * V_11 ;
unsigned int V_49 = 0 ;
int V_6 ;
if ( F_37 ( V_50 ) && V_48 )
...
F_39 ( & V_2 -> V_33 , L_2 ) ;
V_11 = F_40 ( & V_2 -> V_33 , sizeof( * V_11 ) , V_51 ) ;
if ( ! V_11 )
return - V_52 ;
F_41 ( & V_11 -> V_12 ) ;
F_42 ( & V_11 -> V_25 ) ;
V_11 -> V_8 . V_53 = V_46 ? V_46 -> V_54 : - 1 ;
V_11 -> V_8 . V_55 = true ;
