...
{
struct V_1 * V_13 = V_174 ;
return V_13 == F_88 ( V_173 -> V_175 , struct V_1 , V_176 ) ;
}
struct V_172 * F_89 ( struct V_1 * V_13 )
{
T_6 V_177 ;
F_90 ( V_177 ) ;
F_91 ( V_178 , V_177 ) ;
return F_92 ( V_177 , F_87 , V_13 ) ;
}
struct V_172 * F_93 ( struct V_6 * V_7 )
{
return F_89 ( V_7 -> V_102 -> V_103 ) ;
}
void F_94 ( struct V_172 * V_179 )
{
F_95 ( V_179 ) ;
}
struct V_180 * F_96 ( struct V_172 * V_179 ,
T_1 V_60 , struct V_181 * V_182 ,
enum V_183 V_184 , unsigned long V_55 )
{
struct V_185 V_186 ;
if ( V_179 -> V_175 -> V_187 == NULL ) {
F_67 ( L_27 , V_129 ) ;
return NULL ;
}
V_186 . V_60 = V_60 ;
V_186 . V_188 = V_182 -> V_188 ;
V_186 . V_189 = V_182 -> V_189 ;
V_186 . V_190 = V_182 -> V_190 ;
return F_97 ( V_179 , V_182 -> V_191 , V_182 -> V_192 ,
V_184 , V_55 , & V_186 ) ;
}
struct V_180 * F_98 ( struct V_6 * V_7 ,
struct V_172 * V_179 , struct V_181 * V_182 ,
enum V_183 V_184 , unsigned long V_55 )
{
return F_96 ( V_179 , V_7 -> V_60 , V_182 , V_184 , V_55 ) ;
}
struct V_1 * F_99 ( int V_193 )
{
struct V_1 * V_2 ;
F_100 ( & V_194 ) ;
...
int F_102 ( int V_193 , struct V_196 * V_197 )
{
struct V_1 * V_2 ;
struct V_198 * V_199 ;
int V_18 = 0 ;
F_49 ( L_28 , V_129 , V_193 ) ;
if ( ( V_193 != V_200 && V_193 >= V_201 ) ||
! V_197 )
return - V_47 ;
F_100 ( & V_194 ) ;
F_26 (scan, &rio_scans, node) {
if ( V_199 -> V_193 == V_193 ) {
V_18 = - V_202 ;
goto V_95;
}
}
V_199 = F_103 ( sizeof( * V_199 ) , V_25 ) ;
if ( ! V_199 ) {
V_18 = - V_30 ;
goto V_95;
}
...
V_2 -> V_203 = V_197 ;
break;
} else if ( V_193 == V_200 && ! V_2 -> V_203 )
V_2 -> V_203 = V_197 ;
}
F_7 ( & V_199 -> V_41 , & V_204 ) ;
V_95:
F_101 ( & V_194 ) ;
return V_18 ;
}
int F_104 ( int V_193 , struct V_196 * V_197 )
{
struct V_1 * V_2 ;
struct V_198 * V_199 ;
F_49 ( L_28 , V_129 , V_193 ) ;
...
if ( ! F_83 ( V_2 -> V_203 -> V_169 ) ) {
F_101 ( & V_194 ) ;
return - V_205 ;
}
F_101 ( & V_194 ) ;
if ( V_2 -> V_166 >= 0 )
V_18 = V_2 -> V_203 -> V_206 ( V_2 , 0 ) ;
else
V_18 = V_2 -> V_203 -> V_207 ( V_2 , V_208 ) ;
F_84 ( V_2 -> V_203 -> V_169 ) ;
return V_18 ;
}
static void F_106 ( struct V_6 * V_9 )
{
}
...
static void F_108 ( struct V_209 * V_210 )
{
struct V_211 * V_212 ;
V_212 = F_88 ( V_210 , struct V_211 , V_212 ) ;
F_49 ( L_29 ,
V_212 -> V_13 -> V_195 , V_212 -> V_13 -> V_213 ) ;
if ( F_83 ( V_212 -> V_13 -> V_203 -> V_169 ) ) {
V_212 -> V_13 -> V_203 -> V_207 ( V_212 -> V_13 , 0 ) ;
F_84 ( V_212 -> V_13 -> V_203 -> V_169 ) ;
}
}
int F_109 ( void )
{
...
F_26 (port, &rio_mports, node) {
if ( V_2 -> V_166 >= 0 ) {
if ( V_2 -> V_203 && F_83 ( V_2 -> V_203 -> V_169 ) ) {
V_2 -> V_203 -> V_206 ( V_2 , 0 ) ;
F_84 ( V_2 -> V_203 -> V_169 ) ;
}
} else
V_74 ++ ;
...
if ( ! V_74 )
goto V_215;
V_216 = F_110 ( L_30 , 0 , 0 ) ;
if ( ! V_216 ) {
F_67 ( L_31 ) ;
goto V_215;
}
V_212 = F_111 ( V_74 , sizeof *V_212 , V_25 ) ;
if ( ! V_212 ) {
F_67 ( L_32 ) ;
F_112 ( V_216 ) ;
goto V_215;
...
F_100 ( & V_194 ) ;
F_26 (port, &rio_mports, node) {
if ( V_2 -> V_166 < 0 && V_2 -> V_203 ) {
V_212 [ V_74 ] . V_13 = V_2 ;
F_113 ( & V_212 [ V_74 ] . V_212 , F_108 ) ;
F_114 ( V_216 , & V_212 [ V_74 ] . V_212 ) ;
V_74 ++ ;
}
}
F_115 ( V_216 ) ;
...
static int F_116 ( int V_217 )
{
if ( V_218 == 0 || V_218 <= V_217 || V_217 >= V_201 )
return - 1 ;
return V_219 [ V_217 ] ;
}
...
V_2 -> V_195 = V_214 ++ ;
V_2 -> V_166 = F_116 ( V_2 -> V_195 ) ;
V_2 -> V_203 = NULL ;
F_118 ( & V_2 -> V_9 , L_35 , V_2 -> V_195 ) ;
V_2 -> V_9 . V_220 = & V_221 ;
V_21 = F_119 ( & V_2 -> V_9 ) ;
if ( V_21 )
F_120 ( & V_2 -> V_9 , L_36 ,
...
F_121 ( & V_2 -> V_9 , L_37 , V_2 -> V_195 ) ;
F_100 ( & V_194 ) ;
F_7 ( & V_2 -> V_41 , & V_222 ) ;
F_26 (scan, &rio_scans, node) {
if ( V_2 -> V_195 == V_199 -> V_193 ||
V_199 -> V_193 == V_200 ) {
V_2 -> V_203 = V_199 -> V_22 ;
if ( V_2 -> V_195 == V_199 -> V_193 )
break;
}
}
F_101 ( & V_194 ) ;
F_49 ( L_38 , V_129 , V_2 -> V_213 , V_2 -> V_195 ) ;
return 0 ;
}
