...
F_7 ( & V_12 -> V_14 , V_13 ) ;
F_145 ( V_9 -> V_33 ) ;
V_347 = F_149 ( V_311 , V_282 ) ;
if ( V_347 )
F_150 ( V_311 , V_282 ) ;
F_151 ( V_9 -> V_33 , 0x1 , 2 ) ;
F_151 ( V_9 -> V_33 , 0x2 , 2 ) ;
F_151 ( V_9 -> V_33 , V_124 , 5 ) ;
F_151 ( V_9 -> V_33 , V_54 , 5 ) ;
F_150 ( V_348 , V_282 ) ;
F_150 ( V_349 , V_282 ) ;
F_140 ( V_349 , V_282 ) ;
F_150 ( V_349 , V_282 ) ;
V_346 = F_149 ( V_350 , V_282 ) ;
F_140 ( V_349 , V_282 ) ;
if ( V_346 ) {
...
static void F_151 ( T_4 V_351 , T_1 V_20 , unsigned V_352 )
{
T_4 V_282 ;
T_1 V_98 ;
if ( V_352 == 0 )
...
static int F_153 ( T_4 V_227 , T_6 V_20 , int V_356 )
{
int V_99 ;
T_6 V_357 ;
T_4 V_282 ;
...
static void F_154 ( T_4 V_227 , T_6 * V_20 , int V_356 )
{
T_6 V_357 ;
T_4 V_282 ;
F_100 ( V_271 , V_227 + V_245 ) ;
...
F_7 ( & V_12 -> V_14 , V_13 ) ;
F_152 ( V_9 -> V_33 ) ;
V_99 = F_153 ( V_9 -> V_33 , 0xa0 , V_360 ) ;
if ( V_99 ) {
V_359 = 1 ;
goto V_361;
}
V_99 = F_153 ( V_9 -> V_33 , V_358 , V_360 ) ;
if ( V_99 ) {
V_359 = 2 ;
goto V_361;
}
F_152 ( V_9 -> V_33 ) ;
V_99 = F_153 ( V_9 -> V_33 , 0xa1 , V_360 ) ;
if ( V_99 ) {
V_359 = 3 ;
goto V_361;
}
F_154 ( V_9 -> V_33 , V_20 , V_362 ) ;
V_361:
F_8 ( & V_12 -> V_14 , V_13 ) ;
return V_359 ;
}
