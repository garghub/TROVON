...
F_33 ( V_14 , V_67 , V_63 [ V_55 ] . V_68 ,
! ( V_16 [ 2 ] & 1 ) ) ;
V_18 -> V_51 = V_49 ;
} else if ( V_55 < 0 || V_63 [ V_55 ] . V_64 == V_69 ) {
unsigned long V_48 = V_49 ;
if ( V_18 -> V_70 == V_16 [ 2 ] &&
F_29 ( V_48 , V_18 -> V_51 +
F_28 ( V_71 ) ) ) {
...
return;
if ( V_55 >= 0 ) {
F_33 ( V_14 , V_67 , V_63 [ V_55 ] . V_68 , 1 ) ;
F_33 ( V_14 , V_67 , V_63 [ V_55 ] . V_68 , 0 ) ;
} else {
int V_75 = 1 ;
if ( V_58 != V_59 ) {
V_75 = ( V_57 & 0x07 ) + 1 ;
...
} else if ( V_63 [ V_55 ] . V_64 == V_78 ) {
signed char V_79 = V_63 [ V_55 ] . V_68 >> 8 ;
signed char V_80 = V_63 [ V_55 ] . V_68 & 255 ;
int V_50 = F_26 ( V_18 ) ;
if ( V_79 )
F_36 ( V_14 , V_81 , V_79 * V_50 ) ;
if ( V_80 )
F_36 ( V_14 , V_82 , V_80 * V_50 ) ;
V_18 -> V_51 = V_49 ;
} else {
F_19 ( & V_18 -> V_2 -> V_14 , L_16 ,
V_63 [ V_55 ] . V_64 ) ;
return;
}
F_37 ( V_14 ) ;
...
int V_60 ;
V_54 -> V_90 [ 0 ] = F_46 ( V_67 ) | F_46 ( V_91 ) ;
V_54 -> V_92 [ F_47 ( V_93 ) ] = F_46 ( V_94 ) |
F_46 ( V_95 ) | F_46 ( V_96 ) | F_46 ( V_97 ) ;
V_54 -> V_98 [ 0 ] = F_46 ( V_81 ) | F_46 ( V_82 ) ;
for ( V_60 = 0 ; V_63 [ V_60 ] . V_64 != V_65 ; V_60 ++ )
if ( V_63 [ V_60 ] . V_64 == V_66 ||
V_63 [ V_60 ] . V_64 == V_69 )
F_48 ( V_63 [ V_60 ] . V_68 , V_54 -> V_92 ) ;
F_49 ( V_54 , V_18 ) ;
V_54 -> V_99 = F_13 ;
V_54 -> V_100 = F_15 ;
V_54 -> V_101 = V_18 -> V_102 ;
V_54 -> V_103 = V_18 -> V_104 ;
F_50 ( V_18 -> V_4 , & V_54 -> V_105 ) ;
V_54 -> V_14 . V_106 = & V_18 -> V_2 -> V_14 ;
}
...
V_30 -> V_99 = F_16 ;
V_30 -> V_100 = F_17 ;
V_30 -> V_112 = V_18 -> V_113 ;
V_30 -> V_114 = V_18 -> V_115 ;
F_50 ( V_18 -> V_4 , & V_30 -> V_116 ) ;
V_30 -> V_14 . V_106 = & V_18 -> V_2 -> V_14 ;
}
...
int V_117 , V_118 ;
F_53 ( & V_18 -> V_37 ) ;
V_117 = F_54 ( V_4 , V_18 -> V_119 -> V_120 ) ;
V_118 = F_55 ( V_4 , V_117 , F_56 ( V_117 ) ) ;
V_118 = ( V_118 > V_86 ) ? V_86 : V_118 ;
F_57 ( V_18 -> V_23 , V_4 , V_117 , V_18 -> V_53 ,
V_118 , F_38 , V_18 ,
V_18 -> V_119 -> V_121 ) ;
V_18 -> V_23 -> V_122 = V_18 -> V_87 ;
V_18 -> V_23 -> V_123 |= V_124 ;
V_117 = F_58 ( V_4 , V_18 -> V_125 -> V_120 ) ;
V_118 = F_55 ( V_4 , V_117 , F_56 ( V_117 ) ) ;
V_118 = ( V_118 > V_86 ) ? V_86 : V_118 ;
F_57 ( V_18 -> V_40 , V_4 , V_117 , V_18 -> V_88 ,
V_118 , F_18 , V_18 ,
V_18 -> V_125 -> V_121 ) ;
V_18 -> V_40 -> V_122 = V_18 -> V_89 ;
V_18 -> V_40 -> V_123 |= V_124 ;
if ( ( F_22 ( V_18 , 0x8004 , V_126 ) ) ||
( F_22 ( V_18 , 0x8007 , V_127 ) ) ) {
F_9 ( & V_18 -> V_2 -> V_14 ,
L_21 ) ;
return - V_26 ;
}
...
const struct V_128 * V_105 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
struct V_129 * V_130 = V_2 -> V_131 ;
struct V_132 * V_119 , * V_125 ;
struct V_133 * type = (struct V_133 * ) V_105 -> V_134 ;
struct V_18 * V_18 ;
struct V_27 * V_27 ;
struct V_29 * V_29 ;
int V_19 = - V_135 ;
if ( V_130 -> V_8 . V_136 != 2 ) {
V_19 ( L_22 , V_25 ) ;
return - V_137 ;
}
V_119 = & V_130 -> V_138 [ 0 ] . V_8 ;
V_125 = & V_130 -> V_138 [ 1 ] . V_8 ;
if ( ! F_60 ( V_119 ) ) {
V_19 ( L_23 , V_25 ) ;
return - V_137 ;
}
if ( F_61 ( V_119 -> V_139 ) == 0 ) {
V_19 ( L_24 , V_25 ) ;
return - V_137 ;
}
...
V_18 -> V_30 = V_29 ;
V_18 -> V_2 = V_2 ;
F_64 ( V_4 , V_18 -> V_115 , sizeof( V_18 -> V_115 ) ) ;
F_65 ( V_18 -> V_104 , V_18 -> V_115 ,
sizeof( V_18 -> V_104 ) ) ;
F_66 ( V_18 -> V_115 , L_25 , sizeof( V_18 -> V_115 ) ) ;
F_66 ( V_18 -> V_104 , L_26 , sizeof( V_18 -> V_104 ) ) ;
if ( V_4 -> V_5 )
F_65 ( V_18 -> V_113 , V_4 -> V_5 ,
sizeof( V_18 -> V_113 ) ) ;
if ( V_4 -> V_6 )
snprintf ( V_18 -> V_113 , sizeof( V_18 -> V_113 ) ,
L_27 , V_18 -> V_113 , V_4 -> V_6 ) ;
if ( ! strlen ( V_18 -> V_113 ) )
snprintf ( V_18 -> V_113 , sizeof( V_18 -> V_113 ) ,
V_142 L_28 ,
F_61 ( V_18 -> V_4 -> V_143 . V_144 ) ,
F_61 ( V_18 -> V_4 -> V_143 . V_145 ) ) ;
snprintf ( V_18 -> V_102 , sizeof( V_18 -> V_102 ) ,
L_29 , V_18 -> V_113 ) ;
V_29 -> V_146 = V_147 ;
if ( type ) {
if ( type -> V_148 )
V_29 -> V_146 = type -> V_148 ;
else if ( type -> V_149 )
V_29 -> V_146 = type -> V_149 ( V_2 ) ;
}
F_51 ( V_18 ) ;
F_67 ( & V_18 -> V_20 ) ;
V_19 = F_52 ( V_18 ) ;
...
if ( V_19 )
goto V_150;
V_18 -> V_30 -> V_27 -> V_151 [ V_152 ] = V_74 ;
if ( V_153 ) {
V_27 = F_69 () ;
if ( ! V_27 ) {
V_19 = - V_135 ;
