...
return 0 ;
if ( F_30 ( V_41 . V_48 ) || F_31 ( V_41 . V_48 ) )
return 0 ;
V_39 = 1 ;
if ( fflush ( stdout ) ) {
fprintf ( V_15 , L_30 , strerror ( V_30 ) ) ;
goto V_49;
}
if ( ferror ( stdout ) ) {
fprintf ( V_15 , L_31 ) ;
...
if ( fclose ( stdout ) ) {
fprintf ( V_15 , L_32 , strerror ( V_30 ) ) ;
goto V_49;
}
V_39 = 0 ;
V_49:
...
static void F_32 ( int V_10 , const char * * V_9 )
{
const char * V_6 = V_9 [ 0 ] ;
unsigned int V_23 ;
static const char V_50 [] = V_51 ;
if ( sizeof( V_50 ) > 1 ) {
V_23 = strlen ( V_9 [ 0 ] ) - strlen ( V_50 ) ;
if ( V_23 > 0 && ! strcmp ( V_9 [ 0 ] + V_23 , V_50 ) ) {
char * V_52 = F_33 ( V_9 [ 0 ] ) ;
V_9 [ 0 ] = V_6 = V_52 ;
V_52 [ V_23 ] = '\0' ;
}
}
...
static void F_34 ( const char * * V_9 )
{
struct V_36 V_6 = V_53 ;
const char * V_54 ;
int V_39 ;
F_35 ( & V_6 , L_34 , V_9 [ 0 ] ) ;
V_54 = V_9 [ 0 ] ;
...
static int F_39 ( int * V_27 , const char * * * V_9 )
{
int V_57 = 0 ;
while ( 1 ) {
F_32 ( * V_27 , * V_9 ) ;
F_34 ( * V_9 ) ;
if ( V_57 || ! F_18 ( V_27 , V_9 ) )
break;
V_57 = 1 ;
}
return V_57 ;
