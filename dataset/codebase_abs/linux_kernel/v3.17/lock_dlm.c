...
F_64 ( & V_81 -> V_122 , V_142 ,
V_143 ) ;
goto V_135;
}
F_30 ( V_123 , & V_81 -> V_122 ) ;
F_17 ( V_144 , & V_81 -> V_122 ) ;
memset ( V_81 -> V_130 , 0 , V_81 -> V_127 * sizeof( T_5 ) ) ;
memset ( V_81 -> V_128 , 0 , V_81 -> V_127 * sizeof( T_5 ) ) ;
F_52 ( & V_81 -> V_120 ) ;
...
static int F_65 ( struct V_88 * V_89 , struct V_145 * V_146 ,
int V_147 )
{
struct V_80 * V_81 = & V_89 -> V_82 ;
T_5 * V_148 = NULL ;
...
return 0 ;
V_151 = V_150 + V_156 ;
V_148 = F_67 ( V_151 , sizeof( T_5 ) , V_153 ) ;
V_149 = F_67 ( V_151 , sizeof( T_5 ) , V_153 ) ;
if ( ! V_148 || ! V_149 ) {
F_68 ( V_148 ) ;
F_68 ( V_149 ) ;
return - V_154 ;
...
static void F_69 ( struct V_80 * V_81 )
{
F_68 ( V_81 -> V_126 ) ;
F_68 ( V_81 -> V_130 ) ;
F_68 ( V_81 -> V_128 ) ;
...
static void F_71 ( void * V_27 , struct V_145 * V_155 )
{
struct V_88 * V_89 = V_27 ;
struct V_80 * V_81 = & V_89 -> V_82 ;
...
if ( ! F_4 ( V_161 , & V_81 -> V_122 ) )
F_73 ( V_162 , & V_89 -> V_113 , 0 ) ;
F_30 ( V_142 , & V_81 -> V_122 ) ;
F_74 () ;
F_75 ( & V_81 -> V_122 , V_142 ) ;
F_52 ( & V_81 -> V_120 ) ;
}
static void F_76 ( struct V_88 * V_89 , unsigned int V_157 ,
unsigned int V_149 )
{
struct V_80 * V_81 = & V_89 -> V_82 ;
if ( F_4 ( V_163 , & V_81 -> V_122 ) )
return;
if ( V_157 == V_81 -> V_160 )
return;
F_51 ( & V_81 -> V_120 ) ;
...
F_53 ( V_89 , L_37 , V_157 ,
V_149 == V_164 ? L_38 : L_39 ) ;
V_81 -> V_128 [ V_157 ] = V_149 ;
if ( ! F_4 ( V_161 , & V_81 -> V_122 ) )
F_73 ( V_162 , & V_89 -> V_113 ,
V_149 == V_164 ? V_165 : 0 ) ;
F_52 ( & V_81 -> V_120 ) ;
}
static int F_77 ( struct V_88 * V_89 , const char * V_166 )
{
struct V_80 * V_81 = & V_89 -> V_82 ;
char V_167 [ V_168 ] ;
const char * V_169 ;
...
V_169 ++ ;
V_79 = V_172 | V_173 ;
error = F_80 ( V_169 , V_167 , V_79 , V_35 ,
& V_174 , V_89 , & V_170 ,
& V_81 -> V_87 ) ;
if ( error ) {
...
F_53 ( V_89 , L_42 ) ;
F_69 ( V_81 ) ;
F_17 ( V_163 , & V_81 -> V_122 ) ;
return 0 ;
}
if ( ! F_4 ( V_175 , & V_89 -> V_92 ) ) {
F_42 ( V_89 , L_43 ) ;
error = - V_140 ;
goto V_176;
}
...
V_81 -> V_177 = ! ! F_4 ( V_123 , & V_81 -> V_122 ) ;
F_30 ( V_175 , & V_89 -> V_92 ) ;
F_74 () ;
F_75 ( & V_89 -> V_92 , V_175 ) ;
return 0 ;
V_176:
F_81 ( V_81 -> V_87 , 2 ) ;
V_171:
