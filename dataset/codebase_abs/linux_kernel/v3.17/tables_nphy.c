...
struct V_218 * F_23 (
struct V_54 * V_55 , bool V_102 , bool V_219 )
{
struct V_218 * V_220 ;
T_4 V_221 ;
...
V_221 = 0 ;
V_220 = & V_223 [ V_102 ] [ V_221 ] ;
if ( V_102 && V_55 -> V_104 . V_192 >= 6 ) {
if ( V_55 -> V_104 . V_195 == 11 &&
! F_24 ( V_55 ) )
V_220 -> V_224 = 0x2d ;
} else if ( ! V_102 && V_55 -> V_104 . V_192 >= 5 ) {
static const int V_225 [] = { 0x0062 , 0x0064 , 0x006a , 0x106a ,
0x106c , 0x1074 , 0x107c , 0x207c } ;
T_4 V_226 = V_55 -> V_55 -> V_94 -> V_101 . V_103 . V_226 ;
if ( V_219 ) {
V_220 -> V_227 [ 0 ] &= ~ 0x4000 ;
V_220 -> V_227 [ 1 ] &= ~ 0x4000 ;
V_220 -> V_227 [ 2 ] &= ~ 0x4000 ;
V_220 -> V_227 [ 3 ] &= ~ 0x4000 ;
V_220 -> V_228 &= ~ 0x4000 ;
}
if ( V_226 > 7 )
V_226 = 3 ;
V_220 -> V_224 = V_225 [ V_226 ] ;
} else if ( V_102 && V_55 -> V_104 . V_192 == 4 && V_219 ) {
V_220 -> V_227 [ 0 ] &= ~ 0x4000 ;
V_220 -> V_227 [ 1 ] &= ~ 0x4000 ;
V_220 -> V_227 [ 2 ] &= ~ 0x4000 ;
V_220 -> V_227 [ 3 ] &= ~ 0x4000 ;
V_220 -> V_228 &= ~ 0x4000 ;
V_220 -> V_227 [ 0 ] |= 0x1000 ;
V_220 -> V_227 [ 1 ] |= 0x1000 ;
V_220 -> V_227 [ 2 ] |= 0x1000 ;
V_220 -> V_227 [ 3 ] |= 0x1000 ;
V_220 -> V_228 |= 0x1000 ;
}
return V_220 ;
}
const struct V_229 * F_25 (
struct V_54 * V_55 , V_71 V_230 , T_4 V_231 )
{
const struct V_229 * V_220 ;
T_4 T_2 , V_68 ;
switch ( V_231 ) {
case 0 :
V_220 = V_232 ;
...
break;
default:
F_15 ( V_55 -> V_99 , L_6 , V_231 ) ;
return NULL ;
}
for ( V_68 = 0 ; V_68 < T_2 ; V_68 ++ ) {
if ( V_220 [ V_68 ] . V_230 == V_230 )
return & V_220 [ V_68 ] ;
}
return NULL ;
}
