...
T_3 V_72 ;
int V_73 ;
V_40 = F_67 ( sizeof( * V_40 ) , V_65 , V_74 ) ;
if ( ! V_40 ) {
V_73 = - V_66 ;
goto V_75;
}
...
V_40 -> V_58 . V_6 = V_69 ;
V_40 -> V_58 . V_83 = V_74 ;
V_40 -> V_58 . V_84 = sizeof( struct V_7 ) ;
V_40 -> V_58 . V_85 = V_86 ;
V_40 -> V_58 . V_54 = V_40 ;
V_73 = F_69 ( & V_40 -> V_58 ) ;
if ( V_73 )
...
V_40 -> V_46 = F_73 ( F_41 , & V_40 -> V_76 , V_74 ) ;
if ( ! V_40 -> V_46 ) {
V_73 = - V_66 ;
goto V_87;
}
...
V_57 -> V_99 = & V_100 ;
V_57 -> V_101 = V_40 ;
V_57 -> V_102 = V_40 -> V_46 ;
sprintf ( V_57 -> V_103 , L_1 , V_40 -> V_41 ) ;
F_85 ( V_57 ) ;
return 0 ;
V_90:
F_53 ( V_40 -> V_46 ) ;
...
if ( V_36 != V_39 )
continue;
F_91 ( & V_23 -> V_21 , V_105 , V_33 ) ;
V_23 -> V_21 . V_106 = F_20 ;
}
V_97 = F_92 ( 0 , L_5 ) ;
if ( V_97 < 0 )
return V_97 ;
for ( V_63 = 0 ; V_63 < V_107 ; V_63 ++ ) {
if ( F_66 () ) {
F_93 ( V_97 , L_5 ) ;
return - V_108 ;
}
...
F_78 ( & V_76 ) ;
while ( ! F_96 ( & V_91 ) ) {
V_40 = F_97 ( V_91 . V_29 , struct V_40 , V_27 ) ;
F_50 ( V_40 ) ;
}
F_80 ( & V_76 ) ;
}
