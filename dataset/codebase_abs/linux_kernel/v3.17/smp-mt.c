...
static void F_43 ( int V_21 , struct V_43 * V_44 )
{
struct V_45 * V_46 = F_44 ( V_44 ) ;
F_28 () ;
F_45 ( V_47 ) ;
F_29 ( V_21 ) ;
F_46 ( ( unsigned long ) & V_48 ) ;
F_22 ( ( F_21 () & ~ V_19 ) | V_17 ) ;
F_23 ( 0 ) ;
F_13 ( F_12 () | V_11 ) ;
F_47 ( F_48 ( V_44 ) ) ;
...
static void T_1 F_56 ( unsigned int V_57 )
{
F_57 () ;
}
