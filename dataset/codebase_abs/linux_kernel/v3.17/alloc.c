...
long F_48 ( struct V_1 * V_2 , unsigned V_54 , bool V_55 )
{
F_49 ( V_56 ) ;
struct V_3 * V_4 ;
long V_18 ;
if ( F_41 ( & V_2 -> free [ V_57 ] , V_18 ) ||
F_41 ( & V_2 -> free [ V_54 ] , V_18 ) )
goto V_58;
if ( ! V_55 ) {
F_50 ( V_2 , V_54 ) ;
return - 1 ;
...
do {
F_51 ( & V_2 -> V_7 -> V_51 , & V_56 ,
V_59 ) ;
F_13 ( & V_2 -> V_7 -> V_20 ) ;
F_52 () ;
F_9 ( & V_2 -> V_7 -> V_20 ) ;
} while ( ! F_41 ( & V_2 -> free [ V_57 ] , V_18 ) &&
! F_41 ( & V_2 -> free [ V_54 ] , V_18 ) );
F_53 ( & V_2 -> V_7 -> V_51 , & V_56 ) ;
V_58:
F_54 ( V_2 -> V_60 ) ;
F_55 ( V_2 , V_54 ) ;
if ( F_56 ( V_2 -> V_7 ) ) {
...
long V_17 ;
unsigned V_62 ;
for ( V_61 = 0 ; V_61 < F_57 ( V_2 ) * 2 ; V_61 ++ )
F_16 ( V_2 -> F_57 [ V_61 ] == ( V_63 ) V_18 ) ;
...
void F_63 ( struct V_10 * V_11 , struct V_65 * V_66 )
{
unsigned V_17 ;
for ( V_17 = 0 ; V_17 < F_64 ( V_66 ) ; V_17 ++ )
F_62 ( F_65 ( V_11 , V_66 , V_17 ) ,
F_66 ( V_11 , V_66 , V_17 ) ) ;
}
int F_67 ( struct V_10 * V_11 , unsigned V_54 ,
struct V_65 * V_66 , int V_40 , bool V_55 )
{
int V_17 ;
F_19 ( & V_11 -> V_20 ) ;
F_16 ( ! V_40 || V_40 > V_11 -> V_67 || V_40 > 8 ) ;
F_68 ( V_66 ) ;
for ( V_17 = 0 ; V_17 < V_40 ; V_17 ++ ) {
struct V_1 * V_2 = V_11 -> V_68 [ V_17 ] ;
long V_4 = F_48 ( V_2 , V_54 , V_55 ) ;
if ( V_4 == - 1 )
goto V_69;
V_66 -> V_70 [ V_17 ] = F_69 ( V_2 -> V_28 [ V_4 ] . V_6 ,
F_43 ( V_11 , V_4 ) ,
V_2 -> V_15 . V_71 ) ;
F_70 ( V_66 , V_17 + 1 ) ;
}
...
int F_72 ( struct V_10 * V_11 , unsigned V_54 ,
struct V_65 * V_66 , int V_40 , bool V_55 )
{
int V_5 ;
F_9 ( & V_11 -> V_20 ) ;
V_5 = F_67 ( V_11 , V_54 , V_66 , V_40 , V_55 ) ;
F_13 ( & V_11 -> V_20 ) ;
return V_5 ;
}
static struct V_72 * F_73 ( struct V_10 * V_11 ,
...
if ( ! F_75 ( & V_5 -> V_77 , V_73 ) )
goto V_78;
else if ( V_5 -> V_79 == V_74 )
V_76 = V_5 ;
V_5 = V_76 ? : F_76 ( & V_11 -> V_80 ,
struct V_72 , V_81 ) ;
V_78:
if ( ! V_5 -> V_82 && F_64 ( V_75 ) ) {
V_5 -> V_82 = V_11 -> V_15 . V_16 ;
F_77 ( & V_5 -> V_77 , V_75 ) ;
F_68 ( V_75 ) ;
}
if ( ! V_5 -> V_82 )
...
bool F_78 ( struct V_10 * V_11 , struct V_65 * V_66 , unsigned V_12 ,
unsigned V_74 , unsigned V_83 , bool V_55 )
{
struct V_72 * V_4 ;
F_79 (key) V_75 ;
unsigned V_17 ;
F_68 ( & V_75 . V_77 ) ;
F_80 ( & V_11 -> V_84 ) ;
while ( ! ( V_4 = F_73 ( V_11 , V_66 , V_74 , & V_75 . V_77 ) ) ) {
unsigned V_85 = V_83
? V_86
: V_57 ;
F_81 ( & V_11 -> V_84 ) ;
if ( F_72 ( V_11 , V_85 , & V_75 . V_77 , 1 , V_55 ) )
return false ;
F_80 ( & V_11 -> V_84 ) ;
}
if ( F_64 ( & V_75 . V_77 ) )
F_71 ( V_11 , & V_75 . V_77 ) ;
for ( V_17 = 0 ; V_17 < F_64 ( & V_4 -> V_77 ) ; V_17 ++ )
F_82 ( F_83 ( V_11 , & V_4 -> V_77 , V_17 ) ) ;
for ( V_17 = 0 ; V_17 < F_64 ( & V_4 -> V_77 ) ; V_17 ++ )
V_66 -> V_70 [ V_17 ] = V_4 -> V_77 . V_70 [ V_17 ] ;
V_12 = F_12 ( V_12 , V_4 -> V_82 ) ;
F_84 ( V_66 , F_85 ( V_66 ) + V_12 ) ;
F_86 ( V_66 , V_12 ) ;
F_70 ( V_66 , F_64 ( & V_4 -> V_77 ) ) ;
F_87 ( & V_4 -> V_81 , & V_11 -> V_80 ) ;
F_88 ( & V_4 -> V_77 , V_66 ) ;
V_4 -> V_79 = V_74 ;
V_4 -> V_82 -= V_12 ;
for ( V_17 = 0 ; V_17 < F_64 ( & V_4 -> V_77 ) ; V_17 ++ ) {
F_89 ( & V_4 -> V_77 , V_17 , F_90 ( & V_4 -> V_77 , V_17 ) + V_12 ) ;
F_91 ( V_12 ,
& F_65 ( V_11 , & V_4 -> V_77 , V_17 ) -> V_87 ) ;
}
if ( V_4 -> V_82 < V_11 -> V_15 . V_88 )
V_4 -> V_82 = 0 ;
if ( V_4 -> V_82 )
for ( V_17 = 0 ; V_17 < F_64 ( & V_4 -> V_77 ) ; V_17 ++ )
F_22 ( & F_66 ( V_11 , & V_4 -> V_77 , V_17 ) -> V_25 ) ;
F_81 ( & V_11 -> V_84 ) ;
return true ;
}
...
struct V_72 * V_4 = F_98 ( sizeof( * V_4 ) , V_49 ) ;
if ( ! V_4 )
return - V_89 ;
F_99 ( & V_4 -> V_81 , & V_11 -> V_80 ) ;
}
return 0 ;
}
int F_100 ( struct V_1 * V_2 )
{
struct V_90 * V_66 = F_101 ( F_39 ,
V_2 , L_1 ) ;
if ( F_102 ( V_66 ) )
return F_103 ( V_66 ) ;
V_2 -> V_60 = V_66 ;
