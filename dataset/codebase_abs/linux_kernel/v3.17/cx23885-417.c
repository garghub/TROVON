...
static int F_45 ( struct V_164 * V_164 , void * V_86 , T_4 V_123 )
{
struct V_143 * V_144 = V_164 -> V_165 ;
struct V_1 * V_2 = V_144 -> V_2 ;
unsigned int V_93 ;
for ( V_93 = 0 ; V_93 < F_46 ( V_167 ) ; V_93 ++ )
if ( V_123 & V_167 [ V_93 ] . V_123 )
break;
if ( V_93 == F_46 ( V_167 ) )
return - V_159 ;
V_2 -> V_122 = V_167 [ V_93 ] ;
F_47 ( & V_2 -> V_168 ) ;
F_48 ( V_2 , V_123 ) ;
F_49 ( & V_2 -> V_168 ) ;
return 0 ;
}
static int F_50 ( struct V_164 * V_164 , void * V_86 ,
struct V_169 * V_93 )
{
...
static int F_52 ( struct V_164 * V_164 , void * V_86 , unsigned int * V_93 )
{
return F_53 ( V_164 , V_86 , V_93 ) ;
}
static int F_54 ( struct V_164 * V_164 , void * V_86 , unsigned int V_93 )
{
return F_55 ( V_164 , V_86 , V_93 ) ;
}
static int F_56 ( struct V_164 * V_164 , void * V_86 ,
struct V_170 * V_171 )
{
struct V_143 * V_144 = V_164 -> V_165 ;
struct V_1 * V_2 = V_144 -> V_2 ;
...
if ( 0 != V_171 -> V_174 )
return - V_159 ;
strcpy ( V_171 -> V_175 , L_76 ) ;
F_57 ( V_2 , V_176 , V_177 , V_171 ) ;
F_2 ( 1 , L_77 , V_171 -> type ) ;
return 0 ;
}
...
struct V_143 * V_144 = V_164 -> V_165 ;
struct V_1 * V_2 = V_144 -> V_2 ;
struct V_189 * V_190 = & V_2 -> V_125 ;
F_67 ( V_188 -> V_191 , V_2 -> V_175 , sizeof( V_188 -> V_191 ) ) ;
F_67 ( V_188 -> V_192 , V_193 [ V_190 -> V_2 -> V_194 ] . V_175 ,
sizeof( V_188 -> V_192 ) ) ;
sprintf ( V_188 -> V_195 , L_78 , F_68 ( V_2 -> V_118 ) ) ;
V_188 -> V_196 =
V_197 |
V_198 |
V_199 |
...
if ( V_180 -> V_174 != 0 )
return - V_159 ;
F_67 ( V_180 -> V_202 , L_79 , sizeof( V_180 -> V_202 ) ) ;
V_180 -> V_203 = V_204 ;
return 0 ;
}
...
struct V_143 * V_144 = V_164 -> V_165 ;
struct V_1 * V_2 = V_144 -> V_2 ;
V_180 -> V_206 . V_207 . V_203 = V_204 ;
V_180 -> V_206 . V_207 . V_208 = 0 ;
V_180 -> V_206 . V_207 . V_209 =
V_2 -> V_125 . V_146 * V_2 -> V_125 . V_148 ;
V_180 -> V_206 . V_207 . V_210 = 0 ;
V_180 -> V_206 . V_207 . V_127 = V_2 -> V_125 . V_127 ;
V_180 -> V_206 . V_207 . V_126 = V_2 -> V_125 . V_126 ;
V_180 -> V_206 . V_207 . V_154 = V_144 -> V_211 . V_154 ;
F_2 ( 1 , L_80 ,
V_2 -> V_125 . V_127 , V_2 -> V_125 . V_126 , V_144 -> V_211 . V_154 ) ;
return 0 ;
}
...
V_180 -> V_206 . V_207 . V_210 = 0 ;
F_2 ( 1 , L_82 ,
V_180 -> V_206 . V_207 . V_127 , V_180 -> V_206 . V_207 . V_126 , V_180 -> V_206 . V_207 . V_154 ) ;
return 0 ;
}
...
{
struct V_143 * V_144 = V_164 -> V_165 ;
return F_74 ( & V_144 -> V_211 , V_213 ) ;
}
static int F_75 ( struct V_164 * V_164 , void * V_86 ,
struct V_214 * V_213 )
{
struct V_143 * V_144 = V_164 -> V_165 ;
return F_76 ( & V_144 -> V_211 , V_213 ) ;
}
static int F_77 ( struct V_164 * V_164 , void * V_86 ,
struct V_214 * V_213 )
{
struct V_143 * V_144 = V_164 -> V_165 ;
return F_78 ( & V_144 -> V_211 , V_213 ) ;
}
static int F_79 ( struct V_164 * V_164 , void * V_86 , struct V_214 * V_215 )
{
struct V_143 * V_144 = V_86 ;
return F_80 ( & V_144 -> V_211 , V_215 , V_164 -> V_216 & V_217 ) ;
}
static int F_81 ( struct V_164 * V_164 , void * V_86 ,
enum V_218 V_93 )
{
struct V_143 * V_144 = V_164 -> V_165 ;
return F_82 ( & V_144 -> V_211 ) ;
}
static int F_83 ( struct V_164 * V_164 , void * V_86 , enum V_218 V_93 )
{
struct V_143 * V_144 = V_164 -> V_165 ;
return F_84 ( & V_144 -> V_211 ) ;
}
...
struct V_143 * V_144 = V_86 ;
struct V_1 * V_2 = V_144 -> V_2 ;
if ( V_180 -> V_220 != V_221 )
return - V_159 ;
return F_86 ( & V_2 -> V_128 , 0 , V_180 , V_222 ) ;
}
...
return - V_159 ;
V_213 = V_2 -> V_128 ;
V_100 = F_86 ( & V_213 , 0 , V_180 , V_224 ) ;
if ( V_100 == 0 ) {
V_100 = F_28 ( V_2 , F_19 ,
& V_2 -> V_128 , & V_213 ) ;
V_2 -> V_128 = V_213 ;
...
return - V_159 ;
V_213 = V_2 -> V_128 ;
V_100 = F_86 ( & V_213 , 0 , V_180 , V_225 ) ;
return V_100 ;
}
...
struct V_1 * V_2 = V_144 -> V_2 ;
char V_175 [ 32 + 2 ] ;
snprintf ( V_175 , sizeof( V_175 ) , L_83 , V_2 -> V_175 ) ;
F_20 ( V_226
L_84 ,
V_2 -> V_175 ) ;
F_57 ( V_2 , V_227 , V_228 ) ;
F_90 ( & V_2 -> V_128 , V_175 ) ;
F_20 ( V_226
L_85 ,
V_2 -> V_175 ) ;
return 0 ;
...
if ( V_144 -> V_211 . V_240 )
F_84 ( & V_144 -> V_211 ) ;
if ( V_144 -> V_211 . V_241 )
F_101 ( & V_144 -> V_211 ) ;
F_102 ( & V_144 -> V_211 ) ;
V_164 -> V_165 = NULL ;
F_103 ( V_144 ) ;
...
return F_106 ( & V_144 -> V_211 , V_90 , V_142 , V_242 , 0 ,
V_164 -> V_216 & V_217 ) ;
}
...
struct V_1 * V_2 = V_144 -> V_2 ;
F_2 ( 2 , L_86 , V_4 ) ;
return F_108 ( V_164 , & V_144 -> V_211 , V_244 ) ;
}
...
struct V_1 * V_2 = V_144 -> V_2 ;
F_2 ( 2 , L_1 , V_4 ) ;
return F_110 ( & V_144 -> V_211 , V_246 ) ;
}
...
return NULL ;
* V_251 = * V_250 ;
snprintf ( V_251 -> V_175 , sizeof( V_251 -> V_175 ) , L_87 ,
V_193 [ V_190 -> V_2 -> V_194 ] . V_175 , type ) ;
V_251 -> V_252 = & V_2 -> V_252 ;
V_251 -> V_253 = F_114 ;
return V_251 ;
}
...
struct V_189 * V_190 = & V_2 -> V_125 ;
F_2 ( 1 , L_1 , V_4 ) ;
if ( V_193 [ V_2 -> V_194 ] . V_255 != V_256 )
return V_100 ;
V_2 -> V_122 = V_167 [ 0 ] ;
if ( V_2 -> V_122 . V_123 & V_124 )
V_190 -> V_126 = 480 ;
...
V_2 -> V_247 = F_115 ( V_190 ,
V_2 -> V_118 , & V_259 , L_88 ) ;
F_119 ( V_2 -> V_247 , V_2 ) ;
V_100 = F_120 ( V_2 -> V_247 ,
V_260 , - 1 ) ;
if ( V_100 < 0 ) {
F_20 ( V_226 L_89 , V_2 -> V_175 ) ;
return V_100 ;
}
F_20 ( V_226 L_90 ,
V_2 -> V_175 , F_121 ( V_2 -> V_247 ) ) ;
F_29 ( V_2 , 0 ) ;
return 0 ;
}
