...
struct V_52 * V_53 )
{
return F_13 ( V_2 , F_55 ,
V_53 , NULL ) ;
}
struct V_82 * F_57 ( void )
{
...
int __weak F_59 ( struct V_84 * V_85 ,
void * V_29 )
{
return 1 ;
}
void __weak F_60 ( int V_86 ,
struct V_87 * V_88 )
{
}
int F_61 ( void )
{
static T_3 V_89 [] = L_11 ;
T_8 V_90 ;
T_1 V_91 [ 3 ] ;
struct V_92 V_93 = {
. V_94 = V_89 ,
. V_95 = 1 ,
. V_96 . V_97 = sizeof( V_91 ) ,
. V_96 . V_98 = V_91 ,
} ;
V_91 [ V_99 ] = V_100 ;
V_91 [ V_101 ] = 1 ;
V_91 [ V_102 ] = 0 ;
if ( F_51 ( F_62 ( NULL , L_12 , & V_90 ) )
|| F_51 ( F_63 ( V_90 , & V_93 ) ) )
return - V_81 ;
else {
F_22 ( V_93 . V_103 . V_98 ) ;
return 0 ;
}
}
