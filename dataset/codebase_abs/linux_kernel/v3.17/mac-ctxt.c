...
! V_151 ) {
T_3 V_164 ;
V_164 = V_4 -> V_16 . V_165 *
V_4 -> V_16 . V_17 ;
V_164 *= 1024 ;
V_153 -> V_166 =
F_42 ( V_4 -> V_16 . V_167 + V_164 ) ;
V_153 -> V_168 =
F_29 ( V_4 -> V_16 . V_169 + V_164 ) ;
F_43 ( V_28 , L_9 ,
F_44 ( V_153 -> V_166 ) ,
F_39 ( V_153 -> V_168 ) ,
V_164 ) ;
...
return - V_213 ;
V_210 = V_195 -> V_214 ;
V_194 . V_215 = F_29 ( ( T_3 ) V_8 -> V_25 ) ;
V_209 = F_53 ( V_195 ) ;
V_194 . V_216 . V_214 = F_36 ( ( T_2 ) V_210 ) ;
V_194 . V_216 . V_52 = V_8 -> V_51 . V_52 ;
V_194 . V_216 . V_217 = F_29 ( V_218 ) ;
V_212 = V_219 | V_220 ;
V_212 |=
F_54 ( V_28 , ( void * ) V_195 -> V_6 , V_209 , 0 ) <<
V_221 ;
V_194 . V_216 . V_212 = F_29 ( V_212 ) ;
V_28 -> V_222 =
F_55 ( V_28 , V_28 -> V_223 -> V_224 ,
V_28 -> V_222 ) ;
V_194 . V_216 . V_225 =
F_29 ( F_9 ( V_28 -> V_222 ) <<
V_226 ) ;
...
V_195 -> V_6 ,
V_210 ) ;
V_87 . V_214 [ 0 ] = sizeof( V_194 ) ;
V_87 . V_6 [ 0 ] = & V_194 ;
V_87 . V_229 [ 0 ] = 0 ;
V_87 . V_214 [ 1 ] = V_210 ;
V_87 . V_6 [ 1 ] = V_195 -> V_6 ;
V_87 . V_229 [ 1 ] = V_230 ;
return F_57 ( V_28 , & V_87 ) ;
}
...
V_87 . V_148 |= F_29 ( V_182 |
V_171 ) ;
F_62 ( V_28 , V_4 , & V_87 . V_244 . V_242 ,
V_102 == V_243 ) ;
...
static int F_68 ( struct V_27 * V_28 , struct V_3 * V_4 ,
T_3 V_102 , bool V_151 )
{
switch ( V_4 -> type ) {
case V_10 :
...
int F_69 ( struct V_27 * V_28 , struct V_3 * V_4 )
{
struct V_7 * V_8 = F_2 ( V_4 ) ;
int V_36 ;
if ( F_70 ( V_8 -> V_248 , L_11 ,
V_4 -> V_118 , F_71 ( V_4 ) ) )
return - V_43 ;
V_36 = F_68 ( V_28 , V_4 , V_243 ,
true ) ;
if ( V_36 )
return V_36 ;
F_72 ( V_28 , V_4 ) ;
...
{
struct V_7 * V_8 = F_2 ( V_4 ) ;
if ( F_70 ( ! V_8 -> V_248 , L_12 ,
V_4 -> V_118 , F_71 ( V_4 ) ) )
return - V_43 ;
return F_68 ( V_28 , V_4 , V_249 ,
V_151 ) ;
}
int F_74 ( struct V_27 * V_28 , struct V_3 * V_4 )
{
struct V_7 * V_8 = F_2 ( V_4 ) ;
struct V_86 V_87 ;
int V_36 ;
if ( F_70 ( ! V_8 -> V_248 , L_13 ,
V_4 -> V_118 , F_71 ( V_4 ) ) )
return - V_43 ;
...
struct V_3 * V_251 , T_3 V_252 )
{
struct V_7 * V_8 =
F_2 ( V_251 ) ;
if ( ! F_76 ( V_251 ) ) {
int V_253 = F_77 ( V_251 ) ;
F_58 ( V_28 , V_251 ) ;
if ( V_251 -> V_39 &&
! F_78 ( & V_8 -> V_46 ) && V_252 ) {
T_3 V_254 = ( V_253 + 1 ) *
...
F_80 ( V_251 ) ;
F_81 ( V_28 -> V_251 , NULL ) ;
}
}
int F_82 ( struct V_27 * V_28 ,
struct V_258 * V_259 ,
struct V_260 * V_87 )
{
struct V_261 * V_262 = F_83 ( V_259 ) ;
struct V_263 * V_264 ;
struct V_3 * V_251 ;
struct V_3 * V_265 ;
T_4 V_266 ;
F_19 ( & V_28 -> V_58 ) ;
if ( V_28 -> V_223 -> V_267 . V_268 [ 0 ] & V_269 ) {
struct V_270 * V_195 = ( void * ) V_262 -> V_6 ;
V_264 = & V_195 -> V_264 ;
V_266 = F_44 ( V_195 -> V_266 ) ;
V_28 -> V_271 = F_39 ( V_195 -> V_252 ) ;
} else {
struct V_272 * V_195 = ( void * ) V_262 -> V_6 ;
V_264 = & V_195 -> V_264 ;
V_266 = F_44 ( V_195 -> V_266 ) ;
}
F_84 ( V_28 ,
L_15 ,
F_85 ( V_264 -> V_41 . V_41 ) &
V_273 ,
V_264 -> V_274 , V_266 ,
V_28 -> V_271 ,
F_39 ( V_264 -> V_275 ) ) ;
V_251 = F_86 ( V_28 -> V_251 ,
F_87 ( & V_28 -> V_58 ) ) ;
if ( F_88 ( V_251 && V_251 -> V_276 ) )
F_75 ( V_28 , V_251 , V_28 -> V_271 ) ;
V_265 = F_86 ( V_28 -> V_277 ,
F_87 ( & V_28 -> V_58 ) ) ;
if ( F_88 ( V_265 ) ) {
struct V_7 * V_8 =
F_2 ( V_265 ) ;
...
struct V_3 * V_4 )
{
struct V_280 * V_281 = V_1 ;
struct V_7 * V_8 = F_2 ( V_4 ) ;
if ( V_8 -> V_25 != ( T_2 ) F_39 ( V_281 -> V_282 ) )
return;
if ( F_39 ( V_281 -> V_283 ) >
V_284 )
F_91 ( V_4 ) ;
...
{
struct V_261 * V_262 = F_83 ( V_259 ) ;
struct V_280 * V_285 = ( void * ) V_262 -> V_6 ;
F_43 ( V_28 ,
L_16 ,
F_39 ( V_285 -> V_282 ) ,
F_39 ( V_285 -> V_286 ) ,
