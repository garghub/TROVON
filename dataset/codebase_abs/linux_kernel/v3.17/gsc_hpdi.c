...
struct V_4 * V_5 = V_2 -> V_6 ;
V_26 V_113 ;
F_6 ( V_114 , V_2 -> V_47 + V_64 ) ;
F_30 ( 10 ) ;
F_6 ( F_31 ( 32 ) | F_32 ( 32 ) ,
V_2 -> V_47 + V_115 ) ;
F_6 ( F_31 ( 32 ) | F_32 ( 32 ) ,
V_2 -> V_47 + V_116 ) ;
V_5 -> V_117 = F_2 ( V_2 -> V_47 + V_118 ) &
V_119 ;
V_5 -> V_120 = F_2 ( V_2 -> V_47 + V_121 ) &
V_119 ;
F_6 ( 0 , V_2 -> V_47 + V_65 ) ;
V_113 =
V_122 | V_123 | V_124 | V_125 | V_126 | V_127 |
V_128 ;
F_6 ( V_113 , V_5 -> V_18 + V_43 ) ;
return 0 ;
}
...
struct V_4 * V_5 = V_2 -> V_6 ;
V_26 V_66 ;
void T_4 * V_129 = V_5 -> V_18 ;
#ifdef F_34
V_66 = V_130 | V_131 ;
#else
V_66 = 0 ;
#endif
F_6 ( V_66 , V_5 -> V_18 + V_132 ) ;
F_6 ( 0 , V_5 -> V_18 + V_43 ) ;
F_13 ( V_2 , 0 ) ;
F_13 ( V_2 , 1 ) ;
V_66 = 0 ;
...
V_66 |= V_139 ;
V_66 |= V_140 ;
F_6 ( V_66 , V_129 + V_141 ) ;
}
static const struct V_142 * F_35 ( struct V_143 * V_144 )
{
unsigned int V_81 ;
for ( V_81 = 0 ; V_81 < F_36 ( V_145 ) ; V_81 ++ )
if ( V_144 -> V_146 == V_145 [ V_81 ] . V_147 &&
V_144 -> V_148 == V_145 [ V_81 ] . V_149 )
return & V_145 [ V_81 ] ;
return NULL ;
}
...
return V_152 ;
F_42 ( V_144 ) ;
V_5 -> V_18 = F_43 ( V_144 , 0 ) ;
V_2 -> V_47 = F_43 ( V_144 , 2 ) ;
if ( ! V_5 -> V_18 || ! V_2 -> V_47 ) {
F_44 ( V_2 -> V_58 , L_5 ) ;
return - V_156 ;
}
F_33 ( V_2 ) ;
if ( F_45 ( V_144 -> V_31 , F_5 , V_157 ,
V_2 -> V_154 , V_2 ) ) {
F_44 ( V_2 -> V_58 ,
L_6 , V_144 -> V_31 ) ;
return - V_68 ;
...
static int F_53 ( struct V_143 * V_2 ,
const struct V_176 * V_177 )
{
return F_54 ( V_2 , & V_178 , V_177 -> V_179 ) ;
}
