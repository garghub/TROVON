...
static int F_20 ( struct V_19 * V_11 ,
struct V_50 * V_51 )
{
struct V_52 * V_53 ;
struct V_9 * V_10 ;
...
static int F_23 ( struct V_19 * V_11 ,
struct V_9 * V_10 )
{
struct V_50 * V_51 ;
int V_25 ;
...
int F_24 ( struct V_19 * V_11 , struct V_9 * V_10 )
{
int V_25 ;
struct V_3 * V_4 = F_10 ( V_11 ) ;
* F_25 ( V_10 , 1 ) = V_4 -> V_5 . V_42 ;
* F_25 ( V_10 , 1 ) = V_60 ;
* F_25 ( V_10 , 1 ) = V_30 ;
* F_25 ( V_10 , 1 ) = V_10 -> V_17 ;
V_25 = F_14 ( V_11 , V_43 ,
V_44 , V_10 -> V_16 , V_10 -> V_17 ) ;
F_6 ( V_10 ) ;
return V_25 ;
}
static int F_26 ( struct V_19 * V_11 ,
struct V_9 * V_10 )
{
struct V_61 * V_62 ;
T_2 V_63 ;
...
F_32 ( V_10 , V_63 ) ;
return F_33 ( V_11 -> V_12 , V_10 ) ;
exit:
return V_25 ;
}
int F_34 ( struct V_19 * V_11 , struct V_9 * V_10 ,
T_2 V_68 )
{
T_2 V_29 , V_31 ;
int V_25 ;
...
static void F_35 ( struct V_19 * V_11 , T_2 V_56 , T_2 V_34 ,
T_2 V_35 , T_2 V_73 )
{
struct V_9 * V_10 ;
struct V_50 * V_51 ;
...
V_51 -> V_74 = V_73 ;
* F_25 ( V_10 , 1 ) = V_4 -> V_5 . V_36 | 0x10 ;
F_7 ( V_4 , V_10 ) ;
F_6 ( V_10 ) ;
}
static void F_37 ( void * V_75 , struct V_9 * V_10 ,
int V_76 )
{
struct V_3 * V_4 = V_75 ;
struct V_22 * V_23 ;
...
V_4 -> V_5 . V_36 |= 0x10 ;
V_25 = F_38 ( V_4 -> V_11 -> V_12 , V_4 -> V_5 . V_79 ,
V_49 , V_80 ) ;
if ( V_25 < 0 )
return;
V_4 -> V_5 . V_42 = 0 ;
if ( F_39 ( V_23 -> V_38 ) != V_4 -> V_5 . V_73 )
F_35 ( V_4 -> V_11 , V_23 -> V_56 ,
V_23 -> V_34 , V_23 -> V_35 ,
F_39 ( V_23 -> V_38 ) ) ;
break;
default:
...
int F_40 ( struct V_19 * V_11 , T_2 * V_81 , T_1 V_24 )
{
struct V_9 * V_10 ;
struct V_3 * V_4 = F_10 ( V_11 ) ;
struct V_20 * V_21 ;
...
V_4 -> V_5 . V_73 = F_39 ( V_21 -> V_38 ) ;
return F_4 ( V_11 , V_14 ,
V_15 , V_10 -> V_16 ,
V_10 -> V_17 , V_4 -> V_18 , V_4 ) ;
}
static void F_43 ( void * V_75 , struct V_9 * V_10 ,
int V_76 )
{
struct V_3 * V_4 = V_75 ;
struct V_61 * V_91 ;
...
int F_44 ( struct V_19 * V_11 , struct V_9 * V_10 )
{
struct V_3 * V_4 = F_10 ( V_11 ) ;
V_4 -> V_77 = V_78 ;
V_4 -> V_90 = V_4 ;
...
{
struct V_3 * V_4 = F_10 ( V_11 ) ;
F_46 ( & V_4 -> V_5 . V_6 , F_1 ) ;
V_4 -> V_5 . V_42 = 0 ;
V_4 -> V_5 . V_79 = 0 ;
V_4 -> V_5 . V_36 = V_37 ;
}
void F_47 ( struct V_19 * V_11 )
{
struct V_3 * V_4 = F_10 ( V_11 ) ;
F_48 ( & V_4 -> V_5 . V_6 ) ;
}
