...
void T_1 F_30 ( T_2 V_114 ) {}
static inline void F_31 ( unsigned V_124 )
{
if ( V_124 & V_125 )
F_9 ( V_126 , 1 ) ;
if ( V_124 & V_127 )
...
static inline void F_32 ( unsigned V_124 )
{
if ( V_124 & V_125 )
F_22 ( V_136 , 1 ) ;
if ( V_124 & V_127 )
...
void T_1 F_33 ( unsigned V_142 , unsigned V_124 )
{
struct V_143 * V_144 ;
switch ( V_142 ) {
case V_145 :
...
static inline void F_35 ( unsigned V_124 )
{
F_9 ( V_150 , 1 ) ;
F_9 ( V_151 , 0 ) ;
if ( V_124 & V_152 )
...
static inline void F_36 ( unsigned V_124 )
{
F_9 ( V_162 , 1 ) ;
F_9 ( V_163 , 0 ) ;
if ( V_124 & V_152 )
...
static inline void F_37 ( unsigned V_124 )
{
F_9 ( V_138 , 1 ) ;
F_9 ( V_139 , 0 ) ;
if ( V_124 & V_152 )
...
static inline void F_38 ( unsigned V_124 )
{
F_9 ( V_164 , 1 ) ;
F_9 ( V_165 , 0 ) ;
if ( V_124 & V_152 )
...
void T_1 F_39 ( unsigned V_142 , unsigned V_166 , unsigned V_124 )
{
struct V_143 * V_144 ;
struct V_167 * V_5 ;
switch ( V_142 ) {
