...
F_36 ( V_2 -> V_55 ) = V_87 ;
V_2 -> V_56 += V_73 ;
if ( V_2 -> V_56 >= V_71 -> V_21 -> V_89 ) {
V_2 -> V_56 -= V_71 -> V_21 -> V_89 ;
V_2 -> V_57 = false ;
F_37 ( & V_2 -> V_12 ) ;
}
}
static void V_13 ( unsigned long V_90 )
{
...
unsigned int V_91 ,
unsigned int V_92 , bool V_93 )
{
struct V_94 V_95 = { 0 } ;
int V_22 = 0 ;
if ( F_40 ( V_2 -> V_10 ) )
goto V_23;
V_95 . V_96 = F_41 ( V_2 -> V_14 + 1 , V_97 ) ;
V_95 . V_98 = V_99 ;
V_95 . V_91 = V_91 ;
V_95 . V_92 = ( ! V_93 ) ? V_92 : 0 ;
V_95 . V_93 = V_93 ;
V_22 = F_42 ( V_2 -> V_10 , & V_95 , & V_2 -> V_72 . V_100 ,
V_2 -> V_72 . V_101 [ V_2 -> V_14 ] . V_102 ) ;
if ( V_22 < 0 ) {
F_43 ( & V_2 -> V_4 -> V_103 , L_1 , V_22 ) ;
goto V_23;
}
if ( ++ V_2 -> V_14 >= V_104 )
V_2 -> V_14 = 0 ;
...
V_59 = 0 ;
V_72 = V_2 -> V_72 . V_101 [ V_2 -> V_14 ] . V_72 ;
V_72 [ 0 ] = F_28 ( F_36 ( V_2 -> V_107 ) |
( V_2 -> V_38 << V_108 ) |
V_2 -> V_84 ) ;
V_72 [ 1 ] = F_28 ( V_109 | V_110 | V_111 |
( V_2 -> V_32 << V_112 ) | V_65 ) ;
V_72 += 2 ;
V_71 = F_36 ( V_2 -> V_71 ) ;
if ( V_71 )
...
V_92 = 8 + V_59 * 4 * V_2 -> V_38 ;
if ( F_44 ( V_2 , V_92 , false ) < 0 ) {
V_2 -> V_14 = - 1 ;
F_47 ( V_2 ) ;
return;
}
...
V_84 = V_114 [ 0 ] & V_123 ;
if ( V_59 == 0 && ( V_2 -> V_8 & V_124 ) &&
V_2 -> V_84 != V_19 )
V_84 = V_2 -> V_84 ;
if ( ( ( V_2 -> V_8 & V_125 ) && V_84 == 0 ) ||
( V_2 -> V_84 == V_19 ) ) {
V_116 = false ;
} else if ( ! ( V_2 -> V_8 & V_126 ) ) {
V_116 = V_84 != V_2 -> V_84 ;
} else {
if ( ( V_59 > 0 ) && ( V_2 -> V_127 > 0 ) )
V_115 = V_2 -> V_127 ;
else
V_115 = V_59 ;
V_116 = V_84 !=
...
static void F_51 ( struct V_128 * V_10 , T_3 V_62 ,
T_6 V_91 , void * V_129 ,
void * V_130 )
{
struct V_1 * V_2 = V_130 ;
unsigned int V_31 , V_65 , V_101 = V_91 / 4 ;
V_62 += V_104 - V_101 ;
...
static void F_53 ( struct V_128 * V_10 , T_3 V_62 ,
T_6 V_91 , void * V_129 ,
void * V_130 )
{
struct V_1 * V_2 = V_130 ;
unsigned int V_95 , V_65 , V_101 , V_113 ;
T_2 * V_72 , * V_131 = V_129 ;
V_101 = V_91 / V_106 ;
...
static void F_54 ( struct V_128 * V_10 , T_3 V_62 ,
T_6 V_91 , void * V_129 ,
void * V_130 )
{
return;
}
static void F_55 ( struct V_128 * V_10 ,
T_3 V_62 , T_6 V_91 ,
...
F_56 ( & V_2 -> V_15 ) ;
if ( V_2 -> V_9 == V_133 )
V_10 -> V_134 . V_135 = F_53 ;
else if ( ( V_2 -> V_8 & V_25 ) && ( V_2 -> V_8 & V_136 ) )
V_10 -> V_134 . V_135 = F_54 ;
else
V_10 -> V_134 . V_135 = F_51 ;
V_10 -> V_134 . V_135 ( V_10 , V_62 , V_91 , V_129 , V_2 ) ;
}
int F_57 ( struct V_1 * V_2 , int V_137 , int V_138 )
{
static const struct {
unsigned int V_139 ;
unsigned int V_63 ;
...
V_2 -> V_84 = 0 ;
V_2 -> V_60 = V_140 [ V_2 -> V_32 ] . V_139 ;
V_2 -> V_67 = V_140 [ V_2 -> V_32 ] . V_63 ;
V_2 -> V_66 = V_43 ;
if ( V_2 -> V_9 == V_133 ) {
V_6 = V_152 ;
type = V_153 ;
...
V_22 = F_59 ( & V_2 -> V_72 , V_2 -> V_4 , V_104 ,
F_19 ( V_2 ) , V_6 ) ;
if ( V_22 < 0 )
goto V_150;
V_2 -> V_10 = F_60 ( F_61 ( V_2 -> V_4 ) -> V_156 ,
type , V_137 , V_138 , V_147 ,
F_55 , V_2 ) ;
if ( F_40 ( V_2 -> V_10 ) ) {
V_22 = F_62 ( V_2 -> V_10 ) ;
if ( V_22 == - V_157 )
...
{
F_36 ( V_2 -> V_107 ) =
( F_61 ( V_2 -> V_4 ) -> V_156 -> V_163 & 0x3f ) << 24 ;
}
