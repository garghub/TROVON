...
{
F_107 ( V_103 , & V_3 -> V_88 ) ;
F_108 ( & V_3 -> V_88 , V_87 , V_112 ) ;
F_109 ( V_103 , & V_3 -> V_88 ) ;
}
static int F_110 ( struct V_113 * V_42 , unsigned int V_114 , char * * V_115 )
{
struct V_2 * V_3 ;
int V_21 ;
int V_51 = - V_44 ;
...
V_115 ++ ;
V_114 -- ;
V_51 = F_111 ( V_42 , V_116 , V_120 , & V_3 -> V_4 ) ;
if ( V_51 ) {
V_42 -> error = L_19 ;
goto V_124;
}
...
V_115 ++ ;
V_114 -- ;
V_51 = F_111 ( V_42 , V_117 , F_112 ( V_42 -> V_58 ) , & V_3 -> V_5 ) ;
if ( V_51 ) {
V_42 -> error = L_20 ;
goto V_125;
}
V_51 = F_113 ( V_42 , V_114 , V_115 , V_3 , & V_118 , & V_3 -> V_7 ) ;
if ( V_51 ) {
V_42 -> error = L_21 ;
V_51 = - V_44 ;
goto V_126;
...
V_3 -> V_108 = F_117 ( & V_132 ) ;
if ( F_118 ( V_3 -> V_108 ) ) {
V_51 = F_119 ( V_3 -> V_108 ) ;
V_42 -> error = L_23 ;
goto V_133;
}
V_3 -> V_73 = F_120 ( V_134 , V_135 ) ;
if ( ! V_3 -> V_73 ) {
V_42 -> error = L_24 ;
V_51 = - V_26 ;
goto V_136;
...
static void F_129 ( struct V_2 * V_36 ,
struct V_2 * V_37 )
{
union {
struct V_53 V_143 ;
...
V_145 . V_143 = V_37 -> V_81 ;
V_37 -> V_81 = V_36 -> V_81 ;
V_36 -> V_81 = V_145 . V_143 ;
...
static void F_130 ( struct V_113 * V_42 )
{
#ifdef F_131
int V_21 ;
#endif
...
F_106 ( V_3 ) ;
F_46 ( V_3 ) ;
while ( F_132 ( & V_3 -> V_74 ) )
F_22 ( 1 ) ;
F_133 () ;
#ifdef F_131
for ( V_21 = 0 ; V_21 < V_137 ; V_21 ++ )
F_97 ( ! F_134 ( & V_3 -> V_18 [ V_21 ] ) ) ;
#endif
F_128 ( V_3 ) ;
F_124 ( V_3 -> V_73 ) ;
F_126 ( V_3 -> V_7 ) ;
...
static void F_136 ( struct V_2 * V_3 , struct V_13 * V_13 )
{
struct V_13 * V_147 ;
int V_51 ;
while ( V_13 ) {
...
static void F_139 ( struct V_2 * V_3 , int V_150 )
{
if ( ! V_3 -> V_105 )
return;
if ( V_150 == - V_151 )
...
static void F_141 ( struct V_71 * V_72 , int V_153 )
{
struct V_62 * V_65 ;
struct V_2 * V_3 = V_72 -> V_35 ;
...
V_154 = F_86 ( & V_72 -> V_154 ) ;
V_156 = V_72 -> V_156 ;
if ( V_156 ) {
V_156 -> V_157 = V_72 -> V_158 ;
V_156 -> V_159 = V_72 -> V_160 ;
F_63 ( & V_156 -> V_161 ) ;
}
F_64 ( V_72 ) ;
F_94 () ;
...
static void F_143 ( void * V_78 , int V_153 )
{
...
V_3 -> V_7 -> type -> V_163 ( V_3 -> V_7 , & V_72 -> V_65 ,
F_143 , V_72 ) ;
}
static void F_145 ( int V_110 , unsigned long V_111 , void * V_78 )
{
struct V_71 * V_72 = V_78 ;
struct V_2 * V_3 = V_72 -> V_35 ;
V_72 -> V_162 = V_110 || V_111 ;
if ( V_72 -> V_164 == V_3 -> V_128 ) {
V_3 -> V_128 ++ ;
F_144 ( V_72 ) ;
while ( ! F_47 ( & V_3 -> V_129 ) ) {
V_72 = F_146 ( V_3 -> V_129 . V_64 ,
struct V_71 , V_165 ) ;
if ( V_72 -> V_164 != V_3 -> V_128 )
break;
V_3 -> V_128 ++ ;
...
struct V_24 * V_166 ;
struct V_71 * V_167 ;
F_147 (lh, &s->out_of_order_list) {
V_167 = F_146 ( V_166 , struct V_71 , V_165 ) ;
if ( V_167 -> V_164 < V_72 -> V_164 )
break;
}
F_72 ( & V_72 -> V_165 , V_166 ) ;
}
}
static void F_148 ( struct V_71 * V_72 )
{
struct V_2 * V_3 = V_72 -> V_35 ;
struct V_98 V_99 , V_100 ;
struct V_10 * V_28 = V_3 -> V_4 -> V_28 ;
...
V_99 . V_39 = F_79 ( ( T_1 ) V_3 -> V_7 -> V_48 , V_168 - V_99 . V_107 ) ;
V_100 . V_28 = V_3 -> V_5 -> V_28 ;
V_100 . V_107 = F_3 ( V_3 -> V_7 , V_72 -> V_65 . V_77 ) ;
V_100 . V_39 = V_99 . V_39 ;
F_102 ( V_3 -> V_108 , & V_99 , 1 , & V_100 , 0 , F_145 , V_72 ) ;
}
static void V_158 ( struct V_13 * V_13 , int error )
{
void * V_169 = V_13 -> V_159 ;
F_149 ( V_169 , 0 , error ? 1 : 0 ) ;
}
...
void * V_169 ;
V_72 -> V_156 = V_13 ;
V_72 -> V_158 = V_13 -> V_157 ;
V_72 -> V_160 = V_13 -> V_159 ;
V_169 = F_151 ( V_3 -> V_108 ,
F_145 , V_72 ) ;
V_13 -> V_157 = V_158 ;
V_13 -> V_159 = V_169 ;
F_135 ( V_13 ) ;
...
static struct V_71 *
F_152 ( struct V_2 * V_3 , T_2 V_8 )
{
struct V_62 * V_65 = F_56 ( & V_3 -> V_86 , V_8 ) ;
if ( ! V_65 )
return NULL ;
return F_153 ( V_65 , struct V_71 , V_65 ) ;
}
static struct V_71 *
...
V_72 -> V_170 = 0 ;
V_72 -> V_156 = NULL ;
if ( V_3 -> V_7 -> type -> V_171 ( V_3 -> V_7 , & V_72 -> V_65 ) ) {
F_64 ( V_72 ) ;
return NULL ;
}
V_72 -> V_164 = V_3 -> V_127 ++ ;
F_68 ( & V_3 -> V_86 , & V_72 -> V_65 ) ;
return V_72 ;
}
static void F_155 ( struct V_2 * V_3 , struct V_62 * V_65 ,
struct V_13 * V_13 , T_2 V_8 )
{
V_13 -> V_172 = V_3 -> V_5 -> V_28 ;
V_13 -> V_173 . V_174 =
F_3 ( V_3 -> V_7 , F_70 ( V_65 -> V_77 ) +
( V_8 - V_65 -> V_66 ) ) +
( V_13 -> V_173 . V_174 & V_3 -> V_7 -> V_175 ) ;
}
static int F_156 ( struct V_113 * V_42 , struct V_13 * V_13 )
{
struct V_62 * V_65 ;
struct V_2 * V_3 = V_42 -> V_138 ;
int V_51 = V_149 ;
...
V_8 = F_157 ( V_3 -> V_7 , V_13 -> V_173 . V_174 ) ;
if ( ! V_3 -> V_105 )
return - V_151 ;
F_42 ( & V_3 -> V_43 ) ;
if ( ! V_3 -> V_105 ) {
...
static int F_160 ( struct V_113 * V_42 , struct V_13 * V_13 )
{
struct V_62 * V_65 ;
struct V_2 * V_3 = V_42 -> V_138 ;
int V_51 = V_149 ;
...
if ( F_158 ( V_13 ) == V_179 ) {
F_43 ( & V_3 -> V_43 ) ;
return F_137 ( V_3 -> V_4 , V_13 ) ;
}
V_178:
F_43 ( & V_3 -> V_43 ) ;
return V_51 ;
}
static int F_162 ( struct V_113 * V_42 , struct V_13 * V_13 , int error )
{
struct V_2 * V_3 = V_42 -> V_138 ;
if ( F_8 ( V_13 ) )
F_15 ( V_3 , V_13 ) ;
...
static void F_163 ( struct V_113 * V_42 )
{
struct V_2 * V_3 = V_42 -> V_138 ;
F_106 ( V_3 ) ;
}
static int F_164 ( struct V_113 * V_42 )
{
int V_51 = 0 ;
struct V_2 * V_3 = V_42 -> V_138 ;
struct V_2 * V_36 = NULL , * V_37 = NULL ;
...
static void F_166 ( struct V_113 * V_42 )
{
struct V_2 * V_3 = V_42 -> V_138 ;
struct V_2 * V_36 = NULL , * V_37 = NULL ;
F_37 ( & V_27 ) ;
...
static T_3 F_168 ( struct V_10 * V_28 )
{
T_3 V_185 ;
F_37 ( & V_27 ) ;
V_185 = F_74 ( F_31 ( V_28 ) ) ;
F_38 ( & V_27 ) ;
return V_185 ;
}
static void F_169 ( struct V_113 * V_42 )
{
struct V_2 * V_3 = V_42 -> V_138 ;
F_166 ( V_42 ) ;
V_42 -> V_146 = F_168 ( V_3 -> V_4 -> V_28 ) ;
F_104 ( V_3 ) ;
}
static void F_170 ( struct V_113 * V_42 , T_7 type ,
unsigned V_186 , char * V_187 , unsigned V_188 )
{
unsigned V_189 = 0 ;
...
if ( V_35 -> V_7 -> type -> V_191 ) {
T_1 V_192 , V_193 ,
V_194 ;
V_35 -> V_7 -> type -> V_191 ( V_35 -> V_7 ,
& V_192 ,
& V_193 ,
& V_194 ) ;
F_171 ( L_38 ,
...
break;
case V_195 :
F_171 ( L_40 , V_35 -> V_4 -> V_196 , V_35 -> V_5 -> V_196 ) ;
V_35 -> V_7 -> type -> V_197 ( V_35 -> V_7 , type , V_187 + V_189 ,
V_188 - V_189 ) ;
break;
}
}
static int F_172 ( struct V_113 * V_42 ,
T_8 V_198 , void * V_199 )
{
struct V_2 * V_35 = V_42 -> V_138 ;
int V_51 ;
V_51 = V_198 ( V_42 , V_35 -> V_4 , 0 , V_42 -> V_200 , V_199 ) ;
if ( ! V_51 )
V_51 = V_198 ( V_42 , V_35 -> V_5 , 0 , F_78 ( V_35 -> V_5 -> V_28 ) , V_199 ) ;
return V_51 ;
}
static int F_173 ( struct V_24 * V_52 , T_1 V_107 ,
struct V_13 * V_13 )
{
int V_51 = V_149 ;
struct V_2 * V_35 ;
...
goto V_203;
if ( V_107 >= F_174 ( V_35 -> V_42 -> V_58 ) )
goto V_203;
V_8 = F_157 ( V_35 -> V_7 , V_107 ) ;
...
static int F_137 ( struct V_1 * V_4 , struct V_13 * V_13 )
{
struct V_4 * V_32 ;
int V_51 = V_149 ;
F_37 ( & V_27 ) ;
V_32 = F_31 ( V_4 -> V_28 ) ;
if ( V_32 )
V_51 = F_173 ( & V_32 -> V_52 , V_13 -> V_173 . V_174 , V_13 ) ;
F_38 ( & V_27 ) ;
return V_51 ;
}
static int F_100 ( struct V_2 * V_204 ,
...
struct V_4 * V_32 ;
F_37 ( & V_27 ) ;
V_32 = F_31 ( V_204 -> V_4 -> V_28 ) ;
for ( V_147 = 0 ; V_147 < V_55 ; V_147 += V_204 -> V_42 -> V_146 )
if ( F_173 ( & V_32 -> V_52 , V_107 + V_147 , NULL ) ==
V_180 )
V_205 = 1 ;
F_38 ( & V_27 ) ;
return V_205 ;
}
static int F_175 ( struct V_113 * V_42 , unsigned int V_114 , char * * V_115 )
{
int V_51 ;
struct V_206 * V_32 ;
if ( V_114 != 1 ) {
...
V_32 = F_24 ( sizeof( struct V_206 ) , V_25 ) ;
if ( ! V_32 ) {
V_42 -> error = L_42 ;
V_51 = - V_26 ;
goto V_207;
}
V_51 = F_111 ( V_42 , V_115 [ 0 ] , F_112 ( V_42 -> V_58 ) , & V_32 -> V_208 ) ;
if ( V_51 ) {
V_42 -> error = L_43 ;
goto V_209;
}
...
static void F_176 ( struct V_113 * V_42 )
{
struct V_206 * V_32 = V_42 -> V_138 ;
F_127 ( V_42 , V_32 -> V_208 ) ;
F_29 ( V_32 ) ;
}
static int F_177 ( struct V_113 * V_42 , struct V_13 * V_13 )
{
struct V_206 * V_32 = V_42 -> V_138 ;
unsigned V_210 ;
V_13 -> V_172 = V_32 -> V_208 -> V_28 ;
if ( F_99 ( V_13 -> V_176 & V_177 ) )
return V_149 ;
if ( F_158 ( V_13 ) != V_179 )
return V_149 ;
V_210 = V_32 -> V_211 -
( ( unsigned ) V_13 -> V_173 . V_174 & ( V_32 -> V_211 - 1 ) ) ;
if ( F_178 ( V_13 ) > V_210 )
F_179 ( V_13 , V_210 ) ;
return F_137 ( V_32 -> V_208 , V_13 ) ;
}
static void F_180 ( struct V_113 * V_42 )
{
struct V_206 * V_32 = V_42 -> V_138 ;
V_32 -> V_211 = F_168 ( V_32 -> V_208 -> V_28 ) ;
}
static void F_181 ( struct V_113 * V_42 , T_7 type ,
unsigned V_186 , char * V_187 , unsigned V_188 )
{
struct V_206 * V_32 = V_42 -> V_138 ;
switch ( type ) {
...
break;
case V_195 :
snprintf ( V_187 , V_188 , L_44 , V_32 -> V_208 -> V_196 ) ;
break;
}
}
static int F_182 ( struct V_113 * V_42 , struct V_212 * V_213 ,
struct V_214 * V_215 , int V_216 )
{
struct V_206 * V_32 = V_42 -> V_138 ;
struct V_217 * V_218 = F_183 ( V_32 -> V_208 -> V_28 ) ;
if ( ! V_218 -> V_219 )
return V_216 ;
V_213 -> V_172 = V_32 -> V_208 -> V_28 ;
return F_79 ( V_216 , V_218 -> V_219 ( V_218 , V_213 , V_215 ) ) ;
}
static int F_184 ( struct V_113 * V_42 ,
T_8 V_198 , void * V_199 )
{
struct V_206 * V_32 = V_42 -> V_138 ;
return V_198 ( V_42 , V_32 -> V_208 , 0 , V_42 -> V_200 , V_199 ) ;
}
