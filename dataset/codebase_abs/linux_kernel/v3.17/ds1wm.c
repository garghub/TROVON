...
{
int V_46 ;
struct V_47 * V_35 = & V_1 -> V_34 -> V_35 ;
struct V_48 * V_49 = F_18 ( V_35 ) ;
if ( V_1 -> V_50 -> V_51 )
...
static T_2 F_20 ( void * V_7 )
{
struct V_1 * V_1 = V_7 ;
return F_14 ( V_1 , 0xff ) ;
}
static void F_21 ( void * V_7 , T_2 V_55 )
{
struct V_1 * V_1 = V_7 ;
F_13 ( V_1 , V_55 ) ;
}
static T_2 F_22 ( void * V_7 )
{
struct V_1 * V_1 = V_7 ;
F_7 ( V_1 ) ;
return 0 ;
}
static void F_23 ( void * V_7 , struct V_56 * V_57 ,
T_2 V_58 , T_4 V_59 )
{
struct V_1 * V_1 = V_7 ;
int V_44 ;
...
static int F_27 ( struct V_72 * V_34 )
{
struct V_1 * V_1 ;
struct V_48 * V_49 ;
struct V_73 * V_74 ;
...
if ( ! V_34 )
return - V_76 ;
V_1 = F_28 ( & V_34 -> V_35 , sizeof( * V_1 ) , V_77 ) ;
if ( ! V_1 )
return - V_78 ;
F_29 ( V_34 , V_1 ) ;
V_74 = F_30 ( V_34 , V_79 , 0 ) ;
if ( ! V_74 )
return - V_80 ;
V_1 -> V_4 = F_31 ( & V_34 -> V_35 , V_74 -> V_81 ,
F_32 ( V_74 ) ) ;
if ( ! V_1 -> V_4 )
return - V_78 ;
V_1 -> V_5 = F_32 ( V_74 ) >> 3 ;
...
if ( ! V_49 )
return - V_76 ;
V_74 = F_30 ( V_34 , V_82 , 0 ) ;
if ( ! V_74 )
return - V_80 ;
V_1 -> V_83 = V_74 -> V_81 ;
V_1 -> V_13 = ( V_49 -> V_84 ? V_85 : 0 ) ;
V_1 -> V_36 = V_49 -> V_36 ;
if ( V_74 -> V_86 & V_87 )
F_34 ( V_1 -> V_83 , V_88 ) ;
if ( V_74 -> V_86 & V_89 )
F_34 ( V_1 -> V_83 , V_90 ) ;
V_75 = F_35 ( & V_34 -> V_35 , V_1 -> V_83 , F_5 ,
V_91 , L_23 , V_1 ) ;
if ( V_75 )
return V_75 ;
F_17 ( V_1 ) ;
...
static int F_37 ( struct V_72 * V_34 , T_6 V_94 )
{
...
static int F_40 ( struct V_72 * V_34 )
{
struct V_1 * V_1 = F_38 ( V_34 ) ;
F_41 ( & V_92 ) ;
F_19 ( V_1 ) ;
