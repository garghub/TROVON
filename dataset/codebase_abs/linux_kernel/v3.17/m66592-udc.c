...
static int F_101 ( struct V_274 * V_280 )
{
struct V_1 * V_1 = F_102 ( V_280 ) ;
return F_2 ( V_1 , V_281 ) & 0x03FF ;
}
static int F_103 ( struct V_274 * V_18 , int V_282 )
{
...
{
struct V_1 * V_1 = F_105 ( V_284 ) ;
F_106 ( & V_1 -> V_18 ) ;
F_107 ( & V_1 -> V_257 ) ;
F_108 ( V_1 -> V_5 ) ;
F_109 ( F_110 ( V_284 , 0 ) , V_1 ) ;
...
static void F_113 ( struct V_263 * V_23 , struct V_266 * V_286 )
{
}
static int F_114 ( struct V_283 * V_284 )
{
...
V_5 = F_117 ( V_288 -> V_295 , F_118 ( V_288 ) ) ;
if ( V_5 == NULL ) {
V_33 = - V_75 ;
F_16 ( L_21 ) ;
goto V_292;
}
if ( F_119 ( & V_284 -> V_294 ) == NULL ) {
F_116 ( & V_284 -> V_294 , L_22 ) ;
V_33 = - V_112 ;
goto V_292;
}
...
V_1 -> V_51 = F_119 ( & V_284 -> V_294 ) ;
V_1 -> V_160 = V_289 -> V_262 & V_296 ;
F_120 ( & V_1 -> V_17 ) ;
F_121 ( V_284 , V_1 ) ;
V_1 -> V_18 . V_297 = & V_298 ;
V_1 -> V_18 . V_299 = V_222 ;
V_1 -> V_18 . V_300 = V_301 ;
F_122 ( & V_1 -> V_257 ) ;
V_1 -> V_257 . V_302 = F_84 ;
V_1 -> V_257 . V_303 = ( unsigned long ) V_1 ;
V_1 -> V_5 = V_5 ;
V_33 = F_123 ( V_289 -> V_295 , F_81 , V_304 ,
V_301 , V_1 ) ;
if ( V_33 < 0 ) {
F_16 ( L_23 , V_33 ) ;
goto V_292;
...
if ( V_1 -> V_51 -> V_52 ) {
snprintf ( V_290 , sizeof( V_290 ) , L_24 , V_284 -> V_305 ) ;
V_1 -> V_285 = F_124 ( & V_284 -> V_294 , V_290 ) ;
if ( F_125 ( V_1 -> V_285 ) ) {
F_116 ( & V_284 -> V_294 , L_25 ,
V_290 ) ;
V_33 = F_126 ( V_1 -> V_285 ) ;
goto V_306;
}
F_127 ( V_1 -> V_285 ) ;
}
...
F_13 ( & V_1 -> V_18 . V_206 -> V_307 ) ;
for ( V_178 = 0 ; V_178 < V_29 ; V_178 ++ ) {
struct V_45 * V_23 = & V_1 -> V_23 [ V_178 ] ;
if ( V_178 != 0 ) {
F_13 ( & V_1 -> V_23 [ V_178 ] . V_23 . V_307 ) ;
F_94 ( & V_1 -> V_23 [ V_178 ] . V_23 . V_307 ,
& V_1 -> V_18 . V_307 ) ;
}
V_23 -> V_1 = V_1 ;
F_13 ( & V_23 -> V_24 ) ;
V_23 -> V_23 . V_300 = V_308 [ V_178 ] ;
V_23 -> V_23 . V_297 = & V_309 ;
F_128 ( & V_23 -> V_23 , 512 ) ;
}
...
F_56 ( V_1 ) ;
V_33 = F_129 ( & V_284 -> V_294 , & V_1 -> V_18 ) ;
if ( V_33 )
goto V_311;
F_130 ( & V_284 -> V_294 , L_26 , V_312 ) ;
return 0 ;
V_311:
F_92 ( & V_1 -> V_23 [ 0 ] . V_23 , V_1 -> V_205 ) ;
V_310:
