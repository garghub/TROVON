...
static int F_30 ( struct V_6 * V_7 , unsigned type )
{
...
F_25 ( V_2 , V_22 ) ;
F_5 ( V_2 , V_22 , 1 ) ;
} else if ( ! F_29 ( V_2 , F_7 ( V_22 ) ) ) {
F_36 ( & V_2 -> V_65 , V_60 ) ;
return - V_51 ;
}
V_2 -> V_58 |= F_7 ( F_35 ( V_2 , V_9 ) ) ;
F_36 ( & V_2 -> V_65 , V_60 ) ;
if ( type & ( V_35 | V_37 ) )
F_37 ( V_7 -> V_62 , V_66 ) ;
...
static void F_41 ( struct V_1 * V_2 , int V_68 )
{
void T_1 * V_11 = V_2 -> V_5 ;
T_2 V_12 ;
if ( V_2 -> V_13 -> V_74 ) {
...
static inline void F_43 ( struct V_1 * V_2 , int V_9 ,
int V_17 )
{
if ( V_17 )
F_41 ( V_2 , F_10 ( V_2 , V_9 ) ) ;
else
...
F_43 ( V_2 , V_9 , 0 ) ;
F_39 ( V_2 , V_9 ) ;
F_24 ( V_2 , F_35 ( V_2 , V_9 ) , V_77 ) ;
F_20 ( V_2 , V_9 ) ;
}
static int F_47 ( struct V_6 * V_7 , unsigned int V_17 )
{
struct V_1 * V_2 = F_2 ( V_7 ) ;
unsigned int V_9 = F_1 ( V_2 , V_7 -> V_64 ) ;
return F_44 ( V_2 , V_9 , V_17 ) ;
}
static int F_48 ( struct V_8 * V_4 , unsigned V_22 )
{
...
static void F_49 ( struct V_8 * V_4 , unsigned V_22 )
{
struct V_1 * V_2 = F_4 ( V_4 , struct V_1 , V_4 ) ;
unsigned long V_60 ;
F_34 ( & V_2 -> V_65 , V_60 ) ;
V_2 -> V_57 &= ~ ( F_7 ( V_22 ) ) ;
F_27 ( V_2 , V_22 ) ;
F_46 ( V_2 , V_2 -> V_4 . V_5 + V_22 ) ;
F_36 ( & V_2 -> V_65 , V_60 ) ;
if ( ! F_26 ( V_2 ) )
F_50 ( V_2 -> V_61 ) ;
}
static void F_51 ( unsigned int V_62 , struct V_78 * V_79 )
{
void T_1 * V_80 = NULL ;
T_2 V_81 ;
unsigned int V_82 ;
struct V_1 * V_2 ;
int V_83 = 0 ;
struct V_84 * V_85 = F_52 ( V_79 ) ;
struct V_8 * V_4 = F_53 ( V_62 ) ;
F_54 ( V_85 , V_79 ) ;
...
static int F_66 ( struct V_90 * V_61 )
{
struct V_91 * V_92 = F_67 ( V_61 ) ;
...
static int F_69 ( struct V_90 * V_61 )
{
struct V_91 * V_92 = F_67 ( V_61 ) ;
struct V_1 * V_2 = F_68 ( V_92 ) ;
void T_1 * V_93 = V_2 -> V_5 +
...
static int F_74 ( struct V_8 * V_4 , unsigned V_22 )
{
struct V_1 * V_2 ;
unsigned long V_60 ;
void T_1 * V_11 ;
...
static int F_75 ( struct V_8 * V_4 , unsigned V_22 )
{
struct V_1 * V_2 ;
unsigned long V_60 ;
V_2 = F_4 ( V_4 , struct V_1 , V_4 ) ;
...
static int F_77 ( struct V_8 * V_4 , unsigned V_22 , int V_99 )
{
struct V_1 * V_2 ;
unsigned long V_60 ;
V_2 = F_4 ( V_4 , struct V_1 , V_4 ) ;
...
static void F_79 ( struct V_8 * V_4 , unsigned V_22 , int V_99 )
{
struct V_1 * V_2 ;
unsigned long V_60 ;
V_2 = F_4 ( V_4 , struct V_1 , V_4 ) ;
...
static void T_3 F_80 ( struct V_1 * V_2 )
{
static bool V_100 ;
T_2 V_101 ;
if ( V_100 || V_2 -> V_13 -> V_102 == V_103 )
return;
V_101 = F_81 ( V_2 -> V_5 + V_2 -> V_13 -> V_102 ) ;
F_82 ( L_2 ,
...
V_2 -> V_28 = F_84 ( V_2 -> V_61 , L_3 ) ;
if ( F_85 ( V_2 -> V_28 ) )
F_45 ( V_2 -> V_61 , L_4 ) ;
}
static void
F_86 ( struct V_1 * V_2 , unsigned int V_105 ,
unsigned int V_106 )
{
struct V_107 * V_108 ;
struct V_109 * V_110 ;
V_108 = F_87 ( L_5 , 1 , V_105 , V_2 -> V_5 ,
V_111 ) ;
if ( ! V_108 ) {
F_45 ( V_2 -> V_61 , L_6 ) ;
return;
...
V_110 -> V_4 . V_116 = F_30 ;
if ( V_2 -> V_13 -> V_43 )
V_110 -> V_4 . V_117 = F_47 ;
V_110 -> V_13 . V_24 = V_118 / V_2 -> V_95 ;
F_88 ( V_108 , F_89 ( V_106 ) , V_119 ,
V_120 | V_121 , 0 ) ;
}
...
V_2 -> V_4 . V_132 = V_2 -> V_71 ;
V_124 = F_91 ( & V_2 -> V_4 ) ;
if ( V_124 ) {
F_45 ( V_2 -> V_61 , L_9 , V_124 ) ;
return V_124 ;
}
#ifdef F_32
V_123 = F_92 ( - 1 , 0 , V_2 -> V_71 , 0 ) ;
if ( V_123 < 0 ) {
F_45 ( V_2 -> V_61 , L_10 ) ;
return - V_133 ;
}
#endif
V_124 = F_93 ( & V_2 -> V_4 , & V_134 ,
V_123 , F_51 ,
V_77 ) ;
if ( V_124 ) {
F_45 ( V_2 -> V_61 , L_11 , V_124 ) ;
V_124 = F_94 ( & V_2 -> V_4 ) ;
return - V_133 ;
}
F_95 ( & V_2 -> V_4 , & V_134 ,
V_2 -> V_62 , F_51 ) ;
for ( V_122 = 0 ; V_122 < V_2 -> V_71 ; V_122 ++ ) {
int V_62 = F_59 ( V_2 -> V_4 . V_88 , V_122 ) ;
if ( V_2 -> V_104 ) {
F_86 ( V_2 , V_62 , V_2 -> V_71 ) ;
F_96 ( V_62 , NULL , NULL ) ;
F_97 ( V_62 , 0 ) ;
}
}
...
struct V_1 * V_2 ;
int V_124 ;
V_139 = F_99 ( F_100 ( V_144 ) , V_61 ) ;
V_141 = V_139 ? V_139 -> V_145 : F_101 ( V_61 ) ;
if ( ! V_141 )
return - V_51 ;
V_2 = F_102 ( V_61 , sizeof( struct V_1 ) , V_146 ) ;
if ( ! V_2 ) {
F_45 ( V_61 , L_12 ) ;
return - V_147 ;
}
V_143 = F_103 ( V_92 , V_148 , 0 ) ;
if ( F_104 ( ! V_143 ) ) {
F_45 ( V_61 , L_13 ) ;
return - V_133 ;
}
V_2 -> V_62 = V_143 -> V_149 ;
V_2 -> V_61 = V_61 ;
V_2 -> V_4 . V_61 = V_61 ;
V_2 -> V_32 = V_141 -> V_32 ;
V_2 -> V_95 = V_141 -> V_150 ;
V_2 -> V_71 = V_141 -> V_151 ;
V_2 -> V_104 = V_141 -> V_104 ;
V_2 -> V_42 = V_141 -> V_42 ;
V_2 -> V_13 = V_141 -> V_13 ;
#ifdef F_105
V_2 -> V_4 . V_137 = F_106 ( V_136 ) ;
#endif
if ( V_136 ) {
if ( ! F_107 ( V_136 , L_14 ) )
V_2 -> V_152 = true ;
} else {
V_2 -> V_152 = V_141 -> V_152 ;
if ( V_2 -> V_152 )
V_2 -> V_153 =
V_141 -> V_153 ;
}
...
V_2 -> V_18 = F_11 ;
F_108 ( & V_2 -> V_65 ) ;
V_143 = F_103 ( V_92 , V_154 , 0 ) ;
V_2 -> V_5 = F_109 ( V_61 , V_143 ) ;
if ( F_85 ( V_2 -> V_5 ) ) {
F_110 ( V_2 -> V_4 . V_88 ) ;
return F_111 ( V_2 -> V_5 ) ;
}
F_71 ( V_92 , V_2 ) ;
F_112 ( V_2 -> V_61 ) ;
F_113 ( V_2 -> V_61 ) ;
...
F_80 ( V_2 ) ;
F_50 ( V_2 -> V_61 ) ;
F_114 ( & V_2 -> V_136 , & V_155 ) ;
return 0 ;
}
static int F_115 ( struct V_90 * V_61 )
{
struct V_91 * V_92 = F_67 ( V_61 ) ;
struct V_1 * V_2 = F_68 ( V_92 ) ;
T_2 V_156 = 0 , V_157 = 0 ;
...
T_2 V_158 , V_159 ;
F_34 ( & V_2 -> V_65 , V_60 ) ;
V_158 = V_2 -> V_15 . V_34 & V_2 -> V_15 . V_44 ;
if ( V_158 )
F_8 ( V_158 | V_2 -> V_15 . V_40 ,
V_2 -> V_5 + V_2 -> V_13 -> V_40 ) ;
V_159 = V_2 -> V_15 . V_36 & V_2 -> V_15 . V_44 ;
if ( V_159 )
F_8 ( V_159 | V_2 -> V_15 . V_38 ,
...
V_2 -> V_163 = F_6 ( V_2 -> V_5 +
V_2 -> V_13 -> V_23 ) ;
V_156 = V_2 -> V_15 . V_40 ;
V_157 = V_2 -> V_15 . V_38 ;
V_156 &= ~ V_2 -> V_47 ;
V_157 &= ~ V_2 -> V_47 ;
F_8 ( V_156 , V_2 -> V_5 + V_2 -> V_13 -> V_40 ) ;
F_8 ( V_157 , V_2 -> V_5 + V_2 -> V_13 -> V_38 ) ;
V_2 -> V_164 = true ;
V_160:
if ( V_2 -> V_153 )
V_2 -> V_165 =
...
static int F_116 ( struct V_90 * V_61 )
{
struct V_91 * V_92 = F_67 ( V_61 ) ;
struct V_1 * V_2 = F_68 ( V_92 ) ;
T_2 V_12 = 0 , V_166 , V_167 , V_168 ;
unsigned long V_60 ;
int V_169 ;
F_34 ( & V_2 -> V_65 , V_60 ) ;
if ( V_2 -> V_152 && ! V_2 -> V_170 ) {
F_117 ( V_2 ) ;
if ( V_2 -> V_153 )
V_2 -> V_165 =
V_2 -> V_153 ( V_2 -> V_61 ) ;
...
V_12 ^= V_2 -> V_163 ;
V_12 &= V_2 -> V_47 ;
V_167 = V_12 & V_2 -> V_15 . V_40 ;
V_167 &= V_2 -> V_163 ;
V_168 = V_12 & V_2 -> V_15 . V_38 ;
V_168 &= ~ ( V_2 -> V_163 ) ;
V_166 = V_12 & ( ~ ( V_2 -> V_15 . V_40 ) &
~ ( V_2 -> V_15 . V_38 ) ) ;
V_166 |= V_167 | V_168 ;
if ( V_166 ) {
T_2 V_171 , V_172 ;
V_171 = F_6 ( V_2 -> V_5 + V_2 -> V_13 -> V_34 ) ;
V_172 = F_6 ( V_2 -> V_5 + V_2 -> V_13 -> V_36 ) ;
if ( ! V_2 -> V_13 -> V_173 ) {
F_8 ( V_171 | V_166 , V_2 -> V_5 +
V_2 -> V_13 -> V_34 ) ;
F_8 ( V_172 | V_166 , V_2 -> V_5 +
V_2 -> V_13 -> V_36 ) ;
}
if ( V_2 -> V_13 -> V_173 ) {
F_8 ( V_171 | V_12 , V_2 -> V_5 +
V_2 -> V_13 -> V_34 ) ;
F_8 ( V_172 | V_12 , V_2 -> V_5 +
V_2 -> V_13 -> V_36 ) ;
}
F_8 ( V_171 , V_2 -> V_5 + V_2 -> V_13 -> V_34 ) ;
F_8 ( V_172 , V_2 -> V_5 + V_2 -> V_13 -> V_36 ) ;
}
V_2 -> V_164 = false ;
F_36 ( & V_2 -> V_65 , V_60 ) ;
return 0 ;
}
void F_119 ( int V_174 )
{
struct V_1 * V_2 ;
F_120 (bank, &omap_gpio_list, node) {
if ( ! F_26 ( V_2 ) || ! V_2 -> V_152 )
continue;
V_2 -> V_161 = V_174 ;
F_121 ( V_2 -> V_61 ) ;
}
...
static void F_117 ( struct V_1 * V_175 )
{
struct V_176 * V_13 = V_175 -> V_13 ;
void T_1 * V_5 = V_175 -> V_5 ;
V_175 -> V_15 . V_55 = F_6 ( V_5 + V_13 -> V_55 ) ;
V_175 -> V_15 . V_16 = F_6 ( V_5 + V_13 -> V_14 ) ;
V_175 -> V_15 . V_44 = F_6 ( V_5 + V_13 -> V_43 ) ;
V_175 -> V_15 . V_34 = F_6 ( V_5 + V_13 -> V_34 ) ;
V_175 -> V_15 . V_36 = F_6 ( V_5 + V_13 -> V_36 ) ;
V_175 -> V_15 . V_38 = F_6 ( V_5 + V_13 -> V_38 ) ;
V_175 -> V_15 . V_40 = F_6 ( V_5 + V_13 -> V_40 ) ;
V_175 -> V_15 . V_75 = F_6 ( V_5 + V_13 -> V_72 ) ;
V_175 -> V_15 . V_177 = F_6 ( V_5 + V_13 -> V_177 ) ;
if ( V_13 -> V_18 && V_175 -> V_13 -> V_20 )
V_175 -> V_15 . V_19 = F_6 ( V_5 + V_13 -> V_18 ) ;
else
V_175 -> V_15 . V_19 = F_6 ( V_5 + V_13 -> V_19 ) ;
V_175 -> V_170 = true ;
}
...
F_8 ( V_2 -> V_15 . V_177 ,
V_2 -> V_5 + V_2 -> V_13 -> V_177 ) ;
}
static inline void F_117 ( struct V_1 * V_175 ) {}
