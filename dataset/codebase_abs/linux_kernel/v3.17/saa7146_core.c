...
V_10 = - V_49 ;
V_2 -> V_93 . V_94 = F_50 ( V_30 , V_95 ,
& V_2 -> V_93 . V_96 ) ;
if ( ! V_2 -> V_93 . V_94 )
goto V_97;
V_2 -> V_98 . V_94 = F_50 ( V_30 , V_95 ,
& V_2 -> V_98 . V_96 ) ;
if ( ! V_2 -> V_98 . V_94 )
goto V_99;
V_2 -> V_100 . V_94 = F_50 ( V_30 , V_95 ,
& V_2 -> V_100 . V_96 ) ;
if ( ! V_2 -> V_100 . V_94 )
goto V_101;
sprintf ( V_2 -> V_13 , L_13 , V_102 ) ;
F_51 ( L_14 ,
...
V_2 -> V_109 = V_110 ;
F_54 ( & V_2 -> V_72 ) ;
F_4 ( V_2 , V_111 , 0x1c00101f ) ;
V_10 = - V_87 ;
if ( V_62 -> V_112 && V_62 -> V_112 ( V_2 ) ) {
F_55 ( L_15 , V_2 ) ;
goto V_113;
}
if ( V_62 -> V_114 ( V_2 , V_80 ) ) {
F_55 ( L_16 , V_2 ) ;
goto V_113;
}
F_56 ( V_30 , & V_2 -> V_115 ) ;
...
return V_10 ;
V_113:
F_30 ( V_30 , V_95 , V_2 -> V_100 . V_94 ,
V_2 -> V_100 . V_96 ) ;
V_101:
F_30 ( V_30 , V_95 , V_2 -> V_98 . V_94 ,
V_2 -> V_98 . V_96 ) ;
V_99:
F_30 ( V_30 , V_95 , V_2 -> V_93 . V_94 ,
V_2 -> V_93 . V_96 ) ;
V_97:
F_57 ( V_30 -> V_56 , ( void * ) V_2 ) ;
V_92:
F_58 ( V_2 -> V_35 ) ;
V_88:
F_59 ( V_30 , 0 ) ;
...
static void F_61 ( struct V_29 * V_116 )
{
struct V_117 * V_115 = F_62 ( V_116 ) ;
struct V_1 * V_2 = F_63 ( V_115 ) ;
struct {
void * V_118 ;
T_3 V_47 ;
} V_119 [] = {
{ V_2 -> V_100 . V_94 , V_2 -> V_100 . V_96 } ,
{ V_2 -> V_98 . V_94 , V_2 -> V_98 . V_96 } ,
...
F_4 ( V_2 , V_89 , 0 ) ;
F_57 ( V_116 -> V_56 , V_2 ) ;
for ( V_54 = V_119 ; V_54 -> V_118 ; V_54 ++ )
F_30 ( V_116 , V_95 , V_54 -> V_118 , V_54 -> V_47 ) ;
F_58 ( V_2 -> V_35 ) ;
F_59 ( V_116 , 0 ) ;
F_60 ( V_116 ) ;
F_20 ( V_2 ) ;
...
int F_64 ( struct V_82 * V_62 )
{
F_42 ( L_18 , V_62 ) ;
V_62 -> V_121 . V_13 = V_62 -> V_13 ;
V_62 -> V_121 . V_122 = V_62 -> V_123 ;
V_62 -> V_121 . V_112 = F_40 ;
V_62 -> V_121 . remove = F_61 ;
F_51 ( L_19 , V_62 -> V_13 ) ;
return F_65 ( & V_62 -> V_121 ) ;
}
