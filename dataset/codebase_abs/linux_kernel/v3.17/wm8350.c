...
static int F_29 ( struct V_57 * V_131 , int V_132 )
{
...
V_10 = 0 ;
F_30 ( V_2 , V_134 , V_133 , V_10 ) ;
return 0 ;
}
static inline int F_31 ( struct V_135 * V_136 , unsigned int V_137 ,
unsigned int V_138 )
{
T_2 V_139 ;
...
static void F_42 ( struct V_3 * V_153 ,
struct V_210 * V_211 ,
T_1 V_212 )
{
struct V_6 * V_6 = V_153 -> V_6 ;
...
F_50 ( V_6 -> V_160 , 250 ) ;
F_51 ( V_221 ,
& V_153 -> V_215 . V_30 , F_10 ( 200 ) ) ;
return V_222 ;
}
static T_3 F_52 ( int V_219 , void * V_220 )
{
struct V_3 * V_153 = V_220 ;
struct V_6 * V_6 = V_153 -> V_6 ;
#ifndef F_47
...
F_50 ( V_6 -> V_160 , 250 ) ;
F_51 ( V_221 ,
& V_153 -> V_217 . V_30 , F_10 ( 200 ) ) ;
return V_222 ;
}
int F_53 ( struct V_1 * V_2 , enum V_223 V_224 ,
...
static T_3 F_54 ( int V_219 , void * V_220 )
{
struct V_3 * V_153 = V_220 ;
struct V_6 * V_6 = V_153 -> V_6 ;
T_1 V_9 ;
...
V_153 = F_59 ( V_2 -> V_160 , sizeof( struct V_3 ) ,
V_239 ) ;
if ( V_153 == NULL )
return - V_240 ;
F_60 ( V_2 , V_153 ) ;
V_153 -> V_6 = V_6 ;
for ( V_34 = 0 ; V_34 < F_38 ( V_241 ) ; V_34 ++ )
V_153 -> V_185 [ V_34 ] . V_242 = V_241 [ V_34 ] ;
V_55 = F_61 ( V_6 -> V_160 , F_38 ( V_153 -> V_185 ) ,
V_153 -> V_185 ) ;
if ( V_55 != 0 )
return V_55 ;
F_23 ( V_6 , V_243 , V_244 ) ;
F_62 ( & V_2 -> V_32 . V_33 , F_7 ) ;
F_62 ( & V_153 -> V_215 . V_30 , F_44 ) ;
F_62 ( & V_153 -> V_217 . V_30 , F_45 ) ;
F_5 ( V_6 , V_243 , V_244 ) ;
F_19 ( V_2 , V_245 , 0xa7 ) ;
F_19 ( V_2 , 0xde , 0x13 ) ;
F_19 ( V_2 , V_245 , 0 ) ;
...
F_23 ( V_6 , V_232 ,
V_228 | V_230 ) ;
F_23 ( V_6 , V_157 , V_231 ) ;
F_65 ( V_6 , V_257 , V_153 ) ;
F_65 ( V_6 , V_256 , V_153 ) ;
F_65 ( V_6 , V_254 , V_153 ) ;
F_65 ( V_6 , V_255 , V_153 ) ;
V_153 -> V_215 . V_211 = NULL ;
V_153 -> V_217 . V_211 = NULL ;
V_153 -> V_234 . V_211 = NULL ;
F_66 ( & V_153 -> V_215 . V_30 ) ;
F_66 ( & V_153 -> V_217 . V_30 ) ;
F_67 ( & V_2 -> V_32 . V_33 ) ;
F_36 ( V_2 , V_184 ) ;
F_23 ( V_6 , V_243 , V_244 ) ;
return 0 ;
}
static struct V_258 * F_68 ( struct V_259 * V_160 )
{
struct V_6 * V_6 = F_57 ( V_160 ) ;
return V_6 -> V_258 ;
}
static int F_69 ( struct V_260 * V_261 )
{
return F_70 ( & V_261 -> V_160 , & V_262 ,
& V_263 , 1 ) ;
}
static int F_71 ( struct V_260 * V_261 )
{
F_72 ( & V_261 -> V_160 ) ;
return 0 ;
}
