...
V_9 = F_26 ( & V_2 -> V_6 , sizeof( struct V_8 ) ,
V_46 ) ;
if ( ! V_9 ) {
F_3 ( & V_2 -> V_6 , L_9 ) ;
return - V_47 ;
...
V_12 -> V_51 = F_20 ;
V_12 -> V_52 = F_22 ;
V_12 -> V_6 . V_53 = & V_2 -> V_6 ;
V_12 -> V_54 [ 0 ] = F_28 ( V_55 ) | F_28 ( V_56 ) ;
V_12 -> V_57 = sizeof( V_9 -> V_22 [ 0 ] ) ;
V_12 -> V_58 = F_29 ( V_9 -> V_22 ) ;
V_12 -> V_21 = V_9 -> V_22 ;
F_30 ( V_12 , V_30 , V_31 ) ;
F_31 ( V_12 , V_9 ) ;
F_6 ( V_9 , V_11 ) ;
error = F_32 ( & V_2 -> V_6 , V_2 -> V_25 , NULL ,
F_13 ,
V_59 | V_60 ,
V_2 -> V_48 , V_9 ) ;
if ( error ) {
...
{
struct V_1 * V_2 = F_37 ( V_6 ) ;
F_18 ( V_2 ) ;
if ( F_38 ( & V_2 -> V_6 ) )
F_39 ( V_2 -> V_25 ) ;
return 0 ;
}
static int F_40 ( struct V_61 * V_6 )
{
struct V_1 * V_2 = F_37 ( V_6 ) ;
if ( F_38 ( & V_2 -> V_6 ) )
F_41 ( V_2 -> V_25 ) ;
