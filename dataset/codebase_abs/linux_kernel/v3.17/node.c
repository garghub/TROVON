...
int F_37 ( unsigned int V_72 , unsigned int V_15 )
{
int V_73 ;
struct V_1 * V_74 ;
if ( ! F_38 ( V_15 ) )
...
if ( ! V_74 )
return 0 ;
V_73 = F_40 ( & V_75 [ V_15 ] -> V_2 . V_76 ,
& V_74 -> V_76 ,
F_41 ( & V_74 -> V_76 ) ) ;
if ( V_73 )
return V_73 ;
return F_40 ( & V_74 -> V_76 ,
& V_75 [ V_15 ] -> V_2 . V_76 ,
F_41 ( & V_75 [ V_15 ] -> V_2 . V_76 ) ) ;
}
int F_42 ( unsigned int V_72 , unsigned int V_15 )
{
struct V_1 * V_74 ;
if ( ! F_38 ( V_15 ) )
return 0 ;
...
if ( ! V_74 )
return 0 ;
F_43 ( & V_75 [ V_15 ] -> V_2 . V_76 ,
F_41 ( & V_74 -> V_76 ) ) ;
F_43 ( & V_74 -> V_76 ,
F_41 ( & V_75 [ V_15 ] -> V_2 . V_76 ) ) ;
return 0 ;
}
static int F_44 ( unsigned long V_77 )
{
struct V_78 * V_78 ;
if ( ! F_45 ( V_77 ) )
return - 1 ;
...
int F_49 ( struct V_79 * V_80 , int V_15 )
{
int V_73 ;
...
if ( V_87 != V_15 )
continue;
V_73 = F_51 ( & V_75 [ V_15 ] -> V_2 . V_76 ,
& V_80 -> V_2 . V_76 ,
F_41 ( & V_80 -> V_2 . V_76 ) ) ;
if ( V_73 )
return V_73 ;
return F_51 ( & V_80 -> V_2 . V_76 ,
& V_75 [ V_15 ] -> V_2 . V_76 ,
F_41 ( & V_75 [ V_15 ] -> V_2 . V_76 ) ) ;
}
return 0 ;
}
int F_52 ( struct V_79 * V_80 ,
unsigned long V_88 )
{
F_53 ( V_89 , V_90 , V_91 ) ;
unsigned long V_77 , V_81 , V_82 ;
...
static int F_57 ( int V_15 )
{
unsigned long V_93 = F_58 ( V_15 ) -> V_94 ;
unsigned long V_95 = V_93 + F_58 ( V_15 ) -> V_96 ;
unsigned long V_77 ;
struct V_79 * V_80 = NULL ;
int V_97 = 0 ;
for ( V_77 = V_93 ; V_77 < V_95 ; V_77 += V_86 ) {
unsigned long V_98 = F_59 ( V_77 ) ;
struct V_99 * V_100 ;
int V_73 ;
if ( ! F_60 ( V_98 ) )
continue;
...
{
struct V_4 * V_4 = F_65 ( V_102 , struct V_4 , V_60 ) ;
if ( ! F_20 ( V_4 ) )
F_22 ( V_4 ) ;
}
static void F_66 ( int V_15 )
{
F_67 ( & V_75 [ V_15 ] -> V_60 , F_64 ) ;
}
...
static int F_57 ( int V_15 ) { return 0 ; }
static inline int F_68 ( struct V_103 * V_104 ,
unsigned long V_105 , void * V_106 )
{
return V_117 ;
}
...
if ( V_118 != V_15 )
V_62 = V_75 [ V_118 ] ;
V_75 [ V_15 ] = F_72 ( sizeof( struct V_4 ) , V_91 ) ;
if ( ! V_75 [ V_15 ] )
return - V_92 ;
...
static T_1 F_76 ( enum V_119 V_120 , char * V_3 )
{
int V_14 ;
V_14 = F_77 ( V_3 , V_11 - 2 , V_119 [ V_120 ] ) ;
V_3 [ V_14 ++ ] = '\n' ;
V_3 [ V_14 ] = '\0' ;
return V_14 ;
}
...
struct V_12 * V_13 , char * V_3 )
{
struct V_121 * V_122 = F_65 ( V_13 , struct V_121 , V_13 ) ;
return F_76 ( V_122 -> V_120 , V_3 ) ;
}
static int T_3 F_79 ( void )
{
int V_73 ;
F_4 ( F_80 ( V_123 ) != V_124 ) ;
F_4 ( F_80 ( V_125 ) - 1 != V_124 ) ;
V_73 = F_81 ( & V_64 , V_126 ) ;
if ( ! V_73 ) {
