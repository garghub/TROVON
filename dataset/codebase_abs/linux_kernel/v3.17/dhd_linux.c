...
void F_34 ( struct V_10 * V_11 , struct V_38 * V_39 )
{
V_39 -> V_70 = V_11 -> V_6 ;
...
void F_110 ( struct V_69 * V_70 , T_7 V_55 )
{
struct V_71 * V_45 = F_32 ( V_70 ) ;
struct V_1 * V_2 = V_45 -> V_2 ;
if ( V_2 ) {
...
T_3 F_117 ( struct V_69 * V_70 , char * V_7 , void * V_43 , T_1 V_55 )
{
struct V_71 * V_45 = F_32 ( V_70 ) ;
...
{
return F_119 ( & V_11 -> V_59 ) ;
}
int F_120 ( struct V_12 * V_6 )
{
struct V_10 * V_11 = F_16 ( V_6 ) ;
int V_21 ;
V_21 = F_121 ( V_11 -> V_115 ,
! F_118 ( V_11 ) ,
F_122 ( V_158 ) ) ;
F_48 ( ! V_21 ) ;
return ! V_21 ;
