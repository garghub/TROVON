...
V_223 -> type = V_225 ;
V_223 -> V_102 = 1 ;
V_223 -> V_226 . V_227 . V_228 = 2 ;
if ( V_223 -> V_226 . V_227 . V_229 >= 2 )
V_223 -> V_226 . V_227 . V_229 = 1 ;
strcpy ( V_223 -> V_226 . V_227 . V_206 , V_224 [ V_223 -> V_226 . V_227 . V_229 ] ) ;
return 0 ;
}
static int F_87 ( struct V_220 * V_221 ,
struct V_230 * V_231 )
{
struct V_13 * V_14 = F_88 ( V_221 ) ;
unsigned long V_197 = V_14 -> V_197 + ( V_221 -> V_184 . V_232 ? ( V_233 + 0x10 ) : V_233 ) ;
V_231 -> V_226 . V_227 . V_229 [ 0 ] = F_29 ( V_197 ) & V_234 ? 1 : 0 ;
return 0 ;
}
...
struct V_13 * V_14 = F_88 ( V_221 ) ;
T_3 V_35 ;
F_91 ( V_14 -> V_6 , V_236 , & V_35 ) ;
V_231 -> V_226 . integer . V_226 [ 0 ] = ( V_35 & V_237 ) ? 1 : 0 ;
return 0 ;
}
...
struct V_13 * V_14 = F_88 ( V_221 ) ;
T_3 V_35 , V_235 ;
F_91 ( V_14 -> V_6 , V_236 , & V_235 ) ;
V_35 = V_235 & ~ V_237 ;
if ( V_231 -> V_226 . integer . V_226 [ 0 ] )
V_35 |= V_237 ;
V_14 -> V_141 = V_231 -> V_226 . integer . V_226 [ 0 ] ? 1 : 0 ;
if ( V_35 != V_235 ) {
F_93 ( V_14 -> V_6 , V_236 , V_35 ) ;
return 1 ;
}
return 0 ;
}
...
V_223 -> type = V_238 ;
V_223 -> V_102 = 2 ;
V_223 -> V_226 . integer . V_239 = 0 ;
V_223 -> V_226 . integer . V_240 = V_177 ;
return 0 ;
}
...
{
struct V_13 * V_14 = F_88 ( V_221 ) ;
unsigned int V_10 = V_221 -> V_184 . V_241 ;
V_231 -> V_226 . integer . V_226 [ 0 ] = V_177 - V_14 -> V_142 [ V_10 ] [ 0 ] ;
V_231 -> V_226 . integer . V_226 [ 1 ] = V_177 - V_14 -> V_142 [ V_10 ] [ 1 ] ;
return 0 ;
}
...
{
struct V_13 * V_14 = F_88 ( V_221 ) ;
V_231 -> V_226 . integer . V_226 [ 0 ] = V_177 - V_14 -> V_242 [ 0 ] ;
V_231 -> V_226 . integer . V_226 [ 1 ] = V_177 - V_14 -> V_242 [ 1 ] ;
return 0 ;
}
...
int V_9 , V_243 = 0 ;
for ( V_9 = 0 ; V_9 < 2 ; V_9 ++ ) {
V_35 = V_231 -> V_226 . integer . V_226 [ V_9 ] ;
if ( V_35 > V_177 )
V_35 = V_177 ;
V_35 = V_177 - V_35 ;
V_243 |= V_35 != V_14 -> V_142 [ V_10 ] [ V_9 ] ;
if ( V_243 ) {
V_14 -> V_142 [ V_10 ] [ V_9 ] = V_35 ;
F_27 ( V_35 , V_197 + V_244 + V_9 ) ;
}
}
return V_243 ;
}
...
static int F_101 ( struct V_13 * V_14 , const char * V_248 )
{
struct V_249 V_46 ;
int V_48 ;
...
if ( ( V_48 = V_245 ( V_14 -> V_39 , 0 , & V_251 , V_14 , & V_14 -> V_247 ) ) < 0 )
return V_48 ;
V_14 -> V_247 -> V_255 = F_99 ;
V_14 -> V_247 -> clock = V_14 -> V_256 ;
memset ( & V_46 , 0 , sizeof( V_46 ) ) ;
V_46 . V_47 = V_14 ;
V_46 . V_255 = F_100 ;
V_46 . V_6 = V_14 -> V_6 ;
V_46 . V_257 = V_258 | V_259 ;
if ( ( V_48 = F_102 ( V_14 -> V_247 , & V_46 , & V_14 -> V_46 ) ) < 0 )
return V_48 ;
F_103 ( V_14 -> V_46 , V_260 , V_248 ) ;
if ( V_14 -> V_92 != V_93 ) {
F_104 ( V_14 -> V_46 , V_261 , 0x03 << 4 , 0x03 << 4 ) ;
}
return 0 ;
}
static int F_105 ( struct V_13 * V_14 , unsigned char * V_262 )
{
struct V_263 * V_264 ;
struct V_265 * V_22 ;
if ( ! V_266 )
return - V_267 ;
V_22 = F_106 ( V_268 , 8 , L_10 ) ;
if ( ! V_22 ) {
F_107 ( V_14 -> V_39 -> V_2 , L_11 ,
V_268 ) ;
return - V_269 ;
}
V_14 -> V_263 = V_264 = F_108 () ;
if ( ! V_264 ) {
F_7 ( V_14 -> V_39 -> V_2 ,
L_12 ) ;
F_109 ( V_22 ) ;
...
F_110 ( V_264 , L_13 ) ;
F_111 ( V_264 , L_14 , F_112 ( V_14 -> V_6 ) ) ;
F_113 ( V_264 , & V_14 -> V_6 -> V_2 ) ;
V_264 -> V_270 = V_268 ;
F_114 ( V_264 , V_22 ) ;
* V_262 |= V_271 ;
F_93 ( V_14 -> V_6 , V_272 , * V_262 ) ;
F_115 ( V_14 -> V_263 ) ;
return 0 ;
}
...
{
if ( V_14 -> V_263 ) {
struct V_265 * V_22 = F_117 ( V_14 -> V_263 ) ;
F_118 ( V_14 -> V_263 ) ;
V_14 -> V_263 = NULL ;
F_109 ( V_22 ) ;
}
}
static inline int F_105 ( struct V_13 * V_14 , unsigned char * V_262 )
{
return - V_273 ;
}
...
int V_9 , V_48 , V_274 ;
unsigned char V_35 ;
V_274 = V_14 -> V_92 == V_275 ? 1 : 2 ;
for ( V_9 = 0 ; V_9 < V_274 ; V_9 ++ ) {
V_276 . V_232 = V_9 ;
V_48 = F_120 ( V_14 -> V_39 , F_121 ( & V_276 , V_14 ) ) ;
if ( V_48 < 0 )
return V_48 ;
}
if ( F_84 ( V_14 -> V_46 ) ) {
V_48 = F_120 ( V_14 -> V_39 , F_121 ( & V_277 , V_14 ) ) ;
if ( V_48 < 0 )
return V_48 ;
}
if ( V_14 -> V_92 != V_275 ) {
...
strcpy ( V_279 . V_206 , L_15 ) ;
V_279 . V_280 = V_281 ;
if ( ! F_122 ( V_14 -> V_39 , & V_279 ) ) {
F_123 ( V_14 -> V_39 -> V_2 ,
L_16 ) ;
V_48 = F_120 ( V_14 -> V_39 , F_121 ( & V_282 , V_14 ) ) ;
if ( V_48 < 0 )
return V_48 ;
}
else
...
if ( ! V_283 )
return - V_19 ;
V_283 -> V_184 . V_241 = V_9 ;
V_48 = F_120 ( V_14 -> V_39 , V_283 ) ;
if ( V_48 < 0 )
return V_48 ;
V_14 -> V_176 [ V_9 ] = V_283 ;
}
}
}
F_91 ( V_14 -> V_6 , V_236 , & V_35 ) ;
V_35 = ( V_35 & ~ V_285 ) | V_286 ;
V_35 &= ~ V_237 ;
F_93 ( V_14 -> V_6 , V_236 , V_35 ) ;
return 0 ;
}
...
if ( V_293 >= 0x200 ) {
V_293 &= 0xfffc ;
F_125 ( V_14 -> V_6 , 0x18 , V_293 | 0x01 ) ;
#ifdef F_126
V_14 -> V_294 = V_293 ;
#endif
} else {
V_293 = F_127 ( V_14 -> V_6 , 2 ) ;
}
} else {
switch ( V_293 ) {
case 0x300 :
...
case 0x330 :
V_287 &= ~ ( 3 << 2 ) ;
V_287 |= ( V_293 & 0x0030 ) >> 2 ;
break;
default:
if ( V_262 & V_295 )
V_293 = 0x300 + ( ( V_287 & 0x000c ) << 2 ) ;
break;
}
}
if ( V_293 >= 0x200 &&
( V_14 -> V_296 = F_106 ( V_293 , 2 , L_17 ) )
!= NULL ) {
if ( V_288 )
V_262 |= V_297 ;
V_262 |= V_295 ;
...
F_93 ( V_14 -> V_6 , V_272 , V_262 ) ;
F_93 ( V_14 -> V_6 , V_298 , V_287 ) ;
if ( V_14 -> V_296 ) {
if ( F_128 ( V_14 -> V_39 , 0 , V_299 ,
V_293 , V_300 |
V_301 , - 1 ,
& V_14 -> V_73 ) < 0 ) {
F_107 ( V_14 -> V_39 -> V_2 ,
...
static void F_129 ( struct V_304 * V_305 ,
struct V_306 * V_307 )
{
struct V_13 * V_14 = V_305 -> V_47 ;
int V_9 ;
F_130 ( V_307 , L_19 , V_14 -> V_39 -> V_308 ) ;
for ( V_9 = 0 ; V_9 < 0xa0 ; V_9 += 4 ) {
F_130 ( V_307 , L_20 , V_9 , F_15 ( V_14 -> V_197 + V_9 ) ) ;
}
}
static void F_131 ( struct V_13 * V_14 )
{
struct V_304 * V_305 ;
if ( ! F_132 ( V_14 -> V_39 , L_21 , & V_305 ) )
F_133 ( V_305 , V_14 , F_129 ) ;
}
...
F_20 ( 2 ) ;
#endif
F_93 ( V_14 -> V_6 , V_313 , V_317 ) ;
F_20 ( 100 ) ;
}
F_91 ( V_14 -> V_6 , V_313 , & V_310 ) ;
if ( ( V_310 & V_317 ) != V_317 ) {
F_93 ( V_14 -> V_6 , V_313 , V_317 ) ;
F_20 ( 100 ) ;
}
V_309 = V_318 + F_135 ( 750 ) ;
do {
F_91 ( V_14 -> V_6 , V_311 , & V_310 ) ;
if ( V_310 & V_312 )
break;
F_136 ( 1 ) ;
} while ( F_137 ( V_318 , V_309 ) );
if ( ( V_35 = F_14 ( V_14 ) ) & V_38 )
F_7 ( V_14 -> V_39 -> V_2 ,
L_22 , V_35 ) ;
#if 0
...
#endif
if ( V_14 -> V_92 == V_93 ) {
F_93 ( V_14 -> V_6 , V_319 , 0 ) ;
F_18 ( 0 , F_16 ( V_14 , V_320 ) ) ;
}
if ( V_14 -> V_92 != V_93 ) {
struct V_5 * V_6 ;
V_6 = F_138 ( 0x1106 , 0x3068 , NULL ) ;
if ( V_6 ) {
unsigned char V_321 ;
F_91 ( V_6 , 0x44 , & V_321 ) ;
F_93 ( V_6 , 0x44 , V_321 | 0x40 ) ;
F_139 ( V_6 ) ;
}
}
if ( V_14 -> V_92 != V_275 ) {
...
unsigned long V_197 = V_14 -> V_197 + 0x10 * V_10 ;
for ( V_9 = 0 ; V_9 < 2 ; V_9 ++ ) {
V_14 -> V_142 [ V_10 ] [ V_9 ] = V_14 -> V_242 [ V_9 ] ;
F_27 ( V_14 -> V_242 [ V_9 ] ,
V_197 + V_244 + V_9 ) ;
}
}
...
static int F_140 ( struct V_195 * V_2 )
{
struct V_5 * V_6 = F_141 ( V_2 ) ;
struct V_322 * V_39 = F_142 ( V_2 ) ;
struct V_13 * V_14 = V_39 -> V_47 ;
int V_9 ;
F_143 ( V_39 , V_323 ) ;
for ( V_9 = 0 ; V_9 < 2 ; V_9 ++ )
F_144 ( V_14 -> V_207 [ V_9 ] ) ;
for ( V_9 = 0 ; V_9 < V_14 -> V_76 ; V_9 ++ )
F_26 ( V_14 , & V_14 -> V_77 [ V_9 ] ) ;
F_145 ( V_14 -> V_68 ) ;
F_146 ( V_14 -> V_46 ) ;
if ( V_14 -> V_92 != V_93 ) {
F_91 ( V_14 -> V_6 , V_236 , & V_14 -> V_324 ) ;
V_14 -> V_325 [ 0 ] = F_29 ( V_14 -> V_197 + V_233 ) ;
V_14 -> V_325 [ 1 ] = F_29 ( V_14 -> V_197 + V_233 + 0x10 ) ;
}
F_147 ( V_6 ) ;
F_148 ( V_6 ) ;
F_149 ( V_6 , V_326 ) ;
...
static int F_150 ( struct V_195 * V_2 )
{
struct V_5 * V_6 = F_141 ( V_2 ) ;
struct V_322 * V_39 = F_142 ( V_2 ) ;
struct V_13 * V_14 = V_39 -> V_47 ;
...
if ( V_14 -> V_92 == V_93 ) {
if ( V_14 -> V_294 )
F_125 ( V_14 -> V_6 , 0x18 , V_14 -> V_294 | 0x01 ) ;
F_93 ( V_14 -> V_6 , V_272 , V_14 -> V_302 ) ;
F_93 ( V_14 -> V_6 , V_298 , V_14 -> V_303 ) ;
} else {
F_93 ( V_14 -> V_6 , V_236 , V_14 -> V_324 ) ;
F_27 ( V_14 -> V_325 [ 0 ] , V_14 -> V_197 + V_233 ) ;
F_27 ( V_14 -> V_325 [ 1 ] , V_14 -> V_197 + V_233 + 0x10 ) ;
}
F_155 ( V_14 -> V_46 ) ;
for ( V_9 = 0 ; V_9 < V_14 -> V_76 ; V_9 ++ )
F_26 ( V_14 , & V_14 -> V_77 [ V_9 ] ) ;
...
static int F_156 ( struct V_13 * V_14 )
{
unsigned int V_9 ;
if ( V_14 -> V_68 < 0 )
goto V_329;
...
F_26 ( V_14 , & V_14 -> V_77 [ V_9 ] ) ;
if ( V_14 -> V_68 >= 0 )
F_157 ( V_14 -> V_68 , V_14 ) ;
V_329:
F_109 ( V_14 -> V_296 ) ;
F_158 ( V_14 -> V_6 ) ;
if ( V_14 -> V_92 == V_93 ) {
F_116 ( V_14 ) ;
F_93 ( V_14 -> V_6 , V_272 , V_14 -> V_289 ) ;
F_93 ( V_14 -> V_6 , V_298 , V_14 -> V_290 ) ;
}
F_147 ( V_14 -> V_6 ) ;
F_13 ( V_14 ) ;
return 0 ;
}
static int F_159 ( struct V_330 * V_195 )
{
struct V_13 * V_14 = V_195 -> V_331 ;
return F_156 ( V_14 ) ;
}
static int F_160 ( struct V_322 * V_39 ,
struct V_5 * V_6 ,
int V_92 ,
int V_109 ,
unsigned int V_256 ,
...
struct V_13 * V_14 ;
int V_48 ;
static struct V_333 V_251 = {
. V_334 = F_159 ,
} ;
if ( ( V_48 = F_152 ( V_6 ) ) < 0 )
return V_48 ;
if ( ( V_14 = F_161 ( sizeof( * V_14 ) , V_21 ) ) == NULL ) {
F_147 ( V_6 ) ;
return - V_19 ;
}
V_14 -> V_92 = V_92 ;
V_14 -> V_109 = V_109 ;
F_162 ( & V_14 -> V_75 ) ;
F_162 ( & V_14 -> V_139 [ 0 ] . V_133 ) ;
F_162 ( & V_14 -> V_139 [ 1 ] . V_133 ) ;
V_14 -> V_39 = V_39 ;
V_14 -> V_6 = V_6 ;
V_14 -> V_68 = - 1 ;
F_91 ( V_6 , V_272 , & V_14 -> V_289 ) ;
F_91 ( V_6 , V_298 , & V_14 -> V_290 ) ;
F_93 ( V_14 -> V_6 , V_272 ,
V_14 -> V_289 & ~ ( V_335 | V_336 ) ) ;
if ( ( V_48 = F_163 ( V_6 , V_39 -> V_337 ) ) < 0 ) {
F_13 ( V_14 ) ;
F_147 ( V_6 ) ;
return V_48 ;
}
V_14 -> V_197 = F_127 ( V_6 , 0 ) ;
if ( F_164 ( V_6 -> V_68 ,
V_92 == V_338 ?
F_35 : F_30 ,
V_339 ,
...
V_14 -> V_68 = V_6 -> V_68 ;
if ( V_256 >= 8000 && V_256 <= 48000 )
V_14 -> V_256 = V_256 ;
F_145 ( V_14 -> V_68 ) ;
if ( ( V_48 = F_134 ( V_14 ) ) < 0 ) {
F_156 ( V_14 ) ;
return V_48 ;
}
if ( ( V_48 = F_165 ( V_39 , V_341 , V_14 , & V_251 ) ) < 0 ) {
F_156 ( V_14 ) ;
return V_48 ;
}
F_154 ( V_6 ) ;
...
static int F_166 ( struct V_5 * V_6 , int V_109 )
{
const struct V_342 * V_343 ;
V_343 = F_167 ( V_6 , V_344 ) ;
if ( V_343 ) {
F_39 ( & V_6 -> V_2 , L_25 ,
F_168 ( V_343 ) ) ;
return V_343 -> V_226 ;
...
unsigned int V_9 ;
int V_48 ;
V_48 = F_170 ( & V_6 -> V_2 , V_232 , V_184 , V_351 , 0 , & V_39 ) ;
if ( V_48 < 0 )
return V_48 ;
V_350 = V_349 -> V_352 ;
switch ( V_350 ) {
case V_353 :
strcpy ( V_39 -> V_337 , L_30 ) ;
...
for ( V_9 = 0 ; V_9 < F_72 ( V_355 ) ; V_9 ++ ) {
if ( V_6 -> V_109 == V_355 [ V_9 ] . V_109 ) {
V_92 = V_355 [ V_9 ] . type ;
strcpy ( V_39 -> V_201 , V_355 [ V_9 ] . V_206 ) ;
break;
}
}
if ( V_92 != V_275 ) {
if ( V_356 == V_357 )
V_356 = F_166 ( V_6 , V_6 -> V_109 ) ;
if ( V_356 == V_358 )
V_92 = V_275 ;
else
V_92 = V_338 ;
...
if ( V_92 == V_275 )
strcpy ( V_39 -> V_337 , L_33 ) ;
else if ( V_6 -> V_109 >= V_359 )
strcpy ( V_39 -> V_337 , L_34 ) ;
else
strcpy ( V_39 -> V_337 , L_35 ) ;
break;
default:
F_7 ( V_39 -> V_2 , L_36 , V_350 ) ;
V_48 = - V_25 ;
goto V_360;
}
if ( ( V_48 = F_160 ( V_39 , V_6 , V_92 , V_6 -> V_109 ,
V_256 , & V_14 ) ) < 0 )
goto V_360;
V_39 -> V_47 = V_14 ;
if ( ( V_48 = F_101 ( V_14 , V_361 ) ) < 0 )
goto V_360;
if ( V_92 == V_93 ) {
if ( ( V_48 = F_85 ( V_14 ) ) < 0 ||
( V_48 = F_124 ( V_14 ) ) < 0 )
...
for ( V_9 = 0 ; V_9 < V_14 -> V_76 ; V_9 ++ )
F_26 ( V_14 , & V_14 -> V_77 [ V_9 ] ) ;
snprintf ( V_39 -> V_308 , sizeof( V_39 -> V_308 ) ,
L_37 , V_39 -> V_201 ,
F_171 ( V_14 -> V_46 ) , V_14 -> V_197 , V_14 -> V_68 ) ;
F_131 ( V_14 ) ;
if ( ( V_48 = F_172 ( V_39 ) ) < 0 ) {
F_173 ( V_39 ) ;
return V_48 ;
}
F_174 ( V_6 , V_39 ) ;
