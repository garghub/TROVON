...
V_31 = V_15 ;
V_15 = - V_28 ;
V_2 -> V_40 = F_24 ( V_8 , V_31 , 0 ) ;
if ( V_2 -> V_40 == NULL ) {
F_21 ( V_6 , L_9 ) ;
goto V_39;
}
V_2 -> V_41 = V_2 -> V_40 + V_27 ;
...
static int F_36 ( struct V_7 * V_8 , T_2 V_43 )
{
struct V_5 * V_6 = & V_8 -> V_6 ;
struct V_1 * V_2 = F_34 ( V_6 ) ;
unsigned long V_44 ;
...
F_37 ( & V_2 -> V_46 , V_44 ) ;
V_2 -> V_47 = 1 ;
for ( V_45 = 0 ; V_45 < V_2 -> V_48 ; V_45 ++ )
F_38 ( V_2 -> V_49 [ V_45 ] . V_50 ) ;
F_39 ( & V_2 -> V_46 , V_44 ) ;
while ( ! F_40 ( V_2 ) )
F_41 ( V_2 -> V_51 ,
F_40 ( V_2 ) ) ;
