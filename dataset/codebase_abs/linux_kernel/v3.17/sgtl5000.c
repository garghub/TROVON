...
int V_215 ;
struct V_44 * V_45 = F_14 ( V_7 ) ;
V_211 = F_50 ( V_45 -> V_166 [ V_216 ] . V_217 ) ;
V_212 = F_50 ( V_45 -> V_166 [ V_218 ] . V_217 ) ;
V_210 = F_50 ( V_45 -> V_166 [ V_219 ] . V_217 ) ;
V_211 = V_211 / 1000 ;
V_212 = V_212 / 1000 ;
V_210 = V_210 / 1000 ;
...
V_116 = F_56 ( V_7 -> V_86 , F_40 ( V_45 -> V_166 ) ,
V_45 -> V_166 ) ;
if ( V_116 )
goto V_249;
...
V_116 = F_61 ( V_45 -> V_167 , V_261 , V_260 ) ;
if ( V_116 )
return V_116 ;
}
return 0 ;
}
static int F_62 ( struct V_264 * V_265 ,
const struct V_266 * V_267 )
{
struct V_44 * V_45 ;
int V_116 , V_28 , V_268 ;
V_45 = F_63 ( & V_265 -> V_86 , sizeof( struct V_44 ) ,
V_147 ) ;
if ( ! V_45 )
return - V_148 ;
V_45 -> V_167 = F_64 ( V_265 , & V_269 ) ;
if ( F_34 ( V_45 -> V_167 ) ) {
V_116 = F_35 ( V_45 -> V_167 ) ;
F_17 ( & V_265 -> V_86 , L_13 , V_116 ) ;
return V_116 ;
}
V_45 -> V_270 = F_65 ( & V_265 -> V_86 , NULL ) ;
if ( F_34 ( V_45 -> V_270 ) ) {
V_116 = F_35 ( V_45 -> V_270 ) ;
F_17 ( & V_265 -> V_86 , L_14 , V_116 ) ;
if ( V_116 == - V_271 )
return - V_248 ;
return V_116 ;
}
V_116 = F_66 ( V_45 -> V_270 ) ;
if ( V_116 )
return V_116 ;
V_116 = F_67 ( V_45 -> V_167 , V_169 , & V_28 ) ;
if ( V_116 )
goto V_272;
if ( ( ( V_28 & V_273 ) >> V_274 ) !=
V_275 ) {
...
F_52 ( & V_265 -> V_86 , L_16 , V_268 ) ;
V_45 -> V_247 = V_268 ;
F_68 ( V_265 , V_45 ) ;
V_116 = F_60 ( V_45 ) ;
if ( V_116 )
goto V_272;
V_116 = F_69 ( & V_265 -> V_86 ,
& V_279 , & V_280 , 1 ) ;
if ( V_116 )
goto V_272;
return 0 ;
