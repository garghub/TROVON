...
if ( V_225 )
return V_225 ;
V_4 -> V_10 . V_227 = F_111 ( V_4 -> V_226 ) ;
F_42 ( V_138 | V_139 | V_140 | V_141 |
...
{
F_42 ( V_220 , V_4 -> V_10 . V_11 + V_4 -> V_229 ) ;
if ( V_4 -> V_229 != V_4 -> V_221 ) {
int V_230 ;
for ( V_230 = 0 ; V_230 < 10 ; ++ V_230 )
...
{
struct V_3 * V_4 = (struct V_3 * ) V_10 ;
unsigned int V_205 , V_220 , V_231 , V_232 ;
int V_225 ;
V_225 = F_108 ( V_10 ) ;
if ( V_225 )
goto V_233;
...
if ( V_225 )
goto V_233;
F_42 ( V_4 -> V_158 -> V_234 , V_4 -> V_10 . V_11 + V_235 ) ;
F_70 ( & V_4 -> V_10 . V_85 ) ;
V_231 = F_5 ( V_4 -> V_10 . V_11 + V_236 ) ;
V_232 = F_5 ( V_4 -> V_10 . V_11 + V_237 ) ;
V_220 = F_5 ( V_4 -> V_10 . V_11 + V_4 -> V_229 ) ;
V_205 = V_238 | V_239 | V_216 ;
F_42 ( V_205 , V_4 -> V_10 . V_11 + V_206 ) ;
F_42 ( 0 , V_4 -> V_10 . V_11 + V_236 ) ;
F_42 ( 1 , V_4 -> V_10 . V_11 + V_237 ) ;
F_112 ( V_4 , 0 ) ;
F_42 ( 0 , V_4 -> V_10 . V_11 + V_14 ) ;
while ( F_5 ( V_4 -> V_10 . V_11 + V_12 ) & V_164 )
F_84 () ;
F_42 ( V_231 , V_4 -> V_10 . V_11 + V_236 ) ;
F_42 ( V_232 , V_4 -> V_10 . V_11 + V_237 ) ;
F_112 ( V_4 , V_220 ) ;
V_205 = V_4 -> V_240 & ( V_208 | V_210 ) ;
V_205 |= V_238 | V_241 | V_239 ;
F_42 ( V_205 , V_4 -> V_10 . V_11 + V_206 ) ;
F_71 ( & V_4 -> V_10 . V_85 ) ;
...
V_243 &= ~ ( V_222 | V_244 ) ;
F_42 ( V_243 , V_4 -> V_10 . V_11 + V_242 ) ;
}
...
static void
F_120 ( struct V_119 * V_10 , struct V_245 * V_246 ,
struct V_245 * V_247 )
{
struct V_3 * V_4 = (struct V_3 * ) V_10 ;
unsigned int V_220 , V_240 ;
unsigned long V_83 ;
...
V_250 = 16 ;
V_248 = F_121 ( V_10 , V_246 , V_247 , 0 ,
V_10 -> V_227 / V_250 ) ;
#ifdef F_122
if ( V_4 -> V_68 . V_71 )
V_4 -> V_68 . V_72 = F_123 ( 10000000 , V_248 ) ;
#endif
if ( V_248 > V_10 -> V_227 / 16 )
V_249 = F_124 ( V_10 -> V_227 * 8 , V_248 ) ;
else
V_249 = F_124 ( V_10 -> V_227 * 4 , V_248 ) ;
...
V_220 |= V_244 ;
F_40 ( & V_10 -> V_85 , V_83 ) ;
F_125 ( V_10 , V_246 -> V_252 , V_248 ) ;
V_10 -> V_28 = V_26 | 255 ;
if ( V_246 -> V_267 & V_268 )
V_10 -> V_28 |= V_21 | V_22 ;
if ( V_246 -> V_267 & ( V_269 | V_270 | V_271 ) )
V_10 -> V_28 |= V_20 ;
V_10 -> V_272 = 0 ;
if ( V_246 -> V_267 & V_273 )
V_10 -> V_272 |= V_21 | V_22 ;
if ( V_246 -> V_267 & V_269 ) {
V_10 -> V_272 |= V_20 ;
if ( V_246 -> V_267 & V_273 )
V_10 -> V_272 |= V_26 ;
}
...
V_10 -> V_272 |= V_15 ;
if ( F_126 ( V_10 , V_246 -> V_252 ) )
F_91 ( V_10 ) ;
V_240 = F_5 ( V_10 -> V_11 + V_206 ) ;
...
F_42 ( V_249 & 0x3f , V_10 -> V_11 + V_236 ) ;
F_42 ( V_249 >> 6 , V_10 -> V_11 + V_237 ) ;
F_112 ( V_4 , V_220 ) ;
F_42 ( V_240 , V_10 -> V_11 + V_206 ) ;
F_45 ( & V_10 -> V_85 , V_83 ) ;
}
...
{
F_129 ( V_10 -> V_49 , V_279 ) ;
}
static int F_130 ( struct V_119 * V_10 )
{
return F_131 ( V_10 -> V_49 , V_279 , L_21 )
!= NULL ? 0 : - V_107 ;
}
...
static int F_133 ( struct V_119 * V_10 , struct V_281 * V_282 )
{
int V_117 = 0 ;
if ( V_282 -> type != V_283 && V_282 -> type != V_278 )
V_117 = - V_284 ;
if ( V_282 -> V_182 < 0 || V_282 -> V_182 >= V_285 )
V_117 = - V_284 ;
if ( V_282 -> V_286 < 9600 )
V_117 = - V_284 ;
return V_117 ;
...
static void
F_135 ( struct V_287 * V_288 , const char * V_289 , unsigned int V_100 )
{
...
V_293 = F_138 ( & V_4 -> V_10 . V_85 ) ;
else
F_66 ( & V_4 -> V_10 . V_85 ) ;
V_240 = F_5 ( V_4 -> V_10 . V_11 + V_206 ) ;
V_292 = V_240 & ~ V_276 ;
V_292 |= V_238 | V_239 ;
F_42 ( V_292 , V_4 -> V_10 . V_11 + V_206 ) ;
F_139 ( & V_4 -> V_10 , V_289 , V_100 , F_134 ) ;
do {
V_5 = F_5 ( V_4 -> V_10 . V_11 + V_12 ) ;
} while ( V_5 & V_164 );
F_42 ( V_240 , V_4 -> V_10 . V_11 + V_206 ) ;
if ( V_293 )
F_63 ( & V_4 -> V_10 . V_85 ) ;
F_140 ( V_83 ) ;
F_141 ( V_4 -> V_226 ) ;
...
static void T_4
F_142 ( struct V_3 * V_4 , int * V_248 ,
int * V_24 , int * V_296 )
{
if ( F_5 ( V_4 -> V_10 . V_11 + V_206 ) & V_238 ) {
unsigned int V_220 , V_232 , V_231 ;
V_220 = F_5 ( V_4 -> V_10 . V_11 + V_4 -> V_221 ) ;
* V_24 = 'n' ;
if ( V_220 & V_264 ) {
if ( V_220 & V_266 )
...
V_232 = F_5 ( V_4 -> V_10 . V_11 + V_237 ) ;
V_231 = F_5 ( V_4 -> V_10 . V_11 + V_236 ) ;
* V_248 = V_4 -> V_10 . V_227 * 4 / ( 64 * V_232 + V_231 ) ;
if ( V_4 -> V_158 -> V_251 ) {
...
static int T_4 F_143 ( struct V_287 * V_288 , char * V_297 )
{
struct V_3 * V_4 ;
int V_248 = 38400 ;
int V_296 = 8 ;
...
V_4 -> V_10 . V_227 = F_111 ( V_4 -> V_226 ) ;
if ( V_297 )
F_145 ( V_297 , & V_248 , & V_24 , & V_296 , & V_298 ) ;
else
F_142 ( V_4 , & V_248 , & V_24 , & V_296 ) ;
return F_146 ( & V_4 -> V_10 , V_288 , V_248 , V_24 , V_296 , V_298 ) ;
}
static void F_147 ( struct V_119 * V_10 , int V_301 )
{
while ( F_148 ( V_10 -> V_11 + V_12 ) & V_118 )
;
F_149 ( V_301 , V_10 -> V_11 + V_14 ) ;
while ( F_148 ( V_10 -> V_11 + V_12 ) & V_164 )
;
}
static void F_150 ( struct V_287 * V_302 , const char * V_289 , unsigned V_303 )
{
struct V_304 * V_2 = V_302 -> V_81 ;
F_139 ( & V_2 -> V_10 , V_289 , V_303 , F_147 ) ;
}
static int T_4 F_151 ( struct V_304 * V_40 ,
const char * V_305 )
{
if ( ! V_40 -> V_10 . V_11 )
return - V_300 ;
V_40 -> V_302 -> V_306 = F_150 ;
return 0 ;
}
static int F_152 ( int V_291 , struct V_40 * V_2 )
{
struct V_307 * V_308 ;
...
if ( ! V_308 )
return V_117 ;
V_117 = F_154 ( V_308 , L_22 ) ;
if ( F_155 ( V_117 ) ) {
V_310 = true ;
V_117 = V_291 ;
} else {
V_309 = true ;
if ( V_117 >= F_156 ( V_290 ) || V_290 [ V_117 ] != NULL ) {
F_62 ( V_2 , L_23 , V_117 ) ;
V_117 = V_291 ;
}
}
...
static int F_157 ( struct V_1 * V_2 , const struct V_313 * V_314 )
{
struct V_3 * V_4 ;
struct V_315 * V_158 = V_314 -> V_81 ;
void T_10 * V_316 ;
int V_230 , V_117 ;
for ( V_230 = 0 ; V_230 < F_156 ( V_290 ) ; V_230 ++ )
if ( V_290 [ V_230 ] == NULL )
break;
if ( V_230 == F_156 ( V_290 ) )
return - V_107 ;
V_4 = F_158 ( & V_2 -> V_2 , sizeof( struct V_3 ) ,
V_42 ) ;
if ( V_4 == NULL )
return - V_43 ;
V_230 = F_152 ( V_230 , & V_2 -> V_2 ) ;
V_316 = F_159 ( & V_2 -> V_2 , V_2 -> V_317 . V_318 ,
F_160 ( & V_2 -> V_317 ) ) ;
if ( ! V_316 )
return - V_43 ;
V_4 -> V_226 = F_161 ( & V_2 -> V_2 , NULL ) ;
if ( F_162 ( V_4 -> V_226 ) )
return F_163 ( V_4 -> V_226 ) ;
V_4 -> V_158 = V_158 ;
V_4 -> V_229 = V_158 -> V_229 ;
V_4 -> V_221 = V_158 -> V_221 ;
V_4 -> V_240 = 0 ;
V_4 -> V_55 = V_158 -> V_319 ( V_2 ) ;
V_4 -> V_10 . V_2 = & V_2 -> V_2 ;
V_4 -> V_10 . V_49 = V_2 -> V_317 . V_318 ;
V_4 -> V_10 . V_11 = V_316 ;
V_4 -> V_10 . V_320 = V_321 ;
V_4 -> V_10 . V_182 = V_2 -> V_182 [ 0 ] ;
V_4 -> V_10 . V_55 = V_4 -> V_55 ;
V_4 -> V_10 . V_322 = & V_323 ;
V_4 -> V_10 . V_83 = V_324 ;
V_4 -> V_10 . line = V_230 ;
F_34 ( & V_2 -> V_2 , V_4 ) ;
...
static int F_172 ( struct V_40 * V_2 )
{
struct V_3 * V_4 = F_173 ( V_2 ) ;
if ( ! V_4 )
return - V_284 ;
return F_174 ( & V_325 , & V_4 -> V_10 ) ;
}
static int F_175 ( struct V_40 * V_2 )
{
struct V_3 * V_4 = F_173 ( V_2 ) ;
if ( ! V_4 )
return - V_284 ;
return F_176 ( & V_325 , & V_4 -> V_10 ) ;
}
