...
{
struct V_181 * V_55 = F_93 ( V_11 ) ;
struct V_182 * V_10 = F_94 ( V_11 ) ;
...
static int F_101 ( struct V_117 * V_11 )
{
struct V_181 * V_55 = F_93 ( V_11 ) ;
struct V_182 * V_10 = F_94 ( V_11 ) ;
struct V_1 * V_2 = V_10 -> V_81 ;
...
static int
F_111 ( struct V_182 * V_10 , struct V_181 * V_55 ,
struct V_1 * * V_192 )
{
struct V_1 * V_2 ;
int V_82 , V_193 ;
static struct V_194 V_160 = {
. V_195 = F_110 ,
} ;
T_3 V_25 ;
* V_192 = NULL ;
if ( ( V_82 = F_103 ( V_55 ) ) < 0 )
return V_82 ;
...
V_2 -> V_54 = - 1 ;
F_114 ( & V_2 -> V_53 ) ;
V_2 -> V_99 [ V_19 ] . V_107 = V_196 * 1024 ;
V_2 -> V_99 [ V_22 ] . V_107 = V_197 * 1024 ;
V_2 -> V_120 = F_115 ( V_55 , 0 ) ;
V_2 -> V_198 = F_115 ( V_55 , 1 ) ;
...
V_2 -> V_9 += V_209 + V_210 ;
if ( V_211 >= V_2 -> V_9 && V_211 < V_2 -> V_175 )
V_2 -> V_175 = V_211 ;
else {
if ( ( V_82 = F_88 ( V_2 ) ) < 0 )
goto V_200;
...
V_2 -> V_30 = 0 ;
F_72 ( V_2 ) ;
if ( ( V_82 = F_117 ( V_10 , V_213 , V_2 , & V_160 ) ) < 0 )
goto V_200;
* V_192 = V_2 ;
return 0 ;
V_200:
...
static int F_118 ( struct V_181 * V_55 ,
...
V_82 = F_121 ( & V_55 -> V_11 , V_222 , V_171 , V_223 , 0 , & V_10 ) ;
if ( V_82 < 0 )
return V_82 ;
switch ( V_55 -> V_117 ) {
case V_224 :
strcpy ( V_10 -> V_121 , L_15 ) ;
break;
case V_225 :
strcpy ( V_10 -> V_121 , L_25 ) ;
break;
case V_226 :
strcpy ( V_10 -> V_121 , L_26 ) ;
break;
default:
F_15 ( & V_55 -> V_11 , L_27 , V_55 -> V_117 ) ;
F_122 ( V_10 ) ;
return - V_91 ;
}
if ( V_227 )
...
sprintf ( V_10 -> V_228 , L_30 , V_10 -> V_121 ) ;
sprintf ( V_10 -> V_229 , L_31 ,
V_10 -> V_228 ,
V_2 -> V_120 , V_2 -> V_198 , V_2 -> V_54 ) ;
if ( ( V_82 = F_123 ( V_10 ) ) < 0 ) {
F_122 ( V_10 ) ;
return V_82 ;
}
F_124 ( V_55 , V_10 ) ;
...
static void F_125 ( struct V_181 * V_55 )
{
F_122 ( F_126 ( V_55 ) ) ;
}
