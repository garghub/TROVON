...
static int F_100 ( struct V_210 * V_134 ,
struct V_209 * V_44 )
{
struct V_24 * V_25 = V_134 -> V_56 ;
struct V_1 * V_1 ;
...
static int F_112 ( struct V_209 * V_44 ,
...
if ( ! V_186 )
V_186 = V_173 ;
V_116 = F_113 ( & V_44 -> V_23 , V_229 , V_230 , V_231 ,
sizeof( * V_25 ) , & V_134 ) ;
if ( V_116 < 0 )
goto V_220;
...
L_13 ,
V_134 -> V_233 , F_114 ( V_25 -> V_114 [ 0 ] ) ,
V_25 -> V_27 , V_25 -> V_22 ) ;
V_116 = F_115 ( V_134 ) ;
if ( V_116 )
goto V_234;
...
static void F_118 ( struct V_209 * V_44 )
{
F_117 ( F_119 ( V_44 ) ) ;
}
