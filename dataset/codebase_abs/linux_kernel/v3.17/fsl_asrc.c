...
if ( F_84 ( V_152 , L_19 ) )
V_163 . V_164 = V_165 ;
V_8 -> V_22 = F_85 ( & V_11 -> V_10 , L_20 , V_156 ,
& V_163 ) ;
if ( F_82 ( V_8 -> V_22 ) ) {
F_3 ( & V_11 -> V_10 , L_21 ) ;
...
V_139 = F_86 ( V_11 , 0 ) ;
if ( V_139 < 0 ) {
F_3 ( & V_11 -> V_10 , L_22 , V_152 -> V_166 ) ;
return V_139 ;
}
V_14 = F_87 ( & V_11 -> V_10 , V_139 , F_71 , 0 ,
V_8 -> V_75 , V_8 ) ;
if ( V_14 ) {
F_3 ( & V_11 -> V_10 , L_23 , V_139 , V_14 ) ;
return V_14 ;
}
V_8 -> V_167 = F_88 ( & V_11 -> V_10 , L_20 ) ;
if ( F_82 ( V_8 -> V_167 ) ) {
F_3 ( & V_11 -> V_10 , L_24 ) ;
return F_83 ( V_8 -> V_167 ) ;
}
V_8 -> V_168 = F_88 ( & V_11 -> V_10 , L_25 ) ;
if ( F_82 ( V_8 -> V_168 ) ) {
F_3 ( & V_11 -> V_10 , L_26 ) ;
return F_83 ( V_8 -> V_168 ) ;
}
for ( V_13 = 0 ; V_13 < V_169 ; V_13 ++ ) {
sprintf ( V_157 , L_27 , V_13 ) ;
V_8 -> V_56 [ V_13 ] = F_88 ( & V_11 -> V_10 , V_157 ) ;
if ( F_82 ( V_8 -> V_56 [ V_13 ] ) ) {
F_3 ( & V_11 -> V_10 , L_28 , V_157 ) ;
return F_83 ( V_8 -> V_56 [ V_13 ] ) ;
}
}
if ( F_89 ( V_11 -> V_10 . V_153 , L_29 ) ) {
V_8 -> V_58 = 3 ;
V_53 [ V_52 ] = V_170 ;
V_53 [ V_54 ] = V_171 ;
} else {
...
V_14 = F_69 ( V_8 ) ;
if ( V_14 ) {
F_3 ( & V_11 -> V_10 , L_30 , V_14 ) ;
return - V_21 ;
}
V_8 -> V_20 = 10 ;
V_14 = F_90 ( V_152 , L_31 ,
& V_8 -> V_94 ) ;
if ( V_14 ) {
F_3 ( & V_11 -> V_10 , L_32 ) ;
return - V_21 ;
