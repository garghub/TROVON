...
{
const struct V_31 * V_32 = F_14 ( V_2 ) ;
struct V_5 * V_6 = V_2 -> V_7 ;
F_15 ( V_2 , 0 , V_33 ) ;
F_16 ( V_2 , 0x00 , V_34 ) ;
F_16 ( V_2 , 0x80 , V_35 ) ;
F_16 ( V_2 , 0x00 , V_36 ) ;
F_17 ( V_2 , V_32 -> V_37 / 2 , V_38 ) ;
V_6 -> V_39 = 0 ;
F_18 ( V_2 , V_6 -> V_40 |
V_41 ,
V_42 ) ;
F_18 ( V_2 , V_6 -> V_40 , V_42 ) ;
}
...
if ( V_32 -> V_54 == V_73 )
V_6 -> V_74 = 1 ;
V_8 = F_32 ( V_2 , V_6 -> V_21 ) ;
if ( V_8 < 0 )
return V_8 ;
V_6 -> V_9 = F_33 ( V_6 -> V_21 ) ;
if ( V_6 -> V_9 == NULL )
return - V_53 ;
V_6 -> V_10 = F_33 ( V_6 -> V_21 ) ;
if ( V_6 -> V_10 == NULL )
return - V_53 ;
V_6 -> V_12 = F_33 ( V_6 -> V_21 ) ;
if ( V_6 -> V_12 == NULL )
return - V_53 ;
V_6 -> V_11 [ 0 ] = F_33 ( V_6 -> V_21 ) ;
if ( V_6 -> V_11 [ 0 ] == NULL )
return - V_53 ;
V_6 -> V_11 [ 1 ] = F_33 ( V_6 -> V_21 ) ;
if ( V_6 -> V_11 [ 1 ] == NULL )
return - V_53 ;
if ( V_6 -> V_56 )
F_7 ( V_2 ) ;
...
V_2 -> V_77 [ F_36 ( 0 ) ] . V_79 = & F_4 ;
V_2 -> V_77 [ F_36 ( 1 ) ] . V_79 = & F_5 ;
V_2 -> V_77 [ V_81 ] . V_79 = & F_6 ;
return 0 ;
}
static int F_37 ( struct V_46 * V_2 ,
const struct V_82 * V_83 )
{
return F_38 ( V_2 , & V_84 , V_83 -> V_85 ) ;
}
