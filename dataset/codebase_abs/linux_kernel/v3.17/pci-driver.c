...
static T_1 F_11 ( struct V_22 * V_20 , const char * V_23 ,
T_2 V_24 )
{
...
return - V_31 ;
if ( V_30 != 7 ) {
struct V_32 * V_33 = F_2 ( sizeof( * V_33 ) , V_13 ) ;
if ( ! V_33 )
return - V_14 ;
V_33 -> V_3 = V_3 ;
V_33 -> V_4 = V_4 ;
...
static T_1 F_14 ( struct V_22 * V_20 , const char * V_23 ,
T_2 V_24 )
{
struct V_10 * V_11 , * V_21 ;
struct V_1 * V_25 = F_12 ( V_20 ) ;
...
const struct V_26 * F_13 ( const struct V_26 * V_27 ,
struct V_32 * V_38 )
{
if ( V_27 ) {
while ( V_27 -> V_3 || V_27 -> V_5 || V_27 -> V_8 ) {
...
{
int error , V_18 ;
struct V_44 V_45 = { V_2 , V_38 , V_15 } ;
V_18 = F_23 ( & V_38 -> V_38 ) ;
if ( V_18 >= 0 && V_18 != F_24 () ) {
int V_49 ;
F_25 () ;
V_49 = F_26 ( F_27 ( V_18 ) , V_50 ) ;
if ( V_49 < V_51 )
...
const struct V_26 * V_15 ;
int error = 0 ;
if ( ! V_32 -> V_20 && V_2 -> V_48 ) {
error = - V_37 ;
V_15 = F_16 ( V_2 , V_32 ) ;
if ( V_15 )
error = F_22 ( V_2 , V_32 , V_15 ) ;
if ( error >= 0 )
error = 0 ;
}
return error ;
...
{
struct V_32 * V_32 = F_32 ( V_38 ) ;
const struct V_76 * V_72 = V_38 -> V_20 ? V_38 -> V_20 -> V_72 : NULL ;
if ( F_66 ( V_32 ) )
...
const char * V_102 )
{
V_2 -> V_20 . V_41 = V_2 -> V_41 ;
V_2 -> V_20 . V_103 = & V_104 ;
V_2 -> V_20 . V_101 = V_101 ;
V_2 -> V_20 . V_102 = V_102 ;
F_89 ( & V_2 -> V_16 . V_17 ) ;
F_90 ( & V_2 -> V_16 . V_19 ) ;
...
static int F_95 ( struct V_4 * V_38 , struct V_22 * V_2 )
{
struct V_32 * V_32 = F_32 ( V_38 ) ;
struct V_1 * V_46 ;
