...
static void F_63 ( int V_58 , int V_45 ,
struct V_9 * V_68 )
{
if ( V_58 != - V_69 || V_45 )
return;
...
static inline int
F_76 ( struct V_1 * V_2 , int V_62 ,
int (* F_77)( struct V_1 * V_2 , int V_62 ,
struct V_63 * V_64 ,
enum V_34 V_35 ) )
{
...
return F_77 ( V_2 , V_62 , NULL , V_61 ) ;
}
static inline int
...
return F_77 ( V_2 , V_62 , V_64 , V_35 ) ;
}
static inline int
F_79 ( struct V_1 * V_2 ,
...
{
F_82 () ;
return F_76 ( V_2 , V_65 , F_66 ) ;
}
int F_84 ( struct V_1 * V_2 ,
struct V_63 * V_64 )
{
F_82 () ;
return F_78 ( V_2 , V_65 , V_64 ,
V_74 ,
F_66 ) ;
}
int
F_85 ( struct V_1 * V_2 , struct V_63 * V_64 )
{
F_82 () ;
return F_78 ( V_2 , V_65 , V_64 ,
V_61 ,
...
void F_92 ( struct V_1 * V_2 , const char * V_76 )
{
V_2 -> V_4 = NULL ;
F_93 ( & V_2 -> V_8 ) ;
V_2 -> V_19 = V_77 ;
...
struct V_3 * F_100 ( struct V_1 * V_2 )
{
if ( ! F_2 ( V_2 ) )
return NULL ;
