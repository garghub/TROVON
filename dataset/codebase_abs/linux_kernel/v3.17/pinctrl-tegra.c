...
unsigned V_96 , unsigned long * V_31 )
{
F_14 ( V_8 -> V_20 , L_10 ) ;
return - V_95 ;
}
static int F_35 ( struct V_7 * V_8 ,
unsigned V_96 , unsigned long * V_32 ,
unsigned V_33 )
{
F_14 ( V_8 -> V_20 , L_11 ) ;
return - V_95 ;
...
enum V_51 V_39 = F_37 ( V_31 ) ;
T_4 V_97 = F_39 ( V_31 ) ;
const char * V_100 = L_8 ;
int V_29 ;
for ( V_29 = 0 ; V_29 < F_15 ( V_38 ) ; V_29 ++ ) {
if ( V_38 [ V_29 ] . V_39 == V_39 ) {
V_100 = V_38 [ V_29 ] . V_35 ;
break;
}
}
F_10 ( V_18 , L_15 , F_42 ( V_100 ) , V_97 ) ;
}
int F_45 ( struct V_101 * V_102 ,
...
V_2 = F_46 ( & V_102 -> V_20 , sizeof( * V_2 ) , V_111 ) ;
if ( ! V_2 ) {
F_14 ( & V_102 -> V_20 , L_16 ) ;
return - V_112 ;
}
V_2 -> V_20 = & V_102 -> V_20 ;
V_2 -> V_9 = V_104 ;
V_2 -> V_107 = F_46 ( & V_102 -> V_20 ,
V_104 -> V_10 * 4 * sizeof( * V_2 -> V_107 ) ,
V_111 ) ;
if ( ! V_2 -> V_107 )
return - V_112 ;
V_107 = V_2 -> V_107 ;
for ( V_108 = 0 ; V_108 < V_104 -> V_42 ; V_108 ++ ) {
struct V_113 * V_114 = & V_104 -> V_43 [ V_108 ] ;
V_114 -> V_12 = V_107 ;
for ( V_109 = 0 ; V_109 < V_104 -> V_10 ; V_109 ++ ) {
const struct V_45 * V_46 = & V_104 -> V_12 [ V_109 ] ;
if ( V_46 -> V_47 == - 1 )
continue;
for ( V_110 = 0 ; V_110 < 4 ; V_110 ++ )
if ( V_46 -> V_48 [ V_110 ] == V_108 )
break;
if ( V_110 == 4 )
continue;
F_47 ( V_107 - V_2 -> V_107 >=
V_104 -> V_10 * 4 ) ;
* V_107 ++ = V_46 -> V_13 ;
V_114 -> V_10 ++ ;
}
}
V_115 . V_16 = V_2 -> V_9 -> V_116 ;
V_117 . V_13 = F_11 ( & V_102 -> V_20 ) ;
V_117 . V_14 = V_2 -> V_9 -> V_14 ;
V_117 . V_16 = V_2 -> V_9 -> V_16 ;
for ( V_29 = 0 ; ; V_29 ++ ) {
V_106 = F_48 ( V_102 , V_118 , V_29 ) ;
if ( ! V_106 )
break;
}
V_2 -> V_119 = V_29 ;
V_2 -> V_5 = F_46 ( & V_102 -> V_20 , V_2 -> V_119 * sizeof( * V_2 -> V_5 ) ,
V_111 ) ;
if ( ! V_2 -> V_5 ) {
F_14 ( & V_102 -> V_20 , L_17 ) ;
return - V_112 ;
}
for ( V_29 = 0 ; V_29 < V_2 -> V_119 ; V_29 ++ ) {
V_106 = F_48 ( V_102 , V_118 , V_29 ) ;
V_2 -> V_5 [ V_29 ] = F_49 ( & V_102 -> V_20 , V_106 ) ;
if ( F_50 ( V_2 -> V_5 [ V_29 ] ) )
return F_51 ( V_2 -> V_5 [ V_29 ] ) ;
}
V_2 -> V_120 = F_52 ( & V_117 , & V_102 -> V_20 , V_2 ) ;
if ( ! V_2 -> V_120 ) {
F_14 ( & V_102 -> V_20 , L_18 ) ;
return - V_121 ;
}
F_53 ( V_2 -> V_120 , & V_115 ) ;
F_54 ( V_102 , V_2 ) ;
F_55 ( & V_102 -> V_20 , L_19 ) ;
return 0 ;
}
int F_56 ( struct V_101 * V_102 )
{
struct V_1 * V_2 = F_57 ( V_102 ) ;
F_58 ( V_2 -> V_120 ) ;
return 0 ;
}
