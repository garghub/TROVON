...
F_43 ( V_70 -> V_410 [ V_338 ] . V_414 ,
& V_70 -> V_415 [ V_338 ] ) ;
F_44 ( F_28 ( V_70 -> V_410 ) , V_70 -> V_410 ) ;
return 0 ;
}
...
V_28 = F_46 ( V_2 -> V_9 , F_28 ( V_70 -> V_410 ) ,
V_70 -> V_410 ) ;
if ( V_28 ) {
...
for ( V_338 = 0 ; V_338 < F_28 ( V_70 -> V_410 ) ; V_338 ++ ) {
V_28 = F_47 ( V_70 -> V_410 [ V_338 ] . V_414 ,
& V_70 -> V_415 [ V_338 ] ) ;
if ( V_28 ) {
F_13 ( V_2 -> V_9 ,
L_37 ,
...
static int F_51 ( struct V_449 * V_450 )
{
struct V_69 * V_70 ;
int V_28 ;
V_70 = F_52 ( & V_450 -> V_9 , sizeof( * V_70 ) , V_451 ) ;
if ( ! V_70 )
return - V_452 ;
F_53 ( V_450 , V_70 ) ;
V_70 -> V_411 = F_54 ( V_450 , & V_453 ) ;
if ( F_55 ( V_70 -> V_411 ) ) {
V_28 = F_56 ( V_70 -> V_411 ) ;
...
static int F_58 ( struct V_449 * V_450 )
{
F_59 ( & V_450 -> V_9 ) ;
return 0 ;
}
static int F_60 ( struct V_456 * V_457 ,
const struct V_458 * V_299 )
{
struct V_69 * V_70 ;
int V_28 ;
V_70 = F_52 ( & V_457 -> V_9 , sizeof( * V_70 ) , V_451 ) ;
if ( ! V_70 )
return - V_452 ;
F_61 ( V_457 , V_70 ) ;
V_70 -> V_411 = F_62 ( V_457 , & V_453 ) ;
if ( F_55 ( V_70 -> V_411 ) ) {
V_28 = F_56 ( V_70 -> V_411 ) ;
...
static int F_63 ( struct V_456 * V_459 )
{
F_59 ( & V_459 -> V_9 ) ;
return 0 ;
}
