...
V_75 = F_30 ( V_6 -> V_14 , F_14 ( V_77 -> V_102 ) ,
V_77 -> V_102 ) ;
if ( V_75 ) {
...
for ( V_63 = 0 ; V_63 < F_14 ( V_77 -> V_102 ) ; V_63 ++ ) {
V_75 = F_31 ( V_77 -> V_102 [ V_63 ] . V_104 ,
& V_77 -> V_105 [ V_63 ] ) ;
if ( V_75 != 0 ) {
F_10 ( V_6 -> V_14 ,
L_13 ,
...
struct V_76 * V_77 ;
int V_75 ;
V_77 = F_34 ( & V_115 -> V_14 , sizeof *V_77 , V_116 ) ;
if ( ! V_77 )
return - V_117 ;
V_77 -> V_103 = F_35 ( V_115 , & V_118 ) ;
if ( F_36 ( V_77 -> V_103 ) ) {
V_75 = F_37 ( V_77 -> V_103 ) ;
return V_75 ;
}
F_38 ( V_115 , V_77 ) ;
V_75 = F_39 ( & V_115 -> V_14 ,
& V_119 , & V_120 , 1 ) ;
return V_75 ;
}
...
static int F_42 ( struct V_121 * V_122 ,
const struct V_123 * V_124 )
{
struct V_76 * V_77 ;
int V_75 ;
V_77 = F_34 ( & V_122 -> V_14 , sizeof *V_77 , V_116 ) ;
if ( ! V_77 )
return - V_117 ;
V_77 -> V_103 = F_43 ( V_122 , & V_118 ) ;
if ( F_36 ( V_77 -> V_103 ) ) {
V_75 = F_37 ( V_77 -> V_103 ) ;
return V_75 ;
}
F_44 ( V_122 , V_77 ) ;
V_75 = F_39 ( & V_122 -> V_14 ,
& V_119 , & V_120 , 1 ) ;
return V_75 ;
}
