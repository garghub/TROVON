...
{
const struct V_65 * V_66 = F_16 ( V_2 ) ;
int V_67 = 0 ;
unsigned int V_68 ;
V_67 |= F_17 ( & V_3 -> V_69 , V_70 ) ;
V_67 |= F_17 ( & V_3 -> V_71 , V_72 ) ;
V_67 |= F_17 ( & V_3 -> V_73 , V_72 ) ;
V_67 |= F_17 ( & V_3 -> V_74 , V_75 ) ;
V_67 |= F_17 ( & V_3 -> V_76 , V_75 ) ;
if ( V_67 )
return 1 ;
if ( V_67 )
return 2 ;
V_67 |= F_18 ( & V_3 -> V_77 , 0 ) ;
if ( V_3 -> V_71 == V_72 ) {
V_67 |= F_19 ( & V_3 -> V_78 ,
V_66 -> V_79 ) ;
V_67 |= F_20 ( & V_3 -> V_78 ,
...
V_67 |= F_18 ( & V_3 -> V_81 , V_3 -> V_82 ) ;
if ( V_3 -> V_76 == V_75 )
V_67 |= F_20 ( & V_3 -> V_83 , 0x00ffffff ) ;
else
V_67 |= F_18 ( & V_3 -> V_83 , 0 ) ;
if ( V_67 )
return 3 ;
if ( V_3 -> V_71 == V_72 ) {
V_68 = V_3 -> V_78 ;
F_14 ( 100 , & V_68 , V_3 -> V_56 ) ;
V_67 |= F_18 ( & V_3 -> V_78 , V_68 ) ;
}
if ( V_3 -> V_73 == V_72 ) {
V_68 = V_3 -> V_80 ;
F_14 ( 50 , & V_68 , V_3 -> V_56 ) ;
V_67 |= F_18 ( & V_3 -> V_80 , V_68 ) ;
if ( V_3 -> V_71 == V_72 ) {
...
V_15 = F_22 ( V_3 -> V_88 [ V_4 ] ) ;
V_84 = F_23 ( V_3 -> V_88 [ V_4 ] ) ;
F_2 ( ( V_84 << 6 ) | V_15 , V_2 -> V_6 + V_33 + V_4 ) ;
}
V_85 = F_24 ( V_3 -> V_88 [ 0 ] ) ;
F_2 ( V_3 -> V_81 , V_2 -> V_6 + F_7 ( 0 ) ) ;
if ( V_3 -> V_73 == V_72 ) {
V_57 = F_14 ( 50 , & V_3 -> V_80 , V_3 -> V_56 ) ;
...
V_87 = V_89 | 0 | 0 ;
F_2 ( V_87 , V_2 -> V_6 + F_7 ( 5 ) ) ;
F_2 ( V_85 == V_90 , V_2 -> V_6 + F_7 ( 6 ) ) ;
...
static int F_25 ( struct V_1 * V_2 , struct V_21 * V_22 ,
...
V_15 = F_22 ( V_94 -> V_95 ) ;
for ( V_4 = 0 ; V_4 < V_94 -> V_96 ; V_4 ++ ) {
F_8 ( V_2 , V_97 , V_15 , V_19 [ V_4 ] ) ;
V_24 -> V_98 [ V_15 ] = V_19 [ V_4 ] ;
}
return V_4 ;
}
...
V_15 = F_22 ( V_94 -> V_95 ) ;
for ( V_4 = 0 ; V_4 < V_94 -> V_96 ; V_4 ++ )
V_19 [ V_4 ] = V_24 -> V_98 [ V_15 ] ;
return V_4 ;
}
static void F_28 ( struct V_1 * V_2 , int V_99 )
{
...
unsigned int * V_19 )
{
unsigned int V_15 = F_22 ( V_94 -> V_95 ) ;
unsigned int V_101 ;
int V_102 ;
if ( V_15 < 4 )
V_101 = 0x0f ;
...
V_101 = 0xf0 ;
V_102 = F_30 ( V_2 , V_22 , V_94 , V_19 , V_101 ) ;
if ( V_102 )
return V_102 ;
F_28 ( V_2 , ( V_22 -> V_103 & 0x01 ) | ( ( V_22 -> V_103 & 0x10 ) >> 3 ) ) ;
return V_94 -> V_96 ;
}
...
unsigned int * V_19 )
{
unsigned int V_106 = F_22 ( V_94 -> V_95 ) ;
int V_4 ;
for ( V_4 = 0 ; V_4 < V_94 -> V_96 ; V_4 ++ ) {
...
V_24 = F_37 ( V_2 , sizeof( * V_24 ) ) ;
if ( ! V_24 )
return - V_117 ;
V_102 = F_38 ( V_2 ) ;
if ( V_102 < 0 )
return V_102 ;
V_2 -> V_6 = F_39 ( V_111 , 0 ) ;
if ( ! V_2 -> V_6 )
return - V_117 ;
if ( V_111 -> V_38 ) {
V_102 = F_40 ( V_111 -> V_38 , F_12 , V_118 ,
V_2 -> V_115 , V_2 ) ;
if ( V_102 == 0 )
V_2 -> V_38 = V_111 -> V_38 ;
}
...
static int F_46 ( struct V_110 * V_2 ,
const struct V_148 * V_149 )
{
return F_47 ( V_2 , & V_150 , V_149 -> V_151 ) ;
}
