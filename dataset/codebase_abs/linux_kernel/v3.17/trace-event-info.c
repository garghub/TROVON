...
! F_13 ( V_30 -> V_37 , V_26 ) )
continue;
if ( F_17 ( & V_31 , L_17 , V_24 , V_30 -> V_37 ) < 0 ) {
V_14 = - V_23 ;
goto V_18;
}
V_34 = V_21 ( V_31 , & V_22 ) ;
...
static bool F_21 ( char * V_24 , struct V_25 * V_26 )
{
while ( V_26 ) {
...
! F_21 ( V_30 -> V_37 , V_26 ) )
continue;
if ( F_17 ( & V_24 , L_24 , V_20 , V_30 -> V_37 ) < 0 ) {
V_14 = - V_23 ;
goto V_18;
}
V_34 = V_21 ( V_24 , & V_22 ) ;
...
static struct V_25 *
F_27 ( struct V_39 * V_40 )
{
struct V_25 V_20 , * V_41 = & V_20 ;
struct V_42 * V_43 ;
int V_44 = 0 ;
F_28 (pos, pattrs, node) {
if ( V_43 -> V_45 . type != V_46 )
continue;
++ V_44 ;
if ( V_43 -> V_27 ) {
V_41 -> V_28 = F_29 ( V_43 -> V_27 ) ;
if ( V_41 -> V_28 )
goto V_28;
...
struct V_51 * F_33 ( struct V_39 * V_40 ,
int V_13 , bool V_52 )
{
struct V_25 * V_26 ;
struct V_51 * V_53 ;
...
int F_37 ( int V_13 , struct V_39 * V_40 )
{
int V_14 ;
struct V_51 * V_53 ;
V_53 = F_33 ( V_40 , V_13 , false ) ;
if ( ! V_53 )
return - V_23 ;
V_14 = F_35 ( V_53 ) ;
return V_14 ;
