...
static int F_47 ( struct V_86 * V_44 )
{
...
if ( V_11 -> V_61 <= 0 || V_11 -> V_61 > V_92 ) {
F_20 ( & V_88 -> V_44 , L_8 ,
V_11 -> V_61 ) ;
return - V_90 ;
}
if ( V_11 -> V_12 <= 0 || V_11 -> V_12 > V_93 ) {
F_20 ( & V_88 -> V_44 , L_9 ,
V_11 -> V_12 ) ;
return - V_90 ;
}
...
{
struct V_94 * V_95 = V_88 -> V_44 . V_96 ;
struct V_89 * V_11 ;
if ( ! F_54 ( V_97 ) || V_95 == NULL )
return V_88 -> V_44 . V_98 ;
V_11 = F_55 ( & V_88 -> V_44 , sizeof( * V_11 ) , V_99 ) ;
if ( V_11 == NULL )
return NULL ;
if ( F_56 ( V_95 , L_10 ) )
V_11 -> V_52 |= V_53 ;
...
if ( F_56 ( V_95 , L_12 ) )
V_11 -> V_52 |= V_59 ;
F_57 ( V_95 , L_13 , & V_11 -> V_57 ) ;
F_57 ( V_95 , L_14 , & V_11 -> V_61 ) ;
F_57 ( V_95 , L_15 , & V_11 -> V_12 ) ;
return V_11 ;
}
...
struct V_100 * V_101 ;
int V_8 ;
V_7 = F_55 ( & V_88 -> V_44 , sizeof( * V_7 ) , V_99 ) ;
if ( V_7 == NULL )
return - V_102 ;
V_7 -> V_44 = & V_88 -> V_44 ;
F_59 ( & V_7 -> V_84 ) ;
...
if ( V_7 -> V_11 == NULL )
return - V_103 ;
V_8 = F_52 ( V_88 , V_7 -> V_11 ) ;
if ( V_8 < 0 )
return V_8 ;
V_101 = F_61 ( V_88 , V_104 , 0 ) ;
V_7 -> V_105 = F_62 ( & V_88 -> V_44 , V_101 ) ;
if ( F_23 ( V_7 -> V_105 ) )
return F_24 ( V_7 -> V_105 ) ;
V_7 -> clock = F_63 ( & V_88 -> V_44 , NULL ) ;
if ( F_23 ( V_7 -> clock ) ) {
F_20 ( & V_88 -> V_44 , L_16 ) ;
return F_24 ( V_7 -> clock ) ;
}
V_1 = F_61 ( V_88 , V_106 , 0 ) ;
if ( ! V_1 ) {
F_20 ( & V_88 -> V_44 , L_17 ) ;
return - V_90 ;
}
V_8 = F_64 ( & V_88 -> V_44 , V_1 -> V_107 , F_1 ,
V_108 , F_18 ( & V_88 -> V_44 ) , V_7 ) ;
if ( V_8 < 0 ) {
F_20 ( & V_88 -> V_44 , L_18 ) ;
return V_8 ;
}
