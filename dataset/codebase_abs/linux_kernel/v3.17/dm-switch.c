...
static int F_38 ( struct V_2 * V_3 , unsigned V_64 ,
unsigned long V_65 )
{
struct V_1 * V_6 = V_3 -> V_9 ;
struct V_66 * V_49 ;
...
V_67 = V_6 -> V_35 [ V_26 ] . V_36 -> V_67 ;
if ( V_3 -> V_11 + V_6 -> V_35 [ V_26 ] . V_32 != F_39 ( V_49 -> V_68 ) >> V_69 )
V_33 = F_40 ( NULL , V_64 ) ;
return V_33 ? : F_41 ( V_49 , V_67 , V_64 , V_65 ) ;
}
...
int V_33 ;
for ( V_26 = 0 ; V_26 < V_6 -> V_4 ; V_26 ++ ) {
V_33 = V_70 ( V_3 , V_6 -> V_35 [ V_26 ] . V_36 ,
V_6 -> V_35 [ V_26 ] . V_32 , V_3 -> V_11 , V_71 ) ;
if ( V_33 )
return V_33 ;
}
return 0 ;
