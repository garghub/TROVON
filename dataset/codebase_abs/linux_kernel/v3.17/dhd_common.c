...
memcpy ( V_24 -> V_14 -> V_59 , V_24 -> V_57 , sizeof( V_24 -> V_14 -> V_59 ) ) ;
...
F_10 ( L_23 , V_43 ) ;
V_56 = strrchr ( V_43 , ' ' ) + 1 ;
F_26 ( V_24 -> V_14 -> V_60 , V_56 , sizeof( V_24 -> V_14 -> V_60 ) ) ;
V_31 = F_19 ( V_24 , L_24 , 1 ) ;
if ( V_31 ) {
F_10 ( L_25 ) ;
goto V_58;
}
...
V_55 [ 1 ] . V_64 = 0 ;
V_55 [ 1 ] . V_66 = 0 ;
V_31 = F_18 ( V_24 , L_30 , V_55 ,
sizeof( V_55 ) ) ;
if ( V_31 )
F_10 ( L_31 , V_31 ) ;
V_31 = F_25 ( V_24 , L_32 , V_51 ,
V_52 ) ;
if ( V_31 ) {
F_10 ( L_33 , V_31 ) ;
goto V_58;
...
void F_30 ( const char * V_75 , const char * V_76 , ... )
{
struct V_77 V_78 = {
. V_76 = V_76 ,
} ;
...
void F_33 ( V_37 V_80 , const char * V_75 , const char * V_76 , ... )
{
struct V_77 V_78 = {
. V_76 = V_76 ,
} ;
