...
V_12 = ! ( V_6 -> V_16 & V_17 ) ;
V_11 = - V_18 ;
for ( V_10 = 0 ; V_10 < V_6 -> V_19 ; V_10 ++ ) {
V_2 = F_6 ( sizeof( * V_2 ) , V_20 ) ;
if ( ! V_2 )
goto V_21;
F_7 ( & V_2 -> V_22 , & V_13 ) ;
F_7 ( & V_2 -> V_23 , & V_14 ) ;
...
V_2 -> V_27 = F_8 ( V_20 | V_28 ) ;
if ( ! V_2 -> V_27 )
goto V_21;
V_11 = F_9 ( V_6 -> V_29 ,
F_10 ( F_11 ( V_2 -> V_27 ) ) , V_12 ) ;
if ( V_11 < 0 )
goto V_21;
...
static struct V_1 * F_27 ( struct V_8 * V_9 ,
T_3 V_25 , T_1 V_19 )
{
struct V_1 * V_41 = NULL , * V_2 ;
F_28 (gref, &priv->list, next_file) {
...
static int F_29 ( struct V_42 * V_42 , struct V_43 * V_44 )
{
struct V_8 * V_9 ;
V_9 = F_6 ( sizeof( * V_9 ) , V_20 ) ;
if ( ! V_9 )
goto V_45;
F_30 ( & V_9 -> V_33 ) ;
V_44 -> V_46 = V_9 ;
...
static int F_32 ( struct V_42 * V_42 , struct V_43 * V_44 )
{
...
V_7 = F_36 ( V_6 . V_19 , sizeof( V_7 [ 0 ] ) , V_51 ) ;
if ( ! V_7 ) {
V_11 = - V_18 ;
goto V_50;
}
...
F_12 ( & V_31 ) ;
V_2 = F_27 ( V_9 , V_6 . V_25 , V_6 . V_19 ) ;
if ( V_2 ) {
for ( V_10 = 0 ; V_10 < V_6 . V_19 ; V_10 ++ ) {
V_3 = F_33 ( V_2 -> V_23 . V_15 ,
struct V_1 , V_23 ) ;
F_15 ( & V_2 -> V_23 ) ;
V_2 -> V_4 -- ;
V_2 = V_3 ;
...
static long F_41 ( struct V_43 * V_44 , unsigned int V_63 ,
unsigned long V_48 )
{
struct V_8 * V_9 = V_44 -> V_46 ;
switch ( V_63 ) {
...
if ( V_9 -> V_4 == 0 ) {
V_2 = V_9 -> V_2 ;
for ( V_10 = 0 ; V_10 < V_9 -> V_19 ; V_10 ++ ) {
V_2 -> V_4 -- ;
V_15 = F_33 ( V_2 -> V_22 . V_15 ,
struct V_1 , V_22 ) ;
if ( V_2 -> V_4 == 0 )
F_3 ( V_2 ) ;
V_2 = V_15 ;
...
static int F_44 ( struct V_43 * V_44 , struct V_68 * V_69 )
{
struct V_8 * V_9 = V_44 -> V_46 ;
struct V_70 * V_72 ;
struct V_1 * V_2 ;
int V_19 = ( V_69 -> V_73 - V_69 -> V_74 ) >> V_75 ;
int V_41 , V_10 ;
if ( ! ( V_69 -> V_76 & V_77 ) ) {
F_45 ( L_2 , V_47 ) ;
return - V_57 ;
}
V_72 = F_46 ( sizeof( * V_72 ) , V_20 ) ;
if ( ! V_72 )
return - V_18 ;
F_12 ( & V_31 ) ;
F_31 ( L_3 , V_47 ,
V_9 , V_72 , V_69 -> V_78 , V_19 ) ;
V_2 = F_27 ( V_9 , V_69 -> V_78 << V_75 , V_19 ) ;
if ( V_2 == NULL ) {
V_41 = - V_59 ;
F_31 ( L_4 ,
V_47 ) ;
...
V_2 -> V_4 ++ ;
V_41 = F_47 ( V_69 , V_69 -> V_74 + V_10 * V_26 ,
V_2 -> V_27 ) ;
if ( V_41 )
goto V_79;
V_2 = F_33 ( V_2 -> V_23 . V_15 ,
struct V_1 , V_23 ) ;
}
V_41 = 0 ;
V_79:
