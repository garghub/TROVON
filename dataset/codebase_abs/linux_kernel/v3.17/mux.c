...
struct V_59 * F_40 ( struct V_55 * V_56 , int * V_60 )
{
* V_60 = V_56 -> V_60 ;
return V_61 . V_59 ;
}
...
int V_62 = F_1 ( V_2 ) ;
F_42 ( V_63 L_2 , V_62 ) ;
F_43 ( & V_2 -> V_2 , ( void * ) ( long ) V_62 ) ;
F_44 ( V_2 -> V_8 . V_9 + V_64 ,
V_62 * V_65 , L_1 ) ;
if( ! V_51 ) {
V_61 . V_66 = V_67 ;
V_3 = F_45 ( & V_61 ) ;
...
F_53 ( V_2 -> V_8 . V_9 + V_64 , V_62 * V_65 ) ;
return 0 ;
}
