...
V_83 -> V_113 = V_114 ;
V_83 -> V_115 = V_116 ;
F_48 ( V_83 -> V_117 , L_61 ,
sizeof( V_83 -> V_117 ) ) ;
V_83 -> V_118 = V_104 ;
V_83 -> V_119 = & V_120 ;
V_83 -> V_4 . V_121 = & V_39 -> V_4 ;
V_83 -> V_4 . V_122 = V_39 -> V_4 . V_122 ;
F_49 ( V_83 , V_4 ) ;
V_50 = F_50 ( V_83 ) ;
if ( V_50 ) {
F_8 ( & V_39 -> V_4 , L_62
...
static int F_53 ( struct V_123 * V_123 )
{
struct V_3 * V_4 = F_54 ( V_123 ) ;
F_1 ( 0x00 , V_4 -> V_6 + V_7 ) ;
return 0 ;
}
static int F_55 ( struct V_123 * V_123 )
{
int V_50 = 0 ;
struct V_3 * V_4 = F_54 ( V_123 ) ;
F_10 ( V_4 -> V_43 ) ;
