...
V_137 . V_139 = 1 ;
V_137 . V_140 = 0 ;
error = V_136 ( V_50 , V_1 , & V_137 , V_141 ) ;
if ( error < 0 )
goto V_142;
...
F_130 ( V_105 -> V_41 , V_105 -> V_108 , V_150 ) ;
...
V_105 = (struct V_104 * )
( V_156 + V_163 -> V_49 - V_168 ) ;
if ( F_95 ( V_1 , V_146 , V_105 , V_5 . V_30 , V_156 ,
V_169 , V_163 -> V_49 ) )
goto V_25;
if ( F_14 ( V_105 -> V_1 ) ) {
if ( ! F_133 ( V_163 , V_105 -> V_41 , V_105 -> V_108 ,
F_14 ( V_105 -> V_1 ) ,
...
int F_136 ( T_3 * V_50 , struct V_1 * V_175 ,
struct V_1 * V_1 )
{
int V_58 , V_92 = V_31 ;
struct V_4 V_5 ;
...
if ( V_114 )
goto V_25;
V_114 = F_141 ( V_50 , V_100 , V_179 , V_30 ,
V_101 , V_92 , 0 ) ;
if ( V_114 )
goto V_25;
F_28 ( V_30 , L_9 ) ;
