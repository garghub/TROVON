...
return;
if ( ! F_96 ( V_11 -> V_81 -> V_170 . V_171 -> V_102 ,
V_11 -> V_81 -> V_170 . V_171 -> V_172 ,
V_11 -> V_98 . V_99 . V_173 ) )
return;
V_11 -> V_98 . V_99 . V_174 ++ ;
F_97 ( V_11 -> V_81 -> V_170 . V_171 -> V_102 ,
V_11 -> V_81 -> V_170 . V_171 -> V_172 ,
V_11 -> V_98 . V_99 . V_173 ) ;
}
...
int V_187 , V_4 , V_188 ;
const char * V_3 ;
V_187 = F_106 ( V_186 , L_40 ) ;
if ( V_187 < 1 )
return - V_189 ;
for ( V_4 = 0 ; V_4 < V_187 ; V_4 ++ ) {
V_188 = F_107 ( V_186 , L_40 ,
V_4 , & V_3 ) ;
if ( V_188 )
continue;
...
struct V_185 * V_192 ;
int V_4 ;
V_188 = F_108 ( V_191 , V_11 , & V_4 , & V_192 ) ;
if ( V_188 == 0 ) {
* V_121 = V_192 ;
* V_190 = V_4 ;
return 0 ;
...
static int T_4 F_110 ( struct V_10 * V_11 , void * V_143 ,
...
if ( ! V_186 )
return - V_193 ;
va_start = F_111 ( V_186 , V_190 + V_11 -> V_194 ) ;
} else {
va_start = F_112 ( V_117 -> V_119 , V_117 -> V_120 - V_117 -> V_119 ) ;
}
if ( ! va_start ) {
if ( V_117 )
...
static int T_4 F_114 ( struct V_10 * V_11 , void * V_143 )
{
int V_166 , V_190 ;
...
if ( F_115 () ) {
struct V_185 * V_197 ;
V_197 = F_116 ( NULL , L_46 ) ;
if ( ! V_197 )
return - V_189 ;
V_166 = F_108 ( V_197 , V_11 , & V_190 , & V_186 ) ;
if ( V_166 )
F_18 ( L_47 , V_11 -> V_14 ) ;
else if ( V_186 && V_190 )
F_17 ( L_48 ,
...
if ( V_11 -> V_12 -> V_13 ) {
V_166 = F_110 ( V_11 , NULL , V_190 , V_186 ) ;
if ( V_166 < 0 ) {
F_4 ( 1 , L_49 ,
V_11 -> V_14 ) ;
return 0 ;
...
if ( V_186 ) {
if ( F_117 ( V_186 , L_51 , NULL ) )
V_11 -> V_66 |= V_198 ;
if ( F_117 ( V_186 , L_52 , NULL ) )
V_11 -> V_66 |= V_199 ;
}
V_11 -> V_49 = V_177 ;
return 0 ;
...
static int T_4 F_121 ( struct V_10 * V_11 , void * V_143 )
{
if ( V_11 -> V_49 != V_177 )
return 0 ;
F_118 ( V_11 ) ;
...
static int T_4 F_126 ( struct V_6 * * V_210 ,
struct V_6 * * V_211 )
{
unsigned int V_212 ;
...
V_210 -> V_8 = V_5 ;
F_124 ( & V_210 -> V_7 ) ;
F_129 ( & V_210 -> V_7 , & V_5 -> V_218 -> V_207 ) ;
V_5 -> V_218 -> V_220 ++ ;
V_211 -> V_8 = V_5 ;
F_124 ( & V_211 -> V_7 ) ;
F_129 ( & V_211 -> V_7 , & V_5 -> V_219 -> V_90 ) ;
V_5 -> V_219 -> V_91 ++ ;
return 0 ;
}
...
static int T_4 F_131 ( struct V_1 * * V_222 )
{
unsigned int V_4 = 0 ;
unsigned int V_212 ;
if ( V_216 ) {
...
if ( ! F_61 ( V_11 ) )
return 0 ;
return F_133 ( V_11 -> V_98 . V_223 . V_224 ,
...
if ( ! F_61 ( V_11 ) )
return 0 ;
return F_135 ( V_11 -> V_98 . V_223 . V_224 ,
V_11 -> V_98 . V_223 . V_225 ,
V_11 -> V_98 . V_223 . V_226 ) ;
}
...
struct V_147 * V_148 )
{
return F_141 ( V_11 -> V_98 . V_223 . V_224 ,
V_148 -> V_152 ) ;
}
static int F_142 ( struct V_10 * V_11 ,
struct V_147 * V_148 )
{
return F_143 ( V_11 -> V_98 . V_223 . V_224 ,
V_148 -> V_152 ,
V_148 -> V_153 ) ;
}
...
struct V_147 * V_148 )
{
return F_145 ( V_11 -> V_98 . V_223 . V_224 ,
V_148 -> V_153 ) ;
}
...
int F_164 ( int (* F_165)( struct V_10 * V_11 , void * V_143 ) ,
void * V_143 )
{
struct V_10 * V_141 ;
int V_87 = 0 ;
...
return - V_15 ;
F_67 (temp_oh, &omap_hwmod_list, node) {
V_87 = (* F_165)( V_141 , V_143 ) ;
if ( V_87 )
break;
}
return V_87 ;
}
int T_4 F_166 ( struct V_1 * * V_222 )
{
int V_166 , V_4 ;
if ( ! V_231 )
return - V_15 ;
...
int T_4 F_168 ( const char * V_233 )
{
struct V_10 * V_11 ;
...
int F_179 ( struct V_10 * V_11 , struct V_237 * V_188 )
{
struct V_1 * V_89 ;
struct V_2 * V_3 ;
...
struct V_244 * F_182 ( struct V_10 * V_11 )
{
struct V_80 * V_41 ;
struct V_1 * V_5 ;
struct V_78 * V_81 ;
...
int F_192 ( struct V_10 * V_11 , T_2 V_246 )
{
int V_87 ;
unsigned long V_66 ;
if ( ! V_11 )
...
int F_196 ( struct V_10 * V_11 , int V_249 , int V_250 )
{
int V_251 ;
F_197 () ;
...
return - V_15 ;
if ( ! V_11 -> V_62 -> V_252 ) {
V_11 -> V_62 -> V_252 = F_198 ( sizeof( int ) * V_11 -> V_62 -> V_64 ,
V_253 ) ;
if ( ! V_11 -> V_62 -> V_252 )
return - V_232 ;
}
