...
unsigned int F_27 ( void T_1 * V_1 )
{
return F_5 ( V_1 + V_69 ) ;
}
...
void F_29 ( void T_1 * V_1 , unsigned int V_78 )
{
T_2 V_2 ;
V_2 = V_78 & V_79 ;
F_2 ( V_2 , V_1 + V_80 ) ;
}
void F_30 ( void T_1 * V_1 , unsigned int V_20 )
{
T_2 V_2 ;
switch ( V_20 ) {
case V_22 :
...
void F_31 ( void T_1 * V_1 , unsigned int V_92 )
{
F_2 ( V_92 , V_1 + V_93 ) ;
}
void F_32 ( void T_1 * V_1 , struct V_94 * V_95 )
{
F_2 ( V_95 -> V_64 , V_1 + V_96 ) ;
F_2 ( V_95 -> V_97 , V_1 + V_98 ) ;
F_2 ( V_95 -> V_99 , V_1 + V_100 ) ;
}
void F_33 ( void T_1 * V_1 , unsigned int V_101 ,
unsigned int V_102 )
{
...
void F_34 ( void T_1 * V_1 , unsigned int V_109 ,
unsigned int V_110 )
{
T_2 V_2 ;
V_2 = ( V_110 << V_111 ) &
...
void F_35 ( void T_1 * V_16 , unsigned int V_45 )
{
if ( V_45 == V_47 ) {
F_2 ( V_126 ,
V_16 + F_36 ( 1 ) ) ;
...
unsigned int F_42 ( void T_1 * V_1 )
{
...
void F_45 ( void T_1 * V_1 , unsigned int V_149 )
{
V_149 &= V_150 ;
F_2 ( V_151 | V_149 ,
V_1 + V_152 ) ;
}
unsigned int F_46 ( void T_1 * V_1 )
{
return F_5 ( V_1 + V_153 ) ;
}
void F_47 ( void T_1 * V_1 )
{
F_2 ( V_151 , V_1 + V_153 ) ;
}
