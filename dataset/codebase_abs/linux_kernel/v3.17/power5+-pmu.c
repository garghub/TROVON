...
unsigned int V_48 [] , unsigned long V_49 [] , struct V_50 * V_51 [] )
{
unsigned long V_52 = 0 ;
unsigned long V_53 = 0 ;
unsigned int V_4 , V_6 , V_5 , V_44 ;
unsigned int V_54 ;
int V_27 , V_55 , V_8 , V_56 ;
unsigned int V_57 = 0 ;
...
V_60 = 0 ;
for ( V_27 = V_61 ; V_27 <= V_63 ; ++ V_27 ) {
if ( ! V_59 [ V_27 ] )
continue;
if ( V_60 ++ )
return - 1 ;
V_52 |= ( unsigned long ) V_27 << V_64 ;
}
V_60 = 0 ;
for (; V_27 <= V_24 ; ++ V_27 ) {
if ( ! V_59 [ V_27 ] )
...
if ( V_60 ++ )
return - 1 ;
V_52 |= ( unsigned long ) ( V_27 & 3 ) << V_65 ;
}
if ( V_60 > 1 )
return - 1 ;
for ( V_5 = 0 ; V_5 < 4 ; ++ V_5 ) {
...
if ( ! V_6 )
continue;
if ( V_6 == V_19 && V_59 [ V_18 ] ) {
V_6 = V_18 ;
} else if ( V_6 == V_23 + 1 ) {
V_52 |= 1ul << ( V_66 + 3 - V_5 ) ;
}
V_54 = V_6 >> 2 ;
V_52 |= ( unsigned long ) V_54
<< ( V_67 - 2 * V_5 ) ;
}
for ( V_27 = 0 ; V_27 < V_47 ; ++ V_27 ) {
V_4 = ( V_1 [ V_27 ] >> V_12 ) & V_13 ;
...
if ( V_55 && V_6 == V_24 ) {
V_8 = V_44 & 7 ;
V_56 = ( V_1 [ V_27 ] >> V_26 ) & V_69 ;
V_52 |= ( unsigned long ) V_56 << V_25 [ V_8 ] ;
}
if ( F_7 ( V_1 [ V_27 ] ) )
V_53 |= V_70 ;
