...
{
const struct V_76 * V_77 = F_31 ( V_2 ) ;
switch ( V_77 -> V_78 ) {
case V_79 :
F_7 ( 0 , V_2 -> V_13 + V_80 ) ;
...
case V_82 :
F_7 ( 0 , V_2 -> V_13 + V_83 ) ;
F_7 ( 0x0f , V_2 -> V_13 + V_84 ) ;
F_7 ( 0 , V_2 -> V_13 + V_85 ) ;
break;
case V_86 :
F_7 ( 0 , V_2 -> V_13 + V_87 ) ;
F_7 ( 0 , V_2 -> V_13 + V_87 + 1 ) ;
F_7 ( 0 , V_2 -> V_13 + V_87 + 2 ) ;
F_7 ( 0 , V_2 -> V_13 + V_87 + 3 ) ;
break;
case V_88 :
F_7 ( 0 , V_2 -> V_13 + V_89 ) ;
F_7 ( 0 , V_2 -> V_13 + V_89 + 1 ) ;
F_7 ( 0 , V_2 -> V_13 + V_89 + 2 ) ;
F_7 ( 0 , V_2 -> V_13 + V_89 + 3 ) ;
F_18 ( V_2 -> V_13 + V_90 , 0 , 0 , V_91 ) ;
F_18 ( V_2 -> V_13 + V_90 , 0 , 1 , V_91 ) ;
F_18 ( V_2 -> V_13 + V_90 , 0 , 2 , V_91 ) ;
break;
case V_92 :
F_7 ( 0 , V_2 -> V_13 + V_93 ) ;
F_7 ( 0 , V_2 -> V_13 + V_93 + 1 ) ;
F_7 ( 0 , V_2 -> V_13 + V_94 ) ;
F_7 ( 0x0f , V_2 -> V_13 + V_95 ) ;
F_7 ( 0 , V_2 -> V_13 + V_96 ) ;
break;
case V_97 :
F_7 ( 0x88 , V_2 -> V_13 + V_98 ) ;
break;
case V_99 :
case V_100 :
F_7 ( 0x88 , V_2 -> V_13 + V_101 ) ;
break;
case V_102 :
...
F_9 ( 0x08 , V_2 -> V_13 + V_117 ) ;
F_9 ( 0x08 , V_2 -> V_13 + V_118 ) ;
F_9 ( 0 , V_2 -> V_13 + V_122 ) ;
F_9 ( 0 , V_2 -> V_13 + V_122 + 2 ) ;
break;
case V_123 :
F_29 ( V_2 ) ;
break;
case V_124 :
F_9 ( 0x0101 , V_2 -> V_13 + V_125 ) ;
break;
}
return 0 ;
}
...
static unsigned long F_36 ( struct V_151 * V_152 ,
unsigned long V_78 )
{
if ( V_78 != V_111 )
return V_78 ;
if ( F_37 ( V_152 ) < 0 )
return V_78 ;
if ( F_38 ( V_152 , V_153 , L_3 ) == 0 ) {
unsigned long V_154 =
F_39 ( V_152 , V_153 ) + 53 ;
F_7 ( 0x05 , V_154 ) ;
if ( ( F_2 ( V_154 ) & 0x07 ) == 0x02 ) {
F_7 ( 0x02 , V_154 ) ;
if ( ( F_2 ( V_154 ) & 0x07 ) == 0x05 )
V_78 = V_106 ;
}
F_40 ( V_152 , V_153 ) ;
}
...
struct V_49 * V_50 ;
struct V_3 * V_4 ;
int V_24 , V_156 , V_11 , V_157 ;
if ( V_155 < F_44 ( V_158 ) )
V_77 = & V_158 [ V_155 ] ;
if ( ! V_77 )
return - V_159 ;
V_2 -> V_160 = V_77 ;
V_2 -> V_161 = V_77 -> V_162 ;
V_50 = F_45 ( V_2 , sizeof( * V_50 ) ) ;
if ( ! V_50 )
return - V_163 ;
V_24 = F_46 ( V_2 ) ;
if ( V_24 )
return V_24 ;
V_2 -> V_13 = F_39 ( V_152 , V_77 -> V_164 ) ;
V_24 = F_47 ( V_2 , V_77 -> V_165 ) ;
if ( V_24 )
return V_24 ;
V_156 = 0 ;
for ( V_11 = 0 ; V_11 < V_166 ; V_11 ++ )
if ( V_77 -> V_167 [ V_11 ] . V_146 ) {
V_4 = & V_2 -> V_126 [ V_156 ] ;
F_33 ( V_2 , V_4 , & V_77 -> V_167 [ V_11 ] ) ;
V_156 ++ ;
}
for ( V_11 = 0 ; V_11 < V_168 ; V_11 ++ )
if ( V_77 -> V_169 [ V_11 ] . V_146 ) {
V_4 = & V_2 -> V_126 [ V_156 ] ;
F_34 ( V_2 , V_4 , & V_77 -> V_169 [ V_11 ] ) ;
V_156 ++ ;
}
for ( V_11 = 0 ; V_11 < V_170 ; V_11 ++ )
for ( V_157 = 0 ; V_157 < V_77 -> V_171 [ V_11 ] . V_12 ; V_157 ++ ) {
V_4 = & V_2 -> V_126 [ V_156 ] ;
V_24 = F_48 ( V_2 , V_4 , NULL ,
V_2 -> V_13 +
V_77 -> V_171 [ V_11 ] . V_14 +
V_172 * V_157 ) ;
if ( V_24 )
return V_24 ;
V_156 ++ ;
...
V_4 = & V_2 -> V_126 [ V_156 ] ;
V_4 -> type = V_127 ;
F_33 ( V_2 , V_4 , & V_77 -> V_173 ) ;
V_156 ++ ;
}
for ( V_11 = 0 ; V_11 < V_174 ; V_11 ++ )
if ( V_77 -> V_175 [ V_11 ] . V_146 ) {
V_4 = & V_2 -> V_126 [ V_156 ] ;
F_35 ( V_2 , V_4 , & V_77 -> V_175 [ V_11 ] ) ;
V_156 ++ ;
}
if ( V_77 -> V_78 == V_123 )
F_32 ( V_2 ) ;
...
static int F_51 ( struct V_151 * V_2 ,
const struct V_177 * V_178 )
{
unsigned long V_78 ;
V_78 = F_36 ( V_2 , V_178 -> V_179 ) ;
return F_52 ( V_2 , & V_180 , V_78 ) ;
}
