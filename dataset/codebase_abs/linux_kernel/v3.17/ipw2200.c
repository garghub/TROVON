...
F_128 ( & V_23 -> V_564 ) ;
#ifdef F_293
#define F_294 ( T_11 ) WLAN_FC_GET_STYPE( \
le16_to_cpu(((struct ieee80211_hdr *)(x))->frame_control))
if ( ( V_23 -> V_37 & V_670 ) &&
( F_294 ( & V_660 -> V_538 . V_488 )
== V_671 ) ) {
if ( ( sizeof
( struct
V_672 )
...
static void F_298 ( struct V_17 * V_23 )
{
...
unsigned long V_41 ;
F_41 ( & V_496 -> V_98 , V_41 ) ;
while ( ! F_299 ( & V_496 -> V_498 ) ) {
V_438 = V_496 -> V_498 . V_775 ;
V_774 = F_212 ( V_438 , struct V_773 , V_442 ) ;
V_774 -> V_501 = F_300 ( V_503 , V_139 ) ;
if ( ! V_774 -> V_501 ) {
F_4 ( V_782 L_284 ,
V_23 -> V_167 -> V_158 ) ;
break;
...
F_214 ( V_438 ) ;
V_774 -> V_502 =
F_301 ( V_23 -> V_477 , V_774 -> V_501 -> V_3 ,
V_503 , V_504 ) ;
...
static void F_302 ( struct V_106 * V_107 )
{
struct V_17 * V_23 =
...
static int F_304 ( struct V_17 * V_23 , int V_347 , T_2 V_609 )
{
V_609 &= ~ V_783 ;
if ( V_347 == V_119 ) {
switch ( V_609 ) {
...
static int F_305 ( struct V_17 * V_23 ,
...
static void F_306 ( struct V_335 * V_802 ,
...
static void F_308 ( struct V_335 * V_336 ,
T_2 V_804 , T_3 V_805 )
{
T_2 V_806 = ( V_807 == V_804 ) ?
V_783 : 0 ;
...
static int F_309 ( struct V_17 * V_23 ,
struct V_808 * V_809 ,
struct V_440 * V_441 ,
int V_654 )
{
...
F_311 ( V_140 , V_441 -> V_813 + V_23 -> V_163 -> V_164 ) ) {
F_310 ( L_291
L_296 ,
F_292 ( V_311 , V_441 -> V_311 ,
V_441 -> V_810 ) ,
...
F_310 ( L_291
L_301
L_302 , F_292 ( V_311 , V_441 -> V_311 ,
V_441 -> V_810 ) ,
V_441 -> V_216 ,
V_23 -> V_216 ) ;
return 0 ;
}
if ( ! F_312 ( V_23 -> V_163 , V_441 -> V_118 ) ) {
F_310 ( L_291
L_303
L_304 ,
F_292 ( V_311 , V_441 -> V_311 ,
...
F_306 ( & V_809 -> V_336 , & V_336 ) ;
V_809 -> V_441 = V_441 ;
F_310 ( L_308 ,
F_292 ( V_311 , V_441 -> V_311 , V_441 -> V_810 ) ,
V_441 -> V_216 ) ;
return 1 ;
}
static void F_313 ( struct V_106 * V_107 )
{
F_291 ( V_311 ) ;
struct V_17 * V_23 =
...
unsigned long V_41 ;
F_41 ( & V_23 -> V_163 -> V_98 , V_41 ) ;
F_314 (network, &priv->ieee->network_list, list) {
if ( V_441 != V_23 -> V_117 )
F_309 ( V_23 , & V_809 , V_441 ,
1 ) ;
}
F_42 ( & V_23 -> V_163 -> V_98 , V_41 ) ;
...
static int F_315 ( struct V_17 * V_23 ,
struct V_808 * V_809 ,
...
if ( V_441 -> V_818 &&
F_311 ( V_441 -> V_818 + ( V_192 * 3UL ) , V_140 ) ) {
F_265 ( L_291
L_314
L_315 ,
F_292 ( V_311 , V_441 -> V_311 ,
...
static void F_316 ( struct V_17 * V_23 ,
struct V_440 * V_441 )
{
const struct V_201 * V_202 = F_137 ( V_23 -> V_163 ) ;
int V_7 ;
...
case V_820 :
V_441 -> V_118 = V_119 ;
V_7 = F_317 ( V_23 -> V_163 , V_23 -> V_197 ) ;
F_226 ( V_7 == - 1 ) ;
...
static void F_318 ( struct V_17 * V_23 , int type , int V_400 )
{
struct V_829 V_830 ;
...
static void F_319 ( struct V_17 * V_23 , int type )
{
struct V_836 V_830 ;
int V_7 ;
V_830 . V_837 = V_838 ;
...
static void F_321 ( struct V_17 * V_23 , int V_11 )
{
if ( V_23 -> V_163 -> V_843 )
return;
switch ( V_11 ) {
...
F_321 ( V_23 , V_23 -> V_163 -> V_244 . V_11 ) ;
break;
case V_849 :
default:
break;
...
static void F_324 ( struct V_106 * V_107 )
{
struct V_17 * V_23 =
...
if ( V_23 -> V_59 & V_811 )
F_74 ( L_323 ,
F_292 ( V_311 , V_23 -> V_667 , V_23 -> V_668 ) ) ;
else
F_74 ( L_324 ) ;
if ( V_23 -> V_59 & V_819 )
...
static void F_326 ( struct V_17 * V_23 , int V_118 )
{
struct V_858 V_859 ;
T_3 V_24 ;
T_4 V_36 = 0 ;
...
static void F_328 ( struct V_17 * V_23 ,
struct V_323 * V_866 ,
int V_700 )
{
int V_867 = 0 ;
...
static int F_330 ( struct V_17 * V_23 )
{
if ( V_23 -> V_37 & V_103
&& V_23 -> V_117 -> V_640 > 10 )
...
static int F_331 ( struct V_17 * V_23 , int type , int V_873 )
{
struct V_323 V_866 ;
int V_557 = 0 , V_700 ;
if ( ! ( V_23 -> V_37 & V_69 ) ||
...
V_866 . V_875 = F_179 ( F_332 ( V_23 -> V_163 ) ) ;
if ( type == V_876 ) {
F_327 ( L_337 ) ;
V_700 = V_869 ;
V_866 . V_877 [ V_869 ] =
F_173 ( F_330 ( V_23 ) ) ;
F_328 ( V_23 , & V_866 , V_700 ) ;
goto V_878;
}
if ( V_23 -> V_59 & V_195 )
V_866 . V_877 [ V_879 ] =
...
static void F_336 ( struct V_106 * V_107 )
{
struct V_17 * V_23 =
...
static int F_338 ( struct V_17 * V_23 , int V_25 )
{
...
static void F_339 ( struct V_17 * V_23 , char * V_899 ,
int V_827 )
{
F_337 ( V_23 , 1 ) ;
}
static int F_340 ( struct V_17 * V_23 ,
...
return - V_75 ;
if ( V_211 -> V_3 . V_415 ) {
V_1 = F_343 ( V_904 , V_211 -> V_3 . V_415 , V_148 ) ;
if ( V_1 == NULL ) {
V_557 = - V_476 ;
goto V_6;
}
...
F_339 ( V_23 , V_163 -> V_899 , V_163 -> V_827 ) ;
V_6:
return V_557 ;
}
...
return F_349 ( V_23 -> V_163 , V_903 , V_211 , V_904 ) ;
}
...
{
struct V_17 * V_23 = F_342 ( V_166 ) ;
return F_351 ( V_23 -> V_163 , V_903 , V_211 , V_904 ) ;
}
static int F_352 ( struct V_165 * V_166 ,
struct V_902 * V_903 ,
union V_210 * V_211 , char * V_904 )
{
struct V_17 * V_23 = F_342 ( V_166 ) ;
...
static T_2 F_353 ( struct V_17 * V_23 )
{
T_2 V_118 = 0 ;
if ( V_23 -> V_37 & V_103 ) {
unsigned long V_41 ;
...
static int F_362 ( struct V_17 * V_23 ,
struct V_440 * V_441 )
{
int V_432 = 0 ;
unsigned long V_41 ;
...
static T_3 F_356 ( struct V_17 * V_23 )
{
T_3 V_432 = 0 ;
if ( ( V_23 == NULL ) )
return 0 ;
...
static void F_363 ( struct V_17 * V_23 , int V_1000 ,
...
static int F_364 ( struct V_17 * V_23 , T_4 V_1004 )
{
if ( V_1004 > 7 || ! V_23 -> V_955 . V_979 )
V_1004 = 0 ;
return V_1005 [ V_1004 ] - 1 ;
}
static int F_365 ( struct V_165 * V_166 ,
struct V_1006 * V_501 )
{
struct V_17 * V_23 = F_342 ( V_166 ) ;
struct V_966 * V_955 = NULL ;
...
static int F_367 ( struct V_17 * V_23 ,
T_4 V_1004 ,
struct V_1009 * V_768 )
{
int V_1010 = 0 ;
...
static void F_368 ( struct V_106 * V_107 )
{
struct V_17 * V_23 =
F_58 ( V_107 , struct V_17 , V_962 ) ;
F_59 ( & V_23 -> V_109 ) ;
if ( V_23 -> V_37 & V_103 )
F_355 ( V_23 , & ( V_23 -> V_117 -> V_955 ) ) ;
F_60 ( & V_23 -> V_109 ) ;
}
...
static int F_371 ( struct V_165 * V_166 ,
struct V_672 * V_681 ,
struct V_440 * V_441 )
{
struct V_17 * V_23 = F_342 ( V_166 ) ;
...
static int F_357 ( struct V_17 * V_23 , struct V_954
* V_1022 )
{
return F_155 ( V_23 , V_1023 ,
sizeof( * V_1022 ) * 3 , V_1022 ) ;
}
static int F_359 ( struct V_17 * V_23 , struct V_980
* V_1022 )
{
return F_155 ( V_23 , V_1024 , sizeof( * V_1022 ) ,
V_1022 ) ;
}
static int F_372 ( struct V_17 * V_23 ,
struct V_440 * V_441 ,
...
F_305 ( V_23 , V_23 -> V_117 , & V_809 . V_336 ) ;
F_372 ( V_23 , V_23 -> V_117 , & V_809 . V_336 , 1 ) ;
V_23 -> V_37 &= ~ V_652 ;
}
...
V_23 -> V_59 & V_811 &&
V_23 -> V_59 & V_549 ) {
if ( F_299 ( & V_23 -> V_163 -> V_443 ) ) {
struct V_440 * V_1050 = NULL ;
struct V_440 * V_1051 ;
F_314 (target, &priv->ieee->network_list, list) {
if ( ( V_1050 == NULL ) ||
...
V_336 = & V_23 -> V_336 ;
F_214 ( V_438 ) ;
F_215 ( & V_441 -> V_442 , & V_23 -> V_163 -> V_1052 ) ;
}
F_42 ( & V_23 -> V_163 -> V_98 , V_41 ) ;
if ( ! V_441 ) {
F_325 ( V_23 ) ;
...
V_166 -> V_1063 = V_140 ;
if ( F_29 ( ( F_222 ( V_1062 -> V_538 . V_1064 . V_415 ) + V_1065 ) >
F_379 ( V_774 -> V_501 ) ) ) {
V_166 -> V_674 . V_1066 ++ ;
...
F_381 ( V_774 -> V_501 , F_382 ( struct V_1061 , V_538 . V_1064 . V_3 ) ) ;
F_383 ( V_774 -> V_501 , F_222 ( V_1062 -> V_538 . V_1064 . V_415 ) ) ;
F_384 ( L_387 , V_774 -> V_501 -> V_4 ) ;
V_1055 = (struct V_675 * ) V_774 -> V_501 -> V_3 ;
if ( V_23 -> V_163 -> V_513 != V_515 &&
( F_366 ( V_1055 -> V_1071 ) ?
! V_23 -> V_163 -> V_854 : ! V_23 -> V_163 -> V_846 ) )
F_376 ( V_23 , V_774 -> V_501 ) ;
if ( ! F_385 ( V_23 -> V_163 , V_774 -> V_501 , V_674 ) )
V_166 -> V_674 . V_1066 ++ ;
else {
V_774 -> V_501 = NULL ;
F_63 ( V_23 ) ;
...
unsigned short V_4 = F_222 ( V_1062 -> V_538 . V_1064 . V_415 ) ;
V_166 -> V_1063 = V_140 ;
if ( F_29 ( ( F_222 ( V_1062 -> V_538 . V_1064 . V_415 ) + V_1065 ) >
F_379 ( V_774 -> V_501 ) ) ) {
V_166 -> V_674 . V_1066 ++ ;
...
V_1079 -> V_1098 = ( T_7 ) F_222 ( V_1064 -> V_737 ) ;
V_1079 -> V_1099 = F_173 ( F_387 ( V_1073 ) ) ;
if ( V_1073 > 14 ) {
V_1079 -> V_1100 =
F_173 ( ( V_1101 | V_1102 ) ) ;
} else if ( V_1074 & 32 ) {
...
F_383 ( V_774 -> V_501 , V_4 + sizeof( struct V_1078 ) ) ;
F_384 ( L_387 , V_774 -> V_501 -> V_4 ) ;
if ( ! F_385 ( V_23 -> V_163 , V_774 -> V_501 , V_674 ) )
V_166 -> V_674 . V_1066 ++ ;
else {
...
static void F_388 ( struct V_17 * V_23 ,
struct V_773 * V_774 ,
struct V_673 * V_674 )
{
...
T_7 V_737 = ( T_7 ) F_222 ( V_1064 -> V_737 ) ;
...
return;
V_166 -> V_1063 = V_140 ;
if ( F_29 ( ( V_4 + V_1065 ) > F_379 ( V_774 -> V_501 ) ) ) {
V_166 -> V_674 . V_1066 ++ ;
F_380 ( L_385 ) ;
return;
}
...
if ( F_389 ( F_222 ( V_1055 -> V_1057 ) ) ) {
if ( V_161 & V_1111 )
return;
if ( V_161 & V_1112 )
V_1109 = 1 ;
} else if ( F_390 ( F_222 ( V_1055 -> V_1057 ) ) ) {
if ( V_161 & V_1113 )
return;
if ( V_161 & V_1114 )
V_1109 = 1 ;
} else if ( F_391 ( F_222 ( V_1055 -> V_1057 ) ) ) {
if ( V_161 & V_1115 )
return;
if ( V_161 & V_1116 )
V_1109 = 1 ;
}
V_501 = F_392 ( V_774 -> V_501 , V_139 ) ;
if ( V_501 == NULL ) {
F_46 ( L_389 ) ;
return;
}
...
V_1079 -> V_1098 = V_737 ;
V_1079 -> V_1099 = F_173 ( F_387 ( V_197 ) ) ;
if ( V_197 > 14 ) {
V_1079 -> V_1100 =
F_173 ( ( V_1101 | V_1102 ) ) ;
} else if ( V_1108 & ( 1 << 5 ) ) {
...
if ( V_1108 & ( 1 << 6 ) )
V_1079 -> V_1093 |= V_1107 ;
F_384 ( L_387 , V_501 -> V_4 ) ;
if ( ! F_385 ( V_23 -> V_159 -> V_163 , V_501 , V_674 ) ) {
V_166 -> V_674 . V_1066 ++ ;
F_394 ( V_501 ) ;
}
}
...
switch ( V_23 -> V_163 -> V_513 ) {
case V_514 :
if ( F_213 ( V_1117 -> V_1118 , V_23 -> V_167 -> V_1119 ) )
return 0 ;
if ( F_366 ( V_1117 -> V_1071 ) )
return F_213 ( V_1117 -> V_1120 , V_23 -> V_216 ) ;
return F_213 ( V_1117 -> V_1071 ,
V_23 -> V_167 -> V_1119 ) ;
case V_516 :
if ( F_213 ( V_1117 -> V_1120 , V_23 -> V_167 -> V_1119 ) )
return 0 ;
if ( F_366 ( V_1117 -> V_1071 ) )
return F_213 ( V_1117 -> V_1118 , V_23 -> V_216 ) ;
return F_213 ( V_1117 -> V_1071 ,
V_23 -> V_167 -> V_1119 ) ;
}
return 1 ;
...
struct V_675 * V_1117 )
{
T_4 V_1121 = F_222 ( V_1117 -> V_1122 ) ;
T_4 V_1123 = F_397 ( V_1121 ) ;
T_4 V_359 = F_398 ( V_1121 ) ;
T_4 * V_1124 , * V_1125 ;
...
F_399 (p, &priv->ibss_mac_hash[index]) {
V_545 =
...
static void F_401 ( struct V_17 * V_23 ,
struct V_773 * V_774 ,
struct V_673 * V_674 )
{
...
( V_501 -> V_3 + V_1065 ) ;
F_296 ( V_23 -> V_163 , V_1117 , V_674 ) ;
if ( V_23 -> V_163 -> V_513 == V_514 &&
( ( F_402 ( F_222 ( V_1117 -> V_1137 ) ) ==
V_1138 ) ||
( F_402 ( F_222 ( V_1117 -> V_1137 ) ) ==
V_1139 ) ) ) {
if ( F_213 ( V_1117 -> V_1120 , V_23 -> V_216 ) )
F_262 ( V_23 , V_1117 -> V_1118 ) ;
}
if ( V_23 -> V_59 & V_200 ) {
F_142 ( L_391 ) ;
F_383 ( V_501 , F_222 ( V_1062 -> V_538 . V_1064 . V_415 ) +
V_1065 ) ;
F_403 ( V_501 , V_1065 ) ;
memcpy ( F_404 ( V_501 , sizeof( * V_674 ) ) , V_674 , sizeof( * V_674 ) ) ;
V_501 -> V_166 = V_23 -> V_163 -> V_166 ;
F_405 ( V_501 ) ;
V_501 -> V_1140 = V_1141 ;
V_501 -> V_1142 = F_406 ( V_1143 ) ;
...
V_1046 + 0x100 ,
. V_737 =
F_222 ( V_1062 -> V_538 . V_1064 . V_737 ) ,
...
V_821 :
V_820 ,
. V_4 = F_222 ( V_1062 -> V_538 . V_1064 . V_415 ) ,
} ;
if ( V_674 . V_632 != 0 )
V_674 . V_36 |= V_1151 ;
if ( V_674 . signal != 0 )
...
F_384 ( L_394 ,
F_222 ( V_1062 -> V_538 . V_1064 . V_415 ) ) ;
if ( F_222 ( V_1062 -> V_538 . V_1064 . V_415 ) <
F_393 ( F_222 (
V_1117 -> V_1137 ) ) ) {
F_380
( L_395
...
F_222 ( V_1062 -> V_538 . V_1160 . V_15 ) ) ;
F_290 ( V_23 , & V_1062 -> V_538 . V_1160 ) ;
break;
}
default:
F_384 ( L_401 ,
...
static int F_411 ( struct V_17 * V_23 , int V_1161 )
{
int V_882 , V_804 ;
...
static int F_412 ( struct V_17 * V_23 , T_2 V_197 )
{
if ( V_197 == 0 ) {
F_74 ( L_410 ) ;
V_23 -> V_59 &= ~ V_549 ;
...
if ( V_1184 -> V_1186 == 1 ) {
V_197 = F_414 ( V_23 -> V_163 , V_1184 -> V_1185 ) ;
if ( V_197 == 0 )
return - V_75 ;
} else
V_197 = V_1184 -> V_1185 ;
...
F_327 ( L_422 , V_1184 -> V_1185 ) ;
F_59 ( & V_23 -> V_109 ) ;
V_432 = F_412 ( V_23 , V_197 ) ;
F_60 ( & V_23 -> V_109 ) ;
return V_432 ;
}
...
return - V_75 ;
F_59 ( & V_23 -> V_109 ) ;
if ( F_421 ( V_211 -> V_212 . V_215 ) ||
F_422 ( V_211 -> V_212 . V_215 ) ) {
F_327 ( L_427 ) ;
V_23 -> V_59 &= ~ V_819 ;
F_265 ( L_411
L_412 ) ;
...
return - V_906 ;
F_59 ( & V_23 -> V_109 ) ;
V_211 -> V_3 . V_415 = F_6 ( T_1 , V_211 -> V_3 . V_415 , sizeof( V_23 -> V_1224 ) ) ;
...
struct V_17 * V_23 = F_342 ( V_166 ) ;
int V_557 = 0 ;
F_327 ( L_440 , V_211 -> V_327 . V_25 ) ;
F_327 ( L_441 , 3 * V_211 -> V_327 . V_25 ) ;
F_59 ( & V_23 -> V_109 ) ;
...
{
struct V_17 * V_23 = F_342 ( V_166 ) ;
return F_442 ( V_23 -> V_163 , V_903 , V_211 , V_904 ) ;
}
...
F_59 ( & V_23 -> V_109 ) ;
V_432 = F_444 ( V_23 -> V_163 , V_903 , V_211 , V_830 ) ;
...
{
struct V_17 * V_23 = F_342 ( V_166 ) ;
return F_446 ( V_23 -> V_163 , V_903 , V_211 , V_830 ) ;
}
...
if ( F_448 ( V_23 -> V_1181 ) == V_365 )
V_23 -> V_1181 = V_1252 | V_363 ;
else
V_23 -> V_1181 = V_1252 | V_23 -> V_1181 ;
V_557 = F_184 ( V_23 , F_448 ( V_23 -> V_1181 ) ) ;
if ( V_557 ) {
F_327 ( L_458 ) ;
F_60 ( & V_23 -> V_109 ) ;
return V_557 ;
}
F_327 ( L_461 , V_23 -> V_1181 ) ;
F_60 ( & V_23 -> V_109 ) ;
return 0 ;
}
...
F_60 ( & V_23 -> V_109 ) ;
F_444 ( V_23 -> V_163 , V_903 , & V_1260 , NULL ) ;
F_59 ( & V_23 -> V_109 ) ;
if ( ! ( V_23 -> V_37 & V_99 ) ) {
F_265 ( L_488
L_489 ) ;
...
static struct V_1263 * F_460 ( struct V_165 * V_166 )
{
struct V_17 * V_23 = F_342 ( V_166 ) ;
...
static int F_464 ( struct V_165 * V_166 )
{
F_74 ( L_491 ) ;
F_465 ( V_166 ) ;
return 0 ;
}
static int F_466 ( struct V_17 * V_23 , struct V_1289 * V_532 ,
int V_1290 )
{
...
if ( ! ( V_23 -> V_37 & V_103 ) )
goto V_1136;
V_1295 = F_393 ( F_222 ( V_1055 -> V_1137 ) ) ;
switch ( V_23 -> V_163 -> V_513 ) {
case V_514 :
V_1008 = ! F_366 ( V_1055 -> V_1071 ) ;
V_1294 = F_263 ( V_23 , V_1055 -> V_1071 ) ;
if ( V_1294 == V_552 ) {
...
#ifdef F_293
if ( V_1056 & V_1309 )
F_367 ( V_23 , V_1290 , & ( V_768 -> V_538 . V_3 ) ) ;
#endif
V_768 -> V_538 . V_3 . V_539 = F_179 ( F_3 ( ( T_2 ) ( V_540 - 2 ) ,
V_532 -> V_1310 ) ) ;
F_468 ( L_494 ,
V_532 -> V_1310 , F_227 ( V_768 -> V_538 . V_3 . V_539 ) ) ;
...
F_4 ( V_1313 L_498 ,
V_8 , V_15 ) ;
memcpy ( F_383 ( V_501 , V_15 ) ,
V_532 -> V_1292 [ V_8 ] -> V_3 + V_1295 , V_15 ) ;
}
F_394 ( V_532 -> V_1292 [ V_7 ] ) ;
...
static int F_470 ( struct V_165 * V_166 , int V_1290 )
{
struct V_17 * V_23 = F_342 ( V_166 ) ;
#ifdef F_293
int V_1293 = F_364 ( V_23 , V_1290 ) ;
...
static void F_471 ( struct V_17 * V_23 ,
struct V_1289 * V_532 )
{
struct V_673 V_1315 ;
struct V_1054 * V_1055 ;
...
V_4 = V_803 -> V_4 ;
V_1317 = F_300 ( V_4 + sizeof( * V_1080 ) + sizeof( T_4 ) * 2 , V_139 ) ;
if ( ! V_1317 )
continue;
V_1080 = ( void * ) F_383 ( V_1317 , sizeof( * V_1080 ) ) ;
V_1080 -> V_1081 = V_1082 ;
V_1080 -> V_1083 = 0 ;
V_1080 -> V_1085 = 0 ;
V_1080 -> V_1085 |= F_179 ( 1 << V_1089 ) ;
* ( T_8 * ) F_383 ( V_1317 , sizeof( T_4 ) ) = F_173 (
F_387 ( V_23 -> V_197 ) ) ;
if ( V_23 -> V_197 > 14 )
* ( T_8 * ) F_383 ( V_1317 , sizeof( T_4 ) ) =
F_173 ( V_1101 |
V_1102 ) ;
...
F_472 ( V_803 , F_383 ( V_1317 , V_4 ) , V_4 ) ;
if ( ! F_385 ( V_23 -> V_159 -> V_163 , V_1317 , & V_1315 ) )
F_394 ( V_1317 ) ;
}
}
static T_12 F_473 ( struct V_1289 * V_532 ,
...
static int F_475 ( struct V_165 * V_166 , void * V_134 )
{
struct V_17 * V_23 = F_342 ( V_166 ) ;
...
static void F_477 ( struct V_165 * V_166 ,
struct V_1322 * V_903 )
{
struct V_17 * V_134 = F_342 ( V_166 ) ;
char V_1323 [ 64 ] ;
char V_1324 [ 32 ] ;
T_3 V_4 ;
F_478 ( V_903 -> V_1325 , V_1326 , sizeof( V_903 -> V_1325 ) ) ;
F_478 ( V_903 -> V_984 , V_1327 , sizeof( V_903 -> V_984 ) ) ;
V_4 = sizeof( V_1323 ) ;
...
V_1323 , V_1324 ) ;
F_478 ( V_903 -> V_1331 , F_479 ( V_134 -> V_477 ) ,
sizeof( V_903 -> V_1331 ) ) ;
V_903 -> V_1332 = V_386 ;
}
static T_3 F_480 ( struct V_165 * V_166 )
{
struct V_17 * V_23 = F_342 ( V_166 ) ;
...
static T_13 F_484 ( int V_1335 , void * V_3 )
{
struct V_17 * V_23 = V_3 ;
T_3 V_219 , V_220 ;
if ( ! V_23 )
...
static void F_493 ( struct V_17 * V_23 )
{
F_72 ( V_23 ) ;
F_267 ( V_23 -> V_167 ) ;
F_138 ( V_23 ) ;
...
static void F_494 ( struct V_106 * V_107 )
{
struct V_17 * V_23 =
...
F_496 ( & V_23 -> V_228 ) ;
F_496 ( & V_23 -> V_486 ) ;
F_497 ( & V_23 -> V_669 , F_324 ) ;
F_498 ( & V_23 -> V_333 , F_375 ) ;
F_498 ( & V_23 -> V_558 , F_268 ) ;
F_498 ( & V_23 -> V_564 , F_269 ) ;
F_498 ( & V_23 -> V_780 , F_302 ) ;
F_498 ( & V_23 -> V_246 , F_164 ) ;
F_497 ( & V_23 -> V_191 , F_489 ) ;
F_498 ( & V_23 -> V_193 , V_1341 ) ;
F_498 ( & V_23 -> V_190 , V_1342 ) ;
F_497 ( & V_23 -> V_186 , F_334 ) ;
F_497 ( & V_23 -> V_187 , F_335 ) ;
F_497 ( & V_23 -> V_188 , F_333 ) ;
F_497 ( & V_23 -> V_189 , F_286 ) ;
F_497 ( & V_23 -> V_644 , F_282 ) ;
F_498 ( & V_23 -> V_653 , F_336 ) ;
F_498 ( & V_23 -> V_706 , F_374 ) ;
F_497 ( & V_23 -> V_322 , F_169 ) ;
F_498 ( & V_23 -> V_676 , F_492 ) ;
F_498 ( & V_23 -> V_241 , F_494 ) ;
F_497 ( & V_23 -> V_108 , F_57 ) ;
F_497 ( & V_23 -> V_104 , F_62 ) ;
F_497 ( & V_23 -> V_114 , F_66 ) ;
F_498 ( & V_23 -> V_816 , F_313 ) ;
#ifdef F_293
F_498 ( & V_23 -> V_962 , F_368 ) ;
#endif
F_499 ( & V_23 -> V_1338 , ( void (*) ( unsigned long ) )
F_140 , ( unsigned long ) V_23 ) ;
return V_432 ;
}
static void F_500 ( struct V_165 * V_166 ,
struct V_887 * V_244 )
{
struct V_17 * V_23 = F_342 ( V_166 ) ;
int V_7 ;
...
static int F_453 ( struct V_17 * V_23 ,
struct V_335 * V_336 )
{
memset ( V_336 , 0 , sizeof( * V_336 ) ) ;
switch ( V_23 -> V_163 -> V_861 ) {
...
static int F_501 ( struct V_17 * V_23 )
{
if ( F_181 ( V_23 ) )
goto error;
...
{
int V_8 ;
for ( V_8 = 0 ; V_8 < F_223 ( V_1355 ) ; V_8 ++ ) {
...
F_503 ( V_23 -> V_163 , & V_1355 [ V_8 ] ) ;
}
static int F_163 ( struct V_17 * V_23 )
{
int V_155 , V_7 ;
if ( V_23 -> V_1357 ) {
F_504 ( V_23 -> V_163 , V_23 -> V_1357 ) ;
V_23 -> V_1357 = 0 ;
}
if ( V_23 -> V_37 & V_701 )
return - V_306 ;
if ( V_149 && ! V_23 -> V_149 ) {
V_23 -> V_149 = F_505 ( V_149 , sizeof( * V_23 -> V_149 ) ,
V_148 ) ;
if ( V_23 -> V_149 == NULL ) {
F_46 ( L_510 ,
V_149 ) ;
...
static void F_506 ( struct V_17 * V_23 )
{
int V_7 ;
if ( V_23 -> V_37 & V_321 ) {
F_74 ( L_519 ) ;
...
V_1363 -> V_870 = F_505 ( V_202 -> V_203 ,
...
V_1363 -> V_1371 = V_1372 ;
V_1363 -> V_1373 = V_1374 ;
V_182 -> V_183 -> V_1375 [ V_1364 ] = V_1363 ;
}
if ( V_202 -> V_209 ) {
struct V_1362 * V_1376 = & V_23 -> V_163 -> V_1376 ;
V_1376 -> V_882 = V_1377 ;
V_1376 -> V_1365 = V_202 -> V_209 ;
V_1376 -> V_870 = F_505 ( V_202 -> V_209 ,
sizeof( struct V_1366 ) ,
V_148 ) ;
if ( ! V_1376 -> V_870 ) {
V_155 = - V_476 ;
...
for ( V_7 = 0 ; V_7 < V_202 -> V_209 ; V_7 ++ ) {
V_1376 -> V_870 [ V_7 ] . V_882 = V_1377 ;
V_1376 -> V_870 [ V_7 ] . V_1367 = V_202 -> V_18 [ V_7 ] . V_1150 ;
V_1376 -> V_870 [ V_7 ] . V_1368 = V_202 -> V_18 [ V_7 ] . V_197 ;
V_1376 -> V_870 [ V_7 ] . V_346 = V_202 -> V_18 [ V_7 ] . V_346 ;
if ( V_202 -> V_18 [ V_7 ] . V_41 & V_207 )
V_1376 -> V_870 [ V_7 ] . V_41 |=
V_1369 ;
...
V_182 -> V_183 -> V_1382 = F_223 ( V_1381 ) ;
F_508 ( V_182 -> V_183 , & V_23 -> V_477 -> V_166 ) ;
if ( F_509 ( V_182 -> V_183 ) )
V_155 = - V_306 ;
V_6:
return V_155 ;
}
...
{
struct V_1383 * V_159 = F_342 ( V_166 ) ;
...
static T_12 F_512 ( struct V_1006 * V_501 ,
struct V_165 * V_166 )
{
F_74 ( L_525 ) ;
F_240 ( V_501 ) ;
...
if ( V_23 -> V_157 )
return - V_160 ;
V_23 -> V_157 = F_513 ( sizeof( struct V_1383 ) , 1 ) ;
if ( V_23 -> V_157 == NULL )
return - V_476 ;
V_23 -> V_159 = F_342 ( V_23 -> V_157 ) ;
V_23 -> V_159 -> V_163 = F_514 ( V_23 -> V_157 ) ;
...
F_515 ( V_23 -> V_157 , & V_23 -> V_477 -> V_166 ) ;
V_155 = F_516 ( V_23 -> V_157 ) ;
if ( V_155 ) {
F_517 ( V_23 -> V_157 , 1 ) ;
V_23 -> V_157 = NULL ;
return V_155 ;
...
static int F_519 ( struct V_477 * V_1386 ,
...
struct V_17 * V_23 ;
int V_7 ;
V_167 = F_513 ( sizeof( struct V_17 ) , 0 ) ;
if ( V_167 == NULL ) {
V_557 = - V_476 ;
goto V_6;
}
V_23 = F_342 ( V_167 ) ;
V_23 -> V_163 = F_514 ( V_167 ) ;
V_23 -> V_167 = V_167 ;
V_23 -> V_477 = V_1386 ;
V_12 = V_1389 ;
F_303 ( & V_23 -> V_42 ) ;
...
F_522 ( V_1386 ) ;
V_557 = F_523 ( V_1386 , F_524 ( 32 ) ) ;
if ( ! V_557 )
V_557 = F_525 ( V_1386 , F_524 ( 32 ) ) ;
if ( V_557 ) {
F_4 (KERN_WARNING DRV_NAME L_527 ) ;
goto V_1392;
}
F_526 ( V_1386 , V_23 ) ;
V_557 = F_527 ( V_1386 , V_1326 ) ;
if ( V_557 )
goto V_1392;
F_528 ( V_1386 , 0x40 , & V_21 ) ;
if ( ( V_21 & 0x0000ff00 ) != 0 )
F_529 ( V_1386 , 0x40 , V_21 & 0xffff00ff ) ;
V_415 = F_530 ( V_1386 , 0 ) ;
V_23 -> V_1393 = V_415 ;
V_137 = F_531 ( V_1386 , 0 ) ;
if ( ! V_137 ) {
V_557 = - V_1390 ;
goto V_1394;
}
...
F_411 ( V_23 , 1 ) ;
V_557 = F_532 ( V_1386 -> V_1335 , F_484 , V_1396 , V_1326 , V_23 ) ;
if ( V_557 ) {
F_46 ( L_531 , V_1386 -> V_1335 ) ;
goto V_1395;
}
F_515 ( V_167 , & V_1386 -> V_166 ) ;
F_59 ( & V_23 -> V_109 ) ;
V_23 -> V_163 -> V_1397 = F_473 ;
V_23 -> V_163 -> V_897 = F_500 ;
V_23 -> V_163 -> V_1398 = F_470 ;
#ifdef F_293
V_23 -> V_163 -> V_1399 = F_365 ;
V_23 -> V_163 -> V_1400 = F_370 ;
V_23 -> V_163 -> V_1401 = F_369 ;
V_23 -> V_163 -> V_1402 = F_371 ;
#endif
V_23 -> V_163 -> V_642 = - 20 ;
V_23 -> V_163 -> V_643 = - 85 ;
V_167 -> V_1384 = & V_1403 ;
...
V_167 -> V_1406 = & V_1407 ;
V_167 -> V_1408 = & V_1409 ;
V_557 = F_533 ( & V_1386 -> V_166 . V_1410 , & V_1411 ) ;
if ( V_557 ) {
F_46 ( L_532 ) ;
F_60 ( & V_23 -> V_109 ) ;
goto V_1412;
...
return 0 ;
V_1414:
F_534 ( V_23 -> V_163 -> V_182 . V_183 ) ;
F_87 ( V_23 -> V_163 -> V_1376 . V_870 ) ;
F_87 ( V_23 -> V_163 -> V_1363 . V_870 ) ;
V_1413:
F_535 ( & V_1386 -> V_166 . V_1410 , & V_1411 ) ;
V_1412:
F_536 ( V_1386 -> V_1335 , V_23 ) ;
V_1395:
F_537 ( V_23 -> V_22 ) ;
V_1394:
F_538 ( V_1386 ) ;
...
static void F_540 ( struct V_477 * V_1386 )
{
struct V_17 * V_23 = F_541 ( V_1386 ) ;
...
static int F_544 ( struct V_477 * V_1386 , T_15 V_665 )
{
struct V_17 * V_23 = F_541 ( V_1386 ) ;
struct V_165 * V_166 = V_23 -> V_167 ;
...
F_546 ( V_1386 ) ;
F_539 ( V_1386 ) ;
F_547 ( V_1386 , F_548 ( V_1386 , V_665 ) ) ;
V_23 -> V_1415 = F_549 () ;
return 0 ;
}
static int F_550 ( struct V_477 * V_1386 )
{
struct V_17 * V_23 = F_541 ( V_1386 ) ;
struct V_165 * V_166 = V_23 -> V_167 ;
int V_557 ;
...
F_529 ( V_1386 , 0x40 , V_21 & 0xffff00ff ) ;
F_552 ( V_166 ) ;
V_23 -> V_1357 = F_549 () - V_23 -> V_1415 ;
F_128 ( & V_23 -> V_193 ) ;
return 0 ;
}
static void F_553 ( struct V_477 * V_1386 )
{
struct V_17 * V_23 = F_541 ( V_1386 ) ;
F_161 ( V_23 ) ;
F_539 ( V_1386 ) ;
}
static int T_16 F_554 ( void )
{
int V_432 ;
...
V_432 = F_556 ( & V_1417 . V_1325 , & V_1418 ) ;
if ( V_432 ) {
F_46 ( L_543 ) ;
F_557 ( & V_1417 ) ;
return V_432 ;
...
static void T_17 F_558 ( void )
{
F_559 ( & V_1417 . V_1325 , & V_1418 ) ;
F_557 ( & V_1417 ) ;
}
