...
static int F_15 ( struct V_20 * * V_32 , int V_33 )
{
struct V_20 * V_21 ;
int V_22 ;
...
if ( ! V_21 )
return - V_11 ;
V_21 -> V_29 = (struct V_29 * ) F_17 ( V_10 ) ;
if ( ! V_21 -> V_29 ) {
F_4 ( V_34 , V_21 ) ;
return - V_11 ;
}
...
int F_18 ( struct V_14 * V_15 , int V_35 , int V_36 )
{
int V_37 ;
V_37 = F_15 ( V_15 -> V_38 , V_35 ) ;
if ( V_37 )
return V_37 ;
V_37 = F_15 ( V_15 -> V_39 , V_36 ) ;
return V_37 ;
}
...
static void F_20 ( struct V_20 * V_21 , struct V_14 * V_15 ,
void * * V_44 , int V_22 )
{
struct V_20 * V_45 ;
int V_23 ;
F_21 ( & V_21 , sizeof( void * ) ) ;
...
F_13 (irq_ptr, q, i) {
F_23 ( L_1 , V_22 ) ;
F_19 ( V_21 , V_15 , V_56 -> V_63 , V_22 ) ;
V_21 -> V_48 = 1 ;
V_21 -> V_64 . V_65 . V_66 = V_56 -> V_67 ?
V_56 -> V_67 [ V_22 ] : NULL ;
F_20 ( V_21 , V_15 , V_57 , V_22 ) ;
V_57 += V_27 ;
if ( F_24 ( V_15 ) ) {
F_25 ( & V_21 -> V_68 , V_69 ,
( unsigned long ) V_21 ) ;
...
F_14 (irq_ptr, q, i) {
F_23 ( L_2 , V_22 ) ;
F_19 ( V_21 , V_15 , V_56 -> V_71 , V_22 ) ;
V_21 -> V_64 . V_72 . V_73 = V_62 ;
V_62 += V_27 ;
V_21 -> V_48 = 0 ;
V_21 -> V_64 . V_72 . V_74 = V_56 -> V_74 ;
F_20 ( V_21 , V_15 , V_59 , V_22 ) ;
V_59 += V_27 ;
F_25 ( & V_21 -> V_68 , V_75 ,
( unsigned long ) V_21 ) ;
F_26 ( & V_21 -> V_64 . V_72 . V_76 , ( void (*) ( unsigned long ) )
& V_77 , ( unsigned long ) V_21 ) ;
}
}
static void F_27 ( struct V_14 * V_15 , unsigned char V_78 )
{
if ( V_78 & V_79 )
V_15 -> V_80 . V_81 = 1 ;
if ( V_78 & V_82 )
...
F_23 ( L_6 , V_97 -> V_102 ) ;
if ( ! V_15 ) {
V_101 = (struct V_100 * ) F_17 ( V_10 ) ;
if ( ! V_101 )
return - V_11 ;
} else {
V_101 = (struct V_100 * ) V_15 -> V_103 ;
}
V_37 = F_30 ( * V_97 , V_101 ) ;
if ( V_37 )
goto V_72;
...
unsigned char V_78 ;
int V_37 ;
V_37 = F_29 ( V_15 , & V_15 -> V_97 , & V_15 -> V_110 ) ;
if ( V_37 ) {
F_32 ( L_7 , V_15 -> V_97 . V_102 ) ;
F_32 ( L_8 , V_37 ) ;
V_78 = V_79 | V_82 |
V_83 ;
} else
V_78 = V_15 -> V_110 . V_111 ;
F_28 ( V_15 , V_78 , V_15 -> V_110 . V_95 ) ;
F_27 ( V_15 , V_78 ) ;
F_23 ( L_9 , V_78 , V_15 -> V_110 . V_112 ) ;
F_23 ( L_10 , V_15 -> V_110 . V_113 , V_15 -> V_24 . V_114 ) ;
}
...
F_35 ( V_15 , V_15 -> V_38 , V_22 , 0 ) ;
for ( V_22 = 0 ; V_22 < V_56 -> V_133 ; V_22 ++ )
F_35 ( V_15 , V_15 -> V_39 , V_22 ,
V_56 -> V_131 ) ;
}
...
F_39 ( V_15 -> V_146 , & V_15 -> V_97 ) ;
F_22 ( V_15 , V_139 ) ;
F_37 ( V_15 , V_139 ) ;
F_40 ( V_15 ) ;
F_12 ( V_15 , V_139 -> V_16 ,
V_139 -> V_17 ,
V_139 -> V_18 ,
V_139 -> V_19 ) ;
F_36 ( V_15 , V_139 ) ;
V_145 = F_41 ( V_139 -> V_146 , V_156 ) ;
if ( ! V_145 ) {
F_32 ( L_11 , V_15 -> V_97 . V_102 ) ;
V_37 = - V_109 ;
goto V_157;
}
V_15 -> V_158 = * V_145 ;
V_145 = F_41 ( V_139 -> V_146 , V_159 ) ;
if ( ! V_145 ) {
F_32 ( L_12 , V_15 -> V_97 . V_102 ) ;
V_37 = - V_109 ;
goto V_157;
}
V_15 -> V_160 = * V_145 ;
...
F_44 ( V_170 L_24 , V_164 ) ;
}
int F_45 ( struct V_171 * V_172 )
{
V_172 -> V_118 = F_46 ( sizeof( struct V_1 * ) * V_27 ,
V_3 ) ;
if ( ! V_172 -> V_118 ) {
V_172 -> V_116 = 0 ;
return - V_11 ;
...
{
int V_37 ;
V_34 = F_49 ( L_25 , sizeof( struct V_20 ) ,
256 , 0 , NULL ) ;
if ( ! V_34 )
return - V_11 ;
V_2 = F_49 ( L_26 ,
