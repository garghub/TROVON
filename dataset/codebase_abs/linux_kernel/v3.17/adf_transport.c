...
T_1 V_88 = 0 ;
int V_9 , V_60 ;
V_87 = F_56 ( sizeof( * V_87 ) , V_45 ,
V_38 -> V_85 ) ;
if ( ! V_87 )
return - V_46 ;
V_88 = F_41 ( V_38 ) ;
V_5 = V_88 * sizeof( struct V_13 ) ;
V_87 -> V_62 = F_56 ( V_5 , V_45 , V_38 -> V_85 ) ;
if ( ! V_87 -> V_62 ) {
V_60 = - V_46 ;
goto V_89;
}
...
V_60 = F_55 ( V_38 , & V_87 -> V_62 [ V_9 ] , V_9 ,
V_19 ) ;
if ( V_60 )
goto V_98;
}
...
{
struct V_54 * V_87 = V_38 -> V_56 ;
T_1 V_9 , V_88 = F_41 ( V_38 ) ;
for ( V_9 = 0 ; V_9 < V_88 ; V_9 ++ )
F_63 ( & V_87 -> V_62 [ V_9 ] ) ;
}
