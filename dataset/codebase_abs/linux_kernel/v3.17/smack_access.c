...
V_34 -> V_11 = V_66 ;
V_34 -> V_86 = V_87 ++ ;
V_34 -> V_88 . V_89 = V_34 -> V_11 ;
V_34 -> V_88 . V_77 =
V_90 | V_91 ;
V_83 = strlen ( V_66 ) ;
if ( V_83 < V_92 )
V_21 = F_25 ( V_93 , V_34 -> V_11 ,
& V_34 -> V_88 , V_83 ) ;
else
V_21 = F_25 ( V_94 , ( char * ) & V_34 -> V_86 ,
& V_34 -> V_88 , sizeof( V_34 -> V_86 ) ) ;
if ( V_21 >= 0 ) {
F_30 ( & V_34 -> V_29 ) ;
F_31 ( & V_34 -> V_95 ) ;
F_17 ( V_34 ) ;
...
struct V_15 * F_35 ( const T_1 V_97 )
{
struct V_15 * V_34 ;
F_3 () ;
