...
F_47 () ;
while ( V_29 ) {
int V_31 = F_48 ( V_29 , V_32 ) ;
int V_1 ;
for ( V_1 = 0 ; V_1 < V_31 ; V_1 ++ )
F_40 ( V_30 [ V_1 ] ) ;
F_49 ( V_30 , V_31 , false ) ;
V_30 += V_31 ;
V_29 -= V_31 ;
}
}
struct V_13 * F_50 ( T_1 V_14 )
{
struct V_13 * V_13 ;
V_13 = F_51 ( F_13 ( V_14 ) , V_14 . V_16 ) ;
if ( V_13 ) {
F_18 ( V_9 ) ;
if ( F_52 ( V_13 ) )
F_53 ( & V_33 ) ;
...
struct V_13 * F_54 ( T_1 V_14 , T_2 V_21 ,
struct V_34 * V_35 , unsigned long V_36 )
{
struct V_13 * V_37 , * V_38 = NULL ;
int V_24 ;
do {
V_37 = F_51 ( F_13 ( V_14 ) ,
V_14 . V_16 ) ;
...
static unsigned long F_64 ( unsigned long V_41 )
{
static unsigned long V_42 ;
unsigned int V_28 , V_43 , V_44 ;
static T_3 V_45 ;
V_43 = 1 << F_65 ( V_46 ) ;
if ( V_43 <= 1 )
return 1 ;
...
struct V_13 * F_69 ( T_1 V_14 , T_2 V_21 ,
struct V_34 * V_35 , unsigned long V_36 )
{
struct V_13 * V_13 ;
unsigned long V_48 = F_70 ( V_14 ) ;
unsigned long V_41 = V_48 ;
...
V_49 ++ ;
F_71 ( & V_53 ) ;
for ( V_41 = V_49 ; V_41 <= V_50 ; V_41 ++ ) {
V_13 = F_54 ( F_72 ( F_73 ( V_14 ) , V_41 ) ,
V_21 , V_35 , V_36 ) ;
if ( ! V_13 )
continue;
if ( V_41 != V_48 )
...
F_47 () ;
V_54:
return F_54 ( V_14 , V_21 , V_35 , V_36 ) ;
}
