...
V_187 = V_184 -> V_203 ;
F_15 ( L_68 , V_187 -> V_204 . V_205 ) ;
for ( V_79 = 0 ; V_79 < V_187 -> V_204 . V_205 ; ++ V_79 ) {
V_189 = & V_187 -> V_189 [ V_79 ] . V_204 ;
if ( ! V_21 -> V_166 && F_105 ( V_189 ) ) {
V_21 -> V_166 = V_189 -> V_206 ;
}
}
if ( ! V_21 -> V_166 ) {
V_50 = - V_12 ;
...
F_108 ( & V_21 -> V_75 ) ;
V_21 -> V_25 = V_135 ;
F_109 ( & V_21 -> V_55 , & V_207 ,
NULL , & V_21 -> V_75 ,
V_54 ,
V_141 ,
sizeof( struct V_28 ) , V_21 , & V_21 -> V_51 ) ;
V_50 = F_110 ( & V_21 -> V_198 , V_208 , - 1 ) ;
if ( V_50 ) {
F_3 ( & V_2 -> V_11 , L_70 ) ;
goto V_42;
}
...
static int F_117 ( struct V_183 * V_184 , T_9 V_209 )
{
struct V_20 * V_21 = F_113 ( V_184 ) ;
V_21 -> V_210 = V_21 -> V_94 ;
if ( ! V_21 -> V_210 )
return 0 ;
F_74 ( V_21 ) ;
F_70 ( V_21 ) ;
