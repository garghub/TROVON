...
bool F_6 ( void T_2 * V_41 , unsigned char V_42 , unsigned char * V_43 )
{
unsigned short V_44 ;
unsigned char V_45 ;
F_7 ( V_41 + V_46 , V_42 ) ;
...
bool F_12 ( void T_2 * V_41 , unsigned char V_42 , unsigned char V_54 )
{
unsigned short V_44 ;
unsigned char V_45 ;
F_7 ( V_41 + V_46 , V_42 ) ;
...
bool F_13 ( void T_2 * V_41 , unsigned char V_42 , unsigned char V_56 )
{
unsigned char V_57 ;
F_6 ( V_41 , V_42 , & V_57 ) ;
return ( V_57 & V_56 ) == V_56 ;
}
bool F_14 ( void T_2 * V_41 , unsigned char V_42 , unsigned char V_56 )
{
unsigned char V_57 ;
F_6 ( V_41 , V_42 , & V_57 ) ;
return ( V_57 & V_56 ) == 0 ;
...
void F_18 ( void T_2 * V_41 , unsigned char * V_88 )
{
int V_59 ;
...
void
F_3 ( void T_2 * V_41 , unsigned char V_100 )
{
unsigned char V_101 ;
F_6 ( V_41 , 0x09 , & V_101 ) ;
if ( V_100 == V_102 ) {
...
void
F_2 ( void T_2 * V_41 , unsigned char V_100 )
{
unsigned char V_96 ;
F_6 ( V_41 , 0x0A , & V_96 ) ;
if ( V_100 == V_102 ) {
...
void
F_26 ( void T_2 * V_41 , unsigned char V_61 )
{
F_12 ( V_41 , 0x0C , 0x17 ) ;
F_12 ( V_41 , 0x0D , 0xB9 ) ;
}
void
F_27 ( void T_2 * V_41 , unsigned char V_61 )
{
F_12 ( V_41 , 0x0C , 0x00 ) ;
F_12 ( V_41 , 0x0D , 0x01 ) ;
}
