...
static int F_52 ( struct V_6 * V_6 , int V_132 )
{
...
F_53 ( V_132 > 0xf ) ;
V_133 = V_2 -> V_136 [ V_132 ] . V_133 ;
V_134 = ( V_133 & 0x0f00 ) ?
V_135 : ( unsigned char * ) & V_2 -> V_136 [ V_132 ] . V_3 ;
if ( F_54 ( V_125 , V_134 , V_133 ) )
return - 1 ;
return 0 ;
}
static int F_55 ( struct V_6 * V_6 , int V_137 )
{
struct V_125 * V_125 = & V_6 -> V_125 ;
struct V_1 * V_2 = V_6 -> V_18 ;
int V_74 , V_132 ;
if ( F_54 ( V_125 , NULL , V_2 -> V_138 ) )
return - 1 ;
for ( V_74 = 12 ; V_74 >= 0 ; V_74 -= 4 ) {
V_132 = ( V_137 >> V_74 ) & 0xf ;
if ( F_52 ( V_6 , V_132 ) )
return - 1 ;
}
return 0 ;
}
static int F_56 ( struct V_6 * V_6 , int V_137 )
{
struct V_125 * V_125 = & V_6 -> V_125 ;
unsigned char V_134 [ 4 ] ;
if ( F_54 ( V_125 , V_134 , V_139 ) )
return - 1 ;
if ( V_137 != ( ( V_134 [ 0 ] << 8 ) | V_134 [ 1 ] ) )
return - 1 ;
return V_134 [ 2 ] ;
}
static int F_57 ( struct V_6 * V_6 , int V_137 )
{
if ( F_55 ( V_6 , V_137 ) )
return - 1 ;
return F_56 ( V_6 , V_137 ) ;
}
static int F_58 ( struct V_6 * V_6 , T_3 V_140 )
{
if ( F_52 ( V_6 , ( V_140 >> 4 ) & 0xf ) )
return - 1 ;
if ( F_52 ( V_6 , V_140 & 0xf ) )
return - 1 ;
return 0 ;
}
static int F_59 ( struct V_6 * V_6 , int V_137 ,
T_3 V_140 )
{
if ( F_55 ( V_6 , V_137 ) )
return - 1 ;
return F_58 ( V_6 , V_140 ) ;
}
static int F_60 ( struct V_6 * V_6 , int V_141 ,
int V_142 , unsigned char * V_134 )
{
struct V_125 * V_125 = & V_6 -> V_125 ;
V_134 [ 0 ] = 0 ;
if ( V_141 && F_54 ( V_125 , V_134 , V_141 ) )
return - V_143 ;
if ( F_54 ( V_125 , NULL , V_142 ) ||
F_54 ( V_125 , NULL , V_142 ) ||
F_54 ( V_125 , NULL , V_142 ) )
return - V_143 ;
V_134 [ 0 ] = V_134 [ 1 ] = V_134 [ 2 ] = 0xff ;
if ( F_54 ( V_125 , V_134 , V_139 ) )
return - V_143 ;
F_24 ( V_6 , L_6 ,
V_142 , V_134 ) ;
...
static bool F_61 ( unsigned char V_144 [] )
{
if ( V_144 [ 0 ] == 0x73 )
return true ;
if ( V_144 [ 0 ] == 0x88 &&
...
static int F_65 ( struct V_6 * V_6 , bool V_147 )
{
struct V_125 * V_125 = & V_6 -> V_125 ;
int V_148 = V_147 ? V_149 : V_150 ;
if ( F_54 ( V_125 , NULL , V_148 ) ||
F_54 ( V_125 , NULL , V_148 ) ||
F_54 ( V_125 , NULL , V_148 ) ||
...
return - 1 ;
return F_54 ( & V_6 -> V_125 , NULL , V_153 ) ;
}
static int F_68 ( struct V_6 * V_6 , T_4 V_154 )
{
int V_74 , V_132 ;
for ( V_74 = 0 ; V_74 <= 8 ; V_74 += 4 ) {
V_132 = ( V_154 >> V_74 ) & 0xf ;
if ( F_52 ( V_6 , V_132 ) )
return - 1 ;
}
return 0 ;
...
static int F_70 ( struct V_6 * V_6 , bool V_147 )
{
struct V_125 * V_125 = & V_6 -> V_125 ;
if ( V_147 ) {
if ( F_54 ( V_125 , NULL , V_145 ) ||
F_54 ( V_125 , NULL , V_139 ) ||
F_54 ( V_125 , NULL , V_151 ) ||
F_54 ( V_125 , NULL , V_151 ) ||
...
if ( F_70 ( V_6 , true ) )
return - 1 ;
V_156 = F_69 ( V_6 , 0x000 , V_155 ) ;
if ( F_70 ( V_6 , false ) )
V_156 = - 1 ;
return V_156 ;
}
static int F_72 ( struct V_6 * V_6 , char * V_134 )
{
if ( F_60 ( V_6 , 0 , V_151 , V_134 ) )
return - 1 ;
return 0 ;
}
static int F_73 ( struct V_6 * V_6 , int V_147 )
{
struct V_125 * V_125 = & V_6 -> V_125 ;
int V_148 = V_147 ? V_157 : V_158 ;
unsigned char V_159 = V_147 ? 0x0A : 0x00 ;
unsigned char V_134 [ 4 ] ;
if ( F_54 ( V_125 , V_134 , V_139 ) ||
F_54 ( V_125 , NULL , V_151 ) ||
F_54 ( V_125 , NULL , V_151 ) ||
F_54 ( V_125 , & V_159 , V_148 ) )
return - 1 ;
if ( F_72 ( V_6 , V_134 ) )
return - 1 ;
return 0 ;
...
{
struct V_1 * V_2 = V_6 -> V_18 ;
unsigned char V_160 [ sizeof( V_6 -> V_19 ) ] ;
bool V_161 ;
if ( V_2 -> V_29 & V_162 )
F_65 ( V_6 , true ) ;
V_161 = F_54 ( & V_6 -> V_125 , V_160 ,
V_163 | ( V_6 -> V_127 << 8 ) ) < 0 ;
if ( V_2 -> V_29 & V_162 )
F_65 ( V_6 , false ) ;
if ( V_161 || ( V_160 [ 0 ] & V_2 -> V_4 ) != V_2 -> V_5 )
return - 1 ;
if ( ( V_6 -> V_164 & 0xc8 ) == 0x08 ) {
if ( F_54 ( & V_6 -> V_125 , V_160 , V_163 | ( 3 << 8 ) ) )
return - 1 ;
}
memcpy ( V_6 -> V_19 , V_160 , sizeof( V_160 ) ) ;
return 0 ;
}
...
{
unsigned char V_134 [ 2 ] = { 0xC8 , 0x14 } ;
if ( F_65 ( V_6 , true ) )
return - 1 ;
if ( F_54 ( & V_6 -> V_125 , NULL , V_150 ) ||
F_54 ( & V_6 -> V_125 , NULL , V_150 ) ||
F_54 ( & V_6 -> V_125 , NULL , V_150 ) ||
F_54 ( & V_6 -> V_125 , & V_134 [ 0 ] , V_157 ) ||
F_54 ( & V_6 -> V_125 , & V_134 [ 1 ] , V_157 ) )
return - 1 ;
if ( F_65 ( V_6 , false ) )
return - 1 ;
if ( F_71 ( V_6 ) ) {
...
int V_165 , bool V_147 )
{
int V_155 , V_156 = - 1 ;
if ( F_62 ( V_6 ) )
return - 1 ;
V_155 = F_57 ( V_6 , V_165 + 0x0008 ) ;
if ( V_155 == - 1 )
goto error;
if ( V_147 )
V_155 |= 0x01 ;
...
static int F_80 ( struct V_6 * V_6 , int V_165 )
{
int V_156 = - V_143 , V_155 ;
if ( F_62 ( V_6 ) )
goto error;
V_155 = F_57 ( V_6 , V_165 + 0x08 ) ;
if ( V_155 == - 1 )
goto error;
V_156 = V_155 & 0x80 ? 0 : - V_166 ;
error:
F_64 ( V_6 ) ;
return V_156 ;
}
static int F_81 ( struct V_6 * V_6 , int V_165 )
{
struct V_125 * V_125 = & V_6 -> V_125 ;
int V_156 = 0 ;
unsigned char V_134 [ 4 ] ;
if ( F_78 ( V_6 , V_165 , true ) )
return - V_143 ;
if ( F_60 ( V_6 , 0 , V_149 , V_134 ) ) {
F_76 ( V_6 , L_12 ) ;
V_156 = - V_166 ;
} else {
F_24 ( V_6 , L_13 , V_134 ) ;
if ( F_54 ( V_125 , NULL , V_150 ) ||
F_54 ( V_125 , NULL , V_150 ) ||
F_54 ( V_125 , NULL , V_150 ) ||
F_52 ( V_6 , 0x9 ) ||
F_52 ( V_6 , 0x4 ) ) {
...
int V_155 ;
unsigned char V_134 [ 4 ] ;
V_155 = F_80 ( V_6 , V_167 ) ;
if ( V_155 == - V_143 )
goto error;
if ( V_155 == 0 &&
F_81 ( V_6 , V_167 ) == - V_143 )
goto error;
if ( F_62 ( V_6 ) ||
F_79 ( V_6 ) ) {
F_63 ( V_6 , L_15 ) ;
...
V_155 = F_57 ( V_6 , 0x0006 ) ;
if ( V_155 == - 1 )
goto error;
if ( F_58 ( V_6 , V_155 | 0x01 ) )
goto error;
V_155 = F_57 ( V_6 , 0x0007 ) ;
if ( V_155 == - 1 )
goto error;
if ( F_58 ( V_6 , V_155 | 0x01 ) )
goto error;
...
static int F_83 ( struct V_6 * V_6 , int V_168 )
{
int V_169 , V_170 , V_171 , V_172 , V_173 , V_174 , V_175 ;
struct V_1 * V_2 = V_6 -> V_18 ;
V_169 = F_57 ( V_6 , V_168 ) ;
if ( V_169 < 0 )
return V_169 ;
V_170 = ( char ) ( V_169 << 4 ) >> 4 ;
V_170 = 50 + 2 * V_170 ;
V_171 = ( char ) V_169 >> 4 ;
V_171 = 36 + 2 * V_171 ;
V_169 = F_57 ( V_6 , V_168 + 1 ) ;
if ( V_169 < 0 )
return V_169 ;
V_172 = ( char ) ( V_169 << 4 ) >> 4 ;
V_172 = 17 + V_172 ;
V_173 = ( char ) V_169 >> 4 ;
V_173 = 13 + V_173 ;
V_174 = V_170 * ( V_172 - 1 ) ;
V_175 = V_171 * ( V_173 - 1 ) ;
V_2 -> V_176 = V_2 -> V_65 * 10 / V_174 ;
V_2 -> V_177 = V_2 -> V_66 * 10 / V_175 ;
F_24 ( V_6 ,
L_17 ,
V_170 , V_171 , V_172 , V_173 ,
V_174 / 10 , V_175 / 10 , V_2 -> V_176 , V_2 -> V_177 ) ;
return 0 ;
}
...
if ( F_83 ( V_6 , 0xc2da ) )
goto error;
V_155 = F_57 ( V_6 , 0xc2c6 ) ;
if ( V_155 == - 1 )
goto error;
if ( F_58 ( V_6 , V_155 & 0xfd ) )
goto error;
if ( F_59 ( V_6 , 0xc2c9 , 0x64 ) )
goto error;
V_155 = F_57 ( V_6 , 0xc2c4 ) ;
if ( V_155 == - 1 )
goto error;
if ( F_58 ( V_6 , V_155 | 0x02 ) )
goto error;
F_64 ( V_6 ) ;
return F_54 ( V_125 , NULL , V_152 ) ;
error:
F_64 ( V_6 ) ;
return V_156 ;
}
...
V_134 [ 1 ] = 0x64 ;
V_134 [ 2 ] = 0x50 ;
if ( F_54 ( V_125 , & V_134 [ 0 ] , V_157 ) ||
F_54 ( V_125 , & V_134 [ 1 ] , V_157 ) ||
F_54 ( V_125 , & V_134 [ 2 ] , V_157 ) ||
F_54 ( V_125 , V_134 , V_179 ) )
return - 1 ;
V_134 [ 0 ] = 0x64 ;
if ( F_54 ( V_125 , V_134 , V_157 ) ||
F_54 ( V_125 , NULL , V_152 ) ) {
...
F_54 ( V_125 , NULL , V_153 ) ||
F_54 ( V_125 , & V_134 [ 0 ] , V_157 ) ||
F_54 ( V_125 , & V_134 [ 0 ] , V_157 ) )
return - 1 ;
if ( F_54 ( V_125 , V_134 , V_139 ) )
return - 1 ;
V_180 = V_182 + ( V_134 [ 2 ] & 0x0F ) ;
V_181 = V_183 + ( ( V_134 [ 2 ] >> 4 ) & 0x0F ) ;
V_2 -> V_62 = V_180 ;
V_2 -> V_63 = V_181 ;
V_2 -> V_65 = ( V_180 - 1 ) * V_184 ;
V_2 -> V_66 = ( V_181 - 1 ) * V_184 ;
if ( F_64 ( V_6 ) )
return - 1 ;
return 0 ;
}
...
unsigned char * V_197 , unsigned char * V_198 )
{
const struct V_199 * V_200 ;
int V_74 ;
for ( V_74 = 0 ; V_74 < F_92 ( V_201 ) ; V_74 ++ ) {
V_200 = & V_201 [ V_74 ] ;
if ( ! memcmp ( V_197 , V_200 -> V_202 , sizeof( V_200 -> V_202 ) ) &&
( ! V_200 -> V_203 ||
V_200 -> V_203 == V_198 [ 2 ] ) ) {
V_2 -> V_27 = V_200 -> V_27 ;
F_90 ( V_2 ) ;
...
{
unsigned char V_205 [ 4 ] , V_197 [ 4 ] , V_198 [ 4 ] ;
if ( F_60 ( V_6 , V_158 ,
V_150 , V_205 ) )
return - V_143 ;
if ( ( V_205 [ 0 ] & 0xf8 ) != 0 || V_205 [ 1 ] != 0 || ( V_205 [ 2 ] != 10 && V_205 [ 2 ] != 100 ) )
return - V_204 ;
if ( F_60 ( V_6 , V_158 ,
V_149 , V_197 ) ||
F_60 ( V_6 , V_158 ,
...
F_64 ( V_6 ) )
return - V_143 ;
memcpy ( V_2 -> V_195 , V_198 , 3 ) ;
if ( F_91 ( V_6 , V_2 , V_197 , V_198 ) == 0 ) {
return 0 ;
} else if ( V_197 [ 0 ] == 0x73 && V_197 [ 1 ] == 0x03 && V_197 [ 2 ] == 0x50 &&
V_198 [ 0 ] == 0x73 && ( V_198 [ 1 ] == 0x01 || V_198 [ 1 ] == 0x02 ) ) {
V_2 -> V_27 = V_130 ;
F_90 ( V_2 ) ;
if ( F_87 ( V_6 , V_2 ) )
return - V_143 ;
...
return 0 ;
} else if ( V_198 [ 0 ] == 0x88 &&
( ( V_198 [ 1 ] & 0xf0 ) == 0xb0 || ( V_198 [ 1 ] & 0xf0 ) == 0xc0 ) ) {
V_2 -> V_27 = V_131 ;
F_90 ( V_2 ) ;
return 0 ;
} else if ( V_198 [ 0 ] == 0x88 && V_198 [ 1 ] == 0x08 ) {
V_2 -> V_27 = V_105 ;
F_90 ( V_2 ) ;
V_2 -> V_186 = F_84 ;
V_2 -> V_103 = F_27 ;
...
V_2 -> V_29 &= ~ V_32 ;
return 0 ;
} else if ( V_198 [ 0 ] == 0x88 && V_198 [ 1 ] == 0x07 &&
V_198 [ 2 ] >= 0x90 && V_198 [ 2 ] <= 0x9d ) {
V_2 -> V_27 = V_105 ;
F_90 ( V_2 ) ;
return 0 ;
}
...
static void V_188 ( struct V_1 * V_2 ,
struct V_7 * V_8 )
{
...
F_101 ( V_8 , V_87 , V_2 -> V_176 ) ;
F_101 ( V_8 , V_88 , V_2 -> V_177 ) ;
F_102 ( V_8 , V_91 , V_206 |
V_207 | V_208 | V_209 ) ;
F_103 ( V_210 , V_8 -> V_211 ) ;
F_103 ( V_212 , V_8 -> V_211 ) ;
if ( V_2 -> V_27 == V_131 )
F_104 ( V_213 , V_8 -> V_214 ) ;
}
int F_105 ( struct V_6 * V_6 )
{
struct V_1 * V_2 ;
struct V_7 * V_8 = V_6 -> V_13 , * V_9 ;
V_2 = F_106 ( sizeof( struct V_1 ) , V_215 ) ;
V_9 = F_107 () ;
if ( ! V_2 || ! V_9 )
goto V_216;
V_2 -> V_9 = V_9 ;
...
if ( V_2 -> V_186 ( V_6 ) )
goto V_216;
F_109 ( V_217 , V_8 -> V_218 ) ;
F_109 ( V_33 , V_8 -> V_219 ) ;
F_109 ( V_34 , V_8 -> V_219 ) ;
V_8 -> V_218 [ F_110 ( V_220 ) ] |= F_111 ( V_220 ) ;
V_8 -> V_211 [ F_110 ( V_40 ) ] |= F_111 ( V_40 ) ;
V_8 -> V_211 [ F_110 ( V_39 ) ] |= F_111 ( V_39 ) ;
V_8 -> V_211 [ F_110 ( V_14 ) ] |=
F_111 ( V_14 ) | F_111 ( V_16 ) ;
V_8 -> V_218 [ F_110 ( V_221 ) ] |= F_111 ( V_221 ) ;
V_2 -> V_187 ( V_2 , V_8 ) ;
if ( V_2 -> V_27 != V_131 )
F_100 ( V_8 , V_38 , 0 , 127 , 0 , 0 ) ;
if ( V_2 -> V_29 & V_41 ) {
V_8 -> V_218 [ F_110 ( V_217 ) ] |= F_111 ( V_217 ) ;
V_8 -> V_219 [ F_110 ( V_42 ) ] |= F_111 ( V_42 ) ;
}
if ( V_2 -> V_29 & ( V_30 | V_31 ) ) {
V_8 -> V_211 [ F_110 ( V_43 ) ] |= F_111 ( V_43 ) ;
V_8 -> V_211 [ F_110 ( V_44 ) ] |= F_111 ( V_44 ) ;
}
if ( V_2 -> V_29 & V_45 ) {
V_8 -> V_211 [ F_110 ( V_46 ) ] |= F_111 ( V_46 ) ;
V_8 -> V_211 [ F_110 ( V_47 ) ] |= F_111 ( V_47 ) ;
V_8 -> V_211 [ F_110 ( V_48 ) ] |= F_111 ( V_48 ) ;
V_8 -> V_211 [ F_110 ( V_49 ) ] |= F_111 ( V_49 ) ;
} else if ( V_2 -> V_29 & V_196 ) {
F_103 ( V_222 , V_8 -> V_214 ) ;
F_104 ( V_16 , V_8 -> V_211 ) ;
} else {
V_8 -> V_211 [ F_110 ( V_17 ) ] |= F_111 ( V_17 ) ;
}
snprintf ( V_2 -> V_223 , sizeof( V_2 -> V_223 ) , L_19 , V_6 -> V_125 . V_126 -> V_223 ) ;
V_9 -> V_223 = V_2 -> V_223 ;
V_9 -> V_224 = ( V_2 -> V_29 & V_32 ) ?
L_20 : L_21 ;
V_9 -> V_144 . V_225 = V_226 ;
V_9 -> V_144 . V_227 = 0x0002 ;
V_9 -> V_144 . V_228 = V_229 ;
V_9 -> V_144 . V_230 = 0x0000 ;
V_9 -> V_13 . V_231 = & V_6 -> V_125 . V_126 -> V_13 ;
V_9 -> V_218 [ 0 ] = F_111 ( V_220 ) | F_111 ( V_217 ) ;
V_9 -> V_219 [ F_110 ( V_33 ) ] = F_111 ( V_33 ) | F_111 ( V_34 ) ;
V_9 -> V_211 [ F_110 ( V_14 ) ] =
F_111 ( V_14 ) | F_111 ( V_17 ) | F_111 ( V_16 ) ;
F_112 ( V_232 , V_9 -> V_214 ) ;
if ( V_2 -> V_29 & V_32 )
F_112 ( V_233 , V_9 -> V_214 ) ;
if ( F_113 ( V_2 -> V_9 ) )
goto V_216;
V_6 -> V_234 = F_51 ;
V_6 -> V_235 = F_74 ;
...
int F_115 ( struct V_6 * V_6 , bool V_239 )
{
struct V_1 V_135 ;
if ( F_93 ( V_6 , & V_135 ) < 0 )
return - 1 ;
if ( V_239 ) {
V_6 -> V_227 = L_22 ;
V_6 -> V_224 = V_135 . V_29 & V_32 ?
L_23 : L_24 ;
V_6 -> V_200 = V_135 . V_27 << 8 ;
}
return 0 ;
}
