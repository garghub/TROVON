...
if ( ! ( V_42 -> V_60 & V_61 ) )
{
struct V_62 * V_63 = F_7 ( NULL , L_3 ) ;
long V_64 , V_65 = V_42 -> V_66 * 1000000 ;
if ( ! F_8 ( V_63 ) ) {
V_64 = F_9 ( V_63 , V_65 ) ;
if ( ( V_65 - V_64 ) < ( V_65 / 10 ) ) {
F_10 ( V_63 , V_64 ) ;
F_11 ( V_63 ) ;
}
F_12 ( V_63 ) ;
...
V_32 -> V_89 . V_95 = 0 ;
#if 0
#define F_13 ( T_2 ) printk("%25s: %08X\n", #X, X)
D(lcd->screen);
D(lcd->horztiming);
D(lcd->verttiming);
D(lcd->clkcontrol);
...
static void F_17 ( struct V_18 * V_105 )
{
if ( F_18 ( V_42 ) ) {
...
F_19 ( L_4 , V_105 -> V_100 . V_101 ) ;
F_19 ( L_5 , V_105 -> V_106 . V_107 ) ;
}
static int F_20 ( struct V_115 * V_106 ,
struct V_18 * V_105 )
{
...
if ( V_23 -> V_118 < V_113 )
return - V_119 ;
V_117 = F_21 ( ( T_3 ) ( F_22 ( V_106 -> V_117 ) * 1000 ) , V_105 -> V_120 . V_121 ) ;
V_117 = F_23 ( V_117 , V_105 -> V_120 . V_122 , ( T_3 ) V_123 / 2 ) ;
if ( V_123 % V_117 ) {
int V_124 = V_123 % V_117 ;
V_117 -= V_124 ;
}
V_106 -> V_117 = F_24 ( V_117 / 1000 ) ;
#if 0
...
default:
F_19 ( L_6 , V_106 -> V_107 ) ;
return - V_119 ;
}
return 0 ;
}
static int F_25 ( struct V_18 * V_105 )
{
struct V_22 * V_23 = V_105 -> V_116 ;
F_17 ( V_105 ) ;
F_14 ( V_23 ) ;
...
static int F_26 ( unsigned V_131 , unsigned V_126 , unsigned V_128 ,
...
static int F_27 ( int V_139 , struct V_18 * V_105 )
{
struct V_22 * V_23 = V_105 -> V_116 ;
if ( V_140 )
return 0 ;
...
static int F_28 ( struct V_18 * V_146 , struct V_147 * V_148 )
{
struct V_22 * V_23 = V_146 -> V_116 ;
V_148 -> V_149 = F_29 ( V_148 -> V_149 ) ;
F_30 ( V_148 -> V_149 ) |= V_150 ;
return F_31 ( V_148 , V_23 -> V_47 , V_23 -> V_118 ) ;
}
static void F_32 ( T_4 V_151 , struct V_152 * V_153 )
{
...
static void F_33 ( T_4 V_151 , struct V_152 * V_153 )
{
unsigned int V_154 , V_155 ;
...
static void F_34 ( unsigned int V_24 ,
struct V_167 * V_153 )
{
...
static void F_35 ( unsigned int V_24 ,
struct V_167 * V_153 )
{
...
static int F_36 ( struct V_18 * V_146 , unsigned int V_151 ,
unsigned long V_206 )
{
struct V_22 * V_23 = V_146 -> V_116 ;
int V_24 ;
...
if ( V_151 == V_207 ) {
struct V_208 V_209 ;
if ( F_37 ( & V_209 , ( void V_210 * ) V_206 , sizeof( V_209 ) ) )
return - V_211 ;
F_19 ( L_8 ) ;
switch ( V_209 . V_212 ) {
case V_213 :
F_19 ( L_9 ) ;
F_32 ( V_151 , & V_209 . V_214 ) ;
break;
case V_215 :
F_19 ( L_10 ) ;
F_33 ( V_151 , & V_209 . V_214 ) ;
break;
case V_216 :
F_19 ( L_11 ) ;
F_34 ( V_24 , & V_209 . V_33 ) ;
break;
case V_217 :
F_19 ( L_12 ) ;
F_35 ( V_24 , & V_209 . V_33 ) ;
break;
case V_218 :
F_19 ( L_13 ) ;
...
V_168 = F_38 ( ( void V_210 * ) V_206 , & V_209 , sizeof( V_209 ) ) ;
if ( V_168 ) {
F_19 ( L_15 , V_168 ) ;
return - V_211 ;
}
...
static T_5 F_39 ( int V_224 , void * V_225 )
{
V_32 -> V_55 = V_32 -> V_55 ;
F_5 () ;
return V_226 ;
...
V_105 -> V_136 = F_43 ( 16 , sizeof( T_3 ) , V_232 ) ;
if ( ! V_105 -> V_136 ) {
return - V_233 ;
}
if ( F_44 ( & V_105 -> V_234 , V_134 , 0 ) < 0 ) {
F_42 ( L_17 ,
V_134 ) ;
F_45 ( V_105 -> V_136 ) ;
return - V_211 ;
}
strncpy ( V_105 -> V_100 . V_235 , L_18 , sizeof( V_105 -> V_100 . V_235 ) ) ;
...
char * V_248 = NULL ;
char * V_249 , * V_250 ;
int V_251 = F_47 ( V_222 ) ;
int V_252 = - 1 ;
F_48 ( V_253 , & V_248 ) ;
if ( ! V_248 )
goto V_254;
while ( ( V_249 = F_49 ( & V_248 , L_19 ) ) != NULL ) {
if ( ! strncmp ( V_249 , L_20 , 6 ) ) {
int V_19 ;
long int V_255 ;
char * V_250 ;
V_249 += 6 ;
V_255 = F_50 ( V_249 , & V_250 , 0 ) ;
if ( * V_250 == '\0' )
V_252 = ( int ) V_255 ;
else if ( strcmp ( V_249 , L_21 ) == 0 )
V_252 = V_52 -> V_221 () ;
else {
...
V_221 = V_252 ;
} else if ( strncmp ( V_249 , L_23 , 10 ) == 0 )
V_256 = 1 ;
else if ( strncmp ( V_249 , L_24 , 8 ) == 0 ) {
V_249 += 8 ;
V_20 = F_50 ( V_249 , & V_250 , 0 ) ;
if ( ( V_20 < 0 ) ||
( V_20 > V_257 ) )
V_20 = V_257 ;
} else if ( strncmp ( V_249 , L_25 , 7 ) == 0 ) {
V_249 += 7 ;
V_258 = F_50 ( V_249 , & V_250 , 0 ) ;
if ( ( V_258 < 0 ) ||
( V_258 >= F_47 ( V_259 ) ) )
V_258 = V_260 ;
} else if ( strncmp ( V_249 , L_26 , 3 ) == 0 )
return 1 ;
else
F_51 ( L_27 , V_249 ) ;
}
...
static int F_52 ( struct V_261 * V_262 )
{
struct V_22 * V_23 ;
struct V_51 * V_52 ;
...
V_42 = & V_222 [ V_221 ] ;
V_38 = & V_259 [ V_258 ] ;
F_3 ( V_253 L_29 , V_221 , V_42 -> V_59 ) ;
F_3 ( V_253 L_30 , V_258 , V_38 -> V_59 ) ;
V_264 = 0 ;
V_23 = NULL ;
...
V_263 < F_56 ( ( unsigned long ) V_23 -> V_47 +
V_23 -> V_118 ) ;
V_263 += V_269 ) {
F_57 ( F_58 ( V_263 >> V_270 ) ) ;
}
F_19 ( L_32 , V_23 -> V_247 ) ;
F_19 ( L_33 , V_23 -> V_47 , V_23 -> V_118 / 1024 ) ;
if ( ( V_264 = F_40 ( V_23 ) ) < 0 )
goto V_268;
V_264 = F_59 ( V_105 ) ;
if ( V_264 < 0 ) {
F_42 ( L_34 ) ;
...
F_25 ( V_105 ) ;
#if ! F_60 ( V_271 ) && F_60 ( V_272 )
if ( V_24 == 0 )
if ( F_61 ( V_105 , V_273 ) ) {
F_62 ( & V_105 -> V_234 , V_105 ) ;
F_63 ( V_105 , V_273 ) ;
}
#endif
}
V_224 = F_64 ( V_262 , 0 ) ;
V_264 = F_65 ( V_224 , F_39 ,
V_274 , L_35 , ( void * ) V_262 ) ;
if ( V_264 ) {
F_42 ( L_36 ,
V_224 , V_264 ) ;
goto V_268;
...
F_68 ( F_64 ( V_262 , 0 ) , ( void * ) V_262 ) ;
return 0 ;
}
static int F_73 ( struct V_277 * V_262 )
{
struct V_51 * V_52 = F_74 ( V_262 ) ;
F_6 ( NULL , V_52 ) ;
V_32 -> V_77 = 0 ;
F_5 () ;
return 0 ;
}
static int F_75 ( struct V_277 * V_262 )
{
struct V_51 * V_52 = F_74 ( V_262 ) ;
struct V_18 * V_105 ;
int V_19 ;
