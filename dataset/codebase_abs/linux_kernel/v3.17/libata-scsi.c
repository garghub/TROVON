...
F_37 ( args -> V_92 , & V_298 [ 32 ] , V_97 + 2 , 4 ) ;
if ( strncmp ( & V_298 [ 32 ] , L_38 , 4 ) == 0 )
F_37 ( args -> V_92 , & V_298 [ 32 ] , V_97 , 4 ) ;
if ( V_298 [ 32 ] == 0 || V_298 [ 32 ] == ' ' )
memcpy ( & V_298 [ 32 ] , L_39 , 4 ) ;
...
V_298 [ 2 ] = ( 0x238 >> 8 ) ;
V_298 [ 3 ] = ( 0x238 & 0xff ) ;
memcpy ( & V_298 [ 8 ] , L_40 , 8 ) ;
memcpy ( & V_298 [ 16 ] , L_41 , 16 ) ;
