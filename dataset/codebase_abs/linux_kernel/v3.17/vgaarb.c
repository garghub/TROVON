...
if ( ( V_11 -> V_69 >> 8 ) != V_70 )
return false ;
V_12 = F_32 ( sizeof( struct V_9 ) , V_71 ) ;
if ( V_12 == NULL ) {
F_33 ( L_8 ) ;
return false ;
}
...
static void F_44 ( struct V_10 * V_11 , unsigned int V_26 , bool V_85 )
{
struct V_9 * V_12 ;
unsigned long V_24 ;
V_26 &= V_31 ;
...
static int F_46 ( char * V_4 , int V_87 , unsigned int * V_88 ,
unsigned int * V_35 , unsigned int * V_89 )
{
int V_90 ;
unsigned int V_91 , V_92 ;
V_90 = sscanf ( V_4 , L_13 , V_88 , V_35 , & V_91 , & V_92 ) ;
if ( V_90 != 4 )
return 0 ;
* V_89 = F_47 ( V_91 , V_92 ) ;
return 1 ;
}
static T_4 F_48 ( struct V_93 * V_93 , char T_5 * V_4 ,
T_6 V_87 , T_7 * V_94 )
{
...
if ( V_98 > V_87 )
V_98 = V_87 ;
V_50 = F_49 ( V_4 , V_99 , V_98 ) ;
F_39 ( V_99 ) ;
if ( V_50 )
return - V_104 ;
return V_98 ;
}
static T_4 F_50 ( struct V_93 * V_93 , const char T_5 * V_4 ,
T_6 V_87 , T_7 * V_94 )
{
struct V_95 * V_96 = V_93 -> V_97 ;
...
int V_110 ;
int V_111 ;
V_107 = F_32 ( V_87 + 1 , V_71 ) ;
if ( ! V_107 )
return - V_100 ;
if ( F_51 ( V_107 , V_4 , V_87 ) ) {
F_39 ( V_107 ) ;
return - V_104 ;
}
V_108 = V_107 ;
V_107 [ V_87 ] = '\0' ;
if ( strncmp ( V_108 , L_16 , 5 ) == 0 ) {
V_108 += 5 ;
V_109 -= 5 ;
F_13 ( L_17 , V_96 ) ;
...
V_110 = V_87 ;
goto V_103;
} else if ( strncmp ( V_108 , L_18 , 7 ) == 0 ) {
V_108 += 7 ;
V_109 -= 7 ;
F_13 ( L_19 , V_96 ) ;
if ( strncmp ( V_108 , L_20 , 3 ) == 0 )
V_6 = V_2 | V_3 ;
else {
if ( ! F_2
( V_108 , V_109 , & V_6 ) ) {
...
V_110 = V_87 ;
goto V_103;
} else if ( strncmp ( V_108 , L_21 , 8 ) == 0 ) {
V_108 += 8 ;
V_109 -= 8 ;
F_13 ( L_22 , V_96 ) ;
if ( ! F_2 ( V_108 , V_109 , & V_6 ) ) {
...
} else if ( strncmp ( V_108 , L_23 , 7 ) == 0 ) {
unsigned int V_88 , V_35 , V_89 ;
struct V_9 * V_12 ;
V_108 += 7 ;
V_109 -= 7 ;
F_13 ( L_24 , V_96 ) ;
if ( ! strncmp ( V_108 , L_25 , 7 ) )
V_11 = F_8 ( F_5 () ) ;
else {
if ( ! F_46 ( V_108 , V_109 ,
& V_88 , & V_35 , & V_89 ) ) {
...
F_13 ( L_26 , V_108 ,
V_88 , V_35 , F_53 ( V_89 ) , F_54 ( V_89 ) ) ;
V_11 = F_55 ( V_88 , V_35 , V_89 ) ;
F_13 ( L_27 , V_11 ) ;
if ( ! V_11 ) {
F_33 ( L_28 ,
V_88 , V_35 , V_89 ) ;
...
F_7 ( V_11 ) ;
goto V_103;
} else if ( strncmp ( V_108 , L_32 , 8 ) == 0 ) {
V_108 += 8 ;
V_109 -= 8 ;
F_13 ( L_33 , V_96 ) ;
if ( ! F_2 ( V_108 , V_109 , & V_6 ) ) {
...
static unsigned int F_56 ( struct V_93 * V_93 , T_8 * V_49 )
{
struct V_95 * V_96 = V_93 -> V_97 ;
F_13 ( L_7 , V_28 ) ;
if ( V_96 == NULL )
...
static int F_58 ( struct V_119 * V_119 , struct V_93 * V_93 )
{
struct V_95 * V_96 ;
unsigned long V_24 ;
F_13 ( L_7 , V_28 ) ;
V_96 = F_59 ( sizeof( * V_96 ) , V_71 ) ;
if ( V_96 == NULL )
return - V_100 ;
F_60 ( & V_96 -> V_120 ) ;
V_93 -> V_97 = V_96 ;
...
static int F_61 ( struct V_119 * V_119 , struct V_93 * V_93 )
{
struct V_95 * V_96 = V_93 -> V_97 ;
struct V_105 * V_106 ;
unsigned long V_24 ;
...
static int F_62 ( struct V_124 * V_125 , unsigned long V_126 ,
void * V_127 )
{
struct V_128 * V_129 = V_127 ;
struct V_10 * V_11 = F_63 ( V_129 ) ;
bool V_130 = false ;
F_13 ( L_7 , V_28 ) ;
if ( V_126 == V_131 )
V_130 = F_31 ( V_11 ) ;
...
V_11 = NULL ;
while ( ( V_11 =
F_67 ( V_136 , V_136 , V_136 ,
V_136 , V_11 ) ) != NULL )
F_31 ( V_11 ) ;
F_36 ( L_36 ) ;
F_4 (vgadev, &vga_list, list) {
#if F_68 ( V_137 ) || F_68 ( V_138 )
T_11 V_139 , V_140 ;
int V_111 ;
for ( V_111 = 0 ; V_111 < V_141 ; V_111 ++ ) {
if ( ! ( F_69 ( V_12 -> V_11 , V_111 ) & V_142 ) )
continue;
V_139 = F_70 ( V_12 -> V_11 , V_111 ) ;
V_140 = F_71 ( V_12 -> V_11 , V_111 ) ;
if ( ! V_139 || ! V_140 )
continue;
if ( V_143 . V_144 < V_139 ||
( V_143 . V_144 + V_143 . V_145 ) >= V_140 )
continue;
if ( ! F_5 () )
F_36 ( L_9 ,
F_37 ( V_12 -> V_11 ) ) ;
