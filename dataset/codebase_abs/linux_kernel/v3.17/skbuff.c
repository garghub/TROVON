...
F_229 ( V_2 ) -> free = V_289 ;
goto V_166;
}
V_277 = F_23 ( V_281 ) ;
if ( V_277 -> V_80 )
goto V_225;
if ( F_228 ( V_281 ) != V_277 -> V_144 )
return - V_283 ;
V_148 = F_93 ( V_281 ) ;
V_271 = F_230 ( V_148 + F_227 ( V_281 ) , V_50 ) ;
if ( F_32 ( ! V_271 ) )
return - V_140 ;
F_83 ( V_271 , V_281 ) ;
V_271 -> V_133 = V_281 -> V_133 ;
F_43 ( V_271 , V_148 ) ;
F_222 ( V_271 , F_227 ( V_281 ) ) ;
F_231 ( V_271 , F_215 ( V_281 ) - V_281 -> V_8 ) ;
F_232 ( V_271 , F_233 ( V_281 ) ) ;
F_234 ( V_271 , F_235 ( V_281 ) ) ;
F_236 ( V_281 , F_227 ( V_281 ) ) ;
...
F_236 ( V_2 , V_67 ) ;
if ( F_229 ( V_281 ) -> V_284 == V_281 )
F_23 ( V_281 ) -> V_80 = V_2 ;
else
F_229 ( V_281 ) -> V_284 -> V_101 = V_2 ;
F_229 ( V_281 ) -> V_284 = V_2 ;
F_237 ( V_2 ) ;
V_280 = V_281 ;
V_166:
F_229 ( V_281 ) -> V_290 ++ ;
...
static int
F_240 ( struct V_1 * V_2 , struct V_294 * V_267 , int V_67 , int V_6 )
{
int V_174 = F_117 ( V_2 ) ;
int V_75 , V_176 = V_174 - V_67 ;
struct V_1 * V_175 ;
...
if ( V_176 > V_6 )
V_176 = V_6 ;
F_241 ( V_267 , V_2 -> V_8 + V_67 , V_176 ) ;
V_295 ++ ;
if ( ( V_6 -= V_176 ) == 0 )
return V_295 ;
V_67 += V_176 ;
...
if ( V_176 > V_6 )
V_176 = V_6 ;
F_242 ( & V_267 [ V_295 ] , F_100 ( V_56 ) , V_176 ,
...
if ( V_176 > V_6 )
V_176 = V_6 ;
V_295 += F_240 ( V_175 , V_267 + V_295 , V_67 - V_174 ,
V_176 ) ;
if ( ( V_6 -= V_176 ) == 0 )
return V_295 ;
V_67 += V_176 ;
...
int F_243 ( struct V_1 * V_2 , struct V_294 * V_267 ,
int V_67 , int V_6 )
{
return F_240 ( V_2 , V_267 , V_67 , V_6 ) ;
}
int F_244 ( struct V_1 * V_2 , struct V_294 * V_267 , int V_67 , int V_6 )
{
int V_296 = F_240 ( V_2 , V_267 , V_67 , V_6 ) ;
F_245 ( & V_267 [ V_296 - 1 ] ) ;
return V_296 ;
}
int F_246 ( struct V_1 * V_2 , int V_297 , struct V_1 * * V_298 )
{
int V_299 ;
int V_295 ;
struct V_1 * V_221 , * * V_300 ;
if ( ( F_124 ( V_2 ) || F_23 ( V_2 ) -> V_85 ) &&
F_143 ( V_2 , F_247 ( V_2 ) - F_117 ( V_2 ) ) == NULL )
return - V_140 ;
if ( ! F_59 ( V_2 ) ) {
if ( F_130 ( V_2 ) < V_297 &&
...
{
struct V_182 * V_132 = V_2 -> V_132 ;
F_250 ( V_2 -> V_27 , & V_132 -> V_301 ) ;
}
int F_251 ( struct V_182 * V_132 , struct V_1 * V_2 )
{
...
if ( ! F_254 ( V_132 , V_304 ) )
V_132 -> V_305 ( V_132 ) ;
return 0 ;
}
void F_255 ( struct V_1 * V_306 ,
struct V_307 * V_308 ,
struct V_182 * V_132 , int V_309 )
{
struct V_310 * V_311 ;
struct V_1 * V_2 ;
int V_160 ;
...
V_311 -> V_312 . V_317 = V_309 ;
if ( V_132 -> V_318 & V_319 ) {
V_311 -> V_312 . V_320 = F_23 ( V_2 ) -> V_321 ;
if ( V_132 -> V_322 == V_323 )
V_311 -> V_312 . V_320 -= V_132 -> V_324 ;
}
V_160 = F_251 ( V_132 , V_2 ) ;
if ( V_160 )
F_76 ( V_2 ) ;
}
void F_259 ( struct V_1 * V_306 ,
struct V_307 * V_308 )
{
return F_255 ( V_306 , V_308 , V_306 -> V_132 ,
V_325 ) ;
}
void F_260 ( struct V_1 * V_2 , bool V_326 )
{
struct V_182 * V_132 = V_2 -> V_132 ;
struct V_310 * V_311 ;
int V_160 ;
...
memset ( V_311 , 0 , sizeof( * V_311 ) ) ;
V_311 -> V_312 . V_313 = V_314 ;
V_311 -> V_312 . V_315 = V_329 ;
V_160 = F_251 ( V_132 , V_2 ) ;
if ( V_160 )
F_76 ( V_2 ) ;
}
bool F_261 ( struct V_1 * V_2 , T_12 V_174 , T_12 V_76 )
{
...
static int F_262 ( struct V_1 * V_2 , unsigned int V_6 ,
unsigned int V_330 )
{
if ( F_117 ( V_2 ) >= V_6 )
return 0 ;
if ( V_330 > V_2 -> V_6 )
V_330 = V_2 -> V_6 ;
if ( F_143 ( V_2 , V_330 - F_117 ( V_2 ) ) == NULL )
return - V_140 ;
if ( F_117 ( V_2 ) < V_6 )
return - V_331 ;
return 0 ;
}
static int F_263 ( struct V_1 * V_2 , bool V_332 )
{
unsigned int V_76 ;
bool V_333 ;
V_216 * V_117 ;
...
if ( V_160 < 0 )
goto V_23;
if ( F_264 ( V_2 ) -> V_336 & F_265 ( V_337 | V_338 ) )
V_333 = true ;
V_76 = F_266 ( V_2 ) ;
V_160 = - V_331 ;
if ( V_333 )
goto V_23;
V_117 = F_267 ( V_2 , F_264 ( V_2 ) -> V_124 , V_76 ) ;
if ( F_268 ( V_117 ) )
return F_269 ( V_117 ) ;
if ( V_332 )
* V_117 = ~ F_270 ( F_264 ( V_2 ) -> V_339 ,
F_264 ( V_2 ) -> V_340 ,
V_2 -> V_6 - V_76 ,
F_264 ( V_2 ) -> V_124 , 0 ) ;
V_160 = 0 ;
...
static int F_271 ( struct V_1 * V_2 , bool V_332 )
{
int V_160 ;
T_3 V_341 ;
unsigned int V_76 ;
...
V_333 = false ;
V_166 = false ;
V_76 = sizeof( struct V_342 ) ;
V_160 = F_262 ( V_2 , V_76 , V_343 ) ;
if ( V_160 < 0 )
goto V_23;
V_341 = F_272 ( V_2 ) -> V_341 ;
V_6 = sizeof( struct V_342 ) + F_273 ( F_272 ( V_2 ) -> V_344 ) ;
...
if ( V_160 < 0 )
goto V_23;
V_349 = F_274 ( struct V_348 , V_2 , V_76 ) ;
V_341 = V_349 -> V_341 ;
V_76 += F_275 ( V_349 ) ;
break;
}
...
if ( V_160 < 0 )
goto V_23;
V_349 = F_274 ( struct V_351 , V_2 , V_76 ) ;
V_341 = V_349 -> V_341 ;
V_76 += F_276 ( V_349 ) ;
break;
}
...
if ( V_160 < 0 )
goto V_23;
V_349 = F_274 ( struct V_353 , V_2 , V_76 ) ;
if ( V_349 -> V_336 & F_265 ( V_354 | V_355 ) )
V_333 = true ;
V_341 = V_349 -> V_341 ;
V_76 += sizeof( struct V_353 ) ;
break;
}
default:
V_166 = true ;
...
if ( ! V_166 || V_333 )
goto V_23;
V_117 = F_267 ( V_2 , V_341 , V_76 ) ;
if ( F_268 ( V_117 ) )
return F_269 ( V_117 ) ;
if ( V_332 )
* V_117 = ~ F_277 ( & F_272 ( V_2 ) -> V_339 ,
& F_272 ( V_2 ) -> V_340 ,
V_2 -> V_6 - V_76 , V_341 , 0 ) ;
V_160 = 0 ;
V_23:
return V_160 ;
}
int F_278 ( struct V_1 * V_2 , bool V_332 )
{
int V_160 ;
switch ( V_2 -> V_124 ) {
case F_265 ( V_356 ) :
V_160 = F_263 ( V_2 , V_332 ) ;
break;
case F_265 ( V_357 ) :
V_160 = F_271 ( V_2 , V_332 ) ;
break;
default:
V_160 = - V_331 ;
break;
...
void F_279 ( const struct V_1 * V_2 )
{
F_225 ( L_7 ,
V_2 -> V_11 -> V_12 ) ;
}
void F_280 ( struct V_1 * V_2 , bool V_358 )
{
if ( V_358 ) {
F_62 ( V_2 ) ;
F_26 ( V_25 , V_2 ) ;
...
bool F_281 ( struct V_1 * V_173 , struct V_1 * V_202 ,
bool * V_359 , int * V_282 )
{
...
void F_283 ( struct V_1 * V_2 , bool V_360 )
{
if ( V_360 )
F_252 ( V_2 ) ;
V_2 -> V_104 . V_361 = 0 ;
...
if ( F_34 ( V_33 -> V_146 & ( V_363 | V_364 ) ) )
return F_288 ( V_2 ) + V_33 -> V_144 ;
return V_33 -> V_144 ;
}
static struct V_1 * F_289 ( struct V_1 * V_2 )
{
if ( F_290 ( V_2 , F_93 ( V_2 ) ) < 0 ) {
F_76 ( V_2 ) ;
return NULL ;
}
memmove ( V_2 -> V_8 - V_365 , V_2 -> V_8 - V_366 , 2 * V_367 ) ;
V_2 -> V_29 += V_368 ;
return V_2 ;
}
struct V_1 * F_291 ( struct V_1 * V_2 )
{
struct V_369 * V_370 ;
T_12 V_128 ;
if ( F_32 ( F_292 ( V_2 ) ) ) {
...
if ( F_32 ( ! V_2 ) )
goto V_371;
if ( F_32 ( ! F_294 ( V_2 , V_368 ) ) )
goto V_371;
V_370 = (struct V_369 * ) V_2 -> V_8 ;
V_128 = F_273 ( V_370 -> V_372 ) ;
F_295 ( V_2 , V_2 -> V_124 , V_128 ) ;
F_212 ( V_2 , V_368 ) ;
F_296 ( V_2 , V_370 ) ;
V_2 = F_289 ( V_2 ) ;
if ( F_32 ( ! V_2 ) )
