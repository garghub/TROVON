...
error = F_19 ( * V_2 , V_4 , V_51 , - 2 , & V_54 ,
V_65 ) ;
if ( error )
return error ;
if ( V_54 ) {
...
T_2 V_5 ;
int error ;
error = F_19 ( * V_2 , V_4 , 0 , - 1 , & V_10 , V_65 ) ;
if ( error )
return error ;
V_5 = V_10 -> V_62 ;
V_49 = V_10 -> V_40 ;
...
if ( error )
return error ;
error = F_22 ( * V_2 , V_4 , 0 , V_5 , & V_10 , V_65 ) ;
if ( error )
return error ;
F_6 ( * V_2 , V_10 ) ;
error = F_7 ( V_2 , V_4 ) ;
...
F_28 ( V_4 , V_73 ) ;
V_2 = F_29 ( V_72 , V_77 ) ;
error = F_30 ( V_2 , & F_31 ( V_72 ) -> V_78 , 0 , 0 ) ;
if ( error ) {
F_32 ( V_2 , 0 ) ;
return error ;
}
