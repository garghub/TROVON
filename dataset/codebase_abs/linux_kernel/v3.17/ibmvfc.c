...
if ( F_133 ( V_132 , V_247 ) ) {
V_6 -> V_283 = F_90 ( V_247 [ 1 ] ) ;
switch ( V_247 [ 0 ] ) {
case V_284 :
V_6 -> V_7 . V_285 = V_286 ;
break;
...
if ( F_134 ( ! ( V_47 = F_108 ( V_132 , V_2 , V_6 , V_4 -> V_98 ) ) ) )
...
{
struct V_3 * V_4 = F_63 ( V_293 -> V_146 ) ;
...
V_4 -> V_291 = 1 ;
V_2 = F_100 ( V_4 ) ;
F_103 ( V_2 , F_135 , V_31 ) ;
V_296 = & V_2 -> V_7 . V_296 ;
memset ( V_296 , 0 , sizeof( * V_296 ) ) ;
V_296 -> V_297 . V_298 = F_89 ( 1 ) ;
V_296 -> V_297 . V_32 = F_89 ( V_299 ) ;
V_296 -> V_297 . V_300 = F_52 ( sizeof( * V_296 ) ) ;
V_296 -> V_24 = F_90 ( V_281 ) ;
V_296 -> V_279 = F_89 ( V_301 ) ;
V_296 -> V_302 = F_89 ( V_303 ) ;
V_47 = F_115 ( V_2 , V_4 , V_304 ) ;
if ( V_47 != 0 ) {
V_4 -> V_291 = 0 ;
...
static int F_138 ( struct V_3 * V_4 , unsigned int V_281 )
{
struct V_305 * V_306 ;
struct V_64 * V_65 ;
struct V_1 * V_2 ;
...
goto V_310;
V_2 = F_100 ( V_4 ) ;
F_103 ( V_2 , V_311 , V_31 ) ;
V_306 = & V_2 -> V_7 . V_306 ;
memset ( V_306 , 0 , sizeof( * V_306 ) ) ;
V_306 -> V_297 . V_298 = F_89 ( 1 ) ;
V_306 -> V_297 . V_32 = F_89 ( V_312 ) ;
V_306 -> V_297 . V_300 = F_52 ( sizeof( * V_306 ) ) ;
V_306 -> V_24 = F_90 ( V_281 ) ;
V_2 -> V_223 = & V_308 ;
F_139 ( & V_2 -> V_313 ) ;
V_47 = F_115 ( V_2 , V_4 , V_304 ) ;
F_42 ( V_4 -> V_89 -> V_122 , V_39 ) ;
...
V_318 = F_143 ( V_4 -> V_98 , V_293 -> V_335 . V_336 ,
V_293 -> V_335 . V_337 , V_238 ) ;
if ( ! V_318 ) {
F_144 ( & V_4 -> V_333 ) ;
return - V_214 ;
}
V_319 = F_143 ( V_4 -> V_98 , V_293 -> V_338 . V_336 ,
V_293 -> V_338 . V_337 , V_339 ) ;
if ( ! V_319 ) {
F_145 ( V_4 -> V_98 , V_293 -> V_335 . V_336 ,
V_293 -> V_335 . V_337 , V_238 ) ;
F_144 ( & V_4 -> V_333 ) ;
return - V_214 ;
}
...
V_10 -> V_297 . V_298 = F_89 ( 1 ) ;
V_10 -> V_297 . V_32 = F_89 ( V_342 ) ;
V_10 -> V_297 . V_300 = F_52 ( sizeof( * V_10 ) - sizeof( V_10 -> V_343 ) - sizeof( V_10 -> V_7 ) ) ;
V_10 -> V_344 . V_207 = F_90 ( F_2 ( V_2 -> V_18 . V_218 ) +
F_131 ( struct V_314 , V_7 ) ) ;
V_10 -> V_344 . V_208 = F_89 ( sizeof( V_10 -> V_7 ) ) ;
V_10 -> V_7 . V_282 = F_89 ( V_293 -> V_335 . V_277 ) ;
V_10 -> V_7 . V_256 = F_89 ( V_293 -> V_338 . V_277 ) ;
V_10 -> V_7 . V_39 = F_89 ( V_320 ) ;
V_10 -> V_7 . V_279 = F_89 ( V_301 ) ;
V_10 -> V_7 . V_8 . V_207 = F_90 ( F_106 ( V_293 -> V_335 . V_336 ) ) ;
V_10 -> V_7 . V_8 . V_208 = F_89 ( F_107 ( V_293 -> V_335 . V_336 ) ) ;
V_10 -> V_7 . V_38 . V_207 = F_90 ( F_106 ( V_293 -> V_338 . V_336 ) ) ;
V_10 -> V_7 . V_38 . V_208 = F_89 ( F_107 ( V_293 -> V_338 . V_336 ) ) ;
...
F_145 ( V_4 -> V_98 , V_293 -> V_335 . V_336 ,
V_293 -> V_335 . V_337 , V_238 ) ;
F_145 ( V_4 -> V_98 , V_293 -> V_338 . V_336 ,
V_293 -> V_338 . V_337 , V_339 ) ;
F_144 ( & V_4 -> V_333 ) ;
V_95 ;
return V_47 ;
}
static int F_146 ( struct V_254 * V_255 , int type , char * V_346 )
{
struct V_3 * V_4 = F_63 ( V_255 -> V_89 ) ;
struct V_169 * V_170 = F_124 ( V_143 ( V_255 ) ) ;
struct V_5 * V_296 ;
...
if ( V_4 -> V_72 == V_151 ) {
V_2 = F_100 ( V_4 ) ;
F_103 ( V_2 , V_311 , V_21 ) ;
V_296 = & V_2 -> V_7 . V_8 ;
memset ( V_296 , 0 , sizeof( * V_296 ) ) ;
V_296 -> V_153 . V_207 = F_90 ( F_2 ( V_2 -> V_18 . V_218 ) + F_131 ( struct V_5 , V_38 ) ) ;
V_296 -> V_153 . V_208 = F_89 ( sizeof( V_296 -> V_38 ) ) ;
V_296 -> V_275 = F_89 ( V_276 ) ;
V_296 -> V_277 = F_89 ( sizeof( V_296 -> V_7 ) ) ;
V_296 -> V_278 = F_89 ( sizeof( V_296 -> V_38 ) ) ;
V_296 -> V_279 = F_89 ( ( unsigned long ) V_255 -> V_280 ) ;
V_296 -> V_25 = F_90 ( V_170 -> V_281 ) ;
F_132 ( V_255 -> V_26 , & V_296 -> V_7 . V_26 ) ;
V_296 -> V_39 = F_52 ( ( V_233 | V_349 ) ) ;
V_296 -> V_7 . V_27 = type ;
V_2 -> V_223 = & V_308 ;
F_139 ( & V_2 -> V_313 ) ;
V_348 = F_115 ( V_2 , V_4 , V_304 ) ;
}
F_42 ( V_4 -> V_89 -> V_122 , V_39 ) ;
if ( V_348 != 0 ) {
F_147 ( V_236 , V_255 , L_27 ,
V_346 , V_348 ) ;
return - V_179 ;
}
F_147 ( V_350 , V_255 , L_28 , V_346 ) ;
F_140 ( & V_2 -> V_313 ) ;
if ( V_308 . V_8 . V_36 )
V_40 = F_10 ( & V_308 . V_8 ) ;
if ( V_40 ) {
...
F_147 ( V_236 , V_255 , L_29
L_30 , V_346 ,
F_9 ( F_6 ( V_308 . V_8 . V_36 ) , F_6 ( V_308 . V_8 . error ) ) ,
V_308 . V_8 . V_36 , V_308 . V_8 . error , V_347 -> V_39 , V_40 ,
V_347 -> V_43 ) ;
V_348 = - V_179 ;
} else
F_147 ( V_350 , V_255 , L_31 , V_346 ) ;
F_40 ( V_4 -> V_89 -> V_122 , V_39 ) ;
F_44 ( V_2 ) ;
F_42 ( V_4 -> V_89 -> V_122 , V_39 ) ;
return V_348 ;
}
static int F_148 ( struct V_1 * V_2 , void * V_170 )
{
struct V_169 * V_351 ;
if ( V_2 -> V_132 ) {
V_351 = F_124 ( V_143 ( V_2 -> V_132 -> V_231 ) ) ;
if ( V_351 == V_170 )
return 1 ;
}
return 0 ;
...
static int F_150 ( struct V_1 * V_2 , void * V_231 )
{
if ( V_2 -> V_132 && V_2 -> V_132 -> V_231 == V_231 )
return 1 ;
return 0 ;
}
static int F_151 ( struct V_3 * V_4 , void * V_231 ,
int (* F_152) ( struct V_1 * , void * ) )
{
struct V_1 * V_2 ;
F_153 ( V_313 ) ;
int V_352 ;
...
static int F_155 ( struct V_254 * V_255 , int type )
{
struct V_3 * V_4 = F_63 ( V_255 -> V_89 ) ;
...
V_296 -> V_297 . V_32 = F_89 ( V_299 ) ;
V_296 -> V_297 . V_300 = F_52 ( sizeof( * V_296 ) ) ;
V_296 -> V_24 = F_90 ( V_170 -> V_281 ) ;
F_132 ( V_255 -> V_26 , & V_296 -> V_26 ) ;
if ( ! ( F_2 ( V_4 -> V_152 -> V_153 . V_204 ) & V_357 ) )
type &= ~ V_358 ;
if ( V_4 -> V_72 == V_151 )
V_296 -> V_39 = F_89 ( ( type | V_359 ) ) ;
else
V_296 -> V_39 = F_89 ( ( ( type & V_358 ) | V_359 ) ) ;
V_296 -> V_279 = F_89 ( ( unsigned long ) V_255 -> V_280 ) ;
V_296 -> V_302 = F_89 ( ( unsigned long ) V_144 -> V_280 ) ;
V_2 -> V_223 = & V_38 ;
F_139 ( & V_2 -> V_313 ) ;
V_348 = F_115 ( V_2 , V_4 , V_304 ) ;
}
F_42 ( V_4 -> V_89 -> V_122 , V_39 ) ;
if ( V_348 != 0 ) {
F_147 ( V_236 , V_255 , L_25 , V_348 ) ;
return 0 ;
}
F_147 ( V_350 , V_255 , L_34 ) ;
F_140 ( & V_2 -> V_313 ) ;
...
F_147 ( V_350 , V_255 , L_36 ) ;
return 0 ;
}
static int F_156 ( struct V_1 * V_2 , void * V_230 )
{
...
static int F_157 ( struct V_1 * V_2 , void * F_152 )
{
if ( V_2 == F_152 )
return 1 ;
return 0 ;
}
static int F_158 ( struct V_254 * V_255 )
{
struct V_3 * V_4 = F_63 ( V_255 -> V_89 ) ;
struct V_169 * V_170 = F_124 ( V_143 ( V_255 ) ) ;
struct V_5 * V_296 ;
...
F_42 ( V_4 -> V_89 -> V_122 , V_39 ) ;
if ( V_348 != 0 ) {
F_147 ( V_236 , V_255 , L_38 , V_348 ) ;
return - V_179 ;
}
F_147 ( V_350 , V_255 , L_39 ) ;
V_171 = F_154 ( & V_2 -> V_313 , V_171 ) ;
if ( ! V_171 ) {
V_47 = F_155 ( V_255 , 0 ) ;
if ( ! V_47 ) {
V_47 = F_151 ( V_4 , V_255 -> V_280 , F_156 ) ;
if ( V_47 == V_355 )
V_47 = 0 ;
}
if ( V_47 ) {
F_147 ( V_350 , V_255 , L_40 ) ;
F_59 ( V_4 ) ;
V_348 = - V_179 ;
V_47 = F_151 ( V_4 , V_255 -> V_280 , F_156 ) ;
if ( V_47 == V_355 )
V_348 = 0 ;
V_47 = F_151 ( V_4 , V_2 , F_157 ) ;
if ( V_47 != V_355 ) {
F_40 ( V_4 -> V_89 -> V_122 , V_39 ) ;
F_57 ( V_4 ) ;
F_42 ( V_4 -> V_89 -> V_122 , V_39 ) ;
...
F_81 ( V_4 ) ;
if ( V_365 != V_366 ) {
V_364 = F_155 ( V_255 , V_367 ) ;
F_158 ( V_255 ) ;
} else
V_364 = F_155 ( V_255 , V_358 ) ;
if ( ! V_364 )
V_47 = F_151 ( V_4 , V_255 , F_150 ) ;
...
F_81 ( V_4 ) ;
if ( V_365 != V_366 ) {
V_364 = F_155 ( V_255 , V_369 ) ;
V_368 = F_146 ( V_255 , V_370 , L_43 ) ;
} else
V_364 = F_155 ( V_255 , V_358 ) ;
if ( ! V_364 && ! V_368 )
V_47 = F_151 ( V_4 , V_255 , F_150 ) ;
...
* V_47 |= F_155 ( V_255 , V_358 ) ;
}
static void F_163 ( struct V_254 * V_255 , void * V_41 )
{
unsigned long * V_47 = V_41 ;
* V_47 |= F_155 ( V_255 , V_371 ) ;
}
static int F_164 ( struct V_131 * V_8 )
{
struct V_254 * V_255 = V_8 -> V_231 ;
struct V_3 * V_4 = F_63 ( V_255 -> V_89 ) ;
struct V_143 * V_144 = V_143 ( V_255 ) ;
...
F_81 ( V_4 ) ;
if ( V_365 != V_366 ) {
F_165 ( V_144 , & V_364 , F_163 ) ;
V_368 = F_146 ( V_255 , V_372 , L_44 ) ;
} else
F_165 ( V_144 , & V_364 , F_162 ) ;
if ( ! V_364 && ! V_368 )
V_47 = F_151 ( V_4 , V_144 , F_149 ) ;
if ( V_365 == V_366 && V_47 != V_354 )
V_47 = V_366 ;
V_95 ;
return V_47 ;
...
static void F_167 ( struct V_169 * V_170 )
{
struct V_145 * V_146 = F_168 ( V_170 ) ;
struct V_3 * V_4 = F_63 ( V_146 ) ;
struct V_169 * V_373 ;
struct V_254 * V_255 ;
unsigned long V_47 ;
V_92 ;
F_169 (sdev, shost) {
V_373 = F_124 ( V_143 ( V_255 ) ) ;
if ( V_373 != V_170 )
continue;
F_155 ( V_255 , V_358 ) ;
}
V_47 = F_151 ( V_4 , V_170 , F_148 ) ;
if ( V_47 == V_354 )
F_83 ( V_146 ) ;
V_95 ;
}
static const struct V_374 * F_170 ( T_2 V_375 )
{
int V_44 ;
for ( V_44 = 0 ; V_44 < F_8 ( V_376 ) ; V_44 ++ )
if ( V_376 [ V_44 ] . V_375 == V_375 )
return & V_376 [ V_44 ] ;
return & V_377 ;
}
static const char * F_171 ( enum V_378 V_72 )
{
int V_44 ;
for ( V_44 = 0 ; V_44 < F_8 ( V_379 ) ; V_44 ++ )
if ( V_379 [ V_44 ] . V_72 == V_72 )
return V_379 [ V_44 ] . V_346 ;
return L_46 ;
}
static void F_172 ( struct V_380 * V_18 ,
struct V_3 * V_4 )
{
const struct V_374 * V_346 = F_170 ( F_2 ( V_18 -> V_381 ) ) ;
struct V_64 * V_65 ;
F_68 ( V_4 , V_346 -> V_234 , L_47
L_48 , V_346 -> V_346 , V_18 -> V_24 , V_18 -> V_382 , V_18 -> V_174 ,
F_171 ( V_18 -> V_383 ) ) ;
switch ( F_2 ( V_18 -> V_381 ) ) {
case V_384 :
switch ( V_18 -> V_383 ) {
case V_385 :
F_21 ( V_4 , V_140 ) ;
...
continue;
if ( V_18 -> V_382 && F_90 ( V_65 -> V_173 . V_175 ) != V_18 -> V_382 )
continue;
if ( V_18 -> V_174 && F_90 ( V_65 -> V_173 . V_174 ) != V_18 -> V_174 )
continue;
if ( V_65 -> V_399 && F_2 ( V_18 -> V_381 ) == V_396 )
V_65 -> V_400 = 1 ;
if ( ! V_65 -> V_399 || F_2 ( V_18 -> V_381 ) == V_398 ) {
F_15 ( V_65 , V_68 ) ;
F_18 ( V_4 ) ;
}
}
...
break;
default:
F_24 ( V_4 -> V_98 , L_49 , V_18 -> V_381 ) ;
break;
} ;
}
static void F_173 ( struct V_405 * V_18 , struct V_3 * V_4 )
{
long V_47 ;
...
static int F_174 ( struct V_145 * V_146 , unsigned long time )
{
unsigned long V_39 ;
struct V_3 * V_4 = F_63 ( V_146 ) ;
int V_136 = 0 ;
...
static int F_175 ( struct V_254 * V_255 )
{
...
static int F_176 ( struct V_143 * V_144 )
{
struct V_145 * V_146 = F_62 ( V_144 -> V_98 . V_147 ) ;
struct V_3 * V_4 = F_63 ( V_146 ) ;
unsigned long V_39 = 0 ;
...
if ( V_255 -> V_418 ) {
F_178 ( V_255 , V_284 ) ;
F_179 ( V_255 , V_255 -> V_419 ) ;
} else
F_180 ( V_255 , V_255 -> V_419 ) ;
F_42 ( V_146 -> V_122 , V_39 ) ;
return 0 ;
}
static int F_181 ( struct V_254 * V_255 , int V_420 ,
int V_421 )
{
if ( V_421 != V_422 )
return - V_423 ;
...
static int F_183 ( struct V_254 * V_255 , int V_425 )
{
if ( V_255 -> V_418 ) {
F_178 ( V_255 , V_425 ) ;
if ( V_425 )
...
static T_6 F_191 ( struct V_231 * V_98 ,
struct V_426 * V_427 , char * V_428 )
{
struct V_145 * V_146 = F_185 ( V_98 ) ;
struct V_3 * V_4 = F_63 ( V_146 ) ;
...
static T_6 F_192 ( struct V_231 * V_98 ,
struct V_426 * V_427 ,
const char * V_428 , T_7 V_430 )
{
struct V_145 * V_146 = F_185 ( V_98 ) ;
struct V_3 * V_4 = F_63 ( V_146 ) ;
unsigned long V_39 = 0 ;
F_40 ( V_146 -> V_122 , V_39 ) ;
V_4 -> V_234 = F_193 ( V_428 , NULL , 10 ) ;
F_42 ( V_146 -> V_122 , V_39 ) ;
return strlen ( V_428 ) ;
}
static T_6 F_194 ( struct V_431 * V_432 , struct V_433 * V_434 ,
struct V_435 * V_436 ,
char * V_428 , T_8 V_437 , T_7 V_430 )
{
struct V_231 * V_98 = F_73 ( V_434 , struct V_231 , V_434 ) ;
struct V_145 * V_146 = F_185 ( V_98 ) ;
struct V_3 * V_4 = F_63 ( V_146 ) ;
unsigned long V_39 = 0 ;
int V_129 = V_438 ;
...
static struct V_380 * F_195 ( struct V_3 * V_4 )
{
...
static struct V_405 * F_197 ( struct V_3 * V_4 )
{
...
static T_9 F_198 ( int V_112 , void * V_441 )
{
...
F_40 ( V_4 -> V_89 -> V_122 , V_39 ) ;
while ( ! V_136 ) {
while ( ( V_206 = F_195 ( V_4 ) ) != NULL ) {
F_172 ( V_206 , V_4 ) ;
V_206 -> V_217 = 0 ;
F_202 () ;
}
while ( ( V_18 = F_197 ( V_4 ) ) != NULL ) {
F_173 ( V_18 , V_4 ) ;
V_18 -> V_217 = 0 ;
F_202 () ;
}
F_203 ( V_108 ) ;
if ( ( V_206 = F_195 ( V_4 ) ) != NULL ) {
F_199 ( V_108 ) ;
F_172 ( V_206 , V_4 ) ;
V_206 -> V_217 = 0 ;
F_202 () ;
} else if ( ( V_18 = F_197 ( V_4 ) ) != NULL ) {
F_199 ( V_108 ) ;
F_173 ( V_18 , V_4 ) ;
V_18 -> V_217 = 0 ;
F_202 () ;
...
static int F_205 ( struct V_64 * V_65 ,
void (* V_103) ( struct V_64 * ) )
{
if ( ++ V_65 -> V_96 > V_444 ) {
F_15 ( V_65 , V_68 ) ;
...
static int F_206 ( T_1 V_39 )
{
int V_44 ;
int V_315 = ( V_39 & 0x0f00 ) >> 8 ;
for ( V_44 = 0 ; V_44 < F_8 ( V_445 ) ; V_44 ++ )
...
if ( V_449 -> type == V_276 ) {
V_127 = F_206 ( F_6 ( V_449 -> V_39 ) ) ;
if ( V_445 [ V_127 ] . V_117 ) {
if ( F_6 ( V_449 -> V_39 ) & V_454 ) {
V_65 -> V_399 = 0 ;
V_65 -> V_173 . V_455 = 0 ;
if ( F_4 ( V_449 -> V_453 ) & V_456 )
V_65 -> V_173 . V_455 |= V_457 ;
if ( F_4 ( V_449 -> V_453 ) & V_458 )
...
V_450 += F_205 ( V_65 , V_462 ) ;
else if ( V_65 -> V_400 )
V_450 += F_205 ( V_65 , V_462 ) ;
else if ( F_11 ( F_6 ( V_38 -> V_36 ) , F_6 ( V_38 -> error ) ) )
V_450 += F_205 ( V_65 , V_460 ) ;
else
F_15 ( V_65 , V_68 ) ;
F_209 ( V_65 , V_450 , L_65 ,
...
V_447 -> V_297 . V_298 = F_89 ( 1 ) ;
V_447 -> V_297 . V_32 = F_89 ( V_464 ) ;
V_447 -> V_297 . V_300 = F_52 ( sizeof( * V_447 ) ) ;
V_447 -> V_24 = F_90 ( V_65 -> V_24 ) ;
V_447 -> V_449 . type = V_276 ;
V_447 -> V_449 . V_39 = F_52 ( V_454 ) ;
V_447 -> V_449 . V_453 = F_89 ( V_458 ) ;
F_15 ( V_65 , V_465 ) ;
if ( F_115 ( V_2 , V_4 , V_304 ) ) {
V_4 -> V_451 -- ;
F_15 ( V_65 , V_452 ) ;
F_77 ( & V_65 -> V_150 , F_72 ) ;
} else
...
F_208 ( V_65 , L_67 ) ;
if ( V_65 -> V_173 . V_175 &&
V_65 -> V_173 . V_175 != F_211 ( V_38 -> V_453 . V_175 ) ) {
V_4 -> V_90 = 1 ;
F_208 ( V_65 , L_68 ) ;
break;
}
V_65 -> V_173 . V_174 = F_211 ( V_38 -> V_453 . V_174 ) ;
V_65 -> V_173 . V_175 = F_211 ( V_38 -> V_453 . V_175 ) ;
...
V_2 = F_100 ( V_4 ) ;
V_4 -> V_451 ++ ;
F_103 ( V_2 , F_212 , V_31 ) ;
V_2 -> V_65 = V_65 ;
V_10 = & V_2 -> V_7 . V_468 ;
memset ( V_10 , 0 , sizeof( * V_10 ) ) ;
V_10 -> V_297 . V_298 = F_89 ( 1 ) ;
V_10 -> V_297 . V_32 = F_89 ( V_470 ) ;
V_10 -> V_297 . V_300 = F_52 ( sizeof( * V_10 ) ) ;
V_10 -> V_471 = F_90 ( V_65 -> V_24 ) ;
F_15 ( V_65 , V_465 ) ;
if ( F_115 ( V_2 , V_4 , V_304 ) ) {
V_4 -> V_451 -- ;
F_15 ( V_65 , V_452 ) ;
...
static int F_215 ( struct V_314 * V_10 ,
struct V_64 * V_65 )
{
...
return 1 ;
if ( F_4 ( V_10 -> V_343 . V_472 [ 6 ] ) != V_65 -> V_24 )
return 1 ;
return 0 ;
}
...
default:
F_15 ( V_65 , V_68 ) ;
V_473 = ( F_4 ( V_10 -> V_343 . V_472 [ 1 ] ) & 0x00ff0000 ) >> 16 ;
V_59 = ( F_4 ( V_10 -> V_343 . V_472 [ 1 ] ) & 0x0000ff00 ) >> 8 ;
F_217 ( V_65 , L_75 ,
...
V_10 -> V_297 . V_32 = F_89 ( V_342 ) ;
V_10 -> V_297 . V_300 = F_52 ( sizeof( * V_10 ) - sizeof( V_10 -> V_343 ) - sizeof( V_10 -> V_7 ) ) ;
V_10 -> V_344 . V_207 = F_90 ( ( T_2 ) F_2 ( V_2 -> V_18 . V_218 ) +
F_131 ( struct V_314 , V_7 ) ) ;
V_10 -> V_344 . V_208 = F_89 ( sizeof( V_10 -> V_7 ) ) ;
V_10 -> V_7 . V_282 = F_89 ( sizeof( V_10 -> V_343 . V_474 ) ) ;
V_10 -> V_7 . V_256 = F_89 ( sizeof( V_10 -> V_343 . V_472 ) ) ;
V_10 -> V_7 . V_8 . V_207 = F_90 ( ( T_2 ) F_2 ( V_2 -> V_18 . V_218 ) +
F_131 ( struct V_314 , V_343 ) +
F_131 ( struct V_475 , V_474 ) ) ;
V_10 -> V_7 . V_8 . V_208 = F_89 ( sizeof( V_10 -> V_343 . V_474 ) ) ;
V_10 -> V_7 . V_38 . V_207 = F_90 ( ( T_2 ) F_2 ( V_2 -> V_18 . V_218 ) +
F_131 ( struct V_314 , V_343 ) +
F_131 ( struct V_475 , V_472 ) ) ;
V_10 -> V_7 . V_38 . V_208 = F_89 ( sizeof( V_10 -> V_343 . V_472 ) ) ;
}
...
V_296 -> V_297 . V_32 = F_89 ( V_299 ) ;
V_296 -> V_297 . V_300 = F_52 ( sizeof( * V_296 ) ) ;
V_296 -> V_24 = F_90 ( V_65 -> V_24 ) ;
V_296 -> V_279 = F_89 ( V_65 -> V_279 ) ;
V_47 = F_115 ( V_2 , V_4 , V_304 ) ;
if ( V_47 ) {
F_213 ( V_65 , L_78 , V_47 ) ;
V_4 -> V_476 -- ;
F_77 ( & V_65 -> V_150 , F_72 ) ;
F_58 ( V_4 ) ;
} else
...
V_2 = F_100 ( V_4 ) ;
V_4 -> V_451 ++ ;
F_103 ( V_2 , F_216 , V_31 ) ;
V_2 -> V_65 = V_65 ;
F_218 ( V_2 ) ;
V_10 = & V_2 -> V_7 . V_341 ;
V_10 -> V_7 . V_39 = F_89 ( V_327 ) ;
V_10 -> V_7 . V_24 = F_90 ( V_65 -> V_24 ) ;
V_10 -> V_7 . V_279 = F_89 ( V_65 -> V_279 ) ;
V_10 -> V_343 . V_474 [ 0 ] = F_89 ( V_477 ) ;
...
V_10 -> V_343 . V_474 [ 6 ] = F_89 ( F_2 ( V_4 -> V_152 -> V_153 . V_24 ) & 0x00ffffff ) ;
if ( F_222 ( & V_65 -> V_138 ) )
F_223 ( & V_65 -> V_138 , V_16 + ( V_478 * V_178 ) ) ;
else {
V_65 -> V_138 . V_41 = ( unsigned long ) V_65 ;
V_65 -> V_138 . V_249 = V_16 + ( V_478 * V_178 ) ;
V_65 -> V_138 . V_250 = ( void (*) ( unsigned long ) ) F_220 ;
F_118 ( & V_65 -> V_138 ) ;
}
F_15 ( V_65 , V_465 ) ;
if ( F_115 ( V_2 , V_4 , V_479 ) ) {
V_4 -> V_451 -- ;
F_54 ( & V_65 -> V_138 ) ;
F_15 ( V_65 , V_452 ) ;
F_77 ( & V_65 -> V_150 , F_72 ) ;
...
case V_461 :
default:
if ( ( F_6 ( V_38 -> V_36 ) & V_483 ) == V_483 &&
F_6 ( V_38 -> error ) == V_484 &&
F_6 ( V_38 -> V_59 ) == V_485 )
F_15 ( V_65 , V_68 ) ;
else if ( F_11 ( F_6 ( V_38 -> V_36 ) , F_6 ( V_38 -> error ) ) )
V_450 += F_205 ( V_65 , V_482 ) ;
else
F_15 ( V_65 , V_68 ) ;
F_209 ( V_65 , V_450 , L_82 ,
F_9 ( F_6 ( V_38 -> V_36 ) , F_6 ( V_38 -> error ) ) ,
...
V_481 -> V_297 . V_298 = F_89 ( 1 ) ;
V_481 -> V_297 . V_32 = F_89 ( V_486 ) ;
V_481 -> V_297 . V_300 = F_52 ( sizeof( * V_481 ) ) ;
V_481 -> V_382 = F_90 ( V_65 -> V_173 . V_175 ) ;
F_15 ( V_65 , V_465 ) ;
if ( F_115 ( V_2 , V_4 , V_304 ) ) {
V_4 -> V_451 -- ;
F_15 ( V_65 , V_452 ) ;
...
static int F_225 ( struct V_3 * V_4 , T_2 V_24 )
{
struct V_64 * V_65 ;
unsigned long V_39 ;
F_40 ( V_4 -> V_89 -> V_122 , V_39 ) ;
...
T_3 V_495 = F_6 ( V_38 -> V_297 . V_36 ) ;
int V_450 = V_235 ;
switch ( V_495 ) {
case V_360 :
F_29 ( V_4 , L_85 ) ;
V_4 -> V_490 = F_4 ( V_38 -> V_496 ) ;
F_17 ( V_4 , V_75 ) ;
break;
case V_461 :
V_450 += F_60 ( V_4 ) ;
...
F_103 ( V_2 , F_229 , V_31 ) ;
V_10 = & V_2 -> V_7 . V_494 ;
memset ( V_10 , 0 , sizeof( * V_10 ) ) ;
V_10 -> V_297 . V_298 = F_89 ( 1 ) ;
V_10 -> V_297 . V_32 = F_89 ( V_497 ) ;
V_10 -> V_297 . V_300 = F_52 ( sizeof( * V_10 ) ) ;
V_10 -> V_498 = F_89 ( V_4 -> V_499 ) ;
V_10 -> V_500 . V_207 = F_90 ( V_4 -> V_501 ) ;
V_10 -> V_500 . V_208 = F_89 ( V_4 -> V_499 ) ;
F_17 ( V_4 , V_76 ) ;
if ( ! F_115 ( V_2 , V_4 , V_304 ) )
F_29 ( V_4 , L_88 ) ;
else
...
{
struct V_3 * V_4 = V_2 -> V_4 ;
T_3 V_495 = F_6 ( V_2 -> V_33 -> V_502 . V_297 . V_36 ) ;
...
return;
default:
F_24 ( V_4 -> V_98 , L_90 , V_495 ) ;
F_21 ( V_4 , V_164 ) ;
F_44 ( V_2 ) ;
return;
}
V_4 -> V_199 = 0 ;
if ( ! ( F_4 ( V_38 -> V_39 ) & V_505 ) ) {
F_24 ( V_4 -> V_98 , L_91 ,
V_38 -> V_39 ) ;
F_21 ( V_4 , V_164 ) ;
F_20 ( & V_4 -> V_91 ) ;
...
V_4 -> V_117 = 1 ;
V_504 = F_231 ( ( V_506 ) ( F_2 ( V_38 -> V_190 ) >> 9 ) , V_191 ) ;
F_136 ( V_4 -> V_98 , L_93 ,
V_38 -> V_183 , V_38 -> V_210 , V_38 -> V_429 ,
V_38 -> V_212 , V_504 ) ;
F_232 ( V_4 -> V_89 ) = F_2 ( V_38 -> V_174 ) ;
F_233 ( V_4 -> V_89 ) = F_2 ( V_38 -> V_174 ) ;
F_234 ( V_4 -> V_89 ) = F_2 ( V_38 -> V_175 ) ;
F_235 ( V_4 -> V_89 ) = F_2 ( V_38 -> V_24 ) ;
F_236 ( V_4 -> V_89 ) = V_507 ;
F_237 ( V_4 -> V_89 ) = 0 ;
if ( F_4 ( V_38 -> V_453 . V_508 [ 0 ] ) & 0x80000000 )
F_237 ( V_4 -> V_89 ) |= V_509 ;
if ( F_4 ( V_38 -> V_453 . V_510 [ 0 ] ) & 0x80000000 )
F_237 ( V_4 -> V_89 ) |= V_511 ;
if ( F_4 ( V_38 -> V_453 . V_512 [ 0 ] ) & 0x80000000 )
F_237 ( V_4 -> V_89 ) |= V_513 ;
F_238 ( V_4 -> V_89 ) =
F_6 ( V_38 -> V_453 . V_297 . V_514 ) & 0x0fff ;
V_4 -> V_89 -> V_515 = F_4 ( V_38 -> V_201 ) - V_203 ;
...
F_84 ( V_4 ) ;
F_88 ( V_4 ) ;
F_103 ( V_2 , F_230 , V_31 ) ;
memcpy ( V_4 -> V_152 , & V_4 -> V_185 , sizeof( V_4 -> V_185 ) ) ;
V_10 = & V_2 -> V_7 . V_502 ;
memset ( V_10 , 0 , sizeof( struct V_517 ) ) ;
V_10 -> V_297 . V_298 = F_89 ( 1 ) ;
V_10 -> V_297 . V_32 = F_89 ( V_518 ) ;
V_10 -> V_297 . V_300 = F_52 ( sizeof( struct V_517 ) ) ;
V_10 -> V_500 . V_207 = F_90 ( V_4 -> V_519 ) ;
V_10 -> V_500 . V_208 = F_89 ( sizeof( * V_4 -> V_152 ) ) ;
F_17 ( V_4 , V_76 ) ;
if ( ! F_115 ( V_2 , V_4 , V_304 ) )
F_29 ( V_4 , L_94 ) ;
else
...
{
struct V_3 * V_4 = V_2 -> V_4 ;
T_3 V_495 = F_6 ( V_2 -> V_33 -> V_520 . V_297 . V_36 ) ;
F_44 ( V_2 ) ;
switch ( V_495 ) {
case V_360 :
if ( F_101 ( & V_4 -> V_248 ) &&
...
struct V_1 * V_2 ;
V_2 = F_100 ( V_4 ) ;
F_103 ( V_2 , F_239 , V_31 ) ;
V_10 = & V_2 -> V_7 . V_520 ;
memset ( V_10 , 0 , sizeof( * V_10 ) ) ;
V_10 -> V_297 . V_298 = F_89 ( 1 ) ;
V_10 -> V_297 . V_32 = F_89 ( V_523 ) ;
V_10 -> V_297 . V_300 = F_52 ( sizeof( struct V_522 ) ) ;
F_17 ( V_4 , V_77 ) ;
if ( ! F_115 ( V_2 , V_4 , V_304 ) )
F_29 ( V_4 , L_96 ) ;
else
...
static void F_244 ( struct V_3 * V_4 , int V_128 )
{
if ( V_128 & V_393 )
F_245 ( V_4 -> V_89 , F_246 () , V_524 , 0 ) ;
if ( ( V_128 & V_94 ) &&
V_4 -> V_72 >= V_166 )
F_245 ( V_4 -> V_89 , F_246 () , V_525 , 0 ) ;
if ( ( V_128 & V_389 ) &&
V_4 -> V_72 == V_88 )
F_245 ( V_4 -> V_89 , F_246 () , V_526 , 0 ) ;
}
...
unsigned long V_39 ;
F_208 ( V_65 , L_97 ) ;
V_170 = F_248 ( V_4 -> V_89 , 0 , & V_65 -> V_173 ) ;
F_40 ( V_4 -> V_89 -> V_122 , V_39 ) ;
...
F_208 ( V_65 , L_99 ) ;
V_65 -> V_170 = V_170 ;
V_170 -> V_527 = F_6 ( V_65 -> V_453 . V_297 . V_514 ) & 0x0fff ;
V_170 -> V_528 = 0 ;
V_65 -> V_148 = V_170 -> V_529 ;
if ( F_4 ( V_65 -> V_453 . V_508 [ 0 ] ) & 0x80000000 )
V_170 -> V_528 |= V_509 ;
if ( F_4 ( V_65 -> V_453 . V_510 [ 0 ] ) & 0x80000000 )
V_170 -> V_528 |= V_511 ;
if ( F_4 ( V_65 -> V_453 . V_512 [ 0 ] ) & 0x80000000 )
V_170 -> V_528 |= V_513 ;
if ( V_170 -> V_530 )
F_251 ( V_170 -> V_530 , 1 ) ;
} else
...
static void F_252 ( struct V_3 * V_4 )
{
struct V_64 * V_65 ;
unsigned long V_39 ;
struct V_169 * V_170 ;
...
struct V_111 * V_18 = & V_4 -> V_18 ;
V_92 ;
V_18 -> V_100 = (struct V_405 * ) F_260 ( V_213 ) ;
if ( ! V_18 -> V_100 )
return - V_214 ;
V_18 -> V_129 = V_101 / sizeof( * V_18 -> V_100 ) ;
V_18 -> V_118 = F_261 ( V_98 , V_18 -> V_100 ,
V_101 , V_119 ) ;
if ( F_262 ( V_98 , V_18 -> V_118 ) )
goto V_535;
V_534 = V_47 = F_27 ( V_123 , V_108 -> V_110 ,
V_18 -> V_118 , V_101 ) ;
if ( V_47 == V_536 )
V_534 = V_47 = F_39 ( V_4 ) ;
if ( V_47 == V_124 )
...
V_534 = 0 ;
F_263 ( & V_4 -> V_113 , ( void * ) F_201 , ( unsigned long ) V_4 ) ;
if ( ( V_47 = F_264 ( V_108 -> V_112 , F_198 , 0 , V_538 , V_4 ) ) ) {
...
F_266 ( V_4 -> V_487 ) ;
F_74 ( V_4 -> V_14 ) ;
F_99 ( V_4 -> V_98 , V_4 -> V_499 , V_4 -> V_491 ,
V_4 -> V_501 ) ;
F_99 ( V_4 -> V_98 , sizeof( * V_4 -> V_152 ) ,
V_4 -> V_152 , V_4 -> V_519 ) ;
F_267 ( V_4 -> V_220 ) ;
F_36 ( V_4 -> V_98 , V_540 -> V_118 ,
V_540 -> V_129 * sizeof( * V_540 -> V_100 ) , V_119 ) ;
F_37 ( ( unsigned long ) V_540 -> V_100 ) ;
V_95 ;
}
...
struct V_231 * V_98 = V_4 -> V_98 ;
V_92 ;
V_540 -> V_100 = (struct V_380 * ) F_260 ( V_213 ) ;
if ( ! V_540 -> V_100 ) {
F_24 ( V_98 , L_107 ) ;
goto V_541;
}
V_540 -> V_129 = V_101 / sizeof( struct V_380 ) ;
V_540 -> V_118 = F_261 ( V_98 , V_540 -> V_100 ,
V_540 -> V_129 * sizeof( * V_540 -> V_100 ) ,
V_119 ) ;
if ( F_262 ( V_98 , V_540 -> V_118 ) ) {
F_24 ( V_98 , L_108 ) ;
goto V_542;
}
V_4 -> V_220 = F_269 ( V_538 , V_98 ,
...
static void F_271 ( struct V_552 * V_553 )
{
struct V_3 * V_4 = F_73 ( V_553 , struct V_3 ,
V_531 ) ;
struct V_64 * V_65 ;
struct V_169 * V_170 ;
unsigned long V_39 ;
...
F_42 ( V_4 -> V_89 -> V_122 , V_39 ) ;
F_247 ( V_65 ) ;
} else if ( F_272 ( & V_170 -> V_98 ) ) {
F_42 ( V_4 -> V_89 -> V_122 , V_39 ) ;
F_208 ( V_65 , L_113 ) ;
F_273 ( V_170 , V_65 -> V_173 . V_455 ) ;
F_274 ( & V_170 -> V_98 ) ;
}
F_77 ( & V_65 -> V_150 , F_72 ) ;
F_40 ( V_4 -> V_89 -> V_122 , V_39 ) ;
...
static int F_275 ( struct V_107 * V_108 , const struct V_555 * V_149 )
{
struct V_3 * V_4 ;
struct V_145 * V_146 ;
...
F_278 ( & V_4 -> V_91 ) ;
F_278 ( & V_4 -> V_176 ) ;
F_279 ( & V_4 -> V_531 , F_271 ) ;
F_280 ( & V_4 -> V_333 ) ;
if ( ( V_47 = F_268 ( V_4 ) ) )
goto V_565;
V_4 -> V_566 = F_281 ( F_256 , V_4 , L_116 , V_538 ,
V_146 -> V_564 ) ;
if ( F_282 ( V_4 -> V_566 ) ) {
F_24 ( V_98 , L_117 ,
F_283 ( V_4 -> V_566 ) ) ;
...
if ( ( V_47 = F_284 ( V_146 , V_98 ) ) )
goto V_570;
F_285 ( V_146 ) = V_571 ;
if ( ( V_47 = F_286 ( & V_146 -> V_572 . V_434 ,
& V_573 ) ) ) {
F_24 ( V_98 , L_120 , V_47 ) ;
goto V_574;
}
if ( F_287 ( V_146 ) -> V_530 )
F_251 ( F_287 ( V_146 ) -> V_530 , 1 ) ;
F_288 ( V_98 , V_4 ) ;
F_289 ( & V_575 ) ;
F_47 ( & V_4 -> V_130 , & V_576 ) ;
F_290 ( & V_575 ) ;
F_28 ( V_4 ) ;
F_291 ( V_146 ) ;
return 0 ;
...
static int F_295 ( struct V_107 * V_108 )
{
struct V_3 * V_4 = F_109 ( & V_108 -> V_98 ) ;
unsigned long V_39 ;
V_92 ;
F_296 ( & V_4 -> V_89 -> V_572 . V_434 , & V_573 ) ;
F_40 ( V_4 -> V_89 -> V_122 , V_39 ) ;
F_21 ( V_4 , V_73 ) ;
F_42 ( V_4 -> V_89 -> V_122 , V_39 ) ;
F_81 ( V_4 ) ;
...
static int F_298 ( struct V_231 * V_98 )
{
unsigned long V_39 ;
struct V_3 * V_4 = F_109 ( V_98 ) ;
struct V_107 * V_108 = F_26 ( V_98 ) ;
...
static unsigned long F_299 ( struct V_107 * V_108 )
{
unsigned long V_577 = V_202 * sizeof( union V_307 ) ;
return V_577 + ( ( 512 * 1024 ) * V_556 . V_578 ) ;
}
static int T_10 F_300 ( void )
{
int V_47 ;
if ( ! F_301 ( V_579 ) )
return - V_580 ;
F_302 (KERN_INFO IBMVFC_NAMEL_121 ,
