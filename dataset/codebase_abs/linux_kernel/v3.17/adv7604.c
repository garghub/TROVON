...
V_98 -> V_116 = F_51 ( V_6 , 0x34 , 0x1fff ) / 2 ;
}
F_100 ( V_6 , V_97 ) ;
} else {
...
V_221 -> V_99 = V_2 -> V_97 . V_98 . V_99 ;
V_221 -> V_106 = V_2 -> V_97 . V_98 . V_106 ;
V_221 -> V_222 = V_223 ;
if ( V_2 -> V_97 . V_98 . V_137 & V_138 )
V_221 -> V_224 = ( V_2 -> V_97 . V_98 . V_106 <= 576 ) ?
V_225 : V_226 ;
}
...
{
struct V_1 * V_2 = F_2 ( V_6 ) ;
if ( V_221 -> V_178 != V_2 -> V_179 )
return - V_71 ;
F_115 ( V_2 , & V_221 -> V_221 ) ;
if ( V_221 -> V_243 == V_244 ) {
struct V_220 * V_245 ;
V_245 = F_121 ( V_218 , V_221 -> V_178 ) ;
V_221 -> V_221 . V_77 = V_245 -> V_77 ;
} else {
V_221 -> V_221 . V_77 = V_2 -> V_221 -> V_77 ;
}
return 0 ;
}
...
if ( V_221 -> V_178 != V_2 -> V_179 )
return - V_71 ;
V_3 = V_75 ( V_2 , V_221 -> V_221 . V_77 ) ;
if ( V_3 == NULL )
V_3 = V_75 ( V_2 , V_246 ) ;
F_115 ( V_2 , & V_221 -> V_221 ) ;
V_221 -> V_221 . V_77 = V_3 -> V_77 ;
if ( V_221 -> V_243 == V_244 ) {
struct V_220 * V_245 ;
V_245 = F_121 ( V_218 , V_221 -> V_178 ) ;
V_245 -> V_77 = V_221 -> V_221 . V_77 ;
} else {
V_2 -> V_221 = V_3 ;
F_119 ( V_2 ) ;
}
...
static int F_123 ( struct V_5 * V_6 , T_4 V_155 , bool * V_247 )
{
struct V_1 * V_2 = F_2 ( V_6 ) ;
const struct V_90 * V_3 = V_2 -> V_3 ;
...
if ( V_64 -> V_259 == 1 )
V_64 -> V_258 = 1 ;
if ( V_64 -> V_258 > V_2 -> V_64 . V_258 )
V_64 -> V_258 = V_2 -> V_64 . V_258 ;
switch ( V_64 -> V_178 ) {
case V_83 :
case V_84 :
case V_85 :
...
memcpy ( V_2 -> V_64 . V_64 , V_64 -> V_64 , 128 * V_64 -> V_258 ) ;
V_2 -> V_64 . V_258 = V_64 -> V_258 ;
V_2 -> V_172 = F_128 ( V_64 -> V_64 [ 0x15 ] ,
V_64 -> V_64 [ 0x16 ] ) ;
V_2 -> V_64 . V_65 |= 1 << V_64 -> V_178 ;
V_26 = F_41 ( V_6 , 128 * V_64 -> V_258 , V_2 -> V_64 . V_64 ) ;
if ( V_26 < 0 ) {
...
F_110 ( V_6 ) ;
if ( V_234 -> V_288 >= 0 &&
V_234 -> V_288 < V_2 -> V_179 ) {
V_2 -> V_80 = V_234 -> V_288 ;
F_112 ( V_6 ) ;
F_109 ( V_6 ) ;
}
F_19 ( V_6 , 0x0c , 0x42 ) ;
...
const struct V_326 * V_145 )
{
static const struct V_96 V_327 =
V_328 ;
struct V_1 * V_2 ;
struct V_329 * V_144 ;
struct V_5 * V_6 ;
...
V_2 -> V_3 = ( const struct V_90 * ) V_145 -> V_338 ;
V_2 -> V_234 = * V_234 ;
} else {
F_14 ( V_10 , L_151 ) ;
return - V_339 ;
...
if ( F_1 ( V_2 ) )
V_2 -> V_345 =
F_160 ( V_144 , & V_346 , NULL ) ;
V_2 -> V_347 =
F_160 ( V_144 , & V_348 , NULL ) ;
V_2 -> V_349 =
F_160 ( V_144 , & V_350 , NULL ) ;
V_6 -> V_306 = V_144 ;
if ( V_144 -> error ) {
V_26 = V_144 -> error ;
goto V_351;
...
V_2 -> V_355 [ V_2 -> V_179 ] . V_17 = V_357 ;
V_26 = F_163 ( & V_6 -> V_358 , V_2 -> V_179 + 1 ,
V_2 -> V_355 , 0 ) ;
if ( V_26 )
goto V_359;
V_26 = F_133 ( V_6 ) ;
