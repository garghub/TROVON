...
F_13 ( V_42 ) ;
for ( type = 0 ; type < V_45 ; type ++ ) {
V_33 [ type ] . V_48 . V_49 = F_14 ( & V_35 -> V_2 ,
sizeof( struct V_50 * ) *
( V_33 [ type ] . V_47 + 1 ) ,
V_51 ) ;
...
static int T_3 F_15 ( struct V_34 * V_35 )
{
struct V_36 * V_37 = F_9 ( V_35 ) ;
const struct V_38 * * V_39 = V_37 -> V_40 ;
struct V_41 * V_42 , * V_43 ;
...
int V_20 = 0 ;
V_42 = F_10 ( L_8 ) ;
V_7 = F_14 ( & V_35 -> V_2 , V_37 -> V_53 * sizeof( * V_7 ) ,
V_51 ) ;
if ( ! V_7 ) {
V_20 = - V_52 ;
goto V_56;
...
static int T_3 F_19 ( struct V_34 * V_35 )
{
struct V_36 * V_37 ;
struct V_1 * V_60 ;
int V_20 ;
V_37 = F_14 ( & V_35 -> V_2 , sizeof( * V_37 ) , V_51 ) ;
if ( ! V_37 )
return - V_52 ;
F_20 ( V_35 , V_37 ) ;
V_37 -> V_53 = 0 ;
