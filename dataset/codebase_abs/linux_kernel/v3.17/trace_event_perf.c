...
static void
F_36 ( unsigned long V_62 , unsigned long V_63 ,
struct V_64 * V_65 , struct V_54 * V_54 )
{
struct V_66 * V_58 ;
struct V_20 * V_67 ;
struct V_54 V_55 ;
...
F_30 ( F_38 > V_61 ) ;
F_39 ( & V_55 ) ;
V_58 = F_29 ( F_38 , V_70 , NULL , & V_68 ) ;
if ( ! V_58 )
return;
V_58 -> V_62 = V_62 ;
V_58 -> V_63 = V_63 ;
F_40 ( V_58 , F_38 , V_68 , 0 ,
1 , & V_55 , V_67 , NULL ) ;
#undef F_38
}
static int F_41 ( struct V_3 * V_44 )
{
struct V_64 * V_65 = & V_44 -> V_64 ;
V_65 -> V_18 |= V_71 ;
V_65 -> V_72 = F_36 ;
return F_42 ( V_65 ) ;
}
