...
long V_109 = F_72 ( F_73 ( V_20 -> V_110 ) ) ;
if ( V_57 ) {
if ( V_20 -> V_27 == 1 )
F_74 ( V_65 , V_57 , V_109 ) ;
F_75 ( V_65 , V_57 , V_20 -> V_27 - 1 ) ;
}
}
void F_76 ( struct V_17 * V_18 , int V_111 )
{
struct V_19 * V_20 = V_18 -> V_21 ;
struct V_15 * V_16 = V_20 -> V_51 ;
F_13 ( L_21 ,
V_18 -> V_28 , F_70 ( V_20 -> V_107 ) , V_111 ) ;
V_16 -> V_92 . V_112 ++ ;
V_20 -> V_110 = F_77 ( F_78 () , V_20 -> V_113 ) ;
...
static struct V_19 * F_92 ( struct V_15 * V_16 , T_3 V_141 )
{
struct V_19 * V_20 = F_93 ( - V_31 ) ;
if ( ! F_94 ( & V_16 -> V_129 , 1 , V_16 -> V_142 ) )
goto V_8;
V_20 = F_95 ( sizeof( struct V_19 ) , V_141 ) ;
if ( V_20 != NULL )
goto V_8;
F_96 ( & V_16 -> V_129 ) ;
V_20 = F_93 ( - V_143 ) ;
...
{
if ( F_94 ( & V_16 -> V_129 , - 1 , V_16 -> V_144 ) ) {
F_98 ( V_20 ) ;
return true ;
}
return false ;
...
F_2 ( & V_16 -> V_140 ) ;
if ( ! F_64 ( & V_16 -> free ) ) {
V_20 = F_100 ( V_16 -> free . V_145 , struct V_19 , V_114 ) ;
F_101 ( & V_20 -> V_114 ) ;
goto V_146;
}
V_20 = F_92 ( V_16 , V_147 | V_148 ) ;
if ( ! F_102 ( V_20 ) )
goto V_146;
switch ( F_103 ( V_20 ) ) {
case - V_143 :
...
V_20 = F_109 ( & V_16 -> free , struct V_19 , V_114 ) ;
F_101 ( & V_20 -> V_114 ) ;
F_98 ( V_20 ) ;
}
}
struct V_15 * F_110 ( struct V_149 * V_149 , T_4 V_150 ,
unsigned int V_151 ,
unsigned int V_152 )
{
struct V_15 * V_16 ;
struct V_19 * V_20 ;
int V_153 ;
V_16 = F_95 ( V_150 , V_154 ) ;
if ( V_16 == NULL )
goto V_8;
F_111 ( V_16 , V_149 ) ;
for ( V_153 = 0 ; V_153 < V_151 ; V_153 ++ ) {
V_20 = F_95 ( sizeof( struct V_19 ) , V_154 ) ;
if ( ! V_20 )
goto V_155;
F_107 ( & V_20 -> V_114 , & V_16 -> free ) ;
}
...
static void F_111 ( struct V_15 * V_16 , struct V_149 * V_149 )
{
F_112 ( & V_16 -> V_172 , 1 ) ;
F_131 ( & V_16 -> V_40 ) ;
F_131 ( & V_16 -> V_140 ) ;
...
V_16 -> V_49 = V_176 ;
V_16 -> V_177 = 0 ;
F_133 ( & V_16 -> V_178 , L_31 ) ;
F_133 ( & V_16 -> V_54 , L_32 ) ;
F_134 ( & V_16 -> V_35 , L_33 ) ;
F_134 ( & V_16 -> V_134 , L_34 ) ;
F_121 ( V_16 ) ;
V_16 -> V_156 = F_135 ( V_149 ) ;
}
struct V_15 * F_136 ( struct V_179 * args )
{
struct V_15 * V_16 ;
struct V_1 * V_3 ;
F_2 ( & V_6 ) ;
...
F_139 ( & V_16 -> V_57 ) ;
if ( strlen ( args -> V_103 ) > V_184 ) {
F_140 ( V_16 ) ;
return F_93 ( - V_185 ) ;
}
V_16 -> V_103 = F_141 ( args -> V_103 , V_154 ) ;
if ( V_16 -> V_103 == NULL ) {
F_140 ( V_16 ) ;
return F_93 ( - V_143 ) ;
}
