...
F_279 ( V_15 ) ;
F_280 ( V_15 ) ;
V_283 = F_281 ( V_15 , & V_716 ) ;
if ( V_283 )
return V_283 ;
V_690 = F_235 ( V_716 , 0x250 ) ;
if ( ! V_690 )
return - V_180 ;
V_283 = F_282 ( V_15 , V_690 , & V_714 ,
& V_715 , & V_713 ) ;
if ( V_283 )
goto V_719;
V_710 = F_235 ( F_283 ( V_15 ,
...
static void F_287 ( struct V_28 * V_16 , struct V_709 * V_726 )
{
#ifdef F_288
int V_51 ;
char V_727 [ 17 ] ;
...
F_60 ( V_16 , L_242 , F_266 ( & ( V_726 -> V_729 ) ) ) ;
F_60 ( V_16 , L_243 ,
F_266 ( & ( V_726 -> V_730 ) ) ) ;
F_60 ( V_16 , L_244 ,
F_266 ( & ( V_726 -> V_731 ) ) ) ;
...
F_60 ( V_16 , L_248 ,
F_266 ( & ( V_726 -> V_736 ) ) ) ;
F_60 ( V_16 , L_249 , F_266 ( & ( V_726 -> V_737 ) ) ) ;
...
static int F_289 ( struct V_271 * V_15 , unsigned long V_740 )
{
...
V_743 = F_290 ( V_15 , V_51 ) & V_746 ;
if ( V_743 == V_747 )
V_741 += 4 ;
else {
V_742 = F_290 ( V_15 , V_51 ) &
V_748 ;
switch ( V_742 ) {
case V_749 :
case V_750 :
...
static int F_281 ( struct V_271 * V_15 ,
unsigned long * V_768 )
{
int V_51 ;
for ( V_51 = 0 ; V_51 < V_745 ; V_51 ++ )
if ( F_290 ( V_15 , V_51 ) & V_769 ) {
* V_768 = F_283 ( V_15 , V_51 ) ;
...
static int F_286 ( struct V_271 * V_15 , void T_13 * V_690 ,
int V_770 )
{
int V_51 , V_771 ;
T_3 V_772 ;
...
static int F_282 ( struct V_271 * V_15 , void T_13 * V_690 ,
T_3 * V_714 , T_5 * V_715 ,
T_5 * V_713 )
{
* V_714 = F_266 ( V_690 + V_778 ) ;
* V_713 = F_266 ( V_690 + V_779 ) ;
* V_714 &= ( T_3 ) 0x0000ffff ;
* V_715 = F_289 ( V_15 , * V_714 ) ;
if ( * V_715 == - 1 ) {
F_5 ( & V_15 -> V_16 , L_264 ) ;
return - V_62 ;
}
...
static int F_296 ( struct V_1 * V_8 )
{
T_5 V_713 ;
T_3 V_714 ;
T_5 V_715 ;
T_3 V_780 ;
int V_283 ;
V_283 = F_282 ( V_8 -> V_15 , V_8 -> V_690 , & V_714 ,
& V_715 , & V_713 ) ;
if ( V_283 )
return V_283 ;
V_8 -> V_710 = F_235 ( F_283 ( V_8 -> V_15 ,
...
if ( V_283 )
return V_283 ;
V_780 = F_266 ( & V_8 -> V_710 -> V_781 ) ;
V_8 -> V_782 = F_235 ( F_283 ( V_8 -> V_15 ,
V_715 ) + V_713 + V_780 ,
sizeof( * V_8 -> V_782 ) ) ;
if ( ! V_8 -> V_782 )
return - V_180 ;
...
{
V_8 -> V_85 = F_266 ( & ( V_8 -> V_710 -> V_783 ) ) ;
...
V_8 -> V_414 = F_266 ( & ( V_8 -> V_710 -> V_784 ) ) ;
...
static inline bool F_299 ( struct V_1 * V_8 )
{
if ( ! F_300 ( V_8 -> V_710 -> V_728 , L_270 , 4 ) ) {
...
{
T_3 V_785 ;
V_785 = F_266 ( & ( V_8 -> V_710 -> V_785 ) ) ;
#ifdef F_302
V_785 |= V_786 ;
#endif
V_785 |= V_787 ;
F_265 ( V_785 , & ( V_8 -> V_710 -> V_785 ) ) ;
}
static inline void F_303 ( struct V_1 * V_8 )
{
T_3 V_788 ;
if ( V_8 -> V_50 != 0x3225103C )
return;
V_788 = F_266 ( V_8 -> V_690 + V_789 ) ;
V_788 |= 0x8000 ;
F_265 ( V_788 , V_8 -> V_690 + V_789 ) ;
}
...
static void F_305 ( struct V_1 * V_8 )
{
int V_51 ;
T_3 V_790 ;
unsigned long V_59 ;
...
{
T_3 V_794 ;
V_794 = F_266 ( & ( V_8 -> V_710 -> V_730 ) ) ;
if ( ! ( V_794 & V_795 ) )
return - V_525 ;
V_8 -> V_85 = F_266 ( & ( V_8 -> V_710 -> V_736 ) ) ;
F_265 ( V_796 , & ( V_8 -> V_710 -> V_732 . V_733 ) ) ;
F_265 ( 0 , & V_8 -> V_710 -> V_732 . V_797 ) ;
F_265 ( V_793 , V_8 -> V_690 + V_702 ) ;
F_305 ( V_8 ) ;
F_287 ( & V_8 -> V_15 -> V_16 , V_8 -> V_710 ) ;
if ( ! ( F_266 ( & ( V_8 -> V_710 -> V_731 ) ) & V_796 ) )
goto error;
V_8 -> V_48 = V_796 ;
return 0 ;
error:
...
{
int V_798 , V_594 ;
V_798 = F_278 ( V_8 -> V_15 , & V_8 -> V_50 ) ;
if ( V_798 < 0 )
return - V_62 ;
V_8 -> V_799 = V_764 [ V_798 ] . V_799 ;
V_8 -> V_79 = * ( V_764 [ V_798 ] . V_79 ) ;
F_309 ( V_8 -> V_15 , V_800 |
V_801 | V_802 ) ;
V_594 = F_285 ( V_8 -> V_15 ) ;
if ( V_594 ) {
F_5 ( & V_8 -> V_15 -> V_16 , L_273 ) ;
return V_594 ;
}
F_310 ( V_8 -> V_15 ) ;
V_594 = F_311 ( V_8 -> V_15 , V_17 ) ;
if ( V_594 ) {
F_59 ( & V_8 -> V_15 -> V_16 ,
L_274 ) ;
return V_594 ;
...
F_291 ( V_8 ) ;
V_594 = F_281 ( V_8 -> V_15 , & V_8 -> V_716 ) ;
if ( V_594 )
goto V_803;
...
V_594 = F_286 ( V_8 -> V_15 , V_8 -> V_690 , V_725 ) ;
if ( V_594 )
goto V_803;
V_594 = F_296 ( V_8 ) ;
if ( V_594 )
...
if ( F_286 ( V_8 -> V_15 , V_8 -> V_690 , V_810 ) ) {
F_5 ( & V_8 -> V_15 -> V_16 , L_283 ) ;
return - 1 ;
}
F_60 ( & V_8 -> V_15 -> V_16 , L_284 ) ;
if ( F_286 ( V_8 -> V_15 , V_8 -> V_690 , V_725 ) ) {
...
static void F_339 ( struct V_1 * V_8 , T_3 V_814 )
{
int V_51 , V_282 ;
V_282 = F_321 ( V_805 ) ;
for ( V_51 = 0 ; V_51 < F_293 () ; V_51 ++ ) {
T_3 * F_111 ;
F_111 = F_113 ( V_8 -> F_111 , V_282 ) ;
* F_111 = V_814 ;
V_282 = F_324 ( V_282 , V_805 ) ;
...
L_291 ,
V_8 -> V_822 , V_821 ) ;
F_265 ( V_8 -> V_822 , & ( V_8 -> V_710 -> V_825 ) ) ;
F_265 ( V_792 , V_8 -> V_690 + V_702 ) ;
F_304 ( V_8 ) ;
F_347 ( V_8 -> V_44 ) ;
} else {
F_265 ( V_8 -> V_822 , & ( V_8 -> V_710 -> V_825 ) ) ;
...
if ( ! ( V_8 -> V_355 & V_826 ) )
return 0 ;
V_8 -> V_822 = F_266 ( & ( V_8 -> V_710 -> V_827 ) ) ;
...
static void F_352 ( struct V_831 * V_832 )
{
unsigned long V_59 ;
struct V_1 * V_8 = F_253 ( F_353 ( V_832 ) ,
struct V_1 , V_833 ) ;
F_342 ( V_8 ) ;
if ( F_111 ( V_8 ) )
return;
...
static int F_356 ( struct V_271 * V_15 , const struct V_835 * V_836 )
{
int V_837 , V_283 ;
struct V_1 * V_8 ;
int V_838 = 0 ;
unsigned long V_59 ;
if ( V_839 == 0 )
F_357 (KERN_INFO DRIVER_NAME L_292 ) ;
V_283 = F_315 ( V_15 ) ;
if ( V_283 ) {
if ( V_283 != - V_525 )
return V_283 ;
...
static void F_373 ( int V_850 [] , int V_851 ,
...
static void F_374 ( struct V_1 * V_8 , T_3 V_794 )
{
int V_51 ;
unsigned long V_856 ;
...
#define F_375 5
#define F_376 4
int V_862 [ 16 ] = { F_375 , 6 , 7 , 8 , 9 , 10 , 11 , 12 ,
...
V_861 [ 7 ] = V_645 + 4 ;
F_373 ( V_861 , F_18 ( V_861 ) ,
V_645 , 4 , V_8 -> V_87 ) ;
for ( V_51 = 0 ; V_51 < 8 ; V_51 ++ )
F_265 ( V_861 [ V_51 ] , & V_8 -> V_782 -> V_864 [ V_51 ] ) ;
F_265 ( V_8 -> V_85 , & V_8 -> V_782 -> V_865 ) ;
F_265 ( V_8 -> V_92 , & V_8 -> V_782 -> V_866 ) ;
F_265 ( 0 , & V_8 -> V_782 -> V_867 ) ;
F_265 ( 0 , & V_8 -> V_782 -> V_868 ) ;
for ( V_51 = 0 ; V_51 < V_8 -> V_92 ; V_51 ++ ) {
F_265 ( 0 , & V_8 -> V_782 -> V_869 [ V_51 ] . V_195 ) ;
...
if ( V_794 & V_78 ) {
for ( V_51 = 0 ; V_51 < V_8 -> V_92 ; V_51 ++ ) {
F_265 ( V_51 , V_8 -> V_690 + V_872 ) ;
V_8 -> V_77 [ V_51 ] . V_82 =
F_266 ( V_8 -> V_690 + V_873 ) ;
}
V_861 [ 7 ] = V_8 -> V_431 + 8 ;
F_373 ( V_861 , F_18 ( V_861 ) , V_8 -> V_431 , 8 ,
V_8 -> V_97 ) ;
for ( V_51 = 0 ; V_51 < V_8 -> V_92 ; V_51 ++ )
...
V_862 [ 15 ] = V_8 -> V_431 + F_376 ;
F_373 ( V_862 , F_18 ( V_862 ) , V_8 -> V_431 ,
4 , V_8 -> V_101 ) ;
V_884 = F_266 ( & V_8 -> V_710 -> V_885 ) ;
F_358 ( F_178 ( struct V_709 ,
V_885 ) != 0xb8 ) ;
V_8 -> V_886 =
F_235 ( F_283 ( V_8 -> V_15 ,
V_715 ) +
V_713 + V_884 ,
F_18 ( V_862 ) *
sizeof( * V_8 -> V_886 ) ) ;
for ( V_51 = 0 ; V_51 < F_18 ( V_862 ) ; V_51 ++ )
F_265 ( V_862 [ V_51 ] , & V_8 -> V_886 [ V_51 ] ) ;
}
F_265 ( V_793 , V_8 -> V_690 + V_702 ) ;
F_305 ( V_8 ) ;
}
