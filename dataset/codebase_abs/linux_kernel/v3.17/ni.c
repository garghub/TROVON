...
V_6 V_281 = V_282 | V_283 |
V_284 ;
F_68 ( V_271 , F_69 ( V_292 , 0 ) ) ;
F_68 ( V_271 , 1 ) ;
if ( V_271 -> V_293 ) {
T_4 V_294 = V_271 -> V_295 + 3 + 4 + 8 ;
F_68 ( V_271 , F_69 ( V_296 , 1 ) ) ;
F_68 ( V_271 , ( ( V_271 -> V_293 -
V_297 ) >> 2 ) ) ;
F_68 ( V_271 , V_294 ) ;
}
F_68 ( V_271 , F_69 ( V_298 , 2 ) ) ;
F_68 ( V_271 ,
#ifdef F_77
( 2 << 0 ) |
#endif
...
F_68 ( V_271 , V_291 -> V_299 |
( V_291 -> V_300 ? ( V_291 -> V_300 -> V_301 << 24 ) : 0 ) ) ;
F_68 ( V_271 , F_69 ( V_285 , 3 ) ) ;
F_68 ( V_271 , V_286 | V_281 ) ;
F_68 ( V_271 , 0xFFFFFFFF ) ;
F_68 ( V_271 , 0 ) ;
F_68 ( V_271 , ( ( V_291 -> V_300 ? V_291 -> V_300 -> V_301 : 0 ) << 24 ) | 10 ) ;
}
static void F_78 ( struct V_1 * V_2 , bool V_302 )
{
if ( V_302 )
F_6 ( V_303 , 0 ) ;
else {
if ( V_2 -> V_304 -> V_305 . V_306 == V_307 )
F_79 ( V_2 , V_2 -> V_238 . V_308 ) ;
F_6 ( V_303 , ( V_309 | V_310 ) ) ;
F_6 ( V_311 , 0 ) ;
V_2 -> V_271 [ V_307 ] . V_270 = false ;
}
}
...
V_6 V_312 ;
if ( V_2 -> V_313 . V_314 )
V_312 = V_2 -> V_313 . V_313 [ V_271 -> V_315 / 4 ] ;
else {
if ( V_271 -> V_316 == V_307 )
V_312 = F_5 ( V_317 ) ;
else if ( V_271 -> V_316 == V_318 )
V_312 = F_5 ( V_319 ) ;
else
V_312 = F_5 ( V_320 ) ;
}
...
{
if ( V_271 -> V_316 == V_307 ) {
F_6 ( V_321 , V_271 -> V_295 ) ;
( void ) F_5 ( V_321 ) ;
} else if ( V_271 -> V_316 == V_318 ) {
F_6 ( V_322 , V_271 -> V_295 ) ;
( void ) F_5 ( V_322 ) ;
} else {
F_6 ( V_323 , V_271 -> V_295 ) ;
( void ) F_5 ( V_323 ) ;
}
}
...
{
struct V_278 * V_271 = & V_2 -> V_271 [ V_307 ] ;
int V_218 , V_19 ;
...
F_78 ( V_2 , true ) ;
V_218 = F_85 ( V_2 , V_271 , V_330 + 19 ) ;
if ( V_218 ) {
F_86 ( L_21 , V_218 ) ;
return V_218 ;
}
F_68 ( V_271 , F_69 ( V_331 , 0 ) ) ;
F_68 ( V_271 , V_332 ) ;
for ( V_19 = 0 ; V_19 < V_330 ; V_19 ++ )
F_68 ( V_271 , V_333 [ V_19 ] ) ;
F_68 ( V_271 , F_69 ( V_331 , 0 ) ) ;
F_68 ( V_271 , V_334 ) ;
F_68 ( V_271 , F_69 ( V_335 , 0 ) ) ;
F_68 ( V_271 , 0 ) ;
...
F_6 ( V_365 , 0 ) ;
F_6 ( V_366 , ( 1 << 27 ) ) ;
F_6 ( V_367 , ( ( V_2 -> V_313 . V_280 + V_368 ) >> 8 ) & 0xFFFFFFFF ) ;
F_6 ( V_311 , 0xff ) ;
for ( V_19 = 0 ; V_19 < 3 ; ++ V_19 ) {
T_4 V_369 ;
T_5 V_246 ;
V_271 = & V_2 -> V_271 [ V_336 [ V_19 ] ] ;
V_369 = F_94 ( V_271 -> V_370 / 8 ) ;
V_369 |= F_94 ( V_371 / 8 ) << 8 ;
#ifdef F_77
V_369 |= V_372 ;
#endif
F_6 ( V_338 [ V_19 ] , V_369 ) ;
V_246 = V_2 -> V_313 . V_280 + V_373 ;
F_6 ( V_342 [ V_19 ] , V_246 & 0xFFFFFFFC ) ;
F_6 ( V_346 [ V_19 ] , F_73 ( V_246 ) & 0xFF ) ;
}
for ( V_19 = 0 ; V_19 < 3 ; ++ V_19 ) {
V_271 = & V_2 -> V_271 [ V_336 [ V_19 ] ] ;
F_6 ( V_350 [ V_19 ] , V_271 -> V_280 >> 8 ) ;
}
for ( V_19 = 0 ; V_19 < 3 ; ++ V_19 ) {
V_271 = & V_2 -> V_271 [ V_336 [ V_19 ] ] ;
F_95 ( V_338 [ V_19 ] , V_374 , ~ V_374 ) ;
V_271 -> V_295 = 0 ;
F_6 ( V_354 [ V_19 ] , 0 ) ;
F_6 ( V_355 [ V_19 ] , V_271 -> V_295 ) ;
F_93 ( 1 ) ;
F_95 ( V_338 [ V_19 ] , 0 , ~ V_374 ) ;
}
F_84 ( V_2 ) ;
V_2 -> V_271 [ V_307 ] . V_270 = true ;
V_2 -> V_271 [ V_318 ] . V_270 = false ;
V_2 -> V_271 [ V_337 ] . V_270 = false ;
V_218 = F_96 ( V_2 , V_307 , & V_2 -> V_271 [ V_307 ] ) ;
if ( V_218 ) {
V_2 -> V_271 [ V_307 ] . V_270 = false ;
V_2 -> V_271 [ V_318 ] . V_270 = false ;
V_2 -> V_271 [ V_337 ] . V_270 = false ;
...
V_376 |= V_395 ;
if ( V_89 & V_396 )
V_376 |= V_397 | V_390 | V_395 ;
V_89 = F_5 ( V_398 + V_156 ) ;
if ( ! ( V_89 & V_399 ) )
V_376 |= V_400 ;
V_89 = F_5 ( V_398 + V_157 ) ;
if ( ! ( V_89 & V_399 ) )
V_376 |= V_401 ;
V_89 = F_5 ( V_402 ) ;
if ( V_89 & V_403 )
...
static void F_99 ( struct V_1 * V_2 , V_6 V_376 )
{
struct V_424 V_425 ;
V_6 V_426 = 0 , V_427 = 0 ;
V_6 V_89 ;
...
F_6 ( V_303 , V_309 | V_310 ) ;
if ( V_376 & V_400 ) {
V_89 = F_5 ( V_428 + V_156 ) ;
V_89 &= ~ V_429 ;
F_6 ( V_428 + V_156 , V_89 ) ;
}
if ( V_376 & V_401 ) {
V_89 = F_5 ( V_428 + V_157 ) ;
V_89 &= ~ V_429 ;
F_6 ( V_428 + V_157 , V_89 ) ;
}
F_8 ( 50 ) ;
F_102 ( V_2 , & V_425 ) ;
if ( F_103 ( V_2 ) ) {
...
return V_218 ;
F_116 ( V_2 ) ;
if ( ! ( V_2 -> V_75 & V_76 ) && ! V_2 -> V_448 . V_449 ) {
V_218 = F_4 ( V_2 ) ;
if ( V_218 ) {
F_86 ( L_31 ) ;
return V_218 ;
...
if ( V_218 )
V_2 -> V_271 [ V_456 ] . V_370 = 0 ;
V_218 = F_119 ( V_2 , V_318 ) ;
if ( V_218 ) {
F_53 ( V_2 -> V_69 , L_33 , V_218 ) ;
return V_218 ;
}
V_218 = F_119 ( V_2 , V_337 ) ;
if ( V_218 ) {
F_53 ( V_2 -> V_69 , L_33 , V_218 ) ;
return V_218 ;
}
V_218 = F_119 ( V_2 , V_457 ) ;
if ( V_218 ) {
F_53 ( V_2 -> V_69 , L_35 , V_218 ) ;
return V_218 ;
}
V_218 = F_119 ( V_2 , V_458 ) ;
if ( V_218 ) {
F_53 ( V_2 -> V_69 , L_35 , V_218 ) ;
return V_218 ;
}
...
F_124 ( V_2 ) ;
V_218 = F_125 ( V_2 , V_271 , V_271 -> V_370 , V_373 ,
V_461 ) ;
if ( V_218 )
return V_218 ;
V_271 = & V_2 -> V_271 [ V_457 ] ;
V_218 = F_125 ( V_2 , V_271 , V_271 -> V_370 , V_462 ,
F_126 ( V_463 , 0 , 0 , 0 ) ) ;
if ( V_218 )
return V_218 ;
V_271 = & V_2 -> V_271 [ V_458 ] ;
V_218 = F_125 ( V_2 , V_271 , V_271 -> V_370 , V_464 ,
F_126 ( V_463 , 0 , 0 , 0 ) ) ;
if ( V_218 )
return V_218 ;
V_218 = F_83 ( V_2 ) ;
...
if ( V_218 )
return V_218 ;
V_271 = & V_2 -> V_271 [ V_456 ] ;
if ( V_271 -> V_370 ) {
V_218 = F_125 ( V_2 , V_271 , V_271 -> V_370 , 0 ,
V_461 ) ;
if ( ! V_218 )
V_218 = F_128 ( V_2 ) ;
if ( V_218 )
...
{
int V_218 ;
F_134 ( V_2 -> V_465 . V_466 ) ;
F_1 ( V_2 ) ;
if ( V_2 -> V_448 . V_467 == V_468 )
F_135 ( V_2 ) ;
V_2 -> V_469 = true ;
V_218 = F_112 ( V_2 ) ;
if ( V_218 ) {
...
V_6 V_478 , V_6 V_246 )
{
V_6 V_479 = ( V_478 & V_480 ) >> V_481 ;
V_6 V_482 = ( V_478 & V_483 ) >> V_484 ;
V_6 V_485 = ( V_478 & V_486 ) >> V_487 ;
char * V_488 ;
switch ( V_479 ) {
case 32 :
case 16 :
...
F_15 ( L_66 ,
V_485 , V_482 , V_246 ,
( V_478 & V_489 ) ? L_67 : L_68 ,
V_488 , V_479 ) ;
}
void F_179 ( struct V_1 * V_2 , int V_336 , struct V_490 * V_300 )
{
struct V_278 * V_271 = & V_2 -> V_271 [ V_336 ] ;
if ( V_300 == NULL )
return;
F_68 ( V_271 , F_180 ( V_242 + ( V_300 -> V_301 << 2 ) , 0 ) ) ;
F_68 ( V_271 , V_300 -> V_491 >> 12 ) ;
F_68 ( V_271 , F_180 ( V_216 , 0 ) ) ;
F_68 ( V_271 , 0x1 ) ;
F_68 ( V_271 , F_180 ( V_217 , 0 ) ) ;
F_68 ( V_271 , 1 << V_300 -> V_301 ) ;
F_68 ( V_271 , F_69 ( V_492 , 0 ) ) ;
F_68 ( V_271 , 0x0 ) ;
}
