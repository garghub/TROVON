...
& V_8 -> V_80 ,
V_218 ) ;
V_176 -> V_219 = F_99 ( ( unsigned long * )
& V_8 -> V_80 ,
V_218 ) ;
} else {
...
F_105 ( V_246 , V_250 ) ;
F_106 ( V_246 , V_252 ) ;
F_60 ( V_253 , V_70 -> V_254 ) ;
F_60 ( V_246 , V_70 -> V_255 ) ;
F_60 ( V_256 , V_70 -> V_112 ) ;
break;
case V_252 :
F_60 ( F_30 ( V_8 -> V_147 ) ,
V_70 -> V_254 ) ;
...
unsigned int V_27 ;
struct V_69 * V_70 = V_8 -> V_70 ;
V_27 = F_53 ( V_70 -> V_277 ) ;
F_60 ( V_27 , V_70 -> V_277 ) ;
F_60 ( V_70 -> V_278 , V_70 -> V_279 ) ;
V_27 = F_53 ( V_70 -> V_108 ) | V_70 -> V_280 ;
F_60 ( V_27 , V_70 -> V_108 ) ;
F_71 ( 100 ) ;
if ( F_109 ( V_8 ) )
return - 1 ;
...
F_116 ( V_301 L_52 , V_170 -> V_302 [ V_4 ] ) ;
F_116 ( V_301 L_53 ) ;
}
if ( V_170 -> V_303 ) {
F_116 ( V_301 L_54 ,
...
F_116 ( V_301 L_52 , V_170 -> V_304 [ V_4 ] ) ;
F_116 ( V_301 L_53 ) ;
}
}
static int F_117 ( struct V_7 * V_8 , T_3 V_305 , int V_306 )
{
struct V_307 * V_308 ;
int V_124 = - 1 ;
if ( V_306 == V_309 ) {
V_308 = F_118 ( V_8 -> V_139 , 0 , V_305 , 0 ) ;
if ( V_308 ) {
...
static T_4 F_122 ( struct V_7 * V_8 ,
...
static void F_126 ( struct V_7 * V_8 , int V_310 )
{
struct V_307 * V_308 ;
V_308 = F_118 ( V_8 -> V_139 , 0 , V_310 , 0 ) ;
if ( V_308 ) {
F_127 ( & V_308 -> V_324 ) ;
F_120 ( V_308 ) ;
}
}
static int F_128 ( struct V_7 * V_8 , int V_310 , T_4 V_312 )
{
...
static void F_130 ( struct V_7 * V_8 , int V_310 )
{
struct V_320 * V_321 = NULL , * V_322 ;
F_21 (mv_dev, dev_next,
&mhba->shost_dev_list, list) {
...
V_312 = F_122 ( V_8 , V_310 , V_49 ) ;
if ( ! V_312 ) {
F_130 ( V_8 , V_310 ) ;
} else {
V_327 = F_128 ( V_8 , V_310 , V_312 ) ;
if ( ! V_327 ) {
F_130 ( V_8 , V_310 ) ;
...
F_124 ( & V_8 -> V_340 ) ;
do {
V_337 = F_139 ( V_335 , V_3 , V_337 + 1 ) ;
if ( V_337 >= V_3 )
break;
F_117 ( V_8 , V_337 , V_311 ) ;
} while ( 1 );
V_337 = - 1 ;
do {
V_337 = F_139 ( V_336 , V_3 , V_337 + 1 ) ;
if ( V_337 >= V_3 )
break;
F_117 ( V_8 , V_337 , V_309 ) ;
} while ( 1 );
F_125 ( & V_8 -> V_340 ) ;
}
}
static void F_140 ( struct V_7 * V_8 , V_220 V_341 , void * V_342 )
{
if ( V_341 == V_343 ) {
int V_4 , V_76 ;
...
static int F_141 ( struct V_7 * V_8 , unsigned char V_341 )
{
struct V_48 * V_49 ;
struct V_148 * V_51 ;
V_49 = F_38 ( V_8 , 512 ) ;
...
static void F_142 ( struct V_350 * V_351 )
{
struct V_352 * V_353 =
F_143 ( V_351 , struct V_352 , V_354 ) ;
F_141 ( V_353 -> V_8 , V_353 -> V_355 ) ;
F_15 ( V_353 ) ;
}
static void F_144 ( struct V_7 * V_8 , T_2 V_273 )
{
struct V_352 * V_353 ;
...
if ( V_49 -> V_31 )
F_110 ( V_8 , V_49 , V_281 ) ;
else
F_113 ( V_8 , V_49 , V_281 ) ;
}
V_8 -> V_102 -> V_141 ( V_8 , NULL ) ;
}
static T_5 F_149 ( int V_360 , void * V_361 )
{
struct V_7 * V_8 = (struct V_7 * ) V_361 ;
unsigned long V_44 ;
F_88 ( V_8 -> V_139 -> V_140 , V_44 ) ;
if ( F_54 ( V_8 -> V_102 -> V_362 ( V_8 ) || ! V_8 -> V_275 ) ) {
F_89 ( V_8 -> V_139 -> V_140 , V_44 ) ;
return V_363 ;
}
...
static enum V_365 F_150 ( struct V_7 * V_8 ,
struct V_48 * V_49 )
{
void * V_78 ;
struct V_148 * V_66 ;
...
if ( F_44 ( & V_8 -> V_375 ) || ! V_76 )
return;
do {
V_49 = F_50 ( & V_8 -> V_375 ,
struct V_48 , V_57 ) ;
F_46 ( & V_49 -> V_57 ) ;
V_282 = F_150 ( V_8 , V_49 ) ;
switch ( V_282 ) {
case V_373 :
V_374 ++ ;
break;
case V_367 :
F_152 ( & V_49 -> V_57 , & V_8 -> V_375 ) ;
if ( V_374 > 0 )
F_59 ( V_8 ) ;
return;
}
} while ( ! F_44 ( & V_8 -> V_375 ) && V_76 -- );
if ( V_374 > 0 )
F_59 ( V_8 ) ;
}
...
struct V_69 * V_70 = V_8 -> V_70 ;
F_60 ( V_70 -> V_278 , V_70 -> V_279 ) ;
V_377 = F_53 ( V_70 -> V_108 ) ;
V_377 |= V_70 -> V_280 | V_70 -> V_265 | V_70 -> V_266 ;
F_60 ( V_377 , V_70 -> V_108 ) ;
}
...
static int F_155 ( void * V_378 )
{
struct V_7 * V_8 = (struct V_7 * ) V_378 ;
unsigned int V_306 , V_273 = 0 , V_27 = 0 ;
struct V_69 * V_70 = V_8 -> V_70 ;
V_306 = F_53 ( V_70 -> V_379 ) ;
if ( ! ( V_306 & V_70 -> V_380 ) || V_306 == 0xFFFFFFFF )
return 1 ;
if ( F_54 ( V_306 & V_70 -> V_266 ) ) {
V_27 = F_53 ( V_70 -> V_381 ) ;
if ( V_8 -> V_20 -> V_128 == V_230 ) {
if ( V_27 & V_70 -> V_382 ) {
F_60 ( V_27 & V_70 -> V_382 ,
V_70 -> V_381 ) ;
}
} else {
if ( V_27 & ( V_70 -> V_383 | V_70 -> V_382 ) )
F_60 ( V_27 & ( V_70 -> V_383 |
V_70 -> V_382 ) ,
V_70 -> V_381 ) ;
}
...
V_27 = F_53 ( V_70 -> V_381 ) ;
if ( V_27 & V_70 -> V_384 )
F_60 ( V_27 & V_70 -> V_384 , V_70 -> V_381 ) ;
}
if ( V_306 & V_70 -> V_280 ) {
V_273 = F_53 ( V_70 -> V_277 ) ;
if ( V_273 )
F_60 ( V_273 , V_70 -> V_277 ) ;
}
V_8 -> V_275 = V_306 ;
V_8 -> V_273 = V_273 ;
return 0 ;
...
{
unsigned int V_306 ;
V_306 = F_53 ( V_8 -> V_70 -> V_277 ) ;
if ( V_306 )
F_60 ( V_306 , V_8 -> V_70 -> V_277 ) ;
return V_306 ;
}
...
V_287 ;
F_159 ( 0 , V_31 -> V_290 , V_394 , 0x24 ,
0 ) ;
return - 1 ;
}
static int F_160 ( struct V_395 * V_139 ,
struct V_30 * V_31 )
{
struct V_48 * V_49 ;
struct V_7 * V_8 ;
...
static enum V_399 F_162 ( struct V_30 * V_31 )
{
...
static int
F_164 ( struct V_307 * V_308 , struct V_401 * V_402 ,
T_6 V_403 , int V_404 [] )
{
int V_405 , V_406 ;
T_6 V_407 ;
...
static int F_174 ( struct V_10 * V_20 , const struct V_436 * V_310 )
{
struct V_395 * V_129 ;
struct V_7 * V_8 ;
int V_124 ;
...
if ( V_124 )
goto V_446;
V_124 = F_178 ( V_8 -> V_20 -> V_360 , F_149 , V_447 ,
L_88 , V_8 ) ;
if ( V_124 ) {
F_11 ( & V_20 -> V_11 , L_89 ) ;
goto V_448;
...
static int F_186 ( struct V_10 * V_20 , T_7 V_452 )
{
struct V_7 * V_8 = NULL ;
V_8 = F_183 ( V_20 ) ;
F_94 ( V_8 ) ;
