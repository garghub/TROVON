...
if ( ! V_72 -> V_60 . V_296 && ! V_72 -> V_32 . V_296 )
V_72 -> V_53 &= ~ V_293 ;
F_95 ( & V_36 -> V_121 ) ;
F_96 ( & V_36 -> V_121 ) ;
F_118 ( V_72 -> V_292 ) ;
...
F_113 ( V_36 ) ;
V_8 -> V_268 = NULL ;
F_120 ( & V_72 -> V_299 , V_300 ) ;
return 0 ;
}
static int F_121 ( struct V_8 * V_8 , struct V_301 * V_302 )
{
struct V_35 * V_36 = V_8 -> V_268 ;
return F_122 ( & V_36 -> V_121 , V_302 ) ;
}
static unsigned int F_123 ( struct V_8 * V_8 , T_7 * V_303 )
{
struct V_35 * V_36 = V_8 -> V_268 ;
return F_124 ( V_8 , & V_36 -> V_121 , V_303 ) ;
}
static T_8 F_125 ( struct V_8 * V_8 , char T_9 * V_304 ,
T_10 V_58 , T_11 * V_305 )
{
struct V_35 * V_36 = V_8 -> V_268 ;
return F_126 ( & V_36 -> V_121 , V_304 , V_58 , V_305 ,
0 , V_8 -> V_270 & V_271 ) ;
}
...
struct V_32 * V_33 = & V_72 -> V_32 ;
struct V_60 * V_43 = & V_72 -> V_60 ;
struct V_307 * V_308 = & V_33 -> V_205 ;
V_69 V_259 = V_239 / 62500 ;
int V_52 = - V_114 ;
F_131 ( V_308 , 4 ) ;
F_132 ( V_308 , & V_309 , V_209 ,
0 , 10000 , 1 , 100 ) ;
F_132 ( V_308 , & V_309 , V_212 ,
0 , 10000 , 1 , 100 ) ;
F_132 ( V_308 , & V_309 , V_214 ,
0 , 10000 , 1 , 100 ) ;
F_132 ( V_308 , & V_309 , V_216 ,
0 , 10000 , 1 , 100 ) ;
if ( V_308 -> error ) {
F_129 ( V_308 ) ;
return V_308 -> error ;
...
F_79 ( V_72 , & V_259 ) ;
V_33 -> V_306 = V_310 ;
V_33 -> V_306 . V_311 = & V_72 -> V_311 ;
V_33 -> V_306 . V_205 = V_308 ;
F_133 ( & V_33 -> V_306 , V_72 ) ;
V_52 = F_134 ( & V_33 -> V_306 , V_294 , - 1 ) ;
if ( V_52 != 0 )
goto V_95;
V_43 -> V_306 = V_310 ;
V_43 -> V_306 . V_311 = & V_72 -> V_311 ;
V_43 -> V_306 . V_205 = V_308 ;
F_133 ( & V_43 -> V_306 , V_72 ) ;
V_52 = F_134 ( & V_43 -> V_306 , V_26 , - 1 ) ;
if ( V_52 != 0 )
goto V_95;
log ( L_13 ) ;
return 0 ;
