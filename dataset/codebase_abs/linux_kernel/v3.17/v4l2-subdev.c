...
static int
F_42 ( struct V_139 * V_6 ,
struct V_28 * V_140 )
{
if ( F_43 ( V_6 -> V_7 ) == V_141 ) {
struct V_3 * V_4 =
F_44 ( V_6 -> V_7 ) ;
V_140 -> V_30 = V_32 ;
V_140 -> V_6 = V_6 -> V_142 ;
return F_31 ( V_4 , V_6 , V_76 , NULL , V_140 ) ;
}
F_45 ( V_6 -> V_7 -> type != V_143 ,
L_3 ,
...
if ( V_43 < 0 )
return 0 ;
V_144 = F_44 ( V_134 -> V_144 -> V_7 ) ;
V_43 = F_31 ( V_144 , V_6 , V_146 , V_134 ,
& V_135 , & V_136 ) ;
if ( V_43 != - V_56 )
return V_43 ;
return F_41 (
V_144 , V_134 , & V_135 , & V_136 ) ;
}
void F_47 ( struct V_3 * V_4 , const struct V_147 * V_148 )
{
F_48 ( & V_4 -> V_149 ) ;
F_49 ( ! V_148 ) ;
V_4 -> V_148 = V_148 ;
