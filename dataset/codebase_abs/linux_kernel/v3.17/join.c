...
static int F_55 ( struct V_1 * V_2 , T_1 * V_257 )
{
T_1 V_83 [ V_246 ] ;
int V_27 ;
if ( ! V_257 || F_56 ( V_257 ) )
...
memcpy ( V_83 , V_257 , V_246 ) ;
V_27 = F_42 ( V_2 , V_258 ,
V_220 , 0 , V_83 , true ) ;
return V_27 ;
}
int F_57 ( struct V_1 * V_2 , T_1 * V_257 )
{
int V_27 = 0 ;
if ( ! V_2 -> V_151 )
return 0 ;
...
break;
case V_199 :
return F_42 ( V_2 , V_260 ,
V_220 , 0 , NULL , true ) ;
case V_261 :
return F_42 ( V_2 , V_262 ,
V_220 , 0 , NULL , true ) ;
default:
break;
}
...
struct V_1 * V_2 ;
int V_30 ;
for ( V_30 = 0 ; V_30 < V_8 -> V_263 ; V_30 ++ ) {
V_2 = V_8 -> V_2 [ V_30 ] ;
if ( V_2 )
F_57 ( V_2 , NULL ) ;
}
