...
if ( V_76 < 0 ) {
V_76 = - V_76 ;
V_75 . V_78 = ( long ) ( F_19 ( V_76 , 10000000 ) * 100 ) ;
V_75 . V_78 = - V_75 . V_78 ;
V_75 . V_79 = - V_76 ;
} else {
V_75 . V_78 = ( long ) F_19 ( V_76 , 10000000 ) * 100 ;
...
{
return ( T_6 ) V_76 . V_79 * 10000000 + V_76 . V_78 / 100 + V_77 ;
}
struct V_73 F_21 ( T_7 V_80 , T_7 V_81 , int V_82 )
{
struct V_73 V_75 ;
...
T_9 * V_89 = ( T_9 * ) & time ;
T_10 * V_90 = ( T_10 * ) & V_88 ;
F_4 ( V_70 , L_4 , V_88 , time ) ;
V_83 = 2 * V_89 -> V_91 ;
V_84 = V_89 -> V_92 ;
if ( ( V_83 > 59 ) || ( V_84 > 59 ) )
F_4 ( V_93 , L_5 , V_84 , V_83 ) ;
V_83 += ( V_84 * 60 ) ;
V_83 += 60 * 60 * V_89 -> V_94 ;
if ( V_89 -> V_94 > 24 )
F_4 ( V_93 , L_6 , V_89 -> V_94 ) ;
V_85 = V_90 -> V_95 ;
V_86 = V_90 -> V_96 ;
if ( ( V_85 > 31 ) || ( V_86 > 12 ) ) {
F_4 ( V_93 , L_7 , V_86 , V_85 ) ;
if ( V_86 > 12 )
V_86 = 12 ;
}
V_86 -= 1 ;
