...
V_243 = V_14 -> V_164 ;
F_175 () ;
V_244 = F_193 ( V_14 , F_194 ( V_14 -> V_175 ) ) ;
F_177 () ;
V_21 = F_185 ( V_10 ) ;
if ( V_21 >= 0 ) {
F_195 ( V_10 ) ;
F_196 ( V_14 , V_243 , V_10 ) ;
F_197 ( V_245 , V_244 ) ;
F_198 ( V_14 ) ;
}
return V_21 ;
...
if ( V_181 )
goto V_256;
V_10 -> V_66 = F_47 ( V_56 , V_257 ) ;
if ( ( V_181 = V_10 -> V_66 ) < 0 )
goto V_71;
V_10 -> V_258 = F_47 ( V_246 , V_257 ) ;
if ( ( V_181 = V_10 -> V_258 ) < 0 )
goto V_71;
V_181 = F_178 ( V_10 ) ;
if ( V_181 < 0 )
goto V_71;
...
V_181 = F_51 ( V_10 -> V_258 , V_246 , V_10 ) ;
if ( V_181 < 0 )
goto V_71;
...
const char T_1 * const T_1 * V_259 )
{
struct V_55 V_56 = { . V_61 . V_58 = V_75 } ;
struct V_55 V_246 = { . V_61 . V_58 = V_259 } ;
return F_199 ( V_110 , V_56 , V_246 ) ;
}
...
void F_152 ( struct V_12 * V_13 , int V_262 )
{
unsigned long V_263 , V_260 ;
if ( F_3 ( ( unsigned ) V_262 > V_264 ) )
return;
do {
V_263 = F_18 ( V_13 -> V_183 ) ;
V_260 = ( V_263 & ~ V_265 ) | V_262 ;
} while ( F_214 ( & V_13 -> V_183 , V_263 , V_260 ) != V_263 );
}
