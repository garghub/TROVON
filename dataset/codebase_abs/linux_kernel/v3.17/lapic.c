...
if ( ! F_47 ( V_9 ) )
return 0 ;
V_77 = F_57 ( V_9 -> V_11 . V_2 ) ;
return V_77 ;
}
int F_68 ( struct V_8 * V_9 , struct V_78 * V_79 ,
unsigned long * V_80 )
{
struct V_1 * V_2 = V_9 -> V_11 . V_2 ;
return F_69 ( V_2 , V_79 -> V_81 , V_79 -> V_10 ,
V_79 -> V_82 , V_79 -> V_83 , V_80 ) ;
}
static int F_70 ( struct V_8 * V_9 , T_3 V_4 )
{
return F_71 ( V_9 -> V_19 , & V_9 -> V_11 . V_84 . V_85 , & V_4 ,
sizeof( V_4 ) ) ;
}
static int F_72 ( struct V_8 * V_9 , T_3 * V_4 )
{
return F_73 ( V_9 -> V_19 , & V_9 -> V_11 . V_84 . V_85 , V_4 ,
sizeof( * V_4 ) ) ;
}
static inline bool F_74 ( struct V_8 * V_9 )
{
return V_9 -> V_11 . V_84 . V_86 & V_87 ;
}
...
if ( F_72 ( V_9 , & V_4 ) < 0 )
F_76 ( L_1 ,
( unsigned long long ) V_9 -> V_11 . V_84 . V_86 ) ;
return V_4 & 0x1 ;
}
...
F_80 ( V_89 , & V_9 -> V_11 . V_90 ) ;
}
void F_81 ( struct V_8 * V_9 , T_1 * V_92 )
{
struct V_1 * V_2 = V_9 -> V_11 . V_2 ;
int V_23 ;
for ( V_23 = 0 ; V_23 < 8 ; V_23 ++ )
F_1 ( V_2 , V_93 + 0x10 * V_23 , V_92 [ V_23 ] ) ;
}
...
static void F_83 ( struct V_1 * V_2 , T_1 V_94 )
{
F_1 ( V_2 , V_100 , V_94 ) ;
F_82 ( V_2 ) ;
}
...
struct V_78 * V_79 , int * V_115 , unsigned long * V_80 )
{
struct V_20 * V_116 ;
unsigned long V_7 = 1 ;
struct V_1 * * V_117 ;
...
* V_115 = - 1 ;
if ( V_79 -> V_119 == V_111 ) {
* V_115 = F_68 ( V_114 -> V_9 , V_79 , V_80 ) ;
return true ;
}
if ( V_79 -> V_119 )
return false ;
...
V_79 -> V_121 == 0xff )
goto V_26;
V_117 = & V_116 -> V_37 [ V_79 -> V_121 & 0xff ] ;
} else {
T_1 V_102 = V_79 -> V_121 << ( 32 - V_116 -> V_27 ) ;
...
if ( * V_115 < 0 )
* V_115 = 0 ;
* V_115 += F_68 ( V_117 [ V_23 ] -> V_9 , V_79 , V_80 ) ;
}
V_118 = true ;
V_26:
F_93 () ;
...
static int F_69 ( struct V_1 * V_2 , int V_81 ,
int V_10 , int V_82 , int V_83 ,
unsigned long * V_80 )
{
int V_70 = 0 ;
...
struct V_78 V_79 ;
V_79 . V_10 = V_144 & V_45 ;
V_79 . V_81 = V_144 & V_53 ;
V_79 . V_108 = V_144 & V_148 ;
V_79 . V_82 = V_144 & V_149 ;
V_79 . V_83 = V_144 & V_150 ;
V_79 . V_119 = V_144 & V_151 ;
if ( F_28 ( V_2 ) )
V_79 . V_121 = V_146 ;
else
V_79 . V_121 = F_106 ( V_146 ) ;
F_107 ( V_144 , V_79 . V_121 ) ;
F_76 ( L_13
L_14
L_15 ,
V_146 , V_144 , V_79 . V_119 , V_79 . V_121 ,
V_79 . V_83 , V_79 . V_82 , V_79 . V_108 , V_79 . V_81 ,
V_79 . V_10 ) ;
F_108 ( V_2 -> V_9 -> V_19 , V_2 , & V_79 , NULL ) ;
}
...
case 2 :
case 4 :
memcpy ( V_85 , ( char * ) & V_70 + V_175 , V_174 ) ;
break;
default:
F_98 ( V_137 L_19
L_20 , V_174 ) ;
...
T_7 V_180 , int V_174 , void * V_85 )
{
struct V_1 * V_2 = F_119 ( V_179 ) ;
T_1 V_168 = V_180 - V_2 -> V_178 ;
if ( ! F_123 ( V_2 , V_180 ) )
return - V_181 ;
F_121 ( V_2 , V_168 , V_174 , V_85 ) ;
return 0 ;
}
...
T_7 V_180 , int V_174 , const void * V_85 )
{
struct V_1 * V_2 = F_119 ( V_179 ) ;
...
void F_146 ( struct V_8 * V_9 , T_6 V_85 )
{
struct V_1 * V_2 = V_9 -> V_11 . V_2 ;
if ( ! F_47 ( V_9 ) || F_42 ( V_2 ) ||
F_43 ( V_2 ) )
...
if ( ! F_47 ( V_9 ) )
return 0 ;
V_94 = ( T_6 ) F_16 ( V_9 -> V_11 . V_2 , V_100 ) ;
return ( V_94 & 0xf0 ) >> 4 ;
}
...
F_1 ( V_2 , V_93 + 0x10 * V_23 , 0 ) ;
}
V_2 -> V_69 = F_60 ( V_9 -> V_19 ) ;
V_2 -> V_75 = F_60 ( V_9 -> V_19 ) ;
V_2 -> V_76 = - 1 ;
F_125 ( V_2 ) ;
F_127 ( & V_2 -> V_47 . V_187 , 0 ) ;
if ( F_150 ( V_9 ) )
...
V_228 = V_63 & V_53 ;
V_83 = V_63 & V_229 ;
return F_69 ( V_2 , V_228 , V_10 , 1 , V_83 ,
NULL ) ;
}
return 0 ;
}
...
static enum V_230 F_158 ( struct V_231 * V_85 )
{
struct V_232 * V_233 = F_120 ( V_85 , struct V_232 , V_157 ) ;
struct V_1 * V_2 = F_120 ( V_233 , struct V_1 , V_47 ) ;
struct V_8 * V_9 = V_2 -> V_9 ;
T_8 * V_234 = & V_9 -> V_235 ;
if ( ! F_155 ( & V_233 -> V_187 ) ) {
F_159 ( & V_233 -> V_187 ) ;
F_61 ( V_236 , V_9 ) ;
}
if ( F_160 ( V_234 ) )
...
V_2 -> V_9 = V_9 ;
F_165 ( & V_2 -> V_47 . V_157 , V_241 ,
V_192 ) ;
V_2 -> V_47 . V_157 . V_242 = F_158 ;
V_9 -> V_11 . V_217 = V_218 ;
F_149 ( V_9 ,
V_243 | V_218 ) ;
F_18 ( & V_16 . V_17 ) ;
F_151 ( V_9 ) ;
F_166 ( & V_2 -> V_173 , & V_244 ) ;
return 0 ;
V_240:
F_144 ( V_2 ) ;
V_239:
...
V_77 = F_57 ( V_2 ) ;
if ( ( V_77 == - 1 ) ||
( ( V_77 & 0xF0 ) <= F_16 ( V_2 , V_99 ) ) )
return - 1 ;
return V_77 ;
}
int F_168 ( struct V_8 * V_9 )
{
T_1 V_246 = F_16 ( V_9 -> V_11 . V_2 , V_204 ) ;
int V_115 = 0 ;
...
{
T_1 V_85 ;
if ( F_3 ( V_89 , & V_9 -> V_11 . V_90 ) )
F_176 ( V_9 , V_9 -> V_11 . V_2 ) ;
if ( ! F_3 ( V_249 , & V_9 -> V_11 . V_90 ) )
return;
F_73 ( V_9 -> V_19 , & V_9 -> V_11 . V_2 -> V_250 , & V_85 ,
sizeof( T_1 ) ) ;
F_83 ( V_9 -> V_11 . V_2 , V_85 & 0xff ) ;
}
...
if ( V_252 < 0 )
V_252 = 0 ;
V_85 = ( V_94 & 0xff ) | ( ( V_252 & 0xf0 ) << 8 ) | ( V_251 << 24 ) ;
F_71 ( V_9 -> V_19 , & V_9 -> V_11 . V_2 -> V_250 , & V_85 ,
sizeof( T_1 ) ) ;
}
int F_181 ( struct V_8 * V_9 , T_7 V_253 )
{
if ( V_253 ) {
if ( F_182 ( V_9 -> V_19 ,
& V_9 -> V_11 . V_2 -> V_250 ,
V_253 , sizeof( T_1 ) ) )
return - V_254 ;
F_78 ( V_249 , & V_9 -> V_11 . V_90 ) ;
} else {
F_80 ( V_249 , & V_9 -> V_11 . V_90 ) ;
}
V_9 -> V_11 . V_2 -> V_253 = V_253 ;
return 0 ;
}
int F_183 ( struct V_8 * V_9 , T_1 V_255 , T_6 V_85 )
{
struct V_1 * V_2 = V_9 -> V_11 . V_2 ;
T_1 V_63 = ( V_255 - V_256 ) << 4 ;
if ( ! F_184 ( V_9 -> V_19 ) || ! F_28 ( V_2 ) )
return 1 ;
if ( V_255 == 0x830 )
F_136 ( V_2 , V_147 , ( T_1 ) ( V_85 >> 32 ) ) ;
return F_136 ( V_2 , V_63 , ( T_1 ) V_85 ) ;
}
int F_185 ( struct V_8 * V_9 , T_1 V_255 , T_6 * V_85 )
{
struct V_1 * V_2 = V_9 -> V_11 . V_2 ;
T_1 V_63 = ( V_255 - V_256 ) << 4 , V_257 , V_258 = 0 ;
if ( ! F_184 ( V_9 -> V_19 ) || ! F_28 ( V_2 ) )
return 1 ;
if ( F_121 ( V_2 , V_63 , 4 , & V_257 ) )
return 1 ;
if ( V_255 == 0x830 )
F_121 ( V_2 , V_147 , 4 , & V_258 ) ;
* V_85 = ( ( ( T_6 ) V_258 ) << 32 ) | V_257 ;
return 0 ;
}
int F_186 ( struct V_8 * V_9 , T_1 V_63 , T_6 V_85 )
{
struct V_1 * V_2 = V_9 -> V_11 . V_2 ;
if ( ! F_47 ( V_9 ) )
return 1 ;
...
int F_187 ( struct V_8 * V_9 , T_1 V_63 , T_6 * V_85 )
{
struct V_1 * V_2 = V_9 -> V_11 . V_2 ;
T_1 V_257 , V_258 = 0 ;
if ( ! F_47 ( V_9 ) )
...
int F_188 ( struct V_8 * V_9 , T_6 V_85 )
{
T_6 V_177 = V_85 & ~ V_87 ;
if ( ! F_189 ( V_177 , 4 ) )
return 1 ;
V_9 -> V_11 . V_84 . V_86 = V_85 ;
if ( ! F_74 ( V_9 ) )
return 0 ;
return F_182 ( V_9 -> V_19 , & V_9 -> V_11 . V_84 . V_85 ,
V_177 , sizeof( T_3 ) ) ;
}
...
return;
V_259 = F_54 ( & V_2 -> V_131 , 0 ) ;
if ( F_3 ( V_132 , & V_259 ) ) {
F_151 ( V_9 ) ;
F_191 ( V_9 ) ;
if ( F_150 ( V_2 -> V_9 ) )
V_9 -> V_11 . V_260 = V_261 ;
else
V_9 -> V_11 . V_260 = V_262 ;
}
if ( F_3 ( V_135 , & V_259 ) &&
V_9 -> V_11 . V_260 == V_262 ) {
F_192 () ;
