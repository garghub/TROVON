...
static inline struct V_89 * F_46 ( struct V_239 * V_240 )
{
return F_47 ( V_240 , struct V_89 , V_239 ) ;
}
...
static int F_50 ( struct V_239 * V_240 , unsigned V_241 )
{
struct V_89 * V_90 = F_46 ( V_240 ) ;
unsigned int V_3 ;
...
static int F_51 ( struct V_239 * V_240 ,
...
static void F_52 ( struct V_239 * V_240 , unsigned V_241 , int V_111 )
{
struct V_89 * V_90 = F_46 ( V_240 ) ;
...
struct V_252 * V_253 )
{
struct V_260 * V_260 = F_60 ( V_259 -> V_225 ) ;
if ( ! V_260 ) {
F_36 ( & V_259 -> V_2 , L_24 ,
V_259 -> V_225 ) ;
return - V_122 ;
...
T_3 V_268 ;
int V_100 ;
if ( F_63 ( V_266 , L_25 , & V_268 ) >= 0 )
V_253 -> V_269 = V_268 ;
if ( F_63 ( V_266 , L_26 , & V_268 ) >= 0 )
V_253 -> V_270 = V_268 ;
if ( F_64 ( V_266 , L_27 , V_253 -> V_271 ,
F_12 ( V_253 -> V_271 ) ) >= 0 ) {
...
static int F_65 ( struct V_258 * V_259 ,
const struct V_273 * V_274 )
{
struct V_252 * V_253 = F_66 ( & V_259 -> V_2 ) ;
struct V_89 * V_90 ;
int V_275 ;
bool V_276 = false ;
unsigned int V_101 , V_277 ;
int V_110 , V_100 ;
V_90 = F_67 ( & V_259 -> V_2 , sizeof( struct V_89 ) ,
V_278 ) ;
if ( V_90 == NULL )
return - V_279 ;
V_90 -> V_2 = & V_259 -> V_2 ;
V_90 -> V_231 = F_68 ( V_259 , & V_280 ) ;
if ( F_69 ( V_90 -> V_231 ) ) {
V_110 = F_70 ( V_90 -> V_231 ) ;
F_36 ( & V_259 -> V_2 , L_29 ,
V_110 ) ;
return V_110 ;
}
...
if ( V_110 != 0 ) {
F_36 ( & V_259 -> V_2 , L_31 , V_110 ) ;
goto V_281;
}
if ( V_101 != 0x8903 ) {
F_36 ( & V_259 -> V_2 , L_32 , V_101 ) ;
V_110 = - V_282 ;
goto V_281;
}
V_110 = F_35 ( V_90 -> V_231 , V_5 , & V_101 ) ;
if ( V_110 != 0 ) {
F_36 ( & V_259 -> V_2 , L_33 , V_110 ) ;
goto V_281;
}
F_72 ( & V_259 -> V_2 , L_34 ,
( V_101 & V_283 ) + 'A' ) ;
F_73 ( V_90 -> V_231 , V_4 , 0x8903 ) ;
F_53 ( V_90 ) ;
for ( V_100 = 0 ; V_100 < F_12 ( V_253 -> V_271 ) ; V_100 ++ ) {
if ( ( ! V_253 -> V_271 [ V_100 ] ) ||
( V_253 -> V_271 [ V_100 ] > V_272 ) )
continue;
F_73 ( V_90 -> V_231 , V_70 + V_100 ,
...
V_287 , V_277 ) ;
V_110 = F_74 ( V_259 -> V_225 , NULL , F_34 ,
V_275 | V_289 ,
L_35 , V_90 ) ;
if ( V_110 != 0 ) {
F_36 ( V_90 -> V_2 , L_36 ,
...
static int F_76 ( struct V_258 * V_299 )
{
struct V_89 * V_90 = F_77 ( V_299 ) ;
if ( V_299 -> V_225 )
F_78 ( V_299 -> V_225 , V_90 ) ;
F_55 ( V_90 ) ;
F_79 ( & V_299 -> V_2 ) ;
return 0 ;
}
