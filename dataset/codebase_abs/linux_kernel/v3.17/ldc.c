...
{
if ( V_8 -> V_54 & V_159 ) {
F_71 ( V_8 -> V_22 . V_143 , V_8 ) ;
F_71 ( V_8 -> V_22 . V_144 , V_8 ) ;
}
if ( V_8 -> V_54 & V_160 ) {
F_27 ( V_8 -> V_34 , 0 , 0 ) ;
F_30 ( V_8 -> V_34 , 0 , 0 ) ;
...
int F_73 ( struct V_7 * V_8 , const char * V_108 )
{
...
( V_8 -> V_1 != V_3 ) )
return - V_36 ;
snprintf ( V_8 -> V_161 , V_162 , L_34 , V_108 ) ;
snprintf ( V_8 -> V_163 , V_162 , L_35 , V_108 ) ;
V_33 = F_74 ( V_8 -> V_22 . V_143 , F_46 , 0 ,
V_8 -> V_161 , V_8 ) ;
if ( V_33 )
return V_33 ;
V_33 = F_74 ( V_8 -> V_22 . V_144 , F_49 , 0 ,
V_8 -> V_163 , V_8 ) ;
if ( V_33 ) {
F_71 ( V_8 -> V_22 . V_143 , V_8 ) ;
return V_33 ;
...
static int F_79 ( struct V_7 * V_8 , const void * V_167 , unsigned int V_26 )
{
struct V_15 * V_17 ;
unsigned long V_16 ;
int V_33 ;
...
static int F_80 ( struct V_7 * V_8 , void * V_167 , unsigned int V_26 )
{
struct V_15 * V_17 ;
...
static int F_81 ( struct V_7 * V_8 , const void * V_167 ,
unsigned int V_26 )
{
...
static int F_85 ( struct V_7 * V_8 , unsigned long V_181 )
{
unsigned long V_182 ;
int V_27 = 1000 ;
F_3 ( V_179 , L_37 ,
...
static int F_89 ( struct V_7 * V_8 , void * V_167 , unsigned int V_26 )
{
struct V_15 * V_180 ;
unsigned long V_70 , V_102 ;
int V_33 , V_172 ;
...
static int F_90 ( struct V_7 * V_8 , const void * V_167 ,
unsigned int V_26 )
{
if ( V_26 > V_8 -> V_22 . V_148 )
V_26 = V_8 -> V_22 . V_148 ;
return F_81 ( V_8 , V_167 , V_26 ) ;
}
static int F_91 ( struct V_7 * V_8 , void * V_167 , unsigned int V_26 )
{
if ( ! V_8 -> V_185 ) {
int V_33 = F_89 ( V_8 , V_8 -> V_135 , V_8 -> V_22 . V_148 ) ;
if ( V_33 < 0 )
return V_33 ;
V_8 -> V_185 = V_33 ;
V_8 -> V_186 = 0 ;
...
int F_92 ( struct V_7 * V_8 , const void * V_167 , unsigned int V_26 )
{
unsigned long V_54 ;
int V_33 ;
if ( ! V_167 )
...
int F_93 ( struct V_7 * V_8 , void * V_167 , unsigned int V_26 )
{
unsigned long V_54 ;
int V_33 ;
if ( ! V_167 )
...
static long F_94 ( struct V_119 * V_120 , unsigned long V_190 )
{
...
V_195 = 0 ;
V_197:
V_192 = F_95 ( V_124 -> V_125 , V_27 , V_193 , V_190 , 0 ) ;
V_194 = V_192 + V_190 ;
if ( F_82 ( V_194 >= V_27 ) ) {
if ( F_88 ( V_195 < 1 ) ) {
V_27 = V_193 ;
...
static T_5 F_98 ( T_5 V_198 , T_5 V_199 , T_5 V_200 )
{
return ( ( V_199 << V_201 ) |
( V_198 << V_202 ) |
V_200 ) ;
}
static T_5 F_99 ( T_5 V_203 , unsigned long * V_204 )
{
...
static struct V_121 * F_100 ( struct V_119 * V_120 ,
unsigned long V_190 )
{
long V_207 ;
V_207 = F_94 ( V_120 , V_190 ) ;
if ( F_82 ( V_207 < 0 ) )
return NULL ;
return V_120 -> V_127 + V_207 ;
}
static T_5 F_101 ( unsigned int V_208 )
{
T_5 V_209 ;
V_209 = F_97 () ;
if ( V_208 & V_210 ) {
...
static int F_102 ( unsigned long V_109 , long V_223 )
{
int V_224 = 0 ;
do {
...
static void F_103 ( struct V_226 * V_227 , unsigned long V_228 ,
...
{
unsigned long V_109 = F_105 ( F_106 ( V_239 ) ) << V_202 ;
long V_223 = V_239 -> V_240 ;
if ( ( V_239 -> V_241 | V_223 ) & ( 8UL - 1 ) )
return - V_242 ;
return F_102 ( V_109 + V_239 -> V_241 , V_223 ) ;
}
static int F_107 ( struct V_238 * V_239 , int V_243 )
{
int V_224 ;
int V_78 ;
V_224 = 0 ;
for ( V_78 = 0 ; V_78 < V_243 ; V_78 ++ ) {
int V_33 = F_104 ( V_239 + V_78 ) ;
if ( V_33 < 0 )
return V_33 ;
V_224 += V_33 ;
}
...
V_109 = F_100 ( V_120 , V_190 ) ;
F_48 ( & V_120 -> V_96 , V_54 ) ;
if ( ! V_109 )
return - V_114 ;
V_1 . V_127 = V_120 -> V_127 ;
V_1 . V_234 = V_234 ;
V_1 . V_209 = F_101 ( V_208 ) ;
V_1 . V_233 = ~ ( T_5 ) 0 ;
V_1 . V_231 = ( V_109 - V_120 -> V_127 ) ;
V_1 . V_235 = 0 ;
for ( V_78 = 0 ; V_78 < V_243 ; V_78 ++ )
F_103 ( & V_1 , F_105 ( F_106 ( & V_239 [ V_78 ] ) ) << V_202 ,
...
V_1 . V_231 = ( V_109 - V_120 -> V_127 ) ;
V_1 . V_235 = 0 ;
F_103 ( & V_1 , ( V_228 & V_225 ) , ( V_228 & ~ V_225 ) , V_223 ) ;
F_17 ( V_1 . V_235 != 1 ) ;
return V_1 . V_235 ;
}
static void F_110 ( unsigned long V_34 , struct V_119 * V_120 ,
T_5 V_203 , T_5 V_26 )
{
struct V_191 * V_124 = & V_120 -> V_124 ;
unsigned long V_78 , V_204 , V_198 , V_190 ;
struct V_121 * V_109 ;
V_190 = F_111 ( ( ( V_203 & ~ V_225 ) + V_26 ) ) >> V_202 ;
V_198 = F_99 ( V_203 , & V_204 ) ;
V_109 = V_120 -> V_127 + V_198 ;
F_17 ( V_198 > V_124 -> V_27 ||
( V_198 + V_190 ) > V_124 -> V_27 ) ;
for ( V_78 = 0 ; V_78 < V_190 ; V_78 ++ ) {
if ( V_109 -> V_203 )
F_112 ( V_34 , V_203 + ( V_78 << V_204 ) ,
V_109 -> V_203 ) ;
V_109 -> V_232 = 0 ;
F_113 ( V_198 + V_78 , V_124 -> V_125 ) ;
}
}
void F_114 ( struct V_7 * V_8 , struct V_244 * V_234 ,
int V_245 )
{
struct V_119 * V_120 = & V_8 -> V_120 ;
unsigned long V_54 ;
...
F_110 ( V_8 -> V_34 , V_120 , V_247 , V_26 ) ;
}
F_48 ( & V_120 -> V_96 , V_54 ) ;
}
int F_115 ( struct V_7 * V_8 , int V_248 ,
...
void * F_117 ( struct V_7 * V_8 , unsigned int V_223 ,
struct V_244 * V_234 , int * V_245 ,
unsigned int V_208 )
{
void * V_167 ;
...
if ( ! V_167 )
return F_69 ( - V_114 ) ;
V_33 = F_109 ( V_8 , V_167 , V_223 , V_234 , * V_245 , V_208 ) ;
if ( V_33 < 0 ) {
F_62 ( V_167 ) ;
return F_69 ( V_33 ) ;
}
...
void F_118 ( struct V_7 * V_8 , void * V_167 , unsigned int V_223 ,
struct V_244 * V_234 , int V_245 )
{
F_114 ( V_8 , V_234 , V_245 ) ;
F_62 ( V_167 ) ;
}
...
if ( ! V_257 )
return - V_136 ;
V_258 = F_121 ( V_257 , V_259 , L_49 ) ;
V_33 = - V_136 ;
if ( V_258 == V_259 )
goto V_100;
V_79 = F_122 ( V_257 , V_258 , L_50 , NULL ) ;
if ( ! V_79 )
goto V_100;
V_50 = 1 ;
V_51 = 0 ;
if ( F_123 ( V_260 , V_50 , & V_51 ) ) {
