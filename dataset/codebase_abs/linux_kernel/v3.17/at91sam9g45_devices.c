...
void T_1 F_47 ( T_2 V_215 ) {}
static inline void F_48 ( unsigned V_223 )
{
if ( V_223 & V_224 )
F_12 ( V_225 , 1 ) ;
if ( V_223 & V_226 )
...
static inline void F_49 ( unsigned V_223 )
{
if ( V_223 & V_224 )
F_12 ( V_235 , 1 ) ;
if ( V_223 & V_226 )
...
void T_1 F_50 ( unsigned V_241 , unsigned V_223 )
{
struct V_242 * V_243 ;
switch ( V_241 ) {
case V_244 :
...
static inline void F_52 ( unsigned V_223 )
{
F_12 ( V_250 , 1 ) ;
F_12 ( V_251 , 0 ) ;
if ( V_223 & V_252 )
...
static inline void F_53 ( unsigned V_223 )
{
F_12 ( V_255 , 1 ) ;
F_12 ( V_256 , 0 ) ;
if ( V_223 & V_252 )
...
static inline void F_54 ( unsigned V_223 )
{
F_12 ( V_259 , 1 ) ;
F_12 ( V_260 , 0 ) ;
if ( V_223 & V_252 )
...
static inline void F_55 ( unsigned V_223 )
{
F_12 ( V_144 , 1 ) ;
F_12 ( V_145 , 0 ) ;
if ( V_223 & V_252 )
...
void T_1 F_56 ( unsigned V_241 , unsigned V_263 , unsigned V_223 )
{
struct V_242 * V_243 ;
struct V_264 * V_15 ;
switch ( V_241 ) {
...
V_51 = & V_53 . V_280 ;
V_51 -> V_56 = & V_1 . V_57 ;
V_51 -> V_58 = V_281 | V_60 |
F_17 ( V_282 ) ;
V_51 = & V_53 . V_283 ;
V_51 -> V_56 = & V_1 . V_57 ;
V_51 -> V_58 = V_281 | V_61 |
F_18 ( V_284 ) ;
V_285 . V_64 = & V_53 ;
F_2 ( & V_286 ) ;
}
