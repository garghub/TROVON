...
V_4 -> V_127 = V_127 ;
V_4 -> V_128 = V_128 ;
F_97 ( V_116 , L_28 , type -> V_75 ) ;
V_131 = F_100 ( V_129 , V_130 ) ;
V_131 = F_100 ( V_131 , V_127 ) ;
V_131 = F_100 ( V_131 , V_128 ) ;
V_131 = F_100 ( V_131 , ( int ) V_4 -> V_11 ) ;
V_4 -> V_22 = V_131 ;
F_7 ( V_116 , L_29 , V_131 ) ;
...
V_120 = V_124 [ V_12 ] ;
V_5 = V_4 -> V_5 [ V_12 ] ;
V_126 = F_105 ( int , V_4 -> type -> V_157 ,
F_106 ( V_120 ) ) ;
V_5 -> V_157 = V_126 ;
V_5 -> V_158 = V_120 -> V_159 ;
for ( V_13 = 0 ; V_13 < F_63 ( V_5 -> V_90 ) ; ++ V_13 ) {
F_107 ( V_13 , & V_5 -> V_160 ) ;
V_5 -> V_90 [ V_13 ] = F_108 ( 0 , V_17 ) ;
if ( ! V_5 -> V_90 [ V_13 ] )
goto V_151;
V_5 -> V_95 [ V_13 ] = F_109 ( V_126 ,
V_17 ) ;
if ( ! V_5 -> V_95 [ V_13 ] )
goto V_151;
F_110 ( V_5 -> V_90 [ V_13 ] , V_15 ,
F_111 ( V_15 ,
V_120 -> V_159 ) ,
V_5 -> V_95 [ V_13 ] , V_126 ,
V_4 -> type -> V_161 ,
...
V_120 = V_125 [ V_12 ] ;
V_5 = V_4 -> V_5 [ V_12 ] ;
if ( F_112 ( & V_5 -> V_97 , V_164 , V_17 ) )
goto V_151;
V_126 = F_105 ( int , V_4 -> type -> V_165 ,
F_106 ( V_120 ) ) ;
V_5 -> V_165 = V_126 ;
V_5 -> V_166 = V_120 -> V_159 ;
for ( V_13 = 0 ; V_13 < F_63 ( V_5 -> V_91 ) ; ++ V_13 ) {
F_107 ( V_13 , & V_5 -> V_167 ) ;
V_5 -> V_91 [ V_13 ] = F_108 ( 0 , V_17 ) ;
if ( ! V_5 -> V_91 [ V_13 ] )
goto V_151;
V_5 -> V_96 [ V_13 ] = F_109 ( V_126 ,
V_17 ) ;
if ( ! V_5 -> V_96 [ V_13 ] )
goto V_151;
F_110 ( V_5 -> V_91 [ V_13 ] , V_15 ,
F_113 ( V_15 ,
V_120 -> V_159 ) ,
V_5 -> V_96 [ V_13 ] , V_126 ,
V_4 -> type -> V_168 ,
...
V_120 = V_121 [ V_12 ] ;
V_5 = V_4 -> V_5 [ V_12 ] ;
V_5 -> V_92 = F_108 ( 0 , V_17 ) ;
if ( ! V_5 -> V_92 )
goto V_151;
V_126 = F_106 ( V_120 ) ;
V_5 -> V_172 =
V_120 -> V_159 ;
V_5 -> V_98 = F_109 ( V_126 ,
V_17 ) ;
if ( ! V_5 -> V_98 )
goto V_151;
F_114 ( V_5 -> V_92 , V_15 ,
...
for ( V_12 = 0 ; V_12 < V_11 ; ++ V_12 ) {
V_5 = V_4 -> V_5 [ V_12 ] ;
F_118 ( & V_5 -> V_15 , L_33 , V_5 -> V_2 ) ;
F_7 ( V_116 , L_34 , F_119 ( & V_5 -> V_15 ) ) ;
F_120 ( & V_5 -> V_15 ) ;
V_29 = F_121 ( & V_5 -> V_15 ) ;
if ( V_29 )
F_91 ( V_116 , L_35 ) ;
...
static void F_123 ( struct V_101 * V_14 )
{
int V_12 ;
struct V_3 * V_4 = F_124 ( V_14 ) ;
...
int F_133 ( struct V_101 * V_103 , T_1 V_180 )
{
struct V_3 * V_4 = F_124 ( V_103 ) ;
int V_12 , V_181 = 0 ;
V_4 -> V_182 = 1 ;
if ( V_4 -> type -> V_183 ) {
...
static int F_137 ( struct V_101 * V_103 )
{
struct V_3 * V_4 = F_124 ( V_103 ) ;
int V_185 ;
F_134 ( V_4 ) ;
...
static void F_153 ( struct V_42 * V_94 )
{
F_154 ( V_94 , V_39 ) ;
F_154 ( V_94 , V_51 ) ;
F_154 ( V_94 , V_44 ) ;
...
static int F_155 ( struct V_42 * V_24 )
{
int V_29 ;
if ( F_156 () )
return - V_30 ;
...
F_153 ( V_24 ) ;
F_2 ( & V_6 ) ;
F_158 ( & V_24 -> V_220 , & V_221 ) ;
V_29 = F_159 ( V_24 ) ;
if ( V_29 ) {
F_141 ( L_45 , V_29 , V_24 -> V_75 ) ;
F_160 ( & V_24 -> V_220 ) ;
} else {
F_161 ( L_46 , V_24 -> V_75 ) ;
}
F_4 ( & V_6 ) ;
return V_29 ;
}
static void F_162 ( struct V_42 * V_94 )
{
F_161 ( L_47 , V_94 -> V_75 ) ;
F_2 ( & V_6 ) ;
F_160 ( & V_94 -> V_220 ) ;
F_4 ( & V_6 ) ;
F_163 ( V_94 ) ;
}
int F_164 ( struct V_42 * const V_222 [] ,
const char * V_194 ,
...
void F_166 ( struct V_42 * const V_222 [] )
{
