...
unsigned int V_28 [] , unsigned long V_29 [] , struct V_30 * V_31 [] )
{
unsigned long V_32 = 0 ;
unsigned long V_33 = V_34 | V_35 ;
unsigned int V_4 , V_6 , V_36 , V_13 , V_20 ;
unsigned int V_37 = 0 ;
int V_16 ;
...
if ( V_4 <= 3 ) {
V_32 |= ( unsigned long ) V_6
<< ( V_40 - 4 * V_4 ) ;
V_32 |= ( unsigned long ) V_36
<< ( V_41 - V_4 ) ;
V_32 |= V_20 << F_8 ( V_4 ) ;
if ( V_6 == 6 )
