...
T_10 V_102 ;
V_102 = 0 ;
while ( ( V_41 = F_73 ( V_3 , V_102 , V_84 ) ) ) {
V_102 = V_41 -> V_94 + 1 ;
...
V_102 = 0 ;
V_87 = 0 ;
while ( ( V_41 = F_73 ( V_3 , V_102 , V_103 ) ) ) {
...
if ( ! V_91 [ V_93 ] )
continue;
error = F_86 ( V_91 [ V_93 ] , V_41 , V_42 ) ;
if ( error && V_86 != - V_83 )
V_86 = error ;
}
* V_121 -= V_92 ;
...
F_74 ( V_3 ) ;
F_104 ( V_3 -> V_127 ) ;
return F_99 ( V_3 , V_107 | V_116 , & V_121 ) ;
}
int
F_105 (
struct V_2 * V_3 )
...
! F_107 ( F_4 ( V_5 ) -> V_133 , V_130 -> V_134 ) )
return 0 ;
if ( ( V_130 -> V_131 & V_135 ) &&
! F_108 ( F_4 ( V_5 ) -> V_136 , V_130 -> V_137 ) )
return 0 ;
if ( ( V_130 -> V_131 & V_138 ) &&
F_109 ( V_5 ) != V_130 -> V_139 )
return 0 ;
return 1 ;
}
STATIC int
...
bool V_141 = true ;
int V_142 ;
ASSERT ( ! V_130 || ( V_130 && V_130 -> V_143 != 0 ) ) ;
if ( ! F_112 ( V_5 , false ) ) {
F_113 ( V_5 ) ;
F_114 ( V_5 ) ;
return 0 ;
...
if ( ! ( V_42 & V_116 ) &&
F_115 ( F_4 ( V_5 ) -> V_144 , V_145 ) )
return 0 ;
if ( V_130 ) {
if ( V_130 -> V_131 & V_146 )
V_142 = F_110 ( V_5 , V_130 ) ;
else
V_142 = F_106 ( V_5 , V_130 ) ;
if ( ! V_142 )
return 0 ;
if ( V_130 -> V_131 & V_147 &&
F_116 ( V_5 ) < V_130 -> V_148 )
return 0 ;
if ( V_130 -> V_143 == V_5 -> V_11 )
V_141 = false ;
}
V_140 = F_117 ( V_5 -> V_14 , V_5 , V_141 ) ;
...
{
int V_42 = V_107 ;
if ( V_130 && ( V_130 -> V_131 & V_149 ) )
V_42 = V_116 ;
return F_72 ( V_3 , F_111 , V_42 ,
V_130 , V_96 ) ;
}
int
F_118 (
...
struct V_151 * V_152 ;
ASSERT ( F_119 ( V_5 , V_74 ) ) ;
V_130 . V_143 = V_5 -> V_11 ;
V_130 . V_131 = V_146 | V_149 ;
if ( F_120 ( V_5 -> V_14 ) ) {
V_152 = F_121 ( V_5 , V_153 ) ;
if ( V_152 && F_122 ( V_152 ) ) {
V_130 . V_134 = F_4 ( V_5 ) -> V_133 ;
V_130 . V_131 |= V_132 ;
V_150 = 1 ;
}
}
if ( F_123 ( V_5 -> V_14 ) ) {
V_152 = F_121 ( V_5 , V_154 ) ;
if ( V_152 && F_122 ( V_152 ) ) {
V_130 . V_137 = F_4 ( V_5 ) -> V_136 ;
V_130 . V_131 |= V_135 ;
V_150 = 1 ;
}
}
