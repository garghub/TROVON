...
struct V_46 * V_51 = V_13 -> V_73 [ V_9 ] ;
F_46 ( & V_51 -> V_59 -> V_77 , V_18 ) ;
}
F_5 ( & V_15 -> V_22 ) ;
for ( V_9 = 0 ; V_9 < V_13 -> V_69 ; ++ V_9 ) {
struct V_46 * V_51 = V_13 -> V_73 [ V_9 ] ;
...
static void V_56 ( struct V_78 * V_78 )
{
struct V_46 * V_51 = F_47 ( V_78 , struct V_46 , V_24 ) ;
F_46 ( & V_51 -> V_59 -> V_55 ,
V_51 -> V_54 >> V_19 ) ;
F_20 ( V_51 ) ;
}
static void V_42 ( struct V_78 * V_78 )
{
struct V_35 * V_36 = F_47 ( V_78 , struct V_35 ,
V_24 ) ;
F_20 ( V_36 ) ;
}
...
F_48 ( & V_36 -> V_41 ) ;
F_3 ( & V_13 -> V_25 ) ;
F_49 ( & V_29 -> V_17 , & V_13 -> V_26 ) ;
F_5 ( & V_13 -> V_25 ) ;
return 0 ;
}
static void F_50 ( struct V_46 * V_51 , int V_25 )
{
int V_9 ;
unsigned long V_18 = V_51 -> V_54 >> V_19 ;
for ( V_9 = 0 ; V_9 < V_51 -> V_63 ; ++ V_9 ) {
struct V_46 * V_79 ;
V_79 = F_4 ( & V_51 -> V_61 [ V_9 ] -> V_55 , V_18 ) ;
if ( V_79 && V_79 -> V_59 != V_51 -> V_59 )
V_79 -> V_58 = V_25 ;
}
}
static int F_51 ( struct V_20 * V_47 )
{
struct V_46 * V_80 = NULL ;
...
V_45 = F_30 ( & V_47 -> V_77 , ( void * * ) & V_13 ,
V_47 -> V_85 >> V_19 , 1 ) ;
if ( V_45 == 0 || V_13 -> V_48 >= V_47 -> V_84 -> V_54 ) {
V_45 = F_51 ( V_47 ) ;
if ( ! V_45 ) {
F_5 ( & V_15 -> V_22 ) ;
return 0 ;
...
V_47 -> V_85 = V_13 -> V_48 + V_13 -> V_67 ;
V_13 -> V_24 ++ ;
F_5 ( & V_15 -> V_22 ) ;
for ( V_9 = 0 ; V_9 < V_13 -> V_69 ; ++ V_9 ) {
if ( V_13 -> V_73 [ V_9 ] -> V_59 == V_47 ) {
V_86 = V_9 + 1 ;
break;
}
}
...
return 0 ;
F_48 ( & V_47 -> V_44 ) ;
V_45 = F_53 ( V_15 -> V_88 , V_48 , V_67 ,
V_86 , & V_4 ) ;
if ( V_45 )
F_1 ( V_15 -> V_88 , NULL , V_48 , V_45 ) ;
else if ( V_4 )
F_1 ( V_15 -> V_88 , V_4 , V_4 -> V_5 , V_45 ) ;
if ( V_4 )
F_54 ( V_4 ) ;
return 1 ;
}
static void F_55 ( struct V_89 * V_90 )
{
struct V_91 * V_92 ;
struct V_14 * V_15 ;
int V_93 ;
V_92 = F_47 ( V_90 , struct V_91 , V_90 ) ;
V_15 = V_92 -> V_15 ;
F_20 ( V_92 ) ;
V_93 = F_56 ( F_57 ( V_94 ) ,
F_58 ( V_94 ) ) ;
...
{
struct V_91 * V_92 ;
V_92 = F_33 ( sizeof( * V_92 ) , V_57 ) ;
if ( ! V_92 ) {
F_62 () ;
}
F_63 ( & V_92 -> V_90 , V_101 ,
F_55 , NULL , NULL ) ;
V_92 -> V_15 = V_15 ;
F_64 ( V_15 -> V_102 , & V_92 -> V_90 ) ;
}
static void F_65 ( struct V_14 * V_15 , int V_103 )
{
struct V_20 * V_59 ;
struct V_96 * V_97 = V_15 -> V_97 ;
unsigned long V_18 ;
...
V_51 -> V_58 ) ;
for ( V_104 = 0 ; V_104 < V_51 -> V_63 ; ++ V_104 ) {
F_66 ( V_108 L_6 ,
V_51 -> V_61 [ V_104 ] -> V_107 ) ;
}
if ( V_59 -> V_84 == V_51 )
F_66 ( V_108 L_7 ,
V_59 -> V_85 - V_51 -> V_5 ) ;
...
V_13 -> V_73 [ V_9 ] -> V_5 ,
V_13 -> V_73 [ V_9 ] -> V_54 ) ;
for ( V_104 = 0 ; V_104 < V_13 -> V_73 [ V_9 ] -> V_63 ; ++ V_104 ) {
F_66 ( V_108 L_6 ,
V_13 -> V_73 [ V_9 ] -> V_61 [ V_104 ] -> V_107 ) ;
}
}
F_66 ( V_108 L_8 ) ;
...
struct V_35 * F_67 ( struct V_1 * V_2 ,
...
V_11 = F_8 ( V_109 ) ;
F_54 ( V_109 ) ;
if ( F_16 ( V_36 , V_5 , & V_110 , V_7 , V_11 ) ) {
F_20 ( V_36 ) ;
return F_68 ( - V_112 ) ;
}
F_28 ( V_2 -> V_15 ) ;
...
int F_72 ( void * V_113 )
{
struct V_35 * V_36 = V_113 ;
while ( F_61 ( & V_36 -> V_41 ) ) {
F_73 ( V_36 -> V_43 , F_61 ( & V_36 -> V_41 ) == 0 ,
5 * V_114 ) ;
F_65 ( V_36 -> V_2 -> V_15 ,
F_61 ( & V_36 -> V_41 ) < 10 ? 1 : 0 ) ;
}
F_65 ( V_36 -> V_2 -> V_15 , F_61 ( & V_36 -> V_41 ) < 10 ? 1 : 0 ) ;
F_23 ( & V_36 -> V_24 , V_42 ) ;
return 0 ;
}
int F_72 ( void * V_113 )
...
struct V_35 * V_36 = V_113 ;
while ( F_61 ( & V_36 -> V_41 ) ) {
F_74 ( V_36 -> V_43 , F_61 ( & V_36 -> V_41 ) == 0 ) ;
}
F_23 ( & V_36 -> V_24 , V_42 ) ;
return 0 ;
}
void F_75 ( void * V_113 )
{
struct V_35 * V_36 = V_113 ;
F_23 ( & V_36 -> V_24 , V_42 ) ;
}
