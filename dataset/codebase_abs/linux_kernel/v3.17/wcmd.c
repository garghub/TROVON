...
while ( ( V_78 = F_46 ( & V_2 -> V_121 [ 0 ] . V_170 ) ) != NULL ) {
if ( F_47 ( & V_2 -> V_121 [ 0 ] . V_170 ) ) {
V_2 -> V_171 [ 0 ] &= ~ V_76 [ 0 ] ;
V_1 -> V_172 = false ;
} else {
V_1 -> V_172 = true ;
...
while ( ( V_78 = F_46 ( & V_2 -> V_121 [ V_23 ] . V_170 ) ) != NULL ) {
if ( F_47 ( & V_2 -> V_121 [ V_23 ] . V_170 ) ) {
