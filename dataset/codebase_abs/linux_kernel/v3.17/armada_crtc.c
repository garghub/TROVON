...
static void F_36 ( struct V_1 * V_2 , T_4 V_73 )
{
...
static T_5 F_45 ( int V_108 , void * V_109 )
{
...
if ( V_2 -> V_111 & V_9 ) {
V_2 -> V_111 &= ~ V_9 ;
F_46 ( V_2 -> V_111 , V_2 -> V_7 + V_114 ) ;
}
}
void F_47 ( struct V_1 * V_2 , T_4 V_9 )
{
if ( ( V_2 -> V_111 & V_9 ) != V_9 ) {
V_2 -> V_111 |= V_9 ;
F_46 ( V_2 -> V_111 , V_2 -> V_7 + V_114 ) ;
if ( F_2 ( V_2 -> V_7 + V_110 ) & V_9 )
F_46 ( 0 , V_2 -> V_7 + V_110 ) ;
}
}
...
static int F_49 ( struct V_57 * V_17 ,
...
F_51 ( V_2 -> V_107 , ! V_2 -> V_51 ) ;
F_52 ( V_17 -> V_47 , V_2 -> V_49 ) ;
V_17 -> V_18 = * V_68 ;
V_8 = V_2 -> V_10 & ~ V_13 ;
if ( V_8 != V_2 -> V_10 ) {
V_2 -> V_10 = V_8 ;
...
V_8 = V_2 -> V_159 | F_48 ( V_2 ) ;
F_9 ( V_4 , V_39 , V_8 , V_160 ) ;
F_24 ( V_4 , V_39 ) ;
F_1 ( V_2 , V_4 ) ;
F_15 ( & V_2 -> V_80 , V_19 ) ;
F_4 ( V_2 ) ;
F_56 ( V_17 -> V_47 , V_2 -> V_49 ) ;
F_21 ( V_2 , V_54 , F_5 ( V_2 -> V_12 ) ) ;
return 0 ;
}
static int F_57 ( struct V_57 * V_17 , int V_29 , int V_30 ,
struct V_27 * V_54 )
{
struct V_1 * V_2 = F_32 ( V_17 ) ;
struct V_3 V_4 [ 4 ] ;
...
static void F_59 ( struct V_57 * V_17 )
{
struct V_1 * V_2 = F_32 ( V_17 ) ;
F_31 ( V_17 , V_161 ) ;
...
static void F_60 ( void T_1 * V_7 , T_2 * V_168 ,
...
static int F_62 ( struct V_1 * V_2 , bool V_180 )
{
...
V_181 = - V_2 -> V_191 ;
V_182 = 0 ;
V_183 -= F_63 ( V_181 , V_183 ) ;
} else if ( V_2 -> V_191 + V_183 > V_2 -> V_17 . V_18 . V_121 ) {
V_181 = 0 ;
V_182 = V_2 -> V_191 ;
V_183 = F_64 ( int , V_2 -> V_17 . V_18 . V_121 - V_2 -> V_191 , 0 ) ;
} else {
V_181 = 0 ;
V_182 = V_2 -> V_191 ;
}
...
V_186 = - V_2 -> V_192 ;
V_187 = 0 ;
V_188 -= F_63 ( V_186 , V_188 ) ;
} else if ( V_2 -> V_192 + V_188 > V_2 -> V_17 . V_18 . V_122 ) {
V_186 = 0 ;
V_187 = V_2 -> V_192 ;
V_188 = F_64 ( int , V_2 -> V_17 . V_18 . V_122 - V_2 -> V_192 , 0 ) ;
} else {
V_186 = 0 ;
V_187 = V_2 -> V_192 ;
}
...
F_42 ( V_2 , V_106 ) ;
V_2 -> V_97 = false ;
F_41 ( 0 , V_102 , V_2 -> V_7 + V_105 ) ;
F_28 ( & V_2 -> V_80 ) ;
return 0 ;
}
V_190 = F_2 ( V_2 -> V_7 + V_139 ) ;
F_41 ( V_194 , V_194 | V_162 ,
V_2 -> V_7 + V_139 ) ;
if ( ! ( V_190 & V_194 ) ) {
F_61 ( V_2 -> V_7 ) ;
V_180 = true ;
...
F_60 ( V_2 -> V_7 , V_168 , V_185 , V_183 , V_188 ) ;
}
F_27 ( & V_2 -> V_80 ) ;
...
static int F_65 ( struct V_57 * V_17 ,
...
static int F_71 ( struct V_57 * V_17 , int V_29 , int V_30 )
{
struct V_46 * V_47 = V_17 -> V_47 ;
struct V_1 * V_2 = F_32 ( V_17 ) ;
int V_48 ;
...
static void F_72 ( struct V_57 * V_17 )
{
struct V_1 * V_2 = F_32 ( V_17 ) ;
...
static int F_77 ( struct V_57 * V_17 ,
...
if ( V_208 -> V_218 )
return 0 ;
V_208 -> V_218 = F_80 ( V_47 , 0 ,
L_8 , V_220 ,
F_81 ( V_220 ) ) ;
V_208 -> V_219 = F_80 ( V_47 , 0 ,
L_9 , V_221 ,
F_81 ( V_221 ) ) ;
...
int F_82 ( struct V_46 * V_222 , struct V_223 * V_47 ,
...
F_3 ( 0 , V_2 -> V_7 + V_110 ) ;
V_48 = F_91 ( V_47 , V_108 , F_45 , 0 , L_11 ,
V_2 ) ;
if ( V_48 < 0 ) {
F_20 ( V_2 ) ;
return V_48 ;
...
F_41 ( V_238 , 0 , V_2 -> V_7 + V_105 ) ;
V_208 -> V_2 [ V_2 -> V_49 ] = V_2 ;
V_2 -> V_17 . V_211 = V_211 ;
F_92 ( V_222 , & V_2 -> V_17 , & V_239 ) ;
F_93 ( & V_2 -> V_17 , & V_240 ) ;
F_94 ( & V_2 -> V_17 . V_7 , V_208 -> V_218 ,
V_2 -> V_115 ) ;
F_94 ( & V_2 -> V_17 . V_7 , V_208 -> V_219 ,
V_2 -> V_118 ) ;
return F_95 ( V_222 , 1 << V_2 -> V_49 ) ;
}
static int
F_96 ( struct V_223 * V_47 , struct V_223 * V_241 , void * V_83 )
{
struct V_242 * V_243 = F_97 ( V_47 ) ;
struct V_46 * V_222 = V_83 ;
struct V_224 * V_225 = F_98 ( V_243 , V_244 , 0 ) ;
int V_108 = F_99 ( V_243 , 0 ) ;
...
V_250 = F_101 ( V_47 -> V_253 -> V_254 , V_47 ) ;
if ( ! V_250 )
return - V_198 ;
V_251 = F_102 ( V_252 , L_12 ) ;
if ( V_251 )
V_252 = V_251 ;
V_211 = F_102 ( V_252 , L_13 ) ;
F_76 ( V_251 ) ;
if ( ! V_211 ) {
F_103 ( V_47 , L_14 ,
V_252 -> V_255 ) ;
...
return F_82 ( V_222 , V_47 , V_225 , V_108 , V_69 , V_211 ) ;
}
static void
F_104 ( struct V_223 * V_47 , struct V_223 * V_241 , void * V_83 )
{
struct V_1 * V_2 = F_105 ( V_47 ) ;
F_72 ( & V_2 -> V_17 ) ;
}
static int F_106 ( struct V_242 * V_243 )
{
return F_107 ( & V_243 -> V_47 , & V_256 ) ;
}
static int F_108 ( struct V_242 * V_243 )
{
F_109 ( & V_243 -> V_47 , & V_256 ) ;
return 0 ;
}
