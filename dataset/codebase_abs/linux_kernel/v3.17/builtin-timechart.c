...
static int F_94 ( int V_181 , const char * * V_182 )
{
...
* V_9 ++ = V_182 [ V_70 ] ;
return F_99 ( V_183 , V_184 , NULL ) ;
}
static int F_100 ( struct V_2 * V_3 , int V_181 , const char * * V_182 )
{
...
unsigned int V_197 = F_95 ( V_196 ) ;
const char * const V_198 [] = {
L_105 , L_42 ,
L_105 , L_41 ,
} ;
unsigned int V_199 = F_95 ( V_198 ) ;
...
unsigned int V_201 = F_95 ( V_200 ) ;
const char * const V_202 [] = {
L_105 , L_43 ,
L_105 , L_44 ,
} ;
unsigned int V_203 = F_95 ( V_202 ) ;
#ifdef F_84
if ( ! F_98 ( L_41 ) &&
F_98 ( L_45 ) ) {
V_204 = 1 ;
...
static int
F_101 ( const struct V_206 * T_8 V_34 , const char * V_207 ,
int V_34 V_208 )
{
if ( V_207 )
F_68 ( V_207 ) ;
...
static int
F_103 ( const struct V_206 * T_8 , const char * V_207 , int V_34 V_208 )
{
char V_212 = 'n' ;
T_1 * V_110 = T_8 -> V_110 ;
...
int F_104 ( int V_181 , const char * * V_182 ,
const char * T_9 V_34 )
{
struct V_2 V_3 = {
. V_30 = {
...
F_105 ( 'i' , L_110 , & V_174 , L_111 , L_112 ) ,
F_105 ( 'o' , L_113 , & V_168 , L_111 , L_114 ) ,
F_106 ( 'w' , L_115 , & V_216 , L_116 ) ,
F_107 ( 0 , L_117 , NULL , L_118 ,
L_119 ,
F_102 ) ,
F_108 ( 'P' , L_120 , & V_3 . V_151 , L_121 ) ,
F_108 ( 'T' , L_122 , & V_3 . V_153 ,
L_123 ) ,
F_107 ( 'p' , L_37 , NULL , L_37 ,
L_124 ,
F_101 ) ,
F_105 ( 0 , L_125 , & V_217 . V_218 , L_126 ,
L_127 ) ,
F_106 ( 'n' , L_128 , & V_3 . V_152 ,
L_129 ) ,
F_108 ( 't' , L_130 , & V_3 . V_163 ,
L_131 ) ,
F_108 ( 0 , L_132 , & V_3 . V_141 ,
L_133 ) ,
F_107 ( 0 , L_134 , & V_3 . V_118 , L_135 ,
L_136 ,
F_103 ) ,
F_107 ( 0 , L_137 , & V_3 . V_127 , L_135 ,
L_138 ,
F_103 ) ,
F_109 ()
} ;
...
F_108 ( 'T' , L_122 , & V_3 . V_153 ,
L_123 ) ,
F_108 ( 'I' , L_140 , & V_3 . V_221 ,
L_141 ) ,
F_108 ( 'g' , L_142 , & V_3 . V_205 , L_143 ) ,
F_109 ()
} ;
...
V_181 = F_110 ( V_181 , V_182 , V_215 , V_219 ,
V_223 ) ;
...
V_181 = F_110 ( V_181 , V_182 , V_220 , V_222 ,
V_223 ) ;
if ( V_3 . V_151 && V_3 . V_153 ) {
F_90 ( L_145 ) ;
return - 1 ;
...
if ( V_3 . V_221 )
return F_94 ( V_181 , V_182 ) ;
else
return F_100 ( & V_3 , V_181 , V_182 ) ;
} else if ( V_181 )
F_112 ( V_219 , V_215 ) ;
F_113 () ;
