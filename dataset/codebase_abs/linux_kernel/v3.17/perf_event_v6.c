...
V_16 = & V_14 -> V_17 ;
F_14 ( V_14 ) ;
F_15 ( & V_41 , 0 , V_16 -> V_47 ) ;
if ( ! F_16 ( V_14 ) )
continue;
if ( F_17 ( V_14 , & V_41 , V_44 ) )
V_24 -> V_48 ( V_14 ) ;
}
F_18 () ;
return V_49 ;
...
static int
F_21 ( struct V_26 * V_42 ,
struct V_13 * V_14 )
{
struct V_15 * V_16 = & V_14 -> V_17 ;
if ( V_51 == V_16 -> V_31 ) {
if ( F_22 ( V_7 , V_42 -> V_52 ) )
return - V_53 ;
return V_7 ;
} else {
if ( ! F_22 ( V_11 , V_42 -> V_52 ) )
return V_11 ;
if ( ! F_22 ( V_9 , V_42 -> V_52 ) )
return V_9 ;
return - V_53 ;
}
}
