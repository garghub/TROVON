...
int V_77 = 0 ;
F_21 ( V_80 -> V_2 , L_30 ) ;
V_76 -> V_180 = F_53 ( V_80 -> V_2 , L_31 ) ;
if ( F_54 ( V_76 -> V_180 ) == - V_240 )
return - V_240 ;
V_76 -> V_80 = V_80 ;
F_3 ( V_76 ) ;
...
if ( ( V_77 >= V_244 ) && ( V_77 <= V_244 + 0x0f ) ) {
V_112 = V_245 ;
F_24 ( V_80 -> V_2 , L_33 , V_77 ) ;
} else if ( ( V_77 >= V_246 ) && ( V_77 <= V_246 + 0x0f ) ) {
V_112 = V_113 ;
F_24 ( V_80 -> V_2 , L_34 , V_77 ) ;
} else {
V_112 = V_245 ;
F_5 ( V_80 -> V_2 , L_35 , V_77 ) ;
}
if ( V_76 -> V_112 != V_112 ) {
F_55 ( V_80 -> V_2 , L_36 ) ;
V_76 -> V_112 = V_112 ;
...
V_77 = F_57 ( V_80 -> V_2 , V_76 -> V_224 , NULL ,
F_46 , V_249 | V_250 ,
L_38 , V_80 ) ;
if ( V_77 < 0 ) {
F_5 ( V_80 -> V_2 , L_39 ,
...
static int F_60 ( struct V_260 * V_261 ,
...
int V_77 ;
F_61 ( L_40 ) ;
V_76 = F_62 ( & V_261 -> V_2 , sizeof( struct V_75 ) ,
V_267 ) ;
if ( V_76 == NULL )
return - V_268 ;
if ( F_63 ( & V_261 -> V_2 ) ) {
V_265 = F_64 ( V_261 -> V_2 . V_269 -> V_270 ,
& V_261 -> V_2 ) ;
if ( ! V_265 ) {
F_5 ( & V_261 -> V_2 , L_41 ) ;
return - V_96 ;
...
V_76 -> V_112 = V_266 ;
F_65 ( V_261 , V_76 ) ;
V_76 -> V_271 = V_261 -> V_2 . V_272 ;
V_76 -> V_224 = V_261 -> V_224 ;
V_76 -> V_78 = F_66 ( V_261 , & V_273 ) ;
if ( F_28 ( V_76 -> V_78 ) ) {
V_77 = F_54 ( V_76 -> V_78 ) ;
F_5 ( & V_261 -> V_2 , L_42 , V_77 ) ;
goto V_274;
}
V_77 = F_67 ( & V_261 -> V_2 ,
& V_275 , V_276 ,
...
static int F_68 ( struct V_260 * V_277 )
{
F_69 ( & V_277 -> V_2 ) ;
return 0 ;
}
