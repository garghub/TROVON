...
snprintf ( V_2 , sizeof( V_2 ) , L_19 , V_32 ) ;
V_1 = V_2 ;
}
if ( V_43 ) {
if ( F_4 ( V_1 , V_2 ) )
...
F_38 ( V_15 , V_68 ) ) ;
if ( V_78 != V_80 )
V_79 = fprintf ( V_72 , L_32 , V_77 , V_78 ) ;
F_39 ( V_78 ) ;
}
return V_79 ;
}
...
T_5 * V_72 )
{
T_1 V_103 = fprintf ( V_72 , L_33 , V_104 [ type ] ) ;
struct V_26 * V_55 ;
for ( V_55 = F_15 ( & V_86 -> V_89 [ type ] ) ; V_55 ; V_55 = F_44 ( V_55 ) ) {
struct V_15 * V_94 = F_16 ( V_55 , struct V_15 , V_26 ) ;
