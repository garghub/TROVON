...
static inline int F_29 ( void T_2 * V_29 , T_1 V_74 , int V_70 )
{
if ( F_11 () ) {
...
int F_34 ( void T_2 * V_29 , void T_2 * V_61 , int V_26 )
{
int V_63 = ( V_29 != V_61 ) ;
struct V_1 * V_2 = V_62 ;
int V_76 = V_39 ;
...
V_88 = F_48 ( V_13 ) ;
V_25 = F_49 ( V_88 * sizeof( int ) ) ;
V_27 = F_49 ( V_88 * sizeof( int ) ) ;
do {
F_50 ( V_89 , V_87 , & V_83 , & V_84 , & V_85 , & V_86 ) ;
if ( V_83 == 0 )
break;
V_25 [ V_87 ] = V_84 ;
V_27 [ V_87 ] = V_83 ;
...
int V_91 ;
V_92 [ 0 ] = 0 ;
V_92 [ 1 ] = F_52 ( struct V_3 , V_23 ) ;
if ( ! V_93 ) {
for ( V_91 = 2 ; V_91 < V_88 ; V_91 ++ ) {
if ( F_53 ( V_91 , ( unsigned long * ) & V_13 ) ) {
V_92 [ V_91 ] = V_25 [ V_91 ] ;
V_90 [ V_91 ] = V_27 [ V_91 ] ;
}
}
...
int V_91 ;
if ( ! V_93 ) {
F_50 ( V_89 , 0 , & V_83 , & V_84 , & V_85 , & V_86 ) ;
V_39 = V_84 ;
return;
}
V_39 = V_94 + V_95 ;
...
if ( F_53 ( V_91 , ( unsigned long * ) & V_13 ) ) {
F_50 ( V_89 , V_91 , & V_83 , & V_84 , & V_85 , & V_86 ) ;
V_39 += V_83 ;
}
}
}
...
void F_68 ( void )
{
static T_5 void (* F_69)( void ) = F_62 ;
void (* F_70)( void );
if ( ! V_96 )
return;
F_70 = F_69 ;
...
static inline void T_4 F_71 ( void )
{
V_62 -> V_5 . V_6 . V_7 =
F_55 ( V_39 , F_56 ( struct V_43 ) ) ;
if ( ! V_28 )
F_54 () ;
}
void F_72 ( void )
{
static T_5 void (* F_73)( void ) = F_71 ;
F_74 () ;
F_75 () -> V_49 = 0 ;
if ( V_99 == V_100 )
F_76 ( V_108 ) ;
...
void * F_80 ( struct V_43 * V_11 , int V_110 )
{
int V_111 = F_48 ( V_110 ) - 1 ;
if ( ! F_53 ( V_111 , ( unsigned long * ) & V_13 ) )
return NULL ;
