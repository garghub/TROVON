...
return 0 ;
V_30 = F_126 ( & V_11 -> V_12 , & V_106 -> V_12 ) ;
if ( V_30 ) {
F_18 ( L_43 , V_31 , V_30 ) ;
return V_30 ;
}
...
static int F_127 ( struct V_105 * V_107 , struct V_131 * V_132 )
{
...
{
return F_127 ( V_107 , V_132 ) ;
}
static int F_144 ( struct V_105 * V_107 ,
struct V_131 * V_132 )
{
...
struct V_105 * V_106 = F_100 ( V_154 ) ;
F_146 ( & V_106 -> V_12 , L_35 ) ;
V_30 = F_125 ( V_11 , V_154 , V_106 ) ;
if ( V_30 ) {
if ( F_101 ( & V_106 -> V_12 , & V_11 -> V_12 ,
L_35 ) )
F_18 ( L_52 ,
V_31 , V_106 -> V_133 ) ;
return V_30 ;
...
F_34 ( L_53 ,
V_31 , V_154 , V_14 ) ;
} else if ( V_1 -> V_155 && V_1 -> V_76 ) {
V_1 -> V_155 ( V_11 ) ;
}
return 0 ;
}
static int F_148 ( struct V_105 * V_107 ,
struct V_131 * V_132 )
{
unsigned int V_14 = V_107 -> V_133 , V_33 ;
int V_30 ;
...
static int F_151 ( struct V_105 * V_107 , struct V_131 * V_132 )
{
unsigned int V_14 = V_107 -> V_133 ;
int V_30 ;
if ( F_129 ( V_14 ) )
return 0 ;
V_30 = F_144 ( V_107 , V_132 ) ;
if ( ! V_30 )
V_30 = F_148 ( V_107 , V_132 ) ;
return V_30 ;
}
...
int F_164 ( struct V_166 * V_167 , unsigned int V_168 )
{
int V_30 ;
if ( F_4 () )
return - V_67 ;
...
int F_167 ( struct V_166 * V_167 , unsigned int V_168 )
{
int V_30 ;
if ( F_4 () )
return - V_67 ;
...
struct V_40 * V_49 , int V_171 )
{
int V_30 ;
V_49 -> V_48 = V_1 -> V_172 ( V_11 , V_171 ) ;
if ( ! V_49 -> V_48 )
return 0 ;
F_34 ( L_66 ,
V_31 , V_11 -> V_14 , V_49 -> V_46 , V_49 -> V_48 ) ;
F_46 ( V_11 , V_49 ) ;
V_30 = V_1 -> V_173 ( V_11 , V_171 ) ;
F_52 ( V_11 , V_49 , V_30 ) ;
if ( V_30 )
F_18 ( L_67 ,
V_31 , V_30 ) ;
...
V_49 . V_48 = V_174 [ V_171 ] . V_178 ;
F_34 ( L_68 ,
V_31 , V_11 -> V_14 , V_49 . V_46 , V_49 . V_48 ) ;
F_46 ( V_11 , & V_49 ) ;
}
V_176 = V_1 -> V_2 ( V_11 , V_171 ) ;
if ( V_176 )
F_18 ( L_69 , V_31 ,
V_176 ) ;
if ( V_177 ) {
F_52 ( V_11 , & V_49 , V_176 ) ;
if ( F_50 ( V_176 && V_175 ) ) {
V_49 . V_46 = V_175 ;
V_49 . V_48 = V_11 -> V_179 ;
F_46 ( V_11 , & V_49 ) ;
F_52 ( V_11 , & V_49 , 0 ) ;
}
}
...
V_180 = V_11 -> V_144 ;
F_34 ( L_70 ,
V_11 -> V_14 , V_180 , V_181 , V_182 ) ;
if ( V_180 == V_11 -> V_52 )
return 0 ;
V_11 -> V_179 = V_11 -> V_52 ;
if ( V_1 -> V_3 )
V_176 = V_1 -> V_3 ( V_11 , V_180 , V_181 ) ;
else if ( V_1 -> V_2 ) {
struct V_27 * V_174 ;
int V_171 ;
V_174 = F_172 ( V_11 -> V_14 ) ;
if ( F_50 ( ! V_174 ) ) {
F_18 ( L_71 , V_31 ) ;
goto V_75;
}
V_176 = F_173 ( V_11 , V_174 ,
V_180 , V_181 , & V_171 ) ;
if ( F_50 ( V_176 ) ) {
F_18 ( L_72 , V_31 ) ;
goto V_75;
}
if ( V_174 [ V_171 ] . V_178 == V_11 -> V_52 ) {
V_176 = 0 ;
goto V_75;
}
V_176 = F_171 ( V_11 , V_174 , V_171 ) ;
}
V_75:
return V_176 ;
}
...
if ( V_184 == V_187 )
if ( ! F_176 ( V_11 -> V_73 -> V_188 ) )
return - V_67 ;
F_34 ( L_74 ,
V_11 -> V_14 , V_184 ) ;
F_61 ( & V_189 ) ;
if ( ( V_11 -> V_190 && V_184 == V_118 )
|| ( ! V_11 -> V_190
&& ( V_184 == V_119 || V_184 == V_117 ) ) ) {
F_62 ( & V_189 ) ;
return - V_191 ;
}
if ( V_184 == V_117 )
...
V_11 -> V_190 = true ;
F_62 ( & V_189 ) ;
V_30 = V_11 -> V_73 -> V_73 ( V_11 , V_184 ) ;
if ( ! V_30 ) {
if ( V_184 == V_187 )
V_11 -> V_73 -> V_192 ++ ;
else if ( V_184 == V_156 )
...
if ( ( ( V_184 == V_187 ) && V_30 ) ||
( ( V_184 == V_156 ) && ! V_30 ) )
F_177 ( V_11 -> V_73 -> V_188 ) ;
return V_30 ;
}
int F_178 ( struct V_68 * V_73 )
{
int V_74 ;
if ( ! V_73 )
return - V_67 ;
...
V_74 = 0 ;
F_141 ( & V_73 -> V_193 , & V_194 ) ;
}
F_62 ( & V_79 ) ;
return V_74 ;
}
void F_179 ( struct V_68 * V_73 )
{
int V_14 ;
if ( ! V_73 )
return;
...
static int F_181 ( struct V_166 * V_201 ,
unsigned long V_202 , void * V_203 )
{
unsigned int V_14 = ( unsigned long ) V_203 ;
struct V_105 * V_107 ;
V_107 = F_100 ( V_14 ) ;
if ( V_107 ) {
switch ( V_202 & ~ V_204 ) {
...
int F_186 ( struct V_1 * V_212 )
{
unsigned long V_7 ;
int V_30 ;
if ( F_4 () )
return - V_183 ;
if ( ! V_212 || ! V_212 -> V_197 || ! V_212 -> V_141 ||
! ( V_212 -> V_76 || V_212 -> V_2 ||
V_212 -> V_3 ) ||
( V_212 -> V_76 && ( V_212 -> V_2 ||
V_212 -> V_3 ) ) ||
( ! ! V_212 -> V_172 != ! ! V_212 -> V_173 ) )
return - V_67 ;
F_34 ( L_86 , V_212 -> V_71 ) ;
if ( V_212 -> V_76 )
V_212 -> V_7 |= V_42 ;
F_108 ( & V_38 , V_7 ) ;
if ( V_1 ) {
