...
V_7 -> V_82 = false ;
V_7 -> V_288 = V_30 -> V_67 . V_55 -> V_289 ;
F_197 ( & V_7 -> V_18 ) ;
V_74 = F_198 ( & V_7 -> V_75 ) ;
if ( V_74 < 0 )
goto V_290;
F_118 ( V_38 ) ;
F_113 ( V_7 ) ;
V_38 -> V_291 = V_292 | V_293 |
V_125 | V_294 |
V_295 ;
V_38 -> V_123 = V_38 -> V_291 ;
V_38 -> V_296 = V_38 -> V_123 &
~ ( V_294 |
V_295 ) ;
F_199 ( & V_7 -> V_53 ) ;
...
if ( V_74 < 0 )
goto V_298;
if ( F_201 ( & V_7 -> V_38 -> V_38 , & V_299 ) ||
F_201 ( & V_7 -> V_38 -> V_38 , & V_300 ) ||
F_201 ( & V_7 -> V_38 -> V_38 , & V_301 ) )
F_155 ( L_17 ) ;
}
F_202 ( V_7 -> V_38 ) ;
F_6 ( V_10 , V_7 , L_18 ) ;
...
for ( V_17 = 0 ; V_17 < V_7 -> V_32 ; V_17 ++ ) {
V_30 = F_54 ( V_7 -> V_61 [ V_17 ] ) ;
V_30 -> V_67 . V_55 -> V_289 = V_7 -> V_288 ;
}
}
...
static long F_214 ( struct V_71 * V_71 , unsigned int V_314 ,
unsigned long V_89 , int V_315 )
{
struct V_29 * V_30 = V_71 -> V_73 ;
struct V_6 * V_7 ;
void T_5 * V_316 = ( void T_5 * ) V_89 ;
struct V_275 V_276 ;
T_15 V_47 ;
T_16 V_49 ;
int V_288 ;
...
unsigned int V_287 ;
int V_230 ;
if ( V_314 == V_317 || V_314 == V_318 || F_215 ( V_314 ) == 0x89 ) {
if ( F_85 ( & V_276 , V_316 , V_315 ) )
return - V_95 ;
} else {
...
V_7 = F_75 ( V_30 ) ;
if ( V_314 == V_317 && ! V_7 ) {
V_276 . V_277 [ V_320 - 1 ] = '\0' ;
V_230 = F_191 ( V_30 -> V_46 , V_71 , & V_276 ) ;
if ( V_230 )
goto V_34;
if ( F_217 ( V_316 , & V_276 , V_315 ) )
V_230 = - V_95 ;
goto V_34;
}
if ( V_314 == V_321 ) {
...
goto V_34;
V_230 = - V_95 ;
if ( F_85 ( & V_287 , V_316 , sizeof( V_287 ) ) )
goto V_34;
V_230 = 0 ;
V_30 -> V_287 = V_287 ;
goto V_34;
...
switch ( V_314 ) {
case V_322 :
F_205 ( V_323 -> V_324 -> V_325 , V_7 , & V_276 ) ;
if ( V_30 -> V_33 )
V_276 . V_278 |= V_313 ;
if ( ! V_30 -> V_67 . V_55 -> V_108 )
V_276 . V_278 |= V_281 ;
...
V_7 -> V_49 = V_49 ;
F_6 ( V_10 , V_7 , L_26 ,
F_222 ( & V_329 , V_7 -> V_49 ) ) ;
break;
case V_331 :
if ( V_7 -> V_38 -> V_62 & V_332 ) {
F_6 ( V_10 , V_7 ,
L_27 ) ;
V_230 = - V_78 ;
} else {
...
break;
case V_337 :
memcpy ( V_276 . V_338 . V_339 , V_7 -> V_38 -> V_340 , V_86 ) ;
V_276 . V_338 . V_341 = V_7 -> V_38 -> type ;
if ( F_217 ( V_316 , & V_276 , V_315 ) )
V_230 = - V_95 ;
break;
case V_342 :
F_6 ( V_343 , V_7 , L_29 ,
V_276 . V_338 . V_339 ) ;
V_230 = F_224 ( V_7 -> V_38 , & V_276 . V_338 ) ;
break;
case V_344 :
V_288 = V_30 -> V_67 . V_55 -> V_289 ;
if ( F_217 ( V_316 , & V_288 , sizeof( V_288 ) ) )
V_230 = - V_95 ;
break;
case V_345 :
if ( F_85 ( & V_288 , V_316 , sizeof( V_288 ) ) ) {
V_230 = - V_95 ;
break;
}
V_7 -> V_288 = V_288 ;
...
case V_346 :
V_172 = V_7 -> V_172 ;
if ( F_217 ( V_316 , & V_172 , sizeof( V_172 ) ) )
V_230 = - V_95 ;
break;
case V_347 :
if ( F_85 ( & V_172 , V_316 , sizeof( V_172 ) ) ) {
V_230 = - V_95 ;
break;
}
...
break;
V_230 = - V_95 ;
if ( F_85 ( & V_7 -> V_83 , V_316 , sizeof( V_7 -> V_83 ) ) )
break;
V_230 = F_210 ( V_7 ) ;
break;
case V_349 :
...
break;
V_230 = - V_95 ;
if ( F_217 ( V_316 , & V_7 -> V_83 , sizeof( V_7 -> V_83 ) ) )
break;
V_230 = 0 ;
break;
default:
...
unsigned int V_314 , unsigned long V_89 )
{
return F_214 ( V_71 , V_314 , V_89 , sizeof ( struct V_275 ) ) ;
}
...
return F_214 ( V_71 , V_314 , V_89 , sizeof( struct V_352 ) ) ;
}
static int F_228 ( int V_353 , struct V_71 * V_71 , int V_354 )
{
struct V_29 * V_30 = V_71 -> V_73 ;
int V_230 ;
if ( ( V_230 = F_229 ( V_353 , V_71 , V_354 , & V_30 -> V_112 ) ) < 0 )
goto V_76;
if ( V_354 ) {
V_230 = F_230 ( V_71 , F_231 ( V_323 ) , V_355 , 0 ) ;
if ( V_230 )
goto V_76;
V_30 -> V_62 |= V_111 ;
} else
...
static int F_232 ( struct V_356 * V_356 , struct V_71 * V_71 )
{
struct V_29 * V_30 ;
F_233 ( V_10 , L_30 ) ;
V_30 = (struct V_29 * ) F_234 ( & V_357 , V_358 , V_96 ,
& V_359 ) ;
if ( ! V_30 )
return - V_97 ;
F_57 ( V_30 -> V_7 , NULL ) ;
V_30 -> V_46 = F_235 ( V_323 -> V_324 -> V_325 ) ;
V_30 -> V_62 = 0 ;
V_30 -> V_287 = 0 ;
F_236 ( & V_30 -> V_360 . V_142 ) ;
F_57 ( V_30 -> V_67 . V_360 , & V_30 -> V_360 ) ;
V_30 -> V_67 . V_71 = V_71 ;
V_30 -> V_67 . V_361 = & V_362 ;
F_237 ( & V_30 -> V_67 , & V_30 -> V_55 ) ;
F_238 ( & V_30 -> V_55 , V_30 -> V_46 ) ;
V_30 -> V_55 . V_363 = F_174 ;
V_30 -> V_55 . V_289 = V_364 ;
V_71 -> V_73 = V_30 ;
F_239 ( V_66 , & V_30 -> V_67 . V_62 ) ;
F_199 ( & V_30 -> V_52 ) ;
F_240 ( & V_30 -> V_55 , V_365 ) ;
return 0 ;
}
static int F_241 ( struct V_356 * V_356 , struct V_71 * V_71 )
{
struct V_29 * V_30 = V_71 -> V_73 ;
...
static int F_243 ( struct V_366 * V_255 , struct V_71 * V_367 )
{
struct V_6 * V_7 ;
struct V_275 V_276 ;
memset ( & V_276 , 0 , sizeof( V_276 ) ) ;
...
static int F_245 ( struct V_37 * V_38 , struct V_368 * V_314 )
{
V_314 -> V_369 = 0 ;
V_314 -> V_370 = 0 ;
F_246 ( V_314 , V_371 ) ;
...
static void F_247 ( struct V_37 * V_38 , struct V_383 * V_384 )
{
struct V_6 * V_7 = F_31 ( V_38 ) ;
F_248 ( V_384 -> V_385 , V_386 , sizeof( V_384 -> V_385 ) ) ;
F_248 ( V_384 -> V_387 , V_388 , sizeof( V_384 -> V_387 ) ) ;
switch ( V_7 -> V_62 & V_127 ) {
case V_128 :
F_248 ( V_384 -> V_389 , L_32 , sizeof( V_384 -> V_389 ) ) ;
break;
case V_137 :
F_248 ( V_384 -> V_389 , L_33 , sizeof( V_384 -> V_389 ) ) ;
break;
}
}
...
static void F_250 ( struct V_37 * V_38 , T_1 V_391 )
{
#ifdef F_223
struct V_6 * V_7 = F_31 ( V_38 ) ;
V_7 -> V_334 = V_391 ;
