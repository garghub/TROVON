...
V_74 -> V_2 . V_90 = V_12 -> V_90 ;
V_74 -> V_2 . V_91 . V_92 = V_12 -> V_91 . V_92 ;
V_74 -> V_2 . V_14 = F_1 ;
V_74 -> V_2 . V_44 = F_15 ;
if ( V_12 -> V_45 )
V_74 -> V_2 . V_45 = F_16 ;
...
if ( V_12 -> V_65 )
V_74 -> V_2 . V_65 = F_26 ;
if ( ! V_80 && ! V_12 -> V_91 . V_93 && V_12 -> V_66 &&
V_12 -> V_67 ) {
V_74 -> V_2 . V_66 = F_27 ;
V_74 -> V_2 . V_67 = F_28 ;
}
...
V_74 -> V_15 = V_81 ;
if ( F_45 ( V_81 , V_12 ) != 0 ) {
V_74 -> V_15 = ( F_46 ( V_81 , V_12 ) + 1 ) * V_12 -> V_96 ;
F_43 ( V_97 L_2
L_3 , V_80 ,
...
F_47 ( V_74 -> V_2 . V_96 == 0 ) ;
} else {
V_74 -> V_2 . V_96 = V_12 -> V_96 ;
}
if ( ( V_74 -> V_2 . V_22 & V_109 ) &&
F_45 ( V_74 -> V_15 , & V_74 -> V_2 ) ) {
V_74 -> V_2 . V_22 &= ~ V_109 ;
F_43 ( V_101 L_8 ,
V_8 -> V_73 ) ;
}
if ( ( V_74 -> V_2 . V_22 & V_109 ) &&
F_45 ( V_74 -> V_2 . V_26 , & V_74 -> V_2 ) ) {
V_74 -> V_2 . V_22 &= ~ V_109 ;
F_43 ( V_101 L_9 ,
V_8 -> V_73 ) ;
}
...
if ( F_48 ( V_12 , V_114 + V_74 -> V_15 ) )
V_74 -> V_2 . V_13 . V_115 ++ ;
else if ( F_49 ( V_12 , V_114 + V_74 -> V_15 ) )
V_74 -> V_2 . V_13 . V_71 ++ ;
V_114 += V_74 -> V_2 . V_96 ;
}
}
...
int F_50 ( struct V_1 * V_12 , const char * V_73 ,
long long V_15 , long long V_116 )
{
struct V_79 V_8 ;
struct V_7 * V_72 , * V_117 ;
T_5 V_118 , V_105 ;
int V_55 = 0 ;
if ( V_15 == V_94 ||
V_15 == V_95 )
...
V_8 . V_85 = 0 ;
V_8 . V_110 = NULL ;
V_117 = F_40 ( V_12 , & V_8 , - 1 , V_15 ) ;
if ( F_51 ( V_117 ) )
return F_52 ( V_117 ) ;
V_118 = V_15 ;
V_105 = V_15 + V_116 ;
F_35 ( & V_77 ) ;
F_53 (p, &mtd_partitions, list)
if ( V_72 -> V_12 == V_12 ) {
if ( ( V_118 >= V_72 -> V_15 ) &&
( V_118 < ( V_72 -> V_15 + V_72 -> V_2 . V_26 ) ) )
goto V_119;
if ( ( V_105 >= V_72 -> V_15 ) &&
( V_105 < ( V_72 -> V_15 + V_72 -> V_2 . V_26 ) ) )
goto V_119;
}
F_54 ( & V_117 -> V_78 , & V_120 ) ;
F_39 ( & V_77 ) ;
F_55 ( & V_117 -> V_2 ) ;
return V_55 ;
V_119:
...
int F_56 ( struct V_1 * V_12 , int V_80 )
{
struct V_7 * V_74 , * V_75 ;
int V_55 = - V_27 ;
F_35 ( & V_77 ) ;
...
const struct V_79 * V_122 ,
int V_123 )
{
struct V_7 * V_74 ;
T_5 V_81 = 0 ;
int V_103 ;
F_43 ( V_97 L_10 , V_123 , V_12 -> V_73 ) ;
for ( V_103 = 0 ; V_103 < V_123 ; V_103 ++ ) {
V_74 = F_40 ( V_12 , V_122 + V_103 , V_103 , V_81 ) ;
if ( F_51 ( V_74 ) )
return F_52 ( V_74 ) ;
F_35 ( & V_77 ) ;
F_54 ( & V_74 -> V_78 , & V_120 ) ;
F_39 ( & V_77 ) ;
F_55 ( & V_74 -> V_2 ) ;
...
static struct V_124 * F_58 ( const char * V_73 )
{
struct V_124 * V_72 , * V_55 = NULL ;
F_59 ( & V_125 ) ;
F_53 (p, &part_parsers, list)
if ( ! strcmp ( V_72 -> V_73 , V_73 ) && F_60 ( V_72 -> V_89 ) ) {
V_55 = V_72 ;
break;
}
F_61 ( & V_125 ) ;
...
void F_62 ( struct V_124 * V_72 )
{
F_59 ( & V_125 ) ;
F_54 ( & V_72 -> V_78 , & V_126 ) ;
F_61 ( & V_125 ) ;
}
void F_63 ( struct V_124 * V_72 )
{
F_59 ( & V_125 ) ;
F_38 ( & V_72 -> V_78 ) ;
F_61 ( & V_125 ) ;
}
int F_64 ( struct V_1 * V_12 , const char * const * V_127 ,
struct V_79 * * V_128 ,
struct V_129 * V_130 )
{
struct V_124 * V_131 ;
...
if ( ! V_127 )
V_127 = V_132 ;
for ( ; V_55 <= 0 && * V_127 ; V_127 ++ ) {
V_131 = F_58 ( * V_127 ) ;
if ( ! V_131 && ! F_65 ( L_11 , * V_127 ) )
V_131 = F_58 ( * V_127 ) ;
if ( ! V_131 )
continue;
V_55 = (* V_131 -> V_133 )( V_12 , V_128 , V_130 ) ;
F_66 ( V_131 ) ;
if ( V_55 > 0 ) {
F_43 ( V_97 L_12 ,
V_55 , V_131 -> V_73 , V_12 -> V_73 ) ;
break;
}
}
return V_55 ;
