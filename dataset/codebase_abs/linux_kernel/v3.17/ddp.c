...
V_180 = F_117 ( F_116 ( V_147 , V_144 ) , V_231 -> V_249 , V_144 ) ;
if ( V_180 ) {
F_90 ( V_147 ) ;
V_180 = - V_113 ;
goto V_42;
...
struct V_146 * V_251 = F_118 ( V_147 , V_41 ) ;
if ( V_251 ) {
V_235 = 1 ;
F_113 ( V_2 , L_16 , V_2 ) ;
...
V_180 = F_122 ( V_147 , V_148 , V_231 -> V_249 , V_255 ) ;
...
switch ( V_102 ) {
case V_260 : {
long V_261 = V_2 -> V_262 - F_125 ( V_2 ) ;
if ( V_261 < 0 )
V_261 = 0 ;
V_162 = F_126 ( V_261 , ( int T_2 * ) V_259 ) ;
break;
}
case V_263 : {
