...
{
struct V_120 * V_36 = & V_4 -> V_35 . V_36 ;
struct V_9 * V_72 ;
int V_30 ;
...
{
struct V_3 * V_4 = F_59 ( V_112 ) ;
F_13 ( V_4 ) ;
}
static int F_60 ( struct V_122 * V_37 )
{
return 0 ;
}
static int F_61 ( struct V_122 * V_37 )
{
struct V_3 * V_4 = F_62 ( V_37 ) ;
return F_16 ( V_4 ) ;
}
static int F_63 ( struct V_122 * V_37 )
{
return 0 ;
}
static int F_64 ( struct V_122 * V_37 )
{
struct V_3 * V_4 = F_62 ( V_37 ) ;
int V_30 , V_97 ;
V_97 = F_16 ( V_4 ) ;
...
static T_4 F_65 ( struct V_9 * V_72 )
{
struct V_1 * V_32 = F_27 ( V_72 ,
struct V_1 , V_9 ) ;
return V_32 -> V_89 ;
}
static struct V_73 * F_66 ( void * V_124 , int V_30 )
{
return & ( (struct V_75 * ) V_124 ) [ V_30 ] . V_73 ;
}
...
int V_127 [ V_126 ] ;
#if F_68 ( V_128 ) || F_68 ( V_129 )
unsigned long V_130 = 0 ;
int V_131 ;
#endif
int V_113 , V_30 , V_132 = 0 , V_133 = 0 , V_134 = 0 ;
struct V_3 * V_4 ;
struct V_120 * V_36 ;
struct V_135 * V_33 , * V_68 , * V_136 , * V_137 ;
if ( V_112 -> V_37 . V_85 )
V_7 = F_69 ( V_138 , & V_112 -> V_37 ) -> V_16 ;
else
V_7 = F_70 ( & V_112 -> V_37 ) ;
if ( ! V_7 || ! V_7 -> V_31 )
return - V_139 ;
V_33 = F_71 ( V_112 , V_140 , 0 ) ;
V_68 = F_71 ( V_112 , V_140 , 1 ) ;
V_136 = F_71 ( V_112 , V_141 , 0 ) ;
if ( ! V_33 || ! V_136 )
return - V_139 ;
...
V_36 = & V_4 -> V_35 . V_36 ;
V_4 -> V_14 = F_72 ( & V_112 -> V_37 , V_33 ) ;
if ( F_73 ( V_4 -> V_14 ) )
return F_74 ( V_4 -> V_14 ) ;
if ( V_68 ) {
V_4 -> V_68 = F_72 ( & V_112 -> V_37 , V_68 ) ;
if ( F_73 ( V_4 -> V_68 ) )
return F_74 ( V_4 -> V_68 ) ;
}
if ( ! V_7 -> V_142 )
F_75 ( V_143 , V_36 -> V_144 ) ;
if ( V_7 -> V_87 && V_7 -> V_88 )
F_75 ( V_145 , V_36 -> V_144 ) ;
V_36 -> V_146 = V_66 ;
V_4 -> V_35 . V_147 = & V_148 ;
V_4 -> V_35 . V_149 = sizeof( struct V_75 ) ;
V_113 = F_76 ( & V_112 -> V_37 , & V_4 -> V_35 ,
V_7 -> V_31 ) ;
if ( V_113 < 0 )
goto V_150;
V_4 -> V_7 = V_7 ;
...
F_77 ( V_112 , V_4 ) ;
F_78 ( & V_112 -> V_37 ) ;
V_113 = F_79 ( & V_112 -> V_37 ) ;
if ( V_113 < 0 )
F_51 ( & V_112 -> V_37 , L_10 , V_153 , V_113 ) ;
F_80 ( & V_25 ) ;
F_81 ( & V_4 -> V_154 , & V_155 ) ;
F_82 ( & V_25 ) ;
V_113 = F_16 ( V_4 ) ;
if ( V_113 )
goto V_156;
#if F_68 ( V_128 ) || F_68 ( V_157 )
V_137 = F_71 ( V_112 , V_141 , 1 ) ;
if ( ! V_137 )
V_137 = V_136 ;
else
V_133 ++ ;
if ( V_137 == V_136 ||
( V_136 -> V_24 & V_158 ) == V_159 )
V_130 = V_160 ;
V_131 = V_136 -> V_161 ;
V_113 = F_83 ( & V_112 -> V_37 , V_131 , F_40 , V_130 ,
L_11 , V_4 ) ;
if ( V_113 ) {
F_51 ( & V_112 -> V_37 ,
L_12 ,
...
V_137 = V_136 ;
#endif
if ( V_137 -> V_161 == V_137 -> V_163 &&
! F_71 ( V_112 , V_141 , 1 ) ) {
for (; V_132 < V_7 -> V_31 ; V_132 ++ ) {
if ( V_132 < V_126 ) {
V_127 [ V_132 ] = V_137 -> V_161 ;
V_125 [ V_132 ] = V_160 ;
} else {
V_134 = 1 ;
break;
...
do {
for ( V_30 = V_137 -> V_161 ; V_30 <= V_137 -> V_163 ; V_30 ++ ) {
if ( V_132 >= V_126 ) {
V_134 = 1 ;
break;
}
...
V_137 = F_71 ( V_112 ,
V_141 , ++ V_133 ) ;
} while ( V_132 < V_7 -> V_31 && V_137 );
}
for ( V_30 = 0 ; V_30 < V_132 ; V_30 ++ ) {
V_113 = F_48 ( V_4 , V_30 , V_127 [ V_30 ] , V_125 [ V_30 ] ) ;
if ( V_113 )
goto V_164;
}
if ( V_134 )
F_84 ( & V_112 -> V_37 , L_14
L_15 ,
V_7 -> V_31 , V_126 ) ;
F_85 ( & V_112 -> V_37 ) ;
V_113 = F_86 ( & V_4 -> V_35 . V_36 ) ;
if ( V_113 < 0 )
goto V_165;
return V_113 ;
V_165:
...
{
int V_113 = F_95 ( & V_166 ) ;
if ( V_113 )
return V_113 ;
return F_96 ( & V_167 , F_67 ) ;
}
