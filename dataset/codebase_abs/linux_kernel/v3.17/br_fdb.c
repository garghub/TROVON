...
F_69 ( V_7 , L_2
L_3 ,
V_75 ? V_75 -> V_27 -> V_79 : V_7 -> V_27 -> V_79 ) ;
F_23 ( V_7 , V_11 ) ;
}
...
static int F_75 ( struct V_87 * V_88 , const struct V_6 * V_7 ,
const struct V_2 * V_11 ,
T_3 V_89 , T_3 V_90 , int type , unsigned int V_91 )
{
unsigned long V_92 = V_14 ;
struct V_93 V_94 ;
struct V_95 * V_96 ;
struct V_97 * V_98 ;
V_96 = F_76 ( V_88 , V_89 , V_90 , type , sizeof( * V_98 ) , V_91 ) ;
if ( V_96 == NULL )
return - V_99 ;
V_98 = F_77 ( V_96 ) ;
V_98 -> V_100 = V_101 ;
...
V_98 -> V_104 = 0 ;
V_98 -> V_105 = 0 ;
V_98 -> V_106 = V_11 -> V_35 ? V_11 -> V_35 -> V_27 -> V_107 : V_7 -> V_27 -> V_107 ;
V_98 -> V_108 = F_74 ( V_11 ) ;
if ( F_78 ( V_88 , V_109 , V_71 , & V_11 -> V_23 ) )
goto V_110;
if ( F_79 ( V_88 , V_111 , V_7 -> V_27 -> V_107 ) )
goto V_110;
V_94 . V_112 = F_80 ( V_92 - V_11 -> V_77 ) ;
V_94 . V_113 = 0 ;
V_94 . V_114 = F_80 ( V_92 - V_11 -> V_13 ) ;
V_94 . V_115 = 0 ;
if ( F_78 ( V_88 , V_116 , sizeof( V_94 ) , & V_94 ) )
goto V_110;
if ( V_11 -> V_32 && F_78 ( V_88 , V_117 , sizeof( T_4 ) , & V_11 -> V_32 ) )
goto V_110;
return F_81 ( V_88 , V_96 ) ;
V_110:
F_82 ( V_88 , V_96 ) ;
return - V_99 ;
}
...
+ F_85 ( sizeof( T_3 ) )
+ F_85 ( sizeof( T_4 ) )
+ F_85 ( sizeof( struct V_93 ) ) ;
}
static void F_25 ( struct V_6 * V_7 ,
const struct V_2 * V_11 , int type )
{
struct V_118 * V_118 = F_86 ( V_7 -> V_27 ) ;
struct V_87 * V_88 ;
int V_24 = - V_119 ;
V_88 = F_87 ( F_83 () , V_76 ) ;
if ( V_88 == NULL )
goto V_120;
V_24 = F_75 ( V_88 , V_7 , V_11 , 0 , 0 , type , 0 ) ;
if ( V_24 < 0 ) {
F_88 ( V_24 == - V_99 ) ;
F_89 ( V_88 ) ;
goto V_120;
}
F_90 ( V_88 , V_118 , 0 , V_121 , NULL , V_76 ) ;
return;
V_120:
F_91 ( V_118 , V_121 , V_24 ) ;
}
int F_92 ( struct V_87 * V_88 ,
struct V_122 * V_123 ,
struct V_59 * V_27 ,
struct V_59 * V_124 ,
int V_125 )
...
struct V_2 * V_29 ;
F_55 (f, &br->hash[i], hlist) {
if ( V_125 < V_123 -> args [ 0 ] )
goto V_66;
if ( V_124 &&
( ! V_29 -> V_35 || V_29 -> V_35 -> V_27 != V_124 ) ) {
if ( V_124 != V_27 )
goto V_66;
if ( V_29 -> V_35 )
goto V_66;
}
if ( F_75 ( V_88 , V_7 , V_29 ,
F_94 ( V_123 -> V_88 ) . V_89 ,
V_123 -> V_96 -> V_128 ,
V_80 ,
V_129 ) < 0 )
break;
...
static int F_95 ( struct V_25 * V_75 , const T_7 * V_23 ,
T_2 V_62 , T_2 V_91 , T_2 V_16 )
{
...
static int F_96 ( struct V_97 * V_98 , struct V_25 * V_26 ,
...
F_32 ( & V_26 -> V_7 -> V_39 ) ;
V_24 = F_95 ( V_26 , V_23 , V_98 -> V_108 ,
V_135 , V_16 ) ;
F_34 ( & V_26 -> V_7 -> V_39 ) ;
}
return V_24 ;
}
int F_97 ( struct V_97 * V_98 , struct V_137 * V_138 [] ,
struct V_59 * V_27 ,
...
if ( ! ( V_98 -> V_108 & ( V_83 | V_84 | V_86 ) ) ) {
F_98 ( L_6 , V_98 -> V_108 ) ;
return - V_78 ;
}
if ( V_138 [ V_117 ] ) {
if ( F_99 ( V_138 [ V_117 ] ) != sizeof( unsigned short ) ) {
F_98 ( L_7 ) ;
return - V_78 ;
}
V_16 = F_100 ( V_138 [ V_117 ] ) ;
if ( ! V_16 || V_16 >= V_140 ) {
F_98 ( L_8 ,
V_16 ) ;
return - V_78 ;
...
V_43 = F_36 ( V_26 ) ;
if ( V_16 != V_139 ) {
if ( ! V_43 || ! F_103 ( V_16 , V_43 -> V_141 ) ) {
F_98 ( L_11
L_12 , V_16 , V_27 -> V_79 ) ;
return - V_78 ;
}
V_24 = F_96 ( V_98 , V_26 , V_23 , V_135 , V_16 ) ;
} else {
if ( ! V_43 || F_104 ( V_43 -> V_141 , V_139 ) ) {
V_24 = F_96 ( V_98 , V_26 , V_23 , V_135 , 0 ) ;
goto V_50;
}
F_40 (vid, pv->vlan_bitmap, VLAN_N_VID) {
V_24 = F_96 ( V_98 , V_26 , V_23 , V_135 , V_16 ) ;
...
int F_107 ( struct V_97 * V_98 , struct V_137 * V_138 [] ,
struct V_59 * V_27 ,
const unsigned char * V_23 )
{
struct V_25 * V_26 ;
