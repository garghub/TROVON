...
if ( F_49 ( V_116 ) )
return F_51 ( V_116 ) ;
snprintf ( V_65 -> V_118 , sizeof( V_65 -> V_118 ) , L_5 ,
V_114 ) ;
...
F_90 ( V_2 , V_4 ) ;
F_65 ( V_2 , & V_4 -> V_28 ) ;
if ( V_66 == 0 && F_91 ( V_117 . V_121 ) != V_122 ) {
F_92 ( L_8 ,
V_4 -> V_28 . V_12 -> V_123 -> V_124 , V_114 ,
F_91 ( V_117 . V_121 ) ) ;
return - V_108 ;
} else if ( V_66 < 0 ) {
F_92 ( L_9 ,
V_4 -> V_28 . V_12 -> V_123 -> V_124 , V_114 , V_66 ) ;
return V_66 ;
}
* V_115 = F_91 ( V_117 . V_125 ) ;
return V_66 ;
}
...
struct V_57 * V_4 = NULL ;
struct V_62 * V_63 ;
T_2 V_115 = F_94 ( V_126 ) ;
int V_66 = 0 ;
V_8 = F_21 ( V_33 ) ;
if ( F_49 ( V_8 ) )
return F_51 ( V_8 ) ;
F_19 ( & V_8 -> V_39 ) ;
* V_46 = F_83 ( V_8 , F_95 ( V_126 ) ) ;
if ( * V_46 != NULL )
GOTO ( V_78 , V_66 = 0 ) ;
F_11 ( * V_46 ) ;
if ( * V_46 == NULL )
...
( * V_46 ) -> V_49 = & V_8 -> V_13 ;
F_17 ( & V_8 -> V_35 ) ;
F_27 ( & ( * V_46 ) -> V_127 , & V_8 -> V_38 ) ;
V_65 -> V_93 . V_52 = F_95 ( V_126 ) ;
V_65 -> V_93 . V_54 = V_128 ;
V_65 -> V_93 . V_56 = 0 ;
V_4 = F_47 ( V_2 , V_8 , & V_65 -> V_93 ) ;
if ( F_49 ( V_4 ) )
GOTO ( V_129 , V_66 = F_51 ( V_4 ) ) ;
if ( ! F_38 ( V_4 ) ) {
V_66 = F_86 ( V_2 , V_33 , F_95 ( V_126 ) ,
& V_115 , V_8 ) ;
if ( V_66 < 0 )
GOTO ( V_129 , V_66 ) ;
V_63 = F_50 ( V_2 , V_33 ) ;
if ( F_49 ( V_63 ) )
GOTO ( V_129 , V_66 = F_51 ( V_63 ) ) ;
V_65 -> V_95 . V_96 = V_97 | V_130 ;
V_65 -> V_95 . V_98 = V_131 | V_132 | V_133 ;
V_65 -> V_81 . V_82 = F_69 ( V_131 ) ;
...
V_66 = F_89 ( V_2 , V_4 , & V_65 -> V_68 , & V_65 -> V_74 ) ;
F_90 ( V_2 , V_4 ) ;
if ( V_66 == 0 && F_96 ( V_73 ) > V_136 ) {
F_92 ( L_10 ,
V_4 -> V_28 . V_12 -> V_123 -> V_124 ,
F_96 ( V_73 ) ) ;
V_66 = - V_108 ;
}
}
