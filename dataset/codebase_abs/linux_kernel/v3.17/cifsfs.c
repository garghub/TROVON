...
static int F_103 ( struct V_58 * V_58 , long V_217 , struct V_218 * * V_219 )
{
struct V_7 * V_7 = F_88 ( V_58 ) ;
...
return - V_223 ;
if ( V_217 == V_224 ||
( ( V_217 == V_225 ) && F_98 ( F_36 ( V_7 ) ) ) ||
( ( V_217 == V_226 ) && F_94 ( F_36 ( V_7 ) ) ) )
return F_105 ( V_58 , V_217 , V_219 ) ;
else if ( F_106 ( V_221 -> V_227 ) -> V_228 &&
! F_98 ( F_36 ( V_7 ) ) )
return F_105 ( V_58 , V_217 , V_219 ) ;
else
return - V_229 ;
...
V_269 = F_126 ( L_76 , V_270 | V_271 , 0 ) ;
if ( ! V_269 ) {
V_11 = - V_39 ;
goto V_272;
}
