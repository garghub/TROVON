...
if ( F_71 ( & V_1 -> V_163 , V_176 , V_177 ) < 0 ) {
F_68 ( V_1 -> V_86 ) ;
F_57 ( V_1 ) ;
return - V_175 ;
}
...
for ( V_179 = 0 ; V_179 < V_173 && V_143 [ V_179 ] ; V_179 ++ ) {
char * V_180 ;
unsigned long V_181 ;
V_181 = F_76 ( V_143 [ V_179 ] , & V_180 , 0 ) ;
if ( V_180 == V_143 [ V_179 ] ) {
F_18 ( V_18
L_16 ,
V_143 [ V_179 ] ) ;
continue;
}
if ( V_181 == V_144 -> V_182 )
return 1 ;
}
return 0 ;
}
