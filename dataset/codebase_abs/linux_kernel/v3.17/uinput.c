...
unsigned int V_70 ;
int V_71 ;
if ( ! F_26 ( V_72 , V_2 -> V_45 ) )
return 0 ;
for ( V_70 = 0 ; V_70 < V_73 ; V_70 ++ ) {
int V_74 , V_75 ;
if ( ! F_26 ( V_70 , V_2 -> V_76 ) )
continue;
V_74 = F_43 ( V_2 , V_70 ) ;
V_75 = F_44 ( V_2 , V_70 ) ;
if ( ( V_74 != 0 || V_75 != 0 ) && V_75 <= V_74 ) {
F_32 ( V_54
L_2 ,
V_55 , V_70 ,
F_43 ( V_2 , V_70 ) ,
...
if ( F_26 ( V_77 , V_2 -> V_76 ) ) {
V_71 = F_44 ( V_2 , V_77 ) + 1 ;
F_46 ( V_2 , V_71 , 0 ) ;
} else if ( F_26 ( V_78 , V_2 -> V_76 ) ) {
F_47 ( V_2 , 60 ) ;
}
return 0 ;
}
...
V_2 = V_6 -> V_2 ;
V_83 = F_52 ( V_80 , sizeof( struct V_82 ) ) ;
if ( F_53 ( V_83 ) )
return F_54 ( V_83 ) ;
V_6 -> V_56 = V_83 -> V_56 ;
if ( ! V_83 -> V_48 [ 0 ] ) {
...
F_30 ( V_2 -> V_48 ) ;
V_2 -> V_48 = F_55 ( V_83 -> V_48 , V_84 ,
V_67 ) ;
if ( ! V_2 -> V_48 ) {
V_20 = - V_68 ;
goto exit;
}
V_2 -> V_13 . V_85 = V_83 -> V_13 . V_85 ;
V_2 -> V_13 . V_86 = V_83 -> V_13 . V_86 ;
V_2 -> V_13 . V_87 = V_83 -> V_13 . V_87 ;
V_2 -> V_13 . V_88 = V_83 -> V_13 . V_88 ;
for ( V_27 = 0 ; V_27 < V_73 ; V_27 ++ ) {
F_56 ( V_2 , V_27 , V_83 -> V_89 [ V_27 ] ) ;
F_57 ( V_2 , V_27 , V_83 -> V_90 [ V_27 ] ) ;
F_58 ( V_2 , V_27 , V_83 -> V_91 [ V_27 ] ) ;
F_59 ( V_2 , V_27 , V_83 -> V_92 [ V_27 ] ) ;
}
V_20 = F_42 ( V_2 ) ;
if ( V_20 < 0 )
goto exit;
...
if ( V_81 != 0 && V_81 < F_61 () )
return - V_42 ;
while ( V_95 + F_61 () <= V_81 ) {
if ( F_62 ( V_80 + V_95 , & V_94 ) )
return - V_96 ;
...
static T_4 F_63 ( struct V_65 * V_65 , const char T_2 * V_80 ,
T_3 V_81 , T_5 * V_97 )
{
...
char T_2 * V_80 , T_3 V_81 )
{
struct V_93 V_79 ;
T_3 V_101 = 0 ;
while ( V_101 + F_61 () <= V_81 &&
F_64 ( V_6 , & V_79 ) ) {
if ( F_68 ( V_80 + V_101 , & V_79 ) )
return - V_96 ;
V_101 += F_61 () ;
}
return V_101 ;
}
static T_4 F_69 ( struct V_65 * V_65 , char T_2 * V_80 ,
T_3 V_81 , T_5 * V_97 )
{
struct V_5 * V_6 = V_65 -> V_69 ;
T_4 V_20 ;
...
static int F_75 ( const char T_2 * V_80 ,
struct V_108 * V_109 )
{
if ( V_110 ) {
struct V_111 V_112 ;
...
const struct V_108 * V_109 )
{
if ( F_74 ( V_80 , V_109 , sizeof( struct V_108 ) ) )
return - V_96 ;
return 0 ;
}
static int F_75 ( const char T_2 * V_80 ,
struct V_108 * V_109 )
{
if ( F_76 ( V_109 , V_80 , sizeof( struct V_108 ) ) )
return - V_96 ;
return 0 ;
}
...
goto V_25;
case V_132 :
V_20 = F_80 ( V_123 , V_45 , V_133 ) ;
goto V_25;
case V_134 :
V_20 = F_80 ( V_123 , V_135 , V_136 ) ;
goto V_25;
case V_137 :
V_20 = F_80 ( V_123 , V_138 , V_139 ) ;
goto V_25;
case V_140 :
V_20 = F_80 ( V_123 , V_76 , V_141 ) ;
goto V_25;
case V_142 :
V_20 = F_80 ( V_123 , V_143 , V_144 ) ;
goto V_25;
case V_145 :
V_20 = F_80 ( V_123 , V_146 , V_147 ) ;
goto V_25;
case V_148 :
V_20 = F_80 ( V_123 , V_149 , V_150 ) ;
goto V_25;
case V_151 :
V_20 = F_80 ( V_123 , V_152 , V_153 ) ;
goto V_25;
case V_154 :
V_20 = F_80 ( V_123 , V_155 , V_156 ) ;
goto V_25;
case V_157 :
V_20 = F_80 ( V_123 , V_158 , V_159 ) ;
goto V_25;
case V_160 :
if ( V_6 -> V_22 == V_23 ) {
V_20 = - V_42 ;
