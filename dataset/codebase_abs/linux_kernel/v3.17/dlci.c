...
static int F_40 ( unsigned int V_53 , void T_2 * V_86 )
{
struct F_26 V_87 ;
int V_45 ;
if ( ! F_18 ( V_54 ) )
return - V_55 ;
if ( F_15 ( & V_87 , V_86 , sizeof( struct F_26 ) ) )
return - V_46 ;
switch ( V_53 )
{
case V_88 :
V_45 = F_26 ( & V_87 ) ;
if ( ! V_45 )
if ( F_16 ( V_86 , & V_87 , sizeof( struct F_26 ) ) )
return - V_46 ;
break;
case V_89 :
V_45 = F_36 ( & V_87 ) ;
...
V_34 -> V_94 = F_4 ;
V_4 -> type = V_95 ;
V_4 -> V_96 = sizeof( struct V_8 ) ;
V_4 -> V_97 = sizeof( short ) ;
}
static int F_41 ( struct V_98 * V_99 ,
unsigned long V_100 , void * V_101 )
{
struct V_3 * V_4 = F_42 ( V_101 ) ;
if ( F_43 ( V_4 ) != & V_70 )
return V_102 ;
if ( V_100 == V_103 ) {
struct V_33 * V_34 ;
