...
struct V_156 * V_157 )
{
struct V_158 * V_159 = F_46 ( F_47 ( V_157 ) ) ;
struct V_35 * V_36 = V_23 -> V_36 ;
struct V_90 * V_119 ;
int V_96 ;
V_119 = F_48 () ;
...
snprintf ( V_23 -> V_160 , sizeof( V_23 -> V_160 ) , L_57 ,
V_161 [ V_23 -> V_162 ] . V_160 ?
V_161 [ V_23 -> V_162 ] . V_160 :
L_58 ,
F_49 ( V_23 -> V_78 -> V_163 . V_164 ) ,
F_49 ( V_23 -> V_78 -> V_163 . V_165 ) ) ;
F_50 ( V_23 -> V_78 , V_23 -> V_166 , sizeof( V_23 -> V_166 ) ) ;
V_119 -> V_167 = V_23 -> V_160 ;
V_119 -> V_168 = V_23 -> V_166 ;
F_51 ( V_23 -> V_78 , & V_119 -> V_169 ) ;
V_119 -> V_36 . V_170 = V_36 ;
V_119 -> V_93 = V_23 ;
V_119 -> V_171 = V_172 ;
V_119 -> V_173 = V_174 ;
V_119 -> V_120 = F_52 ( 100 ) ;
if ( ! V_23 -> V_41 . V_151 ) {
V_119 -> V_175 = F_25 ;
V_119 -> V_176 = F_26 ;
V_119 -> V_177 = F_24 ;
...
if ( V_161 [ V_23 -> V_162 ] . V_186 )
V_119 -> V_181 = V_161 [ V_23 -> V_162 ] . V_186 ;
V_96 = F_53 ( V_119 ) ;
if ( V_96 < 0 ) {
F_8 ( V_36 , L_59 ) ;
goto V_27;
...
int V_72 , V_195 , V_94 ;
char V_24 [ 63 ] , V_160 [ 128 ] = L_15 ;
enum V_196 V_162 = V_188 -> V_197 ;
bool V_198 ;
bool V_199 ;
bool V_108 ;
int V_200 ;
F_4 ( & V_157 -> V_36 , L_60 , V_140 ) ;
V_190 = V_157 -> V_201 ;
V_198 = V_161 [ V_162 ] . V_202 ;
V_199 = V_161 [ V_162 ] . V_203 ;
V_108 = V_161 [ V_162 ] . V_108 ;
V_200 = V_161 [ V_162 ] . V_200 ;
...
V_72 = F_61 ( V_36 , V_193 -> V_79 ) ;
V_195 = F_62 ( V_36 , V_72 , F_63 ( V_72 ) ) ;
V_23 = F_14 ( sizeof( struct V_22 ) , V_76 ) ;
if ( ! V_23 )
goto V_209;
V_23 -> V_116 = F_64 ( V_36 , V_195 , V_86 , & V_23 -> V_210 ) ;
if ( ! V_23 -> V_116 )
goto V_211;
...
goto V_212;
V_23 -> V_78 = V_36 ;
V_23 -> V_36 = & V_157 -> V_36 ;
V_23 -> V_213 = V_195 ;
V_23 -> V_41 . V_42 = V_199 ;
V_23 -> V_41 . V_108 = V_108 ;
V_23 -> V_41 . V_151 = V_161 [ V_162 ] . V_151 ;
V_23 -> V_162 = V_162 ;
V_23 -> V_77 = V_194 ;
if ( V_36 -> V_163 . V_214
&& F_65 ( V_36 , V_36 -> V_163 . V_214 ,
V_24 , sizeof( V_24 ) ) > 0 )
F_66 ( V_160 , V_24 , sizeof( V_160 ) ) ;
if ( V_36 -> V_163 . V_215
&& F_65 ( V_36 , V_36 -> V_163 . V_215 ,
V_24 , sizeof( V_24 ) ) > 0 )
snprintf ( V_160 + strlen ( V_160 ) , sizeof( V_160 ) - strlen ( V_160 ) ,
L_66 , V_24 ) ;
V_23 -> V_119 = F_45 ( V_23 , V_157 ) ;
if ( ! V_23 -> V_119 )
goto V_216;
...
F_68 ( V_23 -> V_36 , true ) ;
F_69 ( V_23 -> V_36 , true ) ;
F_70 ( & V_157 -> V_36 , L_68 ,
V_160 , V_23 -> V_123 ) ;
F_70 ( & V_157 -> V_36 , L_69 ,
...
F_10 ( V_23 -> V_82 ) ;
V_212:
F_71 ( V_36 , V_195 , V_23 -> V_116 , V_23 -> V_210 ) ;
V_211:
F_9 ( V_23 ) ;
V_209:
F_8 ( & V_157 -> V_36 , L_70 , V_140 ) ;
return - V_220 ;
}
static void F_72 ( struct V_156 * V_157 )
{
struct V_158 * V_36 = F_47 ( V_157 ) ;
struct V_22 * V_23 = F_73 ( V_157 ) ;
F_67 ( V_157 , NULL ) ;
if ( ! V_23 )
return;
V_23 -> V_78 = NULL ;
...
F_75 ( V_23 -> V_82 ) ;
F_10 ( V_23 -> V_82 ) ;
F_71 ( V_36 , V_23 -> V_213 , V_23 -> V_116 , V_23 -> V_210 ) ;
F_9 ( V_23 ) ;
}
static int F_76 ( struct V_156 * V_157 , T_3 V_221 )
{
struct V_22 * V_23 = F_73 ( V_157 ) ;
F_70 ( V_23 -> V_36 , L_71 ) ;
F_75 ( V_23 -> V_82 ) ;
