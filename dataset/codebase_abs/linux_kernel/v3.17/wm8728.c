...
struct V_29 * V_30 ;
int V_41 ;
V_30 = F_15 ( & V_40 -> V_42 , sizeof( struct V_29 ) ,
V_43 ) ;
if ( V_30 == NULL )
return - V_44 ;
V_30 -> V_38 = F_16 ( V_40 , & V_45 ) ;
if ( F_17 ( V_30 -> V_38 ) )
return F_18 ( V_30 -> V_38 ) ;
F_19 ( V_40 , V_30 ) ;
V_41 = F_20 ( & V_40 -> V_42 ,
& V_46 , & V_47 , 1 ) ;
return V_41 ;
...
struct V_29 * V_30 ;
int V_41 ;
V_30 = F_15 ( & V_49 -> V_42 , sizeof( struct V_29 ) ,
V_43 ) ;
if ( V_30 == NULL )
return - V_44 ;
V_30 -> V_38 = F_24 ( V_49 , & V_45 ) ;
if ( F_17 ( V_30 -> V_38 ) )
return F_18 ( V_30 -> V_38 ) ;
F_25 ( V_49 , V_30 ) ;
V_41 = F_20 ( & V_49 -> V_42 ,
...
static int F_26 ( struct V_48 * V_52 )
{
F_22 ( & V_52 -> V_42 ) ;
return 0 ;
}
