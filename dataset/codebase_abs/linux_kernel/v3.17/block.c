...
struct V_19 * V_20 ;
struct V_62 * V_25 ;
T_4 V_71 = ( ( T_4 ) V_70 -> V_72 * V_70 -> V_73 ) >> 9 ;
int V_5 ;
if ( ( T_3 ) V_71 != V_71 )
return - V_74 ;
F_19 ( & V_75 ) ;
...
F_21 ( & V_75 ) ;
V_20 = F_39 ( sizeof( struct V_19 ) , V_77 ) ;
if ( ! V_20 )
return - V_78 ;
F_40 ( & V_20 -> V_40 ) ;
V_20 -> V_16 = V_70 -> V_16 ;
...
F_19 ( & V_20 -> V_40 ) ;
F_42 ( V_20 -> V_25 , V_71 ) ;
F_49 ( L_13 , V_20 -> V_25 -> V_26 , V_70 -> V_72 ) ;
F_21 ( & V_20 -> V_40 ) ;
F_21 ( & V_75 ) ;
return 0 ;
}
...
V_103 = & V_7 [ V_4 ] ;
V_24 = F_60 ( V_103 -> V_18 , V_103 -> V_16 , V_103 -> V_17 ) ;
if ( F_33 ( V_24 ) ) {
F_4 ( L_14 ,
F_34 ( V_24 ) ) ;
V_5 = F_34 ( V_24 ) ;
