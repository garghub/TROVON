...
F_18 ( V_2 -> V_44 , V_2 -> V_29 + 0x1 ) ;
F_18 ( V_30 | V_45 , V_2 -> V_29 + 0x0 ) ;
F_18 ( V_2 -> clock , V_2 -> V_29 + 0x1 ) ;
F_18 ( V_46 , V_2 -> V_29 + 0x0 ) ;
}
static struct V_1 * F_25 ( struct V_3 * V_4 , int V_11 )
{
struct V_1 * V_2 ;
struct V_47 * V_48 ;
int V_49 ;
...
F_26 ( & V_2 -> V_50 ) ;
F_26 ( & V_2 -> V_51 ) ;
V_2 -> V_29 = F_27 ( & V_4 -> V_52 [ 0 ] , 0 , 0x2 , L_2 ) ;
if ( ! V_2 -> V_29 )
goto V_53;
if ( V_4 -> V_54 == 2 ) {
V_2 -> V_32 = F_27 ( & V_4 -> V_52 [ 1 ] , 0 , 0x1 , L_3 ) ;
if ( ! V_2 -> V_32 )
goto V_53;
}
V_2 -> V_27 = 0 ;
F_28 ( & V_2 -> V_28 ) ;
if ( F_29 ( V_4 -> V_55 . V_56 [ 0 ] , F_22 ,
V_57 , L_4 , V_2 ) )
goto V_53;
V_2 -> V_11 = V_11 ;
V_2 -> V_4 = V_4 ;
F_30 ( & V_2 -> V_58 ) ;
V_49 = 0 ;
for ( V_48 = V_4 -> V_18 . V_19 -> V_59 ;
V_48 && V_49 < 8 ;
V_48 = V_48 -> V_60 , V_49 ++ ) {
struct V_3 * V_61 ;
V_61 = F_31 ( V_48 ) ;
V_2 -> V_8 [ V_49 ] . V_9 = V_61 ;
V_2 -> V_8 [ V_49 ] . V_10 = 0 ;
}
F_18 ( V_30 , V_2 -> V_29 + 0x0 ) ;
V_2 -> V_44 = F_14 ( V_2 -> V_29 + 0x01 ) ;
F_18 ( V_30 | V_45 , V_2 -> V_29 + 0x0 ) ;
V_2 -> clock = F_14 ( V_2 -> V_29 + 0x01 ) ;
F_32 ( V_62 L_5 ,
V_2 -> V_11 , V_2 -> V_29 , V_49 , V_2 -> V_44 , V_2 -> clock ) ;
F_24 ( V_2 ) ;
return V_2 ;
V_53:
if ( V_2 -> V_32 )
F_33 ( & V_4 -> V_52 [ 1 ] , V_2 -> V_32 , 1 ) ;
if ( V_2 -> V_29 )
F_33 ( & V_4 -> V_52 [ 0 ] , V_2 -> V_29 , 2 ) ;
F_6 ( V_2 ) ;
return NULL ;
}
...
V_63 = F_35 ( V_2 ) ;
if ( V_63 ) {
F_36 ( V_4 -> V_55 . V_56 [ 0 ] , V_2 ) ;
if ( V_2 -> V_32 )
F_33 ( & V_4 -> V_52 [ 0 ] , V_2 -> V_32 , 1 ) ;
if ( V_2 -> V_29 )
F_33 ( & V_4 -> V_52 [ 1 ] , V_2 -> V_29 , 2 ) ;
F_6 ( V_2 ) ;
} else {
F_37 ( & V_4 -> V_18 , V_2 ) ;
}
