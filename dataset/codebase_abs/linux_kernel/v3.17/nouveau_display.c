...
F_77 ( & V_7 -> V_151 , V_40 ) ;
V_29 = F_78 ( V_142 -> V_135 . V_153 , V_141 ) ;
if ( V_29 )
goto V_154;
V_29 = F_79 ( V_141 , 2 ) ;
if ( V_29 )
...
F_80 ( V_141 , V_156 , V_157 , 1 ) ;
else
F_81 ( V_141 , V_158 , V_157 , 1 ) ;
...
if ( ! V_141 )
return - V_123 ;
V_164 = ( void * ) F_87 ( & V_141 -> V_97 -> V_6 ) ;
...
F_88 ( & V_164 -> V_167 ) ;
F_89 ( & V_143 -> V_135 . V_168 -> V_169 ) ;
V_150 = F_90 ( V_143 -> V_135 . V_153 ) ;
F_91 ( & V_143 -> V_135 . V_168 -> V_169 ) ;
V_29 = F_78 ( V_150 , V_141 ) ;
F_92 ( & V_150 ) ;
if ( V_29 )
goto V_170;
V_29 = F_93 ( & V_142 -> V_135 , true , false , false , NULL ) ;
if ( V_29 )
goto V_170;
* V_145 = (struct V_144 )
{ { } , V_160 , V_3 ( V_13 ) -> V_8 ,
V_49 -> V_171 , V_49 -> V_172 [ 0 ] , V_13 -> V_173 , V_13 -> V_174 ,
V_143 -> V_135 . V_134 } ;
F_94 ( V_7 , V_3 ( V_13 ) -> V_8 ) ;
if ( V_92 -> V_97 . V_100 . V_101 >= V_105 ) {
V_29 = F_95 ( V_13 , V_49 , V_141 , V_161 ) ;
if ( V_29 )
goto V_175;
} else {
struct V_176 * V_177 = V_176 ( V_7 ) ;
int V_11 = V_3 ( V_13 ) -> V_8 ;
if ( V_161 ) {
V_29 = F_79 ( V_141 , 8 ) ;
if ( V_29 )
goto V_175;
F_80 ( V_141 , V_178 , 0x012c , 1 ) ;
F_82 ( V_141 , 0 ) ;
F_80 ( V_141 , V_178 , 0x0134 , 1 ) ;
F_82 ( V_141 , V_11 ) ;
F_80 ( V_141 , V_178 , 0x0100 , 1 ) ;
F_82 ( V_141 , 0 ) ;
F_80 ( V_141 , V_178 , 0x0130 , 1 ) ;
F_82 ( V_141 , 0 ) ;
}
F_96 ( V_143 , & V_177 -> V_179 [ V_11 ] ) ;
}
...
int V_181 = - 1 ;
F_75 ( & V_7 -> V_151 , V_40 ) ;
if ( F_102 ( & V_149 -> V_152 ) ) {
F_70 ( V_92 , L_10 ) ;
F_77 ( & V_7 -> V_151 , V_40 ) ;
return - V_14 ;
}
V_145 = F_103 ( & V_149 -> V_152 , struct V_144 , V_11 ) ;
if ( V_145 -> V_160 ) {
if ( V_92 -> V_97 . V_100 . V_101 >= V_105 )
V_181 = V_145 -> V_13 ;
F_104 ( V_7 , V_181 , V_145 -> V_160 ) ;
}
F_100 ( V_7 , V_145 -> V_13 ) ;
F_85 ( & V_145 -> V_11 ) ;
if ( V_180 )
* V_180 = * V_145 ;
F_27 ( V_145 ) ;
...
struct V_91 * V_92 = V_141 -> V_92 ;
struct V_144 V_183 ;
if ( ! F_101 ( V_141 , & V_183 ) ) {
if ( V_92 -> V_97 . V_100 . V_101 < V_105 ) {
F_106 ( V_92 -> V_7 , V_183 . V_13 , V_183 . V_134 +
V_183 . V_174 * V_183 . V_184 +
V_183 . V_173 * V_183 . V_185 / 8 ) ;
}
}
return 0 ;
}
int
F_107 ( struct V_53 * V_54 , struct V_10 * V_7 ,
struct V_186 * args )
{
struct V_59 * V_135 ;
int V_29 ;
args -> V_184 = F_108 ( args -> V_187 * ( args -> V_185 / 8 ) , 256 ) ;
args -> V_188 = args -> V_184 * args -> V_189 ;
args -> V_188 = F_108 ( args -> V_188 , V_190 ) ;
V_29 = F_109 ( V_7 , args -> V_188 , 0 , V_191 , 0 , 0 , & V_135 ) ;
if ( V_29 )
return V_29 ;
