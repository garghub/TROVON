...
static int F_58 ( struct V_5 * V_21 , enum V_110 V_111 ,
unsigned long V_65 )
{
struct V_1 * V_2 = F_6 ( V_21 ) ;
struct V_3 * V_4 = F_2 ( V_21 -> V_6 ) ;
...
F_30 ( & V_2 -> V_25 , V_71 ) ;
V_8 -> V_78 ( V_2 ) ;
if ( V_8 -> V_115 && ! F_8 ( & V_2 -> V_26 ) ) {
struct V_9 * V_19 = F_59 ( & V_2 -> V_26 ,
struct V_9 , V_29 ) ;
V_19 -> V_88 = V_8 -> V_115 ( V_2 , V_19 ) ;
}
F_36 ( & V_2 -> V_25 , V_71 ) ;
F_37 ( V_2 , true ) ;
break;
...
if ( ! V_65 )
return - V_50 ;
V_113 = (struct V_112 * ) V_65 ;
V_35 = F_20 ( V_2 , V_113 -> V_41 ,
V_113 -> V_84 == V_91 ?
...
static enum V_120 F_61 ( struct V_5 * V_21 ,
T_1 V_23 ,
struct V_121 * V_122 )
{
struct V_1 * V_2 = F_6 ( V_21 ) ;
...
static T_5 F_67 ( int V_129 , void * V_33 )
{
struct V_1 * V_2 = V_33 ;
...
T_5 V_35 ;
F_65 ( & V_2 -> V_25 ) ;
V_35 = V_8 -> F_67 ( V_2 , V_129 ) ? V_130 : V_131 ;
F_66 ( & V_2 -> V_25 ) ;
return V_35 ;
}
static T_5 F_68 ( int V_129 , void * V_33 )
{
struct V_1 * V_2 = V_33 ;
const struct V_7 * V_8 =
F_2 ( V_2 -> V_5 . V_6 ) -> V_8 ;
...
int F_69 ( struct V_1 * V_2 , int V_129 ,
unsigned long V_71 , const char * V_134 )
{
int V_35 = F_70 ( V_2 -> V_33 , V_129 , F_67 ,
F_68 , V_71 , V_134 , V_2 ) ;
V_2 -> V_129 = V_35 < 0 ? V_35 : V_129 ;
return V_35 ;
}
...
{
V_2 -> V_36 = V_39 ;
V_2 -> V_5 . V_6 = & V_4 -> V_135 ;
F_72 ( & V_2 -> V_5 ) ;
V_2 -> V_33 = V_4 -> V_135 . V_33 ;
V_2 -> V_34 = V_34 ;
if ( ! V_2 -> V_99 )
V_2 -> V_99 = V_136 ;
F_73 ( & V_2 -> V_25 ) ;
...
! V_4 -> V_8 -> V_132 )
return - V_50 ;
V_4 -> V_2 = F_24 ( V_140 , sizeof( * V_4 -> V_2 ) , V_59 ) ;
if ( ! V_4 -> V_2 )
return - V_60 ;
F_74 ( & V_135 -> V_138 ) ;
V_135 -> V_66
