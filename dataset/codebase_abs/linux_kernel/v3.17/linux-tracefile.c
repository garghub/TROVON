...
void F_28 ( struct V_3 * V_4 , int V_23 )
{
F_22 ( V_4 -> V_14 < V_7 ) ;
if ( V_4 -> V_14 == V_20 )
F_29 ( & V_4 -> V_11 , V_4 -> V_24 ) ;
else if ( V_4 -> V_14 == V_21 )
F_30 ( & V_4 -> V_11 ) ;
else if ( F_25 ( V_23 ) )
F_31 ( & V_4 -> V_11 ) ;
...
void F_39 ( struct V_28 * V_53 , int V_56 ,
