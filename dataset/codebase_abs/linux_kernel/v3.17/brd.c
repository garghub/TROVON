...
static struct V_105 * F_70 ( T_7 V_106 , int * V_107 , void * V_108 )
{
struct V_2 * V_3 ;
struct V_105 * V_109 ;
F_43 ( & V_110 ) ;
V_3 = F_63 ( F_71 ( V_106 ) >> V_91 ) ;
V_109 = V_3 ? F_72 ( V_3 -> V_90 ) : NULL ;
F_45 ( & V_110 ) ;
* V_107 = 0 ;
return V_109 ;
}
...
F_64 (brd, &brd_devices, brd_list)
F_65 ( V_3 -> V_90 ) ;
F_76 ( F_77 ( V_94 , 0 ) , V_112 ,
V_120 , F_70 , NULL , NULL ) ;
F_78 ( V_121 L_3 ) ;
return 0 ;
V_119:
...
unsigned long V_112 ;
struct V_2 * V_3 , * V_113 ;
V_112 = V_116 ? V_116 << V_91 : 1UL << V_117 ;
F_79 (brd, next, &brd_devices, brd_list)
F_67 ( V_3 ) ;
F_82 ( F_77 ( V_94 , 0 ) , V_112 ) ;
F_80 ( V_94 , L_2 ) ;
}
