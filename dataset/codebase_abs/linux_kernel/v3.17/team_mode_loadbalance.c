...
static int F_39 ( struct V_2 * V_2 , struct V_39 * V_40 )
{
struct V_1 * V_1 = F_1 ( V_2 ) ;
T_1 * V_19 ;
char * V_24 ;
...
static int F_41 ( struct V_2 * V_2 , struct V_39 * V_40 )
{
struct V_1 * V_1 = F_1 ( V_2 ) ;
T_1 * V_19 ;
...
static int F_49 ( struct V_2 * V_2 , struct V_39 * V_40 )
{
struct V_1 * V_1 = F_1 ( V_2 ) ;
unsigned char V_17 = V_40 -> V_59 -> V_60 ;
...
static int F_51 ( struct V_2 * V_2 , struct V_39 * V_40 )
{
...
static bool F_53 ( struct V_67 * V_68 ,
struct V_2 * V_2 )
{
...
static void F_54 ( struct V_32 * V_70 ,
struct V_32 * V_71 ,
struct V_72 * V_35 )
{
unsigned int V_73 ;
...
int V_8 ;
int V_78 ;
V_77 = F_58 ( V_76 , struct V_77 ,
V_65 . V_79 . V_76 ) ;
V_2 = V_77 -> V_2 ;
V_1 = F_1 ( V_2 ) ;
if ( ! F_59 ( & V_2 -> V_56 ) ) {
F_60 ( & V_77 -> V_65 . V_79 , 0 ) ;
return;
}
...
if ( V_82 )
F_60 ( & V_1 -> V_12 -> V_65 . V_79 , 0 ) ;
else
F_66 ( & V_1 -> V_12 -> V_65 . V_79 ) ;
return 0 ;
}
...
F_40 ( ! V_19 ) ;
F_36 ( V_1 -> V_36 , V_19 ) ;
V_1 -> V_12 = F_68 ( sizeof( * V_1 -> V_12 ) , V_52 ) ;
if ( ! V_1 -> V_12 )
return - V_53 ;
V_1 -> V_12 -> V_2 = V_2 ;
V_1 -> V_31 = F_69 ( struct V_30 ) ;
if ( ! V_1 -> V_31 ) {
V_55 = - V_53 ;
goto V_83;
}
F_61 (i) {
struct V_30 * V_84 ;
V_84 = F_62 ( V_1 -> V_31 , V_8 ) ;
F_70 ( & V_84 -> V_35 ) ;
}
F_71 ( & V_1 -> V_12 -> V_65 . V_79 , F_57 ) ;
V_55 = F_72 ( V_2 , V_85 , F_73 ( V_85 ) ) ;
if ( V_55 )
goto V_86;
return 0 ;
V_86:
...
F_76 ( V_2 , V_85 ,
F_73 ( V_85 ) ) ;
F_77 ( & V_1 -> V_12 -> V_65 . V_79 ) ;
F_74 ( V_1 -> V_31 ) ;
F_30 ( V_1 -> V_12 ) ;
}
static int F_78 ( struct V_2 * V_2 , struct V_5 * V_6 )
{
struct V_4 * V_4 = F_2 ( V_6 ) ;
V_4 -> V_31 = F_69 ( struct V_32 ) ;
if ( ! V_4 -> V_31 )
return - V_53 ;
return 0 ;
}
...
static void F_80 ( struct V_2 * V_2 , struct V_5 * V_6 )
{
F_3 ( V_2 , V_6 ) ;
}
