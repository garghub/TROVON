...
static int F_99 ( struct V_178 * V_15 )
{
T_7 V_184 ;
...
int V_21 = 0 ;
F_3 ( V_28 , L_27 ) ;
V_184 = F_100 ( V_6 -> V_14 [ 1 ] ) ;
if ( ! ( V_184 & V_185 ) ) {
F_15 ( L_42 ) ;
return - V_57 ;
}
F_96 ( & V_6 -> V_17 , true ) ;
V_21 = F_101 ( V_6 -> V_14 [ 1 ] , V_185 ) ;
if ( V_21 ) {
F_15 ( L_43 ) ;
F_96 ( & V_6 -> V_17 , false ) ;
return V_21 ;
...
static int F_103 ( struct V_178 * V_15 )
{
struct V_3 * V_4 = F_2 ( V_15 ) ;
struct V_5 * V_6 = V_4 -> V_7 . V_8 ;
F_3 ( V_28 , L_27 ) ;
F_102 ( V_6 -> V_11 , V_186 ) ;
F_96 ( & V_6 -> V_17 , false ) ;
return 0 ;
}
static int T_8 F_104 ( struct V_187 * V_188 )
{
F_3 ( V_28 , L_27 ) ;
V_182 = F_105 ( & V_188 -> V_15 ) ;
if ( V_182 -> V_189 )
V_182 -> V_189 () ;
return 0 ;
}
