...
break;
case V_63 :
V_10 -> V_26 [ V_36 ] . V_27 |= V_64 ;
break;
case V_65 :
break;
}
F_23 ( V_10 , V_36 , V_10 -> V_66 ) ;
}
...
V_10 -> V_69 [ V_36 ] . V_70 = 0 ;
V_10 -> V_69 [ V_36 ] . V_71 = V_72 ;
}
V_10 -> V_48 = 0 ;
}
static inline T_1 F_24 ( struct V_9 * V_10 , int V_21 )
{
return V_10 -> V_26 [ V_21 ] . V_73 ;
}
...
static inline T_1 F_26 ( struct V_9 * V_10 , int V_21 )
{
return V_10 -> V_26 [ V_21 ] . V_27 ;
}
static inline void F_23 ( struct V_9 * V_10 , int V_21 ,
T_1 V_76 )
{
...
for ( V_36 = 0 ; V_36 < V_10 -> V_44 ; V_36 ++ ) {
int V_85 = V_86 - V_36 ;
if ( V_26 -> V_73 & ( 1UL << V_85 ) )
V_26 -> V_41 |= 1UL << V_36 ;
}
} else {
V_26 -> V_13 = V_18 ;
V_26 -> V_39 = false ;
V_26 -> V_41 = V_26 -> V_73 & V_77 ;
}
} else {
V_26 -> V_41 = V_26 -> V_73 ;
}
...
case V_61 :
V_10 -> V_26 [ V_21 ] . V_46 =
! ! ( V_10 -> V_26 [ V_21 ] . V_27 & V_62 ) ;
break;
case V_63 :
V_10 -> V_26 [ V_21 ] . V_27 &= ~ V_62 ;
break;
case V_65 :
V_10 -> V_26 [ V_21 ] . V_27 &= ~ ( V_64 | V_62 ) ;
break;
}
F_19 ( V_10 , V_21 ) ;
F_4 ( L_21 , V_21 , V_76 ,
...
break;
case 0x10 :
if ( ( V_10 -> V_69 [ V_93 ] . V_70 & V_101 ) != 0 &&
( V_76 & V_72 ) == 0 &&
( V_10 -> V_69 [ V_93 ] . V_71 & V_72 ) != 0 )
V_10 -> V_69 [ V_93 ] . V_70 &= ~ V_101 ;
V_10 -> V_69 [ V_93 ] . V_71 = V_76 ;
break;
case 0x20 :
F_28 ( V_10 , V_10 -> V_102 + V_93 , V_76 ) ;
break;
case 0x30 :
F_23 ( V_10 , V_10 -> V_102 + V_93 , V_76 ) ;
break;
}
return 0 ;
}
...
switch ( V_90 & 0x30 ) {
case 0x00 :
V_96 = V_10 -> V_69 [ V_93 ] . V_70 ;
break;
case 0x10 :
V_96 = V_10 -> V_69 [ V_93 ] . V_71 ;
break;
case 0x20 :
V_96 = F_26 ( V_10 , V_10 -> V_102 + V_93 ) ;
break;
case 0x30 :
V_96 = F_24 ( V_10 , V_10 -> V_102 + V_93 ) ;
break;
}
V_97:
F_4 ( L_24 , V_17 , V_96 ) ;
...
int F_94 ( struct V_194 * V_195 ,
const struct V_170 * V_201 )
{
int V_112 = - V_146 ;
switch ( V_201 -> type ) {
case V_202 :
V_195 -> V_203 = F_92 ;
V_195 -> V_198 . V_198 = V_201 -> V_145 . V_198 . V_198 ;
V_195 -> V_198 . V_199 = V_201 -> V_145 . V_198 . V_199 ;
if ( V_195 -> V_198 . V_199 >= V_204 )
goto V_97;
break;
case V_205 :
V_195 -> V_203 = F_93 ;
V_195 -> V_110 . V_206 = V_201 -> V_145 . V_110 . V_206 ;
V_195 -> V_110 . V_207 = V_201 -> V_145 . V_110 . V_207 ;
V_195 -> V_110 . V_200 = V_201 -> V_145 . V_110 . V_200 ;
break;
default:
goto V_97;
}
