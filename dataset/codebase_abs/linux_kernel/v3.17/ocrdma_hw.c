...
static void F_57 ( struct V_8 * V_9 , void * V_310 )
{
...
struct V_242 * V_243 ;
bool V_324 = false ;
F_63 ( & V_9 -> V_325 , V_323 ) ;
F_64 (qp, &cq->sq_head, sq_entry) {
if ( V_243 -> V_286 )
continue;
...
F_65 ( & V_9 -> V_325 , V_323 ) ;
if ( V_324 == false )
return;
if ( V_13 -> V_269 . V_328 ) {
F_63 ( & V_13 -> V_329 , V_323 ) ;
(* V_13 -> V_269 . V_328 ) ( & V_13 -> V_269 , V_13 -> V_269 . V_296 ) ;
F_65 ( & V_13 -> V_329 , V_323 ) ;
}
}
static void F_66 ( struct V_8 * V_9 , T_3 V_330 )
{
unsigned long V_323 ;
struct V_247 * V_13 ;
if ( V_330 >= V_331 )
...
static void F_67 ( struct V_8 * V_9 , T_3 V_106 )
{
...
static T_5 F_68 ( int V_201 , void * V_332 )
{
...
static void F_69 ( struct V_8 * V_9 , struct V_17 * V_174 )
{
struct V_17 * V_144 ;
...
static int F_75 ( struct V_8 * V_9 , struct V_17 * V_144 )
{
int V_41 = 0 ;
T_3 V_99 , V_318 ;
struct V_17 * V_342 ;
...
V_435 ,
V_183 , sizeof( * V_174 ) ) ;
V_41 = F_75 ( V_9 , (struct V_17 * ) V_174 ) ;
if ( V_41 )
goto V_200;
...
sizeof( V_188 -> V_437 ) ) ;
F_61 ( V_9 -> V_350 . V_436 , sizeof( V_188 -> V_437 ) ) ;
V_200:
F_82 ( V_174 ) ;
return V_41 ;
}
...
V_144 -> V_153 . V_446 . V_447 [ 0 ] . V_449 = ( T_1 ) F_27 ( V_9 -> V_441 . V_195 ) ;
...
if ( V_439 )
V_182 -> V_451 = V_439 ;
V_41 = F_77 ( V_9 , V_144 , V_9 -> V_441 . V_4 ) ;
if ( V_41 )
memcpy ( V_182 , V_443 , sizeof( struct V_442 ) ) ;
else
F_61 ( V_182 , V_9 -> V_441 . V_159 ) ;
F_82 ( V_443 ) ;
return V_41 ;
}
...
V_144 -> V_153 . V_446 . V_447 [ 0 ] . V_449 = ( T_1 ) F_27 ( V_160 . V_195 ) ;
...
V_524 ) &
V_525 ;
V_9 -> V_515 . V_526 . V_4 = F_25 ( & V_158 -> V_9 , V_521 ,
& V_9 -> V_515 . V_526 . V_195 ,
V_145 ) ;
if ( V_9 -> V_515 . V_526 . V_4 == NULL )
goto V_527;
V_9 -> V_515 . V_4 = F_25 ( & V_158 -> V_9 , V_9 -> V_515 . V_159 ,
& V_195 , V_145 ) ;
...
V_512 [ V_169 ] . V_449 = ( T_1 ) F_95 ( F_27 ( V_195 ) ) ;
V_195 += V_521 ;
}
V_174 -> V_530 [ 0 ] . V_170 = ( T_1 ) ( V_9 -> V_515 . V_526 . V_195 & 0xFFFFFFFF ) ;
V_174 -> V_530 [ 0 ] . V_171 = ( T_1 ) F_27 ( V_9 -> V_515 . V_526 . V_195 ) ;
V_41 = F_75 ( V_9 , (struct V_17 * ) V_174 ) ;
if ( V_41 )
goto V_200;
...
return 0 ;
V_200:
F_23 ( & V_158 -> V_9 , V_9 -> V_515 . V_159 , V_9 -> V_515 . V_4 ,
V_9 -> V_515 . V_195 ) ;
V_9 -> V_515 . V_4 = NULL ;
V_528:
F_23 ( & V_158 -> V_9 , V_521 , V_9 -> V_515 . V_526 . V_4 ,
V_9 -> V_515 . V_526 . V_195 ) ;
...
V_556 ) ;
F_26 ( & V_174 -> V_174 . V_195 [ 0 ] , V_542 , V_13 -> V_195 , V_502 ) ;
V_41 = F_75 ( V_9 , (struct V_17 * ) V_174 ) ;
if ( V_41 )
goto V_200;
...
F_27 ( V_562 -> V_612 [ V_169 + V_613 ] . V_195 ) ;
}
V_41 = F_75 ( V_9 , (struct V_17 * ) V_174 ) ;
if ( V_41 )
goto V_200;
...
int F_51 ( struct V_242 * V_243 , enum V_23 V_631 ,
enum V_23 * V_632 )
{
unsigned long V_323 ;
int V_41 = 0 ;
enum V_24 V_633 ;
V_633 = F_10 ( V_631 ) ;
F_63 ( & V_243 -> V_634 , V_323 ) ;
if ( V_632 )
* V_632 = F_9 ( V_243 -> V_635 ) ;
if ( V_633 == V_243 -> V_635 ) {
F_65 ( & V_243 -> V_634 , V_323 ) ;
return 1 ;
}
if ( V_633 == V_28 ) {
F_112 ( V_243 ) ;
...
F_26 ( & V_174 -> V_655 [ 0 ] , V_542 , V_195 , V_168 ) ;
...
V_161 = ( V_542 * V_168 ) ;
V_243 -> V_630 . V_4 = F_25 ( & V_158 -> V_9 , V_161 , & V_195 , V_145 ) ;
if ( ! V_243 -> V_630 . V_4 )
return - V_163 ;
...
F_26 ( & V_174 -> V_674 [ 0 ] , V_542 , V_195 , V_168 ) ;
V_174 -> V_656 |= ( F_117 ( V_168 / V_213 ) <<
V_675 ) ;
V_174 -> V_658 |=
( V_542 << V_676 ) &
...
return 0 ;
V_243 -> V_693 = F_25 ( & V_158 -> V_9 , V_691 ,
& V_195 , V_145 ) ;
if ( ! V_243 -> V_693 )
return - V_163 ;
memset ( V_243 -> V_693 , 0 , V_691 ) ;
F_26 ( & V_174 -> V_694 [ 0 ] , V_9 -> V_350 . V_421 ,
V_195 , V_420 ) ;
...
V_200:
if ( V_243 -> V_630 . V_4 )
F_23 ( & V_158 -> V_9 , V_243 -> V_630 . V_161 , V_243 -> V_630 . V_4 , V_243 -> V_630 . V_195 ) ;
V_736:
F_53 ( L_17 , V_293 , V_9 -> V_120 ) ;
F_23 ( & V_158 -> V_9 , V_243 -> V_18 . V_161 , V_243 -> V_18 . V_4 , V_243 -> V_18 . V_195 ) ;
V_733:
F_53 ( L_18 , V_293 , V_9 -> V_120 ) ;
F_82 ( V_174 ) ;
return V_41 ;
}
...
{
int V_41 ;
struct V_758 * V_759 = & V_649 -> V_759 ;
union V_760 V_761 , V_762 ;
T_1 V_763 ;
T_2 V_764 [ 6 ] ;
if ( ( V_759 -> V_765 & V_766 ) == 0 )
return - V_72 ;
if ( F_127 ( & V_243 -> V_9 -> V_309 , 1 , 0 ) )
F_128 ( V_243 -> V_9 ) ;
V_174 -> V_755 . V_767 |=
( V_759 -> V_768 . V_769 << V_770 ) ;
V_174 -> V_755 . V_771 |=
( V_759 -> V_768 . V_772 & V_773 ) ;
V_174 -> V_755 . V_771 |= ( V_759 -> V_774 << V_775 ) ;
V_174 -> V_755 . V_776 |=
( V_759 -> V_768 . V_777 << V_778 ) ;
V_174 -> V_323 |= V_779 ;
memcpy ( & V_174 -> V_755 . V_780 [ 0 ] , & V_759 -> V_768 . V_780 . V_781 [ 0 ] ,
sizeof( V_174 -> V_755 . V_780 ) ) ;
V_41 = F_129 ( & V_243 -> V_9 -> V_266 , 1 ,
V_759 -> V_768 . V_782 , & V_761 ) ;
if ( V_41 )
return V_41 ;
memset ( & V_762 , 0 , sizeof( V_762 ) ) ;
if ( ! memcmp ( & V_761 , & V_762 , sizeof( V_762 ) ) )
return - V_72 ;
V_243 -> V_783 = V_759 -> V_768 . V_782 ;
memcpy ( & V_174 -> V_755 . V_761 [ 0 ] , & V_761 . V_781 [ 0 ] , sizeof( V_174 -> V_755 . V_761 ) ) ;
F_130 ( V_243 -> V_9 , V_759 , & V_764 [ 0 ] ) ;
V_174 -> V_755 . V_784 = V_764 [ 0 ] | ( V_764 [ 1 ] << 8 ) |
( V_764 [ 2 ] << 16 ) | ( V_764 [ 3 ] << 24 ) ;
F_131 ( & V_174 -> V_755 . V_780 [ 0 ] , sizeof( V_174 -> V_755 . V_780 ) ) ;
F_131 ( & V_174 -> V_755 . V_761 [ 0 ] , sizeof( V_174 -> V_755 . V_761 ) ) ;
V_174 -> V_755 . V_785 = V_764 [ 4 ] | ( V_764 [ 5 ] << 8 ) ;
V_763 = V_759 -> V_763 ;
if ( V_763 && ( V_763 < 0x1000 ) ) {
V_174 -> V_755 . V_785 |=
V_763 << V_786 ;
V_174 -> V_323 |= V_787 ;
V_174 -> V_755 . V_771 |=
( V_243 -> V_9 -> V_774 & 0x07 ) << V_775 ;
}
return 0 ;
}
static int F_132 ( struct V_242 * V_243 ,
struct V_756 * V_174 ,
struct V_757 * V_649 , int V_788 )
{
int V_41 = 0 ;
if ( V_788 & V_789 ) {
V_174 -> V_755 . V_790 |= ( V_649 -> V_791 &
V_792 ) ;
V_174 -> V_323 |= V_793 ;
}
if ( V_788 & V_794 ) {
V_243 -> V_795 = V_649 -> V_795 ;
V_174 -> V_755 . V_795 = V_649 -> V_795 ;
V_174 -> V_323 |= V_796 ;
}
if ( V_788 & V_797 ) {
V_41 = F_126 ( V_243 , V_174 , V_649 ) ;
if ( V_41 )
return V_41 ;
} else if ( V_243 -> V_723 == V_724 || V_243 -> V_723 == V_728 ) {
V_174 -> V_755 . V_784 = V_243 -> V_9 -> V_117 . V_764 [ 0 ] |
( V_243 -> V_9 -> V_117 . V_764 [ 1 ] << 8 ) |
( V_243 -> V_9 -> V_117 . V_764 [ 2 ] << 16 ) |
( V_243 -> V_9 -> V_117 . V_764 [ 3 ] << 24 ) ;
V_174 -> V_755 . V_785 = V_243 -> V_9 -> V_117 . V_764 [ 4 ] |
( V_243 -> V_9 -> V_117 . V_764 [ 5 ] << 8 ) ;
}
if ( ( V_788 & V_798 ) &&
V_649 -> V_799 ) {
V_174 -> V_755 . V_678 |=
...
if ( V_788 & V_802 ) {
V_174 -> V_755 . V_803 |= ( V_649 -> V_804 &
V_805 ) ;
V_174 -> V_323 |= V_801 ;
}
if ( V_788 & V_806 ) {
if ( V_649 -> V_807 < V_808 ||
V_649 -> V_807 > V_809 ) {
V_41 = - V_72 ;
goto V_810;
}
...
if ( V_788 & V_814 ) {
V_174 -> V_755 . V_803 |= V_649 -> V_143 <<
V_815 ;
V_174 -> V_323 |= V_816 ;
}
if ( V_788 & V_817 ) {
V_174 -> V_755 . V_771 |= ( V_649 -> V_818 <<
V_819 ) &
V_820 ;
V_174 -> V_323 |= V_821 ;
}
if ( V_788 & V_822 ) {
V_174 -> V_755 . V_771 |= ( V_649 -> V_823 <<
V_824 ) &
V_825 ;
V_174 -> V_323 |= V_826 ;
}
if ( V_788 & V_827 ) {
V_174 -> V_755 . V_803 |= ( V_649 -> V_828 <<
V_829 )
& V_830 ;
V_174 -> V_323 |= V_831 ;
}
if ( V_788 & V_832 ) {
V_174 -> V_755 . V_767 |= ( V_649 -> V_833 & 0x00ffffff ) ;
V_174 -> V_323 |= V_834 ;
}
if ( V_788 & V_835 ) {
V_174 -> V_755 . V_776 |= ( V_649 -> V_836 & 0x00ffffff ) ;
V_174 -> V_323 |= V_837 ;
}
if ( V_788 & V_838 ) {
if ( V_649 -> V_839 > V_243 -> V_9 -> V_350 . V_376 ) {
V_41 = - V_72 ;
goto V_810;
}
V_243 -> V_712 = V_649 -> V_839 ;
V_174 -> V_323 |= V_840 ;
}
if ( V_788 & V_841 ) {
if ( V_649 -> V_842 > V_243 -> V_9 -> V_350 . V_380 ) {
V_41 = - V_72 ;
goto V_810;
}
V_243 -> V_709 = V_649 -> V_842 ;
V_174 -> V_323 |= V_843 ;
}
...
V_41 = F_132 ( V_243 , V_174 , V_649 , V_788 ) ;
if ( V_41 )
goto V_200;
V_41 = F_75 ( V_9 , (struct V_17 * ) V_174 ) ;
if ( V_41 )
...
if ( ! V_174 )
return V_41 ;
V_174 -> V_859 = V_486 -> V_120 & V_860 ;
V_672 = V_855 -> V_350 . V_861 + 1 ;
V_41 = F_91 ( & V_672 ,
V_9 -> V_350 . V_412 ,
& V_542 , & V_168 ) ;
if ( V_41 ) {
...
V_161 = V_542 * V_168 ;
V_286 -> V_630 . V_4 = F_25 ( & V_158 -> V_9 , V_161 , & V_195 , V_145 ) ;
if ( ! V_286 -> V_630 . V_4 ) {
V_41 = - V_163 ;
goto V_862;
}
...
V_174 -> V_863 = F_117 ( V_672 ) ;
V_174 -> V_863 |= V_855 -> V_350 . V_864 <<
V_865 ;
V_174 -> V_859 |= ( F_117 ( V_168 / V_213 )
<< V_866 ) ;
V_174 -> V_867 |= ( V_9 -> V_350 . V_412
<< V_868 )
& V_869 ;
V_174 -> V_867 |= V_542 << V_870 ;
V_41 = F_75 ( V_9 , (struct V_17 * ) V_174 ) ;
if ( V_41 )
goto V_200;
V_188 = (struct V_856 * ) V_174 ;
...
V_286 -> V_630 . V_651 = ( V_188 -> V_871 &
V_874 ) >>
V_875 ;
goto V_862;
V_200:
F_23 ( & V_158 -> V_9 , V_286 -> V_630 . V_161 , V_286 -> V_630 . V_4 , V_195 ) ;
V_862:
F_82 ( V_174 ) ;
return V_41 ;
}
int F_137 ( struct V_734 * V_286 , struct V_876 * V_855 )
{
int V_41 = - V_163 ;
struct V_877 * V_174 ;
struct V_485 * V_486 = V_286 -> V_486 ;
struct V_8 * V_9 = F_138 ( V_486 -> V_878 . V_265 ) ;
V_174 = F_19 ( V_879 , sizeof( * V_174 ) ) ;
if ( ! V_174 )
return V_41 ;
V_174 -> V_120 = V_286 -> V_120 ;
V_174 -> V_880 |= V_855 -> V_881 <<
V_882 ;
V_41 = F_75 ( V_9 , (struct V_17 * ) V_174 ) ;
F_82 ( V_174 ) ;
return V_41 ;
}
int F_139 ( struct V_734 * V_286 , struct V_876 * V_855 )
{
int V_41 = - V_163 ;
struct V_883 * V_174 ;
...
struct V_891 * V_174 ;
struct V_510 * V_158 = V_9 -> V_117 . V_158 ;
V_174 = F_19 ( V_892 , sizeof( * V_174 ) ) ;
if ( ! V_174 )
return V_41 ;
V_174 -> V_120 = V_286 -> V_120 ;
V_41 = F_75 ( V_9 , (struct V_17 * ) V_174 ) ;
if ( V_286 -> V_630 . V_4 )
F_23 ( & V_158 -> V_9 , V_286 -> V_630 . V_161 ,
V_286 -> V_630 . V_4 , V_286 -> V_630 . V_195 ) ;
F_82 ( V_174 ) ;
return V_41 ;
}
static int F_141 ( struct V_8 * V_9 , T_1 V_893 ,
struct V_894 * V_895 )
{
int V_41 = 0 ;
T_4 V_195 ;
struct V_17 V_174 ;
struct V_896 * V_182 = NULL ;
struct V_897 * V_188 = NULL ;
struct V_510 * V_158 = V_9 -> V_117 . V_158 ;
struct V_898 * V_899 = V_174 . V_153 . V_446 . V_447 ;
memset ( & V_174 , 0 , sizeof( struct V_17 ) ) ;
V_174 . V_146 . V_151 = F_142 ( T_1 , sizeof( struct V_897 ) ,
sizeof( struct V_896 ) ) ;
V_182 = F_25 ( & V_158 -> V_9 , V_174 . V_146 . V_151 , & V_195 , V_145 ) ;
if ( ! V_182 ) {
V_41 = - V_163 ;
goto V_527;
}
...
V_445 ;
V_899 -> V_448 = ( T_1 ) ( V_195 & 0xFFFFFFFFUL ) ;
V_899 -> V_449 = ( T_1 ) F_27 ( V_195 ) ;
V_899 -> V_161 = V_174 . V_146 . V_151 ;
memset ( V_182 , 0 , sizeof( struct V_896 ) ) ;
F_18 ( & V_182 -> V_146 , V_900 ,
V_901 , V_174 . V_146 . V_151 ) ;
V_182 -> V_902 = V_893 ;
V_41 = F_75 ( V_9 , & V_174 ) ;
if ( V_41 )
goto V_200;
V_188 = (struct V_897 * ) V_182 ;
F_61 ( V_188 , sizeof( struct V_897 ) ) ;
memcpy ( V_895 , & V_188 -> V_903 , sizeof( struct V_894 ) ) ;
V_200:
F_23 ( & V_158 -> V_9 , V_174 . V_146 . V_151 , V_182 , V_195 ) ;
V_527:
return V_41 ;
}
static int F_143 ( struct V_8 * V_9 , int V_893 ,
struct V_894 * V_895 ,
T_2 * V_904 )
{
int V_41 = - V_72 , V_905 , V_906 ;
int V_907 ;
struct V_908 * V_909 ;
T_2 V_192 , V_910 ;
T_2 V_911 , V_912 ;
T_3 V_913 ;
if ( ! ( V_895 -> V_914 & V_915 ) ) {
F_144 ( L_20 ,
F_145 ( & V_9 -> V_117 . V_158 -> V_9 ) , V_9 -> V_120 ) ;
goto V_916;
}
if ( ! F_146 ( V_895 -> V_917 ) ) {
F_144 ( L_21 ,
F_145 ( & V_9 -> V_117 . V_158 -> V_9 ) , V_9 -> V_120 ,
( V_893 > 0 ? L_22 : L_23 ) ,
( V_895 -> V_917 & V_918 ) ?
...
V_920 )
& V_915 ;
for ( V_905 = 0 ; V_905 < V_907 ; V_905 ++ ) {
V_909 = & V_895 -> V_909 [ V_905 ] ;
V_192 = ( V_909 -> V_921 >>
V_922 )
& V_923 ;
V_910 = ( V_909 -> V_921
...
T_2 V_904 = V_930 ;
int V_893 = V_931 ;
for ( V_905 = 0 ; V_905 < 2 ; V_905 ++ ) {
V_41 = F_141 ( V_9 , V_893 , & V_895 ) ;
if ( V_41 ) {
F_53 ( L_29 , V_293 , V_41 ) ;
V_893 = V_932 ;
continue;
}
V_41 = F_143 ( V_9 , V_893 ,
& V_895 , & V_904 ) ;
if ( V_41 ) {
V_893 = V_932 ;
continue;
...
F_145 ( & V_9 -> V_117 . V_158 -> V_9 ) , V_9 -> V_120 ,
V_904 ) ;
V_9 -> V_917 = F_146 ( V_895 . V_917 ) ;
V_9 -> V_774 = V_904 ;
}
int F_149 ( struct V_8 * V_9 , struct V_933 * V_934 )
{
int V_169 ;
int V_41 = - V_72 ;
struct V_516 * V_935 ;
...
V_41 = - V_51 ;
F_65 ( & V_9 -> V_515 . V_238 , V_323 ) ;
return V_41 ;
}
int F_150 ( struct V_8 * V_9 , struct V_933 * V_934 )
{
unsigned long V_323 ;
F_63 ( & V_9 -> V_515 . V_238 , V_323 ) ;
V_934 -> V_935 -> V_192 = 0 ;
...
{
int V_937 , V_169 , V_41 = 0 ;
int V_201 ;
unsigned long V_323 = 0 ;
V_937 = V_9 -> V_117 . V_204 . V_938 -
V_9 -> V_117 . V_204 . V_939 ;
if ( V_9 -> V_117 . V_202 == V_203 ) {
V_937 = 1 ;
V_323 = V_940 ;
} else {
V_937 = F_116 ( T_1 , V_937 , F_152 () ) ;
}
if ( ! V_937 )
return - V_72 ;
V_9 -> V_207 = F_20 ( sizeof( struct V_1 ) * V_937 , V_145 ) ;
if ( ! V_9 -> V_207 )
return - V_163 ;
for ( V_169 = 0 ; V_169 < V_937 ; V_169 ++ ) {
...
sprintf ( V_9 -> V_207 [ V_169 ] . V_941 , L_32 ,
V_9 -> V_120 , V_169 ) ;
V_201 = F_33 ( V_9 , & V_9 -> V_207 [ V_169 ] ) ;
V_41 = F_153 ( V_201 , F_68 , V_323 ,
V_9 -> V_207 [ V_169 ] . V_941 ,
& V_9 -> V_207 [ V_169 ] ) ;
if ( V_41 )
goto V_942;
V_9 -> V_206 += 1 ;
