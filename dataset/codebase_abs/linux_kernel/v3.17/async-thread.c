...
void F_34 ( struct V_27 * V_28 , T_2 V_37 ,
T_3 V_36 ,
T_3 V_33 ,
T_3 V_34 )
{
...
static inline void F_36 ( struct V_1 * V_20 ,
struct V_27 * V_28 )
{
unsigned long V_3 ;
V_28 -> V_20 = V_20 ;
...
if ( V_28 -> V_33 ) {
F_22 ( & V_20 -> V_15 , V_3 ) ;
F_37 ( & V_28 -> V_14 , & V_20 -> V_14 ) ;
F_28 ( & V_20 -> V_15 , V_3 ) ;
}
F_38 ( V_20 -> V_13 , & V_28 -> V_38 ) ;
F_39 ( V_28 ) ;
}
void F_40 ( struct V_17 * V_20 ,
struct V_27 * V_28 )
{
struct V_1 * V_39 ;
if ( F_25 ( V_40 , & V_28 -> V_3 ) && V_20 -> V_19 )
V_39 = V_20 -> V_19 ;
else
V_39 = V_20 -> V_18 ;
F_36 ( V_39 , V_28 ) ;
...
void F_44 ( struct V_17 * V_20 , int V_41 )
{
if ( ! V_20 )
return;
V_20 -> V_18 -> V_4 = V_41 ;
