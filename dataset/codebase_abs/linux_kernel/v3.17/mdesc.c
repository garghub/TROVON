...
static int F_78 ( struct V_134 * V_134 , struct V_135 * V_135 )
{
struct V_1 * V_2 = F_20 () ;
if ( ! V_2 )
return - V_136 ;
...
static T_5 F_79 ( struct V_135 * V_135 , char T_6 * V_138 ,
T_7 V_46 , T_8 * V_139 )
{
struct V_1 * V_2 = V_135 -> V_137 ;
unsigned char * V_5 ;
int V_140 , V_141 = V_46 ;
if ( * V_139 >= V_2 -> V_3 )
return 0 ;
V_140 = V_2 -> V_3 - * V_139 ;
if ( V_141 > V_140 )
...
static T_8 F_81 ( struct V_135 * V_135 , T_8 V_143 , int V_144 )
{
struct V_1 * V_2 ;
switch ( V_144 ) {
case V_145 :
...
static int F_82 ( struct V_134 * V_134 , struct V_135 * V_135 )
{
F_24 ( V_135 -> V_137 ) ;
return 0 ;
}
