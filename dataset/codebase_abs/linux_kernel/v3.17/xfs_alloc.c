...
if ( args -> V_20 == 0 )
args -> V_20 = 1 ;
ASSERT ( F_126 ( V_69 , args -> V_253 ) < V_69 -> V_75 . V_254 ) ;
ASSERT ( F_127 ( V_69 , args -> V_253 ) < V_246 ) ;
ASSERT ( args -> V_21 <= args -> V_41 ) ;
ASSERT ( args -> V_21 <= V_246 ) ;
ASSERT ( args -> V_39 < args -> V_40 ) ;
if ( F_126 ( V_69 , args -> V_253 ) >= V_69 -> V_75 . V_254 ||
F_127 ( V_69 , args -> V_253 ) >= V_246 ||
...
case V_110 :
case V_111 :
args -> V_95 = F_126 ( V_69 , args -> V_253 ) ;
...
args -> V_46 = F_127 ( V_69 , args -> V_253 ) ;
if ( ( error = F_49 ( args ) ) )
goto V_122;
break;
case V_256 :
...
if ( type == V_262 )
args -> type = V_109 ;
args -> V_95 = V_247 = F_126 ( V_69 , args -> V_253 ) ;
V_52 = V_197 ;
}
for (; ; ) {
args -> V_103 = F_94 ( V_69 , args -> V_95 ) ;
...
args -> V_253 = F_131 ( V_69 , args -> V_95 , args -> V_46 ) ;
#ifdef F_21
ASSERT ( args -> V_4 >= args -> V_21 ) ;
ASSERT ( args -> V_4 <= args -> V_41 ) ;
ASSERT ( args -> V_46 % args -> V_20 == 0 ) ;
F_134 ( V_69 , F_135 ( V_69 , args -> V_253 ) ,
args -> V_4 ) ;
#endif
}
F_95 ( args -> V_103 ) ;
