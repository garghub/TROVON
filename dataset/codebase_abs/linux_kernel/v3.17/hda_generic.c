...
{
char V_10 [ V_123 ] ;
snprintf ( V_10 , sizeof( V_10 ) , L_32 , V_62 , V_61 , V_122 ) ;
...
{
struct V_1 * V_2 = V_19 -> V_2 ;
static const char * const V_209 [ 3 ] = { L_38 , L_39 , L_40 } ;
int V_16 ;
F_117 ( L_41 ,
...
V_209 [ V_139 -> V_152 ] ) ;
for ( V_16 = 0 ; V_16 < V_139 -> V_141 ; V_16 ++ )
F_115 ( V_19 , L_42 , V_2 -> V_187 [ V_16 ] ) ;
if ( V_2 -> V_142 > 0 )
F_117 ( L_43 ,
V_2 -> V_142 ,
...
V_2 -> V_147 . V_150 [ 3 ] ) ;
for ( V_16 = 0 ; V_16 < V_139 -> V_144 ; V_16 ++ )
F_115 ( V_19 , L_48 , V_2 -> V_156 [ V_16 ] ) ;
for ( V_16 = 0 ; V_16 < 3 ; V_16 ++ )
F_115 ( V_19 , L_49 , V_2 -> V_195 [ V_16 ] ) ;
}
...
V_193 = F_79 ( V_19 , L_55 , 0 , 1 , V_52 ) ;
if ( V_193 < 0 )
return V_193 ;
V_193 = F_79 ( V_19 , L_56 , 0 , 2 , V_52 ) ;
if ( V_193 < 0 )
return V_193 ;
} else {
...
if ( ! V_10 || ! strcmp ( V_10 , L_54 ) ) {
V_193 = F_83 ( V_19 , L_55 , 0 , 1 , V_52 ) ;
if ( V_193 < 0 )
return V_193 ;
V_193 = F_83 ( V_19 , L_56 , 0 , 2 , V_52 ) ;
if ( V_193 < 0 )
return V_193 ;
} else {
...
snprintf ( V_224 , sizeof( V_224 ) , L_57 ,
V_62 , V_151 [ V_16 ] ) ;
V_10 = V_224 ;
} else {
V_10 = V_62 ;
...
sprintf ( V_226 -> V_135 . V_227 . V_10 , L_58 , V_79 ) ;
return 0 ;
}
...
static int F_141 ( struct V_18 * V_19 , int V_58 , bool V_243 )
{
struct V_1 * V_2 = V_19 -> V_2 ;
...
V_2 -> V_147 . V_246 = F_144 ( V_2 -> V_206 ,
V_2 -> V_247 ) ;
if ( V_2 -> V_34 )
...
static void F_133 ( struct V_18 * V_19 , bool V_249 ,
int V_250 , int V_251 ,
int V_252 )
{
struct V_1 * V_2 = V_19 -> V_2 ;
...
static void F_149 ( struct V_18 * V_19 , int V_256 , bool V_257 )
{
struct V_1 * V_2 = V_19 -> V_2 ;
bool V_258 ;
unsigned int V_20 ;
...
unsigned int V_266 = F_150 ( V_19 , V_265 ) ;
if ( V_266 != V_263 )
F_151 ( V_19 , V_265 ,
V_262 | ( V_258 ? V_266 : 0 ) ) ;
}
...
struct V_225 * V_226 )
{
return F_155 ( V_130 , V_226 , 2 , V_272 ) ;
}
...
T_1 V_50 = V_130 -> V_121 ;
unsigned int V_20 ;
V_20 = V_132 -> V_135 . V_227 . V_228 [ 0 ] ? V_221 : V_222 ;
...
struct V_1 * V_2 = V_19 -> V_2 ;
int V_58 = 0 ;
F_160 ( V_19 , V_46 , & V_2 -> V_140 , V_10 , V_273 , & V_58 ) ;
F_161 ( V_10 , L_60 , V_273 ) ;
...
if ( V_297 ) {
V_193 = F_80 ( V_2 , V_125 , V_301 , V_302 , V_297 ) ;
if ( V_193 < 0 )
return V_193 ;
V_52 -> V_60 [ V_100 ] = V_297 ;
}
if ( V_298 ) {
V_193 = F_86 ( V_2 , V_127 , V_301 , V_302 , V_298 ) ;
if ( V_193 < 0 )
return V_193 ;
...
F_185 ( V_19 , V_310 , V_318 , V_316 , NULL ) ;
V_321 = true ;
if ( V_2 -> V_315 )
...
const char * V_122 = V_337 ? L_70 : L_71 ;
...
V_5 = V_2 -> V_154 ;
F_216 ( V_19 , F_97 ( V_2 -> V_140 . V_202 ) ,
...
V_5 = V_2 -> V_156 ;
F_216 ( V_19 , F_97 ( V_2 -> V_140 . V_203 ) ,
...
V_2 -> V_377 = V_370 ;
V_5 = V_2 -> V_187 ;
F_216 ( V_19 , F_97 ( V_2 -> V_140 . V_201 ) ,
...
return;
V_2 -> V_374 =
F_214 ( V_19 , F_97 ( V_2 -> V_140 . V_201 ) ,
V_2 -> V_140 . V_201 ) ;
...
static void F_134 ( struct V_18 * V_19 , struct V_382 * V_383 )
{
struct V_1 * V_2 = V_19 -> V_2 ;
if ( V_2 -> V_389 )
...
return F_155 ( V_130 , V_226 , 3 , V_392 ) ;
return F_129 ( V_130 , V_226 ) ;
}
...
if ( ! V_2 -> V_236 )
return;
F_133 ( V_19 , V_2 -> V_237 , V_2 -> V_187 [ 0 ] ,
V_2 -> V_195 [ 0 ] ,
V_2 -> V_140 . V_152 ) ;
F_133 ( V_19 , V_2 -> V_237 , V_2 -> V_154 [ 0 ] ,
V_2 -> V_195 [ 1 ] ,
V_155 ) ;
F_133 ( V_19 , V_2 -> V_237 , V_2 -> V_156 [ 0 ] ,
V_2 -> V_195 [ 2 ] ,
V_153 ) ;
}
