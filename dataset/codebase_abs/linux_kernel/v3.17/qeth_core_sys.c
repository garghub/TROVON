...
V_7 -> V_18 . V_34 = V_46 ;
V_7 -> V_18 . V_39 = 0 ;
} else if ( ! strcmp ( V_22 , L_28 ) ) {
V_7 -> V_18 . V_34 = V_46 ;
V_7 -> V_18 . V_39 = 1 ;
} else if ( ! strcmp ( V_22 , L_29 ) ) {
V_7 -> V_18 . V_34 = V_46 ;
V_7 -> V_18 . V_39 = 2 ;
} else if ( ! strcmp ( V_22 , L_30 ) ) {
V_7 -> V_18 . V_34 = V_46 ;
V_7 -> V_18 . V_39 = 3 ;
} else if ( ! strcmp ( V_22 , L_31 ) ) {
V_7 -> V_18 . V_34 = V_46 ;
V_7 -> V_18 . V_39 = V_42 ;
} else
V_24 = - V_8 ;
...
if ( ! strcmp ( V_22 , V_72 ) ) {
V_70 = V_71 ;
} else if ( ! strcmp ( V_22 , V_74 ) ) {
V_70 = V_73 ;
} else if ( ! strcmp ( V_22 , V_76 ) ) {
V_70 = V_75 ;
} else {
V_24 = - V_8 ;
goto V_27;
...
if ( V_86 . V_87 & V_88 )
V_24 = sprintf ( V_5 , ( V_86 . V_89 & V_88 ?
L_37 : L_38 ) ) ;
if ( V_86 . V_87 & V_90 )
...
V_9 = 1 ;
V_22 = F_18 ( & V_78 , L_17 ) ;
if ( ! strcmp ( V_22 , L_43 ) && ! V_7 -> V_16 . V_91 ) {
if ( V_9 ) {
if ( F_41 ( V_7 ,
V_92 ) ) {
V_24 = F_42 ( V_7 , V_93 ) ;
...
V_7 -> V_16 . V_91 = 1 ;
} else if ( ! strcmp ( V_22 , L_44 ) && V_7 -> V_16 . V_91 ) {
if ( V_9 ) {
V_24 = F_42 ( V_7 , V_94 ) ;
if ( ! V_24 )
V_7 -> V_16 . V_91 = 0 ;
...
V_7 -> V_16 . V_91 = 0 ;
} else if ( ! strcmp ( V_22 , L_45 ) && V_9 && V_7 -> V_16 . V_91 )
V_24 = F_42 ( V_7 , V_95 ) ;
else
V_24 = - V_8 ;
F_14 ( & V_7 -> V_25 ) ;
...
static T_1 F_43 ( char * V_5 , struct V_6 * V_7 , int V_96 )
{
if ( ! V_7 )
return - V_8 ;
return sprintf ( V_5 , L_15 , V_96 ) ;
}
static T_1 F_44 ( struct V_6 * V_7 ,
const char * V_5 , T_2 V_21 , int * V_96 , int V_97 )
{
char * V_22 ;
int V_33 , V_24 = 0 ;
if ( ! V_7 )
...
{
struct V_6 * V_7 = F_2 ( V_2 ) ;
return F_43 ( V_5 , V_7 , V_7 -> V_16 . V_98 . V_99 ) ;
}
...
& V_7 -> V_16 . V_98 . V_99 , 5000 ) ;
}
static T_1 F_47 ( struct V_1 * V_2 ,
struct V_3 * V_4 , char * V_5 )
{
struct V_6 * V_7 = F_2 ( V_2 ) ;
return F_43 ( V_5 , V_7 , V_7 -> V_16 . V_98 . V_100 ) ;
}
