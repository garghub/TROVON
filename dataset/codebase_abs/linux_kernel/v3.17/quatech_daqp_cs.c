...
if ( V_107 )
return V_107 ;
V_2 -> V_11 = V_106 -> V_112 [ 0 ] -> V_40 ;
V_106 -> V_113 = V_2 ;
V_107 = F_37 ( V_106 , F_3 ) ;
if ( V_107 )
return V_107 ;
V_107 = F_38 ( V_2 , 4 ) ;
if ( V_107 )
...
V_2 -> V_18 = V_4 ;
V_4 -> type = V_115 ;
V_4 -> V_116 = V_117 | V_118 | V_119 | V_120 ;
V_4 -> V_121 = 8 ;
V_4 -> V_122 = 2048 ;
V_4 -> V_123 = 0xffff ;
V_4 -> V_124 = & V_125 ;
