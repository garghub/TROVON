...
return error ;
F_106 ( V_1 , V_161 ) ;
V_121 = F_78 ( V_71 , V_176 ) ;
error = F_79 ( V_121 , & F_80 ( V_71 ) -> V_177 , 0 , 0 ) ;
if ( error )
goto V_148;
V_164 = V_178 ;
V_163 |= V_105 ;
...
F_91 ( V_121 , V_6 , V_157 ) ;
if ( V_161 <= V_160 ) {
error = F_108 ( & V_121 , V_6 , V_179 , V_161 ) ;
if ( error )
goto V_180;
F_109 ( V_6 , V_181 ) ;
F_110 ( V_6 ) ;
...
int error ;
F_113 ( V_6 ) ;
V_121 = F_78 ( V_71 , V_186 ) ;
error = F_79 ( V_121 , & F_80 ( V_71 ) -> V_187 , 0 , 0 ) ;
if ( error ) {
F_98 ( V_121 , 0 ) ;
return error ;
}
...
if ( V_195 -> V_203 == - 1LL )
return 0 ;
V_200 = F_115 ( V_195 -> V_204 ) ;
V_201 = F_115 ( V_195 -> V_203 ) ;
V_202 = F_115 ( V_195 -> V_205 ) ;
...
struct V_194 V_215 ;
int error ;
error = F_118 ( V_198 , V_216 ) ;
if ( error )
return error ;
V_215 . V_204 = F_119 ( V_214 ) ;
if ( V_202 == V_217 )
V_215 . V_205 = - 1LL ;
else
V_215 . V_205 = F_120 ( V_214 + V_202 ) - V_215 . V_204 ;
...
V_215 . V_223 |= V_230 ;
error = F_122 ( V_6 , & V_215 , F_114 , V_198 ) ;
if ( error )
return error ;
return 0 ;
}
