...
V_49 = F_40 ( V_52 ) ;
V_46 = F_41 ( V_48 , sizeof( struct V_45 * ) , V_41 ) ;
if ( ! V_46 ) {
F_23 ( L_11 ,
V_35 , V_48 ) ;
return NULL ;
...
V_46 [ V_14 ] = F_42 ( V_53 >> V_54 ) ;
}
V_50 = F_43 ( V_46 , V_48 , V_55 , V_49 ) ;
F_36 ( V_46 ) ;
return V_50 ;
}
static void * F_44 ( T_6 V_5 , T_1 V_4 )
{
if ( ! F_45 ( V_5 , V_4 , L_12 ) ) {
F_23 ( L_13 ,
...
static int F_47 ( T_6 V_5 , T_6 V_4 ,
struct V_1 * V_2 )
{
V_2 -> V_56 = V_5 ;
V_2 -> V_4 = V_4 ;
...
static int F_49 ( struct V_1 * V_2 , T_8 V_58 ,
struct V_30 * V_16 )
{
int V_38 ;
V_38 = F_21 ( V_2 , V_16 ) ;
...
return;
if ( V_2 -> V_50 ) {
if ( F_48 ( V_2 -> V_56 >> V_54 ) ) {
F_52 ( V_2 -> V_50 ) ;
} else {
F_53 ( V_2 -> V_50 ) ;
F_54 ( V_2 -> V_56 , V_2 -> V_4 ) ;
}
V_2 -> V_50 = NULL ;
}
F_35 ( V_2 ) ;
...
struct V_1 * F_55 ( T_6 V_5 , T_1 V_4 ,
T_8 V_58 , struct V_30 * V_16 )
{
struct V_1 * V_2 ;
int V_38 = - V_57 ;
V_2 = F_56 ( sizeof( struct V_1 ) , V_41 ) ;
if ( ! V_2 ) {
F_23 ( L_18 ) ;
goto V_60;
}
V_38 = F_47 ( V_5 , V_4 , V_2 ) ;
if ( V_38 )
goto V_60;
V_38 = F_49 ( V_2 , V_58 , V_16 ) ;
if ( V_38 )
goto V_60;
return V_2 ;
V_60:
