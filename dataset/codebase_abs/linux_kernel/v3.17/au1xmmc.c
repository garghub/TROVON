...
{
unsigned int V_114 = F_43 ( V_4 -> V_115 ) ;
unsigned int V_116 = ( ( V_114 / V_113 ) / 2 ) - 1 ;
T_1 V_117 ;
V_117 = F_4 ( F_5 ( V_4 ) ) ;
V_117 &= ~ ( V_118 ) ;
V_117 |= ( V_116 & V_118 ) | V_119 ;
F_6 ( V_117 , F_5 ( V_4 ) ) ;
F_7 () ;
}
...
V_4 -> V_102 = F_73 ( V_97 -> V_162 , 0x3c ) ;
if ( ! V_4 -> V_102 ) {
...
V_4 -> V_115 = F_75 ( & V_92 -> V_165 , V_202 ) ;
if ( F_76 ( V_4 -> V_115 ) ) {
F_63 ( & V_92 -> V_165 , L_14 ) ;
goto V_203;
}
if ( F_77 ( V_4 -> V_115 ) ) {
F_63 ( & V_92 -> V_165 , L_15 ) ;
goto V_204;
}
V_4 -> V_10 = V_33 ;
if ( V_4 -> V_15 && V_4 -> V_15 -> V_205 ) {
V_124 = V_4 -> V_15 -> V_205 ( V_17 , 1 ) ;
if ( V_124 ) {
F_78 ( & V_92 -> V_165 , L_16 ) ;
V_17 -> V_190 |= V_206 ;
}
} else
V_17 -> V_190 |= V_206 ;
if ( V_4 -> V_15 )
V_17 -> V_190 &= ~ ( V_4 -> V_15 -> V_207 ) ;
F_79 ( & V_4 -> V_89 , F_31 ,
( unsigned long ) V_4 ) ;
F_79 ( & V_4 -> V_111 , F_21 ,
( unsigned long ) V_4 ) ;
...
#ifdef F_80
if ( V_4 -> V_15 && V_4 -> V_15 -> V_208 ) {
struct V_209 * V_208 = V_4 -> V_15 -> V_208 ;
V_208 -> V_178 = F_81 ( V_17 ) ;
V_208 -> V_210 = V_211 ;
V_208 -> V_212 = F_81 ( V_17 ) ;
V_124 = F_82 ( F_29 ( V_17 ) , V_208 ) ;
if ( V_124 )
goto V_213;
}
#endif
...
V_124 = F_83 ( V_17 ) ;
if ( V_124 ) {
F_63 ( & V_92 -> V_165 , L_18 ) ;
goto V_214;
}
F_84 ( V_92 , V_4 ) ;
F_24 ( V_201 L_19
L_20 , V_92 -> V_93 , V_4 -> V_102 ,
V_4 -> V_24 & V_26 ? L_21 : L_22 ) ;
return 0 ;
V_214:
#ifdef F_80
if ( V_4 -> V_15 && V_4 -> V_15 -> V_208 )
...
static int F_94 ( struct V_170 * V_92 )
{
struct V_3 * V_4 = F_95 ( V_92 ) ;
if ( V_4 ) {
F_96 ( V_4 -> V_17 ) ;
#ifdef F_80
if ( V_4 -> V_15 && V_4 -> V_15 -> V_208 )
...
#endif
if ( V_4 -> V_15 && V_4 -> V_15 -> V_205 &&
! ( V_4 -> V_17 -> V_190 & V_206 ) )
V_4 -> V_15 -> V_205 ( V_4 -> V_17 , 0 ) ;
F_6 ( 0 , F_54 ( V_4 ) ) ;
F_6 ( 0 , F_5 ( V_4 ) ) ;
F_6 ( 0 , F_9 ( V_4 ) ) ;
F_7 () ;
...
static int F_97 ( struct V_170 * V_92 , T_5 V_14 )
{
struct V_3 * V_4 = F_95 ( V_92 ) ;
F_6 ( 0 , F_9 ( V_4 ) ) ;
F_6 ( 0 , F_5 ( V_4 ) ) ;
...
static int F_98 ( struct V_170 * V_92 )
{
struct V_3 * V_4 = F_95 ( V_92 ) ;
F_53 ( V_4 ) ;
return 0 ;
