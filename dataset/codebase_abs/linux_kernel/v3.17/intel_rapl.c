...
if ( F_35 ( V_100 , V_97 , & V_37 ) || ! V_37 )
return - V_6 ;
return 0 ;
}
static int F_58 ( struct V_1 * V_3 , int V_100 )
{
int V_5 ;
int V_39 = 0 ;
struct V_14 * V_15 ;
...
V_3 -> V_9 = F_61 ( V_3 -> V_128 + 1 , sizeof( struct V_14 ) ,
V_142 ) ;
if ( ! V_3 -> V_9 ) {
V_39 = - V_143 ;
goto V_141;
...
F_30 ( V_3 ) ;
for ( V_15 = V_3 -> V_9 ; V_15 < V_3 -> V_9 + V_3 -> V_128 ; V_15 ++ ) {
if ( F_13 ( V_15 , V_103 , false , & V_140 ) ) {
F_59 ( L_22 ,
V_3 -> V_2 , V_15 -> V_25 ) ;
V_15 -> V_30 |= V_31 ;
}
...
int V_5 ;
int V_144 ;
struct V_1 * V_145 , * V_3 ;
F_4 (i) {
V_144 = F_5 ( V_5 ) ;
if ( F_62 ( V_144 ) ) {
V_145 = F_64 ( sizeof( * V_3 ) , V_142 ) ;
if ( ! V_145 ) {
F_6 () ;
return - V_143 ;
}
...
static int F_68 ( int V_100 )
{
int V_39 = 0 ;
int V_144 ;
struct V_1 * V_3 ;
V_144 = F_5 ( V_100 ) ;
V_3 = F_64 ( sizeof( struct V_1 ) , V_142 ) ;
if ( ! V_3 )
return - V_143 ;
V_3 -> V_2 = V_144 ;
V_3 -> V_146 = 1 ;
...
static int F_69 ( struct V_149 * V_150 ,
unsigned long V_151 , void * V_152 )
{
unsigned long V_100 = ( unsigned long ) V_152 ;
int V_144 ;
struct V_1 * V_3 ;
V_144 = F_5 ( V_100 ) ;
switch ( V_151 ) {
