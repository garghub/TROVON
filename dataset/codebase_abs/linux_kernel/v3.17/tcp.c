...
V_49 = F_166 ( V_251 , V_252 , V_253 , & V_114 ) ;
if ( V_49 < 0 ) {
F_44 ( 0 , L_63 , V_49 ) ;
goto V_63;
}
V_17 -> V_71 = V_114 ;
V_114 -> V_115 -> V_254 = V_52 ;
V_247 . V_255 = V_256 ;
V_247 . V_257 . V_258 = V_245 -> V_259 ;
V_247 . V_260 = F_167 ( 0 ) ;
V_49 = V_114 -> V_181 -> V_261 ( V_114 , (struct V_262 * ) & V_247 ,
sizeof( V_247 ) ) ;
if ( V_49 ) {
F_44 ( V_177 , L_64 ,
V_49 , & V_245 -> V_259 ) ;
...
F_32 ( & V_46 -> V_50 ) ;
V_248 . V_255 = V_256 ;
V_248 . V_257 . V_258 = V_7 -> V_259 ;
V_248 . V_260 = V_7 -> V_263 ;
V_49 = V_17 -> V_71 -> V_181 -> V_264 ( V_17 -> V_71 ,
(struct V_262 * ) & V_248 ,
sizeof( V_248 ) ,
V_265 ) ;
if ( V_49 == - V_266 )
...
static void F_168 ( struct V_89 * V_90 )
{
struct V_43 * V_46 =
...
F_180 ( & V_267 , V_271 ,
F_175 , NULL , V_270 ) ;
V_49 = F_181 ( NULL , & V_267 ) ;
if ( V_49 == 0 )
V_49 = F_181 ( NULL , & V_268 ) ;
if ( V_49 )
F_177 () ;
return V_49 ;
}
static int F_182 ( struct V_165 * V_114 , int * V_272 )
{
int V_49 , V_273 ;
struct V_246 sin ;
struct V_165 * V_274 = NULL ;
struct V_75 * V_7 = NULL ;
struct V_75 * V_275 = NULL ;
struct V_16 * V_17 = NULL ;
struct V_43 * V_46 ;
F_24 ( V_114 == NULL ) ;
* V_272 = 0 ;
V_49 = F_183 ( V_114 -> V_115 -> V_276 , V_114 -> V_115 -> V_277 ,
V_114 -> V_115 -> V_278 , & V_274 ) ;
if ( V_49 )
goto V_63;
V_274 -> type = V_114 -> type ;
V_274 -> V_181 = V_114 -> V_181 ;
V_49 = V_114 -> V_181 -> V_279 ( V_114 , V_274 , V_265 ) ;
if ( V_49 < 0 )
goto V_63;
* V_272 = 1 ;
V_274 -> V_115 -> V_254 = V_52 ;
V_49 = F_155 ( V_274 ) ;
if ( V_49 ) {
F_44 ( V_177 , L_65 , V_49 ) ;
goto V_63;
...
V_273 = sizeof( sin ) ;
V_49 = V_274 -> V_181 -> V_280 ( V_274 , (struct V_262 * ) & sin ,
& V_273 , 1 ) ;
if ( V_49 < 0 )
goto V_63;
V_7 = F_184 ( sin . V_257 . V_258 ) ;
if ( V_7 == NULL ) {
F_85 ( V_107 L_71
L_72 , & sin . V_257 . V_258 ,
F_185 ( sin . V_260 ) ) ;
V_49 = - V_153 ;
goto V_63;
}
...
L_74
L_75 ,
V_275 -> V_281 , V_275 -> V_110 ,
& ( V_275 -> V_259 ) ,
F_185 ( V_275 -> V_263 ) ,
V_7 -> V_281 ,
V_7 -> V_110 , & sin . V_257 . V_258 ,
F_185 ( sin . V_260 ) ) ;
V_49 = - V_153 ;
goto V_63;
}
...
static void F_187 ( struct V_89 * V_90 )
{
struct V_165 * V_114 = V_283 ;
int V_272 ;
int V_38 ;
for (; ; ) {
V_38 = F_182 ( V_114 , & V_272 ) ;
if ( ! V_272 )
break;
F_125 () ;
}
...
static int F_188 ( T_12 V_286 , T_13 V_287 )
{
struct V_165 * V_114 = NULL ;
int V_49 ;
struct V_246 sin = {
...
V_283 = V_114 ;
F_67 ( & V_285 , F_187 ) ;
V_114 -> V_115 -> V_289 = V_290 ;
V_49 = V_114 -> V_181 -> V_261 ( V_114 , (struct V_262 * ) & sin , sizeof( sin ) ) ;
if ( V_49 < 0 ) {
F_85 ( V_288 L_81
L_82 , V_49 , & V_286 , F_185 ( V_287 ) ) ;
goto V_63;
}
V_49 = V_114 -> V_181 -> V_291 ( V_114 , 64 ) ;
if ( V_49 < 0 )
F_85 ( V_288 L_83 ,
V_49 , & V_286 , F_185 ( V_287 ) ) ;
V_63:
if ( V_49 ) {
V_283 = NULL ;
if ( V_114 )
...
F_98 ( & V_114 -> V_115 -> V_116 ) ;
for ( V_293 = 0 ; V_293 < F_26 ( V_45 ) ; V_293 ++ ) {
struct V_75 * V_7 = F_165 ( V_293 ) ;
if ( V_7 ) {
F_171 ( V_7 ) ;
F_52 ( V_7 ) ;
}
...
if ( F_195 () )
return - V_154 ;
V_239 = F_62 ( sizeof( struct V_215 ) , V_294 ) ;
V_243 = F_62 ( sizeof( struct V_185 ) , V_294 ) ;
V_208 = F_62 ( sizeof( struct V_185 ) , V_294 ) ;
...
for ( V_293 = 0 ; V_293 < F_26 ( V_45 ) ; V_293 ++ ) {
struct V_43 * V_46 = F_25 ( V_293 ) ;
F_152 ( & V_46 -> V_224 , 0 ) ;
F_196 ( & V_46 -> V_50 ) ;
F_68 ( & V_46 -> V_113 , F_164 ) ;
F_68 ( & V_46 -> V_109 ,
F_168 ) ;
F_68 ( & V_46 -> V_105 , F_169 ) ;
V_46 -> V_99 = - V_102 ;
F_33 ( & V_46 -> V_104 ) ;
F_197 ( & V_46 -> V_51 ) ;
F_2 ( & V_46 -> V_55 ) ;
