...
static T_1 F_4 ( struct V_12 * V_12 , const char * V_13 ,
T_2 V_14 , T_3 * V_15 )
{
...
F_2 ( V_5 != NULL ) ;
V_8 = & V_5 -> V_9 . V_10 . V_8 ;
return F_3 ( V_2 , L_1 , V_8 -> V_19 ) ;
}
static T_1 F_8 ( struct V_12 * V_12 , const char * V_13 ,
T_2 V_14 , T_3 * V_15 )
{
struct V_4 * V_5 = ( (struct V_1 * ) V_12 -> V_16 ) -> V_6 ;
struct V_7 * V_8 ;
...
F_2 ( V_5 != NULL ) ;
V_8 = & V_5 -> V_9 . V_10 . V_8 ;
return F_3 ( V_2 , L_2 , V_8 -> V_20 ) ;
}
static T_1 F_10 ( struct V_12 * V_12 , const char * V_13 ,
T_2 V_14 , T_3 * V_15 )
{
struct V_4 * V_5 = ( (struct V_1 * ) V_12 -> V_16 ) -> V_6 ;
struct V_7 * V_8 ;
...
static T_1 F_14 ( struct V_12 * V_12 , const char * V_13 ,
T_2 V_14 , T_3 * V_15 )
{
struct V_4 * V_5 = ( (struct V_1 * ) V_12 -> V_16 ) -> V_6 ;
struct V_7 * V_8 ;
...
F_2 ( V_5 != NULL ) ;
V_10 = & V_5 -> V_9 . V_10 ;
return F_3 ( V_2 , L_4 , V_10 -> V_8 . V_26 . V_27 ) ;
}
static void * F_19 ( struct V_1 * V_28 , T_3 * V_29 )
{
...
static void * F_21 ( struct V_1 * V_28 , void * V_3 , T_3 * V_29 )
{
struct V_4 * V_5 = V_28 -> V_6 ;
struct V_25 * V_10 = & V_5 -> V_9 . V_10 ;
while ( ++ * V_29 < V_10 -> V_8 . V_23 ) {
