...
struct V_88 * V_89 )
{
struct V_8 * V_8 = (struct V_8 * ) V_146 ;
...
F_56 ( V_26 , & V_9 -> V_13 , V_40 -> V_108 -> V_151 ,
V_152 ) ;
F_57 ( & V_9 -> V_13 ) ;
F_58 ( V_26 ) ;
F_59 ( & V_9 -> V_13 , 32 ) ;
...
return F_65 ( V_153 , & V_134 -> V_87 , V_154 ) ;
}
...
F_71 ( V_26 ) ;
F_68 ( V_26 ) ;
V_40 -> V_108 -> V_160 ( V_26 ) ;
F_72 (connector, &dev->mode_config.connector_list,
head) {
struct V_161 * V_161 = F_73 ( V_159 ) ;
struct V_162 * V_163 = & V_161 -> V_27 ;
int V_164 = 0 , V_165 = 0 ;
switch ( V_161 -> type ) {
case V_166 :
V_164 = ( 1 << 0 ) ;
...
break;
case V_167 :
V_164 = V_40 -> V_108 -> V_168 ;
V_165 = ( 1 << V_167 ) ;
break;
case V_169 :
V_164 = V_40 -> V_108 -> V_170 ;
V_165 = ( 1 << V_169 ) ;
break;
case V_171 :
V_164 = ( 1 << 0 ) ;
...
{
struct V_39 * V_40 = V_26 -> V_41 ;
struct V_179 * V_180 = & V_40 -> V_180 ;
int V_43 ;
F_76 ( V_26 ) ;
V_26 -> V_117 . V_181 = 0 ;
V_26 -> V_117 . V_182 = 0 ;
V_26 -> V_117 . V_183 = & V_184 ;
F_77 ( V_26 -> V_91 , V_185 , ( T_2 * )
& ( V_26 -> V_117 . V_118 ) ) ;
for ( V_43 = 0 ; V_43 < V_40 -> V_186 ; V_43 ++ )
F_78 ( V_26 , V_43 , V_180 ) ;
