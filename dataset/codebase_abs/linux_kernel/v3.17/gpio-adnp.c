...
static int F_37 ( struct V_58 * V_48 )
{
struct V_1 * V_1 = F_32 ( V_48 ) ;
...
static int F_41 ( struct V_67 * V_56 , unsigned int V_47 ,
T_4 V_59 )
{
F_42 ( V_47 , V_56 -> V_68 ) ;
F_43 ( V_47 , & V_69 ) ;
...
int V_7 ;
F_49 ( & V_1 -> V_65 ) ;
V_1 -> V_60 = F_50 ( V_3 -> V_9 , V_20 * 6 , V_71 ) ;
if ( ! V_1 -> V_60 )
return - V_72 ;
...
static int F_58 ( struct V_77 * V_8 ,
const struct V_78 * V_79 )
{
struct V_80 * V_81 = V_8 -> V_9 . V_44 ;
struct V_1 * V_1 ;
T_5 V_32 ;
int V_7 ;
V_7 = F_59 ( V_81 , L_15 , & V_32 ) ;
if ( V_7 < 0 )
return V_7 ;
V_8 -> V_47 = F_60 ( V_81 , 0 ) ;
if ( ! V_8 -> V_47 )
return - V_82 ;
V_1 = F_50 ( & V_8 -> V_9 , sizeof( * V_1 ) , V_71 ) ;
if ( ! V_1 )
return - V_72 ;
F_49 ( & V_1 -> V_14 ) ;
V_1 -> V_8 = V_8 ;
...
static int F_64 ( struct V_77 * V_8 )
{
