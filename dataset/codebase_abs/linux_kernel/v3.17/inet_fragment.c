...
struct V_1 * V_2 ;
V_2 = F_25 ( V_39 , struct V_1 , V_42 ) ;
F_26 ( V_41 >= V_6 ) ;
F_27 () ;
for ( V_10 = F_28 ( V_2 -> V_43 ) ; V_40 ; -- V_40 ) {
...
F_38 ( & V_2 -> V_11 ) ;
V_2 -> V_8 = 0 ;
V_2 -> V_45 = F_39 ( V_2 -> V_46 , V_2 -> V_47 , 0 , 0 ,
NULL ) ;
if ( ! V_2 -> V_45 )
return - V_48 ;
return 0 ;
...
void F_45 ( struct V_49 * V_50 , struct V_1 * V_2 )
{
unsigned int V_51 ;
int V_10 ;
V_50 -> V_28 = 0 ;
...
if ( F_47 ( & V_2 -> V_11 , V_51 ) )
goto V_32;
F_29 () ;
F_48 ( & V_50 -> V_52 ) ;
}
static struct V_15 *
F_49 ( struct V_3 * V_29 , struct V_1 * V_2 )
...
static inline void F_50 ( struct V_3 * V_29 , struct V_1 * V_2 )
{
struct V_15 * V_16 ;
V_16 = F_49 ( V_29 , V_2 ) ;
F_9 ( & V_29 -> V_23 ) ;
...
void F_51 ( struct V_3 * V_29 , struct V_1 * V_2 )
{
if ( F_18 ( & V_29 -> V_33 ) )
F_52 ( & V_29 -> V_34 ) ;
if ( ! ( V_29 -> V_35 & V_54 ) ) {
...
static inline void F_53 ( struct V_49 * V_50 , struct V_1 * V_2 ,
struct V_55 * V_56 )
{
if ( V_2 -> V_57 )
V_2 -> V_57 ( V_56 ) ;
...
void F_55 ( struct V_3 * V_4 , struct V_1 * V_2 )
{
struct V_55 * V_58 ;
struct V_49 * V_50 ;
unsigned int V_59 , V_60 = 0 ;
F_21 ( ! ( V_4 -> V_35 & V_54 ) ) ;
F_21 ( F_18 ( & V_4 -> V_33 ) != 0 ) ;
V_58 = V_4 -> V_61 ;
V_50 = V_4 -> V_27 ;
while ( V_58 ) {
...
static struct V_3 * F_58 ( struct V_49 * V_50 ,
struct V_3 * V_66 ,
struct V_1 * V_2 ,
void * V_67 )
{
struct V_15 * V_16 = F_49 ( V_66 , V_2 ) ;
struct V_3 * V_68 ;
#ifdef F_59
F_60 (qp, &hb->chain, list) {
...
#endif
V_68 = V_66 ;
if ( ! F_61 ( & V_68 -> V_33 , V_7 + V_50 -> V_70 ) )
F_19 ( & V_68 -> V_34 ) ;
F_19 ( & V_68 -> V_34 ) ;
...
static struct V_3 * F_62 ( struct V_49 * V_50 ,
struct V_1 * V_2 ,
void * V_67 )
{
struct V_3 * V_4 ;
...
V_4 = F_63 ( V_2 -> V_45 , V_72 ) ;
if ( V_4 == NULL )
return NULL ;
V_4 -> V_27 = V_50 ;
V_2 -> V_73 ( V_4 , V_67 ) ;
F_64 ( V_4 , V_2 -> V_47 ) ;
F_65 ( & V_4 -> V_33 , V_2 -> V_37 , ( unsigned long ) V_4 ) ;
F_36 ( & V_4 -> V_74 ) ;
F_66 ( & V_4 -> V_34 , 1 ) ;
return V_4 ;
}
static struct V_3 * F_67 ( struct V_49 * V_50 ,
struct V_1 * V_2 ,
void * V_67 )
{
struct V_3 * V_4 ;
V_4 = F_62 ( V_50 , V_2 , V_67 ) ;
if ( V_4 == NULL )
return NULL ;
return F_58 ( V_50 , V_4 , V_2 , V_67 ) ;
}
struct V_3 * F_68 ( struct V_49 * V_50 ,
