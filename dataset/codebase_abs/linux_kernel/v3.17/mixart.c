...
{
struct V_50 * V_51 = V_200 -> V_201 ;
return F_45 ( V_51 ) ;
}
static int F_47 ( struct V_1 * V_2 , struct V_202 * V_73 , int V_203 )
{
int V_12 ;
struct V_50 * V_51 ;
...
V_51 -> V_74 = V_203 ;
V_51 -> V_2 = V_2 ;
if ( ( V_12 = F_49 ( V_73 , V_208 , V_51 , & V_205 ) ) < 0 ) {
F_45 ( V_51 ) ;
return V_12 ;
}
V_2 -> V_51 [ V_203 ] = V_51 ;
...
{
unsigned int V_67 ;
for ( V_67 = 0 ; V_67 < V_2 -> V_211 ; V_67 ++ ) {
if ( V_2 -> V_51 [ V_67 ] )
...
if ( V_2 -> V_214 [ V_67 ] . V_215 )
F_56 ( V_2 -> V_214 [ V_67 ] . V_215 ) ;
}
F_57 ( V_2 -> V_18 ) ;
if( V_2 -> V_82 . V_92 ) {
F_58 ( & V_2 -> V_82 ) ;
...
static T_4 F_60 ( struct V_216 * V_217 ,
void * V_218 ,
struct V_219 * V_219 , char T_5 * V_72 ,
T_6 V_220 , T_7 V_221 )
{
struct V_1 * V_2 = V_217 -> V_127 ;
V_220 = V_220 & ~ 3 ;
if ( F_61 ( V_72 , F_62 ( V_2 , V_221 ) , V_220 ) )
return - V_222 ;
return V_220 ;
}
static T_4 F_63 ( struct V_216 * V_217 ,
void * V_218 ,
struct V_219 * V_219 , char T_5 * V_72 ,
T_6 V_220 , T_7 V_221 )
{
struct V_1 * V_2 = V_217 -> V_127 ;
V_220 = V_220 & ~ 3 ;
if ( F_61 ( V_72 , F_64 ( V_2 , V_221 ) , V_220 ) )
return - V_222 ;
return V_220 ;
}
static void F_65 ( struct V_216 * V_217 ,
struct V_223 * V_224 )
{
struct V_50 * V_51 = V_217 -> V_127 ;
T_1 V_225 ;
F_66 ( V_224 , L_37 , V_51 -> V_74 ) ;
if ( V_51 -> V_2 -> V_213 & ( 1 << V_226 ) ) {
F_66 ( V_224 , L_38 ) ;
switch ( V_51 -> V_2 -> V_209 ) {
case V_227 : F_66 ( V_224 , L_39 ) ; break;
case V_210 : F_66 ( V_224 , L_40 ) ; break;
case V_228 : F_66 ( V_224 , L_41 ) ; break;
default: F_66 ( V_224 , L_42 ) ; break;
}
F_66 ( V_224 , L_43 ) ;
V_225 = F_67 ( F_62 ( V_51 -> V_2 , V_229 ) ) ;
if ( V_225 ) {
T_1 V_230 = 100 * F_67 ( F_62 ( V_51 -> V_2 , V_231 ) ) / V_225 ;
T_1 V_232 = 100 * F_67 ( F_62 ( V_51 -> V_2 , V_233 ) ) / V_225 ;
T_1 V_234 = 100 * F_67 ( F_62 ( V_51 -> V_2 , V_235 ) ) / V_225 ;
F_66 ( V_224 , L_44 , V_232 ) ;
F_66 ( V_224 , L_45 , V_230 ) ;
F_66 ( V_224 , L_46 , V_234 ) ;
}
}
}
...
{
struct V_216 * V_217 ;
if ( ! F_69 ( V_51 -> V_73 , L_47 , & V_217 ) ) {
V_217 -> V_127 = V_51 ;
V_217 -> V_236 . V_237 . V_238 = F_65 ;
}
if ( ! F_69 ( V_51 -> V_73 , L_48 , & V_217 ) ) {
V_217 -> V_239 = V_240 ;
V_217 -> V_127 = V_51 -> V_2 ;
V_217 -> V_236 . V_205 = & V_241 ;
V_217 -> V_26 = V_242 ;
}
if ( ! F_69 ( V_51 -> V_73 , L_49 , & V_217 ) ) {
V_217 -> V_239 = V_240 ;
V_217 -> V_127 = V_51 -> V_2 ;
V_217 -> V_236 . V_205 = & V_243 ;
V_217 -> V_26 = V_244 ;
}
}
static int F_70 ( struct V_245 * V_18 ,
...
V_2 -> V_18 = V_18 ;
V_2 -> V_212 = - 1 ;
if ( ( V_12 = F_75 ( V_18 , V_253 ) ) < 0 ) {
F_9 ( V_2 ) ;
F_59 ( V_18 ) ;
return V_12 ;
}
for ( V_67 = 0 ; V_67 < 2 ; V_67 ++ ) {
V_2 -> V_214 [ V_67 ] . V_254 = F_76 ( V_18 , V_67 ) ;
V_2 -> V_214 [ V_67 ] . V_215 = F_77 ( V_18 , V_67 ) ;
if ( ! V_2 -> V_214 [ V_67 ] . V_215 ) {
F_2 ( & V_18 -> V_19 , L_51 ,
V_2 -> V_214 [ V_67 ] . V_254 ) ;
F_51 ( V_2 ) ;
return - V_140 ;
}
}
if ( F_78 ( V_18 -> V_212 , V_255 , V_256 ,
V_257 , V_2 ) ) {
F_2 ( & V_18 -> V_19 , L_52 , V_18 -> V_212 ) ;
F_51 ( V_2 ) ;
return - V_140 ;
}
V_2 -> V_212 = V_18 -> V_212 ;
sprintf ( V_2 -> V_258 , L_53 ) ;
sprintf ( V_2 -> V_259 , L_54 , V_2 -> V_258 , V_2 -> V_214 [ 0 ] . V_254 , V_2 -> V_214 [ 1 ] . V_254 , V_2 -> V_212 ) ;
F_79 ( & V_2 -> V_260 ) ;
V_2 -> V_261 = 0 ;
V_2 -> V_262 = 0 ;
F_79 ( & V_2 -> V_263 ) ;
...
F_82 ( & V_2 -> V_139 , 0 ) ;
F_80 ( & V_2 -> V_173 ) ;
F_83 ( & V_2 -> V_266 , V_267 , ( unsigned long ) V_2 ) ;
V_2 -> V_211 = V_268 ;
for ( V_67 = 0 ; V_67 < V_2 -> V_211 ; V_67 ++ ) {
struct V_202 * V_73 ;
char V_269 [ 16 ] ;
...
V_203 = V_270 [ V_19 ] + V_67 ;
snprintf ( V_269 , sizeof( V_269 ) , L_55 , V_271 [ V_19 ] ? V_271 [ V_19 ] : L_56 , V_67 ) ;
V_12 = F_84 ( & V_18 -> V_19 , V_203 , V_269 , V_272 ,
0 , & V_73 ) ;
if ( V_12 < 0 ) {
...
strcpy ( V_73 -> V_273 , V_253 ) ;
sprintf ( V_73 -> V_258 , L_58 , V_2 -> V_258 , V_67 ) ;
sprintf ( V_73 -> V_259 , L_58 , V_2 -> V_259 , V_67 ) ;
...
V_2 -> V_209 = V_227 ;
V_26 = F_86 ( ( V_90 * V_268 *
sizeof( struct V_81 ) ) ) ;
if ( F_87 ( V_194 , F_40 ( V_18 ) ,
V_26 , & V_2 -> V_82 ) < 0 ) {
F_51 ( V_2 ) ;
return - V_207 ;
}
...
static void F_90 ( struct V_245 * V_18 )
{
F_51 ( F_91 ( V_18 ) ) ;
}
