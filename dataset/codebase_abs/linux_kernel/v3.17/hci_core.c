...
static void F_157 ( struct V_126 * V_127 , unsigned long V_131 )
{
struct V_1 * V_2 = V_127 -> V_2 ;
F_92 ( L_22 , V_2 -> V_102 , V_131 ) ;
if ( ! F_4 ( V_145 , & V_2 -> V_146 ) )
...
return 0 ;
V_16 = F_109 ( V_2 , F_157 , 0 , V_221 ) ;
if ( V_16 < 0 )
return V_16 ;
return 0 ;
}
static void F_159 ( struct V_126 * V_127 , unsigned long V_131 )
{
T_12 V_261 = V_131 ;
...
void F_168 ( struct V_1 * V_2 , int V_271 )
{
...
F_180 ( & V_282 -> V_64 , V_283 ) ;
}
T_9 F_181 ( struct V_1 * V_2 , struct V_51 * V_26 ,
bool V_285 )
{
struct V_46 * V_47 = & V_2 -> V_48 ;
struct V_49 * V_282 ;
...
V_282 = F_183 ( sizeof( * V_282 ) , V_289 ) ;
if ( ! V_282 ) {
V_18 |= V_290 ;
goto V_291;
}
F_180 ( & V_282 -> V_278 , & V_47 -> V_278 ) ;
if ( V_285 ) {
V_282 -> V_281 = V_292 ;
} else {
V_282 -> V_281 = V_293 ;
F_180 ( & V_282 -> V_64 , & V_47 -> V_279 ) ;
}
V_288:
...
static int F_184 ( struct V_1 * V_2 , int V_295 , T_12 * V_9 )
{
struct V_46 * V_47 = & V_2 -> V_48 ;
...
static void F_185 ( struct V_126 * V_127 , unsigned long V_131 )
{
...
F_19 ( V_2 ) ;
if ( F_187 ( V_2 ) > V_316 ||
F_188 ( V_2 ) || V_300 . V_18 & V_317 ) {
F_171 ( V_2 ) ;
V_308 = 1 ;
}
F_22 ( V_2 ) ;
V_310 = V_300 . V_304 * F_189 ( 2000 ) ;
if ( V_308 ) {
V_16 = F_111 ( V_2 , F_185 , ( unsigned long ) & V_300 ,
V_310 ) ;
if ( V_16 < 0 )
goto V_291;
if ( F_190 ( & V_2 -> V_18 , V_302 ,
V_128 ) )
return - V_129 ;
}
V_309 = ( V_300 . V_305 == 0 ) ? 255 : V_300 . V_305 ;
V_9 = F_191 ( sizeof( struct V_296 ) * V_309 , V_289 ) ;
if ( ! V_9 ) {
V_16 = - V_318 ;
goto V_291;
}
F_19 ( V_2 ) ;
V_300 . V_305 = F_184 ( V_2 , V_309 , V_9 ) ;
F_22 ( V_2 ) ;
F_92 ( L_68 , V_300 . V_305 ) ;
if ( ! F_192 ( V_29 , & V_300 , sizeof( V_300 ) ) ) {
V_29 += sizeof( V_300 ) ;
if ( F_192 ( V_29 , V_9 , sizeof( struct V_296 ) *
V_300 . V_305 ) )
V_16 = - V_20 ;
} else
V_16 = - V_20 ;
...
V_2 -> V_341 ( V_2 ) ;
V_2 -> V_18 &= F_199 ( V_342 ) ;
}
V_291:
F_12 ( V_2 ) ;
return V_132 ;
}
int F_200 ( T_13 V_343 )
{
struct V_1 * V_2 ;
int V_16 ;
V_2 = F_163 ( V_343 ) ;
...
static void F_213 ( struct V_1 * V_2 , T_5 V_261 )
{
bool V_370 , V_371 ;
...
int F_217 ( unsigned int V_375 , void T_2 * V_307 )
{
struct V_1 * V_2 ;
struct V_376 V_377 ;
int V_16 = 0 ;
...
break;
case V_382 :
V_16 = F_111 ( V_2 , F_159 , V_377 . V_379 ,
V_221 ) ;
if ( ! V_16 )
F_213 ( V_2 , V_377 . V_379 ) ;
break;
case V_383 :
...
return - V_20 ;
V_2 = F_163 ( V_403 . V_311 ) ;
if ( ! V_2 )
return - V_312 ;
if ( F_4 ( V_344 , & V_2 -> V_72 ) )
V_18 = V_2 -> V_18 & ~ F_199 ( V_17 ) ;
else
V_18 = V_2 -> V_18 ;
...
if ( F_192 ( V_307 , & V_403 , sizeof( V_403 ) ) )
V_16 = - V_20 ;
F_193 ( V_2 ) ;
return V_16 ;
}
static int F_222 ( void * V_26 , bool V_407 )
{
struct V_1 * V_2 = V_26 ;
...
static void F_223 ( struct V_408 * V_409 )
{
struct V_1 * V_2 = F_224 ( V_409 , struct V_1 , V_410 ) ;
int V_16 ;
F_92 ( L_19 , V_2 -> V_102 ) ;
V_16 = F_194 ( V_2 ) ;
if ( V_16 < 0 ) {
...
F_226 ( V_2 -> V_346 , & V_2 -> V_345 ,
V_411 ) ;
}
if ( F_201 ( V_222 , & V_2 -> V_72 ) ) {
if ( F_4 ( V_314 , & V_2 -> V_72 ) )
F_113 ( V_342 , & V_2 -> V_18 ) ;
F_227 ( V_2 ) ;
} else if ( F_201 ( V_320 , & V_2 -> V_72 ) ) {
if ( ! F_4 ( V_314 , & V_2 -> V_72 ) )
F_133 ( V_342 , & V_2 -> V_18 ) ;
F_227 ( V_2 ) ;
}
}
static void F_228 ( struct V_408 * V_409 )
{
struct V_1 * V_2 = F_224 ( V_409 , struct V_1 ,
V_345 . V_409 ) ;
F_92 ( L_19 , V_2 -> V_102 ) ;
F_207 ( V_2 ) ;
}
...
{
struct V_1 * V_2 ;
V_2 = F_224 ( V_409 , struct V_1 , V_353 . V_409 ) ;
F_92 ( L_19 , V_2 -> V_102 ) ;
F_230 ( V_2 ) ;
}
...
struct V_62 * F_235 ( struct V_1 * V_2 , T_7 * V_40 )
{
struct V_62 * V_413 ;
...
static bool F_236 ( struct V_1 * V_2 , struct V_414 * V_349 ,
T_5 V_415 , T_5 V_416 )
{
if ( V_415 < 0x03 )
return true ;
...
static T_5 F_237 ( T_5 type )
{
if ( type == V_421 )
return V_422 ;
return V_423 ;
}
struct V_87 * F_238 ( struct V_1 * V_2 , T_11 V_91 , T_14 rand ,
T_5 V_424 )
{
struct V_87 * V_413 ;
...
continue;
if ( F_237 ( V_413 -> type ) != V_424 )
continue;
return V_413 ;
}
return NULL ;
}
struct V_87 * F_239 ( struct V_1 * V_2 , T_7 * V_40 ,
T_5 V_80 , T_5 V_424 )
{
struct V_87 * V_413 ;
F_26 (k, &hdev->long_term_keys, list)
...
F_237 ( V_413 -> type ) == V_424 )
return V_413 ;
return NULL ;
}
struct V_86 * F_240 ( struct V_1 * V_2 , T_7 * V_82 )
{
struct V_86 * V_81 ;
...
F_26 (irk, &hdev->identity_resolving_keys, list) {
if ( F_241 ( V_2 -> V_425 , V_81 -> V_45 , V_82 ) ) {
...
struct V_86 * F_242 ( struct V_1 * V_2 , T_7 * V_40 ,
T_5 V_80 )
{
struct V_86 * V_81 ;
if ( V_80 == V_426 && ( V_40 -> V_39 [ 5 ] & 0xc0 ) != 0xc0 )
return NULL ;
F_26 (irk, &hdev->identity_resolving_keys, list) {
if ( V_80 == V_81 -> V_80 &&
...
struct V_62 * F_243 ( struct V_1 * V_2 , struct V_414 * V_349 ,
T_7 * V_40 , T_5 * V_45 , T_5 type ,
T_5 V_66 , bool * V_427 )
{
struct V_62 * V_63 , * V_428 ;
T_5 V_416 ;
V_428 = F_235 ( V_2 , V_40 ) ;
if ( V_428 ) {
V_416 = V_428 -> type ;
V_63 = V_428 ;
} else {
V_416 = V_349 ? V_349 -> V_415 : 0xff ;
V_63 = F_183 ( sizeof( * V_63 ) , V_289 ) ;
if ( ! V_63 )
return NULL ;
F_180 ( & V_63 -> V_64 , & V_2 -> V_429 ) ;
}
...
V_63 -> type = type ;
if ( V_427 )
* V_427 = F_236 ( V_2 , V_349 , type ,
V_416 ) ;
return V_63 ;
}
struct V_87 * F_244 ( struct V_1 * V_2 , T_7 * V_40 ,
T_5 V_80 , T_5 type , T_5 V_89 ,
T_5 V_431 [ 16 ] , T_5 V_90 , T_11 V_91 , T_14 rand )
{
struct V_87 * V_63 , * V_428 ;
T_5 V_424 = F_237 ( type ) ;
V_428 = F_239 ( V_2 , V_40 , V_80 , V_424 ) ;
if ( V_428 )
V_63 = V_428 ;
else {
V_63 = F_183 ( sizeof( * V_63 ) , V_289 ) ;
if ( ! V_63 )
return NULL ;
F_180 ( & V_63 -> V_64 , & V_2 -> V_432 ) ;
}
F_148 ( & V_63 -> V_40 , V_40 ) ;
V_63 -> V_41 = V_80 ;
memcpy ( V_63 -> V_45 , V_431 , sizeof( V_63 -> V_45 ) ) ;
V_63 -> V_89 = V_89 ;
V_63 -> V_91 = V_91 ;
V_63 -> rand = rand ;
V_63 -> V_90 = V_90 ;
...
struct V_86 * F_245 ( struct V_1 * V_2 , T_7 * V_40 ,
T_5 V_80 , T_5 V_45 [ 16 ] , T_7 * V_82 )
{
struct V_86 * V_81 ;
V_81 = F_242 ( V_2 , V_40 , V_80 ) ;
if ( ! V_81 ) {
V_81 = F_183 ( sizeof( * V_81 ) , V_289 ) ;
if ( ! V_81 )
return NULL ;
F_148 ( & V_81 -> V_40 , V_40 ) ;
V_81 -> V_80 = V_80 ;
F_180 ( & V_81 -> V_64 , & V_2 -> V_433 ) ;
}
memcpy ( V_81 -> V_45 , V_45 , 16 ) ;
F_148 ( & V_81 -> V_82 , V_82 ) ;
return V_81 ;
}
int F_246 ( struct V_1 * V_2 , T_7 * V_40 )
{
struct V_62 * V_63 ;
V_63 = F_235 ( V_2 , V_40 ) ;
if ( ! V_63 )
...
int F_247 ( struct V_1 * V_2 , T_7 * V_40 , T_5 V_41 )
{
struct V_87 * V_413 , * V_412 ;
int V_435 = 0 ;
F_172 (k, tmp, &hdev->long_term_keys, list) {
...
return V_435 ? 0 : - V_434 ;
}
void F_248 ( struct V_1 * V_2 , T_7 * V_40 , T_5 V_80 )
{
struct V_86 * V_413 , * V_412 ;
F_172 (k, tmp, &hdev->identity_resolving_keys, list) {
...
static void F_249 ( struct V_408 * V_409 )
{
struct V_1 * V_2 = F_224 ( V_409 , struct V_1 ,
V_351 . V_409 ) ;
if ( V_2 -> V_340 ) {
struct V_436 * V_437 = ( void * ) V_2 -> V_340 -> V_26 ;
T_8 V_109 = F_33 ( V_437 -> V_109 ) ;
F_97 ( L_75 , V_2 -> V_102 , V_109 ) ;
} else {
F_97 ( L_76 , V_2 -> V_102 ) ;
}
F_195 ( & V_2 -> V_326 , 1 ) ;
F_250 ( V_2 -> V_438 , & V_2 -> V_335 ) ;
}
struct V_439 * F_251 ( struct V_1 * V_2 ,
T_7 * V_40 )
{
struct V_439 * V_26 ;
...
int F_182 ( struct V_1 * V_2 , T_7 * V_40 )
{
struct V_439 * V_26 ;
V_26 = F_251 ( V_2 , V_40 ) ;
if ( ! V_26 )
...
struct V_38 * F_255 ( struct V_60 * V_38 ,
T_7 * V_40 , T_5 type )
{
struct V_38 * V_39 ;
...
int F_257 ( struct V_60 * V_64 , T_7 * V_40 , T_5 type )
{
struct V_38 * V_447 ;
if ( ! F_156 ( V_40 , V_209 ) )
return - V_448 ;
if ( F_255 ( V_64 , V_40 , type ) )
return - V_449 ;
V_447 = F_183 ( sizeof( * V_447 ) , V_289 ) ;
if ( ! V_447 )
return - V_318 ;
F_148 ( & V_447 -> V_40 , V_40 ) ;
V_447 -> V_41 = type ;
F_180 ( & V_447 -> V_64 , V_64 ) ;
return 0 ;
}
int F_258 ( struct V_60 * V_64 , T_7 * V_40 , T_5 type )
{
struct V_38 * V_447 ;
if ( ! F_156 ( V_40 , V_209 ) ) {
F_256 ( V_64 ) ;
...
struct V_99 * F_259 ( struct V_1 * V_2 ,
T_7 * V_79 , T_5 V_80 )
{
struct V_99 * V_450 ;
if ( ! F_260 ( V_79 , V_80 ) )
...
static bool F_261 ( struct V_1 * V_2 , T_7 * V_79 , T_5 type )
{
struct V_414 * V_349 ;
V_349 = F_262 ( V_2 , V_451 , V_79 ) ;
if ( ! V_349 )
return false ;
if ( V_349 -> V_452 != type )
return false ;
if ( V_349 -> V_271 != V_453 )
return false ;
return true ;
}
struct V_99 * F_263 ( struct V_60 * V_64 ,
T_7 * V_79 , T_5 V_80 )
{
struct V_99 * V_122 ;
if ( ! F_260 ( V_79 , V_80 ) )
...
struct V_99 * F_264 ( struct V_1 * V_2 ,
T_7 * V_79 , T_5 V_80 )
{
struct V_99 * V_450 ;
if ( ! F_260 ( V_79 , V_80 ) )
return NULL ;
V_450 = F_259 ( V_2 , V_79 , V_80 ) ;
if ( V_450 )
return V_450 ;
V_450 = F_183 ( sizeof( * V_450 ) , V_289 ) ;
if ( ! V_450 ) {
F_97 ( L_78 ) ;
return NULL ;
}
F_148 ( & V_450 -> V_79 , V_79 ) ;
V_450 -> V_80 = V_80 ;
F_180 ( & V_450 -> V_64 , & V_2 -> V_454 ) ;
F_175 ( & V_450 -> V_350 ) ;
V_450 -> V_455 = V_2 -> V_93 ;
V_450 -> V_456 = V_2 -> V_92 ;
V_450 -> V_457 = V_2 -> V_94 ;
V_450 -> V_458 = V_2 -> V_95 ;
V_450 -> V_100 = V_459 ;
F_92 ( L_79 , V_79 , V_80 ) ;
return V_450 ;
}
int F_265 ( struct V_1 * V_2 , T_7 * V_79 , T_5 V_80 ,
T_5 V_100 )
{
struct V_99 * V_450 ;
V_450 = F_264 ( V_2 , V_79 , V_80 ) ;
if ( ! V_450 )
return - V_325 ;
if ( V_450 -> V_100 == V_100 )
return 0 ;
F_206 ( & V_450 -> V_350 ) ;
switch ( V_100 ) {
case V_459 :
...
break;
case V_461 :
F_180 ( & V_450 -> V_350 , & V_2 -> V_462 ) ;
F_169 ( V_2 ) ;
break;
case V_463 :
case V_464 :
if ( ! F_261 ( V_2 , V_79 , V_80 ) ) {
F_180 ( & V_450 -> V_350 , & V_2 -> V_465 ) ;
F_169 ( V_2 ) ;
}
break;
}
...
void F_266 ( struct V_1 * V_2 , T_7 * V_79 , T_5 V_80 )
{
struct V_99 * V_450 ;
V_450 = F_259 ( V_2 , V_79 , V_80 ) ;
if ( ! V_450 )
...
{
struct V_99 * V_450 , * V_412 ;
F_172 (params, tmp, &hdev->le_conn_params, list) {
if ( V_450 -> V_100 != V_459 )
continue;
F_173 ( & V_450 -> V_64 ) ;
F_174 ( V_450 ) ;
}
...
static void F_269 ( struct V_1 * V_2 , T_5 V_466 )
{
if ( V_466 ) {
F_97 ( L_83 , V_466 ) ;
F_19 ( V_2 ) ;
...
static void F_270 ( struct V_1 * V_2 , T_5 V_466 )
{
...
static void F_271 ( struct V_408 * V_409 )
{
struct V_1 * V_2 = F_224 ( V_409 , struct V_1 ,
V_358 . V_409 ) ;
struct V_126 V_127 ;
...
F_101 ( & V_127 , V_2 ) ;
F_272 ( & V_127 ) ;
V_16 = F_103 ( & V_127 , F_270 ) ;
if ( V_16 )
F_97 ( L_86 , V_16 ) ;
}
static void F_273 ( struct V_126 * V_127 , T_7 * V_82 )
{
struct V_1 * V_2 = V_127 -> V_2 ;
if ( F_4 ( V_470 , & V_2 -> V_72 ) ||
F_274 ( V_2 , V_451 , V_471 ) ) {
F_92 ( L_87 ) ;
return;
}
F_114 ( V_127 , V_472 , 6 , V_82 ) ;
}
int F_275 ( struct V_126 * V_127 , bool V_473 ,
T_5 * V_474 )
{
struct V_1 * V_2 = V_127 -> V_2 ;
int V_16 ;
if ( F_4 ( V_475 , & V_2 -> V_72 ) ) {
int V_476 ;
* V_474 = V_426 ;
if ( ! F_201 ( V_332 , & V_2 -> V_72 ) &&
! F_156 ( & V_2 -> V_83 , & V_2 -> V_82 ) )
return 0 ;
V_16 = F_276 ( V_2 -> V_425 , V_2 -> V_81 , & V_2 -> V_82 ) ;
if ( V_16 < 0 ) {
F_97 ( L_88 , V_2 -> V_102 ) ;
return V_16 ;
}
F_273 ( V_127 , & V_2 -> V_82 ) ;
V_476 = F_189 ( V_2 -> V_74 * 1000 ) ;
F_226 ( V_2 -> V_438 , & V_2 -> V_359 , V_476 ) ;
return 0 ;
}
if ( V_473 ) {
T_7 V_477 ;
...
struct V_1 * F_278 ( void )
{
struct V_1 * V_2 ;
V_2 = F_183 ( sizeof( * V_2 ) , V_289 ) ;
if ( ! V_2 )
return NULL ;
V_2 -> V_389 = ( V_479 | V_480 | V_481 ) ;
V_2 -> V_482 = ( V_483 ) ;
V_2 -> V_385 = ( V_387 ) ;
V_2 -> V_484 = 0x01 ;
V_2 -> V_485 = 0x03 ;
...
F_175 ( & V_2 -> V_465 ) ;
F_175 ( & V_2 -> V_462 ) ;
F_175 ( & V_2 -> V_502 . V_64 ) ;
F_280 ( & V_2 -> V_336 , V_503 ) ;
F_280 ( & V_2 -> V_335 , V_504 ) ;
F_280 ( & V_2 -> V_334 , V_505 ) ;
F_280 ( & V_2 -> V_410 , F_223 ) ;
F_281 ( & V_2 -> V_345 , F_228 ) ;
F_281 ( & V_2 -> V_353 , F_229 ) ;
F_281 ( & V_2 -> V_358 , F_271 ) ;
F_282 ( & V_2 -> V_338 ) ;
F_282 ( & V_2 -> V_337 ) ;
F_282 ( & V_2 -> V_361 ) ;
F_283 ( & V_2 -> V_107 ) ;
F_281 ( & V_2 -> V_351 , F_249 ) ;
F_284 ( V_2 ) ;
F_285 ( V_2 ) ;
return V_2 ;
}
...
{
int V_269 , error ;
if ( ! V_2 -> V_324 || ! V_2 -> V_341 || ! V_2 -> V_506 )
return - V_21 ;
switch ( V_2 -> V_147 ) {
case V_148 :
V_269 = F_289 ( & V_507 , 0 , 0 , V_289 ) ;
break;
case V_149 :
V_269 = F_289 ( & V_507 , 1 , 0 , V_289 ) ;
break;
default:
return - V_21 ;
}
...
V_2 -> V_438 = F_290 ( L_19 , V_508 | V_509 |
V_510 , 1 , V_2 -> V_102 ) ;
if ( ! V_2 -> V_438 ) {
error = - V_318 ;
goto V_16;
}
V_2 -> V_346 = F_290 ( L_19 , V_508 | V_509 |
V_510 , 1 , V_2 -> V_102 ) ;
if ( ! V_2 -> V_346 ) {
F_291 ( V_2 -> V_438 ) ;
error = - V_318 ;
...
if ( ! F_292 ( V_511 ) )
V_2 -> V_223 = F_293 ( V_2 -> V_102 , V_511 ) ;
F_294 ( & V_2 -> V_343 , L_19 , V_2 -> V_102 ) ;
V_2 -> V_425 = F_295 ( L_91 , 0 ,
V_512 ) ;
if ( F_13 ( V_2 -> V_425 ) ) {
F_97 ( L_92 ) ;
error = F_14 ( V_2 -> V_425 ) ;
V_2 -> V_425 = NULL ;
goto V_513;
}
error = F_296 ( & V_2 -> V_343 ) ;
if ( error < 0 )
goto V_514;
V_2 -> V_515 = F_297 ( V_2 -> V_102 , & V_2 -> V_343 ,
V_516 , & V_517 ,
V_2 ) ;
if ( V_2 -> V_515 ) {
if ( F_298 ( V_2 -> V_515 ) < 0 ) {
F_299 ( V_2 -> V_515 ) ;
V_2 -> V_515 = NULL ;
}
}
if ( V_2 -> V_515 && F_300 ( V_2 -> V_515 ) )
F_113 ( V_321 , & V_2 -> V_72 ) ;
...
F_301 ( & V_268 ) ;
F_180 ( & V_2 -> V_64 , & V_518 ) ;
F_302 ( & V_268 ) ;
if ( F_4 ( V_260 , & V_2 -> V_146 ) )
F_113 ( V_314 , & V_2 -> V_72 ) ;
F_1 ( V_2 , V_519 ) ;
F_165 ( V_2 ) ;
F_250 ( V_2 -> V_346 , & V_2 -> V_410 ) ;
return V_269 ;
V_514:
F_303 ( V_2 -> V_425 ) ;
V_513:
...
int F_315 ( struct V_1 * V_2 , struct V_12 * V_13 )
{
...
F_316 ( V_13 ) -> V_526 = 1 ;
F_317 ( V_13 ) ;
F_318 ( & V_2 -> V_338 , V_13 ) ;
F_250 ( V_2 -> V_438 , & V_2 -> V_336 ) ;
return 0 ;
}
static int F_319 ( struct V_1 * V_2 , int type , void * V_26 ,
int V_6 , T_12 V_266 )
{
int V_116 = 0 ;
int V_527 = 0 ;
...
struct V_12 * V_13 ;
struct V_529 * V_530 ;
if ( ( type < V_531 || type > V_532 ) ||
V_266 >= V_520 )
return - V_533 ;
V_13 = V_2 -> V_521 [ V_266 ] ;
if ( ! V_13 ) {
switch ( type ) {
case V_531 :
V_116 = V_534 ;
...
V_13 = F_320 ( V_116 , V_540 ) ;
if ( ! V_13 )
return - V_318 ;
V_530 = ( void * ) V_13 -> V_541 ;
V_530 -> V_542 = V_527 ;
V_530 -> V_389 = type ;
V_2 -> V_521 [ V_266 ] = V_13 ;
}
while ( V_6 ) {
V_530 = ( void * ) V_13 -> V_541 ;
V_116 = F_321 ( V_543 , V_530 -> V_542 , V_6 ) ;
memcpy ( F_322 ( V_13 , V_116 ) , V_26 , V_116 ) ;
V_6 -= V_116 ;
V_26 += V_116 ;
V_530 -> V_542 -= V_116 ;
V_528 = V_6 ;
...
case V_532 :
if ( V_13 -> V_116 == V_118 ) {
struct V_112 * V_544 = V_112 ( V_13 ) ;
V_530 -> V_542 = V_544 -> V_121 ;
if ( F_323 ( V_13 ) < V_530 -> V_542 ) {
F_16 ( V_13 ) ;
V_2 -> V_521 [ V_266 ] = NULL ;
return - V_318 ;
}
}
break;
case V_531 :
if ( V_13 -> V_116 == V_535 ) {
struct V_545 * V_544 = V_545 ( V_13 ) ;
V_530 -> V_542 = F_33 ( V_544 -> V_546 ) ;
if ( F_323 ( V_13 ) < V_530 -> V_542 ) {
F_16 ( V_13 ) ;
V_2 -> V_521 [ V_266 ] = NULL ;
return - V_318 ;
...
case V_537 :
if ( V_13 -> V_116 == V_539 ) {
struct V_547 * V_544 = V_547 ( V_13 ) ;
V_530 -> V_542 = V_544 -> V_546 ;
if ( F_323 ( V_13 ) < V_530 -> V_542 ) {
F_16 ( V_13 ) ;
V_2 -> V_521 [ V_266 ] = NULL ;
return - V_318 ;
...
int F_324 ( struct V_1 * V_2 , int type , void * V_26 , int V_6 )
{
int V_548 = 0 ;
if ( type < V_531 || type > V_532 )
return - V_533 ;
while ( V_6 ) {
V_548 = F_319 ( V_2 , type , V_26 , V_6 , type - 1 ) ;
if ( V_548 < 0 )
return V_548 ;
V_26 += ( V_6 - V_548 ) ;
V_6 = V_548 ;
...
int F_325 ( struct V_1 * V_2 , void * V_26 , int V_6 )
{
int type ;
int V_548 = 0 ;
while ( V_6 ) {
struct V_12 * V_13 = V_2 -> V_521 [ V_549 ] ;
if ( ! V_13 ) {
struct { char type ; } * V_550 ;
V_550 = V_26 ;
type = V_550 -> type ;
V_26 ++ ;
V_6 -- ;
} else
type = F_316 ( V_13 ) -> V_389 ;
V_548 = F_319 ( V_2 , type , V_26 , V_6 ,
V_549 ) ;
if ( V_548 < 0 )
return V_548 ;
V_26 += ( V_6 - V_548 ) ;
...
int F_326 ( struct V_551 * V_541 )
{
F_92 ( L_93 , V_541 , V_541 -> V_102 ) ;
F_301 ( & V_552 ) ;
F_180 ( & V_541 -> V_64 , & V_553 ) ;
F_302 ( & V_552 ) ;
return 0 ;
}
int F_327 ( struct V_551 * V_541 )
{
F_92 ( L_93 , V_541 , V_541 -> V_102 ) ;
F_301 ( & V_552 ) ;
F_173 ( & V_541 -> V_64 ) ;
...
static void F_328 ( struct V_1 * V_2 , struct V_12 * V_13 )
{
int V_16 ;
F_92 ( L_94 , V_2 -> V_102 , F_316 ( V_13 ) -> V_389 , V_13 -> V_116 ) ;
F_317 ( V_13 ) ;
F_329 ( V_2 , V_13 ) ;
if ( F_330 ( & V_2 -> V_554 ) ) {
F_331 ( V_2 , V_13 ) ;
...
F_332 ( V_13 ) ;
V_16 = V_2 -> V_506 ( V_2 , V_13 ) ;
if ( V_16 < 0 ) {
F_97 ( L_95 , V_2 -> V_102 , V_16 ) ;
F_16 ( V_13 ) ;
}
}
...
int F_103 ( struct V_126 * V_127 , T_15 V_555 )
{
struct V_1 * V_2 = V_127 -> V_2 ;
struct V_12 * V_13 ;
unsigned long V_18 ;
F_92 ( L_96 , F_333 ( & V_127 -> V_337 ) ) ;
if ( V_127 -> V_16 ) {
F_198 ( & V_127 -> V_337 ) ;
return V_127 -> V_16 ;
}
if ( F_334 ( & V_127 -> V_337 ) )
return - V_115 ;
V_13 = F_335 ( & V_127 -> V_337 ) ;
F_316 ( V_13 ) -> V_127 . V_555 = V_555 ;
F_336 ( & V_2 -> V_337 . V_495 , V_18 ) ;
F_337 ( & V_127 -> V_337 , & V_2 -> V_337 ) ;
F_338 ( & V_2 -> V_337 . V_495 , V_18 ) ;
F_250 ( V_2 -> V_438 , & V_2 -> V_335 ) ;
return 0 ;
}
bool F_339 ( struct V_1 * V_2 )
{
return ( V_2 -> V_103 == V_104 ) ;
}
static struct V_12 * F_340 ( struct V_1 * V_2 , T_8 V_109 ,
T_9 V_121 , const void * V_122 )
{
int V_116 = V_556 + V_121 ;
struct V_436 * V_113 ;
struct V_12 * V_13 ;
V_13 = F_320 ( V_116 , V_540 ) ;
if ( ! V_13 )
return NULL ;
V_113 = (struct V_436 * ) F_322 ( V_13 , V_556 ) ;
V_113 -> V_109 = F_119 ( V_109 ) ;
V_113 -> V_121 = V_121 ;
if ( V_121 )
memcpy ( F_322 ( V_13 , V_121 ) , V_122 , V_121 ) ;
F_92 ( L_97 , V_13 -> V_116 ) ;
F_316 ( V_13 ) -> V_389 = V_557 ;
return V_13 ;
}
int F_341 ( struct V_1 * V_2 , T_13 V_109 , T_10 V_121 ,
const void * V_122 )
{
struct V_12 * V_13 ;
F_92 ( L_98 , V_2 -> V_102 , V_109 , V_121 ) ;
V_13 = F_340 ( V_2 , V_109 , V_121 , V_122 ) ;
if ( ! V_13 ) {
F_97 ( L_99 , V_2 -> V_102 ) ;
return - V_318 ;
}
F_316 ( V_13 ) -> V_127 . V_558 = true ;
F_318 ( & V_2 -> V_337 , V_13 ) ;
F_250 ( V_2 -> V_438 , & V_2 -> V_335 ) ;
return 0 ;
}
...
if ( F_334 ( & V_127 -> V_337 ) )
F_316 ( V_13 ) -> V_127 . V_558 = true ;
F_316 ( V_13 ) -> V_127 . V_3 = V_3 ;
F_318 ( & V_127 -> V_337 , V_13 ) ;
}
...
void * F_342 ( struct V_1 * V_2 , T_13 V_109 )
{
struct V_436 * V_113 ;
if ( ! V_2 -> V_340 )
return NULL ;
...
return NULL ;
F_92 ( L_101 , V_2 -> V_102 , V_109 ) ;
return V_2 -> V_340 -> V_26 + V_556 ;
}
static void F_343 ( struct V_12 * V_13 , T_13 V_559 , T_13 V_18 )
{
struct V_545 * V_113 ;
int V_116 = V_13 -> V_116 ;
F_344 ( V_13 , V_535 ) ;
F_345 ( V_13 ) ;
V_113 = (struct V_545 * ) F_346 ( V_13 ) ;
V_113 -> V_559 = F_119 ( F_347 ( V_559 , V_18 ) ) ;
V_113 -> V_546 = F_119 ( V_116 ) ;
}
static void F_348 ( struct V_560 * V_561 , struct V_562 * V_563 ,
struct V_12 * V_13 , T_13 V_18 )
{
struct V_414 * V_349 = V_561 -> V_349 ;
struct V_1 * V_2 = V_349 -> V_2 ;
struct V_12 * V_64 ;
V_13 -> V_116 = F_349 ( V_13 ) ;
V_13 -> V_564 = 0 ;
F_316 ( V_13 ) -> V_389 = V_531 ;
switch ( V_2 -> V_147 ) {
case V_148 :
F_343 ( V_13 , V_349 -> V_559 , V_18 ) ;
break;
case V_149 :
F_343 ( V_13 , V_561 -> V_559 , V_18 ) ;
break;
default:
F_97 ( L_102 , V_2 -> V_102 , V_2 -> V_147 ) ;
return;
}
V_64 = F_350 ( V_13 ) -> V_565 ;
if ( ! V_64 ) {
F_92 ( L_103 , V_2 -> V_102 , V_13 , V_13 -> V_116 ) ;
F_318 ( V_563 , V_13 ) ;
} else {
F_92 ( L_104 , V_2 -> V_102 , V_13 , V_13 -> V_116 ) ;
F_350 ( V_13 ) -> V_565 = NULL ;
F_351 ( & V_563 -> V_495 ) ;
F_352 ( V_563 , V_13 ) ;
V_18 &= ~ V_566 ;
V_18 |= V_567 ;
do {
V_13 = V_64 ; V_64 = V_64 -> V_568 ;
F_316 ( V_13 ) -> V_389 = V_531 ;
F_343 ( V_13 , V_349 -> V_559 , V_18 ) ;
F_92 ( L_104 , V_2 -> V_102 , V_13 , V_13 -> V_116 ) ;
F_352 ( V_563 , V_13 ) ;
...
void F_354 ( struct V_560 * V_561 , struct V_12 * V_13 , T_13 V_18 )
{
struct V_1 * V_2 = V_561 -> V_349 -> V_2 ;
F_92 ( L_105 , V_2 -> V_102 , V_561 , V_18 ) ;
F_348 ( V_561 , & V_561 -> V_569 , V_13 , V_18 ) ;
F_250 ( V_2 -> V_438 , & V_2 -> V_334 ) ;
}
void F_355 ( struct V_414 * V_349 , struct V_12 * V_13 )
{
struct V_1 * V_2 = V_349 -> V_2 ;
struct V_547 V_113 ;
F_92 ( L_106 , V_2 -> V_102 , V_13 -> V_116 ) ;
V_113 . V_559 = F_119 ( V_349 -> V_559 ) ;
V_113 . V_546 = V_13 -> V_116 ;
F_344 ( V_13 , V_539 ) ;
F_345 ( V_13 ) ;
memcpy ( F_346 ( V_13 ) , & V_113 , V_539 ) ;
F_316 ( V_13 ) -> V_389 = V_537 ;
F_318 ( & V_349 -> V_569 , V_13 ) ;
F_250 ( V_2 -> V_438 , & V_2 -> V_334 ) ;
}
static struct V_414 * F_356 ( struct V_1 * V_2 , T_12 type ,
int * V_570 )
{
struct V_571 * V_544 = & V_2 -> V_502 ;
struct V_414 * V_349 = NULL , * V_572 ;
unsigned int V_295 = 0 , F_7 = ~ 0 ;
F_357 () ;
F_358 (c, &h->list, list) {
if ( V_572 -> type != type || F_334 ( & V_572 -> V_569 ) )
continue;
if ( V_572 -> V_271 != V_453 && V_572 -> V_271 != V_573 )
continue;
V_295 ++ ;
if ( V_572 -> V_437 < F_7 ) {
F_7 = V_572 -> V_437 ;
...
break;
case V_451 :
V_574 = V_2 -> V_405 ? V_2 -> V_367 : V_2 -> V_365 ;
break;
default:
V_574 = 0 ;
F_97 ( L_107 ) ;
...
* V_570 = 0 ;
F_92 ( L_108 , V_349 , * V_570 ) ;
return V_349 ;
}
static void F_361 ( struct V_1 * V_2 , T_12 type )
{
struct V_571 * V_544 = & V_2 -> V_502 ;
struct V_414 * V_572 ;
F_97 ( L_109 , V_2 -> V_102 ) ;
F_357 () ;
F_358 (c, &h->list, list) {
if ( V_572 -> type == type && V_572 -> V_437 ) {
F_97 ( L_110 ,
V_2 -> V_102 , & V_572 -> V_579 ) ;
F_362 ( V_572 , V_580 ) ;
}
}
F_360 () ;
}
static struct V_560 * F_363 ( struct V_1 * V_2 , T_12 type ,
int * V_570 )
{
struct V_571 * V_544 = & V_2 -> V_502 ;
struct V_560 * V_561 = NULL ;
unsigned int V_295 = 0 , F_7 = ~ 0 , V_581 = 0 ;
struct V_414 * V_349 ;
int V_574 , V_575 , V_582 = 0 ;
F_92 ( L_19 , V_2 -> V_102 ) ;
F_357 () ;
F_358 (conn, &h->list, list) {
struct V_560 * V_412 ;
if ( V_349 -> type != type )
continue;
if ( V_349 -> V_271 != V_453 && V_349 -> V_271 != V_573 )
continue;
V_582 ++ ;
F_358 (tmp, &conn->chan_list, list) {
struct V_12 * V_13 ;
if ( F_334 ( & V_412 -> V_569 ) )
continue;
V_13 = F_364 ( & V_412 -> V_569 ) ;
if ( V_13 -> V_583 < V_581 )
continue;
if ( V_13 -> V_583 > V_581 ) {
V_295 = 0 ;
...
if ( F_359 ( V_2 , type ) == V_582 )
break;
}
F_360 () ;
if ( ! V_561 )
return NULL ;
switch ( V_561 -> V_349 -> type ) {
case V_576 :
V_574 = V_2 -> V_365 ;
break;
case V_584 :
...
V_575 = V_574 / V_295 ;
* V_570 = V_575 ? V_575 : 1 ;
F_92 ( L_111 , V_561 , * V_570 ) ;
return V_561 ;
}
static void F_365 ( struct V_1 * V_2 , T_12 type )
{
struct V_571 * V_544 = & V_2 -> V_502 ;
struct V_414 * V_349 ;
int V_295 = 0 ;
...
continue;
V_295 ++ ;
F_358 (chan, &conn->chan_list, list) {
struct V_12 * V_13 ;
if ( V_561 -> V_437 ) {
V_561 -> V_437 = 0 ;
continue;
}
if ( F_334 ( & V_561 -> V_569 ) )
continue;
V_13 = F_364 ( & V_561 -> V_569 ) ;
if ( V_13 -> V_583 >= V_586 - 1 )
continue;
V_13 -> V_583 = V_586 - 1 ;
F_92 ( L_112 , V_561 , V_13 ,
V_13 -> V_583 ) ;
}
if ( F_359 ( V_2 , type ) == V_295 )
break;
...
static inline int F_366 ( struct V_1 * V_2 , struct V_12 * V_13 )
{
return F_367 ( V_13 -> V_116 - V_535 , V_2 -> V_587 ) ;
}
static void F_368 ( struct V_1 * V_2 , unsigned int V_574 )
{
if ( ! F_4 ( V_314 , & V_2 -> V_72 ) ) {
if ( ! V_574 && F_369 ( V_294 , V_2 -> V_588 +
V_589 ) )
F_361 ( V_2 , V_576 ) ;
}
}
...
{
unsigned int V_574 = V_2 -> V_365 ;
struct V_560 * V_561 ;
struct V_12 * V_13 ;
int V_570 ;
F_368 ( V_2 , V_574 ) ;
while ( V_2 -> V_365 &&
( V_561 = F_363 ( V_2 , V_576 , & V_570 ) ) ) {
T_9 V_583 = ( F_364 ( & V_561 -> V_569 ) ) -> V_583 ;
while ( V_570 -- && ( V_13 = F_364 ( & V_561 -> V_569 ) ) ) {
F_92 ( L_113 , V_561 , V_13 ,
V_13 -> V_116 , V_13 -> V_583 ) ;
if ( V_13 -> V_583 < V_583 )
break;
V_13 = F_371 ( & V_561 -> V_569 ) ;
F_372 ( V_561 -> V_349 ,
F_316 ( V_13 ) -> V_590 ) ;
F_328 ( V_2 , V_13 ) ;
V_2 -> V_588 = V_294 ;
...
type = V_576 ;
while ( V_2 -> V_585 > 0 &&
( V_561 = F_363 ( V_2 , type , & V_570 ) ) ) {
T_9 V_583 = ( F_364 ( & V_561 -> V_569 ) ) -> V_583 ;
while ( V_570 > 0 && ( V_13 = F_364 ( & V_561 -> V_569 ) ) ) {
int V_591 ;
F_92 ( L_113 , V_561 , V_13 ,
V_13 -> V_116 , V_13 -> V_583 ) ;
if ( V_13 -> V_583 < V_583 )
...
{
F_92 ( L_19 , V_2 -> V_102 ) ;
if ( ! F_359 ( V_2 , V_576 ) && V_2 -> V_147 == V_148 )
return;
if ( ! F_359 ( V_2 , V_584 ) && V_2 -> V_147 == V_149 )
return;
switch ( V_2 -> V_134 ) {
case V_135 :
F_370 ( V_2 ) ;
...
if ( ! F_359 ( V_2 , V_577 ) )
return;
while ( V_2 -> V_366 && ( V_349 = F_356 ( V_2 , V_577 , & V_570 ) ) ) {
while ( V_570 -- && ( V_13 = F_371 ( & V_349 -> V_569 ) ) ) {
F_92 ( L_114 , V_13 , V_13 -> V_116 ) ;
F_328 ( V_2 , V_13 ) ;
V_349 -> V_437 ++ ;
if ( V_349 -> V_437 == ~ 0 )
V_349 -> V_437 = 0 ;
...
if ( ! F_359 ( V_2 , V_578 ) )
return;
while ( V_2 -> V_366 && ( V_349 = F_356 ( V_2 , V_578 ,
& V_570 ) ) ) {
while ( V_570 -- && ( V_13 = F_371 ( & V_349 -> V_569 ) ) ) {
F_92 ( L_114 , V_13 , V_13 -> V_116 ) ;
F_328 ( V_2 , V_13 ) ;
...
struct V_560 * V_561 ;
struct V_12 * V_13 ;
int V_570 , V_574 , V_412 ;
F_92 ( L_19 , V_2 -> V_102 ) ;
if ( ! F_359 ( V_2 , V_451 ) )
return;
if ( ! F_4 ( V_314 , & V_2 -> V_72 ) ) {
if ( ! V_2 -> V_367 && V_2 -> V_406 &&
F_369 ( V_294 , V_2 -> V_592 + V_593 * 45 ) )
F_361 ( V_2 , V_451 ) ;
}
V_574 = V_2 -> V_406 ? V_2 -> V_367 : V_2 -> V_365 ;
V_412 = V_574 ;
while ( V_574 && ( V_561 = F_363 ( V_2 , V_451 , & V_570 ) ) ) {
T_9 V_583 = ( F_364 ( & V_561 -> V_569 ) ) -> V_583 ;
while ( V_570 -- && ( V_13 = F_364 ( & V_561 -> V_569 ) ) ) {
F_92 ( L_113 , V_561 , V_13 ,
V_13 -> V_116 , V_13 -> V_583 ) ;
...
static void V_505 ( struct V_408 * V_409 )
{
struct V_1 * V_2 = F_224 ( V_409 , struct V_1 , V_334 ) ;
struct V_12 * V_13 ;
F_92 ( L_115 , V_2 -> V_102 , V_2 -> V_365 ,
V_2 -> V_366 , V_2 -> V_367 ) ;
if ( ! F_4 ( V_313 , & V_2 -> V_72 ) ) {
F_374 ( V_2 ) ;
F_375 ( V_2 ) ;
...
while ( ( V_13 = F_371 ( & V_2 -> V_361 ) ) )
F_328 ( V_2 , V_13 ) ;
}
static void F_378 ( struct V_1 * V_2 , struct V_12 * V_13 )
{
struct V_545 * V_113 = ( void * ) V_13 -> V_26 ;
struct V_414 * V_349 ;
T_13 V_559 , V_18 ;
F_98 ( V_13 , V_535 ) ;
V_559 = F_33 ( V_113 -> V_559 ) ;
V_18 = F_379 ( V_559 ) ;
V_559 = F_380 ( V_559 ) ;
F_92 ( L_116 , V_2 -> V_102 , V_13 -> V_116 ,
V_559 , V_18 ) ;
V_2 -> V_368 . V_594 ++ ;
F_19 ( V_2 ) ;
V_349 = F_381 ( V_2 , V_559 ) ;
F_22 ( V_2 ) ;
if ( V_349 ) {
F_372 ( V_349 , V_595 ) ;
F_382 ( V_349 , V_13 , V_18 ) ;
return;
} else {
F_97 ( L_117 ,
V_2 -> V_102 , V_559 ) ;
...
static void F_383 ( struct V_1 * V_2 , struct V_12 * V_13 )
{
struct V_547 * V_113 = ( void * ) V_13 -> V_26 ;
struct V_414 * V_349 ;
T_13 V_559 ;
F_98 ( V_13 , V_539 ) ;
V_559 = F_33 ( V_113 -> V_559 ) ;
F_92 ( L_118 , V_2 -> V_102 , V_13 -> V_116 , V_559 ) ;
V_2 -> V_368 . V_596 ++ ;
F_19 ( V_2 ) ;
V_349 = F_381 ( V_2 , V_559 ) ;
F_22 ( V_2 ) ;
...
{
struct V_12 * V_13 ;
V_13 = F_364 ( & V_2 -> V_337 ) ;
if ( ! V_13 )
return true ;
return F_316 ( V_13 ) -> V_127 . V_558 ;
}
...
if ( ! V_2 -> V_340 )
return;
V_437 = ( void * ) V_2 -> V_340 -> V_26 ;
V_109 = F_33 ( V_437 -> V_109 ) ;
if ( V_109 == V_25 )
return;
V_13 = F_387 ( V_2 -> V_340 , V_289 ) ;
if ( ! V_13 )
return;
F_388 ( & V_2 -> V_337 , V_13 ) ;
F_250 ( V_2 -> V_438 , & V_2 -> V_335 ) ;
}
void F_389 ( struct V_1 * V_2 , T_8 V_109 , T_5 V_466 )
{
T_15 V_597 = NULL ;
struct V_12 * V_13 ;
unsigned long V_18 ;
F_92 ( L_120 , V_109 , V_466 ) ;
if ( ! F_342 ( V_2 , V_109 ) ) {
...
return;
if ( V_2 -> V_340 ) {
V_597 = F_316 ( V_2 -> V_340 ) -> V_127 . V_555 ;
if ( V_597 ) {
F_316 ( V_2 -> V_340 ) -> V_127 . V_555 = NULL ;
goto V_598;
}
}
F_336 ( & V_2 -> V_337 . V_495 , V_18 ) ;
while ( ( V_13 = F_390 ( & V_2 -> V_337 ) ) ) {
if ( F_316 ( V_13 ) -> V_127 . V_558 ) {
F_391 ( & V_2 -> V_337 , V_13 ) ;
break;
}
V_597 = F_316 ( V_13 ) -> V_127 . V_555 ;
F_16 ( V_13 ) ;
}
F_338 ( & V_2 -> V_337 . V_495 , V_18 ) ;
V_598:
...
{
struct V_1 * V_2 = F_224 ( V_409 , struct V_1 , V_336 ) ;
struct V_12 * V_13 ;
F_92 ( L_19 , V_2 -> V_102 ) ;
while ( ( V_13 = F_371 ( & V_2 -> V_338 ) ) ) {
F_329 ( V_2 , V_13 ) ;
if ( F_330 ( & V_2 -> V_554 ) ) {
F_331 ( V_2 , V_13 ) ;
}
...
{
struct V_1 * V_2 = F_224 ( V_409 , struct V_1 , V_335 ) ;
struct V_12 * V_13 ;
F_92 ( L_124 , V_2 -> V_102 ,
F_330 ( & V_2 -> V_326 ) , F_333 ( & V_2 -> V_337 ) ) ;
if ( F_330 ( & V_2 -> V_326 ) ) {
V_13 = F_371 ( & V_2 -> V_337 ) ;
if ( ! V_13 )
return;
F_16 ( V_2 -> V_340 ) ;
V_2 -> V_340 = F_387 ( V_13 , V_289 ) ;
if ( V_2 -> V_340 ) {
F_393 ( & V_2 -> V_326 ) ;
F_328 ( V_2 , V_13 ) ;
...
void F_272 ( struct V_126 * V_127 )
{
struct V_599 V_183 ;
memset ( & V_183 , 0 , sizeof( V_183 ) ) ;
V_183 . V_15 = V_600 ;
F_114 ( V_127 , V_601 , sizeof( V_183 ) , & V_183 ) ;
}
static void F_395 ( struct V_126 * V_127 ,
struct V_99 * V_450 )
{
struct V_602 V_183 ;
V_183 . V_41 = V_450 -> V_80 ;
F_148 ( & V_183 . V_40 , & V_450 -> V_79 ) ;
F_114 ( V_127 , V_603 , sizeof( V_183 ) , & V_183 ) ;
}
static T_5 F_396 ( struct V_126 * V_127 )
{
struct V_1 * V_2 = V_127 -> V_2 ;
struct V_99 * V_450 ;
struct V_38 * V_39 ;
...
if ( F_255 ( & V_2 -> V_501 ,
& V_450 -> V_79 , V_450 -> V_80 ) )
continue;
if ( V_604 >= V_2 -> V_246 ) {
return 0x00 ;
}
if ( F_242 ( V_2 , & V_450 -> V_79 ,
V_450 -> V_80 ) ) {
return 0x00 ;
}
V_604 ++ ;
...
T_5 V_474 ;
T_5 V_610 ;
if ( F_275 ( V_127 , false , & V_474 ) )
return;
V_610 = F_396 ( V_127 ) ;
memset ( & V_608 , 0 , sizeof( V_608 ) ) ;
V_608 . type = V_611 ;
V_608 . V_612 = F_119 ( V_2 -> V_489 ) ;
V_608 . V_613 = F_119 ( V_2 -> V_490 ) ;
V_608 . V_614 = V_474 ;
V_608 . V_610 = V_610 ;
F_114 ( V_127 , V_615 , sizeof( V_608 ) ,
& V_608 ) ;
memset ( & V_609 , 0 , sizeof( V_609 ) ) ;
V_609 . V_15 = V_616 ;
V_609 . V_617 = V_618 ;
F_114 ( V_127 , V_601 , sizeof( V_609 ) ,
& V_609 ) ;
}
static void F_398 ( struct V_1 * V_2 , T_5 V_466 )
{
if ( V_466 )
F_92 ( L_125
L_126 , V_466 ) ;
...
if ( F_309 ( & V_2 -> V_465 ) &&
F_309 ( & V_2 -> V_462 ) ) {
if ( ! F_4 ( V_619 , & V_2 -> V_72 ) )
return;
F_272 ( & V_127 ) ;
F_92 ( L_127 , V_2 -> V_102 ) ;
} else {
V_349 = F_274 ( V_2 , V_451 , V_471 ) ;
if ( V_349 )
return;
if ( F_4 ( V_619 , & V_2 -> V_72 ) )
F_272 ( & V_127 ) ;
F_397 ( & V_127 ) ;
F_92 ( L_128 , V_2 -> V_102 ) ;
}
V_16 = F_103 ( & V_127 , F_398 ) ;
if ( V_16 )
F_97 ( L_129 , V_16 ) ;
}
