...
void F_75 ( struct V_8 * V_33 )
{
if ( V_33 -> V_15 . V_82 )
F_76 ( V_33 ) ;
}
int F_77 ( struct V_8 * V_33 )
{
F_50 ( V_33 ) ;
return F_78 ( V_33 ) ;
}
...
int F_85 ( struct V_8 * V_33 , bool V_83 )
{
struct V_7 * V_27 = F_44 ( V_33 ) ;
if ( ! V_27 )
return - V_22 ;
...
void F_86 ( struct V_8 * V_33 , bool V_87 )
{
struct V_7 * V_27 = F_44 ( V_33 ) ;
if ( V_27 && V_33 -> V_84 == & V_86 ) {
V_33 -> V_84 = NULL ;
F_34 ( V_27 ) ;
if ( V_87 ) {
F_87 ( V_33 ) ;
