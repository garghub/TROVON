...
int F_48 ( struct V_8 * V_9 , int V_29 , int V_40 ,
int V_5 )
{
const struct V_41 * V_42 ;
int V_43 , V_44 ;
T_1 V_45 , V_27 ;
if ( V_40 < 0 || V_40 >= F_49 ( V_46 ) )
return - V_36 ;
V_42 = & V_46 [ V_40 ] ;
...
int F_50 ( struct V_8 * V_9 , int V_29 , int V_40 )
{
const struct V_41 * V_42 ;
int V_43 , V_44 ;
T_1 V_45 ;
...
static void F_51 ( unsigned long V_50 )
{
...
int F_53 ( struct V_8 * V_9 , int V_52 )
{
F_54 ( & V_9 -> V_53 ) ;
V_9 -> V_52 = V_52 * V_56 ;
if ( V_9 -> V_52 ) {
...
struct V_8 * F_61 ( struct V_64 * V_10 )
{
struct V_8 * V_9 ;
V_9 = F_62 ( sizeof( * V_9 ) , V_65 ) ;
if ( ! V_9 )
return NULL ;
V_9 -> V_10 = * V_10 ;
...
void F_65 ( struct V_8 * V_9 , T_1 * V_62 )
{
int V_7 ;
