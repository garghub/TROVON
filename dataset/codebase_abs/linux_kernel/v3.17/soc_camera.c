...
struct V_20 * V_21 = F_13 ( V_19 ) ;
struct V_46 * V_47 = F_19 ( V_19 -> V_48 ) ;
unsigned int V_28 , V_97 = 0 , V_98 = 0 ;
int V_7 ;
enum V_99 V_100 ;
while ( ! F_14 ( V_21 , V_76 , V_101 , V_98 , & V_100 ) )
V_98 ++ ;
if ( ! V_47 -> V_62 -> V_102 )
V_97 = V_98 ;
else
...
return - V_103 ;
V_19 -> V_30 =
F_50 ( V_97 * sizeof( struct V_26 ) ) ;
if ( ! V_19 -> V_30 )
return - V_104 ;
F_20 ( V_19 -> V_53 , L_8 , V_97 ) ;
V_97 = 0 ;
for ( V_28 = 0 ; V_28 < V_98 ; V_28 ++ )
if ( ! V_47 -> V_62 -> V_102 ) {
...
V_19 -> V_30 [ V_97 ] . V_31 =
F_51 ( V_100 ) ;
if ( V_19 -> V_30 [ V_97 ] . V_31 )
V_19 -> V_30 [ V_97 ++ ] . V_100 = V_100 ;
} else {
...
return F_76 ( & V_19 -> V_90 , V_140 , V_141 , V_142 ,
V_66 -> V_92 & V_93 ) ;
F_4 ( V_19 -> V_53 , L_17 ) ;
return - V_64 ;
}
...
return - V_122 ;
if ( V_47 -> V_62 -> V_87 )
V_17 = F_78 ( & V_19 -> V_88 , V_146 ) ;
else
V_17 = F_79 ( & V_19 -> V_90 , V_146 ) ;
F_57 ( & V_47 -> V_125 ) ;
F_20 ( V_19 -> V_53 , L_19 ,
...
return V_151 ;
F_56 ( & V_47 -> V_125 ) ;
if ( V_47 -> V_62 -> V_87 && F_81 ( & V_19 -> V_88 . V_152 ) )
F_4 ( V_19 -> V_53 , L_20 ) ;
else
...
V_47 = F_19 ( V_19 -> V_48 ) ;
V_214 = F_125 ( V_211 -> V_219 ) ;
if ( ! V_214 ) {
F_4 ( V_19 -> V_53 , L_28 ,
V_211 -> V_219 ) ;
return - V_25 ;
}
V_4 = F_126 ( sizeof( * V_4 ) , V_220 ) ;
if ( ! V_4 ) {
V_7 = - V_104 ;
goto V_221;
}
...
V_19 -> V_6 = F_127 ( & V_225 , V_216 , L_30 , V_19 ) ;
if ( F_128 ( V_19 -> V_6 ) ) {
V_7 = F_129 ( V_19 -> V_6 ) ;
goto V_226;
}
V_215 = F_130 ( & V_47 -> V_193 , V_214 ,
V_211 -> V_222 , NULL ) ;
if ( ! V_215 ) {
V_7 = - V_25 ;
goto V_227;
...
static void F_143 ( struct V_230 * V_231 ,
struct V_20 * V_21 ,
struct V_232 * V_233 )
{
struct V_194 * V_195 = F_141 ( V_231 ,
...
static int F_144 ( struct V_230 * V_231 )
{
struct V_194 * V_195 = F_141 ( V_231 ,
struct V_194 , V_231 ) ;
struct V_18 * V_19 = F_118 ( V_195 -> V_53 ) ;
...
V_237 = F_141 ( V_233 [ V_28 ] , struct V_236 , V_233 ) ;
...
V_195 = F_146 ( V_47 -> V_193 . V_2 , sizeof( * V_195 ) , V_220 ) ;
if ( ! V_195 )
return - V_104 ;
V_129 . V_212 . V_222 = F_147 ( - V_243 ) ;
...
V_195 -> V_231 . V_248 = F_140 ;
V_195 -> V_231 . V_249 = F_143 ;
V_195 -> V_231 . V_250 = F_144 ;
V_19 -> V_195 = V_195 ;
V_19 -> V_48 = V_47 -> V_193 . V_2 ;
snprintf ( V_216 , sizeof( V_216 ) , L_29 ,
...
V_7 = F_148 ( & V_47 -> V_193 , & V_195 -> V_231 ) ;
if ( ! V_7 )
return 0 ;
F_132 ( V_19 -> V_6 ) ;
V_226:
...
F_145 ( V_47 , V_233 , V_47 -> V_256 [ V_255 ] ) ;
V_233 += V_47 -> V_256 [ V_255 ] ;
}
}
static int F_152 ( struct V_46 * V_47 ,
struct V_257 * V_258 ,
struct V_257 * V_259 )
{
struct V_18 * V_19 ;
...
char V_216 [ V_217 ] ;
int V_7 ;
V_261 = F_146 ( V_47 -> V_193 . V_2 , sizeof( struct V_260 ) ,
V_220 ) ;
if ( ! V_261 )
return - V_104 ;
...
static inline void F_155 ( struct V_46 * V_47 ) { }
...
int V_7 ;
F_160 ( V_19 -> V_53 , L_36 , F_161 ( V_19 -> V_53 ) ) ;
V_7 = F_162 ( & V_19 -> V_139 , 16 ) ;
if ( V_7 < 0 )
return V_7 ;
V_7 = F_163 ( V_19 ) ;
if ( V_7 < 0 )
...
goto V_117;
if ( V_211 -> V_272 )
V_7 = F_164 ( V_211 -> V_272 ) ;
V_7 = V_211 -> V_270 ( V_19 ) ;
if ( V_7 < 0 )
goto V_273;
V_228 = F_65 ( V_19 ) ;
if ( ! V_228 || ! V_228 -> V_162 || ! F_165 ( V_228 ) ||
! F_64 ( V_228 -> V_162 -> V_123 ) ) {
V_211 -> V_271 ( V_19 ) ;
V_7 = - V_25 ;
goto V_274;
}
...
static int F_172 ( struct V_18 * V_19 , struct V_169 * V_75 )
{
struct V_20 * V_21 = F_13 ( V_19 ) ;
return F_14 ( V_21 , V_76 , V_278 , V_75 ) ;
}
static int F_173 ( struct V_18 * V_19 , const struct V_169 * V_75 )
{
struct V_20 * V_21 = F_13 ( V_19 ) ;
...
return - V_64 ;
if ( ! V_47 -> V_62 -> V_177 )
V_47 -> V_62 -> V_177 = F_173 ;
if ( ! V_47 -> V_62 -> V_170 )
V_47 -> V_62 -> V_170 = F_172 ;
if ( ! V_47 -> V_62 -> V_168 )
V_47 -> V_62 -> V_168 = F_171 ;
if ( ! V_47 -> V_62 -> V_190 )
V_47 -> V_62 -> V_190 = F_175 ;
if ( ! V_47 -> V_62 -> V_189 )
V_47 -> V_62 -> V_189 = F_174 ;
if ( ! V_47 -> V_62 -> V_82 )
V_47 -> V_62 -> V_82 = F_176 ;
F_56 ( & V_121 ) ;
F_106 (ix, &hosts, list) {
...
V_7 = F_178 ( V_47 -> V_193 . V_2 , & V_47 -> V_193 ) ;
if ( V_7 < 0 )
goto V_287;
F_179 ( & V_47 -> V_288 , & V_289 ) ;
F_57 ( & V_121 ) ;
F_180 ( & V_47 -> V_125 ) ;
F_180 ( & V_47 -> V_114 ) ;
...
F_184 ( V_19 -> V_53 ) ;
F_185 ( & V_19 -> V_195 -> V_288 , & V_291 ) ;
}
F_57 ( & V_121 ) ;
F_106 (sasc, &notifiers, list) {
F_186 ( & V_195 -> V_231 ) ;
F_187 ( & V_195 -> V_53 -> V_2 ) ;
}
F_56 ( & V_121 ) ;
F_188 (icd, tmp, &devices, list)
if ( V_19 -> V_191 == V_47 -> V_192 )
F_168 ( V_19 ) ;
F_57 ( & V_121 ) ;
F_189 ( & V_47 -> V_193 ) ;
...
if ( ! V_19 -> V_48 )
return - V_25 ;
F_193 ( V_19 -> V_120 , V_19 ) ;
if ( V_19 -> V_120 -> V_203 == 0 ) {
F_194 ( V_19 -> V_120 , V_304 ) ;
F_194 ( V_19 -> V_120 , V_305 ) ;
F_194 ( V_19 -> V_120 , V_306 ) ;
}
V_7 = F_195 ( V_19 -> V_120 , V_307 , - 1 ) ;
if ( V_7 < 0 ) {
...
static int F_196 ( struct V_196 * V_53 )
{
...
if ( ! V_129 )
return - V_64 ;
V_19 = F_146 ( & V_53 -> V_2 , sizeof( * V_19 ) , V_220 ) ;
if ( ! V_19 )
return - V_104 ;
