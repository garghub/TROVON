...
static void F_58 ( const struct V_10 * V_11 , const char * V_154 )
{
struct V_21 * V_22 = NULL ;
...
static void F_59 ( const struct V_10 * V_11 , struct V_162 * V_163 )
{
struct V_147 * V_148 ;
F_56 (t, &pn->pktgen_threads, th_list) {
struct V_21 * V_22 ;
...
continue;
F_60 ( V_22 -> V_164 ) ;
V_22 -> V_164 = F_61 ( V_163 -> V_124 , 0600 ,
V_11 -> V_165 ,
& V_166 ,
V_22 ) ;
if ( ! V_22 -> V_164 )
...
{
struct V_162 * V_163 = F_63 ( V_170 ) ;
struct V_10 * V_11 = F_4 ( F_64 ( V_163 ) , V_15 ) ;
if ( V_11 -> V_171 )
return V_172 ;
switch ( V_169 ) {
case V_173 :
...
break;
case V_174 :
F_58 ( V_11 , V_163 -> V_124 ) ;
break;
}
return V_172 ;
}
static struct V_162 * F_65 ( const struct V_10 * V_11 ,
struct V_21 * V_22 ,
const char * V_154 )
{
char V_175 [ V_176 + 5 ] ;
...
static void F_75 ( struct V_21 * V_22 , T_5 V_204 )
{
T_5 V_205 , V_206 ;
T_8 V_207 ;
struct V_208 V_148 ;
F_76 ( & V_148 . V_209 , V_210 , V_211 ) ;
F_77 ( & V_148 . V_209 , V_204 ) ;
V_207 = F_78 ( F_79 ( & V_148 . V_209 ) ) ;
if ( V_207 <= 0 ) {
V_22 -> V_212 = F_80 ( V_204 , V_22 -> V_29 ) ;
return;
}
V_205 = F_19 () ;
if ( V_207 < 100000 ) {
...
do {
F_83 ( V_213 ) ;
F_84 ( & V_148 . V_209 , V_211 ) ;
if ( ! F_85 ( & V_148 . V_209 ) )
V_148 . V_214 = NULL ;
if ( F_86 ( V_148 . V_214 ) )
F_87 () ;
F_88 ( & V_148 . V_209 ) ;
} while ( V_148 . V_214 && V_22 -> V_88 && ! F_89 ( V_12 ) );
F_90 ( V_215 ) ;
V_206 = F_19 () ;
}
V_22 -> V_90 += F_78 ( F_91 ( V_206 , V_205 ) ) ;
V_22 -> V_212 = F_80 ( V_204 , V_22 -> V_29 ) ;
}
...
V_22 -> V_190 += F_93 ( V_22 ) ;
V_22 -> V_190 += F_94 ( V_22 ) ;
}
static inline int F_95 ( const struct V_21 * V_22 , int V_217 )
{
...
static void F_98 ( struct V_21 * V_22 , int V_217 )
{
struct V_221 * V_222 = V_22 -> V_218 [ V_217 ] . V_222 ;
struct V_10 * V_11 = F_4 ( F_64 ( V_22 -> V_50 ) , V_15 ) ;
if ( ! V_222 ) {
if ( V_22 -> V_82 ) {
V_222 = F_99 ( V_11 -> V_177 , F_29 ( V_22 -> V_82 ) , V_223 ) ;
} else {
V_222 = F_100 ( V_11 -> V_177 , V_224 ,
( V_225 * ) & V_22 -> V_101 ,
( V_225 * ) & V_22 -> V_100 ,
V_223 ,
V_22 -> V_226 ,
...
static int F_110 ( struct V_237 * V_238 , struct V_21 * V_22 )
{
struct V_221 * V_222 = V_22 -> V_218 [ V_22 -> V_220 ] . V_222 ;
int V_178 = 0 ;
struct V_177 * V_177 = F_64 ( V_22 -> V_50 ) ;
if ( ! V_222 )
return 0 ;
...
T_11 * V_254 ;
struct V_199 * V_255 ;
V_253 = V_222 -> V_228 . V_229 - F_119 ( V_238 ) ;
if ( V_253 > 0 ) {
V_149 = F_120 ( V_238 , V_253 , 0 , V_256 ) ;
if ( V_149 < 0 ) {
F_48 ( L_240 ,
V_149 ) ;
goto V_178;
...
F_121 ( V_238 , V_257 ) ;
V_149 = F_110 ( V_238 , V_22 ) ;
if ( V_149 ) {
F_48 ( L_241 , V_149 ) ;
goto V_178;
}
V_254 = ( T_11 * ) F_122 ( V_238 , V_257 ) ;
memcpy ( V_254 , V_22 -> V_143 , 12 ) ;
* ( V_258 * ) & V_254 [ 12 ] = V_252 ;
V_255 = F_123 ( V_238 ) ;
V_255 -> V_259 = F_124 ( V_238 -> V_116 - V_257 ) ;
F_125 ( V_255 ) ;
}
}
return 1 ;
...
static void F_127 ( V_234 * V_260 , struct V_21 * V_22 )
{
unsigned int V_60 ;
for ( V_60 = 0 ; V_60 < V_22 -> V_59 ; V_60 ++ )
...
static inline T_10 F_128 ( unsigned int V_261 , unsigned int V_262 ,
unsigned int V_263 )
{
return F_124 ( V_261 | ( V_262 << 12 ) | ( V_263 << 13 ) ) ;
}
static void F_129 ( struct V_21 * V_22 , struct V_237 * V_238 ,
int V_264 )
{
struct V_265 V_266 ;
struct V_189 * V_267 ;
V_267 = (struct V_189 * ) F_130 ( V_238 , sizeof( * V_267 ) ) ;
V_264 -= sizeof( * V_267 ) ;
if ( V_22 -> V_28 <= 0 ) {
memset ( F_130 ( V_238 , V_264 ) , 0 , V_264 ) ;
} else {
int V_268 = V_22 -> V_28 ;
int V_60 , V_116 ;
int V_269 ;
...
if ( V_116 > 0 ) {
memset ( F_130 ( V_238 , V_116 ) , 0 , V_116 ) ;
V_264 = V_268 * V_271 ;
}
V_60 = 0 ;
...
V_70 = V_22 -> V_70 ;
V_22 -> V_136 = F_133 ( V_70 , V_272 | V_273 , 0 ) ;
if ( ! V_22 -> V_136 )
break;
}
F_134 ( V_22 -> V_136 ) ;
F_135 ( V_238 , V_60 , V_22 -> V_136 ) ;
F_136 ( V_238 ) -> V_268 [ V_60 ] . V_274 = 0 ;
if ( V_60 == ( V_268 - 1 ) )
F_137 ( & F_136 ( V_238 ) -> V_268 [ V_60 ] ,
( V_264 < V_271 ? V_264 : V_271 ) ) ;
else
F_137 ( & F_136 ( V_238 ) -> V_268 [ V_60 ] , V_269 ) ;
V_264 -= F_138 ( & F_136 ( V_238 ) -> V_268 [ V_60 ] ) ;
V_238 -> V_116 += F_138 ( & F_136 ( V_238 ) -> V_268 [ V_60 ] ) ;
V_238 -> V_275 += F_138 ( & F_136 ( V_238 ) -> V_268 [ V_60 ] ) ;
V_60 ++ ;
F_136 ( V_238 ) -> V_276 = V_60 ;
}
}
...
static struct V_237 * F_140 ( struct V_162 * V_163 ,
struct V_21 * V_22 ,
unsigned int V_281 )
{
...
V_22 -> V_190 ;
if ( V_22 -> V_37 & V_87 ) {
int V_70 = V_22 -> V_70 >= 0 ? V_22 -> V_70 : F_132 () ;
V_238 = F_141 ( V_283 + V_282 , V_284 , 0 , V_70 ) ;
if ( F_86 ( V_238 ) ) {
F_142 ( V_238 , V_283 ) ;
V_238 -> V_163 = V_163 ;
}
} else {
V_238 = F_143 ( V_163 , V_282 , V_284 ) ;
}
return V_238 ;
}
static struct V_237 * F_144 ( struct V_162 * V_50 ,
struct V_21 * V_22 )
{
struct V_237 * V_238 = NULL ;
T_11 * V_254 ;
...
F_145 ( V_238 -> V_9 ) ;
F_142 ( V_238 , V_264 ) ;
V_254 = ( T_11 * ) F_122 ( V_238 , 14 ) ;
V_260 = ( V_234 * ) F_130 ( V_238 , V_22 -> V_59 * sizeof( T_7 ) ) ;
if ( V_22 -> V_59 )
F_127 ( V_260 , V_22 ) ;
if ( V_22 -> V_62 != 0xffff ) {
if ( V_22 -> V_65 != 0xffff ) {
V_290 = ( T_10 * ) F_130 ( V_238 , sizeof( T_10 ) ) ;
* V_290 = F_128 ( V_22 -> V_65 ,
V_22 -> V_67 ,
V_22 -> V_66 ) ;
V_291 = ( T_10 * ) F_130 ( V_238 , sizeof( T_10 ) ) ;
* V_291 = F_124 ( V_294 ) ;
}
V_288 = ( T_10 * ) F_130 ( V_238 , sizeof( T_10 ) ) ;
* V_288 = F_128 ( V_22 -> V_62 ,
V_22 -> V_64 ,
V_22 -> V_63 ) ;
V_289 = ( T_10 * ) F_130 ( V_238 , sizeof( T_10 ) ) ;
* V_289 = F_124 ( V_287 ) ;
}
F_146 ( V_238 , 0 ) ;
F_147 ( V_238 , V_238 -> V_116 ) ;
V_255 = (struct V_199 * ) F_130 ( V_238 , sizeof( struct V_199 ) ) ;
F_148 ( V_238 , V_238 -> V_116 ) ;
V_285 = (struct V_188 * ) F_130 ( V_238 , sizeof( struct V_188 ) ) ;
F_149 ( V_238 , V_292 ) ;
...
V_285 -> V_297 = F_124 ( V_22 -> V_103 ) ;
V_285 -> V_298 = F_124 ( V_22 -> V_102 ) ;
V_285 -> V_116 = F_124 ( V_264 + 8 ) ;
V_285 -> V_299 = 0 ;
V_255 -> V_300 = 5 ;
V_255 -> V_4 = 4 ;
V_255 -> V_301 = 32 ;
...
V_255 -> V_261 = F_124 ( V_22 -> V_305 ) ;
V_22 -> V_305 ++ ;
V_255 -> V_306 = 0 ;
V_286 = 20 + 8 + V_264 ;
V_255 -> V_259 = F_124 ( V_286 ) ;
F_125 ( V_255 ) ;
V_238 -> V_252 = V_252 ;
V_238 -> V_163 = V_50 ;
V_238 -> V_307 = V_308 ;
...
V_238 -> V_309 = V_313 ;
V_238 -> V_314 = 0 ;
F_150 ( V_238 , V_285 -> V_297 , V_285 -> V_298 ) ;
} else {
T_12 V_314 = F_151 ( V_238 ) ;
V_285 -> V_299 = F_152 ( V_285 -> V_297 , V_285 -> V_298 ,
V_264 + 8 , V_302 , V_314 ) ;
if ( V_285 -> V_299 == 0 )
V_285 -> V_299 = V_315 ;
}
F_129 ( V_22 , V_238 , V_264 ) ;
#ifdef F_18
if ( ! F_118 ( V_22 , V_238 , V_252 ) )
return NULL ;
#endif
return V_238 ;
}
static struct V_237 * F_153 ( struct V_162 * V_50 ,
struct V_21 * V_22 )
{
struct V_237 * V_238 = NULL ;
T_11 * V_254 ;
...
F_146 ( V_238 , 0 ) ;
F_147 ( V_238 , V_238 -> V_116 ) ;
V_255 = (struct V_187 * ) F_130 ( V_238 , sizeof( struct V_187 ) ) ;
F_148 ( V_238 , V_238 -> V_116 ) ;
V_285 = (struct V_188 * ) F_130 ( V_238 , sizeof( struct V_188 ) ) ;
F_149 ( V_238 , V_292 ) ;
V_238 -> V_296 = V_22 -> V_36 ;
...
V_238 -> V_309 = V_313 ;
V_238 -> V_322 = F_155 ( V_238 ) - V_238 -> V_323 ;
V_238 -> V_324 = F_156 ( struct V_188 , V_299 ) ;
V_285 -> V_299 = ~ F_157 ( & V_255 -> V_303 , & V_255 -> V_304 , V_316 , V_302 , 0 ) ;
} else {
T_12 V_314 = F_151 ( V_238 ) ;
V_285 -> V_299 = F_157 ( & V_255 -> V_303 , & V_255 -> V_304 , V_316 , V_302 , V_314 ) ;
if ( V_285 -> V_299 == 0 )
V_285 -> V_299 = V_315 ;
}
F_129 ( V_22 , V_238 , V_264 ) ;
...
static struct V_237 * F_158 ( struct V_162 * V_50 ,
struct V_21 * V_22 )
{
if ( V_22 -> V_37 & V_38 )
return F_153 ( V_50 , V_22 ) ;
else
...
static void F_159 ( struct V_147 * V_148 )
{
struct V_21 * V_22 ;
int V_326 = 0 ;
F_160 () ;
...
static int F_161 ( const struct V_147 * V_148 )
{
const struct V_21 * V_22 ;
F_44 () ;
F_45 (pkt_dev, &t->if_list, list)
...
static int F_162 ( struct V_147 * V_148 )
{
while ( F_161 ( V_148 ) ) {
F_163 ( 100 ) ;
if ( F_89 ( V_12 ) )
...
static void F_165 ( struct V_21 * V_22 , int V_276 )
{
T_13 V_330 , V_331 , V_332 ;
char * V_333 = V_22 -> V_106 ;
T_5 V_334 = F_91 ( V_22 -> V_89 ,
V_22 -> V_94 ) ;
T_5 V_25 = F_166 ( V_22 -> V_90 ) ;
V_333 += sprintf ( V_333 , L_246 ,
( unsigned long long ) F_21 ( V_334 ) ,
( unsigned long long ) F_21 ( F_91 ( V_334 , V_25 ) ) ,
( unsigned long long ) F_21 ( V_25 ) ,
( unsigned long long ) V_22 -> V_92 ,
V_22 -> V_130 , V_276 ) ;
V_332 = F_167 ( V_22 -> V_92 * V_132 ,
F_78 ( V_334 ) ) ;
...
static int F_168 ( struct V_21 * V_22 )
{
int V_276 = V_22 -> V_238 ? F_136 ( V_22 -> V_238 ) -> V_276 : - 1 ;
if ( ! V_22 -> V_88 ) {
F_10 ( L_248 ,
V_22 -> V_31 ) ;
return - V_18 ;
...
static struct V_21 * F_169 ( struct V_147 * V_148 )
{
...
if ( V_335 == NULL )
V_335 = V_22 ;
else if ( F_81 ( V_22 -> V_212 , V_335 -> V_212 ) < 0 )
V_335 = V_22 ;
}
F_46 () ;
return V_335 ;
}
static void F_170 ( struct V_147 * V_148 )
{
struct V_21 * V_22 ;
F_160 () ;
F_44 () ;
...
F_160 () ;
F_172 (q, n, &t->if_list) {
V_338 = F_173 ( V_337 , struct V_21 , V_339 ) ;
if ( ! V_338 -> V_157 )
continue;
F_126 ( V_338 -> V_238 ) ;
V_338 -> V_238 = NULL ;
...
static void F_175 ( struct V_147 * V_148 )
{
struct V_336 * V_337 , * V_115 ;
struct V_21 * V_338 ;
F_160 () ;
...
{
F_177 ( V_148 -> V_340 -> V_341 , V_148 -> V_177 -> V_165 ) ;
}
static void F_178 ( struct V_21 * V_22 )
{
T_5 V_342 = F_19 () ;
F_87 () ;
V_22 -> V_90 += F_78 ( F_91 ( F_19 () , V_342 ) ) ;
}
static void F_179 ( struct V_21 * V_22 )
{
T_5 V_342 = F_19 () ;
while ( F_180 ( & ( V_22 -> V_238 -> V_343 ) ) != 1 ) {
if ( F_89 ( V_12 ) )
break;
if ( F_181 () )
F_178 ( V_22 ) ;
...
T_14 (* F_184)( struct V_237 * , struct V_162 * )
= V_50 -> V_344 -> V_345 ;
struct V_346 * V_347 ;
V_258 V_292 ;
int V_149 ;
if ( F_131 ( ! F_69 ( V_50 ) || ! F_185 ( V_50 ) ) ) {
F_168 ( V_22 ) ;
return;
}
if ( F_131 ( V_22 -> V_29 == V_131 ) ) {
V_22 -> V_212 = F_80 ( F_19 () , V_348 ) ;
return;
}
if ( ! V_22 -> V_238 || ( V_22 -> V_349 &&
++ V_22 -> V_350 >= V_22 -> V_30 ) ) {
F_126 ( V_22 -> V_238 ) ;
V_22 -> V_238 = F_158 ( V_50 , V_22 ) ;
if ( V_22 -> V_238 == NULL ) {
F_48 ( L_249 ) ;
F_87 () ;
V_22 -> V_350 -- ;
...
F_75 ( V_22 , V_22 -> V_212 ) ;
V_292 = F_186 ( V_22 -> V_238 ) ;
V_347 = F_187 ( V_50 , V_292 ) ;
F_188 () ;
...
F_191 ( & ( V_22 -> V_238 -> V_343 ) ) ;
V_149 = (* F_184)( V_22 -> V_238 , V_50 ) ;
switch ( V_149 ) {
case V_355 :
F_192 ( V_347 ) ;
V_22 -> V_349 = 1 ;
...
F_198 ( & V_148 -> V_363 ) ;
F_199 ( & V_148 -> V_364 ) ;
F_32 ( L_251 , V_362 , F_200 ( V_12 ) ) ;
F_201 () ;
F_90 ( V_215 ) ;
while ( ! F_202 () ) {
V_22 = F_169 ( V_148 ) ;
if ( F_131 ( ! V_22 && V_148 -> V_152 == 0 ) ) {
...
static int F_205 ( struct V_147 * V_148 ,
struct V_21 * V_22 )
{
int V_366 = 0 ;
F_206 ( V_148 ) ;
...
struct V_21 * V_22 ;
int V_178 ;
int V_70 = F_209 ( V_148 -> V_362 ) ;
V_22 = F_55 ( V_148 -> V_177 , V_154 , V_156 ) ;
if ( V_22 ) {
F_48 ( L_257 ) ;
return - V_368 ;
}
V_22 = F_210 ( sizeof( struct V_21 ) , V_272 , V_70 ) ;
if ( ! V_22 )
return - V_370 ;
strcpy ( V_22 -> V_31 , V_154 ) ;
V_22 -> V_218 = F_211 ( V_144 * sizeof( struct V_371 ) ,
V_70 ) ;
if ( V_22 -> V_218 == NULL ) {
F_212 ( V_22 ) ;
return - V_370 ;
...
V_22 -> V_65 = 0xffff ;
V_22 -> V_70 = - 1 ;
V_178 = F_67 ( V_148 -> V_177 , V_22 , V_154 ) ;
if ( V_178 )
goto V_374;
if ( V_22 -> V_50 -> V_133 & V_134 )
V_22 -> V_30 = V_375 ;
V_22 -> V_164 = F_61 ( V_154 , 0600 , V_148 -> V_177 -> V_165 ,
& V_166 , V_22 ) ;
if ( ! V_22 -> V_164 ) {
F_48 ( L_258 ,
V_376 , V_154 ) ;
...
static int T_15 F_215 ( int V_362 , struct V_10 * V_11 )
{
struct V_147 * V_148 ;
struct V_384 * V_385 ;
struct V_386 * V_333 ;
V_148 = F_210 ( sizeof( struct V_147 ) , V_272 ,
F_209 ( V_362 ) ) ;
if ( ! V_148 ) {
F_48 ( L_259 ) ;
return - V_370 ;
...
F_224 ( V_333 , V_362 ) ;
V_148 -> V_340 = V_333 ;
V_385 = F_61 ( V_148 -> V_340 -> V_341 , 0600 , V_11 -> V_165 ,
& V_389 , V_148 ) ;
if ( ! V_385 ) {
F_48 ( L_258 ,
...
static void F_228 ( struct V_147 * V_148 ,
struct V_21 * V_22 )
{
struct V_336 * V_337 , * V_115 ;
struct V_21 * V_333 ;
F_206 ( V_148 ) ;
F_172 (q, n, &t->if_list) {
V_333 = F_173 ( V_337 , struct V_21 , V_339 ) ;
if ( V_333 == V_22 )
F_229 ( & V_333 -> V_339 ) ;
}
F_208 ( V_148 ) ;
}
static int F_174 ( struct V_147 * V_148 ,
struct V_21 * V_22 )
{
F_32 ( L_262 , V_22 ) ;
if ( V_22 -> V_88 ) {
...
static int T_15 F_231 ( struct V_177 * V_177 )
{
...
F_217 ( & V_11 -> V_388 ) ;
V_11 -> V_171 = false ;
V_11 -> V_165 = F_232 ( V_376 , V_11 -> V_177 -> V_391 ) ;
if ( ! V_11 -> V_165 ) {
F_233 ( L_264 , V_376 ) ;
return - V_179 ;
}
V_385 = F_234 ( V_392 , 0600 , V_11 -> V_165 , & V_393 ) ;
if ( V_385 == NULL ) {
F_48 ( L_265 , V_392 ) ;
V_149 = - V_18 ;
goto remove;
...
return 0 ;
V_394:
F_177 ( V_392 , V_11 -> V_165 ) ;
remove:
F_177 ( V_376 , V_11 -> V_177 -> V_391 ) ;
return V_149 ;
}
static void T_16 F_237 ( struct V_177 * V_177 )
{
struct V_10 * V_11 = F_4 ( V_177 , V_15 ) ;
struct V_147 * V_148 ;
struct V_336 * V_337 , * V_115 ;
...
V_11 -> V_171 = true ;
F_49 ( & V_151 ) ;
F_239 ( & V_11 -> V_388 , & V_339 ) ;
F_51 ( & V_151 ) ;
F_172 (q, n, &list) {
V_148 = F_173 ( V_337 , struct V_147 , V_387 ) ;
F_222 ( & V_148 -> V_387 ) ;
F_225 ( V_148 -> V_340 ) ;
F_212 ( V_148 ) ;
}
