...
if ( V_38 < 0 )
return V_38 ;
V_2 = F_37 ( & V_63 -> V_66 , sizeof( * V_2 ) , V_83 ) ;
if ( ! V_2 )
return - V_84 ;
V_80 = F_38 ( V_63 , V_85 , 0 ) ;
...
F_21 ( V_2 ) ;
F_43 ( & V_2 -> V_18 ) ;
V_81 = F_44 ( & V_63 -> V_66 , V_38 , F_17 , 0 ,
V_63 -> V_86 , V_2 ) ;
if ( V_81 ) {
F_30 ( & V_63 -> V_66 , L_10 ) ;
return V_81 ;
...
if ( V_78 ) {
for ( V_82 = 0 ; V_82 < V_78 -> V_89 ; V_82 ++ )
F_48 ( & V_2 -> V_42 , V_78 -> V_90 + V_82 ) ;
}
return 0 ;
}
...
static int F_52 ( struct V_91 * V_66 )
{
...
static int F_54 ( struct V_91 * V_66 )
{
struct V_1 * V_2 = F_53 ( V_66 ) ;
F_21 ( V_2 ) ;
return 0 ;
