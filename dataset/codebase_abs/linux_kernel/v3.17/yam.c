...
F_5 ( 0 , F_6 ( V_32 -> V_49 ) ) ;
if ( F_66 ( V_32 -> V_118 , F_55 , V_149 , V_32 -> V_73 , V_32 ) ) {
...
V_46 -> V_97 = V_46 -> V_98 / 10 ;
for ( V_40 = 0 ; V_40 < V_101 ; V_40 ++ ) {
struct V_44 * V_151 = V_102 [ V_40 ] ;
F_10 ( F_11 ( V_151 -> V_49 ) ) ;
V_151 -> V_74 . V_128 = 0 ;
}
...
F_72 ( V_69 ) ;
F_20 ( V_143 L_34 ,
V_154 , V_32 -> V_49 , V_32 -> V_118 ) ;
return 0 ;
}
static int F_73 ( struct V_44 * V_32 , struct V_155 * V_156 , int V_157 )
{
struct V_45 * V_46 = F_28 ( V_32 ) ;
struct V_158 V_159 ;
struct V_160 * V_161 ;
int V_162 ;
if ( F_74 ( & V_162 , V_156 -> V_163 , sizeof( int ) ) )
return - V_164 ;
if ( V_46 -> V_93 != V_94 )
return - V_153 ;
if ( ! F_75 ( V_165 ) )
...
if ( F_49 ( V_32 ) )
return - V_153 ;
if ( ( V_161 = F_24 ( sizeof( struct V_160 ) , V_39 ) ) == NULL )
return - V_170 ;
if ( F_74 ( V_161 , V_156 -> V_163 , sizeof( struct V_160 ) ) ) {
F_76 ( V_161 ) ;
return - V_164 ;
}
if ( V_161 -> V_17 > V_171 ) {
...
F_17 ( V_161 -> V_16 , V_161 -> V_17 , 0 ) ;
F_76 ( V_161 ) ;
break;
case V_172 :
if ( ! F_75 ( V_173 ) )
return - V_166 ;
if ( F_74 ( & V_159 , V_156 -> V_163 , sizeof( struct V_158 ) ) )
return - V_164 ;
if ( ( V_159 . V_174 . V_175 & V_176 ) && F_49 ( V_32 ) )
return - V_153 ;
if ( ( V_159 . V_174 . V_175 & V_177 ) && F_49 ( V_32 ) )
return - V_153 ;
if ( ( V_159 . V_174 . V_175 & V_178 ) && F_49 ( V_32 ) )
return - V_153 ;
if ( ( V_159 . V_174 . V_175 & V_179 ) && F_49 ( V_32 ) )
return - V_153 ;
if ( V_159 . V_174 . V_175 & V_176 ) {
V_46 -> V_5 = V_159 . V_174 . V_5 ;
V_32 -> V_49 = V_159 . V_174 . V_5 ;
}
if ( V_159 . V_174 . V_175 & V_177 ) {
if ( V_159 . V_174 . V_118 > 15 )
return - V_153 ;
V_46 -> V_118 = V_159 . V_174 . V_118 ;
V_32 -> V_118 = V_159 . V_174 . V_118 ;
}
if ( V_159 . V_174 . V_175 & V_178 ) {
if ( V_159 . V_174 . V_17 > V_171 )
return - V_153 ;
V_46 -> V_17 = V_159 . V_174 . V_17 ;
}
if ( V_159 . V_174 . V_175 & V_179 ) {
if ( V_159 . V_174 . V_48 > V_180 )
return - V_153 ;
V_46 -> V_48 = V_159 . V_174 . V_48 ;
}
if ( V_159 . V_174 . V_175 & V_181 ) {
if ( V_159 . V_174 . V_182 > V_183 )
return - V_153 ;
V_46 -> V_96 = V_159 . V_174 . V_182 ;
}
if ( V_159 . V_174 . V_175 & V_184 ) {
if ( V_159 . V_174 . V_185 > V_186 )
return - V_153 ;
V_46 -> V_116 = V_159 . V_174 . V_185 ;
}
if ( V_159 . V_174 . V_175 & V_187 ) {
if ( V_159 . V_174 . V_188 > V_189 )
return - V_153 ;
V_46 -> V_90 = V_159 . V_174 . V_188 ;
}
if ( V_159 . V_174 . V_175 & V_190 ) {
if ( V_159 . V_174 . V_115 > V_191 )
return - V_153 ;
V_46 -> V_115 = V_159 . V_174 . V_115 ;
}
if ( V_159 . V_174 . V_175 & V_192 ) {
if ( V_159 . V_174 . V_193 > V_194 )
return - V_153 ;
V_46 -> V_99 = V_159 . V_174 . V_193 ;
}
if ( V_159 . V_174 . V_175 & V_195 ) {
if ( V_159 . V_174 . V_196 > V_197 )
return - V_153 ;
V_46 -> V_98 = V_159 . V_174 . V_196 ;
V_46 -> V_97 = V_46 -> V_98 / 10 ;
}
break;
case V_198 :
memset ( & V_159 , 0 , sizeof( V_159 ) ) ;
V_159 . V_174 . V_175 = 0xffffffff ;
V_159 . V_174 . V_5 = V_46 -> V_5 ;
V_159 . V_174 . V_118 = V_46 -> V_118 ;
V_159 . V_174 . V_17 = V_46 -> V_17 ;
V_159 . V_174 . V_48 = V_46 -> V_48 ;
V_159 . V_174 . V_182 = V_46 -> V_96 ;
V_159 . V_174 . V_188 = V_46 -> V_90 ;
V_159 . V_174 . V_185 = V_46 -> V_116 ;
V_159 . V_174 . V_115 = V_46 -> V_115 ;
V_159 . V_174 . V_193 = V_46 -> V_99 ;
V_159 . V_174 . V_196 = V_46 -> V_98 ;
if ( F_77 ( V_156 -> V_163 , & V_159 , sizeof( struct V_158 ) ) )
return - V_164 ;
break;
default:
return - V_153 ;
...
static int F_78 ( struct V_44 * V_32 , void * V_199 )
{
struct V_200 * V_201 = (struct V_200 * ) V_199 ;
memcpy ( V_32 -> V_202 , V_201 -> V_203 , V_32 -> V_204 ) ;
return 0 ;
}
...
V_32 -> V_218 = V_219 ;
V_32 -> V_204 = V_220 ;
memcpy ( V_32 -> V_221 , & V_222 , V_220 ) ;
memcpy ( V_32 -> V_202 , & V_223 , V_220 ) ;
}
