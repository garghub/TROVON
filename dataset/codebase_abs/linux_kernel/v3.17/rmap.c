...
bool V_97 ;
unsigned long V_98 ;
F_129 ( V_38 , & V_97 , & V_98 ) ;
if ( F_121 ( & V_38 -> V_94 ) ) {
F_122 ( V_38 , V_99 ) ;
F_130 ( V_38 , V_100 ) ;
}
F_131 ( V_38 , & V_97 , & V_98 ) ;
}
void F_132 ( struct V_38 * V_38 )
{
bool V_101 = F_61 ( V_38 ) ;
bool V_97 ;
unsigned long V_98 ;
if ( ! V_101 )
F_129 ( V_38 , & V_97 , & V_98 ) ;
if ( ! F_133 ( - 1 , & V_38 -> V_94 ) )
goto V_43;
if ( F_18 ( F_72 ( V_38 ) ) )
goto V_43;
if ( V_101 ) {
...
static int F_138 ( struct V_38 * V_38 , struct V_10 * V_11 ,
unsigned long V_49 , void * V_66 )
{
struct V_15 * V_16 = V_11 -> V_17 ;
T_7 * V_63 ;
...
T_8 * V_64 ;
int V_80 = V_71 ;
enum V_103 V_98 = (enum V_103 ) V_66 ;
V_63 = F_84 ( V_38 , V_16 , V_49 , & V_64 , 0 ) ;
if ( ! V_63 )
goto V_43;
if ( ! ( V_98 & V_104 ) ) {
...
V_102 = F_103 ( V_11 , V_49 , V_63 ) ;
if ( F_100 ( V_102 ) )
F_139 ( V_38 ) ;
F_140 ( V_16 ) ;
if ( F_141 ( V_38 ) && ! ( V_98 & V_109 ) ) {
if ( ! F_72 ( V_38 ) ) {
if ( F_61 ( V_38 ) )
F_142 ( V_16 , V_110 ) ;
else
...
T_9 V_88 = { . V_112 = F_146 (page) } ;
T_7 V_113 ;
if ( F_147 ( V_38 ) ) {
if ( F_148 ( V_88 ) < 0 ) {
F_106 ( V_16 , V_49 , V_63 , V_102 ) ;
V_80 = V_73 ;
goto V_107;
}
if ( F_149 ( & V_16 -> V_114 ) ) {
...
F_110 ( ! ( V_98 & V_119 ) ) ;
V_88 = F_152 ( V_38 , F_101 ( V_102 ) ) ;
}
V_113 = F_143 ( V_88 ) ;
if ( F_153 ( V_102 ) )
V_113 = F_154 ( V_113 ) ;
F_106 ( V_16 , V_49 , V_63 , V_113 ) ;
F_110 ( F_155 ( * V_63 ) ) ;
} else if ( F_151 ( V_118 ) &&
( V_98 & V_119 ) ) {
T_9 V_88 ;
V_88 = F_152 ( V_38 , F_101 ( V_102 ) ) ;
F_106 ( V_16 , V_49 , V_63 , F_143 ( V_88 ) ) ;
} else
F_142 ( V_16 , V_111 ) ;
F_132 ( V_38 ) ;
F_156 ( V_38 ) ;
...
static int F_158 ( unsigned long V_122 , unsigned int * V_75 ,
...
V_124 = V_49 ;
V_125 = V_126 ;
F_159 ( V_16 , V_124 , V_125 ) ;
if ( F_50 ( & V_11 -> V_17 -> V_120 ) ) {
V_127 = ( V_11 -> V_53 & V_72 ) ;
if ( ! V_127 )
F_51 ( & V_11 -> V_17 -> V_120 ) ;
}
V_63 = F_160 ( V_16 , V_59 , V_49 , & V_64 ) ;
F_140 ( V_16 ) ;
for (; V_49 < V_126 ; V_63 ++ , V_49 += V_130 ) {
if ( ! F_77 ( * V_63 ) )
continue;
V_38 = F_161 ( V_11 , V_49 , * V_63 ) ;
...
T_7 V_131 = F_162 ( V_38 -> V_91 ) ;
if ( F_153 ( V_102 ) )
V_131 = F_163 ( V_131 ) ;
F_106 ( V_16 , V_49 , V_63 , V_131 ) ;
}
if ( F_100 ( V_102 ) )
F_139 ( V_38 ) ;
F_132 ( V_38 ) ;
...
F_82 ( V_63 - 1 , V_64 ) ;
F_164 ( V_16 , V_124 , V_125 ) ;
if ( V_127 )
F_51 ( & V_11 -> V_17 -> V_120 ) ;
return V_80 ;
}
static int F_165 ( struct V_38 * V_38 ,
...
F_166 (vma, &mapping->i_mmap_nonlinear, shared.nonlinear)
V_11 -> V_134 = NULL ;
return V_80 ;
}
bool F_168 ( struct V_10 * V_11 )
{
int V_135 = V_11 -> V_53 & ( V_136 | V_137 ) ;
if ( ! V_135 )
return false ;
if ( ( V_11 -> V_53 & V_138 ) ==
V_138 )
...
static bool F_169 ( struct V_10 * V_11 , void * V_66 )
{
return F_168 ( V_11 ) ;
}
static int F_170 ( struct V_38 * V_38 )
{
return ! F_46 ( V_38 ) ;
}
int F_171 ( struct V_38 * V_38 , enum V_103 V_98 )
{
int V_80 ;
struct V_82 V_83 = {
. V_84 = F_138 ,
...
if ( ( V_98 & V_119 ) && ! F_95 ( V_38 ) && F_61 ( V_38 ) )
V_83 . V_86 = F_169 ;
V_80 = F_97 ( V_38 , & V_83 ) ;
if ( V_80 != V_121 && ! F_46 ( V_38 ) )
V_80 = V_76 ;
return V_80 ;
}
int F_172 ( struct V_38 * V_38 )
{
int V_80 ;
struct V_82 V_83 = {
. V_84 = F_138 ,
...
F_114 ( ! F_111 ( V_38 ) || F_173 ( V_38 ) , V_38 ) ;
V_80 = F_97 ( V_38 , & V_83 ) ;
return V_80 ;
}
...
static struct V_1 * F_174 ( struct V_38 * V_38 ,
struct V_82 * V_83 )
{
struct V_1 * V_1 ;
if ( V_83 -> V_85 )
...
static int F_175 ( struct V_38 * V_38 , struct V_82 * V_83 )
{
struct V_1 * V_1 ;
T_3 V_45 = F_58 ( V_38 ) ;
struct V_7 * V_12 ;
...
if ( ! V_1 )
return V_80 ;
F_176 (avc, &anon_vma->rb_root, pgoff, pgoff) {
...
if ( V_80 != V_71 )
break;
if ( V_83 -> V_139 && V_83 -> V_139 ( V_38 ) )
break;
}
F_54 ( V_1 ) ;
return V_80 ;
}
static int F_177 ( struct V_38 * V_38 , struct V_82 * V_83 )
{
...
return V_80 ;
F_178 ( & V_40 -> V_141 ) ;
F_179 (vma, &mapping->i_mmap, pgoff, pgoff) {
unsigned long V_49 = F_59 ( V_38 , V_11 ) ;
if ( V_83 -> V_86 && V_83 -> V_86 ( V_11 , V_83 -> V_66 ) )
continue;
V_80 = V_83 -> V_84 ( V_38 , V_11 , V_49 , V_83 -> V_66 ) ;
...
if ( F_149 ( & V_40 -> V_142 ) )
goto V_139;
V_80 = V_83 -> V_140 ( V_38 , V_40 , V_83 -> V_66 ) ;
V_139:
F_180 ( & V_40 -> V_141 ) ;
return V_80 ;
}
...
return F_175 ( V_38 , V_83 ) ;
else
return F_177 ( V_38 , V_83 ) ;
}
static void F_182 ( struct V_38 * V_38 ,
struct V_10 * V_11 , unsigned long V_49 , int V_92 )
{
struct V_1 * V_1 = V_11 -> V_1 ;
F_110 ( ! V_1 ) ;
...
if ( V_93 )
F_182 ( V_38 , V_11 , V_49 , 0 ) ;
}
void F_184 ( struct V_38 * V_38 ,
struct V_10 * V_11 , unsigned long V_49 )
{
F_110 ( V_49 < V_11 -> V_46 || V_49 >= V_11 -> V_50 ) ;
F_3 ( & V_38 -> V_94 , 0 ) ;
F_182 ( V_38 , V_11 , V_49 , 1 ) ;
}
