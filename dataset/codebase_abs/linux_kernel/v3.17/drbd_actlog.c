...
void F_51 ( struct V_1 * V_2 , struct V_78 * V_79 )
{
if ( F_45 ( V_2 , V_79 ) )
F_46 ( V_2 ) ;
}
int F_52 ( struct V_1 * V_2 , struct V_78 * V_79 )
{
...
for ( V_63 = V_80 ; V_63 <= V_82 ; V_63 ++ ) {
struct V_64 * V_72 ;
V_72 = F_55 ( V_2 -> V_77 , V_63 ) ;
if ( ! V_72 )
F_56 ( V_2 , L_8 , V_63 ) ;
}
return 0 ;
}
void F_57 ( struct V_1 * V_2 , struct V_78 * V_79 )
{
unsigned V_80 = V_79 -> V_27 >> ( V_81 - 9 ) ;
unsigned V_82 = V_79 -> V_30 == 0 ? V_80 : ( V_79 -> V_27 + ( V_79 -> V_30 >> 9 ) - 1 ) >> ( V_81 - 9 ) ;
unsigned V_63 ;
...
static unsigned int F_61 ( unsigned int V_102 )
{
return V_102 >>
( ( V_103 + 3 ) -
( V_81 - V_104 ) ) ;
...
V_116 -> V_122 = F_66 ( V_123 ) ;
V_116 -> V_124 = F_66 ( V_2 -> V_111 ) ;
V_79 = 0 ;
F_39 ( & V_2 -> V_74 ) ;
F_67 (e, &device->act_log->to_be_changed, list) {
if ( V_79 == V_125 ) {
V_79 ++ ;
break;
}
V_116 -> V_126 [ V_79 ] = F_68 ( V_117 -> V_127 ) ;
V_116 -> V_128 [ V_79 ] = F_66 ( V_117 -> V_129 ) ;
if ( V_117 -> V_85 != V_130 )
F_69 ( V_2 ,
F_61 ( V_117 -> V_85 ) ) ;
V_79 ++ ;
...
F_41 ( & V_2 -> V_74 ) ;
F_30 ( V_79 > V_125 ) ;
V_116 -> V_131 = F_68 ( V_79 ) ;
for ( ; V_79 < V_125 ; V_79 ++ ) {
V_116 -> V_126 [ V_79 ] = F_68 ( - 1 ) ;
V_116 -> V_128 [ V_79 ] = F_66 ( V_130 ) ;
}
V_116 -> V_132 = F_68 ( V_2 -> V_77 -> V_94 ) ;
V_116 -> V_133 = F_68 ( V_2 -> V_134 ) ;
V_118 = F_70 ( int , V_135 ,
V_2 -> V_77 -> V_94 - V_2 -> V_134 ) ;
for ( V_79 = 0 ; V_79 < V_118 ; V_79 ++ ) {
unsigned V_136 = V_2 -> V_134 + V_79 ;
V_119 = F_71 ( V_2 -> V_77 , V_136 ) -> V_85 ;
V_116 -> V_137 [ V_79 ] = F_66 ( V_119 ) ;
}
for (; V_79 < V_135 ; V_79 ++ )
V_116 -> V_137 [ V_79 ] = F_66 ( V_130 ) ;
V_2 -> V_134 += V_135 ;
if ( V_2 -> V_134 >= V_2 -> V_77 -> V_94 )
V_2 -> V_134 = 0 ;
V_27 = F_62 ( V_2 ) ;
V_120 = F_72 ( 0 , V_116 , 4096 ) ;
V_116 -> F_72 = F_66 ( V_120 ) ;
if ( F_73 ( V_2 ) )
V_31 = - V_44 ;
else {
bool V_88 ;
...
F_11 () ;
if ( V_88 ) {
if ( F_27 ( V_2 , V_2 -> V_51 , V_27 , V_33 ) ) {
V_31 = - V_44 ;
F_15 ( V_2 , 1 , V_138 ) ;
} else {
V_2 -> V_111 ++ ;
...
struct V_64 * V_72 ;
int V_79 ;
F_28 ( V_2 , F_13 ( V_142 , & V_2 -> V_77 -> V_25 ) ) ;
for ( V_79 = 0 ; V_79 < V_2 -> V_77 -> V_94 ; V_79 ++ ) {
V_72 = F_71 ( V_2 -> V_77 , V_79 ) ;
if ( V_72 -> V_85 == V_130 )
continue;
...
int F_78 ( struct V_1 * V_2 , void * V_116 )
{
...
int V_79 ;
memset ( V_91 , 0 , 4096 ) ;
V_91 -> V_122 = F_66 ( V_123 ) ;
V_91 -> V_145 = F_68 ( V_146 ) ;
V_91 -> F_72 = F_66 ( F_72 ( 0 , V_91 , 4096 ) ) ;
for ( V_79 = 0 ; V_79 < V_112 ; V_79 ++ ) {
int V_31 = F_27 ( V_2 , V_2 -> V_51 , V_144 + V_79 * 8 , V_33 ) ;
if ( V_31 )
return V_31 ;
}
return 0 ;
...
if ( V_149 == V_150 )
V_117 = F_35 ( V_2 -> V_66 , V_63 ) ;
else
V_117 = F_43 ( V_2 -> V_66 , V_63 ) ;
if ( V_117 ) {
struct V_62 * V_151 = F_37 ( V_117 , struct V_62 , V_69 ) ;
...
V_151 -> V_154 , V_147 ,
F_81 ( V_2 -> V_8 . V_155 ) ) ;
V_151 -> V_153 = F_82 ( V_2 , V_63 ) ;
}
} else {
int V_153 = F_82 ( V_2 , V_63 ) ;
if ( V_151 -> V_25 != 0 ) {
F_80 ( V_2 , L_15
L_16 ,
V_151 -> V_69 . V_85 , V_151 -> V_153 ,
...
{
return F_86 ( V_13 , V_2 -> V_168 + 2 * V_22 ) ;
}
static void F_87 ( struct V_1 * V_2 , bool V_169 )
{
if ( V_169 )
F_88 ( V_170 , & V_2 -> V_25 ) ;
else if ( ! F_85 ( V_2 ) )
...
while ( V_172 <= V_173 ) {
unsigned long V_175 = F_53 ( V_173 , V_172 | V_176 ) ;
unsigned long V_177 ;
if ( V_149 == V_156 )
...
V_177 = F_93 ( V_2 , V_172 , V_175 ) ;
if ( V_177 ) {
F_58 ( & V_2 -> V_74 , V_25 ) ;
V_174 += F_79 ( V_2 , F_94 ( V_172 ) , V_177 , V_149 ) ;
F_60 ( & V_2 -> V_74 , V_25 ) ;
V_147 += V_177 ;
}
V_172 = V_175 + 1 ;
...
enum V_148 V_149 ,
const char * V_179 , const unsigned int line )
{
...
return 0 ;
if ( V_30 <= 0 || ! F_97 ( V_30 , 512 ) || V_30 > V_183 ) {
F_14 ( V_2 , L_20 ,
V_184 [ V_149 ] ,
...
V_180 = F_100 ( V_182 - 1 ) ;
if ( V_149 == V_152 ) {
if ( F_36 ( V_181 < V_186 - 1 ) )
goto V_45;
if ( F_36 ( V_181 == ( V_182 - 1 ) ) )
V_173 = V_180 ;
else
V_173 = F_100 ( V_181 - ( V_186 - 1 ) ) ;
V_172 = F_100 ( V_27 + V_186 - 1 ) ;
} else {
V_172 = F_100 ( V_27 ) ;
V_173 = F_100 ( V_181 ) ;
}
V_147 = F_90 ( V_2 , V_172 , V_173 , V_149 ) ;
V_45:
F_65 ( V_2 ) ;
return V_147 ;
}
...
V_117 = F_43 ( V_2 -> V_66 , V_63 ) ;
V_68 = V_117 ? F_37 ( V_117 , struct V_62 , V_69 ) : NULL ;
if ( V_68 ) {
if ( V_68 -> V_69 . V_85 != V_63 ) {
V_68 -> V_153 = F_82 ( V_2 , V_63 ) ;
V_68 -> V_154 = 0 ;
F_49 ( V_2 -> V_66 ) ;
V_187 = 1 ;
}
...
struct V_62 * V_68 ;
int V_79 ;
bool V_196 = F_110 ( V_2 , V_27 , true ) ;
if ( V_196 && V_2 -> V_197 != V_63 )
return - V_198 ;
F_39 ( & V_2 -> V_74 ) ;
if ( V_2 -> V_197 != V_130 && V_2 -> V_197 != V_63 ) {
V_117 = F_35 ( V_2 -> V_66 , V_2 -> V_197 ) ;
V_68 = V_117 ? F_37 ( V_117 , struct V_62 , V_69 ) : NULL ;
if ( V_68 ) {
...
F_88 ( V_70 , & V_68 -> V_25 ) ;
F_28 ( V_2 , V_68 -> V_69 . V_141 == 1 ) ;
V_2 -> V_157 ++ ;
goto V_200;
}
V_200:
for ( V_79 = 0 ; V_79 < V_67 ; V_79 ++ ) {
if ( F_103 ( V_2 -> V_77 , V_102 + V_79 ) )
goto V_201;
}
F_88 ( V_195 , & V_68 -> V_25 ) ;
V_199:
...
V_117 = F_71 ( V_2 -> V_66 , V_79 ) ;
V_68 = F_37 ( V_117 , struct V_62 , V_69 ) ;
