...
V_23 = F_11 ( V_19 , struct V_22 , V_23 ) ;
if ( F_35 ( ! V_19 || ( ! V_23 -> V_23 . V_21 && V_23 -> V_23 . V_26 != V_27 ) ) ) {
F_13 ( L_21 , V_31 ) ;
return - V_32 ;
}
V_25 = V_23 -> V_25 ;
...
V_134 = F_11 ( V_129 , struct V_24 , V_40 ) ;
if ( ! F_62 ( V_134 -> V_141 ) )
return F_63 ( V_134 -> V_141 , V_140 ) ;
return - V_126 ;
}
static int
F_64 ( struct V_142 * V_143 , void * V_144 )
{
...
static int
F_66 ( struct V_161 * V_161 , struct V_162 * V_162 )
{
return F_67 ( V_162 , F_64 , V_161 -> V_163 ) ;
}
...
static int F_70 ( struct V_128 * V_170 ,
struct V_171 * V_39 )
{
struct V_24 * V_25 = F_71 ( V_170 ) ;
int V_172 ;
V_25 -> V_39 = V_39 ;
V_25 -> F_53 = 1 ;
if ( ! F_62 ( V_25 -> V_141 ) ) {
V_172 = F_72 ( V_25 -> V_141 -> V_173 ,
& V_25 -> V_40 ) ;
if ( V_172 )
goto V_174;
}
...
static void
F_56 ( struct V_24 * V_25 , struct V_171 * V_39 )
{
int V_123 ;
...
static int F_75 ( struct V_128 * V_170 ,
struct V_171 * V_39 )
{
struct V_24 * V_25 = F_71 ( V_170 ) ;
F_76 () ;
...
F_77 () ;
if ( ! F_62 ( V_25 -> V_141 ) )
( void ) F_72 ( V_25 -> V_141 -> V_173 , NULL ) ;
V_25 -> V_39 = NULL ;
F_73 ( V_25 ) ;
return 0 ;
}
static T_5
F_78 ( int V_177 , void * V_178 )
{
...
static void F_82 ( unsigned long V_178 )
{
...
if ( ( V_184 & V_77 ) != 0 && V_25 -> V_60 != V_61 ) {
F_18 ( V_23 , 0 ) ;
F_84 ( & V_25 -> V_175 ) ;
F_30 ( V_25 ) ;
}
...
F_85 ( V_189 . V_186 . V_197 ) ,
F_85 ( V_189 . V_186 . V_198 ) ,
F_85 ( V_189 . V_186 . V_199 ) ) ;
...
static void F_90 ( struct V_222 * V_25 )
{
F_13 ( L_89 , V_31 , F_91 ( V_25 ) ) ;
}
...
if ( V_177 < 0 )
return - V_125 ;
V_25 -> V_139 = F_97 ( & V_224 -> V_25 , NULL ) ;
if ( F_98 ( V_25 -> V_139 ) )
return F_99 ( V_25 -> V_139 ) ;
F_100 ( L_93 , V_227 , V_177 ,
V_25 -> V_106 ? L_11 : L_94 ,
V_247 L_38
) ;
V_25 -> V_25 = & V_224 -> V_25 ;
V_25 -> V_2 = F_101 ( & V_224 -> V_25 ) ;
V_25 -> V_141 = F_102 ( & V_224 -> V_25 , V_248 ) ;
if ( F_2 ( V_25 -> V_2 -> V_6 ) ) {
V_172 = F_103 ( & V_224 -> V_25 , V_25 -> V_2 -> V_6 ,
L_95 ) ;
if ( V_172 ) {
F_104 ( & V_224 -> V_25 ,
L_96 ,
...
F_105 ( V_25 -> V_2 -> V_6 , 0 ) ;
}
F_106 ( & V_25 -> V_175 ) ;
V_25 -> V_175 . V_250 = F_82 ;
...
F_68 ( V_25 ) ;
V_25 -> V_136 = 0 ;
V_172 = F_108 ( & V_224 -> V_25 , V_177 , F_88 , 0 ,
V_227 , V_25 ) ;
if ( V_172 != 0 ) {
F_94 ( L_97 ,
V_227 , V_177 , V_172 ) ;
...
#endif
F_111 ( V_25 ) ;
V_172 = F_112 ( & V_224 -> V_25 , & V_25 -> V_40 ) ;
if ( ! V_172 )
return V_172 ;
F_113 ( V_25 ) ;
V_249:
...
static void F_114 ( struct V_223 * V_178 )
{
F_1 () ;
}
static int F_115 ( struct V_223 * V_224 )
{
struct V_24 * V_25 = F_116 ( V_224 ) ;
if ( V_25 -> V_39 )
return - V_253 ;
F_117 ( & V_25 -> V_40 ) ;
V_25 -> F_53 = 0 ;
...
static int F_118 ( struct V_223 * V_25 , T_6 V_254 )
{
struct V_24 * V_134 = F_116 ( V_25 ) ;
unsigned long V_48 ;
if ( ! F_2 ( V_134 -> V_2 -> V_6 ) && ! V_134 -> V_2 -> V_7 )
F_86 ( L_99 ) ;
V_134 -> V_137 = 1 ;
...
static int F_119 ( struct V_223 * V_25 )
{
struct V_24 * V_134 = F_116 ( V_25 ) ;
unsigned long V_48 ;
V_134 -> V_137 = 0 ;
