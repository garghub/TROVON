...
V_15 = F_74 ( sizeof( * V_15 ) , V_151 ) ;
if ( ! V_15 )
return;
V_91 = F_74 ( sizeof( * V_91 ) , V_151 ) ;
if ( ! V_91 ) {
F_56 ( V_15 ) ;
return;
}
...
V_60 = & V_91 -> V_4 ;
V_7 = & V_60 -> V_4 ;
F_75 ( V_11 , & V_60 -> V_4 , & V_152 ,
V_153 ) ;
F_76 ( V_11 , & V_8 -> V_4 , & V_154 ,
V_155 ) ;
V_8 -> V_156 = F_23 ;
V_8 -> V_157 = F_15 ;
V_8 -> V_158 = F_32 ;
...
V_11 -> V_115 . V_116 ,
V_173 ) ;
V_60 -> V_73 . V_83 = V_173 ;
F_47 ( & V_11 -> V_115 . V_174 ) ;
