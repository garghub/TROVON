...
static void F_66 ( struct V_11 * V_12 , struct V_171 * V_87 )
{
F_41 ( V_12 ) ;
}
static int F_67 ( struct V_11 * V_12 , struct V_171 * V_87 )
{
...
static void F_68 ( struct V_171 * V_87 , struct V_3 * V_4 )
{
V_4 -> V_21 = & V_22 [ V_172 ] ;
}
static int
F_69 ( struct V_173 * V_174 , int V_175 , struct V_176 * V_177 )
{
struct V_13 * V_13 = F_70 ( V_174 ) ;
return F_71 ( F_72 ( V_13 ) -> V_178 , V_175 , V_177 ) ;
}
