...
goto V_12;
V_32 = F_11 ( V_25 , sizeof( V_25 ) , L_2 ,
F_20 ( V_31 ) >> 10 ,
F_20 ( V_31 ) & 0x3ff ) ;
V_7 = F_12 ( V_1 , V_25 , V_32 , 0 ) ;
if ( V_7 < 0 )
goto V_12;
}
V_7 = V_8 ;
...
static const struct V_34 * F_21 ( const int * V_35 , int V_36 , char * V_37 )
{
...
static char * F_26 ( const int * V_35 , int V_36 , const struct V_34 * * V_51 )
{
char * V_52 , * V_7 ;
V_7 = F_22 ( - V_15 ) ;
V_52 = F_27 () ;
if ( V_52 ) {
const struct V_34 * V_38 = F_21 ( V_35 , V_36 , V_52 ) ;
V_7 = V_52 ;
* V_51 = V_38 ;
if ( F_28 ( V_38 ) ) {
F_29 ( V_52 ) ;
...
static T_1 F_31 ( const int * V_35 , int V_36 ,
void T_2 * V_2 , T_3 V_3 , void T_2 * V_4 , T_3 V_5 )
{
...
V_54 = F_33 ( V_44 ) -> V_61 ;
V_1 = F_34 ( V_54 -> V_62 , V_54 , V_55 , V_56 ) ;
V_7 = F_32 ( V_1 ) ;
if ( F_28 ( V_1 ) )
goto V_60;
...
static void F_36 ( const int * V_35 , int V_36 )
{
int V_22 ;
...
static void F_39 ( const int * V_35 , int V_36 )
{
int V_22 ;
T_6 V_68 = V_69 ;
for ( V_22 = 0 ; V_22 < V_36 ; V_22 ++ )
...
static T_1 F_41 ( int T_2 * V_73 , int V_36 ,
void T_2 * V_2 , T_3 V_3 , void T_2 * V_4 , T_3 V_5 )
{
int V_35 [ V_74 ] ;
int V_22 ;
...
return - V_13 ;
F_39 ( V_35 , V_36 ) ;
return F_31 ( V_35 , V_36 , V_2 , V_3 , V_4 , V_5 ) ;
}
