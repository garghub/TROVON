...
F_41 ( V_102 [ V_36 ] . V_105 . V_106 . V_106 ) ;
F_41 ( V_102 ) ;
}
...
if ( V_109 >= V_110 )
return 0 ;
V_111 = F_43 ( * V_102 , sizeof( * V_111 ) * V_110 , V_112 ) ;
if ( ! V_111 )
return - V_113 ;
...
if ( * V_103 == * V_107 )
return - V_114 ;
V_118 = F_46 ( V_106 , V_117 * sizeof( * V_118 ) ,
V_112 ) ;
if ( ! V_118 )
return - V_113 ;
...
static const char * F_47 ( struct V_46 * V_47 ,
const char * V_120 )
{
int V_36 , V_121 ;
struct V_1 * V_122 = F_19 ( V_47 ) ;
if ( sscanf ( ( char * ) V_120 , L_32 , & V_121 ) == 1 )
...
struct V_124 * V_131 ;
V_10 = F_49 ( V_125 , L_33 , & V_79 ) ;
if ( V_10 >= 0 )
V_108 = 1 ;
V_10 = F_50 ( V_125 , & V_106 , & V_126 ) ;
if ( V_126 )
V_127 = 1 ;
V_131 = F_51 ( V_125 , L_34 , 0 ) ;
if ( V_131 ) {
V_10 = F_50 ( V_131 , & V_106 ,
& V_126 ) ;
if ( V_10 )
goto exit;
V_127 |= V_126 ;
}
V_10 = F_52 ( V_125 , L_35 ) ;
if ( V_10 < 0 )
goto exit;
if ( V_127 )
V_108 ++ ;
V_108 *= V_10 ;
V_10 = F_42 ( V_102 , V_107 , V_103 , V_108 ) ;
if ( V_10 < 0 )
goto exit;
F_53 (np, L_35 , prop, group) {
if ( V_79 ) {
V_10 = F_44 ( V_102 , V_107 ,
V_103 , V_85 , V_79 ) ;
if ( V_10 < 0 )
goto exit;
}
if ( V_127 ) {
V_130 = F_47 ( V_47 , V_85 ) ;
...
* V_103 = 0 ;
F_55 (np_config, np) {
V_10 = F_48 ( V_47 , V_125 , V_102 ,
& V_107 , V_103 ) ;
if ( V_10 < 0 ) {
F_40 ( V_47 , * V_102 , * V_103 ) ;
return V_10 ;
}
}
return 0 ;
...
V_136 = F_58 ( V_106 [ V_36 ] ) ;
V_137 = F_59 ( V_106 [ V_36 ] ) ;
F_20 ( V_3 -> V_11 , L_36 ,
V_132 , V_106 [ V_36 ] ,
( V_136 == V_138 ) ? L_37 : L_38 ,
( V_136 == V_138 ) ?
( V_137 ? L_39 : L_40 ) :
( V_137 ? L_16 : L_14 ) ) ;
V_5 = V_132 - 1 ;
...
static int F_60 ( struct V_142 * V_23 )
{
...
static int F_61 ( struct V_147 * V_148 )
{
struct V_124 * V_125 = V_148 -> V_11 . V_149 ;
const struct V_150 * V_151 ;
struct V_1 * V_7 ;
unsigned int V_152 = - 1 ;
int V_10 , V_153 ;
int V_36 ;
if ( ! V_125 ) {
F_6 ( & V_148 -> V_11 , L_42 ) ;
...
V_7 = F_62 ( & V_148 -> V_11 , sizeof( struct V_1 ) ,
V_112 ) ;
if ( V_7 == NULL ) {
F_6 ( & V_148 -> V_11 ,
L_43 ) ;
...
V_7 -> V_11 = & V_148 -> V_11 ;
V_7 -> V_44 = F_63 ( V_148 -> V_11 . V_44 ) ;
V_7 -> V_3 = V_154 ;
V_7 -> V_3 . V_11 = & V_148 -> V_11 ;
V_7 -> V_3 . V_76 = - 1 ;
V_151 = F_64 ( V_155 , & V_148 -> V_11 ) ;
if ( ! V_151 ) {
F_6 ( & V_148 -> V_11 , L_44 ) ;
return - V_97 ;
}
V_152 = ( unsigned long ) V_151 -> V_105 ;
switch ( V_152 ) {
case V_156 :
F_65 ( & V_7 -> V_23 ) ;
break;
...
V_7 -> V_3 . V_77 = F_60 ( V_7 -> V_23 ) ;
V_7 -> V_40 = V_7 -> V_23 -> V_160 ;
V_7 -> V_37 = V_7 -> V_23 -> V_161 ;
V_10 = F_69 ( & V_7 -> V_3 ) ;
if ( V_10 ) {
F_6 ( & V_148 -> V_11 , L_47 , V_10 ) ;
return V_10 ;
}
F_70 ( & V_148 -> V_11 , L_48 ) ;
V_162 . V_90 = V_7 -> V_23 -> V_90 ;
V_162 . V_89 = V_7 -> V_23 -> V_89 ;
V_7 -> V_47 = F_71 ( & V_162 , & V_148 -> V_11 , V_7 ) ;
if ( ! V_7 -> V_47 ) {
F_6 ( & V_148 -> V_11 ,
L_49 ) ;
V_10 = - V_27 ;
...
F_74 ( V_148 , V_7 ) ;
F_70 ( & V_148 -> V_11 , L_51 ) ;
return 0 ;
V_163:
V_153 = F_75 ( & V_7 -> V_3 ) ;
if ( V_153 )
F_70 ( & V_148 -> V_11 , L_52 ) ;
return V_10 ;
}
static int F_76 ( struct V_147 * V_148 )
{
struct V_1 * V_7 = F_77 ( V_148 ) ;
int V_10 ;
V_10 = F_75 ( & V_7 -> V_3 ) ;
if ( V_10 < 0 ) {
F_6 ( V_7 -> V_11 , L_53 ,
