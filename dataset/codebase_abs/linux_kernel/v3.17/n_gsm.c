...
struct V_229 * V_90 )
{
struct V_232 * V_236 = (struct V_232 * ) F_144 ( V_90 ) ;
...
if ( ! V_8 -> V_90 )
return;
V_236 = (struct V_232 * ) F_144 ( V_8 -> V_90 ) ;
F_150 ( V_236 ) ;
}
...
static void F_199 ( struct V_280 * V_281 , struct V_94 * V_95 )
{
struct V_7 * V_8 = V_95 -> V_290 ;
struct V_47 * V_48 = V_8 -> V_48 ;
F_83 ( V_8 ) ;
F_83 ( V_48 -> V_8 [ 0 ] ) ;
F_106 ( V_48 ) ;
V_281 -> V_305 [ V_95 -> V_282 ] = NULL ;
}
static int T_7 F_200 ( void )
{
int V_306 = F_201 ( V_307 , & V_308 ) ;
if ( V_306 != 0 ) {
F_168 ( L_39 ,
V_306 ) ;
return V_306 ;
...
V_197 -> type = V_312 ;
V_197 -> V_313 = V_314 ;
V_197 -> V_71 = V_315 | V_316
| V_317 ;
V_197 -> V_318 = V_319 ;
V_197 -> V_318 . V_320 &= ~ V_321 ;
F_204 ( V_197 , & V_322 ) ;
F_69 ( & V_181 ) ;
if ( F_205 ( V_197 ) ) {
F_206 ( V_197 ) ;
...
F_8 ( L_43 ,
V_197 -> V_310 , V_197 -> V_311 ) ;
return 0 ;
}
static void T_8 F_207 ( void )
{
int V_306 = F_203 ( V_307 ) ;
if ( V_306 != 0 )
F_168 ( L_44 ,
V_306 ) ;
F_208 ( V_197 ) ;
