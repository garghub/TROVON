...
static void F_27 ( struct V_15 * V_38 ,
struct V_12 * V_13 )
{
F_28 ( & V_38 -> V_11 , & V_13 -> V_39 ) ;
}
static void F_29 ( struct V_10 * V_40 )
{
struct V_10 * V_41 , * V_42 ;
F_30 (list_ptr, tmp, head) {
struct V_15 * V_16 =
F_5 ( V_41 , struct V_15 , V_11 ) ;
F_31 ( V_41 ) ;
F_20 ( V_16 ) ;
}
}
static void F_23 ( struct V_10 * V_40 )
{
struct V_12 * V_16 ;
...
static struct V_15 * F_32 ( struct V_12 * V_43 ,
const char * V_17 )
{
struct V_10 * V_11 ;
...
static struct V_12 * F_33 ( struct V_26 * V_27 ,
const char * V_44 )
{
...
char * V_18 )
{
struct V_12 * V_13 = F_33 ( V_27 , V_44 ) ;
struct V_15 * V_46 = NULL ;
if ( V_13 )
V_46 = F_32 ( V_13 , V_45 ) ;
if ( V_46 ) {
memcpy ( V_18 , V_46 -> V_18 , V_47 ) ;
return 0 ;
}
return - 1 ;
}
...
struct V_4 * V_32 = V_27 -> V_32 ;
struct V_15 * V_50 ;
struct V_12 * V_51 = F_33 ( V_27 ,
V_48 ) ;
if ( ! V_51 )
return - V_37 ;
V_50 = F_15 ( sizeof( * V_50 ) , V_29 ) ;
if ( ! V_50 )
return - V_30 ;
F_16 ( & V_50 -> V_11 ) ;
F_36 ( V_50 -> V_17 , V_17 , sizeof( V_50 -> V_17 ) ) ;
if ( type == V_52 ) {
snprintf ( V_50 -> V_18 , V_47 ,
L_5 , ( * ( ( long * ) V_18 ) ) ) ;
} else if ( type == V_53 ) {
F_36 ( V_50 -> V_18 , ( char * ) V_18 , sizeof( V_50 -> V_18 ) ) ;
} else if ( type == V_54 ) {
snprintf ( V_50 -> V_18 , V_47 ,
...
int F_37 ( struct V_26 * V_27 , const char * V_14 )
{
struct V_4 * V_32 = V_27 -> V_32 ;
struct V_12 * V_13 = F_33 ( V_27 , V_14 ) ;
if ( V_13 )
return 0 ;
V_13 = F_15 ( sizeof( * V_13 ) , V_29 ) ;
if ( ! V_13 )
return - V_30 ;
F_36 ( V_13 -> V_14 , V_14 , sizeof( V_13 -> V_14 ) ) ;
F_16 ( & V_13 -> V_39 ) ;
F_22 ( & V_32 -> V_31 ) ;
F_28 ( & V_13 -> V_11 , & V_32 -> V_8 ) ;
F_24 ( & V_32 -> V_31 ) ;
return 0 ;
}
int F_38 ( struct V_26 * V_27 ,
const char * V_51 , const char * V_14 ,
char * V_55 )
{
struct V_4 * V_32 = V_27 -> V_32 ;
int V_21 ;
F_39 ( & V_32 -> V_31 ) ;
V_21 = F_34 ( V_27 , V_51 , V_14 , V_55 ) ;
F_40 ( & V_32 -> V_31 ) ;
return V_21 ;
}
