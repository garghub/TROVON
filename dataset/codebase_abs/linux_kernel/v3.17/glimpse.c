...
V_29 = 0 ;
if ( ! ( V_21 -> V_30 & V_31 ) ) {
F_10 ( V_32 , L_1 V_33 L_2 , F_11 ( V_23 ) ) ;
if ( V_21 -> V_34 ) {
* V_18 = V_35 ;
V_18 -> V_36 = V_15 ;
V_18 -> V_37 = V_38 ;
...
static int F_21 ( struct V_1 * V_1 , struct V_10 * * V_46 ,
struct V_12 * * V_47 , int * V_48 )
{
struct V_10 * V_11 ;
struct V_12 * V_13 ;
struct V_20 * V_21 = F_7 ( V_1 ) ;
struct V_14 * V_15 = V_21 -> V_49 ;
int V_29 ;
if ( F_22 ( F_23 ( V_1 ) ) ) {
V_11 = F_24 ( V_48 ) ;
if ( ! F_13 ( V_11 ) ) {
...
int V_29 ;
int V_48 ;
V_29 = F_21 ( V_1 , & V_11 , & V_13 , & V_48 ) ;
if ( V_29 > 0 ) {
V_51:
V_13 -> V_52 = 1 ;
V_29 = F_27 ( V_11 , V_13 , V_53 , V_13 -> V_50 ) ;
if ( V_29 > 0 )
V_29 = V_13 -> V_54 ;
else if ( V_29 == 0 )
V_29 = F_5 ( V_11 , V_13 , V_1 , V_13 -> V_50 ,
V_16 ) ;
F_28 ( V_55 , 2 ) ;
F_29 ( V_11 , V_13 ) ;
if ( F_30 ( V_13 -> V_56 ) )
...
* V_18 = V_35 ;
V_18 -> V_36 = V_15 ;
V_28 = F_33 ( V_11 , V_13 , V_18 , L_5 , V_44 ) ;
if ( V_28 != NULL ) {
F_17 ( V_11 , V_1 ) ;
F_19 ( V_11 , V_28 ) ;
F_20 ( V_11 , V_28 , L_5 , V_44 ) ;
V_29 = 0 ;
} else
V_29 = - V_59 ;
}
