...
int V_5 ;
V_35 = F_21 ( V_26 , ( T_4 ) ( sizeof( V_25 ) - 1 ) ) ;
...
{
V_2 -> V_39 = F_25 ( L_12 , NULL ) ;
if ( ! V_2 -> V_39 ) {
F_26 ( V_2 -> V_7 ,
L_13 ) ;
return;
}
V_2 -> V_40 = F_27 ( L_14 , 0644 ,
V_2 -> V_39 ,
V_2 , & V_41 ) ;
if ( ! V_2 -> V_40 )
F_26 ( V_2 -> V_7 ,
...
static int F_30 ( struct V_42 * V_13 ,
const struct V_43 * V_44 )
{
struct V_45 * V_46 = F_31 ( & V_13 -> V_7 ) ;
struct V_1 * V_2 ;
int V_47 , V_48 ;
int V_5 = 0 ;
V_2 = F_32 ( & V_13 -> V_7 , sizeof( struct V_1 ) ,
V_33 ) ;
if ( ! V_2 ) {
F_2 ( & V_13 -> V_7 ,
L_16 ) ;
...
F_12 ( V_2 ) ;
for ( V_47 = 0 ; V_47 < V_46 -> V_54 ; V_47 ++ ) {
for ( V_48 = 0 ; V_48 < F_37 ( V_55 ) ; V_48 ++ ) {
if ( ( V_46 -> V_56 [ V_47 ] . V_44 == V_55 [ V_48 ] . V_44 ) &&
! strcmp ( V_46 -> V_56 [ V_47 ] . V_57 ,
V_55 [ V_48 ] . V_57 ) ) {
V_55 [ V_48 ] . V_58 =
V_46 -> V_56 [ V_47 ] . V_58 ;
break;
...
V_5 = F_38 ( V_2 -> V_7 , 0 , V_55 ,
F_37 ( V_55 ) , NULL , 0 , NULL ) ;
if ( V_5 != 0 ) {
...
static int F_39 ( struct V_42 * V_13 )
{
...
static int F_42 ( struct V_60 * V_7 )
{
struct V_42 * V_13 = F_43 ( V_7 ) ;
struct V_1 * V_2 = F_40 ( V_13 ) ;
F_14 ( V_2 ) ;
return 0 ;
}
static int F_44 ( struct V_60 * V_7 )
{
struct V_42 * V_13 = F_43 ( V_7 ) ;
struct V_1 * V_2 = F_40 ( V_13 ) ;
