...
static T_8 F_27 ( struct V_11 * V_12 , const char T_9 * V_13 ,
T_10 V_14 , T_11 * V_15 )
{
struct V_16 * V_17 = V_12 -> V_18 ;
T_7 V_3 , V_19 , V_20 , V_21 ;
...
switch( V_20 ) {
case 4 :
V_2 = F_28 ( V_3 , ( T_7 T_9 * ) V_13 ) ;
break;
case 2 :
V_2 = F_28 ( V_3 , ( T_5 T_9 * ) V_13 ) ;
break;
default:
V_2 = F_28 ( V_3 , ( T_1 T_9 * ) V_13 ) ;
break;
}
if ( V_2 )
return - V_23 ;
...
{
struct V_16 * V_32 ;
V_32 = F_30 ( sizeof( * V_32 ) , V_33 ) ;
if ( ! V_32 )
return - V_34 ;
V_32 -> V_24 = type ;
F_31 ( V_30 , 0600 , V_29 , V_32 , & V_35 ) ;
return 0 ;
}
...
return - V_37 ;
V_36 = F_33 ( L_1 , V_38 ) ;
V_2 |= F_29 ( V_36 , L_2 , V_5 ) ;
V_2 |= F_29 ( V_36 , L_3 , V_39 ) ;
V_2 |= F_29 ( V_36 , L_4 , V_25 ) ;
return V_2 ;
}
void F_34 ( void )
{
