...
F_3 ( V_2 , L_11 ) ;
F_3 ( V_2 , L_12 , V_26 / 10 , V_26 % 10 ) ;
if ( V_8 > ( 4UL << ( 30 - V_31 ) ) )
F_3 ( V_2 , L_13 ,
( unsigned long ) F_9 ( V_25 >> 10 ) ,
( unsigned long ) F_9 ( V_8 >> 10 ) ) ;
else
F_3 ( V_2 , L_14 ,
( unsigned long ) F_9 ( V_25 ) ,
( unsigned long ) F_9 ( V_8 ) ) ;
...
F_3 ( V_2 , L_21 , V_30 ? L_22 : L_23 ) ;
if ( V_38 >= 1 ) {
unsigned long V_43 = F_10 ( V_5 ) ;
unsigned long V_44 ;
...
V_7 . V_11 == V_13 )
F_8 ( V_5 , V_2 , V_7 ) ;
if ( V_38 >= 1 && F_25 ( V_5 , V_96 ) ) {
F_26 ( V_2 , V_5 -> V_97 ) ;
F_26 ( V_2 , V_5 -> V_98 ) ;
F_27 ( V_5 ) ;
}
if ( V_38 >= 2 )
F_3 ( V_2 , L_34 , F_24 ( & V_5 -> V_99 ) ) ;
}
F_28 () ;
return 0 ;
}
static int F_29 ( struct V_100 * V_100 , struct V_101 * V_101 )
{
int V_102 ;
if ( F_30 ( V_103 ) ) {
V_102 = F_31 ( V_101 , F_12 , NULL ) ;
if ( V_102 )
F_32 ( V_103 ) ;
return V_102 ;
}
...
static int F_33 ( struct V_100 * V_100 , struct V_101 * V_101 )
{
F_32 ( V_103 ) ;
return F_34 ( V_100 , V_101 ) ;
}
