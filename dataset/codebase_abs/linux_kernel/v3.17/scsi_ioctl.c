...
F_35 ( V_95 ) ;
if ( V_97 -> V_100 > V_144 ) {
V_95 -> V_89 = F_36 ( V_97 -> V_100 , V_142 ) ;
if ( ! V_95 -> V_89 )
goto V_145;
}
V_107 = - V_101 ;
...
V_107 = F_37 ( - 1 , V_97 -> V_151 , V_97 -> V_147 ,
0 , NULL , & V_150 ) ;
if ( V_107 < 0 ) {
F_38 ( V_150 ) ;
goto V_146;
...
V_107 = 0 ;
if ( V_97 -> V_131 < V_148 ) {
V_97 -> V_147 = F_39 ( V_150 ,
V_97 -> V_147 ,
V_97 -> V_131 ) ;
V_148 = V_97 -> V_131 ;
}
V_107 = F_40 ( V_4 , V_95 , NULL , (struct V_152 * ) V_150 ,
V_97 -> V_147 ,
V_148 , V_142 ) ;
F_38 ( V_150 ) ;
} else if ( V_97 -> V_131 )
V_107 = F_41 ( V_4 , V_95 , NULL , V_97 -> V_151 , V_97 -> V_131 ,
V_142 ) ;
if ( V_107 )
goto V_146;
V_105 = V_95 -> V_105 ;
...
V_95 -> V_153 = 0 ;
V_126 = V_154 ;
F_42 ( V_4 , V_125 , V_95 , V_128 ) ;
V_97 -> V_155 = F_43 ( V_154 - V_126 ) ;
V_107 = F_25 ( V_95 , V_97 , V_105 ) ;
V_146:
if ( V_95 -> V_89 != V_95 -> V_156 )
F_38 ( V_95 -> V_89 ) ;
V_145:
F_44 ( V_95 ) ;
V_143:
...
int F_45 ( struct V_3 * V_4 , struct V_124 * V_157 , T_2 V_98 ,
struct V_158 T_1 * V_159 )
{
struct V_94 * V_95 ;
int V_7 ;
unsigned int V_160 , V_161 , V_162 , V_163 , V_164 ;
char * V_165 = NULL , V_123 [ V_129 ] ;
if ( ! V_159 )
return - V_12 ;
if ( F_8 ( V_160 , & V_159 -> V_166 ) )
return - V_101 ;
if ( F_8 ( V_161 , & V_159 -> V_167 ) )
return - V_101 ;
if ( V_160 > V_168 || V_161 > V_168 )
return - V_12 ;
if ( F_8 ( V_163 , V_159 -> V_169 ) )
return - V_101 ;
V_162 = F_46 ( V_160 , V_161 ) ;
if ( V_162 ) {
V_165 = F_36 ( V_162 , V_4 -> V_170 | V_171 | V_172 ) ;
if ( ! V_165 )
return - V_139 ;
}
V_95 = F_34 ( V_4 , V_160 ? V_140 : V_141 , V_173 ) ;
if ( ! V_95 ) {
V_7 = - V_139 ;
goto error;
}
...
V_7 = - V_101 ;
V_95 -> V_100 = V_164 ;
if ( F_23 ( V_95 -> V_89 , V_159 -> V_169 , V_164 ) )
goto error;
if ( V_160 && F_23 ( V_165 , V_159 -> V_169 + V_164 , V_160 ) )
goto error;
...
if ( V_162 && F_48 ( V_4 , V_95 , V_165 , V_162 , V_173 ) ) {
V_7 = V_183 << 24 ;
goto V_143;
}
memset ( V_123 , 0 , sizeof( V_123 ) ) ;
V_95 -> V_123 = V_123 ;
V_95 -> V_119 = 0 ;
F_42 ( V_4 , V_157 , V_95 , 0 ) ;
V_143:
V_7 = V_95 -> V_109 & 0xff ;
if ( V_7 ) {
if ( V_95 -> V_119 && V_95 -> V_123 ) {
V_162 = ( V_184 > V_95 -> V_119 ) ?
V_95 -> V_119 : V_184 ;
if ( F_30 ( V_159 -> V_169 , V_95 -> V_123 , V_162 ) )
V_7 = - V_101 ;
}
} else {
if ( F_30 ( V_159 -> V_169 , V_165 , V_161 ) )
V_7 = - V_101 ;
}
error:
F_38 ( V_165 ) ;
...
static int F_49 ( struct V_3 * V_4 , struct V_124 * V_125 ,
int V_89 , int V_169 )
{
struct V_94 * V_95 ;
int V_7 ;
V_95 = F_34 ( V_4 , V_140 , V_173 ) ;
F_35 ( V_95 ) ;
V_95 -> V_6 = V_103 ;
V_95 -> V_89 [ 0 ] = V_89 ;
V_95 -> V_89 [ 4 ] = V_169 ;
V_95 -> V_100 = 6 ;
V_7 = F_42 ( V_4 , V_125 , V_95 , 0 ) ;
F_44 ( V_95 ) ;
return V_7 ;
}
static inline int F_50 ( struct V_3 * V_4 ,
struct V_124 * V_125 , int V_169 )
{
return F_49 ( V_4 , V_125 , V_185 , V_169 ) ;
}
int F_51 ( struct V_3 * V_4 , struct V_124 * V_125 , T_2 V_98 ,
...
case V_210 :
F_52 ( V_211 L_1 , V_212 -> V_213 ) ;
V_7 = - V_12 ;
if ( ! V_186 )
break;
V_7 = F_45 ( V_4 , V_125 , V_98 , V_186 ) ;
break;
case V_214 :
V_7 = F_50 ( V_4 , V_125 , 0x03 ) ;
break;
case V_215 :
V_7 = F_50 ( V_4 , V_125 , 0x02 ) ;
break;
default:
V_7 = - V_216 ;
}
...
int F_53 ( struct V_217 * V_218 , unsigned int V_89 )
{
...
int F_55 ( struct V_217 * V_218 , T_2 V_98 ,
unsigned int V_89 , void T_1 * V_186 )
{
int V_107 ;
V_107 = F_53 ( V_218 , V_89 ) ;
if ( V_107 < 0 )
return V_107 ;
return F_51 ( V_218 -> V_125 -> V_224 , V_218 -> V_125 , V_98 , V_89 , V_186 ) ;
}
