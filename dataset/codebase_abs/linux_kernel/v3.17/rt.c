...
return;
if ( ! F_149 ( & V_22 -> V_60 -> V_99 , V_22 -> V_33 , NULL ) )
return;
F_140 ( V_22 , V_57 , 1 ) ;
F_77 ( V_22 ) ;
}
...
if ( F_41 ( V_22 , V_58 ) ) {
F_63 ( V_22 ) ;
if ( F_92 ( ( V_22 -> V_114 && V_22 -> V_114 -> V_115 ) ||
V_22 -> V_116 . V_117 ) )
return V_118 ;
}
if ( V_58 -> V_90 == & V_91 )
...
static void F_157 ( struct V_22 * V_22 , struct V_41 * V_57 )
{
F_105 ( V_22 ) ;
if ( F_64 ( & V_57 -> V_44 ) && V_57 -> V_65 > 1 )
F_57 ( V_22 , V_57 ) ;
}
static int F_158 ( struct V_22 * V_22 , struct V_41 * V_57 , int V_47 )
{
if ( ! F_159 ( V_22 , V_57 ) &&
F_160 ( V_47 , F_161 ( V_57 ) ) )
return 1 ;
return 0 ;
}
static struct V_41 * F_162 ( struct V_22 * V_22 , int V_47 )
{
struct V_119 * V_101 = & V_22 -> V_44 . V_37 ;
struct V_41 * V_57 ;
if ( ! F_54 ( V_22 ) )
return NULL ;
F_163 (p, head, pushable_tasks) {
if ( F_158 ( V_22 , V_57 , V_47 ) )
return V_57 ;
}
return NULL ;
}
static int F_146 ( struct V_41 * V_120 )
{
struct V_121 * V_122 ;
struct V_72 * V_123 = F_164 ( V_124 ) ;
int V_125 = F_165 () ;
int V_47 = F_166 ( V_120 ) ;
if ( F_92 ( ! V_123 ) )
return - 1 ;
if ( V_120 -> V_65 == 1 )
return - 1 ;
if ( ! F_149 ( & F_40 ( V_120 ) -> V_60 -> V_99 , V_120 , V_123 ) )
return - 1 ;
if ( F_160 ( V_47 , V_123 ) )
return V_47 ;
if ( ! F_160 ( V_125 , V_123 ) )
V_125 = - 1 ;
F_143 () ;
F_167 (cpu, sd) {
if ( V_122 -> V_104 & V_126 ) {
int V_127 ;
if ( V_125 != - 1 &&
F_160 ( V_125 , F_168 ( V_122 ) ) ) {
F_147 () ;
return V_125 ;
}
V_127 = F_169 ( V_123 ,
...
static struct V_22 * F_171 ( struct V_41 * V_120 , struct V_22 * V_22 )
{
struct V_22 * V_128 = NULL ;
int V_129 ;
int V_47 ;
...
if ( V_128 -> V_44 . V_32 . V_33 > V_120 -> V_59 )
break;
F_173 ( V_22 , V_128 ) ;
V_128 = NULL ;
}
...
static struct V_41 * F_174 ( struct V_22 * V_22 )
{
struct V_41 * V_57 ;
if ( ! F_54 ( V_22 ) )
return NULL ;
...
return 0 ;
V_133:
if ( F_92 ( V_131 == V_22 -> V_33 ) ) {
F_120 ( 1 ) ;
return 0 ;
}
if ( F_92 ( V_131 -> V_59 < V_22 -> V_33 -> V_59 ) ) {
F_77 ( V_22 ) ;
return 0 ;
}
F_176 ( V_131 ) ;
V_128 = F_171 ( V_131 , V_22 ) ;
if ( ! V_128 ) {
struct V_41 * V_120 ;
V_120 = F_174 ( V_22 ) ;
if ( F_166 ( V_131 ) == V_22 -> V_47 && V_120 == V_131 ) {
goto V_109;
}
if ( ! V_120 )
goto V_109;
...
{
int V_125 = V_67 -> V_47 , V_132 = 0 , V_47 ;
struct V_41 * V_57 ;
struct V_22 * V_134 ;
if ( F_103 ( ! F_42 ( V_67 ) ) )
return 0 ;
...
continue;
V_134 = F_34 ( V_47 ) ;
if ( V_134 -> V_44 . V_32 . V_34 >=
V_67 -> V_44 . V_32 . V_33 )
continue;
F_172 ( V_67 , V_134 ) ;
V_57 = F_162 ( V_134 , V_125 ) ;
if ( V_57 && ( V_57 -> V_59 < V_67 -> V_44 . V_32 . V_33 ) ) {
F_120 ( V_57 == V_134 -> V_33 ) ;
F_120 ( ! V_57 -> V_115 ) ;
if ( V_57 -> V_59 < V_134 -> V_33 -> V_59 )
goto V_135;
V_132 = 1 ;
F_178 ( V_134 , V_57 , 0 ) ;
F_179 ( V_57 , V_125 ) ;
...
static void F_184 ( struct V_22 * V_22 , struct V_41 * V_57 )
{
if ( ! F_159 ( V_22 , V_57 ) &&
! F_151 ( V_22 -> V_33 ) &&
F_54 ( V_22 ) &&
V_57 -> V_65 > 1 &&
( F_185 ( V_22 -> V_33 ) || F_145 ( V_22 -> V_33 ) ) &&
( V_22 -> V_33 -> V_65 < 2 ||
V_22 -> V_33 -> V_59 <= V_57 -> V_59 ) )
F_181 ( V_22 ) ;
}
static void F_186 ( struct V_41 * V_57 ,
const struct V_72 * V_136 )
{
struct V_22 * V_22 ;
int V_76 ;
F_95 ( ! F_145 ( V_57 ) ) ;
...
static void F_187 ( struct V_22 * V_22 )
{
if ( V_22 -> V_44 . V_36 )
F_44 ( V_22 ) ;
F_96 ( V_22 ) ;
...
F_48 ( V_22 ) ;
F_91 ( V_22 ) ;
F_116 ( & V_22 -> V_60 -> V_99 , V_22 -> V_47 , V_137 ) ;
}
static void F_189 ( struct V_22 * V_22 , struct V_41 * V_57 )
{
if ( ! V_57 -> V_115 || V_22 -> V_44 . V_70 )
return;
if ( F_63 ( V_22 ) )
F_77 ( V_22 ) ;
}
...
unsigned int V_25 ;
F_31 (i) {
F_191 ( & F_192 ( V_124 , V_25 ) ,
V_53 , F_39 ( V_25 ) ) ;
}
}
static void F_193 ( struct V_22 * V_22 , struct V_41 * V_57 )
{
int V_138 = 1 ;
if ( V_57 -> V_115 && V_22 -> V_33 != V_57 ) {
#ifdef V_31
if ( V_57 -> V_65 > 1 && V_22 -> V_44 . V_36 &&
F_175 ( V_22 ) && V_22 != F_40 ( V_57 ) )
V_138 = 0 ;
#endif
if ( V_138 && V_57 -> V_59 < V_22 -> V_33 -> V_59 )
F_77 ( V_22 ) ;
}
}
static void
F_194 ( struct V_22 * V_22 , struct V_41 * V_57 , int V_139 )
{
if ( ! V_57 -> V_115 )
return;
if ( V_22 -> V_33 == V_57 ) {
...
V_140 = F_196 ( V_57 , V_142 ) ;
V_141 = F_197 ( V_57 , V_142 ) ;
if ( V_140 != V_143 ) {
unsigned long V_34 ;
if ( V_57 -> V_44 . V_144 != V_145 ) {
V_57 -> V_44 . V_106 ++ ;
V_57 -> V_44 . V_144 = V_145 ;
}
V_34 = F_198 ( F_100 ( V_140 , V_141 ) , V_146 / V_147 ) ;
if ( V_57 -> V_44 . V_106 > V_34 )
V_57 -> V_148 . V_149 = V_57 -> V_92 . V_96 ;
}
}
static void F_199 ( struct V_22 * V_22 , struct V_41 * V_57 , int V_150 )
{
struct V_42 * V_43 = & V_57 -> V_44 ;
F_105 ( V_22 ) ;
F_195 ( V_22 , V_57 ) ;
...
static unsigned int F_202 ( struct V_22 * V_22 , struct V_41 * V_120 )
{
...
void F_203 ( struct V_155 * V_156 , int V_47 )
{
T_4 V_78 ;
struct V_21 * V_21 ;
F_143 () ;
F_93 (rt_rq, iter, cpu_rq(cpu))
F_204 ( V_156 , V_47 , V_21 ) ;
F_147 () ;
}
