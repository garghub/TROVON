...
{
int V_3 = 0 , V_63 = V_62 -> V_64 . V_63 ;
struct V_1 * V_2 = F_30 ( V_62 ) ;
if ( V_63 < V_65 ||
V_63 > V_62 -> V_64 . V_66 ) {
F_16 ( & V_62 -> V_32 , L_9 ,
V_65 , V_67 ) ;
...
static int F_31 ( struct V_68 * V_21 )
{
int V_3 = 0 ;
struct V_1 * V_2 = NULL ;
...
struct V_69 V_64 ;
V_2 = F_32 ( & V_21 -> V_32 , sizeof( struct V_1 ) , V_70 ) ;
if ( ! V_2 )
return - V_71 ;
V_21 -> V_72 = 9 ;
V_3 = F_33 ( V_21 ) ;
...
V_54 = F_37 ( & V_21 -> V_32 , L_14 , & V_21 -> V_32 , V_2 ,
& V_73 ) ;
if ( F_38 ( V_54 ) )
return F_39 ( V_54 ) ;
V_2 -> V_54 = V_54 ;
memset ( & V_64 , 0 , sizeof( struct V_69 ) ) ;
V_64 . type = V_74 ;
V_64 . V_66 = V_67 ;
V_62 = F_40 ( & V_21 -> V_32 , L_15 , & V_21 -> V_32 ,
V_2 , & V_75 , & V_64 ) ;
if ( F_38 ( V_62 ) )
return F_39 ( V_62 ) ;
V_62 -> V_64 . V_63 = V_67 ;
...
static int F_43 ( struct V_68 * V_21 )
{
struct V_1 * V_2 = F_44 ( V_21 ) ;
F_25 ( V_2 , V_60 ) ;
return 0 ;
}
static int F_45 ( struct V_77 * V_32 )
{
struct V_1 * V_2 = F_46 ( V_32 ) ;
F_47 ( V_32 , L_17 , V_2 -> V_50 ) ;
return F_25 ( V_2 , V_60 ) ;
}
static int F_48 ( struct V_77 * V_32 )
{
struct V_1 * V_2 = F_46 ( V_32 ) ;
V_2 -> V_50 = V_60 ;
return F_25 ( V_2 , V_59 ) ;
}
static void F_49 ( struct V_68 * V_21 )
{
struct V_1 * V_2 = F_44 ( V_21 ) ;
F_25 ( V_2 , V_60 ) ;
}
