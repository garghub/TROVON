...
V_31 = F_81 ( V_2 , 1 << V_130 , V_146 ) ;
if ( V_31 == - V_147 )
F_82 ( V_2 ) ;
if ( V_31 )
return V_31 ;
V_4 = F_83 ( V_10 , sizeof( * V_4 ) , V_148 ) ;
if ( ! V_4 )
return - V_149 ;
V_4 -> V_11 |= ( unsigned long ) V_127 . V_16 ;
if ( V_125 == V_150 &&
( V_2 -> V_151 == 0xa1 || V_2 -> V_151 == 0xa2 ) )
V_4 -> V_11 |= V_109 ;
if ( V_125 == V_152 && V_2 -> V_151 >= 0x40 )
V_4 -> V_11 &= ~ V_153 ;
if ( F_47 ( V_2 ) )
V_4 -> V_11 &= ~ V_154 ;
V_4 -> V_48 = F_84 ( V_2 ) [ V_130 ] ;
if ( F_56 ( V_2 ) )
V_4 -> V_11 |= V_155 ;
F_1 ( V_2 , V_4 ) ;
if ( V_4 -> V_156 & V_157 ) {
...
V_105 = F_86 ( F_87 ( V_4 -> V_156 ) , F_88 ( V_4 -> V_18 ) ) ;
V_115 = F_62 ( V_2 , V_105 , V_4 ) ;
if ( V_115 > 1 )
V_4 -> V_11 |= V_166 ;
V_14 = F_89 ( & V_2 -> V_10 , V_129 , V_105 ) ;
if ( ! V_14 )
return - V_149 ;
V_14 -> V_16 = V_4 ;
if ( ! ( V_4 -> V_156 & V_167 ) || V_168 )
V_14 -> V_11 |= V_169 ;
else
F_2 ( & V_2 -> V_10 , L_63 ) ;
if ( V_127 . V_11 & V_170 )
...
for ( V_104 = 0 ; V_104 < V_14 -> V_105 ; V_104 ++ ) {
struct V_28 * V_29 = V_14 -> V_75 [ V_104 ] ;
F_91 ( V_29 , V_130 , - 1 , L_64 ) ;
F_91 ( V_29 , V_130 ,
0x100 + V_29 -> V_171 * 0x80 , L_65 ) ;
if ( V_29 -> V_11 & V_170 )
V_29 -> V_172 = V_4 -> V_173 ;
if ( ! ( V_4 -> V_18 & ( 1 << V_104 ) ) )
V_29 -> V_76 = & V_174 ;
}
F_40 ( V_14 ) ;
F_59 ( V_14 ) ;
V_31 = F_34 ( V_2 , V_4 -> V_156 & V_175 ) ;
if ( V_31 )
return V_31 ;
V_31 = F_4 ( V_14 ) ;
if ( V_31 )
...
return F_93 ( V_14 , V_2 -> V_114 , V_176 , V_119 ,
& V_122 ) ;
}
