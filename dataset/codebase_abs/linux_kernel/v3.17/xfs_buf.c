...
struct V_174 * V_175 = V_2 -> V_14 -> V_89 ;
if ( F_147 ( & V_175 -> V_90 ) ) {
F_68 ( V_175 ,
L_6 ,
...
while ( V_179 < V_183 ) {
struct V_53 * V_53 ;
int V_149 , V_184 , V_185 ;
V_149 = ( V_179 + V_2 -> V_6 ) >> V_64 ;
V_184 = ( V_179 + V_2 -> V_6 ) & ~ V_63 ;
V_53 = V_2 -> V_50 [ V_149 ] ;
V_185 = F_44 ( T_4 , V_5 - V_184 ,
F_38 ( V_2 -> V_44 ) - V_179 ) ;
ASSERT ( ( V_185 + V_184 ) <= V_5 ) ;
switch ( V_182 ) {
case V_186 :
memset ( F_46 ( V_53 ) + V_184 , 0 , V_185 ) ;
break;
case V_187 :
memcpy ( V_181 , F_46 ( V_53 ) + V_184 , V_185 ) ;
break;
case V_188 :
memcpy ( F_46 ( V_53 ) + V_184 , V_181 , V_185 ) ;
}
V_179 += V_185 ;
V_181 += V_185 ;
}
...
void * V_193 )
{
struct V_1 * V_2 = F_116 ( V_191 , struct V_1 , V_16 ) ;
struct V_190 * V_194 = V_193 ;
if ( F_9 ( & V_2 -> V_17 ) > 1 ) {
F_159 ( V_2 , V_48 ) ;
return V_195 ;
}
...
F_163 ( V_194 ) ;
int V_197 = 0 ;
while ( F_164 ( & V_76 -> V_15 ) ) {
F_165 ( & V_76 -> V_15 , F_158 ,
& V_194 , V_198 ) ;
while ( ! F_33 ( & V_194 ) ) {
struct V_1 * V_2 ;
V_2 = F_166 ( & V_194 , struct V_1 , V_16 ) ;
F_167 ( & V_2 -> V_16 ) ;
if ( V_2 -> V_7 & V_141 ) {
F_53 ( V_76 -> V_89 ,
L_7
...
struct V_202 * V_203 )
{
struct V_25 * V_76 = F_116 ( V_201 ,
struct V_25 , V_204 ) ;
F_163 ( V_194 ) ;
unsigned long V_205 ;
unsigned long V_206 = V_203 -> V_206 ;
V_205 = F_172 ( & V_76 -> V_15 , V_203 -> V_207 , F_169 ,
& V_194 , & V_206 ) ;
while ( ! F_33 ( & V_194 ) ) {
struct V_1 * V_2 ;
V_2 = F_166 ( & V_194 , struct V_1 , V_16 ) ;
...
struct V_25 * V_76 = F_116 ( V_201 ,
struct V_25 , V_204 ) ;
return F_174 ( & V_76 -> V_15 , V_203 -> V_207 ) ;
}
void
F_175 (
struct V_174 * V_175 ,
...
V_76 -> V_87 = V_210 ;
V_76 -> V_88 = V_210 - 1 ;
if ( F_180 ( V_76 -> V_157 , V_210 ) ) {
char V_211 [ V_212 ] ;
F_181 ( V_76 -> V_157 , V_211 ) ;
F_68 ( V_76 -> V_89 ,
L_9 ,
V_210 , V_211 ) ;
return - V_213 ;
}
V_76 -> V_214 = F_182 ( V_76 -> V_157 ) ;
V_76 -> V_215 = F_182 ( V_76 -> V_157 ) - 1 ;
return 0 ;
}
STATIC int
F_183 (
...
{
T_13 * V_76 ;
V_76 = F_12 ( sizeof( * V_76 ) , V_218 | V_23 ) ;
V_76 -> V_89 = V_175 ;
V_76 -> V_219 = V_217 -> V_220 ;
V_76 -> V_157 = V_217 ;
V_76 -> V_111 = F_185 ( V_217 ) ;
if ( ! V_76 -> V_111 )
goto error;
if ( F_183 ( V_76 , V_217 ) )
goto error;
if ( F_186 ( & V_76 -> V_15 ) )
goto error;
V_76 -> V_204 . V_221 = F_173 ;
V_76 -> V_204 . V_222 = F_171 ;
V_76 -> V_204 . V_223 = V_224 ;
V_76 -> V_204 . V_29 = V_225 ;
F_187 ( & V_76 -> V_204 ) ;
return V_76 ;
error:
F_14 ( V_76 ) ;
...
struct V_190 * V_229 )
{
struct V_1 * V_230 = F_116 ( V_228 , struct V_1 , V_37 ) ;
struct V_1 * V_2 = F_116 ( V_229 , struct V_1 , V_37 ) ;
T_7 V_231 ;
V_231 = V_230 -> V_19 [ 0 ] . V_41 - V_2 -> V_19 [ 0 ] . V_41 ;
if ( V_231 < 0 )
return - 1 ;
if ( V_231 > 0 )
return 1 ;
...
F_196 ( & V_2 -> V_37 , V_233 ) ;
F_197 ( V_2 , V_48 ) ;
}
F_198 ( NULL , V_233 , F_192 ) ;
F_150 ( & V_164 ) ;
F_194 (bp, n, io_list, b_list) {
...
{
F_163 ( V_233 ) ;
return F_193 ( V_232 , & V_233 , false ) ;
}
int
F_200 (
struct V_190 * V_232 )
...
int error = 0 , V_236 ;
struct V_1 * V_2 ;
F_193 ( V_232 , & V_233 , true ) ;
while ( ! F_33 ( & V_233 ) ) {
V_2 = F_166 ( & V_233 , struct V_1 , V_37 ) ;
F_167 ( & V_2 -> V_37 ) ;
V_236 = F_73 ( V_2 ) ;
F_69 ( V_2 ) ;
if ( ! error )
