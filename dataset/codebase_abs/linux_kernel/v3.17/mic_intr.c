...
struct V_11 * V_12 = F_2 ( V_4 -> V_13 -> V_14 ,
struct V_11 , V_2 ) ;
V_55 = F_53 ( ( unsigned long ) V_68 ) ;
V_66 = F_54 ( ( unsigned long ) V_68 ) ;
if ( V_4 -> V_8 . V_36 > 1 ) {
...
int F_57 ( struct V_3 * V_4 , struct V_11 * V_12 )
{
int V_41 ;
V_41 = F_25 ( V_4 , V_12 ) ;
if ( ! V_41 )
...
void F_58 ( struct V_3 * V_4 , struct V_11 * V_12 )
{
int V_15 ;
V_4 -> V_72 -> V_77 ( V_4 ) ;
if ( V_4 -> V_8 . V_36 > 1 ) {
