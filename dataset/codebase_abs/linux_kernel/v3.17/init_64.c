...
struct V_96 * V_96 = V_95 -> V_97 +
F_93 ( V_93 , V_32 , V_52 , V_98 ) ;
unsigned long V_99 = V_32 >> V_63 ;
unsigned long V_100 = V_52 >> V_63 ;
int V_101 ;
F_94 ( V_32 , V_32 + V_52 ) ;
V_101 = F_95 ( V_93 , V_96 , V_99 , V_100 ) ;
F_96 ( V_101 ) ;
F_89 ( V_32 , V_52 ) ;
return V_101 ;
}
static void T_9 F_97 ( struct V_35 * V_35 , int V_102 )
{
unsigned long V_103 ;
...
F_102 ( ( unsigned long ) F_27 ( V_35 ) , V_102 ) ;
}
static void T_9 F_103 ( T_7 * V_107 , T_1 * V_7 )
{
T_7 * V_48 ;
int V_68 ;
...
static void T_9 F_105 ( T_1 * V_108 , T_2 * V_12 )
{
T_1 * V_7 ;
int V_68 ;
...
static bool T_9 F_107 ( T_2 * V_109 , T_3 * V_24 )
{
T_2 * V_12 ;
int V_68 ;
...
static void T_9
F_109 ( T_7 * V_107 , unsigned long V_3 , unsigned long V_4 ,
bool V_110 )
{
...
static void T_9
F_115 ( T_1 * V_108 , unsigned long V_3 , unsigned long V_4 ,
bool V_110 )
{
unsigned long V_11 , V_66 = 0 ;
T_7 * V_114 ;
...
static void T_9
F_118 ( T_2 * V_109 , unsigned long V_3 , unsigned long V_4 ,
bool V_110 )
{
unsigned long V_11 , V_66 = 0 ;
T_1 * V_115 ;
...
V_115 = ( T_1 * ) F_120 ( * V_12 ) ;
F_115 ( V_115 , V_3 , V_11 , V_110 ) ;
F_105 ( V_115 , V_12 ) ;
}
if ( V_110 )
F_67 ( V_80 , - V_66 ) ;
...
static void T_9
F_121 ( unsigned long V_32 , unsigned long V_4 , bool V_110 )
{
unsigned long V_11 ;
T_3 * V_24 ;
T_2 * V_12 ;
...
int T_6 F_125 ( T_10 V_32 , T_10 V_52 )
{
unsigned long V_99 = V_32 >> V_63 ;
unsigned long V_100 = V_52 >> V_63 ;
struct V_96 * V_96 ;
int V_101 ;
V_96 = F_126 ( F_127 ( V_99 ) ) ;
F_124 ( V_32 , V_32 + V_52 ) ;
V_101 = F_128 ( V_96 , V_99 , V_100 ) ;
F_96 ( V_101 ) ;
return V_101 ;
}
...
void F_138 ( void )
{
unsigned long V_32 = F_139 ( V_64 ) ;
unsigned long V_4 = F_139 ( V_119 ) ;
if ( ! V_120 )
return;
F_36 ( L_13 ,
V_32 , V_4 ) ;
F_140 ( V_32 , ( V_4 - V_32 ) >> V_63 ) ;
}
void F_141 ( void )
{
unsigned long V_32 = F_139 ( V_64 ) ;
...
#endif
F_147 ( L_18 ,
( unsigned long ) F_55 ( F_148 ( V_124 ) ) ,
( unsigned long ) F_55 ( F_148 ( V_121 ) ) ) ;
F_147 ( L_18 ,
( unsigned long ) F_55 ( F_148 ( V_125 ) ) ,
( unsigned long ) F_55 ( F_148 ( V_130 ) ) ) ;
}
...
F_173 ( V_155 , V_19 ( * V_24 ) , V_106 ) ;
V_12 = F_16 ( V_24 , V_3 ) ;
if ( F_41 ( * V_12 ) ) {
V_11 = ( V_3 + V_43 ) & V_44 ;
continue;
}
F_173 ( V_155 , V_10 ( * V_12 ) , V_106 ) ;
if ( ! V_154 ) {
V_11 = ( V_3 + V_43 ) & V_44 ;
V_7 = F_9 ( V_12 , V_3 ) ;
if ( F_44 ( * V_7 ) )
