...
{
struct V_24 * V_46 = V_45 -> V_47 ;
struct V_1 * V_2 = V_45 -> V_2 ;
unsigned long V_30 ;
int V_28 ;
F_16 ( & V_2 -> V_39 , V_30 ) ;
for ( V_28 = V_46 -> V_31 - 1 ; V_28 >= 0 ; -- V_28 ) {
if ( V_46 -> V_33 [ V_28 ] ) {
F_17 ( & V_2 -> V_39 ,
V_30 ) ;
return V_28 ;
...
if ( V_49 < 0 )
return;
F_29 ( V_45 -> V_2 -> V_19 -> V_20 , L_2 , V_49 ) ;
V_26 = ( V_45 -> V_47 -> V_26 + V_49 + 1 ) & ( V_36 - 1 ) ;
F_14 ( V_45 -> V_2 , V_45 -> V_47 ,
V_26 ) ;
}
static void
F_30 ( struct V_1 * V_2 , T_1 * V_41 ,
int V_40 , int V_31 , int V_49 )
{
int V_28 ;
...
if ( V_103 == V_107 )
V_49 = ( ( V_49 + V_31 ) - 1 ) & ( V_36 - 1 ) ;
if ( ( ( V_104 < V_26 ) &&
( V_49 < V_26 ) && ( V_49 > V_104 ) ) ||
( ( V_104 > V_26 ) && ( ( V_49 > V_104 ) ||
( V_49 < V_26 ) ) ) ) {
V_104 = V_49 ;
if ( ( ( V_49 - V_31 ) + 1 ) >= 0 )
V_26 = ( V_104 - V_31 ) + 1 ;
else
V_26 = ( V_36 - ( V_31 - V_49 ) ) + 1 ;
F_14 ( V_2 , V_25 , V_26 ) ;
}
if ( V_103 != V_107 ) {
if ( V_49 >= V_26 )
