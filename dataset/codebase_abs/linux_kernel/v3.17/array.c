...
static void F_48 ( struct V_1 * V_2 , struct V_3 * V_83 )
{
F_3 ( V_2 , L_29 ) ;
F_49 ( V_2 , & V_83 -> V_84 ) ;
F_4 ( V_2 , '\n' ) ;
...
int F_51 ( struct V_1 * V_2 , struct V_19 * V_20 ,
struct V_21 * V_21 , struct V_3 * V_83 )
{
struct V_85 * V_86 = F_52 ( V_83 ) ;
F_1 ( V_2 , V_83 ) ;
...
static int F_56 ( struct V_1 * V_2 , struct V_19 * V_20 ,
...
if ( V_116 -> V_117 ) {
struct V_21 * V_118 = F_61 ( V_116 -> V_117 ) ;
V_94 = F_21 ( V_118 , V_20 ) ;
F_62 ( V_118 ) ;
V_95 = F_63 ( F_64 ( V_116 -> V_117 ) ) ;
}
V_64 = F_37 ( V_83 ) ;
F_32 ( V_83 , & V_96 , & V_97 ) ;
V_102 = V_116 -> V_102 ;
...
V_107 = V_116 -> V_107 ;
V_110 = V_116 -> V_110 ;
V_112 = F_65 ( V_116 -> V_119 [ V_120 ] . V_121 ) ;
if ( V_87 ) {
...
int F_70 ( struct V_1 * V_2 , struct V_19 * V_20 ,
struct V_21 * V_21 , struct V_3 * V_83 )
{
return F_56 ( V_2 , V_20 , V_21 , V_83 , 1 ) ;
}
...
struct V_85 * V_86 = F_52 ( V_83 ) ;
if ( V_86 ) {
V_11 = F_72 ( V_86 , & V_124 , & V_125 , & V_126 , & V_123 ) ;
F_54 ( V_86 ) ;
}
F_73 ( V_2 , 0 , V_11 ) ;
F_73 ( V_2 , ' ' , V_123 ) ;
...
static struct V_21 *
F_74 ( struct V_127 * V_127 , struct V_21 * V_128 , T_5 V_129 )
{
struct V_3 * V_130 , * V_83 ;
struct V_21 * V_21 = NULL ;
F_75 ( & V_131 ) ;
V_130 = F_76 ( F_77 ( V_127 ) , V_132 ) ;
if ( ! V_130 )
goto V_133;
if ( V_128 ) {
V_83 = F_76 ( V_128 , V_132 ) ;
if ( V_83 && V_83 -> V_31 == V_130 &&
! ( F_78 ( & V_83 -> V_134 ) ) ) {
if ( F_79 ( & V_83 -> V_134 , & V_130 -> V_135 ) )
goto V_133;
V_83 = F_80 ( & V_83 -> V_134 ,
struct V_3 , V_134 ) ;
V_21 = F_81 ( F_82 ( V_83 ) ) ;
goto V_133;
}
}
F_83 (task, &start->children, sibling) {
if ( V_129 -- == 0 ) {
V_21 = F_81 ( F_82 ( V_83 ) ) ;
break;
}
...
static int F_85 ( struct V_1 * V_136 , void * V_137 )
{
...
static void * F_86 ( struct V_1 * V_136 , T_5 * V_129 )
{
return F_74 ( V_136 -> V_138 , NULL , * V_129 ) ;
}
static void * F_87 ( struct V_1 * V_136 , void * V_137 , T_5 * V_129 )
{
struct V_21 * V_21 ;
V_21 = F_74 ( V_136 -> V_138 , V_137 , * V_129 + 1 ) ;
F_62 ( V_137 ) ;
++ * V_129 ;
return V_21 ;
}
static void F_88 ( struct V_1 * V_136 , void * V_137 )
{
F_62 ( V_137 ) ;
}
static int F_89 ( struct V_127 * V_127 , struct V_141 * V_141 )
{
struct V_1 * V_2 ;
int V_142 ;
V_142 = F_90 ( V_141 , & V_143 ) ;
if ( V_142 )
return V_142 ;
V_2 = V_141 -> V_144 ;
V_2 -> V_138 = V_127 ;
...
int F_91 ( struct V_127 * V_127 , struct V_141 * V_141 )
{
F_92 ( V_127 , V_141 ) ;
return 0 ;
}
