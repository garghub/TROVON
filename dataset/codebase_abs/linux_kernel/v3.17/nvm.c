...
if ( V_2 -> V_36 -> V_38 -> V_56 != V_57 )
V_75 = V_76 ;
else if ( ( V_2 -> V_36 -> V_77 & 0xc ) == 0 )
V_75 = V_78 ;
else
V_75 = V_79 ;
V_26 = F_20 ( & V_69 , V_2 -> V_80 ,
V_2 -> V_36 -> V_37 ) ;
if ( V_26 ) {
F_5 ( V_2 , L_12 ,
V_2 -> V_80 , V_26 ) ;
...
for ( V_87 = 0 ; V_87 < F_26 ( V_2 -> V_50 ) ; V_87 ++ ) {
if ( ! V_2 -> V_50 [ V_87 ] . V_6 || ! V_2 -> V_50 [ V_87 ] . V_5 )
continue;
V_26 = F_9 ( V_2 , V_87 , V_49 [ V_87 ] . V_6 ,
V_49 [ V_87 ] . V_5 ) ;
if ( V_26 < 0 ) {
F_5 ( V_2 , L_22 , V_26 ) ;
break;
...
int F_27 ( struct V_1 * V_2 , bool V_88 )
{
int V_26 , V_3 ;
T_3 V_43 = 0 ;
T_2 * V_89 , * V_74 ;
if ( F_28 ( V_2 -> V_38 -> V_59 >= V_84 ) )
return - V_40 ;
if ( V_88 ) {
F_7 ( V_2 -> V_36 -> V_37 , L_23 ) ;
V_89 = F_29 ( V_2 -> V_38 -> V_44 -> V_45 ,
V_85 ) ;
if ( ! V_89 )
return - V_86 ;
for ( V_3 = 0 ; V_3 < V_84 ; V_3 ++ ) {
V_26 = F_11 ( V_2 , V_3 , V_89 ,
V_43 ) ;
if ( V_26 < 0 )
continue;
V_43 += V_26 ;
V_74 = F_23 ( V_89 , V_26 , V_85 ) ;
if ( ! V_74 ) {
V_26 = - V_86 ;
break;
}
