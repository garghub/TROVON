...
V_67 = F_38 ( V_8 ) ? V_72 : 0 ;
V_81 = ( 4 - ( ( ( void * ) V_8 -> V_35 - NULL ) & 0x3 ) ) % 4 ;
V_55 = sizeof( * V_80 ) + V_81 ;
F_39 ( F_19 ( V_8 ) < V_55 + V_83 ) ;
F_40 ( V_8 , V_55 ) ;
V_80 = (struct V_79 * ) V_8 -> V_35 ;
memset ( V_80 , 0 , sizeof( * V_80 ) ) ;
V_80 -> V_52 = V_2 -> V_52 ;
V_80 -> V_53 = V_2 -> V_53 ;
V_80 -> V_84 = F_41 ( ( T_1 ) ( V_8 -> V_55 - V_55 ) ) ;
V_80 -> V_74 = ( V_45 ) V_8 -> V_74 ;
V_80 -> V_85 = F_42 ( V_2 , V_8 ) ;
if ( V_80 -> V_74 < F_43 ( V_2 -> V_18 . V_86 ) )
V_80 -> V_87 =
F_44 ( V_2 -> V_18 . V_86 [ V_80 -> V_74 ] ) ;
if ( V_67 == V_72 ) {
V_80 -> V_88 = F_41 ( V_67 ) ;
V_55 += V_89 ;
}
