...
int F_198 ( struct V_161 * V_207 , void * V_208 )
{
struct V_209 * V_209 ;
struct V_4 * V_36 ;
char * V_91 , * V_37 ;
...
int V_92 ;
V_92 = - V_117 ;
V_91 = F_56 ( V_210 , V_42 ) ;
if ( ! V_91 )
goto V_49;
V_92 = - V_211 ;
V_209 = V_207 -> V_141 ;
V_36 = F_199 ( V_209 , V_212 ) ;
if ( ! V_36 )
goto V_213;
V_92 = - V_214 ;
F_42 () ;
V_3 = F_4 ( V_36 , V_6 ) ;
V_37 = F_200 ( V_3 -> V_52 , V_91 , V_210 ) ;
F_48 () ;
if ( ! V_37 )
goto V_215;
F_201 ( V_207 , V_37 ) ;
...
void F_204 ( struct V_161 * V_207 , struct V_4 * V_5 )
{
F_201 ( V_207 , L_9 ) ;
F_205 ( V_207 , & V_5 -> V_40 ) ;
F_201 ( V_207 , L_6 ) ;
F_201 ( V_207 , L_10 ) ;
F_206 ( V_207 , & V_5 -> V_40 ) ;
F_201 ( V_207 , L_6 ) ;
}
