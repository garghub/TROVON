...
static T_4 F_25 ( struct V_4 * V_5 ,
struct V_10 * V_11 , char * V_12 )
{
struct V_1 * V_6 = F_4 ( V_5 ) ;
...
static T_4 F_27 ( struct V_4 * V_5 ,
struct V_10 * V_11 , char * V_12 )
{
struct V_1 * V_6 = F_4 ( V_5 ) ;
struct V_36 * V_37 = & V_6 -> V_37 ;
...
int F_72 ( struct V_1 * V_6 , T_6 V_103 , T_5 V_96 , T_5 * V_104 ,
void * * V_105 , T_7 * V_106 )
{
* V_104 = 0 ;
* V_105 = NULL ;
if ( V_106 )
...
int F_73 ( struct V_1 * V_6 , T_6 V_103 , T_5 V_96 )
{
if ( ! V_6 -> V_107 )
return - V_58 ;
if ( V_103 < 0 || V_103 > V_6 -> V_23 || V_96 > V_6 -> V_23 - V_103 )
...
int F_75 ( struct V_1 * V_6 , T_6 V_103 , T_5 V_96 , T_5 * V_104 ,
T_8 * V_12 )
{
int V_111 ;
* V_104 = 0 ;
...
int F_77 ( struct V_1 * V_6 , T_6 V_114 , T_5 V_96 , T_5 * V_104 ,
const T_8 * V_12 )
{
* V_104 = 0 ;
...
int F_78 ( struct V_1 * V_6 , T_6 V_114 , T_5 V_96 , T_5 * V_104 ,
const T_8 * V_12 )
{
* V_104 = 0 ;
if ( ! V_6 -> V_116 )
...
int F_79 ( struct V_1 * V_6 , T_6 V_103 , struct V_117 * V_118 )
{
int V_111 ;
...
int F_80 ( struct V_1 * V_6 , T_5 V_96 , T_5 * V_104 ,
struct V_121 * V_12 )
{
if ( ! V_6 -> V_122 )
return - V_58 ;
...
int F_81 ( struct V_1 * V_6 , T_6 V_103 , T_5 V_96 ,
T_5 * V_104 , T_8 * V_12 )
{
* V_104 = 0 ;
if ( ! V_6 -> V_123 )
...
int F_82 ( struct V_1 * V_6 , T_5 V_96 , T_5 * V_104 ,
struct V_121 * V_12 )
{
if ( ! V_6 -> V_124 )
return - V_58 ;
...
int F_83 ( struct V_1 * V_6 , T_6 V_103 , T_5 V_96 ,
T_5 * V_104 , T_8 * V_12 )
{
* V_104 = 0 ;
if ( ! V_6 -> V_125 )
...
int F_84 ( struct V_1 * V_6 , T_6 V_114 , T_5 V_96 ,
T_5 * V_104 , T_8 * V_12 )
{
int V_67 ;
* V_104 = 0 ;
...
int F_85 ( struct V_1 * V_6 , T_6 V_103 , T_5 V_96 )
{
if ( ! V_6 -> V_128 )
return - V_58 ;
if ( ! V_96 )
...
int F_86 ( struct V_1 * V_6 , T_6 V_129 , T_9 V_96 )
{
if ( ! V_6 -> V_130 )
return - V_58 ;
...
int F_35 ( struct V_1 * V_6 , T_6 V_129 , T_9 V_96 )
{
if ( ! V_6 -> V_131 )
return - V_58 ;
if ( V_129 < 0 || V_129 > V_6 -> V_23 || V_96 > V_6 -> V_23 - V_129 )
...
int F_87 ( struct V_1 * V_6 , T_6 V_129 , T_9 V_96 )
{
if ( ! V_6 -> V_132 )
return - V_58 ;
if ( V_129 < 0 || V_129 > V_6 -> V_23 || V_96 > V_6 -> V_23 - V_129 )
...
int F_88 ( struct V_1 * V_6 , T_6 V_129 )
{
...
int F_89 ( struct V_1 * V_6 , T_6 V_129 )
{
if ( V_129 < 0 || V_129 > V_6 -> V_23 )
return - V_97 ;
if ( ! V_6 -> V_134 )
...
int F_90 ( struct V_1 * V_6 , T_6 V_129 )
{
if ( ! V_6 -> V_135 )
return - V_58 ;
if ( V_129 < 0 || V_129 > V_6 -> V_23 )
...
unsigned long V_33 , T_6 V_114 , T_5 * V_104 )
{
unsigned long V_2 ;
T_5 V_138 = 0 , V_139 ;
int V_67 = 0 ;
...
void * F_93 ( const struct V_1 * V_6 , T_5 * V_23 )
{
T_10 V_22 = V_143 | V_144 |
V_145 | V_146 ;
T_5 V_147 = F_94 ( T_5 , V_6 -> V_25 , V_21 ) ;
void * V_148 ;
* V_23 = F_95 ( T_5 , * V_23 , V_149 ) ;
while ( * V_23 > V_147 ) {
...
static int T_11 F_103 ( struct V_44 * V_155 , const char * V_30 )
{
int V_67 ;
V_67 = F_104 ( V_155 ) ;
if ( ! V_67 )
