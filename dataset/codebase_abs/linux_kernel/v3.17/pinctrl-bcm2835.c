...
unsigned V_8 , unsigned long * V_71 ,
unsigned V_86 )
{
struct V_1 * V_2 = F_50 ( V_55 ) ;
enum V_109 V_110 ;
...
T_1 V_112 , V_6 ;
int V_69 ;
for ( V_69 = 0 ; V_69 < V_86 ; V_69 ++ ) {
V_110 = F_72 ( V_71 [ V_69 ] ) ;
V_111 = F_73 ( V_71 [ V_69 ] ) ;
if ( V_110 != V_83 )
return - V_52 ;
V_112 = F_6 ( V_8 ) ;
V_6 = F_7 ( V_8 ) ;
...
struct V_119 V_120 ;
int V_94 , V_69 ;
F_76 ( F_46 ( V_60 ) != V_121 ) ;
F_76 ( F_46 ( V_56 ) != V_121 ) ;
V_2 = F_77 ( V_11 , sizeof( * V_2 ) , V_81 ) ;
if ( ! V_2 )
return - V_82 ;
F_78 ( V_116 , V_2 ) ;
V_2 -> V_11 = V_11 ;
V_94 = F_79 ( V_73 , 0 , & V_120 ) ;
if ( V_94 ) {
F_56 ( V_11 , L_18 ) ;
return V_94 ;
}
V_2 -> V_4 = F_80 ( V_11 , & V_120 ) ;
if ( F_81 ( V_2 -> V_4 ) )
return F_82 ( V_2 -> V_4 ) ;
V_2 -> V_16 = V_122 ;
V_2 -> V_16 . V_11 = V_11 ;
V_2 -> V_16 . V_118 = V_73 ;
V_2 -> V_23 = F_83 ( V_73 , V_121 ,
& V_123 , NULL ) ;
if ( ! V_2 -> V_23 ) {
F_56 ( V_11 , L_19 ) ;
return - V_82 ;
...
F_90 ( & V_2 -> V_50 [ V_69 ] ) ;
V_129 = strlen ( F_91 ( V_2 -> V_11 ) ) + 16 ;
V_85 = F_77 ( V_2 -> V_11 , V_129 , V_81 ) ;
if ( ! V_85 )
return - V_82 ;
snprintf ( V_85 , V_129 , L_20 , F_91 ( V_2 -> V_11 ) , V_69 ) ;
V_94 = F_92 ( V_11 , V_2 -> V_24 [ V_69 ] ,
F_28 , V_132 ,
V_85 , & V_2 -> V_47 [ V_69 ] ) ;
if ( V_94 ) {
...
F_96 ( V_2 -> V_133 , & V_2 -> V_135 ) ;
return 0 ;
}
static int F_97 ( struct V_115 * V_116 )
{
struct V_1 * V_2 = F_98 ( V_116 ) ;
F_99 ( V_2 -> V_133 ) ;
F_95 ( & V_2 -> V_16 ) ;
return 0 ;
}
