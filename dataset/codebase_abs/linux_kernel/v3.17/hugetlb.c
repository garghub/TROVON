...
if ( V_91 > F_31 ( V_41 ) )
V_91 = F_31 ( V_41 ) ;
F_45 ( ! F_151 ( V_96 , 1 << V_91 ) ) ;
for ( V_100 = V_96 ; V_100 < V_97 ; V_100 += 1 << V_91 )
F_148 ( F_88 ( V_100 ) ) ;
}
static struct V_65 * F_152 ( struct V_40 * V_41 , int V_66 )
{
struct V_65 * V_65 ;
unsigned int V_131 ;
if ( F_106 ( V_41 ) )
...
struct V_65 * F_155 ( struct V_40 * V_41 , int V_66 )
{
struct V_65 * V_65 = NULL ;
F_8 ( & V_117 ) ;
...
F_2 ( & V_117 ) ;
if ( ! V_65 )
V_65 = F_152 ( V_41 , V_66 ) ;
return V_65 ;
}
static int F_156 ( struct V_40 * V_41 , int V_9 )
{
struct V_21 V_134 ;
...
static long F_160 ( struct V_40 * V_41 ,
...
static void F_161 ( struct V_40 * V_41 ,
struct V_14 * V_15 , unsigned long V_142 )
{
struct V_17 * V_18 ;
T_1 V_143 ;
...
static struct V_65 * F_162 ( struct V_14 * V_15 ,
...
struct V_144 * V_145 ;
V_143 = F_124 ( V_41 ) ;
V_31 = F_160 ( V_41 , V_15 , V_142 ) ;
if ( V_31 < 0 )
return F_163 ( - V_11 ) ;
if ( V_31 || V_75 )
if ( F_10 ( V_2 , 1 ) )
return F_163 ( - V_146 ) ;
V_10 = F_164 ( V_143 , F_107 ( V_41 ) , & V_145 ) ;
if ( V_10 )
goto V_147;
F_8 ( & V_117 ) ;
...
F_165 ( V_143 , F_107 ( V_41 ) , V_145 , V_65 ) ;
F_2 ( & V_117 ) ;
F_119 ( V_65 , ( unsigned long ) V_2 ) ;
F_161 ( V_41 , V_15 , V_142 ) ;
return V_65 ;
V_148:
F_166 ( V_143 , F_107 ( V_41 ) , V_145 ) ;
V_147:
if ( V_31 || V_75 )
F_11 ( V_2 , 1 ) ;
return F_163 ( - V_146 ) ;
}
struct V_65 * F_167 ( struct V_14 * V_15 ,
unsigned long V_142 , int V_75 )
{
struct V_65 * V_65 = F_162 ( V_15 , V_142 , V_75 ) ;
if ( F_168 ( V_65 ) )
V_65 = NULL ;
return V_65 ;
}
int __weak F_169 ( struct V_40 * V_41 )
{
struct V_149 * V_150 ;
int V_104 , V_105 ;
...
return 0 ;
V_152:
F_9 ( ( unsigned long ) F_171 ( V_150 ) & ( F_115 ( V_41 ) - 1 ) ) ;
F_22 ( & V_150 -> V_153 , & V_154 ) ;
V_150 -> V_40 = V_41 ;
return 1 ;
}
static void T_4 F_172 ( struct V_65 * V_65 , int V_91 )
{
...
#endif
F_179 ( F_90 ( V_65 ) != 1 ) ;
F_172 ( V_65 , V_41 -> V_91 ) ;
F_179 ( F_89 ( V_65 ) ) ;
F_101 ( V_41 , V_65 , F_52 ( V_65 ) ) ;
if ( F_106 ( V_41 ) )
F_180 ( V_65 , 1 << V_41 -> V_91 ) ;
}
}
static void T_4 F_181 ( struct V_40 * V_41 )
{
unsigned long V_92 ;
...
static char * T_4 F_183 ( char * V_158 , unsigned long V_159 )
{
if ( V_159 >= ( 1UL << 30 ) )
...
char V_158 [ 32 ] ;
F_185 ( L_4 ,
F_183 ( V_158 , F_115 ( V_41 ) ) ,
V_41 -> V_69 ) ;
}
}
static void F_186 ( struct V_40 * V_41 , unsigned long V_3 ,
T_3 * V_87 )
{
int V_92 ;
if ( F_106 ( V_41 ) )
return;
F_187 (i, *nodes_allowed) {
...
static inline void F_186 ( struct V_40 * V_41 , unsigned long V_3 ,
T_3 * V_87 )
{
}
static int F_189 ( struct V_40 * V_41 , T_3 * V_87 ,
int V_9 )
{
int V_104 , V_105 ;
F_45 ( V_9 != - 1 && V_9 != 1 ) ;
...
static unsigned long F_190 ( struct V_40 * V_41 , unsigned long V_3 ,
T_3 * V_87 )
{
...
return V_41 -> V_157 ;
F_8 ( & V_117 ) ;
while ( V_41 -> V_119 && V_3 > F_191 ( V_41 ) ) {
if ( ! F_189 ( V_41 , V_87 , - 1 ) )
break;
}
while ( V_3 > F_191 ( V_41 ) ) {
F_2 ( & V_117 ) ;
if ( F_106 ( V_41 ) )
...
F_186 ( V_41 , V_161 , V_87 ) ;
while ( V_161 < F_191 ( V_41 ) ) {
...
return F_194 ( V_164 , V_165 ) ;
}
static T_5 F_195 ( struct V_163 * V_164 ,
struct V_169 * V_170 , char * V_158 )
{
struct V_40 * V_41 ;
unsigned long V_106 ;
int V_66 ;
V_41 = F_193 ( V_164 , & V_66 ) ;
if ( V_66 == V_133 )
V_106 = V_41 -> V_106 ;
else
...
V_87 = & V_140 [ V_141 ] ;
V_41 -> V_157 = F_190 ( V_41 , V_3 , V_87 ) ;
if ( V_87 != & V_140 [ V_141 ] )
F_199 ( V_87 ) ;
return V_172 ;
V_35:
...
int V_66 ;
int V_85 ;
V_85 = F_202 ( V_158 , 10 , & V_3 ) ;
if ( V_85 )
return V_85 ;
V_41 = F_193 ( V_164 , & V_66 ) ;
return F_196 ( V_171 , V_41 , V_66 , V_3 , V_172 ) ;
}
static T_5 F_203 ( struct V_163 * V_164 ,
struct V_169 * V_170 , char * V_158 )
{
return F_195 ( V_164 , V_170 , V_158 ) ;
}
static T_5 F_204 ( struct V_163 * V_164 ,
struct V_169 * V_170 , const char * V_158 , T_6 V_172 )
{
return F_201 ( false , V_164 , V_158 , V_172 ) ;
}
...
struct V_169 * V_170 , const char * V_158 , T_6 V_172 )
{
return F_201 ( true , V_164 , V_158 , V_172 ) ;
}
static T_5 F_207 ( struct V_163 * V_164 ,
struct V_169 * V_170 , char * V_158 )
{
struct V_40 * V_41 = F_193 ( V_164 , NULL ) ;
...
static int F_212 ( struct V_40 * V_41 , struct V_163 * V_176 ,
struct V_163 * * V_167 ,
struct V_177 * V_178 )
{
int V_179 ;
int V_180 = F_124 ( V_41 ) ;
V_167 [ V_180 ] = F_213 ( V_41 -> V_181 , V_176 ) ;
if ( ! V_167 [ V_180 ] )
return - V_11 ;
V_179 = F_214 ( V_167 [ V_180 ] , V_178 ) ;
if ( V_179 )
F_215 ( V_167 [ V_180 ] ) ;
return V_179 ;
}
static void T_4 F_216 ( void )
{
struct V_40 * V_41 ;
int V_85 ;
V_182 = F_213 ( L_6 , V_183 ) ;
if ( ! V_182 )
return;
F_114 (h) {
V_85 = F_212 ( V_41 , V_182 ,
V_167 , & V_178 ) ;
if ( V_85 )
F_217 ( L_7 , V_41 -> V_181 ) ;
}
}
...
static void F_219 ( struct V_105 * V_105 )
{
struct V_40 * V_41 ;
...
static void F_222 ( struct V_105 * V_105 )
{
struct V_40 * V_41 ;
struct V_185 * V_186 = & V_187 [ V_105 -> V_188 . V_189 ] ;
int V_85 ;
if ( V_186 -> V_182 )
return;
V_186 -> V_182 = F_213 ( L_6 ,
& V_105 -> V_188 . V_164 ) ;
if ( ! V_186 -> V_182 )
return;
F_114 (h) {
V_85 = F_212 ( V_41 , V_186 -> V_182 ,
V_186 -> V_167 ,
& V_191 ) ;
if ( V_85 ) {
F_217 ( L_8 ,
...
static void F_220 ( void ) { }
static void F_223 ( void ) { }
static void T_7 F_225 ( void )
{
struct V_40 * V_41 ;
F_220 () ;
F_114 (h) {
F_215 ( V_167 [ F_124 ( V_41 ) ] ) ;
}
F_215 ( V_182 ) ;
F_3 ( V_192 ) ;
}
static int T_4 F_226 ( void )
{
int V_92 ;
if ( ! F_150 () )
return 0 ;
...
{
V_193 = F_236 ( V_205 , & V_205 ) ;
return 1 ;
}
static unsigned int F_237 ( unsigned int * V_208 )
{
int V_105 ;
unsigned int V_209 = 0 ;
F_187 (node, cpuset_current_mems_allowed)
V_209 += V_208 [ V_105 ] ;
return V_209 ;
}
static int F_238 ( bool V_171 ,
...
V_10 = F_239 ( V_211 , V_212 , V_213 , V_214 , V_215 ) ;
if ( V_10 )
goto V_35;
if ( V_212 )
V_10 = F_196 ( V_171 , V_41 ,
V_133 , V_135 , * V_214 ) ;
V_35:
return V_10 ;
}
...
void T_8 * V_213 , T_6 * V_214 , T_9 * V_215 )
{
return F_238 ( false , V_211 , V_212 ,
V_213 , V_214 , V_215 ) ;
}
int F_241 ( struct V_210 * V_211 , int V_212 ,
void T_8 * V_213 , T_6 * V_214 , T_9 * V_215 )
{
return F_238 ( true , V_211 , V_212 ,
V_213 , V_214 , V_215 ) ;
}
...
static int F_248 ( struct V_40 * V_41 , long V_9 )
{
int V_10 = - V_11 ;
F_8 ( & V_117 ) ;
if ( V_9 > 0 ) {
...
F_252 ( & V_18 -> V_48 , F_41 ) ;
if ( V_221 ) {
F_248 ( V_41 , - V_221 ) ;
F_11 ( V_2 , V_221 ) ;
}
}
static int F_253 ( struct V_14 * V_15 , struct V_224 * V_225 )
{
F_218 () ;
return 0 ;
}
static T_10 F_254 ( struct V_14 * V_15 , struct V_65 * V_65 ,
int V_226 )
{
T_10 V_227 ;
if ( V_226 ) {
V_227 = F_255 ( F_256 ( F_257 ( V_65 ,
V_15 -> V_228 ) ) ) ;
} else {
V_227 = F_258 ( F_257 ( V_65 ,
V_15 -> V_228 ) ) ;
}
V_227 = F_259 ( V_227 ) ;
V_227 = F_260 ( V_227 ) ;
V_227 = F_261 ( V_227 , V_15 , V_65 , V_226 ) ;
return V_227 ;
}
...
{
T_10 V_227 ;
V_227 = F_255 ( F_256 ( F_263 ( V_229 ) ) ) ;
if ( F_264 ( V_15 , V_42 , V_229 , V_227 , 1 ) )
F_265 ( V_15 , V_42 , V_229 ) ;
}
static int F_266 ( T_10 V_230 )
{
T_11 V_231 ;
if ( F_267 ( V_230 ) || F_268 ( V_230 ) )
return 0 ;
V_231 = F_269 ( V_230 ) ;
if ( F_270 ( V_231 ) && F_271 ( V_231 ) )
return 1 ;
else
return 0 ;
}
static int F_272 ( T_10 V_230 )
{
T_11 V_231 ;
if ( F_267 ( V_230 ) || F_268 ( V_230 ) )
return 0 ;
V_231 = F_269 ( V_230 ) ;
if ( F_270 ( V_231 ) && F_273 ( V_231 ) )
return 1 ;
else
return 0 ;
}
int F_274 ( struct V_232 * V_233 , struct V_232 * V_234 ,
struct V_14 * V_15 )
{
...
V_241 = V_15 -> V_223 ;
if ( V_238 )
F_275 ( V_234 , V_240 , V_241 ) ;
for ( V_142 = V_15 -> V_43 ; V_142 < V_15 -> V_223 ; V_142 += V_239 ) {
T_12 * V_244 , * V_245 ;
V_235 = F_276 ( V_234 , V_142 ) ;
if ( ! V_235 )
continue;
V_236 = F_277 ( V_233 , V_142 , V_239 ) ;
if ( ! V_236 ) {
V_10 = - V_11 ;
break;
}
if ( V_236 == V_235 )
continue;
V_245 = F_278 ( V_41 , V_233 , V_236 ) ;
V_244 = F_279 ( V_41 , V_234 , V_235 ) ;
F_280 ( V_244 , V_246 ) ;
V_227 = F_263 ( V_235 ) ;
if ( F_267 ( V_227 ) ) {
;
} else if ( F_67 ( F_266 ( V_227 ) ||
F_272 ( V_227 ) ) ) {
T_11 V_247 = F_269 ( V_227 ) ;
if ( F_281 ( V_247 ) && V_238 ) {
F_282 ( & V_247 ) ;
V_227 = F_283 ( V_247 ) ;
F_284 ( V_234 , V_142 , V_235 , V_227 ) ;
}
F_284 ( V_233 , V_142 , V_236 , V_227 ) ;
} else {
if ( V_238 )
F_285 ( V_234 , V_142 , V_235 ) ;
V_227 = F_263 ( V_235 ) ;
V_237 = F_286 ( V_227 ) ;
F_287 ( V_237 ) ;
F_288 ( V_237 ) ;
...
if ( V_238 )
F_289 ( V_234 , V_240 , V_241 ) ;
return V_10 ;
}
void F_290 ( struct V_248 * V_249 , struct V_14 * V_15 ,
...
F_179 ( ! F_35 ( V_15 ) ) ;
F_9 ( V_222 & ~ F_291 ( V_41 ) ) ;
F_9 ( V_36 & ~ F_291 ( V_41 ) ) ;
F_292 ( V_249 , V_15 ) ;
F_275 ( V_252 , V_240 , V_241 ) ;
V_255:
for ( V_42 = V_222 ; V_42 < V_36 ; V_42 += V_239 ) {
V_229 = F_276 ( V_252 , V_42 ) ;
if ( ! V_229 )
continue;
V_254 = F_278 ( V_41 , V_252 , V_229 ) ;
if ( F_293 ( V_252 , & V_42 , V_229 ) )
goto V_256;
V_230 = F_263 ( V_229 ) ;
if ( F_267 ( V_230 ) )
goto V_256;
if ( F_67 ( F_272 ( V_230 ) ) ) {
F_294 ( V_252 , V_42 , V_229 ) ;
goto V_256;
}
V_65 = F_286 ( V_230 ) ;
if ( V_250 ) {
...
V_230 = F_295 ( V_252 , V_42 , V_229 ) ;
F_296 ( V_249 , V_229 , V_42 ) ;
if ( F_297 ( V_230 ) )
F_298 ( V_65 ) ;
F_299 ( V_65 ) ;
V_251 = ! F_300 ( V_249 , V_65 ) ;
if ( V_251 ) {
F_2 ( V_254 ) ;
break;
}
...
F_289 ( V_252 , V_240 , V_241 ) ;
F_302 ( V_249 , V_15 ) ;
}
void F_303 ( struct V_248 * V_249 ,
struct V_14 * V_15 , unsigned long V_222 ,
unsigned long V_36 , struct V_65 * V_250 )
{
F_290 ( V_249 , V_15 , V_222 , V_36 , V_250 ) ;
V_15 -> V_53 &= ~ V_54 ;
}
void F_304 ( struct V_14 * V_15 , unsigned long V_222 ,
unsigned long V_36 , struct V_65 * V_250 )
{
struct V_232 * V_252 ;
struct V_248 V_249 ;
V_252 = V_15 -> V_253 ;
F_305 ( & V_249 , V_252 , V_222 , V_36 ) ;
F_290 ( & V_249 , V_15 , V_222 , V_36 , V_250 ) ;
F_306 ( & V_249 , V_222 , V_36 ) ;
}
static void F_307 ( struct V_232 * V_252 , struct V_14 * V_15 ,
...
struct V_55 * V_56 ;
T_1 V_259 ;
V_42 = V_42 & F_291 ( V_41 ) ;
V_259 = ( ( V_42 - V_15 -> V_43 ) >> V_156 ) +
V_15 -> V_44 ;
V_56 = F_15 ( V_15 -> V_16 ) -> V_51 ;
F_308 ( & V_56 -> V_260 ) ;
F_309 (iter_vma, &mapping->i_mmap, pgoff, pgoff) {
if ( V_258 == V_15 )
continue;
if ( ! F_48 ( V_258 , V_64 ) )
F_304 ( V_258 , V_42 ,
...
static int F_311 ( struct V_232 * V_252 , struct V_14 * V_15 ,
...
V_262 = F_286 ( V_230 ) ;
V_265:
if ( F_120 ( V_262 ) == 1 && F_312 ( V_262 ) ) {
F_313 ( V_262 , V_15 , V_42 ) ;
F_262 ( V_15 , V_42 , V_229 ) ;
return 0 ;
}
if ( F_48 ( V_15 , V_64 ) &&
V_262 != V_261 )
...
F_314 ( V_262 ) ;
F_2 ( V_254 ) ;
V_263 = F_162 ( V_15 , V_42 , V_264 ) ;
if ( F_168 ( V_263 ) ) {
if ( V_264 ) {
F_315 ( V_262 ) ;
F_9 ( F_267 ( V_230 ) ) ;
F_307 ( V_252 , V_15 , V_262 , V_42 ) ;
F_9 ( F_267 ( V_230 ) ) ;
F_8 ( V_254 ) ;
V_229 = F_276 ( V_252 , V_42 & F_291 ( V_41 ) ) ;
if ( F_316 ( V_229 &&
F_317 ( F_263 ( V_229 ) , V_230 ) ) )
goto V_265;
return 0 ;
}
V_10 = ( F_318 ( V_263 ) == - V_11 ) ?
V_266 : V_267 ;
goto V_268;
}
if ( F_67 ( F_319 ( V_15 ) ) ) {
...
F_107 ( V_41 ) ) ;
F_321 ( V_263 ) ;
V_240 = V_42 & F_291 ( V_41 ) ;
V_241 = V_240 + F_115 ( V_41 ) ;
F_275 ( V_252 , V_240 , V_241 ) ;
F_8 ( V_254 ) ;
V_229 = F_276 ( V_252 , V_42 & F_291 ( V_41 ) ) ;
if ( F_316 ( V_229 && F_317 ( F_263 ( V_229 ) , V_230 ) ) ) {
F_122 ( V_263 ) ;
F_322 ( V_15 , V_42 , V_229 ) ;
F_284 ( V_252 , V_42 , V_229 ,
F_254 ( V_15 , V_263 , 1 ) ) ;
F_299 ( V_262 ) ;
...
F_288 ( V_65 ) ;
V_271 = F_254 ( V_15 , V_65 , ( ( V_15 -> V_53 & V_280 )
&& ( V_15 -> V_53 & V_242 ) ) ) ;
F_284 ( V_252 , V_42 , V_229 , V_271 ) ;
if ( ( V_61 & V_278 ) && ! ( V_15 -> V_53 & V_242 ) ) {
V_10 = F_311 ( V_252 , V_15 , V_42 , V_229 , V_271 , V_65 , V_254 ) ;
}
F_2 ( V_254 ) ;
F_336 ( V_65 ) ;
V_35:
...
V_282 = F_338 ( ( T_13 * ) & V_281 , sizeof( V_281 ) / sizeof( T_13 ) , 0 ) ;
...
return 0 ;
} else if ( F_67 ( F_272 ( V_227 ) ) )
return V_283 |
F_335 ( F_124 ( V_41 ) ) ;
}
V_229 = F_277 ( V_252 , V_42 , F_115 ( V_41 ) ) ;
if ( ! V_229 )
return V_266 ;
V_56 = V_15 -> V_16 -> V_57 ;
V_143 = F_29 ( V_41 , V_15 , V_42 ) ;
V_282 = F_337 ( V_41 , V_252 , V_15 , V_56 , V_143 , V_42 ) ;
F_308 ( & V_192 [ V_282 ] ) ;
V_227 = F_263 ( V_229 ) ;
if ( F_267 ( V_227 ) ) {
...
V_254 = F_279 ( V_41 , V_252 , V_229 ) ;
F_8 ( V_254 ) ;
if ( F_67 ( ! F_317 ( V_227 , F_263 ( V_229 ) ) ) )
goto V_285;
if ( V_61 & V_278 ) {
if ( ! F_341 ( V_227 ) ) {
V_10 = F_311 ( V_252 , V_15 , V_42 , V_229 , V_227 ,
V_261 , V_254 ) ;
goto V_285;
}
V_227 = F_256 ( V_227 ) ;
...
V_227 = F_259 ( V_227 ) ;
if ( F_264 ( V_15 , V_42 , V_229 , V_227 ,
V_61 & V_278 ) )
F_265 ( V_15 , V_42 , V_229 ) ;
V_285:
F_2 ( V_254 ) ;
...
int V_292 ;
struct V_65 * V_65 ;
V_230 = F_276 ( V_252 , V_290 & F_291 ( V_41 ) ) ;
if ( V_230 )
V_254 = F_278 ( V_41 , V_252 , V_230 ) ;
V_292 = ! V_230 || F_267 ( F_263 ( V_230 ) ) ;
if ( V_292 && ( V_61 & V_293 ) &&
! F_326 ( V_41 , V_15 , V_290 ) ) {
if ( V_230 )
F_2 ( V_254 ) ;
V_291 = 0 ;
break;
}
if ( V_292 || F_343 ( F_263 ( V_230 ) ) ||
( ( V_61 & V_294 ) &&
! F_341 ( F_263 ( V_230 ) ) ) ) {
int V_10 ;
if ( V_230 )
F_2 ( V_254 ) ;
V_10 = F_339 ( V_252 , V_15 , V_290 ,
( V_61 & V_294 ) ? V_278 : 0 ) ;
if ( ! ( V_10 & V_295 ) )
continue;
V_291 = 0 ;
...
V_289 = ( V_290 & ~ F_291 ( V_41 ) ) >> V_156 ;
V_65 = F_286 ( F_263 ( V_230 ) ) ;
V_296:
if ( V_286 ) {
V_286 [ V_92 ] = F_344 ( V_65 , V_289 ) ;
F_345 ( V_286 [ V_92 ] ) ;
}
if ( V_287 )
V_287 [ V_92 ] = V_15 ;
...
F_275 ( V_252 , V_222 , V_36 ) ;
F_308 ( & V_15 -> V_16 -> V_57 -> V_260 ) ;
...
if ( ! F_267 ( F_263 ( V_229 ) ) ) {
V_230 = F_295 ( V_252 , V_42 , V_229 ) ;
V_230 = F_260 ( F_348 ( V_230 , V_298 ) ) ;
V_230 = F_261 ( V_230 , V_15 , NULL , 0 ) ;
F_284 ( V_252 , V_42 , V_229 , V_230 ) ;
V_286 ++ ;
}
F_2 ( V_254 ) ;
}
F_349 ( V_15 , V_222 , V_36 ) ;
F_310 ( & V_15 -> V_16 -> V_57 -> V_260 ) ;
F_289 ( V_252 , V_222 , V_36 ) ;
...
F_252 ( & V_17 -> V_48 , F_41 ) ;
return V_10 ;
}
void F_352 ( struct V_12 * V_12 , long V_300 , long V_301 )
{
struct V_40 * V_41 = F_351 ( V_12 ) ;
...
F_8 ( & V_12 -> V_274 ) ;
V_12 -> V_275 -= ( F_332 ( V_41 ) * V_301 ) ;
F_2 ( & V_12 -> V_274 ) ;
F_11 ( V_2 , ( V_31 - V_301 ) ) ;
F_248 ( V_41 , - ( V_31 - V_301 ) ) ;
}
static unsigned long F_353 ( struct V_14 * V_302 ,
struct V_14 * V_15 ,
...
T_10 * F_356 ( struct V_232 * V_252 , unsigned long V_142 , T_16 * V_311 )
{
...
T_12 * V_254 ;
if ( ! F_355 ( V_15 , V_142 ) )
return ( T_10 * ) F_358 ( V_252 , V_311 , V_142 ) ;
F_308 ( & V_56 -> V_260 ) ;
F_309 (svma, &mapping->i_mmap, idx, idx) {
if ( V_302 == V_15 )
continue;
V_303 = F_353 ( V_302 , V_15 , V_142 , V_143 ) ;
if ( V_303 ) {
V_312 = F_276 ( V_302 -> V_253 , V_303 ) ;
if ( V_312 ) {
F_287 ( F_178 ( V_312 ) ) ;
break;
}
...
if ( ! V_312 )
goto V_35;
V_254 = F_279 ( F_33 ( V_15 ) , V_252 , V_312 ) ;
F_8 ( V_254 ) ;
if ( F_359 ( * V_311 ) )
F_360 ( V_252 , V_311 ,
...
F_2 ( V_254 ) ;
V_35:
V_230 = ( T_10 * ) F_358 ( V_252 , V_311 , V_142 ) ;
F_310 ( & V_56 -> V_260 ) ;
return V_230 ;
}
int F_293 ( struct V_232 * V_252 , unsigned long * V_142 , T_10 * V_229 )
{
T_17 * V_315 = F_361 ( V_252 , * V_142 ) ;
T_16 * V_311 = F_362 ( V_315 , * V_142 ) ;
F_9 ( F_90 ( F_178 ( V_229 ) ) == 0 ) ;
if ( F_90 ( F_178 ( V_229 ) ) == 1 )
return 0 ;
F_363 ( V_311 ) ;
F_127 ( F_178 ( V_229 ) ) ;
* V_142 = F_97 ( * V_142 , V_194 * V_316 ) - V_194 ;
return 1 ;
}
T_10 * F_356 ( struct V_232 * V_252 , unsigned long V_142 , T_16 * V_311 )
{
...
T_10 * F_277 ( struct V_232 * V_252 ,
unsigned long V_142 , unsigned long V_239 )
{
T_17 * V_315 ;
T_16 * V_311 ;
T_10 * V_230 = NULL ;
V_315 = F_361 ( V_252 , V_142 ) ;
V_311 = F_364 ( V_252 , V_315 , V_142 ) ;
if ( V_311 ) {
if ( V_239 == V_307 ) {
V_230 = ( T_10 * ) V_311 ;
} else {
F_9 ( V_239 != V_317 ) ;
if ( F_365 () && F_359 ( * V_311 ) )
V_230 = F_356 ( V_252 , V_142 , V_311 ) ;
else
V_230 = ( T_10 * ) F_358 ( V_252 , V_311 , V_142 ) ;
}
}
...
T_10 * F_276 ( struct V_232 * V_252 , unsigned long V_142 )
{
T_17 * V_315 ;
T_16 * V_311 ;
V_313 * V_318 = NULL ;
V_315 = F_361 ( V_252 , V_142 ) ;
if ( F_368 ( * V_315 ) ) {
V_311 = F_362 ( V_315 , V_142 ) ;
if ( F_369 ( * V_311 ) ) {
if ( F_370 ( * V_311 ) )
return ( T_10 * ) V_311 ;
V_318 = F_371 ( V_311 , V_142 ) ;
}
}
return ( T_10 * ) V_318 ;
}
...
static int F_374 ( struct V_65 * V_320 )
{
struct V_65 * V_65 ;
struct V_65 * V_135 ;
struct V_40 * V_41 = F_117 ( V_320 ) ;
int V_66 = F_52 ( V_320 ) ;
