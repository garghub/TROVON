...
static int F_22 ( struct V_14 * V_14 , char * V_20 ,
unsigned long long V_3 )
{
char * V_2 ;
V_2 = malloc ( V_3 ) ;
...
T_2 F_26 ( int V_1 , struct V_25 * V_26 , bool V_27 )
{
char V_2 [ V_13 ] ;
char V_28 [] = { 23 , 8 , 68 } ;
char * V_29 ;
