...
int V_3 ;
for ( V_3 = 0 ; V_3 < V_48 ; V_3 ++ ) {
V_198 . V_44 = V_49 [ V_3 ] . V_50 . V_44 ;
V_198 . V_199 = V_49 [ V_3 ] . V_50 . V_200 ;
F_83 ( V_8 , & V_198 ) ;
}
}
static int F_85 ( struct V_159 * V_159 , void * V_201 ,
struct V_202 * V_203 )
{
struct V_52 * V_53 = V_201 ;
V_203 -> V_117 . V_204 . V_115 = V_53 -> V_115 ;
V_203 -> V_117 . V_204 . V_116 = V_53 -> V_116 ;
V_203 -> V_117 . V_204 . V_126 = V_53 -> V_148 . V_126 ;
V_203 -> V_117 . V_204 . V_205 = V_53 -> V_117 -> V_2 ;
V_203 -> V_117 . V_204 . V_206 =
( V_203 -> V_117 . V_204 . V_115 * V_53 -> V_117 -> V_122 ) >> 3 ;
V_203 -> V_117 . V_204 . V_207 =
V_203 -> V_117 . V_204 . V_116 * V_203 -> V_117 . V_204 . V_206 ;
return 0 ;
}
static int F_86 ( struct V_159 * V_159 , void * V_201 ,
struct V_202 * V_203 )
{
struct V_7 * V_8 = ( (struct V_52 * ) V_201 ) -> V_8 ;
struct V_1 * V_117 ;
enum V_125 V_126 ;
unsigned int V_208 , V_209 ;
V_117 = F_1 ( V_203 -> V_117 . V_204 . V_205 ) ;
if ( NULL == V_117 )
return - V_47 ;
V_126 = V_203 -> V_117 . V_204 . V_126 ;
V_208 = F_51 ( V_8 -> V_28 ) ;
V_209 = F_52 ( V_8 -> V_28 ) ;
if ( V_210 == V_126 ) {
V_126 = ( V_203 -> V_117 . V_204 . V_116 > V_209 / 2 )
? V_141
: V_140 ;
}
switch ( V_126 ) {
...
V_203 -> V_117 . V_204 . V_126 = V_126 ;
F_87 ( & V_203 -> V_117 . V_204 . V_115 , 48 , V_208 , 2 ,
& V_203 -> V_117 . V_204 . V_116 , 32 , V_209 , 0 , 0 ) ;
V_203 -> V_117 . V_204 . V_206 =
( V_203 -> V_117 . V_204 . V_115 * V_117 -> V_122 ) >> 3 ;
V_203 -> V_117 . V_204 . V_207 =
V_203 -> V_117 . V_204 . V_116 * V_203 -> V_117 . V_204 . V_206 ;
return 0 ;
}
static int F_88 ( struct V_159 * V_159 , void * V_201 ,
struct V_202 * V_203 )
{
struct V_52 * V_53 = V_201 ;
struct V_7 * V_8 = ( (struct V_52 * ) V_201 ) -> V_8 ;
...
int V_213 ;
F_8 ( 2 , L_5 , V_6 ) ;
V_213 = F_86 ( V_159 , V_201 , V_203 ) ;
if ( 0 != V_213 )
return V_213 ;
V_53 -> V_117 = F_1 ( V_203 -> V_117 . V_204 . V_205 ) ;
V_53 -> V_115 = V_203 -> V_117 . V_204 . V_115 ;
V_53 -> V_116 = V_203 -> V_117 . V_204 . V_116 ;
V_53 -> V_148 . V_126 = V_203 -> V_117 . V_204 . V_126 ;
F_8 ( 2 , L_29 , V_6 ,
V_53 -> V_115 , V_53 -> V_116 , V_53 -> V_148 . V_126 ) ;
F_89 ( & V_212 , & V_203 -> V_117 . V_204 , V_214 ) ;
F_15 ( V_8 , V_29 , V_215 , & V_212 ) ;
F_90 ( & V_203 -> V_117 . V_204 , & V_212 ) ;
return 0 ;
}
static int F_91 ( struct V_159 * V_159 , void * V_201 ,
struct V_216 * V_217 )
{
struct V_7 * V_8 = ( (struct V_52 * ) V_201 ) -> V_8 ;
strcpy ( V_217 -> V_218 , L_30 ) ;
F_92 ( V_217 -> V_219 , V_40 [ V_8 -> V_41 ] . V_39 ,
sizeof( V_217 -> V_219 ) ) ;
sprintf ( V_217 -> V_220 , L_31 , F_93 ( V_8 -> V_33 ) ) ;
V_217 -> V_221 =
V_222 |
V_223 |
V_224 |
...
static int F_94 ( struct V_159 * V_159 , void * V_201 ,
struct V_229 * V_203 )
{
if ( F_95 ( V_203 -> V_230 >= F_2 ( V_4 ) ) )
return - V_47 ;
F_92 ( V_203 -> V_231 , V_4 [ V_203 -> V_230 ] . V_39 ,
sizeof( V_203 -> V_231 ) ) ;
V_203 -> V_205 = V_4 [ V_203 -> V_230 ] . V_2 ;
return 0 ;
}
static int F_96 ( struct V_159 * V_159 , void * V_201 ,
struct V_232 * V_233 )
{
struct V_52 * V_53 = V_201 ;
return F_97 ( F_60 ( V_53 ) , V_233 ) ;
}
static int F_98 ( struct V_159 * V_159 , void * V_201 ,
struct V_234 * V_233 )
{
struct V_52 * V_53 = V_201 ;
return F_99 ( F_60 ( V_53 ) , V_233 ) ;
}
static int F_100 ( struct V_159 * V_159 , void * V_201 ,
struct V_234 * V_233 )
{
struct V_52 * V_53 = V_201 ;
return F_101 ( F_60 ( V_53 ) , V_233 ) ;
}
static int F_102 ( struct V_159 * V_159 , void * V_201 ,
struct V_234 * V_233 )
{
struct V_52 * V_53 = V_201 ;
return F_103 ( F_60 ( V_53 ) , V_233 ,
V_159 -> V_177 & V_178 ) ;
}
static int F_104 ( struct V_159 * V_159 , void * V_201 ,
enum V_161 V_3 )
{
struct V_52 * V_53 = V_201 ;
struct V_7 * V_8 = V_53 -> V_8 ;
...
static int F_107 ( struct V_159 * V_159 , void * V_201 , enum V_161 V_3 )
{
struct V_52 * V_53 = V_201 ;
struct V_7 * V_8 = V_53 -> V_8 ;
int V_213 , V_235 ;
...
return - V_47 ;
V_235 = F_61 ( V_53 ) ;
V_213 = F_77 ( F_60 ( V_53 ) ) ;
if ( V_213 < 0 )
return V_213 ;
F_25 ( V_8 , V_53 , V_235 ) ;
return 0 ;
}
static int F_108 ( struct V_159 * V_159 , void * V_201 , T_2 * V_44 )
{
struct V_7 * V_8 = ( (struct V_52 * ) V_201 ) -> V_8 ;
F_8 ( 1 , L_5 , V_6 ) ;
* V_44 = V_8 -> V_28 ;
...
static int F_109 ( struct V_159 * V_159 , void * V_201 , T_2 V_236 )
{
struct V_7 * V_8 = ( (struct V_52 * ) V_201 ) -> V_8 ;
F_8 ( 1 , L_5 , V_6 ) ;
F_21 ( & V_8 -> V_56 ) ;
...
int F_110 ( struct V_7 * V_8 , struct V_237 * V_3 )
{
...
if ( V_248 >= V_249 )
return - V_47 ;
if ( 0 == F_33 ( V_248 ) -> type )
return - V_47 ;
V_3 -> V_230 = V_248 ;
V_3 -> type = V_250 ;
strcpy ( V_3 -> V_39 , V_238 [ F_33 ( V_248 ) -> type ] ) ;
if ( ( V_85 == F_33 ( V_248 ) -> type ) ||
( V_245 == F_33 ( V_248 ) -> type ) ) {
V_3 -> type = V_251 ;
V_3 -> V_252 = V_253 ;
}
if ( F_33 ( V_248 ) -> type != V_85 )
V_3 -> V_254 = 0x3 ;
if ( V_8 -> V_71 == V_248 ) {
F_15 ( V_8 , V_29 , V_255 , & V_3 -> V_256 ) ;
}
return 0 ;
}
static int F_111 ( struct V_159 * V_159 , void * V_201 ,
struct V_237 * V_3 )
{
struct V_7 * V_8 = ( (struct V_52 * ) V_201 ) -> V_8 ;
F_8 ( 1 , L_5 , V_6 ) ;
...
int F_112 ( struct V_159 * V_159 , void * V_201 , unsigned int * V_3 )
{
struct V_7 * V_8 = ( (struct V_52 * ) V_201 ) -> V_8 ;
* V_3 = V_8 -> V_71 ;
F_8 ( 1 , L_42 , V_6 , * V_3 ) ;
...
static int F_113 ( struct V_159 * V_159 , void * V_201 , unsigned int * V_3 )
{
return F_112 ( V_159 , V_201 , V_3 ) ;
}
int F_114 ( struct V_159 * V_159 , void * V_201 , unsigned int V_3 )
{
struct V_7 * V_8 = ( (struct V_52 * ) V_201 ) -> V_8 ;
F_8 ( 1 , L_43 , V_6 , V_3 ) ;
if ( V_3 >= V_249 ) {
...
static int F_115 ( struct V_159 * V_159 , void * V_201 , unsigned int V_3 )
{
return F_114 ( V_159 , V_201 , V_3 ) ;
}
static int F_116 ( struct V_159 * V_159 , void * V_201 )
{
struct V_52 * V_53 = V_201 ;
struct V_7 * V_8 = V_53 -> V_8 ;
F_3 ( V_257
L_45 ,
V_8 -> V_39 ) ;
F_15 ( V_8 , V_195 , V_258 ) ;
F_3 ( V_257
L_46 ,
V_8 -> V_39 ) ;
return 0 ;
}
static int F_117 ( struct V_159 * V_159 , void * V_201 ,
struct V_259 * V_3 )
{
struct V_7 * V_8 = ( (struct V_52 * ) V_201 ) -> V_8 ;
static const char * V_238 [] = {
...
V_3 -> V_230 = V_248 ;
strcpy ( V_3 -> V_39 , V_238 [ V_248 ] ) ;
V_3 -> V_260 = V_261 ;
V_3 -> V_262 = V_263 ;
return 0 ;
}
static int F_118 ( struct V_159 * V_159 , void * V_201 ,
struct V_259 * V_3 )
{
return F_117 ( V_159 , V_201 , V_3 ) ;
}
static int F_119 ( struct V_159 * V_159 , void * V_201 ,
struct V_259 * V_3 )
{
struct V_7 * V_8 = ( (struct V_52 * ) V_201 ) -> V_8 ;
V_3 -> V_230 = V_8 -> V_264 ;
F_8 ( 1 , L_14 , V_6 , V_3 -> V_230 ) ;
return F_117 ( V_159 , V_201 , V_3 ) ;
}
static int F_120 ( struct V_159 * V_159 , void * V_201 ,
const struct V_259 * V_3 )
{
struct V_7 * V_8 = ( (struct V_52 * ) V_201 ) -> V_8 ;
if ( V_3 -> V_230 >= 2 )
return - V_47 ;
F_8 ( 1 , L_43 , V_6 , V_3 -> V_230 ) ;
V_8 -> V_264 = V_3 -> V_230 ;
F_31 ( V_8 , V_8 -> V_264 + 1 ) ;
return 0 ;
}
static int F_121 ( struct V_159 * V_159 , void * V_201 ,
struct V_42 * V_43 )
{
V_43 -> V_44 = F_122 ( V_265 , V_43 -> V_44 ) ;
if ( F_95 ( V_43 -> V_44 == 0 ) )
return - V_47 ;
return F_19 ( V_43 ) ;
}
static int F_123 ( struct V_159 * V_159 , void * V_201 ,
struct V_193 * V_194 )
{
struct V_7 * V_8 = ( (struct V_52 * ) V_201 ) -> V_8 ;
return F_82 ( V_8 , V_194 ) ;
}
static int F_124 ( struct V_159 * V_159 , void * V_201 ,
struct V_193 * V_194 )
{
struct V_7 * V_8 = ( (struct V_52 * ) V_201 ) -> V_8 ;
return F_83 ( V_8 , V_194 ) ;
}
static int F_125 ( struct V_159 * V_159 , void * V_201 ,
struct V_266 * V_267 )
{
struct V_7 * V_8 = ( (struct V_52 * ) V_201 ) -> V_8 ;
if ( V_8 -> V_226 == V_227 )
...
if ( 0 != V_267 -> V_230 )
return - V_47 ;
strcpy ( V_267 -> V_39 , L_38 ) ;
F_15 ( V_8 , V_268 , V_269 , V_267 ) ;
return 0 ;
}
static int F_126 ( struct V_159 * V_159 , void * V_201 ,
...
if ( 0 != V_267 -> V_230 )
return - V_47 ;
F_15 ( V_8 , V_268 , V_270 , V_267 ) ;
return 0 ;
}
static int F_127 ( struct V_159 * V_159 , void * V_201 ,
struct V_271 * V_203 )
{
struct V_52 * V_53 = V_201 ;
struct V_7 * V_8 = V_53 -> V_8 ;
if ( V_8 -> V_226 == V_227 )
return - V_47 ;
V_203 -> type = V_53 -> V_162 ? V_272 : V_273 ;
V_203 -> V_274 = V_8 -> V_275 ;
F_15 ( V_8 , V_268 , V_276 , V_203 ) ;
return 0 ;
}
static int F_128 ( struct V_7 * V_8 , const struct V_271 * V_203 )
{
struct V_193 V_198 ;
if ( V_8 -> V_226 == V_227 )
return - V_47 ;
if ( F_95 ( V_203 -> V_268 != 0 ) )
return - V_47 ;
F_21 ( & V_8 -> V_56 ) ;
V_8 -> V_275 = V_203 -> V_274 ;
V_198 . V_44 = V_277 ;
V_198 . V_199 = 1 ;
F_83 ( V_8 , & V_198 ) ;
F_15 ( V_8 , V_268 , V_278 , V_203 ) ;
F_129 ( 100 ) ;
V_198 . V_199 = 0 ;
F_83 ( V_8 , & V_198 ) ;
F_22 ( & V_8 -> V_56 ) ;
...
F_83 ( V_8 , & V_198 ) ;
F_8 ( 1 , L_49 , V_6 ,
V_284 . V_274 , V_203 -> V_268 , V_284 . V_252 ) ;
V_280 = F_131 ( & V_8 -> V_287 . V_288 , 1 ) ;
if ( ! V_280 ) {
F_22 ( & V_8 -> V_56 ) ;
return - V_47 ;
}
V_282 = V_280 -> V_289 . V_290 ;
if ( ( V_8 -> V_41 == V_95 ) ||
( V_8 -> V_41 == V_93 ) ||
( V_8 -> V_41 == V_94 ) )
V_282 = & V_8 -> V_291 . V_292 ;
if ( V_282 && V_282 -> V_293 . V_294 . V_295 ) {
F_15 ( V_8 , V_29 , V_30 , V_8 -> V_28 ) ;
V_282 -> V_293 . V_294 . V_295 ( V_282 , & V_284 ) ;
}
else
F_3 ( V_5 L_50 , V_6 ) ;
F_129 ( 100 ) ;
...
int F_132 ( struct V_159 * V_159 , void * V_201 ,
const struct V_271 * V_203 )
{
struct V_52 * V_53 = V_201 ;
struct V_7 * V_8 = V_53 -> V_8 ;
...
case V_94 :
case V_95 :
V_67 = F_130 ( V_8 , V_203 ) ;
break;
default:
V_67 = F_128 ( V_8 , V_203 ) ;
}
return V_67 ;
}
static int F_133 ( struct V_159 * V_159 , void * V_201 ,
const struct V_271 * V_203 )
{
return F_132 ( V_159 , V_201 , V_203 ) ;
}
...
int F_137 ( struct V_7 * V_8 , T_1 V_256 )
{
T_1 V_296 , V_11 ;
int V_297 = 0 ;
V_296 = F_105 ( V_108 ) ;
...
F_149 ( & V_8 -> V_173 ) ;
V_309 = V_310 ;
strcpy ( V_309 . V_39 , L_58 ) ;
V_8 -> V_28 = V_311 ;
F_150 ( & V_8 -> V_148 . V_15 ) ;
F_150 ( & V_8 -> V_148 . V_113 ) ;
V_8 -> V_148 . V_24 . V_312 = F_134 ;
...
V_320 . V_321 = V_322 ;
V_320 . type = V_8 -> V_226 ;
V_320 . V_62 = F_155 ( V_316 ) ;
V_320 . V_323 = V_324 ;
F_35 ( V_316 , V_268 , V_325 , & V_320 ) ;
if ( ( V_8 -> V_41 == V_326 ) ||
( V_8 -> V_41 == V_327 ) ) {
struct V_328 V_198 = {
. V_329 = V_330 ,
...
V_8 -> V_307 = F_16 ( V_8 , V_8 -> V_33 ,
& V_310 , L_61 ) ;
V_213 = F_156 ( V_8 -> V_307 , V_164 ,
V_335 [ V_8 -> V_336 ] ) ;
if ( V_213 < 0 ) {
F_3 ( V_257 L_62 ,
V_8 -> V_39 ) ;
...
F_3 ( V_257 L_63 ,
V_8 -> V_39 , F_65 ( V_8 -> V_307 ) ) ;
V_8 -> V_306 = F_16 ( V_8 , V_8 -> V_33 ,
& V_309 , L_64 ) ;
V_213 = F_156 ( V_8 -> V_306 , V_165 ,
V_338 [ V_8 -> V_336 ] ) ;
if ( V_213 < 0 ) {
F_3 ( V_257 L_65 ,
V_8 -> V_39 ) ;
