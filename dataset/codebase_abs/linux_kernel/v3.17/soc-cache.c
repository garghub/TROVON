...
V_7 -> V_16 . V_17 ) ;
if ( V_9 -> V_18 )
V_7 -> V_19 = F_7 ( V_9 -> V_18 ,
V_11 , V_20 ) ;
else
V_7 -> V_19 = F_8 ( V_11 , V_20 ) ;
if ( ! V_7 -> V_19 )
return - V_21 ;
return 0 ;
}
...
unsigned int V_3 ;
V_9 = V_7 -> V_10 ;
for ( V_25 = 0 ; V_25 < V_9 -> V_12 ; ++ V_25 ) {
V_26 = F_11 ( V_7 , V_25 , & V_3 ) ;
if ( V_26 )
return V_26 ;
if ( V_9 -> V_18 )
if ( F_3 ( V_9 -> V_18 ,
