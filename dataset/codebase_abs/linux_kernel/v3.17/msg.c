...
int V_163 ;
F_91 ( & V_161 ) ;
V_162 = ( ( ( V_161 . V_164 - V_161 . V_165 ) / V_166 ) * V_161 . V_167 )
/ V_168 ;
V_163 = F_58 ( & V_169 ) ;
V_162 /= V_163 ;
if ( V_162 < V_170 ) {
...
if ( V_162 > V_171 / V_163 ) {
V_3 -> V_25 = V_171 / V_163 ;
return;
}
V_3 -> V_25 = V_162 ;
}
...
F_93 ( & V_3 -> V_58 , 0 ) ;
F_93 ( & V_3 -> V_57 , 0 ) ;
F_94 ( & V_3 -> V_173 [ V_174 ] ) ;
}
void F_95 ( struct V_2 * V_3 )
{
F_96 ( V_3 , & F_3 ( V_3 ) , F_35 ) ;
F_97 ( & V_3 -> V_173 [ V_174 ] . V_175 ) ;
}
static int F_98 ( struct V_176 * V_8 , void * V_177 )
{
struct V_178 * V_179 = F_99 ( V_8 ) ;
...
V_14 -> V_33 ,
V_14 -> V_34 ,
F_101 ( V_179 , V_14 -> V_7 . V_82 ) ,
F_102 ( V_179 , V_14 -> V_7 . V_83 ) ,
F_101 ( V_179 , V_14 -> V_7 . V_180 ) ,
F_102 ( V_179 , V_14 -> V_7 . V_181 ) ,
V_14 -> V_26 ,
V_14 -> V_27 ,
V_14 -> V_28 ) ;
}
