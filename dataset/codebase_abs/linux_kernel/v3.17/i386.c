...
V_29 -> V_8 &= ~ V_52 ;
F_29 ( V_3 , V_3 -> V_54 , & V_53 ) ;
F_30 ( V_3 , V_3 -> V_54 ,
V_53 & ~ V_55 ) ;
}
}
}
static void F_31 ( struct V_34 * V_17 , int V_37 )
{
struct V_2 * V_3 ;
struct V_34 * V_35 ;
...
static void F_33 ( struct V_34 * V_17 )
{
struct V_2 * V_3 ;
struct V_34 * V_35 ;
F_4 (dev, &bus->devices, bus_list) {
...
void F_36 ( struct V_34 * V_17 )
{
F_37 ( V_58 , & V_17 -> V_3 , L_4 ) ;
F_22 ( V_17 ) ;
F_31 ( V_17 , 0 ) ;
F_31 ( V_17 , 1 ) ;
if ( ! ( V_15 & V_57 ) )
...
int F_42 ( struct V_2 * V_3 , struct V_59 * V_60 ,
...
if ( V_68 && V_63 )
V_64 |= V_69 ;
else if ( V_68 || V_70 . V_71 > 3 )
V_64 |= V_72 ;
V_64 |= V_73 ;
V_60 -> V_67 = F_44 ( V_64 ) ;
if ( F_45 ( V_60 , V_60 -> V_74 , V_60 -> V_75 ,
V_60 -> V_76 - V_60 -> V_74 ,
V_60 -> V_67 ) )
return - V_77 ;
V_60 -> V_78 = & V_79 ;
