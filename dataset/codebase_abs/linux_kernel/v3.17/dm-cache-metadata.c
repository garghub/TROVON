...
static void F_67 ( T_3 V_94 , T_6 * V_91 , unsigned * V_10 )
{
T_7 V_92 = F_11 ( V_94 ) ;
T_7 V_4 = V_92 >> 16 ;
* V_91 = F_57 ( V_4 ) ;
...
struct V_23 * F_68 ( struct V_95 * V_50 ,
T_4 V_65 ,
bool V_85 ,
T_1 V_44 )
{
...
T_6 V_98 ;
unsigned V_10 ;
V_31 = F_75 ( & V_24 -> V_42 , V_24 -> V_58 , F_65 ( V_4 ) , & V_92 ) ;
if ( V_31 ) {
F_9 ( L_13 ) ;
return V_31 ;
}
F_67 ( V_92 , & V_98 , & V_10 ) ;
* V_30 = ! ( ( V_10 & V_99 ) && ( V_10 & V_100 ) ) ;
return 0 ;
}
...
* V_30 = true ;
while ( V_101 != V_102 ) {
V_31 = F_74 ( V_24 , V_101 , V_30 ) ;
if ( V_31 )
return V_31 ;
if ( ! * V_30 ) {
F_9 ( L_14 ,
( unsigned long long ) F_65 ( V_101 ) ) ;
return 0 ;
}
V_101 = F_58 ( F_65 ( V_101 ) + 1 ) ;
}
return 0 ;
}
int F_77 ( struct V_23 * V_24 , T_8 V_103 )
{
int V_31 ;
bool V_104 ;
T_3 V_105 = F_66 ( 0 , 0 ) ;
F_78 ( & V_24 -> V_97 ) ;
F_79 ( & V_105 ) ;
if ( F_65 ( V_103 ) < F_65 ( V_24 -> V_66 ) ) {
V_31 = F_76 ( V_24 , V_103 , V_24 -> V_66 , & V_104 ) ;
if ( V_31 ) {
F_80 ( & V_105 ) ;
goto V_106;
}
...
V_31 = F_81 ( & V_24 -> V_42 , V_24 -> V_58 , F_65 ( V_24 -> V_66 ) ,
F_65 ( V_103 ) ,
& V_105 , & V_24 -> V_58 ) ;
if ( ! V_31 )
V_24 -> V_66 = V_103 ;
...
static int F_85 ( struct V_23 * V_24 , T_6 V_4 )
{
return F_86 ( & V_24 -> V_72 , V_24 -> V_60 ,
F_30 ( V_4 ) , & V_24 -> V_60 ) ;
}
static int F_87 ( struct V_23 * V_24 , T_6 V_4 )
{
return F_88 ( & V_24 -> V_72 , V_24 -> V_60 ,
F_30 ( V_4 ) , & V_24 -> V_60 ) ;
}
static int F_89 ( struct V_23 * V_24 , T_6 V_4 ,
bool * V_108 )
{
return F_90 ( & V_24 -> V_72 , V_24 -> V_60 ,
F_30 ( V_4 ) , & V_24 -> V_60 ,
V_108 ) ;
}
static int F_91 ( struct V_23 * V_24 ,
T_6 V_109 , bool V_110 )
{
int V_31 ;
V_31 = ( V_110 ? F_85 : F_87 ) ( V_24 , V_109 ) ;
if ( V_31 )
return V_31 ;
V_24 -> V_90 = true ;
return 0 ;
...
T_6 V_109 = F_57 ( V_4 ) ;
if ( V_24 -> V_73 ) {
V_31 = F_89 ( V_24 , V_109 , & V_110 ) ;
if ( V_31 )
return V_31 ;
} else
V_110 = false ;
V_31 = V_111 ( V_37 , V_24 -> V_61 , V_109 , V_110 ) ;
if ( V_31 )
break;
}
return V_31 ;
...
static int F_98 ( struct V_23 * V_24 , T_8 V_112 )
{
int V_31 ;
T_3 V_92 = F_66 ( 0 , 0 ) ;
F_79 ( & V_92 ) ;
V_31 = F_99 ( & V_24 -> V_42 , V_24 -> V_58 , F_65 ( V_112 ) ,
& V_92 , & V_24 -> V_58 ) ;
if ( V_31 )
return V_31 ;
V_24 -> V_90 = true ;
...
int F_100 ( struct V_23 * V_24 , T_8 V_112 )
{
int V_31 ;
F_78 ( & V_24 -> V_97 ) ;
V_31 = F_98 ( V_24 , V_112 ) ;
F_82 ( & V_24 -> V_97 ) ;
return V_31 ;
}
...
struct V_114 * V_115 )
{
const char * V_55 = F_104 ( V_115 ) ;
const unsigned * V_56 = F_105 ( V_115 ) ;
T_1 V_44 = F_106 ( V_115 ) ;
...
struct V_114 * V_115 )
{
return V_24 -> V_73 && F_103 ( V_24 , V_115 ) &&
F_107 ( V_24 ) ;
}
static int F_109 ( void * V_37 , T_7 V_112 , void * V_116 )
{
int V_31 = 0 ;
bool V_117 ;
T_3 V_92 ;
...
T_6 V_113 ;
unsigned V_10 ;
struct V_119 * V_119 = V_37 ;
struct V_23 * V_24 = V_119 -> V_24 ;
memcpy ( & V_92 , V_116 , sizeof( V_92 ) ) ;
F_67 ( V_92 , & V_113 , & V_10 ) ;
if ( V_10 & V_99 ) {
if ( V_119 -> V_120 ) {
V_31 = F_75 ( & V_24 -> V_45 , V_24 -> V_59 ,
V_112 , & V_118 ) ;
if ( V_31 && V_31 != - V_121 )
return V_31 ;
}
V_117 = V_119 -> V_122 ? ( V_10 & V_100 ) : true ;
V_31 = V_119 -> V_111 ( V_119 -> V_37 , V_113 , F_58 ( V_112 ) ,
V_117 , F_8 ( V_118 ) , V_119 -> V_120 ) ;
}
return V_31 ;
}
static int F_110 ( struct V_23 * V_24 ,
struct V_114 * V_115 ,
T_11 V_111 , void * V_37 )
{
struct V_119 V_119 ;
V_119 . V_111 = V_111 ;
V_119 . V_37 = V_37 ;
V_119 . V_24 = V_24 ;
V_119 . V_122 = V_24 -> V_73 ;
V_119 . V_120 = F_108 ( V_24 , V_115 ) ;
return F_111 ( & V_24 -> V_42 , V_24 -> V_58 , F_109 , & V_119 ) ;
}
...
int V_31 ;
F_95 ( & V_24 -> V_97 ) ;
V_31 = F_110 ( V_24 , V_115 , V_111 , V_37 ) ;
F_96 ( & V_24 -> V_97 ) ;
return V_31 ;
}
static int F_113 ( void * V_37 , T_7 V_112 , void * V_116 )
{
int V_31 = 0 ;
T_3 V_92 ;
T_6 V_113 ;
...
{
return F_111 ( & V_24 -> V_42 , V_24 -> V_58 , F_113 , NULL ) ;
}
...
static int F_117 ( struct V_23 * V_24 , T_8 V_112 , bool V_117 )
{
int V_31 ;
unsigned V_10 ;
T_6 V_113 ;
T_3 V_92 ;
V_31 = F_75 ( & V_24 -> V_42 , V_24 -> V_58 , F_65 ( V_112 ) , & V_92 ) ;
if ( V_31 )
return V_31 ;
F_67 ( V_92 , & V_113 , & V_10 ) ;
if ( ( ( V_10 & V_100 ) && V_117 ) || ( ! ( V_10 & V_100 ) && ! V_117 ) )
return 0 ;
V_92 = F_66 ( V_113 , ( V_10 & ~ V_100 ) | ( V_117 ? V_100 : 0 ) ) ;
F_79 ( & V_92 ) ;
V_31 = F_99 ( & V_24 -> V_42 , V_24 -> V_58 , F_65 ( V_112 ) ,
& V_92 , & V_24 -> V_58 ) ;
if ( V_31 )
...
T_8 V_112 , bool V_117 )
{
int V_31 ;
F_78 ( & V_24 -> V_97 ) ;
V_31 = F_117 ( V_24 , V_112 , V_117 ) ;
F_82 ( & V_24 -> V_97 ) ;
return V_31 ;
}
...
int F_121 ( struct V_23 * V_24 , bool V_124 )
{
int V_31 ;
T_5 V_88 = ( V_124 ? F_52 :
F_54 ) ;
...
int V_31 = - V_17 ;
F_95 ( & V_24 -> V_97 ) ;
V_31 = F_125 ( V_24 -> V_47 , V_30 ) ;
F_96 ( & V_24 -> V_97 ) ;
return V_31 ;
}
static int F_126 ( struct V_23 * V_24 , struct V_114 * V_115 )
{
int V_31 ;
V_11 V_92 ;
T_1 V_125 ;
...
V_24 -> V_44 = V_125 ;
if ( V_24 -> V_59 ) {
V_31 = F_127 ( & V_24 -> V_45 , V_24 -> V_59 ) ;
if ( V_31 )
return V_31 ;
}
...
V_92 = F_5 ( 0 ) ;
F_79 ( & V_92 ) ;
V_31 = F_81 ( & V_24 -> V_45 , V_24 -> V_59 , 0 ,
F_65 ( V_24 -> V_66 ) ,
& V_92 , & V_24 -> V_59 ) ;
if ( V_31 )
return V_31 ;
...
static int F_128 ( void * V_37 , T_8 V_112 , T_6 V_113 , T_2 V_126 )
{
struct V_23 * V_24 = V_37 ;
V_11 V_92 = F_5 ( V_126 ) ;
int V_31 ;
F_79 ( & V_92 ) ;
V_31 = F_99 ( & V_24 -> V_45 , V_24 -> V_59 ,
F_65 ( V_112 ) , & V_92 , & V_24 -> V_59 ) ;
V_24 -> V_90 = true ;
return V_31 ;
}
static int F_129 ( struct V_23 * V_24 , struct V_114 * V_115 )
{
int V_31 ;
V_31 = F_126 ( V_24 , V_115 ) ;
if ( V_31 ) {
F_9 ( L_16 ) ;
return V_31 ;
}
return F_130 ( V_115 , F_128 , V_24 ) ;
}
int F_131 ( struct V_23 * V_24 , struct V_114 * V_115 )
{
int V_31 ;
F_78 ( & V_24 -> V_97 ) ;
V_31 = F_129 ( V_24 , V_115 ) ;
F_82 ( & V_24 -> V_97 ) ;
return V_31 ;
}
int F_132 ( struct V_23 * V_24 , bool * V_30 )
{
return F_76 ( V_24 , 0 , V_24 -> V_66 , V_30 ) ;
}
