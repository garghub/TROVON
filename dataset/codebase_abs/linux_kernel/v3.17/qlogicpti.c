...
V_61 -> V_226 = F_55 ( & V_61 -> V_227 ) + V_225 ;
V_61 -> V_228 = F_56 ( V_225 ) ;
}
static int F_57 ( struct V_229 * V_230 )
{
struct V_1 * V_2 = F_58 ( V_230 -> V_61 ) ;
...
static int F_59 ( struct V_178 * V_179 , void (* F_60)( struct V_178 * ) )
{
...
struct V_178 * F_61 ( struct V_1 * V_2 )
{
