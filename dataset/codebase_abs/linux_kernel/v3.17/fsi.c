...
struct V_138 * V_139 ;
int V_33 = F_22 ( V_14 , V_32 ) ;
enum V_140 V_141 = V_33 ? V_142 : V_143 ;
int V_7 = - V_68 ;
...
T_1 V_35 , V_123 ;
int V_169 ;
V_35 = F_108 ( V_6 , V_170 ) ;
V_35 >>= F_21 ( V_14 , V_32 ) ;
V_35 &= V_171 ;
V_169 = 256 << V_35 ;
F_41 ( V_66 , L_34 , V_169 ) ;
...
F_62 ( V_14 , V_172 , V_152 , V_152 ) ;
} else {
F_28 ( V_14 , V_151 , V_173 ) ;
F_62 ( V_14 , V_151 , V_152 , V_152 ) ;
}
}
...
static int F_114 ( struct V_18 * V_19 , int V_181 ,
struct V_22 * V_27 )
{
struct V_13 * V_14 = F_20 ( V_19 ) ;
...
static void F_130 ( struct V_204 * V_205 )
{
F_131 ( V_205 ) ;
}
...
V_24 -> V_205 ,
V_206 ,
V_24 -> V_207 -> V_208 -> V_66 ,
V_209 , V_210 ) ;
}
static void F_134 ( char * V_211 ,
struct V_212 * V_213 ,
struct V_214 * V_215 ,
struct V_70 * V_66 )
{
...
for ( V_123 = 0 ; V_123 < F_135 ( V_217 ) ; V_123 ++ ) {
sprintf ( V_216 , L_39 , V_211 , V_217 [ V_123 ] . V_211 ) ;
if ( F_136 ( V_213 , V_216 , NULL ) )
V_8 |= V_217 [ V_123 ] . V_4 ;
}
V_215 -> V_8 = V_8 ;
F_41 ( V_66 , L_40 , V_211 , V_215 -> V_8 ) ;
}
...
V_14 -> V_53 . V_55 = V_14 ;
if ( V_215 -> V_221 ) {
V_14 -> V_49 . V_157 = V_215 -> V_221 ;
V_14 -> V_49 . V_166 = & V_222 ;
}
}
static int F_139 ( struct V_223 * V_224 )
{
struct V_5 * V_6 ;
struct V_212 * V_213 = V_224 -> V_66 . V_225 ;
struct V_226 V_215 ;
const struct V_227 * V_11 ;
struct V_13 * V_14 ;
struct V_228 * V_229 ;
unsigned int V_134 ;
int V_7 ;
...
V_231 = F_140 ( V_232 , & V_224 -> V_66 ) ;
if ( V_231 ) {
V_11 = V_231 -> V_2 ;
F_134 ( L_41 , V_213 , & V_215 . V_233 , & V_224 -> V_66 ) ;
F_134 ( L_42 , V_213 , & V_215 . V_234 , & V_224 -> V_66 ) ;
}
} else {
const struct V_235 * V_236 = V_224 -> V_236 ;
if ( V_236 )
V_11 = (struct V_227 * ) V_236 -> V_237 ;
if ( V_224 -> V_66 . V_238 )
memcpy ( & V_215 , V_224 -> V_66 . V_238 , sizeof( V_215 ) ) ;
}
if ( ! V_11 ) {
F_36 ( & V_224 -> V_66 , L_43 ) ;
return - V_239 ;
}
V_229 = F_141 ( V_224 , V_240 , 0 ) ;
V_134 = F_142 ( V_224 , 0 ) ;
if ( ! V_229 || ( int ) V_134 <= 0 ) {
F_36 ( & V_224 -> V_66 , L_44 ) ;
return - V_239 ;
}
V_6 = F_143 ( & V_224 -> V_66 , sizeof( * V_6 ) , V_241 ) ;
if ( ! V_6 ) {
F_36 ( & V_224 -> V_66 , L_45 ) ;
return - V_242 ;
}
V_6 -> V_10 = F_144 ( & V_224 -> V_66 ,
V_229 -> V_153 , F_145 ( V_229 ) ) ;
if ( ! V_6 -> V_10 ) {
F_36 ( & V_224 -> V_66 , L_46 ) ;
return - V_243 ;
}
V_6 -> V_11 = V_11 ;
F_146 ( & V_6 -> V_9 ) ;
...
V_14 -> V_10 = V_6 -> V_10 ;
V_14 -> V_6 = V_6 ;
F_137 ( V_14 , & V_215 . V_233 ) ;
F_138 ( V_14 , & V_215 . V_233 ) ;
V_7 = F_38 ( V_14 , & V_224 -> V_66 ) ;
if ( V_7 < 0 ) {
F_36 ( & V_224 -> V_66 , L_47 ) ;
return V_7 ;
}
V_14 = & V_6 -> V_30 ;
V_14 -> V_10 = V_6 -> V_10 + 0x40 ;
V_14 -> V_6 = V_6 ;
F_137 ( V_14 , & V_215 . V_234 ) ;
F_138 ( V_14 , & V_215 . V_234 ) ;
V_7 = F_38 ( V_14 , & V_224 -> V_66 ) ;
if ( V_7 < 0 ) {
F_36 ( & V_224 -> V_66 , L_48 ) ;
goto V_244;
}
F_147 ( & V_224 -> V_66 ) ;
F_148 ( & V_224 -> V_66 , V_6 ) ;
V_7 = F_149 ( & V_224 -> V_66 , V_134 , & F_87 , 0 ,
F_150 ( & V_224 -> V_66 ) , V_6 ) ;
if ( V_7 ) {
F_36 ( & V_224 -> V_66 , L_49 ) ;
goto V_245;
}
V_7 = F_151 ( & V_224 -> V_66 , & V_246 ) ;
if ( V_7 < 0 ) {
F_36 ( & V_224 -> V_66 , L_50 ) ;
goto V_245;
}
V_7 = F_152 ( & V_224 -> V_66 , & V_247 ,
V_248 , F_135 ( V_248 ) ) ;
if ( V_7 < 0 ) {
F_36 ( & V_224 -> V_66 , L_51 ) ;
goto V_249;
}
return V_7 ;
V_249:
