...
V_3 [ V_8 ] = F_110 ( & V_74 -> V_72 , V_190 [ V_8 ] ) ;
if ( F_105 ( V_3 [ V_8 ] ) )
...
if ( V_158 ) {
V_34 [ V_8 ] = F_111 ( V_158 , 0 ) ;
V_189 [ V_8 ] = F_111 ( V_158 , 2 ) ;
} else {
char V_194 [ 10 ] ;
sprintf ( V_194 , L_25 , V_8 ) ;
V_34 [ V_8 ] = F_112 ( V_74 , V_194 ) ;
sprintf ( V_194 , L_26 , V_8 ) ;
V_189 [ V_8 ] = F_112 ( V_74 , V_194 ) ;
}
V_19 [ V_8 ] -> V_35 = V_34 [ V_8 ] ;
V_19 [ V_8 ] -> V_36 = V_189 [ V_8 ] ;
V_186 = F_113 ( V_72 , V_34 [ V_8 ] , F_36 , 0 ,
L_27 , V_72 ) ;
if ( V_186 < 0 ) {
F_37 ( & V_74 -> V_72 ,
L_28 ,
...
V_186 = F_113 ( V_72 , V_189 [ V_8 ] , F_39 , 0 ,
L_29 , V_72 ) ;
if ( V_186 < 0 ) {
F_37 ( & V_74 -> V_72 ,
L_28 ,
