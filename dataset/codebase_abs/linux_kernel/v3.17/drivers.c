...
unsigned long V_44 )
{
unsigned long V_45 = V_46 + F_22 ( V_47 ) ;
int V_48 ;
while ( F_23 ( V_46 , V_45 ) ) {
V_48 = F_21 ( V_2 , V_11 , V_42 , V_44 ) ;
if ( V_48 != - V_49 )
return V_48 ;
F_24 () ;
}
...
unsigned int V_51 )
{
unsigned int V_52 = 1 << F_26 ( V_42 -> V_53 ) ;
if ( ! V_51 )
V_51 = V_52 ;
switch ( V_43 [ 0 ] ) {
case V_54 :
...
break;
case V_57 :
V_43 [ 1 ] = ( V_11 -> V_55 & V_51 ) ? V_58 : V_59 ;
return V_42 -> V_60 ;
default:
return - V_13 ;
}
...
unsigned int * V_43 )
{
unsigned int V_61 = ( V_11 -> V_62 < 32 ) ? ( ( 1 << V_11 -> V_62 ) - 1 )
: 0xffffffff ;
unsigned int V_51 = V_43 [ 0 ] & V_61 ;
unsigned int V_63 = V_43 [ 1 ] ;
if ( V_51 ) {
V_11 -> V_64 &= ~ V_51 ;
V_11 -> V_64 |= ( V_63 & V_51 ) ;
}
...
struct V_41 V_65 ;
int V_48 ;
static const unsigned V_66 = 32 ;
unsigned V_67 = F_26 ( V_42 -> V_53 ) ;
const unsigned V_68 =
( V_67 < V_66 ) ? 0 : V_67 ;
unsigned int V_69 [ 2 ] ;
...
return - V_13 ;
V_69 [ 0 ] = 1 << ( V_67 - V_68 ) ;
V_69 [ 1 ] = V_43 [ 0 ] ? ( 1 << ( V_67 - V_68 ) )
: 0 ;
}
V_48 = V_11 -> V_75 ( V_2 , V_11 , & V_65 , V_69 ) ;
if ( V_48 < 0 )
return V_48 ;
if ( V_42 -> V_42 == V_76 )
V_43 [ 0 ] = ( V_69 [ 1 ] >> ( V_67 - V_68 ) ) & 1 ;
return 1 ;
}
...
if ( V_78 > V_24 -> V_84 )
V_78 = V_24 -> V_84 ;
if ( F_13 ( V_2 , V_11 , V_78 ) < 0 ) {
F_30 ( V_2 -> V_81 , L_3 ) ;
return - V_14 ;
}
if ( V_11 -> V_87 ) {
V_48 = V_11 -> V_87 ( V_2 , V_11 ) ;
if ( V_48 < 0 )
return V_48 ;
}
F_32 ( V_11 ) ;
...
if ( V_11 -> type == V_89 ) {
if ( V_11 -> V_62 < 32 )
V_11 -> V_55 = ( 1 << V_11 -> V_62 ) - 1 ;
else
V_11 -> V_55 = 0xffffffff ;
}
if ( V_11 -> V_90 == 0 )
V_11 -> V_90 = 1 ;
if ( V_11 -> V_91 ) {
...
V_11 -> V_92 = & V_94 ;
if ( ! V_11 -> V_95 && V_11 -> V_75 )
V_11 -> V_95 = F_28 ;
if ( ! V_11 -> V_96 && V_11 -> V_75 )
V_11 -> V_96 = F_28 ;
if ( ! V_11 -> V_95 )
V_11 -> V_95 = F_19 ;
if ( ! V_11 -> V_96 )
...
if ( ! F_21 )
return - V_13 ;
V_48 = F_39 ( & V_107 , V_101 , V_3 ) ;
if ( V_48 == 0 ) {
V_48 = F_21 ( V_2 , V_107 -> V_43 , V_107 -> V_6 , V_44 ) ;
F_40 ( V_107 ) ;
}
return V_48 < 0 ? V_48 : 0 ;
}
...
struct V_99 * V_25 , unsigned long V_44 )
{
struct V_1 * V_2 ;
int V_48 ;
if ( ! V_120 ) {
