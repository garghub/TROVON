...
const struct V_42 * const V_47 [] )
{
struct V_6 * V_7 = F_2 ( V_2 ) ;
struct V_48 V_49 = {
. V_50 = V_46 -> V_14 ? : V_51 ,
. V_52 = F_25 ( struct V_8 , V_18 ) ,
. V_53 = F_25 ( struct V_8 , V_4 ) ,
. V_54 = V_2 -> V_28 ,
. V_55 = V_56 ,
. V_57 = V_58 ,
. V_59 = V_60 ,
...
unsigned int V_36 ;
for ( V_36 = 0 ; V_36 < V_26 -> V_14 ; V_36 ++ ) {
for ( V_9 = F_28 ( V_26 -> V_29 [ V_36 ] , struct V_8 , V_18 ) ;
V_9 != NULL ; V_9 = V_30 ) {
V_30 = F_28 ( V_9 -> V_18 . V_30 , struct V_8 , V_18 ) ;
F_8 ( V_2 , V_9 ) ;
}
}
F_29 ( V_7 ) ;
}
static bool F_30 ( const struct V_45 * V_46 , T_1 V_62 ,
struct V_63 * V_64 )
{
unsigned int V_65 ;
V_65 = sizeof( struct V_8 ) ;
if ( V_62 & V_11 )
V_65 += F_31 ( struct V_8 , V_5 [ 0 ] ) ;
if ( V_46 -> V_14 ) {
V_64 -> V_14 = sizeof( struct V_6 ) +
F_32 ( V_46 -> V_14 * 4 / 3 ) *
sizeof( struct V_8 * ) +
V_46 -> V_14 * V_65 ;
} else {
V_64 -> V_14 = V_65 + 2 * sizeof( struct V_8 * ) ;
}
V_64 -> V_66 = V_67 ;
return true ;
}
