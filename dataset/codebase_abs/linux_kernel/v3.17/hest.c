...
V_28 = F_9 ( L_5 , V_2 -> V_36 ) ;
if ( ! V_28 )
return - V_38 ;
V_18 = F_10 ( V_28 , & V_2 , sizeof( void * ) ) ;
if ( V_18 )
goto V_39;
V_18 = F_11 ( V_28 ) ;
if ( V_18 )
...
static int T_3 F_13 ( unsigned int V_40 )
{
int V_18 , V_17 ;
struct V_29 V_29 ;
V_29 . V_25 = 0 ;
V_29 . V_33 = F_14 ( sizeof( void * ) * V_40 , V_41 ) ;
if ( ! V_29 . V_33 )
return - V_38 ;
V_18 = F_3 ( F_8 , & V_29 ) ;
if ( V_18 )
