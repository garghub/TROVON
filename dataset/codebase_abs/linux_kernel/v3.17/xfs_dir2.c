...
int error ;
F_54 ( args , V_111 ) ;
V_114 = F_55 ( V_14 , V_111 * V_115 ) ;
V_57 = args -> V_76 -> V_35 ;
error = F_56 ( args , & V_114 , V_57 ) ;
if ( error )
return error ;
* V_112 = F_57 ( args -> V_76 , ( V_116 ) V_114 ) ;
if ( V_111 == V_117 ) {
T_15 V_118 ;
V_118 = F_58 ( V_14 , V_114 + V_57 ) ;
if ( V_118 > V_49 -> V_51 . V_53 ) {
V_49 -> V_51 . V_53 = V_118 ;
F_59 ( args -> V_78 , V_49 , V_119 ) ;
}
}
return 0 ;
}
...
T_14 V_121 ;
int V_83 ;
if ( ( V_83 = F_60 ( args -> V_49 , & V_121 , V_92 ) ) )
return V_83 ;
V_83 = F_58 ( args -> V_49 -> V_77 , V_121 ) == args -> V_76 -> V_34 ;
...
V_14 = V_49 -> V_77 ;
V_71 = args -> V_78 ;
V_125 = F_63 ( args -> V_76 , V_122 ) ;
if ( ( error = F_64 ( V_71 , V_49 , V_125 , args -> V_76 -> V_35 ,
...
ASSERT ( V_126 ) ;
F_65 ( V_71 , V_124 ) ;
if ( V_122 >= F_66 ( args -> V_76 , V_39 ) )
return 0 ;
if ( V_49 -> V_51 . V_53 > F_67 ( args -> V_76 , V_122 + 1 , 0 ) )
return 0 ;
V_114 = V_125 ;
if ( ( error = F_68 ( V_71 , V_49 , & V_114 , V_92 ) ) ) {
return error ;
}
...
ASSERT ( V_114 > 0 ) ;
V_49 -> V_51 . V_53 = F_58 ( V_14 , V_114 ) ;
F_59 ( V_71 , V_49 , V_119 ) ;
return 0 ;
}
