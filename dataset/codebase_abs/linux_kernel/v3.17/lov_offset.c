...
int F_6 ( struct V_1 * V_2 , T_2 V_12 ,
int V_4 , T_2 * V_13 )
{
unsigned long V_5 = V_2 -> V_6 ;
T_2 V_14 , V_15 , V_8 ;
...
T_2 F_7 ( struct V_1 * V_2 , T_2 V_18 ,
int V_4 )
{
unsigned long V_5 = V_2 -> V_6 ;
T_2 V_14 , V_15 , V_8 ;
...
int F_10 ( struct V_1 * V_2 , T_2 V_12 )
{
unsigned long V_5 = V_2 -> V_6 ;
T_2 V_14 , V_8 ;
int V_10 = V_2 -> V_11 ;
F_2 ( F_3 ( V_10 ) != NULL ) ;
F_3 ( V_10 ) -> F_11 ( V_2 , NULL , & V_12 , & V_8 ) ;
V_14 = F_5 ( V_12 , V_8 ) ;
F_5 ( V_14 , V_5 ) ;
return V_14 ;
}
