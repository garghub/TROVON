...
static int F_22 ( int V_51 )
{
T_1 V_25 [ V_26 ] ;
if ( F_23 ( V_51 , 0 , V_36 ) )
return - 1 ;
if ( F_24 ( V_51 , V_25 , sizeof( V_25 ) ) != sizeof( V_25 ) )
return - 1 ;
if ( memcmp ( V_25 , V_31 , V_32 ) ||
V_25 [ V_33 ] != V_34 )
return - 1 ;
return V_25 [ V_37 ] == V_63 ;
}
enum V_64 F_25 ( int V_51 )
{
T_9 V_39 ;
int V_24 ;
V_24 = F_22 ( V_51 ) ;
...
if ( V_24 )
return V_66 ;
if ( F_24 ( V_51 , & V_39 , sizeof( V_39 ) ) != sizeof( V_39 ) )
return V_65 ;
if ( V_39 . V_67 == V_68 )
return V_69 ;
return V_70 ;
}
int F_26 ( struct V_59 * V_59 , struct V_62 * V_62 V_22 ,
struct V_57 * V_58 ,
...
if ( V_24 >= 0 )
V_59 -> V_72 = V_24 ;
if ( F_7 ( V_58 -> V_17 , V_50 , V_71 ) > 0 ) {
F_27 ( V_59 , V_50 ) ;
return 1 ;
}
return 0 ;
}
int F_28 ( int V_51 V_22 , bool T_15 V_22 ,
T_16 T_17 V_22 , void * V_2 V_22 ,
bool * V_72 V_22 )
{
return - 1 ;
}
int F_29 ( struct V_73 * T_18 V_22 )
{
return - 1 ;
}
void F_30 ( struct V_73 * T_18 V_22 )
{
}
