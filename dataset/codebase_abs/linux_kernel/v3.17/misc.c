...
int V_141 , V_142 ;
char V_143 [ 17 ] ;
unsigned char * V_47 = V_87 ;
if ( V_144 == 0 )
return;
for ( V_141 = 0 , V_142 = 0 ; V_141 < V_52 ; V_141 ++ , V_142 ++ ) {
if ( V_141 % 8 == 0 ) {
F_49 ( V_145 L_22 ) ;
V_142 = 0 ;
}
F_49 ( L_23 , V_47 [ V_141 ] ) ;
V_143 [ 2 * V_142 ] = ' ' ;
if ( isprint ( V_47 [ V_141 ] ) )
V_143 [ 1 + ( 2 * V_142 ) ] = V_47 [ V_141 ] ;
else
V_143 [ 1 + ( 2 * V_142 ) ] = '_' ;
if ( V_141 % 8 == 7 ) {
V_143 [ 16 ] = 0 ;
...
void F_52 ( struct V_104 * V_151 , T_2 V_152 )
{
V_152 &= 0xF ;
if ( V_152 == V_153 ) {
...
int F_53 ( struct V_104 * V_151 )
{
int V_158 ;
V_159:
V_158 = F_54 ( & V_151 -> V_136 , V_135 ,
V_160 ) ;
if ( V_158 )
return V_158 ;
F_2 ( & V_151 -> V_161 ) ;
if ( ! V_151 -> V_162 )
F_45 ( V_163 , & V_151 -> V_136 ) ;
V_151 -> V_162 ++ ;
if ( F_55 ( V_135 , & V_151 -> V_136 ) ) {
V_151 -> V_162 -- ;
if ( V_151 -> V_162 == 0 ) {
F_46 ( V_163 , & V_151 -> V_136 ) ;
F_56 ( & V_151 -> V_136 , V_163 ) ;
}
F_4 ( & V_151 -> V_161 ) ;
goto V_159;
}
...
void F_58 ( struct V_104 * V_151 )
{
F_46 ( V_135 , & V_151 -> V_136 ) ;
F_56 ( & V_151 -> V_136 , V_135 ) ;
}
bool
F_59 ( struct V_146 * V_147 )
{
if ( V_147 -> V_148 & V_164 ) {
if ( F_60 ( V_147 -> V_165 , F_61 () ) )
return true ;
}
if ( V_147 -> V_148 & V_166 ) {
if ( F_62 ( V_147 -> V_167 ) )
return true ;
}
return false ;
...
void
F_65 ( struct V_171 * V_131 , struct V_172 * V_173 ,
struct V_168 * V_169 )
{
#ifdef F_19
memcpy ( V_169 -> V_174 , V_131 -> V_174 , V_175 ) ;
#endif
V_169 -> V_152 = V_176 ;
V_169 -> V_173 = V_173 ;
V_131 -> V_177 = V_169 ;
F_66 ( & V_169 -> V_170 , & F_67 ( V_173 ) -> V_178 ) ;
}
void
F_68 ( struct V_171 * V_131 , struct V_172 * V_173 ,
struct V_168 * V_169 )
{
F_2 ( & V_128 ) ;
F_65 ( V_131 , V_173 , V_169 ) ;
F_4 ( & V_128 ) ;
}
