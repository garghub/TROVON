...
V_237 -> type = V_264 ;
V_237 -> V_34 = 1 ;
V_237 -> V_242 . V_265 . V_266 = 5 ;
if ( V_237 -> V_242 . V_265 . V_268 >= V_237 -> V_242 . V_265 . V_266 )
V_237 -> V_242 . V_265 . V_268 = V_237 -> V_242 . V_265 . V_266 - 1 ;
strcpy ( V_237 -> V_242 . V_265 . V_187 , V_277 [ V_237 -> V_242 . V_265 . V_268 ] ) ;
return 0 ;
}
static inline int F_138 ( int V_222 )
{
...
int F_140 ( struct V_1 * V_2 , int V_278 )
{
unsigned long V_20 ;
unsigned char V_279 ;
...
int F_142 ( struct V_1 * V_2 , unsigned int V_20 ,
int V_278 )
{
...
static int F_143 ( struct V_234 * V_235 ,
struct V_240 * V_241 )
{
struct V_1 * V_2 = F_118 ( V_235 ) ;
int V_222 = F_144 ( V_235 , & V_241 -> V_283 ) ;
V_241 -> V_242 . V_265 . V_268 [ 0 ] =
F_140 ( V_2 , F_138 ( V_222 ) ) ;
return 0 ;
}
...
unsigned char F_151 ( struct V_1 * V_2 ,
...
V_2 -> V_107 . V_227 =
( F_151 ( V_2 , V_14 , 0x00 ) << 0 ) |
( F_151 ( V_2 , V_14 , 0x01 ) << 8 ) |
( F_151 ( V_2 , V_14 , 0x02 ) << 16 ) |
( F_151 ( V_2 , V_14 , 0x03 ) << 24 ) ;
if ( V_2 -> V_107 . V_227 == 0 ||
V_2 -> V_107 . V_227 == ( unsigned int ) - 1 ) {
T_5 V_301 , V_175 ;
F_154 ( V_2 -> V_189 , V_302 ,
& V_301 ) ;
F_154 ( V_2 -> V_189 , V_303 , & V_175 ) ;
V_2 -> V_107 . V_227 =
( ( unsigned int ) F_155 ( V_301 ) << 16 ) | F_155 ( V_175 ) ;
if ( V_2 -> V_107 . V_227 == 0 ||
V_2 -> V_107 . V_227 == ( unsigned int ) - 1 ) {
F_49 ( V_2 -> V_13 -> V_14 ,
L_38 ) ;
...
#endif
V_310:
V_2 -> V_107 . V_138 = F_151 ( V_2 , V_14 , 0x04 ) ;
...
return - V_16 ;
if ( ! V_2 -> V_325 ) {
V_135 = F_163 ( V_2 -> V_13 ,
F_164 ( & V_326 , V_2 ) ) ;
if ( V_135 < 0 )
return V_135 ;
}
V_135 = F_163 ( V_2 -> V_13 , F_164 ( & V_327 , V_2 ) ) ;
if ( V_135 < 0 )
return V_135 ;
V_135 = F_163 ( V_2 -> V_13 , V_324 = F_164 ( & V_328 , V_2 ) ) ;
if ( V_135 < 0 )
return V_135 ;
V_324 -> V_283 . V_175 = V_2 -> V_177 -> V_175 ;
V_135 = F_163 ( V_2 -> V_13 , V_324 = F_164 ( & V_329 , V_2 ) ) ;
if ( V_135 < 0 )
return V_135 ;
V_324 -> V_283 . V_175 = V_2 -> V_177 -> V_175 ;
V_135 = F_163 ( V_2 -> V_13 , V_324 = F_164 ( & V_330 , V_2 ) ) ;
if ( V_135 < 0 )
return V_135 ;
V_324 -> V_283 . V_175 = V_2 -> V_177 -> V_175 ;
#if 0
...
{
int V_135 ;
V_135 = F_163 ( V_2 -> V_13 , F_164 ( & V_331 , V_2 ) ) ;
if ( V_135 < 0 )
return V_135 ;
V_135 = F_163 ( V_2 -> V_13 , F_164 ( & V_332 , V_2 ) ) ;
if ( V_135 < 0 )
return V_135 ;
V_135 = F_163 ( V_2 -> V_13 , F_164 ( & V_333 , V_2 ) ) ;
if ( V_135 < 0 )
return V_135 ;
V_135 = F_163 ( V_2 -> V_13 , F_164 ( & V_334 , V_2 ) ) ;
if ( V_135 < 0 )
return V_135 ;
...
V_336 . V_34 = 2 ;
V_135 = F_163 ( V_2 -> V_13 , F_164 ( & V_336 , V_2 ) ) ;
if ( V_135 < 0 )
return V_135 ;
}
V_135 = F_163 ( V_2 -> V_13 , F_164 ( & V_338 , V_2 ) ) ;
if ( V_135 < 0 )
return V_135 ;
return 0 ;
}
...
static int F_172 ( struct V_341 * V_175 )
{
struct V_1 * V_2 = V_175 -> V_342 ;
return F_166 ( V_2 ) ;
}
static int F_173 ( struct V_343 * V_13 ,
struct V_344 * V_189 ,
const char * V_296 ,
struct V_1 * * V_345 )
{
...
F_179 ( V_189 -> V_64 ) ;
V_13 -> V_21 = V_2 ;
V_135 = F_180 ( V_189 , L_6 ) ;
if ( V_135 < 0 ) {
F_171 ( V_2 ) ;
F_170 ( V_189 ) ;
return V_135 ;
}
V_2 -> V_233 = F_181 ( V_189 , 0 ) ;
V_2 -> V_148 = F_181 ( V_189 , 1 ) ;
if ( F_182 ( V_189 -> V_64 , F_47 ,
V_358 , V_359 , V_2 ) ) {
...
V_135 = F_183 ( V_13 , V_360 , V_2 , & V_128 ) ;
if ( V_135 < 0 ) {
F_166 ( V_2 ) ;
return V_135 ;
}
...
static int F_184 ( struct V_344 * V_189 ,
...
V_135 = F_185 ( & V_189 -> V_14 , V_367 [ V_14 ] , V_283 [ V_14 ] , V_368 ,
0 , & V_13 ) ;
if ( V_135 < 0 )
return V_135 ;
strcpy ( V_13 -> V_369 , L_6 ) ;
strcpy ( V_13 -> V_370 , L_45 ) ;
V_135 = F_173 ( V_13 , V_189 , V_306 [ V_14 ] , & V_2 ) ;
if ( V_135 < 0 ) {
F_186 ( V_13 ) ;
return V_135 ;
}
...
struct V_378 * V_39 ;
V_135 = F_187 ( V_13 , L_46 , 0 , 1 , 1 , & V_39 ) ;
if ( V_135 < 0 ) {
F_186 ( V_13 ) ;
return V_135 ;
}
...
static void F_191 ( struct V_344 * V_189 )
{
struct V_343 * V_13 = F_192 ( V_189 ) ;
struct V_1 * V_2 = V_13 -> V_21 ;
if ( V_2 -> V_307 && V_2 -> V_307 -> V_387 )
V_2 -> V_307 -> V_387 ( V_2 ) ;
F_186 ( V_13 ) ;
}
static int F_193 ( struct V_175 * V_14 )
{
struct V_344 * V_189 = F_194 ( V_14 ) ;
...
static int F_201 ( struct V_175 * V_14 )
{
struct V_344 * V_189 = F_194 ( V_14 ) ;
struct V_343 * V_13 = F_195 ( V_14 ) ;
struct V_1 * V_2 = V_13 -> V_21 ;
