...
{
struct V_301 * V_302 = (struct V_301 * ) V_177 ;
struct V_54 * V_230 [ V_187 ] ;
struct V_238 * V_239 , * V_306 ;
int V_284 = 0 , V_241 = 0 , V_123 , V_179 , V_307 ;
V_239 = NULL ;
if ( V_305 ) {
V_239 = F_31 ( V_305 , struct V_238 , V_80 ) ;
V_284 = V_239 -> V_284 ;
V_241 = V_239 -> V_241 ;
V_307 = 0 ;
for ( V_123 = 0 ; V_123 < V_284 ; V_123 ++ ) {
V_230 [ V_123 ] = V_239 -> V_230 [ V_123 ] ;
V_307 |= V_230 [ V_123 ] -> V_62 . V_63 ;
}
if ( V_307 ) {
...
V_306 = F_174 ( V_230 , V_284 , V_4 , V_28 ,
V_302 -> V_286 ) ;
if ( F_18 ( V_306 ) ) {
V_179 = F_161 ( V_306 ) ;
if ( V_179 != - V_228 )
...
F_149 ( & V_306 -> V_7 . V_37 ) ;
return & V_306 -> V_80 ;
V_309:
V_239 = F_192 ( V_35 , V_302 , V_4 , V_241 , V_28 ) ;
if ( F_18 ( V_239 ) ) {
F_173 ( V_230 , V_284 ) ;
return F_128 ( V_239 ) ;
}
...
int V_123 , V_179 , V_284 , V_241 = 0 , V_311 = 0 ;
V_37 = NULL ;
V_239 = NULL ;
V_240 = NULL ;
...
struct V_34 * F_196 ( struct V_35 * V_35 , struct V_34 * V_286 ,
const struct V_3 * V_4 ,
struct V_201 * V_202 , int V_46 )
{
struct V_34 * V_37 = F_182 ( V_35 , V_286 , V_4 , V_202 ,
V_46 | V_303 ) ;
if ( F_18 ( V_37 ) && F_161 ( V_37 ) == - V_318 )
return F_194 ( V_35 , V_286 -> V_93 -> V_28 , V_286 ) ;
return V_37 ;
}
static inline int
F_197 ( int V_152 , struct V_98 * V_99 , const struct V_3 * V_4 )
{
struct V_40 * V_41 ;
if ( ! V_99 -> V_325 || V_152 < 0 || V_152 >= V_99 -> V_325 -> V_158 )
return 0 ;
V_41 = V_99 -> V_325 -> V_326 [ V_152 ] ;
if ( ! V_41 -> type -> V_327 )
return 0 ;
return V_41 -> type -> V_327 ( V_41 , V_99 , V_4 ) ;
}
static inline int
F_198 ( const struct V_212 * V_219 , const struct V_40 * V_41 ,
unsigned short V_28 )
{
if ( F_199 ( V_41 ) )
return V_219 -> V_229 && ! F_200 ( V_219 , V_41 , V_219 -> V_223 ) ;
return V_41 -> V_45 . V_20 == V_219 -> V_45 . V_20 &&
( V_41 -> V_45 . V_328 == V_219 -> V_45 . V_328 || ! V_219 -> V_45 . V_328 ) &&
( V_41 -> V_44 . V_329 == V_219 -> V_329 || ! V_219 -> V_329 ) &&
V_41 -> V_44 . V_220 == V_219 -> V_220 &&
( V_219 -> V_330 || ( V_219 -> V_331 & ( 1 << V_41 -> V_44 . V_332 ) ) ||
! ( F_201 ( V_219 -> V_45 . V_20 , V_333 ) ) ) &&
! ( V_41 -> V_44 . V_220 != V_267 &&
F_200 ( V_219 , V_41 , V_28 ) ) ;
}
static inline int
F_202 ( const struct V_212 * V_219 , const struct V_334 * V_325 , int V_335 ,
unsigned short V_28 )
{
int V_152 = V_335 ;
if ( V_219 -> V_229 ) {
...
V_335 = - 1 ;
for (; V_152 < V_325 -> V_158 ; V_152 ++ ) {
if ( F_198 ( V_219 , V_325 -> V_326 [ V_152 ] , V_28 ) )
return ++ V_152 ;
if ( V_325 -> V_326 [ V_152 ] -> V_44 . V_220 != V_267 ) {
if ( V_335 == - 1 )
V_335 = - 2 - V_152 ;
break;
}
...
int F_203 ( struct V_98 * V_99 , struct V_3 * V_4 ,
unsigned int V_28 , int V_336 )
{
struct V_31 * V_32 = F_8 ( V_28 ) ;
int V_179 ;
if ( F_9 ( V_32 == NULL ) )
return - V_38 ;
V_32 -> V_337 ( V_99 , V_4 , V_336 ) ;
V_179 = F_204 ( V_99 , & V_4 -> V_193 ) ;
F_13 ( V_32 ) ;
return V_179 ;
}
static inline int F_205 ( const struct V_334 * V_325 , int V_338 , int * V_339 )
{
for (; V_338 < V_325 -> V_158 ; V_338 ++ ) {
if ( V_325 -> V_326 [ V_338 ] -> V_44 . V_220 != V_267 ) {
* V_339 = V_338 ;
return 1 ;
}
}
...
int F_206 ( struct V_201 * V_202 , int V_60 , struct V_98 * V_99 ,
unsigned short V_28 )
{
struct V_35 * V_35 = F_207 ( V_99 -> V_254 ) ;
struct V_54 * V_81 ;
struct V_54 * V_230 [ V_187 ] ;
int V_231 = 0 ;
int V_210 ;
...
V_60 &= V_343 ;
V_341 = F_129 ( V_60 ) ;
if ( F_203 ( V_99 , & V_4 , V_28 , V_336 ) < 0 ) {
F_175 ( V_35 , V_344 ) ;
return 0 ;
}
F_208 ( V_99 , & V_4 , V_28 ) ;
if ( V_99 -> V_325 ) {
int V_123 ;
for ( V_123 = V_99 -> V_325 -> V_158 - 1 ; V_123 >= 0 ; V_123 -- ) {
struct V_40 * V_41 = V_99 -> V_325 -> V_326 [ V_123 ] ;
...
if ( ! V_81 ) {
struct V_79 * V_80 ;
V_80 = F_195 ( V_35 , & V_4 , V_28 , V_341 ,
F_126 , NULL ) ;
if ( F_127 ( V_80 ) )
V_81 = F_128 ( V_80 ) ;
else
...
if ( ! V_81 ) {
if ( V_99 -> V_325 && F_205 ( V_99 -> V_325 , 0 , & V_342 ) ) {
F_197 ( V_342 , V_99 , & V_4 ) ;
F_175 ( V_35 , V_347 ) ;
return 0 ;
}
return 1 ;
...
if ( V_81 -> V_209 == V_285 ) {
struct V_334 * V_325 ;
static struct V_334 V_348 ;
struct V_212 * V_232 [ V_233 ] ;
struct V_212 * V_349 [ V_233 ] ;
struct V_212 * * V_234 = V_232 ;
int V_350 = 0 ;
int V_123 , V_338 ;
if ( ( V_325 = V_99 -> V_325 ) == NULL )
V_325 = & V_348 ;
for ( V_340 = 0 ; V_340 < V_231 ; V_340 ++ ) {
if ( V_230 [ V_340 ] != V_81 &&
V_230 [ V_340 ] -> V_209 != V_285 ) {
F_175 ( V_35 , V_351 ) ;
goto V_327;
}
if ( V_350 + V_230 [ V_340 ] -> V_210 >= V_233 ) {
F_175 ( V_35 , V_352 ) ;
goto V_353;
}
for ( V_123 = 0 ; V_123 < V_230 [ V_340 ] -> V_210 ; V_123 ++ )
V_234 [ V_350 ++ ] = & V_230 [ V_340 ] -> V_211 [ V_123 ] ;
}
V_210 = V_350 ;
if ( V_231 > 1 ) {
F_209 ( V_349 , V_234 , V_210 , V_28 , V_35 ) ;
V_234 = V_349 ;
}
for ( V_123 = V_210 - 1 , V_338 = 0 ; V_123 >= 0 ; V_123 -- ) {
V_338 = F_202 ( V_234 [ V_123 ] , V_325 , V_338 , V_28 ) ;
if ( V_338 < 0 ) {
if ( V_338 < - 1 )
V_342 = - ( 2 + V_338 ) ;
F_175 ( V_35 , V_354 ) ;
...
int F_210 ( struct V_98 * V_99 , unsigned short V_28 )
{
struct V_35 * V_35 = F_207 ( V_99 -> V_254 ) ;
struct V_3 V_4 ;
struct V_34 * V_37 ;
...
F_189 ( V_99 ) ;
V_37 = F_182 ( V_35 , F_180 ( V_99 ) , & V_4 , NULL , V_303 ) ;
if ( F_18 ( V_37 ) ) {
V_355 = 0 ;
V_37 = NULL ;
}
...
static struct V_34 * F_211 ( struct V_34 * V_37 , T_3 V_357 )
{
...
{
return ! F_212 ( (struct V_238 * ) V_37 ) ;
}
void F_213 ( struct V_34 * V_37 , struct V_253 * V_254 )
{
while ( ( V_37 = V_37 -> V_265 ) && V_37 -> V_101 && V_37 -> V_254 == V_254 ) {
V_37 -> V_254 = F_207 ( V_254 ) -> V_358 ;
F_214 ( V_37 -> V_254 ) ;
F_215 ( V_254 ) ;
}
}
static void F_216 ( struct V_98 * V_99 )
{
}
static struct V_34 * F_217 ( struct V_34 * V_37 )
{
if ( V_37 ) {
if ( V_37 -> V_269 ) {
F_162 ( V_37 ) ;
...
struct V_238 * V_239 = (struct V_238 * ) V_37 ;
T_3 V_359 , V_360 ;
V_359 = F_222 ( V_37 -> V_265 ) ;
V_239 -> V_361 = V_359 ;
V_359 = F_223 ( V_37 -> V_101 , V_359 ) ;
V_360 = F_222 ( V_239 -> V_240 ) ;
V_239 -> V_360 = V_360 ;
if ( V_359 > V_360 )
V_359 = V_360 ;
F_224 ( V_37 , V_362 , V_359 ) ;
} while ( ( V_37 = V_37 -> V_57 ) );
}
static int F_212 ( struct V_238 * V_363 )
{
struct V_34 * V_37 = & V_363 -> V_7 . V_37 ;
struct V_238 * V_364 ;
T_3 V_365 ;
if ( ! F_225 ( V_37 -> V_250 , ( (struct V_238 * ) V_37 ) -> V_366 ) ||
( V_37 -> V_254 && ! F_226 ( V_37 -> V_254 ) ) )
return 0 ;
if ( V_37 -> V_46 & V_242 )
return 1 ;
V_364 = NULL ;
...
return 0 ;
V_365 = F_222 ( V_37 -> V_265 ) ;
if ( V_239 -> V_361 != V_365 ) {
V_364 = V_239 ;
V_239 -> V_361 = V_365 ;
}
if ( ! F_225 ( V_239 -> V_240 , V_239 -> V_367 ) )
return 0 ;
V_365 = F_222 ( V_239 -> V_240 ) ;
if ( V_239 -> V_360 != V_365 ) {
V_364 = V_239 ;
V_239 -> V_360 = V_365 ;
}
V_37 = V_37 -> V_265 ;
...
for (; ; ) {
V_37 = & V_364 -> V_7 . V_37 ;
V_365 = F_223 ( V_37 -> V_101 , V_365 ) ;
if ( V_365 > V_364 -> V_360 )
V_365 = V_364 -> V_360 ;
F_224 ( V_37 , V_362 , V_365 ) ;
if ( V_364 == V_363 )
break;
V_364 = (struct V_238 * ) V_364 -> V_7 . V_37 . V_57 ;
V_364 -> V_361 = V_365 ;
}
return 1 ;
}
...
{
return F_228 ( V_37 -> V_250 ) ;
}
static unsigned int F_229 ( const struct V_34 * V_37 )
{
unsigned int V_365 = F_230 ( V_37 , V_362 ) ;
return V_365 ? : F_222 ( V_37 -> V_250 ) ;
}
static struct V_368 * F_231 ( const struct V_34 * V_37 ,
struct V_98 * V_99 ,
const void * V_9 )
{
return V_37 -> V_250 -> V_93 -> V_369 ( V_37 , V_99 , V_9 ) ;
}
...
V_243 -> V_371 = V_372 ;
if ( F_156 ( V_243 -> V_373 == NULL ) )
V_243 -> V_373 = F_211 ;
if ( F_156 ( V_243 -> V_374 == NULL ) )
V_243 -> V_374 = F_227 ;
if ( F_156 ( V_243 -> V_365 == NULL ) )
V_243 -> V_365 = F_229 ;
if ( F_156 ( V_243 -> V_375 == NULL ) )
V_243 -> V_375 = F_217 ;
if ( F_156 ( V_243 -> V_376 == NULL ) )
V_243 -> V_376 = F_216 ;
if ( F_156 ( V_243 -> V_369 == NULL ) )
V_243 -> V_369 = F_231 ;
if ( F_156 ( V_32 -> V_377 == NULL ) )
V_32 -> V_377 = F_220 ;
...
switch ( V_32 -> V_28 ) {
case V_29 :
V_378 = & V_35 -> V_101 . V_244 ;
break;
#if F_154 ( V_245 )
case V_30 :
V_378 = & V_35 -> V_101 . V_246 ;
break;
#endif
default:
F_46 () ;
...
static int F_241 ( struct V_379 * V_380 , unsigned long V_381 , void * V_382 )
{
struct V_253 * V_254 = F_242 ( V_382 ) ;
switch ( V_381 ) {
case V_383 :
F_218 ( F_207 ( V_254 ) ) ;
}
...
{
int V_385 ;
V_35 -> V_386 . V_387 = F_244 ( struct V_388 ) ;
if ( ! V_35 -> V_386 . V_387 )
return - V_214 ;
V_385 = F_245 ( V_35 ) ;
if ( V_385 < 0 )
F_246 ( V_35 -> V_386 . V_387 ) ;
return V_385 ;
}
...
static int T_6 F_249 ( struct V_35 * V_35 )
{
unsigned int V_104 , V_389 ;
int V_60 ;
if ( F_250 ( V_35 , & V_390 ) )
V_372 = F_251 ( L_1 ,
sizeof( struct V_238 ) ,
...
NULL ) ;
V_104 = 8 - 1 ;
V_389 = ( V_104 + 1 ) * sizeof( struct V_103 ) ;
V_35 -> V_101 . V_127 = F_69 ( V_389 ) ;
if ( ! V_35 -> V_101 . V_127 )
goto V_393;
...
F_252 ( & V_35 -> V_101 . V_107 [ V_60 ] ) ;
V_395 = & V_35 -> V_101 . V_105 [ V_60 ] ;
V_395 -> V_108 = F_69 ( V_389 ) ;
if ( ! V_395 -> V_108 )
goto V_396;
V_395 -> V_104 = V_104 ;
}
F_37 ( & V_35 -> V_101 . V_175 ) ;
F_253 ( & V_35 -> V_101 . V_148 , F_79 ) ;
if ( F_250 ( V_35 , & V_390 ) )
F_254 ( & V_397 ) ;
return 0 ;
V_396:
...
struct V_394 * V_395 ;
V_395 = & V_35 -> V_101 . V_105 [ V_60 ] ;
F_72 ( V_395 -> V_108 , V_389 ) ;
}
F_72 ( V_35 -> V_101 . V_127 , V_389 ) ;
V_393:
return - V_214 ;
}
...
V_395 = & V_35 -> V_101 . V_105 [ V_60 ] ;
V_389 = ( V_395 -> V_104 + 1 ) * sizeof( struct V_103 ) ;
F_95 ( ! F_65 ( V_395 -> V_108 ) ) ;
F_72 ( V_395 -> V_108 , V_389 ) ;
}
V_389 = ( V_35 -> V_101 . V_102 + 1 ) * sizeof( struct V_103 ) ;
...
if ( V_385 < 0 )
goto V_64;
F_261 ( & V_35 -> V_101 . V_402 ) ;
F_39 ( & V_35 -> V_101 . V_124 ) ;
F_262 ( & V_35 -> V_101 . V_403 ) ;
return 0 ;
V_64:
F_263 ( V_35 ) ;
V_401:
...
if ( V_177 )
F_271 ( V_406 , L_2 ,
V_177 -> V_407 , V_177 -> V_408 , V_177 -> V_409 ) ;
switch ( V_2 -> V_28 ) {
case V_29 :
F_271 ( V_406 , L_3 , & V_2 -> V_12 . V_10 ) ;
if ( V_2 -> V_13 != 32 )
F_271 ( V_406 , L_4 ,
V_2 -> V_13 ) ;
F_271 ( V_406 , L_5 , & V_2 -> V_9 . V_10 ) ;
if ( V_2 -> V_11 != 32 )
F_271 ( V_406 , L_6 ,
V_2 -> V_11 ) ;
break;
case V_30 :
F_271 ( V_406 , L_7 , V_2 -> V_12 . V_410 ) ;
if ( V_2 -> V_13 != 128 )
F_271 ( V_406 , L_4 ,
V_2 -> V_13 ) ;
F_271 ( V_406 , L_8 , V_2 -> V_9 . V_410 ) ;
if ( V_2 -> V_11 != 128 )
F_271 ( V_406 , L_6 ,
V_2 -> V_11 ) ;
break;
...
void F_272 ( struct V_54 * V_55 , int V_411 , bool V_182 )
{
struct V_405 * V_406 ;
V_406 = F_273 ( L_9 ) ;
if ( V_406 == NULL )
return;
F_274 ( V_182 , V_406 ) ;
F_271 ( V_406 , L_10 , V_411 ) ;
F_270 ( V_55 , V_406 ) ;
F_275 ( V_406 ) ;
}
void F_105 ( struct V_54 * V_55 , int V_411 ,
bool V_182 )
{
struct V_405 * V_406 ;
V_406 = F_273 ( L_11 ) ;
...
static bool F_276 ( const struct V_1 * V_412 ,
const struct V_1 * V_413 )
{
if ( V_412 -> V_20 == V_414 ) {
if ( V_413 -> V_28 == V_412 -> V_28 &&
F_277 ( & V_413 -> V_9 , & V_412 -> V_9 ,
V_412 -> V_28 ) &&
F_277 ( & V_413 -> V_12 , & V_412 -> V_12 ,
V_412 -> V_28 ) &&
V_413 -> V_11 == V_412 -> V_11 &&
V_413 -> V_13 == V_412 -> V_13 ) {
return true ;
}
} else {
if ( memcmp ( V_413 , V_412 , sizeof( * V_413 ) ) == 0 ) {
return true ;
}
}
return false ;
...
static int F_279 ( const struct V_415 * V_167 , const struct V_212 * V_416 )
{
int V_191 = 0 ;
if ( V_416 -> V_220 == V_167 -> V_220 && V_416 -> V_45 . V_20 == V_167 -> V_20 &&
( V_167 -> V_329 == 0 || V_416 -> V_329 == V_167 -> V_329 ) ) {
switch ( V_416 -> V_220 ) {
case V_221 :
case V_222 :
if ( F_277 ( & V_416 -> V_45 . V_9 , & V_167 -> V_417 ,
V_167 -> V_418 ) &&
F_277 ( & V_416 -> V_12 , & V_167 -> V_419 ,
V_167 -> V_418 ) ) {
V_191 = 1 ;
}
break;
...
struct V_415 * V_167 , int V_420 )
{
struct V_415 * V_421 ;
int V_123 , V_422 , V_423 = 0 ;
F_70 ( & V_81 -> V_61 ) ;
if ( F_9 ( V_81 -> V_62 . V_63 ) ) {
F_71 ( & V_81 -> V_61 ) ;
return - V_181 ;
...
for ( V_422 = 0 , V_421 = V_167 ; V_422 < V_420 ; V_422 ++ , V_421 ++ ) {
if ( ! F_279 ( V_421 , & V_81 -> V_211 [ V_123 ] ) )
continue;
V_423 ++ ;
if ( V_81 -> V_211 [ V_123 ] . V_220 != V_221 &&
V_81 -> V_211 [ V_123 ] . V_220 != V_222 )
continue;
memcpy ( & V_81 -> V_211 [ V_123 ] . V_45 . V_9 , & V_421 -> V_424 ,
sizeof( V_81 -> V_211 [ V_123 ] . V_45 . V_9 ) ) ;
memcpy ( & V_81 -> V_211 [ V_123 ] . V_12 , & V_421 -> V_425 ,
sizeof( V_81 -> V_211 [ V_123 ] . V_12 ) ) ;
V_81 -> V_211 [ V_123 ] . V_223 = V_421 -> V_426 ;
F_53 ( & V_81 -> V_100 ) ;
}
}
F_71 ( & V_81 -> V_61 ) ;
...
static int F_281 ( const struct V_415 * V_167 , int V_420 )
{
int V_123 , V_422 ;
if ( V_420 < 1 || V_420 > V_233 )
return - V_189 ;
for ( V_123 = 0 ; V_123 < V_420 ; V_123 ++ ) {
if ( F_277 ( & V_167 [ V_123 ] . V_417 , & V_167 [ V_123 ] . V_424 ,
V_167 [ V_123 ] . V_418 ) &&
F_277 ( & V_167 [ V_123 ] . V_419 , & V_167 [ V_123 ] . V_425 ,
V_167 [ V_123 ] . V_418 ) )
return - V_189 ;
if ( F_141 ( & V_167 [ V_123 ] . V_424 , V_167 [ V_123 ] . V_426 ) ||
F_141 ( & V_167 [ V_123 ] . V_425 , V_167 [ V_123 ] . V_426 ) )
return - V_189 ;
for ( V_422 = V_123 + 1 ; V_422 < V_420 ; V_422 ++ ) {
if ( ! memcmp ( & V_167 [ V_123 ] . V_417 , & V_167 [ V_422 ] . V_417 ,
sizeof( V_167 [ V_123 ] . V_417 ) ) &&
! memcmp ( & V_167 [ V_123 ] . V_419 , & V_167 [ V_422 ] . V_419 ,
sizeof( V_167 [ V_123 ] . V_419 ) ) &&
V_167 [ V_123 ] . V_20 == V_167 [ V_422 ] . V_20 &&
V_167 [ V_123 ] . V_220 == V_167 [ V_422 ] . V_220 &&
V_167 [ V_123 ] . V_329 == V_167 [ V_422 ] . V_329 &&
V_167 [ V_123 ] . V_418 == V_167 [ V_422 ] . V_418 )
return - V_189 ;
}
}
return 0 ;
}
int V_415 ( const struct V_1 * V_2 , T_4 V_60 , T_4 type ,
struct V_415 * V_167 , int V_420 ,
struct V_428 * V_338 , struct V_35 * V_35 )
{
int V_123 , V_179 , V_429 = 0 , V_430 = 0 ;
struct V_54 * V_81 = NULL ;
struct V_40 * V_41 , * V_431 ;
struct V_40 * V_432 [ V_233 ] ;
struct V_40 * V_433 [ V_233 ] ;
struct V_415 * V_421 ;
if ( ( V_179 = F_281 ( V_167 , V_420 ) ) < 0 )
goto V_64;
if ( ( V_81 = F_278 ( V_2 , V_60 , type , V_35 ) ) == NULL ) {
V_179 = - V_181 ;
goto V_64;
}
for ( V_123 = 0 , V_421 = V_167 ; V_123 < V_420 ; V_123 ++ , V_421 ++ ) {
if ( ( V_41 = F_282 ( V_421 , V_35 ) ) ) {
V_432 [ V_429 ] = V_41 ;
V_429 ++ ;
if ( ( V_431 = F_283 ( V_41 , V_421 ) ) ) {
V_433 [ V_430 ] = V_431 ;
V_430 ++ ;
} else {
V_179 = - V_427 ;
...
if ( ( V_179 = F_280 ( V_81 , V_167 , V_420 ) ) < 0 )
goto V_434;
if ( V_429 ) {
F_284 ( V_432 , V_429 ) ;
F_285 ( V_432 , V_429 ) ;
}
F_286 ( V_2 , V_60 , type , V_167 , V_420 , V_338 ) ;
F_28 ( V_81 ) ;
return 0 ;
V_64:
return V_179 ;
