...
static int F_23 ( struct V_31 * V_32 , void * V_33 )
{
struct V_1 * V_7 = F_1 ( F_24 ( V_32 ) ) ;
V_14 V_34 ;
int V_27 ;
F_21 (i) {
V_34 = F_13 ( V_7 , V_27 ) ;
F_25 ( V_32 , L_1 , ( unsigned long long ) V_34 ) ;
}
F_25 ( V_32 , L_2 ) ;
return 0 ;
}
static int F_26 ( struct V_31 * V_35 , void * V_36 )
{
struct V_1 * V_7 = F_1 ( F_24 ( V_35 ) ) ;
int V_20 ;
T_1 V_23 = 0 ;
F_27 (cpu) {
struct V_17 * V_37 = F_14 ( V_7 -> V_16 , V_20 ) ;
V_23 += V_37 -> V_16 [ V_38 ] ;
V_23 += V_37 -> V_16 [ V_39 ] ;
}
V_23 = F_28 ( V_23 ) ;
F_25 ( V_35 , L_3 , V_40 [ V_41 ] , V_23 ) ;
V_23 = 0 ;
F_27 (cpu) {
struct V_17 * V_37 = F_14 ( V_7 -> V_16 , V_20 ) ;
V_23 += V_37 -> V_16 [ V_42 ] ;
...
V_23 = F_28 ( V_23 ) ;
F_25 ( V_35 , L_3 , V_40 [ V_45 ] , V_23 ) ;
return 0 ;
}
void F_29 ( struct V_4 * V_5 , V_14 V_46 )
{
struct V_1 * V_7 ;
int V_20 ;
V_20 = F_30 ( V_5 ) ;
...
void F_33 ( struct V_4 * V_47 , int V_48 , V_14 V_23 )
{
struct V_17 * V_37 ;
struct V_1 * V_7 ;
F_31 () ;
