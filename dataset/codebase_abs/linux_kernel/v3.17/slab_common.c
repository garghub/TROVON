...
static T_5 void * F_96 ( const void * V_69 , T_1 V_89 ,
T_3 V_16 )
{
void * V_13 ;
T_1 V_90 = 0 ;
...
V_13 = F_98 ( V_89 , V_16 ) ;
if ( V_13 && V_69 )
memcpy ( V_13 , V_69 , V_90 ) ;
return V_13 ;
}
void * F_99 ( const void * V_69 , T_1 V_89 , T_3 V_16 )
{
if ( F_59 ( ! V_89 ) )
return V_49 ;
return F_96 ( V_69 , V_89 , V_16 ) ;
}
void * F_100 ( const void * V_69 , T_1 V_89 , T_3 V_16 )
{
void * V_13 ;
if ( F_59 ( ! V_89 ) ) {
F_27 ( V_69 ) ;
...
V_13 = F_96 ( V_69 , V_89 , V_16 ) ;
if ( V_13 && V_69 != V_13 )
F_27 ( V_69 ) ;
return V_13 ;
}
void F_101 ( const void * V_69 )
{
T_1 V_90 ;
void * V_91 = ( void * ) V_69 ;
if ( F_59 ( F_102 ( V_91 ) ) )
