...
static int F_30 ( struct V_91 * V_42 )
{
struct V_5 * V_6 ;
struct V_24 * V_25 ;
int V_13 ;
V_25 = F_31 ( & V_42 -> V_52 , sizeof( * V_6 ) ) ;
if ( V_25 == NULL )
return - V_92 ;
V_6 = F_7 ( V_25 ) ;
F_32 ( V_42 , V_25 ) ;
V_6 -> V_26 = & V_93 [ F_33 ( V_42 ) -> V_94 ] ;
V_25 -> V_52 . V_95 = & V_42 -> V_52 ;
V_25 -> V_59 = F_33 ( V_42 ) -> V_59 ;
...
V_25 -> V_102 = V_103 ;
V_13 = F_34 ( & V_6 -> V_14 , V_25 , V_42 , & V_104 ) ;
if ( V_13 )
return V_13 ;
V_13 = F_35 ( & V_6 -> V_14 , V_25 ,
V_105 ) ;
if ( V_13 )
return V_13 ;
V_13 = F_20 ( V_25 ) ;
...
static int F_38 ( struct V_91 * V_42 )
{
struct V_24 * V_25 = F_39 ( V_42 ) ;
struct V_5 * V_6 = F_7 ( V_25 ) ;
F_40 ( V_25 ) ;
F_18 ( V_25 ) ;
F_37 ( & V_6 -> V_14 , V_25 ) ;
