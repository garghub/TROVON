...
V_2 -> V_204 . V_206 = V_206 ;
V_2 -> V_204 . V_207 = & V_2 -> V_207 ;
F_108 ( & V_2 -> V_204 , V_2 ) ;
V_88 = F_109 ( & V_2 -> V_204 , V_208 , - 1 ) ;
if ( V_88 )
F_10 ( L_30 ) ;
else
F_110 ( L_31 ,
...
static int F_112 ( struct V_209 * V_94 ,
...
F_122 ( V_2 ) ;
V_213 = V_94 -> V_218 ;
for ( V_12 = 0 ; V_12 < V_213 -> V_219 . V_220 ; ++ V_12 ) {
V_215 = & V_213 -> V_215 [ V_12 ] . V_219 ;
if ( ! V_2 -> V_67
&& F_123 ( V_215 ) ) {
V_2 -> V_67 = F_124 ( V_215 ) ;
break;
}
}
if ( ! V_2 -> V_67 ) {
...
static void F_128 ( struct V_209 * V_94 )
{
...
static int F_133 ( struct V_209 * V_222 , T_8 V_223 )
{
struct V_1 * V_2 = F_129 ( V_222 ) ;
if ( F_65 ( V_2 ) ) {
F_16 ( V_2 ) ;
F_15 ( V_2 ) ;
}
...
static int F_134 ( struct V_209 * V_222 )
{
struct V_1 * V_2 = F_129 ( V_222 ) ;
if ( ! F_9 ( V_2 ) )
return 0 ;
