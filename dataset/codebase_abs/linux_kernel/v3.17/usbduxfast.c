...
if ( ! V_7 )
return - V_24 ;
F_18 ( V_7 -> V_21 , V_5 , F_19 ( V_5 , V_51 ) ,
V_7 -> V_52 , V_53 ,
F_12 , V_2 ) ;
V_10 = F_16 ( V_7 -> V_21 , V_50 ) ;
if ( V_10 ) {
...
V_33 |= F_21 ( & V_31 -> V_61 ,
V_62 | V_59 ) ;
V_33 |= F_21 ( & V_31 -> V_63 , V_64 | V_59 ) ;
V_33 |= F_21 ( & V_31 -> V_65 , V_44 ) ;
V_33 |= F_21 ( & V_31 -> V_43 , V_44 | V_66 ) ;
if ( V_33 )
return 1 ;
V_33 |= F_22 ( V_31 -> V_57 ) ;
V_33 |= F_22 ( V_31 -> V_61 ) ;
...
if ( V_33 )
return 2 ;
V_33 |= F_23 ( & V_31 -> V_68 , 0 ) ;
if ( ! V_31 -> V_69 )
V_33 |= - V_67 ;
V_33 |= F_23 ( & V_31 -> V_70 , V_31 -> V_69 ) ;
if ( V_31 -> V_69 == 1 )
V_56 = 1 ;
else
V_56 = V_71 ;
...
V_54 = V_73 * 1000 ;
V_55 = V_54 / 30 ;
V_33 |= F_23 ( & V_31 -> V_72 , V_55 ) ;
}
switch ( V_31 -> V_43 ) {
case V_44 :
V_33 |= F_24 ( & V_31 -> V_74 , 1 ) ;
break;
case V_66 :
V_33 |= F_23 ( & V_31 -> V_74 , 0 ) ;
break;
default:
break;
}
...
V_23 -> V_29 -> V_85 = 0 ;
V_7 -> V_42 = V_86 ;
V_78 = F_27 ( V_31 -> V_87 [ 0 ] ) ;
for ( V_80 = 0 ; V_80 < V_31 -> V_69 ; ++ V_80 ) {
V_77 = F_28 ( V_31 -> V_87 [ V_80 ] ) ;
if ( V_77 != V_80 ) {
F_5 ( V_2 -> V_14 ,
L_8 ) ;
F_11 ( & V_7 -> V_25 ) ;
...
int V_15 = V_81 * 2 ;
if ( F_27 ( V_31 -> V_87 [ V_81 ] ) > 0 )
V_79 = 0xff - 0x04 ;
else
V_79 = 0xff ;
F_6 ( V_2 , V_15 , V_54 / 2 ,
0x02 , V_79 , 0x00 ) ;
if ( F_27 ( V_31 -> V_87 [ V_81 + 1 ] ) > 0 )
V_79 = 0xff - 0x04 ;
else
V_79 = 0xff ;
...
struct V_4 * V_5 = F_2 ( V_2 ) ;
struct V_6 * V_7 = V_2 -> V_8 ;
unsigned int V_77 = F_28 ( V_92 -> V_94 ) ;
unsigned int V_95 = F_27 ( V_92 -> V_94 ) ;
...
V_7 = F_40 ( V_2 , sizeof( * V_7 ) ) ;
if ( ! V_7 )
return - V_114 ;
F_41 ( & V_7 -> V_25 , 1 ) ;
F_42 ( V_123 , V_7 ) ;
V_7 -> V_11 = F_34 ( V_13 , V_115 ) ;
if ( ! V_7 -> V_11 )
return - V_114 ;
V_10 = F_43 ( V_5 ,
...
V_7 -> V_21 = F_44 ( 0 , V_115 ) ;
if ( ! V_7 -> V_21 ) {
F_5 ( V_2 -> V_14 , L_25 ) ;
return - V_114 ;
}
V_7 -> V_52 = F_34 ( V_53 , V_115 ) ;
if ( ! V_7 -> V_52 )
return - V_114 ;
V_10 = F_45 ( V_2 , & V_5 -> V_2 , V_130 ,
F_32 , 0 ) ;
if ( V_10 )
return V_10 ;
return F_30 ( V_2 ) ;
