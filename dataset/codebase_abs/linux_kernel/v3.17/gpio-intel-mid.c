...
static void F_22 ( unsigned V_40 , struct V_41 * V_42 )
{
struct V_2 * V_3 = F_23 ( V_42 ) ;
struct V_1 * V_8 = F_1 ( V_3 ) ;
struct V_30 * V_43 = F_24 ( V_42 ) ;
struct V_44 * V_4 = F_25 ( V_43 ) ;
T_3 V_45 , V_32 , V_46 ;
unsigned long V_47 ;
void T_1 * V_48 ;
for ( V_45 = 0 ; V_45 < V_8 -> V_4 . V_10 ; V_45 += 32 ) {
V_48 = F_3 ( & V_8 -> V_4 , V_45 , V_49 ) ;
while ( ( V_47 = F_6 ( V_48 ) ) ) {
V_32 = F_26 ( V_47 ) ;
V_46 = F_9 ( V_32 ) ;
F_7 ( V_46 , V_48 ) ;
...
unsigned V_45 ;
for ( V_45 = 0 ; V_45 < V_8 -> V_4 . V_10 ; V_45 += 32 ) {
V_11 = F_3 ( & V_8 -> V_4 , V_45 , V_34 ) ;
F_7 ( 0 , V_11 ) ;
V_11 = F_3 ( & V_8 -> V_4 , V_45 , V_36 ) ;
F_7 ( 0 , V_11 ) ;
V_11 = F_3 ( & V_8 -> V_4 , V_45 , V_49 ) ;
F_7 ( ~ 0 , V_11 ) ;
}
}
static int F_30 ( struct V_52 * V_28 )
{
int V_53 = F_31 ( V_28 , 500 ) ;
return V_53 ? : - V_54 ;
}
static int F_32 ( struct V_55 * V_27 ,
...
int V_60 ;
struct V_61 * V_62 =
(struct V_61 * ) V_57 -> V_63 ;
V_60 = F_33 ( V_27 ) ;
if ( V_60 )
return V_60 ;
V_60 = F_34 ( V_27 , 1 << 0 | 1 << 1 , F_35 ( V_27 ) ) ;
if ( V_60 ) {
F_36 ( & V_27 -> V_28 , L_1 ) ;
return V_60 ;
}
V_45 = F_37 ( V_27 ) [ 1 ] ;
V_59 = F_6 ( V_45 ) ;
V_58 = F_6 ( sizeof( T_3 ) + V_45 ) ;
F_38 ( V_27 , 1 << 1 ) ;
V_8 = F_39 ( & V_27 -> V_28 , sizeof( * V_8 ) , V_64 ) ;
if ( ! V_8 ) {
F_36 ( & V_27 -> V_28 , L_2 ) ;
return - V_65 ;
}
V_8 -> V_12 = F_37 ( V_27 ) [ 0 ] ;
V_8 -> V_4 . V_66 = F_40 ( & V_27 -> V_28 ) ;
