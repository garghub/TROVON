...
static struct V_159 *
F_65 ( struct V_166 * V_165 )
{
struct V_163 * V_164 = F_66 ( V_165 ) ;
return V_164 -> V_160 ;
}
static void F_67 ( struct V_166 * V_165 )
{
struct V_163 * V_164 = F_66 ( V_165 ) ;
F_68 ( V_164 ) ;
F_69 ( V_165 ) ;
...
static enum V_185
F_71 ( struct V_166 * V_165 , bool V_186 )
{
return V_187 ;
}
...
if ( V_3 < 0 )
goto V_192;
V_3 = F_77 ( V_165 , V_160 ) ;
if ( V_3 < 0 )
goto V_193;
V_165 -> V_160 = V_160 ;
F_78 ( V_165 , V_141 ) ;
F_79 ( & V_165 -> V_151 ,
V_2 -> V_83 -> V_194 . V_195 , V_141 ) ;
return 0 ;
V_193:
F_68 ( & V_2 -> V_165 ) ;
V_192:
