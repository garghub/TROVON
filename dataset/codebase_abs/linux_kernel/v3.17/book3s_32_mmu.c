...
{
return F_9 ( V_2 , ( V_6 >> 28 ) & 0xf ) ;
}
static T_3 F_10 ( struct V_1 * V_2 , T_2 V_6 ,
bool V_7 )
{
T_3 V_8 ;
struct V_9 V_10 ;
if ( ! F_11 ( V_2 , V_6 , & V_10 , V_7 , false ) )
return V_10 . V_11 ;
F_12 ( V_2 , V_6 >> V_12 , & V_8 ) ;
...
F_17 ( L_1 ,
F_18 ( V_2 ) , V_6 , V_16 -> V_22 , V_19 ,
F_3 ( V_13 ) ) ;
V_21 = F_19 ( V_2 -> V_23 , V_19 >> V_24 ) ;
if ( F_20 ( V_21 ) )
return V_21 ;
return V_21 | ( V_19 & ~ V_25 ) ;
}
static T_1 F_21 ( T_1 V_13 , T_2 V_6 , bool V_14 )
{
...
static int F_25 ( struct V_1 * V_2 , T_2 V_6 ,
struct V_9 * V_10 , bool V_7 ,
bool V_26 , bool V_14 )
{
T_1 V_13 ;
...
F_23 ( L_5 , V_6 >> 28 ,
F_3 ( V_13 ) , V_13 ) ;
V_10 -> V_11 = F_10 ( V_2 , V_6 , V_7 ) ;
V_45 = F_15 ( V_2 , V_13 , V_6 , V_14 ) ;
if ( F_20 ( V_45 ) ) {
F_24 ( V_43 L_6 ) ;
goto V_50;
}
V_48 = F_21 ( V_13 , V_6 , V_14 ) ;
if( F_26 ( V_19 , ( void V_51 * ) V_45 , sizeof( V_19 ) ) ) {
F_24 ( V_52 L_7 , V_45 ) ;
goto V_50;
}
for ( V_29 = 0 ; V_29 < 16 ; V_29 += 2 ) {
V_46 = F_27 ( V_19 [ V_29 ] ) ;
V_47 = F_27 ( V_19 [ V_29 + 1 ] ) ;
if ( V_48 == V_46 ) {
T_5 V_40 ;
V_10 -> V_37 = ( V_47 & ~ ( 0xFFFULL ) ) | ( V_6 & 0xFFF ) ;
V_40 = V_47 & 3 ;
if ( ( F_6 ( V_13 ) && ( F_22 ( V_2 ) & V_32 ) ) ||
( F_5 ( V_13 ) && ! ( F_22 ( V_2 ) & V_32 ) ) )
V_40 |= 4 ;
V_10 -> V_41 = false ;
V_10 -> V_39 = false ;
V_10 -> V_42 = true ;
...
F_23 ( L_10 ,
V_29 , F_27 ( V_19 [ V_29 ] ) ,
F_27 ( V_19 [ V_29 + 1 ] ) , V_48 ) ;
}
}
return - V_44 ;
}
static int F_29 ( struct V_1 * V_2 , T_2 V_6 ,
struct V_9 * V_10 , bool V_7 ,
bool V_26 )
{
int V_21 ;
...
V_10 -> V_60 = V_61 ;
if ( F_30 ( V_58 ) &&
F_30 ( ( V_6 & ~ 0xfffULL ) == ( V_58 & ~ 0xfffULL ) ) &&
! ( F_22 ( V_2 ) & V_32 ) ) {
V_10 -> V_11 = F_10 ( V_2 , V_6 , V_7 ) ;
...
V_21 = F_11 ( V_2 , V_6 , V_10 , V_7 , V_26 ) ;
if ( V_21 < 0 )
V_21 = F_25 ( V_2 , V_6 , V_10 ,
V_7 , V_26 , true ) ;
if ( V_21 == - V_44 )
V_21 = F_25 ( V_2 , V_6 , V_10 ,
V_7 , V_26 , false ) ;
...
static T_1 F_31 ( struct V_1 * V_2 , T_1 V_64 )
{
return F_9 ( V_2 , V_64 ) ;
}
static void F_32 ( struct V_1 * V_2 , T_1 V_64 ,
T_6 V_65 )
{
F_33 ( V_2 , V_64 , V_65 ) ;
F_34 ( V_2 , V_64 << V_12 ) ;
}
static void F_35 ( struct V_1 * V_2 , T_6 V_66 , bool V_67 )
{
int V_29 ;
struct V_1 * V_68 ;
F_36 (i, v, vcpu->kvm)
F_37 ( V_68 , V_66 , 0x0FFFF000 ) ;
}
static int F_12 ( struct V_1 * V_2 , T_6 V_69 ,
T_3 * V_8 )
{
T_6 V_66 = V_69 << V_12 ;
T_1 V_70 ;
