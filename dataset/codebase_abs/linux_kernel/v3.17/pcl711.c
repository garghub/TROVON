...
unsigned int V_11 = V_20 -> V_87 [ V_40 ] ;
int V_58 ;
for ( V_58 = 0 ; V_58 < V_52 -> V_59 ; V_58 ++ ) {
V_11 = V_26 [ V_58 ] ;
F_31 ( V_2 , V_40 , V_11 ) ;
...
{
const struct V_96 * V_97 = F_40 ( V_2 ) ;
struct V_19 * V_20 ;
struct V_9 * V_10 ;
int V_57 ;
...
if ( ! V_20 )
return - V_98 ;
V_57 = F_42 ( V_2 , V_95 -> V_99 [ 0 ] , 0x10 ) ;
if ( V_57 )
return V_57 ;
if ( V_95 -> V_99 [ 1 ] && V_95 -> V_99 [ 1 ] <= V_97 -> V_100 ) {
V_57 = F_43 ( V_95 -> V_99 [ 1 ] , F_7 , 0 ,
V_2 -> V_101 , V_2 ) ;
if ( V_57 == 0 )
V_2 -> V_6 = V_95 -> V_99 [ 1 ] ;
}
...
V_10 = & V_2 -> V_102 [ 0 ] ;
V_10 -> type = V_103 ;
V_10 -> V_104 = V_105 | V_106 ;
if ( V_97 -> V_107 > 8 )
V_10 -> V_104 |= V_108 ;
V_10 -> V_45 = V_97 -> V_107 ;
V_10 -> V_14 = 0xfff ;
V_10 -> V_109 = V_97 -> V_110 ;
V_10 -> V_111 = F_18 ;
if ( V_2 -> V_6 ) {
V_2 -> V_22 = V_10 ;
V_10 -> V_104 |= V_112 ;
