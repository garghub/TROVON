...
static void F_136 ( struct V_61 * V_62 )
{
struct V_16 * V_17 = V_62 -> V_236 ;
...
V_242 = ( unsigned short ) ( V_46 -> V_37 . V_234 & V_253 ) ;
V_242 -= V_250 ;
F_138 ( V_11 , V_242 ) ;
V_11 -> V_254 = F_139 ( V_11 , V_17 ) ;
F_98 ( V_17 , V_11 ) ;
#if F_2 ( V_151 )
...
V_249 [ V_5 + 1 ] = ~ V_11 -> V_44 [ V_11 -> V_242 + V_5 ] ;
V_11 -> V_256 = F_140 ( V_249 , V_250 + 1 , V_11 -> V_256 ) ;
} else {
for ( V_5 = 0 ; V_5 < V_250 ; V_5 ++ )
V_249 [ V_5 ] = ~ V_11 -> V_44 [ V_11 -> V_242 + V_5 ] ;
V_11 -> V_256 = F_140 ( V_249 , V_250 , V_11 -> V_256 ) ;
}
V_11 -> V_258 = V_259 ;
}
#endif
F_141 ( & V_62 -> V_260 , V_11 ) ;
V_17 -> V_245 . V_261 ++ ;
...
static int F_142 ( struct V_263 * V_260 , int V_264 )
{
int V_5 = 0 ;
struct V_61 * V_62 = F_110 ( V_260 ,
struct V_61 ,
V_260 ) ;
while ( V_46 -> V_37 . V_234 != 0 && V_5 < V_264 ) {
F_136 ( V_62 ) ;
V_5 ++ ;
}
if ( V_5 < V_264 ) {
F_143 ( V_260 ) ;
if ( F_144 ( V_265 , & V_62 -> V_65 ) )
F_145 ( V_266 ) ;
}
return V_5 ;
}
static T_2 F_146 ( int V_105 , void * V_106 )
{
struct V_61 * V_62 = F_22 ( V_106 ) ;
V_59 V_37 ;
V_37 = F_147 () ;
F_148 ( V_37 | V_267 | V_268 ) ;
if ( V_37 & V_267 ) {
F_149 ( V_266 ) ;
F_150 ( V_265 , & V_62 -> V_65 ) ;
F_151 ( & V_62 -> V_260 ) ;
}
return V_107 ;
}
...
static int F_167 ( struct V_16 * V_174 , struct V_175 * V_176 , int V_109 )
{
struct V_61 * V_62 = F_22 ( V_174 ) ;
if ( ! F_75 ( V_174 ) )
return - V_91 ;
...
default:
if ( V_62 -> V_64 )
return F_168 ( V_62 -> V_64 , V_176 , V_109 ) ;
else
return - V_131 ;
}
}
...
static int F_176 ( struct V_16 * V_17 )
{
struct V_61 * V_62 = F_22 ( V_17 ) ;
F_28 ( L_16 , V_17 -> V_104 , V_185 ) ;
F_127 ( V_17 ) ;
...
F_178 ( V_17 ) ;
F_179 ( V_62 -> V_64 ) ;
F_180 ( V_62 -> V_64 , V_292 , V_293 ) ;
F_169 ( V_17 ) ;
F_1 () ;
return 0 ;
}
static int F_181 ( struct V_294 * V_295 )
{
struct V_16 * V_236 ;
struct V_61 * V_62 ;
struct V_294 * V_296 ;
struct V_297 * V_298 ;
int V_125 ;
V_236 = F_182 ( sizeof( struct V_61 ) ) ;
if ( ! V_236 )
return - V_47 ;
F_183 ( V_236 , & V_295 -> V_17 ) ;
F_184 ( V_295 , V_236 ) ;
V_62 = F_22 ( V_236 ) ;
V_62 -> V_236 = V_236 ;
* ( V_159 * ) ( & ( V_236 -> V_166 [ 0 ] ) ) = F_185 ( F_186 () ) ;
* ( V_161 * ) ( & ( V_236 -> V_166 [ 4 ] ) ) = F_187 ( ( V_57 ) F_188 () ) ;
F_72 ( 0x12345678 ) ;
if ( F_186 () != 0x12345678 ) {
F_189 ( & V_295 -> V_17 , L_20 ) ;
V_125 = - V_89 ;
goto V_299;
}
if ( ! F_171 ( V_236 -> V_166 ) ) {
if ( F_190 ( V_236 -> V_166 ) ||
! F_171 ( V_236 -> V_166 ) ) {
F_26 ( V_236 , L_21 ) ;
F_191 ( V_236 ) ;
}
...
F_69 ( V_236 -> V_166 ) ;
if ( ! F_192 ( & V_295 -> V_17 ) ) {
F_189 ( & V_295 -> V_17 , L_22 ) ;
V_125 = - V_89 ;
goto V_299;
}
V_296 = F_192 ( & V_295 -> V_17 ) ;
V_62 -> V_52 = F_193 ( V_296 ) ;
if ( ! V_62 -> V_52 ) {
F_189 ( & V_295 -> V_17 , L_23 ) ;
V_125 = - V_89 ;
goto V_299;
}
V_62 -> V_52 -> V_300 = V_236 ;
V_298 = F_192 ( & V_296 -> V_17 ) ;
V_125 = F_30 ( V_236 , V_298 -> V_79 ) ;
if ( V_125 ) {
F_189 ( & V_295 -> V_17 , L_24 ) ;
goto V_301;
}
...
V_62 -> V_237 . V_307 = F_131 ;
V_62 -> V_65 = 0 ;
F_196 ( V_236 , & V_62 -> V_260 , F_142 , V_15 ) ;
F_120 ( & V_62 -> V_67 ) ;
V_125 = F_53 ( V_266 , F_146 ,
0 , L_25 , V_236 ) ;
if ( V_125 ) {
F_189 ( & V_295 -> V_17 , L_26 ) ;
V_125 = - V_165 ;
goto V_308;
}
V_125 = F_197 ( V_236 ) ;
if ( V_125 ) {
F_189 ( & V_295 -> V_17 , L_27 ) ;
goto V_309;
}
F_100 ( V_236 ) ;
V_125 = F_117 ( V_236 , & V_295 -> V_17 ) ;
if ( V_125 ) {
F_189 ( & V_295 -> V_17 , L_28 ) ;
goto V_310;
}
F_165 ( V_236 , L_29 , V_311 , V_117 ) ;
return 0 ;
V_310:
V_309:
F_54 ( V_266 , V_236 ) ;
...
static int F_202 ( struct V_294 * V_295 )
{
struct V_16 * V_236 = F_193 ( V_295 ) ;
struct V_61 * V_62 = F_22 ( V_236 ) ;
F_121 ( V_62 ) ;
...
static int F_204 ( struct V_294 * V_295 , T_7 V_312 )
{
struct V_16 * V_313 = F_193 ( V_295 ) ;
struct V_61 * V_62 = F_22 ( V_313 ) ;
if ( V_62 -> V_124 ) {
F_25 ( ( F_24 () & ~ V_244 ) | V_269 ) ;
F_205 ( V_314 ) ;
F_206 ( V_133 ) ;
} else {
if ( F_75 ( V_313 ) )
...
static int F_209 ( struct V_294 * V_295 )
{
struct V_52 * V_315 ;
struct V_297 * V_316 ;
const unsigned short * V_317 ;
int V_125 , V_5 ;
V_316 = F_192 ( & V_295 -> V_17 ) ;
if ( ! V_316 ) {
F_189 ( & V_295 -> V_17 , L_30 ) ;
return - V_91 ;
}
V_317 = V_316 -> V_318 ;
V_125 = F_210 ( V_317 , V_115 ) ;
if ( V_125 ) {
F_189 ( & V_295 -> V_17 , L_31 ) ;
return V_125 ;
}
V_125 = - V_47 ;
V_315 = F_211 () ;
...
V_315 -> V_320 = F_14 ;
V_315 -> V_321 = F_19 ;
V_315 -> V_322 = & V_295 -> V_17 ;
V_315 -> V_104 = L_32 ;
V_315 -> V_323 = V_316 -> V_323 ;
snprintf ( V_315 -> V_324 , V_325 , L_33 ,
V_295 -> V_104 , V_295 -> V_324 ) ;
V_315 -> V_105 = F_212 ( sizeof( int ) * V_86 , V_326 ) ;
if ( ! V_315 -> V_105 )
goto V_327;
for ( V_5 = V_125 ; V_5 < V_86 ; ++ V_5 )
V_315 -> V_105 [ V_5 ] = V_148 ;
V_125 = F_213 ( V_316 -> V_328 , 0 , V_86 ) ;
if ( V_125 != V_316 -> V_328 )
F_189 ( & V_295 -> V_17 , L_34 ,
V_316 -> V_328 ) ;
for ( V_5 = 0 ; V_5 < V_125 ; ++ V_5 ) {
unsigned short V_329 = V_316 -> V_330 [ V_5 ] . V_164 ;
if ( V_329 < V_86 )
V_315 -> V_105 [ V_329 ] = V_316 -> V_330 [ V_5 ] . V_105 ;
else
F_189 ( & V_295 -> V_17 ,
L_35 ,
V_329 , V_5 ) ;
...
static int F_217 ( struct V_294 * V_295 )
{
struct V_52 * V_315 = F_193 ( V_295 ) ;
struct V_297 * V_316 =
F_192 ( & V_295 -> V_17 ) ;
F_199 ( V_315 ) ;
F_215 ( V_315 -> V_105 ) ;
