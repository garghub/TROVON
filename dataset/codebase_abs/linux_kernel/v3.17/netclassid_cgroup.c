...
static int F_11 ( const void * V_13 , struct V_14 * V_14 , unsigned V_15 )
{
int V_16 ;
struct V_17 * V_18 = F_12 ( V_14 , & V_16 ) ;
if ( V_18 )
...
F_14 (p, tset) {
F_15 ( V_5 ) ;
F_16 ( V_5 -> V_24 , 0 , F_11 , V_13 ) ;
F_17 ( V_5 ) ;
}
}
static T_1 F_18 ( struct V_2 * V_3 , struct V_25 * V_26 )
{
return F_1 ( V_3 ) -> V_12 ;
}
static int F_19 ( struct V_2 * V_3 , struct V_25 * V_26 ,
T_1 V_27 )
{
