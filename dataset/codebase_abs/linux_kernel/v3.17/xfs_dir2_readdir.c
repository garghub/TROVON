...
if ( F_7 ( V_21 , V_10 -> V_34 ) > V_21 -> V_35 )
return 0 ;
error = F_13 ( NULL , V_13 , & V_50 ) ;
if ( error )
return error ;
V_56 = F_14 ( V_21 , V_10 -> V_34 ) ;
V_48 = V_50 -> V_58 ;
F_15 ( V_13 , V_50 ) ;
V_51 = F_16 ( V_21 , V_48 ) ;
...
V_68 -> V_82 = F_23 ( V_66 + V_21 -> V_83 , ( 1 << V_21 -> V_84 ) ) - 1 ;
ASSERT ( V_68 -> V_82 >= 0 ) ;
if ( 1 + V_68 -> V_82 > V_68 -> V_76 &&
V_68 -> V_85 < F_24 ( V_21 , V_86 ) ) {
V_68 -> V_87 = V_68 -> V_88 - V_68 -> V_81 ;
error = F_25 ( V_13 , V_68 -> V_85 ,
F_24 ( V_21 , V_86 ) -
V_68 -> V_85 ,
...
if ( ! V_68 -> V_81 ) {
* V_69 = F_26 ( V_21 , V_68 -> V_85 ) ;
goto V_89;
}
V_68 -> V_91 = F_27 ( V_21 , V_72 -> V_80 ) ;
error = F_28 ( NULL , V_13 , V_72 -> V_80 ,
V_72 -> V_78 >= V_21 -> V_77 ?
F_29 ( V_13 -> V_28 , V_72 -> V_79 ) :
- 1 , & V_50 ) ;
if ( error )
goto V_89;
if ( V_68 -> V_92 )
...
if ( V_10 -> V_34 >= V_98 )
return 0 ;
V_62 = F_23 ( V_66 + V_21 -> V_83 , ( 1 << V_21 -> V_84 ) ) ;
V_97 = F_34 ( F_4 ( struct V_67 , V_72 ) +
...
V_3 = V_13 -> V_36 -> V_64 ( V_52 ) ;
V_10 -> V_34 = F_40 ( V_69 ) & 0x7fffffff ;
if ( ! F_9 ( V_10 , ( char * ) V_52 -> V_46 , V_52 -> V_47 ,
F_19 ( V_52 -> V_65 ) ,
F_1 ( V_13 -> V_28 , V_3 ) ) )
break;
...
V_102 = F_3 ( & args , V_10 ) ;
else if ( ( V_102 = F_47 ( & args , & V_103 ) ) )
;
else if ( V_103 )
V_102 = F_12 ( & args , V_10 ) ;
else
V_102 = F_33 ( & args , V_10 , V_66 ) ;
F_48 ( V_13 , V_104 ) ;
return V_102 ;
}
