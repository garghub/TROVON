...
struct V_150 * V_151 = V_2 -> V_4 -> V_151 ;
int V_75 = - V_30 ;
if ( F_136 ( & V_151 -> V_153 , V_151 -> V_258 ,
& ( V_2 -> V_11 -> V_12 ) ) ) {
F_43 ( & V_2 -> V_11 -> V_12 ,
L_62 ) ;
F_137 ( V_2 , V_259 ,
...
V_75 = F_139 ( V_2 , & V_263 , V_4 -> V_97 ) ;
if ( V_75 )
return - V_30 ;
V_4 -> V_264 = ( T_2 ) V_263 . V_265 ;
V_4 -> V_266 = V_263 . V_266 ;
V_4 -> V_267 = V_263 . V_267 ;
V_4 -> V_268 = V_263 . V_268 ;
V_4 -> V_269 = V_263 . V_269 ;
V_4 -> V_270 = V_263 . V_270 ;
V_4 -> V_271 = V_263 . V_271 ;
if ( F_86 ( V_272 , & V_2 -> V_43 ) )
return V_273 ;
if ( V_4 -> V_269 & V_274 )
return V_108 ;
return V_273 ;
...
F_43 ( & V_2 -> V_11 -> V_12 , L_63 ,
V_29 , V_71 ) ;
return - V_30 ;
}
V_2 -> V_275 = F_141 ( V_4 -> V_268 , V_275 ) ;
V_2 -> V_276 = F_141 ( V_4 -> V_267 , V_276 ) ;
return 0 ;
}
...
static int V_280 ( struct V_1 * V_2 )
{
int V_75 = - V_30 ;
F_143 ( V_2 ) ;
if ( F_144 ( V_2 ) )
...
T_1 V_304 , V_305 ;
int V_27 ;
V_304 = F_2 ( V_2 -> V_4 , V_5 ) ;
V_305 = F_2 ( V_2 -> V_4 , V_18 ) ;
if ( F_146 ( V_2 , V_304 , V_305 ) ) {
V_27 = F_75 ( & V_115 , V_2 ,
V_306 ) ;
if ( V_27 )
return;
V_115 . V_117 . V_118 [ 1 ] = V_307 ;
V_27 = F_77 ( V_2 , & V_115 ) ;
if ( V_27 )
F_43 ( & V_2 -> V_11 -> V_12 ,
L_65 ) ;
...
switch ( V_11 -> V_309 ) {
case V_310 :
strncpy ( V_151 -> V_258 , V_311 ,
V_312 ) ;
break;
case V_313 :
strncpy ( V_151 -> V_258 , V_314 ,
V_312 ) ;
break;
default:
F_43 ( & V_11 -> V_12 , L_66 ,
...
int F_151 ( struct V_1 * V_2 , int V_321 )
{
struct V_80 * V_4 = V_2 -> V_4 ;
int V_75 = 0 ;
V_2 -> V_322 = false ;
...
V_75 = F_156 ( V_2 ) ;
if ( V_75 ) {
F_43 ( & V_2 -> V_11 -> V_12 , L_68 ) ;
goto V_325;
}
F_157 ( & V_2 -> V_326 , V_327 ) ;
V_75 = F_158 ( V_2 ) ;
if ( V_75 )
goto V_328;
F_145 ( V_2 ) ;
