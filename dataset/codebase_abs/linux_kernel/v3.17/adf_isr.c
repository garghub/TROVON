...
if ( ! V_13 )
return - V_42 ;
V_37 = F_20 ( V_9 , sizeof( char * ) , V_40 ) ;
if ( ! V_37 ) {
F_21 ( V_13 ) ;
return - V_42 ;
}
for ( V_11 = 0 ; V_11 < V_9 ; V_11 ++ ) {
* ( V_37 + V_11 ) = F_22 ( V_38 , V_40 ) ;
if ( ! ( * ( V_37 + V_11 ) ) )
goto V_43;
}
...
{
struct V_29 * V_44 = V_2 -> V_31 ;
struct V_6 * V_7 = V_2 -> V_8 ;
int V_11 ;
for ( V_11 = 0 ; V_11 < V_7 -> V_10 ; V_11 ++ )
F_25 ( & V_44 -> V_34 [ V_11 ] . V_23 ,
V_45 ,
( unsigned long ) & V_44 -> V_34 [ V_11 ] ) ;
return 0 ;
}
...
int V_11 ;
for ( V_11 = 0 ; V_11 < V_7 -> V_10 ; V_11 ++ ) {
F_27 ( & V_44 -> V_34 [ V_11 ] . V_23 ) ;
F_28 ( & V_44 -> V_34 [ V_11 ] . V_23 ) ;
}
}
