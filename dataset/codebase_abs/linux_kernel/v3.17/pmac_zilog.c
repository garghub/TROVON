...
F_112 (node_p, L_50 ) {
V_263 = V_264 = NULL ;
for ( V_210 = NULL ; ( V_210 = F_113 ( V_262 , V_210 ) ) != NULL ; ) {
...
struct V_217 * V_218 ;
int V_93 ;
V_218 = F_115 ( V_2 -> V_269 , V_270 , 0 ) ;
V_93 = F_116 ( V_2 -> V_269 , 0 ) ;
if ( ! V_218 || ! V_93 )
return - V_221 ;
V_2 -> V_36 . V_222 = V_218 -> V_223 ;
...
static int T_3 F_99 ( struct V_275 * V_269 )
{
struct V_1 * V_2 ;
int V_4 ;
...
static int T_5 F_103 ( struct V_275 * V_269 )
{
struct V_1 * V_2 = F_118 ( V_269 ) ;
if ( ! V_2 )
return - V_221 ;
F_105 ( & V_260 , & V_2 -> V_36 ) ;
V_2 -> V_36 . V_256 = NULL ;
...
static void F_129 ( struct V_113 * V_36 , int V_37 )
{
struct V_1 * V_2 = (struct V_1 * ) V_36 ;
while ( ( F_2 ( V_2 , V_27 ) & V_82 ) == 0 )
F_3 ( 5 ) ;
...
static void F_130 ( struct V_281 * V_282 , const char * V_283 , unsigned int V_213 )
{
...
F_131 ( & V_2 -> V_36 , V_283 , V_213 , F_129 ) ;
F_7 ( V_2 , V_6 , V_2 -> V_32 [ 1 ] ) ;
F_45 ( & V_2 -> V_36 . V_56 , V_30 ) ;
}
static int T_3 F_132 ( struct V_281 * V_285 , char * V_286 )
{
struct V_1 * V_2 ;
struct V_113 * V_36 ;
int V_161 = 38400 ;
...
F_71 ( V_150 ) ;
if ( V_286 )
F_135 ( V_286 , & V_161 , & V_62 , & V_287 , & V_288 ) ;
return F_136 ( V_36 , V_285 , V_161 , V_62 , V_287 , V_288 ) ;
}
