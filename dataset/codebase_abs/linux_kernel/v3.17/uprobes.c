...
int V_202 ;
F_190 () ;
V_202 = F_191 ( & V_48 , ( void V_203 * ) V_15 ,
sizeof( V_48 ) ) ;
F_192 () ;
if ( F_116 ( V_202 == 0 ) )
goto V_95;
V_202 = F_38 ( NULL , V_20 , V_15 , 1 , 0 , 1 , & V_17 , NULL ) ;
if ( V_202 < 0 )
return V_202 ;
...
bool __weak F_200 ( struct V_56 * V_209 , struct V_166 * V_167 )
{
return false ;
}
