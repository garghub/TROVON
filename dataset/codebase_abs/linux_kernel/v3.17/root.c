...
{
F_43 ( V_22 -> V_44 , V_43 ) ;
V_43 -> V_45 = V_46 . V_45 + F_44 () ;
return 0 ;
}
static struct V_22 * F_45 ( struct V_47 * V_48 , struct V_22 * V_22 , unsigned int V_21 )
{
if ( ! F_46 ( V_48 , V_22 , V_21 ) )
return NULL ;
return F_47 ( V_48 , V_22 , V_21 ) ;
}
static int F_48 ( struct V_49 * V_49 , struct V_50 * V_51 )
{
if ( V_51 -> V_52 < V_53 ) {
int error = F_49 ( V_49 , V_51 ) ;
if ( F_50 ( error <= 0 ) )
return error ;
V_51 -> V_52 = V_53 ;
}
return F_51 ( V_49 , V_51 ) ;
}
