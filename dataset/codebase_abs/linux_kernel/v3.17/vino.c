...
struct V_280 * V_281 )
{
F_2 ( L_81 , V_281 -> V_195 ) ;
if ( V_281 -> V_195 >= V_259 )
return - V_17 ;
F_2 ( L_82 , V_65 [ V_281 -> V_195 ] . V_282 ) ;
V_281 -> V_258 = V_65 [ V_281 -> V_195 ] . V_258 ;
strcpy ( V_281 -> V_282 , V_65 [ V_281 -> V_195 ] . V_282 ) ;
return 0 ;
}
...
struct V_56 V_284 ;
unsigned long V_52 ;
struct V_285 * V_286 = & V_29 -> V_287 . V_288 ;
F_2 ( L_83 ,
V_286 -> V_75 , V_286 -> V_76 ) ;
F_31 ( & V_187 -> V_194 , V_52 ) ;
memcpy ( & V_284 , V_57 , sizeof( struct V_56 ) ) ;
F_32 ( & V_187 -> V_194 , V_52 ) ;
V_284 . V_25 = F_104 ( V_286 -> V_258 ) ;
if ( V_284 . V_25 == V_26 ) {
V_284 . V_25 = V_181 ;
V_286 -> V_258 =
V_65 [ V_284 . V_25 ] .
...
F_47 ( & V_284 , V_286 -> V_75 , V_286 -> V_76 ) ;
F_2 ( L_84 ,
V_65 [ V_284 . V_25 ] . V_282 ) ;
V_286 -> V_75 = ( V_284 . V_59 . V_60 - V_284 . V_59 . V_61 ) /
V_284 . V_63 ;
V_286 -> V_76 = ( V_284 . V_59 . V_80 - V_284 . V_59 . V_79 ) /
V_284 . V_63 ;
V_286 -> V_137 = V_289 ;
V_286 -> V_290 = V_284 . V_67 ;
V_286 -> V_291 = V_284 . V_67 *
( V_284 . V_59 . V_80 - V_284 . V_59 . V_79 ) /
V_284 . V_63 ;
V_286 -> V_292 =
V_65 [ V_284 . V_25 ] . V_292 ;
return 0 ;
}
...
struct V_285 * V_286 = & V_29 -> V_287 . V_288 ;
F_31 ( & V_187 -> V_194 , V_52 ) ;
V_286 -> V_75 = ( V_57 -> V_59 . V_60 - V_57 -> V_59 . V_61 ) /
V_57 -> V_63 ;
V_286 -> V_76 = ( V_57 -> V_59 . V_80 - V_57 -> V_59 . V_79 ) /
V_57 -> V_63 ;
V_286 -> V_258 =
V_65 [ V_57 -> V_25 ] . V_258 ;
V_286 -> V_137 = V_289 ;
V_286 -> V_290 = V_57 -> V_67 ;
V_286 -> V_291 = V_57 -> V_67 *
( V_57 -> V_59 . V_80 - V_57 -> V_59 . V_79 ) /
V_57 -> V_63 ;
V_286 -> V_292 =
V_65 [ V_57 -> V_25 ] . V_292 ;
F_32 ( & V_187 -> V_194 , V_52 ) ;
return 0 ;
}
...
F_47 ( V_57 , V_286 -> V_75 , V_286 -> V_76 ) ;
F_2 ( L_84 ,
V_65 [ V_57 -> V_25 ] . V_282 ) ;
V_286 -> V_75 = V_57 -> V_59 . V_60 - V_57 -> V_59 . V_61 ;
V_286 -> V_76 = V_57 -> V_59 . V_80 - V_57 -> V_59 . V_79 ;
V_286 -> V_137 = V_289 ;
V_286 -> V_290 = V_57 -> V_67 ;
...
V_294 -> V_296 . V_61 = 0 ;
V_294 -> V_296 . V_79 = 0 ;
V_294 -> V_296 . V_75 = V_136 -> V_75 ;
V_294 -> V_296 . V_76 = V_136 -> V_76 ;
memcpy ( & V_294 -> V_297 , & V_294 -> V_296 ,
sizeof( struct V_298 ) ) ;
V_294 -> V_299 . V_300 = 1 ;
V_294 -> V_299 . V_301 = 1 ;
break;
...
case V_295 :
F_31 ( & V_187 -> V_194 , V_52 ) ;
V_304 -> V_304 . V_61 = V_57 -> V_59 . V_61 ;
V_304 -> V_304 . V_79 = V_57 -> V_59 . V_79 ;
V_304 -> V_304 . V_75 = V_57 -> V_59 . V_60 - V_57 -> V_59 . V_61 ;
V_304 -> V_304 . V_76 = V_57 -> V_59 . V_80 - V_57 -> V_59 . V_79 ;
F_32 ( & V_187 -> V_194 , V_52 ) ;
break;
case V_302 :
default:
...
case V_295 :
F_31 ( & V_187 -> V_194 , V_52 ) ;
F_45 ( V_57 , V_304 -> V_304 . V_61 , V_304 -> V_304 . V_79 ,
V_304 -> V_304 . V_75 , V_304 -> V_304 . V_76 ) ;
F_32 ( & V_187 -> V_194 , V_52 ) ;
break;
case V_302 :
default:
...
struct V_56 * V_57 = F_109 ( V_260 ) ;
unsigned long V_52 ;
struct V_307 * V_308 = & V_306 -> V_309 . V_310 ;
V_308 -> V_311 = V_312 ;
V_308 -> V_313 . V_300 = 1 ;
F_31 ( & V_187 -> V_194 , V_52 ) ;
V_308 -> V_313 . V_301 = V_57 -> V_83 ;
F_32 ( & V_187 -> V_194 , V_52 ) ;
return 0 ;
}
...
struct V_307 * V_308 = & V_306 -> V_309 . V_310 ;
F_31 ( & V_187 -> V_194 , V_52 ) ;
if ( ( V_308 -> V_313 . V_300 == 0 ) ||
( V_308 -> V_313 . V_301 == 0 ) ) {
F_52 ( V_57 ) ;
} else {
F_50 ( V_57 , V_308 -> V_313 . V_301 /
V_308 -> V_313 . V_300 ) ;
}
F_32 ( & V_187 -> V_194 , V_52 ) ;
return 0 ;
...
V_142 -> V_317 = ( V_57 -> V_197 . type == V_46 ) ?
V_318 : V_327 ;
...
{
struct V_56 * V_57 = F_109 ( V_260 ) ;
unsigned int V_331 = V_260 -> V_332 & V_333 ;
struct V_1 * V_2 ;
...
if ( V_124 )
goto V_41;
if ( V_155 -> V_347 < V_339 [ V_4 ] . V_348 ||
V_155 -> V_347 > V_339 [ V_4 ] . V_349 ) {
V_124 = - V_350 ;
goto V_41;
}
V_124 = F_133 ( V_345 , V_351 , V_155 ) ;
if ( V_124 )
V_124 = - V_17 ;
break;
}
...
if ( V_124 )
goto V_41;
if ( V_155 -> V_347 < V_343 [ V_4 ] . V_348 ||
V_155 -> V_347 > V_343 [ V_4 ] . V_349 ) {
V_124 = - V_350 ;
goto V_41;
}
V_124 = F_100 ( V_345 , V_351 , V_155 ) ;
if ( V_124 )
V_124 = - V_17 ;
break;
}
...
static void F_137 ( struct V_354 * V_355 )
{
struct V_1 * V_2 = V_355 -> V_356 ;
V_2 -> V_55 ++ ;
F_2 ( L_105 , V_2 -> V_55 ) ;
}
static void F_138 ( struct V_354 * V_355 )
{
struct V_1 * V_2 = V_355 -> V_356 ;
V_2 -> V_55 -- ;
F_2 ( L_106 , V_2 -> V_55 ) ;
}
static int F_139 ( struct V_260 * V_260 , struct V_354 * V_355 )
{
struct V_56 * V_57 = F_109 ( V_260 ) ;
unsigned long V_198 = V_355 -> V_357 ;
unsigned long V_14 = V_355 -> V_358 - V_355 -> V_357 ;
unsigned long V_49 = V_355 -> V_359 << V_360 ;
struct V_1 * V_2 = NULL ;
...
if ( V_14 < V_9 )
break;
if ( F_142 ( V_355 , V_198 , V_364 , V_9 ,
V_355 -> V_365 ) ) {
F_2 ( L_115 ) ;
V_16 = - V_334 ;
goto V_41;
...
static unsigned int F_143 ( struct V_260 * V_260 , T_6 * V_372 )
{
struct V_56 * V_57 = F_109 ( V_260 ) ;
unsigned int V_210 ;
unsigned int V_16 = 0 ;
...
if ( V_210 > 0 )
goto V_374;
F_144 ( V_260 , & V_57 -> V_197 . V_203 , V_372 ) ;
if ( F_38 ( & V_57 -> V_197 , & V_210 ) ) {
F_2 ( L_117 ) ;
V_16 = V_373 ;
goto error;
...
unsigned int V_377 , unsigned long V_378 )
{
struct V_56 * V_57 = F_109 ( V_260 ) ;
long V_16 ;
if ( F_140 ( & V_57 -> V_352 ) )
return - V_204 ;
V_16 = F_146 ( V_260 , V_377 , V_378 ) ;
F_27 ( & V_57 -> V_352 ) ;
return V_16 ;
}
static void F_147 ( int V_379 )
{
switch( V_379 ) {
case 11 :
F_148 ( V_187 -> V_142 . V_380 ) ;
V_187 -> V_142 . V_380 = NULL ;
case 10 :
F_148 ( V_187 -> V_141 . V_380 ) ;
V_187 -> V_141 . V_380 = NULL ;
case 9 :
F_149 ( & V_381 ) ;
case 8 :
F_150 ( V_382 , NULL ) ;
case 7 :
if ( V_187 -> V_142 . V_380 ) {
F_151 ( V_187 -> V_142 . V_380 ) ;
V_187 -> V_142 . V_380 = NULL ;
}
case 6 :
if ( V_187 -> V_141 . V_380 ) {
F_151 ( V_187 -> V_141 . V_380 ) ;
V_187 -> V_141 . V_380 = NULL ;
}
case 5 :
F_5 ( NULL ,
...
V_127 = (struct V_390 * ) F_156 ( V_391 , sizeof( struct V_390 ) ) ;
if ( ! V_127 ) {
F_34 ( V_54 L_124 ) ;
return - V_106 ;
}
V_392 ++ ;
if ( F_157 ( V_386 , & ( V_127 -> V_386 ) ) ) {
F_34 ( V_54 L_125 ) ;
F_147 ( V_392 ) ;
return - V_254 ;
}
if ( F_158 ( V_386 ) != V_393 ) {
F_34 ( V_54 L_126 ,
V_386 ) ;
F_147 ( V_392 ) ;
return - V_254 ;
}
F_34 ( V_394 L_127 , F_159 ( V_386 ) ) ;
return 0 ;
}
...
int V_124 ;
int V_4 ;
V_187 = F_161 ( sizeof( struct V_396 ) , V_18 ) ;
if ( ! V_187 ) {
F_147 ( V_392 ) ;
return - V_19 ;
}
V_392 ++ ;
F_162 ( V_187 -> V_385 . V_256 , L_128 ,
sizeof( V_187 -> V_385 . V_256 ) ) ;
V_124 = F_163 ( NULL , & V_187 -> V_385 ) ;
if ( V_124 )
return V_124 ;
V_392 ++ ;
V_187 -> V_384 = F_13 ( V_18 | V_20 ) ;
if ( ! V_187 -> V_384 ) {
F_147 ( V_392 ) ;
return - V_19 ;
}
...
( void * ) V_187 -> V_384 ,
V_9 , V_10 ) ;
for ( V_4 = 0 ; V_4 < V_383 ; V_4 ++ ) {
V_187 -> V_188 . V_7 [ V_4 ] = V_395 ;
}
V_127 -> V_155 = 0 ;
...
F_54 ( V_147 ) ;
V_127 -> V_156 = 0 ;
V_127 -> V_141 . V_397 = V_398 ;
V_127 -> V_142 . V_397 = V_398 ;
return 0 ;
}
...
V_392 ++ ;
memcpy ( V_57 -> V_380 , & V_399 ,
sizeof( struct V_400 ) ) ;
strcpy ( V_57 -> V_380 -> V_256 , V_256 ) ;
V_57 -> V_380 -> V_401 = F_151 ;
V_57 -> V_380 -> V_385 = & V_187 -> V_385 ;
F_168 ( V_57 -> V_380 , V_57 ) ;
return 0 ;
}
...
if ( V_16 )
return V_16 ;
V_16 = F_164 ( & V_187 -> V_142 , V_404 ,
V_405 ) ;
if ( V_16 )
return V_16 ;
V_16 = F_170 ( V_382 , F_91 , 0 ,
V_267 , NULL ) ;
if ( V_16 ) {
F_34 ( V_54 L_130 ,
V_382 ) ;
...
F_172 ( & V_381 , & V_187 -> V_385 ) ;
V_392 ++ ;
V_16 = F_173 ( V_187 -> V_141 . V_380 ,
V_406 , - 1 ) ;
if ( V_16 < 0 ) {
F_34 ( V_54 L_132
L_133 ) ;
