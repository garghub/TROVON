...
static int F_40 ( struct V_78 * V_95 , const struct V_67 * V_96 ,
unsigned int * V_97 , unsigned int * V_98 ,
unsigned int V_99 [] , void * V_100 [] )
{
struct V_1 * V_2 = F_41 ( V_95 ) ;
unsigned long V_94 ;
V_94 = V_2 -> V_70 * V_2 -> V_71 * 2 ;
* V_97 = F_42 (unsigned int, *nbuffers,
...
static void F_43 ( struct V_102 * V_103 )
{
unsigned long V_104 ;
struct V_1 * V_2 = F_41 ( V_103 -> V_78 ) ;
struct V_105 * V_106 =
F_44 ( V_103 , struct V_105 , V_103 ) ;
F_45 ( & V_2 -> V_107 , V_104 ) ;
if ( ! V_2 -> V_28 ) {
F_46 ( & V_106 -> V_103 , V_108 ) ;
} else {
V_106 -> V_109 = F_47 ( V_103 , 0 ) ;
V_106 -> V_110 = F_48 ( V_103 , 0 ) ;
V_106 -> V_111 = 0 ;
V_106 -> V_112 = 0 ;
if ( V_106 -> V_110 < V_2 -> V_70 * V_2 -> V_71 * 2 )
F_46 ( & V_106 -> V_103 , V_108 ) ;
else
F_49 ( & V_106 -> V_113 , & V_2 -> V_114 ) ;
}
F_50 ( & V_2 -> V_107 , V_104 ) ;
}
static int F_51 ( struct V_78 * V_95 , unsigned int V_115 )
{
struct V_1 * V_2 = F_41 ( V_95 ) ;
return F_7 ( V_2 ) ;
}
static void F_52 ( struct V_78 * V_95 )
{
struct V_1 * V_2 = F_41 ( V_95 ) ;
F_17 ( V_2 ) ;
}
...
unsigned long V_104 ;
F_45 ( & V_2 -> V_107 , V_104 ) ;
while ( ! F_53 ( & V_2 -> V_114 ) ) {
V_106 = F_54 ( & V_2 -> V_114 ,
struct V_105 , V_113 ) ;
F_55 ( & V_106 -> V_113 ) ;
F_46 ( & V_106 -> V_103 , V_108 ) ;
F_5 ( L_14 ,
V_106 , V_106 -> V_103 . V_116 . V_60 ) ;
}
V_2 -> V_34 . V_106 = NULL ;
F_50 ( & V_2 -> V_107 , V_104 ) ;
}
...
V_79 = & V_2 -> V_80 ;
V_79 -> type = V_117 ;
V_79 -> V_118 = V_119 | V_120 | V_121 ;
V_79 -> V_122 = V_2 ;
V_79 -> V_123 = sizeof( struct V_105 ) ;
V_79 -> V_124 = & V_125 ;
V_79 -> V_126 = & V_127 ;
V_79 -> V_128 = V_129 ;
V_30 = F_57 ( V_79 ) ;
...
int V_30 ;
V_2 -> V_90 = V_130 ;
V_2 -> V_90 . V_131 = V_132 ;
V_2 -> V_90 . V_133 = & V_2 -> V_80 ;
V_2 -> V_90 . V_134 = & V_2 -> V_32 ;
V_2 -> V_90 . V_133 -> V_134 = & V_2 -> V_135 ;
V_2 -> V_90 . V_40 = & V_2 -> V_40 ;
V_2 -> V_17 = V_136 ;
V_2 -> V_70 = 720 ;
V_2 -> V_71 = 480 ;
V_2 -> V_68 = & V_63 [ 0 ] ;
