...
V_96 = F_136 ( sizeof( struct V_1 ) ) ;
if ( ! V_96 )
return - V_241 ;
F_137 ( V_96 , & V_111 -> V_3 ) ;
F_8 ( & V_111 -> V_3 , L_34 ) ;
V_4 = F_2 ( V_96 ) ;
V_4 -> V_3 = & V_111 -> V_3 ;
V_4 -> V_96 = V_96 ;
...
F_139 ( & V_4 -> V_23 ) ;
F_140 ( & V_4 -> V_39 , F_71 ) ;
V_4 -> V_245 = F_141 ( V_111 , V_246 , 0 ) ;
V_4 -> V_247 = F_141 ( V_111 , V_246 , 1 ) ;
V_4 -> V_225 = F_141 ( V_111 , V_248 , 0 ) ;
if ( V_4 -> V_245 == NULL || V_4 -> V_247 == NULL ||
V_4 -> V_225 == NULL ) {
F_10 ( V_4 -> V_3 , L_35 ) ;
V_22 = - V_75 ;
goto V_249;
}
V_4 -> V_92 = F_142 ( V_111 , 1 ) ;
if ( V_4 -> V_92 >= 0 ) {
F_8 ( V_4 -> V_3 , L_36 , V_4 -> V_92 ) ;
V_22 = F_119 ( V_4 -> V_92 , F_112 ,
V_228 , F_143 ( V_4 -> V_3 ) , V_96 ) ;
if ( V_22 ) {
F_10 ( V_4 -> V_3 , L_37 , V_22 ) ;
} else {
...
V_243 = F_144 ( V_4 -> V_245 ) ;
V_4 -> V_113 = F_145 ( V_4 -> V_245 -> V_250 , V_243 ,
V_111 -> V_61 ) ;
if ( V_4 -> V_113 == NULL ) {
F_10 ( V_4 -> V_3 , L_39 ) ;
V_22 = - V_251 ;
...
V_4 -> V_6 = F_146 ( V_4 -> V_245 -> V_250 , V_243 ) ;
if ( V_4 -> V_6 == NULL ) {
F_10 ( V_4 -> V_3 , L_40 ) ;
V_22 = - V_45 ;
goto V_249;
}
V_243 = F_144 ( V_4 -> V_247 ) ;
V_4 -> V_112 = F_145 ( V_4 -> V_247 -> V_250 , V_243 ,
V_111 -> V_61 ) ;
if ( V_4 -> V_112 == NULL ) {
F_10 ( V_4 -> V_3 , L_41 ) ;
V_22 = - V_251 ;
...
V_4 -> V_7 = F_146 ( V_4 -> V_247 -> V_250 , V_243 ) ;
if ( V_4 -> V_7 == NULL ) {
F_10 ( V_4 -> V_3 , L_42 ) ;
V_22 = - V_45 ;
goto V_249;
}
V_96 -> V_252 = ( unsigned long ) V_4 -> V_6 ;
V_96 -> V_213 = V_4 -> V_225 -> V_250 ;
F_38 ( V_4 , V_243 ) ;
if ( V_233 != NULL ) {
if ( V_233 -> V_20 & V_253 )
F_38 ( V_4 , 1 ) ;
...
V_244 = F_3 ( V_4 , V_256 ) ;
V_244 |= ( T_3 ) F_3 ( V_4 , V_257 ) << 8 ;
V_244 |= ( T_3 ) F_3 ( V_4 , V_258 ) << 16 ;
V_244 |= ( T_3 ) F_3 ( V_4 , V_259 ) << 24 ;
if ( V_244 == V_260 )
break;
F_10 ( V_4 -> V_3 , L_43 , V_244 ) ;
}
if ( V_244 != V_260 ) {
F_10 ( V_4 -> V_3 , L_44 , V_244 ) ;
V_22 = - V_261 ;
goto V_249;
}
V_244 = F_3 ( V_4 , V_262 ) ;
F_8 ( V_4 -> V_3 , L_45 , V_244 ) ;
switch ( V_244 ) {
case V_263 :
V_4 -> type = V_115 ;
break;
...
break;
default:
F_8 ( V_4 -> V_3 , L_46 , V_244 ) ;
V_4 -> type = V_38 ;
}
if ( V_4 -> type == V_115 || V_4 -> type == V_116 ) {
V_96 -> V_142 = V_66 | V_265 ;
V_96 -> V_64 |= V_96 -> V_142 ;
}
F_148 ( V_96 ) ;
V_96 -> V_266 = & V_267 ;
V_96 -> V_268 = F_149 ( V_269 ) ;
V_96 -> V_270 = & V_271 ;
V_4 -> V_62 = V_272 ;
V_4 -> V_46 . V_273 = 0x1f ;
V_4 -> V_46 . V_274 = 0x1f ;
...
V_242 = L_48 ;
memcpy ( V_96 -> V_128 , V_233 -> V_128 , V_278 ) ;
}
if ( ! F_150 ( V_96 -> V_128 ) ) {
V_242 = L_49 ;
...
return 0 ;
V_249:
F_10 ( V_4 -> V_3 , L_54 , V_22 ) ;
F_79 ( V_111 , V_4 ) ;
F_155 ( V_96 ) ;
return V_22 ;
}
static int
F_156 ( struct V_232 * V_3 )
{
struct V_110 * V_111 = F_51 ( V_3 ) ;
struct V_2 * V_96 = F_157 ( V_111 ) ;
struct V_1 * V_4 ;
if ( V_96 ) {
V_4 = F_2 ( V_96 ) ;
V_4 -> V_17 = 1 ;
