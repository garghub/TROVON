...
{
T_3 V_9 = 0 ;
char V_29 [ 16 ] , V_30 [ 32 ] , * line = NULL ;
T_1 * V_31 ;
if ( V_17 == NULL ) {
fprintf ( V_14 , L_17 ) ;
return 1 ;
}
V_31 = fopen ( V_28 , L_18 ) ;
if ( V_31 == NULL ) {
perror ( L_11 ) ;
fprintf ( V_14 , L_19 ) ;
free ( V_17 ) ;
...
continue;
if ( sscanf ( line , L_20 , V_29 , V_30 ) < 2 )
continue;
F_6 ( L_21 , V_29 , V_30 ) ;
if ( strcmp ( L_22 , V_29 ) == 0 )
sscanf ( V_30 , L_23 , & V_17 -> V_18 ) ;
else if ( strcmp ( L_24 , V_29 ) == 0 )
sscanf ( V_30 , L_23 , & V_17 -> V_19 ) ;
else if ( strcmp ( L_25 , V_29 ) == 0 )
sscanf ( V_30 , L_23 , & V_17 -> V_21 ) ;
else if ( strcmp ( L_26 , V_29 ) == 0 )
sscanf ( V_30 , L_23 , & V_17 -> V_20 ) ;
else if ( strcmp ( L_27 , V_29 ) == 0 )
sscanf ( V_30 , L_28 , & V_17 -> V_22 ) ;
else if ( strcmp ( L_29 , V_29 ) == 0 )
sscanf ( V_30 , L_28 , & V_17 -> V_23 ) ;
else if ( strcmp ( L_30 , V_29 ) == 0 )
sscanf ( V_30 , L_28 , & V_17 -> V_26 ) ;
else if ( strcmp ( L_31 , V_29 ) == 0 )
V_17 -> V_8 = F_2 ( V_30 ) ;
else if ( strcmp ( L_32 , V_29 ) == 0 )
sscanf ( V_30 , L_28 , & V_17 -> V_24 ) ;
else if ( strcmp ( L_33 , V_29 ) == 0 ) {
strncpy ( V_17 -> V_27 , V_30 ,
sizeof( V_17 -> V_27 ) ) ;
V_17 -> V_27 [ sizeof( V_17 -> V_27 ) - 1 ] = '\0' ;
}
else if ( strcmp ( L_34 , V_29 ) == 0 ) {
if ( F_1 ( V_30 ) != V_6 )
V_17 -> V_25 = F_1 ( V_30 ) ;
}
}
