...
for ( V_84 = 0 ; V_84 < V_55 -> V_118 ; V_84 ++ ) {
F_21 ( V_2 ) ;
F_22 ( V_2 ) ;
V_116 = F_49 ( V_2 , V_15 , V_55 , F_25 , 0 ) ;
if ( V_116 )
break;
V_115 [ V_84 ] = F_23 ( V_2 , V_15 ) ;
}
F_19 ( V_5 -> V_93 | V_114 ,
V_2 -> V_8 + V_94 ) ;
F_21 ( V_2 ) ;
return V_116 ? V_116 : V_55 -> V_118 ;
}
...
int V_84 ;
for ( V_84 = 0 ; V_84 < V_55 -> V_118 ; V_84 ++ ) {
F_19 ( ( V_115 [ V_84 ] & 0xff ) ,
V_2 -> V_8 + F_51 ( V_36 ) ) ;
F_19 ( ( V_115 [ V_84 ] >> 8 ) & 0x0f ,
V_2 -> V_8 + F_52 ( V_36 ) ) ;
V_5 -> V_119 [ V_36 ] = V_115 [ V_84 ] ;
}
return V_55 -> V_118 ;
}
...
unsigned int * V_115 )
{
V_115 [ 1 ] = F_24 ( V_2 -> V_8 + V_120 ) |
( F_24 ( V_2 -> V_8 + V_121 ) << 8 ) ;
return V_55 -> V_118 ;
}
...
{
if ( F_56 ( V_15 , V_115 ) ) {
F_19 ( V_15 -> V_122 & 0xff , V_2 -> V_8 + V_123 ) ;
F_19 ( ( V_15 -> V_122 >> 8 ) , V_2 -> V_8 + V_124 ) ;
}
V_115 [ 1 ] = V_15 -> V_122 ;
return V_55 -> V_118 ;
}
...
if ( V_62 -> V_125 )
F_1 ( V_2 , false ) ;
V_5 -> V_39 = F_58 ( 16 , 0 , 0 ) ;
F_16 ( V_2 , F_58 ( 0 , 0 , 0 ) , 0 ) ;
for ( V_36 = 0 ; V_36 < V_62 -> V_126 ; V_36 ++ ) {
F_19 ( 0 , V_2 -> V_8 + F_51 ( V_36 ) ) ;
F_19 ( 0 , V_2 -> V_8 + F_52 ( V_36 ) ) ;
}
if ( V_62 -> V_127 ) {
...
static int F_60 ( struct V_1 * V_2 , struct V_128 * V_129 )
{
const struct V_61 * V_62 = F_27 ( V_2 ) ;
struct V_4 * V_5 ;
struct V_14 * V_15 ;
...
int V_116 ;
int V_84 ;
V_5 = F_61 ( V_2 , sizeof( * V_5 ) ) ;
if ( ! V_5 )
return - V_157 ;
V_116 = F_62 ( V_2 , V_129 -> V_134 [ 0 ] , 0x10 ) ;
if ( V_116 )
return V_116 ;
if ( ( 1 << V_129 -> V_134 [ 1 ] ) & V_62 -> V_125 ) {
V_116 = F_63 ( V_129 -> V_134 [ 1 ] , F_40 , 0 ,
V_2 -> V_158 , V_2 ) ;
if ( V_116 == 0 )
V_2 -> V_106 = V_129 -> V_134 [ 1 ] ;
}
if ( V_2 -> V_106 && V_62 -> V_159 &&
( V_129 -> V_134 [ 2 ] == 3 || V_129 -> V_134 [ 2 ] == 1 ) ) {
V_116 = F_64 ( V_129 -> V_134 [ 2 ] , V_2 -> V_158 ) ;
if ( V_116 ) {
F_65 ( V_2 -> V_100 ,
L_2 ,
V_129 -> V_134 [ 2 ] ) ;
...
V_5 -> V_31 = V_129 -> V_134 [ 2 ] ;
V_5 -> V_160 = 1 ;
V_5 -> V_24 = ( 1 << V_5 -> V_160 ) * V_161 ;
for ( V_84 = 0 ; V_84 < 2 ; V_84 ++ ) {
unsigned long V_105 ;
V_105 = F_66 ( V_162 , V_5 -> V_160 ) ;
if ( ! V_105 )
return - V_157 ;
V_5 -> V_105 [ V_84 ] = V_105 ;
V_5 -> V_33 [ V_84 ] = F_67 ( ( void * ) V_105 ) ;
}
}
switch ( V_62 -> V_132 ) {
case V_163 :
...
if ( V_62 -> V_127 )
V_155 += 2 ;
V_116 = F_68 ( V_2 , V_155 ) ;
if ( V_116 )
return V_116 ;
V_156 = 0 ;
V_15 = & V_2 -> V_166 [ V_156 ] ;
V_15 -> type = V_167 ;
V_15 -> V_168 = V_169 ;
if ( V_5 -> V_41 ) {
V_15 -> V_168 |= V_170 ;
V_15 -> V_171 = V_62 -> V_172 / 2 ;
} else {
V_15 -> V_168 |= V_173 ;
V_15 -> V_171 = V_62 -> V_172 ;
}
V_15 -> V_53 = V_62 -> V_174 ? 0xffff : 0x0fff ;
F_59 ( V_2 , V_15 , V_129 ) ;
V_15 -> V_175 = F_48 ;
if ( V_2 -> V_106 ) {
V_2 -> V_108 = V_15 ;
...
V_15 = & V_2 -> V_166 [ V_156 ] ;
V_15 -> type = V_184 ;
V_15 -> V_168 = V_185 | V_173 ;
V_15 -> V_171 = V_62 -> V_126 ;
V_15 -> V_53 = 0xfff ;
V_15 -> V_130 = & V_186 ;
V_15 -> V_175 = F_53 ;
V_15 -> V_187 = F_50 ;
...
if ( V_5 ) {
if ( V_5 -> V_105 [ 0 ] )
F_70 ( V_5 -> V_105 [ 0 ] , V_5 -> V_160 ) ;
if ( V_5 -> V_105 [ 1 ] )
F_70 ( V_5 -> V_105 [ 1 ] , V_5 -> V_160 ) ;
if ( V_5 -> V_31 )
F_71 ( V_5 -> V_31 ) ;
}
F_72 ( V_2 ) ;
