...
int V_54 ;
F_36 ( & V_46 -> V_53 ) ;
if ( V_21 ( V_46 -> V_36 ) && V_46 -> V_47 ) {
V_46 -> V_48 = V_49 ;
goto exit;
}
F_32 ( V_46 -> V_55 , V_46 -> V_5 , & V_46 -> V_26 ) ;
V_46 -> V_48 *= 2 ;
if ( V_46 -> V_47 )
V_54 = V_56 ;
else
...
int F_40 ( struct V_3 * V_4 , struct V_16 * V_26 ,
T_1 V_2 )
{
struct V_45 * V_46 ;
V_46 = F_41 ( sizeof( * V_46 ) , V_57 ) ;
if ( ! V_46 )
return - V_58 ;
V_46 -> V_5 = F_1 ( V_43 , V_2 , V_4 ) ;
if ( ! V_46 -> V_5 ) {
F_42 ( V_46 ) ;
return - V_59 ;
}
memcpy ( & V_46 -> V_26 , V_26 , sizeof( * V_26 ) ) ;
V_46 -> V_55 = V_4 ;
V_46 -> V_36 = V_2 ;
V_46 -> V_47 = 0 ;
V_46 -> V_48 = V_51 ;
F_43 ( & V_46 -> V_53 ) ;
F_44 ( & V_46 -> V_52 , ( V_60 ) F_39 , ( unsigned long ) V_46 ) ;
F_34 ( & V_46 -> V_52 , V_46 -> V_48 ) ;
V_4 -> V_35 = V_46 ;
F_32 ( V_46 -> V_55 , V_46 -> V_5 , & V_46 -> V_26 ) ;
return 0 ;
}
void F_45 ( struct V_45 * V_46 )
{
F_46 ( & V_46 -> V_52 ) ;
F_47 ( & V_46 -> V_52 ) ;
F_20 ( V_46 -> V_5 ) ;
