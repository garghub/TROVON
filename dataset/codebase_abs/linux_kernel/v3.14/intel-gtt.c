...
static int F_32 ( struct V_44 * V_20 , T_3 V_45 ,
int type )
{
int V_8 ;
if ( ( V_45 + V_20 -> V_21 )
...
static struct V_44 * F_34 ( T_5 V_53 , int type )
{
struct V_44 * V_54 ;
struct V_1 * V_1 ;
switch ( V_53 ) {
...
static void F_45 ( T_4 V_48 , unsigned int V_69 ,
unsigned int V_70 )
{
T_1 V_71 = V_72 ;
switch ( V_70 ) {
...
static void F_78 ( T_4 V_48 , unsigned int V_69 ,
unsigned int V_70 )
{
T_1 V_71 = V_72 ;
if ( V_70 == V_75 )
...
static bool F_86 ( unsigned int V_70 )
{
switch ( V_70 ) {
case 0 :
case V_57 :
...
static struct V_44 * F_94 ( T_5 V_53 ,
int type )
{
struct V_44 * V_54 ;
if ( type == V_73 && V_82 == 1 ) {
...
F_29 ( & V_200 -> V_42 , L_14 , V_204 [ V_8 ] . V_191 ) ;
