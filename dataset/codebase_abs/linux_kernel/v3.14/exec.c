...
V_108 = F_76 ( V_124 , V_110 , & V_112 ) ;
if ( F_49 ( V_108 ) )
goto V_71;
V_33 = - V_125 ;
if ( ! F_77 ( F_78 ( V_108 ) -> V_126 ) )
goto exit;
if ( V_108 -> V_127 . V_128 -> V_129 & V_130 )
goto exit;
F_79 ( V_108 ) ;
V_33 = F_80 ( V_108 ) ;
if ( V_33 )
...
struct V_108 * F_82 ( const char * V_110 )
{
struct V_109 V_131 = { . V_110 = V_110 } ;
return F_75 ( & V_131 ) ;
}
int F_83 ( struct V_108 * V_108 , T_4 V_72 ,
...
V_133 = F_59 () ;
F_60 ( F_84 () ) ;
V_134 = F_85 ( V_108 , ( void T_1 * ) V_132 , F_48 , & V_19 ) ;
F_60 ( V_133 ) ;
return V_134 ;
}
T_5 F_86 ( struct V_108 * V_108 , unsigned long V_132 , T_4 V_19 , T_6 V_50 )
{
T_5 V_135 = V_108 -> V_136 -> V_137 ( V_108 , ( void T_1 * ) V_132 , V_50 , & V_19 ) ;
if ( V_135 > 0 )
F_87 ( V_132 , V_132 + V_50 ) ;
return V_135 ;
}
...
F_139 ( V_10 -> V_181 , V_10 -> V_109 , sizeof( V_10 -> V_181 ) ) ;
F_12 ( V_10 , 0 ) ;
V_184 = F_88 ( V_10 -> V_13 ) ;
if ( V_184 )
goto V_71;
V_10 -> V_13 = NULL ;
F_60 ( V_185 ) ;
V_14 -> V_186 &= ~ ( V_187 | V_188 | V_189 |
V_190 | V_191 ) ;
F_142 () ;
...
F_153 ( V_14 -> V_13 , V_199 ) ;
else
F_153 ( V_14 -> V_13 , V_200 ) ;
F_135 ( V_14 , V_10 -> V_181 ) ;
V_14 -> V_13 -> V_201 = V_202 ;
if ( ! F_147 ( V_10 -> V_203 -> V_204 , F_148 () ) ||
! F_150 ( V_10 -> V_203 -> V_205 , F_151 () ) ) {
V_14 -> V_206 = 0 ;
} else {
...
{
if ( F_157 ( & V_14 -> signal -> V_209 ) )
return - V_210 ;
V_10 -> V_203 = F_158 () ;
if ( F_111 ( V_10 -> V_203 ) )
return 0 ;
F_159 ( & V_14 -> signal -> V_209 ) ;
return - V_37 ;
}
...
if ( V_10 -> V_211 != V_10 -> V_109 )
F_163 ( V_10 -> V_211 ) ;
F_163 ( V_10 ) ;
}
int F_164 ( char * V_211 , struct V_9 * V_10 )
{
if ( V_10 -> V_211 != V_10 -> V_109 )
F_163 ( V_10 -> V_211 ) ;
V_10 -> V_211 = F_165 ( V_211 , V_36 ) ;
if ( ! V_10 -> V_211 )
return - V_37 ;
return 0 ;
}
...
V_212 = V_49 ;
V_213 = 1 ;
F_128 ( & V_49 -> V_220 -> V_150 ) ;
F_173 () ;
F_174 (p, t) {
if ( V_212 -> V_220 == V_49 -> V_220 )
V_213 ++ ;
}
F_175 () ;
if ( V_49 -> V_220 -> V_221 > V_213 )
V_10 -> V_215 |= V_222 ;
else
V_49 -> V_220 -> V_223 = 1 ;
F_130 ( & V_49 -> V_220 -> V_150 ) ;
}
int F_176 ( struct V_9 * V_10 )
{
struct V_224 * V_224 = F_78 ( V_10 -> V_108 ) ;
T_8 V_225 = V_224 -> V_126 ;
int V_184 ;
V_10 -> V_203 -> V_226 = F_148 () ;
V_10 -> V_203 -> V_227 = F_151 () ;
if ( ! ( V_10 -> V_108 -> V_127 . V_128 -> V_129 & V_228 ) &&
! V_14 -> V_218 &&
F_177 ( V_10 -> V_203 -> V_229 , V_224 -> V_230 ) &&
F_178 ( V_10 -> V_203 -> V_229 , V_224 -> V_231 ) ) {
if ( V_225 & V_232 ) {
V_10 -> V_193 |= V_233 ;
V_10 -> V_203 -> V_226 = V_224 -> V_230 ;
}
if ( ( V_225 & ( V_234 | V_235 ) ) == ( V_234 | V_235 ) ) {
V_10 -> V_193 |= V_233 ;
V_10 -> V_203 -> V_227 = V_224 -> V_231 ;
}
}
V_184 = F_179 ( V_10 ) ;
if ( V_184 )
return V_184 ;
V_10 -> V_236 = 1 ;
memset ( V_10 -> V_179 , 0 , V_237 ) ;
return F_83 ( V_10 -> V_108 , 0 , V_10 -> V_179 , V_237 ) ;
}
int F_180 ( struct V_9 * V_10 )
{
int V_21 = 0 ;
unsigned long V_72 ;
char * V_68 ;
...
int F_183 ( struct V_9 * V_10 )
{
bool V_239 = F_184 ( V_240 ) ;
struct V_1 * V_2 ;
int V_184 ;
if ( V_10 -> V_241 > 5 )
return - V_242 ;
...
F_133 ( & V_5 ) ;
if ( V_239 && V_184 == - V_245 ) {
if ( F_188 ( V_10 -> V_179 [ 0 ] ) && F_188 ( V_10 -> V_179 [ 1 ] ) &&
F_188 ( V_10 -> V_179 [ 2 ] ) && F_188 ( V_10 -> V_179 [ 3 ] ) )
return V_184 ;
if ( F_189 ( L_1 , * ( V_246 * ) ( V_10 -> V_179 + 2 ) ) < 0 )
return V_184 ;
V_239 = false ;
goto V_244;
}
...
V_247 = V_14 -> V_164 ;
F_173 () ;
V_248 = F_191 ( V_14 , F_192 ( V_14 -> V_175 ) ) ;
F_175 () ;
V_21 = F_183 ( V_10 ) ;
if ( V_21 >= 0 ) {
F_193 ( V_10 ) ;
F_194 ( V_14 , V_247 , V_10 ) ;
F_195 ( V_249 , V_248 ) ;
F_196 ( V_14 ) ;
}
return V_21 ;
}
static int F_197 ( struct V_109 * V_109 ,
struct V_55 V_56 ,
struct V_55 V_250 )
{
struct V_9 * V_10 ;
...
F_202 () ;
V_10 -> V_108 = V_108 ;
V_10 -> V_109 = V_10 -> V_211 = V_109 -> V_110 ;
V_184 = F_38 ( V_10 ) ;
if ( V_184 )
goto V_260;
V_10 -> V_66 = F_48 ( V_56 , V_261 ) ;
if ( ( V_184 = V_10 -> V_66 ) < 0 )
goto V_71;
V_10 -> V_262 = F_48 ( V_250 , V_261 ) ;
if ( ( V_184 = V_10 -> V_262 ) < 0 )
goto V_71;
V_184 = F_176 ( V_10 ) ;
if ( V_184 < 0 )
goto V_71;
V_184 = F_58 ( 1 , & V_10 -> V_109 , V_10 ) ;
if ( V_184 < 0 )
goto V_71;
V_10 -> V_101 = V_10 -> V_49 ;
V_184 = F_52 ( V_10 -> V_262 , V_250 , V_10 ) ;
if ( V_184 < 0 )
goto V_71;
...
int F_208 ( struct V_109 * V_109 ,
const char T_1 * const T_1 * V_75 ,
const char T_1 * const T_1 * V_263 )
{
struct V_55 V_56 = { . V_61 . V_58 = V_75 } ;
struct V_55 V_250 = { . V_61 . V_58 = V_263 } ;
return F_197 ( V_109 , V_56 , V_250 ) ;
}
static int F_209 ( struct V_109 * V_109 ,
const T_2 T_1 * V_75 ,
const T_2 T_1 * V_263 )
{
struct V_55 V_56 = {
...
void F_153 ( struct V_12 * V_13 , int V_266 )
{
unsigned long V_267 , V_264 ;
if ( F_3 ( ( unsigned ) V_266 > V_268 ) )
return;
do {
V_267 = F_18 ( V_13 -> V_186 ) ;
V_264 = ( V_267 & ~ V_269 ) | V_266 ;
} while ( F_212 ( & V_13 -> V_186 , V_267 , V_264 ) != V_267 );
}
T_10 long F_213 ( const char T_1 * V_109 ,
const T_2 T_1 * V_56 ,
const T_2 T_1 * V_250 )
{
return F_209 ( F_214 ( V_109 ) , V_56 , V_250 ) ;
}
