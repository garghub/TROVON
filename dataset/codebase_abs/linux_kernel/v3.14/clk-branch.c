...
const char * V_21 = F_8 ( V_2 -> V_5 . V_22 . V_23 ) ;
if ( F_1 ( V_2 ) )
return 0 ;
if ( V_2 -> V_10 == V_24 || ( ! V_8 && V_19 ) ) {
F_9 ( 10 ) ;
...
static int F_11 ( struct V_28 * V_22 , bool V_29 ,
bool (F_7)( const struct V_1 * , bool ) )
{
...
return F_6 ( V_2 , V_29 , F_7 ) ;
}
static int F_15 ( struct V_28 * V_22 )
{
return F_11 ( V_22 , true , F_4 ) ;
}
static void F_16 ( struct V_28 * V_22 )
{
F_11 ( V_22 , false , F_4 ) ;
}
static int F_17 ( struct V_28 * V_22 )
{
return F_11 ( V_22 , true , F_5 ) ;
}
static void F_18 ( struct V_28 * V_22 )
{
F_11 ( V_22 , false , F_5 ) ;
}
