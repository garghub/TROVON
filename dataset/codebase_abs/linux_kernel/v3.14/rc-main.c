...
return - V_48 ;
F_80 ( V_114 , V_26 -> V_35 -> V_115 ) ;
F_80 ( V_116 , V_26 -> V_35 -> V_115 ) ;
F_80 ( V_64 , V_26 -> V_35 -> V_115 ) ;
F_80 ( V_65 , V_26 -> V_35 -> V_117 ) ;
if ( V_26 -> V_76 )
V_26 -> V_35 -> V_76 = F_51 ;
if ( V_26 -> V_77 )
V_26 -> V_35 -> V_77 = F_53 ;
...
if ( V_111 >= V_119 )
return - V_16 ;
} while ( F_82 ( V_111 , V_118 ) );
V_26 -> V_111 = V_111 ;
F_83 ( & V_26 -> V_26 , L_28 , V_26 -> V_111 ) ;
F_84 ( & V_26 -> V_26 , V_26 ) ;
V_6 = F_85 ( & V_26 -> V_26 ) ;
if ( V_6 )
goto V_120;
...
if ( V_6 )
goto V_121;
V_26 -> V_35 -> V_26 . V_122 = & V_26 -> V_26 ;
memcpy ( & V_26 -> V_35 -> V_123 , & V_26 -> V_124 , sizeof( V_26 -> V_124 ) ) ;
V_26 -> V_35 -> V_125 = V_26 -> V_126 ;
...
if ( V_6 )
goto V_127;
V_26 -> V_35 -> V_128 [ V_129 ] = 500 ;
V_26 -> V_35 -> V_128 [ V_130 ] = 125 ;
V_110 = F_87 ( & V_26 -> V_26 . V_131 , V_15 ) ;
F_8 ( V_8 L_29 ,
F_56 ( & V_26 -> V_26 ) ,
...
V_120:
F_50 ( & V_26 -> V_46 ) ;
F_93 ( V_26 -> V_111 , V_118 ) ;
return V_6 ;
}
void F_94 ( struct V_25 * V_26 )
{
if ( ! V_26 )
return;
F_95 ( & V_26 -> V_69 ) ;
