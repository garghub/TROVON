...
inline void F_13 ( struct V_37 * V_38 ,
struct V_7 * V_8 )
{
unsigned long V_45 ;
...
inline void F_18 ( struct V_37 * V_38 ,
struct V_7 * V_8 )
{
short V_46 = V_8 -> V_47 & V_48 ;
struct V_49 * V_50 =
...
inline struct V_37 *
F_19 ( struct V_1 * V_62 ,
struct V_7 * V_8 , T_1 V_63 )
{
struct V_37 * V_38 ;
struct V_64 * V_65 ;
...
void F_22 ( struct V_7 * V_8 , T_1 * V_76 , T_1 V_63 )
{
...
static void F_30 ( unsigned long V_91 )
{
struct V_7 * V_8 =
(struct V_7 * ) V_91 ;
unsigned long V_45 ;
...
static struct V_37 * F_58 ( struct V_7 * V_8 ,
T_1 * V_137 )
{
T_1 * V_16 ;
int V_138 ;
...
static struct V_37 * F_59 ( struct V_7 * V_8 ,
T_1 * V_137 )
{
struct V_37 * V_38 ;
T_1 * V_16 ;
...
static struct V_37 * F_61 ( struct V_7 * V_8 , short V_175 )
{
struct V_37 * V_38 ;
struct V_49 * V_176 ;
...
static void F_62 ( struct V_7 * V_8 , T_1 * V_137 )
{
...
static void F_63 ( struct V_7 * V_8 , int V_182 , T_1 * V_137 )
{
...
static void F_64 ( struct V_7 * V_8 , T_1 * V_137 )
{
...
static void F_68 ( unsigned long V_55 )
{
...
static void F_71 ( struct V_7 * V_8 , T_1 * V_209 ,
int V_210 )
{
T_1 * V_211 ;
struct V_37 * V_38 ;
...
static void F_80 ( struct V_109 * V_110 )
{
...
inline void F_81 ( struct V_7 * V_8 ,
struct V_1 * V_2 )
{
T_1 V_223 [ V_224 + 1 ] ;
int V_225 = 0 ;
...
static int F_87 ( struct V_37 * V_38 , T_1 * V_137 )
{
struct V_125 * V_240 ;
if ( V_38 -> V_77 < ( sizeof( struct V_125 ) - sizeof( struct V_242 ) ) ) {
F_67 ( L_16 , V_38 -> V_77 ) ;
...
static short F_89 ( struct V_7 * V_8 , struct V_37 * V_38 ,
T_1 * V_246 )
{
T_1 * V_16 ;
T_1 * V_247 ;
...
static int F_90 ( struct V_37 * V_38 , T_1 * V_137 )
{
struct V_183 * V_240 ;
...
static inline void F_92 ( struct V_7 * V_8 ,
struct V_37 * V_38 )
{
T_1 V_137 [ V_71 ] ;
V_8 -> V_85 . V_249 ++ ;
...
inline void F_93 ( struct V_7 * V_8 ,
struct V_37 * V_38 )
{
T_1 V_137 [ V_71 ] ;
int V_135 ;
...
static short F_96 ( struct V_7 * V_8 , T_2 * V_253 ,
T_2 * V_254 )
{
int V_255 = 0 ;
T_1 V_256 ;
...
inline int F_99 ( struct V_7 * V_8 ,
struct V_37 * V_38 ,
struct V_279 * V_280 ,
V_161 type , V_161 V_281 )
{
...
static void F_140 ( struct V_7 * V_8 , char * V_167 ,
int V_147 )
{
F_139 ( V_8 , 1 ) ;
F_119 ( V_8 ) ;
}
static int F_141 ( struct V_7 * V_8 , int V_349 ,
int V_350 )
{
int V_43 = 0 ;
switch ( V_349 ) {
...
static int F_144 ( struct V_7 * V_8 , T_1 V_153 ,
T_2 V_347 )
{
int V_43 = 0 ;
unsigned long V_45 ;
...
V_355 = F_150 ( V_417 -> V_419 , V_417 -> V_418 ) ;
if ( F_151 ( V_355 ) ) {
V_43 = F_152 ( V_355 ) ;
goto V_100;
}
switch ( V_355 -> V_420 ) {
case V_421 :
V_43 = F_144 ( V_8 , V_355 -> V_357 . V_422 . V_153 ,
V_355 -> V_357 . V_422 . V_347 ) ;
break;
case V_423 :
...
break;
case V_425 :
V_43 = F_141 ( V_8 , V_355 -> V_357 . V_426 . V_349 ,
V_355 -> V_357 . V_426 . V_427 ) ;
break;
default:
F_9 ( L_39 , V_355 -> V_420 ) ;
V_43 = - V_353 ;
break;
}
if ( V_43 == 0 && F_153 ( V_417 -> V_419 , V_355 , V_417 -> V_418 ) )
V_43 = - V_428 ;
F_73 ( V_355 ) ;
V_100:
F_37 ( & V_8 -> V_221 ) ;
...
F_154 ( V_8 -> V_55 , V_435 , & V_430 , NULL ) ;
}
