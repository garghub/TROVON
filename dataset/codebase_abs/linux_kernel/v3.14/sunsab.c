...
V_201 = F_55 ( & V_2 -> V_14 . V_87 , V_85 ) ;
else
F_26 ( & V_2 -> V_14 . V_87 , V_85 ) ;
F_56 ( & V_2 -> V_14 , V_199 , V_157 , F_53 ) ;
F_1 ( V_2 ) ;
if ( V_201 )
F_27 ( & V_2 -> V_14 . V_87 , V_85 ) ;
}
static int F_57 ( struct V_197 * V_198 , char * V_204 )
{
struct V_1 * V_2 = & V_200 [ V_198 -> V_37 ] ;
unsigned long V_85 ;
...
F_59 ( V_198 , V_2 -> V_14 . V_208 -> V_209 ) ;
...
static inline struct V_197 * F_61 ( void )
{
return & V_225 ;
}
...
V_2 -> V_14 . V_232 = F_63 ( & V_227 -> V_230 [ 0 ] , V_228 ,
sizeof( union V_233 ) ,
L_1 ) ;
if ( ! V_2 -> V_14 . V_232 )
return - V_234 ;
...
static int F_64 ( struct V_226 * V_227 )
{
static int V_249 ;
struct V_1 * V_2 ;
int V_122 ;
V_2 = & V_200 [ V_249 * 2 ] ;
V_122 = F_62 ( & V_2 [ 0 ] , V_227 ,
0 ,
( V_249 * 2 ) + 0 ) ;
if ( V_122 )
goto V_250;
V_122 = F_62 ( & V_2 [ 1 ] , V_227 ,
sizeof( union V_233 ) ,
( V_249 * 2 ) + 1 ) ;
if ( V_122 )
goto V_251;
F_65 ( F_61 () , V_227 -> V_208 . V_209 ,
& V_206 , V_2 [ 0 ] . V_14 . line ,
false ) ;
F_65 ( F_61 () , V_227 -> V_208 . V_209 ,
& V_206 , V_2 [ 1 ] . V_14 . line ,
false ) ;
V_122 = F_66 ( & V_206 , & V_2 [ 0 ] . V_14 ) ;
if ( V_122 )
goto V_252;
V_122 = F_66 ( & V_206 , & V_2 [ 1 ] . V_14 ) ;
if ( V_122 )
goto V_253;
F_67 ( V_227 , & V_2 [ 0 ] ) ;
V_249 ++ ;
...
static int F_70 ( struct V_226 * V_227 )
{
struct V_1 * V_2 = F_71 ( V_227 ) ;
F_68 ( & V_206 , & V_2 [ 1 ] . V_14 ) ;
F_68 ( & V_206 , & V_2 [ 0 ] . V_14 ) ;
F_69 ( & V_227 -> V_230 [ 0 ] ,
V_2 [ 1 ] . V_14 . V_232 ,
sizeof( union V_233 ) ) ;
...
if ( V_256 ) {
V_200 = F_75 ( sizeof( struct V_1 ) *
V_256 , V_257 ) ;
if ( ! V_200 )
return - V_234 ;
V_122 = F_76 ( & V_206 , V_256 ) ;
if ( V_122 ) {
F_77 ( V_200 ) ;
V_200 = NULL ;
return V_122 ;
