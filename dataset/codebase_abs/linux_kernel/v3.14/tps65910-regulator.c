...
V_139 = F_28 ( V_133 -> V_50 . V_137 -> V_146 ) ;
V_140 = F_29 ( V_139 , L_9 ) ;
if ( ! V_140 ) {
...
F_31 ( V_140 ) ;
if ( V_64 < 0 ) {
F_23 ( & V_133 -> V_50 , L_12 ,
V_64 ) ;
return NULL ;
}
* V_135 = V_141 ;
for ( V_143 = 0 ; V_143 < V_144 ; V_143 ++ ) {
if ( ! V_141 [ V_143 ] . V_149 || ! V_141 [ V_143 ] . V_146 )
continue;
V_136 -> V_150 [ V_143 ] =
V_141 [ V_143 ] . V_149 ;
V_64 = F_32 ( V_141 [ V_143 ] . V_146 ,
L_13 , & V_142 ) ;
if ( ! V_64 )
...
case V_123 :
V_53 -> V_58 = & F_1 ;
V_53 -> V_163 = F_30 ( V_164 ) ;
V_53 -> V_112 = V_165 ;
V_107 = V_164 ;
break;
case V_127 :
V_53 -> V_58 = & F_2 ;
V_53 -> V_163 = F_30 ( V_166 ) ;
V_53 -> V_112 = V_167 ;
V_107 = V_166 ;
break;
default:
...
sizeof( struct V_169 ) , V_145 ) ;
if ( ! V_53 -> V_93 ) {
F_23 ( & V_133 -> V_50 , L_16 ) ;
return - V_160 ;
}
V_53 -> V_107 = F_27 ( & V_133 -> V_50 , V_53 -> V_163 *
sizeof( struct V_154 * ) , V_145 ) ;
if ( ! V_53 -> V_107 ) {
F_23 ( & V_133 -> V_50 , L_17 ) ;
return - V_160 ;
}
V_53 -> V_157 = F_27 ( & V_133 -> V_50 , V_53 -> V_163 *
sizeof( struct V_49 * ) , V_145 ) ;
if ( ! V_53 -> V_157 ) {
F_23 ( & V_133 -> V_50 , L_18 ) ;
return - V_160 ;
}
for ( V_158 = 0 ; V_158 < V_53 -> V_163 && V_158 < V_170 ;
V_158 ++ , V_107 ++ ) {
V_156 = V_136 -> V_150 [ V_158 ] ;
if ( ! V_156 )
continue;
V_53 -> V_107 [ V_158 ] = V_107 ;
V_53 -> V_93 [ V_158 ] . V_171 = V_107 -> V_171 ;
V_53 -> V_93 [ V_158 ] . V_172 = V_107 -> V_173 ;
V_53 -> V_93 [ V_158 ] . V_1 = V_158 ;
V_53 -> V_93 [ V_158 ] . V_174 = V_107 -> V_174 ;
V_53 -> V_93 [ V_158 ] . V_175 = V_107 -> V_176 ;
if ( V_158 == V_6 || V_158 == V_8 ) {
V_53 -> V_93 [ V_158 ] . V_177 = & V_178 ;
V_53 -> V_93 [ V_158 ] . V_174 = V_100 *
V_179 ;
V_53 -> V_93 [ V_158 ] . V_180 = 12500 ;
} else if ( V_158 == V_10 ) {
if ( F_24 ( V_54 ) == V_123 ) {
V_53 -> V_93 [ V_158 ] . V_177 = & V_181 ;
V_53 -> V_93 [ V_158 ] . V_94 = V_107 -> V_108 ;
} else {
V_53 -> V_93 [ V_158 ] . V_177 = & V_178 ;
V_53 -> V_93 [ V_158 ] . V_180 = 5000 ;
}
} else if ( V_158 == V_28 &&
F_24 ( V_54 ) == V_123 ) {
V_53 -> V_93 [ V_158 ] . V_177 = & V_182 ;
V_53 -> V_93 [ V_158 ] . V_94 = V_107 -> V_108 ;
} else {
if ( F_24 ( V_54 ) == V_123 ) {
V_53 -> V_93 [ V_158 ] . V_177 = & V_183 ;
V_53 -> V_93 [ V_158 ] . V_94 = V_107 -> V_108 ;
} else {
V_53 -> V_93 [ V_158 ] . V_177 = & V_184 ;
}
}
V_159 = F_22 ( V_53 , V_158 ,
V_136 -> V_151 [ V_158 ] ) ;
if ( V_159 < 0 )
F_36 ( V_54 -> V_50 ,
L_19 ) ;
V_53 -> V_93 [ V_158 ] . type = V_185 ;
V_53 -> V_93 [ V_158 ] . V_186 = V_187 ;
V_53 -> V_93 [ V_158 ] . V_188 = V_53 -> V_58 ( V_158 ) ;
V_53 -> V_93 [ V_158 ] . V_189 = V_190 ;
V_153 . V_50 = V_54 -> V_50 ;
V_153 . V_149 = V_156 ;
V_153 . V_191 = V_53 ;
V_153 . V_192 = V_54 -> V_192 ;
if ( V_135 )
V_153 . V_146 = V_135 [ V_158 ] . V_146 ;
V_157 = F_37 ( & V_133 -> V_50 , & V_53 -> V_93 [ V_158 ] ,
& V_153 ) ;
if ( F_38 ( V_157 ) ) {
F_23 ( V_54 -> V_50 ,
L_20 ,
...
int V_158 ;
for ( V_158 = 0 ; V_158 < V_53 -> V_163 ; V_158 ++ ) {
int V_159 ;
if ( ! V_53 -> V_157 [ V_158 ] )
continue;
V_159 = F_22 ( V_53 , V_158 , 0 ) ;
if ( V_159 < 0 )
F_23 ( & V_133 -> V_50 ,
L_21 ) ;
}
