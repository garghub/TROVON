...
{
struct V_1 * V_2 ;
struct V_38 * V_39 = F_13 ( & V_6 -> V_32 ) ;
struct V_22 * V_22 ;
int error ;
if ( ! F_14 ( V_6 -> V_15 , V_40 ) ) {
F_15 ( & V_6 -> V_32 , L_1 ) ;
return - V_41 ;
}
if ( ! V_6 -> V_20 ) {
...
V_2 = F_16 ( & V_6 -> V_32 , sizeof( * V_2 ) , V_43 ) ;
if ( ! V_2 )
return - V_44 ;
V_22 = F_17 ( & V_6 -> V_32 ) ;
if ( ! V_22 )
...
if ( V_39 )
V_2 -> V_35 = V_39 -> V_35 ;
else if ( V_6 -> V_32 . V_45 )
V_2 -> V_35 = F_18 ( V_6 -> V_32 . V_45 , 0 ) ;
else
V_2 -> V_35 = - V_46 ;
if ( F_10 ( V_2 -> V_35 ) ) {
error = F_19 ( & V_6 -> V_32 , V_2 -> V_35 , NULL ) ;
if ( error ) {
F_15 ( & V_6 -> V_32 ,
L_3 ,
V_2 -> V_35 ) ;
...
V_22 -> V_47 = L_4 ;
V_22 -> V_37 . V_48 = V_49 ;
V_22 -> V_32 . V_50 = & V_6 -> V_32 ;
F_20 ( V_51 , V_22 -> V_52 ) ;
F_20 ( V_53 , V_22 -> V_52 ) ;
F_20 ( V_54 , V_22 -> V_52 ) ;
F_21 ( V_22 , V_28 , 0 , V_55 , 0 , 0 ) ;
F_21 ( V_22 , V_29 , V_56 , V_57 , 0 , 0 ) ;
F_21 ( V_22 , V_30 , V_58 , V_59 , 0 , 0 ) ;
...
static int F_28 ( struct V_61 * V_32 )
{
...
static int F_33 ( struct V_61 * V_32 )
{
struct V_5 * V_6 = F_29 ( V_32 ) ;
struct V_1 * V_2 = F_27 ( V_6 ) ;
if ( F_30 ( & V_6 -> V_32 ) ) {
