...
break;
case V_57 :
if ( V_36 ( & V_32 -> V_58 ) != sizeof( T_7 )
|| V_36 ( & V_32 -> V_59 ) != sizeof( V_60 ) ) {
fprintf ( V_10 ,
L_7 , V_6 ) ;
F_7 () ;
}
...
break;
case V_61 : {
T_8 * const V_62 = ( T_8 * ) V_32 ;
if ( V_36 ( & V_62 -> V_58 ) != sizeof( T_8 )
|| V_36 ( & V_62 -> V_59 ) != sizeof( V_63 ) ) {
fprintf ( V_10 ,
L_7 , V_6 ) ;
F_7 () ;
}
...
for ( V_17 = 1 ; V_17 < V_64 ; V_17 ++ ) {
char * V_67 = V_65 [ V_17 ] ;
int const V_68 = setjmp ( V_69 ) ;
switch ( V_68 ) {
default:
fprintf ( V_10 , L_9 , V_67 ) ;
exit ( 1 ) ;
break;
case V_70 :
V_5 = - 1 ;
