...
T_9 V_56 , const char * V_60 )
{
struct V_61 * V_55 = & V_21 -> V_55 ;
const char * V_62 = F_42 ( V_21 ) ;
if ( ! ( V_55 -> V_56 & V_56 ) ) {
F_23 ( L_8 ,
V_62 , V_60 ) ;
return - V_63 ;
...
if ( ! V_70 -> V_17 )
F_46 ( V_70 -> V_81 , T_2 -> V_9 . V_82 , V_83 ) ;
V_16 = F_47 ( T_2 , & V_6 -> V_2 ) ;
if ( ! V_70 -> V_17 ) {
T_2 -> V_9 . V_84 = V_6 -> V_11 ;
F_48 ( T_2 , T_2 -> V_85 , V_70 -> V_81 , true ) ;
}
F_49 ( T_2 ) ;
return V_16 ;
}
int F_50 ( int V_86 , const char * * V_87 , const char * T_10 V_13 )
{
struct V_5 V_6 = {
. V_2 = {
. T_3 = F_8 ,
...
F_52 ( 'b' , L_14 , & V_6 . V_72 ,
L_15 ) ,
F_53 ( 'i' , L_16 , & V_6 . V_67 , L_17 ,
L_18 ) ,
F_53 ( 'o' , L_19 , & V_6 . V_8 . V_66 , L_17 ,
L_20 ) ,
F_52 ( 's' , L_21 , & V_6 . V_73 ,
L_22
L_23 ) ,
F_54 ( 'v' , L_24 , & V_97 ,
L_25 ) ,
...
V_86 = F_56 ( V_86 , V_87 , V_96 , V_98 , 0 ) ;
if ( V_86 )
F_57 ( V_98 , V_96 ) ;
if ( F_58 ( & V_6 . V_8 ) ) {
perror ( L_27 ) ;
