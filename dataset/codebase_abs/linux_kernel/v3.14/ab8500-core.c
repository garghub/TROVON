...
int V_24 ;
T_2 V_15 ;
V_1 = F_64 ( & V_99 -> V_5 , sizeof *V_1 , V_111 ) ;
if ( ! V_1 )
return - V_112 ;
if ( V_103 )
V_1 -> V_78 = V_103 -> V_78 ;
V_1 -> V_5 = & V_99 -> V_5 ;
V_110 = F_65 ( V_99 , V_113 , 0 ) ;
if ( ! V_110 )
return - V_114 ;
...
V_1 -> V_6 = F_64 ( & V_99 -> V_5 , V_1 -> V_25 , V_111 ) ;
if ( ! V_1 -> V_6 )
return - V_112 ;
V_1 -> V_27 = F_64 ( & V_99 -> V_5 , V_1 -> V_25 , V_111 ) ;
if ( ! V_1 -> V_27 )
return - V_112 ;
V_4 = F_17 ( V_1 , V_84 ,
V_85 , & V_15 ) ;
...
if ( V_4 < 0 )
return V_4 ;
F_60 ( V_1 -> V_5 , L_35 , V_15 ) ;
if ( V_15 ) {
for ( V_24 = 0 ; V_24 < F_69 ( V_101 ) ; V_24 ++ ) {
if ( V_15 & 1 )
F_70 ( L_36 , V_101 [ V_24 ] ) ;
V_15 = V_15 >> 1 ;
}
F_70 ( L_33 ) ;
} else {
...
V_4 = F_73 ( V_1 -> V_5 , 0 , V_148 ,
F_69 ( V_148 ) , NULL ,
V_1 -> V_78 , V_1 -> V_53 ) ;
if ( V_4 )
return V_4 ;
if ( ! V_149 ) {
V_4 = F_73 ( V_1 -> V_5 , 0 , V_150 ,
F_69 ( V_150 ) , NULL ,
V_1 -> V_78 , V_1 -> V_53 ) ;
if ( V_4 )
F_3 ( V_1 -> V_5 , L_39 ) ;
...
V_1 -> V_10 >= V_151 ) || F_45 ( V_1 ) )
V_4 = F_75 ( & V_1 -> V_5 -> V_152 ,
& V_153 ) ;
else
V_4 = F_75 ( & V_1 -> V_5 -> V_152 ,
& V_154 ) ;
...
{
struct V_1 * V_1 = F_77 ( V_99 ) ;
if ( ( ( F_47 ( V_1 ) || F_46 ( V_1 ) ) &&
V_1 -> V_10 >= V_151 ) || F_45 ( V_1 ) )
F_78 ( & V_1 -> V_5 -> V_152 , & V_153 ) ;
else
F_78 ( & V_1 -> V_5 -> V_152 , & V_154 ) ;
if ( ( F_47 ( V_1 ) || F_46 ( V_1 ) ) &&
V_1 -> V_10 >= V_151 )
F_78 ( & V_1 -> V_5 -> V_152 , & V_155 ) ;
F_79 ( V_1 -> V_5 ) ;
return 0 ;
}
