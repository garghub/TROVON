...
static void F_56 ( struct V_3 * V_4 , struct V_51 * V_52 )
{
F_57 ( V_52 -> V_53 , L_1 , sizeof( V_52 -> V_53 ) ) ;
F_57 ( V_52 -> V_54 , V_55 , sizeof( V_52 -> V_54 ) ) ;
F_57 ( V_52 -> V_56 , L_2 , sizeof( V_52 -> V_56 ) ) ;
F_57 ( V_52 -> V_57 , L_2 , sizeof( V_52 -> V_57 ) ) ;
}
static T_3 F_58 ( struct V_3 * V_4 ,
T_3 V_58 )
{
struct V_5 * V_6 = F_2 ( V_4 ) ;
return F_59 ( V_6 , V_58 ) ;
}
static void F_60 ( struct V_3 * V_59 )
{
}
...
static int F_64 ( struct V_60 * V_44 , T_4 V_61 )
{
struct V_62 * V_63 ;
int V_64 ;
V_63 = F_65 ( sizeof( * V_44 -> V_63 ) , V_61 ) ;
if ( ! V_63 )
return - V_29 ;
V_64 = F_66 ( V_63 , V_44 -> V_4 , V_61 ) ;
if ( V_64 ) {
F_67 ( V_63 ) ;
return V_64 ;
}
...
int F_68 ( struct V_60 * V_44 , T_4 V_61 )
{
if ( ! V_44 -> V_6 -> V_4 -> V_65 )
return 0 ;
return F_64 ( V_44 , V_61 ) ;
}
static int F_69 ( struct V_3 * V_4 , struct V_66 * V_67 ,
T_4 V_61 )
{
struct V_5 * V_6 = F_2 ( V_4 ) ;
struct V_60 * V_44 ;
...
static int F_71 ( struct V_3 * V_4 , struct V_3 * V_69 )
{
struct V_5 * V_6 = F_2 ( V_4 ) ;
return F_72 ( V_6 , V_69 ) ;
}
static int F_73 ( struct V_3 * V_4 , struct V_3 * V_69 )
{
struct V_5 * V_6 = F_2 ( V_4 ) ;
return F_74 ( V_6 , V_69 ) ;
}
...
F_84 ( & V_6 -> V_84 ) ;
F_83 ( & V_6 -> V_85 ) ;
V_6 -> V_86 . V_87 [ 0 ] = 0x80 ;
V_6 -> V_86 . V_87 [ 1 ] = 0x00 ;
memcpy ( V_6 -> V_88 , V_89 , V_90 ) ;
V_6 -> V_91 = V_92 ;
V_6 -> V_93 = V_94 ;
V_6 -> V_95 = V_6 -> V_86 ;
