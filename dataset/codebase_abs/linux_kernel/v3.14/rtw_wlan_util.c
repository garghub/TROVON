...
if ( V_216 && V_47 > 0 ) {
V_230 = (struct V_165 * ) ( V_216 + 2 ) ;
V_235 = V_230 -> V_172 [ 0 ] ;
} else {
V_235 = 0 ;
}
if ( V_234 != V_181 -> V_246 . V_234 ||
( ( V_235 & 0x03 ) != ( V_181 -> V_246 . V_235 & 0x03 ) ) ) {
F_29 ( L_7 , V_77 ,
V_234 , V_235 ) ;
F_29 ( L_8 , V_77 ,
V_181 -> V_246 . V_234 , V_181 -> V_246 . V_235 ) ;
F_29 ( L_9 , V_77 ) ;
V_181 -> V_246 . V_234 = V_234 ;
...
F_29 ( L_10 , V_77 ) ;
V_233 = V_53 -> V_25 . V_29 ;
}
}
if ( V_233 != V_53 -> V_25 . V_29 ) {
F_29 ( L_11 , V_77 ,
V_233 , V_53 -> V_25 . V_29 ) ;
goto V_249;
}
...
memcpy ( V_223 -> V_252 . V_252 , ( V_216 + 2 ) , V_236 ) ;
V_223 -> V_252 . V_253 = V_236 ;
F_62 ( V_254 , V_255 , ( L_12
L_13 , V_77 , V_223 -> V_252 . V_252 ,
V_223 -> V_252 . V_253 , V_181 -> V_182 . V_252 . V_252 ,
V_181 -> V_182 . V_252 . V_253 ) ) ;
if ( ! F_58 ( V_223 -> V_252 . V_252 , V_181 -> V_182 . V_252 . V_252 , 32 ) ||
V_223 -> V_252 . V_253 != V_181 -> V_182 . V_252 . V_253 ) {
if ( V_223 -> V_252 . V_252 [ 0 ] != '\0' && V_223 -> V_252 . V_253 != 0 ) {
F_29 ( L_14 , V_77 ) ;
goto V_249;
}
}
...
F_62 ( V_254 , V_255 ,
( L_15 ,
V_77 , V_181 -> V_182 . V_256 , V_223 -> V_256 ) ) ;
if ( V_181 -> V_182 . V_256 != V_223 -> V_256 ) {
F_29 ( L_16 , V_77 ) ;
goto V_249;
}
...
if ( V_222 == V_258 || V_222 == V_257 ) {
V_227 = F_65 ( & V_223 -> V_88 [ 12 ] , & V_228 , V_223 -> V_241 - 12 ) ;
if ( V_227 && ( V_228 > 0 ) ) {
if ( V_260 == F_66 ( V_227 , V_228 + 2 , & V_224 , & V_225 , & V_226 ) ) {
F_62 ( V_254 , V_255 ,
( L_18 , V_77 ,
V_225 , V_224 , V_226 ) ) ;
}
...
if ( V_227 && ( V_228 > 0 ) ) {
if ( V_260 == F_68 ( V_227 , V_228 + 2 , & V_224 , & V_225 , & V_226 ) ) {
F_62 ( V_254 , V_255 ,
( L_19 ,
...
F_62 ( V_254 , V_261 ,
( L_20 , V_77 , V_181 -> V_246 . V_224 , V_224 ) ) ;
...
void F_70 ( struct V_21 * V_22 , T_1 * V_214 , T_6 V_263 , struct V_179 * V_180 )
{
unsigned int V_3 ;
unsigned int V_47 ;
struct V_115 * V_116 ;
V_47 = V_263 - ( V_264 + V_265 ) ;
for ( V_3 = 0 ; V_3 < V_47 ; ) {
V_116 = (struct V_115 * ) ( V_214 + ( V_264 + V_265 ) + V_3 ) ;
switch ( V_116 -> V_266 ) {
case V_267 :
F_48 ( V_22 , V_116 ) ;
break;
...
struct V_26 * V_27 = & ( V_24 -> V_28 ) ;
struct V_84 * V_181 = & ( V_27 -> V_182 ) ;
if ( F_63 ( (struct V_84 * ) V_181 ) & V_269 ) {
for ( V_3 = sizeof( struct V_270 ) ; V_3 < V_27 -> V_182 . V_241 ; ) {
V_116 = (struct V_115 * ) ( V_27 -> V_182 . V_88 + V_3 ) ;
switch ( V_116 -> V_266 ) {
case V_271 :
if ( ( F_58 ( V_116 -> V_124 , V_272 , 4 ) ) && ( F_58 ( ( V_116 -> V_124 + 12 ) , V_273 , 4 ) ) )
return true ;
break;
case V_274 :
if ( F_58 ( ( V_116 -> V_124 + 8 ) , V_275 , 4 ) )
return true ;
default:
break;
}
...
if ( F_63 ( (struct V_84 * ) V_181 ) & V_269 ) {
for ( V_3 = sizeof( struct V_270 ) ; V_3 < V_181 -> V_241 ; ) {
V_116 = (struct V_115 * ) ( V_181 -> V_88 + V_3 ) ;
switch ( V_116 -> V_266 ) {
case V_271 :
if ( F_58 ( V_116 -> V_124 , V_272 , 4 ) &&
( ( F_58 ( ( V_116 -> V_124 + 12 ) , V_276 , 4 ) ) ||
( F_58 ( ( V_116 -> V_124 + 16 ) , V_276 , 4 ) ) ) )
return false ;
break;
case V_274 :
if ( ( F_58 ( ( V_116 -> V_124 + 8 ) , V_277 , 4 ) ) ||
( F_58 ( ( V_116 -> V_124 + 12 ) , V_277 , 4 ) ) )
return false ;
default:
break;
}
...
unsigned int F_75 ( unsigned char * V_278 , unsigned int V_279 )
{
unsigned int V_3 , V_280 ;
unsigned int V_281 = 0 ;
V_280 = ( V_279 > V_44 ) ? V_44 : V_279 ;
for ( V_3 = 0 ; V_3 < V_280 ; V_3 ++ ) {
if ( ( * ( V_278 + V_3 ) ) & 0x80 )
V_281 |= 0x1 << F_74 ( * ( V_278 + V_3 ) ) ;
}
return V_281 ;
}
unsigned int F_76 ( unsigned char * V_278 , unsigned int V_279 )
{
unsigned int V_3 , V_280 ;
unsigned int V_281 = 0 ;
V_280 = ( V_279 > V_44 ) ? V_44 : V_279 ;
...
unsigned int F_77 ( struct V_282 * V_283 )
{
unsigned int V_281 = 0 ;
V_281 = ( ( V_283 -> V_194 . V_196 . V_201 [ 0 ] << 12 ) | ( V_283 -> V_194 . V_196 . V_201 [ 1 ] << 20 ) ) ;
return V_281 ;
}
int F_78 ( struct V_21 * V_22 , struct V_282 * V_283 )
{
unsigned char V_284 ;
struct V_23 * V_24 = & V_22 -> V_25 ;
struct V_26 * V_27 = & ( V_24 -> V_28 ) ;
...
if ( ( V_27 -> V_285 == V_286 ) )
return V_89 ;
V_284 = ( V_24 -> V_176 & V_174 ) ? 6 : 5 ;
if ( F_79 ( V_283 -> V_194 . V_196 . V_287 ) & ( 0x1 << V_284 ) )
return V_260 ;
else
return V_89 ;
}
unsigned char F_80 ( T_2 V_281 )
{
int V_3 ;
unsigned char V_288 = 0 ;
...
void F_85 ( struct V_21 * V_22 , T_1 V_289 )
{
unsigned char V_290 [ V_55 ] ;
#ifdef F_86
struct V_291 * V_292 = & V_22 -> V_293 ;
if ( ! F_87 ( V_292 , V_294 ) )
return;
#endif
F_9 ( V_290 , 0 , V_55 ) ;
if ( ( V_289 & V_6 ) && ( V_289 == V_6 ) )
memcpy ( V_290 , V_295 , 4 ) ;
else if ( V_289 & V_6 )
memcpy ( V_290 , V_296 , 7 ) ;
else
memcpy ( V_290 , V_297 , 3 ) ;
if ( V_289 & V_6 )
F_88 ( V_22 , V_32 ) ;
else
F_88 ( V_22 , V_36 ) ;
F_13 ( V_22 , V_298 , V_290 ) ;
}
...
V_299 = 0 ;
V_300 = 0 ;
for ( V_3 = sizeof( struct V_270 ) ; V_3 < V_47 ; ) {
V_116 = (struct V_115 * ) ( V_214 + V_3 ) ;
switch ( V_116 -> V_266 ) {
case V_271 :
if ( ( F_58 ( V_116 -> V_124 , V_301 , 3 ) ) ||
( F_58 ( V_116 -> V_124 , V_302 , 3 ) ) ) {
F_29 ( L_23 ) ;
return V_303 ;
} else if ( ( F_58 ( V_116 -> V_124 , V_304 , 3 ) ) ||
( F_58 ( V_116 -> V_124 , V_305 , 3 ) ) ||
( F_58 ( V_116 -> V_124 , V_305 , 3 ) ) ) {
F_29 ( L_24 ) ;
return V_306 ;
} else if ( F_58 ( V_116 -> V_124 , V_307 , 3 ) ) {
F_29 ( L_25 ) ;
return V_308 ;
...
} else if ( F_58 ( V_116 -> V_124 , V_310 , 3 ) ) {
F_29 ( L_27 ) ;
return V_311 ;
} else if ( F_58 ( V_116 -> V_124 , V_312 , 3 ) ) {
F_29 ( L_28 ) ;
return V_313 ;
} else if ( F_58 ( V_116 -> V_124 , V_314 , 3 ) ) {
F_29 ( L_29 ) ;
return V_315 ;
} else if ( F_58 ( V_116 -> V_124 , V_316 , 3 ) ) {
V_299 = 1 ;
if ( V_300 ) {
F_29 ( L_30 ) ;
return V_317 ;
...
void F_91 ( struct V_21 * V_53 , T_4 V_322 )
{
...
struct V_26 * V_27 = & ( V_24 -> V_28 ) ;
struct V_84 * V_181 = & ( V_27 -> V_182 ) ;
unsigned char * V_1 = V_181 -> V_335 ;
V_2 = F_93 ( V_181 -> V_335 ) ;
if ( ( V_27 -> V_204 ) && ( V_27 -> V_192 ) )
V_27 -> V_30 = 1 ;
if ( V_24 -> V_29 > 14 ) {
if ( V_27 -> V_30 )
...
V_24 -> V_143 = V_4 & V_22 -> V_142 . V_336 ;
V_334 = 0x0a0a0808 ;
V_22 -> V_337 . V_338 ( V_22 , V_339 , ( T_1 * ) & V_334 ) ;
if ( V_24 -> V_143 & V_6 )
F_88 ( V_22 , V_32 ) ;
else
F_88 ( V_22 , V_36 ) ;
...
struct V_26 * V_27 = & ( V_24 -> V_28 ) ;
if ( V_24 -> V_143 & V_6 ) {
memcpy ( ( V_27 -> V_95 [ V_113 ] . V_335 ) , V_295 , 4 ) ;
} else {
memcpy ( ( V_27 -> V_95 [ V_113 ] . V_335 ) , V_297 , 3 ) ;
}
}
int F_95 ( struct V_21 * V_22 , T_1 * V_340 , T_6 V_341 , int V_342 )
{
unsigned int V_343 ;
struct V_115 * V_116 ;
int V_344 = 0 ;
struct V_23 * V_24 = & ( V_22 -> V_25 ) ;
struct V_26 * V_27 = & ( V_24 -> V_28 ) ;
V_116 = (struct V_115 * ) F_61 ( V_340 , V_345 , & V_343 , V_341 ) ;
if ( V_116 == NULL )
return V_89 ;
memcpy ( V_27 -> V_95 [ V_342 ] . V_335 , V_116 -> V_124 , V_343 ) ;
V_344 = V_343 ;
V_116 = (struct V_115 * ) F_61 ( V_340 , V_346 , & V_343 , V_341 ) ;
if ( V_116 )
memcpy ( ( V_27 -> V_95 [ V_342 ] . V_335 + V_344 ) , V_116 -> V_124 , V_343 ) ;
return V_260 ;
}
void F_96 ( struct V_21 * V_22 , T_1 * V_347 , T_1 * V_107 )
{
struct V_179 * V_180 ;
T_4 V_348 ;
T_4 V_349 ;
struct V_350 * V_351 ;
struct V_183 * V_184 = & V_22 -> V_185 ;
struct V_352 * V_353 = (struct V_352 * ) V_347 ;
struct V_23 * V_24 = & V_22 -> V_25 ;
struct V_26 * V_27 = & ( V_24 -> V_28 ) ;
V_180 = F_50 ( V_184 , V_107 ) ;
if ( V_180 ) {
V_349 = F_35 ( V_353 -> V_354 ) ;
V_348 = ( V_349 >> 2 ) & 0x0f ;
V_351 = & V_180 -> V_355 [ V_348 ] ;
V_351 -> V_356 = 0xffff ;
V_351 -> V_61 = ( V_27 -> V_357 ) ? true : false ;
}
}
...
V_227 = ( T_7 * ) V_116 ;
V_24 -> V_358 = F_98 ( * ( V_227 + 1 ) ) ;
V_24 -> V_358 = V_24 -> V_358 << 32 ;
V_24 -> V_358 |= F_98 ( * V_227 ) ;
}
void F_99 ( struct V_21 * V_22 , struct V_23 * V_24 )
{
F_13 ( V_22 , V_359 , NULL ) ;
}
void F_100 ( struct V_21 * V_22 )
{
F_101 ( V_22 ) ;
}
int F_102 ( struct V_21 * V_21 , bool V_360 )
{
int V_96 = V_260 ;
if ( V_360 ) {
if ( V_361 == NULL ) {
