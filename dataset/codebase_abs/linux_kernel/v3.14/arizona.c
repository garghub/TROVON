...
V_194 = F_52 ( V_193 , V_195 * V_191 ) ;
F_48 ( V_187 , L_35 , V_194 ) ;
...
F_48 ( V_187 , L_38 , V_190 -> V_204 ) ;
return 0 ;
}
static void F_53 ( struct V_8 * V_8 , unsigned int V_109 ,
...
V_85 << V_216 ) ;
if ( V_208 )
F_7 ( V_8 -> V_19 , V_109 + 0x7 ,
V_217 ,
V_190 -> V_204 << V_218 ) ;
else
F_7 ( V_8 -> V_19 , V_109 + 0x9 ,
V_217 ,
V_190 -> V_204 << V_218 ) ;
...
static bool F_54 ( struct V_186 * V_187 )
{
...
static void F_55 ( struct V_186 * V_187 ,
struct V_189 * V_71 ,
struct V_189 * V_208 )
{
struct V_8 * V_8 = V_187 -> V_8 ;
int V_31 ;
bool V_222 = false ;
if ( V_187 -> V_223 >= 0 && V_187 -> V_224 &&
V_187 -> V_223 != V_187 -> V_225 ) {
F_7 ( V_8 -> V_19 , V_187 -> V_109 + 5 ,
V_226 ,
V_71 -> V_198 << V_227 ) ;
F_53 ( V_8 , V_187 -> V_109 , V_71 , V_187 -> V_223 ,
false ) ;
if ( V_187 -> V_225 >= 0 ) {
F_53 ( V_8 , V_187 -> V_109 + 0x10 , V_208 ,
V_187 -> V_225 , true ) ;
V_222 = true ;
}
} else if ( V_187 -> V_225 >= 0 ) {
F_7 ( V_8 -> V_19 , V_187 -> V_109 + 5 ,
V_226 ,
V_208 -> V_198 << V_227 ) ;
F_53 ( V_8 , V_187 -> V_109 , V_208 ,
V_187 -> V_225 , false ) ;
...
V_228 ,
V_228 ) ;
V_31 = F_58 ( & V_187 -> V_188 ,
F_59 ( 250 ) ) ;
if ( V_31 == 0 )
F_60 ( V_187 , L_41 ) ;
}
static void F_61 ( struct V_186 * V_187 )
{
struct V_8 * V_8 = V_187 -> V_8 ;
bool V_232 ;
F_7 ( V_8 -> V_19 , V_187 -> V_109 + 1 ,
V_231 , V_231 ) ;
F_62 ( V_8 -> V_19 , V_187 -> V_109 + 1 ,
V_221 , 0 , & V_232 ) ;
...
int V_31 ;
if ( V_187 -> V_223 == V_85 && V_187 -> V_224 == V_191 )
return 0 ;
if ( V_187 -> V_233 ) {
if ( V_191 > 0 ) {
V_31 = F_50 ( V_187 , & V_71 , V_191 , V_187 -> V_233 ) ;
if ( V_31 != 0 )
return V_31 ;
}
if ( V_187 -> V_225 >= 0 ) {
V_31 = F_50 ( V_187 , & V_208 , V_187 -> V_229 ,
V_187 -> V_233 ) ;
if ( V_31 != 0 )
return V_31 ;
}
...
V_187 -> V_223 = V_85 ;
V_187 -> V_224 = V_191 ;
if ( V_187 -> V_233 && V_191 > 0 ) {
F_55 ( V_187 , & V_71 , & V_208 ) ;
}
return 0 ;
}
int F_65 ( struct V_186 * V_187 , int V_85 ,
unsigned int V_191 , unsigned int V_192 )
{
struct V_189 V_71 , V_208 ;
int V_31 ;
if ( V_187 -> V_225 == V_85 &&
V_187 -> V_229 == V_191 && V_187 -> V_233 == V_192 )
return 0 ;
if ( V_192 ) {
if ( V_187 -> V_223 >= 0 ) {
V_31 = F_50 ( V_187 , & V_71 , V_187 -> V_224 ,
V_192 ) ;
if ( V_31 != 0 )
return V_31 ;
}
V_31 = F_50 ( V_187 , & V_208 , V_191 , V_192 ) ;
if ( V_31 != 0 )
return V_31 ;
}
V_187 -> V_225 = V_85 ;
...
int F_66 ( struct V_8 * V_8 , int V_139 , int V_109 , int V_234 ,
int V_235 , struct V_186 * V_187 )
{
int V_31 ;
unsigned int V_14 ;
F_67 ( & V_187 -> V_188 ) ;
...
V_187 -> V_8 = V_8 ;
V_187 -> V_225 = V_236 ;
F_10 ( V_8 -> V_19 , V_237 , & V_14 ) ;
switch ( V_14 & V_238 ) {
case V_239 :
case V_240 :
V_187 -> V_223 = V_14 & V_238 ;
break;
default:
V_187 -> V_223 = V_236 ;
}
V_187 -> V_224 = 32768 ;
snprintf ( V_187 -> V_241 , sizeof( V_187 -> V_241 ) , L_42 , V_139 ) ;
snprintf ( V_187 -> V_242 , sizeof( V_187 -> V_242 ) ,
L_43 , V_139 ) ;
V_31 = F_16 ( V_8 , V_235 , V_187 -> V_242 ,
F_47 , V_187 ) ;
if ( V_31 != 0 ) {
F_11 ( V_8 -> V_9 , L_44 ,
V_139 , V_31 ) ;
...
int F_68 ( struct V_6 * V_7 , int V_243 , bool V_244 )
{
unsigned int V_53 , V_14 ;
if ( V_243 < 1 || V_243 > 6 )
return - V_65 ;
V_53 = V_245 + ( V_243 - 1 ) * 8 ;
if ( V_244 )
V_14 = V_246 ;
else
V_14 = 0 ;
return F_22 ( V_7 , V_53 , V_246 , V_14 ) ;
}
