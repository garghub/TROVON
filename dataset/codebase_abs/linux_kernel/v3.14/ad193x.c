...
int V_78 ;
V_6 -> V_79 = V_5 -> V_7 ;
V_78 = F_10 ( V_6 , 0 , 0 , V_80 ) ;
if ( V_78 < 0 ) {
F_11 ( V_6 -> V_81 , L_1 , V_78 ) ;
return V_78 ;
}
F_12 ( V_5 -> V_7 , V_82 , 0x0 ) ;
F_12 ( V_5 -> V_7 , V_8 , 0x1A ) ;
F_12 ( V_5 -> V_7 , V_83 , 0x41 ) ;
F_12 ( V_5 -> V_7 , V_84 , 0x3 ) ;
F_12 ( V_5 -> V_7 , V_54 , 0x43 ) ;
F_12 ( V_5 -> V_7 , V_73 , 0x99 ) ;
F_12 ( V_5 -> V_7 , V_85 , 0x04 ) ;
return V_78 ;
}
static bool F_13 ( struct V_86 * V_81 , unsigned int V_87 )
{
return false ;
}
static int F_14 ( struct V_88 * V_89 )
{
struct V_4 * V_5 ;
V_5 = F_15 ( & V_89 -> V_81 , sizeof( struct V_4 ) ,
V_90 ) ;
if ( V_5 == NULL )
return - V_91 ;
V_5 -> V_7 = F_16 ( V_89 , & V_92 ) ;
if ( F_17 ( V_5 -> V_7 ) )
return F_18 ( V_5 -> V_7 ) ;
F_19 ( V_89 , V_5 ) ;
return F_20 ( & V_89 -> V_81 , & V_93 ,
& V_94 , 1 ) ;
}
...
{
struct V_4 * V_5 ;
V_5 = F_15 ( & V_96 -> V_81 , sizeof( struct V_4 ) ,
V_90 ) ;
if ( V_5 == NULL )
return - V_91 ;
V_5 -> V_7 = F_24 ( V_96 , & V_99 ) ;
if ( F_17 ( V_5 -> V_7 ) )
return F_18 ( V_5 -> V_7 ) ;
F_25 ( V_96 , V_5 ) ;
return F_20 ( & V_96 -> V_81 , & V_93 ,
& V_94 , 1 ) ;
}
