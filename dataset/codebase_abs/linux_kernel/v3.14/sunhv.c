...
static inline void F_51 ( struct V_1 * V_2 , char V_18 )
{
int V_17 = 1000000 ;
while ( V_17 -- > 0 ) {
long V_5 = F_3 ( V_18 ) ;
...
static void F_52 ( struct V_72 * V_73 , const char * V_65 , unsigned V_66 )
{
struct V_1 * V_2 = V_74 ;
unsigned long V_37 ;
int V_28 , V_75 = 1 ;
...
return - V_86 ;
V_2 = F_56 ( sizeof( struct V_1 ) , V_87 ) ;
if ( F_57 ( ! V_2 ) )
return - V_88 ;
V_82 = 1 ;
if ( F_58 ( V_89 , 1 , & V_82 ) == 0 &&
V_82 >= 1 ) {
V_83 = - V_88 ;
V_70 = F_56 ( V_30 , V_87 ) ;
if ( ! V_70 )
...
if ( V_83 )
goto V_102;
F_60 ( & V_92 , V_81 -> V_100 . V_103 ,
& V_101 , V_2 -> line , false ) ;
V_83 = F_61 ( & V_101 , V_2 ) ;
if ( V_83 )
goto V_104;
V_83 = F_62 ( V_2 -> V_35 , F_23 , 0 , L_2 , V_2 ) ;
if ( V_83 )
goto V_105;
F_63 ( V_81 , V_2 ) ;
return 0 ;
...
static int F_67 ( struct V_80 * V_100 )
{
struct V_1 * V_2 = F_68 ( V_100 ) ;
F_69 ( V_2 -> V_35 , V_2 ) ;
F_64 ( & V_101 , V_2 ) ;
F_65 ( & V_101 , 1 ) ;
F_66 ( V_2 ) ;
