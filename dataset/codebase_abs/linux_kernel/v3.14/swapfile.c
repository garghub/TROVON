...
int F_77 ( T_4 V_114 , T_2 V_5 , struct V_115 * * V_116 )
{
...
return 0 ;
return F_82 ( F_3 ( type , V_5 ) , & V_18 ) ;
}
unsigned int F_83 ( int type , int free )
{
unsigned int V_35 = 0 ;
F_30 ( & V_82 ) ;
if ( ( unsigned int ) type < V_91 ) {
...
static inline int F_84 ( T_5 V_119 , T_5 V_120 )
{
#ifdef F_85
T_5 V_121 = F_86 ( V_120 ) ;
return F_87 ( V_119 , V_120 ) || F_87 ( V_119 , V_121 ) ;
#else
return F_87 ( V_119 , V_120 ) ;
#endif
}
static int F_88 ( struct V_122 * V_123 , T_6 * V_124 ,
...
int V_8 = 1 ;
V_126 = V_7 ;
V_7 = F_89 ( V_7 , V_123 , V_125 ) ;
if ( F_40 ( ! V_7 ) )
return - V_130 ;
if ( F_90 ( V_123 -> V_131 , V_7 ,
V_19 , & V_128 ) ) {
V_8 = - V_130 ;
goto V_132;
}
V_119 = F_91 ( V_123 -> V_131 , V_124 , V_125 , & V_129 ) ;
if ( F_40 ( ! F_84 ( * V_119 , F_92 ( V_6 ) ) ) ) {
F_93 ( V_128 ) ;
V_8 = 0 ;
goto V_90;
}
F_94 ( V_123 -> V_131 , V_133 ) ;
F_95 ( V_123 -> V_131 , V_134 ) ;
F_96 ( V_7 ) ;
F_97 ( V_123 -> V_131 , V_125 , V_119 ,
F_98 ( F_99 ( V_7 , V_123 -> V_135 ) ) ) ;
if ( V_7 == V_126 )
F_100 ( V_7 , V_123 , V_125 ) ;
else
F_101 ( V_7 , V_123 , V_125 ) ;
F_102 ( V_7 , V_128 ) ;
F_59 ( V_6 ) ;
F_103 ( V_7 ) ;
V_90:
...
static int F_106 ( struct V_122 * V_123 , T_6 * V_124 ,
...
T_5 * V_119 ;
int V_8 = 0 ;
V_119 = F_107 ( V_124 , V_125 ) ;
do {
if ( F_40 ( F_84 ( * V_119 , V_120 ) ) ) {
F_108 ( V_119 ) ;
V_8 = F_88 ( V_123 , V_124 , V_125 , V_6 , V_7 ) ;
if ( V_8 )
goto V_90;
V_119 = F_107 ( V_124 , V_125 ) ;
}
...
static inline int F_109 ( struct V_122 * V_123 , T_8 * V_138 ,
unsigned long V_125 , unsigned long V_136 ,
T_1 V_6 , struct V_7 * V_7 )
{
T_6 * V_124 ;
unsigned long V_27 ;
int V_8 ;
V_124 = F_110 ( V_138 , V_125 ) ;
do {
V_27 = F_111 ( V_125 , V_136 ) ;
if ( F_112 ( V_124 ) )
continue;
V_8 = F_106 ( V_123 , V_124 , V_125 , V_27 , V_6 , V_7 ) ;
if ( V_8 )
return V_8 ;
} while ( V_124 ++ , V_125 = V_27 , V_125 != V_136 );
return 0 ;
}
static inline int F_113 ( struct V_122 * V_123 , T_9 * V_139 ,
unsigned long V_125 , unsigned long V_136 ,
T_1 V_6 , struct V_7 * V_7 )
{
T_8 * V_138 ;
unsigned long V_27 ;
int V_8 ;
V_138 = F_114 ( V_139 , V_125 ) ;
do {
V_27 = F_115 ( V_125 , V_136 ) ;
if ( F_116 ( V_138 ) )
continue;
V_8 = F_109 ( V_123 , V_138 , V_125 , V_27 , V_6 , V_7 ) ;
if ( V_8 )
return V_8 ;
} while ( V_138 ++ , V_125 = V_27 , V_125 != V_136 );
return 0 ;
}
static int F_117 ( struct V_122 * V_123 ,
T_1 V_6 , struct V_7 * V_7 )
{
T_9 * V_139 ;
...
V_139 = F_120 ( V_123 -> V_131 , V_125 ) ;
do {
V_27 = F_121 ( V_125 , V_136 ) ;
if ( F_122 ( V_139 ) )
continue;
V_8 = F_113 ( V_123 , V_139 , V_125 , V_27 , V_6 , V_7 ) ;
if ( V_8 )
return V_8 ;
...
if ( V_123 -> V_148 && ( V_8 = F_117 ( V_123 , V_6 , V_7 ) ) )
break;
}
F_127 ( & V_144 -> V_145 ) ;
return ( V_8 < 0 ) ? V_8 : 0 ;
}
static unsigned int F_128 ( struct V_3 * V_4 ,
...
V_103 = F_130 ( V_4 -> V_39 [ V_151 ] ) ;
if ( V_103 && F_1 ( V_103 ) != V_41 )
break;
}
return V_151 ;
}
int F_131 ( unsigned int type , bool V_150 ,
unsigned long V_152 )
{
...
V_153 = & V_156 ;
F_132 ( & V_156 . V_157 ) ;
while ( ( V_151 = F_128 ( V_4 , V_151 , V_150 ) ) != 0 ) {
if ( F_133 ( V_158 ) ) {
V_155 = - V_159 ;
break;
}
...
return;
F_30 ( & V_165 ) ;
F_144 (p, next, &init_mm.mmlist)
F_145 ( V_52 ) ;
F_29 ( & V_165 ) ;
}
static T_2 F_82 ( T_1 V_6 , struct V_115 * * V_18 )
{
struct V_3 * V_117 ;
struct V_10 * V_170 ;
struct V_10 * V_11 ;
...
T_2 F_147 ( struct V_7 * V_7 , struct V_115 * * V_18 )
{
T_1 V_6 ;
V_6 . V_9 = F_63 ( V_7 ) ;
return F_82 ( V_6 , V_18 ) ;
}
static void F_148 ( struct V_3 * V_117 )
{
while ( ! F_149 ( & V_117 -> V_15 . V_26 ) ) {
struct V_10 * V_11 ;
...
int
F_152 ( struct V_3 * V_117 , unsigned long V_20 ,
...
V_11 = F_15 ( V_24 , struct V_10 , V_26 ) ;
F_146 ( V_11 -> V_20 + V_11 -> V_17 != V_20 ) ;
if ( V_11 -> V_12 + V_11 -> V_17 == V_12 ) {
V_11 -> V_17 += V_17 ;
return 0 ;
}
}
V_179 = F_153 ( sizeof( * V_11 ) , V_19 ) ;
if ( V_179 == NULL )
return - V_130 ;
V_179 -> V_20 = V_20 ;
V_179 -> V_17 = V_17 ;
V_179 -> V_12 = V_12 ;
F_154 ( & V_179 -> V_26 , & V_117 -> V_15 . V_26 ) ;
return 1 ;
}
static int F_155 ( struct V_3 * V_117 , T_2 * V_180 )
{
struct V_172 * V_173 = V_117 -> V_173 ;
struct V_174 * V_175 = V_173 -> V_176 ;
struct V_181 * V_181 = V_175 -> V_182 ;
int V_8 ;
if ( F_156 ( V_181 -> V_183 ) ) {
V_8 = F_152 ( V_117 , 0 , V_117 -> V_64 , 0 ) ;
* V_180 = V_117 -> V_72 ;
return V_8 ;
}
...
return F_157 ( V_117 , V_173 , V_180 ) ;
}
static void F_158 ( struct V_3 * V_52 , int V_88 ,
unsigned char * V_39 ,
struct V_28 * V_45 )
{
int V_151 , V_149 ;
...
static void F_160 ( struct V_3 * V_52 , int V_88 ,
unsigned char * V_39 ,
struct V_28 * V_45 ,
unsigned long * V_187 )
{
F_161 ( V_52 -> type , V_187 ) ;
F_30 ( & V_82 ) ;
F_30 ( & V_52 -> V_47 ) ;
F_158 ( V_52 , V_88 , V_39 , V_45 ) ;
F_29 ( & V_52 -> V_47 ) ;
F_29 ( & V_82 ) ;
}
static void F_162 ( struct V_3 * V_52 )
{
F_30 ( & V_82 ) ;
F_30 ( & V_52 -> V_47 ) ;
F_158 ( V_52 , V_52 -> V_88 , V_52 -> V_39 , V_52 -> V_45 ) ;
F_29 ( & V_52 -> V_47 ) ;
F_29 ( & V_82 ) ;
}
static unsigned F_163 ( struct V_172 * V_172 , T_10 * V_188 )
{
struct V_189 * V_190 = V_172 -> V_191 ;
F_164 ( V_172 , & V_192 , V_188 ) ;
...
static void * F_165 ( struct V_189 * V_199 , T_11 * V_200 )
{
struct V_3 * V_4 ;
int type ;
T_11 V_201 = * V_200 ;
...
static void * F_168 ( struct V_189 * V_199 , void * V_204 , T_11 * V_200 )
{
...
static void F_169 ( struct V_189 * V_199 , void * V_204 )
{
F_170 ( & V_202 ) ;
}
static int F_171 ( struct V_189 * V_199 , void * V_204 )
{
struct V_3 * V_4 = V_204 ;
struct V_172 * V_172 ;
int V_205 ;
...
V_172 = V_4 -> V_173 ;
V_205 = F_173 ( V_199 , & V_172 -> V_206 , L_3 ) ;
F_174 ( V_199 , L_4 ,
V_205 < 40 ? 40 - V_205 : 1 , L_5 ,
F_156 ( F_175 ( V_172 ) -> V_183 ) ?
L_6 : L_7 ,
V_4 -> V_72 << ( V_16 - 10 ) ,
V_4 -> V_73 << ( V_16 - 10 ) ,
V_4 -> V_88 ) ;
...
static int F_176 ( struct V_181 * V_181 , struct V_172 * V_172 )
{
struct V_189 * V_190 ;
int V_8 ;
V_8 = F_177 ( V_172 , & V_207 ) ;
if ( V_8 )
return V_8 ;
V_190 = V_172 -> V_191 ;
V_190 -> V_193 = F_53 ( & V_194 ) ;
...
static struct V_3 * F_182 ( void )
{
struct V_3 * V_52 ;
unsigned int type ;
V_52 = F_183 ( sizeof( * V_52 ) , V_19 ) ;
if ( ! V_52 )
return F_184 ( - V_130 ) ;
F_30 ( & V_82 ) ;
for ( type = 0 ; type < V_91 ; type ++ ) {
...
static int F_188 ( struct V_3 * V_52 , struct V_181 * V_181 )
{
int error ;
if ( F_156 ( V_181 -> V_183 ) ) {
V_52 -> V_18 = F_79 ( F_189 ( V_181 ) ) ;
error = F_190 ( V_52 -> V_18 ,
V_211 | V_212 | V_213 ,
V_214 ) ;
if ( error < 0 ) {
V_52 -> V_18 = NULL ;
...
V_52 -> V_216 = F_191 ( V_52 -> V_18 ) ;
error = F_192 ( V_52 -> V_18 , V_137 ) ;
if ( error < 0 )
return error ;
V_52 -> V_31 |= V_108 ;
} else if ( F_193 ( V_181 -> V_183 ) ) {
...
static unsigned long F_195 ( struct V_3 * V_52 ,
union V_221 * V_221 ,
struct V_181 * V_181 )
{
int V_151 ;
...
if ( F_196 ( V_221 -> V_29 . V_226 ) == 1 ) {
F_197 ( & V_221 -> V_29 . V_226 ) ;
F_197 ( & V_221 -> V_29 . V_224 ) ;
F_197 ( & V_221 -> V_29 . V_227 ) ;
for ( V_151 = 0 ; V_151 < V_221 -> V_29 . V_227 ; V_151 ++ )
F_197 ( & V_221 -> V_29 . V_228 [ V_151 ] ) ;
}
...
if ( ! V_222 )
return 0 ;
V_223 = F_200 ( V_181 ) >> V_16 ;
if ( V_223 && V_222 > V_223 ) {
F_198 ( L_13 ) ;
return 0 ;
}
if ( V_221 -> V_29 . V_227 && F_193 ( V_181 -> V_183 ) )
return 0 ;
if ( V_221 -> V_29 . V_227 > V_230 )
return 0 ;
return V_222 ;
}
static int F_201 ( struct V_3 * V_52 ,
union V_221 * V_221 ,
unsigned char * V_39 ,
struct V_28 * V_45 ,
unsigned long V_222 ,
...
unsigned int V_231 ;
int V_232 ;
unsigned long V_233 = F_202 ( V_222 , V_40 ) ;
...
for ( V_151 = V_222 ; V_151 < F_203 ( V_222 , V_40 ) ; V_151 ++ )
...
static bool F_204 ( struct V_3 * V_4 )
{
struct V_234 * V_235 = F_205 ( V_4 -> V_18 ) ;
if ( ! V_235 || ! F_206 ( V_235 ) )
return false ;
return true ;
}
void F_207 ( struct V_236 * V_9 )
{
unsigned int type ;
...
static int F_208 ( T_1 V_6 , unsigned char V_65 )
{
struct V_3 * V_52 ;
unsigned long V_5 , type ;
unsigned char V_103 ;
...
{
int V_14 = 0 ;
while ( ! V_14 && F_208 ( V_6 , 1 ) == - V_130 )
V_14 = F_211 ( V_6 , V_244 ) ;
return V_14 ;
}
int F_212 ( T_1 V_6 )
{
return F_208 ( V_6 , V_2 ) ;
}
struct V_3 * F_213 ( struct V_7 * V_7 )
{
T_1 V_199 = { . V_9 = F_63 (page) } ;
F_146 ( ! F_69 ( V_7 ) ) ;
return V_87 [ F_49 ( V_199 ) ] ;
}
struct V_174 * F_214 ( struct V_7 * V_7 )
{
F_65 ( ! F_69 ( V_7 ) , V_7 ) ;
return F_213 ( V_7 ) -> V_173 -> V_176 ;
}
T_3 F_215 ( struct V_7 * V_7 )
{
T_1 V_199 = { . V_9 = F_63 (page) } ;
F_65 ( ! F_69 ( V_7 ) , V_7 ) ;
return F_50 ( V_199 ) ;
}
int F_211 ( T_1 V_6 , T_13 V_245 )
{
struct V_3 * V_4 ;
struct V_7 * V_89 ;
struct V_7 * V_7 ;
...
if ( ! ( V_103 & V_106 ) )
goto V_90;
V_252 = F_219 ( V_246 ) + V_5 ;
V_103 = * V_252 ;
F_220 ( V_252 ) ;
if ( ( V_103 & ~ V_106 ) != V_253 )
goto V_90;
}
F_154 ( & V_7 -> V_250 , & V_89 -> V_250 ) ;
V_7 = NULL ;
V_90:
F_29 ( & V_4 -> V_47 ) ;
V_248:
...
static void F_222 ( struct V_3 * V_4 )
{
T_3 V_5 ;
