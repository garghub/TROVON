...
V_223 = - V_279 ;
V_5 -> V_272 = F_149 ( V_272 -> V_280 , F_150 ( V_272 ) ) ;
if ( ! V_5 -> V_272 ) {
...
V_223 = F_153 ( & V_270 -> V_90 , & V_5 -> V_78 ) ;
if ( V_223 )
goto V_285;
F_14 ( V_5 ) ;
return 0 ;
...
static int F_157 ( struct V_269 * V_266 )
{
struct V_4 * V_5 = F_158 ( V_266 ) ;
...
static void F_163 ( struct V_269 * V_266 )
{
struct V_4 * V_5 = F_158 ( V_266 ) ;
if ( F_3 ( V_5 , V_17 ) & V_27 )
F_109 ( V_5 ) ;
}
static int F_164 ( struct V_269 * V_266 , T_5 V_75 )
{
int V_48 ;
struct V_4 * V_5 = F_158 ( V_266 ) ;
struct V_44 * V_45 ;
...
for ( V_48 = 1 ; V_48 < V_50 ; V_48 ++ ) {
V_45 = & V_5 -> V_44 [ V_48 ] ;
V_45 -> V_286 = F_9 ( V_45 , V_56 ) ;
V_45 -> V_287 = F_9 ( V_45 , V_17 ) ;
F_42 ( V_45 , L_90 ,
V_45 -> V_286 , V_45 -> V_287 ) ;
}
F_109 ( V_5 ) ;
V_5 -> V_288 = V_5 -> V_202 ;
F_98 ( V_5 , 0 ) ;
...
static int F_165 ( struct V_269 * V_266 )
{
int V_48 ;
struct V_4 * V_5 = F_158 ( V_266 ) ;
struct V_44 * V_45 ;
...
for ( V_48 = 1 ; V_48 < V_50 ; V_48 ++ ) {
V_45 = & V_5 -> V_44 [ V_48 ] ;
F_35 ( V_45 , V_56 , V_45 -> V_286 ) ;
F_35 ( V_45 , V_17 , V_45 -> V_287 ) ;
F_42 ( V_45 , L_90 ,
V_45 -> V_286 , V_45 -> V_287 ) ;
}
F_98 ( V_5 , V_5 -> V_288 ) ;
