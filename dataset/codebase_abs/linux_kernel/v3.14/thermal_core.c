...
static int F_10 ( struct V_18 * V_18 , struct V_19 * V_20 , int * V_21 )
{
int V_22 ;
if ( V_20 )
F_5 ( V_20 ) ;
V_22 = F_11 ( V_18 , NULL , 0 , 0 , V_23 ) ;
if ( V_20 )
F_7 ( V_20 ) ;
if ( F_12 ( V_22 < 0 ) )
return V_22 ;
...
static void F_13 ( struct V_18 * V_18 , struct V_19 * V_20 , int V_21 )
{
if ( V_20 )
F_5 ( V_20 ) ;
F_14 ( V_18 , V_21 ) ;
...
int F_15 ( struct V_8 * V_24 , int V_25 )
{
enum V_26 V_27 ;
...
struct V_36 * F_16 ( struct V_8 * V_24 ,
...
static void F_17 ( struct V_8 * V_24 ,
struct V_37 * V_38 , int V_22 )
{
F_18 ( & V_24 -> V_40 , L_1 ,
V_24 -> type , V_38 -> type , V_22 ) ;
}
static void F_19 ( struct V_8 * V_24 , int V_41 ,
struct V_37 * V_38 ,
unsigned long * V_42 )
{
int V_43 , V_22 ;
...
static void F_21 ( struct V_8 * V_24 , int V_41 ,
struct V_37 * V_38 )
{
int V_43 ;
for ( V_43 = 0 ; V_43 < V_24 -> V_44 ; V_43 ++ )
...
F_19 ( V_3 , V_16 -> V_50 [ V_43 ] . V_53 , V_38 ,
V_16 -> V_50 [ V_43 ] . V_54 ) ;
}
}
F_7 ( & V_15 ) ;
...
F_19 ( V_24 , V_16 -> V_50 [ V_43 ] . V_53 , V_3 ,
V_16 -> V_50 [ V_43 ] . V_54 ) ;
}
}
exit:
...
static void F_25 ( struct V_8 * V_24 ,
int V_55 )
{
if ( V_55 > 1000 )
F_26 ( V_56 , & V_24 -> V_57 ,
...
static void F_32 ( struct V_8 * V_24 ,
int V_25 , enum V_61 V_62 )
{
long V_64 ;
...
{
struct V_8 * V_24 = F_44 ( V_76 , struct
V_8 ,
V_57 . V_76 ) ;
F_42 ( V_24 ) ;
}
static T_1
F_45 ( struct V_40 * V_77 , struct V_78 * V_79 , char * V_80 )
{
struct V_8 * V_24 = F_46 ( V_77 ) ;
return sprintf ( V_80 , L_5 , V_24 -> type ) ;
}
static T_1
F_47 ( struct V_40 * V_77 , struct V_78 * V_79 , char * V_80 )
{
struct V_8 * V_24 = F_46 ( V_77 ) ;
long V_31 ;
int V_22 ;
...
static T_1
F_49 ( struct V_40 * V_77 , struct V_78 * V_79 ,
...
return - V_9 ;
if ( F_52 ( V_80 , 10 , & V_31 ) )
return - V_9 ;
V_22 = V_24 -> V_29 -> V_91 ( V_24 , V_25 , V_31 ) ;
return V_22 ? V_22 : V_71 ;
}
static T_1
F_53 ( struct V_40 * V_77 , struct V_78 * V_79 ,
char * V_80 )
{
struct V_8 * V_24 = F_46 ( V_77 ) ;
int V_25 , V_22 ;
...
static T_1
F_60 ( struct V_40 * V_77 , struct V_78 * V_98 , char * V_80 )
{
struct V_8 * V_24 = F_46 ( V_77 ) ;
return sprintf ( V_80 , L_5 , V_24 -> V_6 -> V_2 ) ;
}
static T_1
F_61 ( struct V_40 * V_77 , struct V_78 * V_79 ,
const char * V_80 , T_2 V_71 )
{
struct V_8 * V_24 = F_46 ( V_77 ) ;
int V_22 = 0 ;
...
static T_1
F_62 ( struct V_40 * V_77 ,
struct V_78 * V_79 , char * V_80 )
{
struct V_37 * V_38 = F_63 ( V_77 ) ;
return sprintf ( V_80 , L_5 , V_38 -> type ) ;
}
static T_1
F_64 ( struct V_40 * V_77 ,
struct V_78 * V_79 , char * V_80 )
{
struct V_37 * V_38 = F_63 ( V_77 ) ;
unsigned long V_94 ;
...
V_77 -> V_46 = V_46 ;
V_77 -> V_108 = V_109 ;
V_83 = F_10 ( & V_24 -> V_18 , & V_24 -> V_20 , & V_77 -> V_21 ) ;
if ( V_83 )
goto V_110;
sprintf ( V_77 -> V_2 , L_21 , V_77 -> V_21 ) ;
V_83 =
F_69 ( & V_24 -> V_40 . V_111 , & V_38 -> V_40 . V_111 , V_77 -> V_2 ) ;
if ( V_83 )
goto F_13;
...
V_77 -> V_79 . V_113 = F_67 ;
V_83 = F_71 ( & V_24 -> V_40 , & V_77 -> V_79 ) ;
if ( V_83 )
goto V_114;
F_5 ( & V_24 -> V_20 ) ;
F_5 ( & V_38 -> V_20 ) ;
...
if ( ! V_83 ) {
F_72 ( & V_77 -> V_116 , & V_24 -> V_117 ) ;
F_72 ( & V_77 -> V_118 , & V_38 -> V_117 ) ;
}
F_7 ( & V_38 -> V_20 ) ;
F_7 ( & V_24 -> V_20 ) ;
if ( ! V_83 )
return 0 ;
F_73 ( & V_24 -> V_40 , & V_77 -> V_79 ) ;
V_114:
F_74 ( & V_24 -> V_40 . V_111 , V_77 -> V_2 ) ;
F_13:
F_13 ( & V_24 -> V_18 , & V_24 -> V_20 , V_77 -> V_21 ) ;
V_110:
F_75 ( V_77 ) ;
return V_83 ;
}
int F_22 ( struct V_8 * V_24 ,
int V_25 ,
struct V_37 * V_38 )
{
...
return - V_121 ;
V_120:
F_73 ( & V_24 -> V_40 , & V_3 -> V_79 ) ;
F_74 ( & V_24 -> V_40 . V_111 , V_3 -> V_2 ) ;
F_13 ( & V_24 -> V_18 , & V_24 -> V_20 , V_3 -> V_21 ) ;
F_75 ( V_3 ) ;
return 0 ;
}
static void F_77 ( struct V_40 * V_77 )
{
struct V_8 * V_24 ;
struct V_37 * V_38 ;
if ( ! strncmp ( F_78 ( V_77 ) , L_23 ,
sizeof( L_23 ) - 1 ) ) {
V_24 = F_46 ( V_77 ) ;
F_75 ( V_24 ) ;
} else if( ! strncmp ( F_78 ( V_77 ) , L_24 ,
sizeof( L_24 ) - 1 ) ) {
V_38 = F_63 ( V_77 ) ;
F_75 ( V_38 ) ;
}
...
! V_29 -> V_102 )
return F_80 ( - V_9 ) ;
V_38 = F_68 ( sizeof( struct V_37 ) , V_23 ) ;
if ( ! V_38 )
return F_80 ( - V_107 ) ;
V_83 = F_10 ( & V_126 , & V_127 , & V_38 -> V_21 ) ;
if ( V_83 ) {
F_75 ( V_38 ) ;
return F_80 ( V_83 ) ;
}
F_81 ( V_38 -> type , type ? : L_25 , sizeof( V_38 -> type ) ) ;
F_82 ( & V_38 -> V_20 ) ;
F_83 ( & V_38 -> V_117 ) ;
V_38 -> V_123 = V_123 ;
V_38 -> V_29 = V_29 ;
...
V_38 -> V_124 = V_124 ;
F_84 ( & V_38 -> V_40 , L_26 , V_38 -> V_21 ) ;
V_83 = F_85 ( & V_38 -> V_40 ) ;
if ( V_83 ) {
F_13 ( & V_126 , & V_127 , V_38 -> V_21 ) ;
F_75 ( V_38 ) ;
return F_80 ( V_83 ) ;
}
if ( type ) {
V_83 = F_71 ( & V_38 -> V_40 , & V_131 ) ;
if ( V_83 )
goto V_132;
}
V_83 = F_71 ( & V_38 -> V_40 , & V_133 ) ;
if ( V_83 )
goto V_132;
V_83 = F_71 ( & V_38 -> V_40 , & V_134 ) ;
if ( V_83 )
goto V_132;
F_5 ( & V_15 ) ;
F_6 ( & V_38 -> V_135 , & V_136 ) ;
F_7 ( & V_15 ) ;
F_23 ( V_38 ) ;
return V_38 ;
V_132:
...
struct V_37 *
F_87 ( char * type , void * V_124 ,
const struct V_125 * V_29 )
{
return F_79 ( NULL , type , V_124 , V_29 ) ;
}
struct V_37 *
...
const struct V_125 * V_29 )
{
return F_79 ( V_123 , type , V_124 , V_29 ) ;
}
...
F_21 ( V_24 , V_16 -> V_50 [ V_43 ] . V_53 , V_38 ) ;
...
F_7 ( & V_15 ) ;
if ( V_38 -> type [ 0 ] )
F_73 ( & V_38 -> V_40 , & V_131 ) ;
F_73 ( & V_38 -> V_40 , & V_133 ) ;
F_73 ( & V_38 -> V_40 , & V_134 ) ;
F_13 ( & V_126 , & V_127 , V_38 -> V_21 ) ;
F_86 ( & V_38 -> V_40 ) ;
return;
}
...
V_38 -> V_128 = true ;
F_41 ( & V_38 -> V_40 , L_28 , V_108 ) ;
}
void F_91 ( struct V_8 * V_24 , int V_25 )
{
F_35 ( V_24 , V_25 ) ;
}
static int F_92 ( struct V_8 * V_24 , int V_41 )
{
int V_137 ;
int V_138 = sizeof( struct V_139 ) * V_24 -> V_44 ;
V_24 -> V_140 = F_68 ( V_138 , V_23 ) ;
if ( ! V_24 -> V_140 )
return - V_107 ;
V_24 -> V_141 = F_68 ( V_138 , V_23 ) ;
if ( ! V_24 -> V_141 ) {
F_75 ( V_24 -> V_140 ) ;
return - V_107 ;
}
if ( V_24 -> V_29 -> V_93 ) {
V_24 -> V_142 = F_68 ( V_138 , V_23 ) ;
if ( ! V_24 -> V_142 ) {
F_75 ( V_24 -> V_140 ) ;
F_75 ( V_24 -> V_141 ) ;
return - V_107 ;
...
static void F_93 ( struct V_8 * V_24 )
{
int V_137 ;
for ( V_137 = 0 ; V_137 < V_24 -> V_44 ; V_137 ++ ) {
F_73 ( & V_24 -> V_40 ,
...
struct V_8 * F_94 ( const char * type ,
...
return F_80 ( - V_9 ) ;
V_24 = F_68 ( sizeof( struct V_8 ) , V_23 ) ;
if ( ! V_24 )
return F_80 ( - V_107 ) ;
F_83 ( & V_24 -> V_117 ) ;
F_95 ( & V_24 -> V_18 ) ;
F_82 ( & V_24 -> V_20 ) ;
V_83 = F_10 ( & V_148 , & V_127 , & V_24 -> V_21 ) ;
if ( V_83 ) {
F_75 ( V_24 ) ;
return F_80 ( V_83 ) ;
}
F_81 ( V_24 -> type , type ? : L_25 , sizeof( V_24 -> type ) ) ;
V_24 -> V_29 = V_29 ;
V_24 -> V_16 = V_16 ;
...
V_24 -> V_59 = V_59 ;
V_24 -> V_60 = V_60 ;
F_84 ( & V_24 -> V_40 , L_29 , V_24 -> V_21 ) ;
V_83 = F_85 ( & V_24 -> V_40 ) ;
if ( V_83 ) {
F_13 ( & V_148 , & V_127 , V_24 -> V_21 ) ;
F_75 ( V_24 ) ;
return F_80 ( V_83 ) ;
}
if ( type ) {
V_83 = F_71 ( & V_24 -> V_40 , & V_149 ) ;
if ( V_83 )
goto V_132;
}
V_83 = F_71 ( & V_24 -> V_40 , & V_150 ) ;
if ( V_83 )
goto V_132;
if ( V_29 -> V_84 ) {
V_83 = F_71 ( & V_24 -> V_40 , & V_151 ) ;
if ( V_83 )
goto V_132;
}
V_83 = F_92 ( V_24 , V_41 ) ;
...
if ( ! V_58 ) {
V_83 = F_71 ( & V_24 -> V_40 , & V_152 ) ;
if ( V_83 )
goto V_132;
}
#ifdef F_37
V_83 = F_71 ( & V_24 -> V_40 , & V_153 ) ;
if ( V_83 )
goto V_132;
#endif
V_83 = F_71 ( & V_24 -> V_40 , & V_154 ) ;
if ( V_83 )
goto V_132;
F_5 ( & V_10 ) ;
if ( V_24 -> V_16 )
...
F_25 ( V_24 , 0 ) ;
if ( V_24 -> type [ 0 ] )
F_73 ( & V_24 -> V_40 , & V_149 ) ;
F_73 ( & V_24 -> V_40 , & V_150 ) ;
if ( V_24 -> V_29 -> V_84 )
F_73 ( & V_24 -> V_40 , & V_151 ) ;
F_73 ( & V_24 -> V_40 , & V_154 ) ;
F_93 ( V_24 ) ;
V_24 -> V_6 = NULL ;
F_99 ( V_24 ) ;
F_13 ( & V_148 , & V_127 , V_24 -> V_21 ) ;
...
struct V_8 * F_102 ( const char * V_2 )
{
struct V_8 * V_3 = NULL , * V_157 = F_80 ( - V_9 ) ;
unsigned int V_158 = 0 ;
if ( ! V_2 )
goto exit;
F_5 ( & V_15 ) ;
F_2 (pos, &thermal_tz_list, node)
if ( ! F_3 ( V_2 , V_3 -> type , V_5 ) ) {
V_158 ++ ;
V_157 = V_3 ;
}
F_7 ( & V_15 ) ;
...
if ( ! V_24 )
return - V_9 ;
V_138 = F_104 ( sizeof( struct V_164 ) ) +
F_104 ( 0 ) ;
V_162 = F_105 ( V_138 , V_168 ) ;
if ( ! V_162 )
return - V_107 ;
V_166 = F_106 ( V_162 , 0 , V_167 ++ ,
& V_169 , 0 ,
V_170 ) ;
if ( ! V_166 ) {
F_107 ( V_162 ) ;
...
V_165 -> V_160 = V_160 ;
V_83 = F_110 ( V_162 , V_166 ) ;
if ( V_83 < 0 ) {
F_107 ( V_162 ) ;
return V_83 ;
}
V_83 = F_111 ( & V_169 , V_162 , 0 ,
0 , V_168 ) ;
if ( V_83 )
F_18 ( & V_24 -> V_40 , L_30 , V_83 ) ;
return V_83 ;
}
...
static inline int F_112 ( void ) { return 0 ; }
