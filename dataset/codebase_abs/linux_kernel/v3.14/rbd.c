...
static void F_141 ( struct V_165 * V_166 )
{
...
V_189 = F_145 ( V_188 , V_93 , 1 , false , V_222 ) ;
if ( ! V_189 )
return NULL ;
if ( V_221 )
...
V_189 -> V_227 = F_139 ;
V_189 -> V_203 = V_166 ;
V_189 -> V_228 . V_229 = F_146 ( V_22 -> V_230 ) ;
F_147 ( & V_189 -> V_231 , V_166 -> V_217 ) ;
return V_189 ;
}
static struct V_200 *
...
V_22 = V_168 -> V_22 ;
V_188 = & V_22 -> V_38 -> V_49 -> V_188 ;
V_189 = F_145 ( V_188 , V_93 , 2 , false , V_222 ) ;
if ( ! V_189 )
return NULL ;
V_189 -> V_223 = V_224 | V_225 ;
V_189 -> V_227 = F_139 ;
...
static void F_149 ( struct V_200 * V_189 )
{
F_150 ( V_189 ) ;
}
static struct V_165 * F_151 ( const char * V_217 ,
V_87 V_127 , V_87 V_135 ,
enum V_183 type )
{
struct V_165 * V_166 ;
...
if ( ! V_128 )
return NULL ;
V_166 = F_152 ( V_232 , V_45 ) ;
if ( ! V_166 ) {
F_32 ( V_128 ) ;
return NULL ;
}
V_166 -> V_217 = memcpy ( V_128 , V_217 , V_77 ) ;
V_166 -> V_127 = V_127 ;
V_166 -> V_135 = V_135 ;
V_166 -> V_32 = 0 ;
V_166 -> V_116 = V_179 ;
...
static bool F_159 ( struct V_21 * V_22 )
{
int V_2 ;
if ( ! V_22 -> V_234 )
return false ;
...
static struct V_175 * F_160 (
struct V_21 * V_22 ,
V_87 V_127 , V_87 V_135 ,
bool V_221 )
{
struct V_175 * V_168 ;
V_168 = F_74 ( V_236 , V_222 ) ;
if ( ! V_168 )
return NULL ;
if ( V_221 ) {
F_161 ( & V_22 -> V_237 ) ;
F_162 ( V_22 -> V_90 . V_93 ) ;
F_163 ( & V_22 -> V_237 ) ;
}
V_168 -> V_238 = NULL ;
V_168 -> V_22 = V_22 ;
...
F_21 ( L_20 , V_44 , V_168 ) ;
F_165 (img_request, obj_request, next_obj_request)
F_115 ( V_168 , V_166 ) ;
F_18 ( V_168 -> V_178 == 0 ) ;
if ( F_130 ( V_168 ) ) {
F_129 ( V_168 ) ;
...
struct V_175 * V_242 ;
struct V_165 * V_244 ;
V_242 = F_48 ( V_47 , struct V_175 , V_47 ) ;
V_244 = V_242 -> V_166 ;
V_242 -> V_166 = NULL ;
F_111 ( V_244 ) ;
F_126 ( V_242 ) ;
...
static bool F_167 ( struct V_165 * V_166 )
{
struct V_175 * V_168 ;
unsigned int V_191 ;
int V_190 ;
...
V_245 = V_166 -> V_116 < V_168 -> V_178 - 1 ;
} else {
F_18 ( V_168 -> V_238 != NULL ) ;
V_245 = F_168 ( V_168 -> V_238 , V_190 , V_191 ) ;
}
return V_245 ;
}
static void F_169 ( struct V_165 * V_166 )
{
struct V_175 * V_168 ;
...
static int F_171 ( struct V_175 * V_168 ,
enum V_183 type ,
void * V_247 )
{
struct V_21 * V_22 = V_168 -> V_22 ;
...
V_87 V_127 ;
V_87 V_135 ;
V_217 = F_73 ( V_22 , V_198 ) ;
if ( ! V_217 )
goto V_251;
V_127 = F_77 ( V_22 , V_198 ) ;
V_135 = F_78 ( V_22 , V_198 , V_249 ) ;
V_166 = F_151 ( V_217 ,
V_127 , V_135 , type ) ;
F_75 ( V_217 ) ;
if ( ! V_166 )
...
if ( type == V_185 ) {
unsigned int V_252 ;
F_18 ( V_135 <= ( V_87 ) V_208 ) ;
V_252 = ( unsigned int ) V_135 ;
V_166 -> V_196 =
F_97 ( & V_196 ,
& V_248 ,
V_252 ,
...
unsigned int V_233 ;
V_166 -> V_152 = V_152 ;
V_233 = ( T_5 ) F_172 ( V_127 , V_135 ) ;
V_166 -> V_233 = V_233 ;
if ( ( V_127 + V_135 ) & ~ V_157 )
V_233 -- ;
V_152 += V_233 ;
}
V_189 = F_144 ( V_22 , V_221 ,
V_166 ) ;
if ( ! V_189 )
goto V_253;
V_166 -> V_189 = V_189 ;
V_166 -> V_182 = F_169 ;
F_173 ( V_189 , 0 , V_204 , V_127 , V_135 ,
0 , 0 ) ;
if ( type == V_185 )
F_174 ( V_189 , 0 ,
V_166 -> V_196 , V_135 ) ;
...
V_244 = V_168 -> V_166 ;
F_18 ( V_244 != NULL ) ;
F_18 ( F_116 ( V_244 -> type ) ) ;
V_256 = V_168 -> V_190 ;
V_257 = V_168 -> V_135 ;
F_18 ( V_257 == V_168 -> V_191 ) ;
F_112 ( V_168 ) ;
F_18 ( V_244 -> V_168 ) ;
V_22 = V_244 -> V_168 -> V_22 ;
F_18 ( V_22 ) ;
if ( ! V_22 -> V_199 ) {
struct V_187 * V_188 ;
F_154 ( V_152 , V_233 ) ;
V_188 = & V_22 -> V_38 -> V_49 -> V_188 ;
V_256 = F_117 ( V_188 , V_244 ) ;
if ( ! V_256 )
return;
}
if ( V_256 )
...
V_244 -> V_254 = V_152 ;
V_244 -> V_255 = V_233 ;
F_178 ( V_189 , 0 , V_214 , L_37 , L_38 ) ;
F_179 ( V_189 , 0 , V_152 , V_257 , 0 ,
false , false ) ;
V_127 = V_244 -> V_127 ;
V_135 = V_244 -> V_135 ;
F_173 ( V_189 , 1 , V_212 ,
...
V_233 = ( T_5 ) F_172 ( 0 , V_135 ) ;
V_152 = F_181 ( V_233 , V_45 ) ;
if ( F_26 ( V_152 ) ) {
V_190 = F_182 ( V_152 ) ;
V_152 = NULL ;
goto V_98;
...
T_6 V_77 ;
int V_42 ;
V_77 = sizeof ( V_86 ) + sizeof ( V_259 ) + sizeof ( V_259 ) ;
V_233 = ( T_5 ) F_172 ( 0 , V_77 ) ;
V_152 = F_181 ( V_233 , V_45 ) ;
if ( F_26 ( V_152 ) )
return F_182 ( V_152 ) ;
V_42 = - V_43 ;
V_258 = F_151 ( V_166 -> V_217 , 0 , 0 ,
V_186 ) ;
if ( ! V_258 )
goto V_246;
F_109 ( V_166 ) ;
...
F_18 ( V_166 -> V_168 ) ;
V_22 = V_166 -> V_168 -> V_22 ;
V_258 -> V_189 = F_144 ( V_22 , false ,
V_258 ) ;
if ( ! V_258 -> V_189 )
goto V_246;
V_258 -> V_182 = F_184 ;
F_187 ( V_258 -> V_189 , 0 , V_213 ) ;
F_188 ( V_258 -> V_189 , 0 , V_152 , V_77 , 0 ,
false , false ) ;
F_141 ( V_258 ) ;
V_188 = & V_22 -> V_38 -> V_49 -> V_188 ;
V_42 = F_117 ( V_188 , V_258 ) ;
V_246:
if ( V_42 )
F_111 ( V_166 ) ;
return V_42 ;
...
V_261 = V_166 -> V_198 + V_166 -> V_135 ;
if ( V_261 > V_22 -> V_199 ) {
V_87 V_191 = 0 ;
if ( V_166 -> V_198 < V_22 -> V_199 )
V_191 = V_22 -> V_199 -
V_166 -> V_198 ;
V_166 -> V_191 = F_190 ( V_262 , V_191 ) ;
} else {
V_166 -> V_191 = V_262 ;
}
V_246:
...
goto V_98;
if ( V_166 -> type == V_185 )
V_190 = F_171 ( V_168 , V_185 ,
V_166 -> V_196 ) ;
else
V_190 = F_171 ( V_168 , V_186 ,
V_166 -> V_152 ) ;
if ( V_190 )
goto V_98;
V_168 -> V_182 = F_189 ;
...
static int F_191 ( struct V_21 * V_22 , V_87 V_264 )
{
struct V_165 * V_166 ;
struct V_187 * V_188 = & V_22 -> V_38 -> V_49 -> V_188 ;
int V_42 ;
V_166 = F_151 ( V_22 -> V_265 , 0 , 0 ,
V_184 ) ;
if ( ! V_166 )
return - V_43 ;
V_42 = - V_43 ;
V_166 -> V_189 = F_144 ( V_22 , false , V_166 ) ;
if ( ! V_166 -> V_189 )
goto V_246;
F_192 ( V_166 -> V_189 , 0 , V_215 ,
V_264 , 0 , 0 ) ;
F_141 ( V_166 ) ;
...
static void F_193 ( V_87 V_266 , V_87 V_264 , T_9 V_204 , void * V_267 )
{
struct V_21 * V_22 = (struct V_21 * ) V_267 ;
int V_42 ;
if ( ! V_22 )
return;
F_21 ( L_40 , V_44 ,
V_22 -> V_265 , ( unsigned long long ) V_264 ,
( unsigned int ) V_204 ) ;
V_42 = F_194 ( V_22 ) ;
if ( V_42 )
F_98 ( V_22 , L_41 , V_42 ) ;
...
static int F_195 ( struct V_21 * V_22 , bool V_268 )
{
struct V_187 * V_188 = & V_22 -> V_38 -> V_49 -> V_188 ;
struct V_165 * V_166 ;
int V_42 ;
F_18 ( V_268 ^ ! ! V_22 -> V_269 ) ;
F_18 ( V_268 ^ ! ! V_22 -> V_270 ) ;
if ( V_268 ) {
V_42 = F_196 ( V_188 , F_193 , V_22 ,
& V_22 -> V_269 ) ;
if ( V_42 < 0 )
return V_42 ;
F_18 ( V_22 -> V_269 != NULL ) ;
}
V_42 = - V_43 ;
V_166 = F_151 ( V_22 -> V_265 , 0 , 0 ,
V_184 ) ;
if ( ! V_166 )
goto V_271;
V_166 -> V_189 = F_144 ( V_22 , true , V_166 ) ;
if ( ! V_166 -> V_189 )
goto V_271;
if ( V_268 )
...
F_198 ( V_188 ,
V_22 -> V_270 -> V_189 ) ;
F_192 ( V_166 -> V_189 , 0 , V_216 ,
V_22 -> V_269 -> V_272 , 0 , V_268 ? 1 : 0 ) ;
F_143 ( V_166 ) ;
V_42 = F_117 ( V_188 , V_166 ) ;
if ( V_42 )
goto V_271;
...
T_5 V_233 ;
int V_42 ;
V_233 = ( T_5 ) F_172 ( 0 , V_278 ) ;
V_152 = F_181 ( V_233 , V_45 ) ;
if ( F_26 ( V_152 ) )
return F_182 ( V_152 ) ;
V_42 = - V_43 ;
V_166 = F_151 ( V_217 , 0 , V_278 ,
V_186 ) ;
if ( ! V_166 )
goto V_246;
V_166 -> V_152 = V_152 ;
...
if ( ! V_166 -> V_189 )
goto V_246;
F_178 ( V_166 -> V_189 , 0 , V_214 ,
V_273 , V_274 ) ;
if ( V_276 ) {
struct V_279 * V_280 ;
V_280 = F_22 ( sizeof ( * V_280 ) , V_281 ) ;
if ( ! V_280 )
goto V_246;
F_203 ( V_280 ) ;
F_204 ( V_280 , V_275 , V_276 ) ;
F_205 ( V_166 -> V_189 , 0 ,
V_280 ) ;
}
F_206 ( V_166 -> V_189 , 0 ,
...
F_207 ( V_152 , V_277 , 0 , V_166 -> V_191 ) ;
V_246:
if ( V_166 )
F_111 ( V_166 ) ;
else
...
static void F_208 ( struct V_282 * V_283 )
__releases( V_283 -> V_284 ) __acquires( V_283 -> V_284 )
{
struct V_21 * V_22 = V_283 -> V_285 ;
bool V_28 = V_22 -> V_27 . V_28 ;
struct V_286 * V_238 ;
int V_190 ;
while ( ( V_238 = F_209 ( V_283 ) ) ) {
bool V_221 = F_210 ( V_238 ) == V_287 ;
struct V_175 * V_168 ;
V_87 V_127 ;
V_87 V_135 ;
if ( V_238 -> V_288 != V_289 ) {
F_21 ( L_43 , V_44 ,
( int ) V_238 -> V_288 ) ;
F_211 ( V_238 , 0 ) ;
continue;
}
V_127 = ( V_87 ) F_212 ( V_238 ) << V_83 ;
V_135 = ( V_87 ) F_213 ( V_238 ) ;
if ( ! V_135 ) {
F_21 ( L_44 , V_44 ) ;
F_211 ( V_238 , 0 ) ;
continue;
...
static int F_214 ( struct V_282 * V_283 , struct V_293 * V_294 ,
struct V_142 * V_295 )
{
struct V_21 * V_22 = V_283 -> V_285 ;
T_10 V_296 ;
...
T_10 V_298 ;
int V_42 ;
V_296 = F_215 ( V_294 -> V_299 ) + V_294 -> V_250 ;
V_297 = 1 << ( V_22 -> V_90 . V_106 - V_83 ) ;
V_298 = V_296 & ( V_297 - 1 ) ;
V_42 = ( int ) ( V_297 - V_298 ) << V_83 ;
if ( V_42 > V_294 -> V_162 )
V_42 -= V_294 -> V_162 ;
else
V_42 = 0 ;
F_18 ( V_295 -> V_148 <= V_158 ) ;
if ( V_42 > ( int ) V_295 -> V_148 || ! V_294 -> V_162 )
V_42 = ( int ) V_295 -> V_148 ;
return V_42 ;
}
...
F_14 ( & V_22 -> V_30 ) ;
if ( ! V_25 ) {
V_77 = ( T_10 ) V_22 -> V_27 . V_77 / V_304 ;
...
if ( ! V_36 )
return - V_43 ;
snprintf ( V_36 -> V_307 , sizeof( V_36 -> V_307 ) , V_308 L_52 ,
V_22 -> V_5 ) ;
V_36 -> V_309 = V_22 -> V_309 ;
V_36 -> V_310 = V_22 -> V_7 ;
if ( V_13 )
V_36 -> V_32 |= V_311 ;
V_36 -> V_312 = & V_313 ;
V_36 -> V_24 = V_22 ;
V_283 = F_231 ( F_208 , & V_22 -> V_30 ) ;
if ( ! V_283 )
goto V_314;
F_232 ( V_283 , V_304 ) ;
V_134 = F_79 ( & V_22 -> V_90 ) ;
F_233 ( V_283 , V_134 / V_304 ) ;
F_234 ( V_283 , V_134 ) ;
F_235 ( V_283 , V_134 ) ;
F_236 ( V_283 , V_134 ) ;
F_237 ( V_283 , F_214 ) ;
...
struct V_21 * V_22 = F_238 ( V_18 ) ;
if ( V_22 -> V_309 )
return sprintf ( V_146 , L_55 , V_22 -> V_309 ) ;
...
{
struct V_21 * V_22 = F_238 ( V_18 ) ;
return sprintf ( V_146 , L_58 , V_22 -> V_112 -> V_316 ) ;
}
...
struct V_21 * V_22 = F_238 ( V_18 ) ;
return sprintf ( V_146 , L_53 ,
( unsigned long long ) V_22 -> V_112 -> V_317 ) ;
}
...
{
struct V_21 * V_22 = F_238 ( V_18 ) ;
return sprintf ( V_146 , L_58 , V_22 -> V_112 -> V_319 ) ;
}
...
{
struct V_21 * V_22 = F_238 ( V_18 ) ;
struct V_320 * V_112 = V_22 -> V_234 ;
int V_321 ;
char * V_322 = V_146 ;
if ( ! V_112 )
return sprintf ( V_146 , L_60 ) ;
V_321 = sprintf ( V_322 , L_61 ,
( unsigned long long ) V_112 -> V_317 , V_112 -> V_316 ) ;
if ( V_321 < 0 )
return V_321 ;
V_322 += V_321 ;
V_321 = sprintf ( V_322 , L_62 , V_112 -> V_319 ,
V_112 -> V_318 ? V_112 -> V_318 : L_63 ) ;
if ( V_321 < 0 )
return V_321 ;
V_322 += V_321 ;
V_321 = sprintf ( V_322 , L_64 ,
( unsigned long long ) V_112 -> V_113 , V_112 -> V_117 ) ;
if ( V_321 < 0 )
return V_321 ;
V_322 += V_321 ;
V_321 = sprintf ( V_322 , L_65 , V_22 -> V_199 ) ;
if ( V_321 < 0 )
return V_321 ;
V_322 += V_321 ;
return ( T_11 ) ( V_322 - V_146 ) ;
}
...
static struct V_320 * F_253 ( struct V_320 * V_112 )
{
F_36 ( & V_112 -> V_47 ) ;
return V_112 ;
}
static void F_157 ( struct V_320 * V_112 )
{
if ( V_112 )
F_51 ( & V_112 -> V_47 , V_323 ) ;
}
static struct V_320 * F_254 ( void )
{
struct V_320 * V_112 ;
...
static void V_323 ( struct V_47 * V_47 )
{
struct V_320 * V_112 = F_48 ( V_47 , struct V_320 , V_47 ) ;
F_32 ( V_112 -> V_316 ) ;
F_32 ( V_112 -> V_319 ) ;
F_32 ( V_112 -> V_318 ) ;
F_32 ( V_112 -> V_117 ) ;
...
V_22 -> V_112 = V_112 ;
V_22 -> V_38 = V_41 ;
V_22 -> V_230 . V_324 = F_259 ( 1 << V_325 ) ;
V_22 -> V_230 . V_326 = F_259 ( 1 ) ;
V_22 -> V_230 . V_327 = F_259 ( 1 << V_325 ) ;
V_22 -> V_230 . V_328 = F_259 ( ( T_5 ) V_112 -> V_317 ) ;
return V_22 ;
}
...
T_9 * V_82 , V_87 * V_125 )
{
V_86 V_329 = F_261 ( V_113 ) ;
int V_42 ;
struct {
T_9 V_82 ;
V_86 V_77 ;
} V_330 ( ( V_331 ) ) V_332 = { 0 } ;
V_42 = F_202 ( V_22 , V_22 -> V_265 ,
L_37 , L_67 ,
& V_329 , sizeof ( V_329 ) ,
& V_332 , sizeof ( V_332 ) ) ;
F_21 ( L_68 , V_44 , V_42 ) ;
if ( V_42 < 0 )
return V_42 ;
if ( V_42 < sizeof ( V_332 ) )
return - V_333 ;
if ( V_82 ) {
* V_82 = V_332 . V_82 ;
F_21 ( L_69 , ( unsigned int ) * V_82 ) ;
}
* V_125 = F_55 ( V_332 . V_77 ) ;
F_21 ( L_70 ,
...
goto V_246;
V_335 = V_334 ;
V_22 -> V_90 . V_92 = F_264 ( & V_335 ,
V_335 + V_42 , NULL , V_132 ) ;
V_42 = 0 ;
...
if ( V_42 < 0 )
return V_42 ;
if ( V_42 < sizeof ( V_338 ) )
return - V_333 ;
V_337 = F_55 ( V_338 . V_337 ) ;
if ( V_337 & ~ V_339 )
return - V_292 ;
* V_126 = F_55 ( V_338 . V_111 ) ;
F_21 ( L_74 ,
( unsigned long long ) V_113 ,
( unsigned long long ) * V_126 ,
( unsigned long long ) F_55 ( V_338 . V_337 ) ) ;
return 0 ;
}
...
if ( V_317 > ( V_87 ) V_343 ) {
F_98 ( NULL , L_77 ,
( unsigned long long ) V_317 , V_343 ) ;
goto V_98;
}
V_319 = F_264 ( & V_335 , V_153 , NULL , V_45 ) ;
if ( F_26 ( V_319 ) ) {
V_42 = F_182 ( V_319 ) ;
goto V_98;
}
F_267 ( & V_335 , V_153 , V_113 , V_98 ) ;
F_267 ( & V_335 , V_153 , V_340 , V_98 ) ;
if ( ! V_22 -> V_234 ) {
V_234 -> V_317 = V_317 ;
V_234 -> V_319 = V_319 ;
V_234 -> V_113 = V_113 ;
...
char * V_318 = NULL ;
int V_42 ;
F_18 ( ! V_22 -> V_112 -> V_318 ) ;
V_97 = strlen ( V_22 -> V_112 -> V_319 ) ;
V_346 = sizeof ( V_259 ) + V_97 ;
V_319 = F_22 ( V_346 , V_45 ) ;
if ( ! V_319 )
return NULL ;
V_335 = V_319 ;
V_153 = V_319 + V_346 ;
F_272 ( & V_335 , V_153 , V_22 -> V_112 -> V_319 , ( T_5 ) V_97 ) ;
V_77 = sizeof ( V_259 ) + V_347 ;
V_334 = F_22 ( V_77 , V_45 ) ;
if ( ! V_334 )
goto V_246;
V_42 = F_202 ( V_22 , V_348 ,
L_37 , L_86 ,
V_319 , V_346 ,
V_334 , V_77 ) ;
if ( V_42 < 0 )
...
V_335 = V_334 ;
V_153 = V_334 + V_42 ;
V_318 = F_264 ( & V_335 , V_153 , & V_97 , V_45 ) ;
if ( F_26 ( V_318 ) )
V_318 = NULL ;
else
F_21 ( L_87 , V_44 , V_318 , V_97 ) ;
V_246:
F_32 ( V_334 ) ;
F_32 ( V_319 ) ;
return V_318 ;
...
V_316 = F_277 ( V_188 -> V_349 , V_112 -> V_317 ) ;
if ( ! V_316 ) {
F_98 ( V_22 , L_88 , V_112 -> V_317 ) ;
return - V_115 ;
}
V_316 = F_61 ( V_316 , V_45 ) ;
if ( ! V_316 )
return - V_43 ;
V_318 = F_271 ( V_22 ) ;
if ( ! V_318 )
...
struct V_85 * V_93 ;
T_5 V_96 ;
V_77 = sizeof ( V_86 ) + sizeof ( V_259 ) +
V_350 * sizeof ( V_86 ) ;
V_334 = F_255 ( V_77 , V_45 ) ;
if ( ! V_334 )
return - V_43 ;
V_42 = F_202 ( V_22 , V_22 -> V_265 ,
L_37 , L_90 , NULL , 0 ,
...
V_153 = V_334 + V_42 ;
V_42 = - V_333 ;
F_267 ( & V_335 , V_153 , V_99 , V_246 ) ;
F_279 ( & V_335 , V_153 , V_78 , V_246 ) ;
if ( V_78 > ( V_84 - sizeof ( struct V_85 ) )
/ sizeof ( V_87 ) ) {
V_42 = - V_4 ;
goto V_246;
}
if ( ! F_280 ( & V_335 , V_153 , V_78 * sizeof ( V_86 ) ) )
goto V_246;
V_42 = 0 ;
V_93 = F_58 ( V_78 , V_45 ) ;
if ( ! V_93 ) {
...
V_335 = V_334 ;
V_153 = V_334 + V_42 ;
V_117 = F_264 ( & V_335 , V_153 , NULL , V_45 ) ;
if ( F_26 ( V_117 ) )
goto V_246;
F_21 ( L_93 ,
...
if ( V_22 -> V_90 . V_111 & V_352 &&
( V_91 || V_22 -> V_234 ) ) {
bool V_353 ;
V_42 = F_266 ( V_22 ) ;
if ( V_42 )
return V_42 ;
V_353 = V_22 -> V_234 && V_22 -> V_112 -> V_316 ;
if ( V_91 && V_353 )
F_98 ( V_22 , L_94
L_95 ) ;
}
...
F_290 ( & V_22 -> V_48 ) ;
F_30 ( & V_363 ) ;
F_291 ( & V_361 , V_22 -> V_5 ) ;
F_21 ( L_98 , V_22 , V_22 -> V_5 ) ;
}
static inline T_6 F_292 ( const char * * V_146 )
{
const char * V_365 = L_99 ;
* V_146 += strspn ( * V_146 , V_365 ) ;
return strcspn ( * V_146 , V_365 ) ;
}
...
static inline char * F_294 ( const char * * V_146 , T_6 * V_367 )
{
char * V_368 ;
T_6 V_97 ;
V_97 = F_292 ( V_146 ) ;
V_368 = F_295 ( * V_146 , V_97 + 1 , V_45 ) ;
if ( ! V_368 )
return NULL ;
* ( V_368 + V_97 ) = '\0' ;
* V_146 += V_97 ;
...
char * V_319 ;
if ( V_22 -> V_112 -> V_319 ) {
V_22 -> V_74 = * V_22 -> V_112 -> V_319 ? 2 : 1 ;
return 0 ;
}
V_77 = sizeof ( V_377 ) + strlen ( V_22 -> V_112 -> V_318 ) ;
V_217 = F_22 ( V_77 , V_132 ) ;
if ( ! V_217 )
return - V_43 ;
sprintf ( V_217 , L_104 , V_377 , V_22 -> V_112 -> V_318 ) ;
F_21 ( L_105 , V_217 ) ;
V_77 = sizeof ( V_259 ) + V_341 ;
V_376 = F_255 ( V_77 , V_132 ) ;
if ( ! V_376 ) {
V_42 = - V_43 ;
goto V_246;
}
V_42 = F_202 ( V_22 , V_217 ,
L_37 , L_106 , NULL , 0 ,
V_376 , V_341 ) ;
F_21 ( L_68 , V_44 , V_42 ) ;
if ( V_42 == - V_34 ) {
V_319 = F_61 ( L_107 , V_45 ) ;
V_42 = V_319 ? 0 : - V_43 ;
if ( ! V_42 )
V_22 -> V_74 = 1 ;
} else if ( V_42 > sizeof ( V_259 ) ) {
void * V_335 = V_376 ;
V_319 = F_264 ( & V_335 , V_335 + V_42 ,
NULL , V_132 ) ;
V_42 = F_26 ( V_319 ) ? F_182 ( V_319 ) : 0 ;
if ( ! V_42 )
V_22 -> V_74 = 2 ;
} else {
V_42 = - V_4 ;
...
{
struct V_21 * V_243 = NULL ;
struct V_320 * V_234 ;
struct V_38 * V_41 ;
int V_42 ;
if ( ! V_22 -> V_234 )
return 0 ;
V_234 = F_253 ( V_22 -> V_234 ) ;
V_41 = F_35 ( V_22 -> V_38 ) ;
V_42 = - V_43 ;
V_243 = F_256 ( V_41 , V_234 ) ;
if ( ! V_243 )
goto V_98;
V_42 = F_301 ( V_243 , false ) ;
if ( V_42 < 0 )
goto V_98;
V_22 -> V_243 = V_243 ;
F_257 ( & V_22 -> V_235 , 1 ) ;
...
F_303 ( V_379
< sizeof ( V_308 ) + V_380 ) ;
sprintf ( V_22 -> V_128 , L_109 , V_308 , V_22 -> V_5 ) ;
if ( ! V_13 ) {
...
if ( V_42 )
goto V_384;
F_224 ( V_22 -> V_36 , V_22 -> V_27 . V_77 / V_304 ) ;
V_42 = F_282 ( V_22 ) ;
if ( V_42 )
goto V_385;
F_106 ( V_291 , & V_22 -> V_32 ) ;
F_305 ( V_22 -> V_36 ) ;
F_268 ( L_110 , V_22 -> V_36 -> V_307 ,
( unsigned long long ) V_22 -> V_27 . V_77 ) ;
return V_42 ;
V_385:
F_72 ( V_22 ) ;
...
F_18 ( F_52 ( V_22 -> V_74 ) ) ;
if ( V_22 -> V_74 == 1 )
V_77 = strlen ( V_112 -> V_318 ) + sizeof ( V_386 ) ;
else
V_77 = sizeof ( V_387 ) + strlen ( V_112 -> V_319 ) ;
V_22 -> V_265 = F_22 ( V_77 , V_45 ) ;
if ( ! V_22 -> V_265 )
return - V_43 ;
if ( V_22 -> V_74 == 1 )
sprintf ( V_22 -> V_265 , L_104 ,
V_112 -> V_318 , V_386 ) ;
else
sprintf ( V_22 -> V_265 , L_104 ,
V_387 , V_112 -> V_319 ) ;
...
V_22 -> V_265 = NULL ;
V_22 -> V_74 = 0 ;
F_32 ( V_22 -> V_112 -> V_319 ) ;
V_22 -> V_112 -> V_319 = NULL ;
F_260 ( V_22 ) ;
}
...
static T_11 F_309 ( struct V_392 * V_354 ,
const char * V_146 ,
T_6 V_321 )
{
struct V_21 * V_22 = NULL ;
...
if ( ! F_310 ( V_394 ) )
return - V_395 ;
V_393 = F_296 ( V_146 , & V_40 , & V_60 , & V_112 ) ;
if ( V_393 < 0 )
goto V_396;
V_28 = V_60 -> V_28 ;
F_32 ( V_60 ) ;
...
V_393 = F_311 ( V_188 -> V_349 , V_112 -> V_316 ) ;
if ( V_393 < 0 )
goto V_398;
V_112 -> V_317 = ( V_87 ) V_393 ;
if ( V_112 -> V_317 > ( V_87 ) V_343 ) {
F_98 ( NULL , L_113 ,
( unsigned long long ) V_112 -> V_317 , V_343 ) ;
V_393 = - V_115 ;
goto V_398;
}
...
static T_11 F_313 ( struct V_392 * V_354 ,
const char * V_146 ,
T_6 V_321 )
{
if ( V_13 )
return - V_4 ;
return F_309 ( V_354 , V_146 , V_321 ) ;
}
static T_11 F_314 ( struct V_392 * V_354 ,
const char * V_146 ,
T_6 V_321 )
{
return F_309 ( V_354 , V_146 , V_321 ) ;
}
static void V_359 ( struct V_17 * V_18 )
{
struct V_21 * V_22 = F_238 ( V_18 ) ;
F_216 ( V_22 ) ;
F_127 ( V_291 , & V_22 -> V_32 ) ;
...
{
while ( V_22 -> V_243 ) {
struct V_21 * V_400 = V_22 ;
struct V_21 * V_401 = V_400 -> V_243 ;
struct V_21 * V_402 ;
while ( V_401 && ( V_402 = V_401 -> V_243 ) ) {
V_400 = V_401 ;
V_401 = V_402 ;
}
F_18 ( V_401 ) ;
...
static T_11 F_315 ( struct V_392 * V_354 ,
const char * V_146 ,
T_6 V_321 )
{
struct V_21 * V_22 = NULL ;
...
static T_11 F_320 ( struct V_392 * V_354 ,
const char * V_146 ,
T_6 V_321 )
{
if ( V_13 )
return - V_4 ;
return F_315 ( V_354 , V_146 , V_321 ) ;
}
static T_11 F_321 ( struct V_392 * V_354 ,
const char * V_146 ,
T_6 V_321 )
{
return F_315 ( V_354 , V_146 , V_321 ) ;
