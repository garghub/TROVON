...
int V_28 , int V_30 , struct V_1 * * V_107 )
{
enum V_108 V_109 = V_110 | V_111 | V_112 ;
struct V_3 * V_4 ;
F_81 ( V_87 ) ;
int V_33 ;
int V_113 = 1 , V_69 ;
struct V_1 * V_98 = * V_107 ;
struct V_1 * V_114 ;
if ( F_82 ( V_2 ) || F_2 ( V_2 ) )
return V_115 ;
if ( ! F_83 ( V_98 ) )
...
if ( V_113 )
F_54 ( V_114 , & V_87 ) ;
V_33 = F_100 ( V_114 , V_109 ) ;
if ( V_33 != V_115 )
F_14 ( V_34 L_16 ,
V_29 , F_101 ( V_114 ) ) ;
V_69 = F_86 ( V_114 ) || ( V_30 & V_118 ) ;
F_36 ( & V_87 , V_69 , V_28 ,
V_33 != V_115 , V_2 , V_29 , V_30 ) ;
return V_33 ;
}
static void F_102 ( struct V_1 * V_98 )
{
int V_120 ;
int V_121 = 1 << F_16 ( V_98 ) ;
...
F_102 ( V_98 ) ;
F_117 ( V_2 ) ;
if ( F_80 ( V_2 , V_29 , V_28 , V_30 , & V_98 )
!= V_115 ) {
F_14 ( V_34 L_27 , V_29 ) ;
V_97 = - V_106 ;
goto V_126;
...
V_97 = - V_106 ;
for ( V_103 = V_127 ; ; V_103 ++ )
if ( ( V_2 -> V_30 & V_103 -> V_128 ) == V_103 -> V_97 )
break;
V_122 |= ( V_2 -> V_30 & ( 1UL << V_129 ) ) ;
if ( ! V_103 -> V_128 )
for ( V_103 = V_127 ; ; V_103 ++ )
if ( ( V_122 & V_103 -> V_128 ) == V_103 -> V_97 )
break;
...
V_131 = & F_119 ( V_130 ) ;
F_120 ( & V_131 -> V_135 , V_132 ) ;
if ( F_121 ( & V_131 -> V_136 , V_134 ) )
F_122 ( F_123 () , & V_131 -> V_137 ) ;
else
F_78 ( L_29 ,
V_29 ) ;
F_124 ( & V_131 -> V_135 , V_132 ) ;
F_125 ( V_130 ) ;
}
static void F_126 ( struct V_138 * V_137 )
{
struct V_130 * V_131 ;
...
for (; ; ) {
F_120 ( & V_131 -> V_135 , V_132 ) ;
V_139 = F_128 ( & V_131 -> V_136 , & V_134 ) ;
F_124 ( & V_131 -> V_135 , V_132 ) ;
if ( ! V_139 )
break;
if ( V_134 . V_30 & V_140 )
F_129 ( F_109 ( V_134 . V_29 ) , V_134 . V_30 ) ;
else
F_106 ( V_134 . V_29 , V_134 . V_28 , V_134 . V_30 ) ;
}
}
...
int V_141 ;
F_131 (cpu) {
V_131 = & F_132 ( V_130 , V_141 ) ;
F_133 ( & V_131 -> V_135 ) ;
F_134 ( V_131 -> V_136 ) ;
F_135 ( & V_131 -> V_137 , F_126 ) ;
}
return 0 ;
}
...
F_99 ( V_1 ) ;
F_96 ( V_1 ) ;
if ( V_142 && ! ( V_29 == F_138 ( 0 ) && F_28 ( V_2 ) == 1 ) )
F_96 ( V_1 ) ;
return 0 ;
}
static struct V_1 * F_139 ( struct V_1 * V_2 , unsigned long V_143 , int * * V_144 )
{
int V_52 = F_25 ( V_2 ) ;
if ( F_91 ( V_2 ) )
...
F_99 ( V_98 ) ;
F_146 ( & V_98 -> V_148 , & V_147 ) ;
V_33 = F_147 ( & V_147 , F_139 , V_149 ,
V_150 , V_151 ) ;
if ( V_33 ) {
F_32 ( L_40 ,
V_29 , V_33 , V_1 -> V_30 ) ;
