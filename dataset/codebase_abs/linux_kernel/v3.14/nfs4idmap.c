...
static T_2 F_52 ( T_3 V_8 , T_2 * * V_74 , int * V_36 )
{
char V_35 [ 11 ] ;
int V_40 ;
int V_75 ;
...
if ( V_75 > * V_36 )
return V_76 ;
* V_74 = F_54 ( * V_74 , V_35 , V_40 ) ;
* V_36 -= V_75 ;
return 0 ;
}
static T_2 F_55 ( struct V_64 * V_65 , int type , T_3 V_8 , T_2 * * V_74 , int * V_36 )
{
struct V_4 * V_49 , V_71 = {
. V_8 = V_8 ,
. type = type ,
...
{
if ( V_77 && V_65 -> V_78 . V_79 < V_80 )
if ( F_57 ( V_65 , type , V_9 , V_70 , V_8 ) )
return 0 ;
return F_48 ( V_65 , type , V_9 , V_70 , V_8 ) ;
}
static T_2 F_60 ( struct V_64 * V_65 , int type , T_3 V_8 , T_2 * * V_74 , int * V_36 )
{
if ( V_77 && V_65 -> V_78 . V_79 < V_80 )
return F_52 ( V_8 , V_74 , V_36 ) ;
return F_55 ( V_65 , type , V_8 , V_74 , V_36 ) ;
}
T_2
...
T_2 V_82 ;
T_3 V_8 = - 1 ;
V_82 = F_59 ( V_65 , V_45 , V_9 , V_70 , & V_8 ) ;
* V_81 = F_62 ( & V_83 , V_8 ) ;
if ( ! F_63 ( * V_81 ) )
V_82 = V_73 ;
return V_82 ;
...
T_2 V_82 ;
T_3 V_8 = - 1 ;
V_82 = F_59 ( V_65 , V_18 , V_9 , V_70 , & V_8 ) ;
* V_84 = F_65 ( & V_83 , V_8 ) ;
if ( ! F_66 ( * V_84 ) )
V_82 = V_73 ;
return V_82 ;
}
T_2 F_67 ( struct V_64 * V_65 , T_5 V_81 , T_2 * * V_74 , int * V_36 )
{
T_3 V_8 = F_68 ( & V_83 , V_81 ) ;
return F_60 ( V_65 , V_45 , V_8 , V_74 , V_36 ) ;
}
T_2 F_69 ( struct V_64 * V_65 , T_6 V_84 , T_2 * * V_74 , int * V_36 )
{
T_3 V_8 = F_70 ( & V_83 , V_84 ) ;
return F_60 ( V_65 , V_18 , V_8 , V_74 , V_36 ) ;
}
