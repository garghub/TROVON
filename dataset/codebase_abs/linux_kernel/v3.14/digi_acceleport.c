...
static void F_32 ( struct V_59 * V_60 , int V_135 )
{
struct V_12 * V_13 = V_60 -> V_61 ;
...
unsigned long V_4 ;
F_9 ( & V_10 -> V_15 , V_4 ) ;
V_137 = ( V_10 -> V_55 & ~ V_139 ) | V_138 ;
F_4 ( & V_10 -> V_15 , V_4 ) ;
return F_21 ( V_13 , V_137 , 1 ) ;
}
...
V_141 = F_16 ( V_17 , V_13 -> V_33 - 2 - V_10 -> V_42 ) ;
V_140 = V_141 + V_10 -> V_42 ;
if ( V_140 == 0 ) {
F_4 ( & V_10 -> V_15 , V_4 ) ;
return 0 ;
}
V_13 -> V_34 -> V_36 = V_140 + 2 ;
* V_39 ++ = V_43 ;
* V_39 ++ = V_140 ;
memcpy ( V_39 , V_10 -> V_44 , V_10 -> V_42 ) ;
V_39 += V_10 -> V_42 ;
memcpy ( V_39 , V_16 , V_141 ) ;
V_19 = F_17 ( V_13 -> V_34 , V_37 ) ;
if ( V_19 == 0 ) {
V_10 -> V_28 = 1 ;
V_19 = V_141 ;
...
static void F_38 ( struct V_143 * V_143 )
{
...
V_23 = V_13 -> V_23 ;
if ( V_23 == NULL || ( V_146 = F_12 ( V_23 ) ) == NULL ) {
F_18 ( & V_13 -> V_26 ,
L_12 ,
V_38 , V_147 ) ;
return;
}
if ( V_10 -> V_27 == V_146 -> V_148 ) {
F_14 ( & V_13 -> V_26 , L_13 ) ;
F_22 ( & V_10 -> V_15 ) ;
V_10 -> V_28 = 0 ;
F_40 ( & V_13 -> V_29 ) ;
...
V_150 = V_13 -> V_33 - 2 - V_10 -> V_42 ;
F_4 ( & V_10 -> V_15 , V_4 ) ;
F_14 ( & V_13 -> V_26 , L_14 , V_10 -> V_27 , V_150 ) ;
return V_150 ;
}
...
static void F_44 ( struct V_12 * V_13 , int V_151 )
{
F_21 ( V_13 , V_151 * ( V_48 | V_52 ) , 1 ) ;
}
...
if ( V_60 ) {
V_152 . V_72 = ~ V_60 -> V_69 . V_72 ;
V_152 . V_70 = ~ V_60 -> V_69 . V_70 ;
F_27 ( V_60 , V_13 , & V_152 ) ;
}
return 0 ;
}
...
F_40 ( & V_10 -> V_162 ) ;
F_51 ( & V_10 -> V_15 ) ;
F_52 ( & V_13 -> V_23 -> V_158 ) ;
}
static int F_46 ( struct V_145 * V_23 )
{
int V_76 , V_19 = 0 ;
struct V_22 * V_146 = F_12 ( V_23 ) ;
struct V_12 * V_13 ;
F_22 ( & V_146 -> V_163 ) ;
if ( V_146 -> V_164 ) {
F_23 ( & V_146 -> V_163 ) ;
...
V_146 -> V_164 = 1 ;
F_23 ( & V_146 -> V_163 ) ;
for ( V_76 = 0 ; V_76 < V_23 -> type -> V_165 + 1 ; V_76 ++ ) {
V_13 = V_23 -> V_13 [ V_76 ] ;
V_19 = F_17 ( V_13 -> V_64 , V_166 ) ;
if ( V_19 != 0 ) {
F_18 ( & V_13 -> V_26 ,
L_4 ,
V_38 , V_19 , V_76 ) ;
...
static int F_53 ( struct V_12 * V_13 , unsigned V_167 )
{
struct V_9 * V_10 ;
V_10 = F_54 ( sizeof( * V_10 ) , V_166 ) ;
if ( ! V_10 )
return - V_168 ;
F_55 ( & V_10 -> V_15 ) ;
V_10 -> V_27 = V_167 ;
...
static int F_59 ( struct V_145 * V_23 )
{
struct V_22 * V_146 ;
int V_19 ;
V_146 = F_54 ( sizeof( * V_146 ) , V_166 ) ;
if ( ! V_146 )
return - V_168 ;
F_55 ( & V_146 -> V_163 ) ;
V_146 -> V_148 = V_23 -> type -> V_165 ;
V_146 -> V_24 = V_23 -> V_13 [ V_146 -> V_148 ] ;
V_19 = F_53 ( V_146 -> V_24 ,
V_146 -> V_148 ) ;
if ( V_19 ) {
F_60 ( V_146 ) ;
return V_19 ;
...
static void F_62 ( struct V_145 * V_23 )
{
int V_76 ;
for ( V_76 = 0 ; V_76 < V_23 -> type -> V_165 + 1 ; V_76 ++ ) {
...
static void F_63 ( struct V_145 * V_23 )
{
struct V_22 * V_146 ;
struct V_9 * V_10 ;
V_146 = F_12 ( V_23 ) ;
V_10 = F_13 ( V_146 -> V_24 ) ;
F_60 ( V_10 ) ;
F_60 ( V_146 ) ;
}
static int F_64 ( struct V_12 * V_13 )
{
return F_53 ( V_13 , V_13 -> V_169 ) ;
}
...
static void F_66 ( struct V_143 * V_143 )
{
struct V_12 * V_13 = V_143 -> V_144 ;
struct V_9 * V_10 ;
struct V_22 * V_146 ;
...
V_19 = F_17 ( V_143 , V_37 ) ;
if ( V_19 != 0 && V_19 != - V_149 ) {
F_18 ( & V_13 -> V_26 ,
L_22 ,
V_38 , V_19 , V_10 -> V_27 ) ;
}
}
static int F_68 ( struct V_143 * V_143 )
{
struct V_12 * V_13 = V_143 -> V_144 ;
struct V_9 * V_10 = F_13 ( V_13 ) ;
int V_170 = ( ( unsigned char * ) V_143 -> V_35 ) [ 0 ] ;
int V_20 = ( ( unsigned char * ) V_143 -> V_35 ) [ 1 ] ;
int V_171 = ( ( unsigned char * ) V_143 -> V_35 ) [ 2 ] ;
unsigned char * V_39 = ( ( unsigned char * ) V_143 -> V_35 ) + 3 ;
int V_172 , V_173 ;
int V_147 = V_143 -> V_147 ;
if ( V_143 -> V_147 == - V_174 )
return 0 ;
if ( V_143 -> V_175 != V_20 + 2 ) {
F_18 ( & V_13 -> V_26 , L_23
L_24
L_25 , V_38 , V_147 ,
V_10 -> V_27 , V_170 , V_20 , V_143 -> V_175 ,
V_171 ) ;
return - 1 ;
}
F_22 ( & V_10 -> V_15 ) ;
...
F_14 ( & V_13 -> V_26 , L_27 , V_38 , V_170 ) ;
return V_173 ? 1 : 0 ;
}
static int F_67 ( struct V_143 * V_143 )
{
struct V_12 * V_13 = V_143 -> V_144 ;
struct V_145 * V_23 = V_13 -> V_23 ;
struct V_59 * V_60 ;
struct V_9 * V_10 = F_13 ( V_13 ) ;
int V_170 , line , V_147 , V_137 ;
int V_76 ;
unsigned int V_186 ;
for ( V_76 = 0 ; V_76 < V_143 -> V_175 - 3 ; ) {
V_170 = ( ( unsigned char * ) V_143 -> V_35 ) [ V_76 ++ ] ;
line = ( ( unsigned char * ) V_143 -> V_35 ) [ V_76 ++ ] ;
V_147 = ( ( unsigned char * ) V_143 -> V_35 ) [ V_76 ++ ] ;
V_137 = ( ( unsigned char * ) V_143 -> V_35 ) [ V_76 ++ ] ;
F_14 ( & V_13 -> V_26 , L_28 ,
V_170 , line , V_147 , V_137 ) ;
if ( V_147 != 0 || line >= V_23 -> type -> V_165 )
continue;
V_13 = V_23 -> V_13 [ line ] ;
V_10 = F_13 ( V_13 ) ;
if ( V_10 == NULL )
