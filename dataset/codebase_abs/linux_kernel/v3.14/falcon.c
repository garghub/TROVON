...
memcpy ( V_4 -> V_32 -> V_421 , V_346 -> V_422 [ 0 ] , V_423 ) ;
F_96 ( V_4 , V_325 , V_4 -> V_32 , L_47 ,
V_4 -> V_141 , V_4 -> V_186 . V_300 ) ;
V_63 = F_165 ( V_4 ,
F_141 ( V_346 -> V_414 . V_424 ) ) ;
V_59:
F_73 ( V_346 ) ;
return V_63 ;
}
...
{
struct V_118 * V_119 = V_4 -> V_119 ;
T_1 V_427 , V_428 , V_429 ;
int V_430 ;
F_2 ( V_4 , & V_428 , V_6 ) ;
F_2 ( V_4 , & V_427 , V_431 ) ;
F_2 ( V_4 , & V_429 , V_432 ) ;
if ( F_7 ( V_428 , V_433 ) ) {
V_430 = ( F_7 ( V_427 , V_434 ) ?
V_417 : V_420 ) ;
...
static unsigned int F_168 ( struct V_3 * V_4 )
{
return 0x20000 ;
}
...
int V_63 ;
V_4 -> V_444 = V_4 ;
V_119 = F_171 ( sizeof( * V_119 ) , V_125 ) ;
if ( ! V_119 )
return - V_126 ;
V_4 -> V_119 = V_119 ;
V_63 = - V_124 ;
...
T_1 V_427 ;
struct V_382 * V_445 ;
T_5 V_446 = V_4 -> V_382 -> V_447 ;
if ( ( V_446 == 0xff ) || ( V_446 == 0 ) ) {
F_40 ( V_4 , V_325 , V_4 -> V_32 ,
L_52 ) ;
goto V_384;
}
F_2 ( V_4 , & V_427 , V_431 ) ;
if ( F_7 ( V_427 , V_448 ) == 0 ) {
F_40 ( V_4 , V_325 , V_4 -> V_32 ,
L_53 ) ;
goto V_384;
}
if ( F_7 ( V_427 , V_449 ) == 0 ) {
F_40 ( V_4 , V_325 , V_4 -> V_32 ,
L_54 ) ;
goto V_384;
}
V_445 = F_173 ( V_4 -> V_382 ) ;
while ( ( V_445 = F_174 ( V_450 ,
V_451 ,
V_445 ) ) ) {
if ( V_445 -> V_452 == V_4 -> V_382 -> V_452 &&
V_445 -> V_453 == V_4 -> V_382 -> V_453 + 1 ) {
V_119 -> V_385 = V_445 ;
break;
}
}
...
V_4 -> V_456 = ( F_79 ( V_4 ) <= V_337 ? 4 :
V_40 ) ;
V_4 -> V_457 = 4968 ;
V_443 = F_159 ( V_4 ) ;
V_443 -> V_458 . V_459 = V_460 ;
V_443 -> V_461 = V_462 ;
V_443 -> V_461 . V_1 = V_4 ;
V_443 -> V_458 . V_463 = & V_443 -> V_461 ;
V_443 -> V_458 . V_445 . V_464 = & V_4 -> V_382 -> V_445 ;
F_175 ( V_443 -> V_458 . V_102 , L_59 ,
sizeof( V_443 -> V_458 . V_102 ) ) ;
V_63 = F_176 ( & V_443 -> V_458 ) ;
if ( V_63 )
goto V_455;
V_63 = F_159 ( V_4 ) -> type -> V_465 ( V_4 ) ;
if ( V_63 ) {
F_40 ( V_4 , V_325 , V_4 -> V_32 ,
L_60 ) ;
goto V_466;
...
V_119 -> V_165 = 1 ;
F_177 ( & V_119 -> V_280 , & F_114 ,
( unsigned long ) V_4 ) ;
return 0 ;
V_466:
F_178 ( & V_443 -> V_458 ) ;
memset ( & V_443 -> V_458 , 0 , sizeof( V_443 -> V_458 ) ) ;
V_455:
F_134 ( V_4 , & V_4 -> V_27 ) ;
V_454:
V_395:
...
{
const unsigned V_467 = 20 ;
const unsigned V_468 = 25 ;
T_1 V_5 ;
F_2 ( V_4 , & V_5 , V_261 ) ;
if ( F_79 ( V_4 ) <= V_337 ) {
F_3 ( V_5 , V_469 , 0 ) ;
...
F_3 ( V_5 , V_476 ,
V_477 >> 5 ) ;
F_3 ( V_5 , V_478 , 27648 >> 8 ) ;
F_3 ( V_5 , V_479 , 54272 >> 8 ) ;
F_3 ( V_5 , V_480 , V_467 ) ;
F_3 ( V_5 , V_481 , V_468 ) ;
F_3 ( V_5 , V_262 , 1 ) ;
F_3 ( V_5 , V_482 , 1 ) ;
...
{
struct V_118 * V_119 = V_4 -> V_119 ;
struct F_159 * V_443 = F_159 ( V_4 ) ;
V_443 -> type -> V_501 ( V_4 ) ;
F_178 ( & V_443 -> V_458 ) ;
memset ( & V_443 -> V_458 , 0 , sizeof( V_443 -> V_458 ) ) ;
F_134 ( V_4 , & V_4 -> V_27 ) ;
F_153 ( V_4 , V_369 ) ;
...
static T_4 F_187 ( struct V_3 * V_4 , T_5 * V_502 )
{
return F_188 ( V_281 , V_282 ,
V_283 , V_502 ) ;
}
static T_4 F_189 ( struct V_3 * V_4 , V_331 * V_503 ,
struct V_504 * V_505 )
{
struct V_118 * V_119 = V_4 -> V_119 ;
...
if ( V_503 )
memcpy ( V_503 , V_284 , sizeof( V_331 ) * V_282 ) ;
if ( V_505 ) {
V_505 -> V_514 = V_284 [ V_515 ] ;
V_505 -> V_516 = V_284 [ V_517 ] ;
V_505 -> V_518 = V_284 [ V_511 ] ;
V_505 -> V_519 = V_284 [ V_520 ] ;
V_505 -> V_521 = V_284 [ V_508 ] ;
V_505 -> V_522 = V_284 [ V_523 ] ;
V_505 -> V_524 =
V_284 [ V_525 ] +
V_284 [ V_526 ] ;
V_505 -> V_527 = V_284 [ V_528 ] ;
V_505 -> V_529 = V_284 [ V_530 ] ;
V_505 -> V_531 = V_284 [ V_532 ] ;
V_505 -> V_533 = ( V_505 -> V_524 +
V_505 -> V_527 +
V_505 -> V_529 +
V_284 [ V_534 ] ) ;
}
...
static void F_196 ( struct V_3 * V_4 , enum V_535 V_536 )
{
F_159 ( V_4 ) -> type -> V_537 ( V_4 , V_536 ) ;
}
static void F_197 ( struct V_3 * V_4 , struct V_538 * V_539 )
{
V_539 -> V_540 = 0 ;
V_539 -> V_541 = 0 ;
memset ( & V_539 -> V_542 , 0 , sizeof( V_539 -> V_542 ) ) ;
}
static int F_198 ( struct V_3 * V_4 , T_10 type )
{
if ( type != 0 )
return - V_65 ;
return 0 ;
