...
V_63 -> V_228 = F_143 ( V_216 ) ;
V_63 -> V_90 = V_229 ;
}
if ( V_197 )
F_144 ( V_63 , F_143 ( V_230 ) , V_215 ) ;
if ( V_26 -> V_220 & V_231 )
F_145 ( & V_1 -> V_54 [ V_23 ] , V_63 ) ;
else
F_146 ( V_63 ) ;
} else {
F_10 ( V_63 ) ;
...
static int F_147 ( struct V_22 * V_14 , struct V_20 * V_20 ,
T_1 type , T_2 V_23 , T_2 V_24 , void * V_21 )
{
struct V_1 * V_1 = F_7 ( V_14 ) ;
F_148 ( & V_1 -> V_33 [ V_23 ] , V_20 ,
V_24 , V_232 ,
F_136 , V_21 ) ;
return 0 ;
}
static int F_149 ( struct V_55 * V_54 , int V_233 )
{
struct V_36 * V_26 = V_54 -> V_68 ;
struct V_1 * V_1 = F_40 ( V_26 ) ;
unsigned int V_234 = F_150 ( V_1 , 0 ) ;
...
static int F_153 ( struct V_55 * V_54 , int V_233 )
{
struct V_36 * V_26 = V_54 -> V_68 ;
struct V_1 * V_1 = F_40 ( V_26 ) ;
unsigned int V_33 = ( V_54 - & V_1 -> V_54 [ 0 ] ) ;
unsigned int V_56 = F_150 ( V_1 , V_33 ) ;
unsigned int V_49 = F_154 ( V_1 , V_33 ) ;
...
0 ,
0 ) ;
V_134 = F_151 ( & V_1 -> V_33 [ V_33 ] , F_133 ) ;
if ( V_134 )
V_237 = V_239 ;
if ( V_237 < V_239 ) {
F_152 ( V_54 ) ;
...
static void F_155 ( unsigned long V_44 )
{
...
struct V_36 * V_26 = V_1 -> V_26 ;
unsigned int V_29 ;
switch ( F_159 ( V_1 -> V_14 ) ) {
case V_243 :
F_160 ( V_1 -> V_2 -> V_43 , V_26 ) ;
break;
case V_244 :
F_160 ( V_1 -> V_2 -> V_43 , V_1 ) ;
break;
case V_245 :
for ( V_29 = 0 ; V_29 < F_161 ( V_1 -> V_246 ) ; V_29 ++ )
if ( V_1 -> V_246 [ V_29 ] . V_247 )
F_160 ( V_1 -> V_60 [ V_29 ] . V_61 ,
...
switch ( F_159 ( V_1 -> V_14 ) ) {
case V_243 :
V_134 = F_163 ( V_1 -> V_2 -> V_43 , F_39 ,
V_249 , V_26 -> V_169 , V_26 ) ;
break;
case V_244 :
V_134 = F_163 ( V_1 -> V_2 -> V_43 , F_51 ,
0 , V_26 -> V_169 , V_1 ) ;
break;
case V_245 :
for ( V_29 = 0 ; V_29 < V_1 -> V_32 ; V_29 ++ ) {
...
V_134 = F_163 ( V_1 -> V_60 [ V_29 ] . V_61 ,
...
switch ( F_159 ( V_1 -> V_14 ) ) {
case V_244 :
F_156 ( & V_1 -> V_240 , V_241 ) ;
break;
default:
break;
}
}
static int F_169 ( struct V_36 * V_26 )
{
struct V_1 * V_1 = F_40 ( V_26 ) ;
unsigned int V_29 ;
int V_134 ;
...
for ( V_29 = 0 ; V_29 < V_1 -> V_32 ; V_29 ++ ) {
F_151 ( & V_1 -> V_33 [ V_29 ] , F_133 ) ;
if ( F_170 ( & V_1 -> V_33 [ V_29 ] ) == 0 ) {
F_22 ( V_26 , L_19 ) ;
V_134 = - V_193 ;
goto V_255;
}
...
static int F_177 ( struct V_36 * V_26 )
{
struct V_1 * V_1 = F_40 ( V_26 ) ;
unsigned int V_29 ;
int V_134 ;
...
F_104 ( V_1 ) ;
for ( V_29 = 0 ; V_29 < V_1 -> V_31 ; V_29 ++ ) {
V_134 = F_183 ( & V_1 -> V_11 [ V_29 ] ) ;
if ( V_134 )
return V_134 ;
}
for ( V_29 = 0 ; V_29 < V_1 -> V_32 ; V_29 ++ ) {
V_134 = F_184 ( & V_1 -> V_33 [ V_29 ] ) ;
if ( V_134 )
return V_134 ;
}
F_176 ( V_1 ) ;
F_158 ( V_1 ) ;
for ( V_29 = 0 ; V_29 < V_1 -> V_31 ; V_29 ++ )
F_185 ( & V_1 -> V_11 [ V_29 ] , F_6 ) ;
for ( V_29 = 0 ; V_29 < V_1 -> V_32 ; V_29 ++ )
F_186 ( & V_1 -> V_33 [ V_29 ] , F_132 ) ;
...
static int F_189 ( struct V_36 * V_26 , int V_257 )
{
struct V_1 * V_1 = F_40 ( V_26 ) ;
...
static void F_190 ( struct V_259 * V_260 )
{
struct V_1 * V_1 = F_191 ( V_260 , struct V_1 , V_40 ) ;
struct V_36 * V_26 = V_1 -> V_26 ;
...
F_44 ( & V_1 -> V_49 [ 0 ] ) ;
F_164 ( V_1 ) ;
V_134 = F_184 ( & V_1 -> V_33 [ 0 ] ) ;
if ( V_134 ) {
F_193 () ;
F_22 ( V_26 , L_21 ) ;
return;
}
F_186 ( & V_1 -> V_33 [ 0 ] , F_132 ) ;
F_187 ( & V_1 -> V_56 [ 0 ] ) ;
F_188 ( & V_1 -> V_49 [ 0 ] ) ;
V_26 -> V_35 = V_257 ;
F_151 ( & V_1 -> V_33 [ 0 ] , F_133 ) ;
if ( F_170 ( & V_1 -> V_33 [ 0 ] ) == 0 ) {
F_193 () ;
F_22 ( V_26 , L_22 ) ;
return;
}
...
static void F_194 ( struct V_36 * V_26 )
{
struct V_1 * V_1 = F_40 ( V_26 ) ;
...
static int F_195 ( struct V_22 * V_14 ,
int (* F_196)( struct V_22 * , int ) ,
int (* F_197)( struct V_22 * , int * ) ,
int V_261 )
{
unsigned long time ;
int V_262 ;
int V_134 ;
F_198 ( F_199 () ) ;
V_134 = F_196 ( V_14 , V_261 ) ;
if ( V_134 )
return V_134 ;
time = V_241 + ( V_263 * 2 ) ;
do {
V_134 = F_197 ( V_14 , & V_262 ) ;
if ( V_134 )
return V_134 ;
if ( V_262 )
return 0 ;
F_200 ( V_263 / 10 ) ;
} while ( F_201 ( time , V_241 ) );
return - V_264 ;
}
static int F_202 ( struct V_1 * V_1 )
{
int V_134 ;
V_134 = F_195 ( V_1 -> V_14 , V_265 ,
V_266 , 0 ) ;
if ( V_134 )
F_203 ( F_204 ( V_1 ) , L_24 ,
V_134 ) ;
return V_134 ;
}
...
sizeof( union V_270 ) ) ;
F_19 ( & V_1 -> V_253 ) ;
F_209 ( V_1 -> V_2 , sizeof( union V_270 ) ,
V_271 , V_269 ) ;
return V_134 ;
}
static int F_210 ( struct V_1 * V_1 , T_1 V_275 )
{
T_6 V_276 ;
...
sizeof( union V_277 ) ) ;
F_19 ( & V_1 -> V_253 ) ;
F_209 ( V_1 -> V_2 , sizeof( union V_277 ) ,
V_278 , V_276 ) ;
return V_134 ;
}
static int F_212 ( struct V_1 * V_1 , T_1 V_280 ,
...
const T_1 V_275 = 7 ;
const T_1 V_282 = 0 ;
T_1 V_283 = F_215 ( V_1 , V_288 ) && ( V_1 -> V_32 > 1 ) ;
if ( V_283 ) {
if ( ! F_206 ( V_1 ) ) {
if ( F_210 ( V_1 , V_275 ) ) {
V_283 = 0 ;
...
return F_212 ( V_1 , V_280 , V_281 ,
V_275 , V_282 , V_283 ) ;
}
static void F_217 ( struct V_259 * V_260 )
{
struct V_1 * V_1 = F_191 ( V_260 , struct V_1 , V_52 ) ;
if ( ! F_103 ( V_1 -> V_26 ) )
return;
F_192 () ;
F_13 ( & V_1 -> V_289 ) ;
...
F_169 ( V_1 -> V_26 ) ;
F_19 ( & V_1 -> V_289 ) ;
F_221 ( V_290 , V_1 -> V_26 ) ;
F_193 () ;
}
static int F_222 ( struct V_1 * V_1 )
{
...
unsigned int V_29 ;
F_198 ( F_161 ( V_1 -> V_60 ) < V_291 + V_292 + 2 ) ;
...
if ( ! F_223 ( V_1 -> V_2 , V_1 -> V_60 , V_291 + V_292 + 2 ) ) {
V_1 -> V_32 = V_291 ;
V_1 -> V_31 = V_292 ;
V_1 -> V_256 = V_291 + V_292 ;
V_1 -> V_252 = V_291 + V_292 + 2 ;
...
V_1 -> V_256 >= 1 + V_292 &&
V_1 -> V_252 >= 1 + V_292 + 2 ) {
if ( ! F_223 ( V_1 -> V_2 , V_1 -> V_60 , 1 + V_292 + 2 ) ) {
V_1 -> V_32 = 1 ;
V_1 -> V_31 = V_292 ;
V_1 -> V_256 = 1 + V_292 ;
V_1 -> V_252 = 1 + V_292 + 2 ;
...
V_1 -> V_256 = 2 ;
V_1 -> V_252 = 3 ;
F_224 ( V_1 -> V_14 , V_243 ) ;
return 0 ;
}
F_224 ( V_1 -> V_14 , V_296 ) ;
return - V_157 ;
}
static void F_226 ( struct V_1 * V_1 )
{
switch ( F_159 ( V_1 -> V_14 ) ) {
case V_245 :
F_227 ( V_1 -> V_2 ) ;
...
switch ( F_159 ( V_1 -> V_14 ) ) {
default:
F_238 ( V_26 , & V_1 -> V_54 [ 0 ] , F_149 , 64 ) ;
break;
case V_245 :
for ( V_29 = 0 ; V_29 < V_1 -> V_32 ; V_29 ++ )
F_238 ( V_26 , & V_1 -> V_54 [ V_29 ] ,
F_153 , 64 ) ;
break;
}
return 0 ;
...
{
unsigned int V_29 ;
for ( V_29 = 0 ; V_29 < F_161 ( V_1 -> V_298 ) ; V_29 ++ )
if ( V_1 -> V_298 [ V_29 ] . V_299 )
F_240 ( V_1 -> V_298 [ V_29 ] . V_299 ) ;
}
static int F_241 ( struct V_300 * V_2 , const struct V_301 * V_302 )
{
...
V_134 = F_246 ( V_2 , V_309 ) ;
if ( V_134 ) {
F_203 ( V_68 , L_37 ) ;
goto V_310;
}
F_247 ( V_2 ) ;
V_134 = F_248 ( V_2 , F_249 ( 64 ) ) ;
if ( V_134 ) {
V_134 = F_248 ( V_2 , F_249 ( 32 ) ) ;
if ( V_134 ) {
F_203 ( V_68 , L_38 ) ;
goto V_311;
}
V_134 = F_250 ( V_2 , F_249 ( 32 ) ) ;
if ( V_134 ) {
F_203 ( V_68 , L_39
L_40 , 32 ) ;
goto V_311;
...
for ( V_29 = 0 ; V_29 < F_161 ( V_1 -> V_298 ) ; V_29 ++ ) {
if ( ! ( F_251 ( V_2 , V_29 ) & V_312 ) )
continue;
V_1 -> V_298 [ V_29 ] . V_17 = F_252 ( V_2 , V_29 ) ;
V_1 -> V_298 [ V_29 ] . V_299 = F_253 ( V_2 , V_29 , V_1 -> V_298 [ V_29 ] . V_17 ) ;
if ( ! V_1 -> V_298 [ V_29 ] . V_299 ) {
F_203 ( V_68 , L_41 , V_29 ) ;
V_134 = - V_313 ;
goto V_314;
}
V_1 -> V_298 [ V_29 ] . V_315 = F_254 ( V_2 , V_29 ) ;
}
V_1 -> V_14 = F_255 ( NULL , V_1 , V_2 , V_1 -> V_298 ,
F_161 ( V_1 -> V_298 ) ) ;
if ( ! V_1 -> V_14 ) {
F_203 ( V_68 , L_42 ) ;
V_134 = - V_313 ;
...
#ifdef F_5
V_304 = F_256 ( V_2 , V_316 ) ;
if ( V_304 ) {
F_257 ( V_2 , V_304 + V_317 ,
& V_1 -> V_9 ) ;
if ( V_1 -> V_9 ) {
V_134 = F_258 ( V_2 , V_1 -> V_9 ) ;
if ( V_134 ) {
F_203 ( V_68 , L_43
L_44 ,
V_134 ) ;
...
#endif
V_1 -> V_153 = F_259 ( V_305 , sizeof( * V_1 -> V_153 ) , V_319 ) ;
if ( ! V_1 -> V_153 ) {
V_134 = - V_193 ;
goto V_320;
}
...
F_263 ( V_26 , V_1 -> V_32 ) ;
F_264 ( & V_1 -> V_240 ) ;
V_1 -> V_240 . V_323 = F_155 ;
V_1 -> V_240 . V_44 = ( unsigned long ) V_1 ;
F_265 ( & V_1 -> V_52 , F_217 ) ;
F_265 ( & V_1 -> V_40 , F_190 ) ;
for ( V_29 = 0 ; V_29 < V_1 -> V_31 ; V_29 ++ )
F_260 ( & V_1 -> V_25 [ V_29 ] ) ;
V_1 -> V_37 = V_1 -> V_294 . V_35 ;
( void ) F_189 ( V_26 , V_1 -> V_37 ) ;
...
static void F_276 ( struct V_300 * V_2 )
{
struct V_36 * V_26 = F_277 ( V_2 ) ;
if ( V_26 ) {
struct V_1 * V_1 = F_40 ( V_26 ) ;
F_278 ( & V_1 -> V_52 ) ;
F_278 ( & V_1 -> V_40 ) ;
...
static int T_8 F_280 ( void )
{
F_281 ( L_52 , V_346 , V_347 ) ;
return F_282 ( & V_348 ) ;
}
static void T_9 F_283 ( void )
{
F_284 ( & V_348 ) ;
}
