...
T_3 F_21 ( int V_39 , void * V_40 )
{
struct V_25 * V_19 = V_40 ;
struct V_14 * V_15 = V_19 -> V_26 ;
T_2 V_37 , V_41 = 0 , V_42 = 0 , V_43 = 0 ;
int V_44 = 0 ;
F_15 ( & V_15 -> V_33 ) ;
V_37 = F_8 ( V_45 ) ;
if ( V_37 & ( V_46 | V_38 ) )
...
if ( V_43 && V_15 -> V_55 -> V_56 ) {
V_44 = V_15 -> V_55 -> V_56 ( V_19 ) ;
F_25 ( V_57 , F_26 ( V_57 ) ) ;
}
F_9 ( V_37 , V_45 ) ;
( void ) F_8 ( V_45 ) ;
...
void F_41 ( struct V_25 * V_19 , int V_1 )
{
struct V_14 * V_15 = V_19 -> V_26 ;
unsigned long V_60 ;
if ( F_39 ( V_19 ) )
...
T_1 F_43 ( struct V_25 * V_19 , int V_1 )
{
T_2 V_83 = V_84 ;
T_2 V_85 = V_86 ;
T_2 V_78 = V_11 ;
T_2 V_77 = 0 ;
T_2 V_87 = 0 , V_88 = 0 , V_89 = 0 , V_90 = 0 ;
switch ( V_1 ) {
case 0 :
break;
case 1 :
