...
int F_123 ( struct V_1 * V_2 , const struct V_150 * V_150 ,
T_3 V_151 )
{
int V_24 , V_25 ;
...
struct V_16 * V_17 ;
unsigned int V_102 ;
if ( ! F_124 ( V_150 -> V_152 ) )
return 0 ;
if ( ! F_125 ( V_2 ) )
return 0 ;
V_102 = ( V_151 + V_153 - 1 ) >> V_154 ;
F_126 ( V_2 , & V_135 , V_150 -> V_155 , V_102 ) ;
F_127 ( V_2 , & V_136 , V_150 -> V_155 ) ;
F_73 ( & V_2 -> V_98 ) ;
V_24 = F_65 ( V_2 , & V_135 , & V_17 , & V_25 ) ;
if ( V_24 < 0 )
goto V_123;
...
V_102 = F_77 ( V_2 , V_47 ) ;
F_5 ( L_42 ,
( unsigned long ) V_150 -> V_155 , V_151 ,
( ( T_3 ) V_102 ) << V_154 ) ;
F_74 ( & V_2 -> V_98 ) ;
F_128 ( V_2 , V_150 ) ;
F_31 () ;
