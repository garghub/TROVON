...
static struct V_4 * F_37 ( struct V_1 * V_2 , int V_33 )
{
int V_22 ;
struct V_5 * V_5 ;
struct V_4 * V_4 = NULL ;
struct V_34 args ;
V_22 = F_38 ( V_2 -> V_20 , L_5 , L_6 ,
V_33 , & args ) ;
if ( V_22 ) {
F_39 ( V_2 , L_7 ,
V_2 -> V_20 -> V_35 ) ;
...
void F_45 ( struct V_1 * V_2 , struct V_4 * V_4 )
{
int V_41 ;
if ( ! V_4 )
return;
V_41 = F_46 ( V_2 , F_1 , F_7 , V_4 ) ;
F_47 ( V_2 , V_41 , L_8 ) ;
}
struct V_4 * F_48 ( struct V_1 * V_2 , struct V_34
* args )
{
struct V_4 * V_4 ;
struct V_11 V_12 ;
...
struct V_4 * F_49 ( struct V_1 * V_2 , const char * string )
{
int V_33 = 0 ;
struct V_4 * V_4 ;
if ( string == NULL ) {
...
{
struct V_4 * V_4 = F_49 ( V_2 , string ) ;
if ( F_54 ( V_4 ) == - V_17 )
V_4 = NULL ;
return V_4 ;
}
...
struct V_4 * F_60 ( struct V_1 * V_2 , const struct V_46 * V_27 ,
struct V_47 * V_14 )
{
int V_22 ;
int V_48 ;
...
if ( F_61 ( ! V_2 ) )
return F_13 ( - V_42 ) ;
V_4 = F_62 ( sizeof( * V_4 ) , V_44 ) ;
if ( ! V_4 )
return F_13 ( - V_45 ) ;
V_48 = F_63 ( & V_49 , 0 , 0 , V_44 ) ;
if ( V_48 < 0 ) {
F_32 ( V_2 , L_11 ) ;
V_22 = V_48 ;
goto V_50;
...
V_4 -> V_27 = V_27 ;
V_4 -> V_14 = V_14 ;
V_22 = F_66 ( & V_4 -> V_2 , L_12 , V_16 ( V_2 ) , V_48 ) ;
if ( V_22 )
goto V_53;
V_22 = F_67 ( & V_4 -> V_2 ) ;
if ( V_22 )
...
struct V_4 * F_72 ( struct V_1 * V_2 , const struct V_46 * V_27 ,
struct V_47 * V_14 )
{
struct V_4 * * V_43 , * V_4 ;
...
void F_75 ( struct V_1 * V_2 , struct V_4 * V_4 )
{
int V_41 ;
V_41 = F_46 ( V_2 , F_5 , F_7 , V_4 ) ;
F_47 ( V_2 , V_41 , L_8 ) ;
}
