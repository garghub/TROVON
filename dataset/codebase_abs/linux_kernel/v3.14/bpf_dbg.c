...
int main ( int V_161 , char * * V_162 )
{
T_5 * V_149 = NULL , * V_150 = NULL ;
if ( V_161 >= 2 )
V_149 = fopen ( V_162 [ 1 ] , L_77 ) ;
if ( V_161 >= 3 )
V_150 = fopen ( V_162 [ 2 ] , L_78 ) ;
return F_77 ( V_149 ? : V_163 , V_150 ? : stdout ) ;
}
