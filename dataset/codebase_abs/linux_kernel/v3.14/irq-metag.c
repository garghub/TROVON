...
static void F_16 ( unsigned int V_22 , struct V_23 * V_24 )
{
struct V_12 * V_13 = F_17 ( V_24 ) ;
T_2 V_1 ;
unsigned int V_25 ;
T_3 V_26 ;
V_27:
V_26 = F_7 ( V_11 ) & V_13 -> V_15 ;
for ( V_1 = 0 ; V_26 != 0 ; V_26 >>= 1 , ++ V_1 ) {
if ( V_26 & 0x1 ) {
V_25 = F_18 ( V_13 -> V_28 , V_1 ) ;
F_19 ( V_25 ) ;
goto V_27;
}
}
...
if ( ! V_13 -> V_28 )
return - V_29 ;
return F_21 ( V_13 -> V_28 , V_1 ) ;
}
static void F_22 ( struct V_12 * V_13 ,
int V_19 )
{
unsigned int V_16 = V_21 [ V_19 ] ;
unsigned int V_30 = F_13 ( V_16 ) ;
int V_22 = F_23 ( V_30 ) ;
F_24 ( V_22 , V_13 ) ;
F_25 ( V_22 , F_16 ) ;
F_26 ( V_22 , V_31 ) ;
}
static int F_27 ( struct V_32 * V_33 , unsigned int V_22 ,
T_2 V_1 )
{
if ( ! F_1 ( V_1 ) )
return - V_34 ;
