...
V_2 -> V_2 . V_316 = & V_317 ;
V_2 -> V_8 = 1 ;
F_135 ( & V_2 -> V_2 , ( unsigned short ) ~ 0 ) ;
V_2 -> V_2 . V_115 = NULL ;
V_2 -> V_33 = 0xff ;
V_2 -> V_28 = ( T_2 ) V_77 ;
V_2 -> V_207 = 0 ;
...
static void F_136 ( struct V_319 * V_13 )
{
...
static int F_137 ( struct V_299 * V_300 )
{
struct V_6 * V_7 ;
...
unsigned int V_64 ;
const void * V_322 ;
V_321 = F_138 ( V_323 , & V_300 -> V_13 ) ;
if ( ! V_321 )
return - V_104 ;
V_322 = F_139 ( V_302 , L_41 , NULL ) ;
...
F_141 ( & V_7 -> V_183 , F_73 ,
( unsigned long ) V_7 ) ;
V_7 -> V_334 = F_142 ( V_302 , 0 ) ;
if ( ! V_7 -> V_334 ) {
V_237 = - V_104 ;
goto V_335;
}
V_237 = F_143 ( V_7 -> V_334 , F_125 , 0 ,
V_327 , V_7 ) ;
if ( V_237 ) {
F_39 ( V_7 -> V_13 , L_45 ,
V_7 -> V_334 , V_237 ) ;
...
V_237 = F_144 ( & V_300 -> V_13 , & V_7 -> V_12 ,
F_136 ) ;
if ( V_237 )
goto V_337;
F_145 ( V_300 , V_7 ) ;
...
static int F_149 ( struct V_299 * V_13 , T_9 V_44 )
{
return - V_339 ;
}
static int F_150 ( struct V_299 * V_13 )
{
return - V_339 ;
}
static int F_151 ( struct V_299 * V_300 )
{
struct V_6 * V_7 = F_152 ( V_300 ) ;
struct V_1 * V_2 ;
unsigned int V_102 ;
F_153 ( F_1 ) ;
F_154 ( & V_7 -> V_12 ) ;
