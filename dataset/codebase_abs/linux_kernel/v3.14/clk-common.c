...
unsigned long * V_6 )
{
struct V_9 * V_23 = F_16 ( V_5 -> V_9 ) ;
struct V_9 * V_24 = F_16 ( V_23 ) ;
unsigned long V_25 = F_17 ( V_24 ) ;
return F_9 ( F_18 ( V_23 ) , V_19 , & V_25 ) ;
}
...
static void F_22 ( struct V_4 * V_9 )
{
T_1 V_1 = F_2 ( V_26 + V_27 ) ;
V_1 |= ( V_28 | V_29 ) ;
F_4 ( V_1 , V_26 + V_27 ) ;
}
static unsigned long F_23 ( struct V_4 * V_5 , unsigned long V_6 )
{
T_1 V_1 = F_2 ( V_26 + V_27 ) ;
...
static int F_26 ( struct V_4 * V_5 , T_3 V_35 )
{
struct V_31 * V_9 = F_25 ( V_5 ) ;
T_1 V_32 = F_1 ( V_9 -> V_11 ) ;
if ( strcmp ( V_5 -> V_33 -> V_34 , L_1 ) == 0 )
...
static unsigned long F_27 ( struct V_4 * V_5 ,
unsigned long V_6 )
{
unsigned long V_7 = V_6 ;
struct V_31 * V_9 = F_25 ( V_5 ) ;
...
static long F_28 ( struct V_4 * V_5 , unsigned long V_19 ,
unsigned long * V_6 )
{
unsigned long V_7 ;
...
static int F_29 ( struct V_4 * V_5 , unsigned long V_19 ,
unsigned long V_6 )
{
struct V_31 * V_9 = F_25 ( V_5 ) ;
unsigned long V_7 ;
...
static int F_30 ( struct V_4 * V_5 , unsigned long V_19 ,
unsigned long V_6 )
{
int V_40 , V_41 ;
struct V_9 * V_42 ;
if ( V_19 == F_17 ( V_43 . V_5 . V_9 ) ) {
V_40 = F_31 ( V_5 -> V_9 , V_43 . V_5 . V_9 ) ;
return V_40 ;
}
if ( V_19 == F_17 ( V_44 . V_5 . V_9 ) ) {
V_40 = F_31 ( V_5 -> V_9 , V_44 . V_5 . V_9 ) ;
return V_40 ;
}
if ( V_19 == F_17 ( V_45 . V_5 . V_9 ) ) {
V_40 = F_31 ( V_5 -> V_9 , V_45 . V_5 . V_9 ) ;
return V_40 ;
}
V_42 = F_16 ( V_5 -> V_9 ) ;
