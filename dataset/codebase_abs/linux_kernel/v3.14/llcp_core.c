...
T_1 * V_95 , V_96 ;
T_1 * V_97 , V_98 ;
T_4 V_67 = F_74 ( V_13 -> V_75 ) ;
T_1 V_99 = 0 ;
int V_100 = 0 ;
V_91 = V_101 ;
V_90 = F_75 ( V_102 , & V_91 ,
1 , & V_92 ) ;
V_99 += V_92 ;
V_93 = F_75 ( V_103 , & V_13 -> V_104 , 1 , & V_94 ) ;
V_99 += V_94 ;
F_9 ( L_13 , V_13 -> V_75 ) ;
V_95 = F_75 ( V_105 , ( T_1 * ) & V_67 , 2 , & V_96 ) ;
V_99 += V_96 ;
V_97 = F_75 ( V_106 , ( T_1 * ) & V_13 -> V_107 , 0 ,
& V_98 ) ;
V_99 += V_98 ;
V_99 += F_60 ( V_108 ) ;
if ( V_99 > V_109 ) {
...
T_1 * F_76 ( struct V_62 * V_26 , T_2 * V_112 )
{
struct V_12 * V_13 ;
V_13 = F_58 ( V_26 ) ;
if ( V_13 == NULL ) {
...
int F_77 ( struct V_62 * V_26 , T_1 * V_111 , T_1 V_99 )
{
...
static void F_84 ( struct V_7 * V_3 , struct V_14 * V_116 )
{
...
continue;
if ( V_122 == NULL ) {
V_122 = F_86 ( V_120 , V_124 ,
V_125 ) ;
if ( V_122 == NULL )
continue;
V_52 = F_87 ( V_122 , V_124 ) ;
V_52 [ 0 ] = V_13 -> V_26 ? V_13 -> V_26 -> V_126 : 0xFF ;
V_52 [ 1 ] = V_121 ;
}
V_123 = F_88 ( V_122 , V_125 ) ;
if ( ! V_123 )
continue;
if ( F_89 ( V_4 , V_123 ) )
F_13 ( V_123 ) ;
...
struct V_3 * V_4 ;
struct V_7 * V_22 ;
V_120 = F_91 ( & V_13 -> V_17 ) ;
if ( V_120 != NULL ) {
V_4 = V_120 -> V_4 ;
V_22 = V_7 ( V_4 ) ;
if ( V_22 == NULL && F_80 ( V_120 ) == V_127 ) {
F_13 ( V_120 ) ;
F_92 ( V_13 -> V_26 ) ;
} else if ( V_22 && ! V_22 -> V_128 ) {
F_93 ( & V_13 -> V_17 , V_120 ) ;
F_92 ( V_13 -> V_26 ) ;
} else {
struct V_14 * V_129 = NULL ;
T_1 V_130 = F_80 ( V_120 ) ;
int V_100 ;
F_9 ( L_16 ) ;
F_94 ( V_131 , L_17 ,
V_132 , 16 , 1 ,
...
F_85 ( V_13 , V_120 ,
V_136 ) ;
V_100 = F_97 ( V_13 -> V_26 , V_13 -> V_137 ,
V_120 , V_138 , V_13 ) ;
if ( V_100 ) {
F_13 ( V_129 ) ;
goto V_110;
...
static struct V_7 * F_99 ( struct V_12 * V_13 ,
T_1 V_47 )
{
struct V_3 * V_4 ;
struct V_7 * V_22 ;
...
static T_1 * F_101 ( struct V_14 * V_120 , T_2 * V_69 )
{
...
T_1 * V_68 ;
T_2 V_69 ;
V_68 = F_101 ( V_120 , & V_69 ) ;
if ( V_68 == NULL ) {
V_151 = V_152 ;
goto V_153;
}
F_9 ( L_21 , V_69 ) ;
V_3 = F_100 ( V_13 , V_68 , V_69 ) ;
if ( V_3 == NULL ) {
V_151 = V_152 ;
goto V_153;
}
...
V_148 = F_110 ( NULL , V_149 -> V_70 , V_125 ) ;
if ( V_148 == NULL ) {
V_151 = V_154 ;
F_109 ( & V_3 -> V_4 ) ;
F_39 ( & V_3 -> V_4 ) ;
...
F_112 ( V_150 , & V_120 -> V_52 [ V_143 ] ,
V_120 -> V_133 - V_143 ) ;
F_9 ( L_24 , V_150 , & V_150 -> V_4 ) ;
F_1 ( & V_13 -> V_23 , V_148 ) ;
F_113 ( & V_3 -> V_4 , V_148 ) ;
F_114 ( V_13 -> V_26 -> V_126 ) ;
V_148 -> V_24 = V_25 ;
V_149 -> V_159 ( V_149 , 0 ) ;
F_115 ( V_150 ) ;
F_109 ( & V_3 -> V_4 ) ;
...
return;
V_153:
F_116 ( V_13 , V_48 , V_47 , V_151 ) ;
}
int F_117 ( struct V_7 * V_3 )
{
int V_160 = 0 ;
struct V_12 * V_13 = V_3 -> V_13 ;
F_9 ( L_25 ,
V_3 -> V_128 , F_118 ( & V_3 -> V_18 ) ,
V_3 -> V_8 ) ;
while ( V_3 -> V_128 &&
F_118 ( & V_3 -> V_18 ) < V_3 -> V_8 ) {
struct V_14 * V_116 ;
V_116 = F_91 ( & V_3 -> V_17 ) ;
if ( V_116 == NULL )
break;
F_84 ( V_3 , V_116 ) ;
F_98 ( & V_13 -> V_17 , V_116 ) ;
V_160 ++ ;
}
return V_160 ;
}
...
F_120 (&llcp_sock->tx_pending_queue,
s, tmp) {
F_12 ( V_15 , & V_22 -> V_18 ) ;
F_93 ( & V_13 -> V_17 , V_15 ) ;
}
...
F_116 ( V_13 , V_48 , V_47 , V_168 ) ;
F_109 ( V_4 ) ;
F_38 ( V_22 ) ;
}
static void F_123 ( struct V_12 * V_13 , struct V_14 * V_120 )
{
struct V_7 * V_22 ;
struct V_3 * V_4 ;
T_1 V_48 , V_47 ;
...
F_47 ( & V_13 -> V_56 ) ;
F_9 ( L_38 , V_140 [ 2 ] ) ;
F_127 (sdp, &local->pending_sdreqs, node) {
...
F_56 ( V_13 -> V_26 , & V_53 ) ;
if ( ! F_53 ( & V_171 ) )
F_128 ( V_13 , & V_171 , V_172 ) ;
}
static void F_129 ( struct V_12 * V_13 , struct V_14 * V_120 )
{
T_1 V_130 ;
T_5 V_177 ;
struct V_14 * V_178 ;
...
goto V_182;
V_178 = F_130 ( V_177 , V_183 ) ;
if ( V_178 == NULL ) {
F_43 ( L_42 ) ;
return;
}
memcpy ( F_131 ( V_178 , V_177 ) , V_120 -> V_52 , V_177 ) ;
F_132 ( V_13 , V_178 ) ;
F_13 ( V_178 ) ;
V_182:
F_104 ( V_120 , V_177 ) ;
...
F_96 ( V_120 ) ;
F_85 ( V_13 , V_120 , V_189 ) ;
F_132 ( V_13 , V_120 ) ;
F_44 ( & V_13 -> V_38 ) ;
F_13 ( V_13 -> V_41 ) ;
V_13 -> V_41 = NULL ;
}
static void F_134 ( struct V_12 * V_13 , struct V_14 * V_120 )
{
V_13 -> V_41 = V_120 ;
F_135 ( & V_13 -> V_37 ) ;
F_44 ( & V_13 -> V_39 ) ;
...
int F_136 ( struct V_62 * V_26 , struct V_14 * V_120 )
{
struct V_12 * V_13 ;
V_13 = F_58 ( V_26 ) ;
if ( V_13 == NULL )
...
void F_138 ( struct V_62 * V_26 , T_6 V_137 ,
T_1 V_192 , T_1 V_193 )
{
struct V_12 * V_13 ;
F_9 ( L_57 , V_193 ) ;
...
int F_139 ( struct V_62 * V_195 )
{
struct V_12 * V_13 ;
V_13 = F_140 ( sizeof( struct V_12 ) , V_183 ) ;
if ( V_13 == NULL )
return - V_196 ;
V_13 -> V_26 = V_195 ;
F_141 ( & V_13 -> V_46 ) ;
...
F_145 ( & V_13 -> V_17 ) ;
F_146 ( & V_13 -> V_38 , F_90 ) ;
V_13 -> V_41 = NULL ;
F_146 ( & V_13 -> V_39 , F_133 ) ;
F_146 ( & V_13 -> V_40 , F_40 ) ;
F_147 ( & V_13 -> V_23 . V_5 ) ;
F_147 ( & V_13 -> V_139 . V_5 ) ;
F_147 ( & V_13 -> V_34 . V_5 ) ;
V_13 -> V_104 = 150 ;
V_13 -> V_155 = V_198 ;
V_13 -> V_107 = F_74 ( V_199 ) ;
V_13 -> V_75 = 0x1 ;
F_73 ( V_13 ) ;
V_13 -> V_10 = V_190 ;
V_13 -> V_58 = V_191 ;
...
F_146 ( & V_13 -> V_43 , F_45 ) ;
F_149 ( & V_13 -> V_46 , & V_200 ) ;
return 0 ;
}
void F_150 ( struct V_62 * V_26 )
{
struct V_12 * V_13 = F_58 ( V_26 ) ;
if ( V_13 == NULL ) {
F_9 ( L_59 ) ;
