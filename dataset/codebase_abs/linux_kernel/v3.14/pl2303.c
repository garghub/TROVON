...
static int F_48 ( struct V_46 * V_47 , struct V_32 * V_33 )
{
struct V_1 * V_2 = V_33 -> V_2 ;
struct V_19 * V_20 = F_14 ( V_2 ) ;
int V_73 ;
if ( V_20 -> V_30 & V_31 ) {
F_49 ( V_2 -> V_6 , V_33 -> V_74 -> V_75 ) ;
F_49 ( V_2 -> V_6 , V_33 -> V_76 -> V_75 ) ;
} else {
F_6 ( V_2 , 8 , 0 ) ;
F_6 ( V_2 , 9 , 0 ) ;
}
...
V_96 . V_101 = 460800 ;
if ( F_57 ( ( void V_102 * ) V_94 , & V_96 , sizeof V_96 ) )
return - V_103 ;
return 0 ;
default:
break;
...
static void F_58 ( struct V_46 * V_47 , int V_105 )
{
struct V_32 * V_33 = V_47 -> V_79 ;
struct V_1 * V_2 = V_33 -> V_2 ;
T_1 V_106 ;
...
F_64 ( & V_33 -> V_33 . V_124 ) ;
}
}
static void F_65 ( struct V_125 * V_125 )
{
...
F_59 ( V_33 , V_111 , V_112 ) ;
exit:
V_39 = F_50 ( V_125 , V_131 ) ;
if ( V_39 ) {
F_4 ( & V_33 -> V_6 ,
L_27 ,
V_11 , V_39 ) ;
...
static void F_67 ( struct V_125 * V_125 )
{
struct V_32 * V_33 = V_125 -> V_126 ;
struct V_34 * V_35 = F_20 ( V_33 ) ;
unsigned char * V_111 = V_125 -> V_127 ;
...
V_132 ) ;
if ( V_84 & V_140 )
F_68 ( & V_33 -> V_33 , 0 , V_141 ) ;
if ( V_33 -> V_33 . V_142 && V_33 -> V_143 ) {
for ( V_44 = 0 ; V_44 < V_125 -> V_112 ; ++ V_44 )
if ( ! F_69 ( V_33 , V_111 [ V_44 ] ) )
F_68 ( & V_33 -> V_33 , V_111 [ V_44 ] ,
V_132 ) ;
} else {
F_70 ( & V_33 -> V_33 , V_111 , V_132 ,
V_125 -> V_112 ) ;
}
F_71 ( & V_33 -> V_33 ) ;
}
