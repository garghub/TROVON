...
static void F_8 ( enum V_18 V_19 ,
struct V_13 * V_14 )
{
switch ( V_19 ) {
case V_20 :
...
static T_4 F_12 ( int V_26 , void * V_27 )
{
...
static void T_3 F_13 ( struct V_31 * V_32 )
{
T_5 V_33 ;
struct V_34 * V_35 ;
if ( ! F_14 ( V_32 ) ) {
...
V_25 = F_18 ( V_35 ) ;
F_19 ( V_35 ) ;
} else if ( ! F_20 ( V_32 , L_4 , & V_33 ) ) {
V_25 = V_33 ;
} else {
F_6 ( L_5 ) ;
return;
}
V_15 . V_36 = F_21 ( V_32 , 0 ) ;
V_15 . V_16 = F_22 ( V_32 , 0 ) ;
F_1 ( V_15 . V_16 ) ;
F_9 () ;
F_23 ( V_15 . V_36 , & V_37 ) ;
F_7 ( ( V_25 / V_38 ) , NULL ) ;
