...
struct V_3 * V_4 ;
V_34 = - V_48 ;
if ( F_26 ( & V_94 , V_62 , sizeof( V_94 ) ) )
break;
V_34 = - V_91 ;
V_4 = F_8 ( V_2 , V_94 . V_11 ) ;
if ( V_4 ) {
F_42 ( V_94 . V_11 ) ;
V_34 = 0 ;
}
...
static unsigned int F_45 ( struct V_30 * V_30 , T_6 * V_97 )
{
unsigned int V_98 = V_99 | V_100 ;
struct V_1 * V_2 = V_30 -> V_39 ;
F_46 ( V_30 , & V_2 -> V_24 , V_97 ) ;
if ( V_2 -> V_21 != V_2 -> V_20 )
V_98 |= V_101 | V_102 ;
if ( V_2 -> V_28 )
V_98 = V_103 ;
...
static int F_47 ( int V_104 , struct V_30 * V_105 , int V_106 )
{
struct V_1 * V_2 = V_105 -> V_39 ;
return F_48 ( V_104 , V_105 , V_106 , & V_2 -> V_25 ) ;
}
static int F_49 ( struct V_107 * V_107 , struct V_30 * V_105 )
{
struct V_1 * V_2 ;
V_2 = F_31 ( sizeof( * V_2 ) , V_51 ) ;
if ( V_2 == NULL )
return - V_52 ;
V_2 -> V_58 = F_50 ( V_51 , L_2 , V_108 -> V_109 ) ;
if ( V_2 -> V_58 == NULL ) {
F_7 ( V_2 ) ;
return - V_52 ;
}
...
F_53 ( & V_2 -> V_19 ) ;
V_105 -> V_39 = V_2 ;
return F_54 ( V_107 , V_105 ) ;
}
static int F_55 ( struct V_107 * V_107 , struct V_30 * V_105 )
{
struct V_1 * V_2 = V_105 -> V_39 ;
struct V_5 * V_10 ;
while ( ( V_10 = V_2 -> V_7 . V_5 ) ) {
struct V_3 * V_4 ;
V_4 = F_56 ( V_10 , struct V_3 , V_10 ) ;
F_41 ( F_28 ( V_4 -> V_11 ) ) ;
F_36 ( V_2 , V_4 ) ;
}
