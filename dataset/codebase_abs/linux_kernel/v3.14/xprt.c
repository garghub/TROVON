...
struct V_19 * F_69 ( struct V_15 * V_16 , T_2 V_104 )
{
struct V_19 * V_105 ;
F_3 (entry, &xprt->recv, rq_list)
if ( V_105 -> V_106 == V_104 )
return V_105 ;
F_13 ( L_20 ,
F_70 ( V_104 ) ) ;
V_16 -> V_92 . V_107 ++ ;
...
long V_108 = F_72 ( F_73 ( V_20 -> V_109 ) ) ;
if ( V_57 ) {
if ( V_20 -> V_27 == 1 )
F_74 ( V_65 , V_57 , V_108 ) ;
F_75 ( V_65 , V_57 , V_20 -> V_27 - 1 ) ;
}
}
void F_76 ( struct V_17 * V_18 , int V_110 )
{
struct V_19 * V_20 = V_18 -> V_21 ;
struct V_15 * V_16 = V_20 -> V_51 ;
F_13 ( L_21 ,
V_18 -> V_28 , F_70 ( V_20 -> V_106 ) , V_110 ) ;
V_16 -> V_92 . V_111 ++ ;
V_20 -> V_109 = F_77 ( F_78 () , V_20 -> V_112 ) ;
if ( V_16 -> V_41 -> V_57 != NULL )
F_71 ( V_18 ) ;
F_8 ( & V_20 -> V_113 ) ;
V_20 -> V_114 . V_115 = V_110 ;
F_79 () ;
V_20 -> V_116 = V_110 ;
F_46 ( & V_16 -> V_54 , V_18 ) ;
}
...
if ( ! V_20 -> V_116 ) {
if ( F_64 ( & V_20 -> V_113 ) && F_85 ( V_18 ) ) {
F_24 ( & V_16 -> V_40 ) ;
memcpy ( & V_20 -> V_114 , & V_20 -> V_125 ,
sizeof( V_20 -> V_114 ) ) ;
F_4 ( & V_20 -> V_113 , & V_16 -> V_88 ) ;
F_25 ( & V_16 -> V_40 ) ;
F_51 ( V_20 ) ;
F_86 ( & V_16 -> V_57 ) ;
}
...
F_24 ( & V_16 -> V_40 ) ;
V_16 -> V_41 -> V_122 ( V_18 ) ;
V_123 = F_87 ( & V_16 -> V_128 ) ;
if ( V_123 > V_16 -> V_92 . V_129 )
V_16 -> V_92 . V_129 = V_123 ;
V_16 -> V_92 . V_130 ++ ;
V_16 -> V_92 . V_131 += V_16 -> V_92 . V_130 - V_16 -> V_92 . V_111 ;
...
static struct V_19 * F_92 ( struct V_15 * V_16 , T_3 V_140 )
{
struct V_19 * V_20 = F_93 ( - V_31 ) ;
if ( ! F_94 ( & V_16 -> V_128 , 1 , V_16 -> V_141 ) )
goto V_8;
V_20 = F_95 ( sizeof( struct V_19 ) , V_140 ) ;
if ( V_20 != NULL )
goto V_8;
F_96 ( & V_16 -> V_128 ) ;
V_20 = F_93 ( - V_142 ) ;
...
{
if ( F_94 ( & V_16 -> V_128 , - 1 , V_16 -> V_143 ) ) {
F_98 ( V_20 ) ;
return true ;
}
return false ;
...
F_2 ( & V_16 -> V_139 ) ;
if ( ! F_64 ( & V_16 -> free ) ) {
V_20 = F_100 ( V_16 -> free . V_144 , struct V_19 , V_113 ) ;
F_101 ( & V_20 -> V_113 ) ;
goto V_145;
}
V_20 = F_92 ( V_16 , V_146 | V_147 ) ;
if ( ! F_102 ( V_20 ) )
goto V_145;
switch ( F_103 ( V_20 ) ) {
case - V_142 :
...
V_20 = F_109 ( & V_16 -> free , struct V_19 , V_113 ) ;
F_101 ( & V_20 -> V_113 ) ;
F_98 ( V_20 ) ;
}
}
struct V_15 * F_110 ( struct V_148 * V_148 , T_4 V_149 ,
unsigned int V_150 ,
unsigned int V_151 )
{
struct V_15 * V_16 ;
struct V_19 * V_20 ;
int V_152 ;
V_16 = F_95 ( V_149 , V_153 ) ;
if ( V_16 == NULL )
goto V_8;
F_111 ( V_16 , V_148 ) ;
for ( V_152 = 0 ; V_152 < V_150 ; V_152 ++ ) {
V_20 = F_95 ( sizeof( struct V_19 ) , V_153 ) ;
if ( ! V_20 )
goto V_154;
F_107 ( & V_20 -> V_113 , & V_16 -> free ) ;
}
...
static void F_111 ( struct V_15 * V_16 , struct V_148 * V_148 )
{
F_112 ( & V_16 -> V_171 , 1 ) ;
F_131 ( & V_16 -> V_40 ) ;
F_131 ( & V_16 -> V_139 ) ;
...
V_16 -> V_49 = V_175 ;
V_16 -> V_176 = 0 ;
F_133 ( & V_16 -> V_177 , L_31 ) ;
F_133 ( & V_16 -> V_54 , L_32 ) ;
F_134 ( & V_16 -> V_35 , L_33 ) ;
F_134 ( & V_16 -> V_133 , L_34 ) ;
F_121 ( V_16 ) ;
V_16 -> V_155 = F_135 ( V_148 ) ;
}
struct V_15 * F_136 ( struct V_178 * args )
{
struct V_15 * V_16 ;
struct V_1 * V_3 ;
F_2 ( & V_6 ) ;
...
F_139 ( & V_16 -> V_57 ) ;
if ( strlen ( args -> V_102 ) > V_184 ) {
F_140 ( V_16 ) ;
return F_93 ( - V_185 ) ;
}
V_16 -> V_102 = F_141 ( args -> V_102 , V_153 ) ;
if ( V_16 -> V_102 == NULL ) {
F_140 ( V_16 ) ;
return F_93 ( - V_142 ) ;
}
