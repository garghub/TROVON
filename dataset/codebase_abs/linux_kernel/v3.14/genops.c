...
void F_116 ( struct V_95 * exp , struct V_190 * V_191 )
{
F_11 ( & exp -> V_125 ) ;
F_4 ( V_191 -> V_192 >= 0 ) ;
if ( V_191 -> V_193 != NULL &&
...
static void F_126 ( struct V_12 * V_216 ,
enum V_217 V_218 )
{
int V_34 ;
struct V_95 * exp ;
...
F_88 ( & V_222 ) ;
F_11 ( & V_2 -> V_55 ) ;
F_130 ( & V_2 -> V_146 , & V_222 ) ;
F_130 ( & V_2 -> V_223 , & V_222 ) ;
F_14 ( & V_2 -> V_55 ) ;
if ( ! F_76 ( & V_222 ) ) {
F_17 ( V_220 , L_55
L_56 , V_2 -> V_57 , V_2 ) ;
...
continue;
F_11 ( & exp -> V_131 ) ;
if ( exp -> V_202 || F_133 ( exp ) ) {
F_14 ( & exp -> V_131 ) ;
continue;
}
exp -> V_202 = 1 ;
F_14 ( & exp -> V_131 ) ;
F_102 ( & exp -> V_113 , & V_222 ) ;
V_225 ++ ;
F_17 ( V_220 , L_58 ,
V_2 -> V_56 , exp -> V_105 . V_64 ,
exp -> V_106 == NULL ? L_59 :
F_135 ( exp -> V_106 -> V_213 . V_214 ) ) ;
F_136 ( exp , L_60 , 0 ) ;
}
F_14 ( & V_2 -> V_55 ) ;
if ( V_225 )
...
{
if ( exp -> V_106 != NULL )
return F_135 ( exp -> V_106 -> V_213 . V_214 ) ;
return L_66 ;
}
int F_139 ( struct V_1 * V_2 , const char * V_214 )
{
struct V_115 * V_231 ;
struct V_95 * V_232 = NULL ;
int V_233 = 0 ;
T_1 V_234 = F_140 ( ( char * ) V_214 ) ;
F_11 ( & V_2 -> V_55 ) ;
if ( V_2 -> V_70 ) {
F_14 ( & V_2 -> V_55 ) ;
return V_233 ;
...
F_14 ( & V_2 -> V_55 ) ;
F_144 ( & V_236 , V_64 ) ;
if ( F_50 ( & V_236 , & V_2 -> V_63 ) ) {
F_6 ( L_72 , V_2 -> V_56 ) ;
F_98 ( V_235 ) ;
return V_233 ;
}
V_232 = F_141 ( V_235 , & V_236 ) ;
if ( V_232 == NULL ) {
F_6 ( L_73 ,
V_2 -> V_56 , V_64 ) ;
} else {
...
void * F_174 ( int V_264 , int V_271 , int type )
{
struct V_265 * V_267 ;
int V_272 = F_171 ( V_264 ) ;
F_24 ( V_267 , V_272 ) ;
if ( V_267 == NULL )
return F_39 ( - V_38 ) ;
V_267 -> V_268 = V_269 ;
...
inline void F_175 ( void * V_266 , int V_264 )
{
struct V_265 * V_267 = F_172 ( V_266 ) ;
F_32 ( V_267 , F_171 ( V_264 ) ) ;
}
