...
V_35 = ( V_35 + V_41 - 1 ) & V_42 ;
V_36 = F_35 ( V_2 , V_22 , V_35 ) ;
if ( V_36 < 0 )
return V_36 ;
if ( V_22 -> V_43 ) {
V_36 = V_22 -> V_43 ( V_2 , V_22 , V_35 ) ;
if ( V_36 < 0 )
return V_36 ;
}
F_33 ( V_2 -> V_9 , L_3 ,
...
F_16 ( & V_2 -> V_5 ) ;
V_22 = F_30 ( V_2 , V_7 ) ;
if ( V_22 && ( V_22 -> V_28 & V_29 ) && V_22 -> V_34 )
V_51 = V_22 -> V_34 -> V_37 / 1024 ;
F_19 ( & V_2 -> V_5 ) ;
F_11 ( V_2 ) ;
...
V_22 = F_30 ( V_2 , V_7 ) ;
if ( V_22 && ( V_22 -> V_28 & V_29 ) && V_22 -> V_34 )
V_54 = F_32 ( V_2 , V_22 , V_22 -> V_34 , V_51 ) ;
else
V_54 = - V_56 ;
F_19 ( & V_2 -> V_5 ) ;
F_11 ( V_2 ) ;
...
F_16 ( & V_2 -> V_5 ) ;
V_22 = F_31 ( V_2 , V_7 ) ;
if ( V_22 && ( V_22 -> V_28 & V_31 ) && V_22 -> V_34 )
V_51 = V_22 -> V_34 -> V_37 / 1024 ;
F_19 ( & V_2 -> V_5 ) ;
F_11 ( V_2 ) ;
return snprintf ( V_49 , V_41 , L_4 , V_51 ) ;
...
if ( V_86 . V_51 ) {
V_36 = F_32 ( V_2 , V_22 , V_34 , V_86 . V_51 ) ;
if ( V_36 < 0 )
return V_36 ;
}
V_86 . V_51 = V_34 -> V_45 ;
...
V_134 . V_140 = F_79 ( V_34 , V_134 . V_140 ) ;
F_80 ( V_34 , V_134 . V_140 ) ;
if ( F_52 ( V_22 ) &&
V_34 -> V_138 == V_34 -> V_139 ) {
F_55 ( V_2 , V_22 ) ;
}
}
if ( V_134 . V_141 && ( V_22 -> V_28 & V_31 ) ) {
V_134 . V_141 =
F_81 ( V_34 , V_134 . V_141 ) ;
F_82 ( V_34 , V_134 . V_141 ) ;
}
V_142:
V_134 . V_138 = V_34 -> V_138 ;
V_134 . V_136 = V_34 -> V_136 ;
V_134 . V_139 = V_34 -> V_139 ;
V_134 . V_137 = V_34 -> V_137 ;
V_89:
...
V_71 = V_22 -> V_34 -> V_67 ( V_2 , V_22 , V_145 [ 0 ] ) ;
if ( V_71 >= 0 )
V_71 = 1 ;
break;
default:
...
if ( V_71 == 0 )
V_71 = V_22 -> V_194 ( V_2 , V_22 , V_144 , V_145 ) ;
break;
case V_195 :
if ( V_144 -> V_146 != 2 ) {
V_71 = - V_56 ;
...
if ( V_71 )
break;
V_71 = V_22 -> V_199 ( V_2 , V_22 , V_144 , V_145 ) ;
break;
default:
V_71 = - V_56 ;
break;
...
struct V_200 T_3 * V_76 , void * V_91 )
{
struct V_200 V_201 ;
...
int V_15 = 0 ;
int V_71 = 0 ;
if ( F_64 ( & V_201 , V_76 , sizeof( V_201 ) ) )
return - V_79 ;
V_145 = F_91 ( sizeof( unsigned int ) * V_203 , V_65 ) ;
if ( ! V_145 ) {
V_71 = - V_102 ;
goto error;
}
V_202 = F_74 ( V_201 . V_204 , sizeof( * V_202 ) , V_65 ) ;
if ( ! V_202 ) {
V_71 = - V_102 ;
goto error;
}
if ( F_64 ( V_202 , V_201 . V_202 ,
sizeof( * V_202 ) * V_201 . V_204 ) ) {
F_33 ( V_2 -> V_9 , L_19 ) ;
V_71 = - V_79 ;
goto error;
}
for ( V_15 = 0 ; V_15 < V_201 . V_204 ; V_15 ++ ) {
if ( V_202 [ V_15 ] . V_146 > V_203 ) {
F_33 ( V_2 -> V_9 ,
L_20 ) ;
V_71 = - V_56 ;
goto error;
}
if ( V_202 [ V_15 ] . V_144 & V_205 ) {
if ( F_64 ( V_145 , V_202 [ V_15 ] . V_145 ,
V_202 [ V_15 ] . V_146 * sizeof( unsigned int ) ) ) {
F_33 ( V_2 -> V_9 ,
L_19 ) ;
V_71 = - V_79 ;
goto error;
...
V_71 = F_85 ( V_2 , V_202 + V_15 , V_145 , V_91 ) ;
if ( V_71 < 0 )
goto error;
if ( V_202 [ V_15 ] . V_144 & V_206 ) {
if ( F_68 ( V_202 [ V_15 ] . V_145 , V_145 ,
V_202 [ V_15 ] . V_146 * sizeof( unsigned int ) ) ) {
F_33 ( V_2 -> V_9 ,
L_21 ) ;
V_71 = - V_79 ;
...
struct V_207 T_3 * V_76 , void * V_91 )
{
struct V_207 V_68 ;
struct V_21 * V_22 ;
struct V_33 * V_34 ;
...
V_208 = ( unsigned int T_3 * ) V_68 . V_69 ;
if ( V_68 . V_129 >= V_2 -> V_73 ) {
F_33 ( V_2 -> V_9 , L_23 , V_68 . V_129 ) ;
return - V_52 ;
}
V_22 = & V_2 -> V_74 [ V_68 . V_129 ] ;
V_34 = V_22 -> V_34 ;
if ( V_22 -> type == V_188 ) {
F_33 ( V_2 -> V_9 , L_24 , V_68 . V_129 ) ;
return - V_189 ;
}
if ( ! V_22 -> V_121 || ! V_22 -> V_209 || ! V_22 -> V_34 ) {
F_33 ( V_2 -> V_9 ,
L_25 , V_68 . V_129 ) ;
return - V_189 ;
}
...
V_34 -> V_68 = V_68 ;
V_34 -> V_68 . V_145 = NULL ;
V_34 -> V_68 . V_69 = F_96 ( V_208 ,
V_34 -> V_68 . V_210 * sizeof( int ) ) ;
if ( F_97 ( V_34 -> V_68 . V_69 ) ) {
V_71 = F_98 ( V_34 -> V_68 . V_69 ) ;
V_34 -> V_68 . V_69 = NULL ;
F_33 ( V_2 -> V_9 , L_30 ,
V_71 ) ;
goto V_211;
...
V_71 = V_22 -> V_209 ( V_2 , V_22 , & V_34 -> V_68 ) ;
if ( V_34 -> V_68 . V_59 & V_212 || V_71 ) {
F_33 ( V_2 -> V_9 , L_32 , V_71 ) ;
V_68 = V_34 -> V_68 ;
V_68 . V_69 = ( unsigned int V_213 * ) V_208 ;
V_68 . V_145 = NULL ;
...
static int F_100 ( struct V_1 * V_2 , unsigned int V_76 ,
void * V_91 )
{
int V_71 = 0 ;
unsigned long V_59 ;
...
static int F_101 ( struct V_1 * V_2 , unsigned int V_76 ,
void * V_91 )
{
struct V_21 * V_22 ;
if ( V_76 >= V_2 -> V_73 )
...
return - V_40 ;
if ( V_22 -> V_221 )
return V_22 -> V_221 ( V_2 , V_22 ) ;
return - V_56 ;
}
static long F_104 ( struct V_91 * V_91 , unsigned int V_68 ,
unsigned long V_76 )
{
const unsigned V_7 = F_70 ( F_71 ( V_91 ) ) ;
struct V_1 * V_2 = V_91 -> V_222 ;
int V_223 ;
F_16 ( & V_2 -> V_5 ) ;
if ( V_68 == V_224 ) {
if ( V_7 >= V_23 ) {
...
break;
case V_228 :
V_223 = F_69 ( V_2 , (struct V_90 T_3 * ) V_76 ,
V_91 ) ;
break;
case V_229 :
V_223 = F_73 ( V_2 ,
...
break;
case V_230 :
V_223 = F_76 ( V_2 , ( void T_3 * ) V_76 ) ;
break;
case V_231 :
V_223 = F_105 ( V_2 , ( void T_3 * ) V_76 ) ;
break;
case V_232 :
V_223 = F_78 ( V_2 ,
...
break;
case V_233 :
V_223 = F_100 ( V_2 , V_76 , V_91 ) ;
break;
case V_234 :
V_223 = F_101 ( V_2 , V_76 , V_91 ) ;
break;
case V_235 :
V_223 = F_102 ( V_2 , V_76 , V_91 ) ;
break;
case V_236 :
V_223 = F_95 ( V_2 , (struct V_207 T_3 * ) V_76 , V_91 ) ;
break;
case V_237 :
V_223 = F_99 ( V_2 , (struct V_207 T_3 * ) V_76 ,
V_91 ) ;
break;
case V_238 :
V_223 = F_90 ( V_2 ,
(struct V_200 T_3 * ) V_76 ,
V_91 ) ;
break;
case V_239 :
V_223 = F_94 ( V_2 , (struct V_143 T_3 * ) V_76 ,
V_91 ) ;
break;
case V_240 :
V_223 = F_103 ( V_2 , V_76 , V_91 ) ;
break;
default:
V_223 = - V_225 ;
break;
...
static void F_106 ( struct V_241 * V_242 )
{
struct V_243 * V_244 ;
V_244 = V_242 -> V_245 ;
F_107 ( V_244 ) ;
}
static void F_108 ( struct V_241 * V_242 )
{
struct V_243 * V_244 ;
V_244 = V_242 -> V_245 ;
F_109 ( V_244 ) ;
}
static int F_110 ( struct V_91 * V_91 , struct V_241 * V_246 )
{
const unsigned V_7 = F_70 ( F_71 ( V_91 ) ) ;
struct V_1 * V_2 = V_91 -> V_222 ;
struct V_21 * V_22 ;
struct V_33 * V_34 ;
struct V_243 * V_244 ;
unsigned long V_247 = V_246 -> V_248 ;
unsigned long V_51 ;
int V_249 ;
int V_15 ;
int V_36 ;
...
V_249 = V_51 >> V_254 ;
V_244 = V_34 -> V_255 ;
if ( ! V_244 || V_249 > V_244 -> V_249 ) {
V_36 = - V_56 ;
goto V_226;
}
for ( V_15 = 0 ; V_15 < V_249 ; ++ V_15 ) {
struct V_256 * V_49 = & V_244 -> V_257 [ V_15 ] ;
if ( F_111 ( V_246 , V_247 ,
F_112 ( F_113 ( V_49 -> V_258 ) ) ,
V_41 , V_259 ) ) {
V_36 = - V_186 ;
goto V_226;
}
...
V_246 -> V_260 = & V_261 ;
V_246 -> V_245 = V_244 ;
V_246 -> V_260 -> V_262 ( V_246 ) ;
V_36 = 0 ;
V_226:
F_19 ( & V_2 -> V_5 ) ;
return V_36 ;
}
static unsigned int F_114 ( struct V_91 * V_91 , T_4 * V_263 )
{
unsigned int V_57 = 0 ;
const unsigned V_7 = F_70 ( F_71 ( V_91 ) ) ;
struct V_1 * V_2 = V_91 -> V_222 ;
...
V_22 = F_30 ( V_2 , V_7 ) ;
if ( V_22 && V_22 -> V_34 ) {
F_115 ( V_91 , & V_22 -> V_34 -> V_70 , V_263 ) ;
...
V_22 = F_31 ( V_2 , V_7 ) ;
if ( V_22 && V_22 -> V_34 ) {
unsigned int V_266 = F_117 ( V_22 -> V_34 -> V_87 ) ;
F_115 ( V_91 , & V_22 -> V_34 -> V_70 , V_263 ) ;
F_81 ( V_22 -> V_34 , V_22 -> V_34 -> V_45 ) ;
if ( ! V_22 -> V_39 || ! F_50 ( V_22 ) ||
F_118 ( V_22 -> V_34 ) >= V_266 )
V_57 |= V_267 | V_268 ;
}
V_226:
F_19 ( & V_2 -> V_5 ) ;
...
static T_1 F_119 ( struct V_91 * V_91 , const char T_3 * V_49 ,
T_2 V_269 , T_5 * V_270 )
{
struct V_21 * V_22 ;
struct V_33 * V_34 ;
...
V_146 = V_269 ;
V_271 = V_146 ;
if ( V_34 -> V_136 + V_271 > V_34 -> V_45 )
V_271 = V_34 -> V_45 - V_34 -> V_136 ;
F_81 ( V_34 , V_34 -> V_45 ) ;
if ( V_271 > F_118 ( V_34 ) )
V_271 = F_118 ( V_34 ) ;
if ( V_271 < V_146 )
...
V_271 = F_64 ( V_34 -> V_283 + V_34 -> V_136 ,
V_49 , V_146 ) ;
if ( V_271 ) {
V_146 -= V_271 ;
V_36 = - V_79 ;
...
static T_1 F_127 ( struct V_91 * V_91 , char T_3 * V_49 , T_2 V_269 ,
T_5 * V_270 )
{
struct V_21 * V_22 ;
struct V_33 * V_34 ;
...
V_146 = V_269 ;
V_271 = F_116 ( V_34 ) ;
if ( V_34 -> V_137 + V_271 > V_34 -> V_45 )
V_271 = V_34 -> V_45 - V_34 -> V_137 ;
if ( V_271 < V_146 )
V_146 = V_271 ;
if ( V_146 == 0 ) {
if ( ! F_50 ( V_22 ) ) {
...
static int F_128 ( struct V_286 * V_286 , struct V_91 * V_91 )
{
...
#ifdef F_130
F_19 ( & V_2 -> V_5 ) ;
F_131 ( L_41 , V_20 , V_2 -> V_7 ) ;
F_16 ( & V_2 -> V_5 ) ;
#endif
V_2 -> V_289 = false ;
if ( ! V_2 -> V_12 && ! F_63 ( V_288 ) ) {
F_33 ( V_2 -> V_9 , L_42 ) ;
V_223 = - V_52 ;
goto V_187;
}
...
static int F_133 ( int V_291 , struct V_91 * V_91 , int V_292 )
{
struct V_1 * V_2 = V_91 -> V_222 ;
return F_134 ( V_291 , V_91 , V_292 , & V_2 -> V_293 ) ;
}
static int F_135 ( struct V_286 * V_286 , struct V_91 * V_91 )
{
struct V_1 * V_2 = V_91 -> V_222 ;
...
void F_136 ( const struct V_1 * V_2 , const char * V_22 )
{
F_58 ( V_2 -> V_9 , L_43 , V_2 -> V_13 -> V_96 , V_22 ) ;
}
void F_137 ( struct V_1 * V_2 , struct V_21 * V_22 )
{
struct V_33 * V_34 = V_22 -> V_34 ;
unsigned V_61 = 0 ;
unsigned V_295 = 0 ;
...
return;
if ( V_22 ->
V_34 -> V_296 & ( V_215 | V_217 |
V_218 ) ) {
V_295 |= V_62 ;
}
if ( V_22 -> V_34 -> V_296 & ( V_217 | V_218 ) ) {
V_295 |= V_63 ;
V_61 |= V_63 ;
}
if ( V_295 ) {
F_46 ( V_22 , V_295 , V_61 ) ;
}
if ( V_34 -> V_214 & V_22 -> V_34 -> V_296 ) {
F_138 ( & V_34 -> V_70 ) ;
if ( V_22 -> V_28 & V_29 )
F_139 ( & V_2 -> V_293 , V_297 , V_298 ) ;
if ( V_22 -> V_28 & V_31 )
F_139 ( & V_2 -> V_293 , V_297 , V_299 ) ;
}
V_22 -> V_34 -> V_296 = 0 ;
}
struct V_1 * F_140 ( struct V_27 * V_300 )
{
struct V_1 * V_2 ;
struct V_27 * V_46 ;
unsigned V_15 ;
...
V_2 -> V_7 = V_15 ;
V_46 = F_144 ( V_19 , V_300 ,
F_24 ( V_20 , V_15 ) , NULL , L_45 , V_15 ) ;
if ( ! F_97 ( V_46 ) )
V_2 -> V_9 = F_145 ( V_46 ) ;
return V_2 ;
}
static void F_146 ( unsigned V_7 )
{
F_26 ( V_7 >= V_23 ) ;
F_22 ( F_21 ( V_7 ) ) ;
}
void F_147 ( struct V_27 * V_300 )
{
int V_7 ;
struct V_1 * V_2 ;
...
V_15 += V_23 ;
V_22 -> V_7 = V_15 ;
V_46 = F_144 ( V_19 , V_2 -> V_9 ,
F_24 ( V_20 , V_15 ) , NULL , L_47 ,
V_2 -> V_7 , V_22 -> V_44 ) ;
if ( ! F_97 ( V_46 ) )
V_22 -> V_9 = V_46 ;
return 0 ;
...
V_36 = F_153 ( F_24 ( V_20 , 0 ) ,
V_302 , L_51 ) ;
if ( V_36 )
return - V_189 ;
F_154 ( & V_304 , & V_305 ) ;
V_304 . V_306 = V_307 ;
F_155 ( & V_304 . V_308 , L_51 ) ;
if ( F_156 ( & V_304 , F_24 ( V_20 , 0 ) , V_302 ) ) {
F_157 ( F_24 ( V_20 , 0 ) ,
V_302 ) ;
return - V_189 ;
}
V_19 = F_158 ( V_307 , L_51 ) ;
if ( F_97 ( V_19 ) ) {
F_143 ( L_52 ) ;
F_159 ( & V_304 ) ;
F_157 ( F_24 ( V_20 , 0 ) ,
