...
{
int V_2 ;
if ( F_11 ( V_21 , & V_8 -> V_22 ) )
return;
V_2 = F_7 ( V_8 ) ? V_23 : V_24 ;
F_4 ( V_8 , V_2 , 0 ) ;
}
...
void F_53 ( void )
{
F_4 ( V_20 + F_52 () , V_77 , 0 ) ;
for (; ; ) ;
}
static void F_54 ( void )
{
unsigned long V_85 ;
V_85 = F_55 ( & V_20 [ F_52 () ] . V_22 , 0 ) ;
if ( F_56 ( V_82 , & V_85 ) )
F_53 () ;
if ( F_56 ( V_86 , & V_85 ) )
F_57 () ;
...
static void F_59 ( struct V_88 V_88 ,
unsigned int V_89 , unsigned long V_90 )
{
F_60 ( V_88 . V_91 == 0x1202 ? V_92 : V_93 ) ;
F_54 () ;
}
...
void F_71 ( int V_98 , int V_101 )
{
struct V_95 V_102 = { 0 , ~ ( 1UL << V_101 ) , V_98 } ;
F_66 ( F_68 , & V_102 , 1 ) ;
}
static void T_7 F_72 ( int V_19 , T_1 V_10 )
{
...
F_78 ( V_103 , V_26 + V_108 , sizeof( * V_103 ) ) ;
}
int F_79 ( int V_19 )
{
struct V_8 * V_8 ;
...
static struct V_114 * F_82 ( void )
{
static int V_115 ;
struct V_114 * V_94 ;
int V_10 ;
V_94 = F_83 ( sizeof( * V_94 ) , V_28 ) ;
if ( V_94 && ( V_115 || F_84 ( V_94 ) ) ) {
V_115 = 1 ;
...
static int F_85 ( struct V_114 * V_94 , int V_120 )
{
struct V_8 * V_8 ;
T_5 V_121 ;
int V_19 , V_122 , V_123 ;
V_122 = 0 ;
F_86 ( & V_121 , V_124 , V_125 ) ;
V_19 = F_36 ( & V_121 ) ;
...
F_80 ( V_19 , V_132 ) ;
F_87 ( V_19 , true ) ;
if ( V_120 && F_88 ( V_19 ) != 0 )
F_87 ( V_19 , false ) ;
else
V_122 ++ ;
V_19 = F_89 ( V_19 , & V_121 ) ;
}
return V_122 ;
}
...
continue;
if ( V_19 < V_94 -> V_118 ) {
F_72 ( V_133 , V_94 -> V_19 [ V_19 ] . V_10 ) ;
V_133 ++ ;
} else
V_134 ++ ;
}
F_91 ( L_4 , V_133 , V_134 ) ;
F_92 () ;
F_85 ( V_94 , 0 ) ;
F_93 () ;
F_94 ( V_94 ) ;
...
int F_106 ( unsigned int V_19 , struct V_61 * V_140 )
{
struct V_8 * V_8 ;
int V_141 ;
V_8 = V_20 + V_19 ;
...
static int T_7 F_108 ( char * V_143 )
{
F_109 ( & V_143 , & V_144 ) ;
return 0 ;
}
...
void T_7 F_118 ( unsigned int V_147 )
{
if ( F_119 ( 0x1201 , F_59 ) != 0 )
F_75 ( L_5 ) ;
if ( F_119 ( 0x1202 , F_59 ) != 0 )
F_75 ( L_6 ) ;
F_90 () ;
}
void T_7 F_120 ( void )
...
V_8 -> V_129 = V_131 ;
V_8 -> V_10 = V_105 ;
V_8 -> V_27 = (struct V_25 * ) ( unsigned long ) F_121 () ;
...
void T_7 F_122 ( unsigned int V_147 )
{
}
void T_7 F_123 ( void )
{
...
int F_124 ( unsigned int V_148 )
{
return 0 ;
}
static T_9 F_125 ( struct V_149 * V_150 ,
...
static T_9 F_128 ( struct V_149 * V_150 ,
struct V_151 * V_152 ,
...
struct V_151 * V_152 , char * V_153 )
{
struct V_160 * V_161 = & F_134 ( V_162 , V_150 -> V_156 ) ;
unsigned long long V_163 ;
unsigned int V_164 ;
do {
V_164 = F_135 ( V_161 -> V_164 ) ;
V_163 = F_135 ( V_161 -> V_163 ) ;
if ( F_135 ( V_161 -> V_165 ) )
V_163 ++ ;
} while ( ( V_164 & 1 ) || ( F_135 ( V_161 -> V_164 ) != V_164 ) );
return sprintf ( V_153 , L_9 , V_163 ) ;
}
static T_9 F_136 ( struct V_149 * V_150 ,
struct V_151 * V_152 , char * V_153 )
{
struct V_160 * V_161 = & F_134 ( V_162 , V_150 -> V_156 ) ;
...
V_166 = F_44 () ;
V_164 = F_135 ( V_161 -> V_164 ) ;
V_167 = F_135 ( V_161 -> V_167 ) ;
V_168 = F_135 ( V_161 -> V_165 ) ;
V_169 = F_135 ( V_161 -> V_170 ) ;
} while ( ( V_164 & 1 ) || ( F_135 ( V_161 -> V_164 ) != V_164 ) );
V_167 += V_168 ? ( ( V_169 ? : V_166 ) - V_168 ) : 0 ;
return sprintf ( V_153 , L_9 , V_167 >> 12 ) ;
}
static int F_137 ( struct V_171 * V_172 , unsigned long V_173 ,
void * V_174 )
{
...
switch ( V_173 & ~ V_177 ) {
case V_178 :
V_176 = F_138 ( & V_143 -> V_179 , & V_180 ) ;
break;
case V_181 :
F_139 ( & V_143 -> V_179 , & V_180 ) ;
break;
}
return F_140 ( V_176 ) ;
}
...
struct V_19 * V_175 ;
int V_141 ;
V_175 = F_83 ( sizeof( * V_175 ) , V_28 ) ;
if ( ! V_175 )
return - V_45 ;
V_20 [ V_19 ] . V_19 = V_175 ;
V_143 = & V_175 -> V_150 ;
V_175 -> V_182 = 1 ;
V_141 = F_141 ( V_175 , V_19 ) ;
if ( V_141 )
goto V_34;
V_141 = F_138 ( & V_143 -> V_179 , & V_183 ) ;
if ( V_141 )
goto V_184;
if ( F_107 ( V_19 ) ) {
V_141 = F_138 ( & V_143 -> V_179 , & V_180 ) ;
if ( V_141 )
goto V_185;
}
V_141 = F_142 ( V_175 ) ;
...
static T_9 T_11 F_147 ( struct V_149 * V_150 ,
struct V_151 * V_152 ,
const char * V_153 ,
T_10 V_154 )
{
