...
goto V_63;
V_62:
V_58 = F_29 ( V_53 ) -> V_58 | F_29 ( V_53 ) -> V_64 ;
V_58 |= ( V_36 int ) ( V_55 & V_65 ) ;
V_58 |= ( V_36 int ) ( ( V_55 ^ F_28 ( V_54 ) ) &
~ ( V_65 | V_66 | V_67 ) ) ;
V_58 |= ( V_36 int ) ( V_8 -> V_68 ^ V_54 -> V_68 ) ;
for ( V_59 = sizeof( * V_8 ) ; V_59 < V_9 ; V_59 += 4 )
V_58 |= * ( V_38 * ) ( ( V_69 * ) V_8 + V_59 ) ^
* ( V_38 * ) ( ( V_69 * ) V_54 + V_59 ) ;
V_13 = F_6 ( V_53 ) ;
V_58 |= ( V_21 - 1 ) >= V_13 ;
...
V_53 = * V_51 ;
V_54 = F_4 ( V_53 ) ;
F_28 ( V_54 ) |= V_55 & ( V_66 | V_67 ) ;
V_63:
V_58 = V_21 < V_13 ;
V_58 |= ( V_36 int ) ( V_55 & ( V_70 | V_67 |
V_71 | V_72 |
V_66 ) ) ;
if ( V_53 && ( ! F_29 ( V_2 ) -> V_60 || V_58 ) )
V_52 = V_51 ;
V_18:
F_29 ( V_2 ) -> V_58 |= ( V_58 != 0 ) ;
return V_52 ;
}
int F_31 ( struct V_1 * V_2 )
{
struct V_7 * V_8 = F_4 ( V_2 ) ;
V_2 -> V_73 = ( unsigned char * ) V_8 - V_2 -> V_51 ;
V_2 -> V_74 = F_32 ( struct V_7 , V_39 ) ;
V_2 -> V_42 = V_43 ;
F_9 ( V_2 ) -> V_33 = F_29 ( V_2 ) -> V_75 ;
if ( V_8 -> V_48 )
F_9 ( V_2 ) -> V_23 |= V_26 ;
return 0 ;
}
...
V_8 -> V_39 = 0 ;
V_2 -> V_42 = V_43 ;
F_35 ( V_2 , V_77 -> V_78 , V_77 -> V_79 ) ;
return 0 ;
}
static struct V_1 * * F_36 ( struct V_1 * * V_51 , struct V_1 * V_2 )
{
const struct V_76 * V_77 = F_37 ( V_2 ) ;
V_37 V_80 ;
if ( F_29 ( V_2 ) -> V_58 )
goto V_81;
V_80 = F_29 ( V_2 ) -> V_44 ;
switch ( V_2 -> V_42 ) {
case V_82 :
V_80 = F_38 ( V_2 , F_22 ( V_2 ) , F_27 ( V_2 ) ,
0 ) ;
case V_83 :
if ( ! F_39 ( F_27 ( V_2 ) , V_77 -> V_78 , V_77 -> V_79 ,
V_80 ) ) {
V_2 -> V_42 = V_84 ;
break;
}
...
{
const struct V_76 * V_77 = F_34 ( V_2 ) ;
struct V_7 * V_8 = F_4 ( V_2 ) ;
V_8 -> V_39 = ~ F_39 ( V_2 -> V_21 - V_85 , V_77 -> V_78 ,
V_77 -> V_79 , 0 ) ;
F_9 ( V_2 ) -> V_23 = V_24 ;
return F_31 ( V_2 ) ;
}
