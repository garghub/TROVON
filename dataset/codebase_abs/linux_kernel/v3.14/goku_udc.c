...
static inline int
F_35 ( T_2 T_1 * V_76 , T_5 * V_77 , struct V_67 * V_68 , unsigned V_14 )
{
unsigned V_74 , V_78 ;
V_74 = F_36 ( V_68 -> V_68 . V_74 - V_68 -> V_68 . V_73 , V_14 ) ;
V_68 -> V_68 . V_73 += V_74 ;
V_78 = V_74 ;
while ( F_30 ( V_78 -- ) )
F_2 ( * V_77 ++ , V_76 ) ;
...
static int F_37 ( struct V_11 * V_12 , struct V_67 * V_68 )
{
struct V_9 * V_10 = V_12 -> V_10 ;
T_2 V_39 ;
T_5 * V_77 ;
...
F_38 ( V_77 ) ;
V_10 = V_12 -> V_10 ;
if ( F_39 ( V_12 -> V_24 == 0 && V_10 -> V_63 != V_81 ) )
return - V_82 ;
if ( F_39 ( ( V_39 & F_40 ( V_12 -> V_24 ) ) != 0 ) )
return 0 ;
if ( V_12 -> V_24 != 0 )
F_2 ( ~ F_16 ( V_12 -> V_24 ) , & V_10 -> V_2 -> V_83 ) ;
V_78 = F_35 ( V_12 -> V_84 , V_77 , V_68 , V_12 -> V_12 . V_44 ) ;
if ( F_39 ( V_78 != V_12 -> V_12 . V_44 ) ) {
...
static int F_41 ( struct V_11 * V_12 , struct V_67 * V_68 )
{
struct V_1 T_1 * V_2 ;
T_2 V_88 , V_89 ;
T_5 * V_77 ;
...
if ( F_39 ( V_91 || V_68 -> V_68 . V_73 == V_68 -> V_68 . V_74 ) ) {
if ( F_39 ( V_12 -> V_24 == 0 ) ) {
if ( V_12 -> V_10 -> V_101 )
F_2 ( V_12 -> V_10 -> V_102
? V_103
...
F_28 ( V_12 , V_68 , 0 ) ;
if ( V_92 && ! F_26 ( & V_12 -> V_69 ) ) {
V_68 = F_44 ( V_12 -> V_69 . V_105 ,
struct V_67 , V_69 ) ;
goto V_93;
}
return 1 ;
...
{
struct V_67 * V_68 ;
if ( F_39 ( F_26 ( & V_12 -> V_69 ) ) )
return;
V_68 = F_44 ( V_12 -> V_69 . V_105 , struct V_67 , V_69 ) ;
( V_12 -> V_32 ? F_37 : F_41 ) ( V_12 , V_68 ) ;
}
static int F_48 ( struct V_11 * V_12 , struct V_67 * V_68 )
{
struct V_1 T_1 * V_2 = V_12 -> V_10 -> V_2 ;
T_2 V_53 ;
...
static void F_49 ( struct V_9 * V_10 , struct V_11 * V_12 )
{
struct V_67 * V_68 ;
struct V_1 T_1 * V_2 = V_12 -> V_10 -> V_2 ;
T_2 V_53 ;
...
static void F_50 ( struct V_11 * V_12 , int V_71 )
{
struct V_1 T_1 * V_2 = V_12 -> V_10 -> V_2 ;
struct V_67 * V_68 ;
T_2 V_121 , V_53 ;
...
V_68 -> V_68 . V_71 = V_71 ;
F_19 ( V_12 -> V_10 , L_18 , V_124 , V_12 -> V_12 . V_37 ,
V_12 -> V_32 ? L_3 : L_4 ,
V_68 -> V_68 . V_73 , V_68 -> V_68 . V_74 ) ;
...
static int
F_51 ( struct V_5 * V_6 , struct V_65 * V_70 , T_4 V_66 )
{
struct V_67 * V_68 ;
struct V_11 * V_12 ;
struct V_9 * V_10 ;
...
int V_71 ;
V_68 = F_6 ( V_70 , struct V_67 , V_68 ) ;
if ( F_39 ( ! V_70 || ! V_70 -> V_75
|| ! V_70 -> V_77 || ! F_26 ( & V_68 -> V_69 ) ) )
return - V_18 ;
V_12 = F_6 ( V_6 , struct V_11 , V_12 ) ;
if ( F_39 ( ! V_6 || ( ! V_12 -> V_12 . V_8 && V_12 -> V_24 != 0 ) ) )
return - V_18 ;
V_10 = V_12 -> V_10 ;
if ( F_39 ( ! V_10 -> V_19 || V_10 -> V_20 . V_21 == V_22 ) )
return - V_23 ;
if ( V_10 -> V_63 == V_64 )
return - V_30 ;
if ( V_12 -> V_33 ) {
V_71 = F_52 ( & V_10 -> V_20 , & V_68 -> V_68 ,
V_12 -> V_32 ) ;
if ( V_71 )
return V_71 ;
}
...
V_71 = ( V_12 -> V_32 ? F_37 : F_41 ) ( V_12 , V_68 ) ;
if ( F_39 ( V_71 != 0 ) ) {
if ( V_71 > 0 )
V_71 = 0 ;
V_68 = NULL ;
...
if ( F_30 ( V_68 != NULL ) )
F_53 ( & V_68 -> V_69 , & V_12 -> V_69 ) ;
if ( F_30 ( ! F_26 ( & V_12 -> V_69 ) )
&& F_30 ( V_12 -> V_24 != 0 )
&& ! V_12 -> V_33
&& ! ( V_10 -> V_47 & F_16 ( V_12 -> V_24 ) ) )
F_45 ( V_10 , V_10 -> V_2 , V_12 -> V_24 ) ;
F_14 ( & V_10 -> V_38 , V_15 ) ;
return V_71 ;
}
...
static int F_54 ( struct V_5 * V_6 , struct V_65 * V_70 )
{
struct V_67 * V_68 ;
struct V_11 * V_12 ;
struct V_9 * V_10 ;
...
if ( V_10 -> V_63 == V_64 )
return - V_30 ;
F_19 ( V_10 , L_20 , V_124 , V_6 -> V_37 ,
V_12 -> V_32 ? L_3 : L_4 ,
V_12 -> V_33 ? L_5 : L_6 ,
V_70 ) ;
F_13 ( & V_10 -> V_38 , V_15 ) ;
F_55 (req, &ep->queue, queue) {
if ( & V_68 -> V_68 == V_70 )
break;
}
if ( & V_68 -> V_68 != V_70 ) {
...
if ( F_26 ( & V_12 -> V_69 ) )
return;
V_68 = F_44 ( V_12 -> V_69 . V_105 , struct V_67 ,
V_69 ) ;
( void ) F_48 ( V_12 , V_68 ) ;
} else
F_47 ( V_12 ) ;
...
static int F_57 ( struct V_5 * V_6 , int V_130 )
{
struct V_11 * V_12 ;
unsigned long V_15 ;
int V_131 = 0 ;
...
F_19 ( V_12 -> V_10 , L_24 , V_124 , V_12 -> V_12 . V_37 , V_88 ) ;
return V_88 ;
}
...
return;
V_12 = F_6 ( V_6 , struct V_11 , V_12 ) ;
F_19 ( V_12 -> V_10 , L_25 , V_124 , V_12 -> V_12 . V_37 ) ;
...
static inline const char * F_61 ( void )
{
if ( V_34 == 0 )
return L_26 ;
else if ( V_34 == 2 )
...
static void F_62 ( struct V_138 * V_139 , const char * V_140 , T_2 V_141 )
{
F_63 (m,
...
static int F_64 ( struct V_138 * V_139 , void * V_142 )
{
...
F_62 ( V_139 , L_67 , F_9 ( & V_2 -> V_83 ) ) ;
F_62 ( V_139 , L_68 , F_9 ( & V_2 -> V_47 ) ) ;
...
static int F_68 ( struct V_154 * V_154 , struct V_155 * V_155 )
{
return F_69 ( V_155 , F_64 , F_70 ( F_71 ( V_155 ) ) ) ;
}
...
F_53 ( & V_12 -> V_12 . V_157 , & V_10 -> V_20 . V_157 ) ;
V_12 -> V_10 = V_10 ;
F_23 ( & V_12 -> V_69 ) ;
F_15 ( NULL , V_12 ) ;
}
...
static int F_76 ( struct V_136 * V_181 ,
struct V_182 * V_19 )
{
struct V_9 * V_10 = F_77 ( V_181 ) ;
...
static int F_79 ( struct V_136 * V_181 ,
struct V_182 * V_19 )
{
struct V_9 * V_10 = F_77 ( V_181 ) ;
unsigned long V_15 ;
...
V_185 . V_188 = F_81 ( ( F_9 ( & V_2 -> V_189 ) << 8 )
| F_9 ( & V_2 -> V_190 ) ) ;
V_185 . V_191 = F_81 ( ( F_9 ( & V_2 -> V_192 ) << 8 )
| F_9 ( & V_2 -> V_193 ) ) ;
V_185 . V_194 = F_81 ( ( F_9 ( & V_2 -> V_195 ) << 8 )
| F_9 ( & V_2 -> V_196 ) ) ;
F_2 ( 0 , & V_2 -> V_197 ) ;
F_20 ( & V_10 -> V_12 [ 0 ] , 0 ) ;
V_10 -> V_12 [ 0 ] . V_45 = 0 ;
...
F_82 ( V_185 . V_188 ) , F_82 ( V_185 . V_191 ) ,
F_82 ( V_185 . V_194 ) ) ;
#endif
V_10 -> V_101 = ( V_185 . V_187 == V_208
&& V_185 . V_186 == V_206 ) ;
if ( F_39 ( V_10 -> V_101 ) )
V_10 -> V_102 = ( V_185 . V_188 != F_81 ( 0 ) ) ;
F_33 ( & V_10 -> V_38 ) ;
...
static T_6 F_83 ( int V_210 , void * V_211 )
{
...
static void F_87 ( struct V_226 * V_211 )
{
struct V_9 * V_10 = F_88 ( V_211 ) ;
F_27 ( V_10 ) ;
}
static void F_89 ( struct V_227 * V_228 )
{
struct V_9 * V_10 = F_90 ( V_228 ) ;
F_12 ( V_10 , L_106 , V_124 ) ;
F_91 ( & V_10 -> V_20 ) ;
F_92 ( V_10 -> V_19 ) ;
#ifdef F_93
...
F_109 ( V_228 , V_10 ) ;
F_85 ( V_10 , L_106 , V_246 ) ;
F_85 ( V_10 , L_125 V_247 L_126 , F_61 () ) ;
F_85 ( V_10 , L_127 , V_228 -> V_210 , V_237 ) ;
F_73 ( V_10 ) ;
F_72 ( V_10 ) ;
if ( F_110 ( V_228 -> V_210 , F_83 , V_248 ,
V_244 , V_10 ) != 0 ) {
...
F_111 ( V_228 ) ;
#ifdef F_93
F_112 ( V_229 , 0 , NULL , & V_249 , V_10 ) ;
#endif
V_131 = F_113 ( & V_228 -> V_10 , & V_10 -> V_20 ,
F_87 ) ;
if ( V_131 )
goto V_239;
return 0 ;
