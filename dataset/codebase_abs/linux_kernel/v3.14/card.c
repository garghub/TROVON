...
F_28 ( & V_51 ) ;
F_29 ( & V_5 -> V_52 , & V_53 ) ;
F_29 ( & V_5 -> V_54 , & V_5 -> V_31 -> V_55 ) ;
F_30 ( & V_51 ) ;
F_31 (pos, &card->devices) {
struct V_11 * V_12 = F_32 ( V_42 ) ;
F_33 ( V_12 ) ;
}
F_34 (pos, temp, &pnp_card_drivers) {
struct V_2 * V_3 =
F_35 ( V_42 , struct V_2 ,
V_52 ) ;
F_8 ( V_5 , V_3 ) ;
}
return 0 ;
...
F_38 ( & V_5 -> V_54 ) ;
F_30 ( & V_51 ) ;
F_34 (pos, temp, &card->devices) {
struct V_11 * V_12 = F_32 ( V_42 ) ;
F_39 ( V_12 ) ;
}
}
int F_40 ( struct V_4 * V_5 , struct V_11 * V_12 )
{
...
struct V_11 * F_42 ( struct V_18 * V_19 ,
...
static int F_45 ( struct V_11 * V_12 , T_2 V_61 )
{
...
V_3 -> V_17 . V_20 = NULL ;
V_3 -> V_17 . remove = & F_5 ;
V_3 -> V_17 . V_63 = V_3 -> V_63 ? F_45 : NULL ;
V_3 -> V_17 . V_65 = V_3 -> V_65 ? F_46 : NULL ;
error = F_48 ( & V_3 -> V_17 ) ;
if ( error < 0 )
return error ;
F_28 ( & V_51 ) ;
F_29 ( & V_3 -> V_52 , & V_67 ) ;
F_30 ( & V_51 ) ;
F_34 (pos, temp, &pnp_cards) {
struct V_4 * V_5 =
F_35 ( V_42 , struct V_4 , V_52 ) ;
F_8 ( V_5 , V_3 ) ;
}
return 0 ;
}
