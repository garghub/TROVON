...
V_7 -> V_9 = V_9 ;
V_19 -> V_98 . V_104 = & V_95 -> V_98 ;
V_19 -> V_61 = F_52 ( & V_95 -> V_98 ) ;
V_19 -> V_63 = V_105 ;
V_19 -> V_106 = & V_107 ;
F_10 ( V_19 ) ;
F_3 ( V_7 , V_108 , V_109 ) ;
V_103 = F_37 ( V_19 , V_7 -> V_9 ) ;
if ( V_103 < 0 )
return V_103 ;
V_103 = F_26 ( V_19 ,
& F_17 ,
...
static int F_58 ( struct V_114 * V_98 )
{
struct V_18 * V_19 = F_59 ( V_98 ) ;
struct V_1 * V_7 = F_11 ( V_19 ) ;
struct V_115 * V_116 ;
unsigned int V_117 ;
V_116 = F_50 ( F_60 ( V_98 ) ) ;
if ( ! F_61 ( V_116 -> V_98 ) ) {
V_117 = F_1 ( V_7 , V_32 ) ;
V_117 &= ~ ( V_33 ) ;
F_3 ( V_7 , V_32 , ( V_117 |
...
static int F_62 ( struct V_114 * V_98 )
{
struct V_18 * V_19 = F_59 ( V_98 ) ;
struct V_1 * V_7 = F_11 ( V_19 ) ;
unsigned int V_119 ;
