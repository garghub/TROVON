...
static int F_36 ( struct V_48 * V_49 , unsigned int V_26 ,
T_1 V_1 )
{
unsigned int V_18 = 1 << F_1 ( V_1 ) ;
void T_2 * V_27 = F_4 ( V_1 ) ;
...
if ( V_21 -> V_34 [ V_37 ] )
V_53 -> V_58 [ V_37 ] = F_14 ( V_27 ) ;
if ( V_54 )
V_53 -> V_59 [ V_37 ] = F_14 ( V_23 ) ;
V_27 += V_3 ;
V_23 += V_3 ;
}
F_22 ( V_24 ) ;
...
F_22 ( V_24 ) ;
V_63 = F_14 ( V_23 ) ;
V_63 = ( V_63 & ~ V_54 ) | ( V_53 -> V_59 [ V_37 ] & V_54 ) ;
F_9 ( V_63 , V_23 ) ;
F_23 ( V_24 ) ;
}
V_54 = V_21 -> V_34 [ V_37 ] ;
...
F_22 ( V_24 ) ;
V_63 = F_14 ( V_27 ) ;
V_63 = ( V_63 & ~ V_54 ) | ( V_53 -> V_58 [ V_37 ] & V_54 ) ;
F_9 ( V_63 , V_27 ) ;
F_23 ( V_24 ) ;
}
V_27 += V_3 ;
...
if ( V_71 )
F_51 () ;
V_21 -> V_42 = F_57 ( V_68 , V_21 -> V_40 * 32 ,
& V_74 , V_21 ) ;
if ( F_58 ( ! V_21 -> V_42 ) ) {
F_55 ( L_6 ) ;
return - V_56 ;
