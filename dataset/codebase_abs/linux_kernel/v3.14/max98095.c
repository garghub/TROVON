...
struct V_214 * V_215 ;
int V_123 = 0 ;
V_123 = F_65 ( V_24 , 8 , 8 , V_220 ) ;
if ( V_123 != 0 ) {
F_27 ( V_24 -> V_2 , L_18 , V_123 ) ;
return V_123 ;
}
F_63 ( V_24 ) ;
V_215 = F_60 ( V_24 -> V_2 ) ;
...
V_41 -> V_48 = 0 ;
if ( V_215 -> V_188 ) {
V_123 = F_66 ( V_215 -> V_188 , NULL ,
F_55 ,
V_221 | V_222 ,
L_19 , V_24 ) ;
if ( V_123 ) {
F_27 ( V_24 -> V_2 , L_20 , V_123 ) ;
goto V_223;
}
}
V_123 = F_26 ( V_24 , V_224 ) ;
if ( V_123 < 0 ) {
F_27 ( V_24 -> V_2 , L_21 ,
V_123 ) ;
goto V_225;
}
F_67 ( V_24 -> V_2 , L_22 , V_123 - 0x40 + 'A' ) ;
F_5 ( V_24 , V_218 , V_226 ) ;
F_37 ( V_24 , V_126 ) ;
F_5 ( V_24 , V_227 ,
V_228 | V_229 ) ;
F_5 ( V_24 , V_230 ,
V_231 | V_232 ) ;
F_5 ( V_24 , V_233 , V_234 ) ;
F_5 ( V_24 , V_235 , V_236 ) ;
F_5 ( V_24 , V_237 , V_238 ) ;
F_5 ( V_24 , V_239 ,
V_240 | V_241 ) ;
F_5 ( V_24 , V_242 ,
V_243 | V_241 ) ;
...
V_245 | V_241 ) ;
F_54 ( V_24 ) ;
F_12 ( V_24 , V_218 , V_246 ,
V_246 ) ;
return 0 ;
V_225:
if ( V_215 -> V_188 )
F_68 ( V_215 -> V_188 , V_24 ) ;
V_223:
return V_123 ;
}
...
static int F_70 ( struct V_214 * V_247 ,
const struct V_248 * V_136 )
{
struct V_40 * V_41 ;
int V_123 ;
V_41 = F_71 ( & V_247 -> V_2 , sizeof( struct V_40 ) ,
V_170 ) ;
if ( V_41 == NULL )
return - V_249 ;
V_41 -> V_130 = F_72 ( V_247 , & V_250 ) ;
if ( F_73 ( V_41 -> V_130 ) ) {
V_123 = F_74 ( V_41 -> V_130 ) ;
F_27 ( & V_247 -> V_2 , L_23 , V_123 ) ;
return V_123 ;
}
V_41 -> V_251 = V_136 -> V_252 ;
F_75 ( V_247 , V_41 ) ;
V_41 -> V_135 = V_247 -> V_2 . V_253 ;
V_123 = F_76 ( & V_247 -> V_2 , & V_254 ,
V_255 , F_22 ( V_255 ) ) ;
return V_123 ;
}
static int F_77 ( struct V_214 * V_215 )
{
F_78 ( & V_215 -> V_2 ) ;
return 0 ;
}
