...
static void F_251 ( unsigned int V_43 , unsigned int V_155 , T_8 V_41 )
{
struct V_310 V_276 ;
F_252 ( V_43 , & V_276 ) ;
...
int F_265 ( struct V_331 * V_298 , int V_43 ,
struct V_114 * V_115 )
{
int V_26 ;
if ( ! F_90 ( V_43 ) ) {
...
static int T_1 F_266 ( int V_158 , int V_332 )
{
union V_183 V_184 ;
...
static T_8 T_1 F_268 ( T_8 V_307 )
{
if ( ( V_197 . V_198 == V_199 ) &&
! F_155 ( V_200 [ V_201 ] ) )
return F_266 ( V_34 , V_307 ) ;
else
return V_307 ;
}
static T_8 T_1 F_268 ( T_8 V_307 )
...
F_270 ( V_335 , 256 ) ;
for ( V_14 = 0 ; V_14 < V_34 ; V_14 ++ ) {
F_271 ( F_1 ( V_14 ) , V_335 ) ;
}
if ( ! F_74 ( V_307 , V_335 ) )
return V_307 ;
return F_272 ( V_335 , 256 ) ;
}
static int T_1 F_273 ( int V_158 )
{
union V_324 V_325 ;
unsigned long V_64 ;
F_42 ( & V_65 , V_64 ) ;
...
static struct V_340 * T_1 F_279 ( int V_34 )
{
unsigned long V_341 ;
struct V_340 * V_47 ;
char * V_342 ;
...
V_352:
#endif
V_348 = ( unsigned long ) F_282 ( V_353 ) ;
V_348 = F_283 ( V_348 ) ;
}
F_284 ( V_101 , V_348 ) ;
F_8 ( V_15 , L_83 ,
F_285 ( V_101 ) + ( V_348 & ~ V_354 ) ,
V_348 ) ;
V_101 ++ ;
V_350 -> V_355 = V_348 ;
...
return - 1 ;
V_108 = F_3 ( V_158 ) ;
if ( F_288 ( V_109 > V_108 -> V_360 ) )
return - 1 ;
return V_109 - V_108 -> V_110 ;
}
static T_1 int F_289 ( unsigned long V_361 )
{
if ( V_34 >= V_362 ) {
F_81 ( L_86 ,
V_362 , V_34 ) ;
...
void T_1 F_291 ( int V_307 , T_3 V_361 , T_3 V_110 )
{
int V_101 = 0 ;
int V_326 ;
struct V_6 * V_108 ;
...
F_284 ( V_349 + V_101 , V_361 ) ;
if ( F_290 ( V_101 ) ) {
F_292 ( V_349 + V_101 ) ;
return;
}
V_2 [ V_101 ] . V_3 . V_4 = F_268 ( V_307 ) ;
V_2 [ V_101 ] . V_3 . V_367 = F_273 ( V_101 ) ;
V_326 = F_260 ( V_101 ) ;
V_108 = F_3 ( V_101 ) ;
V_108 -> V_110 = V_110 ;
