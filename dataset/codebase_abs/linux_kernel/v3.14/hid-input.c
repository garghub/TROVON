...
static int F_54 ( struct V_31 * V_32 , unsigned int type ,
...
int V_373 ;
if ( type == V_374 )
return F_55 ( V_32 , type , V_10 , V_14 ) ;
if ( type != V_364 )
return - 1 ;
...
static void F_62 ( struct V_12 * V_5 )
{
...
static struct V_115 * F_63 ( struct V_12 * V_5 )
{
struct V_115 * V_116 = F_64 ( sizeof( * V_116 ) , V_80 ) ;
struct V_31 * V_31 = F_65 () ;
if ( ! V_116 || ! V_31 ) {
F_21 ( V_116 ) ;
F_66 ( V_31 ) ;
F_67 ( V_5 , L_9 ) ;
...
V_31 -> V_32 . V_389 = & V_5 -> V_32 ;
V_116 -> V_117 = V_31 ;
F_69 ( & V_116 -> V_390 , & V_5 -> V_391 ) ;
return V_116 ;
}
...
for ( V_16 = 0 ; V_16 < F_71 ( V_393 ) ; V_16 ++ )
V_392 |= V_116 -> V_117 -> V_130 [ V_16 ] ;
for ( V_16 = 0 ; V_16 < F_71 ( V_394 ) ; V_16 ++ )
V_392 |= V_116 -> V_117 -> V_37 [ V_16 ] ;
for ( V_16 = 0 ; V_16 < F_71 ( V_395 ) ; V_16 ++ )
V_392 |= V_116 -> V_117 -> V_396 [ V_16 ] ;
for ( V_16 = 0 ; V_16 < F_71 ( V_397 ) ; V_16 ++ )
V_392 |= V_116 -> V_117 -> V_351 [ V_16 ] ;
for ( V_16 = 0 ; V_16 < F_71 ( V_398 ) ; V_16 ++ )
V_392 |= V_116 -> V_117 -> V_354 [ V_16 ] ;
for ( V_16 = 0 ; V_16 < F_71 ( V_399 ) ; V_16 ++ )
V_392 |= V_116 -> V_117 -> V_400 [ V_16 ] ;
for ( V_16 = 0 ; V_16 < F_71 ( V_401 ) ; V_16 ++ )
V_392 |= V_116 -> V_117 -> V_402 [ V_16 ] ;
for ( V_16 = 0 ; V_16 < F_71 ( V_403 ) ; V_16 ++ )
V_392 |= V_116 -> V_117 -> V_404 [ V_16 ] ;
for ( V_16 = 0 ; V_16 < F_71 ( V_405 ) ; V_16 ++ )
V_392 |= V_116 -> V_117 -> V_406 [ V_16 ] ;
return ! ! V_392 ;
}
static void F_72 ( struct V_12 * V_5 ,
struct V_115 * V_116 )
{
struct V_19 * V_20 ;
int V_16 , V_18 ;
...
int F_74 ( struct V_12 * V_5 , unsigned int V_408 )
{
struct V_375 * V_376 = V_5 -> V_124 ;
struct V_19 * V_20 ;
...
void F_80 ( struct V_12 * V_5 )
{
struct V_115 * V_116 , * V_420 ;
F_29 ( V_5 ) ;
F_81 (hidinput, next, &hid->inputs, list) {
F_73 ( & V_116 -> V_390 ) ;
F_82 ( V_116 -> V_117 ) ;
F_21 ( V_116 ) ;
}
