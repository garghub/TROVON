...
V_193 = F_92 ( V_181 ) ;
if ( V_193 == 0 ) {
F_12 ( & V_10 -> V_17 -> V_18 , L_17 , V_181 ) ;
return - V_19 ;
}
F_4 ( V_193 , V_1 ) ;
if ( F_2 ( V_1 ) != V_193 ) {
