...
static int F_67 ( struct V_6 * V_7 , int V_110 )
{
...
V_7 -> V_37 , V_5 -> V_19 , V_10 -> V_53 ) ;
F_35 ( V_55 , L_7 , V_56 , 16 , 1 ,
V_5 -> V_11 , F_36 ( F_72 , V_5 -> V_19 ) , true ) ;
#endif
...
static void F_78 ( struct V_28 * V_29 , struct V_4 * V_5 )
{
struct V_67 * V_68 = F_45 ( V_29 ) ;
struct V_6 * V_7 = V_5 -> V_7 ;
if ( V_68 == NULL ) {
...
static int F_81 ( struct V_28 * V_29 , void T_3 * V_130 )
{
struct V_67 * V_68 ;
int V_131 ;
struct V_132 V_133 ;
V_131 = F_82 ( & V_133 , V_130 , sizeof( struct V_132 ) ) ;
if ( V_131 != 0 )
F_18 ( L_29 , V_131 ) ;
if ( V_133 . V_134 < 0 || V_133 . V_134 >= V_135 ||
! V_136 [ V_133 . V_134 ] )
return - V_107 ;
V_68 = F_83 ( sizeof( struct V_67 ) , V_137 ) ;
if ( ! V_68 )
return - V_138 ;
V_68 -> V_69 = 0 ;
...
static const char * F_95 ( unsigned char V_151 )
{
...
static void F_96 ( struct V_154 * V_155 , struct V_1 * V_2 )
{
int V_71 ;
for ( V_71 = 0 ; V_71 < V_156 ; V_71 ++ )
F_97 ( V_155 , L_37 , V_2 -> V_75 [ V_71 ] & 0xff ) ;
F_97 ( V_155 , L_38 ) ;
for ( V_71 = 0 ; V_71 < V_109 ; V_71 ++ )
F_97 ( V_155 , L_37 , V_2 -> V_78 [ V_71 ] & 0xff ) ;
F_97 ( V_155 , L_39 , F_95 ( V_2 -> V_151 ) ,
V_2 -> V_59 & 0xffff ) ;
if ( V_2 -> V_29 )
F_97 ( V_155 , L_40 , V_2 -> V_29 -> V_65 , V_2 -> V_29 -> V_66 ) ;
else
F_97 ( V_155 , L_41 ) ;
if ( V_2 -> V_157 ) {
F_97 ( V_155 , L_42 , V_2 -> V_157 -> V_65 ,
V_2 -> V_157 -> V_66 ) ;
}
F_98 ( V_155 , '\n' ) ;
}
static void * F_99 ( struct V_158 * V_159 , struct V_160 * V_161 ,
T_4 * V_162 )
{
...
V_72 = F_100 ( V_164 , struct V_1 , V_168 ) ;
F_101 (tmp, next) {
if ( -- * V_162 < 0 )
break;
}
...
V_169 = F_99 ( V_159 , & V_10 -> V_173 [ V_170 ] , V_162 ) ;
if ( V_169 )
break;
}
V_159 -> V_171 = V_170 ;
...
V_169 = F_99 ( V_159 , V_174 [ V_177 ] , V_162 ) ;
if ( V_169 )
break;
}
V_159 -> V_178 = V_177 ;
...
break;
case V_191 :
V_189 = F_85 ( V_29 , ( int ) V_130 ) ;
break;
case V_192 :
V_189 = F_81 ( V_29 , ( void T_3 * ) V_130 ) ;
break;
}
return V_189 ;
}
...
unsigned long V_59 ;
struct V_9 * V_10 =
F_100 ( V_243 , struct V_9 , V_211 . V_243 ) ;
struct V_163 * V_168 ;
struct V_1 * V_2 ;
unsigned long V_237 ;
int V_71 ;
...
static void
F_84 ( struct V_9 * V_10 , const struct V_132 * V_133 ,
struct V_28 * V_29 ,
...
static int F_86 ( struct V_9 * V_10 , struct V_28 * V_29 )
{
unsigned long V_59 ;
unsigned char V_75 [] = {
...
static void F_71 ( struct V_9 * V_10 , struct V_28 * V_29 )
{
unsigned long V_59 ;
struct V_163 * V_168 ;
struct V_1 * V_2 ;
