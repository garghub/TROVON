...
static inline bool
F_71 ( const struct V_33 * const V_38 [] )
{
return ! V_38 [ V_108 ] ||
F_72 ( V_38 [ V_108 ] ) != V_24 ;
}
static inline T_4
F_73 ( const struct V_109 * V_110 )
{
return V_110 -> V_111 & V_112 ? 0 : V_113 ;
}
static struct V_109 *
F_74 ( struct V_81 * V_82 , T_4 V_114 , T_4 V_115 , unsigned int V_48 ,
enum V_116 V_117 )
{
struct V_109 * V_110 ;
struct V_118 * V_119 ;
V_110 = F_75 ( V_82 , V_114 , V_115 , V_117 | ( V_12 << 8 ) ,
sizeof( * V_119 ) , V_48 ) ;
if ( V_110 == NULL )
return NULL ;
V_119 = F_76 ( V_110 ) ;
...
static struct V_52 *
F_77 ( struct V_1 * V_79 , const char * V_6 , T_5 * V_47 )
{
...
static inline struct V_52 *
F_78 ( struct V_1 * V_79 , const char * V_6 )
{
T_5 V_47 ;
return F_77 ( V_79 , V_6 , & V_47 ) ;
}
static int
F_79 ( struct V_1 * V_79 , const char * V_6 , T_5 * V_78 ,
struct V_52 * * V_53 )
{
struct V_52 * V_105 ;
T_5 V_103 ;
...
static int
F_80 ( struct V_127 * V_128 , struct V_81 * V_82 ,
...
V_7 = F_72 ( V_129 [ V_137 ] ) ;
V_8 = F_72 ( V_129 [ V_136 ] ) ;
F_12 ( L_18 ,
...
return - V_139 ;
F_83 ( & V_53 -> V_91 ) ;
F_84 ( V_53 -> V_6 , V_6 , V_140 ) ;
V_53 -> V_7 = V_7 ;
V_53 -> V_8 = V_8 ;
V_22 = F_85 ( V_133 , V_7 , V_8 , & ( V_53 -> type ) ) ;
if ( V_22 )
goto V_88;
if ( V_129 [ V_138 ] &&
...
if ( V_22 != 0 )
goto V_142;
V_22 = F_79 ( V_79 , V_53 -> V_6 , & V_78 , & V_131 ) ;
if ( V_22 == - V_125 ) {
if ( ( V_48 & V_113 ) &&
...
static int
F_91 ( struct V_127 * V_128 , struct V_81 * V_82 ,
const struct V_109 * V_110 ,
const struct V_33 * const V_129 [] )
{
struct V_1 * V_79 = F_1 ( F_82 ( V_128 ) ) ;
struct V_52 * V_105 ;
T_5 V_103 ;
int V_22 = 0 ;
if ( F_36 ( F_71 ( V_129 ) ) )
...
V_105 = F_77 ( V_79 , F_41 ( V_129 [ V_134 ] ) ,
& V_103 ) ;
if ( V_105 == NULL ) {
V_22 = - V_150 ;
goto V_88;
...
static int
F_93 ( struct V_127 * V_128 , struct V_81 * V_82 ,
const struct V_109 * V_110 ,
const struct V_33 * const V_129 [] )
{
struct V_1 * V_79 = F_1 ( F_82 ( V_128 ) ) ;
...
V_129 [ V_153 ] == NULL ) )
return - V_40 ;
V_53 = F_78 ( V_79 , F_41 ( V_129 [ V_134 ] ) ) ;
if ( V_53 == NULL )
return - V_150 ;
F_60 ( & V_76 ) ;
if ( V_53 -> V_77 != 0 ) {
...
V_129 [ V_153 ] == NULL ) )
return - V_40 ;
V_156 = F_77 ( V_79 , F_41 ( V_129 [ V_134 ] ) ,
& V_158 ) ;
if ( V_156 == NULL )
return - V_150 ;
V_157 = F_77 ( V_79 , F_41 ( V_129 [ V_153 ] ) ,
& V_159 ) ;
if ( V_157 == NULL )
return - V_155 ;
...
static inline void
F_98 ( struct V_109 * V_110 )
{
const struct V_33 * V_129 ;
int V_167 ;
F_12 ( L_22 ) ;
F_99 (attr, nlh, sizeof(struct nfgenmsg), rem) {
F_12 ( L_23 , V_35 ( V_129 ) , V_129 -> V_168 ) ;
}
}
static int
F_100 ( struct V_162 * V_163 , struct V_1 * V_79 )
{
struct V_109 * V_110 = F_101 ( V_163 -> V_82 ) ;
int V_169 = F_102 ( sizeof( struct V_118 ) ) ;
...
if ( V_170 [ V_134 ] ) {
struct V_52 * V_53 ;
V_53 = F_77 ( V_79 , F_41 ( V_170 [ V_134 ] ) ,
& V_78 ) ;
if ( V_53 == NULL )
return - V_150 ;
V_172 = V_175 ;
...
static int
F_104 ( struct V_81 * V_82 , struct V_162 * V_163 )
{
T_5 V_78 = V_104 , V_21 ;
struct V_52 * V_53 = NULL ;
struct V_109 * V_110 = NULL ;
unsigned int V_48 = F_105 ( V_163 -> V_82 ) . V_114 ? V_180 : 0 ;
struct V_1 * V_79 = F_1 ( F_82 ( V_82 -> V_181 ) ) ;
T_4 V_172 , V_182 ;
int V_22 = 0 ;
if ( ! V_163 -> args [ V_179 ] ) {
V_22 = F_100 ( V_163 , V_79 ) ;
if ( V_22 < 0 ) {
V_110 = F_101 ( V_163 -> V_82 ) ;
if ( V_110 -> V_111 & V_183 )
F_106 ( V_163 -> V_82 , V_110 , V_22 ) ;
return V_22 ;
}
}
if ( V_163 -> args [ V_166 ] >= V_79 -> V_106 )
goto V_88;
V_172 = F_107 ( V_163 -> args [ V_179 ] ) ;
V_182 = F_108 ( V_163 -> args [ V_179 ] ) ;
...
V_110 = F_74 ( V_82 , F_105 ( V_163 -> V_82 ) . V_114 ,
...
if ( F_109 ( V_82 , V_108 , V_24 ) ||
F_110 ( V_82 , V_134 , V_53 -> V_6 ) )
goto V_190;
if ( V_182 & V_191 )
goto V_192;
...
static int
F_112 ( struct V_127 * V_128 , struct V_81 * V_82 ,
const struct V_109 * V_110 ,
const struct V_33 * const V_129 [] )
{
if ( F_36 ( F_71 ( V_129 ) ) )
...
return F_113 ( V_128 , V_82 , V_110 , & V_197 ) ;
}
}
static int
F_114 ( struct V_127 * V_128 , struct V_81 * V_82 , struct V_52 * V_53 ,
...
return 0 ;
if ( V_203 && V_202 ) {
struct V_109 * V_209 , * V_110 = F_101 ( V_82 ) ;
struct V_81 * V_210 ;
struct V_211 * V_212 ;
...
struct V_33 * V_214 ;
T_4 * V_215 ;
V_210 = F_115 ( V_213 , V_31 ) ;
if ( V_210 == NULL )
return - V_139 ;
V_209 = F_116 ( V_210 , F_105 ( V_82 ) . V_114 ,
...
* V_215 = V_203 ;
F_117 ( V_128 , V_210 , F_105 ( V_82 ) . V_114 , V_220 ) ;
return - V_221 ;
}
return V_22 ;
}
static int
F_118 ( struct V_127 * V_128 , struct V_81 * V_82 ,
const struct V_109 * V_110 ,
const struct V_33 * const V_129 [] )
{
struct V_1 * V_79 = F_1 ( F_82 ( V_128 ) ) ;
...
V_53 -> type -> V_224 ) )
return - V_40 ;
V_22 = F_114 ( V_128 , V_82 , V_53 , V_38 , V_96 , V_48 ,
V_202 ) ;
} else {
int V_225 ;
F_119 (nla, attr[IPSET_ATTR_ADT], nla_rem) {
...
V_53 -> type -> V_224 ) )
return - V_40 ;
V_22 = F_114 ( V_128 , V_82 , V_53 , V_38 , V_96 ,
V_48 , V_202 ) ;
if ( V_22 < 0 )
return V_22 ;
}
...
static int
F_120 ( struct V_127 * V_128 , struct V_81 * V_82 ,
const struct V_109 * V_110 ,
const struct V_33 * const V_129 [] )
{
struct V_1 * V_79 = F_1 ( F_82 ( V_128 ) ) ;
...
V_53 -> type -> V_224 ) )
return - V_40 ;
V_22 = F_114 ( V_128 , V_82 , V_53 , V_38 , V_102 , V_48 ,
V_202 ) ;
} else {
int V_225 ;
F_119 (nla, attr[IPSET_ATTR_ADT], nla_rem) {
...
V_53 -> type -> V_224 ) )
return - V_40 ;
V_22 = F_114 ( V_128 , V_82 , V_53 , V_38 , V_102 ,
V_48 , V_202 ) ;
if ( V_22 < 0 )
return V_22 ;
}
...
if ( V_53 == NULL )
return - V_150 ;
V_210 = F_115 ( V_227 , V_31 ) ;
if ( V_210 == NULL )
return - V_139 ;
V_226 = F_74 ( V_210 , F_105 ( V_82 ) . V_114 , V_110 -> V_186 , 0 ,
V_228 ) ;
if ( ! V_226 )
goto V_229;
if ( F_109 ( V_210 , V_108 , V_24 ) ||
F_110 ( V_210 , V_134 , V_53 -> V_6 ) ||
F_110 ( V_210 , V_135 , V_53 -> type -> V_6 ) ||
F_109 ( V_210 , V_137 , V_53 -> V_7 ) ||
F_109 ( V_210 , V_136 , V_53 -> V_8 ) )
goto V_190;
F_111 ( V_210 , V_226 ) ;
V_22 = F_117 ( V_128 , V_210 , F_105 ( V_82 ) . V_114 , V_220 ) ;
if ( V_22 < 0 )
return V_22 ;
return 0 ;
V_190:
...
V_7 = F_72 ( V_129 [ V_137 ] ) ;
V_133 = F_41 ( V_129 [ V_135 ] ) ;
V_22 = F_125 ( V_133 , V_7 , & V_20 , & V_21 ) ;
if ( V_22 )
return V_22 ;
V_210 = F_115 ( V_227 , V_31 ) ;
if ( V_210 == NULL )
...
goto V_229;
if ( F_109 ( V_210 , V_108 , V_24 ) ||
F_110 ( V_210 , V_135 , V_133 ) ||
F_109 ( V_210 , V_137 , V_7 ) ||
F_109 ( V_210 , V_136 , V_21 ) ||
F_109 ( V_210 , V_231 , V_20 ) )
goto V_190;
F_111 ( V_210 , V_226 ) ;
...
static int
F_126 ( struct V_127 * V_128 , struct V_81 * V_82 ,
const struct V_109 * V_110 ,
const struct V_33 * const V_129 [] )
{
struct V_81 * V_210 ;
...
static int
F_127 ( struct V_127 * V_181 , int V_233 , void T_6 * V_234 , int * V_54 )
{
unsigned int * V_235 ;
void * V_236 ;
int V_237 = * V_54 , V_22 = 0 ;
struct V_2 * V_2 = F_82 ( V_181 ) ;
struct V_1 * V_79 = F_1 ( V_2 ) ;
if ( ! F_128 ( V_2 -> V_238 , V_239 ) )
return - V_240 ;
if ( V_233 != V_241 )
return - V_242 ;
...
F_33 ( F_135 ( V_79 -> V_80 , 1 ) ) ;
}
static int T_9
F_136 ( void )
{
int V_22 = F_137 ( & V_257 ) ;
if ( V_22 != 0 ) {
F_138 ( L_31 ) ;
return V_22 ;
}
