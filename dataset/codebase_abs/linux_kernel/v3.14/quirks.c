...
{
F_26 ( V_2 , 0xE0 , 64 , V_44 , L_13 ) ;
F_26 ( V_2 , 0xE2 , 32 , V_44 + 1 , L_14 ) ;
}
static void F_34 ( struct V_1 * V_2 , const char * V_37 , unsigned int V_34 , unsigned int V_45 )
{
T_1 V_46 ;
T_1 V_47 , V_35 , V_48 ;
F_10 ( V_2 , V_34 , & V_46 ) ;
...
V_35 = 16 ;
for (; ; ) {
unsigned V_49 = V_35 >> 1 ;
if ( ( V_49 & V_47 ) == V_49 )
break;
V_35 = V_49 ;
}
V_48 &= - V_35 ;
F_6 ( & V_2 -> V_2 , L_15 , V_37 , V_48 , V_48 + V_35 - 1 ) ;
}
static void F_35 ( struct V_1 * V_2 , const char * V_37 , unsigned int V_34 , unsigned int V_45 )
{
T_1 V_46 ;
T_1 V_47 , V_35 , V_48 ;
F_10 ( V_2 , V_34 , & V_46 ) ;
...
V_48 &= - V_35 ;
F_6 ( & V_2 -> V_2 , L_16 , V_37 , V_48 , V_48 + V_35 - 1 ) ;
}
static void F_36 ( struct V_1 * V_2 )
{
T_1 V_50 ;
F_26 ( V_2 , 0x40 , 64 , V_44 , L_17 ) ;
F_26 ( V_2 , 0x90 , 16 , V_44 + 1 , L_18 ) ;
F_10 ( V_2 , 0x5c , & V_50 ) ;
...
F_5 ( V_2 , V_51 , & V_45 ) ;
if ( V_45 & V_52 )
F_26 ( V_2 , V_53 , 128 , V_44 ,
L_27 ) ;
F_5 ( V_2 , V_54 , & V_45 ) ;
if ( V_45 & V_55 )
F_26 ( V_2 , V_56 , 64 , V_44 + 1 ,
L_28 ) ;
}
...
F_5 ( V_2 , V_58 , & V_45 ) ;
if ( V_45 & V_59 )
F_26 ( V_2 , V_60 , 64 , V_44 + 1 ,
L_30 ) ;
}
static void F_39 ( struct V_1 * V_2 , unsigned V_61 , const char * V_37 , int V_62 )
{
T_1 V_63 ;
T_1 V_35 , V_48 ;
F_10 ( V_2 , V_61 , & V_63 ) ;
...
static void F_41 ( struct V_1 * V_2 , unsigned V_61 , const char * V_37 )
{
T_1 V_63 ;
T_1 V_47 , V_48 ;
F_10 ( V_2 , V_61 , & V_63 ) ;
...
V_47 = ( V_63 >> 16 ) & 0xfc ;
V_47 |= 3 ;
F_6 ( & V_2 -> V_2 , L_33 , V_37 , V_48 , V_47 ) ;
}
...
{
if ( V_2 -> V_22 & 0x10 )
F_26 ( V_2 , 0x48 , 256 , V_44 ,
L_38 ) ;
}
static void F_44 ( struct V_1 * V_2 )
{
F_43 ( V_2 ) ;
F_26 ( V_2 , 0x70 , 128 , V_44 + 1 ,
L_39 ) ;
F_26 ( V_2 , 0x90 , 16 , V_44 + 2 , L_40 ) ;
}
static void F_45 ( struct V_1 * V_2 )
{
F_26 ( V_2 , 0x88 , 128 , V_44 , L_41 ) ;
F_26 ( V_2 , 0xd0 , 16 , V_44 + 1 , L_42 ) ;
}
...
if ( ! V_87 || V_87 > 15 )
return;
if ( V_2 -> V_43 -> V_72 != 0 || F_58 ( V_2 -> V_71 ) > V_80 ||
F_58 ( V_2 -> V_71 ) < V_79 )
return;
F_5 ( V_2 , V_88 , & V_77 ) ;
if ( V_87 != V_77 ) {
...
if ( V_61 & 2 ) {
V_61 &= ~ 2 ;
F_6 ( & V_2 -> V_2 , L_55 , V_61 ) ;
F_7 ( V_2 , 0x41 , V_61 ) ;
}
}
static void F_68 ( struct V_1 * V_64 )
{
T_2 V_93 ;
if ( V_64 -> V_22 != 0x04 )
return;
...
static void F_70 ( struct V_1 * V_64 )
{
T_3 V_97 ;
F_5 ( V_64 , V_98 , & V_97 ) ;
if ( V_97 & 5 ) {
...
static void F_71 ( struct V_1 * V_64 )
{
T_3 V_97 ;
F_5 ( V_64 , V_98 , & V_97 ) ;
...
static void F_72 ( struct V_1 * V_64 )
{
V_64 -> V_99 |= V_100 ;
}
...
F_27 ( V_2 , 0xF2 , & V_63 ) ;
if ( V_63 & 0x8 ) {
F_49 ( V_2 , 0xF2 , V_63 & ( ~ 0x8 ) ) ;
F_27 ( V_2 , 0xF2 , & V_63 ) ;
if ( V_63 & 0x8 )
F_6 ( & V_2 -> V_2 , L_59 , V_63 ) ;
else
F_6 ( & V_2 -> V_2 , L_60 ) ;
}
}
...
if ( F_77 ( ! V_106 || ! V_123 ) )
return;
V_63 = F_82 ( V_123 + 0x3418 ) ;
F_83 ( V_63 & 0xFFFFFFF7 , V_123 + 0x3418 ) ;
}
...
F_5 ( V_2 , 0x50 , & V_63 ) ;
if ( V_63 & 0xc0 ) {
F_7 ( V_2 , 0x50 , V_63 & ( ~ 0xc0 ) ) ;
F_5 ( V_2 , 0x50 , & V_63 ) ;
if ( V_63 & 0xc0 )
F_6 ( & V_2 -> V_2 , L_63 , V_63 ) ;
else
F_6 ( & V_2 -> V_2 , L_64 ) ;
}
}
static void F_90 ( struct V_1 * V_64 )
{
T_1 V_127 , V_128 , V_95 ;
T_3 V_129 ;
if ( F_91 ( V_64 -> V_71 ) )
return;
F_10 ( V_64 , 0x40 , & V_127 ) ;
F_10 ( V_64 , 0x80 , & V_128 ) ;
V_127 &= ~ 0x00CFF302 ;
V_128 &= ~ ( 1 << 24 ) ;
switch ( V_64 -> V_78 ) {
case V_130 :
...
F_63 ( V_64 , 0x40 , V_127 ) ;
F_63 ( V_64 , 0x80 , V_128 ) ;
F_5 ( V_64 , V_139 , & V_129 ) ;
V_64 -> V_140 = V_129 & 0x7f ;
V_64 -> V_141 = ! ! ( V_129 & 0x80 ) ;
F_10 ( V_64 , V_142 , & V_95 ) ;
V_64 -> V_95 = V_95 >> 8 ;
}
static void F_92 ( struct V_1 * V_64 )
{
int V_143 ;
if ( ( V_64 -> V_95 >> 8 ) != 0xff00 )
return;
if ( F_93 ( V_64 , 0 ) && F_25 ( V_64 , 0 ) )
F_94 ( & V_144 , & V_64 -> V_29 [ 0 ] ) ;
for ( V_143 = 1 ; V_143 < 6 ; V_143 ++ ) {
memset ( & V_64 -> V_29 [ V_143 ] , 0 , sizeof( V_64 -> V_29 [ V_143 ] ) ) ;
}
}
static void F_95 ( struct V_1 * V_64 )
{
F_96 ( V_64 ) ;
V_64 -> V_145 = 1 ;
}
...
{
T_3 V_61 ;
if ( F_5 ( V_2 , 0xF4 , & V_61 ) == 0 && ! ( V_61 & 0x02 ) ) {
F_6 ( & V_2 -> V_2 , L_83 ) ;
F_7 ( V_2 , 0xF4 , V_61 | 0x02 ) ;
}
}
...
{
struct V_1 * V_202 ;
V_202 = F_129 ( V_201 -> V_43 , F_130 ( 1 , 0 ) ) ;
if ( V_202 ) {
...
if ( ! V_2 -> V_74 )
return;
V_64 = F_129 ( V_2 -> V_43 , 0 ) ;
if ( ! V_64 )
return;
if ( ! F_131 ( V_2 ) && ! F_131 ( V_64 ) ) {
F_47 ( & V_2 -> V_2 , L_85
L_86 ) ;
V_2 -> V_74 -> V_75 |= V_200 ;
}
...
V_2 = F_129 ( V_201 -> V_43 , F_130 ( V_143 , 0 ) ) ;
if ( ! V_2 )
continue;
...
V_201 = F_129 ( V_2 -> V_43 , F_130 ( V_143 , 0 ) ) ;
if ( ! V_201 )
continue;
...
int V_241 ;
T_3 V_63 ;
V_241 = F_5 ( V_2 , 0x00D0 , & V_63 ) ;
if ( V_241 )
return;
V_2 -> V_29 [ 2 ] . V_32 = V_2 -> V_29 [ 2 ] . V_31 + ( ( V_242 ) 1 << V_63 ) - 1 ;
V_241 = F_5 ( V_2 , 0x00D1 , & V_63 ) ;
if ( V_241 )
return;
V_2 -> V_29 [ 4 ] . V_32 = V_2 -> V_29 [ 4 ] . V_31 + ( ( V_242 ) 1 << V_63 ) - 1 ;
}
...
static void F_182 ( struct V_1 * V_2 , struct V_253 * V_254 ,
struct V_253 * V_32 )
{
T_6 V_243 ;
for (; V_254 < V_32 ; V_254 ++ )
if ( ( V_254 -> V_95 == ( T_1 ) ( V_2 -> V_95 >> V_254 -> V_255 ) ||
V_254 -> V_95 == ( T_1 ) V_256 ) &&
( V_254 -> V_152 == V_2 -> V_152 ||
V_254 -> V_152 == ( T_2 ) V_256 ) &&
( V_254 -> V_78 == V_2 -> V_78 ||
V_254 -> V_78 == ( T_2 ) V_256 ) ) {
V_243 = F_166 ( V_2 , V_254 -> V_257 ) ;
V_254 -> V_257 ( V_2 ) ;
F_174 ( V_2 , V_243 , V_254 -> V_257 ) ;
}
}
void F_183 ( enum V_258 V_259 , struct V_1 * V_2 )
{
...
static int F_186 ( struct V_1 * V_2 , int V_287 )
{
int V_203 ;
if ( V_2 -> V_95 == V_288 ) {
V_203 = F_140 ( V_2 , V_289 ) ;
if ( ! V_203 )
return - V_290 ;
if ( V_287 )
return 0 ;
...
static int F_188 ( struct V_1 * V_2 , int V_287 )
{
if ( V_287 )
return 0 ;
if ( ! F_189 ( V_2 ) )
F_163 ( & V_2 -> V_2 , L_117 ) ;
F_190 ( V_2 , V_291 , V_292 ) ;
F_187 ( 100 ) ;
return 0 ;
}
static int F_191 ( struct V_1 * V_2 , int V_287 )
{
void T_4 * V_293 ;
unsigned long V_294 ;
T_1 V_63 ;
...
if ( ! V_293 )
return - V_295 ;
F_192 ( 0x00000002 , V_293 + V_296 ) ;
F_192 ( 0x00000005 , V_293 + V_297 ) ;
V_63 = F_193 ( V_293 + V_298 ) & 0xfffffffe ;
F_192 ( V_63 , V_293 + V_298 ) ;
V_294 = V_299 + F_194 ( V_300 ) ;
do {
V_63 = F_193 ( V_293 + V_301 ) ;
if ( ( V_63 & 0xb0000000 ) == 0 )
goto V_302;
F_187 ( 10 ) ;
} while ( F_195 ( V_299 , V_294 ) );
F_47 ( & V_2 -> V_2 , L_118 ) ;
V_302:
F_192 ( 0x00000002 , V_293 + V_303 ) ;
F_179 ( V_2 , V_293 ) ;
return 0 ;
}
static int F_196 ( struct V_1 * V_2 , int V_287 )
{
T_2 V_304 ;
T_2 V_305 ;
...
V_304 | V_306 ) ;
F_197 ( V_2 ) ;
F_27 ( V_2 , V_2 -> V_307 + V_308 , & V_305 ) ;
if ( ( V_305 & V_309 ) == 0 )
F_49 ( V_2 , V_2 -> V_307 + V_308 ,
V_305 |
V_309 |
V_310 ) ;
if ( ! F_189 ( V_2 ) )
...
int F_199 ( struct V_1 * V_2 , int V_287 )
{
const struct V_311 * V_143 ;
for ( V_143 = V_311 ; V_143 -> V_312 ; V_143 ++ ) {
if ( ( V_143 -> V_152 == V_2 -> V_152 ||
V_143 -> V_152 == ( T_2 ) V_256 ) &&
( V_143 -> V_78 == V_2 -> V_78 ||
V_143 -> V_78 == ( T_2 ) V_256 ) )
return V_143 -> V_312 ( V_2 , V_287 ) ;
}
return - V_290 ;
}
...
if ( ! F_91 ( V_2 -> V_71 ) )
return F_201 ( V_2 ) ;
return F_129 ( V_2 -> V_43 , F_130 ( F_58 ( V_2 -> V_71 ) , 0 ) ) ;
}
struct V_1 * F_202 ( struct V_1 * V_2 )
{
const struct V_313 * V_143 ;
for ( V_143 = V_313 ; V_143 -> V_314 ; V_143 ++ ) {
if ( ( V_143 -> V_152 == V_2 -> V_152 ||
V_143 -> V_152 == ( T_2 ) V_256 ) &&
( V_143 -> V_78 == V_2 -> V_78 ||
V_143 -> V_78 == ( T_2 ) V_256 ) )
return V_143 -> V_314 ( V_2 ) ;
}
return F_201 ( V_2 ) ;
}
static int F_203 ( struct V_1 * V_2 , T_2 V_315 )
{
#ifdef F_204
struct V_316 * V_317 = NULL ;
T_8 V_318 ;
if ( ! V_2 -> V_141 || ! F_205 ( V_2 -> V_43 ) )
return - V_319 ;
V_318 = F_206 ( L_119 , 0 , & V_317 ) ;
if ( F_207 ( V_318 ) )
return - V_319 ;
V_315 &= ( V_320 | V_321 | V_322 | V_323 ) ;
return V_315 & ~ ( V_320 | V_321 ) ? 0 : 1 ;
#else
return - V_319 ;
#endif
}
int F_208 ( struct V_1 * V_2 , T_2 V_315 )
{
const struct V_324 * V_143 ;
int V_325 ;
for ( V_143 = V_324 ; V_143 -> V_326 ; V_143 ++ ) {
if ( ( V_143 -> V_152 == V_2 -> V_152 ||
V_143 -> V_152 == ( T_2 ) V_256 ) &&
( V_143 -> V_78 == V_2 -> V_78 ||
V_143 -> V_78 == ( T_2 ) V_256 ) ) {
V_325 = V_143 -> V_326 ( V_2 , V_315 ) ;
if ( V_325 >= 0 )
return V_325 ;
}
}
