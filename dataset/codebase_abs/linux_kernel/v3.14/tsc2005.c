...
{
const struct V_104 * V_105 = F_49 ( & V_14 -> V_15 ) ;
struct V_1 * V_2 ;
struct V_96 * V_96 ;
...
V_2 -> V_14 = V_14 ;
V_2 -> V_33 = V_96 ;
V_2 -> V_55 = V_105 -> V_125 ? : 280 ;
V_2 -> V_72 = V_105 -> V_126 ;
V_2 -> V_73 = V_105 -> V_73 ;
F_53 ( & V_2 -> V_83 ) ;
F_54 ( & V_2 -> V_56 ) ;
F_55 ( & V_2 -> V_57 , F_20 , ( unsigned long ) V_2 ) ;
F_56 ( & V_2 -> V_71 , F_40 ) ;
F_47 ( V_2 ) ;
snprintf ( V_2 -> V_127 , sizeof( V_2 -> V_127 ) ,
L_14 , F_57 ( & V_14 -> V_15 ) ) ;
V_96 -> V_128 = L_15 ;
V_96 -> V_127 = V_2 -> V_127 ;
V_96 -> V_129 . V_130 = V_131 ;
V_96 -> V_15 . V_132 = & V_14 -> V_15 ;
V_96 -> V_133 [ 0 ] = F_58 ( V_134 ) | F_58 ( V_135 ) ;
V_96 -> V_136 [ F_59 ( V_38 ) ] = F_60 ( V_38 ) ;
F_61 ( V_96 , V_34 , 0 , V_106 , V_109 , 0 ) ;
F_61 ( V_96 , V_35 , 0 , V_107 , V_110 , 0 ) ;
F_61 ( V_96 , V_36 , 0 , V_108 , V_111 , 0 ) ;
V_96 -> V_137 = F_44 ;
V_96 -> V_138 = F_46 ;
F_62 ( V_96 , V_2 ) ;
F_22 ( V_2 ) ;
error = F_63 ( V_14 -> V_39 , NULL , F_14 ,
V_139 | V_140 ,
L_16 , V_2 ) ;
if ( error ) {
...
F_64 ( V_14 , V_2 ) ;
error = F_65 ( & V_14 -> V_15 . V_86 , & V_141 ) ;
if ( error ) {
F_5 ( & V_14 -> V_15 ,
L_18 , error ) ;
goto V_142;
...
static int F_72 ( struct V_78 * V_14 )
{
struct V_1 * V_2 = F_33 ( V_14 ) ;
F_68 ( & V_2 -> V_14 -> V_15 . V_86 , & V_141 ) ;
F_69 ( V_2 -> V_14 -> V_39 , V_2 ) ;
F_73 ( V_2 -> V_33 ) ;
F_71 ( V_2 ) ;
return 0 ;
}
...
static int F_75 ( struct V_74 * V_15 )
{
struct V_78 * V_14 = F_32 ( V_15 ) ;
struct V_1 * V_2 = F_33 ( V_14 ) ;
F_34 ( & V_2 -> V_83 ) ;
