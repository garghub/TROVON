...
struct V_26 * V_27 = F_25 ( V_202 -> V_225 [ V_57 ] ) ;
int V_268 ;
for ( V_268 = 0 ; V_268 < V_27 -> V_105 ; V_268 ++ ) {
struct V_144 * V_145 = V_27 -> V_106 [ V_268 ] ;
V_145 -> V_217 ( V_145 ) ;
}
}
for ( V_57 = 0 ; V_57 < V_202 -> V_224 ; V_57 ++ )
...
static int F_133 ( struct V_324 * V_325 )
{
...
return - V_327 ;
if ( V_325 -> V_328 != 0 ) {
F_78 ( & V_325 -> V_219 , L_68 ) ;
V_16 = - V_309 ;
goto V_329;
}
V_202 = F_135 ( & V_325 -> V_219 , sizeof( struct V_201 ) ,
V_229 ) ;
if ( V_202 == NULL ) {
V_16 = - V_230 ;
goto V_329;
...
V_202 -> V_332 = F_144 () ;
for ( V_57 = 0 ; V_57 < V_202 -> V_332 ; V_57 ++ )
V_202 -> V_333 [ V_57 ] = F_145 ( V_57 ) ;
V_326 = NULL ;
for ( V_57 = 0 ; V_57 < V_202 -> V_269 ; ++ V_57 ) {
struct V_101 * V_252 ;
const char * V_334 ;
...
if ( V_334 == NULL ||
( V_252 -> V_302 && strcmp ( V_334 , V_252 -> V_302 ) == 0 ) ) {
V_326 = V_252 ;
break;
}
}
...
if ( F_121 ( V_202 ) )
F_130 ( & V_325 -> V_219 , L_75 ) ;
} else if ( V_326 && V_326 -> V_109 -> V_295 &&
V_326 -> V_109 -> V_294 ) {
struct V_115 V_24 ;
V_16 = F_125 ( V_326 , & V_24 ) ;
if ( V_16 == 0 )
V_326 -> V_109 -> V_295 ( V_326 , & V_24 ) ;
}
V_16 = F_108 ( V_202 ) ;
if ( V_16 )
goto V_331;
...
if ( V_326 ) {
T_2 V_20 , V_22 ;
V_326 -> V_109 -> V_231 ( V_326 , & V_20 , & V_22 ) ;
F_148 ( V_202 -> V_219 , L_82 ,
V_326 -> V_302 , V_20 , V_22 ) ;
}
return 0 ;
V_331:
F_101 ( V_202 ) ;
F_149 () ;
V_329:
F_78 ( & V_325 -> V_219 , L_83 ) ;
return V_16 ;
}
static int T_7 F_150 ( struct V_324 * V_325 )
{
struct V_201 * V_202 = F_151 ( V_325 ) ;
F_152 ( V_202 ) ;
F_101 ( V_202 ) ;
F_149 () ;
return 0 ;
