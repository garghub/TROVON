...
static int F_127 ( struct V_1 * V_2 , struct V_34 * V_35 ,
...
static int F_129 ( struct V_1 * V_2 , struct V_34 * V_35 ,
const struct V_171 * V_172 , int V_49 )
{
struct V_47 * V_48 ;
struct V_89 * V_58 ;
...
V_113 = F_127 ( V_2 , V_35 , V_48 , V_58 ,
V_172 , V_49 ) ;
if ( V_113 )
break;
}while ( ++ V_50 < V_48 -> V_55 . V_56 );
...
if ( V_172 -> V_49 & V_258 )
V_49 = - V_179 ;
V_257 = F_129 ( V_2 , V_35 , V_172 , V_49 ) ;
if ( V_257 )
V_35 -> V_41 &= ~ V_165 ;
if ( V_2 -> V_17 < V_259 ) {
T_1 V_4 ;
...
static void F_140 ( struct V_1 * V_2 , T_1 V_100 )
{
T_1 V_4 ;
T_1 V_283 = V_284 ;
if ( V_100 != V_188 )
...
return F_131 ( V_2 , & V_172 -> V_321 ) ;
}
switch ( V_172 -> type . type ) {
case V_322 :
F_147 ( V_2 , & V_172 -> V_323 ) ;
break;
default:
F_34 ( V_2 -> V_23 , L_84 , V_172 -> V_324 ) ;
}
}
static T_6 F_149 ( struct V_1 * V_2 , T_1 V_325 )
{
struct V_326 * V_327 ;
T_6 V_113 = V_328 ;
int V_329 ;
...
V_329 -= 4 ;
F_3 ( V_2 -> V_5 , F_150 ( V_325 ) , 4 ) ;
}
V_327 -> V_248 = 0 ;
V_327 -> V_41 &= ~ V_331 ;
V_113 = V_334 ;
V_4 = F_2 ( V_2 -> V_5 , F_151 ( V_325 ) ) ;
V_4 &= ~ V_335 ;
F_3 ( V_2 -> V_5 , F_151 ( V_325 ) , V_4 ) ;
return V_113 ;
}
...
V_113 |= F_149 ( V_2 , V_50 ) ;
F_68 ( & V_2 -> V_65 , V_41 ) ;
return V_113 ;
}
static T_6 F_152 ( struct V_1 * V_2 , T_1 V_325 )
{
struct V_326 * V_327 ;
T_1 V_248 ;
T_1 V_4 ;
V_327 = V_2 -> V_330 [ V_325 ] ;
V_248 = F_2 ( V_2 -> V_5 , F_150 ( V_325 ) ) ;
V_248 &= V_338 ;
if ( ! V_248 )
return V_328 ;
V_327 -> V_248 = V_248 ;
