...
static void F_14 ( struct V_1 * V_26 , int V_55 )
{
F_15 ( V_26 , L_59 ) ;
F_6 ( V_26 , NULL , NULL ) ;
if ( V_26 -> V_73 )
...
unsigned long V_125 ;
V_2 = V_117 -> V_2 ;
F_29 ( & V_2 -> V_126 , V_125 ) ;
V_29 = F_26 ( V_2 , V_117 -> V_127 , V_117 -> V_118 , V_2 -> V_128 ) ;
V_29 += F_26 ( V_2 , V_117 -> V_127 + V_29 , V_117 -> V_118 - V_29 ,
V_2 -> V_129 ) ;
F_30 ( & V_2 -> V_126 , V_125 ) ;
return V_29 ;
}
static T_5 F_31 ( struct V_124 * V_117 )
{
struct V_1 * V_2 ;
struct V_103 * * V_130 , * V_103 ;
unsigned long V_125 ;
unsigned V_29 , V_6 , V_131 ;
char * V_5 ;
unsigned V_56 ;
if ( ! ( V_130 = F_32 ( V_132 * sizeof *V_130 , V_133 ) ) )
return 0 ;
V_131 = 0 ;
V_2 = V_117 -> V_2 ;
V_5 = V_117 -> V_127 ;
...
if ( V_117 ) {
if ( V_117 -> V_127 )
F_52 ( ( unsigned long ) V_117 -> V_127 ) ;
F_34 ( V_117 ) ;
}
return 0 ;
}
