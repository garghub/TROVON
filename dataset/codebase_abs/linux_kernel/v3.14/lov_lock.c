...
if ( F_40 ( V_81 -> V_89 , V_74 ,
V_78 , V_79 , & V_76 , & V_77 ) )
V_75 ++ ;
}
F_10 ( V_75 > 0 ) ;
F_41 ( V_28 -> V_39 , V_75 * sizeof( V_28 -> V_39 [ 0 ] ) ) ;
if ( V_28 -> V_39 == NULL )
return - V_55 ;
V_28 -> V_38 = V_75 ;
for ( V_74 = 0 , V_75 = 0 ; V_74 < V_84 -> V_88 ; ++ V_74 ) {
...
V_78 , V_79 , & V_76 , & V_77 ) ) {
struct V_52 * V_53 ;
V_53 = & V_28 -> V_39 [ V_75 ] . V_90 ;
F_10 ( V_53 -> V_20 == NULL ) ;
V_53 -> V_20 = F_42 ( V_84 -> V_91 [ V_74 ] ) ;
V_53 -> V_86 = F_43 ( V_53 -> V_20 , V_76 ) ;
V_53 -> V_87 = F_43 ( V_53 -> V_20 , V_77 ) ;
...
struct V_4 * V_29 ;
struct V_31 * V_32 ;
if ( V_28 -> V_39 [ V_74 ] . V_40 == NULL ) {
V_29 = F_19 ( V_3 , V_12 , V_28 , V_74 , & V_32 ) ;
if ( F_6 ( V_29 ) ) {
V_61 = F_31 ( V_29 ) ;
break;
}
...
struct V_27 * V_28 = F_54 ( V_103 ) ;
struct V_56 * V_57 = F_63 ( V_3 , V_105 ) ;
int V_74 ;
int V_61 ;
enum V_115 V_116 ;
...
V_16 = V_7 -> V_40 ;
if ( V_16 == NULL ) {
V_61 = F_61 ( V_3 , V_105 , V_12 , V_28 , V_74 ) ;
break;
}
V_29 = V_16 -> V_63 . V_36 ;
...
{
struct V_27 * V_28 = F_54 ( V_103 ) ;
struct V_56 * V_57 = F_63 ( V_3 , V_103 -> V_36 ) ;
int V_74 ;
int V_61 ;
...
V_37 = F_49 ( V_3 , V_28 , V_74 , 0 , V_37 ) ;
}
F_24 ( V_3 , V_16 , V_57 , V_8 ) ;
}
V_61 = F_32 ( V_61 , V_37 ) ;
...
case V_111 :
V_37 = F_67 ( V_8 -> V_21 , V_29 ) ;
F_49 ( V_3 , V_28 , V_74 , 0 , 0 ) ;
break;
default:
F_49 ( V_3 , V_28 , V_74 , 1 , 0 ) ;
break;
}
F_24 ( V_3 , V_16 , V_57 , V_8 ) ;
}
...
{
struct V_127 * V_128 = V_125 -> V_89 ;
T_1 V_76 ;
T_1 V_77 ;
int V_61 ;
if ( F_37 ( V_125 ) -> V_88 == 1 )
return F_74 ( V_60 , V_53 ) ;
V_76 = F_38 ( & V_125 -> V_129 , V_53 -> V_86 ) ;
V_77 = F_38 ( & V_125 -> V_129 , V_53 -> V_87 + 1 ) - 1 ;
V_61 = V_77 - V_76 <= V_128 -> V_130 &&
V_126 == F_75 ( V_128 , V_76 ) &&
V_126 == F_75 ( V_128 , V_77 ) ;
if ( V_61 ) {
struct V_52 * V_131 = & F_76 ( V_3 ) -> V_132 ;
T_1 V_133 ;
T_1 V_134 ;
V_131 -> V_20 = NULL ;
V_131 -> V_92 = V_53 -> V_92 ;
V_131 -> V_93 = V_53 -> V_93 ;
V_61 = F_40 ( V_128 , V_126 , V_76 , V_77 ,
& V_133 , & V_134 ) ;
F_10 ( V_61 ) ;
V_131 -> V_86 = F_43 ( V_60 -> V_20 , V_133 ) ;
V_131 -> V_87 = F_43 ( V_60 -> V_20 , V_134 ) ;
V_61 = F_74 ( V_60 , V_131 ) ;
}
return V_61 ;
}
...
! F_78 ( V_12 ) && V_135 -> V_92 != V_97 )
V_61 = 0 ;
else
V_61 = F_74 ( & V_125 -> V_85 , V_135 ) ;
F_79 ( V_141 , V_142 L_6 V_142 L_7 ,
F_80 ( & V_125 -> V_85 ) , F_80 ( & V_125 -> V_39 [ 0 ] . V_54 ) ,
...
F_10 ( V_28 -> V_41 > 0 ) ;
V_28 -> V_41 -- ;
F_82 ( & V_5 -> V_46 , L_1 , V_16 -> V_63 . V_36 ) ;
F_48 ( V_3 , V_5 ) ;
F_22 ( V_32 , V_50 ) ;
}
...
static int F_85 ( const struct V_2 * V_3 , void * V_144 ,
...
int F_87 ( const struct V_2 * V_3 , struct V_146 * V_136 ,
...
if ( V_28 != NULL ) {
F_88 ( V_105 , & V_28 -> V_35 , V_136 , & V_147 ) ;
...
static int F_90 ( const struct V_2 * V_3 , void * V_144 ,
T_3 V_145 , const struct V_102 * V_103 )
{
(* V_145)( V_3 , V_144 , L_11 ) ;
return 0 ;
}
int F_91 ( const struct V_2 * V_3 , struct V_146 * V_136 ,
struct V_4 * V_105 , const struct V_11 * V_12 )
{
struct V_27 * V_28 ;
int V_61 = - V_55 ;
F_20 ( V_28 , V_104 , V_51 ) ;
if ( V_28 != NULL ) {
F_88 ( V_105 , & V_28 -> V_35 , V_136 , & V_148 ) ;
V_28 -> V_85 = V_105 -> V_19 ;
V_61 = 0 ;
}
return V_61 ;
}
static struct V_56 * F_63 ( const struct V_2 * V_3 ,
struct V_4 * V_5 )
{
struct V_56 * V_57 ;
V_57 = & F_76 ( V_3 ) -> V_149 ;
