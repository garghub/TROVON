...
for ( V_22 = 0 ; V_22 < V_21 -> V_87 - V_88 ; V_22 ++ ) {
V_81 = V_21 -> V_81 [ V_22 ] ;
V_81 -> V_89 . V_90 = F_21 ( V_70 -> V_74 ) ;
F_22 ( V_79 , F_23 ( 0 , V_22 ) , V_81 -> V_89 . V_90 ) ;
V_81 -> V_91 . V_90 = F_21 ( V_70 -> V_76 ) ;
F_22 ( V_79 , F_23 ( 1 , V_22 ) , V_81 -> V_91 . V_90 ) ;
F_24 ( V_79 ) ;
}
return 0 ;
}
