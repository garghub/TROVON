...
if ( ! V_61 )
return - V_30 ;
if ( ! F_17 ( & V_56 -> V_50 , V_60 -> V_64 ,
F_18 ( V_60 ) , V_56 -> V_65 ) ) {
F_19 ( & V_56 -> V_50 , L_5 ) ;
return - V_66 ;
}
V_2 = F_20 ( & V_56 -> V_50 , sizeof( * V_2 ) , V_67 ) ;
if ( ! V_2 ) {
F_19 ( & V_56 -> V_50 , L_6 ) ;
return - V_68 ;
}
V_2 -> V_11 = F_21 ( & V_56 -> V_50 , V_60 -> V_64 ,
F_18 ( V_60 ) ) ;
if ( ! V_2 -> V_11 ) {
F_19 ( & V_56 -> V_50 , L_7 ) ;
return - V_68 ;
...
if ( ! V_58 )
return - V_30 ;
V_2 -> V_18 . V_69 = V_58 -> V_18 ;
V_2 -> V_18 . V_70 = V_61 -> V_64 ;
V_2 -> V_18 . V_71 = 16 ;
V_2 -> V_18 . V_72 = V_73 ;
V_2 -> V_43 = V_58 -> V_43 ;
V_2 -> V_50 = & V_56 -> V_50 ;
F_27 ( & V_56 -> V_50 , V_2 ) ;
V_33 = F_28 ( & V_56 -> V_50 , V_2 -> V_44 , F_13 , 0 ,
L_8 , V_2 ) ;
if ( V_33 ) {
F_19 ( & V_56 -> V_50 , L_9 ) ;
return V_33 ;
}
V_33 = F_29 ( & V_56 -> V_50 , & V_74 ,
& V_75 , 1 ) ;
if ( V_33 )
return V_33 ;
return F_30 ( & V_56 -> V_50 , & V_2 -> V_76 ,
V_58 -> V_77 ) ;
}
