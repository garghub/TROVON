...
static void F_102 ( struct V_186 * V_187 )
{
struct V_47 * V_48 = F_76 ( V_187 , struct V_47 , V_187 ) ;
F_101 ( V_48 ) ;
}
static inline void F_103 ( struct V_47 * V_48 )
{
F_104 ( & V_48 -> V_187 ) ;
}
static inline void F_105 ( struct V_47 * V_48 )
{
F_106 ( & V_48 -> V_187 , F_102 ) ;
}
static struct V_47 * F_107 ( void )
{
...
static int F_109 ( struct V_47 * V_48 , T_1 * V_25 , int V_4 )
{
if ( F_110 ( V_48 -> V_95 ) < V_4 ) {
F_111 ( V_192 , & V_48 -> V_95 -> V_71 ) ;
return - V_193 ;
}
if ( V_27 & 4 )
F_19 ( L_27 , V_66 ,
...
static int F_112 ( struct V_94 * V_95 , struct V_47 * V_48 )
{
int V_195 , V_87 ;
int V_196 = V_48 -> V_184 << 6 ;
V_48 -> V_95 = F_113 ( V_95 ) ;
V_48 -> V_40 = F_109 ;
V_195 = F_99 ( V_48 ) ;
if ( V_195 != 0 )
F_44 ( V_48 -> V_95 ) ;
...
F_114 ( V_197 , V_196 + V_87 , NULL ) ;
}
return V_195 ;
}
static void F_115 ( struct V_94 * V_95 , struct V_47 * V_48 )
{
int V_87 ;
int V_196 = V_48 -> V_184 << 6 ;
F_11 ( V_95 != V_48 -> V_95 ) ;
for ( V_87 = 1 ; V_87 < V_88 ; V_87 ++ )
F_116 ( V_197 , V_196 + V_87 ) ;
F_95 ( V_48 ) ;
F_44 ( V_48 -> V_95 ) ;
V_48 -> V_95 = NULL ;
}
static void F_117 ( struct V_94 * V_95 , const unsigned char * V_198 ,
...
default:
F_118 ( 1 , L_29 ,
F_119 ( V_95 , V_117 ) , V_71 ) ;
break;
}
}
}
static T_3 F_120 ( struct V_94 * V_95 )
{
return 0 ;
}
static void F_121 ( struct V_94 * V_95 )
{
}
...
static int F_123 ( struct V_94 * V_95 )
{
struct V_47 * V_48 ;
...
V_95 -> V_204 = 65536 ;
V_48 -> V_51 = 1 ;
return F_112 ( V_95 , V_48 ) ;
}
static void F_124 ( struct V_94 * V_95 )
{
struct V_47 * V_48 = V_95 -> V_200 ;
unsigned long V_71 ;
F_125 ( V_192 , & V_95 -> V_71 ) ;
F_25 ( & V_48 -> V_72 , V_71 ) ;
F_17 ( V_48 ) ;
if ( V_48 -> V_67 < V_92 ) {
F_35 ( V_48 ) ;
...
static T_3 F_126 ( struct V_94 * V_95 , struct V_205 * V_205 ,
...
{
int V_207 = F_110 ( V_95 ) ;
if ( V_207 >= V_206 )
return V_95 -> V_154 -> V_194 ( V_95 , V_117 , V_206 ) ;
F_111 ( V_192 , & V_95 -> V_71 ) ;
return - V_208 ;
}
static unsigned int F_128 ( struct V_94 * V_95 , struct V_205 * V_205 ,
T_6 * V_209 )
{
unsigned int V_210 = 0 ;
struct V_47 * V_48 = V_95 -> V_200 ;
F_129 ( V_205 , & V_95 -> V_211 , V_209 ) ;
F_129 ( V_205 , & V_95 -> V_212 , V_209 ) ;
if ( F_130 ( V_205 ) )
V_210 |= V_213 ;
if ( ! F_131 ( V_95 ) && F_110 ( V_95 ) > 0 )
V_210 |= V_214 | V_215 ;
if ( V_48 -> V_119 )
V_210 |= V_213 ;
return V_210 ;
}
static int F_132 ( struct V_94 * V_95 , struct V_47 * V_48 ,
struct V_216 * V_2 )
{
int V_217 = 0 ;
int V_218 = 0 ;
...
static int F_134 ( struct V_94 * V_95 , struct V_205 * V_205 ,
...
V_2 . V_78 = V_48 -> V_78 ;
V_2 . V_219 = 0 ;
if ( F_135 ( ( void * ) V_224 , & V_2 , sizeof( V_2 ) ) )
return - V_227 ;
return 0 ;
case V_228 :
if ( F_136 ( & V_2 , ( void * ) V_224 , sizeof( V_2 ) ) )
return - V_227 ;
return F_132 ( V_95 , V_48 , & V_2 ) ;
default:
return F_137 ( V_95 , V_205 , V_93 , V_224 ) ;
}
}
static int F_138 ( struct V_229 * V_90 )
{
F_8 ( L_31 , V_230 ) ;
F_139 ( V_90 ) ;
return 0 ;
...
static struct V_231 * F_142 ( struct V_229 * V_90 )
{
return & ( (struct V_232 * ) F_143 ( V_90 ) ) -> V_233 ;
}
...
static void F_146 ( struct V_186 * V_187 )
{
struct V_232 * V_236 ;
struct V_7 * V_8 ;
...
static inline void F_148 ( struct V_232 * V_236 )
{
F_104 ( & V_236 -> V_187 ) ;
}
static inline void F_149 ( struct V_232 * V_236 )
{
F_106 ( & V_236 -> V_187 , F_146 ) ;
}
static int F_150 ( struct V_237 * V_85 ,
struct V_229 * V_90 )
{
struct V_232 * V_236 = (struct V_232 * ) F_143 ( V_90 ) ;
struct V_7 * V_8 = V_236 -> V_8 ;
F_148 ( V_236 ) ;
F_151 ( & V_8 -> V_86 , V_85 ) ;
F_152 ( V_90 ) . V_238 ++ ;
F_152 ( V_90 ) . V_67 += V_85 -> V_4 ;
F_36 ( V_8 ) ;
V_90 -> V_239 = V_137 ;
F_149 ( V_236 ) ;
return V_240 ;
}
static void F_153 ( struct V_229 * V_90 )
{
F_154 ( & V_90 -> V_241 , L_32 ) ;
F_152 ( V_90 ) . V_242 ++ ;
}
...
F_157 ( V_85 , V_244 ) ;
memcpy ( F_158 ( V_85 , V_74 ) , V_243 , V_74 ) ;
V_85 -> V_241 = V_90 ;
V_85 -> V_246 = F_159 ( V_247 ) ;
F_160 ( V_85 ) ;
F_152 ( V_90 ) . V_248 ++ ;
F_152 ( V_90 ) . V_249 += V_74 ;
F_149 ( V_236 ) ;
return;
}
static int F_161 ( struct V_229 * V_90 , int V_250 )
{
struct V_232 * V_236 = (struct V_232 * ) F_143 ( V_90 ) ;
...
static void F_162 ( struct V_229 * V_90 )
{
...
if ( ! V_8 -> V_90 )
return;
V_236 = (struct V_232 * ) F_143 ( V_8 -> V_90 ) ;
F_149 ( V_236 ) ;
}
static int F_163 ( struct V_7 * V_8 , struct V_267 * V_268 )
{
char * V_269 ;
int V_270 = 0 ;
struct V_229 * V_90 ;
...
if ( V_268 -> V_274 [ 0 ] != '\0' )
V_269 = V_268 -> V_274 ;
V_90 = F_166 ( sizeof( struct V_232 ) ,
V_269 ,
F_162 ) ;
if ( ! V_90 ) {
F_167 ( L_36 ) ;
...
static int F_170 ( struct V_110 * V_107 )
{
struct V_7 * V_8 = F_76 ( V_107 , struct V_7 , V_107 ) ;
if ( V_8 -> V_145 != V_147 )
return 0 ;
...
static void F_171 ( struct V_110 * V_107 , int V_278 )
{
struct V_7 * V_8 = F_76 ( V_107 , struct V_7 , V_107 ) ;
...
static int F_172 ( struct V_279 * V_280 , struct V_94 * V_95 )
{
struct V_47 * V_48 ;
struct V_7 * V_8 ;
...
V_195 = F_173 ( & V_8 -> V_107 , V_280 , V_95 ) ;
if ( V_195 ) {
if ( V_283 )
F_83 ( V_8 ) ;
F_88 ( & V_48 -> V_151 ) ;
...
static int F_174 ( struct V_94 * V_95 , struct V_205 * V_290 )
{
...
F_90 ( V_107 , V_95 ) ;
V_8 -> V_103 = 0 ;
F_111 ( V_291 , & V_107 -> V_71 ) ;
F_64 ( V_8 ) ;
return F_175 ( V_107 , V_95 , V_290 ) ;
}
static void F_176 ( struct V_94 * V_95 , struct V_205 * V_290 )
{
struct V_7 * V_8 = V_95 -> V_289 ;
struct V_47 * V_48 ;
if ( V_8 == NULL )
...
F_88 ( & V_8 -> V_151 ) ;
V_48 = V_8 -> V_48 ;
if ( F_177 ( & V_8 -> V_107 , V_95 , V_290 ) == 0 )
return;
F_48 ( V_8 ) ;
if ( F_178 ( V_291 , & V_8 -> V_107 . V_71 ) ) {
if ( F_179 ( V_95 ) )
F_180 ( & V_8 -> V_107 ) ;
}
F_181 ( & V_8 -> V_107 , V_95 ) ;
F_90 ( & V_8 -> V_107 , NULL ) ;
return;
}
...
static int F_184 ( struct V_94 * V_95 , const unsigned char * V_117 ,
int V_4 )
{
int V_292 ;
struct V_7 * V_8 = V_95 -> V_289 ;
if ( V_8 -> V_145 == V_146 )
return - V_203 ;
V_292 = F_185 ( V_8 -> V_77 , V_117 , V_4 , & V_8 -> V_81 ) ;
F_36 ( V_8 ) ;
return V_292 ;
}
...
static void F_189 ( struct V_94 * V_95 , int V_294 )
{
}
...
switch ( V_93 ) {
case V_297 :
if ( F_136 ( & V_268 , ( void T_4 * ) V_224 , sizeof( V_268 ) ) )
return - V_227 ;
V_268 . V_274 [ V_276 - 1 ] = '\0' ;
F_86 ( & V_8 -> V_151 ) ;
V_281 = F_163 ( V_8 , & V_268 ) ;
F_88 ( & V_8 -> V_151 ) ;
if ( F_135 ( ( void T_4 * ) V_224 , & V_268 , sizeof( V_268 ) ) )
return - V_227 ;
return V_281 ;
case V_298 :
if ( ! F_164 ( V_271 ) )
...
static void F_193 ( struct V_94 * V_95 , struct V_300 * V_301 )
{
struct V_7 * V_8 = V_95 -> V_289 ;
if ( V_8 -> V_145 == V_146 )
return;
F_194 ( & V_95 -> V_104 , V_301 ) ;
}
...
static int F_197 ( struct V_94 * V_95 , int V_145 )
{
struct V_7 * V_8 = V_95 -> V_289 ;
int V_303 = 0 ;
if ( V_8 -> V_145 == V_146 )
...
return F_169 ( V_8 , V_303 ) ;
}
static void F_198 ( struct V_279 * V_280 , struct V_94 * V_95 )
{
struct V_7 * V_8 = V_95 -> V_289 ;
struct V_47 * V_48 = V_8 -> V_48 ;
F_83 ( V_8 ) ;
F_83 ( V_48 -> V_8 [ 0 ] ) ;
F_105 ( V_48 ) ;
V_280 -> V_304 [ V_95 -> V_281 ] = NULL ;
}
static int T_7 F_199 ( void )
{
int V_305 = F_200 ( V_306 , & V_307 ) ;
if ( V_305 != 0 ) {
F_167 ( L_39 ,
V_305 ) ;
return V_305 ;
