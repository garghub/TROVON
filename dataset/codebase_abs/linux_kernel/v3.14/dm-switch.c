...
{
struct V_1 * V_6 = V_3 -> V_9 ;
T_1 V_25 = F_27 ( V_3 , V_45 -> V_46 . V_47 ) ;
...
unsigned V_55 , char * V_56 , unsigned V_57 )
{
struct V_1 * V_6 = V_3 -> V_9 ;
unsigned V_58 = 0 ;
int V_26 ;
...
F_36 ( L_16 , V_6 -> V_35 [ V_26 ] . V_36 -> V_61 ,
( unsigned long long ) V_6 -> V_35 [ V_26 ] . V_32 ) ;
break;
}
}
static int F_37 ( struct V_2 * V_3 , unsigned V_62 ,
unsigned long V_63 )
{
struct V_1 * V_6 = V_3 -> V_9 ;
struct V_64 * V_49 ;
...
if ( V_3 -> V_11 + V_6 -> V_35 [ V_26 ] . V_32 != F_38 ( V_49 -> V_66 ) >> V_67 )
V_33 = F_39 ( NULL , V_62 ) ;
return V_33 ? : F_40 ( V_49 , V_65 , V_62 , V_63 ) ;
}
