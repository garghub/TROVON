...
static int F_37 ( struct V_2 * V_3 , struct V_78 * V_67 )
{
...
if ( V_67 -> V_56 & V_49 )
V_67 -> V_102 . V_103 =
F_39 ( V_67 -> V_102 . V_105 + V_67 -> V_102 . V_104 ,
V_67 -> V_102 . V_16 ) ;
else
V_67 -> V_102 . V_103 =
...
static void F_41 ( struct V_2 * V_3 , struct V_78 * V_67 )
{
}
static int F_42 ( void * V_93 , bool V_112 , bool V_95 )
{
return F_43 ( (struct V_86 * ) V_93 , V_95 ) ;
}
static int F_44 ( void * V_93 )
{
return 0 ;
}
static void F_45 ( void * * V_93 )
{
F_26 ( (struct V_86 * * ) V_93 ) ;
}
static void * F_46 ( void * V_93 )
{
return F_47 ( (struct V_86 * ) V_93 ) ;
}
static bool F_48 ( void * V_93 )
{
return F_49 ( (struct V_86 * ) V_93 ) ;
}
static int F_50 ( struct V_113 * V_98 ,
struct V_78 * V_114 )
{
...
V_11 = F_52 ( V_116 -> V_6 , V_116 -> V_104 ,
...
static int F_53 ( struct V_113 * V_98 )
{
struct V_115 * V_116 = ( void * ) V_98 ;
F_54 ( V_116 -> V_6 , V_116 -> V_104 , V_98 -> V_94 ) ;
return 0 ;
}
static void F_55 ( struct V_113 * V_98 )
{
struct V_115 * V_116 = ( void * ) V_98 ;
F_56 ( & V_116 -> V_98 ) ;
F_57 ( V_116 ) ;
...
V_116 -> V_6 = V_6 ;
if ( F_61 ( & V_116 -> V_98 , V_3 , V_16 , V_119 , V_121 ) ) {
F_57 ( V_116 ) ;
return NULL ;
}
return & V_116 -> V_98 . V_98 ;
}
static int F_62 ( struct V_113 * V_98 )
{
struct V_1 * V_6 ;
struct V_115 * V_116 = ( void * ) V_98 ;
unsigned V_125 ;
...
#ifdef F_65
if ( F_66 () ) {
return F_67 ( & V_116 -> V_98 , V_6 -> V_132 ) ;
}
#endif
V_11 = F_68 ( V_98 ) ;
if ( V_11 ) {
...
V_116 -> V_98 . V_118 [ V_125 ] = F_69 ( V_6 -> V_133 , V_98 -> V_117 [ V_125 ] ,
0 , V_91 ,
V_134 ) ;
if ( F_70 ( V_6 -> V_133 , V_116 -> V_98 . V_118 [ V_125 ] ) ) {
while ( -- V_125 ) {
F_71 ( V_6 -> V_133 , V_116 -> V_98 . V_118 [ V_125 ] ,
V_91 , V_134 ) ;
...
static void F_73 ( struct V_113 * V_98 )
{
struct V_1 * V_6 ;
struct V_115 * V_116 = ( void * ) V_98 ;
unsigned V_125 ;
...
F_90 ( & V_6 -> V_5 . V_3 , V_50 ) ;
F_90 ( & V_6 -> V_5 . V_3 , V_35 ) ;
F_91 ( & V_6 -> V_5 . V_3 ) ;
F_92 ( V_6 ) ;
F_11 ( V_6 ) ;
V_6 -> V_5 . V_139 = false ;
...
void F_79 ( struct V_1 * V_6 , T_4 V_16 )
{
struct V_27 * V_28 ;
if ( ! V_6 -> V_5 . V_139 )
return;
...
unsigned V_169 = * ( int * ) V_167 -> V_170 -> V_165 ;
struct V_171 * V_132 = V_167 -> V_159 -> V_132 ;
struct V_1 * V_6 = V_132 -> V_160 ;
struct V_172 * V_173 = (struct V_172 * ) V_6 -> V_5 . V_3 . V_28 [ V_169 ] . V_174 ;
int V_175 ;
struct V_23 * V_176 = V_6 -> V_5 . V_3 . V_176 ;
F_100 ( & V_176 -> V_177 ) ;
V_175 = F_101 ( V_164 , V_173 ) ;
F_102 ( & V_176 -> V_177 ) ;
return V_175 ;
}
static int F_103 ( struct V_178 * V_178 , struct V_74 * V_179 )
{
struct V_1 * V_6 = V_178 -> V_180 ;
F_104 ( V_178 , V_6 -> V_39 . V_181 ) ;
V_179 -> V_158 = V_178 -> V_180 ;
return 0 ;
}
static T_5 F_105 ( struct V_74 * V_182 , char T_6 * V_183 ,
T_7 V_16 , T_8 * V_184 )
{
struct V_1 * V_6 = V_182 -> V_158 ;
T_5 V_185 = 0 ;
int V_11 ;
if ( V_16 & 0x3 || * V_184 & 0x3 )
return - V_46 ;
while ( V_16 ) {
unsigned long V_26 ;
T_1 V_186 ;
if ( * V_184 >= V_6 -> V_39 . V_181 )
return V_185 ;
F_106 ( & V_6 -> V_187 , V_26 ) ;
F_107 ( V_188 , ( ( T_1 ) * V_184 ) | 0x80000000 ) ;
if ( V_6 -> V_189 >= V_190 )
F_107 ( V_191 , * V_184 >> 31 ) ;
V_186 = F_108 ( V_192 ) ;
F_109 ( & V_6 -> V_187 , V_26 ) ;
V_11 = F_110 ( V_186 , ( T_1 * ) V_183 ) ;
if ( V_11 )
return V_11 ;
V_185 += 4 ;
V_183 += 4 ;
...
static int F_111 ( struct V_178 * V_178 , struct V_74 * V_179 )
{
struct V_1 * V_6 = V_178 -> V_180 ;
F_104 ( V_178 , V_6 -> V_39 . V_143 ) ;
V_179 -> V_158 = V_178 -> V_180 ;
return 0 ;
}
static T_5 F_112 ( struct V_74 * V_182 , char T_6 * V_183 ,
T_7 V_16 , T_8 * V_184 )
{
struct V_1 * V_6 = V_182 -> V_158 ;
T_5 V_185 = 0 ;
int V_11 ;
while ( V_16 ) {
T_8 V_193 = * V_184 / V_91 ;
unsigned V_194 = * V_184 & ~ V_195 ;
T_7 V_196 = F_113 ( T_7 , V_16 , V_91 - V_194 ) ;
struct V_120 * V_120 ;
void * V_197 ;
if ( V_193 >= V_6 -> V_198 . V_199 )
return V_185 ;
V_120 = V_6 -> V_198 . V_117 [ V_193 ] ;
if ( V_120 ) {
V_197 = F_114 ( V_120 ) ;
V_197 += V_194 ;
V_11 = F_115 ( V_183 , V_197 , V_196 ) ;
F_116 ( V_6 -> V_198 . V_117 [ V_193 ] ) ;
} else
V_11 = F_117 ( V_183 , V_196 ) ;
if ( V_11 )
return - V_135 ;
V_185 += V_196 ;
V_183 += V_196 ;
...
#if F_118 ( V_200 )
unsigned V_201 ;
struct V_202 * V_159 = V_6 -> V_44 -> V_203 ;
struct V_204 * V_205 , * V_206 = V_159 -> V_207 ;
V_205 = F_119 ( L_17 , V_208 | V_209 , V_206 ,
V_6 , & V_210 ) ;
if ( F_120 ( V_205 ) )
return F_121 ( V_205 ) ;
V_6 -> V_5 . V_211 = V_205 ;
V_205 = F_119 ( L_18 , V_208 | V_209 , V_206 ,
V_6 , & V_212 ) ;
if ( F_120 ( V_205 ) )
return F_121 ( V_205 ) ;
V_6 -> V_5 . V_116 = V_205 ;
...
-- V_201 ;
#endif
return F_123 ( V_6 , V_213 , V_201 ) ;
#else
return 0 ;
#endif
}
static void F_88 ( struct V_1 * V_6 )
{
#if F_118 ( V_200 )
F_124 ( V_6 -> V_5 . V_211 ) ;
V_6 -> V_5 . V_211 = NULL ;
