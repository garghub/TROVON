...
T_2 void T_3 F_12 ( struct V_40 * V_18 )
{
T_4 V_41 ;
do {
...
if ( V_41 == 0xffff )
break;
F_13 ( F_14 ( V_43 , V_41 ) , V_18 ) ;
} while ( 1 );
}
void T_1 F_15 ( void T_5 * V_44 )
{
struct V_45 * V_46 ;
int V_47 ;
int V_48 ;
...
F_4 ( 0 , V_8 + V_10 ) ;
F_4 ( 0 , V_8 + V_9 ) ;
V_47 = F_16 ( - 1 , 0 , V_6 , F_17 () ) ;
F_18 ( V_47 < 0 ) ;
V_46 = F_19 ( NULL , NULL , L_2 ) ;
V_43 = F_20 ( V_46 , V_6 , V_47 , 0 ,
& V_51 , NULL ) ;
F_18 ( ! V_43 ) ;
