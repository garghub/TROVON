...
for (; V_86 -- > 0 && ( V_137 > 0 ) ;
++ V_136 , ++ V_88 , -- V_137 ) {
F_49 ( V_143 [ V_144 ] , V_88 ) ;
V_144 = ( V_144 + 1 ) % V_145 ;
}
* V_87 = V_136 ;
return V_88 - V_85 ;
}
static int F_50 ( struct V_93 * V_93 , struct V_84 * V_84 )
{
if ( V_146 )
return - V_95 ;
if ( V_84 -> V_96 & V_147 )
...
static void F_52 ( const char * string , int V_148 )
{
if ( V_149 )
return;
if ( V_146 > 0 ) {
...
V_151 = F_2 ( V_3 ) | V_158 ;
F_3 ( V_3 , V_151 & ~ V_158 ) ;
V_152 = F_55 ( F_56 ( V_3 ) ) & V_159 ;
F_3 ( V_3 , V_151 ) ;
V_153 = F_55 ( F_56 ( V_3 ) ) & V_159 ;
...
static inline int F_57 ( struct V_161 * V_162 )
{
#if 0
...
static inline void F_58 ( struct V_161 * V_162 )
{
#if 0
if (((phys_prev & input->mask) == input->value)
&& ((phys_curr & input->mask) > input->value)) {
...
if ( V_162 -> type == V_164 ) {
void (* F_59)( int ) = V_162 -> V_166 . V_167 . F_59 ;
if ( F_59 != NULL )
F_59 ( V_162 -> V_166 . V_167 . V_182 ) ;
} else if ( V_162 -> type == V_170 ) {
...
V_171 = 0 ;
V_177 = 1 ;
F_61 (item, &logical_inputs) {
V_162 = F_62 ( V_186 , struct V_161 , V_187 ) ;
switch ( V_162 -> V_40 ) {
case V_184 :
if ( ( V_155 & V_162 -> V_163 ) != V_162 -> V_82 )
break;
...
static int F_68 ( const char * V_196 , V_160 * V_163 , V_160 * V_82 ,
...
static struct V_161 * F_69 ( const char * V_196 , const char * V_207 ,
const char * V_208 ,
const char * V_209 )
{
struct V_161 * V_210 ;
V_210 = F_70 ( sizeof( struct V_161 ) , V_211 ) ;
if ( ! V_210 )
return NULL ;
if ( ! F_68 ( V_196 , & V_210 -> V_163 , & V_210 -> V_82 , & V_159 ,
& V_158 ) ) {
F_71 ( V_210 ) ;
return NULL ;
}
...
static int F_75 ( struct V_215 * V_216 , unsigned long V_217 ,
void * V_218 )
{
if ( V_101 && V_102 ) {
switch ( V_217 ) {
...
static void F_83 ( struct V_223 * V_224 )
{
if ( V_224 -> V_225 != V_223 )
return;
if ( ! V_3 ) {
