...
if ( V_91 -> V_122 [ V_30 ] != NULL ) {
F_66 ( V_2 , V_91 -> V_122 [ V_30 ] ,
V_91 -> V_123 [ V_30 ] ,
V_91 -> V_124 [ V_30 ] ) ;
V_91 -> V_122 [ V_30 ] = NULL ;
V_91 -> V_123 [ V_30 ] = 0x0 ;
V_91 -> V_124 [ V_30 ] = 0 ;
}
}
...
V_135 = F_71 ( V_16 ) ;
V_68 = F_42 ( V_135 + V_126 , V_69 ) ;
V_91 -> V_122 [ V_30 ] = F_72 ( V_2 , V_13 -> V_68 ,
& V_91 -> V_123 [ V_30 ] ,
& V_91 -> V_124 [ V_30 ] ) ;
if ( V_91 -> V_122 [ V_30 ] == NULL ) {
V_3 = - V_44 ;
...
static long F_76 ( struct V_41 * V_42 , unsigned int V_93 ,
unsigned long V_137 )
{
int V_3 = 0 ;
struct V_7 * V_8 = (struct V_7 * ) V_42 -> V_48 ;
...
case V_164 :
return F_75 ( V_8 , V_137 , 0 ) ;
case V_165 : {
if ( ! F_44 ( V_71 ) )
return - V_153 ;
return F_75 ( V_8 , V_137 , 1 ) ;
}
default:
return - V_65 ;
}
...
F_90 ( & V_2 -> V_46 , & V_170 ) ;
V_2 -> V_46 . V_9 = V_171 ;
V_3 = F_91 ( & V_2 -> V_46 , V_2 -> V_166 , 1 ) ;
if ( V_3 < 0 ) {
F_16 ( & V_27 -> V_28 , L_12 ) ;
goto V_172;
}
V_2 -> V_28 = F_92 ( V_2 -> V_173 ,
& V_2 -> V_27 -> V_28 ,
V_2 -> V_166 , V_2 ,
V_174 ,
V_168 L_13 ,
...
return 0 ;
V_177:
F_96 ( V_2 -> V_173 , V_2 -> V_166 ) ;
V_176:
F_97 ( & V_2 -> V_46 ) ;
V_172:
F_98 ( V_2 -> V_166 , V_167 ) ;
V_169:
V_2 -> V_28 = NULL ;
return V_3 ;
}
...
return 1 ;
F_99 ( V_2 ) ;
V_3 = F_105 ( & V_2 -> V_46 . V_181 . V_182 . V_183 ) ;
if ( V_3 != 1 ) {
F_16 ( & V_27 -> V_28 ,
L_17 , V_29 , V_3 ) ;
F_106 ( L_18 ) ;
