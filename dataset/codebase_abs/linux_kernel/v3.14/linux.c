...
V_8 = F_75 ( & V_106 , V_104 ) ;
if ( ! V_8 )
return - V_107 ;
V_24 = F_73 ( V_8 , 1 ) ;
if ( V_24 )
return V_24 ;
return F_76 ( V_58 . V_1 ) ;
}
int
F_77 ( struct V_7 * V_103 , void * V_83 )
{
const struct V_5 * V_6 ;
int V_108 ;
for ( V_108 = 0 ; V_108 < 128 ; V_108 ++ )
{
struct V_7 * V_23 ;
char V_104 [ sizeof ( V_105 ) + 3 ] ;
sprintf ( V_104 , V_105 L_9 , V_108 ) ;
V_23 = F_75 ( & V_106 , V_104 ) ;
if ( ! V_23 )
continue;
V_6 = F_22 ( V_23 ) -> V_6 ;
...
sizeof ( struct V_57 ) ) )
return - V_86 ;
return F_4 ( F_79 ( V_58 . V_1 ) ) ;
}
static T_3
F_80 ( struct V_7 * V_23 , struct V_28 * V_29 , int V_30 )
{
V_27 * V_25 ;
void * V_83 ;
int V_109 , V_110 ;
...
if ( V_25 -> V_132 != V_133 )
return - V_107 ;
if ( F_49 ( & V_109 , V_29 -> V_134 , sizeof ( V_109 ) ) )
return - V_86 ;
#if 0
...
#endif
V_110 = F_82 ( V_109 ) ;
if ( V_110 > sizeof( V_128 ) )
return - V_86 ;
V_83 = V_29 -> V_134 + sizeof ( V_109 ) ;
if ( F_49 ( & V_128 , V_83 , V_110 ) )
return - V_86 ;
V_24 = 0 ;
switch ( V_109 )
{
...
break;
case V_149 :
V_24 = ( V_110 == sizeof ( struct V_116 ) ) ? F_83 ( V_25 , & V_128 . V_127 . V_117 ) : - V_86 ;
if ( V_24 == 0 )
if ( F_51 ( V_83 , & V_128 , V_110 ) )
return - V_86 ;
break;
default:
V_24 = - V_88 ;
...
struct V_7 * T_9
F_85 ( T_6 * V_59 , int V_152 , unsigned long V_153 , unsigned long V_154 ,
int V_155 , int V_156 )
{
struct V_7 * V_23 ;
V_27 * V_25 ;
V_23 = F_86 ( sizeof( V_27 ) , V_157 , F_84 ) ;
if ( ! V_23 )
{
F_41 ( L_10 , V_59 -> V_19 ) ;
V_158 = V_20 ;
...
#endif
if ( F_91 ( V_23 ) ||
( F_92 ( V_25 , ( V_172 * ) V_153 , ( V_172 * ) V_154 ) != V_173 ) )
{
F_43 ( F_17 ( V_23 ) ) ;
F_43 ( V_23 ) ;
V_158 = V_107 ;
...
#ifdef F_95
if ( F_93 ( V_156 , & F_18 , V_174 , V_23 -> V_9 , V_23 ) )
{
...
V_27 * V_25 ;
struct V_7 * V_23 ;
int V_108 , V_189 , V_190 ;
for ( V_108 = 0 , V_59 = V_62 ; V_108 < V_191 ; V_108 ++ , V_59 ++ )
{
if ( V_59 -> V_23 )
{
