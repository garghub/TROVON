...
struct V_230 * V_231 ;
unsigned char V_232 ;
struct V_228 * V_233 = V_229 -> V_182 ;
if ( V_233 -> V_221 . V_132 >= V_229 -> V_221 . V_132 )
return;
if ( ! V_233 -> V_182 )
return;
V_232 = V_233 -> V_182 -> V_221 . V_132 ;
F_84 (tmp, &bridge_to_fix->parent->children) {
struct V_228 * V_234 = F_85 ( V_231 ) ;
if ( V_234 -> V_221 . V_116 > V_233 -> V_221 . V_132
&& V_234 -> V_221 . V_116 <= V_232 )
V_232 = V_234 -> V_221 . V_116 - 1 ;
}
if ( V_229 -> V_221 . V_132 > V_232 )
F_59 ( V_206 , & V_229 -> V_7 ,
L_16
L_17 , V_232 ) ;
if ( V_233 -> V_221 . V_132 < V_232 ) {
unsigned char V_235 =
F_86 ( int , V_229 -> V_221 . V_132 , V_232 ) ;
F_59 ( V_186 , & V_233 -> V_7 ,
L_18
L_19 ,
V_233 -> V_236 ,
( int ) V_233 -> V_221 . V_132 , V_235 ) ;
V_233 -> V_221 . V_132 = V_235 ;
F_13 ( V_233 -> V_237 ,
V_238 , V_233 -> V_221 . V_132 ) ;
}
}
static int F_87 ( struct V_13 * V_7 , const struct V_239 * V_240 )
{
struct V_1 * V_2 ;
int V_241 ;
if ( ! V_7 -> V_184 ) {
F_59 ( V_242 , & V_7 -> V_7 , L_20
L_21 ) ;
return - V_243 ;
}
V_2 = F_88 ( sizeof( struct V_1 ) , V_244 ) ;
if ( ! V_2 )
return - V_245 ;
V_2 -> V_2 . V_246 = & V_247 ;
V_2 -> V_2 . V_248 = & V_249 ;
...
V_2 -> V_2 . V_250 = V_2 ;
V_2 -> V_2 . V_251 = V_252 ;
V_2 -> V_2 . V_253 = V_254 | V_255 ;
V_2 -> V_2 . V_256 = 0x1000 ;
V_2 -> V_2 . V_257 = V_7 ;
V_2 -> V_7 = V_7 ;
F_72 ( V_7 , V_2 ) ;
if ( F_89 ( V_7 ) ) {
...
F_60 ( V_2 ) ;
V_2 -> V_83 = V_7 -> V_82 ;
if ( V_240 -> V_250 != V_263 &&
V_240 -> V_250 < F_93 ( V_264 ) ) {
V_2 -> type = & V_264 [ V_240 -> V_250 ] ;
V_241 = V_2 -> type -> V_265 ( V_2 ) ;
if ( V_241 < 0 )
goto V_266;
}
...
V_2 -> V_83 = 0 ;
F_94 ( & V_2 -> V_152 ) ;
V_2 -> V_152 . V_267 = F_46 ;
V_2 -> V_152 . V_151 = ( unsigned long ) V_2 ;
V_2 -> V_152 . V_153 = V_154 + V_155 ;
F_47 ( & V_2 -> V_152 ) ;
F_59 ( V_186 , & V_7 -> V_7 ,
L_25
...
{
struct V_13 * V_271 = F_25 ( V_7 ) ;
struct V_1 * V_2 = F_26 ( V_271 ) ;
if ( ! V_2 )
return 0 ;
if ( V_2 -> type && V_2 -> type -> V_272 )
V_2 -> type -> V_272 ( V_2 ) ;
F_99 ( V_271 ) ;
F_11 ( V_271 , 16 * 4 , & V_2 -> V_273 [ 0 ] ) ;
F_11 ( V_271 , 17 * 4 , & V_2 -> V_273 [ 1 ] ) ;
F_71 ( V_271 ) ;
return 0 ;
}
...
if ( ! V_2 )
return 0 ;
F_17 ( V_271 , 16 * 4 , V_2 -> V_273 [ 0 ] ) ;
F_17 ( V_271 , 17 * 4 , V_2 -> V_273 [ 1 ] ) ;
V_241 = F_89 ( V_271 ) ;
if ( V_241 )
return V_241 ;
F_101 ( V_271 ) ;
if ( V_2 -> type && V_2 -> type -> V_274 )
V_2 -> type -> V_274 ( V_2 ) ;
return 0 ;
}
