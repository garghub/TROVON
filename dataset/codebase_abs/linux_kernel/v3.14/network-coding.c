...
goto free;
F_21 ( & V_43 -> V_56 ) ;
memcpy ( V_43 -> V_60 , V_35 -> V_15 , V_119 ) ;
V_43 -> V_35 = V_115 ;
F_19 ( & V_43 -> V_44 , 2 ) ;
if ( V_116 ) {
V_57 = & V_115 -> V_38 ;
...
int V_120 )
{
struct V_42 * V_121 = NULL , * V_122 = NULL ;
if ( ! F_7 ( & V_5 -> V_10 ) )
goto V_93;
if ( ! ( V_35 -> V_20 & V_21 ) )
goto V_93;
...
static struct V_45 * F_82 ( struct V_4 * V_5 ,
struct V_61 * V_62 ,
T_2 * V_79 ,
T_2 * V_80 )
{
int V_123 ;
struct V_45 * V_46 , V_124 ;
F_56 ( & V_124 , V_79 , V_80 ) ;
V_46 = F_60 ( V_62 , ( void * ) & V_124 ) ;
if ( V_46 ) {
V_46 -> V_54 = V_23 ;
return V_46 ;
}
...
F_19 ( & V_46 -> V_44 , 2 ) ;
V_46 -> V_54 = V_23 ;
memcpy ( V_46 -> V_76 , V_80 , V_119 ) ;
memcpy ( V_46 -> V_75 , V_79 , V_119 ) ;
F_42 ( V_59 , V_5 , L_5 ,
V_46 -> V_75 ,
V_46 -> V_76 ) ;
V_123 = F_83 ( V_62 , F_59 ,
F_57 , & V_124 ,
& V_46 -> V_77 ) ;
if ( V_123 < 0 ) {
F_26 ( V_46 ) ;
...
static T_2 F_84 ( T_2 V_114 )
{
T_2 V_125 , V_126 ;
F_85 ( & V_125 , sizeof( V_125 ) ) ;
V_126 = V_125 * ( V_127 - V_114 ) ;
V_126 /= V_127 ;
return V_127 - V_126 ;
}
static void F_86 ( char * V_80 , const char * V_79 , unsigned int V_96 )
{
unsigned int V_66 ;
...
if ( ! V_146 )
goto V_93;
V_133 = V_145 -> V_158 . V_159 ;
V_131 = F_84 ( V_133 ) ;
V_133 = V_146 -> V_158 . V_159 ;
V_132 = F_84 ( V_133 ) ;
if ( V_131 >= V_132 ) {
V_148 = V_48 -> V_46 -> V_76 ;
V_147 = V_48 -> V_46 -> V_75 ;
V_150 = V_88 -> V_60 ;
V_149 = V_129 -> V_160 ;
V_137 = (struct V_136 * ) V_48 -> V_49 -> V_81 ;
V_138 = (struct V_136 * ) V_49 -> V_81 ;
V_151 = V_48 -> V_161 ;
V_152 = F_90 ( V_49 ,
V_49 -> V_81 + sizeof( * V_138 ) ) ;
} else {
V_148 = V_88 -> V_60 ;
V_147 = V_129 -> V_160 ;
V_150 = V_48 -> V_46 -> V_76 ;
V_149 = V_48 -> V_46 -> V_75 ;
V_137 = (struct V_136 * ) V_49 -> V_81 ;
V_138 = (struct V_136 * ) V_48 -> V_49 -> V_81 ;
V_151 = F_90 ( V_49 ,
...
V_154 = V_135 -> V_96 - V_155 ;
if ( F_91 ( V_134 ) < 0 || F_91 ( V_135 ) < 0 )
goto V_93;
F_92 ( V_134 , V_157 ) ;
V_140 = (struct V_139 * ) V_134 -> V_81 ;
F_93 ( V_134 ) ;
V_140 -> V_162 = V_2 ;
V_140 -> V_163 = V_164 ;
V_140 -> V_112 = V_137 -> V_112 ;
memcpy ( V_140 -> V_147 , V_147 , V_119 ) ;
memcpy ( V_140 -> V_165 , V_137 -> V_166 , V_119 ) ;
V_140 -> V_167 = V_151 ;
V_140 -> V_168 = V_137 -> V_169 ;
memcpy ( V_140 -> V_150 , V_150 , V_119 ) ;
memcpy ( V_140 -> V_149 , V_149 , V_119 ) ;
memcpy ( V_140 -> V_170 , V_138 -> V_166 , V_119 ) ;
V_140 -> V_171 = V_152 ;
V_140 -> V_172 = V_138 -> V_112 ;
V_140 -> V_173 = V_138 -> V_169 ;
V_140 -> V_174 = F_94 ( V_154 ) ;
F_86 ( V_134 -> V_81 + V_156 ,
V_135 -> V_81 + V_155 , V_154 ) ;
if ( F_95 ( V_135 ) -> V_175 &&
F_95 ( V_134 ) -> V_175 ) {
V_153 = V_135 -> V_96 + V_97 ;
V_153 += V_134 -> V_96 + V_97 ;
F_68 ( V_5 , V_176 , 2 ) ;
F_68 ( V_5 , V_177 , V_153 ) ;
} else if ( ! F_95 ( V_135 ) -> V_175 &&
! F_95 ( V_134 ) -> V_175 ) {
V_153 = V_135 -> V_96 + V_97 ;
V_153 += V_134 -> V_96 + V_97 ;
F_68 ( V_5 , V_178 , 2 ) ;
F_68 ( V_5 , V_179 , V_153 ) ;
} else if ( F_95 ( V_135 ) -> V_175 &&
! F_95 ( V_134 ) -> V_175 ) {
F_67 ( V_5 , V_176 ) ;
F_68 ( V_5 , V_177 ,
...
static bool F_98 ( struct V_128 * V_49 ,
T_2 * V_80 , T_2 * V_79 )
{
if ( F_95 ( V_49 ) -> V_175 && ! F_75 ( V_80 , V_79 ) )
return false ;
else
return true ;
}
...
{
struct V_45 * V_46 , V_124 ;
struct V_47 * V_181 = NULL ;
struct V_47 * V_48 , * V_98 ;
struct V_61 * V_62 = V_5 -> V_7 . V_25 ;
int V_182 ;
if ( ! V_62 )
return NULL ;
F_56 ( & V_124 , V_121 -> V_60 ,
V_122 -> V_60 ) ;
V_182 = F_57 ( & V_124 , V_62 -> V_67 ) ;
F_47 () ;
F_48 (nc_path, &hash->table[idx], hash_entry) {
if ( ! F_75 ( V_46 -> V_75 , V_121 -> V_60 ) )
continue;
if ( ! F_75 ( V_46 -> V_76 , V_122 -> V_60 ) )
continue;
F_40 ( & V_46 -> V_99 ) ;
if ( F_53 ( & V_46 -> V_72 ) ) {
F_44 ( & V_46 -> V_99 ) ;
...
{
struct V_129 * V_129 ;
V_49 = F_103 ( V_49 , V_118 ) ;
if ( ! V_49 )
return;
V_129 = F_104 ( V_49 ) ;
memcpy ( V_129 -> V_160 , V_129 -> V_185 , V_119 ) ;
memcpy ( V_129 -> V_185 , V_184 , V_119 ) ;
F_92 ( V_49 , V_97 ) ;
F_105 ( V_5 , V_49 ) ;
F_33 ( V_49 ) ;
}
static bool F_106 ( struct V_128 * V_49 ,
struct V_130 * V_88 ,
struct V_129 * V_129 )
{
struct V_12 * V_186 = V_88 -> V_89 -> V_187 ;
...
F_102 ( V_5 , V_48 -> V_49 ,
V_48 -> V_88 -> V_60 ) ;
if ( F_87 ( V_5 , V_49 , V_129 , V_48 ,
V_88 ) )
return true ;
F_62 ( V_48 ) ;
return false ;
}
static bool F_107 ( struct V_128 * V_49 ,
struct V_45 * V_46 ,
struct V_130 * V_88 ,
T_6 V_161 )
{
...
V_48 -> V_46 = V_46 ;
F_40 ( & V_46 -> V_99 ) ;
F_108 ( & V_48 -> V_56 , & V_46 -> V_72 ) ;
F_44 ( & V_46 -> V_99 ) ;
return true ;
}
bool F_109 ( struct V_128 * V_49 ,
struct V_130 * V_88 )
{
const struct V_12 * V_186 = V_88 -> V_89 -> V_187 ;
struct V_4 * V_5 = F_11 ( V_186 ) ;
struct V_136 * V_188 ;
struct V_45 * V_46 ;
struct V_129 * V_129 = F_104 ( V_49 ) ;
T_6 V_161 ;
T_8 * V_189 ;
if ( ! F_7 ( & V_5 -> V_10 ) )
goto V_93;
V_189 = F_110 ( V_49 ) ;
V_188 = (struct V_136 * ) V_189 ;
if ( V_188 -> V_162 != V_190 )
goto V_93;
if ( F_106 ( V_49 , V_88 , V_129 ) )
return true ;
V_46 = F_82 ( V_5 ,
V_5 -> V_7 . V_25 ,
V_129 -> V_160 ,
...
if ( ! V_46 )
goto V_93;
V_161 = F_90 ( V_49 , V_189 + sizeof( * V_188 ) ) ;
if ( ! F_107 ( V_49 , V_46 , V_88 , V_161 ) )
goto V_191;
return true ;
V_191:
F_30 ( V_46 ) ;
...
if ( ! V_46 )
goto V_93;
V_49 = F_111 ( V_49 , V_118 ) ;
if ( F_52 ( ! V_49 ) )
goto V_191;
if ( F_52 ( ! F_112 ( V_49 , V_97 ) ) )
goto V_192;
if ( F_52 ( ! F_113 ( V_49 , V_97 ) ) )
goto V_192;
V_161 = F_90 ( V_49 , V_189 + sizeof( * V_188 ) ) ;
if ( ! F_107 ( V_49 , V_46 , NULL , V_161 ) )
goto V_192;
F_67 ( V_5 , V_193 ) ;
return;
V_192:
...
{
struct V_129 * V_129 = F_104 ( V_49 ) ;
if ( F_115 ( V_5 , V_129 -> V_185 ) )
return;
F_92 ( V_49 , V_97 ) ;
F_105 ( V_5 , V_49 ) ;
}
static struct V_136 *
F_116 ( struct V_4 * V_5 , struct V_128 * V_49 ,
struct V_47 * V_48 )
{
const int V_194 = sizeof( struct V_136 ) ;
const int V_195 = sizeof( struct V_139 ) - V_194 ;
struct V_136 * V_196 ;
struct V_139 V_197 ;
struct V_129 * V_129 , V_198 ;
T_2 * V_199 , V_112 , V_169 ;
unsigned int V_154 ;
int V_27 ;
memcpy ( & V_197 , V_49 -> V_81 , sizeof( V_197 ) ) ;
memcpy ( & V_198 , F_117 ( V_49 ) , sizeof( V_198 ) ) ;
if ( F_118 ( V_49 , 0 ) < 0 )
return NULL ;
if ( F_52 ( ! F_113 ( V_49 , V_195 ) ) )
return NULL ;
F_119 ( V_49 , - V_97 ) ;
F_120 ( V_49 ) ;
V_129 = F_104 ( V_49 ) ;
memcpy ( V_129 , & V_198 , sizeof( * V_129 ) ) ;
if ( F_115 ( V_5 , V_197 . V_150 ) ) {
memcpy ( V_129 -> V_185 , V_197 . V_150 , V_119 ) ;
V_49 -> V_200 = V_201 ;
V_199 = V_197 . V_170 ;
V_112 = V_197 . V_172 ;
V_169 = V_197 . V_173 ;
...
V_154 = F_121 ( V_197 . V_174 ) ;
if ( V_154 > V_49 -> V_96 )
return NULL ;
F_86 ( V_49 -> V_81 + V_194 ,
V_48 -> V_49 -> V_81 + V_194 ,
V_154 ) ;
if ( V_48 -> V_49 -> V_96 > V_154 + V_194 ) {
V_27 = F_122 ( V_49 , V_154 + V_194 ) ;
if ( V_27 )
return NULL ;
}
V_196 = (struct V_136 * ) V_49 -> V_81 ;
V_196 -> V_162 = V_190 ;
V_196 -> V_163 = V_164 ;
V_196 -> V_112 = V_112 ;
memcpy ( V_196 -> V_166 , V_199 , V_119 ) ;
V_196 -> V_169 = V_169 ;
F_32 ( V_48 ) ;
return V_196 ;
}
...
F_56 ( & V_124 , V_204 , V_166 ) ;
V_87 = F_57 ( & V_124 , V_62 -> V_67 ) ;
F_47 () ;
F_48 (nc_path, &hash->table[index], hash_entry) {
F_40 ( & V_46 -> V_99 ) ;
F_124 (tmp_nc_packet,
&nc_path->packet_list, list) {
if ( V_161 == V_203 -> V_161 ) {
F_65 ( & V_203 -> V_56 ) ;
V_48 = V_203 ;
break;
}
...
static int V_3 ( struct V_128 * V_49 ,
struct V_205 * V_206 )
{
...
struct V_47 * V_48 ;
struct V_129 * V_129 ;
int V_207 = sizeof( * V_140 ) ;
if ( ! F_7 ( & V_5 -> V_10 ) )
return V_208 ;
if ( F_52 ( ! F_112 ( V_49 , V_207 ) ) )
return V_208 ;
V_140 = (struct V_139 * ) V_49 -> V_81 ;
V_129 = F_104 ( V_49 ) ;
if ( ! F_115 ( V_5 , V_129 -> V_185 ) &&
! F_115 ( V_5 , V_140 -> V_150 ) )
return V_208 ;
if ( F_115 ( V_5 , V_140 -> V_150 ) )
F_67 ( V_5 , V_209 ) ;
V_48 = F_123 ( V_5 , V_129 ,
V_140 ) ;
if ( ! V_48 ) {
F_67 ( V_5 , V_210 ) ;
return V_208 ;
...
if ( F_91 ( V_48 -> V_49 ) < 0 )
goto V_211;
V_196 = F_116 ( V_5 , V_49 , V_48 ) ;
if ( ! V_196 ) {
F_67 ( V_5 , V_210 ) ;
goto V_211;
}
F_95 ( V_49 ) -> V_175 = true ;
F_67 ( V_5 , V_212 ) ;
F_68 ( V_5 , V_213 ,
V_49 -> V_96 + V_97 ) ;
return F_125 ( V_49 , V_206 ) ;
V_211:
F_32 ( V_48 ) ;
return V_208 ;
}
...
int F_130 ( struct V_214 * V_215 , void * V_216 )
{
...
V_220 = F_136 ( L_13 , V_5 -> V_222 ) ;
if ( ! V_220 )
goto V_93;
V_221 = F_137 ( L_14 , V_223 | V_224 , V_220 ,
& V_5 -> V_7 . V_32 ) ;
if ( ! V_221 )
goto V_93;
V_221 = F_138 ( L_15 , V_223 | V_224 , V_220 ,
& V_5 -> V_7 . V_33 ) ;
if ( ! V_221 )
goto V_93;
V_221 = F_138 ( L_16 , V_223 | V_224 , V_220 ,
& V_5 -> V_7 . V_34 ) ;
if ( ! V_221 )
goto V_93;
return 0 ;
