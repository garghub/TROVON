...
static int F_5 ( const void * V_11 , const void * V_12 )
{
...
static int F_10 ( const char * V_3 )
{
struct V_31 V_32 ;
if ( V_31 ( V_3 , & V_32 ) ||
! F_11 ( V_32 . V_33 ) )
...
F_14 ( & V_42 , L_4 , V_35 ) ;
V_4 = V_42 . V_4 ;
while ( ( V_40 = F_15 ( V_38 ) ) != NULL ) {
int V_44 ;
if ( F_16 ( V_40 -> V_45 , V_36 ) )
continue;
F_17 ( & V_42 , V_4 ) ;
F_18 ( & V_42 , V_40 -> V_45 ) ;
if ( ! F_10 ( V_42 . V_42 ) )
...
void F_22 ( const char * V_36 ,
struct V_1 * V_46 ,
struct V_1 * V_47 )
{
const char * V_48 = getenv ( L_6 ) ;
const char * V_49 = F_23 () ;
if ( V_49 ) {
F_12 ( V_46 , V_49 , V_36 ) ;
...
void F_25 ( const char * V_53 , struct V_1 * V_46 ,
struct V_1 * V_47 )
{
...
int F_27 ( struct V_1 * V_54 , const char * V_55 )
{
unsigned int V_10 ;
...
static int F_28 ( const char * V_56 , const char * V_57 , void * V_58 )
{
if ( ! strcmp ( V_56 , L_11 ) )
V_59 = F_29 ( V_56 , V_57 ) ;
if ( ! F_16 ( V_56 , L_12 ) )
F_1 ( & V_60 , V_56 + 6 , strlen ( V_56 + 6 ) ) ;
return F_30 ( V_56 , V_57 , V_58 ) ;
}
static int F_31 ( const void * V_61 , const void * V_62 )
{
...
static void F_32 ( struct V_1 * V_2 , struct V_1 * V_69 )
{
unsigned int V_10 ;
...
const char * F_33 ( const char * V_70 )
{
...
for ( V_10 = 0 ; V_10 < V_46 . V_8 ; ++ V_10 )
V_46 . V_7 [ V_10 ] -> V_4 =
F_35 ( V_70 , V_46 . V_7 [ V_10 ] -> V_3 , 0 , 2 , 1 , 4 ) ;
qsort ( V_46 . V_7 , V_46 . V_8 ,
sizeof( * V_46 . V_7 ) , F_31 ) ;
V_71 = V_46 . V_7 [ 0 ] -> V_4 ;
V_29 = 1 ;
...
int F_37 ( int T_3 V_74 , const char * * T_4 V_74 ,
