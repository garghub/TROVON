...
static void F_140 ( struct V_278 * V_21 , struct V_281 * V_302 )
{
}
static int T_7 F_141 ( struct V_1 * V_1 ,
struct V_297 * V_298 )
{
struct V_303 * V_304 ;
V_304 = F_142 ( V_298 , V_305 , L_20 ) ;
if ( ! V_304 ) {
F_17 ( & V_298 -> V_306 , L_21 ) ;
return - V_111 ;
}
V_1 -> V_300 = F_143 ( V_304 -> V_307 , F_144 ( V_304 ) ) ;
if ( V_1 -> V_300 == NULL ) {
F_17 ( & V_298 -> V_306 , L_22 ) ;
return - V_81 ;
}
return 0 ;
}
static int T_7 F_145 ( struct V_297 * V_298 )
{
char V_308 [ 8 ] ;
struct V_303 * V_304 , * V_309 ;
int V_255 ;
void T_8 * V_5 = NULL ;
struct V_1 * V_1 = NULL ;
int V_31 = 0 ;
int V_54 ;
unsigned long V_310 ;
V_304 = F_146 ( V_298 , V_305 , 0 ) ;
if ( ! V_304 ) {
V_31 = - V_111 ;
F_17 ( & V_298 -> V_306 , L_23 ) ;
goto V_311;
}
V_309 = F_146 ( V_298 , V_312 , 0 ) ;
V_255 = V_309 -> V_307 ;
V_310 = V_309 -> V_277 & V_313 ;
if ( V_255 < 0 ) {
V_31 = - V_111 ;
F_17 ( & V_298 -> V_306 , L_24 ) ;
goto V_311;
}
V_5 = F_143 ( V_304 -> V_307 , F_144 ( V_304 ) ) ;
if ( V_5 == NULL ) {
V_31 = - V_81 ;
F_17 ( & V_298 -> V_306 , L_25 ) ;
goto V_311;
}
V_1 = F_116 ( sizeof( struct V_1 ) , V_215 ) ;
if ( V_1 == NULL ) {
V_31 = - V_81 ;
F_17 ( & V_298 -> V_306 , L_26 ) ;
goto V_311;
}
F_147 ( & V_1 -> V_14 ) ;
F_148 ( V_298 , V_1 ) ;
V_1 -> V_46 = F_149 ( & V_298 -> V_306 ) ;
V_1 -> V_160 = V_310 == V_314 ;
V_1 -> V_15 . V_315 = & V_316 ;
V_1 -> V_15 . V_291 = V_231 ;
V_1 -> V_15 . V_317 = V_318 ;
F_150 ( & V_1 -> V_272 ) ;
V_1 -> V_272 . V_319 = F_109 ;
V_1 -> V_272 . V_320 = ( unsigned long ) V_1 ;
V_1 -> V_5 = V_5 ;
if ( V_1 -> V_46 -> V_47 ) {
snprintf ( V_308 , sizeof( V_308 ) , L_27 , V_298 -> V_321 ) ;
V_1 -> V_301 = F_151 ( & V_298 -> V_306 , V_308 ) ;
if ( F_152 ( V_1 -> V_301 ) ) {
F_17 ( & V_298 -> V_306 , L_28 ,
V_308 ) ;
V_31 = F_153 ( V_1 -> V_301 ) ;
goto V_311;
}
F_154 ( V_1 -> V_301 ) ;
}
if ( V_1 -> V_46 -> V_299 ) {
V_31 = F_141 ( V_1 , V_298 ) ;
if ( V_31 < 0 )
goto V_322;
}
F_12 ( V_1 ) ;
V_31 = F_155 ( V_255 , F_106 , V_323 ,
V_318 , V_1 ) ;
if ( V_31 < 0 ) {
F_17 ( & V_298 -> V_306 , L_29 , V_31 ) ;
goto V_322;
}
F_14 ( & V_1 -> V_15 . V_324 ) ;
V_1 -> V_15 . V_214 = & V_1 -> V_21 [ 0 ] . V_21 ;
F_14 ( & V_1 -> V_15 . V_214 -> V_324 ) ;
for ( V_54 = 0 ; V_54 < V_27 ; V_54 ++ ) {
struct V_57 * V_21 = & V_1 -> V_21 [ V_54 ] ;
if ( V_54 != 0 ) {
F_14 ( & V_1 -> V_21 [ V_54 ] . V_21 . V_324 ) ;
F_119 ( & V_1 -> V_21 [ V_54 ] . V_21 . V_324 ,
& V_1 -> V_15 . V_324 ) ;
}
V_21 -> V_1 = V_1 ;
F_14 ( & V_21 -> V_22 ) ;
V_21 -> V_21 . V_317 = V_325 [ V_54 ] ;
V_21 -> V_21 . V_315 = & V_326 ;
F_156 ( & V_21 -> V_21 , 512 ) ;
}
F_156 ( & V_1 -> V_21 [ 0 ] . V_21 , 64 ) ;
V_1 -> V_21 [ 0 ] . V_4 = 0 ;
...
V_1 -> V_213 -> V_187 = F_140 ;
V_31 = F_157 ( & V_298 -> V_306 , & V_1 -> V_15 ) ;
if ( V_31 )
goto V_328;
F_158 ( & V_298 -> V_306 , L_30 , V_329 ) ;
return 0 ;
V_328:
F_117 ( & V_1 -> V_21 [ 0 ] . V_21 , V_1 -> V_213 ) ;
V_327:
