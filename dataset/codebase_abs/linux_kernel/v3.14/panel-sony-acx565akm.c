...
V_14 -> V_54 = V_110 ;
V_2 = F_59 ( & V_14 -> V_19 , sizeof( * V_2 ) , V_111 ) ;
if ( V_2 == NULL )
return - V_112 ;
F_60 ( & V_14 -> V_19 , V_2 ) ;
V_2 -> V_14 = V_14 ;
...
V_65 . V_68 = V_67 ;
V_65 . type = V_116 ;
V_107 = F_63 ( L_6 , & V_2 -> V_14 -> V_19 ,
V_2 , & V_117 , & V_65 ) ;
V_2 -> V_93 = V_107 ;
if ( V_2 -> V_42 ) {
V_13 = F_64 ( & V_107 -> V_19 . V_118 , & V_119 ) ;
if ( V_13 ) {
F_19 ( & V_107 -> V_19 ,
L_22 , V_64 ) ;
goto V_120;
...
V_69 = 0 ;
V_107 -> V_65 . V_108 = V_108 ;
V_107 -> V_65 . V_69 = V_69 ;
F_27 ( V_107 ) ;
V_2 -> V_89 = V_121 ;
V_82 = & V_2 -> V_82 ;
V_82 -> V_19 = & V_14 -> V_19 ;
...
static int F_69 ( struct V_102 * V_14 )
{
struct V_1 * V_2 = F_28 ( & V_14 -> V_19 ) ;
struct V_81 * V_82 = & V_2 -> V_82 ;
struct V_81 * V_83 = V_2 -> V_83 ;
F_6 ( & V_2 -> V_14 -> V_19 , L_13 , V_64 ) ;
F_66 ( & V_2 -> V_93 -> V_19 . V_118 , & V_119 ) ;
F_67 ( V_2 -> V_93 ) ;
F_70 ( V_82 ) ;
F_51 ( V_82 ) ;
F_41 ( V_82 ) ;
