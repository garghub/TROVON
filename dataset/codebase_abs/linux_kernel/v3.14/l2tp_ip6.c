...
V_157:
F_39 ( V_3 ) ;
V_56 = F_83 ( V_3 , V_158 , V_111 -> V_159 ,
...
V_156:
F_85 ( V_121 ) ;
if ( ! ( V_111 -> V_132 & V_163 ) || V_31 )
goto V_157;
V_56 = 0 ;
goto V_162;
}
static int F_86 ( struct V_108 * V_109 , struct V_2 * V_3 ,
struct V_110 * V_111 , T_2 V_31 , int V_164 ,
int V_92 , int * V_48 )
{
struct V_51 * V_52 = F_45 ( V_3 ) ;
F_69 ( struct V_53 * , V_85 , V_111 -> V_114 ) ;
...
V_56 = F_89 ( V_15 , 0 , V_111 -> V_159 , V_165 ) ;
if ( V_56 )
goto V_162;
F_90 ( V_111 , V_3 , V_15 ) ;
if ( V_85 ) {
