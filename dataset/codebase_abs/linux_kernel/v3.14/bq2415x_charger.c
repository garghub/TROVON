...
static void F_35 ( struct V_1 * V_2 , int V_146 )
{
F_3 ( & V_147 ) ;
if ( V_2 -> V_148 == V_146 ) {
F_6 ( & V_147 ) ;
...
F_39 ( V_2 -> V_6 , L_10 , V_8 ) ;
if ( V_2 -> V_145 > 0 )
V_2 -> V_145 = 0 ;
F_30 ( V_2 , V_126 ) ;
F_35 ( V_2 , 0 ) ;
}
static void F_40 ( struct V_152 * V_149 )
{
struct V_1 * V_2 = F_34 ( V_149 , struct V_1 ,
V_149 . V_149 ) ;
int V_10 ;
int error ;
int V_124 ;
