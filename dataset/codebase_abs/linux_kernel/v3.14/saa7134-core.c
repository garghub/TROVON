...
static struct V_172 * F_87 ( struct V_1 * V_2 ,
struct V_172 * V_173 ,
char * type )
{
struct V_172 * V_174 ;
...
V_2 -> V_12 , type , V_167 [ V_2 -> V_178 ] . V_12 ) ;
F_89 ( V_179 , & V_174 -> V_70 ) ;
F_90 ( V_174 , V_2 ) ;
return V_174 ;
}
...
static void F_94 ( struct V_183 * V_184 ,
struct V_1 * V_2 )
{
int V_185 ;
if ( NULL != V_2 -> V_186 )
return;
if ( V_167 [ V_2 -> V_178 ] . V_187 != V_184 -> type )
return;
V_185 = V_184 -> V_188 ( V_2 ) ;
if ( 0 != V_185 )
return;
V_2 -> V_186 = V_184 ;
}
...
static int F_96 ( struct V_39 * V_39 ,
...
V_2 -> V_198 = V_192 ;
sprintf ( V_2 -> V_12 , L_54 , V_39 -> V_23 , V_2 -> V_198 ) ;
if ( V_199 ) {
if ( V_199 & V_200 )
F_4 ( V_201 L_55 , V_2 -> V_12 ) ;
if ( V_199 & V_202 )
F_4 ( V_201 L_56 , V_2 -> V_12 ) ;
if ( V_199 & V_203 )
F_4 ( V_201 L_57 , V_2 -> V_12 ) ;
if ( V_199 & V_204 )
F_4 ( V_201 L_58 , V_2 -> V_12 ) ;
#ifdef F_100
if ( V_199 & F_100 ) {
F_4 ( V_201 L_59 ,
V_2 -> V_12 ) ;
...
F_4 ( V_201 L_67 ,
V_2 -> V_12 , V_205 ) ;
F_101 ( V_39 , V_210 , V_205 ) ;
}
V_2 -> V_211 = V_39 -> V_212 ;
F_102 ( V_39 , V_210 , & V_2 -> V_213 ) ;
F_4 ( V_201 L_68
L_69 , V_2 -> V_12 ,
F_103 ( V_39 ) , V_2 -> V_211 , V_39 -> V_76 ,
V_2 -> V_213 , ( unsigned long long ) F_104 ( V_39 , 0 ) ) ;
F_105 ( V_39 ) ;
if ( ! F_106 ( V_39 , F_107 ( 32 ) ) ) {
F_4 ( L_70 , V_2 -> V_12 ) ;
V_185 = - V_196 ;
goto V_197;
}
V_2 -> V_178 = V_191 -> V_169 ;
if ( ( unsigned ) V_214 [ V_2 -> V_198 ] < V_166 )
V_2 -> V_178 = V_214 [ V_2 -> V_198 ] ;
if ( V_215 == V_2 -> V_178 )
F_86 ( 0 ) ;
else if ( V_216 == V_2 -> V_178 ) {
F_86 ( 1 ) ;
V_2 -> V_178 = V_215 ;
}
V_2 -> V_217 = V_214 [ V_2 -> V_198 ] != V_2 -> V_178 ;
V_2 -> V_218 = V_167 [ V_2 -> V_178 ] . V_218 ;
V_2 -> V_219 = V_167 [ V_2 -> V_178 ] . V_219 ;
V_2 -> V_220 = V_167 [ V_2 -> V_178 ] . V_220 ;
V_2 -> V_221 = V_167 [ V_2 -> V_178 ] . V_221 ;
V_2 -> V_222 = V_167 [ V_2 -> V_178 ] . V_222 ;
if ( V_209 != V_223 [ V_2 -> V_198 ] )
V_2 -> V_218 = V_223 [ V_2 -> V_198 ] ;
F_4 ( V_201 L_71 ,
V_2 -> V_12 , V_39 -> V_224 ,
V_39 -> V_225 , V_167 [ V_2 -> V_178 ] . V_12 ,
V_2 -> V_178 , V_2 -> V_217 ?
L_72 : L_73 ) ;
if ( ! F_108 ( F_104 ( V_39 , 0 ) ,
F_109 ( V_39 , 0 ) ,
V_2 -> V_12 ) ) {
V_185 = - V_226 ;
F_4 ( V_227 L_74 ,
V_2 -> V_12 , ( unsigned long long ) F_104 ( V_39 , 0 ) ) ;
goto V_197;
}
V_2 -> V_228 = F_110 ( F_104 ( V_39 , 0 ) ,
F_109 ( V_39 , 0 ) ) ;
V_2 -> V_229 = ( V_230 V_231 * ) V_2 -> V_228 ;
if ( NULL == V_2 -> V_228 ) {
V_185 = - V_196 ;
F_4 ( V_227 L_75 ,
V_2 -> V_12 ) ;
...
if ( F_10 ( V_2 ) ) {
V_2 -> V_235 =
F_116 ( & V_2 -> V_175 , & V_2 -> V_236 ,
L_77 ,
V_167 [ V_2 -> V_178 ] . V_237 , NULL ) ;
if ( V_2 -> V_235 )
V_2 -> V_235 -> V_238 = V_239 ;
}
if ( V_167 [ V_2 -> V_178 ] . V_240 ) {
struct V_241 * V_242 ;
V_242 = F_116 ( & V_2 -> V_175 ,
& V_2 -> V_236 , L_78 ,
0 , F_117 ( V_167 [ V_2 -> V_178 ] . V_240 ) ) ;
if ( V_242 ) {
F_4 ( V_201 L_79 , V_2 -> V_12 ) ;
V_2 -> V_243 = 1 ;
}
}
F_118 ( & V_244 ) ;
F_119 (mops, &mops_list, next)
F_94 ( V_186 , V_2 ) ;
F_40 ( & V_2 -> V_245 , & V_246 ) ;
F_120 ( & V_244 ) ;
F_61 ( V_2 ) ;
if ( V_247 != V_2 -> V_218 )
F_121 ( V_2 , V_248 , V_249 , 0 ) ;
if ( V_208 > 0 )
F_4 ( V_201 L_80 , V_2 -> V_12 ) ;
V_2 -> V_180 = F_87 ( V_2 , & V_250 , L_20 ) ;
V_2 -> V_180 -> V_251 = & V_2 -> V_251 ;
V_185 = F_122 ( V_2 -> V_180 , V_252 ,
V_253 [ V_2 -> V_198 ] ) ;
if ( V_185 < 0 ) {
F_4 ( V_201 L_81 ,
V_2 -> V_12 ) ;
...
F_4 ( V_201 L_82 ,
V_2 -> V_12 , F_123 ( V_2 -> V_180 ) ) ;
V_2 -> V_181 = F_87 ( V_2 , & V_250 , L_19 ) ;
V_2 -> V_181 -> V_251 = & V_2 -> V_251 ;
V_185 = F_122 ( V_2 -> V_181 , V_255 ,
V_256 [ V_2 -> V_198 ] ) ;
if ( V_185 < 0 )
goto V_254;
F_4 ( V_201 L_83 ,
V_2 -> V_12 , F_123 ( V_2 -> V_181 ) ) ;
if ( F_124 ( V_2 ) ) {
V_2 -> V_182 = F_87 ( V_2 , & V_257 , L_84 ) ;
V_2 -> V_182 -> V_251 = & V_2 -> V_258 ;
V_185 = F_122 ( V_2 -> V_182 , V_259 ,
V_260 [ V_2 -> V_198 ] ) ;
if ( V_185 < 0 )
goto V_254;
F_4 ( V_201 L_83 ,
V_2 -> V_12 , F_123 ( V_2 -> V_182 ) ) ;
}
V_192 ++ ;
...
static void F_131 ( struct V_39 * V_39 )
{
struct V_262 * V_175 = F_132 ( V_39 ) ;
...
static int F_134 ( struct V_39 * V_39 , T_5 V_54 )
{
struct V_262 * V_175 = F_132 ( V_39 ) ;
struct V_1 * V_2 = F_9 ( V_175 , struct V_1 , V_175 ) ;
V_2 -> V_91 = 0 ;
...
F_136 ( V_2 ) ;
F_137 ( V_39 ) ;
F_138 ( V_39 , F_139 ( V_39 , V_54 ) ) ;
return 0 ;
}
static int F_140 ( struct V_39 * V_39 )
{
struct V_262 * V_175 = F_132 ( V_39 ) ;
struct V_1 * V_2 = F_9 ( V_175 , struct V_1 , V_175 ) ;
unsigned long V_70 ;
...
int F_151 ( struct V_183 * V_184 )
{
struct V_1 * V_2 ;
F_118 ( & V_244 ) ;
F_119 (dev, &saa7134_devlist, devlist)
F_94 ( V_184 , V_2 ) ;
F_40 ( & V_184 -> V_57 , & V_267 ) ;
F_120 ( & V_244 ) ;
return 0 ;
}
void F_152 ( struct V_183 * V_184 )
{
struct V_1 * V_2 ;
F_118 ( & V_244 ) ;
F_46 ( & V_184 -> V_57 ) ;
