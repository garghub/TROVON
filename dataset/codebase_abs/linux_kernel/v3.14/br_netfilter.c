...
{
unsigned char * V_92 = ( V_54 * ) ( F_77 ( V_2 ) + 1 ) ;
T_2 V_93 ;
const unsigned char * V_94 = F_78 ( V_2 ) ;
int V_95 = V_92 - V_94 ;
int V_39 = ( V_92 [ 1 ] + 1 ) << 3 ;
if ( ( V_92 + V_39 ) - V_2 -> V_42 > F_79 ( V_2 ) )
goto V_96;
V_95 += 2 ;
V_39 -= 2 ;
while ( V_39 > 0 ) {
...
static unsigned int F_81 ( const struct V_104 * V_29 ,
struct V_1 * V_2 ,
...
return V_108 ;
V_2 -> V_3 = F_3 ( V_111 ) ;
F_83 ( V_112 , V_113 , V_2 , V_2 -> V_16 , NULL ,
F_52 ) ;
return V_114 ;
}
static unsigned int F_84 ( const struct V_104 * V_29 ,
struct V_1 * V_2 ,
const struct V_31 * V_105 ,
const struct V_31 * V_106 ,
int (* F_82)( struct V_1 * ) )
...
return V_118 ;
F_29 ( V_2 ) ;
return F_81 ( V_29 , V_2 , V_105 , V_106 , F_82 ) ;
}
if ( ! V_119 && ! V_18 -> V_120 )
return V_118 ;
if ( ! F_88 ( V_2 ) && ! F_89 ( V_2 ) && ! F_90 ( V_2 ) )
return V_118 ;
F_29 ( V_2 ) ;
if ( F_34 ( V_2 ) )
return V_108 ;
...
F_91 ( V_2 ) ;
V_2 -> V_3 = F_3 ( V_121 ) ;
F_83 ( V_122 , V_113 , V_2 , V_2 -> V_16 , NULL ,
F_61 ) ;
return V_114 ;
}
static unsigned int F_92 ( const struct V_104 * V_29 ,
struct V_1 * V_2 ,
const struct V_31 * V_105 ,
const struct V_31 * V_106 ,
int (* F_82)( struct V_1 * ) )
...
static unsigned int F_97 ( const struct V_104 * V_29 ,
struct V_1 * V_2 ,
const struct V_31 * V_105 ,
const struct V_31 * V_106 ,
int (* F_82)( struct V_1 * ) )
...
if ( F_88 ( V_2 ) || F_89 ( V_2 ) || F_90 ( V_2 ) )
V_127 = V_122 ;
else if ( F_85 ( V_2 ) || F_86 ( V_2 ) || F_87 ( V_2 ) )
V_127 = V_112 ;
else
return V_118 ;
F_27 ( V_2 ) ;
...
V_2 -> V_3 = F_3 ( V_111 ) ;
F_83 ( V_127 , V_130 , V_2 , F_71 ( V_2 , V_105 ) , V_126 ,
F_94 ) ;
return V_114 ;
}
static unsigned int F_98 ( const struct V_104 * V_29 ,
struct V_1 * V_2 ,
const struct V_31 * V_105 ,
const struct V_31 * V_106 ,
int (* F_82)( struct V_1 * ) )
...
F_83 ( V_135 , V_136 , V_2 , (struct V_31 * ) V_105 ,
(struct V_31 * ) V_106 , F_94 ) ;
return V_114 ;
}
...
V_2 -> V_39 + F_101 ( V_2 ) > V_2 -> V_16 -> V_12 &&
! F_102 ( V_2 ) ) {
if ( F_34 ( V_2 ) )
return V_108 ;
V_76 = F_103 ( V_2 , V_138 ) ;
} else
V_76 = V_138 ( V_2 ) ;
return V_76 ;
}
...
static unsigned int F_104 ( const struct V_104 * V_29 ,
struct V_1 * V_2 ,
const struct V_31 * V_105 ,
const struct V_31 * V_106 ,
int (* F_82)( struct V_1 * ) )
...
V_2 -> V_3 = F_3 ( V_111 ) ;
F_83 ( V_127 , V_140 , V_2 , NULL , V_139 ,
F_100 ) ;
return V_114 ;
}
static unsigned int F_105 ( const struct V_104 * V_29 ,
struct V_1 * V_2 ,
const struct V_31 * V_105 ,
const struct V_31 * V_106 ,
int (* F_82)( struct V_1 * ) )
...
static
int F_106 ( struct V_142 * V_143 , int V_144 ,
void T_5 * V_145 , T_6 * V_146 , T_7 * V_147 )
{
int V_76 ;
V_76 = F_107 ( V_143 , V_144 , V_145 , V_146 , V_147 ) ;
if ( V_144 && * ( int * ) ( V_143 -> V_42 ) )
* ( int * ) ( V_143 -> V_42 ) = 1 ;
return V_76 ;
}
int T_8 F_108 ( void )
...
if ( V_76 < 0 )
return V_76 ;
V_76 = F_110 ( V_148 , F_111 ( V_148 ) ) ;
if ( V_76 < 0 ) {
F_112 ( & V_30 ) ;
return V_76 ;
}
#ifdef F_113
V_149 = F_114 ( & V_150 , L_1 , V_151 ) ;
if ( V_149 == NULL ) {
F_115 ( V_152
L_2 ) ;
F_116 ( V_148 , F_111 ( V_148 ) ) ;
F_112 ( & V_30 ) ;
return - V_153 ;
}
#endif
