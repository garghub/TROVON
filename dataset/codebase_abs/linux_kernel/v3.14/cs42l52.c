...
static void F_21 ( struct V_140 * V_141 )
{
struct V_58 * V_59 =
F_22 ( V_141 , struct V_58 , V_142 ) ;
...
static int F_27 ( struct V_150 * V_2 , unsigned int type ,
unsigned int V_151 , int V_152 )
{
struct V_56 * V_57 = F_28 ( V_2 ) ;
struct V_58 * V_59 = F_4 ( V_57 ) ;
F_23 ( V_57 -> V_2 , L_6 , V_151 , V_152 ) ;
switch ( V_151 ) {
case V_153 :
if ( V_152 )
V_152 = 261 ;
...
long int time ;
int V_69 ;
V_69 = F_32 ( V_157 , 10 , & time ) ;
if ( V_69 != 0 )
return V_69 ;
F_33 ( V_59 -> V_159 , V_160 , V_154 , time ) ;
return V_158 ;
}
...
struct V_58 * V_59 = F_4 ( V_57 ) ;
int V_69 ;
V_59 -> V_159 = F_35 ( V_57 -> V_2 ) ;
if ( ! V_59 -> V_159 ) {
F_9 ( V_57 -> V_2 , L_7 ) ;
return;
}
F_36 ( & V_59 -> V_142 , F_21 ) ;
V_59 -> V_146 = 0 ;
V_59 -> V_159 -> V_161 = L_8 ;
V_59 -> V_159 -> V_162 = F_37 ( V_57 -> V_2 ) ;
V_59 -> V_159 -> V_163 . V_164 = V_165 ;
V_59 -> V_159 -> V_166 [ 0 ] = F_38 ( V_160 ) ;
V_59 -> V_159 -> V_167 [ 0 ] = F_38 ( V_153 ) | F_38 ( V_154 ) ;
V_59 -> V_159 -> V_168 = F_27 ;
V_59 -> V_159 -> V_2 . V_169 = V_57 -> V_2 ;
F_39 ( V_59 -> V_159 , V_57 ) ;
V_69 = F_40 ( V_59 -> V_159 ) ;
if ( V_69 != 0 ) {
V_59 -> V_159 = NULL ;
F_9 ( V_57 -> V_2 , L_9 ) ;
}
V_69 = F_41 ( V_57 -> V_2 , & V_170 ) ;
if ( V_69 != 0 ) {
F_9 ( V_57 -> V_2 , L_10 ,
V_69 ) ;
}
...
struct V_58 * V_59 = F_4 ( V_57 ) ;
int V_69 ;
V_57 -> V_172 = V_59 -> V_138 ;
V_69 = F_46 ( V_57 , 8 , 8 , V_173 ) ;
if ( V_69 < 0 ) {
F_9 ( V_57 -> V_2 , L_11 , V_69 ) ;
return V_69 ;
}
F_17 ( V_59 -> V_138 , true ) ;
F_3 ( V_57 ) ;
...
static int F_48 ( struct V_176 * V_176 ,
const struct V_177 * V_163 )
{
struct V_58 * V_59 ;
struct V_60 * V_61 = F_49 ( & V_176 -> V_2 ) ;
int V_69 ;
unsigned int V_178 = 0 ;
unsigned int V_3 ;
T_3 V_179 ;
V_59 = F_50 ( & V_176 -> V_2 , sizeof( struct V_58 ) ,
V_180 ) ;
if ( V_59 == NULL )
return - V_181 ;
V_59 -> V_2 = & V_176 -> V_2 ;
V_59 -> V_138 = F_51 ( V_176 , & V_182 ) ;
if ( F_52 ( V_59 -> V_138 ) ) {
V_69 = F_53 ( V_59 -> V_138 ) ;
F_9 ( & V_176 -> V_2 , L_12 , V_69 ) ;
return V_69 ;
}
if ( V_61 ) {
V_59 -> V_61 = * V_61 ;
...
if ( V_176 -> V_2 . V_183 ) {
if ( F_54 ( V_176 -> V_2 . V_183 ,
L_14 ) )
V_61 -> V_62 = true ;
if ( F_54 ( V_176 -> V_2 . V_183 ,
L_15 ) )
V_61 -> V_64 = true ;
if ( F_55 ( V_176 -> V_2 . V_183 ,
L_16 , & V_179 ) >= 0 )
V_61 -> V_184 = V_179 ;
if ( F_55 ( V_176 -> V_2 . V_183 ,
L_17 , & V_179 ) >= 0 )
V_61 -> V_185 = V_179 ;
V_61 -> V_186 =
F_56 ( V_176 -> V_2 . V_183 ,
L_18 , 0 ) ;
}
V_59 -> V_61 = * V_61 ;
}
if ( V_59 -> V_61 . V_186 ) {
V_69 = F_57 ( V_59 -> V_61 . V_186 ,
V_187 , L_19 ) ;
if ( V_69 < 0 ) {
F_9 ( & V_176 -> V_2 , L_20 ,
V_59 -> V_61 . V_186 , V_69 ) ;
return V_69 ;
}
F_58 ( V_59 -> V_61 . V_186 , 0 ) ;
F_58 ( V_59 -> V_61 . V_186 , 1 ) ;
}
F_59 ( V_176 , V_59 ) ;
V_69 = F_60 ( V_59 -> V_138 , V_188 ,
F_6 ( V_188 ) ) ;
if ( V_69 != 0 )
F_61 ( V_59 -> V_2 , L_21 ,
V_69 ) ;
V_69 = F_62 ( V_59 -> V_138 , V_4 , & V_3 ) ;
V_178 = V_3 & V_189 ;
if ( V_178 != V_190 ) {
V_69 = - V_191 ;
F_9 ( & V_176 -> V_2 ,
...
V_3 & 0xFF ) ;
if ( V_59 -> V_61 . V_62 )
F_64 ( V_59 -> V_138 , V_19 ,
V_192 ,
V_59 -> V_61 . V_62 <<
V_193 ) ;
if ( V_59 -> V_61 . V_64 )
F_64 ( V_59 -> V_138 , V_20 ,
V_192 ,
V_59 -> V_61 . V_64 <<
V_193 ) ;
if ( V_59 -> V_61 . V_185 )
F_64 ( V_59 -> V_138 , V_55 ,
V_194 ,
V_59 -> V_61 . V_185 <<
V_195 ) ;
if ( V_59 -> V_61 . V_184 )
F_64 ( V_59 -> V_138 , V_10 ,
V_196 ,
V_59 -> V_61 . V_184 ) ;
V_69 = F_65 ( & V_176 -> V_2 ,
& V_197 , & V_198 , 1 ) ;
...
static int F_66 ( struct V_176 * V_199 )
{
F_67 ( & V_199 -> V_2 ) ;
return 0 ;
}
