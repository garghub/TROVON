...
static int F_68 ( struct V_84 * V_85 , const struct V_6 * V_7 ,
const struct V_2 * V_11 ,
...
struct V_92 * V_93 ;
struct V_94 * V_95 ;
V_93 = F_69 ( V_85 , V_86 , V_87 , type , sizeof( * V_95 ) , V_88 ) ;
if ( V_93 == NULL )
return - V_96 ;
V_95 = F_70 ( V_93 ) ;
V_95 -> V_97 = V_98 ;
...
V_95 -> V_101 = 0 ;
V_95 -> V_102 = 0 ;
V_95 -> V_103 = V_11 -> V_33 ? V_11 -> V_33 -> V_31 -> V_104 : V_7 -> V_31 -> V_104 ;
V_95 -> V_105 = F_67 ( V_11 ) ;
if ( F_71 ( V_85 , V_106 , V_69 , & V_11 -> V_28 ) )
goto V_107;
V_91 . V_108 = F_72 ( V_89 - V_11 -> V_75 ) ;
V_91 . V_109 = 0 ;
V_91 . V_110 = F_72 ( V_89 - V_11 -> V_13 ) ;
V_91 . V_111 = 0 ;
if ( F_71 ( V_85 , V_112 , sizeof( V_91 ) , & V_91 ) )
goto V_107;
if ( F_71 ( V_85 , V_113 , sizeof( T_4 ) , & V_11 -> V_29 ) )
goto V_107;
return F_73 ( V_85 , V_93 ) ;
V_107:
F_74 ( V_85 , V_93 ) ;
return - V_96 ;
}
...
{
return F_76 ( sizeof( struct V_94 ) )
+ F_77 ( V_69 )
+ F_77 ( sizeof( T_4 ) )
+ F_77 ( sizeof( struct V_90 ) ) ;
}
static void F_17 ( struct V_6 * V_7 ,
const struct V_2 * V_11 , int type )
{
struct V_114 * V_114 = F_78 ( V_7 -> V_31 ) ;
struct V_84 * V_85 ;
int V_115 = - V_116 ;
V_85 = F_79 ( F_75 () , V_74 ) ;
if ( V_85 == NULL )
goto V_117;
V_115 = F_68 ( V_85 , V_7 , V_11 , 0 , 0 , type , 0 ) ;
if ( V_115 < 0 ) {
F_80 ( V_115 == - V_96 ) ;
F_81 ( V_85 ) ;
goto V_117;
}
F_82 ( V_85 , V_114 , 0 , V_118 , NULL , V_74 ) ;
return;
V_117:
F_83 ( V_114 , V_118 , V_115 ) ;
}
...
goto V_64;
if ( F_68 ( V_85 , V_7 , V_23 ,
F_86 ( V_120 -> V_85 ) . V_86 ,
V_120 -> V_93 -> V_124 ,
V_78 ,
V_125 ) < 0 )
break;
...
static int F_88 ( struct V_94 * V_95 , struct V_26 * V_27 ,
const unsigned char * V_28 , T_4 V_131 , T_4 V_16 )
{
int V_115 = 0 ;
if ( V_95 -> V_101 & V_132 ) {
F_51 () ;
...
F_25 ( & V_27 -> V_7 -> V_37 ) ;
V_115 = F_87 ( V_27 , V_28 , V_95 -> V_105 ,
V_131 , V_16 ) ;
F_27 ( & V_27 -> V_7 -> V_37 ) ;
}
return V_115 ;
}
int F_89 ( struct V_94 * V_95 , struct V_133 * V_134 [] ,
struct V_57 * V_31 ,
const unsigned char * V_28 , T_4 V_131 )
{
struct V_26 * V_27 ;
int V_115 = 0 ;
struct V_40 * V_41 ;
...
if ( V_134 [ V_113 ] ) {
if ( F_91 ( V_134 [ V_113 ] ) != sizeof( unsigned short ) ) {
F_90 ( L_7 ) ;
return - V_76 ;
}
V_16 = F_92 ( V_134 [ V_113 ] ) ;
if ( ! V_16 || V_16 >= V_136 ) {
F_90 ( L_8 ,
V_16 ) ;
return - V_76 ;
...
V_41 = F_29 ( V_27 ) ;
if ( V_16 != V_135 ) {
if ( ! V_41 || ! F_95 ( V_16 , V_41 -> V_137 ) ) {
F_90 ( L_11
L_12 , V_16 , V_31 -> V_77 ) ;
return - V_76 ;
}
V_115 = F_88 ( V_95 , V_27 , V_28 , V_131 , V_16 ) ;
} else {
if ( ! V_41 || F_96 ( V_41 -> V_137 , V_135 ) ) {
V_115 = F_88 ( V_95 , V_27 , V_28 , V_131 , 0 ) ;
goto V_48;
}
F_33 (vid, pv->vlan_bitmap, VLAN_N_VID) {
V_115 = F_88 ( V_95 , V_27 , V_28 , V_131 , V_16 ) ;
...
static int F_97 ( struct V_6 * V_7 , const T_5 * V_28 , T_4 V_138 )
{
struct V_35 * V_20 = & V_7 -> V_36 [ F_9 ( V_28 , V_138 ) ] ;
struct V_2 * V_11 ;
V_11 = F_26 ( V_20 , V_28 , V_138 ) ;
if ( ! V_11 )
return - V_128 ;
F_15 ( V_7 , V_11 ) ;
return 0 ;
...
int V_115 ;
F_25 ( & V_27 -> V_7 -> V_37 ) ;
V_115 = F_97 ( V_27 -> V_7 , V_28 , V_16 ) ;
F_27 ( & V_27 -> V_7 -> V_37 ) ;
return V_115 ;
}
int F_99 ( struct V_94 * V_95 , struct V_133 * V_134 [] ,
struct V_57 * V_31 ,
const unsigned char * V_28 )
{
struct V_26 * V_27 ;
...
V_115 = F_98 ( V_27 , V_28 , V_16 ) ;
} else {
if ( ! V_41 || F_96 ( V_41 -> V_137 , V_135 ) ) {
V_115 = F_98 ( V_27 , V_28 , 0 ) ;
goto V_48;
}
V_115 = - V_128 ;
F_33 (vid, pv->vlan_bitmap, VLAN_N_VID) {
