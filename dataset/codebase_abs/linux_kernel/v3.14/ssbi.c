...
static int
F_9 ( struct V_1 * V_1 , T_2 V_11 , const T_3 * V_12 , int V_13 )
{
int V_16 = 0 ;
if ( V_1 -> V_17 == V_18 ) {
T_1 V_19 = F_1 ( V_1 , V_20 ) ;
...
static int
F_12 ( struct V_1 * V_1 , T_2 V_11 , const T_3 * V_12 , int V_13 )
{
T_1 V_14 ;
int V_16 = 0 ;
while ( V_13 ) {
...
int F_17 ( struct V_36 * V_37 , T_2 V_11 , const T_3 * V_12 , int V_13 )
{
struct V_1 * V_1 = F_14 ( V_37 ) ;
unsigned long V_38 ;
int V_16 ;
