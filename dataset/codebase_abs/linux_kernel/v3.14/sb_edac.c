...
static struct V_36 * F_64 ( T_2 V_53 )
{
struct V_12 * V_12 ;
F_13 (sbridge_dev, &sbridge_edac_list, list) {
if ( V_12 -> V_53 == V_53 )
...
F_88 ( L_85 ) ;
F_88 ( L_86 ,
V_150 -> V_189 , V_150 -> V_156 , V_150 -> V_190 , V_150 -> V_158 ) ;
F_88 ( L_87 , V_150 -> V_191 ) ;
F_88 ( L_88 , V_150 -> V_108 ) ;
F_88 ( L_89 , V_150 -> V_192 ) ;
F_88 ( L_90 ,
V_150 -> V_193 , V_150 -> V_194 , V_150 -> time ,
V_150 -> V_187 , V_150 -> V_195 ) ;
if ( F_89 ( V_150 -> V_196 ) . V_197 != V_21 -> V_12 -> V_54 )
return V_186 ;
F_84 () ;
...
F_91 ( V_37 -> V_16 ) ;
F_7 ( 1 , L_94 , V_37 -> V_199 ) ;
F_16 ( V_37 -> V_199 ) ;
F_92 ( V_37 ) ;
V_12 -> V_37 = NULL ;
}
static int F_93 ( struct V_12 * V_12 , enum type type )
{
struct V_36 * V_37 ;
struct V_200 V_71 [ 2 ] ;
struct V_20 * V_21 ;
...
V_71 [ 1 ] . V_44 = V_204 ;
V_71 [ 1 ] . V_202 = true ;
V_37 = F_94 ( V_12 -> V_54 , F_42 ( V_71 ) , V_71 ,
sizeof( * V_21 ) ) ;
if ( F_73 ( ! V_37 ) )
return - V_145 ;
F_7 ( 0 , L_93 ,
...
V_37 -> V_210 = L_95 ;
V_37 -> V_211 = V_212 ;
V_37 -> V_213 = F_95 ( V_16 ) ;
V_37 -> V_214 = NULL ;
V_37 -> V_215 = F_83 ;
V_21 -> V_59 . type = type ;
if ( type == V_166 ) {
V_21 -> V_59 . V_65 = V_216 ;
V_21 -> V_59 . V_94 = F_25 ;
V_21 -> V_59 . V_96 = F_26 ;
V_21 -> V_59 . V_99 = V_217 ;
V_21 -> V_59 . V_97 = F_42 ( V_217 ) ;
V_21 -> V_59 . V_100 = V_218 ;
V_21 -> V_59 . V_123 = F_42 ( V_218 ) ;
V_21 -> V_59 . V_2 = V_219 ;
V_37 -> V_199 = F_96 ( V_15 , L_96 , V_37 -> V_220 ) ;
V_146 = F_78 ( V_37 , V_12 ) ;
if ( F_73 ( V_146 < 0 ) )
goto V_221;
} else {
V_21 -> V_59 . V_65 = V_222 ;
V_21 -> V_59 . V_94 = F_20 ;
V_21 -> V_59 . V_96 = F_23 ;
V_21 -> V_59 . V_99 = V_223 ;
V_21 -> V_59 . V_97 = F_42 ( V_223 ) ;
V_21 -> V_59 . V_100 = V_224 ;
V_21 -> V_59 . V_123 = F_42 ( V_224 ) ;
V_21 -> V_59 . V_2 = V_225 ;
V_37 -> V_199 = F_96 ( V_15 , L_97 , V_37 -> V_220 ) ;
...
static int F_98 ( struct V_27 * V_16 , const struct V_226 * V_227 )
{
int V_146 ;
T_2 V_54 , V_135 = 0 ;
struct V_12 * V_12 ;
...
static void F_101 ( struct V_27 * V_16 )
{
struct V_12 * V_12 ;
F_7 ( 0 , L_54 ) ;
F_99 ( & V_228 ) ;
