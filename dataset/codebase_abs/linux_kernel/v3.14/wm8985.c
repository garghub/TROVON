...
static int F_37 ( struct V_195 * V_196 )
{
struct V_116 * V_117 ;
int V_156 ;
...
static int F_46 ( struct V_202 * V_203 ,
const struct V_204 * V_205 )
{
struct V_116 * V_117 ;
int V_156 ;
V_117 = F_38 ( & V_203 -> V_2 , sizeof *V_117 , V_197 ) ;
if ( ! V_117 )
return - V_198 ;
F_47 ( V_203 , V_117 ) ;
V_117 -> V_178 = F_48 ( V_203 , & V_199 ) ;
if ( F_41 ( V_117 -> V_178 ) ) {
V_156 = F_42 ( V_117 -> V_178 ) ;
F_11 ( & V_203 -> V_2 , L_19 ,
V_156 ) ;
...
V_156 = F_43 ( & V_203 -> V_2 ,
& V_200 , & V_201 , 1 ) ;
return V_156 ;
}
static int F_49 ( struct V_202 * V_203 )
{
F_45 ( & V_203 -> V_2 ) ;
return 0 ;
}
