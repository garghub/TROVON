...
static const char * F_21 ( int V_16 )
{
#define F_22 ( T_2 ) case x: return #x
switch ( V_16 ) {
F_22 ( V_17 ) ;
F_22 ( V_18 ) ;
F_22 ( V_19 ) ;
...
int F_23 ( struct V_1 * V_2 , char * * V_26 )
{
int V_27 ;
...
if ( V_26 ) {
int V_29 = 0 ;
T_3 V_30 = F_25 ( V_28 ) * 48 + 40 ;
* V_26 = F_26 ( V_30 , V_31 ) ;
if ( ! * V_26 )
return - V_32 ;
V_29 += F_27 ( * V_26 + V_29 , V_30 - V_29 ,
L_2 ) ;
for ( V_27 = 0 ; V_27 < F_25 ( V_28 ) ; V_27 ++ )
V_29 += F_27 ( * V_26 + V_29 , V_30 - V_29 ,
L_3 ,
F_21 ( V_28 [ V_27 ] ) ,
F_4 ( V_2 , V_28 [ V_27 ] ) ) ;
