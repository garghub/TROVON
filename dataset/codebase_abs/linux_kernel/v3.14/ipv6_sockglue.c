...
char T_1 * V_36 , int T_1 * V_37 , unsigned int V_255 )
{
struct V_38 * V_39 = F_12 ( V_2 ) ;
int V_250 ;
int V_41 ;
...
return - V_44 ;
if ( V_207 . V_256 . V_189 != V_56 )
return - V_62 ;
F_21 ( V_2 ) ;
V_244 = F_69 ( V_2 , & V_207 ,
...
V_39 -> V_139 . V_138 ;
V_260 . V_140 = V_39 -> V_171 ? V_2 -> V_61 : V_39 -> V_139 . V_140 ;
...
V_260 . V_138 = V_39 -> V_171 ? V_39 -> V_171 :
V_39 -> V_139 . V_138 ;
V_260 . V_140 = V_39 -> V_171 ? V_2 -> V_61 :
V_39 -> V_139 . V_140 ;
...
V_167 V_264 = V_39 -> V_263 ;
F_72 ( & V_143 , V_247 , V_109 , sizeof( V_264 ) , & V_264 ) ;
}
}
V_250 -= V_143 . V_152 ;
return F_74 ( V_250 , V_37 ) ;
}
case V_216 :
{
struct V_265 * V_266 ;
...
V_266 = F_76 ( V_2 ) ;
if ( V_266 )
V_269 . V_270 = F_77 ( V_266 ) ;
F_78 () ;
if ( ! V_269 . V_270 )
return - V_60 ;
if ( F_74 ( V_250 , V_37 ) )
return - V_44 ;
if ( F_66 ( V_36 , & V_269 , V_250 ) )
return - V_44 ;
return 0 ;
break;
}
...
if ( V_41 < 0 )
V_41 = F_17 ( V_2 ) -> V_271 . V_272 -> V_155 ;
break;
}
case V_160 :
V_41 = V_39 -> V_161 ;
...
break;
case V_162 :
V_41 = ( V_166 int ) F_80 ( ( V_273 ) V_39 -> V_168 ) ;
break;
case V_212 :
V_41 = V_39 -> V_215 ;
break;
...
struct V_274 V_275 ;
int V_255 ;
if ( V_250 < sizeof( V_275 ) )
return - V_126 ;
if ( F_41 ( & V_275 , V_36 , sizeof( V_275 ) ) )
return - V_44 ;
...
V_41 = F_81 ( V_2 , & V_275 , V_255 ) ;
if ( V_41 < 0 )
return V_41 ;
if ( F_74 ( V_250 , V_37 ) )
return - V_44 ;
if ( F_66 ( V_36 , & V_275 , V_250 ) )
return - V_44 ;
return 0 ;
}
case V_227 :
...
int V_244 ;
if ( V_34 == V_245 && V_2 -> V_8 != V_9 )
return V_73 . V_279 ( V_2 , V_34 , V_35 , V_36 , V_37 ) ;
if( V_34 != V_247 )
return - V_12 ;
...
return - V_44 ;
F_21 ( V_2 ) ;
V_244 = F_83 ( V_2 , V_248 , V_35 , V_36 ,
& V_250 ) ;
F_57 ( V_2 ) ;
if ( V_244 >= 0 )
V_244 = F_74 ( V_250 , V_37 ) ;
}
#endif
return V_244 ;
}
...
if ( V_34 == V_245 && V_2 -> V_8 != V_9 ) {
if ( V_73 . V_280 != NULL )
return V_73 . V_280 ( V_2 , V_34 , V_35 ,
V_36 , V_37 ) ;
return V_73 . V_279 ( V_2 , V_34 , V_35 , V_36 , V_37 ) ;
}
if ( V_34 != V_247 )
