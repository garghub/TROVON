...
int F_43 ( struct V_45 * V_46 , T_3 V_51 )
{
T_3 V_52 = V_46 -> V_48 + V_51 ;
if ( V_52 > V_46 -> V_53 )
V_52 = V_46 -> V_53 + 1 ;
V_51 -= V_52 - V_46 -> V_48 ;
V_46 -> V_48 = F_44 ( V_52 , V_46 -> V_54 ) ;
return V_51 ;
}
void F_45 ( struct V_45 * V_46 , T_3 V_55 )
{
if ( V_46 -> V_56 >= V_55 ) {
if ( V_46 -> V_48 < V_46 -> V_54 )
V_46 -> V_48 ++ ;
V_46 -> V_56 = 0 ;
} else {
V_46 -> V_56 ++ ;
...
void F_46 ( struct V_13 * V_14 , T_3 V_57 , T_3 V_51 , T_3 V_44 )
{
struct V_45 * V_46 = F_40 ( V_14 ) ;
if ( ! F_39 ( V_14 , V_44 ) )
return;
if ( V_46 -> V_48 <= V_46 -> V_53 )
F_43 ( V_46 , V_51 ) ;
else
F_45 ( V_46 , V_46 -> V_48 ) ;
}
...
{
const struct V_45 * V_46 = F_40 ( V_14 ) ;
return F_48 ( V_46 -> V_48 >> 1U , 2U ) ;
}
T_3 F_49 ( const struct V_13 * V_14 )
{
const struct V_45 * V_46 = F_40 ( V_14 ) ;
return V_46 -> V_53 / 2 ;
}
