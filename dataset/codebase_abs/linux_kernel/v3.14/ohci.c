...
V_262 , V_263 ) ;
F_6 ( V_4 , V_26 , V_27 ) ;
F_127 ( & V_4 -> V_3 , V_4 -> V_29 , V_26 ,
V_27 , V_4 -> V_30 ,
V_4 -> V_286 ) ;
V_4 -> V_286 = false ;
}
static T_8 F_128 ( int V_287 , void * V_44 )
{
struct V_1 * V_4 = V_44 ;
T_1 V_288 , V_289 ;
int V_49 ;
V_288 = F_13 ( V_4 , V_276 ) ;
if ( ! V_288 || ! ~ V_288 )
return V_290 ;
F_11 ( V_4 , V_276 ,
V_288 & ~ ( V_9 | V_17 ) ) ;
F_2 ( V_4 , V_288 ) ;
if ( V_288 & V_10 )
F_129 ( V_291 , & V_4 -> F_124 ) ;
if ( V_288 & V_11 )
F_130 ( & V_4 -> V_118 . V_126 ) ;
if ( V_288 & V_12 )
F_130 ( & V_4 -> V_292 . V_126 ) ;
if ( V_288 & V_13 )
F_130 ( & V_4 -> V_220 . V_126 ) ;
if ( V_288 & V_14 )
F_130 ( & V_4 -> V_226 . V_126 ) ;
if ( V_288 & V_15 ) {
V_289 = F_13 ( V_4 , V_293 ) ;
F_11 ( V_4 , V_293 , V_289 ) ;
while ( V_289 ) {
V_49 = F_131 ( V_289 ) - 1 ;
F_130 (
& V_4 -> V_294 [ V_49 ] . V_143 . V_126 ) ;
V_289 &= ~ ( 1 << V_49 ) ;
}
}
if ( V_288 & V_16 ) {
V_289 = F_13 ( V_4 , V_295 ) ;
F_11 ( V_4 , V_295 , V_289 ) ;
while ( V_289 ) {
V_49 = F_131 ( V_289 ) - 1 ;
F_130 (
& V_4 -> V_296 [ V_49 ] . V_143 . V_126 ) ;
V_289 &= ~ ( 1 << V_49 ) ;
}
}
if ( F_8 ( V_288 & V_21 ) )
...
static int F_135 ( struct V_1 * V_4 )
{
T_1 V_48 ;
int V_49 ;
F_11 ( V_4 , V_300 , V_301 ) ;
...
static void F_136 ( V_41 * V_302 , const V_41 * V_303 , T_9 V_94 )
{
T_9 V_304 = V_94 * 4 ;
memcpy ( V_302 , V_303 , V_304 ) ;
if ( V_304 < V_202 )
memset ( & V_302 [ V_94 ] , 0 , V_202 - V_304 ) ;
}
static int F_137 ( struct V_1 * V_4 )
{
bool V_305 ;
int V_57 , V_306 , V_307 , V_43 ;
if ( ! ( F_13 ( V_4 , V_300 ) &
V_308 ) )
return 0 ;
V_305 = false ;
...
V_319 ) ;
F_15 ( V_4 ) ;
for ( V_315 = 0 , V_49 = 0 ; ! V_315 && V_49 < 3 ; V_49 ++ ) {
F_19 ( 50 ) ;
V_315 = F_13 ( V_4 , V_300 ) &
V_318 ;
}
if ( ! V_315 ) {
F_20 ( V_4 , L_61 ) ;
...
F_11 ( V_4 , F_140 ( V_49 ) ,
V_329 ) ;
V_316 = F_13 ( V_4 , V_46 ) & 0x00ff00ff ;
if ( V_316 >= V_330 ) {
F_11 ( V_4 , V_331 ,
0xfffffffe ) ;
V_3 -> V_332 = true ;
...
F_11 ( V_4 , V_336 , V_337 >> 16 ) ;
F_11 ( V_4 , V_276 , ~ 0 ) ;
F_11 ( V_4 , V_338 , ~ 0 ) ;
V_57 = F_137 ( V_4 ) ;
if ( V_57 < 0 )
return V_57 ;
V_57 = F_29 ( V_3 , 4 , 0 , V_339 | V_340 ) ;
if ( V_57 < 0 )
return V_57 ;
if ( V_206 ) {
V_4 -> V_277 =
...
F_11 ( V_4 , V_280 ,
F_10 ( V_4 -> V_277 [ 2 ] ) ) ;
F_11 ( V_4 , V_341 , V_4 -> V_279 ) ;
F_11 ( V_4 , V_342 , 0x80000000 ) ;
V_317 = V_13 | V_14 |
V_11 | V_12 |
V_16 | V_15 |
V_17 |
...
F_83 ( V_4 -> V_3 . V_79 , V_202 ,
V_277 , V_279 ) ;
F_141 ( & V_4 -> V_3 , true , true ) ;
return 0 ;
}
static void F_143 ( struct V_2 * V_3 , struct V_91 * V_174 )
{
struct V_1 * V_4 = V_1 ( V_3 ) ;
...
static int F_145 ( struct V_2 * V_3 , struct V_91 * V_174 )
{
struct V_1 * V_4 = V_1 ( V_3 ) ;
...
V_349 = ( V_29 & 0xffc0 ) == V_351 ? V_29 & 0x3f : 63 ;
if ( V_349 < 32 )
F_11 ( V_4 , V_285 , 1 << V_349 ) ;
else
F_11 ( V_4 , V_284 , 1 << ( V_349 - 32 ) ) ;
F_15 ( V_4 ) ;
V_214:
F_75 ( & V_4 -> V_155 , V_154 ) ;
return V_57 ;
}
static T_1 F_147 ( struct V_2 * V_3 , int V_352 )
{
struct V_1 * V_4 = V_1 ( V_3 ) ;
unsigned long V_154 ;
T_1 V_353 ;
...
return V_353 ;
case V_361 :
V_353 = F_13 ( V_4 , V_325 ) ;
return ( V_353 >> 4 ) & 0x0ffff00f ;
case V_362 :
...
static void F_149 ( struct V_2 * V_3 , int V_352 , T_1 V_353 )
{
struct V_1 * V_4 = V_1 ( V_3 ) ;
unsigned long V_154 ;
switch ( V_352 ) {
case V_354 :
if ( ( V_353 & V_356 ) && V_4 -> V_268 ) {
F_11 ( V_4 , V_363 ,
V_270 ) ;
F_15 ( V_4 ) ;
}
...
break;
case V_358 :
F_11 ( V_4 , V_256 , V_353 >> 16 ) ;
F_15 ( V_4 ) ;
break;
case V_359 :
F_11 ( V_4 , V_246 , V_353 ) ;
F_11 ( V_4 , V_364 ,
V_20 ) ;
F_15 ( V_4 ) ;
break;
...
break;
case V_361 :
V_353 = ( V_353 & 0xf ) | ( ( V_353 & 0xf ) << 4 ) |
( ( V_353 & 0xf ) << 8 ) | ( ( V_353 & 0x0ffff000 ) << 4 ) ;
F_11 ( V_4 , V_325 , V_353 ) ;
F_15 ( V_4 ) ;
break;
case V_362 :
F_11 ( V_4 , V_333 , V_353 & 0x3f ) ;
F_15 ( V_4 ) ;
break;
default:
F_148 ( 1 ) ;
...
static void F_150 ( struct V_365 * V_63 )
{
V_63 -> V_366 . V_153 . V_367 ( & V_63 -> V_366 , V_63 -> V_368 ,
V_63 -> V_98 , V_63 -> V_34 ,
V_63 -> V_366 . V_369 ) ;
V_63 -> V_98 = 0 ;
}
static void F_151 ( struct V_365 * V_63 , const T_1 * V_370 )
{
T_1 * V_371 ;
if ( V_63 -> V_98 + V_63 -> V_366 . V_372 > V_71 ) {
if ( V_63 -> V_366 . V_373 )
return;
F_150 ( V_63 ) ;
}
V_371 = V_63 -> V_34 + V_63 -> V_98 ;
V_63 -> V_368 = ( V_374 ) F_72 ( ( V_40 T_4 ) V_370 [ 0 ] ) ;
if ( V_63 -> V_366 . V_372 > 0 )
V_371 [ 0 ] = F_152 ( V_370 [ 1 ] ) ;
if ( V_63 -> V_366 . V_372 > 4 )
V_371 [ 1 ] = F_152 ( V_370 [ 0 ] ) ;
if ( V_63 -> V_366 . V_372 > 8 )
memcpy ( & V_371 [ 2 ] , & V_370 [ 2 ] , V_63 -> V_366 . V_372 - 8 ) ;
V_63 -> V_98 += V_63 -> V_366 . V_372 ;
}
static int F_153 ( struct V_143 * V_143 ,
struct V_66 * V_67 ,
struct V_66 * V_85 )
{
struct V_365 * V_63 =
F_1 ( V_143 , struct V_365 , V_143 ) ;
struct V_66 * V_375 ;
T_1 V_376 ;
for ( V_375 = V_67 ; V_375 <= V_85 ; V_375 ++ )
if ( V_375 -> V_72 )
break;
if ( V_375 > V_85 )
return 0 ;
...
V_67 ++ ;
V_376 = F_72 ( V_67 -> V_139 ) ;
F_154 ( V_143 -> V_4 -> V_3 . V_79 ,
V_376 & V_377 ,
V_376 & ~ V_377 ,
F_49 ( V_67 -> V_134 ) ,
V_80 ) ;
}
F_151 ( V_63 , ( T_1 * ) ( V_85 + 1 ) ) ;
if ( V_85 -> V_135 & F_34 ( V_185 ) )
F_150 ( V_63 ) ;
return 1 ;
}
static int F_155 ( struct V_143 * V_143 ,
struct V_66 * V_67 ,
struct V_66 * V_85 )
{
struct V_365 * V_63 =
F_1 ( V_143 , struct V_365 , V_143 ) ;
unsigned int V_134 , V_70 , V_378 ;
T_1 V_376 ;
V_134 = F_49 ( V_85 -> V_134 ) ;
V_70 = F_49 ( F_47 ( V_85 -> V_70 ) ) ;
V_378 = V_134 - V_70 ;
V_376 = F_72 ( V_85 -> V_139 ) ;
if ( V_378 > 0 ) {
V_63 -> V_379 = V_376 ;
V_63 -> V_380 = V_378 ;
}
...
V_378 , V_80 ) ;
if ( V_85 -> V_135 & F_34 ( V_185 ) ) {
V_63 -> V_366 . V_153 . V_381 ( & V_63 -> V_366 ,
V_376 + V_378 ,
V_63 -> V_366 . V_369 ) ;
V_63 -> V_380 = 0 ;
}
...
static void F_156 ( struct V_365 * V_63 )
{
F_154 ( V_63 -> V_143 . V_4 -> V_3 . V_79 ,
V_63 -> V_379 & V_377 ,
V_63 -> V_379 & ~ V_377 ,
V_63 -> V_380 , V_80 ) ;
V_63 -> V_366 . V_153 . V_381 ( & V_63 -> V_366 ,
V_63 -> V_379 + V_63 -> V_380 ,
V_63 -> V_366 . V_369 ) ;
V_63 -> V_380 = 0 ;
}
static inline void F_157 ( struct V_143 * V_143 ,
struct V_66 * V_375 )
{
T_3 V_135 ;
T_1 V_376 ;
if ( V_375 -> V_135 & F_34 ( V_138 ) )
return;
V_375 += 2 ;
if ( ( F_72 ( V_375 -> V_139 ) & V_377 ) ==
( V_143 -> V_150 & V_377 ) ) {
if ( V_375 -> V_135 & F_34 ( V_138 ) )
return;
V_375 ++ ;
...
static int F_158 ( struct V_143 * V_143 ,
struct V_66 * V_67 ,
struct V_66 * V_85 )
{
struct V_365 * V_63 =
...
V_371 = V_63 -> V_34 + V_63 -> V_98 ;
V_63 -> V_368 = F_49 ( V_85 -> V_70 ) ;
* V_371 = F_106 ( ( F_49 ( V_375 -> V_72 ) << 16 ) |
F_49 ( V_375 -> V_70 ) ) ;
V_63 -> V_98 += 4 ;
if ( V_85 -> V_135 & F_34 ( V_185 ) )
F_150 ( V_63 ) ;
...
static void F_159 ( struct V_1 * V_4 , T_6 V_382 )
{
T_1 V_383 = V_382 >> 32 , V_384 = V_382 ;
...
static struct V_390 * F_161 ( struct V_2 * V_3 ,
int type , int V_391 , T_9 V_372 )
{
struct V_1 * V_4 = V_1 ( V_3 ) ;
struct V_365 * V_156 ( V_63 ) ;
T_5 V_156 ( V_153 ) ;
T_6 * V_156 ( V_382 ) ;
T_1 * V_156 ( V_392 ) , V_156 ( V_74 ) ;
int V_65 , V_57 = - V_53 ;
F_125 ( & V_4 -> V_155 ) ;
switch ( type ) {
case V_393 :
...
V_392 = & V_4 -> V_397 ;
V_153 = F_153 ;
V_65 = * V_382 & 1ULL << V_391 ? F_131 ( * V_392 ) - 1 : - 1 ;
if ( V_65 >= 0 ) {
* V_382 &= ~ ( 1ULL << V_391 ) ;
* V_392 &= ~ ( 1 << V_65 ) ;
V_74 = F_114 ( V_65 ) ;
...
V_392 = & V_4 -> V_397 ;
V_153 = F_155 ;
V_65 = ! V_4 -> V_399 ? F_131 ( * V_392 ) - 1 : - 1 ;
if ( V_65 >= 0 ) {
V_4 -> V_399 = true ;
* V_392 &= ~ ( 1 << V_65 ) ;
V_74 = F_114 ( V_65 ) ;
...
static int F_165 ( struct V_390 * V_366 ,
T_7 V_402 , T_1 V_403 , T_1 V_404 )
{
struct V_365 * V_63 = F_1 ( V_366 , struct V_365 , V_366 ) ;
struct V_1 * V_4 = V_63 -> V_143 . V_4 ;
T_1 V_135 = V_405 , V_406 ;
int V_65 ;
if ( V_63 -> V_143 . V_85 -> V_69 == 0 )
return - V_407 ;
switch ( V_63 -> V_366 . type ) {
case V_393 :
V_65 = V_63 - V_4 -> V_296 ;
V_406 = 0 ;
if ( V_402 >= 0 )
V_406 = V_408 |
( V_402 & 0x7fff ) << 16 ;
F_11 ( V_4 , V_295 , 1 << V_65 ) ;
F_11 ( V_4 , V_409 , 1 << V_65 ) ;
F_85 ( & V_63 -> V_143 , V_406 ) ;
break;
case V_398 :
V_135 |= V_410 | V_329 ;
case V_395 :
V_65 = V_63 - V_4 -> V_294 ;
V_406 = ( V_404 << 28 ) | ( V_403 << 8 ) | V_63 -> V_366 . V_391 ;
if ( V_402 >= 0 ) {
V_406 |= ( V_402 & 0x07fff ) << 12 ;
V_135 |= V_411 ;
}
F_11 ( V_4 , V_293 , 1 << V_65 ) ;
F_11 ( V_4 , V_412 , 1 << V_65 ) ;
F_11 ( V_4 , F_166 ( V_63 -> V_143 . V_74 ) , V_406 ) ;
...
static int F_167 ( struct V_390 * V_366 )
{
struct V_1 * V_4 = V_1 ( V_366 -> V_3 ) ;
struct V_365 * V_63 = F_1 ( V_366 , struct V_365 , V_366 ) ;
int V_65 ;
switch ( V_63 -> V_366 . type ) {
case V_393 :
...
F_15 ( V_4 ) ;
F_87 ( & V_63 -> V_143 ) ;
F_168 ( & V_63 -> V_143 . V_126 ) ;
return 0 ;
}
static void F_169 ( struct V_390 * V_366 )
{
struct V_1 * V_4 = V_1 ( V_366 -> V_3 ) ;
struct V_365 * V_63 = F_1 ( V_366 , struct V_365 , V_366 ) ;
unsigned long V_154 ;
...
static int F_170 ( struct V_390 * V_366 , T_6 * V_382 )
{
struct V_1 * V_4 = V_1 ( V_366 -> V_3 ) ;
unsigned long V_154 ;
int V_57 ;
...
V_63 = & V_4 -> V_294 [ V_49 ] ;
if ( V_63 -> V_143 . V_168 )
F_165 ( & V_63 -> V_366 , 0 , V_63 -> V_403 , V_63 -> V_404 ) ;
}
...
static int F_172 ( struct V_365 * V_63 ,
struct V_418 * V_174 ,
struct V_419 * V_76 ,
unsigned long V_109 )
{
struct V_66 * V_67 , * V_85 , * V_375 ;
struct V_418 * V_92 ;
T_4 * V_34 ;
T_2 V_166 , V_420 ;
T_1 V_141 , V_421 , V_422 , V_287 ;
T_1 V_423 , V_424 , V_425 ;
int V_59 , V_426 , V_49 , V_94 , V_43 ;
V_92 = V_174 ;
V_423 = V_109 ;
if ( V_92 -> V_427 )
V_141 = 1 ;
...
if ( V_92 -> V_98 > 0 )
V_141 ++ ;
V_426 = F_173 ( V_423 + V_92 -> V_99 ) >> V_428 ;
if ( V_92 -> V_99 > 0 )
V_422 = V_426 - ( V_423 >> V_428 ) ;
else
V_422 = 0 ;
V_141 += V_422 ;
V_421 = F_174 ( V_92 -> V_98 , sizeof( * V_67 ) ) ;
V_67 = F_84 ( & V_63 -> V_143 , V_141 + V_421 , & V_166 ) ;
if ( V_67 == NULL )
return - V_140 ;
if ( ! V_92 -> V_427 ) {
V_67 [ 0 ] . V_135 = F_34 ( V_178 ) ;
...
V_34 = ( T_4 * ) & V_67 [ 1 ] ;
V_34 [ 0 ] = F_33 ( F_175 ( V_92 -> V_429 ) |
F_176 ( V_92 -> V_430 ) |
F_177 ( V_181 ) |
F_178 ( V_63 -> V_366 . V_391 ) |
F_179 ( V_63 -> V_366 . V_31 ) ) ;
V_34 [ 1 ] =
F_33 ( F_180 ( V_92 -> V_98 +
V_92 -> V_99 ) ) ;
}
if ( V_92 -> V_98 > 0 ) {
...
V_375 = V_67 + V_141 - V_422 ;
V_424 = V_423 + V_92 -> V_99 ;
for ( V_49 = 0 ; V_49 < V_422 ; V_49 ++ ) {
V_59 = V_423 >> V_428 ;
V_43 = V_423 & ~ V_377 ;
V_425 = ( V_59 + 1 ) << V_428 ;
V_94 =
F_181 ( V_425 , V_424 ) - V_423 ;
V_375 [ V_49 ] . V_134 = F_34 ( V_94 ) ;
V_420 = F_31 ( V_76 -> V_64 [ V_59 ] ) ;
V_375 [ V_49 ] . V_139 = F_33 ( V_420 + V_43 ) ;
F_182 ( V_63 -> V_143 . V_4 -> V_3 . V_79 ,
V_420 , V_43 , V_94 ,
V_183 ) ;
V_423 += V_94 ;
}
...
V_138 |
V_287 ) ;
F_86 ( & V_63 -> V_143 , V_67 , V_141 , V_421 ) ;
return 0 ;
}
static int F_183 ( struct V_365 * V_63 ,
struct V_418 * V_174 ,
struct V_419 * V_76 ,
unsigned long V_109 )
{
struct V_79 * V_79 = V_63 -> V_143 . V_4 -> V_3 . V_79 ;
struct V_66 * V_67 , * V_375 ;
T_2 V_166 , V_420 ;
T_1 V_141 , V_421 , V_433 ;
int V_49 , V_261 , V_94 ;
int V_59 , V_43 , V_434 , V_372 , V_435 ;
V_434 = V_174 -> V_98 / V_63 -> V_366 . V_372 ;
V_372 = F_184 ( V_63 -> V_366 . V_372 , ( T_9 ) 8 ) ;
V_421 = F_174 ( V_372 , sizeof( * V_67 ) ) ;
V_59 = V_109 >> V_428 ;
V_43 = V_109 & ~ V_377 ;
V_435 = V_174 -> V_99 / V_434 ;
for ( V_49 = 0 ; V_49 < V_434 ; V_49 ++ ) {
V_141 = F_174 ( V_435 + V_43 , V_71 ) + 1 ;
...
V_136 ) ;
if ( V_174 -> V_427 && V_49 == 0 )
V_67 -> V_135 |= F_34 ( V_436 ) ;
V_67 -> V_134 = F_34 ( V_372 ) ;
...
V_375 ++ ;
V_375 -> V_135 = F_34 ( V_137 |
V_136 ) ;
if ( V_43 + V_433 < V_71 )
V_94 = V_433 ;
else
V_94 = V_71 - V_43 ;
V_375 -> V_134 = F_34 ( V_94 ) ;
V_375 -> V_70 = V_375 -> V_134 ;
V_375 -> V_72 = 0 ;
V_420 = F_31 ( V_76 -> V_64 [ V_59 ] ) ;
V_375 -> V_139 = F_33 ( V_420 + V_43 ) ;
F_182 ( V_79 , V_420 ,
V_43 , V_94 ,
V_80 ) ;
V_43 = ( V_43 + V_94 ) & ~ V_377 ;
V_433 -= V_94 ;
if ( V_43 == 0 )
V_59 ++ ;
}
...
V_437 |
V_138 ) ;
if ( V_174 -> V_431 && V_49 == V_434 - 1 )
V_375 -> V_135 |= F_34 ( V_185 ) ;
F_86 ( & V_63 -> V_143 , V_67 , V_141 , V_421 ) ;
}
return 0 ;
}
static int F_185 ( struct V_365 * V_63 ,
struct V_418 * V_174 ,
struct V_419 * V_76 ,
unsigned long V_109 )
{
struct V_66 * V_67 ;
T_2 V_166 , V_420 ;
int V_59 , V_43 , V_433 , V_141 , V_49 , V_94 ;
V_59 = V_109 >> V_428 ;
V_43 = V_109 & ~ V_377 ;
V_433 = V_174 -> V_99 ;
V_141 = F_174 ( V_43 + V_433 , V_71 ) ;
if ( F_148 ( V_43 & 3 || V_433 & 3 || V_59 + V_141 > V_76 -> V_438 ) )
return - V_439 ;
...
static int F_186 ( struct V_390 * V_366 ,
struct V_418 * V_174 ,
struct V_419 * V_76 ,
unsigned long V_109 )
{
...
switch ( V_366 -> type ) {
case V_393 :
V_57 = F_172 ( V_63 , V_174 , V_76 , V_109 ) ;
break;
case V_395 :
V_57 = F_183 ( V_63 , V_174 , V_76 , V_109 ) ;
break;
case V_398 :
V_57 = F_185 ( V_63 , V_174 , V_76 , V_109 ) ;
break;
}
F_75 ( & V_63 -> V_143 . V_4 -> V_155 , V_154 ) ;
return V_57 ;
}
static void F_187 ( struct V_390 * V_366 )
{
struct V_143 * V_63 =
& F_1 ( V_366 , struct V_365 , V_366 ) -> V_143 ;
F_11 ( V_63 -> V_4 , F_36 ( V_63 -> V_74 ) , V_75 ) ;
}
static int F_188 ( struct V_390 * V_366 )
{
struct V_365 * V_63 = F_1 ( V_366 , struct V_365 , V_366 ) ;
int V_57 = 0 ;
F_96 ( & V_63 -> V_143 . V_126 ) ;
if ( ! F_189 ( 0 , & V_63 -> V_440 ) ) {
...
static void F_192 ( struct V_441 * V_442 )
{
if ( F_193 ( V_443 ) ) {
struct V_444 * V_445 = F_194 ( V_442 ) ;
if ( V_445 ) {
F_195 ( V_446 , V_445 , 0 , 1 ) ;
F_195 ( V_447 , V_445 , 0 , 1 ) ;
}
}
}
static void F_196 ( struct V_441 * V_442 )
{
if ( F_193 ( V_443 ) ) {
struct V_444 * V_445 = F_194 ( V_442 ) ;
if ( V_445 ) {
F_195 ( V_447 , V_445 , 0 , 0 ) ;
F_195 ( V_446 , V_445 , 0 , 0 ) ;
}
}
}
static inline void F_192 ( struct V_441 * V_442 ) {}
static inline void F_196 ( struct V_441 * V_442 ) {}
static int F_197 ( struct V_441 * V_442 ,
const struct V_448 * V_449 )
{
struct V_1 * V_4 ;
T_1 V_450 , V_451 , V_452 , V_316 ;
T_6 V_453 ;
int V_49 , V_454 ;
T_9 V_304 ;
if ( V_442 -> V_455 == V_456 ) {
F_198 ( & V_442 -> V_442 , L_63 ) ;
return - V_400 ;
}
...
F_200 ( & V_4 -> V_3 , & V_458 , & V_442 -> V_442 ) ;
F_192 ( V_442 ) ;
V_454 = F_201 ( V_442 ) ;
if ( V_454 ) {
F_198 ( & V_442 -> V_442 , L_64 ) ;
goto V_459;
}
F_202 ( V_442 ) ;
F_203 ( V_442 , V_460 , 0 ) ;
...
F_205 ( & V_4 -> V_155 ) ;
F_206 ( & V_4 -> V_61 ) ;
F_207 ( & V_4 -> F_124 , F_124 ) ;
if ( ! ( F_208 ( V_442 , 0 ) & V_461 ) ||
F_209 ( V_442 , 0 ) < V_462 ) {
F_20 ( V_4 , L_65 ) ;
V_454 = - V_463 ;
goto V_464;
}
V_454 = F_210 ( V_442 , 0 , V_465 ) ;
if ( V_454 ) {
F_20 ( V_4 , L_66 ) ;
goto V_464;
}
V_4 -> V_45 = F_211 ( V_442 , 0 , V_462 ) ;
if ( V_4 -> V_45 == NULL ) {
F_20 ( V_4 , L_67 ) ;
V_454 = - V_463 ;
goto V_466;
}
for ( V_49 = 0 ; V_49 < F_9 ( V_467 ) ; V_49 ++ )
if ( ( V_467 [ V_49 ] . V_455 == V_442 -> V_455 ) &&
( V_467 [ V_49 ] . V_79 == ( unsigned short ) V_468 ||
V_467 [ V_49 ] . V_79 == V_442 -> V_79 ) &&
( V_467 [ V_49 ] . V_469 == ( unsigned short ) V_468 ||
V_467 [ V_49 ] . V_469 >= V_442 -> V_469 ) ) {
V_4 -> V_116 = V_467 [ V_49 ] . V_154 ;
break;
}
if ( V_470 )
V_4 -> V_116 = V_470 ;
...
V_454 = F_60 ( & V_4 -> V_118 , V_4 , 0 ,
V_473 ) ;
if ( V_454 < 0 )
goto V_474;
V_454 = F_60 ( & V_4 -> V_292 , V_4 , V_71 / 4 ,
V_475 ) ;
if ( V_454 < 0 )
goto V_476;
V_454 = F_79 ( & V_4 -> V_220 , V_4 ,
V_477 , F_98 ) ;
if ( V_454 < 0 )
goto V_478;
V_454 = F_79 ( & V_4 -> V_226 , V_4 ,
V_479 , F_98 ) ;
if ( V_454 < 0 )
goto V_480;
F_11 ( V_4 , V_412 , ~ 0 ) ;
V_4 -> V_396 = ~ 0ULL ;
V_4 -> V_235 = F_13 ( V_4 , V_412 ) ;
F_11 ( V_4 , V_414 , ~ 0 ) ;
V_4 -> V_397 = V_4 -> V_235 ;
V_4 -> V_416 = F_212 ( V_4 -> V_397 ) ;
V_304 = sizeof( struct V_365 ) * V_4 -> V_416 ;
V_4 -> V_294 = F_199 ( V_304 , V_127 ) ;
F_11 ( V_4 , V_409 , ~ 0 ) ;
V_4 -> V_234 = F_13 ( V_4 , V_409 ) ;
F_11 ( V_4 , V_413 , ~ 0 ) ;
V_4 -> V_394 = V_4 -> V_234 ;
V_4 -> V_417 = F_212 ( V_4 -> V_394 ) ;
V_304 = sizeof( struct V_365 ) * V_4 -> V_417 ;
V_4 -> V_296 = F_199 ( V_304 , V_127 ) ;
if ( V_4 -> V_296 == NULL || V_4 -> V_294 == NULL ) {
V_454 = - V_140 ;
goto V_481;
}
V_4 -> V_253 = V_4 -> V_131 + V_71 / 2 ;
V_4 -> V_323 = V_4 -> V_133 + V_71 / 2 ;
V_450 = F_13 ( V_4 , V_280 ) ;
V_451 = ( V_450 >> 12 ) & 0xf ;
V_452 = V_450 & 0x7 ;
V_453 = ( ( T_6 ) F_13 ( V_4 , V_482 ) << 32 ) |
F_13 ( V_4 , V_483 ) ;
if ( ! ( V_4 -> V_116 & V_484 ) )
F_213 ( V_442 ) ;
if ( F_214 ( V_442 -> V_287 , F_128 ,
F_215 ( V_442 ) ? 0 : V_485 ,
V_465 , V_4 ) ) {
F_20 ( V_4 , L_68 , V_442 -> V_287 ) ;
V_454 = - V_320 ;
goto V_486;
}
V_454 = F_216 ( & V_4 -> V_3 , V_451 , V_452 , V_453 ) ;
if ( V_454 )
goto V_487;
V_316 = F_13 ( V_4 , V_46 ) & 0x00ff00ff ;
F_4 ( V_4 ,
L_69
L_70 ,
V_316 >> 16 , V_316 & 0xff , V_4 -> V_3 . V_65 ,
V_4 -> V_416 , V_4 -> V_417 , V_4 -> V_116 ,
F_13 ( V_4 , V_336 ) ?
L_71 : L_3 ) ;
return 0 ;
V_487:
F_217 ( V_442 -> V_287 , V_4 ) ;
V_486:
F_218 ( V_442 ) ;
V_481:
F_219 ( V_4 -> V_294 ) ;
...
static void F_223 ( struct V_441 * V_442 )
{
struct V_1 * V_4 = F_224 ( V_442 ) ;
if ( F_13 ( V_4 , V_300 ) & V_318 ) {
F_11 ( V_4 , V_338 , ~ 0 ) ;
F_15 ( V_4 ) ;
}
F_225 ( & V_4 -> F_124 ) ;
...
F_219 ( V_4 ) ;
F_196 ( V_442 ) ;
F_227 ( & V_442 -> V_442 , L_72 ) ;
}
static int F_228 ( struct V_441 * V_442 , T_11 V_488 )
{
struct V_1 * V_4 = F_224 ( V_442 ) ;
int V_454 ;
F_135 ( V_4 ) ;
...
V_454 = F_230 ( V_442 , F_231 ( V_442 , V_488 ) ) ;
if ( V_454 )
F_20 ( V_4 , L_74 , V_454 ) ;
F_196 ( V_442 ) ;
return 0 ;
}
static int F_232 ( struct V_441 * V_442 )
{
struct V_1 * V_4 = F_224 ( V_442 ) ;
int V_454 ;
F_192 ( V_442 ) ;
...
if ( ! F_13 ( V_4 , V_483 ) &&
! F_13 ( V_4 , V_482 ) ) {
F_11 ( V_4 , V_483 , ( T_1 ) V_4 -> V_3 . V_453 ) ;
F_11 ( V_4 , V_482 , ( T_1 ) ( V_4 -> V_3 . V_453 >> 32 ) ) ;
}
V_454 = F_139 ( & V_4 -> V_3 , NULL , 0 ) ;
if ( V_454 )
return V_454 ;
F_171 ( V_4 ) ;
return 0 ;
}
static int T_12 F_234 ( void )
{
V_291 = F_235 ( V_490 , V_491 , 0 ) ;
if ( ! V_291 )
return - V_140 ;
return F_236 ( & V_492 ) ;
}
