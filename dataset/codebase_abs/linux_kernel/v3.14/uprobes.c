...
static void F_195 ( struct V_166 * V_167 )
{
struct V_56 * V_56 ;
unsigned long V_193 ;
int V_209 ( V_43 ) ;
...
static void F_198 ( struct V_168 * V_165 , struct V_166 * V_167 )
{
struct V_56 * V_56 ;
V_56 = V_165 -> V_172 ;
if ( V_165 -> V_194 == V_211 )
F_199 ( & V_56 -> V_92 , V_167 ) ;
