...
return - V_24 ;
V_36 = F_30 ( V_34 , V_44 , 0 ) ;
if ( ! V_36 ) {
F_31 ( & V_34 -> V_39 , L_3 ) ;
return - V_24 ;
}
V_1 = F_32 ( & V_34 -> V_39 , sizeof( * V_1 ) , V_45 ) ;
if ( V_1 == NULL )
return - V_46 ;
F_33 ( & V_1 -> V_9 ) ;
V_1 -> V_4 = F_34 ( & V_34 -> V_39 , V_36 ) ;
if ( F_35 ( V_1 -> V_4 ) )
return F_36 ( V_1 -> V_4 ) ;
V_1 -> V_12 . V_47 = F_37 ( V_38 ) ;
...
static int T_3 F_47 ( struct V_33 * V_34 )
{
