...
if ( V_21 ) {
F_11 ( V_9 -> V_36 , F_12 ( V_9 -> V_24 ) ) ;
F_13 ( V_9 -> V_36 , V_21 * V_23 ) ;
F_14 ( V_9 -> V_36 ) ;
}
F_15 ( V_5 ) ;
V_15 -> V_27 |= V_42 ;
F_5 ( V_7 , V_12 ) ;
F_16 ( 0x00 , V_7 -> V_28 + V_43 ) ;
return V_26 ;
}
static int F_4 ( struct V_6 * V_7 , struct V_11 * V_12 )
{
struct V_8 * V_9 = V_7 -> V_10 ;
V_9 -> V_44 &= ~ V_45 & ~ V_46 ;
F_16 ( V_9 -> V_44 , V_7 -> V_28 + V_47 ) ;
F_7 ( V_9 -> V_36 ) ;
F_16 ( 0 , V_7 -> V_28 + V_48 ) ;
return 0 ;
}
...
V_9 -> V_37 -=
V_9 -> V_37 % sizeof( V_9 -> V_24 [ 0 ] ) ;
F_13 ( V_9 -> V_36 , V_9 -> V_37 ) ;
F_14 ( V_9 -> V_36 ) ;
F_15 ( V_69 ) ;
F_16 ( 0x00 , V_7 -> V_28 + V_43 ) ;
V_9 -> V_44 |= V_45 | V_46 ;
F_16 ( V_9 -> V_44 , V_7 -> V_28 + V_47 ) ;
F_29 ( V_7 -> V_28 + V_79 , 0 , 2 , 72 , 0 ) ;
V_72 = 0 ;
if ( V_17 -> V_54 == V_55 &&
( V_70 & V_80 ) !=
( V_9 -> V_71 & V_80 ) ) {
...
F_16 ( V_72 , V_7 -> V_28 + V_85 ) ;
if ( V_17 -> V_54 == V_55 )
F_16 ( 0 , V_7 -> V_28 + V_86 ) ;
return 0 ;
}
static int F_30 ( struct V_6 * V_7 , struct V_11 * V_12 ,
struct V_87 * V_88 , unsigned int * V_89 )
{
struct V_8 * V_9 = V_7 -> V_10 ;
unsigned int V_3 , V_90 ;
static const int V_91 = 100000 ;
static const int V_92 = 36 ;
F_16 ( 0 , V_7 -> V_28 + V_48 ) ;
if ( F_27 ( V_7 , F_24 ( V_88 -> V_93 ) , 1 ) < 0 )
return - 1 ;
V_9 -> V_71 &= ~ V_75 ;
V_9 -> V_71 &= ~ V_76 ;
F_16 ( V_9 -> V_71 , V_7 -> V_28 + V_77 ) ;
...
static int F_37 ( struct V_6 * V_7 , struct V_114 * V_115 )
{
const struct V_49 * V_50 = F_18 ( V_7 ) ;
struct V_8 * V_9 ;
struct V_11 * V_12 ;
...
int V_3 ;
int V_117 ;
V_9 = F_38 ( V_7 , sizeof( * V_9 ) ) ;
if ( ! V_9 )
return - V_118 ;
V_117 = F_39 ( V_7 , V_115 -> V_116 [ 0 ] , V_119 ) ;
if ( V_117 )
return V_117 ;
V_7 -> V_120 = V_121 + F_35 ( V_7 ) ;
V_50 = F_18 ( V_7 ) ;
V_7 -> V_122 = V_50 -> V_123 ;
if ( ( V_1 >= 3 && V_1 <= 7 ) || ( V_1 >= 9 && V_1 <= 12 ) ||
V_1 == 14 || V_1 == 15 ) {
V_117 = F_40 ( V_1 , F_1 , 0 ,
V_7 -> V_122 , V_7 ) ;
if ( V_117 == 0 ) {
V_9 -> V_44 |= F_41 ( V_1 ) ;
V_7 -> V_1 = V_1 ;
...
F_16 ( V_143 , V_7 -> V_28 + V_144 ) ;
F_16 ( V_9 -> V_44 , V_7 -> V_28 + V_47 ) ;
F_47 ( V_145 | V_146 , V_7 -> V_28 + V_77 ) ;
F_47 ( V_145 , V_7 -> V_28 + V_77 ) ;
V_9 -> V_71 = 0 ;
F_16 ( V_9 -> V_71 , V_7 -> V_28 + V_77 ) ;
for ( V_3 = 0 ; V_3 < V_91 ; V_3 ++ ) {
if ( ( V_147 & F_3 ( V_7 -> V_28 + V_29 ) ) == 0 )
break;
F_31 ( 1000 ) ;
}
if ( V_3 == V_91 ) {
...
struct V_8 * V_9 = V_7 -> V_10 ;
if ( V_7 -> V_28 )
F_16 ( V_146 | V_145 , V_7 -> V_28 + V_77 ) ;
if ( V_9 ) {
if ( V_9 -> V_36 )
F_50 ( V_9 -> V_36 ) ;
F_51 ( V_9 -> V_24 ) ;
