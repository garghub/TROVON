...
goto V_38;
F_19 ( V_2 -> V_5 . V_6 ) ;
F_20 ( V_4 -> V_25 , V_39 , 1 ) ;
F_21 ( V_4 -> V_25 , V_40 , 1 << 6 , 0 ) ;
return 0 ;
V_38:
F_22 ( V_2 -> V_35 ) ;
V_36:
F_23 ( V_2 -> V_32 , V_2 -> V_33 ) ;
V_34:
F_24 ( V_2 ) ;
V_30:
F_25 ( V_4 ) ;
...
if ( V_16 )
F_23 ( V_16 -> V_22 , F_12 ( V_16 ) ) ;
F_21 ( V_10 -> V_4 . V_25 , V_40 , 0 , 1 << 6 ) ;
F_20 ( V_10 -> V_4 . V_25 , V_39 , 0 ) ;
return 0 ;
}
...
bool V_44 = F_30 ( V_4 ) ;
int V_7 ;
if ( F_31 ( V_45 , V_43 -> V_46 ) )
F_32 ( 5 ) ;
V_43 -> V_46 = V_45 ;
V_7 = F_33 ( V_2 , V_44 ) ;
if ( V_7 )
return V_7 ;
F_20 ( V_4 -> V_25 , V_39 , 0 ) ;
return V_7 ;
}
