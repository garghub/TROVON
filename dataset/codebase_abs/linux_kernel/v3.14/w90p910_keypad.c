...
V_2 = F_20 ( sizeof( struct V_1 ) , V_43 ) ;
V_4 = F_21 () ;
if ( ! V_2 || ! V_4 ) {
F_18 ( & V_36 -> V_22 , L_3 ) ;
error = - V_44 ;
...
V_2 -> V_4 = V_4 ;
V_2 -> V_13 = V_13 ;
V_40 = F_22 ( V_36 , V_46 , 0 ) ;
if ( V_40 == NULL ) {
F_18 ( & V_36 -> V_22 , L_4 ) ;
error = - V_42 ;
goto V_45;
}
V_40 = F_23 ( V_40 -> V_47 , F_24 ( V_40 ) , V_36 -> V_48 ) ;
if ( V_40 == NULL ) {
F_18 ( & V_36 -> V_22 , L_5 ) ;
error = - V_49 ;
goto V_45;
}
V_2 -> V_17 = F_25 ( V_40 -> V_47 , F_24 ( V_40 ) ) ;
if ( V_2 -> V_17 == NULL ) {
F_18 ( & V_36 -> V_22 , L_6 ) ;
error = - V_42 ;
goto V_50;
}
V_2 -> V_26 = F_26 ( & V_36 -> V_22 , NULL ) ;
if ( F_27 ( V_2 -> V_26 ) ) {
F_18 ( & V_36 -> V_22 , L_7 ) ;
error = F_28 ( V_2 -> V_26 ) ;
goto V_51;
...
V_4 -> V_55 = F_10 ;
V_4 -> V_56 = F_14 ;
V_4 -> V_22 . V_57 = & V_36 -> V_22 ;
error = F_30 ( V_38 , NULL ,
V_58 , V_59 ,
V_2 -> V_10 , V_4 ) ;
if ( error ) {
F_18 ( & V_36 -> V_22 , L_8 ) ;
