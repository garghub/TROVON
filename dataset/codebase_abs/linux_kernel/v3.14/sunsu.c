...
V_244 = F_84 ( & V_2 -> V_4 . V_24 , V_39 ) ;
else
F_21 ( & V_2 -> V_4 . V_24 , V_39 ) ;
V_28 = F_1 ( V_2 , V_30 ) ;
F_5 ( V_2 , V_30 , 0 ) ;
F_85 ( & V_2 -> V_4 , V_242 , V_72 , F_82 ) ;
F_80 ( V_2 ) ;
F_5 ( V_2 , V_30 , V_28 ) ;
if ( V_244 )
F_22 ( & V_2 -> V_4 . V_24 , V_39 ) ;
}
static int T_3 F_86 ( struct V_240 * V_241 , char * V_247 )
{
...
static inline struct V_240 * F_89 ( void )
{
return & V_254 ;
}
static enum V_104 F_90 ( struct V_255 * V_256 )
{
struct V_255 * V_257 = F_91 ( L_11 ) ;
if ( V_257 ) {
const char * V_258 = F_92 ( V_257 , L_12 , NULL ) ;
const char * V_259 = F_92 ( V_257 , L_13 , NULL ) ;
if ( V_258 ) {
if ( V_256 == F_91 ( V_258 ) )
return V_105 ;
}
...
static int F_93 ( struct V_260 * V_261 )
{
...
V_2 -> V_270 = F_95 ( V_263 ) ;
V_2 -> V_4 . V_11 = F_96 ( V_263 , 0 , V_2 -> V_270 , L_14 ) ;
if ( ! V_2 -> V_4 . V_11 ) {
if ( type != V_144 )
F_97 ( V_2 ) ;
return - V_268 ;
...
return 0 ;
V_275:
F_98 ( & V_261 -> V_262 [ 0 ] , V_2 -> V_4 . V_11 , V_2 -> V_270 ) ;
return V_265 ;
}
static int F_102 ( struct V_260 * V_261 )
{
struct V_1 * V_2 = F_103 ( V_261 ) ;
bool V_277 = false ;
if ( V_2 -> V_104 == V_107 ||
V_2 -> V_104 == V_105 )
V_277 = true ;
