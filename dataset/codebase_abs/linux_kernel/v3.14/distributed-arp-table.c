...
if ( ! V_2 -> V_88 )
return NULL ;
V_73 = F_33 ( V_93 * sizeof( * V_73 ) , V_51 ) ;
if ( ! V_73 )
return NULL ;
V_87 = ( T_5 ) F_22 ( & V_59 ,
V_90 ) ;
...
if ( ! V_99 )
goto V_50;
F_31 ( V_49 , V_2 , L_16 , & V_40 ) ;
for ( V_18 = 0 ; V_18 < V_93 ; V_18 ++ ) {
if ( V_99 [ V_18 ] . type == V_89 )
continue;
V_97 = F_43 ( V_99 [ V_18 ] . V_85 ,
V_100 ) ;
if ( ! V_97 )
goto V_101;
V_98 = F_44 ( V_33 , V_51 ) ;
...
void F_55 ( struct V_110 * V_111 )
{
struct V_1 * V_2 = F_56 ( V_111 ) ;
F_51 ( V_2 ) ;
}
...
int F_66 ( struct V_117 * V_118 , void * V_119 )
{
...
if ( ! V_122 )
goto V_50;
F_68 ( V_118 , L_17 , V_111 -> V_127 ) ;
F_68 ( V_118 , L_18 , L_19 ,
L_20 , L_21 , L_22 ) ;
for ( V_18 = 0 ; V_18 < V_19 -> V_20 ; V_18 ++ ) {
V_17 = & V_19 -> V_21 [ V_18 ] ;
F_25 () ;
...
T_3 * V_129 , * V_130 ;
T_4 type = 0 ;
if ( F_36 ( ! F_72 ( V_33 , V_34 + V_37 ) ) )
goto V_50;
V_128 = (struct V_128 * ) ( V_33 -> V_36 + V_34 ) ;
if ( V_128 -> V_131 != F_73 ( V_132 ) )
goto V_50;
if ( F_36 ( ! F_72 ( V_33 , V_34 + V_37 +
F_74 ( V_33 -> V_133 ) ) ) )
goto V_50;
V_38 = (struct V_38 * ) ( V_33 -> V_36 + V_34 + V_37 ) ;
if ( V_38 -> V_134 != F_73 ( V_135 ) )
goto V_50;
if ( V_38 -> V_136 != F_73 ( V_137 ) )
goto V_50;
if ( V_38 -> V_138 != V_39 )
goto V_50;
if ( V_38 -> V_139 != 4 )
...
V_58 = F_19 ( V_33 , V_34 ) ;
V_59 = F_21 ( V_33 , V_34 ) ;
if ( F_75 ( V_58 ) || F_76 ( V_58 ) ||
F_75 ( V_59 ) || F_76 ( V_59 ) ||
F_77 ( V_58 ) || F_78 ( V_58 ) ||
F_77 ( V_59 ) || F_78 ( V_59 ) )
goto V_50;
V_129 = F_18 ( V_33 , V_34 ) ;
if ( F_79 ( V_129 ) || F_80 ( V_129 ) )
goto V_50;
if ( V_38 -> V_140 != F_73 ( V_141 ) ) {
V_130 = F_20 ( V_33 , V_34 ) ;
if ( F_79 ( V_130 ) ||
F_80 ( V_130 ) )
goto V_50;
}
type = F_81 ( V_38 -> V_140 ) ;
V_50:
return type ;
}
static unsigned short F_82 ( struct V_32 * V_33 , int * V_34 )
{
unsigned short V_41 ;
V_41 = F_83 ( V_33 , * V_34 ) ;
if ( V_41 & V_142 )
...
if ( V_8 ) {
if ( F_85 ( V_2 , V_8 -> V_46 ,
V_145 ) ) {
V_81 = true ;
goto V_50;
}
V_144 = F_86 ( V_146 , V_132 , V_58 ,
V_2 -> V_147 , V_59 , V_129 ,
V_8 -> V_46 , V_129 ) ;
if ( ! V_144 )
goto V_50;
if ( V_41 & V_142 )
V_144 = F_87 ( V_144 , F_73 ( V_148 ) ,
V_41 & V_149 ) ;
F_88 ( V_144 ) ;
V_144 -> V_150 = F_89 ( V_144 ,
V_2 -> V_147 ) ;
V_2 -> V_151 . V_152 ++ ;
V_2 -> V_151 . V_153 += V_33 -> V_154 + V_37 + V_34 ;
V_2 -> V_147 -> V_155 = V_48 ;
F_90 ( V_144 ) ;
F_31 ( V_49 , V_2 , L_25 ) ;
V_81 = true ;
} else {
V_81 = F_42 ( V_2 , V_33 , V_59 ,
V_67 ) ;
}
V_50:
if ( V_8 )
...
V_156 = F_92 ( V_2 , V_144 ,
V_68 ,
NULL , V_41 ) ;
else
V_156 = F_93 ( V_2 , V_144 , NULL , V_41 ) ;
if ( V_156 != V_157 ) {
F_48 ( V_2 , V_158 ) ;
V_81 = true ;
}
...
F_42 ( V_2 , V_33 , V_58 , V_66 ) ;
F_42 ( V_2 , V_33 , V_59 , V_66 ) ;
}
...
if ( V_160 -> V_161 )
goto V_50;
V_41 = F_82 ( V_160 -> V_33 , & V_34 ) ;
type = F_71 ( V_2 , V_160 -> V_33 , V_34 ) ;
if ( type != V_141 )
goto V_50;
V_59 = F_21 ( V_160 -> V_33 , V_34 ) ;
V_8 = F_24 ( V_2 , V_59 , V_41 ) ;
if ( ! V_8 ) {
F_31 ( V_49 , V_2 ,
L_29 , & V_59 ) ;
