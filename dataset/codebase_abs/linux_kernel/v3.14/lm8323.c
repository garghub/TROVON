...
{
struct V_104 * V_105 = F_50 ( & V_9 -> V_10 ) ;
struct V_106 * V_26 ;
struct V_1 * V_2 ;
int V_51 ;
int V_5 , V_107 ;
...
V_107 = F_39 ( V_2 , V_51 + 1 , & V_9 -> V_10 ,
V_105 -> V_115 [ V_51 ] ) ;
if ( V_107 < 0 )
goto V_116;
}
V_2 -> V_25 = true ;
V_107 = F_44 ( & V_9 -> V_10 , & V_117 ) ;
if ( V_107 < 0 )
goto V_116;
...
V_107 = F_62 ( V_9 -> V_57 , NULL , F_22 ,
V_128 | V_129 , L_31 , V_2 ) ;
if ( V_107 ) {
...
static int F_70 ( struct V_102 * V_9 )
{
...
F_67 ( V_2 -> V_51 [ V_5 ] . V_98 . V_10 , & V_100 ) ;
