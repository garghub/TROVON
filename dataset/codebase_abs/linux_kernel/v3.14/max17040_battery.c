...
if ( ! F_20 ( V_53 , V_55 ) )
return - V_56 ;
V_8 = F_21 ( & V_21 -> V_25 , sizeof( * V_8 ) , V_57 ) ;
if ( ! V_8 )
return - V_58 ;
V_8 -> V_21 = V_21 ;
...
static int F_29 ( struct V_66 * V_25 )
{
struct V_20 * V_21 = F_30 ( V_25 ) ;
struct V_7 * V_8 = F_10 ( V_21 ) ;
F_28 ( & V_8 -> V_48 ) ;
return 0 ;
}
static int F_31 ( struct V_66 * V_25 )
{
struct V_20 * V_21 = F_30 ( V_25 ) ;
struct V_7 * V_8 = F_10 ( V_21 ) ;
F_17 ( & V_8 -> V_48 , V_49 ) ;
