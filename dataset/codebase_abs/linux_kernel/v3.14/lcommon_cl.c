...
T_8 F_170 ( struct V_289 * V_290 )
{
T_8 type = 0 ;
struct V_291 * V_292 ;
int V_293 = 0 ;
if ( F_171 ( V_290 -> V_294 ) & V_295 ) {
const unsigned V_296 = sizeof( struct V_291 ) - 1 ;
V_293 = F_172 ( V_290 -> V_297 ) ;
V_293 = ( V_293 + V_296 ) & ~ V_296 ;
V_292 = ( void * ) V_290 -> V_298 + V_293 ;
type = F_173 ( F_172 ( V_292 -> V_299 ) ) ;
}
return type ;
}
V_204 F_174 ( const struct V_263 * V_264 , int V_300 )
{
if ( V_301 == 32 || V_300 )
return F_175 ( V_264 ) ;
else
...
V_302 = ( F_176 ( V_264 ) >> 32 ) ;
return V_302 ;
}
struct V_303 * F_180 ( struct V_112 * V_112 )
{
return F_181 ( F_123 ( V_112 ) -> V_236 ) ;
}
void inline F_182 ( struct V_112 * V_112 , struct V_303 * V_276 )
{
