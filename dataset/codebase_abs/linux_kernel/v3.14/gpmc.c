...
V_115 -> V_4 = V_2 ;
V_115 -> V_252 = V_246 ;
V_115 -> V_253 = F_88 ( V_246 , L_57 , 0 ) ;
if ( V_115 -> V_253 == NULL )
V_115 -> V_253 =
F_88 ( V_246 , L_58 , 0 ) ;
if ( V_115 -> V_253 == NULL )
F_64 ( L_59 , V_91 ) ;
if ( F_89 ( V_246 , L_60 , & V_247 ) ) {
F_35 ( L_61 , V_91 ) ;
return - V_92 ;
}
if ( ! strcmp ( V_247 , L_62 ) || ! strcmp ( V_247 , L_63 ) ||
! strcmp ( V_247 , L_64 ) || ! strcmp ( V_247 , L_65 ) )
V_115 -> V_254 =
V_255 ;
else if ( ! strcmp ( V_247 , L_66 ) )
if ( V_115 -> V_253 )
V_115 -> V_254 =
V_256 ;
else
...
F_35 ( L_68 , V_91 ) ;
if ( ! F_89 ( V_246 , L_69 , & V_247 ) )
for ( V_2 = 0 ; V_2 < F_90 ( V_260 ) ; V_2 ++ )
if ( ! strcasecmp ( V_247 , V_260 [ V_2 ] ) ) {
V_115 -> V_261 = V_2 ;
break;
}
V_2 = F_91 ( V_246 ) ;
...
static int F_93 ( struct V_244 * V_245 ,
struct V_242 * V_246 )
{
T_1 V_2 ;
struct V_264 * V_265 ;
...
V_265 = F_87 ( & V_245 -> V_249 , sizeof( * V_265 ) ,
V_251 ) ;
if ( ! V_265 )
return - V_93 ;
V_265 -> V_4 = V_2 ;
...
static int F_95 ( struct V_244 * V_245 ,
struct V_242 * V_246 )
{
struct V_213 V_214 ;
struct V_40 V_172 ;
...
if ( F_96 ( V_246 , 0 , & V_81 ) < 0 ) {
F_86 ( & V_245 -> V_249 , L_71 ,
V_246 -> V_250 ) ;
return - V_92 ;
}
V_88 = F_36 ( V_4 , F_39 ( & V_81 ) , & V_70 ) ;
if ( V_88 < 0 ) {
F_86 ( & V_245 -> V_249 , L_72 , V_4 ) ;
return V_88 ;
}
if ( F_97 ( V_246 , L_73 ) ||
F_97 ( V_246 , L_74 ) ||
...
if ( V_88 < 0 ) {
F_86 ( & V_245 -> V_249 , L_77 ,
V_4 , & V_81 . V_85 ) ;
goto V_268;
}
F_81 ( V_246 , & V_214 ) ;
V_88 = F_83 ( V_246 , L_78 , & V_214 . V_219 ) ;
if ( V_88 < 0 )
goto V_268;
V_88 = F_75 ( V_4 , & V_214 ) ;
if ( V_88 < 0 )
...
F_18 ( V_4 , & V_172 ) ;
V_267:
if ( F_99 ( V_246 , NULL , & V_245 -> V_249 ) )
return 0 ;
F_86 ( & V_245 -> V_249 , L_79 , V_246 -> V_154 ) ;
V_88 = - V_92 ;
V_268:
F_40 ( V_4 ) ;
return V_88 ;
...
F_101 ( V_271 , & V_245 -> V_249 ) ;
if ( ! V_270 )
return 0 ;
V_88 = F_83 ( V_245 -> V_249 . V_252 , L_80 ,
& V_90 ) ;
if ( V_88 < 0 ) {
F_35 ( L_81 , V_91 ) ;
return V_88 ;
...
V_88 = F_83 ( V_245 -> V_249 . V_252 , L_84 ,
& V_234 ) ;
if ( V_88 < 0 ) {
F_35 ( L_85 , V_91 ) ;
return V_88 ;
...
if ( ! V_246 -> V_154 )
continue;
if ( F_103 ( V_246 -> V_154 , L_86 ) == 0 )
V_88 = F_85 ( V_245 , V_246 ) ;
else if ( F_103 ( V_246 -> V_154 , L_87 ) == 0 )
V_88 = F_93 ( V_245 , V_246 ) ;
else if ( F_103 ( V_246 -> V_154 , L_88 ) == 0 ||
F_103 ( V_246 -> V_154 , L_89 ) == 0 ||
F_103 ( V_246 -> V_154 , L_90 ) == 0 )
V_88 = F_95 ( V_245 , V_246 ) ;
...
static int F_106 ( struct V_244 * V_245 )
{
int V_273 ;
T_1 V_18 ;
struct V_80 * V_81 ;
V_81 = F_107 ( V_245 , V_274 , 0 ) ;
if ( V_81 == NULL )
return - V_275 ;
V_276 = V_81 -> V_85 ;
V_277 = F_39 ( V_81 ) ;
V_3 = F_108 ( & V_245 -> V_249 , V_81 ) ;
if ( F_109 ( V_3 ) )
return F_110 ( V_3 ) ;
V_81 = F_107 ( V_245 , V_278 , 0 ) ;
if ( V_81 == NULL )
F_98 ( & V_245 -> V_249 , L_92 ) ;
else
V_151 = V_81 -> V_85 ;
V_9 = F_111 ( & V_245 -> V_249 , L_93 ) ;
if ( F_109 ( V_9 ) ) {
F_86 ( & V_245 -> V_249 , L_94 ) ;
V_151 = 0 ;
return F_110 ( V_9 ) ;
}
F_112 ( & V_245 -> V_249 ) ;
...
static int F_119 ( struct V_244 * V_245 )
{
F_56 () ;
F_62 () ;
F_117 ( & V_245 -> V_249 ) ;
...
static int F_121 ( struct V_282 * V_249 )
{
F_122 () ;
F_117 ( V_249 ) ;
return 0 ;
}
static int F_123 ( struct V_282 * V_249 )
{
F_113 ( V_249 ) ;
F_124 () ;
return 0 ;
...
V_245 = F_132 ( V_287 , - 1 , V_285 , NULL , 0 ) ;
F_104 ( F_109 ( V_245 ) , L_99 , V_286 ) ;
return F_133 ( V_245 ) ;
}
...
{
int V_108 ;
V_290 . V_291 = F_3 ( V_292 ) ;
V_290 . V_293 = F_3 ( V_101 ) ;
V_290 . V_294 = F_3 ( V_295 ) ;
V_290 . V_296 = F_3 ( V_105 ) ;
V_290 . V_297 = F_3 ( V_118 ) ;
V_290 . V_298 = F_3 ( V_120 ) ;
V_290 . V_299 = F_3 ( V_122 ) ;
for ( V_108 = 0 ; V_108 < V_90 ; V_108 ++ ) {
V_290 . V_300 [ V_108 ] . V_301 = F_24 ( V_108 ) ;
if ( V_290 . V_300 [ V_108 ] . V_301 ) {
V_290 . V_300 [ V_108 ] . V_218 =
F_6 ( V_108 , V_21 ) ;
V_290 . V_300 [ V_108 ] . V_302 =
F_6 ( V_108 , V_24 ) ;
V_290 . V_300 [ V_108 ] . V_303 =
F_6 ( V_108 , V_27 ) ;
V_290 . V_300 [ V_108 ] . V_304 =
F_6 ( V_108 , V_30 ) ;
V_290 . V_300 [ V_108 ] . V_305 =
F_6 ( V_108 , V_52 ) ;
V_290 . V_300 [ V_108 ] . V_306 =
F_6 ( V_108 , V_34 ) ;
V_290 . V_300 [ V_108 ] . V_307 =
F_6 ( V_108 , V_74 ) ;
}
}
}
...
{
int V_108 ;
F_1 ( V_292 , V_290 . V_291 ) ;
F_1 ( V_101 , V_290 . V_293 ) ;
F_1 ( V_295 , V_290 . V_294 ) ;
F_1 ( V_105 , V_290 . V_296 ) ;
F_1 ( V_118 , V_290 . V_297 ) ;
F_1 ( V_120 , V_290 . V_298 ) ;
F_1 ( V_122 , V_290 . V_299 ) ;
for ( V_108 = 0 ; V_108 < V_90 ; V_108 ++ ) {
if ( V_290 . V_300 [ V_108 ] . V_301 ) {
F_5 ( V_108 , V_21 ,
V_290 . V_300 [ V_108 ] . V_218 ) ;
