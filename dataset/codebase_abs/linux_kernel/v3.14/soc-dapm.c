...
{
if ( V_9 -> V_62 ) {
* V_46 = F_39 ( V_9 -> V_62 , V_38 ) ;
return 0 ;
} else if ( V_9 -> V_68 ) {
* V_46 = F_40 ( V_9 -> V_68 , V_38 ) ;
return 0 ;
}
...
struct V_8 * V_253 = NULL , * V_254 = NULL ;
const char * V_144 ;
const char * V_58 ;
char V_255 [ 80 ] ;
char V_256 [ 80 ] ;
int V_76 ;
if ( V_12 -> V_62 && V_12 -> V_62 -> V_141 && ! V_252 ) {
snprintf ( V_255 , sizeof( V_255 ) , L_7 ,
V_12 -> V_62 -> V_141 , V_251 -> V_144 ) ;
V_144 = V_255 ;
snprintf ( V_256 , sizeof( V_256 ) , L_7 ,
...
const struct V_250 * V_251 , int V_257 )
{
int V_85 , V_258 , V_76 = 0 ;
F_78 ( & V_12 -> V_14 -> V_18 , V_259 ) ;
for ( V_85 = 0 ; V_85 < V_257 ; V_85 ++ ) {
V_258 = F_156 ( V_12 , V_251 , false ) ;
if ( V_258 < 0 ) {
F_21 ( V_12 -> V_3 , L_83 ,
V_251 -> V_58 ,
...
F_16 ( & V_14 -> V_18 ) ;
if ( V_42 )
V_261 -> V_46 . integer . V_46 [ 0 ] = V_40 - V_69 ;
else
V_261 -> V_46 . integer . V_46 [ 0 ] = V_69 ;
return 0 ;
}
...
L_91 ,
V_25 -> V_19 . V_13 ) ;
V_69 = ( V_261 -> V_46 . integer . V_46 [ 0 ] & V_39 ) ;
V_88 = ! ! V_69 ;
if ( V_42 )
V_69 = V_40 - V_69 ;
F_78 ( & V_14 -> V_18 , V_163 ) ;
...
V_261 -> V_46 . V_262 . V_92 [ 0 ] = ( V_69 >> V_91 -> V_93 ) & V_91 -> V_39 ;
if ( V_91 -> V_93 != V_91 -> V_263 )
V_261 -> V_46 . V_262 . V_92 [ 1 ] =
( V_69 >> V_91 -> V_263 ) & V_91 -> V_39 ;
return 0 ;
}
...
struct V_203 V_204 ;
int V_76 = 0 ;
if ( V_261 -> V_46 . V_262 . V_92 [ 0 ] > V_91 -> V_40 - 1 )
return - V_142 ;
V_231 = V_261 -> V_46 . V_262 . V_92 [ 0 ] ;
V_69 = V_231 << V_91 -> V_93 ;
V_39 = V_91 -> V_39 << V_91 -> V_93 ;
if ( V_91 -> V_93 != V_91 -> V_263 ) {
if ( V_261 -> V_46 . V_262 . V_92 [ 1 ] > V_91 -> V_40 - 1 )
return - V_142 ;
V_69 |= V_261 -> V_46 . V_262 . V_92 [ 1 ] << V_91 -> V_263 ;
V_39 |= V_91 -> V_39 << V_91 -> V_263 ;
}
F_78 ( & V_14 -> V_18 , V_163 ) ;
...
struct V_260 * V_261 )
{
V_261 -> V_46 . V_262 . V_92 [ 0 ] = F_34 ( V_25 ) ;
return 0 ;
}
...
int V_73 ;
int V_76 = 0 ;
if ( V_261 -> V_46 . V_262 . V_92 [ 0 ] >= V_91 -> V_40 )
return - V_142 ;
F_78 ( & V_14 -> V_18 , V_163 ) ;
V_46 = V_261 -> V_46 . V_262 . V_92 [ 0 ] ;
V_73 = F_35 ( V_25 , V_46 ) ;
if ( V_73 )
V_76 = F_138 ( V_14 , V_25 , V_46 , V_91 ) ;
F_16 ( & V_14 -> V_18 ) ;
if ( V_76 > 0 )
F_141 ( V_14 ) ;
return V_73 ;
...
struct V_61 * V_62 = F_36 ( V_25 ) ;
struct V_90 * V_91 = (struct V_90 * ) V_25 -> V_35 ;
unsigned int V_264 , V_69 , V_231 ;
V_264 = F_39 ( V_62 , V_91 -> V_38 ) ;
V_69 = ( V_264 >> V_91 -> V_93 ) & V_91 -> V_39 ;
for ( V_231 = 0 ; V_231 < V_91 -> V_40 ; V_231 ++ ) {
if ( V_69 == V_91 -> V_97 [ V_231 ] )
break;
}
V_261 -> V_46 . V_262 . V_92 [ 0 ] = V_231 ;
if ( V_91 -> V_93 != V_91 -> V_263 ) {
V_69 = ( V_264 >> V_91 -> V_263 ) & V_91 -> V_39 ;
for ( V_231 = 0 ; V_231 < V_91 -> V_40 ; V_231 ++ ) {
if ( V_69 == V_91 -> V_97 [ V_231 ] )
break;
}
V_261 -> V_46 . V_262 . V_92 [ 1 ] = V_231 ;
}
return 0 ;
}
...
return - V_142 ;
V_231 = V_261 -> V_46 . V_262 . V_92 [ 0 ] ;
V_69 = V_91 -> V_97 [ V_261 -> V_46 . V_262 . V_92 [ 0 ] ] << V_91 -> V_93 ;
V_39 = V_91 -> V_39 << V_91 -> V_93 ;
if ( V_91 -> V_93 != V_91 -> V_263 ) {
if ( V_261 -> V_46 . V_262 . V_92 [ 1 ] > V_91 -> V_40 - 1 )
return - V_142 ;
V_69 |= V_91 -> V_97 [ V_261 -> V_46 . V_262 . V_92 [ 1 ] ] << V_91 -> V_263 ;
V_39 |= V_91 -> V_39 << V_91 -> V_263 ;
}
F_78 ( & V_14 -> V_18 , V_163 ) ;
V_73 = F_166 ( V_62 , V_91 -> V_38 , V_39 , V_69 ) ;
...
V_266 -> type = V_267 ;
V_266 -> V_223 = 1 ;
V_266 -> V_46 . integer . V_268 = 0 ;
V_266 -> V_46 . integer . V_40 = 1 ;
return 0 ;
}
...
struct V_24 * V_25 , int V_167 )
{
struct V_55 * V_269 , * V_270 ;
struct V_160 * V_58 , * V_144 ;
const struct V_271 * V_272 = V_9 -> V_273 ;
struct V_274 V_275 ;
struct V_276 * V_273 = NULL ;
T_8 V_4 ;
int V_76 ;
if ( F_105 ( ! V_272 ) ||
F_105 ( F_9 ( & V_9 -> V_125 ) || F_9 ( & V_9 -> V_127 ) ) )
return - V_142 ;
V_269 = F_104 ( & V_9 -> V_125 , struct V_55 ,
V_124 ) ;
V_270 = F_104 ( & V_9 -> V_127 , struct V_55 ,
V_126 ) ;
if ( F_105 ( ! V_269 || ! V_270 ) ||
F_105 ( ! V_270 -> V_58 || ! V_269 -> V_144 ) ||
F_105 ( ! V_269 -> V_58 || ! V_270 -> V_144 ) )
return - V_142 ;
V_58 = V_269 -> V_58 -> V_277 ;
V_144 = V_270 -> V_144 -> V_277 ;
if ( V_272 -> V_278 ) {
V_4 = F_186 ( V_272 -> V_278 ) - 1 ;
} else {
F_84 ( V_9 -> V_12 -> V_3 , L_94 ,
V_272 -> V_278 ) ;
V_4 = 0 ;
}
V_273 = F_20 ( sizeof( * V_273 ) , V_7 ) ;
if ( ! V_273 ) {
V_76 = - V_30 ;
goto V_80;
}
F_187 ( F_188 ( V_273 , V_279 ) , V_4 ) ;
F_189 ( V_273 , V_280 ) -> V_268 =
V_272 -> V_281 ;
F_189 ( V_273 , V_280 ) -> V_40 =
V_272 -> V_282 ;
F_189 ( V_273 , V_283 ) -> V_268
= V_272 -> V_284 ;
F_189 ( V_273 , V_283 ) -> V_40
= V_272 -> V_285 ;
memset ( & V_275 , 0 , sizeof( V_275 ) ) ;
switch ( V_167 ) {
case V_186 :
if ( V_58 -> V_81 -> V_286 && V_58 -> V_81 -> V_286 -> V_287 ) {
V_275 . V_162 = V_288 ;
V_76 = V_58 -> V_81 -> V_286 -> V_287 ( & V_275 ,
V_273 , V_58 ) ;
if ( V_76 != 0 ) {
F_21 ( V_58 -> V_3 ,
L_95 , V_76 ) ;
...
if ( V_144 -> V_81 -> V_286 && V_144 -> V_81 -> V_286 -> V_287 ) {
V_275 . V_162 = V_164 ;
V_76 = V_144 -> V_81 -> V_286 -> V_287 ( & V_275 , V_273 ,
V_144 ) ;
if ( V_76 != 0 ) {
F_21 ( V_144 -> V_3 ,
L_95 , V_76 ) ;
...
struct V_8 * V_144 )
{
struct V_250 V_290 [ 2 ] ;
struct V_8 V_37 ;
struct V_8 * V_9 ;
T_3 V_291 ;
char * V_292 ;
V_291 = strlen ( V_58 -> V_13 ) + strlen ( V_144 -> V_13 ) + 2 ;
V_292 = F_192 ( V_14 -> V_3 , V_291 , V_7 ) ;
if ( ! V_292 )
return - V_30 ;
snprintf ( V_292 , V_291 , L_98 , V_58 -> V_13 , V_144 -> V_13 ) ;
memset ( & V_37 , 0 , sizeof( V_37 ) ) ;
V_37 . V_38 = V_87 ;
V_37 . V_19 = V_116 ;
V_37 . V_13 = V_292 ;
...
V_290 [ 0 ] . V_58 = V_58 -> V_13 ;
V_290 [ 0 ] . V_144 = V_292 ;
V_290 [ 1 ] . V_58 = V_292 ;
V_290 [ 1 ] . V_144 = V_144 -> V_13 ;
return F_158 ( & V_14 -> V_12 , V_290 ,
F_109 ( V_290 ) ) ;
}
...
memset ( & V_37 , 0 , sizeof( V_37 ) ) ;
V_37 . V_38 = V_87 ;
if ( V_161 -> V_81 -> V_293 . V_294 ) {
V_37 . V_19 = V_110 ;
V_37 . V_13 = V_161 -> V_81 -> V_293 . V_294 ;
V_37 . V_225 = V_161 -> V_81 -> V_293 . V_294 ;
F_70 ( V_161 -> V_3 , L_99 ,
V_37 . V_13 ) ;
V_9 = F_24 ( V_12 , & V_37 ) ;
if ( ! V_9 ) {
F_21 ( V_12 -> V_3 , L_100 ,
V_161 -> V_81 -> V_293 . V_294 ) ;
return - V_30 ;
}
V_9 -> V_277 = V_161 ;
V_161 -> V_165 = V_9 ;
}
if ( V_161 -> V_81 -> V_295 . V_294 ) {
V_37 . V_19 = V_111 ;
V_37 . V_13 = V_161 -> V_81 -> V_295 . V_294 ;
V_37 . V_225 = V_161 -> V_81 -> V_295 . V_294 ;
F_70 ( V_161 -> V_3 , L_99 ,
V_37 . V_13 ) ;
V_9 = F_24 ( V_12 , & V_37 ) ;
if ( ! V_9 ) {
F_21 ( V_12 -> V_3 , L_100 ,
V_161 -> V_81 -> V_295 . V_294 ) ;
return - V_30 ;
}
V_9 -> V_277 = V_161 ;
V_161 -> V_166 = V_9 ;
...
if ( ! V_9 -> V_225 || ! strstr ( V_9 -> V_225 , V_296 -> V_13 ) )
continue;
if ( V_161 -> V_81 -> V_293 . V_294 &&
strstr ( V_9 -> V_225 ,
V_161 -> V_81 -> V_293 . V_294 ) ) {
...
void F_195 ( struct V_17 * V_14 )
{
struct V_236 * V_237 = V_14 -> V_237 ;
struct V_160 * V_297 , * V_298 ;
struct V_250 V_258 ;
int V_85 ;
memset ( & V_258 , 0 , sizeof( V_258 ) ) ;
for ( V_85 = 0 ; V_85 < V_14 -> V_299 ; V_85 ++ ) {
V_237 = & V_14 -> V_237 [ V_85 ] ;
V_297 = V_237 -> V_297 ;
V_298 = V_237 -> V_298 ;
if ( V_237 -> V_300 -> V_301 )
continue;
if ( F_196 ( V_298 ) ||
F_196 ( V_297 ) )
continue;
if ( V_298 -> V_165 && V_297 -> V_165 ) {
V_258 . V_58 = V_297 -> V_165 -> V_13 ;
V_258 . V_144 = V_298 -> V_165 -> V_13 ;
F_70 ( V_237 -> V_3 , L_102 ,
V_297 -> V_62 -> V_13 , V_258 . V_58 ,
V_298 -> V_68 -> V_13 , V_258 . V_144 ) ;
F_156 ( & V_14 -> V_12 , & V_258 , true ) ;
}
if ( V_298 -> V_166 && V_297 -> V_166 ) {
V_258 . V_58 = V_298 -> V_166 -> V_13 ;
V_258 . V_144 = V_297 -> V_166 -> V_13 ;
F_70 ( V_237 -> V_3 , L_102 ,
V_298 -> V_62 -> V_13 , V_258 . V_58 ,
V_297 -> V_68 -> V_13 , V_258 . V_144 ) ;
F_156 ( & V_14 -> V_12 , & V_258 , true ) ;
}
}
}
static void F_197 ( struct V_236 * V_237 , int V_162 ,
int V_167 )
{
struct V_8 * V_302 , * V_303 ;
struct V_160 * V_297 = V_237 -> V_297 ;
...
void F_198 ( struct V_236 * V_237 , int V_162 ,
int V_167 )
{
struct V_17 * V_14 = V_237 -> V_14 ;
F_78 ( & V_14 -> V_18 , V_163 ) ;
F_197 ( V_237 , V_162 , V_167 ) ;
F_16 ( & V_14 -> V_18 ) ;
}
...
int V_76 ;
F_78 ( & V_12 -> V_14 -> V_18 , V_163 ) ;
V_76 = F_154 ( V_12 , V_242 , 1 ) ;
F_16 ( & V_12 -> V_14 -> V_18 ) ;
return V_76 ;
}
int F_200 ( struct V_16 * V_12 ,
const char * V_242 )
{
struct V_8 * V_9 = F_153 ( V_12 , V_242 , true ) ;
if ( ! V_9 ) {
F_21 ( V_12 -> V_3 , L_104 , V_242 ) ;
return - V_142 ;
}
F_70 ( V_9 -> V_12 -> V_3 , L_105 , V_242 ) ;
V_9 -> V_154 = 1 ;
V_9 -> V_172 = 1 ;
F_10 ( V_9 , L_106 ) ;
return 0 ;
}
int F_201 ( struct V_16 * V_12 ,
const char * V_242 )
{
int V_76 ;
F_78 ( & V_12 -> V_14 -> V_18 , V_163 ) ;
V_76 = F_200 ( V_12 , V_242 ) ;
F_16 ( & V_12 -> V_14 -> V_18 ) ;
return V_76 ;
}
int F_202 ( struct V_16 * V_12 ,
const char * V_242 )
{
...
int V_76 ;
F_78 ( & V_12 -> V_14 -> V_18 , V_163 ) ;
V_76 = F_154 ( V_12 , V_242 , 0 ) ;
F_16 ( & V_12 -> V_14 -> V_18 ) ;
return V_76 ;
}
int F_203 ( struct V_16 * V_12 ,
const char * V_242 )
{
return F_154 ( V_12 , V_242 , 0 ) ;
}
int F_204 ( struct V_16 * V_12 , const char * V_242 )
{
int V_76 ;
F_78 ( & V_12 -> V_14 -> V_18 , V_163 ) ;
V_76 = F_154 ( V_12 , V_242 , 0 ) ;
...
static bool F_206 ( struct V_17 * V_14 ,
struct V_8 * V_9 )
{
struct V_55 * V_84 ;
...
static void F_209 ( struct V_16 * V_12 )
{
struct V_17 * V_14 = V_12 -> V_14 ;
struct V_8 * V_9 ;
F_107 ( V_216 ) ;
