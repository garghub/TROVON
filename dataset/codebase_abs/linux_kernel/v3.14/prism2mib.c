...
T_5 * V_33 )
{
V_58 -> V_43 = F_19 ( ( T_3 ) ( V_33 -> V_43 ) ) ;
memcpy ( V_58 -> V_16 , V_33 -> V_16 , V_33 -> V_43 ) ;
}
void F_6 ( T_6 * V_59 , T_5 * V_33 )
{
memcpy ( V_59 , V_33 -> V_16 , V_33 -> V_43 ) ;
}
void F_21 ( struct V_57 * V_58 ,
T_5 * V_33 )
{
V_33 -> V_43 = ( T_6 ) ( F_18 ( ( T_3 ) ( V_58 -> V_43 ) ) ) ;
memcpy ( V_33 -> V_16 , V_58 -> V_16 , V_33 -> V_43 ) ;
}
void F_5 ( T_6 * V_59 , T_5 * V_33 , int V_43 )
{
V_33 -> V_43 = ( T_6 ) V_43 ;
memcpy ( V_33 -> V_16 , V_59 , V_43 ) ;
}
