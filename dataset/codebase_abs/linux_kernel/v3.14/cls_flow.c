...
F_52 ( & V_106 , V_115 , V_116 ) ;
V_109 = F_53 ( V_95 , V_63 , V_103 , V_100 [ V_117 ] , & V_106 ) ;
if ( V_109 < 0 )
return V_109 ;
V_109 = F_54 ( V_63 , V_103 [ V_118 ] , & V_108 ) ;
if ( V_109 < 0 )
goto V_119;
...
V_89 = F_39 ( V_89 , 1 ) ;
V_109 = - V_126 ;
V_70 = F_56 ( sizeof( * V_70 ) , V_127 ) ;
if ( V_70 == NULL )
goto V_120;
V_70 -> V_98 = V_98 ;
V_70 -> V_83 = ~ 0U ;
F_52 ( & V_70 -> V_90 , V_115 , V_116 ) ;
F_42 ( & V_70 -> V_82 , 4 ) ;
V_70 -> V_93 . V_128 = F_41 ;
V_70 -> V_93 . V_129 = ( unsigned long ) V_70 ;
F_57 ( & V_70 -> V_93 ) ;
}
F_58 ( V_63 , & V_70 -> V_90 , & V_106 ) ;
F_59 ( V_63 , & V_70 -> V_77 , & V_108 ) ;
F_60 ( V_63 ) ;
if ( V_103 [ V_113 ] ) {
V_70 -> V_71 = V_71 ;
V_70 -> V_79 = V_79 ;
...
static int F_77 ( struct V_95 * V_95 , struct V_62 * V_63 , unsigned long V_138 ,
...
V_140 = F_78 ( V_5 , V_102 ) ;
if ( V_140 == NULL )
goto V_143;
if ( F_79 ( V_5 , V_113 , V_70 -> V_71 ) ||
F_79 ( V_5 , V_121 , V_70 -> V_80 ) )
goto V_143;
if ( V_70 -> V_83 != ~ 0 || V_70 -> V_84 != 0 ) {
if ( F_79 ( V_5 , V_130 , V_70 -> V_83 ) ||
F_79 ( V_5 , V_131 , V_70 -> V_84 ) )
goto V_143;
}
if ( V_70 -> V_85 &&
F_79 ( V_5 , V_132 , V_70 -> V_85 ) )
goto V_143;
if ( V_70 -> V_86 &&
F_79 ( V_5 , V_133 , V_70 -> V_86 ) )
goto V_143;
if ( V_70 -> V_87 &&
F_79 ( V_5 , V_134 , V_70 -> V_87 ) )
goto V_143;
if ( V_70 -> V_89 &&
F_79 ( V_5 , V_112 , V_70 -> V_89 ) )
goto V_143;
if ( V_70 -> V_92 &&
F_79 ( V_5 , V_122 , V_70 -> V_92 / V_123 ) )
goto V_143;
if ( F_80 ( V_5 , & V_70 -> V_90 ) < 0 )
goto V_143;
#ifdef F_81
if ( V_70 -> V_77 . V_144 . V_145 &&
F_82 ( V_5 , & V_70 -> V_77 , V_118 ) < 0 )
goto V_143;
#endif
F_83 ( V_5 , V_140 ) ;
...
static void F_86 ( struct V_62 * V_63 , struct V_146 * V_91 )
{
struct V_66 * V_67 = V_63 -> V_68 ;
struct V_69 * V_70 ;
F_34 (f, &head->filters, list) {
