...
unsigned long V_56 )
{
struct V_57 * V_58 = F_25 ( V_2 ) ;
struct V_35 * V_36 ;
struct V_7 * V_8 ;
int V_59 ;
int V_17 ;
V_36 = F_26 ( V_2 , sizeof( * V_36 ) ) ;
if ( ! V_36 )
return - V_60 ;
V_17 = F_27 ( V_2 ) ;
if ( V_17 )
return V_17 ;
V_2 -> V_4 = F_28 ( V_58 , 1 ) ;
V_36 -> V_38 = F_28 ( V_58 , 0 ) ;
V_59 = F_17 ( V_2 ) ;
if ( V_58 -> V_43 > 0 ) {
V_17 = F_29 ( V_58 -> V_43 , F_19 , V_61 ,
V_2 -> V_62 , V_2 ) ;
if ( V_17 == 0 )
V_2 -> V_43 = V_58 -> V_43 ;
}
...
static int F_34 ( struct V_57 * V_2 ,
const struct V_89 * V_90 )
{
return F_35 ( V_2 , & V_91 , V_90 -> V_92 ) ;
}
