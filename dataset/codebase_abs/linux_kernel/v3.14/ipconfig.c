...
goto V_97;
if ( ( V_86 = F_47 ( V_86 , V_98 ) ) == NULL )
return V_99 ;
if ( ! F_48 ( V_86 , sizeof( struct V_90 ) ) )
goto V_97;
V_91 = (struct V_90 * ) F_49 ( V_86 ) ;
if ( V_91 -> V_100 != V_2 -> V_101 || V_2 -> type != F_50 ( V_91 -> V_102 ) )
goto V_97;
if ( V_91 -> V_103 != F_51 ( V_104 ) )
goto V_97;
if ( V_91 -> V_105 != F_51 ( V_106 ) )
goto V_97;
...
if ( V_77 ) {
* V_121 ++ = 12 ;
V_122 = strlen ( F_61 () -> V_78 ) ;
* V_121 ++ = V_122 ;
memcpy ( V_121 , F_61 () -> V_78 , V_122 ) ;
V_121 += V_122 ;
}
if ( * V_125 ) {
F_17 ( L_19 ,
...
static void T_1 F_62 ( T_4 * V_121 )
{
memcpy ( V_121 , V_123 , 4 ) ;
V_121 += 4 ;
* V_121 ++ = 1 ;
...
V_131 -> V_135 = 4 ;
V_131 -> V_136 = 5 ;
V_131 -> V_137 = F_51 ( sizeof( struct V_128 ) ) ;
V_131 -> V_138 = F_51 ( V_139 ) ;
V_131 -> V_140 = 64 ;
V_131 -> V_141 = V_142 ;
V_131 -> V_143 = F_36 ( V_144 ) ;
V_131 -> V_145 = F_72 ( ( unsigned char * ) V_131 , V_131 -> V_136 ) ;
V_129 -> V_146 . V_147 = F_51 ( 68 ) ;
V_129 -> V_146 . V_148 = F_51 ( 67 ) ;
V_129 -> V_146 . V_122 = F_51 ( sizeof( struct V_128 ) - sizeof( struct V_130 ) ) ;
V_129 -> V_149 = V_150 ;
if ( V_2 -> type < 256 )
...
F_62 ( V_129 -> V_158 ) ;
V_86 -> V_2 = V_2 ;
V_86 -> V_141 = F_51 ( V_106 ) ;
if ( F_74 ( V_86 , V_2 , F_50 ( V_86 -> V_141 ) ,
...
static int T_1 F_76 ( char * V_148 , char * V_160 , int V_122 , int V_161 )
{
if ( ! V_122 )
return 0 ;
if ( V_122 > V_161 - 1 )
...
static void T_1 F_77 ( T_4 * V_162 )
{
T_4 V_163 ;
int V_114 ;
T_2 V_18 ;
...
break;
case 12 :
F_76 ( F_61 () -> V_78 , V_162 + 1 , * V_162 ,
V_165 ) ;
V_77 = 1 ;
break;
case 15 :
F_76 ( V_166 , V_162 + 1 , * V_162 , sizeof( V_166 ) ) ;
break;
case 17 :
if ( ! V_167 [ 0 ] )
F_76 ( V_167 , V_162 + 1 , * V_162 ,
sizeof( V_167 ) ) ;
break;
case 26 :
...
if ( V_86 -> V_122 < F_50 ( V_131 -> V_137 ) )
goto V_97;
if ( F_72 ( ( char * ) V_131 , V_131 -> V_136 ) )
goto V_97;
if ( V_129 -> V_146 . V_147 != F_51 ( 67 ) || V_129 -> V_146 . V_148 != F_51 ( 68 ) )
goto V_97;
if ( F_50 ( V_131 -> V_137 ) < F_50 ( V_129 -> V_146 . V_122 ) + sizeof( struct V_130 ) )
goto V_97;
V_122 = F_50 ( V_129 -> V_146 . V_122 ) - sizeof( struct V_172 ) ;
...
T_4 * V_176 = ( T_4 * ) V_129 + F_50 ( V_129 -> V_173 . V_137 ) ;
T_4 * V_162 ;
#ifdef F_73
if ( V_22 & V_157 ) {
V_27 V_177 = V_68 ;
...
* V_222 ++ = '\0' ;
F_108 ( F_61 () -> V_168 , V_222 ,
sizeof( F_61 () -> V_168 ) ) ;
}
F_108 ( F_61 () -> V_78 , V_221 ,
sizeof( F_61 () -> V_78 ) ) ;
V_77 = 1 ;
break;
case 5 :
