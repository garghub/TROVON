...
static int F_19 ( struct V_44 * V_101 , int V_110 )
{
struct V_9 * V_10 = V_101 -> V_10 ;
T_1 V_15 ;
V_15 = F_5 ( V_10 , V_111 ) & ~ V_112 ;
if ( V_110 )
F_6 ( V_10 , V_111 , V_15 | V_112 ) ;
else
F_6 ( V_10 , V_111 , V_15 ) ;
return 0 ;
}
...
break;
case V_119 :
if ( V_10 -> V_120 . V_121 == V_122 ) {
V_14 = F_21 ( V_63 -> V_123 ) ;
if ( V_14 < 0 ) {
F_22 ( V_10 -> V_2 , L_6 , V_14 ) ;
return V_14 ;
}
F_6 ( V_10 , V_124 , V_125 |
V_126 | V_127 |
V_128 | V_129 |
V_130 ) ;
F_6 ( V_10 , V_131 , V_132 |
V_133 | V_134 |
V_135 ) ;
F_23 ( 300 ) ;
F_6 ( V_10 , V_131 , V_132 |
V_133 | V_134 ) ;
F_6 ( V_10 , V_124 , 0 ) ;
F_6 ( V_10 , V_117 , 0x1b00 ) ;
F_23 ( 50 ) ;
F_6 ( V_10 , V_117 , 0x1f02 ) ;
F_23 ( 100 ) ;
F_6 ( V_10 , V_117 , 0x1f03 ) ;
F_23 ( 600 ) ;
F_6 ( V_10 , V_131 , V_132 |
V_133 | V_134 |
V_136 ) ;
F_6 ( V_10 , V_117 , 0x3 ) ;
F_6 ( V_10 , V_131 , V_136 ) ;
F_6 ( V_10 , V_137 , 0x2 ) ;
F_6 ( V_10 , V_138 , 0xa003 ) ;
F_6 ( V_10 , V_137 , 0 ) ;
}
F_12 ( V_10 , V_117 ,
V_118 , 0x4 ) ;
...
F_12 ( V_10 , V_49 ,
V_145 , V_145 ) ;
F_6 ( V_10 , V_146 , 0x50 | ( 1 << 8 ) ) ;
F_6 ( V_10 , V_147 , 0x50 | ( 1 << 8 ) ) ;
return 0 ;
}
...
static int F_31 ( struct V_148 * V_149 ,
const struct V_150 * V_151 )
{
struct V_62 * V_63 ;
int V_14 ;
V_63 = F_32 ( & V_149 -> V_2 , sizeof( struct V_62 ) ,
V_152 ) ;
if ( V_63 == NULL )
return - V_153 ;
F_33 ( V_149 , V_63 ) ;
...
static int F_35 ( struct V_148 * V_156 )
{
F_36 ( & V_156 -> V_2 ) ;
return 0 ;
}
