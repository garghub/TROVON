...
static int F_22 ( unsigned char * V_71 )
{
int V_1 = V_71 [ 2 ] ;
if ( V_1 < 0 || V_1 >= V_51 )
return - V_53 ;
...
V_52 [ V_1 ] -> F_24 ( V_1 , V_71 [ 3 ] , V_71 [ 4 ] , V_71 [ 5 ] ) ;
break;
case V_74 :
V_52 [ V_1 ] -> F_25 ( V_1 , V_71 [ 3 ] , V_71 [ 4 ] ) ;
break;
case V_75 :
V_52 [ V_1 ] -> F_26 ( V_1 , V_71 [ 3 ] , V_71 [ 4 ] ) ;
break;
case V_76 :
V_52 [ V_1 ] -> F_27 ( V_1 , V_71 [ 3 ] , ( char ) V_71 [ 4 ] ) ;
break;
case V_77 :
V_52 [ V_1 ] -> F_28 ( V_1 , V_71 [ 3 ] , V_71 [ 4 ] , ( short ) ( V_71 [ 5 ] | ( V_71 [ 6 ] << 8 ) ) ) ;
break;
case V_78 :
...
static int F_30 ( int V_1 , int V_80 , int V_64 )
{
unsigned short V_81 ;
int V_86 ;
V_81 = ( V_80 << 8 ) | ( V_64 + 1 ) ;
V_86 = V_52 [ V_1 ] -> F_30 ( V_1 , V_80 , V_64 ,
& V_52 [ V_1 ] -> V_83 ) ;
...
static void F_31 ( unsigned char * V_23 )
{
#define V_1 event_rec[1]
#define F_32 event_rec[2]
#define V_80 event_rec[3]
#define V_64 event_rec[4]
#define F_33 event_rec[5]
int V_86 = - 1 ;
...
return;
if ( V_86 == - 1 && V_9 == V_34 && V_52 [ V_1 ] -> F_30 )
{
V_86 = F_30 ( V_1 , V_80 , V_64 ) ;
}
if ( V_86 == - 1 )
V_86 = V_80 ;
...
if ( V_80 == 9 )
{
V_52 [ V_1 ] -> F_25 ( V_1 , V_86 , 128 + V_64 ) ;
V_52 [ V_1 ] -> V_92 [ V_80 ] . V_93 = 128 + V_64 ;
}
V_52 [ V_1 ] -> F_34 ( V_1 , V_86 , V_80 ) ;
}
V_52 [ V_1 ] -> F_24 ( V_1 , V_86 , V_64 , F_33 ) ;
break;
case V_90 :
if ( V_86 == - 1 )
V_86 = V_80 ;
V_52 [ V_1 ] -> F_23 ( V_1 , V_86 , V_64 , F_33 ) ;
break;
case V_94 :
if ( V_86 == - 1 )
V_86 = V_80 ;
V_52 [ V_1 ] -> F_26 ( V_1 , V_86 , F_33 ) ;
break;
default: ;
}
#undef V_1
...
static void F_35 ( unsigned char * V_23 )
{
unsigned char V_1 = V_23 [ 1 ] ;
unsigned char F_32 = V_23 [ 2 ] ;
...
V_52 [ V_1 ] -> F_28 ( V_1 , V_82 , V_95 , V_100 ) ;
}
else
V_52 [ V_1 ] -> F_28 ( V_1 , V_80 , V_95 , V_96 ) ;
}
else
V_52 [ V_1 ] -> F_28 ( V_1 , V_80 , V_95 , V_96 ) ;
break;
...
for ( V_82 = 0 ; V_82 < V_52 [ V_1 ] -> V_83 . V_84 ; V_82 ++ )
if ( ( V_52 [ V_1 ] -> V_83 . V_85 [ V_82 ] & 0xff00 ) == V_81 )
V_52 [ V_1 ] -> F_36 ( V_1 , V_82 , V_96 ) ;
}
else
V_52 [ V_1 ] -> F_36 ( V_1 , V_80 , V_96 ) ;
}
else
V_52 [ V_1 ] -> F_36 ( V_1 , V_80 , V_96 ) ;
break;
...
static int F_37 ( unsigned char * V_23 )
{
unsigned char F_32 = V_23 [ 1 ] ;
unsigned int F_33 = * ( int * ) & V_23 [ 4 ] ;
if ( V_9 == V_34 )
{
int V_103 ;
...
static void F_39 ( unsigned char * V_23 )
{
unsigned char F_32 = V_23 [ 1 ] ;
unsigned int F_33 = * ( ( unsigned int * ) & V_23 [ 4 ] ) ;
switch ( F_32 )
{
case V_116 :
F_40 ( F_33 ) ;
...
static void F_41 ( unsigned char * V_23 )
{
...
static int F_42 ( unsigned char * V_71 )
{
unsigned int * V_119 ;
switch ( V_71 [ 0 ] )
{
...
if ( V_54 & ( 1 << 0 ) )
if ( V_52 [ 0 ] )
V_52 [ 0 ] -> F_23 ( 0 , V_71 [ 1 ] , 255 , V_71 [ 3 ] ) ;
break;
case V_73 :
if ( V_71 [ 4 ] < 128 || V_71 [ 4 ] == 255 )
if ( V_54 & ( 1 << 0 ) )
if ( V_52 [ 0 ] )
V_52 [ 0 ] -> F_24 ( 0 , V_71 [ 1 ] , V_71 [ 2 ] , V_71 [ 3 ] ) ;
break;
case V_31 :
...
static void F_45 ( int V_1 , unsigned char * F_28 , int V_131 )
{
int V_82 ;
for ( V_82 = 0 ; V_82 < 128 ; V_82 ++ )
F_28 [ V_82 ] = V_132 [ V_82 ] ;
}
...
int F_47 ( int V_1 , struct V_2 * V_2 )
{
int V_137 , V_44 , V_82 ;
int V_138 , V_139 ;
if ( ! V_140 )
...
if ( V_52 [ V_82 ] == NULL )
continue;
if ( ! F_50 ( V_52 [ V_82 ] -> V_149 ) )
continue;
if ( ( V_139 = V_52 [ V_82 ] -> F_18 ( V_82 , V_44 ) ) < 0 )
{
F_14 ( V_56 L_7 , V_82 , V_139 ) ;
if ( V_52 [ V_82 ] -> V_150 )
F_14 ( V_56 L_8 , V_52 [ V_82 ] -> V_150 ) ;
}
else
{
V_54 |= ( 1 << V_82 ) ;
...
{
if ( ! F_50 ( V_62 [ V_82 ] -> V_149 ) )
continue;
if ( ( V_137 = V_62 [ V_82 ] -> F_18 ( V_82 , V_44 ,
F_9 , F_6 ) ) >= 0 )
{
V_60 [ V_82 ] = 1 ;
}
...
void F_54 ( int V_1 , struct V_2 * V_2 )
{
int V_82 ;
int V_44 = F_12 ( V_2 ) ;
V_1 = V_1 >> 4 ;
...
{
if ( V_66 && ! V_58 && ! F_53 ( V_153 ) )
F_17 () ;
if ( V_66 > 0 )
F_4 ( & V_67 , V_155 ) ;
return V_66 ;
}
static void F_58 ( int V_1 , unsigned char V_26 )
{
int V_152 ;
unsigned long V_8 ;
V_152 = 3 * V_155 ;
F_2 ( & V_11 , V_8 ) ;
while ( V_152 && ! V_62 [ V_1 ] -> F_43 ( V_1 , V_26 ) ) {
F_4 ( & V_67 , V_155 / 25 ) ;
V_152 -- ;
}
F_3 ( & V_11 , V_8 ) ;
...
if ( V_52 [ V_82 ] )
{
V_52 [ V_82 ] -> F_28 ( V_82 , V_80 , 123 , 0 ) ;
V_52 [ V_82 ] -> F_28 ( V_82 , V_80 , 121 , 0 ) ;
V_52 [ V_82 ] -> F_36 ( V_82 , V_80 , 1 << 13 ) ;
}
}
else
{
...
for ( V_80 = 0 ; V_80 < 16 ; V_80 ++ )
{
F_58 ( V_82 , ( unsigned char ) ( 0xb0 + ( V_80 & 0x0f ) ) ) ;
F_58 ( V_82 , 0x7b ) ;
F_58 ( V_82 , 0 ) ;
}
V_62 [ V_82 ] -> F_56 ( V_82 ) ;
...
int F_62 ( int V_1 , struct V_2 * V_2 , unsigned int F_32 , void T_1 * V_157 )
{
...
if ( V_9 != V_34 )
return - V_57 ;
return V_35 -> V_169 ( V_37 , F_32 , V_157 ) ;
case V_170 :
if ( V_9 != V_34 )
return - V_57 ;
if ( F_63 ( V_144 , V_6 ) )
...
if ( ! ( V_54 & ( 1 << V_1 ) ) && ! V_158 )
return - V_143 ;
return V_52 [ V_1 ] -> V_169 ( V_1 , F_32 , V_157 ) ;
case V_185 :
V_100 = V_51 ;
break;
case V_186 :
...
if ( ! ( V_54 & ( 1 << V_1 ) ) && ! V_158 )
return - V_143 ;
V_100 = V_52 [ V_1 ] -> V_169 ( V_1 , F_32 , V_157 ) ;
break;
case V_188 :
if ( F_63 ( V_1 , V_6 ) )
return - V_171 ;
...
if ( ! ( V_54 & ( 1 << V_1 ) ) )
return - V_53 ;
V_52 [ V_1 ] -> V_169 ( V_1 , F_32 , V_157 ) ;
return 0 ;
case V_189 :
if ( F_63 ( V_1 , & ( (struct V_159 T_1 * ) V_157 ) -> V_190 ) )
return - V_171 ;
if ( V_1 < 0 || V_1 >= V_51 )
return - V_53 ;
if ( ! ( V_54 & ( 1 << V_1 ) ) && ! V_158 )
...
F_65 ( V_160 . V_193 , V_52 [ V_1 ] -> V_194 , sizeof( V_160 . V_193 ) ) ;
V_160 . V_190 = V_1 ;
...
return 0 ;
case V_197 :
if ( F_63 ( V_1 , & ( (struct V_198 T_1 * ) V_157 ) -> V_190 ) )
return - V_171 ;
...
if ( ! V_52 [ 0 ] -> V_169 )
return - V_57 ;
return V_52 [ 0 ] -> V_169 ( 0 , F_32 , V_157 ) ;
}
return F_66 ( V_100 , V_6 ) ;
}
unsigned int F_67 ( int V_1 , struct V_2 * V_2 , T_2 * V_201 )
{
unsigned long V_8 ;
...
unsigned long F_72 ( unsigned long V_212 , int V_213 , int V_214 ,
int V_215 )
{
unsigned long V_216 ;
