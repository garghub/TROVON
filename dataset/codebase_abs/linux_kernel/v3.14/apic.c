...
while ( V_29 ) {
if ( V_29 & 0x1 )
F_65 ( V_154 , V_230 L_82 , V_228 [ V_171 ] ) ;
V_171 ++ ;
V_29 >>= 1 ;
}
F_65 ( V_154 , V_230 L_83 ) ;
}
...
V_167 | V_39 ) ;
V_143 |= V_236 | V_234 ;
V_143 = F_168 ( V_143 , V_238 ) ;
F_28 ( V_138 , V_143 ) ;
}
int F_169 ( int V_8 , int V_239 )
{
int V_126 , V_240 = V_241 ;
bool V_242 = F_170 ( V_216 ,
V_222 ) ;
if ( V_243 != V_181 &&
V_243 != F_118 () &&
V_243 == V_8 ) {
...
if ( ! V_242 && V_245 >= V_241 - 1 &&
V_8 != V_216 ) {
int V_244 = V_240 + V_246 - 1 ;
F_12 (
L_90
L_91
L_92 , V_240 , V_244 , V_8 ) ;
V_246 ++ ;
return - V_247 ;
}
if ( V_245 >= V_241 ) {
...
V_218 [ V_8 ] = V_239 ;
if ( V_239 != V_218 [ V_216 ] ) {
F_12 ( L_95 ,
V_218 [ V_216 ] , V_126 , V_239 ) ;
}
F_172 ( V_8 , V_222 ) ;
if ( V_8 > V_206 )
V_206 = V_8 ;
