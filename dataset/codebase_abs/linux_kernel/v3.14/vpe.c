...
static T_11 F_57 ( struct V_128 * V_128 , const char T_12 * V_142 ,
V_107 V_143 , T_13 * V_144 )
{
V_107 V_26 = V_143 ;
struct V_1 * V_4 ;
if ( F_50 ( F_58 ( V_128 ) ) != V_8 )
return - V_134 ;
V_4 = F_1 ( F_51 () ) ;
if ( V_4 == NULL )
return - V_134 ;
if ( ( V_143 + V_4 -> V_20 ) > V_4 -> V_94 ) {
F_34 ( L_32 ) ;
return - V_55 ;
}
V_143 -= F_59 ( V_4 -> V_93 + V_4 -> V_20 , V_142 , V_143 ) ;
if ( ! V_143 )
return - V_145 ;
V_4 -> V_20 += V_143 ;
return V_26 ;
...
int F_61 ( int V_10 , struct V_132 * V_17 )
{
struct V_1 * V_4 = F_1 ( V_10 ) ;
if ( V_4 == NULL )
return - 1 ;
F_62 ( & V_17 -> V_15 , & V_4 -> V_17 ) ;
return 0 ;
}
char * F_63 ( int V_10 )
{
