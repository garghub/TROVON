T_1 int T_2 (string)( struct V_1 * V_2 ,
const char * V_3 ,
void * V_4 , void * V_5 )
{
int V_6 = * ( V_7 * ) V_4 >> 16 ;
...
static T_1 void F_3 ( struct V_8 * V_4 )
{
...
static T_1 void F_6 ( struct V_8 * V_4 )
{
if ( F_4 ( V_9 , V_4 -> V_10 . V_11 ) )
F_6 ( V_4 -> V_10 . V_4 ) ;
else if ( F_4 ( V_12 , V_4 -> V_10 . V_11 ) )
...
static T_1 void F_13 ( struct V_20 * V_21 ,
void * V_22 , void * V_23 )
{
* ( unsigned long * ) V_23 = F_14 ( V_21 ) ;
}
static T_1 void F_15 ( struct V_20 * V_21 ,
void * V_22 , void * V_23 )
{
* ( unsigned long * ) V_23 = F_16 ( V_21 ) ;
}
static T_3 F_17 ( const struct V_14 * type ,
T_3 V_24 ,
const struct V_14 * V_15 )
{
int V_16 ;
...
T_4 F_41 ( struct V_75 * V_75 , const char T_5 * V_76 ,
T_6 V_77 , T_7 * V_78 ,
int (* F_38)( int , char * * ) )
{
char * V_79 , * V_30 ;
