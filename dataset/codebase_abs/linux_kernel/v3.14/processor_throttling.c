...
static long F_53 ( void * V_32 )
{
struct V_128 * V_129 = V_32 ;
struct V_7 * V_8 = V_129 -> V_8 ;
return V_8 -> V_19 . F_19 ( V_8 ,
V_129 -> V_36 , V_129 -> V_126 ) ;
}
...
V_130 . V_36 = V_50 ;
V_39 = & ( V_8 -> V_19 ) ;
F_55 (i, cpu_online_mask, p_throttling->shared_cpu_map) {
V_130 . V_35 = V_4 ;
F_12 ( V_41 ,
& V_130 ) ;
}
...
V_129 . V_36 = V_50 ;
V_129 . V_126 = V_126 ;
V_106 = F_56 ( V_8 -> V_93 , F_53 , & V_129 ) ;
} else {
F_55 (i, cpu_online_mask,
