...
static int F_41 ( struct V_85 * V_86 , void * V_87 )
{
...
static int F_44 ( struct V_89 * V_89 , struct V_90 * V_90 )
{
return F_45 ( V_90 , F_41 , V_89 -> V_91 ) ;
}
static void F_46 ( struct V_1 * V_2 )
{
char * V_92 ;
V_92 = F_47 ( V_93 , L_21 , V_2 ) ;
if ( ! V_92 ) {
F_48 ( L_22 , V_94 ) ;
return;
}
V_2 -> V_95 = F_49 ( V_92 , V_96 , V_97 ,
V_2 , & V_98 ) ;
F_50 ( L_23 , V_94 , V_92 ) ;
F_51 ( V_92 ) ;
}
static struct V_8 * F_52 ( struct V_30 * V_30 ,
...
if ( V_2 -> V_9 [ V_49 ] )
goto V_56;
V_9 = F_53 ( sizeof( struct V_8 ) , V_93 ) ;
if ( ! V_9 )
goto V_56;
F_54 ( & V_9 -> V_20 ) ;
V_9 -> V_49 = V_49 ;
...
int F_56 ( struct V_59 * V_47 , unsigned long V_44 )
{
struct V_17 * V_18 ;
...
return - V_101 ;
V_18 = F_53 ( sizeof( struct V_17 ) , V_93 ) ;
if ( ! V_18 )
return - V_102 ;
V_18 -> V_47 = V_47 ;
V_18 -> V_44 = V_44 ;
...
int F_58 ( struct V_59 * V_47 , T_5 V_107 )
{
struct V_17 * V_18 = V_47 -> V_31 . V_18 ;
struct V_1 * V_2 = V_47 -> V_30 -> V_31 . V_2 ;
union V_33 V_52 , V_53 ;
...
static int F_59 ( struct V_1 * V_2 , long V_3 , T_5 V_110 )
{
int V_111 ;
struct V_8 * V_9 ;
struct V_6 * V_112 ;
...
F_7 ( & V_9 -> V_20 ) ;
if ( ! V_111 && F_60 ( V_115 , V_113 ) )
V_111 = - V_121 ;
return V_111 ;
}
static int F_61 ( struct V_1 * V_2 , long V_3 , T_5 V_110 )
{
struct V_8 * V_9 ;
struct V_6 * V_112 ;
T_5 T_6 * V_113 = ( T_5 T_6 * ) V_110 ;
...
int F_63 ( struct V_30 * V_30 , int V_125 , T_1 V_3 , int V_4 ,
bool V_126 )
{
struct V_1 * V_2 = V_30 -> V_31 . V_2 ;
...
switch ( V_130 -> V_131 ) {
case V_132 :
return F_61 ( V_2 , V_130 -> V_130 , V_130 -> V_110 ) ;
}
return - V_133 ;
}
...
switch ( V_130 -> V_131 ) {
case V_132 :
return F_59 ( V_2 , V_130 -> V_130 , V_130 -> V_110 ) ;
}
return - V_133 ;
}
static int F_66 ( struct V_127 * V_128 , struct V_129 * V_130 )
{
switch ( V_130 -> V_131 ) {
case V_132 :
...
static int F_69 ( struct V_127 * V_128 , T_1 type )
{
struct V_1 * V_2 ;
struct V_30 * V_30 = V_128 -> V_30 ;
int V_111 = 0 ;
V_2 = F_53 ( sizeof( * V_2 ) , V_93 ) ;
if ( ! V_2 )
return - V_102 ;
V_128 -> V_87 = V_2 ;
V_2 -> V_128 = V_128 ;
...
int F_72 ( struct V_127 * V_128 , struct V_59 * V_47 ,
T_1 V_138 )
{
struct V_1 * V_2 = V_128 -> V_87 ;
int V_139 = - V_140 ;
...
if ( V_47 -> V_31 . V_144 )
return - V_140 ;
V_139 = F_56 ( V_47 , V_138 ) ;
if ( ! V_139 )
V_47 -> V_31 . V_144 = V_145 ;
return V_139 ;
}
void F_73 ( struct V_59 * V_47 )
{
if ( ! V_47 -> V_31 . V_18 )
return;
F_51 ( V_47 -> V_31 . V_18 ) ;
