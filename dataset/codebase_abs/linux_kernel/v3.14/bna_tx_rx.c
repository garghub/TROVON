...
F_49 ( & V_8 -> V_128 , & V_26 ) ;
F_45 ( & V_26 -> V_91 ) ;
F_50 ( F_73 ( V_8 -> V_35 -> V_42 ) , V_26 ) ;
}
if ( V_8 -> V_132 ) {
F_45 ( & V_8 -> V_132 -> V_91 ) ;
F_50 ( F_73 ( V_8 -> V_35 -> V_42 ) ,
V_8 -> V_132 ) ;
V_8 -> V_132 = NULL ;
}
...
enum V_156
F_80 ( struct V_111 * V_35 , T_1 * V_157 ,
void (* F_81)( struct V_158 * , struct V_111 * ) )
{
struct V_7 * V_8 = & V_35 -> V_8 ;
if ( V_8 -> V_132 == NULL ) {
V_8 -> V_132 =
F_82 ( F_73 ( V_8 -> V_35 -> V_42 ) ) ;
if ( V_8 -> V_132 == NULL )
return V_159 ;
F_45 ( & V_8 -> V_132 -> V_91 ) ;
}
...
enum V_156
F_83 ( struct V_111 * V_35 , T_1 * V_39 ,
void (* F_81)( struct V_158 * , struct V_111 * ) )
{
struct V_7 * V_8 = & V_35 -> V_8 ;
struct V_25 * V_26 ;
if ( F_84 ( & V_8 -> V_104 , V_39 ) ||
F_84 ( & V_8 -> V_103 , V_39 ) ) {
if ( F_81 )
F_81 ( V_35 -> V_42 -> V_158 , V_35 ) ;
return V_163 ;
}
V_26 = F_82 ( F_74 ( V_8 -> V_35 -> V_42 ) ) ;
if ( V_26 == NULL )
return V_164 ;
F_45 ( & V_26 -> V_91 ) ;
...
enum V_156
F_85 ( struct V_111 * V_35 , int V_165 , T_1 * V_166 ,
void (* F_81)( struct V_158 * , struct V_111 * ) )
{
...
enum V_156
F_86 ( struct V_111 * V_35 , int V_165 , T_1 * V_174 ,
void (* F_81)( struct V_158 * , struct V_111 * ) )
{
...
void
F_88 ( struct V_111 * V_35 , int V_177 )
{
struct V_7 * V_8 = & V_35 -> V_8 ;
...
static void F_105 ( struct V_111 * V_35 )
{
F_106 ( V_35 ) ;
}
static void F_107 ( struct V_111 * V_35 ,
enum V_192 V_10 )
{
switch ( V_10 ) {
case V_193 :
...
static void
F_111 ( struct V_111 * V_35 , enum V_192 V_10 )
{
switch ( V_10 ) {
case V_196 :
case V_197 :
...
static void F_113 ( struct V_111 * V_35 )
{
...
static void
F_115 ( struct V_111 * V_35 , enum V_192 V_10 )
{
switch ( V_10 ) {
case V_196 :
F_6 ( V_35 , V_198 ) ;
...
F_119 ( V_35 -> V_42 , & V_113 -> V_115 . V_2 , V_205 ) ;
}
F_120 ( & V_35 -> V_42 -> V_207 ) ;
}
static void
F_121 ( struct V_111 * V_35 , enum V_192 V_10 )
{
switch ( V_10 ) {
case V_195 :
F_6 ( V_35 , F_115 ) ;
F_122 ( & V_35 -> V_42 -> V_207 ) ;
F_78 ( & V_35 -> V_8 ) ;
break;
case V_196 :
F_6 ( V_35 , V_208 ) ;
...
V_212 -> V_218 . V_219 = F_126 ( & V_35 -> V_42 -> V_220 ) ;
V_212 -> V_221 = V_35 -> V_139 ;
for ( V_60 = 0 , V_216 = F_127 ( & V_35 -> V_222 ) ;
V_60 < V_35 -> V_139 ;
V_60 ++ , V_216 = F_128 ( V_216 ) ) {
V_113 = (struct V_112 * ) V_216 ;
F_129 ( V_113 , V_214 , V_215 ) ;
switch ( V_113 -> type ) {
case V_223 :
case V_224 :
F_130 ( & V_212 -> V_225 [ V_60 ] . V_226 . V_227 ,
& V_215 -> V_228 ) ;
V_212 -> V_225 [ V_60 ] . V_226 . V_229 =
F_22 ( ( T_2 ) V_215 -> V_230 ) ;
case V_231 :
F_130 ( & V_212 -> V_225 [ V_60 ] . V_232 . V_227 ,
& V_214 -> V_228 ) ;
if ( V_214 -> V_233 )
V_212 -> V_218 . V_233 =
V_65 ;
...
F_130 ( & V_212 -> V_225 [ V_60 ] . V_115 . V_227 ,
& V_113 -> V_115 . V_228 ) ;
...
F_37 (qe_rxp, &rx->rxp_q) {
V_113 = (struct V_112 * ) V_204 ;
F_133 ( V_35 -> V_42 , & V_113 -> V_115 . V_2 ) ;
}
F_132 ( V_35 ) ;
}
static int
F_134 ( struct V_270 * V_271 , struct V_124 * V_218 )
{
if ( ( V_271 -> V_272 == 0 ) ||
( V_271 -> V_273 == 0 ) ||
( V_271 -> V_274 == 0 ) )
...
static void
F_136 ( struct V_270 * V_271 , struct V_213 * V_276 )
{
F_45 ( & V_276 -> V_91 ) ;
...
static void
F_138 ( struct V_270 * V_271 , struct V_112 * V_113 )
{
F_45 ( & V_113 -> V_91 ) ;
...
static struct V_111 *
F_139 ( struct V_270 * V_271 , enum V_279 type )
{
struct V_90 * V_91 = NULL ;
...
static void
F_141 ( struct V_270 * V_271 , struct V_111 * V_35 )
{
...
if ( V_282 == NULL ) {
F_142 ( & V_271 -> V_280 , & V_35 -> V_91 ) ;
} else if ( F_128 ( V_282 ) == & V_271 -> V_280 ) {
F_42 ( & V_35 -> V_91 , & V_271 -> V_280 ) ;
} else {
F_128 ( & V_35 -> V_91 ) = F_128 ( V_282 ) ;
F_143 ( & V_35 -> V_91 ) = V_282 ;
F_128 ( V_282 ) = & V_35 -> V_91 ;
F_143 ( F_128 ( & V_35 -> V_91 ) ) = & V_35 -> V_91 ;
}
V_271 -> V_272 ++ ;
}
static void
F_144 ( struct V_112 * V_113 , struct V_213 * V_214 ,
struct V_213 * V_215 )
{
switch ( V_113 -> type ) {
case V_231 :
...
static void
F_149 ( void * V_306 , struct V_111 * V_35 )
{
...
{
V_35 -> V_308 &= ~ V_309 ;
if ( V_35 -> V_311 == ( V_312 ) F_107 )
F_149 ( & V_35 -> V_42 -> V_271 , V_35 ) ;
else {
V_35 -> V_154 = F_149 ;
...
void
F_155 ( struct V_270 * V_271 , enum V_279 type )
{
struct V_111 * V_35 ;
struct V_90 * V_91 ;
V_271 -> V_12 |= V_313 ;
...
void F_161 ( struct V_270 * V_271 , struct V_42 * V_42 ,
struct V_126 * V_127 )
{
int V_178 ;
struct V_111 * V_317 ;
...
void
F_163 ( struct V_111 * V_35 , struct V_118 * V_119 )
{
...
struct V_90 * V_216 ;
int V_60 ;
F_164 ( & V_35 -> V_42 -> V_43 , ( T_1 * ) V_327 ,
sizeof( struct V_326 ) ) ;
...
+ F_165 ( V_327 -> V_333 [ V_60 ] . V_329 ) ;
V_113 -> V_328 = V_327 -> V_333 [ V_60 ] . V_334 ;
V_214 -> V_302 -> V_335 =
V_35 -> V_42 -> V_331 . V_332
+ F_165 ( V_327 -> V_333 [ V_60 ] . V_336 ) ;
V_214 -> V_328 = V_327 -> V_333 [ V_60 ] . V_337 ;
if ( V_215 ) {
V_215 -> V_302 -> V_335 =
V_35 -> V_42 -> V_331 . V_332
+ F_165 ( V_327 -> V_333 [ V_60 ] . V_338 ) ;
...
void
F_166 ( struct V_111 * V_35 , struct V_118 * V_119 )
{
F_66 ( V_35 , V_197 ) ;
}
void
F_167 ( struct V_124 * V_225 , struct V_126 * V_127 )
{
...
F_168 ( V_350 ) ;
V_343 = V_350 * V_355 ;
V_343 = F_169 ( V_343 , V_305 ) ;
V_346 = F_170 ( V_343 ) ;
F_168 ( V_352 ) ;
V_345 = V_352 * V_356 ;
V_345 = F_169 ( V_345 , V_305 ) ;
V_348 = F_170 ( V_345 ) ;
if ( V_231 != V_225 -> V_275 ) {
F_168 ( V_351 ) ;
V_344 = V_351 * V_356 ;
V_344 = F_169 ( V_344 , V_305 ) ;
V_347 = F_170 ( V_344 ) ;
} else
V_347 = 0 ;
...
struct V_111 *
F_172 ( struct V_42 * V_42 , struct V_158 * V_158 ,
struct V_124 * V_218 ,
...
void
F_175 ( struct V_111 * V_35 , enum V_98 type ,
void (* F_81)( void * , struct V_111 * ) )
{
if ( type == V_110 ) {
(* F_81)( V_35 -> V_42 -> V_158 , V_35 ) ;
} else {
...
enum V_156
F_179 ( struct V_111 * V_35 , enum V_434 V_435 ,
enum V_434 V_436 ,
void (* F_81)( struct V_158 * , struct V_111 * ) )
{
struct V_7 * V_8 = & V_35 -> V_8 ;
...
void
F_182 ( struct V_111 * V_35 , int V_3 )
{
struct V_112 * V_113 ;
struct V_90 * V_91 ;
F_37 (qe, &rx->rxp_q) {
...
void
F_183 ( struct V_42 * V_42 , const V_6 V_411 [] [ V_438 ] )
{
int V_60 , V_61 ;
...
static void
F_185 ( struct V_461 * V_462 )
{
F_186 ( V_462 ) ;
}
static void
F_187 ( struct V_461 * V_462 , enum V_463 V_10 )
{
switch ( V_10 ) {
case V_464 :
F_6 ( V_462 , V_465 ) ;
...
F_119 ( V_462 -> V_42 , & V_477 -> V_2 , V_205 ) ;
}
...
for ( V_60 = 0 , V_91 = F_127 ( & V_462 -> V_494 ) ;
V_60 < V_462 -> V_493 ;
V_60 ++ , V_91 = F_128 ( V_91 ) ) {
V_477 = (struct V_476 * ) V_91 ;
F_130 ( & V_212 -> V_225 [ V_60 ] . V_227 . V_227 , & V_477 -> V_228 ) ;
...
F_37 (qe, &tx->txq_q) {
V_477 = (struct V_476 * ) V_91 ;
F_133 ( V_462 -> V_42 , & V_477 -> V_2 ) ;
}
F_199 ( V_462 ) ;
}
static void
F_200 ( struct V_476 * V_477 , int V_291 , int V_292 ,
struct V_293 * V_294 ,
struct V_293 * V_295 ,
struct V_293 * V_296 )
{
...
static struct V_461 *
F_201 ( struct V_502 * V_503 , enum V_504 type )
{
struct V_90 * V_91 = NULL ;
...
if ( V_282 == NULL ) {
F_142 ( & V_503 -> V_505 , & V_462 -> V_91 ) ;
} else if ( F_128 ( V_282 ) == & V_503 -> V_505 ) {
F_42 ( & V_462 -> V_91 , & V_503 -> V_505 ) ;
} else {
F_128 ( & V_462 -> V_91 ) = F_128 ( V_282 ) ;
F_143 ( & V_462 -> V_91 ) = V_282 ;
F_128 ( V_282 ) = & V_462 -> V_91 ;
F_143 ( F_128 ( & V_462 -> V_91 ) ) = & V_462 -> V_91 ;
}
}
static void
...
void
F_206 ( struct V_461 * V_462 , struct V_118 * V_119 )
{
struct V_510 * V_327 = & V_462 -> V_31 . V_327 ;
struct V_476 * V_477 = NULL ;
struct V_90 * V_91 ;
int V_60 ;
F_164 ( & V_462 -> V_42 -> V_43 , ( T_1 * ) V_327 ,
sizeof( struct V_510 ) ) ;
V_462 -> V_328 = V_327 -> V_328 ;
for ( V_60 = 0 , V_91 = F_127 ( & V_462 -> V_494 ) ;
V_60 < V_462 -> V_493 ; V_60 ++ , V_91 = F_128 ( V_91 ) ) {
V_477 = (struct V_476 * ) V_91 ;
...
void
F_209 ( int V_493 , int V_513 , struct V_126 * V_127 )
{
V_6 V_514 ;
V_6 V_291 ;
struct V_349 * V_136 ;
...
struct V_461 *
F_210 ( struct V_42 * V_42 , struct V_158 * V_158 ,
struct V_524 * V_495 ,
...
void
F_213 ( struct V_461 * V_462 , enum V_98 type ,
void (* F_81)( void * , struct V_461 * ) )
{
if ( type == V_110 ) {
(* F_81)( V_462 -> V_42 -> V_158 , V_462 ) ;
return;
}
V_462 -> V_154 = F_81 ;
...
void
F_216 ( struct V_502 * V_503 , struct V_42 * V_42 ,
struct V_126 * V_127 )
{
int V_60 ;
V_503 -> V_42 = V_42 ;
...
void
F_218 ( struct V_502 * V_503 , enum V_504 type )
{
struct V_461 * V_462 ;
struct V_90 * V_91 ;
V_503 -> V_12 |= V_531 ;
...
void
F_221 ( struct V_461 * V_462 , int V_3 )
{
struct V_476 * V_477 ;
struct V_90 * V_91 ;
F_37 (qe, &tx->txq_q) {
