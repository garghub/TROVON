...
* V_75 = F_5 ( V_110 ) & ~ ( V_111 - 1 ) ;
if ( * V_75 == 0 ) {
F_90 ( L_20 ) ;
goto exit;
}
V_55 = 0 ;
V_77 -> V_112 = F_1 ( V_113 ) & 0x0f ;
F_90 ( L_21 , V_78 ,
...
V_77 -> V_116 = 1 ;
F_6 ( 5 ) ;
V_77 -> V_117 = F_1 ( V_118 ) & 0x3f ;
} else if ( V_77 -> type == V_106 ) {
int V_119 , V_120 , V_121 , V_122 , V_123 ;
V_77 -> V_116 = 1 ;
F_6 ( V_124 ) ;
V_119 = F_1 ( V_125 ) ;
V_120 = F_1 ( V_126 ) ;
...
&& ! ( V_77 -> V_116 ) )
V_77 -> V_135 = F_1 ( V_136 ) ;
V_1 = F_1 ( V_128 ) ;
V_134 = V_77 -> type == V_104 && ( V_1 & ( 1 << 2 ) ) ;
if ( ( V_77 -> type == V_94 || V_134 ) && ! ( V_1 & ( 1 << 1 ) ) ) {
V_1 |= ( 1 << 1 ) ;
F_4 ( V_128 , V_1 ) ;
F_91 ( L_26 ) ;
}
...
{
struct V_9 * V_10 = F_94 ( V_140 ) ;
struct V_76 * V_77 = F_95 ( V_17 ) ;
int V_54 ;
F_96 ( & V_17 -> V_141 , & V_142 ) ;
for ( V_54 = 0 ; V_54 < 10 ; V_54 ++ ) {
if ( V_77 -> V_115 & ( 1 << V_54 ) )
continue;
F_96 ( & V_17 -> V_141 , & V_143 [ V_54 ] ) ;
if ( V_144 [ V_54 ] )
F_97 ( & V_17 -> V_141 ,
V_144 [ V_54 ] ) ;
}
for ( V_54 = 0 ; V_54 < 3 ; V_54 ++ ) {
if ( ! ( V_10 -> V_145 & ( 1 << V_54 ) ) )
continue;
F_96 ( & V_17 -> V_141 , & V_146 [ V_54 ] ) ;
if ( F_98 ( V_10 ) )
F_97 ( & V_17 -> V_141 ,
V_147 [ V_54 ] ) ;
if ( V_77 -> V_117 )
...
if ( ! ( V_10 -> V_149 & ( 1 << V_54 ) ) )
continue;
F_96 ( & V_17 -> V_141 , & V_150 [ V_54 ] ) ;
if ( V_77 -> V_117 )
F_97 ( & V_17 -> V_141 ,
V_151 [ V_54 ] ) ;
if ( V_54 < 3 && ! F_50 ( V_10 ) )
...
if ( V_77 -> V_131 & ( 1 << 0 ) )
continue;
F_96 ( & V_17 -> V_141 , & V_153 [ V_54 ] ) ;
if ( F_61 ( V_10 ) )
F_96 ( & V_17 -> V_141 ,
& V_154 [ V_54 ] ) ;
}
if ( ! V_77 -> V_116 )
F_96 ( & V_17 -> V_141 , & V_155 ) ;
F_96 ( & V_17 -> V_141 , & V_156 ) ;
}
static int F_99 ( struct V_157 * V_140 )
{
struct V_9 * V_10 ;
struct V_158 * V_159 ;
struct V_16 * V_17 = & V_140 -> V_17 ;
struct V_76 * V_77 = F_95 ( V_17 ) ;
int V_55 = 0 , V_54 ;
int V_160 ;
int V_161 ;
V_159 = F_100 ( V_140 , V_162 , 0 ) ;
if ( ! F_101 ( & V_140 -> V_17 , V_159 -> V_163 , V_164 ,
V_7 ) ) {
F_62 ( V_17 , L_31 ,
( unsigned long ) V_159 -> V_163 ,
( unsigned long ) ( V_159 -> V_163 + V_164 - 1 ) ) ;
return - V_8 ;
}
V_10 = F_102 ( & V_140 -> V_17 , sizeof( struct V_9 ) , V_165 ) ;
if ( ! V_10 )
return - V_166 ;
V_10 -> V_167 = V_159 -> V_163 ;
V_10 -> type = V_77 -> type ;
V_10 -> V_168 = V_169 [ V_77 -> type ] . V_168 ;
V_10 -> V_170 = V_169 [ V_77 -> type ] . V_170 ;
V_10 -> V_171 = V_169 [ V_77 -> type ] . V_171 ;
V_10 -> V_74 = V_169 [ V_77 -> type ] . V_74 ;
switch ( V_10 -> type ) {
case V_85 :
if ( V_77 -> V_112 >= 0x03 ) {
V_10 -> V_168 &= ~ V_172 ;
...
F_106 ( V_140 ) ;
V_55 = F_107 ( & V_17 -> V_141 , & V_142 ) ;
if ( V_55 )
return V_55 ;
for ( V_54 = 0 ; V_54 < 10 ; V_54 ++ ) {
if ( V_77 -> V_115 & ( 1 << V_54 ) )
continue;
V_55 = F_107 ( & V_17 -> V_141 , & V_143 [ V_54 ] ) ;
if ( V_55 )
goto error;
if ( V_77 -> V_117 && V_144 [ V_54 ] ) {
V_55 = F_108 ( & V_17 -> V_141 ,
V_144 [ V_54 ] ) ;
if ( V_55 )
goto error;
}
...
if ( ! ( V_10 -> V_145 & ( 1 << V_54 ) ) )
continue;
V_55 = F_107 ( & V_17 -> V_141 , & V_146 [ V_54 ] ) ;
if ( V_55 )
goto error;
if ( F_98 ( V_10 ) ) {
V_55 = F_108 ( & V_17 -> V_141 ,
...
if ( ! ( V_10 -> V_149 & ( 1 << V_54 ) ) )
continue;
V_55 = F_107 ( & V_17 -> V_141 , & V_150 [ V_54 ] ) ;
if ( V_55 )
goto error;
if ( V_54 < 3 && ! F_50 ( V_10 ) ) {
V_55 = F_108 ( & V_17 -> V_141 ,
...
if ( V_160 ) {
for ( V_54 = 0 ; V_54 < 3 ; V_54 ++ ) {
if ( V_77 -> V_131 & ( 1 << V_54 ) )
continue;
V_55 = F_107 ( & V_17 -> V_141 ,
& V_153 [ V_54 ] ) ;
if ( V_55 )
goto error;
if ( ! F_61 ( V_10 ) )
...
if ( ! V_77 -> V_116 ) {
V_10 -> V_69 = F_111 () ;
V_10 -> V_70 = V_77 -> V_135 ;
V_55 = F_107 ( & V_17 -> V_141 , & V_155 ) ;
if ( V_55 )
goto error;
}
for ( V_54 = 0 ; V_54 < 4 ; V_54 ++ ) {
if ( ! ( V_77 -> V_114 & ( 1 << V_54 ) ) )
continue;
V_55 = F_108 ( & V_17 -> V_141 ,
V_177 [ V_54 ] ) ;
if ( V_55 )
...
V_10 -> V_178 = F_112 ( V_17 ) ;
if ( F_113 ( V_10 -> V_178 ) ) {
V_55 = F_114 ( V_10 -> V_178 ) ;
goto error;
}
return 0 ;
error:
...
static int F_115 ( struct V_157 * V_140 )
{
struct V_9 * V_10 = F_94 ( V_140 ) ;
F_116 ( V_10 -> V_178 ) ;
F_93 ( & V_140 -> V_17 ) ;
...
{
F_117 ( V_1 , V_10 -> V_167 + V_179 ) ;
return F_118 ( V_10 -> V_167 + V_180 ) ;
}
static void F_30 ( struct V_9 * V_10 , T_1 V_1 , T_1 V_181 )
{
F_117 ( V_1 , V_10 -> V_167 + V_179 ) ;
F_117 ( V_181 , V_10 -> V_167 + V_180 ) ;
}
...
T_1 V_183 [ 3 ] ;
for ( V_54 = 0 ; V_54 < 3 ; V_54 ++ )
V_183 [ V_54 ] = F_40 ( V_10 ,
F_64 ( V_54 ) ) ;
if ( ! ( ( V_183 [ 0 ] | V_183 [ 1 ] | V_183 [ 2 ] ) & 0x80 ) ) {
F_119 ( V_17 ,
L_33 ) ;
F_30 ( V_10 , V_59 ,
V_58 | 0x87 ) ;
...
static void F_106 ( struct V_157 * V_140 )
{
struct V_76 * V_77 = F_95 ( & V_140 -> V_17 ) ;
struct V_9 * V_10 = F_94 ( V_140 ) ;
int V_58 , V_54 ;
T_1 V_184 ;
for ( V_54 = 0 ; V_54 < 3 ; V_54 ++ ) {
...
V_58 = F_40 ( V_10 , V_185 ) ;
if ( ( V_58 & 0xff ) == 0 ) {
F_30 ( V_10 , V_185 , 0xff ) ;
}
V_184 = 0x70 & ~ ( V_77 -> V_130 << 4 ) ;
V_10 -> V_40 = F_40 ( V_10 , V_60 ) ;
if ( ( V_10 -> V_40 & V_184 ) == 0 ) {
V_10 -> V_40 |= V_184 ;
F_30 ( V_10 , V_60 ,
V_10 -> V_40 ) ;
}
V_10 -> V_149 = ( V_10 -> V_40 >> 4 ) & 0x07 ;
if ( F_50 ( V_10 ) && V_10 -> type != V_41 ) {
V_58 = F_40 ( V_10 , V_186 ) ;
if ( ~ V_58 & 0x07 & V_10 -> V_149 ) {
F_110 ( & V_140 -> V_17 ,
L_37 ) ;
F_30 ( V_10 , V_186 ,
V_58 | 0x07 ) ;
...
int V_54 ;
F_29 ( & V_10 -> V_27 ) ;
if ( F_121 ( V_188 , V_10 -> V_189 + V_190 + V_190 / 2 )
|| ! V_10 -> V_31 ) {
if ( V_187 ) {
F_30 ( V_10 , V_67 ,
F_40 ( V_10 , V_67 ) | 0x40 ) ;
...
if ( V_55 )
goto exit;
V_140 = F_126 ( V_7 , V_75 ) ;
if ( ! V_140 ) {
V_55 = - V_166 ;
F_127 ( L_38 ) ;
goto exit;
}
V_55 = F_128 ( V_140 , & V_159 , 1 ) ;
if ( V_55 ) {
F_127 ( L_39 , V_55 ) ;
goto V_200;
}
V_55 = F_129 ( V_140 , V_77 ,
sizeof( struct V_76 ) ) ;
if ( V_55 ) {
F_127 ( L_40 ) ;
goto V_200;
...
{
int V_55 ;
unsigned short V_201 = 0 ;
struct V_76 V_77 ;
memset ( & V_77 , 0 , sizeof( struct V_76 ) ) ;
V_55 = F_88 ( & V_201 , & V_77 ) ;
if ( V_55 )
return V_55 ;
V_55 = F_133 ( & V_202 ) ;
if ( V_55 )
return V_55 ;
V_55 = F_124 ( V_201 , & V_77 ) ;
if ( V_55 ) {
F_134 ( & V_202 ) ;
return V_55 ;
}
