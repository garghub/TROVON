...
static void F_176 ( unsigned long V_99 )
{
...
static int F_178 ( struct V_42 * V_43 )
{
struct V_1 * V_2 ;
struct V_241 * V_242 ;
int V_84 , V_23 ;
V_242 = F_179 ( sizeof( * V_242 ) , V_183 ) ;
if ( ! V_242 )
return - V_48 ;
V_2 = F_173 ( V_43 ) ;
if ( ! V_2 ) {
F_180 ( & V_43 -> V_232 , L_49 ) ;
V_84 = - V_151 ;
goto V_269;
}
F_2 ( & V_43 -> V_6 ) ;
...
F_181 ( & V_43 -> V_272 , F_176 , ( unsigned long ) V_43 ) ;
F_182 ( & V_43 -> V_272 , V_75 + V_273 ) ;
F_4 ( & V_43 -> V_6 ) ;
...
static void F_184 ( struct V_187 * V_188 ,
struct V_1 * V_2 )
{
struct V_55 * V_56 ;
F_71 ( & V_2 -> V_2 . V_210 ) ;
...
F_73 ( & V_2 -> V_2 . V_210 ) ;
if ( V_188 == V_275 )
F_185 ( V_188 , F_186 ( V_2 ) ) ;
else
F_185 ( V_188 , V_2 -> V_145 ) ;
}
static struct V_150 * F_187 ( struct V_34 * V_35 )
{
struct V_150 * V_49 ;
...
{
struct V_42 * V_43 = F_192 ( F_48 ( V_90 ) , V_278 ) ;
int V_84 ;
V_84 = F_178 ( V_43 ) ;
if ( V_84 == - V_132 && ++ V_43 -> V_279 < V_280 )
F_25 ( & V_43 -> V_278 , V_281 ) ;
}
static int F_193 ( struct V_150 * V_49 , struct V_282 * V_232 )
{
struct V_233 * V_283 = & V_232 -> V_233 ;
struct V_21 * V_284 = F_194 ( V_232 ) ;
struct V_42 * V_43 ;
struct V_285 V_286 ;
int V_287 , V_288 ;
int V_46 ;
V_43 = F_195 ( sizeof( * V_43 ) , V_183 ) ;
if ( ! V_43 )
return - V_48 ;
F_165 ( V_43 , V_270 ) ;
F_196 ( V_283 , V_43 ) ;
V_43 -> V_232 = V_232 ;
V_43 -> V_234 = ( T_5 ) V_284 -> V_289 [ 3 ] << 32 | V_284 -> V_289 [ 4 ] ;
...
F_197 () ;
V_43 -> V_46 = V_46 ;
F_198 ( & V_286 , V_232 -> V_291 ) ;
while ( F_199 ( & V_286 , & V_287 , & V_288 ) ) {
if ( V_287 == ( V_292 | V_293 ) ) {
V_43 -> V_235 = V_294 + 4 * V_288 ;
break;
}
}
if ( V_43 -> V_235 == 0ULL ) {
...
F_202 ( & V_43 -> V_278 , F_191 ) ;
V_43 -> V_49 = V_49 ;
F_203 ( & V_43 -> V_296 , & V_49 -> V_297 ) ;
...
static int F_208 ( struct V_282 * V_232 )
{
struct V_21 * V_284 = F_194 ( V_232 ) ;
...
V_303 = F_216 ( & V_49 -> V_155 [ V_14 ] -> V_2 ,
V_311 ,
...
V_49 -> V_155 [ V_14 ] -> V_233 = V_303 ;
}
if ( V_300 ) {
struct V_233 * V_313 ;
V_313 = F_216 ( & V_49 -> V_155 [ V_14 ] -> V_2 ,
V_275 ,
F_186 ( V_49 -> V_155 [ V_14 ] ) ,
V_35 -> V_233 ) ;
if ( F_204 ( V_313 ) ) {
V_84 = F_217 ( V_313 ) ;
F_180 ( & V_232 , L_56 ,
...
V_49 -> V_155 [ V_14 ] -> V_233 = V_313 ;
V_49 -> V_155 [ V_14 ] -> V_71 = true ;
}
if ( ! F_218 ( V_314 ) ) {
V_49 -> V_315 = F_219 ( F_141 ( & V_232 -> V_233 ) ,
V_314 ) ;
if ( ! F_218 ( V_49 -> V_315 ) ) {
F_220 ( L_57 , 0444 , V_49 -> V_315 ,
V_49 , & V_316 ) ;
F_220 ( L_58 , 0444 , V_49 -> V_315 ,
V_49 , & V_317 ) ;
}
}
F_203 ( & V_49 -> V_296 , & V_318 ) ;
F_221 ( & V_232 , L_59 ,
F_141 ( V_35 -> V_233 ) , ( unsigned long long ) V_35 -> V_234 ) ;
V_84 = F_193 ( V_49 , V_232 ) ;
if ( ! V_84 )
return 0 ;
F_180 ( & V_232 , L_60 , V_84 ) ;
F_222 ( V_49 -> V_315 ) ;
F_207 ( & V_49 -> V_296 ) ;
if ( V_300 )
F_185 ( V_275 ,
...
F_185 ( V_311 , V_49 -> V_155 [ V_14 ] -> V_145 ) ;
...
static int F_223 ( struct V_282 * V_232 ,
const struct V_319 * V_276 )
{
struct V_150 * V_49 ;
int V_84 ;
F_71 ( & V_320 ) ;
V_49 = F_187 ( F_194 ( V_232 ) -> V_35 ) ;
if ( ! V_49 )
V_84 = F_208 ( V_232 ) ;
else
V_84 = F_193 ( V_49 , V_232 ) ;
...
static void F_224 ( struct V_282 * V_232 )
{
struct V_42 * V_43 = F_225 ( & V_232 -> V_233 ) ;
...
F_222 ( V_49 -> V_315 ) ;
for ( V_152 = 0 ; V_152 < V_264 ; ++ V_152 )
F_184 ( V_311 , V_49 -> V_155 [ V_152 ] ) ;
if ( V_300 )
F_184 ( V_275 , V_49 -> V_155 [ V_152 ] ) ;
F_83 ( & V_49 -> V_149 , F_75 ) ;
}
F_73 ( & V_320 ) ;
}
static void F_227 ( struct V_282 * V_232 )
{
struct V_21 * V_284 = F_194 ( V_232 ) ;
struct V_42 * V_43 = F_225 ( & V_232 -> V_233 ) ;
int V_46 ;
...
static void F_228 ( struct V_89 * V_90 )
{
struct V_42 * V_43 = F_192 ( V_90 , V_90 ) ;
struct V_251 * V_245 = & V_43 -> V_321 . V_245 ;
struct V_1 * V_2 ;
struct V_241 * V_242 ;
int V_23 ;
V_242 = F_179 ( sizeof( * V_242 ) , V_183 ) ;
...
static void F_229 ( struct V_89 * V_90 )
{
struct V_42 * V_43 = F_192 ( V_90 , V_90 ) ;
struct V_1 * V_2 = NULL ;
struct V_241 * V_242 ;
...
static int F_230 ( struct V_42 * V_43 ,
struct V_241 * V_242 ,
unsigned long long V_45 ,
T_1 V_37 )
{
...
bool V_265 = false ;
int V_23 ;
if ( V_45 != V_326 . V_120 || V_37 < sizeof( V_242 -> V_244 ) )
return V_25 ;
...
F_2 ( & V_43 -> V_6 ) ;
if ( V_43 -> V_219 == V_302 ) {
F_180 ( & V_43 -> V_232 , L_64 ) ;
F_4 ( & V_43 -> V_6 ) ;
return V_25 ;
}
V_23 = V_39 ;
F_5 ( & V_43 -> V_232 , L_65 , V_242 -> V_244 . V_240 ) ;
switch ( F_152 ( V_242 -> V_244 . V_240 ) & V_327 ) {
case V_243 :
if ( F_231 ( & V_43 -> V_90 ) ) {
F_180 ( & V_43 -> V_232 , L_66 ) ;
V_23 = V_123 ;
} else {
V_43 -> V_321 . V_245 = V_242 -> V_245 ;
F_232 ( & V_43 -> V_90 , F_228 ) ;
F_233 ( V_328 , & V_43 -> V_90 ) ;
}
break;
case V_246 :
if ( V_43 -> V_219 != V_268 ) {
...
case V_248 :
if ( F_231 ( & V_43 -> V_90 ) ) {
F_180 ( & V_43 -> V_232 , L_68 ) ;
V_23 = V_123 ;
} else {
F_232 ( & V_43 -> V_90 , F_229 ) ;
F_233 ( V_328 , & V_43 -> V_90 ) ;
}
break;
case V_249 :
...
F_221 ( & V_43 -> V_232 , L_69 ) ;
V_2 = F_177 ( V_43 ) ;
V_265 = true ;
}
break;
default:
F_180 ( & V_43 -> V_232 , L_70 ,
...
static void F_234 ( struct V_34 * V_35 ,
struct V_113 * V_114 ,
int V_44 , int V_115 , int V_116 ,
int V_46 ,
unsigned long long V_45 ,
...
switch ( V_44 ) {
case V_121 :
V_23 = F_230 ( V_43 , V_242 , V_45 , V_37 ) ;
break;
default:
V_23 = V_124 ;
}
...
V_314 = F_219 ( V_330 , NULL ) ;
if ( V_264 + V_329 > V_331 )
V_264 = V_331 - V_329 ;
V_154 = V_264 + V_329 ;
V_311 = F_236 ( V_146 , V_332
| V_333 ) ;
if ( F_204 ( V_311 ) ) {
V_84 = F_217 ( V_311 ) ;
return V_84 ;
...
V_326 . V_122 = sizeof( struct V_241 ) ;
V_326 . V_309 = F_234 ;
V_84 = F_215 ( & V_326 ,
& V_352 ) ;
if ( V_84 ) {
