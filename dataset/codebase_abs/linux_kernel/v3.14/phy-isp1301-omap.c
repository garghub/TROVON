...
V_100 = V_105 ;
if ( V_118 )
F_42 ( V_19 -> V_20 , V_19 -> V_20 -> V_120 ) ;
}
F_33 ( V_3 , V_95 ) ;
return V_100 ;
}
...
static int F_44 ( struct V_130 * V_18 )
{
V_121 = V_18 ;
return 0 ;
}
...
F_11 ( V_3 , V_153 ,
V_72 | V_70 | V_73 ) ;
F_79 ( & V_3 -> V_7 -> V_18 , L_42 ) ;
return 0 ;
}
static int
F_80 ( struct V_102 * V_19 , struct V_157 * V_20 )
{
struct V_2 * V_3 = F_59 ( V_19 -> V_9 , struct V_2 , V_9 ) ;
if ( V_3 != V_156 )
return - V_21 ;
if ( ! V_20 ) {
F_40 ( 0 , V_129 ) ;
...
return 0 ;
#else
F_65 ( & V_3 -> V_7 -> V_18 , L_45 ) ;
return - V_159 ;
#endif
}
static int
F_82 ( struct V_102 * V_19 , struct V_160 * V_26 )
{
struct V_2 * V_3 = F_59 ( V_19 -> V_9 , struct V_2 , V_9 ) ;
if ( V_3 != V_156 )
return - V_21 ;
...
#ifdef F_54
V_19 -> V_26 = V_26 ;
F_65 ( & V_3 -> V_7 -> V_18 , L_46 ) ;
if ( V_19 -> V_20 )
return F_78 ( V_3 ) ;
return 0 ;
#elif ! F_81 ( V_161 ) && ! F_81 ( V_162 )
V_19 -> V_26 = V_26 ;
{
T_2 V_34 ;
V_34 = F_29 ( V_39 ) & V_65 ;
...
F_11 ( V_3 , V_153 ,
V_72 ) ;
F_79 ( & V_3 -> V_7 -> V_18 , L_47 ) ;
F_32 ( V_3 , V_95 ) ;
if ( F_7 ( V_3 , V_47 ) & V_72 )
F_52 ( V_3 ) ;
return 0 ;
#else
F_65 ( & V_3 -> V_7 -> V_18 , L_48 ) ;
return - V_159 ;
#endif
}
static int
F_84 ( struct V_163 * V_18 , unsigned V_1 )
{
if ( ! V_156 )
return - V_21 ;
if ( V_18 -> V_10 == V_52 )
...
static int
F_85 ( struct V_102 * V_19 )
{
struct V_2 * V_3 = F_59 ( V_19 -> V_9 , struct V_2 , V_9 ) ;
T_2 V_64 ;
if ( V_3 != V_156 || V_3 -> V_9 . V_10 != V_42 )
return - V_21 ;
V_64 = F_29 ( V_39 ) ;
if ( ! ( V_64 & V_76 ) )
return - V_159 ;
...
static int
F_87 ( struct V_151 * V_152 , const struct V_167 * V_168 )
{
int V_4 ;
struct V_2 * V_3 ;
if ( V_156 )
return 0 ;
V_3 = F_88 ( sizeof *V_3 , V_169 ) ;
if ( ! V_3 )
return 0 ;
V_3 -> V_9 . V_19 = F_88 ( sizeof * V_3 -> V_9 . V_19 , V_169 ) ;
if ( ! V_3 -> V_9 . V_19 ) {
F_70 ( V_3 ) ;
return 0 ;
}
...
V_4 = F_9 ( V_3 , V_171 ) ;
if ( V_4 != V_172 ) {
F_65 ( & V_152 -> V_18 , L_51 , V_4 ) ;
goto V_173;
}
V_4 = F_9 ( V_3 , V_174 ) ;
if ( V_4 != V_175 ) {
F_65 ( & V_152 -> V_18 , L_52 , V_4 ) ;
goto V_173;
}
V_3 -> V_150 = V_152 -> V_18 . V_176 ;
V_152 -> V_18 . V_176 = F_68 ;
V_4 = F_10 ( V_152 , V_177 ) ;
F_79 ( & V_152 -> V_18 , L_53 V_178 L_54 ,
V_4 >> 8 , V_4 & 0xff ) ;
F_13 ( V_3 , V_12 , V_179 ) ;
...
V_3 -> V_9 . V_19 -> V_188 = F_80 ,
V_3 -> V_9 . V_19 -> V_189 = F_82 ,
V_3 -> V_9 . V_19 -> V_190 = F_85 ,
V_3 -> V_9 . V_19 -> V_191 = F_86 ,
F_3 ( V_3 , 0 ) ;
F_16 ( V_3 ) ;
V_156 = V_3 ;
#ifdef F_54
...
#ifdef F_63
F_64 ( & V_3 -> V_147 , V_148 + V_149 ) ;
F_65 ( & V_152 -> V_18 , L_58 , V_192 ) ;
#endif
V_4 = F_95 ( & V_3 -> V_9 , V_193 ) ;
if ( V_4 < 0 )
F_96 ( & V_152 -> V_18 , L_59 ,
V_4 ) ;
return 0 ;
V_173:
F_70 ( V_3 -> V_9 . V_19 ) ;
