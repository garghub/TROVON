...
static void F_36 ( struct V_24 * V_15 , int V_37 )
{
F_37 ( V_15 , V_37 ) ;
F_10 ( F_22 ( V_15 ) ) ;
}
static void F_38 ( struct V_24 * V_15 )
{
#ifdef F_39
...
static int F_47 ( struct V_24 * V_15 ,
struct V_59 * V_60 )
{
struct V_10 * V_11 = F_22 ( V_15 ) ;
...
static int F_50 ( struct V_24 * V_15 ,
struct V_59 * V_60 )
{
struct V_10 * V_11 = F_22 ( V_15 ) ;
int V_4 ;
...
static int F_53 ( struct V_24 * V_15 , T_2 V_1 ,
union V_80 * V_8 )
{
int V_40 = F_54 ( V_15 , V_1 , V_8 ) ;
return V_40 ;
}
static int F_55 ( struct V_24 * V_15 , T_2 V_1 ,
union V_80 * V_8 )
{
int V_40 = F_54 ( V_15 , V_1 , V_8 ) ;
return V_40 ;
}
static struct V_24 * F_56 ( struct V_81 * V_81 ,
unsigned int V_1 )
{
struct V_10 * V_11 ;
struct V_24 * V_15 ;
...
static void F_65 ( struct V_24 * V_15 )
{
struct V_10 * V_11 = F_22 ( V_15 ) ;
...
static void F_68 ( struct V_81 * V_81 )
{
}
...
F_71 ( V_101 , V_101 +
V_74 [ V_96 ] + V_95 ) ;
V_40 = F_72 ( NULL , sizeof( struct V_10 ) , 0 , V_102 ) ;
if ( V_40 )
goto V_97;
V_103 . V_104 = V_102 ;
V_105 = & V_103 ;
