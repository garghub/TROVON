...
if ( V_63 ) {
V_68 = F_34 ( V_63 , V_65 ) ;
V_70 = F_35 ( sizeof( struct V_34 * ) * V_68 ,
V_71 ) ;
if ( ! V_70 ) {
V_39 = - V_72 ;
goto V_73;
...
if ( V_62 ) {
V_67 = F_34 ( V_62 , V_64 ) ;
V_69 = F_35 ( sizeof( struct V_34 * ) * V_67 ,
V_71 ) ;
if ( ! V_69 ) {
V_39 = - V_72 ;
goto V_73;
...
int V_39 ;
struct V_5 * V_6 ;
V_6 = F_35 ( sizeof( struct V_5 ) , V_83 ) ;
if ( ! V_6 ) {
F_43 ( L_10 ) ;
V_39 = - V_72 ;
goto V_84;
...
V_6 -> V_9 = false ;
if ( F_49 ( V_12 , V_86 ) ) {
F_50 ( V_12 , struct V_87 , V_82 , & V_82 ) ;
} else {
V_39 = - V_88 ;
goto V_85;
}
...
F_51 ( V_12 , F_52 ( struct V_87 , V_24 ) ,
V_24 , V_82 ) ;
V_6 -> V_24 = V_24 ;
V_6 -> V_82 = V_82 ;
V_39 = F_53 ( & ( V_12 -> V_77 . V_89 ) , & V_90 . V_79 ) ;
if ( V_39 ) {
goto V_91;
}
V_6 -> V_23 = F_35 ( sizeof( V_92 ) , V_83 ) ;
if ( ! V_6 -> V_23 ) {
V_39 = - V_72 ;
goto V_91;
}
...
static int
F_58 ( struct V_3 * V_4 , const char * V_98 , char * args )
{
struct V_5 * V_6 ;
int V_99 = - V_100 ;
int V_101 = 0 ;
F_3 ( & V_8 ) ;
F_59 (chan, &virtio_chan_list, chan_list) {
if ( ! strncmp ( V_98 , V_6 -> V_24 , V_6 -> V_82 ) &&
strlen ( V_98 ) == V_6 -> V_82 ) {
if ( ! V_6 -> V_9 ) {
V_6 -> V_9 = true ;
V_101 = 1 ;
break;
...
static void F_60 ( struct V_81 * V_12 )
{
