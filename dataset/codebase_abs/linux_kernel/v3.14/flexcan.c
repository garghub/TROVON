...
if ( V_185 ) {
V_155 = V_185 -> V_37 ;
} else if ( V_183 -> V_194 -> V_195 ) {
V_155 = (struct V_186 * )
V_183 -> V_194 -> V_195 ;
} else {
return - V_181 ;
}
V_27 = F_86 ( sizeof( struct V_3 ) , 1 ) ;
if ( ! V_27 )
return - V_196 ;
V_27 -> V_197 = & V_198 ;
V_27 -> V_117 = V_117 ;
...
V_4 -> V_166 = V_166 ;
V_4 -> V_167 = V_167 ;
V_4 -> V_207 = F_87 ( & V_183 -> V_27 ) ;
V_4 -> V_155 = V_155 ;
V_4 -> V_5 = F_88 ( & V_183 -> V_27 , L_23 ) ;
if ( F_78 ( V_4 -> V_5 ) )
V_4 -> V_5 = NULL ;
F_89 ( V_27 , & V_4 -> V_109 , F_43 , V_208 ) ;
F_90 ( V_183 , V_27 ) ;
F_91 ( V_27 , & V_183 -> V_27 ) ;
V_142 = F_71 ( V_27 ) ;
if ( V_142 ) {
...
static int F_95 ( struct V_182 * V_183 )
{
struct V_26 * V_27 = F_96 ( V_183 ) ;
struct V_3 * V_4 = F_19 ( V_27 ) ;
F_73 ( V_27 ) ;
F_97 ( & V_4 -> V_109 ) ;
F_94 ( V_27 ) ;
...
static int F_98 ( struct V_210 * V_210 )
{
struct V_26 * V_27 = F_99 ( V_210 ) ;
struct V_3 * V_4 = F_19 ( V_27 ) ;
int V_142 ;
V_142 = F_14 ( V_4 ) ;
if ( V_142 )
...
static int F_102 ( struct V_210 * V_210 )
{
struct V_26 * V_27 = F_99 ( V_210 ) ;
struct V_3 * V_4 = F_19 ( V_27 ) ;
V_4 -> V_7 . V_78 = V_79 ;
