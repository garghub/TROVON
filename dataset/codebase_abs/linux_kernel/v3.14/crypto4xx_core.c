...
static int F_49 ( struct V_143 * V_177 , int V_140 )
{
...
T_1 V_190 = 0 ;
V_158 = F_49 ( V_182 , V_183 ) ;
if ( V_158 == 1 )
V_158 = 0 ;
if ( F_54 ( V_144 ) || V_77 -> V_191 ) {
V_160 = 0 ;
} else {
if ( V_183 > V_54 ) {
V_160 = V_183 / V_54 ;
...
static int F_57 ( struct V_212 * V_165 )
{
struct V_213 * V_214 = V_165 -> V_215 ;
struct V_216 * V_217 = F_58 ( V_214 ) ;
...
static void F_61 ( struct V_212 * V_165 )
{
struct V_76 * V_77 = F_39 ( V_165 ) ;
F_8 ( V_77 ) ;
F_10 ( V_77 ) ;
}
int F_62 ( struct V_1 * V_223 ,
struct V_224 * V_213 ,
int V_225 )
{
struct V_216 * V_214 ;
...
case V_222 :
V_226 = F_63 ( & V_214 -> V_214 . V_227 . V_228 ) ;
break;
default:
V_226 = F_64 ( & V_214 -> V_214 . V_227 . V_229 ) ;
break;
}
if ( V_226 ) {
F_65 ( & V_214 -> V_230 ) ;
...
F_66 ( & V_214 -> V_230 , & V_223 -> V_231 ) ;
}
}
return 0 ;
}
static void F_67 ( struct V_1 * V_223 )
{
...
switch ( V_214 -> V_214 . type ) {
case V_222 :
F_69 ( & V_214 -> V_214 . V_227 . V_228 ) ;
break;
default:
F_70 ( & V_214 -> V_214 . V_227 . V_229 ) ;
}
F_14 ( V_214 ) ;
}
}
static void F_71 ( unsigned long V_232 )
{
...
static T_4 F_73 ( int V_236 , void * V_232 )
{
struct V_81 * V_2 = (struct V_81 * ) V_232 ;
struct V_173 * V_80 = F_72 ( V_2 ) ;
if ( V_80 -> V_2 -> V_16 == 0 )
...
static int T_5 F_75 ( struct V_239 * V_240 )
{
int V_226 ;
struct V_241 V_242 ;
struct V_81 * V_2 = & V_240 -> V_2 ;
struct V_173 * V_80 ;
V_226 = F_76 ( V_240 -> V_2 . V_243 , 0 , & V_242 ) ;
if ( V_226 )
return - V_244 ;
if ( F_77 ( NULL , NULL , L_1 ) ) {
F_78 ( V_245 , V_246 ,
F_79 ( V_245 , V_246 ) | V_247 ) ;
F_78 ( V_245 , V_246 ,
F_79 ( V_245 , V_246 ) & ~ V_247 ) ;
} else if ( F_77 ( NULL , NULL ,
L_2 ) ) {
F_78 ( V_245 , V_248 ,
F_79 ( V_245 , V_248 ) | V_249 ) ;
F_78 ( V_245 , V_248 ,
F_79 ( V_245 , V_248 ) & ~ V_249 ) ;
} else if ( F_77 ( NULL , NULL ,
L_3 ) ) {
F_78 ( V_245 , V_250 ,
F_79 ( V_245 , V_250 ) | V_251 ) ;
F_78 ( V_245 , V_250 ,
F_79 ( V_245 , V_250 ) & ~ V_251 ) ;
} else {
F_80 ( V_252 L_4 ) ;
...
if ( V_226 )
goto V_257;
F_84 ( & V_80 -> V_237 , F_71 ,
( unsigned long ) V_2 ) ;
V_80 -> V_236 = F_85 ( V_240 -> V_2 . V_243 , 0 ) ;
V_226 = F_86 ( V_80 -> V_236 , F_73 , 0 ,
V_80 -> V_2 -> V_258 , V_2 ) ;
if ( V_226 )
goto V_259;
