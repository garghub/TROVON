...
while ( ! F_93 ( & V_76 ) ) {
int V_21 ;
V_16 = F_95 ( & V_76 , struct V_13 , V_84 ) ;
F_96 ( & V_16 -> V_84 ) ;
F_64 ( V_16 , F_93 ( & V_76 ) ) ;
V_21 = V_3 -> V_39 -> V_85 ( V_8 , V_16 ) ;
switch ( V_21 ) {
case V_86 :
V_78 ++ ;
continue;
...
if ( ! V_78 )
V_8 -> V_91 [ 0 ] ++ ;
else if ( V_78 < ( 1 << ( V_92 - 1 ) ) )
V_8 -> V_91 [ F_100 ( V_78 ) + 1 ] ++ ;
if ( ! F_93 ( & V_76 ) ) {
F_89 ( & V_8 -> V_82 ) ;
F_101 ( & V_76 , & V_8 -> V_83 ) ;
F_91 ( & V_8 -> V_82 ) ;
...
void F_102 ( struct V_7 * V_8 , bool V_93 )
{
if ( F_61 ( F_9 ( V_79 , & V_8 -> V_54 ) ) )
return;
if ( ! V_93 )
...
struct V_2 * V_3 = V_8 -> V_42 ;
F_103 ( V_3 , & V_8 -> V_94 , 0 ) ;
}
}
void F_25 ( struct V_2 * V_3 , bool V_93 )
{
struct V_7 * V_8 ;
int V_9 ;
F_75 (q, hctx, i) {
...
{
struct V_7 * V_8 ;
V_8 = F_110 ( V_97 , struct V_7 , V_94 . V_97 ) ;
F_41 ( V_8 ) ;
}
...
F_112 ( V_8 -> V_42 , V_16 ) ;
if ( V_98 )
F_97 ( & V_16 -> V_84 , & V_6 -> V_76 ) ;
else
F_113 ( & V_16 -> V_84 , & V_6 -> V_76 ) ;
F_8 ( V_8 , V_6 ) ;
F_84 ( V_16 ) ;
}
...
while ( ! F_93 ( V_105 ) ) {
struct V_13 * V_16 ;
V_16 = F_95 ( V_105 , struct V_13 , V_84 ) ;
F_96 ( & V_16 -> V_84 ) ;
V_16 -> V_33 = V_6 ;
...
{
struct V_13 * V_111 = F_110 ( V_109 , struct V_13 , V_84 ) ;
struct V_13 * V_112 = F_110 ( V_110 , struct V_13 , V_84 ) ;
...
while ( ! F_93 ( & V_139 ) ) {
struct V_13 * V_16 ;
V_16 = F_95 ( & V_139 , struct V_13 , V_84 ) ;
V_16 -> V_33 = V_6 ;
F_144 ( & V_16 -> V_84 , & V_6 -> V_76 ) ;
}
F_8 ( V_8 , V_6 ) ;
F_91 ( & V_6 -> V_82 ) ;
F_5 ( V_6 ) ;
...
F_96 ( & V_142 -> V_144 ) ;
F_149 ( V_142 , V_142 -> V_145 ) ;
}
F_142 ( V_8 -> V_20 ) ;
if ( V_8 -> V_18 )
F_150 ( V_8 -> V_18 ) ;
}
static T_3 F_151 ( unsigned int V_146 )
{
T_3 V_21 = V_147 ;
while ( V_146 -- )
V_21 *= 2 ;
...
if ( ! V_8 -> V_20 )
return - V_155 ;
V_153 = F_154 ( sizeof( struct V_13 ) + V_8 -> V_43 ,
F_155 () ) ;
...
int V_157 ;
void * V_158 ;
while ( V_154 < F_151 ( V_156 - 1 ) && V_156 )
V_156 -- ;
do {
V_142 = F_156 ( V_149 , V_135 , V_156 ) ;
if ( V_142 )
break;
if ( ! V_156 -- )
break;
if ( F_151 ( V_156 ) < V_153 )
break;
} while ( 1 );
if ( ! V_142 )
break;
...
V_158 = F_157 ( V_142 ) ;
V_151 = F_151 ( V_156 ) / V_153 ;
V_157 = F_158 ( V_151 , V_8 -> V_66 - V_9 ) ;
V_154 -= V_157 * V_153 ;
...
V_8 -> V_18 = F_160 ( V_8 -> V_66 , V_148 , V_149 ) ;
if ( ! V_8 -> V_18 ) {
V_160:
F_148 ( V_8 ) ;
return - V_155 ;
...
F_143 , V_8 ) ;
F_165 ( & V_8 -> V_166 ) ;
if ( F_152 ( V_8 , V_133 -> V_148 , V_149 ) )
break;
V_8 -> V_81 = F_140 ( V_167 * sizeof( void * ) ,
V_135 , V_149 ) ;
if ( ! V_8 -> V_81 )
break;
V_163 = F_166 ( V_167 , V_168 ) / V_168 ;
V_8 -> V_11 = F_167 ( V_163 * sizeof( unsigned long ) ,
V_135 , V_149 ) ;
if ( ! V_8 -> V_11 )
break;
V_8 -> V_10 = V_163 ;
...
V_8 = V_3 -> V_39 -> V_40 ( V_3 , V_9 ) ;
V_6 -> V_12 = V_8 -> V_169 ;
V_8 -> V_81 [ V_8 -> V_169 ++ ] = V_6 ;
}
}
struct V_2 * F_174 ( struct V_132 * V_133 ,
void * V_162 )
{
struct V_7 * * V_174 ;
struct V_1 * V_6 ;
...
int V_9 ;
if ( ! V_133 -> V_124 ||
! V_133 -> V_170 -> V_85 || ! V_133 -> V_170 -> V_40 ||
...
V_3 = F_177 ( V_135 , V_133 -> V_137 ) ;
if ( ! V_3 )
goto V_180;
V_3 -> V_131 = F_178 ( V_133 ) ;
if ( ! V_3 -> V_131 )
goto V_181;
F_179 ( & V_3 -> V_69 , F_74 , ( unsigned long ) V_3 ) ;
F_180 ( V_3 , 30000 ) ;
V_3 -> V_182 = V_167 ;
...
V_3 -> V_185 = V_186 ;
F_181 ( V_3 , F_126 ) ;
F_182 ( V_3 , V_133 -> V_170 -> V_69 ) ;
if ( V_133 -> V_69 )
F_180 ( V_3 , V_133 -> V_69 ) ;
if ( V_133 -> V_170 -> V_187 )
F_183 ( V_3 , V_133 -> V_170 -> V_187 ) ;
F_184 ( V_3 ) ;
F_169 ( V_3 , V_133 -> V_124 ) ;
V_3 -> V_188 = F_185 ( F_154 ( sizeof( struct V_13 ) + V_133 -> V_43 ,
F_155 () ) , V_135 ) ;
if ( ! V_3 -> V_188 )
goto V_189;
if ( F_161 ( V_3 , V_133 , V_162 ) )
goto V_190;
F_172 ( V_3 ) ;
F_186 ( & V_191 ) ;
...
{
F_27 ( V_3 ) ;
F_192 ( V_3 -> V_131 , V_3 -> V_124 ) ;
F_172 ( V_3 ) ;
F_30 ( V_3 ) ;
}
static int F_193 ( struct V_194 * V_195 ,
