...
static void T_3
F_45 ( struct V_78 * V_79 , char * * V_80 , struct V_81 * V_82 )
{
F_35 () ;
F_44 () ;
if ( F_26 () )
...
static void F_46 ( struct V_83 * V_84 , T_2 V_25 , T_2 V_85 )
{
if ( V_84 -> V_86 == V_87 ) {
if ( V_25 )
F_13 ( V_88 |
...
static void F_47 ( struct V_83 * V_84 , T_2 V_91 )
{
if ( V_84 -> V_86 == V_87 ) {
T_2 V_20 = 0 , V_92 = 0 ;
if ( V_91 & V_93 )
...
static T_2 F_48 ( struct V_83 * V_84 )
{
T_2 V_95 = 0 ;
T_2 V_96 = V_97 ;
V_96 = V_97 ;
...
static enum V_119 F_59 ( struct V_117 * V_118 )
{
struct V_121 * V_122 = F_58 ( V_118 ,
struct V_121 , V_118 ) ;
return ( V_5 & V_122 -> V_1 ) ? V_123 : V_124 ;
}
...
if ( ! F_19 () )
return - V_125 ;
for ( V_11 = 0 ; V_11 < F_29 ( V_126 ) ; V_11 ++ ) {
struct V_121 * V_122 ;
V_122 = F_61 ( sizeof( * V_122 ) , V_127 ) ;
if ( ! V_122 )
break;
V_122 -> V_118 . V_128 = V_126 [ V_11 ] . V_128 ;
V_122 -> V_118 . V_129 = F_57 ;
V_122 -> V_118 . V_130 = F_59 ;
V_122 -> V_118 . V_131 = V_126 [ V_11 ] . V_132 ;
if ( ! V_11 )
V_122 -> V_1 = V_133 ;
else
V_122 -> V_1 = V_134 ;
if ( F_62 ( NULL , & V_122 -> V_118 ) < 0 ) {
F_63 ( V_122 ) ;
break;
}
}
