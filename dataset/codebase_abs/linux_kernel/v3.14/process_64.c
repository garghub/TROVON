...
T_5 long F_69 ( unsigned long V_97 ,
unsigned long V_98 ,
struct V_4 * V_5 ,
unsigned long V_99 )
{
...
V_60 = F_71 ( V_97 , V_98 , V_99 ,
V_100 , V_101 ) ;
if ( ( unsigned long ) V_60 >= - V_106 )
V_5 -> V_10 [ V_103 ] = V_102 ;
return V_60 ;
}
int F_72 ( unsigned long V_97 , unsigned long V_67 ,
...
int F_76 ( struct V_4 * V_5 , T_6 * V_131 )
{
...
unsigned long F_77 ( struct V_63 * V_44 )
{
