...
static inline unsigned long F_27 ( struct V_3 * V_4 ,
...
static inline unsigned long F_35 ( struct V_3 * V_4 ,
...
if ( F_38 ( V_24 ) )
continue;
V_16 += F_27 ( V_4 , V_24 , V_6 , V_25 , V_2 ,
V_8 , V_9 ) ;
...
if ( F_45 ( V_32 ) )
continue;
V_16 += F_35 ( V_4 , V_32 , V_6 , V_25 , V_2 ,
V_8 , V_9 ) ;
...
unsigned long F_48 ( struct V_3 * V_4 , unsigned long V_33 ,
...
F_49 ( V_11 , V_33 , V_7 ) ;
if ( F_50 ( V_4 ) )
V_16 = F_51 ( V_4 , V_33 , V_7 , V_2 ) ;
else
V_16 = F_39 ( V_4 , V_33 , V_7 , V_2 , V_8 , V_9 ) ;
F_52 ( V_11 , V_33 , V_7 ) ;
return V_16 ;
}
int
F_53 ( struct V_3 * V_4 , struct V_3 * * V_34 ,
...
* V_34 = F_55 ( V_11 , * V_34 , V_33 , V_7 , V_35 ,
V_4 -> V_50 , V_4 -> V_51 , V_41 , F_56 ( V_4 ) ) ;
if ( * V_34 ) {
V_4 = * V_34 ;
goto V_52;
}
* V_34 = V_4 ;
if ( V_33 != V_4 -> V_49 ) {
error = F_57 ( V_11 , V_4 , V_33 , 1 ) ;
if ( error )
goto V_53;
}
if ( V_7 != V_4 -> V_54 ) {
error = F_57 ( V_11 , V_4 , V_7 , 0 ) ;
if ( error )
goto V_53;
}
V_52:
...
F_58 ( V_35 ) ) ;
if ( F_59 ( V_4 ) ) {
V_4 -> V_55 = F_58 ( V_35 & ~ V_45 ) ;
V_8 = 1 ;
}
F_48 ( V_4 , V_33 , V_7 , V_4 -> V_55 ,
V_8 , 0 ) ;
F_60 ( V_11 , V_36 , V_4 -> V_51 , - V_38 ) ;
F_60 ( V_11 , V_35 , V_4 -> V_51 , V_38 ) ;
F_61 ( V_4 ) ;
return 0 ;
V_53:
F_62 ( V_40 ) ;
