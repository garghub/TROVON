...
F_16 ( V_42 , V_16 -> V_25 . V_45 , V_16 -> V_46 -> V_47 , V_16 -> V_19 , V_16 -> V_43 ,
V_16 -> V_44 , & V_48 , L_1 ,
V_37 -> V_49 -> V_50 , V_37 -> V_50 , V_51 [ type ] ,
V_40 ) ;
}
unsigned int
F_17 ( struct V_15 * V_16 , const struct V_52 * V_46 )
{
const struct V_30 * V_37 = V_46 -> V_7 ;
...
if ( V_2 -> V_46 == & V_65 )
F_1 ( V_2 , V_4 ) ;
else if ( V_2 -> V_46 != & V_66 ||
! F_3 ( V_2 , V_4 , V_16 ) )
V_2 -> V_46 -> V_67 ( V_2 , V_4 , V_16 ) ;
...
switch ( V_4 [ V_12 ] . V_13 & V_68 ) {
case V_69 :
case V_70 :
case V_71 :
if ( F_5 ( V_16 -> V_19 -> V_72 ) )
F_14 ( V_16 , V_37 , V_40 , V_73 ) ;
...
if ( F_5 ( V_16 -> V_19 -> V_72 ) )
F_14 ( V_16 , V_37 , ++ V_40 , V_78 ) ;
return F_10 ( V_37 ) -> V_79 ;
}
int T_3 F_24 ( void )
{
int V_80 ;
