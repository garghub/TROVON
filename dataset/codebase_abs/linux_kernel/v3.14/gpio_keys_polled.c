...
V_4 -> V_9 = V_9 ;
V_4 -> V_13 = V_40 & V_43 ;
if ( F_13 ( V_32 , L_6 , & V_4 -> V_12 ) ) {
F_18 ( V_16 , L_7 ,
V_4 -> V_9 ) ;
error = - V_44 ;
goto V_42;
}
V_4 -> V_45 = F_12 ( V_32 , L_8 , NULL ) ;
if ( F_13 ( V_32 , L_9 , & V_4 -> type ) )
V_4 -> type = V_11 ;
V_4 -> V_46 = ! ! F_12 ( V_32 , L_10 , NULL ) ;
if ( F_13 ( V_32 , L_11 ,
& V_4 -> V_47 ) )
V_4 -> V_47 = 5 ;
}
...
V_6 -> V_8 = F_28 ( V_9 ) ;
V_6 -> V_10 = - 1 ;
V_6 -> V_25 = F_29 ( V_4 -> V_47 ,
V_21 -> V_38 ) ;
F_30 ( V_2 , type , V_4 -> V_12 ) ;
}
V_18 -> V_50 = V_50 ;
V_18 -> V_16 = V_16 ;
V_18 -> V_21 = V_21 ;
