...
{
struct V_1 * V_9 = F_1 ( V_3 ) ;
F_59 ( V_117 , F_53 ( V_115 , V_9 -> V_116 ) ) ;
F_60 ( & V_9 -> V_38 ) ;
F_36 ( V_9 -> V_49 ) ;
...
int T_7 F_66 ( struct V_136 * V_137 , int V_7 )
{
int V_36 ;
T_8 V_96 ;
V_117 = F_67 ( V_138 , L_20 ) ;
