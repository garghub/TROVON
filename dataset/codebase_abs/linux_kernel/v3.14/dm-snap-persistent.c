...
V_2 -> V_6 -> V_54 = F_24 ( V_2 -> V_6 -> V_7 ) - 1 ;
V_50 = 0 ;
}
V_2 -> V_37 = F_25 () ;
if ( F_26 ( V_2 -> V_37 ) )
...
static int F_69 ( struct V_83 * V_6 ,
unsigned V_106 , char * * V_107 )
{
struct V_1 * V_2 ;
V_2 = F_70 ( sizeof( * V_2 ) , V_108 ) ;
if ( ! V_2 )
return - V_4 ;
V_2 -> V_6 = V_6 ;
V_2 -> V_60 = 1 ;
...
break;
case V_114 :
F_74 ( L_11 , ( unsigned long long ) V_6 -> V_7 ) ;
}
return V_112 ;
}
int F_75 ( void )
