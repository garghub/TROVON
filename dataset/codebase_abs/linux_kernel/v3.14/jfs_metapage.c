...
V_52 = F_77 ( V_18 , 1 ) ;
V_52 -> V_86 = V_41 -> V_49 -> V_87 ;
V_52 -> V_82 . V_88 = V_71 << ( V_41 -> V_22 - 9 ) ;
V_52 -> V_89 = F_67 ;
V_52 -> V_54 = V_10 ;
V_75 = V_12 ;
V_74 = V_43 << V_41 -> V_22 ;
...
static int F_80 ( struct V_94 * V_95 , struct V_10 * V_10 )
{
struct V_41 * V_41 = V_10 -> V_20 -> V_21 ;
struct V_52 * V_52 = NULL ;
int V_65 ;
int V_96 = V_61 >> V_41 -> V_22 ;
T_3 V_73 ;
T_3 V_71 ;
int V_68 ;
unsigned int V_43 ;
...
unsigned long V_107 ;
F_82 ( L_9 ,
V_41 -> V_51 , V_42 , V_101 ) ;
V_104 = V_41 -> V_22 ;
V_103 = V_77 - V_104 ;
V_106 = V_42 >> V_103 ;
V_107 = ( V_42 - ( V_106 << V_103 ) ) << V_104 ;
if ( ( V_107 + V_100 ) > V_61 ) {
F_85 ( L_10 ) ;
F_85 ( L_11 , V_42 , V_100 ) ;
F_86 () ;
return NULL ;
}
if ( V_101 )
V_20 = F_69 ( V_41 -> V_49 ) -> V_108 -> V_109 ;
else {
...
void F_104 ( struct V_41 * V_116 , T_4 V_117 , int V_43 )
{
T_3 V_42 ;
int V_103 = V_77 - V_116 -> V_22 ;
int V_118 = 1 << V_103 ;
struct V_105 * V_20 =
F_69 ( V_116 -> V_49 ) -> V_108 -> V_109 ;
struct V_1 * V_2 ;
struct V_10 * V_10 ;
unsigned int V_12 ;
for ( V_42 = V_117 & ~ ( V_118 - 1 ) ; V_42 < V_117 + V_43 ;
V_42 += V_118 ) {
V_10 = F_105 ( V_20 , V_42 >> V_103 ) ;
if ( ! V_10 )
continue;
for ( V_12 = 0 ; V_12 < V_61 ; V_12 += V_62 ) {
V_2 = F_17 ( V_10 , V_12 ) ;
...
static int F_106 ( struct V_119 * V_120 , void * V_121 )
{
F_107 ( V_120 ,
L_22
L_23
...
static int F_108 ( struct V_41 * V_41 , struct V_94 * V_94 )
{
return F_109 ( V_94 , F_106 , NULL ) ;
}
