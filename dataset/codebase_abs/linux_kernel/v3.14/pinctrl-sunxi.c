...
{
struct V_116 * V_76 = F_71 ( V_114 ) ;
struct V_2 * V_3 = F_72 ( V_114 ) ;
const unsigned long V_78 = F_27 ( V_3 -> V_65 + V_117 ) ;
F_30 ( V_78 , V_3 -> V_65 + V_117 ) ;
if ( V_78 ) {
int V_118 ;
F_73 ( V_76 , V_17 ) ;
F_74 (irqoffset, &reg, SUNXI_IRQ_NUMBER) {
int V_119 = F_58 ( V_3 -> V_92 , V_118 ) ;
F_75 ( V_119 ) ;
}
F_76 ( V_76 , V_17 ) ;
}
...
static int F_78 ( struct V_121 * V_122 )
{
struct V_2 * V_3 = F_79 ( V_122 ) ;
int V_5 ;
V_3 -> V_6 = V_3 -> V_17 -> V_18 ;
V_3 -> V_8 = F_80 ( & V_122 -> V_39 ,
...
{
struct V_27 * V_28 = V_122 -> V_39 . V_125 ;
const struct V_126 * V_127 ;
struct V_128 * V_21 ;
struct V_2 * V_3 ;
int V_5 , V_36 , V_129 ;
struct V_130 * V_130 ;
V_3 = F_80 ( & V_122 -> V_39 , sizeof( * V_3 ) , V_41 ) ;
if ( ! V_3 )
return - V_42 ;
F_83 ( V_122 , V_3 ) ;
F_84 ( & V_3 -> V_64 ) ;
V_3 -> V_65 = F_85 ( V_28 , 0 ) ;
if ( ! V_3 -> V_65 )
return - V_42 ;
V_127 = F_86 ( V_131 , & V_122 -> V_39 ) ;
if ( ! V_127 )
return - V_132 ;
V_3 -> V_17 = (struct V_133 * ) V_127 -> V_46 ;
V_36 = F_78 ( V_122 ) ;
if ( V_36 ) {
F_11 ( & V_122 -> V_39 , L_13 , V_36 ) ;
return V_36 ;
}
V_21 = F_80 ( & V_122 -> V_39 ,
...
V_134 . V_9 = F_87 ( & V_122 -> V_39 ) ;
V_134 . V_135 = V_136 ;
V_134 . V_21 = V_21 ;
V_134 . V_18 = V_3 -> V_17 -> V_18 ;
V_3 -> V_39 = & V_122 -> V_39 ;
V_3 -> V_113 = F_88 ( & V_134 ,
& V_122 -> V_39 , V_3 ) ;
if ( ! V_3 -> V_113 ) {
F_11 ( & V_122 -> V_39 , L_14 ) ;
return - V_40 ;
}
V_3 -> V_76 = F_80 ( & V_122 -> V_39 , sizeof( * V_3 -> V_76 ) , V_41 ) ;
if ( ! V_3 -> V_76 ) {
V_36 = - V_42 ;
goto V_137;
}
V_129 = V_3 -> V_17 -> V_21 [ V_3 -> V_17 -> V_18 - 1 ] . V_20 . V_23 ;
V_3 -> V_76 = & V_138 ;
V_3 -> V_76 -> V_87 = F_89 ( V_129 , V_86 ) ;
V_3 -> V_76 -> V_91 = F_87 ( & V_122 -> V_39 ) ;
V_3 -> V_76 -> V_39 = & V_122 -> V_39 ;
V_3 -> V_76 -> V_77 = 0 ;
V_36 = F_90 ( V_3 -> V_76 ) ;
if ( V_36 )
goto V_137;
for ( V_5 = 0 ; V_5 < V_3 -> V_17 -> V_18 ; V_5 ++ ) {
const struct V_19 * V_20 = V_3 -> V_17 -> V_21 + V_5 ;
V_36 = F_91 ( V_3 -> V_76 , F_87 ( & V_122 -> V_39 ) ,
V_20 -> V_20 . V_23 ,
V_20 -> V_20 . V_23 , 1 ) ;
if ( V_36 )
goto V_139;
}
V_130 = F_92 ( & V_122 -> V_39 , NULL ) ;
if ( F_93 ( V_130 ) ) {
V_36 = F_94 ( V_130 ) ;
goto V_139;
}
F_95 ( V_130 ) ;
V_3 -> V_114 = F_96 ( V_28 , 0 ) ;
if ( ! V_3 -> V_114 ) {
V_36 = - V_40 ;
goto V_139;
}
V_3 -> V_92 = F_97 ( V_28 , V_140 ,
& V_141 , NULL ) ;
if ( ! V_3 -> V_92 ) {
F_11 ( & V_122 -> V_39 , L_15 ) ;
V_36 = - V_42 ;
goto V_139;
}
for ( V_5 = 0 ; V_5 < V_140 ; V_5 ++ ) {
int V_142 = F_98 ( V_3 -> V_92 , V_5 ) ;
F_99 ( V_142 , & V_143 ,
V_144 ) ;
F_100 ( V_142 , V_3 ) ;
} ;
F_101 ( V_3 -> V_114 , F_70 ) ;
F_102 ( V_3 -> V_114 , V_3 ) ;
F_103 ( & V_122 -> V_39 , L_16 ) ;
return 0 ;
V_139:
if ( F_104 ( V_3 -> V_76 ) )
F_11 ( & V_122 -> V_39 , L_17 ) ;
V_137:
F_105 ( V_3 -> V_113 ) ;
return V_36 ;
}
