...
static void F_65 ( struct V_89 * V_115 )
{
struct V_100 * V_101 ;
while ( ( V_101 = F_66 ( V_115 ) ) != NULL ) {
...
{
struct V_120 * V_121 ;
char * V_122 , * V_123 , * V_124 ;
int V_36 = - V_26 ;
V_121 = F_17 ( sizeof( struct V_120 ) , V_25 ) ;
if ( ! V_121 )
return V_36 ;
F_8 ( V_121 ) ;
V_122 = F_73 ( V_121 -> V_125 , 16 , V_25 ) ;
if ( ! V_122 )
goto V_126;
V_123 = F_73 ( V_121 -> V_127 , 16 , V_25 ) ;
if ( ! V_123 )
goto V_128;
V_124 = F_73 ( V_121 -> V_129 , 16 , V_25 ) ;
if ( ! V_124 )
goto V_130;
F_28 ( L_10 ,
V_122 , V_123 , V_124 ) ;
...
if ( ! F_7 () )
return - V_37 ;
F_33 ( 0x8843407F , V_131 ) ;
F_33 ( 9 , V_132 ) ;
return 0 ;
}
static void F_75 ( void )
{
V_20 . V_21 -> V_133 = & V_134 ;
V_20 . V_21 -> V_135 = 1 ;
strcpy ( V_20 . V_21 -> V_136 , V_137 ) ;
V_20 . V_21 -> V_138 = V_139 | V_140 | V_141 |
V_142 ;
}
static void F_76 ( void )
{
V_20 . V_84 -> V_143 = V_144 ;
V_20 . V_84 -> V_145 = 1 ;
V_20 . V_84 -> V_146 = 1 ;
strcpy ( V_20 . V_84 -> V_147 , V_137 ) ;
}
static int F_77 ( void )
{
F_78 ( V_20 . V_148 , V_108 ) ;
F_79 ( V_20 . V_148 , 1 ) ;
F_80 ( V_20 . V_148 , 0x40000 ) ;
V_20 . V_84 -> V_149 = V_20 . V_148 ;
return F_74 () ;
}
...
V_20 . V_84 -> V_156 = & V_157 ;
V_36 = F_51 () ;
if ( V_36 )
goto V_158;
V_20 . V_148 = F_86 ( F_65 , & V_103 ) ;
if ( ! V_20 . V_148 )
goto V_159;
V_36 = F_77 () ;
if ( V_36 )
...
static int F_91 ( struct V_150 * V_151 )
{
F_92 ( & V_93 ) ;
F_88 ( V_20 . V_148 ) ;
F_53 ( V_90 , & V_20 ) ;
