...
void F_46 ( struct V_12 * V_12 , int V_13 , T_2 V_14 , int V_78 )
{
T_5 V_79 ;
if ( V_78 ) {
...
static inline struct V_55 * F_47 ( struct V_80 * V_81 )
{
return F_19 ( V_81 , struct V_55 , V_81 ) ;
}
static inline struct V_55 * F_48 ( struct V_80 * V_81 )
{
return F_19 ( V_81 , struct V_55 , V_82 ) ;
}
static inline int F_49 ( T_6 V_83 )
{
return ( ( V_83 >= V_84 ) &&
( V_83 < V_84 + V_85 ) ) ;
}
static int F_50 ( struct V_80 * V_86 ,
T_6 V_83 , int V_87 , const void * V_65 )
{
struct V_55 * V_49 = F_47 ( V_86 ) ;
...
break;
case V_98 :
F_45 ( V_12 , V_83 , V_89 -> V_97 | ( V_14 << 8 ) ) ;
V_89 -> V_93 = V_96 ;
break;
}
}
...
static int F_53 ( struct V_80 * V_86 ,
...
static int F_54 ( struct V_80 * V_86 ,
T_6 V_83 , int V_87 , const void * V_65 )
{
struct V_55 * V_49 = F_48 ( V_86 ) ;
struct V_26 * V_18 = & V_49 -> V_18 ;
struct V_12 * V_12 = V_49 -> V_12 ;
T_2 V_14 = * ( T_2 * ) V_65 ;
if ( V_83 != V_100 )
...
static int F_55 ( struct V_80 * V_86 ,
T_6 V_83 , int V_87 , void * V_65 )
{
struct V_55 * V_49 = F_48 ( V_86 ) ;
struct V_26 * V_18 = & V_49 -> V_18 ;
