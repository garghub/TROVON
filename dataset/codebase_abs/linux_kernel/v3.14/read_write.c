...
static T_2 F_65 ( struct V_1 * V_1 ,
const struct V_98 T_3 * V_94 ,
unsigned long V_95 , T_1 * V_40 )
{
V_41 V_58 = - V_64 ;
...
static V_41 F_66 ( int V_99 , int V_100 , T_1 * V_38 ,
T_2 V_39 , T_1 V_101 )
{
struct V_32 V_102 , V_27 ;
...
V_40 = * V_38 ;
if ( ! ( V_102 . V_1 -> V_2 & V_108 ) )
goto V_107;
}
V_25 = F_22 ( V_44 , V_102 . V_1 , & V_40 , V_39 ) ;
if ( V_25 < 0 )
goto V_107;
V_39 = V_25 ;
V_25 = - V_64 ;
...
goto V_109;
V_25 = - V_6 ;
V_103 = F_12 ( V_102 . V_1 ) ;
V_104 = F_12 ( V_27 . V_1 ) ;
V_105 = V_27 . V_1 -> V_7 ;
V_25 = F_22 ( V_76 , V_27 . V_1 , & V_105 , V_39 ) ;
if ( V_25 < 0 )
goto V_109;
V_39 = V_25 ;
if ( ! V_101 )
V_101 = F_68 ( V_103 -> V_20 -> V_21 , V_104 -> V_20 -> V_21 ) ;
if ( F_23 ( V_40 + V_39 > V_101 ) ) {
V_25 = - V_42 ;
if ( V_40 >= V_101 )
goto V_109;
V_39 = V_101 - V_40 ;
...
#endif
F_44 ( V_27 . V_1 ) ;
V_25 = F_69 ( V_102 . V_1 , & V_40 , V_27 . V_1 , & V_105 , V_39 , V_106 ) ;
F_45 ( V_27 . V_1 ) ;
if ( V_25 > 0 ) {
F_33 ( V_68 , V_25 ) ;
F_41 ( V_68 , V_25 ) ;
