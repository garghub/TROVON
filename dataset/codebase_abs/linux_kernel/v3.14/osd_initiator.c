...
V_56 V_249 , const void * V_250 , const V_56 * V_174 )
{
struct V_65 * V_66 = V_65 ( & V_8 -> V_67 ) ;
bool V_229 , V_230 ;
...
V_31 = F_129 ( V_8 , V_229 , V_230 ) ;
if ( V_31 ) {
F_25 ( L_40 ) ;
return V_31 ;
}
V_8 -> V_35 . V_195 = V_258 ;
V_8 -> V_114 . V_195 = V_259 ;
if ( ! V_8 -> V_187 )
V_8 -> V_187 = V_188 ;
...
if ( V_31 )
return V_31 ;
F_131 ( & V_8 -> V_67 , V_174 ) ;
V_8 -> V_99 -> V_260 = V_8 -> V_67 . V_97 ;
V_8 -> V_99 -> V_261 = F_26 ( V_8 ) ;
return 0 ;
}
static bool F_132 ( int V_262 )
{
return ( V_262 == V_263 ) ||
( V_262 == V_264 ) ||
( V_262 == V_265 ) ||
...
V_269 -> V_310 =
F_138 ( V_307 -> V_311 ) ;
V_269 -> V_125 . V_133 = F_139 ( V_307 -> V_312 ) ;
V_269 -> V_125 . V_135 = F_139 ( V_307 -> V_313 ) ;
F_136 (
L_52 ,
F_18 ( V_269 -> V_125 . V_133 ) , F_18 ( V_269 -> V_125 . V_135 ) ) ;
F_136 (
L_53
L_54 ,
V_269 -> V_308 ,
...
struct V_320
* V_321 = V_277 ;
unsigned V_38 = F_140 ( V_290 , V_111 ) ;
...
const struct V_124 * V_125 , bool V_350 , const bool V_225 )
{
...
type = V_125 -> V_133 ? V_355 :
V_356 ;
V_292 = V_357 ;
}
memset ( V_250 , 0 , sizeof( * V_250 ) ) ;
V_250 -> V_126 . V_176 = V_358 ;
V_250 -> V_126 . V_359 = 0 ;
V_250 -> V_126 . V_360 = V_361 ;
V_250 -> V_126 . V_362 = type ;
F_142 ( & V_250 -> V_126 , V_363 ) ;
V_250 -> V_126 . V_364 = V_292 ;
V_250 -> V_10 . V_365 . V_366 = 0 ;
V_250 -> V_10 . V_365 . V_367 = F_71 ( V_125 -> V_133 ) ;
V_250 -> V_10 . V_365 . V_368 = F_71 ( V_125 -> V_135 ) ;
}
void F_130 ( struct V_79 * V_67 , const void * V_11 )
{
bool V_369 = true ;
memcpy ( & V_67 -> V_68 . V_11 , V_11 , V_369 ? V_370 : V_2 ) ;
}
bool F_125 ( struct V_78 * V_226 V_94 )
{
return false ;
}
void F_131 ( struct V_79 * V_80 V_94 , const V_56 * V_174 V_94 )
{
}
