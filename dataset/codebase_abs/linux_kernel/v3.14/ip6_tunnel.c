...
static int F_150 ( struct V_247 * V_248 [] , struct V_247 * V_76 [] )
{
T_5 V_104 ;
if ( ! V_76 )
return 0 ;
V_104 = F_151 ( V_76 [ V_249 ] ) ;
if ( V_104 != V_135 &&
V_104 != V_121 &&
V_104 != 0 )
return - V_226 ;
...
static void F_152 ( struct V_247 * V_76 [] ,
struct V_46 * V_40 )
{
...
return;
if ( V_76 [ V_250 ] )
V_40 -> V_147 = F_153 ( V_76 [ V_250 ] ) ;
if ( V_76 [ V_251 ] )
F_154 ( & V_40 -> V_41 , V_76 [ V_251 ] ,
sizeof( struct V_1 ) ) ;
if ( V_76 [ V_252 ] )
F_154 ( & V_40 -> V_42 , V_76 [ V_252 ] ,
sizeof( struct V_1 ) ) ;
if ( V_76 [ V_253 ] )
V_40 -> V_186 = F_151 ( V_76 [ V_253 ] ) ;
if ( V_76 [ V_254 ] )
V_40 -> V_111 = F_151 ( V_76 [ V_254 ] ) ;
if ( V_76 [ V_255 ] )
V_40 -> V_206 = F_155 ( V_76 [ V_255 ] ) ;
if ( V_76 [ V_256 ] )
V_40 -> V_43 = F_153 ( V_76 [ V_256 ] ) ;
if ( V_76 [ V_249 ] )
V_40 -> V_104 = F_151 ( V_76 [ V_249 ] ) ;
}
...
static int F_162 ( struct V_65 * V_66 , const struct V_7 * V_8 )
{
struct V_22 * V_261 = F_28 ( V_8 ) ;
struct V_46 * V_262 = & V_261 -> V_40 ;
if ( F_163 ( V_66 , V_250 , V_262 -> V_147 ) ||
F_164 ( V_66 , V_251 , sizeof( struct V_1 ) ,
& V_262 -> V_41 ) ||
F_164 ( V_66 , V_252 , sizeof( struct V_1 ) ,
& V_262 -> V_42 ) ||
F_165 ( V_66 , V_253 , V_262 -> V_186 ) ||
F_165 ( V_66 , V_254 , V_262 -> V_111 ) ||
F_166 ( V_66 , V_255 , V_262 -> V_206 ) ||
F_163 ( V_66 , V_256 , V_262 -> V_43 ) ||
F_165 ( V_66 , V_249 , V_262 -> V_104 ) )
goto V_263;
return 0 ;
V_263:
return - V_179 ;
...
V_54 = F_149 ( V_38 -> V_64 ) ;
if ( V_54 < 0 )
goto V_271;
V_54 = F_172 ( V_38 -> V_64 ) ;
if ( V_54 < 0 )
goto V_271;
V_23 = F_28 ( V_38 -> V_64 ) ;
