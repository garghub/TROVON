...
struct V_8 * F_142 ( struct V_240 * V_157 )
{
struct V_10 * V_11 ;
struct V_8 * V_9 ;
V_9 = F_143 ( sizeof( struct V_10 ) , & V_241 ) ;
if ( ! V_9 ) {
...
F_146 ( & V_11 -> V_46 ) ;
V_11 -> V_88 = 0 ;
F_147 ( & V_11 -> V_16 , V_9 , V_157 ) ;
F_148 ( V_11 ) ;
F_149 ( V_11 ) ;
F_150 ( & V_11 -> V_211 , F_130 ) ;
F_151 ( V_9 , & V_157 -> V_242 ) ;
return V_9 ;
}
static void F_152 ( struct V_208 * V_209 )
{
struct V_10 * V_11 =
...
F_153 ( V_53 * 1024 / 1000 ) * 3 ;
F_17 ( & V_11 -> V_21 ) ;
if ( V_53 > 0 && F_154 ( V_257 ) ) {
F_58 ( F_6 ( V_11 ) , L_19
L_20
L_21 ,
V_53 , V_54 ) ;
...
V_258:
F_155 ( V_24 , & V_11 -> V_47 . V_256 ,
V_259 ) ;
}
static void F_149 ( struct V_10 * V_11 )
{
F_156 ( & V_11 -> V_47 . V_256 , F_152 ) ;
}
...
{
F_58 ( F_6 ( V_11 ) , L_4 ) ;
F_157 ( & V_11 -> V_47 . V_256 ) ;
F_87 ( V_11 ) ;
}
static void F_158 ( struct V_208 * V_209 )
{
struct V_10 * V_11 =
...
V_263:
F_155 ( V_24 , & V_11 -> V_260 . V_261 ,
V_266 ) ;
}
static void F_148 ( struct V_10 * V_11 )
{
F_156 ( & V_11 -> V_260 . V_261 , F_158 ) ;
}
...
{
F_58 ( F_6 ( V_11 ) , L_4 ) ;
F_157 ( & V_11 -> V_260 . V_261 ) ;
F_159 ( & V_11 -> V_16 , V_267 ) ;
}
