...
if ( ! F_38 ( V_59 ) -> V_69 )
continue;
V_67 = (struct V_15 * ) ( V_59 -> V_13 + V_62 ) ;
V_68 = * ( T_5 * ) V_55 ^ * ( T_5 * ) V_67 ;
if ( ( V_68 & F_40 ( 0xF00FFFFF ) ) ||
memcmp ( & V_55 -> V_14 , & V_67 -> V_14 ,
V_60 - F_41 ( struct V_15 , V_14 ) ) ) {
F_38 ( V_59 ) -> V_69 = 0 ;
continue;
}
F_38 ( V_59 ) -> V_63 |= ! ! ( V_68 & F_40 ( 0x0FF00000 ) ) ;
F_38 ( V_59 ) -> V_63 |= V_63 ;
}
F_38 ( V_2 ) -> V_63 |= V_63 ;
V_64 = V_2 -> V_64 ;
F_42 ( V_2 , V_55 , F_39 ( V_2 ) ) ;
V_58 = V_5 -> V_21 . V_65 ( V_52 , V_2 ) ;
V_2 -> V_64 = V_64 ;
V_66:
F_43 () ;
V_19:
...
if ( F_45 ( ! V_5 || ! V_5 -> V_21 . V_71 ) )
goto V_66;
V_17 = V_5 -> V_21 . V_71 ( V_2 , V_32 ) ;
V_66:
F_43 () ;
return V_17 ;
}
