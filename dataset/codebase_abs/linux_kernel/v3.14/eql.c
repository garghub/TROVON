...
struct V_21 * V_58 ;
T_6 V_69 ;
if ( F_43 ( & V_69 , V_68 , sizeof ( T_6 ) ) )
return - V_70 ;
V_58 = F_44 ( & V_71 , V_69 . V_72 ) ;
if ( ! V_58 )
return - V_73 ;
if ( ( V_24 -> V_13 & V_14 ) == V_14 ) {
if ( ! F_45 ( V_58 ) && ! F_46 ( V_58 ) ) {
T_2 * V_39 = F_47 ( sizeof( * V_39 ) , V_74 ) ;
T_1 * V_2 = F_9 ( V_24 ) ;
int V_75 ;
if ( ! V_39 )
return - V_76 ;
...
static int F_29 ( struct V_21 * V_12 , T_8 T_7 * V_79 )
{
T_1 * V_2 = F_9 ( V_12 ) ;
T_2 * V_10 ;
struct V_21 * V_58 ;
T_8 V_80 ;
int V_75 ;
if ( F_43 ( & V_80 , V_79 , sizeof ( T_8 ) ) )
return - V_70 ;
V_58 = F_44 ( & V_71 , V_80 . V_72 ) ;
if ( ! V_58 )
return - V_73 ;
V_75 = - V_78 ;
F_21 ( & V_2 -> V_7 . V_8 ) ;
...
F_22 ( & V_2 -> V_7 . V_8 ) ;
if ( ! V_75 && F_48 ( V_79 , & V_80 , sizeof ( T_8 ) ) )
V_75 = - V_70 ;
return V_75 ;
}
static int F_30 ( struct V_21 * V_12 , T_8 T_7 * V_79 )
{
T_2 * V_10 ;
T_1 * V_2 ;
struct V_21 * V_58 ;
