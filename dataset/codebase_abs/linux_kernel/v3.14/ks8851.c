...
V_2 -> V_17 = V_224 ;
V_2 -> V_82 = 6144 ;
V_2 -> V_229 = F_108 ( & V_224 -> V_37 , L_24 ) ;
if ( F_109 ( V_2 -> V_229 ) ) {
V_12 = F_110 ( V_2 -> V_229 ) ;
if ( V_12 == - V_230 )
goto V_231;
} else {
V_12 = F_111 ( V_2 -> V_229 ) ;
if ( V_12 ) {
F_40 ( & V_224 -> V_37 , L_25 ,
V_12 ) ;
goto V_232;
}
}
F_112 ( & V_2 -> V_39 ) ;
F_113 ( & V_2 -> V_145 ) ;
F_114 ( & V_2 -> V_113 , F_47 ) ;
F_114 ( & V_2 -> V_142 , F_63 ) ;
F_115 ( & V_2 -> V_10 ) ;
F_116 ( & V_2 -> V_7 , & V_2 -> V_10 ) ;
F_115 ( & V_2 -> V_27 ) ;
F_116 ( & V_2 -> V_28 [ 0 ] , & V_2 -> V_27 ) ;
F_116 ( & V_2 -> V_28 [ 1 ] , & V_2 -> V_27 ) ;
V_2 -> V_197 . V_103 = V_2 ;
V_2 -> V_197 . V_233 = V_234 ;
V_2 -> V_197 . V_235 = F_85 ;
V_2 -> V_197 . V_236 = F_86 ;
V_2 -> V_98 . V_37 = V_225 ;
V_2 -> V_98 . V_237 = 1 ,
V_2 -> V_98 . V_238 = 1 ;
V_2 -> V_98 . V_239 = 0xf ;
V_2 -> V_98 . V_240 = F_97 ;
V_2 -> V_98 . V_241 = F_98 ;
F_117 ( & V_224 -> V_37 , L_26 , V_174 ) ;
V_2 -> V_174 = F_118 ( V_174 , ( V_242 |
V_243 |
V_244 ) ) ;
F_119 ( & V_2 -> V_115 ) ;
F_120 ( V_225 , & V_245 ) ;
F_121 ( V_225 , & V_224 -> V_37 ) ;
F_122 ( V_224 , V_2 ) ;
V_225 -> V_246 = V_247 ;
V_225 -> V_248 = & V_249 ;
V_225 -> V_70 = V_224 -> V_70 ;
F_15 ( V_2 , V_250 ) ;
V_226 = F_10 ( V_2 , V_251 ) ;
if ( ( V_226 & ~ V_252 ) != V_253 ) {
F_40 ( & V_224 -> V_37 , L_27 ) ;
V_12 = - V_254 ;
goto V_255;
}
V_2 -> V_44 = F_10 ( V_2 , V_256 ) ;
if ( V_2 -> V_44 & V_45 )
V_2 -> V_257 = 128 ;
else
V_2 -> V_257 = 0 ;
F_99 ( V_2 ) ;
F_26 ( V_2 ) ;
V_12 = F_123 ( V_224 -> V_70 , NULL , F_39 ,
V_258 | V_259 ,
V_225 -> V_260 , V_2 ) ;
if ( V_12 < 0 ) {
...
V_12 = F_124 ( V_225 ) ;
if ( V_12 ) {
F_40 ( & V_224 -> V_37 , L_29 ) ;
goto V_262;
}
F_125 ( V_225 , L_30 ,
F_126 ( V_226 ) , V_225 -> V_42 , V_225 -> V_70 ,
V_2 -> V_44 & V_45 ? L_31 : L_32 ) ;
return 0 ;
V_262:
F_127 ( V_225 -> V_70 , V_2 ) ;
V_261:
V_255:
if ( ! F_109 ( V_2 -> V_229 ) )
F_128 ( V_2 -> V_229 ) ;
...
static int F_131 ( struct V_223 * V_224 )
{
struct V_1 * V_263 = F_132 ( V_224 ) ;
if ( F_133 ( V_263 ) )
F_117 ( & V_224 -> V_37 , L_33 ) ;
F_134 ( V_263 -> V_18 ) ;
F_127 ( V_224 -> V_70 , V_263 ) ;
if ( ! F_109 ( V_263 -> V_229 ) ) {
F_128 ( V_263 -> V_229 ) ;
F_129 ( V_263 -> V_229 ) ;
}
F_130 ( V_263 -> V_18 ) ;
