...
unsigned long F_260 ( unsigned long V_220 )
{
struct V_256 V_256 ;
struct V_1 V_2 = {
. V_122 = V_281 ,
...
struct V_247 * V_247 = F_261 ( F_262 () , V_2 . V_122 ) ;
...
static int F_264 ( struct V_311 * V_312 , unsigned long V_313 ,
void * V_314 )
{
int V_35 ;
...
if ( V_264 -> F_251 )
return 0 ;
V_264 -> F_251 = F_268 ( F_251 , V_264 , L_3 , V_35 ) ;
if ( F_269 ( V_264 -> F_251 ) ) {
F_56 ( V_321 == V_322 ) ;
F_270 ( L_4 , V_35 ) ;
V_43 = F_271 ( V_264 -> F_251 ) ;
V_264 -> F_251 = NULL ;
}
return V_43 ;
}
...
static inline unsigned long F_277 ( struct V_4 * V_4 )
{
...
static long F_278 ( struct V_4 * V_4 )
{
long V_326 ;
long V_31 = 0 ;
if ( V_327 & V_328 )
...
static int F_279 ( struct V_4 * V_4 , T_8 V_122 , unsigned int V_160 )
{
...
int F_280 ( struct V_4 * V_4 , T_8 V_122 , unsigned int V_160 )
{
int V_185 ;
int V_43 ;
if ( F_278 ( V_4 ) <= V_4 -> V_335 &&
...
return V_340 ;
V_185 = F_202 ( V_4 ) ;
if ( F_281 ( V_185 , V_341 ) && V_185 != F_262 () )
return V_340 ;
if ( F_282 ( V_4 , V_342 ) )
return V_340 ;
V_43 = F_279 ( V_4 , V_122 , V_160 ) ;
F_234 ( V_4 , V_342 ) ;
if ( ! V_43 )
F_83 ( V_343 ) ;
return V_43 ;
...
{
return ! F_283 ( F_42 ( V_49 ) ) && ! F_284 ( V_49 ) ;
}
void F_285 ( struct V_49 * * V_344 , int V_159 )
{
struct V_11 * V_11 ;
struct V_4 * V_4 = NULL ;
int V_345 = 0 ;
...
int F_289 ( struct V_352 * V_353 , int V_354 ,
void T_11 * V_355 ,
T_1 * V_356 , T_12 * V_357 )
{
F_287 () ;
F_290 ( V_353 , V_354 , V_355 , V_356 , V_357 ) ;
V_358 = 0 ;
return 0 ;
}
static T_13 F_291 ( struct V_359 * V_360 ,
struct V_361 * V_362 ,
char * V_363 )
{
F_287 () ;
...
static T_13 F_292 ( struct V_359 * V_360 ,
struct V_361 * V_362 ,
...
int F_293 ( struct V_365 * V_365 )
{
return F_294 ( & V_365 -> V_360 , & V_366 ) ;
}
void F_295 ( struct V_365 * V_365 )
{
F_296 ( & V_365 -> V_360 , & V_366 ) ;
}
