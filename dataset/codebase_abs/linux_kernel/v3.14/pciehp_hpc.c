...
static bool F_30 ( struct V_43 * V_44 , int V_45 )
{
T_2 V_46 ;
int V_47 = 0 ;
...
if ( V_47 > 1 && V_51 )
F_32 ( V_52 L_12 ,
F_33 ( V_44 ) , V_44 -> V_53 , F_34 ( V_45 ) ,
F_35 ( V_45 ) , V_47 , V_49 , V_46 ) ;
return V_50 ;
}
...
F_38 ( V_3 -> V_4 -> V_5 -> V_55 , V_37 ) ;
if ( ! V_50 )
return - 1 ;
return 0 ;
}
static int F_39 ( struct V_2 * V_3 , bool V_58 )
{
struct V_1 * V_19 = F_1 ( V_3 ) ;
T_1 V_59 ;
F_14 ( V_19 , V_60 , & V_59 ) ;
...
V_59 |= V_61 ;
F_15 ( V_19 , V_60 , V_59 ) ;
F_20 ( V_3 , L_14 , V_41 , V_59 ) ;
return 0 ;
}
static int F_40 ( struct V_2 * V_3 )
{
return F_39 ( V_3 , true ) ;
}
static int F_41 ( struct V_2 * V_3 )
{
return F_39 ( V_3 , false ) ;
}
...
void F_45 ( struct V_62 * V_62 , T_3 * V_63 )
{
...
void F_46 ( struct V_62 * V_62 , T_3 * V_63 )
{
struct V_1 * V_19 = F_1 ( V_62 -> V_3 ) ;
T_1 V_20 ;
F_14 ( V_19 , V_22 , & V_20 ) ;
...
void F_48 ( struct V_62 * V_62 , T_3 V_74 )
{
struct V_2 * V_3 = V_62 -> V_3 ;
T_1 V_75 ;
if ( ! F_49 ( V_3 ) )
...
F_21 ( V_3 , V_76 , V_77 ) ;
F_20 ( V_3 , L_17 , V_41 ,
F_43 ( V_3 -> V_4 -> V_5 ) + V_34 ,
V_76 ) ;
}
void F_52 ( struct V_62 * V_62 )
{
struct V_2 * V_3 = V_62 -> V_3 ;
if ( ! F_51 ( V_3 ) )
return;
...
int F_65 ( struct V_62 * V_62 , int V_94 )
{
struct V_2 * V_3 = V_62 -> V_3 ;
struct V_1 * V_19 = F_1 ( V_3 ) ;
if ( V_94 )
...
{
struct V_62 * V_62 ;
V_62 = F_71 ( sizeof( * V_62 ) , V_96 ) ;
if ( ! V_62 )
return - V_97 ;
V_62 -> V_98 = F_72 ( L_20 , 0 , 0 , F_73 ( V_3 ) ) ;
if ( ! V_62 -> V_98 )
goto abort;
V_62 -> V_3 = V_3 ;
F_74 ( & V_62 -> V_99 ) ;
F_75 ( & V_62 -> V_100 , V_101 ) ;
V_3 -> V_62 = V_62 ;
return 0 ;
abort:
F_76 ( V_62 ) ;
...
F_81 ( V_3 , L_22 ,
F_82 ( V_19 ) , V_19 -> V_15 ) ;
F_81 ( V_3 , L_23 , V_19 -> V_104 ) ;
F_81 ( V_3 , L_24 , V_19 -> V_105 ) ;
F_81 ( V_3 , L_25 ,
V_19 -> V_106 ) ;
F_81 ( V_3 , L_26 ,
V_19 -> V_107 ) ;
F_81 ( V_3 , L_27 ,
F_43 ( V_19 ) ) ;
for ( V_102 = 0 ; V_102 < V_108 ; V_102 ++ ) {
if ( ! F_83 ( V_19 , V_102 ) )
continue;
F_81 ( V_3 , L_28 ,
V_102 , & V_19 -> V_109 [ V_102 ] ) ;
}
F_81 ( V_3 , L_29 , V_3 -> V_110 ) ;
F_81 ( V_3 , L_30 , F_73 ( V_3 ) ) ;
F_81 ( V_3 , L_31 ,
F_62 ( V_3 ) ? L_32 : L_33 ) ;
F_81 ( V_3 , L_34 ,
F_84 ( V_3 ) ? L_32 : L_33 ) ;
...
F_81 ( V_3 , L_40 ,
F_23 ( V_3 ) ? L_33 : L_32 ) ;
F_14 ( V_19 , V_22 , & V_103 ) ;
F_81 ( V_3 , L_41 , V_103 ) ;
F_14 ( V_19 , V_34 , & V_103 ) ;
F_81 ( V_3 , L_42 , V_103 ) ;
}
struct V_2 * F_86 ( struct V_111 * V_112 )
{
struct V_2 * V_3 ;
T_2 V_110 , V_113 ;
struct V_1 * V_19 = V_112 -> V_5 ;
V_3 = F_71 ( sizeof( * V_3 ) , V_96 ) ;
if ( ! V_3 ) {
F_87 ( & V_112 -> V_105 , L_43 , V_41 ) ;
goto abort;
}
V_3 -> V_4 = V_112 ;
F_88 ( V_19 , V_114 , & V_110 ) ;
V_3 -> V_110 = V_110 ;
F_74 ( & V_3 -> V_32 ) ;
F_89 ( & V_3 -> V_27 ) ;
F_80 ( V_3 ) ;
if ( F_23 ( V_3 ) ||
! ( F_84 ( V_3 ) | F_49 ( V_3 ) | F_51 ( V_3 ) | F_85 ( V_3 ) ) )
V_3 -> V_33 = 1 ;
F_88 ( V_19 , V_115 , & V_113 ) ;
if ( V_113 & V_116 ) {
F_20 ( V_3 , L_44 ) ;
V_3 -> V_54 = 1 ;
}
