...
struct V_60 V_61 ;
if ( F_30 ( V_2 , V_44 , sizeof( V_56 ) , & V_56 ) ||
F_31 ( V_2 , V_45 , V_8 -> V_15 ) )
goto V_62;
V_61 . V_63 = F_32 ( V_13 - V_8 -> V_11 . V_63 ) ;
V_61 . V_12 = F_32 ( V_13 - V_8 -> V_11 . V_12 ) ;
V_61 . V_64 = F_32 ( V_8 -> V_11 . V_64 ) ;
if ( F_30 ( V_2 , V_65 , sizeof( V_61 ) , & V_61 ) )
goto V_62;
return V_2 -> V_66 ;
V_62:
F_33 ( V_2 , V_55 ) ;
