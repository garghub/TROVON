...
static int F_49 ( int V_105 , int V_106 , T_5 V_25 , T_5 V_111 )
{
struct V_104 V_112 ;
...
static T_6 F_53 ( struct V_1 * V_2 , T_6 V_122 )
{
T_6 V_123 ;
#define F_54 0x7000
#define F_55 0x8000
...
F_71 ( V_2 -> V_126 , V_2 -> V_128 , V_2 -> V_127 ) ;
F_59 ( & V_2 -> V_140 , V_139 ) ;
V_2 -> V_150 = V_2 -> V_141 ;
F_60 ( & V_2 -> V_140 , V_139 ) ;
}
...
F_59 ( & V_2 -> V_140 , V_139 ) ;
F_50 ( & V_161 ) ;
if ( V_2 -> V_141 == V_169 && V_2 -> V_141 == V_2 -> V_150 ) {
V_120 = F_48 ( & V_161 , & V_113 ) ;
if ( V_120 < V_2 -> V_144 -> V_170 [ V_171 ] ) {
F_60 ( & V_2 -> V_140 , V_139 ) ;
return;
}
}
...
F_79 ( V_2 -> V_30 , V_2 -> V_189 ,
sizeof( V_2 -> V_189 ) ) ;
F_80 ( V_2 -> V_189 , L_65 , sizeof( V_2 -> V_189 ) ) ;
V_126 -> V_190 = V_2 -> V_187 ;
V_126 -> V_191 = V_2 -> V_189 ;
F_81 ( V_2 -> V_30 , & V_126 -> V_192 ) ;
...
static struct V_202 * F_84 ( struct V_1 * V_2 )
{
struct V_202 * V_144 ;
int V_185 , V_61 ;
V_144 = F_85 () ;
...
F_79 ( V_2 -> V_30 , V_2 -> V_205 ,
sizeof( V_2 -> V_205 ) ) ;
F_80 ( V_2 -> V_205 , L_69 , sizeof( V_2 -> V_205 ) ) ;
V_144 -> V_206 = V_2 -> V_205 ;
V_144 -> V_207 [ 0 ] = F_86 ( V_208 ) | F_86 ( V_209 ) | F_86 ( V_210 ) ;
V_144 -> V_211 [ F_87 ( V_212 ) ] =
F_86 ( V_148 ) | F_86 ( V_149 ) ;
V_144 -> V_213 [ 0 ] = F_86 ( V_146 ) | F_86 ( V_147 ) |
F_86 ( V_145 ) ;
for ( V_61 = 0 ; V_61 < F_57 ( V_132 ) ; V_61 ++ ) {
T_6 V_141 = V_132 [ V_61 ] . V_123 ;
F_88 ( V_141 , V_144 -> V_211 ) ;
}
F_81 ( V_2 -> V_30 , & V_144 -> V_214 ) ;
...
static struct V_202 * F_92 ( struct V_1 * V_2 )
{
struct V_202 * V_86 ;
int V_185 ;
V_86 = F_85 () ;
...
F_79 ( V_2 -> V_217 , V_2 -> V_218 ,
sizeof( V_2 -> V_218 ) ) ;
F_80 ( V_2 -> V_218 , L_72 , sizeof( V_2 -> V_218 ) ) ;
V_86 -> V_206 = V_2 -> V_218 ;
V_86 -> V_207 [ 0 ] =
F_86 ( V_208 ) | F_86 ( V_219 ) ;
V_86 -> V_211 [ F_87 ( V_91 ) ] =
F_86 ( V_91 ) ;
F_93 ( V_86 , V_87 ,
0x00 , 0xfff , 0 , 0 ) ;
F_93 ( V_86 , V_89 ,
...
V_2 -> V_5 = V_5 ;
V_2 -> V_181 = false ;
V_2 -> V_188 = F_102 ( V_2 -> V_30 -> V_248 . V_249 ) ;
V_2 -> V_64 = F_102 ( V_2 -> V_30 -> V_248 . V_250 ) ;
...
V_2 -> V_151 . V_258 = F_41 ;
}
V_2 -> V_217 = F_100 ( F_101 ( V_159 ) ) ;
V_2 -> V_7 = V_245 ;
V_185 = - V_17 ;
V_222 = V_159 -> V_253 ;
if ( ! F_94 ( V_2 , V_222 ) )
...
int V_185 ;
F_4 ( V_2 -> V_4 , L_91 ) ;
V_185 = F_108 ( & V_159 -> V_4 . V_260 , & V_261 ) ;
if ( V_185 )
F_78 ( V_2 -> V_4 , L_92
L_93 , V_185 ) ;
if ( V_2 -> V_62 == V_63 )
V_185 = F_109 ( V_159 , & V_262 ) ;
else
V_185 = F_109 ( V_159 , & V_263 ) ;
if ( V_185 )
F_33 ( V_2 -> V_4 , L_94
L_95 ) ;
}
...
T_5 V_188 , V_64 ;
V_265 = F_100 ( F_101 ( V_12 ) ) ;
V_222 = V_12 -> V_253 ;
V_226 = V_222 -> V_227 . V_228 ;
V_188 = F_102 ( V_265 -> V_248 . V_249 ) ;
V_64 = F_102 ( V_265 -> V_248 . V_250 ) ;
F_4 ( V_4 , L_96 ,
...
F_114 ( & V_12 -> V_4 . V_260 , & V_261 ) ;
F_114 ( & V_12 -> V_4 . V_260 , & V_270 ) ;
F_112 ( V_12 , NULL ) ;
if ( V_2 -> V_44 . V_46 ) {
F_25 ( V_2 -> V_5 ) ;
F_115 ( & V_2 -> V_44 . V_45 ) ;
...
if ( ! V_2 -> V_51 && ! V_2 -> V_176 )
F_1 ( V_2 ) ;
F_11 ( & V_15 ) ;
F_4 ( V_4 , L_103 ,
V_8 , V_226 ) ;
}
static int F_119 ( struct V_11 * V_159 , T_8 V_274 )
{
struct V_1 * V_2 = F_10 ( V_159 ) ;
int V_226 = V_159 -> V_253 -> V_227 . V_228 ;
if ( V_226 == 0 )
F_25 ( V_2 -> V_6 ) ;
else
F_25 ( V_2 -> V_7 ) ;
