...
static int F_23 ( struct V_11 * V_12 , unsigned long V_13 ,
...
int F_35 ( const char * V_29 , char * V_30 , int * V_31 )
{
struct V_17 * V_18 ;
char * V_32 , * V_33 = NULL ;
int V_34 = V_35 ;
...
char * V_41 , * V_42 ;
memset ( V_32 , 0 , V_34 ) ;
V_43 = F_39 ( int , V_18 -> V_42 - V_13 , V_34 ) ;
V_44 = F_23 ( V_2 , V_13 , V_32 ,
V_43 , 0 ) ;
if ( V_44 != V_43 )
break;
V_13 += V_44 ;
...
char * V_46 ;
int V_47 ;
V_42 = F_40 ( V_41 , '\0' , V_45 ) ;
F_41 ( V_42 >= V_41 &&
V_42 <= V_41 + V_45 ) ;
if ( F_42 ( V_42 - V_41 == V_45 ) ) {
if ( F_42 ( V_45 == V_43 ) ) {
F_43 ( L_1 ) ;
GOTO ( V_48 , V_25 = - V_39 ) ;
}
