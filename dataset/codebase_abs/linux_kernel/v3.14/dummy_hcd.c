...
F_62 ( V_13 ) ;
V_133 = F_67 ( & V_132 -> V_19 , & V_13 -> V_18 ) ;
if ( V_133 < 0 )
goto V_136;
V_133 = F_68 ( & V_13 -> V_18 . V_19 , & V_137 ) ;
if ( V_133 < 0 )
goto V_138;
F_69 ( V_132 , V_13 ) ;
return V_133 ;
...
{
struct V_17 * V_13 = F_72 ( V_132 ) ;
F_73 ( & V_13 -> V_18 . V_19 , & V_137 ) ;
F_70 ( & V_13 -> V_18 ) ;
return 0 ;
}
static void F_74 ( struct V_17 * V_13 , struct V_9 * V_33 ,
int V_57 )
{
F_75 ( & V_13 -> V_30 ) ;
V_13 -> V_38 = V_57 ;
...
static int F_77 ( struct V_131 * V_132 , T_3 V_139 )
{
struct V_17 * V_13 = F_72 ( V_132 ) ;
...
static unsigned int F_79 ( const struct V_59 * V_60 )
{
unsigned int V_141 ;
V_141 = F_80 ( V_60 ) << 1 ;
if ( F_81 ( V_60 ) )
...
static int F_82 ( struct V_9 * V_33 , struct V_142 * V_142 )
{
...
static int F_83 ( struct V_9 * V_33 ,
unsigned int V_144 )
{
int V_127 ;
V_127 = V_33 -> V_145 [ F_84 ( V_144 ) ] ;
if ( F_85 ( V_144 ) )
V_127 >>= 4 ;
else
V_127 &= 0xf ;
...
static void F_86 ( struct V_9 * V_33 ,
...
V_127 |= V_146 ;
V_33 -> V_145 [ F_84 ( V_144 ) ] = V_127 ;
}
static int F_87 ( struct V_9 * V_33 , struct V_142 * V_142 )
{
unsigned int V_127 ;
int V_147 ;
V_147 = F_82 ( V_33 , V_142 ) ;
if ( ! V_142 -> V_148 ) {
if ( V_147 )
return - V_67 ;
return 0 ;
...
V_133 = F_87 ( V_33 , V_142 ) ;
if ( V_133 ) {
F_37 ( V_149 ) ;
goto V_69;
}
V_133 = F_91 ( V_11 , V_142 ) ;
if ( V_133 ) {
F_37 ( V_149 ) ;
goto V_69;
}
...
F_92 ( V_33 -> V_152 ) ;
} else if ( F_93 ( V_33 -> V_152 != V_142 -> V_19 ) )
F_27 ( F_6 ( V_33 ) , L_23 ) ;
F_40 ( & V_149 -> V_153 , & V_33 -> V_153 ) ;
V_142 -> V_154 = V_149 ;
if ( F_94 ( V_142 -> V_144 ) == V_155 )
V_142 -> V_156 = 1 ;
if ( ! F_95 ( & V_33 -> V_157 ) )
...
static int F_96 ( struct V_10 * V_11 , struct V_142 * V_142 , int V_28 )
{
struct V_9 * V_33 ;
unsigned long V_79 ;
int V_133 ;
...
static int F_98 ( struct V_142 * V_142 , struct V_5 * V_8 ,
T_4 V_159 )
{
void * V_160 , * V_161 ;
...
V_79 |= V_173 ;
F_100 ( V_164 , V_142 -> V_174 , V_142 -> V_168 , V_79 ) ;
V_149 -> V_151 = 1 ;
}
V_167 = F_101 ( V_164 ) ;
if ( V_167 == false ) {
...
static int F_104 ( struct V_9 * V_33 , struct V_142 * V_142 ,
...
static int F_106 ( struct V_17 * V_13 , struct V_1 * V_4 )
{
...
static struct V_1 * F_107 ( struct V_17 * V_13 , V_111 V_32 )
{
int V_119 ;
if ( ! F_108 ( ( V_13 -> V_18 . V_22 == V_23 ?
V_13 -> V_24 : V_13 -> V_25 ) ) )
return NULL ;
if ( ( V_32 & ~ V_84 ) == 0 )
return & V_13 -> V_4 [ 0 ] ;
...
static int F_109 ( struct V_9 * V_33 , struct V_142 * V_142 ,
struct V_189 * V_190 ,
int * V_28 )
{
struct V_1 * V_191 ;
...
unsigned V_193 ;
unsigned V_194 ;
V_193 = F_110 ( V_190 -> V_195 ) ;
V_194 = F_110 ( V_190 -> V_196 ) ;
switch ( V_190 -> V_197 ) {
case V_198 :
...
V_223:
F_112 (urbp, tmp, &dum_hcd->urbp_list, urbp_list) {
struct V_142 * V_142 ;
struct V_5 * V_8 ;
V_111 V_32 ;
struct V_1 * V_4 = NULL ;
...
continue;
type = F_94 ( V_142 -> V_144 ) ;
if ( V_221 <= 0 && type == V_226 )
continue;
V_32 = F_84 ( V_142 -> V_144 ) ;
if ( F_99 ( V_142 -> V_144 ) )
V_32 |= V_84 ;
V_4 = F_107 ( V_13 , V_32 ) ;
if ( ! V_4 ) {
...
V_177 = V_221 ;
switch ( F_94 ( V_142 -> V_144 ) ) {
case V_231 :
V_177 = V_61 ( V_177 , F_106 ( V_13 , V_4 ) ) ;
V_28 = - V_232 ;
break;
case V_233 :
V_177 = V_61 ( V_177 , F_106 ( V_13 , V_4 ) ) ;
...
V_230:
V_4 -> V_128 = V_104 ;
V_221 = F_104 ( V_33 , V_142 , V_4 , V_177 , & V_28 ) ;
break;
}
if ( V_28 == - V_81 )
continue;
...
F_114 ( F_5 ( V_33 ) , V_142 ) ;
F_15 ( & V_13 -> V_30 ) ;
F_115 ( F_5 ( V_33 ) , V_142 , V_28 ) ;
F_16 ( & V_13 -> V_30 ) ;
goto V_223;
}
if ( F_12 ( & V_33 -> V_153 ) ) {
...
static int F_117 ( struct V_10 * V_11 , char * V_88 )
{
struct V_9 * V_33 ;
unsigned long V_79 ;
int V_62 = 0 ;
...
if ( ! F_118 ( V_11 ) )
goto V_69;
if ( V_33 -> V_52 && F_119 ( V_104 , V_33 -> V_103 ) ) {
V_33 -> V_35 |= ( V_234 << 16 ) ;
V_33 -> V_35 &= ~ V_51 ;
F_20 ( V_33 ) ;
}
...
static inline void
F_121 ( struct V_236 * V_60 )
{
memset ( V_60 , 0 , sizeof *V_60 ) ;
V_60 -> V_65 = 0x2a ;
V_60 -> V_237 = 12 ;
V_60 -> V_238 = F_122 ( 0x0001 ) ;
V_60 -> V_239 = 1 ;
V_60 -> V_240 . V_241 . V_242 = 0x04 ;
V_60 -> V_240 . V_241 . V_243 = 0xffff ;
}
static inline void F_123 ( struct V_236 * V_60 )
{
memset ( V_60 , 0 , sizeof *V_60 ) ;
V_60 -> V_65 = 0x29 ;
V_60 -> V_237 = 9 ;
...
if ( V_11 -> V_22 == V_34 )
F_121 ( (struct V_236 * ) V_88 ) ;
else
F_123 ( (struct V_236 * ) V_88 ) ;
break;
case V_255 | V_256 :
if ( V_11 -> V_22 != V_34 )
goto error;
...
F_20 ( V_33 ) ;
( ( V_263 * ) V_88 ) [ 0 ] = F_122 ( V_33 -> V_35 ) ;
( ( V_263 * ) V_88 ) [ 1 ] = F_122 ( V_33 -> V_35 >> 16 ) ;
break;
case V_264 :
V_62 = - V_228 ;
break;
...
static inline T_2 F_128 ( char * V_88 , T_6 V_276 , struct V_142 * V_142 )
{
int V_4 = F_84 ( V_142 -> V_144 ) ;
...
static T_2 F_129 ( struct V_14 * V_19 , struct V_112 * V_113 ,
char * V_88 )
{
struct V_10 * V_11 = F_130 ( V_19 ) ;
struct V_9 * V_33 = F_4 ( V_11 ) ;
struct V_149 * V_149 ;
T_6 V_276 = 0 ;
unsigned long V_79 ;
...
T_6 V_277 ;
V_277 = F_128 ( V_88 , V_115 - V_276 , V_149 -> V_142 ) ;
V_88 += V_277 ;
V_276 += V_277 ;
}
F_31 ( & V_33 -> V_13 -> V_30 , V_79 ) ;
...
static int F_131 ( struct V_9 * V_33 )
{
F_132 ( & V_33 -> V_157 ) ;
V_33 -> V_157 . V_114 = F_111 ;
...
struct V_17 * V_13 ;
V_13 = F_4 ( V_11 ) -> V_13 ;
F_73 ( F_6 ( F_4 ( V_11 ) ) , & V_283 ) ;
F_137 ( V_13 -> V_54 ) ;
F_138 ( F_6 ( F_4 ( V_11 ) ) , L_53 ) ;
}
...
static int F_143 ( struct V_131 * V_132 )
{
struct V_17 * V_13 ;
struct V_10 * V_25 ;
struct V_10 * V_24 ;
int V_62 ;
F_138 ( & V_132 -> V_19 , L_56 V_296 L_57 , V_297 ) ;
V_13 = * ( ( void * * ) F_66 ( & V_132 -> V_19 ) ) ;
if ( ! V_107 . V_108 )
V_9 . V_79 = V_285 ;
V_25 = F_144 ( & V_9 , & V_132 -> V_19 , F_145 ( & V_132 -> V_19 ) ) ;
if ( ! V_25 )
return - V_150 ;
V_25 -> V_298 = 1 ;
V_62 = F_146 ( V_25 , 0 , 0 ) ;
...
goto V_299;
if ( V_107 . V_108 ) {
V_24 = F_147 ( & V_9 , & V_132 -> V_19 ,
F_145 ( & V_132 -> V_19 ) , V_25 ) ;
if ( ! V_24 ) {
V_62 = - V_150 ;
goto V_300;
}
...
static int F_150 ( struct V_131 * V_132 )
{
struct V_17 * V_13 ;
V_13 = F_4 ( F_72 ( V_132 ) ) -> V_13 ;
if ( V_13 -> V_24 ) {
F_149 ( F_5 ( V_13 -> V_24 ) ) ;
F_148 ( F_5 ( V_13 -> V_24 ) ) ;
}
...
static int F_151 ( struct V_131 * V_132 , T_3 V_139 )
{
struct V_10 * V_11 ;
struct V_9 * V_33 ;
int V_133 = 0 ;
...
V_33 = F_4 ( V_11 ) ;
if ( V_33 -> V_45 == V_158 ) {
F_152 ( & V_132 -> V_19 , L_58 ) ;
V_133 = - V_302 ;
} else
F_153 ( V_303 , & V_11 -> V_79 ) ;
return V_133 ;
}
...
V_62 = F_161 ( V_307 [ V_119 ] , & V_13 [ V_119 ] ,
sizeof( void * ) ) ;
if ( V_62 )
goto V_312;
V_62 = F_161 ( V_309 [ V_119 ] , & V_13 [ V_119 ] ,
sizeof( void * ) ) ;
if ( V_62 )
goto V_312;
}
...
for ( V_119 = 0 ; V_119 < V_107 . V_306 ; V_119 ++ ) {
struct V_17 * V_13 ;
V_13 = * ( ( void * * ) F_66 ( & V_309 [ V_119 ] -> V_19 ) ) ;
F_167 ( V_309 [ V_119 ] ) ;
F_167 ( V_307 [ V_119 ] ) ;
F_37 ( V_13 ) ;
}
