...
{
struct V_49 * V_40 = V_74 ;
if ( V_40 -> V_75 == V_76 && V_40 -> V_72 ) {
F_32 ( & V_40 -> V_77 ) ;
} else {
unsigned int V_78 ;
V_78 = F_9 ( V_40 -> V_18 + V_79 ) ;
if ( V_78 == 0 || V_78 == ~ 0 )
return V_80 ;
if ( V_78 & V_81 ) {
F_32 ( & V_40 -> V_77 ) ;
...
F_39 ( & V_32 -> V_40 , L_20 , V_87 ) ;
F_45 ( V_87 , V_50 -> V_18 + V_92 ) ;
F_46 ( & V_16 ) ;
V_17 = V_50 ;
V_97 = V_32 ;
F_47 ( & V_16 ) ;
...
L_22 ,
V_102 , V_89 ) ;
if ( ! V_103 && ! F_29 ( V_32 , V_50 ) ) {
V_50 -> V_75 = V_76 ;
V_50 -> V_73 = V_50 -> V_69 [ 0 ] . V_71 ;
...
error = F_51 ( V_50 -> V_73 , F_31 , V_106 ,
V_90 , V_50 ) ;
if ( error ) {
F_16 ( & V_32 -> V_40 , L_23 ,
V_50 -> V_73 , error ) ;
