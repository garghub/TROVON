...
F_6 ( F_37 ( & V_12 -> V_15 ) != & V_82 ) ;
F_38 ( & V_12 -> V_15 , & V_5 -> V_83 ) ;
}
...
V_5 = & V_4 -> V_6 . V_10 [ V_21 -> V_11 ] ;
if ( V_5 -> V_88 ) {
V_85 = V_5 -> V_89 + F_40 () - 1 ;
V_86 = ( V_84 >= V_85 ) ;
}
if ( V_86 ) {
F_41 ( & V_12 -> V_15 , L_11 ) ;
F_42 ( & V_12 -> V_15 , & V_90 ) ;
F_43 ( & V_12 -> V_15 , V_5 -> V_89 ) ;
} else {
F_41 ( & V_12 -> V_15 , L_12 ) ;
F_42 ( & V_12 -> V_15 , & V_82 ) ;
F_44 ( & V_12 -> V_15 , & V_5 -> V_83 ) ;
}
return 0 ;
}
static void F_45 ( struct V_13 * V_5 , struct V_68 * V_18 )
{
struct V_14 * V_15 ;
F_22 (dev, &bus->devices, bus_list) {
F_38 ( & V_15 -> V_15 , & V_5 -> V_83 ) ;
if ( V_15 -> V_70 )
F_45 ( V_5 , V_15 -> V_70 ) ;
}
}
static void F_46 ( struct V_13 * V_5 ,
struct V_91 * V_92 ,
...
static void F_51 ( struct V_13 * V_5 ,
struct V_91 * V_92 ,
T_5 * V_93 , T_5 * V_94 , bool V_95 )
{
unsigned long V_38 , V_37 , V_99 ;
...
void F_52 ( struct V_91 * V_92 ,
T_5 * V_93 , T_5 * V_94 , bool V_95 )
{
struct V_13 * V_5 = F_53 ( V_92 , struct V_13 ,
V_83 ) ;
struct V_3 * V_4 = V_5 -> V_4 ;
if ( V_4 -> type == V_53 )
F_46 ( V_5 , V_92 , V_93 , V_94 , V_95 ) ;
else
F_51 ( V_5 , V_92 , V_93 , V_94 , V_95 ) ;
}
...
T_6 V_26 ;
void * V_111 ;
#define F_55 ((0x10000000 / 0x1000) * 8)
if ( F_6 ( V_5 -> V_76 >= 0 ) )
return;
V_5 -> V_76 = V_105 ;
F_31 ( V_5 , L_13 ,
( V_105 << 28 ) , ( ( V_105 + V_106 ) << 28 ) - 1 ) ;
V_108 = F_56 ( V_4 -> V_17 -> V_112 , V_113 ,
F_57 ( F_55 * V_106 ) ) ;
if ( ! V_108 ) {
F_15 ( V_5 , L_14 ) ;
goto V_114;
...
V_111 = F_58 ( V_108 ) ;
memset ( V_111 , 0 , F_55 * V_106 ) ;
for ( V_110 = 0 ; V_110 < V_106 ; V_110 ++ ) {
V_26 = F_59 ( V_4 -> V_47 ,
V_5 -> V_11 ,
V_105 + V_110 , 1 ,
F_47 ( V_111 ) + F_55 * V_110 ,
F_55 , 0x1000 ) ;
if ( V_26 ) {
F_15 ( V_5 , L_15
L_16 , V_26 ) ;
...
V_92 = & V_5 -> V_83 ;
F_60 ( V_92 , V_111 , F_55 * V_106 ,
V_105 << 28 ) ;
V_109 = F_61 ( V_4 -> V_17 -> V_115 , L_17 , NULL ) ;
if ( V_109 ) {
V_92 -> V_100 = 0 ;
V_5 -> V_97 = F_62 ( V_109 ) ;
V_92 -> V_98 = ( unsigned long ) F_63 ( V_5 -> V_97 ,
8 ) ;
V_92 -> V_101 = V_116 | V_117 |
V_102 ;
}
F_64 ( V_92 , V_4 -> V_17 -> V_112 ) ;
F_65 ( V_92 , F_30 ( V_5 -> V_29 ) , V_5 -> V_11 ) ;
if ( V_5 -> V_12 )
F_38 ( & V_5 -> V_12 -> V_15 , V_92 ) ;
else
F_45 ( V_5 , V_5 -> V_29 ) ;
return;
V_114:
...
V_5 -> V_76 = - 1 ;
if ( V_108 )
F_66 ( V_108 , F_57 ( F_55 * V_106 ) ) ;
}
static void F_67 ( struct V_91 * V_92 , bool V_118 )
{
struct V_13 * V_5 = F_53 ( V_92 , struct V_13 ,
V_83 ) ;
T_7 V_119 = ( V_5 -> V_11 << 1 ) + 1 ;
T_6 V_26 ;
F_31 ( V_5 , L_18 , V_118 ? L_19 : L_20 ) ;
if ( V_118 ) {
T_8 V_85 = F_40 () ;
V_85 = F_68 ( V_85 ) ;
V_26 = F_69 ( V_5 -> V_4 -> V_47 ,
V_5 -> V_11 ,
V_119 ,
V_5 -> V_89 ,
V_85 ) ;
...
const T_5 * V_109 ;
struct V_91 * V_92 ;
unsigned int V_121 , V_37 ;
T_6 V_26 ;
if ( F_6 ( V_5 -> V_76 >= 0 ) )
return;
V_5 -> V_76 = 0 ;
V_37 = ( 1 << F_72 ( V_4 -> V_6 . V_122 ) ) ;
V_121 = ( V_37 / 0x1000 ) * 8 ;
F_31 ( V_5 , L_22 ,
V_37 ) ;
V_108 = F_56 ( V_4 -> V_17 -> V_112 , V_113 ,
...
V_111 = F_58 ( V_108 ) ;
memset ( V_111 , 0 , V_121 ) ;
V_26 = F_59 ( V_4 -> V_47 , V_5 -> V_11 ,
V_5 -> V_11 << 1 , 1 , F_47 ( V_111 ) ,
V_121 , 0x1000 ) ;
if ( V_26 ) {
F_15 ( V_5 , L_24
L_16 , V_26 ) ;
...
V_5 -> V_76 = - 1 ;
if ( V_108 )
F_66 ( V_108 , F_57 ( V_121 ) ) ;
}
static void F_73 ( struct V_3 * V_4 )
{
struct V_16 * V_17 = V_4 -> V_17 ;
unsigned int V_123 , V_124 , V_106 , V_125 , V_105 ;
struct V_13 * V_5 ;
if ( V_4 -> V_6 . V_79 > V_4 -> V_6 . V_126 )
V_123 = 0 ;
else
V_123 = V_4 -> V_6 . V_126 -
V_4 -> V_6 . V_79 ;
F_74 ( L_25 ,
V_17 -> V_127 , V_4 -> V_6 . V_126 ) ;
F_74 ( L_26 ,
...
V_106 = 1 ;
if ( V_123 ) {
V_106 += ( ( V_5 -> V_58 * V_123 ) + ( V_125 / 2 ) ) / V_125 ;
if ( V_106 > V_124 )
V_106 = V_124 ;
}
if ( V_4 -> type == V_53 ) {
...
{
unsigned int V_130 = ( unsigned int ) F_76 ( V_129 ) ;
struct V_131 * V_132 = F_77 ( V_129 ) ;
struct V_3 * V_4 = F_53 ( V_132 , struct V_3 ,
V_6 . V_131 ) ;
T_6 V_26 ;
V_26 = F_78 ( V_4 -> V_47 , V_130 ) ;
F_79 ( V_26 ) ;
F_80 ( V_129 ) ;
}
static int F_81 ( struct V_3 * V_4 , struct V_14 * V_15 ,
...
if ( V_21 && V_21 -> V_143 )
V_135 = 0 ;
V_26 = F_82 ( V_4 -> V_47 , V_5 -> V_11 , V_140 ) ;
if ( V_26 ) {
F_26 ( L_30 ,
...
if ( V_135 ) {
T_5 V_145 ;
V_26 = F_83 ( V_4 -> V_47 , V_5 -> V_54 , V_140 , 1 ,
& V_145 , & V_142 ) ;
if ( V_26 ) {
F_26 ( L_31 ,
F_13 ( V_15 ) , V_26 ) ;
...
V_137 -> V_146 = F_84 ( V_145 ) >> 32 ;
V_137 -> V_147 = F_84 ( V_145 ) & 0xfffffffful ;
} else {
T_9 V_148 ;
V_26 = F_85 ( V_4 -> V_47 , V_5 -> V_54 , V_140 , 1 ,
& V_148 , & V_142 ) ;
if ( V_26 ) {
F_26 ( L_32 ,
F_13 ( V_15 ) , V_26 ) ;
...
V_137 -> V_146 = 0 ;
V_137 -> V_147 = F_86 ( V_148 ) ;
}
V_137 -> V_142 = F_86 ( V_142 ) ;
if ( V_4 -> type == V_56 ) {
if ( ! V_4 -> V_6 . V_149 ) {
V_138 = F_87 ( V_134 ) ;
V_139 = F_77 ( V_138 ) ;
V_4 -> V_6 . V_149 = 1 ;
V_4 -> V_6 . V_131 = * V_139 ;
V_4 -> V_6 . V_131 . V_150 = F_75 ;
}
F_88 ( V_134 , & V_4 -> V_6 . V_131 ) ;
}
F_89 ( L_33
L_34 ,
...
{
unsigned int V_30 ;
const T_9 * V_151 = F_61 ( V_4 -> V_17 -> V_115 ,
L_37 , NULL ) ;
if ( ! V_151 ) {
V_151 = F_61 ( V_4 -> V_17 -> V_115 , L_38 , NULL ) ;
}
if ( ! V_151 )
return;
V_4 -> V_141 = F_91 ( V_151 ) ;
V_30 = F_91 ( V_151 + 1 ) ;
if ( F_92 ( & V_4 -> V_152 , V_30 , V_4 -> V_17 -> V_115 ) ) {
F_12 ( L_39 ,
V_4 -> V_17 -> V_127 ) ;
return;
}
...
F_35 (hose, tmp, &hose_list, list_node) {
V_4 = V_17 -> V_19 ;
sprintf ( V_172 , L_45 , V_17 -> V_127 ) ;
V_4 -> V_173 = F_101 ( V_172 , V_174 ) ;
if ( ! V_4 -> V_173 )
F_29 ( L_46 ,
V_73 , V_17 -> V_127 ) ;
}
...
static T_10 F_107 ( struct V_68 * V_18 ,
unsigned long type )
{
struct V_14 * V_176 ;
struct V_16 * V_17 = F_9 ( V_18 ) ;
...
static T_11 F_109 ( struct V_3 * V_4 , struct V_68 * V_18 ,
T_11 V_179 )
{
...
{
F_111 ( V_4 -> V_47 , V_180 ,
V_181 ) ;
}
void T_12 F_112 ( struct V_182 * V_183 ,
T_1 V_184 , int V_185 )
{
struct V_16 * V_17 ;
struct V_3 * V_4 ;
...
void * V_194 ;
long V_26 ;
F_74 ( L_47 , V_185 , V_183 -> V_195 ) ;
V_190 = F_61 ( V_183 , L_48 , NULL ) ;
if ( ! V_190 ) {
F_12 ( L_49 ) ;
return;
}
V_193 = F_62 ( V_190 ) ;
F_113 ( L_50 , V_193 ) ;
V_4 = F_114 ( sizeof( struct V_3 ) ) ;
if ( ! V_4 ) {
F_12 ( L_51 ) ;
return;
}
memset ( V_4 , 0 , sizeof( struct V_3 ) ) ;
V_4 -> V_17 = V_17 = F_115 ( V_183 ) ;
if ( ! V_4 -> V_17 ) {
F_12 ( L_52 ,
V_183 -> V_195 ) ;
F_116 ( ( unsigned long ) V_4 , sizeof( struct V_3 ) ) ;
return;
}
F_117 ( & V_4 -> V_196 ) ;
V_191 = F_61 ( V_183 , L_53 , & V_192 ) ;
if ( V_191 && V_192 == 8 ) {
V_17 -> V_197 = F_86 ( V_191 [ 0 ] ) ;
V_17 -> V_198 = F_86 ( V_191 [ 1 ] ) ;
} else {
...
if ( F_118 ( V_183 , L_55 ) )
V_4 -> V_199 = V_200 ;
else if ( F_118 ( V_183 , L_56 ) )
V_4 -> V_199 = V_201 ;
else
V_4 -> V_199 = V_202 ;
F_119 ( V_17 , V_183 , ! V_17 -> V_127 ) ;
V_4 -> V_203 = F_120 ( V_183 , 0 ) ;
if ( V_4 -> V_203 == NULL )
F_12 ( L_57 ) ;
V_4 -> V_6 . V_8 = 1 ;
V_191 = F_61 ( V_183 , L_58 , NULL ) ;
if ( V_191 )
V_4 -> V_6 . V_8 = F_91 ( V_191 ) ;
V_191 = F_61 ( V_183 , L_59 , NULL ) ;
if ( V_191 )
V_4 -> V_6 . V_204 = F_91 ( V_191 ) ;
V_4 -> V_6 . V_205 = F_121 ( & V_17 -> V_206 [ 0 ] ) ;
V_4 -> V_6 . V_205 += 0x10000 ;
V_4 -> V_6 . V_168 = V_4 -> V_6 . V_205 / V_4 -> V_6 . V_8 ;
V_4 -> V_6 . V_122 = V_17 -> V_206 [ 0 ] . V_38 - V_17 -> V_167 [ 0 ] ;
V_4 -> V_6 . V_207 = V_17 -> V_208 ;
V_4 -> V_6 . V_162 = V_4 -> V_6 . V_207 / V_4 -> V_6 . V_8 ;
V_4 -> V_6 . V_161 = 0 ;
V_186 = F_122 ( V_4 -> V_6 . V_8 / 8 , sizeof( unsigned long ) ) ;
V_187 = V_186 ;
...
F_123 ( V_4 -> V_6 . V_204 , V_4 -> V_6 . V_7 ) ;
F_124 ( & V_4 -> V_6 . V_60 ) ;
F_124 ( & V_4 -> V_6 . V_78 ) ;
V_4 -> V_6 . V_126 = V_4 -> V_6 . V_122 >> 28 ;
V_17 -> V_206 [ 1 ] . V_34 = 0 ;
V_17 -> V_206 [ 1 ] . V_38 = 0 ;
V_17 -> V_206 [ 1 ] . V_37 = 0 ;
V_17 -> V_206 [ 2 ] . V_34 = 0 ;
...
V_217 . V_220 = F_107 ;
F_125 ( V_221 ) ;
V_26 = F_111 ( V_193 , V_180 , V_181 ) ;
if ( V_26 )
F_29 ( L_62 , V_26 ) ;
}
void T_12 F_126 ( struct V_182 * V_183 )
{
F_112 ( V_183 , 0 , V_56 ) ;
}
...
const T_5 * V_190 ;
T_1 V_184 ;
F_74 ( L_63 , V_183 -> V_195 ) ;
V_190 = F_61 ( V_183 , L_64 , NULL ) ;
if ( ! V_190 ) {
F_12 ( L_65 ) ;
return;
}
