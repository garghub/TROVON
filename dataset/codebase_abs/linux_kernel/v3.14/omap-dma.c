...
F_82 ( V_124 , V_116 ) ;
if ( V_124 -> V_48 . V_136 ) {
V_137 . V_138 = V_116 -> V_4 . V_127 ;
V_125 = F_83 ( V_124 -> V_48 . V_136 ,
V_139 , & V_137 ) ;
if ( V_125 ) {
F_81 ( L_6 ) ;
F_84 ( & V_116 -> V_4 ) ;
...
{
struct V_1 * V_116 = F_87 ( V_124 ) ;
if ( V_124 -> V_48 . V_136 )
F_88 ( V_124 -> V_48 . V_136 ) ;
F_84 ( & V_116 -> V_4 ) ;
F_74 ( V_116 ) ;
return 0 ;
}
bool F_89 ( struct V_6 * V_9 , void * V_140 )
{
if ( V_9 -> V_47 -> V_48 -> V_141 == & V_142 . V_141 ) {
struct V_5 * V_7 = F_3 ( V_9 ) ;
unsigned V_143 = * ( unsigned * ) V_140 ;
return V_143 == V_7 -> V_29 ;
}
return false ;
}
