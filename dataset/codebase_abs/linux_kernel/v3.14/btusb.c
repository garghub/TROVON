...
static void F_97 ( struct V_95 * V_65 )
{
struct V_1 * V_2 = F_98 ( V_65 ) ;
struct V_9 * V_10 ;
F_7 ( L_40 , V_65 ) ;
if ( ! V_2 )
return;
...
F_99 ( V_10 ) ;
if ( V_65 == V_2 -> V_96 )
F_100 ( & V_193 , V_2 -> V_65 ) ;
else if ( V_2 -> V_96 )
F_100 ( & V_193 , V_2 -> V_96 ) ;
F_94 ( V_10 ) ;
}
static int F_101 ( struct V_95 * V_65 , T_4 V_194 )
{
struct V_1 * V_2 = F_98 ( V_65 ) ;
F_7 ( L_40 , V_65 ) ;
if ( V_2 -> V_195 ++ )
...
static int F_107 ( struct V_95 * V_65 )
{
struct V_1 * V_2 = F_98 ( V_65 ) ;
struct V_9 * V_10 = V_2 -> V_10 ;
int V_12 = 0 ;
