...
struct V_10 * V_15 ;
int V_5 ;
V_15 = F_43 ( V_3 -> V_12 , sizeof( * V_15 ) * V_3 -> V_6 -> V_17 ,
V_19 ) ;
if ( ! V_15 )
return - V_39 ;
V_4 = F_43 ( V_3 -> V_12 , sizeof( * V_4 ) * V_3 -> V_6 -> V_7 ,
V_19 ) ;
if ( ! V_4 )
return - V_39 ;
...
struct V_10 * F_52 ( struct V_2 * V_3 , T_1 V_20 )
{
if ( V_3 -> V_6 -> V_17 < V_20 )
return NULL ;
return V_3 -> V_15 + V_20 ;
}
struct V_1 * F_53 ( struct V_10 * V_14 )
{
return V_14 ? V_14 -> V_9 : NULL ;
}
T_1 F_54 ( struct V_1 * V_9 )
{
return V_9 -> V_20 ;
}
