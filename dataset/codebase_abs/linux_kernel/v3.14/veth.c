...
static int F_45 ( struct V_97 * V_98 [] , struct V_97 * V_33 [] )
{
if ( V_98 [ V_99 ] ) {
...
if ( V_98 [ V_102 ] ) {
if ( ! F_35 ( F_49 ( V_98 [ V_102 ] ) ) )
return - V_75 ;
}
return 0 ;
}
static int F_50 ( struct V_103 * V_104 , struct V_1 * V_2 ,
struct V_97 * V_98 [] , struct V_97 * V_33 [] )
{
int V_105 ;
struct V_1 * V_36 ;
struct V_34 * V_35 ;
char V_106 [ V_107 ] ;
struct V_97 * V_108 [ V_109 + 1 ] , * * V_110 ;
struct V_111 * V_112 ;
struct V_103 * V_103 ;
...
V_114 = V_33 [ V_113 ] ;
V_112 = F_48 ( V_114 ) ;
V_105 = F_51 ( V_108 , V_109 ,
F_48 ( V_114 ) + sizeof( struct V_111 ) ,
F_46 ( V_114 ) - sizeof( struct V_111 ) ,
V_115 ) ;
if ( V_105 < 0 )
return V_105 ;
V_105 = F_45 ( V_108 , NULL ) ;
if ( V_105 < 0 )
return V_105 ;
V_110 = V_108 ;
} else {
...
if ( V_110 [ V_116 ] )
F_52 ( V_106 , V_110 [ V_116 ] , V_107 ) ;
else
snprintf ( V_106 , V_107 , V_22 L_1 ) ;
V_103 = F_53 ( V_104 , V_110 ) ;
if ( F_54 ( V_103 ) )
return F_55 ( V_103 ) ;
V_36 = F_56 ( V_103 , V_106 , & V_117 , V_110 ) ;
if ( F_54 ( V_36 ) ) {
F_57 ( V_103 ) ;
return F_55 ( V_36 ) ;
}
...
goto V_119;
F_34 ( V_36 ) ;
V_105 = F_60 ( V_36 , V_112 ) ;
if ( V_105 < 0 )
goto V_120;
if ( V_98 [ V_99 ] == NULL )
F_58 ( V_2 ) ;
if ( V_98 [ V_116 ] )
F_52 ( V_2 -> V_121 , V_98 [ V_116 ] , V_107 ) ;
else
snprintf ( V_2 -> V_121 , V_107 , V_22 L_1 ) ;
V_105 = F_59 ( V_2 ) ;
if ( V_105 < 0 )
goto V_122;
F_34 ( V_2 ) ;
...
static void F_63 ( struct V_1 * V_2 , struct V_123 * V_124 )
{
struct V_34 * V_35 ;
struct V_1 * V_36 ;
V_35 = F_9 ( V_2 ) ;
