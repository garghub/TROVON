...
{
struct V_1 * V_24 = F_22 ( sizeof( * V_24 ) , V_101 ) ;
struct V_2 * V_3 ;
struct V_102 * V_43 ;
T_2 V_103 = 0x13 ;
T_2 V_104 [ 12 ] ;
F_23 ( V_5 , L_1 ,
V_5 -> V_103 << 1 , V_5 -> V_105 -> V_106 ) ;
if ( V_24 == NULL )
return - V_107 ;
V_3 = & V_24 -> V_3 ;
F_24 ( V_3 , V_5 , & V_108 ) ;
F_4 ( V_5 , & V_103 , 1 ) ;
F_5 ( V_5 , V_104 , sizeof( V_104 ) ) ;
V_24 -> V_109 = ( V_104 [ 8 ] << 8 ) | V_104 [ 9 ] ;
V_24 -> V_110 = 0 ;
if ( V_24 -> V_109 == 0x0206 ) {
V_24 -> V_110 = 1 ;
F_23 ( V_5 , L_2 ) ;
}
V_24 -> V_26 = V_111 ;
...
~ ( 1 << V_119 ) ,
V_119 ) ;
V_24 -> V_120 = F_26 ( V_43 , & V_112 ,
V_45 ,
V_121 , 0 ,
V_30 ) ;
V_24 -> V_47 = F_27 ( V_43 , & V_112 ,
V_122 , 1000000 , 27000000 , 1000 , 6000000 ) ;
F_27 ( V_43 , & V_112 ,
V_49 , 0 , ( 1 << 14 ) - 1 , 1 , 16 ) ;
F_27 ( V_43 , & V_112 ,
V_51 , 0 , ( 1 << 14 ) - 1 , 1 , 260 ) ;
