...
{
struct V_8 * V_9 = V_2 -> V_9 ;
struct V_132 * V_133 = & V_4 -> V_21 . V_133 ;
struct V_124 * V_125 ;
struct V_126 * V_127 ;
...
( ( T_3 * ) V_125 +
sizeof( struct V_124 ) ) ;
V_107 = F_3 ( V_4 -> V_110 ) - V_111 - sizeof( * V_133 ) ;
if ( V_107 <
F_3 ( V_125 -> V_121 ) + sizeof( * V_125 ) )
return 0 ;
switch ( V_23 ) {
case V_73 :
if ( V_9 -> V_134 == V_135 )
F_18 ( V_2 , V_125 ) ;
V_2 -> V_136 = ( T_2 ) V_127 -> V_129 ;
break;
case V_137 :
if ( ! F_15 ( V_133 -> V_138 ) )
break;
...
if ( V_23 == V_73 ) {
V_2 -> V_131 = V_140 -> V_122 ;
V_2 -> V_130 = V_140 -> V_123 ;
}
F_13 ( V_2 -> V_9 -> V_13 ,
L_11 ,
V_2 -> V_136 , V_2 -> V_131 ,
...
if ( ! F_41 ( V_2 -> V_164 . V_165 . V_166 , V_226 -> V_228 ) ) {
...
int F_44 ( struct V_1 * V_2 , T_2 V_238 ,
struct V_3 * V_4 )
{
int V_239 = 0 ;
struct V_8 * V_9 = V_2 -> V_9 ;
