...
( V_8 -> V_84 . V_85 [ 0 ] . V_12 & V_108 ) )
V_96 |= V_109 ;
else if ( V_8 -> V_84 . V_85 [ 0 ] . V_12 & V_107 )
V_96 |= V_110 ;
F_37 ( V_96 , V_95 ) ;
V_95 += 2 ;
* V_95 = V_91 ;
...
V_153 = & V_20 -> V_153 [ V_36 ] ;
F_59 ( & V_145 ) ;
V_143 = F_60 ( V_145 . V_158 , V_145 . V_159 ) ;
V_146 = F_61 ( F_62 ( V_143 , V_156 ) ) ;
if ( V_153 -> V_160 < V_146 )
V_153 -> V_160 = V_146 ;
V_153 -> V_161 ++ ;
V_153 -> V_162 += V_146 ;
if ( ! V_153 -> V_163 )
...
int V_92 ;
int V_93 = 0 ;
for ( V_147 = 0 ; V_147 < V_173 ; V_147 ++ ) {
if ( ( V_8 -> V_12 & V_174 ) &&
! ( V_8 -> V_12 & V_175 ) ) {
V_8 -> V_84 . V_85 [ V_147 ] . V_86 = - 1 ;
V_8 -> V_84 . V_85 [ V_147 ] . V_176 = 0 ;
break;
} else if ( V_8 -> V_84 . V_85 [ V_147 ] . V_86 < 0 ) {
break;
} else if ( V_147 >= V_2 -> V_177 ) {
V_8 -> V_84 . V_85 [ V_147 ] . V_86 = - 1 ;
V_8 -> V_84 . V_85 [ V_147 ] . V_176 = 0 ;
break;
}
V_91 += V_8 -> V_84 . V_85 [ V_147 ] . V_176 ;
}
V_169 = V_147 - 1 ;
if ( V_91 < 0 )
V_91 = 0 ;
F_41 () ;
V_90 = V_6 -> V_2 . V_178 -> V_179 [ V_8 -> V_180 ] ;
V_151 = V_22 -> V_33 ;
F_64 (local, hdr->addr1, sta, tmp) {
if ( ! F_65 ( V_22 -> V_181 , V_20 -> V_28 -> V_27 . V_48 ) )
continue;
V_93 = F_66 ( & V_20 -> V_28 -> V_27 ) ;
if ( V_8 -> V_12 & V_182 )
F_67 ( V_20 , V_183 ) ;
...
if ( F_68 ( & V_20 -> V_28 -> V_27 ) &&
F_12 ( V_151 ) )
F_69 (
F_13 ( V_22 ) ,
V_20 , true , V_130 ) ;
if ( ( V_6 -> V_2 . V_12 & V_184 ) &&
( V_169 != - 1 ) )
V_20 -> V_185 = V_8 -> V_84 . V_85 [ V_169 ] ;
if ( ( V_8 -> V_12 & V_186 ) &&
( F_12 ( V_151 ) ) ) {
T_2 V_36 , V_81 ;
T_1 * V_59 ;
...
if ( ! V_130 && F_71 ( V_151 ) ) {
T_2 V_36 , V_25 ;
V_172 = (struct V_171 * ) V_4 -> V_23 ;
V_25 = F_70 ( V_172 -> V_25 ) ;
if ( ! ( V_25 & V_189 ) ) {
T_2 V_81 = F_70 ( V_172 -> V_190 ) ;
V_36 = ( V_25 &
V_191 ) >>
V_192 ;
F_29 ( V_20 , V_36 , V_81 ) ;
...
F_72 ( V_6 , V_90 , V_20 , V_4 ) ;
if ( F_68 ( & V_20 -> V_28 -> V_27 ) )
F_73 ( V_6 , V_20 , V_4 ) ;
if ( ! ( V_8 -> V_12 & V_196 ) && V_130 )
F_25 ( V_20 , V_4 ) ;
if ( ( V_20 -> V_28 -> V_27 . type == V_76 ) &&
( V_6 -> V_2 . V_12 & V_57 ) )
F_74 ( V_20 -> V_28 , ( void * ) V_4 -> V_23 , V_130 ) ;
if ( V_6 -> V_2 . V_12 & V_57 ) {
if ( V_8 -> V_12 & V_105 ) {
if ( V_20 -> V_197 )
V_20 -> V_197 = 0 ;
} else if ( ++ V_20 -> V_197 >= V_198 ) {
F_75 ( V_20 -> V_28 -> V_135 ,
V_20 -> V_20 . V_48 ,
V_20 -> V_197 ,
V_137 ) ;
V_20 -> V_197 = 0 ;
...
if ( F_44 ( V_151 ) && F_79 ( V_151 ) &&
( V_6 -> V_2 . V_12 & V_57 ) &&
! ( V_8 -> V_12 & V_196 ) &&
V_6 -> V_207 && ! ( V_6 -> V_208 ) ) {
if ( V_8 -> V_12 & V_105 ) {
V_6 -> V_207 -> V_61 . V_209 . V_12 |=
V_210 ;
} else
F_18 ( & V_6 -> V_211 , V_26 +
F_80 ( 10 ) ) ;
...
F_40 ( V_6 , V_4 , false ) ;
F_81 ( V_4 ) ;
V_170 = ! ! ( V_8 -> V_12 & V_196 ) ||
! ( F_58 ( V_151 ) ) ;
if ( ! V_6 -> V_212 && ( ! V_170 || ! V_6 -> V_213 ) ) {
F_82 ( V_4 ) ;
return;
}
V_92 = F_30 ( V_8 ) ;
if ( F_83 ( F_84 ( V_4 ) < V_92 ) ) {
F_85 ( L_2 ) ;
F_82 ( V_4 ) ;
return;
}
...
V_4 -> V_214 = V_215 ;
V_4 -> V_10 = V_216 ;
V_4 -> V_217 = F_87 ( V_218 ) ;
memset ( V_4 -> V_219 , 0 , sizeof( V_4 -> V_219 ) ) ;
F_41 () ;
F_42 (sdata, &local->interfaces, list) {
if ( V_28 -> V_27 . type == V_220 ) {
if ( ! F_27 ( V_28 ) )
continue;
if ( ( V_28 -> V_61 . V_221 & V_222 ) &&
! V_170 )
continue;
if ( V_168 ) {
V_166 = F_88 ( V_4 , V_137 ) ;
if ( V_166 ) {
V_166 -> V_135 = V_168 ;
F_89 ( V_166 ) ;
}
...
void F_90 ( struct V_223 * V_224 , T_5 V_225 )
{
struct V_19 * V_20 = F_91 ( V_224 , struct V_19 , V_20 ) ;
F_75 ( V_20 -> V_28 -> V_135 , V_20 -> V_20 . V_48 ,
V_225 , V_137 ) ;
}
