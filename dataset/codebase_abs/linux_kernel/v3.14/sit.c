...
if ( type == V_112 ) {
F_68 ( V_84 , F_18 ( V_84 -> V_4 ) , V_9 -> V_4 -> V_115 , 0 ,
V_116 , 0 ) ;
V_36 = 0 ;
goto V_37;
}
...
static inline bool F_70 ( struct V_1 * V_95 , const T_1 V_122 ,
const struct V_91 * V_123 )
{
T_1 V_124 = 0 ;
if ( F_71 ( V_95 , V_123 , & V_124 ) && V_122 != V_124 )
return true ;
return false ;
}
...
V_126 = 48 ;
#endif
return F_73 ( V_125 , V_126 , V_95 -> V_4 ) ;
}
...
return false ;
V_127 = F_48 ( V_84 ) ;
if ( F_75 ( F_70 ( V_95 , V_14 -> V_15 , & V_127 -> V_15 ) ) ) {
F_76 ( L_2 ,
& V_14 -> V_15 , & V_127 -> V_15 ,
& V_14 -> V_16 , & V_127 -> V_16 ) ;
return true ;
}
if ( F_77 ( ! F_70 ( V_95 , V_14 -> V_16 , & V_127 -> V_16 ) ) )
return false ;
if ( F_72 ( V_95 , & V_127 -> V_16 ) )
return false ;
F_76 ( L_3 ,
& V_14 -> V_15 , & V_127 -> V_15 ,
& V_14 -> V_16 , & V_127 -> V_16 ) ;
...
V_95 -> V_13 . V_14 . V_131 != 0 )
goto V_144;
if ( ! F_90 ( NULL , V_145 , V_84 ) )
goto V_144;
if ( F_91 ( V_84 , 0 , V_146 . V_147 ) )
goto V_144;
return F_92 ( V_95 , V_84 , & V_146 , V_137 ) ;
}
return 1 ;
V_144:
F_64 ( V_84 ) ;
...
static bool F_71 ( struct V_1 * V_95 , const struct V_91 * V_125 ,
T_1 * V_148 )
{
#ifdef F_13
if ( F_93 ( V_125 , & V_95 -> V_30 . V_31 ,
V_95 -> V_30 . V_33 ) ) {
...
V_152 = ( F_94 ( V_125 -> V_93 [ V_149 ] ) << V_150 ) >>
V_95 -> V_30 . V_34 ;
V_151 = V_150 - V_95 -> V_30 . V_34 ;
if ( V_151 > 0 )
V_152 |= F_94 ( V_125 -> V_93 [ V_149 + 1 ] ) >>
( 32 - V_151 ) ;
...
bool V_168 = false ;
if ( F_98 ( V_84 ) )
V_167 = F_99 ( F_98 ( V_84 ) , & V_155 -> V_16 ) ;
if ( V_167 == NULL ) {
F_100 ( L_5 ) ;
goto V_165;
}
...
V_98 = F_103 ( V_95 -> V_2 , & V_162 , NULL ,
V_102 , V_154 -> V_15 ,
0 , 0 ,
V_116 , F_104 ( V_138 ) ,
V_95 -> V_13 . V_17 ) ;
...
if ( V_156 ) {
V_163 = F_107 ( & V_98 -> V_102 ) - sizeof( struct V_85 ) ;
if ( V_163 < 68 ) {
V_4 -> V_135 . V_177 ++ ;
F_106 ( V_98 ) ;
goto V_165;
...
F_98 ( V_84 ) -> V_179 -> V_180 ( F_98 ( V_84 ) , NULL , V_84 , V_163 ) ;
if ( V_84 -> V_63 > V_163 && ! F_108 ( V_84 ) ) {
F_62 ( V_84 , V_181 , 0 , V_163 ) ;
F_106 ( V_98 ) ;
goto V_165;
}
}
...
V_160 = F_110 ( V_159 ) + sizeof( struct V_85 ) ;
if ( F_111 ( V_84 ) < V_160 || F_112 ( V_84 ) ||
( F_113 ( V_84 ) && ! F_114 ( V_84 , 0 ) ) ) {
struct V_83 * V_182 = F_115 ( V_84 , V_160 ) ;
if ( ! V_182 ) {
F_106 ( V_98 ) ;
V_4 -> V_135 . V_183 ++ ;
F_64 ( V_84 ) ;
...
V_84 = F_119 ( V_84 , false , V_187 ) ;
if ( F_105 ( V_84 ) ) {
F_106 ( V_98 ) ;
goto V_37;
}
V_36 = F_120 ( V_98 , V_84 , V_162 . V_15 , V_162 . V_16 , V_116 , V_138 ,
V_117 , V_156 , ! F_121 ( V_95 -> V_2 , F_18 ( V_4 ) ) ) ;
...
struct V_1 * V_95 = F_14 ( V_4 ) ;
const struct V_85 * V_154 = & V_95 -> V_13 . V_14 ;
V_84 = F_119 ( V_84 , false , V_189 ) ;
if ( F_105 ( V_84 ) )
goto V_37;
F_124 ( V_84 , V_4 , V_154 , V_143 ) ;
return V_184 ;
V_37:
V_4 -> V_135 . V_188 ++ ;
return V_184 ;
...
V_14 = & V_95 -> V_13 . V_14 ;
if ( V_14 -> V_16 ) {
struct V_158 * V_98 = F_103 ( V_95 -> V_2 , & V_162 ,
NULL ,
V_14 -> V_16 , V_14 -> V_15 ,
0 , 0 ,
V_116 ,
...
V_159 = F_127 ( V_95 -> V_2 , V_95 -> V_13 . V_17 ) ;
if ( V_159 ) {
...
static int
F_134 ( struct V_3 * V_4 , struct V_196 * V_197 , int V_198 )
{
int V_36 = 0 ;
struct V_22 V_74 ;
struct V_56 V_55 ;
...
V_74 . V_14 . V_100 != 5 || ( V_74 . V_14 . V_157 & F_81 ( ~ V_209 ) ) )
goto V_203;
if ( V_74 . V_14 . V_117 )
V_74 . V_14 . V_157 |= F_81 ( V_209 ) ;
...
static int F_137 ( struct V_3 * V_4 , int V_218 )
{
...
V_4 -> V_222 = F_26 ;
V_4 -> type = V_223 ;
V_4 -> V_192 = V_224 + sizeof( struct V_85 ) ;
V_4 -> V_163 = V_225 - sizeof( struct V_85 ) ;
V_4 -> V_19 = V_226 ;
V_4 -> V_42 &= ~ V_227 ;
V_4 -> V_18 = 0 ;
V_4 -> V_228 = 4 ;
...
F_141 (i) {
struct V_129 * V_234 ;
V_234 = F_142 ( V_4 -> V_130 , V_233 ) ;
F_143 ( & V_234 -> V_140 ) ;
}
V_95 -> V_219 = F_140 ( struct V_235 ) ;
if ( ! V_95 -> V_219 ) {
F_138 ( V_4 -> V_130 ) ;
return - V_72 ;
}
...
static int T_8 F_144 ( struct V_3 * V_4 )
{
struct V_1 * V_95 = F_14 ( V_4 ) ;
...
static int F_145 ( struct V_237 * V_238 [] , struct V_237 * V_96 [] )
{
T_6 V_147 ;
if ( ! V_96 || ! V_96 [ V_239 ] )
return 0 ;
V_147 = F_146 ( V_96 [ V_239 ] ) ;
if ( V_147 != V_116 &&
V_147 != V_143 &&
V_147 != 0 )
return - V_75 ;
...
static void F_147 ( struct V_237 * V_96 [] ,
struct V_22 * V_13 )
{
...
return;
if ( V_96 [ V_240 ] )
V_13 -> V_17 = F_148 ( V_96 [ V_240 ] ) ;
if ( V_96 [ V_241 ] )
V_13 -> V_14 . V_15 = F_149 ( V_96 [ V_241 ] ) ;
if ( V_96 [ V_242 ] )
V_13 -> V_14 . V_16 = F_149 ( V_96 [ V_242 ] ) ;
if ( V_96 [ V_243 ] ) {
V_13 -> V_14 . V_117 = F_146 ( V_96 [ V_243 ] ) ;
if ( V_13 -> V_14 . V_117 )
V_13 -> V_14 . V_157 = F_81 ( V_209 ) ;
}
if ( V_96 [ V_244 ] )
V_13 -> V_14 . V_138 = F_146 ( V_96 [ V_244 ] ) ;
if ( ! V_96 [ V_245 ] || F_146 ( V_96 [ V_245 ] ) )
V_13 -> V_14 . V_157 = F_81 ( V_209 ) ;
if ( V_96 [ V_246 ] )
V_13 -> V_40 = F_150 ( V_96 [ V_246 ] ) ;
if ( V_96 [ V_239 ] )
V_13 -> V_14 . V_131 = F_146 ( V_96 [ V_239 ] ) ;
}
static bool F_151 ( struct V_237 * V_96 [] ,
struct V_195 * V_30 )
{
bool V_64 = false ;
...
static int F_154 ( struct V_2 * V_251 , struct V_3 * V_4 ,
struct V_237 * V_238 [] , struct V_237 * V_96 [] )
{
struct V_2 * V_2 = F_18 ( V_4 ) ;
struct V_1 * V_48 ;
#ifdef F_13
...
static int F_155 ( struct V_3 * V_4 , struct V_237 * V_238 [] ,
struct V_237 * V_96 [] )
{
struct V_1 * V_9 = F_14 ( V_4 ) ;
struct V_22 V_74 ;
...
static int F_158 ( struct V_83 * V_84 , const struct V_3 * V_4 )
{
struct V_1 * V_95 = F_14 ( V_4 ) ;
struct V_22 * V_252 = & V_95 -> V_13 ;
if ( F_159 ( V_84 , V_240 , V_252 -> V_17 ) ||
F_160 ( V_84 , V_241 , V_252 -> V_14 . V_15 ) ||
F_160 ( V_84 , V_242 , V_252 -> V_14 . V_16 ) ||
F_161 ( V_84 , V_243 , V_252 -> V_14 . V_117 ) ||
F_161 ( V_84 , V_244 , V_252 -> V_14 . V_138 ) ||
F_161 ( V_84 , V_245 ,
! ! ( V_252 -> V_14 . V_157 & F_81 ( V_209 ) ) ) ||
F_161 ( V_84 , V_239 , V_252 -> V_14 . V_131 ) ||
F_162 ( V_84 , V_246 , V_252 -> V_40 ) )
goto V_253;
#ifdef F_13
if ( F_163 ( V_84 , V_247 , sizeof( struct V_91 ) ,
& V_95 -> V_30 . V_31 ) ||
F_160 ( V_84 , V_248 ,
V_95 -> V_30 . V_32 ) ||
F_164 ( V_84 , V_249 ,
...
static void F_165 ( struct V_3 * V_4 , struct V_255 * V_80 )
{
struct V_2 * V_2 = F_18 ( V_4 ) ;
struct V_10 * V_11 = F_3 ( V_2 , V_12 ) ;
if ( V_4 != V_11 -> V_29 )
...
V_11 -> V_25 [ 1 ] = V_11 -> V_258 ;
V_11 -> V_25 [ 2 ] = V_11 -> V_259 ;
V_11 -> V_25 [ 3 ] = V_11 -> V_260 ;
...
F_25 ( V_11 -> V_29 , V_2 ) ;
V_11 -> V_29 -> V_45 = & V_46 ;
V_11 -> V_29 -> V_229 |= V_262 ;
V_36 = F_144 ( V_11 -> V_29 ) ;
if ( V_36 )
goto V_263;
F_12 ( V_11 -> V_29 , V_11 ) ;
if ( ( V_36 = F_170 ( V_11 -> V_29 ) ) )
goto V_264;
V_9 = F_14 ( V_11 -> V_29 ) ;
...
if ( V_36 < 0 )
return V_36 ;
V_36 = F_184 ( & V_266 , V_267 ) ;
if ( V_36 < 0 ) {
F_182 ( L_8 , V_271 ) ;
goto V_272;
}
V_36 = F_184 ( & V_268 , V_269 ) ;
if ( V_36 < 0 ) {
F_182 ( L_9 , V_271 ) ;
goto V_273;
}
