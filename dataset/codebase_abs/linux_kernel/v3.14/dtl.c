...
{
struct V_4 * V_5 = & F_7 ( V_6 , V_18 -> V_19 ) ;
V_5 -> V_16 = V_18 -> V_16 ;
V_5 -> V_15 = V_18 -> V_16 + V_18 -> V_20 ;
V_5 -> V_17 = 0 ;
F_5 () ;
V_5 -> V_8 = V_18 -> V_16 ;
V_5 -> V_21 = F_8 ( V_18 -> V_19 ) . V_22 ;
F_8 ( V_18 -> V_19 ) . V_22 |= V_23 ;
V_24 = F_1 ;
F_9 ( & V_25 ) ;
return 0 ;
}
...
F_5 () ;
V_5 -> V_16 = NULL ;
F_8 ( V_18 -> V_19 ) . V_22 = V_5 -> V_21 ;
if ( F_11 ( & V_25 ) )
V_24 = NULL ;
}
static T_1 F_12 ( struct V_18 * V_18 )
{
return F_7 ( V_6 , V_18 -> V_19 ) . V_17 ;
}
static int F_6 ( struct V_18 * V_18 )
{
unsigned long V_26 ;
...
static void F_10 ( struct V_18 * V_18 )
{
int V_28 = F_13 ( V_18 -> V_19 ) ;
F_8 ( V_18 -> V_19 ) . V_22 = 0x0 ;
F_17 ( V_28 ) ;
}
static T_1 F_12 ( struct V_18 * V_18 )
{
return F_8 ( V_18 -> V_19 ) . V_14 ;
}
...
return - V_38 ;
V_34 = V_39 ;
V_16 = F_19 ( V_36 , V_40 , F_20 ( V_18 -> V_19 ) ) ;
if ( ! V_16 ) {
F_16 ( V_31 L_3 ,
V_32 , V_18 -> V_19 ) ;
return - V_37 ;
...
static int F_26 ( struct V_43 * V_43 , struct V_44 * V_45 )
{
struct V_18 * V_18 = V_43 -> V_46 ;
F_24 ( V_18 ) ;
return 0 ;
}
static T_2 F_27 ( struct V_44 * V_45 , char T_3 * V_16 , T_4 V_48 ,
T_5 * V_49 )
{
...
V_35 = F_28 ( V_16 , & V_18 -> V_16 [ V_54 ] , V_51 * sizeof( struct V_1 ) ) ;
if ( V_35 )
return - V_56 ;
V_50 += V_51 ;
return V_50 * sizeof( struct V_1 ) ;
}
static int F_29 ( struct V_18 * V_18 )
{
char V_57 [ 10 ] ;
sprintf ( V_57 , L_4 , V_18 -> V_19 ) ;
V_18 -> V_44 = F_30 ( V_57 , 0400 , V_58 , V_18 , & V_59 ) ;
if ( ! V_18 -> V_44 )
return - V_37 ;
return 0 ;
}
...
F_36 (i) {
struct V_18 * V_18 = & F_7 ( V_68 , V_54 ) ;
F_37 ( & V_18 -> V_41 ) ;
V_18 -> V_19 = V_54 ;
V_35 = F_29 ( V_18 ) ;
if ( V_35 )
