...
if ( V_130 == 7 )
F_107 ( L_2 ) ;
V_116 -> V_22 . V_136 = V_130 ? 2 << V_130 : 0 ;
...
if ( V_130 == 7 )
F_107 ( L_3 ) ;
V_116 -> V_123 . V_136 = V_130 ? 2 << V_130 : 0 ;
...
F_110 ( L_5 ,
V_104 >> 10 ,
V_116 -> V_22 . V_17 & V_124 ? L_6 : L_7 ,
V_184 [ V_116 -> V_22 . V_27 ] , V_116 -> V_22 . V_136 ) ;
F_110 ( L_8 ,
V_103 >> 10 , V_184 [ V_116 -> V_123 . V_27 ] ,
( V_116 -> V_123 . V_17 & V_172 ) ? L_9 : L_7 ,
( V_116 -> V_123 . V_17 & V_181 ) ?
L_10 : L_11 ,
V_116 -> V_123 . V_136 ) ;
}
...
{
unsigned long V_17 , V_4 , V_185 , V_20 , V_186 ;
unsigned int V_127 = F_103 () ;
struct V_115 * V_116 = & V_21 ;
if ( V_127 & V_166 )
return 0 ;
V_185 = ( unsigned long ) & V_187 ;
V_185 &= ~ ( ( 4 * 1024 * 1024 ) - 1 ) ;
V_20 = V_185 + ( 4 * 1024 * 1024 ) ;
F_17 ( V_17 ) ;
V_186 = ( 64 * 1024 ) ;
for ( V_4 = V_185 ; V_4 < V_20 ; V_4 = ( V_185 + V_186 ) ) {
unsigned long * V_188 = ( unsigned long * ) V_4 ;
...
F_112 ( V_191 , V_185 ) ;
V_186 = ( 128 * 1024 ) ;
for ( V_4 = V_185 + ( 128 * 1024 ) ; V_4 < V_20 ; V_4 = V_185 + V_186 ) {
F_112 ( V_192 , V_4 ) ;
__asm__ __volatile__("nop; nop; nop; nop;");
if ( ! F_113 () )
break;
...
V_4 -= V_185 ;
V_53 = V_4 ;
V_116 -> V_193 . V_136 = 16 << ( ( V_127 & V_194 ) >> 22 ) ;
V_116 -> V_193 . V_27 = 1 ;
V_116 -> V_123 . V_25 = 0 ;
return 1 ;
}
...
struct V_115 * V_116 = & V_21 ;
V_53 = 512 * 1024 ;
V_116 -> V_193 . V_136 = 32 ;
V_116 -> V_193 . V_27 = 4 ;
V_116 -> V_193 . V_25 = 0 ;
V_116 -> V_193 . V_23 = V_53 / ( V_116 -> V_193 . V_27 ) ;
V_116 -> V_193 . V_163 = V_53 / ( V_116 -> V_193 . V_136 * V_116 -> V_193 . V_27 ) ;
F_115 ( L_12 ,
V_53 >> 10 , V_184 [ V_116 -> V_193 . V_27 ] , V_116 -> V_193 . V_136 ) ;
V_116 -> V_140 |= V_195 ;
}
...
case V_74 :
case V_75 :
V_53 = 0x80000 << ( ( V_127 & V_198 ) >> 16 ) ;
V_116 -> V_193 . V_136 = 64 << ( ( V_127 >> 13 ) & 1 ) ;
V_116 -> V_193 . V_27 = 2 ;
V_116 -> V_193 . V_25 = 0 ;
V_196 = 1 ;
break;
...
return;
default:
if ( V_116 -> V_200 & ( V_201 | V_202 |
V_203 | V_204 ) ) {
#ifdef F_122
if ( F_123 () ) {
V_53 = V_116 -> V_193 . V_27 * V_116 -> V_193 . V_163 * V_116 -> V_193 . V_136 ;
F_110 ( L_13 ,
V_53 >> 10 ,
V_184 [ V_116 -> V_193 . V_27 ] , V_116 -> V_193 . V_136 ) ;
}
#else
if ( ! ( V_116 -> V_193 . V_17 & V_205 ) )
F_107 ( L_14 ) ;
#endif
return;
}
...
static int T_5 F_128 ( char * V_209 )
{
F_129 ( & V_209 , & V_210 ) ;
return 0 ;
}
...
{
extern char __weak V_214 ;
extern char __weak V_215 ;
switch ( F_27 () ) {
case V_169 :
case V_170 :
F_135 ( 0x100 , & V_215 , 0x80 ) ;
break;
default:
F_135 ( 0x100 , & V_214 , 0x80 ) ;
break;
}
}
void F_136 ( void )
{
extern void V_216 ( void ) ;
extern void V_217 ( void ) ;
struct V_115 * V_116 = & V_21 ;
F_102 () ;
F_116 () ;
F_12 () ;
