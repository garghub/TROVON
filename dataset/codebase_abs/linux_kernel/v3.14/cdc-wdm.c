...
static int F_44 ( struct V_61 * V_61 , T_6 V_99 )
{
struct V_1 * V_4 = V_61 -> V_69 ;
F_45 ( V_4 -> V_16 , ! F_14 ( V_14 , & V_4 -> V_15 ) ) ;
if ( V_4 -> V_11 < 0 && ! F_14 ( V_49 , & V_4 -> V_15 ) )
F_12 ( & V_4 -> V_3 -> V_21 , L_22 ,
V_4 -> V_11 ) ;
return F_31 ( V_4 -> V_11 ) ;
}
static unsigned int F_46 ( struct V_61 * V_61 , struct V_100 * V_16 )
{
struct V_1 * V_4 = V_61 -> V_69 ;
unsigned long V_15 ;
...
V_101 |= V_107 | V_108 ;
F_48 ( & V_4 -> V_10 , V_15 ) ;
F_49 ( V_61 , & V_4 -> V_16 , V_16 ) ;
V_104:
return V_101 ;
}
static int F_50 ( struct V_109 * V_109 , struct V_61 * V_61 )
{
int V_7 = F_51 ( V_109 ) ;
int V_33 = - V_78 ;
struct V_2 * V_3 ;
...
static int F_53 ( struct V_109 * V_109 , struct V_61 * V_61 )
{
struct V_1 * V_4 = V_61 -> V_69 ;
F_52 ( & V_110 ) ;
F_52 ( & V_4 -> V_76 ) ;
...
static long F_55 ( struct V_61 * V_61 , unsigned int V_113 , unsigned long V_114 )
{
struct V_1 * V_4 = V_61 -> V_69 ;
int V_33 = 0 ;
switch ( V_113 ) {
case V_115 :
if ( F_43 ( ( void T_2 * ) V_114 , & V_4 -> V_27 , sizeof( V_4 -> V_27 ) ) )
V_33 = - V_75 ;
break;
default:
V_33 = - V_116 ;
...
{
struct V_1 * V_4 = F_57 ( V_118 , struct V_1 , V_56 ) ;
unsigned long V_15 ;
int V_33 = 0 ;
int V_34 ;
F_47 ( & V_4 -> V_10 , V_15 ) ;
...
static int F_58 ( struct V_2 * V_3 , struct V_119 * V_120 ,
T_7 V_121 , int (* V_111)( struct V_2 * , int ) )
{
int V_33 = - V_55 ;
struct V_1 * V_4 ;
V_4 = F_59 ( sizeof( struct V_1 ) , V_73 ) ;
if ( ! V_4 )
goto V_84;
F_60 ( & V_4 -> V_122 ) ;
F_61 ( & V_4 -> V_94 ) ;
...
if ( ! V_4 -> V_60 )
goto V_97;
V_4 -> V_58 = F_67 ( 0 , V_73 ) ;
if ( ! V_4 -> V_58 )
goto V_97;
V_4 -> V_51 = F_67 ( 0 , V_73 ) ;
if ( ! V_4 -> V_51 )
goto V_97;
V_4 -> V_57 = F_67 ( 0 , V_73 ) ;
if ( ! V_4 -> V_57 )
goto V_97;
...
V_4 -> V_111 = V_111 ;
F_2 ( & V_5 ) ;
F_71 ( & V_4 -> V_122 , & V_131 ) ;
F_4 ( & V_5 ) ;
V_33 = F_72 ( V_3 , & V_132 ) ;
if ( V_33 < 0 )
goto V_97;
else
F_73 ( & V_3 -> V_21 , L_27 , F_74 ( V_3 -> V_133 ) ) ;
V_84:
return V_33 ;
V_97:
F_2 ( & V_5 ) ;
...
static int F_76 ( struct V_2 * V_3 , int V_134 )
{
int V_33 = F_30 ( V_3 ) ;
V_3 -> V_135 = V_134 ;
if ( ! V_33 )
...
static int F_77 ( struct V_2 * V_3 , const struct V_136 * V_99 )
{
int V_33 = - V_125 ;
struct V_137 * V_138 ;
struct V_119 * V_120 ;
...
V_33 = F_58 ( V_3 , V_120 , V_145 , & F_76 ) ;
V_97:
return V_33 ;
}
struct V_153 * F_79 ( struct V_2 * V_3 ,
struct V_119 * V_120 ,
int V_121 ,
int (* V_111)( struct V_2 * , int ) )
{
int V_33 = - V_125 ;
V_33 = F_58 ( V_3 , V_120 , V_121 , V_111 ) ;
if ( V_33 < 0 )
goto V_97;
return & V_154 ;
V_97:
...
static int F_85 ( struct V_2 * V_3 , T_8 V_155 )
{
