...
static int F_43 ( struct V_10 * V_11 , struct V_68 * V_69 )
{
struct V_1 * V_2 = F_7 ( V_11 ) ;
...
if ( V_69 == NULL )
return - V_78 ;
V_74 = F_44 ( V_70 , V_71 , V_69 , V_79 ) ;
if ( V_74 < 0 )
return V_74 ;
if ( V_70 [ V_80 ] == NULL ||
V_70 [ V_81 ] == NULL )
return - V_78 ;
V_77 = V_70 [ V_82 ] ? F_45 ( V_70 [ V_82 ] ) : 0 ;
V_73 = F_46 ( V_70 [ V_80 ] ) ;
if ( V_73 -> V_61 > V_83 )
return - V_78 ;
V_76 = F_47 ( V_73 -> V_61 + 1 ) - 1 ;
if ( V_76 != V_2 -> V_5 ) {
struct V_13 * * V_84 ;
V_84 = F_48 ( V_76 + 1 , sizeof( struct V_13 * ) ,
V_85 | V_86 ) ;
if ( ! V_84 )
V_84 = F_49 ( ( V_76 + 1 ) * sizeof( struct V_13 * ) ) ;
if ( ! V_84 )
return - V_87 ;
F_50 ( V_11 ) ;
V_75 = V_2 -> V_9 ;
...
V_2 -> V_6 = V_73 -> V_6 ;
V_2 -> V_61 = V_73 -> V_61 ;
F_51 ( & V_2 -> V_43 , V_73 -> V_49 , V_73 -> V_54 , V_73 -> V_89 ,
V_73 -> V_90 , V_73 -> V_91 ,
F_46 ( V_70 [ V_81 ] ) ,
V_77 ) ;
F_52 ( & V_2 -> V_47 ) ;
...
static int F_54 ( struct V_10 * V_11 , struct V_68 * V_69 )
{
return F_43 ( V_11 , V_69 ) ;
}
static int F_55 ( struct V_10 * V_11 , struct V_13 * V_14 )
{
struct V_1 * V_2 = F_7 ( V_11 ) ;
...
if ( V_92 == NULL )
goto V_94;
if ( F_57 ( V_14 , V_80 , sizeof( V_69 ) , & V_69 ) ||
F_58 ( V_14 , V_82 , V_2 -> V_43 . V_77 ) )
goto V_94;
return F_59 ( V_14 , V_92 ) ;
V_94:
F_60 ( V_14 , V_92 ) ;
return - V_95 ;
}
static int F_61 ( struct V_10 * V_11 , struct V_96 * V_97 )
{
struct V_1 * V_2 = F_7 ( V_11 ) ;
struct V_98 V_99 = {
...
return F_62 ( V_97 , & V_99 , sizeof( V_99 ) ) ;
}
...
static struct V_10 * F_65 ( struct V_10 * V_11 , unsigned long V_102 )
{
return NULL ;
}
static unsigned long F_66 ( struct V_10 * V_11 , T_2 V_20 )
{
return 0 ;
}
static void F_67 ( struct V_10 * V_2 , unsigned long V_103 )
{
}
static unsigned long F_68 ( struct V_10 * V_11 , unsigned long V_104 ,
T_2 V_20 )
{
return 0 ;
}
static struct V_105 * * F_69 ( struct V_10 * V_11 , unsigned long V_103 )
{
struct V_1 * V_2 = F_7 ( V_11 ) ;
if ( V_103 )
return NULL ;
...
static int F_70 ( struct V_10 * V_11 , unsigned long V_103 ,
struct V_13 * V_14 , struct V_106 * V_107 )
{
V_107 -> V_108 |= F_20 ( V_103 ) ;
return 0 ;
}
static void F_71 ( struct V_10 * V_11 , struct V_109 * V_102 )
{
if ( ! V_102 -> V_110 ) {
...
static struct V_13 * F_72 ( struct V_10 * V_11 )
{
struct V_1 * V_2 = F_7 ( V_11 ) ;
