...
struct V_18 * V_19 = V_18 -> V_19 ;
struct V_82 * V_83 = F_11 ( V_19 ) ;
F_108 ( struct V_145 * , V_199 , V_198 -> V_200 ) ;
struct V_145 V_178 ;
struct V_1 * V_2 ;
unsigned char * V_201 ;
...
F_60 ( V_19 ) ;
V_2 = F_110 ( V_19 , V_205 , V_202 , & V_8 ) ;
F_59 ( V_19 ) ;
if ( ! V_2 )
goto V_70;
F_111 ( V_2 ) -> V_74 = V_198 -> V_203 ;
F_112 ( V_2 , V_215 + V_216 ) ;
F_77 ( V_19 , L_4 ) ;
F_113 ( V_2 ) ;
F_114 ( V_2 , V_6 ) ;
V_8 = F_115 ( F_116 ( V_2 ) , V_198 -> V_217 , V_6 ) ;
if ( V_8 )
goto V_218;
...
static int F_120 ( struct V_195 * V_196 , struct V_61 * V_18 ,
struct V_197 * V_198 , T_2 V_205 ,
int V_74 )
{
struct V_18 * V_19 = V_18 -> V_19 ;
struct V_82 * V_83 = F_11 ( V_19 ) ;
F_108 ( struct V_145 * , V_178 , V_198 -> V_200 ) ;
T_2 V_225 ;
int V_206 , V_226 ;
struct V_1 * V_2 ;
unsigned char * V_201 ;
...
V_198 -> V_203 |= V_208 ;
V_8 = F_123 ( V_2 , 0 , V_198 -> V_217 , V_225 ) ;
if ( V_8 )
goto V_228;
if ( V_178 ) {
V_178 -> V_147 = V_84 ;
V_178 -> V_148 = V_83 -> V_78 ;
V_198 -> V_213 = sizeof( * V_178 ) ;
}
F_124 ( V_19 ) ;
V_8 = V_225 ;
V_228:
...
static int F_126 ( struct V_61 * V_18 , unsigned int V_230 , unsigned long V_231 )
{
struct V_18 * V_19 = V_18 -> V_19 ;
struct V_82 * V_83 = F_11 ( V_19 ) ;
...
struct V_182 V_111 ;
V_8 = - V_72 ;
if ( F_133 ( & V_111 , V_232 , sizeof( V_111 ) ) )
break;
V_8 = - V_71 ;
F_59 ( V_19 ) ;
if ( V_19 -> V_45 != V_46 &&
...
struct V_183 V_265 ;
V_8 = - V_72 ;
if ( F_133 ( & V_265 , V_232 , sizeof( V_265 ) ) )
break;
V_8 = - V_71 ;
F_59 ( V_19 ) ;
if ( V_19 -> V_45 != V_46 &&
...
struct V_270 V_48 ;
V_8 = - V_72 ;
if ( F_133 ( & V_48 , V_232 , sizeof( V_48 ) ) )
break;
V_8 = - V_71 ;
if ( V_48 . V_193 > V_186 )
break;
...
struct V_274 V_272 ;
V_8 = - V_72 ;
if ( F_133 ( & V_272 , V_232 , sizeof( V_272 ) ) )
break;
F_59 ( V_19 ) ;
V_83 -> V_272 = V_272 ;
F_60 ( V_19 ) ;
...
static int F_134 ( unsigned int V_230 ,
...
int V_8 = - V_71 ;
V_8 = - V_72 ;
if ( F_133 ( & V_285 , V_284 , sizeof( * V_284 ) ) )
goto V_70;
V_8 = - V_71 ;
V_22 = F_135 ( V_285 . V_286 ) ;
if ( V_22 == NULL )
goto V_70;
V_31 = F_19 ( V_22 ) ;
if ( V_31 == NULL )
...
static int F_137 ( struct V_61 * V_18 , unsigned int V_230 ,
unsigned long V_231 )
{
void T_1 * V_232 = F_138 ( V_231 ) ;
struct V_18 * V_19 = V_18 -> V_19 ;
int V_8 = - V_282 ;
switch( V_230 ) {
case V_233 :
case V_235 :
V_8 = F_126 ( V_18 , V_230 , ( unsigned long ) V_232 ) ;
break;
case V_236 :
V_8 = - V_71 ;
if ( V_19 )
