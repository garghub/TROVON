...
V_34 -> V_37 = V_2 ;
V_18 = F_25 ( V_48 , & V_2 -> V_15 , & V_45 , V_52 ) ;
if ( V_18 )
goto V_66;
V_2 -> V_32 = V_32 ;
V_2 -> V_51 = V_51 ;
...
V_34 -> V_75 -> V_76 [ 0 ] . V_16 = F_28 ( V_48 -> V_60 , 0 ) ;
V_34 -> V_75 -> V_76 [ 0 ] . V_51 = F_29 ( V_48 -> V_60 , 0 ) ;
F_30 ( V_34 , V_58 -> V_31 [ 0 ] , V_58 -> V_50 ) ;
F_31 ( V_34 , & V_2 -> V_49 , V_56 -> V_77 , V_56 -> V_78 ) ;
V_34 -> V_79 = V_32 ;
V_34 -> V_80 = V_51 ;
V_34 -> V_81 . V_24 = V_82 ;
F_32 ( L_4 ,
...
static void F_33 ( struct V_83 * V_84 , T_2 V_85 , T_2 V_86 ,
T_2 V_87 , int V_88 )
{
struct V_89 * V_89 = F_34 ( V_84 ) ;
V_89 -> V_90 [ V_88 ] = V_85 >> 8 ;
V_89 -> V_91 [ V_88 ] = V_86 >> 8 ;
V_89 -> V_92 [ V_88 ] = V_87 >> 8 ;
}
static void F_35 ( struct V_83 * V_84 , T_2 * V_85 , T_2 * V_86 ,
T_2 * V_87 , int V_88 )
{
struct V_89 * V_89 = F_34 ( V_84 ) ;
...
struct V_1 * V_2 ;
int V_18 ;
V_2 = F_46 ( sizeof( struct V_1 ) , V_98 ) ;
if ( ! V_2 )
return - V_65 ;
V_96 -> V_67 = V_2 ;
V_2 -> V_49 . V_99 = & V_100 ;
...
void F_54 ( struct V_47 * V_48 , int V_101 )
{
struct V_95 * V_96 = V_48 -> V_97 ;
if ( ! V_96 -> V_67 )
return;
F_55 ( V_96 -> V_67 -> V_49 . V_67 , V_101 ) ;
}
