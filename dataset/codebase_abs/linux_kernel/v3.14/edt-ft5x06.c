...
return error ;
if ( F_45 ( V_103 -> V_110 ) ) {
error = F_46 ( & V_2 -> V_22 , V_103 -> V_110 ,
V_111 , L_25 ) ;
if ( error ) {
F_13 ( & V_2 -> V_22 ,
L_26 ,
...
V_19 = F_55 ( & V_2 -> V_22 , sizeof( * V_19 ) , V_64 ) ;
if ( ! V_19 ) {
F_13 ( & V_2 -> V_22 , L_27 ) ;
return - V_65 ;
}
...
V_36 -> V_53 = V_19 -> V_53 ;
V_36 -> V_30 . V_112 = V_113 ;
V_36 -> V_22 . V_114 = & V_2 -> V_22 ;
F_58 ( V_115 , V_36 -> V_116 ) ;
F_58 ( V_117 , V_36 -> V_116 ) ;
F_58 ( V_118 , V_36 -> V_116 ) ;
F_58 ( V_119 , V_36 -> V_120 ) ;
F_59 ( V_36 , V_121 , 0 , V_19 -> V_62 * 64 - 1 , 0 , 0 ) ;
F_59 ( V_36 , V_122 , 0 , V_19 -> V_63 * 64 - 1 , 0 , 0 ) ;
F_59 ( V_36 , V_38 ,
0 , V_19 -> V_62 * 64 - 1 , 0 , 0 ) ;
F_59 ( V_36 , V_39 ,
0 , V_19 -> V_63 * 64 - 1 , 0 , 0 ) ;
error = F_60 ( V_36 , V_32 , 0 ) ;
if ( error ) {
F_13 ( & V_2 -> V_22 , L_31 ) ;
return error ;
}
...
error = F_64 ( & V_2 -> V_22 . V_125 , & V_126 ) ;
if ( error )
return error ;
error = F_65 ( V_36 ) ;
if ( error ) {
F_66 ( & V_2 -> V_22 . V_125 , & V_126 ) ;
return error ;
}
F_38 ( V_19 , F_67 ( & V_2 -> V_22 ) ) ;
F_68 ( & V_2 -> V_22 , 1 ) ;
F_34 ( & V_2 -> V_22 ,
L_33 ,
V_103 -> V_110 , V_103 -> V_96 ) ;
return 0 ;
}
...
static int F_70 ( struct V_25 * V_22 )
{
struct V_1 * V_2 = F_15 ( V_22 ) ;
if ( F_71 ( V_22 ) )
F_72 ( V_2 -> V_23 ) ;
