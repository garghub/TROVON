...
{
const bool V_246 = V_119 -> V_43 & V_247 ;
V_119 -> V_43 &= ~ V_247 ;
#ifdef F_88
V_119 -> V_43 |= V_246 ? 0 : V_248 ;
#else
V_119 -> V_43 |= V_246 ? V_248 : 0 ;
#endif
if ( V_119 -> V_43 & V_248 && ! F_89 ( V_119 ) ) {
F_90 ( L_6
L_7 , V_119 -> V_15 . V_121 ) ;
return - V_249 ;
} else if ( ! ( V_119 -> V_43 & V_248 ) && F_89 ( V_119 ) ) {
F_90 ( L_8
L_7 , V_119 -> V_15 . V_121 ) ;
return - V_249 ;
}
...
static bool F_91 ( struct V_250 * V_251 , struct V_250 * V_252 )
{
if ( V_251 -> V_253 == V_252 -> V_253 )
return true ;
if ( V_251 -> V_253 > V_252 -> V_253 && V_251 -> V_253 < V_252 -> V_253 + V_252 -> V_39 )
return true ;
return false ;
}
static bool F_92 ( struct V_254 * V_255 ,
struct V_254 * V_256 )
{
int V_35 , V_36 ;
if ( ! V_256 || ! V_255 )
return false ;
for ( V_35 = 0 ; V_35 < V_256 -> V_7 ; ++ V_35 ) {
struct V_250 * V_75 = & V_256 -> V_257 [ V_35 ] ;
for ( V_36 = 0 ; V_36 < V_255 -> V_7 ; ++ V_36 ) {
struct V_250 * V_258 = & V_255 -> V_257 [ V_36 ] ;
F_58 ( V_259 L_9 ,
( unsigned long long ) V_258 -> V_253 ,
( unsigned long long ) V_258 -> V_39 ,
( unsigned long long ) V_75 -> V_253 ,
...
static int F_93 ( struct V_254 * V_260 ,
const char * V_261 , bool V_262 )
{
int V_35 , V_162 ;
...
if ( ! V_6 [ V_35 ] )
continue;
if ( ! ( V_6 [ V_35 ] -> V_43 & V_264 ) )
continue;
V_263 = V_6 [ V_35 ] -> V_265 ;
if ( F_92 ( V_263 , V_260 ) ||
( V_262 && V_263 && V_263 -> V_7 &&
V_263 -> V_257 [ 0 ] . V_253 == V_266 ) ) {
F_58 ( V_267 L_10
L_11 ,
V_261 , V_6 [ V_35 ] -> V_15 . V_121 ) ;
V_162 = F_94 ( V_6 [ V_35 ] ) ;
if ( V_162 )
return V_162 ;
}
...
F_98 ( & V_1 -> V_11 ) ;
F_98 ( & V_1 -> V_238 ) ;
V_1 -> V_270 = F_99 ( V_271 , V_1 -> V_272 ,
F_100 ( V_273 , V_35 ) , NULL , L_5 , V_35 ) ;
if ( F_101 ( V_1 -> V_270 ) ) {
F_58 ( V_181 L_12 , V_35 , F_102 ( V_1 -> V_270 ) ) ;
V_1 -> V_270 = NULL ;
} else
F_103 ( V_1 ) ;
if ( V_1 -> V_274 . V_42 == NULL ) {
V_1 -> V_274 . V_42 = F_26 ( V_275 , V_102 ) ;
if ( V_1 -> V_274 . V_42 ) {
V_1 -> V_274 . V_39 = V_275 ;
V_1 -> V_274 . V_41 = 1 ;
V_1 -> V_274 . V_276 = 1 ;
V_1 -> V_274 . V_277 = 32 ;
V_1 -> V_274 . V_43 = V_278 ;
}
}
V_1 -> V_274 . V_24 = 0 ;
if ( ! V_1 -> V_274 . V_279 )
V_1 -> V_274 . V_279 = ~ ( T_2 ) 0 ;
if ( ! V_1 -> V_274 . V_280 )
V_1 -> V_274 . V_280 = ~ ( T_2 ) 0 ;
if ( ! V_1 -> V_168 . V_183 || ! V_1 -> V_168 . V_184 )
F_104 ( & V_1 -> V_168 ) ;
if ( V_1 -> V_281 )
F_105 ( V_1 -> V_270 , false ) ;
else
F_105 ( V_1 -> V_270 , true ) ;
F_55 ( & V_179 , & V_1 -> V_13 ) ;
...
return - V_147 ;
if ( V_1 -> V_270 ) {
F_110 ( V_271 , F_100 ( V_273 , V_35 ) ) ;
V_1 -> V_270 = NULL ;
}
return 0 ;
}
int F_111 ( struct V_254 * V_260 ,
const char * V_261 , bool V_262 )
{
int V_162 ;
F_3 ( & V_5 ) ;
V_162 = F_93 ( V_260 , V_261 , V_262 ) ;
F_5 ( & V_5 ) ;
return V_162 ;
}
int
...
void F_114 ( struct V_1 * V_10 , int V_95 )
{
struct V_154 V_155 ;
V_155 . V_10 = V_10 ;
if ( V_95 ) {
...
F_115 ( void )
{
F_116 ( L_13 , 0 , NULL , & V_288 ) ;
if ( F_117 ( V_273 , L_13 , & V_289 ) )
F_58 ( L_14 , V_273 ) ;
V_271 = F_118 ( V_290 , L_15 ) ;
if ( F_101 ( V_271 ) ) {
F_58 ( V_181 L_16 , F_102 ( V_271 ) ) ;
V_271 = NULL ;
}
return 0 ;
}
...
int V_132 = 1 ;
F_124 (pos, n, &info->modelist) {
V_168 = F_125 ( V_117 , struct V_292 , V_293 ) ;
V_116 = & V_168 -> V_179 ;
F_126 ( & V_13 , V_116 ) ;
V_13 . V_153 = V_294 ;
...
if ( ! F_59 ( & V_10 -> V_168 ) ) {
V_155 . V_10 = V_10 ;
V_132 = F_53 ( V_295 , & V_155 ) ;
}
return V_132 ;
}
int F_128 ( const char * V_261 , char * * V_296 )
{
char * V_297 , * V_298 = NULL ;
int V_299 = 0 ;
int V_300 = strlen ( V_261 ) , V_35 ;
if ( V_300 && V_301 && strncmp ( V_261 , L_17 , 4 ) )
V_299 = 1 ;
if ( V_300 && ! V_299 ) {
for ( V_35 = 0 ; V_35 < V_3 ; V_35 ++ ) {
if ( V_302 [ V_35 ] == NULL )
...
continue;
V_297 = V_302 [ V_35 ] ;
if ( ! strncmp ( V_261 , V_297 , V_300 ) &&
V_297 [ V_300 ] == ':' )
V_298 = V_297 + V_300 + 1 ;
}
}
if ( ! V_298 && V_296 && V_303 )
V_298 = F_129 ( V_303 , V_102 ) ;
...
static int T_11 F_130 ( char * V_298 )
{
int V_35 , V_304 = 0 ;
if ( ! V_298 || ! * V_298 )
V_304 = 1 ;
if ( ! V_304 && ! strncmp ( V_298 , L_19 , 6 ) ) {
V_301 = 1 ;
V_304 = 1 ;
}
if ( ! V_304 && ! strchr ( V_298 , ':' ) ) {
V_303 = V_298 ;
V_304 = 1 ;
}
if ( ! V_304 ) {
