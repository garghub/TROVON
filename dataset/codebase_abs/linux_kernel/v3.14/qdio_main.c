...
if ( V_40 != V_11 -> V_98 ) {
V_11 -> V_98 = V_40 ;
if ( ! F_48 ( V_11 -> V_25 ) && V_99 )
V_11 -> V_63 . T_4 . V_90 = F_49 () ;
return 1 ;
} else
return 0 ;
}
...
static inline unsigned long F_53 ( struct V_109 * V_11 ,
int V_40 )
{
...
static int F_66 ( struct V_10 * V_11 , unsigned long V_9 )
{
int V_61 = 0 , V_6 ;
unsigned int V_58 ;
if ( ! F_67 ( V_11 ) )
...
F_56 ( V_11 ) ;
if ( F_28 ( V_11 ) == V_134 )
if ( ! F_32 ( V_11 ) && ! F_64 ( V_11 ) )
goto V_135;
if ( V_11 -> V_63 . T_3 . V_136 )
return;
if ( F_64 ( V_11 ) )
F_70 ( & V_11 -> V_63 . T_3 . V_137 ) ;
else
if ( ! F_71 ( & V_11 -> V_63 . T_3 . V_137 ) )
F_72 ( & V_11 -> V_63 . T_3 . V_137 , V_138 + 10 * V_139 ) ;
return;
V_135:
...
void F_78 ( unsigned long V_123 )
{
struct V_10 * V_11 = (struct V_10 * ) V_123 ;
F_76 ( V_11 ) ;
}
static inline void F_79 ( struct V_48 * V_25 ,
enum V_140 V_14 )
{
...
static void F_81 ( struct V_48 * V_25 , struct V_141 * V_141 )
{
...
if ( F_64 ( V_11 ) )
continue;
if ( F_35 ( V_11 ) && F_85 ( V_11 ) )
F_26 ( V_11 ) ;
F_60 ( & V_11 -> V_121 ) ;
}
}
static void F_86 ( struct V_155 * V_32 ,
...
static void F_89 ( struct V_155 * V_32 , int V_157 ,
int V_158 )
{
struct V_48 * V_25 = V_32 -> V_159 -> V_160 ;
F_10 ( V_37 , V_25 , L_42 ) ;
...
void F_90 ( struct V_155 * V_32 , unsigned long V_156 ,
struct V_141 * V_141 )
{
struct V_48 * V_25 = V_32 -> V_159 -> V_160 ;
int V_157 , V_158 ;
...
int F_93 ( struct V_155 * V_32 ,
struct V_178 * V_123 )
{
if ( ! V_32 || ! V_32 -> V_159 )
return - V_179 ;
F_94 ( L_46 , V_32 -> V_159 -> V_1 . V_146 ) ;
return F_95 ( NULL , & V_32 -> V_159 -> V_1 , V_123 ) ;
}
static void F_96 ( struct V_155 * V_32 )
{
struct V_48 * V_25 = V_32 -> V_159 -> V_160 ;
struct V_10 * V_11 ;
int V_43 ;
...
int F_98 ( struct V_155 * V_32 , int V_180 )
{
struct V_48 * V_25 = V_32 -> V_159 -> V_160 ;
int V_18 ;
unsigned long V_107 ;
...
return - V_181 ;
F_13 ( F_99 () ) ;
F_94 ( L_47 , V_32 -> V_159 -> V_1 . V_146 ) ;
F_100 ( & V_25 -> V_182 ) ;
if ( V_25 -> V_14 == V_175 ) {
F_101 ( & V_25 -> V_182 ) ;
return 0 ;
...
F_96 ( V_32 ) ;
F_103 ( V_25 ) ;
F_104 ( F_105 ( V_32 ) , V_107 ) ;
if ( V_180 & V_183 )
V_18 = F_106 ( V_32 , V_184 ) ;
else
...
F_79 ( V_25 , V_176 ) ;
F_108 ( F_105 ( V_32 ) , V_107 ) ;
F_109 ( V_32 -> V_159 -> V_172 ,
V_25 -> V_14 == V_175 ||
V_25 -> V_14 == V_169 ,
10 * V_139 ) ;
F_104 ( F_105 ( V_32 ) , V_107 ) ;
...
int F_111 ( struct V_155 * V_32 )
{
struct V_48 * V_25 = V_32 -> V_159 -> V_160 ;
if ( ! V_25 )
return - V_181 ;
F_94 ( L_50 , V_32 -> V_159 -> V_1 . V_146 ) ;
F_100 ( & V_25 -> V_182 ) ;
if ( V_25 -> V_187 != NULL ) {
F_112 ( V_25 -> V_187 ) ;
V_25 -> V_187 = NULL ;
...
int F_114 ( struct V_188 * V_189 )
{
struct V_48 * V_25 ;
F_94 ( L_51 , V_189 -> V_32 -> V_159 -> V_1 . V_146 ) ;
if ( ( V_189 -> V_190 && ! V_189 -> V_191 ) ||
( V_189 -> V_192 && ! V_189 -> V_193 ) )
return - V_179 ;
if ( ( V_189 -> V_190 > V_194 ) ||
( V_189 -> V_192 > V_194 ) )
return - V_179 ;
if ( ( ! V_189 -> V_195 ) ||
( ! V_189 -> V_196 ) )
return - V_179 ;
V_25 = ( void * ) F_115 ( V_197 | V_198 ) ;
if ( ! V_25 )
goto V_199;
F_116 ( & V_25 -> V_182 ) ;
F_117 ( V_189 , V_25 ) ;
V_25 -> V_200 = F_115 ( V_197 ) ;
if ( ! V_25 -> V_200 )
goto V_201;
V_25 -> V_202 = (struct V_202 * ) F_115 ( V_197 | V_198 ) ;
if ( ! V_25 -> V_202 )
goto V_201;
if ( F_118 ( V_25 , V_189 -> V_190 ,
V_189 -> V_192 ) )
goto V_201;
V_189 -> V_32 -> V_159 -> V_160 = V_25 ;
F_79 ( V_25 , V_175 ) ;
return 0 ;
V_201:
F_113 ( V_25 ) ;
...
int F_122 ( struct V_188 * V_189 )
{
struct V_48 * V_25 ;
struct V_155 * V_32 = V_189 -> V_32 ;
unsigned long V_204 ;
int V_18 ;
F_94 ( L_53 , V_32 -> V_159 -> V_1 . V_146 ) ;
V_25 = V_32 -> V_159 -> V_160 ;
if ( ! V_25 )
return - V_181 ;
if ( V_32 -> V_159 -> V_14 != V_205 )
return - V_179 ;
F_100 ( & V_25 -> V_182 ) ;
F_123 ( V_189 ) ;
V_18 = F_124 ( V_25 ) ;
...
V_25 -> V_206 . V_207 = V_25 -> V_208 . V_174 ;
V_25 -> V_206 . V_107 = V_209 ;
V_25 -> V_206 . V_16 = V_25 -> V_208 . V_16 ;
V_25 -> V_206 . V_210 = ( V_54 ) ( ( V_211 ) V_25 -> V_202 ) ;
F_104 ( F_105 ( V_32 ) , V_204 ) ;
F_125 ( V_32 , 0 ) ;
V_18 = F_126 ( V_32 , & V_25 -> V_206 , V_212 , 0 , 0 ) ;
if ( V_18 ) {
F_5 ( L_54 , V_25 -> V_1 . V_146 ) ;
F_5 ( L_55 , V_18 ) ;
}
F_108 ( F_105 ( V_32 ) , V_204 ) ;
if ( V_18 ) {
F_101 ( & V_25 -> V_182 ) ;
F_98 ( V_32 , V_183 ) ;
return V_18 ;
...
int V_18 ;
unsigned long V_204 ;
F_94 ( L_56 , V_32 -> V_159 -> V_1 . V_146 ) ;
V_25 = V_32 -> V_159 -> V_160 ;
if ( ! V_25 )
return - V_181 ;
if ( V_32 -> V_159 -> V_14 != V_205 )
...
V_25 -> V_206 . V_207 = V_25 -> V_213 . V_174 ;
V_25 -> V_206 . V_107 = V_209 ;
V_25 -> V_206 . V_16 = V_25 -> V_213 . V_16 ;
V_25 -> V_206 . V_210 = 0 ;
F_104 ( F_105 ( V_32 ) , V_204 ) ;
F_131 ( V_32 , V_214 ) ;
V_18 = F_126 ( V_32 , & V_25 -> V_206 , V_215 ,
0 , V_216 ) ;
if ( V_18 ) {
...
static int F_135 ( struct V_10 * V_11 , unsigned int V_217 ,
int V_40 , int V_16 )
{
int V_218 ;
F_8 ( V_11 , V_219 ) ;
...
if ( F_15 ( V_11 ) ) {
V_218 = F_40 ( V_40 , V_16 ) ;
V_218 = F_57 ( V_218 , V_11 -> V_63 . T_4 . V_72 ) ;
V_11 -> V_63 . T_4 . V_73 -= V_218 ;
if ( V_11 -> V_63 . T_4 . V_73 <= 0 ) {
V_11 -> V_63 . T_4 . V_70 = 0 ;
V_11 -> V_63 . T_4 . V_73 = 0 ;
goto V_86;
}
V_11 -> V_63 . T_4 . V_72 = F_40 ( V_11 -> V_63 . T_4 . V_72 , V_218 ) ;
}
else
V_11 -> V_63 . T_4 . V_70 = 0 ;
}
...
static int F_138 ( struct V_10 * V_11 , unsigned int V_217 ,
int V_40 , int V_16 )
{
unsigned char V_14 = 0 ;
int V_220 , V_18 = 0 ;
...
if ( F_28 ( V_11 ) == V_66 ) {
unsigned long V_110 = 0 ;
F_13 ( V_16 > 1 && ! F_63 ( V_11 ) ) ;
V_110 = F_53 ( & V_11 -> V_63 . T_3 , V_40 ) ;
V_18 = F_66 ( V_11 , V_110 ) ;
} else if ( F_35 ( V_11 ) ) {
V_18 = F_26 ( V_11 ) ;
} else {
...
if ( V_220 >= V_11 -> V_63 . T_3 . V_226 || V_18 )
F_60 ( & V_11 -> V_121 ) ;
else
if ( ! F_71 ( & V_11 -> V_63 . T_3 . V_137 ) )
F_72 ( & V_11 -> V_63 . T_3 . V_137 , V_138 + V_139 ) ;
return V_18 ;
}
int F_141 ( struct V_155 * V_32 , unsigned int V_217 ,
int V_227 , unsigned int V_40 , unsigned int V_16 )
{
struct V_48 * V_25 ;
...
return - V_181 ;
F_10 ( V_37 , V_25 ,
L_58 , V_217 , V_40 , V_16 ) ;
if ( V_25 -> V_14 != V_115 )
return - V_13 ;
if ( ! V_16 )
return 0 ;
if ( V_217 & V_228 )
return F_135 ( V_25 -> V_161 [ V_227 ] ,
V_217 , V_40 , V_16 ) ;
else if ( V_217 & V_229 )
return F_138 ( V_25 -> V_163 [ V_227 ] ,
V_217 , V_40 , V_16 ) ;
return - V_179 ;
}
...
int F_148 ( struct V_231 V_1 ,
int V_232 , T_8 * V_233 ,
void (* F_149)( void * V_234 , enum V_235 type ,
void * V_236 ) ,
void * V_234 )
{
struct V_237 * V_238 ;
...
V_54 V_239 = 0 ;
int V_240 = 1 ;
int V_43 , V_241 , V_242 ;
V_238 = (struct V_237 * ) F_115 ( V_197 ) ;
if ( V_238 == NULL )
return - V_203 ;
do {
V_18 = F_150 ( V_1 , V_238 , V_238 -> V_243 . V_244 , V_232 ) ;
if ( V_18 != 0 && V_18 != - V_131 )
goto T_3;
if ( V_238 -> V_233 . V_245 != 1 ) {
V_18 = - V_13 ;
continue;
} else
V_18 = 0 ;
if ( F_149 == NULL )
continue;
V_241 = V_238 -> V_243 . V_246 ;
V_242 = ( V_238 -> V_233 . V_247 -
sizeof( struct V_248 ) -
sizeof( struct V_249 ) ) /
V_241 ;
if ( ! V_240 && ( V_238 -> V_243 . V_250 != V_239 ) ) {
V_18 = - V_251 ;
break;
}
V_240 = 0 ;
V_239 = V_238 -> V_243 . V_250 ;
for ( V_43 = 0 ; V_43 < V_242 ; V_43 ++ )
switch ( V_241 ) {
case sizeof( struct V_252 ) :
(* F_149)( V_234 , V_253 ,
& V_238 -> V_254 . V_255 [ V_43 ] ) ;
break;
case sizeof( struct V_256 ) :
(* F_149)( V_234 , V_257 ,
& V_238 -> V_254 . V_258 [ V_43 ] ) ;
break;
case sizeof( struct V_259 ) :
(* F_149)( V_234 , V_260 ,
& V_238 -> V_254 . V_261 [ V_43 ] ) ;
break;
default:
F_13 ( 1 ) ;
V_18 = - V_13 ;
...
} while ( V_238 -> V_233 . V_245 == 0x0107 ||
( V_238 -> V_233 . V_245 == 1 &&
( V_238 -> V_243 . V_244 . V_262 || V_238 -> V_243 . V_244 . V_263 ) ) );
( * V_233 ) = V_238 -> V_233 . V_245 ;
T_3:
F_151 ( ( unsigned long ) V_238 ) ;
return V_18 ;
}
