...
if ( V_39 -> V_317 == V_39 ) {
V_15 = F_125 ( V_39 , V_92 , & V_52 . V_326 ) ;
if ( V_15 )
goto V_198;
V_15 = V_39 -> V_59 -> V_370 ( V_39 , V_92 ,
F_123 ( V_39 -> V_285 , V_52 . V_326 ) , & V_56 ) ;
} else {
V_15 = F_126 ( V_39 , V_92 , F_123 ( V_39 -> V_285 , V_52 . V_326 ) ) ;
}
F_39 ( V_39 ) ;
if ( V_15 )
goto V_198;
...
V_378 = F_67 ( F_131 ( sizeof *V_378 , sizeof ( struct V_389 ) ) +
...
F_131 ( sizeof *V_378 , sizeof ( struct V_389 ) ) ;
if ( F_46 ( V_378 -> V_408 ,
V_49 + sizeof V_52 +
...
static struct V_410 * F_132 ( const char T_3 * V_49 ,
int V_50 ,
T_5 V_384 ,
T_5 V_385 ,
T_5 V_383 )
...
F_141 (mcast, &obj->mcast_list, list)
...
V_15 = F_142 ( V_39 , & V_420 -> V_422 , V_52 . V_421 ) ;
if ( ! V_15 )
...
if ( ! V_39 )
return - V_65 ;
V_15 = F_144 ( V_39 , (union V_423 * ) V_52 . V_422 , V_52 . V_421 ) ;
if ( V_15 )
goto V_273;
V_181 = F_7 ( V_39 -> V_27 , struct V_279 , V_289 . V_27 ) ;
F_141 (mcast, &obj->mcast_list, list)
...
static int F_145 ( struct V_424 * V_425 ,
union V_426 * V_427 )
{
if ( V_425 -> V_267 )
return - V_65 ;
...
return - V_63 ;
V_66 = F_147 ( & V_52 , V_443 , sizeof( V_52 ) ) ;
if ( V_66 )
return V_66 ;
...
V_52 . V_452 . V_430 > F_148 ( struct V_424 , V_267 ) &&
V_52 . V_452 . V_430 >=
( (struct V_424 * ) V_425 ) -> V_430 ; V_380 ++ ) {
V_66 = F_145 ( V_425 , V_427 ) ;
if ( V_66 )
goto V_81;
V_452 -> V_430 +=
...
if ( V_443 -> V_453 < sizeof( V_52 ) )
return - V_65 ;
V_15 = F_147 ( & V_52 , V_443 , sizeof( V_52 ) ) ;
if ( V_15 )
return V_15 ;
if ( V_52 . V_456 )
return - V_65 ;
