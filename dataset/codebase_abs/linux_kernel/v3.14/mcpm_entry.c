...
int F_7 ( unsigned int V_1 , unsigned int V_2 )
{
if ( ! V_12 )
return - V_14 ;
F_8 () ;
...
int F_15 ( unsigned int V_1 , unsigned int V_2 )
{
int V_20 ;
if ( F_10 ( ! V_12 || ! V_12 -> V_21 ) )
return - V_14 ;
...
void F_19 ( unsigned int V_1 , unsigned int V_2 )
{
...
void F_23 ( unsigned int V_2 , int V_31 )
{
F_21 () ;
...
bool F_24 ( unsigned int V_1 , unsigned int V_2 )
{
unsigned int V_32 ;
...
int F_27 ( unsigned int V_2 )
{
F_25 ( & V_26 . V_27 [ V_2 ] . V_2 ) ;
return V_26 . V_27 [ V_2 ] . V_2 ;
}
int T_1 F_28 (
void (* F_29)( unsigned int V_41 ) )
{
unsigned int V_32 , V_42 , V_43 , V_44 ;
F_30 ( V_45 * V_46 != sizeof V_26 ) ;
F_11 ( ( unsigned long ) & V_26 & ( V_47 - 1 ) ) ;
