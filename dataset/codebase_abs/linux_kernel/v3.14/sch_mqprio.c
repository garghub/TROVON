...
if ( F_34 ( V_50 , V_63 , sizeof( V_28 ) , & V_28 ) )
goto V_64;
return V_50 -> V_65 ;
V_64:
F_35 ( V_50 , V_51 ) ;
...
static struct V_1 * F_36 ( struct V_1 * V_2 , unsigned long V_46 )
{
struct V_29 * V_30 = F_24 ( V_2 , V_46 ) ;
if ( ! V_30 )
return NULL ;
...
static unsigned long F_37 ( struct V_1 * V_2 , T_1 V_67 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
...
static void F_38 ( struct V_1 * V_2 , unsigned long V_46 )
{
}
static int F_39 ( struct V_1 * V_2 , unsigned long V_46 ,
...
if ( F_41 ( V_77 , & V_2 -> V_54 ) < 0 ||
F_42 ( V_77 , & V_2 -> V_55 ) < 0 )
return - 1 ;
}
return 0 ;
}
static void F_43 ( struct V_1 * V_2 , struct V_81 * V_82 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
unsigned long V_7 ;
if ( V_82 -> V_83 )
