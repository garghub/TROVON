...
V_21 -> V_167 = V_25 -> V_53 . V_165 ;
V_2 -> V_168 = V_169 + V_115 ;
V_2 -> V_97 = F_68 ( & V_138 -> V_79 , V_2 -> V_168 ,
V_135 ) ;
if ( V_2 -> V_97 == NULL ) {
V_67 = - V_144 ;
goto V_170;
...
V_2 -> V_107 = ( T_1 * ) ( V_2 -> V_97 + V_169 ) ;
if ( V_21 -> V_46 <= 512 )
V_25 -> V_53 . V_117 = & V_172 ;
V_25 -> V_53 . V_106 = 256 ;
V_25 -> V_53 . V_120 = V_173 ;
V_25 -> V_53 . V_174 = V_25 -> V_53 . V_175 = 0 ;
if ( V_2 -> V_11 -> V_136 ) {
V_25 -> V_176 |= V_177 ;
if ( V_21 -> V_46 <= 512 ) {
V_25 -> V_178 = & V_179 ;
...
V_67 = F_84 ( V_21 , NULL , & V_142 , V_2 -> V_11 -> V_183 ,
V_2 -> V_11 -> V_184 ) ;
if ( ! V_67 )
return V_67 ;
F_85 ( V_21 ) ;
...
static int F_91 ( struct V_137 * V_138 , T_6 V_185 )
{
T_1 V_4 ;
struct V_1 * V_2 = F_89 ( V_138 ) ;
V_4 = F_19 ( F_3 ( V_2 -> V_6 ) ) ;
