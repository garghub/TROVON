...
static int F_79 ( struct V_228 * V_234 , struct V_235 * V_236 )
{
struct V_231 V_229 ;
V_229 . V_237 = strlen ( V_234 -> V_232 ) + 1 ;
V_229 . V_238 = V_234 -> V_233 ;
V_229 . V_239 = V_234 -> type ;
return F_80 ( V_236 , & V_229 , sizeof( V_229 ) ) &&
F_80 ( V_236 , V_234 -> V_232 , V_229 . V_237 ) && F_81 ( V_236 , 4 ) &&
...
memcpy ( V_241 -> V_163 , V_164 , V_165 ) ;
V_241 -> V_163 [ V_244 ] = V_245 ;
V_241 -> V_163 [ V_246 ] = V_247 ;
V_241 -> V_163 [ V_248 ] = V_249 ;
V_241 -> V_163 [ V_250 ] = V_251 ;
V_241 -> V_109 = V_252 ;
V_241 -> V_253 = V_243 ;
V_241 -> V_254 = V_249 ;
...
static void F_83 ( struct V_50 * V_257 , int V_230 , T_9 V_258 )
{
V_257 -> V_98 = V_259 ;
V_257 -> V_92 = V_258 ;
V_257 -> V_90 = 0 ;
...
static void F_84 ( struct V_228 * V_262 , const char * V_232 , int type ,
unsigned int V_230 , void * V_240 )
{
V_262 -> V_232 = V_232 ;
V_262 -> type = type ;
V_262 -> V_233 = V_230 ;
...
static void F_102 ( struct V_228 * V_262 , struct V_292 * V_5 )
{
...
static void F_103 ( struct V_228 * V_262 , T_11 * V_308 ,
const T_12 * V_309 )
{
T_7 V_310 = F_73 () ;
F_75 ( V_311 ) ;
...
static int F_105 ( struct V_228 * V_262 )
{
struct V_37 * V_38 ;
...
struct V_347 * V_348 ,
const T_12 * V_309 , struct V_156 * V_157 )
{
...
V_348 -> V_264 -> V_365 = F_127 ( V_4 , V_157 ,
V_348 -> V_366 ) ;
...
if ( ! F_117 ( V_241 , V_52 , & V_348 , V_236 -> V_309 , V_236 -> V_157 ) )
goto V_398;
V_394 = 1 ;
V_214 = F_73 () ;
F_75 ( V_311 ) ;
...
if ( ! V_396 )
goto V_399;
F_83 ( V_396 , V_230 , V_258 ) ;
V_258 += V_230 ;
}
V_395 = V_258 = F_78 ( V_258 , V_44 ) ;
V_258 += F_141 ( V_380 , V_236 -> V_192 ) ;
V_258 += F_145 () ;
V_384 = V_258 ;
if ( V_52 == V_397 ) {
...
V_257 . V_98 = V_99 ;
V_257 . V_92 = V_258 ;
V_257 . V_90 = V_38 -> V_212 ;
V_257 . V_260 = 0 ;
V_257 . V_89 = F_70 ( V_38 , V_236 -> V_192 ) ;
V_257 . V_100 = V_38 -> V_227 - V_38 -> V_212 ;
V_258 += V_257 . V_89 ;
V_257 . V_125 = V_38 -> V_194 & V_210 ? V_126 : 0 ;
if ( V_38 -> V_194 & V_400 )
V_257 . V_125 |= V_128 ;
if ( V_38 -> V_194 & V_401 )
V_257 . V_125 |= V_130 ;
...
unsigned long V_3 ;
unsigned long V_2 ;
V_2 = V_38 -> V_212 + F_70 ( V_38 , V_236 -> V_192 ) ;
...
V_404 = ! F_80 ( V_236 , V_405 , V_188 ) ;
F_151 ( V_403 ) ;
F_152 ( V_403 ) ;
} else
V_404 = ! F_148 ( V_236 , V_188 ) ;
if ( V_404 )
goto V_399;
}
}
