...
int F_31 ( struct V_11 * V_12 , T_1 V_3 , T_1 V_5 )
{
...
int F_36 ( struct V_11 * V_12 , T_1 V_3 )
{
struct V_1 * V_29 ;
F_32 () ;
V_29 = F_33 ( V_12 -> V_26 ) ;
if ( ! V_29 )
return - V_24 ;
F_37 ( V_12 , NULL , V_12 -> V_14 -> V_21 , V_3 ) ;
F_13 ( V_29 , V_3 ) ;
return 0 ;
}
...
bool F_39 ( struct V_11 * V_12 , T_1 V_3 )
{
struct V_1 * V_29 ;
bool V_39 = false ;
F_40 () ;
...
int F_43 ( struct V_11 * V_12 , unsigned long V_40 )
{
if ( ! F_44 () )
return F_45 () ;
if ( V_12 -> V_31 == V_40 )
...
int F_47 ( struct V_9 * V_19 , T_1 V_3 , T_1 V_5 )
{
struct V_1 * V_29 = NULL ;
int V_15 ;
F_32 () ;
...
int F_48 ( struct V_9 * V_19 , T_1 V_3 )
{
struct V_1 * V_29 ;
F_32 () ;
V_29 = F_33 ( V_19 -> V_26 ) ;
if ( ! V_29 )
return - V_24 ;
F_37 ( V_19 -> V_12 , V_19 , V_19 -> V_14 -> V_21 , V_3 ) ;
return F_13 ( V_29 , V_3 ) ;
}
void F_49 ( struct V_9 * V_19 )
{
struct V_1 * V_29 ;
T_1 V_3 ;
F_32 () ;
...
if ( ! V_29 )
return;
F_50 (vid, pv->vlan_bitmap, VLAN_N_VID)
F_12 ( V_19 -> V_14 , F_9 ( V_20 ) , V_3 ) ;
F_18 ( V_29 ) ;
}
bool F_51 ( struct V_9 * V_19 , T_1 V_3 )
{
struct V_1 * V_29 ;
bool V_39 = false ;
F_40 () ;
