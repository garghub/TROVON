...
V_2 -> V_23 -> V_6 = V_2 -> V_24 ;
if ( F_7 ( V_2 -> V_23 , V_25 ) )
return - V_26 ;
return 0 ;
}
...
static int F_13 ( struct V_27 * V_13 , const struct V_28 * V_29 )
{
struct V_30 * V_6 = F_14 ( V_13 ) ;
struct V_31 * V_32 ;
struct V_2 * V_2 ;
struct V_5 * V_5 ;
int error = - V_33 ;
V_2 = F_15 ( sizeof( struct V_2 ) , V_25 ) ;
V_5 = F_16 () ;
if ( ! V_2 || ! V_5 )
goto V_34;
V_2 -> V_4 = F_17 ( V_6 , 8 , V_25 , & V_2 -> V_35 ) ;
if ( ! V_2 -> V_4 )
goto V_34;
V_2 -> V_23 = F_18 ( 0 , V_25 ) ;
if ( ! V_2 -> V_23 )
goto V_36;
V_2 -> V_24 = V_6 ;
V_2 -> V_13 = V_13 ;
...
F_36 ( V_2 -> V_6 ) ;
F_30 ( V_2 -> V_23 ) ;
F_31 ( V_2 -> V_24 , 8 , V_2 -> V_4 , V_2 -> V_35 ) ;
F_33 ( V_2 ) ;
}
