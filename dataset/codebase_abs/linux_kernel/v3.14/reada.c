...
V_92 -> V_90 . V_101 = F_55 ;
V_92 -> V_15 = V_15 ;
F_63 ( & V_15 -> V_102 , & V_92 -> V_90 ) ;
}
static void F_64 ( struct V_14 * V_15 , int V_103 )
{
struct V_20 * V_59 ;
struct V_96 * V_97 = V_15 -> V_97 ;
unsigned long V_18 ;
...
F_72 ( V_36 -> V_43 , F_61 ( & V_36 -> V_41 ) == 0 ,
5 * V_114 ) ;
F_64 ( V_36 -> V_2 -> V_15 ,
F_61 ( & V_36 -> V_41 ) < 10 ? 1 : 0 ) ;
}
F_64 ( V_36 -> V_2 -> V_15 , F_61 ( & V_36 -> V_41 ) < 10 ? 1 : 0 ) ;
F_23 ( & V_36 -> V_24 , V_42 ) ;
return 0 ;
}
int F_71 ( void * V_113 )
