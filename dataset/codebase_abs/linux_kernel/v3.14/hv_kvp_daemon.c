...
F_52 ( L_59 , 0 , V_195 ) ;
F_4 ( V_196 , L_60 , F_2 () ) ;
V_194 = F_49 ( 0 ) + sizeof( struct V_164 ) + sizeof( struct V_188 ) ;
V_193 = calloc ( 1 , V_194 ) ;
if ( ! V_193 ) {
F_4 ( V_10 , L_61 ) ;
exit ( V_12 ) ;
}
F_17 () ;
F_43 ( V_197 , sizeof( V_197 ) ) ;
if ( F_8 () ) {
F_4 ( V_10 , L_62 ) ;
exit ( V_12 ) ;
}
V_8 = F_53 ( V_198 , V_199 , V_200 ) ;
if ( V_8 < 0 ) {
F_4 ( V_10 , L_63 , V_11 ,
strerror ( V_11 ) ) ;
exit ( V_12 ) ;
...
V_92 . V_203 = 0 ;
V_92 . V_204 = 0 ;
error = F_54 ( V_8 , (struct V_205 * ) & V_92 , sizeof( V_92 ) ) ;
if ( error < 0 ) {
...
V_183 = V_206 ;
if ( F_55 ( V_8 , V_207 , V_208 , & V_183 , sizeof( V_183 ) ) < 0 ) {
F_4 ( V_10 , L_65 , V_11 , strerror ( V_11 ) ) ;
F_12 ( V_8 ) ;
exit ( V_12 ) ;
}
V_172 = (struct V_164 * ) V_193 ;
V_172 -> V_209 . V_210 = V_206 ;
V_172 -> V_209 . V_211 = V_212 ;
V_189 = (struct V_188 * ) V_172 -> V_213 ;
V_189 -> V_214 . V_215 = V_216 ;
V_172 -> V_217 = 0 ;
V_172 -> V_73 = sizeof( struct V_188 ) ;
V_73 = F_48 ( V_8 , V_172 ) ;
if ( V_73 < 0 ) {
F_4 ( V_10 , L_66 , V_11 , strerror ( V_11 ) ) ;
F_12 ( V_8 ) ;
exit ( V_12 ) ;
}
V_185 . V_8 = V_8 ;
while ( 1 ) {
struct V_205 * V_218 = (struct V_205 * ) & V_92 ;
T_4 V_219 = sizeof( V_92 ) ;
V_185 . V_220 = V_221 ;
V_185 . V_222 = 0 ;
if ( F_56 ( & V_185 , 1 , - 1 ) < 0 ) {
F_4 ( V_10 , L_67 , V_11 , strerror ( V_11 ) ) ;
if ( V_11 == V_223 ) {
F_12 ( V_8 ) ;
exit ( V_12 ) ;
}
...
V_73 = F_57 ( V_8 , V_193 , V_194 , 0 ,
V_218 , & V_219 ) ;
if ( V_73 < 0 ) {
F_4 ( V_10 , L_68 ,
V_92 . V_203 , V_11 , strerror ( V_11 ) ) ;
F_12 ( V_8 ) ;
return - 1 ;
}
if ( V_92 . V_203 ) {
...
V_186 = (struct V_166 * ) V_193 ;
if ( V_186 -> V_168 != V_169 )
continue;
V_187 = (struct V_164 * ) F_58 ( V_186 ) ;
V_189 = (struct V_188 * ) V_187 -> V_213 ;
V_103 = V_189 -> V_214 . V_215 ;
V_1 = V_189 -> V_214 . V_1 ;
V_189 -> error = V_225 ;
if ( ( V_226 ) && ( V_103 == V_216 ) ) {
V_226 = 0 ;
V_44 = ( char * ) V_189 -> V_227 . V_228 . V_229 ;
...
switch ( V_103 ) {
case V_123 :
V_192 = & V_189 -> V_227 . V_192 ;
V_64 =
F_25 ( ( char * ) V_192 -> V_231 ) ;
if ( V_64 == NULL ) {
V_189 -> error = V_102 ;
break;
}
...
case V_234 :
if ( F_14 ( V_1 ,
V_189 -> V_227 . V_235 . V_213 . V_34 ,
V_189 -> V_227 . V_235 . V_213 . V_35 ,
V_189 -> V_227 . V_235 . V_213 . V_38 ,
V_189 -> V_227 . V_235 . V_213 . V_39 ) )
V_189 -> error = V_236 ;
break;
case V_237 :
if ( F_15 ( V_1 ,
...
case V_238 :
if ( F_13 ( V_1 ,
V_189 -> V_227 . V_239 . V_34 ,
V_189 -> V_227 . V_239 . V_35 ) )
V_189 -> error = V_236 ;
break;
default:
break;
...
if ( V_1 != V_241 ) {
if ( F_16 ( V_1 ,
V_189 -> V_227 . V_242 . V_42 ,
V_189 -> V_227 . V_242 . V_213 . V_34 ,
V_40 ,
V_189 -> V_227 . V_242 . V_213 . V_38 ,
V_41 ) )
V_189 -> error = V_236 ;
goto V_240;
}
V_189 = (struct V_188 * ) V_187 -> V_213 ;
V_191 = ( char * ) V_189 -> V_227 . V_242 . V_213 . V_34 ;
V_190 = ( char * ) V_189 -> V_227 . V_242 . V_213 . V_38 ;
switch ( V_189 -> V_227 . V_242 . V_42 ) {
case V_243 :
strcpy ( V_190 , V_197 ) ;
strcpy ( V_191 , L_71 ) ;
break;
...
V_240:
V_187 -> V_209 . V_210 = V_206 ;
V_187 -> V_209 . V_211 = V_212 ;
V_187 -> V_217 = 0 ;
V_187 -> V_73 = sizeof( struct V_188 ) ;
V_73 = F_48 ( V_8 , V_187 ) ;
if ( V_73 < 0 ) {
F_4 ( V_10 , L_81 , V_11 ,
strerror ( V_11 ) ) ;
