...
static T_4 * F_41 ( struct V_3 * V_4 , T_4 * V_87 ,
unsigned int * V_88 )
{
int V_16 ;
struct V_32 * V_89 = F_7 ( V_4 ) ;
unsigned char V_90 [] = {
...
if ( ( ( * V_88 - V_16 ) > sizeof( V_90 ) ) &&
! memcmp ( & V_87 [ V_16 ] , V_90 ,
sizeof( V_90 ) ) ) {
V_87 [ V_16 + 4 ] = 0x01 ;
V_16 += sizeof( V_90 ) ;
}
if ( ( ( * V_88 - V_16 ) > sizeof( V_91 ) ) &&
! memcmp ( & V_87 [ V_16 ] , V_91 ,
sizeof( V_91 ) ) ) {
V_87 [ V_16 + 4 ] = 0x01 ;
V_16 += sizeof( V_91 ) ;
}
...
struct V_9 * V_10 ;
int V_96 ;
V_89 = F_43 ( & V_4 -> V_97 , sizeof( * V_89 ) , V_98 ) ;
if ( ! V_89 ) {
F_38 ( V_4 , L_11 ) ;
return - V_40 ;
}
V_89 -> V_37 = F_43 ( & V_4 -> V_97 , sizeof( * V_89 -> V_37 ) , V_98 ) ;
if ( ! V_89 -> V_37 ) {
F_38 ( V_4 , L_12 ) ;
return - V_40 ;
}
...
V_89 -> V_92 = V_2 -> V_99 ;
V_89 -> V_37 -> V_4 = V_4 ;
V_89 -> V_37 -> V_100 = V_4 -> V_101 ;
V_89 -> V_37 -> V_102 = V_4 -> V_103 ;
F_45 ( & V_89 -> V_58 ) ;
F_45 ( & V_89 -> V_34 ) ;
F_46 ( & V_89 -> V_47 ) ;
V_46 = F_47 ( V_4 ) ;
...
V_89 -> V_108 [
V_89 -> V_105 ] . V_2 = V_111 ;
V_89 -> V_108 [
V_89 -> V_105 ] . V_95 = V_95 ;
V_89 -> V_108 [
V_89 -> V_105 ] . V_112 =
V_89 -> V_37 ;
V_89 -> V_108 [
V_89 -> V_105 ] . V_113 =
sizeof( * V_89 -> V_37 ) ;
F_30 ( V_4 , L_20 , V_95 , V_89 ) ;
V_89 -> V_105 ++ ;
}
}
V_46 = F_51 ( & V_4 -> V_97 , 0 , V_89 -> V_108 ,
V_89 -> V_105 , NULL , 0 , NULL ) ;
if ( V_46 < 0 )
goto V_110;
return V_46 ;
V_110:
for ( V_66 = 0 ; V_66 < V_89 -> V_105 ; ++ V_66 )
F_15 ( V_89 -> V_108 [ V_66 ] . V_95 ) ;
F_15 ( V_89 -> V_108 ) ;
V_107:
F_52 ( V_4 ) ;
return V_46 ;
...
F_26 ( & V_45 -> V_58 , V_53 ) ;
F_54 ( & V_4 -> V_97 ) ;
for ( V_66 = 0 ; V_66 < V_45 -> V_105 ; ++ V_66 )
F_15 ( V_45 -> V_108 [ V_66 ] . V_95 ) ;
F_15 ( V_45 -> V_108 ) ;
F_44 ( V_4 , NULL ) ;
F_55 ( & V_45 -> V_47 ) ;
}
