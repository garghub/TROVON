...
static void F_107 ( char * V_171 )
{
struct V_1 * V_172 , * V_173 ;
if ( ! V_171 )
return;
V_172 = F_2 ( NULL , V_171 ) ;
if ( V_172 ) {
V_173 = F_108 ( V_172 , NULL ) ;
while ( V_173 ) {
F_93 ( V_173 ) ;
V_173 = F_108 ( V_172 , V_173 ) ;
}
F_5 ( V_172 ) ;
}
}
...
V_176 = F_42 ( V_175 , L_40 , NULL ) ;
if ( ! V_176 ) {
strcpy ( V_104 , L_39 ) ;
return strlen ( V_104 ) ;
}
return sprintf ( V_104 , L_41 , V_7 -> type , V_176 ) ;
}
void F_115 ( struct V_7 * V_8 )
{
F_116 ( & V_8 -> V_49 ) ;
}
static int F_117 ( struct V_48 * V_49 , struct V_177 * V_178 )
{
const struct V_7 * V_7 = F_24 ( V_49 ) ;
struct V_82 * V_179 = F_41 ( V_178 ) ;
const struct V_148 * V_149 = V_179 -> V_154 ;
return ( V_149 != NULL ) && ( F_79 ( V_149 , V_7 ) != NULL ) ;
}
static int F_118 ( struct V_48 * V_49 , struct V_180 * V_181 )
{
const struct V_7 * V_7 = F_24 ( V_49 ) ;
struct V_1 * V_175 ;
const char * V_176 ;
...
if ( ! V_176 )
return - V_152 ;
F_119 ( V_181 , L_42 , V_7 -> type , V_176 ) ;
return 0 ;
}
const void * F_120 ( struct V_7 * V_113 , char * V_182 , int * V_73 )
{
return F_42 ( V_113 -> V_49 . V_4 , V_182 , V_73 ) ;
}
static struct V_7 * F_121 ( const char * V_159 )
{
struct V_48 * V_80 ;
V_80 = F_122 ( & V_108 , NULL , V_159 ) ;
if ( ! V_80 )
return NULL ;
return F_24 ( V_80 ) ;
}
struct V_7 * F_123 ( struct V_1 * V_183 )
{
char V_184 [ 20 ] ;
struct V_1 * V_185 ;
const char * V_186 ;
...
if ( ! V_185 )
return NULL ;
V_186 = F_42 ( V_185 , L_43 , NULL ) ;
F_5 ( V_185 ) ;
if ( ! V_186 )
return NULL ;
if ( ! strcmp ( V_186 , L_1 ) ) {
const T_6 * V_6 ;
V_6 = F_42 ( V_183 , L_29 , NULL ) ;
if ( ! V_6 )
return NULL ;
snprintf ( V_184 , sizeof( V_184 ) , L_31 ,
( V_187 ) F_96 ( V_6 , 1 ) ) ;
} else if ( ! strcmp ( V_186 , L_37 ) )
snprintf ( V_184 , sizeof( V_184 ) , L_33 , V_183 -> V_159 ) ;
else
return NULL ;
return F_121 ( V_184 ) ;
}
...
{
int V_188 = F_125 ( V_49 -> V_166 , V_189 ) ;
if ( V_188 != V_99 )
F_60 ( V_100 L_44 , V_188 ) ;
return V_188 ;
}
int F_126 ( struct V_7 * V_49 )
{
int V_188 = F_125 ( V_49 -> V_166 , V_190 ) ;
if ( V_188 != V_99 )
F_60 ( V_100 L_45 , V_188 ) ;
return V_188 ;
}
