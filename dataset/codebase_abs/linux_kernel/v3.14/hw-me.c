...
struct V_1 * V_2 = F_6 ( V_7 ) ;
char V_31 , V_32 ;
unsigned char V_50 , V_35 ;
V_2 -> V_21 = F_7 ( V_2 ) ;
V_50 = ( unsigned char ) ( ( V_2 -> V_21 & V_51 ) >> 24 ) ;
V_31 = ( char ) ( ( V_2 -> V_21 & V_52 ) >> 8 ) ;
V_32 = ( char ) ( ( V_2 -> V_21 & V_53 ) >> 16 ) ;
...
static int F_36 ( struct V_6 * V_7 , unsigned char * V_54 ,
unsigned long V_55 )
{
struct V_1 * V_2 = F_6 ( V_7 ) ;
T_1 * V_43 = ( T_1 * ) V_54 ;
T_1 V_11 ;
for (; V_55 >= sizeof( T_1 ) ; V_55 -= sizeof( T_1 ) )
* V_43 ++ = F_5 ( V_7 ) ;
if ( V_55 > 0 ) {
T_1 V_49 = F_5 ( V_7 ) ;
memcpy ( V_43 , & V_49 , V_55 ) ;
}
V_11 = F_8 ( V_2 ) | V_16 ;
F_9 ( V_2 , V_11 ) ;
return 0 ;
}
T_3 F_37 ( int V_56 , void * V_57 )
{
...
V_63 = F_47 ( V_7 ) ;
while ( V_63 > 0 ) {
if ( V_7 -> V_69 . V_70 . V_42 )
break;
F_26 ( & V_7 -> V_29 -> V_7 , L_9 , V_63 ) ;
V_64 = F_48 ( V_7 , & V_62 , & V_63 ) ;
if ( V_64 && V_7 -> V_65 != V_66 ) {
F_44 ( & V_7 -> V_67 ) ;
goto V_68;
}
}
