...
V_6 -> V_13 = V_6 -> V_16 = V_6 -> V_15 = 0 ;
V_6 -> V_21 = 0 ;
V_43 = F_26 ( V_49 [ V_42 ] , V_50 [ V_42 ] , V_51 , 0 ,
& V_6 -> V_52 ) ;
if ( V_43 < 0 ) {
F_22 ( V_6 ) ;
return V_43 ;
...
F_28 ( V_6 -> V_52 , V_2 -> V_42 ) ;
V_43 = F_29 ( V_6 -> V_52 , L_1 , 0 , 0 , 1 , & V_6 -> V_55 ) ;
if ( V_43 < 0 ) {
F_30 ( V_6 -> V_52 ) ;
F_22 ( V_6 ) ;
return V_43 ;
}
F_31 ( V_6 -> V_52 -> V_56 , L_1 , sizeof( V_6 -> V_52 -> V_56 ) ) ;
F_31 ( V_6 -> V_52 -> V_57 , V_2 -> V_58 , sizeof( V_6 -> V_52 -> V_56 ) ) ;
F_31 ( V_6 -> V_52 -> V_59 , V_6 -> V_52 -> V_57 ,
