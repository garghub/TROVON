...
{
int V_49 ;
V_49 = F_18 ( V_13 , 8 , 8 , V_57 ) ;
if ( V_49 < 0 ) {
F_14 ( V_13 -> V_2 , L_2 , V_49 ) ;
return V_49 ;
}
F_9 ( V_13 , V_58 , 1 , 1 ) ;
F_9 ( V_13 , V_59 , 0x40 , 0x40 ) ;
F_9 ( V_13 , V_60 , 0xff , 0xc0 ) ;
return 0 ;
}
...
struct V_14 * V_15 ;
int V_49 ;
V_15 = F_20 ( & V_62 -> V_2 , sizeof( struct V_14 ) ,
V_65 ) ;
if ( V_15 == NULL )
return - V_66 ;
V_15 -> V_56 = F_21 ( V_62 , & V_67 ) ;
if ( F_22 ( V_15 -> V_56 ) )
return F_23 ( V_15 -> V_56 ) ;
F_24 ( V_62 , V_15 ) ;
V_49 = F_25 ( & V_62 -> V_2 ,
& V_68 , & V_69 , 1 ) ;
return V_49 ;
}
static int F_26 ( struct V_61 * V_70 )
{
F_27 ( & V_70 -> V_2 ) ;
return 0 ;
}
