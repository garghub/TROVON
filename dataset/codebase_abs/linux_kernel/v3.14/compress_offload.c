...
return - V_23 ;
V_5 = V_32 -> V_138 ;
sprintf ( V_137 , L_17 , V_5 -> V_26 -> V_139 , V_5 -> V_32 ) ;
F_14 ( L_18 , V_137 , V_5 -> V_140 ,
V_5 -> V_25 ) ;
V_13 = F_53 ( V_22 , V_5 -> V_26 ,
V_5 -> V_32 , & V_141 , V_5 , V_137 ) ;
if ( V_13 < 0 ) {
F_5 ( L_19 , V_13 ) ;
return V_13 ;
}
...
int F_56 ( struct V_142 * V_26 , int V_32 ,
...
V_5 -> V_32 = V_32 ;
V_5 -> V_25 = V_11 ;
return F_57 ( V_26 , V_147 , V_5 , & V_30 ) ;
}
...
{
int V_69 ;
if ( V_32 -> V_140 == NULL || V_32 -> V_148 == NULL || V_32 -> V_30 == NULL )
return - V_20 ;
F_14 ( L_21 , V_32 -> V_140 ) ;
