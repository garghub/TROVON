...
struct V_198 * V_199 = F_83 ( & V_183 -> V_200 ) ;
struct V_182 * V_1 ;
struct V_201 * V_202 ;
struct V_203 V_204 ;
int V_60 = - V_192 ;
V_202 = F_84 ( sizeof( * V_202 ) , V_205 ) ;
if ( ! V_202 ) {
F_85 ( & V_183 -> V_200 , L_44 ) ;
goto V_206;
}
V_202 -> V_200 = & V_183 -> V_200 ;
V_199 -> V_207 = & V_208 ;
F_86 ( V_183 , V_202 ) ;
memset ( V_197 , 0x00 , sizeof( * V_197 ) *
F_87 ( V_197 ) ) ;
V_197 [ 0 ] . V_209 = V_183 -> V_184 [ 0 ] . V_209 ;
V_197 [ 0 ] . V_191 = V_183 -> V_184 [ 0 ] . V_191 ;
V_197 [ 0 ] . V_210 = V_183 -> V_184 [ 0 ] . V_210 ;
V_197 [ 0 ] . V_64 = V_183 -> V_184 [ 0 ] . V_64 ;
V_197 [ 1 ] . V_209 = V_183 -> V_184 [ 1 ] . V_209 ;
V_197 [ 1 ] . V_191 = V_183 -> V_184 [ 1 ] . V_191 ;
V_197 [ 1 ] . V_210 = V_183 -> V_184 [ 1 ] . V_210 ;
V_197 [ 1 ] . V_64 = V_183 -> V_184 [ 1 ] . V_64 ;
V_197 [ 2 ] . V_209 = V_183 -> V_184 [ 2 ] . V_209 ;
V_197 [ 2 ] . V_191 = V_183 -> V_184 [ 2 ] . V_191 ;
V_197 [ 2 ] . V_210 = V_183 -> V_184 [ 2 ] . V_210 ;
V_197 [ 2 ] . V_64 = V_183 -> V_184 [ 2 ] . V_64 ;
V_204 = V_211 ;
V_204 . V_212 = & V_183 -> V_200 ;
V_204 . V_213 = V_197 ;
V_204 . V_214 = F_87 ( V_197 ) ;
V_204 . V_215 = V_199 ;
V_204 . V_216 = sizeof( * V_199 ) ;
V_202 -> V_1 = V_1 = F_88 ( & V_204 ) ;
if ( F_89 ( V_1 ) ) {
V_60 = F_90 ( V_1 ) ;
F_85 ( & V_183 -> V_200 , L_45 , V_60 ) ;
goto V_217;
}
return 0 ;
V_217:
