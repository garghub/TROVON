...
return - V_137 ;
V_136:
V_93 [ V_58 ] = F_33 ( V_15 -> V_20 + V_123 ) ;
...
F_40 ( V_15 ) ;
if ( V_145 -> V_101 ) {
V_146 = F_46 ( V_145 -> V_101 , F_26 ,
V_148 , V_15 -> V_149 , V_15 ) ;
if ( V_146 == 0 )
V_15 -> V_101 = V_145 -> V_101 ;
}
V_146 = F_47 ( V_15 , 4 ) ;
if ( V_146 )
return V_146 ;
...
V_51 -> V_156 = & V_170 ;
V_51 -> V_171 = F_38 ;
F_48 ( V_15 -> V_173 , L_9 , V_15 -> V_149 ) ;
return 0 ;
}
