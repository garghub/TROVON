...
static unsigned int F_34 ( struct V_56 * V_57 ,
unsigned int V_28 )
{
struct V_1 * V_2 = V_57 -> V_13 ;
unsigned long V_65 ;
...
F_41 ( V_75 L_3
L_4 ,
F_42 ( V_2 -> V_24 ) , V_2 -> V_76 [ V_28 ] ) ;
V_67 = 1 ;
V_2 -> V_72 ++ ;
goto V_68;
}
if ( ! V_2 -> V_70 ) {
F_14 (KERN_WARNING SFX L_3
L_5 ,
...
V_57 -> V_81 = 0 ;
F_22 ( V_2 ) ;
F_17 ( V_2 , V_85 , F_46 ( V_2 , V_85 ) & ~ V_86 ) ;
return - 1 ;
}
static int F_47 ( struct V_1 * V_2 , unsigned int V_28 )
{
int V_65 = 50 ;
while ( V_65 -- ) {
if ( F_27 ( V_2 , V_87 ) & V_88 ) {
V_2 -> V_38 . V_55 [ V_28 ] = F_46 ( V_2 , V_89 ) ;
return 0 ;
}
F_39 ( 1 ) ;
}
...
if ( F_33 () )
F_48 ( V_75 L_11 ,
F_42 ( V_2 -> V_24 ) , F_27 ( V_2 , V_87 ) , V_58 ) ;
return - V_59 ;
}
...
return F_34 ( V_57 , V_28 ) ;
}
static void F_53 ( struct V_1 * V_2 )
{
unsigned long V_65 ;
F_17 ( V_2 , V_85 , F_46 ( V_2 , V_85 ) & ~ V_93 ) ;
V_65 = V_69 + F_35 ( 100 ) ;
...
V_95:
if ( ! F_54 ( V_2 , V_85 ) ) {
F_48 ( V_75 L_12 , F_42 ( V_2 -> V_24 ) ) ;
return - V_98 ;
}
if ( ! V_2 -> V_84 )
F_17 ( V_2 , V_85 , F_46 ( V_2 , V_85 ) |
V_86 ) ;
if ( ! V_2 -> V_99 ) {
V_2 -> V_99 = F_27 ( V_2 , V_96 ) ;
F_41 ( V_75 L_13 , F_42 ( V_2 -> V_24 ) , V_2 -> V_99 ) ;
}
return 0 ;
}
static void F_59 ( struct V_1 * V_2 )
{
F_17 ( V_2 , V_100 , F_46 ( V_2 , V_100 ) |
V_101 | V_102 ) ;
}
...
{
if ( ! ( V_2 -> V_47 & V_123 ) ) {
F_41 ( V_75 L_14 , F_42 ( V_2 -> V_24 ) ) ;
F_68 ( V_2 -> V_24 , V_124 , 0x07 , 0 ) ;
}
if ( V_2 -> V_47 & V_125 ) {
F_41 ( V_75 L_15 , F_42 ( V_2 -> V_24 ) , F_2 ( V_2 ) ) ;
F_68 ( V_2 -> V_24 ,
V_126 , 0x07 ,
F_2 ( V_2 ) ? V_127 : 0 ) ;
}
if ( V_2 -> V_47 & V_128 ) {
F_41 ( V_75 L_16 , F_42 ( V_2 -> V_24 ) , F_2 ( V_2 ) ) ;
F_68 ( V_2 -> V_24 ,
V_129 ,
0x0f , V_130 ) ;
F_68 ( V_2 -> V_24 ,
...
if ( V_55 == - 1 )
return - V_59 ;
F_41 ( V_75 L_22 , F_42 ( V_2 -> V_24 ) , V_28 ) ;
return 0 ;
}
...
if ( ! V_205 ) {
F_14 (KERN_ERR SFX L_28 , pci_name(chip->pci)) ;
return - V_235 ;
}
return 0 ;
}
...
if ( V_177 -> V_301 > 64 )
V_18 -> V_302 = - F_86 ( V_177 , 64 ) ;
else
V_18 -> V_302 = 0 ;
V_18 -> V_303 = ( ( ( V_177 -> V_301 * 24000 ) /
V_177 -> V_179 ) * 1000 ) ;
F_88 ( V_2 , V_18 ) ;
if ( V_20 -> V_240 == V_241 )
V_18 -> V_304 = F_148 ( V_18 , V_305 ) + 1 ;
else
V_18 -> V_304 = 0 ;
V_182 = V_18 -> V_182 ;
if ( ( V_2 -> V_47 & V_48 ) &&
...
struct V_18 * V_18 ;
struct V_19 * V_306 ;
int V_307 = 0 , V_308 , V_309 = 0 , V_310 = 0 ;
int V_311 , V_65 ;
V_18 = F_117 ( V_20 ) ;
F_151 ( V_2 , V_18 , V_53 ) ;
...
F_152 (s, substream) {
if ( V_306 -> V_198 -> V_223 != V_20 -> V_198 -> V_223 )
continue;
V_18 = F_117 ( V_306 ) ;
V_310 |= 1 << V_18 -> V_113 ;
V_309 ++ ;
...
if ( V_2 -> V_47 & V_319 )
F_17 ( V_2 , V_320 ,
F_46 ( V_2 , V_320 ) | V_310 ) ;
else
F_17 ( V_2 , V_321 , F_46 ( V_2 , V_321 ) | V_310 ) ;
F_152 (s, substream) {
if ( V_306 -> V_198 -> V_223 != V_20 -> V_198 -> V_223 )
continue;
V_18 = F_117 ( V_306 ) ;
if ( V_308 ) {
V_18 -> V_322 = F_46 ( V_2 , V_252 ) ;
if ( ! V_307 )
V_18 -> V_322 -=
V_18 -> V_303 ;
F_64 ( V_2 , V_18 ) ;
...
unsigned int V_304 ;
V_324 = F_89 ( V_18 , V_330 ) ;
if ( V_18 -> V_20 -> V_240 == V_241 ) {
return V_324 ;
}
V_328 = F_30 ( * V_18 -> V_117 ) ;
V_328 %= V_18 -> V_168 ;
V_304 = F_156 ( V_2 -> V_331 + V_332 ) ;
if ( V_18 -> V_112 ) {
if ( V_324 <= V_304 )
return 0 ;
V_18 -> V_112 = 0 ;
...
if ( V_324 <= V_304 )
V_325 = V_18 -> V_172 + V_324 - V_304 ;
else
V_325 = V_324 - V_304 ;
V_329 = V_325 % V_18 -> V_168 ;
V_327 = V_324 % V_18 -> V_168 ;
if ( V_327 >= V_304 )
V_326 = V_324 - V_327 ;
else if ( V_328 >= V_329 )
V_326 = V_325 - V_329 ;
else {
V_326 = V_325 - V_329 + V_18 -> V_168 ;
if ( V_326 >= V_18 -> V_172 )
V_326 = 0 ;
}
return V_326 + V_328 ;
...
case V_190 :
V_334 = F_89 ( V_18 , V_330 ) ;
break;
case V_336 :
V_334 = F_155 ( V_2 , V_18 ) ;
break;
default:
V_334 = F_30 ( * V_18 -> V_117 ) ;
if ( V_333 && V_2 -> V_189 [ V_240 ] == V_337 ) {
if ( ! V_334 || V_334 == ( V_29 ) - 1 ) {
F_158 ( V_338
L_31
L_32 ) ;
...
V_2 -> V_189 [ V_240 ] == V_339 &&
( V_2 -> V_47 & V_340 ) ) {
unsigned int V_341 = F_89 ( V_18 , V_330 ) ;
if ( V_240 == V_241 )
V_335 = V_334 - V_341 ;
else
V_335 = V_341 - V_334 ;
...
V_335 = F_159 ( V_20 -> V_177 , V_335 ) ;
}
if ( V_20 -> V_177 ) {
if ( V_264 -> V_208 . V_267 )
V_335 += V_264 -> V_208 . V_267 ( V_264 , V_251 -> V_232 ,
V_20 ) ;
V_20 -> V_177 -> V_335 = V_335 ;
}
F_160 ( V_2 , V_18 , V_334 , V_335 ) ;
return V_334 ;
}
...
V_29 V_342 ;
unsigned int V_334 ;
V_342 = F_46 ( V_2 , V_252 ) - V_18 -> V_322 ;
if ( V_342 < ( V_18 -> V_303 * 2 ) / 3 )
return - 1 ;
V_334 = F_157 ( V_2 , V_18 , true ) ;
if ( F_162 ( ! V_18 -> V_168 ,
L_35 ) )
return - 1 ;
if ( V_342 < ( V_18 -> V_303 * 5 ) / 4 &&
V_334 % V_18 -> V_168 > V_18 -> V_168 / 2 )
return V_173 [ V_2 -> V_174 ] ? 0 : - 1 ;
V_18 -> V_322 += V_342 ;
return 1 ;
}
static void F_163 ( struct V_343 * V_344 )
{
struct V_1 * V_2 = F_114 ( V_344 , struct V_1 , V_152 ) ;
int V_103 , V_345 , V_141 ;
if ( ! V_2 -> V_346 ) {
F_158 ( V_338
L_36
L_37 ,
...
struct V_1 * V_2 = V_251 -> V_2 ;
if ( ! F_2 ( V_2 ) )
V_7 -> V_348 = F_166 ( V_7 -> V_348 ) ;
return F_167 ( V_20 , V_7 ) ;
}
static void F_168 ( struct V_349 * V_198 )
{
...
struct V_349 * V_198 ;
struct V_196 * V_251 ;
int V_353 = V_352 -> V_238 ;
unsigned int V_158 ;
int V_306 , V_22 ;
F_97 (apcm, &chip->pcm_list, list) {
if ( V_251 -> V_198 -> V_238 == V_353 ) {
F_14 (KERN_ERR SFX L_38 ,
pci_name(chip->pci), pcm_dev) ;
return - V_98 ;
}
}
V_22 = F_171 ( V_2 -> V_223 , V_352 -> V_354 , V_353 ,
V_352 -> V_240 [ V_241 ] . V_355 ,
V_352 -> V_240 [ V_268 ] . V_355 ,
& V_198 ) ;
if ( V_22 < 0 )
return V_22 ;
F_172 ( V_198 -> V_354 , V_352 -> V_354 , sizeof( V_198 -> V_354 ) ) ;
V_251 = F_173 ( sizeof( * V_251 ) , V_356 ) ;
if ( V_251 == NULL )
return - V_357 ;
V_251 -> V_2 = V_2 ;
V_251 -> V_198 = V_198 ;
...
V_198 -> V_361 = V_362 ;
F_174 ( & V_251 -> V_350 , & V_2 -> V_363 ) ;
V_352 -> V_198 = V_198 ;
for ( V_306 = 0 ; V_306 < 2 ; V_306 ++ ) {
V_251 -> V_264 [ V_306 ] = & V_352 -> V_240 [ V_306 ] ;
if ( V_352 -> V_240 [ V_306 ] . V_355 )
F_175 ( V_198 , V_306 , & V_364 ) ;
}
V_158 = V_365 * 1024 ;
if ( V_158 > V_366 )
V_158 = V_366 ;
...
for ( V_103 = 0 ; V_103 < V_2 -> V_104 ; V_103 ++ ) {
struct V_18 * V_18 = & V_2 -> V_18 [ V_103 ] ;
V_18 -> V_117 = ( V_29 V_367 * ) ( V_2 -> V_117 . V_7 + V_103 * 8 ) ;
V_18 -> V_368 = V_2 -> V_331 + ( 0x20 * V_103 + 0x80 ) ;
V_18 -> V_147 = 1 << V_103 ;
V_18 -> V_113 = V_103 ;
V_18 -> V_182 = V_103 + 1 ;
}
...
static int F_45 ( struct V_1 * V_2 , int V_369 )
{
...
V_18 -> V_162 = 0 ;
V_160 = ( V_29 * ) V_18 -> V_160 . V_7 ;
V_22 = F_81 ( V_2 , V_373 , V_18 , & V_160 , 0 , V_372 , 0 ) ;
if ( V_22 < 0 )
goto error;
F_88 ( V_2 , V_18 ) ;
F_111 ( V_18 ) ;
...
static void V_220 ( struct V_56 * V_57 , bool V_308 )
{
struct V_1 * V_2 = V_57 -> V_13 ;
...
static void V_216 ( struct V_56 * V_57 , bool V_377 )
{
struct V_1 * V_2 = V_57 -> V_13 ;
if ( ! ( V_2 -> V_47 & V_142 ) )
return;
...
static int F_191 ( const char * V_58 , const struct V_380 * V_381 )
{
struct V_1 * V_2 ;
struct V_231 * V_204 ;
int V_382 = V_214 ;
int V_291 = F_192 ( V_58 , V_381 ) ;
if ( V_291 || V_382 == V_214 )
return V_291 ;
F_92 ( & V_378 ) ;
...
static int F_211 ( struct V_392 * V_393 , unsigned long V_394 , void * V_17 )
{
struct V_1 * V_2 = F_114 ( V_393 , struct V_1 , V_395 ) ;
F_212 ( V_2 -> V_57 ) ;
F_95 ( V_2 ) ;
return V_396 ;
}
...
if ( ! V_2 -> V_405 )
return 0 ;
V_22 = F_230 ( V_2 -> V_24 , & V_406 ,
V_407 ,
V_2 -> V_57 != NULL ) ;
if ( V_22 < 0 )
return V_22 ;
V_2 -> V_408 = 1 ;
F_231 ( & V_2 -> V_24 -> V_9 , & V_2 -> V_409 ) ;
return 0 ;
}
...
static int F_240 ( struct V_412 * V_238 )
{
return F_232 ( V_238 -> V_413 ) ;
}
...
if ( V_197 ) {
if ( F_244 ( V_197 ) == V_402 )
V_421 = true ;
F_228 ( V_197 ) ;
}
return V_421 ;
}
static int F_245 ( struct V_1 * V_2 , int V_422 )
{
...
V_424 = F_246 ( V_2 -> V_24 , V_426 ) ;
if ( V_424 ) {
F_158 ( V_427
L_49
L_50 ,
V_424 -> V_428 , V_424 -> V_429 , V_424 -> V_430 ) ;
return V_424 -> V_428 ;
}
if ( V_2 -> V_47 & V_431 ) {
F_48 ( V_75 L_51 , F_42 ( V_2 -> V_24 ) ) ;
return V_336 ;
}
if ( V_2 -> V_47 & V_432 ) {
F_48 ( V_75 L_52 , F_42 ( V_2 -> V_24 ) ) ;
return V_190 ;
}
return V_337 ;
}
...
V_2 -> V_228 = V_433 [ V_9 ] ;
if ( V_2 -> V_228 == - 1 ) {
V_424 = F_246 ( V_2 -> V_24 , V_434 ) ;
if ( V_424 ) {
F_158 ( V_427
L_53
L_50 ,
V_424 -> V_428 , V_424 -> V_429 , V_424 -> V_430 ) ;
V_2 -> V_228 = V_424 -> V_428 ;
}
}
if ( V_2 -> V_228 != - 1 &&
( V_2 -> V_228 & V_435 ) ) {
...
V_2 -> V_77 = 1 ;
V_424 = F_246 ( V_2 -> V_24 , V_437 ) ;
if ( V_424 ) {
F_158 ( V_427
L_55 ,
V_424 -> V_429 , V_424 -> V_430 , V_424 -> V_428 ) ;
V_2 -> V_77 = V_424 -> V_428 ;
return;
}
if ( V_2 -> V_47 & V_438 ) {
F_158 ( V_427 L_56 ) ;
...
if ( ! ( V_58 & 0x80 ) && V_2 -> V_24 -> V_440 == 0x30 )
V_135 = false ;
}
break;
case V_441 :
...
if ( V_135 != V_2 -> V_135 ) {
F_14 (KERN_INFO SFX L_57 ,
pci_name(chip->pci), snoop ? L_58 : L_59 ) ;
V_2 -> V_135 = V_135 ;
}
}
static void F_250 ( struct V_343 * V_344 )
{
F_220 ( F_114 ( V_344 , struct V_1 , V_443 ) ) ;
}
static int F_251 ( struct V_383 * V_223 , struct V_119 * V_24 ,
int V_9 , unsigned int V_47 ,
struct V_1 * * V_444 )
{
static struct V_445 V_208 = {
. V_446 = F_240 ,
} ;
struct V_1 * V_2 ;
int V_22 ;
...
if ( V_22 < 0 )
return V_22 ;
V_2 = F_173 ( sizeof( * V_2 ) , V_356 ) ;
if ( ! V_2 ) {
F_14 (KERN_ERR SFX L_60 , pci_name(pci)) ;
F_198 ( V_24 ) ;
return - V_357 ;
}
F_252 ( & V_2 -> V_26 ) ;
...
V_22 = F_257 ( V_223 , V_450 , V_2 , & V_208 ) ;
if ( V_22 < 0 ) {
F_14 (KERN_ERR SFX L_61 ,
pci_name(chip->pci)) ;
F_232 ( V_2 ) ;
return V_22 ;
}
F_254 ( & V_2 -> V_443 , F_250 ) ;
* V_444 = V_2 ;
return 0 ;
}
...
int V_9 = V_2 -> V_174 ;
struct V_119 * V_24 = V_2 -> V_24 ;
struct V_383 * V_223 = V_2 -> V_223 ;
int V_103 , V_22 ;
unsigned short V_451 ;
#if V_452 != 64
if ( V_2 -> V_226 == V_453 ) {
T_7 V_454 ;
F_72 ( V_24 , 0x40 , & V_454 ) ;
F_73 ( V_24 , 0x40 , V_454 | 0x10 ) ;
F_259 ( V_24 , V_455 , 0 ) ;
}
#endif
V_22 = F_260 ( V_24 , L_62 ) ;
if ( V_22 < 0 )
return V_22 ;
V_2 -> V_410 = 1 ;
V_2 -> V_28 = F_261 ( V_24 , 0 ) ;
V_2 -> V_331 = F_262 ( V_24 , 0 ) ;
if ( V_2 -> V_331 == NULL ) {
F_14 (KERN_ERR SFX L_63 , pci_name(chip->pci)) ;
return - V_235 ;
}
if ( V_2 -> V_77 )
if ( F_206 ( V_24 ) < 0 )
...
F_205 ( V_24 ) ;
F_263 ( V_2 -> V_78 ) ;
V_451 = F_27 ( V_2 , V_456 ) ;
F_41 ( V_75 L_64 , F_42 ( V_2 -> V_24 ) , V_451 ) ;
if ( V_2 -> V_24 -> V_414 == V_415 ) {
struct V_119 * V_457 ;
V_457 = F_264 ( V_415 ,
V_458 ,
NULL ) ;
...
if ( V_2 -> V_47 & V_461 )
V_2 -> V_282 = 0 ;
else if ( V_2 -> V_47 & V_462 )
V_2 -> V_282 = 1 ;
else
V_2 -> V_282 = 1 ;
}
if ( ( V_451 & V_459 ) && ! F_265 ( V_24 , F_266 ( 64 ) ) )
F_267 ( V_24 , F_266 ( 64 ) ) ;
else {
F_265 ( V_24 , F_266 ( 32 ) ) ;
F_267 ( V_24 , F_266 ( 32 ) ) ;
}
V_2 -> V_245 = ( V_451 >> 8 ) & 0x0f ;
V_2 -> V_243 = ( V_451 >> 12 ) & 0x0f ;
...
V_2 -> V_18 = F_268 ( V_2 -> V_104 , sizeof( * V_2 -> V_18 ) ,
V_356 ) ;
if ( ! V_2 -> V_18 ) {
F_14 (KERN_ERR SFX L_66 , pci_name(chip->pci)) ;
return - V_357 ;
}
for ( V_103 = 0 ; V_103 < V_2 -> V_104 ; V_103 ++ ) {
F_269 ( & V_2 -> V_18 [ V_103 ] ) ;
V_22 = F_12 ( V_23 ,
F_13 ( V_2 -> V_24 ) ,
V_471 , & V_2 -> V_18 [ V_103 ] . V_160 ) ;
if ( V_22 < 0 ) {
...
F_179 ( V_2 ) ;
F_71 ( V_2 ) ;
F_67 ( V_2 , ( V_472 [ V_9 ] & 2 ) == 0 ) ;
if ( ! V_2 -> V_99 ) {
F_14 (KERN_ERR SFX L_69 , pci_name(chip->pci)) ;
return - V_473 ;
}
strcpy ( V_223 -> V_474 , L_70 ) ;
F_172 ( V_223 -> V_475 , V_476 [ V_2 -> V_226 ] ,
sizeof( V_223 -> V_475 ) ) ;
snprintf ( V_223 -> V_477 , sizeof( V_223 -> V_477 ) ,
L_71 ,
V_223 -> V_475 , V_2 -> V_28 , V_2 -> V_78 ) ;
return 0 ;
}
...
static void F_271 ( const struct V_478 * V_411 , void * V_479 )
{
struct V_383 * V_223 = V_479 ;
struct V_1 * V_2 = V_223 -> V_13 ;
struct V_119 * V_24 = V_2 -> V_24 ;
if ( ! V_411 ) {
F_14 (KERN_ERR SFX L_72 ,
pci_name(chip->pci)) ;
goto error;
}
V_2 -> V_411 = V_411 ;
...
static int F_274 ( struct V_119 * V_24 ,
...
V_22 = F_275 ( V_113 [ V_9 ] , V_486 [ V_9 ] , V_487 , 0 , & V_223 ) ;
if ( V_22 < 0 ) {
F_14 ( V_83 L_73 ) ;
return V_22 ;
}
F_276 ( V_223 , & V_24 -> V_9 ) ;
V_22 = F_251 ( V_223 , V_24 , V_9 , V_481 -> V_488 , & V_2 ) ;
if ( V_22 < 0 )
goto V_489;
V_223 -> V_13 = V_2 ;
F_273 ( V_24 , V_223 ) ;
...
if ( F_243 ( V_24 ) ) {
F_14 (KERN_INFO SFX L_75 ,
pci_name(pci)) ;
F_14 (KERN_INFO SFX L_76 , pci_name(pci)) ;
V_2 -> V_92 = true ;
}
V_482 = ! V_2 -> V_92 ;
#ifdef F_237
if ( V_490 [ V_9 ] && * V_490 [ V_9 ] ) {
F_14 (KERN_ERR SFX L_77 ,
pci_name(pci), patch[dev]) ;
V_22 = F_277 ( V_487 , true , V_490 [ V_9 ] ,
& V_24 -> V_9 , V_356 , V_223 ,
F_271 ) ;
if ( V_22 < 0 )
goto V_489;
V_482 = false ;
...
#ifdef F_237
if ( V_2 -> V_411 ) {
V_22 = F_282 ( V_2 -> V_57 , V_2 -> V_411 -> V_158 ,
V_2 -> V_411 -> V_122 ) ;
if ( V_22 < 0 )
goto V_489;
#ifndef F_96
