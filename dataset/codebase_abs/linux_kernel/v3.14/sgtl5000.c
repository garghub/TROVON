...
static int F_61 ( struct V_27 * V_7 )
{
struct V_44 * V_45 = F_14 ( V_7 ) ;
F_38 ( V_7 , V_169 ) ;
F_44 ( F_40 ( V_45 -> V_170 ) ,
...
{
int V_251 , V_116 , V_270 , V_271 ;
for ( V_251 = 0 ; V_251 < F_40 ( V_272 ) ; V_251 ++ ) {
V_270 = V_272 [ V_251 ] . V_273 ;
V_271 = V_272 [ V_251 ] . V_28 ;
V_116 = F_63 ( V_45 -> V_171 , V_271 , V_270 ) ;
if ( V_116 )
return V_116 ;
}
return 0 ;
}
static int F_64 ( struct V_274 * V_275 ,
const struct V_276 * V_277 )
{
struct V_44 * V_45 ;
int V_116 , V_28 , V_278 ;
V_45 = F_65 ( & V_275 -> V_86 , sizeof( struct V_44 ) ,
V_151 ) ;
if ( ! V_45 )
return - V_152 ;
V_45 -> V_171 = F_66 ( V_275 , & V_279 ) ;
if ( F_34 ( V_45 -> V_171 ) ) {
V_116 = F_35 ( V_45 -> V_171 ) ;
F_17 ( & V_275 -> V_86 , L_15 , V_116 ) ;
return V_116 ;
}
V_45 -> V_280 = F_67 ( & V_275 -> V_86 , NULL ) ;
if ( F_34 ( V_45 -> V_280 ) ) {
V_116 = F_35 ( V_45 -> V_280 ) ;
F_17 ( & V_275 -> V_86 , L_16 , V_116 ) ;
if ( V_116 == - V_281 )
return - V_256 ;
return V_116 ;
}
V_116 = F_68 ( V_45 -> V_280 ) ;
if ( V_116 )
return V_116 ;
V_116 = F_69 ( V_45 -> V_171 , V_173 , & V_28 ) ;
if ( V_116 )
goto V_282;
if ( ( ( V_28 & V_283 ) >> V_284 ) !=
V_285 ) {
...
V_278 = ( V_28 & V_287 ) >> V_288 ;
F_53 ( & V_275 -> V_86 , L_18 , V_278 ) ;
V_45 -> V_255 = V_278 ;
F_70 ( V_275 , V_45 ) ;
V_116 = F_62 ( V_45 ) ;
if ( V_116 )
goto V_282;
V_116 = F_71 ( & V_275 -> V_86 ,
& V_289 , & V_290 , 1 ) ;
if ( V_116 )
goto V_282;
return 0 ;
...
static int F_73 ( struct V_274 * V_275 )
{
struct V_44 * V_45 = F_74 ( V_275 ) ;
F_75 ( & V_275 -> V_86 ) ;
F_72 ( V_45 -> V_280 ) ;
return 0 ;
}
