...
V_65 = (struct V_28 * ) F_33 ( sizeof( * V_65 ) ) ;
if ( V_65 == NULL ) {
F_31 ( & V_23 -> V_66 ) ;
return;
}
...
int F_40 ( struct V_22 * V_23 , struct V_10 * V_11 , int V_75 )
{
unsigned short V_76 ;
...
struct V_94 * V_95 = (struct V_94 * ) ( V_11 -> V_13 + V_14 ) ;
unsigned char * V_96 = ( unsigned char * ) ( V_95 + 1 ) ;
unsigned int * V_97 , * V_98 ;
if ( V_95 -> V_99 != F_45 ( V_80 ) ) {
F_41 ( L_15 , F_4 ( V_95 -> V_99 ) ) ;
return - 1 ;
}
switch ( V_75 ) {
case V_84 :
...
case V_85 :
F_30 ( L_16 , V_96 [ 0 ] ,
V_96 [ 1 ] , V_96 [ 2 ] , V_96 [ 3 ] , V_96 [ 4 ] , V_96 [ 5 ] ) ;
memcpy ( V_96 , F_46 ( V_23 ) , V_68 ) ;
V_96 += V_95 -> V_100 ;
V_97 = ( unsigned int * ) V_96 ;
F_15 ( V_31 , V_97 ) ;
F_32 ( V_23 , V_11 -> V_13 + V_68 , V_31 ) ;
F_35 ( V_23 ) ;
return 0 ;
...
V_96 += V_95 -> V_100 ;
V_97 = ( unsigned int * ) V_96 ;
V_96 += ( V_95 -> V_100 + V_95 -> V_101 ) ;
V_98 = ( unsigned int * ) V_96 ;
F_15 ( V_31 , V_98 ) ;
F_27 ( V_23 , V_11 , V_31 ) ;
V_96 = ( unsigned char * ) ( V_95 + 1 ) ;
V_96 += ( V_95 -> V_100 + V_95 -> V_101 ) ;
memcpy ( V_96 , V_11 -> V_13 , V_68 ) ;
return 0 ;
default:
return - 1 ;
}
...
( V_76 <= V_103 ) ) {
unsigned char V_104 [ 2 ] = { 0xFF , 0xFF } ;
struct V_105 * V_106 = NULL ;
struct V_107 * V_108 = NULL ;
struct V_109 * V_110 = NULL ;
unsigned char * V_111 = V_11 -> V_13 + V_14 ;
if ( V_76 == V_102 ) {
F_30 ( L_18 ) ;
V_106 = (struct V_105 * ) V_111 ;
} else if ( V_76 <= V_103 ) {
if ( ! memcmp ( V_104 , V_111 , 2 ) ) {
F_30 ( L_19 ) ;
V_106 = (struct V_105 * ) V_111 ;
} else {
unsigned char V_112 = 0xE0 ;
unsigned char V_113 = 0xAA ;
if ( * V_111 == V_113 ) {
unsigned char V_114 [ 5 ] = { 0x0 , 0x0 , 0x0 , 0x81 , 0x37 } ;
unsigned char V_115 [ 5 ] = { 0x00 , 0x00 , 0x00 , 0x80 , 0xF3 } ;
unsigned char V_116 [ 5 ] = { 0x08 , 0x00 , 0x07 , 0x80 , 0x9B } ;
V_111 += 3 ;
if ( ! memcmp ( V_114 , V_111 , 5 ) ) {
V_111 += 5 ;
F_30 ( L_20 ) ;
V_106 = (struct V_105 * ) V_111 ;
} else if ( ! memcmp ( V_115 , V_111 , 5 ) ) {
V_111 += 5 ;
V_108 = (struct V_107 * ) V_111 ;
} else if ( ! memcmp ( V_116 , V_111 , 5 ) ) {
V_111 += 5 ;
V_110 = (struct V_109 * ) V_111 ;
} else {
F_41 ( L_21 , V_111 [ 0 ] ,
V_111 [ 1 ] , V_111 [ 2 ] , V_111 [ 3 ] , V_111 [ 4 ] ) ;
return - 1 ;
}
} else if ( * V_111 == V_112 ) {
V_111 += 3 ;
...
switch ( V_75 ) {
case V_84 :
if ( ! memcmp ( V_11 -> V_13 + V_68 , V_106 -> V_117 . V_40 , V_68 ) )
F_30 ( L_23 ) ;
return 0 ;
case V_85 :
F_30 ( L_24 ,
...
if ( ! memcmp ( V_11 -> V_13 + V_68 , V_106 -> V_117 . V_40 , V_68 ) ) {
F_30 ( L_25 ) ;
F_17 ( V_31 , & V_106 -> V_117 . V_119 , & V_106 -> V_117 . V_120 ) ;
memcpy ( V_106 -> V_117 . V_40 , F_46 ( V_23 ) , V_68 ) ;
} else {
F_16 ( V_31 , & V_106 -> V_117 . V_119 , V_106 -> V_117 . V_40 ) ;
}
F_32 ( V_23 , V_11 -> V_13 + V_68 , V_31 ) ;
F_35 ( V_23 ) ;
return 0 ;
case V_88 :
if ( ! memcmp ( F_46 ( V_23 ) , V_106 -> V_118 . V_40 , V_68 ) ) {
F_30 ( L_26 ) ;
F_17 ( V_31 , & V_106 -> V_118 . V_119 , & V_106 -> V_118 . V_120 ) ;
F_27 ( V_23 , V_11 , V_31 ) ;
memcpy ( V_106 -> V_118 . V_40 , V_11 -> V_13 , V_68 ) ;
} else {
F_16 ( V_31 , & V_106 -> V_118 . V_119 , V_106 -> V_118 . V_40 ) ;
F_27 ( V_23 , V_11 , V_31 ) ;
}
return 0 ;
default:
...
if ( V_108 -> V_121 != V_68 || V_108 -> V_122 != V_123 ) {
F_41 ( L_27 ) ;
return - 1 ;
}
switch ( V_75 ) {
...
return 0 ;
case V_85 :
memcpy ( V_108 -> V_124 , F_46 ( V_23 ) , V_68 ) ;
F_30 ( L_28 ,
V_108 -> V_125 ,
V_108 -> V_126 ,
V_108 -> V_127 ,
V_108 -> V_128 ) ;
F_18 ( V_31 , & V_108 -> V_125 , & V_108 -> V_126 ) ;
F_32 ( V_23 , V_11 -> V_13 + V_68 , V_31 ) ;
F_35 ( V_23 ) ;
return 0 ;
case V_88 :
...
V_108 -> V_127 ,
V_108 -> V_128 ) ;
F_18 ( V_31 , & V_108 -> V_127 , & V_108 -> V_128 ) ;
F_27 ( V_23 , V_11 , V_31 ) ;
memcpy ( V_108 -> V_129 , V_11 -> V_13 , V_68 ) ;
return 0 ;
default:
return - 1 ;
}
...
V_110 -> V_132 ,
V_110 -> V_133 ) ;
F_18 ( V_31 , & V_110 -> V_130 , & V_110 -> V_131 ) ;
F_32 ( V_23 , V_11 -> V_13 + V_68 , V_31 ) ;
F_35 ( V_23 ) ;
return 0 ;
case V_88 :
...
V_110 -> V_132 ,
V_110 -> V_133 ) ;
F_18 ( V_31 , & V_110 -> V_132 , & V_110 -> V_133 ) ;
F_27 ( V_23 , V_11 , V_31 ) ;
return 0 ;
default:
return - 1 ;
...
case V_85 :
if ( V_2 -> V_43 == 0 ) {
if ( V_2 -> V_137 == V_138 || V_2 -> V_137 == V_139 ) {
if ( V_23 -> V_140 . V_141 ) {
struct V_12 * V_7 , * V_142 ;
unsigned char V_143 [ 40 ] ;
int V_144 = 0 ;
V_7 = (struct V_12 * ) V_143 ;
V_142 = (struct V_12 * ) F_1 ( V_2 , F_2 ( V_145 ) ) ;
if ( V_142 ) {
V_144 = F_2 ( V_142 -> V_16 ) ;
if ( V_144 + V_9 + V_146 + V_147 > sizeof( V_143 ) ) {
F_47 ( L_32 ) ;
return - 1 ;
}
memcpy ( V_7 -> V_148 + V_146 + V_147 ,
V_142 -> V_148 , V_144 ) ;
if ( F_9 ( V_11 , ( unsigned char * ) V_142 , V_9 + V_144 ) < 0 ) {
F_47 ( L_33 ) ;
return - 1 ;
}
V_2 -> V_8 = F_8 ( F_2 ( V_2 -> V_8 ) - V_9 - V_144 ) ;
}
V_7 -> V_149 = V_145 ;
V_7 -> V_16 = F_8 ( V_146 + V_147 + V_144 ) ;
V_136 = ( T_2 * ) V_7 -> V_148 ;
* V_136 = F_8 ( V_150 ) ;
memcpy ( V_7 -> V_148 + V_146 , V_11 -> V_13 + V_68 , V_68 ) ;
if ( F_3 ( V_11 , V_7 ) < 0 )
return - 1 ;
F_30 ( L_34 ,
( V_2 -> V_137 == V_138 ? L_35 : L_36 ) ) ;
} else {
if ( V_23 -> V_151 &&
memcmp ( V_11 -> V_13 + V_68 , V_23 -> V_152 , V_68 ) ) {
F_47 ( L_37 ) ;
return - 2 ;
}
if ( V_23 -> V_151 == 0 )
memcpy ( V_23 -> V_152 , V_11 -> V_13 + V_68 , V_68 ) ;
V_23 -> V_151 = V_153 ;
}
} else {
return - 1 ;
...
return 0 ;
case V_88 :
if ( V_2 -> V_137 == V_156 || V_2 -> V_137 == V_157 ) {
if ( V_23 -> V_140 . V_141 ) {
struct V_12 * V_7 ;
unsigned char * V_158 ;
unsigned short V_6 , V_5 ;
int V_159 = 0 ;
V_158 = F_1 ( V_2 , F_2 ( V_145 ) ) ;
if ( V_158 == NULL ) {
F_47 ( L_39 ) ;
return - 1 ;
}
...
if ( ( V_6 != F_2 ( V_145 ) ) || ( V_5 < ( V_146 + V_147 ) ) ) {
F_47 ( L_40 , V_5 ) ;
return - 1 ;
}
V_136 = ( T_2 * ) V_7 -> V_148 ;
if ( F_2 ( * V_136 ) != V_150 ) {
F_47 ( L_41 ,
( V_2 -> V_137 == V_156 ? L_42 : L_43 ) ) ;
return - 1 ;
}
memcpy ( V_11 -> V_13 , V_7 -> V_148 + V_146 , V_68 ) ;
if ( V_5 > V_146 + V_147 )
V_159 = V_9 ;
if ( F_9 ( V_11 , V_158 + V_159 , V_9 + V_146 + V_147 - V_159 ) < 0 ) {
F_47 ( L_44 ) ;
return - 1 ;
}
V_2 -> V_8 = F_8 ( F_2 ( V_2 -> V_8 ) - ( V_9 + V_146 + V_147 - V_159 ) ) ;
if ( V_159 > 0 )
V_7 -> V_16 = F_8 ( V_5 - V_146 - V_147 ) ;
F_30 ( L_45 ,
( V_2 -> V_137 == V_156 ? L_42 : L_43 ) , V_11 -> V_154 -> V_155 ) ;
} else {
if ( ! V_23 -> V_151 ) {
F_47 ( L_46 ) ;
return - 1 ;
}
memcpy ( V_11 -> V_13 , V_23 -> V_152 , V_68 ) ;
V_23 -> V_151 = V_153 ;
}
} else {
if ( V_2 -> V_43 != 0 ) {
F_30 ( L_47 , V_11 -> V_154 -> V_155 ) ;
...
V_11 -> V_18 - V_14 - sizeof( * V_82 ) , F_46 ( V_23 ) ) ) {
struct V_48 * V_165 = (struct V_48 * ) ( V_11 -> V_13 + V_14 + sizeof( * V_82 ) ) ;
V_165 -> V_166 = 0 ;
V_165 -> V_166 = F_48 ( & V_82 -> V_86 , & V_82 -> V_87 ,
F_4 ( V_82 -> V_167 ) ,
V_164 ,
F_49 ( ( V_168 * ) V_165 ,
F_4 ( V_82 -> V_167 ) , 0 ) ) ;
...
* ( ( T_2 * ) ( V_11 -> V_13 + V_68 * 2 ) ) = F_45 ( V_172 ) ;
...
if ( ( V_179 -> V_181 == F_45 ( V_182 ) ) &&
( V_179 -> V_183 == F_45 ( V_184 ) ) ) {
struct V_185 * V_186 =
(struct V_185 * ) ( ( V_180 ) V_179 + sizeof( struct V_178 ) ) ;
V_89 V_187 = F_42 ( ( T_1 ) V_186 -> V_187 ) ;
if ( V_187 == V_188 ) {
...
void * F_54 ( struct V_22 * V_23 , unsigned char * V_67 ,
unsigned char * V_32 )
{
unsigned char V_31 [ V_33 ] ;
struct V_28 * V_65 ;
