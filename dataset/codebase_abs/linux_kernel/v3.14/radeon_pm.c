...
F_3 ( & V_2 -> V_8 . V_15 ) ;
V_201 |= V_2 -> V_8 . V_16 . V_203 > 0 ;
V_201 |= V_2 -> V_8 . V_16 . V_204 > 0 ;
F_68 ( V_2 , ! V_201 ) ;
F_6 ( & V_2 -> V_8 . V_15 ) ;
} else {
if ( V_201 ) {
...
if ( V_2 -> V_8 . V_10 ) {
V_2 -> V_8 . V_213 = V_2 -> V_8 . V_10 [ V_2 -> V_8 . V_11 ] . V_62 [ 0 ] . V_95 . V_95 ;
V_2 -> V_8 . V_214 = V_2 -> V_8 . V_10 [ V_2 -> V_8 . V_11 ] . V_62 [ 0 ] . V_95 . V_215 ;
}
if ( V_2 -> V_8 . V_12 == V_68
&& V_2 -> V_8 . V_108 == V_206 ) {
V_2 -> V_8 . V_108 = V_205 ;
...
if ( V_122 )
return V_122 ;
F_85 ( & V_2 -> V_8 . V_112 , V_223 ) ;
if ( V_2 -> V_8 . V_9 > 1 ) {
V_122 = F_86 ( V_2 -> V_97 , & V_224 ) ;
if ( V_122 )
F_79 ( L_30 ) ;
V_122 = F_86 ( V_2 -> V_97 , & V_225 ) ;
if ( V_122 )
F_79 ( L_31 ) ;
if ( F_87 ( V_2 ) ) {
F_79 ( L_32 ) ;
...
goto V_226;
V_2 -> V_8 . V_14 = true ;
V_122 = F_86 ( V_2 -> V_97 , & V_227 ) ;
if ( V_122 )
F_79 ( L_35 ) ;
V_122 = F_86 ( V_2 -> V_97 , & V_228 ) ;
if ( V_122 )
F_79 ( L_35 ) ;
V_122 = F_86 ( V_2 -> V_97 , & V_224 ) ;
if ( V_122 )
...
V_264 = F_104 ( V_263 ) ;
if ( V_263 -> V_265 ) {
V_2 -> V_8 . V_16 . V_196 |= ( 1 << V_264 -> V_266 ) ;
V_2 -> V_8 . V_16 . V_162 ++ ;
}
}
if ( F_4 () > 0 )
...
{
int V_263 , V_270 , V_271 , V_272 ;
bool V_273 = true ;
for ( V_263 = 0 ; ( V_263 < V_2 -> V_81 ) && V_273 ; V_263 ++ ) {
if ( V_2 -> V_8 . V_52 & ( 1 << V_263 ) ) {
V_272 = F_108 ( V_2 -> V_72 , V_263 , 0 , & V_270 , & V_271 , NULL , NULL ) ;
if ( ( V_272 & V_274 ) &&
! ( V_272 & V_275 ) )
V_273 = false ;
}
...
static bool F_21 ( struct V_1 * V_2 , bool V_276 )
{
T_1 V_277 = 0 ;
bool V_273 = F_18 ( V_2 ) ;
if ( V_273 == false )
...
static void V_223 ( struct V_152 * V_153 )
{
struct V_1 * V_2 ;
int V_278 ;
V_2 = F_51 ( V_153 , struct V_1 ,
V_8 . V_112 . V_153 ) ;
V_278 = F_109 ( & V_2 -> V_279 . V_280 ) ;
F_3 ( & V_2 -> V_8 . V_15 ) ;
if ( V_2 -> V_8 . V_108 == V_205 ) {
int V_281 = 0 ;
int V_6 ;
...
F_6 ( & V_2 -> V_8 . V_15 ) ;
F_111 ( & V_2 -> V_279 . V_280 , V_278 ) ;
}
static int F_112 ( struct V_286 * V_287 , void * V_288 )
{
struct V_289 * V_290 = (struct V_289 * ) V_287 -> V_291 ;
struct V_101 * V_97 = V_290 -> V_292 -> V_97 ;
struct V_1 * V_2 = V_97 -> V_102 ;
if ( V_2 -> V_8 . V_14 ) {
F_3 ( & V_2 -> V_8 . V_15 ) ;
if ( V_2 -> V_18 -> V_16 . V_293 )
F_113 ( V_2 , V_287 ) ;
else
F_114 ( V_287 , L_44 ) ;
F_6 ( & V_2 -> V_8 . V_15 ) ;
} else {
F_114 ( V_287 , L_45 , V_2 -> V_8 . V_63 ) ;
if ( ( V_2 -> V_64 >= V_249 ) && ( V_2 -> V_89 & V_91 ) )
F_114 ( V_287 , L_46 , V_2 -> V_8 . V_67 ) ;
else
F_114 ( V_287 , L_46 , F_115 ( V_2 ) ) ;
F_114 ( V_287 , L_47 , V_2 -> V_8 . V_66 ) ;
if ( V_2 -> V_18 -> V_8 . V_294 )
F_114 ( V_287 , L_48 , F_116 ( V_2 ) ) ;
if ( V_2 -> V_8 . V_213 )
F_114 ( V_287 , L_49 , V_2 -> V_8 . V_213 ) ;
if ( V_2 -> V_18 -> V_8 . V_295 )
F_114 ( V_287 , L_50 , F_117 ( V_2 ) ) ;
}
return 0 ;
}
...
{
#if F_118 ( V_296 )
return F_119 ( V_2 , V_297 , F_120 ( V_297 ) ) ;
#else
return 0 ;
#endif
}
