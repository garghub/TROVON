...
goto V_114;
V_93 = - V_221 ;
if ( F_112 ( V_216 , V_77 -> V_11 ) )
goto V_114;
V_93 = F_114 ( & V_64 , & V_148 ) ;
if ( V_93 ) {
if ( V_93 != - V_190 )
goto V_114;
if ( ! F_112 ( V_216 , V_77 -> V_2 ) )
goto V_197;
V_148 . type = V_188 ;
} else {
T_2 V_222 = V_64 . V_55 ;
...
V_189:
V_4 = F_122 ( & V_200 , V_217 , 0 , V_201 , V_202 ) ;
if ( V_4 == NULL )
goto V_203;
memset ( & V_4 -> V_64 , 0 , sizeof( V_4 -> V_64 ) ) ;
V_4 -> V_137 = V_64 . V_55 ;
...
static int F_136 ( struct V_36 * V_37 , T_5 V_229 , T_5 V_230 ,
...
struct V_234 * V_235 ;
long V_75 ;
V_235 = F_137 ( V_37 , V_229 , V_230 , V_231 , sizeof( * V_223 ) , V_111 ) ;
if ( ! V_235 )
return - V_236 ;
V_223 = F_138 ( V_235 ) ;
V_223 -> V_237 = V_238 ;
...
if ( V_4 -> V_82 & V_250 )
V_223 -> V_245 |= V_251 ;
if ( F_139 ( V_37 , V_252 , V_243 ) < 0 ||
F_140 ( V_37 , V_253 , V_4 -> V_138 ) < 0 )
goto V_254;
if ( V_4 -> V_64 . V_55 ) {
V_223 -> V_240 = 16 ;
if ( F_140 ( V_37 , V_255 , V_4 -> V_64 . V_55 ) < 0 )
goto V_254;
}
if ( V_4 -> V_2 . V_7 &&
F_139 ( V_37 , V_256 , V_4 -> V_2 . V_7 -> V_117 ) < 0 )
goto V_254;
if ( F_140 ( V_37 , V_257 , V_4 -> V_204 ) < 0 )
goto V_254;
if ( V_4 -> V_138 != V_4 -> V_154 &&
F_140 ( V_37 , V_258 , V_4 -> V_154 ) < 0 )
goto V_254;
...
goto V_254;
if ( F_144 ( V_4 ) &&
F_139 ( V_37 , V_259 , V_4 -> V_64 . V_59 ) < 0 )
goto V_254;
return F_145 ( V_37 , V_235 ) ;
V_254:
F_146 ( V_37 , V_235 ) ;
return - V_236 ;
}
static int F_147 ( struct V_36 * V_260 , struct V_234 * V_235 )
{
struct V_261 * V_261 = F_148 ( V_260 -> V_35 ) ;
struct V_233 * V_262 = F_138 ( V_235 ) ;
struct V_3 * V_4 = NULL ;
struct V_76 * V_77 ;
int V_93 ;
struct V_36 * V_37 ;
...
if ( ! F_73 ( V_261 , & V_112 ) )
return - V_136 ;
V_93 = F_149 ( V_235 , sizeof( * V_262 ) , V_264 , V_265 , V_266 ) ;
if ( V_93 < 0 )
return V_93 ;
memset ( & V_64 , 0 , sizeof( V_64 ) ) ;
V_64 . V_214 = V_267 ;
V_37 = F_150 ( V_268 , V_269 ) ;
if ( V_37 == NULL )
return - V_211 ;
F_151 ( V_37 ) ;
V_77 = F_50 ( V_37 ) ;
if ( V_264 [ V_255 ] )
V_64 . V_55 = F_152 ( V_264 [ V_255 ] ) ;
if ( V_264 [ V_253 ] )
V_64 . V_54 = F_152 ( V_264 [ V_253 ] ) ;
if ( V_264 [ V_259 ] )
V_64 . V_59 = F_153 ( V_264 [ V_259 ] ) ;
if ( V_64 . V_59 ) {
struct V_6 * V_7 ;
...
V_4 -> V_82 |= V_250 ;
V_93 = F_136 ( V_37 , F_158 ( V_260 ) . V_229 , V_235 -> V_273 , V_274 , 0 , 0 ) ;
if ( V_93 == 0 )
goto V_272;
if ( V_93 < 0 ) {
V_93 = - V_236 ;
...
return F_159 ( V_37 , & V_112 , F_158 ( V_260 ) . V_229 ) ;
V_272:
F_59 ( V_37 ) ;
return V_93 ;
}
int F_160 ( struct V_36 * V_37 , struct V_275 * V_77 )
{
struct V_261 * V_261 = F_148 ( V_37 -> V_35 ) ;
struct V_3 * V_4 ;
int V_276 , V_277 ;
int V_278 , V_279 ;
struct V_233 * V_262 ;
if ( ! F_73 ( V_261 , & V_112 ) )
return 0 ;
if ( F_161 ( V_77 -> V_235 ) < sizeof( struct V_233 ) )
return - V_136 ;
V_262 = F_138 ( V_77 -> V_235 ) ;
...
V_279 = 0 ;
F_125 () ;
for( V_4 = F_126 ( V_24 [ V_276 ] . V_25 ) , V_278 = 0 ;
V_4 ;
V_4 = F_126 ( V_4 -> V_2 . V_29 ) , V_278 ++ ) {
if ( V_278 < V_279 )
continue;
F_135 ( V_37 , F_162 ( & V_4 -> V_2 ) ) ;
if ( F_136 ( V_37 , F_158 ( V_77 -> V_37 ) . V_229 ,
...
static struct V_3 * F_165 ( struct V_281 * V_230 , struct V_3 * V_4 )
{
struct V_282 * V_283 = V_230 -> V_284 ;
V_4 = F_126 ( V_4 -> V_2 . V_29 ) ;
while ( ! V_4 ) {
...
static void * F_166 ( struct V_281 * V_230 , T_7 * V_286 )
{
struct V_3 * V_4 = F_164 ( V_230 ) ;
if ( V_4 ) {
while( * V_286 && ( V_4 = F_165 ( V_230 , V_4 ) ) )
-- * V_286 ;
}
return * V_286 ? NULL : V_4 ;
}
static void * F_167 ( struct V_281 * V_230 , void * V_287 , T_7 * V_286 )
{
struct V_3 * V_4 = F_165 ( V_230 , V_287 ) ;
++ * V_286 ;
return V_4 ;
}
static void F_168 ( struct V_281 * V_230 , void * V_287 )
{
if ( V_287 )
F_128 () ;
}
static int F_169 ( struct V_281 * V_230 , void * V_287 )
{
struct V_3 * V_4 = V_287 ;
char V_288 [ V_289 ] , V_290 [ V_289 ] ;
F_170 ( V_230 , L_11 ,
V_4 -> V_2 . V_7 ? V_4 -> V_2 . V_7 -> V_96 : L_12 ,
F_171 ( F_58 ( V_4 -> V_138 ) , V_288 ) ,
F_171 ( F_58 ( V_4 -> V_137 ) , V_290 ) ,
F_17 ( & V_4 -> V_2 . V_27 ) ,
V_4 -> V_2 . V_291 , 0 ) ;
return 0 ;
}
static int F_172 ( struct V_292 * V_292 , struct V_293 * V_293 )
{
return F_173 ( V_293 , & V_294 ,
sizeof( struct V_282 ) ) ;
}
void T_8 F_174 ( void )
{
...
V_200 . V_305 = ( V_14 + 1 ) ;
F_181 ( L_16 , V_306 , V_112 . V_307 ,
& V_308 ) ;
#ifdef F_182
F_183 ( V_309 , V_310 , F_147 ,
V_311 , NULL ) ;
#else
F_183 ( V_309 , V_310 , F_147 ,
F_160 , NULL ) ;
