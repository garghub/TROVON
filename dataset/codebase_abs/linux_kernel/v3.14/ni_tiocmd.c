...
if ( V_26 < 0 )
return V_26 ;
V_26 = F_10 ( V_2 , 1 , V_32 ) ;
V_23 -> V_33 -> V_34 = NULL ;
return V_26 ;
}
static int F_11 ( struct V_1 * V_2 , struct V_35 * V_33 )
{
struct V_5 * V_6 = V_2 -> V_6 ;
unsigned V_7 = V_2 -> V_8 ;
...
F_1 ( V_2 , 1 , 0 ) ;
F_8 ( V_2 -> V_30 ) ;
return F_10 ( V_2 , 1 , V_32 ) ;
}
static int F_18 ( struct V_1 * V_2 , struct V_35 * V_33 )
{
struct V_36 * V_37 = & V_33 -> V_37 ;
unsigned V_7 = V_2 -> V_8 ;
int V_51 = 0 ;
...
V_51 = 1 ;
V_52 = V_37 -> V_54 ;
} else if ( V_37 -> V_55 == V_45 ) {
V_51 = 1 ;
V_52 = V_37 -> V_56 ;
}
if ( V_51 )
V_26 = F_19 ( V_2 , 0 , V_52 ) ;
if ( V_37 -> V_25 & V_57 ) {
F_2 ( V_2 , F_20 ( V_7 ) ,
F_21 ( V_7 ) ,
F_21 ( V_7 ) ) ;
...
if ( F_24 ( V_2 -> V_6 ) )
V_60 |= V_45 ;
V_59 |= F_25 ( & V_37 -> V_42 , V_60 ) ;
V_59 |= F_25 ( & V_37 -> V_53 ,
V_61 | V_45 | V_47 ) ;
V_59 |= F_25 ( & V_37 -> V_55 ,
V_43 | V_45 | V_47 ) ;
V_59 |= F_25 ( & V_37 -> V_62 , V_63 ) ;
V_59 |= F_25 ( & V_37 -> V_64 , V_65 ) ;
if ( V_59 )
return 1 ;
V_59 |= F_26 ( V_37 -> V_42 ) ;
V_59 |= F_26 ( V_37 -> V_53 ) ;
V_59 |= F_26 ( V_37 -> V_55 ) ;
if ( V_37 -> V_55 != V_43 && V_37 -> V_53 != V_61 )
V_59 |= - V_28 ;
if ( V_59 )
return 2 ;
if ( V_37 -> V_42 != V_45 )
V_59 |= F_27 ( & V_37 -> V_46 , 0 ) ;
if ( V_37 -> V_53 != V_45 )
V_59 |= F_27 ( & V_37 -> V_54 , 0 ) ;
if ( V_37 -> V_55 != V_45 )
V_59 |= F_27 ( & V_37 -> V_56 , 0 ) ;
V_59 |= F_27 ( & V_37 -> V_66 , V_37 -> V_67 ) ;
V_59 |= F_27 ( & V_37 -> V_68 , 0 ) ;
if ( V_59 )
return 3 ;
if ( V_59 )
return 4 ;
