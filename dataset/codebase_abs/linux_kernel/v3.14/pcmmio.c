...
static int F_31 ( unsigned long V_9 , unsigned int V_82 )
{
unsigned char V_83 ;
while ( V_82 -- ) {
V_83 = F_9 ( V_9 + V_84 ) ;
...
static int F_38 ( unsigned long V_9 , unsigned int V_82 )
{
unsigned char V_83 ;
while ( V_82 -- ) {
V_83 = F_9 ( V_9 + V_95 ) ;
...
F_3 ( F_41 ( V_61 ) , V_9 + V_98 ) ;
F_3 ( 0 , V_9 + V_99 ) ;
F_3 ( V_38 | V_100 , V_9 + V_101 ) ;
V_25 = F_38 ( V_9 , 100000 ) ;
if ( V_25 )
return V_25 ;
for ( V_40 = 0 ; V_40 < V_16 -> V_24 ; V_40 ++ ) {
V_3 = V_17 [ V_40 ] ;
...
static int F_42 ( struct V_1 * V_2 , struct V_103 * V_104 )
{
struct V_6 * V_7 ;
struct V_13 * V_14 ;
int V_25 ;
V_25 = F_43 ( V_2 , V_104 -> V_105 [ 0 ] , 32 ) ;
if ( V_25 )
return V_25 ;
V_7 = F_44 ( V_2 , sizeof( * V_7 ) ) ;
if ( ! V_7 )
return - V_106 ;
F_45 ( & V_7 -> V_11 ) ;
F_45 ( & V_7 -> V_41 ) ;
F_14 ( V_2 ) ;
if ( V_104 -> V_105 [ 1 ] ) {
V_25 = F_46 ( V_104 -> V_105 [ 1 ] , F_20 , 0 ,
V_2 -> V_107 , V_2 ) ;
if ( V_25 == 0 ) {
