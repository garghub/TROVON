...
{
struct V_22 * V_26 = F_21 ( & V_48 -> V_2 ) ;
...
V_50 -> V_53 . V_38 = F_24 ( V_26 -> V_36 , V_33 ) ;
if ( V_50 -> V_53 . V_38 == NULL ) {
F_16 ( & V_48 -> V_2 , L_13 ) ;
V_32 = - V_34 ;
goto V_54;
}
V_50 -> V_8 = F_25 ( V_26 -> V_8 ,
