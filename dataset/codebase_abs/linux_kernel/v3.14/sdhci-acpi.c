...
V_5 = V_35 | V_36 ;
V_32 = F_22 ( V_27 , V_23 , F_13 , V_5 , L_1 , V_29 ) ;
if ( V_32 )
goto V_34;
return 0 ;
V_34:
...
if ( F_27 ( V_16 , & V_26 ) )
return - V_43 ;
if ( F_28 ( V_26 ) || ! V_26 -> V_19 . V_44 )
return - V_43 ;
V_11 = F_29 ( V_26 ) ;
V_41 = F_30 ( V_38 , V_45 , 0 ) ;
if ( ! V_41 )
return - V_46 ;
V_42 = F_31 ( V_41 ) ;
if ( V_42 < 0x100 )
F_32 ( V_27 , L_3 ) ;
if ( ! F_33 ( V_27 , V_41 -> V_47 , V_42 , F_34 ( V_27 ) ) )
return - V_46 ;
V_7 = F_35 ( V_27 , sizeof( struct V_1 ) ) ;
if ( F_18 ( V_7 ) )
return F_19 ( V_7 ) ;
V_2 = F_36 ( V_7 ) ;
V_2 -> V_7 = V_7 ;
...
V_7 -> V_29 -> V_61 |= V_2 -> V_4 -> V_58 -> V_61 ;
V_7 -> V_29 -> V_62 |= V_2 -> V_4 -> V_58 -> V_62 ;
V_7 -> V_29 -> V_63 |= V_2 -> V_4 -> V_58 -> V_63 ;
}
V_7 -> V_59 |= V_2 -> V_4 -> V_59 ;
V_7 -> V_60 |= V_2 -> V_4 -> V_60 ;
V_7 -> V_29 -> V_61 |= V_2 -> V_4 -> V_61 ;
V_7 -> V_29 -> V_62 |= V_2 -> V_4 -> V_62 ;
V_7 -> V_29 -> V_63 |= V_2 -> V_4 -> V_63 ;
}
V_7 -> V_29 -> V_62 |= V_64 ;
V_32 = F_43 ( V_7 ) ;
if ( V_32 )
