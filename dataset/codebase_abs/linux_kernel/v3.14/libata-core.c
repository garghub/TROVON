...
case V_521 :
if ( V_194 -> V_68 . V_72 != V_541 &&
V_194 -> V_68 . V_72 != V_542 )
break;
case V_525 :
case V_543 :
...
while ( V_550 ) {
struct V_193 * V_194 ;
unsigned int V_108 = F_224 ( V_550 ) ;
...
V_194 -> V_42 |= V_235 ;
V_5 -> V_220 |= 1 << V_194 -> V_108 ;
if ( F_200 ( F_227 ( V_551 ) &&
( ! V_194 -> V_230 || ! V_194 -> V_202 || ! V_194 -> V_232 ) ) )
goto V_552;
if ( F_228 ( V_551 ) || ( F_218 ( V_551 ) &&
( V_5 -> V_42 & V_553 ) ) )
if ( F_207 ( V_194 ) )
goto V_552;
if ( F_5 ( V_194 -> V_15 -> V_42 & V_547 ) ) {
V_3 -> V_540 . V_494 |= V_554 ;
F_229 ( & V_3 -> V_540 , L_155 ) ;
F_230 ( V_3 ) ;
return;
}
V_5 -> V_214 -> V_555 ( V_194 ) ;
V_194 -> V_158 |= V_5 -> V_214 -> V_556 ( V_194 ) ;
if ( F_5 ( V_194 -> V_158 ) )
goto V_557;
return;
V_552:
...
{
struct V_4 * V_5 = V_3 -> V_5 ;
return ( V_5 -> V_42 & V_448 ) && V_5 -> V_214 -> V_558 ;
}
int F_127 ( struct V_2 * V_3 , int V_559 , T_1 * V_560 )
{
if ( F_13 ( V_3 ) ) {
if ( F_104 ( V_3 ) )
return V_3 -> V_5 -> V_214 -> V_558 ( V_3 , V_559 , V_560 ) ;
return - V_392 ;
}
return F_231 ( V_3 , V_559 , V_560 ) ;
}
int F_153 ( struct V_2 * V_3 , int V_559 , T_1 V_560 )
{
if ( F_13 ( V_3 ) ) {
if ( F_104 ( V_3 ) )
return V_3 -> V_5 -> V_214 -> V_561 ( V_3 , V_559 , V_560 ) ;
return - V_392 ;
}
return F_232 ( V_3 , V_559 , V_560 ) ;
}
int F_185 ( struct V_2 * V_3 , int V_559 , T_1 V_560 )
{
if ( F_13 ( V_3 ) ) {
int V_181 ;
if ( F_104 ( V_3 ) ) {
V_181 = V_3 -> V_5 -> V_214 -> V_561 ( V_3 , V_559 , V_560 ) ;
if ( V_181 == 0 )
V_181 = V_3 -> V_5 -> V_214 -> V_558 ( V_3 , V_559 , & V_560 ) ;
return V_181 ;
}
return - V_392 ;
}
...
static int F_233 ( struct V_4 * V_5 , T_6 V_563 ,
unsigned int V_494 , unsigned int V_564 ,
int * V_565 )
{
struct V_2 * V_3 ;
unsigned long V_42 ;
...
static int F_235 ( struct V_4 * V_5 , T_6 V_563 , int * V_565 )
{
unsigned int V_564 = V_569 | V_570 |
V_571 ;
return F_233 ( V_5 , V_563 , 0 , V_564 , V_565 ) ;
}
static int F_236 ( struct V_21 * V_15 , T_6 V_563 )
{
struct V_4 * V_5 = F_237 ( V_15 ) ;
return F_235 ( V_5 , V_563 , NULL ) ;
}
...
if ( F_239 ( V_15 ) )
return 0 ;
return F_236 ( V_15 , V_573 ) ;
}
static int F_241 ( struct V_21 * V_15 )
{
return F_236 ( V_15 , V_574 ) ;
}
static int F_242 ( struct V_4 * V_5 , T_6 V_563 ,
int * V_565 )
{
int V_181 ;
V_181 = F_233 ( V_5 , V_563 , V_554 ,
V_570 | V_569 , V_565 ) ;
return V_181 ;
}
static int F_243 ( struct V_21 * V_15 , T_6 V_563 )
{
struct V_4 * V_5 = F_237 ( V_15 ) ;
return F_242 ( V_5 , V_563 , NULL ) ;
}
static int F_244 ( struct V_21 * V_15 )
{
int V_181 ;
V_181 = F_243 ( V_15 , V_575 ) ;
if ( ! V_181 ) {
F_245 ( V_15 ) ;
F_246 ( V_15 ) ;
F_247 ( V_15 ) ;
...
{
return F_236 ( V_15 , V_576 ) ;
}
static int F_251 ( struct V_21 * V_15 )
{
return F_243 ( V_15 , V_577 ) ;
}
int F_252 ( struct V_4 * V_5 , int * V_565 )
{
return F_235 ( V_5 , V_572 , V_565 ) ;
}
int F_253 ( struct V_4 * V_5 , int * V_565 )
{
return F_242 ( V_5 , V_575 , V_565 ) ;
}
int F_254 ( struct V_519 * V_273 , T_6 V_563 )
{
V_273 -> V_15 -> V_578 . V_579 = V_563 ;
return 0 ;
}
void F_255 ( struct V_519 * V_273 )
{
V_273 -> V_15 -> V_578 . V_579 = V_580 ;
}
...
T_2 V_136 ;
int V_181 ;
V_181 = F_127 ( V_3 , V_388 , & V_3 -> V_588 ) ;
if ( V_181 )
return V_181 ;
V_136 = ( V_3 -> V_588 >> 4 ) & 0xf ;
if ( V_136 )
V_3 -> V_40 &= ( 1 << V_136 ) - 1 ;
F_12 ( V_3 ) ;
V_3 -> V_281 = V_3 -> V_40 ;
...
struct V_4 * V_5 ;
F_30 ( L_130 ) ;
V_5 = F_261 ( sizeof( * V_5 ) , V_589 ) ;
if ( ! V_5 )
return NULL ;
V_5 -> V_211 |= V_590 | V_212 ;
...
V_5 -> V_593 = 0x00FF ;
#elif F_262 ( V_594 )
V_5 -> V_593 = V_595 | V_596 | V_597 | V_598 | V_599 ;
#else
V_5 -> V_593 = V_595 | V_599 | V_598 ;
#endif
F_263 ( & V_5 -> V_600 ) ;
F_264 ( & V_5 -> V_601 , V_602 ) ;
F_265 ( & V_5 -> V_603 , V_604 ) ;
F_266 ( & V_5 -> V_605 ) ;
F_267 ( & V_5 -> V_606 ) ;
F_268 ( & V_5 -> V_607 ) ;
F_269 ( & V_5 -> V_608 ) ;
V_5 -> V_608 . V_609 = V_610 ;
V_5 -> V_608 . V_611 = ( unsigned long ) V_5 ;
V_5 -> V_33 = V_34 ;
F_257 ( V_5 , & V_5 -> V_3 , 0 ) ;
#ifdef F_270
V_5 -> V_612 . V_613 = 1 ;
...
static void F_272 ( struct V_21 * V_615 , void * V_616 )
{
struct V_519 * V_273 = F_273 ( V_615 ) ;
int V_25 ;
for ( V_25 = 0 ; V_25 < V_273 -> V_617 ; V_25 ++ ) {
struct V_4 * V_5 = V_273 -> V_618 [ V_25 ] ;
if ( ! V_5 )
continue;
if ( V_5 -> V_293 )
F_274 ( V_5 -> V_293 ) ;
...
F_275 ( V_5 -> V_12 ) ;
F_275 ( V_5 ) ;
V_273 -> V_618 [ V_25 ] = NULL ;
}
F_276 ( V_615 , NULL ) ;
}
struct V_519 * F_277 ( struct V_21 * V_15 , int V_619 )
{
struct V_519 * V_273 ;
T_5 V_620 ;
int V_25 ;
F_30 ( L_130 ) ;
if ( ! F_278 ( V_15 , NULL , V_589 ) )
return NULL ;
V_620 = sizeof( struct V_519 ) + ( V_619 + 1 ) * sizeof( void * ) ;
V_273 = F_279 ( F_272 , V_620 , V_589 ) ;
if ( ! V_273 )
goto V_264;
F_280 ( V_15 , V_273 ) ;
F_276 ( V_15 , V_273 ) ;
...
V_273 -> V_15 = V_15 ;
V_273 -> V_617 = V_619 ;
for ( V_25 = 0 ; V_25 < V_619 ; V_25 ++ ) {
struct V_4 * V_5 ;
V_5 = F_260 ( V_273 ) ;
if ( ! V_5 )
goto V_264;
V_5 -> V_622 = V_25 ;
V_273 -> V_618 [ V_25 ] = V_5 ;
}
F_282 ( V_15 , NULL ) ;
return V_273 ;
V_264:
...
const struct V_623 * const * V_624 ,
int V_617 )
{
const struct V_623 * V_625 ;
struct V_519 * V_273 ;
int V_25 , V_337 ;
V_273 = F_277 ( V_15 , V_617 ) ;
if ( ! V_273 )
return NULL ;
for ( V_25 = 0 , V_337 = 0 , V_625 = NULL ; V_25 < V_273 -> V_617 ; V_25 ++ ) {
struct V_4 * V_5 = V_273 -> V_618 [ V_25 ] ;
if ( V_624 [ V_337 ] )
V_625 = V_624 [ V_337 ++ ] ;
V_5 -> V_44 = V_625 -> V_44 ;
...
V_5 -> V_46 = V_625 -> V_46 ;
V_5 -> V_42 |= V_625 -> V_42 ;
V_5 -> V_3 . V_42 |= V_625 -> V_626 ;
V_5 -> V_214 = V_625 -> V_627 ;
if ( ! V_273 -> V_214 && ( V_625 -> V_627 != & V_628 ) )
V_273 -> V_214 = V_625 -> V_627 ;
}
return V_273 ;
}
...
static void F_286 ( struct V_21 * V_615 , void * V_616 )
{
struct V_519 * V_273 = F_273 ( V_615 ) ;
int V_25 ;
F_87 ( ! ( V_273 -> V_42 & V_631 ) ) ;
for ( V_25 = 0 ; V_25 < V_273 -> V_617 ; V_25 ++ ) {
struct V_4 * V_5 = V_273 -> V_618 [ V_25 ] ;
if ( V_5 -> V_214 -> V_632 )
V_5 -> V_214 -> V_632 ( V_5 ) ;
}
if ( V_273 -> V_214 -> V_633 )
V_273 -> V_214 -> V_633 ( V_273 ) ;
}
static void F_287 ( struct V_634 * V_214 )
{
static F_288 ( V_210 ) ;
const struct V_634 * V_481 ;
void * * V_635 = ( void * * ) V_214 ;
void * * V_636 = ( void * * ) & V_214 -> V_637 ;
void * * V_638 ;
if ( ! V_214 || ! V_214 -> V_637 )
return;
F_289 ( & V_210 ) ;
for ( V_481 = V_214 -> V_637 ; V_481 ; V_481 = V_481 -> V_637 ) {
void * * V_639 = ( void * * ) V_481 ;
for ( V_638 = V_635 ; V_638 < V_636 ; V_638 ++ , V_639 ++ )
if ( ! * V_638 )
* V_638 = * V_639 ;
}
for ( V_638 = V_635 ; V_638 < V_636 ; V_638 ++ )
if ( F_290 ( * V_638 ) )
* V_638 = NULL ;
V_214 -> V_637 = NULL ;
F_291 ( & V_210 ) ;
...
static void F_300 ( void * V_611 , T_7 V_646 )
{
struct V_4 * V_5 = V_611 ;
if ( ! ( V_5 -> V_273 -> V_42 & V_468 ) && V_5 -> V_622 != 0 )
F_301 ( V_646 ) ;
( void ) F_299 ( V_5 ) ;
F_301 ( V_646 ) ;
F_302 ( V_5 , 1 ) ;
}
int F_303 ( struct V_519 * V_273 , struct V_647 * V_648 )
{
int V_25 , V_181 ;
if ( ! ( V_273 -> V_42 & V_631 ) ) {
...
for ( V_25 = V_273 -> V_617 ; V_273 -> V_618 [ V_25 ] ; V_25 ++ )
F_275 ( V_273 -> V_618 [ V_25 ] ) ;
for ( V_25 = 0 ; V_25 < V_273 -> V_617 ; V_25 ++ ) {
V_273 -> V_618 [ V_25 ] -> V_31 = F_304 ( & V_649 ) ;
V_273 -> V_618 [ V_25 ] -> V_591 = V_25 + 1 ;
}
for ( V_25 = 0 ; V_25 < V_273 -> V_617 ; V_25 ++ ) {
V_181 = F_305 ( V_273 -> V_15 , V_273 -> V_618 [ V_25 ] ) ;
if ( V_181 ) {
goto V_650;
}
}
V_181 = F_306 ( V_273 , V_648 ) ;
if ( V_181 )
goto V_650;
for ( V_25 = 0 ; V_25 < V_273 -> V_617 ; V_25 ++ ) {
struct V_4 * V_5 = V_273 -> V_618 [ V_25 ] ;
...
V_650:
while ( -- V_25 >= 0 ) {
F_309 ( V_273 -> V_618 [ V_25 ] ) ;
}
return V_181 ;
}
int F_310 ( struct V_519 * V_273 , int V_651 ,
...
if ( ! V_651 ) {
F_87 ( V_652 ) ;
return F_303 ( V_273 , V_648 ) ;
}
V_181 = F_311 ( V_273 -> V_15 , V_651 , V_652 , V_653 ,
F_312 ( V_273 -> V_15 ) , V_273 ) ;
if ( V_181 )
return V_181 ;
for ( V_25 = 0 ; V_25 < V_273 -> V_617 ; V_25 ++ )
F_313 ( V_273 -> V_618 [ V_25 ] , L_162 , V_651 ) ;
V_181 = F_303 ( V_273 , V_648 ) ;
if ( V_181 )
F_314 ( V_273 -> V_15 , V_651 , V_273 ) ;
return V_181 ;
}
...
void F_319 ( struct V_519 * V_273 )
{
int V_25 ;
for ( V_25 = 0 ; V_25 < V_273 -> V_617 ; V_25 ++ )
F_315 ( V_273 -> V_618 [ V_25 ] ) ;
F_320 ( V_273 ) ;
}
void F_321 ( struct V_658 * V_659 )
{
struct V_519 * V_273 = F_322 ( V_659 ) ;
F_319 ( V_273 ) ;
}
...
case 1 : {
T_2 V_662 = 0 ;
F_324 ( V_659 , V_132 -> V_559 , & V_662 ) ;
V_386 = V_662 ;
break;
}
case 2 : {
T_4 V_663 = 0 ;
F_325 ( V_659 , V_132 -> V_559 , & V_663 ) ;
V_386 = V_663 ;
break;
}
case 4 : {
T_1 V_664 = 0 ;
F_326 ( V_659 , V_132 -> V_559 , & V_664 ) ;
V_386 = V_664 ;
break;
}
default:
...
V_386 &= V_132 -> V_390 ;
return ( V_386 == V_132 -> V_560 ) ? 1 : 0 ;
}
void F_327 ( struct V_658 * V_659 , T_6 V_563 )
{
F_328 ( V_659 ) ;
F_329 ( V_659 ) ;
if ( V_563 . V_665 & V_666 )
F_330 ( V_659 , V_667 ) ;
}
...
int F_335 ( struct V_658 * V_659 , T_6 V_563 )
{
struct V_519 * V_273 = F_322 ( V_659 ) ;
int V_181 = 0 ;
V_181 = F_254 ( V_273 , V_563 ) ;
if ( V_181 )
return V_181 ;
F_327 ( V_659 , V_563 ) ;
return 0 ;
...
{
struct V_519 * V_273 = F_338 ( V_659 ) ;
F_319 ( V_273 ) ;
return 0 ;
}
...
{ L_209 , . V_41 = V_674 } ,
{ L_210 , . V_41 = V_675 } ,
{ L_211 , . V_41 = V_674 | V_675 } ,
{ L_212 , . V_41 = V_676 } ,
{ L_213 , . V_49 = V_356 } ,
{ L_214 , . V_49 = V_316 } ,
} ;
char * V_464 = * V_481 , * V_148 = * V_481 ;
char * V_143 , * V_560 , * V_677 ;
...
if ( V_148 ) {
* V_148 ++ = '\0' ;
V_670 -> V_21 = F_341 ( V_148 , & V_677 , 10 ) ;
if ( V_148 == V_677 || * V_677 != '\0' ) {
* V_255 = L_215 ;
return - V_119 ;
}
}
V_670 -> V_30 = F_341 ( V_143 , & V_677 , 10 ) ;
if ( V_148 == V_677 || * V_677 != '\0' ) {
* V_255 = L_216 ;
return - V_119 ;
}
...
if ( strncasecmp ( V_560 , V_681 -> V_35 , strlen ( V_560 ) ) )
continue;
V_679 ++ ;
V_678 = V_681 ;
if ( strcasecmp ( V_560 , V_681 -> V_35 ) == 0 ) {
V_679 = 1 ;
break;
}
}
...
for ( V_148 = V_686 ; * V_148 ; V_148 ++ )
if ( * V_148 == ',' )
V_683 ++ ;
V_29 = F_261 ( sizeof( V_29 [ 0 ] ) * V_683 , V_589 ) ;
if ( ! V_29 ) {
F_343 ( V_687 L_219
L_220 ) ;
return;
...
void F_174 ( struct V_4 * V_5 , unsigned int V_692 )
{
...
T_1 F_354 ( struct V_4 * V_5 , void T_11 * V_559 , T_1 V_390 , T_1 V_560 ,
...
while ( ( V_386 & V_390 ) == V_560 && F_173 ( V_465 , V_463 ) ) {
F_174 ( V_5 , V_477 ) ;
V_386 = F_355 ( V_559 ) ;
}
return V_386 ;
...
int F_358 ( const struct V_4 * V_5 , const char * V_696 ,
const char * V_697 , ... )
{
struct V_698 V_699 ;
T_12 args ;
...
V_699 . V_697 = V_697 ;
V_699 . V_701 = & args ;
V_700 = F_343 ( L_225 , V_696 , V_5 -> V_31 , & V_699 ) ;
va_end ( args ) ;
return V_700 ;
}
int F_359 ( const struct V_2 * V_3 , const char * V_696 ,
const char * V_697 , ... )
{
struct V_698 V_699 ;
T_12 args ;
...
int F_360 ( const struct V_14 * V_15 , const char * V_696 ,
const char * V_697 , ... )
{
struct V_698 V_699 ;
T_12 args ;
...
void F_361 ( const struct V_21 * V_15 , const char * V_702 )
{
F_362 ( V_271 , V_15 , L_227 , V_702 ) ;
}
