...
{
struct V_24 * V_24 ;
struct V_25 * V_26 = F_13 ( & V_51 -> V_2 ) ;
int V_6 ;
bool V_53 = false ;
if ( ! V_26 ) {
F_2 ( & V_51 -> V_2 , L_9 ) ;
...
V_24 = F_14 ( & V_51 -> V_2 , sizeof( struct V_24 ) , V_54 ) ;
if ( ! V_24 ) {
F_2 ( & V_51 -> V_2 , L_10 ) ;
return - V_55 ;
}
...
return V_6 ;
if ( V_51 -> V_58 ) {
V_6 = F_19 ( V_24 , V_51 -> V_58 , V_26 -> V_59 ) ;
if ( V_6 )
F_10 ( & V_51 -> V_2 , L_12 , V_6 ) ;
else
V_53 = true ;
}
V_6 = F_20 ( V_24 -> V_2 , - 1 , V_60 ,
F_21 ( V_60 ) , NULL , 0 , NULL ) ;
if ( V_6 ) {
