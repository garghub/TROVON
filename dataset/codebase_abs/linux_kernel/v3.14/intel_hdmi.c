...
int V_121 = V_102 -> V_58 . V_108 * 3 / 2 ;
int V_122 = F_67 ( V_2 ) ;
int V_123 ;
if ( V_2 -> V_124 ) {
if ( V_2 -> V_71 &&
...
if ( F_50 ( V_4 ) && ! F_4 ( V_4 ) )
V_102 -> V_126 = true ;
if ( V_102 -> V_93 > 8 * 3 && V_2 -> V_71 &&
V_121 <= V_122 && F_50 ( V_4 ) ) {
F_74 ( L_9 ) ;
V_123 = 12 * 3 ;
V_102 -> V_107 = V_121 ;
} else {
...
static enum V_128
F_75 ( struct V_17 * V_18 , bool V_129 )
{
...
F_95 ( V_6 , V_49 , F_98 ( V_70 ) , 0x2b245f5f ) ;
F_95 ( V_6 , V_49 , F_99 ( V_70 ) , 0x5578b83a ) ;
F_95 ( V_6 , V_49 , F_100 ( V_70 ) , 0x0c782040 ) ;
F_95 ( V_6 , V_49 , F_101 ( V_70 ) , 0x2b247878 ) ;
F_95 ( V_6 , V_49 , F_102 ( V_70 ) , 0x00030000 ) ;
F_95 ( V_6 , V_49 , F_103 ( V_70 ) , 0x00002000 ) ;
F_95 ( V_6 , V_49 , F_97 ( V_70 ) , V_158 ) ;
F_95 ( V_6 , V_49 , F_104 ( V_70 ) , 0x00760018 ) ;
F_95 ( V_6 , V_49 , F_105 ( V_70 ) , 0x00400888 ) ;
F_106 ( & V_6 -> V_157 ) ;
F_61 ( V_13 ) ;
F_107 ( V_6 , V_155 ) ;
}
...
struct V_84 * V_84 ;
struct V_165 * V_165 ;
V_15 = F_127 ( sizeof( * V_15 ) , V_185 ) ;
if ( ! V_15 )
return;
V_165 = F_127 ( sizeof( * V_165 ) , V_185 ) ;
if ( ! V_165 ) {
F_82 ( V_15 ) ;
return;
}
V_84 = & V_15 -> V_3 ;
F_128 ( V_4 , & V_84 -> V_3 , & V_186 ,
V_187 ) ;
V_84 -> V_188 = F_72 ;
V_84 -> V_189 = F_49 ;
V_84 -> V_190 = F_64 ;
