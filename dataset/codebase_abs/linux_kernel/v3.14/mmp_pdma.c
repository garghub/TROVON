...
V_2 -> V_7 = V_28 -> V_7 ;
if ( V_22 ) {
V_30 = F_66 ( V_28 -> V_21 , V_22 , F_10 , 0 ,
L_10 , V_2 ) ;
if ( V_30 ) {
F_31 ( V_28 -> V_21 , L_11 ) ;
return V_30 ;
...
F_32 ( & V_35 -> V_45 ) ;
F_32 ( & V_35 -> V_47 ) ;
F_47 ( & V_35 -> V_35 . V_145 , & V_28 -> V_36 . V_146 ) ;
return 0 ;
}
...
struct V_61 * V_35 ;
V_35 = F_70 ( & V_151 -> V_36 ) ;
if ( ! V_35 )
return NULL ;
F_25 ( V_35 ) -> V_10 = V_148 -> args [ 0 ] ;
return V_35 ;
}
...
struct V_155 * V_156 = F_72 ( & V_143 -> V_21 ) ;
struct V_157 * V_158 ;
...
F_67 ( & V_28 -> V_39 ) ;
V_158 = F_73 ( V_143 , V_159 , 0 ) ;
V_28 -> V_7 = F_74 ( V_28 -> V_21 , V_158 ) ;
if ( F_75 ( V_28 -> V_7 ) )
return F_76 ( V_28 -> V_7 ) ;
V_154 = F_77 ( V_160 , V_28 -> V_21 ) ;
if ( V_154 )
F_78 ( V_28 -> V_21 -> V_161 , L_12 ,
& V_40 ) ;
else if ( V_156 && V_156 -> V_40 )
V_40 = V_156 -> V_40 ;
else
V_40 = 32 ;
V_28 -> V_40 = V_40 ;
...
if ( V_31 != V_40 ) {
V_22 = F_79 ( V_143 , 0 ) ;
V_30 = F_66 ( V_28 -> V_21 , V_22 , F_12 , 0 ,
L_10 , V_28 ) ;
if ( V_30 )
return V_30 ;
}
...
F_81 ( V_162 , V_28 -> V_36 . V_163 ) ;
F_81 ( V_164 , V_28 -> V_36 . V_163 ) ;
F_81 ( V_165 , V_28 -> V_36 . V_163 ) ;
F_81 ( V_166 , V_28 -> V_36 . V_163 ) ;
V_28 -> V_36 . V_21 = & V_143 -> V_21 ;
V_28 -> V_36 . V_167 = F_34 ;
V_28 -> V_36 . V_168 = F_42 ;
V_28 -> V_36 . V_169 = F_54 ;
V_28 -> V_36 . V_170 = F_44 ;
V_28 -> V_36 . V_171 = F_48 ;
V_28 -> V_36 . V_172 = F_52 ;
V_28 -> V_36 . V_173 = F_56 ;
V_28 -> V_36 . V_174 = F_53 ;
V_28 -> V_36 . V_175 = V_176 ;
if ( V_28 -> V_21 -> V_177 )
F_82 ( V_28 -> V_21 , V_28 -> V_21 -> V_177 ) ;
else
...
bool F_88 ( struct V_61 * V_35 , void * V_178 )
{
struct V_32 * V_179 = F_25 ( V_35 ) ;
if ( V_35 -> V_36 -> V_21 -> V_180 != & V_181 . V_180 )
return false ;
V_179 -> V_10 = * ( unsigned int * ) V_178 ;
return true ;
}
