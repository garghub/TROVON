...
error = F_17 ( V_11 , & V_16 , & V_25 , & V_26 ) ;
if ( error )
return error ;
F_6 ( & V_7 , V_15 , V_16 ) ;
error = F_18 ( F_2 ( V_11 ) , & V_7 , V_16 , V_23 , & V_6 ) ;
if ( F_13 ( error ) )
goto V_28;
V_1 = F_19 ( V_6 ) ;
...
T_1 V_16 )
{
return F_10 ( V_11 , V_15 , V_16 | V_33 , 0 ) ;
}
STATIC struct V_15 *
F_26 (
struct V_1 * V_11 ,
...
return F_27 ( - V_36 ) ;
F_6 ( & V_7 , V_15 , 0 ) ;
error = F_28 ( F_2 ( V_11 ) , & V_7 , & V_34 , NULL ) ;
if ( F_13 ( error ) ) {
if ( F_13 ( error != V_37 ) )
return F_27 ( - error ) ;
F_29 ( V_15 , NULL ) ;
...
return F_27 ( - V_36 ) ;
F_6 ( & V_38 , V_15 , 0 ) ;
error = F_28 ( F_2 ( V_11 ) , & V_38 , & V_6 , & V_39 ) ;
if ( F_13 ( error ) ) {
if ( F_13 ( error != V_37 ) )
return F_27 ( - error ) ;
return NULL ;
...
if ( ! V_39 . V_7 )
return F_30 ( F_19 ( V_6 ) , V_15 ) ;
V_40 . V_7 = V_39 . V_7 ;
V_40 . V_18 = V_39 . V_18 ;
V_15 = F_32 ( V_15 , F_19 ( V_6 ) , & V_40 ) ;
F_33 ( V_39 . V_7 ) ;
return V_15 ;
}
STATIC int
...
error = F_35 ( F_2 ( V_11 ) , F_2 ( V_1 ) , & V_7 ) ;
if ( F_13 ( error ) )
return - error ;
F_36 ( V_1 ) ;
F_22 ( V_15 , V_1 ) ;
...
( V_48 ? 0777 & ~ F_42 () : V_49 ) ;
F_6 ( & V_7 , V_15 , V_16 ) ;
error = F_43 ( F_2 ( V_11 ) , & V_7 , V_46 , V_16 , & V_34 ) ;
if ( F_13 ( error ) )
goto V_50;
V_1 = F_19 ( V_34 ) ;
error = F_4 ( V_1 , V_11 , & V_15 -> V_17 ) ;
...
return - F_45 ( F_2 ( V_51 ) , & V_56 , F_2 ( V_52 -> V_42 ) ,
F_2 ( V_53 ) , & V_57 , V_55 ?
F_2 ( V_55 ) : NULL ) ;
}
STATIC void *
...
char * V_60 ;
int error = - V_61 ;
V_60 = F_47 ( V_62 + 1 , V_63 ) ;
if ( ! V_60 )
goto V_64;
error = - F_48 ( F_2 ( V_15 -> V_42 ) , V_60 ) ;
if ( F_13 ( error ) )
goto V_65;
F_49 ( V_59 , V_60 ) ;
return NULL ;
...
V_69 -> ctime = V_1 -> V_91 ;
V_69 -> V_92 =
F_56 ( V_71 , V_6 -> V_77 . V_93 + V_6 -> V_94 ) ;
switch ( V_1 -> V_43 & V_20 ) {
case V_95 :
case V_96 :
V_69 -> V_97 = V_98 ;
V_69 -> V_23 = F_57 ( F_58 ( V_6 -> V_99 . V_100 . V_101 ) & 0x1ff ,
F_59 ( V_6 -> V_99 . V_100 . V_101 ) ) ;
break;
default:
if ( F_60 ( V_6 ) ) {
V_69 -> V_97 =
F_61 ( V_6 ) << V_71 -> V_45 . V_102 ;
} else
V_69 -> V_97 = F_62 ( V_71 ) ;
V_69 -> V_23 = 0 ;
break;
...
if ( F_53 ( V_71 ) )
return F_54 ( V_73 ) ;
error = - F_68 ( V_1 , V_103 ) ;
if ( error )
return F_54 ( error ) ;
}
ASSERT ( ( V_120 & V_135 ) == 0 ) ;
if ( F_69 ( V_71 ) && ( V_120 & ( V_136 | V_137 ) ) ) {
T_7 V_138 = 0 ;
if ( ( V_120 & V_136 ) && F_70 ( V_71 ) ) {
V_81 = V_103 -> V_139 ;
V_138 |= V_140 ;
} else {
V_81 = V_1 -> V_82 ;
}
if ( ( V_120 & V_137 ) && F_71 ( V_71 ) ) {
V_83 = V_103 -> V_141 ;
V_138 |= V_142 ;
} else {
V_83 = V_1 -> V_84 ;
...
V_121 = F_76 ( V_71 , V_143 ) ;
error = F_77 ( V_121 , & F_78 ( V_71 ) -> V_144 , 0 , 0 ) ;
if ( error )
goto V_145;
F_79 ( V_6 , V_105 ) ;
...
if ( F_80 ( V_71 ) &&
( ( F_70 ( V_71 ) && ! F_81 ( V_123 , V_81 ) ) ||
( F_71 ( V_71 ) && ! F_82 ( V_125 , V_83 ) ) ) ) {
ASSERT ( V_121 ) ;
error = F_83 ( V_121 , V_6 , V_127 , V_128 ,
NULL , F_84 ( V_146 ) ?
V_147 : 0 ) ;
if ( error )
goto V_148;
...
if ( ! F_81 ( V_123 , V_81 ) ) {
if ( F_80 ( V_71 ) && F_70 ( V_71 ) ) {
ASSERT ( V_120 & V_136 ) ;
ASSERT ( V_127 ) ;
V_129 = F_86 ( V_121 , V_6 ,
& V_6 -> V_152 , V_127 ) ;
}
V_6 -> V_77 . V_153 = F_73 ( V_81 ) ;
V_1 -> V_82 = V_81 ;
}
if ( ! F_82 ( V_125 , V_83 ) ) {
if ( F_80 ( V_71 ) && F_71 ( V_71 ) ) {
ASSERT ( F_87 ( & V_71 -> V_45 ) ||
! F_88 ( V_71 ) ) ;
ASSERT ( V_120 & V_137 ) ;
ASSERT ( V_128 ) ;
V_130 = F_86 ( V_121 , V_6 ,
& V_6 -> V_154 , V_128 ) ;
}
V_6 -> V_77 . V_155 = F_74 ( V_83 ) ;
V_1 -> V_84 = V_83 ;
}
}
if ( V_120 & V_156 )
...
if ( error )
return F_54 ( error ) ;
ASSERT ( F_64 ( V_6 , V_165 ) ) ;
ASSERT ( F_98 ( V_6 -> V_77 . V_78 ) ) ;
...
return 0 ;
V_103 -> V_106 &= ~ V_135 ;
return F_66 ( V_6 , V_103 , 0 ) ;
}
error = F_99 ( V_6 , 0 ) ;
if ( error )
return error ;
if ( V_161 > V_160 ) {
error = F_100 ( V_6 , V_161 , V_160 ) ;
if ( error )
return error ;
}
if ( V_160 != V_6 -> V_77 . V_173 && V_161 > V_6 -> V_77 . V_173 ) {
error = - F_101 ( F_19 ( V_6 ) -> V_174 ,
V_6 -> V_77 . V_173 , V_161 ) ;
if ( error )
return error ;
}
F_102 ( V_1 ) ;
error = - F_103 ( V_1 -> V_174 , V_161 , V_175 ) ;
if ( error )
return error ;
V_121 = F_76 ( V_71 , V_176 ) ;
error = F_77 ( V_121 , & F_78 ( V_71 ) -> V_177 , 0 , 0 ) ;
if ( error )
goto V_148;
F_104 ( V_1 , V_161 ) ;
V_164 = V_178 ;
...
F_89 ( V_121 , V_6 , V_157 ) ;
if ( V_161 <= V_160 ) {
error = F_106 ( & V_121 , V_6 , V_179 , V_161 ) ;
if ( error )
goto V_180;
F_107 ( V_6 , V_181 ) ;
F_108 ( V_6 ) ;
...
F_79 ( V_6 , V_165 ) ;
error = F_97 ( V_6 , V_103 ) ;
F_93 ( V_6 , V_165 ) ;
} else {
error = F_66 ( V_6 , V_103 , 0 ) ;
}
return - error ;
}
STATIC int
...
int error ;
F_111 ( V_6 ) ;
V_121 = F_76 ( V_71 , V_186 ) ;
error = F_77 ( V_121 , & F_78 ( V_71 ) -> V_187 , 0 , 0 ) ;
if ( error ) {
F_96 ( V_121 , 0 ) ;
return - error ;
}
...
F_85 ( V_121 , V_6 , V_105 ) ;
F_89 ( V_121 , V_6 , V_192 ) ;
return - F_92 ( V_121 , 0 ) ;
}
STATIC int
F_112 (
...
if ( V_195 -> V_203 == - 1LL )
return 0 ;
V_200 = F_113 ( V_195 -> V_204 ) ;
V_201 = F_113 ( V_195 -> V_203 ) ;
V_202 = F_113 ( V_195 -> V_205 ) ;
...
struct V_194 V_215 ;
int error ;
error = F_116 ( V_198 , V_216 ) ;
if ( error )
return error ;
V_215 . V_204 = F_117 ( V_214 ) ;
if ( V_202 == V_217 )
V_215 . V_205 = - 1LL ;
else
V_215 . V_205 = F_117 ( V_202 ) ;
V_215 . V_218 = ! V_198 -> V_219 ? V_220 :
V_198 -> V_219 + 1 ;
V_215 . V_218 = F_118 ( V_221 , V_215 . V_218 ,
...
V_215 . V_223 |= V_230 ;
error = F_119 ( V_6 , & V_215 , F_112 , V_198 ) ;
if ( error )
return - error ;
return 0 ;
}
...
F_124 ( V_1 , V_6 -> V_77 . V_80 ) ;
V_1 -> V_82 = F_125 ( V_6 -> V_77 . V_153 ) ;
V_1 -> V_84 = F_126 ( V_6 -> V_77 . V_155 ) ;
switch ( V_1 -> V_43 & V_20 ) {
case V_95 :
case V_96 :
V_1 -> V_246 =
F_57 ( F_58 ( V_6 -> V_99 . V_100 . V_101 ) & 0x1ff ,
F_59 ( V_6 -> V_99 . V_100 . V_101 ) ) ;
break;
default:
V_1 -> V_246 = 0 ;
...
default:
V_1 -> V_252 = & V_253 ;
F_128 ( V_1 , V_1 -> V_43 , V_1 -> V_246 ) ;
break;
}
V_242 = F_129 ( V_1 -> V_174 ) ;
F_130 ( V_1 -> V_174 , ( V_242 & ~ ( V_265 ) ) ) ;
if ( ! F_131 ( V_6 ) ) {
F_132 ( V_1 ) ;
F_133 ( V_1 ) ;
}
