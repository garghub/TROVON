...
if ( F_10 ( V_34 -> V_23 ) )
return - V_41 ;
F_11 ( V_20 -> V_42 , & V_37 , V_34 ) ;
V_4 -> V_14 += V_37 . V_23 >> ( V_15 - ( V_7 ? 5 : 0 ) ) ;
V_6 = V_34 -> V_43 & V_44 ? V_9 : V_45 ;
...
long V_52 ;
unsigned long V_53 ;
F_11 ( V_20 -> V_42 , & V_37 , & V_20 -> V_33 [ V_21 ] ) ;
...
int F_25 ( struct V_72 * V_42 , struct V_3 * V_4 ,
enum V_5 V_6 )
{
struct V_1 * V_2 = V_42 -> V_46 ;
int V_7 = F_24 ( V_2 , V_6 ) ;
unsigned long V_70 ;
V_70 = ( V_6 == V_9 ) ? V_42 -> V_73 -> V_24 :
V_42 -> V_74 -> V_24 ;
if ( ! F_23 ( V_2 , V_4 , V_70 , V_7 ) )
return - V_41 ;
return F_1 ( V_2 , V_4 , V_6 , V_7 ) ;
}
void F_26 ( struct V_72 * V_42 , enum V_5 V_6 )
{
struct V_1 * V_2 = V_42 -> V_46 ;
if ( ! F_24 ( V_2 , V_6 ) )
return;
if ( V_6 == V_9 ) {
V_42 -> V_73 -> V_31 . V_55 = L_9 ;
V_42 -> V_73 -> V_24 <<= 5 ;
} else {
V_42 -> V_74 -> V_31 . V_55 = L_10 ;
V_42 -> V_74 -> V_24 <<= 5 ;
}
return;
}
int F_27 ( struct V_72 * V_42 , T_2 V_75 , T_3 * V_76 , T_1 V_24 )
{
struct V_1 * V_2 = V_42 -> V_46 ;
V_75 += V_2 -> V_77 -> V_23 ;
switch( V_24 ) {
...
int F_31 ( struct V_72 * V_42 , T_2 V_75 , T_3 V_76 , T_1 V_24 )
{
struct V_1 * V_2 = V_42 -> V_46 ;
V_75 += V_2 -> V_77 -> V_23 ;
switch( V_24 ) {
