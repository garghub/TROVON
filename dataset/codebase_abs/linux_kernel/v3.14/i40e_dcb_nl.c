...
{
int V_76 , V_77 ;
for ( V_76 = 0 ; V_76 < V_13 -> V_2 . V_78 . V_79 ; V_76 ++ ) {
if ( V_13 -> V_57 [ V_76 ] && V_13 -> V_57 [ V_76 ] -> V_58 ) {
V_77 = F_11 ( V_13 -> V_57 [ V_76 ] , V_66 ) ;
if ( V_77 )
F_14 ( & V_13 -> V_80 -> V_9 , L_1 ,
V_81 , V_13 -> V_57 [ V_76 ] -> V_82 ,
V_77 , V_66 -> V_70 ,
V_66 -> V_72 , V_66 -> V_67 ) ;
}
}
}
static bool F_15 ( struct V_14 * V_83 ,
struct V_75 * V_66 )
{
int V_38 ;
for ( V_38 = 0 ; V_38 < V_83 -> V_65 ; V_38 ++ ) {
if ( V_66 -> V_70 == V_83 -> V_66 [ V_38 ] . V_70 &&
V_66 -> V_72 == V_83 -> V_66 [ V_38 ] . V_72 &&
V_66 -> V_67 == V_83 -> V_66 [ V_38 ] . V_67 )
return true ;
}
return false ;
}
