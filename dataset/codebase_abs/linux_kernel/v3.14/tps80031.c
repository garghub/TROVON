...
{
struct V_26 * V_27 = F_20 ( & V_95 -> V_2 ) ;
struct V_25 * V_25 ;
int V_9 ;
T_2 V_98 ;
T_2 V_99 ;
...
V_25 = F_21 ( & V_95 -> V_2 , sizeof( * V_25 ) , V_101 ) ;
if ( ! V_25 ) {
F_4 ( & V_95 -> V_2 , L_9 ) ;
return - V_102 ;
}
for ( V_32 = 0 ; V_32 < V_103 ; V_32 ++ ) {
if ( V_104 [ V_32 ] == V_95 -> V_105 )
V_25 -> V_106 [ V_32 ] = V_95 ;
else
V_25 -> V_106 [ V_32 ] = F_22 ( V_95 -> V_107 ,
V_104 [ V_32 ] ) ;
if ( ! V_25 -> V_106 [ V_32 ] ) {
...
F_23 ( V_25 -> V_106 [ V_32 ] , V_25 ) ;
V_25 -> V_50 [ V_32 ] = F_24 ( V_25 -> V_106 [ V_32 ] ,
& V_109 [ V_32 ] ) ;
if ( F_25 ( V_25 -> V_50 [ V_32 ] ) ) {
V_9 = F_26 ( V_25 -> V_50 [ V_32 ] ) ;
F_4 ( & V_95 -> V_2 ,
L_11 , V_32 , V_9 ) ;
goto V_108;
}
}
V_9 = F_27 ( & V_95 -> V_2 , V_110 ,
V_111 , & V_98 ) ;
if ( V_9 < 0 ) {
F_4 ( & V_95 -> V_2 ,
L_12 , V_9 ) ;
...
return 0 ;
V_116:
F_31 ( V_95 -> V_46 , V_25 -> V_53 ) ;
V_108:
for ( V_32 = 0 ; V_32 < V_103 ; V_32 ++ ) {
if ( V_25 -> V_106 [ V_32 ] && ( V_25 -> V_106 [ V_32 ] != V_95 ) )
F_32 ( V_25 -> V_106 [ V_32 ] ) ;
}
return V_9 ;
}
static int F_33 ( struct V_94 * V_95 )
{
struct V_25 * V_25 = F_34 ( V_95 ) ;
int V_32 ;
if ( V_22 == V_25 ) {
V_22 = NULL ;
V_118 = NULL ;
