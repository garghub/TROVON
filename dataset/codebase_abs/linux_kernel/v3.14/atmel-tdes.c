...
unsigned long V_202 ;
int V_26 ;
V_17 = F_106 ( sizeof( struct V_11 ) , V_80 ) ;
if ( V_17 == NULL ) {
F_29 ( V_29 , L_20 ) ;
V_26 = - V_78 ;
goto V_203;
...
( unsigned long ) V_17 ) ;
F_110 ( & V_17 -> V_135 , V_205 ) ;
V_17 -> V_183 = - 1 ;
V_201 = F_111 ( V_196 , V_206 , 0 ) ;
if ( ! V_201 ) {
F_29 ( V_29 , L_21 ) ;
V_26 = - V_182 ;
goto V_207;
...
V_26 = F_114 ( V_17 -> V_183 , F_94 , V_209 ,
L_23 , V_17 ) ;
if ( V_26 ) {
F_29 ( V_29 , L_24 ) ;
goto V_210;
}
V_17 -> V_21 = F_115 ( & V_196 -> V_29 , L_25 ) ;
if ( F_116 ( V_17 -> V_21 ) ) {
F_29 ( V_29 , L_26 ) ;
V_26 = F_117 ( V_17 -> V_21 ) ;
goto V_211;
}
V_17 -> V_13 = F_118 ( V_17 -> V_162 , V_202 ) ;
if ( ! V_17 -> V_13 ) {
F_29 ( V_29 , L_27 ) ;
V_26 = - V_78 ;
goto V_212;
