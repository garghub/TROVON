...
break;
case V_308 :
V_47 -> V_209 . V_294 . V_250 = V_181 -> V_184 ;
break;
case V_309 :
V_47 -> V_209 . V_294 . V_252 = V_181 -> V_184 ;
break;
case V_310 :
V_47 -> V_209 . V_294 . V_248 = V_181 -> V_184 ;
break;
case V_311 :
V_47 -> V_209 . V_294 . V_254 = V_181 -> V_184 ;
break;
case V_312 :
V_47 -> V_209 . V_294 . V_220 = V_181 -> V_184 ;
break;
default:
...
static int F_71 ( struct V_328 * V_168 ,
const struct V_329 * V_330 )
{
switch ( V_330 -> type ) {
case V_163 :
return F_72 ( V_168 , V_330 , 2 , NULL ) ;
default:
return - V_100 ;
}
}
static int F_73 ( struct V_1 * V_9 , struct V_331 * V_332 )
{
int V_5 ;
if ( ! V_9 )
return - V_100 ;
...
static int F_74 ( struct V_333 * V_334 ,
...
} else if ( V_334 -> type == V_115 ) {
if ( V_18 -> V_118 )
* V_336 = V_18 -> V_118 -> V_95 ;
else
* V_336 = V_344 ;
if ( * V_335 < 1 )
* V_335 = 1 ;
...
static void F_77 ( struct V_333 * V_346 )
{
struct V_17 * V_18 = F_38 ( V_346 -> V_339 ) ;
struct V_36 * V_37 = V_18 -> V_37 ;
F_78 ( & V_37 -> V_347 ) ;
}
static int F_79 ( struct V_331 * V_332 )
{
...
static int F_80 ( struct V_331 * V_332 )
{
struct V_333 * V_334 = V_332 -> V_333 ;
struct V_17 * V_18 = F_38 ( V_334 -> V_339 ) ;
int V_125 ;
...
return V_125 ;
F_4 ( 2 , L_45 ,
F_14 ( V_332 , 0 ) , V_18 -> V_113 ) ;
if ( F_14 ( V_332 , 0 ) < V_18 -> V_113 ) {
F_39 ( L_46 ) ;
return - V_100 ;
}
} else if ( V_334 -> type == V_115 ) {
...
return V_125 ;
F_4 ( 2 , L_47 ,
F_14 ( V_332 , 0 ) , V_18 -> V_120 ) ;
F_4 ( 2 , L_48 ,
F_14 ( V_332 , 1 ) , V_18 -> V_121 ) ;
if ( F_14 ( V_332 , 0 ) < V_18 -> V_120 ||
F_14 ( V_332 , 1 ) < V_18 -> V_121 ) {
F_39 ( L_49 ) ;
return - V_100 ;
}
...
static int F_81 ( struct V_333 * V_346 , unsigned int V_152 )
{
struct V_17 * V_18 = F_38 ( V_346 -> V_339 ) ;
struct V_36 * V_37 = V_18 -> V_37 ;
if ( F_20 ( V_37 ) &&
...
static int F_82 ( struct V_333 * V_346 )
{
unsigned long V_41 ;
struct V_17 * V_18 = F_38 ( V_346 -> V_339 ) ;
struct V_36 * V_37 = V_18 -> V_37 ;
...
static void F_83 ( struct V_331 * V_332 )
{
struct V_333 * V_334 = V_332 -> V_333 ;
struct V_17 * V_18 = F_38 ( V_334 -> V_339 ) ;
struct V_36 * V_37 = V_18 -> V_37 ;
...
if ( V_334 -> type == V_105 ) {
V_363 = & V_18 -> V_348 [ V_332 -> V_70 . V_98 ] ;
V_363 -> V_41 &= ~ V_68 ;
F_13 ( & V_37 -> V_42 , V_41 ) ;
...
V_363 = & V_18 -> V_351 [ V_332 -> V_70 . V_98 ] ;
V_363 -> V_41 &= ~ V_68 ;
F_13 ( & V_37 -> V_42 , V_41 ) ;
...
F_39 ( L_51 , V_334 -> type ) ;
}
if ( F_3 ( V_18 ) )
F_21 ( V_18 ) ;
F_15 ( V_37 -> V_44 , V_54 , V_37 ) ;
}
struct V_365 * F_84 ( void )
{
return & V_366 ;
}
struct V_367 * F_85 ( void )
{
return & V_368 ;
}
const struct V_369 * F_86 ( void )
{
return & V_370 ;
}
...
V_18 -> V_388 [ V_5 ] = F_90 ( & V_18 -> V_373 ,
& V_372 , NULL ) ;
} else {
