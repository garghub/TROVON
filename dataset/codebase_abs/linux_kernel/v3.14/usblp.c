...
struct V_35 * V_35 ;
char * V_107 ;
if ( ( V_107 = F_50 ( V_106 , V_108 ) ) == NULL )
return NULL ;
if ( ( V_35 = F_51 ( 0 , V_108 ) ) == NULL ) {
F_28 ( V_107 ) ;
return NULL ;
}
F_52 ( V_35 , V_1 -> V_3 ,
...
if ( ! ( V_1 -> V_20 & V_173 ) )
continue;
if ( V_164 -> V_154 . V_174 < V_10 ||
V_164 -> V_154 . V_174 > V_11 )
continue;
V_14 = V_15 = NULL ;
...
if ( ! V_14 || ( V_164 -> V_154 . V_174 > 1 && ! V_15 ) )
continue;
...
V_1 -> V_12 [ V_164 -> V_154 . V_174 ] . V_13 =
V_164 -> V_154 . V_177 ;
V_1 -> V_12 [ V_164 -> V_154 . V_174 ] . V_14 = V_14 ;
V_1 -> V_12 [ V_164 -> V_154 . V_174 ] . V_15 = V_15 ;
}
if ( V_178 >= V_10 &&
V_178 <= V_11 &&
V_1 -> V_12 [ V_178 ] . V_13 != - 1 )
return V_178 ;
...
return - V_85 ;
V_180 = V_1 -> V_12 [ V_12 ] . V_13 ;
if ( V_180 < 0 )
return - V_85 ;
V_179 = F_97 ( V_1 -> V_3 , V_1 -> V_9 , V_180 ) ;
if ( V_179 < 0 ) {
F_8 ( V_50 L_45 ,
V_180 , V_1 -> V_9 ) ;
return V_179 ;
...
static int F_103 ( struct V_59 * V_4 , T_6 V_182 )
{
struct V_1 * V_1 = F_24 ( V_4 ) ;
F_29 ( V_1 ) ;
#if 0
