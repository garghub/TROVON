...
static int F_63 ( struct V_51 * V_23 )
{
F_25 ( 1 ) ;
return - V_8 ;
}
...
F_65 (f, tmp, &c->functions, list) {
F_66 ( & V_56 -> V_47 , & V_44 -> V_59 ) ;
if ( V_56 -> V_93 ) {
F_67 ( & V_19 -> V_23 . V_94 -> V_95 , L_10
L_11 , V_56 -> V_1 , V_56 ) ;
V_56 -> V_93 ( V_45 , V_56 ) ;
}
}
...
static int F_68 ( struct V_100 * V_94 ,
struct V_101 * V_102 )
{
struct V_103 * V_28 = F_69 ( V_102 ) ;
...
V_19 -> V_67 [ V_105 ] = & V_87 -> V_3 ;
V_87 -> V_3 . V_107 = V_87 -> V_107 ;
V_87 -> V_107 [ V_108 ] . V_10 =
V_87 -> V_88 ;
V_87 -> V_107 [ V_109 ] . V_10 = V_87 -> V_89 ;
V_87 -> V_107 [ V_110 ] . V_10 = V_87 -> V_90 ;
V_105 ++ ;
}
V_19 -> V_67 [ V_105 ] = NULL ;
V_10 = F_72 ( & V_19 -> V_23 , V_19 -> V_67 ,
V_111 ) ;
if ( F_32 ( V_10 ) ) {
V_7 = F_33 ( V_10 ) ;
goto V_106;
}
V_19 -> V_23 . V_24 . V_112 = V_10 [ V_108 ] . V_113 ;
V_19 -> V_23 . V_24 . V_114 = V_10 [ V_109 ] . V_113 ;
V_19 -> V_23 . V_24 . V_115 = V_10 [ V_110 ] . V_113 ;
}
F_30 (c, &gi->cdev.configs, list) {
struct V_38 * V_44 ;
struct V_55 * V_56 ;
...
V_44 -> V_67 [ V_105 ] = & V_77 -> V_3 ;
V_77 -> V_3 . V_107 = & V_77 -> V_107 ;
V_77 -> V_107 . V_10 = V_77 -> V_78 ;
V_105 ++ ;
}
V_44 -> V_67 [ V_105 ] = NULL ;
V_10 = F_72 ( & V_19 -> V_23 , V_44 -> V_67 , 1 ) ;
if ( F_32 ( V_10 ) ) {
V_7 = F_33 ( V_10 ) ;
goto V_106;
}
V_45 -> V_116 = V_10 [ 0 ] . V_113 ;
}
F_65 (f, tmp, &cfg->func_list, list) {
F_28 ( & V_56 -> V_47 ) ;
V_7 = F_73 ( V_45 , V_56 ) ;
if ( V_7 ) {
F_74 ( & V_56 -> V_47 , & V_44 -> V_59 ) ;
goto V_117;
}
}
F_75 ( V_23 -> V_94 ) ;
...
static void F_77 ( struct V_100 * V_94 )
{
struct V_51 * V_23 ;
struct V_18 * V_19 ;
V_23 = F_78 ( V_94 ) ;
...
F_59 ( & V_19 -> V_84 , L_9 ,
& V_120 ) ;
V_19 -> V_28 . V_121 = F_63 ;
V_19 -> V_28 . V_93 = F_63 ;
V_19 -> V_28 . V_122 = NULL ;
V_19 -> V_28 . V_123 = NULL ;
V_19 -> V_28 . V_124 = V_125 ;
F_80 ( & V_19 -> V_30 ) ;
F_46 ( & V_19 -> V_41 ) ;
F_46 ( & V_19 -> V_42 ) ;
F_44 ( & V_19 -> V_23 ) ;
V_19 -> V_23 . V_24 . V_126 = V_127 ;
V_19 -> V_23 . V_24 . V_128 = V_129 ;
V_19 -> V_23 . V_24 . V_22 = F_8 ( F_81 () ) ;
V_19 -> V_28 . V_29 = V_130 ;
V_19 -> V_28 . V_29 . V_43 = F_4 ( V_1 , V_15 ) ;
V_19 -> V_28 . V_1 = V_19 -> V_28 . V_29 . V_43 ;
if ( ! V_19 -> V_28 . V_29 . V_43 )
goto V_31;
#ifdef F_82
V_19 -> V_131 . V_126 = sizeof( struct V_132 ) ;
V_19 -> V_131 . V_128 = V_133 ;
V_19 -> V_131 . V_63 = V_134 | V_135 ;
#endif
F_59 ( & V_19 -> V_35 , V_1 ,
& V_136 ) ;
return & V_19 -> V_35 ;
...
static void F_83 ( struct V_52 * V_35 , struct V_33 * V_34 )
{
F_55 ( V_34 ) ;
}
