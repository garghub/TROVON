...
static int F_39 ( struct V_78 * V_66 )
{
struct V_1 * V_2 = V_66 -> V_79 ;
struct V_10 * V_11 = F_2 ( V_2 ) ;
...
static int F_44 ( struct V_78 * V_66 )
{
struct V_1 * V_2 = V_66 -> V_79 ;
struct V_10 * V_11 = F_2 ( V_2 ) ;
int V_14 ;
...
static void F_45 ( struct V_78 * V_66 )
{
struct V_1 * V_2 = V_66 -> V_79 ;
struct V_10 * V_11 = F_2 ( V_2 ) ;
V_66 -> V_110 = 0 ;
...
static int F_46 ( struct V_78 * V_66 )
{
struct V_1 * V_2 = V_66 -> V_79 ;
struct V_10 * V_11 = F_2 ( V_2 ) ;
int V_14 = 0 ;
...
static void F_49 ( struct V_78 * V_66 )
{
struct V_1 * V_2 = V_66 -> V_79 ;
struct V_10 * V_11 = F_2 ( V_2 ) ;
F_47 ( & V_111 ) ;
...
static int F_50 ( struct V_78 * V_66 , int V_114 )
{
struct V_1 * V_2 = V_66 -> V_79 ;
struct V_10 * V_11 = F_2 ( V_2 ) ;
int V_14 = 0 ;
...
struct V_10 * V_11 = F_2 ( V_2 ) ;
int V_14 ;
F_52 ( & V_2 -> V_45 , L_25 , V_2 -> V_68 ) ;
V_14 = F_53 ( V_2 -> V_68 , NULL , F_22 ,
V_117 | V_118 ,
V_2 -> V_119 , V_11 ) ;
if ( V_14 < 0 ) {
F_54 ( & V_2 -> V_45 ,
...
T_5 V_131 ;
V_131 = F_57 ( & V_2 -> V_45 ) ;
if ( ! V_131 || F_58 ( V_131 , & V_130 ) )
return - V_121 ;
V_128 = F_59 ( V_131 , V_126 , 1 , 1 , NULL ,
V_132 ) ;
if ( ! V_128 ) {
F_13 ( & V_2 -> V_45 , L_35 ) ;
return - V_121 ;
}
V_125 -> V_133 = V_128 -> integer . V_134 ;
F_60 ( V_128 ) ;
return 0 ;
}
...
T_6 V_135 ;
int V_14 ;
V_14 = F_62 ( V_45 -> V_136 , L_36 , & V_135 ) ;
if ( V_14 ) {
F_13 ( & V_2 -> V_45 , L_37 ) ;
return - V_121 ;
}
...
const struct V_137 * V_69 )
{
int V_14 ;
struct V_10 * V_11 ;
struct V_78 * V_66 ;
V_86 V_138 ;
struct V_124 * V_139 = V_2 -> V_45 . V_139 ;
F_40 ( L_39 , V_2 -> V_30 ) ;
if ( ! V_2 -> V_68 ) {
F_13 ( & V_2 -> V_45 ,
L_40 ) ;
...
F_64 ( V_2 , V_11 ) ;
V_11 -> V_2 = V_2 ;
V_138 = V_11 -> V_125 . V_133 ;
V_11 -> V_24 = F_65 ( V_138 ) ;
F_66 ( & V_11 -> V_19 ) ;
...
V_66 -> V_144 = F_33 ;
V_66 -> V_145 = F_35 ;
V_66 -> V_45 . V_146 = & V_2 -> V_45 ;
F_70 ( & V_66 -> V_45 , F_71 ( & V_2 -> V_45 ) ) ;
V_66 -> V_147 = V_148 ;
V_66 -> V_149 = F_12 ( V_11 -> V_42 . V_123 ) ;
V_66 -> V_150 = F_12 ( V_11 -> V_42 . V_151 ) ;
V_66 -> V_152 = F_12 ( V_11 -> V_42 . V_153 ) ;
snprintf ( V_66 -> V_119 , sizeof( V_66 -> V_119 ) , L_41 ,
V_2 -> V_119 , V_66 -> V_150 , V_66 -> V_152 ) ;
V_14 = F_72 ( V_66 ) ;
if ( V_14 ) {
if ( V_14 != - V_121 )
F_42 ( V_2 , L_42 , V_14 ) ;
...
static int F_81 ( struct V_73 * V_45 )
{
int V_14 ;
struct V_1 * V_2 = F_77 ( V_45 ) ;
F_82 ( V_2 -> V_68 ) ;
