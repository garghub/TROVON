...
static int F_41 ( struct V_89 * V_15 )
{
int V_5 = - V_83 ;
T_1 V_16 ;
struct V_1 * V_2 ;
F_20 ( V_90 L_31 , V_15 -> V_85 ) ;
V_2 = F_42 ( sizeof( struct V_1 ) , V_82 ) ;
if ( ! V_2 )
goto V_91;
V_2 -> V_12 = F_42 ( 3 , V_82 ) ;
if ( ! V_2 -> V_12 )
goto V_92;
V_15 -> V_93 = V_94 ;
if ( V_15 -> V_95 > V_96 )
...
V_2 -> V_15 = V_15 ;
F_45 ( V_15 , V_2 ) ;
V_2 -> V_36 = F_46 ( 0 , & V_97 ) ;
if ( ! V_2 -> V_36 )
goto V_98;
V_2 -> V_36 -> V_39 = V_2 ;
V_2 -> V_36 -> V_99 = & V_2 -> V_15 -> V_36 ;
V_2 -> V_36 -> V_100 -> V_101 [ 0 ] = V_102 ;
V_2 -> V_36 -> V_103 = V_104 | V_105 ;
F_22 ( F_8 ( V_2 ) , L_32 ) ;
V_5 = F_47 ( V_2 -> V_36 ) ;
if ( V_5 )
goto V_106;
...
static int F_53 ( struct V_89 * V_15 )
{
