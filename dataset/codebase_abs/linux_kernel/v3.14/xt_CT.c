...
if ( V_14 -> V_60 & ~ V_61 )
return - V_53 ;
memcpy ( V_69 . V_33 , V_14 -> V_33 , sizeof( V_14 -> V_33 ) ) ;
V_50 = F_21 ( V_12 , & V_69 ) ;
if ( V_50 < 0 )
return V_50 ;
V_14 -> V_4 = V_69 . V_4 ;
...
static void F_36 ( const struct V_71 * V_12 ,
struct V_16 * V_14 )
{
struct V_3 * V_4 = V_14 -> V_4 ;
struct V_34 * V_35 ;
...
static void F_40 ( const struct V_71 * V_12 )
{
struct V_13 * V_14 = V_12 -> V_15 ;
struct V_16 V_69 = {
. V_60 = V_14 -> V_60 ,
...
static void F_41 ( const struct V_71 * V_12 )
{
F_36 ( V_12 , V_12 -> V_15 ) ;
}
static unsigned int
...
{
if ( ! V_12 -> V_64 -> V_72 . V_73 ) {
F_8 ( L_9
L_10 ) ;
V_12 -> V_64 -> V_72 . V_73 = true ;
}
return 0 ;
}
