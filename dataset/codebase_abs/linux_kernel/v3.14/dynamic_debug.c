...
V_72 = F_32 ( V_76 L_45 , F_38 ( V_78 ) , & V_74 ) ;
} else {
...
static T_4 F_42 ( struct V_83 * V_83 , const char T_5 * V_84 ,
T_1 V_85 , T_6 * V_86 )
{
char * V_87 ;
int V_88 ;
...
V_87 = F_43 ( V_85 + 1 , V_91 ) ;
if ( ! V_87 )
return - V_92 ;
if ( F_44 ( V_87 , V_84 , V_85 ) ) {
F_45 ( V_87 ) ;
return - V_93 ;
}
V_87 [ V_85 ] = '\0' ;
...
static struct V_3 * F_46 ( struct V_94 * V_95 )
{
if ( F_47 ( & V_96 ) ) {
V_95 -> V_97 = NULL ;
V_95 -> V_98 = 0 ;
...
V_95 -> V_97 = F_48 ( V_96 . V_99 ,
struct V_24 , V_100 ) ;
V_95 -> V_98 = 0 ;
return & V_95 -> V_97 -> V_32 [ V_95 -> V_98 ] ;
}
static struct V_3 * F_49 ( struct V_94 * V_95 )
{
if ( V_95 -> V_97 == NULL )
return NULL ;
if ( ++ V_95 -> V_98 == V_95 -> V_97 -> V_31 ) {
V_95 -> V_98 = 0 ;
if ( F_50 ( & V_95 -> V_97 -> V_100 , & V_96 ) ) {
V_95 -> V_97 = NULL ;
return NULL ;
}
V_95 -> V_97 = F_48 ( V_95 -> V_97 -> V_100 . V_99 ,
struct V_24 , V_100 ) ;
}
return & V_95 -> V_97 -> V_32 [ V_95 -> V_98 ] ;
}
static void * F_51 ( struct V_101 * V_102 , T_6 * V_64 )
{
...
static void * F_52 ( struct V_101 * V_102 , void * V_7 , T_6 * V_64 )
{
struct V_94 * V_95 = V_102 -> V_103 ;
struct V_3 * V_4 ;
F_6 ( L_51 ,
...
static int F_53 ( struct V_101 * V_102 , void * V_7 )
{
struct V_94 * V_95 = V_102 -> V_103 ;
struct V_3 * V_4 = V_7 ;
char V_106 [ 10 ] ;
...
F_56 ( V_102 , V_4 -> V_17 , L_55 ) ;
F_54 ( V_102 , L_56 ) ;
return 0 ;
}
static void F_57 ( struct V_101 * V_102 , void * V_7 )
{
F_6 ( L_52 , V_102 , V_7 ) ;
F_12 ( & V_29 ) ;
}
static int F_58 ( struct V_107 * V_107 , struct V_83 * V_83 )
{
struct V_94 * V_95 ;
int V_108 ;
F_6 ( L_57 ) ;
V_95 = F_59 ( sizeof( * V_95 ) , V_91 ) ;
if ( V_95 == NULL )
return - V_92 ;
V_108 = F_60 ( V_83 , & V_109 ) ;
if ( V_108 ) {
F_45 ( V_95 ) ;
return V_108 ;
}
...
int F_61 ( struct V_3 * V_111 , unsigned int V_104 ,
const char * V_45 )
{
struct V_24 * V_25 ;
char * V_112 ;
V_25 = F_59 ( sizeof( * V_25 ) , V_91 ) ;
if ( V_25 == NULL )
return - V_92 ;
V_112 = F_62 ( V_45 , V_91 ) ;
if ( V_112 == NULL ) {
F_45 ( V_25 ) ;
return - V_92 ;
}
...
{
F_6 ( L_61 , V_113 , V_42 ) ;
return F_64 ( V_113 , V_42 , NULL , 0 ) ;
}
int F_66 ( char * V_113 , char * V_42 , const char * V_20 )
{
F_6 ( L_62 , V_20 , V_113 , V_42 ) ;
return F_64 ( V_113 , V_42 , V_20 , - V_117 ) ;
}
...
F_8 ( & V_29 ) ;
while ( ! F_47 ( & V_96 ) ) {
struct V_24 * V_25 = F_48 ( V_96 . V_99 ,
struct V_24 ,
V_100 ) ;
F_67 ( V_25 ) ;
}
...
if ( ! V_121 )
return - V_122 ;
V_120 = F_73 ( L_64 , NULL ) ;
if ( ! V_120 )
return - V_92 ;
V_83 = F_74 ( L_65 , 0644 , V_120 , NULL ,
& V_123 ) ;
if ( ! V_83 ) {
F_75 ( V_120 ) ;
return - V_92 ;
...
V_125 = F_62 ( V_132 , V_91 ) ;
F_77 ( L_71 , V_125 , NULL ,
0 , 0 , 0 , & F_65 ) ;
F_45 ( V_125 ) ;
return 0 ;
V_131:
