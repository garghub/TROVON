...
V_93 = F_5 ( V_15 -> V_17 ) ;
if ( ! ( V_93 & ~ ( V_135 | V_136 ) ) )
V_93 = V_13 -> V_119 . V_137 ;
return ( V_93 & V_138 ) == V_52 ;
}
...
V_15 = F_74 ( sizeof( * V_15 ) , V_145 ) ;
if ( ! V_15 )
return;
V_87 = F_74 ( sizeof( * V_87 ) , V_145 ) ;
if ( ! V_87 ) {
F_56 ( V_15 ) ;
return;
}
...
V_56 = & V_87 -> V_4 ;
V_7 = & V_56 -> V_4 ;
F_75 ( V_11 , & V_56 -> V_4 , & V_146 ,
V_147 ) ;
F_76 ( V_11 , & V_8 -> V_4 , & V_148 ,
V_149 ) ;
V_8 -> V_150 = F_21 ;
V_8 -> V_151 = F_13 ;
V_8 -> V_152 = F_30 ;
...
V_11 -> V_111 . V_112 ,
V_166 ) ;
V_56 -> V_69 . V_80 = V_166 ;
V_88 = F_82 ( V_7 , F_83 ( V_13 , V_141 ) ) ;
if ( V_88 ) {
if ( F_41 ( V_7 , V_88 ) ) {
F_84 ( V_7 ,
V_88 ) ;
...
if ( V_13 -> V_119 . V_178 ) {
F_31 ( L_16 ) ;
F_86 ( V_13 -> V_119 . V_178 ) ;
V_68 = F_42 ( V_11 , V_13 -> V_119 . V_178 ) ;
if ( V_68 ) {
V_68 -> type |= V_172 ;
goto V_177;
}
