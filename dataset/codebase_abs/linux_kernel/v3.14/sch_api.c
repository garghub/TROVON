...
void F_54 ( char * V_106 , struct V_37 * V_45 )
{
if ( ! ( V_45 -> V_40 & V_107 ) ) {
F_55 ( L_4 ,
...
int V_28 ;
if ( ( V_120 -> V_199 != V_200 ) && ! F_12 ( V_35 ) )
return - V_36 ;
V_28 = F_127 ( V_120 , sizeof( * V_197 ) , V_161 , V_198 , NULL ) ;
if ( V_28 < 0 )
return V_28 ;
V_49 = F_128 ( V_147 , V_197 -> V_201 ) ;
if ( ! V_49 )
return - V_202 ;
V_149 = V_197 -> V_203 ;
if ( V_149 ) {
...
V_3 = F_23 ( V_49 , V_197 -> V_204 ) ;
if ( ! V_3 )
return - V_29 ;
}
if ( V_161 [ V_163 ] && F_27 ( V_161 [ V_163 ] , V_3 -> V_34 -> V_10 ) )
return - V_27 ;
if ( V_120 -> V_199 == V_205 ) {
if ( ! V_149 )
return - V_27 ;
if ( V_3 -> V_39 == 0 )
return - V_29 ;
...
static int F_129 ( struct V_96 * V_97 , struct V_148 * V_120 )
{
struct V_147 * V_147 = F_125 ( V_97 -> V_195 ) ;
struct V_196 * V_197 ;
struct V_54 * V_161 [ V_198 + 1 ] ;
...
if ( V_197 -> V_204 ) {
if ( V_3 && ! ( V_120 -> V_207 & V_208 ) )
return - V_6 ;
if ( F_131 ( V_197 -> V_204 ) )
return - V_27 ;
V_3 = F_23 ( V_49 , V_197 -> V_204 ) ;
if ( ! V_3 )
goto V_209;
if ( V_120 -> V_207 & V_210 )
return - V_6 ;
if ( V_161 [ V_163 ] && F_27 ( V_161 [ V_163 ] , V_3 -> V_34 -> V_10 ) )
return - V_27 ;
if ( V_3 == V_51 ||
...
struct V_157 * V_158 ;
if ( V_51 && V_51 -> V_34 -> V_17 && V_51 -> V_34 -> V_17 -> V_212 )
V_158 = V_51 -> V_34 -> V_17 -> V_212 ( V_51 , V_197 ) ;
else if ( V_51 )
V_158 = V_51 -> V_158 ;
else
V_158 = F_101 ( V_49 , 0 ) ;
...
static int F_132 ( struct V_96 * V_97 , struct V_37 * V_3 , T_2 V_149 ,
T_2 V_213 , T_2 V_214 , T_5 V_40 , int V_215 )
{
struct V_196 * V_197 ;
struct V_148 * V_216 ;
unsigned char * V_217 = F_133 ( V_97 ) ;
struct V_218 V_219 ;
struct V_78 * V_82 ;
V_216 = F_134 ( V_97 , V_213 , V_214 , V_215 , sizeof( * V_197 ) , V_40 ) ;
if ( ! V_216 )
goto V_220;
V_197 = F_126 ( V_216 ) ;
V_197 -> V_221 = V_222 ;
V_197 -> V_223 = 0 ;
V_197 -> V_224 = 0 ;
V_197 -> V_201 = F_18 ( V_3 ) -> V_225 ;
V_197 -> V_203 = V_149 ;
V_197 -> V_204 = V_3 -> V_39 ;
V_197 -> V_226 = F_135 ( & V_3 -> V_73 ) ;
if ( F_136 ( V_97 , V_163 , V_3 -> V_34 -> V_10 ) )
goto V_100;
if ( V_3 -> V_34 -> V_227 && V_3 -> V_34 -> V_227 ( V_3 , V_97 ) < 0 )
goto V_100;
V_3 -> V_146 . V_145 = V_3 -> V_3 . V_145 ;
V_82 = F_120 ( V_3 -> V_82 ) ;
if ( V_82 && F_46 ( V_97 , V_82 ) < 0 )
goto V_100;
if ( F_137 ( V_97 , V_228 , V_229 , V_230 ,
F_117 ( V_3 ) , & V_219 ) < 0 )
goto V_100;
if ( V_3 -> V_34 -> V_231 && V_3 -> V_34 -> V_231 ( V_3 , & V_219 ) < 0 )
goto V_100;
if ( F_138 ( & V_219 , & V_3 -> V_178 ) < 0 ||
F_139 ( & V_219 , & V_3 -> V_178 , & V_3 -> V_179 ) < 0 ||
F_140 ( & V_219 , & V_3 -> V_146 ) < 0 )
goto V_100;
if ( F_141 ( & V_219 ) < 0 )
goto V_100;
V_216 -> V_232 = F_133 ( V_97 ) - V_217 ;
return V_97 -> V_31 ;
V_220:
V_100:
F_142 ( V_97 , V_217 ) ;
...
static bool F_143 ( struct V_37 * V_3 )
{
return ( V_3 -> V_40 & V_41 ) ? true : false ;
}
static int F_96 ( struct V_147 * V_147 , struct V_96 * V_233 ,
struct V_148 * V_120 , T_2 V_149 ,
struct V_37 * V_150 , struct V_37 * V_151 )
{
struct V_96 * V_97 ;
T_2 V_213 = V_233 ? F_144 ( V_233 ) . V_213 : 0 ;
V_97 = F_145 ( V_234 , V_74 ) ;
if ( ! V_97 )
return - V_235 ;
if ( V_150 && ! F_143 ( V_150 ) ) {
if ( F_132 ( V_97 , V_150 , V_149 , V_213 , V_120 -> V_236 ,
0 , V_205 ) < 0 )
goto V_166;
}
if ( V_151 && ! F_143 ( V_151 ) ) {
if ( F_132 ( V_97 , V_151 , V_149 , V_213 , V_120 -> V_236 ,
V_150 ? V_208 : 0 , V_237 ) < 0 )
goto V_166;
}
if ( V_97 -> V_31 )
return F_146 ( V_97 , V_147 , V_213 , V_238 ,
V_120 -> V_207 & V_239 ) ;
V_166:
F_147 ( V_97 ) ;
return - V_27 ;
}
static int F_148 ( struct V_37 * V_38 , struct V_96 * V_97 ,
struct V_240 * V_241 ,
int * V_242 , int V_243 )
{
...
if ( ! F_143 ( V_3 ) &&
F_132 ( V_97 , V_3 , V_3 -> V_42 , F_144 ( V_241 -> V_97 ) . V_213 ,
...
static int F_149 ( struct V_96 * V_97 , struct V_240 * V_241 )
{
struct V_147 * V_147 = F_125 ( V_97 -> V_195 ) ;
int V_248 , V_245 ;
int V_249 , V_243 ;
...
V_243 = 0 ;
V_245 = 0 ;
if ( F_148 ( V_49 -> V_45 , V_97 , V_241 , & V_245 , V_243 ) < 0 )
goto V_247;
V_158 = F_24 ( V_49 ) ;
if ( V_158 &&
F_148 ( V_158 -> V_50 , V_97 , V_241 ,
& V_245 , V_243 ) < 0 )
goto V_247;
V_250:
V_248 ++ ;
...
T_2 V_252 ;
int V_28 ;
if ( ( V_120 -> V_199 != V_253 ) && ! F_12 ( V_35 ) )
return - V_36 ;
V_28 = F_127 ( V_120 , sizeof( * V_197 ) , V_161 , V_198 , NULL ) ;
if ( V_28 < 0 )
return V_28 ;
...
V_252 = V_49 -> V_45 -> V_39 ;
if ( V_213 )
V_213 = F_89 ( V_252 , V_213 ) ;
} else {
if ( V_252 == 0 )
V_252 = V_49 -> V_45 -> V_39 ;
}
...
V_149 = F_89 ( V_252 , V_149 ) ;
if ( V_149 )
V_53 = V_19 -> V_20 ( V_3 , V_149 ) ;
if ( V_53 == 0 ) {
V_28 = - V_29 ;
if ( V_120 -> V_199 != V_255 ||
! ( V_120 -> V_207 & V_211 ) )
goto V_11;
} else {
switch ( V_120 -> V_199 ) {
...
V_28 = - V_159 ;
if ( V_19 -> V_257 )
V_28 = V_19 -> V_257 ( V_3 , V_53 ) ;
if ( V_28 == 0 )
F_154 ( V_147 , V_97 , V_120 , V_3 , V_53 , V_256 ) ;
goto V_11;
case V_253 :
V_28 = F_154 ( V_147 , V_97 , V_120 , V_3 , V_53 , V_255 ) ;
goto V_11;
default:
V_28 = - V_27 ;
goto V_11;
...
V_28 = - V_159 ;
if ( V_19 -> V_183 )
V_28 = V_19 -> V_183 ( V_3 , V_149 , V_213 , V_161 , & V_251 ) ;
if ( V_28 == 0 )
F_154 ( V_147 , V_97 , V_120 , V_3 , V_251 , V_255 ) ;
V_11:
if ( V_53 )
V_19 -> V_21 ( V_3 , V_53 ) ;
return V_28 ;
...
if ( F_136 ( V_97 , V_163 , V_3 -> V_34 -> V_10 ) )
goto V_100;
if ( V_17 -> V_227 && V_17 -> V_227 ( V_3 , V_53 , V_97 , V_197 ) < 0 )
goto V_100;
if ( F_137 ( V_97 , V_228 , V_229 , V_230 ,
F_117 ( V_3 ) , & V_219 ) < 0 )
goto V_100;
if ( V_17 -> V_231 && V_17 -> V_231 ( V_3 , V_53 , & V_219 ) < 0 )
goto V_100;
if ( F_141 ( & V_219 ) < 0 )
goto V_100;
V_216 -> V_232 = F_133 ( V_97 ) - V_217 ;
...
static int F_154 ( struct V_147 * V_147 , struct V_96 * V_233 ,
struct V_148 * V_120 , struct V_37 * V_3 ,
unsigned long V_53 , int V_215 )
{
struct V_96 * V_97 ;
T_2 V_213 = V_233 ? F_144 ( V_233 ) . V_213 : 0 ;
V_97 = F_145 ( V_234 , V_74 ) ;
if ( ! V_97 )
return - V_235 ;
if ( F_155 ( V_97 , V_3 , V_53 , V_213 , V_120 -> V_236 , 0 , V_215 ) < 0 ) {
F_147 ( V_97 ) ;
return - V_27 ;
}
return F_146 ( V_97 , V_147 , V_213 , V_238 ,
...
return F_155 ( V_259 -> V_97 , V_3 , V_53 , F_144 ( V_259 -> V_241 -> V_97 ) . V_213 ,
...
if ( ! V_38 )
return 0 ;
if ( F_157 ( V_38 , V_97 , V_197 , V_241 , V_260 , V_261 ) < 0 )
return - 1 ;
F_16 (q, &root->list, list) {
if ( F_157 ( V_3 , V_97 , V_197 , V_241 , V_260 , V_261 ) < 0 )
return - 1 ;
}
return 0 ;
}
static int F_159 ( struct V_96 * V_97 , struct V_240 * V_241 )
{
struct V_196 * V_197 = F_126 ( V_241 -> V_216 ) ;
struct V_147 * V_147 = F_125 ( V_97 -> V_195 ) ;
struct V_157 * V_158 ;
struct V_48 * V_49 ;
int V_262 , V_261 ;
...
return 0 ;
V_49 = F_160 ( V_147 , V_197 -> V_201 ) ;
if ( ! V_49 )
return 0 ;
V_261 = V_241 -> args [ 0 ] ;
V_262 = 0 ;
if ( F_158 ( V_49 -> V_45 , V_97 , V_197 , V_241 , & V_262 , V_261 ) < 0 )
goto V_247;
V_158 = F_24 ( V_49 ) ;
if ( V_158 &&
F_158 ( V_158 -> V_50 , V_97 , V_197 , V_241 ,
& V_262 , V_261 ) < 0 )
goto V_247;
V_247:
V_241 -> args [ 0 ] = V_262 ;
...
int F_161 ( struct V_96 * V_97 , const struct V_263 * V_264 ,
struct V_265 * V_266 )
{
T_8 V_267 = V_97 -> V_267 ;
int V_28 ;
for (; V_264 ; V_264 = V_264 -> V_9 ) {
if ( V_264 -> V_267 != V_267 &&
V_264 -> V_267 != F_162 ( V_268 ) )
continue;
V_28 = V_264 -> V_269 ( V_97 , V_264 , V_266 ) ;
if ( V_28 >= 0 ) {
#ifdef F_163
if ( V_28 != V_270 && V_97 -> V_271 )
V_97 -> V_271 = F_164 ( V_97 -> V_271 , 0 ) ;
#endif
return V_28 ;
}
}
...
int F_165 ( struct V_96 * V_97 , const struct V_263 * V_264 ,
struct V_265 * V_266 )
{
int V_28 = 0 ;
#ifdef F_163
...
V_273:
#endif
V_28 = F_161 ( V_97 , V_264 , V_266 ) ;
#ifdef F_163
if ( V_28 == V_270 ) {
T_2 V_274 = F_166 ( V_97 -> V_271 ) ;
V_264 = V_272 ;
if ( V_274 ++ >= V_275 ) {
F_167 ( L_5 ,
V_264 -> V_3 -> V_34 -> V_10 ,
...
V_97 -> V_271 = F_164 ( V_97 -> V_271 , V_274 ) ;
goto V_273;
}
#endif
return V_28 ;
}
void F_169 ( struct V_263 * V_264 )
{
V_264 -> V_34 -> V_181 ( V_264 ) ;
F_14 ( V_264 -> V_34 -> V_33 ) ;
F_36 ( V_264 ) ;
}
void F_170 ( struct V_263 * * V_278 )
{
struct V_263 * V_264 ;
...
static int F_171 ( struct V_279 * V_214 , void * V_280 )
{
struct V_281 V_282 ;
F_172 ( V_113 , & V_282 ) ;
F_173 ( V_214 , L_6 ,
( T_2 ) V_283 , ( T_2 ) F_174 ( 1 ) ,
1000000 ,
( T_2 ) V_284 / ( T_2 ) F_175 ( F_176 ( V_282 ) ) ) ;
return 0 ;
}
static int F_177 ( struct V_285 * V_285 , struct V_286 * V_286 )
{
return F_178 ( V_286 , F_171 , NULL ) ;
}
static int T_9 F_179 ( struct V_147 * V_147 )
{
struct V_287 * V_288 ;
V_288 = F_180 ( L_7 , 0 , V_147 -> V_289 , & V_290 ) ;
if ( V_288 == NULL )
return - V_91 ;
return 0 ;
}
...
F_1 ( & V_295 ) ;
F_1 ( & V_296 ) ;
F_186 ( V_297 , V_237 , F_129 , NULL , NULL ) ;
F_186 ( V_297 , V_205 , F_124 , NULL , NULL ) ;
F_186 ( V_297 , V_200 , F_124 , F_149 , NULL ) ;
F_186 ( V_297 , V_255 , F_153 , NULL , NULL ) ;
F_186 ( V_297 , V_256 , F_153 , NULL , NULL ) ;
F_186 ( V_297 , V_253 , F_153 , F_159 , NULL ) ;
return 0 ;
}
