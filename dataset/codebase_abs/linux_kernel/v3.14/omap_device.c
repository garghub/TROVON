...
V_2 -> V_49 = V_24 ;
V_19 = F_41 ( V_52 , sizeof( struct V_11 * ) * V_24 , V_28 ) ;
if ( ! V_19 )
goto V_55;
V_2 -> V_19 = V_19 ;
V_2 -> V_9 = V_9 ;
...
F_39 ( V_2 , & V_51 [ V_9 -> V_35 ] ) ;
}
V_25 = F_42 ( V_9 , V_51 , V_53 ) ;
F_22 ( V_51 ) ;
if ( V_25 )
goto V_60;
V_59:
...
if ( ! V_12 )
return F_43 ( - V_31 ) ;
return F_45 ( V_62 , V_63 , V_52 , 1 , V_64 ,
V_65 ) ;
}
struct V_18 T_2 * F_45 ( const char * V_62 ,
int V_63 ,
struct V_11 * * V_52 ,
int V_24 , void * V_64 ,
int V_65 )
...
if ( V_9 -> V_67 != - 1 )
F_47 ( & V_9 -> V_10 , L_14 , V_9 -> V_37 , V_9 -> V_67 ) ;
else
F_47 ( & V_9 -> V_10 , L_15 , V_9 -> V_37 ) ;
V_2 = F_18 ( V_9 , V_52 , V_24 ) ;
if ( F_5 ( V_2 ) )
goto V_68;
V_25 = F_48 ( V_9 , V_64 , V_65 ) ;
if ( V_25 )
goto V_69;
V_25 = F_49 ( V_9 ) ;
if ( V_25 )
...
static int F_52 ( struct V_70 * V_10 )
{
struct V_18 * V_9 = F_24 ( V_10 ) ;
int V_25 ;
V_25 = F_53 ( V_10 ) ;
...
static int F_55 ( struct V_70 * V_10 )
{
struct V_18 * V_9 = F_24 ( V_10 ) ;
F_20 ( V_9 ) ;
return F_56 ( V_10 ) ;
