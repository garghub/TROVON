...
if ( F_72 ( V_120 ) || F_73 ( V_120 ) ) {
unsigned char V_76 = F_74 ( V_120 ) ;
unsigned char V_77 = F_75 ( V_120 ) ;
V_22 =
...
static void F_76 ( struct V_119 * V_120 , int V_191 )
{
struct V_1 * V_2 = V_120 -> V_139 ;
struct V_5 * V_4 = F_8 ( V_2 , V_29 ) ;
struct V_6 * V_8 ;
...
static inline int F_77 ( struct V_119 * V_120 ,
struct V_1 * V_2 ,
struct V_5 * V_4 )
{
T_4 V_70 ;
...
return - V_122 ;
F_66 ( & V_8 -> V_83 ) ;
V_149 = F_78 ( V_120 , V_2 , V_4 , V_204 ) ;
F_67 ( & V_8 -> V_83 ) ;
return V_149 ;
}
