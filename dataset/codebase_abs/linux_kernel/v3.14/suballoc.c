...
static void F_90 ( struct V_53 * V_54 , int V_120 , int type )
{
F_71 ( & V_54 -> V_131 ) ;
if ( type == V_137 )
V_54 -> V_132 = V_120 ;
...
int V_75 ;
int V_120 = F_93 ( V_54 ) ;
* V_7 = F_98 ( sizeof( struct V_6 ) , V_143 ) ;
if ( ! ( * V_7 ) ) {
V_75 = - V_95 ;
F_39 ( V_75 ) ;
goto V_77;
...
if ( V_55 )
V_101 = ! F_109 ( V_160 , ( unsigned long * ) V_55 -> V_86 ) ;
else
V_101 = 1 ;
F_113 ( V_71 ) ;
return V_101 ;
...
if ( V_7 -> V_193 )
goto V_194;
V_101 = F_127 ( V_70 , V_69 , V_7 -> V_13 ,
V_2 -> V_169 ,
F_11 ( V_26 -> V_44 ) ) ;
if ( V_101 < 0 ) {
F_39 ( V_101 ) ;
...
V_101 = F_116 ( V_69 , V_70 , V_26 , V_170 ,
V_2 -> V_5 , V_2 -> V_169 ) ;
if ( V_101 < 0 )
F_39 ( V_101 ) ;
V_194:
...
V_198 = F_118 ( V_17 ) ;
V_7 -> V_197 = V_198 ;
V_75 = F_131 ( V_7 , V_69 , V_121 , V_96 ,
V_2 , & V_191 ) ;
if ( ! V_75 ) {
V_199 = F_1 ( V_2 ) ;
goto V_201;
...
F_84 ( & F_17 ( V_7 -> V_9 -> V_52 ) -> V_129 . V_205 ) ;
* V_202 = V_2 . V_4 ;
* V_203 = V_2 . V_5 ;
* V_204 = V_2 . V_3 ;
V_7 -> V_200 += V_2 . V_169 ;
...
static inline void F_163 ( struct V_37 * V_107 )
{
int V_100 ;
F_162 ( L_33 , ( unsigned long long ) V_107 -> V_40 ) ;
F_162 ( L_34 , V_107 -> V_248 ) ;
F_162 ( L_35 ,
( unsigned long long ) V_107 -> V_118 ) ;
F_162 ( L_36 , V_107 -> V_115 ) ;
F_162 ( L_37 ,
F_16 ( V_107 -> V_249 ) ) ;
F_162 ( L_38 ,
F_16 ( V_107 -> V_111 . V_112 . V_113 ) ) ;
F_162 ( L_39 ,
F_16 ( V_107 -> V_111 . V_112 . V_114 ) ) ;
F_162 ( L_40 , V_107 -> V_42 . V_43 . V_18 ) ;
F_162 ( L_41 , V_107 -> V_42 . V_43 . V_19 ) ;
F_162 ( L_42 , V_107 -> V_42 . V_43 . V_89 ) ;
F_162 ( L_43 ,
...
V_101 = F_100 ( V_54 , V_251 -> V_258 , V_255 ) ;
if ( V_101 < 0 ) {
if ( V_101 != - V_94 )
F_39 ( V_101 ) ;
goto V_51;
