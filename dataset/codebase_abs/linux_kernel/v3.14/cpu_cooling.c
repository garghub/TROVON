...
static struct V_50 *
F_24 ( struct V_55 * V_56 ,
const struct V_35 * V_57 )
{
struct V_50 * V_58 ;
struct V_30 * V_59 = NULL ;
unsigned int V_60 = 0 , V_49 = 0 ;
char V_61 [ V_62 ] ;
int V_3 = 0 , V_13 ;
struct V_7 V_8 ;
F_16 (i, clip_cpus) {
...
if ( V_60 != V_8 . V_63 . V_64 ||
V_49 != V_8 . V_63 . V_46 )
return F_25 ( - V_22 ) ;
}
}
V_59 = F_26 ( sizeof( struct V_30 ) ,
V_5 ) ;
if ( ! V_59 )
return F_25 ( - V_65 ) ;
F_27 ( & V_59 -> V_37 , V_57 ) ;
V_3 = F_1 ( & V_66 , & V_59 -> V_2 ) ;
if ( V_3 ) {
F_28 ( V_59 ) ;
return F_25 ( - V_22 ) ;
}
snprintf ( V_61 , sizeof( V_61 ) , L_1 ,
V_59 -> V_2 ) ;
V_58 = F_29 ( V_56 , V_61 , V_59 ,
& V_67 ) ;
if ( F_30 ( V_58 ) ) {
F_6 ( & V_66 , V_59 -> V_2 ) ;
F_28 ( V_59 ) ;
...
struct V_50 *
F_32 ( const struct V_35 * V_57 )
{
return F_24 ( NULL , V_57 ) ;
}
struct V_50 *
