...
const unsigned V_102 = F_70 ( V_59 -> V_62 ) ;
V_101 = V_59 -> V_103 ;
F_71 ( V_59 , V_59 -> V_60 ) ;
V_100 = F_63 ( V_55 ) ;
if ( ( int ) ( F_64 ( V_55 ) -
...
unsigned int V_101 ;
T_1 V_112 =
V_59 -> V_113 . V_114 * F_70 ( V_59 -> V_62 ) ;
V_101 = V_59 -> V_115 ;
F_74 ( V_59 , V_59 -> V_60 ) ;
V_111 = F_65 ( V_55 ) ;
if ( V_59 -> V_113 . V_116 == V_117 &&
( int ) ( V_111 - V_112 ) > 0 )
V_111 = V_112 ;
V_110 = F_66 ( V_55 ) ;
if ( V_59 -> V_113 . V_116 == V_117 &&
( int ) ( V_110 - V_112 ) > 0 )
V_110 = V_112 ;
if ( ( int ) ( V_110 - V_101 ) > 0 ) {
F_26 ( V_59 -> V_62 -> V_63 -> V_64 ,
L_12 ) ;
V_59 -> V_104 |= V_105 ;
return - 1 ;
}
V_65 = V_111 - V_59 -> V_118 ;
if ( V_65 <= 0 )
return 0 ;
if ( V_65 ) {
F_75 ( V_59 , V_65 ) ;
...
unsigned F_76 ( struct V_50 * V_55 )
{
struct V_1 * V_4 = V_55 -> V_4 ;
unsigned V_119 ;
unsigned long V_53 ;
F_40 ( & V_4 -> V_7 , V_53 ) ;
V_119 = F_15 ( V_4 -> V_14 + F_77 ( V_55 -> V_10 ) ) ;
if ( V_119 & V_120 ) {
V_55 -> V_11 = 1 ;
F_23 ( V_121 ,
