...
{
F_73 ( struct V_5 * , V_68 , V_110 -> V_129 ) ;
...
V_138 = F_75 ( V_9 , V_83 & V_141 , V_128 ) ;
V_133 = 0 ;
do {
T_5 V_142 ;
if ( F_55 ( V_92 ) ) {
...
if ( V_133 >= V_138 && ! V_9 -> V_144 . V_145 )
break;
if ( V_133 ) {
if ( V_9 -> V_146 ||
V_9 -> V_80 == V_89 ||
...
V_143:
V_136 = V_18 -> V_128 ;
V_137 = V_18 -> V_128 - V_142 ;
if ( V_128 < V_137 )
V_137 = V_128 ;
if ( ! ( V_83 & V_149 ) ) {
int V_10 = F_79 ( V_18 , V_142 ,
V_110 -> V_150 , V_137 ) ;
if ( V_10 ) {
if ( ! V_133 )
V_133 = - V_151 ;
...
goto V_152;
if ( ! ( V_83 & V_140 ) ) {
F_80 ( & V_9 -> V_124 . V_153 , V_132 ) ;
F_81 ( V_9 , V_18 , false ) ;
F_82 ( & V_9 -> V_124 . V_153 , V_132 ) ;
* V_135 = 0 ;
}
if ( V_137 + V_142 < V_136 )
continue;
} while ( V_128 > 0 );
V_43:
F_28 ( V_9 ) ;
...
static int F_84 ( struct V_126 * V_127 , struct V_26 * V_8 ,
struct V_109 * V_110 , T_4 V_128 )
{
struct V_8 * V_9 = V_8 -> V_9 ;
struct V_20 * V_21 = F_7 ( V_9 ) ;
F_73 ( struct V_5 * , V_6 , V_110 -> V_129 ) ;
int V_83 = V_110 -> V_155 ;
int V_19 = V_83 & V_131 ;
struct V_17 * V_18 ;
T_4 V_156 = 0 ;
int V_10 = - V_58 , V_133 = 0 , V_157 ;
F_23 ( L_8 , V_44 ,
V_21 -> V_45 . V_46 , V_21 -> V_47 . V_46 ) ;
F_22 ( V_9 ) ;
if ( V_6 ) {
if ( V_110 -> V_154 < sizeof( * V_6 ) )
goto V_158;
} else {
if ( F_4 ( & V_21 -> V_6 ) )
goto V_158;
...
V_157 = V_21 -> V_50 -> V_159 + F_5 ( V_9 , V_6 ) ;
V_156 = V_157 + V_128 ;
if ( V_156 > V_21 -> V_50 -> V_160 )
V_156 = V_21 -> V_50 -> V_160 ;
V_133 = V_156 - V_157 ;
F_28 ( V_9 ) ;
V_18 = F_85 ( V_9 , V_156 , V_19 , & V_10 ) ;
F_22 ( V_9 ) ;
if ( ! V_18 )
goto V_158;
V_18 -> V_50 = V_21 -> V_50 ;
...
F_86 ( V_18 , V_157 ) ;
V_10 = F_87 ( F_88 ( V_18 , V_133 ) , V_110 -> V_150 , V_133 ) ;
if ( V_10 )
goto V_43;
if ( V_9 -> V_14 == V_38 || V_6 -> V_161 ) {
...
goto V_43;
if( V_21 -> V_50 )
V_165 . V_61 = V_21 -> V_50 -> type ;
V_165 . V_70 = V_21 -> V_47 . V_46 ;
memcpy ( & V_165 . V_73 , & V_21 -> V_47 . V_64 , V_66 ) ;
} else {
V_10 = - V_58 ;
if ( ! V_21 -> V_1 )
goto V_43;
V_165 . V_70 = V_21 -> V_1 -> V_45 . V_46 ;
if ( V_21 -> V_50 ) {
V_165 . V_61 = V_21 -> V_50 -> type ;
memcpy ( & V_165 . V_73 , V_21 -> V_50 -> V_65 ,
V_66 ) ;
}
}
V_10 = 0 ;
V_165 . V_71 = V_72 ;
memcpy ( V_68 , & V_165 , sizeof( V_165 ) ) ;
V_43:
F_28 ( V_9 ) ;
return V_10 ;
}
static int F_93 ( struct V_26 * V_8 , unsigned int V_167 ,
unsigned long V_168 )
{
return - V_169 ;
}
static int F_94 ( struct V_26 * V_8 , int V_170 , int V_171 ,
...
int V_10 = - V_58 ;
F_22 ( V_9 ) ;
if ( F_8 ( V_170 != V_119 || V_173 != sizeof( int ) ) )
goto V_43;
V_10 = F_95 ( V_174 , ( int T_6 * ) V_172 ) ;
if ( V_10 )
goto V_43;
V_10 = - V_58 ;
switch ( V_171 ) {
...
if ( V_174 > V_182 )
goto V_43;
V_21 -> V_183 . V_184 = V_174 * V_185 ;
break;
case V_186 :
if ( V_174 > V_187 )
goto V_43;
V_21 -> V_188 . V_184 = V_174 * V_185 ;
break;
case V_189 :
if ( V_174 > V_190 )
goto V_43;
V_21 -> V_191 . V_184 = V_174 * V_185 ;
break;
case V_192 :
if ( V_174 > V_193 )
goto V_43;
V_21 -> V_194 . V_184 = V_174 * V_185 ;
break;
case V_195 :
if ( V_174 > V_196 )
goto V_43;
...
static int F_96 ( struct V_26 * V_8 , int V_170 , int V_171 ,
char T_6 * V_172 , int T_6 * V_173 )
{
struct V_8 * V_9 = V_8 -> V_9 ;
struct V_20 * V_21 = F_7 ( V_9 ) ;
int V_200 = 0 , V_128 = 0 , V_10 = - V_58 ;
F_22 ( V_9 ) ;
if ( F_8 ( V_170 != V_119 ) )
goto V_43;
V_10 = F_95 ( V_128 , V_173 ) ;
if ( V_10 )
goto V_43;
V_10 = - V_58 ;
if ( V_128 != sizeof( int ) )
...
switch ( V_171 ) {
case V_175 :
V_200 = V_21 -> V_177 ; break;
case V_178 :
V_200 = V_21 -> V_180 ; break;
case V_181 :
V_200 = V_21 -> V_183 . V_184 / V_185 ; break;
case V_186 :
V_200 = V_21 -> V_188 . V_184 / V_185 ; break;
case V_189 :
V_200 = V_21 -> V_191 . V_184 / V_185 ; break;
case V_192 :
V_200 = V_21 -> V_194 . V_184 / V_185 ; break;
case V_195 :
V_200 = V_21 -> V_197 ; break;
case V_198 :
V_200 = V_21 -> V_199 ; break;
case V_120 :
V_200 = ( V_21 -> V_111 & V_112 ) != 0 ;
break;
default:
V_10 = - V_162 ;
goto V_43;
...
V_10 = 0 ;
if ( F_97 ( V_128 , V_173 ) || F_98 ( V_172 , & V_200 , V_128 ) )
V_10 = - V_151 ;
V_43:
F_28 ( V_9 ) ;
return V_10 ;
