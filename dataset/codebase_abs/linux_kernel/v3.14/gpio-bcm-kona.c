...
static unsigned int F_44 ( struct V_33 * V_34 )
{
struct V_1 * V_13 = F_29 ( V_34 ) ;
if ( F_45 ( & V_13 -> V_2 , V_34 -> V_35 ) )
F_26 ( V_13 -> V_2 . V_28 ,
L_3 ,
V_34 -> V_35 ) ;
F_33 ( V_34 ) ;
...
struct V_1 * V_13 = F_29 ( V_34 ) ;
F_31 ( V_34 ) ;
F_47 ( & V_13 -> V_2 , V_34 -> V_35 ) ;
}
static int F_48 ( struct V_25 * V_34 , unsigned int V_48 ,
T_3 V_35 )
{
int V_58 ;
V_58 = F_49 ( V_48 , V_34 -> V_59 ) ;
if ( V_58 < 0 )
return V_58 ;
F_50 ( V_48 , & V_60 ) ;
F_51 ( V_48 , & V_61 , V_62 ) ;
...
static void F_55 ( struct V_25 * V_34 , unsigned int V_48 )
{
F_51 ( V_48 , NULL , NULL ) ;
F_49 ( V_48 , NULL ) ;
}
...
V_13 = F_59 ( V_28 , sizeof( * V_13 ) , V_74 ) ;
if ( ! V_13 )
return - V_75 ;
V_13 -> V_2 = V_76 ;
V_3 = & V_13 -> V_2 ;
V_13 -> V_65 = F_60 ( V_28 -> V_77 ) ;
if ( V_13 -> V_65 == 0 ) {
F_26 ( V_28 , L_5 ) ;
return - V_78 ;
}
...
V_27 = F_63 ( V_67 , V_82 , 0 ) ;
V_13 -> V_4 = F_64 ( V_28 , V_27 ) ;
if ( F_65 ( V_13 -> V_4 ) ) {
V_58 = - V_24 ;
goto V_83;
}
