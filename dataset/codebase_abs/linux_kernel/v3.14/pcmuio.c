...
{
const struct V_32 * V_33 = F_18 ( V_2 ) ;
int V_3 ;
for ( V_3 = 0 ; V_3 < V_33 -> V_34 ; ++ V_3 ) {
F_4 ( V_2 , 0 , V_3 , 0 , 0 ) ;
F_4 ( V_2 , 0 , V_3 , 0 , 3 ) ;
F_4 ( V_2 , 0 , V_3 , V_35 , 0 ) ;
...
int V_3 = F_2 ( V_7 ) ;
struct V_15 * V_16 = & V_13 -> V_17 [ V_3 ] ;
unsigned int V_43 = V_7 -> V_40 -> V_44 . V_45 ;
unsigned V_46 = V_7 -> V_40 -> V_47 ;
unsigned int V_9 = 0 ;
unsigned long V_18 ;
unsigned int V_48 ;
F_5 ( & V_16 -> V_49 , V_18 ) ;
...
unsigned int V_51 = F_21 ( V_7 -> V_40 -> V_44 . V_52 [ V_48 ] ) ;
if ( V_42 & ( 1 << V_51 ) )
V_9 |= ( 1 << V_48 ) ;
}
if ( F_22 ( V_7 -> V_40 , V_9 ) &&
F_22 ( V_7 -> V_40 , V_9 >> 16 ) ) {
V_7 -> V_40 -> V_47 |= ( V_53 | V_54 ) ;
} else {
F_19 ( V_2 , V_7 ) ;
}
if ( ! V_16 -> V_55 ) {
...
int V_3 = F_2 ( V_7 ) ;
struct V_15 * V_16 = & V_13 -> V_17 [ V_3 ] ;
struct V_66 * V_44 = & V_7 -> V_40 -> V_44 ;
unsigned int V_67 = 0 ;
unsigned int V_68 = 0 ;
int V_48 ;
if ( ! V_16 -> V_55 && V_16 -> V_56 == 0 ) {
V_7 -> V_40 -> V_47 |= V_57 ;
V_16 -> V_39 = 0 ;
return 1 ;
}
...
V_16 -> V_39 = 1 ;
if ( V_44 -> V_52 ) {
for ( V_48 = 0 ; V_48 < V_44 -> V_45 ; V_48 ++ ) {
unsigned int V_69 = V_44 -> V_52 [ V_48 ] ;
unsigned int V_51 = F_21 ( V_69 ) ;
unsigned int V_70 = F_27 ( V_69 ) ;
unsigned int V_71 = F_28 ( V_69 ) ;
V_67 |= ( 1 << V_51 ) ;
V_68 |= ( ( V_71 || V_70 ) ? 1 : 0 ) << V_51 ;
}
}
V_67 &= ( ( 1 << V_7 -> V_25 ) - 1 ) ;
V_16 -> V_38 = V_67 ;
F_4 ( V_2 , V_68 , V_3 , V_35 , 0 ) ;
...
static int
F_30 ( struct V_1 * V_2 , struct V_6 * V_7 ,
unsigned int V_72 )
{
struct V_12 * V_13 = V_2 -> V_14 ;
int V_3 = F_2 ( V_7 ) ;
...
{
int V_80 = 0 ;
V_80 |= F_33 ( & V_44 -> V_78 , V_81 | V_79 ) ;
V_80 |= F_33 ( & V_44 -> V_82 , V_83 ) ;
V_80 |= F_33 ( & V_44 -> V_84 , V_81 ) ;
V_80 |= F_33 ( & V_44 -> V_85 , V_76 ) ;
V_80 |= F_33 ( & V_44 -> V_75 , V_76 | V_86 ) ;
if ( V_80 )
return 1 ;
V_80 |= F_34 ( V_44 -> V_78 ) ;
V_80 |= F_34 ( V_44 -> V_75 ) ;
if ( V_80 )
return 2 ;
V_80 |= F_35 ( & V_44 -> V_87 , 0 ) ;
V_80 |= F_35 ( & V_44 -> V_88 , 0 ) ;
V_80 |= F_35 ( & V_44 -> V_89 , 0 ) ;
V_80 |= F_35 ( & V_44 -> V_90 , V_44 -> V_45 ) ;
switch ( V_44 -> V_75 ) {
case V_76 :
break;
case V_86 :
V_80 |= F_35 ( & V_44 -> V_77 , 0 ) ;
break;
default:
break;
}
...
static int F_36 ( struct V_1 * V_2 , struct V_91 * V_92 )
{
const struct V_32 * V_33 = F_18 ( V_2 ) ;
struct V_6 * V_7 ;
struct V_12 * V_13 ;
...
F_17 ( V_2 ) ;
if ( V_92 -> V_93 [ 1 ] ) {
V_30 = F_40 ( V_92 -> V_93 [ 1 ] , F_25 , 0 ,
V_2 -> V_96 , V_2 ) ;
if ( V_30 == 0 )
V_2 -> V_60 = V_92 -> V_93 [ 1 ] ;
}
if ( V_33 -> V_34 == 2 ) {
if ( V_92 -> V_93 [ 2 ] == V_2 -> V_60 ) {
V_13 -> V_63 = V_92 -> V_93 [ 2 ] ;
} else if ( V_92 -> V_93 [ 2 ] ) {
V_30 = F_40 ( V_92 -> V_93 [ 2 ] , F_25 , 0 ,
V_2 -> V_96 , V_2 ) ;
if ( V_30 == 0 )
V_13 -> V_63 = V_92 -> V_93 [ 2 ] ;
}
}
V_30 = F_41 ( V_2 , V_33 -> V_34 * 2 ) ;
if ( V_30 )
return V_30 ;
for ( V_48 = 0 ; V_48 < V_2 -> V_97 ; ++ V_48 ) {
V_7 = & V_2 -> V_58 [ V_48 ] ;
V_7 -> type = V_98 ;
...
V_7 -> V_105 = F_13 ;
V_7 -> V_106 = F_15 ;
if ( ( V_48 == 0 && V_2 -> V_60 ) || ( V_48 == 2 && V_13 -> V_63 ) ) {
V_2 -> V_107 = V_7 ;
V_7 -> V_99 |= V_108 ;
V_7 -> V_109 = V_7 -> V_25 ;
V_7 -> V_110 = F_29 ;
