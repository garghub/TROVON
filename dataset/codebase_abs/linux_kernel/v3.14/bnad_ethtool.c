...
static int
F_61 ( struct V_1 * V_2 , struct V_186 * V_187 )
{
struct V_27 * V_27 = F_7 ( V_2 ) ;
struct V_161 V_162 ;
const struct V_188 * V_189 ;
int V_164 = 0 ;
V_164 = F_62 ( & V_189 , V_187 -> V_190 , & V_27 -> V_44 -> V_191 ) ;
if ( V_164 ) {
F_63 ( L_42 , V_187 -> V_190 ) ;
goto V_192;
}
V_162 . V_27 = V_27 ;
V_162 . V_165 = 0 ;
F_53 ( & V_162 . V_166 ) ;
F_64 ( & V_27 -> V_36 ) ;
V_164 = F_60 ( & V_27 -> V_37 . V_167 , V_193 ,
V_27 -> V_183 , ( T_2 * ) V_189 -> V_190 , V_189 -> V_194 , 0 ,
V_168 , & V_162 ) ;
if ( V_164 != V_169 ) {
F_65 ( L_43 , V_164 ) ;
V_164 = - V_195 ;
