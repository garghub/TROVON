...
V_332 = V_330 -> V_277 + V_330 -> V_145 - V_145 ;
...
if ( V_338 ) {
F_92 ( V_11 , V_330 , * V_145 , * V_39 , V_262 ) ;
if ( V_10 -> V_29 > V_11 -> V_28 . V_25 ) {
...
V_345 -> V_346 . V_145 -= V_345 -> V_346 . V_277 & ~ V_335 ;
V_345 -> V_346 . V_277 = ( V_345 -> V_346 . V_277 - V_335 - 1 ) & V_335 ;
V_265 = F_95 ( V_17 , & V_345 -> V_346 . V_145 , & V_345 -> V_346 . V_39 ,
V_262 , V_335 ,
0 ,
V_337 , V_338 ) ;
if ( 0 != V_265 )
...
int V_357 , V_271 , V_250 = 0 ;
if ( NULL == V_17 -> V_353 )
return - V_97 ;
if ( ! ( V_17 -> V_353 -> V_164 & V_358 ) )
return - V_97 ;
V_250 = F_98 ( V_17 , V_345 ,
V_354 ,
V_354 ) ;
if ( 0 != V_250 )
return V_250 ;
V_357 = V_345 -> V_347 ;
V_271 = sizeof( * V_356 ) * ( V_357 + 4 ) ;
V_356 = F_101 ( V_271 , V_359 ) ;
if ( NULL == V_356 )
return - V_360 ;
if ( V_357 > 0 ) {
...
if ( NULL != V_10 -> V_279 . V_362 )
V_357 = F_103 ( V_10 -> V_279 . V_260 . V_145 , V_10 -> V_279 . V_260 . V_39 ,
...
F_66 ( V_17 -> V_363 . V_356 ) ;
V_17 -> V_363 . V_356 = V_356 ;
V_17 -> V_363 . V_364 = V_357 ;
V_17 -> V_363 . V_346 = V_345 -> V_346 ;
V_17 -> V_363 . V_262 = V_345 -> V_262 ;
V_17 -> V_363 . V_365 = 1 ;
V_10 -> V_366 . V_363 . V_346 . V_145 = V_345 -> V_346 . V_145 ;
V_10 -> V_366 . V_363 . V_346 . V_39 = V_345 -> V_346 . V_39 ;
V_10 -> V_366 . V_363 . V_262 = V_345 -> V_262 ;
V_250 = 0 ;
if ( F_12 ( V_17 , V_257 ) ) {
struct V_247 * V_248 ;
V_248 = F_106 ( sizeof( * V_248 ) ) ;
V_248 -> V_26 = V_10 -> V_26 [ ! ! V_17 -> V_27 ] . V_28 ;
F_107 ( V_10 , & V_17 -> V_363 , V_17 -> V_353 , V_248 ) ;
...
static int F_110 ( struct V_16 * V_17 , enum V_372 type )
{
struct V_258 * V_259 = F_108 ( V_17 ) ;
int V_370 = F_109 ( V_17 ) ;
if ( F_12 ( V_17 , V_370 ) )
return - V_343 ;
if ( F_111 ( V_259 ) )
return - V_343 ;
...
V_294 -> V_145 = V_145 ;
V_294 -> V_39 = V_39 ;
if ( V_260 -> V_164 & V_374 ) {
V_294 -> V_375 = V_145 ;
V_294 -> V_376 = ( V_145 * V_39 * V_260 -> V_275 ) >> 3 ;
} else {
V_294 -> V_375 = ( V_145 * V_260 -> V_275 ) >> 3 ;
V_294 -> V_376 = V_39 * V_294 -> V_375 ;
}
}
...
{
struct V_16 * V_17 = V_291 ;
F_112 ( & V_294 -> V_260 . V_378 , V_17 -> V_260 ,
V_17 -> V_145 , V_17 -> V_39 ) ;
V_294 -> V_260 . V_378 . V_262 = V_17 -> V_256 . V_262 ;
V_294 -> V_260 . V_378 . V_379 = V_17 -> V_260 -> V_244 ;
V_294 -> V_260 . V_378 . V_380 = V_381 ;
return 0 ;
}
...
{
struct V_16 * V_17 = V_291 ;
V_294 -> V_260 . V_345 . V_346 = V_17 -> V_363 . V_346 ;
V_294 -> V_260 . V_345 . V_262 = V_17 -> V_363 . V_262 ;
return 0 ;
}
...
T_2 V_352 ;
int V_265 ;
V_260 = F_63 ( V_294 -> V_260 . V_378 . V_379 ) ;
if ( NULL == V_260 )
return - V_97 ;
V_262 = V_294 -> V_260 . V_378 . V_262 ;
switch ( V_262 ) {
case V_272 :
case V_273 :
case V_274 :
...
V_262 = ( V_294 -> V_260 . V_378 . V_39 > V_352 )
? V_350
: V_273 ;
break;
}
V_145 = V_294 -> V_260 . V_378 . V_145 ;
V_39 = V_294 -> V_260 . V_378 . V_39 ;
...
if ( 0 != V_265 )
return V_265 ;
V_294 -> V_260 . V_378 . V_262 = V_262 ;
F_112 ( & V_294 -> V_260 . V_378 , V_260 , V_145 , V_39 ) ;
V_294 -> V_260 . V_378 . V_380 = V_381 ;
return 0 ;
}
...
V_39 = V_294 -> V_260 . V_378 . V_39 ;
V_262 = V_294 -> V_260 . V_378 . V_262 ;
V_250 = F_95 ( V_17 , & V_145 , & V_39 , V_294 -> V_260 . V_378 . V_262 ,
~ 3 ,
2 ,
1 ,
1 ) ;
...
V_260 = F_63 ( V_294 -> V_260 . V_378 . V_379 ) ;
V_17 -> V_260 = V_260 ;
V_17 -> V_256 . V_262 = V_294 -> V_260 . V_378 . V_262 ;
V_17 -> V_256 . V_384 = V_385 ;
V_17 -> V_145 = V_294 -> V_260 . V_378 . V_145 ;
V_17 -> V_39 = V_294 -> V_260 . V_378 . V_39 ;
V_10 -> V_366 . V_260 = V_260 ;
V_10 -> V_366 . V_145 = V_294 -> V_260 . V_378 . V_145 ;
V_10 -> V_366 . V_39 = V_294 -> V_260 . V_378 . V_39 ;
return 0 ;
}
...
return F_100 ( V_17 , V_10 , & V_294 -> V_260 . V_345 , 1 ) ;
}
...
if ( 0 == V_388 )
return - V_97 ;
F_120 ( V_256 -> V_389 , L_20 , sizeof( V_256 -> V_389 ) ) ;
F_120 ( V_256 -> V_390 , V_10 -> V_391 -> V_302 , sizeof( V_256 -> V_390 ) ) ;
snprintf ( V_256 -> V_392 , sizeof( V_256 -> V_392 ) ,
L_21 , F_121 ( V_10 -> V_11 . V_393 ) ) ;
V_256 -> V_394 =
V_395 |
V_396 |
V_397 |
...
if ( V_10 -> V_170 != V_171 )
V_256 -> V_394 |= V_406 ;
if ( V_324 -> V_407 == V_408 )
V_256 -> V_409 = V_256 -> V_394 &
( V_395 |
V_396 |
V_397 |
V_399 |
V_406 ) ;
else if ( V_324 -> V_407 == V_410 )
V_256 -> V_409 = V_256 -> V_394 &
( V_401 |
V_396 |
V_397 |
...
static int F_122 ( struct V_411 * V_294 )
{
int V_299 = - 1 , V_53 ;
for ( V_53 = 0 ; V_53 < V_245 ; V_53 ++ ) {
...
if ( V_245 == V_53 )
return - V_97 ;
V_294 -> V_379 = V_246 [ V_53 ] . V_244 ;
F_120 ( V_294 -> V_412 , V_246 [ V_53 ] . V_302 , sizeof( V_294 -> V_412 ) ) ;
return V_53 ;
}
...
V_414 -> V_164 = V_417 ;
if ( V_17 -> V_353 )
V_414 -> V_260 . V_379 = V_17 -> V_353 -> V_244 ;
return 0 ;
}
static int F_126 ( struct V_290 * V_290 , void * V_294 , unsigned int V_418 )
{
struct V_16 * V_17 = V_294 ;
struct V_9 * V_10 = V_17 -> V_10 ;
struct V_247 * V_248 ;
int V_250 = 0 ;
if ( V_418 ) {
if ( F_127 ( ! V_10 -> V_279 . V_362 ) ) {
return - V_97 ;
}
if ( F_127 ( ! V_17 -> V_363 . V_365 ) ) {
...
! F_129 ( V_420 ) )
return - V_421 ;
V_260 = F_63 ( V_414 -> V_260 . V_379 ) ;
if ( NULL == V_260 )
return - V_97 ;
if ( 0 == ( V_260 -> V_164 & V_358 ) )
return - V_97 ;
V_250 = - V_97 ;
if ( V_414 -> V_164 & V_422 ) {
T_2 V_145 = V_414 -> V_260 . V_145 ;
T_2 V_39 = V_414 -> V_260 . V_39 ;
...
V_10 -> V_279 . V_362 = V_414 -> V_362 ;
V_10 -> V_279 . V_260 . V_145 = V_414 -> V_260 . V_145 ;
V_10 -> V_279 . V_260 . V_39 = V_414 -> V_260 . V_39 ;
if ( 0 != V_414 -> V_260 . V_375 )
V_10 -> V_279 . V_260 . V_375 = V_414 -> V_260 . V_375 ;
else
V_10 -> V_279 . V_260 . V_375 = V_10 -> V_279 . V_260 . V_145 * V_260 -> V_275 / 8 ;
V_250 = 0 ;
V_17 -> V_353 = V_260 ;
V_10 -> V_366 . V_353 = V_260 ;
if ( V_414 -> V_164 & V_422 ) {
V_17 -> V_363 . V_346 . V_277 = 0 ;
V_17 -> V_363 . V_346 . V_25 = 0 ;
V_17 -> V_363 . V_346 . V_145 = V_414 -> V_260 . V_145 ;
V_17 -> V_363 . V_346 . V_39 = V_414 -> V_260 . V_39 ;
V_10 -> V_366 . V_363 . V_346 . V_145 = V_414 -> V_260 . V_145 ;
V_10 -> V_366 . V_363 . V_346 . V_39 = V_414 -> V_260 . V_39 ;
F_66 ( V_17 -> V_363 . V_356 ) ;
V_17 -> V_363 . V_356 = NULL ;
V_17 -> V_363 . V_364 = 0 ;
if ( F_12 ( V_17 , V_257 ) ) {
struct V_247 * V_248 ;
V_248 = F_106 ( sizeof( * V_248 ) ) ;
...
static int F_134 ( struct V_290 * V_290 , void * V_291 , struct V_425 * V_330 )
{
struct V_16 * V_17 = V_291 ;
struct V_9 * V_10 = V_17 -> V_10 ;
int V_370 = F_109 ( V_17 ) ;
if ( ! F_11 ( V_10 , V_17 , V_370 ) )
return - V_343 ;
return F_135 ( F_108 ( V_17 ) , V_330 ) ;
}
static int F_136 ( struct V_290 * V_290 , void * V_291 , struct V_425 * V_330 )
{
struct V_16 * V_17 = V_291 ;
...
if ( V_429 -> type != V_367 )
return - V_97 ;
V_429 -> V_429 . V_287 . V_430 = V_282 ;
F_143 ( V_36 [ V_10 -> V_35 ] . V_161 ,
& V_429 -> V_429 . V_287 . V_431 ) ;
return 0 ;
}
...
static int F_146 ( struct V_290 * V_290 , void * V_294 , struct V_439 * V_26 )
{
struct V_16 * V_17 = V_294 ;
struct V_9 * V_10 = V_17 -> V_10 ;
if ( V_26 -> type != V_367 &&
...
static int F_147 ( struct V_290 * V_290 , void * V_294 , const struct V_439 * V_26 )
{
struct V_16 * V_17 = V_294 ;
struct V_9 * V_10 = V_17 -> V_10 ;
const struct V_329 * V_330 ;
...
V_330 = & V_36 [ V_10 -> V_35 ] . V_37 . V_38 ;
V_440 = V_330 -> V_277 ;
V_442 = V_440 + V_330 -> V_145 ;
V_443 = V_330 -> V_25 + V_330 -> V_39 ;
V_441 = F_148 ( V_330 -> V_25 , V_10 -> V_29 ) ;
if ( V_441 + 32 >= V_443 ) {
return V_250 ;
}
V_11 . V_28 . V_277 = F_149 ( V_444 , V_26 -> V_11 . V_277 , V_440 , V_442 - 48 ) ;
V_11 . V_28 . V_277 = F_94 ( V_11 . V_28 . V_277 , ( T_2 ) V_334 ) ;
V_11 . V_28 . V_145 = F_149 ( V_444 , V_26 -> V_11 . V_145 ,
48 , V_442 - V_11 . V_28 . V_277 ) ;
V_11 . V_28 . V_25 = F_149 ( V_444 , V_26 -> V_11 . V_25 , V_441 , V_443 - 32 ) ;
V_11 . V_28 . V_25 = ( V_11 . V_28 . V_25 + 1 ) & ~ 1 ;
V_11 . V_28 . V_39 = F_149 ( V_444 , V_26 -> V_11 . V_39 ,
32 , V_443 - V_11 . V_28 . V_25 ) ;
...
T_8 V_281 , T_9 * V_445 )
{
struct V_16 * V_17 = V_290 -> V_446 ;
int V_250 = 0 ;
if ( V_17 -> V_10 -> V_199 )
F_58 ( V_17 -> V_10 ) ;
F_22 ( L_23 ,
V_17 -> V_10 -> V_11 . V_58 , ( int ) V_281 , V_447 [ V_17 -> type ] ) ;
switch ( V_17 -> type ) {
case V_367 :
if ( ! F_11 ( V_17 -> V_10 , V_17 , V_21 ) ) {
return - V_343 ;
}
V_250 = F_151 ( & V_17 -> V_256 , V_237 , V_281 , V_445 ,
V_290 -> V_426 & V_427 ) ;
F_18 ( V_17 -> V_10 , V_17 , V_21 ) ;
break;
case V_368 :
if ( ! F_11 ( V_17 -> V_10 , V_17 , V_371 ) )
return - V_343 ;
V_250 = F_152 ( & V_17 -> V_369 , V_237 , V_281 , V_445 , 1 ,
V_290 -> V_426 & V_427 ) ;
break;
default:
F_99 () ;
...
static unsigned int F_153 ( struct V_290 * V_290 , T_10 * V_448 )
{
struct V_16 * V_17 = V_290 -> V_446 ;
struct V_247 * V_5 ;
enum V_261 V_262 ;
unsigned int V_265 = 0 ;
unsigned long V_449 = F_154 ( V_448 ) ;
if ( F_155 ( & V_17 -> V_17 ) )
V_265 = V_450 ;
else if ( V_449 & V_450 )
F_156 ( V_290 , & V_17 -> V_17 . V_448 , V_448 ) ;
if ( ! ( V_449 & ( V_451 | V_452 ) ) )
return V_265 ;
if ( V_368 == V_17 -> type ) {
if ( ! F_11 ( V_17 -> V_10 , V_17 , V_371 ) )
return V_265 | V_453 ;
return V_265 | F_157 ( V_290 , & V_17 -> V_369 , V_448 ) ;
}
if ( F_12 ( V_17 , V_22 ) ) {
if ( F_158 ( & V_17 -> V_256 . V_454 ) )
return V_265 | V_453 ;
V_5 = F_159 ( V_17 -> V_256 . V_454 . V_455 , struct V_247 , V_251 . V_454 ) ;
} else {
if ( NULL == V_17 -> V_256 . V_456 ) {
if ( F_13 ( V_17 -> V_10 , V_22 ) )
return V_265 | V_453 ;
V_17 -> V_256 . V_456 = F_106 ( V_17 -> V_256 . V_457 ) ;
if ( NULL == V_17 -> V_256 . V_456 )
return V_265 | V_453 ;
V_17 -> V_256 . V_456 -> V_458 = V_459 ;
V_262 = F_160 ( & V_17 -> V_256 ) ;
if ( 0 != V_17 -> V_256 . V_460 -> V_461 ( & V_17 -> V_256 , V_17 -> V_256 . V_456 , V_262 ) ) {
F_66 ( V_17 -> V_256 . V_456 ) ;
V_17 -> V_256 . V_456 = NULL ;
return V_265 | V_453 ;
}
V_17 -> V_256 . V_460 -> V_462 ( & V_17 -> V_256 , V_17 -> V_256 . V_456 ) ;
V_17 -> V_256 . V_463 = 0 ;
}
V_5 = (struct V_247 * ) V_17 -> V_256 . V_456 ;
}
F_156 ( V_290 , & V_5 -> V_251 . V_464 , V_448 ) ;
if ( V_5 -> V_251 . V_252 == V_253 ||
V_5 -> V_251 . V_252 == V_465 )
V_265 = V_265 | V_451 | V_452 ;
return V_265 ;
}
...
F_22 ( L_25 ,
V_10 -> V_11 . V_58 , V_447 [ type ] ) ;
V_17 = F_101 ( sizeof( * V_17 ) , V_359 ) ;
if ( F_127 ( ! V_17 ) )
return - V_360 ;
V_10 -> V_109 ++ ;
V_290 -> V_446 = V_17 ;
...
V_17 -> type = type ;
V_17 -> V_363 . V_365 = 0 ;
F_166 ( & V_17 -> V_256 , & V_467 ,
& V_10 -> V_11 . V_393 -> V_8 , & V_10 -> V_166 ,
V_367 ,
V_350 ,
sizeof( struct V_247 ) ,
V_17 , & V_10 -> V_468 ) ;
F_166 ( & V_17 -> V_369 , & V_469 ,
& V_10 -> V_11 . V_393 -> V_8 , & V_10 -> V_166 ,
V_368 ,
V_383 ,
sizeof( struct V_247 ) ,
...
if ( V_17 -> V_256 . V_456 ) {
F_74 ( & V_17 -> V_256 , V_17 -> V_256 . V_456 ) ;
F_66 ( V_17 -> V_256 . V_456 ) ;
}
if ( F_12 ( V_17 , V_21 ) ) {
F_18 ( V_10 , V_17 , V_21 ) ;
...
static int
F_174 ( struct V_290 * V_290 , struct V_471 * V_472 )
{
struct V_16 * V_17 = V_290 -> V_446 ;
F_22 ( L_26 ,
V_17 -> V_10 -> V_11 . V_58 , V_447 [ V_17 -> type ] ,
V_472 -> V_473 , V_472 -> V_474 - V_472 -> V_473 ) ;
return F_175 ( F_108 ( V_17 ) , V_472 ) ;
}
...
F_66 ( V_17 ) ;
V_10 -> V_475 -- ;
F_51 ( V_10 , V_162 , V_478 , V_479 , & V_477 ) ;
if ( V_10 -> V_475 == 0 )
V_10 -> V_110 = 0 ;
return 0 ;
}
...
struct V_476 V_477 ;
V_477 . V_480 = V_281 / 3 ;
V_477 . V_481 = V_290 -> V_426 & V_427 ;
V_477 . V_482 = V_237 ;
V_477 . V_483 = V_290 ;
V_477 . V_484 = - V_466 ;
F_75 ( V_10 ) ;
F_51 ( V_10 , V_162 , V_478 , V_485 , & V_477 ) ;
return V_477 . V_484 ;
}
static unsigned int F_181 ( struct V_290 * V_290 , T_10 * V_448 )
{
struct V_16 * V_17 = V_290 -> V_446 ;
struct V_9 * V_10 = V_17 -> V_10 ;
unsigned long V_449 = F_154 ( V_448 ) ;
...
V_477 . V_486 = V_448 ;
V_477 . V_484 = V_370 ;
F_51 ( V_10 , V_162 , V_478 , V_487 , & V_477 ) ;
return V_477 . V_484 ;
}
static int F_182 ( T_4 V_488 )
{
...
static void F_188 ( T_4 V_505 , T_4 V_506 )
{
unsigned int V_53 ;
F_183 ( L_64 ) ;
for ( V_53 = 0 ; V_53 < F_184 ( V_507 ) ; V_53 ++ ) {
if ( V_505 & ( 1 << V_53 ) )
F_183 ( L_55 , V_507 [ V_53 ] ) ;
if ( V_506 & ( 1 << V_53 ) )
F_183 ( L_65 ) ;
}
}
...
( unsigned long ) F_186 ( V_10 -> main. V_501 [ V_508 + 1 ] ) ,
( unsigned long ) F_186 ( V_10 -> main. V_501 [ V_509 + 1 ] ) ,
( unsigned long ) V_265 ) ;
...
static int
F_193 ( struct V_9 * V_10 , struct V_510 * V_511 )
{
struct V_247 * V_512 ;
memset ( V_511 , 0 , sizeof( * V_511 ) ) ;
if ( ! F_158 ( & V_10 -> V_287 ) ) {
V_511 -> V_168 = 1 ;
V_512 = F_159 ( V_10 -> V_287 . V_455 , struct V_247 , V_251 . V_286 ) ;
if ( F_194 ( V_512 -> V_251 . V_262 ) )
V_511 -> V_25 = V_512 ;
if ( F_195 ( V_512 -> V_251 . V_262 ) )
V_511 -> V_504 = V_512 ;
if ( ! F_93 ( V_512 -> V_251 . V_262 ) &&
( V_512 -> V_251 . V_286 . V_455 != & V_10 -> V_287 ) ) {
V_512 = F_159 ( V_512 -> V_251 . V_286 . V_455 , struct V_247 , V_251 . V_286 ) ;
if ( ! F_93 ( V_512 -> V_251 . V_262 ) ) {
if ( NULL == V_511 -> V_504 &&
...
static void
F_196 ( struct V_9 * V_10 , struct V_510 * V_514 ,
...
F_198 ( & V_514 -> V_504 -> V_251 . V_464 ) ;
}
}
}
static void
F_199 ( struct V_9 * V_10 , struct V_247 * V_514 ,
unsigned int V_252 )
{
struct V_515 V_516 ;
if ( NULL == V_514 )
...
F_202 ( V_10 , NULL ) ;
F_59 ( V_10 , 0 ) ;
F_196 ( V_10 , & V_249 , & V_248 , V_465 ) ;
F_199 ( V_10 , V_518 , V_465 ) ;
while ( ! F_158 ( & V_10 -> V_287 ) ) {
V_512 = F_159 ( V_10 -> V_287 . V_455 , struct V_247 , V_251 . V_286 ) ;
F_203 ( & V_512 -> V_251 . V_286 ) ;
V_512 -> V_251 . V_252 = V_465 ;
F_198 ( & V_512 -> V_251 . V_464 ) ;
}
while ( ! F_158 ( & V_10 -> V_523 ) ) {
V_512 = F_159 ( V_10 -> V_523 . V_455 , struct V_247 , V_251 . V_286 ) ;
F_203 ( & V_512 -> V_251 . V_286 ) ;
V_512 -> V_251 . V_252 = V_465 ;
F_198 ( & V_512 -> V_251 . V_464 ) ;
}
...
F_206 ( V_10 , V_509 , NULL , 0 ) ;
F_197 ( & V_514 -> V_251 . V_516 ) ;
V_514 -> V_251 . V_242 = V_10 -> V_242 ;
V_514 -> V_251 . V_252 = V_253 ;
F_198 ( & V_514 -> V_251 . V_464 ) ;
F_207 ( & V_10 -> V_166 ) ;
}
static inline int F_208 ( struct V_499 * V_488 , T_4 V_265 )
{
...
( V_10 -> V_167 . V_504 && F_208 ( & V_10 -> V_167 . V_504 -> V_504 , V_265 ) ) ) {
V_10 -> V_519 ++ ;
if ( V_524 )
F_189 ( V_10 , V_265 ) ;
F_207 ( & V_10 -> V_166 ) ;
...
F_205 ( & V_10 -> V_166 ) ;
if ( ! F_158 ( & V_10 -> V_523 ) )
V_248 = F_159 ( V_10 -> V_523 . V_455 , struct V_247 , V_251 . V_286 ) ;
V_249 = V_10 -> V_503 ;
V_265 = F_16 ( V_522 ) ;
if ( NULL != V_249 && ( F_208 ( & V_249 -> V_25 , V_265 ) ||
F_208 ( & V_249 -> V_504 , V_265 ) ) ) {
V_10 -> V_519 ++ ;
if ( V_524 )
F_189 ( V_10 , V_265 ) ;
F_207 ( & V_10 -> V_166 ) ;
...
static T_12 F_211 ( int V_525 , void * V_526 )
{
T_4 V_527 , V_528 ;
T_4 V_529 ;
int V_281 ;
...
if ( V_386 > 0 )
F_191 ( L_95 ) ;
V_10 -> V_391 = F_214 ( V_10 , & V_547 , L_96 ) ;
if ( NULL == V_10 -> V_391 )
goto V_292;
if ( F_223 ( V_10 -> V_391 , V_408 ,
V_548 [ V_10 -> V_11 . V_58 ] ) < 0 )
goto V_292;
F_23 ( L_97 ,
V_10 -> V_11 . V_58 , F_163 ( V_10 -> V_391 ) ) ;
if ( F_224 ( & V_10 -> V_391 -> V_8 ,
& V_549 ) < 0 ) {
F_19 ( L_98 , V_10 -> V_11 . V_58 ) ;
goto V_292;
}
V_10 -> V_400 = F_214 ( V_10 , & V_547 , L_99 ) ;
if ( NULL == V_10 -> V_400 )
goto V_292;
if ( F_223 ( V_10 -> V_400 , V_410 ,
V_550 [ V_10 -> V_11 . V_58 ] ) < 0 )
goto V_292;
F_23 ( L_97 ,
V_10 -> V_11 . V_58 , F_163 ( V_10 -> V_400 ) ) ;
if ( ! V_10 -> V_551 )
return 0 ;
V_10 -> V_402 = F_214 ( V_10 , & V_552 , L_100 ) ;
if ( NULL == V_10 -> V_402 )
goto V_292;
V_10 -> V_402 -> V_121 = & V_10 -> V_553 ;
if ( F_223 ( V_10 -> V_402 , V_554 ,
V_555 [ V_10 -> V_11 . V_58 ] ) < 0 )
goto V_292;
F_23 ( L_97 ,
V_10 -> V_11 . V_58 , F_163 ( V_10 -> V_402 ) ) ;
return 0 ;
V_292:
F_219 ( V_10 ) ;
return - 1 ;
}
static void F_225 ( struct V_556 * V_8 )
{
#if F_226 ( V_557 )
unsigned int V_477 ;
F_227 ( V_8 , V_558 , & V_477 ) ;
V_477 = ( V_477 | V_559 ) ;
F_228 ( V_8 , V_558 , V_477 ) ;
#endif
}
static int F_229 ( struct V_556 * V_8 , const struct V_560 * V_561 )
{
struct V_315 V_562 = {
. V_288 = 0 ,
. type = V_436 ,
...
return - V_360 ;
F_23 ( L_101 , V_566 ) ;
V_568 [ V_566 ] = V_10 = F_230 ( sizeof( * V_10 ) , V_359 ) ;
if ( V_10 == NULL ) {
F_19 ( L_102 ) ;
return - V_360 ;
}
...
F_242 ( V_8 ) ;
F_225 ( V_8 ) ;
V_484 = F_243 ( & V_8 -> V_8 , & V_10 -> V_11 . V_325 ) ;
if ( V_484 < 0 ) {
...
F_245 ( V_8 , V_577 , & V_563 ) ;
F_23 ( L_108 ,
V_566 , V_10 -> V_149 , V_10 -> V_542 , F_121 ( V_8 ) ,
V_10 -> V_11 . V_393 -> V_525 , V_563 ,
( unsigned long long ) F_240 ( V_8 , 0 ) ) ;
F_246 () ;
V_10 -> V_578 = F_247 ( F_240 ( V_8 , 0 ) , 0x1000 ) ;
if ( NULL == V_10 -> V_578 ) {
...
F_248 ( V_10 ) ;
F_17 ( 0 , V_175 ) ;
V_484 = F_249 ( V_10 -> V_11 . V_393 -> V_525 , F_211 ,
V_580 , V_10 -> V_11 . V_325 . V_302 , ( void * ) V_10 ) ;
if ( V_484 < 0 ) {
F_19 ( L_110 ,
V_566 , V_10 -> V_11 . V_393 -> V_525 ) ;
goto V_579;
}
if ( 0 != F_250 ( V_10 ) ) {
V_484 = - V_575 ;
...
V_599 . V_584 = V_600 ;
V_601 . V_584 = V_602 ;
V_10 -> V_366 . V_10 = V_10 ;
V_10 -> V_366 . V_363 . V_346 . V_145 = 320 ;
V_10 -> V_366 . V_363 . V_346 . V_39 = 240 ;
V_10 -> V_366 . V_260 = F_63 ( V_603 ) ;
V_10 -> V_366 . V_145 = 320 ;
V_10 -> V_366 . V_39 = 240 ;
V_10 -> V_366 . V_363 . V_346 . V_145 = 320 ;
V_10 -> V_366 . V_363 . V_346 . V_39 = 240 ;
V_10 -> V_366 . V_363 . V_262 = V_350 ;
V_10 -> V_69 = 0 ;
F_251 ( V_565 , & V_604 ,
...
F_252 ( V_565 , & V_583 , NULL ) ;
F_252 ( V_565 , & V_588 , NULL ) ;
F_252 ( V_565 , & V_585 , NULL ) ;
F_252 ( V_565 , & V_589 , NULL ) ;
F_252 ( V_565 , & V_592 , NULL ) ;
F_252 ( V_565 , & V_595 , NULL ) ;
F_252 ( V_565 , & V_593 , NULL ) ;
F_252 ( V_565 , & V_598 , NULL ) ;
F_252 ( V_565 , & V_599 , NULL ) ;
F_252 ( V_565 , & V_601 , NULL ) ;
if ( V_115 )
F_39 ( V_10 , L_111 ) ;
F_253 ( V_10 ) ;
F_56 ( V_10 ) ;
...
return 0 ;
V_581:
F_262 ( V_10 -> V_11 . V_393 -> V_525 , V_10 ) ;
V_579:
F_263 ( & V_10 -> V_121 ) ;
F_263 ( & V_10 -> V_553 ) ;
...
if ( V_10 -> V_578 )
F_265 ( V_10 -> V_578 ) ;
F_266 ( F_240 ( V_10 -> V_11 . V_393 , 0 ) ,
F_241 ( V_10 -> V_11 . V_393 , 0 ) ) ;
return V_484 ;
}
static void F_267 ( struct V_556 * V_556 )
{
struct V_611 * V_325 = F_268 ( V_556 ) ;
...
F_263 ( & V_10 -> V_121 ) ;
F_263 ( & V_10 -> V_553 ) ;
F_273 ( V_10 -> V_11 . V_393 , & V_10 -> main ) ;
F_262 ( V_10 -> V_11 . V_393 -> V_525 , V_10 ) ;
F_265 ( V_10 -> V_578 ) ;
F_266 ( F_240 ( V_10 -> V_11 . V_393 , 0 ) ,
F_241 ( V_10 -> V_11 . V_393 , 0 ) ) ;
...
static int F_274 ( struct V_556 * V_556 , T_13 V_252 )
{
struct V_611 * V_325 = F_268 ( V_556 ) ;
struct V_9 * V_10 = F_269 ( V_325 ) ;
struct V_510 V_613 ;
...
V_10 -> V_252 . V_615 = V_10 -> V_167 ;
V_10 -> V_252 . V_369 = V_10 -> V_503 ;
...
F_275 ( V_556 ) ;
if ( 0 != F_276 ( V_556 , F_277 ( V_556 , V_252 ) ) ) {
F_278 ( V_556 ) ;
V_10 -> V_252 . V_618 = 1 ;
}
return 0 ;
}
static int F_279 ( struct V_556 * V_556 )
{
struct V_611 * V_325 = F_268 ( V_556 ) ;
struct V_9 * V_10 = F_269 ( V_325 ) ;
unsigned long V_164 ;
...
F_53 ( & V_10 -> V_166 , V_164 ) ;
V_10 -> V_167 = V_10 -> V_252 . V_615 ;
V_10 -> V_503 = V_10 -> V_252 . V_369 ;
V_10 -> V_255 = V_10 -> V_252 . V_255 ;
F_201 ( V_10 , & V_10 -> V_167 ) ;
F_202 ( V_10 , V_10 -> V_503 ) ;
F_59 ( V_10 , 0 ) ;
F_54 ( & V_10 -> V_166 , V_164 ) ;
return 0 ;
}
