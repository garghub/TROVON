...
int V_10 ;
for ( V_10 = 0 ; V_10 < V_69 -> V_74 ; V_10 ++ )
V_70 [ V_10 ] = V_8 -> V_82 [ F_14 ( V_69 -> V_73 ) ] ;
return V_10 ;
}
...
{
struct V_7 * V_8 = V_2 -> V_9 ;
unsigned int V_51 = F_14 ( V_69 -> V_73 ) ;
unsigned int V_90 ;
int V_91 ;
if ( V_51 < 4 )
V_90 = 0x0f ;
...
V_90 = 0xf0 ;
V_91 = F_23 ( V_2 , V_23 , V_69 , V_70 , V_90 ) ;
if ( V_91 )
return V_91 ;
V_8 -> V_55 &= ~ ( V_92 | V_93 ) ;
if ( V_23 -> V_94 & 0x0f )
...
struct V_95 * V_96 )
{
const struct V_97 * V_98 = F_25 ( V_2 ) ;
struct V_7 * V_8 ;
struct V_22 * V_23 ;
int V_91 ;
V_91 = F_26 ( V_2 , V_96 -> V_99 [ 0 ] , V_100 ) ;
if ( V_91 )
return V_91 ;
V_91 = F_27 ( V_2 , 4 ) ;
if ( V_91 )
...
F_3 ( V_2 ) ;
if ( V_96 -> V_99 [ 1 ] ) {
V_91 = F_29 ( V_96 -> V_99 [ 1 ] , F_4 , 0 ,
V_2 -> V_102 , V_2 ) ;
if ( V_91 == 0 )
V_2 -> V_20 = V_96 -> V_99 [ 1 ] ;
}
V_8 -> V_103 = V_96 -> V_99 [ 5 ] ;
V_8 -> V_104 = V_96 -> V_99 [ 6 ] ;
V_8 -> V_105 = V_96 -> V_99 [ 7 ] ;
V_8 -> V_106 = V_96 -> V_99 [ 8 ] ;
V_8 -> V_83 = V_96 -> V_99 [ 9 ] ;
V_8 -> V_107 = V_96 -> V_99 [ 10 ] ;
V_8 -> V_108 = V_96 -> V_99 [ 11 ] ;
V_8 -> V_85 = V_96 -> V_99 [ 12 ] ;
V_23 = & V_2 -> V_109 [ 0 ] ;
V_23 -> type = V_110 ;
