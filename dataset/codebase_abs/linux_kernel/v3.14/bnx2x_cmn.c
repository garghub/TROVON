...
{
return V_8 ?
F_9 ( int , V_8 , F_10 ( V_2 ) ) :
F_9 ( int , F_11 () ,
F_10 ( V_2 ) ) ;
}
static inline void F_12 ( struct V_1 * V_2 , int V_9 , int V_10 )
{
struct V_11 * V_12 = & V_2 -> V_13 [ V_9 ] ;
struct V_11 * V_14 = & V_2 -> V_13 [ V_10 ] ;
struct V_15 * V_16 = & V_2 -> V_17 [ V_9 ] ;
struct V_15 * V_18 = & V_2 -> V_17 [ V_10 ] ;
struct V_19 * V_20 = & V_2 -> V_21 [ V_9 ] ;
struct V_19 * V_22 = & V_2 -> V_21 [ V_10 ] ;
int V_23 , V_24 ;
int V_25 = 0 , V_26 = 0 ;
struct V_27 * V_28 = V_14 -> V_29 ;
V_12 -> V_5 = V_14 -> V_5 ;
memcpy ( V_14 , V_12 , sizeof( * V_14 ) ) ;
V_14 -> V_30 = V_10 ;
V_14 -> V_29 = V_28 ;
memcpy ( V_18 , V_16 , sizeof( * V_18 ) ) ;
memcpy ( V_22 , V_20 , sizeof( * V_22 ) ) ;
V_23 = F_13 ( V_2 ) * ( V_2 ) -> V_31 ;
V_24 = ( F_13 ( V_2 ) - V_9 + V_10 ) *
( V_2 ) -> V_31 ;
if ( V_9 == F_14 ( V_2 ) ) {
V_25 = V_23 + V_32 ;
V_26 = V_24 + V_32 ;
}
memcpy ( & V_2 -> V_33 [ V_26 ] ,
& V_2 -> V_33 [ V_25 ] ,
sizeof( struct V_34 ) ) ;
V_14 -> V_35 [ 0 ] = & V_2 -> V_33 [ V_26 ] ;
}
void F_15 ( struct V_1 * V_2 , char * V_36 , T_1 V_37 )
{
if ( F_16 ( V_2 ) ) {
T_2 V_38 [ V_39 ] ;
V_38 [ 0 ] = '\0' ;
F_17 ( & V_2 -> V_40 ,
V_38 , V_39 ) ;
F_18 ( V_36 , V_2 -> V_41 , V_37 ) ;
snprintf ( V_36 + strlen ( V_2 -> V_41 ) , 32 - strlen ( V_2 -> V_41 ) ,
L_1 ,
( V_2 -> V_42 . V_43 & 0xff0000 ) >> 16 ,
( V_2 -> V_42 . V_43 & 0xff00 ) >> 8 ,
( V_2 -> V_42 . V_43 & 0xff ) ,
( ( V_38 [ 0 ] != '\0' ) ? L_2 : L_3 ) , V_38 ) ;
} else {
F_19 ( V_2 , V_36 , V_37 ) ;
}
}
...
{
int V_3 , cos , V_45 = F_13 ( V_2 ) ;
for ( cos = 1 ; cos < V_2 -> V_31 ; cos ++ ) {
for ( V_3 = 0 ; V_3 < V_45 - V_44 ; V_3 ++ ) {
struct V_11 * V_13 = & V_2 -> V_13 [ V_3 ] ;
int V_46 = cos * ( V_45 - V_44 ) + V_3 ;
memcpy ( & V_2 -> V_33 [ V_46 ] , V_13 -> V_35 [ cos ] ,
sizeof( struct V_34 ) ) ;
V_13 -> V_35 [ cos ] = & V_2 -> V_33 [ V_46 ] ;
}
}
}
static T_3 F_21 ( struct V_1 * V_2 , struct V_34 * V_47 ,
T_3 V_48 , unsigned int * V_49 ,
unsigned int * V_50 )
{
struct V_51 * V_52 = & V_47 -> V_53 [ V_48 ] ;
struct V_54 * V_55 ;
struct V_56 * V_57 ;
struct V_58 * V_59 = V_52 -> V_59 ;
T_3 V_60 = F_22 ( V_52 -> V_61 ) , V_62 ;
int V_63 ;
T_3 V_64 = 0 ;
F_23 ( & V_59 -> V_65 ) ;
F_24 ( V_66 , L_4 ,
V_47 -> V_67 , V_48 , V_52 , V_59 ) ;
V_55 = & V_47 -> V_68 [ V_60 ] . V_69 ;
V_63 = F_25 ( V_55 -> V_63 ) - 1 ;
#ifdef F_26
if ( ( V_63 - 1 ) > ( V_70 + 2 ) ) {
F_27 ( L_5 ) ;
F_28 () ;
...
V_60 = F_22 ( F_29 ( V_60 ) ) ;
if ( V_52 -> V_71 & V_72 ) {
V_57 = & V_47 -> V_68 [ V_60 ] . V_73 ;
V_64 = F_30 ( V_57 ) ;
-- V_63 ;
V_60 = F_22 ( F_29 ( V_60 ) ) ;
}
F_31 ( & V_2 -> V_74 -> V_4 , F_32 ( V_55 ) ,
F_30 ( V_55 ) + V_64 ,
V_75 ) ;
while ( V_63 > 0 ) {
V_57 = & V_47 -> V_68 [ V_60 ] . V_73 ;
F_33 ( & V_2 -> V_74 -> V_4 , F_32 ( V_57 ) ,
F_30 ( V_57 ) , V_75 ) ;
if ( -- V_63 )
V_60 = F_22 ( F_29 ( V_60 ) ) ;
}
...
int F_37 ( struct V_1 * V_2 , struct V_34 * V_47 )
{
struct V_77 * V_78 ;
T_3 V_79 , V_80 , V_81 = V_47 -> V_82 ;
unsigned int V_49 = 0 , V_50 = 0 ;
#ifdef F_26
if ( F_38 ( V_2 -> V_83 ) )
return - 1 ;
#endif
V_78 = F_39 ( V_2 -> V_4 , V_47 -> V_67 ) ;
V_79 = F_25 ( * V_47 -> V_84 ) ;
V_80 = V_47 -> V_85 ;
while ( V_80 != V_79 ) {
T_3 V_86 ;
...
F_24 ( V_66 ,
L_6 ,
V_47 -> V_67 , V_79 , V_80 , V_86 ) ;
V_81 = F_21 ( V_2 , V_47 , V_86 ,
& V_49 , & V_50 ) ;
V_80 ++ ;
}
F_40 ( V_78 , V_49 , V_50 ) ;
...
static inline void F_48 ( struct V_11 * V_13 ,
T_3 V_48 )
{
T_3 V_90 = V_13 -> V_91 ;
if ( F_49 ( V_48 , V_90 ) > 0 )
...
static inline void F_50 ( struct V_11 * V_13 ,
T_3 V_92 ,
struct V_93 * V_94 )
{
...
F_51 ( V_13 -> V_97 ,
F_52 ( F_25 ( V_94 -> V_98 . V_99 [ V_3 ] ) ) ) ;
F_24 ( V_100 , L_7 ,
V_92 - 1 , F_25 ( V_94 -> V_98 . V_99 [ V_92 - 1 ] ) ) ;
F_23 ( ( void * ) ( V_13 -> V_97 ) ) ;
F_48 ( V_13 ,
F_25 ( V_94 -> V_98 . V_99 [ V_92 - 1 ] ) ) ;
V_90 = F_52 ( V_13 -> V_91 ) ;
V_95 = V_90 >> V_101 ;
V_96 = F_52 ( V_13 -> V_102 ) >> V_101 ;
if ( V_95 + 1 != V_96 )
V_95 ++ ;
for ( V_3 = V_96 ; V_3 != V_95 ; V_3 = F_53 ( V_3 ) ) {
if ( F_35 ( V_13 -> V_97 [ V_3 ] ) )
break;
V_13 -> V_97 [ V_3 ] = V_103 ;
V_44 += V_104 ;
}
...
F_24 ( V_100 ,
L_8 ,
V_13 -> V_91 , V_13 -> V_102 ) ;
}
static T_4 F_55 ( const struct V_1 * V_2 ,
const struct V_105 * V_94 ,
enum V_106 * V_107 )
{
if ( ( V_2 -> V_4 -> V_108 & V_109 ) &&
( V_94 -> V_110 & V_111 ) ) {
enum V_112 V_113 ;
V_113 = V_94 -> V_110 & V_114 ;
* V_107 = ( ( V_113 == V_115 ) ||
( V_113 == V_116 ) ) ?
V_117 : V_118 ;
return F_56 ( V_94 -> V_119 ) ;
}
* V_107 = V_120 ;
return 0 ;
}
static void F_57 ( struct V_11 * V_13 , T_3 V_121 ,
T_3 V_122 , T_3 V_123 ,
struct V_105 * V_94 )
{
struct V_1 * V_2 = V_13 -> V_2 ;
struct V_124 * V_125 = & V_13 -> V_126 [ V_122 ] ;
struct V_124 * V_127 = & V_13 -> V_126 [ V_123 ] ;
struct V_128 * V_129 = & V_13 -> V_130 [ V_123 ] ;
T_5 V_131 ;
struct V_27 * V_29 = & V_13 -> V_29 [ V_121 ] ;
struct V_124 * V_132 = & V_29 -> V_132 ;
if ( V_29 -> V_133 != V_134 )
F_27 ( L_9 , V_121 ) ;
V_131 = F_58 ( & V_2 -> V_74 -> V_4 ,
V_132 -> V_135 + V_136 ,
V_13 -> V_137 , V_138 ) ;
if ( F_38 ( F_59 ( & V_2 -> V_74 -> V_4 , V_131 ) ) ) {
F_60 ( V_13 , V_122 , V_123 ) ;
V_29 -> V_133 = V_139 ;
return;
}
V_127 -> V_135 = V_132 -> V_135 ;
F_61 ( V_127 , V_131 , V_131 ) ;
V_129 -> V_140 = F_62 ( F_63 ( V_131 ) ) ;
V_129 -> V_141 = F_62 ( F_64 ( V_131 ) ) ;
* V_132 = * V_125 ;
V_29 -> V_142 =
F_25 ( V_94 -> V_143 . V_71 ) ;
V_29 -> V_144 = F_25 ( V_94 -> V_144 ) ;
V_29 -> V_133 = V_145 ;
V_29 -> V_146 = F_25 ( V_94 -> V_146 ) ;
V_29 -> V_147 = V_94 -> V_147 ;
V_29 -> V_148 = F_55 ( V_2 , V_94 , & V_29 -> V_107 ) ;
if ( V_13 -> V_149 == V_150 ) {
T_3 V_151 = F_25 ( V_94 -> V_152 ) ;
V_29 -> V_153 = V_154 / V_151 * V_151 ;
V_29 -> V_151 = V_151 ;
}
#ifdef F_26
V_13 -> V_155 |= ( 1 << V_121 ) ;
...
DP(NETIF_MSG_LINK, L_85, bp->port.pmf);
}
...
DP(NETIF_MSG_IFUP, L_95);
DP(NETIF_MSG_IFUP,
L_96, CNIC_ENABLED(bp) ? L_97 : L_98);
#ifdef F_26
if (unlikely(bp->panic)) {
BNX2X_ERR(L_99);
return -EPERM;
...
DP(NETIF_MSG_IFUP, L_100, bp->num_queues);
for_each_queue(bp, i)
bnx2x_bz_fp(bp, i);
...
break;
default:
dev_err(&bp->pdev->dev, L_119, state);
return -EINVAL;
}
return 0;
}
...
DP(NETIF_MSG_TX_QUEUED,
L_123,
(xmit_type & XMIT_GSO) ? L_124 : L_125,
...
DP(NETIF_MSG_TX_QUEUED, L_137, tx_data_bd);
first_bd->nbd = cpu_to_le16(nbd);
bd_prod = TX_BD(NEXT_TX_IDX(bd_prod));
...
pbd_e2->data.mac_addr.src_lo,
pbd_e2->parsing_data);
DP(NETIF_MSG_TX_QUEUED, L_140, nbd, bd_prod);
...
DP(BNX2X_MSG_SP, L_149, rx_ring_size);
...
if (IS_PF(bp))
msix_table_size++;
BNX2X_DEV_INFO(L_153, msix_table_size);
fp_array_size = BNX2X_MAX_RSS_COUNT(bp) + CNIC_SUPPORT(bp);
bp->fp_array_size = fp_array_size;
BNX2X_DEV_INFO(L_154, bp->fp_array_size);
...
BNX2X_DEV_INFO(L_155, txq_array_size);
