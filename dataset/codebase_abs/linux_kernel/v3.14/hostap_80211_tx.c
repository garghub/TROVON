...
F_9 ( V_3 , & V_5 . V_21 , V_54 ) ;
} else if ( V_27 -> V_45 == V_46 && ! V_39 ) {
V_6 |= V_15 ;
F_9 ( V_3 , & V_5 . V_19 , V_54 ) ;
memcpy ( & V_5 . V_20 , V_24 -> V_55 , V_54 ) ;
...
if ( F_14 ( V_3 , V_28 , V_29 ,
V_72 ) ) {
F_6 ( V_3 ) ;
V_26 -> V_73 . V_74 ++ ;
return V_43 ;
}
} else if ( F_15 ( V_3 ) < V_28 ) {
struct V_2 * V_75 = V_3 ;
V_3 = F_16 ( V_3 , V_28 ) ;
F_6 ( V_75 ) ;
if ( V_3 == NULL ) {
...
if ( V_35 )
memcpy ( F_17 ( V_3 , V_37 ) , V_35 , V_37 ) ;
memcpy ( F_17 ( V_3 , V_36 ) , & V_5 , V_36 ) ;
if ( V_34 == V_32 ) {
memcpy ( F_18 ( V_3 , V_54 ) , & V_5 . V_22 , V_54 ) ;
}
V_26 -> V_73 . V_76 ++ ;
...
static struct V_2 * F_23 ( struct V_2 * V_3 ,
struct V_84 * V_85 )
{
struct V_25 * V_26 ;
T_3 * V_27 ;
