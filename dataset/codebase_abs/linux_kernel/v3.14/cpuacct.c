...
static int F_24 ( struct V_30 * V_31 , void * V_32 )
{
struct V_1 * V_7 = F_1 ( F_25 ( V_31 ) ) ;
V_13 V_33 ;
int V_26 ;
F_22 (i) {
V_33 = F_14 ( V_7 , V_26 ) ;
F_26 ( V_31 , L_1 , ( unsigned long long ) V_33 ) ;
}
F_26 ( V_31 , L_2 ) ;
return 0 ;
}
static int F_27 ( struct V_30 * V_34 , void * V_35 )
{
struct V_1 * V_7 = F_1 ( F_25 ( V_34 ) ) ;
int V_19 ;
T_1 V_22 = 0 ;
F_28 (cpu) {
struct V_16 * V_36 = F_15 ( V_7 -> V_15 , V_19 ) ;
V_22 += V_36 -> V_15 [ V_37 ] ;
V_22 += V_36 -> V_15 [ V_38 ] ;
}
V_22 = F_29 ( V_22 ) ;
F_26 ( V_34 , L_3 , V_39 [ V_40 ] , V_22 ) ;
V_22 = 0 ;
F_28 (cpu) {
struct V_16 * V_36 = F_15 ( V_7 -> V_15 , V_19 ) ;
V_22 += V_36 -> V_15 [ V_41 ] ;
...
V_22 = F_29 ( V_22 ) ;
F_26 ( V_34 , L_3 , V_39 [ V_44 ] , V_22 ) ;
return 0 ;
}
void F_30 ( struct V_4 * V_5 , V_13 V_45 )
{
struct V_1 * V_7 ;
int V_19 ;
V_19 = F_31 ( V_5 ) ;
...
void F_34 ( struct V_4 * V_46 , int V_47 , V_13 V_22 )
{
struct V_16 * V_36 ;
struct V_1 * V_7 ;
F_32 () ;
