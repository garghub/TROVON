...
F_4 ( V_10 L_8 ,
V_5 [ 0 ] , V_5 [ 1 ] , V_5 [ 2 ] ) ;
V_43 = F_19 ( V_31 , V_5 , 3 ) ;
if ( V_43 != 3 )
F_20 ( V_10 L_9 , V_43 ) ;
}
static long F_21 ( struct V_2 * V_3 , unsigned int V_59 , void * V_60 )
{
...
if ( V_4 -> V_21 )
V_15 -> V_19 |= V_64 | V_65 ;
F_22 ( V_15 -> V_66 , & V_4 -> V_23 , V_15 -> V_67 ) ;
break;
default:
return - V_68 ;
}
...
static int F_24 ( struct V_2 * V_3 , const struct V_69 * V_70 )
{
struct V_1 * V_4 = F_1 ( V_3 ) ;
F_18 ( V_4 ) ;
return 0 ;
...
V_4 = F_27 ( & V_31 -> V_81 , sizeof( * V_4 ) , V_82 ) ;
if ( V_4 == NULL )
return - V_83 ;
V_4 -> V_12 = V_84 * 3 ;
V_4 -> V_11 = F_27 ( & V_31 -> V_81 , V_4 -> V_12 , V_82 ) ;
if ( V_4 -> V_11 == NULL )
return - V_83 ;
V_3 = & V_4 -> V_3 ;
F_28 ( V_3 , V_31 , & V_85 ) ;
