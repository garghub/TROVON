...
do {
V_82 = V_166 -> V_82 ;
V_201 = ! V_200 && F_122 ( V_202 , & V_82 -> V_203 ) ;
} while ( F_123 ( V_166 , V_201 ? 0 : - V_204 , V_82 -> V_167 . V_95 ) );
if ( ! V_200 )
F_124 ( V_169 ) ;
}
static void
F_125 ( struct V_9 * V_10 , struct V_58 * V_58 )
{
struct V_162 * V_166 ;
unsigned long V_18 ;
...
static void
F_127 ( struct V_8 * V_16 )
{
struct V_25 * V_205 , * V_206 ;
...
if ( ! V_3 )
goto V_209;
V_206 = (struct V_25 * ) F_42 ( V_16 -> V_3 ) ;
V_208 = (struct V_42 * ) ( V_206 + 1 ) ;
V_205 = (struct V_25 * ) V_3 -> V_210 ;
F_128 ( V_3 , sizeof( * V_205 ) ) ;
V_207 = (struct V_42 * ) V_3 -> V_210 ;
F_128 ( V_3 , sizeof( * V_207 ) ) ;
if ( V_207 -> V_104 & 0xa9 ) {
F_71 ( L_11 ,
V_208 -> V_104 , V_207 -> V_104 ,
V_10 -> V_37 , V_10 -> V_39 ) ;
V_209: if ( V_58 )
F_129 ( V_202 , & V_58 -> V_82 -> V_203 ) ;
goto V_152;
}
V_18 = V_208 -> V_94 << 9 ;
switch ( V_208 -> V_104 ) {
...
break;
F_107 ( & V_10 -> V_149 ) ;
F_110 ( V_10 , V_24 , V_3 -> V_210 ) ;
F_108 ( & V_10 -> V_149 ) ;
break;
default:
F_61 ( L_18 ,
V_208 -> V_104 ,
F_132 ( F_133 ( & V_205 -> V_36 ) ) ,
V_205 -> V_38 ) ;
}
V_152:
F_107 ( & V_10 -> V_149 ) ;
...
if ( V_143 == V_216 )
return 1 ;
if ( F_31 ( & V_217 [ V_186 ] . V_13 ) )
return 0 ;
V_14 = V_217 [ V_186 ] . V_13 . V_64 ;
F_11 ( V_14 ) ;
V_16 = F_10 ( V_14 , struct V_8 , V_13 ) ;
F_108 ( & V_217 [ V_186 ] . V_149 ) ;
F_127 ( V_16 ) ;
V_215 = V_16 -> V_24 -> V_10 -> V_39 % V_218 ;
if ( ! V_219 [ V_215 ] . V_220 ) {
F_137 ( V_186 != 0 ) ;
F_103 ( & V_221 ) ;
if ( ! V_219 [ V_215 ] . V_220
&& F_138 ( & V_219 [ V_215 ] ) == 0 )
...
do {
F_107 ( V_223 -> V_149 ) ;
V_226 = V_223 -> V_229 ( V_223 -> V_186 ) ;
if ( ! V_226 ) {
F_143 ( V_223 -> V_230 , & V_224 ) ;
F_144 ( V_231 ) ;
}
F_108 ( V_223 -> V_149 ) ;
if ( ! V_226 ) {
F_145 () ;
F_146 ( V_223 -> V_230 , & V_224 ) ;
} else
F_147 () ;
} while ( ! F_148 () );
F_142 ( & V_223 -> V_228 ) ;
...
void
F_149 ( struct V_222 * V_223 )
{
F_150 ( V_223 -> V_232 ) ;
F_151 ( & V_223 -> V_228 ) ;
}
int
F_138 ( struct V_222 * V_223 )
{
struct V_233 * V_232 ;
F_152 ( & V_223 -> V_228 ) ;
V_232 = F_153 ( F_139 , V_223 , L_19 , V_223 -> V_234 ) ;
if ( V_232 == NULL || F_154 ( V_232 ) )
return - V_235 ;
V_223 -> V_232 = V_232 ;
F_151 ( & V_223 -> V_228 ) ;
F_152 ( & V_223 -> V_228 ) ;
...
T_1 V_61 ;
V_16 -> V_60 = V_3 ;
V_186 = V_16 -> V_24 -> V_10 -> V_39 % V_218 ;
F_79 ( & V_217 [ V_186 ] . V_149 , V_61 ) ;
if ( ! V_219 [ V_186 ] . V_220 ) {
F_80 ( & V_217 [ V_186 ] . V_149 , V_61 ) ;
V_186 = 0 ;
F_79 ( & V_217 [ V_186 ] . V_149 , V_61 ) ;
}
F_40 ( & V_16 -> V_13 , & V_217 [ V_186 ] . V_13 ) ;
F_80 ( & V_217 [ V_186 ] . V_149 , V_61 ) ;
F_155 ( & V_236 [ V_186 ] ) ;
}
struct V_1 *
...
char V_237 [ 128 ] ;
T_7 V_37 ;
V_26 = (struct V_25 * ) V_3 -> V_210 ;
V_37 = F_132 ( F_133 ( & V_26 -> V_36 ) ) ;
V_10 = F_157 ( V_37 , V_26 -> V_38 , 0 ) ;
if ( V_10 == NULL ) {
snprintf ( V_237 , sizeof V_237 , L_20
L_21 ,
V_37 , V_26 -> V_38 ) ;
F_63 ( V_237 ) ;
return V_3 ;
...
V_241 = V_10 -> V_76 ;
V_242 = V_241 * 2 ;
V_69 = F_32 ( V_242 , sizeof( * V_10 -> V_73 ) , V_5 ) ;
if ( ! V_69 )
return NULL ;
memmove ( V_69 , V_10 -> V_73 , sizeof( * V_10 -> V_73 ) * V_241 ) ;
V_10 -> V_75 = V_69 + ( V_10 -> V_75 - V_10 -> V_73 ) ;
F_164 ( V_10 -> V_73 ) ;
V_10 -> V_73 = V_69 ;
V_10 -> V_76 = V_242 ;
return & V_10 -> V_73 [ V_241 ] ;
}
static struct V_23 *
F_165 ( struct V_9 * V_10 , char * V_33 , T_1 V_156 )
{
struct V_23 * V_24 , * * V_69 , * * V_243 ;
V_69 = V_10 -> V_73 ;
V_243 = V_69 + V_10 -> V_76 ;
for (; V_69 < V_243 && * V_69 ; V_69 ++ )
;
if ( V_69 == V_243 ) {
V_69 = F_163 ( V_10 ) ;
if ( ! V_69 )
...
V_127 = V_24 + V_10 -> V_76 ;
for (; V_24 < V_127 && * V_24 ; V_24 ++ )
if ( V_245 == 0 || V_245 > ( * V_24 ) -> V_246 )
V_245 = ( * V_24 ) -> V_246 ;
if ( V_245 != V_10 -> V_130 ) {
V_10 -> V_130 = V_245 ;
F_61 ( L_25 ,
V_10 -> V_37 , V_10 -> V_39 , V_245 ) ;
}
}
static void
F_170 ( struct V_23 * V_24 , struct V_115 * V_30 , int V_245 )
{
struct V_9 * V_10 ;
struct V_51 * V_126 , * V_127 ;
int V_246 ;
...
{
struct V_23 * * V_24 , * * V_243 ;
V_10 -> V_134 = V_238 ;
V_10 -> V_136 = V_239 ;
V_10 -> V_130 = 0 ;
V_24 = V_10 -> V_73 ;
V_243 = V_24 + V_10 -> V_76 ;
for (; V_24 < V_243 && * V_24 ; V_24 ++ )
F_167 ( * V_24 ) ;
}
void
...
{
int V_143 ;
for ( V_143 = 0 ; V_143 < V_218 ; V_143 ++ ) {
if ( V_219 [ V_143 ] . V_220 )
F_175 ( V_143 ) ;
}
}
void
...
int V_143 ;
int V_253 ;
V_126 = ( void * ) F_178 ( V_254 | V_255 ) ;
if ( ! V_126 )
return - V_235 ;
V_133 = F_179 ( V_126 ) ;
V_218 = F_180 () ;
V_217 = F_32 ( V_218 , sizeof( struct V_256 ) , V_254 ) ;
if ( ! V_217 )
return - V_235 ;
V_219 = F_32 ( V_218 , sizeof( struct V_222 ) , V_254 ) ;
if ( ! V_219 ) {
V_253 = - V_235 ;
goto V_257;
}
V_236 = F_32 ( V_218 , sizeof( V_258 ) , V_254 ) ;
if ( ! V_236 ) {
V_253 = - V_235 ;
goto V_259;
}
F_181 ( & V_221 ) ;
for ( V_143 = 0 ; V_143 < V_218 ; V_143 ++ ) {
F_168 ( & V_217 [ V_143 ] . V_13 ) ;
F_182 ( & V_217 [ V_143 ] . V_149 ) ;
F_183 ( & V_236 [ V_143 ] ) ;
snprintf ( V_219 [ V_143 ] . V_234 , sizeof( V_219 [ V_143 ] . V_234 ) , L_32 , V_143 ) ;
V_219 [ V_143 ] . V_229 = F_136 ;
V_219 [ V_143 ] . V_230 = & V_236 [ V_143 ] ;
V_219 [ V_143 ] . V_149 = & V_217 [ V_143 ] . V_149 ;
V_219 [ V_143 ] . V_186 = V_143 ;
V_219 [ V_143 ] . V_220 = 0 ;
}
V_219 [ 0 ] . V_220 = 1 ;
if ( F_138 ( & V_219 [ 0 ] ) ) {
