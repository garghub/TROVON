...
V_11 = F_20 ( V_3 , & V_8 ) ;
if ( F_31 ( V_11 ) )
return ( int ) F_34 ( V_11 ) ;
}
error = F_35 ( V_6 , V_1 , V_41 , V_11 , V_8 , 0 ) ;
if ( error == - V_47 ) {
error = 0 ;
if ( type == V_43 ) {
V_1 -> V_51 = V_52 ;
...
int
F_37 ( struct V_5 * V_6 ,
struct V_1 * V_53 , struct V_54 * V_54 ,
struct V_1 * V_1 )
{
struct V_2 * V_55 , * V_3 ;
int V_56 = 0 ;
...
V_56 = F_41 ( V_53 , & V_1 -> V_49 , & V_55 , & V_3 ) ;
if ( V_56 )
return V_56 ;
if ( V_55 ) {
V_56 = F_8 ( V_6 , V_1 , V_45 ,
V_55 ) ;
F_19 ( V_55 ) ;
}
if ( V_3 ) {
if ( ! V_56 )
V_56 = F_8 ( V_6 , V_1 , V_43 ,
V_3 ) ;
F_19 ( V_3 ) ;
}
return V_56 ;
