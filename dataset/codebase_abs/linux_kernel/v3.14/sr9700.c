...
F_51 ( V_107 , V_87 ) ;
if ( ( V_107 -> V_38 % V_2 -> V_114 ) == 0 )
V_38 ++ ;
V_107 -> V_5 [ 0 ] = V_38 ;
V_107 -> V_5 [ 1 ] = V_38 >> 8 ;
return V_107 ;
}
static void F_52 ( struct V_1 * V_2 , struct V_115 * V_115 )
{
int V_116 ;
T_1 * V_37 ;
if ( V_115 -> V_117 < 8 )
...
V_37 = V_115 -> V_118 ;
V_116 = ! ! ( V_37 [ 0 ] & 0x40 ) ;
if ( F_53 ( V_2 -> V_20 ) != V_116 ) {
F_54 ( V_2 , V_116 , 1 ) ;
F_15 ( V_2 -> V_20 , L_11 , V_116 ) ;
}
}
