...
V_26 -> V_10 . V_27 . V_12 . args . V_29 = F_7 ( V_25 -> V_29 ) ;
...
V_40 -> V_46 =
F_9 ( V_6 -> V_10 . V_41 . V_8 . V_45 . V_46 ) ;
V_40 -> V_47 = F_9 ( V_6 -> V_10 . V_41 . V_8 . V_45 . V_47 ) ;
V_40 -> V_48 = F_9 ( V_6 -> V_10 . V_41 . V_8 . V_45 . V_48 ) ;
V_19:
return error ;
}
int F_10 ( struct V_1 * V_2 , struct V_49 * V_50 )
{
int error = V_3 ;
struct V_4 * V_5 , * V_6 ;
V_5 = V_2 -> V_7 ;
...
V_50 -> V_59 = F_9 ( V_6 -> V_10 . V_51 . V_8 . V_54 . V_59 ) ;
V_19:
return error ;
}
...
goto V_19;
V_61 -> V_65 =
F_12 ( V_6 -> V_10 . V_62 . V_8 . V_66 . V_65 ) ;
V_61 -> V_67 =
F_12 ( V_6 -> V_10 . V_62 . V_8 . V_66 . V_67 ) ;
V_61 -> V_68 =
F_12 ( V_6 -> V_10 . V_62 . V_8 . V_66 . V_68 ) ;
V_61 -> V_69 =
F_9 ( V_6 -> V_10 . V_62 . V_8 . V_66 . V_69 ) ;
V_61 -> V_70 =
...
T_1 V_75 , T_1 V_76 )
{
V_5 -> V_77 . V_78 = F_3 ( V_75 ) ;
V_5 -> V_77 . V_79 = F_3 ( V_80 ) ;
V_5 -> V_77 . V_81 = F_3 ( V_82 ) ;
V_5 -> V_77 . V_83 = F_3 ( V_76 ) ;
}
...
if ( ( error == 0 ) &&
( F_9 ( V_6 -> V_10 . V_84 . V_8 . V_13 ) == V_13 ) ) {
return 0 ;
}
return V_3 ;
}
