...
static bool F_104 ( struct V_18 * V_19 , T_4 V_142 , T_4 V_143 ,
struct V_144 * V_145 )
{
...
V_146 [ V_151 ] = & V_147 ;
F_24 ( V_151 + 1 > F_106 ( V_146 ) ) ;
F_24 ( F_107 ( V_19 -> V_154 , V_146 , V_151 , 1 , V_19 , V_58 ) < 0 ) ;
...
static int F_110 ( struct V_44 * V_22 , void * V_17 )
{
struct V_18 * V_19 = F_80 ( V_22 ) ;
...
unsigned int V_172 ;
F_115 (cpu) {
struct V_63 * V_46 = F_116 ( V_19 -> V_46 , V_171 ) ;
T_6 V_173 , V_174 , V_175 , V_176 ;
do {
V_172 = F_117 ( & V_46 -> V_127 ) ;
V_173 = V_46 -> V_129 ;
V_174 = V_46 -> V_128 ;
} while ( F_118 ( & V_46 -> V_127 , V_172 ) );
do {
V_172 = F_117 ( & V_46 -> V_67 ) ;
V_175 = V_46 -> V_69 ;
V_176 = V_46 -> V_68 ;
} while ( F_118 ( & V_46 -> V_67 , V_172 ) );
V_170 -> V_69 += V_175 ;
V_170 -> V_129 += V_173 ;
V_170 -> V_68 += V_176 ;
V_170 -> V_128 += V_174 ;
...
static void F_119 ( struct V_44 * V_22 )
{
struct V_18 * V_19 = F_80 ( V_22 ) ;
int V_100 ;
for ( V_100 = 0 ; V_100 < V_19 -> V_116 ; V_100 ++ )
F_120 ( & V_19 -> V_11 [ V_100 ] . V_111 ) ;
}
...
static int F_124 ( struct V_18 * V_19 , T_7 V_179 )
{
struct V_144 V_97 ;
struct V_180 V_181 ;
struct V_44 * V_22 = V_19 -> V_22 ;
if ( ! V_19 -> V_182 || ! F_105 ( V_19 -> V_20 , V_183 ) )
return 0 ;
V_181 . V_184 = V_179 ;
...
static int F_125 ( struct V_44 * V_22 )
{
struct V_18 * V_19 = F_80 ( V_22 ) ;
int V_100 ;
F_126 ( & V_19 -> V_114 ) ;
...
static int F_136 ( struct V_44 * V_22 ,
T_8 V_206 , T_7 V_207 )
{
struct V_18 * V_19 = F_80 ( V_22 ) ;
struct V_144 V_97 ;
...
static void F_137 ( struct V_18 * V_19 , long V_211 )
{
int V_100 ;
if ( V_19 -> V_212 ) {
for ( V_100 = 0 ; V_100 < V_19 -> V_124 ; V_100 ++ ) {
F_138 ( V_19 -> V_11 [ V_100 ] . V_2 , - 1 ) ;
F_138 ( V_19 -> V_126 [ V_100 ] . V_2 , - 1 ) ;
}
V_19 -> V_212 = false ;
}
}
...
V_100 = 0 ;
F_141 (cpu) {
F_138 ( V_19 -> V_11 [ V_100 ] . V_2 , V_171 ) ;
F_138 ( V_19 -> V_126 [ V_100 ] . V_2 , V_171 ) ;
F_142 ( V_19 -> V_22 , F_143 ( V_171 ) , V_100 ) ;
V_100 ++ ;
}
V_19 -> V_212 = true ;
}
static int F_144 ( struct V_213 * V_214 ,
...
static void F_146 ( struct V_44 * V_22 ,
struct V_229 * V_230 )
{
struct V_18 * V_19 = F_80 ( V_22 ) ;
struct V_156 * V_20 = V_19 -> V_20 ;
F_147 ( V_230 -> V_231 , V_232 , sizeof( V_230 -> V_231 ) ) ;
F_147 ( V_230 -> V_233 , V_234 , sizeof( V_230 -> V_233 ) ) ;
F_147 ( V_230 -> V_235 , F_148 ( V_20 ) , sizeof( V_230 -> V_235 ) ) ;
}
static int F_149 ( struct V_44 * V_22 ,
struct V_236 * V_237 )
{
struct V_18 * V_19 = F_80 ( V_22 ) ;
...
static void F_154 ( struct V_44 * V_22 ,
struct V_236 * V_237 )
{
struct V_18 * V_19 = F_80 ( V_22 ) ;
...
static int F_155 ( struct V_44 * V_22 , int V_244 )
{
...
static void F_156 ( struct V_112 * V_113 )
{
struct V_18 * V_19 =
...
static void F_165 ( struct V_156 * V_20 )
{
...
F_170 ( F_6 ( & V_19 -> V_11 [ V_100 ] , V_117 ) , 0 ) ;
}
}
...
const char * * V_261 ;
V_260 = V_19 -> V_124 * 2 +
F_105 ( V_19 -> V_20 , V_153 ) ;
V_259 = F_130 ( V_260 * sizeof( * V_259 ) , V_117 ) ;
if ( ! V_259 )
goto V_262;
V_258 = F_176 ( V_260 * sizeof( * V_258 ) , V_117 ) ;
if ( ! V_258 )
goto V_263;
V_261 = F_176 ( V_260 * sizeof( * V_261 ) , V_117 ) ;
if ( ! V_261 )
goto V_264;
if ( V_19 -> V_182 ) {
V_258 [ V_260 - 1 ] = NULL ;
...
{
int V_100 ;
V_19 -> V_126 = F_130 ( sizeof( * V_19 -> V_126 ) * V_19 -> V_124 , V_117 ) ;
if ( ! V_19 -> V_126 )
goto V_270;
V_19 -> V_11 = F_130 ( sizeof( * V_19 -> V_11 ) * V_19 -> V_124 , V_117 ) ;
if ( ! V_19 -> V_11 )
goto V_271;
F_178 ( & V_19 -> V_114 , F_70 ) ;
for ( V_100 = 0 ; V_100 < V_19 -> V_124 ; V_100 ++ ) {
V_19 -> V_11 [ V_100 ] . V_15 = NULL ;
F_179 ( V_19 -> V_22 , & V_19 -> V_11 [ V_100 ] . V_111 , F_74 ,
V_272 ) ;
F_131 ( V_19 -> V_11 [ V_100 ] . V_97 , F_106 ( V_19 -> V_11 [ V_100 ] . V_97 ) ) ;
F_180 ( & V_19 -> V_11 [ V_100 ] . V_62 , 1 , V_273 ) ;
F_131 ( V_19 -> V_126 [ V_100 ] . V_97 , F_106 ( V_19 -> V_126 [ V_100 ] . V_97 ) ) ;
}
return 0 ;
V_271:
F_134 ( V_19 -> V_126 ) ;
...
! F_105 ( V_20 , V_153 ) )
V_124 = 1 ;
V_22 = F_185 ( sizeof( struct V_18 ) , V_124 ) ;
if ( ! V_22 )
return - V_96 ;
...
V_22 -> V_268 = V_289 ;
F_186 ( V_22 , & V_290 ) ;
F_187 ( V_22 , & V_20 -> V_22 ) ;
if ( F_105 ( V_20 , V_291 ) ) {
V_22 -> V_292 |= V_293 | V_294 | V_295 ;
if ( V_296 )
V_22 -> V_268 |= V_293 | V_294 | V_295 ;
if ( F_105 ( V_20 , V_297 ) ) {
V_22 -> V_292 |= V_298 | V_299
| V_300 | V_301 ;
}
if ( F_105 ( V_20 , V_302 ) )
V_22 -> V_292 |= V_298 ;
...
V_22 -> V_292 |= V_299 ;
if ( V_306 )
V_22 -> V_268 |= V_22 -> V_292 & ( V_307 | V_299 ) ;
}
if ( F_105 ( V_20 , V_308 ) )
V_22 -> V_268 |= V_309 ;
V_22 -> V_310 = V_22 -> V_268 ;
if ( F_105 ( V_20 , V_166 ) )
F_188 ( V_20 ,
F_113 ( struct V_167 , V_168 ) ,
V_22 -> V_311 , V_22 -> V_162 ) ;
else
F_189 ( V_22 ) ;
V_19 = F_80 ( V_22 ) ;
V_19 -> V_22 = V_22 ;
V_19 -> V_20 = V_20 ;
V_20 -> V_21 = V_19 ;
V_19 -> V_46 = F_190 ( struct V_63 ) ;
V_45 = - V_96 ;
if ( V_19 -> V_46 == NULL )
goto free;
F_115 (i) {
struct V_63 * V_63 ;
V_63 = F_116 ( V_19 -> V_46 , V_100 ) ;
F_191 ( & V_63 -> V_127 ) ;
F_191 ( & V_63 -> V_67 ) ;
}
F_192 ( & V_19 -> V_250 ) ;
V_19 -> V_251 = true ;
F_193 ( & V_19 -> V_248 , F_156 ) ;
if ( F_105 ( V_20 , V_312 ) ||
F_105 ( V_20 , V_313 ) ||
F_105 ( V_20 , V_314 ) ||
F_105 ( V_20 , V_315 ) )
...
V_19 -> V_216 . V_323 = & F_144 ;
V_45 = F_196 ( & V_19 -> V_216 ) ;
if ( V_45 ) {
F_34 ( L_28 ) ;
goto V_322;
}
if ( F_105 ( V_19 -> V_20 , V_253 ) ) {
F_162 ( V_22 ) ;
F_166 ( & V_19 -> V_248 ) ;
} else {
V_19 -> V_150 = V_255 ;
...
{
V_19 -> V_20 -> V_256 -> V_324 ( V_19 -> V_20 ) ;
F_172 ( V_19 ) ;
F_169 ( V_19 ) ;
F_171 ( V_19 ) ;
F_174 ( V_19 ) ;
}
static void F_201 ( struct V_156 * V_20 )
{
struct V_18 * V_19 = V_20 -> V_21 ;
F_202 ( & V_19 -> V_216 ) ;
F_157 ( & V_19 -> V_250 ) ;
...
static int F_204 ( struct V_156 * V_20 )
{
struct V_18 * V_19 = V_20 -> V_21 ;
int V_100 ;
F_202 ( & V_19 -> V_216 ) ;
...
static int F_207 ( struct V_156 * V_20 )
{
struct V_18 * V_19 = V_20 -> V_21 ;
int V_45 , V_100 ;
V_45 = F_181 ( V_19 ) ;
