...
if ( F_67 ( V_9 , & V_4 ) < 0 )
F_71 ( L_1 ,
( unsigned long long ) V_9 -> V_11 . V_82 . V_84 ) ;
return V_4 & 0x1 ;
}
...
case V_109 :
if ( V_107 == 0 )
V_70 = F_82 ( V_108 , V_100 ) ;
else
V_70 = F_83 ( V_108 , V_100 ) ;
break;
case V_110 :
V_70 = ( V_108 == V_105 ) ;
break;
...
struct V_76 * V_77 , int * V_114 , unsigned long * V_78 )
{
struct V_20 * V_115 ;
unsigned long V_7 = 1 ;
struct V_1 * * V_116 ;
...
* V_114 = - 1 ;
if ( V_77 -> V_118 == V_110 ) {
* V_114 = F_63 ( V_113 -> V_9 , V_77 , V_78 ) ;
return true ;
}
if ( V_77 -> V_118 )
return false ;
F_87 () ;
V_115 = F_88 ( V_19 -> V_11 . V_40 ) ;
if ( ! V_115 )
goto V_26;
if ( V_77 -> V_107 == 0 ) {
if ( V_77 -> V_79 == V_119 ||
V_77 -> V_120 == 0xff )
goto V_26;
V_116 = & V_115 -> V_37 [ V_77 -> V_120 & 0xff ] ;
} else {
T_1 V_101 = V_77 -> V_120 << ( 32 - V_115 -> V_27 ) ;
V_116 = V_115 -> V_39 [ F_29 ( V_115 , V_101 ) ] ;
...
if ( * V_114 < 0 )
* V_114 = 0 ;
* V_114 += F_63 ( V_116 [ V_23 ] -> V_9 , V_77 , V_78 ) ;
}
V_117 = true ;
V_26:
F_91 () ;
...
struct V_76 V_77 ;
V_77 . V_10 = V_143 & V_45 ;
V_77 . V_79 = V_143 & V_53 ;
V_77 . V_107 = V_143 & V_147 ;
V_77 . V_80 = V_143 & V_148 ;
V_77 . V_81 = V_143 & V_149 ;
V_77 . V_118 = V_143 & V_150 ;
if ( F_28 ( V_2 ) )
V_77 . V_120 = V_145 ;
else
V_77 . V_120 = F_105 ( V_145 ) ;
F_106 ( V_143 , V_77 . V_120 ) ;
F_71 ( L_13
L_14
L_15 ,
V_145 , V_143 , V_77 . V_118 , V_77 . V_120 ,
V_77 . V_81 , V_77 . V_80 , V_77 . V_107 , V_77 . V_79 ,
V_77 . V_10 ) ;
...
V_2 -> V_47 . V_155 == 0 )
return 0 ;
V_151 = F_109 ( & V_2 -> V_47 . V_156 ) ;
if ( F_110 ( V_151 ) < 0 )
V_151 = F_111 ( 0 , 0 ) ;
V_152 = F_112 ( F_110 ( V_151 ) , V_2 -> V_47 . V_155 ) ;
V_153 = F_113 ( V_152 ,
( V_157 * V_2 -> V_158 ) ) ;
return V_153 ;
}
...
V_70 = F_117 ( V_2 , V_167 & ~ 0xf ) ;
F_121 ( V_167 , V_70 ) ;
switch ( V_173 ) {
case 1 :
case 2 :
case 4 :
memcpy ( V_83 , ( char * ) & V_70 + V_174 , V_173 ) ;
break;
default:
F_97 ( V_136 L_19
L_20 , V_173 ) ;
...
T_7 V_179 , int V_173 , void * V_83 )
{
struct V_1 * V_2 = F_118 ( V_178 ) ;
T_1 V_167 = V_179 - V_2 -> V_177 ;
if ( ! F_122 ( V_2 , V_179 ) )
return - V_180 ;
F_120 ( V_2 , V_167 , V_173 , V_83 ) ;
return 0 ;
}
...
{
T_4 V_185 ;
F_126 ( & V_2 -> V_47 . V_186 , 0 ) ;
if ( F_43 ( V_2 ) || F_42 ( V_2 ) ) {
V_185 = V_2 -> V_47 . V_156 . V_187 -> V_188 () ;
V_2 -> V_47 . V_155 = ( T_6 ) F_16 ( V_2 , V_154 )
* V_157 * V_2 -> V_158 ;
if ( ! V_2 -> V_47 . V_155 )
return;
if ( F_43 ( V_2 ) ) {
T_5 V_189 = V_190 * 1000LL ;
if ( V_2 -> V_47 . V_155 < V_189 ) {
F_127 (
L_22
L_23 ,
V_2 -> V_9 -> V_104 ,
V_2 -> V_47 . V_155 , V_189 ) ;
V_2 -> V_47 . V_155 = V_189 ;
}
}
F_128 ( & V_2 -> V_47 . V_156 ,
F_129 ( V_185 , V_2 -> V_47 . V_155 ) ,
V_191 ) ;
...
T_6 V_195 , V_196 = V_2 -> V_47 . V_196 ;
T_6 V_152 = 0 ;
struct V_8 * V_9 = V_2 -> V_9 ;
...
V_2 -> V_47 . V_48 ) !=
( V_4 & V_2 -> V_47 . V_48 ) )
F_137 ( & V_2 -> V_47 . V_156 ) ;
if ( ! F_20 ( V_2 ) )
V_4 |= V_44 ;
V_4 &= ( V_213 [ 0 ] | V_2 -> V_47 . V_48 ) ;
F_1 ( V_2 , V_46 , V_4 ) ;
break;
case V_154 :
if ( F_44 ( V_2 ) )
...
T_7 V_179 , int V_173 , const void * V_83 )
{
struct V_1 * V_2 = F_118 ( V_178 ) ;
...
V_228 = V_63 & V_53 ;
V_81 = V_63 & V_229 ;
return F_64 ( V_2 , V_228 , V_10 , 1 , V_81 ,
NULL ) ;
}
return 0 ;
}
...
static enum V_230 F_158 ( struct V_231 * V_83 )
{
struct V_232 * V_233 = F_119 ( V_83 , struct V_232 , V_156 ) ;
struct V_1 * V_2 = F_119 ( V_233 , struct V_1 , V_47 ) ;
struct V_8 * V_9 = V_2 -> V_9 ;
T_8 * V_234 = & V_9 -> V_235 ;
...
V_2 -> V_9 = V_9 ;
F_165 ( & V_2 -> V_47 . V_156 , V_241 ,
V_191 ) ;
V_2 -> V_47 . V_156 . V_242 = F_158 ;
...
if ( ! F_3 ( V_250 , & V_9 -> V_11 . V_88 ) )
return;
F_68 ( V_9 -> V_19 , & V_9 -> V_11 . V_2 -> V_251 , & V_83 ,
sizeof( T_1 ) ) ;
...
if ( V_253 < 0 )
V_253 = 0 ;
V_83 = ( V_92 & 0xff ) | ( ( V_253 & 0xf0 ) << 8 ) | ( V_252 << 24 ) ;
F_66 ( V_9 -> V_19 , & V_9 -> V_11 . V_2 -> V_251 , & V_83 ,
sizeof( T_1 ) ) ;
}
...
V_254 , sizeof( T_1 ) ) )
return - V_255 ;
F_73 ( V_250 , & V_9 -> V_11 . V_88 ) ;
} else {
F_75 ( V_250 , & V_9 -> V_11 . V_88 ) ;
}
V_9 -> V_11 . V_2 -> V_254 = V_254 ;
return 0 ;
}
int F_183 ( struct V_8 * V_9 , T_1 V_256 , T_6 V_83 )
{
struct V_1 * V_2 = V_9 -> V_11 . V_2 ;
...
return 1 ;
if ( V_256 == 0x830 )
F_135 ( V_2 , V_146 , ( T_1 ) ( V_83 >> 32 ) ) ;
return F_135 ( V_2 , V_63 , ( T_1 ) V_83 ) ;
}
int F_185 ( struct V_8 * V_9 , T_1 V_256 , T_6 * V_83 )
{
struct V_1 * V_2 = V_9 -> V_11 . V_2 ;
T_1 V_63 = ( V_256 - V_257 ) << 4 , V_258 , V_259 = 0 ;
if ( ! F_184 ( V_9 -> V_19 ) || ! F_28 ( V_2 ) )
return 1 ;
if ( F_120 ( V_2 , V_63 , 4 , & V_258 ) )
return 1 ;
if ( V_256 == 0x830 )
F_120 ( V_2 , V_146 , 4 , & V_259 ) ;
* V_83 = ( ( ( T_6 ) V_259 ) << 32 ) | V_258 ;
return 0 ;
}
