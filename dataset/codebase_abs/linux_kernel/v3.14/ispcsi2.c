...
static int F_64 ( struct V_158 * V_222 ,
struct V_204 * V_205 ,
struct V_223 * V_32 )
{
...
static int F_66 ( struct V_158 * V_222 ,
struct V_204 * V_205 ,
struct V_226 * V_227 )
{
struct V_3 * V_4 = F_65 ( V_222 ) ;
...
V_211 . V_215 = 1 ;
V_211 . V_216 = 1 ;
F_60 ( V_4 , V_205 , V_227 -> V_161 , & V_211 , V_208 ) ;
...
static int F_67 ( struct V_158 * V_222 , struct V_204 * V_205 ,
struct V_232 * V_26 )
{
struct V_3 * V_4 = F_65 ( V_222 ) ;
struct V_25 * V_211 ;
V_211 = F_58 ( V_4 , V_205 , V_26 -> V_161 , V_26 -> V_207 ) ;
if ( V_211 == NULL )
return - V_225 ;
V_26 -> V_211 = * V_211 ;
return 0 ;
}
static int F_68 ( struct V_158 * V_222 , struct V_204 * V_205 ,
struct V_232 * V_26 )
{
struct V_3 * V_4 = F_65 ( V_222 ) ;
struct V_25 * V_211 ;
...
if ( V_211 == NULL )
return - V_225 ;
F_60 ( V_4 , V_205 , V_26 -> V_161 , & V_26 -> V_211 , V_26 -> V_207 ) ;
* V_211 = V_26 -> V_211 ;
if ( V_26 -> V_161 == V_28 ) {
V_211 = F_58 ( V_4 , V_205 , V_170 ,
V_26 -> V_207 ) ;
* V_211 = V_26 -> V_211 ;
F_60 ( V_4 , V_205 , V_170 , V_211 , V_26 -> V_207 ) ;
}
return 0 ;
}
static int F_69 ( struct V_158 * V_222 , struct V_204 * V_205 )
{
struct V_232 V_211 ;
...
static int F_70 ( struct V_158 * V_222 , int V_5 )
{
struct V_3 * V_4 = F_65 ( V_222 ) ;
struct V_1 * V_2 = V_4 -> V_2 ;
...
static int F_77 ( struct V_240 * V_163 ,
const struct V_160 * V_241 ,
const struct V_160 * V_242 , T_2 V_243 )
{
struct V_158 * V_222 = F_37 ( V_163 ) ;
struct V_3 * V_4 = F_65 ( V_222 ) ;
struct V_6 * V_8 = & V_4 -> V_8 ;
switch ( V_241 -> V_224 | F_78 ( V_242 -> V_163 ) ) {
case V_170 | V_244 :
if ( V_243 & V_245 ) {
if ( V_4 -> V_43 & ~ V_45 )
return - V_140 ;
...
{
struct V_158 * V_222 = & V_4 -> V_194 ;
struct V_160 * V_162 = V_4 -> V_162 ;
struct V_240 * V_250 = & V_222 -> V_163 ;
int V_249 ;
F_86 ( V_222 , & V_251 ) ;
V_222 -> V_252 = & V_253 ;
...
F_88 ( V_222 , V_4 ) ;
V_222 -> V_243 |= V_255 ;
V_162 [ V_170 ] . V_243 = V_256 ;
V_162 [ V_28 ] . V_243 = V_257
| V_258 ;
V_250 -> V_259 = & V_260 ;
V_249 = F_89 ( V_250 , V_261 , V_162 , 0 ) ;
if ( V_249 < 0 )
return V_249 ;
F_69 ( V_222 , NULL ) ;
V_4 -> V_171 . type = V_262 ;
V_4 -> V_171 . V_259 = & V_263 ;
V_4 -> V_171 . V_264 = 32 ;
V_4 -> V_171 . V_265 = 1 ;
V_4 -> V_171 . V_266 = 0x1ffe0 ;
V_4 -> V_171 . V_2 = V_4 -> V_2 ;
V_4 -> V_171 . V_267 = F_90 ( 4096 * 4096 ) * 3 ;
V_249 = F_91 ( & V_4 -> V_171 , L_18 ) ;
if ( V_249 < 0 )
goto V_268;
V_249 = F_92 ( & V_4 -> V_194 . V_163 , V_170 ,
