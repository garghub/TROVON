...
V_3 -> V_90 . V_91 = V_87 ;
memcpy ( V_3 -> V_90 . V_92 , V_88 , ( V_87 * sizeof( V_93 ) ) ) ;
return true ;
}
unsigned short
F_23 (
...
{
unsigned short V_55 = V_82 ;
T_2 V_3 = ( T_2 ) V_86 ;
for ( V_55 = V_82 ; V_55 > V_17 ; V_55 -- ) {
if ( V_3 -> V_61 [ 0 ] . V_94 & ( 1 << V_55 ) ) {
return V_55 ;
}
}
if ( V_3 -> V_39 == V_78 ) {
...
{
T_2 V_3 = ( T_2 ) V_86 ;
unsigned char * V_103 = ( unsigned char * ) ( V_3 -> V_104 ) ;
if ( ( V_98 != NULL ) &&
( V_3 -> V_105 < ( V_106 - sizeof( V_107 ) - sizeof( V_108 ) - 3 ) )
) {
V_3 -> V_104 -> V_109 = V_110 ;
V_3 -> V_104 -> V_20 = 3 ;
V_3 -> V_104 -> V_111 = ( ( V_112 ) V_98 ) -> V_111 ;
V_3 -> V_104 -> V_113 = V_99 ;
V_3 -> V_104 -> V_114 = ( ( V_112 ) V_98 ) -> V_114 ;
switch ( V_3 -> V_104 -> V_114 ) {
case V_115 :
V_3 -> V_104 -> V_20 += sizeof( V_116 ) ;
memcpy ( & ( V_3 -> V_104 -> V_117 . V_118 ) ,
& ( ( ( V_112 ) V_98 ) -> V_119 ) ,
sizeof( V_120 ) ) ;
V_3 -> V_104 -> V_117 . V_118 . V_121 = V_100 ;
break;
case V_122 :
V_3 -> V_104 -> V_20 += sizeof( V_123 ) ;
memcpy ( & ( V_3 -> V_104 -> V_117 . V_124 ) ,
& ( ( ( V_112 ) V_98 ) -> V_119 ) ,
sizeof( V_120 ) ) ;
V_3 -> V_104 -> V_117 . V_124 . V_125 = V_101 ;
break;
case V_126 :
V_3 -> V_104 -> V_20 += sizeof( V_127 ) ;
memcpy ( & ( V_3 -> V_104 -> V_117 . V_128 ) ,
& ( ( ( V_112 ) V_98 ) -> V_119 ) ,
sizeof( V_120 ) ) ;
memcpy ( V_3 -> V_104 -> V_117 . V_128 . V_129 , V_102 , 8 ) ;
break;
default:
break;
}
V_103 += ( 2 + V_3 -> V_104 -> V_20 ) ;
V_3 -> V_105 += ( 2 + V_3 -> V_104 -> V_20 ) ;
V_3 -> V_104 = ( V_130 ) V_103 ;
}
if ( V_97 ) {
F_26 ( V_3 ) ;
}
