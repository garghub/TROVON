...
static void F_24 ( struct V_18 * V_19 , T_4 V_64 )
{
...
V_2 -> V_37 = F_35 ( sizeof( T_4 ) * ( V_33 + 1 ) , V_82 ) ;
if ( ! V_2 -> V_37 ) {
V_62 = - V_66 ;
goto V_83;
}
...
V_2 -> V_33 = V_33 ;
V_19 -> V_84 = V_2 ;
strcpy ( F_36 ( V_19 ) , V_85 ) ;
strcpy ( F_37 ( V_19 ) , V_86 ) ;
V_62 = F_25 ( V_2 ) ;
if ( V_62 ) {
F_7 ( ( V_22 ,
L_15 ) ) ;
