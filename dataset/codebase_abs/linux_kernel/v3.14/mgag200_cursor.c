...
V_25 = F_6 ( V_24 , true ) ;
if ( V_25 ) {
F_14 ( & V_17 -> V_46 -> V_17 , L_1 ) ;
goto V_40;
}
if ( ! V_24 -> V_47 . V_48 ) {
V_25 = F_15 ( & V_24 -> V_24 , 0 , V_24 -> V_24 . V_49 , & V_24 -> V_47 ) ;
if ( V_25 ) {
F_14 ( & V_17 -> V_46 -> V_17 , L_2 ) ;
goto V_50;
}
}
memset ( & V_29 [ 0 ] , 0 , sizeof( T_1 ) * 16 ) ;
for ( V_26 = 0 ; V_26 < 16384 ; V_26 += 4 ) {
V_32 = F_16 ( V_24 -> V_47 . V_48 + V_26 ) ;
if ( V_32 >> 24 != 0xff &&
V_32 >> 24 != 0x0 ) {
if ( V_51 ) {
F_17 ( & V_17 -> V_46 -> V_17 , L_3 ) ;
F_17 ( & V_17 -> V_46 -> V_17 , L_4 ) ;
V_51 = false ;
}
V_25 = - V_39 ;
goto V_52;
...
V_32 = F_16 ( V_24 -> V_47 . V_48 + 4 * ( V_28 + 64 * V_27 ) ) ;
if ( V_32 >> 24 == 0x0 ) {
...
F_19 ( V_21 -> V_47 . V_48 + V_27 * 48 , & V_37 [ 0 ] , 48 ) ;
}
if ( V_21 == V_6 )
V_35 = V_2 -> V_5 . V_42 ;
else
V_35 = V_2 -> V_5 . V_43 ;
F_18 ( V_54 , ( T_3 ) ( ( V_35 >> 10 ) & 0xff ) ) ;
F_18 ( V_55 , ( T_3 ) ( ( V_35 >> 18 ) & 0x3f ) ) ;
F_18 ( V_56 , 4 ) ;
...
int F_22 ( struct V_9 * V_10 , int V_57 , int V_58 )
{
