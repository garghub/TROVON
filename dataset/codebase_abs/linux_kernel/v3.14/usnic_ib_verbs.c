...
V_53 = V_81 . V_82 ;
F_38 ( & V_8 -> V_62 ) ;
V_42 = ( V_192 -> V_196 == V_192 -> V_197 ) ? 1 : 2 ;
V_55 = V_198 [ V_53 . V_47 ] ;
F_59 ( & V_55 , V_41 , V_42 ) ;
...
int F_65 ( struct V_171 * V_180 , struct V_173 * V_204 ,
int V_205 , struct V_5 * V_6 )
{
struct V_3 * V_4 ;
int V_206 ;
F_25 ( L_9 ) ;
...
if ( ( V_205 & V_207 ) && V_204 -> V_178 == V_208 ) {
V_206 = F_63 ( V_4 , V_208 , NULL ) ;
} else if ( ( V_205 & V_207 ) && V_204 -> V_178 == V_209 ) {
V_206 = F_63 ( V_4 , V_209 , NULL ) ;
} else if ( ( V_205 & V_207 ) && V_204 -> V_178 == V_210 ) {
V_206 = F_63 ( V_4 , V_210 , NULL ) ;
} else {
F_4 ( L_17 ,
V_205 & V_207 , V_204 -> V_178 ) ;
V_206 = - V_85 ;
}
F_42 ( & V_4 -> V_21 -> V_22 -> V_62 ) ;
return V_206 ;
}
struct V_211 * F_66 ( struct V_87 * V_90 , int V_212 ,
int V_213 , struct V_188 * V_189 ,
struct V_5 * V_6 )
{
struct V_211 * V_214 ;
F_25 ( L_9 ) ;
V_214 = F_50 ( sizeof( * V_214 ) , V_190 ) ;
if ( ! V_214 )
return F_29 ( - V_200 ) ;
return V_214 ;
}
int F_67 ( struct V_211 * V_214 )
{
F_25 ( L_9 ) ;
F_52 ( V_214 ) ;
return 0 ;
}
struct V_215 * F_68 ( struct V_187 * V_51 , T_1 V_216 , T_1 V_217 ,
T_1 V_218 , int V_219 ,
struct V_5 * V_6 )
{
struct V_220 * V_221 ;
...
F_25 ( L_18 , V_216 ,
V_218 , V_217 ) ;
V_221 = F_50 ( sizeof( * V_221 ) , V_190 ) ;
if ( F_9 ( V_221 ) )
return F_29 ( V_221 ? F_11 ( V_221 ) : - V_32 ) ;
V_221 -> V_222 = F_69 ( F_55 ( V_51 ) -> V_65 , V_216 , V_217 ,
V_219 , 0 ) ;
if ( F_9 ( V_221 -> V_222 ) ) {
V_20 = V_221 -> V_222 ? F_11 ( V_221 -> V_222 ) : - V_25 ;
goto V_223;
}
V_221 -> V_224 . V_225 = V_221 -> V_224 . V_226 = 0 ;
return & V_221 -> V_224 ;
V_223:
F_52 ( V_221 ) ;
return F_29 ( V_20 ) ;
}
int F_70 ( struct V_215 * V_224 )
{
struct V_220 * V_221 = F_71 ( V_224 ) ;
F_25 ( L_19 , V_221 -> V_222 -> V_227 , V_221 -> V_222 -> V_217 ) ;
F_72 ( V_221 -> V_222 , V_224 -> V_51 -> V_195 -> V_189 -> V_228 ) ;
F_52 ( V_221 ) ;
return 0 ;
}
...
F_75 ( & V_189 -> V_203 ) ;
F_38 ( & V_8 -> V_62 ) ;
F_60 ( & V_189 -> V_45 , & V_8 -> V_229 ) ;
F_42 ( & V_8 -> V_62 ) ;
return & V_189 -> V_230 ;
}
int F_76 ( struct V_188 * V_231 )
{
struct V_193 * V_189 = F_57 ( V_231 ) ;
struct V_7 * V_8 = F_37 ( V_231 -> V_58 ) ;
F_25 ( L_9 ) ;
F_38 ( & V_8 -> V_62 ) ;
F_16 ( ! F_18 ( & V_189 -> V_203 ) ) ;
F_64 ( & V_189 -> V_45 ) ;
F_42 ( & V_8 -> V_62 ) ;
F_52 ( V_189 ) ;
return 0 ;
...
V_8 = F_37 ( V_189 -> V_58 ) ;
V_233 -> V_235 |= V_236 ;
V_233 -> V_237 = F_79 ( V_233 -> V_237 ) ;
V_26 = V_233 -> V_238 ;
F_25 ( L_20 ,
V_233 -> V_238 , V_239 , V_26 ) ;
F_38 ( & V_8 -> V_62 ) ;
F_28 (qp_grp, &uctx->qp_grp_list, link) {
V_21 = V_4 -> V_21 ;
if ( F_7 ( V_21 -> V_23 ) == V_26 ) {
V_14 = F_5 ( V_21 -> V_23 , 0 ) ;
if ( ( V_233 -> V_240 - V_233 -> V_241 ) != V_14 -> V_30 ) {
F_4 ( L_21 ,
V_14 -> V_30 ,
V_233 -> V_240 - V_233 -> V_241 ) ;
F_42 ( & V_8 -> V_62 ) ;
return - V_85 ;
}
V_28 = V_14 -> V_28 ;
...
struct V_243 * F_81 ( struct V_187 * V_51 ,
struct V_244 * V_245 )
{
F_25 ( L_9 ) ;
return F_29 ( - V_246 ) ;
}
int F_82 ( struct V_243 * V_247 )
{
F_25 ( L_9 ) ;
return - V_85 ;
}
int F_83 ( struct V_171 * V_180 , struct V_248 * V_249 ,
struct V_248 * * V_250 )
{
F_25 ( L_9 ) ;
return - V_85 ;
}
int F_84 ( struct V_171 * V_180 , struct V_251 * V_249 ,
struct V_251 * * V_250 )
{
F_25 ( L_9 ) ;
return - V_85 ;
}
int F_85 ( struct V_211 * V_252 , int V_253 ,
struct V_254 * V_255 )
{
F_25 ( L_9 ) ;
return - V_85 ;
}
int F_86 ( struct V_211 * V_214 ,
enum V_256 V_257 )
{
F_25 ( L_9 ) ;
return - V_85 ;
}
struct V_215 * F_87 ( struct V_187 * V_51 , int V_258 )
{
F_25 ( L_9 ) ;
return F_29 ( - V_32 ) ;
}
