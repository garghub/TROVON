...
V_72 -> V_74 , V_72 -> V_75 ,
V_72 -> V_76 , V_72 -> V_77 ) ;
for ( V_6 = 0 ; V_6 < V_72 -> V_78 ; V_6 ++ )
F_20 ( V_2 , V_72 -> V_79 [ V_6 ] >= 32 && V_72 -> V_79 [ V_6 ] < 127 ?
V_72 -> V_79 [ V_6 ] : '_' ) ;
F_20 ( V_2 , '\t' ) ;
for ( V_6 = 0 ; V_6 < V_72 -> V_78 ; V_6 ++ )
F_2 ( V_2 , L_39 , V_72 -> V_79 [ V_6 ] ) ;
F_20 ( V_2 , '\t' ) ;
for ( V_6 = 0 ; V_6 < V_72 -> V_80 ; V_6 ++ )
F_2 ( V_2 , L_39 , V_72 -> V_81 [ V_6 ] ) ;
F_20 ( V_2 , '\n' ) ;
return 0 ;
}
