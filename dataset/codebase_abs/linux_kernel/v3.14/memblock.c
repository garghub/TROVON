...
struct V_38 * V_32 = & V_2 . V_3 . V_15 [ V_12 ] ;
if ( V_103 <= V_32 -> V_6 ) {
V_85 = V_32 -> V_5 + V_103 ;
break;
}
...
static int T_1 F_87 ( struct V_1 * type , T_2 V_36 )
{
...
int T_4 F_88 ( T_2 V_36 )
{
return F_87 ( & V_2 . V_4 , V_36 ) != - 1 ;
}
int T_1 F_89 ( T_2 V_36 )
{
return F_87 ( & V_2 . V_3 , V_36 ) != - 1 ;
}
int T_1 F_90 ( unsigned long V_107 ,
unsigned long * V_100 , unsigned long * V_101 )
{
struct V_1 * type = & V_2 . V_3 ;
int V_106 = F_87 ( type , ( T_2 ) V_107 << V_102 ) ;
if ( V_106 == - 1 )
return - 1 ;
* V_100 = type -> V_15 [ V_106 ] . V_5 >> V_102 ;
* V_101 = ( type -> V_15 [ V_106 ] . V_5 + type -> V_15 [ V_106 ] . V_6 )
>> V_102 ;
return type -> V_15 [ V_106 ] . V_20 ;
}
int T_1 F_91 ( T_2 V_5 , T_2 V_6 )
{
int V_56 = F_87 ( & V_2 . V_3 , V_5 ) ;
T_2 V_18 = V_5 + F_2 ( V_5 , & V_6 ) ;
if ( V_56 == - 1 )
return 0 ;
...
void T_1 F_93 ( T_2 V_19 )
{
int V_12 ;
T_2 V_17 , V_18 , V_108 , V_109 ;
struct V_1 * V_73 = & V_2 . V_3 ;
for ( V_12 = 0 ; V_12 < V_73 -> V_13 ; V_12 ++ ) {
V_108 = V_73 -> V_15 [ V_12 ] . V_5 ;
V_109 = V_73 -> V_15 [ V_12 ] . V_5 + V_73 -> V_15 [ V_12 ] . V_6 ;
V_17 = F_9 ( V_108 , V_19 ) ;
V_18 = F_12 ( V_109 , V_19 ) ;
if ( V_17 == V_108 && V_18 == V_109 )
continue;
if ( V_17 < V_18 ) {
V_73 -> V_15 [ V_12 ] . V_5 = V_17 ;
V_73 -> V_15 [ V_12 ] . V_6 = V_18 - V_17 ;
} else {
F_20 ( V_73 , V_12 ) ;
V_12 -- ;
}
...
void T_1 F_94 ( T_2 V_103 )
{
V_2 . V_27 = V_103 ;
}
static void T_1 F_95 ( struct V_1 * type , char * V_110 )
{
unsigned long long V_5 , V_6 ;
unsigned long V_34 ;
int V_12 ;
F_96 ( L_15 , V_110 , type -> V_13 ) ;
for ( V_12 = 0 ; V_12 < type -> V_13 ; V_12 ++ ) {
struct V_38 * V_57 = & type -> V_15 [ V_12 ] ;
char V_111 [ 32 ] = L_16 ;
V_5 = V_57 -> V_5 ;
...
static int T_4 F_100 ( char * V_112 )
{
if ( V_112 && strstr ( V_112 , L_21 ) )
V_113 = 1 ;
return 0 ;
}
static int F_101 ( struct V_114 * V_77 , void * V_115 )
{
...
static int F_103 ( struct V_117 * V_117 , struct V_118 * V_118 )
{
return F_104 ( V_118 , F_101 , V_117 -> V_119 ) ;
}
static int T_4 F_105 ( void )
{
struct V_120 * V_121 = F_106 ( L_25 , NULL ) ;
if ( ! V_121 )
return - V_122 ;
F_107 ( L_1 , V_123 , V_121 , & V_2 . V_3 , & V_124 ) ;
F_107 ( L_2 , V_123 , V_121 , & V_2 . V_4 , & V_124 ) ;
return 0 ;
}
