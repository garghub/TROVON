...
void F_23 ( struct V_13 * V_17 )
{
F_17 ( & V_21 ) ;
F_24 ( & V_17 -> V_25 , & V_26 ) ;
F_18 ( & V_21 ) ;
}
void T_1 F_25 ( struct V_13 * V_17 , T_2 V_27 )
{
F_17 ( & V_21 ) ;
while ( V_27 -- ) {
F_24 ( & V_17 -> V_25 , & V_26 ) ;
...
F_26 ( struct V_1 * V_1 , const char * V_15 , const char * V_28 ,
T_4 V_29 )
{
struct V_30 * V_31 ;
V_31 = F_27 ( sizeof( * V_31 ) ) ;
if ( ! V_31 )
return NULL ;
V_31 -> V_17 . V_1 = V_1 ;
if ( V_15 ) {
F_28 ( V_31 -> V_15 , V_15 , sizeof( V_31 -> V_15 ) ) ;
V_31 -> V_17 . V_15 = V_31 -> V_15 ;
}
if ( V_28 ) {
F_29 ( V_31 -> V_14 , sizeof( V_31 -> V_14 ) , V_28 , V_29 ) ;
V_31 -> V_17 . V_14 = V_31 -> V_14 ;
}
return & V_31 -> V_17 ;
}
struct V_13 * T_3
F_30 ( struct V_1 * V_1 , const char * V_15 , const char * V_28 , ... )
{
struct V_13 * V_17 ;
T_4 V_29 ;
va_start ( V_29 , V_28 ) ;
V_17 = F_26 ( V_1 , V_15 , V_28 , V_29 ) ;
va_end ( V_29 ) ;
return V_17 ;
}
int F_31 ( const char * V_32 , const char * V_33 , char * V_34 ,
struct V_22 * V_23 )
{
struct V_1 * V_35 = F_19 ( V_23 , V_34 ) ;
struct V_13 * V_36 ;
if ( F_6 ( V_35 ) )
return F_32 ( V_35 ) ;
V_36 = F_30 ( V_35 , V_32 , V_33 ) ;
F_21 ( V_35 ) ;
if ( ! V_36 )
return - V_37 ;
F_23 ( V_36 ) ;
...
int F_37 ( struct V_1 * V_1 , struct V_13 * V_17 , T_2 V_27 )
{
unsigned V_39 ;
if ( F_6 ( V_1 ) )
return F_32 ( V_1 ) ;
