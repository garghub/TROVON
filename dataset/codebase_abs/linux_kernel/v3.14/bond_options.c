...
static struct V_1 * F_4 ( const struct V_4 * V_5 ,
T_2 V_9 )
{
int V_6 ;
for ( V_6 = 0 ; V_5 -> V_7 && V_5 -> V_7 [ V_6 ] . string ; V_6 ++ )
...
struct V_1 * F_6 ( const struct V_4 * V_5 ,
struct V_1 * V_3 )
{
char * V_15 , V_16 [ V_17 + 1 ] = { 0 , } ;
struct V_1 * V_18 , * V_19 = NULL ;
bool V_20 ;
int V_6 , V_21 ;
if ( V_5 -> V_10 & V_22 )
return V_3 ;
...
struct V_4 * F_2 ( unsigned int V_2 )
{
if ( ! F_20 ( V_2 ) )
return NULL ;
return & V_48 [ V_2 ] ;
}
int F_21 ( struct V_26 * V_27 , struct V_1 * V_49 )
{
...
int F_44 ( struct V_26 * V_27 , struct V_1 * V_49 )
{
F_23 ( L_19 ,
...
int F_47 ( struct V_26 * V_27 , struct V_1 * V_49 )
{
int V_8 = V_49 -> V_8 ;
if ( ! V_27 -> V_29 . V_51 ) {
F_11 ( L_23 ,
...
int F_57 ( struct V_26 * V_27 , T_3 V_78 )
{
int V_19 ;
F_35 ( & V_27 -> V_87 ) ;
V_19 = F_54 ( V_27 , V_78 ) ;
...
int F_58 ( struct V_26 * V_27 , T_3 V_78 )
{
T_3 * V_80 = V_27 -> V_29 . V_74 ;
struct V_81 * V_82 ;
struct V_56 * V_56 ;
...
int F_64 ( struct V_26 * V_27 , struct V_1 * V_49 )
{
...
int F_76 ( struct V_26 * V_27 , struct V_1 * V_49 )
{
...
int F_83 ( struct V_26 * V_27 , struct V_1 * V_49 )
{
char V_113 [ V_59 + 1 ] = { 0 , } ;
struct V_55 * V_36 ;
char * V_58 ;
