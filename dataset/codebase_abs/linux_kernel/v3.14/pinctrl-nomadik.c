...
{
struct V_141 * V_142 ;
struct V_143 * V_144 = V_53 -> V_53 . V_145 ;
struct V_1 * V_2 ;
struct V_121 * V_45 ;
struct V_146 * V_147 ;
struct V_79 * V_79 ;
...
int V_47 ;
int V_149 ;
V_142 = F_88 ( & V_53 -> V_53 , sizeof( * V_142 ) , V_150 ) ;
if ( ! V_142 )
return - V_151 ;
if ( F_89 ( V_144 , L_33 , NULL ) )
V_142 -> V_152 = true ;
if ( F_90 ( V_144 , L_34 , & V_53 -> V_153 ) ) {
F_20 ( & V_53 -> V_53 , L_35 ) ;
return - V_84 ;
}
V_142 -> V_154 = V_53 -> V_153 * V_83 ;
V_142 -> V_155 = V_83 ;
V_47 = F_91 ( V_53 , 0 ) ;
if ( V_47 < 0 )
return V_47 ;
V_148 = F_91 ( V_53 , 1 ) ;
if ( V_148 >= 0 && ! V_142 -> V_117 )
return - V_84 ;
V_147 = F_92 ( V_53 , V_156 , 0 ) ;
V_46 = F_93 ( & V_53 -> V_53 , V_147 ) ;
if ( F_94 ( V_46 ) )
return F_95 ( V_46 ) ;
...
return F_95 ( V_79 ) ;
F_97 ( V_79 ) ;
V_2 = F_88 ( & V_53 -> V_53 , sizeof( * V_2 ) , V_150 ) ;
if ( ! V_2 )
return - V_151 ;
V_2 -> V_118 = V_53 -> V_153 ;
V_2 -> V_79 = V_79 ;
V_2 -> V_8 = V_46 ;
V_2 -> V_45 = V_157 ;
V_2 -> V_119 = V_47 ;
...
V_2 -> V_37 = V_142 -> V_37 ;
V_2 -> V_99 = V_142 -> V_152 ;
F_98 ( & V_2 -> V_104 ) ;
V_45 = & V_2 -> V_45 ;
V_45 -> V_46 = V_142 -> V_154 ;
V_45 -> V_133 = V_142 -> V_155 ;
V_45 -> V_125 = V_142 -> V_158 ? : F_99 ( & V_53 -> V_53 ) ;
V_45 -> V_53 = & V_53 -> V_53 ;
V_45 -> V_159 = V_160 ;
F_23 ( V_2 -> V_79 ) ;
...
F_25 ( V_2 -> V_79 ) ;
V_45 -> V_145 = V_144 ;
V_149 = F_101 ( & V_2 -> V_45 ) ;
if ( V_149 )
return V_149 ;
F_102 ( V_2 -> V_118 >= F_103 ( V_77 ) ) ;
V_77 [ V_2 -> V_118 ] = V_2 ;
F_104 ( V_53 , V_2 ) ;
V_2 -> V_48 = F_105 ( V_144 ,
V_83 , 0 ,
& V_161 , V_2 ) ;
if ( ! V_2 -> V_48 ) {
F_20 ( & V_53 -> V_53 , L_36 ) ;
V_149 = F_106 ( & V_2 -> V_45 ) ;
return - V_162 ;
}
F_57 ( V_2 ) ;
F_107 ( & V_53 -> V_53 , L_37 , V_2 -> V_8 ) ;
return 0 ;
}
static int F_108 ( struct V_80 * V_81 )
{
struct V_57 * V_58 = F_27 ( V_81 ) ;
return V_58 -> V_67 -> V_163 ;
}
static const char * F_109 ( struct V_80 * V_81 ,
unsigned V_164 )
{
struct V_57 * V_58 = F_27 ( V_81 ) ;
return V_58 -> V_67 -> V_165 [ V_164 ] . V_158 ;
}
static int F_110 ( struct V_80 * V_81 , unsigned V_164 ,
const unsigned * * V_166 ,
unsigned * V_167 )
{
struct V_57 * V_58 = F_27 ( V_81 ) ;
* V_166 = V_58 -> V_67 -> V_165 [ V_164 ] . V_166 ;
* V_167 = V_58 -> V_67 -> V_165 [ V_164 ] . V_168 ;
return 0 ;
}
static struct V_169 *
F_111 ( struct V_80 * V_81 , unsigned V_3 )
{
struct V_57 * V_58 = F_27 ( V_81 ) ;
int V_60 ;
for ( V_60 = 0 ; V_60 < V_58 -> V_67 -> V_170 ; V_60 ++ ) {
struct V_169 * V_171 ;
V_171 = & V_58 -> V_67 -> V_172 [ V_60 ] ;
if ( V_3 >= V_171 -> V_173 &&
V_3 <= ( V_171 -> V_173 + V_171 -> V_168 - 1 ) )
return V_171 ;
}
return NULL ;
}
static void F_112 ( struct V_80 * V_81 , struct V_123 * V_124 ,
unsigned V_3 )
{
struct V_169 * V_171 ;
struct V_121 * V_45 ;
V_171 = F_111 ( V_81 , V_3 ) ;
...
static void F_113 ( struct V_80 * V_81 ,
struct V_175 * V_176 , unsigned V_177 )
{
int V_60 ;
for ( V_60 = 0 ; V_60 < V_177 ; V_60 ++ )
if ( V_176 [ V_60 ] . type == V_178 )
F_114 ( V_176 [ V_60 ] . V_179 . V_180 . V_180 ) ;
F_114 ( V_176 ) ;
}
static int F_115 ( struct V_175 * * V_176 , unsigned * V_181 ,
unsigned * V_177 , unsigned V_182 )
{
unsigned V_183 = * V_181 ;
unsigned V_184 = * V_177 + V_182 ;
struct V_175 * V_185 ;
if ( V_183 >= V_184 )
return 0 ;
V_185 = F_116 ( * V_176 , sizeof( * V_185 ) * V_184 , V_150 ) ;
if ( ! V_185 )
return - V_151 ;
memset ( V_185 + V_183 , 0 , ( V_184 - V_183 ) * sizeof( * V_185 ) ) ;
* V_176 = V_185 ;
* V_181 = V_184 ;
return 0 ;
}
static int F_117 ( struct V_175 * * V_176 , unsigned * V_181 ,
unsigned * V_177 , const char * V_186 ,
const char * V_187 )
{
if ( * V_177 == * V_181 )
return - V_188 ;
( * V_176 ) [ * V_177 ] . type = V_189 ;
( * V_176 ) [ * V_177 ] . V_179 . V_190 . V_186 = V_186 ;
( * V_176 ) [ * V_177 ] . V_179 . V_190 . V_187 = V_187 ;
( * V_177 ) ++ ;
return 0 ;
}
...
unsigned * V_181 ,
unsigned * V_177 , const char * V_186 ,
unsigned long * V_180 , unsigned V_191 )
{
unsigned long * V_192 ;
if ( * V_177 == * V_181 )
return - V_188 ;
V_192 = F_119 ( V_180 , V_191 * sizeof( * V_192 ) ,
V_150 ) ;
if ( ! V_192 )
return - V_151 ;
( * V_176 ) [ * V_177 ] . type = V_178 ;
( * V_176 ) [ * V_177 ] . V_179 . V_180 . V_193 = V_186 ;
( * V_176 ) [ * V_177 ] . V_179 . V_180 . V_180 = V_192 ;
( * V_176 ) [ * V_177 ] . V_179 . V_180 . V_191 = V_191 ;
( * V_177 ) ++ ;
return 0 ;
}
static int F_120 ( int V_194 , int V_32 , unsigned long * V_195 )
{
int V_149 = 0 ;
if ( V_196 [ V_194 ] . V_197 == NULL )
* V_195 = V_196 [ V_194 ] . V_195 ;
else {
if ( V_32 < V_196 [ V_194 ] . V_198 ) {
* V_195 = V_196 [ V_194 ] . V_195 |
V_196 [ V_194 ] . V_197 [ V_32 ] ;
}
}
return V_149 ;
}
static const char * F_121 ( struct V_80 * V_81 , const char * V_199 )
{
int V_60 , V_200 ;
struct V_57 * V_58 = F_27 ( V_81 ) ;
if ( sscanf ( ( char * ) V_199 , L_39 , & V_200 ) == 1 )
for ( V_60 = 0 ; V_60 < V_58 -> V_67 -> V_168 ; V_60 ++ )
if ( V_58 -> V_67 -> V_166 [ V_60 ] . V_201 == V_200 )
return V_58 -> V_67 -> V_166 [ V_60 ] . V_158 ;
return NULL ;
}
static bool F_122 ( struct V_143 * V_144 ,
unsigned long * V_180 )
{
bool V_202 = 0 ;
unsigned long V_203 = 0 ;
int V_60 , V_32 , V_149 ;
for ( V_60 = 0 ; V_60 < F_103 ( V_196 ) ; V_60 ++ ) {
V_149 = F_90 ( V_144 ,
V_196 [ V_60 ] . V_204 , & V_32 ) ;
if ( V_149 != - V_84 ) {
if ( F_120 ( V_60 , V_32 , & V_203 ) == 0 ) {
* V_180 |= V_203 ;
V_202 = 1 ;
}
}
...
unsigned V_182 = 0 ;
struct V_204 * V_205 ;
const char * V_186 , * V_206 ;
struct V_143 * V_207 ;
V_149 = F_124 ( V_144 , L_40 , & V_187 ) ;
if ( V_149 >= 0 )
V_182 = 1 ;
V_202 = F_122 ( V_144 , & V_180 ) ;
V_207 = F_125 ( V_144 , L_41 , 0 ) ;
if ( V_207 )
V_202 |= F_122 ( V_207 , & V_180 ) ;
V_149 = F_126 ( V_144 , L_42 ) ;
if ( V_149 < 0 )
goto exit;
if ( V_202 )
V_182 ++ ;
V_182 *= V_149 ;
V_149 = F_115 ( V_176 , V_181 , V_177 , V_182 ) ;
if ( V_149 < 0 )
goto exit;
F_127 (np, L_42 , prop, group) {
if ( V_187 ) {
V_149 = F_117 ( V_176 , V_181 , V_177 ,
V_186 , V_187 ) ;
if ( V_149 < 0 )
goto exit;
}
if ( V_202 ) {
V_206 = F_121 ( V_81 , V_186 ) ;
V_149 = F_118 ( V_176 , V_181 , V_177 ,
V_206 , & V_180 , 1 ) ;
if ( V_149 < 0 )
goto exit;
}
...
static int F_128 ( struct V_80 * V_81 ,
struct V_143 * V_207 ,
struct V_175 * * V_176 , unsigned * V_177 )
{
unsigned V_181 ;
...
* V_177 = 0 ;
F_129 (np_config, np) {
V_149 = F_123 ( V_81 , V_144 , V_176 ,
& V_181 , V_177 ) ;
if ( V_149 < 0 ) {
F_113 ( V_81 , * V_176 , * V_177 ) ;
return V_149 ;
}
}
return 0 ;
...
{
struct V_57 * V_58 = F_27 ( V_81 ) ;
return V_58 -> V_67 -> V_208 ;
}
static const char * F_131 ( struct V_80 * V_81 ,
unsigned V_187 )
{
struct V_57 * V_58 = F_27 ( V_81 ) ;
return V_58 -> V_67 -> V_209 [ V_187 ] . V_158 ;
}
static int F_132 ( struct V_80 * V_81 ,
unsigned V_187 ,
const char * const * * V_165 ,
unsigned * const V_210 )
{
struct V_57 * V_58 = F_27 ( V_81 ) ;
* V_165 = V_58 -> V_67 -> V_209 [ V_187 ] . V_165 ;
* V_210 = V_58 -> V_67 -> V_209 [ V_187 ] . V_163 ;
return 0 ;
}
static int F_133 ( struct V_80 * V_81 , unsigned V_187 ,
unsigned V_186 )
{
struct V_57 * V_58 = F_27 ( V_81 ) ;
...
int V_149 = - V_84 ;
int V_60 ;
V_212 = & V_58 -> V_67 -> V_165 [ V_186 ] ;
if ( V_212 -> V_213 < 0 )
return - V_84 ;
F_17 ( V_58 -> V_53 , L_43 , V_212 -> V_158 , V_212 -> V_168 ) ;
V_34 = ( ( V_212 -> V_213 & V_82 ) == V_82 ) ;
if ( V_34 ) {
F_35 ( & V_103 , V_102 ) ;
memset ( V_15 , 0xff , sizeof( V_15 ) ) ;
for ( V_60 = 0 ; V_60 < V_212 -> V_168 ; V_60 ++ )
V_15 [ V_212 -> V_166 [ V_60 ] / V_83 ] &= ~ F_7 ( V_212 -> V_166 [ V_60 ] ) ;
F_22 ( V_15 ) ;
}
for ( V_60 = 0 ; V_60 < V_212 -> V_168 ; V_60 ++ ) {
struct V_169 * V_171 ;
...
struct V_121 * V_45 ;
unsigned V_5 ;
V_171 = F_111 ( V_81 , V_212 -> V_166 [ V_60 ] ) ;
if ( ! V_171 ) {
F_20 ( V_58 -> V_53 ,
L_44 ,
V_212 -> V_166 [ V_60 ] , V_212 -> V_158 , V_60 ) ;
goto V_214;
}
if ( ! V_171 -> V_174 ) {
F_20 ( V_58 -> V_53 , L_45 ,
...
F_17 ( V_58 -> V_53 , L_46 , V_212 -> V_166 [ V_60 ] , V_212 -> V_213 ) ;
F_23 ( V_2 -> V_79 ) ;
V_5 = V_212 -> V_166 [ V_60 ] % V_83 ;
F_13 ( V_2 , V_5 ) ;
F_12 ( V_2 , V_5 ,
( V_212 -> V_213 & V_82 ) , V_34 ) ;
F_25 ( V_2 -> V_79 ) ;
if ( ( V_212 -> V_213 & V_82 ) == V_82 )
F_19 ( V_58 , V_212 -> V_166 [ V_60 ] ,
V_212 -> V_213 >> V_215 ) ;
}
V_149 = 0 ;
V_214:
...
static void F_134 ( struct V_80 * V_81 ,
unsigned V_187 , unsigned V_186 )
{
struct V_57 * V_58 = F_27 ( V_81 ) ;
const struct V_211 * V_212 ;
V_212 = & V_58 -> V_67 -> V_165 [ V_186 ] ;
if ( V_212 -> V_213 < 0 )
return;
F_17 ( V_58 -> V_53 , L_47 , V_212 -> V_158 , V_212 -> V_168 ) ;
}
static int F_135 ( struct V_80 * V_81 ,
struct V_169 * V_171 ,
unsigned V_3 )
{
struct V_57 * V_58 = F_27 ( V_81 ) ;
...
unsigned V_5 ;
T_7 V_203 ;
int V_19 , V_15 , V_219 , V_32 , V_60 ;
bool V_28 , V_220 , V_221 ;
V_171 = F_111 ( V_81 , V_70 ) ;
if ( ! V_171 ) {
...
V_221 = F_145 ( V_203 ) ;
if ( V_221 ) {
int V_222 = F_146 ( V_203 ) ;
int V_223 = F_147 ( V_203 ) ;
int V_224 = F_148 ( V_203 ) ;
V_220 = true ;
if ( V_222 )
V_19 = V_222 - 1 ;
if ( V_223 )
...
L_59 ,
V_70 ,
V_222 ? V_216 [ V_19 ] : L_60 ,
V_223 ? ( V_219 ? L_61 : L_62 )
: L_60 ,
V_224 ? ( V_32 ? L_63 : L_64 ) : L_60 ) ;
}
F_17 ( V_2 -> V_45 . V_53 ,
L_65 ,
V_70 , V_203 , V_216 [ V_19 ] , V_217 [ V_15 ] ,
V_219 ? L_66 : L_62 ,
V_219 ? ( V_32 ? L_63 : L_64 ) : L_31 ,
V_28 ? L_67 : L_68 ) ;
F_23 ( V_2 -> V_79 ) ;
V_5 = V_70 % V_83 ;
if ( V_220 )
...
static int F_149 ( struct V_140 * V_225 , T_8 V_226 )
{
struct V_57 * V_58 ;
V_58 = F_150 ( V_225 ) ;
if ( ! V_58 )
return - V_84 ;
return F_151 ( V_58 -> V_227 ) ;
}
static int F_152 ( struct V_140 * V_225 )
{
struct V_57 * V_58 ;
V_58 = F_150 ( V_225 ) ;
if ( ! V_58 )
return - V_84 ;
return F_153 ( V_58 -> V_227 ) ;
}
static int F_154 ( struct V_140 * V_225 )
{
const struct V_228 * V_229 ;
struct V_143 * V_144 = V_225 -> V_53 . V_145 ;
struct V_143 * V_230 ;
struct V_57 * V_58 ;
unsigned int V_231 = 0 ;
int V_60 ;
V_58 = F_88 ( & V_225 -> V_53 , sizeof( * V_58 ) , V_150 ) ;
if ( ! V_58 )
return - V_151 ;
V_229 = F_155 ( V_232 , & V_225 -> V_53 ) ;
if ( ! V_229 )
return - V_233 ;
V_231 = ( unsigned int ) V_229 -> V_179 ;
if ( V_231 == V_234 )
F_156 ( & V_58 -> V_67 ) ;
if ( V_231 == V_235 )
F_157 ( & V_58 -> V_67 ) ;
if ( V_231 == V_236 )
F_158 ( & V_58 -> V_67 ) ;
V_230 = F_125 ( V_144 , L_69 , 0 ) ;
if ( V_230 )
V_58 -> V_65 = F_159 ( V_230 , 0 ) ;
if ( ! V_58 -> V_65 ) {
if ( V_231 == V_234 ) {
F_107 ( & V_225 -> V_53 ,
L_70
...
F_20 ( & V_225 -> V_53 , L_72 ) ;
return - V_84 ;
}
}
for ( V_60 = 0 ; V_60 < V_58 -> V_67 -> V_170 ; V_60 ++ ) {
if ( ! V_77 [ V_58 -> V_67 -> V_172 [ V_60 ] . V_153 ] ) {
F_21 ( & V_225 -> V_53 , L_73 , V_60 ) ;
return - V_237 ;
}
V_58 -> V_67 -> V_172 [ V_60 ] . V_174 = & V_77 [ V_58 -> V_67 -> V_172 [ V_60 ] . V_153 ] -> V_45 ;
}
V_238 . V_166 = V_58 -> V_67 -> V_166 ;
V_238 . V_168 = V_58 -> V_67 -> V_168 ;
V_58 -> V_53 = & V_225 -> V_53 ;
V_58 -> V_227 = F_160 ( & V_238 , & V_225 -> V_53 , V_58 ) ;
if ( ! V_58 -> V_227 ) {
F_20 ( & V_225 -> V_53 , L_74 ) ;
return - V_84 ;
}
for ( V_60 = 0 ; V_60 < V_58 -> V_67 -> V_170 ; V_60 ++ )
F_161 ( V_58 -> V_227 , & V_58 -> V_67 -> V_172 [ V_60 ] ) ;
F_104 ( V_225 , V_58 ) ;
F_107 ( & V_225 -> V_53 , L_75 ) ;
return 0 ;
}
