...
if ( V_290 >= 0 ) {
if ( F_83 ( V_298 -> V_307 [ V_290 ] . V_308 , V_294 -> V_306 ) ) {
goto V_309;
}
F_84 ( V_279 -> V_86 ,
...
F_84 ( V_279 -> V_86 , V_294 -> V_306 ,
V_289 , V_311 ) ;
V_295 = F_85 ( V_279 -> V_280 , V_289 , NULL ,
V_312 ) ;
} else {
F_86 ( V_294 , NULL ) ;
}
...
static struct V_1 * F_90 ( struct V_130 * V_3 ,
...
V_298 = V_280 -> V_298 ;
V_2 -> V_275 = NULL ;
V_316 = F_85 ( V_280 , V_2 -> V_10 , NULL , V_312 ) ;
...
static int F_95 ( struct V_1 * V_2 , T_1 * V_331 ,
T_3 V_72 , T_3 V_332 )
{
T_3 V_333 ;
T_3 V_334 = 0 ;
...
if ( V_117 != V_114 )
V_268 = 1 ;
else if ( ! F_106 ( V_113 , V_116 , ( V_116 + V_126 ) ) )
V_268 = 1 ;
if ( V_268 ) {
F_7 ( V_14 , L_63
L_64 , V_301 , __LINE__ , V_2 ,
...
V_136 = F_108 ( V_2 , V_76 , V_16 , V_72 ,
1 ) ;
if ( V_136 ) {
F_101 ( V_2 , V_16 , 0 ) ;
break;
...
V_136 = F_108 ( V_2 , V_76 , V_16 , V_72 , 0 ) ;
if ( V_136 ) {
F_7 ( V_14 , L_73 ,
V_2 ) ;
break;
...
static int F_110 ( struct V_1 * V_2 , struct V_15 * V_16 ,
struct V_75 * V_76 )
{
int V_74 = 0 ;
T_3 V_357 ;
...
int V_72 ;
V_72 = ( V_76 -> V_124 << 2 ) - sizeof( struct V_75 ) ;
if ( F_105 ( V_2 , V_76 , V_16 ) )
return - V_43 ;
F_111 ( V_16 , V_76 -> V_124 << 2 ) ;
V_357 = F_36 ( V_76 -> V_113 ) ;
V_74 = V_16 -> V_35 ;
switch ( V_2 -> V_32 ) {
case V_197 :
F_42 ( V_2 ) ;
V_136 = F_108 ( V_2 , V_76 , V_16 , V_72 , 1 ) ;
if ( V_136 )
break;
V_2 -> V_105 . V_228 = F_36 ( V_76 -> V_117 ) ;
V_2 -> V_32 = V_342 ;
...
static int F_108 ( struct V_1 * V_2 , struct V_75 * V_76 ,
struct V_15 * V_16 , int V_72 , int V_361 )
{
T_1 * V_331 = ( T_1 * ) & V_76 [ 1 ] ;
if ( V_72 ) {
if ( F_95 ( V_2 , V_331 , V_72 ,
( T_3 ) V_76 -> V_120 ) ) {
F_7 ( V_14 , L_74 ,
V_301 , V_2 ) ;
if ( V_361 )
...
break;
default:
if ( ( V_367 ) && ( ! F_105 ( V_2 , V_76 , V_16 ) ) )
F_98 ( V_2 ) ;
F_96 ( V_16 ) ;
break;
}
}
static struct V_257 * F_114 ( struct V_130 * V_3 ,
struct V_288 * V_279 , struct V_313 * V_9 )
{
struct V_257 * V_266 ;
unsigned long V_29 ;
...
static struct V_1 * F_115 ( struct V_130 * V_3 ,
...
static int F_120 ( struct V_130 * V_3 , struct V_1 * V_2 )
{
int V_136 = 0 ;
if ( ! V_3 || ! V_2 )
return - V_43 ;
...
static int F_121 ( struct V_130 * V_3 ,
...
V_392 = F_122 ( V_78 -> V_110 ) ;
V_393 = F_122 ( V_78 -> V_109 ) ;
F_7 ( V_14 , L_93 ,
...
static struct V_130 * F_125 ( void )
{
struct V_130 * V_3 ;
...
F_7 ( V_14 , L_97 , V_3 ) ;
F_7 ( V_14 , L_98 ) ;
V_3 -> V_404 = F_127 ( L_99 ) ;
V_3 -> V_405 = F_8 ;
F_7 ( V_14 , L_100 ) ;
V_3 -> V_406 = F_127 ( L_101 ) ;
F_25 ( V_3 ) ;
return V_3 ;
}
static int F_128 ( struct V_130 * V_3 )
{
F_7 ( V_14 , L_102 , V_3 ) ;
if ( ! V_3 )
return - V_43 ;
...
static int F_132 ( struct V_130 * V_3 )
{
return V_3 -> V_32 ;
}
static int F_133 ( struct V_130 * V_3 , T_3 type , T_3 V_407 )
{
int V_136 = 0 ;
switch ( type ) {
case V_408 :
...
static int F_134 ( struct V_140 * V_143 , struct V_1 * V_2 )
{
int V_136 = 0 ;
if ( ! V_143 )
return - V_43 ;
...
F_7 ( V_14 , L_104
L_105 ,
V_143 -> V_146 . V_205 , F_135 ( V_143 -> V_165 -> V_116 ) ,
F_135 ( V_143 -> V_165 -> V_429 ) ,
V_2 -> V_105 . V_244 , F_135 ( V_143 -> V_165 -> V_421 ) ,
F_135 ( V_143 -> V_165 -> V_126 ) ,
F_135 ( V_143 -> V_165 -> V_410 ) ) ;
F_7 ( V_14 , L_106 , F_135 ( V_143 -> V_165 -> V_362 ) ) ;
F_7 ( V_14 , L_107 , F_135 ( V_143 -> V_165 -> V_435 ) ) ;
F_7 ( V_14 , L_108 , F_135 ( V_143 -> V_165 -> V_363 ) ) ;
F_7 ( V_14 , L_109 ) ;
V_2 -> V_32 = V_225 ;
return V_136 ;
}
...
F_136 ( & V_143 -> V_330 ) ;
V_439 -> V_143 = V_143 ;
F_137 ( & V_439 -> V_439 , V_440 ) ;
F_138 ( V_219 -> V_406 , & V_439 -> V_439 ) ;
return 0 ;
}
...
static int F_139 ( struct V_140 * V_143 )
{
unsigned long V_29 ;
int V_136 = 0 ;
struct V_194 * V_7 ;
...
V_452 |= V_469 ;
F_141 ( V_279 -> V_280 , V_143 , V_452 , 1 ) ;
if ( V_143 -> V_457 ) {
...
static int F_142 ( struct V_140 * V_143 , int V_484 )
{
int V_136 = 0 ;
struct V_288 * V_279 ;
struct V_317 * V_280 ;
...
int F_145 ( struct V_194 * V_7 , struct V_495 * V_496 )
{
T_4 V_142 ;
struct V_497 * V_330 ;
struct V_140 * V_143 ;
...
T_1 * * V_19 = & V_18 ;
T_2 V_20 = 0 ;
struct V_512 * V_513 = (struct V_512 * ) & V_7 -> V_478 ;
struct V_512 * V_514 = (struct V_512 * ) & V_7 -> V_479 ;
V_330 = F_146 ( V_7 -> V_456 , V_496 -> V_515 ) ;
if ( ! V_330 )
return - V_43 ;
V_143 = F_147 ( V_330 ) ;
V_279 = F_140 ( V_143 -> V_330 . V_456 ) ;
...
if ( V_2 -> V_48 == V_46 )
V_511 = 4 ;
memcpy ( V_37 -> V_518 , V_496 -> V_377 ,
V_496 -> V_376 ) ;
F_10 ( V_2 , V_19 , & V_20 , V_143 -> V_488 , V_28 ) ;
V_143 -> V_376 = V_496 -> V_376 ;
V_145 = & V_143 -> V_146 . V_147 [ 0 ] ;
if ( V_514 -> V_519 . V_520 != V_513 -> V_519 . V_520 ) {
V_142 = ( unsigned long ) V_143 ;
V_486 = V_279 -> V_486 ;
V_509 = V_143 -> V_509 ;
V_507 . V_521 = V_143 -> V_493 + V_511 ;
V_507 . V_522 = V_20 ;
V_510 = ( T_4 ) ( unsigned long ) * V_19 ;
V_505 = V_486 -> V_490 . V_523 ( (struct V_524 * ) V_509 ,
& V_507 , 1 ,
V_525 ,
& V_510 ) ;
if ( ! V_505 ) {
...
V_505 -> V_526 = & V_509 -> V_527 ;
V_505 -> V_456 = V_509 -> V_527 . V_456 ;
V_143 -> V_489 = V_505 ;
V_142 |= V_148 >> 1 ;
F_30 ( V_145 -> V_149 ,
V_150 ,
...
V_2 ) ;
F_134 ( V_143 , V_2 ) ;
V_143 -> V_165 -> V_531 [ 0 ] = F_149 ( F_16 ( V_513 -> V_532 ) ) ;
V_143 -> V_165 -> V_531 [ 1 ] = F_149 ( F_16 ( V_514 -> V_532 ) ) ;
V_143 -> V_165 -> V_533 = F_31 ( F_36 ( V_514 -> V_519 . V_520 ) ) ;
V_143 -> V_165 -> V_416 |= F_31 (
( T_3 ) F_71 ( V_280 -> V_281 -> V_282 ) <<
V_534 ) ;
V_143 -> V_165 -> V_535 |=
F_31 ( F_85 ( V_280 ,
F_135 ( V_143 -> V_165 -> V_533 ) , NULL ,
V_312 ) << 16 ) ;
V_143 -> V_165 -> V_536 = F_31 (
V_182 - F_150 ( V_280 , V_537 ) ) ;
V_143 -> V_165 -> V_538 = F_31 ( V_143 -> V_146 . V_205 ) ;
V_143 -> V_165 -> V_166 |= F_31 (
( ( T_3 ) 1 << V_539 ) ) ;
V_143 -> V_165 -> V_166 |=
F_31 ( ( T_3 ) V_496 -> V_540 ) ;
memset ( & V_502 , 0 , sizeof( V_502 ) ) ;
V_502 . V_541 =
F_31 ( ( T_3 ) F_71 ( V_280 -> V_281 -> V_282 ) << 24 ) ;
V_502 . V_542 = V_514 -> V_519 . V_520 ;
V_502 . V_543 [ 0 ] = V_514 -> V_532 ;
V_502 . V_543 [ 1 ] = V_513 -> V_532 ;
V_503 = F_151 ( & V_502 ) ;
V_143 -> V_544 = F_122 ( V_503 ^ 0xffffffff ) ;
F_7 ( V_14 , L_129 ,
V_143 -> V_544 , V_143 -> V_544 & V_498 -> V_545 ) ;
V_143 -> V_544 &= V_498 -> V_545 ;
V_143 -> V_165 -> V_544 = F_31 ( V_143 -> V_544 ) ;
V_2 -> V_3 -> V_402 -> V_272 ( V_2 -> V_3 , V_2 ) ;
F_7 ( V_14 , L_130
L_131
L_132 , V_143 -> V_146 . V_205 ,
F_36 ( V_514 -> V_519 . V_520 ) , F_16 ( V_514 -> V_532 ) ,
F_36 ( V_513 -> V_519 . V_520 ) , F_16 ( V_513 -> V_532 ) ,
F_135 ( V_143 -> V_165 -> V_116 ) ,
F_135 ( V_143 -> V_165 -> V_429 ) ,
V_20 ) ;
V_7 -> V_385 ( V_7 ) ;
F_136 ( & V_143 -> V_330 ) ;
...
V_136 = V_7 -> V_473 ( V_7 , & V_444 ) ;
V_500 . V_547 = V_461 ;
F_152 ( & V_143 -> V_330 , & V_500 , V_548 , NULL ) ;
if ( V_2 -> V_275 ) {
V_2 -> V_275 -> V_54 =
V_143 -> V_376 ;
...
int F_153 ( struct V_194 * V_7 , const void * V_549 , T_1 V_550 )
{
struct V_1 * V_2 ;
struct V_1 * V_274 ;
struct V_130 * V_3 ;
...
return - V_43 ;
if ( V_274 ) {
memcpy ( & V_274 -> V_25 . V_518 , V_549 , V_550 ) ;
V_274 -> V_25 . V_41 = V_550 ;
V_274 -> V_54 = V_550 ;
} else {
V_19 = & V_2 -> V_69 [ 0 ] + sizeof( struct V_36 ) ;
V_2 -> V_54 = V_550 ;
...
return V_3 -> V_402 -> V_552 ( V_3 , V_2 ) ;
}
int F_154 ( struct V_194 * V_7 , struct V_495 * V_496 )
{
struct V_497 * V_330 ;
struct V_140 * V_143 ;
struct V_288 * V_279 ;
...
if ( ! V_280 )
return - V_43 ;
if ( ! V_513 -> V_532 || ! V_514 -> V_532 )
return - V_43 ;
F_7 ( V_14 , L_135
L_136 , V_143 -> V_146 . V_205 ,
F_36 ( V_279 -> V_382 ) , F_36 ( V_514 -> V_519 . V_520 ) ,
F_16 ( V_514 -> V_532 ) , F_36 ( V_513 -> V_519 . V_520 ) ,
F_16 ( V_513 -> V_532 ) ) ;
F_38 ( & V_556 ) ;
V_143 -> V_487 = 1 ;
V_143 -> V_7 = V_7 ;
V_7 -> V_482 = V_143 ;
V_143 -> V_376 = V_496 -> V_376 ;
V_143 -> V_165 -> V_166 |= F_31 ( ( T_3 ) V_496 -> V_540 ) ;
if ( V_496 -> V_540 == 0 )
V_143 -> V_165 -> V_166 |= F_31 ( 1 ) ;
F_7 ( V_14 , L_137 , ( T_3 ) V_496 -> V_540 ) ;
F_7 ( V_14 , L_138 ,
V_496 -> V_376 ) ;
if ( V_513 -> V_519 . V_520 != V_514 -> V_519 . V_520 ) {
F_70 ( V_279 , F_16 ( V_513 -> V_532 ) ,
F_71 ( V_280 -> V_281 -> V_282 ) ,
V_557 ) ;
V_327 = 1 ;
}
V_9 . V_11 = F_23 ( V_513 -> V_519 . V_520 ) ;
V_9 . V_13 = F_22 ( V_513 -> V_532 ) ;
V_9 . V_10 = F_23 ( V_514 -> V_519 . V_520 ) ;
V_9 . V_12 = F_22 ( V_514 -> V_532 ) ;
V_9 . V_7 = V_7 ;
V_9 . V_326 = V_558 ;
V_7 -> V_385 ( V_7 ) ;
V_2 = V_219 -> V_402 -> V_559 ( V_219 , V_279 ,
...
int F_155 ( struct V_194 * V_7 , int V_358 )
{
struct V_288 * V_279 ;
struct V_257 * V_2 ;
struct V_313 V_9 ;
...
struct V_512 * V_513 = (struct V_512 * ) & V_7 -> V_478 ;
F_7 ( V_14 , L_139 ,
V_7 , F_16 ( V_513 -> V_532 ) ) ;
if ( V_7 -> V_478 . V_553 != V_554 )
return - V_555 ;
V_279 = F_140 ( V_7 -> V_456 ) ;
if ( ! V_279 )
return - V_43 ;
F_7 ( V_14 , L_140 ,
V_279 , V_279 -> V_86 , V_279 -> V_86 -> V_516 ) ;
F_7 ( V_14 , L_141 ,
V_279 -> V_382 , V_513 -> V_519 . V_520 ) ;
V_9 . V_11 = V_279 -> V_382 ;
V_9 . V_13 = V_513 -> V_532 ;
V_9 . V_358 = V_358 ;
V_9 . V_7 = V_7 ;
V_9 . V_326 = V_558 ;
V_2 = V_219 -> V_402 -> V_560 ( V_219 , V_279 , & V_9 ) ;
if ( ! V_2 ) {
F_78 ( V_300 L_142 ,
V_301 , __LINE__ ) ;
return - V_27 ;
...
V_7 -> V_482 = V_2 ;
if ( ! V_2 -> V_374 ) {
V_268 = F_70 ( V_279 , F_16 ( V_513 -> V_532 ) ,
F_71 ( V_279 -> V_280 -> V_281 -> V_282 ) ,
V_557 ) ;
if ( V_268 ) {
F_78 ( V_300 L_143 ,
V_268 ) ;
V_219 -> V_402 -> V_561 ( V_219 , ( void * ) V_2 ) ;
return V_268 ;
}
F_38 ( & V_562 ) ;
}
...
int F_156 ( struct V_194 * V_7 )
{
if ( V_7 -> V_482 )
V_219 -> V_402 -> V_561 ( V_219 , V_7 -> V_482 ) ;
else
F_7 ( V_14 , L_144 ) ;
V_7 -> V_200 ( V_7 ) ;
return 0 ;
}
int F_157 ( struct V_15 * V_16 , struct V_296 * V_563 )
{
int V_295 = 0 ;
V_564 ++ ;
if ( ( V_219 ) && ( V_219 -> V_402 ) )
V_295 = V_219 -> V_402 -> V_565 ( V_219 , F_158 ( V_563 ) , V_16 ) ;
else
F_7 ( V_14 , L_145
L_146 ) ;
return V_295 ;
...
V_280 = V_279 -> V_280 ;
V_298 = V_280 -> V_298 ;
V_513 = (struct V_512 * ) & V_7 -> V_478 ;
V_514 = (struct V_512 * ) & V_7 -> V_479 ;
V_567 = (struct V_512 * ) & V_444 . V_478 ;
if ( V_143 -> V_466 )
return;
F_38 ( & V_568 ) ;
F_7 ( V_14 , L_148
L_149 ,
V_143 -> V_146 . V_205 , F_36 ( V_514 -> V_519 . V_520 ) ,
F_16 ( V_514 -> V_532 ) , F_16 ( V_513 -> V_532 ) , V_182 ) ;
F_134 ( V_143 , V_2 ) ;
V_143 -> V_165 -> V_531 [ 0 ] = F_149 ( F_16 ( V_513 -> V_532 ) ) ;
V_143 -> V_165 -> V_531 [ 1 ] = F_149 ( F_16 ( V_514 -> V_532 ) ) ;
V_143 -> V_165 -> V_533 = F_31 ( F_36 ( V_514 -> V_519 . V_520 ) ) ;
...
( T_3 ) F_71 ( V_280 -> V_281 -> V_282 ) <<
V_534 ) ;
V_143 -> V_165 -> V_535 |= F_31 (
F_85 ( V_280 ,
F_135 ( V_143 -> V_165 -> V_533 ) ,
NULL , V_312 ) << 16 ) ;
V_143 -> V_165 -> V_536 = F_31 (
V_182 - F_150 ( V_280 , V_537 ) ) ;
V_143 -> V_165 -> V_538 = F_31 ( V_143 -> V_146 . V_205 ) ;
...
V_143 -> V_544 = F_122 ( V_503 ^ 0xffffffff ) ;
F_7 ( V_14 , L_150 ,
V_143 -> V_544 , V_143 -> V_544 & V_298 -> V_545 ) ;
V_143 -> V_544 &= V_298 -> V_545 ;
V_143 -> V_165 -> V_544 = F_31 ( V_143 -> V_544 ) ;
...
V_444 . V_482 = V_7 -> V_482 ;
V_567 -> V_572 = V_554 ;
V_567 -> V_532 = V_513 -> V_532 ;
V_444 . V_479 = V_7 -> V_479 ;
V_444 . V_377 = ( void * ) V_6 -> V_2 -> V_69 ;
V_444 . V_376 = ( T_1 ) V_6 -> V_2 -> V_54 ;
V_444 . V_573 = V_2 -> V_55 ;
V_444 . V_540 = V_2 -> V_56 ;
V_567 -> V_519 . V_520 = V_6 -> V_9 . V_10 ;
V_136 = V_7 -> V_473 ( V_7 , & V_444 ) ;
F_7 ( V_14 , L_119 , V_136 ) ;
if ( V_136 )
F_78 ( V_300 L_133
...
#ifdef F_163
{
struct V_512 * V_567 = (struct V_512 * )
& V_444 . V_478 ;
struct V_512 * V_574 = (struct V_512 * )
& V_444 . V_479 ;
F_7 ( V_14 , L_154 ,
V_567 -> V_519 . V_520 , V_574 -> V_519 . V_520 ) ;
}
#endif
V_136 = V_7 -> V_473 ( V_7 , & V_444 ) ;
F_7 ( V_14 , L_119 , V_136 ) ;
...
V_567 -> V_572 = V_554 ;
V_567 -> V_532 = F_22 ( V_6 -> V_9 . V_13 ) ;
V_567 -> V_519 . V_520 = F_23 ( V_6 -> V_9 . V_11 ) ;
V_574 -> V_572 = V_554 ;
V_574 -> V_532 = F_22 ( V_6 -> V_9 . V_12 ) ;
V_574 -> V_519 . V_520 = F_23 ( V_6 -> V_9 . V_10 ) ;
...
F_137 ( & V_6 -> V_578 , V_579 ) ;
F_7 ( V_14 , L_161 ,
V_6 -> V_2 , V_6 ) ;
F_138 ( V_6 -> V_2 -> V_3 -> V_404 , & V_6 -> V_578 ) ;
F_7 ( V_14 , L_162 ) ;
return 0 ;
}
static void V_579 ( struct V_441 * V_439 )
{
