...
enum V_328 V_329 , int V_330 )
{
F_2 ( V_39 , V_331 ) ;
int V_8 ;
int V_332 = V_329 == V_333 ? 0 : 1 ;
int V_334 = V_329 == V_335 ? 1 : 0 ;
int V_336 = V_329 == V_335 ? 1000 : 0 ;
T_7 V_337 = V_2 -> V_338 . V_337 ;
T_2 V_339 = V_329 != V_340 ?
V_341 * sizeof( T_3 ) : 0 ;
F_3 ( V_342 != 0 ) ;
F_55 ( V_39 , V_343 , V_337 ) ;
F_56 ( V_39 , V_344 ,
V_345 , ! ! V_334 ,
V_346 , V_330 ,
V_347 , V_332 ,
...
V_350 , 1 ,
V_351 , V_336 ) ;
F_9 ( V_39 , V_352 , V_339 ) ;
V_8 = F_4 ( V_2 , V_353 , V_39 , sizeof( V_39 ) ,
NULL , 0 , NULL ) ;
return V_8 ;
}
void F_57 ( struct V_1 * V_2 )
{
T_8 * V_354 = V_2 -> V_338 . V_56 ;
V_354 [ V_355 ] = V_356 ;
F_54 ( V_2 , V_335 , 0 ) ;
}
...
V_2 -> V_360 = & V_361 ;
V_2 -> V_152 . V_155 = V_157 | V_158 ;
V_2 -> V_152 . V_362 = F_12 ;
V_2 -> V_152 . V_363 = F_14 ;
V_8 = V_2 -> V_360 -> V_364 ( V_2 ) ;
if ( V_8 != 0 )
return V_8 ;
V_8 = F_62 ( V_2 , & V_2 -> V_338 ,
V_341 * sizeof( T_3 ) , V_147 ) ;
if ( V_8 )
return V_8 ;
F_63 ( V_2 , V_364 , V_2 -> V_34 ,
L_5 ,
( T_3 ) V_2 -> V_338 . V_337 ,
V_2 -> V_338 . V_56 ,
( T_3 ) F_64 ( V_2 -> V_338 . V_56 ) ) ;
F_54 ( V_2 , V_340 , 1 ) ;
return 0 ;
}
void F_65 ( struct V_1 * V_2 )
{
V_2 -> V_360 -> remove ( V_2 ) ;
F_66 ( V_2 , & V_2 -> V_338 ) ;
}
...
F_2 ( V_5 , V_365 ) ;
int V_8 ;
V_8 = F_4 ( V_2 , V_366 , NULL , 0 ,
V_5 , sizeof( V_5 ) , NULL ) ;
if ( V_8 )
return V_8 ;
return F_5 ( V_5 , V_367 ) ;
}
