...
static int F_28 ( int V_63 , char * V_64 , char * V_20 , char * V_3 )
{
T_1 * V_65 ;
char V_11 [ V_66 + 1 ] ;
snprintf ( V_11 , V_66 , V_67 L_29 , V_63 ) ;
V_65 = fopen ( V_11 , L_30 ) ;
if ( ! V_65 ) {
V_6 ( L_31 ) ;
return - 1 ;
}
if ( fscanf ( V_65 , L_32 , V_64 , V_20 , V_3 ) != 3 ) {
V_6 ( L_33 ) ;
fclose ( V_65 ) ;
return - 1 ;
}
...
int V_15 ;
char V_50 [ V_26 ] ;
V_18 = (struct V_68 * ) calloc ( 1 , sizeof( * V_18 ) ) ;
if ( ! V_18 ) {
F_3 ( L_11 ) ;
return - 1 ;
}
...
int F_34 ( T_2 V_20 , int V_69 , T_3 V_23 ,
T_3 V_22 ) {
struct V_46 * V_70 ;
char V_71 [ 200 ] ;
int V_15 ;
V_70 = F_22 ( V_18 -> V_35 , L_37 ) ;
if ( ! V_70 ) {
F_3 ( L_38 ,
V_18 -> V_35 -> V_40 ) ;
return - 1 ;
}
snprintf ( V_71 , sizeof( V_71 ) , L_39 ,
V_20 , V_69 , V_23 , V_22 ) ;
F_3 ( L_40 , V_71 ) ;
V_15 = F_35 ( V_70 , V_71 , strlen ( V_71 ) ) ;
if ( V_15 < 0 ) {
F_3 ( L_41 ) ;
return - 1 ;
}
...
static unsigned long F_36 ( T_2 V_27 , T_2 V_28 )
{
return ( V_27 << 16 ) | V_28 ;
}
int F_37 ( T_2 V_20 , int V_69 , T_2 V_27 ,
T_2 V_28 , T_3 V_22 )
{
int V_23 = F_36 ( V_27 , V_28 ) ;
return F_34 ( V_20 , V_69 , V_23 , V_22 ) ;
}
int F_38 ( T_2 V_20 )
{
struct V_46 * V_72 ;
char V_71 [ 200 ] ;
int V_15 ;
V_72 = F_22 ( V_18 -> V_35 , L_43 ) ;
if ( ! V_72 ) {
F_3 ( L_44 ,
V_18 -> V_35 -> V_40 ) ;
return - 1 ;
}
snprintf ( V_71 , sizeof( V_71 ) , L_45 , V_20 ) ;
F_3 ( L_40 , V_71 ) ;
V_15 = F_35 ( V_72 , V_71 , strlen ( V_71 ) ) ;
if ( V_15 < 0 ) {
F_3 ( L_41 ) ;
return - 1 ;
}
...
return 0 ;
V_15 = F_28 ( V_2 -> V_20 , V_64 , V_75 , V_77 ) ;
if ( V_15 ) {
V_6 ( L_49 ) ;
V_78 = 1 ;
}
printf ( L_50 , V_2 -> V_20 ,
F_40 ( V_2 -> V_21 ) ,
F_41 ( V_2 -> V_7 . V_22 ) ) ;
F_42 ( V_73 , sizeof( V_73 ) ,
V_2 -> V_7 . V_79 , V_2 -> V_7 . V_80 ) ;
printf ( L_51 , V_73 ) ;
if ( ! V_78 ) {
printf ( L_52 , V_2 -> V_7 . V_3 ,
V_64 , V_75 , V_77 ) ;
printf ( L_53 , L_54 ,
V_2 -> V_27 , V_2 -> V_28 ) ;
} else {
