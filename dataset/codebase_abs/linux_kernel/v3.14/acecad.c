...
F_3 ( V_7 , V_18 , V_11 ) ;
if ( V_11 ) {
int V_19 = V_5 [ 1 ] | ( V_5 [ 2 ] << 8 ) ;
int V_20 = V_5 [ 3 ] | ( V_5 [ 4 ] << 8 ) ;
int V_21 = V_5 [ 5 ] | ( V_5 [ 6 ] << 8 ) ;
int V_22 = V_5 [ 0 ] & 0x01 ;
int V_23 = ( V_5 [ 0 ] & 0x10 ) >> 4 ;
int V_24 = ( V_5 [ 0 ] & 0x20 ) >> 5 ;
F_4 ( V_7 , V_25 , V_19 ) ;
F_4 ( V_7 , V_26 , V_20 ) ;
F_4 ( V_7 , V_27 , V_21 ) ;
F_3 ( V_7 , V_28 , V_22 ) ;
...
V_3 -> V_36 -> V_7 = V_3 -> V_32 ;
if ( F_6 ( V_3 -> V_36 , V_37 ) )
return - V_38 ;
return 0 ;
}
...
static int F_12 ( struct V_9 * V_10 , const struct V_39 * V_40 )
{
struct V_41 * V_7 = F_13 ( V_10 ) ;
...
V_3 = F_18 ( sizeof( struct V_2 ) , V_37 ) ;
V_6 = F_19 () ;
if ( ! V_3 || ! V_6 ) {
V_49 = - V_54 ;
goto V_55;
}
V_3 -> V_5 = F_20 ( V_7 , 8 , V_37 , & V_3 -> V_56 ) ;
if ( ! V_3 -> V_5 ) {
V_49 = - V_54 ;
goto V_55;
}
V_3 -> V_36 = F_21 ( 0 , V_37 ) ;
if ( ! V_3 -> V_36 ) {
V_49 = - V_54 ;
goto V_57;
}
...
V_6 -> V_68 [ F_28 ( V_69 ) ] = F_27 ( V_18 ) |
F_27 ( V_28 ) | F_27 ( V_29 ) |
F_27 ( V_30 ) ;
switch ( V_40 -> V_70 ) {
case 0 :
F_29 ( V_6 , V_25 , 0 , 5000 , 4 , 0 ) ;
F_29 ( V_6 , V_26 , 0 , 3750 , 4 , 0 ) ;
F_29 ( V_6 , V_27 , 0 , 512 , 0 , 0 ) ;
if ( ! strlen ( V_3 -> V_59 ) )
...
break;
case 1 :
F_29 ( V_6 , V_25 , 0 , 53000 , 4 , 0 ) ;
F_29 ( V_6 , V_26 , 0 , 2250 , 4 , 0 ) ;
F_29 ( V_6 , V_27 , 0 , 1024 , 0 , 0 ) ;
if ( ! strlen ( V_3 -> V_59 ) )
snprintf ( V_3 -> V_59 , sizeof( V_3 -> V_59 ) ,
L_7 ,
F_30 ( V_7 -> V_71 . V_72 ) ,
...
F_31 ( V_3 -> V_36 , V_7 , V_47 ,
V_3 -> V_5 , V_48 > 8 ? 8 : V_48 ,
F_1 , V_3 , V_46 -> V_74 ) ;
V_3 -> V_36 -> V_75 = V_3 -> V_56 ;
V_3 -> V_36 -> V_76 |= V_77 ;
V_49 = F_32 ( V_3 -> V_8 ) ;
if ( V_49 )
goto V_78;
...
F_40 ( V_3 -> V_8 ) ;
F_34 ( V_3 -> V_36 ) ;
F_35 ( V_3 -> V_32 , 8 , V_3 -> V_5 , V_3 -> V_56 ) ;
F_37 ( V_3 ) ;
}
