...
T_6 * V_501 = ( T_6 * ) & ( V_454 -> V_502 -> V_503 ) ;
memcpy ( V_501 , V_454 -> V_504 , V_500 ) ;
}
F_223 ( V_454 ) ;
} else
V_454 -> V_455 = 0 ;
...
{
enum V_506 * V_457 = V_454 -> V_457 ;
* V_457 = V_507 ;
if ( V_454 -> V_353 == V_493 )
* V_457 = V_508 ;
else if ( V_454 -> V_353 == V_496 ) {
union V_509 V_510 ;
struct V_487 * V_502 = (struct V_487 * ) V_454 -> V_504 ;
T_10 V_511 = ( V_502 -> V_503 . V_512 [ 4 ] & 0x3 ) << 7 |
( V_502 -> V_503 . V_512 [ 5 ] >> 1 ) ;
V_510 . V_513 = V_502 -> V_503 . V_512 [ 0 ] ;
F_3 ( V_454 , V_510 . V_513 ) ;
F_3 ( V_454 , V_511 ) ;
if ( ( V_511 & V_514 ) ||
( V_511 & V_515 ) ||
( V_511 & V_516 ) )
...
( V_511 & V_526 ) )
* V_457 = V_527 ;
else if ( V_510 . V_528 . V_529 )
* V_457 = V_527 ;
else if ( V_510 . V_528 . V_530 && V_510 . V_528 . V_531 )
* V_457 = V_523 ;
else if ( V_510 . V_528 . V_532 )
* V_457 = V_507 ;
else
F_3 ( V_454 , 0 ) ;
} else
...
{
struct V_487 * V_502 = (struct V_487 * ) V_454 -> V_504 ;
struct V_534 * V_512 = (struct V_534 * ) V_502 -> V_503 . V_512 ;
union V_535 V_536 = V_512 -> V_536 ;
union V_509 V_510 = V_512 -> V_510 ;
if ( V_456 == V_537 ) {
if ( V_510 . V_528 . V_529 || V_510 . V_528 . V_531 )
return V_34 ;
else {
F_3 ( V_454 , V_510 . V_513 ) ;
return V_538 ;
...
V_454 -> V_504 = V_277 ;
V_454 -> V_488 = V_278 ;
memset ( V_454 -> V_504 , 0 , sizeof( struct V_487 ) ) ;
...
T_4
F_240 ( struct V_453 * V_454 , enum V_506 * V_457 ,
T_12 V_18 , void * V_98 )
{
if ( ! F_131 ( V_454 -> V_2 ) ) {
F_3 ( V_454 , 0 ) ;
...
memcpy ( V_565 -> V_504 , V_565 -> V_579 + V_565 -> V_376 , V_158 ) ;
F_153 ( V_565 -> V_2 , & V_565 -> V_435 ) ;
V_565 -> V_574 -= V_158 ;
V_565 -> V_376 += V_158 ;
}
...
V_596 = (struct V_570 * ) V_565 -> V_504 ;
...
* ( ( T_1 * ) V_621 -> V_623 . V_504 + V_61 ) = V_621 -> V_623 . V_639 ;
...
for ( V_61 = 0 ; V_61 < ( V_638 >> 2 ) ; V_61 ++ ) {
if ( * ( ( T_1 * ) V_621 -> V_623 . V_504 + V_61 ) != V_648 ) {
F_3 ( V_621 , V_61 ) ;
F_3 ( V_621 , V_648 ) ;
F_3 ( V_621 ,
* ( ( T_1 * ) V_621 -> V_623 . V_504 + V_61 ) ) ;
V_621 -> V_623 . V_628 -> V_649 =
V_650 ;
V_621 -> V_623 . V_142 = V_650 ;
V_621 -> V_623 . V_18 ( V_621 -> V_623 . V_98 ,
...
{
V_621 -> V_623 . V_504 = V_277 ;
V_621 -> V_623 . V_488 = V_278 ;
memset ( V_621 -> V_623 . V_504 , 0 , V_638 ) ;
}
static void
...
F_276 ( ( T_1 * ) V_196 , ( T_1 * ) V_694 -> V_504 ,
sizeof( struct V_699 ) ) ;
...
F_276 ( ( T_1 * ) V_289 , ( T_1 * ) V_694 -> V_504 ,
sizeof( struct V_708 ) ) ;
...
memcpy ( V_761 -> V_504 , V_761 -> V_579 + V_761 -> V_376 , V_158 ) ;
...
F_3 ( V_761 , V_761 -> V_376 ) ;
F_3 ( V_761 , V_158 ) ;
memcpy ( V_761 -> V_579 + V_761 -> V_376 , V_761 -> V_504 , V_158 ) ;
V_761 -> V_574 -= V_158 ;
V_761 -> V_376 += V_158 ;
if ( V_761 -> V_574 == 0 ) {
V_761 -> V_142 = V_142 ;
