...
V_89 [ V_105 ] += ( T_1 ) ( ( V_149 -> V_188 . V_189 >> 8 ) & 0xffffffff ) ;
break;
case V_190 :
...
V_89 [ V_105 ] &= ~ F_75 ( 0xf ) ;
V_13 -> V_33 &= ~ F_75 ( 0xf ) ;
V_89 [ V_105 ] |= F_75 ( F_1 ( V_149 -> V_188 . V_1 ) ) ;
V_13 -> V_33 |= F_75 ( F_1 ( V_149 -> V_188 . V_1 ) ) ;
if ( V_149 -> V_188 . V_1 & V_2 ) {
unsigned V_75 , V_78 , V_196 , V_197 ;
F_76 ( V_149 -> V_188 . V_1 ,
& V_75 , & V_78 , & V_196 ,
& V_197 ) ;
V_89 [ V_105 ] |= F_77 ( F_2 ( V_13 -> V_7 ) ) ;
V_89 [ V_105 ] |= F_78 ( V_197 ) |
F_79 ( V_75 ) |
F_80 ( V_78 ) |
F_81 ( V_196 ) ;
}
...
V_89 [ V_105 ] |= F_82 ( F_1 ( V_149 -> V_188 . V_1 ) ) ;
V_13 -> V_21 [ V_91 ] |= F_82 ( F_1 ( V_149 -> V_188 . V_1 ) ) ;
}
V_13 -> V_28 = true ;
break;
case V_244 :
...
V_89 [ V_105 ] |= F_84 ( V_197 ) |
F_85 ( V_75 ) |
F_86 ( V_78 ) |
F_87 ( V_196 ) ;
}
}
V_91 = ( ( V_145 - V_272 ) / 0x3c ) ;
...
V_91 = ( V_145 - V_316 ) / 0x3c ;
V_13 -> V_20 [ V_91 ] = F_43 ( V_53 , V_105 ) ;
V_89 [ V_105 ] += ( T_1 ) ( ( V_149 -> V_188 . V_189 >> 8 ) & 0xffffffff ) ;
V_13 -> V_19 [ V_91 ] = V_149 -> V_203 ;
V_13 -> V_28 = true ;
break;
case V_324 :
case V_325 :
...
unsigned V_105 ;
unsigned V_14 ;
unsigned V_433 , V_434 , V_145 ;
int V_87 ;
T_1 V_435 ;
V_13 = (struct V_12 * ) V_53 -> V_13 ;
V_89 = V_53 -> V_89 . V_90 ;
V_105 = V_144 -> V_105 + 1 ;
V_435 = F_43 ( V_53 , V_105 ) ;
switch ( V_144 -> V_436 ) {
case V_437 :
{
int V_438 ;
...
V_89 [ V_105 + 0 ] = V_435 + ( T_1 ) ( V_149 -> V_188 . V_189 & 0xffffffff ) ;
V_87 = F_63 ( V_53 ) ;
if ( V_87 ) {
F_7 ( V_53 -> V_66 , L_65 , V_67 , __LINE__ ) ;
return V_87 ;
...
case V_455 :
{
T_1 V_456 , V_93 , V_457 ;
T_2 V_86 , V_91 ;
if ( V_144 -> V_147 != 4 ) {
F_64 ( L_78 ) ;
return - V_68 ;
}
V_456 = F_43 ( V_53 , V_105 + 4 ) ;
V_93 = V_456 & 0x1fffff ;
V_457 = F_43 ( V_53 , V_105 + 1 ) ;
if ( ( ( ( V_457 & 0x60000000 ) >> 29 ) != 0 ) ||
( ( ( V_457 & 0x00300000 ) >> 20 ) != 0 ) ||
( ( ( ( V_457 & 0x00300000 ) >> 20 ) == 0 ) &&
( V_456 & V_458 ) ) ||
( ( ( ( V_457 & 0x60000000 ) >> 29 ) == 0 ) &&
( V_456 & V_459 ) ) ) {
if ( V_93 % 4 ) {
F_64 ( L_79 ) ;
return - V_68 ;
...
( ( T_2 ) ( F_43 ( V_53 , V_105 + 1 ) & 0xff ) << 32 ) ;
V_86 = V_149 -> V_188 . V_189 + V_91 ;
if ( ( V_91 + V_93 ) > F_23 ( V_149 -> V_203 ) ) {
F_7 ( V_53 -> V_66 , L_83 ,
V_91 + V_93 , F_23 ( V_149 -> V_203 ) ) ;
return - V_68 ;
}
V_89 [ V_105 ] = V_86 ;
V_89 [ V_105 + 1 ] = ( V_89 [ V_105 + 1 ] & 0xffffff00 ) | ( F_91 ( V_86 ) & 0xff ) ;
} else if ( ( ( V_457 & 0x60000000 ) >> 29 ) != 2 ) {
F_64 ( L_84 ) ;
return - V_68 ;
}
}
if ( V_456 & V_458 ) {
if ( ( ( V_457 & 0x00300000 ) >> 20 ) != 1 ) {
F_64 ( L_85 ) ;
return - V_68 ;
}
} else {
...
V_89 [ V_105 + 2 ] += ( T_1 ) ( ( V_149 -> V_188 . V_189 >> 8 ) & 0xffffffff ) ;
}
break;
case V_463 :
...
F_93 ( F_1 ( V_149 -> V_188 . V_1 ) ) ;
if ( V_149 -> V_188 . V_1 & V_2 ) {
unsigned V_75 , V_78 , V_196 , V_197 ;
F_76 ( V_149 -> V_188 . V_1 ,
& V_75 , & V_78 , & V_196 ,
& V_197 ) ;
V_89 [ V_105 + 1 + ( V_14 * 8 ) + 6 ] |= F_94 ( V_197 ) ;
...
V_103 = V_149 -> V_203 ;
V_106 = ( T_1 ) ( ( V_149 -> V_188 . V_189 >> 8 ) & 0xffffffff ) ;
V_476 = V_89 [ V_105 + 1 + ( V_14 * 8 ) + 0 ] & 0x7 ;
V_475 = V_89 [ V_105 + 1 + ( V_14 * 8 ) + 3 ] ;
if ( ( V_476 == V_478 || V_476 == V_479 ) &&
! V_475 &&
! F_99 ( V_53 ) ) {
V_107 = 0 ;
V_104 = NULL ;
...
V_107 = ( T_1 ) ( ( V_149 -> V_188 . V_189 >> 8 ) & 0xffffffff ) ;
V_104 = V_149 -> V_203 ;
}
...
if ( V_53 -> V_152 && ( V_93 + V_86 ) > F_23 ( V_149 -> V_203 ) ) {
F_7 ( V_53 -> V_66 , L_99 ) ;
V_89 [ V_105 + 1 + ( V_14 * 8 ) + 1 ] = F_23 ( V_149 -> V_203 ) - V_86 ;
}
V_481 = V_149 -> V_188 . V_189 + V_86 ;
V_89 [ V_105 + 1 + ( V_14 * 8 ) + 0 ] = V_481 ;
...
if ( ( V_86 + 4 ) > F_23 ( V_149 -> V_203 ) ) {
F_64 ( L_106 ,
V_86 + 4 , F_23 ( V_149 -> V_203 ) ) ;
return - V_68 ;
}
V_86 += V_149 -> V_188 . V_189 ;
V_89 [ V_105 + 1 ] = V_86 ;
...
if ( ( V_86 + 8 ) > F_23 ( V_149 -> V_203 ) ) {
F_64 ( L_112 ,
V_86 + 8 , F_23 ( V_149 -> V_203 ) ) ;
return - V_68 ;
}
V_86 += V_149 -> V_188 . V_189 ;
V_89 [ V_105 + 0 ] = V_86 ;
...
int V_87 ;
if ( V_53 -> V_13 == NULL ) {
V_13 = F_101 ( sizeof( * V_13 ) , V_501 ) ;
if ( V_13 == NULL )
return - V_502 ;
F_3 ( V_13 ) ;
if ( V_53 -> V_152 -> V_114 >= V_153 )
V_91 = V_53 -> V_152 -> V_503 . V_504 . V_505 ;
else
V_91 = V_53 -> V_152 -> V_503 . V_506 . V_505 ;
switch ( V_91 & 0xf ) {
case 0 :
V_13 -> V_76 = 1 ;
break;
...
} while ( V_53 -> V_105 < V_53 -> V_511 [ V_53 -> V_512 ] . V_513 );
#if 0
...
{
struct V_514 * V_515 = & V_53 -> V_511 [ V_53 -> V_512 ] ;
struct V_148 * V_516 , * V_517 , * V_518 ;
T_1 V_519 , V_520 , V_147 , V_521 ;
volatile T_1 * V_89 = V_53 -> V_89 . V_90 ;
T_1 V_105 ;
T_2 V_522 , V_523 , V_524 ;
int V_87 ;
do {
if ( V_53 -> V_105 >= V_515 -> V_513 ) {
F_64 ( L_120 ,
V_53 -> V_105 , V_515 -> V_513 ) ;
return - V_68 ;
}
V_105 = V_53 -> V_105 ;
V_519 = F_43 ( V_53 , V_105 ) ;
V_520 = F_105 ( V_519 ) ;
V_147 = F_106 ( V_519 ) ;
V_521 = F_107 ( V_519 ) ;
switch ( V_520 ) {
...
switch ( V_521 ) {
case 8 :
V_523 = F_43 ( V_53 , V_105 + 1 ) ;
V_523 <<= 8 ;
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_517 -> V_188 . V_189 >> 8 ) ;
V_53 -> V_105 += V_147 + 7 ;
break;
case 0 :
V_523 = F_43 ( V_53 , V_105 + 1 ) ;
V_523 |= ( ( T_2 ) ( F_43 ( V_53 , V_105 + 2 ) & 0xff ) ) << 32 ;
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_517 -> V_188 . V_189 & 0xfffffffc ) ;
V_89 [ V_105 + 2 ] += F_91 ( V_517 -> V_188 . V_189 ) & 0xff ;
V_53 -> V_105 += V_147 + 3 ;
break;
default:
F_64 ( L_122 , V_105 , V_519 ) ;
return - V_68 ;
}
if ( ( V_523 + ( V_147 * 4 ) ) > F_23 ( V_517 -> V_203 ) ) {
F_7 ( V_53 -> V_66 , L_123 ,
V_523 , F_23 ( V_517 -> V_203 ) ) ;
return - V_68 ;
}
break;
case V_526 :
...
V_523 = F_43 ( V_53 , V_105 + 1 ) ;
V_523 |= ( ( T_2 ) ( F_43 ( V_53 , V_105 + 3 ) & 0xff ) ) << 32 ;
if ( ( V_522 + ( V_147 * 4 ) ) > F_23 ( V_516 -> V_203 ) ) {
F_7 ( V_53 -> V_66 , L_125 ,
V_522 + ( V_147 * 4 ) , F_23 ( V_516 -> V_203 ) ) ;
return - V_68 ;
}
if ( ( V_523 + ( V_147 * 4 ) ) > F_23 ( V_517 -> V_203 ) ) {
F_7 ( V_53 -> V_66 , L_126 ,
V_523 + ( V_147 * 4 ) , F_23 ( V_517 -> V_203 ) ) ;
return - V_68 ;
}
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_517 -> V_188 . V_189 & 0xfffffffc ) ;
V_89 [ V_105 + 2 ] += ( T_1 ) ( V_516 -> V_188 . V_189 & 0xfffffffc ) ;
V_89 [ V_105 + 3 ] += F_91 ( V_517 -> V_188 . V_189 ) & 0xff ;
V_89 [ V_105 + 4 ] += F_91 ( V_516 -> V_188 . V_189 ) & 0xff ;
V_53 -> V_105 += 5 ;
break;
case 0x08 :
...
V_522 <<= 8 ;
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_516 -> V_188 . V_189 >> 8 ) ;
V_523 = F_43 ( V_53 , V_105 + 7 ) ;
V_523 |= ( ( T_2 ) ( F_43 ( V_53 , V_105 + 8 ) & 0xff ) ) << 32 ;
V_89 [ V_105 + 7 ] += ( T_1 ) ( V_517 -> V_188 . V_189 & 0xfffffffc ) ;
V_89 [ V_105 + 8 ] += F_91 ( V_517 -> V_188 . V_189 ) & 0xff ;
} else {
V_522 = F_43 ( V_53 , V_105 + 7 ) ;
V_522 |= ( ( T_2 ) ( F_43 ( V_53 , V_105 + 8 ) & 0xff ) ) << 32 ;
V_89 [ V_105 + 7 ] += ( T_1 ) ( V_516 -> V_188 . V_189 & 0xfffffffc ) ;
V_89 [ V_105 + 8 ] += F_91 ( V_516 -> V_188 . V_189 ) & 0xff ;
V_523 = F_43 ( V_53 , V_105 + 1 ) ;
V_523 <<= 8 ;
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_517 -> V_188 . V_189 >> 8 ) ;
}
...
V_523 = F_43 ( V_53 , V_105 + 1 ) ;
V_523 |= ( ( T_2 ) ( F_43 ( V_53 , V_105 + 3 ) & 0xff ) ) << 32 ;
if ( ( V_522 + V_147 ) > F_23 ( V_516 -> V_203 ) ) {
F_7 ( V_53 -> V_66 , L_129 ,
V_522 + V_147 , F_23 ( V_516 -> V_203 ) ) ;
return - V_68 ;
}
if ( ( V_523 + V_147 ) > F_23 ( V_517 -> V_203 ) ) {
F_7 ( V_53 -> V_66 , L_130 ,
V_523 + V_147 , F_23 ( V_517 -> V_203 ) ) ;
return - V_68 ;
}
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_517 -> V_188 . V_189 & 0xffffffff ) ;
V_89 [ V_105 + 2 ] += ( T_1 ) ( V_516 -> V_188 . V_189 & 0xffffffff ) ;
V_89 [ V_105 + 3 ] += F_91 ( V_517 -> V_188 . V_189 ) & 0xff ;
V_89 [ V_105 + 4 ] += F_91 ( V_516 -> V_188 . V_189 ) & 0xff ;
V_53 -> V_105 += 5 ;
break;
...
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_516 -> V_188 . V_189 & 0xffffffff ) ;
V_89 [ V_105 + 2 ] += F_91 ( V_516 -> V_188 . V_189 ) & 0xff ;
V_89 [ V_105 + 4 ] += ( T_1 ) ( V_517 -> V_188 . V_189 & 0xffffffff ) ;
V_89 [ V_105 + 5 ] += F_91 ( V_517 -> V_188 . V_189 ) & 0xff ;
V_53 -> V_105 += 9 ;
break;
case 0x44 :
V_87 = F_108 ( V_53 , & V_518 ) ;
if ( V_87 ) {
F_64 ( L_132 ) ;
return - V_68 ;
}
V_523 = F_43 ( V_53 , V_105 + 1 ) ;
V_523 |= ( ( T_2 ) ( F_43 ( V_53 , V_105 + 4 ) & 0xff ) ) << 32 ;
V_524 = F_43 ( V_53 , V_105 + 2 ) ;
V_524 |= ( ( T_2 ) ( F_43 ( V_53 , V_105 + 5 ) & 0xff ) ) << 32 ;
V_522 = F_43 ( V_53 , V_105 + 3 ) ;
V_522 |= ( ( T_2 ) ( F_43 ( V_53 , V_105 + 6 ) & 0xff ) ) << 32 ;
if ( ( V_522 + ( V_147 * 4 ) ) > F_23 ( V_516 -> V_203 ) ) {
F_7 ( V_53 -> V_66 , L_133 ,
V_522 + ( V_147 * 4 ) , F_23 ( V_516 -> V_203 ) ) ;
return - V_68 ;
...
if ( ( V_524 + ( V_147 * 4 ) ) > F_23 ( V_518 -> V_203 ) ) {
F_7 ( V_53 -> V_66 , L_135 ,
V_524 + ( V_147 * 4 ) , F_23 ( V_518 -> V_203 ) ) ;
return - V_68 ;
}
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_517 -> V_188 . V_189 & 0xfffffffc ) ;
V_89 [ V_105 + 2 ] += ( T_1 ) ( V_518 -> V_188 . V_189 & 0xfffffffc ) ;
V_89 [ V_105 + 3 ] += ( T_1 ) ( V_516 -> V_188 . V_189 & 0xfffffffc ) ;
V_89 [ V_105 + 4 ] += F_91 ( V_517 -> V_188 . V_189 ) & 0xff ;
V_89 [ V_105 + 5 ] += F_91 ( V_518 -> V_188 . V_189 ) & 0xff ;
V_89 [ V_105 + 6 ] += F_91 ( V_516 -> V_188 . V_189 ) & 0xff ;
V_53 -> V_105 += 7 ;
break;
case 0x48 :
if ( F_43 ( V_53 , V_105 + 2 ) & ( 1 << 31 ) ) {
...
V_524 = F_43 ( V_53 , V_105 + 2 ) ;
V_524 <<= 8 ;
V_522 = F_43 ( V_53 , V_105 + 8 ) ;
V_522 |= ( ( T_2 ) ( F_43 ( V_53 , V_105 + 9 ) & 0xff ) ) << 32 ;
if ( ( V_522 + ( V_147 * 4 ) ) > F_23 ( V_516 -> V_203 ) ) {
F_7 ( V_53 -> V_66 , L_137 ,
V_522 + ( V_147 * 4 ) , F_23 ( V_516 -> V_203 ) ) ;
return - V_68 ;
...
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_517 -> V_188 . V_189 >> 8 ) ;
V_89 [ V_105 + 2 ] += ( T_1 ) ( V_518 -> V_188 . V_189 >> 8 ) ;
V_89 [ V_105 + 8 ] += ( T_1 ) ( V_516 -> V_188 . V_189 & 0xfffffffc ) ;
V_89 [ V_105 + 9 ] += F_91 ( V_516 -> V_188 . V_189 ) & 0xff ;
V_53 -> V_105 += 10 ;
break;
case 0x49 :
if ( V_53 -> V_114 < V_153 ) {
...
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_516 -> V_188 . V_189 >> 8 ) ;
V_89 [ V_105 + 4 ] += ( T_1 ) ( V_517 -> V_188 . V_189 >> 8 ) ;
V_53 -> V_105 += 13 ;
break;
case 0x4f :
if ( F_43 ( V_53 , V_105 + 2 ) & ( 1 << 31 ) ) {
...
V_523 = F_43 ( V_53 , V_105 + 1 ) ;
V_523 |= ( ( T_2 ) ( F_43 ( V_53 , V_105 + 3 ) & 0x00ff0000 ) ) << 16 ;
if ( ( V_523 + ( V_147 * 4 ) ) > F_23 ( V_517 -> V_203 ) ) {
F_7 ( V_53 -> V_66 , L_148 ,
V_523 , F_23 ( V_517 -> V_203 ) ) ;
return - V_68 ;
...
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_517 -> V_188 . V_189 & 0xfffffffc ) ;
V_89 [ V_105 + 3 ] += ( F_91 ( V_517 -> V_188 . V_189 ) << 16 ) & 0x00ff0000 ;
V_53 -> V_105 += 4 ;
break;
case V_528 :
V_53 -> V_105 += 1 ;
...
static int F_110 ( struct V_603 * V_152 ,
T_1 * V_89 , struct V_143 * V_144 )
{
T_1 V_105 = V_144 -> V_105 + 1 ;
T_1 V_435 = V_89 [ V_105 ] ;
T_1 V_433 , V_434 , V_145 , V_14 ;
T_1 V_456 , V_457 ;
switch ( V_144 -> V_436 ) {
case V_500 :
case V_604 :
...
for ( V_14 = 0 ; V_14 < ( V_456 & 0x1fffff ) ; V_14 ++ ) {
V_145 = V_433 + ( 4 * V_14 ) ;
if ( ! F_109 ( V_145 ) ) {
F_64 ( L_151 ) ;
return - V_68 ;
...
int F_111 ( struct V_603 * V_152 , struct V_617 * V_89 )
{
int V_618 = 0 ;
T_1 V_105 = 0 ;
struct V_143 V_144 ;
...
break;
case V_510 :
V_144 . V_436 = F_114 ( V_89 -> V_90 [ V_105 ] ) ;
V_618 = F_110 ( V_152 , V_89 -> V_90 , & V_144 ) ;
V_105 += V_144 . V_147 + 2 ;
break;
default:
...
if ( V_618 )
break;
} while ( V_105 < V_89 -> V_513 );
return V_618 ;
}
int F_115 ( struct V_603 * V_152 , struct V_617 * V_89 )
{
T_1 V_105 = 0 ;
T_1 V_519 , V_520 , V_147 , V_521 ;
do {
V_519 = V_89 -> V_90 [ V_105 ] ;
V_520 = F_105 ( V_519 ) ;
V_147 = F_106 ( V_519 ) ;
V_521 = F_107 ( V_519 ) ;
switch ( V_520 ) {
