...
if ( V_2 -> V_13 [ V_20 ] <= V_33 ) {
V_2 -> V_13 [ V_20 ] = V_32 [ V_20 ] ;
F_13 ( V_2 -> V_13 [ V_20 ] , V_15 -> V_34 ) ;
}
}
F_14 ( V_35 , V_15 -> V_34 ) ;
sprintf ( V_2 -> V_36 , V_37 ) ;
sprintf ( V_2 -> V_38 , L_3 ) ;
V_15 -> V_36 = V_2 -> V_36 ;
V_15 -> V_38 = V_2 -> V_38 ;
V_15 -> V_19 . V_39 = V_40 ;
V_15 -> V_19 . V_41 = 0x0001 ;
V_15 -> V_19 . V_42 = 0x0001 ;
V_15 -> V_19 . V_43 = 0x0100 ;
V_2 -> V_11 = F_1 ( V_2 ) ;
V_21 = F_15 ( V_7 -> V_8 , NULL , F_4 ,
V_44 | V_45 ,
V_37 , V_2 ) ;
if ( V_21 ) {
...
static int F_24 ( struct V_48 * V_23 )
{
struct V_17 * V_7 = F_25 ( V_23 ) ;
F_26 ( V_7 -> V_8 ) ;
return 0 ;
}
static int F_27 ( struct V_48 * V_23 )
{
struct V_17 * V_7 = F_25 ( V_23 ) ;
F_28 ( V_7 -> V_8 ) ;
return 0 ;
