...
static int T_7 F_45 ( const T_8 * V_82 ,
int * V_97 , T_3 * V_98 )
{
int V_83 ;
T_9 * V_84 ;
...
static int T_7 F_46 ( const T_8 * V_82 , char * V_99 )
{
int V_83 , V_50 = 0 ;
T_9 * V_84 ;
V_84 = ( T_9 * ) ( V_82 + 1 ) ;
...
static int T_7 F_47 ( char * V_100 , T_2 * V_78 ,
char * * V_99 , T_2 * V_57 )
{
...
if ( V_50 < 0 )
return V_50 ;
V_50 = F_45 ( V_82 , & V_97 , & V_102 ) ;
if ( V_50 < 0 )
return V_50 ;
* V_57 = F_48 ( V_102 , V_13 ) ;
* V_99 = F_30 ( * V_57 ) ;
if ( ! * V_99 )
return - V_55 ;
V_50 = F_46 ( V_82 , * V_99 ) ;
...
static int T_7 F_50 ( const T_11 * V_82 ,
int * V_97 , T_3 * V_98 )
{
int V_83 ;
T_12 * V_84 ;
...
static int T_7 F_51 ( const T_11 * V_82 , char * V_99 )
{
int V_83 , V_50 = 0 ;
T_12 * V_84 ;
V_84 = ( T_12 * ) ( V_82 + 1 ) ;
...
static int T_7 F_52 ( char * V_100 , T_2 * V_78 ,
char * * V_99 , T_2 * V_57 )
{
int V_83 , V_97 = 0 , V_50 = 0 ;
char * V_12 ;
...
static int T_7 F_53 ( char * V_100 ,
T_2 V_78 ,
T_2 V_35 ,
struct V_80 * V_81 )
{
...
V_110 -> V_38 = V_29 ;
V_110 -> V_15 = V_15 ;
F_55 ( & V_110 -> V_112 , V_81 ) ;
V_84 -> V_94 = V_109 + ( V_38 - V_29 ) ;
V_109 = V_109 + V_15 ;
}
return 0 ;
}
static int T_7 F_56 ( char * V_100 ,
T_2 V_78 ,
T_2 V_35 ,
struct V_80 * V_81 )
{
...
static void T_7 F_57 ( T_2 V_78 , T_2 V_35 ,
struct V_80 * V_81 )
{
T_5 V_109 ;
struct V_30 * V_31 ;
...
{
F_59 ( ( unsigned long ) V_34 , F_60 ( V_113 ) ) ;
V_34 = NULL ;
F_61 ( V_37 ) ;
V_37 = NULL ;
}
...
F_9 ( V_115 ) ;
V_115 = V_133 ;
V_134 = F_70 ( L_6 , V_135 , NULL , & V_136 ) ;
if ( V_134 )
V_134 -> V_15 = V_32 ;
return 0 ;
}
