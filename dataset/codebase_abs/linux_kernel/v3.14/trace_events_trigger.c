...
if ( ! V_2 -> V_62 ) {
F_53 ( V_106 -> V_7 , 0 , 1 ) ;
F_102 ( V_106 -> V_7 -> V_91 -> V_113 ) ;
F_1 ( V_2 ) ;
F_3 ( V_106 ) ;
}
}
static int
F_103 ( struct V_28 * V_3 ,
struct V_6 * V_7 ,
char * V_71 , char * V_55 , char * V_76 )
{
struct V_6 * V_114 ;
...
static T_5 void F_110 ( void )
{
F_43 ( & V_123 ) ;
F_43 ( & V_124 ) ;
}
static T_5 int F_111 ( void )
{
int V_35 ;
V_35 = F_41 ( & V_123 ) ;
if ( F_90 ( V_35 < 0 ) )
