...
V_2 = F_124 ( V_15 , V_245 , V_244 -> V_252 , V_79 ,
V_95 & V_249 ) ;
if ( V_2 >= 0 )
V_2 = V_79 ;
V_17:
...
static int F_125 ( struct V_241 * V_242 , struct V_189 * V_14 ,
...
V_2 = F_127 ( V_57 , sizeof( struct V_59 ) , V_244 -> V_252 ,
V_254 ) ;
if ( V_2 )
goto V_256;
if ( V_57 -> V_257 . V_258 )
...
F_72 ( V_282 ) ;
V_146 = F_141 ( V_283 , F_119 ) ;
if ( ! V_146 )
F_72 ( V_284 ) ;
V_149 = F_142 ( V_285 , F_119 ) ;
if ( ! V_149 )
F_72 ( V_286 ) ;
F_143 ( & V_287 ) ;
F_144 () ;
