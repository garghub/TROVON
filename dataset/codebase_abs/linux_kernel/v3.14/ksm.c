...
int V_23 = V_149 ;
int V_150 = 0 ;
F_179 ( ! F_24 ( V_22 ) , V_22 ) ;
F_179 ( ! F_180 ( V_22 ) , V_22 ) ;
V_5 = F_125 ( V_22 ) ;
if ( ! V_5 )
return V_23 ;
V_54:
...
void F_184 ( struct V_22 * V_157 , struct V_22 * V_158 )
{
struct V_5 * V_5 ;
F_179 ( ! F_180 ( V_158 ) , V_158 ) ;
F_179 ( ! F_180 ( V_157 ) , V_157 ) ;
F_179 ( V_157 -> V_55 != V_158 -> V_55 , V_157 ) ;
V_5 = F_125 ( V_157 ) ;
if ( V_5 ) {
F_179 ( V_5 -> V_38 != F_90 ( V_158 ) , V_158 ) ;
V_5 -> V_38 = F_90 ( V_157 ) ;
F_185 () ;
F_66 ( V_158 , NULL ) ;
}
}
static int F_186 ( void * V_159 )
{
F_187 () ;
return 0 ;
}
...
while ( V_122 & V_160 ) {
F_152 ( & V_125 ) ;
F_188 ( & V_122 , F_189 ( V_160 ) ,
F_186 , V_161 ) ;
F_150 ( & V_125 ) ;
}
}
static void F_190 ( unsigned long V_162 ,
unsigned long V_163 )
{
struct V_5 * V_5 ;
struct V_73 * V_74 , * V_41 ;
...
static int F_193 ( struct V_164 * V_165 ,
unsigned long V_166 , void * V_154 )
{
struct V_167 * V_168 = V_154 ;
switch ( V_166 ) {
case V_169 :
F_150 ( & V_125 ) ;
V_122 |= V_160 ;
...
case V_170 :
F_190 ( V_168 -> V_162 ,
V_168 -> V_162 + V_168 -> V_171 ) ;
case V_172 :
F_150 ( & V_125 ) ;
V_122 &= ~ V_160 ;
F_152 ( & V_125 ) ;
F_194 () ;
F_195 ( & V_122 , F_189 ( V_160 ) ) ;
break;
}
return V_173 ;
}
...
static T_6 F_196 ( struct V_174 * V_175 ,
struct V_176 * V_177 , char * V_178 )
{
return sprintf ( V_178 , L_1 , V_127 ) ;
}
static T_6 F_197 ( struct V_174 * V_175 ,
struct V_176 * V_177 ,
const char * V_178 , T_7 V_179 )
{
unsigned long V_180 ;
int V_68 ;
V_68 = F_198 ( V_178 , 10 , & V_180 ) ;
if ( V_68 || V_180 > V_181 )
return - V_182 ;
V_127 = V_180 ;
return V_179 ;
}
static T_6 F_199 ( struct V_174 * V_175 ,
struct V_176 * V_177 , char * V_178 )
{
return sprintf ( V_178 , L_1 , V_126 ) ;
}
static T_6 F_200 ( struct V_174 * V_175 ,
struct V_176 * V_177 ,
const char * V_178 , T_7 V_179 )
{
int V_68 ;
unsigned long V_171 ;
V_68 = F_198 ( V_178 , 10 , & V_171 ) ;
if ( V_68 || V_171 > V_181 )
return - V_182 ;
V_126 = V_171 ;
return V_179 ;
}
static T_6 F_201 ( struct V_174 * V_175 , struct V_176 * V_177 ,
char * V_178 )
{
return sprintf ( V_178 , L_2 , V_122 ) ;
}
static T_6 F_202 ( struct V_174 * V_175 , struct V_176 * V_177 ,
const char * V_178 , T_7 V_179 )
{
int V_68 ;
unsigned long V_84 ;
V_68 = F_198 ( V_178 , 10 , & V_84 ) ;
if ( V_68 || V_84 > V_181 )
return - V_182 ;
if ( V_84 > V_141 )
return - V_182 ;
...
static T_6 F_205 ( struct V_174 * V_175 ,
struct V_176 * V_177 , char * V_178 )
{
return sprintf ( V_178 , L_1 , V_39 ) ;
}
static T_6 F_206 ( struct V_174 * V_175 ,
struct V_176 * V_177 ,
const char * V_178 , T_7 V_179 )
{
int V_68 ;
unsigned long V_184 ;
V_68 = F_198 ( V_178 , 10 , & V_184 ) ;
if ( V_68 )
return V_68 ;
if ( V_184 > 1 )
return - V_182 ;
...
struct V_107 * V_178 ;
V_178 = F_207 ( V_186 + V_186 , sizeof( * V_178 ) ,
V_11 ) ;
if ( ! V_178 )
V_68 = - V_10 ;
else {
...
F_152 ( & V_125 ) ;
return V_68 ? V_68 : V_179 ;
}
static T_6 F_208 ( struct V_174 * V_175 ,
struct V_176 * V_177 , char * V_178 )
{
return sprintf ( V_178 , L_2 , V_43 ) ;
}
static T_6 F_209 ( struct V_174 * V_175 ,
struct V_176 * V_177 , char * V_178 )
{
return sprintf ( V_178 , L_2 , V_42 ) ;
}
static T_6 F_210 ( struct V_174 * V_175 ,
struct V_176 * V_177 , char * V_178 )
{
return sprintf ( V_178 , L_2 , V_64 ) ;
}
static T_6 F_211 ( struct V_174 * V_175 ,
struct V_176 * V_177 , char * V_178 )
{
long V_188 ;
V_188 = V_12 - V_43
...
if ( V_188 < 0 )
V_188 = 0 ;
return sprintf ( V_178 , L_3 , V_188 ) ;
}
static T_6 F_212 ( struct V_174 * V_175 ,
struct V_176 * V_177 , char * V_178 )
{
return sprintf ( V_178 , L_2 , V_61 . V_62 ) ;
}
