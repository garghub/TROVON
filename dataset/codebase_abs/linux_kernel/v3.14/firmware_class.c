...
V_17 -> V_122 = true ;
F_94 ( V_111 , false ) ;
F_36 ( V_111 , L_17 , V_17 -> V_20 ) ;
if ( V_115 != V_12 )
F_98 ( & V_61 -> V_109 , V_115 ) ;
F_99 ( & V_61 -> V_52 . V_85 , V_123 ) ;
}
F_100 ( & V_17 -> V_21 ) ;
F_101 ( & V_61 -> V_109 ) ;
F_102 ( V_111 , & V_119 ) ;
...
static int
F_112 ( struct V_1 * * V_126 , const char * V_3 ,
struct V_40 * V_40 )
{
struct V_1 * V_1 ;
struct V_13 * V_17 ;
int V_125 ;
* V_126 = V_1 = F_5 ( sizeof( * V_1 ) , V_58 ) ;
if ( ! V_1 ) {
F_73 ( V_40 , L_18 ,
V_23 ) ;
return - V_29 ;
...
static int
F_115 ( const struct V_1 * * V_126 , const char * V_3 ,
struct V_40 * V_40 , unsigned int V_110 )
{
struct V_1 * V_2 ;
long V_115 ;
...
V_125 ) ;
F_34 ( V_40 , L_23 ) ;
V_125 = F_106 ( V_2 , V_3 , V_40 ,
V_110 , V_115 ) ;
}
}
if ( ! V_125 )
V_125 = F_113 ( V_2 , V_40 , V_110 ) ;
F_119 () ;
V_81:
if ( V_125 < 0 ) {
F_120 ( V_2 ) ;
...
int
F_121 ( const struct V_1 * * V_126 , const char * V_3 ,
struct V_40 * V_40 )
{
int V_125 ;
F_122 ( V_131 ) ;
V_125 = F_115 ( V_126 , V_3 , V_40 ,
V_121 | V_130 ) ;
F_123 ( V_131 ) ;
return V_125 ;
}
int F_124 ( const struct V_1 * * V_126 ,
const char * V_3 , struct V_40 * V_40 )
{
int V_125 ;
F_122 ( V_131 ) ;
V_125 = F_115 ( V_126 , V_3 , V_40 , V_121 ) ;
F_123 ( V_131 ) ;
return V_125 ;
}
...
V_133 = F_51 ( V_108 , struct V_132 , V_108 ) ;
F_115 ( & V_2 , V_133 -> V_3 , V_133 -> V_40 ,
V_133 -> V_110 ) ;
...
const char * V_3 , struct V_40 * V_40 , T_5 V_138 , void * V_135 ,
...
const struct V_1 * V_2 ;
F_10 ( L_24 , V_23 , V_14 ) ;
V_125 = F_121 ( & V_2 , V_14 , NULL ) ;
if ( ! V_125 )
F_63 ( V_2 ) ;
F_10 ( L_25 , V_23 , V_14 , V_125 ) ;
return V_125 ;
}
...
static struct V_140 * F_134 ( const char * V_3 )
{
struct V_140 * V_141 ;
...
static void F_137 ( void * V_145 ,
T_6 V_146 )
{
struct V_140 * V_141 = V_145 ;
struct V_15 * V_16 = & V_25 ;
int V_125 ;
V_125 = F_131 ( V_141 -> V_3 ) ;
if ( V_125 ) {
F_14 ( & V_16 -> V_142 ) ;
F_138 ( & V_141 -> V_27 ) ;
F_16 ( & V_16 -> V_142 ) ;
...
struct V_140 * V_141 ;
F_14 ( & V_16 -> V_142 ) ;
while ( ! F_57 ( & V_16 -> V_144 ) ) {
V_141 = F_146 ( V_16 -> V_144 . V_124 ,
struct V_140 , V_27 ) ;
F_138 ( & V_141 -> V_27 ) ;
F_16 ( & V_16 -> V_142 ) ;
F_133 ( V_141 -> V_3 ) ;
...
static void F_153 ( unsigned long V_153 )
{
F_98 ( & V_25 . V_108 ,
F_154 ( V_153 ) ) ;
}
static int F_155 ( struct V_62 * V_154 ,
unsigned long V_35 , void * V_155 )
{
switch ( V_35 ) {
case V_156 :
case V_157 :
