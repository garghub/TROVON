...
static int F_12 ( char * V_38 )
{
unsigned long V_2 ;
char * V_45 ;
V_2 = F_13 ( V_38 , & V_45 , 10 ) ;
if ( V_45 == V_38 )
return 0 ;
return 1 ;
}
static int F_14 ( struct V_25 * V_26 , const int * * V_31 ,
...
return 0 ;
if ( ! F_14 ( V_26 , & V_31 , & V_32 , & V_33 , & V_46 ) )
return 0 ;
F_16 ( L_7 , V_48 , V_26 -> V_49 ) ;
V_47 = ( char * ) & V_32 [ 1 ] ;
type = ( char * ) & V_33 [ 1 ] ;
for ( V_43 = 0 ; V_43 < V_31 [ 0 ] ; V_43 ++ ) {
V_4 = F_17 ( V_26 , V_31 [ V_43 + 1 ] , V_47 , V_46 [ V_43 + 1 ] ) ;
if ( ! V_4 )
return - V_50 ;
V_4 -> type = F_13 ( type , NULL , 10 ) ;
F_16 ( L_8 ,
V_31 [ V_43 + 1 ] , V_47 , type ) ;
V_10 = F_18 ( V_4 ) ;
if ( ! V_10 )
V_10 = F_19 ( V_4 ) ;
if ( V_10 )
...
struct V_4 * V_4 ;
F_22 (tmp, n, &rpaphp_slot_head) {
V_4 = F_23 ( V_52 , struct V_4 , V_54 ) ;
F_24 ( & V_4 -> V_54 ) ;
F_25 ( V_4 -> V_1 ) ;
}
return;
