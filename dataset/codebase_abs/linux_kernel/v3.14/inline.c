...
if ( V_114 )
return V_114 ;
V_114 = F_30 ( V_51 , V_5 -> V_30 ) ;
if ( V_114 )
return V_114 ;
F_99 ( V_1 , V_105 , V_92 , V_42 , V_113 ) ;
...
static int F_106 ( T_3 * V_51 , struct V_1 * V_100 ,
struct V_4 * V_5 )
{
int V_58 ;
...
V_135 = F_119 ( V_1 -> V_13 , V_137 . V_145 ) ;
if ( ! V_135 ) {
error = - V_80 ;
goto V_142;
}
F_120 ( V_135 ) ;
error = F_121 ( V_51 , V_135 ) ;
if ( error ) {
F_122 ( V_135 ) ;
error = - V_144 ;
goto V_142;
...
error = F_109 ( V_51 , V_1 , V_135 ,
V_124 , V_92 ) ;
}
F_122 ( V_135 ) ;
V_142:
if ( error )
F_108 ( V_51 , V_1 , V_5 , V_124 , V_92 ) ;
V_25:
F_20 ( V_135 ) ;
F_40 ( V_124 ) ;
return error ;
}
int F_124 ( T_3 * V_51 , struct V_109 * V_109 ,
struct V_1 * V_1 )
{
int V_58 , V_92 ;
void * V_101 ;
...
while ( V_50 < V_92 ) {
if ( V_50 == 0 ) {
V_157 . V_1 = F_127 ( V_1 -> V_28 ) ;
V_157 . V_108 = 1 ;
strcpy ( V_157 . V_42 , L_6 ) ;
V_157 . V_107 = F_105 (
F_107 ( V_157 . V_108 ) ,
V_92 ) ;
F_128 ( V_1 -> V_13 , & V_157 , V_158 ) ;
V_105 = & V_157 ;
V_50 = V_159 ;
} else if ( V_50 == V_159 ) {
V_157 . V_1 = F_127 ( V_155 ) ;
V_157 . V_108 = 2 ;
...
V_50 += F_94 ( V_105 -> V_107 , V_92 ) ;
if ( F_95 ( V_1 , V_147 , V_105 ,
V_5 . V_30 , V_156 ,
V_92 , V_50 ) ) {
V_58 = V_154 ;
goto V_25;
...
F_129 ( V_105 -> V_42 , V_105 -> V_108 , V_150 ) ;
...
if ( V_163 -> V_50 == 0 ) {
if ( ! F_132 ( V_163 , L_6 , 1 , V_1 -> V_28 , V_171 ) )
goto V_25;
V_163 -> V_50 = V_166 ;
continue;
}
if ( V_163 -> V_50 == V_166 ) {
if ( ! F_132 ( V_163 , L_7 , 2 , V_155 , V_171 ) )
goto V_25;
V_163 -> V_50 = V_167 ;
continue;
}
...
if ( F_95 ( V_1 , V_146 , V_105 , V_5 . V_30 , V_156 ,
V_169 , V_163 -> V_50 ) )
goto V_25;
if ( F_14 ( V_105 -> V_1 ) ) {
if ( ! F_132 ( V_163 , V_105 -> V_42 , V_105 -> V_108 ,
F_14 ( V_105 -> V_1 ) ,
F_133 ( V_165 , V_105 -> V_172 ) ) )
goto V_25;
}
V_163 -> V_50 += F_94 ( V_105 -> V_107 , V_169 ) ;
}
V_25:
F_40 ( V_156 ) ;
F_20 ( V_5 . V_30 ) ;
...
int F_135 ( T_3 * V_51 , struct V_1 * V_175 ,
struct V_1 * V_1 )
{
int V_58 , V_92 = V_31 ;
struct V_4 V_5 ;
...
struct V_90 * F_137 ( struct V_1 * V_100 ,
...
V_133 ;
V_92 = V_31 - V_133 ;
V_58 = F_138 ( V_5 . V_30 , V_101 , V_92 ,
V_100 , V_112 , 0 , V_177 ) ;
if ( V_58 == 1 )
goto V_178;
if ( V_58 < 0 )
...
V_114 = F_30 ( V_51 , V_30 ) ;
if ( V_114 )
goto V_25;
V_114 = F_140 ( V_51 , V_100 , V_179 , V_30 ,
V_101 , V_92 , 0 ) ;
if ( V_114 )
goto V_25;
F_141 ( V_30 , L_8 ) ;
V_114 = F_102 ( V_51 , V_100 ) ;
if ( F_82 ( V_114 ) )
goto V_25;
F_92 ( V_100 , V_5 . V_30 , V_101 , V_92 ) ;
V_25:
