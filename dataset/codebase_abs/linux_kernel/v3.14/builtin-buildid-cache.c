...
F_5 ( V_6 , sizeof( V_6 ) , V_37 ) ;
V_38 = F_22 ( V_37 , V_36 , V_35 ,
false , false ) ;
if ( V_39 )
F_23 ( L_14 , V_37 , V_35 ,
V_38 ? L_15 : L_16 ) ;
...
static bool F_26 ( struct V_40 * V_40 , int T_5 V_41 )
{
char V_35 [ V_4 ] ;
T_1 V_6 [ V_7 ] ;
if ( F_27 ( V_40 , V_35 , sizeof( V_35 ) ) &&
F_21 ( V_35 , V_6 ,
...
F_28 ( L_18 ,
V_35 ) ;
} else if ( memcmp ( V_40 -> V_6 , V_6 , sizeof( V_40 -> V_6 ) ) ) {
F_28 ( L_18 ,
V_35 ) ;
}
return true ;
}
static int F_29 ( const char * V_35 , bool V_44 , T_6 * V_45 )
{
struct V_46 V_47 = {
. V_48 = V_35 ,
. V_49 = V_50 ,
...
struct V_51 * V_52 = F_30 ( & V_47 , false , NULL ) ;
if ( V_52 == NULL )
return - 1 ;
F_31 ( V_52 , V_45 , F_26 , 0 ) ;
F_32 ( V_52 ) ;
return 0 ;
}
static int F_33 ( const char * V_35 ,
const char * V_36 )
{
T_1 V_6 [ V_7 ] ;
char V_37 [ V_7 * 2 + 1 ] ;
...
int F_34 ( int V_53 , const char * * V_54 ,
const char * T_7 V_41 )
{
struct V_55 * V_56 ;
struct V_57 * V_58 ;
...
F_35 ( 'k' , L_8 , & V_63 ,
L_23 , L_24 ) ,
F_35 ( 'r' , L_25 , & V_60 , L_21 ,
L_26 ) ,
F_35 ( 'M' , L_27 , & V_61 , L_23 ,
L_28 ) ,
F_36 ( 'f' , L_29 , & V_44 , L_30 ) ,
F_35 ( 'u' , L_31 , & V_62 , L_21 ,
L_32 ) ,
F_37 ( 'v' , L_33 , & V_39 , L_34 ) ,
F_38 ()
} ;
...
V_53 = F_39 ( V_53 , V_54 , V_65 ,
V_66 , 0 ) ;
if ( F_40 () < 0 )
return - 1 ;
F_41 () ;
snprintf ( V_36 , sizeof( V_36 ) , L_36 , V_67 ) ;
if ( V_59 ) {
V_56 = F_42 ( true , V_59 ) ;
if ( V_56 ) {
F_43 (pos, list)
if ( F_20 ( V_58 -> V_68 , V_36 ) ) {
if ( V_42 == V_69 ) {
F_16 ( L_37 ,
V_58 -> V_68 ) ;
continue;
...
if ( V_61 )
V_30 = F_29 ( V_61 , V_44 , stdout ) ;
if ( V_62 ) {
V_56 = F_42 ( true , V_62 ) ;
if ( V_56 ) {
F_43 (pos, list)
if ( F_33 ( V_58 -> V_68 , V_36 ) ) {
if ( V_42 == V_43 ) {
F_16 ( L_39 ,
V_58 -> V_68 ) ;
continue;
