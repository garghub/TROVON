...
static int F_52 ( struct V_28 * V_29 , struct V_5 * V_6 )
{
struct V_11 * V_12 = F_27 ( V_6 ) ;
unsigned long V_65 ;
int V_33 ;
...
F_45 ( V_6 ) ;
F_4 ( L_13 , V_6 -> V_10 , V_70 , V_33 ) ;
}
F_55 ( & V_12 -> V_56 , V_65 ) ;
F_56 ( V_29 ) ;
return V_71 ;
}
static struct V_72 * F_57 ( struct V_5 * V_6 )
{
struct V_11 * V_12 = F_27 ( V_6 ) ;
return & V_12 -> V_47 ;
}
...
static int F_60 ( struct V_5 * V_6 , void * V_7 )
{
struct V_11 * V_12 = F_27 ( V_6 ) ;
struct V_73 * V_74 = V_7 ;
if ( ! F_6 ( V_74 -> V_75 ) )
return - V_76 ;
F_36 ( & V_12 -> V_56 ) ;
memcpy ( V_6 -> V_8 , V_74 -> V_75 , V_77 ) ;
F_40 ( & V_12 -> V_56 ) ;
return 0 ;
}
static int F_61 ( struct V_5 * V_6 , int V_78 )
{
return - V_20 ;
}
void F_62 ( unsigned long V_79 )
{
}
static int F_63 ( int V_34 , char * V_35 )
{
struct V_5 * V_6 ;
struct V_11 * V_12 ;
int V_19 ;
V_6 = F_64 ( sizeof( * V_12 ) ) ;
if ( V_6 == NULL ) {
F_4 ( L_14 ) ;
return 1 ;
}
...
static int T_2 F_74 ( char * V_1 )
{
struct V_11 * V_96 = NULL ;
struct V_97 * V_98 ;
struct V_51 * V_52 ;
char * V_3 ;
int V_99 ;
...
F_36 ( & V_84 ) ;
F_37 (ele, &devices) {
V_96 = F_38 ( V_52 , struct V_11 , V_80 ) ;
if ( V_96 -> V_34 == V_100 )
break;
}
F_40 ( & V_84 ) ;
if ( V_96 && V_96 -> V_34 == V_100 ) {
F_75 ( V_101 L_21 , V_100 ) ;
return 1 ;
}
V_98 = F_77 ( sizeof( * V_98 ) ) ;
if ( V_98 == NULL ) {
F_75 ( V_101 L_22 ) ;
return 1 ;
}
...
V_98 -> V_34 = V_100 ;
V_98 -> V_35 = V_1 + 1 ;
F_79 ( & V_98 -> V_102 , & V_103 ) ;
return 1 ;
}
static int V_97 ( void )
{
struct V_51 * V_52 , * V_104 ;
F_80 (ele, next, &eth_cmd_line) {
struct V_97 * V_105 ;
V_105 = F_38 ( V_52 , struct V_97 , V_102 ) ;
F_63 ( V_105 -> V_34 , V_105 -> V_35 ) ;
}
return 1 ;
}
