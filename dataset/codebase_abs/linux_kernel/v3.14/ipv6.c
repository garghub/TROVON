...
F_92 ( V_131 -> V_137 , & V_134 -> V_20 ) ;
F_92 ( V_131 -> V_138 , & V_129 -> V_10 ) ;
...
V_134 = F_94 ( V_2 , V_58 , V_8 ) ;
if ( V_134 == NULL )
goto V_147;
F_95 ( V_134 , V_50 , NULL , NULL ) ;
...
V_129 -> V_142 = NULL ;
if ( V_71 -> V_89 != NULL ) {
V_129 -> V_142 = F_96 ( V_71 -> V_89 , V_154 ) ;
F_97 ( V_71 -> V_89 ) ;
V_71 -> V_89 = NULL ;
if ( V_129 -> V_142 )
F_98 ( V_129 -> V_142 , V_134 ) ;
}
V_129 -> V_25 = NULL ;
V_129 -> V_143 = F_21 ( V_8 ) ;
V_129 -> V_144 = F_14 ( V_8 ) -> V_145 ;
if ( V_16 -> V_25 != NULL )
V_129 -> V_25 = F_99 ( V_134 , V_16 -> V_25 ) ;
F_2 ( V_134 ) -> V_155 = 0 ;
if ( V_129 -> V_25 != NULL )
...
if ( ! F_115 ( V_2 , V_175 , V_8 ) )
goto V_174;
return F_116 ( V_2 , V_8 , 1 ) ? - 1 : 0 ;
V_171:
if ( ! F_115 ( NULL , V_175 , V_8 ) )
goto V_167;
if ( V_18 -> V_95 != V_96 ) {
F_74 ( V_8 ) -> V_109 =
V_176 ;
...
static int F_117 ( struct V_1 * V_2 , struct V_177 * V_178 ,
int V_179 )
{
struct V_180 * V_181 = (struct V_180 * ) V_178 ;
struct V_182 * V_183 = F_2 ( V_2 ) ;
struct V_130 * V_184 = F_91 ( V_2 ) ;
struct V_15 * V_16 = F_10 ( V_2 ) ;
...
if ( V_75 . V_79 & V_196 ) {
struct V_197 * V_79 ;
V_79 = F_119 ( V_2 , V_75 . V_79 ) ;
if ( V_79 == NULL )
return - V_189 ;
F_120 ( V_79 ) ;
}
}
if ( F_121 ( & V_181 -> V_198 ) )
V_181 -> V_198 . V_199 [ 15 ] = 1 ;
V_185 = F_86 ( & V_181 -> V_198 ) ;
if ( V_185 & V_200 )
return - V_201 ;
if ( V_185 & V_123 ) {
...
V_183 -> V_5 = & V_6 ;
V_2 -> V_140 = V_141 ;
V_34 = F_124 ( V_2 , (struct V_177 * ) & sin , sizeof( sin ) ) ;
if ( V_34 ) {
V_183 -> V_155 = V_205 ;
V_183 -> V_5 = & V_213 ;
V_2 -> V_140 = F_102 ;
...
F_92 ( V_184 -> V_138 , & V_16 -> V_10 ) ;
F_92 ( V_184 -> V_159 , & V_2 -> V_139 ) ;
return V_34 ;
}
if ( ! F_121 ( & V_2 -> V_139 ) )
V_10 = & V_2 -> V_139 ;
...
static int T_7 F_135 ( struct V_36 * V_36 )
{
if ( V_39 . V_221 == NULL )
return - V_222 ;
return F_136 ( & V_36 -> V_93 . V_94 , V_223 ,
V_224 , V_13 , V_36 ) ;
}
static void T_8 F_137 ( struct V_36 * V_36 )
{
F_138 ( V_36 -> V_93 . V_94 ) ;
}
static int T_9 F_139 ( void )
{
int V_34 = F_140 ( & V_225 , 1 ) ;
if ( V_34 != 0 )
goto V_42;
V_34 = F_141 ( & V_226 , V_13 ) ;
if ( V_34 != 0 )
goto V_227;
F_142 ( & V_228 ) ;
V_34 = F_143 ( & V_229 ) ;
