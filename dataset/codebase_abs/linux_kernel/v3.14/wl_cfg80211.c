...
F_56 ( V_212 , & V_2 -> V_4 ) ;
F_66 ( V_2 -> V_119 . V_120 , 0 , NULL , 0 , V_157 ) ;
}
F_56 ( V_185 , & V_2 -> V_4 ) ;
...
struct V_591 * V_79 , T_10 * V_330 )
{
struct V_94 * V_95 = F_52 ( V_75 ) ;
struct V_19 * V_224 = V_79 -> V_224 ;
const T_2 * V_30 = V_79 -> V_30 ;
T_6 V_36 = V_79 -> V_36 ;
...
F_3 ( V_73 , L_13 ) ;
* V_330 = 0 ;
V_593 = ( const struct V_592 * ) V_30 ;
if ( ! F_163 ( V_593 -> V_600 ) ) {
F_19 ( L_270 ) ;
return - V_354 ;
}
V_2 = F_58 ( V_119 , struct V_1 , V_119 ) ;
if ( F_164 ( V_593 -> V_600 ) ) {
V_386 = V_571 +
V_572 ;
V_226 = V_36 - V_386 ;
...
V_157 ) ;
} else if ( F_166 ( V_593 -> V_600 ) ) {
V_597 = F_46 ( sizeof( * V_597 ) , V_157 ) ;
if ( V_597 == NULL ) {
F_19 ( L_271 ) ;
V_66 = - V_158 ;
goto exit;
...
V_595 = & V_597 -> V_595 ;
V_595 -> V_601 = F_13 ( * V_330 ) ;
memcpy ( & V_595 -> V_602 [ 0 ] , & V_593 -> V_602 [ 0 ] , V_105 ) ;
memcpy ( & V_597 -> V_104 [ 0 ] , & V_593 -> V_104 [ 0 ] , V_105 ) ;
V_595 -> V_36 = F_14 ( V_36 - V_571 ) ;
if ( V_224 )
V_370 = V_224 -> V_24 ;
else
F_98 ( V_2 -> V_68 , V_603 ,
& V_370 ) ;
V_599 = F_7 ( V_370 ) ;
V_597 -> V_234 = F_13 ( V_599 ) ;
memcpy ( V_595 -> V_62 , & V_30 [ V_571 ] ,
F_102 ( V_595 -> V_36 ) ) ;
F_3 ( V_73 , L_272 ,
* V_330 , F_102 ( V_595 -> V_36 ) , V_370 ) ;
V_598 = F_167 ( V_95 , F_63 ( V_95 ) ,
V_597 ) ;
F_165 ( V_119 , * V_330 , V_30 , V_36 , V_598 ,
V_157 ) ;
F_49 ( V_597 ) ;
} else {
F_3 ( V_73 , L_273 , V_593 -> V_600 ) ;
...
static int F_173 ( enum V_609 V_610 )
{
int V_463 ;
switch ( V_610 ) {
case V_611 :
...
static struct V_75 * F_177 ( struct V_627 * V_628 )
{
struct V_75 * V_75 ;
T_5 V_66 = 0 ;
V_75 = F_178 ( & V_629 , sizeof( struct V_94 ) ) ;
if ( ! V_75 ) {
F_19 ( L_280 ) ;
return F_23 ( - V_158 ) ;
}
...
F_119 ( V_90 ) ;
V_75 -> V_634 = V_635 ;
V_75 -> V_636 = F_153 ( V_635 ) ;
V_75 -> V_381 [ V_382 ] = & V_637 ;
V_75 -> V_638 = V_639 ;
V_75 -> V_640 = V_641 ;
V_75 -> V_642 = F_153 ( V_641 ) ;
V_75 -> V_57 |= V_643 |
V_644 |
V_645 |
V_646 ;
...
{
T_4 V_656 = V_416 -> V_456 ;
T_4 V_419 = V_416 -> V_419 ;
if ( V_656 == V_657 && V_419 == V_429 ) {
F_3 ( V_222 , L_284 ) ;
return true ;
}
return false ;
}
static bool F_190 ( const struct V_415 * V_416 )
{
T_4 V_656 = V_416 -> V_456 ;
T_1 V_57 = V_416 -> V_57 ;
if ( V_656 == V_658 && ( ! ( V_57 & V_659 ) ) ) {
F_3 ( V_222 , L_285 ) ;
return true ;
}
return false ;
}
static bool F_191 ( struct V_94 * V_95 ,
const struct V_415 * V_416 )
{
T_4 V_656 = V_416 -> V_456 ;
T_4 V_419 = V_416 -> V_419 ;
if ( V_656 == V_658 && V_419 == V_660 ) {
F_3 ( V_222 , L_286 ,
V_416 -> V_57 & V_659 ? L_287 : L_288 ) ;
return true ;
}
if ( V_656 == V_657 && V_419 != V_429 ) {
F_3 ( V_222 , L_289 ) ;
...
static T_5 F_194 ( struct V_94 * V_95 ,
struct V_67 * V_68 )
{
struct V_667 * V_668 ;
struct V_661 * V_662 = F_193 ( V_95 ) ;
...
V_668 =
(struct V_667 * ) V_95 -> V_401 ;
V_669 = F_97 ( V_668 -> V_669 ) ;
V_670 = F_97 ( V_668 -> V_670 ) ;
if ( V_669 ) {
...
F_3 ( V_73 , L_13 ) ;
F_194 ( V_95 , V_68 ) ;
memcpy ( V_216 -> V_104 , V_416 -> V_672 , V_105 ) ;
F_111 ( V_95 , V_68 ) ;
V_30 = F_46 ( V_377 , V_157 ) ;
if ( V_30 == NULL ) {
V_66 = - V_158 ;
...
V_129:
F_49 ( V_30 ) ;
F_197 ( V_65 , V_365 , ( T_2 * ) V_216 -> V_104 ,
V_662 -> V_663 , V_662 -> V_664 ,
V_662 -> V_665 , V_662 -> V_666 , V_157 ) ;
F_3 ( V_222 , L_297 ) ;
...
static T_5
F_200 ( struct V_94 * V_95 ,
struct V_64 * V_65 ,
const struct V_415 * V_416 , void * V_62 )
{
static int V_676 ;
T_4 V_656 = V_416 -> V_456 ;
T_4 V_677 = V_416 -> V_677 ;
struct V_332 V_333 ;
F_3 ( V_222 , L_300 , V_656 , V_677 ) ;
if ( V_656 == V_658 && V_677 == V_678 &&
V_65 != F_63 ( V_95 ) ) {
F_3 ( V_222 , L_301 ) ;
F_201 ( & V_95 -> V_679 ) ;
return 0 ;
}
if ( ( ( V_656 == V_680 ) || ( V_656 == V_681 ) ) &&
( V_677 == V_429 ) ) {
...
V_333 . V_683 = V_62 ;
V_333 . V_684 = V_416 -> V_685 ;
V_676 ++ ;
V_333 . V_676 = V_676 ;
F_202 ( V_65 , V_416 -> V_672 , & V_333 , V_157 ) ;
} else if ( ( V_656 == V_686 ) ||
( V_656 == V_687 ) ||
( V_656 == V_688 ) ) {
F_203 ( V_65 , V_416 -> V_672 , V_157 ) ;
}
return 0 ;
}
static T_5
...
T_5 V_66 = 0 ;
if ( V_68 -> V_2 -> V_70 == V_128 ) {
V_66 = F_200 ( V_95 , V_65 , V_416 , V_62 ) ;
} else if ( F_189 ( V_416 ) ) {
F_3 ( V_222 , L_303 ) ;
if ( F_110 ( V_68 -> V_2 ) ) {
memcpy ( V_216 -> V_104 , V_416 -> V_672 , V_105 ) ;
F_109 ( V_95 , V_65 , V_416 -> V_672 ) ;
F_205 ( V_65 , V_416 -> V_672 , V_157 ) ;
F_56 ( V_185 ,
& V_68 -> V_2 -> V_4 ) ;
F_40 ( V_212 ,
& V_68 -> V_2 -> V_4 ) ;
} else
F_198 ( V_95 , V_65 , V_416 , true ) ;
} else if ( F_190 ( V_416 ) ) {
F_3 ( V_222 , L_304 ) ;
if ( ! F_110 ( V_68 -> V_2 ) ) {
F_198 ( V_95 , V_65 , V_416 , false ) ;
if ( F_33 ( V_212 ,
& V_68 -> V_2 -> V_4 ) )
F_66 ( V_65 , 0 , NULL , 0 ,
V_157 ) ;
...
T_4 V_656 = V_416 -> V_456 ;
T_4 V_419 = V_416 -> V_419 ;
if ( V_656 == V_689 && V_419 == V_429 ) {
if ( F_2 ( V_212 , & V_68 -> V_2 -> V_4 ) )
F_196 ( V_95 , V_68 -> V_65 , V_416 ) ;
else
F_198 ( V_95 , V_68 -> V_65 , V_416 , true ) ;
}
return V_66 ;
}
static T_5
...
V_691 = V_694 ;
F_208 ( V_68 -> V_65 , ( T_2 * ) & V_416 -> V_672 , V_691 , - 1 ,
NULL , V_157 ) ;
return 0 ;
}
...
{
struct V_94 * V_95 = V_68 -> V_417 -> V_418 ;
struct V_695 * V_696 = (struct V_695 * ) V_62 ;
struct V_697 * V_656 = & V_95 -> V_698 ;
struct V_1 * V_2 ;
F_3 ( V_73 , L_305 ,
V_696 -> V_152 , V_696 -> V_57 , V_696 -> V_699 ,
V_696 -> V_423 ) ;
F_210 ( & V_656 -> V_700 ) ;
V_656 -> V_152 = V_696 -> V_152 ;
V_2 = V_656 -> V_2 ;
switch ( V_696 -> V_152 ) {
case V_701 :
if ( ! V_95 -> V_698 . V_2 ) {
...
F_212 ( V_68 -> V_65 , F_213 ( V_95 -> V_75 ) ) ;
}
F_211 ( & V_656 -> V_700 ) ;
F_214 ( & V_656 -> V_703 ) ;
return 0 ;
...
static void F_215 ( struct V_706 * V_204 )
{
V_204 -> V_196 = ( T_4 ) - 1 ;
V_204 -> V_195 = ( T_4 ) - 1 ;
V_204 -> V_209 = ( T_4 ) - 1 ;
...
{
F_121 ( V_95 -> V_430 , V_658 ,
F_204 ) ;
F_121 ( V_95 -> V_430 , V_687 ,
F_204 ) ;
F_121 ( V_95 -> V_430 , V_688 ,
F_204 ) ;
...
F_204 ) ;
F_121 ( V_95 -> V_430 , V_689 ,
F_206 ) ;
F_121 ( V_95 -> V_430 , V_707 ,
F_207 ) ;
F_121 ( V_95 -> V_430 , V_657 ,
F_204 ) ;
F_121 ( V_95 -> V_430 , V_708 ,
F_135 ) ;
F_121 ( V_95 -> V_430 , V_709 ,
F_209 ) ;
...
V_715 ) ;
F_121 ( V_95 -> V_430 , V_716 ,
V_717 ) ;
F_121 ( V_95 -> V_430 , V_718 ,
V_717 ) ;
}
static void F_217 ( struct V_94 * V_95 )
{
F_49 ( V_95 -> V_204 ) ;
V_95 -> V_204 = NULL ;
F_49 ( V_95 -> V_719 ) ;
...
static T_5 F_219 ( struct V_94 * V_95 )
{
T_5 V_66 = 0 ;
V_95 -> V_101 = NULL ;
V_95 -> V_358 = true ;
...
static void F_222 ( struct V_94 * V_95 )
{
V_95 -> V_722 = false ;
F_112 ( V_95 ) ;
F_217 ( V_95 ) ;
}
static void F_223 ( struct V_697 * V_656 )
{
F_224 ( & V_656 -> V_703 ) ;
F_220 ( & V_656 -> V_700 ) ;
}
struct V_94 * F_225 ( struct V_724 * V_417 ,
struct V_627 * V_725 )
{
struct V_64 * V_65 = V_417 -> V_726 [ 0 ] -> V_65 ;
struct V_94 * V_95 ;
struct V_75 * V_75 ;
struct V_1 * V_2 ;
struct V_67 * V_68 ;
...
V_66 = F_98 ( V_68 , V_730 ,
& V_727 ) ;
if ( V_66 ) {
F_19 ( L_312 , V_66 ) ;
goto V_729;
}
V_95 -> V_18 . V_727 = ( T_2 ) V_727 ;
F_231 ( & V_95 -> V_18 ) ;
return V_95 ;
V_729:
F_222 ( V_95 ) ;
...
void F_232 ( struct V_94 * V_95 )
{
if ( ! V_95 )
return;
F_136 ( ! F_233 ( & V_95 -> V_655 ) ) ;
F_234 ( V_95 -> V_75 ) ;
F_235 ( V_95 ) ;
F_222 ( V_95 ) ;
F_182 ( V_95 -> V_75 ) ;
...
static T_5
F_236 ( struct V_67 * V_68 , T_4 V_731 , T_4 V_732 )
{
T_5 V_66 = 0 ;
V_396 V_733 [ 2 ] ;
V_396 V_734 [ 2 ] ;
if ( V_731 ) {
V_66 = F_21 ( V_68 , L_313 , V_732 ) ;
if ( V_66 ) {
F_19 ( L_314 , V_66 ) ;
goto V_735;
}
}
F_3 ( V_5 , L_315 , V_731 ? L_316 : L_317 ) ;
V_66 = F_21 ( V_68 , L_318 , V_731 ) ;
if ( V_66 ) {
F_19 ( L_319 , V_66 ) ;
goto V_735;
}
V_733 [ 0 ] = F_13 ( V_736 ) ;
V_733 [ 1 ] = F_13 ( V_737 ) ;
V_66 = F_29 ( V_68 , V_738 ,
( void * ) V_733 , sizeof( V_733 ) ) ;
if ( V_66 ) {
F_19 ( L_320 , V_66 ) ;
goto V_735;
}
V_734 [ 0 ] = F_13 ( V_739 ) ;
V_734 [ 1 ] = F_13 ( V_737 ) ;
V_66 = F_29 ( V_68 , V_740 ,
( void * ) V_734 , sizeof( V_734 ) ) ;
if ( V_66 ) {
F_19 ( L_321 , V_66 ) ;
goto V_735;
}
...
static T_5
F_237 ( struct V_67 * V_68 , T_5 V_741 ,
T_5 V_742 , T_5 V_743 )
{
T_5 V_66 = 0 ;
V_66 = F_41 ( V_68 , V_744 ,
V_741 ) ;
if ( V_66 ) {
if ( V_66 == - V_87 )
F_3 ( V_5 , L_322 ) ;
...
bool V_756 ;
T_4 V_757 ;
V_751 = F_46 ( V_159 , V_157 ) ;
if ( V_751 == NULL )
return - V_158 ;
V_391 = (struct V_750 * ) V_751 ;
V_66 = F_96 ( V_68 , L_328 , V_751 ,
V_159 ) ;
if ( V_66 ) {
F_19 ( L_329 , V_66 ) ;
goto exit;
...
V_637 . V_137 = 0 ;
V_758 . V_137 = 0 ;
V_752 = F_97 ( V_391 -> V_172 ) ;
for ( V_138 = 0 ; V_138 < V_752 ; V_138 ++ ) {
V_20 . V_28 = ( T_1 ) F_97 ( V_391 -> V_759 [ V_138 ] ) ;
V_95 -> V_18 . V_379 ( & V_20 ) ;
if ( V_20 . V_369 == V_398 ) {
V_749 = V_760 ;
V_757 = F_153 ( V_760 ) ;
...
if ( ! ( V_748 [ V_369 ] & V_763 ) &&
V_20 . V_25 == V_764 )
continue;
V_756 = false ;
for ( V_438 = 0 ; ( V_438 < * V_754 && ( * V_754 < V_757 ) ) ; V_438 ++ ) {
if ( V_749 [ V_438 ] . V_144 == V_20 . V_23 ) {
V_756 = true ;
break;
}
}
...
V_749 [ V_55 ] . V_144 = V_20 . V_23 ;
F_19 ( L_331 ,
V_20 . V_23 , V_749 [ V_55 ] . V_24 ,
V_20 . V_25 , V_20 . V_765 ) ;
if ( V_20 . V_25 == V_764 ) {
V_755 = V_749 [ V_55 ] . V_57 &
V_462 ;
if ( V_20 . V_765 == V_766 ) {
if ( V_755 == V_462 )
V_749 [ V_55 ] . V_57 &=
...
static void F_239 ( struct V_67 * V_68 , T_4 V_748 [] )
{
T_4 V_369 , V_773 ;
int V_66 ;
V_369 = V_774 ;
V_66 = F_86 ( V_68 , L_333 , & V_369 ) ;
if ( ! V_66 ) {
V_748 [ V_382 ] = V_369 ;
V_369 = V_775 ;
V_66 = F_86 ( V_68 , L_333 , & V_369 ) ;
...
static T_5 F_240 ( struct V_94 * V_95 )
{
struct V_67 * V_68 = F_18 ( F_63 ( V_95 ) ) ;
struct V_75 * V_75 ;
T_5 V_780 ;
...
T_4 V_784 ;
T_5 V_138 ;
struct V_368 * V_381 [ 2 ] = { NULL , NULL } ;
struct V_368 * V_369 ;
V_66 = F_99 ( V_68 , V_785 ,
& V_780 , sizeof( V_780 ) ) ;
if ( V_66 ) {
F_19 ( L_337 , V_66 ) ;
return V_66 ;
...
F_3 ( V_5 , L_340 ,
V_781 [ 0 ] , V_781 [ 1 ] , V_781 [ 2 ] ) ;
V_66 = F_86 ( V_68 , L_341 , & V_782 ) ;
if ( V_66 ) {
F_19 ( L_342 , V_66 ) ;
} else {
F_239 ( V_68 , V_748 ) ;
...
F_3 ( V_5 , L_343 , V_782 ,
V_748 [ V_382 ] , V_748 [ V_383 ] ) ;
V_66 = F_238 ( V_95 , V_748 ) ;
if ( V_66 ) {
F_19 ( L_344 , V_66 ) ;
return V_66 ;
}
V_784 = V_781 [ 0 ] ;
for ( V_138 = 1 ; V_138 <= V_784 && V_138 < F_153 ( V_781 ) ; V_138 ++ ) {
V_369 = NULL ;
if ( ( V_781 [ V_138 ] == V_775 ) &&
( V_758 . V_137 > 0 ) )
V_369 = & V_758 ;
else if ( ( V_781 [ V_138 ] == V_774 ) &&
( V_637 . V_137 > 0 ) )
V_369 = & V_637 ;
else
continue;
if ( V_748 [ V_369 -> V_369 ] & V_763 ) {
V_369 -> V_787 . V_788 |= V_789 ;
V_369 -> V_787 . V_788 |= V_790 ;
}
V_369 -> V_787 . V_788 |= V_791 ;
V_369 -> V_787 . V_788 |= V_792 ;
V_369 -> V_787 . V_793 = true ;
V_369 -> V_787 . V_794 = V_795 ;
V_369 -> V_787 . V_796 = V_797 ;
V_369 -> V_787 . V_798 . V_799 [ 0 ] = 0xff ;
V_369 -> V_787 . V_798 . V_800 = V_801 ;
V_381 [ V_369 -> V_369 ] = V_369 ;
}
V_75 = F_31 ( V_95 ) ;
...
static T_5 F_241 ( struct V_94 * V_95 )
{
return F_240 ( V_95 ) ;
}
static T_5 F_242 ( struct V_94 * V_95 )
{
struct V_64 * V_65 ;
struct V_74 * V_119 ;
struct V_67 * V_68 ;
...
F_237 ( V_68 , V_803 ,
V_804 , V_805 ) ;
V_802 = V_95 -> V_358 ? V_359 : V_360 ;
V_66 = F_41 ( V_68 , V_361 , V_802 ) ;
if ( V_66 )
goto V_806;
F_3 ( V_5 , L_345 ,
( V_802 ? L_154 : L_155 ) ) ;
V_66 = F_236 ( V_68 , ( V_95 -> V_721 ? 0 : 1 ) , V_807 ) ;
if ( V_66 )
goto V_806;
...
static T_5 F_243 ( struct V_67 * V_68 )
{
F_40 ( V_3 , & V_68 -> V_2 -> V_4 ) ;
return F_242 ( V_68 -> V_417 -> V_418 ) ;
}
...
enum V_77 F_247 ( struct V_67 * V_68 )
{
struct V_74 * V_119 = & V_68 -> V_2 -> V_119 ;
return V_119 -> V_123 ;
}
T_4 F_248 ( struct V_94 * V_95 , unsigned long V_808 )
{
struct V_1 * V_2 ;
bool V_313 = 0 ;
F_130 (vif, &cfg->vif_list, list) {
if ( F_2 ( V_808 , & V_2 -> V_4 ) )
V_313 ++ ;
}
return V_313 ;
}
static inline bool F_249 ( struct V_697 * V_656 ,
T_2 V_152 )
{
T_2 V_809 ;
F_210 ( & V_656 -> V_700 ) ;
...
bool V_810 ;
F_210 ( & V_656 -> V_700 ) ;
V_810 = V_656 -> V_2 != NULL ;
F_211 ( & V_656 -> V_700 ) ;
return V_810 ;
}
int F_251 ( struct V_94 * V_95 ,
T_2 V_152 , T_11 V_356 )
{
struct V_697 * V_656 = & V_95 -> V_698 ;
return F_252 ( V_656 -> V_703 ,
F_249 ( V_656 , V_152 ) , V_356 ) ;
}
