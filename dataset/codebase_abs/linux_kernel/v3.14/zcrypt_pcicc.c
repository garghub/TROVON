...
if ( V_29 < 10 )
return - V_34 ;
if ( F_18 ( V_49 , V_51 , V_29 - 1 ) )
return - V_33 ;
if ( F_19 ( 0 , V_49 + V_29 - 1 ) )
return - V_33 ;
}
if ( F_18 ( V_49 + V_29 , V_56 , V_55 ) )
return - V_33 ;
return 0 ;
}
...
static void F_22 ( struct V_69 * V_41 ,
struct V_6 * V_26 ,
struct V_6 * V_48 )
{
...
V_74:
F_25 ( (struct V_75 * ) V_26 -> V_76 ) ;
}
static long F_26 ( struct V_4 * V_5 ,
struct V_8 * V_9 )
{
struct V_6 V_7 ;
struct V_75 V_77 ;
...
V_78 = F_32 ( & V_77 ) ;
if ( V_78 == 0 )
V_78 = F_20 ( V_5 , & V_7 , V_9 -> V_49 ,
V_9 -> V_50 ) ;
else
F_33 ( V_5 -> V_41 , & V_7 ) ;
V_87:
F_34 ( ( unsigned long ) V_7 . V_27 ) ;
return V_78 ;
}
static long F_35 ( struct V_4 * V_5 ,
struct V_45 * V_46 )
{
struct V_6 V_7 ;
struct V_75 V_77 ;
...
static int F_36 ( struct V_69 * V_41 )
{
struct V_4 * V_5 ;
int V_78 ;
V_5 = F_37 ( V_38 ) ;
...
static void F_40 ( struct V_69 * V_41 )
{
