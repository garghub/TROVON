...
if ( ! V_54 ) {
F_84 ( & V_23 -> V_33 , 64 ) ;
V_23 -> V_33 . V_172 = & V_173 ;
V_3 -> V_31 . V_174 = & V_23 -> V_33 ;
} else {
if ( V_43 )
F_84 ( & V_23 -> V_33 , V_52 -> V_53 ) ;
else
F_84 ( & V_23 -> V_33 , V_52 -> V_120 ) ;
V_23 -> V_33 . V_172 = & V_175 ;
F_57 ( & V_23 -> V_33 . V_171 , & V_3 -> V_31 . V_171 ) ;
}
}
static inline void F_85 ( struct V_3 * V_3 )
{
T_3 V_54 ;
struct V_84 * V_52 ;
unsigned V_176 = 0 ;
...
int F_86 ( struct V_3 * V_3 )
{
int V_25 ;
V_3 -> V_31 . V_172 = & V_178 ;
V_3 -> V_31 . V_179 = V_180 ;
V_3 -> V_31 . V_181 = V_182 ;
F_87 ( V_3 ) ;
V_3 -> V_150 -> V_158 -> V_183 = 0 ;
...
V_3 -> V_188 = 0 ;
F_71 ( V_3 , 0 ) ;
V_25 = F_89 ( V_3 -> V_17 , & V_3 -> V_31 ) ;
if ( V_25 )
goto V_189;
return 0 ;
V_189:
V_3 -> V_31 . V_32 . V_190 = NULL ;
F_90 ( & V_3 -> V_31 . V_32 ) ;
return V_25 ;
}
...
static int F_93 ( struct V_144 * V_31 ,
struct V_193 * V_194 )
{
struct V_3 * V_3 = F_66 ( V_31 ) ;
struct V_195 * V_158 = V_3 -> V_150 -> V_158 ;
unsigned long V_105 ;
int V_143 = 0 ;
if ( V_194 -> V_179 < V_180 ) {
V_143 = - V_107 ;
goto V_189;
}
F_80 ( V_3 -> V_17 ) ;
F_15 ( V_3 -> V_17 , L_62 , V_194 -> V_196 ) ;
V_3 -> V_170 = 0 ;
V_3 -> V_197 = V_194 ;
F_42 ( & V_3 -> V_26 , V_105 ) ;
V_3 -> V_188 = 1 ;
...
F_49 ( & V_3 -> V_26 , V_105 ) ;
F_95 ( V_3 ) ;
if ( V_3 -> V_150 -> V_198 == V_199 )
F_96 ( V_3 , 1 ) ;
if ( V_3 -> V_150 -> V_198 == V_200 )
F_81 ( V_3 -> V_17 ) ;
return 0 ;
V_189:
return V_143 ;
}
static void F_97 ( struct V_3 * V_3 , struct V_193 * V_194 )
{
int V_201 ;
struct V_84 * V_52 ;
if ( V_3 -> V_31 . V_181 == V_182 )
V_194 = NULL ;
else
V_3 -> V_31 . V_181 = V_182 ;
if ( V_3 -> V_170 ) {
...
static int F_99 ( struct V_144 * V_31 ,
struct V_193 * V_194 )
{
struct V_3 * V_3 = F_66 ( V_31 ) ;
unsigned long V_105 ;
...
V_3 -> V_150 -> V_151 = V_202 ;
F_97 ( V_3 , V_194 ) ;
F_94 ( V_3 -> V_150 -> V_158 , NULL ) ;
F_15 ( V_3 -> V_17 , L_63 ,
V_194 ? V_194 -> V_196 : L_64 ) ;
V_3 -> V_188 = 0 ;
V_3 -> V_197 = NULL ;
F_71 ( V_3 , 0 ) ;
F_49 ( & V_3 -> V_26 , V_105 ) ;
...
case V_152 :
V_3 -> V_188 = 1 ;
if ( V_3 -> V_197 && V_3 -> V_197 -> V_204 ) {
F_14 ( & V_3 -> V_26 ) ;
V_3 -> V_197 -> V_204 ( & V_3 -> V_31 ) ;
F_16 ( & V_3 -> V_26 ) ;
}
break;
default:
...
( void ) F_77 ( & V_3 -> V_31 , 0 ) ;
V_3 -> V_31 . V_181 = V_182 ;
if ( V_3 -> V_197 && V_3 -> V_197 -> V_207 ) {
F_14 ( & V_3 -> V_26 ) ;
V_3 -> V_197 -> V_207 ( & V_3 -> V_31 ) ;
F_16 ( & V_3 -> V_26 ) ;
}
switch ( V_3 -> V_150 -> V_151 ) {
default:
