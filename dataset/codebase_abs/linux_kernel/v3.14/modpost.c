...
return 0 ;
if ( strcmp ( V_163 , L_47 ) == 0 &&
F_49 ( V_162 , V_170 ) &&
( strncmp ( V_167 , L_48 , strlen ( L_48 ) ) == 0 ) )
return 0 ;
if ( F_49 ( V_163 , V_171 ) &&
F_49 ( V_162 , V_170 ) &&
...
{
return V_4 [ 0 ] == '$' && strchr ( L_49 , V_4 [ 1 ] )
&& ( V_4 [ 2 ] == '\0' || V_4 [ 2 ] == '.' ) ;
}
...
if ( * V_22 == '.' )
V_22 ++ ;
if ( strstr ( V_22 , L_50 ) != NULL )
strcat ( V_15 , L_51 ) ;
else if ( strstr ( V_22 , L_52 ) != NULL )
strcat ( V_15 , L_53 ) ;
else
strcat ( V_15 , L_54 ) ;
return V_184 ;
...
char * V_195 ;
switch ( V_188 ) {
case 0 : V_190 = L_58 ; V_191 = L_15 ; break;
case 1 : V_190 = L_59 ; V_191 = L_60 ; break;
default: V_190 = L_61 ; V_191 = L_15 ; break;
}
switch ( V_189 ) {
case 0 : V_192 = L_58 ; V_193 = L_15 ; break;
case 1 : V_192 = L_59 ; V_193 = L_60 ; break;
default: V_192 = L_61 ; V_193 = L_15 ; break;
}
V_196 ++ ;
if ( ! V_197 )
return;
...
V_241 = F_44 ( V_67 . V_114 , V_67 . V_115 , L_95 ) ;
if ( V_67 . V_114 && ! V_241 && ! F_5 ( V_6 ) )
F_2 ( L_96
L_97
L_98 , V_6 ) ;
while ( V_241 ) {
...
V_241 = F_43 ( V_67 . V_114 , V_67 . V_115 ,
L_95 , V_241 ) ;
}
for ( V_70 = V_67 . V_118 ; V_70 < V_67 . V_119 ; V_70 ++ ) {
...
( F_5 ( V_6 ) && V_243 ) )
F_74 ( V_11 , V_6 , & V_67 ) ;
V_240 = F_44 ( V_67 . V_114 , V_67 . V_115 , L_99 ) ;
if ( V_240 )
F_78 ( V_6 , V_240 , V_67 . V_114 ,
V_240 - ( char * ) V_67 . V_68 ) ;
if ( V_240 || ( V_244 && ! F_5 ( V_6 ) ) )
F_79 ( V_6 , V_11 -> V_245 ,
sizeof( V_11 -> V_245 ) - 1 ) ;
F_33 ( & V_67 ) ;
if ( V_246 )
V_11 -> V_141 = F_12 ( L_100 , 0 , V_11 -> V_141 ) ;
}
static void F_80 ( const char * V_50 )
{
T_11 * V_247 = V_248 ;
char V_249 [ V_250 ] ;
if ( strcmp ( V_50 , L_101 ) != 0 ) {
V_247 = fopen ( V_50 , L_102 ) ;
if ( ! V_247 )
F_1 ( L_103 , V_50 ) ;
}
while ( fgets ( V_249 , V_250 , V_247 ) != NULL ) {
if ( F_4 ( V_249 , L_57 ) )
...
void F_81 ( struct V_251 * V_252 , const char * V_22 , int V_66 )
{
if ( V_252 -> V_51 - V_252 -> V_63 < V_66 ) {
V_252 -> V_51 += V_66 + V_253 ;
V_252 -> V_15 = realloc ( V_252 -> V_15 , V_252 -> V_51 ) ;
}
strncpy ( V_252 -> V_15 + V_252 -> V_63 , V_22 , V_66 ) ;
V_252 -> V_63 += V_66 ;
}
static void F_82 ( enum V_23 exp , const char * V_254 , const char * V_22 )
{
const char * V_255 = F_5 ( V_254 ) ? L_15 : L_16 ;
switch ( exp ) {
case V_37 :
F_1 ( L_104
L_105 , V_254 , V_255 , V_22 ) ;
break;
case V_38 :
F_1 ( L_104
L_106 , V_254 , V_255 , V_22 ) ;
break;
case V_39 :
F_2 ( L_104
L_107 , V_254 , V_255 , V_22 ) ;
break;
case V_35 :
case V_36 :
case V_30 :
...
static void F_83 ( enum V_23 exp , const char * V_254 , const char * V_22 )
{
const char * V_255 = F_5 ( V_254 ) ? L_15 : L_16 ;
switch ( exp ) {
case V_36 :
...
static void F_85 ( struct V_251 * V_257 , struct V_10 * V_11 )
{
F_86 ( V_257 , L_110 ) ;
F_86 ( V_257 , L_111 ) ;
F_86 ( V_257 , L_112 ) ;
...
static void F_87 ( struct V_251 * V_257 , int V_258 )
{
if ( V_258 )
F_86 ( V_257 , L_123 ) ;
}
static void F_88 ( struct V_251 * V_257 , const char * V_14 )
{
static const char * V_259 = L_124 ;
if ( strncmp ( V_259 , V_14 , strlen ( V_259 ) ) == 0 )
F_86 ( V_257 , L_125 ) ;
}
static int F_89 ( struct V_251 * V_257 , struct V_10 * V_11 )
{
struct V_20 * V_22 , * exp ;
int V_260 = 0 ;
for ( V_22 = V_11 -> V_141 ; V_22 ; V_22 = V_22 -> V_13 ) {
...
static void F_90 ( struct V_251 * V_257 , struct V_10 * V_11 ,
struct V_10 * V_12 )
{
struct V_20 * V_22 ;
struct V_10 * V_254 ;
int V_262 = 1 ;
for ( V_254 = V_12 ; V_254 ; V_254 = V_254 -> V_13 )
V_254 -> V_263 = F_5 ( V_254 -> V_14 ) ;
F_86 ( V_257 , L_57 ) ;
F_86 ( V_257 , L_132 ) ;
F_86 ( V_257 , L_128 ) ;
F_86 ( V_257 , L_133 ) ;
...
V_15 = V_22 -> V_10 -> V_14 ;
F_86 ( V_257 , L_135 , V_262 ? L_15 : L_136 , V_15 ) ;
V_262 = 0 ;
}
F_86 ( V_257 , L_137 ) ;
}
static void F_91 ( struct V_251 * V_257 , struct V_10 * V_11 )
{
if ( V_11 -> V_245 [ 0 ] ) {
F_86 ( V_257 , L_57 ) ;
F_86 ( V_257 , L_138 ,
...
static void F_92 ( struct V_251 * V_257 , const char * V_249 )
{
char * V_264 ;
T_11 * V_64 ;
struct V_52 V_53 ;
V_64 = fopen ( V_249 , L_102 ) ;
if ( ! V_64 )
goto V_265;
...
static void F_93 ( const char * V_249 , unsigned int V_47 )
{
unsigned long V_51 , V_63 = 0 ;
void * V_64 = F_23 ( V_249 , & V_51 ) ;
char * line ;
if ( ! V_64 )
return;
while ( ( line = F_28 ( & V_63 , V_64 , V_51 ) ) ) {
char * V_127 , * V_6 , * V_180 , * V_23 , * V_268 ;
unsigned int V_48 ;
struct V_10 * V_11 ;
struct V_20 * V_22 ;
...
static void F_95 ( const char * V_249 )
{
struct V_251 V_252 = { } ;
struct V_20 * V_20 ;
int V_271 ;
for ( V_271 = 0 ; V_271 < V_26 ; V_271 ++ ) {
V_20 = V_27 [ V_271 ] ;
while ( V_20 ) {
if ( F_94 ( V_20 ) )
F_86 ( & V_252 , L_141 ,
...
while ( ( V_278 = F_96 ( V_272 , V_273 , L_142 ) ) != - 1 ) {
switch ( V_278 ) {
case 'i' :
V_274 = V_282 ;
break;
...
V_260 = 0 ;
for ( V_11 = V_12 ; V_11 ; V_11 = V_11 -> V_13 ) {
char V_249 [ strlen ( V_11 -> V_14 ) + 10 ] ;
if ( V_11 -> V_65 )
continue;
V_252 . V_63 = 0 ;
F_85 ( & V_252 , V_11 ) ;
F_87 ( & V_252 , ! V_270 ) ;
F_88 ( & V_252 , V_11 -> V_14 ) ;
V_260 |= F_89 ( & V_252 , V_11 ) ;
F_90 ( & V_252 , V_11 , V_12 ) ;
F_97 ( & V_252 , V_11 ) ;
F_91 ( & V_252 , V_11 ) ;
sprintf ( V_249 , L_143 , V_11 -> V_14 ) ;
F_92 ( & V_252 , V_249 ) ;
}
if ( V_276 )
F_95 ( V_276 ) ;
