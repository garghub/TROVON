...
{
const struct V_112 * V_75 = F_62 ( & V_31 -> V_26 ) ;
struct V_61 * V_46 ;
struct V_71 * V_71 ;
int error ;
unsigned int V_181 ;
if ( ! V_75 )
return - V_42 ;
V_46 = F_63 ( sizeof( struct V_61 ) , V_58 ) ;
V_71 = F_64 () ;
if ( ! V_46 || ! V_71 ) {
F_7 ( & V_31 -> V_26 , L_15 ) ;
error = - V_59 ;
...
V_46 -> V_183 = V_75 && V_75 -> V_183 ;
V_71 -> V_184 = ( V_46 -> V_183 ) ? L_28 :
L_29 ;
snprintf ( V_46 -> V_185 , sizeof( V_46 -> V_185 ) , L_30 ,
V_31 -> V_56 -> V_186 , V_31 -> V_53 ) ;
V_71 -> V_185 = V_46 -> V_185 ;
V_71 -> V_79 . V_187 = V_188 ;
V_71 -> V_26 . V_189 = & V_31 -> V_26 ;
V_71 -> V_190 = F_58 ;
V_71 -> V_191 = F_60 ;
V_46 -> V_31 = V_31 ;
V_46 -> V_71 = V_71 ;
...
if ( error )
goto V_182;
F_65 ( V_192 , V_71 -> V_193 ) ;
F_65 ( V_194 , V_71 -> V_193 ) ;
F_65 ( V_195 , V_71 -> V_196 ) ;
if ( V_46 -> V_183 ) {
int V_63 ;
F_65 ( V_197 , V_71 -> V_198 ) ;
F_65 ( V_199 , V_71 -> V_198 ) ;
for ( V_63 = 0 ; V_63 < V_74 ; V_63 ++ )
if ( V_75 -> V_76 [ V_63 ] != V_77 )
F_65 ( V_75 -> V_76 [ V_63 ] , V_71 -> V_196 ) ;
F_65 ( V_200 , V_71 -> V_196 ) ;
F_65 ( V_201 , V_71 -> V_196 ) ;
F_65 ( V_202 , V_71 -> V_196 ) ;
F_65 ( V_203 , V_71 -> V_196 ) ;
F_65 ( V_204 , V_71 -> V_196 ) ;
F_66 ( V_71 , V_205 , V_206 ) ;
F_66 ( V_71 , V_207 , V_206 ) ;
F_66 ( V_71 , V_96 ,
V_206 ) ;
F_66 ( V_71 , V_97 ,
V_206 ) ;
...
F_67 ( V_71 , V_208 ,
0 , 255 , 0 , 0 ) ;
V_181 = V_46 -> V_103 - V_46 -> V_102 + 1 ;
error = F_68 ( V_71 , V_181 , 0 ) ;
if ( error )
goto V_209;
F_67 ( V_71 , V_99 ,
0 , V_210 , 0 , 0 ) ;
...
F_69 ( V_71 , V_46 ) ;
F_70 ( V_31 , V_46 ) ;
error = F_71 ( V_31 -> V_104 , NULL , F_29 ,
V_75 -> V_211 | V_212 ,
V_31 -> V_184 , V_46 ) ;
if ( error ) {
F_7 ( & V_31 -> V_26 , L_31 ) ;
...
if ( error )
goto V_213;
error = F_73 ( & V_31 -> V_26 . V_214 , & V_215 ) ;
if ( error )
goto V_216;
return 0 ;
V_216:
...
{
struct V_61 * V_46 = F_78 ( V_31 ) ;
F_79 ( & V_31 -> V_26 . V_214 , & V_215 ) ;
F_75 ( V_46 -> V_104 , V_46 ) ;
F_74 ( V_46 -> V_71 ) ;
F_16 ( V_46 -> V_66 ) ;
F_16 ( V_46 ) ;
return 0 ;
