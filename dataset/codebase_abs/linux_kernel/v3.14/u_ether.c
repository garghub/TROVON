...
V_14 = F_78 ( V_9 ) ;
if ( V_14 < 0 ) {
F_79 ( & V_130 -> V_12 , L_22 , V_14 ) ;
F_80 ( V_9 ) ;
V_12 = F_69 ( V_14 ) ;
} else {
F_81 ( V_12 , L_23 , V_9 -> V_126 ) ;
F_81 ( V_12 , L_24 , V_12 -> V_134 ) ;
F_82 ( V_9 ) ;
}
return V_12 ;
}
struct V_8 * F_83 ( const char * V_133 )
{
struct V_8 * V_9 ;
struct V_11 * V_12 ;
V_9 = F_68 ( sizeof( * V_12 ) ) ;
...
V_142 . V_144 = V_9 -> type ;
memcpy ( V_142 . V_145 , V_12 -> V_140 , V_128 ) ;
F_86 () ;
V_14 = F_87 ( V_9 , & V_142 ) ;
F_88 () ;
if ( V_14 )
...
F_81 ( V_12 , L_23 , V_12 -> V_140 ) ;
return V_14 ;
}
void F_89 ( struct V_8 * V_9 , struct V_1 * V_130 )
{
struct V_11 * V_12 ;
V_12 = F_4 ( V_9 ) ;
V_12 -> V_2 = V_130 ;
...
int F_90 ( struct V_8 * V_9 , const char * V_126 )
{
struct V_11 * V_12 ;
T_5 V_146 [ V_128 ] ;
V_12 = F_4 ( V_9 ) ;
if ( F_62 ( V_126 , V_146 ) )
return - V_129 ;
memcpy ( V_12 -> V_140 , V_146 , V_128 ) ;
return 0 ;
}
int F_91 ( struct V_8 * V_9 , char * V_126 , int V_69 )
{
struct V_11 * V_12 ;
V_12 = F_4 ( V_9 ) ;
return F_66 ( V_12 -> V_140 , V_126 , V_69 ) ;
}
int F_92 ( struct V_8 * V_9 , const char * V_131 )
{
struct V_11 * V_12 ;
T_5 V_146 [ V_128 ] ;
V_12 = F_4 ( V_9 ) ;
...
int F_94 ( struct V_8 * V_9 , char * V_131 , int V_69 )
{
struct V_11 * V_12 ;
if ( V_69 < 13 )
return - V_129 ;
...
void F_95 ( struct V_8 * V_9 , T_5 V_134 [ V_128 ] )
{
struct V_11 * V_12 ;
V_12 = F_4 ( V_9 ) ;
...
int F_98 ( struct V_8 * V_9 , char * V_28 , int V_69 )
{
F_86 () ;
F_8 ( V_28 , F_99 ( V_9 ) , V_69 ) ;
F_88 () ;
return strlen ( V_28 ) ;
}
...
struct V_8 * F_103 ( struct V_91 * V_92 )
{
struct V_11 * V_12 = V_92 -> V_147 ;
int V_148 = 0 ;
if ( ! V_12 )
return F_69 ( - V_129 ) ;
V_92 -> V_94 -> V_65 = V_12 ;
V_148 = F_61 ( V_92 -> V_94 ) ;
if ( V_148 != 0 ) {
F_13 ( V_12 , L_27 ,
V_92 -> V_94 -> V_28 , V_148 ) ;
goto V_149;
}
V_92 -> V_43 -> V_65 = V_12 ;
V_148 = F_61 ( V_92 -> V_43 ) ;
if ( V_148 != 0 ) {
F_13 ( V_12 , L_27 ,
V_92 -> V_43 -> V_28 , V_148 ) ;
goto V_150;
}
if ( V_148 == 0 )
V_148 = F_37 ( V_12 , V_92 , F_1 ( V_12 -> V_2 ,
V_12 -> V_3 ) ) ;
if ( V_148 == 0 ) {
V_12 -> V_115 = V_92 -> V_151 ;
