...
static int F_57 ( struct V_17 * V_23 , char * V_75 , int V_76 , T_1 V_77 ,
T_1 V_78 )
{
char V_79 [ 27 ] ;
...
struct V_39 * V_40 ;
int V_81 ;
V_81 = F_58 ( V_75 , V_76 , L_14 , V_23 -> V_4 , V_23 -> V_5 ) ;
if ( V_77 == 2 ) {
...
static int V_55 ( struct V_19 * V_29 , char * V_75 , int V_76 , T_1 V_77 ,
...
if ( ( V_82 <= V_23 -> V_5 ) && ( V_83 >= V_23 -> V_4 ) ) {
V_81 += F_58 ( V_75 + V_81 , V_76 - V_81 , L_23 ,
V_84 ) ;
F_38 ( & V_29 -> V_24 ) ;
V_81 += F_57 ( V_23 , V_75 + V_81 , V_76 - V_81 ,
V_77 , V_78 ) ;
F_43 ( & V_29 -> V_24 ) ;
...
static void F_75 ( struct V_19 * V_29 )
{
...
F_48 ( & V_65 ) ;
for ( V_86 = 0 ; V_86 < V_2 ; V_86 ++ ) {
if ( F_77 ( & V_59 . V_60 [ V_86 ] ) )
continue;
V_21 = & V_59 . V_60 [ V_86 ] ;
F_78 (seq, safe, seq_head, ns_list) {
F_75 ( V_29 ) ;
}
continue;
}
