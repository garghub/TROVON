...
return - V_92 ;
V_65 = V_5 ( V_3 ) ;
return ( V_65 -> V_66 . V_4 . V_40 == V_40 ||
V_65 -> V_66 . V_4 . V_80 ) ? 0 : - V_92 ;
}
static int F_64 ( struct V_5 * V_78 ,
struct V_39 * V_40 ,
T_1 V_93 )
{
...
if ( F_36 ( V_32 != 0 ) )
return V_32 ;
V_32 = F_69 ( V_40 , & V_78 -> V_66 . V_4 ,
V_79 , & V_94 ) ;
if ( V_32 != 0 || V_94 )
F_56 ( & V_78 -> V_7 . V_4 ) ;
return V_32 ;
}
static int F_70 ( T_1 V_41 ,
struct V_39 * V_40 ,
T_1 V_93 )
{
if ( ! ( V_93 & V_95 ) )
return F_71 ( V_40 , V_41 ,
V_79 ) ;
return 0 ;
}
int F_72 ( struct V_98 * V_99 , void * V_100 ,
struct V_101 * V_102 )
{
struct V_103 * V_104 =
(struct V_103 * ) V_100 ;
struct V_1 * V_105 ;
struct V_5 * V_78 ;
struct V_39 * V_40 = F_73 ( V_102 ) -> V_40 ;
int V_32 ;
...
V_7 ) ;
V_32 = F_64 ( V_78 , V_40 , V_104 -> V_93 ) ;
F_15 ( & V_105 ) ;
...
int F_74 ( struct V_98 * V_99 , void * V_100 ,
struct V_101 * V_102 )
{
struct V_11 * V_12 = F_75 ( V_99 ) ;
union V_113 * V_104 =
(union V_113 * ) V_100 ;
...
struct V_1 * V_105 ;
T_1 V_41 ;
struct V_118 * V_119 = V_118 ( V_102 -> V_120 ) ;
int V_32 ;
V_32 = F_76 ( & V_119 -> V_121 , true ) ;
if ( F_36 ( V_32 != 0 ) )
return V_32 ;
V_32 = F_58 ( V_12 , F_73 ( V_102 ) -> V_40 ,
V_115 -> V_53 , false , & V_41 , & V_105 ) ;
if ( F_36 ( V_32 != 0 ) )
goto V_122;
V_117 -> V_41 = V_41 ;
V_117 -> V_123 = F_77 ( & V_105 -> V_4 . V_124 ) ;
V_117 -> V_125 = V_41 ;
V_117 -> V_126 = 0 ;
F_15 ( & V_105 ) ;
V_122:
...
int F_79 ( struct V_98 * V_99 , void * V_100 ,
struct V_101 * V_102 )
{
struct V_127 * V_104 =
(struct V_127 * ) V_100 ;
return F_71 ( F_73 ( V_102 ) -> V_40 ,
V_104 -> V_41 ,
V_128 ) ;
}
int F_43 ( struct V_39 * V_40 ,
T_1 V_41 , struct V_1 * * V_129 )
{
struct V_5 * V_65 ;
struct V_44 * V_4 ;
V_4 = F_38 ( V_40 , V_41 ) ;
...
* V_41 = V_78 -> V_66 . V_4 . V_89 . V_90 ;
return F_69 ( V_40 , & V_78 -> V_66 . V_4 ,
V_128 , NULL ) ;
}
...
int V_32 ;
F_83 ( L_7 , V_134 ) ;
V_133 = F_1 ( V_9 , struct V_132 , V_9 ) ;
V_32 = F_84 ( V_12 , V_133 -> V_135 ) ;
F_85 ( V_32 != 0 ) ;
}
...
{
struct V_137 * V_133 =
F_1 ( V_9 , struct V_137 , V_133 . V_9 ) ;
struct V_11 * V_12 = V_9 -> V_12 ;
F_89 ( V_133 , V_4 ) ;
F_90 ( F_91 ( V_12 ) ,
V_138 ) ;
}
static void F_92 ( struct V_44 * * V_75 )
{
struct V_44 * V_4 = * V_75 ;
struct V_137 * V_133 =
F_1 ( V_4 , struct V_137 , V_4 ) ;
struct V_8 * V_9 = & V_133 -> V_133 . V_9 ;
* V_75 = NULL ;
F_21 ( & V_9 ) ;
}
int F_93 ( struct V_98 * V_99 , void * V_100 ,
struct V_101 * V_102 )
{
struct V_11 * V_12 = F_75 ( V_99 ) ;
struct V_8 * V_9 ;
struct V_137 * V_133 ;
struct V_139 * V_104 = (struct V_139 * ) V_100 ;
struct V_39 * V_40 = F_73 ( V_102 ) -> V_40 ;
struct V_13 * V_13 = & V_12 -> V_14 [ V_140 ] ;
int V_32 = 0 ;
V_9 = F_32 ( V_12 , V_13 , V_104 -> V_135 ) ;
if ( F_36 ( V_9 == NULL ) )
return - V_45 ;
if ( V_9 -> V_30 != & F_88 ) {
V_32 = - V_45 ;
...
V_133 = F_1 ( V_9 , struct V_137 , V_133 . V_9 ) ;
if ( V_133 -> V_4 . V_40 != V_40 ) {
V_32 = - V_45 ;
goto V_129;
}
F_71 ( V_40 , V_133 -> V_4 . V_89 . V_90 , V_128 ) ;
V_129:
F_21 ( & V_9 ) ;
return V_32 ;
}
...
V_9 = & V_133 -> V_133 . V_9 ;
V_133 -> V_4 . V_80 = false ;
V_133 -> V_4 . V_40 = NULL ;
V_32 = F_86 ( V_12 , & V_133 -> V_133 , F_88 ) ;
if ( F_36 ( V_32 != 0 ) )
goto V_141;
V_82 = F_2 ( V_9 ) ;
V_32 = F_97 ( V_40 , & V_133 -> V_4 , false , V_142 ,
& F_92 , NULL ) ;
if ( F_36 ( V_32 != 0 ) ) {
F_21 ( & V_82 ) ;
goto V_143;
}
V_104 -> V_135 = V_9 -> V_18 ;
V_143:
F_21 ( & V_9 ) ;
V_141:
F_78 ( & V_119 -> V_121 ) ;
...
struct V_39 * V_40 ,
T_1 * V_144 , struct V_8 * * V_129 )
{
struct V_137 * V_133 ;
struct V_8 * V_9 ;
int V_32 ;
V_9 = F_32 ( V_12 , & V_12 -> V_14 [ V_140 ] ,
* V_144 ) ;
if ( F_36 ( V_9 == NULL ) )
return - V_45 ;
if ( V_9 -> V_30 != & F_88 ) {
...
struct V_1 * V_105 ;
int V_32 ;
args -> V_147 = args -> V_148 * ( ( args -> V_149 + 7 ) / 8 ) ;
args -> V_53 = args -> V_147 * args -> V_150 ;
V_32 = F_76 ( & V_119 -> V_121 , true ) ;
if ( F_36 ( V_32 != 0 ) )
return V_32 ;
V_32 = F_58 ( V_12 , F_73 ( V_102 ) -> V_40 ,
...
{
unsigned long V_53 =
( V_9 -> V_152 + V_153 - 1 ) & V_154 ;
struct V_1 * V_21 ;
int V_32 ;
if ( F_16 ( V_9 -> V_21 ) ) {
F_24 ( V_9 -> V_21 -> V_4 . V_57 * V_153 < V_53 ) ;
return 0 ;
}
V_21 = F_59 ( sizeof( * V_21 ) , V_33 ) ;
if ( F_36 ( V_21 == NULL ) )
return - V_83 ;
V_32 = F_50 ( V_9 -> V_12 , V_21 , V_9 -> V_152 ,
V_9 -> V_15 -> V_155 ,
V_69 ,
& F_47 ) ;
if ( F_36 ( V_32 != 0 ) )
...
if ( V_15 -> V_157 &&
( ( V_15 -> V_158 && F_13 ( & V_9 -> V_22 ) &&
V_25 -> V_3 != NULL ) ||
( ! V_15 -> V_158 && V_25 -> V_3 != NULL ) ) ) {
V_32 = V_15 -> V_157 ( V_9 , V_25 ) ;
if ( F_36 ( V_32 != 0 ) )
goto V_159;
if ( V_15 -> V_158 )
F_104 ( & V_9 -> V_22 , & V_9 -> V_21 -> V_73 ) ;
}
V_9 -> V_38 = true ;
return 0 ;
V_159:
...
if ( ! F_13 ( & V_9 -> V_20 ) )
return;
if ( V_160 && V_160 != V_9 -> V_21 ) {
if ( V_9 -> V_21 ) {
F_106 ( & V_9 -> V_21 -> V_4 . V_162 -> V_121 . V_4 ) ;
F_11 ( & V_9 -> V_22 ) ;
F_15 ( & V_9 -> V_21 ) ;
}
V_9 -> V_21 = F_107 ( V_160 ) ;
F_106 ( & V_160 -> V_4 . V_162 -> V_121 . V_4 ) ;
F_104 ( & V_9 -> V_22 , & V_160 -> V_73 ) ;
}
if ( V_160 )
V_9 -> V_37 = V_161 ;
if ( ! V_9 -> V_15 -> V_163 || V_9 -> V_18 == - 1 )
return;
F_7 ( & V_12 -> V_17 ) ;
F_104 ( & V_9 -> V_20 ,
& V_9 -> V_12 -> V_164 [ V_9 -> V_15 -> V_16 ] ) ;
F_9 ( & V_12 -> V_17 ) ;
}
static int
...
F_104 ( & V_25 -> V_167 , & V_166 ) ;
V_32 = F_109 ( NULL , & V_166 ) ;
if ( F_36 ( V_32 != 0 ) )
goto V_168;
if ( V_9 -> V_15 -> V_158 && F_13 ( & V_9 -> V_22 ) )
return 0 ;
V_26 = V_9 -> V_26 ;
V_32 = F_110 ( & V_9 -> V_21 -> V_4 ,
V_9 -> V_15 -> V_155 ,
true , false ) ;
if ( F_36 ( V_32 != 0 ) )
goto V_169;
...
int F_112 ( struct V_8 * V_9 , bool V_170 )
{
struct V_11 * V_12 = V_9 -> V_12 ;
int V_32 ;
F_7 ( & V_12 -> V_17 ) ;
F_11 ( & V_9 -> V_20 ) ;
F_9 ( & V_12 -> V_17 ) ;
if ( V_9 -> V_15 -> V_158 && V_9 -> V_21 == NULL &&
! V_170 ) {
V_32 = F_102 ( V_9 , true ) ;
if ( F_36 ( V_32 != 0 ) )
return V_32 ;
...
int F_114 ( struct V_8 * V_9 , bool V_69 )
{
struct V_24 V_25 ;
const struct V_36 * V_15 = V_9 -> V_15 ;
int V_32 ;
...
struct V_8 * V_172 ;
struct V_11 * V_12 = V_9 -> V_12 ;
struct V_165 * V_173 = & V_12 -> V_164 [ V_9 -> V_15 -> V_16 ] ;
struct V_24 V_25 ;
unsigned V_174 = 0 ;
if ( F_16 ( ! V_9 -> V_15 -> V_163 ) )
return 0 ;
V_25 . V_3 = NULL ;
if ( V_9 -> V_21 )
...
V_172 = F_2
( F_116 ( V_173 , struct V_8 ,
V_20 ) ) ;
F_11 ( & V_172 -> V_20 ) ;
F_9 ( & V_12 -> V_17 ) ;
V_32 = F_114 ( V_172 , true ) ;
if ( F_36 ( V_32 != 0 ) ) {
F_7 ( & V_12 -> V_17 ) ;
F_104 ( & V_172 -> V_20 , V_173 ) ;
F_9 ( & V_12 -> V_17 ) ;
if ( V_32 == - V_110 ||
++ V_174 > V_176 ) {
F_21 ( & V_172 ) ;
...
if ( F_36 ( V_32 != 0 ) )
goto V_169;
else if ( ! V_9 -> V_15 -> V_158 && V_9 -> V_21 ) {
F_11 ( & V_9 -> V_22 ) ;
F_15 ( & V_9 -> V_21 ) ;
}
return 0 ;
...
{
struct V_70 * V_71 = V_3 -> V_71 ;
struct V_179 * V_180 = V_71 -> V_180 ;
struct V_177 * V_181 ;
struct V_11 * V_12 =
F_1 ( V_71 , struct V_11 , V_71 ) ;
if ( V_178 == NULL )
F_118 ( NULL , V_12 , & V_178 , NULL ) ;
else
V_180 -> V_182 ( V_178 ) ;
F_65 ( & V_71 -> V_96 ) ;
V_181 = V_3 -> V_183 ;
...
F_65 ( & V_71 -> V_96 ) ;
( void ) F_66 ( V_3 , false , false , false ) ;
F_67 ( & V_71 -> V_96 ) ;
}
}
bool F_122 ( const struct V_8 * V_9 )
{
return V_9 -> V_15 -> V_158 ;
}
static void F_123 ( struct V_11 * V_12 ,
enum V_189 type )
{
struct V_165 * V_173 = & V_12 -> V_164 [ type ] ;
struct V_8 * V_172 ;
unsigned V_174 = 0 ;
int V_32 ;
do {
