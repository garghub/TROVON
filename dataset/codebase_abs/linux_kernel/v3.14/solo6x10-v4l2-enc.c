...
{
struct V_1 * V_2 = F_100 ( V_138 ) ;
return F_114 ( V_2 -> V_3 , V_156 & V_183 ) ;
}
...
static inline int F_118 ( T_3 V_20 , T_1 V_207 , T_1 V_208 )
{
if ( ! V_207 || ! V_208 )
return 1 ;
if ( V_208 == V_20 )
...
if ( F_120 ( & V_2 -> V_179 ) )
return - V_45 ;
V_2 -> V_21 = F_118 ( V_20 , V_210 -> V_193 , V_210 -> V_194 ) ;
F_10 ( V_2 ) ;
return F_117 ( V_138 , V_139 , V_197 ) ;
}
static long F_121 ( struct V_138 * V_138 , void * V_211 ,
...
{
struct V_1 * V_2 =
F_86 ( V_224 -> V_225 , struct V_1 , V_226 ) ;
struct V_3 * V_3 = V_2 -> V_3 ;
int V_136 ;
switch ( V_224 -> V_227 ) {
case V_228 :
...
case V_231 :
case V_232 :
return F_124 ( V_3 , V_224 -> V_227 , V_2 -> V_5 ,
V_224 -> V_233 ) ;
case V_234 :
...
return 0 ;
return F_125 ( V_3 , V_2 -> V_5 , V_224 -> V_233 ) ;
case V_237 :
...
F_133 ( V_226 , & V_247 , NULL ) ;
F_133 ( V_226 , & V_248 , NULL ) ;
F_133 ( V_226 , & V_249 , NULL ) ;
if ( V_226 -> error ) {
V_8 = V_226 -> error ;
goto V_250;
}
...
F_139 ( V_274 , & V_2 -> V_157 -> V_6 ) ;
F_140 ( V_2 -> V_157 , V_2 ) ;
V_8 = F_141 ( V_2 -> V_157 , V_275 , V_240 ) ;
if ( V_8 < 0 )
goto V_276;
...
int F_148 ( struct V_3 * V_3 , unsigned V_240 )
{
int V_61 ;
F_149 ( & V_3 -> V_107 ) ;
...
V_3 -> V_114 [ V_61 ] = F_127 ( V_3 , V_61 , V_240 ) ;
