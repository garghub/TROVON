...
unsigned long V_191 ;
int V_107 ;
V_146 = F_108 ( sizeof( struct V_1 ) , V_188 ) ;
if ( V_146 == NULL ) {
F_40 ( V_33 , L_24 ) ;
V_107 = - V_171 ;
goto V_192;
...
F_109 ( V_184 , V_146 ) ;
F_110 ( & V_146 -> V_193 ) ;
F_111 ( & V_146 -> V_120 , F_87 ,
( unsigned long ) V_146 ) ;
F_112 ( & V_146 -> V_129 , V_194 ) ;
V_146 -> V_144 = - 1 ;
V_190 = F_113 ( V_184 , V_195 , 0 ) ;
if ( ! V_190 ) {
F_40 ( V_33 , L_25 ) ;
V_107 = - V_196 ;
goto V_197;
...
V_191 = F_114 ( V_190 ) ;
V_146 -> V_144 = F_115 ( V_184 , 0 ) ;
if ( V_146 -> V_144 < 0 ) {
F_40 ( V_33 , L_26 ) ;
V_107 = V_146 -> V_144 ;
goto V_197;
}
V_107 = F_116 ( V_146 -> V_144 , F_88 , V_199 , L_27 ,
V_146 ) ;
if ( V_107 ) {
F_40 ( V_33 , L_28 ) ;
goto V_197;
}
V_146 -> V_117 = F_117 ( & V_184 -> V_33 , L_29 ) ;
if ( F_79 ( V_146 -> V_117 ) ) {
F_40 ( V_33 , L_30 ) ;
V_107 = F_81 ( V_146 -> V_117 ) ;
goto V_200;
}
V_146 -> V_4 = F_118 ( V_146 -> V_178 , V_191 ) ;
if ( ! V_146 -> V_4 ) {
F_40 ( V_33 , L_31 ) ;
V_107 = - V_171 ;
goto V_201;
...
goto V_205;
F_62 ( V_33 , L_33 ,
F_119 ( V_146 -> V_92 . V_96 ) ) ;
}
F_120 ( & V_31 . V_32 ) ;
F_121 ( & V_146 -> V_193 , & V_31 . V_206 ) ;
F_122 ( & V_31 . V_32 ) ;
V_107 = F_93 ( V_146 ) ;
if ( V_107 )
goto V_207;
