...
V_127 = V_130 ;
if ( ! F_86 ( V_3 , & V_131 ) ) {
V_127 = F_87 ( V_127 , sizeof( V_130 ) , V_132 ) ;
if ( V_127 == NULL )
goto V_133;
V_127 [ 0 ] . V_114 = & V_3 -> V_4 . V_5 . V_134 ;
V_127 [ 1 ] . V_114 = & V_3 -> V_4 . V_5 . V_135 ;
V_127 [ 2 ] . V_114 = & V_3 -> V_4 . V_5 . V_64 ;
if ( V_3 -> V_136 != & V_137 )
V_127 [ 0 ] . V_138 = NULL ;
}
V_129 = F_88 ( V_3 , L_3 , V_127 ) ;
if ( V_129 == NULL )
goto V_139;
V_3 -> V_4 . V_140 = V_129 ;
return 0 ;
...
{
struct V_126 * V_127 ;
V_127 = V_3 -> V_4 . V_140 -> V_141 ;
F_91 ( V_3 -> V_4 . V_140 ) ;
F_89 ( V_127 ) ;
}
static void F_92 ( void )
{
F_88 ( & V_131 , L_3 , V_142 ) ;
}
...
{
V_3 -> V_4 . V_5 . V_134 = 4 * 1024 * 1024 ;
V_3 -> V_4 . V_5 . V_135 = 3 * 1024 * 1024 ;
V_3 -> V_4 . V_5 . V_64 = V_143 ;
F_94 ( & V_3 -> V_4 . V_5 ) ;
return F_85 ( V_3 ) ;
}
...
V_11 . V_147 = F_13 ;
V_11 . V_148 = NULL ;
V_11 . V_149 = sizeof( struct V_18 ) ;
V_11 . V_150 = F_10 ;
V_11 . V_151 = F_22 ;
V_11 . V_152 = 10 * 60 * V_153 ;
F_99 ( & V_11 ) ;
}
