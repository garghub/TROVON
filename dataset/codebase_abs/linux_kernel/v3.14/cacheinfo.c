...
V_60 = V_62 - 2 ;
if ( V_60 > 1 ) {
V_61 = F_58 ( V_54 , V_60 , & V_5 -> V_19 ) ;
V_54 [ V_61 ++ ] = '\n' ;
V_54 [ V_61 ] = '\0' ;
}
return V_61 ;
}
static void F_59 ( struct V_1 * V_63 )
{
const char * V_64 ;
const char * V_65 ;
struct V_5 * V_5 ;
...
V_64 = V_5 -> V_10 -> V_16 ;
V_65 = F_3 ( V_5 ) ;
for ( V_26 = 0 ; V_26 < F_26 ( V_66 ) ; V_26 ++ ) {
struct V_55 * V_53 ;
T_2 V_67 ;
V_53 = V_66 [ V_26 ] ;
...
if ( F_61 ( & V_63 -> V_4 , & V_53 -> V_53 ) )
F_14 ( L_20 ,
V_53 -> V_53 . V_7 , V_64 , V_65 ) ;
}
F_17 ( V_54 ) ;
}
static void F_62 ( struct V_5 * V_5 , int V_51 ,
struct V_47 * V_47 )
{
struct V_1 * V_68 ;
int V_67 ;
...
static struct V_5 * F_66 ( unsigned int V_43 )
{
struct V_9 * V_44 ;
struct V_5 * V_5 ;
V_44 = F_42 ( V_43 , NULL ) ;
...
static void F_70 ( struct V_5 * V_5 , int V_17 )
{
while ( V_5 ) {
