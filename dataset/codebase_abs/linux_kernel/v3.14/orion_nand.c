...
if ( V_28 -> V_42 . V_44 ) {
V_9 = F_11 ( & V_28 -> V_42 , sizeof( struct V_8 ) ,
V_36 ) ;
if ( ! V_9 ) {
V_34 = - V_37 ;
goto V_38;
}
if ( ! F_12 ( V_28 -> V_42 . V_44 , L_3 , & V_35 ) )
V_9 -> V_13 = ( V_45 ) V_35 ;
else
V_9 -> V_13 = 0 ;
if ( ! F_12 ( V_28 -> V_42 . V_44 , L_4 , & V_35 ) )
V_9 -> V_15 = ( V_45 ) V_35 ;
else
V_9 -> V_15 = 1 ;
if ( ! F_12 ( V_28 -> V_42 . V_44 ,
L_5 , & V_35 ) )
V_9 -> V_46 = ( V_45 ) V_35 * 8 ;
else
V_9 -> V_46 = 8 ;
if ( ! F_12 ( V_28 -> V_42 . V_44 ,
L_6 , & V_35 ) )
