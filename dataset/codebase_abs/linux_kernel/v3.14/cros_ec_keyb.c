...
static int F_8 ( struct V_14 * V_10 )
{
struct V_1 * V_2 = F_9 ( V_10 ) ;
return F_10 ( & V_2 -> V_25 -> V_26 ,
& V_2 -> V_27 ) ;
}
static void F_11 ( struct V_14 * V_10 )
{
struct V_1 * V_2 = F_9 ( V_10 ) ;
F_12 ( & V_2 -> V_25 -> V_26 ,
& V_2 -> V_27 ) ;
...
{
int V_34 ;
struct V_1 * V_2 = F_15 ( V_31 , struct V_1 ,
V_27 ) ;
T_1 V_12 [ V_2 -> V_9 ] ;
V_34 = F_13 ( V_2 , V_12 ) ;
if ( V_34 >= 0 )
...
{
struct V_38 * V_25 = F_17 ( V_37 -> V_10 . V_39 ) ;
...
if ( ! V_42 )
return - V_45 ;
V_2 = F_18 ( & V_37 -> V_10 , sizeof( * V_2 ) , V_46 ) ;
if ( ! V_2 )
return - V_47 ;
V_43 = F_19 ( & V_37 -> V_10 , & V_2 -> V_11 ,
& V_2 -> V_9 ) ;
if ( V_43 )
return V_43 ;
V_2 -> V_24 = F_18 ( & V_37 -> V_10 , V_2 -> V_9 , V_46 ) ;
if ( ! V_2 -> V_24 )
return - V_47 ;
V_15 = F_20 ( & V_37 -> V_10 ) ;
if ( ! V_15 )
...
V_2 -> V_19 = F_23 ( V_42 ,
L_4 ) ;
V_43 = F_24 ( NULL , NULL , V_2 -> V_11 , V_2 -> V_9 ,
NULL , V_15 ) ;
if ( V_43 ) {
F_25 ( V_10 , L_5 ) ;
return V_43 ;
}
V_2 -> V_21 = F_26 ( V_2 -> V_9 ) ;
F_27 ( V_15 , V_62 , V_63 ) ;
F_28 ( V_15 , V_2 ) ;
V_2 -> V_15 = V_15 ;
V_43 = F_29 ( V_2 -> V_15 ) ;
...
V_64 = V_66 - V_64 ;
F_31 ( V_2 -> V_10 , L_7 , V_65 ,
F_32 ( V_64 ) ) ;
}
static int F_33 ( struct V_40 * V_10 )
{
