...
{
return F_26 ( V_41 , V_42 , L_11 , * ( ( char * * ) V_38 -> V_39 ) ) ;
}
static void F_27 ( void * V_39 )
{
F_4 ( * ( ( char * * ) V_39 ) ) ;
}
int F_28 ( const char * V_7 , const struct V_15 * V_38 )
{
if ( ! V_7 ) V_7 = L_12 ;
return F_29 ( V_7 , V_38 -> V_39 ) ;
}
int F_30 ( char * V_41 , const struct V_15 * V_38 )
{
return sprintf ( V_41 , L_13 , * ( bool * ) V_38 -> V_39 ? 'Y' : 'N' ) ;
}
int F_31 ( const char * V_7 , const struct V_15 * V_38 )
{
int V_35 ;
bool V_43 ;
struct V_15 V_44 ;
...
int F_32 ( char * V_41 , const struct V_15 * V_38 )
{
return sprintf ( V_41 , L_13 , ( * ( bool * ) V_38 -> V_39 ) ? 'N' : 'Y' ) ;
}
int F_33 ( const char * V_7 , const struct V_15 * V_38 )
{
struct V_15 V_45 ;
bool V_46 ;
int V_35 ;
...
static int F_34 ( const char * V_21 ,
const char * V_7 ,
...
static int F_37 ( const char * V_7 , const struct V_15 * V_38 )
{
const struct V_53 * V_54 = V_38 -> V_54 ;
unsigned int V_55 ;
return F_34 ( V_38 -> V_21 , V_7 , 1 , V_54 -> V_48 , V_54 -> V_49 ,
V_54 -> V_50 , V_54 -> V_23 -> V_27 , V_38 -> V_22 ,
V_54 -> V_34 ? : & V_55 ) ;
}
static int F_38 ( char * V_41 , const struct V_15 * V_38 )
{
int V_13 , V_56 , V_35 ;
const struct V_53 * V_54 = V_38 -> V_54 ;
struct V_15 V_3 ;
...
int F_40 ( const char * V_7 , const struct V_15 * V_38 )
{
...
int F_41 ( char * V_41 , const struct V_15 * V_38 )
{
const struct V_58 * V_59 = V_38 -> V_60 ;
return F_42 ( V_41 , V_59 -> string , V_59 -> V_61 ) ;
}
static T_3 F_43 ( struct V_62 * V_63 ,
...
static T_3 F_45 ( struct V_62 * V_63 ,
struct V_64 * V_71 ,
...
static T_4 int F_48 ( struct V_64 * V_65 ,
...
V_74 = F_49 ( V_74 , sizeof( V_73 -> V_77 . V_74 [ 0 ] ) * ( V_34 + 2 ) , V_4 ) ;
if ( ! V_74 ) {
V_20 = - V_40 ;
goto V_79;
}
...
V_73 -> V_77 . V_21 = L_19 ;
V_73 -> V_77 . V_74 = V_74 ;
F_50 ( & V_73 -> V_74 [ V_34 ] . V_63 . V_80 ) ;
V_73 -> V_74 [ V_34 ] . V_8 = V_38 ;
V_73 -> V_74 [ V_34 ] . V_63 . V_81 = F_43 ;
V_73 -> V_74 [ V_34 ] . V_63 . V_82 = F_45 ;
...
if ( V_86 [ V_13 ] . V_75 == 0 )
continue;
V_20 = F_48 ( & V_85 -> V_87 , & V_86 [ V_13 ] , V_86 [ V_13 ] . V_21 ) ;
if ( V_20 )
return V_20 ;
V_16 = true ;
}
if ( ! V_16 )
return 0 ;
V_20 = F_53 ( & V_85 -> V_87 . V_88 , & V_85 -> V_87 . V_76 -> V_77 ) ;
if ( V_20 )
F_51 ( & V_85 -> V_87 ) ;
return V_20 ;
}
...
{
if ( V_85 -> V_87 . V_76 ) {
F_55 ( & V_85 -> V_87 . V_88 , & V_85 -> V_87 . V_76 -> V_77 ) ;
F_51 ( & V_85 -> V_87 ) ;
}
}
void F_56 ( const struct V_15 * V_16 , unsigned V_34 )
{
unsigned int V_13 ;
...
static struct V_64 * T_5 F_57 ( const char * V_21 )
{
struct V_64 * V_65 ;
struct V_89 * V_88 ;
int V_20 ;
...
V_65 = F_60 ( sizeof( struct V_64 ) , V_4 ) ;
F_35 ( ! V_65 ) ;
V_65 -> V_85 = V_91 ;
V_65 -> V_88 . V_92 = V_90 ;
V_20 = F_61 ( & V_65 -> V_88 , & V_93 , NULL ,
L_11 , V_21 ) ;
#ifdef F_62
if ( ! V_20 )
V_20 = F_63 ( & V_65 -> V_88 , & V_94 . V_80 ) ;
#endif
if ( V_20 ) {
F_64 ( & V_65 -> V_88 ) ;
F_65 ( L_20 ,
...
static void T_5 F_67 ( const char * V_21 ,
struct V_15 * V_86 ,
unsigned int V_95 )
{
struct V_64 * V_65 ;
...
return;
if ( V_65 -> V_76 )
F_55 ( & V_65 -> V_88 , & V_65 -> V_76 -> V_77 ) ;
V_20 = F_48 ( V_65 , V_86 , V_86 -> V_21 + V_95 ) ;
F_35 ( V_20 ) ;
V_20 = F_53 ( & V_65 -> V_88 , & V_65 -> V_76 -> V_77 ) ;
F_35 ( V_20 ) ;
F_68 ( & V_65 -> V_88 , V_96 ) ;
F_64 ( & V_65 -> V_88 ) ;
}
...
F_42 ( V_98 , V_38 -> V_21 , V_97 ) ;
}
F_67 ( V_98 , V_38 , V_97 ) ;
}
}
T_3 F_70 ( struct V_62 * V_63 ,
struct V_64 * V_65 , char * V_66 )
{
struct V_103 * V_104 =
F_71 ( V_63 , struct V_103 , V_63 ) ;
return F_26 ( V_66 , V_42 , L_22 , V_104 -> V_105 ) ;
}
...
V_65 = F_57 ( V_104 -> V_108 ) ;
if ( V_65 ) {
V_20 = F_63 ( & V_65 -> V_88 , & V_104 -> V_63 . V_80 ) ;
F_68 ( & V_65 -> V_88 , V_96 ) ;
F_64 ( & V_65 -> V_88 ) ;
}
}
}
static T_3 F_73 ( struct V_89 * V_88 ,
struct V_69 * V_80 ,
char * V_66 )
{
struct V_62 * V_69 ;
...
static T_3 F_75 ( struct V_89 * V_88 ,
struct V_69 * V_80 ,
const char * V_66 , T_1 V_52 )
{
struct V_62 * V_69 ;
...
static int F_76 ( struct V_92 * V_92 , struct V_89 * V_88 )
{
struct V_110 * V_111 = F_77 ( V_88 ) ;
if ( V_111 == & V_93 )
return 1 ;
return 0 ;
}
static void F_78 ( struct V_89 * V_88 )
{
struct V_64 * V_65 = F_59 ( V_88 ) ;
F_79 ( V_65 -> V_112 ) ;
}
static int T_5 F_80 ( void )
{
V_90 = F_81 ( L_23 , & V_113 , NULL ) ;
if ( ! V_90 ) {
F_82 ( V_114 L_24 ,
__FILE__ , __LINE__ ) ;
return - V_40 ;
