...
static int F_41 ( struct V_80 * V_118 )
{
...
static int F_47 ( struct V_80 * V_118 )
{
struct V_128 V_124 ;
struct V_121 * V_122 ;
...
static T_6 F_76 ( struct V_80 * V_118 ,
...
static T_6 F_77 ( struct V_80 * V_118 ,
struct V_170 * V_171 , const char * V_172 , T_7 V_137 )
{
...
static T_6 F_79 ( struct V_80 * V_118 , struct V_170 * V_171 ,
char * V_172 )
{
F_4 ( L_18 ,
V_173 -> V_174 ) ;
...
default:
F_30 ( L_28 ,
V_82 . V_182 , V_82 . V_185 ) ;
break;
}
}
static T_2
F_85 ( struct V_194 * V_84 ,
struct V_195 * V_82 )
{
T_2 V_22 ;
union V_49 * V_50 ;
struct V_19 V_21 = { sizeof( struct V_194 ) , V_84 } ;
struct V_19 V_89 = { V_48 , NULL } ;
...
* V_82 = * ( (struct V_195 * ) V_50 -> V_52 . V_24 ) ;
F_16 ( V_50 ) ;
return V_22 ;
}
...
static T_2 T_5 F_88 ( T_3 V_198 , T_1 V_55 ,
void * V_199 , void * * V_57 )
{
* ( T_3 * ) V_57 = V_198 ;
return V_30 ;
}
static int T_5 F_89 ( const char * V_158 , const char * V_200 ,
T_3 * V_198 )
{
T_2 V_22 ;
T_3 V_54 ;
...
V_138 -> V_158 = L_34 ;
V_138 -> V_202 = L_35 ;
V_138 -> V_60 . V_203 = V_204 ;
V_138 -> V_205 [ 0 ] = F_93 ( V_206 ) ;
...
V_184 -> V_158 = L_36 ;
V_184 -> V_202 = L_37 ;
V_184 -> V_60 . V_203 = V_204 ;
V_28 = F_100 ( V_184 , V_208 , NULL ) ;
if ( V_28 )
goto V_207;
V_22 = F_101 ( V_169 ,
F_80 , NULL ) ;
...
static int F_106 ( struct V_212 * V_80 )
{
int V_28 ;
if ( F_7 ( V_5 ) ) {
...
static int F_107 ( struct V_212 * V_80 )
{
if ( F_7 ( V_5 ) )
F_43 () ;
if ( F_7 ( V_7 ) )
...
static void F_110 ( struct V_212 * V_80 )
{
struct V_216 * V_152 = & V_1 -> V_152 ;
if ( ! V_152 )
return;
...
static int F_111 ( struct V_212 * V_80 )
{
if ( F_7 ( V_73 ) )
F_112 ( & V_80 -> V_118 , & V_217 ) ;
F_112 ( & V_80 -> V_118 , & V_218 ) ;
return 0 ;
}
...
{
F_116 ( V_1 -> V_221 . V_88 ) ;
F_116 ( V_1 -> V_221 . V_222 ) ;
}
static int F_117 ( void )
{
V_1 -> V_221 . V_222 = F_118 ( L_8 , NULL ) ;
if ( ! V_1 -> V_221 . V_222 ) {
F_50 ( L_38 ) ;
return - V_161 ;
}
V_1 -> V_221 . V_88 = F_119 ( L_39 , V_223 ,
V_1 -> V_221 . V_222 ,
& V_1 -> V_221 . V_224 ) ;
if ( ! V_1 -> V_221 . V_88 )
goto V_225;
