...
static int F_34 ( struct V_42 * V_3 )
{
int V_70 ;
F_35 ( V_3 ) ;
V_70 = F_36 ( V_3 -> V_50 , V_118 , 0 , L_12 , V_3 ) ;
if ( V_70 )
F_15 ( L_13 , V_3 -> V_55 , V_3 -> V_50 ) ;
return V_70 ;
}
static int F_37 ( struct V_42 * V_3 )
{
F_38 ( V_3 -> V_50 , V_3 ) ;
F_39 ( V_3 ) ;
return 0 ;
...
V_89 . V_119 = 0 ;
F_40 ( V_73 , V_120 , V_3 , L_14 ) ;
}
static void V_117 ( struct V_42 * V_3 )
{
unsigned char * V_121 = F_41 ( F_42 ( V_3 -> V_50 ) ) ;
struct V_72 * V_73 = F_25 ( V_3 ) ;
F_40 ( V_73 , V_120 , V_3 , L_15 ,
V_122 ) ;
V_89 . V_119 = 0 ;
V_121 [ 0xC0000 ] = 0 ;
if ( F_43 ( V_73 ) )
...
static void F_45 ( struct V_42 * V_3 , void * V_123 , int V_124 ,
int V_125 )
{
...
static void F_46 ( struct V_42 * V_3 , int V_123 ,
...
F_47 ( V_129 , V_3 -> V_60 + V_131 , 4 ) ;
V_129 -> V_125 = F_48 ( V_129 -> V_125 ) ;
}
...
F_47 ( V_133 -> V_138 , V_3 -> V_60 + V_135 ,
V_137 ) ;
V_125 -= V_137 ;
F_47 ( V_133 -> V_138 + V_137 , V_89 . V_98 ,
V_125 ) ;
} else {
F_47 ( V_133 -> V_138 , V_3 -> V_60 + V_135 , V_125 ) ;
}
}
...
if ( V_136 + V_125 > V_89 . V_99 ) {
int V_137 = V_89 . V_99 - V_136 ;
F_45 ( V_3 , V_133 -> V_138 , V_135 , V_137 ) ;
V_125 -= V_137 ;
F_45 ( V_3 , V_133 -> V_138 + V_137 ,
V_89 . V_98 - V_3 -> V_60 ,
V_125 ) ;
} else {
F_45 ( V_3 , V_133 -> V_138 , V_135 , V_125 ) ;
}
}
