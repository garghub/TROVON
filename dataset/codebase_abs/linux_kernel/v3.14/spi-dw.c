...
V_106 = F_45 ( V_104 ) ;
if ( ! V_106 ) {
V_106 = F_50 ( & V_104 -> V_81 , sizeof( struct V_105 ) ,
V_12 ) ;
if ( ! V_106 )
return - V_29 ;
F_51 ( V_104 , V_106 ) ;
...
int F_66 ( struct V_157 * V_81 , struct V_5 * V_6 )
{
struct V_158 * V_80 ;
int V_9 ;
F_67 ( V_6 == NULL ) ;
...
V_6 -> V_164 ) ;
V_9 = F_69 ( V_81 , V_6 -> V_95 , F_34 , V_165 ,
V_6 -> V_163 , V_6 ) ;
if ( V_9 < 0 ) {
F_28 ( & V_80 -> V_81 , L_26 ) ;
goto V_166;
