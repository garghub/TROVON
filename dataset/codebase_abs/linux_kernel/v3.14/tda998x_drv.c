...
static int
F_79 ( struct V_5 * V_6 , const struct V_236 * V_237 )
{
return 0 ;
}
static int
...
V_249 | V_250 ) ;
F_19 ( V_2 ) ;
V_14 -> V_195 = F_14 ( V_2 , V_251 ) |
F_14 ( V_2 , V_252 ) << 8 ;
V_14 -> V_195 &= ~ 0x30 ;
switch ( V_14 -> V_195 ) {
case V_253 : F_84 ( V_10 -> V_10 , L_9 ) ; break;
case V_254 : F_84 ( V_10 -> V_10 , L_10 ) ; break;
case V_255 : F_84 ( V_10 -> V_10 , L_11 ) ; break;
case V_196 : F_84 ( V_10 -> V_10 , L_12 ) ; break;
default:
