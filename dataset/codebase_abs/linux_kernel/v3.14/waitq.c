...
if ( V_2 -> V_7 )
return - V_11 ;
V_70 = F_39 ( V_25 , F_40 ( V_2 -> V_102 ) ) ;
V_71 = F_41 ( V_25 , F_40 ( V_2 -> V_102 ) ) ;
if ( V_70 == 0 || V_71 == 0 )
return - V_11 ;
if ( ! V_72 -> V_99 ) {
if ( F_42 ( V_2 -> type ) )
...
V_12 = F_43 ( V_85 + 1 , V_103 ) ;
if ( ! V_12 )
return - V_104 ;
if ( F_33 ( V_72 ) && F_42 ( V_2 -> type ) )
...
if ( ! V_4 ) {
V_4 = F_43 ( sizeof( struct V_3 ) , V_103 ) ;
if ( ! V_4 ) {
F_5 ( V_86 . V_12 ) ;
F_3 ( & V_2 -> V_6 ) ;
return - V_104 ;
...
T_5 V_106 ;
unsigned long V_107 ;
F_12 ( & V_25 -> V_34 -> V_35 , V_107 ) ;
V_106 = V_25 -> V_108 ;
F_50 ( & V_25 -> V_108 , V_109 & ~ V_106 . V_110 [ 0 ] ) ;
F_14 () ;
F_15 ( & V_25 -> V_34 -> V_35 , V_107 ) ;
...
if ( ! V_10 ) {
struct V_91 * V_67 ;
struct V_72 * V_111 = NULL ;
V_67 = F_30 ( V_72 ) ;
if ( ! V_67 ) {
V_111 = F_35 ( V_72 -> V_83 , & V_72 -> V_84 ) ;
if ( V_111 )
V_67 = F_30 ( V_111 ) ;
}
if ( V_67 ) {
...
int F_52 ( struct V_1 * V_2 , T_6 V_44 , int V_10 )
{
struct V_3 * V_4 , * * V_112 ;
F_2 ( & V_2 -> V_6 ) ;
for ( V_112 = & V_2 -> V_8 ; ( V_4 = * V_112 ) != NULL ; V_112 = & V_4 -> V_9 ) {
if ( V_4 -> V_44 == V_44 )
break;
}
if ( ! V_4 ) {
