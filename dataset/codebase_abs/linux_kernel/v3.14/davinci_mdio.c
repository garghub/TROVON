...
{
struct V_48 * V_7 = F_23 ( & V_50 -> V_20 ) ;
struct V_55 * V_20 = & V_50 -> V_20 ;
struct V_1 * V_2 ;
struct V_56 * V_57 ;
struct V_58 * V_59 ;
int V_35 , V_60 ;
V_2 = F_24 ( sizeof( * V_2 ) , V_61 ) ;
if ( ! V_2 )
return - V_62 ;
V_2 -> V_14 = F_25 () ;
if ( ! V_2 -> V_14 ) {
...
V_2 -> V_7 = V_64 ;
snprintf ( V_2 -> V_14 -> V_65 , V_66 , L_10 , V_50 -> V_67 ) ;
} else {
V_2 -> V_7 = V_7 ? ( * V_7 ) : V_64 ;
snprintf ( V_2 -> V_14 -> V_65 , V_66 , L_11 ,
V_50 -> V_67 , V_50 -> V_65 ) ;
}
V_2 -> V_14 -> V_67 = F_26 ( V_20 ) ;
V_2 -> V_14 -> V_68 = F_15 ,
V_2 -> V_14 -> V_69 = F_18 ,
V_2 -> V_14 -> V_70 = F_5 ,
V_2 -> V_14 -> V_71 = V_20 ;
...
V_2 -> V_20 = V_20 ;
F_34 ( & V_2 -> V_39 ) ;
V_57 = F_35 ( V_50 , V_72 , 0 ) ;
if ( ! V_57 ) {
F_13 ( V_20 , L_14 ) ;
V_35 = - V_73 ;
goto V_63;
}
V_57 = F_36 ( V_20 , V_57 -> V_74 , F_37 ( V_57 ) ,
F_26 ( V_20 ) ) ;
if ( ! V_57 ) {
F_13 ( V_20 , L_15 ) ;
V_35 = - V_75 ;
...
V_2 -> V_11 = F_38 ( V_20 , V_57 -> V_74 , F_37 ( V_57 ) ) ;
if ( ! V_2 -> V_11 ) {
F_13 ( V_20 , L_16 ) ;
V_35 = - V_62 ;
goto V_63;
...
if ( V_35 )
goto V_63;
for ( V_60 = 0 ; V_60 < V_18 ; V_60 ++ ) {
V_59 = V_2 -> V_14 -> V_76 [ V_60 ] ;
if ( V_59 ) {
F_8 ( V_20 , L_17 ,
V_59 -> V_60 , F_26 ( & V_59 -> V_20 ) ,
V_59 -> V_77 ? V_59 -> V_77 -> V_67 : L_18 ) ;
}
}
return 0 ;
V_63:
...
static int F_48 ( struct V_55 * V_20 )
{
struct V_1 * V_2 = F_49 ( V_20 ) ;
T_1 V_78 ;
F_16 ( & V_2 -> V_39 ) ;
V_78 = F_7 ( & V_2 -> V_11 -> V_12 ) ;
V_78 &= ~ V_10 ;
F_3 ( V_78 , & V_2 -> V_11 -> V_12 ) ;
F_14 ( V_2 ) ;
V_2 -> V_40 = true ;
F_17 ( & V_2 -> V_39 ) ;
F_42 ( V_2 -> V_20 ) ;
