...
static void
F_76 ( struct V_112 * V_113 , unsigned int V_16 )
{
int V_48 ;
for ( V_48 = 0 ; V_48 < V_16 - 2 ; V_48 ++ )
F_70 ( V_113 [ V_48 ] . V_115 ) ;
...
{
struct V_1 * V_2 = F_24 ( V_118 , struct V_1 , V_109 ) ;
struct V_112 * V_113 , * V_119 ;
struct V_120 * V_121 ;
unsigned int V_122 ;
struct V_123 V_124 ;
V_113 = F_75 ( V_2 -> V_125 , V_2 -> V_126 ) ;
if ( F_62 ( V_113 ) )
return;
F_36 ( & V_2 -> V_12 . V_59 ) ;
V_119 = V_2 -> V_113 ;
...
static void
F_79 ( struct V_85 * V_12 , int V_127 , int V_16 , int V_13 )
{
struct V_1 * V_2 = F_24 ( V_12 , struct V_1 , V_12 ) ;
V_2 -> V_128 = V_127 ;
V_2 -> V_125 = V_16 ;
...
{
struct V_1 * V_2 = F_24 ( V_12 , struct V_1 , V_12 ) ;
struct V_120 * V_121 = F_77 ( & V_2 -> V_73 ) ;
if ( V_121 ) {
V_121 -> V_131 = NULL ;
F_82 ( & V_2 -> V_73 , NULL ) ;
F_83 ( V_121 ) ;
...
V_2 -> V_113 = F_75 ( V_2 -> V_12 . V_16 , V_2 -> V_12 . V_13 ) ;
if ( F_62 ( V_2 -> V_113 ) ) {
V_52 = F_92 ( V_2 -> V_113 ) ;
F_44 ( & V_2 -> V_12 ) ;
F_89 ( & V_2 -> V_12 ) ;
...
V_2 -> V_72 -> V_140 [ F_94 ( V_141 ) ] = F_38 ;
V_2 -> V_72 -> V_140 [ F_94 ( V_142 ) ] = F_41 ;
V_2 -> V_72 -> V_140 [ F_94 ( V_143 ) ] = F_40 ;
V_2 -> V_72 -> V_140 [ F_94 ( V_144 ) ] = F_35 ;
