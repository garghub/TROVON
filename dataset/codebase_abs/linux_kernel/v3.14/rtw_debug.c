...
V_110 = F_54 ( V_111 ) ;
while ( ( F_55 ( V_111 , V_110 ) ) == false ) {
V_49 = F_56 ( V_110 , struct V_48 , V_117 ) ;
V_110 = F_54 ( V_110 ) ;
...
V_7 += snprintf ( V_1 + V_7 , V_4 - V_7 , L_26 , V_49 -> V_43 . V_71 ) ;
V_7 += snprintf ( V_1 + V_7 , V_4 - V_7 , L_27 , V_49 -> V_43 . V_72 , V_49 -> V_43 . V_73 ) ;
V_7 += snprintf ( V_1 + V_7 , V_4 - V_7 , L_64 , V_49 -> V_118 ) ;
V_7 += snprintf ( V_1 + V_7 , V_4 - V_7 , L_65 , V_49 -> V_119 ) ;
V_7 += snprintf ( V_1 + V_7 , V_4 - V_7 , L_66 , V_49 -> V_120 ) ;
V_7 += snprintf ( V_1 + V_7 , V_4 - V_7 , L_67 , V_49 -> V_121 ) ;
V_7 += snprintf ( V_1 + V_7 , V_4 - V_7 , L_68 , V_49 -> V_122 ) ;
V_7 += snprintf ( V_1 + V_7 , V_4 - V_7 , L_69 , V_49 -> V_123 ) ;
V_7 += snprintf ( V_1 + V_7 , V_4 - V_7 , L_70 , V_49 -> V_124 ) ;
V_7 += snprintf ( V_1 + V_7 , V_4 - V_7 , L_71 , V_49 -> V_125 ) ;
...
struct V_34 * V_35 = & V_14 -> V_36 ;
int V_7 = 0 ;
T_3 V_57 , V_126 = 1 , V_127 = 36 , V_128 = 0 , V_129 = 0 ;
for ( V_57 = 0 ; V_35 -> V_130 [ V_57 ] . V_131 != 0 ; V_57 ++ ) {
if ( V_35 -> V_130 [ V_57 ] . V_131 == 1 )
V_128 = V_57 ;
if ( V_35 -> V_130 [ V_57 ] . V_131 == 36 )
V_129 = V_57 ;
}
for ( V_57 = 0 ; V_35 -> V_130 [ V_57 ] . V_131 != 0 ; V_57 ++ ) {
if ( V_35 -> V_130 [ V_57 ] . V_131 == 6 ) {
if ( V_35 -> V_130 [ V_57 ] . V_132 < V_35 -> V_130 [ V_128 ] . V_132 ) {
V_128 = V_57 ;
V_126 = V_35 -> V_130 [ V_57 ] . V_131 ;
}
}
if ( V_35 -> V_130 [ V_57 ] . V_131 >= 36 &&
V_35 -> V_130 [ V_57 ] . V_131 < 140 ) {
if ( ( ( V_35 -> V_130 [ V_57 ] . V_131 - 36 ) % 8 == 0 ) &&
( V_35 -> V_130 [ V_57 ] . V_132 < V_35 -> V_130 [ V_129 ] . V_132 ) ) {
V_129 = V_57 ;
V_127 = V_35 -> V_130 [ V_57 ] . V_131 ;
}
}
if ( V_35 -> V_130 [ V_57 ] . V_131 >= 149 &&
V_35 -> V_130 [ V_57 ] . V_131 < 165 ) {
if ( ( ( V_35 -> V_130 [ V_57 ] . V_131 - 149 ) % 8 == 0 ) &&
( V_35 -> V_130 [ V_57 ] . V_132 < V_35 -> V_130 [ V_129 ] . V_132 ) ) {
V_129 = V_57 ;
V_127 = V_35 -> V_130 [ V_57 ] . V_131 ;
}
...
V_35 -> V_130 [ V_57 ] . V_131 , V_35 -> V_130 [ V_57 ] . V_132 ) ;
}
V_7 += snprintf ( V_1 + V_7 , V_4 - V_7 , L_73 , V_127 ) ;
V_7 += snprintf ( V_1 + V_7 , V_4 - V_7 , L_74 , V_126 ) ;
* V_5 = 1 ;
return V_7 ;
}
