...
int V_395 ;
struct V_396 * V_397 ;
F_13 ( V_398 , L_156 , V_37 ) ;
F_13 ( V_285 , L_157 , V_37 ,
V_390 -> V_399 [ 0 ] . V_400 . V_401 ) ;
V_393 = NULL ;
V_394 = NULL ;
V_397 = V_390 -> V_402 ;
for ( V_73 = 0 ; V_73 < V_397 -> V_400 . V_401 ; V_73 ++ ) {
V_392 = & V_397 -> V_392 [ V_73 ] . V_400 ;
F_13 ( V_285 , L_158 ,
V_37 , V_73 , V_392 -> V_403 ,
V_392 -> V_404 ) ;
if ( ! V_393 && F_129 ( V_392 ) )
V_393 = V_392 ;
if ( ! V_394 && F_130 ( V_392 ) )
V_394 = V_392 ;
}
if ( ! V_393 || ! V_394 ) {
F_14 ( & V_390 -> V_38 , L_159 ) ;
return - V_405 ;
}
V_71 -> V_226 = F_131 ( V_71 -> V_10 , V_393 -> V_403 ) ;
V_71 -> V_349 = F_132 ( V_71 -> V_10 , V_394 -> V_403 ) ;
V_71 -> V_223 = F_133 ( 0 , V_41 ) ;
V_71 -> V_340 = F_133 ( 0 , V_41 ) ;
if ( ! V_71 -> V_223 || ! V_71 -> V_340 ) {
F_14 ( & V_390 -> V_38 , L_160 ) ;
return - V_42 ;
}
V_395 = sizeof( struct V_333 ) + V_406 ;
V_71 -> V_335 = F_15 ( V_395 , V_41 ) ;
if ( ! V_71 -> V_335 )
return - V_42 ;
F_13 ( V_398 , L_161 , V_37 ) ;
return 0 ;
}
...
V_21 = F_128 ( V_71 , V_390 ) ;
if ( V_21 < 0 )
goto exit;
V_21 = F_29 ( V_71 ) ;
if ( V_21 < 0 ) {
F_14 ( & V_390 -> V_38 , L_163 ) ;
goto exit;
}
V_71 -> V_407 = F_31 ( V_71 -> V_76 ) ;
V_71 -> V_210 = V_408 ;
V_71 -> V_245 = V_356 ;
V_71 -> V_130 = V_409 ;
V_71 -> V_128 = V_410 ;
...
V_71 -> V_277 = 0 ;
V_80 = V_71 -> V_79 -> V_80 ;
V_71 -> V_79 -> V_80 -> V_415 = 1 ;
V_71 -> V_79 -> V_80 -> V_416 = 0 ;
V_71 -> V_79 -> V_80 -> V_417 = F_135 ( V_355 ) ;
V_71 -> V_79 -> V_80 -> V_418 [ V_419 ] = & V_420 ;
V_71 -> V_79 -> V_328 = V_421 |
V_422 ;
V_71 -> V_79 -> V_423 = 100 ;
F_136 ( V_71 -> V_79 , & V_390 -> V_38 ) ;
...
F_139 ( & V_390 -> V_38 ) , V_71 -> V_74 ,
V_71 -> V_309 . V_310 , V_71 -> V_309 . V_311 ,
V_71 -> V_309 . V_312 , V_71 -> V_309 . V_313 ) ;
F_47 ( V_71 -> V_79 -> V_80 , L_167 ,
V_71 -> V_76 , V_71 -> V_407 -> V_427 ) ;
exit:
return V_21 ;
}
...
static int F_148 ( struct V_389 * V_390 ,
...
int V_430 = 0 ;
struct V_431 V_432 ;
int V_1 = ( int ) V_429 -> V_433 ;
V_10 = F_149 ( F_150 ( V_390 ) ) ;
V_231 = F_89 ( V_10 , V_1 ) ;
if ( ! V_231 ) {
V_21 = - V_234 ;
goto error;
...
|| ( V_64 == V_436 ) ) {
V_21 = F_33 ( V_10 , V_437 , & V_432 , sizeof( V_432 ) ) ;
if ( V_21 < 0 || ( V_432 . V_310 | V_432 . V_311 ) == 0 )
V_430 = 1 ;
} else
V_430 = 1 ;
if ( V_430 ) {
...
F_151 ( V_390 , V_71 ) ;
memcpy ( & V_71 -> V_309 , & V_432 , sizeof( struct V_431 ) ) ;
V_71 -> V_1 = V_1 ;
V_21 = F_134 ( V_71 , V_390 ) ;
if ( V_21 < 0 )
F_140 ( V_71 ) ;
return V_21 ;
error:
...
static void F_152 ( struct V_389 * V_390 )
{
struct V_70 * V_71 ;
V_71 = F_153 ( V_390 ) ;
F_151 ( V_390 , NULL ) ;
