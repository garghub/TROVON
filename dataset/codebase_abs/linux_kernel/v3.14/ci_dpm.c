...
PPSMC_Result result;
#endif
V_74 = F_42 ( V_3 , V_879 , V_880 ) ;
if ( V_74 ) {
F_43 ( L_18 ) ;
return V_74 ;
}
V_3 -> V_876 . V_881 = true ;
F_223 ( V_3 ) ;
#if 0
...
struct V_1 * V_4 = F_1 ( V_3 ) ;
struct V_9 * V_868 = & V_4 -> V_871 ;
struct V_9 * V_882 = & V_4 -> V_869 ;
int V_74 ;
F_170 ( V_3 , V_868 ) ;
if ( V_4 -> V_883 )
F_197 ( V_3 , V_868 , V_882 ) ;
V_74 = F_61 ( V_3 ) ;
if ( V_74 ) {
F_43 ( L_19 ) ;
return V_74 ;
...
T_1 V_886 )
{
V_10 -> V_887 = F_230 ( V_885 -> V_888 ) ;
V_10 -> V_180 = F_231 ( V_885 -> V_889 ) ;
V_10 -> V_890 = F_231 ( V_885 -> V_891 ) ;
if ( V_892 < V_886 ) {
V_10 -> V_464 = F_230 ( V_885 -> V_893 ) ;
V_10 -> V_466 = F_230 ( V_885 -> V_894 ) ;
} else {
V_10 -> V_464 = 0 ;
V_10 -> V_466 = 0 ;
}
...
struct V_1 * V_4 = F_1 ( V_3 ) ;
struct V_8 * V_11 = F_2 ( V_10 ) ;
struct V_900 * V_901 = & V_11 -> V_188 [ V_637 ] ;
V_11 -> V_187 = V_637 + 1 ;
V_901 -> V_174 = F_231 ( V_899 -> V_902 . V_903 ) ;
V_901 -> V_174 |= V_899 -> V_902 . V_904 << 16 ;
V_901 -> V_175 = F_231 ( V_899 -> V_902 . V_905 ) ;
V_901 -> V_175 |= V_899 -> V_902 . V_906 << 16 ;
V_901 -> V_638 = F_233 ( V_3 ,
V_4 -> V_907 ,
V_4 -> V_669 . V_908 ,
V_899 -> V_902 . V_909 ) ;
V_901 -> V_716 = F_234 ( V_3 ,
V_4 -> V_669 . V_910 ,
F_231 ( V_899 -> V_902 . V_911 ) ) ;
if ( V_10 -> V_180 & V_912 ) {
V_4 -> V_913 = V_901 -> V_638 ;
}
if ( V_10 -> V_890 & V_914 ) {
V_4 -> V_592 . V_593 = true ;
V_4 -> V_592 . V_901 = * V_901 ;
V_4 -> V_592 . V_664 = V_915 ;
}
if ( V_10 -> V_180 & V_895 ) {
V_901 -> V_175 = V_4 -> V_669 . V_671 ;
V_901 -> V_174 = V_4 -> V_669 . V_670 ;
V_901 -> V_638 = V_4 -> V_669 . V_908 ;
V_901 -> V_716 = V_4 -> V_669 . V_910 ;
}
switch ( V_10 -> V_180 & V_181 ) {
case V_182 :
V_4 -> V_641 = true ;
if ( V_4 -> V_642 . V_83 < V_901 -> V_638 )
V_4 -> V_642 . V_83 = V_901 -> V_638 ;
if ( V_4 -> V_642 . V_82 > V_901 -> V_638 )
V_4 -> V_642 . V_82 = V_901 -> V_638 ;
if ( V_4 -> V_644 . V_83 < V_901 -> V_716 )
V_4 -> V_644 . V_83 = V_901 -> V_716 ;
if ( V_4 -> V_644 . V_82 > V_901 -> V_716 )
V_4 -> V_644 . V_82 = V_901 -> V_716 ;
break;
case V_916 :
V_4 -> V_640 = true ;
if ( V_4 -> V_643 . V_83 < V_901 -> V_638 )
V_4 -> V_643 . V_83 = V_901 -> V_638 ;
if ( V_4 -> V_643 . V_82 > V_901 -> V_638 )
V_4 -> V_643 . V_82 = V_901 -> V_638 ;
if ( V_4 -> V_645 . V_83 < V_901 -> V_716 )
V_4 -> V_645 . V_83 = V_901 -> V_716 ;
if ( V_4 -> V_645 . V_82 > V_901 -> V_716 )
V_4 -> V_645 . V_82 = V_901 -> V_716 ;
break;
default:
break;
}
...
{
struct V_917 * V_918 = & V_3 -> V_918 ;
struct V_884 * V_885 ;
union V_919 * V_920 ;
int V_41 , V_98 , V_99 , V_921 , V_922 ;
union V_898 * V_899 ;
struct V_923 * V_924 ;
struct V_925 * V_926 ;
struct V_927 * V_928 ;
union V_929 * V_929 ;
int V_637 = F_236 ( V_930 , V_931 ) ;
T_2 V_932 ;
T_1 V_933 , V_934 ;
T_1 * V_935 ;
struct V_8 * V_11 ;
if ( ! F_237 ( V_918 -> V_936 , V_637 , NULL ,
& V_933 , & V_934 , & V_932 ) )
return - V_45 ;
V_929 = (union V_929 * ) ( V_918 -> V_936 -> V_937 + V_932 ) ;
V_924 = (struct V_923 * )
( V_918 -> V_936 -> V_937 + V_932 +
F_231 ( V_929 -> V_938 . V_939 ) ) ;
V_926 = (struct V_925 * )
( V_918 -> V_936 -> V_937 + V_932 +
F_231 ( V_929 -> V_938 . V_940 ) ) ;
V_928 = (struct V_927 * )
( V_918 -> V_936 -> V_937 + V_932 +
F_231 ( V_929 -> V_938 . V_941 ) ) ;
V_3 -> V_5 . V_6 . V_11 = F_183 ( sizeof( struct V_9 ) *
V_924 -> V_942 , V_816 ) ;
if ( ! V_3 -> V_5 . V_6 . V_11 )
return - V_817 ;
V_935 = ( T_1 * ) V_924 -> V_943 ;
V_3 -> V_5 . V_6 . V_48 = F_230 ( V_929 -> V_938 . V_944 ) ;
V_3 -> V_5 . V_6 . V_598 = F_231 ( V_929 -> V_938 . V_945 ) ;
V_3 -> V_5 . V_6 . V_946 = F_231 ( V_929 -> V_938 . V_947 ) ;
for ( V_41 = 0 ; V_41 < V_924 -> V_942 ; V_41 ++ ) {
T_1 * V_411 ;
V_920 = (union V_919 * ) V_935 ;
V_921 = V_920 -> V_948 . V_949 ;
V_885 = (struct V_884 * )
& V_928 -> V_950 [ V_921 ] ;
if ( ! V_3 -> V_5 . V_920 [ V_41 ] . V_899 )
return - V_45 ;
...
F_229 ( V_3 , & V_3 -> V_5 . V_6 . V_11 [ V_41 ] ,
V_885 ,
V_928 -> V_951 ) ;
V_99 = 0 ;
V_411 = ( T_1 * ) & V_920 -> V_948 . V_952 [ 0 ] ;
for ( V_98 = 0 ; V_98 < V_920 -> V_948 . V_953 ; V_98 ++ ) {
V_922 = V_411 [ V_98 ] ;
if ( V_922 >= V_926 -> V_942 )
continue;
if ( V_99 >= V_954 )
break;
V_899 = (union V_898 * )
...
V_935 += 2 + V_920 -> V_948 . V_953 ;
}
V_3 -> V_5 . V_6 . V_956 = V_924 -> V_942 ;
return 0 ;
}
...
& V_933 , & V_934 , & V_932 ) ) {
V_959 =
( T_16 * ) ( V_918 -> V_936 -> V_937 +
V_932 ) ;
V_439 -> V_677 = F_231 ( V_959 -> V_960 ) ;
V_439 -> V_673 = F_231 ( V_959 -> V_961 ) ;
V_439 -> V_675 = F_231 ( V_959 -> V_962 ) ;
V_439 -> V_908 = F_194 ( V_3 ) ;
V_439 -> V_910 = F_196 ( V_3 ) ;
V_439 -> V_670 = F_230 ( V_959 -> V_963 ) ;
V_439 -> V_671 = F_230 ( V_959 -> V_964 ) ;
return 0 ;
}
return - V_45 ;
}
...
{
int V_41 ;
for ( V_41 = 0 ; V_41 < V_3 -> V_5 . V_6 . V_956 ; V_41 ++ ) {
...
return - V_817 ;
V_3 -> V_5 . V_6 . V_7 = V_4 ;
V_74 = F_242 ( V_3 -> V_967 , & V_141 ) ;
if ( V_74 )
V_4 -> V_907 = 0 ;
else
V_4 -> V_907 = V_141 ;
V_4 -> V_846 = V_847 ;
V_4 -> V_643 . V_83 = V_968 ;
V_4 -> V_643 . V_82 = V_849 ;
V_4 -> V_642 . V_83 = V_968 ;
V_4 -> V_642 . V_82 = V_849 ;
V_4 -> V_645 . V_83 = 0 ;
V_4 -> V_645 . V_82 = 16 ;
V_4 -> V_644 . V_83 = 0 ;
V_4 -> V_644 . V_82 = 16 ;
V_74 = F_238 ( V_3 , & V_4 -> V_669 ) ;
if ( V_74 ) {
F_239 ( V_3 ) ;
return V_74 ;
}
...
F_183 ( 4 * sizeof( struct V_972 ) , V_816 ) ;
...
V_3 -> V_5 . V_6 . V_42 . V_973 = 4 ;
V_3 -> V_5 . V_6 . V_42 . V_974 = 15000 ;
V_3 -> V_5 . V_6 . V_42 . V_975 = 200 ;
V_3 -> V_5 . V_6 . V_42 . V_976 . V_46 = 0 ;
V_3 -> V_5 . V_6 . V_42 . V_976 . V_977 = NULL ;
V_3 -> V_5 . V_6 . V_42 . V_978 . V_46 = 0 ;
V_3 -> V_5 . V_6 . V_42 . V_978 . V_977 = NULL ;
if ( V_3 -> V_979 == V_980 ) {
V_4 -> V_108 . V_690 = 94500 ;
V_4 -> V_108 . V_109 = 95000 ;
V_4 -> V_108 . V_981 = 104000 ;
} else {
...
V_4 -> V_384 = V_406 ;
V_4 -> V_388 = V_406 ;
if ( F_244 ( V_3 , V_380 , V_381 ) )
V_4 -> V_378 = V_379 ;
else if ( F_244 ( V_3 , V_380 , V_982 ) )
V_4 -> V_378 = V_382 ;
if ( V_3 -> V_5 . V_6 . V_48 & V_983 ) {
if ( F_244 ( V_3 , V_385 , V_381 ) )
V_4 -> V_384 = V_379 ;
else if ( F_244 ( V_3 , V_385 , V_982 ) )
V_4 -> V_384 = V_382 ;
else
V_3 -> V_5 . V_6 . V_48 &= ~ V_983 ;
}
if ( V_3 -> V_5 . V_6 . V_48 & V_984 ) {
if ( F_244 ( V_3 , V_389 , V_381 ) )
V_4 -> V_388 = V_379 ;
else if ( F_244 ( V_3 , V_389 , V_982 ) )
V_4 -> V_388 = V_382 ;
else
V_3 -> V_5 . V_6 . V_48 &= ~ V_984 ;
}
V_4 -> V_534 = true ;
#if F_245 ( F_198 )
V_4 -> V_883 =
...
V_4 -> V_883 = false ;
#endif
if ( F_237 ( V_3 -> V_918 . V_936 , V_637 , & V_966 ,
& V_933 , & V_934 , & V_932 ) ) {
V_4 -> V_341 = true ;
V_4 -> V_504 = true ;
V_4 -> V_875 = true ;
...
struct V_900 * V_901 ;
int V_41 ;
F_250 ( V_10 -> V_180 , V_10 -> V_890 ) ;
F_251 ( V_10 -> V_887 ) ;
F_252 ( L_28 , V_10 -> V_464 , V_10 -> V_466 ) ;
for ( V_41 = 0 ; V_41 < V_11 -> V_187 ; V_41 ++ ) {
V_901 = & V_11 -> V_188 [ V_41 ] ;
F_252 ( L_29 ,
V_41 , V_901 -> V_174 , V_901 -> V_175 , V_901 -> V_638 + 1 , V_901 -> V_716 ) ;
}
F_253 ( V_3 , V_10 ) ;
}
T_3 F_254 ( struct V_2 * V_3 , bool V_988 )
{
struct V_1 * V_4 = F_1 ( V_3 ) ;
struct V_8 * V_989 = F_2 ( & V_4 -> V_871 ) ;
if ( V_988 )
return V_989 -> V_188 [ 0 ] . V_174 ;
else
return V_989 -> V_188 [ V_989 -> V_187 - 1 ] . V_174 ;
}
T_3 F_255 ( struct V_2 * V_3 , bool V_988 )
{
struct V_1 * V_4 = F_1 ( V_3 ) ;
struct V_8 * V_989 = F_2 ( & V_4 -> V_871 ) ;
if ( V_988 )
return V_989 -> V_188 [ 0 ] . V_175 ;
else
return V_989 -> V_188 [ V_989 -> V_187 - 1 ] . V_175 ;
}
