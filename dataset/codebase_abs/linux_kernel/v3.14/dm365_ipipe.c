...
struct V_309 * V_310 , unsigned int V_311 ,
enum V_312 V_313 )
{
if ( V_313 == V_314 )
return F_89 ( V_310 , V_311 ) ;
return & V_15 -> V_315 [ V_311 ] ;
}
static void
...
V_317 = V_320 ;
if ( V_311 == V_321 ) {
for ( V_3 = 0 ; V_3 < F_75 ( V_322 ) ; V_3 ++ )
if ( V_316 -> V_323 == V_322 [ V_3 ] )
break;
if ( V_3 >= F_75 ( V_322 ) )
V_316 -> V_323 = V_324 ;
} else if ( V_311 == V_325 ) {
for ( V_3 = 0 ; V_3 < F_75 ( V_326 ) ; V_3 ++ )
if ( V_316 -> V_323 == V_326 [ V_3 ] )
break;
if ( V_3 >= F_75 ( V_326 ) )
V_316 -> V_323 = V_327 ;
}
V_316 -> V_328 = F_91 ( T_1 , V_316 -> V_328 , V_329 , V_318 ) ;
V_316 -> V_330 = F_91 ( T_1 , V_316 -> V_330 , V_331 , V_317 ) ;
}
static int
F_92 ( struct V_267 * V_268 , struct V_309 * V_310 ,
struct V_332 * V_316 )
{
struct V_14 * V_15 = F_74 ( V_268 ) ;
struct V_308 * V_333 ;
V_333 = F_88 ( V_15 , V_310 , V_316 -> V_311 , V_316 -> V_313 ) ;
if ( V_333 == NULL )
return - V_8 ;
F_90 ( V_15 , V_310 , V_316 -> V_311 , & V_316 -> V_333 , V_316 -> V_313 ) ;
* V_333 = V_316 -> V_333 ;
if ( V_316 -> V_313 == V_314 )
return 0 ;
if ( V_316 -> V_311 == V_321 &&
( V_15 -> V_301 == V_334 ||
V_15 -> V_301 == V_335 ) )
V_15 -> V_315 [ V_316 -> V_311 ] = V_316 -> V_333 ;
else if ( V_316 -> V_311 == V_325 &&
V_15 -> V_306 == V_336 )
V_15 -> V_315 [ V_316 -> V_311 ] = V_316 -> V_333 ;
else
return - V_8 ;
...
static int
F_93 ( struct V_267 * V_268 , struct V_309 * V_310 ,
struct V_332 * V_316 )
{
struct V_14 * V_15 = F_74 ( V_268 ) ;
if ( V_316 -> V_313 == V_337 )
V_316 -> V_333 = V_15 -> V_315 [ V_316 -> V_311 ] ;
else
V_316 -> V_333 = * ( F_89 ( V_310 , V_316 -> V_311 ) ) ;
return 0 ;
}
static int
F_94 ( struct V_267 * V_268 , struct V_309 * V_310 ,
struct V_338 * V_339 )
{
struct V_14 * V_15 = F_74 ( V_268 ) ;
struct V_308 V_333 ;
if ( V_339 -> V_340 != 0 )
return - V_8 ;
V_333 . V_323 = V_339 -> V_323 ;
V_333 . V_328 = 1 ;
V_333 . V_330 = 1 ;
F_90 ( V_15 , V_310 , V_339 -> V_311 , & V_333 ,
V_314 ) ;
V_339 -> V_341 = V_333 . V_328 ;
V_339 -> V_342 = V_333 . V_330 ;
if ( V_333 . V_323 != V_339 -> V_323 )
return - V_8 ;
V_333 . V_323 = V_339 -> V_323 ;
V_333 . V_328 = - 1 ;
V_333 . V_330 = - 1 ;
F_90 ( V_15 , V_310 , V_339 -> V_311 , & V_333 ,
V_314 ) ;
V_339 -> V_343 = V_333 . V_328 ;
V_339 -> V_344 = V_333 . V_330 ;
return 0 ;
}
static int
F_95 ( struct V_267 * V_268 , struct V_309 * V_310 ,
struct V_345 * V_323 )
{
switch ( V_323 -> V_311 ) {
case V_321 :
if ( V_323 -> V_340 >= F_75 ( V_322 ) )
return - V_8 ;
V_323 -> V_323 = V_322 [ V_323 -> V_340 ] ;
break;
case V_325 :
if ( V_323 -> V_340 >= F_75 ( V_326 ) )
return - V_8 ;
V_323 -> V_323 = V_326 [ V_323 -> V_340 ] ;
break;
default:
return - V_8 ;
}
...
static int F_96 ( struct V_346 * V_347 )
{
struct V_14 * V_15 =
F_97 ( V_347 -> V_348 , struct V_14 , V_349 ) ;
struct V_350 * V_351 = & V_15 -> V_17 . V_351 ;
switch ( V_347 -> V_74 ) {
case V_352 :
V_351 -> V_353 = V_347 -> V_300 ;
F_98 ( V_15 -> V_25 , V_351 ) ;
break;
case V_354 :
V_351 -> V_355 = V_347 -> V_300 ;
F_98 ( V_15 -> V_25 , V_351 ) ;
break;
default:
return - V_8 ;
...
static int
F_99 ( struct V_267 * V_268 , struct V_309 * V_310 )
{
struct V_332 V_333 ;
memset ( & V_333 , 0 , sizeof( V_333 ) ) ;
V_333 . V_311 = V_321 ;
V_333 . V_313 = V_310 ? V_314 : V_337 ;
V_333 . V_333 . V_323 = V_324 ;
V_333 . V_333 . V_328 = V_319 ;
V_333 . V_333 . V_330 = V_320 ;
F_92 ( V_268 , V_310 , & V_333 ) ;
memset ( & V_333 , 0 , sizeof( V_333 ) ) ;
V_333 . V_311 = V_325 ;
V_333 . V_313 = V_310 ? V_314 : V_337 ;
V_333 . V_333 . V_323 = V_327 ;
V_333 . V_333 . V_328 = V_319 ;
V_333 . V_333 . V_330 = V_320 ;
F_92 ( V_268 , V_310 , & V_333 ) ;
return 0 ;
...
static int
F_100 ( struct V_356 * V_357 , const struct V_358 * V_359 ,
const struct V_358 * V_360 , T_1 V_361 )
{
struct V_267 * V_268 = F_101 ( V_357 ) ;
struct V_14 * V_15 = F_74 ( V_268 ) ;
struct V_294 * V_295 = F_86 ( V_15 ) ;
T_4 V_362 = V_295 -> V_298 . V_301 ;
switch ( V_359 -> V_340 | F_102 ( V_360 -> V_357 ) ) {
case V_321 | V_363 :
if ( ! ( V_361 & V_364 ) ) {
V_15 -> V_301 = V_302 ;
break;
...
int
F_109 ( struct V_14 * V_15 , struct V_368 * V_369 )
{
struct V_358 * V_370 = & V_15 -> V_370 [ 0 ] ;
struct V_267 * V_268 = & V_15 -> V_22 ;
struct V_356 * V_371 = & V_268 -> V_357 ;
static T_5 V_372 ;
struct V_373 * V_374 ;
V_374 = F_110 ( V_369 , V_375 , 4 ) ;
if ( ! V_374 )
return - V_376 ;
V_372 = F_111 ( V_374 ) ;
V_374 = F_112 ( V_374 -> V_377 , V_372 , V_374 -> V_378 ) ;
if ( ! V_374 )
return - V_365 ;
V_15 -> V_25 = F_113 ( V_374 -> V_377 , V_372 ) ;
if ( ! V_15 -> V_25 )
return - V_365 ;
V_374 = F_110 ( V_369 , V_375 , 6 ) ;
if ( ! V_374 )
return - V_376 ;
V_15 -> V_26 = F_113 ( V_374 -> V_377 , V_372 ) ;
if ( ! V_15 -> V_26 )
return - V_365 ;
F_114 ( V_268 , & V_379 ) ;
V_268 -> V_380 = & V_381 ;
F_115 ( V_268 -> V_378 , L_21 , sizeof( V_268 -> V_378 ) ) ;
V_268 -> V_382 = 1 << 16 ;
F_116 ( V_268 , V_15 ) ;
V_268 -> V_361 |= V_383 ;
V_370 [ V_321 ] . V_361 = V_384 ;
V_370 [ V_325 ] . V_361 = V_385 ;
V_15 -> V_301 = V_302 ;
V_15 -> V_306 = V_307 ;
V_371 -> V_386 = & V_387 ;
F_117 ( & V_15 -> V_349 , 2 ) ;
F_118 ( & V_15 -> V_349 , & V_388 ,
V_352 , 0 ,
V_389 , 1 , 16 ) ;
F_118 ( & V_15 -> V_349 , & V_388 ,
V_354 , 0 ,
V_390 , 1 , 16 ) ;
F_119 ( & V_15 -> V_349 ) ;
V_268 -> V_391 = & V_15 -> V_349 ;
return F_120 ( V_371 , V_392 , V_370 , 0 ) ;
}
