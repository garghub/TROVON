...
V_99 . V_101 = V_26 ;
V_26 = - V_102 ;
V_31 = F_50 ( V_22 -> V_62 , & V_103 ) ;
if ( ! V_31 )
goto V_68;
V_17 -> V_4 . V_72 = V_31 ;
V_31 -> V_66 = V_22 ;
V_31 = F_50 ( V_22 -> V_62 , & V_104 ) ;
if ( ! V_31 )
goto V_68;
V_17 -> V_4 . V_73 = V_31 ;
V_31 -> V_66 = V_22 ;
V_31 = F_50 ( V_22 -> V_62 , & V_105 ) ;
if ( ! V_31 )
goto V_68;
V_17 -> V_28 = V_31 ;
V_31 -> V_66 = V_22 ;
V_26 = - V_106 ;
V_17 -> V_20 = F_51 ( V_31 , V_107 ) ;
if ( ! V_17 -> V_20 )
goto V_68;
V_17 -> V_20 -> V_25 = F_52 ( V_108 , V_107 ) ;
if ( ! V_17 -> V_20 -> V_25 )
goto V_68;
...
V_17 -> V_4 . V_120 = F_41 ;
F_39 ( V_17 -> V_23 , V_79 , 0 ) ;
F_54 ( V_17 -> V_23 , V_17 -> V_121 ) ;
if ( V_17 -> V_122 && V_17 -> V_123 &&
F_55 ( V_17 -> V_23 , V_17 -> V_123 ,
V_17 -> V_122 ) )
goto V_68;
F_15 ( V_22 , L_15 ,
...
void F_59 ( struct V_124 * V_3 , struct V_70 * V_71 )
{
struct V_84 * V_125 ;
V_125 = F_2 ( V_3 , struct V_84 , V_87 ) ;
if ( V_125 -> V_88 )
F_60 ( F_61 ( V_125 -> V_71 ) ) ;
else
F_62 ( V_125 -> V_71 ) ;
V_125 -> V_126 = V_125 -> V_88 = true ;
V_125 -> V_71 = V_71 ;
}
static inline struct V_84 * F_63 ( struct V_127 * V_128 )
{
return F_2 ( F_64 ( V_128 ) , struct V_84 ,
V_87 . V_129 ) ;
}
static void F_65 ( struct V_124 * V_3 )
{
struct V_84 * V_125 ;
V_125 = F_2 ( V_3 , struct V_84 , V_87 ) ;
if ( ! V_125 -> V_126 ) {
...
static struct V_124 * F_66 ( void )
{
struct V_84 * V_125 ;
V_125 = F_67 ( sizeof( * V_125 ) , V_107 ) ;
if ( ! V_125 )
return F_68 ( - V_106 ) ;
F_69 ( & V_125 -> V_130 ) ;
V_125 -> V_87 . V_131 = F_65 ;
V_125 -> V_71 = F_70 () ;
if ( F_33 ( V_125 -> V_71 ) ) {
struct V_70 * V_71 = V_125 -> V_71 ;
F_57 ( V_125 ) ;
return F_71 ( V_71 ) ;
}
F_72 ( & V_125 -> V_87 . V_129 , L_20 ,
& V_132 ) ;
return & V_125 -> V_87 ;
}
...
V_17 = F_1 ( V_3 ) ;
F_74 ( V_17 -> V_23 ) ;
V_125 = F_2 ( V_3 -> V_86 , struct V_84 , V_87 ) ;
F_57 ( V_17 ) ;
F_75 ( & V_125 -> V_130 ) ;
V_125 -> V_133 -- ;
F_76 ( & V_125 -> V_130 ) ;
}
static void F_77 ( struct V_80 * V_81 , struct V_2 * V_3 )
{
struct V_1 * V_17 = F_1 ( V_3 ) ;
F_56 ( V_3 ) ;
F_57 ( V_17 -> V_20 -> V_25 ) ;
...
static struct V_2 * F_78 ( struct V_124 * V_86 )
{
struct V_1 * V_17 ;
struct V_84 * V_125 ;
int V_26 ;
V_17 = F_67 ( sizeof( * V_17 ) , V_107 ) ;
if ( ! V_17 )
return F_68 ( - V_106 ) ;
V_125 = F_2 ( V_86 , struct V_84 , V_87 ) ;
F_75 ( & V_125 -> V_130 ) ;
V_125 -> V_133 ++ ;
F_79 ( V_125 -> V_71 , V_17 -> V_121 ) ;
V_17 -> V_123 = V_125 -> V_134 ;
V_17 -> V_122 = V_125 -> V_122 ;
V_17 -> V_4 . V_135 = F_61 ( V_125 -> V_71 ) ;
F_76 ( & V_125 -> V_130 ) ;
V_17 -> V_4 . V_75 = 0 ;
V_17 -> V_4 . V_136 = sizeof( struct V_15 ) ;
V_17 -> V_4 . V_137 = F_6 ;
V_17 -> V_4 . V_138 = V_139 ;
V_17 -> V_4 . V_5 . V_35 = L_21 ;
V_17 -> V_4 . V_5 . V_140 = F_44 ;
V_17 -> V_4 . V_5 . V_141 = F_77 ;
V_17 -> V_4 . V_5 . V_142 = F_27 ;
V_17 -> V_4 . V_5 . V_143 = F_22 ;
V_17 -> V_4 . V_5 . V_144 = F_36 ;
V_17 -> V_4 . V_5 . V_145 = F_73 ;
V_26 = F_80 ( F_10 , V_17 ) ;
if ( V_26 < 0 ) {
F_57 ( V_17 ) ;
return F_68 ( V_26 ) ;
