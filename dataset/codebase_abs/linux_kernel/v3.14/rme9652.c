...
static T_4 F_39 ( struct V_83 * V_84 )
{
T_4 V_13 = 0 ;
...
static void F_40 ( struct V_83 * V_84 , T_4 V_13 )
{
...
static int F_41 ( struct V_92 * V_93 , struct V_94 * V_95 )
{
V_95 -> type = V_96 ;
V_95 -> V_97 = 1 ;
return 0 ;
}
static int F_42 ( struct V_92 * V_93 , struct V_98 * V_99 )
{
struct V_10 * V_11 = F_43 ( V_93 ) ;
F_40 ( & V_99 -> V_100 . V_101 , V_11 -> V_102 ) ;
return 0 ;
}
static int F_44 ( struct V_92 * V_93 , struct V_98 * V_99 )
{
struct V_10 * V_11 = F_43 ( V_93 ) ;
int V_103 ;
T_4 V_13 ;
V_13 = F_39 ( & V_99 -> V_100 . V_101 ) ;
F_24 ( & V_11 -> V_17 ) ;
...
static int F_45 ( struct V_92 * V_93 , struct V_94 * V_95 )
{
V_95 -> type = V_96 ;
V_95 -> V_97 = 1 ;
return 0 ;
...
{
struct V_10 * V_11 = F_43 ( V_93 ) ;
F_40 ( & V_99 -> V_100 . V_101 , V_11 -> V_104 ) ;
return 0 ;
}
static int F_47 ( struct V_92 * V_93 , struct V_98 * V_99 )
{
struct V_10 * V_11 = F_43 ( V_93 ) ;
int V_103 ;
T_4 V_13 ;
...
static int F_48 ( struct V_92 * V_93 , struct V_94 * V_95 )
{
V_95 -> type = V_96 ;
V_95 -> V_97 = 1 ;
return 0 ;
}
static int F_49 ( struct V_92 * V_93 , struct V_98 * V_99 )
{
V_99 -> V_100 . V_101 . V_29 [ 0 ] = V_93 -> V_105 ;
return 0 ;
}
static unsigned int F_50 ( struct V_10 * V_11 )
{
if ( V_11 -> V_23 & V_106 )
return 1 ;
return 0 ;
}
static int F_51 ( struct V_10 * V_11 , int V_107 )
{
int V_43 = 0 ;
if ( V_107 ) {
V_11 -> V_23 |= V_106 ;
...
static int F_52 ( struct V_92 * V_93 , struct V_94 * V_95 )
{
...
struct V_10 * V_11 = F_43 ( V_93 ) ;
F_24 ( & V_11 -> V_17 ) ;
V_99 -> V_100 . V_110 . V_112 [ 0 ] = F_50 ( V_11 ) ;
F_26 ( & V_11 -> V_17 ) ;
return 0 ;
}
...
static int F_57 ( struct V_10 * V_11 , int V_115 )
{
int V_43 = 0 ;
V_11 -> V_23 &= ~ V_114 ;
V_11 -> V_23 |= F_58 ( V_115 ) ;
if ( ( V_43 = V_11 -> V_45 ) ) {
F_22 ( V_11 ) ;
}
F_6 ( V_11 , V_41 , V_11 -> V_23 ) ;
...
struct V_10 * V_11 = F_43 ( V_93 ) ;
F_24 ( & V_11 -> V_17 ) ;
V_99 -> V_100 . V_110 . V_112 [ 0 ] = F_55 ( V_11 ) ;
F_26 ( & V_11 -> V_17 ) ;
return 0 ;
}
...
static int F_63 ( struct V_10 * V_11 , int V_117 )
{
int V_43 = 0 ;
if ( V_117 ) {
V_11 -> V_23 |= V_116 ;
...
static int F_67 ( struct V_10 * V_11 , int V_120 )
{
int V_43 = 0 ;
switch ( V_120 ) {
case 0 :
...
struct V_10 * V_11 = F_43 ( V_93 ) ;
F_24 ( & V_11 -> V_17 ) ;
V_99 -> V_100 . V_110 . V_112 [ 0 ] = F_66 ( V_11 ) ;
F_26 ( & V_11 -> V_17 ) ;
return 0 ;
}
...
static int F_72 ( struct V_10 * V_11 , int V_130 )
{
int V_43 ;
V_11 -> V_23 &= ~ V_121 ;
switch ( V_130 ) {
...
struct V_10 * V_11 = F_43 ( V_93 ) ;
F_24 ( & V_11 -> V_17 ) ;
V_99 -> V_100 . V_110 . V_112 [ 0 ] = F_71 ( V_11 ) ;
F_26 ( & V_11 -> V_17 ) ;
return 0 ;
}
...
static int F_87 ( struct V_156 * V_157 , struct V_10 * V_11 )
{
unsigned int V_158 ;
int V_136 ;
struct V_92 * V_159 ;
for ( V_158 = 0 ; V_158 < F_88 ( V_160 ) ; V_158 ++ ) {
if ( ( V_136 = F_89 ( V_157 , V_159 = F_90 ( & V_160 [ V_158 ] , V_11 ) ) ) < 0 )
return V_136 ;
if ( V_158 == 1 )
V_11 -> V_161 = V_159 ;
}
if ( V_11 -> V_53 == V_54 )
if ( ( V_136 = F_89 ( V_157 , V_159 = F_90 ( & V_162 , V_11 ) ) ) < 0 )
return V_136 ;
if ( V_11 -> V_78 >= 15 )
if ( ( V_136 = F_89 ( V_157 , V_159 = F_90 ( & V_163 , V_11 ) ) ) < 0 )
return V_136 ;
return 0 ;
}
static void
F_91 ( struct V_164 * V_165 , struct V_166 * V_167 )
{
struct V_10 * V_11 = (struct V_10 * ) V_165 -> V_147 ;
T_4 V_63 = V_11 -> V_63 ;
int V_168 = 0 ;
int V_22 ;
unsigned int V_29 ;
int V_79 ;
V_29 = F_8 ( V_11 , V_20 ) ;
F_92 ( V_167 , L_18 , V_11 -> V_82 , V_11 -> V_157 -> V_169 + 1 ) ;
F_92 ( V_167 , L_19 ,
V_11 -> V_170 , V_11 -> V_171 ) ;
F_92 ( V_167 , L_20 ,
V_11 -> V_172 , V_11 -> V_173 , ( unsigned long ) V_11 -> V_14 ) ;
F_92 ( V_167 , L_21 , V_11 -> V_23 ) ;
F_92 ( V_167 , L_22 ) ;
...
V_79 = V_29 & V_141 ;
if ( V_29 & V_140 ) {
F_92 ( V_167 , L_55 , V_79 ? L_56 : L_15 ) ;
} else {
F_92 ( V_167 , L_57 ) ;
}
V_79 = V_29 & V_143 ;
if ( V_29 & V_142 ) {
F_92 ( V_167 , L_58 , V_79 ? L_56 : L_15 ) ;
} else {
F_92 ( V_167 , L_59 ) ;
}
V_79 = V_29 & V_145 ;
if ( V_29 & V_144 ) {
F_92 ( V_167 , L_60 , V_79 ? L_56 : L_15 ) ;
} else {
F_92 ( V_167 , L_61 ) ;
}
F_92 ( V_167 , L_22 ) ;
...
if ( V_63 & ( 1 << V_22 ) ) {
F_92 ( V_167 , L_64 , V_22 + 1 ) ;
} else {
F_92 ( V_167 , L_65 , V_22 + 1 ) ;
}
if ( ( ( V_22 + 1 ) % 8 ) == 0 ) {
F_92 ( V_167 , L_22 ) ;
}
...
{
struct V_164 * V_165 ;
if ( ! F_94 ( V_11 -> V_157 , L_66 , & V_165 ) )
F_95 ( V_165 , V_11 , F_91 ) ;
}
static void F_96 ( struct V_10 * V_11 )
{
F_4 ( & V_11 -> V_178 , V_11 -> V_2 ) ;
F_4 ( & V_11 -> V_179 , V_11 -> V_2 ) ;
}
...
if ( F_1 ( V_11 -> V_2 , & V_11 -> V_178 , V_182 ) < 0 ||
F_1 ( V_11 -> V_2 , & V_11 -> V_179 , V_182 ) < 0 ) {
if ( V_11 -> V_178 . V_9 )
F_5 ( & V_11 -> V_178 ) ;
F_18 ( V_37 L_67 , V_11 -> V_82 ) ;
return - V_8 ;
}
V_181 = F_103 ( V_11 -> V_178 . V_183 , 0x10000ul ) ;
V_180 = F_103 ( V_11 -> V_179 . V_183 , 0x10000ul ) ;
F_6 ( V_11 , V_184 , V_181 ) ;
F_6 ( V_11 , V_185 , V_180 ) ;
V_11 -> V_170 = V_11 -> V_178 . V_9 + ( V_181 - V_11 -> V_178 . V_183 ) ;
V_11 -> V_171 = V_11 -> V_179 . V_9 + ( V_180 - V_11 -> V_179 . V_183 ) ;
return 0 ;
}
...
static T_7 F_105 ( int V_172 , void * V_186 )
{
struct V_10 * V_11 = (struct V_10 * ) V_186 ;
if ( ! ( F_8 ( V_11 , V_20 ) & V_187 ) ) {
return V_188 ;
}
F_6 ( V_11 , V_189 , 0 ) ;
if ( V_11 -> V_190 ) {
F_106 ( V_11 -> V_191 -> V_192 [ V_193 ] . V_194 ) ;
}
if ( V_11 -> V_195 ) {
F_106 ( V_11 -> V_191 -> V_192 [ V_196 ] . V_194 ) ;
}
return V_197 ;
}
static T_2 F_107 ( struct V_198 * V_194 )
{
struct V_10 * V_11 = F_108 ( V_194 ) ;
return F_17 ( V_11 ) ;
}
...
static int F_111 ( struct V_198 * V_194 , int V_60 ,
T_2 V_201 , void T_8 * V_202 , T_2 V_97 )
{
struct V_10 * V_11 = F_108 ( V_194 ) ;
char * V_203 ;
if ( F_110 ( V_201 + V_97 > V_200 / 4 ) )
return - V_52 ;
V_203 = F_109 ( V_11 ,
V_194 -> V_204 -> V_199 ,
V_60 ) ;
if ( F_110 ( ! V_203 ) )
return - V_154 ;
if ( F_112 ( V_203 + V_201 * 4 , V_202 , V_97 * 4 ) )
return - V_205 ;
return V_97 ;
}
static int F_113 ( struct V_198 * V_194 , int V_60 ,
T_2 V_201 , void T_8 * V_206 , T_2 V_97 )
{
struct V_10 * V_11 = F_108 ( V_194 ) ;
char * V_203 ;
if ( F_110 ( V_201 + V_97 > V_200 / 4 ) )
...
if ( F_110 ( ! V_203 ) )
return - V_154 ;
if ( F_114 ( V_206 , V_203 + V_201 * 4 , V_97 * 4 ) )
return - V_205 ;
return V_97 ;
}
static int F_115 ( struct V_198 * V_194 , int V_60 ,
T_2 V_201 , T_2 V_97 )
{
struct V_10 * V_11 = F_108 ( V_194 ) ;
char * V_203 ;
...
if ( F_110 ( ! V_203 ) )
return - V_154 ;
memset ( V_203 + V_201 * 4 , 0 , V_97 * 4 ) ;
return V_97 ;
}
static int F_116 ( struct V_198 * V_194 )
{
struct V_207 * V_208 = V_194 -> V_208 ;
struct V_10 * V_11 = F_108 ( V_194 ) ;
struct V_198 * V_209 ;
...
V_209 = V_11 -> V_195 ;
if ( V_11 -> V_45 )
V_208 -> V_29 -> V_210 = F_17 ( V_11 ) ;
else
V_208 -> V_29 -> V_210 = 0 ;
if ( V_209 ) {
struct V_198 * V_38 ;
struct V_207 * V_211 = V_209 -> V_208 ;
F_117 (s, substream) {
if ( V_38 == V_209 ) {
V_211 -> V_29 -> V_210 = V_208 -> V_29 -> V_210 ;
break;
}
}
}
...
static int F_118 ( struct V_198 * V_194 ,
struct V_212 * V_213 )
{
struct V_10 * V_11 = F_108 ( V_194 ) ;
int V_136 ;
...
if ( ( V_136 = F_27 ( V_11 , F_119 ( V_213 ) ) ) < 0 ) {
F_120 ( V_213 , V_216 ) ;
return V_136 ;
}
if ( ( V_136 = F_23 ( V_11 , F_121 ( V_213 ) ) ) < 0 ) {
F_120 ( V_213 , V_217 ) ;
return V_136 ;
}
return 0 ;
}
static int F_122 ( struct V_198 * V_194 ,
struct V_218 * V_219 )
{
struct V_10 * V_11 = F_108 ( V_194 ) ;
int V_135 ;
if ( F_110 ( V_219 -> V_60 >= V_54 ) )
return - V_52 ;
if ( ( V_135 = V_11 -> V_55 [ V_219 -> V_60 ] ) < 0 ) {
return - V_52 ;
}
V_219 -> V_30 = V_135 * V_200 ;
V_219 -> V_220 = 0 ;
V_219 -> V_221 = 32 ;
return 0 ;
}
static int F_123 ( struct V_198 * V_194 ,
unsigned int V_222 , void * V_223 )
{
switch ( V_222 ) {
case V_224 :
{
...
case V_225 :
{
struct V_218 * V_219 = V_223 ;
return F_122 ( V_194 , V_219 ) ;
}
default:
break;
}
return F_124 ( V_194 , V_222 , V_223 ) ;
}
static void F_125 ( struct V_10 * V_11 )
{
memset ( V_11 -> V_171 , 0 , V_182 ) ;
}
static int F_126 ( struct V_198 * V_194 ,
int V_222 )
{
struct V_10 * V_11 = F_108 ( V_194 ) ;
struct V_198 * V_209 ;
...
static int F_131 ( struct V_198 * V_194 )
{
struct V_10 * V_11 = F_108 ( V_194 ) ;
unsigned long V_15 ;
int V_229 = 0 ;
...
struct V_230 * V_231 )
{
struct V_10 * V_11 = V_231 -> V_232 ;
struct V_233 * V_234 = F_133 ( V_213 , V_235 ) ;
unsigned int V_236 [ 2 ] = { V_11 -> V_237 , V_11 -> V_53 } ;
return F_134 ( V_234 , 2 , V_236 , 0 ) ;
}
...
struct V_10 * V_11 = V_231 -> V_232 ;
struct V_233 * V_234 = F_133 ( V_213 , V_235 ) ;
struct V_233 * V_238 = F_133 ( V_213 , V_216 ) ;
if ( V_238 -> V_133 > 48000 ) {
struct V_233 V_239 = {
. V_133 = V_11 -> V_237 ,
. V_131 = V_11 -> V_237 ,
. integer = 1 ,
} ;
return F_136 ( V_234 , & V_239 ) ;
} else if ( V_238 -> V_131 < 88200 ) {
struct V_233 V_239 = {
. V_133 = V_11 -> V_53 ,
. V_131 = V_11 -> V_53 ,
. integer = 1 ,
...
struct V_233 * V_234 = F_133 ( V_213 , V_235 ) ;
struct V_233 * V_238 = F_133 ( V_213 , V_216 ) ;
if ( V_234 -> V_133 >= V_11 -> V_53 ) {
struct V_233 V_239 = {
. V_133 = 44100 ,
. V_131 = 48000 ,
. integer = 1 ,
} ;
return F_136 ( V_238 , & V_239 ) ;
} else if ( V_234 -> V_131 <= V_11 -> V_237 ) {
struct V_233 V_239 = {
. V_133 = 88200 ,
. V_131 = 96000 ,
. integer = 1 ,
...
static int F_138 ( struct V_198 * V_194 )
{
struct V_10 * V_11 = F_108 ( V_194 ) ;
struct V_207 * V_208 = V_194 -> V_208 ;
F_24 ( & V_11 -> V_17 ) ;
F_139 ( V_194 ) ;
V_208 -> V_240 = V_241 ;
V_208 -> V_242 = V_11 -> V_171 ;
V_208 -> V_243 = V_182 ;
if ( V_11 -> V_190 == NULL ) {
F_22 ( V_11 ) ;
F_28 ( V_11 , - 1 , 0 ) ;
}
V_11 -> V_18 = V_244 -> V_245 ;
V_11 -> V_195 = V_194 ;
F_26 ( & V_11 -> V_17 ) ;
F_140 ( V_208 , 0 , 32 , 24 ) ;
F_141 ( V_208 , 0 , V_217 , & V_246 ) ;
F_142 ( V_208 , 0 , V_235 ,
F_132 , V_11 ,
V_235 , - 1 ) ;
F_142 ( V_208 , 0 , V_235 ,
...
V_11 -> V_161 -> V_247 [ 0 ] . V_248 &= ~ V_249 ;
F_143 ( V_11 -> V_157 , V_250 |
V_251 , & V_11 -> V_161 -> V_252 ) ;
return 0 ;
}
static int F_144 ( struct V_198 * V_194 )
{
struct V_10 * V_11 = F_108 ( V_194 ) ;
F_24 ( & V_11 -> V_17 ) ;
V_11 -> V_18 = - 1 ;
...
static int F_145 ( struct V_198 * V_194 )
{
struct V_10 * V_11 = F_108 ( V_194 ) ;
struct V_207 * V_208 = V_194 -> V_208 ;
F_24 ( & V_11 -> V_17 ) ;
F_139 ( V_194 ) ;
V_208 -> V_240 = V_253 ;
V_208 -> V_242 = V_11 -> V_170 ;
V_208 -> V_243 = V_182 ;
if ( V_11 -> V_195 == NULL ) {
F_22 ( V_11 ) ;
F_28 ( V_11 , - 1 , 0 ) ;
}
V_11 -> V_19 = V_244 -> V_245 ;
V_11 -> V_190 = V_194 ;
F_26 ( & V_11 -> V_17 ) ;
F_140 ( V_208 , 0 , 32 , 24 ) ;
F_141 ( V_208 , 0 , V_217 , & V_246 ) ;
...
static int F_146 ( struct V_198 * V_194 )
{
struct V_10 * V_11 = F_108 ( V_194 ) ;
F_24 ( & V_11 -> V_17 ) ;
V_11 -> V_19 = - 1 ;
...
static int F_147 ( struct V_156 * V_157 ,
struct V_10 * V_11 )
{
struct V_254 * V_191 ;
int V_136 ;
if ( ( V_136 = F_148 ( V_157 ,
V_11 -> V_82 ,
0 , 1 , 1 , & V_191 ) ) < 0 ) {
return V_136 ;
}
V_11 -> V_191 = V_191 ;
V_191 -> V_147 = V_11 ;
strcpy ( V_191 -> V_113 , V_11 -> V_82 ) ;
F_149 ( V_191 , V_196 , & V_255 ) ;
F_149 ( V_191 , V_193 , & V_256 ) ;
V_191 -> V_257 = V_258 ;
return 0 ;
}
static int F_150 ( struct V_156 * V_157 ,
struct V_10 * V_11 ,
int V_34 )
{
...
if ( ( V_136 = F_152 ( V_2 ) ) < 0 )
return V_136 ;
F_153 ( & V_11 -> V_17 ) ;
if ( ( V_136 = F_154 ( V_2 , L_66 ) ) < 0 )
return V_136 ;
V_11 -> V_173 = F_155 ( V_2 , 0 ) ;
V_11 -> V_14 = F_156 ( V_11 -> V_173 , V_262 ) ;
if ( V_11 -> V_14 == NULL ) {
F_38 ( V_37 L_68 , V_11 -> V_173 , V_11 -> V_173 + V_262 - 1 ) ;
return - V_49 ;
}
if ( F_157 ( V_2 -> V_172 , F_105 , V_263 ,
V_264 , V_11 ) ) {
F_38 ( V_37 L_69 , V_2 -> V_172 ) ;
return - V_49 ;
}
V_11 -> V_172 = V_2 -> V_172 ;
V_11 -> V_34 = V_34 ;
V_29 = F_8 ( V_11 , V_20 ) ;
if ( F_37 ( V_29 & V_81 ) == 1 ) {
V_11 -> V_78 = 15 ;
...
V_11 -> V_237 = ( V_11 -> V_53 - 2 ) / 2 + 2 ;
F_158 ( V_11 -> V_2 ) ;
if ( ( V_136 = F_102 ( V_11 ) ) < 0 ) {
return V_136 ;
}
if ( ( V_136 = F_147 ( V_157 , V_11 ) ) < 0 ) {
return V_136 ;
}
if ( ( V_136 = F_87 ( V_157 , V_11 ) ) < 0 ) {
return V_136 ;
}
F_93 ( V_11 ) ;
V_11 -> V_267 = - 1 ;
...
static void F_159 ( struct V_156 * V_157 )
{
struct V_10 * V_11 = (struct V_10 * ) V_157 -> V_147 ;
if ( V_11 )
F_97 ( V_11 ) ;
}
...
V_136 = F_161 ( V_273 [ V_6 ] , V_252 [ V_6 ] , V_274 ,
sizeof( struct V_10 ) , & V_157 ) ;
if ( V_136 < 0 )
return V_136 ;
V_11 = (struct V_10 * ) V_157 -> V_147 ;
V_157 -> V_275 = F_159 ;
V_11 -> V_6 = V_6 ;
V_11 -> V_2 = V_2 ;
F_162 ( V_157 , & V_2 -> V_6 ) ;
if ( ( V_136 = F_150 ( V_157 , V_11 , V_34 [ V_6 ] ) ) < 0 ) {
F_163 ( V_157 ) ;
return V_136 ;
}
strcpy ( V_157 -> V_276 , V_11 -> V_82 ) ;
sprintf ( V_157 -> V_277 , L_78 ,
V_157 -> V_276 , V_11 -> V_173 , V_11 -> V_172 ) ;
if ( ( V_136 = F_164 ( V_157 ) ) < 0 ) {
F_163 ( V_157 ) ;
return V_136 ;
}
F_165 ( V_2 , V_157 ) ;
