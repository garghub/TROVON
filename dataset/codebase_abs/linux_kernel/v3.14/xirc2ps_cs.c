...
V_163 = V_106 + 2 < V_164 ;
F_54 ( L_42 ,
V_13 -> V_111 , V_164 , V_163 ? L_43 : L_44 ) ;
if ( ! V_163 ) {
return V_170 ;
}
...
F_45 ( V_13 , L_46 , V_191 [ V_13 -> V_92 ] ) ;
F_42 ( V_13 , 1 ) ;
}
return 0 ;
}
...
struct V_192 * V_193 )
{
F_83 ( V_193 -> V_194 , L_48 , sizeof( V_193 -> V_194 ) ) ;
snprintf ( V_193 -> V_195 , sizeof( V_193 -> V_195 ) , L_49 ,
V_13 -> V_94 ) ;
}
static int
F_84 ( struct V_12 * V_13 , struct V_196 * V_197 , int V_198 )
{
T_2 * V_14 = F_15 ( V_13 ) ;
unsigned int V_1 = V_13 -> V_94 ;
struct V_199 * V_3 = F_85 ( V_197 ) ;
F_54 ( L_50 ,
...
unsigned int V_1 = V_13 -> V_94 ;
unsigned V_180 ;
F_54 ( L_51 , V_13 ? V_13 -> V_111 : L_52 , V_13 , V_211 ) ;
F_86 ( V_13 ) ;
F_2 ( V_110 , V_212 ) ;
F_87 ( 20 ) ;
F_2 ( V_110 , 0 ) ;
...
static int T_10 F_90 ( char * V_232 )
{
int V_233 [ 10 ] = { - 1 } ;
V_232 = F_91 ( V_232 , 9 , V_233 ) ;
#define F_92 ( T_11 , T_12 ) if (ints[0] >= Y && ints[Y] != -1) { X = ints[Y]; }
F_92 ( V_92 , 3 ) ;
F_92 ( V_225 , 4 ) ;
F_92 ( V_83 , 5 ) ;
F_92 ( V_157 , 6 ) ;
