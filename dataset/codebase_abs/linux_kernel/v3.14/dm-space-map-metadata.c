...
static int F_18 ( int V_35 , int V_36 )
{
...
{
struct V_25 * V_26 = F_21 ( V_38 , struct V_25 , V_38 ) ;
F_22 ( V_26 ) ;
}
static int F_23 ( struct V_37 * V_38 , T_1 * V_39 )
{
struct V_25 * V_26 = F_21 ( V_38 , struct V_25 , V_38 ) ;
* V_39 = V_26 -> V_32 . V_40 ;
return 0 ;
...
static int F_25 ( struct V_37 * V_38 , T_1 V_17 ,
T_3 * V_23 )
{
int V_14 ;
unsigned V_44 ;
...
static int F_29 ( struct V_37 * V_38 , T_1 V_17 ,
T_3 V_39 )
{
int V_14 , V_36 ;
enum V_29 V_30 ;
...
F_16 ( V_26 ) ;
V_14 = F_30 ( & V_26 -> V_32 , V_17 , V_39 , & V_30 ) ;
V_36 = F_17 ( V_26 ) ;
...
enum V_29 V_30 ;
struct V_25 * V_26 = F_21 ( V_38 , struct V_25 , V_38 ) ;
V_14 = F_34 ( & V_26 -> V_41 , V_26 -> V_11 , V_26 -> V_41 . V_40 , V_17 ) ;
if ( V_14 )
return V_14 ;
V_26 -> V_11 = * V_17 + 1 ;
if ( F_19 ( V_26 ) )
...
static int F_40 ( struct V_37 * V_38 , T_4 * V_23 )
{
* V_23 = sizeof( struct V_48 ) ;
return 0 ;
}
static int F_41 ( struct V_37 * V_38 , void * V_49 , T_4 V_50 )
{
struct V_25 * V_26 = F_21 ( V_38 , struct V_25 , V_38 ) ;
struct V_48 V_51 ;
V_51 . V_40 = F_42 ( V_26 -> V_32 . V_40 ) ;
V_51 . V_42 = F_42 ( V_26 -> V_32 . V_42 ) ;
V_51 . V_52 = F_42 ( V_26 -> V_32 . V_52 ) ;
V_51 . V_53 = F_42 ( V_26 -> V_32 . V_53 ) ;
if ( V_50 < sizeof( V_51 ) )
return - V_54 ;
...
static int F_44 ( struct V_37 * V_38 , T_1 V_55 )
{
F_12 ( L_7 ) ;
return - V_47 ;
}
static int F_45 ( struct V_37 * V_38 , T_1 * V_39 )
{
struct V_25 * V_26 = F_21 ( V_38 , struct V_25 , V_38 ) ;
return V_26 -> V_32 . V_40 ;
}
...
static int F_47 ( struct V_37 * V_38 , T_1 V_17 ,
T_3 * V_23 )
{
struct V_25 * V_26 = F_21 ( V_38 , struct V_25 , V_38 ) ;
return V_17 < V_26 -> V_11 ? 1 : 0 ;
}
...
static int F_54 ( struct V_37 * V_38 , T_4 * V_23 )
{
F_12 ( L_9 ) ;
return - V_47 ;
}
static int F_55 ( struct V_37 * V_38 , void * V_56 ,
T_4 V_50 )
{
F_12 ( L_10 ) ;
return - V_47 ;
}
static int F_56 ( struct V_37 * V_38 , T_1 V_55 )
{
int V_14 , V_44 ;
enum V_29 V_30 ;
struct V_25 * V_26 = F_21 ( V_38 , struct V_25 , V_38 ) ;
...
F_17:
memcpy ( V_38 , & V_59 , sizeof( * V_38 ) ) ;
return V_14 ;
}
struct V_37 * F_58 ( void )
{
struct V_25 * V_26 ;
V_26 = F_59 ( sizeof( * V_26 ) , V_60 ) ;
if ( ! V_26 )
return F_60 ( - V_21 ) ;
memcpy ( & V_26 -> V_38 , & V_59 , sizeof( V_26 -> V_38 ) ) ;
return & V_26 -> V_38 ;
}
...
V_14 = F_62 ( & V_26 -> V_32 , V_62 ) ;
if ( V_14 )
return V_14 ;
if ( V_40 > V_64 )
V_40 = V_64 ;
V_14 = F_57 ( & V_26 -> V_32 , V_40 ) ;
if ( V_14 )
return V_14 ;
memcpy ( & V_26 -> V_38 , & V_59 , sizeof( V_26 -> V_38 ) ) ;
for ( V_44 = V_63 ; ! V_14 && V_44 < V_26 -> V_11 ; V_44 ++ )
V_14 = F_14 ( & V_26 -> V_32 , V_44 , & V_30 ) ;
if ( V_14 )
return V_14 ;
return F_37 ( V_38 ) ;
...
int V_14 ;
struct V_25 * V_26 = F_21 ( V_38 , struct V_25 , V_38 ) ;
V_14 = F_64 ( & V_26 -> V_32 , V_62 , V_51 , V_65 ) ;
if ( V_14 )
return V_14 ;
V_26 -> V_11 = 0 ;
V_26 -> V_34 = 0 ;
