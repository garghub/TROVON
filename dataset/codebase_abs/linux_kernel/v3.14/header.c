...
static int F_16 ( const char * V_28 , T_1 V_29 , T_4 * V_30 ,
...
return;
for ( V_24 = 0 ; V_24 < V_118 -> V_124 ; V_24 ++ )
F_72 ( & V_118 -> V_125 [ V_24 ] ) ;
for ( V_24 = 0 ; V_24 < V_118 -> V_127 ; V_24 ++ )
F_72 ( & V_118 -> V_128 [ V_24 ] ) ;
free ( V_118 ) ;
}
static struct V_117 * F_73 ( void )
{
struct V_117 * V_118 ;
void * V_129 ;
T_2 V_99 , V_24 ;
...
static int F_75 ( int V_5 , struct V_1 * T_7 V_82 ,
struct V_83 * V_84 V_82 )
{
char * V_6 = NULL ;
T_8 * V_120 ;
...
static int F_76 ( int V_5 , int V_133 )
{
char V_16 [ V_114 ] ;
char V_134 [ 32 ] ;
char * V_6 = NULL , * V_94 ;
...
static int F_77 ( int V_5 , struct V_1 * T_7 V_82 ,
struct V_83 * V_84 V_82 )
{
char * V_6 = NULL ;
T_1 V_17 = 0 ;
...
static int F_79 ( int V_5 , struct V_1 * T_7 V_82 ,
struct V_83 * V_84 V_82 )
{
struct V_142 * V_143 = NULL ;
T_10 V_144 = F_80 ( V_5 , 0 , V_145 ) ;
T_11 V_146 = 0 ;
int V_8 ;
V_8 = F_7 ( V_5 , & V_146 , sizeof( V_146 ) ) ;
if ( V_8 < 0 )
return V_8 ;
while ( ( V_143 = F_81 ( V_143 ) ) ) {
if ( ! V_143 -> V_28 )
continue;
V_146 ++ ;
...
if ( F_82 ( V_5 , & V_146 , sizeof( V_146 ) , V_144 ) != sizeof( V_146 ) ) {
F_80 ( V_5 , V_144 , V_147 ) ;
return - 1 ;
}
return 0 ;
}
static int F_83 ( int V_5 , struct V_1 * T_7 V_82 ,
struct V_83 * V_84 )
{
...
static int F_85 ( int V_5 , struct V_1 * T_7 V_82 ,
struct V_83 * V_84 V_82 )
{
char V_153 [ 64 ] ;
int V_8 ;
V_8 = F_86 ( V_153 , sizeof( V_153 ) ) ;
if ( ! V_8 )
goto V_154;
return - 1 ;
V_154:
...
static void F_89 ( struct V_1 * V_19 , int V_5 V_82 ,
T_8 * V_120 )
{
fprintf ( V_120 , L_25 , V_19 -> V_155 . V_157 ) ;
}
static void F_90 ( struct V_1 * V_19 , int V_5 V_82 , T_8 * V_120 )
{
...
static void F_95 ( struct V_1 * V_19 , int V_5 V_82 ,
T_8 * V_120 )
{
int V_99 , V_24 ;
char * V_16 ;
...
static void F_96 ( struct V_105 * V_169 )
{
struct V_105 * V_106 ;
if ( ! V_169 )
return;
...
static void F_100 ( struct V_1 * V_19 , int V_5 , T_8 * V_120 )
{
struct V_105 * V_106 , * V_169 = F_97 ( V_19 , V_5 ) ;
T_2 V_140 ;
V_113 * V_112 ;
if ( ! V_169 ) {
fprintf ( V_120 , L_35 ) ;
...
static void F_102 ( struct V_1 * V_19 , int V_5 V_82 ,
T_8 * V_120 )
{
T_2 V_99 , V_139 , V_24 ;
char * V_16 , * V_185 ;
...
goto error;
V_16 = V_185 + 1 ;
V_135 = F_103 ( V_16 , & V_185 , 0 ) ;
if ( * V_185 != ':' )
goto error;
V_16 = V_185 + 1 ;
V_136 = F_103 ( V_16 , & V_185 , 0 ) ;
if ( * V_185 != ':' )
goto error;
...
static void F_104 ( struct V_1 * V_19 , int V_5 V_82 , T_8 * V_120 )
{
fprintf ( V_120 , L_56 , V_19 -> V_155 . V_188 ) ;
}
static void F_105 ( struct V_1 * V_19 V_82 ,
...
static void F_107 ( struct V_1 * V_19 , int V_5 V_82 ,
T_8 * V_120 )
{
struct V_56 * V_57 ;
struct V_105 * V_106 ;
...
static int F_108 ( struct V_33 * V_193 ,
char * V_68 ,
struct V_56 * V_57 )
{
int V_15 = - 1 ;
...
V_41 = F_110 ( V_37 , V_68 ) ;
if ( V_41 != NULL ) {
char V_63 [ V_35 * 2 + 1 ] ;
F_111 ( V_41 , & V_193 -> V_30 ) ;
if ( V_68 [ 0 ] == '[' )
V_41 -> V_78 = V_195 ;
...
if ( F_80 ( V_200 , V_206 , V_147 ) == ( T_10 ) - 1 )
return - 1 ;
return F_112 ( V_2 , V_200 , V_144 , V_7 ) ;
}
F_108 ( & V_193 , V_68 , V_57 ) ;
V_144 += V_193 . V_2 . V_7 ;
}
...
static int F_115 ( struct V_207 * T_12 V_82 ,
struct V_1 * V_19 V_82 ,
int V_5 , void * V_208 )
{
T_3 V_8 = F_116 ( V_5 , V_208 , false ) ;
return V_8 < 0 ? - 1 : 0 ;
}
static int F_117 ( struct V_207 * T_12 ,
struct V_1 * V_19 , int V_5 ,
void * V_208 V_82 )
{
if ( F_114 ( V_19 , V_5 , T_12 -> V_144 , T_12 -> V_7 ) )
F_31 ( L_69 ) ;
return 0 ;
}
...
static int F_125 ( struct V_207 * T_12 V_82 ,
struct V_1 * V_19 , int V_5 ,
void * V_208 V_82 )
{
T_9 V_131 ;
...
static struct V_105 *
F_126 ( struct V_83 * V_84 , int V_152 )
{
struct V_105 * V_106 ;
F_66 (evlist, evsel) {
...
static void
F_127 ( struct V_83 * V_84 ,
struct V_105 * V_209 )
{
struct V_105 * V_106 ;
if ( ! V_209 -> V_28 )
return;
V_106 = F_126 ( V_84 , V_209 -> V_152 ) ;
if ( ! V_106 )
return;
if ( V_106 -> V_28 )
return;
V_106 -> V_28 = F_128 ( V_209 -> V_28 ) ;
}
static int
F_129 ( struct V_207 * T_12 V_82 ,
struct V_1 * V_2 , int V_5 ,
void * V_208 V_82 )
{
struct V_56 * V_57 ;
struct V_105 * V_106 , * V_169 = F_97 ( V_2 , V_5 ) ;
if ( ! V_169 )
return 0 ;
V_57 = F_25 ( V_2 , struct V_56 , V_2 ) ;
for ( V_106 = V_169 ; V_106 -> V_110 . V_7 ; V_106 ++ )
F_127 ( V_57 -> V_84 , V_106 ) ;
F_96 ( V_169 ) ;
return 0 ;
}
static int F_130 ( struct V_207 * T_12 V_82 ,
struct V_1 * V_19 , int V_5 ,
void * V_208 V_82 )
{
T_3 V_8 ;
...
if ( ! V_16 )
goto error;
F_132 ( & V_211 , V_16 , strlen ( V_16 ) + 1 ) ;
free ( V_16 ) ;
}
V_19 -> V_155 . V_164 = F_133 ( & V_211 , NULL ) ;
return 0 ;
error:
F_134 ( & V_211 ) ;
return - 1 ;
...
V_19 -> V_155 . V_166 = F_133 ( & V_211 , NULL ) ;
V_8 = F_13 ( V_5 , & V_99 , sizeof( V_99 ) ) ;
if ( V_8 != sizeof( V_99 ) )
return - 1 ;
if ( V_19 -> V_21 )
...
V_19 -> V_155 . V_168 = F_133 ( & V_211 , NULL ) ;
return 0 ;
error:
F_134 ( & V_211 ) ;
return - 1 ;
}
static int F_136 ( struct V_207 * T_12 V_82 ,
struct V_1 * V_19 , int V_5 ,
void * V_208 V_82 )
{
T_3 V_8 ;
...
F_137 ( & V_211 , L_70 V_132 L_71 V_132 L_72 ,
V_133 , V_135 , V_136 ) ;
V_16 = F_12 ( V_5 , V_19 ) ;
if ( ! V_16 )
goto error;
...
V_19 -> V_155 . V_187 = F_133 ( & V_211 , NULL ) ;
return 0 ;
error:
F_134 ( & V_211 ) ;
return - 1 ;
...
if ( ! V_28 )
goto error;
F_137 ( & V_211 , L_74 , type , V_28 ) ;
F_132 ( & V_211 , L_4 , 1 ) ;
free ( V_28 ) ;
V_146 -- ;
}
V_19 -> V_155 . V_191 = F_133 ( & V_211 , NULL ) ;
return 0 ;
error:
F_134 ( & V_211 ) ;
return - 1 ;
}
static int F_139 ( struct V_207 * T_12 V_82 ,
struct V_1 * V_19 , int V_5 ,
void * V_208 V_82 )
{
T_1 V_8 = - 1 ;
...
V_74:
for ( V_24 = 0 ; V_24 < V_148 ; V_24 ++ )
F_72 ( & V_214 [ V_24 ] . V_28 ) ;
free ( V_214 ) ;
return V_8 ;
}
static int F_140 ( struct V_207 * T_12 ,
struct V_1 * V_19 ,
int V_3 , int V_5 , void * V_208 )
{
struct V_215 * V_216 = V_208 ;
if ( F_80 ( V_5 , T_12 -> V_144 , V_147 ) == ( T_10 ) - 1 ) {
...
int F_142 ( struct V_56 * V_57 , T_8 * V_120 , bool V_221 )
{
struct V_215 V_216 ;
struct V_1 * V_2 = & V_57 -> V_2 ;
int V_5 = F_143 ( V_57 -> V_92 ) ;
V_216 . V_120 = V_120 ;
V_216 . V_221 = V_221 ;
F_144 ( V_2 , V_5 , & V_216 ,
F_140 ) ;
...
static int F_145 ( int V_5 , struct V_1 * T_7 , int type ,
struct V_207 * * V_94 ,
struct V_83 * V_84 )
{
int V_15 ;
...
if ( ! V_218 [ type ] . F_8 )
return - 1 ;
( * V_94 ) -> V_144 = F_80 ( V_5 , 0 , V_145 ) ;
V_15 = V_218 [ type ] . F_8 ( V_5 , T_7 , V_84 ) ;
if ( V_15 < 0 ) {
F_31 ( L_82 , type ) ;
F_80 ( V_5 , ( * V_94 ) -> V_144 , V_147 ) ;
return - 1 ;
}
( * V_94 ) -> V_7 = F_80 ( V_5 , 0 , V_145 ) - ( * V_94 ) -> V_144 ;
( * V_94 ) ++ ;
}
return V_8 ;
}
...
V_225 = V_2 -> V_227 ;
F_80 ( V_5 , V_225 + V_224 , V_147 ) ;
F_148 (feat, header->adds_features, HEADER_FEAT_BITS) {
if ( F_145 ( V_5 , V_2 , V_3 , & V_94 , V_84 ) )
F_3 ( V_2 , V_3 ) ;
}
F_80 ( V_5 , V_225 , V_147 ) ;
...
V_113 V_236 ;
int V_15 ;
F_80 ( V_5 , sizeof( V_229 ) , V_147 ) ;
F_66 (session->evlist, evsel) {
V_106 -> V_237 = F_80 ( V_5 , 0 , V_145 ) ;
...
if ( ! V_2 -> V_238 )
V_2 -> V_238 = F_80 ( V_5 , 0 , V_145 ) ;
V_2 -> V_227 = V_2 -> V_238 + V_2 -> V_239 ;
if ( V_232 ) {
V_15 = F_146 ( V_2 , V_84 , V_5 ) ;
if ( V_15 < 0 )
return V_15 ;
}
V_229 = (struct V_233 ) {
...
F_80 ( V_5 , V_2 -> V_238 + V_2 -> V_239 , V_147 ) ;
return 0 ;
}
...
int F_144 ( struct V_1 * V_2 , int V_5 ,
void * V_208 ,
int (* F_153)( struct V_207 * T_12 ,
struct V_1 * V_19 ,
int V_3 , int V_5 , void * V_208 ) )
{
...
return - 1 ;
V_224 = sizeof( * V_223 ) * V_222 ;
F_80 ( V_5 , V_2 -> V_227 , V_147 ) ;
V_15 = F_151 ( V_2 , V_5 , V_223 , V_224 ) ;
if ( V_15 < 0 )
goto V_74;
F_148 (feat, header->adds_features, HEADER_LAST_FEATURE) {
V_15 = F_153 ( V_242 ++ , V_2 , V_3 , V_5 , V_208 ) ;
if ( V_15 < 0 )
goto V_74;
}
V_15 = 0 ;
...
static int F_155 ( T_9 V_243 , struct V_1 * V_19 )
{
V_113 V_240 ;
int V_24 ;
...
static int F_157 ( V_113 V_230 , T_9 V_243 ,
...
if ( V_19 -> V_21 ) {
F_152 ( V_2 , F_159 ( struct V_233 ,
V_4 ) ) ;
}
if ( V_2 -> V_7 != sizeof( * V_2 ) ) {
if ( V_2 -> V_7 == F_159 ( F_160 ( * V_2 ) , V_4 ) )
F_161 ( V_2 -> V_4 , V_226 ) ;
else
return - 1 ;
} else if ( V_19 -> V_21 ) {
...
static int F_165 ( struct V_207 * T_12 ,
struct V_1 * V_19 ,
int V_3 , int V_5 , void * V_208 )
{
if ( F_80 ( V_5 , T_12 -> V_144 , V_147 ) == ( T_10 ) - 1 ) {
...
if ( ! V_218 [ V_3 ] . F_153 )
return 0 ;
return V_218 [ V_3 ] . F_153 ( T_12 , V_19 , V_5 , V_208 ) ;
}
static int F_166 ( struct V_228 * V_2 ,
struct V_1 * V_19 , int V_5 ,
bool V_255 )
{
T_3 V_8 ;
...
if ( V_8 <= 0 )
return - 1 ;
if ( F_157 ( V_2 -> V_230 , V_2 -> V_7 , true , V_19 ) < 0 ) {
F_31 ( L_92 ) ;
return - 1 ;
}
if ( V_19 -> V_21 )
V_2 -> V_7 = F_99 ( V_2 -> V_7 ) ;
if ( V_255 && F_7 ( V_256 , V_2 , sizeof( * V_2 ) ) < 0 )
return - 1 ;
return 0 ;
}
static int F_167 ( struct V_56 * V_57 )
{
struct V_1 * V_2 = & V_57 -> V_2 ;
struct V_228 V_229 ;
if ( F_166 ( & V_229 , V_2 ,
...
static int F_168 ( int V_5 , struct V_1 * V_19 ,
struct V_234 * V_235 )
{
...
static int F_169 ( struct V_105 * V_106 ,
struct V_263 * V_263 )
{
struct V_264 * V_209 ;
char V_10 [ 128 ] ;
...
V_209 = F_170 ( V_263 , V_106 -> V_110 . V_173 ) ;
if ( V_209 == NULL )
return - 1 ;
if ( ! V_106 -> V_28 ) {
snprintf ( V_10 , sizeof( V_10 ) , L_98 , V_209 -> system , V_209 -> V_28 ) ;
V_106 -> V_28 = F_128 ( V_10 ) ;
if ( V_106 -> V_28 == NULL )
return - 1 ;
}
V_106 -> V_265 = V_209 ;
...
F_80 ( V_5 , V_229 . V_241 . V_144 , V_147 ) ;
for ( V_24 = 0 ; V_24 < V_269 ; V_24 ++ ) {
struct V_105 * V_106 ;
T_10 V_185 ;
if ( F_168 ( V_5 , V_2 , & V_235 ) < 0 )
goto V_272;
if ( V_2 -> V_21 )
F_98 ( & V_235 . V_110 ) ;
V_185 = F_80 ( V_5 , 0 , V_145 ) ;
V_106 = F_175 ( & V_235 . V_110 ) ;
if ( V_106 == NULL )
goto V_273;
V_106 -> V_21 = V_2 -> V_21 ;
F_176 ( V_57 -> V_84 , V_106 ) ;
V_270 = V_235 . V_111 . V_7 / sizeof( V_113 ) ;
if ( F_177 ( V_106 , 1 , V_270 ) )
goto V_273;
F_80 ( V_5 , V_235 . V_111 . V_144 , V_147 ) ;
for ( V_140 = 0 ; V_140 < V_270 ; V_140 ++ ) {
if ( F_151 ( V_2 , V_5 , & V_268 , sizeof( V_268 ) ) )
goto V_272;
F_178 ( V_57 -> V_84 , V_106 , 0 , V_140 , V_268 ) ;
}
F_80 ( V_5 , V_185 , V_147 ) ;
}
V_72 . V_274 = V_269 ;
F_144 ( V_2 , V_5 , & V_57 -> V_275 ,
F_165 ) ;
if ( F_171 ( V_57 -> V_84 ,
V_57 -> V_275 . V_263 ) )
goto V_273;
...
if ( V_279 == NULL )
return - V_27 ;
V_279 -> V_110 . V_110 = * V_110 ;
memcpy ( V_279 -> V_110 . V_112 , V_112 , V_111 * sizeof( V_113 ) ) ;
V_279 -> V_110 . V_2 . type = V_280 ;
V_279 -> V_110 . V_2 . V_7 = ( T_6 ) V_7 ;
if ( V_279 -> V_110 . V_2 . V_7 == V_7 )
V_15 = F_153 ( V_277 , V_279 , NULL , NULL ) ;
else
V_15 = - V_281 ;
free ( V_279 ) ;
return V_15 ;
}
int F_181 ( struct V_276 * V_277 ,
struct V_56 * V_57 ,
T_13 F_153 )
{
struct V_105 * V_106 ;
int V_15 = 0 ;
F_66 (session->evlist, evsel) {
V_15 = F_180 ( V_277 , & V_106 -> V_110 , V_106 -> V_111 ,
V_106 -> V_112 , F_153 ) ;
if ( V_15 ) {
F_31 ( L_101 ) ;
return V_15 ;
...
int F_182 ( struct V_276 * V_277 V_82 ,
union V_278 * V_209 ,
struct V_83 * * V_282 )
{
T_2 V_24 , V_111 , V_283 ;
struct V_105 * V_106 ;
...
V_106 = F_175 ( & V_209 -> V_110 . V_110 ) ;
if ( V_106 == NULL )
return - V_27 ;
F_176 ( V_84 , V_106 ) ;
V_111 = V_209 -> V_2 . V_7 ;
V_111 -= ( void * ) & V_209 -> V_110 . V_112 - ( void * ) V_209 ;
V_283 = V_111 / sizeof( V_113 ) ;
if ( F_177 ( V_106 , 1 , V_283 ) )
return - V_27 ;
for ( V_24 = 0 ; V_24 < V_283 ; V_24 ++ ) {
F_178 ( V_84 , V_106 , 0 , V_24 , V_209 -> V_110 . V_112 [ V_24 ] ) ;
}
V_72 . V_274 = V_84 -> V_109 ;
return 0 ;
}
int F_183 ( struct V_276 * V_277 , int V_5 ,
struct V_83 * V_84 ,
T_13 F_153 )
{
union V_278 V_279 ;
struct V_284 * V_285 ;
T_3 V_7 = 0 , V_286 = 0 , V_287 ;
int V_15 V_82 = 0 ;
V_285 = F_184 ( & V_84 -> V_85 , V_5 , true ) ;
if ( ! V_285 )
return - 1 ;
memset ( & V_279 , 0 , sizeof( V_279 ) ) ;
V_279 . V_284 . V_2 . type = V_288 ;
V_7 = V_285 -> V_7 ;
V_286 = F_11 ( V_7 , sizeof( V_113 ) ) ;
V_287 = V_286 - V_7 ;
V_279 . V_284 . V_2 . V_7 = sizeof( V_279 . V_284 ) ;
V_279 . V_284 . V_7 = V_286 ;
F_153 ( V_277 , & V_279 , NULL , NULL ) ;
F_185 ( V_285 ) ;
F_9 ( V_5 , NULL , 0 , V_287 ) ;
return V_286 ;
}
int F_186 ( struct V_276 * V_277 V_82 ,
union V_278 * V_209 ,
struct V_56 * V_57 )
{
T_3 V_289 , V_287 , V_7 = V_209 -> V_284 . V_7 ;
int V_5 = F_143 ( V_57 -> V_92 ) ;
T_10 V_144 = F_80 ( V_5 , 0 , V_145 ) ;
char V_6 [ V_290 ] ;
F_80 ( V_5 , V_144 + sizeof( struct V_291 ) ,
V_147 ) ;
V_289 = F_116 ( V_5 , & V_57 -> V_275 ,
V_57 -> V_255 ) ;
V_287 = F_11 ( V_289 , sizeof( V_113 ) ) - V_289 ;
if ( F_13 ( V_5 , V_6 , V_287 ) < 0 ) {
F_187 ( L_102 , V_292 ) ;
return - 1 ;
}
if ( V_57 -> V_255 ) {
int V_293 = F_8 ( V_256 , V_6 , V_287 ) ;
if ( V_293 <= 0 || V_293 != V_287 ) {
F_187 ( L_103 , V_292 ) ;
return - 1 ;
}
}
...
V_17 = V_42 -> V_47 + 1 ;
V_17 = F_11 ( V_17 , V_14 ) ;
memcpy ( & V_279 . V_30 . V_30 , V_42 -> V_30 , sizeof( V_42 -> V_30 ) ) ;
V_279 . V_30 . V_2 . type = V_294 ;
V_279 . V_30 . V_2 . V_32 = V_32 ;
V_279 . V_30 . V_31 = V_38 -> V_31 ;
V_279 . V_30 . V_2 . V_7 = sizeof( V_279 . V_30 ) + V_17 ;
memcpy ( & V_279 . V_30 . V_68 , V_42 -> V_46 , V_42 -> V_47 ) ;
V_15 = F_153 ( V_277 , & V_279 , NULL , V_38 ) ;
return V_15 ;
}
int F_189 ( struct V_276 * V_277 V_82 ,
union V_278 * V_209 ,
struct V_56 * V_57 )
{
F_108 ( & V_209 -> V_30 ,
