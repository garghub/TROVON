...
int V_15 , V_62 ;
V_61 -> V_9 = V_9 ;
V_9 -> V_131 = V_61 -> V_132 ;
V_62 = F_36 ( V_9 , 0 , 0 , V_133 ) ;
if ( V_62 )
return V_62 ;
...
static int F_41 ( struct V_136 * V_137 )
{
struct V_138 * V_139 = F_42 ( V_137 -> V_112 . V_140 ) ;
struct V_60 * V_61 ;
struct V_141 * V_142 ;
int V_15 , V_62 ;
V_61 = F_43 ( & V_137 -> V_112 , sizeof( struct V_60 ) ,
V_143 ) ;
if ( V_61 == NULL )
return - V_144 ;
V_61 -> V_139 = V_139 ;
V_61 -> V_91 = ( V_139 -> V_145 == V_146 ) ? V_139 -> V_147
: V_139 -> V_148 ;
V_61 -> V_132 = ( V_139 -> V_145 == V_146 ) ? V_139 -> V_132
: V_139 -> V_149 ;
F_44 ( V_137 , V_61 ) ;
for ( V_15 = 0 ; V_15 < 4 ; V_15 ++ ) {
V_142 = F_45 ( V_137 , V_150 , V_15 ) ;
if ( ! V_142 ) {
F_38 ( & V_137 -> V_112 , L_6 ) ;
return - V_22 ;
}
V_61 -> V_94 [ V_15 ] = V_142 -> V_151 + V_139 -> V_152 ;
strncpy ( V_61 -> V_36 [ V_15 ] , V_142 -> V_36 , V_153 ) ;
}
V_62 = F_46 ( & V_137 -> V_112 , & V_154 ,
V_155 , F_4 ( V_155 ) ) ;
if ( V_62 ) {
F_38 ( & V_137 -> V_112 , L_7 ) ;
return - V_22 ;
}
return V_62 ;
}
