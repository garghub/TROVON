...
switch ( F_33 ( V_251 ) ) {
case V_107 :
V_326 . V_293 = F_71 ( V_249 -> V_354 [ F_51 ( V_251 ) ] ) ;
V_323 = V_296 ;
goto V_302;
case V_104 :
V_326 . V_292 = F_72 ( V_249 -> V_354 [ F_51 ( V_251 ) ] ) ;
V_323 = V_316 ;
goto V_302;
default:
return V_28 ;
...
V_357 = V_242 -> V_179 ;
if ( F_74 ( V_357 ) && V_169 ) {
if ( ( F_75 ( V_358 [ 0 ] , ( T_7 T_1 * ) F_76 ( V_242 -> V_179 ) ) ) ||
( F_75 ( V_358 [ 1 ] , ( T_7 T_1 * ) F_76 ( V_242 -> V_179 + 2 ) ) ) ||
( F_75 ( V_358 [ 2 ] , ( T_7 T_1 * ) F_76 ( V_242 -> V_179 + 4 ) ) ) ||
( F_75 ( V_358 [ 3 ] , ( T_7 T_1 * ) F_76 ( V_242 -> V_179 + 6 ) ) ) ) {
F_14 ( V_263 ) ;
return V_264 ;
}
V_359 = V_358 ;
...
break;
F_78 () ;
} while ( V_242 -> V_179 > V_357 );
if ( V_291 == V_28 && V_242 -> V_179 != V_356 )
V_291 = 0 ;
return V_291 ;
}
static int F_79 ( void * V_360 , T_2 * V_260 )
{
int V_361 ;
...
struct V_363 * V_364 ;
T_8 * V_365 ;
V_364 = & F_81 ( V_366 , V_361 ) ;
V_365 = ( void * ) V_364 + ( unsigned long ) V_360 ;
V_362 += F_82 ( V_365 ) ;
}
* V_260 = V_362 ;
return 0 ;
...
{
struct V_367 * V_292 , * V_368 ;
if ( ! V_369 )
return - V_370 ;
V_368 = F_84 ( L_3 , V_369 ) ;
if ( ! V_368 )
return - V_371 ;
#define F_85 ( T_10 ) \
do { \
