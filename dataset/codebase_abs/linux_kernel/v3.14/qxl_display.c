...
F_5 ( V_6 ,
L_16 ,
V_3 , V_4 , V_135 -> V_140 . V_3 ,
V_135 -> V_140 . V_4 , V_135 -> V_140 . V_141 , V_135 -> V_140 . V_142 ) ;
...
V_52 -> V_24 , V_52 -> V_26 , V_52 -> V_143 ) ;
}
...
struct V_5 * V_6 = V_39 -> V_40 ;
if ( V_52 -> V_106 ) {
struct V_107 * V_122 = F_46 ( V_52 -> V_106 ) ;
...
static int F_68 ( struct V_38 * V_39 , int V_144 )
{
struct V_53 * V_53 ;
V_53 = F_4 ( sizeof( struct V_53 ) , V_10 ) ;
if ( ! V_53 )
return - V_145 ;
F_69 ( V_39 , & V_53 -> V_113 , & V_146 ) ;
V_53 -> V_44 = V_144 ;
F_70 ( & V_53 -> V_113 , 256 ) ;
F_71 ( & V_53 -> V_113 , & V_147 ) ;
return 0 ;
}
static void F_72 ( struct V_148 * V_149 , int V_46 )
{
F_62 ( L_18 ) ;
}
static bool F_73 ( struct V_148 * V_149 ,
const struct V_45 * V_46 ,
struct V_45 * V_126 )
{
F_62 ( L_18 ) ;
...
V_2 -> V_31 = V_12 ;
if ( V_149 -> V_52 -> V_143 ) {
V_46 = & V_149 -> V_52 -> V_46 ;
V_2 -> V_3 = V_46 -> V_127 ;
V_2 -> V_4 = V_46 -> V_128 ;
V_2 -> V_24 = V_149 -> V_52 -> V_24 ;
V_2 -> V_26 = V_149 -> V_52 -> V_26 ;
...
static void F_77 ( struct V_148 * V_149 )
{
struct V_5 * V_6 = V_149 -> V_39 -> V_40 ;
F_75 ( V_6 , V_149 ) ;
F_62 ( L_18 ) ;
}
static void F_78 ( struct V_148 * V_149 ,
struct V_45 * V_46 ,
struct V_45 * V_126 )
{
F_62 ( L_18 ) ;
...
struct V_45 * V_46 )
{
F_62 ( L_24 , V_46 -> V_150 , V_46 -> V_127 ,
V_46 -> V_128 , V_46 -> V_151 ) ;
return V_152 ;
}
static struct V_148 * F_81 ( struct V_34 * V_35 )
{
struct V_41 * V_41 =
F_13 ( V_35 ) ;
F_62 ( L_18 ) ;
...
static int F_93 ( struct V_38 * V_39 , int V_164 )
{
struct V_5 * V_6 = V_39 -> V_40 ;
struct V_41 * V_41 ;
struct V_34 * V_35 ;
...
struct V_107 * V_108 ;
int V_58 ;
V_70 = F_30 ( V_39 , V_64 , V_124 -> V_174 [ 0 ] ) ;
...
struct V_69 * V_175 ;
int V_19 = V_176 ;
int V_177 = sizeof( struct V_9 ) +
V_19 * sizeof( struct V_1 ) ;
V_58 = F_103 ( V_6 , V_177 , 0 ,
V_178 ,
false , false , NULL , & V_175 ) ;
if ( V_58 ) {
F_31 ( L_27 , V_11 , V_58 ) ;
return - V_145 ;
}
V_6 -> V_179 = F_32 ( V_175 ) ;
V_58 = F_33 ( V_6 -> V_179 , false ) ;
if ( V_58 )
return V_58 ;
V_58 = F_34 ( V_6 -> V_179 , V_178 , NULL ) ;
if ( V_58 ) {
F_35 ( V_6 -> V_179 ) ;
return V_58 ;
}
F_35 ( V_6 -> V_179 ) ;
F_36 ( V_6 -> V_179 , NULL ) ;
V_6 -> V_18 = V_6 -> V_179 -> V_180 ;
V_6 -> V_129 -> V_18 =
F_39 ( V_6 , V_6 -> V_179 , 0 ) ;
memset ( V_6 -> V_18 , 0 , V_177 ) ;
V_6 -> V_18 -> V_19 = V_19 ;
return 0 ;
}
...
if ( V_58 )
return V_58 ;
V_6 -> V_33 -> V_181 . V_182 = ( void * ) & V_183 ;
V_6 -> V_33 -> V_181 . V_184 = 320 ;
V_6 -> V_33 -> V_181 . V_185 = 200 ;
V_6 -> V_33 -> V_181 . V_186 = 8192 ;
V_6 -> V_33 -> V_181 . V_187 = 8192 ;
V_6 -> V_33 -> V_181 . V_188 = V_6 -> V_189 ;
F_91 ( V_6 ) ;
for ( V_12 = 0 ; V_12 < V_176 ; ++ V_12 ) {
F_68 ( V_6 -> V_33 , V_12 ) ;
F_93 ( V_6 -> V_33 , V_12 ) ;
}
V_6 -> V_190 . V_191 = true ;
F_107 ( V_6 ) ;
return 0 ;
}
