...
T_24 V_252 ;
int error ;
V_250 = F_73 ( V_105 , 1 << V_12 -> V_39 . V_244 , V_245 ) ;
V_251 = F_135 ( V_45 , V_250 ) ;
V_252 = F_136 ( V_45 + V_205 , V_250 ) ;
ASSERT ( V_251 >= V_45 ) ;
ASSERT ( V_252 <= V_45 + V_205 ) ;
if ( V_251 < V_252 - 1 ) {
F_131 ( F_76 ( V_2 ) , V_251 ,
V_252 - 1 ) ;
error = F_103 ( V_2 , V_251 ,
V_252 - V_251 - 1 ,
V_253 | V_254 ) ;
if ( error )
goto V_113;
if ( V_251 != V_45 ) {
error = F_137 ( V_2 , V_45 , V_251 - V_45 ) ;
if ( error )
goto V_113;
}
if ( V_252 != V_45 + V_205 )
error = F_137 ( V_2 , V_252 ,
V_45 + V_205 - V_252 ) ;
} else {
...
V_255 -> V_57 . V_149 == V_147 )
return V_148 ;
if ( V_2 -> V_57 . V_256 < V_255 -> V_57 . V_256 )
return V_148 ;
if ( V_2 -> V_57 . V_149 == V_103 &&
V_255 -> V_57 . V_149 == V_146 )
return V_148 ;
if ( V_255 -> V_57 . V_149 == V_103 &&
F_79 ( V_255 , V_125 ) >
F_139 ( V_2 , V_125 ) )
return V_148 ;
if ( V_2 -> V_57 . V_149 == V_103 &&
...
F_139 ( V_255 , V_125 ) )
return V_148 ;
if ( V_255 -> V_57 . V_149 == V_146 ) {
if ( F_140 ( V_2 ) &&
F_141 ( V_255 -> V_190 . V_106 ) > F_140 ( V_2 ) )
return V_148 ;
if ( F_79 ( V_255 , V_125 ) <=
F_139 ( V_2 , V_125 ) )
return V_148 ;
...
if ( F_140 ( V_255 ) &&
F_141 ( V_2 -> V_190 . V_106 ) > F_140 ( V_255 ) )
return V_148 ;
if ( F_79 ( V_2 , V_125 ) <=
F_139 ( V_255 , V_125 ) )
return V_148 ;
...
T_8 * V_12 = V_2 -> V_4 ;
T_3 * V_5 ;
T_26 * V_258 = & V_257 -> V_259 ;
T_13 * V_260 , * V_77 , * V_261 ;
int V_262 , V_263 ;
int error = 0 ;
int V_264 = 0 ;
int V_265 = 0 ;
T_27 V_266 ;
V_260 = F_81 ( sizeof( T_13 ) , V_166 ) ;
if ( ! V_260 ) {
error = F_58 ( V_158 ) ;
goto V_113;
}
F_143 ( V_2 , V_255 , V_200 ) ;
F_143 ( V_2 , V_255 , V_49 ) ;
if ( ( V_2 -> V_57 . V_188 & V_267 ) != ( V_255 -> V_57 . V_188 & V_267 ) ) {
error = F_58 ( V_148 ) ;
goto V_268;
}
if ( F_2 ( V_2 ) != F_2 ( V_255 ) ) {
error = F_58 ( V_148 ) ;
goto V_268;
}
error = - F_75 ( F_76 ( V_255 ) -> V_162 ) ;
if ( error )
goto V_268;
F_131 ( F_76 ( V_255 ) , 0 , - 1 ) ;
if ( F_94 ( F_76 ( V_255 ) ) != 0 ) {
error = F_58 ( V_148 ) ;
goto V_268;
}
if ( V_257 -> V_269 != 0 ||
V_257 -> V_270 != V_2 -> V_57 . V_161 ||
V_257 -> V_270 != V_255 -> V_57 . V_161 ) {
error = F_58 ( V_271 ) ;
goto V_268;
}
F_144 ( V_2 , 0 ) ;
F_144 ( V_255 , 1 ) ;
error = F_138 ( V_2 , V_255 ) ;
if ( error ) {
F_145 ( V_12 ,
L_7 ,
V_272 , V_2 -> V_185 ) ;
...
if ( ( V_258 -> V_273 . V_274 != F_76 ( V_2 ) -> V_275 . V_274 ) ||
( V_258 -> V_273 . V_276 != F_76 ( V_2 ) -> V_275 . V_276 ) ||
( V_258 -> V_277 . V_274 != F_76 ( V_2 ) -> V_278 . V_274 ) ||
( V_258 -> V_277 . V_276 != F_76 ( V_2 ) -> V_278 . V_276 ) ) {
error = F_58 ( V_279 ) ;
goto V_268;
}
if ( F_146 ( F_76 ( V_2 ) ) ) {
...
F_131 ( F_76 ( V_2 ) , 0 , - 1 ) ;
V_5 = F_97 ( V_12 , V_280 ) ;
error = F_11 ( V_5 , & F_100 ( V_12 ) -> V_281 , 0 , 0 ) ;
if ( error ) {
F_85 ( V_2 , V_200 ) ;
F_85 ( V_255 , V_200 ) ;
F_99 ( V_5 , 0 ) ;
...
F_143 ( V_2 , V_255 , V_49 ) ;
if ( ( ( F_72 ( V_2 ) != 0 ) && ( V_2 -> V_57 . V_282 > 0 ) ) &&
( V_2 -> V_57 . V_145 != V_147 ) ) {
error = F_60 ( V_5 , V_2 , V_144 , & V_264 ) ;
if ( error )
goto V_283;
}
if ( ( ( F_72 ( V_255 ) != 0 ) && ( V_255 -> V_57 . V_282 > 0 ) ) &&
( V_255 -> V_57 . V_145 != V_147 ) ) {
error = F_60 ( V_5 , V_255 , V_144 ,
& V_265 ) ;
if ( error )
goto V_283;
}
F_23 ( V_5 , V_2 , V_49 | V_200 ) ;
F_23 ( V_5 , V_255 , V_49 | V_200 ) ;
V_262 = V_59 ;
V_263 = V_59 ;
if ( V_2 -> V_57 . V_284 == 3 &&
V_2 -> V_57 . V_149 == V_146 ) {
...
if ( V_255 -> V_57 . V_284 == 3 &&
V_255 -> V_57 . V_149 == V_146 ) {
V_262 |= V_285 ;
error = F_147 ( V_5 , V_255 , V_125 ,
V_2 -> V_185 , NULL ) ;
if ( error )
goto V_283;
}
...
* V_77 = * V_261 ;
* V_261 = * V_260 ;
V_266 = ( T_27 ) V_2 -> V_57 . V_58 ;
V_2 -> V_57 . V_58 = V_255 -> V_57 . V_58 - V_265 + V_264 ;
V_255 -> V_57 . V_58 = V_266 + V_265 - V_264 ;
V_266 = ( T_27 ) V_2 -> V_57 . V_256 ;
V_2 -> V_57 . V_256 = V_255 -> V_57 . V_256 ;
V_255 -> V_57 . V_256 = V_266 ;
V_266 = ( T_27 ) V_2 -> V_57 . V_149 ;
V_2 -> V_57 . V_149 = V_255 -> V_57 . V_149 ;
V_255 -> V_57 . V_149 = V_266 ;
ASSERT ( V_255 -> V_60 == 0 ) ;
V_255 -> V_60 = V_2 -> V_60 ;
V_2 -> V_60 = 0 ;
switch ( V_2 -> V_57 . V_149 ) {
case V_103 :
if ( V_2 -> V_57 . V_256 <= V_286 ) {
V_77 -> V_287 . V_288 =
V_77 -> V_289 . V_290 ;
}
V_262 |= V_291 ;
break;
case V_146 :
ASSERT ( V_2 -> V_57 . V_284 < 3 ||
( V_262 & V_285 ) ) ;
V_262 |= V_292 ;
break;
}
switch ( V_255 -> V_57 . V_149 ) {
case V_103 :
if ( V_255 -> V_57 . V_256 <= V_286 ) {
V_261 -> V_287 . V_288 =
V_261 -> V_289 . V_290 ;
}
V_263 |= V_291 ;
...
case V_146 :
V_263 |= V_292 ;
ASSERT ( V_255 -> V_57 . V_284 < 3 ||
( V_263 & V_285 ) ) ;
break;
}
F_28 ( V_5 , V_2 , V_262 ) ;
F_28 ( V_5 , V_255 , V_263 ) ;
if ( V_12 -> V_293 & V_294 )
F_148 ( V_5 ) ;
error = F_9 ( V_5 , 0 ) ;
F_149 ( V_2 , 0 ) ;
