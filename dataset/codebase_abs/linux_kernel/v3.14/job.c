...
static int F_31 ( struct V_65 * V_66 , unsigned long V_31 )
{
if ( V_66 -> V_7 -> V_67 ( V_66 -> V_48 , V_66 -> V_68 , V_31 ) ) {
if ( ! V_66 -> V_5 )
return - V_69 ;
if ( ! F_30 ( V_66 -> V_50 , V_66 -> V_57 , V_66 -> V_31 ) )
return - V_69 ;
V_66 -> V_5 -- ;
V_66 -> V_50 ++ ;
}
...
static int F_35 ( struct V_65 * V_66 , struct V_14 * V_56 )
{
...
switch ( V_78 ) {
case 0 :
V_66 -> V_68 = V_77 >> 6 & 0x3ff ;
V_66 -> V_70 = V_77 & 0x3f ;
V_66 -> V_71 = V_77 >> 16 & 0xfff ;
V_76 = F_32 ( V_66 ) ;
if ( V_76 )
goto V_79;
break;
...
static inline int F_36 ( struct V_1 * V_7 , struct V_80 * V_48 )
{
struct V_65 V_66 ;
T_3 V_81 = 0 ;
T_3 V_31 = 0 ;
...
int F_40 ( struct V_1 * V_7 , struct V_80 * V_48 )
{
int V_76 ;
unsigned int V_43 , V_86 ;
struct V_40 * V_41 = F_41 ( V_48 -> V_87 ) ;
F_42 ( V_88 , F_19 ( V_41 ) ) ;
F_43 ( V_88 , F_19 ( V_41 ) ) ;
for ( V_43 = 0 ; V_43 < V_7 -> V_44 ; V_43 ++ ) {
...
for ( V_86 = V_43 + 1 ; V_86 < V_7 -> V_33 ; V_86 ++ )
...
V_7 -> V_8 = 0 ;
if ( V_7 -> V_83 )
F_51 ( V_7 -> V_19 -> V_48 , V_7 -> V_83 ,
V_7 -> V_75 ,
V_7 -> V_82 ) ;
}
void F_52 ( struct V_80 * V_48 , struct V_1 * V_7 )
{
