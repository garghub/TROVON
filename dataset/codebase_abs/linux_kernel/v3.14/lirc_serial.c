...
if ( V_103 < 0 ) {
if ( V_103 == - V_108 )
F_34 ( & V_100 -> V_100 , L_13 , V_104 ) ;
else if ( V_103 == - V_30 )
F_34 ( & V_100 -> V_100 , L_14 ) ;
return V_103 ;
}
if ( ( ( V_2 != 0 )
&& ( F_35 ( V_2 , 8 << V_3 ,
...
F_34 ( & V_100 -> V_100 , L_15 , V_4 ) ;
F_37 ( & V_100 -> V_100 , L_16 ) ;
F_37 ( & V_100 -> V_100 ,
L_17 ) ;
F_37 ( & V_100 -> V_100 , L_18 ) ;
V_103 = - V_108 ;
goto V_109;
}
V_103 = F_27 () ;
...
F_39 ( & V_100 -> V_100 , L_19 ,
V_71 ? L_20 : L_21 ) ;
} else
F_39 ( & V_100 -> V_100 , L_22 ,
V_71 ? L_20 : L_21 ) ;
F_12 ( L_23 , V_104 , V_4 ) ;
return 0 ;
V_110:
...
static T_4 F_48 ( struct V_113 * V_113 , const char T_5 * V_114 ,
T_6 V_115 , T_7 * V_116 )
{
int V_34 , V_117 ;
unsigned long V_111 ;
