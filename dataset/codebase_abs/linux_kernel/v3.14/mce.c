...
V_2 -> V_7 . V_17 . V_45 = V_23 ;
} else if ( V_2 -> V_5 == V_10 ) {
V_2 -> V_7 . V_11 . V_44 = true ;
V_2 -> V_7 . V_11 . V_45 = V_23 ;
} else if ( V_2 -> V_5 == V_13 ) {
V_2 -> V_7 . V_14 . V_44 = true ;
V_2 -> V_7 . V_14 . V_45 = V_23 ;
} else if ( V_2 -> V_5 == V_6 ) {
V_2 -> V_7 . V_8 . V_44 = true ;
V_2 -> V_7 . V_8 . V_45 = V_23 ;
}
return;
}
int F_4 ( struct V_1 * V_2 , bool V_46 )
{
int V_25 = F_3 ( V_26 ) - 1 ;
struct V_1 * V_47 ;
int V_48 = 0 ;
...
static void F_8 ( struct V_54 * V_55 )
{
int V_25 ;
while ( F_3 ( V_51 ) > 0 ) {
V_25 = F_3 ( V_51 ) - 1 ;
