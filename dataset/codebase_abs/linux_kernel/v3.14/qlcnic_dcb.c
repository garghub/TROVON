...
static int F_36 ( struct V_7 * V_8 , char * V_32 )
{
...
if ( ! V_74 )
return 0 ;
V_24 = F_56 ( V_8 , ( char * ) & V_74 -> type [ 0 ] ,
V_60 ) ;
if ( V_24 )
return V_24 ;
V_24 = F_56 ( V_8 , ( char * ) & V_74 -> type [ 1 ] ,
V_61 ) ;
if ( V_24 )
return V_24 ;
V_24 = F_56 ( V_8 , ( char * ) & V_74 -> type [ 2 ] ,
V_62 ) ;
if ( V_24 )
return V_24 ;
V_74 -> V_75 = V_76 ;
...
{
struct V_7 * V_8 ;
V_8 = F_58 ( V_78 , struct V_7 , V_20 . V_78 ) ;
F_30 ( V_8 ) ;
F_59 ( V_19 , & V_8 -> V_10 ) ;
}
static void F_60 ( struct V_7 * V_8 , void * V_79 )
{
if ( F_61 ( V_19 , & V_8 -> V_10 ) )
return;
F_62 ( V_8 -> V_21 , & V_8 -> V_20 , 0 ) ;
}
...
{
int V_24 ;
V_24 = F_56 ( V_8 , ( char * ) V_8 -> V_23 , 0 ) ;
if ( V_24 )
return V_24 ;
F_57 ( V_8 -> V_2 ) ;
return V_24 ;
}
static void F_66 ( struct V_7 * V_8 , void * V_79 )
{
T_2 * V_3 = V_79 ;
if ( F_61 ( V_19 , & V_8 -> V_10 ) )
return;
...
static void F_67 ( struct V_30 * V_74 ,
struct V_56 * V_86 ,
struct V_91 * type )
{
struct V_92 * V_93 ;
...
V_94 = F_68 ( V_74 -> V_75 , V_59 ) ;
V_93 = & type -> V_93 [ V_94 ] ;
V_93 -> V_97 = true ;
V_93 -> V_4 |= F_15 ( V_59 ) ;
if ( F_69 ( V_86 -> V_68 [ 1 ] , V_59 ) &&
type -> V_98 ) {
V_93 -> V_99 [ V_59 ] . V_97 = true ;
V_93 -> V_99 [ V_59 ] . V_100 = V_101 ;
}
if ( V_59 < 4 )
V_95 = F_70 ( V_86 -> V_69 [ 0 ] , V_59 ) ;
else
V_95 = F_70 ( V_86 -> V_69 [ 1 ] , V_59 ) ;
V_93 -> V_95 = V_95 ;
V_93 -> V_102 = V_103 ;
type -> V_104 [ V_93 -> V_95 ] . V_105 ++ ;
}
}
static void F_71 ( struct V_56 * V_86 ,
struct V_91 * type )
{
struct V_106 * V_104 ;
...
V_104 -> V_97 = true ;
if ( V_59 < 4 ) {
V_108 = F_72 ( V_86 -> V_70 [ 0 ] , V_59 ) ;
V_107 = F_73 ( V_86 -> V_71 [ 0 ] , V_59 ) ;
} else {
V_108 = F_72 ( V_86 -> V_70 [ 1 ] , V_59 ) ;
V_107 = F_73 ( V_86 -> V_71 [ 1 ] , V_59 ) ;
}
V_104 -> V_110 = V_108 ;
V_104 -> V_111 = V_107 ;
}
...
V_73 = & type -> V_73 [ V_59 ] ;
V_73 -> V_97 = true ;
V_73 -> V_118 = F_75 ( V_86 -> V_73 [ V_59 ] ) - 1 ;
V_117 . V_118 = V_73 -> V_118 ;
V_73 -> V_119 = F_76 ( V_86 -> V_73 [ V_59 ] ) ;
...
static void F_78 ( struct V_1 * V_2 , T_1 V_83 )
{
...
F_78 ( V_2 , V_59 ) ;
F_79 ( V_2 -> V_11 , V_123 , V_124 , 0 , 0 ) ;
}
static T_1 F_80 ( struct V_125 * V_11 )
{
struct V_1 * V_2 = F_81 ( V_11 ) ;
return F_17 ( V_9 , & V_2 -> V_8 -> V_10 ) ;
}
static void F_82 ( struct V_125 * V_11 , T_1 * V_58 )
{
memcpy ( V_58 , V_11 -> V_126 , V_11 -> V_127 ) ;
}
static void
F_83 ( struct V_125 * V_11 , int V_94 , T_1 * V_128 ,
...
static void F_84 ( struct V_125 * V_11 , int V_95 ,
T_1 * V_132 )
{
struct V_1 * V_2 = F_81 ( V_11 ) ;
struct V_106 * V_133 ;
...
static void F_85 ( struct V_125 * V_11 , int V_128 ,
T_1 * V_134 )
{
struct V_1 * V_2 = F_81 ( V_11 ) ;
struct V_92 * V_93 ;
...
static T_1 F_86 ( struct V_125 * V_11 , int V_135 ,
T_1 * V_40 )
{
struct V_1 * V_2 = F_81 ( V_11 ) ;
if ( ! F_17 ( V_9 , & V_2 -> V_8 -> V_10 ) )
...
static int F_87 ( struct V_125 * V_11 , int V_143 , T_1 * V_144 )
{
struct V_1 * V_2 = F_81 ( V_11 ) ;
struct V_28 * V_22 = V_2 -> V_8 -> V_22 ;
if ( ! F_17 ( V_9 , & V_2 -> V_8 -> V_10 ) )
...
static T_1 F_88 ( struct V_125 * V_11 , T_1 V_147 , T_3 V_148 )
{
struct V_1 * V_2 = F_81 ( V_11 ) ;
struct V_116 V_73 = {
. V_118 = V_147 ,
...
static T_1 F_91 ( struct V_125 * V_11 )
{
struct V_1 * V_2 = F_81 ( V_11 ) ;
struct V_28 * V_22 = V_2 -> V_8 -> V_22 ;
if ( ! F_17 ( V_9 , & V_2 -> V_8 -> V_10 ) )
...
static T_1 F_92 ( struct V_125 * V_11 , int V_149 , T_1 * V_150 )
{
struct V_1 * V_2 = F_81 ( V_11 ) ;
struct V_91 * type ;
if ( ! F_17 ( V_9 , & V_2 -> V_8 -> V_10 ) )
...
static inline void
F_94 ( struct V_125 * V_11 , int V_128 , T_1 * V_102 ,
T_1 * V_95 , T_1 * V_132 , T_1 * V_156 )
{
* V_102 = * V_95 = * V_132 = * V_156 = 0 ;
}
static inline void
F_95 ( struct V_125 * V_11 , int V_95 , T_1 * V_132 )
{
* V_132 = 0 ;
}
...
static int F_99 ( struct V_125 * V_11 ,
struct V_166 * V_167 )
{
struct V_1 * V_2 = F_81 ( V_11 ) ;
struct V_28 * V_22 = V_2 -> V_8 -> V_22 ;
