...
static void F_31 ( struct V_32 * V_8 )
{
struct V_33 * V_5 =
F_32 ( V_8 , struct V_33 , V_8 ) ;
...
void F_38 ( struct V_32 * V_8 )
{
struct V_1 * V_2 = F_32 ( V_8 , struct V_1 , V_8 . V_8 ) ;
struct V_33 * V_5 ;
...
F_23 ( V_2 ) ;
F_20 ( V_2 , 0 ) ;
F_41 ( V_2 -> V_10 , & V_2 -> V_8 , 5 * V_44 ) ;
break;
case V_41 :
case V_42 :
F_7 ( V_12 , L_19 , F_8 ( V_2 ) ) ;
F_42 ( & V_2 -> V_8 ) ;
if ( V_2 -> V_35 == V_41 ) {
F_28 ( V_2 ) ;
} else {
...
{
struct V_4 * V_5 = F_32 ( V_8 , struct V_4 , V_8 ) ;
struct V_1 * V_2 = V_5 -> V_2 ;
struct V_11 * V_12 = V_2 -> V_12 ;
F_33 ( & V_2 -> V_34 ) ;
switch ( V_5 -> V_3 ) {
