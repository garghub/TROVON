...
return;
V_151 -> V_170 = V_295 ;
F_82 ( & V_151 -> V_185 -> V_247 -> V_296 , V_151 ) ;
}
static void
...
F_167 ( memcmp ( & V_181 -> V_266 , & V_181 -> V_306 ,
...
V_151 -> V_170 = V_295 ;
if ( V_305 ) {
V_151 -> V_177 = F_169 ( V_151 , V_305 , V_181 , V_265 ,
V_151 -> V_161 . V_164 ) ;
}
...
V_181 -> V_312 = F_173 ( & V_181 -> V_308 [ 0 ] , V_265 ) ;
return V_265 ;
}
static T_6 *
...
goto V_316;
V_265 += 1 ;
if ( ( V_315 = F_174 ( * V_265 ++ ) ) != V_317 ) {
F_43 ( L_64 ,
V_151 -> V_228 , V_31 , V_315 ) ;
error = - V_146 ;
goto V_318;
}
if ( ( V_315 = F_174 ( * V_265 ++ ) ) != V_319 ) {
if ( -- V_186 < 0 )
goto V_316;
switch ( ( V_315 = F_174 ( * V_265 ++ ) ) ) {
case V_320 :
break;
case V_321 :
F_43 ( L_65 ,
...
static void F_176 ( void * V_336 , struct V_337 * V_338 , void * V_339 )
{
}
static int F_177 ( void * V_336 , struct V_337 * V_338 , void * V_339 )
{
return 0 ;
}
...
V_28 = F_105 ( V_2 , & V_160 , V_154 | V_343 ) ;
F_178 ( V_160 . V_165 ) ;
return V_28 ;
}
struct V_142 * F_179 ( struct V_1 * V_2 , struct V_165 * V_344 , int V_108 )
{
struct V_159 V_160 = {
. V_162 = & V_340 ,
. V_165 = V_344 ,
