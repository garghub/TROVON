...
V_19 -> V_27 = V_74 / 12 ;
V_19 -> V_26 = F_45 ( V_17 -> V_14 ,
V_19 -> V_27 * sizeof( struct V_59 ) , V_47 ) ;
V_19 -> V_29 = F_45 ( V_17 -> V_14 ,
V_19 -> V_27 * sizeof( unsigned int ) , V_47 ) ;
if ( ! V_19 -> V_26 || ! V_19 -> V_29 )
return - V_48 ;
for ( V_20 = 0 ; V_20 < V_19 -> V_27 ; V_20 ++ ) {
V_19 -> V_26 [ V_20 ] . V_3 = F_46 ( * V_75 ++ ) ;
V_19 -> V_26 [ V_20 ] . V_61 = F_46 ( * V_75 ++ ) ;
V_19 -> V_26 [ V_20 ] . V_57 = F_46 ( * V_75 ++ ) ;
...
V_17 -> V_14 = & V_81 -> V_14 ;
V_2 = F_45 ( & V_81 -> V_14 , sizeof( * V_2 ) , V_47 ) ;
if ( ! V_2 )
return - V_48 ;
V_88 = F_52 ( V_81 , V_91 , 0 ) ;
if ( ! V_88 )
return - V_92 ;
V_2 -> V_5 = F_53 ( & V_81 -> V_14 , V_88 -> V_93 ,
F_54 ( V_88 ) ) ;
if ( ! V_2 -> V_5 )
return - V_48 ;
V_90 = & V_94 ;
V_90 -> V_18 = F_55 ( & V_81 -> V_14 ) ;
V_90 -> V_26 = V_17 -> V_26 ;
V_90 -> V_27 = V_17 -> V_27 ;
V_72 = F_50 ( V_81 , V_2 , V_17 ) ;
if ( V_72 ) {
F_19 ( & V_81 -> V_14 , L_17 ) ;
return V_72 ;
}
...
V_2 -> V_14 = V_17 -> V_14 ;
F_56 ( V_81 , V_2 ) ;
V_2 -> V_82 = F_57 ( V_90 , & V_81 -> V_14 , V_2 ) ;
if ( ! V_2 -> V_82 ) {
F_19 ( & V_81 -> V_14 , L_18 ) ;
return - V_28 ;
}
V_72 = F_58 ( V_81 -> V_14 . V_83 , NULL , NULL , & V_81 -> V_14 ) ;
if ( V_72 ) {
F_59 ( V_2 -> V_82 ) ;
F_19 ( & V_81 -> V_14 , L_19 ) ;
return V_72 ;
...
int F_61 ( struct V_80 * V_81 )
{
struct V_1 * V_2 = F_62 ( V_81 ) ;
F_59 ( V_2 -> V_82 ) ;
return 0 ;
}
