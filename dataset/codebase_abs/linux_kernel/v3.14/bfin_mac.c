...
static int F_93 ( struct V_16 * V_174 ,
struct V_175 * V_176 )
{
struct V_61 * V_62 = F_23 ( V_174 ) ;
return F_92 ( V_176 -> V_183 , & V_62 -> V_196 ,
sizeof( V_62 -> V_196 ) ) ?
- V_184 : 0 ;
}
static void F_94 ( struct V_16 * V_174 , struct V_18 * V_11 )
{
struct V_61 * V_62 = F_23 ( V_174 ) ;
if ( F_95 ( V_11 ) -> V_197 & V_198 ) {
int V_48 = V_49 ;
F_95 ( V_11 ) -> V_197 |= V_199 ;
while ( ( ! ( F_96 () & V_200 ) ) && ( -- V_48 ) )
F_13 ( 1 ) ;
if ( V_48 == 0 )
F_38 ( V_174 , L_13 ) ;
else {
...
V_202 . V_205 = F_97 ( V_203 ) ;
F_98 ( V_11 , & V_202 ) ;
}
}
}
static void F_99 ( struct V_16 * V_174 , struct V_18 * V_11 )
{
struct V_61 * V_62 = F_23 ( V_174 ) ;
V_59 V_206 ;
T_4 V_204 , V_203 ;
...
static void F_101 ( struct V_16 * V_174 )
{
struct V_61 * V_62 = F_23 ( V_174 ) ;
T_4 V_208 , V_209 ;
V_59 V_169 , V_210 ;
...
static void F_107 ( struct V_61 * V_62 , T_4 V_203 )
{
V_59 V_213 , V_212 ;
V_203 >>= V_62 -> V_173 ;
V_213 = V_203 >> 32 ;
...
static int F_110 ( struct V_214 * V_215 , T_5 V_209 )
{
T_4 V_216 ;
V_59 V_217 , V_208 ;
int V_218 = 0 ;
struct V_61 * V_62 =
F_111 ( V_215 , struct V_61 , V_219 ) ;
if ( V_209 < 0 ) {
V_218 = 1 ;
V_209 = - V_209 ;
}
...
V_216 = V_208 ;
V_216 *= V_209 ;
V_217 = F_112 ( V_216 , 1000000000ULL ) ;
V_208 = V_218 ? V_208 - V_217 : V_208 + V_217 ;
F_103 ( V_208 ) ;
return 0 ;
}
static int F_113 ( struct V_214 * V_215 , T_6 V_220 )
{
T_6 V_221 ;
unsigned long V_65 ;
struct V_61 * V_62 =
...
static int F_114 ( struct V_214 * V_215 , struct V_223 * V_224 )
{
T_4 V_203 ;
V_59 V_225 ;
unsigned long V_65 ;
...
V_203 = F_104 ( V_62 ) ;
F_30 ( & V_62 -> V_222 , V_65 ) ;
V_224 -> V_226 = F_115 ( V_203 , 1000000000 , & V_225 ) ;
V_224 -> V_227 = V_225 ;
return 0 ;
}
...
static int F_118 ( struct V_16 * V_174 , struct V_231 * V_17 )
{
struct V_61 * V_62 = F_23 ( V_174 ) ;
V_62 -> V_219 = V_232 ;
...
V_11 -> V_257 = F_140 ( V_250 , V_251 + 1 , V_11 -> V_257 ) ;
} else {
for ( V_5 = 0 ; V_5 < V_251 ; V_5 ++ )
V_250 [ V_5 ] = ~ V_11 -> V_44 [ V_11 -> V_242 + V_5 ] ;
V_11 -> V_257 = F_140 ( V_250 , V_251 , V_11 -> V_257 ) ;
}
V_11 -> V_259 = V_260 ;
}
#endif
...
static int F_162 ( struct V_16 * V_174 , struct V_175 * V_176 , int V_109 )
{
struct V_61 * V_62 = F_23 ( V_174 ) ;
if ( ! F_76 ( V_174 ) )
return - V_91 ;
switch ( V_109 ) {
case V_290 :
return F_78 ( V_174 , V_176 ) ;
case V_291 :
return F_93 ( V_174 , V_176 ) ;
default:
if ( V_62 -> V_64 )
return F_163 ( V_62 -> V_64 , V_176 , V_109 ) ;
else
return - V_131 ;
}
}
...
F_171 ( V_17 ) ;
F_172 ( V_62 -> V_64 ) ;
F_173 ( V_62 -> V_64 , V_292 , V_293 ) ;
F_164 ( V_17 ) ;
F_1 () ;
return 0 ;
}
static int F_174 ( struct V_294 * V_295 )
{
struct V_16 * V_236 ;
struct V_61 * V_62 ;
struct V_294 * V_296 ;
struct V_297 * V_298 ;
int V_125 ;
V_236 = F_175 ( sizeof( struct V_61 ) ) ;
if ( ! V_236 )
return - V_47 ;
F_176 ( V_236 , & V_295 -> V_17 ) ;
F_177 ( V_295 , V_236 ) ;
V_62 = F_23 ( V_236 ) ;
V_62 -> V_236 = V_236 ;
* ( V_159 * ) ( & ( V_236 -> V_166 [ 0 ] ) ) = F_178 ( F_179 () ) ;
* ( V_161 * ) ( & ( V_236 -> V_166 [ 4 ] ) ) = F_180 ( ( V_57 ) F_181 () ) ;
F_73 ( 0x12345678 ) ;
if ( F_179 () != 0x12345678 ) {
F_182 ( & V_295 -> V_17 , L_20 ) ;
V_125 = - V_89 ;
goto V_299;
}
if ( ! F_166 ( V_236 -> V_166 ) ) {
if ( F_183 ( V_236 -> V_166 ) ||
! F_166 ( V_236 -> V_166 ) ) {
F_27 ( V_236 , L_21 ) ;
F_184 ( V_236 ) ;
}
...
F_70 ( V_236 -> V_166 ) ;
if ( ! F_185 ( & V_295 -> V_17 ) ) {
F_182 ( & V_295 -> V_17 , L_22 ) ;
V_125 = - V_89 ;
goto V_299;
}
V_296 = F_185 ( & V_295 -> V_17 ) ;
V_62 -> V_52 = F_186 ( V_296 ) ;
if ( ! V_62 -> V_52 ) {
F_182 ( & V_295 -> V_17 , L_23 ) ;
V_125 = - V_89 ;
goto V_299;
}
V_62 -> V_52 -> V_300 = V_236 ;
V_298 = F_185 ( & V_296 -> V_17 ) ;
V_125 = F_31 ( V_236 , V_298 -> V_79 ) ;
if ( V_125 ) {
F_182 ( & V_295 -> V_17 , L_24 ) ;
goto V_301;
}
...
F_121 ( & V_62 -> V_67 ) ;
V_125 = F_54 ( V_268 , F_142 ,
0 , L_25 , V_236 ) ;
if ( V_125 ) {
F_182 ( & V_295 -> V_17 , L_26 ) ;
V_125 = - V_165 ;
goto V_308;
}
V_125 = F_189 ( V_236 ) ;
if ( V_125 ) {
F_182 ( & V_295 -> V_17 , L_27 ) ;
goto V_309;
}
F_101 ( V_236 ) ;
V_125 = F_118 ( V_236 , & V_295 -> V_17 ) ;
if ( V_125 ) {
F_182 ( & V_295 -> V_17 , L_28 ) ;
goto V_310;
}
F_160 ( V_236 , L_29 , V_311 , V_117 ) ;
return 0 ;
V_310:
V_309:
F_55 ( V_268 , V_236 ) ;
...
static int F_193 ( struct V_294 * V_295 )
{
struct V_16 * V_236 = F_186 ( V_295 ) ;
...
static int F_195 ( struct V_294 * V_295 , T_7 V_312 )
{
struct V_16 * V_313 = F_186 ( V_295 ) ;
...
static int F_200 ( struct V_294 * V_295 )
{
struct V_52 * V_315 ;
struct V_297 * V_316 ;
const unsigned short * V_317 ;
int V_125 , V_5 ;
V_316 = F_185 ( & V_295 -> V_17 ) ;
if ( ! V_316 ) {
F_182 ( & V_295 -> V_17 , L_30 ) ;
return - V_91 ;
}
V_317 = V_316 -> V_318 ;
V_125 = F_201 ( V_317 , V_115 ) ;
if ( V_125 ) {
F_182 ( & V_295 -> V_17 , L_31 ) ;
return V_125 ;
}
V_125 = - V_47 ;
V_315 = F_202 () ;
...
V_315 -> V_105 = F_203 ( sizeof( int ) * V_86 , V_327 ) ;
if ( ! V_315 -> V_105 )
goto V_328;
for ( V_5 = V_125 ; V_5 < V_86 ; ++ V_5 )
V_315 -> V_105 [ V_5 ] = V_148 ;
V_125 = F_204 ( V_316 -> V_329 , 0 , V_86 ) ;
if ( V_125 != V_316 -> V_329 )
F_182 ( & V_295 -> V_17 , L_34 ,
V_316 -> V_329 ) ;
...
static int F_208 ( struct V_294 * V_295 )
{
struct V_52 * V_315 = F_186 ( V_295 ) ;
struct V_297 * V_316 =
F_185 ( & V_295 -> V_17 ) ;
F_190 ( V_315 ) ;
F_206 ( V_315 -> V_105 ) ;
