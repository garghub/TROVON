...
{
struct V_11 * V_12 = F_14 ( V_5 ) ;
return sprintf ( V_8 , L_4 , V_12 -> V_36 ) ;
}
...
static int F_70 ( struct V_80 * V_37 )
{
int V_19 ;
struct V_11 * V_12 ;
struct V_81 * V_65 ;
...
static int T_5 F_77 ( unsigned short V_52 )
{
int V_1 , V_88 , V_89 = 0 ;
int V_90 ;
...
if ( V_89 )
F_81 ( L_10 ,
V_1 & 0x80 ? L_11 : L_12 , ( int ) V_52 ) ;
V_92:
for ( V_90 -- ; V_90 >= V_52 ; V_90 -- )
F_82 ( V_90 , 1 ) ;
return V_89 ;
}
static int T_5 F_83 ( unsigned short V_52 )
{
struct V_81 V_65 = {
. V_83 = V_52 ,
. V_93 = V_52 + V_91 - 1 ,
