...
{
if ( strncmp ( L_51 , V_130 -> V_131 , 8 ) == 0 ) {
...
} else if ( strncmp ( L_52 , V_130 -> V_131 , 8 ) == 0 ) {
...
return - V_34 ;
F_86 ( L_54 ,
V_136 ? L_55 : L_56 , V_135 -> V_131 , V_135 -> V_138 ) ;
F_3 ( & V_5 ) ;
V_2 = F_84 ( V_135 ) ;
if ( V_2 == NULL ) {
...
V_144:
F_30 ( L_67 ,
V_137 , V_136 ? L_55 : L_56 , V_135 -> V_131 , V_135 -> V_138 ,
V_29 ) ;
F_4 ( & V_5 ) ;
return V_29 ;
}
