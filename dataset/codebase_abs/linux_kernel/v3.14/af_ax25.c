...
if ( F_127 ( F_128 ( V_35 , V_249 ) , V_248 -> V_267 , V_249 ) ) {
V_196 = - V_59 ;
F_35 ( V_35 ) ;
goto V_152;
}
...
F_141 ( V_35 , 0 , V_248 -> V_267 , V_269 ) ;
if ( V_248 -> V_251 ) {
T_4 V_22 ;
T_3 V_271 ;
const unsigned char * V_272 = F_142 ( V_35 ) ;
F_123 ( struct V_197 * , V_252 , V_248 -> V_251 ) ;
memset ( V_252 , 0 , sizeof( struct V_193 ) ) ;
F_143 ( V_272 + 1 , V_35 -> V_43 - V_272 - 1 , & V_271 , NULL ,
& V_22 , NULL , NULL ) ;
V_252 -> V_199 = V_200 ;
...
static int F_145 ( struct V_126 * V_2 , int V_273 )
{
return - V_153 ;
}
...
V_293 . V_91 = V_3 -> V_91 ;
V_293 . V_294 = F_153 ( & V_3 -> V_294 ) / V_52 ;
V_293 . V_295 = F_153 ( & V_3 -> V_295 ) / V_52 ;
V_293 . V_296 = F_153 ( & V_3 -> V_296 ) / V_52 ;
V_293 . V_297 = F_153 ( & V_3 -> V_297 ) / ( 60 * V_52 ) ;
V_293 . V_90 = V_3 -> V_90 ;
V_293 . V_46 = V_3 -> V_46 ;
V_293 . V_298 = F_154 ( V_2 ) ;
V_293 . V_299 = F_147 ( V_2 ) ;
...
static void * F_156 ( struct V_322 * V_323 , T_9 * V_324 )
__acquires( V_5 )
{
F_6 ( & V_5 ) ;
return F_157 ( & V_20 , * V_324 ) ;
}
static void * F_158 ( struct V_322 * V_323 , void * V_325 , T_9 * V_324 )
{
return F_159 ( V_325 , & V_20 , V_324 ) ;
}
static void F_160 ( struct V_322 * V_323 , void * V_325 )
__releases( V_5 )
{
F_8 ( & V_5 ) ;
}
static int F_161 ( struct V_322 * V_323 , void * V_325 )
{
T_1 * V_3 = F_162 ( V_325 , struct T_1 , V_4 ) ;
char V_326 [ 11 ] ;
int V_57 ;
F_163 ( V_323 , L_3 ,
( long ) V_3 ,
V_3 -> T_2 == NULL ? L_4 : V_3 -> T_2 -> V_7 -> V_149 ,
F_164 ( V_326 , & V_3 -> V_24 ) ,
V_3 -> V_23 ? L_5 : L_6 ) ;
F_163 ( V_323 , L_7 , F_164 ( V_326 , & V_3 -> V_29 ) ) ;
for ( V_57 = 0 ; ( V_3 -> V_33 != NULL ) && ( V_57 < V_3 -> V_33 -> V_32 ) ; V_57 ++ ) {
F_163 ( V_323 , L_8 ,
F_164 ( V_326 , & V_3 -> V_33 -> V_67 [ V_57 ] ) ,
V_3 -> V_33 -> V_226 [ V_57 ] ? L_5 : L_6 ) ;
}
F_163 ( V_323 , L_9 ,
V_3 -> V_46 ,
V_3 -> V_300 , V_3 -> V_301 , V_3 -> V_302 ,
F_153 ( & V_3 -> V_294 ) / V_52 , V_3 -> V_86 / V_52 ,
F_153 ( & V_3 -> V_295 ) / V_52 , V_3 -> V_88 / V_52 ,
F_153 ( & V_3 -> V_296 ) / V_52 , V_3 -> V_93 / V_52 ,
F_153 ( & V_3 -> V_297 ) / ( 60 * V_52 ) ,
V_3 -> V_95 / ( 60 * V_52 ) ,
V_3 -> V_90 , V_3 -> V_91 ,
V_3 -> V_85 / V_52 ,
V_3 -> V_83 ,
...
static int F_167 ( struct V_327 * V_327 , struct V_328 * V_328 )
{
return F_168 ( V_328 , & V_329 ) ;
}
static int T_10 F_169 ( void )
{
int V_330 = F_170 ( & V_167 , 0 ) ;
if ( V_330 != 0 )
goto V_152;
F_171 ( & V_331 ) ;
F_172 ( & V_332 ) ;
F_173 ( & V_333 ) ;
F_174 ( L_12 , V_334 , V_15 . V_335 ,
& V_336 ) ;
F_174 ( L_13 , V_334 , V_15 . V_335 , & V_337 ) ;
F_174 ( L_14 , V_334 , V_15 . V_335 , & V_338 ) ;
V_152:
return V_330 ;
}
static void T_11 F_175 ( void )
{
F_176 ( L_12 , V_15 . V_335 ) ;
F_176 ( L_13 , V_15 . V_335 ) ;
F_176 ( L_14 , V_15 . V_335 ) ;
F_177 ( & V_333 ) ;
F_178 ( & V_332 ) ;
F_179 ( V_159 ) ;
F_180 ( & V_167 ) ;
