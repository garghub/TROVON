...
F_93 ( & V_180 -> V_344 ) ;
while ( 1 ) {
F_110 ( & V_180 -> V_345 , & V_219 , V_267 ) ;
if ( ! ( V_180 -> V_346 & V_257 -> V_262 ) )
break;
F_94 ( & V_180 -> V_344 ) ;
F_94 ( & V_333 ) ;
...
F_111 ( & V_180 -> V_345 , & V_219 ) ;
V_180 -> V_346 |= V_257 -> V_262 & ( V_263 | V_264 ) ;
F_94 ( & V_180 -> V_344 ) ;
V_187 = 0 ;
if ( ( V_338 & 0xF ) == V_347 )
V_187 = V_138 ;
...
static int F_114 ( struct V_337 * V_337 , struct V_257 * V_257 )
{
T_11 * V_180 ;
F_22 ( L_90 , V_337 , V_257 ) ;
V_339 ;
...
static int F_115 ( struct V_337 * V_337 , struct V_257 * V_257 )
{
F_22 ( L_90 , V_337 , V_257 ) ;
V_343 ;
return 0 ;
}
static int F_116 ( T_11 * V_180 , unsigned int V_354 , void T_19 * V_280 )
{
int V_17 = - 1 ;
...
static int F_117 ( T_11 * V_180 , unsigned int V_354 , void T_19 * V_280 )
{
int V_17 ;
int V_149 ;
F_22 ( L_91 , V_180 , V_354 , V_280 ) ;
...
static long F_118 ( struct V_257 * V_257 ,
unsigned int V_279 ,
unsigned long V_280 )
{
T_11 * V_180 = ( T_11 * ) V_257 -> V_261 ;
...
F_93 ( & V_180 -> V_378 ) ;
{
if ( ( V_279 & ~ V_374 ) == F_119 ( 0 ) )
V_377 = F_116 ( V_180 , V_354 , ( void T_19 * ) V_280 ) ;
else if ( ( V_279 & ~ V_374 ) == F_120 ( 0 ) )
V_377 = F_117 ( V_180 , V_354 , ( void T_19 * ) V_280 ) ;
else
V_377 = - V_103 ;
}
F_94 ( & V_180 -> V_378 ) ;
...
do {
V_86 = F_10 ( & V_5 , V_82 ) ;
} while ( V_86 == V_84 && F_122 ( V_19 , V_18 ) );
F_5 ( & V_5 ) ;
F_24 ( L_95 , V_86 ) ;
...
static int T_2 F_123 ( struct V_379 * V_380 )
{
T_11 * V_180 = NULL ;
int V_149 = - V_15 ;
F_22 ( L_93 , V_380 ) ;
V_180 = F_124 ( sizeof ( T_11 ) , V_386 ) ;
if ( V_180 == NULL )
goto V_387;
...
if ( V_149 )
goto V_395;
V_149 = F_128 ( V_380 -> V_254 , F_87 , 0 , L_100 , V_180 ) ;
if ( V_149 )
goto V_396;
V_180 -> V_342 = F_129 ( & V_397 , - 1 ) ;
...
F_132 ( V_180 -> V_342 ) ;
V_398:
F_133 ( V_380 -> V_254 , V_180 ) ;
V_396:
V_395:
F_134 ( V_180 -> V_182 . V_390 , V_391 ) ;
V_394:
F_134 ( V_180 -> V_181 . V_390 , V_391 ) ;
V_392:
F_5 ( & V_180 -> V_5 ) ;
V_388:
F_135 ( V_180 ) ;
...
static int T_20 F_136 ( struct V_379 * V_380 )
{
T_11 * V_180 , * * V_402 ;
F_106 ( L_103 ) ;
V_402 = & V_340 ;
