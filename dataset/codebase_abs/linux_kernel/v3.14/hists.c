...
static inline bool F_95 ( void * V_47 )
{
return V_47 == NULL ;
}
...
goto V_180;
if ( F_99 ( V_175 ) ) {
V_163 [ V_169 ] = F_100 ( V_67 ) ;
if ( ! V_163 [ V_169 ] )
goto V_180;
V_166 [ V_169 ] = F_100 ( V_173 ) ;
if ( ! V_166 [ V_169 ] ) {
F_94 ( & V_163 [ V_169 ] ) ;
F_101 ( L_37 ) ;
fclose ( V_177 ) ;
...
F_102 ( V_168 ) ;
if ( V_169 ) {
V_170 = F_103 ( V_169 , V_163 ) ;
if ( V_170 < V_169 && V_170 >= 0 ) {
V_167 = F_100 ( V_166 [ V_170 ] ) ;
if ( V_167 ) {
if ( V_181 )
free ( ( void * ) V_182 ) ;
V_182 = V_167 ;
...
static int F_104 ( struct V_113 * V_114 , int V_51 ,
...
if ( V_2 -> V_32 != NULL &&
V_188 &&
V_188 -> V_223 . V_66 != NULL &&
! V_188 -> V_223 . V_70 -> V_71 -> V_208 &&
F_46 ( & V_163 [ V_169 ] , L_54 ,
V_188 -> V_223 . V_66 -> V_67 ) > 0 )
V_197 = V_169 ++ ;
if ( V_2 -> V_32 != NULL &&
V_188 &&
V_188 -> V_224 . V_66 != NULL &&
! V_188 -> V_224 . V_70 -> V_71 -> V_208 &&
( V_188 -> V_224 . V_66 != V_188 -> V_223 . V_66 ||
V_188 -> V_224 . V_70 -> V_71 != V_188 -> V_223 . V_70 -> V_71 ) &&
F_46 ( & V_163 [ V_169 ] , L_54 ,
V_188 -> V_224 . V_66 -> V_67 ) > 0 )
V_198 = V_169 ++ ;
} else {
if ( V_2 -> V_32 != NULL &&
V_2 -> V_32 -> V_66 != NULL &&
...
if ( V_152 != NULL &&
F_46 ( & V_163 [ V_169 ] , L_55 ,
( V_2 -> V_5 -> V_155 ? L_56 : L_57 ) ,
( V_152 -> V_161 ? F_92 ( V_152 ) : L_32 ) ,
V_152 -> V_162 ) > 0 )
V_196 = V_169 ++ ;
if ( V_71 != NULL &&
F_46 ( & V_163 [ V_169 ] , L_58 ,
( V_2 -> V_5 -> V_154 ? L_56 : L_57 ) ,
( V_71 -> V_225 ? L_59 : V_71 -> V_72 ) ) > 0 )
V_195 = V_169 ++ ;
if ( V_2 -> V_32 != NULL &&
V_2 -> V_32 -> V_70 != NULL &&
F_46 ( & V_163 [ V_169 ] , L_60 ) > 0 )
V_199 = V_169 ++ ;
if ( V_2 -> V_33 ) {
struct V_226 * V_66 ;
if ( F_46 ( & V_163 [ V_169 ] , L_61 ,
F_92 ( V_2 -> V_33 -> V_152 ) ) > 0 )
V_200 = V_169 ++ ;
V_66 = V_2 -> V_33 -> V_9 . V_66 ;
if ( V_66 && V_66 -> V_227 &&
F_46 ( & V_163 [ V_169 ] , L_62 ,
V_66 -> V_67 ) > 0 )
V_201 = V_169 ++ ;
}
if ( F_46 ( & V_163 [ V_169 ] , L_63 ) > 0 )
V_202 = V_169 ++ ;
if ( F_95 ( V_39 ) && F_46 ( & V_163 [ V_169 ] ,
L_64 ) > 0 )
V_203 = V_169 ++ ;
V_220:
V_163 [ V_169 ++ ] = ( char * ) L_65 ;
V_228:
V_170 = F_103 ( V_169 , V_163 ) ;
if ( V_170 == V_169 - 1 )
break;
...
if ( V_170 == V_194 || V_170 == V_198 || V_170 == V_197 ) {
struct V_11 * V_12 ;
int V_148 ;
V_209:
if ( ! V_229 && F_116 ( V_186 ) )
continue;
V_12 = F_86 ( V_2 ) ;
if ( V_12 == NULL )
continue;
if ( V_170 == V_197 ) {
V_12 -> V_9 . V_66 = V_12 -> V_187 -> V_223 . V_66 ;
V_12 -> V_9 . V_70 = V_12 -> V_187 -> V_223 . V_70 ;
} else if ( V_170 == V_198 ) {
V_12 -> V_9 . V_66 = V_12 -> V_187 -> V_224 . V_66 ;
V_12 -> V_9 . V_70 = V_12 -> V_187 -> V_224 . V_70 ;
}
V_12 -> V_230 = true ;
V_148 = F_117 ( V_12 , V_114 , V_39 ) ;
V_12 -> V_230 = false ;
if ( ( V_148 == 'q' || V_148 == F_115 ( 'c' ) )
&& V_198 != - 2 && V_197 != - 2 )
goto V_228;
...
continue;
F_40 ( L_66 ,
V_71 -> V_225 ? L_59 : V_71 -> V_72 ) ;
V_2 -> V_5 -> V_154 = V_71 ;
V_231 . V_232 = true ;
F_121 ( V_190 , & V_2 -> V_5 -> V_154 ) ;
}
F_122 ( V_5 ) ;
F_3 ( V_2 ) ;
} else if ( V_170 == V_196 ) {
...
V_2 -> V_5 -> V_155 = V_152 ;
V_233 . V_232 = true ;
F_121 ( V_190 , & V_2 -> V_5 -> V_155 ) ;
}
F_123 ( V_5 ) ;
F_3 ( V_2 ) ;
}
else if ( V_170 == V_202 || V_170 == V_200 ||
V_170 == V_201 ) {
V_211:
memset ( V_191 , 0 , 64 ) ;
if ( V_170 == V_200 )
sprintf ( V_191 , L_68 , F_92 ( V_2 -> V_33 -> V_152 ) ) ;
if ( V_170 == V_201 )
sprintf ( V_191 , L_69 , V_2 -> V_33 -> V_9 . V_66 -> V_67 ) ;
F_124 ( V_191 ) ;
}
else if ( V_170 == V_203 ) {
V_212:
...
static void F_126 ( struct V_36 * V_2 ,
void * V_130 , int V_76 )
{
struct V_235 * V_236 = F_67 ( V_2 ,
struct V_235 , V_3 ) ;
struct V_113 * V_114 = F_127 ( V_130 , struct V_113 , V_17 ) ;
bool V_107 = F_47 ( V_2 , V_76 ) ;
unsigned long V_51 = V_114 -> V_5 . V_49 . V_51 [ V_157 ] ;
const char * V_37 = F_128 ( V_114 ) ;
char V_62 [ 256 ] , V_153 ;
const char * V_237 = L_14 ;
T_2 V_65 ;
F_48 ( V_2 , V_107 ? V_96 :
V_95 ) ;
if ( F_88 ( V_114 ) ) {
...
V_65 = F_43 ( V_62 , sizeof( V_62 ) , L_72 , V_51 ,
...
F_48 ( V_2 , V_239 ) ;
V_51 = F_91 ( V_51 , & V_153 ) ;
V_65 += F_43 ( V_62 , sizeof( V_62 ) , L_73 ,
V_51 , V_153 , V_153 == ' ' ? L_32 : L_14 ) ;
V_237 = V_62 ;
}
F_50 ( V_237 , V_2 -> V_4 - V_65 ) ;
if ( V_107 )
V_236 -> V_32 = V_114 ;
}
static int F_130 ( struct V_235 * V_236 ,
int V_51 , const char * V_240 ,
struct V_38 * V_39 )
{
struct V_241 * V_242 = V_236 -> V_3 . V_243 ;
struct V_113 * V_159 ;
const char * V_37 , * V_41 = L_74 ;
int V_42 = V_39 ? V_39 -> V_43 : 0 ;
int V_40 ;
if ( F_34 ( & V_236 -> V_3 , V_41 ,
L_75 ) < 0 )
return - 1 ;
while ( 1 ) {
V_40 = F_35 ( & V_236 -> V_3 , V_42 ) ;
switch ( V_40 ) {
case V_46 :
V_39 -> V_47 ( V_39 -> V_48 ) ;
if ( ! V_236 -> V_244 && V_236 -> V_238 ) {
F_30 ( & V_236 -> V_3 ) ;
V_236 -> V_244 = true ;
}
continue;
...
switch ( V_40 ) {
case V_204 :
if ( V_159 -> V_17 . V_27 == & V_242 -> V_35 )
V_159 = F_132 ( V_242 ) ;
else
V_159 = F_133 ( V_159 ) ;
goto V_245;
case V_205 :
if ( V_159 -> V_17 . V_246 == & V_242 -> V_35 )
V_159 = F_134 ( V_242 ) ;
else
V_159 = F_135 ( V_159 ) ;
goto V_245;
...
static bool F_136 ( struct V_36 * V_2 V_247 ,
void * V_130 )
{
struct V_113 * V_114 = F_127 ( V_130 , struct V_113 , V_17 ) ;
if ( V_101 . V_110 && ! F_137 ( V_114 ) )
return true ;
return false ;
}
static int F_138 ( struct V_241 * V_242 ,
int V_6 , const char * V_240 ,
struct V_38 * V_39 ,
float V_44 ,
struct V_185 * V_186 )
{
...
F_107 ( L_76 ) ;
F_139 (evlist, pos) {
const char * V_37 = F_128 ( V_159 ) ;
T_2 V_252 = strlen ( V_37 ) + 7 ;
if ( V_236 . V_3 . V_4 < V_252 )
V_236 . V_3 . V_4 = V_252 ;
}
return F_130 ( & V_236 , V_6 , V_240 , V_39 ) ;
}
int F_140 ( struct V_241 * V_242 , const char * V_240 ,
struct V_38 * V_39 ,
float V_44 ,
struct V_185 * V_186 )
{
...
V_253:
if ( V_6 == 1 ) {
struct V_113 * V_25 = F_132 ( V_242 ) ;
const char * V_37 = F_128 ( V_25 ) ;
return F_104 ( V_25 , V_6 , V_240 ,
