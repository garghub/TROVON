...
F_2 ( V_26 < 1 << V_70 ||
( V_26 & ( V_26 - 1 ) ) ) ;
V_2 = F_32 ( sizeof( * V_2 ) , V_161 ) ;
if ( ! V_2 ) {
V_56 = - V_162 ;
goto V_163;
}
V_2 -> V_47 = F_128 ( sizeof( struct V_164 ) << V_165 ) ;
if ( ! V_2 -> V_47 ) {
V_56 = - V_162 ;
goto V_166;
}
...
V_2 -> V_32 = ( F_129 ( V_26 ) - 1 >= V_167 ) ?
F_129 ( V_26 ) - 1 - V_167 : 0 ;
V_2 -> V_4 = ( F_129 ( V_26 ) - 1 < V_167 ?
V_167 - ( F_129 ( V_26 ) - 1 ) : 0 ) ;
V_2 -> V_39 = V_39 ;
V_2 -> V_113 = V_113 ;
V_2 -> V_86 = V_86 ;
for ( V_147 = 0 ; V_147 < V_148 ; V_147 ++ ) {
F_130 ( & V_2 -> V_45 [ V_147 ] ) ;
V_2 -> V_42 [ V_147 ] = 0 ;
}
for ( V_147 = 0 ; V_147 < 1 << V_165 ; V_147 ++ )
F_131 ( & V_2 -> V_47 [ V_147 ] ) ;
F_132 ( & V_2 -> V_6 ) ;
F_130 ( & V_2 -> V_111 ) ;
V_2 -> V_112 = V_111 ;
V_2 -> V_120 = V_168 ;
...
if ( V_2 -> V_4 ) {
if ( ! F_137 ( V_2 ) ) {
F_137 ( V_2 ) = F_138 ( V_161 , L_3 , V_2 -> V_26 ) ;
if ( ! F_137 ( V_2 ) ) {
V_56 = - V_162 ;
F_10 ( & V_17 ) ;
goto V_170;
...
static void F_146 ( struct V_183 * V_184 )
{
F_145 () ;
F_147 ( V_185 , & V_186 ,
V_187 * V_181 ) ;
