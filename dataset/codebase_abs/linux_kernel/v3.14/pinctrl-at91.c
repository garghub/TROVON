...
void T_1 * V_45 = V_157 -> V_42 ;
unsigned V_46 = 1 << V_18 ;
F_22 ( V_46 , V_45 + ( V_130 ? V_160 : V_161 ) ) ;
}
...
int V_162 ;
if ( V_18 < V_107 -> V_156 )
V_162 = F_97 ( V_157 -> V_163 , V_18 ) ;
else
V_162 = - V_164 ;
F_2 ( V_107 -> V_9 , L_42 ,
V_107 -> V_165 , V_18 + V_107 -> V_109 , V_162 ) ;
return V_162 ;
}
static void F_98 ( struct V_16 * V_17 , struct V_106 * V_107 )
{
enum V_59 V_166 ;
int V_6 ;
struct V_104 * V_157 = F_92 ( V_107 ) ;
...
const char * V_167 ;
T_2 V_158 ;
V_167 = F_99 ( V_107 , V_6 ) ;
if ( ! V_167 )
continue;
V_166 = V_157 -> V_91 -> V_168 ( V_45 , V_46 ) ;
F_8 ( V_17 , L_43 ,
V_167 , V_107 -> V_165 , V_6 ) ;
if ( V_166 == V_62 ) {
V_158 = F_24 ( V_45 + V_159 ) ;
F_8 ( V_17 , L_44 ,
V_158 & V_46 ?
...
static void F_100 ( struct V_169 * V_170 )
{
struct V_104 * V_157 = F_101 ( V_170 ) ;
void T_1 * V_45 = V_157 -> V_42 ;
unsigned V_46 = 1 << V_170 -> V_171 ;
if ( V_45 )
F_22 ( V_46 , V_45 + V_47 ) ;
}
static void F_102 ( struct V_169 * V_170 )
{
struct V_104 * V_157 = F_101 ( V_170 ) ;
void T_1 * V_45 = V_157 -> V_42 ;
unsigned V_46 = 1 << V_170 -> V_171 ;
if ( V_45 )
F_22 ( V_46 , V_45 + V_172 ) ;
}
static int F_103 ( struct V_169 * V_170 , unsigned type )
{
switch ( type ) {
case V_173 :
case V_174 :
...
static int F_104 ( struct V_169 * V_170 , unsigned type )
{
struct V_104 * V_157 = F_101 ( V_170 ) ;
void T_1 * V_45 = V_157 -> V_42 ;
unsigned V_46 = 1 << V_170 -> V_171 ;
switch ( type ) {
case V_175 :
F_105 ( V_170 -> V_176 , V_177 ) ;
F_22 ( V_46 , V_45 + V_178 ) ;
F_22 ( V_46 , V_45 + V_179 ) ;
break;
case V_180 :
F_105 ( V_170 -> V_176 , V_177 ) ;
F_22 ( V_46 , V_45 + V_178 ) ;
...
case V_173 :
default:
F_106 ( L_48 , F_107 ( V_170 -> V_176 ) ) ;
return - V_15 ;
}
F_22 ( V_46 , V_45 + V_187 ) ;
return 0 ;
}
static int F_108 ( struct V_169 * V_170 , unsigned V_188 )
{
struct V_104 * V_157 = F_101 ( V_170 ) ;
unsigned V_40 = V_157 -> V_189 ;
unsigned V_46 = 1 << V_170 -> V_171 ;
if ( F_109 ( V_40 >= V_190 ) )
return - V_15 ;
if ( V_188 )
...
continue;
V_45 = V_41 [ V_6 ] -> V_42 ;
V_194 [ V_6 ] = F_37 ( V_45 + V_195 ) ;
F_39 ( V_194 [ V_6 ] , V_45 + V_47 ) ;
F_39 ( V_191 [ V_6 ] , V_45 + V_172 ) ;
if ( ! V_191 [ V_6 ] )
F_112 ( V_41 [ V_6 ] -> clock ) ;
else
F_113 ( V_196 L_49 ,
'A' + V_6 , V_191 [ V_6 ] ) ;
}
...
F_39 ( V_194 [ V_6 ] , V_45 + V_172 ) ;
}
}
static void F_116 ( unsigned V_176 , struct V_197 * V_198 )
{
struct V_199 * V_107 = F_117 ( V_198 ) ;
struct V_169 * V_200 = F_118 ( V_198 ) ;
struct V_104 * V_157 = F_101 ( V_200 ) ;
void T_1 * V_45 = V_157 -> V_42 ;
unsigned long V_201 ;
int V_202 ;
F_119 ( V_107 , V_198 ) ;
for (; ; ) {
V_201 = F_24 ( V_45 + V_203 ) & F_24 ( V_45 + V_195 ) ;
if ( ! V_201 ) {
if ( ! V_157 -> V_204 )
break;
V_157 = V_157 -> V_204 ;
...
F_120 (n, &isr, BITS_PER_LONG) {
F_121 ( F_122 ( V_157 -> V_163 , V_202 ) ) ;
}
}
F_123 ( V_107 , V_198 ) ;
}
static int F_124 ( struct V_205 * V_206 , unsigned int V_162 ,
T_5 V_207 )
{
struct V_104 * V_157 = V_206 -> V_208 ;
void T_1 * V_45 = V_157 -> V_42 ;
T_2 V_46 = 1 << V_207 ;
F_125 ( V_162 , & V_209 ) ;
F_126 ( V_162 , & V_210 ) ;
if ( ( V_157 -> V_91 == & V_211 ) &&
( F_24 ( V_45 + V_212 ) & V_46 ) &&
( F_24 ( V_45 + V_213 ) & V_46 ) )
F_127 ( V_162 , V_183 ) ;
else
F_127 ( V_162 , V_177 ) ;
F_128 ( V_162 , V_214 ) ;
...
static int F_130 ( struct V_205 * V_170 ,
struct V_19 * V_215 ,
const T_2 * V_216 , unsigned int V_217 ,
T_5 * V_218 ,
unsigned int * V_219 )
{
struct V_104 * V_157 = V_170 -> V_208 ;
int V_88 ;
int V_43 = V_157 -> V_107 . V_109 + V_216 [ 0 ] ;
if ( F_131 ( V_217 < 2 ) )
return - V_15 ;
* V_218 = V_216 [ 0 ] ;
* V_219 = V_216 [ 1 ] & V_220 ;
V_88 = F_132 ( V_43 , V_215 -> V_221 ) ;
if ( V_88 )
return V_88 ;
V_88 = F_133 ( V_43 ) ;
if ( V_88 )
...
static int F_134 ( struct V_19 * V_222 ,
struct V_104 * V_157 )
{
struct V_104 * V_223 = NULL ;
struct V_169 * V_170 = F_135 ( V_157 -> V_192 ) ;
V_157 -> V_224 = F_136 ( V_170 ) ;
V_210 . V_225 = V_157 -> V_91 -> V_226 ;
F_22 ( ~ 0 , V_157 -> V_42 + V_47 ) ;
V_157 -> V_163 = F_137 ( V_222 , V_157 -> V_107 . V_156 ,
& V_227 , V_157 ) ;
if ( ! V_157 -> V_163 )
F_138 ( L_50 ,
V_157 -> V_189 ) ;
if ( V_157 -> V_189 )
V_223 = V_41 [ V_157 -> V_189 - 1 ] ;
if ( V_223 && V_223 -> V_204 == V_157 )
return 0 ;
F_129 ( V_157 -> V_192 , V_157 ) ;
F_139 ( V_157 -> V_192 , F_116 ) ;
return 0 ;
}
static void F_140 ( void )
{
unsigned V_6 ;
struct V_104 * V_157 , * V_228 = NULL ;
for ( V_6 = 0 ; V_6 < V_193 ; V_6 ++ ) {
V_157 = V_41 [ V_6 ] ;
if ( V_228 && V_228 -> V_192 == V_157 -> V_192 )
V_228 -> V_204 = V_157 ;
V_228 = V_157 ;
}
}
...
int V_88 = 0 ;
int V_176 , V_6 ;
int V_231 = F_142 ( V_20 , L_51 ) ;
T_3 V_156 ;
char * * V_232 ;
F_143 ( V_231 >= F_144 ( V_41 ) ) ;
if ( V_41 [ V_231 ] ) {
V_88 = - V_233 ;
goto V_154;
}
...
V_230 = F_146 ( V_141 , V_234 , 0 ) ;
V_105 -> V_42 = F_147 ( & V_141 -> V_9 , V_230 ) ;
if ( F_148 ( V_105 -> V_42 ) ) {
V_88 = F_149 ( V_105 -> V_42 ) ;
goto V_154;
}
V_105 -> V_91 = (struct V_145 * )
F_76 ( V_235 , & V_141 -> V_9 ) -> V_30 ;
V_105 -> V_192 = V_176 ;
V_105 -> V_189 = V_231 ;
V_105 -> clock = F_150 ( & V_141 -> V_9 , NULL ) ;
if ( F_148 ( V_105 -> clock ) ) {
F_11 ( & V_141 -> V_9 , L_52 ) ;
goto V_154;
}
if ( F_151 ( V_105 -> clock ) )
goto V_236;
if ( F_152 ( V_105 -> clock ) ) {
F_11 ( & V_141 -> V_9 , L_53 ) ;
goto V_237;
}
V_105 -> V_107 = V_238 ;
V_107 = & V_105 -> V_107 ;
V_107 -> V_143 = V_20 ;
V_107 -> V_165 = F_9 ( & V_141 -> V_9 ) ;
V_107 -> V_9 = & V_141 -> V_9 ;
V_107 -> V_239 = V_240 ;
V_107 -> V_109 = V_231 * V_44 ;
if ( ! F_153 ( V_20 , L_54 , & V_156 ) ) {
if ( V_156 >= V_44 )
F_154 ( L_55 ,
V_231 , V_44 , V_44 ) ;
else
...
V_232 = F_12 ( & V_141 -> V_9 , sizeof( char * ) * V_107 -> V_156 ,
V_27 ) ;
if ( ! V_232 ) {
V_88 = - V_28 ;
goto V_237;
...
for ( V_6 = 0 ; V_6 < V_107 -> V_156 ; V_6 ++ )
V_232 [ V_6 ] = F_79 ( V_27 , L_38 , V_231 + 'A' , V_6 ) ;
V_107 -> V_232 = ( const char * const * ) V_232 ;
V_102 = & V_105 -> V_102 ;
V_102 -> V_4 = V_107 -> V_165 ;
V_102 -> V_110 = V_231 ;
V_102 -> V_241 = V_102 -> V_109 = V_102 -> V_110 * V_44 ;
...
goto V_237;
V_41 [ V_231 ] = V_105 ;
V_193 = F_156 ( V_193 , V_231 + 1 ) ;
F_140 () ;
F_134 ( V_20 , V_105 ) ;
F_83 ( & V_141 -> V_9 , L_56 , V_105 -> V_42 ) ;
return 0 ;
V_237:
F_157 ( V_105 -> clock ) ;
V_236:
F_158 ( V_105 -> clock ) ;
V_154:
F_11 ( & V_141 -> V_9 , L_57 , V_88 , V_231 ) ;
return V_88 ;
}
