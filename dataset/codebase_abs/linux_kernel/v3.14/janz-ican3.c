...
static bool F_56 ( struct V_1 * V_2 , struct V_109 * V_110 )
{
struct V_87 * V_88 = (struct V_87 * ) V_110 -> V_72 ;
struct V_109 * V_180 = F_57 ( & V_2 -> V_128 ) ;
struct V_87 * V_181 ;
if ( ! V_180 )
return false ;
...
static int F_63 ( struct V_189 * V_190 , int V_191 )
{
struct V_1 * V_2 = F_64 ( V_190 , struct V_1 , V_190 ) ;
unsigned long V_34 ;
int V_192 = 0 ;
int V_64 ;
while ( true ) {
...
F_65 ( V_190 ) ;
F_12 ( & V_2 -> V_37 , V_34 ) ;
if ( F_66 ( V_2 -> V_106 ) && F_58 ( V_2 ) )
F_67 ( V_2 -> V_106 ) ;
F_14 ( & V_2 -> V_37 , V_34 ) ;
F_3 ( 1 << V_2 -> V_168 , & V_2 -> V_194 -> V_195 ) ;
return V_192 ;
}
static T_3 F_68 ( int V_196 , void * V_197 )
{
...
return 0 ;
F_71 ( 10 ) ;
} while ( F_72 ( V_209 , V_203 + V_210 / 4 ) );
F_9 ( V_2 -> V_19 , L_17 ) ;
return - V_211 ;
}
...
static int F_83 ( struct V_109 * V_110 , struct V_105 * V_106 )
{
struct V_1 * V_2 = F_76 ( V_106 ) ;
struct V_87 * V_88 = (struct V_87 * ) V_110 -> V_72 ;
struct V_52 V_33 ;
...
static int F_86 ( struct V_105 * V_106 , enum V_228 V_229 )
{
struct V_1 * V_2 = F_76 ( V_106 ) ;
int V_64 ;
if ( V_229 != V_230 )
...
static int F_87 ( const struct V_105 * V_106 ,
struct V_232 * V_163 )
{
struct V_1 * V_2 = F_76 ( V_106 ) ;
int V_64 ;
...
if ( V_64 )
return V_64 ;
V_64 = F_88 ( & V_2 -> V_164 , V_210 ) ;
if ( V_64 == 0 ) {
F_89 ( V_2 -> V_19 , L_29 , V_63 ) ;
return - V_211 ;
}
...
static T_4 F_90 ( struct V_233 * V_19 ,
struct V_234 * V_235 ,
char * V_236 )
{
struct V_1 * V_2 = F_76 ( F_91 ( V_19 ) ) ;
int V_64 ;
V_64 = F_30 ( V_2 , V_165 ) ;
if ( V_64 )
return V_64 ;
V_64 = F_88 ( & V_2 -> V_167 , V_210 ) ;
if ( V_64 == 0 ) {
F_89 ( V_2 -> V_19 , L_29 , V_63 ) ;
return - V_211 ;
}
...
static T_4 F_92 ( struct V_233 * V_19 ,
struct V_234 * V_235 ,
...
static int F_94 ( struct V_240 * V_241 )
{
struct V_242 * V_243 ;
struct V_105 * V_106 ;
struct V_1 * V_2 ;
...
struct V_233 * V_19 ;
int V_64 ;
V_243 = F_95 ( & V_241 -> V_19 ) ;
if ( ! V_243 )
return - V_246 ;
F_6 ( & V_241 -> V_19 , L_31 , V_243 -> V_247 ) ;
V_19 = & V_241 -> V_19 ;
V_106 = F_96 ( sizeof( * V_2 ) , 0 ) ;
if ( ! V_106 ) {
F_9 ( V_19 , L_32 ) ;
V_64 = - V_20 ;
goto V_248;
...
F_98 ( V_106 , & V_2 -> V_190 , F_63 , V_57 ) ;
F_99 ( & V_2 -> V_128 ) ;
F_100 ( & V_2 -> V_37 ) ;
F_101 ( & V_2 -> V_167 ) ;
F_101 ( & V_2 -> V_164 ) ;
...
V_106 -> V_251 = & V_252 ;
V_106 -> V_34 |= V_253 ;
F_102 ( V_106 , & V_241 -> V_19 ) ;
V_2 -> V_101 . clock . V_254 = V_255 ;
V_2 -> V_101 . V_256 = & V_257 ;
V_2 -> V_101 . V_258 = F_85 ;
V_2 -> V_101 . V_259 = F_86 ;
V_2 -> V_101 . V_260 = F_87 ;
V_2 -> V_101 . V_261 = V_226
| V_130
| V_103 ;
V_2 -> V_196 = F_103 ( V_241 , 0 ) ;
if ( V_2 -> V_196 < 0 ) {
F_9 ( V_19 , L_33 ) ;
V_64 = - V_124 ;
goto V_262;
}
V_106 -> V_196 = V_2 -> V_196 ;
V_245 = F_104 ( V_241 , V_263 , 0 ) ;
if ( ! V_245 ) {
F_9 ( V_19 , L_34 ) ;
V_64 = - V_124 ;
goto V_262;
}
V_2 -> V_15 = F_105 ( V_245 -> V_203 , F_106 ( V_245 ) ) ;
if ( ! V_2 -> V_15 ) {
F_9 ( V_19 , L_35 ) ;
V_64 = - V_20 ;
goto V_262;
...
V_245 = F_104 ( V_241 , V_263 , 1 ) ;
if ( ! V_245 ) {
F_9 ( V_19 , L_36 ) ;
V_64 = - V_124 ;
goto V_264;
}
V_2 -> V_194 = F_105 ( V_245 -> V_203 , F_106 ( V_245 ) ) ;
if ( ! V_2 -> V_194 ) {
F_9 ( V_19 , L_37 ) ;
V_64 = - V_20 ;
goto V_264;
...
F_3 ( 1 << V_2 -> V_168 , & V_2 -> V_194 -> V_199 ) ;
V_64 = F_107 ( V_2 -> V_196 , F_68 , V_265 , V_266 , V_2 ) ;
if ( V_64 ) {
F_9 ( V_19 , L_38 ) ;
goto V_267;
}
...
static int F_114 ( struct V_240 * V_241 )
{
struct V_105 * V_106 = F_115 ( V_241 ) ;
struct V_1 * V_2 = F_76 ( V_106 ) ;
F_116 ( V_106 ) ;
F_110 ( & V_2 -> V_190 ) ;
F_3 ( 1 << V_2 -> V_168 , & V_2 -> V_194 -> V_199 ) ;
