...
static void T_4
F_28 ( struct V_49 * V_50 , struct V_9 * V_10 ,
const struct V_16 * V_17 )
{
struct V_34 * V_34 ;
int V_36 ;
int V_52 ;
unsigned int V_1 ;
const char * V_37 [ V_53 ] ;
const char * V_35 = V_50 -> V_35 ;
struct V_18 * V_19 ;
V_36 = F_29 ( V_50 , L_7 , L_8 ) ;
if ( V_36 <= 0 || V_36 > V_53 )
return;
for ( V_52 = 0 ; V_52 < V_36 ; ++ V_52 ) {
V_37 [ V_52 ] = F_30 ( V_50 , V_52 ) ;
if ( ! V_37 [ V_52 ] )
return;
}
F_31 ( V_50 , L_9 , & V_35 ) ;
...
void T_4 F_34 ( struct V_49 * V_50 ,
struct V_9 * V_10 )
{
F_28 ( V_50 , V_10 , & V_55 ) ;
}
