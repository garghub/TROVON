...
V_81 = F_44 ( V_5 , V_6 -> V_130 , V_12 * 2 ) ;
if ( V_81 < 0 ) {
F_18 ( V_6 -> V_30 , L_10 , V_81 ) ;
return V_81 ;
}
V_81 = F_45 ( V_6 -> V_130 , V_12 ) ;
if ( V_81 < 0 )
return V_81 ;
V_81 = F_46 ( V_6 -> V_130 ) ;
if ( V_81 < 0 ) {
...
F_50 ( V_117 , F_51 ( 1 ) ,
V_132 ) ;
F_50 ( V_117 , V_133 | V_134 ,
V_135 ) ;
V_121 = 1 + V_112 + V_114 - 10 ;
F_50 ( V_117 , V_136 , V_137 ) ;
V_25 = V_138 | V_139 | V_140 |
V_141 ;
F_50 ( V_117 , V_25 , V_142 ) ;
V_25 = F_52 ( V_121 ) | F_53 ( V_121 + 8 ) ;
F_50 ( V_117 , V_25 , V_143 ) ;
...
V_25 = V_148 ;
if ( ( V_77 -> V_128 == 720 ) && ( ( V_77 -> V_149 == 480 ) ||
( V_77 -> V_149 == 576 ) ) )
F_6 ( V_6 ,
V_25 | V_150 ,
V_151 ) ;
...
V_25 | V_152 ,
V_151 ) ;
V_122 = F_56 ( V_6 -> V_130 ) / 1000000 * 4 ;
...
F_32 ( V_6 ) ;
F_35 ( V_6 ) ;
for ( V_22 = 0 ; V_22 < V_6 -> V_32 -> V_158 ; V_22 ++ ) {
...
V_190 ) ;
F_6 ( V_6 , 0 , V_191 ) ;
V_25 = F_69 ( V_117 , V_194 ) ;
V_25 |= V_195 ;
F_50 ( V_117 , V_25 , V_194 ) ;
V_25 = F_69 ( V_117 , V_196 ) ;
V_25 &= ~ V_197 ;
V_25 |= V_198 ;
F_50 ( V_117 , V_25 , V_196 ) ;
V_25 = F_69 ( V_117 , V_199 ) ;
V_25 |= V_200 | V_201 | V_202 | V_203 |
V_204 | V_205 | V_206 ;
F_50 ( V_117 , V_25 , V_199 ) ;
F_50 ( V_117 , V_207 << 8 , V_208 ) ;
F_50 ( V_117 , V_207 , V_208 ) ;
V_6 -> V_124 = true ;
return 0 ;
}
...
struct V_130 * V_130 , unsigned long V_12 )
{
struct V_1 * V_6 = F_3 ( V_5 ) ;
struct V_130 * V_120 ;
int V_81 ;
V_81 = F_74 ( V_130 , V_6 -> V_209 ) ;
if ( V_81 < 0 ) {
F_18 ( V_5 -> V_30 , L_13 , V_81 ) ;
return V_81 ;
}
V_120 = F_75 ( V_6 -> V_209 ) ;
...
struct V_130 * V_212 ;
long V_81 ;
V_212 = F_75 ( V_6 -> V_209 ) ;
V_81 = F_77 ( V_212 , V_12 * 4 ) ;
if ( V_81 <= 0 )
* V_211 = V_213 ;
else
* V_211 = V_214 ;
...
static int F_78 ( struct V_215 * V_216 , void * V_66 )
{
struct V_217 * V_29 = V_216 -> V_218 ;
struct V_1 * V_6 = V_29 -> V_219 -> V_66 ;
int V_81 ;
V_81 = F_46 ( V_6 -> V_130 ) ;
if ( V_81 )
return V_81 ;
...
unsigned int V_22 ;
int V_81 ;
V_6 -> V_329 = F_81 ( L_15 , V_328 -> V_330 ) ;
if ( ! V_6 -> V_329 )
return - V_331 ;
V_6 -> V_332 = F_82 ( V_332 , sizeof( V_332 ) ,
V_333 ) ;
if ( ! V_6 -> V_332 ) {
V_81 = - V_331 ;
goto remove;
}
for ( V_22 = 0 ; V_22 < F_10 ( V_332 ) ; V_22 ++ )
V_6 -> V_332 [ V_22 ] . V_66 = V_6 ;
V_81 = F_83 ( V_6 -> V_332 ,
F_10 ( V_332 ) ,
V_6 -> V_329 , V_328 ) ;
if ( V_81 < 0 )
...
{
struct V_334 * V_335 = F_89 ( V_3 -> V_212 ) ;
...
V_6 -> V_5 . V_338 = & V_339 ;
V_81 = F_90 ( V_335 -> V_340 , & V_6 -> V_5 ) ;
if ( V_81 < 0 ) {
F_18 ( V_3 -> V_30 , L_17 , V_81 ) ;
return V_81 ;
}
if ( F_91 ( V_341 ) ) {
V_81 = F_80 ( V_6 , V_335 -> V_340 -> V_342 ) ;
if ( V_81 < 0 )
...
static int F_95 ( struct V_343 * V_344 )
{
const struct V_345 * V_346 ;
struct V_1 * V_6 ;
struct V_347 * V_8 ;
int V_81 ;
V_346 = F_96 ( V_348 , V_344 -> V_30 . V_31 ) ;
if ( ! V_346 )
return - V_349 ;
V_6 = F_97 ( & V_344 -> V_30 , sizeof( * V_6 ) , V_333 ) ;
if ( ! V_6 )
return - V_331 ;
V_6 -> V_32 = V_346 -> V_66 ;
V_6 -> V_30 = & V_344 -> V_30 ;
...
V_6 -> V_89 = false ;
V_6 -> V_82 = false ;
V_6 -> V_130 = F_98 ( & V_344 -> V_30 , NULL ) ;
if ( F_99 ( V_6 -> V_130 ) ) {
F_18 ( & V_344 -> V_30 , L_22 ) ;
return F_100 ( V_6 -> V_130 ) ;
}
V_6 -> V_131 = F_101 ( & V_344 -> V_30 , L_15 ) ;
if ( F_99 ( V_6 -> V_131 ) ) {
F_18 ( & V_344 -> V_30 , L_23 ) ;
return F_100 ( V_6 -> V_131 ) ;
}
V_81 = F_102 ( V_6 -> V_130 ) ;
if ( V_81 < 0 )
return V_81 ;
V_6 -> V_209 = F_98 ( & V_344 -> V_30 , L_24 ) ;
if ( F_99 ( V_6 -> V_209 ) )
return F_100 ( V_6 -> V_209 ) ;
V_81 = F_102 ( V_6 -> V_209 ) ;
if ( V_81 < 0 )
return V_81 ;
V_81 = F_74 ( V_6 -> V_130 , V_6 -> V_209 ) ;
if ( V_81 < 0 ) {
F_18 ( & V_344 -> V_30 , L_25 , V_81 ) ;
return V_81 ;
}
V_6 -> V_336 = F_103 ( & V_344 -> V_30 , L_26 ) ;
if ( F_99 ( V_6 -> V_336 ) ) {
F_18 ( & V_344 -> V_30 , L_27 ) ;
return F_100 ( V_6 -> V_336 ) ;
}
V_6 -> V_129 = F_103 ( & V_344 -> V_30 , L_28 ) ;
if ( F_99 ( V_6 -> V_129 ) ) {
F_18 ( & V_344 -> V_30 , L_29 ) ;
return F_100 ( V_6 -> V_129 ) ;
}
V_6 -> V_5 . V_30 = & V_344 -> V_30 ;
V_81 = F_104 ( & V_6 -> V_5 ) ;
if ( V_81 < 0 )
return V_81 ;
V_8 = F_105 ( V_344 , V_350 , 0 ) ;
V_6 -> V_8 = F_106 ( & V_344 -> V_30 , V_8 ) ;
if ( F_99 ( V_6 -> V_8 ) )
return F_100 ( V_6 -> V_8 ) ;
V_81 = F_107 ( V_344 , 0 ) ;
if ( V_81 < 0 )
return V_81 ;
V_6 -> V_351 = V_81 ;
F_108 ( & V_6 -> V_3 . V_352 ) ;
V_6 -> V_3 . V_338 = & V_353 ;
V_6 -> V_3 . V_30 = & V_344 -> V_30 ;
V_81 = F_109 ( & V_6 -> V_3 ) ;
if ( V_81 < 0 ) {
F_18 ( & V_344 -> V_30 , L_30 ,
V_81 ) ;
return V_81 ;
}
F_110 ( V_344 , V_6 ) ;
...
static int F_111 ( struct V_343 * V_344 )
{
struct V_1 * V_6 = F_112 ( V_344 ) ;
int V_81 ;
V_81 = F_113 ( & V_6 -> V_3 ) ;
if ( V_81 < 0 ) {
F_18 ( & V_344 -> V_30 , L_31 ,
V_81 ) ;
return V_81 ;
}
V_81 = F_114 ( & V_6 -> V_5 ) ;
if ( V_81 < 0 ) {
F_18 ( & V_344 -> V_30 , L_32 , V_81 ) ;
return V_81 ;
}
F_115 ( V_6 -> V_209 ) ;
F_115 ( V_6 -> V_130 ) ;
