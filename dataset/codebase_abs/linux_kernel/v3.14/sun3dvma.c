...
V_16 -> V_20 = V_35 ;
F_17 ( & ( V_16 -> V_17 ) , & V_27 ) ;
V_6 = F_20 ( V_5 * sizeof( unsigned long ) ) ;
F_1 ( V_8 , V_35 ) ;
#ifdef F_21
F_22 () ;
#endif
}
unsigned long F_23 ( unsigned long V_36 , int V_25 , int V_26 )
{
unsigned long V_30 ;
unsigned long V_37 ;
if( ! V_25 )
...
void * F_27 ( unsigned long V_25 , unsigned long V_26 )
{
unsigned long V_36 ;
unsigned long V_30 ;
unsigned long V_40 ;
...
#endif
V_25 = ( ( V_25 + ( V_29 - 1 ) ) & V_32 ) ;
if( ( V_36 = F_28 ( V_41 , F_29 ( V_25 ) ) ) == 0 )
return NULL ;
if( ( V_30 = ( unsigned long ) F_23 ( V_36 , V_25 , V_26 ) ) == 0 ) {
F_30 ( V_36 , F_29 ( V_25 ) ) ;
return NULL ;
}
V_40 = F_31 ( V_30 ) ;
if( F_32 ( V_36 , V_40 , V_25 ) < 0 ) {
F_26 ( ( void * ) V_30 ) ;
F_30 ( V_36 , F_29 ( V_25 ) ) ;
return NULL ;
}
