...
V_25 -> V_141 = F_102 ( V_249 ) ;
if ( F_2 ( V_25 -> V_2 -> V_6 ) ) {
if ( ( V_172 = F_103 ( V_25 -> V_2 -> V_6 ,
L_95 ) ) ) {
F_104 ( & V_224 -> V_25 ,
L_96 ,
V_25 -> V_2 -> V_6 , V_172 ) ;
...
F_106 ( & V_25 -> V_175 ) ;
V_25 -> V_175 . V_251 = F_82 ;
V_25 -> V_175 . V_252 = ( unsigned long ) V_25 ;
V_3 = V_25 ;
F_107 ( V_224 , V_25 ) ;
F_57 ( V_25 ) ;
F_68 ( V_25 ) ;
V_25 -> V_136 = 0 ;
V_172 = F_108 ( V_177 , F_88 ,
0 , V_227 , V_25 ) ;
if ( V_172 != 0 ) {
F_94 ( L_97 ,
V_227 , V_177 , V_172 ) ;
...
static void F_118 ( struct V_223 * V_178 )
{
F_1 () ;
}
static int F_119 ( struct V_223 * V_224 )
{
struct V_24 * V_25 = F_120 ( V_224 ) ;
if ( V_25 -> V_39 )
return - V_257 ;
F_121 ( & V_25 -> V_40 ) ;
V_25 -> F_53 = 0 ;
...
static int F_122 ( struct V_223 * V_25 , T_6 V_258 )
{
struct V_24 * V_134 = F_120 ( V_25 ) ;
unsigned long V_48 ;
if ( ! F_2 ( V_134 -> V_2 -> V_6 ) && ! V_134 -> V_2 -> V_7 )
F_86 ( L_99 ) ;
V_134 -> V_137 = 1 ;
...
static int F_123 ( struct V_223 * V_25 )
{
struct V_24 * V_134 = F_120 ( V_25 ) ;
unsigned long V_48 ;
V_134 -> V_137 = 0 ;
