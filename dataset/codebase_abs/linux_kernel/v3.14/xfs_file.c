...
T_4 V_113 ;
F_37 ( V_76 , V_49 ) ;
V_113 = F_67 ( V_17 , V_43 -> V_53 - V_49 , V_49 ) ;
if ( V_113 < 0 )
V_49 = V_113 ;
}
V_106:
...
V_118 = V_12 + V_115 ;
error = - F_72 ( V_31 , V_118 ) ;
if ( error )
goto V_122;
}
error = F_73 ( V_2 , V_12 , V_115 ,
V_123 ) ;
if ( error )
goto V_122;
}
V_117 = F_74 ( V_2 -> V_25 , V_124 ) ;
error = F_75 ( V_117 , & F_76 ( V_2 -> V_25 ) -> V_125 , 0 , 0 ) ;
if ( error ) {
F_77 ( V_117 , 0 ) ;
goto V_122;
}
...
if ( V_2 -> V_126 . V_127 & V_129 )
V_2 -> V_126 . V_127 &= ~ V_130 ;
if ( ! ( V_114 & V_120 ) )
V_2 -> V_126 . V_131 |= V_132 ;
F_79 ( V_117 , V_2 , V_133 | V_134 ) ;
F_80 ( V_117 , V_2 , V_135 ) ;
if ( V_17 -> V_54 & V_136 )
F_81 ( V_117 ) ;
error = F_82 ( V_117 , 0 ) ;
if ( error )
...
struct V_17 * V_17 )
{
if ( ! ( V_17 -> V_54 & V_141 ) && F_33 ( V_31 ) > V_142 )
return - V_143 ;
if ( F_23 ( F_85 ( V_31 -> V_144 ) ) )
return - V_33 ;
return 0 ;
}
STATIC int
...
int V_114 ;
int error ;
error = F_84 ( V_31 , V_17 ) ;
if ( error )
return error ;
V_114 = F_87 ( V_2 ) ;
if ( V_2 -> V_126 . V_145 > 0 )
F_88 ( NULL , V_2 , 0 , - 1 ) ;
F_6 ( V_2 , V_114 ) ;
return 0 ;
}
...
int error ;
T_2 V_149 ;
V_149 = ( T_2 ) F_92 ( T_1 , 32768 , V_2 -> V_126 . V_150 ) ;
error = F_93 ( V_2 , V_148 , V_149 ) ;
if ( error )
return - error ;
return 0 ;
}
...
unsigned V_175 ;
unsigned int V_176 ;
V_174 = F_92 ( T_10 , V_19 - V_170 , V_177 ) ;
V_175 = F_105 ( & V_169 , V_31 -> V_11 , V_170 ,
V_174 ) ;
if ( V_175 == 0 ) {
if ( type == V_163 )
break;
...
V_159 = F_98 ( V_7 , & V_179 , type ) ;
if ( V_159 ) {
* V_12 = F_109 ( T_1 , V_172 , V_179 ) ;
F_107 ( V_7 ) ;
goto V_106;
}
V_158 = F_99 ( V_7 ) + V_180 ;
F_107 ( V_7 ) ;
}
if ( V_175 < V_174 ) {
if ( type == V_164 ) {
...
! F_112 ( V_167 [ V_176 ] . V_85 ) ) )
goto V_106;
if ( V_167 [ V_176 ] . V_95 == V_96 ) {
if ( F_103 ( V_31 , & V_167 [ V_176 ] ,
V_163 , & V_12 ) )
goto V_106;
}
}
...
V_106:
V_12 = F_113 ( V_17 , V_12 , V_31 -> V_144 -> V_65 ) ;
V_122:
F_6 ( V_2 , V_183 ) ;
if ( error )
return - error ;
...
case V_193 :
return F_111 ( V_17 , V_12 ) ;
case V_194 :
return F_114 ( V_17 , V_12 ) ;
default:
return - V_63 ;
}
}
