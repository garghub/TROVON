...
{
struct V_1 * V_8 ;
if ( F_21 ( & V_6 -> V_33 ) != V_34 )
return;
V_8 = F_4 ( V_6 ) ;
if ( ! V_8 )
return;
F_10 ( V_6 , NULL ) ;
F_26 ( V_6 , V_35 , V_36 , NULL ) ;
F_1 ( V_8 ) ;
}
void F_27 ( struct V_5 * V_6 )
{
struct V_1 * V_8 = NULL , * V_37 = NULL ;
...
goto V_9;
V_8 = F_4 ( V_6 ) ;
if ( ! F_28 ( & V_6 -> V_7 . V_16 ) && V_8 )
goto V_9;
V_37 = F_17 ( V_6 ) ;
if ( V_8 == V_37 )
goto V_9;
if ( V_37 ) {
sprintf ( V_38 , L_1 , V_37 -> V_11 -> V_39 ) ;
V_18 = F_19 ( V_37 -> V_11 ,
V_28 ) ;
if ( ! V_18 ) {
F_15 ( V_6 ) ;
...
return V_85 ;
V_86 = (struct V_86 * ) V_82 -> V_96 ;
V_93 = V_86 -> V_97 ;
* V_83 += V_95 ;
if ( V_93 == F_54 ( V_98 ) ) {
if ( ! F_53 ( V_82 , * V_83 + V_99 ) )
return V_85 ;
V_91 = (struct V_90 * ) V_82 -> V_96 ;
V_93 = V_91 -> V_100 ;
* V_83 += V_99 ;
}
switch ( V_93 ) {
...
return V_85 ;
V_87 = (struct V_87 * ) ( V_82 -> V_96 + * V_83 ) ;
* V_83 += V_87 -> V_102 * 4 ;
if ( V_87 -> V_103 != V_104 )
return V_85 ;
break;
...
return V_85 ;
V_88 = (struct V_88 * ) ( V_82 -> V_96 + * V_83 ) ;
* V_83 += sizeof( * V_88 ) ;
if ( V_88 -> V_106 != V_104 )
return V_85 ;
break;
...
return V_85 ;
V_86 = (struct V_86 * ) V_82 -> V_96 ;
if ( F_55 ( V_86 -> V_97 ) == V_98 )
V_86 = (struct V_86 * ) ( V_82 -> V_96 + V_99 ) ;
V_89 = (struct V_89 * ) ( V_82 -> V_96 + * V_83 ) ;
* V_83 += sizeof( * V_89 ) ;
switch ( V_93 ) {
case F_54 ( V_101 ) :
if ( V_89 -> V_107 == F_54 ( 67 ) )
V_66 = V_108 ;
else if ( V_89 -> V_109 == F_54 ( 67 ) )
V_66 = V_110 ;
break;
case F_54 ( V_105 ) :
if ( V_89 -> V_107 == F_54 ( 547 ) )
V_66 = V_108 ;
else if ( V_89 -> V_109 == F_54 ( 547 ) )
V_66 = V_110 ;
break;
}
V_92 = * V_83 + V_111 ;
...
V_94 = V_82 -> V_96 + * V_83 + V_113 ;
if ( * V_94 != V_114 )
return V_85 ;
V_94 = V_82 -> V_96 + * V_83 + V_115 ;
if ( * V_94 != V_112 )
return V_85 ;
memcpy ( V_84 , V_82 -> V_96 + V_92 , V_112 ) ;
}
return V_66 ;
}
...
struct V_10 * V_118 = NULL ;
struct V_1 * V_2 = NULL , * V_8 = NULL ;
struct V_19 * V_119 , * V_120 ;
struct V_86 * V_86 = (struct V_86 * ) V_82 -> V_96 ;
bool V_121 = false ;
T_2 V_122 ;
unsigned short V_123 ;
V_123 = F_57 ( V_82 , 0 ) ;
V_118 = F_58 ( V_6 , V_86 -> V_124 ,
V_86 -> V_125 , V_123 ) ;
if ( ! V_118 )
goto V_9;
V_2 = F_37 ( V_6 , V_118 ) ;
...
V_117 = F_59 ( V_6 , V_118 , NULL ) ;
if ( ! V_117 )
goto V_9;
V_120 = F_20 ( V_117 , V_28 ) ;
if ( ! V_120 )
goto V_9;
