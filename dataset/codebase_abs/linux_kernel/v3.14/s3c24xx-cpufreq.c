...
struct V_37 * F_26 ( struct V_67 * V_68 , const char * V_69 )
{
struct V_37 * V_37 ;
V_37 = F_27 ( V_68 , V_69 ) ;
if ( F_28 ( V_37 ) )
...
{
V_39 -> V_37 = V_14 ;
return F_30 ( V_39 , V_59 , V_2 . V_29 -> V_70 ) ;
}
...
F_20 ( V_73 L_31 , V_49 ) ;
V_63 = ( V_2 . V_29 -> V_82 ) ( & V_2 , & V_4 ) ;
if ( V_63 )
F_20 ( V_47 L_32 , V_49 ) ;
return V_63 ;
}
static void F_39 ( struct V_83 * V_84 ,
struct V_83 * V_85 , struct V_83 * V_86 )
{
V_84 -> V_6 = F_40 ( V_85 -> V_6 , V_86 -> V_6 ) ;
V_84 -> V_8 = F_40 ( V_85 -> V_8 , V_86 -> V_8 ) ;
V_84 -> V_7 = F_40 ( V_85 -> V_7 , V_86 -> V_7 ) ;
V_84 -> V_9 = F_40 ( V_85 -> V_9 , V_86 -> V_9 ) ;
}
static inline T_2 F_41 ( T_2 V_10 , T_2 V_87 )
{
T_2 V_88 ;
V_88 = V_10 * V_87 ;
V_88 = F_42 ( V_88 , 1000 * 1000 ) ;
return V_88 ;
}
static void F_43 ( void )
{
unsigned int V_89 = V_2 . V_29 -> V_90 ;
T_2 V_91 = ( T_2 ) F_4 ( V_71 ) ;
T_2 V_92 ;
if ( V_89 == 0 ) {
F_44 ( 1 ) ;
return;
}
V_92 = F_41 ( V_91 , V_2 . V_29 -> V_93 ) << V_89 ;
V_92 |= F_41 ( V_91 , V_2 . V_29 -> V_94 ) ;
F_20 ( V_73 L_33 , V_49 , V_92 ) ;
F_45 ( V_92 , V_95 ) ;
}
...
F_47 ( V_59 ) ;
V_59 = NULL ;
V_96 = V_2 . V_29 -> V_97 ( & V_2 , NULL , 0 ) ;
V_96 ++ ;
V_59 = F_48 ( sizeof( * V_59 ) * V_96 , V_80 ) ;
if ( ! V_59 ) {
F_20 ( V_47 L_34 , V_49 ) ;
return - V_81 ;
}
V_98 = V_96 ;
V_63 = V_2 . V_29 -> V_97 ( & V_2 , V_59 , V_96 ) ;
F_49 ( V_59 , V_63 , V_96 , V_99 ) ;
return 0 ;
}
static int T_1 F_50 ( void )
{
int V_63 = 0 ;
if ( V_2 . V_29 && V_2 . V_78 ) {
V_63 = F_31 () ;
if ( V_63 )
goto V_100;
F_3 ( & V_2 ) ;
...
if ( V_2 . V_78 -> V_102 && ! V_2 . V_29 -> V_30 ) {
F_20 ( V_47 L_36 ,
V_49 ) ;
V_63 = - V_55 ;
goto V_100;
...
int T_1 F_52 ( struct V_41 * V_105 ,
unsigned int V_106 )
{
struct V_41 * V_107 ;
unsigned int V_96 ;
V_96 = sizeof( * V_107 ) * ( V_106 + 1 ) ;
V_107 = F_48 ( V_96 , V_80 ) ;
if ( V_107 ) {
memcpy ( V_107 , V_105 , V_96 ) ;
V_60 = V_107 ;
V_107 += V_106 ;
V_107 -> V_18 = V_99 ;
F_20 ( V_73 L_37 , V_106 ) ;
} else
F_20 ( V_47 L_38 ) ;
return V_107 ? 0 : - V_81 ;
}
