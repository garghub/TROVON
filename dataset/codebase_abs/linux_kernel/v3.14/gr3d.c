...
V_1 -> V_34 = F_25 ( & V_26 -> V_12 , L_2 ) ;
if ( F_22 ( V_1 -> V_34 ) ) {
F_23 ( & V_26 -> V_12 , L_3 ) ;
return F_24 ( V_1 -> V_34 ) ;
}
if ( F_26 ( V_28 , L_4 ) ) {
V_1 -> V_35 = F_21 ( & V_26 -> V_12 , L_5 ) ;
if ( F_22 ( V_1 -> V_33 ) ) {
F_23 ( & V_26 -> V_12 , L_6 ) ;
return F_24 ( V_1 -> V_33 ) ;
}
V_1 -> V_36 = F_25 ( & V_26 -> V_12 ,
L_5 ) ;
if ( F_22 ( V_1 -> V_36 ) ) {
F_23 ( & V_26 -> V_12 , L_7 ) ;
return F_24 ( V_1 -> V_36 ) ;
}
}
V_15 = F_27 ( V_37 , V_1 -> V_33 ,
V_1 -> V_34 ) ;
if ( V_15 < 0 ) {
F_23 ( & V_26 -> V_12 , L_8 ) ;
return V_15 ;
...
F_28 ( & V_1 -> V_3 . V_39 . V_40 ) ;
V_1 -> V_3 . V_39 . V_41 = & V_42 ;
V_1 -> V_3 . V_39 . V_12 = & V_26 -> V_12 ;
V_1 -> V_3 . V_39 . V_19 = V_22 ;
V_1 -> V_3 . V_39 . V_14 = V_14 ;
V_1 -> V_3 . V_39 . V_43 = 1 ;
F_28 ( & V_1 -> V_3 . V_40 ) ;
V_1 -> V_3 . V_41 = & V_44 ;
V_15 = F_29 ( & V_1 -> V_3 . V_39 ) ;
if ( V_15 < 0 ) {
F_23 ( & V_26 -> V_12 , L_10 ,
V_15 ) ;
return V_15 ;
}
for ( V_31 = 0 ; V_31 < F_30 ( V_45 ) ; V_31 ++ )
F_31 ( V_45 [ V_31 ] , V_1 -> V_24 ) ;
F_32 ( V_26 , V_1 ) ;
return 0 ;
}
static int F_33 ( struct V_25 * V_26 )
{
struct V_1 * V_1 = F_34 ( V_26 ) ;
int V_15 ;
V_15 = F_35 ( & V_1 -> V_3 . V_39 ) ;
if ( V_15 < 0 ) {
F_23 ( & V_26 -> V_12 , L_11 ,
V_15 ) ;
return V_15 ;
