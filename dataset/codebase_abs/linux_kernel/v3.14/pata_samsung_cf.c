...
{
struct V_105 * V_106 = F_46 ( & V_114 -> V_78 ) ;
...
enum V_117 V_107 ;
int V_118 ;
V_107 = F_47 ( V_114 ) -> V_119 ;
V_10 = F_48 ( V_78 , sizeof( * V_10 ) , V_120 ) ;
if ( ! V_10 ) {
F_27 ( V_78 , L_3 ) ;
return - V_121 ;
}
V_10 -> V_102 = F_49 ( V_114 , 0 ) ;
V_116 = F_50 ( V_114 , V_122 , 0 ) ;
V_10 -> V_29 = F_51 ( V_78 , V_116 ) ;
if ( F_52 ( V_10 -> V_29 ) )
return F_53 ( V_10 -> V_29 ) ;
V_10 -> V_31 = F_54 ( & V_114 -> V_78 , L_4 ) ;
if ( F_52 ( V_10 -> V_31 ) ) {
F_27 ( V_78 , L_5 ) ;
V_118 = F_53 ( V_10 -> V_31 ) ;
V_10 -> V_31 = NULL ;
return V_118 ;
}
F_55 ( V_10 -> V_31 ) ;
...
V_21 -> V_46 . V_131 = V_10 -> V_29 + V_132 ;
V_21 -> V_46 . V_83 = V_10 -> V_29 + V_133 ;
V_21 -> V_46 . V_72 = V_10 -> V_29 + V_134 ;
V_21 -> V_46 . V_55 = V_10 -> V_29 + V_134 ;
V_21 -> V_46 . V_57 = V_10 -> V_29 + V_135 ;
V_21 -> V_46 . V_59 = V_10 -> V_29 + V_136 ;
V_21 -> V_46 . V_61 = V_10 -> V_29 + V_137 ;
V_21 -> V_46 . V_63 = V_10 -> V_29 + V_138 ;
V_21 -> V_46 . V_71 = V_10 -> V_29 + V_139 ;
V_21 -> V_46 . V_76 = V_10 -> V_29 + V_140 ;
V_21 -> V_46 . V_75 = V_10 -> V_29 + V_140 ;
V_21 -> V_46 . V_77 = V_10 -> V_29 + V_141 ;
V_21 -> V_46 . V_52 = V_10 -> V_29 + V_141 ;
F_57 ( V_21 , L_8 ,
( unsigned long long ) V_116 -> V_142 ) ;
V_24 -> V_25 = V_10 ;
if ( V_106 && V_106 -> V_143 )
V_106 -> V_143 () ;
F_42 ( V_10 , V_106 ) ;
F_58 ( V_114 , V_24 ) ;
return F_59 ( V_24 , V_10 -> V_102 ,
...
static int T_8 F_61 ( struct V_113 * V_114 )
{
struct V_39 * V_24 = F_62 ( V_114 ) ;
struct V_9 * V_10 = V_24 -> V_25 ;
F_63 ( V_24 ) ;
F_60 ( V_10 -> V_31 ) ;
return 0 ;
...
{
struct V_113 * V_114 = F_65 ( V_78 ) ;
struct V_39 * V_24 = F_62 ( V_114 ) ;
return F_66 ( V_24 , V_145 ) ;
}
