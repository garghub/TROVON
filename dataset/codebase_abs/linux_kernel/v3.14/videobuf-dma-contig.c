...
F_4 ( V_13 -> V_15 -> V_2 , L_3 ,
V_13 , V_13 -> V_16 , V_11 -> V_17 , V_11 -> V_18 ) ;
V_13 -> V_16 ++ ;
}
static void F_8 ( struct V_10 * V_11 )
{
struct V_12 * V_13 = V_11 -> V_14 ;
struct V_19 * V_15 = V_13 -> V_15 ;
int V_20 ;
F_4 ( V_15 -> V_2 , L_4 ,
V_13 , V_13 -> V_16 , V_11 -> V_17 , V_11 -> V_18 ) ;
V_13 -> V_16 -- ;
if ( 0 == V_13 -> V_16 ) {
struct V_3 * V_4 ;
F_4 ( V_15 -> V_2 , L_5 , V_13 , V_15 ) ;
F_9 ( V_15 ) ;
if ( V_15 -> V_21 )
F_10 ( V_15 ) ;
for ( V_20 = 0 ; V_20 < V_22 ; V_20 ++ ) {
if ( NULL == V_15 -> V_23 [ V_20 ] )
continue;
if ( V_15 -> V_23 [ V_20 ] -> V_13 != V_13 )
continue;
V_4 = V_15 -> V_23 [ V_20 ] -> V_24 ;
if ( V_4 ) {
F_11 ( V_4 -> V_25 , V_26 ) ;
F_4 ( V_15 -> V_2 , L_6 ,
V_20 , V_4 -> V_7 ) ;
...
V_15 -> V_23 [ V_20 ] -> V_13 = NULL ;
V_15 -> V_23 [ V_20 ] -> V_27 = 0 ;
}
F_12 ( V_13 ) ;
F_13 ( V_15 ) ;
}
...
if ( ! V_11 )
goto V_42;
if ( ( V_29 -> V_27 + V_4 -> V_5 ) > V_11 -> V_18 )
goto V_42;
V_35 = 0 ;
V_33 = 0 ;
V_36 = V_29 -> V_27 ;
...
static int F_25 ( struct V_19 * V_15 ,
struct V_28 * V_29 ,
struct V_48 * V_49 )
{
...
break;
case V_53 :
F_4 ( V_15 -> V_2 , L_9 , V_52 ) ;
if ( V_29 -> V_27 )
return F_15 ( V_4 , V_29 ) ;
if ( F_1 ( V_15 -> V_2 , V_4 , F_16 ( V_29 -> V_5 ) ,
V_46 ) )
return - V_9 ;
break;
case V_54 :
default:
F_4 ( V_15 -> V_2 , L_10 , V_52 ) ;
return - V_40 ;
}
return 0 ;
}
static int F_26 ( struct V_19 * V_15 ,
struct V_28 * V_47 ,
struct V_10 * V_11 )
{
struct V_3 * V_4 ;
...
F_24 ( ! V_4 ) ;
F_11 ( V_4 -> V_25 , V_26 ) ;
if ( F_1 ( V_15 -> V_2 , V_4 , F_16 ( V_47 -> V_56 ) ,
V_46 | V_57 ) )
goto error;
V_5 = V_11 -> V_18 - V_11 -> V_17 ;
V_11 -> V_58 = F_27 ( V_11 -> V_58 ) ;
V_55 = F_28 ( V_11 , V_11 -> V_17 , V_5 ) ;
if ( V_55 ) {
F_3 ( V_15 -> V_2 , L_12 ,
V_55 ) ;
...
struct V_71 * V_72 )
{
F_30 ( V_15 , V_65 , V_2 , V_66 , type , V_69 , V_70 ,
V_24 , & V_73 , V_72 ) ;
}
