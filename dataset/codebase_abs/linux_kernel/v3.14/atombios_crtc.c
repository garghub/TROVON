...
if ( V_9 -> V_69 >= V_343 ) {
unsigned V_344 , V_12 , V_345 , V_346 ;
V_346 = 64 << V_323 ;
V_344 = 8 * 8 * V_311 -> V_332 / 8 ;
V_344 = F_70 ( V_346 , V_344 ) ;
for ( V_12 = 0 ; V_344 > 64 ; V_12 ++ ) {
V_344 >>= 1 ;
}
if ( V_12 >= 16 ) {
F_44 ( L_4 ,
...
if ( V_9 -> V_69 >= V_347 )
V_345 = ( V_9 -> V_348 . V_349 . V_350 [ V_12 ] >> 6 ) & 0x3 ;
else
V_345 = ( V_9 -> V_348 . V_351 . V_352 [ V_12 ] >> 20 ) & 0x3 ;
V_317 |= F_71 ( V_345 ) ;
} else {
if ( V_9 -> V_69 >= V_353 )
V_326 = V_9 -> V_348 . V_354 . V_355 ;
else
V_326 = V_9 -> V_348 . V_356 . V_355 ;
switch ( ( V_326 & 0xf0 ) >> 4 ) {
case 0 :
V_317 |= F_71 ( V_357 ) ;
break;
...
V_317 |= F_72 ( V_363 ) ;
if ( V_9 -> V_69 >= V_347 ) {
T_5 V_364 = ( V_9 -> V_348 . V_349 . V_352 [ 10 ] >> 6 ) & 0x1f ;
V_317 |= F_78 ( V_364 ) ;
} else if ( ( V_9 -> V_69 == V_343 ) ||
( V_9 -> V_69 == V_365 ) )
V_317 |= F_79 ( V_366 ) ;
else if ( ( V_9 -> V_69 == V_367 ) ||
( V_9 -> V_69 == V_368 ) ||
( V_9 -> V_69 == V_369 ) )
V_317 |= F_79 ( V_370 ) ;
switch ( V_11 -> V_18 ) {
...
F_16 ( V_377 + V_11 -> V_378 ,
F_80 ( V_316 ) ) ;
F_16 ( V_379 + V_11 -> V_378 ,
F_80 ( V_316 ) ) ;
F_16 ( V_380 + V_11 -> V_378 ,
( T_5 ) V_316 & V_381 ) ;
F_16 ( V_382 + V_11 -> V_378 ,
( T_5 ) V_316 & V_381 ) ;
F_16 ( V_383 + V_11 -> V_378 , V_317 ) ;
F_16 ( V_384 + V_11 -> V_378 , V_324 ) ;
F_16 ( V_385 + V_11 -> V_378 , 0 ) ;
F_16 ( V_386 + V_11 -> V_378 , 0 ) ;
F_16 ( V_387 + V_11 -> V_378 , 0 ) ;
F_16 ( V_388 + V_11 -> V_378 , 0 ) ;
F_16 ( V_389 + V_11 -> V_378 , V_311 -> V_390 ) ;
F_16 ( V_391 + V_11 -> V_378 , V_311 -> V_392 ) ;
V_318 = V_311 -> V_393 [ 0 ] / ( V_311 -> V_332 / 8 ) ;
F_16 ( V_394 + V_11 -> V_378 , V_318 ) ;
F_16 ( V_395 + V_11 -> V_378 , 1 ) ;
if ( V_9 -> V_69 >= V_347 )
F_16 ( V_396 + V_11 -> V_378 ,
V_311 -> V_392 ) ;
else
F_16 ( V_397 + V_11 -> V_378 ,
V_311 -> V_392 ) ;
V_306 &= ~ 3 ;
V_307 &= ~ 1 ;
F_16 ( V_398 + V_11 -> V_378 ,
( V_306 << 16 ) | V_307 ) ;
V_327 = V_2 -> V_4 . V_399 ;
V_328 = ( V_2 -> V_4 . V_400 + 1 ) & ~ 1 ;
F_16 ( V_401 + V_11 -> V_378 ,
( V_327 << 16 ) | V_328 ) ;
V_326 = F_15 ( V_402 + V_11 -> V_378 ) ;
V_326 &= ~ V_403 ;
F_16 ( V_402 + V_11 -> V_378 , V_326 ) ;
F_16 ( V_404 + V_11 -> V_378 , 0 ) ;
if ( ! V_308 && V_305 && V_305 != V_2 -> V_305 ) {
V_310 = F_58 ( V_305 ) ;
...
if ( V_9 -> V_69 >= V_196 ) {
if ( V_11 -> V_18 ) {
F_16 ( V_420 , F_80 ( V_316 ) ) ;
F_16 ( V_421 , F_80 ( V_316 ) ) ;
} else {
F_16 ( V_422 , F_80 ( V_316 ) ) ;
F_16 ( V_423 , F_80 ( V_316 ) ) ;
}
}
F_16 ( V_424 + V_11 -> V_378 ,
( T_5 ) V_316 ) ;
F_16 ( V_425 +
V_11 -> V_378 , ( T_5 ) V_316 ) ;
F_16 ( V_426 + V_11 -> V_378 , V_317 ) ;
if ( V_9 -> V_69 >= V_415 )
F_16 ( V_427 + V_11 -> V_378 , V_324 ) ;
F_16 ( V_428 + V_11 -> V_378 , 0 ) ;
F_16 ( V_429 + V_11 -> V_378 , 0 ) ;
F_16 ( V_430 + V_11 -> V_378 , 0 ) ;
F_16 ( V_431 + V_11 -> V_378 , 0 ) ;
F_16 ( V_432 + V_11 -> V_378 , V_311 -> V_390 ) ;
F_16 ( V_433 + V_11 -> V_378 , V_311 -> V_392 ) ;
V_318 = V_311 -> V_393 [ 0 ] / ( V_311 -> V_332 / 8 ) ;
F_16 ( V_434 + V_11 -> V_378 , V_318 ) ;
F_16 ( V_435 + V_11 -> V_378 , 1 ) ;
F_16 ( V_436 + V_11 -> V_378 ,
V_311 -> V_392 ) ;
V_306 &= ~ 3 ;
V_307 &= ~ 1 ;
F_16 ( V_437 + V_11 -> V_378 ,
( V_306 << 16 ) | V_307 ) ;
V_327 = V_2 -> V_4 . V_399 ;
V_328 = ( V_2 -> V_4 . V_400 + 1 ) & ~ 1 ;
F_16 ( V_438 + V_11 -> V_378 ,
( V_327 << 16 ) | V_328 ) ;
V_326 = F_15 ( V_439 + V_11 -> V_378 ) ;
V_326 &= ~ V_440 ;
F_16 ( V_439 + V_11 -> V_378 , V_326 ) ;
F_16 ( V_441 + V_11 -> V_378 , 0 ) ;
if ( ! V_308 && V_305 && V_305 != V_2 -> V_305 ) {
V_310 = F_58 ( V_305 ) ;
V_315 = F_59 ( V_310 -> V_313 ) ;
V_329 = F_60 ( V_315 , false ) ;
...
struct V_8 * V_9 = V_7 -> V_10 ;
if ( F_28 ( V_9 ) )
return F_55 ( V_2 , V_442 , V_306 , V_307 , 0 ) ;
else if ( F_8 ( V_9 ) )
return F_83 ( V_2 , V_442 , V_306 , V_307 , 0 ) ;
else
return F_85 ( V_2 , V_442 , V_306 , V_307 , 0 ) ;
}
int F_86 ( struct V_1 * V_2 ,
struct V_304 * V_305 ,
int V_306 , int V_307 , enum V_443 V_74 )
{
struct V_6 * V_7 = V_2 -> V_7 ;
struct V_8 * V_9 = V_7 -> V_10 ;
if ( F_28 ( V_9 ) )
...
V_444 &= ~ V_448 ;
F_16 ( V_447 , V_444 ) ;
F_16 ( V_449 , F_15 ( V_450 ) ) ;
F_16 ( V_451 , F_15 ( V_452 ) ) ;
break;
}
}
...
if ( V_454 -> V_36 &&
! F_42 ( F_33 ( V_454 -> V_36 ) ) ) {
if ( V_454 -> V_183 == V_11 -> V_183 ) {
if ( V_454 -> V_134 != V_142 )
return V_454 -> V_134 ;
}
V_456 = V_454 -> V_184 ;
if ( ( V_2 -> V_4 . clock == V_453 -> V_4 . clock ) &&
( V_184 == V_456 ) &&
( V_11 -> V_210 == V_454 -> V_210 ) &&
( V_454 -> V_134 != V_142 ) )
return V_454 -> V_134 ;
}
}
...
struct V_3 * V_4 ,
struct V_3 * V_5 ,
int V_306 , int V_307 , struct V_304 * V_442 )
{
struct V_11 * V_11 = F_2 ( V_2 ) ;
struct V_6 * V_7 = V_2 -> V_7 ;
struct V_8 * V_9 = V_7 -> V_10 ;
...
if ( F_28 ( V_9 ) )
F_16 ( V_395 + V_11 -> V_378 , 0 ) ;
else if ( F_8 ( V_9 ) )
F_16 ( V_435 + V_11 -> V_378 , 0 ) ;
if ( F_21 ( V_9 ) )
F_17 ( V_2 , V_85 ) ;
for ( V_148 = 0 ; V_148 < V_9 -> V_153 ; V_148 ++ ) {
if ( V_9 -> V_31 . V_154 [ V_148 ] &&
