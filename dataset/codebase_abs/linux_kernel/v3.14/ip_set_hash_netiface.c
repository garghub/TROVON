...
if ( V_46 -> V_60 & V_33 ) {
#ifdef F_31
const struct V_61 * V_62 = V_31 -> V_62 ;
if ( ! V_62 )
return - V_57 ;
V_51 . V_7 = F_30 ? F_29 ( V_63 ) : F_29 ( V_64 ) ;
V_51 . V_24 = 1 ;
#else
V_51 . V_7 = NULL ;
#endif
} else
V_51 . V_7 = F_30 ? F_28 ( V_65 ) : F_28 ( V_66 ) ;
if ( ! V_51 . V_7 )
return - V_57 ;
V_56 = F_4 ( & V_48 -> V_67 , & V_51 . V_7 ) ;
if ( V_44 == V_68 ) {
if ( ! V_56 ) {
V_56 = F_6 ( & V_48 -> V_67 , & V_51 . V_7 ) ;
if ( V_56 )
return V_56 ;
}
} else if ( ! V_56 )
...
enum V_43 V_44 , T_1 * V_71 , T_1 V_28 , bool V_72 )
{
struct V_47 * V_48 = V_40 -> V_32 ;
T_3 V_49 = V_40 -> V_50 -> V_44 [ V_44 ] ;
...
if ( V_70 [ V_80 ] )
* V_71 = F_36 ( V_70 [ V_80 ] ) ;
V_56 = F_37 ( V_70 [ V_34 ] , & V_22 ) ||
F_38 ( V_40 , V_70 , & V_55 ) ;
if ( V_56 )
return V_56 ;
if ( V_70 [ V_35 ] ) {
V_51 . V_23 = F_39 ( V_70 [ V_35 ] ) ;
if ( V_51 . V_23 > V_53 )
return - V_81 ;
}
strcpy ( V_7 , F_40 ( V_70 [ V_36 ] ) ) ;
V_51 . V_7 = V_7 ;
V_56 = F_4 ( & V_48 -> V_67 , & V_51 . V_7 ) ;
if ( V_44 == V_68 ) {
if ( ! V_56 ) {
...
F_45 ( V_22 , V_73 , V_51 . V_23 ) ;
if ( V_72 )
V_22 = F_46 ( V_48 -> V_5 . V_22 ) ;
while ( ! F_47 ( V_22 , V_73 ) ) {
V_51 . V_22 = F_22 ( V_22 ) ;
V_74 = F_48 ( V_22 , V_73 , & V_51 . V_23 ) ;
V_56 = V_49 ( V_40 , & V_51 , & V_55 , & V_55 , V_28 ) ;
...
static inline bool
F_49 ( const struct V_86 * V_19 ,
const struct V_86 * V_20 ,
T_1 * V_21 )
{
return F_50 ( & V_19 -> V_22 . V_87 , & V_20 -> V_22 . V_87 ) &&
V_19 -> V_23 == V_20 -> V_23 &&
( ++ * V_21 ) &&
V_19 -> V_24 == V_20 -> V_24 &&
V_19 -> V_7 == V_20 -> V_7 ;
...
static inline int
F_51 ( const struct V_86 * V_25 )
{
return V_25 -> V_26 ? - V_27 : 1 ;
}
static inline void
F_52 ( struct V_86 * V_25 , T_1 V_28 )
{
V_25 -> V_26 = ( V_28 >> 16 ) & V_29 ;
}
static inline void
F_53 ( struct V_86 * V_25 , T_2 * V_28 )
{
F_14 ( * V_28 , V_25 -> V_26 ) ;
}
static inline void
F_54 ( struct V_86 * V_25 , T_2 V_23 )
{
F_55 ( & V_25 -> V_22 , V_23 ) ;
V_25 -> V_23 = V_23 ;
}
...
const struct V_86 * V_32 )
{
T_1 V_28 = V_32 -> V_24 ? V_33 : 0 ;
if ( V_32 -> V_26 )
V_28 |= V_29 ;
if ( F_57 ( V_31 , V_34 , & V_32 -> V_22 . V_87 ) ||
F_19 ( V_31 , V_35 , V_32 -> V_23 ) ||
F_20 ( V_31 , V_36 , V_32 -> V_7 ) ||
( V_28 &&
F_21 ( V_31 , V_37 , F_22 ( V_28 ) ) ) )
...
if ( V_44 == V_58 )
V_51 . V_23 = V_53 ;
F_60 ( V_31 , V_46 -> V_28 & V_59 , & V_51 . V_22 . V_87 ) ;
...
struct V_47 * V_48 = V_40 -> V_32 ;
T_3 V_49 = V_40 -> V_50 -> V_44 [ V_44 ] ;
struct V_86 V_51 = { . V_23 = V_53 , . V_25 = 1 } ;
struct V_54 V_55 = F_33 ( V_40 ) ;
char V_7 [ V_75 ] ;
int V_56 ;
if ( F_34 ( ! V_70 [ V_34 ] ||
