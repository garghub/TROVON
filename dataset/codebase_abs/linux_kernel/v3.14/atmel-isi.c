...
struct V_211 * V_9 ;
int V_61 , V_212 ;
struct V_213 * V_208 = & V_207 -> V_208 ;
struct V_83 * V_105 ;
struct V_214 * V_107 ;
V_107 = V_208 -> V_215 ;
if ( ! V_107 || ! V_107 -> V_216 ) {
F_31 ( & V_207 -> V_208 ,
L_23 ) ;
return - V_26 ;
}
V_6 = F_79 ( & V_207 -> V_208 , sizeof( struct V_5 ) , V_217 ) ;
if ( ! V_6 ) {
F_31 ( & V_207 -> V_208 , L_24 ) ;
return - V_218 ;
}
V_6 -> V_176 = F_80 ( & V_207 -> V_208 , L_25 ) ;
if ( F_67 ( V_6 -> V_176 ) )
...
F_28 ( & V_6 -> V_45 ) ;
F_28 ( & V_6 -> V_95 ) ;
V_6 -> V_177 = F_80 ( V_208 , L_26 ) ;
if ( ! F_67 ( V_6 -> V_177 ) ) {
V_61 = F_83 ( V_6 -> V_177 , V_107 -> V_219 ) ;
if ( V_61 < 0 )
return V_61 ;
}
V_6 -> V_209 = F_84 ( & V_207 -> V_208 ,
sizeof( struct V_1 ) * V_89 ,
& V_6 -> V_210 ,
V_217 ) ;
if ( ! V_6 -> V_209 ) {
...
for ( V_212 = 0 ; V_212 < V_89 ; V_212 ++ ) {
V_6 -> V_220 [ V_212 ] . V_96 = V_6 -> V_209 + V_212 ;
V_6 -> V_220 [ V_212 ] . V_49 = V_6 -> V_210 +
V_212 * sizeof( struct V_1 ) ;
F_35 ( & V_6 -> V_220 [ V_212 ] . V_40 , & V_6 -> V_95 ) ;
}
V_6 -> V_91 = F_85 ( & V_207 -> V_208 ) ;
if ( F_67 ( V_6 -> V_91 ) ) {
V_61 = F_81 ( V_6 -> V_91 ) ;
goto V_221;
}
V_9 = F_86 ( V_207 , V_222 , 0 ) ;
V_6 -> V_9 = F_87 ( & V_207 -> V_208 , V_9 ) ;
if ( F_67 ( V_6 -> V_9 ) ) {
V_61 = F_81 ( V_6 -> V_9 ) ;
goto V_223;
}
if ( V_107 -> V_216 & V_224 )
V_6 -> V_168 = 1 << 7 ;
if ( V_107 -> V_216 & V_225 )
V_6 -> V_168 |= 1 << 9 ;
F_2 ( V_6 , V_27 , V_28 ) ;
V_56 = F_88 ( V_207 , 0 ) ;
if ( F_89 ( V_56 ) ) {
...
V_61 = F_90 ( & V_207 -> V_208 , V_56 , F_13 , 0 , L_28 , V_6 ) ;
if ( V_61 ) {
F_31 ( & V_207 -> V_208 , L_29 , V_56 ) ;
goto V_226;
}
V_6 -> V_56 = V_56 ;
V_105 = & V_6 -> V_105 ;
...
V_105 -> V_127 = & V_228 ;
V_105 -> V_86 = V_6 ;
V_105 -> V_229 . V_208 = & V_207 -> V_208 ;
V_105 -> V_230 = V_207 -> V_231 ;
V_61 = F_91 ( V_105 ) ;
if ( V_61 ) {
F_31 ( & V_207 -> V_208 , L_31 ) ;
goto V_232;
}
return 0 ;
V_232:
