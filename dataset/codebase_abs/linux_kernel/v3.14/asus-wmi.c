...
V_107 = F_70 ( V_2 -> V_93 , V_85 , 0 , L_21 ) ;
if ( V_107 ) {
F_50 ( L_22 , V_107 ) ;
goto V_117;
}
...
if ( V_68 && V_68 != - V_42 )
goto exit;
V_68 = F_74 ( V_2 , & V_2 -> V_129 , L_27 ,
V_136 , V_137 ) ;
if ( V_68 && V_68 != - V_42 )
goto exit;
V_68 = F_74 ( V_2 , & V_2 -> V_130 , L_28 ,
V_138 , V_139 ) ;
if ( V_68 && V_68 != - V_42 )
goto exit;
V_68 = F_74 ( V_2 , & V_2 -> V_131 , L_29 ,
V_140 , V_141 ) ;
if ( V_68 && V_68 != - V_42 )
goto exit;
V_68 = F_74 ( V_2 , & V_2 -> V_132 , L_30 ,
V_142 , V_143 ) ;
if ( V_68 && V_68 != - V_42 )
goto exit;
...
{
int V_39 , V_74 ;
if ( ! V_198 || sscanf ( V_148 , L_38 , & V_39 ) != 1 )
return - V_127 ;
if ( V_39 < 0 || V_39 > 2 )
return - V_127 ;
...
if ( V_3 < 0 )
return V_3 ;
F_127 ( V_219 , L_42 , V_2 -> V_220 . V_43 , V_25 ) ;
return 0 ;
}
...
if ( V_3 < 0 )
return V_3 ;
F_127 ( V_219 , L_43 , V_2 -> V_220 . V_43 ,
V_2 -> V_220 . V_45 , V_25 ) ;
return 0 ;
}
...
F_127 ( V_219 , L_45 , V_2 -> V_220 . V_22 ,
V_2 -> V_220 . V_43 , V_2 -> V_220 . V_45 ,
V_34 ? V_34 -> type : - 1 ) ;
F_13 ( V_34 ) ;
return 0 ;
...
static int F_147 ( struct V_16 * V_145 )
{
struct V_1 * V_2 ;
V_2 = F_91 ( V_145 ) ;
F_146 ( V_2 -> V_7 -> V_248 ) ;
...
static int F_148 ( struct V_145 * V_145 )
{
...
V_252 = ! F_17 ( V_2 ,
V_135 ) ;
F_46 ( V_2 -> V_128 . V_92 , V_252 ) ;
}
if ( V_2 -> V_129 . V_92 ) {
V_252 = ! F_17 ( V_2 , V_137 ) ;
F_46 ( V_2 -> V_129 . V_92 , V_252 ) ;
}
if ( V_2 -> V_130 . V_92 ) {
V_252 = ! F_17 ( V_2 , V_139 ) ;
F_46 ( V_2 -> V_130 . V_92 , V_252 ) ;
}
if ( V_2 -> V_131 . V_92 ) {
V_252 = ! F_17 ( V_2 , V_141 ) ;
F_46 ( V_2 -> V_131 . V_92 , V_252 ) ;
}
if ( V_2 -> V_132 . V_92 ) {
V_252 = ! F_17 ( V_2 , V_143 ) ;
F_46 ( V_2 -> V_132 . V_92 , V_252 ) ;
}
return 0 ;
}
static int F_150 ( struct V_16 * V_155 )
{
struct V_236 * V_237 = F_140 ( V_155 -> V_14 . V_7 ) ;
struct V_238 * V_239 = F_141 ( V_237 ) ;
int V_107 ;
...
if ( V_239 -> V_248 && ! F_151 ( V_239 -> V_248 ) ) {
F_48 ( L_55 ) ;
return - V_42 ;
}
if ( V_239 -> V_253 ) {
V_107 = V_239 -> V_253 ( V_155 ) ;
if ( V_107 )
return V_107 ;
}
return F_139 ( V_155 ) ;
}
int T_8 F_152 ( struct V_238 * V_7 )
{
struct V_236 * V_236 ;
struct V_16 * V_16 ;
if ( V_254 )
...
V_236 = & V_7 -> V_236 ;
V_236 -> remove = F_147 ;
V_236 -> V_7 . V_255 = V_7 -> V_255 ;
V_236 -> V_7 . V_6 = V_7 -> V_6 ;
V_236 -> V_7 . V_256 = & V_257 ;
V_16 = F_153 ( V_236 ,
F_150 ,
NULL , 0 , NULL , 0 ) ;
if ( F_94 ( V_16 ) )
