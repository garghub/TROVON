...
struct V_664 * V_665 = V_663 -> V_666 ;
int V_565 ;
T_4 V_186 = V_759 -> V_760 -> V_186 ;
T_2 V_761 ;
T_2 V_762 ;
V_565 = F_276 ( V_611 , V_186 , & V_762 ) ;
if ( V_565 )
return V_565 ;
V_565 = F_280 ( V_665 -> V_15 , V_762 , & V_761 ) ;
if ( V_565 )
return V_565 ;
V_759 -> V_517 = V_761 ;
V_759 -> V_753 = V_762 ;
...
{
return F_62 ( V_456 , V_889 , V_517 , V_13 ) ;
}
