...
{
struct V_191 V_61 = { V_188 , V_159 } ;
return F_129 ( V_33 , & V_61 , 1 ) ;
}
...
T_12 V_192 , V_193 ;
int V_194 ;
V_194 = V_33 -> V_40 % V_33 -> V_34 ;
V_37 = V_33 -> V_37 -> V_111 + V_194 ;
if ( V_182 == 1 ) {
if ( F_109 ( V_61 [ 0 ] . V_195 , & V_37 -> V_195 ) ) {
F_121 ( V_33 , L_25 ) ;
return - V_117 ;
}
if ( F_109 ( V_61 [ 0 ] . V_159 , & V_37 -> V_159 ) ) {
F_121 ( V_33 , L_26 ) ;
return - V_117 ;
}
} else if ( F_131 ( V_37 , V_61 , V_182 * sizeof *V_37 ) ) {
F_121 ( V_33 , L_27 ) ;
return - V_117 ;
}
if ( F_110 ( V_33 -> V_44 ) ) {
...
V_192 = V_33 -> V_40 ;
V_193 = ( V_33 -> V_40 += V_182 ) ;
if ( F_110 ( ( T_12 ) ( V_193 - V_33 -> V_41 ) < ( T_12 ) ( V_193 - V_192 ) ) )
V_33 -> V_42 = false ;
return 0 ;
}
int F_129 ( struct V_32 * V_33 , struct V_191 * V_61 ,
unsigned V_182 )
{
int V_194 , V_190 , V_136 ;
V_194 = V_33 -> V_40 % V_33 -> V_34 ;
V_190 = V_33 -> V_34 - V_194 ;
if ( V_190 < V_182 ) {
V_136 = F_130 ( V_33 , V_61 , V_190 ) ;
if ( V_136 < 0 )
return V_136 ;
V_61 += V_190 ;
V_182 -= V_190 ;
}
V_136 = F_130 ( V_33 , V_61 , V_182 ) ;
F_104 () ;
...
return F_136 ( V_196 , V_193 , V_192 ) ;
}
