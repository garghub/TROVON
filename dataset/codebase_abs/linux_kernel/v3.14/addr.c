...
T_4 V_159 , unsigned long V_186 )
{
F_16 ( 1 ) ;
return - V_173 ;
}
static int F_121 ( struct V_187 * V_188 , struct V_189 * V_190 )
{
struct V_6 * V_6 = F_28 ( V_188 -> V_191 ) ;
struct V_7 * V_8 = F_9 ( V_6 ) ;
struct V_192 * V_193 = V_188 -> V_191 -> V_194 ;
T_4 V_63 = V_190 -> V_195 << V_66 ;
int V_148 , V_196 , V_10 ;
F_7 ( L_62 ,
V_6 , F_122 ( V_6 ) , V_63 , ( V_197 ) V_23 ) ;
...
while ( 1 ) {
V_196 = 0 ;
V_10 = F_123 ( V_8 , V_200 , V_148 , & V_196 , - 1 ) ;
if ( V_10 == 0 )
break;
if ( V_10 != - V_169 ) {
F_16 ( 1 ) ;
...
F_7 ( L_63 ,
V_6 , V_63 , ( V_197 ) V_23 , F_124 ( V_196 ) ) ;
V_10 = F_125 ( V_188 , V_190 ) ;
F_7 ( L_64 ,
V_6 , V_63 , ( V_197 ) V_23 , F_124 ( V_196 ) , V_10 ) ;
F_126 ( V_8 , V_196 ) ;
return V_10 ;
}
static int F_127 ( struct V_187 * V_188 , struct V_189 * V_190 )
{
struct V_6 * V_6 = F_28 ( V_188 -> V_191 ) ;
struct V_7 * V_8 = F_9 ( V_6 ) ;
struct V_192 * V_193 = V_188 -> V_191 -> V_194 ;
struct V_160 * V_161 = F_29 ( V_6 ) -> V_161 ;
struct V_2 * V_2 = V_190 -> V_2 ;
T_4 V_63 = F_33 ( V_2 ) ;
T_4 V_85 = F_71 ( V_6 ) ;
V_197 V_31 ;
int V_148 , V_196 , V_10 ;
...
while ( 1 ) {
V_196 = 0 ;
V_10 = F_123 ( V_8 , V_202 , V_148 , & V_196 , V_63 + V_31 ) ;
if ( V_10 == 0 )
break;
if ( V_10 != - V_169 ) {
F_16 ( 1 ) ;
...
( V_2 -> V_5 != V_6 -> V_108 ) )
goto V_32;
V_10 = F_108 ( V_188 -> V_191 , V_63 , V_31 , V_2 ) ;
if ( V_10 == 0 ) {
F_118 ( V_2 ) ;
F_110 ( & V_161 -> V_167 ) ;
V_10 = V_204 ;
...
int V_206 ;
F_11 ( & V_8 -> V_15 ) ;
V_206 = F_129 ( V_8 , V_202 ) ;
F_13 ( & V_8 -> V_15 ) ;
if ( V_206 )
F_130 ( V_6 , V_206 ) ;
}
F_7 ( L_67 ,
V_6 , V_63 , V_31 , F_124 ( V_196 ) , V_10 ) ;
F_126 ( V_8 , V_196 ) ;
return V_10 ;
}
int F_131 ( struct V_25 * V_25 , struct V_187 * V_188 )
{
struct V_4 * V_5 = V_25 -> V_207 ;
if ( ! V_5 -> V_208 -> V_209 )
return - V_210 ;
F_132 ( V_25 ) ;
V_188 -> V_211 = & V_212 ;
