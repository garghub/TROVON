...
static int T_5 F_185 ( struct V_382 * V_383 , char * V_389 )
{
struct V_1 * V_2 ;
int V_294 = 9600 ;
int V_265 = 8 ;
...
return - V_274 ;
if ( V_389 )
F_186 ( V_389 , & V_294 , & V_176 , & V_265 , & V_390 ) ;
return F_187 ( V_2 , V_383 , V_294 , V_176 , V_265 , V_390 ) ;
}
static int F_188 ( void )
{
return F_189 () ;
}
static int T_5 F_190 ( void )
{
F_173 () ;
F_191 ( & V_391 ) ;
return 0 ;
}
int F_192 ( struct V_1 * V_10 )
{
int line ;
struct V_1 * V_2 ;
...
static int F_199 ( struct V_393 * V_380 )
{
struct V_394 * V_10 = F_200 ( & V_380 -> V_380 ) ;
struct V_5 V_395 ;
...
static int F_203 ( struct V_393 * V_380 )
{
int V_132 ;
for ( V_132 = 0 ; V_132 < V_366 ; V_132 ++ ) {
struct V_5 * V_6 = & V_368 [ V_132 ] ;
...
static int F_205 ( struct V_393 * V_380 , T_6 V_183 )
{
int V_132 ;
...
static int F_206 ( struct V_393 * V_380 )
{
int V_132 ;
for ( V_132 = 0 ; V_132 < V_367 ; V_132 ++ ) {
struct V_5 * V_6 = & V_368 [ V_132 ] ;
...
static struct V_5 * F_207 ( struct V_1 * V_2 )
{
int V_132 ;
for ( V_132 = 0 ; V_132 < V_366 ; V_132 ++ )
if ( F_193 ( & V_368 [ V_132 ] . V_2 , V_2 ) )
return & V_368 [ V_132 ] ;
for ( V_132 = 0 ; V_132 < V_366 ; V_132 ++ )
...
static void T_8 F_225 ( void )
{
#undef V_408
#define V_408 "8250_core."
F_226 ( V_372 , & V_409 , & V_372 , 0644 ) ;
F_226 ( V_366 , & V_409 , & V_366 , 0644 ) ;
F_226 ( V_289 , & V_409 , & V_289 , 0644 ) ;
#ifdef F_56
F_227 ( V_408 , V_134 ,
& V_410 , . V_411 = & V_412 ,
0444 , - 1 ) ;
