...
if ( V_61 < 0 )
return 0 ;
if ( V_4 -> V_59 [ V_39 -> V_6 ] < 0 )
V_61 <<= - V_4 -> V_59 [ V_39 -> V_6 ] ;
else
V_61 >>= V_4 -> V_59 [ V_39 -> V_6 ] ;
V_61 = F_33 ( V_61 , 1000 ) ;
return V_61 & 0xffff ;
...
switch ( V_4 -> V_14 -> V_69 [ V_39 -> V_62 ] ) {
case V_70 :
V_76 = F_37 ( V_4 , V_39 , V_61 ) ;
break;
case V_71 :
V_76 = F_38 ( V_4 , V_39 , V_61 ) ;
break;
case V_72 :
default:
V_76 = F_36 ( V_4 , V_39 , V_61 ) ;
break;
}
return V_76 ;
}
static int F_41 ( struct V_3 * V_4 , struct V_77 * V_67 ,
int V_78 )
{
struct V_38 * V_79 = V_67 -> V_79 ;
...
int V_61 ;
V_61 = F_41 ( V_4 , boolean , V_89 -> V_78 ) ;
if ( V_61 < 0 )
return V_61 ;
return snprintf ( V_87 , V_90 , L_2 , V_61 ) ;
}
static T_5 F_46 ( struct V_35 * V_36 ,
struct V_85 * V_91 , char * V_87 )
{
struct V_3 * V_4 = F_25 ( V_36 ) ;
struct V_38 * V_39 = F_47 ( V_91 ) ;
if ( V_39 -> V_4 < 0 )
return V_39 -> V_4 ;
return snprintf ( V_87 , V_90 , L_3 , F_35 ( V_4 , V_39 ) ) ;
}
...
int V_82 ;
T_2 V_76 ;
if ( F_49 ( V_87 , 10 , & V_61 ) < 0 )
return - V_93 ;
F_27 ( & V_4 -> V_40 ) ;
V_76 = F_40 ( V_4 , V_39 , V_61 ) ;
V_82 = F_11 ( V_2 , V_39 -> V_6 , V_39 -> V_18 , V_76 ) ;
if ( V_82 < 0 )
V_7 = V_82 ;
else
V_39 -> V_4 = V_76 ;
...
return snprintf ( V_87 , V_90 , L_4 , V_95 -> V_95 ) ;
}
...
return - V_105 ;
V_109 = & boolean -> V_96 ;
snprintf ( boolean -> V_107 , sizeof( boolean -> V_107 ) , L_5 ,
V_107 , V_111 , type ) ;
boolean -> V_79 = V_79 ;
boolean -> V_80 = V_80 ;
...
struct V_38 * V_39 ;
struct V_85 * V_109 ;
V_39 = F_60 ( V_4 -> V_36 , sizeof( * V_39 ) , V_104 ) ;
if ( ! V_39 )
return NULL ;
V_109 = & V_39 -> V_96 ;
snprintf ( V_39 -> V_107 , sizeof( V_39 -> V_107 ) , L_5 ,
V_107 , V_111 , type ) ;
V_39 -> V_6 = V_6 ;
V_39 -> V_18 = V_18 ;
V_39 -> V_62 = V_62 ;
V_39 -> V_58 = V_58 ;
F_54 ( V_109 , V_39 -> V_107 ,
V_114 ? V_112 : V_112 | V_115 ,
F_46 , F_48 ) ;
...
return - V_105 ;
V_109 = & V_95 -> V_96 ;
snprintf ( V_95 -> V_107 , sizeof( V_95 -> V_107 ) , L_6 , V_107 , V_111 ) ;
if ( ! V_78 )
strncpy ( V_95 -> V_95 , V_116 , sizeof( V_95 -> V_95 ) - 1 ) ;
else
snprintf ( V_95 -> V_95 , sizeof( V_95 -> V_95 ) , L_7 , V_116 ,
V_78 ) ;
...
struct V_38 * V_49 ,
const struct V_117 * V_89 )
{
const struct V_118 * V_119 = V_89 -> V_120 ;
int V_121 = V_89 -> V_121 ;
int V_122 = 0 ;
int V_26 , V_82 ;
struct V_38 * V_123 ;
for ( V_26 = 0 ; V_26 < V_121 ; V_26 ++ ) {
if ( F_23 ( V_2 , V_6 , V_119 -> V_18 ) ) {
V_123 = F_61 ( V_4 , V_107 , V_119 -> V_89 , V_78 ,
V_6 , V_119 -> V_18 , V_89 -> V_62 ,
V_89 -> V_58 || V_119 -> V_58 ,
false ) ;
if ( ! V_123 )
return - V_105 ;
if ( V_119 -> V_124 && ( V_14 -> F_21 [ V_6 ] & V_89 -> V_125 ) ) {
V_82 = F_59 ( V_4 , V_107 ,
V_119 -> V_126 , V_78 ,
V_89 -> V_127 ? V_119 -> V_128 ? V_123 : V_49
: NULL ,
V_89 -> V_127 ? V_119 -> V_128 ? V_49 : V_123
: NULL ,
V_89 -> V_129 + V_6 , V_119 -> V_124 ) ;
if ( V_82 )
return V_82 ;
V_122 = 1 ;
}
...
V_49 = F_61 ( V_4 , V_107 , L_8 , V_78 , V_6 , V_89 -> V_18 ,
V_89 -> V_62 , true , true ) ;
if ( ! V_49 )
return - V_105 ;
if ( V_89 -> V_125 ) {
...
V_136 [ V_133 ] ) ;
if ( V_76 < 0 ||
( ! ( V_76 & ( V_137 >> ( ( V_133 & 1 ) * 4 ) ) ) ) )
continue;
if ( F_61 ( V_4 , L_10 , L_8 , V_78 ,
V_6 , V_134 [ V_133 ] ,
V_64 , true , true ) == NULL )
return - V_105 ;
...
V_49 = V_141 + V_6 ;
V_82 = F_59 ( V_4 , L_10 ,
L_9 , V_78 , NULL , NULL , V_49 ,
V_142 >> ( V_133 & 1 ) ) ;
if ( V_82 )
return V_82 ;
V_82 = F_59 ( V_4 , L_10 ,
L_11 , V_78 , NULL , NULL , V_49 ,
V_143 >> ( V_133 & 1 ) ) ;
if ( V_82 )
return V_82 ;
}
...
V_4 -> V_165 [ 0 ] = & V_4 -> V_102 ;
V_4 -> V_166 = F_76 ( V_36 , V_2 -> V_107 ,
V_4 , V_4 -> V_165 ) ;
if ( F_77 ( V_4 -> V_166 ) ) {
V_82 = F_78 ( V_4 -> V_166 ) ;
F_70 ( V_36 , L_21 ) ;
