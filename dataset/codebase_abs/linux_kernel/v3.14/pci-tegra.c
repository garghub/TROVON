...
{
const struct V_63 * V_64 = V_8 -> V_65 ;
V_8 -> V_187 = F_75 ( V_8 -> V_40 , L_25 ) ;
if ( F_24 ( V_8 -> V_187 ) )
return F_76 ( V_8 -> V_187 ) ;
V_8 -> V_188 = F_75 ( V_8 -> V_40 , L_26 ) ;
if ( F_24 ( V_8 -> V_188 ) )
return F_76 ( V_8 -> V_188 ) ;
V_8 -> V_191 = F_75 ( V_8 -> V_40 , L_27 ) ;
if ( F_24 ( V_8 -> V_191 ) )
return F_76 ( V_8 -> V_191 ) ;
if ( V_64 -> V_189 ) {
V_8 -> V_190 = F_75 ( V_8 -> V_40 , L_28 ) ;
if ( F_24 ( V_8 -> V_190 ) )
return F_76 ( V_8 -> V_190 ) ;
}
return 0 ;
}
static int F_77 ( struct V_4 * V_8 )
{
V_8 -> V_181 = F_78 ( V_8 -> V_40 , L_25 ) ;
if ( F_24 ( V_8 -> V_181 ) )
return F_76 ( V_8 -> V_181 ) ;
V_8 -> V_180 = F_78 ( V_8 -> V_40 , L_26 ) ;
if ( F_24 ( V_8 -> V_180 ) )
return F_76 ( V_8 -> V_180 ) ;
V_8 -> V_164 = F_78 ( V_8 -> V_40 , L_29 ) ;
if ( F_24 ( V_8 -> V_164 ) )
...
{
struct V_192 * V_88 = F_80 ( V_8 -> V_40 ) ;
...
V_12 = F_81 ( V_88 , V_195 , L_33 ) ;
V_8 -> V_12 = F_82 ( & V_88 -> V_40 , V_12 ) ;
if ( F_24 ( V_8 -> V_12 ) ) {
V_28 = F_76 ( V_8 -> V_12 ) ;
goto V_196;
}
V_11 = F_81 ( V_88 , V_195 , L_26 ) ;
V_8 -> V_11 = F_82 ( & V_88 -> V_40 , V_11 ) ;
if ( F_24 ( V_8 -> V_11 ) ) {
V_28 = F_76 ( V_8 -> V_11 ) ;
goto V_196;
}
V_194 = F_81 ( V_88 , V_195 , L_34 ) ;
if ( ! V_194 ) {
V_28 = - V_197 ;
goto V_196;
}
V_8 -> V_24 = F_83 ( V_8 -> V_40 , V_194 -> V_25 ,
...
V_8 -> V_90 = V_28 ;
V_28 = F_85 ( V_8 -> V_90 , F_57 , V_199 , L_37 , V_8 ) ;
if ( V_28 ) {
...
static void F_93 ( struct V_1 * V_3 , unsigned long V_90 )
{
struct V_204 * V_40 = V_3 -> V_3 . V_40 ;
F_89 ( & V_3 -> V_200 ) ;
if ( ! F_94 ( V_90 , V_3 -> V_201 ) )
F_19 ( V_40 , L_39 , V_90 ) ;
else
F_95 ( V_90 , V_3 -> V_201 ) ;
F_92 ( & V_3 -> V_200 ) ;
}
static T_7 F_96 ( int V_90 , void * V_205 )
{
...
while ( V_71 ) {
unsigned int V_10 = F_97 ( & V_71 , 32 ) ;
unsigned int V_49 = V_27 * 32 + V_10 ;
unsigned int V_90 ;
F_4 ( V_8 , 1 << V_10 , V_207 + V_27 * 4 ) ;
V_90 = F_98 ( V_92 -> V_208 , V_49 ) ;
if ( V_90 ) {
if ( F_94 ( V_49 , V_92 -> V_201 ) )
F_99 ( V_90 ) ;
else
F_100 ( V_8 -> V_40 , L_40 ) ;
} else {
...
static int F_101 ( struct V_2 * V_3 , struct V_70 * V_88 ,
struct V_209 * V_210 )
{
...
if ( V_213 < 0 )
return V_213 ;
V_90 = F_102 ( V_92 -> V_208 , V_213 ) ;
if ( ! V_90 )
return - V_214 ;
F_103 ( V_90 , V_210 ) ;
V_212 . V_215 = F_104 ( ( void * ) V_92 -> V_216 ) ;
V_212 . V_217 = 0 ;
V_212 . V_205 = V_213 ;
F_105 ( V_90 , & V_212 ) ;
return 0 ;
}
static void F_106 ( struct V_2 * V_3 , unsigned int V_90 )
{
struct V_1 * V_92 = F_1 ( V_3 ) ;
struct V_218 * V_219 = F_107 ( V_90 ) ;
F_93 ( V_92 , V_219 -> V_213 ) ;
}
static int F_108 ( struct V_220 * V_208 , unsigned int V_90 ,
T_9 V_213 )
{
F_109 ( V_90 , & V_221 , V_222 ) ;
F_110 ( V_90 , V_208 -> V_223 ) ;
F_111 ( V_90 , V_224 ) ;
F_51 () ;
return 0 ;
}
static int F_112 ( struct V_4 * V_8 )
{
struct V_192 * V_88 = F_80 ( V_8 -> V_40 ) ;
const struct V_63 * V_64 = V_8 -> V_65 ;
struct V_1 * V_92 = & V_8 -> V_92 ;
...
V_92 -> V_3 . V_225 = F_101 ;
V_92 -> V_3 . V_226 = F_106 ;
V_92 -> V_208 = F_114 ( V_8 -> V_40 -> V_227 , V_202 ,
& V_228 , & V_92 -> V_3 ) ;
if ( ! V_92 -> V_208 ) {
F_19 ( & V_88 -> V_40 , L_42 ) ;
return - V_30 ;
...
V_92 -> V_90 = V_28 ;
V_28 = F_85 ( V_92 -> V_90 , F_96 , 0 ,
V_221 . V_198 , V_8 ) ;
if ( V_28 < 0 ) {
F_19 ( & V_88 -> V_40 , L_44 , V_28 ) ;
goto V_28;
}
V_92 -> V_216 = F_115 ( V_29 , 0 ) ;
V_50 = F_104 ( ( void * ) V_92 -> V_216 ) ;
...
static int F_120 ( struct V_4 * V_8 , T_1 V_239 ,
T_1 * V_240 )
{
...
T_1 V_239 = 0 ;
int V_28 ;
if ( F_123 ( & V_249 , V_242 ) ) {
F_19 ( V_8 -> V_40 , L_52 ) ;
return - V_214 ;
}
V_8 -> V_186 = F_124 ( V_8 -> V_40 , L_53 ) ;
if ( F_24 ( V_8 -> V_186 ) )
return F_76 ( V_8 -> V_186 ) ;
V_8 -> V_185 = F_124 ( V_8 -> V_40 , L_54 ) ;
if ( F_24 ( V_8 -> V_185 ) )
return F_76 ( V_8 -> V_185 ) ;
if ( V_64 -> V_183 ) {
V_8 -> V_184 = F_124 ( V_8 -> V_40 , L_55 ) ;
if ( F_24 ( V_8 -> V_184 ) )
return F_76 ( V_8 -> V_184 ) ;
}
F_125 (&parser, &range) {
F_126 ( & V_251 , V_242 , & V_194 ) ;
...
if ( ! F_131 ( V_48 ) )
continue;
V_258 = F_132 ( V_8 -> V_40 , sizeof( * V_258 ) , V_29 ) ;
if ( ! V_258 )
return - V_30 ;
V_28 = F_133 ( V_48 , 0 , & V_258 -> V_69 ) ;
if ( V_28 < 0 ) {
F_19 ( V_8 -> V_40 , L_60 ,
V_28 ) ;
return V_28 ;
...
V_258 -> V_239 = V_9 ;
V_258 -> V_8 = V_8 ;
V_258 -> V_50 = F_82 ( V_8 -> V_40 , & V_258 -> V_69 ) ;
if ( F_24 ( V_258 -> V_50 ) )
return F_76 ( V_258 -> V_50 ) ;
F_25 ( & V_258 -> V_31 , & V_8 -> V_259 ) ;
}
V_28 = F_120 ( V_8 , V_239 , & V_8 -> V_144 ) ;
if ( V_28 < 0 ) {
F_19 ( V_8 -> V_40 , L_65 ) ;
return V_28 ;
}
...
static bool F_134 ( struct V_47 * V_48 )
{
...
struct V_267 V_268 ;
F_136 (port, tmp, &pcie->ports, list) {
F_100 ( V_8 -> V_40 , L_67 ,
V_48 -> V_49 , V_48 -> V_239 ) ;
F_32 ( V_48 ) ;
if ( F_134 ( V_48 ) )
continue;
F_100 ( V_8 -> V_40 , L_68 , V_48 -> V_49 ) ;
F_33 ( V_48 ) ;
F_34 ( V_48 ) ;
}
...
V_268 . V_273 = F_54 ;
V_268 . V_274 = & V_93 ;
F_137 ( V_8 -> V_40 , & V_268 ) ;
return 0 ;
}
static int F_138 ( struct V_192 * V_88 )
{
const struct V_275 * V_276 ;
struct V_4 * V_8 ;
int V_28 ;
V_276 = F_139 ( V_277 , & V_88 -> V_40 ) ;
if ( ! V_276 )
return - V_278 ;
V_8 = F_132 ( & V_88 -> V_40 , sizeof( * V_8 ) , V_29 ) ;
if ( ! V_8 )
return - V_30 ;
F_16 ( & V_8 -> V_42 ) ;
F_16 ( & V_8 -> V_259 ) ;
