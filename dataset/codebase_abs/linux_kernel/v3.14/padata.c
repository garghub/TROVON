...
int F_83 ( struct V_13 * V_14 , T_1 V_55 ,
T_1 V_56 )
{
int V_24 ;
F_84 ( & V_14 -> V_18 ) ;
F_69 () ;
V_24 = F_81 ( V_14 , V_55 , V_56 ) ;
F_70 () ;
F_85 ( & V_14 -> V_18 ) ;
return V_24 ;
}
int F_86 ( struct V_13 * V_14 , int V_75 ,
T_1 V_6 )
{
...
static int F_87 ( struct V_13 * V_14 , int V_4 )
{
struct V_1 * V_2 ;
if ( F_21 ( V_4 , V_59 ) ) {
...
int F_88 ( struct V_13 * V_14 , int V_4 , int V_78 )
{
int V_24 ;
if ( ! ( V_78 & ( V_69 | V_68 ) ) )
return - V_26 ;
...
F_69 () ;
if ( V_78 & V_69 )
F_89 ( V_4 , V_14 -> V_6 . V_31 ) ;
if ( V_78 & V_68 )
F_89 ( V_4 , V_14 -> V_6 . V_7 ) ;
V_24 = F_87 ( V_14 , V_4 ) ;
F_70 () ;
F_85 ( & V_14 -> V_18 ) ;
return V_24 ;
}
static int F_90 ( struct V_13 * V_14 , int V_4 )
{
struct V_1 * V_2 = NULL ;
if ( F_21 ( V_4 , V_59 ) ) {
if ( ! F_79 ( V_14 , V_14 -> V_6 . V_7 ) ||
...
return - V_58 ;
F_71 ( V_14 , V_2 ) ;
F_91 ( V_4 , V_2 -> V_6 . V_31 ) ;
F_91 ( V_4 , V_2 -> V_6 . V_7 ) ;
}
return 0 ;
}
int F_92 ( struct V_13 * V_14 , int V_4 , int V_78 )
{
int V_24 ;
if ( ! ( V_78 & ( V_69 | V_68 ) ) )
return - V_26 ;
...
F_69 () ;
if ( V_78 & V_69 )
F_91 ( V_4 , V_14 -> V_6 . V_31 ) ;
if ( V_78 & V_68 )
F_91 ( V_4 , V_14 -> V_6 . V_7 ) ;
V_24 = F_90 ( V_14 , V_4 ) ;
F_70 () ;
F_85 ( & V_14 -> V_18 ) ;
return V_24 ;
...
void F_94 ( struct V_13 * V_14 )
{
F_84 ( & V_14 -> V_18 ) ;
F_67 ( V_14 ) ;
F_85 ( & V_14 -> V_18 ) ;
}
static inline int F_95 ( struct V_13 * V_14 , int V_4 )
{
return F_21 ( V_4 , V_14 -> V_6 . V_7 ) ||
F_21 ( V_4 , V_14 -> V_6 . V_31 ) ;
}
static int F_96 ( struct V_71 * V_79 ,
unsigned long V_80 , void * V_81 )
{
int V_24 ;
struct V_13 * V_14 ;
int V_4 = ( unsigned long ) V_81 ;
V_14 = F_10 ( V_79 , struct V_13 , V_82 ) ;
switch ( V_80 ) {
case V_83 :
case V_84 :
case V_85 :
...
T_2 V_97 ;
F_84 ( & V_14 -> V_18 ) ;
if ( ! strcmp ( V_95 -> V_98 , L_1 ) )
V_6 = V_14 -> V_6 . V_31 ;
else
V_6 = V_14 -> V_6 . V_7 ;
V_97 = F_104 ( V_96 , V_99 , F_105 ( V_6 ) ,
V_100 ) ;
if ( V_99 - V_97 < 2 )
V_97 = - V_26 ;
else
V_97 += sprintf ( V_96 + V_97 , L_2 ) ;
F_85 ( & V_14 -> V_18 ) ;
return V_97 ;
}
static T_2 F_106 ( struct V_13 * V_14 ,
struct V_94 * V_95 ,
const char * V_96 , T_3 V_101 )
{
T_1 V_102 ;
T_2 V_103 ;
int V_104 ;
if ( ! F_44 ( & V_102 , V_57 ) )
return - V_58 ;
V_103 = F_107 ( V_96 , V_101 , F_105 ( V_102 ) ,
V_105 ) ;
if ( V_103 < 0 )
goto V_30;
V_104 = ! strcmp ( V_95 -> V_98 , L_1 ) ?
V_69 : V_68 ;
V_103 = F_86 ( V_14 , V_104 , V_102 ) ;
if ( ! V_103 )
V_103 = V_101 ;
V_30:
F_46 ( V_102 ) ;
...
static T_2 F_108 ( struct V_92 * V_93 ,
struct V_94 * V_95 , char * V_96 )
{
struct V_13 * V_14 ;
struct V_106 * V_107 ;
...
V_107 = F_109 ( V_95 ) ;
if ( V_107 -> V_109 )
V_103 = V_107 -> V_109 ( V_14 , V_95 , V_96 ) ;
return V_103 ;
}
static T_2 F_110 ( struct V_92 * V_93 , struct V_94 * V_95 ,
const char * V_96 , T_3 V_101 )
{
struct V_13 * V_14 ;
struct V_106 * V_107 ;
...
V_107 = F_109 ( V_95 ) ;
if ( V_107 -> V_109 )
V_103 = V_107 -> V_110 ( V_14 , V_95 , V_96 , V_101 ) ;
return V_103 ;
}
struct V_13 * F_111 ( struct V_111 * V_36 )
{
return F_112 ( V_36 , V_112 , V_112 ) ;
}
struct V_13 * F_112 ( struct V_111 * V_36 ,
const struct V_6 * V_55 ,
const struct V_6 * V_56 )
{
struct V_13 * V_14 ;
...
F_70 () ;
F_113 ( & V_14 -> V_70 ) ;
F_114 ( & V_14 -> V_93 , & V_115 ) ;
F_115 ( & V_14 -> V_18 ) ;
#ifdef F_99
V_14 -> V_82 . V_116 = F_96 ;
V_14 -> V_82 . V_117 = 0 ;
F_116 ( & V_14 -> V_82 ) ;
#endif
return V_14 ;
