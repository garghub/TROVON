...
static int F_32 ( struct V_1 * V_2 , int V_33 )
{
if ( V_33 == V_42 ) {
T_2 V_43 ;
F_33 ( V_2 -> V_4 , V_44 , & V_43 ) ;
if ( V_43 )
return 1 ;
} else if ( V_33 == V_45 ) {
T_2 V_46 ;
...
static int F_35 ( struct V_3 * V_4 , void * V_52 )
{
( * ( int * ) V_52 ) ++ ;
return 0 ;
}
...
if ( ! V_55 )
return - V_59 ;
V_54 -> V_60 [ V_54 -> V_56 ] . V_61 = F_38 ( V_55 ) ;
V_54 -> V_60 [ V_54 -> V_56 ] . V_62 = F_39 ( V_4 -> V_63 ) ;
...
static int F_41 ( struct V_3 * V_4 , void * V_52 )
{
...
static bool F_42 ( struct V_3 * V_4 , struct V_74 * V_75 )
{
...
static int F_43 ( struct V_3 * V_4 , void * V_52 )
{
struct V_77 * V_78 = V_52 ;
if ( ! V_78 -> V_75 || F_42 ( V_4 , V_78 -> V_4 -> V_75 ) )
...
F_45 ( V_4 -> V_63 , F_43 , & V_78 ) ;
return V_78 . V_5 ;
}
static long F_46 ( void * V_38 ,
...
if ( V_6 == V_82 ) {
struct V_83 V_67 ;
V_81 = F_47 ( struct V_83 , V_84 ) ;
if ( F_48 ( & V_67 , ( void V_85 * ) V_80 , V_81 ) )
return - V_86 ;
if ( V_67 . V_87 < V_81 )
return - V_73 ;
V_67 . V_17 = V_88 ;
...
V_67 . V_90 = V_91 ;
V_67 . V_84 = V_92 ;
return F_49 ( ( void V_85 * ) V_80 , & V_67 , V_81 ) ;
} else if ( V_6 == V_93 ) {
struct V_3 * V_4 = V_2 -> V_4 ;
struct V_94 V_67 ;
V_81 = F_47 ( struct V_94 , V_95 ) ;
if ( F_48 ( & V_67 , ( void V_85 * ) V_80 , V_81 ) )
return - V_86 ;
if ( V_67 . V_87 < V_81 )
return - V_73 ;
...
T_2 * V_52 = NULL ;
int V_5 = 0 ;
V_81 = F_47 ( struct V_117 , V_71 ) ;
if ( F_48 ( & V_118 , ( void V_85 * ) V_80 , V_81 ) )
return - V_86 ;
...
V_132:
if ( F_49 ( ( void V_85 * ) V_80 , & V_118 , V_81 ) )
V_5 = - V_86 ;
if ( ! V_5 ) {
if ( F_49 ( ( void V_85 * ) ( V_80 + V_81 ) , V_60 ,
...
if ( F_48 ( V_137 , ( void V_85 * ) ( V_80 + V_81 ) ,
