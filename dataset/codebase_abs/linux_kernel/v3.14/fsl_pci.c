...
static int F_73 ( struct V_183 * V_184 , T_2 V_185 )
{
...
V_43 = & V_10 -> V_83 [ V_49 ] ;
if ( ( V_43 -> V_48 & V_84 ) &&
V_210 >= V_43 -> V_45 && V_210 <= V_43 -> V_85 )
return 1 ;
}
}
return 0 ;
...
if ( F_85 ( V_184 ) ) {
F_86 () ;
V_156 = F_87 ( V_184 -> V_215 , & V_185 ) ;
F_88 () ;
} else {
V_156 = F_89 ( V_184 -> V_215 , V_185 ) ;
}
if ( F_73 ( V_184 , V_185 ) ) {
V_184 -> V_215 += 4 ;
return 1 ;
...
if ( V_217 )
return;
V_216 = F_91 ( NULL , L_38 ) ;
while ( ( V_217 = F_92 ( V_216 ) ) ) {
F_93 ( V_216 ) ;
V_216 = V_217 ;
if ( F_94 ( V_218 , V_216 ) && F_40 ( V_216 ) )
return;
}
F_95 (np, pci_ids) {
if ( F_40 ( V_216 ) ) {
...
int V_156 ;
struct V_130 * V_219 ;
V_219 = V_125 -> V_2 . V_131 ;
V_156 = F_39 ( V_125 , V_217 == V_219 ) ;
F_97 ( V_125 ) ;
return 0 ;
}
static int F_98 ( struct V_35 * V_2 )
{
struct V_9 * V_10 ;
struct V_42 V_220 ;
V_10 = F_99 ( V_2 -> V_131 ) ;
