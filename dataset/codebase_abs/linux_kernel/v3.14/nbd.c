...
V_143 = F_85 ( V_38 ) ;
if ( V_143 ) {
struct V_145 * V_145 = F_86 ( V_143 ) ;
if ( F_87 ( V_145 -> V_146 ) ) {
V_32 -> V_143 = V_143 ;
V_32 -> V_35 = F_88 ( V_145 ) ;
if ( V_147 > 0 )
V_139 -> V_148 = 1 ;
V_32 -> V_142 = 0 ;
return 0 ;
...
case V_3 :
V_32 -> V_149 = V_38 ;
V_32 -> V_150 &= ~ ( V_32 -> V_149 - 1 ) ;
V_139 -> V_151 -> V_152 = V_32 -> V_150 ;
F_89 ( V_139 , V_32 -> V_149 ) ;
F_90 ( V_32 -> V_36 , V_32 -> V_150 >> 9 ) ;
return 0 ;
case V_4 :
V_32 -> V_150 = V_38 & ~ ( V_32 -> V_149 - 1 ) ;
V_139 -> V_151 -> V_152 = V_32 -> V_150 ;
F_89 ( V_139 , V_32 -> V_149 ) ;
F_90 ( V_32 -> V_36 , V_32 -> V_150 >> 9 ) ;
return 0 ;
case V_5 :
V_32 -> V_75 = V_38 * V_153 ;
return 0 ;
case V_6 :
V_32 -> V_26 = V_38 ;
return 0 ;
case V_11 :
V_32 -> V_150 = ( ( V_94 ) V_38 ) * V_32 -> V_149 ;
V_139 -> V_151 -> V_152 = V_32 -> V_150 ;
F_89 ( V_139 , V_32 -> V_149 ) ;
F_90 ( V_32 -> V_36 , V_32 -> V_150 >> 9 ) ;
return 0 ;
...
V_32 -> V_36 -> V_156 ) ;
if ( V_32 -> V_26 & V_157 )
F_93 ( V_32 -> V_36 -> V_156 , V_136 ) ;
else
F_93 ( V_32 -> V_36 -> V_156 , 0 ) ;
V_154 = F_94 ( F_71 , V_32 , L_47 ,
V_32 -> V_36 -> V_29 ) ;
if ( F_53 ( V_154 ) ) {
F_9 ( & V_32 -> V_34 ) ;
return F_54 ( V_154 ) ;
...
F_80 ( F_11 ( V_32 -> V_36 ) ,
L_49 ,
V_32 -> V_126 . V_127 , V_32 -> V_126 . V_159 ,
& V_32 -> V_126 ) ;
return 0 ;
}
return - V_160 ;
}
static int F_99 ( struct V_138 * V_139 , T_4 V_161 ,
unsigned int V_1 , unsigned long V_38 )
{
struct V_31 * V_32 = V_139 -> V_162 -> V_122 ;
int error ;
if ( ! F_100 ( V_163 ) )
return - V_164 ;
F_58 ( V_32 -> V_90 != V_124 ) ;
...
V_170 = F_103 ( V_171 , sizeof( * V_170 ) , V_172 ) ;
if ( ! V_170 )
return - V_166 ;
V_168 = 0 ;
if ( V_147 > 0 ) {
...
if ( ( 1UL << V_168 ) > V_173 )
return - V_59 ;
if ( V_171 > 1UL << ( V_174 - V_168 ) )
return - V_59 ;
for ( V_167 = 0 ; V_167 < V_171 ; V_167 ++ ) {
struct V_121 * V_36 = F_105 ( 1 << V_168 ) ;
if ( ! V_36 )
goto V_106;
V_170 [ V_167 ] . V_36 = V_36 ;
V_36 -> V_156 = F_106 ( F_76 , & V_175 ) ;
if ( ! V_36 -> V_156 ) {
F_107 ( V_36 ) ;
goto V_106;
}
F_92 ( V_176 , V_36 -> V_156 ) ;
V_36 -> V_156 -> V_177 . V_178 = 512 ;
V_36 -> V_156 -> V_177 . V_179 = V_180 ;
V_36 -> V_156 -> V_177 . V_181 = 0 ;
F_108 ( V_36 -> V_156 , 65536 ) ;
V_36 -> V_156 -> V_177 . V_182 = 256 ;
}
if ( F_109 ( V_183 , L_52 ) ) {
V_103 = - V_23 ;
goto V_106;
}
F_15 ( V_184 L_53 , V_183 ) ;
F_4 ( V_185 , L_54 , V_186 ) ;
for ( V_167 = 0 ; V_167 < V_171 ; V_167 ++ ) {
struct V_121 * V_36 = V_170 [ V_167 ] . V_36 ;
V_170 [ V_167 ] . V_143 = NULL ;
V_170 [ V_167 ] . V_90 = V_124 ;
V_170 [ V_167 ] . V_26 = 0 ;
F_110 ( & V_170 [ V_167 ] . V_128 ) ;
F_111 ( & V_170 [ V_167 ] . V_30 ) ;
F_110 ( & V_170 [ V_167 ] . V_126 ) ;
F_112 ( & V_170 [ V_167 ] . V_34 ) ;
F_113 ( & V_170 [ V_167 ] . V_104 ) ;
F_113 ( & V_170 [ V_167 ] . V_137 ) ;
V_170 [ V_167 ] . V_149 = 1024 ;
V_170 [ V_167 ] . V_150 = 0 ;
V_36 -> V_187 = V_183 ;
V_36 -> V_188 = V_167 << V_168 ;
V_36 -> V_189 = & V_190 ;
V_36 -> V_122 = & V_170 [ V_167 ] ;
sprintf ( V_36 -> V_29 , L_55 , V_167 ) ;
F_90 ( V_36 , 0 ) ;
F_114 ( V_36 ) ;
}
return 0 ;
V_106:
while ( V_167 -- ) {
F_115 ( V_170 [ V_167 ] . V_36 -> V_156 ) ;
F_107 ( V_170 [ V_167 ] . V_36 ) ;
}
F_116 ( V_170 ) ;
return V_103 ;
}
