...
static int
F_67 ( struct V_1 * V_2 , struct V_225 * V_226 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
return F_68 ( V_6 , V_226 -> V_71 ) ;
}
static int
F_69 ( struct V_1 * V_2 )
{
...
static int
F_70 ( struct V_1 * V_2 , struct V_230 * V_231 ,
T_5 * V_71 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
struct V_24 V_232 ;
...
if ( F_16 ( V_6 ) ) {
if ( F_15 ( V_6 ) )
return F_7 ( V_6 , V_227 ,
V_231 -> V_46 , V_71 ) ;
else
return F_7 ( V_6 , V_228 ,
V_231 -> V_46 , V_71 ) ;
}
V_231 -> V_235 = V_236 | ( V_6 -> V_16 -> V_195 << 16 ) ;
memset ( & V_232 , 0 , sizeof( struct V_24 ) ) ;
V_232 . V_33 = sizeof( struct V_237 ) ;
V_232 . V_35 = F_60 ( & V_6 -> V_16 -> V_37 , V_232 . V_33 ,
& V_232 . V_36 , V_211 ) ;
if ( ! V_232 . V_35 )
return - V_38 ;
V_26 = F_71 ( V_6 , & V_232 ) ;
if ( ! V_26 ) {
V_234 = V_232 . V_35 ;
memcpy ( V_71 , V_234 -> V_238 + V_231 -> V_83 , V_231 -> V_46 ) ;
}
F_62 ( & V_6 -> V_16 -> V_37 , V_232 . V_33 , V_232 . V_35 ,
V_232 . V_36 ) ;
return V_26 ;
}
...
static void F_73 ( struct V_1 * V_2 , T_1 V_240 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
if ( V_6 -> V_239 == V_240 )
return;
if ( ( V_240 & V_241 ) != ( V_6 -> V_239 & V_241 ) )
if ( F_74 ( V_6 ) )
F_75 ( V_6 , V_240 & V_241 ?
V_242 :
V_243 ) ;
V_6 -> V_239 = V_240 ;
return;
}
static V_95 F_76 ( struct V_5 * V_6 , V_95 V_244 )
{
V_95 V_71 = 0 ;
switch ( V_244 ) {
case V_245 :
...
static int F_77 ( struct V_1 * V_2 , struct V_260 * V_261 ,
T_1 * V_262 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
if ( ! F_78 ( V_6 ) ) {
...
switch ( V_261 -> V_261 ) {
case V_263 :
V_261 -> V_71 = F_76 ( V_6 , V_261 -> V_244 ) ;
break;
case V_264 :
V_261 -> V_71 = V_6 -> V_100 - 1 ;
break;
default:
return - V_105 ;
}
...
T_1 V_246 = V_6 -> V_246 ;
if ( V_261 -> V_71 != V_266 &&
V_261 -> V_71 != ( V_266 | V_267 ) )
return - V_105 ;
switch ( V_261 -> V_244 ) {
case V_245 :
if ( V_261 -> V_71 == V_266 )
V_246 &= ~ V_250 ;
else if ( V_261 -> V_71 == ( V_266 | V_267 ) )
V_246 |= V_247 |
V_250 ;
break;
case V_255 :
...
if ( ( V_77 + V_66 ) >= 128 )
break;
V_265 [ V_77 + V_66 ] = V_73 -> V_268 ;
}
}
}
V_26 = F_81 ( V_6 , V_265 , V_246 , 128 ) ;
if ( ! V_26 )
V_6 -> V_246 = V_246 ;
return V_26 ;
}
static int F_82 ( struct V_1 * V_2 , struct V_260 * V_261 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
int V_26 = 0 ;
if ( ! F_78 ( V_6 ) ) {
...
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
V_271 -> V_272 = V_6 -> V_273 ;
V_271 -> V_274 = F_84 ( V_6 ) ;
}
static int F_85 ( struct V_1 * V_2 ,
struct V_270 * V_271 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
if ( V_271 -> V_275 || V_271 -> V_276 || V_271 -> V_277 ||
! V_271 -> V_272 || V_271 -> V_272 > F_84 ( V_6 ) )
return - V_105 ;
V_6 -> V_278 = V_271 -> V_272 ;
return F_86 ( V_6 ) ;
}
