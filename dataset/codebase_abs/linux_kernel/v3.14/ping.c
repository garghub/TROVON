...
V_34 = F_20 ( V_36 ) ;
F_21 ( V_2 ) ;
V_11 = F_22 ( V_2 , V_84 , & V_40 , V_5 ,
0 , V_34 ,
V_26 -> V_85 , NULL , & V_33 , V_38 ,
V_86 , V_26 -> V_87 ) ;
if ( V_11 ) {
F_23 ( F_24 ( V_2 ) , V_38 -> V_88 ,
V_89 ) ;
F_25 ( V_2 ) ;
} else {
V_11 = F_26 ( V_2 , & V_33 ,
...
static void * F_28 ( struct V_90 * V_91 , T_5 * V_92 )
{
return F_29 ( V_91 , V_92 , V_42 ) ;
}
static int F_30 ( struct V_90 * V_91 , void * V_93 )
{
if ( V_93 == V_94 ) {
F_31 ( V_91 , V_95 ) ;
} else {
int V_96 = ( (struct V_97 * ) V_91 -> V_98 ) -> V_96 ;
struct V_23 * V_24 = F_7 ( V_93 ) ;
T_6 V_99 = F_32 ( V_24 -> V_75 ) ;
T_6 V_100 = F_32 ( V_24 -> V_101 ) ;
F_33 ( V_91 , V_93 , V_99 , V_100 , V_96 ) ;
}
return 0 ;
}
static int T_7 F_34 ( struct V_15 * V_15 )
{
return F_35 ( V_15 , & V_102 ) ;
}
static void T_7 F_36 ( struct V_15 * V_15 )
{
return F_37 ( V_15 , & V_102 ) ;
}
int T_8 F_38 ( void )
{
#ifdef F_39
int V_103 = F_40 ( & V_104 ) ;
if ( V_103 )
return V_103 ;
#endif
V_105 . V_106 = V_106 ;
