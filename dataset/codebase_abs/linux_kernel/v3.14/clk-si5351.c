...
if ( ! V_152 )
return - V_157 ;
V_152 -> V_158 = F_57 ( V_149 , 0 ) ;
if ( ! F_58 ( V_152 -> V_158 ) )
F_59 ( V_152 -> V_158 ) ;
V_152 -> V_159 = F_57 ( V_149 , 1 ) ;
if ( ! F_58 ( V_152 -> V_159 ) )
F_59 ( V_152 -> V_159 ) ;
...
if ( ! F_63 ( V_148 , L_19 , & V_4 ) ) {
switch ( V_4 ) {
case 0 :
V_152 -> V_163 [ V_12 ] . V_165 =
V_95 ;
break;
case 1 :
V_152 -> V_163 [ V_12 ] . V_165 =
...
if ( ! F_63 ( V_148 , L_25 , & V_4 ) )
V_152 -> V_163 [ V_12 ] . V_35 = V_4 ;
V_152 -> V_163 [ V_12 ] . V_167 =
F_64 ( V_148 , L_26 ) ;
}
V_7 -> V_8 . V_168 = V_152 ;
return 0 ;
...
{
enum V_146 V_52 = (enum V_146 ) V_170 -> V_171 ;
struct V_151 * V_152 ;
struct V_1 * V_2 ;
struct V_172 V_173 ;
struct V_60 * V_60 ;
...
V_2 -> V_7 = V_7 ;
V_2 -> V_52 = V_52 ;
V_2 -> V_178 = V_152 -> V_158 ;
V_2 -> V_179 = V_152 -> V_159 ;
V_2 -> V_6 = F_67 ( V_7 , & V_180 ) ;
if ( F_58 ( V_2 -> V_6 ) ) {
F_3 ( & V_7 -> V_8 , L_28 ) ;
return F_68 ( V_2 -> V_6 ) ;
}
...
V_5 = F_29 ( V_2 , V_177 , V_152 -> V_160 [ V_177 ] ) ;
if ( V_5 ) {
F_3 ( & V_7 -> V_8 ,
L_29 ,
V_177 , V_152 -> V_160 [ V_177 ] ) ;
return V_5 ;
}
}
for ( V_177 = 0 ; V_177 < 8 ; V_177 ++ ) {
V_5 = F_38 ( V_2 , V_177 ,
V_152 -> V_163 [ V_177 ] . V_164 ) ;
if ( V_5 ) {
F_3 ( & V_7 -> V_8 ,
L_30 ,
V_177 , V_152 -> V_163 [ V_177 ] . V_164 ) ;
return V_5 ;
}
V_5 = F_45 ( V_2 , V_177 ,
V_152 -> V_163 [ V_177 ] . V_165 ) ;
if ( V_5 ) {
F_3 ( & V_7 -> V_8 ,
L_31 ,
V_177 , V_152 -> V_163 [ V_177 ] . V_165 ) ;
return V_5 ;
}
V_5 = F_46 ( V_2 , V_177 ,
V_152 -> V_163 [ V_177 ] . V_105 ) ;
if ( V_5 ) {
F_3 ( & V_7 -> V_8 ,
L_32 ,
V_177 , V_152 -> V_163 [ V_177 ] . V_105 ) ;
return V_5 ;
}
V_5 = F_47 ( V_2 , V_177 ,
V_152 -> V_163 [ V_177 ] . V_166 ) ;
if ( V_5 ) {
F_3 ( & V_7 -> V_8 ,
L_33 ,
V_177 , V_152 -> V_163 [ V_177 ] . V_166 ) ;
return V_5 ;
}
}
...
V_173 . V_185 = 0 ;
if ( ! F_58 ( V_2 -> V_178 ) ) {
V_2 -> V_186 = F_34 ( V_2 -> V_178 ) ;
V_173 . V_174 = & V_2 -> V_186 ;
V_173 . V_175 = 1 ;
}
V_2 -> V_29 . V_173 = & V_173 ;
V_60 = F_69 ( & V_7 -> V_8 , & V_2 -> V_29 ) ;
if ( F_58 ( V_60 ) ) {
F_3 ( & V_7 -> V_8 , L_34 , V_173 . V_161 ) ;
return F_68 ( V_60 ) ;
}
if ( V_2 -> V_52 == V_53 ) {
memset ( & V_173 , 0 , sizeof( V_173 ) ) ;
...
V_173 . V_183 = & V_187 ;
if ( ! F_58 ( V_2 -> V_179 ) ) {
V_2 -> V_188 = F_34 ( V_2 -> V_179 ) ;
V_173 . V_174 = & V_2 -> V_188 ;
V_173 . V_175 = 1 ;
}
...
V_175 = ( V_2 -> V_52 == V_53 ) ? 2 : 1 ;
V_174 [ 0 ] = V_182 [ 0 ] ;
V_174 [ 1 ] = V_182 [ 1 ] ;
V_2 -> V_189 [ 0 ] . V_12 = 0 ;
V_2 -> V_189 [ 0 ] . V_2 = V_2 ;
V_2 -> V_189 [ 0 ] . V_28 . V_173 = & V_173 ;
memset ( & V_173 , 0 , sizeof( V_173 ) ) ;
V_173 . V_161 = V_190 [ 0 ] ;
V_173 . V_183 = & V_191 ;
V_173 . V_185 = 0 ;
...
V_176 = ( V_2 -> V_52 == V_162 ) ? 3 : 8 ;
V_174 [ 0 ] = V_190 [ 0 ] ;
if ( V_2 -> V_52 == V_192 )
V_174 [ 1 ] = V_190 [ 2 ] ;
else
V_174 [ 1 ] = V_190 [ 1 ] ;
V_2 -> V_195 = F_56 ( & V_7 -> V_8 , V_176 *
sizeof( * V_2 -> V_195 ) , V_156 ) ;
V_2 -> V_163 = F_56 ( & V_7 -> V_8 , V_176 *
sizeof( * V_2 -> V_163 ) , V_156 ) ;
V_2 -> V_196 . V_197 = V_176 ;
V_2 -> V_196 . V_198 = F_56 ( & V_7 -> V_8 ,
V_176 * sizeof( * V_2 -> V_196 . V_198 ) , V_156 ) ;
if ( F_70 ( ! V_2 -> V_195 || ! V_2 -> V_163 ||
! V_2 -> V_196 . V_198 ) )
return - V_157 ;
for ( V_177 = 0 ; V_177 < V_176 ; V_177 ++ ) {
V_2 -> V_195 [ V_177 ] . V_12 = V_177 ;
V_2 -> V_195 [ V_177 ] . V_2 = V_2 ;
V_2 -> V_195 [ V_177 ] . V_28 . V_173 = & V_173 ;
memset ( & V_173 , 0 , sizeof( V_173 ) ) ;
V_173 . V_161 = V_199 [ V_177 ] ;
V_173 . V_183 = & V_200 ;
V_173 . V_185 = 0 ;
if ( V_152 -> V_163 [ V_177 ] . V_167 )
V_173 . V_185 |= V_88 ;
V_173 . V_174 = V_174 ;
V_173 . V_175 = 2 ;
V_60 = F_69 ( & V_7 -> V_8 , & V_2 -> V_195 [ V_177 ] . V_28 ) ;
if ( F_58 ( V_60 ) ) {
F_3 ( & V_7 -> V_8 , L_34 ,
V_173 . V_161 ) ;
return - V_51 ;
...
V_175 = ( V_2 -> V_52 == V_53 ) ? 4 : 3 ;
V_174 [ 2 ] = V_182 [ 0 ] ;
V_174 [ 3 ] = V_182 [ 1 ] ;
for ( V_177 = 0 ; V_177 < V_176 ; V_177 ++ ) {
V_174 [ 0 ] = V_199 [ V_177 ] ;
V_174 [ 1 ] = ( V_177 < 4 ) ? V_199 [ 0 ] :
V_199 [ 4 ] ;
V_2 -> V_163 [ V_177 ] . V_12 = V_177 ;
V_2 -> V_163 [ V_177 ] . V_2 = V_2 ;
V_2 -> V_163 [ V_177 ] . V_28 . V_173 = & V_173 ;
memset ( & V_173 , 0 , sizeof( V_173 ) ) ;
V_173 . V_161 = V_201 [ V_177 ] ;
V_173 . V_183 = & V_202 ;
V_173 . V_185 = 0 ;
if ( V_152 -> V_163 [ V_177 ] . V_165 == V_95 )
V_173 . V_185 |= V_88 ;
V_173 . V_174 = V_174 ;
V_173 . V_175 = V_175 ;
V_60 = F_69 ( & V_7 -> V_8 , & V_2 -> V_163 [ V_177 ] . V_28 ) ;
if ( F_58 ( V_60 ) ) {
F_3 ( & V_7 -> V_8 , L_34 ,
V_173 . V_161 ) ;
return - V_51 ;
}
V_2 -> V_196 . V_198 [ V_177 ] = V_60 ;
if ( V_152 -> V_163 [ V_177 ] . V_35 != 0 ) {
int V_5 ;
V_5 = F_71 ( V_60 , V_152 -> V_163 [ V_177 ] . V_35 ) ;
if ( V_5 != 0 ) {
F_3 ( & V_7 -> V_8 , L_35 ,
V_5 ) ;
}
