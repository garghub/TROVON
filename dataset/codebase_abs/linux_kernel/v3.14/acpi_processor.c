...
V_27 = F_24 ( V_20 -> V_24 , V_39 , V_20 -> V_48 ) ;
if ( V_27 < 0 ) {
F_25 ( V_20 -> V_24 , L_14 ) ;
return - V_26 ;
}
V_20 -> V_27 = V_27 ;
V_38 = F_26 ( V_20 -> V_27 , V_20 -> V_48 ) ;
if ( ! V_41 ) {
V_41 = 1 ;
if ( ( V_38 == - 1 ) && ( F_27 () == 1 ) )
V_38 = 0 ;
...
F_29 ( V_20 -> V_54 . V_55 , 6 , L_19 ) ;
}
V_22 = F_9 ( V_20 -> V_24 , L_20 , NULL , & V_42 ) ;
if ( F_30 ( V_22 ) )
F_31 ( V_20 -> V_28 , V_42 ) ;
return 0 ;
}
...
struct V_33 * V_2 ;
int V_17 = 0 ;
V_20 = F_33 ( sizeof( struct V_19 ) , V_60 ) ;
if ( ! V_20 )
return - V_61 ;
if ( ! F_34 ( & V_20 -> V_54 . V_62 , V_60 ) ) {
V_17 = - V_61 ;
goto V_63;
}
V_20 -> V_24 = V_33 -> V_24 ;
strcpy ( F_35 ( V_33 ) , V_64 ) ;
strcpy ( F_36 ( V_33 ) , V_65 ) ;
V_33 -> V_66 = V_20 ;
V_17 = F_19 ( V_33 ) ;
if ( V_17 )
return 0 ;
...
#endif
F_38 ( V_20 -> V_28 >= V_68 ) ;
if ( F_39 ( V_69 , V_20 -> V_28 ) != NULL &&
F_39 ( V_69 , V_20 -> V_28 ) != V_33 ) {
F_40 ( & V_33 -> V_2 ,
L_21 ,
V_20 -> V_28 ) ;
goto V_70;
