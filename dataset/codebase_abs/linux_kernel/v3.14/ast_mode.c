...
static void F_15 ( struct V_95 * V_12 , struct V_20 * V_21 ,
struct V_23 * V_24 )
{
struct V_1 * V_2 = V_12 -> V_13 ;
T_1 V_77 ;
...
static void F_17 ( struct V_10 * V_11 , unsigned V_93 )
{
struct V_1 * V_2 = V_11 -> V_12 -> V_13 ;
T_2 V_113 ;
V_113 = V_93 >> 2 ;
...
static int F_40 ( struct V_95 * V_12 )
{
struct V_14 * V_11 ;
int V_15 ;
...
static int F_55 ( struct V_95 * V_12 )
{
struct V_153 * V_153 ;
...
static int F_69 ( struct V_95 * V_12 )
{
struct V_158 * V_158 ;
struct V_147 * V_148 ;
struct V_145 * V_146 ;
...
static int F_76 ( struct V_95 * V_12 )
{
struct V_1 * V_2 = V_12 -> V_13 ;
int V_138 ;
int V_128 ;
...
static void F_80 ( struct V_95 * V_12 )
{
struct V_1 * V_2 = V_12 -> V_13 ;
F_81 ( & V_2 -> V_180 ) ;
F_82 ( V_2 -> V_181 ) ;
