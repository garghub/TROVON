...
if ( ( ! V_6 -> V_179 &&
F_42 ( V_3 , V_180 , V_6 -> V_178 ) )
|| F_42 ( V_3 , V_181 , V_6 -> V_178 ) ||
V_6 -> V_40 -> V_80 ( V_3 ) )
return - V_60 ;
return 0 ;
}
...
static inline int F_68 ( struct V_2 * V_3 )
{
return - V_71 ;
}
...
( ( V_6 -> V_22 != V_79 &&
V_6 -> V_22 != V_189 ) ||
( V_6 -> V_212 < F_50 ( 1 , 3 , 1 ) ) ) )
return - V_71 ;
}
if ( V_6 -> V_212 >= F_50 ( 1 , 3 , 1 ) )
V_89 = F_67 ( V_3 , V_177 , V_299 ) ;
else
V_89 = F_68 ( V_3 ) ;
if ( V_89 == 0 )
V_6 -> V_313 = V_314 ;
...
V_318 = F_71 ( V_45 , V_318 , V_319 , & V_322 ,
V_326 ) ;
memset ( & V_322 , 0 , sizeof( V_322 ) ) ;
V_322 . V_248 = V_327 ;
V_322 . V_150 . V_110 . V_72 = V_299 ;
V_322 . V_150 . V_110 . V_55 = 1 ;
V_318 = F_72 ( V_45 , V_318 , V_319 ,
& V_322 , V_177 ) ;
memset ( & V_322 , 0 , sizeof( V_322 ) ) ;
V_322 . V_248 = V_328 ;
if ( V_317 ) {
...
F_73 ( F_6 ( V_315 -> V_339 ) ) ;
V_322 . V_150 . V_26 . V_33 =
F_73 ( F_6 ( V_315 -> V_340 ) ) ;
}
...
V_318 = F_72 ( V_45 , V_318 , V_319 , & V_322 , L_55 ) ;
if ( V_315 ) {
memset ( & V_322 , 0 , sizeof( V_322 ) ) ;
V_322 . V_248 = V_348 ;
V_323 = V_318 + F_74 ( V_45 ) ;
V_325 = V_315 -> V_349 ;
...
static inline int F_76 ( T_1 * V_6 ,
struct V_44 * V_45 ,
...
struct V_364 * V_365 ;
F_77 ( & V_6 -> V_130 ) ;
F_78 (ptr, &local->bss_list) {
struct V_316 * V_317 ;
V_317 = F_79 ( V_365 , struct V_316 , V_366 ) ;
V_317 -> V_367 = 0 ;
}
...
struct V_316 * V_317 ;
V_317 = F_79 ( V_365 , struct V_316 , V_366 ) ;
if ( F_36 ( V_317 -> V_126 , V_315 -> V_126 ) ) {
V_317 -> V_367 = 1 ;
V_318 = F_70 (
...
if ( V_317 -> V_367 )
continue;
V_318 = F_70 ( V_6 , V_45 , NULL , V_317 ,
V_318 , V_319 ) ;
if ( ( V_319 - V_318 ) <= V_326 ) {
F_80 ( & V_6 -> V_130 ) ;
return - V_369 ;
...
V_6 = V_5 -> V_6 ;
if ( V_6 -> V_313 &&
F_82 ( V_314 , V_6 -> V_313 + 3 * V_371 ) ) {
return - V_372 ;
}
V_6 -> V_313 = 0 ;
V_370 = F_76 ( V_6 , V_45 , V_47 , V_110 -> V_72 ) ;
if ( V_370 >= 0 ) {
V_110 -> V_72 = V_370 ;
return 0 ;
} else {
...
return F_81 ( V_3 , V_45 , V_110 , V_47 ) ;
}
}
static int F_85 ( struct V_2 * V_3 , int * V_48 )
{
struct V_4 * V_5 ;
T_1 * V_6 ;
V_5 = F_2 ( V_3 ) ;
...
T_6 V_423 ;
F_91 ( & V_423 , V_424 ) ;
F_92 ( & V_6 -> V_425 , & V_423 ) ;
F_93 ( V_426 ) ;
F_94 ( V_371 ) ;
if ( F_95 ( V_424 ) )
V_89 = - V_427 ;
F_93 ( V_428 ) ;
F_96 ( & V_6 -> V_425 , & V_423 ) ;
if ( F_20 ( V_3 , V_244 ,
V_429 ) ||
V_6 -> V_40 -> V_80 ( V_3 ) )
F_15 ( V_78 L_69
...
if ( F_97 ( & V_6 -> V_432 ) )
F_98 ( & V_6 -> V_432 ) ;
if ( V_99 > 0 && V_99 < V_433 / V_371 ) {
V_6 -> V_432 . V_434 = V_314 +
V_6 -> V_431 * V_371 ;
F_99 ( & V_6 -> V_432 ) ;
}
break;
...
break;
case V_443 :
V_89 = F_102 ( V_6 , V_99 , 1 ) ;
break;
case V_444 :
V_6 -> V_445 = V_99 ;
if ( V_6 -> V_212 < F_50 ( 1 , 7 , 0 ) )
V_89 = - V_71 ;
else if ( F_20 ( V_3 , V_446 ,
V_99 ? 1 : 0 ) )
V_89 = - V_60 ;
break;
case V_447 :
...
V_456 = * V_47 ;
V_39 = * ( V_47 + 1 ) ;
if ( V_6 -> V_40 -> V_248 ( V_3 , V_287 , V_456 , & V_39 , NULL ) )
return - V_71 ;
return 0 ;
}
static int F_106 ( struct V_2 * V_3 , int * V_48 )
{
struct V_4 * V_5 ;
T_1 * V_6 ;
int V_89 = 0 ;
...
F_15 ( V_78 L_77
L_78 ,
V_3 -> V_46 , F_107 ( V_424 ) , V_424 -> V_457 ) ;
if ( * V_48 == 0 ) {
V_252 = V_23 ;
V_89 = F_54 ( V_3 , NULL , & V_252 , NULL ) ;
} else if ( * V_48 == 1 ) {
V_89 = - V_71 ;
...
static int F_108 ( struct V_2 * V_3 , int * V_48 )
{
struct V_4 * V_5 ;
T_1 * V_6 ;
V_5 = F_2 ( V_3 ) ;
...
switch ( * V_48 ) {
case 0 :
V_6 -> V_40 -> V_458 ( V_3 , 1 ) ;
V_6 -> V_40 -> V_459 ( V_3 , 0 ) ;
break;
case 1 :
V_6 -> V_40 -> V_460 ( V_3 ) ;
break;
...
break;
case 4 :
if ( V_6 -> V_40 -> V_248 ( V_3 , V_463 , 0 , NULL ,
NULL ) )
return - V_60 ;
break;
default:
...
static int F_110 ( struct V_2 * V_3 , int * V_48 )
{
int V_464 = * V_48 ;
int V_99 = * ( V_48 + 1 ) ;
F_15 ( V_78 L_81 , V_3 -> V_46 , V_464 , V_99 ) ;
if ( F_20 ( V_3 , V_464 , V_99 ) )
return - V_60 ;
return 0 ;
}
static int F_111 ( T_1 * V_6 , int * V_248 )
{
int V_89 = 0 ;
switch ( * V_248 ) {
case V_465 :
V_6 -> V_104 -> V_466 . V_467 = V_468 ;
break;
case V_469 :
V_6 -> V_104 -> V_466 . V_467 = V_470 ;
break;
case V_471 :
V_6 -> V_104 -> V_466 . V_467 = V_472 ;
break;
case V_473 :
F_112 ( & V_6 -> V_104 -> V_466 ) ;
break;
case V_474 :
F_113 ( V_6 -> V_104 ) ;
F_114 ( V_6 -> V_3 , V_6 -> V_104 , 0 ) ;
break;
default:
V_89 = - V_71 ;
break;
...
static int F_115 ( T_1 * V_6 , struct V_50 * V_475 )
{
struct V_476 * V_375 ;
int V_89 = 0 ;
if ( V_475 -> V_72 < sizeof( struct V_476 ) ||
V_475 -> V_72 > 1024 || ! V_475 -> V_477 )
return - V_60 ;
V_375 = F_27 ( V_475 -> V_72 , V_65 ) ;
if ( V_375 == NULL )
return - V_66 ;
if ( F_116 ( V_375 , V_475 -> V_477 , V_475 -> V_72 ) ) {
V_89 = - V_478 ;
goto V_479;
}
if ( V_475 -> V_72 < sizeof( struct V_476 ) +
V_375 -> V_480 * sizeof( struct V_481 ) ) {
V_89 = - V_60 ;
goto V_479;
}
V_89 = V_6 -> V_40 -> V_482 ( V_6 , V_375 ) ;
V_479:
F_14 ( V_375 ) ;
return V_89 ;
}
static int F_117 ( struct V_2 * V_3 , T_2 * V_483 ,
T_5 V_38 )
{
...
return - V_66 ;
* ( ( V_43 * ) V_37 ) = F_30 ( V_38 ) ;
memcpy ( V_37 + 2 , V_483 , V_38 ) ;
F_14 ( V_6 -> V_484 ) ;
V_6 -> V_484 = V_37 ;
V_6 -> V_485 = V_38 + 2 ;
return V_6 -> V_40 -> V_117 ( V_6 -> V_3 , V_486 ,
V_37 , V_38 + 2 ) ;
}
...
break;
case V_492 :
V_6 -> V_450 = V_110 -> V_99 ;
break;
case V_493 :
V_6 -> V_452 = V_110 -> V_99 ;
break;
case V_494 :
...
return - V_71 ;
case V_492 :
V_110 -> V_99 = V_6 -> V_450 ;
break;
case V_493 :
V_110 -> V_99 = V_6 -> V_452 ;
break;
case V_494 :
V_110 -> V_99 = V_6 -> V_401 ;
break;
case V_495 :
V_110 -> V_99 = V_6 -> V_445 ;
break;
case V_496 :
...
struct V_4 * V_5 = F_2 ( V_3 ) ;
T_1 * V_6 = V_5 -> V_6 ;
struct V_498 * V_499 = (struct V_498 * ) V_47 ;
int V_48 , V_89 = 0 ;
struct V_500 * V_63 ;
struct V_53 * * V_54 ;
void * V_501 ;
T_2 * V_112 ;
const char * V_502 , * V_503 ;
V_48 = V_51 -> V_55 & V_56 ;
if ( V_48 > V_59 )
return - V_60 ;
if ( V_48 < 1 || V_48 > V_59 )
...
if ( V_48 != 0 )
return - V_60 ;
V_501 = F_122 ( V_6 -> V_104 , V_112 , 0 , & V_54 ) ;
if ( V_501 == NULL ) {
if ( V_6 -> V_22 == V_79 ) {
V_48 = 0 ;
V_54 = & V_6 -> V_57 . V_54 [ V_48 ] ;
...
if ( ( ! ( V_499 -> V_508 & V_509 ) || V_499 -> V_510 > 0 )
&& ( * V_54 ) -> V_63 -> V_75 &&
( * V_54 ) -> V_63 -> V_75 ( V_499 -> V_81 , V_499 -> V_510 , V_499 -> V_511 ,
( * V_54 ) -> V_68 ) < 0 ) {
F_15 ( V_78 L_88 ,
V_6 -> V_3 -> V_46 ) ;
V_89 = - V_60 ;
...
if ( V_499 -> V_508 & V_509 ) {
if ( ! V_501 )
V_6 -> V_57 . V_58 = V_48 ;
}
if ( V_501 == NULL && V_499 -> V_510 > 0 ) {
int V_73 = 1 , V_74 ;
for ( V_74 = 0 ; V_74 < V_59 ; V_74 ++ ) {
if ( V_74 != V_48 && V_6 -> V_57 . V_54 [ V_74 ] ) {
V_73 = 0 ;
...
struct V_53 * * V_54 ;
void * V_501 ;
V_375 -> V_150 . V_54 . V_517 = 0 ;
V_375 -> V_150 . V_54 . V_502 [ V_518 - 1 ] = '\0' ;
if ( V_516 !=
( int ) ( ( char * ) V_375 -> V_150 . V_54 . V_81 - ( char * ) V_375 ) +
V_375 -> V_150 . V_54 . V_510 )
return - V_60 ;
if ( F_121 ( V_375 -> V_519 ) ) {
if ( V_375 -> V_150 . V_54 . V_520 >= V_59 )
return - V_60 ;
V_501 = NULL ;
V_54 = & V_6 -> V_57 . V_54 [ V_375 -> V_150 . V_54 . V_520 ] ;
} else {
if ( V_375 -> V_150 . V_54 . V_520 )
return - V_60 ;
V_501 = F_122 (
V_6 -> V_104 , V_375 -> V_519 ,
( V_375 -> V_150 . V_54 . V_55 & V_521 ) ,
& V_54 ) ;
if ( V_501 == NULL ) {
V_375 -> V_150 . V_54 . V_517 = V_522 ;
return - V_60 ;
}
}
if ( strcmp ( V_375 -> V_150 . V_54 . V_502 , L_89 ) == 0 ) {
if ( V_54 )
F_9 ( & V_6 -> V_57 , V_54 ) ;
goto V_62;
}
V_63 = F_11 ( V_375 -> V_150 . V_54 . V_502 ) ;
if ( V_63 == NULL && strcmp ( V_375 -> V_150 . V_54 . V_502 , L_3 ) == 0 ) {
F_12 ( L_4 ) ;
V_63 = F_11 ( V_375 -> V_150 . V_54 . V_502 ) ;
} else if ( V_63 == NULL && strcmp ( V_375 -> V_150 . V_54 . V_502 , L_82 ) == 0 ) {
F_12 ( L_83 ) ;
V_63 = F_11 ( V_375 -> V_150 . V_54 . V_502 ) ;
} else if ( V_63 == NULL && strcmp ( V_375 -> V_150 . V_54 . V_502 , L_84 ) == 0 ) {
F_12 ( L_85 ) ;
V_63 = F_11 ( V_375 -> V_150 . V_54 . V_502 ) ;
}
if ( V_63 == NULL ) {
F_15 ( V_78 L_87 ,
V_6 -> V_3 -> V_46 , V_375 -> V_150 . V_54 . V_502 ) ;
V_375 -> V_150 . V_54 . V_517 = V_523 ;
V_89 = - V_60 ;
goto V_62;
}
V_6 -> V_406 = V_6 -> V_255 = 1 ;
...
V_64 -> V_63 = V_63 ;
V_64 -> V_68 = V_64 -> V_63 -> V_69 ( V_375 -> V_150 . V_54 . V_520 ) ;
if ( V_64 -> V_68 == NULL ) {
F_14 ( V_64 ) ;
V_375 -> V_150 . V_54 . V_517 =
V_524 ;
V_89 = - V_60 ;
goto V_62;
}
...
if ( ( ! ( V_375 -> V_150 . V_54 . V_55 & V_525 ) ||
V_375 -> V_150 . V_54 . V_510 > 0 ) && ( * V_54 ) -> V_63 -> V_75 &&
( * V_54 ) -> V_63 -> V_75 ( V_375 -> V_150 . V_54 . V_81 ,
V_375 -> V_150 . V_54 . V_510 , V_375 -> V_150 . V_54 . V_526 ,
( * V_54 ) -> V_68 ) < 0 ) {
F_15 ( V_78 L_88 ,
V_6 -> V_3 -> V_46 ) ;
V_375 -> V_150 . V_54 . V_517 = V_527 ;
V_89 = - V_60 ;
goto V_62;
}
if ( V_375 -> V_150 . V_54 . V_55 & V_525 ) {
if ( ! V_501 )
V_6 -> V_57 . V_58 = V_375 -> V_150 . V_54 . V_520 ;
else if ( V_375 -> V_150 . V_54 . V_520 ) {
F_15 ( V_78 L_90 ,
V_6 -> V_3 -> V_46 ) ;
V_375 -> V_150 . V_54 . V_517 =
V_528 ;
...
V_501 = NULL ;
if ( V_375 -> V_150 . V_54 . V_520 >= V_59 )
V_375 -> V_150 . V_54 . V_520 = V_6 -> V_57 . V_58 ;
V_54 = & V_6 -> V_57 . V_54 [ V_375 -> V_150 . V_54 . V_520 ] ;
} else {
V_375 -> V_150 . V_54 . V_520 = 0 ;
V_501 = F_122 ( V_6 -> V_104 , V_375 -> V_519 , 0 ,
& V_54 ) ;
if ( V_501 == NULL ) {
V_375 -> V_150 . V_54 . V_517 = V_522 ;
return - V_60 ;
...
if ( * V_54 == NULL || ( * V_54 ) -> V_63 == NULL ) {
memcpy ( V_375 -> V_150 . V_54 . V_502 , L_89 , 5 ) ;
V_375 -> V_150 . V_54 . V_510 = 0 ;
V_375 -> V_150 . V_54 . V_520 = 0xff ;
} else {
strncpy ( V_375 -> V_150 . V_54 . V_502 , ( * V_54 ) -> V_63 -> V_46 ,
V_518 ) ;
V_375 -> V_150 . V_54 . V_510 = 0 ;
memset ( V_375 -> V_150 . V_54 . V_526 , 0 , 8 ) ;
if ( ( * V_54 ) -> V_63 -> V_83 ) {
V_375 -> V_150 . V_54 . V_510 =
( * V_54 ) -> V_63 -> V_83 ( V_375 -> V_150 . V_54 . V_81 ,
V_512 ,
V_375 -> V_150 . V_54 . V_526 ,
( * V_54 ) -> V_68 ) ;
}
}
if ( V_501 )
...
if ( V_530 < 0 )
return - V_60 ;
V_370 = V_6 -> V_40 -> V_41 ( V_6 -> V_3 , V_375 -> V_150 . V_464 . V_464 ,
V_375 -> V_150 . V_464 . V_110 , V_375 -> V_150 . V_464 . V_38 , 0 ) ;
if ( V_370 >= 0 ) {
V_375 -> V_150 . V_464 . V_38 = V_370 ;
return 0 ;
}
return V_370 ;
}
static int F_128 ( T_1 * V_6 ,
struct V_515 * V_375 ,
int V_516 )
{
int V_530 ;
V_530 = V_516 - V_531 ;
if ( V_530 < 0 || V_530 < V_375 -> V_150 . V_464 . V_38 )
return - V_60 ;
return V_6 -> V_40 -> V_117 ( V_6 -> V_3 , V_375 -> V_150 . V_464 . V_464 ,
V_375 -> V_150 . V_464 . V_110 , V_375 -> V_150 . V_464 . V_38 ) ;
}
static int F_129 ( T_1 * V_6 ,
struct V_515 * V_375 ,
int V_516 )
{
F_15 ( V_78 L_91 ,
V_6 -> V_3 -> V_46 , V_375 -> V_519 ) ;
memcpy ( V_6 -> V_148 , V_375 -> V_519 , V_128 ) ;
return 0 ;
}
...
struct V_50 * V_110 , char * V_47 )
{
return F_117 ( V_3 , V_47 , V_110 -> V_72 ) ;
}
...
struct V_4 * V_5 = F_2 ( V_3 ) ;
T_1 * V_6 = V_5 -> V_6 ;
int V_38 = V_6 -> V_485 - 2 ;
if ( V_38 <= 0 || V_6 -> V_484 == NULL ) {
V_110 -> V_72 = 0 ;
return 0 ;
}
if ( V_110 -> V_72 < V_38 )
return - V_369 ;
V_110 -> V_72 = V_38 ;
memcpy ( V_47 , V_6 -> V_484 + 2 , V_38 ) ;
return 0 ;
}
static int F_132 ( T_1 * V_6 ,
struct V_515 * V_375 ,
int V_516 )
{
int V_530 , V_38 ;
V_38 = V_375 -> V_150 . V_484 . V_38 ;
V_530 = V_516 - V_532 ;
if ( V_530 < 0 || V_530 < V_38 )
return - V_60 ;
return F_117 ( V_6 -> V_3 ,
V_375 -> V_150 . V_484 . V_110 , V_38 ) ;
}
...
struct V_4 * V_5 = F_2 ( V_3 ) ;
T_1 * V_6 = V_5 -> V_6 ;
struct V_533 * V_534 = (struct V_533 * ) V_47 ;
V_43 V_535 ;
V_535 = F_30 ( V_534 -> V_536 ) ;
switch ( V_534 -> V_248 ) {
case V_537 :
return F_134 ( V_6 , V_534 -> V_112 . V_136 ,
V_538 ,
( T_2 * ) & V_535 , 2 ) ;
case V_539 :
return F_134 ( V_6 , V_534 -> V_112 . V_136 ,
...
{
V_43 V_535 ;
V_535 = F_30 ( V_375 -> V_150 . V_534 . V_536 ) ;
switch ( V_375 -> V_150 . V_534 . V_248 ) {
case V_541 :
return F_134 ( V_6 , V_375 -> V_519 ,
V_538 ,
( T_2 * ) & V_535 , 2 ) ;
case V_542 :
return F_134 ( V_6 , V_375 -> V_519 ,
...
if ( ! V_6 -> V_309 )
return - V_310 ;
return F_67 ( V_6 -> V_3 , V_375 -> V_150 . V_139 . V_177 ,
V_375 -> V_150 . V_139 . V_299 ) ;
#else
return - V_71 ;
#endif
}
static int F_137 ( T_1 * V_6 , struct V_50 * V_475 )
{
struct V_515 * V_375 ;
int V_89 = 0 ;
int V_543 = 0 ;
if ( V_475 -> V_72 < sizeof( struct V_515 ) ||
V_475 -> V_72 > V_544 || ! V_475 -> V_477 )
return - V_60 ;
V_375 = F_27 ( V_475 -> V_72 , V_65 ) ;
if ( V_375 == NULL )
return - V_66 ;
...
switch ( V_375 -> V_248 ) {
case V_545 :
V_89 = F_125 ( V_6 , V_375 , V_475 -> V_72 ) ;
break;
case V_546 :
V_89 = F_126 ( V_6 , V_375 , V_475 -> V_72 ) ;
break;
case V_547 :
V_89 = F_127 ( V_6 , V_375 , V_475 -> V_72 ) ;
break;
case V_548 :
V_89 = F_128 ( V_6 , V_375 , V_475 -> V_72 ) ;
break;
case V_549 :
V_89 = F_129 ( V_6 , V_375 , V_475 -> V_72 ) ;
break;
case V_550 :
V_89 = F_132 ( V_6 , V_375 ,
V_475 -> V_72 ) ;
break;
case V_551 :
V_89 = F_135 ( V_6 , V_375 ) ;
break;
case V_552 :
V_89 = F_136 ( V_6 , V_375 ) ;
break;
default:
V_89 = F_138 ( V_6 -> V_104 , V_375 ) ;
V_543 = 1 ;
break;
}
if ( V_89 == 1 || ! V_543 ) {
if ( F_139 ( V_475 -> V_477 , V_375 , V_475 -> V_72 ) ) {
V_89 = - V_478 ;
goto V_479;
} else if ( V_543 )
V_89 = 0 ;
...
V_5 = F_2 ( V_3 ) ;
V_6 = V_5 -> V_6 ;
F_141 ( V_45 -> V_554 , L_92 , sizeof( V_45 -> V_554 ) ) ;
snprintf ( V_45 -> V_555 , sizeof( V_45 -> V_555 ) ,
L_93 , ( V_6 -> V_212 >> 16 ) & 0xff ,
( V_6 -> V_212 >> 8 ) & 0xff ,
V_6 -> V_212 & 0xff ) ;
}
int F_142 ( struct V_2 * V_3 , struct V_556 * V_557 , int V_248 )
{
struct V_558 * V_257 = (struct V_558 * ) V_557 ;
struct V_4 * V_5 ;
T_1 * V_6 ;
int V_89 = 0 ;
V_5 = F_2 ( V_3 ) ;
...
switch ( V_248 ) {
case V_559 :
if ( ! F_143 ( V_560 ) ) V_89 = - V_561 ;
else V_89 = F_85 ( V_3 , ( int * ) V_257 -> V_150 . V_46 ) ;
break;
case V_562 :
if ( ! F_143 ( V_560 ) ) V_89 = - V_561 ;
else V_89 = F_106 ( V_3 , ( int * ) V_257 -> V_150 . V_46 ) ;
break;
case V_563 :
if ( ! F_143 ( V_560 ) ) V_89 = - V_561 ;
else V_89 = F_108 ( V_3 , ( int * ) V_257 -> V_150 . V_46 ) ;
break;
case V_564 :
if ( ! F_143 ( V_560 ) ) V_89 = - V_561 ;
else V_89 = F_144 ( V_6 , V_257 -> V_150 . V_135 . V_136 , 1 ) ;
break;
case V_565 :
if ( ! F_143 ( V_560 ) ) V_89 = - V_561 ;
else V_89 = F_145 ( V_6 , V_257 -> V_150 . V_135 . V_136 , 1 , 0 ) ;
break;
case V_566 :
if ( ! F_143 ( V_560 ) ) V_89 = - V_561 ;
else V_89 = F_110 ( V_3 ,
...
case V_567 :
if ( ! F_143 ( V_560 ) ) V_89 = - V_561 ;
else V_89 = F_111 ( V_6 , ( int * ) V_257 -> V_150 . V_46 ) ;
break;
case V_568 :
if ( ! F_143 ( V_560 ) ) V_89 = - V_561 ;
else V_89 = F_147 ( & V_6 -> V_104 -> V_466 ,
V_257 -> V_150 . V_135 . V_136 ) ;
break;
case V_569 :
if ( ! F_143 ( V_560 ) ) V_89 = - V_561 ;
else V_89 = F_148 ( & V_6 -> V_104 -> V_466 ,
V_257 -> V_150 . V_135 . V_136 ) ;
break;
case V_570 :
if ( ! F_143 ( V_560 ) ) V_89 = - V_561 ;
else V_89 = F_149 ( V_6 -> V_104 , V_6 -> V_3 ,
V_257 -> V_150 . V_135 . V_136 ) ;
break;
#endif
#ifdef F_150
case V_571 :
if ( ! F_143 ( V_560 ) ) V_89 = - V_561 ;
else V_89 = F_115 ( V_6 , & V_257 -> V_150 . V_110 ) ;
break;
#endif
case V_572 :
if ( ! F_143 ( V_560 ) ) V_89 = - V_561 ;
else V_89 = F_137 ( V_6 , & V_257 -> V_150 . V_110 ) ;
break;
default:
V_89 = - V_71 ;
break;
