...
F_82 () ;
V_180:
F_114 ( V_9 -> V_183 , & V_9 -> V_177 , V_184 ) ;
}
...
void F_117 ( struct V_8 * V_9 , struct V_21 * V_21 , char V_185 )
{
struct V_28 * V_29 = & ( F_5 ( V_9 ) ) ;
if ( V_185 == V_186 ) {
F_16 ( V_9 , V_21 , 0 ) ;
...
void F_118 ( struct V_8 * V_9 , struct V_21 * V_188 )
