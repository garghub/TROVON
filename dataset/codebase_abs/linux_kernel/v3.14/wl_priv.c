...
if ( V_4 -> V_18 . V_39 != 0 ) {
T_3 * V_23 ;
V_15 = F_21 ( V_40 , V_2 -> V_23 , V_2 -> V_38 ) ;
if ( V_15 != 0 ) {
F_10 ( V_8 , L_18 , V_15 ) ;
V_2 -> V_15 = V_35 ;
return V_15 ;
...
case V_196 :
if ( V_4 -> V_197 ) {
F_32 ( & ( V_4 -> V_18 ) , V_210 | V_46 ) ;
F_32 ( & ( V_4 -> V_18 ) , V_211 ) ;
} else {
F_32 ( & ( V_4 -> V_18 ) , V_212 | V_46 ) ;
F_32 ( & ( V_4 -> V_18 ) , V_213 ) ;
}
break;
default:
F_33 ( V_4 ) ;
V_2 -> V_15 = F_34 ( & ( V_4 -> V_18 ) , ( V_214 ) V_49 ) ;
F_35 ( V_4 ) ;
break;
}
if ( V_50 )
...
V_15 = F_21 ( V_40 , V_2 -> V_23 , sizeof( T_7 ) * 2 ) ;
if ( V_15 != 0 ) {
F_10 ( V_8 , L_22 ) ;
V_2 -> V_15 = V_35 ;
return V_15 ;
}
V_15 = F_26 ( & ( V_4 -> V_53 ) , V_2 -> V_23 , sizeof( T_7 ) * 2 ) ;
if ( ( ( V_4 -> V_53 . V_38 + 1 ) * sizeof( T_7 ) ) > V_2 -> V_38 ) {
F_10 ( V_8 , L_27 ) ;
V_2 -> V_38 = sizeof( V_4 -> V_53 ) ;
V_2 -> V_15 = V_31 ;
...
F_27 ( V_4 -> V_18 . V_219 . V_220 ) == V_221 ;
break;
case V_190 :
case V_222 :
case V_196 :
...
case V_165 :
default:
V_15 = F_21 ( V_225 , V_2 -> V_23 , V_2 -> V_38 ) ;
if ( V_15 != 0 ) {
F_10 ( V_8 , L_31 ) ;
V_2 -> V_15 = V_35 ;
break;
...
F_33 ( V_4 ) ;
V_2 -> V_15 = F_38 ( & ( V_4 -> V_18 ) , ( V_214 ) V_49 ) ;
F_35 ( V_4 ) ;
break;
}
switch ( V_4 -> V_53 . V_24 ) {
...
V_15 = F_21 ( V_225 , V_2 -> V_23 , sizeof( V_4 -> V_226 ) ) ;
if ( V_15 != 0 ) {
V_2 -> V_15 = V_35 ;
return V_15 ;
}
...
V_15 = F_21 ( V_225 , V_2 -> V_23 , sizeof( V_4 -> V_229 ) ) ;
if ( V_15 != 0 ) {
V_2 -> V_15 = V_35 ;
return V_15 ;
}
...
V_4 -> V_53 . V_24 = V_170 ;
V_238 = F_38 ( & ( V_4 -> V_18 ) , ( V_214 ) & ( V_4 -> V_53 ) ) ;
if ( V_238 == V_240 ) {
...
F_42 ( V_4 , & V_16 ) ;
memset ( V_4 -> V_75 , 0 , sizeof( V_4 -> V_75 ) ) ;
V_38 = F_28 ( T_6 , V_234 -> V_23 . V_237 , sizeof( V_4 -> V_75 ) ) ;
