...
static void F_54 ( struct V_38 * V_39 , const char * V_131 , ... ) {
T_3 V_132 ;
char V_133 [ 1024 ] ;
int V_32 ;
unsigned long V_6 ;
T_4 V_134 ;
F_16 ( V_49 , V_6 ) ;
va_start ( V_132 , V_131 ) ;
V_32 = vsnprintf ( V_133 , sizeof( V_133 ) , V_131 , V_132 ) ;
va_end ( V_132 ) ;
F_66 ( ( V_133 ) ) ;
if ( ! V_39 || ! V_39 -> V_50 ) {
F_6 ( L_11 , V_133 ) ;
...
V_134 = strlen ( V_133 ) + 1 ;
if ( V_39 -> V_50 - V_39 -> V_48 < V_134 )
V_134 = V_39 -> V_50 - V_39 -> V_48 ;
memcpy ( V_39 -> V_50 , V_133 , V_134 ) ;
V_39 -> V_50 += V_134 ;
F_19 ( V_49 , V_6 ) ;
}
int F_67 ( T_1 V_135 )
{
V_136 -> V_78 = V_137 ;
F_68 ( ( V_135 * V_138 ) / 1000 ) ;
return ( F_69 ( V_136 ) ) ;
}
char * F_70 ( int V_98 )
{
switch( V_98 ) {
case V_139 : return ( L_28 ) ;
case V_140 : return ( L_29 ) ;
case V_141 : return ( L_30 ) ;
case V_142 : return ( L_31 ) ;
case V_143 : return ( L_32 ) ;
case V_144 : return ( L_33 ) ;
case V_145 : return ( L_34 ) ;
case V_146 : return ( L_35 ) ;
case V_147 : return ( L_36 ) ;
case V_148 : return ( L_37 ) ;
case V_149 : return ( L_38 ) ;
case V_150 : return ( L_39 ) ;
case V_151 : return ( L_40 ) ;
case V_152 : return ( L_41 ) ;
case V_153 : return ( L_42 ) ;
case V_154 : return ( L_43 ) ;
case V_155 : return ( L_44 ) ;
case V_156 : return ( L_45 ) ;
case V_157 : return ( L_46 ) ;
case V_158 : return ( L_47 ) ;
case V_159 : return ( L_48 ) ;
case V_160 : return ( L_49 ) ;
case V_161 : return ( L_50 ) ;
case V_162 : return ( L_51 ) ;
case V_163 : return ( L_52 ) ;
case V_164 : return ( L_53 ) ;
case V_165 : return ( L_54 ) ;
case V_166 : return ( L_55 ) ;
case V_167 : return ( L_56 ) ;
case V_168 : return ( L_57 ) ;
case V_169 : return ( L_58 ) ;
case V_170 : return ( L_59 ) ;
case V_171 : return ( L_60 ) ;
case V_172 : return ( L_61 ) ;
case V_173 : return ( L_62 ) ;
case V_174 : return ( L_63 ) ;
default: return ( L_64 ) ;
}
}
