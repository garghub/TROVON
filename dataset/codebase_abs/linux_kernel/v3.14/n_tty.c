...
if ( V_8 -> V_105 && ! V_8 -> V_106 && F_98 ( V_8 ) && F_108 ( V_8 ) ) {
F_99 ( V_8 ) ;
F_59 ( V_8 ) ;
}
if ( V_43 == '\r' ) {
...
{
struct V_1 * V_2 = V_8 -> V_11 ;
bool V_120 = F_123 ( V_8 ) || ( F_124 ( V_8 ) && F_112 ( V_8 ) ) ;
if ( V_2 -> V_121 )
F_128 ( V_8 , V_68 , V_118 , V_38 ) ;
else if ( V_2 -> V_122 || ( F_134 ( V_8 ) && ! V_120 ) )
F_131 ( V_8 , V_68 , V_118 , V_38 ) ;
else if ( V_8 -> V_123 && ! F_134 ( V_8 ) )
F_132 ( V_8 , V_68 , V_118 , V_38 ) ;
else {
if ( V_2 -> V_107 ) {
char V_111 = V_117 ;
if ( V_118 )
...
if ( ! V_120 && ! F_10 ( V_8 ) )
F_135 ( V_8 , V_68 , V_118 , V_38 ) ;
else
F_133 ( V_8 , V_68 , V_118 , V_38 ) ;
F_60 ( V_8 ) ;
if ( V_8 -> V_35 -> V_86 )
V_8 -> V_35 -> V_86 ( V_8 ) ;
}
...
char * V_118 , int V_38 , int V_125 )
{
struct V_1 * V_2 = V_8 -> V_11 ;
int V_126 , V_23 , V_127 = 0 ;
F_89 ( & V_8 -> V_57 ) ;
while ( 1 ) {
V_126 = F_9 ( V_8 ) ;
V_23 = F_138 ( V_38 , V_126 ) ;
if ( ! V_23 ) {
if ( V_125 && ! V_126 )
V_2 -> V_15 = 1 ;
break;
}
F_136 ( V_8 , V_68 , V_118 , V_23 ) ;
V_68 += V_23 ;
if ( V_118 )
V_118 += V_23 ;
V_38 -= V_23 ;
...
char * V_118 , int V_38 )
{
F_137 ( V_8 , V_68 , V_118 , V_38 , 0 ) ;
}
static int F_140 ( struct V_7 * V_8 , const unsigned char * V_68 ,
char * V_118 , int V_38 )
{
return F_137 ( V_8 , V_68 , V_118 , V_38 , 1 ) ;
}
int F_141 ( int V_94 )
{
return ( F_142 ( & V_128 -> V_129 , V_94 ) ||
V_128 -> V_130 -> V_131 [ V_94 - 1 ] . V_132 . V_133 == V_134 ) ;
}
static void F_143 ( struct V_7 * V_8 , struct V_135 * V_81 )
{
struct V_1 * V_2 = V_8 -> V_11 ;
if ( ! V_81 || ( V_81 -> V_136 ^ V_8 -> V_137 . V_136 ) & V_138 ) {
F_30 ( V_2 -> V_50 , V_6 ) ;
V_2 -> V_48 = V_2 -> V_4 ;
...
F_118 ( '\n' , V_2 -> V_119 ) ;
if ( F_144 ( V_8 ) ) {
F_118 ( F_72 ( V_8 ) , V_2 -> V_119 ) ;
F_118 ( F_77 ( V_8 ) , V_2 -> V_119 ) ;
F_118 ( F_115 ( V_8 ) , V_2 -> V_119 ) ;
F_118 ( '\n' , V_2 -> V_119 ) ;
F_118 ( F_116 ( V_8 ) , V_2 -> V_119 ) ;
if ( F_112 ( V_8 ) ) {
F_118 ( F_73 ( V_8 ) , V_2 -> V_119 ) ;
F_118 ( F_113 ( V_8 ) , V_2 -> V_119 ) ;
F_118 ( F_117 ( V_8 ) , V_2 -> V_119 ) ;
if ( F_61 ( V_8 ) )
F_118 ( F_114 ( V_8 ) ,
V_2 -> V_119 ) ;
}
...
if ( F_98 ( V_8 ) ) {
F_118 ( F_101 ( V_8 ) , V_2 -> V_119 ) ;
F_118 ( F_102 ( V_8 ) , V_2 -> V_119 ) ;
}
if ( F_104 ( V_8 ) ) {
F_118 ( F_105 ( V_8 ) , V_2 -> V_119 ) ;
F_118 ( F_106 ( V_8 ) , V_2 -> V_119 ) ;
F_118 ( F_107 ( V_8 ) , V_2 -> V_119 ) ;
}
F_145 ( V_109 , V_2 -> V_119 ) ;
V_2 -> V_122 = 0 ;
V_2 -> V_121 = 0 ;
} else {
V_2 -> V_122 = 1 ;
...
F_11 ( V_8 ) ;
if ( ! F_98 ( V_8 ) && V_81 && ( V_81 -> V_140 & V_141 ) && ! V_8 -> V_106 ) {
F_99 ( V_8 ) ;
F_59 ( V_8 ) ;
}
if ( F_25 ( & V_8 -> V_39 ) )
...
static inline int F_152 ( struct V_7 * V_8 , int V_145 )
{
struct V_1 * V_2 = V_8 -> V_11 ;
int V_146 = V_145 && ! F_153 ( V_8 ) && F_154 ( V_8 ) ? F_154 ( V_8 ) : 1 ;
if ( V_2 -> V_12 && ! F_134 ( V_8 ) ) {
if ( V_2 -> V_14 != V_2 -> V_4 )
return 1 ;
} else if ( F_1 ( V_2 ) >= V_146 )
return 1 ;
return 0 ;
}
static int F_155 ( struct V_7 * V_8 ,
unsigned char T_2 * * V_147 ,
T_1 * V_67 )
{
struct V_1 * V_2 = V_8 -> V_11 ;
int V_65 ;
...
if ( V_23 ) {
V_65 = F_156 ( * V_147 , F_3 ( V_2 , V_71 ) , V_23 ) ;
V_23 -= V_65 ;
V_148 = V_23 == 1 && F_2 ( V_2 , V_71 ) == F_115 ( V_8 ) ;
F_7 ( V_8 , F_3 ( V_2 , V_71 ) , V_23 ,
V_2 -> V_12 ) ;
V_2 -> V_4 += V_23 ;
if ( F_134 ( V_8 ) && V_2 -> V_12 && V_148 && ! F_1 ( V_2 ) )
V_23 = 0 ;
* V_147 += V_23 ;
* V_67 -= V_23 ;
}
...
return 0 ;
V_71 = V_2 -> V_4 & ( V_6 - 1 ) ;
V_149 = F_130 ( T_1 , V_71 + V_23 , V_6 ) ;
F_158 ( L_8 ,
V_58 , * V_67 , V_71 , V_23 , V_149 ) ;
V_151 = F_159 ( V_2 -> V_50 , V_149 , V_71 ) ;
V_150 = V_23 - ( V_149 - V_71 ) ;
if ( V_151 == V_6 && V_150 ) {
V_151 = F_159 ( V_2 -> V_50 , V_150 , 0 ) ;
if ( V_151 != V_150 )
V_153 = 1 ;
} else if ( V_151 != V_149 )
V_153 = 1 ;
...
V_23 += V_153 ;
V_43 = V_23 ;
if ( V_153 && ! V_2 -> V_51 && F_2 ( V_2 , V_151 ) == V_109 ) {
V_23 -- ;
V_154 = ! V_23 && V_2 -> V_4 != V_2 -> V_48 ;
}
F_158 ( L_9 ,
V_58 , V_151 , V_153 , V_23 , V_43 , V_149 , V_150 ) ;
if ( V_23 > V_149 ) {
V_152 = F_156 ( * V_147 , F_3 ( V_2 , V_71 ) , V_149 ) ;
if ( V_152 )
return - V_155 ;
V_152 = F_156 ( * V_147 + V_149 , V_2 -> F_2 , V_23 - V_149 ) ;
} else
V_152 = F_156 ( * V_147 , F_3 ( V_2 , V_71 ) , V_23 ) ;
if ( V_152 )
return - V_155 ;
* V_147 += V_23 ;
* V_67 -= V_23 ;
if ( V_153 )
F_145 ( V_151 , V_2 -> V_50 ) ;
F_160 () ;
V_2 -> V_4 += V_43 ;
if ( V_153 ) {
if ( ! V_2 -> V_51 )
...
return V_154 ? - V_156 : 0 ;
}
static int F_162 ( struct V_7 * V_8 , struct V_157 * V_157 )
{
if ( V_157 -> V_158 -> V_63 == V_159 ||
V_128 -> signal -> V_8 != V_8 )
return 0 ;
F_163 ( & V_8 -> V_52 ) ;
if ( ! V_8 -> V_160 )
F_92 ( V_116 L_10 ) ;
else if ( F_164 ( V_128 ) != V_8 -> V_160 ) {
F_165 ( & V_8 -> V_52 ) ;
if ( F_141 ( V_161 ) || F_166 () )
return - V_162 ;
F_81 ( F_164 ( V_128 ) , V_161 , 1 ) ;
F_167 ( V_163 ) ;
return - V_164 ;
}
F_165 ( & V_8 -> V_52 ) ;
...
static T_3 F_168 ( struct V_7 * V_8 , struct V_157 * V_157 ,
unsigned char T_2 * V_21 , T_1 V_67 )
{
struct V_1 * V_2 = V_8 -> V_11 ;
unsigned char T_2 * V_147 = V_21 ;
F_169 ( V_165 , V_128 ) ;
int V_43 ;
int V_166 , time ;
T_3 V_65 = 0 ;
...
V_167 = ( V_101 / 10 ) * F_153 ( V_8 ) ;
V_2 -> V_124 = V_166 = 1 ;
}
}
V_53 = V_8 -> V_53 ;
F_172 ( & V_8 -> V_56 , & V_165 ) ;
while ( V_67 ) {
if ( V_53 && V_8 -> V_33 -> V_54 ) {
unsigned char V_171 ;
if ( V_147 != V_21 )
break;
F_32 ( & V_8 -> V_33 -> V_52 , V_19 ) ;
V_171 = V_8 -> V_33 -> V_54 ;
V_8 -> V_33 -> V_54 = 0 ;
F_34 ( & V_8 -> V_33 -> V_52 , V_19 ) ;
if ( F_6 ( V_8 , V_171 , V_147 ++ ) ) {
V_65 = - V_155 ;
V_147 -- ;
break;
}
...
F_173 ( V_172 ) ;
if ( ( ( V_166 - ( V_147 - V_21 ) ) < V_2 -> V_124 ) &&
( ( V_166 - ( V_147 - V_21 ) ) >= 1 ) )
V_2 -> V_124 = ( V_166 - ( V_147 - V_21 ) ) ;
if ( ! F_152 ( V_8 , 0 ) ) {
if ( F_14 ( V_173 , & V_8 -> V_19 ) ) {
F_87 ( & V_8 -> V_57 ) ;
F_174 ( V_8 ) ;
F_89 ( & V_8 -> V_57 ) ;
if ( ! F_152 ( V_8 , 0 ) ) {
...
static T_3 F_180 ( struct V_7 * V_8 , struct V_157 * V_157 ,
const unsigned char * V_21 , T_1 V_67 )
{
const unsigned char * V_147 = V_21 ;
F_169 ( V_165 , V_128 ) ;
int V_43 ;
T_3 V_65 = 0 ;
if ( F_181 ( V_8 ) && V_157 -> V_158 -> V_63 != V_159 ) {
V_65 = F_182 ( V_8 ) ;
if ( V_65 )
return V_65 ;
}
...
if ( F_175 ( V_157 ) || ( V_8 -> V_33 && ! V_8 -> V_33 -> V_38 ) ) {
V_65 = - V_162 ;
break;
}
if ( F_57 ( V_8 ) ) {
while ( V_67 > 0 ) {
T_3 V_177 = F_55 ( V_8 , V_147 , V_67 ) ;
if ( V_177 < 0 ) {
if ( V_177 == - V_156 )
break;
V_65 = V_177 ;
...
while ( V_67 > 0 ) {
V_43 = V_8 -> V_35 -> V_63 ( V_8 , V_147 , V_67 ) ;
if ( V_43 < 0 ) {
V_65 = V_43 ;
goto V_69;
}
...
V_69:
F_178 ( V_174 ) ;
F_179 ( & V_8 -> V_39 , & V_165 ) ;
if ( V_147 - V_21 != V_67 && V_8 -> V_24 )
F_118 ( V_25 , & V_8 -> V_19 ) ;
F_87 ( & V_8 -> V_57 ) ;
return ( V_147 - V_21 ) ? V_147 - V_21 : V_65 ;
}
static unsigned int F_184 ( struct V_7 * V_8 , struct V_157 * V_157 ,
T_4 * V_165 )
{
struct V_1 * V_2 = V_8 -> V_11 ;
unsigned int V_178 = 0 ;
F_185 ( V_157 , & V_8 -> V_56 , V_165 ) ;
F_185 ( V_157 , & V_8 -> V_39 , V_165 ) ;
if ( F_152 ( V_8 , 1 ) )
V_178 |= V_179 | V_180 ;
if ( V_8 -> V_53 && V_8 -> V_33 -> V_54 )
V_178 |= V_181 | V_179 | V_180 ;
if ( F_14 ( V_173 , & V_8 -> V_19 ) )
V_178 |= V_182 ;
if ( F_175 ( V_157 ) )
V_178 |= V_182 ;
if ( ! ( V_178 & ( V_182 | V_179 | V_180 ) ) ) {
if ( F_154 ( V_8 ) && ! F_153 ( V_8 ) )
V_2 -> V_124 = F_154 ( V_8 ) ;
else
V_2 -> V_124 = 1 ;
}
if ( V_8 -> V_35 -> V_63 && ! F_186 ( V_8 ) &&
F_187 ( V_8 ) < V_183 &&
F_53 ( V_8 ) > 0 )
V_178 |= V_40 | V_184 ;
return V_178 ;
}
static unsigned long F_188 ( struct V_1 * V_2 )
{
T_1 V_67 , V_83 , V_71 ;
if ( V_2 -> V_14 == V_2 -> V_4 )
return 0 ;
...
static int F_189 ( struct V_7 * V_8 , struct V_157 * V_157 ,
...
switch ( V_185 ) {
case V_187 :
return F_8 ( F_187 ( V_8 ) , ( int T_2 * ) V_186 ) ;
case V_188 :
F_36 ( & V_8 -> V_57 ) ;
if ( F_144 ( V_8 ) )
V_65 = F_188 ( V_2 ) ;
...
default:
return F_190 ( V_8 , V_157 , V_185 , V_186 ) ;
}
}
static void F_191 ( struct V_7 * V_8 , int V_189 )
{
struct V_1 * V_2 = V_8 -> V_11 ;
if ( ! F_25 ( & V_8 -> V_56 ) ) {
if ( V_189 )
