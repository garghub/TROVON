...
case V_98 :
V_71 -> V_195 . V_150 = V_71 -> V_165 << V_73 ;
V_71 -> V_195 . V_58 = F_113 ( V_2 -> V_197 , 1 ) ;
V_71 -> V_195 . V_107 = true ;
if ( F_17 ( V_10 -> V_15 ) -> V_42 >= V_43 ) {
struct V_198 * V_199 = V_198 ( V_10 -> V_15 ) ;
V_53 = V_199 -> V_200 ( V_199 , V_147 , V_170 ,
& V_147 -> V_201 ) ;
if ( V_53 )
return V_53 ;
V_71 -> V_195 . V_150 = V_147 -> V_201 . V_150 ;
}
break;
default:
return - V_62 ;
...
static void
F_114 ( struct V_112 * V_34 , struct V_143 * V_71 )
{
struct V_9 * V_10 = F_11 ( V_34 ) ;
struct V_198 * V_199 = V_198 ( V_10 -> V_15 ) ;
struct V_146 * V_147 = V_71 -> V_148 ;
if ( ! V_147 -> V_201 . V_147 )
return;
V_199 -> V_202 ( V_199 , & V_147 -> V_201 ) ;
}
static int
...
struct V_35 * V_36 = V_35 ( V_33 ) ;
struct V_41 * V_15 = F_17 ( V_10 -> V_15 ) ;
T_1 V_203 = F_116 ( V_15 -> V_197 , 1 ) >> V_73 ;
int V_53 ;
...
if ( F_17 ( V_10 -> V_15 ) -> V_42 >= V_43 ||
V_33 -> V_71 . V_165 + V_33 -> V_71 . V_72 < V_203 )
return 0 ;
V_36 -> V_74 . V_84 = 0 ;
V_36 -> V_74 . V_85 = V_203 ;
F_24 ( V_36 , V_77 , 0 ) ;
...
{
struct V_204 * V_205 = ( void * ) V_69 ;
struct V_9 * V_10 ;
struct V_1 * V_2 ;
unsigned V_11 ;
int V_206 ;
bool V_207 = ! ! ( V_69 -> V_113 & V_208 ) ;
if ( V_69 -> V_209 != V_210 )
return 0 ;
if ( V_207 && V_69 -> V_50 ) {
F_119 ( V_69 -> V_50 , V_69 -> V_211 ,
V_205 -> V_212 , V_69 -> V_72 ) ;
V_69 -> V_209 = V_213 ;
return 0 ;
}
V_10 = F_11 ( V_69 -> V_34 ) ;
...
V_205 -> V_212 [ V_11 ] = F_125 ( V_2 -> V_197 , V_69 -> V_211 [ V_11 ] ,
0 , V_47 ,
V_214 ) ;
if ( F_126 ( V_2 -> V_197 , V_205 -> V_212 [ V_11 ] ) ) {
while ( -- V_11 ) {
F_127 ( V_2 -> V_197 , V_205 -> V_212 [ V_11 ] ,
V_47 , V_214 ) ;
V_205 -> V_212 [ V_11 ] = 0 ;
}
F_128 ( V_69 ) ;
...
{
struct V_29 * V_216 = F_8 ( V_20 ) ;
struct V_29 * V_217 = NULL ;
F_4 ( & V_36 -> V_33 . V_34 -> V_192 ) ;
V_217 = V_36 -> V_33 . V_176 ;
V_36 -> V_33 . V_176 = V_216 ;
...
static int
F_136 ( void * V_176 , bool V_218 , bool V_172 )
{
return F_137 ( V_176 , V_218 , V_172 ) ;
}
static int
F_138 ( void * V_176 )
{
...
struct V_188 *
F_139 ( struct V_35 * V_36 , struct V_219 * V_59 )
{
struct V_188 * V_149 ;
F_102 (vma, &nvbo->vma_list, head) {
if ( V_149 -> V_59 == V_59 )
...
int
F_140 ( struct V_35 * V_36 , struct V_219 * V_59 ,
struct V_188 * V_149 )
{
