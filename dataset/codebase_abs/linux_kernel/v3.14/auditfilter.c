...
static void F_66 ( T_4 V_160 , int V_161 , struct V_162 * V_163 )
{
struct V_164 * V_165 ;
struct V_4 * V_166 ;
int V_3 ;
...
if ( F_9 ( ! V_116 ) )
break;
V_165 = F_67 ( V_160 , V_161 , V_168 ,
0 , 1 , V_116 ,
sizeof( * V_116 ) + V_116 -> V_129 ) ;
if ( V_165 )
F_68 ( V_163 , V_165 ) ;
F_3 ( V_116 ) ;
}
...
int F_79 ( int type , T_4 V_160 , int V_161 , void * V_116 ,
T_2 V_117 )
{
int V_51 = 0 ;
struct V_1 * V_18 ;
...
int F_81 ( struct V_164 * V_180 , int V_161 )
{
T_1 V_160 = F_82 ( V_180 ) . V_160 ;
struct V_181 * V_181 = F_83 ( F_82 ( V_180 ) . V_182 ) ;
struct V_183 * V_184 ;
struct V_185 * V_186 ;
int V_51 = 0 ;
V_186 = F_12 ( sizeof( struct V_185 ) , V_19 ) ;
if ( ! V_186 )
return - V_27 ;
V_186 -> V_181 = F_84 ( V_181 ) ;
V_186 -> V_160 = V_160 ;
F_85 ( & V_186 -> V_163 ) ;
F_52 ( & V_152 ) ;
F_66 ( V_160 , V_161 , & V_186 -> V_163 ) ;
F_53 ( & V_152 ) ;
V_184 = F_86 ( V_187 , V_186 , L_11 ) ;
if ( F_27 ( V_184 ) ) {
F_87 ( & V_186 -> V_163 ) ;
F_3 ( V_186 ) ;
V_51 = F_80 ( V_184 ) ;
...
int F_88 ( T_1 V_188 , T_1 V_33 , T_1 V_189 )
{
switch ( V_33 ) {
case V_34 :
return ( V_188 == V_189 ) ;
...
int F_90 ( T_6 V_188 , T_1 V_33 , T_6 V_189 )
{
switch ( V_33 ) {
case V_34 :
return F_42 ( V_188 , V_189 ) ;
case V_35 :
return ! F_42 ( V_188 , V_189 ) ;
case V_190 :
return F_91 ( V_188 , V_189 ) ;
case V_191 :
return F_92 ( V_188 , V_189 ) ;
case V_192 :
return F_93 ( V_188 , V_189 ) ;
case V_193 :
return F_94 ( V_188 , V_189 ) ;
case V_89 :
case V_90 :
default:
F_89 () ;
...
int F_95 ( T_7 V_188 , T_1 V_33 , T_7 V_189 )
{
switch ( V_33 ) {
case V_34 :
return F_43 ( V_188 , V_189 ) ;
case V_35 :
return ! F_43 ( V_188 , V_189 ) ;
case V_190 :
return F_96 ( V_188 , V_189 ) ;
case V_191 :
return F_97 ( V_188 , V_189 ) ;
case V_192 :
return F_98 ( V_188 , V_189 ) ;
case V_193 :
return F_99 ( V_188 , V_189 ) ;
case V_89 :
case V_90 :
default:
F_89 () ;
...
int F_101 ( const char * V_196 , const char * V_194 , int V_197 )
{
int V_198 , V_199 ;
const char * V_38 ;
V_198 = strlen ( V_196 ) ;
...
if ( V_199 < V_198 )
return 1 ;
V_197 = V_197 == V_200 ? F_100 ( V_194 ) : V_197 ;
if ( V_199 - V_197 != V_198 )
return 1 ;
V_38 = V_194 + V_197 ;
return strncmp ( V_38 , V_196 , V_198 ) ;
}
static int F_102 ( struct V_4 * V_6 , int type ,
enum V_201 * V_202 )
{
int V_3 ;
...
switch ( V_11 -> type ) {
case V_81 :
V_203 = F_88 ( F_103 ( V_174 ) , V_11 -> V_33 , V_11 -> V_49 ) ;
break;
case V_70 :
V_203 = F_90 ( F_104 () , V_11 -> V_33 , V_11 -> V_124 ) ;
break;
case V_76 :
V_203 = F_95 ( F_105 () , V_11 -> V_33 , V_11 -> V_126 ) ;
break;
case V_74 :
V_203 = F_90 ( F_71 ( V_174 ) ,
V_11 -> V_33 , V_11 -> V_124 ) ;
break;
case V_108 :
V_203 = F_88 ( F_106 ( V_174 ) ,
V_11 -> V_33 , V_11 -> V_49 ) ;
break;
case V_69 :
V_203 = F_88 ( type , V_11 -> V_33 , V_11 -> V_49 ) ;
break;
case V_95 :
case V_96 :
case V_97 :
...
switch ( V_6 -> V_56 ) {
case V_63 : * V_202 = V_205 ; break;
case V_57 : * V_202 = V_206 ; break;
}
return 1 ;
}
int F_109 ( int type )
{
enum V_201 V_202 = V_205 ;
struct V_1 * V_2 ;
int V_207 , V_136 ;
V_136 = 1 ;
F_110 () ;
F_111 (e, &audit_filter_list[AUDIT_FILTER_USER], list) {
V_207 = F_102 ( & V_2 -> V_6 , type , & V_202 ) ;
if ( V_207 ) {
if ( V_207 > 0 && V_202 == V_205 )
V_136 = 0 ;
break;
}
}
...
if ( F_114 ( & V_148 [ V_60 ] ) )
goto V_208;
F_111 (e, &audit_filter_list[AUDIT_FILTER_TYPE],
list) {
int V_3 ;
...
static int F_115 ( struct V_4 * V_166 )
{
...
F_118 ( & V_166 -> V_210 , & V_209 -> V_6 . V_210 ) ;
F_119 ( & V_18 -> V_37 , & V_209 -> V_37 ) ;
F_120 ( & V_166 -> V_37 , & V_209 -> V_6 . V_37 ) ;
}
F_65 ( & V_18 -> V_17 , F_5 ) ;
return V_51 ;
}
...
F_52 ( & V_152 ) ;
for ( V_3 = 0 ; V_3 < V_167 ; V_3 ++ ) {
F_122 (r, n, &audit_rules_list[i], list) {
int V_169 = F_115 ( V_166 ) ;
if ( ! V_51 )
V_51 = V_169 ;
}
}
