...
static int F_26 ( struct V_12 * V_33 , unsigned V_17 )
{
F_3 ( F_24 ( V_33 ) , V_34 , F_7 ( V_17 ) ) ;
return 0 ;
}
static int F_27 ( struct V_12 * V_33 , unsigned V_17 )
{
return ( int ) ( F_1 ( F_24 ( V_33 ) , V_35 ) & F_7 ( V_17 ) ) ;
}
static void F_28 ( struct V_12 * V_33 , unsigned int V_16 ,
unsigned V_18 , int V_7 )
{
F_3 ( F_24 ( V_33 ) , V_16 ,
( 1 << ( V_18 + 16 ) ) | ( V_7 << V_18 ) ) ;
}
static void F_29 ( struct V_12 * V_33 , unsigned V_17 , int V_7 )
{
if ( V_17 < 16 )
F_28 ( V_33 , V_36 , V_17 , V_7 ) ;
else
F_28 ( V_33 , V_37 , V_17 - 16 , V_7 ) ;
}
static int F_30 ( struct V_12 * V_33 , unsigned V_17 ,
int V_7 )
{
F_29 ( V_33 , V_17 , V_7 ) ;
F_3 ( F_24 ( V_33 ) , V_38 , F_7 ( V_17 ) ) ;
return 0 ;
}
static int F_31 ( struct V_12 * V_33 , unsigned V_17 )
{
return F_32 ( F_24 ( V_33 ) -> V_30 , V_17 ) ;
}
static int F_33 ( struct V_12 * V_33 , unsigned V_17 )
{
return F_34 ( V_33 -> V_39 + V_17 ) ;
}
static void F_35 ( struct V_12 * V_33 , unsigned V_17 )
{
F_36 ( V_33 -> V_39 + V_17 ) ;
F_26 ( V_33 , V_17 ) ;
}
...
V_50 = & V_49 ;
if ( F_50 ( V_47 -> V_13 . V_62 , L_8 ,
& V_50 -> V_63 ) ) {
F_12 ( & V_47 -> V_13 , L_9 ) ;
V_54 = - V_21 ;
goto V_57;
}
V_54 = F_51 ( V_47 -> V_13 . V_62 , L_10 ) ;
if ( V_54 < 0 ) {
F_12 ( & V_47 -> V_13 , L_11 ) ;
goto V_57;
}
...
if ( F_53 ( & V_47 -> V_13 , V_25 [ 0 ] -> V_60 ,
F_20 , 0 , V_53 , V_2 ) ) {
F_12 ( & V_47 -> V_13 , L_13 ) ;
V_54 = - V_84 ;
goto V_85;
}
if ( F_53 ( & V_47 -> V_13 , V_25 [ 1 ] -> V_60 ,
F_20 , 0 , V_53 , V_2 ) ) {
F_12 ( & V_47 -> V_13 , L_14 ) ;
V_54 = - V_84 ;
goto V_85;
