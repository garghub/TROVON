...
F_37 ( & V_73 ) ;
V_55 -> V_74 -- ;
F_39 ( V_55 -> V_67 [ V_71 ] , NULL ) ;
if ( ! V_55 -> V_74 )
F_42 ( F_25 , V_55 ) ;
F_40 ( & V_73 ) ;
}
static int F_43 ( struct V_56 * V_70 ,
struct V_2 * V_3 )
{
struct V_54 * V_55 = V_70 -> V_55 ;
int V_31 = 0 ;
...
static void F_45 ( struct V_56 * V_70 ,
struct V_2 * V_3 )
{
struct V_54 * V_55 = V_70 -> V_55 ;
int V_71 ;
...
unsigned long T_1 __weak F_50 ( int V_14 )
{
...
static void F_55 ( void * V_78 , struct V_12 * V_13 , long V_53 )
{
struct V_4 * V_58 ;
struct V_28 * V_79 ;
struct V_80 * V_81 ;
...
if ( ! V_58 )
return;
V_81 = F_57 ( V_58 -> V_34 -> V_84 ) ;
if ( F_58 ( V_81 ) )
return;
V_65 = sizeof( unsigned long ) * V_58 -> V_36 + sizeof( * V_79 ) ;
V_65 = F_59 ( V_65 + sizeof( V_85 ) , sizeof( V_86 ) ) ;
V_65 -= sizeof( V_85 ) ;
V_79 = (struct V_28 * ) F_60 ( V_65 ,
...
F_61 ( V_79 , V_65 , V_82 , 0 , 1 , V_13 , V_81 , NULL ) ;
}
...
static void F_67 ( void * V_78 , struct V_12 * V_13 , long V_31 )
{
struct V_4 * V_58 ;
struct V_41 * V_79 ;
struct V_80 * V_81 ;
...
if ( ! V_58 )
return;
V_81 = F_57 ( V_58 -> V_42 -> V_84 ) ;
if ( F_58 ( V_81 ) )
return;
V_65 = F_59 ( sizeof( * V_79 ) + sizeof( V_85 ) , sizeof( V_86 ) ) ;
V_65 -= sizeof( V_85 ) ;
V_79 = (struct V_41 * ) F_60 ( V_65 ,
