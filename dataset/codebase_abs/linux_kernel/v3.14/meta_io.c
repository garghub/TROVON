...
void F_54 ( struct V_71 * V_72 , T_1 V_73 , T_2 V_74 )
{
struct V_24 * V_25 = F_55 ( & V_72 -> V_75 ) ;
struct V_4 * V_5 ;
while ( V_74 ) {
...
int F_58 ( struct V_71 * V_72 , int V_78 , T_1 V_79 ,
struct V_4 * * V_43 )
{
struct V_24 * V_25 = F_55 ( & V_72 -> V_75 ) ;
...
V_80 = F_34 ( V_19 , V_79 , V_50 , & V_5 ) ;
if ( V_80 == 0 && F_59 ( V_25 , V_5 , V_81 ) ) {
F_40 ( V_5 ) ;
V_80 = - V_46 ;
}
* V_43 = V_5 ;
...
struct V_4 * F_60 ( struct V_18 * V_19 , T_1 V_84 , T_2 V_85 )
{
struct V_24 * V_25 = V_19 -> V_26 ;
struct V_4 * V_86 , * V_5 ;
T_2 V_87 = F_61 ( V_25 , V_88 ) >>
V_25 -> V_32 . V_33 ;
F_2 ( ! V_85 ) ;
if ( V_87 < 1 )
V_87 = 1 ;
if ( V_85 > V_87 )
V_85 = V_87 ;
V_86 = F_19 ( V_19 , V_84 , V_41 ) ;
if ( F_37 ( V_86 ) )
goto V_89;
if ( ! F_62 ( V_86 ) )
F_63 ( V_49 | V_9 , 1 , & V_86 ) ;
V_84 ++ ;
V_85 -- ;
while ( V_85 ) {
V_5 = F_19 ( V_19 , V_84 , V_41 ) ;
if ( ! F_37 ( V_5 ) && ! F_62 ( V_5 ) )
F_63 ( V_90 | V_9 , 1 , & V_5 ) ;
F_40 ( V_5 ) ;
V_84 ++ ;
V_85 -- ;
if ( ! F_62 ( V_86 ) && F_37 ( V_86 ) )
goto V_89;
}
F_38 ( V_86 ) ;
V_89:
