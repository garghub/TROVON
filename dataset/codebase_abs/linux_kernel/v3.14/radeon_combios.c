...
if ( V_8 == 0 ) {
V_340 = F_2 ( V_10 + 3 ) ;
V_271 = F_2 ( V_10 + 4 ) & 0x3f ;
V_341 = F_2 ( V_10 + 5 ) ;
} else if ( V_8 == 1 ) {
V_340 = F_2 ( V_10 + 4 ) ;
V_271 = F_2 ( V_10 + 5 ) & 0x3f ;
V_341 = F_2 ( V_10 + 6 ) ;
} else if ( V_8 == 2 ) {
V_340 = F_2 ( V_10 + 4 ) ;
V_271 = F_2 ( V_10 + 5 ) & 0x3f ;
...
V_6 -> V_333 . V_335 [ V_332 ] . V_337 [ 0 ] . V_153 = F_14 ( V_10 + 0x5 + 0x2 ) ;
V_6 -> V_333 . V_335 [ V_332 ] . V_337 [ 0 ] . V_152 = F_14 ( V_10 + 0x5 + 0x6 ) ;
if ( ( V_6 -> V_333 . V_335 [ V_332 ] . V_337 [ 0 ] . V_153 == 0 ) ||
( V_6 -> V_333 . V_335 [ V_332 ] . V_337 [ 0 ] . V_152 == 0 ) )
goto V_351;
V_6 -> V_333 . V_335 [ V_332 ] . type =
V_352 ;
V_330 = F_3 ( V_10 + 0x5 + 0x0 ) ;
if ( V_8 > 4 )
V_331 = F_3 ( V_10 + 0x5 + 0xe ) ;
...
T_4 V_358 = F_2 ( V_10 + 0x5 + 0xb ) ;
T_3 V_359 = F_3 ( V_10 + 0x5 + 0xc ) ;
if ( V_358 && V_359 ) {
V_6 -> V_333 . V_335 [ V_332 ] . V_337 [ 0 ] . V_353 . V_271 . V_356 =
F_3 ( V_359 ) * 4 ;
V_237 = F_2 ( V_359 + 0x2 ) ;
...
if ( V_10 ) {
while ( F_3 ( V_10 ) ) {
T_1 V_376 = ( ( F_3 ( V_10 ) & 0xe000 ) >> 13 ) ;
T_7 V_348 = ( F_3 ( V_10 ) & 0x1fff ) ;
...
if ( V_10 ) {
while ( F_2 ( V_10 ) ) {
T_6 V_376 = ( ( F_2 ( V_10 ) & 0xc0 ) >> 6 ) ;
T_6 V_348 = ( F_2 ( V_10 ) & 0x3f ) ;
...
V_381 = F_2 ( V_10 ) * 8 ;
V_10 ++ ;
V_374 = F_2 ( V_10 ) << V_381 ;
V_374 |= ~ ( 0xff << V_381 ) ;
V_10 ++ ;
V_375 = F_2 ( V_10 ) << V_381 ;
V_10 ++ ;
V_237 = F_27 ( V_348 ) ;
V_237 &= V_374 ;
V_237 |= V_375 ;
