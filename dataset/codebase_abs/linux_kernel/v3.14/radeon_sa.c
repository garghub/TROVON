...
struct V_3 * V_4 ,
struct V_17 * * V_18 ,
unsigned V_5 , unsigned V_6 , bool V_37 )
{
...
F_34 ( V_6 > V_4 -> V_6 ) ;
F_34 ( V_5 > V_4 -> V_5 ) ;
* V_18 = F_35 ( sizeof( struct V_17 ) , V_38 ) ;
if ( ( * V_18 ) == NULL ) {
return - V_39 ;
}
( * V_18 ) -> V_23 = V_4 ;
...
T_2 V_29 = V_8 -> V_29 + V_4 -> V_21 ;
T_2 V_28 = V_8 -> V_28 + V_4 -> V_21 ;
