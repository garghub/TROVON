...
int V_73 ;
V_14 -> V_83 = V_16 -> V_19 ;
V_73 = F_24 ( V_14 , 0 , 0 , V_84 ) ;
if ( V_73 < 0 ) {
F_25 ( V_14 -> V_85 , L_1 , V_73 ) ;
return V_73 ;
}
V_73 = F_6 ( V_16 -> V_19 , V_86 , 0 ) ;
if ( V_73 < 0 ) {
F_25 ( V_14 -> V_85 , L_2 , V_73 ) ;
return V_73 ;
}
F_8 ( V_16 -> V_19 , V_87 ,
V_88 , V_88 ) ;
...
static bool F_27 ( struct V_96 * V_85 , unsigned int V_97 )
{
return V_97 == V_86 ;
}
...
struct V_15 * V_16 ;
int V_73 ;
V_16 = F_29 ( & V_99 -> V_85 , sizeof( struct V_15 ) ,
V_100 ) ;
if ( V_16 == NULL )
return - V_101 ;
F_30 ( V_99 , V_16 ) ;
V_16 -> type = V_94 ;
V_16 -> V_19 = F_31 ( V_99 , & V_102 ) ;
if ( F_32 ( V_16 -> V_19 ) )
return F_33 ( V_16 -> V_19 ) ;
V_73 = F_34 ( & V_99 -> V_85 ,
& V_103 , & V_104 , 1 ) ;
return V_73 ;
}
...
struct V_15 * V_16 ;
int V_73 ;
V_16 = F_29 ( & V_106 -> V_85 , sizeof( struct V_15 ) ,
V_100 ) ;
if ( V_16 == NULL )
return - V_101 ;
F_38 ( V_106 , V_16 ) ;
V_16 -> type = V_108 -> V_109 ;
V_16 -> V_19 = F_39 ( V_106 , & V_102 ) ;
if ( F_32 ( V_16 -> V_19 ) )
return F_33 ( V_16 -> V_19 ) ;
V_73 = F_34 ( & V_106 -> V_85 ,
& V_103 , & V_104 , 1 ) ;
return V_73 ;
}
static int F_40 ( struct V_105 * V_110 )
{
F_36 ( & V_110 -> V_85 ) ;
return 0 ;
}
