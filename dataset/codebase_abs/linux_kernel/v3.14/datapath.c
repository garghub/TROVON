...
F_101 (i) {
struct V_38 * V_201 ;
V_201 = F_102 ( V_15 -> V_26 , V_130 ) ;
F_161 ( & V_201 -> V_56 ) ;
}
V_15 -> V_27 = F_162 ( V_30 * sizeof( struct V_28 ) ,
V_9 ) ;
if ( ! V_15 -> V_27 ) {
V_58 = - V_85 ;
goto V_202;
...
F_163 ( & V_15 -> V_27 [ V_130 ] ) ;
V_33 . V_203 = F_74 ( V_104 [ V_192 ] ) ;
V_33 . type = V_204 ;
V_33 . V_205 = NULL ;
V_33 . V_15 = V_15 ;
V_33 . V_29 = V_19 ;
...
V_58 = - V_171 ;
if ( V_58 == - V_171 ) {
if ( V_6 -> V_165 -> V_207 < V_208 )
F_151 ( V_4 , V_6 ) ;
}
goto V_209;
}
V_160 = F_148 ( V_15 , V_6 , V_210 ) ;
V_58 = F_55 ( V_160 ) ;
if ( F_31 ( V_160 ) )
goto V_211;
V_197 = F_164 ( F_24 ( V_15 ) , V_212 ) ;
F_165 ( & V_15 -> V_213 , & V_197 -> V_214 ) ;
F_6 () ;
F_1 ( & V_191 , V_160 , V_6 ) ;
return 0 ;
V_211:
F_33 ( F_166 ( V_15 , V_19 ) ) ;
V_209:
F_25 ( V_15 -> V_27 ) ;
V_202:
F_22 ( V_15 -> V_26 ) ;
V_200:
F_167 ( & V_15 -> V_44 , false ) ;
V_199:
F_23 ( F_24 ( V_15 ) ) ;
F_25 ( V_15 ) ;
V_167:
...
static void F_168 ( struct V_12 * V_15 )
{
int V_130 ;
for ( V_130 = 0 ; V_130 < V_30 ; V_130 ++ ) {
struct V_18 * V_18 ;
struct V_215 * V_216 ;
F_169 (vport, n, &dp->ports[i], dp_hash_node)
if ( V_18 -> V_29 != V_19 )
F_33 ( V_18 ) ;
}
F_170 ( & V_15 -> V_213 ) ;
F_33 ( F_166 ( V_15 , V_19 ) ) ;
F_167 ( & V_15 -> V_44 , true ) ;
F_171 ( & V_15 -> V_25 , F_20 ) ;
}
...
static int F_174 ( struct V_3 * V_4 , struct V_5 * V_6 )
{
struct V_3 * V_160 ;
struct V_12 * V_15 ;
int V_58 ;
...
static int F_175 ( struct V_3 * V_4 , struct V_178 * V_179 )
{
struct V_197 * V_197 = F_164 ( F_94 ( V_4 -> V_125 ) , V_212 ) ;
struct V_12 * V_15 ;
int V_218 = V_179 -> args [ 0 ] ;
int V_130 = 0 ;
F_11 () ;
F_176 (dp, &ovs_net->dps, list_node) {
if ( V_130 >= V_218 &&
...
static int F_177 ( struct V_18 * V_18 , struct V_3 * V_4 ,
T_3 V_50 , T_3 V_138 , T_3 V_139 , T_5 V_47 )
{
struct V_75 * V_75 ;
struct V_219 V_220 ;
int V_58 ;
V_75 = F_69 ( V_4 , V_50 , V_138 , & V_221 ,
V_139 , V_47 ) ;
if ( ! V_75 )
return - V_144 ;
V_75 -> V_14 = F_17 ( V_18 -> V_15 ) ;
if ( F_147 ( V_4 , V_222 , V_18 -> V_29 ) ||
F_147 ( V_4 , V_223 , V_18 -> V_20 -> type ) ||
F_146 ( V_4 , V_224 , V_18 -> V_20 -> V_21 ( V_18 ) ) ||
F_147 ( V_4 , V_225 , V_18 -> V_51 ) )
goto V_146;
F_178 ( V_18 , & V_220 ) ;
if ( F_110 ( V_4 , V_226 , sizeof( struct V_219 ) ,
& V_220 ) )
goto V_146;
V_58 = F_179 ( V_18 , V_4 ) ;
if ( V_58 == - V_144 )
...
struct V_3 * F_180 ( struct V_18 * V_18 , T_3 V_50 ,
T_3 V_138 , T_5 V_47 )
{
struct V_3 * V_4 ;
int V_156 ;
V_4 = F_181 ( V_227 , V_84 ) ;
if ( ! V_4 )
return F_120 ( - V_85 ) ;
V_156 = F_177 ( V_18 , V_4 , V_50 , V_138 , 0 , V_47 ) ;
F_121 ( V_156 < 0 ) ;
return V_4 ;
}
static struct V_18 * F_182 ( struct V_13 * V_13 ,
struct V_75 * V_75 ,
struct V_72 * V_104 [ V_228 + 1 ] )
{
struct V_12 * V_15 ;
struct V_18 * V_18 ;
if ( V_104 [ V_224 ] ) {
V_18 = F_150 ( V_13 , F_74 ( V_104 [ V_224 ] ) ) ;
if ( ! V_18 )
return F_120 ( - V_83 ) ;
if ( V_75 -> V_14 &&
V_75 -> V_14 != F_17 ( V_18 -> V_15 ) )
...
goto V_230;
if ( V_104 [ V_222 ] ) {
V_29 = F_154 ( V_104 [ V_222 ] ) ;
V_58 = - V_89 ;
if ( V_29 >= V_229 )
goto V_230;
V_18 = F_166 ( V_15 , V_29 ) ;
V_58 = - V_206 ;
if ( V_18 )
goto V_230;
} else {
...
V_33 . V_203 = F_74 ( V_104 [ V_224 ] ) ;
V_33 . type = F_154 ( V_104 [ V_223 ] ) ;
V_33 . V_205 = V_104 [ V_231 ] ;
V_33 . V_15 = V_15 ;
V_33 . V_29 = V_29 ;
V_33 . V_51 = F_154 ( V_104 [ V_225 ] ) ;
V_18 = F_29 ( & V_33 ) ;
V_58 = F_55 ( V_18 ) ;
if ( F_31 ( V_18 ) )
goto V_230;
V_58 = 0 ;
V_160 = F_180 ( V_18 , V_6 -> V_7 , V_6 -> V_157 ,
V_232 ) ;
if ( F_31 ( V_160 ) ) {
V_58 = F_55 ( V_160 ) ;
F_33 ( V_18 ) ;
...
static int F_184 ( struct V_3 * V_4 , struct V_5 * V_6 )
{
struct V_72 * * V_104 = V_6 -> V_105 ;
struct V_3 * V_160 ;
struct V_18 * V_18 ;
int V_58 ;
F_4 () ;
V_18 = F_182 ( F_94 ( V_4 -> V_125 ) , V_6 -> V_103 , V_104 ) ;
V_58 = F_55 ( V_18 ) ;
if ( F_31 ( V_18 ) )
goto V_230;
if ( V_104 [ V_223 ] &&
F_154 ( V_104 [ V_223 ] ) != V_18 -> V_20 -> type ) {
V_58 = - V_111 ;
goto V_230;
}
V_160 = F_181 ( V_227 , V_9 ) ;
if ( ! V_160 ) {
V_58 = - V_85 ;
goto V_230;
}
if ( V_104 [ V_231 ] ) {
V_58 = F_185 ( V_18 , V_104 [ V_231 ] ) ;
if ( V_58 )
goto V_233;
}
if ( V_104 [ V_225 ] )
V_18 -> V_51 = F_154 ( V_104 [ V_225 ] ) ;
V_58 = F_177 ( V_18 , V_160 , V_6 -> V_7 ,
V_6 -> V_157 , 0 , V_232 ) ;
F_121 ( V_58 < 0 ) ;
F_6 () ;
F_1 ( & V_221 , V_160 , V_6 ) ;
...
static int F_187 ( struct V_3 * V_4 , struct V_5 * V_6 )
{
struct V_72 * * V_104 = V_6 -> V_105 ;
struct V_75 * V_75 = V_6 -> V_103 ;
struct V_3 * V_160 ;
...
int V_58 ;
F_11 () ;
V_18 = F_182 ( F_94 ( V_4 -> V_125 ) , V_75 , V_104 ) ;
V_58 = F_55 ( V_18 ) ;
if ( F_31 ( V_18 ) )
goto V_230;
V_160 = F_180 ( V_18 , V_6 -> V_7 ,
...
static int F_188 ( struct V_3 * V_4 , struct V_178 * V_179 )
{
struct V_75 * V_75 = F_139 ( F_140 ( V_179 -> V_180 ) ) ;
struct V_12 * V_15 ;
int V_183 = V_179 -> args [ 0 ] , V_218 = V_179 -> args [ 1 ] ;
int V_130 , V_235 = 0 ;
F_11 () ;
V_15 = F_10 ( F_94 ( V_4 -> V_125 ) , V_75 -> V_14 ) ;
if ( ! V_15 ) {
...
static void F_189 ( int V_236 )
{
int V_130 ;
for ( V_130 = 0 ; V_130 < V_236 ; V_130 ++ )
F_190 ( V_237 [ V_130 ] . V_2 ) ;
}
...
int V_130 ;
V_238 = 0 ;
for ( V_130 = 0 ; V_130 < F_192 ( V_237 ) ; V_130 ++ ) {
const struct V_239 * V_240 = & V_237 [ V_130 ] ;
V_240 -> V_2 -> V_20 = V_240 -> V_20 ;
V_240 -> V_2 -> V_241 = V_240 -> V_241 ;
V_240 -> V_2 -> V_242 = V_240 -> V_243 ;
V_240 -> V_2 -> V_244 = V_240 -> V_243 ? 1 : 0 ;
V_58 = F_193 ( V_240 -> V_2 ) ;
if ( V_58 )
goto error;
V_238 ++ ;
}
...
static int T_7 F_194 ( struct V_13 * V_13 )
{
struct V_197 * V_197 = F_164 ( V_13 , V_212 ) ;
F_195 ( & V_197 -> V_214 ) ;
F_196 ( & V_197 -> V_245 , V_246 ) ;
return 0 ;
}
static void T_8 F_197 ( struct V_13 * V_13 )
{
struct V_12 * V_15 , * V_247 ;
struct V_197 * V_197 = F_164 ( V_13 , V_212 ) ;
F_4 () ;
F_198 (dp, dp_next, &ovs_net->dps, list_node)
F_168 ( V_15 ) ;
F_6 () ;
F_199 ( & V_197 -> V_245 ) ;
}
...
{
int V_58 ;
F_201 ( sizeof( struct V_248 ) > F_202 ( struct V_3 , V_179 ) ) ;
F_203 ( L_4 ) ;
V_58 = F_204 () ;
if ( V_58 )
goto error;
