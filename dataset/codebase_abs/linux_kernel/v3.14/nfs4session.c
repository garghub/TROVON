...
struct V_65 * F_48 ( struct V_73 * V_74 )
{
struct V_65 * V_66 ;
...
if ( ! F_62 ( V_74 ) )
return 0 ;
F_63 ( V_76 , & V_74 -> V_88 -> V_75 ) ;
return F_58 ( V_74 ) ;
}
int F_64 ( struct V_73 * V_74 , unsigned long V_89 )
{
struct V_65 * V_66 = V_74 -> V_88 ;
int V_26 ;
F_24 ( & V_74 -> V_90 ) ;
if ( F_65 ( V_76 , & V_66 -> V_75 ) ) {
V_74 -> V_91 = V_89 ;
V_74 -> V_92 = V_53 ;
}
F_25 ( & V_74 -> V_90 ) ;
