...
#ifdef F_25
V_19 -> V_86 . V_103 = F_26 ( V_37 -> V_38 . V_103 ) ;
#endif
V_74 = F_27 ( & V_19 -> V_86 ) ;
if ( V_74 ) {
V_19 -> V_86 . V_97 = 0 ;
...
if ( V_89 -> V_104 )
V_89 -> V_104 ( V_19 -> V_86 . V_98 , V_19 -> V_86 . V_97 ) ;
return 0 ;
}
static void F_28 ( struct V_18 * V_19 )
{
if ( V_19 -> V_86 . V_97 ) {
int V_74 = F_29 ( & V_19 -> V_86 ) ;
F_30 ( & V_19 -> V_37 -> V_38 , L_4 ,
L_5 , V_74 ) ;
}
}
static int F_24 ( struct V_49 * V_37 ,
...
{
struct V_105 * V_106 = V_37 -> V_38 . V_103 , * V_107 ;
struct V_88 * V_89 ;
struct V_108 * V_109 ;
int V_110 ;
V_110 = F_32 ( V_106 ) ;
if ( ! V_110 || V_110 > V_91 )
return F_33 ( - V_111 ) ;
V_109 = F_34 ( & V_37 -> V_38 ,
sizeof( struct V_108 ) * V_91 , V_112 ) ;
if ( ! V_109 )
return F_33 ( - V_113 ) ;
F_35 (np, child) {
struct V_108 V_20 ;
...
int V_114 ;
V_20 . V_93 =
F_36 ( V_107 , L_6 , NULL ) ? : V_107 -> V_93 ;
V_20 . V_115 =
F_36 ( V_107 , L_7 , NULL ) ;
V_20 . V_75 = 0 ;
if ( F_37 ( V_107 , L_8 , L_9 ) >= 0 )
V_20 . V_75 |= V_116 ;
V_114 = F_38 ( V_107 , L_10 , & V_27 ) ;
if ( V_114 != 0 || V_27 < 0 || V_27 >= V_91 )
continue;
V_109 [ V_27 ] = V_20 ;
}
V_89 = F_34 ( & V_37 -> V_38 ,
...
int V_74 ;
int V_63 = 0 ;
V_121 = F_41 ( V_37 -> V_38 . V_122 ) ;
V_89 = F_42 ( & V_37 -> V_38 ) ;
if ( ! F_43 ( V_121 , V_123 ) )
return - V_124 ;
if ( ! V_89 || V_89 -> V_92 . V_117 != V_91 ) {
V_89 = F_31 ( V_37 ) ;
if ( F_44 ( V_89 ) ) {
F_30 ( & V_37 -> V_38 , L_11 ,
V_91 ) ;
...
V_19 = F_34 ( & V_37 -> V_38 , sizeof( * V_19 ) , V_112 ) ;
if ( ! V_19 )
return - V_113 ;
V_19 -> V_37 = V_37 ;
F_46 ( & V_19 -> V_48 , F_9 ) ;
...
F_50 ( & V_19 -> V_92 [ V_63 ] . V_62 ) ;
}
return V_74 ;
}
static int F_51 ( struct V_49 * V_37 )
{
int V_63 ;
struct V_18 * V_19 = F_52 ( V_37 ) ;
struct V_56 * V_109 = V_19 -> V_92 ;
for ( V_63 = 0 ; V_63 < V_91 ; V_63 ++ ) {
if ( V_109 [ V_63 ] . V_62 . V_93 )
F_50 ( & V_109 [ V_63 ] . V_62 ) ;
}
F_28 ( V_19 ) ;
F_53 ( & V_19 -> V_48 ) ;
return 0 ;
