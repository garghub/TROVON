...
(struct V_73 * ) V_3 ;
struct V_74 * V_75 ;
struct V_76 * V_77 = V_76 ( V_5 -> V_78 ) ;
...
int V_63 ;
V_88 = V_61 -> V_88 ;
V_80 = (struct V_79 * ) ( unsigned long ) V_61 -> V_80 ;
if ( F_15 ( V_88 == 0 ) )
return 0 ;
if ( V_80 == NULL ) {
F_7 ( L_5 ) ;
...
V_81 = F_21 ( V_88 , sizeof( * V_81 ) , V_90 ) ;
if ( V_81 == NULL ) {
F_7 ( L_6 ) ;
V_63 = - V_66 ;
goto V_89;
}
V_63 = F_22 ( V_81 , V_80 , V_88 * sizeof( * V_81 ) ) ;
if ( V_63 ) {
F_7 ( L_7 ) ;
V_63 = - V_70 ;
goto V_91;
...
V_85 = F_25 ( V_83 ) ;
V_63 = F_26 ( & V_77 -> V_95 , true ) ;
if ( F_15 ( V_63 != 0 ) )
goto V_96;
V_63 = F_27 ( V_7 , V_72 , V_61 -> V_97 ,
V_98 ,
& V_87 ) ;
if ( V_63 )
goto V_99;
...
struct V_102 * V_61 =
(struct V_102 * ) V_3 ;
struct V_103 T_4 * V_104 =
(struct V_103 T_4 * )
( unsigned long ) V_61 -> V_105 ;
struct V_76 * V_77 = V_76 ( V_5 -> V_78 ) ;
struct V_79 T_4 * V_80 ;
struct V_79 * V_81 = NULL ;
struct V_82 * V_83 ;
...
unsigned int F_37 ( struct V_107 * V_108 , struct V_109 * V_110 )
{
struct V_4 * V_5 = V_108 -> V_111 ;
struct V_6 * V_7 =
F_2 ( V_5 -> V_112 -> V_2 ) ;
F_38 ( V_7 , V_113 ) ;
return F_39 ( V_108 , V_110 ) ;
}
T_5 F_40 ( struct V_107 * V_108 , char T_4 * V_62 ,
T_3 V_114 , T_6 * V_115 )
{
struct V_4 * V_5 = V_108 -> V_111 ;
struct V_6 * V_7 =
F_2 ( V_5 -> V_112 -> V_2 ) ;
F_38 ( V_7 , V_113 ) ;
return F_41 ( V_108 , V_62 , V_114 , V_115 ) ;
}
