...
struct V_43 * V_44 = F_10 ( V_6 ) ;
int V_119 ;
F_22 ( V_6 -> V_10 , L_5 , V_120 ) ;
V_6 -> V_121 = V_44 -> V_122 ;
V_119 = F_23 ( V_6 , 8 , 8 , V_123 ) ;
if ( V_119 < 0 ) {
F_18 ( V_6 -> V_10 , L_6 , V_119 ) ;
return V_119 ;
}
V_44 -> V_73 = 0 ;
V_44 -> V_76 = 0 ;
F_11 ( V_6 , V_8 , V_124 | V_125 ) ;
F_11 ( V_6 , V_126 , V_127 | V_128 ) ;
F_11 ( V_6 , V_129 , V_130 ) ;
F_11 ( V_6 , V_131 , V_132 ) ;
F_11 ( V_6 , V_133 , V_134 ) ;
F_11 ( V_6 , V_13 , V_135 | V_136 ) ;
F_11 ( V_6 , V_137 ,
V_138 | V_139 |
V_140 | V_141 ) ;
F_11 ( V_6 , V_142 , V_143 ) ;
F_11 ( V_6 , V_144 , V_145 ) ;
F_11 ( V_6 , V_146 ,
V_147 | V_148 |
V_149 | V_150 | V_151 ) ;
...
static int F_24 ( struct V_167 * V_168 ,
const struct V_169 * V_170 )
{
struct V_43 * V_44 ;
int V_119 ;
V_44 = F_25 ( & V_168 -> V_10 , sizeof( struct V_43 ) ,
V_171 ) ;
if ( ! V_44 )
return - V_172 ;
F_26 ( V_168 , V_44 ) ;
V_44 -> V_122 = F_27 ( V_168 , & V_173 ) ;
if ( F_28 ( V_44 -> V_122 ) ) {
V_119 = F_29 ( V_44 -> V_122 ) ;
F_18 ( & V_168 -> V_10 , L_7 , V_119 ) ;
return V_119 ;
}
V_119 = F_30 ( V_44 -> V_122 , V_174 ,
F_20 ( V_174 ) ) ;
if ( V_119 != 0 )
F_31 ( & V_168 -> V_10 , L_8 , V_119 ) ;
V_119 = F_32 ( & V_168 -> V_10 ,
& V_175 , & V_176 , 1 ) ;
if ( V_119 < 0 )
F_18 ( & V_168 -> V_10 , L_9 , V_119 ) ;
return V_119 ;
}
static int F_33 ( struct V_167 * V_177 )
{
F_34 ( & V_177 -> V_10 ) ;
return 0 ;
}
static int F_35 ( struct V_178 * V_179 )
{
struct V_43 * V_44 ;
int V_119 ;
V_44 = F_25 ( & V_179 -> V_10 , sizeof( struct V_43 ) ,
V_171 ) ;
if ( ! V_44 )
return - V_172 ;
F_36 ( V_179 , V_44 ) ;
V_44 -> V_122 = F_37 ( V_179 , & V_180 ) ;
if ( F_28 ( V_44 -> V_122 ) ) {
V_119 = F_29 ( V_44 -> V_122 ) ;
F_18 ( & V_179 -> V_10 , L_10 , V_119 ) ;
return V_119 ;
}
V_119 = F_30 ( V_44 -> V_122 , V_181 ,
F_20 ( V_181 ) ) ;
if ( V_119 != 0 )
F_31 ( & V_179 -> V_10 , L_8 , V_119 ) ;
V_119 = F_32 ( & V_179 -> V_10 ,
& V_175 , & V_176 , 1 ) ;
return V_119 ;
}
static int F_38 ( struct V_178 * V_179 )
{
F_34 ( & V_179 -> V_10 ) ;
return 0 ;
}
