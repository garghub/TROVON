...
{
struct V_3 * V_4 = F_16 ( V_9 ) ;
F_17 ( & V_4 -> V_16 . V_2 ) ;
return 0 ;
}
static int F_18 ( struct V_10 * V_5 )
{
struct V_8 * V_9 = F_19 ( V_5 ) ;
struct V_3 * V_4 = F_16 ( V_9 ) ;
if ( F_20 ( V_5 ) )
F_21 ( V_4 -> V_6 , V_4 -> V_7 , true ) ;
F_3 ( V_4 -> V_6 , V_4 -> V_7 , false ) ;
return 0 ;
}
static int F_22 ( struct V_10 * V_5 )
{
struct V_8 * V_9 = F_19 ( V_5 ) ;
struct V_3 * V_4 = F_16 ( V_9 ) ;
F_3 ( V_4 -> V_6 , V_4 -> V_7 , true ) ;
if ( F_20 ( V_5 ) )
F_21 ( V_4 -> V_6 , V_4 -> V_7 , false ) ;
return 0 ;
}
