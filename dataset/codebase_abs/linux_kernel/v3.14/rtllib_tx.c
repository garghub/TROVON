...
void F_6 ( struct V_34 * V_35 )
{
if ( F_7 ( ! V_35 ) )
return;
F_8 ( V_35 ) ;
}
static struct V_34 * F_9 ( int V_36 , int V_37 ,
T_3 V_38 )
{
struct V_34 * V_35 ;
int V_39 ;
V_35 = F_10 ( sizeof( struct V_34 ) + ( sizeof( T_1 * ) * V_36 ) ,
V_38 ) ;
if ( ! V_35 )
return NULL ;
...
return;
if ( V_55 -> V_68 ) {
if ( ! F_22 ( V_13 , (struct V_69 * * ) ( & V_57 ) , V_59 -> V_62 ,
V_43 -> V_70 , V_71 , true ) ) {
F_3 ( V_23 L_3 , V_24 ) ;
return;
}
...
T_2 F_31 ( struct V_12 * V_13 , struct V_14 * V_43 ,
T_1 * V_136 )
{
T_2 V_137 = 0 ;
if ( F_21 ( V_136 ) )
...
if ( ! F_22 ( V_13 , (struct V_69 * * ) ( & V_138 ) , V_136 ,
V_43 -> V_70 , V_71 , true ) )
return 0 ;
V_137 = V_138 -> V_83 ;
...
static int F_32 ( struct V_14 * V_43 )
{
switch ( V_43 -> V_70 ) {
case 6 :
case 7 :
...
int F_33 ( struct V_14 * V_43 , struct V_139 * V_29 )
{
...
if ( F_36 ( V_13 -> V_171 == 0 ) ) {
if ( F_7 ( V_43 -> V_31 < V_11 + sizeof( T_2 ) ) ) {
F_3 ( V_169 L_5 ,
...
V_147 = F_37 ( ( (struct V_45 * ) V_43 -> V_1 ) -> V_2 ) ;
if ( V_13 -> V_84 == V_172 ) {
V_35 = F_9 ( 1 , V_43 -> V_31 , V_173 ) ;
if ( F_7 ( ! V_35 ) ) {
F_3 ( V_169 L_6
L_7 ,
V_13 -> V_29 -> V_30 ) ;
...
V_35 -> V_175 = 0 ;
V_35 -> V_176 = F_11 ( V_43 -> V_31 ) ;
memcpy ( F_38 ( V_35 -> V_41 [ 0 ] , V_43 -> V_31 ) , V_43 -> V_1 ,
V_43 -> V_31 ) ;
goto V_170;
}
if ( V_43 -> V_31 > 282 ) {
...
V_162 = F_21 ( V_153 . V_62 ) ;
V_153 . V_201 = F_11 ( V_150 ) ;
if ( V_162 ) {
V_40 = V_202 ;
V_151 |= V_203 ;
} else {
...
if ( V_159 ) {
V_16 = V_205 + 2 ;
while ( F_7 ( V_13 -> V_206 & ( 0x01 << V_43 -> V_70 ) ) ) {
F_3 ( V_23 L_11 , V_43 -> V_70 ) ;
if ( F_32 ( V_43 ) )
break;
F_3 ( V_23 L_12 ,
V_43 -> V_70 ) ;
...
if ( ( V_159 ) && ( ! V_162 ) ) {
V_141 -> V_155 =
F_11 ( F_31 ( V_13 , V_152 ,
V_153 . V_62 ) ) ;
V_141 -> V_155 =
F_11 ( F_44 ( V_141 -> V_155 ) << 4 | V_39 ) ;
} else {
V_141 -> V_155 =
F_11 ( V_13 -> V_223 [ 0 ] << 4 | V_39 ) ;
}
if ( V_39 == 0 ) {
F_1 (
F_38 ( V_152 , V_11 +
...
memcpy ( F_38 ( V_152 , V_149 ) , V_43 -> V_1 , V_149 ) ;
F_41 ( V_43 , V_149 ) ;
if ( V_148 )
F_2 ( V_13 , V_152 ,
V_16 ) ;
...
if ( F_7 ( V_43 -> V_31 < sizeof( struct V_224 ) ) ) {
F_3 ( V_169 L_5 ,
V_13 -> V_29 -> V_30 , V_43 -> V_31 ) ;
goto V_170;
}
...
int F_50 ( struct V_14 * V_43 , struct V_139 * V_29 )
{
memset ( V_43 -> V_42 , 0 , sizeof( V_43 -> V_42 ) ) ;
return F_33 ( V_43 , V_29 ) ;
}
