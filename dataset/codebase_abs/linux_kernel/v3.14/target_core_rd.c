...
static int F_21 ( struct V_1 * V_1 , int V_47 )
{
struct V_15 * V_16 ;
T_1 V_30 , V_39 ;
T_1 V_33 = ( V_34 /
...
static struct V_2 * F_22 ( struct V_4 * V_5 , const char * V_48 )
{
struct V_1 * V_1 ;
struct V_7 * V_7 = V_5 -> V_11 ;
...
static T_2
F_27 ( struct V_60 * V_61 , struct V_20 * V_62 , T_1 V_63 ,
enum V_64 V_65 )
{
struct V_2 * V_66 = V_61 -> V_66 ;
struct V_1 * V_3 = F_1 ( V_66 ) ;
struct V_15 * V_67 ;
struct V_20 * V_68 ;
struct V_69 V_70 ;
T_1 V_71 ;
...
if ( ! V_67 )
return V_80 ;
V_68 = & V_67 -> V_16 [ V_73 - V_67 -> V_36 ] ;
F_6 ( L_26 ,
V_3 -> V_28 ,
V_65 == V_81 ? L_27 : L_28 ,
V_61 -> V_77 , V_72 , V_73 , V_71 ) ;
if ( V_61 -> V_82 && V_65 == V_83 ) {
struct V_15 * V_84 ;
struct V_20 * V_85 ;
T_1 V_86 = V_61 -> V_79 / V_66 -> V_52 . V_78 ;
T_1 V_87 , V_88 ;
V_75 = V_61 -> V_77 * V_66 -> V_47 ;
V_87 = F_29 ( V_75 , V_29 ) ;
V_88 = V_75 ;
V_84 = F_26 ( V_3 , V_88 ) ;
if ( ! V_84 )
...
V_40 = F_30 ( V_61 , V_61 -> V_77 , V_86 , 0 ,
V_85 , V_87 ) ;
if ( V_40 )
return V_40 ;
}
...
if ( ! ( T_1 ) V_70 . V_38 ) {
F_6 ( L_29 ,
V_3 -> V_28 , V_70 . V_93 , V_70 . V_38 ) ;
F_33 ( & V_70 ) ;
return V_94 ;
}
V_91 = F_34 ( ( T_1 ) V_70 . V_38 , V_74 ) ;
if ( V_91 > V_72 ) {
F_6 ( L_30
L_31 , V_3 -> V_28 ,
V_73 , V_71 , V_72 ) ;
...
V_92 = F_35 ( V_68 ) + V_71 ;
if ( V_65 == V_81 )
memcpy ( V_70 . V_93 , V_92 , V_91 ) ;
else
memcpy ( V_92 , V_70 . V_93 , V_91 ) ;
V_72 -= V_91 ;
if ( ! V_72 )
continue;
V_74 -= V_91 ;
...
return V_80 ;
V_85 = & V_84 -> V_16 [ V_88 - V_84 -> V_36 ] ;
V_40 = F_36 ( V_61 , V_61 -> V_77 , V_86 , 0 ,
V_85 , V_87 ) ;
if ( V_40 )
return V_40 ;
}
...
static T_2
F_46 ( struct V_60 * V_61 )
{
return F_47 ( V_61 , & V_110 ) ;
}
int T_7 F_48 ( void )
{
int V_49 ;
