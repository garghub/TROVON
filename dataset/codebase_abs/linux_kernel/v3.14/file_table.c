...
if ( F_64 ( ! F_65 () && ! ( V_65 -> V_67 & V_68 ) ) ) {
F_66 ( & V_3 -> V_5 . V_6 , F_60 ) ;
if ( ! F_67 ( V_65 , & V_3 -> V_5 . V_6 , true ) )
return;
}
if ( F_68 ( & V_3 -> V_5 . V_61 , & V_59 ) )
F_69 ( & V_69 , 1 ) ;
}
}
void F_70 ( struct V_3 * V_3 )
{
if ( F_63 ( & V_3 -> V_24 ) ) {
struct V_64 * V_65 = V_66 ;
F_71 ( ! ( V_65 -> V_67 & V_68 ) ) ;
...
void T_6 F_73 ( unsigned long V_70 )
{
unsigned long V_71 ;
V_8 = F_74 ( L_2 , sizeof( struct V_3 ) , 0 ,
V_72 | V_73 , NULL ) ;
V_71 = ( V_70 * ( V_74 / 1024 ) ) / 10 ;
V_10 . V_11 = F_75 (unsigned long, n, NR_FILE) ;
F_76 () ;
F_77 ( & V_9 , 0 ) ;
}
