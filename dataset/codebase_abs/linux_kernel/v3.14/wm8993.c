...
unsigned int V_3 ;
int V_147 , V_123 ;
V_140 = F_56 ( & V_142 -> V_2 , sizeof( struct V_139 ) ,
V_319 ) ;
if ( V_140 == NULL )
return - V_320 ;
V_140 -> V_2 = & V_142 -> V_2 ;
F_57 ( & V_140 -> V_163 ) ;
V_140 -> V_192 = F_58 ( V_142 , & V_321 ) ;
if ( F_59 ( V_140 -> V_192 ) ) {
V_147 = F_60 ( V_140 -> V_192 ) ;
...
V_147 = F_62 ( & V_142 -> V_2 , F_6 ( V_140 -> V_191 ) ,
V_140 -> V_191 ) ;
if ( V_147 != 0 ) {
...
if ( V_147 != 0 )
goto V_324;
V_147 = F_63 ( V_140 -> V_192 , V_325 ,
F_6 ( V_325 ) ) ;
if ( V_147 != 0 )
F_18 ( V_140 -> V_2 , L_38 ,
V_147 ) ;
if ( V_142 -> V_162 ) {
V_147 = F_64 ( V_140 -> V_192 , V_26 ,
V_326 |
V_327 , 7 ) ;
if ( V_147 != 0 )
goto V_324;
V_147 = F_65 ( V_142 -> V_162 , NULL , F_39 ,
V_328 | V_329 ,
L_39 , V_140 ) ;
if ( V_147 != 0 )
goto V_324;
