...
{
struct V_1 * V_2 = F_14 ( V_18 -> V_35 ) ;
struct V_19 * V_10 = V_2 -> V_10 ;
if ( 8 != V_18 -> V_52 ) {
F_8 ( V_10 , L_4 ) ;
return - V_53 ;
}
F_12 ( V_10 , L_5 , V_18 -> V_54 ) ;
return 0 ;
}
...
struct V_29 * V_29 ;
int V_38 ;
V_58 = F_23 ( V_56 , V_59 , 0 ) ;
if ( ! V_58 ) {
F_8 ( & V_56 -> V_10 , L_7 ) ;
return - V_60 ;
}
V_35 = F_24 ( & V_56 -> V_10 , sizeof( * V_2 ) ) ;
if ( ! V_35 ) {
F_8 ( & V_56 -> V_10 , L_8 ) ;
return - V_61 ;
}
...
V_35 -> V_69 = F_21 ;
V_35 -> V_70 = V_32 | V_31 ;
V_35 -> V_10 . V_71 = V_56 -> V_10 . V_71 ;
V_35 -> V_72 = true ;
V_35 -> V_73 = F_13 ;
V_38 = F_31 ( & V_56 -> V_10 , V_35 ) ;
if ( V_38 < 0 ) {
F_8 ( & V_56 -> V_10 , L_12 ) ;
goto V_64;
}
