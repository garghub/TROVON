...
V_23 -> V_84 = F_25 ( V_38 , 0444 , V_23 -> V_83 ,
V_23 , & V_85 ) ;
if ( F_23 ( V_23 -> V_84 ) )
F_24 ( V_23 -> V_23 , L_47 , V_38 ) ;
}
static void F_26 ( struct V_26 * V_23 )
{
F_27 ( V_23 -> V_84 ) ;
F_27 ( V_23 -> V_83 ) ;
}
static void F_20 ( struct V_26 * V_23 ) {}
static void F_26 ( struct V_26 * V_23 ) {}
static struct V_59 * F_28 ( struct V_13 * V_14 , T_4 V_86 )
{
T_5 V_65 ;
struct V_59 * V_87 ;
V_87 = F_29 ( V_14 -> V_23 -> V_88 , V_86 , & V_65 ) ;
if ( ! V_87 ) {
F_24 ( V_14 -> V_23 -> V_23 , L_48 ) ;
return NULL ;
}
...
static inline void F_30 ( struct V_26 * V_23 ,
struct V_59 * V_60 )
{
F_31 ( V_23 -> V_88 , V_60 , ( T_5 ) V_60 -> V_65 ) ;
}
static void F_32 ( struct V_26 * V_23 , struct V_15 * V_16 )
{
struct V_59 * V_60 ;
struct V_59 * V_61 ;
V_61 = V_16 -> V_62 ;
...
static void F_33 ( struct V_13 * V_14 , struct V_15 * V_16 ,
int V_72 )
__releases( &dev->lock
static struct V_89 * F_34 ( struct V_90 * V_91 , T_4 V_86 )
{
struct V_15 * V_16 ;
V_16 = F_35 ( sizeof( * V_16 ) , V_86 ) ;
if ( ! V_16 )
return NULL ;
F_36 ( & V_16 -> V_58 ) ;
return & V_16 -> V_16 ;
...
V_16 = F_38 ( & V_14 -> V_58 , struct V_15 , V_58 ) ;
F_39 ( ! V_16 -> V_64 ) ;
F_40 () ;
F_41 ( & V_14 -> V_33 -> V_93 , V_16 -> V_64 -> V_65 ) ;
V_92 = F_10 ( & V_14 -> V_33 -> V_92 ) ;
F_41 ( & V_14 -> V_33 -> V_92 , V_92 | V_94 ) ;
V_14 -> V_43 = 1 ;
}
static void F_42 ( struct V_13 * V_14 , int V_72 )
{
struct V_15 * V_16 ;
V_16 = F_38 ( & V_14 -> V_58 , struct V_15 , V_58 ) ;
F_33 ( V_14 , V_16 , V_72 ) ;
...
L_49 ,
V_96 , V_14 -> V_48 ) ;
V_104 = F_44 ( V_14 , V_16 , V_105 , V_96 , V_86 ) ;
if ( V_104 )
goto V_107;
V_102 -= V_96 ;
V_103 += V_96 ;
...
static int F_47 ( struct V_13 * V_14 , struct V_15 * V_16 ,
T_4 V_86 )
{
T_2 V_102 ;
T_2 V_103 ;
...
static int F_48 ( struct V_13 * V_14 , struct V_15 * V_16 , T_4 V_86 )
{
struct V_26 * V_23 = V_14 -> V_23 ;
int V_104 ;
if ( F_49 ( ! V_14 -> V_14 . V_60 && V_14 -> V_111 != 0 ) ) {
F_24 ( V_23 -> V_23 , L_50 , V_14 -> V_14 . V_38 ) ;
return - V_112 ;
}
if ( F_49 ( ! V_16 -> V_16 . V_25 || ! F_12 ( & V_16 -> V_58 ) ) ) {
F_24 ( V_23 -> V_23 ,
L_51 ,
...
if ( F_49 ( ! V_23 -> V_114 || V_23 -> V_73 . V_115 == V_116 ) ) {
F_24 ( V_23 -> V_23 , L_53 ) ;
return - V_117 ;
}
if ( V_23 -> V_76 == V_11 ) {
...
V_104 = F_50 ( & V_23 -> V_73 , & V_16 -> V_16 , V_14 -> V_18 ) ;
if ( V_104 ) {
F_24 ( V_23 -> V_23 , L_55 ) ;
return V_104 ;
}
...
V_104 = F_45 ( V_14 , V_16 , V_86 ) ;
if ( V_104 )
return V_104 ;
V_16 -> V_16 . V_72 = - V_119 ;
V_16 -> V_16 . V_20 = 0 ;
F_51 ( & V_16 -> V_58 , & V_14 -> V_58 ) ;
if ( ! V_14 -> V_43 && F_52 ( ! V_14 -> V_44 ) )
F_37 ( V_14 ) ;
return 0 ;
}
static inline int F_53 ( struct V_13 * V_14 , struct V_15 * V_16 ,
T_4 V_86 )
{
if ( V_14 -> V_18 )
F_3 ( L_56 , V_14 , V_16 ) ;
return F_48 ( V_14 , V_16 , V_86 ) ;
}
...
V_16 = F_38 ( & V_14 -> V_58 , struct V_15 , V_58 ) ;
F_33 ( V_14 , V_16 , - V_117 ) ;
}
}
static void F_55 ( struct V_13 * V_14 )
{
F_41 ( & V_14 -> V_33 -> V_32 , 0 ) ;
F_41 ( & V_14 -> V_33 -> V_92 , 0 ) ;
V_14 -> V_14 . V_47 = V_120 ;
V_14 -> V_14 . V_60 = NULL ;
V_14 -> V_44 = 1 ;
V_14 -> V_43 = 0 ;
}
static void F_56 ( struct V_26 * V_23 )
{
T_3 V_32 ;
V_32 = F_10 ( & V_23 -> V_121 [ 0 ] . V_33 -> V_32 ) ;
F_41 ( & V_23 -> V_121 [ 0 ] . V_33 -> V_32 , V_32 | V_122 ) ;
V_32 = F_10 ( & V_23 -> V_123 [ 0 ] . V_33 -> V_32 ) ;
F_41 ( & V_23 -> V_123 [ 0 ] . V_33 -> V_32 , V_32 | V_122 ) ;
V_23 -> V_76 = V_10 ;
}
static int F_57 ( struct V_13 * V_14 , int V_124 , int V_125 , int V_126 )
{
T_3 V_32 ;
int V_127 = 0 ;
...
F_5 ( V_14 -> V_23 -> V_23 , L_58 ,
( V_124 ? ( V_125 ? L_59 : L_60 ) : L_61 ) , V_14 -> V_14 . V_38 ) ;
V_32 = F_10 ( & V_14 -> V_33 -> V_32 ) ;
if ( V_124 ) {
F_41 ( & V_14 -> V_33 -> V_32 , V_32 | V_40 ) ;
V_14 -> V_44 = 1 ;
if ( V_125 )
V_14 -> V_45 = 1 ;
} else {
...
static inline void F_58 ( struct V_26 * V_23 , enum V_1 V_28 )
{
if ( V_23 -> V_76 != V_28 )
F_8 ( V_23 -> V_23 , L_62 ,
F_1 ( V_28 ) ) ;
...
{
F_41 ( & V_23 -> V_33 -> V_71 , 0 ) ;
F_40 () ;
V_23 -> V_77 = 0 ;
}
static void F_60 ( struct V_26 * V_23 )
{
struct V_13 * V_14 ;
F_14 (ep, &dev->ep_list, ep_list)
F_54 ( V_14 ) ;
...
struct V_26 * V_23 ;
T_3 V_71 ;
V_14 = F_63 ( V_91 , struct V_13 , V_14 ) ;
V_23 = V_14 -> V_23 ;
F_64 ( & V_23 -> V_133 ) ;
V_71 = F_10 ( & V_23 -> V_33 -> V_71 ) ;
V_71 |= V_134 | ( V_23 -> V_79 << V_135 ) ;
F_41 ( & V_23 -> V_33 -> V_71 , V_71 ) ;
F_65 ( & V_23 -> V_133 ) ;
}
static void F_66 ( struct V_90 * V_91 , struct V_89 * V_132 )
{
}
static int F_67 ( struct V_26 * V_23 , T_1 * V_25 , int V_19 ,
void (* F_68)( struct V_90 * V_14 ,
struct V_89 * V_16 ) )
{
...
V_23 -> V_137 -> V_16 . F_68 = F_68 ;
V_72 = F_53 ( & V_23 -> V_123 [ 0 ] , V_23 -> V_137 , V_139 ) ;
if ( V_72 < 0 )
F_24 ( V_23 -> V_23 ,
L_63 , V_72 ) ;
return V_72 ;
}
static inline int F_69 ( struct V_26 * V_23 , T_2 V_140 )
{
T_6 V_141 = F_70 ( V_140 ) ;
return F_67 ( V_23 , ( T_1 * ) & V_141 , 2 ,
F_66 ) ;
}
static inline int F_71 ( struct V_26 * V_23 )
{
return F_67 ( V_23 , NULL , 0 , F_66 ) ;
}
static void F_72 ( struct V_26 * V_23 , T_1 V_142 )
{
T_3 V_71 ;
...
switch ( V_27 ) {
case V_145 :
F_5 ( V_23 -> V_23 , L_64 , V_28 & 0xff ) ;
F_72 ( V_23 , V_28 & 0xff ) ;
if ( V_28 )
F_61 ( & V_23 -> V_73 , V_146 ) ;
else
F_61 ( & V_23 -> V_73 , V_147 ) ;
return F_71 ( V_23 ) ;
case V_148 :
V_140 = 0x0001 | ( V_23 -> V_78 ? 0x0002 : 0 ) ;
return F_69 ( V_23 , V_140 ) ;
case V_149 :
switch ( V_28 ) {
case V_150 :
V_23 -> V_78 = 1 ;
...
static int F_75 ( struct V_26 * V_23 , T_1 type , T_1 V_27 ,
T_2 V_28 , T_2 V_29 )
{
struct V_13 * V_14 ;
int V_72 ;
...
return F_69 ( V_23 , V_156 ? 0x0001 : 0 ) ;
case V_149 :
switch ( V_28 ) {
case V_162 :
V_72 = F_57 ( V_14 , 1 , 0 , 1 ) ;
if ( V_72 >= 0 )
V_72 = F_71 ( V_23 ) ;
return V_72 ;
}
...
static void F_76 ( struct V_26 * V_23 )
{
int V_104 = F_53 ( & V_23 -> V_121 [ 0 ] , V_23 -> V_163 , V_139 ) ;
if ( V_104 )
F_24 ( V_23 -> V_23 , L_65 ,
V_104 ) ;
}
static void F_77 ( struct V_26 * V_23 , struct V_15 * V_16 )
__releases( &dev->lock
static void F_78 ( struct V_26 * V_23 , T_3 V_72 )
{
T_3 V_71 ;
V_23 -> V_73 . V_115 = F_79 ( V_72 ) ;
F_61 ( & V_23 -> V_73 , V_164 ) ;
...
V_23 -> V_77 = 1 ;
F_40 () ;
F_41 ( & V_23 -> V_33 -> V_71 , V_167 ) ;
V_72 = F_10 ( & V_23 -> V_33 -> V_72 ) ;
if ( V_72 & V_170 )
F_78 ( V_23 , V_72 ) ;
}
static void F_81 ( struct V_26 * V_23 )
{
F_60 ( V_23 ) ;
...
static void F_82 ( struct V_26 * V_23 , T_3 V_72 )
{
F_72 ( V_23 , 0 ) ;
F_58 ( V_23 , V_5 ) ;
F_61 ( & V_23 -> V_73 , V_147 ) ;
...
F_41 ( & V_14 -> V_33 -> V_92 , V_172 | V_94 ) ;
}
return 1 ;
}
static int F_86 ( struct V_26 * V_23 )
{
T_3 V_72 = F_10 ( & V_23 -> V_33 -> V_72 ) ;
int V_177 = 0 ;
...
F_5 ( V_23 -> V_23 , L_68 ,
F_17 ( V_72 ) ) ;
F_41 ( & V_23 -> V_33 -> V_72 , V_180 ) ;
F_82 ( V_23 , V_72 ) ;
V_177 = 1 ;
}
if ( V_23 -> V_73 . V_115 != F_79 ( V_72 ) ) {
F_5 ( V_23 -> V_23 , L_69 ,
F_17 ( V_72 ) ) ;
V_23 -> V_73 . V_115 = F_79 ( V_72 ) ;
V_177 = 1 ;
...
static T_7 F_87 ( int V_186 , void * V_187 )
{
...
V_177 = F_83 ( V_14 ) || V_177 ;
}
for ( V_138 = 0 ; V_138 < V_23 -> V_161 ; V_138 ++ ) {
V_14 = & V_23 -> V_121 [ V_138 ] ;
if ( ! V_14 -> V_44 && ! V_14 -> V_46 && ! F_12 ( & V_14 -> V_58 ) )
V_177 = F_85 ( V_14 ) || V_177 ;
}
V_177 = F_86 ( V_23 ) || V_177 ;
if ( ! V_177 ) {
F_14 (ep, &dev->ep_list, ep_list) {
...
V_189:
F_89 ( & V_23 -> V_133 , V_188 ) ;
return V_177 ? V_191 : V_192 ;
}
static T_7 F_90 ( int V_186 , void * V_187 )
{
struct V_26 * V_23 = V_187 ;
if ( ! V_23 -> V_77 )
return V_192 ;
...
V_196 = 0x7ff & F_97 ( V_60 ) ;
V_195 = 0x3 & ( F_97 ( V_60 ) >> 11 ) ;
V_197 = F_98 ( V_32 ) ;
...
if ( V_14 -> V_18 )
V_32 |= V_201 ;
F_41 ( & V_14 -> V_33 -> V_32 , V_32 ) ;
F_41 ( & V_14 -> V_33 -> V_92 , V_202 | V_203 ) ;
F_65 ( & V_14 -> V_23 -> V_133 ) ;
F_5 ( V_14 -> V_23 -> V_23 , L_80 ,
V_14 -> V_14 . V_38 , V_39 [ V_35 ] , V_14 -> V_48 ) ;
return 0 ;
}
static int F_99 ( struct V_90 * V_91 )
{
struct V_13 * V_14 ;
struct V_26 * V_23 ;
unsigned long V_188 ;
...
static void F_100 ( struct V_90 * V_91 , struct V_89 * V_132 )
{
struct V_15 * V_16 ;
if ( ! V_91 || ! V_132 )
return;
V_16 = F_63 ( V_132 , struct V_15 , V_16 ) ;
F_101 ( ! F_12 ( & V_16 -> V_58 ) ,
L_82 ) ;
F_102 ( V_16 ) ;
}
...
if ( V_14 -> V_18 )
F_3 ( L_83 , V_14 , V_16 ) ;
V_104 = F_48 ( V_14 , V_16 , V_86 ) ;
F_65 ( & V_14 -> V_23 -> V_133 ) ;
return V_104 ;
}
static int F_104 ( struct V_90 * V_91 , struct V_89 * V_132 )
{
struct V_15 * V_16 ;
struct V_13 * V_14 ;
struct V_26 * V_23 ;
...
if ( F_38 ( & V_14 -> V_58 , struct V_15 , V_58 ) == V_16 ) {
F_43 ( V_14 ) ;
if ( V_14 -> V_44 )
F_33 ( V_14 , V_16 , - V_206 ) ;
else
F_42 ( V_14 , - V_206 ) ;
...
static int F_105 ( struct V_90 * V_91 , int V_124 , int V_125 )
{
int V_104 ;
struct V_13 * V_14 ;
if ( ! V_91 )
...
V_104 = F_57 ( V_14 , V_124 , V_125 , 0 ) ;
V_189:
F_65 ( & V_14 -> V_23 -> V_133 ) ;
return V_104 ;
}
static int F_106 ( struct V_90 * V_91 , int V_124 )
{
return F_105 ( V_91 , V_124 , 0 ) ;
}
static int F_107 ( struct V_90 * V_91 )
{
return F_105 ( V_91 , 1 , 1 ) ;
}
...
if ( ! V_211 )
return - V_204 ;
V_23 = F_63 ( V_211 , struct V_26 , V_73 ) ;
...
static int F_112 ( struct V_210 * V_211 , int V_214 )
{
struct V_26 * V_23 ;
T_3 V_71 ;
if ( ! V_211 )
...
static int F_113 ( struct V_210 * V_73 ,
struct V_215 * V_114 )
{
struct V_26 * V_23 = F_114 ( V_73 ) ;
F_64 ( & V_23 -> V_133 ) ;
V_114 -> V_114 . V_216 = NULL ;
V_23 -> V_114 = V_114 ;
F_80 ( V_23 ) ;
F_65 ( & V_23 -> V_133 ) ;
F_115 ( V_23 -> V_23 , L_85 ,
V_114 -> V_114 . V_38 ) ;
return 0 ;
}
static int F_116 ( struct V_210 * V_73 ,
struct V_215 * V_114 )
{
struct V_26 * V_23 = F_114 ( V_73 ) ;
unsigned long V_188 ;
...
F_60 ( V_23 ) ;
F_89 ( & V_23 -> V_133 , V_188 ) ;
F_115 ( V_23 -> V_23 , L_86 ) ;
return 0 ;
}
static int F_117 ( struct V_26 * V_23 , int V_111 , int V_18 , T_3 V_217 )
{
struct V_13 * V_14 ;
struct V_15 * V_16 ;
struct V_89 * V_132 ;
...
F_36 ( & V_14 -> V_58 ) ;
if ( V_111 == 0 ) {
V_132 = F_34 ( & V_14 -> V_14 , V_222 ) ;
V_25 = F_118 ( V_23 -> V_23 , V_223 , V_224 | V_222 ) ;
if ( ! V_132 || ! V_25 ) {
return - V_97 ;
}
V_16 = F_63 ( V_132 , struct V_15 , V_16 ) ;
...
V_23 -> V_163 = V_16 ;
F_119 ( & V_14 -> V_14 , V_120 ) ;
V_14 -> V_48 = V_120 ;
} else {
F_119 ( & V_14 -> V_14 , ( T_2 ) V_217 ) ;
F_51 ( & V_14 -> V_14 . V_225 , & V_23 -> V_73 . V_225 ) ;
}
F_51 ( & V_14 -> V_225 , & V_23 -> V_225 ) ;
return 0 ;
}
static int F_120 ( struct V_26 * V_23 )
{
...
int V_173 ;
F_72 ( V_23 , 0 ) ;
F_36 ( & V_23 -> V_73 . V_225 ) ;
V_23 -> V_73 . V_115 = V_116 ;
V_23 -> V_73 . V_233 = & V_23 -> V_123 [ 0 ] . V_14 ;
F_36 ( & V_23 -> V_225 ) ;
F_58 ( V_23 , V_4 ) ;
V_231 = ( T_3 * ) F_121 ( V_227 , L_87 , & V_173 ) ;
V_173 /= sizeof( T_3 ) ;
for ( V_138 = 0 ; V_138 < V_23 -> V_161 ; V_138 ++ ) {
V_232 = ( V_231 && V_138 < V_173 ) ? V_231 [ V_138 ] : 1024 ;
V_104 = F_117 ( V_23 , V_138 , 0 , V_232 ) ;
if ( V_104 )
return V_104 ;
}
V_231 = ( T_3 * ) F_121 ( V_227 , L_88 , & V_173 ) ;
V_173 /= sizeof( T_3 ) ;
for ( V_138 = 0 ; V_138 < V_23 -> V_160 ; V_138 ++ ) {
V_232 = ( V_231 && V_138 < V_173 ) ? V_231 [ V_138 ] : 1024 ;
V_104 = F_117 ( V_23 , V_138 , 1 , V_232 ) ;
if ( V_104 )
return V_104 ;
}
V_23 -> V_78 = 0 ;
...
V_230 = V_202 | V_203 ;
F_41 ( & V_23 -> V_121 [ 0 ] . V_33 -> V_32 , V_229 ) ;
F_41 ( & V_23 -> V_123 [ 0 ] . V_33 -> V_32 , V_229 | V_201 ) ;
F_41 ( & V_23 -> V_121 [ 0 ] . V_33 -> V_92 , V_230 ) ;
F_41 ( & V_23 -> V_123 [ 0 ] . V_33 -> V_92 , V_230 ) ;
return 0 ;
}
static int F_122 ( struct V_234 * V_235 )
{
struct V_26 * V_23 = F_123 ( & V_235 -> V_23 ) ;
if ( V_23 -> V_236 )
F_124 ( & V_23 -> V_73 ) ;
if ( V_23 -> V_114 )
return - V_118 ;
...
if ( V_23 -> V_88 )
F_125 ( V_23 -> V_88 ) ;
F_126 ( & V_235 -> V_23 , NULL ) ;
F_100 ( & V_23 -> V_123 [ 0 ] . V_14 , & V_23 -> V_137 -> V_16 ) ;
F_100 ( & V_23 -> V_121 [ 0 ] . V_14 , & V_23 -> V_163 -> V_16 ) ;
return 0 ;
}
static int F_127 ( struct V_26 * V_23 , int V_186 )
{
return F_128 ( V_23 -> V_23 , V_186 , F_90 , F_87 ,
V_237 , V_238 , V_23 ) ;
}
...
int V_127 ;
T_3 V_72 ;
V_23 = F_118 ( & V_235 -> V_23 , sizeof( * V_23 ) , V_222 ) ;
if ( ! V_23 )
return - V_97 ;
V_23 -> V_23 = & V_235 -> V_23 ;
V_240 = F_130 ( V_235 , V_242 , 0 ) ;
V_33 = F_131 ( V_23 -> V_23 , V_240 ) ;
if ( F_23 ( V_33 ) )
return F_132 ( V_33 ) ;
...
V_23 -> V_88 = F_135 ( L_92 , V_23 -> V_23 ,
...
F_20 ( V_23 ) ;
F_59 ( V_23 ) ;
V_127 = F_127 ( V_23 , V_23 -> V_186 ) ;
if ( V_127 ) {
F_24 ( V_23 -> V_23 , L_95 , V_23 -> V_186 ) ;
goto V_189;
}
if ( V_23 -> V_243 ) {
V_127 = F_127 ( V_23 , V_23 -> V_243 ) ;
if ( V_127 ) {
F_24 ( V_23 -> V_23 , L_96 ,
V_23 -> V_243 ) ;
goto V_189;
}
V_127 = F_127 ( V_23 , V_23 -> V_244 ) ;
if ( V_127 ) {
F_24 ( V_23 -> V_23 , L_97 ,
V_23 -> V_244 ) ;
goto V_189;
...
if ( V_23 -> V_243 )
F_115 ( V_23 -> V_23 , L_98 , V_23 -> V_33 ,
V_23 -> V_186 , V_23 -> V_243 , V_23 -> V_244 ) ;
else
F_115 ( V_23 -> V_23 , L_99 , V_23 -> V_33 , V_23 -> V_186 ) ;
V_189:
F_65 ( & V_23 -> V_133 ) ;
if ( V_127 )
F_122 ( V_235 ) ;
