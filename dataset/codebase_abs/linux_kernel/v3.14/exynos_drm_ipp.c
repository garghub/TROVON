...
struct V_98 * V_99 ;
int V_37 = 0 ;
F_16 ( L_30 , V_104 -> V_105 ) ;
V_99 = & V_36 -> V_93 [ V_104 -> V_106 ] ;
F_24 (m_node, head, list) {
F_16 ( L_31 , V_37 ++ , ( int ) V_97 ) ;
...
F_16 ( L_37 , ( int ) V_97 , V_104 -> V_106 ) ;
F_16 ( L_38 , V_104 -> V_34 , V_97 -> V_105 ) ;
F_50 (i) {
F_16 ( L_39 , V_79 , V_104 -> V_116 [ V_79 ] ) ;
if ( V_104 -> V_116 [ V_79 ] ) {
V_115 = F_51 ( V_40 ,
...
struct V_123 * V_124 ;
unsigned long V_125 ;
F_16 ( L_44 , V_104 -> V_106 , V_104 -> V_105 ) ;
...
int V_17 , V_79 ;
F_36 (i)
F_16 ( L_88 , V_79 ? L_16 : L_17 , V_105 [ V_79 ] ) ;
if ( ! V_40 ) {
F_18 ( L_89 ) ;
return - V_7 ;
}
...
F_83 ( & V_166 ) ;
F_16 ( L_94 , V_166 . V_168 , V_166 . V_169 ) ;
...
F_97 ( & V_26 -> V_30 ) ;
F_97 ( & V_26 -> V_80 ) ;
V_26 -> V_174 = F_98 ( L_104 ) ;
if ( ! V_26 -> V_174 ) {
F_99 ( V_24 , L_105 ) ;
return - V_7 ;
}
V_26 -> V_133 = F_98 ( L_106 ) ;
if ( ! V_26 -> V_133 ) {
F_99 ( V_24 , L_107 ) ;
V_17 = - V_7 ;
goto V_180;
