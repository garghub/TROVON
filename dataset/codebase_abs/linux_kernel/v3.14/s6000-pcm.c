...
F_6 ( V_12 ) , 0 ) ;
F_26 ( & V_6 -> V_44 , V_46 ) ;
F_31 ( F_5 ( V_12 ) , F_6 ( V_12 ) ) ;
F_28 ( & V_6 -> V_44 , V_46 ) ;
return 0 ;
}
static int F_32 ( struct V_1 * V_2 , int V_49 )
{
struct V_8 * V_9 = V_2 -> V_7 ;
struct V_10 * V_11 ;
int V_35 ;
...
F_26 ( & V_6 -> V_44 , V_46 ) ;
if ( V_2 -> V_21 == V_22 )
V_59 = F_21 ( F_5 ( V_11 -> V_24 ) ,
F_6 ( V_11 -> V_24 ) ) ;
else
V_59 = F_22 ( F_5 ( V_11 -> V_26 ) ,
F_6 ( V_11 -> V_26 ) ) ;
V_59 -= V_4 -> V_20 ;
F_28 ( & V_6 -> V_44 , V_46 ) ;
V_58 = F_35 ( V_4 , V_59 ) ;
...
V_6 = F_41 ( sizeof( struct V_5 ) , V_68 ) ;
if ( V_6 == NULL )
return - V_69 ;
F_42 ( & V_6 -> V_44 ) ;
V_4 -> V_7 = V_6 ;
...
static int F_54 ( struct V_8 * V_4 )
{
