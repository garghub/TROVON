...
static int F_45 ( struct V_91 * V_66 , unsigned int V_24 ,
T_4 V_92 )
{
F_46 ( V_24 , & V_93 ,
V_94 ) ;
...
{
int V_15 = 0 , V_97 ;
struct V_98 * V_99 = V_80 -> V_100 . V_53 ;
const struct V_101 * V_102 =
F_49 ( V_103 , & V_80 -> V_100 ) ;
const struct V_83 * V_104 ;
...
V_97 = V_104 -> V_90 ;
V_37 = V_97 - 1 ;
V_23 = F_51 ( - 1 , 0 , V_97 , 0 ) ;
if ( V_23 < 0 ) {
F_50 ( & V_80 -> V_100 , L_8 ) ;
V_15 = V_23 ;
goto V_107;
}
V_108 = F_52 ( V_99 , V_97 , V_23 , 0 ,
& V_109 , NULL ) ;
V_54 = V_99 ;
return 0 ;
V_107:
...
struct V_112 * V_112 ;
struct V_113 * V_114 ;
int V_6 , V_24 , V_15 , V_115 = 0 ;
int V_116 = 0 , V_117 = 0 , V_118 , V_119 = 0 ;
V_114 = F_55 ( & V_80 -> V_100 ) ;
if ( V_114 ) {
V_23 = V_114 -> V_23 ;
if ( V_23 <= 0 )
return - V_38 ;
...
return - V_38 ;
V_116 = F_56 ( V_80 , L_9 ) ;
V_117 = F_56 ( V_80 , L_10 ) ;
V_118 = F_56 ( V_80 , L_11 ) ;
if ( ( V_116 > 0 && V_117 <= 0 ) || ( V_116 <= 0 && V_117 > 0 )
|| ( V_118 <= 0 ) )
return - V_38 ;
V_111 = F_57 ( V_80 , V_120 , 0 ) ;
if ( ! V_111 )
return - V_38 ;
V_47 = F_58 ( V_111 -> V_121 , F_59 ( V_111 ) ) ;
if ( ! V_47 )
return - V_38 ;
if ( V_116 > 0 )
V_119 = 2 ;
V_112 = F_60 ( & V_80 -> V_100 , NULL ) ;
if ( F_61 ( V_112 ) ) {
F_50 ( & V_80 -> V_100 , L_12 ,
F_62 ( V_112 ) ) ;
F_53 ( V_47 ) ;
return F_62 ( V_112 ) ;
}
...
F_21 ( V_37 , V_114 ? V_114 -> V_122 : NULL ) ;
F_34 (gpio, c) {
F_15 ( 0 , V_2 -> V_5 + V_62 ) ;
F_15 ( 0 , V_2 -> V_5 + V_60 ) ;
F_15 ( ~ 0 , V_2 -> V_5 + V_77 ) ;
if ( F_6 ( V_9 ) )
F_15 ( ~ 0 , V_2 -> V_5 + V_123 ) ;
}
if ( ! V_115 ) {
#ifdef F_65
V_24 = F_37 ( 0 ) ;
...
int V_6 ;
F_34 (gpio, c) {
V_2 -> V_127 = F_9 ( V_2 -> V_5 + V_33 ) ;
V_2 -> V_128 = F_9 ( V_2 -> V_5 + V_18 ) ;
V_2 -> V_129 = F_9 ( V_2 -> V_5 + V_60 ) ;
V_2 -> V_130 = F_9 ( V_2 -> V_5 + V_62 ) ;
...
int V_6 ;
F_34 (gpio, c) {
F_15 ( V_2 -> V_127 , V_2 -> V_5 + V_30 ) ;
F_15 ( ~ V_2 -> V_127 , V_2 -> V_5 + V_31 ) ;
F_15 ( V_2 -> V_129 , V_2 -> V_5 + V_60 ) ;
F_15 ( V_2 -> V_130 , V_2 -> V_5 + V_62 ) ;
F_15 ( V_2 -> V_128 , V_2 -> V_5 + V_18 ) ;
}
}
