...
for ( V_57 = 0 ; V_57 < V_74 - 1 ; V_57 ++ )
V_65 -> V_75 [ 0 ] -> V_76 [ V_57 ] = V_68 [ V_57 ] ;
F_32 ( V_10 , V_65 , V_77 ) ;
return 0 ;
}
...
static int F_35 ( struct V_13 * V_85 )
{
F_10 ( L_27 , V_12 , V_85 -> V_42 ) ;
return 0 ;
}
static void F_36 ( struct V_13 * V_85 )
{
F_10 ( L_27 , V_12 , V_85 -> V_42 ) ;
}
...
static void F_37 ( char * V_87 , unsigned int * V_88 , const char * V_68 , unsigned int V_89 )
{
memcpy ( V_87 + * V_88 , V_68 , V_89 ) ;
* V_88 += V_89 ;
}
static int F_38 ( struct V_13 * V_85 )
{
...
F_10 ( L_28 ,
V_12 , V_60 -> V_45 ) ;
F_37 ( V_87 , & V_88 , V_94 , sizeof( V_94 ) ) ;
}
if ( V_60 -> V_45 & V_95 ) {
F_10 ( L_29
L_30 , V_12 , V_60 -> V_45 ) ;
F_37 ( V_87 , & V_88 , V_96 , sizeof( V_96 ) ) ;
}
if ( V_60 -> V_45 & V_97 ) {
F_10 ( L_31 ,
V_12 , V_60 -> V_45 ) ;
F_37 ( V_87 , & V_88 , V_98 , sizeof( V_98 ) ) ;
}
if ( V_60 -> V_45 & V_99 ) {
F_10 ( L_32 ,
V_12 , V_60 -> V_45 ) ;
F_37 ( V_87 , & V_88 , V_100 , sizeof( V_100 ) ) ;
}
if ( V_60 -> V_45 & V_101 ) {
F_10 ( L_33 ,
V_12 , V_60 -> V_45 ) ;
F_37 ( V_87 , & V_88 , V_102 , sizeof( V_102 ) ) ;
}
if ( V_60 -> V_45 & V_103 ) {
F_10 ( L_34 ,
V_12 , V_60 -> V_45 ) ;
}
V_52 = F_40 ( V_85 , V_87 , V_88 ) ;
F_5 ( V_87 ) ;
return V_52 ;
}
static int F_41 ( struct V_104 * V_11 , unsigned int type ,
unsigned int V_105 , int V_76 )
{
struct V_13 * V_20 = F_42 ( V_11 ) ;
...
if ( type != V_109 )
return - 1 ;
V_108 = F_44 ( V_20 , type , V_105 , & V_75 ) ;
if ( V_108 == - 1 ) {
F_45 ( & V_11 -> V_11 , L_36 ) ;
return - 1 ;
}
F_46 ( V_75 , V_108 , V_76 ) ;
V_68 = F_47 ( V_75 -> V_65 , V_110 ) ;
if ( ! V_68 ) {
F_45 ( & V_11 -> V_11 , L_37 ) ;
return - 1 ;
}
F_48 ( V_75 -> V_65 , & V_68 [ 0 ] ) ;
V_67 = & V_106 -> V_69 [ V_70 ] ;
V_65 = V_67 -> V_71 [ V_72 ] ;
F_46 ( V_65 -> V_75 [ 0 ] , 0 , V_5 -> V_9 ) ;
F_46 ( V_65 -> V_75 [ 0 ] , 1 , V_111 ) ;
F_46 ( V_65 -> V_75 [ 0 ] , 2 , V_68 [ 1 ] ) ;
F_32 ( V_106 , V_65 , V_77 ) ;
F_5 ( V_68 ) ;
return 0 ;
}
static int F_49 ( struct V_13 * V_85 )
{
F_10 ( L_10 , V_12 ) ;
return 0 ;
}
static void F_50 ( struct V_13 * V_85 )
{
F_10 ( L_10 , V_12 ) ;
}
...
static int F_53 ( struct V_13 * V_10 ,
const struct V_116 * V_117 )
{
struct V_15 * V_16 = F_8 ( V_10 -> V_11 . V_17 ) ;
struct V_1 * V_2 ;
int V_52 ;
if ( F_54 ( (struct V_4 * ) V_10 -> V_47 ) )
return - V_73 ;
F_10 ( L_39 , V_12 ,
V_16 -> V_118 -> V_119 . V_120 ) ;
if ( V_16 -> V_118 -> V_119 . V_120 !=
V_121 ) {
F_10 ( L_40 , V_12 ,
V_16 -> V_118 -> V_119 . V_120 ) ;
return - V_73 ;
...
if ( ! F_60 ( V_10 , V_70 , V_72 ,
0 , V_74 - 1 ) ) {
V_52 = - V_73 ;
goto V_123;
}
V_52 = F_61 ( V_10 , V_124 ) ;
if ( V_52 ) {
F_6 ( & V_10 -> V_11 ,
L_44 , V_12 ) ;
goto V_125;
...
static void F_68 ( struct V_13 * V_10 )
{
struct V_1 * V_2 = F_52 ( V_10 ) ;
struct V_4 * V_5 ;
int V_57 ;
...
F_64 ( V_10 ) ;
F_65 ( V_10 ) ;
for ( V_57 = 0 ; V_57 < ( V_129 + V_26 ) ; V_57 ++ ) {
V_5 = V_2 -> V_8 [ V_57 ] ;
if ( V_5 != NULL ) {
F_4 ( V_5 -> V_10 ) ;
F_5 ( V_5 ) ;
...
static int F_70 ( struct V_13 * V_10 ,
const struct V_116 * V_117 )
{
int V_130 ;
