...
int V_73 ;
T_1 V_3 ;
V_73 = F_24 ( V_48 , 8 , 16 , V_123 ) ;
if ( V_73 < 0 ) {
F_14 ( V_48 -> V_2 , L_3 , V_73 ) ;
return V_73 ;
}
V_73 = F_25 ( V_48 ) ;
if ( V_73 < 0 ) {
...
V_3 = F_4 ( V_48 , V_40 ) ;
V_73 = F_5 ( V_48 , V_40 , V_3 | V_121 -> V_124 ) ;
if ( V_73 < 0 )
return V_73 ;
}
return V_73 ;
...
static int F_28 ( struct V_125 * V_126 ,
const struct V_127 * V_128 )
{
struct V_86 * V_87 ;
int V_73 ;
V_87 = F_29 ( & V_126 -> V_2 , sizeof( struct V_86 ) ,
V_129 ) ;
if ( V_87 == NULL )
return - V_130 ;
V_87 -> V_96 = F_30 ( V_126 , & V_131 ) ;
if ( F_31 ( V_87 -> V_96 ) )
return F_32 ( V_87 -> V_96 ) ;
F_33 ( V_126 , V_87 ) ;
V_73 = F_34 ( & V_126 -> V_2 ,
& V_132 , & V_133 , 1 ) ;
return V_73 ;
}
static int F_35 ( struct V_125 * V_134 )
{
F_36 ( & V_134 -> V_2 ) ;
return 0 ;
}
