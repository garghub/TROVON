...
V_193 = & V_3 -> V_106 ;
V_193 -> type = V_192 -> type ;
V_193 -> V_195 = V_196 | V_197 ;
V_193 -> V_198 = V_103 ;
V_193 -> V_96 = & V_199 ;
V_193 -> V_200 = & V_201 ;
V_193 -> V_202 = sizeof( struct V_91 ) ;
V_33 = F_101 ( V_193 ) ;
if ( V_33 ) {
F_60 ( & V_5 -> V_105 , L_40 ) ;
F_48 ( V_5 -> V_17 ) ;
...
{
int V_33 ;
V_3 -> V_39 . V_105 = V_224 ;
V_33 = F_119 ( & V_3 -> V_39 , V_225 , - 1 ) ;
if ( V_33 < 0 )
F_3 ( L_54 ,
V_226 , V_33 ) ;
return V_33 ;
