...
F_79 ( V_2 , & V_10 -> V_222 ) ;
V_221:
F_80 ( & V_40 -> V_174 . V_220 , V_10 -> V_125 , V_231 ) ;
V_218:
for ( V_42 = 0 ; V_42 < V_210 ; ++ V_42 )
if ( V_10 -> V_22 [ V_42 ] . V_24 )
...
{
struct V_232 * V_174 = & V_39 ( V_2 ) -> V_174 ;
struct V_39 * V_40 = V_39 ( V_2 ) ;
int V_42 , V_233 ;
if ( V_174 -> V_234 )
F_86 ( V_2 -> V_205 -> V_172 , V_2 ) ;
for ( V_42 = 0 ; V_42 < V_2 -> V_5 . V_177 + 1 ; ++ V_42 )
if ( V_174 -> V_10 [ V_42 ] . V_234 ) {
F_86 ( V_174 -> V_10 [ V_42 ] . V_172 , V_174 -> V_10 + V_42 ) ;
V_174 -> V_10 [ V_42 ] . V_234 = 0 ;
}
for ( V_42 = 0 ; V_42 < V_2 -> V_5 . V_202 ; V_42 ++ ) {
if ( V_40 -> V_235 . V_236 & 1ULL << V_42 ) {
V_233 = V_2 -> V_5 . V_177 + 1 + V_42 ;
F_86 ( V_40 -> V_174 . V_10 [ V_233 ] . V_172 ,
& V_40 -> V_174 . V_10 [ V_233 ] ) ;
}
}
F_77 ( V_174 -> V_237 ) ;
}
...
{
struct V_39 * V_40 = V_39 ( V_2 ) ;
V_40 -> V_238 = F_60 ( F_61 ( V_2 -> V_205 , V_40 -> V_239 . V_240 ) +
V_40 -> V_239 . V_241 , V_242 ) ;
if ( ! V_40 -> V_238 ) {
F_47 ( V_2 , L_62 ) ;
return - V_214 ;
}
...
{
struct V_39 * V_40 = V_39 ( V_2 ) ;
V_40 -> V_174 . V_10 = F_90 ( V_2 -> V_5 . V_243 - V_2 -> V_5 . V_201 ,
...
V_95 = F_93 ( & V_40 -> V_174 . V_220 , V_2 -> V_5 . V_243 ,
V_2 -> V_5 . V_243 - 1 , V_2 -> V_5 . V_201 , 0 ) ;
if ( V_95 )
goto V_217;
for ( V_42 = 0 ; V_42 < F_58 ( V_2 ) ; ++ V_42 )
V_40 -> V_174 . V_204 [ V_42 ] = NULL ;
...
goto V_244;
V_40 -> V_174 . V_175 =
F_95 ( 1 << ( V_40 -> V_174 . V_245 & 31 ) ) ;
V_40 -> V_174 . V_176 = V_40 -> V_238 +
( V_40 -> V_174 . V_245 < 32 ? 4 : 0 ) ;
}
V_40 -> V_174 . V_237 =
F_68 ( V_246 * ( V_2 -> V_5 . V_177 + 1 +
V_2 -> V_5 . V_202 ) ,
V_215 ) ;
if ( ! V_40 -> V_174 . V_237 ) {
V_95 = - V_214 ;
...
V_95 = F_64 ( V_2 , V_2 -> V_5 . V_247 -
V_2 -> V_5 . V_248 +
V_171 ,
( V_2 -> V_6 & V_249 ) ? V_42 : 0 ,
...
V_95 = F_64 ( V_2 , V_251 + V_171 ,
( V_2 -> V_6 & V_249 ) ? V_2 -> V_5 . V_177 : 0 ,
...
int F_104 ( struct V_1 * V_2 , char * V_257 , struct V_258 * V_259 ,
int * V_260 )
{
struct V_39 * V_40 = V_39 ( V_2 ) ;
int V_233 = 0 , V_95 = 0 , V_42 ;
F_105 ( & V_40 -> V_235 . V_261 ) ;
for ( V_42 = 0 ; ! V_233 && V_42 < V_2 -> V_5 . V_202 ; V_42 ++ ) {
if ( ~ V_40 -> V_235 . V_236 & 1ULL << V_42 ) {
V_40 -> V_235 . V_236 |= 1ULL << V_42 ;
V_233 = V_2 -> V_5 . V_177 + 1 + V_42 ;
snprintf ( V_40 -> V_174 . V_237 +
V_233 * V_246 ,
V_246 , L_68 , V_257 ) ;
...
if ( V_259 ) {
V_95 = F_107 ( V_259 ,
V_40 -> V_174 . V_10 [ V_233 ] . V_172 ) ;
if ( V_95 )
F_12 ( V_2 , L_69 ) ;
}
#endif
V_95 = F_97 ( V_40 -> V_174 . V_10 [ V_233 ] . V_172 ,
F_52 , 0 ,
& V_40 -> V_174 . V_237 [ V_233 << 5 ] ,
V_40 -> V_174 . V_10 + V_233 ) ;
if ( V_95 ) {
V_40 -> V_235 . V_236 ^= 1 << V_42 ;
V_233 = 0 ;
continue;
}
F_2 ( & V_40 -> V_174 . V_10 [ V_233 ] , 1 ) ;
}
}
F_108 ( & V_40 -> V_235 . V_261 ) ;
if ( V_233 ) {
* V_260 = V_233 ;
} else {
* V_260 = 0 ;
V_95 = ( V_42 == V_2 -> V_5 . V_202 ) ? - V_262 : V_95 ;
}
return V_95 ;
}
void F_109 ( struct V_1 * V_2 , int V_233 )
{
struct V_39 * V_40 = V_39 ( V_2 ) ;
int V_42 = V_233 - V_2 -> V_5 . V_177 - 1 ;
if ( F_110 ( V_42 >= 0 ) ) {
F_105 ( & V_40 -> V_235 . V_261 ) ;
if ( V_40 -> V_235 . V_236 & 1ULL << V_42 ) {
F_86 ( V_40 -> V_174 . V_10 [ V_233 ] . V_172 ,
