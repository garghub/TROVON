...
static void F_44 ( struct V_101 * V_18 )
{
struct V_4 * V_5 ;
struct V_84 * V_6 ;
struct V_1 * V_2 ;
int V_85 ;
V_5 = F_2 ( F_45 ( V_18 ) , struct V_4 , V_18 ) ;
V_102:
V_6 = & V_5 -> V_6 ;
V_2 = V_6 -> V_2 ;
V_85 = V_6 -> V_86 ;
...
static T_2 F_47 ( int V_58 , void * V_16 )
{
struct V_4 * V_5 = V_16 ;
if ( ! V_5 -> V_64 ) {
F_39 ( V_5 ) ;
...
static T_3
F_48 ( struct V_108 * V_16 , struct V_109 * V_110 , char * V_111 )
{
struct V_4 * V_5 = F_49 ( V_16 ) ;
return F_50 ( V_111 , V_112 , L_21 ,
V_5 -> V_20 . V_78 ) ;
}
static T_3
F_51 ( struct V_108 * V_16 , struct V_109 * V_110 ,
...
static T_3
F_52 ( struct V_108 * V_16 , struct V_109 * V_110 ,
const char * V_111 , T_4 V_113 )
{
struct V_4 * V_5 = F_49 ( V_16 ) ;
if ( ! V_5 -> V_6 . V_2 -> V_104 )
return - 1 ;
if ( V_113 > 2 )
return - 1 ;
if ( V_111 [ 0 ] == '1' ) {
...
static T_3
F_53 ( struct V_108 * V_16 , struct V_109 * V_110 ,
char * V_111 )
{
struct V_4 * V_5 = F_49 ( V_16 ) ;
return F_50 ( V_111 , V_112 , L_21 ,
...
static T_3
F_54 ( struct V_108 * V_16 , struct V_109 * V_110 ,
const char * V_111 , T_4 V_113 )
{
struct V_4 * V_5 = F_49 ( V_16 ) ;
if ( ! V_5 -> V_6 . V_2 -> V_104 )
...
static int F_55 ( struct V_114 * V_15 )
{
struct V_4 * V_5 = F_56 ( V_15 ) ;
F_57 ( & V_5 -> V_15 -> V_16 . V_115 , & V_116 ) ;
if ( V_5 -> V_17 ) {
F_58 ( V_5 -> V_17 ) ;
F_59 ( V_5 -> V_17 ) ;
}
...
static int F_61 ( struct V_114 * V_15 )
{
struct V_117 * V_7 = F_62 ( & V_15 -> V_16 ) ;
struct V_4 * V_5 ;
struct V_1 * V_2 ;
struct V_118 * V_119 ;
int V_63 = 0 , V_120 ;
...
V_5 = F_63 ( & V_15 -> V_16 , sizeof( * V_5 ) , V_121 ) ;
if ( ! V_5 ) {
F_17 ( & V_15 -> V_16 , L_28 ) ;
return - V_122 ;
}
V_2 = F_63 ( & V_15 -> V_16 , sizeof( * V_2 ) , V_121 ) ;
if ( ! V_2 )
return - V_122 ;
F_64 ( V_15 , V_5 ) ;
V_5 -> V_15 = V_15 ;
V_5 -> V_7 = V_7 ;
V_5 -> V_62 = F_65 ( & V_15 -> V_16 , NULL ) ;
if ( F_66 ( V_5 -> V_62 ) )
return F_67 ( V_5 -> V_62 ) ;
V_5 -> V_17 = F_68 ( L_29 ) ;
if ( ! V_5 -> V_17 ) {
F_6 ( & V_15 -> V_16 , L_30 ) ;
return - V_122 ;
...
V_2 -> V_126 = F_4 ;
V_2 -> V_8 = F_1 ;
for ( V_120 = 0 ; V_120 < V_26 ; V_120 ++ )
F_18 ( & V_5 -> V_20 . V_25 [ V_120 ] ) ;
V_119 = F_70 ( V_5 -> V_15 ,
V_127 , L_31 ) ;
if ( V_119 == NULL ) {
F_17 ( & V_15 -> V_16 , L_32 ) ;
...
V_5 -> V_66 = F_71 ( & V_15 -> V_16 , V_119 -> V_129 , F_72 ( V_119 ) ) ;
if ( V_5 -> V_66 == NULL ) {
F_17 ( & V_15 -> V_16 , L_33 ) ;
V_63 = - V_130 ;
goto V_128;
...
V_5 -> V_131 = F_71 ( & V_15 -> V_16 , V_119 -> V_129 , F_72 ( V_119 ) ) ;
if ( V_5 -> V_131 == NULL ) {
F_17 ( & V_15 -> V_16 , L_36 ) ;
V_63 = - V_130 ;
goto V_128;
...
V_5 -> V_35 =
(struct V_132 V_133 * ) ( ( unsigned long ) V_5 -> V_131
+ ( F_21 ( V_5 -> V_131 ) & V_134 ) ) ;
if ( V_7 -> V_23 ) {
V_63 = F_73 ( & V_15 -> V_16 , V_7 -> V_23 -> V_58 ,
NULL , F_47 ,
V_135 , L_38 , V_5 ) ;
if ( V_63 ) {
F_9 ( & V_15 -> V_16 ,
...
if ( V_7 -> V_49 ) {
V_5 -> V_67 = 1 ;
V_63 = F_73 ( & V_15 -> V_16 , V_7 -> V_49 -> V_58 ,
NULL , F_47 ,
V_135 , L_40 , V_5 ) ;
if ( V_63 ) {
F_9 ( & V_15 -> V_16 ,
...
F_20 ( V_5 ) ;
F_24 ( V_5 ) ;
V_119 = F_74 ( V_5 -> V_15 , V_137 , 0 ) ;
if ( V_119 == NULL ) {
F_17 ( & V_15 -> V_16 , L_43 ) ;
V_63 = - V_9 ;
goto V_138;
}
V_5 -> V_58 = V_119 -> V_129 ;
if ( F_75 ( & V_15 -> V_16 , V_5 -> V_58 , F_46 , V_59 ,
V_124 , V_5 ) ) {
F_17 ( & V_15 -> V_16 , L_44 ,
V_5 -> V_58 ) ;
V_5 -> V_58 = 0 ;
...
V_63 = F_76 ( & V_5 -> V_6 , V_139 ) ;
if ( V_63 < 0 ) {
F_17 ( & V_15 -> V_16 , L_45 ,
V_63 ) ;
goto V_138;
}
V_63 = F_77 ( & V_15 -> V_16 . V_115 , & V_116 ) ;
if ( V_63 < 0 ) {
F_6 ( & V_15 -> V_16 ,
L_46 , V_63 ) ;
goto V_140;
...
static int F_79 ( struct V_114 * V_15 , T_5 V_86 )
{
struct V_4 * V_5 = F_56 ( V_15 ) ;
if ( V_5 -> V_6 . V_86 != V_88 ) {
F_9 ( & V_15 -> V_16 ,
...
static int F_80 ( struct V_114 * V_15 )
{
struct V_4 * V_5 = F_56 ( V_15 ) ;
T_1 V_42 ;
if ( ! V_5 -> V_67 ) {
