...
if ( F_70 ( ! V_141 [ V_12 ] ) )
return - V_147 ;
F_71 ( & V_9 -> V_133 , V_141 [ V_12 ] , V_12 , NULL ) ;
}
...
static int F_93 ( struct V_38 * V_39 ,
struct V_40 * V_41 )
{
struct V_3 * V_4 = F_39 ( V_39 ) ;
struct V_8 * V_9 = V_4 -> V_9 ;
...
return;
if ( F_45 ( V_4 -> V_95 ) ) {
unsigned int V_171 = F_30 ( V_4 , 0x0f ) ;
if ( F_101 ( V_171 ) == V_172 ||
F_101 ( V_171 ) == V_173 ||
F_101 ( V_171 ) == V_174 ) {
V_171 = ( V_171 & ( ~ V_175 ) )
| ( V_174 <<
...
if ( V_9 -> V_164 )
V_189 |= V_190 ;
V_188 = F_114 ( V_4 , & V_9 -> V_15 . V_107 , NULL , V_189 ) ;
if ( V_188 < 0 )
return V_188 ;
V_9 -> V_15 . V_191 = F_1 ;
V_9 -> V_15 . V_192 = F_3 ;
...
V_9 -> V_15 . V_195 = F_24 ;
V_9 -> V_15 . V_196 = F_26 ;
V_188 = F_115 ( V_4 , & V_9 -> V_15 . V_107 ) ;
if ( V_188 < 0 )
return V_188 ;
V_9 -> V_15 . V_197 [ 3 ] |= V_198 ;
if ( V_9 -> V_125 > 0 ) {
V_188 = F_52 ( V_4 ,
V_9 -> V_125 ) ;
if ( V_188 < 0 )
...
#ifdef F_116
if ( V_9 -> V_15 . V_199 ) {
T_1 V_18 = V_9 -> V_15 . V_199 ;
unsigned int V_115 ;
V_188 = F_52 ( V_4 , V_18 ) ;
if ( V_188 < 0 )
return V_188 ;
if ( V_4 -> V_129 ) {
V_4 -> V_129 -> V_200 = V_9 -> V_201 ;
...
#endif
if ( V_9 -> V_59 )
V_9 -> V_15 . V_202 . V_203 = F_15 ;
if ( V_9 -> V_204 &&
F_37 ( V_4 , L_18 ) == 1 ) {
if ( ! F_57 ( & V_9 -> V_15 , NULL , V_9 -> V_204 ) )
return - V_126 ;
}
if ( V_9 -> V_205 ) {
V_188 = F_68 ( V_4 ) ;
...
static void F_121 ( struct V_206 * V_207 ,
...
static void F_123 ( struct V_206 * V_207 ,
struct V_3 * V_4 ,
unsigned int V_209 )
{
F_122 ( V_207 , L_20 ,
F_7 ( V_4 , V_4 -> V_31 , 0 , V_209 , 0 ) ) ;
}
static void F_124 ( struct V_206 * V_207 ,
struct V_3 * V_4 , T_1 V_18 )
{
F_121 ( V_207 , V_4 , V_18 ) ;
if ( V_18 == V_4 -> V_31 )
F_123 ( V_207 , V_4 , 0xfa0 ) ;
}
static void F_125 ( struct V_206 * V_207 ,
struct V_3 * V_4 , T_1 V_18 )
{
if ( V_18 == V_4 -> V_31 )
F_123 ( V_207 , V_4 , 0xfe0 ) ;
}
static void F_126 ( struct V_206 * V_207 ,
struct V_3 * V_4 , T_1 V_18 )
{
if ( V_18 == V_4 -> V_31 )
F_123 ( V_207 , V_4 , 0xfeb ) ;
}
...
V_9 -> V_47 = 0x01 ;
V_9 -> V_70 = 1 ;
V_9 -> V_74 = F_136 ( V_231 ) ;
V_9 -> V_75 = V_231 ;
V_9 -> V_15 . V_212 = 1 ;
V_9 -> V_15 . V_232 = 1 ;
V_4 -> V_213 = V_214 ;
F_103 ( V_4 , V_233 , V_234 ,
V_235 ) ;
F_104 ( V_4 , V_152 ) ;
if ( ! V_9 -> V_157 )
F_77 ( V_4 , V_236 ) ;
...
V_9 -> V_15 . V_199 = 0x21 ;
V_9 -> V_75 = V_240 ;
V_9 -> V_74 = F_136 ( V_240 ) ;
V_9 -> V_99 = - 1 ;
V_4 -> V_213 = V_214 ;
F_77 ( V_4 , V_241 ) ;
F_103 ( V_4 , V_242 , V_243 ,
V_244 ) ;
F_104 ( V_4 , V_152 ) ;
F_137 ( V_4 ) ;
V_188 = F_113 ( V_4 ) ;
...
{
struct V_8 * V_9 ;
const struct V_246 * V_247 = V_248 ;
int V_188 ;
V_188 = F_128 ( V_4 ) ;
if ( V_188 < 0 )
return V_188 ;
...
if ( F_141 ( F_142 ( V_4 , 0x28 ) ) == V_250 )
F_77 ( V_4 , V_251 ) ;
if ( F_142 ( V_4 , 0xa ) & V_252 )
F_143 ( V_4 , V_247 ) ;
V_9 -> V_204 = & V_253 ;
V_9 -> V_89 = 0x50 ;
V_9 -> V_93 = 0 ;
V_9 -> V_14 = 1 ;
V_9 -> V_15 . V_199 = 0x26 ;
V_9 -> V_74 = F_136 ( V_254 ) ;
V_9 -> V_75 = V_254 ;
F_103 ( V_4 , V_255 , V_256 ,
V_257 ) ;
F_104 ( V_4 , V_152 ) ;
F_137 ( V_4 ) ;
V_188 = F_113 ( V_4 ) ;
...
V_4 -> V_213 = V_214 ;
F_77 ( V_4 , V_258 ) ;
F_145 ( V_4 , 0x12 , V_116 ,
( 0 << V_259 ) |
( 2 << V_128 ) |
( 0x27 << V_260 ) |
( 0 << V_123 ) ) ;
F_103 ( V_4 , V_261 , V_262 ,
V_180 ) ;
F_104 ( V_4 , V_152 ) ;
V_188 = F_113 ( V_4 ) ;
if ( V_188 < 0 ) {
