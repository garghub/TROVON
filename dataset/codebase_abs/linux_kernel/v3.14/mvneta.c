...
static void F_209 ( struct V_1 * V_2 , int V_337 )
{
T_1 V_39 ;
F_1 ( V_2 , V_338 , 0 ) ;
if ( V_337 == V_339 )
...
static int F_210 ( struct V_347 * V_348 )
{
const struct V_327 * V_349 ;
struct V_350 * V_351 ;
struct V_352 * V_353 = V_348 -> V_17 . V_354 ;
struct V_352 * V_288 ;
T_1 V_323 ;
struct V_1 * V_2 ;
struct V_16 * V_17 ;
...
int V_20 ;
if ( V_103 != 0 ) {
F_211 ( & V_348 -> V_17 , L_26 , V_103 ) ;
return - V_238 ;
}
V_17 = F_212 ( sizeof( struct V_1 ) , V_63 , V_66 ) ;
if ( ! V_17 )
return - V_189 ;
V_17 -> V_250 = F_213 ( V_353 , 0 ) ;
if ( V_17 -> V_250 == 0 ) {
V_205 = - V_238 ;
goto V_358;
}
V_288 = F_214 ( V_353 , L_27 , 0 ) ;
if ( ! V_288 ) {
F_211 ( & V_348 -> V_17 , L_28 ) ;
V_205 = - V_290 ;
goto V_297;
}
V_337 = F_215 ( V_353 ) ;
if ( V_337 < 0 ) {
F_211 ( & V_348 -> V_17 , L_29 ) ;
V_205 = - V_238 ;
goto V_297;
}
V_17 -> V_359 = V_320 ;
...
V_2 -> V_288 = V_288 ;
V_2 -> V_289 = V_337 ;
V_2 -> V_136 = F_217 ( & V_348 -> V_17 , NULL ) ;
if ( F_218 ( V_2 -> V_136 ) ) {
V_205 = F_219 ( V_2 -> V_136 ) ;
goto V_297;
}
F_220 ( V_2 -> V_136 ) ;
V_351 = F_221 ( V_348 , V_367 , 0 ) ;
if ( ! V_351 ) {
V_205 = - V_290 ;
goto V_368;
}
V_2 -> V_5 = F_222 ( & V_348 -> V_17 , V_351 ) ;
if ( V_2 -> V_5 == NULL ) {
V_205 = F_219 ( V_2 -> V_5 ) ;
goto V_368;
}
...
F_10 (cpu) {
struct V_21 * V_18 ;
V_18 = F_11 ( V_2 -> V_18 , V_20 ) ;
F_224 ( & V_18 -> V_27 ) ;
}
V_355 = F_225 ( V_353 ) ;
if ( V_355 ) {
V_357 = L_30 ;
memcpy ( V_17 -> V_248 , V_355 , V_230 ) ;
} else {
F_178 ( V_2 , V_356 ) ;
if ( F_226 ( V_356 ) ) {
V_357 = L_31 ;
memcpy ( V_17 -> V_248 , V_356 , V_230 ) ;
} else {
V_357 = L_32 ;
F_227 ( V_17 ) ;
}
...
V_2 -> V_259 = V_318 ;
V_2 -> V_17 = V_17 ;
F_228 ( V_17 , & V_348 -> V_17 ) ;
V_205 = F_202 ( V_2 , V_323 ) ;
if ( V_205 < 0 ) {
F_211 ( & V_348 -> V_17 , L_33 ) ;
goto V_369;
}
F_209 ( V_2 , V_337 ) ;
V_349 = F_229 () ;
if ( V_349 )
F_205 ( V_2 , V_349 ) ;
F_230 ( V_17 , & V_2 -> V_211 , F_140 , V_2 -> V_365 ) ;
V_17 -> V_370 = V_371 | V_372 ;
V_17 -> V_373 |= V_371 | V_372 ;
V_17 -> V_374 |= V_371 | V_372 ;
V_17 -> V_375 |= V_376 ;
V_205 = F_231 ( V_17 ) ;
if ( V_205 < 0 ) {
F_211 ( & V_348 -> V_17 , L_34 ) ;
goto V_377;
}
F_133 ( V_17 , L_35 , V_357 ,
V_17 -> V_248 ) ;
F_232 ( V_348 , V_2 -> V_17 ) ;
return 0 ;
V_377:
F_204 ( V_2 ) ;
V_369:
...
static int F_237 ( struct V_347 * V_348 )
{
struct V_16 * V_17 = F_238 ( V_348 ) ;
struct V_1 * V_2 = F_9 ( V_17 ) ;
F_239 ( V_17 ) ;
F_204 ( V_2 ) ;
F_234 ( V_2 -> V_136 ) ;
