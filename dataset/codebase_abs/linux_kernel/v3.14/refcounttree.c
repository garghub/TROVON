...
static inline int F_274 ( struct V_56 * V_348 , struct V_339 * V_357 )
{
if ( V_357 -> V_342 )
return - V_358 ;
if ( F_275 ( V_348 ) )
return - V_359 ;
return F_276 ( V_348 , V_360 | V_361 ) ;
}
static int F_277 ( struct V_339 * V_340 , struct V_56 * V_348 ,
struct V_339 * V_349 , bool V_326 )
{
struct V_56 * V_56 = V_340 -> V_342 ;
int error ;
if ( ! V_56 )
return - V_359 ;
error = F_274 ( V_348 , V_349 ) ;
if ( error )
return error ;
if ( V_348 -> V_77 != V_56 -> V_77 )
return - V_362 ;
if ( F_278 ( V_56 ) || F_279 ( V_56 ) )
return - V_363 ;
if ( ! F_280 ( V_56 -> V_335 ) )
return - V_363 ;
if ( V_326 ) {
if ( ! F_281 ( F_282 () , V_56 -> V_333 ) && ! F_283 ( V_364 ) )
return - V_363 ;
if ( ! F_284 ( V_56 -> V_334 ) && ! F_283 ( V_364 ) )
return - V_363 ;
}
if ( ! V_326 ) {
error = F_276 ( V_56 , V_365 ) ;
if ( error )
return error ;
}
F_23 ( & V_56 -> V_113 ) ;
...
if ( ! V_1 ( F_13 ( V_56 -> V_77 ) ) )
return - V_355 ;
error = F_288 ( V_370 , V_366 , 0 , & V_368 ) ;
if ( error ) {
F_56 ( error ) ;
return error ;
}
V_349 = F_289 ( V_370 , V_367 , & V_369 , 0 ) ;
error = F_79 ( V_349 ) ;
if ( F_78 ( V_349 ) ) {
F_56 ( error ) ;
goto V_53;
