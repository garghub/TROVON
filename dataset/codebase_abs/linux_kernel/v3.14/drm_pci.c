...
int F_32 ( struct V_55 * V_10 , const struct V_56 * V_57 ,
struct V_58 * V_19 )
{
struct V_1 * V_2 ;
int V_26 ;
F_23 ( L_6 ) ;
V_2 = F_33 ( V_19 , & V_10 -> V_2 ) ;
if ( ! V_2 )
return - V_30 ;
V_26 = F_34 ( V_10 ) ;
if ( V_26 )
...
F_35 ( V_10 , V_2 ) ;
F_24 ( V_2 ) ;
V_26 = F_36 ( V_2 , V_57 -> V_63 ) ;
if ( V_26 )
goto V_64;
F_37 ( L_7 ,
V_19 -> V_22 , V_19 -> V_65 , V_19 -> V_66 , V_19 -> V_67 ,
V_19 -> V_68 , F_38 ( V_10 ) , V_2 -> V_69 -> V_70 ) ;
if ( ! F_25 ( V_2 , V_62 ) )
F_39 ( & V_2 -> V_71 , & V_19 -> V_71 ) ;
return 0 ;
V_64:
F_29 ( V_2 ) ;
F_40 ( V_10 ) ;
...
int F_42 ( struct V_58 * V_19 , struct V_17 * V_18 )
{
...
return F_43 ( V_18 ) ;
F_44 ( & V_19 -> V_71 ) ;
for ( V_73 = 0 ; V_18 -> V_76 [ V_73 ] . V_77 != 0 ; V_73 ++ ) {
V_72 = & V_18 -> V_76 [ V_73 ] ;
V_10 = NULL ;
while ( ( V_10 =
F_45 ( V_72 -> V_77 , V_72 -> V_78 , V_72 -> V_79 ,
V_72 -> V_80 , V_10 ) ) != NULL ) {
if ( ( V_10 -> V_81 & V_72 -> V_82 ) != V_72 -> V_81 )
continue;
F_46 ( V_10 ) ;
F_32 ( V_10 , V_72 , V_19 ) ;
}
...
int F_47 ( struct V_1 * V_2 , T_3 * V_83 )
{
struct V_55 * V_84 ;
T_3 V_85 , V_86 ;
* V_83 = 0 ;
...
F_37 ( L_8 , V_84 -> V_77 , V_84 -> V_78 , V_85 , V_86 ) ;
return 0 ;
}
int F_42 ( struct V_58 * V_19 , struct V_17 * V_18 )
{
...
void F_29 ( struct V_1 * V_2 ) {}
void F_49 ( struct V_58 * V_19 , struct V_17 * V_18 )
{
