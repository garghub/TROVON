...
static void V_208 ( struct V_77 * V_230 )
{
struct V_6 * V_7 = F_23 ( V_230 , struct V_6 , V_207 . V_78 ) ;
F_69 ( V_7 , V_198 ) ;
}
static void V_228 ( struct V_77 * V_230 )
{
struct V_6 * V_7 = F_23 ( V_230 , struct V_6 , V_207 . V_78 ) ;
F_69 ( V_7 , V_200 ) ;
}
static void F_75 ( struct V_6 * V_7 , enum V_231 type )
{
struct V_1 * V_2 = V_7 -> V_2 ;
int V_55 ;
F_76 ( & V_7 -> V_207 ) ;
...
unsigned V_243 ;
unsigned V_244 ;
V_7 -> V_134 = F_51 ( sizeof( * V_7 -> V_134 ) , V_245 ) ;
if ( ! V_7 -> V_134 ) {
V_56 = - V_164 ;
goto V_246;
}
V_7 -> V_75 = F_51 ( sizeof( * V_7 -> V_75 ) , V_245 ) ;
if ( ! V_7 -> V_75 ) {
V_56 = - V_164 ;
goto V_246;
}
F_83 ( & V_7 -> V_109 ) ;
V_7 -> V_3 = F_51 ( sizeof( * V_7 -> V_3 ) , V_245 ) ;
if ( ! V_7 -> V_3 ) {
V_56 = - V_164 ;
goto V_246;
}
...
V_242 = L_35 ;
goto V_246;
} else if ( V_7 -> V_3 -> V_247 > V_248 ) {
V_242 = L_36 ;
V_56 = - V_111 ;
goto V_246;
} else if ( V_7 -> V_3 -> V_247 == 0 ) {
V_242 = L_37 ;
V_56 = - V_111 ;
goto V_246;
}
V_2 -> V_12 = V_7 -> V_3 -> V_247 ;
F_84 ( V_238 , L_38 , V_2 -> V_12 ,
...
char V_250 [ V_248 + 1 ] ;
for ( V_55 = 0 ; V_55 < V_2 -> V_12 ; V_55 ++ )
V_250 [ V_55 ] = V_7 -> V_3 -> V_34 . V_251 . V_252
[ ( ( V_55 + 1 ) / 8 ) ] & ( 1 << ( ( V_55 + 1 ) % 8 ) )
? 'F' : 'R' ;
V_250 [ V_2 -> V_12 ] = 0 ;
F_21 ( V_238 , L_41 , V_250 ) ;
} else
F_21 ( V_238 , L_42 ) ;
switch ( V_174 & V_175 ) {
case V_253 :
...
break;
case V_266 :
V_7 -> V_139 . V_265 = 666 * 2 ;
F_21 ( V_238 , L_53
L_54 ,
16 , V_7 -> V_139 . V_265 ) ;
break;
case V_267 :
V_7 -> V_139 . V_265 = 666 * 3 ;
F_21 ( V_238 , L_53
L_54 ,
24 , V_7 -> V_139 . V_265 ) ;
break;
case V_268 :
V_7 -> V_139 . V_265 = 666 * 4 ;
F_21 ( V_238 , L_53
L_54 ,
32 , V_7 -> V_139 . V_265 ) ;
break;
...
F_21 ( V_238 , L_56 ,
V_7 -> V_3 -> V_172 * 2 ) ;
V_56 = F_90 ( V_2 , V_270 , 0 , & V_239 ) ;
if ( V_56 ) {
V_242 = L_57 ;
goto V_246;
}
V_152 = F_55 ( V_2 -> V_169 ) ;
if ( V_2 == V_2 -> V_169 -> V_271 ) {
if ( V_152 -> V_272 > 0 )
V_2 -> V_273 = V_152 -> V_272 ;
else
V_2 -> V_273 = V_244 * V_2 -> V_12 ;
if ( V_2 -> V_273 >= V_244 )
V_7 -> V_274 = V_244 ;
else {
V_7 -> V_274 = V_2 -> V_273 ;
...
} else if ( ( V_239 & ( 1 << V_276 ) ) == 0 ) {
int V_277 = V_2 -> V_273 -
V_7 -> V_3 -> V_278 ;
F_21 ( V_238 , L_58 ,
V_7 -> V_3 -> V_278 ) ;
V_7 -> V_275 = 1 ;
if ( V_277 < V_2 -> V_12 * V_243 )
F_7 ( V_238 ,
L_59
L_60 ) ;
V_7 -> V_274 = V_243 ;
...
V_56 = F_60 ( V_7 , & V_239 , & V_240 ) ;
if ( V_56 < 0 ) {
V_242 = L_57 ;
goto V_246;
}
if ( V_2 -> V_11 -> V_279 . V_20 & V_280 )
F_21 ( V_238 , L_63 ,
( V_239 & V_281 )
? L_64 : L_65 ) ;
if ( ( V_174 & V_256 ) == 0 )
F_21 ( V_238 , L_66 ,
( V_239 & V_282 ) ? L_39 : L_67 ) ;
V_162 = F_91 ( V_2 , V_236 -> V_283 ) ;
V_241 = F_92 ( V_2 , V_162 , F_93 ( V_162 ) ) ;
if ( V_241 > sizeof( * V_7 -> V_134 ) )
V_241 = sizeof( * V_7 -> V_134 ) ;
V_7 -> V_125 = F_94 ( 0 , V_245 ) ;
if ( ! V_7 -> V_125 ) {
V_56 = - V_164 ;
goto V_246;
}
F_95 ( V_7 -> V_125 , V_2 , V_162 , * V_7 -> V_134 , V_241 , F_42 ,
V_7 , V_236 -> V_284 ) ;
if ( V_7 -> V_229 && V_99 )
V_7 -> V_86 [ 0 ] = V_87 ;
for ( V_55 = 0 ; V_55 < V_2 -> V_12 ; V_55 ++ ) {
...
static void F_98 ( struct V_286 * V_286 )
{
struct V_6 * V_7 = F_23 ( V_286 , struct V_6 , V_286 ) ;
F_99 ( F_36 ( V_7 -> V_112 ) ) ;
F_48 ( V_7 ) ;
}
...
F_110 ( & V_7 -> V_286 , F_98 ) ;
}
static int F_111 ( struct V_192 * V_193 , const struct V_290 * V_291 )
{
struct V_292 * V_279 ;
struct V_235 * V_236 ;
struct V_1 * V_2 ;
...
#endif
if ( ( V_279 -> V_279 . V_296 != 0 ) &&
( V_279 -> V_279 . V_296 != 1 ) ) {
V_297:
F_29 ( & V_193 -> V_22 , L_72 ) ;
return - V_114 ;
}
if ( V_279 -> V_279 . V_298 != 1 )
goto V_297;
V_236 = & V_279 -> V_236 [ 0 ] . V_279 ;
if ( ! F_115 ( V_236 ) )
goto V_297;
F_84 ( & V_193 -> V_22 , L_73 ) ;
V_7 = F_85 ( sizeof( * V_7 ) , V_245 ) ;
if ( ! V_7 ) {
...
static int
F_119 ( struct V_192 * V_193 , unsigned int V_303 , void * V_304 )
{
struct V_1 * V_2 = F_101 ( V_193 ) ;
struct V_6 * V_7 = F_3 ( V_2 ) ;
switch ( V_303 ) {
case V_305 : {
struct V_306 * V_307 = V_304 ;
int V_55 ;
F_102 ( & V_288 ) ;
if ( V_2 -> V_167 <= 0 )
V_307 -> V_308 = 0 ;
else {
V_307 -> V_308 = V_2 -> V_12 ;
for ( V_55 = 0 ; V_55 < V_307 -> V_308 ; V_55 ++ ) {
...
void F_123 ( struct V_1 * V_2 , struct V_310 * V_313 )
{
struct V_6 * V_7 = F_3 ( V_2 ) ;
int V_317 ;
for ( V_317 = 0 ; V_317 < V_2 -> V_12 ; V_317 ++ ) {
if ( V_7 -> V_159 [ V_317 ] -> V_312 == V_313 )
V_7 -> V_159 [ V_317 ] -> V_312 = NULL ;
}
}
...
return false ;
V_7 = F_3 ( V_14 -> V_23 ) ;
return ! ! V_7 -> V_159 [ V_14 -> V_123 - 1 ] -> V_312 ;
}
...
F_38 ( & V_288 , V_117 ) ;
if ( V_323 >= 0 )
F_126 ( & V_14 -> V_22 , V_323 ) ;
}
static void F_127 ( struct V_1 * V_14 )
{
int V_167 ;
struct V_325 * V_169 = V_14 -> V_169 ;
if ( V_14 -> V_326 ) {
V_167 = V_14 -> V_123 + 1 ;
F_128 ( F_129 ( V_167 , V_169 -> V_327 . V_328 ) ) ;
} else {
V_167 = F_130 ( V_169 -> V_327 . V_328 , 128 ,
V_169 -> V_329 ) ;
if ( V_167 >= 128 )
V_167 = F_130 ( V_169 -> V_327 . V_328 ,
128 , 1 ) ;
V_169 -> V_329 = ( V_167 >= 127 ? 1 : V_167 + 1 ) ;
}
if ( V_167 < 128 ) {
F_41 ( V_167 , V_169 -> V_327 . V_328 ) ;
V_14 -> V_167 = V_167 ;
}
}
...
{
if ( V_14 -> V_167 > 0 ) {
F_72 ( V_14 -> V_167 , V_14 -> V_169 -> V_327 . V_328 ) ;
V_14 -> V_167 = - 1 ;
}
}
...
if ( V_152 -> V_153 -> V_330 && V_14 -> V_23 )
V_152 -> V_153 -> V_330 ( V_152 , V_14 ) ;
}
void F_77 ( struct V_1 * * V_331 )
{
struct V_1 * V_14 = * V_331 ;
struct V_6 * V_7 = F_3 ( V_14 ) ;
int V_55 ;
F_64 ( V_14 , V_189 ) ;
F_84 ( & V_14 -> V_22 , L_75 ,
...
F_137 ( & V_14 -> V_22 . V_332 , L_77 ) ;
F_137 ( & V_158 -> V_22 . V_332 , L_78 ) ;
if ( ! V_158 -> V_333 )
F_138 ( & V_158 -> V_22 ) ;
else
V_158 -> V_333 = false ;
...
static void F_143 ( struct V_1 * V_14 , char * V_291 , char * string )
{
if ( ! string )
return;
F_84 ( & V_14 -> V_22 , L_79 , V_291 , string ) ;
}
...
V_14 -> V_3 . V_338 ,
V_14 -> V_3 . V_339 ) ;
F_143 ( V_14 , L_82 , V_14 -> V_340 ) ;
F_143 ( V_14 , L_83 , V_14 -> V_341 ) ;
F_143 ( V_14 , L_84 , V_14 -> V_342 ) ;
}
...
if ( ! V_14 -> V_169 -> V_344
&& V_14 -> V_345
&& V_14 -> V_23 == V_14 -> V_169 -> V_271 ) {
struct V_346 * V_279 = NULL ;
struct V_325 * V_169 = V_14 -> V_169 ;
if ( F_147 ( V_14 -> V_347 [ 0 ] ,
F_12 ( V_14 -> V_345 [ 0 ] . V_279 . V_348 ) ,
V_349 , ( void * * ) & V_279 ) == 0 ) {
if ( V_279 -> V_20 & V_350 ) {
...
if ( ! F_148 ( V_14 ) ) {
if ( V_14 -> V_169 -> V_352 || V_14 -> V_169 -> V_344 ) {
V_343 = F_149 ( V_14 , V_355 ) ;
if ( V_343 < 0 )
F_21 ( & V_14 -> V_22 , L_88 , V_343 ) ;
}
V_343 = - V_356 ;
goto V_246;
}
...
V_14 -> V_340 = F_152 ( V_14 , V_14 -> V_3 . V_338 ) ;
V_14 -> V_341 = F_152 ( V_14 ,
V_14 -> V_3 . V_337 ) ;
V_14 -> V_342 = F_152 ( V_14 , V_14 -> V_3 . V_339 ) ;
V_343 = F_145 ( V_14 ) ;
if ( V_343 < 0 )
return V_343 ;
F_153 ( V_14 ) ;
...
return;
if ( F_1 ( V_2 ) ) {
if ( F_12 ( V_7 -> V_3 -> V_34 . V_35 . V_252 )
& ( 1 << V_110 ) )
V_357 = false ;
} else {
if ( V_7 -> V_3 -> V_34 . V_251 . V_252 [ V_110 / 8 ] & ( 1 << ( V_110 % 8 ) ) )
V_357 = false ;
}
if ( V_357 )
V_14 -> V_357 = V_358 ;
...
V_14 -> V_22 . V_361 = F_162 ( V_362 ,
( ( ( V_14 -> V_169 -> V_360 - 1 ) * 128 ) + ( V_14 -> V_167 - 1 ) ) ) ;
F_144 ( V_14 ) ;
if ( V_14 -> V_342 )
F_163 ( V_14 -> V_342 , strlen ( V_14 -> V_342 ) ) ;
if ( V_14 -> V_340 )
F_163 ( V_14 -> V_340 , strlen ( V_14 -> V_340 ) ) ;
if ( V_14 -> V_341 )
F_163 ( V_14 -> V_341 ,
strlen ( V_14 -> V_341 ) ) ;
F_164 ( & V_14 -> V_22 ) ;
if ( V_14 -> V_23 )
F_154 ( V_14 ) ;
V_343 = F_165 ( & V_14 -> V_22 ) ;
if ( V_343 ) {
F_29 ( & V_14 -> V_22 , L_91 , V_343 ) ;
goto V_246;
}
if ( V_14 -> V_23 ) {
struct V_6 * V_7 = F_3 ( V_14 -> V_23 ) ;
struct V_157 * V_158 = V_7 -> V_159 [ V_14 -> V_123 - 1 ] ;
V_343 = F_166 ( & V_14 -> V_22 . V_332 ,
& V_158 -> V_22 . V_332 , L_77 ) ;
if ( V_343 )
goto V_246;
V_343 = F_166 ( & V_158 -> V_22 . V_332 ,
& V_14 -> V_22 . V_332 , L_78 ) ;
if ( V_343 ) {
F_137 ( & V_14 -> V_22 . V_332 , L_77 ) ;
goto V_246;
}
...
( void ) F_168 ( & V_14 -> V_22 , & V_14 -> V_334 , V_14 ) ;
F_169 ( V_14 ) ;
F_170 ( & V_14 -> V_22 ) ;
return V_343 ;
V_246:
...
V_366 = F_177 ( V_363 , sizeof( V_363 -> V_3 ) ) ;
if ( V_366 < 0 ) {
F_29 ( & V_363 -> V_22 , L_93
L_94 , V_366 ) ;
goto V_370;
}
V_363 -> V_364 = 1 ;
V_367 = F_178 ( V_363 ) ;
if ( V_367 >= 0 ) {
V_366 = F_174 ( V_363 , V_367 ) ;
if ( V_366 ) {
F_29 ( & V_363 -> V_22 ,
L_95 , V_367 , V_366 ) ;
}
}
F_84 ( & V_363 -> V_22 , L_96 ) ;
V_370:
F_179 ( V_363 ) ;
V_369:
V_368:
...
static unsigned F_180 ( struct V_6 * V_7 )
{
struct V_196 * V_152 ;
if ( V_7 -> V_2 -> V_23 != NULL )
return 0 ;
V_152 = F_23 ( V_7 -> V_2 -> V_169 , struct V_196 , V_371 ) ;
return V_152 -> V_372 ;
}
static bool F_181 ( struct V_1 * V_14 , int V_373 )
{
if ( V_14 -> V_15 == V_49 )
return false ;
return F_182 ( V_373 ) ;
...
if ( V_75 == 0 && ! V_14 -> V_404 && V_14 -> V_225 ) {
F_202 ( & V_158 -> V_22 ) ;
V_158 -> V_333 = true ;
}
F_169 ( V_7 -> V_2 ) ;
...
if ( V_75 == 0 ) {
V_413 = 0 ;
V_75 = F_90 ( V_14 , V_270 , 0 , & V_413 ) ;
if ( V_75 && ! V_14 -> V_226 && V_14 -> V_225 ) {
...
F_41 ( V_71 , V_7 -> V_419 ) ;
if ( F_1 ( V_7 -> V_2 ) )
V_75 = F_61 ( V_7 , V_71 , V_224 ) ;
else
V_75 = F_18 ( V_7 -> V_2 ,
V_71 , V_411 ) ;
if ( V_75 ) {
F_21 ( V_7 -> V_112 , L_120 ,
V_71 , V_75 ) ;
} else {
...
if ( V_14 -> V_82 != V_388 )
return - V_68 ;
return V_152 -> V_153 -> V_468 ( V_152 , V_14 ) ;
}
static int
...
int V_55 , V_471 , V_461 ;
unsigned V_173 = V_380 ;
enum V_472 V_473 = V_14 -> V_15 ;
const char * V_15 ;
int V_167 = V_14 -> V_167 ;
if ( ! V_2 -> V_23 ) {
V_173 = V_474 ;
if ( V_71 == V_2 -> V_169 -> V_351 )
V_2 -> V_169 -> V_352 = 0 ;
}
if ( V_473 == V_384 )
V_173 = V_381 ;
...
goto V_246;
V_461 = - V_111 ;
if ( V_473 != V_475 && V_473 != V_14 -> V_15 ) {
...
case V_49 :
case V_383 :
V_14 -> V_334 . V_279 . V_476 = F_215 ( 512 ) ;
break;
case V_16 :
V_14 -> V_334 . V_279 . V_476 = F_215 ( 64 ) ;
break;
case V_385 :
V_14 -> V_334 . V_279 . V_476 = F_215 ( 64 ) ;
break;
case V_384 :
V_14 -> V_334 . V_279 . V_476 = F_215 ( 8 ) ;
break;
default:
goto V_246;
}
...
F_84 ( & V_14 -> V_22 ,
L_149 ,
( V_14 -> V_345 ) ? L_150 : L_151 , V_15 ,
V_167 , V_14 -> V_169 -> V_477 -> V_153 -> V_478 ) ;
if ( V_2 -> V_139 ) {
...
for ( V_55 = 0 ; V_55 < V_479 ; ( ++ V_55 , F_59 ( 100 ) ) ) {
bool V_480 = false ;
if ( F_181 ( V_14 , V_469 ) ) {
struct V_481 * V_482 ;
int V_483 = 0 ;
...
goto V_246;
#define F_235 64
V_482 = F_51 ( F_235 , V_211 ) ;
if ( ! V_482 ) {
V_461 = - V_164 ;
continue;
}
for ( V_471 = 0 ; V_471 < 3 ; ++ V_471 ) {
V_482 -> V_484 = 0 ;
V_483 = F_14 ( V_14 , F_236 () ,
V_63 , V_64 ,
V_485 << 8 , 0 ,
V_482 , F_235 ,
V_486 ) ;
...
if ( V_461 )
goto V_246;
if ( V_152 -> V_491 && ! V_2 -> V_23 )
F_237 ( V_152 -> V_491 , V_14 -> V_15 ) ;
if ( ( V_14 -> V_15 == V_49 ) &&
( F_12 ( V_14 -> V_3 . V_492 ) < 0x0300 ) ) {
F_29 ( & V_14 -> V_22 , L_157
L_158 ) ;
F_186 ( V_7 , V_71 , V_14 ,
V_493 , true ) ;
V_461 = - V_68 ;
...
if ( V_14 -> V_3 . V_484 == 0xff ||
V_14 -> V_15 == V_49 )
V_55 = 512 ;
else
V_55 = V_14 -> V_3 . V_484 ;
if ( F_238 ( & V_14 -> V_334 . V_279 ) != V_55 ) {
if ( V_14 -> V_15 == V_384 ||
! ( V_55 == 8 || V_55 == 16 || V_55 == 32 || V_55 == 64 ) ) {
F_29 ( & V_14 -> V_22 , L_159 , V_55 ) ;
V_461 = - V_489 ;
goto V_246;
}
if ( V_14 -> V_15 == V_385 )
F_21 ( & V_14 -> V_22 , L_160 , V_55 ) ;
else
F_7 ( & V_14 -> V_22 , L_161 , V_55 ) ;
V_14 -> V_334 . V_279 . V_476 = F_215 ( V_55 ) ;
F_224 ( V_14 ) ;
}
V_461 = F_177 ( V_14 , V_494 ) ;
if ( V_461 < ( signed ) sizeof( V_14 -> V_3 ) ) {
if ( V_461 != - V_111 )
F_29 ( & V_14 -> V_22 , L_162 ,
V_461 ) ;
if ( V_461 >= 0 )
V_461 = - V_495 ;
goto V_246;
}
if ( V_14 -> V_326 == 0 && F_12 ( V_14 -> V_3 . V_492 ) >= 0x0201 ) {
V_461 = F_239 ( V_14 ) ;
if ( ! V_461 ) {
V_14 -> V_24 = F_5 ( V_14 ) ;
F_11 ( V_14 ) ;
...
V_461 = 0 ;
if ( V_152 -> V_153 -> V_496 )
V_152 -> V_153 -> V_496 ( V_152 , V_14 ) ;
F_229 ( V_14 ) ;
V_246:
if ( V_461 ) {
F_63 ( V_7 , V_71 , 0 ) ;
...
struct V_497 * V_498 ;
int V_75 ;
V_498 = F_51 ( sizeof *V_498 , V_245 ) ;
if ( V_498 == NULL )
return;
V_75 = F_241 ( V_14 , V_499 , 0 ,
V_498 , sizeof *V_498 ) ;
if ( V_75 == sizeof *V_498 ) {
F_84 ( & V_14 -> V_22 , L_163
L_164 ) ;
if ( V_7 -> V_229 ) {
...
V_243 = 100 ;
if ( V_14 -> V_11 )
V_500 = F_243 ( V_14 , V_14 -> V_11 ) ;
else if ( V_71 != V_14 -> V_169 -> V_351 || V_2 -> V_23 )
V_500 = V_243 ;
else
V_500 = 8 ;
if ( V_500 > V_7 -> V_274 )
...
F_64 ( V_14 , V_502 ) ;
V_14 -> V_273 = V_7 -> V_274 ;
V_14 -> V_204 = V_2 -> V_204 + 1 ;
V_14 -> V_326 = F_180 ( V_7 ) ;
if ( F_1 ( V_7 -> V_2 ) )
V_14 -> V_15 = V_49 ;
else
V_14 -> V_15 = V_475 ;
...
if ( V_14 -> V_504 & V_505 )
F_59 ( 1000 ) ;
if ( V_14 -> V_3 . V_506 == V_507
&& V_14 -> V_273 <= V_243 ) {
T_1 V_508 ;
V_75 = F_90 ( V_14 , V_270 , 0 ,
& V_508 ) ;
if ( V_75 ) {
F_21 ( & V_14 -> V_22 , L_171 , V_75 ) ;
goto V_509;
}
if ( ( V_508 & ( 1 << V_276 ) ) == 0 ) {
F_29 ( & V_14 -> V_22 ,
...
V_390:
F_63 ( V_7 , V_71 , 1 ) ;
if ( V_152 -> V_153 -> V_511 && ! V_7 -> V_2 -> V_23 )
V_152 -> V_153 -> V_511 ( V_152 , V_71 ) ;
}
...
V_513 = V_121 . V_147 ;
F_103 ( V_513 ) ;
V_7 = F_46 ( V_513 , struct V_6 , V_120 ) ;
F_254 ( & V_7 -> V_286 ) ;
F_105 ( & V_118 ) ;
V_2 = V_7 -> V_2 ;
V_238 = V_7 -> V_112 ;
...
continue;
V_512 = F_129 ( V_55 , V_7 -> V_191 ) ;
V_514 = F_257 ( V_55 , V_7 -> V_124 ) ;
...
;
else if ( F_60 ( V_7 , & V_239 , & V_240 ) < 0 )
F_29 ( V_238 , L_194 ) ;
else {
if ( V_240 & V_522 ) {
F_21 ( V_238 , L_195 ) ;
...
V_530 = F_266 ( F_258 , NULL , L_200 ) ;
if ( ! F_267 ( V_530 ) )
return 0 ;
F_268 ( & V_528 ) ;
F_265 ( V_529 L_201 , V_527 ) ;
return - 1 ;
}
void F_269 ( void )
{
...
return 1 ;
if ( V_14 -> V_17 ) {
V_536 = F_12 ( V_14 -> V_17 -> V_279 -> V_348 ) ;
if ( V_536 != F_12 ( V_533 -> V_279 -> V_348 ) )
return 1 ;
if ( memcmp ( V_14 -> V_17 -> V_279 , V_533 -> V_279 , V_536 ) )
return 1 ;
}
if ( V_14 -> V_342 )
V_535 = strlen ( V_14 -> V_342 ) + 1 ;
V_536 = V_535 ;
for ( V_534 = 0 ; V_534 < V_14 -> V_3 . V_539 ; V_534 ++ ) {
V_537 = F_12 ( V_14 -> V_345 [ V_534 ] . V_279 . V_348 ) ;
V_536 = F_58 ( V_536 , V_537 ) ;
}
V_482 = F_51 ( V_536 , V_211 ) ;
if ( V_482 == NULL ) {
F_29 ( & V_14 -> V_22 , L_202 ) ;
return 1 ;
}
for ( V_534 = 0 ; V_534 < V_14 -> V_3 . V_539 ; V_534 ++ ) {
V_537 = F_12 ( V_14 -> V_345 [ V_534 ] . V_279 . V_348 ) ;
V_538 = F_241 ( V_14 , V_540 , V_534 , V_482 ,
V_537 ) ;
if ( V_538 != V_537 ) {
F_21 ( & V_14 -> V_22 , L_203 ,
V_534 , V_538 ) ;
V_80 = 1 ;
break;
}
if ( memcmp ( V_482 , V_14 -> V_347 [ V_534 ] , V_537 )
!= 0 ) {
...
if ( ! V_80 && V_535 ) {
V_538 = F_272 ( V_14 , V_14 -> V_3 . V_339 ,
V_482 , V_535 ) ;
if ( V_538 + 1 != V_535 ) {
F_21 ( & V_14 -> V_22 , L_205 ,
V_538 ) ;
V_80 = 1 ;
} else if ( memcmp ( V_482 , V_14 -> V_342 , V_538 ) != 0 ) {
...
{
struct V_1 * V_543 = V_14 -> V_23 ;
struct V_6 * V_544 ;
struct V_196 * V_152 = F_55 ( V_14 -> V_169 ) ;
struct V_481 V_3 = V_14 -> V_3 ;
struct V_532 * V_17 ;
int V_55 , V_56 = 0 ;
int V_71 = V_14 -> V_123 ;
if ( V_14 -> V_82 == V_189 ||
...
V_56 = F_200 ( V_14 ) ;
if ( V_56 ) {
F_29 ( & V_14 -> V_22 , L_209 , V_113 ) ;
goto V_546;
}
V_56 = F_192 ( V_14 ) ;
if ( V_56 ) {
F_29 ( & V_14 -> V_22 , L_210 ,
V_113 ) ;
goto V_546;
}
F_41 ( V_71 , V_544 -> V_419 ) ;
for ( V_55 = 0 ; V_55 < V_501 ; ++ V_55 ) {
F_224 ( V_14 ) ;
V_56 = F_232 ( V_544 , V_14 , V_71 , V_55 ) ;
if ( V_56 >= 0 || V_56 == - V_382 || V_56 == - V_111 )
break;
}
F_72 ( V_71 , V_544 -> V_419 ) ;
if ( V_56 < 0 )
goto V_546;
if ( F_271 ( V_14 , & V_3 , V_17 ) ) {
F_84 ( & V_14 -> V_22 , L_211 ) ;
V_14 -> V_3 = V_3 ;
goto V_546;
}
if ( ! V_14 -> V_11 )
...
V_56 = F_14 ( V_14 , F_17 ( V_14 , 0 ) ,
V_547 , 0 ,
V_14 -> V_11 -> V_279 . V_542 , 0 ,
NULL , 0 , V_205 ) ;
if ( V_56 < 0 ) {
F_29 ( & V_14 -> V_22 ,
L_214 ,
V_14 -> V_11 -> V_279 . V_542 , V_56 ) ;
F_30 ( V_152 -> V_456 ) ;
goto V_546;
}
F_30 ( V_152 -> V_456 ) ;
F_64 ( V_14 , V_83 ) ;
for ( V_55 = 0 ; V_55 < V_14 -> V_11 -> V_279 . V_548 ; V_55 ++ ) {
struct V_549 * V_345 = V_14 -> V_11 ;
struct V_192 * V_193 = V_345 -> V_13 [ V_55 ] ;
struct V_550 * V_279 ;
V_279 = & V_193 -> V_293 -> V_279 ;
if ( V_279 -> V_551 == 0 ) {
...
V_193 -> V_552 = 1 ;
V_56 = F_89 ( V_14 , V_279 -> V_553 ,
V_279 -> V_551 ) ;
V_193 -> V_552 = 0 ;
}
if ( V_56 < 0 ) {
F_29 ( & V_14 -> V_22 , L_215
L_216 ,
V_279 -> V_553 ,
V_279 -> V_551 ,
V_56 ) ;
...
F_176 ( V_14 ) ;
if ( V_345 ) {
for ( V_55 = 0 ; V_55 < V_345 -> V_279 . V_548 ; ++ V_55 ) {
struct V_192 * V_555 = V_345 -> V_13 [ V_55 ] ;
struct V_556 * V_151 ;
int V_557 = 0 ;
if ( V_555 -> V_22 . V_153 ) {
V_151 = F_278 ( V_555 -> V_22 . V_153 ) ;
if ( V_151 -> V_558 && V_151 -> V_559 )
V_557 = ( V_151 -> V_558 ) ( V_555 ) ;
else if ( V_555 -> V_560 ==
V_561 )
V_557 = 1 ;
if ( V_557 )
...
V_56 = F_204 ( V_14 ) ;
if ( V_345 ) {
for ( V_55 = V_345 -> V_279 . V_548 - 1 ; V_55 >= 0 ; -- V_55 ) {
struct V_192 * V_555 = V_345 -> V_13 [ V_55 ] ;
struct V_556 * V_151 ;
int V_562 = V_555 -> V_563 ;
if ( ! V_562 && V_555 -> V_22 . V_153 ) {
V_151 = F_278 ( V_555 -> V_22 . V_153 ) ;
if ( V_151 -> V_559 )
V_562 = ( V_151 -> V_559 ) ( V_555 ) ;
else if ( V_555 -> V_560 ==
V_561 )
V_562 = 1 ;
}
...
if ( V_464 == V_466 ) {
T_2 V_568 = 1 << ( V_55 % 8 ) ;
if ( ! ( V_279 -> V_34 . V_251 . V_252 [ V_55 / 8 ] & V_568 ) ) {
F_21 ( & V_2 -> V_22 , L_217 ,
V_55 ) ;
V_279 -> V_34 . V_251 . V_252 [ V_55 / 8 ] |= V_568 ;
}
}
}
} else {
T_1 V_569 = F_12 ( V_279 -> V_34 . V_35 . V_252 ) ;
for ( V_55 = 1 ; V_55 <= V_2 -> V_12 ; V_55 ++ ) {
V_464 = F_230 ( V_2 , V_55 ) ;
if ( V_464 == V_466 ) {
T_1 V_568 = 1 << V_55 ;
...
V_279 -> V_34 . V_35 . V_252 = F_215 ( V_569 ) ;
}
}
