...
{
int V_21 ;
V_21 = F_45 ( V_6 , V_15 , V_115 , V_116 , 0 ) ;
if ( V_21 )
return V_21 ;
return V_115 -> V_120 ;
}
...
return 0 ;
case V_149 :
return F_53 ( V_6 , V_15 , V_116 [ 1 ] ) ;
case V_150 :
V_116 [ 1 ] = V_9 -> V_137 ;
return 0 ;
case V_151 :
F_55 ( V_6 , V_15 , V_57 , V_116 [ 1 ] , ( V_116 [ 2 ] != 0 ) ) ;
return 0 ;
case V_152 :
return - V_94 ;
}
...
if ( V_21 < 0 )
return V_21 ;
V_20 = F_14 ( F_38 ( ( T_1 * ) ( V_9 -> V_105 + 1 ) ) ) ;
V_20 &= 0x00ffffff ;
V_20 ^= 0x00800000 ;
return ( int ) V_20 ;
}
...
struct V_1 * V_1 ;
int V_4 ;
V_9 -> V_99 = F_66 ( V_100 , V_156 ) ;
V_9 -> V_23 = F_66 ( V_25 , V_156 ) ;
V_9 -> V_105 = F_66 ( V_106 , V_156 ) ;
V_9 -> V_11 = F_67 ( V_9 -> V_12 , sizeof( * V_1 ) ,
V_156 ) ;
V_9 -> V_47 = F_67 ( V_9 -> V_48 , sizeof( * V_1 ) ,
V_156 ) ;
...
V_1 -> V_6 = V_71 ;
V_1 -> V_17 = NULL ;
V_1 -> V_160 = F_69 ( V_71 , 6 ) ;
V_1 -> V_73 = V_74 ;
V_1 -> V_24 = F_66 ( V_25 , V_156 ) ;
if ( ! V_1 -> V_24 )
return - V_155 ;
V_1 -> V_161 = F_7 ;
V_1 -> V_65 = 1 ;
...
V_1 -> V_6 = V_71 ;
V_1 -> V_17 = NULL ;
V_1 -> V_160 = F_70 ( V_71 , 2 ) ;
V_1 -> V_73 = V_74 ;
V_1 -> V_24 = F_66 ( V_62 , V_156 ) ;
if ( ! V_1 -> V_24 )
return - V_155 ;
V_1 -> V_161 = F_19 ;
V_1 -> V_65 = 1 ;
...
if ( V_21 )
return V_21 ;
V_21 = F_78 ( V_71 , V_164 -> V_171 -> V_172 . V_173 ,
3 ) ;
if ( V_21 < 0 ) {
F_10 ( V_6 -> V_27 ,
L_10 ) ;
...
V_21 = F_79 ( V_6 , & V_71 -> V_6 , V_174 ,
F_59 , 0 ) ;
if ( V_21 )
return V_21 ;
V_21 = F_80 ( V_6 , ( V_9 -> V_63 ) ? 4 : 3 ) ;
if ( V_21 )
return V_21 ;
V_15 = & V_6 -> V_175 [ 0 ] ;
V_6 -> V_18 = V_15 ;
