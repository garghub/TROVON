...
V_67 = V_5 -> V_56 . V_67 ;
V_69 = ( V_66 & 0xff ) ;
V_68 = ( ( V_66 & 0xff0000 ) >> 16 ) ;
}
if ( V_65 < V_68 || V_65 > V_67 ||
V_65 < V_5 -> V_56 . V_71 ) {
F_22 ( & V_5 -> V_56 . V_58 ) ;
return - V_33 ;
}
...
F_31 ( & V_5 -> V_56 . V_58 ) ;
if ( F_4 ( V_5 -> V_2 ) )
V_10 = F_33 ( V_5 , V_5 -> V_56 . V_71 ) ;
else
V_10 = V_5 -> V_56 . V_71 * V_62 ;
F_22 ( & V_5 -> V_56 . V_58 ) ;
return snprintf ( V_21 , V_24 , L_4 , V_10 ) ;
}
static T_3 F_45 ( struct V_17 * V_18 ,
struct V_19 * V_20 ,
const char * V_21 , T_5 V_41 )
{
struct V_22 * V_55 = F_10 ( V_18 ) ;
...
if ( V_65 < V_68 || V_65 > V_67 || V_65 > V_5 -> V_56 . V_64 ) {
F_22 ( & V_5 -> V_56 . V_58 ) ;
return - V_33 ;
}
V_5 -> V_56 . V_71 = V_65 ;
...
static T_3 F_46 ( struct V_17 * V_18 , struct V_19 * V_20 , char * V_21 )
{
struct V_22 * V_55 = F_10 ( V_18 ) ;
struct V_1 * V_2 = V_55 -> V_2 ;
struct V_4 * V_5 = V_2 -> V_6 ;
...
F_22 ( & V_2 -> V_48 ) ;
if ( V_20 == & V_72 ) {
V_65 = ( ( V_66 & 0x0000ff ) >> 0 ) * V_62 ;
} else if ( V_20 == & V_73 ) {
V_65 = ( ( V_66 & 0x00ff00 ) >> 8 ) * V_62 ;
} else if ( V_20 == & V_74 ) {
V_65 = ( ( V_66 & 0xff0000 ) >> 16 ) * V_62 ;
} else {
F_48 () ;
}
return snprintf ( V_21 , V_24 , L_4 , V_65 ) ;
}
static T_3 F_49 ( struct V_36 * V_37 , struct V_38 * V_39 ,
struct V_40 * V_20 , char * V_21 ,
T_4 V_75 , T_5 V_41 )
{
...
static T_3 F_55 ( struct V_36 * V_36 , struct V_38 * V_39 ,
struct V_40 * V_20 , char * V_21 ,
T_4 V_75 , T_5 V_41 )
{
struct V_17 * V_18 = F_18 ( V_39 , struct V_17 , V_39 ) ;
...
#endif
if ( F_16 ( V_2 ) ) {
V_10 = F_63 ( V_2 -> V_83 -> V_18 , & V_85 ) ;
if ( V_10 )
F_62 ( L_8 ) ;
if ( F_64 ( V_2 ) > 1 ) {
V_10 = F_63 ( V_2 -> V_83 -> V_18 ,
& V_86 ) ;
if ( V_10 )
F_62 ( L_9 ) ;
}
...
V_10 = 0 ;
if ( F_4 ( V_2 ) )
V_10 = F_65 ( & V_2 -> V_83 -> V_18 -> V_39 , V_87 ) ;
else if ( F_60 ( V_2 ) -> V_82 >= 6 )
V_10 = F_65 ( & V_2 -> V_83 -> V_18 -> V_39 , V_88 ) ;
if ( V_10 )
F_62 ( L_10 ) ;
V_10 = F_66 ( & V_2 -> V_83 -> V_18 -> V_39 ,
& V_89 ) ;
if ( V_10 )
F_62 ( L_11 ) ;
}
...
{
F_68 ( & V_2 -> V_83 -> V_18 -> V_39 , & V_89 ) ;
if ( F_4 ( V_2 ) )
F_69 ( & V_2 -> V_83 -> V_18 -> V_39 , V_87 ) ;
else
F_69 ( & V_2 -> V_83 -> V_18 -> V_39 , V_88 ) ;
F_70 ( V_2 -> V_83 -> V_18 , & V_86 ) ;
F_70 ( V_2 -> V_83 -> V_18 , & V_85 ) ;
#ifdef F_59
F_71 ( & V_2 -> V_83 -> V_18 -> V_39 , & V_84 ) ;
#endif
}
