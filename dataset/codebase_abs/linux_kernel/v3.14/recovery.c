...
F_8 ( L_32 , V_6 -> V_103 , V_6 -> V_104 ) ;
V_14 = F_53 ( V_6 , V_6 -> V_103 , V_6 -> V_104 , V_16 ) ;
if ( V_14 )
return V_14 ;
F_8 ( L_33 , V_6 -> V_105 , V_6 -> V_106 ) ;
...
{
struct V_126 * V_149 = F_89 ( & V_6 -> V_127 ) ;
while ( V_149 ) {
struct V_129 * V_130 ;
int V_14 ;
V_130 = F_70 ( V_149 , struct V_129 , V_131 ) ;
if ( ! V_130 -> V_125 ) {
union V_137 V_138 ;
F_83 ( V_6 , & V_138 , V_130 -> V_122 ) ;
...
struct V_151 * V_152 ;
F_26 ( ! V_130 -> V_135 ) ;
V_135 = F_92 ( V_6 -> V_153 , V_130 -> V_122 ) ;
if ( F_41 ( V_135 ) )
return F_93 ( V_135 ) ;
V_152 = V_151 ( V_135 ) ;
...
V_135 -> V_123 = V_130 -> V_124 ;
V_152 -> V_154 = V_130 -> V_124 ;
V_152 -> V_155 = V_130 -> V_124 ;
V_130 -> V_135 = V_135 ;
V_149 = F_94 ( V_149 ) ;
continue;
}
