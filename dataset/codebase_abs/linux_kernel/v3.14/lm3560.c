...
if ( V_3 )
goto V_45;
V_3 = F_26 ( & V_2 -> V_72 [ V_15 ] . V_81 , 0 , NULL , 0 ) ;
if ( V_3 < 0 )
goto V_45;
V_2 -> V_72 [ V_15 ] . V_81 . type = V_82 ;
return V_3 ;
V_45:
F_27 ( & V_2 -> V_59 [ V_15 ] ) ;
return V_3 ;
...
{
struct V_1 * V_2 ;
struct V_86 * V_55 = F_30 ( & V_76 -> V_77 ) ;
int V_3 ;
V_2 = F_31 ( & V_76 -> V_77 , sizeof( * V_2 ) , V_87 ) ;
if ( V_2 == NULL )
return - V_88 ;
V_2 -> V_7 = F_32 ( V_76 , & V_89 ) ;
if ( F_33 ( V_2 -> V_7 ) ) {
V_3 = F_34 ( V_2 -> V_7 ) ;
return V_3 ;
}
...
{
struct V_1 * V_2 = F_39 ( V_76 ) ;
unsigned int V_95 ;
for ( V_95 = V_17 ; V_95 < V_96 ; V_95 ++ ) {
F_40 ( & V_2 -> V_72 [ V_95 ] ) ;
F_27 ( & V_2 -> V_59 [ V_95 ] ) ;
F_41 ( & V_2 -> V_72 [ V_95 ] . V_81 ) ;
}
return 0 ;
}
