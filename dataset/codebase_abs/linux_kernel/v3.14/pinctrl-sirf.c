...
struct V_100 , V_72 ) ;
return F_52 ( V_101 -> V_102 , V_11 + V_101 -> V_58 *
V_69 ) ;
}
...
static unsigned int F_64 ( struct V_104 * V_105 )
{
struct V_100 * V_101 = F_57 ( V_105 ) ;
if ( F_65 ( & V_101 -> V_72 . V_64 , V_105 -> V_107 % V_69 ) )
F_11 ( V_101 -> V_72 . V_64 . V_28 ,
L_13 ,
V_105 -> V_107 ) ;
F_62 ( V_105 ) ;
return 0 ;
}
static void F_66 ( struct V_104 * V_105 )
{
struct V_100 * V_101 = F_57 ( V_105 ) ;
F_61 ( V_105 ) ;
F_67 ( & V_101 -> V_72 . V_64 , V_105 -> V_107 % V_69 ) ;
}
static void F_68 ( unsigned int V_123 , struct V_124 * V_125 )
{
struct V_100 * V_101 = F_69 ( V_123 ) ;
T_1 V_126 , V_127 ;
int V_106 = 0 ;
struct V_128 * V_72 = F_70 ( V_123 ) ;
F_71 ( V_72 , V_125 ) ;
V_126 = F_17 ( V_101 -> V_72 . V_110 + F_45 ( V_101 -> V_58 ) ) ;
if ( ! V_126 ) {
F_72 ( V_129
L_14 ,
V_130 , V_101 -> V_58 , V_126 ) ;
F_73 ( V_123 , V_125 ) ;
return;
}
while ( V_126 ) {
V_127 = F_17 ( V_101 -> V_72 . V_110 + F_44 ( V_101 -> V_58 , V_106 ) ) ;
if ( ( V_126 & 0x1 ) && ( V_127 & V_111 ) ) {
F_74 ( L_15 ,
V_130 , V_101 -> V_58 , V_106 ) ;
F_75 ( F_76 ( V_101 -> V_102 , V_106 +
V_101 -> V_58 * V_69 ) ) ;
}
V_106 ++ ;
V_126 = V_126 >> 1 ;
...
static inline void F_78 ( struct V_100 * V_101 , unsigned V_131 )
{
T_1 V_108 ;
V_108 = F_17 ( V_101 -> V_72 . V_110 + V_131 ) ;
V_108 &= ~ V_113 ;
F_19 ( V_108 , V_101 -> V_72 . V_110 + V_131 ) ;
}
static int F_79 ( struct V_63 * V_72 , unsigned V_11 )
{
struct V_100 * V_101 = F_55 ( V_72 ) ;
unsigned long V_67 ;
if ( F_80 ( V_72 -> V_132 + V_11 ) )
return - V_29 ;
F_58 ( & V_101 -> V_133 , V_67 ) ;
F_78 ( V_101 , F_44 ( V_101 -> V_58 , V_11 ) ) ;
F_60 ( V_101 , V_11 ) ;
F_59 ( & V_101 -> V_133 , V_67 ) ;
return 0 ;
}
static void F_81 ( struct V_63 * V_72 , unsigned V_11 )
{
struct V_100 * V_101 = F_55 ( V_72 ) ;
unsigned long V_67 ;
F_58 ( & V_101 -> V_133 , V_67 ) ;
...
F_78 ( V_101 , F_44 ( V_101 -> V_58 , V_11 ) ) ;
F_59 ( & V_101 -> V_133 , V_67 ) ;
F_82 ( V_72 -> V_132 + V_11 ) ;
}
static int F_83 ( struct V_63 * V_72 , unsigned V_103 )
{
struct V_100 * V_101 = F_55 ( V_72 ) ;
...
static inline void F_84 ( struct V_100 * V_101 , unsigned V_11 ,
int V_134 )
{
T_1 V_135 ;
unsigned long V_67 ;
...
static int F_85 ( struct V_63 * V_72 , unsigned V_103 , int V_134 )
{
struct V_100 * V_101 = F_55 ( V_72 ) ;
int V_106 = F_53 ( V_103 ) ;
T_1 V_11 ;
...
V_11 = F_44 ( V_101 -> V_58 , V_106 ) ;
F_58 ( & V_109 , V_67 ) ;
F_84 ( V_101 , V_11 , V_134 ) ;
F_59 ( & V_109 , V_67 ) ;
return 0 ;
}
static int F_86 ( struct V_63 * V_72 , unsigned V_11 )
{
struct V_100 * V_101 = F_55 ( V_72 ) ;
T_1 V_108 ;
unsigned long V_67 ;
...
static void F_87 ( struct V_63 * V_72 , unsigned V_11 ,
int V_134 )
{
struct V_100 * V_101 = F_55 ( V_72 ) ;
T_1 V_127 ;
unsigned long V_67 ;
F_58 ( & V_101 -> V_133 , V_67 ) ;
V_127 = F_17 ( V_101 -> V_72 . V_110 + F_44 ( V_101 -> V_58 , V_11 ) ) ;
if ( V_134 )
V_127 |= V_136 ;
else
V_127 &= ~ V_136 ;
F_19 ( V_127 , V_101 -> V_72 . V_110 + F_44 ( V_101 -> V_58 , V_11 ) ) ;
F_59 ( & V_101 -> V_133 , V_67 ) ;
}
static int F_88 ( struct V_138 * V_105 , unsigned int V_123 ,
T_4 V_107 )
{
...
F_89 ( V_123 , & V_140 ) ;
F_90 ( V_123 , V_141 ) ;
F_91 ( V_123 , V_101 + V_107 / V_69 ) ;
F_92 ( V_123 , V_142 ) ;
return 0 ;
}
static void F_93 ( const T_1 * V_143 )
{
int V_36 , V_144 ;
const unsigned long * V_145 = ( const unsigned long * ) V_143 ;
for ( V_36 = 0 ; V_36 < V_68 ; V_36 ++ ) {
F_94 (n, p + i, BITS_PER_LONG) {
...
static void F_95 ( const T_1 * V_148 )
{
int V_36 , V_144 ;
...
static int F_96 ( struct V_13 * V_20 )
{
int V_36 , V_149 = 0 ;
struct V_100 * V_101 ;
void T_2 * V_110 ;
...
if ( F_35 ( V_20 , L_10 ) )
V_45 = 1 ;
V_102 = F_98 ( V_20 , V_69 * V_68 ,
& V_150 , V_71 ) ;
if ( ! V_102 ) {
F_99 ( L_16 , V_20 -> V_151 ) ;
V_149 = - V_152 ;
goto V_153;
}
for ( V_36 = 0 ; V_36 < V_68 ; V_36 ++ ) {
V_101 = & V_71 [ V_36 ] ;
F_100 ( & V_101 -> V_133 ) ;
V_101 -> V_72 . V_64 . V_154 = F_79 ;
V_101 -> V_72 . V_64 . free = F_81 ;
V_101 -> V_72 . V_64 . V_155 = F_83 ;
V_101 -> V_72 . V_64 . V_156 = F_86 ;
V_101 -> V_72 . V_64 . V_157 = F_85 ;
V_101 -> V_72 . V_64 . V_158 = F_87 ;
V_101 -> V_72 . V_64 . V_159 = F_49 ;
V_101 -> V_72 . V_64 . V_132 = V_36 * V_69 ;
V_101 -> V_72 . V_64 . V_160 = V_69 ;
V_101 -> V_72 . V_64 . V_161 = F_101 ( V_20 -> V_151 , V_30 ) ;
V_101 -> V_72 . V_64 . V_75 = V_20 ;
V_101 -> V_72 . V_64 . V_162 = F_31 ;
V_101 -> V_72 . V_64 . V_163 = 2 ;
V_101 -> V_72 . V_64 . V_28 = & V_74 -> V_28 ;
V_101 -> V_72 . V_110 = V_110 ;
V_101 -> V_58 = V_36 ;
V_101 -> V_45 = V_45 ;
V_101 -> V_164 = F_102 ( V_74 , V_36 ) ;
if ( V_101 -> V_164 < 0 ) {
V_149 = V_101 -> V_164 ;
goto V_153;
}
V_149 = F_103 ( & V_101 -> V_72 . V_64 ) ;
if ( V_149 ) {
F_99 ( L_17 ,
V_20 -> V_151 , V_149 ) ;
goto V_153;
...
V_101 -> V_102 = V_102 ;
F_104 ( V_101 -> V_164 , F_68 ) ;
F_105 ( V_101 -> V_164 , V_101 ) ;
}
if ( ! F_106 ( V_20 , L_18 , V_143 ,
V_68 ) )
F_93 ( V_143 ) ;
if ( ! F_106 ( V_20 , L_19 , V_148 ,
V_68 ) )
F_95 ( V_148 ) ;
return 0 ;
V_153:
