...
break;
V_44 = ( V_43 | V_49 ) ;
V_45 = F_30 ( & V_42 -> V_47 , V_43 , V_44 ) ;
if ( V_45 == V_43 )
return V_50 ;
}
F_5 ( V_8 ) ;
V_46 = ( T_5 ) V_39 << 8 ;
F_31 ( V_15 , V_2 -> V_51 , V_46 ) ;
return V_52 ;
}
static void F_32 ( struct V_29 * V_30 , int V_39 )
{
...
V_75 = F_35 ( V_15 , V_2 -> V_78 ) ;
V_76 = F_35 ( V_15 , V_2 -> V_79 ) ;
F_16 ( & V_18 -> V_20 ,
L_4
L_5
L_6 ,
...
F_36 ( & V_18 -> V_20 , L_7 , V_30 -> V_46 ) ;
F_37 ( V_18 , V_8 , sizeof( * V_8 ) ) ;
F_8 ( V_8 ) ;
V_55 = F_11 ( V_8 -> V_53 ,
F_38 ( V_30 -> V_27 . V_82 ) ,
0xffff ) ;
...
L_9 ,
V_84 , F_40 ( & V_18 -> V_20 ) ,
V_8 -> V_85 , F_38 ( V_30 -> V_27 . V_82 ) ,
V_55 , V_56 ) ;
}
F_26 ( V_30 , V_36 ) ;
V_2 -> V_86 ++ ;
V_2 -> V_87 -- ;
F_41 ( & V_2 -> V_88 [ V_2 -> V_4 ] ) ;
V_74:
...
int F_42 ( struct V_14 * V_15 , struct V_29 * V_30 )
{
int V_89 ;
unsigned int V_39 ;
struct V_1 * V_2 ;
...
static struct V_7 * F_44 ( struct V_14 * V_15 ,
struct V_1 * V_2 ,
int * V_46 )
{
T_5 * V_96 ;
...
V_96 [ 0xd0 / 8 ] = 0ULL ;
V_8 -> V_85 = V_97 ;
V_8 -> V_24 = F_45 ( V_2 -> V_98 ++ ) ;
return V_8 ;
}
int F_46 ( struct V_14 * V_15 , struct V_29 * V_30 )
{
struct V_7 * V_8 = NULL ;
unsigned int V_99 ;
unsigned long V_17 ;
...
V_100 = F_35 ( V_15 , V_2 -> V_79 ) ;
F_36 ( & V_18 -> V_20 , L_15 , V_30 -> V_46 ) ;
F_37 ( V_18 , V_8 , sizeof( * V_8 ) ) ;
F_16 ( & V_18 -> V_20 ,
L_16
L_17 ,
...
int F_49 ( struct V_14 * V_15 , struct V_105 * V_106 )
{
int V_12 ;
struct V_18 * V_18 = V_15 -> V_18 ;
if ( V_106 == NULL ) {
...
int F_50 ( struct V_14 * V_15 , struct V_29 * V_30 )
{
struct V_7 * V_8 ;
unsigned long V_17 ;
struct V_1 * V_2 ;
...
V_8 -> V_116 = F_45 ( V_30 -> V_27 . V_117 ) ;
...
V_8 -> V_47 = F_52 ( 0x00000000 ) ;
V_111 = F_11 ( ( const T_2 * ) V_8 ,
F_53 ( V_30 -> V_27 . V_121 ) , 0xffff ) ;
V_8 -> V_47 = F_52 ( ( V_131 ) V_111 << 16 ) ;
if ( ! V_112 )
V_8 -> V_47 |= V_132 ;
F_36 ( & V_18 -> V_20 , L_22 , V_30 -> V_46 ) ;
F_37 ( V_18 , V_8 , sizeof( * V_8 ) ) ;
if ( F_27 ( V_30 ) ) {
F_49 ( V_15 , & V_30 -> V_67 ) ;
...
static int F_58 ( struct V_14 * V_15 , struct V_1 * V_2 )
{
int V_89 , V_16 ;
struct V_7 * V_8 ;
T_5 V_141 ;
...
if ( V_143 < 2 )
return - V_90 ;
V_142 = F_59 ( V_143 * sizeof( struct V_7 ) , V_144 ) ;
V_2 -> V_87 = 0 ;
V_2 -> V_134 = 0 ;
V_2 -> V_86 = 0 ;
V_2 -> V_113 = 0 ;
...
F_31 ( V_15 , V_2 -> V_150 , 0x07 ) ;
F_31 ( V_15 , V_2 -> V_151 , V_2 -> V_81 ) ;
F_31 ( V_15 , V_2 -> V_152 , V_2 -> V_98 ) ;
F_31 ( V_15 , V_2 -> V_153 , V_141 ) ;
return 0 ;
V_148:
F_24 ( V_2 -> V_73 ) ;
V_2 -> V_73 = NULL ;
V_6:
F_63 ( V_15 , V_142 , V_2 -> V_22 ,
V_2 -> V_81 ) ;
V_2 -> V_22 = NULL ;
V_2 -> V_81 = 0ull ;
return - V_154 ;
...
static void F_65 ( struct V_14 * V_15 , struct V_1 * V_2 )
{
unsigned int V_142 ;
V_142 = F_59 ( V_2 -> V_5 * sizeof( struct V_7 ) , V_144 ) ;
F_24 ( V_2 -> V_73 ) ;
V_2 -> V_73 = NULL ;
if ( V_2 -> V_22 ) {
F_63 ( V_15 , V_142 , V_2 -> V_22 ,
...
static T_6 F_66 ( int V_155 , void * V_156 )
{
T_5 V_157 ;
...
static int F_68 ( void * V_163 )
{
int V_164 = 0 , V_89 = 0 ;
struct V_14 * V_15 = (struct V_14 * ) V_163 ;
while ( ! F_69 () ) {
F_34 ( V_15 , & V_15 -> V_2 ) ;
if ( V_112 ) {
V_89 = F_43 (
...
F_61 ( & V_15 -> V_136 ) ;
V_15 -> V_177 = F_75 ( F_68 , V_15 ,
V_84 L_28 ,
V_15 -> V_21 ) ;
if ( F_76 ( V_15 -> V_177 ) ) {
V_89 = F_77 ( V_15 -> V_177 ) ;
V_15 -> V_177 = NULL ;
goto V_178;
}
V_89 = F_78 ( V_15 , V_179 ) ;
if ( V_89 > 0 )
V_89 = F_78 ( V_15 , V_89 ) ;
if ( V_89 != 0 ) {
V_89 = - V_154 ;
...
F_61 ( & V_15 -> V_161 ) ;
if ( F_72 ( V_15 ) ) {
V_89 = F_79 ( V_18 -> V_155 , F_66 , V_181 ,
V_84 , V_15 ) ;
} else {
V_89 = F_79 ( V_18 -> V_155 , F_67 , V_181 ,
V_84 , V_15 ) ;
}
if ( V_89 < 0 ) {
