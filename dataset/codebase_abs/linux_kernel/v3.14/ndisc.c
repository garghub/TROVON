...
V_99 = & F_41 ( V_2 ) -> V_99 ;
if ( ( V_156 -= F_78 ( V_53 -> V_58 , V_157 ) ) < 0 ) {
if ( ! ( V_53 -> V_64 & V_80 ) ) {
F_9 ( 1 , V_158 ,
L_4 ,
V_28 , V_143 ) ;
...
static void F_103 ( struct V_1 * V_191 , struct V_10 * V_9 )
{
struct V_110 * V_111 = (struct V_110 * ) F_83 ( V_191 ) ;
struct V_1 * V_2 ;
struct V_192 * V_193 ;
struct V_194 * V_195 ;
struct V_108 * V_108 = F_32 ( V_191 -> V_5 ) ;
int V_96 ;
int V_196 = F_104 ( sizeof( struct V_194 )
+ ( V_9 -> V_14 << 3 ) ) ;
T_4 V_197 = V_196 + F_105 ( sizeof( struct V_37 ) ) ;
V_2 = F_106 ( V_197 , V_95 ) ;
if ( V_2 == NULL ) {
V_96 = - V_198 ;
goto V_199;
}
V_193 = F_107 ( V_2 , 0 , 0 , V_200 , V_196 , 0 ) ;
if ( V_193 == NULL ) {
goto V_201;
}
V_195 = F_108 ( V_193 ) ;
...
if ( F_109 ( V_2 , V_209 , sizeof( struct V_37 ) ,
& F_41 ( V_191 ) -> V_99 ) )
goto V_201;
F_110 ( V_2 , V_193 ) ;
F_111 ( V_2 , V_108 , 0 , V_210 , NULL , V_95 ) ;
return;
V_201:
F_112 ( V_2 ) ;
V_96 = - V_211 ;
V_199:
F_113 ( V_108 , V_210 , V_96 ) ;
}
static void F_114 ( struct V_1 * V_2 )
{
struct V_212 * V_212 = (struct V_212 * ) F_83 ( V_2 ) ;
...
V_214 = V_233 ;
#endif
V_190 = F_100 ( & F_41 ( V_2 ) -> V_99 , V_2 -> V_5 ) ;
if ( V_190 ) {
V_53 = F_120 ( & V_190 -> V_107 , & F_41 ( V_2 ) -> V_99 ) ;
if ( ! V_53 ) {
F_9 ( 0 , V_96 ,
L_24 ,
V_28 ) ;
...
if ( V_190 == NULL && V_213 ) {
F_9 ( 3 , V_158 , L_25 ) ;
V_190 = F_122 ( & F_41 ( V_2 ) -> V_99 , V_2 -> V_5 , V_214 ) ;
if ( V_190 == NULL ) {
F_9 ( 0 , V_96 ,
L_26 ,
V_28 ) ;
...
V_190 -> V_234 = ( V_190 -> V_234 & ~ V_235 ) | F_123 ( V_214 ) ;
}
if ( V_190 )
F_124 ( V_190 , V_236 + ( V_237 * V_213 ) ) ;
if ( V_212 -> V_138 . V_238 ) {
V_56 -> V_135 . V_101 = V_212 -> V_138 . V_238 ;
if ( V_190 )
F_125 ( & V_190 -> V_107 , V_239 ,
V_212 -> V_138 . V_238 ) ;
}
V_228:
if ( V_56 -> V_60 ) {
unsigned long V_240 = F_126 ( V_212 -> V_241 ) ;
if ( V_240 && V_240 / 1000 < V_242 / V_237 ) {
V_240 = ( V_240 * V_237 ) / 1000 ;
if ( V_240 < V_237 / 10 )
V_240 = V_237 / 10 ;
F_127 ( V_56 -> V_60 , V_243 , V_240 ) ;
V_56 -> V_244 = V_236 ;
F_128 ( V_245 , V_56 ) ;
}
V_240 = F_126 ( V_212 -> V_246 ) ;
if ( V_240 && V_240 / 1000 < V_242 / ( 3 * V_237 ) ) {
V_240 = ( V_240 * V_237 ) / 1000 ;
if ( V_240 < V_237 / 10 )
V_240 = V_237 / 10 ;
if ( V_240 != F_78 ( V_56 -> V_60 , V_247 ) ) {
F_127 ( V_56 -> V_60 ,
V_247 , V_240 ) ;
F_127 ( V_56 -> V_60 ,
V_248 , 3 * V_240 ) ;
V_56 -> V_60 -> V_246 = F_129 ( V_240 ) ;
V_56 -> V_244 = V_236 ;
F_128 ( V_245 , V_56 ) ;
}
}
...
continue;
F_130 ( V_2 -> V_5 , ( T_1 * ) V_250 , ( V_250 -> V_14 ) << 3 ,
& F_41 ( V_2 ) -> V_99 ) ;
}
}
V_249:
...
T_1 * V_102 ;
struct V_17 V_19 ;
struct V_263 * V_132 = (struct V_263 * ) F_83 ( V_2 ) ;
T_2 V_164 = F_84 ( V_2 ) - ( F_83 ( V_2 ) +
F_85 ( struct V_263 , V_9 ) ) ;
#ifdef F_116
switch ( V_2 -> V_216 ) {
case V_217 :
case V_219 :
...
return;
if ( ! V_19 . V_262 ) {
F_134 ( V_2 , F_32 ( V_2 -> V_5 ) ,
V_2 -> V_5 -> V_115 , 0 ) ;
return;
}
V_102 = ( T_1 * ) V_19 . V_262 ;
V_102 += 8 ;
if ( ! F_135 ( V_2 , V_102 - F_83 ( V_2 ) ) )
return;
F_136 ( V_2 , V_264 , 0 , 0 ) ;
}
...
void F_138 ( struct V_1 * V_2 , const struct V_37 * V_143 )
{
struct V_40 * V_5 = V_2 -> V_5 ;
struct V_108 * V_108 = F_32 ( V_5 ) ;
struct V_90 * V_91 = V_108 -> V_92 . V_93 ;
...
if ( ! F_139 ( & F_41 ( V_2 ) -> V_100 , V_143 ) &&
F_115 ( V_143 ) != ( V_273 | V_215 ) ) {
F_9 ( 2 , V_27 ,
L_33 ) ;
return;
}
...
V_107 = F_140 ( V_108 , NULL , & V_114 ) ;
if ( V_107 -> error ) {
F_141 ( V_107 ) ;
return;
}
V_107 = F_142 ( V_108 , V_107 , F_143 ( & V_114 ) , NULL , 0 ) ;
if ( F_48 ( V_107 ) )
return;
...
V_268 = F_144 ( V_108 -> V_92 . V_276 , & V_190 -> V_277 . V_38 , 1 ) ;
V_160 = F_145 ( V_268 , 1 * V_237 ) ;
if ( V_268 )
F_146 ( V_268 ) ;
if ( ! V_160 )
goto V_275;
...
memset ( F_90 ( V_2 ) , 0 , sizeof( struct V_281 ) ) ;
...
static int F_155 ( struct V_283 * V_284 , unsigned long V_285 , void * V_286 )
{
struct V_40 * V_5 = F_156 ( V_286 ) ;
struct V_108 * V_108 = F_32 ( V_5 ) ;
struct V_55 * V_109 ;
switch ( V_285 ) {
case V_287 :
...
static void F_160 ( struct V_292 * V_293 ,
...
int F_162 ( struct V_292 * V_293 , int V_302 , void T_7 * V_303 , T_4 * V_304 , T_8 * V_305 )
{
...
F_160 ( V_293 , L_42 , V_5 ? V_5 -> V_183 : L_43 ) ;
if ( strcmp ( V_293 -> V_301 , L_40 ) == 0 )
V_160 = F_163 ( V_293 , V_302 , V_303 , V_304 , V_305 ) ;
else if ( strcmp ( V_293 -> V_301 , L_41 ) == 0 )
V_160 = F_164 ( V_293 , V_302 ,
V_303 , V_304 , V_305 ) ;
else if ( ( strcmp ( V_293 -> V_301 , L_44 ) == 0 ) ||
( strcmp ( V_293 -> V_301 , L_45 ) == 0 ) )
V_160 = F_165 ( V_293 , V_302 ,
V_303 , V_304 , V_305 ) ;
else
V_160 = - 1 ;
if ( V_302 && V_160 == 0 && V_5 && ( V_109 = F_20 ( V_5 ) ) != NULL ) {
if ( V_293 -> V_3 == & F_78 ( V_109 -> V_60 , V_247 ) )
V_109 -> V_60 -> V_246 =
F_129 ( F_78 ( V_109 -> V_60 , V_247 ) ) ;
V_109 -> V_244 = V_236 ;
F_128 ( V_245 , V_109 ) ;
F_23 ( V_109 ) ;
}
...
static int T_9 F_166 ( struct V_108 * V_108 )
{
struct V_307 * V_308 ;
struct V_90 * V_91 ;
int V_96 ;
V_96 = F_167 ( & V_91 , V_309 ,
V_310 , V_105 , V_108 ) ;
if ( V_96 < 0 ) {
F_9 ( 0 , V_96 ,
L_46 ,
...
static void T_10 F_168 ( struct V_108 * V_108 )
{
F_169 ( V_108 -> V_92 . V_93 ) ;
}
int T_11 F_170 ( void )
{
int V_96 ;
