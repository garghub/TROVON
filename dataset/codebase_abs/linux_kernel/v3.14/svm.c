...
static void F_104 ( struct V_8 * V_9 , T_8 V_188 , bool V_189 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
F_71 ( V_188 < 0 ) ;
if ( V_189 )
V_188 = F_96 ( V_9 , V_188 ) ;
V_10 -> V_1 -> V_2 . V_185 += V_188 ;
if ( F_7 ( V_9 ) )
V_10 -> V_17 . V_18 -> V_2 . V_185 += V_188 ;
else
F_103 ( V_9 -> V_187 ,
V_10 -> V_1 -> V_2 . V_185 - V_188 ,
V_10 -> V_1 -> V_2 . V_185 ) ;
...
static T_2 F_105 ( struct V_8 * V_9 , T_2 V_190 )
{
T_2 V_174 ;
V_174 = F_96 ( V_9 , F_106 () ) ;
return V_190 - V_174 ;
}
static void F_107 ( struct V_7 * V_10 )
{
struct V_11 * V_2 = & V_10 -> V_1 -> V_2 ;
struct V_191 * V_42 = & V_10 -> V_1 -> V_42 ;
V_10 -> V_9 . V_192 = 1 ;
...
V_42 -> V_71 . V_168 = V_253 | V_169 |
V_170 | V_254 ;
V_42 -> V_71 . V_172 = 0xffff ;
V_42 -> V_255 . V_172 = 0xffff ;
V_42 -> V_256 . V_172 = 0xffff ;
F_95 ( & V_42 -> V_257 , V_258 ) ;
F_95 ( & V_42 -> V_259 , V_260 ) ;
F_27 ( & V_10 -> V_9 , 0 ) ;
V_42 -> V_261 = 0xffff0ff0 ;
F_109 ( & V_10 -> V_9 , 2 ) ;
...
struct V_148 * V_283 ;
int V_80 ;
V_10 = F_115 ( V_284 , V_127 ) ;
if ( ! V_10 ) {
V_80 = - V_128 ;
goto V_285;
}
V_10 -> V_178 = V_97 ;
V_80 = F_116 ( & V_10 -> V_9 , V_279 , V_280 ) ;
if ( V_80 )
goto V_286;
V_80 = - V_128 ;
V_148 = F_68 ( V_127 ) ;
if ( ! V_148 )
goto V_287;
V_281 = F_82 ( V_127 , V_139 ) ;
if ( ! V_281 )
goto V_288;
V_283 = F_82 ( V_127 , V_139 ) ;
if ( ! V_283 )
goto V_289;
V_282 = F_68 ( V_127 ) ;
if ( ! V_282 )
...
V_10 -> V_132 = F_83 ( V_281 ) ;
F_75 ( V_10 -> V_132 ) ;
V_10 -> V_17 . V_132 = F_83 ( V_283 ) ;
F_75 ( V_10 -> V_17 . V_132 ) ;
V_10 -> V_1 = F_83 ( V_148 ) ;
F_117 ( V_10 -> V_1 ) ;
V_10 -> V_291 = F_59 ( V_148 ) << V_119 ;
V_10 -> V_109 = 0 ;
F_107 ( V_10 ) ;
...
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
F_64 ( F_93 ( V_10 -> V_291 >> V_119 ) ) ;
F_91 ( F_123 ( V_10 -> V_132 ) , V_139 ) ;
F_64 ( F_123 ( V_10 -> V_17 . V_18 ) ) ;
F_91 ( F_123 ( V_10 -> V_17 . V_132 ) , V_139 ) ;
F_119 ( V_9 ) ;
F_120 ( V_284 , V_10 ) ;
}
static void F_124 ( struct V_8 * V_9 , int V_125 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
int V_28 ;
if ( F_125 ( V_125 != V_9 -> V_125 ) ) {
V_10 -> V_109 = 0 ;
F_1 ( V_10 -> V_1 ) ;
}
#ifdef F_26
F_54 ( V_295 , F_4 ( V_9 ) -> V_189 . V_296 ) ;
#endif
F_126 ( V_251 , V_10 -> V_189 . V_251 ) ;
F_126 ( V_252 , V_10 -> V_189 . V_252 ) ;
V_10 -> V_189 . V_297 = F_127 () ;
...
int V_28 ;
++ V_9 -> V_301 . V_302 ;
F_129 ( V_10 -> V_189 . V_297 ) ;
#ifdef F_26
F_130 ( V_251 , V_10 -> V_189 . V_251 ) ;
F_49 ( V_303 , V_304 -> V_305 . V_252 ) ;
F_131 ( V_10 -> V_189 . V_252 ) ;
#else
#ifdef F_132
F_130 ( V_252 , V_10 -> V_189 . V_252 ) ;
#endif
#endif
for ( V_28 = 0 ; V_28 < V_298 ; V_28 ++ )
...
case V_312 :
F_72 ( ! V_39 ) ;
F_138 ( V_9 , V_9 -> V_23 . V_313 , F_139 ( V_9 ) ) ;
break;
default:
F_77 () ;
}
...
static struct V_165 * F_142 ( struct V_8 * V_9 , int V_166 )
{
struct V_191 * V_42 = & F_4 ( V_9 ) -> V_1 -> V_42 ;
switch ( V_166 ) {
case V_315 : return & V_42 -> V_71 ;
case V_316 : return & V_42 -> V_250 ;
case V_317 : return & V_42 -> V_248 ;
case V_318 : return & V_42 -> V_251 ;
case V_319 : return & V_42 -> V_252 ;
case V_320 : return & V_42 -> V_249 ;
case V_321 : return & V_42 -> V_259 ;
case V_322 : return & V_42 -> V_257 ;
}
F_77 () ;
return NULL ;
}
static T_2 F_143 ( struct V_8 * V_9 , int V_166 )
{
struct V_165 * V_323 = F_142 ( V_9 , V_166 ) ;
return V_323 -> V_72 ;
}
...
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
V_340 -> V_341 = V_10 -> V_1 -> V_42 . V_256 . V_172 ;
V_340 -> V_113 = V_10 -> V_1 -> V_42 . V_256 . V_72 ;
}
static void F_147 ( struct V_8 * V_9 , struct V_100 * V_340 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
V_10 -> V_1 -> V_42 . V_256 . V_172 = V_340 -> V_341 ;
V_10 -> V_1 -> V_42 . V_256 . V_72 = V_340 -> V_113 ;
F_3 ( V_10 -> V_1 , V_342 ) ;
}
static void F_148 ( struct V_8 * V_9 , struct V_100 * V_340 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
V_340 -> V_341 = V_10 -> V_1 -> V_42 . V_255 . V_172 ;
V_340 -> V_113 = V_10 -> V_1 -> V_42 . V_255 . V_72 ;
}
static void F_149 ( struct V_8 * V_9 , struct V_100 * V_340 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
...
{
T_9 V_343 = V_10 -> V_9 . V_23 . V_264 ;
T_2 * V_344 = & V_10 -> V_1 -> V_42 . V_264 ;
if ( ! V_10 -> V_9 . V_192 )
* V_344 |= V_345 ;
else
* V_344 = ( * V_344 & ~ V_345 )
...
unsigned long V_351 = F_4 ( V_9 ) -> V_1 -> V_42 . V_268 ;
if ( V_268 & V_352 )
return 1 ;
if ( V_39 && ( ( V_351 ^ V_268 ) & V_353 ) )
F_158 ( V_9 ) ;
...
static void F_161 ( struct V_7 * V_10 , struct V_98 * V_99 )
{
...
{
return F_4 ( V_9 ) -> V_1 -> V_42 . V_261 ;
}
static void F_163 ( struct V_8 * V_9 , unsigned long V_365 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
V_10 -> V_1 -> V_42 . V_261 = V_365 ;
F_3 ( V_10 -> V_1 , V_366 ) ;
}
static void F_164 ( struct V_8 * V_9 , unsigned long V_365 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
V_10 -> V_1 -> V_42 . V_367 = V_365 ;
F_3 ( V_10 -> V_1 , V_366 ) ;
}
...
F_166 ( V_368 , V_64 ) ;
if ( ! V_39 && F_167 ( & V_10 -> V_9 ) )
F_168 ( & V_10 -> V_9 , V_368 ) ;
V_126 = F_169 ( & V_10 -> V_9 , V_368 , V_64 ,
V_10 -> V_1 -> V_2 . V_372 ,
V_10 -> V_1 -> V_2 . V_373 ) ;
break;
case V_374 :
...
static T_2 F_197 ( struct V_8 * V_9 , int V_130 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
T_2 V_272 = V_10 -> V_17 . V_401 ;
T_2 V_402 ;
int V_50 ;
V_50 = F_198 ( V_9 -> V_279 , F_199 ( V_272 ) , & V_402 ,
F_200 ( V_272 ) + V_130 * 8 , 8 ) ;
if ( V_50 )
return 0 ;
return V_402 ;
}
...
{
F_205 ( V_9 , & V_9 -> V_23 . V_410 ) ;
V_9 -> V_23 . V_410 . V_411 = F_201 ;
V_9 -> V_23 . V_410 . V_412 = F_196 ;
V_9 -> V_23 . V_410 . V_413 = F_197 ;
V_9 -> V_23 . V_410 . V_414 = F_202 ;
...
static void * F_213 ( struct V_7 * V_10 , T_2 V_426 , struct V_148 * * V_427 )
{
struct V_148 * V_148 ;
F_214 () ;
V_148 = F_215 ( V_10 -> V_9 . V_279 , V_426 >> V_119 ) ;
if ( F_216 ( V_148 ) )
goto error;
* V_427 = V_148 ;
return F_217 ( V_148 ) ;
...
static void F_218 ( struct V_148 * V_148 )
{
F_219 ( V_148 ) ;
F_220 ( V_148 ) ;
}
...
V_6 = V_394 % 8 ;
V_81 = 0 ;
if ( F_222 ( V_10 -> V_9 . V_279 , V_426 , & V_81 , 1 ) )
V_81 &= ( 1 << V_6 ) ;
...
return V_428 ;
V_26 = V_10 -> V_9 . V_23 . V_262 [ V_430 ] ;
V_27 = F_21 ( V_26 ) ;
...
return V_420 ;
V_27 *= 4 ;
if ( F_222 ( V_10 -> V_9 . V_279 , V_10 -> V_17 . V_431 + V_27 , & V_365 , 4 ) )
return V_420 ;
...
V_1 -> V_2 . V_448 ,
V_450 ) ;
V_449 = F_213 ( V_10 , V_10 -> V_17 . V_1 , & V_148 ) ;
if ( ! V_449 )
return 1 ;
F_228 ( & V_10 -> V_9 ) ;
V_10 -> V_17 . V_1 = 0 ;
...
V_449 -> V_42 . V_250 = V_1 -> V_42 . V_250 ;
V_449 -> V_42 . V_255 = V_1 -> V_42 . V_255 ;
V_449 -> V_42 . V_256 = V_1 -> V_42 . V_256 ;
V_449 -> V_42 . V_38 = V_10 -> V_9 . V_23 . V_38 ;
V_449 -> V_42 . V_264 = F_229 ( & V_10 -> V_9 ) ;
V_449 -> V_42 . V_272 = F_139 ( & V_10 -> V_9 ) ;
V_449 -> V_42 . V_419 = V_1 -> V_42 . V_419 ;
V_449 -> V_42 . V_268 = V_10 -> V_9 . V_23 . V_268 ;
V_449 -> V_42 . V_307 = F_230 ( & V_10 -> V_9 ) ;
V_449 -> V_42 . V_68 = V_1 -> V_42 . V_68 ;
V_449 -> V_42 . V_451 = V_1 -> V_42 . V_451 ;
V_449 -> V_42 . V_452 = V_1 -> V_42 . V_452 ;
V_449 -> V_42 . V_367 = V_1 -> V_42 . V_367 ;
V_449 -> V_42 . V_261 = V_1 -> V_42 . V_261 ;
...
V_10 -> V_1 -> V_42 . V_250 = V_18 -> V_42 . V_250 ;
V_10 -> V_1 -> V_42 . V_255 = V_18 -> V_42 . V_255 ;
V_10 -> V_1 -> V_42 . V_256 = V_18 -> V_42 . V_256 ;
F_109 ( & V_10 -> V_9 , V_18 -> V_42 . V_307 ) ;
F_27 ( & V_10 -> V_9 , V_18 -> V_42 . V_38 ) ;
F_154 ( & V_10 -> V_9 , V_18 -> V_42 . V_264 | V_454 ) ;
F_156 ( & V_10 -> V_9 , V_18 -> V_42 . V_268 ) ;
if ( V_39 ) {
V_10 -> V_1 -> V_42 . V_272 = V_18 -> V_42 . V_272 ;
V_10 -> V_9 . V_23 . V_272 = V_18 -> V_42 . V_272 ;
} else {
( void ) F_233 ( & V_10 -> V_9 , V_18 -> V_42 . V_272 ) ;
}
F_113 ( & V_10 -> V_9 , V_455 , V_18 -> V_42 . V_452 ) ;
F_113 ( & V_10 -> V_9 , V_456 , V_18 -> V_42 . V_451 ) ;
F_113 ( & V_10 -> V_9 , V_263 , V_18 -> V_42 . V_68 ) ;
V_10 -> V_1 -> V_42 . V_367 = 0 ;
...
if ( F_222 ( V_10 -> V_9 . V_279 , V_27 , & V_365 , 4 ) )
return false ;
V_10 -> V_17 . V_132 [ V_457 ] = V_10 -> V_132 [ V_457 ] | V_365 ;
}
V_10 -> V_1 -> V_2 . V_245 = F_108 ( V_10 -> V_17 . V_132 ) ;
return true ;
}
...
V_449 = F_213 ( V_10 , V_10 -> V_1 -> V_42 . V_452 , & V_148 ) ;
if ( ! V_449 )
return false ;
if ( ! F_237 ( V_449 ) ) {
...
F_239 ( V_10 -> V_1 -> V_42 . V_68 , V_458 ,
V_449 -> V_42 . V_68 ,
V_449 -> V_2 . V_246 ,
V_449 -> V_2 . V_74 ,
V_449 -> V_2 . V_270 ) ;
...
V_18 -> V_42 . V_250 = V_1 -> V_42 . V_250 ;
V_18 -> V_42 . V_255 = V_1 -> V_42 . V_255 ;
V_18 -> V_42 . V_256 = V_1 -> V_42 . V_256 ;
V_18 -> V_42 . V_38 = V_10 -> V_9 . V_23 . V_38 ;
V_18 -> V_42 . V_264 = F_229 ( & V_10 -> V_9 ) ;
V_18 -> V_42 . V_268 = V_10 -> V_9 . V_23 . V_268 ;
V_18 -> V_42 . V_307 = F_230 ( & V_10 -> V_9 ) ;
...
V_18 -> V_42 . V_272 = F_139 ( & V_10 -> V_9 ) ;
F_226 ( V_18 , V_1 ) ;
...
V_10 -> V_1 -> V_42 . V_250 = V_449 -> V_42 . V_250 ;
V_10 -> V_1 -> V_42 . V_255 = V_449 -> V_42 . V_255 ;
V_10 -> V_1 -> V_42 . V_256 = V_449 -> V_42 . V_256 ;
F_109 ( & V_10 -> V_9 , V_449 -> V_42 . V_307 ) ;
F_27 ( & V_10 -> V_9 , V_449 -> V_42 . V_38 ) ;
F_154 ( & V_10 -> V_9 , V_449 -> V_42 . V_264 ) ;
F_156 ( & V_10 -> V_9 , V_449 -> V_42 . V_268 ) ;
if ( V_39 ) {
V_10 -> V_1 -> V_42 . V_272 = V_449 -> V_42 . V_272 ;
V_10 -> V_9 . V_23 . V_272 = V_449 -> V_42 . V_272 ;
} else
( void ) F_233 ( & V_10 -> V_9 , V_449 -> V_42 . V_272 ) ;
F_234 ( & V_10 -> V_9 ) ;
V_10 -> V_1 -> V_42 . V_419 = V_10 -> V_9 . V_23 . V_419 = V_449 -> V_42 . V_419 ;
F_113 ( & V_10 -> V_9 , V_455 , V_449 -> V_42 . V_452 ) ;
F_113 ( & V_10 -> V_9 , V_456 , V_449 -> V_42 . V_451 ) ;
F_113 ( & V_10 -> V_9 , V_263 , V_449 -> V_42 . V_68 ) ;
V_10 -> V_1 -> V_42 . V_452 = V_449 -> V_42 . V_452 ;
V_10 -> V_1 -> V_42 . V_451 = V_449 -> V_42 . V_451 ;
V_10 -> V_1 -> V_42 . V_68 = V_449 -> V_42 . V_68 ;
V_10 -> V_1 -> V_42 . V_367 = V_449 -> V_42 . V_367 ;
V_10 -> V_1 -> V_42 . V_261 = V_449 -> V_42 . V_261 ;
...
V_10 -> V_1 -> V_2 . V_185 += V_449 -> V_2 . V_185 ;
...
V_461 -> V_42 . V_252 = V_443 -> V_42 . V_252 ;
V_461 -> V_42 . V_259 = V_443 -> V_42 . V_259 ;
V_461 -> V_42 . V_257 = V_443 -> V_42 . V_257 ;
...
{
struct V_8 * V_9 = & V_10 -> V_9 ;
F_250 ( V_10 -> V_1 -> V_42 . V_68 , V_9 -> V_23 . V_262 [ V_430 ] ,
V_9 -> V_23 . V_262 [ V_455 ] ) ;
F_251 ( V_9 , V_9 -> V_23 . V_262 [ V_455 ] ) ;
V_10 -> V_55 = F_34 ( & V_10 -> V_9 ) + 3 ;
F_31 ( & V_10 -> V_9 ) ;
return 1 ;
}
...
{
F_253 ( V_10 -> V_1 -> V_42 . V_68 , V_10 -> V_9 . V_23 . V_262 [ V_455 ] ) ;
F_175 ( & V_10 -> V_9 , V_217 ) ;
return 1 ;
}
...
T_1 V_130 = F_256 ( & V_10 -> V_9 , V_430 ) ;
if ( F_257 ( & V_10 -> V_9 , V_130 , V_474 ) == 0 ) {
V_10 -> V_55 = F_34 ( & V_10 -> V_9 ) + 3 ;
F_31 ( & V_10 -> V_9 ) ;
}
return 1 ;
...
if ( V_477 != V_494 )
V_479 = - 1 ;
if ( F_260 ( & V_10 -> V_9 , V_475 , V_479 , V_476 ,
V_63 , V_64 ) == V_496 ) {
...
bool F_269 ( struct V_7 * V_10 , unsigned long V_81 )
{
...
if ( V_508 >= 16 ) {
V_508 -= 16 ;
V_81 = F_256 ( & V_10 -> V_9 , V_311 ) ;
switch ( V_508 ) {
case 0 :
if ( ! F_269 ( V_10 , V_81 ) )
V_80 = F_110 ( & V_10 -> V_9 , V_81 ) ;
else
return 1 ;
break;
case 3 :
V_80 = F_233 ( & V_10 -> V_9 , V_81 ) ;
break;
case 4 :
V_80 = F_271 ( & V_10 -> V_9 , V_81 ) ;
break;
case 8 :
V_80 = F_272 ( & V_10 -> V_9 , V_81 ) ;
break;
default:
F_98 ( 1 , L_12 , V_508 ) ;
F_175 ( & V_10 -> V_9 , V_217 ) ;
...
if ( V_511 >= 16 ) {
V_81 = F_256 ( & V_10 -> V_9 , V_311 ) ;
F_276 ( & V_10 -> V_9 , V_511 - 16 , V_81 ) ;
} else {
V_80 = F_277 ( & V_10 -> V_9 , V_511 , & V_81 ) ;
if ( ! V_80 )
F_113 ( & V_10 -> V_9 , V_311 , V_81 ) ;
}
F_31 ( & V_10 -> V_9 ) ;
...
struct V_376 * V_376 = V_10 -> V_9 . V_377 ;
int V_126 ;
T_4 V_512 = F_274 ( & V_10 -> V_9 ) ;
V_126 = F_270 ( V_10 ) ;
if ( F_279 ( V_10 -> V_9 . V_279 ) )
return V_126 ;
if ( V_512 <= F_274 ( & V_10 -> V_9 ) )
return V_126 ;
V_376 -> V_380 = V_513 ;
return 0 ;
}
T_2 F_280 ( struct V_8 * V_9 , T_2 V_514 )
{
struct V_1 * V_1 = F_8 ( F_4 ( V_9 ) ) ;
return V_1 -> V_2 . V_185 +
F_96 ( V_9 , V_514 ) ;
}
static int F_281 ( struct V_8 * V_9 , unsigned V_515 , T_2 * V_516 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
switch ( V_515 ) {
case V_517 : {
* V_516 = V_10 -> V_1 -> V_2 . V_185 +
F_96 ( V_9 , F_106 () ) ;
break;
}
case V_518 :
* V_516 = V_10 -> V_1 -> V_42 . V_463 ;
break;
#ifdef F_26
case V_519 :
* V_516 = V_10 -> V_1 -> V_42 . V_464 ;
break;
case V_520 :
* V_516 = V_10 -> V_1 -> V_42 . V_465 ;
break;
case V_303 :
* V_516 = V_10 -> V_1 -> V_42 . V_462 ;
break;
case V_521 :
* V_516 = V_10 -> V_1 -> V_42 . V_466 ;
break;
#endif
case V_522 :
* V_516 = V_10 -> V_1 -> V_42 . V_467 ;
break;
case V_523 :
* V_516 = V_10 -> V_469 ;
break;
...
break;
case V_525 :
* V_516 = V_10 -> V_1 -> V_42 . V_526 ;
break;
case V_144 :
* V_516 = V_10 -> V_1 -> V_42 . V_527 ;
break;
case V_145 :
* V_516 = V_10 -> V_1 -> V_42 . V_528 ;
break;
case V_146 :
* V_516 = V_10 -> V_1 -> V_42 . V_529 ;
break;
case V_147 :
* V_516 = V_10 -> V_1 -> V_42 . V_530 ;
break;
case V_117 :
...
break;
default:
return F_282 ( V_9 , V_515 , V_516 ) ;
}
return 0 ;
}
static int F_283 ( struct V_7 * V_10 )
{
T_1 V_515 = V_10 -> V_9 . V_23 . V_262 [ V_430 ] ;
T_2 V_516 ;
if ( F_281 ( & V_10 -> V_9 , V_515 , & V_516 ) ) {
F_284 ( V_515 ) ;
F_208 ( & V_10 -> V_9 , 0 ) ;
} else {
F_285 ( V_515 , V_516 ) ;
V_10 -> V_9 . V_23 . V_262 [ V_455 ] = V_516 & 0xffffffff ;
V_10 -> V_9 . V_23 . V_262 [ V_278 ] = V_516 >> 32 ;
V_10 -> V_55 = F_34 ( & V_10 -> V_9 ) + 2 ;
F_31 ( & V_10 -> V_9 ) ;
}
return 1 ;
}
static int F_286 ( struct V_8 * V_9 , T_2 V_516 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
int V_535 , V_536 ;
if ( V_516 & ~ V_537 )
...
static int F_287 ( struct V_8 * V_9 , struct V_540 * V_26 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
T_1 V_515 = V_26 -> V_130 ;
T_2 V_516 = V_26 -> V_516 ;
switch ( V_515 ) {
case V_517 :
F_288 ( V_9 , V_26 ) ;
break;
case V_518 :
V_10 -> V_1 -> V_42 . V_463 = V_516 ;
break;
#ifdef F_26
case V_519 :
V_10 -> V_1 -> V_42 . V_464 = V_516 ;
break;
case V_520 :
V_10 -> V_1 -> V_42 . V_465 = V_516 ;
break;
case V_303 :
V_10 -> V_1 -> V_42 . V_462 = V_516 ;
break;
case V_521 :
V_10 -> V_1 -> V_42 . V_466 = V_516 ;
break;
#endif
case V_522 :
V_10 -> V_1 -> V_42 . V_467 = V_516 ;
break;
case V_523 :
V_10 -> V_469 = V_516 ;
V_10 -> V_1 -> V_42 . V_469 = V_516 ;
break;
case V_524 :
V_10 -> V_468 = V_516 ;
V_10 -> V_1 -> V_42 . V_468 = V_516 ;
break;
case V_525 :
if ( ! F_84 ( V_541 ) ) {
F_289 ( V_9 , L_14 ,
...
break;
case V_532 :
return F_286 ( V_9 , V_516 ) ;
case V_544 :
F_289 ( V_9 , L_15 , V_515 , V_516 ) ;
break;
default:
return F_290 ( V_9 , V_26 ) ;
}
return 0 ;
}
...
struct V_540 V_26 ;
T_1 V_515 = V_10 -> V_9 . V_23 . V_262 [ V_430 ] ;
T_2 V_516 = ( V_10 -> V_9 . V_23 . V_262 [ V_455 ] & - 1u )
| ( ( T_2 ) ( V_10 -> V_9 . V_23 . V_262 [ V_278 ] & - 1u ) << 32 ) ;
V_26 . V_516 = V_516 ;
V_26 . V_130 = V_515 ;
V_26 . V_545 = false ;
V_10 -> V_55 = F_34 ( & V_10 -> V_9 ) + 2 ;
if ( F_287 ( & V_10 -> V_9 , & V_26 ) ) {
F_292 ( V_515 , V_516 ) ;
F_208 ( & V_10 -> V_9 , 0 ) ;
} else {
F_293 ( V_515 , V_516 ) ;
...
F_55 ( L_22 , L_34 , V_2 -> V_446 ) ;
F_55 ( L_22 , L_35 , V_2 -> V_51 ) ;
F_55 ( L_22 , L_36 , V_2 -> V_407 ) ;
F_55 ( L_24 , L_37 , V_2 -> V_371 ) ;
F_55 ( L_24 , L_38 , V_2 -> V_369 ) ;
F_55 ( L_22 , L_39 , V_2 -> V_447 ) ;
F_55 ( L_22 , L_40 , V_2 -> V_448 ) ;
F_55 ( L_41 , L_42 , V_2 -> V_270 ) ;
F_55 ( L_24 , L_43 , V_2 -> V_401 ) ;
...
F_55 ( L_49 ,
L_55 ,
V_42 -> V_252 . V_167 , V_42 -> V_252 . V_168 ,
V_42 -> V_252 . V_172 , V_42 -> V_252 . V_72 ) ;
F_55 ( L_49 ,
L_56 ,
...
F_55 ( L_49 ,
L_57 ,
V_42 -> V_257 . V_167 , V_42 -> V_257 . V_168 ,
V_42 -> V_257 . V_172 , V_42 -> V_257 . V_72 ) ;
F_55 ( L_49 ,
L_58 ,
...
F_55 ( L_49 ,
L_59 ,
V_42 -> V_259 . V_167 , V_42 -> V_259 . V_168 ,
V_42 -> V_259 . V_172 , V_42 -> V_259 . V_72 ) ;
F_55 ( L_60 ,
V_42 -> V_306 , V_42 -> V_38 ) ;
F_55 ( L_61 ,
L_62 , V_42 -> V_264 , L_63 , V_42 -> V_419 ) ;
F_55 ( L_61 ,
L_64 , V_42 -> V_272 , L_65 , V_42 -> V_268 ) ;
F_55 ( L_61 ,
L_66 , V_42 -> V_261 , L_67 , V_42 -> V_367 ) ;
F_55 ( L_61 ,
...
L_79 , V_42 -> V_469 ) ;
F_55 ( L_61 ,
L_80 , V_42 -> V_271 , L_81 , V_42 -> V_526 ) ;
F_55 ( L_61 ,
L_82 , V_42 -> V_527 , L_83 , V_42 -> V_528 ) ;
F_55 ( L_61 ,
L_84 , V_42 -> V_529 ,
L_85 , V_42 -> V_530 ) ;
}
static void F_300 ( struct V_8 * V_9 , T_2 * V_549 , T_2 * V_550 )
{
...
if ( F_7 ( V_9 ) ) {
int V_417 ;
F_302 ( V_10 -> V_1 -> V_42 . V_68 , V_407 ,
V_10 -> V_1 -> V_2 . V_371 ,
V_10 -> V_1 -> V_2 . V_369 ,
V_10 -> V_1 -> V_2 . V_447 ,
V_10 -> V_1 -> V_2 . V_448 ,
...
V_407 != V_418 + V_216 &&
V_407 != V_408 && V_407 != V_554 &&
V_407 != V_424 && V_407 != V_425 )
F_33 ( V_61 L_87
L_88 ,
V_59 , V_10 -> V_1 -> V_2 . V_447 ,
V_407 ) ;
if ( V_407 >= F_304 ( V_555 )
|| ! V_555 [ V_407 ] ) {
V_376 -> V_380 = V_556 ;
V_376 -> V_557 . V_558 = V_407 ;
return 0 ;
}
return V_555 [ V_407 ] ( V_10 ) ;
}
...
static void F_307 ( struct V_7 * V_10 )
{
int V_125 = F_53 () ;
struct V_98 * V_99 = F_56 ( V_108 , V_125 ) ;
...
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
V_10 -> V_1 -> V_2 . V_74 = V_47 | V_559 ;
V_9 -> V_23 . V_24 |= V_560 ;
F_16 ( V_10 , V_503 ) ;
++ V_9 -> V_301 . V_561 ;
}
static inline void F_309 ( struct V_7 * V_10 , int V_562 )
{
struct V_11 * V_2 ;
V_2 = & V_10 -> V_1 -> V_2 ;
V_2 -> V_446 = V_562 ;
...
struct V_7 * V_10 = F_4 ( V_9 ) ;
F_72 ( ! ( F_20 ( V_10 ) ) ) ;
F_311 ( V_9 -> V_23 . V_565 . V_62 ) ;
++ V_9 -> V_301 . V_566 ;
V_10 -> V_1 -> V_2 . V_74 = V_9 -> V_23 . V_565 . V_62 |
V_47 | V_48 ;
}
static void F_312 ( struct V_8 * V_9 , int V_567 , int V_568 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
...
static void F_313 ( struct V_8 * V_9 , bool V_569 )
{
return;
}
static int F_314 ( struct V_279 * V_279 )
{
return 0 ;
}
static void F_315 ( struct V_8 * V_9 , T_2 * V_570 )
{
return;
}
static void F_316 ( struct V_279 * V_279 , int V_571 )
{
return;
}
...
! ( V_10 -> V_9 . V_23 . V_24 & V_560 ) ;
V_50 = V_50 && F_20 ( V_10 ) && F_212 ( V_10 ) ;
return V_50 ;
}
static bool F_319 ( struct V_8 * V_9 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
return ! ! ( V_10 -> V_9 . V_23 . V_24 & V_560 ) ;
}
static void F_320 ( struct V_8 * V_9 , bool V_572 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
if ( V_572 ) {
V_10 -> V_9 . V_23 . V_24 |= V_560 ;
...
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
if ( ( V_10 -> V_9 . V_23 . V_24 & ( V_560 | V_504 ) )
== V_560 )
return 0 ;
V_10 -> V_356 = true ;
...
static int F_324 ( struct V_279 * V_279 , unsigned int V_34 )
{
return 0 ;
}
...
static inline void F_326 ( struct V_8 * V_9 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
if ( F_7 ( V_9 ) && ( V_9 -> V_23 . V_24 & V_422 ) )
return;
if ( ! F_11 ( V_10 , V_199 ) ) {
int V_575 = V_10 -> V_1 -> V_2 . V_246 & V_576 ;
F_272 ( V_9 , V_575 ) ;
}
}
static inline void F_327 ( struct V_8 * V_9 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
T_2 V_575 ;
if ( F_7 ( V_9 ) && ( V_9 -> V_23 . V_24 & V_422 ) )
return;
V_575 = F_274 ( V_9 ) ;
V_10 -> V_1 -> V_2 . V_246 &= ~ V_576 ;
V_10 -> V_1 -> V_2 . V_246 |= V_575 & V_576 ;
}
static void F_303 ( struct V_7 * V_10 )
{
T_4 V_577 ;
int type ;
T_1 V_578 = V_10 -> V_1 -> V_2 . V_447 ;
unsigned V_73 = V_10 -> V_73 ;
V_10 -> V_73 = 0 ;
if ( ( V_10 -> V_9 . V_23 . V_24 & V_504 )
&& F_34 ( & V_10 -> V_9 ) != V_10 -> V_505 ) {
V_10 -> V_9 . V_23 . V_24 &= ~ ( V_560 | V_504 ) ;
F_184 ( V_471 , & V_10 -> V_9 ) ;
}
V_10 -> V_9 . V_23 . V_490 = false ;
F_231 ( & V_10 -> V_9 ) ;
...
F_330 ( & V_10 -> V_9 , V_577 , V_80 ) ;
} else
F_331 ( & V_10 -> V_9 , V_577 ) ;
break;
case V_493 :
F_332 ( & V_10 -> V_9 , V_577 , false ) ;
break;
default:
break;
}
...
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
V_10 -> V_1 -> V_42 . V_452 = V_9 -> V_23 . V_262 [ V_455 ] ;
V_10 -> V_1 -> V_42 . V_451 = V_9 -> V_23 . V_262 [ V_456 ] ;
...
V_9 -> V_23 . V_262 [ V_455 ] = V_10 -> V_1 -> V_42 . V_452 ;
V_9 -> V_23 . V_262 [ V_456 ] = V_10 -> V_1 -> V_42 . V_451 ;
V_9 -> V_23 . V_262 [ V_263 ] = V_10 -> V_1 -> V_42 . V_68 ;
F_335 ( V_10 -> V_1 -> V_2 . V_407 , V_9 , V_450 ) ;
...
F_326 ( V_9 ) ;
V_10 -> V_55 = 0 ;
V_10 -> V_1 -> V_2 . V_362 = V_581 ;
if ( V_10 -> V_1 -> V_2 . V_407 == V_418 + V_216 )
V_10 -> V_370 = F_338 () ;
if ( V_39 ) {
V_9 -> V_23 . V_582 &= ~ ( 1 << V_312 ) ;
V_9 -> V_23 . V_583 &= ~ ( 1 << V_312 ) ;
}
...
static void F_339 ( struct V_8 * V_9 , unsigned long V_403 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
V_10 -> V_1 -> V_42 . V_272 = V_403 ;
F_3 ( V_10 -> V_1 , V_44 ) ;
F_158 ( V_9 ) ;
}
static void F_340 ( struct V_8 * V_9 , unsigned long V_403 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
V_10 -> V_1 -> V_2 . V_401 = V_403 ;
F_3 ( V_10 -> V_1 , V_404 ) ;
V_10 -> V_1 -> V_42 . V_272 = F_139 ( V_9 ) ;
F_3 ( V_10 -> V_1 , V_44 ) ;
F_158 ( V_9 ) ;
}
...
static void
F_342 ( struct V_8 * V_9 , unsigned char * V_586 )
{
V_586 [ 0 ] = 0x0f ;
V_586 [ 1 ] = 0x01 ;
V_586 [ 2 ] = 0xd9 ;
}
static void F_343 ( void * V_587 )
{
* ( int * ) V_587 = 0 ;
}
...
static T_2 F_345 ( struct V_8 * V_9 , T_11 V_588 , bool V_589 )
{
return 0 ;
}
...
static void F_347 ( T_1 V_590 , struct V_591 * V_592 )
{
switch ( V_590 ) {
case 0x80000001 :
if ( V_17 )
...
static void F_352 ( struct V_8 * V_9 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
F_14 ( V_10 , V_387 ) ;
F_153 ( V_10 ) ;
}
static int F_353 ( struct V_8 * V_9 ,
struct V_598 * V_45 ,
enum V_599 V_600 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
int V_417 , V_50 = V_601 ;
struct V_602 V_603 ;
struct V_1 * V_1 = V_10 -> V_1 ;
if ( V_45 -> V_22 >= F_304 ( V_604 ) )
goto V_285;
V_603 = V_604 [ V_45 -> V_22 ] ;
if ( V_600 != V_603 . V_600 )
goto V_285;
switch ( V_603 . V_407 ) {
case V_435 :
if ( V_45 -> V_22 == V_605 )
V_603 . V_407 += V_45 -> V_606 ;
break;
case V_607 : {
...
if ( ! ( V_22 & ( 1ULL << V_222 ) ) )
break;
V_264 = V_9 -> V_23 . V_264 & ~ V_345 ;
V_81 = V_45 -> V_609 & ~ V_345 ;
if ( V_45 -> V_22 == V_610 ) {
V_264 &= 0xfUL ;
V_81 &= 0xfUL ;
if ( V_264 & V_454 )
...
T_2 V_616 ;
T_1 V_617 ;
V_616 = ( V_9 -> V_23 . V_262 [ V_278 ] & 0xffff ) << 16 ;
if ( V_45 -> V_22 == V_618 ||
V_45 -> V_22 == V_619 ) {
V_616 |= V_397 ;
V_617 = V_45 -> V_620 ;
...
static int T_5 F_355 ( void )
{
return F_356 ( & V_627 , sizeof( struct V_7 ) ,
F_357 ( struct V_7 ) , V_628 ) ;
}
static void T_6 F_358 ( void )
{
F_359 () ;
}
