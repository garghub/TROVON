...
V_19 -> V_32 = V_33 ;
V_19 -> V_34 = & V_35 ;
V_19 -> V_36 = 0xfeeeeeeeeeeeeeeeULL ;
#ifdef F_15
V_19 -> V_37 = F_11 ( V_8 ) ;
#endif
#ifdef F_16
...
{
int V_8 , V_2 ;
V_2 = F_21 ( 0x10000000ULL , V_46 ) ;
V_47 = F_2 ( sizeof( struct V_18 ) * V_48 ) ;
V_49 = F_3 ( F_4 ( V_47 , V_7 , V_2 ) ) ;
memset ( V_49 , 0 , V_47 ) ;
F_22 ( V_50 L_1 ,
V_47 , V_48 , V_49 ) ;
F_1 ( V_48 , V_2 ) ;
...
{
int V_10 ;
V_10 = F_2 ( sizeof( struct V_18 ) * V_48 ) ;
if ( V_10 >= V_47 )
return;
F_8 ( F_9 ( V_49 ) + V_10 , V_47 - V_10 ) ;
F_22 ( V_50 L_2 ,
V_47 - V_10 ) ;
V_47 = V_10 ;
F_6 () ;
