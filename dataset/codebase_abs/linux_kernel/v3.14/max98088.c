...
F_55 ( V_8 -> V_2 , L_11 , V_153 - 0x40 + 'A' ) ;
F_5 ( V_8 , V_59 , V_173 ) ;
F_37 ( V_8 , V_115 ) ;
F_5 ( V_8 , V_174 , 0x00 ) ;
F_5 ( V_8 , V_175 ,
...
static int F_58 ( struct V_187 * V_188 ,
const struct V_189 * V_146 )
{
struct V_21 * V_22 ;
int V_153 ;
V_22 = F_59 ( & V_188 -> V_2 , sizeof( struct V_21 ) ,
V_157 ) ;
if ( V_22 == NULL )
return - V_190 ;
V_22 -> V_119 = F_60 ( V_188 , & V_191 ) ;
if ( F_61 ( V_22 -> V_119 ) )
return F_62 ( V_22 -> V_119 ) ;
V_22 -> V_192 = V_146 -> V_193 ;
F_63 ( V_188 , V_22 ) ;
V_22 -> V_125 = V_188 -> V_2 . V_194 ;
V_153 = F_64 ( & V_188 -> V_2 ,
& V_195 , & V_196 [ 0 ] , 2 ) ;
return V_153 ;
}
static int F_65 ( struct V_187 * V_197 )
{
F_66 ( & V_197 -> V_2 ) ;
return 0 ;
}
