...
void F_124 ( struct V_1 * V_2 , bool V_262 )
{
int V_263 ;
struct V_164 * V_264 ;
struct V_265 * V_266 ;
...
V_263 = F_56 ( & V_2 -> V_15 . V_6 -> V_268 ) ;
if ( ( V_2 -> V_15 . V_6 -> V_65 - V_263 ) > 0 )
V_2 -> V_67 = ( V_2 -> V_15 . V_6 -> V_65 - V_263 ) >> 1 ;
else
V_2 -> V_67 = 0 ;
F_28 ( L_8 ,
V_154 , V_2 , V_2 -> V_67 , V_263 ,
V_2 -> V_15 . V_6 -> V_65 ) ;
if ( V_262 && F_123 ( V_2 ) ) {
V_2 -> V_68 = V_2 -> V_67 ;
F_28 ( L_9
...
{
int V_269 ;
V_269 = ( V_96 == V_2 -> V_15 . V_6 -> V_95 ) ? V_270 : 0 ;
if ( V_2 -> V_69 . V_94 )
V_269 |= V_271 ;
if ( V_2 -> V_69 . V_97 )
V_269 |= V_272 ;
return F_128 ( F_2 ( V_2 -> V_15 . V_6 ) ,
& V_2 -> V_15 . V_18 ,
& V_2 -> V_4 -> V_15 . V_18 ,
V_7 , V_8 , V_269 ) ;
}
...
T_2 V_8 )
{
int V_274 = F_20 ( V_129 -> V_275 -> V_235 . V_110 ) ;
int V_276 = V_129 -> V_277 ;
T_9 * V_278 = ( T_9 * ) V_129 -> V_275 + V_274 ;
return F_130 ( & V_2 -> V_15 . V_18 , V_278 , V_276 ,
...
F_132 ( V_8 ) ;
F_52 ( & V_138 ) ;
V_282 = F_133 ( & V_139 , V_2 , 1 , 0 , V_283 ) ;
F_54 ( & V_138 ) ;
if ( V_280 )
F_134 () ;
if ( V_282 < 0 )
return V_282 ;
V_2 -> V_137 = ( V_284 ) V_282 ;
return 0 ;
}
...
void F_138 ( const struct V_1 * V_2 )
{
struct V_164 * V_288 ;
struct V_164 * V_286 ;
F_82 (ack, tmp, &asoc->asconf_ack_list,
transmitted_list) {
if ( V_288 -> V_225 . V_290 -> V_291 ==
F_95 ( V_2 -> V_69 . V_81 ) )
break;
F_107 ( & V_288 -> V_289 ) ;
F_136 ( V_288 ) ;
...
if ( V_288 -> V_225 . V_290 -> V_291 == V_291 ) {
F_140 ( V_288 ) ;
return V_288 ;
}
}
