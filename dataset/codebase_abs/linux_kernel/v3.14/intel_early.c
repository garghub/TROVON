...
static T_2 enum V_1
F_33 ( unsigned long V_58 , unsigned long V_76 ,
struct V_29 * V_29 ,
unsigned long * V_26 ,
struct V_5 * V_6 )
{
unsigned int V_60 = V_76 - V_58 + 1 ;
struct V_77 V_78 ;
long V_79 = 0 ;
#ifdef F_8
char * V_30 = ( char * ) F_6 ( V_80 ) ;
#else
char * V_30 = V_80 ;
#endif
V_78 . V_59 = NULL ;
V_78 . V_60 = 0 ;
V_78 = F_34 ( V_30 , ( void * ) V_58 , V_60 , & V_79 ) ;
if ( ! V_78 . V_59 )
return V_62 ;
return F_19 ( 0 , V_58 , V_78 . V_59 , V_78 . V_60 ,
V_29 , V_26 ,
V_6 ) ;
}
static void
...
if ( V_83 == NULL )
return;
F_35 ( V_6 , V_83 -> V_52 . V_72 ) ;
}
static int F_41 ( struct V_29 * V_29 ,
struct V_5 * V_6 )
{
struct V_2 * V_83 ;
unsigned int V_63 [ 2 ] ;
...
return 0 ;
F_24 ( V_86 ,
( unsigned long ) V_83 -> V_87 ,
( unsigned long ) V_83 -> V_87 >> 16 >> 16 ) ;
F_24 ( V_70 , 0 , 0 ) ;
F_25 () ;
F_23 ( V_70 , V_63 [ 0 ] , V_63 [ 1 ] ) ;
if ( V_63 [ 1 ] != V_83 -> V_52 . V_11 )
return - 1 ;
#ifdef F_42
F_39 () ;
#endif
