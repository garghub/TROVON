...
static int F_53 ( struct V_26 * V_11 )
{
struct V_9 * V_10 ;
struct V_67 * V_3 ;
int V_54 ;
V_10 = F_54 ( V_11 ) ;
V_3 = V_10 -> V_2 -> V_3 ;
if ( ( ( V_3 -> V_89 & 0xFFFF00 ) == ( V_106 << 8 ) ) &&
( ( V_3 -> V_89 & 0x0000FF ) != V_91 ) &&
( V_11 -> V_107 & V_108 ) ) {
F_18 ( & V_3 -> V_37 , L_9
L_10 ) ;
}
V_54 = F_55 ( V_3 , F_56 ( 32 ) ) ;
if ( V_54 )
return V_54 ;
F_57 ( V_3 ) ;
return 0 ;
}
static int F_58 ( struct V_26 * V_11 , int V_109 )
{
T_2 V_110 ;
V_110 = F_24 ( V_11 , V_111 ) ;
switch ( V_109 ) {
case V_112 :
V_110 |= V_113 ;
V_110 &= ~ V_114 ;
...
F_25 ( V_11 , V_110 , V_111 ) ;
return 0 ;
}
static void F_59 ( struct V_26 * V_11 )
{
struct V_9 * V_10 = F_54 ( V_11 ) ;
int V_116 = V_10 -> V_116 ;
if ( ! F_12 ( V_116 ) )
return;
F_60 ( V_116 , 0 ) ;
F_26 ( 10 ) ;
...
static int F_62 ( struct V_62 * V_37 )
{
struct V_67 * V_3 = F_63 ( V_37 ) ;
struct V_1 * V_2 ;
struct V_9 * V_10 ;
T_4 V_117 ;
T_4 V_118 = 0 ;
...
if ( V_54 )
goto V_119;
V_117 = V_10 -> V_11 -> V_21 -> V_118 ;
if ( V_117 & V_120 )
F_66 ( V_10 -> V_11 ) ;
V_118 |= V_117 ;
}
if ( V_2 -> V_121 && V_2 -> V_121 -> V_122 ) {
V_54 = V_2 -> V_121 -> V_122 ( V_2 ) ;
if ( V_54 )
goto V_119;
}
F_67 ( V_3 ) ;
...
V_119:
while ( -- V_87 >= 0 )
F_72 ( V_2 -> V_88 [ V_87 ] -> V_11 ) ;
return V_54 ;
}
static int F_73 ( struct V_62 * V_37 )
{
struct V_67 * V_3 = F_63 ( V_37 ) ;
struct V_1 * V_2 ;
struct V_9 * V_10 ;
...
if ( V_54 )
return V_54 ;
if ( V_2 -> V_121 && V_2 -> V_121 -> V_126 ) {
V_54 = V_2 -> V_121 -> V_126 ( V_2 ) ;
if ( V_54 )
return V_54 ;
}
for ( V_87 = 0 ; V_87 < V_2 -> V_23 ; V_87 ++ ) {
...
{
struct V_67 * V_3 = F_77 ( V_37 , struct V_67 , V_37 ) ;
struct V_1 * V_2 ;
struct V_9 * V_10 ;
int V_87 , V_54 ;
V_2 = F_64 ( V_3 ) ;
...
V_127:
while ( -- V_87 >= 0 )
F_79 ( V_2 -> V_88 [ V_87 ] -> V_11 ) ;
return V_54 ;
}
static int F_80 ( struct V_62 * V_37 )
{
struct V_67 * V_3 = F_77 ( V_37 , struct V_67 , V_37 ) ;
struct V_1 * V_2 ;
struct V_9 * V_10 ;
...
static struct V_9 * F_82 (
struct V_67 * V_3 , struct V_1 * V_2 , int V_128 ,
int V_129 )
{
struct V_9 * V_10 ;
struct V_26 * V_11 ;
int V_54 , V_130 = V_128 + V_129 ;
if ( ! ( F_83 ( V_3 , V_130 ) & V_131 ) ) {
F_40 ( & V_3 -> V_37 , L_11 , V_130 ) ;
return F_84 ( - V_50 ) ;
}
if ( F_85 ( V_3 , V_130 ) < 0x100 ) {
F_40 ( & V_3 -> V_37 , L_12
L_13 ) ;
}
...
V_11 = F_86 ( & V_3 -> V_37 , sizeof( struct V_9 ) ) ;
if ( F_87 ( V_11 ) ) {
F_40 ( & V_3 -> V_37 , L_16 ) ;
return F_88 ( V_11 ) ;
}
...
V_10 -> V_30 = - V_31 ;
if ( * V_133 )
V_10 -> V_134 = V_133 ( V_3 , V_129 ) ;
if ( V_10 -> V_134 ) {
if ( V_10 -> V_134 -> V_135 ) {
V_54 = V_10 -> V_134 -> V_135 ( V_10 -> V_134 ) ;
if ( V_54 ) {
F_40 ( & V_3 -> V_37 , L_17 ) ;
goto free;
}
}
V_10 -> V_116 = V_10 -> V_134 -> V_116 ;
V_10 -> V_30 = V_10 -> V_134 -> V_30 ;
}
V_11 -> V_136 = L_18 ;
V_11 -> V_137 = & V_138 ;
V_11 -> V_7 = V_2 -> V_7 ;
...
V_11 -> V_24 = V_3 -> V_24 ;
V_54 = F_89 ( V_3 , V_130 , F_90 ( V_11 -> V_21 ) ) ;
if ( V_54 ) {
F_40 ( & V_3 -> V_37 , L_19 ) ;
goto V_140;
}
V_11 -> V_72 = F_91 ( V_3 , V_130 ) ;
if ( ! V_11 -> V_72 ) {
F_40 ( & V_3 -> V_37 , L_20 ) ;
V_54 = - V_141 ;
goto V_142;
}
if ( V_2 -> V_121 && V_2 -> V_121 -> V_143 ) {
V_54 = V_2 -> V_121 -> V_143 ( V_10 ) ;
if ( V_54 )
goto V_144;
}
if ( F_12 ( V_10 -> V_116 ) ) {
if ( ! F_13 ( V_10 -> V_116 , L_21 ) ) {
F_92 ( V_10 -> V_116 , 1 ) ;
...
V_11 -> V_21 -> V_145 = V_123 | V_120 ;
V_11 -> V_21 -> V_129 = V_129 ;
V_11 -> V_21 -> V_39 |= V_146 ;
V_54 = F_93 ( V_11 ) ;
if ( V_54 )
goto remove;
F_11 ( V_10 ) ;
if ( V_2 -> V_121 && V_2 -> V_121 -> V_147 &&
! F_12 ( V_10 -> V_30 ) )
V_2 -> V_148 = false ;
return V_10 ;
remove:
if ( F_12 ( V_10 -> V_116 ) )
F_17 ( V_10 -> V_116 ) ;
if ( V_2 -> V_121 && V_2 -> V_121 -> V_149 )
V_2 -> V_121 -> V_149 ( V_10 , 0 ) ;
V_144:
F_94 ( V_11 -> V_72 ) ;
V_142:
F_95 ( V_3 , V_130 ) ;
V_140:
if ( V_10 -> V_134 && V_10 -> V_134 -> V_140 )
V_10 -> V_134 -> V_140 ( V_10 -> V_134 ) ;
free:
F_96 ( V_11 ) ;
return F_84 ( V_54 ) ;
}
...
F_19 ( V_10 ) ;
V_86 = 0 ;
V_53 = F_45 ( V_10 -> V_11 -> V_72 + V_150 ) ;
if ( V_53 == ( T_5 ) - 1 )
V_86 = 1 ;
F_98 ( V_10 -> V_11 , V_86 ) ;
if ( F_12 ( V_10 -> V_116 ) )
F_17 ( V_10 -> V_116 ) ;
if ( V_10 -> V_2 -> V_121 && V_10 -> V_2 -> V_121 -> V_149 )
V_10 -> V_2 -> V_121 -> V_149 ( V_10 , V_86 ) ;
if ( V_10 -> V_134 && V_10 -> V_134 -> V_140 )
V_10 -> V_134 -> V_140 ( V_10 -> V_134 ) ;
F_95 ( V_10 -> V_2 -> V_3 , V_10 -> V_132 ) ;
F_96 ( V_10 -> V_11 ) ;
}
static void F_99 ( struct V_62 * V_37 )
{
F_100 ( V_37 ) ;
F_101 ( V_37 ) ;
F_102 ( V_37 , 50 ) ;
...
static void F_105 ( struct V_62 * V_37 )
{
F_106 ( V_37 ) ;
F_107 ( V_37 ) ;
}
static int F_108 ( struct V_67 * V_3 ,
...
F_109 ( V_152 == NULL ) ;
F_39 ( & V_3 -> V_37 , L_23 ,
( int ) V_3 -> V_153 , ( int ) V_3 -> V_62 , ( int ) V_3 -> V_56 ) ;
V_54 = F_33 ( V_3 , V_154 , & V_88 ) ;
if ( V_54 )
return V_54 ;
V_88 = F_110 ( V_88 ) + 1 ;
F_111 ( & V_3 -> V_37 , L_24 , V_88 ) ;
if ( V_88 == 0 )
return - V_50 ;
F_109 ( V_88 > V_155 ) ;
V_54 = F_33 ( V_3 , V_154 , & V_128 ) ;
if ( V_54 )
return V_54 ;
V_128 &= V_156 ;
if ( V_128 > 5 ) {
...
if ( V_54 )
return V_54 ;
V_2 = F_112 ( sizeof( struct V_1 ) , V_157 ) ;
if ( ! V_2 ) {
V_54 = - V_141 ;
goto V_28;
}
V_2 -> V_3 = V_3 ;
V_2 -> V_121 = ( const struct V_158 * ) V_152 -> V_159 ;
if ( V_2 -> V_121 ) {
V_2 -> V_7 = V_2 -> V_121 -> V_7 ;
V_2 -> V_139 = V_2 -> V_121 -> V_139 ;
V_2 -> V_148 = V_2 -> V_121 -> V_148 ;
}
V_2 -> V_23 = V_88 ;
F_113 ( V_3 , V_2 ) ;
if ( V_2 -> V_121 && V_2 -> V_121 -> V_160 ) {
V_54 = V_2 -> V_121 -> V_160 ( V_2 ) ;
if ( V_54 )
goto free;
}
V_88 = V_2 -> V_23 ;
for ( V_87 = 0 ; V_87 < V_88 ; V_87 ++ ) {
V_10 = F_82 ( V_3 , V_2 , V_128 , V_87 ) ;
if ( F_87 ( V_10 ) ) {
...
static void F_116 ( struct V_67 * V_3 )
{
int V_87 ;
struct V_1 * V_2 ;
V_2 = F_64 ( V_3 ) ;
