...
static int F_65 ( struct V_1 * V_2 , struct V_61 * V_89 )
{
V_89 -> V_90 = NULL ;
F_2 ( L_18 , V_2 , V_89 ) ;
return 0 ;
...
if ( V_4 -> V_91 ) {
for ( V_16 = 0 ; V_16 < V_4 -> V_17 ; V_16 ++ ) {
F_67 ( & V_4 -> V_20 [ V_16 ] -> V_92 ,
V_4 -> V_91 , 0 ) ;
}
for ( V_16 = 0 ; V_16 < V_4 -> V_47 ; V_16 ++ ) {
F_67 ( & V_4 -> V_46 [ V_16 ] -> V_92 ,
V_4 -> V_91 , 0 ) ;
}
}
F_68 ( V_2 ) ;
...
static int F_73 ( struct V_93 * V_94 , T_1 V_95 )
{
F_2 ( L_23 ) ;
return 0 ;
}
static int F_74 ( struct V_93 * V_96 )
{
F_2 ( L_23 ) ;
return 0 ;
}
static void F_75 ( struct V_93 * V_96 )
{
F_2 ( L_23 ) ;
}
static int F_76 ( struct V_93 * V_96 )
{
int V_23 ;
if ( F_77 () == false )
return - V_26 ;
...
F_2 ( L_24 , V_96 -> V_28 ) ;
return F_80 ( & V_97 , V_96 ) ;
}
static int F_81 ( struct V_93 * V_96 )
{
F_2 ( L_23 ) ;
F_7 () ;
F_79 () ;
