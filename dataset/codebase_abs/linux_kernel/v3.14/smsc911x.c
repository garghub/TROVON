...
F_157 ( V_29 ) ;
V_29 -> V_5 |= V_318 ;
F_158 ( V_29 , & V_2 -> V_185 , F_81 , V_319 ) ;
V_29 -> V_320 = & V_321 ;
V_29 -> V_322 = & V_323 ;
return 0 ;
}
...
F_76 ( V_2 -> V_40 ) ;
F_161 ( V_29 ) ;
F_162 ( V_29 -> V_136 , V_29 ) ;
V_325 = F_163 ( V_22 , V_326 ,
L_105 ) ;
if ( ! V_325 )
V_325 = F_164 ( V_22 , V_326 , 0 ) ;
F_165 ( V_325 -> V_327 , F_166 ( V_325 ) ) ;
F_167 ( V_2 -> V_7 ) ;
( void ) F_30 ( V_22 ) ;
F_38 ( V_22 ) ;
F_168 ( V_29 ) ;
...
static int F_169 ( struct V_328 * V_4 ,
struct V_329 * V_330 )
{
const char * V_331 ;
T_1 V_332 = 0 ;
if ( ! V_330 )
return - V_130 ;
V_4 -> V_133 = F_170 ( V_330 ) ;
V_331 = F_171 ( V_330 ) ;
if ( V_331 )
memcpy ( V_4 -> V_331 , V_331 , V_92 ) ;
F_172 ( V_330 , L_106 , & V_4 -> V_333 ) ;
F_172 ( V_330 , L_107 , & V_332 ) ;
if ( V_332 == 4 )
V_4 -> V_5 |= V_6 ;
else
V_4 -> V_5 |= V_8 ;
if ( F_173 ( V_330 , L_108 , NULL ) )
V_4 -> V_226 = V_334 ;
if ( F_173 ( V_330 , L_109 , NULL ) )
V_4 -> V_228 = V_335 ;
if ( F_173 ( V_330 , L_110 , NULL ) )
V_4 -> V_5 |= V_58 ;
if ( F_173 ( V_330 , L_111 , NULL ) )
V_4 -> V_5 |= V_60 ;
if ( F_173 ( V_330 , L_112 , NULL ) )
V_4 -> V_5 |= V_317 ;
return 0 ;
}
static inline int F_169 (
struct V_328 * V_4 ,
struct V_329 * V_330 )
{
return - V_130 ;
...
struct V_23 * V_29 ;
struct V_1 * V_2 ;
struct V_328 * V_4 = F_175 ( & V_22 -> V_29 ) ;
...
V_338 = F_166 ( V_325 ) ;
V_337 = F_164 ( V_22 , V_342 , 0 ) ;
if ( ! V_337 ) {
F_177 ( L_115 ) ;
V_340 = - V_130 ;
goto V_341;
}
if ( ! F_178 ( V_325 -> V_327 , V_338 , V_287 ) ) {
V_340 = - V_274 ;
goto V_341;
}
V_29 = F_179 ( sizeof( struct V_1 ) ) ;
if ( ! V_29 ) {
V_340 = - V_144 ;
goto V_343;
}
F_180 ( V_29 , & V_22 -> V_29 ) ;
V_2 = F_24 ( V_29 ) ;
V_29 -> V_136 = V_337 -> V_327 ;
V_339 = V_337 -> V_5 & V_344 ;
V_2 -> V_7 = F_181 ( V_325 -> V_327 , V_338 ) ;
V_2 -> V_29 = V_29 ;
V_2 -> V_291 = ( ( 1 << V_345 ) - 1 ) ;
F_182 ( V_22 , V_29 ) ;
V_340 = F_33 ( V_22 ) ;
...
static int F_187 ( struct V_354 * V_29 )
{
