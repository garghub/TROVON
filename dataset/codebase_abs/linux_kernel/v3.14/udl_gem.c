...
static int F_16 ( struct V_1 * V_5 , T_5 V_40 )
{
struct V_29 * * V_34 ;
if ( V_5 -> V_34 )
return 0 ;
V_34 = F_17 ( & V_5 -> V_7 , V_40 ) ;
if ( F_18 ( V_34 ) )
return F_19 ( V_34 ) ;
V_5 -> V_34 = V_34 ;
return 0 ;
...
F_22 ( & V_5 -> V_7 , V_5 -> V_34 , false , false ) ;
V_5 -> V_34 = NULL ;
}
int F_23 ( struct V_1 * V_5 )
{
int V_42 = V_5 -> V_7 . V_4 / V_13 ;
int V_11 ;
if ( V_5 -> V_7 . V_41 ) {
V_5 -> V_43 = F_24 ( V_5 -> V_7 . V_41 -> V_44 ) ;
if ( ! V_5 -> V_43 )
return - V_14 ;
return 0 ;
}
...
if ( V_11 )
return V_11 ;
V_5 -> V_43 = F_25 ( V_5 -> V_34 , V_42 , 0 , V_45 ) ;
if ( ! V_5 -> V_43 )
return - V_14 ;
return 0 ;
}
...
{
if ( V_5 -> V_7 . V_41 ) {
F_27 ( V_5 -> V_7 . V_41 -> V_44 , V_5 -> V_43 ) ;
return;
}
if ( V_5 -> V_43 )
F_28 ( V_5 -> V_43 ) ;
...
struct V_46 * F_43 ( struct V_2 * V_3 ,
struct V_59 * V_59 )
{
struct V_60 * V_61 ;
struct V_56 * V_48 ;
