...
V_87 . V_16 = V_118 ;
V_87 . V_119 . V_11 = V_91 ;
V_28 = F_3 ( V_9 , ( V_18 * ) & V_87 ) ;
if ( ( V_28 != 0 ) ||
( V_87 . V_117 . V_11 != V_120 ) ) {
break;
}
V_92 [ 0 ] = V_121 ;
...
V_89 = F_19 ( V_20 ,
F_20 ( V_20 ,
F_21 ( V_87 . V_122 . V_11 ) ) ,
( const V_18 * ) & ( V_87 . V_102 . V_11 . V_11 ) ,
V_87 . V_123 . V_11 , V_87 . V_124 . V_11 ,
V_87 . V_125 . V_11 ,
V_92 ,
V_93 ,
...
static int F_24 ( struct V_20 * V_20 , T_2 V_128 )
{
struct V_82 * V_83 = F_15 ( V_20 ) ;
T_1 * V_9 = V_83 -> V_9 ;
T_2 V_11 ;
...
int V_142 = - 1 ;
int V_143 = ( V_136 -> V_144 . V_145 == V_43 ) ||
( V_136 -> V_144 . V_145 == V_44 ) ;
int V_28 ;
int V_2 = 0 ;
if ( V_138 ) {
V_142 = F_18 ( V_138 -> V_114 ) ;
V_28 = F_2 ( V_9 ,
V_146 ,
V_142 ) ;
if ( V_28 )
...
static int F_29 ( struct V_20 * V_20 , struct V_161 * V_94 ,
enum V_162 type , int V_163 )
{
struct V_82 * V_83 = F_15 ( V_20 ) ;
T_1 * V_9 = V_83 -> V_9 ;
T_2 V_11 ;
...
static int F_31 ( struct V_20 * V_20 , struct V_161 * V_94 ,
int * V_68 )
{
struct V_82 * V_83 = F_15 ( V_20 ) ;
T_1 * V_9 = V_83 -> V_9 ;
...
void F_32 ( T_1 * V_9 , V_18 V_168 )
{
T_5 V_70 = V_168 ?
V_169 : V_170 ;
F_33 ( V_9 -> V_95 , V_9 -> V_102 ,
NULL , 0 , NULL , 0 , V_70 , V_126 ) ;
}
void F_34 ( T_1 * V_9 )
{
...
struct V_20 * F_38 ( struct V_171 * V_22 , T_1 * V_9 )
{
struct V_20 * V_20 ;
struct V_82 * V_83 ;
V_20 = F_39 ( & V_172 , sizeof( * V_83 ) ) ;
if ( ! V_20 )
return NULL ;
V_83 = F_15 ( V_20 ) ;
V_83 -> V_9 = V_9 ;
memcpy ( V_83 -> V_113 , V_111 , sizeof( V_111 ) ) ;
memcpy ( V_83 -> V_173 , V_174 , sizeof( V_174 ) ) ;
V_83 -> V_175 . V_113 = V_83 -> V_113 ;
V_83 -> V_175 . V_110 = F_17 ( V_111 ) ;
V_83 -> V_175 . V_176 = V_83 -> V_173 ;
V_83 -> V_175 . V_177 = F_17 ( V_174 ) ;
V_83 -> V_175 . V_175 = V_178 ;
V_83 -> V_175 . V_179 . V_180 = false ;
V_20 -> V_181 [ V_178 ] = & V_83 -> V_175 ;
F_40 ( V_20 , V_22 ) ;
V_20 -> V_182 = V_183 ;
V_20 -> V_184 = 1 ;
V_20 -> V_185 = F_41 ( V_32 )
| F_41 ( V_29 ) ;
V_20 -> V_186 = V_187 ;
V_20 -> V_188 = V_189 ;
V_20 -> V_190 = V_191 ;
