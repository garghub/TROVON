...
static struct V_111 * F_68 ( struct V_30 * V_17 , struct V_231 * V_232 )
{
struct V_111 * V_7 ;
struct V_6 * V_233 ;
int V_184 ;
...
V_7 -> V_234 = V_232 ;
V_7 -> V_14 = V_235 ;
V_7 -> V_203 = V_233 -> V_203 ;
F_70 ( & V_233 -> V_185 ) ;
V_184 = F_71 ( & V_7 -> V_236 , 16 , 0 ) ;
if ( V_184 < 0 ) {
F_72 ( V_7 ) ;
return NULL ;
}
...
struct V_237 * V_238 = F_74 ( V_17 ) ;
const char * V_239 = V_238 -> V_239 ;
unsigned int V_240 ;
struct V_111 * V_7 ;
struct V_6 * V_233 ;
const struct V_241 * V_148 ;
int V_184 , V_242 ;
if ( V_238 -> V_89 >= F_75 ( V_88 ) ) {
F_11 ( V_17 , L_36 ,
V_238 -> V_89 ) ;
return - V_33 ;
}
...
if ( ! F_76 ( & V_7 -> V_115 , V_7 , V_244 , V_148 ,
V_242 , NULL , V_188 ) ) {
V_184 = - V_227 ;
goto V_245;
}
F_77 ( V_148 , V_242 , & V_7 -> V_247 ) ;
...
struct V_13 * V_29 ;
struct V_251 V_252 ;
V_255 = F_85 ( V_221 , V_257 , 0 ) ;
if ( ! V_255 )
return - V_33 ;
V_2 = F_86 ( sizeof( * V_2 ) , V_226 ) ;
if ( ! V_2 )
return - V_156 ;
F_87 ( & V_2 -> V_27 ) ;
V_2 -> V_4 = F_88 ( V_255 -> V_258 , F_89 ( V_255 ) ) ;
if ( ! V_2 -> V_4 ) {
V_184 = - V_156 ;
goto V_259;
}
F_90 ( L_39 , V_255 , V_2 -> V_4 ) ;
F_91 () ;
V_2 -> V_17 = V_17 ;
F_92 ( V_221 , V_2 ) ;
V_252 . V_2 = V_2 ;
