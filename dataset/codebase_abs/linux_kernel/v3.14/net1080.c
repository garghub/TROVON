...
static inline void F_13 ( struct V_1 * V_2 , T_2 V_38 )
{
F_9 ( V_2 , V_14 , V_2 -> V_15 , L_14 ,
V_2 -> V_16 -> V_17 -> V_18 , V_2 -> V_16 -> V_19 ,
V_38 , F_14 ( V_38 ) , F_15 ( V_38 ) ) ;
}
...
F_17 ( V_2 -> V_15 , L_17 , V_40 ) ;
goto V_42;
}
V_38 = V_39 ;
F_7 ( V_2 , V_44 ,
F_18 ( V_45 , F_15 ( V_38 ) ) ) ;
F_17 ( V_2 -> V_15 , L_18 , V_45 ) ;
F_19 ( V_2 , V_14 , V_2 -> V_15 , L_19 ,
( V_6 & V_30 ) ? 'A' : 'B' ,
( V_6 & V_34 ) ? L_3 : L_20 ) ;
V_40 = 0 ;
V_42:
...
static int F_23 ( struct V_1 * V_2 , struct V_49 * V_50 )
{
struct V_51 * V_52 ;
struct V_53 * V_54 ;
T_2 V_55 , V_56 ;
...
if ( F_25 ( V_56 ) > V_64 ) {
V_2 -> V_15 -> V_61 . V_62 ++ ;
F_17 ( V_2 -> V_15 , L_24 , V_56 ) ;
F_21 ( V_2 ) ;
return 0 ;
} else if ( V_55 < V_65 ) {
V_2 -> V_15 -> V_61 . V_62 ++ ;
F_17 ( V_2 -> V_15 , L_25 , V_55 ) ;
F_21 ( V_2 ) ;
return 0 ;
} else if ( V_55 > V_65 ) {
F_17 ( V_2 -> V_15 , L_26 , V_55 - V_65 ) ;
F_21 ( V_2 ) ;
}
F_26 ( V_50 , V_55 ) ;
V_54 = (struct V_53 * )
( V_50 -> V_63 + V_50 -> V_57 - sizeof *V_54 ) ;
F_27 ( V_50 , V_50 -> V_57 - sizeof *V_54 ) ;
if ( ( V_56 & 0x01 ) == 0 ) {
...
static struct V_49 *
F_30 ( struct V_1 * V_2 , struct V_49 * V_50 , T_3 V_69 )
{
struct V_49 * V_70 ;
...
V_50 = V_70 ;
V_74:
V_52 = (struct V_51 * ) F_37 ( V_50 , sizeof *V_52 ) ;
V_52 -> V_55 = F_38 ( sizeof ( * V_52 ) ) ;
V_52 -> V_56 = F_38 ( V_57 ) ;
V_52 -> V_67 = F_38 ( ( T_2 ) V_2 -> V_76 ++ ) ;
if ( ! ( ( V_50 -> V_57 + sizeof *V_54 ) & 0x01 ) )
* F_39 ( V_50 , 1 ) = V_66 ;
V_54 = (struct V_53 * ) F_39 ( V_50 , sizeof *V_54 ) ;
F_40 ( V_52 -> V_67 , & V_54 -> V_67 ) ;
#if 0
...
static int F_41 ( struct V_1 * V_2 , struct V_77 * V_78 )
{
