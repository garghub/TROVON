...
V_100 += V_98 ;
#ifdef F_67
if ( F_68 ( V_110 -> V_172 . V_173 ) ) {
struct V_177 * V_178 ;
T_1 V_179 , V_180 , V_181 ;
unsigned V_182 = 256 / 4 ;
V_178 = F_69 ( F_70 ( V_2 ) -> V_172 . V_173 ) ;
V_179 = F_71 ( F_2 ( V_2 ,
& V_2 -> V_5 -> V_12 ) ) ;
while ( V_179 && V_182 -- ) {
F_72 ( V_178 , V_179 , & V_180 ) ;
switch ( V_180 & 0xff ) {
case 1 :
V_98 = F_29 ( V_100 , V_99 ,
L_108 , V_180 ,
( V_180 & ( 1 << 24 ) ) ? L_109 : L_3 ,
( V_180 & ( 1 << 16 ) ) ? L_110 : L_3 ) ;
V_99 -= V_98 ;
V_100 += V_98 ;
V_179 += 4 ;
F_72 ( V_178 , V_179 , & V_181 ) ;
V_98 = F_29 ( V_100 , V_99 ,
L_111 , V_181 ) ;
V_99 -= V_98 ;
V_100 += V_98 ;
...
F_2 ( V_2 ,
& V_2 -> V_183 -> V_185 [ V_7 - 1 ] ) ) ;
V_98 = F_29 ( V_100 , V_99 , V_171 , V_98 , V_93 ) ;
V_99 -= V_98 ;
V_100 += V_98 ;
if ( V_7 == F_4 ( V_2 -> V_6 ) && V_2 -> V_186 ) {
V_98 = F_29 ( V_100 , V_99 ,
L_115 ,
F_2 ( V_2 ,
& V_2 -> V_186 -> V_187 ) ) ;
...
V_98 = F_29 ( V_100 , V_99 ,
L_117 ,
V_2 -> V_189 . V_190 , V_2 -> V_189 . error , V_2 -> V_189 . V_191 ,
V_2 -> V_189 . V_192 ) ;
V_99 -= V_98 ;
V_100 += V_98 ;
V_98 = F_29 ( V_100 , V_99 , L_118 ,
V_2 -> V_189 . V_193 , V_2 -> V_189 . V_194 ) ;
V_99 -= V_98 ;
V_100 += V_98 ;
#endif
V_107:
...
static struct V_108 * F_76 ( struct V_195 * V_86 ,
T_6 (* F_77)( struct V_108 * ) )
{
struct V_108 * V_8 ;
V_8 = F_78 ( sizeof( struct V_108 ) , V_196 ) ;
if ( V_8 ) {
V_8 -> V_86 = V_86 ;
V_8 -> F_77 = F_77 ;
F_79 ( & V_8 -> V_197 ) ;
...
static int F_80 ( struct V_108 * V_8 )
{
int V_199 = 0 ;
if ( ! V_8 -> V_112 )
V_8 -> V_112 = F_81 ( V_8 -> V_113 ) ;
if ( ! V_8 -> V_112 ) {
V_199 = - V_200 ;
goto V_201;
}
...
static T_6 F_82 ( struct V_202 * V_202 , char T_9 * V_203 ,
T_10 V_39 , T_11 * V_179 )
{
struct V_108 * V_8 = V_202 -> V_204 ;
int V_199 = 0 ;
F_83 ( & V_8 -> V_197 ) ;
if ( V_8 -> V_182 == 0 ) {
V_199 = F_80 ( V_8 ) ;
...
F_84 ( & V_8 -> V_197 ) ;
V_199 = F_85 ( V_203 , V_39 , V_179 ,
V_8 -> V_112 , V_8 -> V_182 ) ;
V_201:
return V_199 ;
}
static int F_86 ( struct V_205 * V_205 , struct V_202 * V_202 )
{
struct V_108 * V_8 = V_202 -> V_204 ;
if ( V_8 ) {
F_87 ( V_8 -> V_112 ) ;
...
static int F_88 ( struct V_205 * V_205 , struct V_202 * V_202 )
{
V_202 -> V_204 = F_76 ( V_205 -> V_206 , F_46 ) ;
return V_202 -> V_204 ? 0 : - V_200 ;
}
static int F_89 ( struct V_205 * V_205 , struct V_202 * V_202 )
{
V_202 -> V_204 = F_76 ( V_205 -> V_206 ,
F_53 ) ;
return V_202 -> V_204 ? 0 : - V_200 ;
}
static int F_90 ( struct V_205 * V_205 , struct V_202 * V_202 )
{
struct V_108 * V_8 ;
V_8 = F_76 ( V_205 -> V_206 , F_58 ) ;
if ( ! V_8 )
return - V_200 ;
V_8 -> V_113 = ( sizeof( void * ) == 4 ? 6 : 8 ) * V_198 ;
V_202 -> V_204 = V_8 ;
return 0 ;
}
static int F_91 ( struct V_205 * V_205 , struct V_202 * V_202 )
{
V_202 -> V_204 = F_76 ( V_205 -> V_206 ,
F_64 ) ;
return V_202 -> V_204 ? 0 : - V_200 ;
...
{
struct V_195 * V_86 = & F_70 ( V_2 ) -> V_172 ;
V_2 -> V_207 = F_92 ( V_86 -> V_208 , V_209 ) ;
if ( ! V_2 -> V_207 )
return;
if ( ! F_93 ( L_119 , V_210 , V_2 -> V_207 , V_86 ,
& V_211 ) )
goto V_212;
if ( ! F_93 ( L_120 , V_210 , V_2 -> V_207 , V_86 ,
& V_213 ) )
goto V_212;
if ( ! F_93 ( L_121 , V_210 , V_2 -> V_207 , V_86 ,
& V_214 ) )
goto V_212;
if ( ! F_93 ( L_122 , V_210 , V_2 -> V_207 , V_86 ,
& V_215 ) )
goto V_212;
return;
V_212:
