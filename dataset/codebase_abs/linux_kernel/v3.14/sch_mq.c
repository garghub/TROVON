...
static struct V_12 * F_22 ( struct V_1 * V_2 , unsigned long V_41 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
...
struct V_42 * V_43 )
{
unsigned int V_7 = F_13 ( V_43 -> V_44 ) ;
...
static int F_24 ( struct V_1 * V_2 , unsigned long V_41 , struct V_1 * V_45 ,
struct V_1 * * V_26 )
{
struct V_12 * V_13 = F_22 ( V_2 , V_41 ) ;
struct V_3 * V_4 = F_2 ( V_2 ) ;
if ( V_4 -> V_23 & V_46 )
F_25 ( V_4 ) ;
* V_26 = F_15 ( V_13 , V_45 ) ;
...
static struct V_1 * F_27 ( struct V_1 * V_2 , unsigned long V_41 )
{
struct V_12 * V_13 = F_22 ( V_2 , V_41 ) ;
return V_13 -> V_34 ;
}
static unsigned long F_28 ( struct V_1 * V_2 , T_1 V_47 )
{
unsigned int V_7 = F_13 ( V_47 ) ;
if ( ! F_22 ( V_2 , V_7 ) )
return 0 ;
return V_7 ;
}
static void F_29 ( struct V_1 * V_2 , unsigned long V_41 )
{
}
...
struct V_12 * V_13 = F_22 ( V_2 , V_41 ) ;
V_2 = V_13 -> V_34 ;
V_2 -> V_33 . V_31 = V_2 -> V_30 . V_31 ;
if ( F_32 ( V_51 , & V_2 -> V_32 ) < 0 ||
F_33 ( V_51 , & V_2 -> V_33 ) < 0 )
return - 1 ;
return 0 ;
}
