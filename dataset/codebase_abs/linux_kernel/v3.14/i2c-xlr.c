...
if ( F_17 ( V_5 -> V_19 ) )
return F_18 ( V_5 -> V_19 ) ;
V_5 -> V_10 . V_38 . V_62 = & V_56 -> V_38 ;
V_5 -> V_10 . V_63 = V_64 ;
V_5 -> V_10 . V_65 = V_5 ;
V_5 -> V_10 . V_66 = & V_67 ;
V_5 -> V_10 . V_68 = V_56 -> V_69 ;
V_5 -> V_10 . V_70 = V_71 ;
snprintf ( V_5 -> V_10 . V_72 , sizeof( V_5 -> V_10 . V_72 ) , L_3 ) ;
F_19 ( & V_5 -> V_10 , V_5 ) ;
V_50 = F_20 ( & V_5 -> V_10 ) ;
if ( V_50 < 0 ) {
F_8 ( & V_5 -> V_10 . V_38 , L_4 ) ;
return V_50 ;
}
F_21 ( V_56 , V_5 ) ;
F_22 ( & V_5 -> V_10 . V_38 , L_5 ) ;
return 0 ;
}
