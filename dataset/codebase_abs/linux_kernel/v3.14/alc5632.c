...
struct V_52 * V_53 = F_11 ( V_19 ) ;
int V_121 ;
V_19 -> V_122 = V_53 -> V_12 ;
V_121 = F_25 ( V_19 , 8 , 16 , V_123 ) ;
if ( V_121 != 0 ) {
F_26 ( V_19 -> V_2 , L_1 , V_121 ) ;
return V_121 ;
}
F_20 ( V_19 , V_110 ) ;
switch ( V_53 -> V_124 ) {
...
static int F_29 ( struct V_126 * V_127 ,
const struct V_128 * V_124 )
{
struct V_52 * V_53 ;
int V_121 , V_129 , V_130 ;
unsigned int V_131 , V_132 ;
V_53 = F_30 ( & V_127 -> V_2 ,
sizeof( struct V_52 ) , V_133 ) ;
if ( V_53 == NULL )
return - V_134 ;
F_31 ( V_127 , V_53 ) ;
V_53 -> V_12 = F_32 ( V_127 , & V_135 ) ;
if ( F_33 ( V_53 -> V_12 ) ) {
V_121 = F_34 ( V_53 -> V_12 ) ;
F_26 ( & V_127 -> V_2 , L_2 , V_121 ) ;
return V_121 ;
}
V_129 = F_35 ( V_53 -> V_12 , V_10 , & V_131 ) ;
V_130 = F_35 ( V_53 -> V_12 , V_11 , & V_132 ) ;
if ( V_129 != 0 || V_130 != 0 ) {
F_26 ( & V_127 -> V_2 ,
L_3 , V_129 , V_130 ) ;
return - V_136 ;
...
V_132 >>= 8 ;
if ( ( V_131 != 0x10EC ) || ( V_132 != V_124 -> V_137 ) ) {
F_26 ( & V_127 -> V_2 ,
L_4 , V_131 , V_132 ) ;
return - V_35 ;
}
...
V_121 = F_36 ( & V_127 -> V_2 ,
& V_140 , & V_138 , 1 ) ;
if ( V_121 < 0 ) {
F_26 ( & V_127 -> V_2 , L_7 , V_121 ) ;
return V_121 ;
}
return V_121 ;
}
