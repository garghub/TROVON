...
static T_5 *
F_133 ( struct V_98 * V_233 , struct V_154 * V_234 )
{
T_5 * V_88 ;
T_3 V_235 ;
V_88 = V_234 -> V_217 ;
...
{
struct V_154 * V_234 = (struct V_154 * ) V_91 -> V_156 ;
struct V_93 * V_94 = & V_234 -> V_157 ;
struct V_98 * V_233 = & V_91 -> V_116 ;
struct V_98 V_141 ;
struct V_1 V_122 ;
struct V_81 * V_87 ;
T_5 * V_88 ;
int V_237 , V_140 ;
int V_133 = - V_39 ;
V_88 = F_133 ( V_233 , V_234 ) ;
if ( V_88 == NULL )
goto V_40;
V_237 = ( T_4 * ) ( V_88 + 1 ) - ( T_4 * ) V_233 -> V_103 [ 0 ] . V_86 ;
V_140 = V_233 -> V_4 - V_237 ;
F_14 ( V_140 % 4 ) ;
* V_88 ++ = F_72 ( V_140 ) ;
* V_88 ++ = F_72 ( V_94 -> V_112 ) ;
if ( F_87 ( V_233 , & V_141 , V_237 , V_140 ) )
F_88 () ;
if ( V_233 -> V_144 [ 0 ] . V_86 == NULL ) {
if ( V_233 -> V_103 [ 0 ] . V_85 + V_142 > V_89 )
goto V_238;
V_233 -> V_144 [ 0 ] . V_86 = V_233 -> V_103 [ 0 ] . V_86
+ V_233 -> V_103 [ 0 ] . V_85 ;
V_233 -> V_144 [ 0 ] . V_85 = 0 ;
}
V_87 = & V_233 -> V_144 [ 0 ] ;
V_122 . V_5 = ( T_4 * ) V_87 -> V_86 + V_87 -> V_85 + 4 ;
if ( F_73 ( V_234 -> V_47 -> V_49 , & V_141 , & V_122 ) )
goto V_238;
F_64 ( V_87 , V_122 . V_4 ) ;
memset ( V_122 . V_5 + V_122 . V_4 , 0 ,
F_60 ( V_122 . V_4 ) - V_122 . V_4 ) ;
V_87 -> V_85 += F_74 ( V_122 . V_4 ) << 2 ;
V_233 -> V_4 += F_74 ( V_122 . V_4 ) << 2 ;
F_14 ( V_87 -> V_85 > V_89 ) ;
V_40:
V_133 = 0 ;
V_238:
...
return 0 ;
V_4 = V_88 ++ ;
V_149 = ( T_4 * ) V_88 - ( T_4 * ) V_233 -> V_103 [ 0 ] . V_86 ;
* V_88 ++ = F_72 ( V_94 -> V_112 ) ;
V_240 = V_233 -> V_171 ;
if ( V_233 -> V_144 [ 0 ] . V_86 ) {
F_14 ( V_233 -> V_144 [ 0 ] . V_86 >= V_233 -> V_103 [ 0 ] . V_86
+ V_89 ) ;
F_14 ( V_233 -> V_144 [ 0 ] . V_86 < V_233 -> V_103 [ 0 ] . V_86 ) ;
if ( V_233 -> V_144 [ 0 ] . V_85 + V_233 -> V_103 [ 0 ] . V_85
+ 2 * V_142 > V_89 )
return - V_22 ;
memmove ( V_233 -> V_144 [ 0 ] . V_86 + V_142 ,
V_233 -> V_144 [ 0 ] . V_86 ,
V_233 -> V_144 [ 0 ] . V_85 ) ;
V_233 -> V_144 [ 0 ] . V_86 += V_142 ;
}
if ( V_233 -> V_144 [ 0 ] . V_86 == NULL ) {
if ( V_233 -> V_103 [ 0 ] . V_85 + 2 * V_142 > V_89 )
return - V_22 ;
V_233 -> V_144 [ 0 ] . V_86 = V_233 -> V_103 [ 0 ] . V_86
+ V_233 -> V_103 [ 0 ] . V_85 + V_142 ;
V_233 -> V_144 [ 0 ] . V_85 = 0 ;
}
if ( F_136 ( V_234 -> V_47 -> V_49 , V_149 , V_233 , V_240 ) )
return - V_22 ;
* V_4 = F_72 ( V_233 -> V_4 - V_149 ) ;
V_145 = 3 - ( ( V_233 -> V_4 - V_149 - 1 ) & 3 ) ;
V_88 = ( T_5 * ) ( V_233 -> V_144 [ 0 ] . V_86 + V_233 -> V_144 [ 0 ] . V_85 ) ;
memset ( V_88 , 0 , V_145 ) ;
V_233 -> V_144 [ 0 ] . V_85 += V_145 ;
V_233 -> V_4 += V_145 ;
return 0 ;
}
static int
...
if ( V_234 -> V_47 )
F_25 ( & V_234 -> V_47 -> V_14 , V_181 -> V_187 ) ;
V_234 -> V_47 = NULL ;
return V_133 ;
}
static void
...
struct V_28 * V_29 ;
int V_242 ;
V_29 = F_141 ( & V_243 , V_198 ) ;
if ( F_142 ( V_29 ) )
return F_143 ( V_29 ) ;
V_242 = F_144 ( V_29 , V_198 ) ;
if ( V_242 ) {
F_145 ( V_29 , V_198 ) ;
return V_242 ;
}
