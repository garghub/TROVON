...
F_93 ( F_94 ( V_91 ) < 0 ) ;
V_127 = F_95 ( V_91 -> V_89 *
sizeof( V_127 [ 0 ] ) , 0 ) ;
V_128 = F_95 ( V_91 -> V_89 *
sizeof( V_128 [ 0 ] ) , 0 ) ;
V_130 = F_95 ( V_134 * sizeof( V_130 [ 0 ] ) , 0 ) ;
V_129 = F_95 ( V_134 * sizeof( V_129 [ 0 ] ) , 0 ) ;
...
V_169 = F_117 ( V_184 , & V_180 [ V_94 * V_178 ] ,
V_178 ) ;
if ( V_169 < 0 )
F_118 ( L_27 , V_169 ) ;
memcpy ( ( void * ) V_184 , V_172 , V_91 -> V_77 ) ;
}
F_54 ( L_28 ,
V_178 , V_177 , V_176 . V_1 , V_91 -> V_77 ,
V_91 -> V_112 , V_91 -> V_113 ) ;
V_169 = F_91 ( V_91 , V_176 . V_1 ) ;
goto V_185;
V_182:
while ( -- V_181 >= 0 )
V_164 ( F_119 ( V_180 [ V_181 ] ) , V_28 ) ;
V_169 = - V_45 ;
V_185:
