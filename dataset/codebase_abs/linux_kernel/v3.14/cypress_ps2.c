...
static int F_32 ( unsigned char V_109 )
{
unsigned char V_110 ;
int V_111 ;
V_110 = V_109 >> 6 ;
...
static void F_34 ( struct V_1 * V_1 , bool V_127 )
{
int V_31 ;
...
F_35 ( V_79 , V_133 , V_132 , V_2 ) ;
for ( V_31 = 0 ; V_31 < V_2 ; V_31 ++ ) {
V_130 = & V_114 . V_118 [ V_31 ] ;
F_36 ( V_79 , V_133 [ V_31 ] ) ;
F_37 ( V_79 , V_134 , true ) ;
F_38 ( V_79 , V_86 , V_130 -> V_119 ) ;
F_38 ( V_79 , V_87 , V_130 -> V_120 ) ;
F_38 ( V_79 , V_88 , V_130 -> V_121 ) ;
}
F_39 ( V_79 ) ;
F_40 ( V_79 , V_114 . V_115 ) ;
F_41 ( V_79 , V_106 , V_114 . V_122 ) ;
F_41 ( V_79 , V_107 , V_114 . V_124 ) ;
F_41 ( V_79 , V_108 , V_114 . V_126 ) ;
F_42 ( V_79 ) ;
}
...
static void F_45 ( struct V_1 * V_1 , unsigned int V_140 )
{
struct V_3 * V_4 = V_1 -> V_5 ;
if ( V_140 >= 80 ) {
V_1 -> V_140 = 80 ;
...
F_46 ( & V_1 -> V_8 , ( unsigned char * ) & V_1 -> V_140 ,
V_142 ) ;
}
...
{
struct V_3 * V_4 ;
V_4 = F_52 ( sizeof( struct V_3 ) , V_143 ) ;
if ( ! V_4 )
return - V_144 ;
V_1 -> V_5 = V_4 ;
V_1 -> V_21 = 8 ;
