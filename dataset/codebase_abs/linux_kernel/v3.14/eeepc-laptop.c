...
F_68 ( V_8 -> V_64 ,
& V_8 -> V_64 -> V_75 -> V_84 ) ;
V_76 = F_74 ( V_8 -> V_64 , V_58 , 0 , L_28 ) ;
if ( V_76 ) {
F_52 ( L_29 , V_76 ) ;
goto V_85;
}
...
if ( ! V_143 )
return;
if ( strcmp ( V_143 , L_45 ) == 0 || strcmp ( V_143 , L_46 ) == 0 ) {
V_8 -> V_31 = true ;
F_125 ( L_47
L_48 , V_143 ) ;
F_125 ( L_49 ) ;
}
if ( strcmp ( V_143 , L_50 ) == 0 || strcmp ( V_143 , L_51 ) == 0 ||
strcmp ( V_143 , L_52 ) == 0 ) {
V_8 -> V_99 = true ;
F_125 ( L_53 ) ;
}
...
{
F_132 ( V_8 , V_146 , L_56 ) ;
F_132 ( V_8 , V_147 , L_57 ) ;
F_132 ( V_8 , V_148 , L_58 ) ;
F_132 ( V_8 , V_43 , L_59 ) ;
}
...
V_149 = V_151 | V_152 ;
F_136 ( L_61 , V_149 ) ;
if ( F_1 ( V_8 -> V_1 , L_62 , V_149 ) ) {
F_52 ( L_63 ) ;
return - V_12 ;
}
if ( F_3 ( V_8 -> V_1 , L_64 , & V_8 -> V_13 ) ) {
F_52 ( L_65 ) ;
return - V_12 ;
}
F_133 ( V_8 ) ;
