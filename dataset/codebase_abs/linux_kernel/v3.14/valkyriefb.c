...
{
int V_50 , V_89 ;
F_4 ( & V_4 -> V_5 -> V_90 . V_14 , 0 ) ;
F_37 ( 20000 ) ;
V_50 = ( ( V_89 = F_38 ( & V_4 -> V_5 -> V_90 . V_14 ) ) & 0x70 ) << 4 ;
F_4 ( & V_4 -> V_5 -> V_90 . V_14 , 4 ) ;
F_37 ( 20000 ) ;
V_50 |= ( ( V_89 = F_38 ( & V_4 -> V_5 -> V_90 . V_14 ) ) & 0x30 ) ;
F_4 ( & V_4 -> V_5 -> V_90 . V_14 , 2 ) ;
F_37 ( 20000 ) ;
V_50 |= ( ( V_89 = F_38 ( & V_4 -> V_5 -> V_90 . V_14 ) ) & 0x40 ) >> 3 ;
V_50 |= ( V_89 & 0x10 ) >> 2 ;
F_4 ( & V_4 -> V_5 -> V_90 . V_14 , 1 ) ;
F_37 ( 20000 ) ;
V_50 |= ( ( V_89 = F_38 ( & V_4 -> V_5 -> V_90 . V_14 ) ) & 0x60 ) >> 5 ;
F_4 ( & V_4 -> V_5 -> V_90 . V_14 , 7 ) ;
return V_50 ;
}
...
static void F_33 ( struct V_101 * V_12 , struct V_3 * V_4 )
{
...
struct V_101 * V_12 )
{
V_12 -> V_106 = F_12 ( V_7 -> V_20 , V_7 -> V_17 ) ;
...
V_2 -> V_37 = V_4 -> V_37 ;
V_2 -> V_7 = & V_4 -> V_7 ;
return F_40 ( & V_2 -> V_88 , 256 , 0 ) ;
}
int T_3 F_24 ( char * V_119 )
{
char * V_120 ;
if ( ! V_119 || ! * V_119 )
return 0 ;
while ( ( V_120 = F_41 ( & V_119 , L_15 ) ) != NULL ) {
if ( ! strncmp ( V_120 , L_16 , 6 ) ) {
int V_20 = F_42 ( V_120 + 6 , NULL , 0 ) ;
if ( V_20 > 0 && V_20 <= V_57 )
V_54 = V_20 ;
}
else if ( ! strncmp ( V_120 , L_17 , 6 ) ) {
int V_16 = F_42 ( V_120 + 6 , NULL , 0 ) ;
switch ( V_16 ) {
case 8 :
V_60 = V_63 ;
break;
