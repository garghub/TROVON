...
if ( V_15 == 0 && V_266 && V_266 -> V_302 == V_303 ) {
...
F_7 ( V_292 != NULL ) ;
if ( V_292 -> V_255 & V_296 ) {
struct V_102 V_304 = V_292 -> V_290 ;
...
int V_307 , T_8 V_270 , int V_308 , int V_309 )
{
struct V_102 * V_225 = F_129 ( V_196 , V_309 ) ;
struct V_12 * V_13 = exp -> V_34 ;
struct V_1 * V_2 = & V_13 -> V_35 . V_2 ;
struct V_3 * V_4 ;
T_9 V_310 = { { 0 } } ;
...
V_15 = F_130 ( V_4 -> V_20 , V_225 , & V_310 ,
V_270 , V_312 , NULL ) ;
} else {
F_3 ( V_265 ,
L_72 V_127 L_3 ,
...
V_196 -> V_313 = F_132 ( & V_314 , F_133 () ) ;
V_196 -> V_315 = F_134 ( & V_314 , F_135 () ) ;
V_196 -> V_316 = F_136 () ;
V_4 = F_114 ( V_2 , V_196 , & V_196 -> V_210 ) ;
if ( F_19 ( V_4 ) )
return F_56 ( V_4 ) ;
V_196 -> V_263 |= V_317 ;
V_15 = F_128 ( exp , V_196 , V_4 -> V_86 , V_318 ,
V_319 , V_277 ) ;
if ( V_15 != 0 )
return V_15 ;
...
const char * V_96 , int V_320 , const char * V_321 , int V_322 ,
struct V_260 * * V_261 )
{
struct V_12 * V_13 = exp -> V_34 ;
struct V_1 * V_2 = & V_13 -> V_35 . V_2 ;
...
V_320 , V_96 , F_58 ( & V_196 -> V_197 ) ,
V_322 , V_321 , F_58 ( & V_196 -> V_210 ) ) ;
V_15 = F_20 ( V_13 ) ;
if ( V_15 )
return V_15 ;
V_196 -> V_313 = F_132 ( & V_314 , F_133 () ) ;
V_196 -> V_315 = F_134 ( & V_314 , F_135 () ) ;
V_196 -> V_316 = F_136 () ;
V_323 = F_114 ( V_2 , V_196 , & V_196 -> V_197 ) ;
if ( F_19 ( V_323 ) )
return F_56 ( V_323 ) ;
V_324 = F_114 ( V_2 , V_196 , & V_196 -> V_210 ) ;
if ( F_19 ( V_324 ) )
return F_56 ( V_324 ) ;
V_196 -> V_263 |= V_277 | V_325 ;
V_15 = F_128 ( exp , V_196 , V_323 -> V_86 ,
V_318 , V_319 ,
V_317 ) ;
if ( V_15 == 0 ) {
V_15 = F_128 ( exp , V_196 , V_323 -> V_86 ,
...
V_327 ) ;
if ( V_15 == 0 )
V_15 = F_139 ( V_323 -> V_20 , V_196 , V_96 , V_320 ,
V_321 , V_322 , V_261 ) ;
return V_15 ;
}
...
F_58 ( & V_196 -> V_197 ) , V_196 -> V_333 . V_334 ) ;
V_196 -> V_263 |= V_277 ;
V_4 = F_55 ( V_2 , & V_196 -> V_197 ) ;
if ( F_19 ( V_4 ) )
return F_56 ( V_4 ) ;
V_15 = F_141 ( V_4 -> V_20 , V_196 , V_329 , V_330 , V_331 ,
V_332 , V_261 , V_268 ) ;
return V_15 ;
}
...
V_341 -> V_347 |= V_244 & F_150 ( V_352 ) ;
F_151 ( V_336 [ V_14 ] ) ;
}
F_152 ( V_338 == 0 , L_79 , V_338 ) ;
}
static int F_153 ( struct V_33 * exp , struct V_195 * V_196 ,
struct V_335 * * V_336 , struct V_260 * * V_261 )
{
struct V_12 * V_13 = exp -> V_34 ;
struct V_1 * V_2 = & V_13 -> V_35 . V_2 ;
T_4 V_353 = V_196 -> V_354 ;
int V_15 ;
int V_337 ;
int V_338 ;
struct V_3 * V_4 ;
...
V_353 , F_58 ( & V_196 -> V_197 ) ) ;
V_4 = F_55 ( V_2 , & V_196 -> V_197 ) ;
if ( F_19 ( V_4 ) )
return F_56 ( V_4 ) ;
V_15 = F_154 ( V_4 -> V_20 , V_196 , V_336 , V_261 ) ;
if ( V_15 != 0 )
return V_15 ;
V_337 = ( ( * V_261 ) -> V_355 -> V_356 + V_357 - 1 )
>> V_358 ;
V_338 = ( * V_261 ) -> V_355 -> V_356 >> V_359 ;
F_7 ( ! ( ( * V_261 ) -> V_355 -> V_356 & ~ V_360 ) ) ;
F_7 ( V_337 > 0 && V_337 <= V_196 -> V_361 ) ;
F_3 ( V_265 , L_82 , V_337 , V_338 ,
V_196 -> V_361 ) ;
...
return - V_26 ;
} else if ( F_164 ( V_375 ) || F_164 ( V_376 ) ) {
V_15 = F_20 ( V_13 ) ;
if ( V_15 )
return V_15 ;
...
int F_166 ( struct V_33 * exp , struct V_381 * * V_382 ,
struct V_372 * V_373 )
{
struct V_12 * V_13 = F_6 ( exp ) ;
struct V_1 * V_2 = & V_13 -> V_35 . V_2 ;
...
if ( ! V_373 )
return V_385 ;
V_384 = (struct V_101 * ) V_373 ;
V_383 = (struct V_101 * ) * V_382 ;
if ( V_384 -> V_386 != V_387 &&
V_384 -> V_386 != V_388 )
return - V_26 ;
V_383 -> V_386 = F_150 ( V_384 -> V_386 ) ;
V_383 -> V_389 = F_150 ( V_384 -> V_389 ) ;
V_383 -> V_390 = F_150 ( V_384 -> V_390 ) ;
for ( V_14 = 0 ; V_14 < V_2 -> V_7 . V_18 ; V_14 ++ ) {
V_383 -> V_391 [ V_14 ] = V_384 -> V_391 [ V_14 ] ;
F_167 ( & V_383 -> V_391 [ V_14 ] , & V_384 -> V_391 [ V_14 ] ) ;
}
return V_385 ;
}
int F_168 ( struct V_33 * exp , struct V_372 * * V_384 ,
struct V_381 * V_282 , int V_392 )
{
struct V_12 * V_13 = F_6 ( exp ) ;
struct V_101 * * V_393 = (struct V_101 * * ) V_384 ;
struct V_101 * V_394 = (struct V_101 * ) V_282 ;
struct V_1 * V_2 = & V_13 -> V_35 . V_2 ;
int V_385 ;
int V_14 ;
T_1 V_395 ;
...
if ( ! V_282 )
return V_385 ;
if ( V_394 -> V_386 == V_387 ||
V_394 -> V_386 == V_388 ||
V_394 -> V_386 == V_396 )
{
V_395 = F_169 ( V_394 -> V_386 ) ;
} else {
F_12 ( L_89 ) ;
F_170 () ;
}
( * V_393 ) -> V_386 = V_395 ;
( * V_393 ) -> V_389 = F_169 ( V_394 -> V_389 ) ;
( * V_393 ) -> V_390 = F_169 ( V_394 -> V_390 ) ;
for ( V_14 = 0 ; V_14 < ( * V_393 ) -> V_389 ; V_14 ++ ) {
( * V_393 ) -> V_391 [ V_14 ] = V_394 -> V_391 [ V_14 ] ;
F_171 ( & ( * V_393 ) -> V_391 [ V_14 ] , & ( * V_393 ) -> V_391 [ V_14 ] ) ;
}
return V_385 ;
}
static int F_172 ( struct V_33 * exp , const struct V_102 * V_225 ,
T_9 * V_310 , T_8 V_270 ,
T_10 V_244 , void * V_397 )
{
struct V_12 * V_13 = exp -> V_34 ;
struct V_1 * V_2 = & V_13 -> V_35 . V_2 ;
int V_15 = 0 ;
...
struct V_1 * V_2 = & exp -> V_34 -> V_35 . V_2 ;
int V_15 ;
V_15 = F_174 ( V_2 -> V_19 [ 0 ] -> V_20 , V_281 , V_39 , V_308 ) ;
return V_15 ;
}
...
struct V_33 * V_398 , struct V_33 * V_399 ,
struct V_400 * V_401 )
{
struct V_1 * V_2 = & exp -> V_34 -> V_35 . V_2 ;
return F_178 ( V_2 -> V_19 [ 0 ] -> V_20 , V_206 , V_398 , V_399 , V_401 ) ;
}
int F_179 ( struct V_33 * exp , struct V_400 * V_401 )
{
struct V_12 * V_13 = exp -> V_34 ;
struct V_1 * V_2 = & V_13 -> V_35 . V_2 ;
if ( V_401 -> V_394 )
F_180 ( exp , ( void * ) & V_401 -> V_394 ) ;
return F_181 ( V_2 -> V_19 [ 0 ] -> V_20 , V_401 ) ;
}
...
struct V_1 * V_2 = & V_13 -> V_35 . V_2 ;
struct V_3 * V_4 ;
V_4 = F_55 ( V_2 , & V_403 -> V_405 ) ;
if ( F_19 ( V_4 ) )
return F_56 ( V_4 ) ;
return F_183 ( V_4 -> V_20 , V_403 , V_404 ) ;
}
...
if ( V_15 )
return V_15 ;
V_4 = F_55 ( V_2 , & V_254 -> V_407 . V_408 ) ;
if ( F_19 ( V_4 ) )
return F_56 ( V_4 ) ;
V_15 = F_189 ( V_4 -> V_20 , V_254 , V_406 ) ;
return V_15 ;
}
int F_190 ( struct V_33 * exp , struct V_260 * V_206 ,
const struct V_409 * V_410 , struct V_252 * * V_254 )
{
struct V_1 * V_2 = & exp -> V_34 -> V_35 . V_2 ;
return F_191 ( V_2 -> V_19 [ 0 ] -> V_20 , V_206 , V_410 , V_254 ) ;
}
int F_192 ( struct V_33 * exp ,
struct V_411 * V_412 ,
struct V_278 * V_279 )
{
struct V_195 * V_196 = & V_412 -> V_413 ;
struct V_12 * V_13 = exp -> V_34 ;
struct V_1 * V_2 = & V_13 -> V_35 . V_2 ;
struct V_3 * V_4 = NULL ;
int V_15 ;
...
if ( F_19 ( V_4 ) )
return F_56 ( V_4 ) ;
V_15 = F_193 ( V_4 -> V_20 , V_412 , V_279 ) ;
return V_15 ;
}
int F_194 ( struct V_33 * exp , struct V_280 * V_266 ,
struct V_102 * V_225 , T_4 * V_308 )
{
struct V_12 * V_13 = exp -> V_34 ;
struct V_1 * V_2 = & V_13 -> V_35 . V_2 ;
struct V_3 * V_4 ;
...
if ( F_19 ( V_4 ) )
return F_56 ( V_4 ) ;
V_15 = F_195 ( V_4 -> V_20 , V_266 , V_225 , V_308 ) ;
return V_15 ;
}
int F_196 ( struct V_12 * V_414 , struct V_33 * exp ,
struct V_179 * V_180 )
{
struct V_12 * V_13 = F_6 ( exp ) ;
struct V_1 * V_2 = & V_13 -> V_35 . V_2 ;
...
V_415 += V_180 -> V_420 . V_421 ;
V_416 += V_180 -> V_420 . V_422 ;
}
}
V_180 -> V_420 . V_421 = V_415 ;
V_180 -> V_420 . V_422 = V_416 ;
return V_15 ;
}
int F_197 ( struct V_12 * V_414 , struct V_33 * exp ,
struct V_179 * V_180 )
{
struct V_12 * V_13 = F_6 ( exp ) ;
struct V_1 * V_2 = & V_13 -> V_35 . V_2 ;
...
int V_15 ;
F_91 ( & V_230 ) ;
V_15 = F_200 ( & V_423 , & V_424 ,
V_230 . V_425 , V_426 , NULL ) ;
return V_15 ;
}
