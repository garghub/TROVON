...
{
struct V_128 * V_129 = V_127 -> V_77 . V_130 ;
struct V_114 * V_77 = & V_127 -> V_77 ;
struct V_131 * V_50 ;
struct V_5 * V_9 ;
struct V_1 * V_6 ;
struct V_132 V_133 ;
...
if ( F_58 ( V_129 , L_5 ) )
V_9 -> V_64 = true ;
if ( F_59 ( V_129 , L_6 , & V_136 ) ) {
F_57 ( V_77 , L_7 ) ;
return - V_137 ;
}
V_9 -> V_35 = F_60 ( V_129 , 0 ) ;
if ( V_9 -> V_35 == V_138 ) {
F_57 ( V_77 , L_8 ) ;
return - V_62 ;
}
V_9 -> V_139 = F_61 ( V_77 , NULL ) ;
if ( F_62 ( V_9 -> V_139 ) ) {
F_57 ( V_77 , L_9 ) ;
return F_63 ( V_9 -> V_139 ) ;
}
V_88 = F_64 ( V_129 , 0 , & V_133 ) ;
if ( V_88 ) {
F_57 ( V_77 , L_10 ) ;
goto V_140;
}
V_134 = V_133 . V_141 ;
V_135 = F_65 ( & V_133 ) ;
V_9 -> V_17 = F_66 ( V_77 , V_134 , V_135 ) ;
if ( ! V_9 -> V_17 ) {
F_57 ( V_77 , L_11 ) ;
V_88 = - V_82 ;
goto V_140;
}
V_88 = F_67 ( V_9 -> V_35 , & F_10 , 0 , V_142 , V_9 ) ;
if ( V_88 ) {
F_57 ( V_77 , L_12 ) ;
V_88 = - V_62 ;
goto V_140;
...
V_50 -> V_150 = F_53 ;
F_68 ( & V_50 -> V_7 ) ;
F_69 ( V_151 , V_50 -> V_152 ) ;
F_69 ( V_153 , V_50 -> V_152 ) ;
F_69 ( V_154 , V_50 -> V_152 ) ;
F_69 ( V_155 , V_50 -> V_152 ) ;
...
struct V_11 ,
V_14 ) ;
V_158 -> V_160 [ V_38 ] = F_8 ( V_9 -> V_17 +
V_38 * 0x10 + V_23 ) ;
}
V_158 -> V_161 = F_8 ( V_9 -> V_17 + V_28 ) ;
F_83 ( V_77 ) ;
return 0 ;
}
static int F_88 ( struct V_114 * V_77 )
{
struct V_5 * V_9 = F_79 ( V_77 ) ;
struct V_157 * V_158 = & V_9 -> V_159 ;
struct V_11 * V_12 ;
