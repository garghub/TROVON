...
static int F_59 ( struct V_1 * V_1 , const struct V_127 * V_128 )
{
...
static void F_63 ( struct V_141 * V_111 ,
struct V_106 * V_107 )
{
struct V_106 * V_142 ;
...
if ( V_6 )
return V_6 ;
V_6 = F_76 ( V_7 -> V_9 , V_1 -> V_68 , NULL ,
...
static int F_79 ( struct V_157 * V_9 )
{
struct V_1 * V_1 = F_80 ( V_9 ) ;
if ( V_1 -> V_68 >= 0 && F_81 ( V_9 ) )
F_82 ( V_1 -> V_68 ) ;
return 0 ;
}
static int F_83 ( struct V_157 * V_9 )
{
struct V_1 * V_1 = F_80 ( V_9 ) ;
if ( V_1 -> V_68 >= 0 && F_81 ( V_9 ) )
F_84 ( V_1 -> V_68 ) ;
