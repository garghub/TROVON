...
static struct V_3 * F_124 ( struct V_40 * V_19 ,
struct V_3 * V_4 ,
...
static int F_127 ( struct V_40 * V_19 ,
...
int F_134 ( struct V_40 * V_19 , struct V_3 * * V_4 , struct V_41 * V_42 )
{
* V_4 = NULL ;
return F_127 ( V_19 , V_4 , V_42 ) ;
}
struct V_3 * F_135 ( struct V_40 * V_19 , struct V_41 * V_42 ,
...
struct V_3 * F_139 ( struct V_40 * V_19 , struct V_41 * V_42 ,
const struct V_9 * V_205 )
{
...
static inline int F_141 ( struct V_40 * V_19 ,
...
int F_150 ( struct V_40 * V_19 , int F_142 ( void * V_141 , char * V_140 ,
...
V_119 -> V_255 ;
V_257 = ( V_48 -> V_250 >= V_259 ) ?
V_56 : sizeof( struct V_50 ) + V_256 ;
if ( ( V_234 -> V_208 + V_208 > V_56 - V_258 ) && V_230 &&
( V_19 -> V_260 == V_261 ||
V_19 -> V_260 == V_262 ) ) {
F_155 ( V_19 , V_42 , V_56 - V_258 +
sizeof( struct V_50 ) ) ;
goto V_263;
}
...
V_235 = V_2 ;
V_269 = V_208 + V_271 ;
if ( V_269 > ( V_234 -> V_208 <= V_56 && ! ( V_234 -> V_17 & V_254 ) ? V_56 : V_226 ) - V_210 )
V_269 = V_226 - V_210 - V_119 -> V_4 . V_273 ;
if ( ( V_17 & V_274 ) &&
! ( V_119 -> V_4 . V_6 -> V_266 & V_275 ) )
V_272 = V_56 ;
else
V_272 = V_269 + V_210 ;
V_272 += V_237 ;
if ( V_269 != V_208 + V_271 ) {
V_269 += V_119 -> V_4 . V_273 ;
}
V_272 += V_119 -> V_4 . V_273 ;
V_270 = V_269 + V_210 ;
V_272 += sizeof( struct V_145 ) ;
if ( V_211 ) {
V_2 = F_144 ( V_19 ,
V_272 + V_209 ,
( V_17 & V_214 ) , & V_153 ) ;
...
V_235 , V_226 ,
V_88 + V_211 , V_271 , 0 ) ;
V_235 -> V_215 = F_161 ( V_235 -> V_215 ,
V_2 -> V_215 ) ;
V_88 += V_271 ;
F_162 ( V_235 , V_226 ) ;
}
V_238 = V_269 - V_211 - V_271 ;
if ( V_238 < 0 ) {
V_153 = - V_35 ;
F_15 ( V_2 ) ;
goto error;
} else if ( V_238 > 0 && F_142 ( V_141 , V_88 + V_211 , V_84 , V_238 , V_271 , V_2 ) < 0 ) {
V_153 = - V_278 ;
F_15 ( V_2 ) ;
goto error;
}
...
if ( V_238 > V_208 )
V_238 = V_208 ;
if ( ! ( V_119 -> V_4 . V_6 -> V_266 & V_275 ) ) {
unsigned int V_279 ;
V_279 = V_2 -> V_30 ;
if ( F_142 ( V_141 , F_117 ( V_2 , V_238 ) ,
V_84 , V_238 , V_279 , V_2 ) < 0 ) {
F_163 ( V_2 , V_279 ) ;
V_153 = - V_278 ;
goto error;
}
} else {
int V_280 = F_102 ( V_2 ) -> V_281 ;
struct V_282 * V_283 = F_164 ( V_19 ) ;
V_153 = - V_166 ;
if ( ! F_165 ( V_19 , V_283 ) )
goto error;
if ( ! F_166 ( V_2 , V_280 , V_283 -> V_284 ,
V_283 -> V_84 ) ) {
V_153 = - V_73 ;
if ( V_280 == V_285 )
goto error;
F_167 ( V_2 , V_280 , V_283 -> V_284 ,
V_283 -> V_84 , 0 ) ;
F_102 ( V_2 ) -> V_281 = ++ V_280 ;
F_168 ( V_283 -> V_284 ) ;
}
V_238 = F_169 ( int , V_238 , V_283 -> V_286 - V_283 -> V_84 ) ;
if ( F_142 ( V_141 ,
F_170 ( V_283 -> V_284 ) + V_283 -> V_84 ,
V_84 , V_238 , V_2 -> V_30 , V_2 ) < 0 )
goto V_287;
V_283 -> V_84 += V_238 ;
F_171 ( & F_102 ( V_2 ) -> V_288 [ V_280 - 1 ] , V_238 ) ;
V_2 -> V_30 += V_238 ;
V_2 -> V_170 += V_238 ;
V_2 -> V_163 += V_238 ;
F_172 ( V_238 , & V_19 -> V_276 ) ;
}
V_84 += V_238 ;
V_208 -= V_238 ;
}
...
error:
V_234 -> V_208 -= V_208 ;
F_14 ( F_34 ( V_19 ) , V_119 -> V_289 , V_28 ) ;
return V_153 ;
}
static void F_173 ( struct V_231 * V_232 , struct V_47 * V_48 )
{
if ( V_48 -> V_234 . V_44 ) {
...
int F_174 ( struct V_40 * V_19 )
{
struct V_1 * V_2 , * V_290 ;
struct V_1 * * V_291 ;
struct V_9 V_292 , * V_205 = & V_292 ;
struct V_231 * V_232 = F_151 ( V_19 ) ;
struct V_47 * V_48 = F_35 ( V_19 ) ;
struct V_46 * V_46 = F_34 ( V_19 ) ;
struct V_50 * V_51 ;
...
int V_153 = 0 ;
if ( ( V_2 = F_175 ( & V_19 -> V_213 ) ) == NULL )
goto V_186;
V_291 = & ( F_102 ( V_2 ) -> V_164 ) ;
if ( V_2 -> V_88 < F_57 ( V_2 ) )
F_105 ( V_2 , F_176 ( V_2 ) ) ;
while ( ( V_290 = F_175 ( & V_19 -> V_213 ) ) != NULL ) {
F_105 ( V_290 , F_177 ( V_2 ) ) ;
* V_291 = V_290 ;
V_291 = & ( V_290 -> V_80 ) ;
V_2 -> V_30 += V_290 -> V_30 ;
V_2 -> V_170 += V_290 -> V_30 ;
V_2 -> V_163 += V_290 -> V_163 ;
V_290 -> V_161 = NULL ;
V_290 -> V_19 = NULL ;
}
if ( V_48 -> V_250 < V_259 )
...
F_16 ( V_46 , V_119 -> V_289 , V_70 , V_2 -> V_30 ) ;
if ( V_52 == V_85 ) {
struct V_15 * V_16 = F_6 ( F_2 ( V_2 ) ) ;
F_178 ( V_46 , V_16 , F_179 ( V_2 ) -> V_89 ) ;
F_180 ( V_46 , V_16 , V_293 ) ;
}
V_153 = F_181 ( V_2 ) ;
if ( V_153 ) {
if ( V_153 > 0 )
...
return V_153 ;
error:
F_14 ( V_46 , V_119 -> V_289 , V_28 ) ;
goto V_186;
}
void F_183 ( struct V_40 * V_19 )
{
struct V_1 * V_2 ;
while ( ( V_2 = F_184 ( & V_19 -> V_213 ) ) != NULL ) {
if ( F_2 ( V_2 ) )
F_14 ( F_34 ( V_19 ) , F_6 ( F_2 ( V_2 ) ) ,
V_28 ) ;
F_15 ( V_2 ) ;
}
F_173 ( F_151 ( V_19 ) , F_35 ( V_19 ) ) ;
}
