...
* V_9 ++ = '\n' ;
* V_9 = 0 ;
F_23 ( V_30 , NULL , L_50 , V_30 -> V_33 ) ;
} else
F_23 ( V_30 , L_51 , L_52 , V_32 ) ;
}
void
...
V_45 = V_36 -> V_51 [ 2 ] ;
V_31 = V_36 -> V_51 ;
V_9 += sprintf ( V_9 , L_53 , V_37 ? L_54 : L_55 ) ;
V_32 = V_36 -> V_8 ;
if ( V_44 == V_52 ) {
if ( V_43 == V_53 ) {
if ( V_45 == 3 ) {
...
V_9 += sprintf ( V_9 , L_58 ) ;
V_49 = 1 ;
} else {
V_9 += sprintf ( V_9 , L_59 , V_43 ) ;
V_49 = 1 ;
}
} else {
if ( V_43 == V_53 ) {
...
V_9 += sprintf ( V_9 , L_61 , V_44 ) ;
V_49 = 1 ;
}
} else {
V_9 += sprintf ( V_9 , L_62 , V_43 , V_44 ) ;
V_49 = 1 ;
}
}
...
break;
if ( V_11 == V_56 )
V_9 += sprintf ( V_9 , L_64 ,
V_41 & 0x7f , ( V_41 & 0x80 ) ? L_65 : L_66 ,
V_32 , V_42 ) ;
else
...
if ( * V_31 == 0xa1 ) {
V_9 += sprintf ( V_9 , L_72 ) ;
}
break;
default:
V_9 += sprintf ( V_9 , L_73 , * V_31 ) ;
break;
}
V_31 ++ ;
continue;
...
break;
if ( V_11 != V_60 ) {
V_9 += sprintf ( V_9 , L_74 , V_61 [ V_11 ] . V_19 ) ;
...
break;
if ( V_11 != V_62 ) {
V_9 += sprintf ( V_9 , L_74 , V_63 [ V_11 ] . V_19 ) ;
V_9 += V_63 [ V_11 ] . F_26 ( V_9 , V_31 ) ;
} else
V_9 += sprintf ( V_9 , L_75 , V_46 , * V_31 , V_31 [ 1 ] ) ;
} else
V_9 += sprintf ( V_9 , L_76 , V_46 , * V_31 , V_31 [ 1 ] ) ;
if ( V_48 == 8 ) {
V_46 = V_47 ;
V_47 = 0 ;
V_48 = 0 ;
...
break;
if ( V_11 != V_68 ) {
V_9 += sprintf ( V_9 , L_74 , V_69 [ V_11 ] . V_19 ) ;
V_9 += V_69 [ V_11 ] . F_26 ( V_9 , V_31 ) ;
} else
V_9 += sprintf ( V_9 , L_79 , * V_31 , V_31 [ 1 ] ) ;
} else if ( V_46 == 5 ) {
for ( V_11 = 0 ; V_11 < V_70 ; V_11 ++ )
if ( * V_31 == V_71 [ V_11 ] . V_15 )
break;
if ( V_11 != V_70 ) {
V_9 += sprintf ( V_9 , L_74 , V_71 [ V_11 ] . V_19 ) ;
...
break;
if ( V_11 != V_72 ) {
V_9 += sprintf ( V_9 , L_74 , V_73 [ V_11 ] . V_19 ) ;
...
break;
if ( V_11 != V_75 ) {
V_9 += sprintf ( V_9 , L_74 , V_76 [ V_11 ] . V_19 ) ;
