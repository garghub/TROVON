...
int F_53 ( T_3 * V_69 , T_3 * V_70 , T_2 * V_48 , int V_49 )
{
struct V_1 * V_2 ;
struct V_50 V_71 ;
struct V_50 V_72 ;
...
V_75 = F_55 ( V_2 , V_48 , V_74 ) ;
if ( V_75 ) {
F_44 ( L_10 ) ;
GOTO ( V_77 , V_75 ) ;
}
F_50 ( & V_71 , F_51 ( V_69 ) , 16 ,
( unsigned long ) ( V_69 ) % V_10 ) ;
F_50 ( & V_72 , F_51 ( V_70 ) , 16 ,
( unsigned long ) ( V_70 ) % V_10 ) ;
V_55 . V_2 = V_2 ;
V_55 . V_79 = NULL ;
V_55 . V_57 = 0 ;
V_75 = F_56 ( & V_55 , & V_71 , & V_72 , 16 ) ;
if ( V_75 ) {
F_44 ( L_11 ) ;
GOTO ( V_77 , V_75 ) ;
}
...
int F_58 ( T_3 * V_69 , T_3 * V_70 , T_2 * V_48 , int V_49 )
{
struct V_1 * V_2 ;
struct V_50 V_71 ;
struct V_50 V_72 ;
...
va_start ( args , V_84 ) ;
F_62 ( V_83 , V_84 , args ,
L_13 V_85 L_14 V_86 L_15 V_87
L_16 V_87 L_17
L_18 , V_81 , F_63 ( F_64 ( V_81 ) ) , F_65 ( V_81 ) ,
F_66 ( V_81 ) , F_67 ( V_81 ) , F_68 ( V_81 ) ,
F_47 ( V_81 ) , F_69 ( V_81 ) , F_70 ( V_81 ) ,
F_71 ( V_81 ) ) ;
va_end ( args ) ;
}
