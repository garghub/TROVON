...
if ( V_8 == NULL )
return - V_12 ;
if ( F_2 ( & V_8 -> V_13 . V_14 ) )
return - V_15 ;
F_3 ( & V_10 , V_4 ) ;
V_6 = F_4 ( & V_8 -> V_13 , & V_10 ) ;
if ( V_6 != 0 )
F_5 ( V_16 , L_1 , V_6 ) ;
F_6 ( & V_8 -> V_13 . V_14 ) ;
return ( V_6 < 0 ) ? - V_17 : 0 ;
...
static int F_11 ( struct V_1 * V_2 , T_1 * V_23 )
{
int V_6 = 0 ;
struct V_7 * V_8 ;
struct V_24 V_25 = { 0 } ;
...
static int F_14 ( struct V_1 * V_2 , T_2 * V_46 )
{
struct V_7 * V_8 ;
V_8 = (struct V_7 * ) V_2 -> V_11 ;
if ( V_8 == NULL )
...
static int F_15 ( struct V_1 * V_2 , T_3 * V_28 )
{
struct V_7 * V_8 ;
V_8 = (struct V_7 * ) V_2 -> V_11 ;
if ( V_8 == NULL )
...
static int F_17 ( struct V_1 * V_2 , T_3 * V_48 )
{
struct V_7 * V_8 ;
V_8 = (struct V_7 * ) V_2 -> V_11 ;
if ( V_8 == NULL )
...
static void F_9 ( struct V_3 * V_64 ,
struct V_18 * V_18 )
{
switch ( V_18 -> V_65 ) {
case V_66 :
