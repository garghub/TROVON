...
int V_111 ;
struct V_96 * V_102 ;
V_2 -> V_69 . V_112 . type = V_113 ;
V_2 -> V_69 . V_112 . V_112 = F_67 ( V_2 -> V_114 ) ;
V_111 = F_68 ( V_113 ,
F_67 ( V_2 -> V_114 ) ,
V_2 -> V_115 , & V_2 -> V_69 ) ;
if ( V_111 < 0 || ! V_2 -> V_69 . V_104 ) {
F_69 ( V_116 L_4 ,
V_2 -> V_115 ) ;
return - V_117 ;
}
...
static void F_76 ( struct V_1 * V_2 , int V_52 )
{
...
if ( V_2 -> clock == 0 )
V_2 -> clock = 48000 ;
if ( ( V_52 = F_75 ( V_2 , V_125 ) ) < 0 ) {
F_69 ( V_116 L_6 ) ;
return;
}
if ( ( V_67 = F_56 ( V_2 , V_140 ) ) == NULL ) {
F_69 ( V_116 L_7 , V_2 -> clock ) ;
F_76 ( V_2 , V_52 ) ;
return;
}
...
if ( ( V_111 = F_91 ( V_2 -> V_150 , L_10 , V_149 ,
V_2 -> V_151 ,
V_2 -> V_152 , & V_148 ) ) < 0 )
return V_111 ;
V_148 -> V_18 = V_2 ;
V_148 -> V_153 = F_89 ;
F_92 ( V_148 , V_154 , & V_155 ) ;
F_92 ( V_148 , V_156 , & V_157 ) ;
V_148 -> V_158 = 0 ;
...
static void F_96 ( struct V_164 * V_165 )
{
struct V_1 * V_2 = F_97 ( V_165 , struct V_1 , V_166 ) ;
int V_167 , V_17 ;
...
if ( F_100 ( V_2 -> V_16 , V_171 , V_17 ) )
F_101 ( V_2 -> V_150 , V_172 ,
& V_2 -> V_170 -> V_173 ) ;
#else
if ( ! V_2 -> V_174 )
return;
...
if ( V_17 ) {
F_102 ( V_2 -> V_174 , V_17 , 1 ) ;
F_103 ( V_2 -> V_174 ) ;
F_102 ( V_2 -> V_174 , V_17 , 0 ) ;
F_103 ( V_2 -> V_174 ) ;
}
#endif
}
static T_5 F_104 ( int V_178 , void * V_179 )
{
...
if ( ( V_111 = V_189 ( V_2 -> V_150 , 0 , & V_195 , NULL , & V_190 ) ) < 0 )
return V_111 ;
V_190 -> V_198 = 1 ;
memset ( & V_16 , 0 , sizeof( V_16 ) ) ;
V_16 . V_18 = V_2 ;
if ( ( V_111 = F_108 ( V_190 , & V_16 , & V_2 -> V_16 ) ) < 0 )
return V_111 ;
#ifndef F_98
memset ( & V_193 , 0 , sizeof( V_193 ) ) ;
V_193 . V_199 = V_200 ;
strcpy ( V_193 . V_159 , L_11 ) ;
V_2 -> V_169 = F_109 ( V_2 -> V_150 , & V_193 ) ;
memset ( & V_193 , 0 , sizeof( V_193 ) ) ;
V_193 . V_199 = V_200 ;
strcpy ( V_193 . V_159 , L_12 ) ;
V_2 -> V_170 = F_109 ( V_2 -> V_150 , & V_193 ) ;
#endif
return 0 ;
}
...
F_111 ( V_2 -> V_114 , 0x58 , & V_204 ) ;
F_112 ( V_2 -> V_114 , V_206 , & V_205 ) ;
if ( V_204 & 1 )
V_203 |= 0x10 ;
...
{
struct V_211 * V_114 = V_2 -> V_114 ;
int V_21 ;
unsigned long V_212 = V_2 -> V_5 ;
T_1 V_204 ;
T_3 V_213 ;
F_111 ( V_114 , V_214 , & V_204 ) ;
V_204 &= ~ V_215 ;
V_204 &= ~ ( V_216 | V_217 ) ;
V_204 &= ~ V_218 ;
V_204 |= V_219 ;
...
V_204 &= ~ V_221 ;
V_204 &= ~ V_222 ;
F_116 ( V_114 , V_214 , V_204 ) ;
F_111 ( V_114 , V_223 , & V_204 ) ;
V_204 &= ~ ( 1 << 15 ) ;
V_204 &= ~ ( 1 << 14 ) ;
V_204 &= ~ V_224 ;
V_204 |= V_225 ;
...
V_204 &= ~ ( 1 << 1 ) ;
V_204 &= ~ V_231 ;
F_116 ( V_114 , V_223 , V_204 ) ;
F_111 ( V_114 , V_232 , & V_204 ) ;
V_204 &= ~ ( 1 << 0 ) ;
F_116 ( V_114 , V_232 , V_204 ) ;
F_111 ( V_114 , V_233 , & V_204 ) ;
V_204 |= V_234 ;
V_204 &= ~ V_235 ;
V_204 &= ~ ( 0x1f ) ;
F_116 ( V_114 , V_233 , V_204 ) ;
F_111 ( V_114 , 0x58 , & V_204 ) ;
V_204 |= 1 << 2 ;
V_204 |= 1 << 3 ;
V_204 &= ~ ( 1 << 11 ) ;
F_116 ( V_114 , 0x58 , V_204 ) ;
F_114 ( V_2 ) ;
...
static int F_120 ( struct V_149 * V_112 )
{
struct V_211 * V_114 = F_121 ( V_112 ) ;
struct V_249 * V_150 = F_122 ( V_112 ) ;
...
static int F_130 ( struct V_149 * V_112 )
{
struct V_211 * V_114 = F_121 ( V_112 ) ;
struct V_249 * V_150 = F_122 ( V_112 ) ;
struct V_1 * V_2 = V_150 -> V_18 ;
...
static int F_136 ( struct V_1 * V_2 , int V_112 )
{
struct V_256 * V_257 ;
struct V_258 * V_259 ;
T_1 V_17 ;
if ( ! V_260 [ V_112 ] )
return - V_261 ;
V_259 = F_137 ( V_262 , 8 , L_15 ) ;
if ( ! V_259 )
return - V_123 ;
V_2 -> V_256 = V_257 = F_138 () ;
if ( ! V_257 ) {
F_88 ( V_116 L_16 ) ;
F_139 ( V_259 ) ;
return - V_117 ;
}
F_111 ( V_2 -> V_114 , V_233 , & V_17 ) ;
F_116 ( V_2 -> V_114 , V_233 , V_17 | 0x04 ) ;
F_140 ( V_257 , L_17 ) ;
F_141 ( V_257 , L_18 , F_142 ( V_2 -> V_114 ) ) ;
F_143 ( V_257 , & V_2 -> V_114 -> V_112 ) ;
V_257 -> V_263 = V_262 ;
F_144 ( V_257 , V_259 ) ;
F_145 ( V_257 ) ;
return 0 ;
...
{
if ( V_2 -> V_256 ) {
struct V_258 * V_259 = F_147 ( V_2 -> V_256 ) ;
F_148 ( V_2 -> V_256 ) ;
V_2 -> V_256 = NULL ;
F_139 ( V_259 ) ;
}
}
static inline int F_136 ( struct V_1 * V_2 , int V_112 ) { return - V_264 ; }
...
V_174 -> V_173 . V_269 = V_2 -> V_114 -> V_269 ;
V_174 -> V_173 . V_270 = V_2 -> V_114 -> V_149 ;
V_174 -> V_112 . V_271 = & V_2 -> V_114 -> V_112 ;
F_151 ( V_272 , V_174 -> V_273 ) ;
F_151 ( V_175 , V_174 -> V_274 ) ;
F_151 ( V_177 , V_174 -> V_274 ) ;
F_151 ( V_176 , V_174 -> V_274 ) ;
V_111 = F_152 ( V_174 ) ;
if ( V_111 ) {
F_153 ( V_174 ) ;
return V_111 ;
...
static void F_154 ( struct V_275 * V_276 , T_2 V_277 )
{
struct V_1 * V_2 = V_276 -> V_18 ;
struct V_278 V_279 = * F_155 ( V_2 ) ;
T_1 V_17 = 0 ;
V_17 |= ( V_277 & V_280 ) ? ( 1 << V_279 . V_4 ) : 0 ;
V_17 |= ( V_277 & V_281 ) ? ( 1 << V_279 . V_282 ) : 0 ;
V_17 |= ( V_277 & V_283 ) ? ( 1 << V_279 . V_284 ) : 0 ;
F_2 ( V_17 , V_2 -> V_5 + V_285 ) ;
}
static T_2 F_156 ( struct V_275 * V_276 )
{
struct V_1 * V_2 = V_276 -> V_18 ;
struct V_278 V_279 = * F_155 ( V_2 ) ;
T_1 V_17 = F_7 ( V_2 -> V_5 + V_285 ) ;
T_2 V_286 = 0 ;
if ( V_17 & ( 1 << V_279 . V_4 ) )
V_286 |= V_280 ;
if ( V_17 & ( 1 << V_279 . V_287 ) )
V_286 |= V_288 ;
return V_286 ;
}
static void F_157 ( struct V_275 * V_276 , bool V_289 )
{
struct V_1 * V_2 = V_276 -> V_18 ;
unsigned long V_263 = V_2 -> V_5 + V_285 ;
T_1 V_290 = F_7 ( V_263 + V_291 ) ;
struct V_278 V_279 = * F_155 ( V_2 ) ;
if ( V_289 ) {
F_2 ( ~ ( ( 1 << V_279 . V_4 ) | ( 1 << V_279 . V_282 ) | ( 1 << V_279 . V_284 ) ) ,
V_263 + V_292 ) ;
F_2 ( V_290 | ( 1 << V_279 . V_4 ) | ( 1 << V_279 . V_282 ) | ( 1 << V_279 . V_284 ) ,
V_263 + V_291 ) ;
} else {
F_2 ( ~ ( ( 1 << V_279 . V_282 ) | ( 1 << V_279 . V_284 ) | ( 1 << V_279 . V_4 ) | ( 1 << V_279 . V_287 ) ) ,
V_263 + V_292 ) ;
F_2 ( ( V_290 & ~ ( ( 1 << V_279 . V_4 ) | ( 1 << V_279 . V_287 ) ) )
| ( 1 << V_279 . V_282 ) | ( 1 << V_279 . V_284 ) , V_263 + V_291 ) ;
}
}
...
static int F_166 ( struct V_294 * V_149 )
{
struct V_1 * V_2 = V_149 -> V_295 ;
return F_158 ( V_2 ) ;
}
static int F_167 ( struct V_249 * V_150 ,
struct V_211 * V_114 ,
int V_115 ,
int V_296 ,
int V_297 ,
...
struct V_1 * * V_300 )
{
static struct V_301 V_195 = {
. V_302 = F_166 ,
} ;
struct V_1 * V_2 ;
int V_21 , V_111 ;
* V_300 = NULL ;
if ( ( V_111 = F_132 ( V_114 ) ) < 0 )
return V_111 ;
if ( F_168 ( V_114 , F_169 ( 28 ) ) < 0 ||
F_170 ( V_114 , F_169 ( 28 ) ) < 0 ) {
F_69 ( V_116 L_20 ) ;
F_127 ( V_114 ) ;
return - V_303 ;
}
V_2 = F_78 ( sizeof( * V_2 ) , V_103 ) ;
if ( ! V_2 ) {
F_127 ( V_114 ) ;
return - V_117 ;
}
...
V_2 -> V_151 = V_296 ;
V_2 -> V_152 = V_297 ;
if ( ( V_111 = F_174 ( V_114 , L_10 ) ) < 0 ) {
F_63 ( V_2 ) ;
F_127 ( V_114 ) ;
return V_111 ;
}
V_2 -> V_5 = F_175 ( V_114 , 0 ) ;
if ( F_176 ( V_114 -> V_178 , F_104 , V_304 ,
V_305 , V_2 ) ) {
F_69 ( V_116 L_21 , V_114 -> V_178 ) ;
F_158 ( V_2 ) ;
return - V_123 ;
}
V_2 -> V_178 = V_114 -> V_178 ;
...
F_111 ( V_2 -> V_114 , V_206 , & V_205 ) ;
for ( V_21 = 0 ; V_21 < ( int ) F_177 ( V_306 ) ; V_21 ++ ) {
if ( V_2 -> type == V_306 [ V_21 ] . type &&
V_205 == V_306 [ V_21 ] . V_269 ) {
V_250 = 1 ;
break;
}
}
...
V_2 -> V_250 = V_250 ;
F_115 ( V_2 ) ;
if ( ( V_111 = F_178 ( V_150 , V_307 , V_2 , & V_195 ) ) < 0 ) {
F_158 ( V_2 ) ;
return V_111 ;
}
F_179 ( V_150 , & V_114 -> V_112 ) ;
#ifdef F_161
if ( V_2 -> V_114 -> V_308 != 0x125d )
goto V_309;
V_111 = F_180 ( & V_114 -> V_112 , & V_2 -> V_293 ) ;
if ( V_111 < 0 ) {
F_158 ( V_2 ) ;
return V_111 ;
}
V_2 -> V_276 . V_293 = & V_2 -> V_293 ;
V_2 -> V_276 . V_18 = V_2 ;
V_2 -> V_276 . V_299 = V_299 ;
V_2 -> V_276 . V_195 = & V_310 ;
sprintf ( V_2 -> V_276 . V_311 , L_23 , F_142 ( V_114 ) ) ;
for ( V_21 = 0 ; V_21 < F_177 ( V_312 ) ; V_21 ++ ) {
V_2 -> V_313 = V_21 ;
if ( ! F_181 ( & V_2 -> V_276 , V_314 ) ) {
F_69 ( V_146 L_24 ,
F_155 ( V_2 ) -> V_159 ) ;
F_182 ( V_2 -> V_276 . V_150 , F_155 ( V_2 ) -> V_159 ,
sizeof( V_2 -> V_276 . V_150 ) ) ;
break;
}
}
V_309:
...
static int F_183 ( struct V_211 * V_114 ,
...
V_111 = F_184 ( V_20 [ V_112 ] , V_173 [ V_112 ] , V_314 , 0 , & V_150 ) ;
if ( V_111 < 0 )
return V_111 ;
if ( V_115 [ V_112 ] < 128 )
V_115 [ V_112 ] = 128 ;
...
switch ( V_2 -> type ) {
case V_324 :
strcpy ( V_150 -> V_266 , L_25 ) ;
strcpy ( V_150 -> V_325 , L_26 ) ;
break;
case V_326 :
strcpy ( V_150 -> V_266 , L_27 ) ;
strcpy ( V_150 -> V_325 , L_28 ) ;
break;
case V_327 :
strcpy ( V_150 -> V_266 , L_29 ) ;
strcpy ( V_150 -> V_325 , L_30 ) ;
break;
}
if ( ( V_111 = F_90 ( V_2 , 0 ) ) < 0 ) {
F_185 ( V_150 ) ;
return V_111 ;
}
if ( ( V_111 = F_107 ( V_2 ) ) < 0 ) {
F_185 ( V_150 ) ;
return V_111 ;
}
if ( V_328 [ V_112 ] == 2 ) {
unsigned short V_205 ;
F_111 ( V_2 -> V_114 , V_206 , & V_205 ) ;
for ( V_21 = 0 ; V_21 < F_177 ( V_329 ) ; V_21 ++ ) {
if ( V_2 -> type == V_329 [ V_21 ] . type &&
V_205 == V_329 [ V_21 ] . V_269 ) {
V_328 [ V_112 ] = 0 ;
break;
}
}
...
#endif
F_119 ( V_2 ) ;
V_2 -> clock = clock [ V_112 ] ;
if ( ! V_2 -> clock )
F_85 ( V_2 ) ;
sprintf ( V_150 -> V_335 , L_34 ,
V_150 -> V_325 , V_2 -> V_5 , V_2 -> V_178 ) ;
if ( ( V_111 = F_187 ( V_150 ) ) < 0 ) {
F_185 ( V_150 ) ;
return V_111 ;
}
F_188 ( V_114 , V_150 ) ;
...
static void F_189 ( struct V_211 * V_114 )
{
F_185 ( F_190 ( V_114 ) ) ;
}
