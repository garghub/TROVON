...
V_69 = F_34 ( V_11 -> V_19 , V_11 -> V_16 == 0 , V_82 * 5 ) ;
V_12 = V_11 -> V_15 ;
if ( V_69 == 0 )
F_5 ( V_11 -> V_3 , L_19 ) ;
else if ( V_12 != V_78 )
...
static T_4 F_41 ( struct V_83 * V_84 )
{
return V_90 | V_91 | V_92 |
V_93 ;
}
static int F_42 ( unsigned long V_94 , unsigned int V_95 ,
...
static int F_43 ( struct V_10 * V_11 , unsigned int * V_100 )
{
struct V_101 * V_102 = V_11 -> V_102 ;
unsigned long V_94 = F_44 ( V_11 -> V_87 ) ;
...
V_103 /= 1000 ;
V_104 = F_42 ( V_94 , V_103 , & V_96 , & V_97 ) ;
if ( V_104 > V_103 ) {
F_15 ( V_11 -> V_3 ,
L_22 \
L_23 , V_103 , V_104 ) ;
...
{
struct V_10 * V_11 = F_48 ( V_114 ) ;
unsigned int V_100 ;
int V_116 ;
int V_12 ;
V_116 = F_44 ( V_11 -> V_87 ) - V_11 -> V_105 ;
if ( ( V_115 == V_117 && V_116 < 0 ) ||
( V_115 == V_118 && V_116 > 0 ) ) {
F_49 ( & V_11 -> V_84 ) ;
V_12 = F_43 ( V_11 , & V_100 ) ;
F_50 ( & V_11 -> V_84 ) ;
if ( V_12 < 0 )
F_15 ( V_11 -> V_3 , L_25 ) ;
else
F_51 ( V_11 -> V_3 , L_26 , V_100 ) ;
}
return 0 ;
}
static inline int F_52 ( struct V_10 * V_11 )
{
V_11 -> V_119 . V_120 = F_47 ;
return F_53 ( & V_11 -> V_119 ,
V_121 ) ;
}
static inline void F_54 ( struct V_10 * V_11 )
{
F_55 ( & V_11 -> V_119 ,
V_121 ) ;
}
...
{
unsigned long V_127 = V_24 | V_23 ;
struct V_101 * V_102 ;
unsigned int V_104 ;
V_102 = V_11 -> V_102 ;
F_17 ( V_102 -> V_128 , V_11 -> V_21 + V_129 ) ;
F_51 ( V_11 -> V_3 , L_30 , V_102 -> V_128 ) ;
F_9 ( V_127 , V_11 -> V_21 + V_22 ) ;
if ( F_43 ( V_11 , & V_104 ) != 0 ) {
F_9 ( 0 , V_11 -> V_21 + V_22 ) ;
F_15 ( V_11 -> V_3 , L_31 ) ;
return - V_64 ;
}
F_51 ( V_11 -> V_3 , L_32 , V_104 ) ;
F_5 ( V_11 -> V_3 , L_33 , V_127 ) ;
return 0 ;
}
static void
F_63 ( struct V_130 * V_131 , struct V_10 * V_11 )
{
struct V_101 * V_102 = V_11 -> V_102 ;
if ( ! V_131 )
return;
V_102 -> V_132 = - 1 ;
F_64 ( V_131 , L_34 , & V_102 -> V_110 ) ;
F_64 ( V_131 , L_35 , & V_102 -> V_128 ) ;
F_64 ( V_131 , L_36 ,
( T_4 * ) & V_102 -> V_106 ) ;
}
static void
...
V_11 = F_67 ( & V_2 -> V_3 , sizeof( struct V_10 ) , V_135 ) ;
if ( ! V_11 ) {
F_15 ( & V_2 -> V_3 , L_38 ) ;
return - V_136 ;
}
V_11 -> V_102 = F_67 ( & V_2 -> V_3 , sizeof( * V_102 ) , V_135 ) ;
if ( ! V_11 -> V_102 ) {
F_15 ( & V_2 -> V_3 , L_39 ) ;
return - V_136 ;
}
...
F_63 ( V_2 -> V_3 . V_4 , V_11 ) ;
F_68 ( V_11 -> V_84 . V_137 , L_40 , sizeof( V_11 -> V_84 . V_137 ) ) ;
V_11 -> V_84 . V_138 = V_139 ;
V_11 -> V_84 . V_140 = & V_141 ;
V_11 -> V_84 . V_88 = 2 ;
V_11 -> V_84 . V_142 = V_143 | V_144 ;
V_11 -> V_40 = 50 ;
F_69 ( & V_11 -> V_19 ) ;
V_11 -> V_3 = & V_2 -> V_3 ;
V_11 -> V_87 = F_70 ( & V_2 -> V_3 , L_41 ) ;
if ( F_71 ( V_11 -> V_87 ) ) {
F_15 ( & V_2 -> V_3 , L_42 ) ;
return - V_145 ;
}
F_5 ( & V_2 -> V_3 , L_43 , V_11 -> V_87 ) ;
V_134 = F_72 ( V_2 , V_146 , 0 ) ;
V_11 -> V_21 = F_73 ( & V_2 -> V_3 , V_134 ) ;
if ( F_71 ( V_11 -> V_21 ) )
return F_74 ( V_11 -> V_21 ) ;
F_5 ( & V_2 -> V_3 , L_44 ,
V_11 -> V_21 , V_134 ) ;
V_11 -> V_84 . V_85 = V_11 ;
V_11 -> V_84 . V_3 . V_147 = & V_2 -> V_3 ;
V_11 -> V_148 = F_75 ( V_11 -> V_3 ) ;
if ( V_11 -> V_102 -> V_149 ) {
V_11 -> V_102 -> V_149 ( F_76 ( V_11 -> V_3 ) ) ;
} else if ( F_71 ( V_11 -> V_148 ) && F_56 ( V_11 ) ) {
return - V_64 ;
}
F_37 ( V_11 -> V_87 ) ;
V_12 = F_62 ( V_11 ) ;
...
if ( ! ( V_11 -> V_17 & V_18 ) ) {
V_11 -> V_150 = V_12 = F_77 ( V_2 , 0 ) ;
if ( V_12 <= 0 ) {
F_15 ( & V_2 -> V_3 , L_46 ) ;
return V_12 ;
}
V_12 = F_78 ( & V_2 -> V_3 , V_11 -> V_150 , F_25 , 0 ,
F_79 ( & V_2 -> V_3 ) , V_11 ) ;
if ( V_12 != 0 ) {
F_15 ( & V_2 -> V_3 , L_47 , V_11 -> V_150 ) ;
return V_12 ;
}
}
V_12 = F_52 ( V_11 ) ;
...
V_11 -> V_84 . V_151 = V_11 -> V_102 -> V_132 ;
...
F_82 ( & V_2 -> V_3 ) ;
F_82 ( & V_11 -> V_84 . V_3 ) ;
F_51 ( & V_2 -> V_3 , L_50 , F_79 ( & V_11 -> V_84 . V_3 ) ) ;
return 0 ;
}
static int F_83 ( struct V_1 * V_2 )
{
struct V_10 * V_11 = F_84 ( V_2 ) ;
F_85 ( & V_11 -> V_84 . V_3 ) ;
F_85 ( & V_2 -> V_3 ) ;
F_54 ( V_11 ) ;
F_86 ( & V_11 -> V_84 ) ;
if ( V_2 -> V_3 . V_4 && F_71 ( V_11 -> V_148 ) )
F_61 ( V_11 ) ;
return 0 ;
}
static int F_87 ( struct V_152 * V_3 )
{
struct V_1 * V_2 = F_76 ( V_3 ) ;
struct V_10 * V_11 = F_84 ( V_2 ) ;
V_11 -> V_79 = 1 ;
return 0 ;
}
static int F_88 ( struct V_152 * V_3 )
{
struct V_1 * V_2 = F_76 ( V_3 ) ;
struct V_10 * V_11 = F_84 ( V_2 ) ;
V_11 -> V_79 = 0 ;
