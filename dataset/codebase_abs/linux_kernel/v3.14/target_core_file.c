...
static void F_68 ( struct V_2 * V_3 , unsigned char * V_76 ,
T_1 V_156 , T_1 * V_157 , T_8 V_158 ,
bool V_159 )
{
unsigned char * V_107 = V_76 ;
int V_81 ;
for ( V_81 = 0 ; V_81 < V_156 ; V_81 += V_3 -> V_75 ) {
* ( ( T_8 * ) & V_107 [ 0 ] ) = 0xffff ;
* ( ( V_160 * ) & V_107 [ 2 ] ) = F_69 ( V_158 ) ;
* ( ( V_161 * ) & V_107 [ 4 ] ) = F_70 ( * V_157 ) ;
if ( V_159 )
( * V_157 ) ++ ;
V_107 += V_3 -> V_75 ;
}
...
V_75 = ( V_3 -> V_168 -> V_169 ( V_3 ) + 1 ) * V_3 -> V_75 ;
V_79 = V_75 ;
F_6 ( L_62 ,
( unsigned long long ) V_75 ) ;
for ( V_162 = 0 ; V_162 < V_75 ; V_162 += V_156 ) {
F_68 ( V_3 , V_76 , V_156 , & V_157 , 0xffff ,
V_159 ) ;
V_78 = F_72 ( V_156 , V_79 ) ;
