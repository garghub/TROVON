...
static int T_3 F_45 ( struct V_23 * V_23 )
{
short V_3 ;
int V_17 , V_18 , V_19 ;
T_1 V_1 [ 3 ] ;
...
V_3 = F_51 ( V_16 -> V_18 , V_60 , 0 , V_16 -> V_46 , V_16 ) ;
if ( V_3 )
return V_3 ;
F_16 ( 0 ) ;
if ( V_14 > 3 )
...
int V_17 = V_16 -> V_22 ;
F_54 ( L_15 ,
V_16 -> V_46 , F_49 ( V_17 + V_62 ) , F_17 ( V_17 + V_61 ) ,
F_17 ( V_17 + V_63 ) ) ;
V_16 -> V_64 . V_65 ++ ;
V_16 -> V_66 = V_67 ;
F_18 ( V_57 , V_17 + V_51 ) ;
...
static T_5
F_56 ( struct V_69 * V_70 , struct V_15 * V_16 )
{
struct V_8 * V_9 = F_6 ( V_16 ) ;
int V_17 = V_16 -> V_22 ;
unsigned long V_71 ;
...
F_18 ( 0x00 , V_17 + V_74 ) ;
F_59 ( V_17 + V_74 , V_70 -> V_75 , ( V_70 -> V_73 + 3 ) >> 2 ) ;
...
short V_77 ;
int V_3 = 4 ;
while ( -- V_3 > 0 && ( V_77 = F_49 ( V_17 + V_62 ) ) > 0 ) {
...
F_16 ( 6 ) ;
V_16 -> V_64 . V_103 += F_49 ( V_17 + 0 ) ;
V_16 -> V_64 . V_104 += F_49 ( V_17 + 1 ) ;
F_49 ( V_17 + 2 ) ;
V_16 -> V_64 . V_105 += F_49 ( V_17 + 3 ) ;
V_16 -> V_64 . V_106 += F_49 ( V_17 + 4 ) ;
V_16 -> V_64 . V_107 += F_49 ( V_17 + 5 ) ;
V_16 -> V_64 . V_108 += F_49 ( V_17 + 6 ) ;
F_49 ( V_17 + 7 ) ;
F_49 ( V_17 + 8 ) ;
F_17 ( V_17 + 10 ) ;
F_17 ( V_17 + 12 ) ;
...
struct V_69 * V_70 ;
V_70 = F_71 ( V_16 , V_118 + 5 ) ;
if ( V_14 > 4 )
F_8 ( L_23 ,
V_118 , V_110 ) ;
if ( V_70 != NULL ) {
F_72 ( V_70 , 2 ) ;
F_73 ( V_17 + V_119 , F_74 ( V_70 , V_118 ) ,
( V_118 + 3 ) >> 2 ) ;
F_18 ( V_112 , V_17 + V_51 ) ;
V_70 -> V_120 = F_75 ( V_70 , V_16 ) ;
F_76 ( V_70 ) ;
...
static int
F_83 ( struct V_15 * V_16 , struct V_128 * V_129 )
{
T_7 V_126 ;
int V_17 = V_16 -> V_22 ;
F_16 ( 0 ) ;
...
static int
F_85 ( struct V_15 * V_16 , struct V_128 * V_129 )
{
T_7 V_126 ;
int V_17 = V_16 -> V_22 ;
...
static void F_87 ( struct V_15 * V_16 , struct V_155 * V_156 )
{
F_88 ( V_156 -> V_157 , V_158 , sizeof( V_156 -> V_157 ) ) ;
F_88 ( V_156 -> V_47 , V_159 , sizeof( V_156 -> V_47 ) ) ;
}
static int F_89 ( struct V_15 * V_16 , struct V_128 * V_129 )
{
struct V_8 * V_9 = F_6 ( V_16 ) ;
int V_160 ;
F_90 ( & V_9 -> V_40 ) ;
V_160 = F_83 ( V_16 , V_129 ) ;
F_91 ( & V_9 -> V_40 ) ;
return V_160 ;
}
static int F_92 ( struct V_15 * V_16 , struct V_128 * V_129 )
{
struct V_8 * V_9 = F_6 ( V_16 ) ;
int V_160 ;
F_90 ( & V_9 -> V_40 ) ;
V_160 = F_85 ( V_16 , V_129 ) ;
F_91 ( & V_9 -> V_40 ) ;
return V_160 ;
}
...
static void F_95 ( struct V_15 * V_16 , T_8 V_161 )
{
V_14 = V_161 ;
}
static void
