...
return 0 ;
return F_20 ( V_2 , V_28 , V_29 , V_44 ) ;
}
...
{
const struct V_75 * V_76 = F_31 ( V_2 ) ;
switch ( V_76 -> V_77 ) {
case V_78 :
F_7 ( 0 , V_2 -> V_13 + V_79 ) ;
F_7 ( 0 , V_2 -> V_13 + V_79 + 1 ) ;
F_7 ( 0 , V_2 -> V_13 + V_80 ) ;
F_7 ( 0 , V_2 -> V_13 + V_80 + 1 ) ;
case V_81 :
F_7 ( 0 , V_2 -> V_13 + V_82 ) ;
F_7 ( 0x0f , V_2 -> V_13 + V_83 ) ;
F_7 ( 0 , V_2 -> V_13 + V_84 ) ;
break;
case V_85 :
F_7 ( 0 , V_2 -> V_13 + V_86 ) ;
F_7 ( 0 , V_2 -> V_13 + V_86 + 1 ) ;
F_7 ( 0 , V_2 -> V_13 + V_86 + 2 ) ;
F_7 ( 0 , V_2 -> V_13 + V_86 + 3 ) ;
break;
case V_87 :
F_7 ( 0 , V_2 -> V_13 + V_88 ) ;
...
F_18 ( V_2 -> V_13 + V_89 , 0 , 0 , V_90 ) ;
F_18 ( V_2 -> V_13 + V_89 , 0 , 1 , V_90 ) ;
F_18 ( V_2 -> V_13 + V_89 , 0 , 2 , V_90 ) ;
break;
case V_91 :
F_7 ( 0 , V_2 -> V_13 + V_92 ) ;
F_7 ( 0 , V_2 -> V_13 + V_92 + 1 ) ;
F_7 ( 0 , V_2 -> V_13 + V_93 ) ;
F_7 ( 0x0f , V_2 -> V_13 + V_94 ) ;
F_7 ( 0 , V_2 -> V_13 + V_95 ) ;
break;
case V_96 :
F_7 ( 0x88 , V_2 -> V_13 + V_97 ) ;
break;
case V_98 :
case V_99 :
F_7 ( 0x88 , V_2 -> V_13 + V_100 ) ;
break;
case V_101 :
F_9 ( 0 , V_2 -> V_13 + V_102 ) ;
F_9 ( 0 , V_2 -> V_13 + V_103 ) ;
F_9 ( 0 , V_2 -> V_13 + V_103 + 2 ) ;
F_9 ( 0 , V_2 -> V_13 + V_104 ) ;
F_9 ( 0 , V_2 -> V_13 + V_104 + 2 ) ;
break;
case V_105 :
F_7 ( 0x88 , V_2 -> V_13 + V_106 ) ;
F_7 ( 0x80 , V_2 -> V_13 + V_107 ) ;
F_7 ( 0x80 , V_2 -> V_13 + V_108 ) ;
F_7 ( 0x80 , V_2 -> V_13 + V_109 ) ;
case V_110 :
F_7 ( 0x88 , V_2 -> V_13 + V_111 ) ;
F_7 ( 0x80 , V_2 -> V_13 + V_112 ) ;
F_7 ( 0x80 , V_2 -> V_13 + V_113 ) ;
F_7 ( 0x80 , V_2 -> V_13 + V_114 ) ;
break;
case V_115 :
F_9 ( 0x08 , V_2 -> V_13 + V_116 ) ;
F_9 ( 0x08 , V_2 -> V_13 + V_117 ) ;
...
F_9 ( 0x08 , V_2 -> V_13 + V_116 ) ;
F_9 ( 0x08 , V_2 -> V_13 + V_117 ) ;
F_9 ( 0 , V_2 -> V_13 + V_121 ) ;
F_9 ( 0 , V_2 -> V_13 + V_121 + 2 ) ;
break;
case V_122 :
F_29 ( V_2 ) ;
break;
case V_123 :
F_9 ( 0x0101 , V_2 -> V_13 + V_124 ) ;
break;
}
return 0 ;
}
...
static unsigned long F_36 ( struct V_150 * V_151 ,
unsigned long V_77 )
{
if ( V_77 != V_110 )
return V_77 ;
...
return - V_158 ;
V_2 -> V_159 = V_76 ;
V_2 -> V_160 = V_76 -> V_161 ;
V_49 = F_45 ( V_2 , sizeof( * V_49 ) ) ;
if ( ! V_49 )
return - V_162 ;
V_24 = F_46 ( V_2 ) ;
if ( V_24 )
return V_24 ;
V_2 -> V_13 = F_39 ( V_151 , V_76 -> V_163 ) ;
V_24 = F_47 ( V_2 , V_76 -> V_164 ) ;
if ( V_24 )
return V_24 ;
V_155 = 0 ;
for ( V_11 = 0 ; V_11 < V_165 ; V_11 ++ )
if ( V_76 -> V_166 [ V_11 ] . V_145 ) {
V_4 = & V_2 -> V_125 [ V_155 ] ;
F_33 ( V_2 , V_4 , & V_76 -> V_166 [ V_11 ] ) ;
V_155 ++ ;
}
for ( V_11 = 0 ; V_11 < V_167 ; V_11 ++ )
if ( V_76 -> V_168 [ V_11 ] . V_145 ) {
V_4 = & V_2 -> V_125 [ V_155 ] ;
F_34 ( V_2 , V_4 , & V_76 -> V_168 [ V_11 ] ) ;
V_155 ++ ;
}
for ( V_11 = 0 ; V_11 < V_169 ; V_11 ++ )
for ( V_156 = 0 ; V_156 < V_76 -> V_170 [ V_11 ] . V_12 ; V_156 ++ ) {
V_4 = & V_2 -> V_125 [ V_155 ] ;
F_48 ( V_2 , V_4 , NULL ,
V_2 -> V_13 +
V_76 -> V_170 [ V_11 ] . V_14 +
V_171 * V_156 ) ;
V_155 ++ ;
}
if ( V_76 -> V_172 . V_145 ) {
V_4 = & V_2 -> V_125 [ V_155 ] ;
V_4 -> type = V_126 ;
F_33 ( V_2 , V_4 , & V_76 -> V_172 ) ;
V_155 ++ ;
}
for ( V_11 = 0 ; V_11 < V_173 ; V_11 ++ )
if ( V_76 -> V_174 [ V_11 ] . V_145 ) {
V_4 = & V_2 -> V_125 [ V_155 ] ;
F_35 ( V_2 , V_4 , & V_76 -> V_174 [ V_11 ] ) ;
V_155 ++ ;
}
if ( V_76 -> V_77 == V_122 )
F_32 ( V_2 ) ;
...
static int F_51 ( struct V_150 * V_2 ,
const struct V_176 * V_177 )
{
unsigned long V_77 ;
V_77 = F_36 ( V_2 , V_177 -> V_178 ) ;
return F_52 ( V_2 , & V_179 , V_77 ) ;
}
