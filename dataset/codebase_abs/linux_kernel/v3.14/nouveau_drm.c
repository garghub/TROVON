...
F_94 ( V_21 , L_13 ) ;
if ( V_21 -> V_25 && F_18 ( V_21 ) -> V_92 ) {
if ( ! F_18 ( V_21 ) -> V_92 ( V_21 ) ) {
V_11 = - V_60 ;
goto V_91;
}
}
...
static int
F_117 ( struct V_68 * V_69 , struct V_101 * V_102 )
{
struct V_1 * V_2 = V_69 -> V_2 ;
struct V_20 * V_21 = V_20 ( V_69 ) ;
struct V_9 * V_10 ;
char V_3 [ 32 ] , V_103 [ V_104 ] ;
int V_11 ;
V_11 = F_84 ( V_69 -> V_69 ) ;
if ( V_11 < 0 )
return V_11 ;
F_118 ( V_103 , V_105 ) ;
snprintf ( V_3 , sizeof( V_3 ) , L_19 , V_103 , F_119 ( V_102 -> V_106 ) ) ;
...
static void
F_124 ( struct V_68 * V_69 , struct V_101 * V_102 )
{
struct V_9 * V_10 = V_9 ( V_102 ) ;
struct V_20 * V_21 = V_20 ( V_69 ) ;
F_84 ( V_69 -> V_69 ) ;
if ( V_10 -> V_110 )
F_125 ( V_10 -> V_110 ) ;
...
static void
F_127 ( struct V_68 * V_69 , struct V_101 * V_102 )
{
struct V_9 * V_10 = V_9 ( V_102 ) ;
F_9 ( V_10 ) ;
F_76 ( V_69 -> V_69 ) ;
...
long F_128 ( struct V_111 * V_112 ,
unsigned int V_113 , unsigned long V_114 )
{
struct V_101 * V_115 = V_112 -> V_116 ;
struct V_68 * V_69 ;
long V_11 ;
V_69 = V_115 -> V_117 -> V_69 ;
V_11 = F_84 ( V_69 -> V_69 ) ;
if ( V_11 < 0 )
return V_11 ;
V_11 = F_129 ( V_112 , V_113 , V_114 ) ;
F_76 ( V_69 -> V_69 ) ;
F_123 ( V_69 -> V_69 ) ;
return V_11 ;
}
...
static int F_139 ( struct V_27 * V_69 )
{
struct V_1 * V_2 = F_103 ( V_69 ) ;
struct V_68 * V_95 = F_90 ( V_2 ) ;
struct V_26 * V_27 = F_140 ( V_95 ) ;
int V_11 ;
if ( V_87 == 0 )
return - V_122 ;
F_107 ( V_2 , V_100 ) ;
...
static int F_142 ( struct V_27 * V_69 )
{
struct V_1 * V_2 = F_103 ( V_69 ) ;
struct V_68 * V_95 = F_90 ( V_2 ) ;
struct V_20 * V_21 = V_20 ( V_95 ) ;
struct V_126 * V_127 ;
if ( V_87 == 0 ) {
F_131 ( V_69 ) ;
return - V_118 ;
