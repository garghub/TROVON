...
V_7 = F_63 ( & V_148 -> V_11 , sizeof( struct V_1 ) ,
V_112 ) ;
if ( V_7 == NULL ) {
F_6 ( & V_148 -> V_11 ,
L_44 ) ;
...
V_7 -> V_11 = & V_148 -> V_11 ;
V_7 -> V_44 = F_64 ( V_148 -> V_11 . V_44 ) ;
V_7 -> V_3 = V_154 ;
V_7 -> V_3 . V_11 = & V_148 -> V_11 ;
V_7 -> V_3 . V_76 = - 1 ;
V_151 = F_65 ( V_155 , & V_148 -> V_11 ) ;
if ( ! V_151 ) {
F_6 ( & V_148 -> V_11 , L_45 ) ;
return - V_97 ;
}
...
V_10 = F_70 ( & V_7 -> V_3 ) ;
if ( V_10 ) {
F_6 ( & V_148 -> V_11 , L_48 , V_10 ) ;
return V_10 ;
}
F_71 ( & V_148 -> V_11 , L_49 ) ;
V_162 . V_90 = V_7 -> V_23 -> V_90 ;
V_162 . V_89 = V_7 -> V_23 -> V_89 ;
V_7 -> V_47 = F_72 ( & V_162 , & V_148 -> V_11 , V_7 ) ;
if ( ! V_7 -> V_47 ) {
F_6 ( & V_148 -> V_11 ,
L_50 ) ;
V_10 = - V_27 ;
...
F_75 ( V_148 , V_7 ) ;
F_71 ( & V_148 -> V_11 , L_52 ) ;
return 0 ;
V_163:
V_153 = F_76 ( & V_7 -> V_3 ) ;
if ( V_153 )
F_71 ( & V_148 -> V_11 , L_53 ) ;
return V_10 ;
}
static int F_77 ( struct V_147 * V_148 )
{
struct V_1 * V_7 = F_78 ( V_148 ) ;
int V_10 ;
V_10 = F_76 ( & V_7 -> V_3 ) ;
if ( V_10 < 0 ) {
F_6 ( V_7 -> V_11 , L_54 ,
