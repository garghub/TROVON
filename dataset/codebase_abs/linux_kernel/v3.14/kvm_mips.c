...
void F_37 ( struct V_7 * V_7 , struct V_30 * free ,
struct V_30 * V_31 )
{
}
int F_38 ( struct V_7 * V_7 , struct V_30 * V_32 ,
unsigned long V_33 )
{
return 0 ;
}
void F_39 ( struct V_7 * V_7 )
{
}
...
V_7 -> V_4 . V_20 = V_33 ;
V_7 -> V_4 . V_21 =
F_42 ( V_33 * sizeof( unsigned long ) , V_45 ) ;
if ( ! V_7 -> V_4 . V_21 ) {
F_43 ( L_5 ) ;
V_40 = - V_46 ;
goto V_47;
...
void F_46 ( struct V_7 * V_7 )
{
}
struct V_1 * F_47 ( struct V_7 * V_7 , unsigned int V_48 )
{
...
void * V_55 ;
int V_3 ;
struct V_1 * V_2 = F_42 ( sizeof( struct V_1 ) , V_45 ) ;
if ( ! V_2 ) {
V_40 = - V_46 ;
goto V_47;
}
V_40 = F_48 ( V_2 , V_7 , V_48 ) ;
if ( V_40 )
goto V_56;
...
V_2 -> V_4 . V_60 = ( void * ) F_49 () ;
V_55 = F_42 ( F_50 ( V_53 , V_61 ) , V_45 ) ;
if ( ! V_55 ) {
V_40 = - V_46 ;
goto V_56;
}
...
V_52 - V_51 ) ;
F_51 ( ( unsigned long ) V_55 , F_50 ( V_53 , V_61 ) ) ;
V_2 -> V_4 . V_63 = F_42 ( V_61 << 1 , V_45 ) ;
if ( ! V_2 -> V_4 . V_63 ) {
V_40 = - V_46 ;
goto V_64;
}
...
int F_60 ( struct V_1 * V_2 , struct V_69 * V_70 )
{
int V_12 = 0 ;
T_2 V_71 ;
if ( V_2 -> V_72 )
F_61 ( V_73 , & V_2 -> V_74 , & V_71 ) ;
if ( V_2 -> V_75 ) {
if ( ! V_2 -> V_76 )
F_62 ( V_2 , V_70 ) ;
V_2 -> V_75 = 0 ;
...
int
F_70 ( struct V_1 * V_2 , struct V_78 * V_79 )
{
...
if ( ( V_91 -> V_48 & V_117 ) == V_118 ) {
T_4 T_5 * V_119 = ( T_4 T_5 * ) ( long ) V_91 -> V_120 ;
if ( F_91 ( V_93 , V_119 ) != 0 )
return - V_124 ;
} else if ( ( V_91 -> V_48 & V_117 ) == V_121 ) {
T_6 T_5 * V_122 = ( T_6 T_5 * ) ( long ) V_91 -> V_120 ;
T_7 V_123 ;
if ( F_91 ( V_123 , V_122 ) != 0 )
return - V_124 ;
V_93 = ( T_3 ) V_123 ;
} else {
return - V_85 ;
...
long
F_101 ( struct V_26 * V_27 , unsigned int V_28 , unsigned long V_15 )
{
...
case V_129 : {
struct V_90 V_91 ;
if ( F_102 ( & V_91 , V_127 , sizeof( V_91 ) ) )
return - V_124 ;
if ( V_28 == V_128 )
return F_90 ( V_2 , & V_91 ) ;
else
return F_75 ( V_2 , & V_91 ) ;
}
case V_130 : {
...
struct V_131 V_134 ;
unsigned V_135 ;
if ( F_102 ( & V_134 , V_132 , sizeof( V_134 ) ) )
return - V_124 ;
V_135 = V_134 . V_135 ;
V_134 . V_135 = F_103 ( V_136 ) ;
if ( F_104 ( V_132 , & V_134 , sizeof( V_134 ) ) )
return - V_124 ;
if ( V_135 < V_134 . V_135 )
return - V_137 ;
V_133 = V_132 -> V_91 ;
if ( F_104 ( V_133 , V_136 ,
sizeof( V_136 ) ) )
return - V_124 ;
return 0 ;
}
...
struct V_78 V_79 ;
V_12 = - V_124 ;
if ( F_102 ( & V_79 , V_127 , sizeof( V_79 ) ) )
goto V_47;
...
int F_105 ( struct V_7 * V_7 , struct V_141 * log )
{
struct V_30 * V_34 ;
...
long F_109 ( struct V_26 * V_27 , unsigned int V_28 , unsigned long V_15 )
{
long V_12 ;
switch ( V_28 ) {
default:
...
int
F_114 ( struct V_1 * V_2 , struct V_152 * V_153 )
{
return - V_29 ;
}
...
int F_117 ( struct V_1 * V_2 , struct V_154 * V_155 )
{
return - V_29 ;
}
int F_118 ( struct V_1 * V_2 , struct V_156 * V_157 )
{
return V_158 ;
}
int F_119 ( long V_159 )
{
int V_12 ;
switch ( V_159 ) {
case V_160 :
...
return - 1 ;
F_107 ( L_17 ) ;
F_107 ( L_18 , V_2 -> V_4 . V_102 ) ; ;
F_107 ( L_19 , V_2 -> V_4 . V_9 ) ;
...
F_107 ( L_21 , V_2 -> V_4 . V_98 ) ;
F_107 ( L_22 , V_2 -> V_4 . V_100 ) ;
V_77 = V_2 -> V_4 . V_77 ;
F_107 ( L_23 ,
F_82 ( V_77 ) , F_64 ( V_77 ) ) ;
F_107 ( L_24 , F_123 ( V_77 ) ) ;
return 0 ;
}
int F_124 ( struct V_1 * V_2 , struct V_163 * V_164 )
{
int V_3 ;
for ( V_3 = 1 ; V_3 < F_103 ( V_2 -> V_4 . V_96 ) ; V_3 ++ )
...
int F_125 ( struct V_1 * V_2 , struct V_163 * V_164 )
{
int V_3 ;
for ( V_3 = 0 ; V_3 < F_103 ( V_2 -> V_4 . V_96 ) ; V_3 ++ )
...
void F_126 ( unsigned long V_166 )
{
...
enum V_168 F_127 ( struct V_169 * V_170 )
{
struct V_1 * V_2 ;
V_2 = F_128 ( V_170 , struct V_1 , V_4 . V_66 ) ;
F_126 ( ( unsigned long ) V_2 ) ;
F_129 ( & V_2 -> V_4 . V_66 ,
F_130 ( 0 , F_131 ( 10 ) ) ) ;
return V_171 ;
}
...
{
V_16 -> V_172 ( V_2 ) ;
F_133 ( & V_2 -> V_4 . V_66 , V_173 ,
V_174 ) ;
V_2 -> V_4 . V_66 . V_175 = F_127 ;
return 0 ;
}
