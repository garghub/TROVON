...
static int F_29 ( struct V_47 * V_29 ,
struct V_25 * V_64 ,
struct V_65 * V_42 ,
int V_40 )
{
...
T_1 V_67 ;
V_64 -> V_68 = 0 ;
V_30 = F_30 ( V_29 , L_5 , & V_67 ) ;
if ( V_30 == 0 )
V_64 -> V_68 = V_67 ;
V_10 = F_31 ( V_29 , L_6 , 0 ) ;
if ( ! V_10 ) {
F_32 ( L_7 ) ;
return - V_23 ;
}
...
V_64 -> V_28 = V_66 . V_29 ;
if ( V_66 . V_63 >= 2 ) {
V_64 -> V_32 = V_66 . args [ 0 ] ;
V_64 -> V_33 = V_66 . args [ 1 ] ;
} else {
F_32 ( L_11 ) ;
}
V_69:
...
static int F_33 ( struct V_47 * V_29 ,
enum V_39 * type )
{
const char * V_70 ;
int V_71 , V_22 ;
V_71 = F_34 ( V_29 , L_12 , & V_70 ) ;
if ( V_71 < 0 )
return V_71 ;
for ( V_22 = 0 ; V_22 < F_35 ( V_72 ) ; V_22 ++ )
...
static int F_36 ( struct V_47 * V_29 ,
struct V_65 * V_10 )
{
int V_67 ;
int V_30 ;
V_30 = F_30 ( V_29 , L_13 , & V_67 ) ;
if ( V_30 < 0 ) {
F_32 ( L_14 ) ;
return V_30 ;
}
V_10 -> V_43 = V_67 ;
V_30 = F_30 ( V_29 , L_15 , & V_67 ) ;
if ( V_30 < 0 ) {
F_32 ( L_16 ) ;
return V_30 ;
}
V_10 -> V_45 = V_67 ;
V_30 = F_33 ( V_29 , & V_10 -> type ) ;
if ( V_30 < 0 ) {
F_32 ( L_17 ) ;
return V_30 ;
}
...
if ( ! V_2 )
return F_21 ( - V_75 ) ;
V_30 = F_30 ( V_29 , L_19 , & V_67 ) ;
if ( V_30 < 0 ) {
F_32 ( L_20 ) ;
goto V_76;
}
V_2 -> V_77 = V_67 ;
V_30 = F_30 ( V_29 , L_21 , & V_67 ) ;
if ( V_30 < 0 ) {
F_32 ( L_22 ) ;
goto V_76;
}
...
if ( V_2 -> V_40 == 0 )
goto V_78;
V_2 -> V_42 = F_38 ( V_2 -> V_40 * sizeof( * V_2 -> V_42 ) , V_74 ) ;
if ( ! V_2 -> V_42 ) {
V_30 = - V_75 ;
goto V_76;
}
...
if ( V_2 -> V_24 == 0 )
goto V_78;
V_2 -> V_27 = F_38 ( V_2 -> V_24 * sizeof( * V_2 -> V_27 ) , V_74 ) ;
if ( ! V_2 -> V_27 ) {
V_30 = - V_75 ;
goto V_79;
}
...
static inline void F_42 ( struct V_4 * V_2 )
{
F_41 ( V_2 -> V_27 ) ;
F_41 ( V_2 -> V_42 ) ;
F_41 ( V_2 ) ;
...
V_53 = F_46 ( & V_85 , sizeof( * V_53 ) , V_74 ) ;
if ( ! V_53 )
goto V_86;
V_84 = F_38 ( sizeof( * V_84 ) , V_74 ) ;
if ( ! V_84 ) {
F_41 ( V_53 ) ;
goto V_86;
}
V_84 -> V_87 = true ;
V_48 = F_47 ( V_57 -> V_51 , V_2 -> V_40 ,
0 , V_2 ,
V_53 , V_84 ,
V_2 -> V_77 ,
V_2 -> V_38 ) ;
