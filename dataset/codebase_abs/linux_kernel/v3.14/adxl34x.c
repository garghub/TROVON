...
static T_2 F_37 ( struct V_76 * V_8 ,
struct V_77 * V_78 ,
const char * V_5 , T_3 V_79 )
{
struct V_1 * V_2 = F_25 ( V_8 ) ;
...
static void F_40 ( struct V_25 * V_19 )
{
struct V_1 * V_2 = F_39 ( V_19 ) ;
F_2 ( & V_2 -> V_11 ) ;
if ( ! V_2 -> V_73 && ! V_2 -> V_74 )
...
struct V_1 * F_41 ( struct V_76 * V_8 , int V_33 ,
bool V_92 ,
...
break;
default:
F_42 ( V_8 , L_8 , V_25 -> V_103 ) ;
V_94 = - V_97 ;
goto V_101;
}
snprintf ( V_2 -> V_108 , sizeof( V_2 -> V_108 ) , L_9 , F_47 ( V_8 ) ) ;
V_25 -> V_108 = V_2 -> V_108 ;
V_25 -> V_8 . V_109 = V_8 ;
V_25 -> V_110 . V_111 = V_2 -> V_106 ;
V_25 -> V_110 . V_112 = V_6 -> V_112 ;
V_25 -> V_113 = F_38 ;
V_25 -> V_114 = F_40 ;
F_48 ( V_25 , V_2 ) ;
F_49 ( V_2 -> V_18 . V_20 , V_25 -> V_115 ) ;
if ( V_2 -> V_18 . V_20 == V_116 ) {
F_49 ( V_117 , V_25 -> V_118 ) ;
F_49 ( V_119 , V_25 -> V_118 ) ;
F_49 ( V_120 , V_25 -> V_118 ) ;
} else {
F_49 ( V_121 , V_25 -> V_122 ) ;
F_49 ( V_123 , V_25 -> V_122 ) ;
F_49 ( V_124 , V_25 -> V_122 ) ;
if ( V_18 -> V_125 & V_126 )
V_95 = V_127 ;
else
V_95 = V_128 ;
F_50 ( V_25 , V_121 , - V_95 , V_95 , 3 , 3 ) ;
F_50 ( V_25 , V_123 , - V_95 , V_95 , 3 , 3 ) ;
F_50 ( V_25 , V_124 , - V_95 , V_95 , 3 , 3 ) ;
}
F_49 ( V_129 , V_25 -> V_115 ) ;
F_49 ( V_18 -> V_32 [ V_30 ] , V_25 -> V_130 ) ;
F_49 ( V_18 -> V_32 [ V_131 ] , V_25 -> V_130 ) ;
F_49 ( V_18 -> V_32 [ V_31 ] , V_25 -> V_130 ) ;
if ( V_18 -> V_47 ) {
V_2 -> V_132 = V_46 ;
F_49 ( V_18 -> V_47 , V_25 -> V_130 ) ;
}
if ( V_18 -> V_51 )
F_49 ( V_18 -> V_51 , V_25 -> V_130 ) ;
V_2 -> V_132 |= V_52 | V_53 ;
if ( V_18 -> V_133 ) {
V_2 -> V_132 |= V_65 ;
if ( ! F_51 ( V_18 -> V_66 ) )
...
if ( V_18 -> V_40 & ( V_41 | V_42 | V_43 ) )
V_2 -> V_132 |= V_49 | V_50 ;
if ( F_51 ( V_18 -> V_66 ) == V_135 )
V_2 -> V_68 = false ;
F_20 ( V_2 , V_70 , 0 ) ;
V_94 = F_52 ( V_2 -> V_33 , NULL , F_12 ,
V_136 | V_137 ,
F_47 ( V_8 ) , V_2 ) ;
if ( V_94 ) {
F_42 ( V_8 , L_10 , V_2 -> V_33 ) ;
goto V_101;
}
V_94 = F_53 ( & V_8 -> V_138 , & V_139 ) ;
if ( V_94 )
goto V_140;
V_94 = F_54 ( V_25 ) ;
if ( V_94 )
goto V_141;
F_20 ( V_2 , V_82 , V_18 -> V_142 ) ;
V_2 -> V_81 . V_13 = V_18 -> V_142 ;
F_20 ( V_2 , V_84 , V_18 -> V_143 ) ;
V_2 -> V_81 . V_15 = V_18 -> V_143 ;
F_20 ( V_2 , V_85 , V_18 -> V_144 ) ;
V_2 -> V_81 . V_16 = V_18 -> V_144 ;
F_20 ( V_2 , V_145 , V_18 -> V_146 ) ;
F_20 ( V_2 , V_147 , V_18 -> V_148 ) ;
F_20 ( V_2 , V_149 , V_18 -> V_150 ) ;
F_20 ( V_2 , V_151 , V_18 -> V_152 ) ;
F_20 ( V_2 , V_153 , V_18 -> V_154 ) ;
F_20 ( V_2 , V_155 , V_18 -> V_156 ) ;
F_20 ( V_2 , V_157 , V_18 -> V_158 ) ;
F_20 ( V_2 , V_159 , V_18 -> V_160 ) ;
F_20 ( V_2 , V_161 , V_18 -> V_162 ) ;
F_20 ( V_2 , V_163 , V_18 -> V_40 ) ;
F_20 ( V_2 , V_164 , V_18 -> V_165 ) ;
F_20 ( V_2 , V_87 , F_31 ( V_2 -> V_18 . V_86 ) |
( V_18 -> V_88 ? V_89 : 0 ) ) ;
F_20 ( V_2 , V_166 , V_18 -> V_125 ) ;
F_20 ( V_2 , V_167 , F_51 ( V_18 -> V_66 ) |
F_55 ( V_18 -> V_133 ) ) ;
if ( V_18 -> V_168 ) {
F_20 ( V_2 , V_169 , V_2 -> V_132 | V_48 ) ;
} else {
F_20 ( V_2 , V_169 , 0 ) ;
}
if ( V_2 -> V_106 == 346 && V_2 -> V_18 . V_54 ) {
F_20 ( V_2 , V_170 ,
F_56 ( V_2 -> V_18 . V_171 ) |
F_57 ( V_2 -> V_18 . V_172 ) ) ;
V_2 -> V_58 = 1234 ;
V_2 -> V_62 = 1234 ;
if ( V_18 -> V_54 & V_60 )
for ( V_29 = 0 ; V_29 < F_58 ( V_18 -> V_63 ) ; V_29 ++ )
F_49 ( V_18 -> V_63 [ V_29 ] ,
V_25 -> V_130 ) ;
if ( V_18 -> V_54 & V_56 )
for ( V_29 = 0 ; V_29 < F_58 ( V_18 -> V_59 ) ; V_29 ++ )
F_49 ( V_18 -> V_59 [ V_29 ] ,
V_25 -> V_130 ) ;
} else {
V_2 -> V_18 . V_54 = 0 ;
}
F_20 ( V_2 , V_173 , V_2 -> V_132 | V_48 ) ;
V_2 -> V_18 . V_71 &= ( V_90 | V_91 ) ;
return V_2 ;
V_141:
F_59 ( & V_8 -> V_138 , & V_139 ) ;
V_140:
F_60 ( V_2 -> V_33 , V_2 ) ;
V_101:
F_61 ( V_25 ) ;
