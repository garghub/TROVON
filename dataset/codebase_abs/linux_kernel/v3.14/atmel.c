...
V_391 -> V_398 . V_184 = 100 ;
V_391 -> V_398 . V_188 = 0 ;
V_391 -> V_398 . V_185 = V_189 ;
V_391 -> V_399 . V_183 = 50 ;
V_391 -> V_399 . V_184 = 50 ;
V_391 -> V_399 . V_188 = 0 ;
...
return - V_193 ;
if ( ! memcmp ( V_421 , V_310 -> V_198 , 6 ) ||
! memcmp ( V_422 , V_310 -> V_198 , 6 ) ) {
F_64 ( & V_2 -> V_202 ) ;
F_27 ( & V_2 -> V_77 , V_68 ) ;
F_54 ( V_2 , 1 ) ;
F_28 ( & V_2 -> V_77 , V_68 ) ;
...
V_483 [ 0 ] = V_497 ;
V_483 [ 1 ] = V_2 -> V_206 ;
memcpy ( V_483 + 2 , V_2 -> V_204 , V_2 -> V_206 ) ;
V_483 [ 2 + V_2 -> V_206 ] = V_498 ;
V_483 [ 3 + V_2 -> V_206 ] = 4 ;
memcpy ( V_483 + 4 + V_2 -> V_206 , V_499 , 4 ) ;
...
T_1 V_287 , T_2 V_200 , T_2 V_503 , T_2 V_488 ,
T_2 * V_489 , int V_504 )
{
T_2 * V_505 = V_465 & V_495 ? V_67 -> V_89 : V_67 -> V_91 ;
int V_18 , V_305 ;
for ( V_305 = - 1 , V_18 = 0 ; V_18 < V_2 -> V_207 ; V_18 ++ )
if ( memcmp ( V_505 , V_2 -> V_373 [ V_18 ] . V_92 , V_88 ) == 0 )
V_305 = V_18 ;
if ( V_305 == - 1 ) {
if ( V_2 -> V_207 == V_506 )
return;
V_305 = V_2 -> V_207 ++ ;
memcpy ( V_2 -> V_373 [ V_305 ] . V_92 , V_505 , V_88 ) ;
...
memcpy ( V_2 -> V_373 [ V_305 ] . V_204 , V_489 , V_488 ) ;
...
int V_516 ;
V_2 -> V_373 [ ( int ) ( V_2 -> V_502 ) ] . V_200 |= 0x80 ;
...
T_1 V_521 = V_520 -> V_223 > 4 ? 4 : V_520 -> V_223 ;
union V_221 V_222 ;
if ( V_508 < 8 + V_521 )
return;
if ( V_23 == V_510 ) {
...
memcpy ( V_2 -> V_204 , V_505 -> V_204 , V_2 -> V_206 = V_505 -> V_376 ) ;
if ( V_2 -> V_45 )
F_58 ( V_2 ) ;
if ( V_505 -> V_380 == V_86 &&
V_2 -> V_85 != V_86 &&
...
V_2 -> V_539 * V_2 -> V_287 * ( V_2 -> V_127 . V_183 . V_184 + 100 ) / 4000 ;
V_2 -> V_539 = 0 ;
}
...
T_2 V_200 , V_549 , V_547 ;
T_11 V_545 = F_155 ( V_191 -> V_545 ) ;
...
V_222 . V_15 . V_223 = 0 ;
V_222 . V_15 . V_68 = 0 ;
F_70 ( V_2 -> V_13 , V_566 , & V_222 , NULL ) ;
}
}
break;
case V_567 :
...
F_36 ( V_13 , V_13 -> V_90 , F_9 ( V_13 , V_580 ) , 6 ) ;
if ( V_2 -> V_228 == V_229 )
F_11 ( V_13 , V_230 , 0x0060 ) ;
F_11 ( V_13 , V_230 , 0x0040 ) ;
V_262 = 1 ;
...
V_599 . V_83 = V_2 -> V_83 ;
V_599 . V_283 = V_2 -> V_283 ;
memcpy ( V_599 . V_603 , V_2 -> V_94 , V_88 ) ;
...
V_201 = F_159 ( & V_609 , V_2 -> V_248 , V_2 -> V_261 ) ;
if ( V_201 != 0 ) {
F_51 ( V_170
L_52 ,
...
F_150 ( V_2 , V_179 , V_527 , 1 ) ;
F_150 ( V_2 , V_179 , V_634 , V_2 -> V_286 ) ;
F_151 ( V_2 , V_217 , V_524 , V_499 , 4 ) ;
F_66 ( V_2 , V_179 , V_635 , V_2 -> V_83 ) ;
if ( V_2 -> V_45 )
F_58 ( V_2 ) ;
else
F_158 ( V_2 ) ;
