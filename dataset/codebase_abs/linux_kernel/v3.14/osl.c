...
bool F_129 ( struct V_150 * V_151 )
{
return F_128 ( V_168 , V_151 ) ;
}
T_11
F_130 ( T_1 V_169 , T_1 V_170 , T_21 * V_171 )
{
struct V_172 * V_173 = NULL ;
V_173 = F_131 ( sizeof( struct V_172 ) ) ;
if ( ! V_173 )
return V_160 ;
...
T_11 F_133 ( T_21 V_171 )
{
struct V_172 * V_173 = (struct V_172 * ) V_171 ;
if ( ! V_173 )
return V_64 ;
F_120 ( ( V_174 , L_37 , V_171 ) ) ;
F_134 ( ! F_135 ( & V_173 -> V_175 ) ) ;
F_38 ( V_173 ) ;
V_173 = NULL ;
return V_65 ;
}
T_11 F_136 ( T_21 V_171 , T_1 V_176 , V_132 V_177 )
{
T_11 V_154 = V_65 ;
struct V_172 * V_173 = (struct V_172 * ) V_171 ;
long V_178 ;
...
T_11 F_141 ( T_21 V_171 , T_1 V_176 )
{
struct V_172 * V_173 = (struct V_172 * ) V_171 ;
if ( ! V_173 || ( V_176 < 1 ) )
return V_64 ;
...
T_11 F_145 ( T_1 V_149 , void * V_185 )
{
switch ( V_149 ) {
case V_186 :
...
static int T_3 F_146 ( char * V_188 )
{
char * V_189 = V_70 ;
int V_190 = V_191 - 1 ;
if ( ! V_188 || ! * V_188 )
...
static void T_3 F_150 ( unsigned int V_194 )
{
V_197 . V_203 = 1 ;
V_197 . V_204 = 0 ;
F_149 ( V_194 ) ;
...
void T_3 F_151 ( int V_194 , const struct V_205 * V_206 )
{
...
static int T_3 F_158 ( char * V_188 )
{
if ( V_188 == NULL || * V_188 == '\0' )
return 0 ;
...
int F_159 ( const struct V_213 * V_214 )
{
T_22 V_9 ;
T_7 V_5 ;
T_12 V_215 = 0 ;
...
if ( V_209 != V_212 )
V_215 = 1 ;
V_216 = F_161 ( V_9 , V_214 -> V_220 , V_5 , V_215 ) ;
if ( V_216 ) {
if ( V_209 != V_212 ) {
if ( V_209 == V_211 )
F_11 ( V_221 L_53
...
int F_162 ( T_23 V_220 , T_23 V_224 ,
const char * V_69 )
{
struct V_213 V_214 = {
. V_220 = V_220 ,
...
void F_164 ( T_24 V_171 )
{
F_165 ( V_171 ) ;
}
T_25 F_166 ( T_24 V_225 )
{
T_25 V_217 ;
F_167 ( V_225 , V_217 ) ;
return V_217 ;
}
void F_168 ( T_24 V_225 , T_25 V_217 )
{
F_169 ( V_225 , V_217 ) ;
}
T_11
F_170 ( char * V_69 , V_132 V_41 , V_132 V_226 , T_26 * * V_227 )
{
* V_227 = F_171 ( V_69 , V_41 , 0 , 0 , NULL ) ;
if ( * V_227 == NULL )
return V_145 ;
else
return V_65 ;
}
T_11 F_172 ( T_26 * V_227 )
{
F_173 ( V_227 ) ;
return ( V_65 ) ;
}
T_11 F_174 ( T_26 * V_227 )
{
F_175 ( V_227 ) ;
return ( V_65 ) ;
}
T_11 F_176 ( T_26 * V_227 , void * V_228 )
{
F_177 ( V_227 , V_228 ) ;
return ( V_65 ) ;
}
static int T_3 F_178 ( char * V_229 )
{
...
T_11 T_3 F_180 ( void )
{
V_163 = F_181 ( L_60 , 0 , 1 ) ;
V_162 = F_181 ( L_61 , 0 , 1 ) ;
V_168 = F_182 ( L_62 , 0 ) ;
F_134 ( ! V_163 ) ;
F_134 ( ! V_162 ) ;
F_134 ( ! V_168 ) ;
...
T_11 F_186 ( T_12 V_231 , T_1 V_232 ,
T_1 V_233 )
{
int V_234 = 0 ;
if ( V_235 )
...
T_11 F_188 ( T_12 V_231 , T_1 V_239 ,
T_1 V_240 )
{
int V_234 = 0 ;
if ( V_241 )
...
void F_189 ( int (* V_166)( T_12 V_231 ,
T_1 V_239 , T_1 V_240 ) )
{
V_241 = V_166 ;
}
