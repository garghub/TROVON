...
F_11 ( V_50 L_11 , V_42 [ V_45 ] . V_27 [ V_46 ] ) ;
}
...
F_9 ( 2 , L_13 ,
( V_42 [ V_45 + 1 ] . V_32 & V_48 ) ? L_6 : L_7 ,
V_45 + 1 == V_43 - 1 ? L_8 : L_9 , V_11 , V_42 [ V_45 + 1 ] . V_26 ) ;
V_44 = F_5 ( V_14 ,
& V_42 [ V_45 ] ,
& V_42 [ V_45 + 1 ] ) ;
if ( V_49 >= 2 ) {
for ( V_46 = 0 ; V_46 < V_42 [ V_45 + 1 ] . V_26 ; V_46 ++ )
F_11 ( V_50 L_11 , V_42 [ V_45 + 1 ] . V_27 [ V_46 ] ) ;
}
V_45 ++ ;
} else {
if ( V_49 >= 2 ) {
...
static T_3 F_12 ( struct V_13 * V_52 )
{
return V_53 | V_54 ;
}
void F_13 ( struct V_1 * V_2 , struct V_55 * V_56 )
{
unsigned char V_27 ;
int V_45 , V_44 ;
F_14 ( L_15 ) ;
...
V_56 -> V_11 = V_45 ;
V_44 = F_15 ( V_56 , & V_27 , 0 ) ;
if ( V_44 < 0 )
continue;
F_14 ( L_16 ,
V_2 -> V_57 , V_45 << 1 ,
V_58 [ V_45 ] ? V_58 [ V_45 ] : L_17 ) ;
}
F_14 ( L_18 ) ;
}
...
V_4 -> V_14 = V_59 ;
V_4 -> V_55 = V_60 ;
V_4 -> V_14 . V_2 . V_61 = & V_2 -> V_62 -> V_2 ;
F_18 ( V_4 -> V_14 . V_57 , V_4 -> V_2 -> V_57 , sizeof( V_4 -> V_14 . V_57 ) ) ;
V_4 -> V_14 . V_15 = V_4 ;
F_19 ( & V_4 -> V_14 , & V_2 -> V_63 ) ;
F_20 ( & V_4 -> V_14 ) ;
V_4 -> V_55 . V_64 = & V_4 -> V_14 ;
if ( 0 == V_4 -> V_65 ) {
if ( V_66 )
F_13 ( V_2 , & V_4 -> V_55 ) ;
} else
