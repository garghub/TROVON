...
if ( V_48 + V_49 > V_106 )
V_48 = V_106 - V_49 ;
V_103 = V_28 -> V_101 -> V_107 ( V_93 , V_28 , 1 ) ;
memcpy ( F_66 ( V_32 ) + V_49 , V_103 + V_28 -> V_49 , V_48 ) ;
V_28 -> V_101 -> V_108 ( V_93 , V_28 , V_103 ) ;
...
if ( V_53 < 0 )
goto V_113;
V_28 = F_27 ( V_1 -> V_18 , 0 , V_93 -> V_112 ) ;
if ( ! V_28 ) {
V_53 = - V_91 ;
goto V_113;
}
V_98 . V_100 = 0 ;
V_98 . V_48 = 0 ;
V_98 . V_37 = V_93 -> V_112 ;
V_98 . V_33 = V_28 -> V_33 ;
F_69 ( V_98 . V_33 , V_98 . V_37 ) ;
V_53 = F_70 ( V_93 , & V_96 , F_61 ) ;
F_71 ( V_93 ) ;
if ( F_72 ( V_53 > 0 ) )
...
static unsigned int F_74 ( struct V_80 * V_81 , T_7 * V_114 )
{
struct V_1 * V_1 ;
unsigned int V_53 ;
V_1 = V_81 -> V_85 ;
F_75 ( V_81 , & V_1 -> V_90 , V_114 ) ;
if ( ! V_1 -> V_78 ) {
return V_115 ;
}
V_53 = 0 ;
...
static int F_76 ( struct V_119 * V_119 , struct V_80 * V_81 )
{
struct V_1 * V_1 ;
V_1 = V_81 -> V_85 ;
F_46 ( V_1 , V_120 , 0 ) ;
...
static int F_78 ( struct V_119 * V_119 , struct V_80 * V_81 )
{
struct V_12 * V_12 = V_119 -> V_122 ;
struct V_1 * V_1 ;
int V_53 ;
V_1 = F_8 ( V_12 -> V_10 ) ;
if ( ! V_1 ) {
...
F_55 ( & V_1 -> V_71 ) ;
F_79 ( V_119 , V_81 ) ;
F_46 ( V_81 -> V_85 , V_120 , 1 ) ;
return 0 ;
V_7:
F_77 ( & V_1 -> V_13 , V_121 ) ;
return V_53 ;
}
static int F_80 ( int V_125 , struct V_80 * V_81 , int V_126 )
{
struct V_1 * V_1 ;
V_1 = V_81 -> V_85 ;
return F_81 ( V_125 , V_81 , V_126 , & V_1 -> V_127 ) ;
}
...
if ( ! F_12 ( V_21 ) &&
F_86 ( V_21 , V_130 ) )
F_87 ( V_1 -> V_4 . V_19 , V_1 -> V_4 . V_131 ) ;
}
static int F_88 ( struct V_132 * V_133 , int V_69 )
{
struct V_1 * V_1 ;
V_1 = F_1 ( V_133 -> V_2 ) ;
if ( ! V_1 )
...
static void F_89 ( struct V_132 * V_133 , int V_69 )
{
V_133 -> V_134 = 0 ;
}
...
{
V_128 = F_82 ;
return F_91 ( 0 , 0 , & V_135 ) ;
}
static int F_92 ( struct V_1 * V_1 )
{
int V_53 ;
V_1 -> V_4 . V_2 = V_136 . V_137 ;
V_1 -> V_4 . V_19 = F_93 ( V_1 -> V_4 . V_2 , 0 , & V_135 , V_106 ) ;
...
V_1 = V_81 -> V_85 ;
V_143 = 0 ;
V_143 += snprintf ( V_28 + V_143 , V_75 ,
L_5 , V_1 -> V_142 ? V_1 -> V_142 : L_6 ) ;
V_143 += snprintf ( V_28 + V_143 , V_75 - V_143 ,
L_7 , V_1 -> V_78 ) ;
V_143 += snprintf ( V_28 + V_143 , V_75 - V_143 ,
L_8 , V_1 -> V_79 ) ;
V_143 += snprintf ( V_28 + V_143 , V_75 - V_143 ,
...
V_143 += snprintf ( V_28 + V_143 , V_75 - V_143 ,
L_16 , V_1 -> V_4 . V_2 ) ;
V_53 = F_100 ( V_82 , V_83 , V_84 , V_28 , V_143 ) ;
F_17 ( V_28 ) ;
return V_53 ;
}
static void F_101 ( struct V_1 * V_1 , T_9 V_144 , T_9 V_145 )
{
if ( ! V_1 || ! F_11 ( V_1 ) )
return;
...
static unsigned int F_102 ( struct V_15 * V_16 , T_10 * V_148 )
{
struct V_27 * V_28 ;
unsigned int V_149 ;
int V_53 ;
...
{
if ( V_1 -> V_127 && V_1 -> V_78 )
F_104 ( & V_1 -> V_127 , V_150 , V_151 ) ;
}
...
V_1 -> V_51 = (struct V_154 ) { 0 } ;
V_1 -> V_66 = false ;
V_1 -> V_17 = V_9 -> V_155 [ V_1 -> V_14 ] ;
V_1 -> V_18 = V_9 -> V_156 [ V_1 -> V_14 ] ;
V_1 -> V_12 = F_107 () ;
if ( ! V_1 -> V_12 ) {
...
V_1 -> V_12 -> V_101 = & V_158 ;
V_153 = F_108 ( V_9 -> V_159 , V_14 ) ;
V_56 = F_109 ( V_1 -> V_12 , V_153 , 1 ) ;
if ( V_56 < 0 ) {
F_96 ( & V_1 -> V_9 -> V_21 -> V_10 ,
L_18 , V_56 , V_14 ) ;
goto V_160;
}
V_1 -> V_10 = F_110 ( V_136 . V_161 , & V_1 -> V_9 -> V_21 -> V_10 ,
V_153 , V_1 , L_19 ,
V_1 -> V_9 -> V_21 -> V_162 , V_14 ) ;
if ( F_94 ( V_1 -> V_10 ) ) {
V_56 = F_95 ( V_1 -> V_10 ) ;
F_96 ( & V_1 -> V_9 -> V_21 -> V_10 ,
L_20 ,
...
F_54 ( & V_9 -> V_11 ) ;
F_18 ( & V_1 -> V_35 , & V_1 -> V_9 -> V_165 ) ;
F_55 ( & V_9 -> V_11 ) ;
F_46 ( V_1 , V_166 , 1 ) ;
if ( V_136 . V_167 ) {
sprintf ( V_152 , L_19 ,
V_1 -> V_9 -> V_21 -> V_162 , V_14 ) ;
V_1 -> V_168 = F_113 ( V_152 , 0444 ,
V_136 . V_167 ,
V_1 ,
& V_169 ) ;
}
...
F_14 ( V_28 , true ) ;
V_163:
F_115 ( V_136 . V_161 , V_1 -> V_10 -> V_153 ) ;
V_160:
F_116 ( V_1 -> V_12 ) ;
V_157:
F_17 ( V_1 ) ;
V_46:
F_40 ( V_9 , V_14 , V_166 , 0 ) ;
return V_56 ;
}
static void V_121 ( struct V_13 * V_13 )
{
struct V_1 * V_1 ;
...
if ( V_63 -> V_14 >= V_9 -> V_174 . V_175 ) {
F_38 ( & V_9 -> V_21 -> V_10 ,
L_24 ,
V_63 -> V_14 , V_9 -> V_174 . V_175 - 1 ) ;
break;
}
F_105 ( V_9 , V_63 -> V_14 ) ;
break;
...
sizeof( V_37 ) ) ;
F_101 ( V_1 , V_37 . V_144 , V_37 . V_145 ) ;
V_1 -> V_4 . V_19 -> V_134 = 1 ;
F_85 ( V_1 ) ;
break;
}
case V_120 :
...
if ( V_1 -> V_142 )
break;
V_172 = V_28 -> V_48 - V_28 -> V_49 - sizeof( * V_63 ) + 1 ;
V_1 -> V_142 = F_28 ( V_172 , V_45 ) ;
if ( ! V_1 -> V_142 ) {
F_96 ( V_1 -> V_10 ,
L_25 ) ;
break;
}
strncpy ( V_1 -> V_142 , V_28 -> V_28 + V_28 -> V_49 + sizeof( * V_63 ) ,
V_172 - 1 ) ;
V_1 -> V_142 [ V_172 - 1 ] = 0 ;
V_56 = F_126 ( & V_1 -> V_10 -> V_170 ,
& V_171 ) ;
if ( V_56 ) {
F_96 ( V_1 -> V_10 ,
L_26 ,
...
F_127 ( & V_1 -> V_10 -> V_170 , V_181 ) ;
}
break;
}
}
static void F_128 ( struct V_182 * V_183 )
{
struct V_8 * V_9 ;
struct V_15 * V_16 ;
struct V_27 * V_28 ;
...
struct V_1 * V_1 ;
T_9 V_144 , V_145 ;
F_136 ( V_21 , struct V_188 , V_145 , & V_145 ) ;
F_136 ( V_21 , struct V_188 , V_144 , & V_144 ) ;
V_1 = F_9 ( V_9 , 0 ) ;
F_101 ( V_1 , V_144 , V_145 ) ;
F_85 ( V_1 ) ;
}
}
...
char * * V_190 ;
struct V_15 * * V_191 ;
T_1 V_30 , V_192 , V_193 , V_194 ;
int V_56 ;
V_193 = V_9 -> V_174 . V_175 ;
V_194 = F_13 ( V_9 ) ? ( V_193 + 1 ) * 2 : 2 ;
V_191 = F_28 ( V_194 * sizeof( struct V_15 * ) , V_45 ) ;
V_189 = F_28 ( V_194 * sizeof( T_12 * ) , V_45 ) ;
V_190 = F_28 ( V_194 * sizeof( char * ) , V_45 ) ;
V_9 -> V_155 = F_28 ( V_193 * sizeof( struct V_15 * ) ,
V_45 ) ;
V_9 -> V_156 = F_28 ( V_193 * sizeof( struct V_15 * ) ,
V_45 ) ;
if ( ! V_191 || ! V_189 || ! V_190 || ! V_9 -> V_155 ||
! V_9 -> V_156 ) {
V_56 = - V_91 ;
goto free;
}
...
V_56 = V_9 -> V_21 -> V_174 -> V_195 ( V_9 -> V_21 , V_194 , V_191 ,
V_189 ,
( const char * * ) V_190 ) ;
if ( V_56 )
goto free;
...
V_192 += 2 ;
if ( F_13 ( V_9 ) ) {
V_9 -> V_185 = V_191 [ V_192 ] ;
V_9 -> V_64 = V_191 [ V_192 + 1 ] ;
for ( V_30 = 1 ; V_30 < V_193 ; V_30 ++ ) {
V_192 += 2 ;
V_9 -> V_155 [ V_30 ] = V_191 [ V_192 ] ;
V_9 -> V_156 [ V_30 ] = V_191 [ V_192 + 1 ] ;
}
}
F_17 ( V_190 ) ;
F_17 ( V_189 ) ;
...
if ( ! F_13 ( V_9 ) )
return;
while ( ( V_28 = F_32 ( V_9 -> V_185 , & V_48 ) ) )
F_14 ( V_28 , true ) ;
while ( ( V_28 = F_114 ( V_9 -> V_185 ) ) )
F_14 ( V_28 , true ) ;
}
...
V_9 -> V_21 = V_21 ;
V_21 -> V_187 = V_9 ;
V_9 -> V_159 = F_142 ( 0 , L_32 ,
& V_199 ) ;
if ( V_9 -> V_159 < 0 ) {
F_96 ( & V_21 -> V_10 ,
L_33 ,
V_9 -> V_159 , V_21 -> V_162 ) ;
V_56 = V_9 -> V_159 ;
goto free;
}
V_197 = false ;
...
F_111 ( & V_9 -> V_186 ) ;
F_111 ( & V_9 -> V_65 ) ;
F_145 ( & V_9 -> V_184 , & F_128 ) ;
V_149 = F_102 ( V_9 -> V_185 ,
& V_9 -> V_186 ) ;
if ( ! V_149 ) {
F_96 ( & V_21 -> V_10 ,
L_35 ) ;
...
{
int V_56 ;
V_136 . V_161 = F_154 ( V_207 , L_36 ) ;
if ( F_94 ( V_136 . V_161 ) ) {
V_56 = F_95 ( V_136 . V_161 ) ;
F_155 ( L_37 , V_56 ) ;
return V_56 ;
}
V_136 . V_167 = F_156 ( L_36 , NULL ) ;
if ( ! V_136 . V_167 )
F_157 ( L_38 ) ;
F_144 ( & V_136 . V_138 ) ;
F_144 ( & V_136 . V_202 ) ;
