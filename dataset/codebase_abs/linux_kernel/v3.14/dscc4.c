...
static int F_49 ( struct V_35 * V_36 , const struct V_94 * V_95 )
{
struct V_90 * V_4 ;
struct V_1 * V_8 ;
void T_3 * V_58 ;
...
if ( V_96 < 0 )
goto V_98;
V_96 = F_51 ( V_36 , 0 , L_10 ) ;
if ( V_96 < 0 ) {
F_52 ( L_11 ) ;
goto V_99;
}
V_96 = F_51 ( V_36 , 1 , L_12 ) ;
if ( V_96 < 0 ) {
F_52 ( L_13 ) ;
goto V_100;
}
...
if ( ! V_58 ) {
F_52 ( L_14 ,
( unsigned long long ) F_54 ( V_36 , 0 ) ,
...
F_17 ( V_33 L_15 ,
( unsigned long long ) F_55 ( V_36 , 0 ) ,
( unsigned long long ) F_55 ( V_36 , 1 ) , V_36 -> V_103 ) ;
F_56 ( V_36 , V_104 , 0xf8 ) ;
F_57 ( V_36 ) ;
V_96 = F_58 ( V_36 , V_58 ) ;
if ( V_96 < 0 )
goto V_105;
V_4 = F_45 ( V_36 ) ;
V_96 = F_59 ( V_36 -> V_103 , V_106 , V_107 , V_108 , V_4 -> V_92 ) ;
if ( V_96 < 0 ) {
F_60 ( L_16 , V_36 -> V_103 ) ;
goto V_109;
}
...
static inline int F_67 ( struct V_1 * V_8 , int V_136 )
{
int V_31 = 0 ;
...
static int F_58 ( struct V_35 * V_36 , void T_3 * V_58 )
{
struct V_90 * V_91 ;
struct V_1 * V_92 ;
int V_42 , V_31 = - V_113 ;
V_92 = F_68 ( V_93 , sizeof( * V_92 ) , V_140 ) ;
if ( ! V_92 )
goto V_141;
for ( V_42 = 0 ; V_42 < V_93 ; V_42 ++ ) {
V_92 [ V_42 ] . V_3 = F_69 ( V_92 + V_42 ) ;
if ( ! V_92 [ V_42 ] . V_3 )
goto V_142;
}
V_91 = F_70 ( sizeof( * V_91 ) , V_140 ) ;
if ( ! V_91 )
goto V_142;
V_91 -> V_92 = V_92 ;
F_71 ( & V_91 -> V_143 ) ;
...
void * V_247 ;
int V_42 ;
V_247 = F_61 ( V_36 , V_44 , & V_8 -> V_23 ) ;
if ( ! V_247 )
goto V_141;
V_8 -> V_39 = V_39 = (struct V_26 * ) V_247 ;
V_247 = F_61 ( V_36 , V_43 , & V_8 -> V_16 ) ;
if ( ! V_247 )
goto V_273;
