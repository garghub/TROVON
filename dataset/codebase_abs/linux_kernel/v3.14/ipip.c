...
static int
F_22 ( struct V_39 * V_5 , struct V_48 * V_49 , int V_50 )
{
int V_14 = 0 ;
struct V_51 V_52 ;
if ( F_23 ( & V_52 , V_49 -> V_53 . V_54 , sizeof( V_52 ) ) )
return - V_55 ;
...
V_14 = F_24 ( V_5 , & V_52 , V_50 ) ;
if ( V_14 )
return V_14 ;
if ( F_25 ( V_49 -> V_53 . V_54 , & V_52 , sizeof( V_52 ) ) )
return - V_55 ;
return 0 ;
}
...
static int F_28 ( struct V_39 * V_5 )
{
struct V_12 * V_33 = F_16 ( V_5 ) ;
...
static void F_30 ( struct V_83 * V_11 [] ,
struct V_51 * V_26 )
{
...
return;
if ( V_11 [ V_84 ] )
V_26 -> V_85 = F_31 ( V_11 [ V_84 ] ) ;
if ( V_11 [ V_86 ] )
V_26 -> V_10 . V_20 = F_32 ( V_11 [ V_86 ] ) ;
if ( V_11 [ V_87 ] )
V_26 -> V_10 . V_19 = F_32 ( V_11 [ V_87 ] ) ;
if ( V_11 [ V_88 ] ) {
V_26 -> V_10 . V_27 = F_33 ( V_11 [ V_88 ] ) ;
if ( V_26 -> V_10 . V_27 )
V_26 -> V_10 . V_60 = F_18 ( V_61 ) ;
}
if ( V_11 [ V_89 ] )
V_26 -> V_10 . V_90 = F_33 ( V_11 [ V_89 ] ) ;
if ( ! V_11 [ V_91 ] || F_33 ( V_11 [ V_91 ] ) )
V_26 -> V_10 . V_60 = F_18 ( V_61 ) ;
}
static int F_34 ( struct V_4 * V_92 , struct V_39 * V_5 ,
struct V_83 * V_93 [] , struct V_83 * V_11 [] )
{
struct V_51 V_52 ;
F_30 ( V_11 , & V_52 ) ;
return F_35 ( V_5 , V_93 , & V_52 ) ;
}
static int F_36 ( struct V_39 * V_5 , struct V_83 * V_93 [] ,
struct V_83 * V_11 [] )
{
struct V_51 V_52 ;
F_30 ( V_11 , & V_52 ) ;
...
return - V_62 ;
return F_37 ( V_5 , V_93 , & V_52 ) ;
}
static T_3 F_38 ( const struct V_39 * V_5 )
{
return
F_39 ( 4 ) +
F_39 ( 4 ) +
...
static int F_40 ( struct V_1 * V_2 , const struct V_39 * V_5 )
{
struct V_12 * V_33 = F_16 ( V_5 ) ;
struct V_51 * V_95 = & V_33 -> V_26 ;
if ( F_41 ( V_2 , V_84 , V_95 -> V_85 ) ||
F_42 ( V_2 , V_86 , V_95 -> V_10 . V_20 ) ||
F_42 ( V_2 , V_87 , V_95 -> V_10 . V_19 ) ||
F_43 ( V_2 , V_88 , V_95 -> V_10 . V_27 ) ||
F_43 ( V_2 , V_89 , V_95 -> V_10 . V_90 ) ||
F_43 ( V_2 , V_91 ,
