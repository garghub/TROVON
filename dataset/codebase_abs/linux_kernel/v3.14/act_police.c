...
static int F_31 ( struct V_5 * V_6 , int V_33 )
{
struct V_40 * V_13 = V_6 -> V_24 ;
if ( V_13 )
return F_32 ( & V_13 -> V_87 , V_33 , & V_88 ) ;
return 0 ;
}
static int F_33 ( struct V_1 * V_2 , const struct V_5 * V_6 ,
struct V_89 * V_90 )
{
...
if ( F_37 ( V_2 ) <= V_41 -> V_67 ) {
if ( ! V_41 -> V_70 ) {
F_36 ( & V_41 -> V_57 ) ;
return V_41 -> V_74 ;
}
V_91 = F_26 ( F_27 () ) ;
V_92 = F_38 ( V_79 , V_91 - V_41 -> V_84 ,
V_41 -> V_75 ) ;
if ( V_41 -> V_71 ) {
V_93 = V_92 + V_41 -> V_80 ;
if ( V_93 > V_41 -> V_78 )
V_93 = V_41 -> V_78 ;
V_93 -= ( V_79 ) F_25 ( & V_41 -> V_72 ,
F_37 ( V_2 ) ) ;
}
V_92 += V_41 -> V_77 ;
if ( V_92 > V_41 -> V_75 )
V_92 = V_41 -> V_75 ;
V_92 -= ( V_79 ) F_25 ( & V_41 -> V_58 , F_37 ( V_2 ) ) ;
if ( ( V_92 | V_93 ) >= 0 ) {
V_41 -> V_84 = V_91 ;
V_41 -> V_77 = V_92 ;
V_41 -> V_80 = V_93 ;
...
static int
F_39 ( struct V_1 * V_2 , struct V_5 * V_6 , int V_33 , int V_99 )
{
unsigned char * V_100 = F_40 ( V_2 ) ;
struct V_40 * V_41 = V_6 -> V_24 ;
struct V_38 V_101 = {
. V_15 = V_41 -> V_85 ,
. V_82 = V_41 -> V_81 ,
. V_68 = V_41 -> V_67 ,
. V_76 = F_41 ( V_41 -> V_75 ) ,
. V_102 = V_41 -> V_51 - V_99 ,
. V_103 = V_41 -> V_50 - V_33 ,
} ;
if ( V_41 -> V_70 )
F_42 ( & V_101 . V_58 , & V_41 -> V_58 ) ;
if ( V_41 -> V_71 )
F_42 ( & V_101 . V_61 , & V_41 -> V_72 ) ;
if ( F_43 ( V_2 , V_48 , sizeof( V_101 ) , & V_101 ) )
goto V_26;
if ( V_41 -> V_74 &&
F_44 ( V_2 , V_73 , V_41 -> V_74 ) )
goto V_26;
if ( V_41 -> V_83 &&
F_44 ( V_2 , V_66 , V_41 -> V_83 ) )
goto V_26;
return V_2 -> V_104 ;
V_26:
F_45 ( V_2 , V_100 ) ;
