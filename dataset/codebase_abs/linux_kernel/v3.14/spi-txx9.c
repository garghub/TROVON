...
V_2 -> V_59 = F_44 ( V_2 -> V_91 ) ;
V_2 -> V_17 = F_19 ( V_2 -> V_59 , V_61 + 1 ) ;
V_2 -> V_16 = V_2 -> V_59 / ( V_60 + 1 ) ;
V_88 = F_45 ( V_19 , V_92 , 0 ) ;
if ( ! V_88 )
goto V_93;
if ( ! F_46 ( & V_19 -> V_19 , V_88 -> V_94 , F_47 ( V_88 ) ,
L_4 ) )
goto V_93;
V_2 -> V_4 = F_48 ( & V_19 -> V_19 , V_88 -> V_94 , F_47 ( V_88 ) ) ;
if ( ! V_2 -> V_4 )
goto V_93;
V_34 = F_1 ( V_2 , V_37 ) ;
V_34 &= ~ ( V_38 | V_41 | V_42 ) ;
...
if ( V_22 < 0 )
goto V_93;
V_89 = F_50 ( & V_19 -> V_19 , V_22 , F_14 , 0 ,
L_4 , V_2 ) ;
if ( V_89 )
goto exit;
V_2 -> V_85 = F_51 (
...
V_15 -> V_103 = F_54 ( 8 ) | F_54 ( 16 ) ;
V_89 = F_55 ( & V_19 -> V_19 , V_15 ) ;
if ( V_89 )
goto exit;
return 0 ;
V_93:
...
static int F_59 ( struct V_86 * V_19 )
{
struct V_84 * V_15 = F_60 ( V_19 ) ;
struct V_1 * V_2 = F_9 ( V_15 ) ;
F_56 ( V_2 -> V_85 ) ;
F_57 ( V_2 -> V_91 ) ;
return 0 ;
