...
break;
default:
F_9 ( L_67 , V_328 -> V_344 ) ;
V_288 = - V_321 ;
goto error;
}
memcpy ( V_333 , V_328 -> V_333 . V_88 , V_353 ) ;
V_334 = ( V_28 -> V_48 & V_248 ) - 1 ;
if ( V_328 -> V_354 & V_355 )
V_335 = 1 ;
if ( V_328 -> V_354 & V_356 ) {
V_339 = V_337 ;
memcpy ( V_336 , V_328 -> V_357 , V_339 ) ;
}
if ( V_328 -> V_340 ) {
V_340 = V_328 -> V_340 ;
memcpy ( V_338 , & V_328 -> V_338 [ 0 ] , V_340 ) ;
}
memset ( V_342 , 0 , 64 ) ;
if ( V_340 > 0 ) {
memcpy ( V_342 , V_338 , V_340 ) ;
if ( V_340 == 32 ) {
memcpy ( & V_342 [ 16 ] , & V_338 [ 24 ] , 8 ) ;
memcpy ( & V_342 [ 24 ] , & V_338 [ 16 ] , 8 ) ;
}
}
memcpy ( V_330 -> V_333 , V_333 , V_353 ) ;
V_330 -> V_84 . V_358 . V_332 = ( int ) V_332 ;
V_330 -> V_84 . V_358 . V_335 = V_335 ;
V_330 -> V_84 . V_358 . V_359 = V_334 ;
V_330 -> V_84 . V_358 . V_340 = V_340 ;
V_330 -> V_84 . V_358 . V_338 = ( T_7 * ) V_342 ;
V_330 -> V_84 . V_358 . V_336 = ( T_7 * ) V_336 ;
V_330 -> V_84 . V_358 . V_339 = V_339 ;
if ( V_330 -> V_84 . V_358 . V_332 == V_346 ) {
if ( V_330 -> V_84 . V_358 . V_359 == 0 ) {
V_4 -> V_360 ++ ;
}
if ( ( V_4 -> V_360 == 1 ) && ( V_330 -> V_84 . V_358 . V_359 == 1 ) ) {
V_4 -> V_360 ++ ;
}
if ( ( V_4 -> V_360 == 2 ) && ( V_330 -> V_84 . V_358 . V_359 == 2 ) ) {
V_4 -> V_360 ++ ;
}
if ( ( V_4 -> V_360 == 3 ) && ( V_330 -> V_84 . V_358 . V_359 == 3 ) ) {
V_4 -> V_360 ++ ;
}
}
if ( V_4 -> V_360 == 4 ) {
...
T_1 V_4 = ( T_1 ) F_2 ( V_3 ) ;
T_2 V_33 = & ( V_4 -> V_34 ) ;
struct V_361 * V_362 = (struct V_361 * ) V_29 ;
int V_288 = 0 ;
if ( memcmp ( V_33 -> V_211 , V_362 -> V_333 . V_88 , V_353 ) ) {
V_288 = - V_139 ;
return V_288 ;
}
switch ( V_362 -> V_82 ) {
