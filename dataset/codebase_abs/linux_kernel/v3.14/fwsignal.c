...
V_58 -> V_178 = V_175 ;
V_119 = F_83 ( V_7 -> V_75 , false , & V_14 , V_12 ) ;
if ( V_119 == 0 ) {
F_84 ( V_12 , V_179 , V_175 ) ;
...
static int
F_87 ( struct V_6 * V_7 , T_2 V_182 , T_1 V_74 ,
T_1 V_175 , T_3 V_176 )
{
T_1 V_65 ;
int V_119 ;
...
F_65 ( V_12 ) ;
if ( ! V_183 )
V_119 = F_82 ( V_7 , V_65 , V_12 , V_175 ,
V_176 ) ;
if ( V_183 || V_119 )
F_88 ( V_7 -> V_75 , V_12 , true ) ;
return 0 ;
}
...
F_5 ( V_7 ) ;
F_87 ( V_7 , V_182 , V_74 , V_175 , V_176 ) ;
F_6 ( V_7 ) ;
return V_128 ;
}
...
T_2 V_182 ;
if ( V_100 -> V_23 != V_160 )
F_84 ( V_150 , V_179 , V_58 -> V_178 ) ;
V_182 = V_233 ;
if ( F_8 ( V_150 , V_138 ) ) {
V_182 |= V_234 ;
}
F_84 ( V_150 , V_204 , V_182 ) ;
...
V_100 -> V_86 = 0 ;
V_74 = F_14 ( & V_7 -> V_21 ) ;
F_84 ( V_150 , V_77 , V_74 ) ;
F_84 ( V_150 , V_164 , V_100 -> V_79 -> V_176 [ V_65 ] ) ;
F_84 ( V_150 , V_194 , V_65 ) ;
...
bool V_253 = V_250 -> V_254 == F_106 ( V_255 ) ;
F_25 ( V_159 , L_44 , F_107 ( V_250 -> V_254 ) ) ;
if ( ! V_12 -> V_256 )
V_12 -> V_256 = F_108 ( V_12 , NULL ) ;
V_75 -> V_257 += ! ! V_63 ;
if ( V_253 )
F_109 ( & V_61 -> V_258 ) ;
V_100 -> V_243 = 0 ;
...
void F_113 ( struct V_60 * V_61 )
{
struct V_43 * V_58 = V_61 -> V_64 ;
F_25 ( V_49 , L_47 , V_61 -> V_264 ) ;
if ( ! V_58 )
return;
F_24 ( V_58 , V_61 -> V_265 , V_61 -> V_14 ) ;
}
void F_114 ( struct V_60 * V_61 )
{
struct V_6 * V_7 = V_61 -> V_75 -> V_7 ;
struct V_43 * V_58 ;
if ( ! V_61 -> V_266 )
...
static void F_116 ( struct V_267 * V_268 )
{
struct V_6 * V_7 ;
struct V_211 * V_75 ;
struct V_11 * V_12 ;
...
T_1 V_14 ;
int V_119 ;
V_7 = F_117 ( V_268 , struct V_6 , V_148 ) ;
V_75 = V_7 -> V_75 ;
F_5 ( V_7 ) ;
for ( V_65 = V_251 ; V_65 >= 0 && ! V_7 -> V_269 ;
V_65 -- ) {
if ( ! F_68 ( V_7 ) ) {
...
int F_118 ( struct V_211 * V_75 )
{
struct V_6 * V_7 ;
T_1 V_270 = V_271 ;
int V_236 ;
T_1 V_89 ;
V_75 -> V_7 = F_119 ( sizeof( * ( V_75 -> V_7 ) ) , V_272 ) ;
if ( ! V_75 -> V_7 ) {
V_236 = - V_273 ;
goto V_131;
}
...
V_7 -> V_75 = V_75 ;
V_7 -> V_195 = V_195 ;
V_7 -> V_147 = F_121 ( L_50 ) ;
if ( V_7 -> V_147 == NULL ) {
F_15 ( L_51 ) ;
V_236 = - V_275 ;
goto V_131;
}
F_122 ( & V_7 -> V_148 , F_116 ) ;
if ( V_7 -> V_195 != V_276 )
V_270 |= V_277 |
V_278 |
V_279 |
V_280 ;
V_236 = F_123 ( V_75 , V_281 ,
F_94 ) ;
if ( V_236 < 0 ) {
F_15 ( L_52 ) ;
goto V_131;
}
V_236 = F_123 ( V_75 , V_282 ,
F_95 ) ;
if ( V_236 < 0 ) {
F_15 ( L_53 ) ;
F_124 ( V_75 , V_281 ) ;
...
V_7 -> V_218 = true ;
if ( F_125 ( V_75 -> V_106 [ 0 ] , L_54 , V_270 ) ) {
F_15 ( L_55 ) ;
V_7 -> V_195 = V_276 ;
V_7 -> V_218 = false ;
}
if ( F_125 ( V_75 -> V_106 [ 0 ] , L_56 , 1 ) )
F_25 ( V_198 , L_57 ) ;
if ( F_126 ( V_75 -> V_106 [ 0 ] , L_58 , & V_89 ) == 0 ) {
if ( F_45 ( V_89 ) ) {
V_89 = 0 ;
F_127 ( V_89 , 1 ) ;
if ( F_125 ( V_75 -> V_106 [ 0 ] ,
L_58 , V_89 ) == 0 ) {
F_127 ( V_7 -> V_89 , 1 ) ;
}
}
...
F_128 ( V_75 , & V_7 -> V_8 ) ;
F_25 ( V_198 , L_59 ,
V_7 -> V_218 ? L_60 : L_61 , V_270 ) ;
return 0 ;
V_131:
F_129 ( V_75 ) ;
return V_236 ;
}
void F_129 ( struct V_211 * V_75 )
{
struct V_6 * V_7 = V_75 -> V_7 ;
if ( ! V_7 )
return;
if ( V_75 -> V_7 -> V_147 )
F_130 ( V_75 -> V_7 -> V_147 ) ;
F_5 ( V_7 ) ;
F_39 ( V_7 , - 1 ) ;
V_75 -> V_7 = NULL ;
F_6 ( V_7 ) ;
...
if ( ! V_7 -> V_209 )
return false ;
return V_7 -> V_195 != V_276 ;
}
void F_132 ( struct V_6 * V_7 , struct V_11 * V_12 )
{
T_1 V_74 ;
...
F_5 ( V_7 ) ;
V_74 = F_37 ( V_12 , V_77 ) ;
F_87 ( V_7 , V_192 , V_74 , 0 , 0 ) ;
F_6 ( V_7 ) ;
}
void F_133 ( struct V_211 * V_75 , bool V_283 )
{
struct V_6 * V_7 = V_75 -> V_7 ;
V_7 -> V_269 = V_283 ;
if ( ! V_283 )
