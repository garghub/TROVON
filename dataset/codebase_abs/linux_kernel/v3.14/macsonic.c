...
F_9 ( V_61
L_14 ,
F_26 ( V_18 -> V_20 ) , V_57 , V_18 -> V_22 ? 32 : 16 , V_18 -> V_75 ) ;
#if 0
...
F_9 ( V_61 L_17 ,
F_26 ( V_18 -> V_20 ) , V_91 -> V_99 -> V_11 , V_91 -> V_99 -> V_110 ) ;
F_9 ( V_61 L_14 ,
F_26 ( V_18 -> V_20 ) , F_23 ( V_77 ) , V_22 ? 32 : 16 , V_75 ) ;
#if 0
printk(KERN_INFO "%s: DCR: 0x%04x, DCR2: 0x%04x\n", dev_name(lp->device),
SONIC_READ(SONIC_DCR) & 0xffff, SONIC_READ(SONIC_DCR2) & 0xffff);
#endif
F_18 ( V_51 , V_52 ) ;
F_18 ( V_79 , V_107 | ( V_22 ? V_84 : 0 ) ) ;
F_18 ( V_85 , 0 ) ;
F_18 ( V_86 , 0 ) ;
F_18 ( V_87 , 0x7fff ) ;
...
if ( V_12 )
goto V_124;
F_9 ( L_18 , V_8 -> V_11 , V_8 -> V_49 , V_8 -> V_3 ) ;
return 0 ;
V_124:
F_37 ( V_8 ) ;
return V_12 ;
