...
if ( V_101 < V_4 -> V_10 -> V_91 ) {
F_20 ( L_2 , V_101 , V_4 -> V_10 -> V_91 , V_4 -> V_10 -> V_93 ) ;
V_101 = V_4 -> V_10 -> V_91 ;
}
V_93 = V_4 -> V_10 -> V_93 ;
V_88 = V_42 -> V_50 * V_42 -> V_71 . V_51 ;
...
{
struct V_143 * V_143 = F_29 ( V_2 -> V_144 [ V_145 ] , struct V_143 , V_146 ) ;
...
F_11 ( & V_2 -> V_69 ) ;
V_143 = F_29 ( V_2 -> V_144 [ V_145 ] , struct V_143 , V_146 ) ;
V_43 = V_4 -> V_65 [ 0 ] ;
...
static struct V_166 F_33 ( struct V_1 * V_2 )
{
struct V_141 * V_141 = V_2 -> V_141 ;
...
static int F_35 ( struct V_1 * V_2 , int V_101 )
{
struct V_141 * V_141 = V_2 -> V_141 ;
...
static int F_37 ( struct V_1 * V_2 , int V_101 )
{
struct V_141 * V_141 = V_2 -> V_141 ;
...
static int F_39 ( struct V_1 * V_2 , unsigned char V_172 , int type )
{
...
{
struct V_143 * V_143 = F_29 ( V_2 -> V_144 [ type ] , struct V_143 , V_146 ) ;
return V_143 -> V_58 -> V_152 ( V_143 , V_147 ) ;
}
static int
F_41 ( struct V_1 * V_2 , unsigned int V_147 , int type )
{
struct V_143 * V_143 = F_29 ( V_2 -> V_144 [ type ] , struct V_143 , V_146 ) ;
V_143 -> V_58 -> V_154 ( V_143 , V_147 ) ;
V_143 -> V_58 -> V_99 ( V_143 ) ;
...
{
return F_39 ( V_2 , V_172 , V_177 ) ;
}
static int F_43 ( struct V_1 * V_2 , unsigned char V_172 )
{
return F_39 ( V_2 , V_172 , V_178 ) ;
}
static int F_44 ( struct V_1 * V_2 , unsigned char V_172 )
{
return F_39 ( V_2 , V_172 , V_179 ) ;
}
static int F_45 ( struct V_1 * V_2 , unsigned char V_172 )
{
return F_39 ( V_2 , V_172 , V_180 ) ;
}
static int F_46 ( struct V_1 * V_2 , unsigned char V_172 )
{
return F_39 ( V_2 , V_172 , V_181 ) ;
}
static int F_47 ( struct V_1 * V_2 , unsigned char V_172 )
{
return F_39 ( V_2 , V_172 , V_182 ) ;
}
static int F_48 ( struct V_1 * V_2 , unsigned char V_172 )
{
return F_39 ( V_2 , V_172 , V_145 ) ;
}
static int F_49 ( struct V_1 * V_2 , unsigned char V_172 )
{
return F_39 ( V_2 , V_172 , V_183 ) ;
}
static int F_50 ( struct V_1 * V_2 , unsigned int * V_147 )
{
return F_40 ( V_2 , V_147 , V_145 ) ;
}
static int F_51 ( struct V_1 * V_2 , unsigned int V_147 )
{
return F_41 ( V_2 , V_147 , V_145 ) ;
}
static int F_52 ( struct V_1 * V_2 , unsigned char V_172 )
{
...
if ( V_146 -> type < V_181 ) {
V_143 = F_29 ( V_146 , struct V_143 , V_146 ) ;
V_143 -> V_58 -> V_195 ( V_143 ) ;
V_143 -> V_58 -> V_196 ( V_143 ) ;
} else {
V_192 = F_29 ( V_146 , struct V_192 , V_146 ) ;
}
...
static int F_59 ( struct V_203 * V_204 )
{
...
int V_47 , V_44 ;
V_44 = F_65 ( V_2 -> V_218 , V_2 -> V_212 , V_2 -> V_222 , & V_141 ) ;
if ( V_44 ) {
F_5 ( V_28 L_9 ) ;
return V_44 ;
}
...
static void
F_67 ( struct V_33 * V_33 , struct V_192 * V_192 ,
...
V_143 = F_29 ( V_2 -> V_144 [ V_124 ] , struct V_143 , V_146 ) ;
V_143 -> V_58 -> V_155 ( V_143 , V_186 [ 0 ] ) ;
V_143 -> V_58 -> V_156 ( V_143 , V_186 [ 1 ] ) ;
}
V_192 = F_29 ( V_2 -> V_144 [ V_181 ] , struct V_192 , V_146 ) ;
F_67 ( V_2 -> V_34 [ V_35 ] , V_192 ,
...
V_122 -> V_161 ( V_122 , V_164 , & V_42 -> V_71 ) ;
if ( V_2 -> V_222 == V_241 ) {
V_192 = F_29 ( V_2 -> V_144 [ V_182 ] , struct V_192 , V_146 ) ;
F_67 ( V_2 -> V_34 [ V_35 ] , V_192 ,
...
V_192 = F_29 ( V_2 -> V_144 [ V_183 ] , struct V_192 , V_146 ) ;
F_67 ( V_2 -> V_34 [ V_35 ] , V_192 ,
...
if ( V_44 < 0 )
return V_44 ;
F_70 ( V_2 -> V_254 , V_261 ) ;
return 0 ;
}
int F_76 ( struct V_262 * V_254 , struct V_263 * V_218 ,
...
V_44 = F_78 ( & V_2 -> V_8 , V_218 ) ;
if ( V_44 < 0 )
goto V_55;
V_44 = F_64 ( V_2 ) ;
if ( V_44 < 0 )
goto V_55;
V_44 = F_79 ( V_2 , (struct V_121 * * ) & V_2 -> V_122 ) ;
if ( V_44 ) {
F_5 ( V_28 L_16 ) ;
goto V_55;
}
...
V_44 = F_81 ( V_254 , V_268 , V_2 , & V_58 ) ;
if ( V_44 < 0 )
goto V_55;
F_82 ( V_254 , & V_218 -> V_204 ) ;
* V_264 = V_2 ;
return 0 ;
V_55:
F_54 ( V_2 ) ;
