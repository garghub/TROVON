...
static T_3 F_20 ( struct V_51 * V_14 ,
...
if ( ! V_29 )
return - V_17 ;
V_60 = V_57 ? V_57 -> V_29 : F_31 ( V_11 ) ;
V_29 -> V_14 = & V_11 -> V_14 ;
V_29 -> V_2 = V_2 ;
F_32 ( V_29 -> V_55 , V_60 -> V_55 , sizeof( V_29 -> V_55 ) ) ;
switch ( V_60 -> V_61 ) {
case V_62 :
V_29 -> V_43 = V_63 ;
V_29 -> V_44 = F_33 ( V_63 ) ;
...
F_34 ( V_11 , V_29 ) ;
V_8 = F_35 ( & V_29 -> V_14 -> V_66 , & V_67 ) ;
if ( V_8 ) {
F_29 ( V_29 -> V_14 , L_14 ) ;
return V_8 ;
}
V_29 -> V_68 = F_36 ( V_29 -> V_14 ) ;
if ( F_8 ( V_29 -> V_68 ) ) {
F_29 ( V_29 -> V_14 , L_15 ) ;
V_8 = F_27 ( V_29 -> V_68 ) ;
goto V_69;
...
return 0 ;
V_69:
F_38 ( & V_29 -> V_14 -> V_66 , & V_67 ) ;
F_12 ( V_2 ) ;
return V_8 ;
}
static int F_39 ( struct V_10 * V_11 )
{
struct V_28 * V_29 = F_40 ( V_11 ) ;
struct V_1 * V_2 = V_29 -> V_2 ;
F_41 ( V_29 -> V_68 ) ;
F_38 ( & V_29 -> V_14 -> V_66 , & V_67 ) ;
F_12 ( V_2 ) ;
