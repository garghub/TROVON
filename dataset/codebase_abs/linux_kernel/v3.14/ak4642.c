...
{
int V_70 ;
V_70 = F_17 ( V_9 , 8 , 8 , V_71 ) ;
if ( V_70 < 0 ) {
F_18 ( V_9 -> V_69 , L_1 , V_70 ) ;
return V_70 ;
}
F_11 ( V_9 , V_72 ) ;
return 0 ;
...
{
struct V_77 * V_78 = V_74 -> V_69 . V_79 ;
const struct V_80 * V_80 = NULL ;
struct V_68 * V_68 ;
if ( V_78 ) {
const struct V_81 * V_82 ;
V_82 = F_21 ( V_83 , & V_74 -> V_69 ) ;
if ( V_82 )
V_80 = V_82 -> V_36 ;
} else {
V_80 = ( const struct V_80 * ) V_76 -> V_84 ;
}
if ( ! V_80 ) {
F_18 ( & V_74 -> V_69 , L_2 ) ;
return - V_32 ;
...
if ( F_23 ( V_68 ) )
return F_24 ( V_68 ) ;
return F_25 ( & V_74 -> V_69 ,
& V_85 , & V_86 , 1 ) ;
}
static int F_26 ( struct V_73 * V_87 )
{
F_27 ( & V_87 -> V_69 ) ;
return 0 ;
}
