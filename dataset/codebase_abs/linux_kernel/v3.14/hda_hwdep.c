...
return V_21 ;
if ( V_95 [ V_21 ] . V_97 && F_67 ( V_51 , V_95 [ V_21 ] . V_97 ) )
return V_21 ;
}
return V_98 ;
}
static int F_78 ( char * V_51 , int V_99 , T_4 * V_100 ,
const void * * V_101 )
{
int V_59 ;
T_4 V_102 = * V_100 ;
const char * V_62 = * V_101 ;
while ( isspace ( * V_62 ) && V_102 ) {
V_62 ++ ;
V_102 -- ;
}
if ( ! V_102 )
...
int F_79 ( struct V_86 * V_33 , T_4 V_102 , const void * V_103 )
{
char V_51 [ 128 ] ;
struct V_1 * V_2 ;
int V_104 ;
V_104 = V_98 ;
V_2 = NULL ;
while ( F_78 ( V_51 , sizeof( V_51 ) - 1 , & V_102 , & V_103 ) ) {
if ( ! * V_51 || * V_51 == '#' || * V_51 == '\n' )
continue;
if ( * V_51 == '[' )
V_104 = F_77 ( V_51 , V_33 ) ;
else if ( V_95 [ V_104 ] . V_105 &&
( V_2 || V_104 <= V_106 ) )
V_95 [ V_104 ] . V_105 ( V_51 , V_33 , & V_2 ) ;
}
return 0 ;
}
