...
static int F_133 ( struct V_160 * V_161 , void * V_162 )
{
struct V_1 * V_7 = F_1 ( F_134 ( V_161 ) ) ;
T_7 type = F_135 ( V_161 ) -> V_145 ;
T_8 V_163 ;
char * V_89 , * V_164 ;
int V_24 = 0 ;
V_163 = F_136 ( V_161 , & V_89 ) ;
V_164 = V_89 ;
F_64 ( & V_93 ) ;
switch ( type ) {
case V_158 :
V_164 += F_137 ( V_164 , V_163 , V_7 -> V_30 ) ;
break;
case V_159 :
V_164 += F_138 ( V_164 , V_163 , V_7 -> V_32 ) ;
break;
default:
V_24 = - V_49 ;
goto V_133;
}
if ( V_164 < V_89 + V_163 - 1 ) {
* V_164 ++ = '\n' ;
F_139 ( V_161 , V_164 - V_89 ) ;
} else {
F_139 ( V_161 , - 1 ) ;
}
V_133:
...
static T_6 F_140 ( struct V_2 * V_3 , struct V_143 * V_144 )
{
struct V_1 * V_7 = F_1 ( V_3 ) ;
T_7 type = V_144 -> V_145 ;
switch ( type ) {
...
static T_3 F_142 ( struct V_2 * V_3 , struct V_143 * V_144 )
{
struct V_1 * V_7 = F_1 ( V_3 ) ;
T_7 type = V_144 -> V_145 ;
switch ( type ) {
...
static struct V_2 *
F_143 ( struct V_2 * V_165 )
{
struct V_1 * V_7 ;
if ( ! V_165 )
return & V_47 . V_3 ;
V_7 = F_144 ( sizeof( * V_7 ) , V_41 ) ;
if ( ! V_7 )
return F_19 ( - V_120 ) ;
...
F_108 ( V_17 , & V_7 -> V_10 ) ;
V_73 ++ ;
if ( ! F_9 ( V_168 , & V_3 -> V_51 -> V_10 ) )
goto V_133;
F_39 () ;
F_40 (tmp_cs, pos_css, parent) {
if ( F_11 ( V_167 ) || F_10 ( V_167 ) ) {
F_44 () ;
goto V_133;
}
}
...
struct V_1 * V_166 ;
V_166 = F_5 ( V_7 ) ;
while ( F_42 ( V_166 -> V_30 ) ||
F_43 ( V_166 -> V_32 ) )
V_166 = F_5 ( V_166 ) ;
if ( F_153 ( V_166 -> V_3 . V_51 , V_7 -> V_3 . V_51 ) ) {
F_39 () ;
F_53 ( V_170 L_7 ,
F_154 ( V_7 -> V_3 . V_51 ) ) ;
F_44 () ;
...
static T_1 V_172 ;
bool V_173 ;
bool V_174 = F_120 ( V_7 -> V_3 . V_51 ) ;
V_175:
F_156 ( V_142 , V_7 -> V_52 == 0 ) ;
F_64 ( & V_82 ) ;
if ( V_7 -> V_52 ) {
F_65 ( & V_82 ) ;
goto V_175;
}
F_157 ( & V_171 , V_7 -> V_30 , V_47 . V_30 ) ;
F_158 ( V_172 , V_7 -> V_32 , V_47 . V_32 ) ;
F_64 ( & V_93 ) ;
F_157 ( V_7 -> V_30 , V_7 -> V_30 , & V_171 ) ;
F_65 ( & V_93 ) ;
if ( ( V_174 && F_42 ( V_7 -> V_30 ) ) ||
( ! F_42 ( & V_171 ) && ! F_42 ( V_7 -> V_30 ) ) )
F_70 ( V_7 , NULL ) ;
F_64 ( & V_93 ) ;
F_158 ( V_7 -> V_32 , V_7 -> V_32 , V_172 ) ;
F_65 ( & V_93 ) ;
if ( ( V_174 && F_43 ( V_7 -> V_32 ) ) ||
( ! F_43 ( V_172 ) && ! F_43 ( V_7 -> V_32 ) ) )
F_96 ( V_7 , NULL ) ;
V_173 = F_42 ( V_7 -> V_30 ) ||
F_43 ( V_7 -> V_32 ) ;
F_65 ( & V_82 ) ;
...
static void F_159 ( struct V_176 * V_177 )
{
static T_10 V_178 ;
static T_1 V_179 ;
bool V_180 , V_181 ;
...
F_35 ( & V_178 , V_83 ) ;
V_179 = V_33 [ V_34 ] ;
V_180 = ! F_60 ( V_47 . V_30 , & V_178 ) ;
V_181 = ! F_101 ( V_47 . V_32 , V_179 ) ;
if ( V_180 ) {
F_64 ( & V_93 ) ;
F_35 ( V_47 . V_30 , & V_178 ) ;
F_65 ( & V_93 ) ;
}
if ( V_181 ) {
F_64 ( & V_93 ) ;
...
void F_160 ( bool V_182 )
{
F_61 ( 1 , NULL , NULL ) ;
F_161 ( & V_157 ) ;
}
static int F_162 ( struct V_183 * V_184 ,
unsigned long V_185 , void * V_109 )
{
F_161 ( & V_157 ) ;
return V_186 ;
}
...
void F_165 ( struct V_4 * V_35 , struct V_28 * V_29 )
{
struct V_1 * V_84 ;
F_64 ( & V_93 ) ;
F_84 ( V_35 ) ;
...
void F_166 ( struct V_4 * V_35 )
{
struct V_1 * V_84 ;
F_39 () ;
V_84 = F_66 ( F_3 ( V_35 ) ) ;
F_167 ( V_35 , V_84 -> V_30 ) ;
F_44 () ;
}
void F_168 ( void )
{
...
int F_170 ( T_1 * V_189 )
{
return F_25 ( * V_189 , V_98 -> V_32 ) ;
}
static struct V_1 * F_171 ( struct V_1 * V_7 )
{
while ( ! ( F_11 ( V_7 ) || F_12 ( V_7 ) ) && F_5 ( V_7 ) )
V_7 = F_5 ( V_7 ) ;
return V_7 ;
}
int F_172 ( int V_190 , T_11 V_191 )
{
struct V_1 * V_7 ;
int V_192 ;
if ( F_173 () || ( V_191 & V_193 ) )
return 1 ;
F_174 ( ! ( V_191 & V_194 ) ) ;
if ( F_175 ( V_190 , V_98 -> V_32 ) )
return 1 ;
if ( F_82 ( F_83 ( V_103 ) ) )
return 1 ;
if ( V_191 & V_194 )
...
F_84 ( V_98 ) ;
V_7 = F_171 ( F_3 ( V_98 ) ) ;
V_192 = F_175 ( V_190 , V_7 -> V_32 ) ;
F_91 ( V_98 ) ;
F_65 ( & V_93 ) ;
return V_192 ;
}
int F_176 ( int V_190 , T_11 V_191 )
{
if ( F_173 () || ( V_191 & V_193 ) )
return 1 ;
if ( F_175 ( V_190 , V_98 -> V_32 ) )
...
static int F_177 ( int * V_195 )
{
int V_190 ;
V_190 = F_178 ( * V_195 , V_98 -> V_32 ) ;
if ( V_190 == V_196 )
V_190 = F_179 ( V_98 -> V_32 ) ;
* V_195 = V_190 ;
return V_190 ;
}
int F_180 ( void )
...
V_98 -> V_199 =
F_181 ( & V_98 -> V_32 ) ;
return F_177 ( & V_98 -> V_199 ) ;
}
int F_183 ( const struct V_4 * V_200 ,
const struct V_4 * V_201 )
{
return F_25 ( V_200 -> V_32 , V_201 -> V_32 ) ;
}
void F_184 ( struct V_4 * V_35 )
{
static char V_202 [ V_203 ] ;
static F_185 ( V_204 ) ;
struct V_51 * V_205 = F_3 ( V_35 ) -> V_3 . V_51 ;
F_39 () ;
F_116 ( & V_204 ) ;
F_138 ( V_202 , V_203 ,
V_35 -> V_32 ) ;
F_53 ( V_206 L_8 ,
V_35 -> V_207 , F_154 ( V_205 ) , V_202 ) ;
F_117 ( & V_204 ) ;
F_44 () ;
}
void F_186 ( void )
...
int F_187 ( struct V_160 * V_208 , void * V_209 )
{
struct V_210 * V_210 ;
struct V_4 * V_35 ;
char * V_89 ;
...
V_90 = - V_211 ;
V_210 = V_208 -> V_145 ;
V_35 = F_188 ( V_210 , V_212 ) ;
if ( ! V_35 )
goto V_213;
F_39 () ;
V_3 = F_4 ( V_35 , V_6 ) ;
V_90 = F_189 ( V_3 -> V_51 , V_89 , V_92 ) ;
F_44 () ;
if ( V_90 < 0 )
goto V_214;
F_190 ( V_208 , V_89 ) ;
...
void F_193 ( struct V_160 * V_208 , struct V_4 * V_5 )
{
F_194 ( V_208 , L_9 ) ;
F_195 ( V_208 , & V_5 -> V_32 ) ;
F_194 ( V_208 , L_10 ) ;
F_194 ( V_208 , L_11 ) ;
F_196 ( V_208 , & V_5 -> V_32 ) ;
F_194 ( V_208 , L_10 ) ;
}
