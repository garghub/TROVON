...
V_183 . V_185 = F_104 ( V_161 -> V_186 -> V_138 ) ;
V_183 . V_187 = F_101 ( V_181 ) ;
F_23 ( V_2 , V_161 -> V_163 . V_164 , V_161 -> V_163 . V_165 ,
V_161 -> V_166 , V_188 ,
! F_91 ( V_161 , V_162 ) , sizeof( V_183 ) , & V_183 ) ;
}
...
return;
V_183 . V_184 = F_104 ( V_26 ) ;
V_183 . V_185 = F_104 ( F_106 ( V_147 -> V_189 ) ) ;
V_183 . V_187 = F_101 ( V_181 ) ;
F_23 ( V_2 , F_84 ( V_147 ) , F_83 ( V_147 ) ,
F_107 ( V_147 ) , V_188 , ! ! V_147 -> V_152 ,
sizeof( V_183 ) , & V_183 ) ;
}
...
static inline
const struct V_7 * F_146 ( const struct V_201 * V_202 )
{
return ( const struct V_7 * ) V_202 ;
}
static inline const void * F_147 ( const struct V_201 * V_202 )
{
return F_146 ( V_202 ) + 1 ;
}
static inline T_3 F_148 ( const struct V_201 * V_202 )
{
return F_146 ( V_202 ) -> V_4 ;
}
static inline T_3 F_149 ( const struct V_201 * V_202 )
{
return F_146 ( V_202 ) -> V_57 ;
}
static inline T_3 F_150 ( const struct V_201 * V_202 )
{
return F_146 ( V_202 ) -> V_57 >> 9 ;
}
static inline unsigned long long F_151 ( const struct V_201 * V_202 )
{
return F_146 ( V_202 ) -> V_53 ;
}
static inline T_12 F_152 ( const struct V_201 * V_202 )
{
return F_146 ( V_202 ) -> error ;
}
static T_13 F_153 ( const struct V_201 * V_202 )
{
const T_13 * V_203 = F_147 ( V_202 ) ;
return F_154 ( * V_203 ) ;
}
static void F_155 ( const struct V_201 * V_202 ,
struct V_182 * V_183 )
{
const struct V_182 * V_204 = F_147 ( V_202 ) ;
T_13 V_187 = V_204 -> V_187 ;
V_183 -> V_184 = F_156 ( V_204 -> V_184 ) ;
V_183 -> V_185 = F_156 ( V_204 -> V_185 ) ;
V_183 -> V_187 = F_154 ( V_187 ) ;
}
static int F_157 ( struct V_205 * V_206 , const char * V_207 )
{
char V_191 [ V_208 ] ;
unsigned long long V_209 = V_206 -> V_209 ;
unsigned long V_210 = F_158 ( V_209 , V_211 ) ;
unsigned V_212 = ( unsigned long ) V_209 ;
const struct V_7 * V_8 = F_146 ( V_206 -> V_202 ) ;
F_145 ( V_191 , V_8 ) ;
return F_159 ( & V_206 -> V_213 ,
L_7 ,
F_160 ( V_8 -> V_25 ) , F_161 ( V_8 -> V_25 ) , V_206 -> V_14 ,
V_212 , V_210 , V_206 -> V_202 -> V_3 , V_207 , V_191 ) ;
}
static int F_162 ( struct V_205 * V_206 , const char * V_207 )
{
char V_191 [ V_208 ] ;
const struct V_7 * V_8 = F_146 ( V_206 -> V_202 ) ;
F_145 ( V_191 , V_8 ) ;
return F_159 ( & V_206 -> V_213 , L_8 ,
F_160 ( V_8 -> V_25 ) , F_161 ( V_8 -> V_25 ) , V_207 , V_191 ) ;
}
static int F_163 ( struct V_214 * V_215 , const struct V_201 * V_202 )
{
const unsigned char * V_216 ;
int V_27 ;
int V_110 , V_217 , V_109 ;
V_216 = F_147 ( V_202 ) ;
V_27 = F_146 ( V_202 ) -> V_27 ;
if ( ! V_27 )
return 1 ;
...
V_109 = F_159 ( V_215 , L_9 ,
V_110 == 0 ? L_10 : L_11 , V_216 [ V_110 ] ) ;
if ( ! V_109 )
return V_109 ;
if ( V_110 == V_217 && V_217 != V_27 - 1 )
return F_165 ( V_215 , L_12 ) ;
}
return F_165 ( V_215 , L_13 ) ;
}
static int F_166 ( struct V_214 * V_215 , const struct V_201 * V_202 )
{
char V_132 [ V_218 ] ;
F_167 ( V_202 -> V_3 , V_132 ) ;
if ( F_148 ( V_202 ) & F_82 ( V_150 ) ) {
int V_109 ;
V_109 = F_159 ( V_215 , L_14 , F_149 ( V_202 ) ) ;
if ( ! V_109 )
return 0 ;
V_109 = F_163 ( V_215 , V_202 ) ;
if ( ! V_109 )
return 0 ;
return F_159 ( V_215 , L_15 , V_132 ) ;
} else {
if ( F_150 ( V_202 ) )
return F_159 ( V_215 , L_16 ,
F_151 ( V_202 ) , F_150 ( V_202 ) , V_132 ) ;
return F_159 ( V_215 , L_15 , V_132 ) ;
}
}
static int F_168 ( struct V_214 * V_215 ,
...
V_109 = F_163 ( V_215 , V_202 ) ;
if ( V_109 )
return F_159 ( V_215 , L_17 , F_152 ( V_202 ) ) ;
return 0 ;
} else {
if ( F_150 ( V_202 ) )
return F_159 ( V_215 , L_18 ,
F_151 ( V_202 ) ,
F_150 ( V_202 ) , F_152 ( V_202 ) ) ;
return F_159 ( V_215 , L_19 ,
F_151 ( V_202 ) , F_152 ( V_202 ) ) ;
}
}
static int F_169 ( struct V_214 * V_215 , const struct V_201 * V_202 )
{
struct V_182 V_183 = { . V_184 = 0 , } ;
F_155 ( V_202 , & V_183 ) ;
return F_159 ( V_215 , L_20 ,
F_151 ( V_202 ) , F_150 ( V_202 ) ,
F_160 ( V_183 . V_184 ) , F_161 ( V_183 . V_184 ) ,
( unsigned long long ) V_183 . V_187 ) ;
}
static int F_170 ( struct V_214 * V_215 , const struct V_201 * V_202 )
{
char V_132 [ V_218 ] ;
F_167 ( V_202 -> V_3 , V_132 ) ;
return F_159 ( V_215 , L_15 , V_132 ) ;
}
static int F_171 ( struct V_214 * V_215 , const struct V_201 * V_202 )
{
char V_132 [ V_218 ] ;
F_167 ( V_202 -> V_3 , V_132 ) ;
return F_159 ( V_215 , L_21 , V_132 , F_153 ( V_202 ) ) ;
}
static int F_172 ( struct V_214 * V_215 , const struct V_201 * V_202 )
{
char V_132 [ V_218 ] ;
F_167 ( V_202 -> V_3 , V_132 ) ;
return F_159 ( V_215 , L_22 , F_151 ( V_202 ) ,
F_153 ( V_202 ) , V_132 ) ;
}
static int F_173 ( struct V_214 * V_215 , const struct V_201 * V_202 )
{
int V_109 ;
const struct V_7 * V_8 = F_146 ( V_202 ) ;
V_109 = F_174 ( V_215 , V_8 + 1 , V_8 -> V_27 ) ;
if ( V_109 )
return F_164 ( V_215 , '\n' ) ;
return V_109 ;
}
static void F_175 ( struct V_219 * V_220 )
{
...
static void F_177 ( struct V_223 * V_224 )
{
V_16 = true ;
}
...
static void F_179 ( struct V_223 * V_224 )
{
V_16 = false ;
}
...
static enum V_225 F_181 ( struct V_205 * V_206 ,
bool V_226 )
{
...
bool V_227 ;
T_14 * V_228 ;
V_8 = F_146 ( V_206 -> V_202 ) ;
V_52 = V_8 -> V_4 & ( ( 1 << V_54 ) - 1 ) ;
V_227 = ! ! ( V_229 & V_230 ) ;
V_228 = V_226 ? & F_157 : & F_162 ;
if ( V_8 -> V_4 == V_51 ) {
V_109 = V_228 ( V_206 , V_227 ? L_25 : L_26 ) ;
if ( V_109 )
V_109 = F_173 ( V_215 , V_206 -> V_202 ) ;
goto V_193;
}
if ( F_19 ( V_52 == 0 || V_52 >= F_67 ( V_231 ) ) )
V_109 = F_159 ( V_215 , L_27 , V_52 ) ;
else {
V_109 = V_228 ( V_206 , V_231 [ V_52 ] . V_207 [ V_227 ] ) ;
if ( V_109 )
V_109 = V_231 [ V_52 ] . F_182 ( V_215 , V_206 -> V_202 ) ;
}
V_193:
return V_109 ? V_232 : V_233 ;
}
static enum V_225 F_183 ( struct V_205 * V_206 ,
int V_30 , struct V_234 * V_10 )
{
return F_181 ( V_206 , false ) ;
}
static int F_184 ( struct V_205 * V_206 )
{
struct V_214 * V_215 = & V_206 -> V_213 ;
struct V_7 * V_8 = (struct V_7 * ) V_206 -> V_202 ;
const int V_235 = F_185 ( struct V_7 , V_53 ) ;
struct V_7 V_236 = {
. V_22 = V_23 | V_24 ,
. time = V_206 -> V_209 ,
} ;
if ( ! F_174 ( V_215 , & V_236 , V_235 ) )
return 0 ;
return F_174 ( V_215 , & V_8 -> V_53 ,
sizeof( V_236 ) - V_235 + V_8 -> V_27 ) ;
}
static enum V_225
F_186 ( struct V_205 * V_206 , int V_30 ,
struct V_234 * V_10 )
{
return F_184 ( V_206 ) ?
V_232 : V_233 ;
...
if ( ! ( V_221 . V_203 & V_222 ) )
return V_237 ;
return F_181 ( V_206 , true ) ;
}
static int F_188 ( T_3 V_238 , T_3 V_239 , int V_240 )
{
if ( V_239 == V_222 ) {
if ( V_240 )
V_229 &= ~ V_241 ;
...
static int F_197 ( const char * V_244 )
{
int V_110 ;
int V_245 = 0 ;
char * V_44 , * V_215 , * V_246 ;
V_44 = F_198 ( V_244 , V_84 ) ;
if ( V_44 == NULL )
return - V_85 ;
V_215 = F_199 ( V_44 ) ;
while ( 1 ) {
V_246 = F_200 ( & V_215 , L_30 ) ;
if ( V_246 == NULL )
break;
if ( * V_246 == '\0' )
continue;
for ( V_110 = 0 ; V_110 < F_67 ( V_247 ) ; V_110 ++ ) {
if ( strcasecmp ( V_246 , V_247 [ V_110 ] . V_244 ) == 0 ) {
V_245 |= V_247 [ V_110 ] . V_245 ;
break;
}
}
if ( V_110 == F_67 ( V_247 ) ) {
...
static T_6 F_201 ( char * V_44 , int V_245 )
{
int V_110 ;
char * V_248 = V_44 ;
for ( V_110 = 0 ; V_110 < F_67 ( V_247 ) ; V_110 ++ ) {
if ( V_245 & V_247 [ V_110 ] . V_245 ) {
V_248 += sprintf ( V_248 , L_31 ,
( V_248 == V_44 ) ? L_10 : L_30 , V_247 [ V_110 ] . V_244 ) ;
}
}
* V_248 ++ = '\n' ;
return V_248 - V_44 ;
...
char * V_44 )
{
struct V_100 * V_248 = F_204 ( V_26 ) ;
struct V_74 * V_75 ;
struct V_98 * V_99 ;
T_6 V_109 = - V_135 ;
V_99 = F_205 ( F_206 ( V_248 ) ) ;
if ( V_99 == NULL )
goto V_193;
V_75 = F_202 ( V_99 ) ;
if ( V_75 == NULL )
...
goto V_193;
if ( V_251 == & V_255 ) {
if ( sscanf ( V_44 , L_34 , & V_259 ) != 1 ) {
V_109 = F_197 ( V_44 ) ;
if ( V_109 < 0 )
goto V_193;
V_259 = V_109 ;
}
} else if ( sscanf ( V_44 , L_35 , & V_259 ) != 1 )
goto V_193;
V_109 = - V_135 ;
V_248 = F_204 ( V_26 ) ;
V_99 = F_205 ( F_206 ( V_248 ) ) ;
...
{
return F_210 ( & V_26 -> V_260 , & V_261 ) ;
}
void F_211 ( struct V_25 * V_26 )
{
F_212 ( & V_26 -> V_260 , & V_261 ) ;
}
