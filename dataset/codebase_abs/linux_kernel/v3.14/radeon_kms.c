...
static int F_26 ( struct V_1 * V_2 , void * V_24 , struct V_19 * V_25 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
...
break;
case V_127 :
if ( ( V_4 -> V_128 . V_129 == V_130 ) &&
V_4 -> V_128 . V_131 )
* V_22 = V_4 -> V_128 . V_132 . V_133 . V_134 . V_135 * 10 ;
else
* V_22 = V_4 -> V_128 . V_136 * 10 ;
break;
default:
F_30 ( L_13 , V_27 -> V_39 ) ;
return - V_60 ;
}
if ( F_33 ( V_32 , ( char * ) V_22 , V_33 ) ) {
F_28 ( L_14 , V_52 , __LINE__ ) ;
return - V_53 ;
}
return 0 ;
}
...
int F_36 ( struct V_1 * V_2 , struct V_19 * V_137 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
int V_9 ;
V_137 -> V_138 = NULL ;
...
struct V_141 * V_142 ;
int V_9 ;
V_140 = F_9 ( sizeof( * V_140 ) , V_11 ) ;
if ( F_37 ( ! V_140 ) ) {
return - V_12 ;
}
F_38 ( V_4 , & V_140 -> V_143 ) ;
V_9 = F_39 ( V_4 -> V_144 . V_145 , false ) ;
if ( V_9 )
return V_9 ;
V_142 = F_40 ( V_4 , & V_140 -> V_143 ,
V_4 -> V_144 . V_145 ) ;
V_9 = F_41 ( V_4 , V_142 , V_146 ,
V_147 |
V_148 ) ;
F_42 ( V_4 -> V_144 . V_145 ) ;
if ( V_9 ) {
F_43 ( V_4 , & V_140 -> V_143 ) ;
F_7 ( V_140 ) ;
return V_9 ;
}
V_137 -> V_138 = V_140 ;
...
{
struct V_3 * V_4 = V_2 -> V_5 ;
if ( V_4 -> V_47 >= V_69 && V_137 -> V_138 ) {
struct V_139 * V_140 = V_137 -> V_138 ;
struct V_141 * V_142 ;
int V_9 ;
V_9 = F_39 ( V_4 -> V_144 . V_145 , false ) ;
if ( ! V_9 ) {
V_142 = F_45 ( & V_140 -> V_143 ,
V_4 -> V_144 . V_145 ) ;
if ( V_142 )
F_46 ( V_4 , V_142 ) ;
F_42 ( V_4 -> V_144 . V_145 ) ;
...
T_3 F_49 ( struct V_1 * V_2 , int V_36 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
...
return F_50 ( V_4 , V_36 ) ;
}
int F_51 ( struct V_1 * V_2 , int V_36 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
unsigned long V_149 ;
int V_9 ;
...
F_52 ( & V_4 -> V_150 . V_151 , V_149 ) ;
V_4 -> V_150 . V_152 [ V_36 ] = true ;
V_9 = F_53 ( V_4 ) ;
F_54 ( & V_4 -> V_150 . V_151 , V_149 ) ;
return V_9 ;
}
void F_55 ( struct V_1 * V_2 , int V_36 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
unsigned long V_149 ;
if ( V_36 < 0 || V_36 >= V_4 -> V_54 ) {
...
F_52 ( & V_4 -> V_150 . V_151 , V_149 ) ;
V_4 -> V_150 . V_152 [ V_36 ] = false ;
F_53 ( V_4 ) ;
F_54 ( & V_4 -> V_150 . V_151 , V_149 ) ;
}
int F_56 ( struct V_1 * V_2 , int V_36 ,
int * V_153 ,
struct V_154 * V_155 ,
unsigned V_8 )
{
struct V_35 * V_156 ;
struct V_3 * V_4 = V_2 -> V_5 ;
if ( V_36 < 0 || V_36 >= V_2 -> V_157 ) {
F_28 ( L_15 , V_36 ) ;
return - V_60 ;
}
V_156 = & V_4 -> V_30 . V_55 [ V_36 ] -> V_56 ;
return F_57 ( V_2 , V_36 , V_153 ,
V_155 , V_8 ,
V_156 , & V_156 -> V_158 ) ;
}
