...
F_79 (i) {
struct V_41 * V_160 ;
V_160 = F_80 ( V_17 ( V_4 ) -> V_41 , V_125 ) ;
F_81 ( & V_160 -> V_43 ) ;
}
return 0 ;
}
...
F_83 ( V_18 -> V_41 ) ;
V_18 -> V_41 = NULL ;
for ( V_125 = 0 ; V_125 < F_84 ( V_18 -> V_60 ) ; V_125 ++ ) {
while ( ( V_161 = V_18 -> V_60 [ V_125 ] ) != NULL ) {
V_18 -> V_60 [ V_125 ] = V_161 -> V_62 ;
F_85 ( V_161 ) ;
}
}
}
static T_5 F_86 ( struct V_3 * V_4 ,
T_5 V_142 )
{
struct V_3 * V_34 = V_17 ( V_4 ) -> V_34 ;
T_5 V_162 = V_142 ;
...
return F_88 ( V_18 -> V_34 , V_88 ) ;
}
static void F_89 ( struct V_3 * V_4 ,
struct V_166 * V_167 )
{
F_90 ( V_167 -> V_168 , V_169 , sizeof( V_167 -> V_168 ) ) ;
F_90 ( V_167 -> V_170 , V_171 , sizeof( V_167 -> V_170 ) ) ;
F_90 ( V_167 -> V_172 , L_3 , sizeof( V_167 -> V_172 ) ) ;
}
static struct V_173 * F_91 ( struct V_3 * V_4 , struct V_173 * V_42 )
{
if ( V_17 ( V_4 ) -> V_41 ) {
struct V_41 * V_81 ;
T_3 V_174 = 0 , V_46 = 0 ;
...
unsigned int V_180 ;
V_81 = F_80 ( V_17 ( V_4 ) -> V_41 , V_125 ) ;
do {
V_180 = F_92 ( & V_81 -> V_43 ) ;
V_175 = V_81 -> V_181 ;
V_176 = V_81 -> V_182 ;
V_177 = V_81 -> V_183 ;
V_178 = V_81 -> V_44 ;
V_179 = V_81 -> V_45 ;
} while ( F_93 ( & V_81 -> V_43 , V_180 ) );
V_42 -> V_181 += V_175 ;
V_42 -> V_182 += V_176 ;
V_42 -> V_184 += V_177 ;
V_42 -> V_44 += V_178 ;
...
static int F_95 ( struct V_3 * V_4 , struct V_185 * V_186 ,
T_6 V_187 )
{
struct V_17 * V_18 = V_17 ( V_4 ) ;
struct V_3 * V_34 = V_18 -> V_34 ;
struct V_35 * V_35 ;
int V_72 = 0 ;
V_35 = F_96 ( sizeof( * V_35 ) , V_187 ) ;
V_72 = - V_159 ;
if ( ! V_35 )
goto V_75;
V_72 = F_97 ( V_35 , V_34 , V_187 ) ;
if ( V_72 ) {
F_85 ( V_35 ) ;
goto V_75;
}
...
F_101 ( V_4 ) ;
V_4 -> V_188 |= V_189 ;
V_4 -> V_188 &= ~ ( V_190 | V_191 ) ;
V_4 -> V_192 = 0 ;
V_4 -> V_91 = & V_157 ;
V_4 -> V_193 = V_194 ;
V_4 -> V_195 = & V_196 ;
memset ( V_4 -> V_148 , 0 , V_197 ) ;
}
