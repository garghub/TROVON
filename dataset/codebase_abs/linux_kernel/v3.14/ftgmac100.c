...
static int F_116 ( struct V_125 * V_130 )
{
return 0 ;
}
...
struct V_141 * V_142 )
{
F_118 ( V_142 -> V_143 , V_144 , sizeof( V_142 -> V_143 ) ) ;
F_118 ( V_142 -> V_145 , V_146 , sizeof( V_142 -> V_145 ) ) ;
F_118 ( V_142 -> V_147 , F_107 ( & V_11 -> V_73 ) , sizeof( V_142 -> V_147 ) ) ;
}
static int F_119 ( struct V_10 * V_11 ,
struct V_148 * V_149 )
{
struct V_1 * V_2 = F_103 ( V_11 ) ;
return F_120 ( V_2 -> V_119 , V_149 ) ;
}
static int F_121 ( struct V_10 * V_11 ,
struct V_148 * V_149 )
{
struct V_1 * V_2 = F_103 ( V_11 ) ;
return F_122 ( V_2 -> V_119 , V_149 ) ;
}
static T_6 F_123 ( int V_150 , void * V_151 )
{
...
static int F_127 ( struct V_153 * V_85 , int V_154 )
{
struct V_1 * V_2 = F_128 ( V_85 , struct V_1 , V_85 ) ;
struct V_10 * V_11 = V_2 -> V_11 ;
unsigned int V_155 ;
bool V_156 = true ;
int V_157 = 0 ;
...
V_117 = F_131 ( V_2 -> V_150 , F_123 , 0 , V_11 -> V_127 , V_11 ) ;
if ( V_117 ) {
...
static int F_138 ( struct V_67 * V_68 ,
struct V_10 * V_11 )
{
struct V_1 * V_2 = F_103 ( V_11 ) ;
T_1 V_72 ;
...
V_72 = F_139 ( V_2 -> V_73 , V_68 -> V_137 , F_83 ( V_68 ) , V_105 ) ;
if ( F_45 ( F_95 ( V_2 -> V_73 , V_72 ) ) ) {
if ( F_46 () )
F_10 ( V_11 , L_25 ) ;
V_11 -> V_60 . V_174 ++ ;
...
static int F_140 ( struct V_10 * V_11 , struct V_175 * V_176 , int V_149 )
{
struct V_1 * V_2 = F_103 ( V_11 ) ;
return F_141 ( V_2 -> V_119 , V_176 , V_149 ) ;
}
static int F_142 ( struct V_177 * V_178 )
{
struct V_179 * V_180 ;
int V_150 ;
struct V_10 * V_11 ;
...
if ( ! V_178 )
return - V_128 ;
V_180 = F_143 ( V_178 , V_181 , 0 ) ;
if ( ! V_180 )
return - V_182 ;
V_150 = F_144 ( V_178 , 0 ) ;
if ( V_150 < 0 )
return V_150 ;
V_11 = F_145 ( sizeof( * V_2 ) ) ;
if ( ! V_11 ) {
V_117 = - V_115 ;
goto V_183;
}
F_146 ( V_11 , & V_178 -> V_73 ) ;
F_147 ( V_11 , & V_184 ) ;
V_11 -> V_185 = & V_186 ;
...
V_2 -> V_73 = & V_178 -> V_73 ;
F_149 ( & V_2 -> V_106 ) ;
F_150 ( V_11 , & V_2 -> V_85 , F_127 , 64 ) ;
V_2 -> V_180 = F_151 ( V_180 -> V_190 , F_152 ( V_180 ) ,
F_107 ( & V_178 -> V_73 ) ) ;
if ( ! V_2 -> V_180 ) {
F_153 ( & V_178 -> V_73 , L_26 ) ;
V_117 = - V_115 ;
goto V_191;
}
V_2 -> V_4 = F_154 ( V_180 -> V_190 , F_152 ( V_180 ) ) ;
if ( ! V_2 -> V_4 ) {
F_153 ( & V_178 -> V_73 , L_27 ) ;
V_117 = - V_16 ;
goto V_192;
}
V_2 -> V_150 = V_150 ;
...
V_2 -> V_125 -> V_198 = F_116 ;
V_2 -> V_125 -> V_150 = V_2 -> V_199 ;
for ( V_12 = 0 ; V_12 < V_123 ; V_12 ++ )
V_2 -> V_125 -> V_150 [ V_12 ] = V_200 ;
V_117 = F_156 ( V_2 -> V_125 ) ;
if ( V_117 ) {
F_153 ( & V_178 -> V_73 , L_30 ) ;
goto V_201;
}
V_117 = F_105 ( V_2 ) ;
if ( V_117 ) {
F_153 ( & V_178 -> V_73 , L_31 ) ;
goto V_202;
}
V_117 = F_157 ( V_11 ) ;
if ( V_117 ) {
F_153 ( & V_178 -> V_73 , L_32 ) ;
goto V_203;
}
...
static int T_7 F_167 ( struct V_177 * V_178 )
{
struct V_10 * V_11 ;
struct V_1 * V_2 ;
V_11 = F_168 ( V_178 ) ;
