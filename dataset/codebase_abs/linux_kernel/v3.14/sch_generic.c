...
V_123 -> V_127 = V_125 -> V_127 ;
V_123 -> V_128 = F_140 ( T_2 , V_125 -> V_129 , V_126 ) ;
V_123 -> V_130 = ( V_125 -> V_130 & V_131 ) ;
V_123 -> V_132 = 1 ;
if ( V_123 -> V_128 > 0 ) {
T_2 V_133 = V_134 ;
for (; ; ) {
V_123 -> V_132 = F_141 ( V_133 , V_123 -> V_128 ) ;
if ( V_123 -> V_132 & ( 1U << 31 ) || V_133 & ( 1ULL << 63 ) )
break;
V_133 <<= 1 ;
V_123 -> V_135 ++ ;
}
