...
struct V_75 * V_76 )
{
if ( V_168 -> V_170 != V_169 -> V_170 )
return 0 ;
if ( memcmp ( V_168 -> V_171 , V_169 -> V_171 , V_172 ) != 0 )
return 0 ;
if ( V_76 -> V_173 != V_174 ) {
if ( V_168 -> V_82 != V_169 -> V_82 )
return 0 ;
if ( memcmp ( V_168 -> V_83 , V_169 -> V_83 , V_168 -> V_82 ) != 0 )
return 0 ;
}
if ( ( V_168 -> V_175 & V_176 ) !=
( V_169 -> V_175 & V_176 ) )
return 0 ;
if ( ( V_168 -> V_175 & V_177 ) !=
( V_169 -> V_175 & V_177 ) )
return 0 ;
return 1 ;
}
