...
if ( V_1 -> V_60 && F_36 ( V_1 -> V_60 -> V_61 ) ) {
F_5 ( L_6 ,
V_1 , ( int ) V_1 -> V_13 . V_14 , V_1 -> V_13 . V_15 ) ;
if ( F_1 ( V_1 , V_2 , V_3 ) ) {
V_56 = V_1 ;
...
F_14 ( & V_56 -> V_38 -> V_27 ) ;
F_19 ( & V_56 -> V_27 , V_32 ) ;
F_38 ( & V_56 -> V_38 -> V_30 , & V_56 -> V_28 . V_29 ) ;
F_16 ( & V_56 -> V_27 ) ;
F_16 ( & V_56 -> V_38 -> V_27 ) ;
F_16 ( & V_18 -> V_26 ) ;
return V_56 ;
...
V_66 . V_67 . V_68 = V_18 -> V_69 ;
V_66 . V_67 . type = V_70 ;
if ( ( V_1 = F_35 ( V_45 , V_9 , V_18 , 0 ) ) == NULL )
return - V_63 ;
V_66 . V_14 = V_1 -> V_13 . V_14 ;
memcpy ( V_66 . V_15 , V_1 -> V_13 . V_15 , V_66 . V_14 ) ;
V_66 . V_15 [ V_66 . V_14 ] = '\0' ;
F_17 ( V_1 ) ;
if ( F_44 ( V_65 , & V_66 , sizeof( struct V_64 ) ) )
V_34 = - V_71 ;
F_14 ( & V_18 -> V_50 ) ;
V_5 = F_2 ( V_1 ) ;
V_5 -> V_51 &= ~ V_54 ;
...
int F_46 ( struct V_44 * V_45 , struct V_8 * V_9 ,
struct V_17 * V_18 , int V_72 )
{
struct V_1 * V_1 ;
int V_34 = - V_63 ;
if ( F_47 ( V_18 -> type ) )
V_1 = F_33 ( V_45 , V_9 , V_18 , V_72 ) ;
else
V_1 = F_35 ( V_45 , V_9 , V_18 , V_72 ) ;
if ( V_1 ) {
struct V_4 * V_5 = F_2 ( V_1 ) ;
V_34 = F_40 ( V_18 , V_1 , V_73 ) ;
F_14 ( & V_18 -> V_50 ) ;
V_5 -> V_51 &= ~ V_54 ;
F_45 ( & V_5 -> V_55 ) ;
F_16 ( & V_18 -> V_50 ) ;
...
struct V_17 * V_18 , int T_1 * V_74 )
{
int V_3 = 0 ;
if ( V_74 && F_49 ( V_3 , V_74 ) )
return - V_71 ;
return F_46 ( V_45 , V_9 , V_18 , V_3 ) ;
}
