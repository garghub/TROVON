...
void F_51 ( struct V_42 * V_41 )
{
struct V_14 * V_15 = V_41 -> V_5 . V_15 ;
struct V_16 * V_17 = V_15 -> V_18 ;
struct V_84 * V_85 = & V_17 -> V_86 ;
int clock = V_41 -> V_51 . V_125 ;
T_2 V_19 , V_134 , V_135 ;
int V_136 ;
const char * V_137 ;
T_2 V_138 = ( 1 << 31 ) ;
...
V_135 = V_95 | V_133 |
F_48 ( V_102 ) |
F_49 ( V_103 ) | F_50 ( V_104 ) ;
break;
case V_99 :
F_8 ( 1 , L_30 ) ;
return;
default:
F_8 ( 1 , L_31 , V_41 -> V_55 ) ;
return;
}
V_134 = F_18 ( V_19 ) ;
F_8 ( V_136 < 1 , L_32 , V_137 , V_136 ) ;
if ( V_136 == 1 ) {
F_8 ( V_134 & V_138 , L_33 , V_137 ) ;
F_12 ( V_19 , V_135 ) ;
F_25 ( V_19 ) ;
F_17 ( 20 ) ;
} else {
F_8 ( ( V_134 & V_138 ) == 0 , L_34 , V_137 ) ;
}
}
...
struct V_42 * V_42 = F_21 ( V_41 ) ;
struct V_2 * V_2 = F_38 ( V_41 ) ;
enum V_141 V_142 = V_42 -> V_51 . V_142 ;
int type = V_2 -> type ;
T_2 V_43 ;
if ( type == V_6 || type == V_7 ) {
V_43 = V_143 ;
switch ( V_42 -> V_51 . V_144 ) {
case 18 :
V_43 |= V_145 ;
break;
case 24 :
...
F_12 ( F_54 ( V_142 ) , V_43 ) ;
}
}
void F_55 ( struct V_40 * V_41 )
{
struct V_42 * V_42 = F_21 ( V_41 ) ;
struct V_2 * V_2 = F_38 ( V_41 ) ;
struct V_3 * V_4 = & V_2 -> V_5 ;
...
if ( V_42 -> V_51 . V_72 . V_154 & V_155 )
V_43 |= V_156 ;
if ( V_42 -> V_51 . V_72 . V_154 & V_157 )
V_43 |= V_158 ;
if ( V_142 == V_159 ) {
switch ( V_70 ) {
case V_160 :
if ( F_7 ( V_15 ) && V_42 -> V_51 . V_161 . V_162 )
V_43 |= V_163 ;
else
V_43 |= V_164 ;
break;
...
bool F_59 ( struct V_176 * V_176 )
{
struct V_14 * V_15 = V_176 -> V_5 . V_15 ;
struct V_16 * V_17 = V_15 -> V_18 ;
struct V_2 * V_2 = V_176 -> V_4 ;
int type = V_176 -> V_5 . V_177 ;
enum V_1 V_1 = F_1 ( V_2 ) ;
enum V_70 V_70 = 0 ;
enum V_141 V_142 ;
T_2 V_178 ;
if ( ! V_2 -> V_179 ( V_2 , & V_70 ) )
return false ;
if ( V_1 == V_34 )
V_142 = V_159 ;
else
V_142 = (enum V_141 ) V_70 ;
V_178 = F_18 ( F_57 ( V_142 ) ) ;
switch ( V_178 & V_180 ) {
case V_170 :
case V_171 :
return ( type == V_181 ) ;
...
for ( V_20 = V_187 ; V_20 <= V_188 ; V_20 ++ ) {
V_178 = F_18 ( F_57 ( V_20 ) ) ;
if ( ( V_178 & V_174 )
== F_56 ( V_1 ) ) {
* V_70 = V_20 ;
return true ;
...
static T_2 F_61 ( struct V_16 * V_17 ,
enum V_70 V_70 )
{
T_2 V_43 , V_82 ;
enum V_1 V_1 = V_189 ;
enum V_141 V_142 = F_62 ( V_17 ,
V_70 ) ;
int V_20 ;
if ( V_142 == V_159 ) {
V_1 = V_34 ;
} else {
V_43 = F_18 ( F_57 ( V_142 ) ) ;
V_43 &= V_174 ;
...
T_2 V_199 = F_18 ( V_200 ) ;
T_2 V_201 = V_199 & V_202 ;
if ( V_199 & V_203 ) {
return 800000 ;
} else if ( F_18 ( V_204 ) & V_205 ) {
return 450000 ;
} else if ( V_201 == V_206 ) {
return 450000 ;
} else if ( F_7 ( V_15 ) ) {
...
if ( V_4 -> type == V_7 && V_17 -> V_22 . V_220 &&
V_215 -> V_144 > V_17 -> V_22 . V_220 ) {
F_30 ( L_43 ,
V_215 -> V_144 , V_17 -> V_22 . V_220 ) ;
V_17 -> V_22 . V_220 = V_215 -> V_144 ;
}
}
...
static bool F_96 ( struct V_2 * V_4 ,
struct V_214 * V_215 )
{
int type = V_4 -> type ;
int V_1 = F_1 ( V_4 ) ;
...
V_215 -> V_142 = V_159 ;
if ( type == V_8 )
return F_97 ( V_4 , V_215 ) ;
else
return F_98 ( V_4 , V_215 ) ;
}
static struct V_176 *
...
struct V_176 * V_221 ;
enum V_1 V_1 = V_11 -> V_1 ;
V_221 = F_100 ( sizeof( * V_221 ) , V_222 ) ;
if ( ! V_221 )
return NULL ;
V_11 -> V_210 . V_223 = F_16 ( V_1 ) ;
if ( ! F_101 ( V_11 , V_221 ) ) {
F_102 ( V_221 ) ;
return NULL ;
}
...
if ( ! V_221 )
return NULL ;
V_11 -> V_224 . V_225 = F_16 ( V_1 ) ;
F_104 ( V_11 , V_221 ) ;
return V_221 ;
}
void F_105 ( struct V_14 * V_15 , enum V_1 V_1 )
{
struct V_16 * V_17 = V_15 -> V_18 ;
struct V_10 * V_11 ;
struct V_2 * V_2 ;
struct V_3 * V_4 ;
struct V_176 * V_226 = NULL ;
struct V_176 * V_227 = NULL ;
bool V_228 , V_229 ;
V_228 = ( V_17 -> V_22 . V_23 [ V_1 ] . V_230 ||
V_17 -> V_22 . V_23 [ V_1 ] . V_231 ) ;
V_229 = V_17 -> V_22 . V_23 [ V_1 ] . V_232 ;
if ( ! V_229 && ! V_228 ) {
F_30 ( L_45 ,
F_19 ( V_1 ) ) ;
V_228 = true ;
...
V_11 = F_100 ( sizeof( * V_11 ) , V_222 ) ;
if ( ! V_11 )
return;
V_2 = & V_11 -> V_5 ;
V_4 = & V_2 -> V_5 ;
F_106 ( V_15 , V_4 , & V_233 ,
V_234 ) ;
V_2 -> V_235 = F_96 ;
V_2 -> V_236 = F_31 ;
V_2 -> V_237 = F_78 ;
...
V_243 ) ;
V_2 -> type = V_9 ;
V_2 -> V_244 = ( 1 << 0 ) | ( 1 << 1 ) | ( 1 << 2 ) ;
V_2 -> V_245 = false ;
V_2 -> V_246 = F_90 ;
if ( V_229 )
V_227 = F_99 ( V_11 ) ;
if ( V_2 -> type != V_7 && V_228 )
V_226 = F_103 ( V_11 ) ;
if ( ! V_227 && ! V_226 ) {
F_107 ( V_4 ) ;
F_102 ( V_11 ) ;
