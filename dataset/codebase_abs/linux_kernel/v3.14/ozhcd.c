...
F_122 ( V_3 -> V_236 . V_237 ) ;
F_27 ( & V_80 ) ;
V_81 = V_5 ;
F_30 ( & V_80 ) ;
return 0 ;
}
static int F_123 ( struct V_234 * V_118 )
{
struct V_2 * V_3 = F_124 ( V_118 ) ;
struct V_1 * V_5 ;
if ( V_3 == NULL )
return - 1 ;
V_5 = F_1 ( V_3 ) ;
...
static int F_126 ( struct V_234 * V_118 , T_5 V_238 )
{
return 0 ;
}
static int F_127 ( struct V_234 * V_118 )
{
return 0 ;
}
int F_128 ( void )
