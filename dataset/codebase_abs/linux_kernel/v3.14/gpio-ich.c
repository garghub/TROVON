...
if ( ! F_7 ( V_23 , V_2 ) )
return - V_25 ;
if ( V_11 . V_26 -> V_27 [ V_2 / 32 ] & ( 1 << ( V_2 & 0x1f ) ) )
return 0 ;
return F_6 ( V_28 , V_2 ) ? 0 : - V_29 ;
}
...
V_23 -> V_30 = V_31 ;
V_23 -> V_32 = V_33 ;
V_23 -> V_34 = & V_11 . V_34 -> V_34 ;
V_23 -> V_35 = V_11 . V_26 -> V_35 ?
V_11 . V_26 -> V_35 : F_12 ;
V_23 -> V_36 = V_11 . V_26 -> V_36 ?
V_11 . V_26 -> V_36 : F_10 ;
V_23 -> V_37 = F_14 ;
V_23 -> V_38 = F_8 ;
V_23 -> V_39 = F_9 ;
V_23 -> V_40 = V_41 ;
V_23 -> V_42 = V_11 . V_26 -> V_42 ;
V_23 -> V_43 = false ;
V_23 -> V_44 = NULL ;
}
...
{
int V_48 ;
if ( ! V_46 || ! V_46 -> V_49 || ! V_46 -> V_50 )
return - V_29 ;
for ( V_48 = 0 ; V_48 < F_17 ( V_13 [ 0 ] ) ; V_48 ++ ) {
if ( ! ( V_18 & ( 1 << V_48 ) ) )
continue;
if ( ! F_18 ( V_46 -> V_49 + V_13 [ 0 ] [ V_48 ] ,
V_51 [ V_48 ] , V_47 ) )
goto V_52;
}
return 0 ;
...
if ( ! ( V_18 & ( 1 << V_48 ) ) )
continue;
F_19 ( V_46 -> V_49 + V_13 [ 0 ] [ V_48 ] ,
V_51 [ V_48 ] ) ;
}
return - V_53 ;
}
static void F_20 ( struct V_45 * V_46 , T_2 V_18 )
{
int V_48 ;
for ( V_48 = 0 ; V_48 < F_17 ( V_13 [ 0 ] ) ; V_48 ++ ) {
if ( ! ( V_18 & ( 1 << V_48 ) ) )
...
int V_57 ;
struct V_58 * V_59 = F_22 ( & V_55 -> V_34 ) ;
if ( ! V_59 )
return - V_29 ;
V_11 . V_34 = V_55 ;
switch ( V_59 -> V_60 ) {
...
F_23 ( & V_11 . V_12 ) ;
V_46 = F_24 ( V_55 , V_75 , V_76 ) ;
V_11 . V_18 = V_59 -> V_18 ;
V_57 = F_16 ( V_46 , V_55 -> V_47 ,
V_11 . V_18 ) ;
if ( V_57 )
return V_57 ;
V_11 . V_14 = V_46 ;
if ( ! V_11 . V_26 -> V_77 )
goto V_78;
V_56 = F_24 ( V_55 , V_75 , V_79 ) ;
if ( ! V_56 ) {
F_25 ( L_1 ) ;
goto V_78;
}
if ( ! F_18 ( V_56 -> V_49 , F_26 ( V_56 ) ,
V_55 -> V_47 ) ) {
F_25 ( L_2 ) ;
goto V_78;
}
...
F_29 ( L_4 , V_11 . V_23 . V_40 ,
V_11 . V_23 . V_40 + V_11 . V_23 . V_42 - 1 , V_33 ) ;
return 0 ;
V_80:
