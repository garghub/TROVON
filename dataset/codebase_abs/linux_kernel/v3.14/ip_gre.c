...
V_7 -> V_53 = V_96 + sizeof( struct V_10 ) + 4 ;
...
static int F_55 ( struct V_115 * V_116 [] , struct V_115 * V_55 [] )
{
T_2 V_28 ;
if ( ! V_55 )
return 0 ;
...
if ( V_55 [ V_118 ] )
V_28 |= F_56 ( V_55 [ V_118 ] ) ;
if ( V_28 & ( V_76 | V_77 ) )
return - V_78 ;
return 0 ;
}
static int F_57 ( struct V_115 * V_116 [] , struct V_115 * V_55 [] )
{
T_6 V_29 ;
if ( V_116 [ V_119 ] ) {
...
goto V_51;
if ( V_55 [ V_121 ] ) {
memcpy ( & V_29 , F_60 ( V_55 [ V_121 ] ) , 4 ) ;
if ( ! V_29 )
return - V_78 ;
}
V_51:
return F_55 ( V_116 , V_55 ) ;
}
static void F_61 ( struct V_115 * V_55 [] , struct V_115 * V_116 [] ,
struct V_63 * V_33 )
{
...
return;
if ( V_55 [ V_122 ] )
V_33 -> V_88 = F_62 ( V_55 [ V_122 ] ) ;
if ( V_55 [ V_117 ] )
V_33 -> V_75 = F_27 ( F_56 ( V_55 [ V_117 ] ) ) ;
if ( V_55 [ V_118 ] )
V_33 -> V_43 = F_27 ( F_56 ( V_55 [ V_118 ] ) ) ;
if ( V_55 [ V_123 ] )
V_33 -> V_124 = F_63 ( V_55 [ V_123 ] ) ;
if ( V_55 [ V_125 ] )
V_33 -> V_44 = F_63 ( V_55 [ V_125 ] ) ;
if ( V_55 [ V_126 ] )
V_33 -> V_11 . V_30 = F_63 ( V_55 [ V_126 ] ) ;
if ( V_55 [ V_121 ] )
V_33 -> V_11 . V_29 = F_63 ( V_55 [ V_121 ] ) ;
if ( V_55 [ V_127 ] )
V_33 -> V_11 . V_34 = F_64 ( V_55 [ V_127 ] ) ;
if ( V_55 [ V_128 ] )
V_33 -> V_11 . V_87 = F_64 ( V_55 [ V_128 ] ) ;
if ( ! V_55 [ V_129 ] || F_64 ( V_55 [ V_129 ] ) )
...
struct V_115 * V_116 [] , struct V_115 * V_55 [] )
{
struct V_63 V_64 ;
F_61 ( V_55 , V_116 , & V_64 ) ;
return F_69 ( V_7 , V_116 , & V_64 ) ;
}
static int F_70 ( struct V_41 * V_7 , struct V_115 * V_116 [] ,
struct V_115 * V_55 [] )
{
struct V_63 V_64 ;
F_61 ( V_55 , V_116 , & V_64 ) ;
...
F_76 ( V_2 , V_118 , F_29 ( V_64 -> V_43 ) ) ||
F_77 ( V_2 , V_123 , V_64 -> V_124 ) ||
F_77 ( V_2 , V_125 , V_64 -> V_44 ) ||
F_77 ( V_2 , V_126 , V_64 -> V_11 . V_30 ) ||
F_77 ( V_2 , V_121 , V_64 -> V_11 . V_29 ) ||
F_78 ( V_2 , V_127 , V_64 -> V_11 . V_34 ) ||
