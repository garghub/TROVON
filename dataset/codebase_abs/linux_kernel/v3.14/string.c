...
char * * F_8 ( const char * V_1 , int * V_16 )
{
int V_17 = F_5 ( V_1 ) ;
char * * V_14 = F_9 ( sizeof( * V_14 ) * ( V_17 + 1 ) ) ;
char * * V_18 ;
if ( V_14 == NULL )
goto V_11;
if ( V_16 )
...
static bool F_11 ( const char * V_21 , char V_22 , const char * * V_23 )
{
...
static bool F_12 ( const char * V_1 , const char * V_21 , bool V_27 )
{
while ( * V_1 && * V_21 && * V_21 != '*' ) {
if ( V_27 ) {
if ( isspace ( * V_1 ) ) {
...
{
return F_12 ( V_1 , V_21 , false ) ;
}
bool F_14 ( const char * V_1 , const char * V_21 )
{
return F_12 ( V_1 , V_21 , true ) ;
}
int F_15 ( const char * V_28 , const char * V_29 )
{
...
char * F_16 ( char * V_32 , char V_33 , char V_34 )
{
char * V_15 = V_32 ;
...
void * F_19 ( const void * V_37 , T_2 V_35 )
{
void * V_15 ;
V_15 = malloc ( V_35 ) ;
if ( V_15 )
...
int F_20 ( char * * V_32 , int * V_35 , const char * V_38 )
{
