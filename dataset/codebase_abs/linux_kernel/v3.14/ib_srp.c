...
{
struct V_192 * V_193 = F_81 ( V_17 , V_114 , NULL ) ;
if ( V_193 ) {
...
F_85 ( V_17 , V_114 , V_204 << 16 ) ;
}
}
static int F_87 ( struct V_184 * V_179 )
{
struct V_12 * V_17 = V_179 -> V_185 ;
int V_88 , V_42 ;
F_52 ( V_17 ) ;
...
for ( V_88 = 0 ; V_88 < V_17 -> V_160 ; ++ V_88 ) {
struct V_158 * V_114 = & V_17 -> V_159 [ V_88 ] ;
F_85 ( V_17 , V_114 , V_205 << 16 ) ;
}
F_56 ( & V_17 -> V_206 ) ;
for ( V_88 = 0 ; V_88 < V_17 -> V_69 ; ++ V_88 )
F_88 ( & V_17 -> V_90 [ V_88 ] -> V_173 , & V_17 -> V_206 ) ;
if ( V_42 == 0 )
V_42 = F_75 ( V_17 ) ;
if ( V_42 == 0 )
...
static void F_89 ( struct V_208 * V_151 , T_4 V_168 ,
unsigned int V_209 , T_6 V_210 )
{
struct V_211 * V_212 = V_151 -> V_212 ;
V_212 -> V_213 = F_90 ( V_168 ) ;
...
static int F_91 ( struct V_208 * V_151 ,
struct V_12 * V_17 )
{
...
return 0 ;
if ( V_151 -> V_220 == 1 ) {
F_89 ( V_151 , V_151 -> V_221 , V_151 -> V_222 ,
V_17 -> V_210 ) ;
V_151 -> V_220 = V_151 -> V_222 = 0 ;
return 0 ;
}
V_218 = F_92 ( V_33 -> V_223 , V_151 -> V_224 ,
V_151 -> V_220 , V_219 ) ;
if ( F_24 ( V_218 ) )
return F_25 ( V_218 ) ;
* V_151 -> V_225 ++ = V_218 ;
V_151 -> V_198 ++ ;
F_89 ( V_151 , 0 , V_151 -> V_222 , V_218 -> V_218 -> V_210 ) ;
V_151 -> V_220 = V_151 -> V_222 = 0 ;
return 0 ;
}
static void F_93 ( struct V_208 * V_151 ,
...
static int F_94 ( struct V_208 * V_151 ,
struct V_12 * V_17 ,
struct V_226 * V_227 , int V_228 ,
int V_232 )
{
...
T_4 V_168 = F_95 ( V_157 , V_227 ) ;
unsigned int V_209 = F_96 ( V_157 , V_227 ) ;
unsigned int V_215 ;
int V_42 ;
if ( ! V_209 )
return 0 ;
if ( V_232 == V_233 ) {
F_89 ( V_151 , V_168 , V_209 , V_17 -> V_210 ) ;
return 0 ;
}
if ( V_168 & ~ V_33 -> V_234 || V_209 > V_33 -> V_235 ) {
V_42 = F_91 ( V_151 , V_17 ) ;
if ( V_42 )
return V_42 ;
F_89 ( V_151 , V_168 , V_209 , V_17 -> V_210 ) ;
F_93 ( V_151 , NULL , 0 , 0 ) ;
...
V_215 = F_97 (unsigned int, dma_len, dev->fmr_page_size) ;
if ( ! V_151 -> V_220 )
V_151 -> V_221 = V_168 ;
...
static int F_98 ( struct V_192 * V_193 , struct V_12 * V_17 ,
struct V_158 * V_114 )
{
...
T_6 V_244 ;
T_1 V_245 ;
if ( ! F_77 ( V_193 ) || V_193 -> V_196 == V_246 )
...
V_33 = V_17 -> V_23 -> V_32 ;
V_157 = V_33 -> V_33 ;
V_241 = F_99 ( V_157 , V_237 , V_240 , V_193 -> V_196 ) ;
if ( F_100 ( V_241 == 0 ) )
return - V_248 ;
V_245 = V_249 ;
...
V_29 -> V_213 = F_90 ( F_95 ( V_157 , V_237 ) ) ;
V_29 -> V_214 = F_43 ( V_17 -> V_210 ) ;
V_29 -> V_215 = F_43 ( F_96 ( V_157 , V_237 ) ) ;
V_114 -> V_198 = 0 ;
goto V_251;
}
V_243 = ( void * ) V_239 -> V_250 ;
F_101 ( V_157 , V_114 -> V_163 ,
V_17 -> V_164 , V_165 ) ;
...
F_102 (scat, sg, count, i) {
if ( F_94 ( & V_151 , V_17 , V_227 , V_88 , V_232 ) ) {
T_4 V_168 ;
unsigned int V_209 ;
V_253:
V_227 = V_151 . V_229 ;
V_88 = V_151 . V_230 ;
V_168 = F_95 ( V_157 , V_227 ) ;
V_209 = F_96 ( V_157 , V_227 ) ;
...
if ( V_232 == V_252 && F_91 ( & V_151 , V_17 ) )
goto V_253;
...
if ( F_100 ( V_17 -> V_170 < V_151 . V_217 &&
! V_17 -> V_254 ) ) {
F_35 ( V_95 , V_17 -> V_96 ,
L_13 ) ;
return - V_248 ;
}
V_241 = F_103 ( V_151 . V_217 , V_17 -> V_170 ) ;
...
V_243 -> V_257 . V_213 = F_90 ( V_114 -> V_163 ) ;
...
static void F_105 ( struct V_12 * V_17 , struct V_22 * V_28 ,
enum V_261 V_262 )
{
unsigned long V_199 ;
F_82 ( & V_17 -> V_150 , V_199 ) ;
F_88 ( & V_28 -> V_173 , & V_17 -> V_206 ) ;
if ( V_262 != V_263 )
++ V_17 -> V_201 ;
F_83 ( & V_17 -> V_150 , V_199 ) ;
}
static struct V_22 * F_106 ( struct V_12 * V_17 ,
enum V_261 V_262 )
{
...
V_28 = F_108 ( & V_17 -> V_206 , struct V_22 , V_173 ) ;
F_69 ( & V_28 -> V_173 ) ;
return V_28 ;
}
static int F_109 ( struct V_12 * V_17 ,
...
V_270 . V_130 = V_280 ;
V_270 . V_281 = V_282 ;
return F_110 ( V_17 -> V_39 , & V_270 , & V_271 ) ;
}
static int F_111 ( struct V_12 * V_17 , struct V_22 * V_28 )
{
...
V_270 . V_278 = & V_173 ;
V_270 . V_279 = 1 ;
return F_112 ( V_17 -> V_39 , & V_270 , & V_271 ) ;
}
static void F_113 ( struct V_12 * V_17 , struct V_284 * V_285 )
{
struct V_158 * V_114 ;
struct V_192 * V_193 ;
unsigned long V_199 ;
if ( F_100 ( V_285 -> V_132 & V_286 ) ) {
F_82 ( & V_17 -> V_150 , V_199 ) ;
V_17 -> V_201 += F_114 ( V_285 -> V_200 ) ;
F_83 ( & V_17 -> V_150 , V_199 ) ;
V_17 -> V_287 = - 1 ;
if ( F_114 ( V_285 -> V_288 ) >= 4 )
V_17 -> V_287 = V_285 -> V_289 [ 3 ] ;
F_36 ( & V_17 -> V_290 ) ;
} else {
V_114 = & V_17 -> V_159 [ V_285 -> V_132 ] ;
V_193 = F_81 ( V_17 , V_114 , NULL ) ;
if ( ! V_193 ) {
F_35 ( V_95 , V_17 -> V_96 ,
L_14 ,
...
F_114 ( V_285 -> V_288 ) ,
F_97 ( int , F_114 ( V_285 -> V_293 ) ,
V_294 ) ) ;
}
if ( V_285 -> V_199 & ( V_295 | V_296 ) )
F_115 ( V_193 , F_114 ( V_285 -> V_297 ) ) ;
else if ( V_285 -> V_199 & ( V_298 | V_299 ) )
F_115 ( V_193 , F_114 ( V_285 -> V_300 ) ) ;
...
static int F_116 ( struct V_12 * V_17 , T_5 V_302 ,
...
F_101 ( V_33 , V_28 -> V_31 , V_215 , V_165 ) ;
memcpy ( V_28 -> V_29 , V_285 , V_215 ) ;
F_104 ( V_33 , V_28 -> V_31 , V_215 , V_165 ) ;
V_71 = F_109 ( V_17 , V_28 , V_215 ) ;
if ( V_71 ) {
F_35 ( V_95 , V_17 -> V_96 , V_97
L_16 , V_71 ) ;
F_105 ( V_17 , V_28 , V_263 ) ;
}
return V_71 ;
}
...
T_5 V_306 = F_114 ( V_114 -> V_200 ) ;
if ( F_116 ( V_17 , V_306 , & V_285 , sizeof V_285 ) )
F_35 ( V_95 , V_17 -> V_96 , V_97
L_17 ) ;
}
...
static void F_119 ( struct V_12 * V_17 , struct V_311 * V_312 )
{
struct V_156 * V_33 = V_17 -> V_23 -> V_32 -> V_33 ;
struct V_22 * V_28 = (struct V_22 * ) ( V_277 ) V_312 -> V_276 ;
int V_7 ;
T_1 V_130 ;
F_101 ( V_33 , V_28 -> V_31 , V_17 -> V_313 ,
V_197 ) ;
V_130 = * ( T_1 * ) V_28 -> V_29 ;
if ( 0 ) {
F_35 ( V_95 , V_17 -> V_96 ,
V_97 L_20 , V_130 ) ;
F_120 ( V_95 , L_21 , V_314 , 8 , 1 ,
V_28 -> V_29 , V_312 -> V_315 , true ) ;
}
switch ( V_130 ) {
case V_316 :
F_113 ( V_17 , V_28 -> V_29 ) ;
break;
case V_317 :
...
F_104 ( V_33 , V_28 -> V_31 , V_17 -> V_313 ,
V_197 ) ;
V_7 = F_111 ( V_17 , V_28 ) ;
if ( V_7 != 0 )
F_35 ( V_95 , V_17 -> V_96 ,
...
static void F_123 ( enum V_320 V_321 , bool V_322 ,
struct V_12 * V_17 )
{
...
struct V_311 V_312 ;
F_29 ( V_323 , V_74 ) ;
while ( F_124 ( V_323 , 1 , & V_312 ) > 0 ) {
if ( F_125 ( V_312 . V_91 == V_324 ) ) {
F_119 ( V_17 , & V_312 ) ;
} else {
F_123 ( V_312 . V_91 , false , V_17 ) ;
}
}
}
...
F_123 ( V_312 . V_91 , true , V_17 ) ;
}
}
}
static int F_126 ( struct V_13 * V_174 , struct V_192 * V_193 )
{
...
unsigned long V_199 ;
int V_215 , V_202 ;
const bool V_325 = ! F_127 () && V_326 == V_174 -> V_327 ;
if ( V_325 )
F_128 ( & V_179 -> V_328 ) ;
V_202 = F_129 ( V_17 -> V_179 ) ;
if ( F_100 ( V_202 ) ) {
V_193 -> V_202 = V_202 ;
V_193 -> V_203 ( V_193 ) ;
goto V_329;
...
F_82 ( & V_17 -> V_150 , V_199 ) ;
V_28 = F_106 ( V_17 , V_330 ) ;
if ( ! V_28 )
goto V_331;
V_114 = F_108 ( & V_17 -> V_169 , struct V_158 , V_173 ) ;
F_69 ( & V_114 -> V_173 ) ;
F_83 ( & V_17 -> V_150 , V_199 ) ;
V_33 = V_17 -> V_23 -> V_32 -> V_33 ;
F_101 ( V_33 , V_28 -> V_31 , V_17 -> V_134 ,
V_165 ) ;
V_193 -> V_202 = 0 ;
...
V_239 -> V_130 = V_332 ;
V_239 -> V_310 = F_90 ( ( T_7 ) V_193 -> V_333 -> V_310 << 48 ) ;
V_239 -> V_132 = V_114 -> V_172 ;
memcpy ( V_239 -> V_334 , V_193 -> V_335 , V_193 -> V_336 ) ;
V_114 -> V_193 = V_193 ;
V_114 -> V_239 = V_28 ;
V_215 = F_98 ( V_193 , V_17 , V_114 ) ;
if ( V_215 < 0 ) {
F_35 ( V_95 , V_17 -> V_96 ,
V_97 L_28 ) ;
goto V_337;
}
F_104 ( V_33 , V_28 -> V_31 , V_17 -> V_134 ,
V_165 ) ;
if ( F_109 ( V_17 , V_28 , V_215 ) ) {
...
F_76 ( V_193 , V_17 , V_114 ) ;
V_337:
F_105 ( V_17 , V_28 , V_330 ) ;
F_82 ( & V_17 -> V_150 , V_199 ) ;
F_88 ( & V_114 -> V_173 , & V_17 -> V_169 ) ;
V_331:
F_83 ( & V_17 -> V_150 , V_199 ) ;
if ( V_325 )
F_130 ( & V_179 -> V_328 ) ;
...
static int F_131 ( struct V_12 * V_17 )
{
int V_88 ;
...
static T_8 F_132 ( struct V_40 * V_341 , int V_342 )
{
T_9 V_343 , V_344 ;
T_8 V_345 ;
...
F_133 ( V_344 , V_350 ) ;
V_345 = F_134 ( V_344 + 1000 ) ;
return V_345 ;
}
static void F_135 ( struct V_59 * V_62 ,
struct V_351 * V_352 ,
struct V_12 * V_17 )
{
...
V_17 -> V_313 = F_114 ( V_352 -> V_313 ) ;
V_17 -> V_201 = F_114 ( V_352 -> V_200 ) ;
V_17 -> V_96 -> V_354
= F_103 ( V_17 -> V_201 - V_266 ,
V_17 -> V_96 -> V_354 ) ;
V_17 -> V_96 -> V_355
= F_97 ( int , V_17 -> V_96 -> V_354 ,
V_17 -> V_96 -> V_355 ) ;
} else {
F_35 ( V_109 , V_17 -> V_96 ,
...
if ( V_42 )
goto V_357;
V_17 -> V_345 = F_132 ( V_341 , V_342 ) ;
V_42 = F_21 ( V_17 -> V_39 , V_341 , V_342 ) ;
if ( V_42 )
goto V_357;
V_42 = F_137 ( V_62 , NULL , 0 ) ;
V_357:
F_13 ( V_341 ) ;
error:
V_17 -> V_91 = V_42 ;
}
static void F_138 ( struct V_59 * V_62 ,
struct V_359 * V_36 ,
struct V_12 * V_17 )
{
...
V_62 -> V_369 = F_114 ( V_361 -> V_370 ) & 0x00ffffff ;
...
case V_385 :
V_383 = 1 ;
F_135 ( V_62 , V_36 -> V_119 , V_17 ) ;
break;
case V_386 :
F_35 ( V_147 , V_17 -> V_96 , V_97 L_41 ) ;
V_383 = 1 ;
F_138 ( V_62 , V_36 , V_17 ) ;
break;
case V_387 :
F_35 ( V_109 , V_17 -> V_96 ,
V_97 L_42 ) ;
F_51 ( V_17 , false ) ;
if ( F_139 ( V_62 , NULL , 0 ) )
F_35 ( V_95 , V_17 -> V_96 ,
V_97 L_43 ) ;
F_50 ( V_153 , & V_17 -> V_180 ) ;
break;
...
static int
F_140 ( struct V_392 * V_393 , int V_394 )
{
if ( V_393 -> V_395 ) {
F_141 ( V_393 , V_394 ) ;
if ( V_394 )
...
F_143 ( V_393 , V_393 -> V_396 ) ;
} else
V_394 = 0 ;
return V_394 ;
}
static int
F_144 ( struct V_392 * V_393 , int V_397 , int V_363 )
{
...
static int F_148 ( struct V_12 * V_17 ,
...
F_128 ( & V_179 -> V_328 ) ;
F_48 ( & V_17 -> V_150 ) ;
V_28 = F_106 ( V_17 , V_265 ) ;
F_49 ( & V_17 -> V_150 ) ;
if ( ! V_28 ) {
F_130 ( & V_179 -> V_328 ) ;
return - 1 ;
}
F_101 ( V_33 , V_28 -> V_31 , sizeof *V_406 ,
V_165 ) ;
V_406 = V_28 -> V_29 ;
memset ( V_406 , 0 , sizeof *V_406 ) ;
V_406 -> V_130 = V_407 ;
V_406 -> V_310 = F_90 ( ( T_7 ) V_310 << 48 ) ;
V_406 -> V_132 = V_403 | V_286 ;
V_406 -> V_408 = V_404 ;
V_406 -> V_409 = V_403 ;
F_104 ( V_33 , V_28 -> V_31 , sizeof *V_406 ,
V_165 ) ;
if ( F_109 ( V_17 , V_28 , sizeof *V_406 ) ) {
F_105 ( V_17 , V_28 , V_265 ) ;
F_130 ( & V_179 -> V_328 ) ;
return - 1 ;
}
F_130 ( & V_179 -> V_328 ) ;
...
if ( ! V_114 || ! F_81 ( V_17 , V_114 , V_193 ) )
return V_411 ;
if ( F_148 ( V_17 , V_114 -> V_172 , V_193 -> V_333 -> V_310 ,
V_412 ) == 0 )
V_42 = V_411 ;
...
if ( F_148 ( V_17 , V_417 , V_193 -> V_333 -> V_310 ,
V_418 ) )
return V_415 ;
if ( V_17 -> V_287 )
return V_415 ;
...
return F_153 ( V_17 -> V_179 ) == 0 ? V_411 : V_415 ;
}
static int F_154 ( struct V_392 * V_393 )
{
struct V_13 * V_174 = V_393 -> V_14 ;
struct V_12 * V_17 = F_5 ( V_174 ) ;
...
unsigned long V_348 ;
if ( V_393 -> type == V_421 ) {
V_348 = F_155 ( unsigned , 30 * V_422 , V_17 -> V_345 ) ;
F_156 ( V_420 , V_348 ) ;
}
return 0 ;
}
static T_10 F_157 ( struct V_333 * V_33 , struct V_175 * V_41 ,
char * V_29 )
{
struct V_12 * V_17 = F_5 ( F_158 ( V_33 ) ) ;
return sprintf ( V_29 , L_49 ,
( unsigned long long ) F_45 ( V_17 -> V_146 ) ) ;
}
static T_10 F_159 ( struct V_333 * V_33 , struct V_175 * V_41 ,
char * V_29 )
{
struct V_12 * V_17 = F_5 ( F_158 ( V_33 ) ) ;
return sprintf ( V_29 , L_49 ,
...
static T_10 F_160 ( struct V_333 * V_33 ,
...
static T_10 F_163 ( struct V_333 * V_33 , struct V_175 * V_41 ,
char * V_29 )
{
struct V_12 * V_17 = F_5 ( F_158 ( V_33 ) ) ;
...
static T_10 F_172 ( struct V_333 * V_33 ,
struct V_175 * V_41 , char * V_29 )
{
struct V_12 * V_17 = F_5 ( F_158 ( V_33 ) ) ;
return sprintf ( V_29 , L_53 , V_17 -> V_254 ? L_55 : L_56 ) ;
}
static int F_173 ( struct V_23 * V_14 , struct V_12 * V_17 )
{
struct V_425 V_426 ;
struct V_184 * V_179 ;
sprintf ( V_17 -> V_16 , L_57 ,
( unsigned long long ) F_45 ( V_17 -> V_146 ) ) ;
if ( F_174 ( V_17 -> V_96 , V_14 -> V_32 -> V_33 -> V_427 ) )
return - V_428 ;
memcpy ( V_426 . V_429 , & V_17 -> V_146 , 8 ) ;
memcpy ( V_426 . V_429 + 8 , & V_17 -> V_21 , 8 ) ;
V_426 . V_430 = V_431 ;
V_179 = F_175 ( V_17 -> V_96 , & V_426 ) ;
if ( F_24 ( V_179 ) ) {
F_64 ( V_17 -> V_96 ) ;
return F_25 ( V_179 ) ;
}
...
F_70 ( & V_14 -> V_181 ) ;
V_17 -> V_151 = V_433 ;
F_176 ( & V_17 -> V_96 -> V_434 ,
0 , V_17 -> V_435 , V_436 , 0 ) ;
return 0 ;
}
static void F_177 ( struct V_333 * V_33 )
{
struct V_23 * V_14 =
F_73 ( V_33 , struct V_23 , V_33 ) ;
F_36 ( & V_14 -> V_437 ) ;
}
static bool F_178 ( struct V_23 * V_14 ,
struct V_12 * V_17 )
{
struct V_12 * V_438 ;
bool V_42 = false ;
...
static int F_180 ( const char * V_29 , struct V_12 * V_17 )
{
char * V_439 , * V_440 ;
char * V_441 ;
char V_371 [ 3 ] ;
...
int V_42 = - V_247 ;
int V_88 ;
V_439 = F_181 ( V_29 , V_43 ) ;
if ( ! V_439 )
return - V_44 ;
V_440 = V_439 ;
while ( ( V_441 = F_182 ( & V_440 , L_58 ) ) != NULL ) {
if ( ! * V_441 )
continue;
V_444 = F_183 ( V_441 , V_445 , args ) ;
V_443 |= V_444 ;
switch ( V_444 ) {
case V_446 :
V_441 = F_184 ( args ) ;
...
V_17 -> V_146 = F_90 ( F_185 ( V_441 , NULL , 16 ) ) ;
F_13 ( V_441 ) ;
break;
case V_447 :
V_441 = F_184 ( args ) ;
...
V_17 -> V_21 = F_90 ( F_185 ( V_441 , NULL , 16 ) ) ;
F_13 ( V_441 ) ;
break;
case V_448 :
V_441 = F_184 ( args ) ;
...
F_187 ( V_371 , V_441 + V_88 * 2 , 3 ) ;
V_17 -> V_46 . V_371 . V_372 [ V_88 ] = F_188 ( V_371 , NULL , 16 ) ;
}
F_13 ( V_441 ) ;
...
V_17 -> V_117 = F_90 ( F_185 ( V_441 , NULL , 16 ) ) ;
...
V_17 -> V_144 = F_90 ( F_185 ( V_441 , NULL , 16 ) ) ;
F_13 ( V_441 ) ;
break;
case V_459 :
if ( F_190 ( args , & V_444 ) || V_444 < 1 || V_444 > 255 ) {
F_186 ( L_66 ,
V_441 ) ;
goto V_8;
}
...
break;
case V_465 :
if ( F_190 ( args , & V_444 ) || V_444 < 2 || V_444 > 7 ) {
F_186 ( L_70 ,
V_441 ) ;
goto V_8;
}
...
for ( V_88 = 0 ; V_88 < F_191 ( V_445 ) ; ++ V_88 )
...
static T_10 F_192 ( struct V_333 * V_33 ,
struct V_175 * V_41 ,
...
V_17 -> V_127 = 7 ;
V_17 -> V_69 = V_480 ;
V_42 = F_180 ( V_29 , V_17 ) ;
if ( V_42 )
goto V_71;
V_17 -> V_160 = V_17 -> V_69 - V_266 ;
if ( ! F_178 ( V_17 -> V_23 , V_17 ) ) {
F_35 ( V_207 , V_17 -> V_96 ,
V_97 L_74 ,
F_45 ( V_17 -> V_146 ) ,
F_45 ( V_17 -> V_21 ) ,
...
F_194 ( & V_17 -> V_180 , F_121 ) ;
F_194 ( & V_17 -> V_154 , F_72 ) ;
F_195 ( & V_17 -> V_150 ) ;
F_56 ( & V_17 -> V_206 ) ;
V_42 = F_55 ( V_17 ) ;
if ( V_42 )
goto V_482;
F_196 ( V_157 , V_14 -> V_45 , 0 , & V_17 -> V_46 . V_141 ) ;
...
static T_10 F_198 ( struct V_333 * V_33 , struct V_175 * V_41 ,
char * V_29 )
{
struct V_23 * V_14 = F_73 ( V_33 , struct V_23 , V_33 ) ;
return sprintf ( V_29 , L_52 , V_14 -> V_45 ) ;
}
static struct V_23 * F_199 ( struct V_167 * V_333 , T_1 V_45 )
{
struct V_23 * V_14 ;
...
F_200 ( & V_14 -> V_33 , L_79 , V_333 -> V_33 -> V_424 , V_45 ) ;
if ( F_201 ( & V_14 -> V_33 ) )
goto V_489;
if ( F_202 ( & V_14 -> V_33 , & V_490 ) )
goto V_491;
if ( F_202 ( & V_14 -> V_33 , & V_492 ) )
goto V_491;
if ( F_202 ( & V_14 -> V_33 , & V_493 ) )
goto V_491;
return V_14 ;
V_491:
F_203 ( & V_14 -> V_33 ) ;
...
static void F_204 ( struct V_156 * V_333 )
{
struct V_167 * V_32 ;
struct V_494 * V_495 ;
struct V_496 V_497 ;
...
if ( ! V_495 )
return;
if ( F_205 ( V_333 , V_495 ) ) {
F_186 ( L_80 , V_333 -> V_424 ) ;
goto V_502;
}
V_32 = F_9 ( sizeof *V_32 , V_43 ) ;
if ( ! V_32 )
goto V_502;
V_499 = F_206 ( 12 , F_207 ( V_495 -> V_503 ) - 1 ) ;
V_32 -> V_236 = 1 << V_499 ;
V_32 -> V_234 = ~ ( ( T_7 ) V_32 -> V_236 - 1 ) ;
V_32 -> V_235 = V_32 -> V_236 * V_171 ;
F_56 ( & V_32 -> V_504 ) ;
V_32 -> V_33 = V_333 ;
V_32 -> V_85 = F_208 ( V_333 ) ;
if ( F_24 ( V_32 -> V_85 ) )
goto V_505;
V_32 -> V_477 = F_209 ( V_32 -> V_85 ,
V_506 |
V_52 |
V_53 ) ;
if ( F_24 ( V_32 -> V_477 ) )
...
V_53 |
V_52 ) ;
V_32 -> V_223 = F_210 ( V_32 -> V_85 , & V_497 ) ;
if ( ! F_24 ( V_32 -> V_223 ) )
break;
}
if ( F_24 ( V_32 -> V_223 ) )
...
V_14 = F_199 ( V_32 , V_441 ) ;
if ( V_14 )
F_57 ( & V_14 -> V_173 , & V_32 -> V_504 ) ;
}
F_211 ( V_333 , & V_519 , V_32 ) ;
goto V_502;
V_507:
F_212 ( V_32 -> V_85 ) ;
V_505:
...
static void F_213 ( struct V_156 * V_333 )
{
struct V_167 * V_32 ;
struct V_23 * V_14 , * V_520 ;
struct V_12 * V_17 ;
V_32 = F_214 ( V_333 , & V_519 ) ;
if ( ! V_32 )
return;
F_215 (host, tmp_host, &srp_dev->dev_list, list) {
F_203 ( & V_14 -> V_33 ) ;
F_40 ( & V_14 -> V_437 ) ;
F_68 ( & V_14 -> V_181 ) ;
F_179 (target, &host->target_list, list)
F_47 ( V_17 ) ;
F_70 ( & V_14 -> V_181 ) ;
F_216 ( V_153 ) ;
F_13 ( V_14 ) ;
...
static int T_12 F_219 ( void )
{
int V_42 ;
F_220 ( F_221 ( struct V_311 , V_276 ) < sizeof( void * ) ) ;
if ( V_521 ) {
F_186 ( L_81 ) ;
if ( ! V_478 )
V_478 = V_521 ;
