...
if ( V_57 -> V_51 >= V_53 )
return;
if ( V_57 -> V_51 + V_57 -> V_10 < V_58 )
return;
V_22 . V_24 = V_57 -> V_51 ;
V_22 . V_10 = V_57 -> V_10 ;
if ( V_22 . V_24 < V_58 )
V_22 . V_24 = V_58 ;
V_22 . V_24 = F_19 ( V_22 . V_24 , V_54 ) ;
if ( V_22 . V_24 > V_57 -> V_51 + V_57 -> V_10 )
return;
V_22 . V_10 -= V_22 . V_24 - V_57 -> V_51 ;
if ( V_22 . V_24 + V_22 . V_10 > V_53 )
V_22 . V_10 = V_53 - V_22 . V_24 ;
for ( V_49 . V_24 = V_22 . V_24 , V_49 . V_10 = V_59 ;
F_12 ( & V_22 , & V_49 ) ;
V_49 . V_24 += V_54 ) {
if ( F_15 ( & V_49 ) )
continue;
...
static unsigned long F_20 ( unsigned long V_58 ,
unsigned long V_10 )
{
int V_11 ;
unsigned long V_51 ;
V_58 = F_19 ( V_58 , V_54 ) ;
for ( V_11 = 0 ; V_11 < V_14 -> V_61 ; V_11 ++ ) {
F_18 ( & V_14 -> V_62 [ V_11 ] , V_58 , V_10 ) ;
}
return F_17 () ;
}
unsigned char * F_21 ( unsigned char * V_27 ,
unsigned long V_28 ,
unsigned char * V_29 ,
unsigned long V_30 )
{
unsigned long V_63 = ( unsigned long ) V_29 ;
unsigned long V_17 ;
if ( F_22 ( L_6 ) ) {
F_8 ( L_7 ) ;
goto V_64;
