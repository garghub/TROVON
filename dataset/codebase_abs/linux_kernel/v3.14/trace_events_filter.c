...
static struct V_58 * F_51 ( void )
{
struct V_58 * V_59 ;
V_59 = F_52 ( sizeof( * V_59 ) , V_67 ) ;
return V_59 ;
}
static int F_53 ( struct V_58 * V_59 , int V_60 )
{
struct V_1 * V_2 ;
int V_22 ;
if ( V_59 -> V_28 )
...
static inline void F_54 ( struct V_76 * V_77 )
{
struct V_95 * V_96 = V_77 -> V_78 ;
F_45 ( V_77 ) ;
if ( V_96 -> V_79 & V_80 )
...
static void F_55 ( struct V_83 * system ,
struct V_99 * V_100 )
{
struct V_76 * V_77 ;
struct V_95 * V_96 ;
...
static inline void F_57 ( struct V_76 * V_77 )
{
struct V_95 * V_96 = V_77 -> V_78 ;
if ( V_96 -> V_79 & V_80 ) {
F_46 ( V_96 -> V_59 ) ;
...
static void F_58 ( struct V_83 * system ,
struct V_99 * V_100 )
{
struct V_76 * V_77 ;
struct V_95 * V_96 ;
...
static bool F_62 ( struct V_107 * V_108 )
{
return V_108 -> V_109 == V_104 ||
V_108 -> V_109 == V_105 ||
V_108 -> V_109 == V_111 ;
}
static int F_63 ( struct V_107 * V_108 , int V_26 )
{
if ( F_62 ( V_108 ) &&
( V_26 != V_112 && V_26 != V_113 && V_26 != V_27 ) )
return 0 ;
if ( ! F_62 ( V_108 ) && V_26 == V_27 )
return 0 ;
return 1 ;
}
static T_3 F_64 ( int V_26 , int V_114 ,
int V_115 )
{
T_3 V_54 = NULL ;
switch ( V_114 ) {
...
V_43 = F_67 ( V_2 -> V_8 . V_17 , 0 , & V_52 ) ;
if ( V_43 ) {
F_20 ( V_62 , V_132 , 0 ) ;
return - V_41 ;
}
V_2 -> V_52 = V_52 ;
V_54 = F_64 ( V_2 -> V_26 , V_108 -> V_129 ,
V_108 -> V_131 ) ;
if ( ! V_54 ) {
F_20 ( V_62 , V_133 , 0 ) ;
return - V_41 ;
...
static char F_71 ( struct V_61 * V_62 )
{
...
static inline int F_73 ( struct V_61 * V_62 ,
int V_141 , int V_142 )
{
return V_62 -> V_53 [ V_141 ] . V_143 < V_62 -> V_53 [ V_142 ] . V_143 ;
}
static inline int F_74 ( struct V_61 * V_62 , char V_144 )
{
int V_22 ;
...
static int F_75 ( struct V_61 * V_62 , char V_145 )
{
char V_146 = F_71 ( V_62 ) ;
char V_147 [ 3 ] ;
int V_22 ;
V_147 [ 0 ] = V_145 ;
V_147 [ 1 ] = V_146 ;
...
static inline void F_76 ( struct V_61 * V_62 )
{
memset ( V_62 -> V_150 . string , '\0' , V_151 ) ;
V_62 -> V_150 . V_140 = 0 ;
}
static inline int F_77 ( struct V_61 * V_62 , char V_144 )
{
...
static int F_78 ( struct V_61 * V_62 , int V_26 )
{
struct V_152 * V_152 ;
...
return - V_68 ;
V_152 -> V_26 = V_26 ;
F_79 ( & V_152 -> V_153 , & V_62 -> V_138 ) ;
return 0 ;
}
static int F_80 ( struct V_61 * V_62 )
{
return F_81 ( & V_62 -> V_138 ) ;
}
static int F_82 ( struct V_61 * V_62 )
{
struct V_152 * V_152 ;
if ( F_80 ( V_62 ) )
return V_149 ;
V_152 = F_83 ( & V_62 -> V_138 , struct V_152 , V_153 ) ;
return V_152 -> V_26 ;
}
...
static void F_86 ( struct V_61 * V_62 )
{
while ( ! F_80 ( V_62 ) )
F_84 ( V_62 ) ;
}
static char * F_87 ( struct V_61 * V_62 )
{
return V_62 -> V_150 . string ;
}
static int F_88 ( struct V_61 * V_62 , char * V_150 )
{
struct V_154 * V_155 ;
...
F_89 ( & V_155 -> V_153 , & V_62 -> V_139 ) ;
return 0 ;
}
static int F_90 ( struct V_61 * V_62 , int V_26 )
{
struct V_154 * V_155 ;
V_155 = F_27 ( sizeof( * V_155 ) , V_67 ) ;
if ( ! V_155 )
...
{
struct V_154 * V_155 ;
while ( ! F_81 ( & V_62 -> V_139 ) ) {
V_155 = F_83 ( & V_62 -> V_139 , struct V_154 , V_153 ) ;
F_85 ( & V_155 -> V_153 ) ;
F_22 ( V_155 -> V_150 ) ;
F_22 ( V_155 ) ;
}
...
static struct V_1 * F_93 ( struct V_61 * V_62 ,
struct V_95 * V_96 ,
...
V_2 . V_108 = V_108 ;
return F_65 ( V_62 , V_108 , & V_2 ) ? NULL : & V_2 ;
}
...
static int F_100 ( struct V_1 * V_28 , struct V_1 * V_36 )
{
int V_171 = 0 , V_43 ;
V_43 = F_13 ( V_28 , V_36 , F_99 , & V_171 ) ;
F_19 ( V_43 ) ;
return V_171 ;
}
static int F_101 ( enum V_30 V_31 , struct V_1 * V_2 ,
int * V_42 , void * V_38 )
{
...
static int F_102 ( struct V_1 * V_28 , struct V_1 * V_36 )
{
struct V_173 V_38 = {
. V_36 = V_36 ,
. V_171 = 0 ,
...
if ( V_36 -> V_47 == V_48 )
return 0 ;
V_174 = F_100 ( V_28 , & V_28 [ V_36 -> V_47 ] ) ;
V_174 += F_100 ( V_28 , & V_28 [ V_36 -> V_49 ] ) ;
V_36 -> V_53 = F_38 ( V_174 , sizeof( * V_36 -> V_53 ) , V_67 ) ;
if ( ! V_36 -> V_53 )
return - V_68 ;
V_36 -> V_52 = V_174 ;
V_38 . V_174 = V_174 ;
return F_13 ( V_28 , V_36 , F_101 , & V_38 ) ;
}
static int F_103 ( enum V_30 V_31 , struct V_1 * V_2 ,
int * V_42 , void * V_38 )
{
...
static int F_104 ( struct V_58 * V_59 ,
struct V_1 * V_36 )
{
return F_13 ( V_59 -> V_28 , V_36 , F_103 ,
V_59 -> V_28 ) ;
}
static int F_105 ( struct V_95 * V_96 ,
struct V_58 * V_59 ,
struct V_61 * V_62 ,
char * V_66 ,
bool V_175 )
...
V_2 = F_93 ( V_62 , V_96 , V_155 -> V_26 , V_163 , V_164 ) ;
if ( ! V_2 ) {
V_42 = - V_41 ;
goto V_177;
}
if ( ! V_175 ) {
V_42 = F_59 ( V_62 , V_59 , V_2 , & V_87 ) ;
if ( V_42 )
goto V_177;
}
V_163 = V_164 = NULL ;
...
static inline void F_108 ( struct V_76 * V_77 ,
struct V_58 * V_59 )
{
struct V_95 * V_96 = V_77 -> V_78 ;
if ( V_96 -> V_79 & V_80 )
F_109 ( V_96 -> V_59 , V_59 ) ;
else
F_109 ( V_77 -> V_59 , V_59 ) ;
}
static inline void F_110 ( struct V_76 * V_77 )
{
struct V_95 * V_96 = V_77 -> V_78 ;
if ( V_96 -> V_79 & V_80 )
F_111 ( V_96 -> V_59 , NULL ) ;
else
F_111 ( V_77 -> V_59 , NULL ) ;
}
static inline void
...
static int F_115 ( struct V_83 * system ,
struct V_99 * V_100 ,
struct V_61 * V_62 ,
char * V_66 )
{
...
if ( strcmp ( V_96 -> V_101 -> system , system -> V_102 ) != 0 )
continue;
V_42 = F_105 ( V_96 , NULL , V_62 , V_66 , true ) ;
if ( V_42 )
F_112 ( V_77 ) ;
else
F_113 ( V_77 ) ;
...
if ( F_114 ( V_77 ) )
continue;
V_182 = F_52 ( sizeof( * V_182 ) , V_67 ) ;
if ( ! V_182 )
goto V_184;
F_89 ( & V_182 -> V_153 , & V_181 ) ;
V_182 -> V_59 = F_51 () ;
if ( ! V_182 -> V_59 )
goto V_184;
V_59 = V_182 -> V_59 ;
...
if ( V_42 )
goto V_184;
V_42 = F_105 ( V_96 , V_59 , V_62 , V_66 , false ) ;
if ( V_42 ) {
F_45 ( V_77 ) ;
F_20 ( V_62 , V_185 , 0 ) ;
F_28 ( V_62 , V_59 ) ;
...
goto V_177;
F_117 () ;
F_118 (filter_item, tmp, &filter_list, list) {
F_46 ( V_182 -> V_59 ) ;
F_85 ( & V_182 -> V_153 ) ;
F_22 ( V_182 ) ;
}
...
static int F_119 ( char * V_186 , bool V_187 ,
struct V_61 * * V_188 ,
struct V_58 * * V_189 )
{
struct V_58 * V_59 ;
...
* V_189 = V_59 ;
* V_188 = V_62 ;
F_68 ( V_62 , V_190 , V_186 ) ;
V_42 = F_92 ( V_62 ) ;
if ( V_42 && V_187 )
F_28 ( V_62 , V_59 ) ;
return V_42 ;
}
static void F_120 ( struct V_61 * V_62 )
{
if ( V_62 ) {
F_86 ( V_62 ) ;
F_91 ( V_62 ) ;
...
static int F_121 ( struct V_95 * V_96 ,
...
struct V_61 * V_62 = NULL ;
int V_42 ;
V_42 = F_119 ( V_186 , V_187 , & V_62 , & V_59 ) ;
if ( ! V_42 ) {
V_42 = F_105 ( V_96 , V_59 , V_62 , V_186 , false ) ;
if ( V_42 && V_187 )
F_28 ( V_62 , V_59 ) ;
}
F_120 ( V_62 ) ;
...
int F_122 ( struct V_95 * V_96 ,
char * V_186 , bool V_187 ,
struct V_58 * * V_189 )
{
return F_121 ( V_96 , V_186 , V_187 , V_189 ) ;
}
static int F_123 ( struct V_83 * system ,
struct V_99 * V_100 ,
...
struct V_61 * V_62 = NULL ;
int V_42 ;
V_42 = F_119 ( V_186 , true , & V_62 , & V_59 ) ;
if ( ! V_42 ) {
V_42 = F_115 ( system , V_100 , V_62 , V_186 ) ;
if ( ! V_42 ) {
F_22 ( V_59 -> V_66 ) ;
V_59 -> V_66 = NULL ;
} else {
...
int F_124 ( struct V_76 * V_77 , char * V_66 )
{
struct V_95 * V_96 = V_77 -> V_78 ;
struct V_58 * V_59 ;
int V_42 ;
if ( ! strcmp ( F_125 ( V_66 ) , L_9 ) ) {
F_45 ( V_77 ) ;
V_59 = V_58 ( V_77 ) ;
if ( ! V_59 )
return 0 ;
...
V_42 = F_121 ( V_96 , V_66 , true , & V_59 ) ;
if ( V_59 ) {
struct V_58 * V_183 ;
V_183 = V_58 ( V_77 ) ;
if ( ! V_42 )
...
V_42 = F_123 ( system , V_100 , V_66 , & V_59 ) ;
if ( V_59 ) {
F_46 ( system -> V_59 ) ;
system -> V_59 = V_59 ;
}
...
static char * *
F_128 ( char * V_71 , int V_11 , int * V_171 )
{
char * V_15 , * V_198 , * * V_199 ;
V_15 = F_129 ( V_71 , V_11 , V_67 ) ;
if ( ! V_15 )
return NULL ;
while ( ( V_198 = strchr ( V_15 , ',' ) ) )
* V_198 = ' ' ;
V_199 = F_130 ( V_67 , V_15 , V_171 ) ;
F_22 ( V_15 ) ;
return V_199 ;
}
static int F_131 ( struct V_200 * V_53 , int V_59 ,
int V_201 , char * V_199 , int V_11 )
{
int V_43 ;
if ( V_59 )
V_43 = F_132 ( V_53 , V_199 , V_11 , V_201 ) ;
else
V_43 = F_133 ( V_53 , V_199 , V_11 , V_201 ) ;
return V_43 ;
}
static int F_134 ( int V_59 , char * V_71 , int V_11 ,
struct V_202 * V_38 )
{
...
V_199 = F_128 ( V_71 , V_11 , & V_203 ) ;
if ( ! V_199 )
return - V_41 ;
for ( V_22 = 0 ; V_22 < V_203 ; V_22 ++ ) {
V_43 = F_131 ( V_38 -> V_53 , V_59 , * V_201 ,
...
static int F_136 ( struct V_1 * V_2 , int V_206 )
{
...
static int F_137 ( enum V_30 V_31 ,
struct V_1 * V_2 ,
int * V_42 , void * V_38 )
{
if ( ( V_31 != V_39 ) ||
...
static int F_138 ( struct V_197 * V_3 ,
struct V_58 * V_59 )
{
struct V_202 V_38 = {
. V_204 = 1 ,
...
int F_139 ( struct V_197 * V_3 , int V_207 ,
char * V_186 )
{
int V_42 ;
struct V_58 * V_59 ;
...
if ( V_3 -> V_59 )
goto V_196;
V_42 = F_121 ( V_96 , V_186 , false , & V_59 ) ;
if ( V_42 )
goto V_210;
if ( F_140 ( V_96 ) )
V_42 = F_138 ( V_3 , V_59 ) ;
...
struct V_107 * V_108 = V_2 -> V_108 ;
V_211 = 1 ;
F_142 ( V_212 L_10 , V_108 -> V_102 ) ;
return 1 ;
}
static int F_143 ( enum V_30 V_31 , struct V_1 * V_2 ,
int * V_42 , void * V_38 )
{
char * V_213 = V_38 ;
if ( ( V_31 == V_39 ) &&
