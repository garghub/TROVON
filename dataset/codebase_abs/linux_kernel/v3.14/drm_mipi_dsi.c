...
static int F_23 ( struct V_1 * V_2 , void * V_23 )
{
struct V_5 * V_6 = F_4 ( V_2 ) ;
F_24 ( & V_6 -> V_2 ) ;
return 0 ;
...
int F_29 ( struct V_5 * V_6 , unsigned int V_16 ,
...
T_3 F_30 ( struct V_5 * V_6 , unsigned int V_16 ,
...
int F_34 ( struct V_43 * V_4 )
{
V_4 -> V_44 . V_12 = & V_13 ;
if ( V_4 -> V_45 )
V_4 -> V_44 . V_45 = F_31 ;
if ( V_4 -> remove )
V_4 -> V_44 . remove = F_33 ;
return F_35 ( & V_4 -> V_44 ) ;
}
void F_36 ( struct V_43 * V_4 )
{
F_37 ( & V_4 -> V_44 ) ;
}
