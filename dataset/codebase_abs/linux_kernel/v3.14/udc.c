...
if ( V_57 ) {
V_62 -> V_65 -> V_79 [ 0 ] = F_32 ( V_59 ) ;
for ( V_58 = 1 ; V_58 < V_80 ; V_58 ++ ) {
T_1 V_79 = V_59 + V_58 * V_81 ;
V_79 &= ~ V_82 ;
V_62 -> V_65 -> V_79 [ V_58 ] = F_32 ( V_79 ) ;
}
}
V_56 -> V_74 . V_78 += V_57 ;
if ( ! F_33 ( & V_56 -> V_83 ) ) {
V_61 = F_34 ( V_56 -> V_83 . V_84 ,
struct V_60 , V_85 ) ;
V_61 -> V_65 -> V_86 = F_32 ( V_62 -> V_8 ) ;
}
F_35 ( & V_62 -> V_85 ) ;
F_36 ( & V_62 -> V_85 , & V_56 -> V_83 ) ;
return 0 ;
}
static inline T_2 F_37 ( struct V_53 * V_75 )
{
...
return - V_93 ;
V_56 -> V_74 . V_92 = - V_93 ;
V_88 = F_39 ( & V_4 -> V_94 , & V_56 -> V_74 , V_54 -> V_2 ) ;
if ( V_88 )
return V_88 ;
...
F_28 ( V_54 , V_56 , 0 ) ;
while ( V_89 > 0 ) {
unsigned V_96 = F_40 ( V_56 -> V_74 . V_57 - V_56 -> V_74 . V_78 ,
( unsigned ) ( V_90 * V_81 ) ) ;
F_28 ( V_54 , V_56 , V_96 ) ;
V_89 -= V_96 ;
}
...
F_28 ( V_54 , V_56 , 0 ) ;
V_91 = F_41 ( & V_56 -> V_83 , struct V_60 , V_85 ) ;
V_61 = F_34 ( V_56 -> V_83 . V_84 ,
struct V_60 , V_85 ) ;
V_61 -> V_65 -> V_86 = F_32 ( V_98 ) ;
if ( ! V_56 -> V_74 . V_99 )
V_61 -> V_65 -> V_68 |= F_32 ( V_100 ) ;
F_42 () ;
V_56 -> V_74 . V_78 = 0 ;
...
V_103 = F_34 ( V_54 -> V_101 . V_102 . V_84 ,
struct V_55 , V_102 ) ;
V_105 = F_34 ( V_103 -> V_83 . V_84 ,
struct V_60 , V_85 ) ;
V_105 -> V_65 -> V_86 = F_32 ( V_86 ) ;
F_42 () ;
...
V_54 -> V_101 . V_65 -> V_85 . V_86 = F_32 ( V_91 -> V_8 ) ;
V_54 -> V_101 . V_65 -> V_85 . V_68 &=
F_32 ( ~ ( V_109 | V_70 ) ) ;
if ( V_54 -> type == V_71 && V_54 -> V_2 == V_33 ) {
T_1 V_73 = V_56 -> V_74 . V_57 / V_54 -> V_75 . V_76 ;
if ( V_56 -> V_74 . V_57 == 0
|| V_56 -> V_74 . V_57 % V_54 -> V_75 . V_76 )
V_73 ++ ;
...
F_42 () ;
V_88 = F_15 ( V_4 , V_54 -> V_1 , V_54 -> V_2 ,
V_54 -> type == V_112 ) ;
V_107:
return V_88 ;
}
...
F_44 ( V_54 -> V_66 , V_113 -> V_65 , V_113 -> V_8 ) ;
V_54 -> V_114 = NULL ;
F_31 ( V_113 ) ;
}
...
F_49 ( & V_54 -> V_4 -> V_94 , & V_56 -> V_74 , V_54 -> V_2 ) ;
V_56 -> V_74 . V_78 += V_78 ;
if ( V_56 -> V_74 . V_92 )
...
struct V_55 * V_56 = F_34 ( V_54 -> V_101 . V_102 . V_86 ,
struct V_55 , V_102 ) ;
F_46 (node, tmpnode, &hwreq->tds, td) {
...
F_52 ( & V_4 -> V_125 ) ;
if ( V_137 )
F_63 ( V_4 -> V_140 , L_1 , V_137 ) ;
}
static void F_64 ( struct V_129 * V_75 , struct V_141 * V_74 )
{
...
static int F_65 ( struct V_129 * V_75 , struct V_141 * V_74 ,
T_3 T_4 V_143 )
{
...
F_50 ( V_54 ) ;
V_137 = - V_146 ;
F_66 ( V_54 -> V_4 -> V_140 , L_2 ,
F_37 ( V_54 ) ) ;
}
}
if ( F_67 ( V_54 -> V_75 . V_144 ) &&
V_56 -> V_74 . V_57 > ( 1 + V_54 -> V_75 . V_147 ) * V_54 -> V_75 . V_76 ) {
F_63 ( V_54 -> V_4 -> V_140 , L_3 ) ;
return - V_148 ;
}
if ( ! F_33 ( & V_56 -> V_102 ) ) {
F_63 ( V_54 -> V_4 -> V_140 , L_4 ) ;
return - V_118 ;
}
V_56 -> V_74 . V_92 = - V_149 ;
V_56 -> V_74 . V_78 = 0 ;
V_137 = F_38 ( V_54 , V_56 ) ;
if ( V_137 == - V_93 )
V_137 = 0 ;
if ( ! V_137 )
...
return - V_37 ;
F_51 ( V_54 -> V_125 ) ;
V_74 = F_62 ( & V_54 -> V_75 , V_143 ) ;
F_52 ( V_54 -> V_125 ) ;
if ( V_74 == NULL )
return - V_64 ;
V_74 -> V_127 = F_64 ;
V_74 -> V_57 = 2 ;
V_74 -> V_142 = F_29 ( V_74 -> V_57 , V_143 ) ;
if ( V_74 -> V_142 == NULL ) {
V_137 = - V_64 ;
goto V_152;
}
...
== V_157 ) {
V_2 = ( F_69 ( V_151 -> V_158 ) & V_87 ) ?
V_72 : V_33 ;
V_1 = F_69 ( V_151 -> V_158 ) & V_159 ;
* ( V_156 * ) V_74 -> V_142 = F_12 ( V_4 , V_1 , V_2 ) ;
}
V_137 = F_65 ( & V_54 -> V_75 , V_74 , V_143 ) ;
if ( V_137 )
goto V_160;
return 0 ;
V_160:
...
static void
F_70 ( struct V_129 * V_75 , struct V_141 * V_74 )
{
...
type = V_74 . V_153 ;
V_4 -> V_145 = ( type & V_169 ) ? V_72 : V_33 ;
switch ( V_74 . V_170 ) {
case V_171 :
if ( type == ( V_172 | V_157 ) &&
F_69 ( V_74 . V_173 ) ==
...
if ( type != ( V_172 | V_155 ) )
goto V_178;
if ( F_69 ( V_74 . V_175 ) != 0 ||
F_69 ( V_74 . V_158 ) != 0 )
break;
V_4 -> V_163 = ( T_2 ) F_69 ( V_74 . V_173 ) ;
V_4 -> V_162 = true ;
V_168 = F_72 ( V_4 ) ;
break;
case V_182 :
...
if ( V_74 . V_175 != 0 )
break;
switch ( F_69 ( V_74 . V_173 ) ) {
case V_177 :
V_4 -> V_133 = 1 ;
V_168 = F_72 ( V_4 ) ;
break;
case V_183 :
V_167 = F_69 ( V_74 . V_158 ) >> 8 ;
switch ( V_167 ) {
case V_184 :
case V_185 :
case V_186 :
...
V_4 -> V_145 = V_72 ;
F_51 ( & V_4 -> V_125 ) ;
V_168 = V_4 -> V_138 -> V_151 ( & V_4 -> V_94 , & V_74 ) ;
F_52 ( & V_4 -> V_125 ) ;
break;
}
if ( V_168 < 0 ) {
...
if ( ! F_33 ( & V_54 -> V_101 . V_102 ) )
F_66 ( V_54 -> V_4 -> V_140 , L_7 ) ;
V_54 -> V_2 = F_78 ( V_144 ) ? V_72 : V_33 ;
V_54 -> V_1 = F_79 ( V_144 ) ;
...
if ( V_54 -> type == V_71 && V_54 -> V_2 == V_72 )
V_110 |= 3 << F_11 ( V_111 ) ;
V_54 -> V_101 . V_65 -> V_110 = F_32 ( V_110 ) ;
V_54 -> V_101 . V_65 -> V_85 . V_86 |= F_32 ( V_98 ) ;
if ( V_54 -> V_1 )
...
if ( V_54 -> type == V_112 )
V_54 -> V_2 = ( V_54 -> V_2 == V_72 ) ? V_33 : V_72 ;
...
if ( V_75 == NULL )
return NULL ;
V_56 = F_29 ( sizeof( struct V_55 ) , V_143 ) ;
if ( V_56 != NULL ) {
F_35 ( & V_56 -> V_102 ) ;
F_35 ( & V_56 -> V_83 ) ;
}
...
V_54 -> V_75 . V_144 == NULL || F_33 ( & V_56 -> V_102 ) ||
F_33 ( & V_54 -> V_101 . V_102 ) )
return - V_37 ;
F_55 ( V_54 -> V_125 , V_130 ) ;
F_5 ( V_54 -> V_4 , V_54 -> V_1 , V_54 -> V_2 ) ;
F_48 ( & V_56 -> V_102 ) ;
F_49 ( & V_54 -> V_4 -> V_94 , V_74 , V_54 -> V_2 ) ;
V_74 -> V_92 = - V_194 ;
if ( V_56 -> V_74 . V_127 != NULL ) {
F_51 ( V_54 -> V_125 ) ;
V_56 -> V_74 . V_127 ( & V_54 -> V_75 , & V_56 -> V_74 ) ;
...
V_193 = V_54 -> V_2 ;
do {
V_137 |= F_16 ( V_54 -> V_4 , V_54 -> V_1 , V_54 -> V_2 , V_36 ) ;
if ( ! V_36 )
V_54 -> V_176 = 0 ;
if ( V_54 -> type == V_112 )
V_54 -> V_2 = ( V_54 -> V_2 == V_72 ) ? V_33 : V_72 ;
...
unsigned long V_130 ;
if ( V_75 == NULL ) {
F_63 ( V_54 -> V_4 -> V_140 , L_9 , F_37 ( V_54 ) ) ;
return;
}
F_55 ( V_54 -> V_125 , V_130 ) ;
F_5 ( V_54 -> V_4 , V_54 -> V_1 , V_54 -> V_2 ) ;
...
{
struct V_3 * V_4 = F_54 ( V_197 , struct V_3 , V_94 ) ;
unsigned long V_130 ;
int V_199 = 0 ;
F_55 ( & V_4 -> V_125 , V_130 ) ;
V_4 -> V_200 = V_198 ;
...
for ( V_212 = V_33 ; V_212 <= V_72 ; V_212 ++ ) {
...
V_54 -> V_101 . V_65 = F_30 ( V_4 -> V_217 , V_218 ,
& V_54 -> V_101 . V_8 ) ;
...
F_36 ( & V_54 -> V_75 . V_220 , & V_4 -> V_94 . V_220 ) ;
}
return V_137 ;
}
...
if ( V_54 -> V_114 )
F_43 ( V_54 ) ;
F_44 ( V_4 -> V_217 , V_54 -> V_101 . V_65 , V_54 -> V_101 . V_8 ) ;
}
}
...
{
struct V_248 * V_249 ;
if ( ! F_7 ( V_4 , V_250 , V_251 ) )
return - V_252 ;
V_249 = F_127 ( V_4 -> V_140 , sizeof( struct V_248 ) , V_218 ) ;
if ( ! V_249 )
return - V_64 ;
V_249 -> V_253 = F_121 ;
V_249 -> V_254 = F_124 ;
