...
V_27 = V_34 | V_35 | V_43 | V_37 | V_44 | V_38 |
V_45 | V_46 ;
V_28 = V_39 ;
break;
case 9 :
...
F_14 ( 0x80000005 , & V_30 , & V_31 , & V_32 , & V_33 ) ;
V_2 -> V_48 = ( V_32 >> 24 ) + ( V_33 >> 24 ) ;
}
sprintf ( V_2 -> V_49 , L_12 , V_26 ) ;
break;
#endif
case 6 :
F_1 ( V_2 ) ;
...
static unsigned int
F_15 ( struct V_1 * V_2 , unsigned int V_51 )
{
