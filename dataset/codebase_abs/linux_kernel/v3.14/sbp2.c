...
V_101 = F_73 ( V_88 , 0 , 0 , F_64 ( V_2 -> V_92 ) , V_2 ) ;
if ( F_74 ( V_101 ) )
goto V_115;
F_68 () ;
...
static void F_77 ( struct V_99 * V_5 )
{
struct V_1 * V_2 = F_8 ( F_78 ( V_5 ) ,
struct V_1 , V_5 ) ;
V_2 -> V_110 ( V_5 ) ;
}
static int F_79 ( struct V_7 * V_8 , int V_117 )
{
struct V_1 * V_2 ;
V_2 = F_57 ( sizeof( * V_2 ) , V_118 ) ;
if ( ! V_2 )
return - V_61 ;
V_2 -> V_70 . V_24 = 0x100 ;
V_2 -> V_70 . V_119 = F_10 ;
...
int V_128 , V_129 ;
F_84 ( & V_127 , V_125 ) ;
while ( F_85 ( & V_127 , & V_128 , & V_129 ) )
if ( V_128 == V_130 &&
F_79 ( V_8 , V_129 ) < 0 )
return - V_61 ;
return 0 ;
}
static int F_86 ( struct V_7 * V_8 , const T_5 * V_125 ,
T_5 * V_131 , T_5 * V_132 )
{
struct V_126 V_127 ;
int V_128 , V_129 ;
...
break;
case V_140 :
F_82 ( V_8 , V_127 . V_141 - 1 + V_129 ) ;
break;
case V_142 :
if ( F_83 ( V_8 , V_127 . V_141 - 1 + V_129 ) < 0 )
return - V_61 ;
break;
}
}
...
F_14 ( F_5 ( V_8 ) , L_10 ,
V_60 / 1000 ) ;
V_8 -> V_73 = F_88 ( V_60 , 5000 , 40000 ) ;
}
static void F_89 ( struct V_7 * V_8 , T_5 V_131 ,
T_5 V_132 )
{
int V_143 ;
...
if ( V_144 & V_146 )
goto V_79;
for ( V_143 = 0 ; V_143 < F_90 ( V_147 ) ; V_143 ++ ) {
...
static int F_91 ( struct V_149 * V_9 , const struct V_150 * V_151 )
{
...
if ( V_10 -> V_152 )
return - V_153 ;
if ( F_92 ( V_10 -> V_15 -> V_10 ) > V_154 )
F_93 ( F_94 ( V_10 -> V_15 -> V_10 ,
V_154 ) ) ;
V_88 = F_95 ( & V_155 , sizeof( * V_8 ) ) ;
if ( V_88 == NULL )
return - V_61 ;
...
V_132 = V_161 ;
V_131 = V_161 ;
if ( F_86 ( V_8 , V_9 -> V_125 , & V_131 ,
& V_132 ) < 0 )
goto V_162;
F_87 ( V_8 ) ;
F_89 ( V_8 , V_131 , V_132 ) ;
V_8 -> V_163 = F_99 ( V_10 -> V_46 + 7 , 10U ,
V_10 -> V_15 -> V_164 - 1 ) ;
...
static void F_102 ( struct V_149 * V_9 )
{
struct V_7 * V_8 = F_103 ( & V_9 -> V_10 ) ;
struct V_1 * V_2 ;
F_97 ( F_4 ( V_9 ) ) ;
F_16 (lu, &tgt->lu_list, link) {
F_59 ( V_2 ) ;
...
static void F_100 ( struct V_149 * V_9 )
{
struct V_6 * V_10 = F_4 ( V_9 ) ;
struct V_7 * V_8 = F_103 ( & V_9 -> V_10 ) ;
struct V_1 * V_2 , * V_47 ;
...
F_104 ( & V_2 -> V_5 ) ;
V_101 = F_105 ( V_88 , 0 , 0 , F_64 ( V_2 -> V_92 ) ) ;
if ( V_101 ) {
F_75 ( V_101 ) ;
F_76 ( V_101 ) ;
}
...
static void F_108 ( struct V_10 * V_166 ,
struct V_167 * V_13 )
{
F_109 ( V_13 -> V_168 ) ;
if ( V_13 -> V_17 . V_67 & F_25 ( V_169 ) )
F_52 ( V_166 , V_13 -> V_170 ,
sizeof( V_13 -> V_171 ) , V_75 ) ;
}
static unsigned int F_110 ( T_6 * V_26 , T_6 * V_172 )
{
int V_173 ;
...
static void F_111 ( struct V_12 * V_53 ,
struct V_26 * V_27 )
{
struct V_167 * V_13 =
...
if ( V_183 == V_182 << 16 && F_113 ( * V_27 ) > 1 )
V_183 = F_110 ( F_114 ( * V_27 ) ,
V_13 -> V_168 -> V_189 ) ;
} else {
V_183 = V_186 << 16 ;
F_59 ( V_13 -> V_2 ) ;
...
F_52 ( V_10 -> V_15 -> V_10 , V_13 -> V_55 . V_35 ,
sizeof( V_13 -> V_17 ) , V_75 ) ;
F_108 ( V_10 -> V_15 -> V_10 , V_13 ) ;
V_13 -> V_168 -> V_183 = V_183 ;
V_13 -> V_168 -> V_190 ( V_13 -> V_168 ) ;
}
static int F_115 ( struct V_167 * V_13 ,
struct V_6 * V_10 , struct V_1 * V_2 )
{
struct V_191 * V_192 = F_116 ( V_13 -> V_168 ) ;
int V_143 , V_193 ;
V_193 = F_117 ( V_13 -> V_168 ) ;
if ( V_193 <= 0 )
goto V_194;
if ( V_193 == 1 ) {
...
F_25 ( F_118 ( V_192 ) ) ;
V_13 -> V_17 . V_67 |=
F_25 ( F_119 ( F_120 ( V_192 ) ) ) ;
return 0 ;
}
F_121 (sg, sg, n, i) {
V_13 -> V_171 [ V_143 ] . V_43 = F_25 ( F_120 ( V_192 ) << 16 ) ;
V_13 -> V_171 [ V_143 ] . V_44 = F_25 ( F_118 ( V_192 ) ) ;
}
V_13 -> V_170 =
F_40 ( V_10 -> V_15 -> V_10 , V_13 -> V_171 ,
sizeof( V_13 -> V_171 ) , V_75 ) ;
if ( F_41 ( V_10 -> V_15 -> V_10 , V_13 -> V_170 ) )
goto V_196;
...
struct V_167 * V_13 ;
int V_21 , V_50 = V_198 ;
if ( V_168 -> V_199 == V_200 ) {
F_22 ( F_6 ( V_2 ) , L_16 ) ;
V_168 -> V_183 = V_175 << 16 ;
V_168 -> V_190 ( V_168 ) ;
return 0 ;
}
...
V_13 -> V_2 = V_2 ;
V_13 -> V_168 = V_168 ;
V_13 -> V_17 . V_47 . V_43 = F_25 ( V_201 ) ;
V_13 -> V_17 . V_67 = F_25 (
F_123 ( V_2 -> V_8 -> V_163 ) |
F_124 ( V_10 -> V_46 ) |
V_202 ) ;
if ( V_168 -> V_199 == V_65 )
V_13 -> V_17 . V_67 |= F_25 ( V_203 ) ;
V_21 = V_10 -> V_21 ;
F_68 () ;
if ( F_125 ( V_168 ) && F_115 ( V_13 , V_10 , V_2 ) < 0 )
goto V_79;
memcpy ( V_13 -> V_17 . V_204 , V_168 -> V_205 , V_168 -> V_206 ) ;
V_13 -> V_55 . V_39 = F_111 ;
V_13 -> V_55 . V_35 =
F_40 ( V_10 -> V_15 -> V_10 , & V_13 -> V_17 ,
sizeof( V_13 -> V_17 ) , V_75 ) ;
if ( F_41 ( V_10 -> V_15 -> V_10 , V_13 -> V_55 . V_35 ) ) {
...
return - V_208 ;
V_101 -> V_209 = 1 ;
F_127 ( V_101 -> V_210 , 4 - 1 ) ;
if ( V_2 -> V_8 -> V_112 & V_211 )
V_101 -> V_212 = 36 ;
return 0 ;
}
static int F_128 ( struct V_100 * V_101 )
{
struct V_1 * V_2 = V_101 -> V_89 ;
V_101 -> V_213 = 1 ;
if ( V_72 )
...
V_2 -> V_8 -> V_112 & V_218 )
V_101 -> V_219 = 1 ;
if ( V_2 -> V_8 -> V_112 & V_220 )
V_101 -> V_221 = 1 ;
if ( V_2 -> V_8 -> V_112 & V_222 )
V_101 -> V_223 = 1 ;
if ( V_2 -> V_8 -> V_112 & V_224 )
F_129 ( V_101 -> V_210 , 128 * 1024 / 512 ) ;
return 0 ;
}
static int F_130 ( struct V_197 * V_168 )
{
struct V_1 * V_2 = V_168 -> V_10 -> V_89 ;
F_14 ( F_6 ( V_2 ) , L_17 ) ;
F_53 ( V_2 ) ;
...
static T_7 F_131 ( struct V_10 * V_226 ,
struct V_227 * V_228 , char * V_229 )
{
struct V_100 * V_101 = F_132 ( V_226 ) ;
struct V_1 * V_2 ;
if ( ! V_101 )
return 0 ;
V_2 = V_101 -> V_89 ;
return sprintf ( V_229 , L_18 ,
( unsigned long long ) V_2 -> V_8 -> V_124 ,
V_2 -> V_8 -> V_136 , V_2 -> V_92 ) ;
}
static int T_8 F_133 ( void )
{
return F_134 ( & V_230 . V_231 ) ;
}
