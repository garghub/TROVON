...
static int F_41 ( struct V_2 * V_3 , T_3 V_43 )
{
struct V_1 * V_4 = V_3 -> V_4 ;
F_13 ( V_3 ) ;
F_29 ( V_3 ) ;
F_9 ( V_3 ) ;
return F_42 ( V_3 , & V_4 -> V_6 . V_80 , V_43 ) ;
}
static void F_43 ( struct V_2 * V_3 , T_3 V_43 )
{
unsigned int V_58 ;
unsigned char V_100 ;
V_58 = F_21 ( V_3 , V_43 ) ;
V_100 = ( unsigned char ) F_44 ( V_58 ) ;
V_100 = ( V_100 << 4 ) | F_45 ( V_58 ) ;
if ( F_23 ( V_58 ) == V_64
...
static void F_49 ( struct V_2 * V_3 , struct V_102 * V_103 )
{
F_13 ( V_3 ) ;
F_50 ( V_3 , V_103 ) ;
}
static void F_51 ( struct V_2 * V_3 , struct V_102 * V_103 )
{
F_13 ( V_3 ) ;
F_52 ( V_3 , V_103 ) ;
}
static void F_53 ( struct V_2 * V_3 , struct V_102 * V_103 )
{
F_13 ( V_3 ) ;
}
...
V_4 -> V_6 . V_113 = & V_114 ;
V_4 -> V_6 . V_115 = & V_116 ;
V_91 = F_59 ( V_3 , & V_4 -> V_6 . V_35 , NULL , 0 ) ;
if ( V_91 < 0 )
return V_91 ;
V_91 = F_60 ( V_3 , & V_4 -> V_6 . V_35 ) ;
if ( V_91 < 0 )
return V_91 ;
F_54 ( V_3 ) ;
return 0 ;
...
V_3 -> V_139 = V_140 ;
V_3 -> V_139 . V_141 = F_64 ;
V_3 -> V_139 . V_142 = F_65 ;
V_3 -> V_38 = 0 ;
return 0 ;
}
...
static void F_72 ( struct V_2 * V_3 , T_3 V_53 ,
...
if ( F_83 ( F_74 ( V_3 , V_164 [ V_54 ] ) ) == V_165 )
return 0 ;
}
V_43 = V_3 -> V_166 ;
for ( V_54 = 0 ; V_54 < V_3 -> V_167 ; V_54 ++ , V_43 ++ ) {
unsigned int V_168 = F_74 ( V_3 , V_43 ) ;
if ( F_83 ( V_168 ) == V_165 &&
! ( V_168 & V_169 ) ) {
V_164 [ V_163 ++ ] = V_43 ;
return F_84 ( V_3 ,
