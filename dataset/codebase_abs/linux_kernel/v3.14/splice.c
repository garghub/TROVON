...
V_24 = F_85 ( V_95 -> V_96 . V_54 , V_124 + V_4 -> V_37 , V_95 -> V_39 , & V_125 ) ;
...
T_1 F_87 ( struct V_1 * V_2 , struct V_54 * V_107 ,
T_2 * V_56 , T_3 V_39 , unsigned int V_10 )
{
return F_76 ( V_2 , V_107 , V_56 , V_39 , V_10 , F_62 ) ;
}
static long F_88 ( struct V_1 * V_2 , struct V_54 * V_107 ,
T_2 * V_56 , T_3 V_39 , unsigned int V_10 )
{
T_1 (* F_89)( struct V_1 * , struct V_54 * ,
T_2 * , T_3 , unsigned int );
if ( V_107 -> V_98 -> F_89 )
F_89 = V_107 -> V_98 -> F_89 ;
else
F_89 = F_86 ;
return F_89 ( V_2 , V_107 , V_56 , V_39 , V_10 ) ;
}
static long F_90 ( struct V_54 * V_55 , T_2 * V_56 ,
struct V_1 * V_2 , T_3 V_39 ,
unsigned int V_10 )
{
T_1 (* F_91)( struct V_54 * , T_2 * ,
struct V_1 * , T_3 , unsigned int );
int V_24 ;
if ( F_41 ( ! ( V_55 -> V_126 & V_127 ) ) )
return - V_128 ;
V_24 = F_92 ( V_129 , V_55 , V_56 , V_39 ) ;
if ( F_41 ( V_24 < 0 ) )
return V_24 ;
if ( V_55 -> V_98 -> F_91 )
F_91 = V_55 -> V_98 -> F_91 ;
...
F_91 = F_58 ;
return F_91 ( V_55 , V_56 , V_2 , V_39 , V_10 ) ;
}
T_1 F_93 ( struct V_54 * V_55 , struct V_94 * V_95 ,
T_7 * V_114 )
{
struct V_1 * V_2 ;
long V_24 , V_130 ;
...
T_3 V_39 ;
int V_49 , V_10 ;
V_131 = F_94 ( V_55 ) -> V_131 ;
if ( F_41 ( ! F_95 ( V_131 ) && ! F_96 ( V_131 ) ) )
return - V_100 ;
V_2 = V_29 -> V_132 ;
if ( F_41 ( ! V_2 ) ) {
V_2 = F_97 () ;
...
V_24 = F_90 ( V_55 , & V_82 , V_2 , V_39 , V_10 ) ;
if ( F_41 ( V_24 <= 0 ) )
goto V_134;
V_133 = V_24 ;
V_95 -> V_103 = V_133 ;
...
{
struct V_54 * V_54 = V_95 -> V_96 . V_54 ;
return F_88 ( V_2 , V_54 , V_95 -> V_136 , V_95 -> V_103 ,
V_95 -> V_10 ) ;
}
long F_99 ( struct V_54 * V_55 , T_2 * V_56 , struct V_54 * V_107 ,
...
return - V_100 ;
V_24 = F_92 ( V_140 , V_107 , V_136 , V_39 ) ;
if ( F_41 ( V_24 < 0 ) )
return V_24 ;
V_24 = F_93 ( V_55 , & V_95 , F_98 ) ;
if ( V_24 > 0 )
* V_56 = V_95 . V_82 ;
return V_24 ;
}
static long F_100 ( struct V_54 * V_55 , T_2 V_84 * V_141 ,
...
if ( V_143 == V_144 )
return - V_100 ;
return F_102 ( V_143 , V_144 , V_39 , V_10 ) ;
}
if ( V_143 ) {
if ( V_141 )
return - V_145 ;
...
return - V_100 ;
if ( F_103 ( & V_37 , V_142 , sizeof( T_2 ) ) )
return - V_147 ;
} else {
V_37 = V_107 -> V_148 ;
}
...
if ( F_41 ( V_107 -> V_138 & V_139 ) )
return - V_100 ;
V_24 = F_92 ( V_140 , V_107 , & V_37 , V_39 ) ;
if ( F_41 ( V_24 < 0 ) )
return V_24 ;
F_104 ( V_107 ) ;
V_24 = F_88 ( V_143 , V_107 , & V_37 , V_39 , V_10 ) ;
F_105 ( V_107 ) ;
if ( ! V_142 )
V_107 -> V_148 = V_37 ;
else if ( F_106 ( V_142 , & V_37 , sizeof( T_2 ) ) )
V_24 = - V_147 ;
return V_24 ;
}
if ( V_144 ) {
...
if ( ! ( V_55 -> V_126 & V_149 ) )
return - V_100 ;
if ( F_103 ( & V_37 , V_141 , sizeof( T_2 ) ) )
return - V_147 ;
} else {
V_37 = V_55 -> V_148 ;
}
V_24 = F_90 ( V_55 , & V_37 , V_144 , V_39 , V_10 ) ;
if ( ! V_141 )
V_55 -> V_148 = V_37 ;
else if ( F_106 ( V_141 , & V_37 , sizeof( T_2 ) ) )
V_24 = - V_147 ;
return V_24 ;
}
return - V_100 ;
}
static int F_107 ( const struct V_78 V_84 * V_150 ,
...
int V_49 ;
error = - V_147 ;
if ( F_103 ( & V_156 , V_150 , sizeof( V_156 ) ) )
break;
V_157 = V_156 . V_92 ;
V_39 = V_156 . V_93 ;
error = 0 ;
...
if ( V_155 > V_153 - V_32 )
V_155 = V_153 - V_32 ;
error = F_109 ( ( unsigned long ) V_157 , V_155 ,
0 , & V_36 [ V_32 ] ) ;
if ( F_41 ( error <= 0 ) )
break;
...
char * V_108 ;
int V_24 ;
if ( ! F_111 ( V_95 -> V_96 . V_162 , V_95 -> V_39 ) ) {
V_108 = V_4 -> V_41 -> V_109 ( V_2 , V_4 , 1 ) ;
V_24 = F_112 ( V_95 -> V_96 . V_162 , V_108 + V_4 -> V_37 ,
V_95 -> V_39 ) ;
V_4 -> V_41 -> V_111 ( V_2 , V_4 , V_108 ) ;
if ( ! V_24 ) {
V_24 = V_95 -> V_39 ;
...
V_24 = V_95 -> V_39 ;
if ( F_106 ( V_95 -> V_96 . V_162 , V_108 + V_4 -> V_37 , V_95 -> V_39 ) )
V_24 = - V_147 ;
V_4 -> V_41 -> V_111 ( V_2 , V_4 , V_108 ) ;
V_107:
if ( V_24 > 0 )
...
static long F_113 ( struct V_54 * V_54 , const struct V_78 V_84 * V_150 ,
...
void V_84 * V_157 ;
T_3 V_39 ;
error = F_114 ( V_157 , & V_150 -> V_92 ) ;
if ( F_41 ( error ) )
break;
error = F_114 ( V_39 , & V_150 -> V_93 ) ;
if ( F_41 ( error ) )
break;
if ( F_41 ( ! V_39 ) )
break;
...
if ( F_41 ( ! F_108 ( V_165 , V_157 , V_39 ) ) ) {
error = - V_147 ;
break;
}
V_95 . V_39 = 0 ;
...
static long F_115 ( struct V_54 * V_54 , const struct V_78 V_84 * V_150 ,
unsigned long V_163 , unsigned int V_10 )
{
struct V_1 * V_2 ;
struct V_5 * V_36 [ V_51 ] ;
...
if ( F_29 ( V_2 , & V_21 ) )
return - V_53 ;
V_21 . V_23 = F_107 ( V_150 , V_163 , V_21 . V_36 ,
V_21 . V_38 , false ,
V_21 . V_50 ) ;
if ( V_21 . V_23 <= 0 )
V_24 = V_21 . V_23 ;
...
static int F_117 ( struct V_1 * V_2 , unsigned int V_10 )
{
int V_24 ;
if ( V_2 -> V_31 < V_2 -> V_32 )
return 0 ;
...
static int F_102 ( struct V_1 * V_143 ,
struct V_1 * V_144 ,
T_3 V_39 , unsigned int V_10 )
{
...
bool V_170 = false ;
V_171:
V_24 = F_116 ( V_143 , V_10 ) ;
if ( V_24 )
return V_24 ;
V_24 = F_117 ( V_144 , V_10 ) ;
if ( V_24 )
return V_24 ;
F_118 ( V_143 , V_144 ) ;
do {
...
static int F_119 ( struct V_1 * V_143 ,
struct V_1 * V_144 ,
T_3 V_39 , unsigned int V_10 )
{
struct V_3 * V_167 , * V_168 ;
...
static long F_120 ( struct V_54 * V_55 , struct V_54 * V_107 , T_3 V_39 ,
unsigned int V_10 )
{
struct V_1 * V_143 = F_101 ( V_55 ) ;
struct V_1 * V_144 = F_101 ( V_107 ) ;
int V_24 = - V_100 ;
...
V_24 = F_117 ( V_144 , V_10 ) ;
if ( ! V_24 )
V_24 = F_119 ( V_143 , V_144 , V_39 , V_10 ) ;
}
}
return V_24 ;
}
