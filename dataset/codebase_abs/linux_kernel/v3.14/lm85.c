...
F_91 ( V_65 -> type , V_70 , V_98 ) ;
return 0 ;
}
static void F_92 ( struct V_22 * V_23 , struct V_17 * V_18 )
{
F_93 ( & V_23 -> V_11 . V_99 , & V_100 ) ;
if ( V_18 -> type != V_101 ) {
F_93 ( & V_23 -> V_11 . V_99 , & V_102 ) ;
F_93 ( & V_23 -> V_11 . V_99 , & V_103 ) ;
}
if ( ! V_18 -> V_27 )
F_93 ( & V_23 -> V_11 . V_99 , & V_104 ) ;
if ( V_18 -> type == V_105 )
F_93 ( & V_23 -> V_11 . V_99 , & V_106 ) ;
}
...
struct V_17 * V_18 ;
int V_24 ;
V_18 = F_95 ( & V_23 -> V_11 , sizeof( struct V_17 ) , V_109 ) ;
if ( ! V_18 )
return - V_110 ;
F_96 ( V_23 , V_18 ) ;
V_18 -> type = V_108 -> V_111 ;
F_97 ( & V_18 -> V_25 ) ;
switch ( V_18 -> type ) {
case V_112 :
case V_113 :
...
V_18 -> V_28 = F_98 () ;
F_83 ( V_23 ) ;
V_24 = F_99 ( & V_23 -> V_11 . V_99 , & V_100 ) ;
if ( V_24 )
return V_24 ;
if ( V_18 -> type != V_101 ) {
V_24 = F_99 ( & V_23 -> V_11 . V_99 , & V_102 ) ;
if ( V_24 )
goto V_118;
V_24 = F_99 ( & V_23 -> V_11 . V_99 ,
& V_103 ) ;
if ( V_24 )
goto V_118;
}
if ( V_18 -> type == V_113 || V_18 -> type == V_38 ) {
T_2 V_26 = F_35 ( V_23 , V_119 ) ;
if ( V_26 & 0x80 )
V_18 -> V_27 = true ;
}
if ( ! V_18 -> V_27 ) {
V_24 = F_99 ( & V_23 -> V_11 . V_99 , & V_104 ) ;
if ( V_24 )
goto V_118;
}
if ( V_18 -> type == V_105 ) {
V_24 = F_99 ( & V_23 -> V_11 . V_99 , & V_106 ) ;
if ( V_24 )
goto V_118;
}
V_18 -> V_120 = F_100 ( & V_23 -> V_11 ) ;
if ( F_101 ( V_18 -> V_120 ) ) {
V_24 = F_102 ( V_18 -> V_120 ) ;
goto V_118;
}
return 0 ;
V_118:
...
case F_18 ( 3 ) :
case V_122 :
V_121 = F_87 ( V_23 , V_7 ) & 0xff ;
V_121 |= F_87 ( V_23 , V_7 + 1 ) << 8 ;
break;
default:
V_121 = F_87 ( V_23 , V_7 ) ;
break;
...
int V_136 = F_35 ( V_23 ,
V_137 ) ;
V_18 -> V_43 [ 0 ] = V_134 & 0x0f ;
V_18 -> V_43 [ 1 ] = V_136 & 0x0f ;
V_18 -> V_43 [ 2 ] = V_136 >> 4 ;
V_18 -> V_43 [ 3 ] = V_134 >> 4 ;
V_18 -> V_43 [ 4 ] = V_129 >> 4 ;
V_18 -> V_47 [ 0 ] = V_127 & 0x0f ;
V_18 -> V_47 [ 1 ] = V_129 & 0x0f ;
V_18 -> V_47 [ 2 ] = V_127 >> 4 ;
}
V_18 -> V_125 = V_124 ;
}
if ( ! V_18 -> V_123 ||
F_107 ( V_124 , V_18 -> V_138 + V_139 ) ) {
F_90 ( & V_23 -> V_11 , L_22 ) ;
for ( V_3 = 0 ; V_3 <= 3 ; ++ V_3 ) {
V_18 -> V_44 [ V_3 ] =
F_35 ( V_23 , F_48 ( V_3 ) ) ;
