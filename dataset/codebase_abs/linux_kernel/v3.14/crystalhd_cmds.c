...
static enum V_13 F_41 ( bool V_92 , void * V_93 ,
V_41 V_94 , V_41 V_95 , bool V_96 )
{
if ( ! V_93 || ! V_94 ) {
F_5 ( L_14 ,
( ( V_92 ) ? L_15 : L_16 ) , V_93 , V_94 ) ;
return V_17 ;
}
if ( ( ( V_97 ) V_93 ) & 0x03 ) {
F_5 (
...
F_30 ( V_70 , L_28 , V_155 -> V_156 ) ;
F_62 ( & V_3 -> V_33 , V_3 -> V_30 ) ;
V_155 -> V_7 = 1 ;
* V_154 = V_155 ;
return V_26 ;
}
enum V_13 F_63 ( struct V_2 * V_3 ,
struct V_1 * V_155 )
{
V_41 V_9 = V_155 -> V_9 ;
...
T_2 F_69 ( struct V_2 * V_3 ,
V_41 V_65 , struct V_1 * V_155 )
{
T_2 V_158 = NULL ;
