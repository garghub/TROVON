...
while ( F_99 ( V_2 , V_311 ) & V_312 ) {
V_310 = F_99 ( V_2 , V_313 ) ;
F_137 ( ( L_104 , V_2 -> V_8 , V_310 ) ) ;
...
F_160 ( V_2 -> V_15 [ V_6 ] , V_316 | ( V_310 >> 8 ) ) ;
V_2 -> V_308 = V_4 = 0 ;
if ( ++ V_6 == V_2 -> V_14 )
V_6 = 0 ;
V_2 -> V_170 |= V_272 ;
...
{
unsigned short V_12 = F_99 ( V_2 , V_311 ) ;
F_137 ( ( L_105 , V_2 -> V_8 , V_12 ) ) ;
F_100 ( V_2 , V_311 , V_12 ) ;
V_2 -> V_317 = true ;
if ( V_2 -> V_68 . V_69 == V_89 ) {
if ( V_12 & V_318 ) {
if ( V_2 -> V_86 )
...
{
unsigned int V_12 = F_165 ( V_2 , V_332 ) ;
F_137 ( ( L_106 , V_2 -> V_8 , V_12 ) ) ;
F_166 ( V_2 , V_332 , V_12 ) ;
if ( V_12 & ( V_333 + V_334 ) ) {
F_137 ( ( L_107 , V_2 -> V_8 ) ) ;
V_2 -> V_283 = true ;
}
...
{
unsigned int V_12 = F_165 ( V_2 , V_335 ) ;
F_137 ( ( L_108 , V_2 -> V_8 , V_12 ) ) ;
F_166 ( V_2 , V_335 , V_12 ) ;
...
F_151 ( V_2 , V_337 + V_318 + V_326 ) ;
F_169 ( V_2 ) ;
if ( V_12 & V_326 ) {
unsigned short V_338 = F_99 ( V_2 , V_176 ) ;
F_100 ( V_2 , V_176 , ( unsigned short ) ( V_338 | V_296 ) ) ;
F_100 ( V_2 , V_176 , V_338 ) ;
}
if ( V_2 -> V_86 ) {
if ( V_2 -> V_68 . V_69 != V_89 ) {
if ( V_12 & V_326 )
...
static void F_171 ( struct V_1 * V_2 , unsigned int V_340 , unsigned int V_341 )
{
...
static T_6 F_172 ( int V_348 , void * V_349 )
{
struct V_1 * V_2 = V_349 ;
unsigned int V_350 ;
unsigned int V_6 ;
F_137 ( ( L_110 , V_2 -> V_155 ) ) ;
while( ( V_350 = F_165 ( V_2 , V_351 ) & 0xffffff00 ) ) {
F_137 ( ( L_111 , V_2 -> V_8 , V_350 ) ) ;
V_2 -> V_317 = true ;
...
unsigned int V_340 ;
F_80 ( & V_2 -> V_54 ) ;
while ( ( V_340 = F_165 ( V_2 , V_358 ) ) != 0 ) {
F_137 ( ( L_112 , V_2 -> V_8 , V_340 ) ) ;
V_341 = F_165 ( V_2 , V_359 ) ;
F_166 ( V_2 , V_358 , V_340 ) ;
for ( V_6 = 0 ; V_6 < V_2 -> V_352 ; V_6 ++ ) {
if ( V_2 -> V_353 [ V_6 ] != NULL )
F_171 ( V_2 -> V_353 [ V_6 ] , V_340 , V_341 ) ;
}
}
F_81 ( & V_2 -> V_54 ) ;
}
...
V_2 -> V_284 = 0 ;
V_2 -> V_285 = 0 ;
F_182 ( V_2 , V_302 | V_299 | V_293 | V_307 ) ;
F_87 ( V_2 ) ;
if ( V_2 -> V_49 ||
...
V_2 -> V_68 . V_143 + 1 ;
V_2 -> V_68 . V_85 = F_183 ( V_2 -> V_38 . V_21 ) ;
if ( V_2 -> V_68 . V_85 ) {
...
unsigned short V_338 = F_99 ( V_2 , V_409 ) ;
if ( ! ( V_338 & V_327 ) )
F_100 ( V_2 , V_409 , ( unsigned short ) ( V_338 | V_327 ) ) ;
}
F_193 ( V_410 ) ;
F_194 ( & V_2 -> V_295 , & V_398 ) ;
F_18 ( & V_2 -> V_54 , V_22 ) ;
for(; ; ) {
F_195 () ;
if ( F_48 ( V_87 ) ) {
...
F_196 ( & V_2 -> V_295 , & V_398 ) ;
F_193 ( V_411 ) ;
if ( V_394 & ( V_407 + V_408 ) ) {
F_17 ( & V_2 -> V_54 , V_22 ) ;
if ( ! F_197 ( & V_2 -> V_295 ) ) {
F_100 ( V_2 , V_409 ,
( unsigned short ) ( F_99 ( V_2 , V_409 ) & ~ V_327 ) ) ;
}
F_18 ( & V_2 -> V_54 , V_22 ) ;
}
exit:
if ( V_148 == 0 )
V_148 = F_189 ( V_393 , V_390 ) ;
return V_148 ;
}
static int F_73 ( struct V_1 * V_2 , int T_2 * V_412 )
{
F_13 ( ( L_128 , V_2 -> V_8 , V_2 -> V_412 ) ) ;
if ( F_189 ( V_2 -> V_412 , V_412 ) )
return - V_144 ;
return 0 ;
}
...
if ( ! V_2 -> V_357 )
return - V_175 ;
V_421 . V_341 = F_165 ( V_2 , V_359 ) ;
V_421 . V_422 = 0xffffffff ;
V_421 . V_423 = F_165 ( V_2 , V_425 ) ;
...
static void F_199 ( struct V_342 * V_343 , unsigned int V_3 )
{
F_200 ( & V_343 -> V_347 ) ;
F_201 ( & V_343 -> V_398 , V_87 ) ;
V_343 -> V_3 = V_3 ;
}
static void F_202 ( struct V_342 * * V_426 , struct V_342 * V_343 )
{
F_193 ( V_410 ) ;
F_194 ( & V_343 -> V_347 , & V_343 -> V_398 ) ;
V_343 -> V_346 = * V_426 ;
* V_426 = V_343 ;
}
static void F_203 ( struct V_342 * * V_426 , struct V_342 * V_427 )
{
struct V_342 * V_343 , * V_344 ;
F_196 ( & V_427 -> V_347 , & V_427 -> V_398 ) ;
F_193 ( V_411 ) ;
...
static void F_178 ( struct V_342 * * V_426 )
{
while ( * V_426 != NULL ) {
F_30 ( & ( * V_426 ) -> V_347 ) ;
* V_426 = ( * V_426 ) -> V_346 ;
...
F_13 ( ( L_136 ,
V_2 -> V_8 , V_421 . V_341 , V_421 . V_422 ) ) ;
if ( ( V_421 . V_422 &= ~ F_165 ( V_2 , V_425 ) ) == 0 )
return - V_175 ;
F_199 ( & V_398 , V_421 . V_422 ) ;
F_17 ( & V_2 -> V_353 [ 0 ] -> V_54 , V_22 ) ;
F_166 ( V_2 , V_428 , F_165 ( V_2 , V_428 ) | V_421 . V_422 ) ;
V_341 = F_165 ( V_2 , V_359 ) ;
...
static int F_206 ( struct V_439 * V_38 )
{
unsigned long V_22 ;
...
static void F_207 ( struct V_439 * V_38 , int V_440 )
{
unsigned long V_22 ;
struct V_1 * V_2 = F_144 ( V_38 , struct V_1 , V_38 ) ;
F_17 ( & V_2 -> V_54 , V_22 ) ;
...
V_38 -> V_446 ++ ;
while ( 1 ) {
if ( F_208 ( V_21 ) && F_34 ( V_447 , & V_38 -> V_22 ) )
F_209 ( V_38 ) ;
F_193 ( V_410 ) ;
...
{
V_2 -> V_448 = F_174 ( V_2 -> V_77 + 5 , V_361 ) ;
if ( V_2 -> V_448 == NULL )
return - V_245 ;
V_2 -> V_449 = F_214 ( V_2 -> V_77 + 5 , V_361 ) ;
if ( ! V_2 -> V_449 ) {
F_177 ( V_2 -> V_448 ) ;
V_2 -> V_448 = NULL ;
return - V_245 ;
...
unsigned int V_6 ;
unsigned int V_450 ;
V_2 -> V_262 = F_217 ( V_2 -> V_451 , V_452 , & V_2 -> V_453 ) ;
if ( V_2 -> V_262 == NULL )
return - V_245 ;
memset ( V_2 -> V_262 , 0 , V_452 ) ;
V_2 -> V_15 = (struct V_261 * ) V_2 -> V_262 ;
V_2 -> V_11 = ( (struct V_261 * ) V_2 -> V_262 ) + V_2 -> V_14 ;
V_450 = ( unsigned int ) V_2 -> V_453 ;
for ( V_6 = 0 ; V_6 < V_2 -> V_14 ; V_6 ++ ) {
V_2 -> V_15 [ V_6 ] . V_454 = V_450 + ( V_6 * sizeof( struct V_261 ) ) ;
if ( V_6 == V_2 -> V_14 - 1 )
V_2 -> V_15 [ V_6 ] . V_346 = F_218 ( V_450 ) ;
else
V_2 -> V_15 [ V_6 ] . V_346 = F_218 ( V_450 + ( ( V_6 + 1 ) * sizeof( struct V_261 ) ) ) ;
F_159 ( V_2 -> V_15 [ V_6 ] , V_387 ) ;
}
for ( V_6 = 0 ; V_6 < V_2 -> V_10 ; V_6 ++ ) {
V_2 -> V_11 [ V_6 ] . V_454 = V_450 + ( ( V_2 -> V_14 + V_6 ) * sizeof( struct V_261 ) ) ;
if ( V_6 == V_2 -> V_10 - 1 )
V_2 -> V_11 [ V_6 ] . V_346 = F_218 ( V_450 + V_2 -> V_14 * sizeof( struct V_261 ) ) ;
else
V_2 -> V_11 [ V_6 ] . V_346 = F_218 ( V_450 + ( ( V_2 -> V_14 + V_6 + 1 ) * sizeof( struct V_261 ) ) ) ;
}
return 0 ;
}
...
{
if ( V_2 -> V_262 != NULL ) {
F_220 ( V_2 -> V_451 , V_452 , V_2 -> V_262 , V_2 -> V_453 ) ;
V_2 -> V_262 = NULL ;
V_2 -> V_15 = NULL ;
V_2 -> V_11 = NULL ;
}
...
if ( ( V_262 [ V_6 ] . V_73 = F_217 ( V_2 -> V_451 , V_387 , & V_262 [ V_6 ] . V_455 ) ) == NULL )
return - V_245 ;
V_262 [ V_6 ] . V_456 = F_218 ( ( unsigned int ) V_262 [ V_6 ] . V_455 ) ;
}
return 0 ;
}
static void F_222 ( struct V_1 * V_2 , struct V_261 * V_262 , int V_4 )
{
int V_6 ;
for ( V_6 = 0 ; V_6 < V_4 ; V_6 ++ ) {
if ( V_262 [ V_6 ] . V_73 == NULL )
continue;
F_220 ( V_2 -> V_451 , V_387 , V_262 [ V_6 ] . V_73 , V_262 [ V_6 ] . V_455 ) ;
V_262 [ V_6 ] . V_73 = NULL ;
}
}
...
{
if ( F_227 ( V_2 -> V_154 , V_248 , L_143 ) == NULL ) {
F_12 ( ( L_144 ,
V_2 -> V_8 , V_2 -> V_154 ) ) ;
V_2 -> V_36 = V_457 ;
goto V_458;
...
V_2 -> V_459 = true ;
V_2 -> V_460 = F_228 ( V_2 -> V_154 , V_248 ) ;
if ( ! V_2 -> V_460 ) {
F_12 ( ( L_145 ,
V_2 -> V_8 , V_2 -> V_154 ) ) ;
V_2 -> V_36 = V_461 ;
...
V_2 -> V_35 = NULL ;
V_2 -> line = V_31 ;
sprintf ( V_2 -> V_8 , L_146 , V_464 , V_2 -> line ) ;
if ( V_2 -> line < V_465 ) {
if ( V_466 [ V_2 -> line ] )
V_2 -> V_77 = V_466 [ V_2 -> line ] ;
}
V_31 ++ ;
if ( ! V_34 )
V_34 = V_2 ;
else {
struct V_1 * V_467 = V_34 ;
while( V_467 -> V_35 )
V_467 = V_467 -> V_35 ;
V_467 -> V_35 = V_2 ;
}
...
F_2 ( L_152 ,
V_463 , V_2 -> V_8 , V_2 -> V_154 ,
V_2 -> V_155 , V_2 -> V_77 ) ;
#if V_303
F_127 ( V_2 ) ;
#endif
}
static struct V_1 * F_234 ( int V_473 , int V_474 , struct V_475 * V_451 )
{
struct V_1 * V_2 ;
...
V_2 -> V_38 . V_25 = & V_476 ;
V_2 -> V_18 = V_19 ;
F_236 ( & V_2 -> V_277 , F_143 ) ;
V_2 -> V_77 = 4096 ;
V_2 -> V_147 = 14745600 ;
V_2 -> V_314 = V_387 ;
V_2 -> V_38 . V_477 = 5 * V_253 / 10 ;
V_2 -> V_38 . V_478 = 30 * V_253 ;
F_200 ( & V_2 -> V_294 ) ;
F_200 ( & V_2 -> V_295 ) ;
F_237 ( & V_2 -> V_48 ) ;
memcpy ( & V_2 -> V_68 , & V_479 , sizeof( T_7 ) ) ;
V_2 -> V_385 = V_480 ;
V_2 -> V_473 = V_473 ;
V_2 -> V_474 = V_474 ;
F_238 ( & V_2 -> V_71 , V_481 , ( unsigned long ) V_2 ) ;
F_238 ( & V_2 -> V_271 , V_482 , ( unsigned long ) V_2 ) ;
V_2 -> V_451 = V_451 ;
V_2 -> V_155 = V_451 -> V_249 ;
V_2 -> V_154 = F_239 ( V_451 , 0 ) ;
V_2 -> V_483 = V_484 ;
V_2 -> V_485 = V_486 ;
V_2 -> V_36 = - 1 ;
}
...
static void F_240 ( int V_473 , struct V_475 * V_451 )
{
struct V_1 * V_353 [ V_487 ] ;
int V_6 ;
int V_352 = 1 ;
if ( V_451 -> V_468 == V_470 )
V_352 = 2 ;
else if ( V_451 -> V_468 == V_471 )
V_352 = 4 ;
for ( V_6 = 0 ; V_6 < V_352 ; ++ V_6 ) {
V_353 [ V_6 ] = F_234 ( V_473 , V_6 , V_451 ) ;
if ( V_353 [ V_6 ] == NULL ) {
for ( -- V_6 ; V_6 >= 0 ; -- V_6 ) {
F_241 ( & V_353 [ V_6 ] -> V_38 ) ;
F_177 ( V_353 [ V_6 ] ) ;
}
return;
}
...
F_237 ( & V_353 [ V_6 ] -> V_54 ) ;
}
if ( ! F_226 ( V_353 [ 0 ] ) ) {
F_223 ( V_353 [ 0 ] ) ;
for ( V_6 = 1 ; V_6 < V_352 ; ++ V_6 ) {
V_353 [ V_6 ] -> V_155 = V_353 [ 0 ] -> V_155 ;
V_353 [ V_6 ] -> V_460 = V_353 [ 0 ] -> V_460 ;
F_223 ( V_353 [ V_6 ] ) ;
}
if ( F_242 ( V_353 [ 0 ] -> V_155 ,
F_172 ,
V_353 [ 0 ] -> V_485 ,
V_353 [ 0 ] -> V_8 ,
V_353 [ 0 ] ) < 0 ) {
...
F_244 ( & V_2 -> V_38 , V_488 , V_2 -> line ,
& V_2 -> V_451 -> V_179 ) ;
}
}
static int F_245 ( struct V_475 * V_179 ,
...
static void F_248 ( struct V_475 * V_179 )
{
}
...
struct V_1 * V_2 ;
struct V_1 * V_491 ;
F_2 ( V_492 L_156 , V_32 ) ;
if ( V_488 ) {
for ( V_2 = V_34 ; V_2 != NULL ; V_2 = V_2 -> V_35 )
F_250 ( V_488 , V_2 -> line ) ;
if ( ( V_148 = F_251 ( V_488 ) ) )
F_12 ( ( L_157 , V_148 ) ) ;
F_252 ( V_488 ) ;
}
V_2 = V_34 ;
...
V_488 -> V_502 = V_503 ;
V_488 -> V_502 . V_59 =
V_504 | V_372 | V_365 | V_364 | V_380 ;
V_488 -> V_502 . V_505 = 9600 ;
V_488 -> V_502 . V_506 = 9600 ;
V_488 -> V_22 = V_507 | V_508 ;
F_257 ( V_488 , & V_25 ) ;
if ( ( V_148 = F_258 ( V_488 ) ) < 0 ) {
F_12 ( ( L_160 , V_32 ) ) ;
F_252 ( V_488 ) ;
V_488 = NULL ;
goto error;
...
static T_1 F_261 ( struct V_1 * V_2 , unsigned int V_509 )
{
F_262 () ;
return F_263 ( ( void V_510 * ) V_460 ) ;
}
static void F_264 ( struct V_1 * V_2 , unsigned int V_509 , T_1 V_174 )
{
F_262 () ;
F_265 ( V_174 , ( void V_510 * ) V_460 ) ;
}
static T_12 F_99 ( struct V_1 * V_2 , unsigned int V_509 )
{
F_262 () ;
return F_266 ( ( void V_510 * ) V_460 ) ;
}
static void F_100 ( struct V_1 * V_2 , unsigned int V_509 , T_12 V_174 )
{
F_262 () ;
F_267 ( V_174 , ( void V_510 * ) V_460 ) ;
}
static T_8 F_165 ( struct V_1 * V_2 , unsigned int V_509 )
{
F_262 () ;
return F_268 ( ( void V_510 * ) V_460 ) ;
}
static void F_166 ( struct V_1 * V_2 , unsigned int V_509 , T_8 V_174 )
{
F_262 () ;
F_269 ( V_174 , ( void V_510 * ) V_460 ) ;
}
static void F_270 ( struct V_1 * V_2 )
{
unsigned int V_6 ;
F_166 ( V_2 , V_332 , V_266 ) ;
for( V_6 = 0 ; V_6 < 1000 ; V_6 ++ )
if ( ! ( F_165 ( V_2 , V_332 ) & V_267 ) )
break;
}
static void F_169 ( struct V_1 * V_2 )
{
unsigned int V_6 ;
F_166 ( V_2 , V_335 , V_266 ) ;
for( V_6 = 0 ; V_6 < 1000 ; V_6 ++ )
if ( ! ( F_165 ( V_2 , V_335 ) & V_267 ) )
break;
}
...
if ( V_2 -> V_68 . V_69 != V_89 ) {
F_264 ( V_2 , V_511 , 0x49 ) ;
if ( V_2 -> V_68 . V_137 )
F_272 ( V_2 , V_2 -> V_68 . V_137 ) ;
else
F_272 ( V_2 , 3686400 ) ;
}
}
static void F_272 ( struct V_1 * V_2 , T_9 V_512 )
{
unsigned int div ;
unsigned int V_513 = V_2 -> V_147 ;
if ( V_512 ) {
div = V_513 / V_512 ;
if ( ! ( V_513 % V_512 ) && div )
div -- ;
F_100 ( V_2 , V_514 , ( unsigned short ) div ) ;
}
}
static void F_158 ( struct V_1 * V_2 )
{
unsigned short V_338 ;
V_338 = F_99 ( V_2 , V_389 ) & ~ V_266 ;
F_100 ( V_2 , V_389 , ( unsigned short ) ( V_338 | V_296 ) ) ;
F_100 ( V_2 , V_389 , V_338 ) ;
F_151 ( V_2 , V_331 + V_312 + V_327 ) ;
F_100 ( V_2 , V_311 , V_327 + V_331 ) ;
F_270 ( V_2 ) ;
V_2 -> V_388 = false ;
V_2 -> V_283 = false ;
}
...
{
unsigned short V_338 ;
F_151 ( V_2 , V_331 + V_312 ) ;
F_100 ( V_2 , V_311 , V_331 ) ;
V_338 = F_99 ( V_2 , V_389 ) & ~ V_266 ;
F_100 ( V_2 , V_389 , ( unsigned short ) ( V_338 | V_296 ) ) ;
F_100 ( V_2 , V_389 , V_338 ) ;
F_270 ( V_2 ) ;
F_224 ( V_2 ) ;
if ( V_2 -> V_319 ) {
F_100 ( V_2 , V_409 , ( unsigned short ) ( F_99 ( V_2 , V_409 ) & ~ V_515 ) ) ;
F_182 ( V_2 , V_312 ) ;
if ( V_2 -> V_68 . V_69 == V_89 ) {
F_166 ( V_2 , V_332 , V_177 ) ;
}
} else {
F_100 ( V_2 , V_409 , ( unsigned short ) ( F_99 ( V_2 , V_409 ) | V_515 ) ) ;
F_166 ( V_2 , V_516 , V_2 -> V_15 [ 0 ] . V_454 ) ;
if ( V_2 -> V_68 . V_69 != V_89 ) {
F_166 ( V_2 , V_332 , ( V_296 + V_267 ) ) ;
} else {
F_166 ( V_2 , V_332 , ( V_177 + V_296 + V_267 ) ) ;
}
}
F_182 ( V_2 , V_331 ) ;
...
if ( F_136 ( V_2 -> V_11 [ V_2 -> V_336 ] ) ) {
V_2 -> V_339 = false ;
if ( V_2 -> V_68 . V_69 != V_89 ) {
if ( V_2 -> V_68 . V_22 & V_517 ) {
F_87 ( V_2 ) ;
if ( ! ( V_2 -> V_62 & V_63 ) ) {
V_2 -> V_62 |= V_63 ;
F_33 ( V_2 ) ;
...
F_151 ( V_2 , V_337 ) ;
F_182 ( V_2 , V_326 + V_318 ) ;
F_100 ( V_2 , V_311 , ( unsigned short ) ( V_318 + V_326 ) ) ;
} else {
F_151 ( V_2 , V_337 ) ;
F_182 ( V_2 , V_318 ) ;
F_100 ( V_2 , V_311 , V_318 ) ;
}
F_166 ( V_2 , V_518 , V_2 -> V_11 [ V_2 -> V_336 ] . V_454 ) ;
F_166 ( V_2 , V_335 , V_296 + V_267 ) ;
V_2 -> V_86 = true ;
}
}
...
if ( V_2 -> V_68 . V_22 & V_521 )
V_338 |= V_267 ;
F_100 ( V_2 , V_389 , V_338 ) ;
F_264 ( V_2 , V_511 , 0x69 ) ;
F_198 ( V_2 ) ;
V_338 = V_316 + V_515 + V_267 ;
if ( ( F_165 ( V_2 , V_522 ) & V_354 ) && V_2 -> V_68 . V_85 &&
( ( V_2 -> V_147 < ( V_2 -> V_68 . V_85 * 16 ) ) ||
( V_2 -> V_147 % ( V_2 -> V_68 . V_85 * 16 ) ) ) ) {
V_338 |= V_288 ;
F_272 ( V_2 , V_2 -> V_68 . V_85 * 8 ) ;
} else {
F_272 ( V_2 , V_2 -> V_68 . V_85 * 16 ) ;
}
F_100 ( V_2 , V_409 , V_338 ) ;
F_182 ( V_2 , V_320 | V_331 ) ;
if ( V_2 -> V_68 . V_135 )
F_271 ( V_2 ) ;
}
...
V_338 |= V_316 + V_523 ;
break;
case V_280 : V_338 |= V_515 + V_523 ; break;
case V_281 : V_338 |= V_316 ; break;
case V_279 : V_338 |= V_523 ; break;
}
if ( V_2 -> V_412 & V_413 )
V_338 |= V_414 ;
switch( V_2 -> V_68 . V_136 )
{
case V_524 : V_338 |= V_315 ; break;
case V_525 : V_338 |= V_526 ; break;
case V_527 : V_338 |= V_526 + V_315 ; break;
case V_187 : V_338 |= V_528 ; break;
case V_189 : V_338 |= V_528 + V_315 ; break;
case V_191 : V_338 |= V_528 + V_526 ; break;
case V_529 : V_338 |= V_528 + V_526 + V_315 ; break;
}
switch ( V_2 -> V_68 . V_139 & V_530 )
{
case V_195 : V_338 |= V_519 ; break;
case V_197 : V_338 |= V_519 + V_354 ; break;
}
if ( V_2 -> V_68 . V_141 != V_531 )
V_338 |= V_177 ;
switch ( V_2 -> V_68 . V_140 )
{
case V_532 : V_338 |= V_333 ; break;
case V_533 : V_338 |= V_334 ; break;
case V_534 : V_338 |= V_333 + V_334 ; break;
}
if ( V_2 -> V_68 . V_22 & V_520 )
V_338 |= V_267 ;
F_100 ( V_2 , V_176 , V_338 ) ;
...
{
case V_535 : V_338 = 0x7e ; break;
case V_536 : V_338 = 0xff ; break;
case V_537 : V_338 = 0x00 ; break;
case V_538 : V_338 = 0x55 ; break;
case V_539 : V_338 = 0xaa ; break;
default: V_338 = 0x7e ; break;
}
F_264 ( V_2 , V_540 , ( unsigned char ) V_338 ) ;
V_338 = 0 ;
switch( V_2 -> V_68 . V_69 ) {
case V_282 :
V_338 |= V_316 + V_523 ;
...
if ( V_2 -> V_68 . V_137 )
V_338 |= V_266 + V_267 ;
F_264 ( V_2 , V_511 , ( unsigned char ) V_338 ) ;
...
F_100 ( V_2 , V_389 , ( unsigned short ) ( F_99 ( V_2 , V_389 ) | V_338 ) ) ;
F_272 ( V_2 , V_2 -> V_68 . V_137 * 16 ) ;
}
else
F_272 ( V_2 , V_2 -> V_68 . V_137 ) ;
F_190 ( V_2 ) ;
F_198 ( V_2 ) ;
F_100 ( V_2 , V_409 , V_316 + V_515 + V_267 ) ;
if ( V_2 -> V_68 . V_135 )
F_271 ( V_2 ) ;
}
...
V_541 = F_99 ( V_2 , V_176 ) ;
if ( V_2 -> V_385 & V_542 ) {
V_541 = ( V_541 & ~ ( V_177 + V_333 ) ) | V_334 ;
F_264 ( V_2 , V_540 , ( unsigned char ) ( ( V_2 -> V_385 >> 8 ) & 0xff ) ) ;
} else if ( ! ( V_541 & V_177 ) ) {
V_541 &= ~ ( V_333 + V_334 ) ;
}
F_100 ( V_2 , V_176 , V_541 ) ;
if ( V_2 -> V_385 & ( V_543 | V_542 ) ) {
V_338 = ( unsigned char ) ( V_2 -> V_385 & 0xff ) ;
} else {
switch( V_2 -> V_385 )
{
case V_480 : V_338 = 0x7e ; break;
case V_544 :
case V_545 : V_338 = 0xaa ; break;
case V_546 :
case V_547 : V_338 = 0x00 ; break;
default: V_338 = 0xff ;
}
}
F_264 ( V_2 , V_548 , V_338 ) ;
}
...
if ( V_2 -> V_412 & V_555 )
V_338 |= V_267 ;
F_264 ( V_2 , V_556 , V_338 ) ;
}
static void F_33 ( struct V_1 * V_2 )
{
unsigned char V_338 = F_261 ( V_2 , V_556 ) ;
if ( V_2 -> V_62 & V_64 )
V_338 |= V_288 ;
else
V_338 &= ~ V_288 ;
...
static void F_140 ( struct V_1 * V_2 , unsigned int V_6 , unsigned int V_557 )
{
int V_558 = 0 ;
while( ! V_558 ) {
V_2 -> V_15 [ V_6 ] . V_12 = 0 ;
F_159 ( V_2 -> V_15 [ V_6 ] , V_2 -> V_314 ) ;
if ( V_6 == V_557 )
V_558 = 1 ;
if ( ++ V_6 == V_2 -> V_14 )
V_6 = 0 ;
...
switch ( V_2 -> V_68 . V_139 & V_530 ) {
case V_195 : V_561 = 2 ; break;
case V_197 : V_561 = 4 ; break;
}
V_562:
V_559 = 0 ;
V_560 = 0xff ;
...
goto V_44;
if ( V_559 == 0 && V_2 -> V_68 . V_138 != 0xff )
V_560 = V_2 -> V_15 [ V_259 ] . V_73 [ 0 ] ;
V_559 += F_136 ( V_2 -> V_15 [ V_259 ] ) ;
if ( F_275 ( V_2 -> V_15 [ V_259 ] ) )
break;
if ( ++ V_259 == V_2 -> V_14 )
V_259 = 0 ;
if ( V_259 == V_2 -> V_13 ) {
...
V_12 = F_276 ( V_2 -> V_15 [ V_259 ] ) ;
if ( ( V_2 -> V_68 . V_139 & V_530 ) == V_193 )
V_12 &= ~ V_266 ;
if ( V_559 == 0 ||
( V_560 != 0xff && V_560 != V_2 -> V_68 . V_138 ) ) {
F_140 ( V_2 , V_258 , V_259 ) ;
goto V_562;
}
if ( V_559 < ( 2 + V_561 ) || V_12 & V_267 ) {
V_2 -> V_117 . V_164 ++ ;
V_559 = 0 ;
} else if ( V_12 & V_266 ) {
V_2 -> V_117 . V_167 ++ ;
if ( ! ( V_2 -> V_68 . V_139 & V_563 ) )
V_559 = 0 ;
}
#if V_303
if ( V_559 == 0 ) {
V_2 -> V_238 -> V_202 . V_564 ++ ;
V_2 -> V_238 -> V_202 . V_565 ++ ;
}
#endif
F_145 ( ( L_164 ,
V_2 -> V_8 , V_12 , V_559 ) ) ;
F_138 ( V_2 , V_2 -> V_15 [ V_258 ] . V_73 , F_45 ( int , V_559 , V_2 -> V_314 ) , L_94 ) ;
if ( V_559 ) {
if ( ! ( V_2 -> V_68 . V_139 & V_563 ) ) {
V_559 -= V_561 ;
V_561 = 0 ;
}
if ( V_559 > V_2 -> V_77 + V_561 )
V_2 -> V_117 . V_165 ++ ;
else {
int V_566 = V_559 ;
int V_6 = V_258 ;
unsigned char * V_260 = V_2 -> V_448 ;
V_2 -> V_567 = V_559 ;
V_2 -> V_117 . V_161 ++ ;
while( V_566 ) {
int V_568 = F_45 ( int , V_566 , V_2 -> V_314 ) ;
memcpy ( V_260 , V_2 -> V_15 [ V_6 ] . V_73 , V_568 ) ;
V_260 += V_568 ;
V_566 -= V_568 ;
if ( ++ V_6 == V_2 -> V_14 )
V_6 = 0 ;
...
if ( V_2 -> V_68 . V_139 & V_563 ) {
* V_260 = ( V_12 & V_266 ) ? V_569 : V_570 ;
V_559 ++ ;
}
#if V_303
if ( V_2 -> V_49 )
F_122 ( V_2 , V_2 -> V_448 , V_559 ) ;
else
#endif
F_8 ( V_21 , V_2 -> V_448 , V_2 -> V_449 , V_559 ) ;
}
}
F_140 ( V_2 , V_258 , V_259 ) ;
return true ;
...
unsigned int V_6 ;
struct V_261 * V_575 ;
if ( F_279 ( V_209 , V_387 ) > F_278 ( V_2 ) )
return false ;
...
V_2 -> V_9 = V_6 ;
V_575 = & V_2 -> V_11 [ V_2 -> V_336 ] ;
F_159 ( * V_575 , V_575 -> V_574 ) ;
if ( ! V_2 -> V_86 )
F_44 ( V_2 ) ;
F_36 ( V_2 ) ;
return true ;
...
static unsigned int V_4 = F_282 ( V_576 ) ;
unsigned int V_6 ;
int V_148 = 0 ;
for ( V_6 = 0 ; V_6 < V_4 ; V_6 ++ ) {
F_100 ( V_2 , V_548 , V_576 [ V_6 ] ) ;
F_100 ( V_2 , V_514 , V_576 [ ( V_6 + 1 ) % V_4 ] ) ;
if ( ( F_99 ( V_2 , V_548 ) != V_576 [ V_6 ] ) ||
( F_99 ( V_2 , V_514 ) != V_576 [ ( V_6 + 1 ) % V_4 ] ) ) {
V_148 = - V_33 ;
break;
}
}
V_2 -> V_357 = ( F_165 ( V_2 , V_522 ) & V_333 ) ? 1 : 0 ;
...
if ( ! ( * ( V_582 + 1 ) & ( V_519 + V_354 ) ) ) {
* V_583 = * V_582 ;
V_583 ++ ;
V_2 -> V_567 ++ ;
}
}
F_138 ( V_2 , V_2 -> V_448 , V_2 -> V_567 , L_94 ) ;
return 1 ;
}
return 0 ;
}
...
if ( ! V_148 && ( V_2 -> V_567 != V_4 ||
memcmp ( V_73 , V_2 -> V_448 , V_4 ) ) ) {
V_148 = - V_33 ;
}
F_17 ( & V_2 -> V_54 , V_22 ) ;
F_274 ( V_2 ) ;
...
static void V_481 ( unsigned long V_585 )
{
...
static void V_482 ( unsigned long V_585 )
{
struct V_1 * V_2 = (struct V_1 * ) V_585 ;
unsigned long V_22 ;
F_13 ( ( L_172 , V_2 -> V_8 ) ) ;
