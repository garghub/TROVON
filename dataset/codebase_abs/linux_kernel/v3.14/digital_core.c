...
V_16 = F_30 ( V_3 , V_96 , V_71 ) ;
if ( V_16 )
return V_16 ;
V_69 -> V_97 = ( 1 << V_70 ) ;
V_16 = F_39 ( V_3 -> V_98 , V_69 , 1 ) ;
if ( V_16 )
return V_16 ;
V_3 -> V_99 = 0 ;
return 0 ;
...
V_103 = & V_3 -> V_72 [ V_3 -> V_73 ] ;
F_16 ( & V_3 -> V_100 ) ;
V_16 = V_103 -> V_104 ( V_3 , V_103 -> V_55 ) ;
if ( V_16 )
F_40 ( V_3 ) ;
}
...
if ( V_3 -> V_99 >= V_105 )
return;
V_103 = & V_3 -> V_72 [ V_3 -> V_99 ++ ] ;
V_103 -> V_55 = V_55 ;
V_103 -> V_104 = V_104 ;
}
static int F_43 ( struct V_98 * V_98 , T_6 V_106 ,
T_6 V_107 )
{
struct V_2 * V_3 = F_44 ( V_98 ) ;
T_7 V_108 , V_109 ;
F_37 ( L_9 , V_106 ,
V_107 , V_3 -> V_110 ) ;
V_108 = V_3 -> V_110 & V_106 ;
V_109 = V_3 -> V_110 & V_107 ;
if ( ! V_108 && ! V_109 ) {
F_24 ( L_10 ) ;
return - V_90 ;
}
...
static void F_45 ( struct V_98 * V_98 )
{
struct V_2 * V_3 = F_44 ( V_98 ) ;
F_14 ( & V_3 -> V_100 ) ;
if ( ! V_3 -> V_99 ) {
...
static int F_49 ( struct V_98 * V_98 ,
struct V_68 * V_69 ,
T_8 V_122 , T_8 * V_123 , T_9 V_124 )
{
struct V_2 * V_3 = F_44 ( V_98 ) ;
int V_16 ;
V_16 = F_50 ( V_3 , V_69 , V_122 , V_123 , V_124 ) ;
if ( ! V_16 )
V_3 -> V_112 = V_86 ;
return V_16 ;
}
static int F_51 ( struct V_98 * V_98 )
{
struct V_2 * V_3 = F_44 ( V_98 ) ;
V_3 -> V_112 = 0 ;
return 0 ;
}
static int F_52 ( struct V_98 * V_98 ,
...
static void F_53 ( struct V_98 * V_98 ,
struct V_68 * V_69 )
{
struct V_2 * V_3 = F_44 ( V_98 ) ;
if ( ! V_3 -> V_112 ) {
...
static int F_54 ( struct V_98 * V_125 , struct V_1 * V_5 )
{
...
static int F_59 ( struct V_98 * V_98 , struct V_68 * V_69 ,
