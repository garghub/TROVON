...
struct V_69 V_70 ;
unsigned long V_55 ;
F_34 ( & V_70 , & V_67 -> V_71 , sizeof( struct V_72 ) ) ;
F_20 ( & V_10 -> V_73 . V_58 , V_55 ) ;
V_68 = F_35 ( V_10 -> V_73 . V_57 , & V_70 , 1 , V_67 ,
V_74 ) ;
if ( ! V_68 )
F_36 ( V_10 -> V_73 . V_57 ) ;
F_26 ( & V_10 -> V_73 . V_58 , V_55 ) ;
return V_68 ;
}
...
switch ( V_71 -> V_84 ) {
case V_85 :
F_41 ( V_81 , 0 , V_82 , V_83 ) ;
break;
case V_86 :
V_80 = F_42 ( V_81 , 0 , V_82 , V_83 ) ;
if ( V_80 ) {
F_43 ( V_80 ) ;
F_44 ( V_80 ) ;
} else {
...
static void F_49 ( struct V_90 * V_78 )
{
struct V_66 * V_67 =
F_50 ( V_78 , struct V_66 , V_78 ) ;
...
static void F_52 ( struct V_9 * V_10 , void * V_11 )
{
...
F_34 ( & V_99 , & V_13 -> V_99 , V_95 ) ;
V_98 [ V_103 ++ ] = & V_99 ;
if ( V_101 )
V_98 [ V_103 ++ ] = V_101 -> V_110 ;
F_34 ( & V_15 , & V_13 -> V_15 , V_96 ) ;
V_98 [ V_103 + V_104 ++ ] = & V_15 ;
if ( V_102 )
V_98 [ V_103 + V_104 ++ ] = V_102 -> V_110 ;
return F_57 ( V_57 , V_98 , V_103 , V_104 , V_13 , V_97 ) ;
}
static int F_58 ( struct V_52 * V_57 ,
struct V_12 * V_13 ,
T_3 V_95 , T_3 V_96 , T_4 V_97 )
{
unsigned long V_55 ;
...
bool V_111 = false ;
F_20 ( & V_57 -> V_58 , V_55 ) ;
V_68 = F_56 ( V_57 -> V_57 , V_13 , V_95 , V_96 , V_97 ) ;
if ( ! V_68 )
V_111 = F_59 ( V_57 -> V_57 ) ;
F_26 ( & V_57 -> V_58 , V_55 ) ;
if ( V_111 )
F_60 ( V_57 -> V_57 ) ;
return V_68 ;
...
int V_112 ;
struct V_1 * V_81 = F_1 ( V_10 -> V_3 ) ;
F_62 ( F_63 ( V_6 ) > V_81 -> V_113 ) ;
F_62 ( V_6 -> V_105 == V_114 ) ;
F_10 ( & V_6 -> V_18 -> V_20 ,
L_6 , V_6 , V_6 -> V_115 [ 0 ] ) ;
V_112 = V_116 ;
V_13 = F_64 ( V_49 , V_74 ) ;
...
static int F_65 ( struct V_1 * V_59 ,
struct V_5 * V_6 )
{
struct V_9 * V_10 = F_28 ( V_59 ) ;
struct V_16 * V_17 =
F_9 ( V_6 -> V_18 ) -> V_19 ;
F_66 ( & V_17 -> V_51 ) ;
return F_61 ( V_10 , & V_10 -> V_63 [ 0 ] , V_6 ) ;
}
static struct V_52 * F_67 ( struct V_9 * V_10 ,
struct V_16 * V_17 )
{
struct V_52 * V_57 ;
unsigned long V_55 ;
...
V_127 = F_70 () ;
while ( F_23 ( V_127 >= V_10 -> V_129 ) )
V_127 -= V_10 -> V_129 ;
V_17 -> V_62 = V_57 = & V_10 -> V_63 [ V_127 ] ;
}
F_26 ( & V_17 -> V_128 , V_55 ) ;
return V_57 ;
}
static int F_71 ( struct V_1 * V_59 ,
struct V_5 * V_6 )
{
struct V_9 * V_10 = F_28 ( V_59 ) ;
struct V_16 * V_17 =
F_9 ( V_6 -> V_18 ) -> V_19 ;
struct V_52 * V_62 = F_67 ( V_10 , V_17 ) ;
return F_61 ( V_10 , V_62 , V_6 ) ;
}
static int F_72 ( struct V_9 * V_10 , struct V_12 * V_13 )
{
F_73 ( V_64 ) ;
int V_112 = V_130 ;
V_13 -> V_64 = & V_64 ;
if ( F_58 ( & V_10 -> V_65 , V_13 ,
...
{
struct V_9 * V_10 = F_28 ( V_6 -> V_18 -> V_135 ) ;
struct V_12 * V_13 ;
F_76 ( V_136 , V_6 -> V_18 , L_7 ) ;
V_13 = F_64 ( V_49 , V_132 ) ;
if ( ! V_13 )
return V_130 ;
memset ( V_13 , 0 , sizeof( * V_13 ) ) ;
V_13 -> V_6 = V_6 ;
...
static int F_78 ( struct F_9 * V_142 )
{
struct V_16 * V_17 =
F_79 ( sizeof( * V_17 ) , V_143 ) ;
if ( ! V_17 )
return - V_144 ;
F_80 ( & V_17 -> V_128 ) ;
F_81 ( & V_17 -> V_51 , 0 ) ;
...
static void F_82 ( struct F_9 * V_142 )
{
struct V_16 * V_17 = V_142 -> V_19 ;
F_83 ( V_17 ) ;
}
static void F_84 ( struct V_9 * V_10 , bool V_145 )
{
int V_75 ;
int V_146 ;
if ( ( V_10 -> V_129 == 1 ||
V_10 -> V_129 != F_85 () ) && V_145 ) {
if ( V_10 -> V_147 )
V_145 = false ;
else
return;
...
V_75 = 0 ;
F_86 (cpu) {
F_87 ( V_10 -> V_63 [ V_75 ] . V_57 , V_146 ) ;
V_75 ++ ;
}
V_10 -> V_147 = true ;
} else {
for ( V_75 = 0 ; V_75 < V_10 -> V_129 ; V_75 ++ )
F_87 ( V_10 -> V_63 [ V_75 ] . V_57 , - 1 ) ;
V_10 -> V_147 = false ;
}
}
static void F_88 ( struct V_9 * V_10 , bool V_145 )
{
F_89 () ;
F_84 ( V_10 , V_145 ) ;
F_90 () ;
...
{
struct V_9 * V_10 = F_50 ( V_149 , struct V_9 , V_152 ) ;
switch( V_150 ) {
case V_153 :
case V_154 :
case V_155 :
...
V_164 = F_79 ( V_161 * sizeof( struct V_56 * ) , V_143 ) ;
V_162 = F_79 ( V_161 * sizeof( T_5 * ) , V_143 ) ;
V_163 = F_79 ( V_161 * sizeof( char * ) , V_143 ) ;
...
if ( V_68 )
goto V_101;
F_92 ( & V_10 -> V_65 , V_164 [ 0 ] ) ;
F_92 ( & V_10 -> V_73 , V_164 [ 1 ] ) ;
for ( V_75 = V_61 ; V_75 < V_161 ; V_75 ++ )
F_92 ( & V_10 -> V_63 [ V_75 - V_61 ] ,
V_164 [ V_75 ] ) ;
F_88 ( V_10 , true ) ;
F_96 ( V_3 , V_166 , V_125 ) ;
F_96 ( V_3 , V_167 , V_45 ) ;
if ( F_97 ( V_3 , V_168 ) )
F_37 ( V_10 ) ;
V_68 = 0 ;
...
T_1 V_129 ;
struct V_172 * V_173 ;
V_129 = F_99 ( V_3 , V_129 ) ? : 1 ;
V_170 = F_99 ( V_3 , V_174 ) + 1 ;
if ( V_129 == 1 )
V_173 = & V_175 ;
else
V_173 = & V_176 ;
...
if ( V_68 )
goto V_178;
V_10 -> V_152 . V_179 = & F_91 ;
V_68 = F_101 ( & V_10 -> V_152 ) ;
if ( V_68 ) {
F_45 ( L_12 ) ;
goto V_180;
}
V_171 = F_99 ( V_3 , V_171 ) ? : 1 ;
V_81 -> V_171 = F_14 ( T_1 , V_171 , V_81 -> V_181 ) ;
V_81 -> V_182 = F_99 ( V_3 , V_182 ) ? : 0xFFFF ;
V_81 -> V_183 = F_99 ( V_3 , V_183 ) + 1 + 0x4000 ;
V_81 -> V_184 = V_170 ;
V_81 -> V_185 = 0 ;
V_81 -> V_186 = V_125 ;
V_68 = F_102 ( V_81 , & V_3 -> V_187 ) ;
if ( V_68 )
goto V_180;
return 0 ;
V_180:
