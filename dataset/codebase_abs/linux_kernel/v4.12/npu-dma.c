...
{
struct V_86 * V_86 =
F_65 ( V_103 , struct V_86 , V_103 ) ;
V_86 -> V_90 -> V_91 . V_86 = NULL ;
F_66 ( & V_86 -> V_95 ,
V_86 -> V_90 ) ;
F_67 ( V_86 ) ;
}
void F_68 ( struct V_86 * V_86 ,
struct V_1 * V_6 )
{
struct V_26 * V_89 ;
struct V_70 * V_70 ;
...
if ( F_4 ( F_70 ( V_104 , L_13 ,
& V_105 ) ) )
return;
V_86 -> V_5 [ V_70 -> V_9 ] [ V_105 ] = NULL ;
F_71 ( V_89 -> V_51 , V_86 -> V_90 -> V_91 . V_92 ,
F_72 ( V_6 -> V_36 -> V_107 , V_6 -> V_108 ) ) ;
F_73 ( & V_86 -> V_103 , F_64 ) ;
}
int F_74 ( struct V_86 * V_91 , T_10 * V_109 ,
...
V_43 = F_76 ( NULL , V_90 , V_109 [ V_65 ] , 1 ,
V_113 ? V_117 : 0 ,
V_16 , NULL , NULL ) ;
if ( V_43 != 1 ) {
V_110 [ V_65 ] = V_43 ;
...
for ( V_65 = 0 ; ! F_82 ( V_27 -> V_29 -> V_3 , L_15 ,
V_65 , & V_119 ) ; V_65 ++ )
V_27 -> V_70 . V_78 [ V_65 ] = F_83 ( V_119 , 32 ) ;
F_84 ( L_16 , V_27 -> V_51 , V_65 ) ;
V_27 -> V_70 . V_71 = V_65 ;
V_27 -> V_70 . V_72 = 0 ;
V_120 ++ ;
if ( F_4 ( V_120 >= V_83 ) )
