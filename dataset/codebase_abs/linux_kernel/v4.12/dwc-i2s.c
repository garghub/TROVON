...
T_2 V_92 = F_59 ( V_87 ) ;
int V_48 ;
if ( F_51 ( V_92 >= F_52 ( V_105 ) ) )
return - V_38 ;
V_48 = F_46 ( V_5 , V_85 , V_104 -> V_106 ) ;
if ( V_48 < 0 )
return V_48 ;
...
struct V_84 * V_85 ;
const char * V_127 ;
V_5 = F_62 ( & V_125 -> V_5 , sizeof( * V_5 ) , V_128 ) ;
if ( ! V_5 ) {
F_63 ( & V_125 -> V_5 , L_12 ) ;
return - V_129 ;
}
V_85 = F_62 ( & V_125 -> V_5 , sizeof( * V_85 ) , V_128 ) ;
if ( ! V_85 )
return - V_129 ;
V_85 -> V_130 = & V_131 ;
V_85 -> V_132 = F_44 ;
V_85 -> V_133 = F_45 ;
V_102 = F_64 ( V_125 , V_134 , 0 ) ;
V_5 -> V_9 = F_65 ( & V_125 -> V_5 , V_102 ) ;
if ( F_66 ( V_5 -> V_9 ) )
return F_67 ( V_5 -> V_9 ) ;
V_5 -> V_5 = & V_125 -> V_5 ;
V_11 = F_68 ( V_125 , 0 ) ;
if ( V_11 >= 0 ) {
V_48 = F_69 ( & V_125 -> V_5 , V_11 , F_14 , 0 ,
V_125 -> V_135 , V_5 ) ;
if ( V_48 < 0 ) {
F_18 ( & V_125 -> V_5 , L_13 ) ;
return V_48 ;
...
V_48 = F_58 ( V_5 , V_85 , V_102 , V_104 ) ;
} else {
V_127 = L_14 ;
V_48 = F_60 ( V_5 , V_85 , V_102 ) ;
}
if ( V_48 < 0 )
return V_48 ;
if ( V_5 -> V_36 & V_60 ) {
