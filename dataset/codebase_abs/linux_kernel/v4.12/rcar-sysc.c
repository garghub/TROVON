...
V_12 = V_74 ;
V_69 = F_24 ( sizeof( * V_69 ) , V_83 ) ;
if ( ! V_69 ) {
error = - V_81 ;
goto V_82;
}
V_69 -> V_84 . V_69 = V_69 -> V_69 ;
V_69 -> V_84 . V_85 = F_25 ( V_69 -> V_69 ) ;
for ( V_75 = 0 , V_72 = 0 ; V_75 < V_65 -> V_86 ; V_75 ++ )
V_72 |= F_3 ( V_65 -> V_87 [ V_75 ] . V_19 ) ;
V_73 = F_2 ( V_74 + V_88 ) ;
V_73 |= V_72 ;
F_9 ( L_14 , V_71 -> V_80 , V_73 ) ;
F_5 ( V_73 , V_74 + V_88 ) ;
F_9 ( L_15 , V_71 -> V_80 , V_72 ) ;
F_5 ( V_72 , V_74 + V_89 ) ;
for ( V_75 = 0 ; V_75 < V_65 -> V_86 ; V_75 ++ ) {
const struct V_90 * V_91 = & V_65 -> V_87 [ V_75 ] ;
struct V_36 * V_40 ;
if ( ! V_91 -> V_42 ) {
continue;
}
V_40 = F_24 ( sizeof( * V_40 ) + strlen ( V_91 -> V_42 ) + 1 , V_83 ) ;
if ( ! V_40 ) {
error = - V_81 ;
goto V_82;
}
strcpy ( V_40 -> V_42 , V_91 -> V_42 ) ;
V_40 -> V_39 . V_42 = V_40 -> V_42 ;
V_40 -> V_46 . V_17 = V_91 -> V_17 ;
V_40 -> V_46 . V_16 = V_91 -> V_16 ;
V_40 -> V_46 . V_19 = V_91 -> V_19 ;
V_40 -> V_22 = V_91 -> V_22 ;
F_17 ( V_40 ) ;
if ( V_91 -> V_92 >= 0 )
F_26 ( V_69 -> V_69 [ V_91 -> V_92 ] ,
& V_40 -> V_39 ) ;
V_69 -> V_69 [ V_91 -> V_19 ] = & V_40 -> V_39 ;
}
error = F_27 ( V_71 , & V_69 -> V_84 ) ;
V_82:
F_28 ( V_71 ) ;
return error ;
}
void T_1 F_29 ( struct V_90 * V_87 ,
unsigned int V_86 , T_4 V_93 )
{
unsigned int V_75 ;
for ( V_75 = 0 ; V_75 < V_86 ; V_75 ++ )
if ( V_87 [ V_75 ] . V_19 == V_93 ) {
V_87 [ V_75 ] . V_42 = NULL ;
return;
}
}
void T_1 F_30 ( T_5 V_74 , T_2 V_72 )
{
T_2 V_73 ;
if ( ! F_19 () )
return;
