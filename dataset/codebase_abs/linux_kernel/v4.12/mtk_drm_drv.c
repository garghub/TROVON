...
struct V_75 * V_76 ;
V_76 = F_49 ( V_28 , sizeof( * V_76 ) , V_60 ) ;
if ( ! V_76 ) {
V_19 = - V_61 ;
goto V_77;
}
V_19 = F_64 ( V_28 , V_57 , V_76 , V_68 , NULL ) ;
if ( V_19 )
goto V_77;
V_2 -> V_78 [ V_68 ] = V_76 ;
}
...
int V_19 ;
int V_11 ;
for ( V_11 = 0 ; V_11 < F_80 ( V_83 ) ; V_11 ++ ) {
V_19 = F_81 ( V_83 [ V_11 ] ) ;
if ( V_19 < 0 ) {
F_82 ( L_10 ,
V_83 [ V_11 ] -> V_84 . V_85 , V_19 ) ;
goto V_86;
}
}
return 0 ;
...
{
int V_11 ;
for ( V_11 = F_80 ( V_83 ) - 1 ; V_11 >= 0 ; V_11 -- )
F_83 ( V_83 [ V_11 ] ) ;
}
