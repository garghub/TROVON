...
break;
case V_269 :
F_72 ( V_204 , L_29 , V_175 -> V_270 . V_271 ,
V_175 -> V_270 . V_272 ) ;
break;
case V_229 :
F_78 ( V_175 , & V_204 ) ;
...
case V_273 :
F_72 ( V_204 , L_30 ) ;
F_76 ( V_204 , V_175 -> V_274 . V_44 ) ;
F_17 ( V_175 -> V_274 . V_44 ) ;
break;
}
F_77 ( V_204 ) ;
}
...
{
char * V_275 = V_184 + V_186 - 1 ;
while ( V_275 > V_184 && ! isprint ( * V_275 ) )
V_275 -- ;
V_186 = V_275 - V_184 + 1 ;
...
char * V_218 ;
char * V_277 = L_31 ;
int V_186 = strlen ( V_277 ) ;
struct V_203 * V_204 ;
V_204 = F_71 ( V_175 , V_37 , V_278 ) ;
if ( ! V_204 )
return;
F_72 ( V_204 , L_32 ) ;
if ( ! V_175 -> V_184 . V_185 ) {
V_218 = F_80 ( V_279 , V_37 ) ;
if ( ! V_218 )
goto V_228;
V_276 = F_94 ( V_51 , V_218 , V_279 ) ;
if ( V_276 == 0 ) {
F_17 ( V_218 ) ;
goto V_228;
}
V_276 = F_92 ( V_218 , V_276 ) ;
if ( V_276 == 0 ) {
F_17 ( V_218 ) ;
goto V_228;
}
V_175 -> V_184 . V_185 = V_218 ;
V_175 -> V_184 . V_186 = V_276 ;
}
V_277 = V_175 -> V_184 . V_185 ;
V_186 = V_175 -> V_184 . V_186 ;
V_228:
F_95 ( V_204 , V_277 , V_186 ) ;
F_77 ( V_204 ) ;
}
...
V_204 = F_71 ( V_175 , V_37 , V_280 ) ;
if ( ! V_204 )
return;
F_72 ( V_204 , L_33 ,
V_175 -> V_6 , V_175 -> V_5 ) ;
if ( V_175 -> V_116 != V_281 )
F_72 ( V_204 , L_34 , V_175 -> V_116 ) ;
if ( V_175 -> V_119 )
F_72 ( V_204 , L_35 ,
( V_175 -> V_119 == V_122 ) ? L_36 : L_37 ,
V_175 -> V_120 ) ;
F_72 ( V_204 ,
L_38 ,
V_175 -> V_16 [ 0 ] ,
...
switch ( V_193 -> type ) {
case V_282 : {
struct V_283 * V_284 = ( void * ) V_193 ;
F_72 ( V_204 , L_39 , V_284 -> V_285 ) ;
F_91 ( V_204 , L_40 , & V_284 -> V_286 . V_267 ) ;
F_91 ( V_204 , L_41 , & V_284 -> V_286 . V_266 ) ;
F_72 ( V_204 , L_42 , V_284 -> V_286 . V_287 ) ;
F_91 ( V_204 , L_43 , & V_284 -> V_288 . V_267 ) ;
F_91 ( V_204 , L_44 , & V_284 -> V_288 . V_266 ) ;
F_91 ( V_204 , L_45 , & V_284 -> V_288 . V_268 ) ;
F_91 ( V_204 , L_46 , & V_284 -> V_289 . V_267 ) ;
F_91 ( V_204 , L_47 , & V_284 -> V_289 . V_266 ) ;
F_91 ( V_204 , L_48 , & V_284 -> V_289 . V_268 ) ;
break; }
}
F_77 ( V_204 ) ;
}
...
F_89 ( V_175 , & V_230 ) ;
if ( V_175 -> V_290 [ 0 ] >= 0 ) {
V_204 = F_71 ( V_175 , V_37 , V_291 ) ;
if ( V_204 ) {
F_72 ( V_204 , L_49 ,
V_175 -> V_290 [ 0 ] , V_175 -> V_290 [ 1 ] ) ;
F_77 ( V_204 ) ;
}
}
if ( V_175 -> V_292 ) {
V_204 = F_71 ( V_175 , V_37 , V_293 ) ;
if ( V_204 ) {
F_72 ( V_204 , L_50 ) ;
...
struct V_294 * V_284 = ( void * ) V_193 ;
for ( V_90 = 0 ; V_90 < V_284 -> V_295 ; V_90 ++ )
if ( F_70 ( V_175 , V_284 -> V_296 [ V_90 ] ,
V_284 -> V_297 [ V_90 ] ,
V_284 -> V_298 [ V_90 ] ,
V_284 -> V_299 [ V_90 ] ,
V_284 -> V_300 [ V_90 ] ,
...
if ( V_175 -> V_296 &&
F_70 ( V_175 , V_175 -> V_296 ,
V_175 -> V_297 , V_175 -> V_298 ,
V_175 -> V_299 ,
V_175 -> V_300 , V_175 -> V_301 ) )
V_230 = 1 ;
if ( V_175 -> V_189 . V_190 && V_175 -> V_189 . V_191 ) {
V_204 = F_71 ( V_175 , V_37 , V_302 ) ;
if ( V_204 ) {
F_99 ( V_204 , L_51 , & V_175 -> V_189 ) ;
F_77 ( V_204 ) ;
}
}
V_90 = 0 ;
...
void F_103 ( int V_5 , unsigned long V_305 , unsigned long V_306 ,
...
V_175 -> V_25 = 0 ;
V_88 = F_49 ( V_51 , V_175 , & V_182 [ V_311 ] ) ;
}
if ( V_88 == V_162 )
return;
V_175 -> V_312 = 0 ;
...
void F_107 ( int V_313 , long V_120 )
{
struct V_50 * V_51 = V_94 ;
struct V_1 * V_175 ;
if ( V_313 )
...
static inline void F_108 ( const struct V_314 * V_314 )
{
#ifdef F_14
struct V_1 * V_175 ;
struct V_30 * V_31 ;
...
V_319 = F_112 ( & V_321 ) ;
for(; ; ) {
struct V_314 * V_314 = F_113 ( V_316 ) ;
if ( V_314 && F_2 ( V_314 -> V_315 ) ) {
struct V_28 * V_29 ;
V_29 = F_109 ( V_314 ) ;
if ( V_29 ) {
...
if ( F_2 ( F_114 ( & V_321 , V_319 ) || V_318 ) ) {
F_45 () ;
if ( ! V_318 ) {
F_13 ( V_175 , V_31 , V_39 ) ;
goto V_320;
...
V_323 -> V_22 = V_23 ;
V_323 -> type = type ;
F_116 ( & V_323 -> V_172 , & V_175 -> V_196 ) ;
V_175 -> V_188 ++ ;
return V_323 ;
}
struct V_327 *
F_117 ( const T_6 char * V_328 )
{
...
void F_118 ( struct V_327 * V_44 )
{
struct V_1 * V_175 = V_94 -> V_1 ;
struct V_20 * V_4 ;
if ( ! V_175 -> V_180 )
return;
V_4 = F_115 ( V_175 , V_330 ) ;
if ( ! V_4 )
return;
V_4 -> V_44 = V_44 ;
V_4 -> V_331 = V_332 ;
...
F_119 ( V_94 -> V_333 , & V_175 -> V_189 ) ;
}
void F_120 ( struct V_327 * V_44 , const struct V_190 * V_190 ,
unsigned int V_272 )
{
struct V_1 * V_175 = V_94 -> V_1 ;
struct V_314 * V_314 = F_113 ( V_190 ) ;
struct V_20 * V_4 ;
bool V_317 = V_272 & V_334 ;
if ( ! V_175 -> V_180 )
return;
if ( ! V_44 )
goto V_335;
...
V_228:
if ( V_317 ) {
V_4 -> V_331 = V_4 -> V_44 ? F_122 ( V_4 -> V_44 -> V_44 ) : V_332 ;
V_4 -> type = V_336 ;
if ( V_272 & V_340 )
V_4 -> V_303 = true ;
} else {
...
F_111 ( V_190 ) ;
F_123 ( V_4 , V_190 , V_314 ) ;
}
void F_124 ( const struct V_342 * V_342 )
{
F_120 ( NULL , V_342 -> V_343 . V_190 , 0 ) ;
}
void F_125 ( struct V_314 * V_317 ,
...
V_4 -> type != V_330 ) )
continue;
if ( V_4 -> V_22 == V_317 -> V_337 && V_4 -> V_125 == V_317 -> V_338 -> V_339 &&
! F_126 ( V_344 ,
...
if ( ! V_346 ) {
V_4 = F_115 ( V_175 , V_336 ) ;
if ( ! V_4 )
return;
F_123 ( V_4 , NULL , V_317 ) ;
}
if ( ! V_347 ) {
V_347 = F_115 ( V_175 , type ) ;
if ( ! V_347 )
return;
if ( V_346 ) {
...
if ( V_314 )
F_123 ( V_347 , V_190 , V_314 ) ;
else
V_347 -> V_22 = V_23 ;
}
int F_127 ( struct V_1 * V_2 ,
struct V_348 * V_349 , unsigned int * V_312 )
{
if ( ! V_2 -> V_180 )
return 0 ;
if ( ! V_2 -> V_312 )
V_2 -> V_312 = F_128 () ;
V_349 -> V_254 = V_2 -> ctime . V_254 ;
...
if ( ! F_131 ( V_352 ) )
return - V_351 ;
if ( F_130 ( V_353 ) && F_132 ( V_60 ) )
return - V_351 ;
return 0 ;
}
static void F_133 ( T_2 V_354 , T_2 V_355 ,
unsigned int V_356 , unsigned int V_93 ,
int V_47 )
{
struct V_203 * V_204 ;
T_7 V_43 , V_357 , V_60 ;
...
if ( ! V_309 )
return;
V_204 = F_71 ( NULL , V_37 , V_360 ) ;
if ( ! V_204 )
return;
V_43 = F_73 ( & V_206 , F_134 ( V_94 ) ) ;
V_357 = F_73 ( & V_206 , V_354 ) ;
V_60 = F_73 ( & V_206 , V_355 ) ,
V_359 = F_135 ( V_94 ) ;
F_72 ( V_204 , L_54 , F_28 ( V_94 ) , V_43 ) ;
F_136 ( V_204 ) ;
F_72 ( V_204 , L_55 ,
V_357 , V_60 , V_359 ? F_137 ( V_359 ) : L_56 ,
V_356 , V_93 , ! V_47 ) ;
F_138 ( V_359 ) ;
F_77 ( V_204 ) ;
}
int F_139 ( T_2 V_60 )
{
struct V_50 * V_361 = V_94 ;
unsigned int V_356 , V_93 = ( unsigned int ) - 1 ;
T_2 V_357 ;
int V_47 ;
V_357 = F_140 ( V_94 ) ;
V_356 = F_34 ( V_94 ) ;
...
V_361 -> V_60 = V_60 ;
V_228:
F_133 ( V_357 , V_60 , V_356 , V_93 , V_47 ) ;
return V_47 ;
}
...
const struct V_363 * V_253 )
{
struct V_1 * V_175 = V_94 -> V_1 ;
struct V_363 * V_31 = & V_175 -> V_249 . V_253 ;
if ( V_253 )
memcpy ( V_31 , V_253 , sizeof( struct V_363 ) ) ;
else
memset ( V_31 , 0 , sizeof( struct V_363 ) ) ;
V_175 -> V_249 . V_250 = V_250 ;
V_175 -> V_249 . V_251 = V_251 ;
V_175 -> V_249 . V_252 = V_252 ;
V_175 -> type = V_248 ;
}
void F_144 ( T_8 V_250 , const struct V_364 * V_365 )
{
struct V_1 * V_175 = V_94 -> V_1 ;
if ( V_365 )
V_175 -> V_257 . V_258 = V_365 -> V_258 ;
else
V_175 -> V_257 . V_258 = 0 ;
...
void F_146 ( struct V_366 * V_367 )
{
struct V_1 * V_175 = V_94 -> V_1 ;
V_175 -> V_149 . V_43 = V_367 -> V_43 ;
V_175 -> V_149 . V_49 = V_367 -> V_49 ;
V_175 -> V_149 . V_21 = V_367 -> V_21 ;
V_175 -> V_149 . V_234 = 0 ;
F_147 ( V_367 , & V_175 -> V_149 . V_147 ) ;
V_175 -> type = V_148 ;
}
...
void F_149 ( struct V_368 * V_369 )
{
struct V_1 * V_175 = V_94 -> V_1 ;
V_175 -> type = V_229 ;
V_175 -> V_223 . V_224 = V_369 -> V_224 ;
}
int F_150 ( int V_232 , unsigned long * args )
{
struct V_1 * V_175 = V_94 -> V_1 ;
if ( V_232 <= 0 || V_232 > V_370 || ! args )
return - V_371 ;
V_175 -> type = V_231 ;
...
void F_151 ( int V_372 , int V_373 )
{
struct V_1 * V_175 = V_94 -> V_1 ;
V_175 -> V_290 [ 0 ] = V_372 ;
V_175 -> V_290 [ 1 ] = V_373 ;
}
int F_152 ( int V_186 , void * V_374 )
{
struct V_1 * V_175 = V_94 -> V_1 ;
if ( ! V_175 -> V_200 ) {
void * V_31 = F_80 ( sizeof( struct V_375 ) , V_37 ) ;
if ( ! V_31 )
return - V_199 ;
V_175 -> V_200 = V_31 ;
}
V_175 -> V_292 = V_186 ;
memcpy ( V_175 -> V_200 , V_374 , V_186 ) ;
return 0 ;
}
void F_153 ( struct V_50 * V_349 )
{
struct V_1 * V_175 = V_94 -> V_1 ;
V_175 -> V_296 = F_28 ( V_349 ) ;
V_175 -> V_297 = F_140 ( V_349 ) ;
V_175 -> V_298 = F_134 ( V_349 ) ;
V_175 -> V_299 = F_34 ( V_349 ) ;
F_39 ( V_349 , & V_175 -> V_300 ) ;
memcpy ( V_175 -> V_301 , V_349 -> V_202 , V_376 ) ;
}
int F_154 ( int V_377 , struct V_50 * V_349 )
{
struct V_294 * V_378 ;
struct V_50 * V_51 = V_94 ;
struct V_1 * V_2 = V_51 -> V_1 ;
T_2 V_43 = F_155 () , V_379 = F_134 ( V_349 ) ;
if ( F_50 ( V_349 ) &&
( V_377 == V_380 || V_377 == V_381 ||
V_377 == V_382 || V_377 == V_383 ) ) {
V_384 = F_28 ( V_51 ) ;
if ( F_132 ( V_51 -> V_60 ) )
V_385 = V_51 -> V_60 ;
else
...
return 0 ;
if ( ! V_2 -> V_296 ) {
V_2 -> V_296 = F_28 ( V_349 ) ;
V_2 -> V_297 = F_140 ( V_349 ) ;
V_2 -> V_298 = V_379 ;
V_2 -> V_299 = F_34 ( V_349 ) ;
F_39 ( V_349 , & V_2 -> V_300 ) ;
memcpy ( V_2 -> V_301 , V_349 -> V_202 , V_376 ) ;
return 0 ;
}
V_378 = ( void * ) V_2 -> V_194 ;
if ( ! V_378 || V_378 -> V_295 == V_388 ) {
V_378 = F_12 ( sizeof( * V_378 ) , V_159 ) ;
if ( ! V_378 )
return - V_199 ;
V_378 -> V_316 . type = V_205 ;
V_378 -> V_316 . V_36 = V_2 -> V_194 ;
V_2 -> V_194 = ( void * ) V_378 ;
}
F_104 ( V_378 -> V_295 >= V_388 ) ;
V_378 -> V_296 [ V_378 -> V_295 ] = F_28 ( V_349 ) ;
V_378 -> V_297 [ V_378 -> V_295 ] = F_140 ( V_349 ) ;
V_378 -> V_298 [ V_378 -> V_295 ] = V_379 ;
V_378 -> V_299 [ V_378 -> V_295 ] = F_34 ( V_349 ) ;
F_39 ( V_349 , & V_378 -> V_300 [ V_378 -> V_295 ] ) ;
memcpy ( V_378 -> V_301 [ V_378 -> V_295 ] , V_349 -> V_202 , V_376 ) ;
V_378 -> V_295 ++ ;
return 0 ;
}
int F_157 ( struct V_368 * V_369 ,
const struct V_52 * V_389 , const struct V_52 * V_390 )
{
struct V_283 * V_391 ;
struct V_1 * V_175 = V_94 -> V_1 ;
struct V_392 V_393 ;
V_391 = F_80 ( sizeof( * V_391 ) , V_37 ) ;
if ( ! V_391 )
return - V_199 ;
V_391 -> V_316 . type = V_282 ;
V_391 -> V_316 . V_36 = V_175 -> V_193 ;
V_175 -> V_193 = ( void * ) V_391 ;
F_158 ( V_369 -> V_342 -> V_343 . V_190 , & V_393 ) ;
V_391 -> V_286 . V_267 = V_393 . V_267 ;
V_391 -> V_286 . V_266 = V_393 . V_266 ;
V_391 -> V_286 . V_287 = ! ! ( V_393 . V_394 & V_395 ) ;
V_391 -> V_285 = ( V_393 . V_394 & V_396 ) >> V_397 ;
V_391 -> V_288 . V_267 = V_390 -> V_398 ;
V_391 -> V_288 . V_266 = V_390 -> V_399 ;
V_391 -> V_288 . V_268 = V_390 -> V_400 ;
V_391 -> V_289 . V_267 = V_389 -> V_398 ;
V_391 -> V_289 . V_266 = V_389 -> V_399 ;
V_391 -> V_289 . V_268 = V_389 -> V_400 ;
return 0 ;
}
void F_159 ( const struct V_52 * V_389 , const struct V_52 * V_390 )
{
struct V_1 * V_175 = V_94 -> V_1 ;
V_175 -> V_264 . V_98 = F_28 ( V_94 ) ;
V_175 -> V_264 . V_265 . V_268 = V_389 -> V_400 ;
V_175 -> V_264 . V_265 . V_266 = V_389 -> V_400 ;
V_175 -> V_264 . V_265 . V_267 = V_389 -> V_398 ;
V_175 -> type = V_263 ;
}
void F_160 ( int V_271 , int V_272 )
{
struct V_1 * V_175 = V_94 -> V_1 ;
V_175 -> V_270 . V_271 = V_271 ;
V_175 -> V_270 . V_272 = V_272 ;
V_175 -> type = V_269 ;
}
void F_161 ( char * V_44 )
{
struct V_1 * V_175 = V_94 -> V_1 ;
V_175 -> V_274 . V_44 = F_80 ( strlen ( V_44 ) + 1 , V_37 ) ;
strcpy ( V_175 -> V_274 . V_44 , V_44 ) ;
V_175 -> type = V_273 ;
}
...
if ( V_401 == V_402 )
return;
V_204 = F_71 ( NULL , V_37 , V_403 ) ;
if ( F_2 ( ! V_204 ) )
return;
F_162 ( V_204 ) ;
F_72 ( V_204 , L_59 , V_401 ) ;
F_77 ( V_204 ) ;
}
void F_167 ( unsigned long V_404 , long V_401 , int V_405 )
{
struct V_203 * V_204 ;
V_204 = F_71 ( NULL , V_37 , V_406 ) ;
if ( F_2 ( ! V_204 ) )
return;
F_162 ( V_204 ) ;
F_72 ( V_204 , L_60 ,
V_401 , F_105 () , V_404 ,
F_168 () , F_169 ( V_94 ) , V_405 ) ;
F_77 ( V_204 ) ;
}
