...
#endif
V_162 = ( T_18 * ) ( V_164 + ( V_63 * V_157 -> V_161 ) ) ;
switch ( V_162 -> type ) {
case V_167 :
case V_168 :
case V_169 :
...
if ( V_150 > F_33 ( V_57 -> V_155 ) ) {
T_12 V_193 = V_150 - F_33 ( V_57 -> V_155 ) ;
...
static T_1 F_34 ( T_12 V_159 , struct V_39 * * V_149 ,
T_12 * V_153 )
{
T_1 V_8 ;
unsigned long V_28 ;
...
if ( V_159 > F_33 ( V_73 -> V_56 -> V_155 ) ) {
T_12 V_193 = V_159 -
F_33 ( V_73 -> V_56 -> V_155 ) ;
V_8 = F_34 ( V_193 , & V_73 -> V_149 ,
& V_73 -> V_153 ) ;
if ( V_8 != V_13 )
return V_8 ;
}
