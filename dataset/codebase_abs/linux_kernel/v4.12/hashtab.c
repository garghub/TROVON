...
static struct V_10 * F_83 ( struct V_1 * V_2 , void * V_14 ,
...
if ( F_84 ( & V_2 -> V_97 ) > V_2 -> V_3 . V_20 )
if ( ! V_101 ) {
F_78 ( & V_2 -> V_97 ) ;
return F_35 ( - V_57 ) ;
}
V_38 = F_85 ( V_2 -> V_18 , V_103 | V_33 ) ;
if ( ! V_38 )
return F_35 ( - V_28 ) ;
}
...
static int F_86 ( struct V_1 * V_2 , struct V_10 * V_104 ,
T_3 V_8 )
{
if ( V_104 && V_8 == V_105 )
return - V_106 ;
...
static int F_87 ( struct V_15 * V_3 , void * V_14 , void * V_98 ,
T_3 V_8 )
{
struct V_1 * V_2 = F_14 ( V_3 , struct V_1 , V_3 ) ;
struct V_10 * V_38 = NULL , * V_104 ;
struct V_72 * V_67 ;
unsigned long V_85 ;
struct V_62 * V_86 ;
T_1 V_12 , V_21 ;
...
V_67 = & V_86 -> V_67 ;
F_62 ( & V_86 -> V_68 , V_85 ) ;
V_104 = F_47 ( V_67 , V_21 , V_14 , V_12 ) ;
V_79 = F_86 ( V_2 , V_104 , V_8 ) ;
if ( V_79 )
goto V_27;
V_38 = F_83 ( V_2 , V_14 , V_98 , V_12 , V_21 , false , false ,
V_104 ) ;
if ( F_88 ( V_38 ) ) {
V_79 = F_89 ( V_38 ) ;
goto V_27;
...
static int F_91 ( struct V_15 * V_3 , void * V_14 , void * V_98 ,
T_3 V_8 )
{
struct V_1 * V_2 = F_14 ( V_3 , struct V_1 , V_3 ) ;
struct V_10 * V_38 , * V_104 = NULL ;
struct V_72 * V_67 ;
unsigned long V_85 ;
struct V_62 * V_86 ;
T_1 V_12 , V_21 ;
...
F_64 ( & V_86 -> V_68 , V_85 ) ;
if ( V_79 )
F_92 ( & V_2 -> V_24 , & V_38 -> V_25 ) ;
else if ( V_104 )
F_92 ( & V_2 -> V_24 , & V_104 -> V_25 ) ;
return V_79 ;
}
static int F_93 ( struct V_15 * V_3 , void * V_14 ,
void * V_98 , T_3 V_8 ,
bool V_99 )
{
struct V_1 * V_2 = F_14 ( V_3 , struct V_1 , V_3 ) ;
...
goto V_27;
if ( V_104 ) {
F_80 ( V_2 , F_5 ( V_104 , V_12 ) ,
V_98 , V_99 ) ;
} else {
V_38 = F_83 ( V_2 , V_14 , V_98 , V_12 ,
V_21 , true , V_99 , NULL ) ;
if ( F_88 ( V_38 ) ) {
V_79 = F_89 ( V_38 ) ;
goto V_27;
...
static int F_94 ( struct V_15 * V_3 , void * V_14 ,
void * V_98 , T_3 V_8 ,
bool V_99 )
{
struct V_1 * V_2 = F_14 ( V_3 , struct V_1 , V_3 ) ;
...
void * V_98 , T_3 V_8 )
{
return F_93 ( V_3 , V_14 , V_98 , V_8 , false ) ;
}
static int F_96 ( struct V_15 * V_3 , void * V_14 ,
void * V_98 , T_3 V_8 )
{
return F_94 ( V_3 , V_14 , V_98 , V_8 ,
false ) ;
}
...
struct V_73 * V_74 ;
struct V_10 * V_11 ;
F_100 (l, n, head, hash_node) {
F_63 ( & V_11 -> V_48 ) ;
F_70 ( V_2 , V_11 ) ;
}
}
}
static void F_101 ( struct V_15 * V_3 )
{
struct V_1 * V_2 = F_14 ( V_3 , struct V_1 , V_3 ) ;
F_102 () ;
F_103 () ;
...
static void * F_104 ( struct V_15 * V_3 , void * V_14 )
{
struct V_10 * V_11 = F_52 ( V_3 , V_14 ) ;
if ( V_11 )
...
static void * F_105 ( struct V_15 * V_3 , void * V_14 )
{
struct V_10 * V_11 = F_52 ( V_3 , V_14 ) ;
if ( V_11 ) {
F_61 ( & V_11 -> V_25 ) ;
...
int F_106 ( struct V_15 * V_3 , void * V_14 , void * V_98 )
{
struct V_1 * V_2 = F_14 ( V_3 , struct V_1 , V_3 ) ;
struct V_10 * V_11 ;
void T_2 * V_13 ;
...
int F_109 ( struct V_15 * V_3 , void * V_14 , void * V_98 ,
T_3 V_8 )
{
struct V_1 * V_2 = F_14 ( V_3 , struct V_1 , V_3 ) ;
int V_79 ;
F_107 () ;
if ( F_1 ( V_2 ) )
V_79 = F_94 ( V_3 , V_14 , V_98 ,
V_8 , true ) ;
else
V_79 = F_93 ( V_3 , V_14 , V_98 , V_8 ,
true ) ;
F_108 () ;
return V_79 ;
}
static struct V_15 * F_110 ( union V_42 * V_43 )
{
struct V_15 * V_3 ;
if ( V_43 -> V_31 != sizeof( T_1 ) )
return F_35 ( - V_53 ) ;
V_43 -> V_31 = sizeof( void * ) ;
V_3 = F_32 ( V_43 ) ;
V_43 -> V_31 = sizeof( T_1 ) ;
return V_3 ;
}
static void F_111 ( struct V_15 * V_3 )
{
struct V_1 * V_2 = F_14 ( V_3 , struct V_1 , V_3 ) ;
struct V_73 * V_74 ;
struct V_72 * V_67 ;
...
int F_112 ( struct V_15 * V_3 , struct V_109 * V_110 ,
void * V_14 , void * V_98 , T_3 V_8 )
{
void * V_96 ;
int V_79 ;
T_1 V_111 = * ( T_1 * ) V_98 ;
V_96 = V_3 -> V_94 -> V_112 ( V_3 , V_110 , V_111 ) ;
if ( F_88 ( V_96 ) )
return F_89 ( V_96 ) ;
V_79 = F_87 ( V_3 , V_14 , & V_96 , V_8 ) ;
if ( V_79 )
V_3 -> V_94 -> V_95 ( V_96 ) ;
return V_79 ;
}
static struct V_15 * F_113 ( union V_42 * V_43 )
{
struct V_15 * V_3 , * V_113 ;
V_113 = F_114 ( V_43 -> V_114 ) ;
if ( F_88 ( V_113 ) )
return V_113 ;
V_3 = F_110 ( V_43 ) ;
if ( F_88 ( V_3 ) ) {
...
static void * F_116 ( struct V_15 * V_3 , void * V_14 )
{
struct V_15 * * V_115 = F_55 ( V_3 , V_14 ) ;
if ( ! V_115 )
return NULL ;
return F_117 ( * V_115 ) ;
}
static void F_118 ( struct V_15 * V_3 )
{
F_115 ( V_3 -> V_113 ) ;
F_111 ( V_3 ) ;
}
