...
F_22 ( V_81 ) -> type = V_85 ;
V_81 -> V_86 = V_87 ;
F_23 ( V_4 -> V_82 , V_35 -> V_88 , V_81 , 0 ) ;
V_69 = F_24 ( V_81 ) -> V_89 ? - V_90 : 0 ;
F_25 ( V_81 ) ;
if ( V_4 -> V_7 & V_43 )
( void ) F_9 ( V_4 , 1 , & V_13 ) ;
return V_69 ;
}
static int F_26 ( T_1 * V_4 , int V_91 ,
struct V_92 * * V_93 )
{
struct V_34 * V_68 = V_4 -> V_36 ;
...
if ( ( V_4 -> V_7 & V_8 ) == 0 )
return - V_16 ;
V_94 = V_67 -> V_95 . V_96 - V_67 -> V_95 . V_97 + 1 ;
if ( V_67 -> V_95 . V_97 == V_98 )
V_94 = 0 ;
if ( V_91 == V_98 )
* V_93 = & V_67 -> V_93 [ V_94 ] ;
else if ( V_91 < V_67 -> V_95 . V_97 || V_91 > V_67 -> V_95 . V_96 )
return - V_16 ;
else
* V_93 = & V_67 -> V_93 [ V_91 - V_67 -> V_95 . V_97 ] ;
return 0 ;
}
static int F_27 ( T_1 * V_4 , void * V_99 )
{
struct V_100 * V_101 = V_99 ;
struct V_92 * V_102 , * V_103 ;
unsigned long V_104 , V_105 ;
int V_14 ;
struct V_12 V_13 ;
unsigned char V_39 [ V_40 ] ;
V_14 = F_26 ( V_4 , V_101 -> V_106 , & V_102 ) ;
if ( V_14 )
return V_14 ;
V_14 = F_26 ( V_4 , V_101 -> V_107 , & V_103 ) ;
if ( V_14 )
return V_14 ;
if ( V_101 -> V_107 != V_98 )
++ V_103 ;
V_104 = V_102 -> V_70 . V_71 ;
V_105 = V_103 -> V_70 . V_71 ;
if ( V_105 <= V_104 )
return - V_16 ;
memset ( V_39 , 0 , V_40 ) ;
V_39 [ 0 ] = V_108 ;
F_28 ( V_104 , & V_39 [ 3 ] , & V_39 [ 4 ] , & V_39 [ 5 ] ) ;
F_28 ( V_105 - 1 , & V_39 [ 6 ] , & V_39 [ 7 ] , & V_39 [ 8 ] ) ;
return F_8 ( V_4 , V_39 , 0 , NULL , NULL , & V_13 , 0 , 0 ) ;
}
static int F_29 ( T_1 * V_4 , void * V_99 )
{
struct V_34 * V_35 = V_4 -> V_36 ;
struct V_109 * V_110 = V_99 ;
struct V_66 * V_67 ;
int V_14 ;
V_14 = F_17 ( V_4 , NULL ) ;
if ( V_14 )
return V_14 ;
V_67 = V_35 -> V_67 ;
V_110 -> V_111 = V_67 -> V_95 . V_97 ;
V_110 -> V_112 = V_67 -> V_95 . V_96 ;
return 0 ;
}
static int F_30 ( T_1 * V_4 , void * V_99 )
{
struct V_113 * V_114 = V_99 ;
struct V_92 * V_115 ;
int V_14 ;
V_14 = F_26 ( V_4 , V_114 -> V_116 , & V_115 ) ;
if ( V_14 )
return V_14 ;
V_114 -> V_117 = V_115 -> V_118 ;
V_114 -> V_119 = V_115 -> V_120 ;
if ( V_114 -> V_121 == V_122 ) {
F_28 ( V_115 -> V_70 . V_71 ,
& V_114 -> V_123 . V_124 . V_125 ,
& V_114 -> V_123 . V_124 . V_126 ,
& V_114 -> V_123 . V_124 . V_127 ) ;
} else
V_114 -> V_123 . V_71 = V_115 -> V_70 . V_71 ;
return 0 ;
}
int F_31 ( struct V_1 * V_2 ,
unsigned int V_39 , void * V_99 )
{
T_1 * V_4 = V_2 -> V_5 ;
switch ( V_39 ) {
case V_128 :
return F_27 ( V_4 , V_99 ) ;
case V_129 :
return F_29 ( V_4 , V_99 ) ;
case V_130 :
return F_30 ( V_4 , V_99 ) ;
default:
return - V_16 ;
}
}
...
T_1 * V_4 = V_2 -> V_5 ;
T_3 V_133 = 0 ;
unsigned V_77 = V_132 -> V_134 ;
if ( V_132 -> V_135 <= 0 )
V_132 -> V_135 = V_136 ;
if ( V_132 -> V_13 )
memset ( V_132 -> V_13 , 0 , sizeof( struct V_12 ) ) ;
if ( V_132 -> V_137 )
V_133 |= V_87 ;
V_132 -> V_14 = F_8 ( V_4 , V_132 -> V_39 ,
V_132 -> V_138 == V_139 ,
V_132 -> V_140 , & V_77 ,
V_132 -> V_13 , V_132 -> V_135 , V_133 ) ;
if ( ! V_132 -> V_14 )
V_132 -> V_134 -= V_77 ;
return V_132 -> V_14 ;
}
