...
static int F_104 ( struct V_29 * V_30 , unsigned long V_142 ,
T_3 * V_118 , char * * V_112 , T_1 * V_23 ,
T_1 * V_127 )
{
struct V_133 * V_134 ;
...
* V_118 ) ;
* V_23 = F_105 ( V_30 , V_134 ) ;
if ( V_127 )
* V_127 = F_102 ( V_30 , V_134 ) ;
return 0 ;
}
static int F_106 ( struct V_29 * V_30 , unsigned long V_142 ,
T_3 * V_118 , char * * V_112 , T_1 * V_23 )
{
struct V_119 * V_120 ;
...
while ( V_142 < V_143 ) {
if ( V_144 ) {
V_9 = F_104 ( V_30 , V_142 , & V_118 , & V_112 ,
& V_128 , & V_127 ) ;
if ( ! V_109 )
V_109 = F_59 ( V_4 , V_127 ) ;
if ( ! V_109 ) {
...
V_9 = F_106 ( V_30 , V_142 , & V_118 , & V_112 ,
& V_128 ) ;
}
if ( V_9 )
goto V_13;
...
if ( ! V_41 )
return - V_63 ;
V_9 = F_114 ( V_4 , F_62 ( V_84 ) , V_41 ) ;
if ( V_9 < 0 )
goto V_13;
V_148 = V_9 ;
V_9 = F_112 ( V_4 , F_62 ( V_84 ) , V_41 ) ;
if ( V_9 < 0 )
goto V_13;
V_148 += V_9 ;
V_9 = 0 ;
...
F_115 ( V_41 -> V_59 [ 0 ] , & V_44 , V_41 -> V_60 [ 0 ] ) ;
if ( V_44 . V_54 != V_153 ||
V_44 . type != V_154 )
break;
...
V_9 = F_109 ( V_2 , F_62 ( V_109 ) , F_62 ( V_84 ) , V_112 ,
V_113 , 1 , V_23 ) ;
F_80 ( V_84 ) ;
F_80 ( V_109 ) ;
return V_9 ;
...
F_31 ( V_41 ) ;
if ( ! V_9 && V_160 ) {
F_127 ( F_62 ( V_109 ) , V_109 -> V_165 + V_113 * 2 ) ;
...
if ( F_129 ( V_8 , V_30 , V_111 ) )
return - V_90 ;
V_113 = F_83 ( V_30 , V_111 ) ;
V_9 = F_124 ( V_2 , V_4 , V_41 , V_30 , V_111 , V_44 ) ;
if ( V_9 < 0 )
break;
V_121 = ( unsigned long ) ( V_111 + 1 ) ;
V_121 += V_113 ;
if ( V_9 == 1 && F_125 ( V_30 , V_111 ) != V_167 ) {
struct V_43 V_168 ;
if ( ! V_166 ) {
V_166 = F_92 () ;
if ( ! V_166 ) {
...
if ( ! V_177 || ( F_89 ( V_177 ) && F_135 ( V_177 ) == - V_27 ) ) {
...
T_5 V_183 = F_137 ( V_41 -> V_59 [ 0 ] , V_111 ) ;
...
V_177 = F_138 ( NULL , log , V_175 , V_147 ,
V_112 , V_113 , 0 ) ;
F_31 ( V_175 ) ;
if ( ! V_177 ) {
F_31 ( V_41 ) ;
V_111 = F_138 ( V_2 , V_4 , V_41 , V_147 ,
V_112 , V_113 , - 1 ) ;
F_33 ( V_112 ) ;
if ( F_89 ( V_111 ) ) {
V_9 = F_135 ( V_111 ) ;
...
V_9 = F_130 ( log , V_41 , V_115 , V_169 ,
& V_186 , & V_187 ) ;
if ( V_9 != 0 )
break;
}
...
V_44 . type == V_125 ) {
V_9 = F_108 ( V_32 -> V_2 , V_4 , log , V_41 ,
V_30 , V_178 , & V_44 ) ;
if ( V_9 && V_9 != - V_27 )
break;
V_9 = 0 ;
...
F_142 ( F_23 ( V_182 ) != * V_192 ) ;
if ( V_41 -> V_60 [ * V_192 ] >=
F_132 ( V_182 ) )
break;
V_106 = F_143 ( V_182 , V_41 -> V_60 [ * V_192 ] ) ;
V_199 = F_144 ( V_182 , V_41 -> V_60 [ * V_192 ] ) ;
V_201 = V_8 -> V_203 ;
V_200 = V_41 -> V_59 [ * V_192 ] ;
V_198 = F_145 ( V_200 ) ;
V_105 = F_146 ( V_8 , V_106 ) ;
if ( F_89 ( V_105 ) )
return F_135 ( V_105 ) ;
if ( * V_192 == 1 ) {
...
F_142 ( * V_192 < 0 ) ;
F_142 ( * V_192 >= V_202 ) ;
V_41 -> V_60 [ * V_192 ] = F_132 ( V_41 -> V_59 [ * V_192 ] ) ;
F_153 () ;
return 0 ;
}
...
if ( V_42 + 1 < F_132 ( V_41 -> V_59 [ V_178 ] ) ) {
V_41 -> V_60 [ V_178 ] ++ ;
* V_192 = V_178 ;
F_142 ( * V_192 == 0 ) ;
return 0 ;
...
V_41 -> V_60 [ V_192 ] = 0 ;
while ( 1 ) {
V_206 = F_141 ( V_2 , log , V_41 , & V_192 , V_32 ) ;
if ( V_206 > 0 )
break;
if ( V_206 < 0 ) {
V_9 = V_206 ;
...
V_206 = F_154 ( V_2 , log , V_41 , & V_192 , V_32 ) ;
if ( V_206 > 0 )
break;
if ( V_206 < 0 ) {
V_9 = V_206 ;
...
int V_23 = V_79 % 2 ;
do {
F_163 ( & V_4 -> V_209 [ V_23 ] ,
& V_39 , V_210 ) ;
F_7 ( & V_4 -> V_10 ) ;
if ( V_4 -> V_211 < V_79 &&
F_164 ( & V_4 -> V_212 [ V_23 ] ) )
F_165 () ;
F_166 ( & V_4 -> V_209 [ V_23 ] , & V_39 ) ;
F_2 ( & V_4 -> V_10 ) ;
...
V_215 = V_24 % 2 ;
if ( F_164 ( & V_4 -> V_212 [ V_215 ] ) ) {
F_161 ( V_4 , V_24 ) ;
F_7 ( & V_4 -> V_10 ) ;
return V_6 -> V_214 ;
}
ASSERT ( V_24 == V_4 -> V_24 ) ;
F_174 ( & V_4 -> V_212 [ V_215 ] , 1 ) ;
if ( F_164 ( & V_4 -> V_212 [ ( V_215 + 1 ) % 2 ] ) )
F_161 ( V_4 , V_24 - 1 ) ;
while ( 1 ) {
int V_221 = F_164 ( & V_4 -> V_21 ) ;
if ( ! F_175 ( V_8 , V_222 ) &&
F_176 ( V_15 , & V_4 -> V_16 ) ) {
F_7 ( & V_4 -> V_10 ) ;
F_177 ( 1 ) ;
...
F_174 ( & V_20 -> V_212 [ V_216 ] , 1 ) ;
if ( F_164 ( & V_20 -> V_212 [ ( V_216 + 1 ) % 2 ] ) ) {
F_161 ( V_20 ,
V_218 . V_24 - 1 ) ;
}
F_167 ( V_20 ) ;
...
V_227:
F_2 ( & V_20 -> V_10 ) ;
F_170 ( V_20 , V_216 , V_9 ) ;
V_20 -> V_211 ++ ;
F_174 ( & V_20 -> V_212 [ V_216 ] , 0 ) ;
F_7 ( & V_20 -> V_10 ) ;
...
log = V_4 -> V_11 ;
F_2 ( & V_84 -> V_10 ) ;
V_9 = F_198 ( V_2 , log , V_112 , V_113 , F_61 ( V_84 ) ,
V_115 , & V_23 ) ;
F_7 ( & V_84 -> V_10 ) ;
if ( V_9 == - V_226 ) {
F_183 ( V_8 , V_2 ) ;
...
V_242 . type = V_169 ;
V_242 . V_82 = V_240 ;
V_9 = F_202 ( V_4 , & V_242 , V_41 , V_2 -> V_79 ) ;
...
V_9 = F_203 ( V_4 , V_41 , V_147 , V_169 ) ;
if ( V_9 == 0 ) {
struct V_43 V_244 ;
F_115 ( V_41 -> V_59 [ 0 ] , & V_244 ,
V_41 -> V_60 [ 0 ] ) ;
if ( V_169 == V_244 . type )
V_237 = F_204 ( V_240 , V_244 . V_82 ) + 1 ;
}
goto V_245;
}
V_9 = F_203 ( V_4 , V_41 , V_147 , V_169 ) ;
if ( V_9 == 0 ) {
struct V_43 V_244 ;
F_115 ( V_41 -> V_59 [ 0 ] , & V_244 , V_41 -> V_60 [ 0 ] ) ;
if ( V_169 == V_244 . type ) {
V_237 = V_244 . V_82 ;
...
if ( V_6 &&
( F_205 ( V_243 , V_111 ) == V_2 -> V_79 ||
F_125 ( V_243 , V_111 ) == V_167 ) &&
V_244 . type != V_246 )
V_6 -> V_247 = true ;
}
V_41 -> V_60 [ 0 ] = V_174 ;
...
V_248 = 0 ;
while ( 1 ) {
V_9 = F_201 ( V_2 , V_4 , V_84 , V_41 , V_239 , V_169 ,
V_6 , V_242 , & V_248 ) ;
if ( V_9 )
return V_9 ;
if ( V_248 == ( T_1 ) - 1 )
...
V_156 . V_82 = 0 ;
V_156 . type = 0 ;
V_9 = F_209 ( V_41 -> V_59 [ 0 ] , & V_156 , 0 ,
& V_250 ) ;
V_9 = F_210 ( V_2 , log , V_41 , V_250 ,
V_41 -> V_60 [ 0 ] - V_250 + 1 ) ;
if ( V_9 || V_250 != 0 )
break;
F_31 ( V_41 ) ;
...
& V_77 ) ;
F_223 ( V_94 , V_65 , V_84 -> V_261 , & V_77 ) ;
F_224 ( V_94 , V_65 , V_2 -> V_79 , & V_77 ) ;
F_225 ( V_94 , V_65 , V_84 -> V_262 , & V_77 ) ;
F_226 ( V_94 , V_65 , F_62 ( V_84 ) -> V_263 , & V_77 ) ;
...
struct V_64 ) ;
F_211 ( V_2 , V_41 -> V_59 [ 0 ] , V_51 , & V_84 -> V_138 ,
0 , 0 ) ;
F_31 ( V_41 ) ;
return 0 ;
}
...
T_1 V_252 )
{
struct V_7 * V_8 = F_230 ( V_84 -> V_138 . V_268 ) ;
unsigned long V_269 ;
unsigned long V_270 ;
...
F_115 ( V_243 , V_274 + V_178 , V_178 + V_250 ) ;
}
V_9 = F_231 ( V_2 , log , V_239 ,
V_274 , V_275 , V_266 ) ;
if ( V_9 ) {
F_33 ( V_276 ) ;
return V_9 ;
...
T_1 V_82 , V_37 ;
T_1 V_81 ;
if ( V_178 >= F_132 ( V_264 -> V_59 [ 0 ] ) ) {
V_9 = F_133 ( V_84 -> V_4 , V_264 ) ;
if ( V_9 < 0 )
return V_9 ;
ASSERT ( V_9 == 0 ) ;
V_243 = V_264 -> V_59 [ 0 ] ;
...
static int F_236 ( void * V_288 , struct V_277 * V_289 , struct V_277 * V_290 )
{
...
continue;
if ( ! F_176 ( V_308 , & V_298 -> V_263 ) &&
! F_176 ( V_309 , & V_298 -> V_263 ) &&
! F_176 ( V_310 , & V_298 -> V_263 ) ) {
const T_1 V_36 = V_298 -> V_307 ;
const T_1 V_230 = V_298 -> V_307 + V_298 -> V_37 - 1 ;
F_142 ( V_298 -> V_84 != V_84 ) ;
F_239 ( V_84 -> V_311 , V_36 , V_230 ) ;
}
F_240 ( V_298 -> V_39 ,
( F_176 ( V_308 , & V_298 -> V_263 ) ||
F_176 ( V_309 , & V_298 -> V_263 ) ) ) ;
if ( F_176 ( V_309 , & V_298 -> V_263 ) ) {
F_241 ( V_84 -> V_311 ) ;
* V_296 = true ;
break;
}
...
if ( V_294 -> V_313 ) {
V_301 = 0 ;
V_302 = F_204 ( V_294 -> V_314 , V_294 -> V_315 ) ;
} else {
...
int V_319 = 0 ;
bool V_320 = false ;
V_9 = F_237 ( V_2 , & V_84 -> V_138 , V_4 , V_294 ,
V_295 , & V_320 ) ;
if ( V_9 )
return V_9 ;
if ( V_320 ) {
...
F_47 ( & V_77 ) ;
V_9 = F_244 ( V_2 , log , & V_84 -> V_138 , V_41 , V_294 -> V_36 ,
...
V_86 ,
& V_77 ) ;
V_314 = F_204 ( V_294 -> V_314 , V_294 -> V_315 ) ;
if ( V_294 -> V_313 != V_322 ) {
F_247 ( V_94 , V_316 ,
V_294 -> V_304 ,
& V_77 ) ;
F_248 ( V_94 , V_316 , V_314 ,
& V_77 ) ;
...
F_247 ( V_94 , V_316 , 0 , & V_77 ) ;
F_248 ( V_94 , V_316 , 0 ,
& V_77 ) ;
}
F_249 ( V_94 , V_316 , V_317 , & V_77 ) ;
F_250 ( V_94 , V_316 , V_294 -> V_37 , & V_77 ) ;
F_251 ( V_94 , V_316 , V_294 -> V_324 , & V_77 ) ;
F_252 ( V_94 , V_316 , V_294 -> V_313 ,
& V_77 ) ;
F_253 ( V_94 , V_316 , 0 , & V_77 ) ;
...
F_259 ( NULL , & V_326 , F_236 ) ;
F_260 ( V_84 , V_295 , V_36 , V_230 ) ;
V_9 = F_241 ( V_84 -> V_138 . V_311 ) ;
if ( V_9 )
V_6 -> V_321 = V_9 ;
V_337:
while ( ! F_73 ( & V_326 ) ) {
...
F_263 ( & V_328 -> V_333 ) ;
V_9 = F_243 ( V_2 , V_84 , V_4 , V_294 , V_41 , V_295 ,
V_6 ) ;
F_257 ( & V_328 -> V_333 ) ;
F_261 ( V_328 , V_294 ) ;
F_262 ( V_294 ) ;
...
static int F_265 ( struct V_3 * log , struct V_108 * V_84 ,
...
int V_174 = F_132 ( V_94 ) ;
if ( V_42 >= V_174 ) {
if ( V_341 > 0 ) {
T_1 V_265 = 0 ;
V_9 = F_229 ( V_2 , V_84 , V_239 , V_41 ,
& V_265 , V_250 ,
V_341 , 1 , 0 ) ;
ASSERT ( V_9 <= 0 ) ;
if ( V_9 < 0 )
...
struct V_3 * log = V_4 -> V_11 ;
const T_1 V_147 = F_61 ( V_84 ) ;
const T_1 V_165 = F_268 ( & V_84 -> V_138 ) ;
if ( ! F_19 ( V_8 , V_97 ) )
return 0 ;
V_44 . V_54 = V_147 ;
V_44 . type = V_197 ;
...
V_9 = F_235 ( V_2 , log , V_147 , V_342 , 0 , 0 ,
V_343 , 0 , V_343 , 0 , 0 , 0 ) ;
return V_9 ;
}
...
if ( V_267 == V_282 )
V_249 = V_179 ;
V_9 = F_207 ( V_2 , log , V_41 , V_147 , V_249 ) ;
} else {
if ( V_267 == V_282 ) {
V_231 = F_265 ( log , V_84 , V_41 , & V_252 ) ;
if ( V_231 )
goto V_235;
}
if ( F_176 ( V_355 ,
...
V_9 = F_229 ( V_2 , V_84 , V_239 , V_41 , & V_265 ,
V_351 , V_341 , V_267 ,
V_252 ) ;
if ( V_9 < 0 ) {
V_231 = V_9 ;
...
F_31 ( V_41 ) ;
F_31 ( V_239 ) ;
V_231 = F_266 ( V_2 , V_4 , V_84 , V_41 , V_239 ) ;
if ( V_231 )
goto V_235;
if ( V_248 . type >= V_197 && ! V_352 ) {
F_31 ( V_41 ) ;
F_31 ( V_239 ) ;
V_231 = F_267 ( V_2 , V_4 , V_84 , V_41 ) ;
if ( V_231 )
goto V_235;
}
V_361:
...
F_31 ( V_239 ) ;
if ( V_354 ) {
V_231 = F_228 ( V_2 , log , V_239 , V_84 ) ;
if ( V_231 )
goto V_235;
}
if ( V_352 ) {
V_9 = F_255 ( V_2 , V_4 , V_84 , V_239 ,
...
V_9 = F_206 ( V_2 , V_4 , V_84 , V_41 , V_239 ,
V_6 ) ;
if ( V_9 ) {
V_231 = V_9 ;
goto V_235;
...
static T_2 int F_284 ( struct V_1 * V_2 ,
struct V_108 * V_84 ,
struct V_371 * V_200 ,
struct V_372 * V_364 ,
T_1 V_373 )
...
goto V_13;
if ( ! F_39 ( V_84 -> V_138 . V_152 ) ) {
if ( ! V_200 || F_285 ( V_200 ) || V_364 != V_200 -> V_376 )
goto V_13;
V_84 = F_62 ( F_286 ( V_200 ) ) ;
}
while ( 1 ) {
if ( V_84 != V_375 )
V_84 -> V_234 = V_2 -> V_79 ;
...
int V_174 ;
int V_178 ;
V_380 = F_291 ( & V_378 , struct V_379 ,
V_25 ) ;
if ( V_9 )
goto V_381;
...
V_135:
F_31 ( V_41 ) ;
V_9 = F_202 ( log , & V_242 , V_41 , V_2 -> V_79 ) ;
if ( V_9 < 0 ) {
goto V_381;
} else if ( V_9 > 0 ) {
V_9 = 0 ;
...
int V_384 = V_282 ;
int type ;
F_115 ( V_94 , & V_242 , V_178 ) ;
if ( V_242 . V_54 != V_380 -> V_147 ||
V_242 . type != V_163 )
goto V_381;
V_111 = F_35 ( V_94 , V_178 , struct V_110 ) ;
type = F_125 ( V_94 , V_111 ) ;
if ( F_205 ( V_94 , V_111 ) < V_2 -> V_79 &&
type != V_167 )
continue;
...
continue;
F_31 ( V_41 ) ;
V_382 = F_277 ( V_8 -> V_364 , & V_168 , V_4 , NULL ) ;
if ( F_89 ( V_382 ) ) {
V_9 = F_135 ( V_382 ) ;
goto V_381;
}
if ( F_292 ( F_62 ( V_382 ) , V_2 -> V_79 ) ) {
F_80 ( V_382 ) ;
break;
}
V_6 -> V_247 = false ;
...
V_384 = V_360 ;
V_9 = F_271 ( V_2 , V_4 , F_62 ( V_382 ) ,
V_384 , 0 , V_366 , V_6 ) ;
if ( ! V_9 &&
F_283 ( V_2 , F_62 ( V_382 ) ) )
V_9 = 1 ;
F_80 ( V_382 ) ;
if ( V_9 )
goto V_381;
...
V_386 = F_277 ( V_8 -> V_364 , & V_362 ,
V_4 , NULL ) ;
if ( F_89 ( V_386 ) )
continue;
if ( V_6 )
V_6 -> V_247 = false ;
V_9 = F_271 ( V_2 , V_4 , F_62 ( V_386 ) ,
V_360 , 0 , V_366 , V_6 ) ;
if ( ! V_9 &&
F_283 ( V_2 , F_62 ( V_386 ) ) )
V_9 = 1 ;
...
if ( V_4 != V_84 -> V_4 || F_295 ( & V_4 -> V_208 ) == 0 ) {
V_9 = 1 ;
goto V_390;
}
V_9 = F_284 ( V_2 , V_84 , V_200 , V_364 ,
V_373 ) ;
if ( V_9 )
goto V_390;
if ( F_292 ( V_84 , V_2 -> V_79 ) ) {
V_9 = V_392 ;
goto V_390;
}
V_9 = F_1 ( V_2 , V_4 , V_6 ) ;
if ( V_9 )
goto V_390;
V_9 = F_271 ( V_2 , V_4 , V_84 , V_267 , V_36 , V_230 , V_6 ) ;
if ( V_9 )
goto V_393;
if ( F_46 ( V_84 -> V_138 . V_152 ) &&
V_84 -> V_253 <= V_373 &&
...
struct V_5 * V_6 )
{
struct V_371 * V_200 = F_288 ( V_371 ) ;
int V_9 ;
V_9 = F_294 ( V_2 , V_4 , F_62 ( F_286 ( V_371 ) ) ,
V_200 , V_36 , V_230 , 0 , V_6 ) ;
F_289 ( V_200 ) ;
return V_9 ;
}
int F_297 ( struct V_3 * V_20 )
{
int V_9 ;
struct V_40 * V_41 ;
struct V_1 * V_2 ;
...
V_394 . type = V_246 ;
V_394 . V_82 = ( T_1 ) - 1 ;
V_32 . V_191 = F_301 ( V_8 , & V_394 ) ;
if ( F_89 ( V_32 . V_191 ) ) {
V_9 = F_135 ( V_32 . V_191 ) ;
F_147 ( log -> V_205 ) ;
F_147 ( log -> V_397 ) ;
F_33 ( log ) ;
F_299 ( V_8 , V_9 ,
...
V_32 . V_191 -> V_11 = log ;
F_302 ( V_2 , V_32 . V_191 ) ;
V_9 = F_156 ( V_2 , log , & V_32 ) ;
if ( ! V_9 && V_32 . V_193 == V_196 ) {
V_9 = F_119 ( V_2 , V_32 . V_191 ,
V_41 ) ;
}
...
return 0 ;
return F_294 ( V_2 , V_4 , V_84 , V_200 , 0 ,
V_366 , 1 , NULL ) ;
}
