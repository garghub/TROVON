...
static void F_72 ( struct V_19 * V_20 , int V_172 )
{
struct V_1 * V_2 = F_20 ( V_20 ) ;
if ( V_172 & V_173 ) {
if ( F_67 ( V_20 ) )
...
static int F_73 ( struct V_19 * V_20 , struct V_175 * V_176 )
{
int V_104 = 0 ;
...
V_20 -> V_195 = & V_196 ;
V_20 -> line = line ;
V_20 -> V_167 = F_77 ( line ) ;
}
}
}
static void F_78 ( struct V_19 * V_20 , int V_62 )
{
struct V_1 * V_2 = F_20 ( V_20 ) ;
F_15 ( V_2 ) ;
F_10 ( V_2 , V_84 , V_62 ) ;
}
static void F_79 ( struct V_197 * V_198 , const char * V_199 ,
unsigned int V_64 )
{
...
unsigned long V_172 ;
unsigned int V_51 ;
F_80 ( & V_20 -> V_160 , V_172 ) ;
V_51 = F_9 ( V_2 , F_25 ( ( V_20 -> line ) % 2 ) ) ;
F_11 ( V_2 , F_25 ( ( V_20 -> line ) % 2 ) ,
V_51 & ~ V_52 ) ;
F_10 ( V_2 , V_48 , V_53 ) ;
F_81 ( & V_20 -> V_160 , V_172 ) ;
F_82 ( & V_2 -> V_5 , V_199 , V_64 , F_78 ) ;
F_80 ( & V_20 -> V_160 , V_172 ) ;
F_18 ( V_2 ) ;
if ( V_2 -> V_50 )
F_10 ( V_2 , V_48 , V_49 ) ;
...
static int T_5 F_83 ( struct V_197 * V_198 , char * V_201 )
{
int V_182 = V_198 -> V_200 / V_190 ;
int V_183 = V_198 -> V_200 % V_190 ;
struct V_1 * V_2 = & V_189 [ V_182 ] . V_2 [ V_183 ] ;
...
F_50 ( V_2 ) ;
if ( V_201 )
F_84 ( V_201 , & V_129 , & V_73 , & V_202 , & V_203 ) ;
return F_85 ( V_20 , V_198 , V_129 , V_73 , V_202 , V_203 ) ;
}
