...
static inline int F_15 ( struct V_33 * V_34 , struct V_46 * V_47 ,
T_2 V_48 , void * V_49 , T_1 V_50 )
{
struct V_38 V_53 ;
F_11 ( & V_53 , V_50 ) ;
...
{
struct V_131 V_95 ;
return F_15 ( V_34 , V_47 , V_132 ,
& V_95 , sizeof( V_95 ) ) ;
}
int F_59 ( struct V_33 * V_34 , struct V_46 * V_47 )
{
struct V_133 V_92 ;
return F_15 ( V_34 , V_47 , V_134 ,
& V_92 , sizeof( V_92 ) ) ;
}
...
V_47 = NULL ;
F_65 (cb, next, &dev->ctrl_rd_list, list) {
V_47 = V_141 -> V_47 ;
