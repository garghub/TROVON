...
V_2 -> V_37 = 0 ;
V_2 -> V_161 = 0 ;
F_77 ( V_6 , V_99 , V_135 , V_4 , V_68 , V_189 ) ;
...
return;
V_167 -> type = V_195 ;
V_167 -> V_196 . V_4 = ( ( T_1 * ) V_167 ) + sizeof( * V_167 ) ;
V_167 -> V_196 . V_68 = V_68 ;
memcpy ( ( void * ) V_167 -> V_196 . V_4 , V_4 , V_68 ) ;
V_167 -> V_196 . V_135 = V_135 ;
V_167 -> V_196 . V_194 = V_194 ;
F_69 ( & V_2 -> V_181 , V_33 ) ;
F_70 ( & V_167 -> V_171 , & V_2 -> V_182 ) ;
F_71 ( & V_2 -> V_181 , V_33 ) ;
F_72 ( V_183 , & V_6 -> V_184 ) ;
...
F_83 ( & V_129 -> V_74 ,
V_6 -> V_7 . V_199 ) ;
if ( V_198 && V_198 -> V_200 >= 0 ) {
int V_201 ;
T_5 V_202 ;
V_201 = V_198 -> V_200 ;
V_202 = V_198 -> V_15 [ V_201 ] . V_202 ;
if ( V_202 == V_203 ||
V_202 == V_204 ) {
V_129 -> V_59 = V_201 ;
V_129 -> V_57 = V_198 -> V_15 [ V_201 ] . V_57 ;
V_129 -> V_58 = V_198 -> V_15 [ V_201 ] . V_58 ;
if ( V_129 -> V_72 . V_205 == 0 )
V_129 -> V_72 . V_205 = V_202 ;
if ( V_129 -> V_72 . V_206 == 0 ) {
V_129 -> V_72 . V_206 = 1 ;
V_129 -> V_72 . V_207 [ 0 ] = V_202 ;
}
}
V_129 -> V_72 . V_208 = V_198 -> V_15 ;
V_129 -> V_72 . V_209 = V_198 -> V_200 ;
} else {
if ( F_14 ( V_198 ) )
return - V_26 ;
}
...
{
struct V_1 * V_2 =
F_19 ( V_84 , struct V_1 , V_214 ) ;
struct V_5 * V_6 = F_4 ( V_2 -> V_7 ) ;
F_22 ( V_2 ) ;
if ( V_2 -> V_161 ) {
if ( V_6 -> V_52 -> V_213 || V_2 -> V_130 )
F_85 ( V_6 , V_2 -> V_43 ,
V_77 , true ) ;
else
F_17 ( V_6 , V_2 -> V_43 ,
