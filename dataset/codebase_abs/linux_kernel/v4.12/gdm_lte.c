...
memcpy ( F_17 ( V_23 , V_41 ) , V_40 ,
V_41 ) ;
memcpy ( F_17 ( V_23 , sizeof( struct V_52 ) ) , & V_82 ,
sizeof( struct V_52 ) ) ;
memcpy ( F_17 ( V_23 , sizeof( struct V_83 ) ) , & V_85 ,
sizeof( struct V_83 ) ) ;
memcpy ( F_17 ( V_23 , sizeof( struct V_74 ) ) , & V_78 ,
sizeof( struct V_74 ) ) ;
V_23 -> V_51 = ( (struct V_24 * ) V_40 ) -> V_43 ;
V_23 -> V_2 = V_22 -> V_2 ;
F_18 ( V_23 ) ;
...
memcpy ( F_17 ( V_12 , V_20 ) , V_141 , V_20 ) ;
