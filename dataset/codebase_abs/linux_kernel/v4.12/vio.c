...
V_165 = F_94 ( V_4 ) ;
if ( V_165 ) {
if ( ! strcmp ( V_165 -> V_168 , L_20 ) )
V_85 = V_87 ;
else if ( ! strcmp ( V_165 -> V_168 , L_21 ) )
V_85 = V_86 ;
else {
F_95 ( L_22 ,
V_89 ,
...
V_169 = F_96 ( V_6 , 1 ) ;
F_97 ( & V_8 -> V_49 , L_31 , V_169 ) ;
V_8 -> V_170 = F_98 ( V_4 , 0 ) ;
V_8 -> V_169 = V_169 ;
} else {
V_6 = F_43 ( V_4 , L_32 , NULL ) ;
if ( V_6 != NULL )
V_8 -> V_120 = F_96 ( V_6 , 1 ) ;
F_97 ( & V_8 -> V_49 , L_33 , V_167 ) ;
V_8 -> type = V_167 ;
V_8 -> V_170 = 0 ;
}
V_8 -> V_162 = V_4 -> V_162 ;
...
F_102 ( & V_8 -> V_49 ,
F_76 ( V_8 ) ) ;
V_8 -> V_49 . V_174 = F_103 ( 64 ) ;
V_8 -> V_49 . V_175 = & V_8 -> V_49 . V_174 ;
}
if ( F_104 ( & V_8 -> V_49 ) ) {
F_61 ( V_99 L_34 ,
V_89 , F_105 ( & V_8 -> V_49 ) ) ;
...
static void F_106 ( char * V_176 )
{
struct V_1 * V_177 , * V_178 ;
if ( ! V_176 )
return;
V_177 = F_2 ( NULL , V_176 ) ;
if ( V_177 ) {
V_178 = F_107 ( V_177 , NULL ) ;
while ( V_178 ) {
F_93 ( V_178 ) ;
V_178 = F_107 ( V_177 , V_178 ) ;
}
F_5 ( V_177 ) ;
}
}
...
struct V_101 * V_102 , char * V_103 )
{
return sprintf ( V_103 , L_38 , F_24 ( V_49 ) -> V_162 ) ;
}
static T_5 F_112 ( struct V_48 * V_49 ,
struct V_101 * V_102 , char * V_103 )
{
struct V_1 * V_4 = V_49 -> V_4 ;
return sprintf ( V_103 , L_38 , F_113 ( V_4 ) ) ;
}
static T_5 F_114 ( struct V_48 * V_49 , struct V_101 * V_102 ,
char * V_103 )
{
...
V_181 = F_43 ( V_180 , L_40 , NULL ) ;
if ( ! V_181 ) {
strcpy ( V_103 , L_39 ) ;
return strlen ( V_103 ) ;
}
return sprintf ( V_103 , L_41 , V_7 -> type , V_181 ) ;
}
...
{
const struct V_7 * V_7 = F_24 ( V_49 ) ;
struct V_81 * V_184 = F_42 ( V_183 ) ;
const struct V_151 * V_152 = V_184 -> V_157 ;
return ( V_152 != NULL ) && ( F_80 ( V_152 , V_7 ) != NULL ) ;
}
static int F_118 ( struct V_48 * V_49 , struct V_185 * V_186 )
{
const struct V_7 * V_7 = F_24 ( V_49 ) ;
struct V_1 * V_180 ;
const char * V_181 ;
...
if ( ! V_181 )
return - V_155 ;
F_119 ( V_186 , L_42 , V_7 -> type , V_181 ) ;
return 0 ;
}
const void * F_120 ( struct V_7 * V_112 , char * V_187 , int * V_72 )
{
return F_43 ( V_112 -> V_49 . V_4 , V_187 , V_72 ) ;
}
static struct V_7 * F_121 ( const char * V_162 )
{
struct V_48 * V_79 ;
V_79 = F_122 ( & V_107 , NULL , V_162 ) ;
if ( ! V_79 )
return NULL ;
return F_24 ( V_79 ) ;
}
struct V_7 * F_123 ( struct V_1 * V_188 )
{
char V_189 [ 20 ] ;
struct V_1 * V_190 ;
const char * V_191 ;
...
if ( ! V_190 )
return NULL ;
V_191 = F_43 ( V_190 , L_43 , NULL ) ;
F_5 ( V_190 ) ;
if ( ! V_191 )
return NULL ;
if ( ! strcmp ( V_191 , L_1 ) ) {
const T_6 * V_6 ;
V_6 = F_43 ( V_188 , L_29 , NULL ) ;
if ( ! V_6 )
return NULL ;
snprintf ( V_189 , sizeof( V_189 ) , L_31 ,
( V_192 ) F_96 ( V_6 , 1 ) ) ;
} else if ( ! strcmp ( V_191 , L_37 ) )
snprintf ( V_189 , sizeof( V_189 ) , L_33 , V_188 -> V_162 ) ;
else
return NULL ;
return F_121 ( V_189 ) ;
}
...
{
int V_193 = F_125 ( V_49 -> V_169 , V_194 ) ;
if ( V_193 != V_98 )
F_61 ( V_99 L_44 , V_193 ) ;
return V_193 ;
}
int F_126 ( struct V_7 * V_49 )
{
int V_193 = F_125 ( V_49 -> V_169 , V_195 ) ;
if ( V_193 != V_98 )
F_61 ( V_99 L_45 , V_193 ) ;
return V_193 ;
}
