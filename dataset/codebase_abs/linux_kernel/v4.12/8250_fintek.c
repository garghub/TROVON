...
static void F_15 ( struct V_70 * V_71 ,
struct V_1 * V_2 )
{
F_4 ( V_2 , V_51 , V_2 -> V_52 ) ;
switch ( V_2 -> V_26 ) {
...
struct V_70 * V_71 )
{
static const T_2 V_76 [] = { 0x4e , 0x2e } ;
static const T_1 V_77 [] = { 0x77 , 0xa0 , 0x87 , 0x67 } ;
struct V_78 * V_78 ;
bool V_79 = false ;
int V_80 , V_81 , V_82 , V_27 , V_28 ;
for ( V_80 = 0 ; V_80 < F_17 ( V_76 ) ; V_80 ++ ) {
for ( V_81 = 0 ; V_81 < F_17 ( V_77 ) ; V_81 ++ ) {
V_2 -> V_4 = V_76 [ V_80 ] ;
V_2 -> V_10 = V_77 [ V_81 ] ;
if ( F_6 ( V_76 [ V_80 ] , V_77 [ V_81 ] ) )
continue;
if ( F_10 ( V_2 ) ||
F_11 ( V_2 , & V_27 , & V_28 ) ) {
F_8 ( V_76 [ V_80 ] ) ;
...
for ( V_82 = V_27 ; V_82 < V_28 ; V_82 ++ ) {
T_2 V_83 ;
F_4 ( V_2 , V_51 , V_82 ) ;
V_83 = F_1 ( V_2 , V_84 ) ;
V_83 |= F_1 ( V_2 , V_85 ) << 8 ;
if ( V_83 != V_71 -> V_34 . V_86 )
continue;
V_2 -> V_52 = V_82 ;
V_78 = F_18 ( V_71 -> V_34 . V_87 ) ;
if ( V_78 )
V_79 =
F_19 ( V_78 ) ;
F_13 ( V_2 , V_79 ) ;
...
int F_21 ( struct V_70 * V_71 )
{
struct V_1 * V_2 ;
struct V_1 V_89 ;
if ( F_16 ( & V_89 , V_71 ) )
return - V_16 ;
V_2 = F_22 ( V_71 -> V_34 . V_90 , sizeof( * V_2 ) , V_91 ) ;
if ( ! V_2 )
return - V_92 ;
memcpy ( V_2 , & V_89 , sizeof( V_89 ) ) ;
V_71 -> V_34 . V_38 = V_2 ;
F_20 ( V_71 ) ;
return 0 ;
}
