...
if ( F_176 ( V_247 , V_1 -> V_276 , V_303 , F_177 ( V_3 ) , V_1 ) ) {
F_77 ( V_3 , L_82 , V_247 ) ;
V_183 = - V_221 ;
goto V_302;
}
...
if ( V_266 -> V_304 ) {
T_3 V_305 = F_180 ( V_1 -> V_53 ) ;
V_305 |= V_306 ;
F_181 ( V_1 -> V_53 , V_305 ) ;
}
if ( V_1 -> V_60 -> V_61 -> V_307 ) {
F_68 ( V_1 ) ;
V_1 -> V_60 -> V_61 -> V_62 = V_102 ;
} else {
F_61 ( V_1 ) ;
...
static int F_195 ( struct V_315 * V_316 )
{
struct V_2 * V_3 = & V_316 -> V_3 ;
int V_317 = F_196 ( V_316 , L_85 ) ;
struct V_318 * V_319 ;
void T_2 * V_320 ;
if ( V_317 <= 0 )
return - V_221 ;
V_319 = F_197 ( V_316 , V_321 , 0 ) ;
V_320 = F_198 ( V_3 , V_319 ) ;
if ( F_172 ( V_320 ) )
return F_173 ( V_320 ) ;
return F_163 ( V_3 , V_317 , V_320 ) ;
}
static int F_199 ( struct V_315 * V_316 )
{
struct V_2 * V_3 = & V_316 -> V_3 ;
struct V_1 * V_1 = F_1 ( V_3 ) ;
unsigned long V_58 ;
...
{
int V_19 ;
void T_2 * V_322 = V_1 -> V_53 ;
void T_2 * V_323 ;
V_1 -> V_324 . V_325 = F_83 ( V_322 , V_326 ) ;
V_1 -> V_324 . V_327 = F_7 ( V_322 , V_134 ) ;
V_1 -> V_324 . V_305 = F_180 ( V_1 -> V_53 ) ;
V_1 -> V_324 . V_21 = F_7 ( V_322 , V_24 ) ;
V_1 -> V_324 . V_328 = F_7 ( V_322 , V_121 ) ;
V_1 -> V_324 . V_46 = F_7 ( V_322 , V_38 ) ;
V_1 -> V_324 . V_78 = F_7 ( V_322 , V_98 ) ;
...
continue;
F_8 ( V_322 , V_38 , V_19 ) ;
V_1 -> V_324 . V_329 [ V_19 ] . V_330 =
F_83 ( V_323 , V_331 ) ;
V_1 -> V_324 . V_329 [ V_19 ] . V_332 =
F_83 ( V_323 , V_333 ) ;
V_1 -> V_324 . V_329 [ V_19 ] . V_334 =
F_83 ( V_323 , V_335 ) ;
V_1 -> V_324 . V_329 [ V_19 ] . V_336 =
F_83 ( V_323 , V_337 ) ;
if ( V_1 -> V_186 ) {
V_1 -> V_324 . V_329 [ V_19 ] . V_338 =
F_201 ( V_322 ) ;
V_1 -> V_324 . V_329 [ V_19 ] . V_339 =
F_202 ( V_322 ) ;
V_1 -> V_324 . V_329 [ V_19 ] . V_340 =
F_203 ( V_322 ) ;
V_1 -> V_324 . V_329 [ V_19 ] . V_341 =
F_204 ( V_322 ) ;
}
V_1 -> V_324 . V_329 [ V_19 ] . V_342 =
F_7 ( V_323 , V_343 ) ;
V_1 -> V_324 . V_329 [ V_19 ] . V_344 =
F_7 ( V_323 , V_345 ) ;
V_1 -> V_324 . V_329 [ V_19 ] . V_346 =
F_7 ( V_323 , V_347 ) ;
V_1 -> V_324 . V_329 [ V_19 ] . V_348 =
F_7 ( V_323 , V_349 ) ;
V_1 -> V_324 . V_329 [ V_19 ] . V_350 =
F_205 ( V_1 , V_19 ) ;
V_1 -> V_324 . V_329 [ V_19 ] . V_351 =
F_206 ( V_1 , V_19 ) ;
V_1 -> V_324 . V_329 [ V_19 ] . V_352 =
F_207 ( V_1 , V_19 ) ;
V_1 -> V_324 . V_329 [ V_19 ] . V_353 =
F_208 ( V_1 , V_19 ) ;
V_1 -> V_324 . V_329 [ V_19 ] . V_354 =
F_209 ( V_1 , V_19 ) ;
V_1 -> V_324 . V_329 [ V_19 ] . V_355 =
F_210 ( V_1 , V_19 ) ;
}
}
...
void T_2 * V_323 ;
T_3 V_21 ;
F_52 ( V_322 , V_326 , V_1 -> V_324 . V_325 ) ;
F_8 ( V_322 , V_134 , V_1 -> V_324 . V_327 ) ;
F_181 ( V_1 -> V_53 , V_1 -> V_324 . V_305 ) ;
V_21 = F_7 ( V_322 , V_24 ) ;
V_21 &= V_25 | V_356 ;
V_1 -> V_324 . V_21 &= ~ ( V_25 | V_356 ) ;
V_21 |= V_1 -> V_324 . V_21 ;
F_8 ( V_322 , V_24 , V_21 ) ;
F_52 ( V_322 , V_118 , V_1 -> V_116 ) ;
F_52 ( V_322 , V_120 , V_1 -> V_119 ) ;
F_8 ( V_322 , V_121 , V_1 -> V_324 . V_328 ) ;
if ( V_1 -> V_324 . V_78 & V_99 )
F_8 ( V_322 , V_98 , V_1 -> V_324 . V_78 ) ;
for ( V_19 = 0 ; V_19 < V_1 -> V_136 -> V_178 ; ++ V_19 ) {
struct V_40 * V_41 ;
V_41 = & V_1 -> V_52 [ V_19 ] ;
if ( ! V_41 )
...
F_211 ( V_1 ) ;
V_78 = F_7 ( V_1 -> V_53 , V_98 ) ;
V_358 = V_97 | V_228 | V_126 ;
if ( ( V_78 & V_358 ) != ( V_1 -> V_324 . V_78 & V_358 ) )
V_1 -> V_75 = 0 ;
F_193 ( V_3 ) ;
F_222 ( V_3 ) ;
F_170 ( V_3 ) ;
