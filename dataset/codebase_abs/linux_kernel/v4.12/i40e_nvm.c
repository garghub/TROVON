...
if ( V_93 && ( V_2 -> V_28 . V_29 == V_137 ) &&
! V_131 ) {
T_1 V_138 = V_93 ;
T_2 V_139 = V_2 -> V_28 . V_29 ;
T_2 V_22 ;
V_22 = F_2 ( V_2 , V_26 ) ;
...
void F_39 ( struct V_1 * V_2 , T_5 V_141 )
{
if ( V_141 == V_2 -> V_99 ) {
F_4 ( V_2 , V_19 ,
L_19 , V_141 ) ;
...
T_3 V_143 , V_144 ;
V_95 = V_103 ;
V_144 = F_33 ( V_90 -> V_101 ) ;
V_143 = F_32 ( V_90 -> V_101 ) ;
if ( ( V_90 -> V_102 < 1 ) ||
( V_90 -> V_102 > V_145 ) ) {
F_4 ( V_2 , V_19 ,
L_20 ,
...
T_2 V_159 ;
T_2 V_160 ;
F_4 ( V_2 , V_19 , L_21 , V_161 ) ;
memset ( & V_51 , 0 , sizeof( V_51 ) ) ;
V_51 . V_65 = & V_2 -> V_66 ;
V_159 = sizeof( struct V_155 ) ;
memset ( & V_2 -> V_66 , 0 , V_159 ) ;
if ( V_90 -> V_102 < V_159 ) {
F_4 ( V_2 , V_19 ,
L_22 ,
V_90 -> V_102 , V_159 ) ;
...
V_156 = (struct V_155 * ) V_91 ;
V_160 = V_90 -> V_102 - V_159 ;
V_157 = F_46 ( T_2 , V_160 , F_18 ( V_156 -> V_163 ) ) ;
if ( V_157 ) {
if ( ! V_2 -> V_164 . V_74 ) {
V_93 = F_27 ( V_2 , & V_2 -> V_164 ,
V_2 -> V_28 . V_165 ) ;
if ( V_93 )
F_4 ( V_2 , V_19 ,
L_23 ,
...
if ( V_2 -> V_164 . V_74 ) {
V_158 = V_2 -> V_164 . V_74 ;
memcpy ( V_158 , & V_91 [ V_159 ] , V_160 ) ;
}
}
V_93 = F_47 ( V_2 , V_156 , V_158 ,
V_157 , & V_51 ) ;
if ( V_93 ) {
F_4 ( V_2 , V_19 ,
L_24 ,
...
F_4 ( V_2 , V_19 , L_21 , V_161 ) ;
V_159 = sizeof( struct V_155 ) ;
V_166 = V_159 + F_18 ( V_2 -> V_66 . V_163 ) ;
if ( V_90 -> V_36 > V_166 ) {
F_4 ( V_2 , V_19 , L_25 ,
V_161 , V_90 -> V_36 , V_166 ) ;
* V_92 = - V_162 ;
return V_39 ;
}
if ( V_90 -> V_102 > ( V_166 - V_90 -> V_36 ) ) {
int V_168 = V_166 - V_90 -> V_36 ;
F_4 ( V_2 , V_19 , L_26 ,
V_161 , V_90 -> V_102 , V_168 ) ;
V_90 -> V_102 = V_168 ;
}
V_167 = V_90 -> V_102 ;
if ( V_90 -> V_36 < V_159 ) {
T_2 V_169 = V_159 - V_90 -> V_36 ;
V_169 = F_22 ( V_169 , V_90 -> V_102 ) ;
F_4 ( V_2 , V_19 , L_27 ,
V_161 , V_90 -> V_36 , V_90 -> V_36 + V_169 ) ;
V_158 = ( ( T_3 * ) & V_2 -> V_66 ) + V_90 -> V_36 ;
memcpy ( V_91 , V_158 , V_169 ) ;
V_91 += V_169 ;
V_167 -= V_169 ;
V_158 = V_2 -> V_164 . V_74 ;
} else {
V_158 = V_2 -> V_164 . V_74 + ( V_90 -> V_36 - V_159 ) ;
}
if ( V_167 > 0 ) {
int V_170 = V_158 - ( T_3 * ) V_2 -> V_164 . V_74 ;
F_4 ( V_2 , V_19 , L_28 ,
V_161 , V_170 , V_170 + V_167 ) ;
memcpy ( V_91 , V_158 , V_167 ) ;
}
return 0 ;
}
...
V_144 = F_33 ( V_90 -> V_101 ) ;
V_143 = F_32 ( V_90 -> V_101 ) ;
V_171 = ( V_144 == V_149 ) || ( V_144 == V_150 ) ;
memset ( & V_51 , 0 , sizeof( V_51 ) ) ;
V_51 . V_65 = & V_2 -> V_66 ;
V_93 = F_16 ( V_2 , V_143 , V_90 -> V_36 , ( T_5 ) V_90 -> V_102 ,
V_91 , V_171 , & V_51 ) ;
if ( V_93 ) {
F_4 ( V_2 , V_19 ,
L_29 ,
V_143 , V_90 -> V_36 , V_90 -> V_102 ) ;
F_4 ( V_2 , V_19 ,
L_30 ,
V_93 , V_2 -> V_28 . V_29 ) ;
* V_92 = F_40 ( V_93 , V_2 -> V_28 . V_29 ) ;
...
memset ( & V_51 , 0 , sizeof( V_51 ) ) ;
V_51 . V_65 = & V_2 -> V_66 ;
V_93 = F_50 ( V_2 , V_143 , V_90 -> V_36 , ( T_5 ) V_90 -> V_102 ,
V_171 , & V_51 ) ;
if ( V_93 ) {
F_4 ( V_2 , V_19 ,
L_31 ,
...
memset ( & V_51 , 0 , sizeof( V_51 ) ) ;
V_51 . V_65 = & V_2 -> V_66 ;
V_93 = F_25 ( V_2 , V_143 , V_90 -> V_36 ,
( T_5 ) V_90 -> V_102 , V_91 , V_171 ,
& V_51 ) ;
if ( V_93 ) {
F_4 ( V_2 , V_19 ,
L_33 ,
