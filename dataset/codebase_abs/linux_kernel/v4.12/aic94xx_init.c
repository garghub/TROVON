...
static int F_59 ( struct V_146 * V_47 , const struct V_147 * V_148 )
{
...
F_64 ( V_145 ) = & V_2 -> V_135 ;
V_2 -> V_135 . V_144 . V_145 = V_145 ;
V_145 -> V_158 = V_159 ;
V_145 -> V_160 = ~ 0 ;
V_145 -> V_161 = ~ 0 ;
V_145 -> V_162 = 16 ;
V_3 = F_65 ( V_145 , & V_47 -> V_47 ) ;
if ( V_3 )
goto V_163;
V_3 = V_150 -> V_164 ( V_2 ) ;
if ( V_3 )
goto V_165;
V_3 = - V_12 ;
if ( ! F_66 ( V_47 , F_67 ( 64 ) )
&& ! F_68 ( V_47 , F_67 ( 64 ) ) )
;
else if ( ! F_66 ( V_47 , F_67 ( 32 ) )
&& ! F_68 ( V_47 , F_67 ( 32 ) ) )
;
else {
F_5 ( L_29 , F_6 ( V_47 ) ) ;
...
if ( V_172 )
F_72 ( V_2 -> V_9 ) ;
V_3 = F_73 ( V_2 -> V_9 -> V_173 , V_174 , V_175 ,
V_14 , V_2 ) ;
if ( V_3 ) {
F_5 ( L_35 ,
