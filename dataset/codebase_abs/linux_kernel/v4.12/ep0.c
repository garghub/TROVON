...
V_2 = V_9 -> V_49 [ 0 ] ;
V_9 -> V_103 . V_2 = V_2 ;
V_9 -> V_103 . V_35 . V_104 = sizeof( * V_82 ) ;
V_9 -> V_103 . V_35 . V_105 = V_9 -> V_102 ;
V_9 -> V_103 . V_35 . F_28 = F_32 ;
return F_8 ( V_2 , & V_9 -> V_103 ) ;
}
static int F_36 ( struct V_8 * V_9 , enum V_106 V_107 ,
int V_108 )
{
T_2 V_80 ;
if ( V_107 != V_53 )
...
V_80 &= ~ V_92 ;
F_37 ( V_9 -> V_90 , V_91 , V_80 ) ;
return 0 ;
}
static int F_38 ( struct V_8 * V_9 , enum V_106 V_107 ,
int V_108 )
{
T_2 V_80 ;
if ( V_107 != V_53 )
...
static int F_39 ( struct V_8 * V_9 , enum V_106 V_107 ,
T_2 V_98 , int V_108 )
{
if ( ( V_98 & 0xff ) != 0 )
return - V_99 ;
...
struct V_78 * V_15 , int V_108 )
{
enum V_106 V_107 ;
T_2 V_116 ;
T_2 V_98 ;
int V_23 = 0 ;
V_116 = F_31 ( V_15 -> V_116 ) ;
V_98 = F_31 ( V_15 -> V_98 ) ;
V_107 = V_9 -> V_52 . V_107 ;
switch ( V_116 ) {
case V_117 :
break;
case V_118 :
V_23 = F_36 ( V_9 , V_107 , V_108 ) ;
break;
case V_119 :
V_23 = F_38 ( V_9 , V_107 , V_108 ) ;
break;
case V_120 :
V_23 = - V_99 ;
break;
case V_121 :
V_23 = F_39 ( V_9 , V_107 , V_98 , V_108 ) ;
break;
default:
V_23 = - V_99 ;
}
...
if ( ! V_2 )
return - V_99 ;
if ( V_108 == 0 && ( V_2 -> V_24 & V_123 ) )
break;
V_23 = F_22 ( V_2 , V_108 , true ) ;
if ( V_23 )
return - V_99 ;
break;
default:
...
switch ( V_79 ) {
case V_85 :
V_23 = F_40 ( V_9 , V_15 , V_108 ) ;
break;
case V_96 :
V_23 = F_41 ( V_9 , V_15 , V_108 ) ;
break;
case V_97 :
V_23 = F_42 ( V_9 , V_15 , V_108 ) ;
break;
default:
V_23 = - V_99 ;
}
...
{
enum V_106 V_107 = V_9 -> V_52 . V_107 ;
T_2 V_124 ;
T_2 V_80 ;
V_124 = F_31 ( V_15 -> V_116 ) ;
if ( V_124 > 127 ) {
...
V_80 = F_34 ( V_9 -> V_90 , V_125 ) ;
V_80 &= ~ ( V_126 ) ;
V_80 |= F_45 ( V_124 ) ;
F_37 ( V_9 -> V_90 , V_125 , V_80 ) ;
if ( V_124 )
F_12 ( & V_9 -> V_52 , V_127 ) ;
else
F_12 ( & V_9 -> V_52 , V_128 ) ;
...
int V_23 ;
memcpy ( & V_136 , V_34 -> V_105 , sizeof( V_136 ) ) ;
...
V_2 = V_9 -> V_49 [ 0 ] ;
V_9 -> V_103 . V_2 = V_2 ;
V_9 -> V_103 . V_35 . V_104 = V_2 -> V_61 . V_144 ;
V_9 -> V_103 . V_35 . V_105 = V_9 -> V_102 ;
V_9 -> V_103 . V_35 . F_28 = F_50 ;
return F_8 ( V_2 , & V_9 -> V_103 ) ;
}
...
V_9 -> V_55 = true ;
V_9 -> V_51 = ! ! ( V_15 -> V_83 & V_77 ) ;
V_9 -> V_31 = V_157 ;
}
if ( ( V_15 -> V_83 & V_158 ) == V_159 )
V_23 = F_54 ( V_9 , V_15 ) ;
else
V_23 = F_46 ( V_9 , V_15 ) ;
if ( V_23 == V_132 )
...
V_105 = V_161 -> V_105 ;
V_164 = V_161 -> V_104 ;
V_104 = V_7 -> V_14 & V_169 ;
V_163 = V_162 -> V_61 . V_144 ;
V_165 = V_161 -> V_104 - V_104 ;
V_161 -> V_36 += V_165 ;
if ( ( F_60 ( V_161 -> V_104 , V_162 -> V_61 . V_144 ) &&
V_161 -> V_104 && V_161 -> V_170 ) || V_9 -> V_171 ) {
V_7 ++ ;
V_7 -> V_15 &= ~ V_16 ;
F_58 ( V_162 , V_7 ) ;
V_162 -> V_11 = 0 ;
...
if ( ( V_39 & 1 ) && V_161 -> V_36 < V_161 -> V_104 )
F_21 ( V_9 ) ;
else
F_24 ( V_162 , V_160 , 0 ) ;
}
...
int V_23 ;
V_34 -> V_44 = ! ! V_2 -> V_40 ;
if ( V_34 -> V_35 . V_104 == 0 ) {
F_1 ( V_2 , V_9 -> V_27 , 0 ,
V_172 , false ) ;
V_23 = F_5 ( V_2 ) ;
} else if ( ! F_60 ( V_34 -> V_35 . V_104 , V_2 -> V_61 . V_144 )
&& ( V_2 -> V_40 == 0 ) ) {
T_2 V_144 ;
T_2 V_173 ;
V_23 = F_65 ( V_9 -> V_174 ,
...
V_34 -> V_35 . V_104 && V_34 -> V_35 . V_170 ) {
T_2 V_144 ;
T_2 V_173 ;
V_23 = F_65 ( V_9 -> V_174 ,
& V_34 -> V_35 , V_2 -> V_40 ) ;
