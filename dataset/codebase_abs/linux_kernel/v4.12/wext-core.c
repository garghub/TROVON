...
struct V_18 * V_19 ;
T_4 V_105 ;
if ( ( V_19 = F_55 ( V_3 , V_129 -> V_130 ) ) == NULL )
return - V_131 ;
if ( V_35 == V_132 )
return V_99 ( V_19 , V_129 , V_35 , V_89 ,
& F_42 ) ;
#ifdef F_44
if ( V_35 == V_133 && V_19 -> V_84 )
return V_99 ( V_19 , V_129 , V_35 , V_89 ,
V_134 ) ;
#endif
if ( ! F_56 ( V_19 ) )
...
if ( V_105 ) {
if ( V_35 < V_100 )
return V_99 ( V_19 , V_129 , V_35 , V_89 , V_105 ) ;
else if ( V_102 )
return V_102 ( V_19 , V_129 , V_35 , V_89 , V_105 ) ;
}
return - V_94 ;
}
static int F_57 ( unsigned int V_35 )
{
if ( ( F_46 ( V_35 ) || V_35 == V_135 ||
V_35 == V_136 ) &&
! F_58 ( V_137 ) )
return - V_138 ;
return 0 ;
...
if ( V_139 )
return V_139 ;
F_60 ( V_3 , V_129 -> V_130 ) ;
F_16 () ;
V_139 = F_54 ( V_3 , V_129 , V_35 , V_89 , V_99 , V_102 ) ;
F_17 () ;
return V_139 ;
}
...
V_40 = & ( V_58 [ F_27 ( V_35 ) ] ) ;
if ( V_40 -> V_61 != V_62 ) {
V_139 = V_105 ( V_19 , V_89 , & ( V_129 -> V_74 ) , NULL ) ;
if ( ( V_40 -> V_77 & V_125 ) &&
( ( V_139 == 0 ) || ( V_139 == - V_126 ) ) )
F_24 ( V_19 , V_35 , & ( V_129 -> V_74 ) , NULL ) ;
} else {
V_139 = F_45 ( & V_129 -> V_74 . V_63 , V_35 , V_40 ,
V_105 , V_19 , V_89 ) ;
}
if ( V_139 == - V_126 )
V_139 = F_52 ( V_19 ) ;
...
int V_139 ;
V_139 = F_59 ( V_3 , V_129 , V_35 , & V_89 ,
F_61 ,
V_141 ) ;
if ( V_139 >= 0 &&
F_49 ( V_35 ) &&
F_50 ( V_140 , V_129 , sizeof( struct V_128 ) ) )
return - V_115 ;
return V_139 ;
}
...
V_40 = V_58 + F_27 ( V_35 ) ;
if ( V_40 -> V_61 != V_62 )
return F_61 ( V_19 , V_129 , V_35 , V_89 , V_105 ) ;
V_142 = (struct V_52 * ) & V_129 -> V_74 . V_63 ;
V_104 . V_78 = F_64 ( V_142 -> V_78 ) ;
V_104 . V_64 = V_142 -> V_64 ;
V_104 . V_77 = V_142 -> V_77 ;
V_12 = F_45 ( & V_104 , V_35 , V_40 , V_105 , V_19 , V_89 ) ;
V_142 -> V_78 = F_65 ( V_104 . V_78 ) ;
V_142 -> V_64 = V_104 . V_64 ;
V_142 -> V_77 = V_104 . V_77 ;
return V_12 ;
}
int F_66 ( struct V_3 * V_3 , unsigned int V_35 ,
unsigned long V_140 )
{
void T_6 * V_143 = ( void T_6 * ) V_140 ;
struct V_88 V_89 ;
struct V_128 V_129 ;
char * V_144 ;
int V_139 ;
if ( F_47 ( & V_129 , V_143 , sizeof( struct V_128 ) ) )
return - V_115 ;
V_129 . V_130 [ V_145 - 1 ] = 0 ;
V_144 = strchr ( V_129 . V_130 , ':' ) ;
if ( V_144 )
* V_144 = 0 ;
V_89 . V_35 = V_35 ;
V_89 . V_77 = V_146 ;
...
if ( V_139 >= 0 &&
F_49 ( V_35 ) &&
F_50 ( V_143 , & V_129 , sizeof( struct V_128 ) ) )
return - V_115 ;
return V_139 ;
}
char * F_67 ( struct V_88 * V_89 , char * V_148 ,
char * V_149 , struct V_42 * V_150 , int V_44 )
{
int V_151 = F_68 ( V_89 ) ;
V_44 = F_69 ( V_89 , V_44 ) ;
if ( F_70 ( ( V_148 + V_44 ) < V_149 ) ) {
V_150 -> V_73 = V_44 ;
memcpy ( V_148 , ( char * ) V_150 , V_152 ) ;
memcpy ( V_148 + V_151 , & V_150 -> V_74 ,
V_44 - V_151 ) ;
V_148 += V_44 ;
}
return V_148 ;
}
char * F_71 ( struct V_88 * V_89 , char * V_148 ,
char * V_149 , struct V_42 * V_150 , char * V_38 )
{
int V_44 = F_72 ( V_89 ) + V_150 -> V_74 . V_63 . V_64 ;
int V_153 = F_72 ( V_89 ) ;
int V_151 = F_68 ( V_89 ) ;
if ( F_70 ( ( V_148 + V_44 ) < V_149 ) ) {
V_150 -> V_73 = V_44 ;
memcpy ( V_148 , ( char * ) V_150 , V_152 ) ;
memcpy ( V_148 + V_151 ,
( ( char * ) & V_150 -> V_74 ) + V_68 ,
V_154 - V_152 ) ;
if ( V_150 -> V_74 . V_63 . V_64 && V_38 )
memcpy ( V_148 + V_153 , V_38 , V_150 -> V_74 . V_63 . V_64 ) ;
V_148 += V_44 ;
}
return V_148 ;
}
char * F_73 ( struct V_88 * V_89 , char * V_43 ,
char * V_155 , char * V_149 , struct V_42 * V_150 ,
int V_44 )
{
int V_151 = F_68 ( V_89 ) ;
V_44 -= V_75 ;
if ( F_70 ( ( V_155 + V_44 ) < V_149 ) ) {
memcpy ( V_155 , & V_150 -> V_74 , V_44 ) ;
V_155 += V_44 ;
V_150 -> V_73 = V_155 - V_43 ;
memcpy ( V_43 , ( char * ) V_150 , V_151 ) ;
}
return V_155 ;
}
