...
F_117 ( V_175 , L_21 , V_180 ,
V_182 , V_181 , V_179 -> V_183 ,
V_179 -> V_184 , V_179 -> V_185 ) ;
}
return 0 ;
}
static void F_118 ( struct V_174 * V_175 , void * V_178 )
{ }
static int F_119 ( struct V_31 * V_31 , struct V_4 * V_4 )
{
return F_120 ( V_4 , & V_186 ) ;
}
static int F_121 ( struct V_141 * V_148 )
{
int V_124 ;
...
static T_2 F_123 ( struct V_4 * V_4 , char T_3 * V_6 ,
T_4 V_7 , T_5 * V_8 )
{
char * V_120 ;
T_7 V_81 , V_57 ;
...
static int F_124 ( struct V_141 * V_148 )
{
int V_124 ;
for ( V_124 = 1 ; V_124 <= V_194 ; V_124 ++ ) {
struct V_31 * V_31 ;
struct V_141 * V_141 ;
V_141 = F_102 ( V_148 , F_125 ( V_124 ) ) ;
if ( ! V_141 )
return - V_16 ;
...
static inline unsigned long F_126 ( T_8 V_197 )
{
return ( V_197 * ( V_198 + 1 ) ) | V_199 ;
}
static inline T_8 F_127 ( unsigned long V_27 )
{
return ( V_27 & V_138 ) / ( V_198 + 1 ) ;
}
static inline unsigned long F_128 ( T_8 V_197 , T_7 V_200 )
{
return ( V_197 * ( V_198 + 1 ) + V_200 ) | V_199 ;
}
static inline T_7 F_129 ( unsigned long V_27 )
{
return ( V_27 & V_138 ) % ( V_198 + 1 ) ;
}
...
char V_201 [ V_10 ] ;
T_2 V_57 = snprintf ( V_201 , sizeof( V_201 ) , L_1 , F_127 ( V_27 ) ) ;
...
unsigned long V_27 = F_21 ( V_4 ) -> V_28 ;
char V_201 [ V_10 ] ;
T_2 V_57 = snprintf ( V_201 , sizeof( V_201 ) , L_1 , F_129 ( V_27 ) ) ;
return F_5 ( V_6 , V_7 , V_8 , V_201 , V_57 ) ;
}
...
V_202 = F_133 ( V_28 & V_138 ) ;
V_11 = F_4 ( V_9 , V_10 , L_1 , V_202 ) ;
return F_5 ( V_6 , V_7 , V_8 , V_9 , V_11 ) ;
}
static int F_134 ( char * V_203 , int V_204 ,
struct V_141 * V_148 )
{
int V_124 , V_50 , V_205 ;
char * * V_206 ;
V_50 = F_135 ( V_203 , & V_206 , & V_205 ) ;
if ( V_50 )
return V_50 ;
...
static int F_136 ( char * V_208 , int V_137 ,
struct V_141 * V_148 )
{
struct V_141 * V_141 = NULL ;
struct V_31 * V_31 = NULL ;
int V_50 ;
V_141 = F_102 ( V_148 , L_25 ) ;
if ( ! V_141 )
return - V_16 ;
V_31 = F_88 ( V_148 -> V_155 , V_156 | V_157 ) ;
if ( ! V_31 )
return - V_16 ;
V_31 -> V_165 = & V_209 ;
V_31 -> V_28 = F_126 ( V_137 ) ;
F_104 ( V_141 , V_31 ) ;
V_141 = F_137 ( V_148 , L_26 , & V_210 ) ;
if ( F_8 ( V_141 ) )
return F_9 ( V_141 ) ;
V_50 = F_134 ( V_208 , V_137 , V_141 ) ;
return V_50 ;
}
...
char * * V_212 ;
F_98 ( V_213 ) ;
V_50 = F_138 ( & V_212 , & V_211 ) ;
if ( V_50 )
return V_50 ;
V_210 = F_126 ( V_211 + 2 ) ;
for ( V_124 = 0 ; V_124 < V_211 ; V_124 ++ ) {
struct V_141 * V_214 ;
V_214 = F_137 ( V_213 , V_212 [ V_124 ] ,
& V_210 ) ;
if ( F_8 ( V_214 ) ) {
V_50 = F_9 ( V_214 ) ;
goto V_18;
}
V_50 = F_136 ( V_212 [ V_124 ] , V_124 + 1 ,
V_214 ) ;
if ( V_50 )
goto V_18;
}
...
static struct V_141 * F_137 ( struct V_141 * V_148 , const char * V_139 ,
unsigned long * V_27 )
{
...
static int F_143 ( struct V_128 * V_129 , void * V_56 , int V_226 )
{
int V_58 ;
struct V_141 * V_141 ;
struct V_31 * V_31 ;
struct V_150 * V_151 ;
static const struct V_187 V_227 [] = {
[ V_228 ] = { L_28 , & V_229 , V_230 | V_158 } ,
[ V_231 ] = { L_29 , & V_232 , V_157 | V_158 } ,
[ V_233 ] = { L_30 , & V_234 , V_157 | V_235 } ,
[ V_236 ] = { L_31 , & V_234 , V_157 | V_235 } ,
[ V_237 ] = { L_32 , & V_234 , V_157 | V_235 } ,
[ V_238 ] = { L_33 , & V_234 , V_157 | V_235 } ,
[ V_239 ] = { L_34 , & V_234 , V_157 | V_235 } ,
[ V_240 ] = { L_35 , & V_241 , V_157 } ,
[ V_242 ] = { L_36 , & V_243 , V_158 } ,
[ V_244 ] = { L_37 , & V_245 , V_157 } ,
[ V_246 ] = { L_38 , & V_247 , V_158 } ,
[ V_248 ] = { L_39 , & V_234 , V_157 | V_235 } ,
[ V_249 ] = { L_40 , & V_250 , V_157 | V_158 } ,
[ V_30 ] = { L_41 , & V_251 , V_157 } ,
[ V_252 ] = { L_42 , & V_251 , V_157 } ,
[ V_253 ] = { L_43 , & V_254 , V_157 } ,
[ V_255 ] = { L_44 , & V_256 , V_157 } ,
[ V_257 ] = { L_45 , & V_258 ,
V_235 } ,
{ L_46 }
} ;
V_58 = F_144 ( V_129 , V_259 , V_227 ) ;
if ( V_58 )
goto V_53;
V_149 = F_137 ( V_129 -> V_260 , V_160 , & V_193 ) ;
if ( F_8 ( V_149 ) ) {
V_58 = F_9 ( V_149 ) ;
V_149 = NULL ;
goto V_53;
...
V_151 -> V_264 = V_265 ;
V_151 -> V_163 = V_164 ;
F_145 ( V_31 , V_262 | V_157 | V_235 , F_146 ( V_266 , 3 ) ) ;
F_104 ( V_141 , V_31 ) ;
V_267 . V_141 = V_141 ;
V_141 = F_137 ( V_129 -> V_260 , L_47 , & V_193 ) ;
if ( F_8 ( V_141 ) ) {
V_58 = F_9 ( V_141 ) ;
goto V_53;
}
...
if ( V_58 )
goto V_53;
V_141 = F_137 ( V_129 -> V_260 , L_48 , & V_193 ) ;
if ( F_8 ( V_141 ) ) {
V_58 = F_9 ( V_141 ) ;
goto V_53;
}
...
if ( V_58 )
goto V_53;
V_213 = F_137 ( V_129 -> V_260 , L_49 , & V_193 ) ;
if ( F_8 ( V_213 ) ) {
V_58 = F_9 ( V_213 ) ;
V_213 = NULL ;
goto V_53;
}
V_216 = F_137 ( V_129 -> V_260 , L_50 , & V_193 ) ;
if ( F_8 ( V_216 ) ) {
V_58 = F_9 ( V_216 ) ;
V_216 = NULL ;
goto V_53;
...
static struct V_141 * F_147 ( struct V_268 * V_269 ,
int V_63 , const char * V_270 , void * V_56 )
{
return F_148 ( V_269 , V_63 , V_56 , F_143 ) ;
}
