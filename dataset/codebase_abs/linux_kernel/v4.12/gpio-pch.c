...
V_77 = F_41 ( & V_94 -> V_34 , V_94 -> V_56 , F_22 ,
V_110 , V_101 , V_7 ) ;
if ( V_77 != 0 ) {
F_32 ( & V_94 -> V_34 ,
L_9 , V_57 ) ;
...
static int F_49 ( struct V_93 * V_94 , T_5 V_112 )
{
T_4 V_77 ;
struct V_6 * V_7 = F_48 ( V_94 ) ;
unsigned long V_8 ;
