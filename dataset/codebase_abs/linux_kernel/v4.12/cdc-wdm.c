...
{
struct V_1 * V_4 = F_58 ( V_120 , struct V_1 , V_55 ) ;
unsigned long V_15 ;
int V_33 = 0 ;
int V_34 ;
F_48 ( & V_4 -> V_10 , V_15 ) ;
...
F_64 ( & V_4 -> V_16 ) ;
V_4 -> V_27 = V_123 ;
V_4 -> V_92 = F_38 ( ( T_7 ) V_3 -> V_125 -> V_4 . V_126 ) ;
V_4 -> V_3 = V_3 ;
F_65 ( & V_4 -> V_55 , F_57 ) ;
V_33 = - V_127 ;
if ( ! F_66 ( V_122 ) )
...
V_4 -> V_59 = F_30 ( sizeof( struct V_70 ) , V_72 ) ;
if ( ! V_4 -> V_59 )
goto V_99;
V_4 -> V_60 = F_30 ( sizeof( struct V_70 ) , V_72 ) ;
if ( ! V_4 -> V_60 )
goto V_99;
...
if ( ! V_4 -> V_57 )
goto V_99;
V_4 -> V_29 = F_30 ( V_4 -> V_27 , V_72 ) ;
if ( ! V_4 -> V_29 )
goto V_99;
V_4 -> V_37 = F_30 ( V_4 -> V_128 , V_72 ) ;
if ( ! V_4 -> V_37 )
goto V_99;
V_4 -> V_30 = F_30 ( V_4 -> V_27 , V_72 ) ;
if ( ! V_4 -> V_30 )
goto V_99;
F_69 (
V_4 -> V_58 ,
F_36 ( V_3 ) ,
F_70 ( F_36 ( V_3 ) , V_122 -> V_129 ) ,
V_4 -> V_37 ,
V_4 -> V_128 ,
F_16 ,
V_4 ,
...
if ( ! V_62 )
goto V_99;
F_79 ( & V_142 , V_3 , V_62 , V_145 ) ;
if ( V_142 . V_149 )
V_147 = F_17 ( V_142 . V_149 -> V_27 ) ;
V_140 = V_3 -> V_125 ;
if ( V_140 -> V_4 . V_150 != 1 )
goto V_99;
V_122 = & V_140 -> V_151 [ 0 ] . V_4 ;
V_33 = F_59 ( V_3 , V_122 , V_147 , & F_77 ) ;
V_99:
return V_33 ;
}
struct V_152 * F_80 ( struct V_2 * V_3 ,
struct V_121 * V_122 ,
int V_123 ,
...
static int F_86 ( struct V_2 * V_3 , T_8 V_154 )
{
