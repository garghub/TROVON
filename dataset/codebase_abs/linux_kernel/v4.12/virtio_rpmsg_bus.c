...
F_7 ( & V_6 -> V_49 ) ;
F_62 ( & V_6 -> V_65 ) ;
V_32 = F_63 ( V_17 , 2 , V_79 , V_77 , V_78 , NULL ) ;
if ( V_32 )
goto V_84;
V_6 -> V_71 = V_79 [ 0 ] ;
V_6 -> V_54 = V_79 [ 1 ] ;
F_64 ( F_65 ( V_6 -> V_71 ) !=
F_65 ( V_6 -> V_54 ) ) ;
if ( F_65 ( V_6 -> V_71 ) < V_85 / 2 )
V_6 -> V_51 = F_65 ( V_6 -> V_71 ) * 2 ;
else
V_6 -> V_51 = V_85 ;
V_82 = V_6 -> V_51 * V_53 ;
V_80 = F_66 ( V_17 -> V_16 . V_47 -> V_47 ,
V_82 , & V_6 -> V_86 ,
V_18 ) ;
if ( ! V_80 ) {
V_32 = - V_64 ;
...
struct V_58 V_59 ;
void * V_89 = V_6 -> V_88 + V_81 * V_53 ;
F_40 ( & V_59 , V_89 , V_53 ) ;
V_32 = F_53 ( V_6 -> V_71 , & V_59 , 1 , V_89 ,
V_18 ) ;
F_64 ( V_32 ) ;
}
F_33 ( V_6 -> V_54 ) ;
...
return 0 ;
V_91:
F_70 ( V_17 -> V_16 . V_47 -> V_47 , V_82 ,
V_80 , V_6 -> V_86 ) ;
V_87:
V_17 -> V_92 -> V_93 ( V_6 -> V_17 ) ;
V_84:
F_3 ( V_6 ) ;
return V_32 ;
}
static int F_71 ( struct V_15 * V_16 , void * V_56 )
{
F_72 ( V_16 ) ;
return 0 ;
}
static void F_73 ( struct V_76 * V_17 )
{
struct V_5 * V_6 = V_17 -> V_10 ;
T_4 V_82 = V_6 -> V_51 * V_53 ;
int V_44 ;
V_17 -> V_92 -> V_94 ( V_17 ) ;
V_44 = F_74 ( & V_17 -> V_16 , NULL , F_71 ) ;
if ( V_44 )
