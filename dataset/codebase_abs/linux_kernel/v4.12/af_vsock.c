...
V_147 = F_98 ( V_6 , V_128 -> V_130 & V_193 ) ;
V_94 = V_1 -> V_194 ( V_4 , & V_189 ) ;
if ( V_94 < 0 )
goto V_44;
while ( V_187 < V_129 ) {
T_9 V_195 ;
F_110 ( F_81 ( V_6 ) , & V_110 ) ;
while ( F_72 ( V_4 ) == 0 &&
V_6 -> V_112 == 0 &&
! ( V_6 -> V_90 & V_107 ) &&
! ( V_4 -> V_80 & V_106 ) ) {
...
static int
F_113 ( struct V_65 * V_5 , struct V_127 * V_128 , T_5 V_129 ,
int V_137 )
{
struct V_5 * V_6 ;
struct V_3 * V_4 ;
...
V_202 = F_115 ( V_6 , V_137 & V_206 , V_129 ) ;
if ( V_202 >= V_1 -> V_207 ( V_4 ) ) {
V_94 = - V_200 ;
goto V_44;
}
V_147 = F_116 ( V_6 , V_137 & V_193 ) ;
V_203 = 0 ;
V_94 = V_1 -> V_208 ( V_4 , V_202 , & V_205 ) ;
if ( V_94 < 0 )
goto V_44;
while ( 1 ) {
T_3 V_209 ;
...
static int F_117 ( struct V_64 * V_64 , struct V_65 * V_5 ,
int V_216 , int V_68 )
{
if ( ! V_5 )
return - V_60 ;
if ( V_216 && V_216 != V_217 )
return - V_218 ;
switch ( V_5 -> type ) {
case V_63 :
V_5 -> V_219 = & V_220 ;
...
V_5 -> V_97 = V_104 ;
return F_58 ( V_64 , V_5 , NULL , V_223 , 0 , V_68 ) ? 0 : - V_200 ;
}
static long F_118 ( struct V_109 * V_224 ,
unsigned int V_225 , void T_6 * V_226 )
{
T_1 T_6 * V_227 = V_226 ;
int V_59 = 0 ;
switch ( V_225 ) {
case V_228 :
if ( F_107 ( V_1 -> V_2 () , V_227 ) != 0 )
V_59 = - V_186 ;
break;
default:
F_119 ( L_1 , V_225 ) ;
...
static long F_120 ( struct V_109 * V_224 ,
unsigned int V_225 , unsigned long V_229 )
{
return F_118 ( V_224 , V_225 , ( void T_6 * ) V_229 ) ;
}
static long F_121 ( struct V_109 * V_224 ,
unsigned int V_225 , unsigned long V_229 )
{
return F_118 ( V_224 , V_225 , F_122 ( V_229 ) ) ;
}
int F_123 ( const struct V_230 * V_231 , struct V_232 * V_82 )
{
int V_94 = F_124 ( & V_233 ) ;
if ( V_94 )
return V_94 ;
if ( V_1 ) {
V_94 = - V_234 ;
