...
V_28 -> V_67 = V_67 ;
V_28 -> V_68 . V_69 = V_70 ;
if ( ! strncmp ( V_10 -> V_54 , L_6 , 15 ) )
V_47 = 0x3 ;
V_26 -> V_71 = ( F_18 ( V_8 -> V_13 + V_10 -> V_72 ) >> 4 ) & V_47 ;
snprintf ( V_26 -> V_54 , sizeof( V_26 -> V_54 ) , L_7 , V_26 -> V_71 , V_29 ) ;
if ( F_16 ( V_30 , V_73 ) == 0xFF ) {
F_11 ( L_8 , V_30 ) ;
V_31 = - V_34 ;
goto V_49;
}
...
V_6 -> V_12 = V_8 ;
V_6 -> V_11 . V_74 = F_1 ;
V_6 -> V_11 . V_75 = F_20 ( & V_20 -> V_26 ,
V_35 , L_9 ,
V_26 -> V_71 , V_29 ) ;
V_6 -> V_11 . V_54 = F_20 ( & V_20 -> V_26 , V_35 ,
L_10 ,
V_26 -> V_71 , V_29 ) ;
V_6 -> V_11 . V_26 = & V_26 -> V_26 ;
V_6 -> V_17 . V_74 = F_4 ;
V_6 -> V_17 . V_75 = F_20 ( & V_20 -> V_26 ,
V_35 , L_11 ,
V_26 -> V_71 , V_29 ) ;
V_6 -> V_17 . V_54 = F_20 ( & V_20 -> V_26 , V_35 ,
L_12 ,
V_26 -> V_71 , V_29 ) ;
V_6 -> V_17 . V_26 = & V_26 -> V_26 ;
V_6 -> V_26 = V_26 ;
V_31 = F_21 ( & V_20 -> V_26 , & V_6 -> V_11 ) ;
if ( V_31 )
goto V_49;
V_31 = F_21 ( & V_20 -> V_26 , & V_6 -> V_17 ) ;
if ( V_31 )
goto V_49;
F_22 ( & V_26 -> V_26 , V_6 ) ;
V_31 = F_23 ( V_26 , V_76 ) ;
if ( V_31 )
goto V_49;
F_24 ( V_26 , V_26 -> V_71 , V_29 ) ;
F_25 ( & V_6 -> V_77 , & V_8 -> V_39 ) ;
}
F_26 ( V_20 , V_8 ) ;
return 0 ;
V_49:
...
struct V_7 * V_8 ;
V_8 = F_28 ( V_20 ) ;
F_29 (card, tmpcard, &priv->list_dev, list) {
