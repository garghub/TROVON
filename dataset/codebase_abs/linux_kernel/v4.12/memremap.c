...
goto V_53;
F_44 () ;
error = F_61 ( V_48 , V_25 , V_26 , true ) ;
F_46 () ;
if ( error )
goto V_54;
F_39 (pfn, page_map) {
struct V_55 * V_55 = F_8 ( V_4 ) ;
F_62 ( & V_55 -> V_56 ) ;
V_55 -> V_36 = V_36 ;
F_63 ( V_41 ) ;
}
...
{
return V_38 -> V_57 + V_38 -> free ;
}
void F_64 ( struct V_37 * V_38 , unsigned long V_58 )
{
V_38 -> V_43 -= V_58 ;
}
struct V_37 * F_65 ( unsigned long V_59 )
{
struct V_55 * V_55 = (struct V_55 * ) V_59 ;
struct V_35 * V_36 ;
F_54 () ;
V_36 = F_49 ( F_66 ( F_67 ( V_55 ) ) ) ;
F_55 () ;
