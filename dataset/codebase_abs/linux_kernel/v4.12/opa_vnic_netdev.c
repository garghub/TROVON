...
struct V_22 * V_23 ;
int V_24 ;
V_23 = (struct V_22 * ) F_12 ( V_14 , sizeof( * V_23 ) ) ;
...
F_20 () ;
V_2 -> V_48 = F_21 (unsigned int, info->vesw.eth_mtu_non_vlan,
netdev->min_mtu) ;
...
static int F_27 ( struct V_1 * V_2 , void * V_64 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
...
static void F_29 ( struct V_1 * V_2 , T_4 V_69 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
struct V_70 * V_71 ;
struct V_72 * V_73 ;
...
F_30 (ha, hw_list) {
V_76 = F_31 ( V_76 , V_71 -> V_64 , V_44 ) ;
}
V_75 = F_32 ( V_73 ) * V_44 ;
V_76 = ~ F_31 ( V_76 , ( void * ) & V_75 , sizeof( V_75 ) ) ;
if ( V_76 != * V_74 ) {
* V_74 = V_76 ;
F_28 ( V_6 , V_69 ) ;
}
...
struct V_5 * F_36 ( struct V_87 * V_88 ,
T_4 V_32 , T_4 V_89 )
{
struct V_5 * V_6 ;
struct V_1 * V_2 ;
