...
V_2 -> V_187 = 240 ;
V_2 -> V_188 = V_189 ;
strcpy ( V_2 -> V_190 . V_17 , V_2 -> V_17 ) ;
...
V_2 -> V_24 = V_144 ;
if ( V_196 [ V_2 -> V_169 ] < F_8 ( V_70 ) )
V_2 -> V_24 = V_196 [ V_2 -> V_169 ] ;
for ( V_37 = 0 ; V_2 -> V_24 == V_144 && V_37 < F_8 ( V_197 ) ; V_37 ++ )
if ( V_67 -> V_68 == V_197 [ V_37 ] . V_198 &&
V_67 -> V_69 == V_197 [ V_37 ] . V_199 )
V_2 -> V_24 = V_197 [ V_37 ] . V_196 ;
if ( V_2 -> V_24 == V_144 ) {
V_2 -> V_24 = V_200 ;
F_28 ( V_2 , V_67 ) ;
}
...
V_2 -> V_24 , V_196 [ V_2 -> V_169 ] == V_2 -> V_24 ?
L_38 : L_39 ,
V_2 -> V_4 . V_201 ) ;
