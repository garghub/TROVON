...
F_135 ( & V_4 -> V_297 ) ;
F_136 ( & V_4 -> V_17 ) ;
F_137 ( & V_4 -> V_407 , F_121 ) ;
F_127 ( & V_2 -> V_413 ) ;
F_137 ( & V_2 -> V_407 , V_418 ) ;
return 0 ;
}
...
static int F_141 ( struct V_307 * V_408 )
{
struct V_1 * V_2 = F_77 ( V_408 ) ;
struct V_3 * V_4 = V_2 -> V_4 ;
struct V_92 * V_93 = F_17 ( V_2 -> V_94 ) ;
...
struct V_365 * V_421 ,
const struct V_365 * V_422 ,
const char * V_423 )
{
* V_421 = * V_422 ;
V_421 -> V_17 = & V_2 -> V_4 -> V_17 ;
V_421 -> V_413 = & V_2 -> V_413 ;
if ( V_2 -> V_5 . V_6 )
V_421 -> V_335 = 0 ;
snprintf ( V_421 -> V_205 , sizeof( V_421 -> V_205 ) , L_62 ,
F_144 ( & V_2 -> V_94 -> V_2 ) , V_423 ) ;
F_145 ( V_421 , V_2 ) ;
}
static void F_146 ( struct V_1 * V_2 , unsigned short V_424 )
{
struct V_3 * V_4 = V_2 -> V_4 ;
...
V_426 . V_427 = V_428 | V_429 ;
V_426 . V_430 = V_431 ;
if ( V_2 -> V_5 . V_432 . type ) {
V_426 . type = V_2 -> V_5 . V_432 . type ;
V_426 . V_358 = V_2 -> V_5 . V_433 ;
F_5 ( V_17 ,
0 , V_252 , V_434 , & V_426 ) ;
}
if ( ( V_2 -> V_221 != V_222 ) && ( V_2 -> V_221 ) ) {
V_426 . type = V_2 -> V_221 ;
V_426 . V_358 = V_424 ;
F_5 ( V_17 ,
0 , V_252 , V_434 , & V_426 ) ;
}
...
F_132 ( & V_2 -> V_413 ) ;
V_4 = F_149 ( sizeof( struct V_3 ) , V_446 ) ;
if ( ! V_4 ) {
F_127 ( & V_2 -> V_413 ) ;
return - V_447 ;
}
...
#endif
V_43 = F_151 ( & V_2 -> V_94 -> V_2 , & V_4 -> V_17 ) ;
if ( V_43 < 0 ) {
F_19 ( & V_2 -> V_94 -> V_2 ,
L_64 ) ;
goto V_448;
...
unsigned short V_424 = V_2 -> V_5 . V_424 ;
int V_461 = ( V_2 -> V_5 . V_435 & V_462 ) ;
if ( V_2 -> V_5 . V_432 . type )
F_153 ( & V_4 -> V_17 ,
& V_2 -> V_452 [ V_2 -> V_453 ] ,
L_69 , V_2 -> V_5 . V_433 ,
...
F_159 ( F_160 ( V_445 , V_291 ) ,
F_72 , V_2 ) ;
F_159 ( F_160 ( V_445 , V_294 ) ,
F_72 , V_2 ) ;
}
F_4 ( V_2 ) ;
F_161 ( & V_2 -> V_156 . V_147 ) ;
F_161 ( & V_2 -> V_158 . V_147 ) ;
if ( V_2 -> V_5 . V_280 ) {
...
( V_480 | V_293 ) ) ;
F_9 ( V_2 ) ;
if ( NULL == F_160 ( V_445 , V_298 ) )
F_158 ( V_445 , & V_475 ,
V_298 ,
0 , 0x1f , 1 , V_25 ) ;
if ( NULL == F_160 ( V_445 , V_299 ) )
F_158 ( V_445 , & V_475 ,
V_299 ,
- 0x80 , 0x7f , 1 , V_27 ) ;
if ( NULL == F_160 ( V_445 , V_300 ) )
F_158 ( V_445 , & V_475 ,
V_300 ,
0 , 0x1f , 1 , V_29 ) ;
if ( NULL == F_160 ( V_445 , V_301 ) )
F_158 ( V_445 , & V_475 ,
V_301 ,
- 0x30 , 0x30 , 1 , V_31 ) ;
if ( NULL == F_160 ( V_445 , V_302 ) )
F_158 ( V_445 , & V_475 ,
V_302 ,
- 0x30 , 0x30 , 1 , V_33 ) ;
if ( NULL == F_160 ( V_445 , V_303 ) )
F_158 ( V_445 , & V_475 ,
V_303 ,
0 , 0x0f , 1 , V_35 ) ;
F_7 ( V_2 ) ;
...
if ( V_43 )
goto V_471;
F_143 ( V_2 , & V_4 -> V_208 , & V_481 , L_73 ) ;
F_164 ( & V_4 -> V_482 ) ;
F_164 ( & V_4 -> V_483 ) ;
...
if ( V_2 -> V_378 == V_379 ) {
F_165 ( & V_4 -> V_208 , V_493 ) ;
F_165 ( & V_4 -> V_208 , V_494 ) ;
}
V_43 = F_166 ( & V_4 -> V_208 , V_371 ,
V_495 [ V_2 -> V_496 ] ) ;
if ( V_43 ) {
F_19 ( & V_2 -> V_94 -> V_2 ,
L_74 , V_43 ) ;
...
if ( F_3 ( V_2 ) == 1 ) {
F_143 ( V_2 , & V_4 -> V_210 , & V_481 ,
L_75 ) ;
V_4 -> V_210 . V_484 = & V_4 -> V_272 ;
V_4 -> V_210 . V_484 -> V_413 = & V_4 -> V_483 ;
F_165 ( & V_4 -> V_210 , V_488 ) ;
if ( V_2 -> V_221 == V_222 ) {
F_165 ( & V_4 -> V_210 , V_489 ) ;
F_165 ( & V_4 -> V_210 , V_490 ) ;
F_165 ( & V_4 -> V_210 , V_491 ) ;
F_165 ( & V_4 -> V_210 , V_492 ) ;
}
if ( V_2 -> V_378 == V_379 ) {
F_165 ( & V_4 -> V_210 , V_493 ) ;
F_165 ( & V_4 -> V_210 , V_494 ) ;
}
V_43 = F_166 ( & V_4 -> V_210 , V_410 ,
V_497 [ V_2 -> V_496 ] ) ;
if ( V_43 < 0 ) {
F_19 ( & V_2 -> V_94 -> V_2 ,
L_76 ) ;
...
if ( V_368 [ V_2 -> V_369 ] . V_432 . type == V_498 ) {
F_143 ( V_2 , & V_4 -> V_383 , & V_499 ,
L_77 ) ;
V_43 = F_166 ( & V_4 -> V_383 , V_249 ,
V_500 [ V_2 -> V_496 ] ) ;
if ( V_43 < 0 ) {
F_19 ( & V_2 -> V_94 -> V_2 ,
L_78 ) ;
