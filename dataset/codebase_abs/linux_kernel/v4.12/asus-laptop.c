...
static void F_116 ( struct V_200 * V_35 , V_137 V_195 )
{
struct V_19 * V_20 = F_117 ( V_35 ) ;
T_5 V_11 ;
V_11 = V_20 -> V_201 [ V_195 % 128 ] ++ ;
F_118 ( V_20 -> V_35 -> V_202 . V_203 ,
F_119 ( & V_20 -> V_35 -> V_38 ) , V_195 ,
V_11 ) ;
...
F_120 ( & V_20 -> F_12 -> V_37 -> V_38 . V_210 ,
V_211 ) ;
return ;
}
F_106 ( V_20 , V_195 ) ;
}
static T_6 F_121 ( struct V_212 * V_210 ,
struct V_213 * V_118 ,
int V_214 )
{
struct V_35 * V_38 = F_26 ( V_210 , struct V_35 , V_210 ) ;
struct V_59 * V_215 = F_122 ( V_38 ) ;
struct V_19 * V_20 = F_123 ( V_215 ) ;
T_1 V_1 = V_20 -> V_1 ;
bool V_216 ;
if ( V_20 -> V_50 ) {
if ( V_118 == & V_217 . V_118 )
V_216 = true ;
else if ( V_118 == & V_218 . V_118 )
V_216 = false ;
else
goto V_219;
return V_216 ? V_118 -> V_220 : 0 ;
}
V_219:
if ( V_118 == & V_221 . V_118 ) {
V_216 = ! F_4 ( V_1 , V_96 , NULL ) ;
} else if ( V_118 == & V_222 . V_118 ) {
V_216 = ! F_4 ( V_1 , V_98 , NULL ) ;
} else if ( V_118 == & V_223 . V_118 ) {
V_216 = ! F_4 ( V_1 , V_148 , NULL ) ;
} else if ( V_118 == & V_224 . V_118 ) {
V_216 =
! F_4 ( V_20 -> V_1 , V_144 , NULL ) ;
} else if ( V_118 == & V_225 . V_118 ) {
V_216 = ! F_4 ( V_20 -> V_1 , V_146 , NULL ) ;
} else if ( V_118 == & V_226 . V_118 ) {
V_216 = ! F_4 ( V_1 , V_136 , NULL ) ;
} else if ( V_118 == & V_217 . V_118 ||
V_118 == & V_218 . V_118 ) {
V_216 = ! F_4 ( V_1 , V_151 , NULL ) &&
! F_4 ( V_1 , V_153 , NULL ) ;
} else if ( V_118 == & V_227 . V_118 ) {
V_216 = V_20 -> V_50 ;
} else if ( V_118 == & V_228 . V_118 ) {
V_216 = ! F_4 ( V_1 , V_166 , NULL ) &&
! F_4 ( V_1 , V_167 , NULL ) &&
! F_4 ( V_1 , V_164 , NULL ) ;
} else {
V_216 = true ;
...
{
int V_156 ;
V_20 -> V_59 = F_125 ( V_113 , - 1 ) ;
if ( ! V_20 -> V_59 )
return - V_51 ;
F_126 ( V_20 -> V_59 , V_20 ) ;
V_156 = F_127 ( V_20 -> V_59 ) ;
if ( V_156 )
goto V_229;
V_156 = F_128 ( & V_20 -> V_59 -> V_38 . V_210 ,
& V_230 ) ;
if ( V_156 )
goto V_231;
return 0 ;
...
{
F_132 ( & V_20 -> V_59 -> V_38 . V_210 , & V_230 ) ;
F_133 ( V_20 -> V_59 ) ;
}
static int F_134 ( struct V_19 * V_20 )
{
struct V_4 V_157 = { V_158 , NULL } ;
union V_8 * V_232 = NULL ;
unsigned long long V_233 ;
char * string = NULL ;
T_2 V_10 ;
V_10 = F_135 ( V_234 , 1 , & V_20 -> V_126 ) ;
if ( F_31 ( V_10 ) )
F_6 ( L_61 ) ;
...
V_10 =
F_10 ( V_20 -> V_1 , L_64 , NULL , & V_233 ) ;
if ( F_31 ( V_10 ) )
F_6 ( L_65 ) ;
else if ( V_233 )
F_136 ( L_66 ,
( V_125 ) V_233 ) ;
if ( F_3 ( V_20 -> V_1 , L_67 , V_235 ) )
F_54 ( L_68 , V_235 ) ;
if ( V_157 . V_12 ) {
V_232 = V_157 . V_12 ;
switch ( V_232 -> type ) {
case V_236 :
string = V_232 -> string . V_12 ;
break;
case V_237 :
string = V_232 -> V_157 . V_12 ;
break;
default:
string = L_69 ;
break;
...
{
int V_156 = 0 ;
V_156 = F_140 ( V_20 -> V_35 ) ;
if ( V_156 )
return V_156 ;
if ( ! V_20 -> V_35 -> V_10 . V_239 ) {
F_54 ( L_71 ) ;
return - V_17 ;
}
V_156 = F_134 ( V_20 ) ;
...
if ( ! V_232 )
return;
if ( strncmp ( V_232 , L_74 , 6 ) == 0 ) {
V_241 = - 1 ;
}
}
static int F_143 ( struct V_200 * V_35 )
{
struct V_19 * V_20 ;
int V_156 ;
F_136 ( L_75 ,
V_124 ) ;
V_20 = F_144 ( sizeof( struct V_19 ) , V_238 ) ;
if ( ! V_20 )
return - V_51 ;
V_20 -> V_1 = V_35 -> V_1 ;
strcpy ( F_145 ( V_35 ) , V_246 ) ;
...
static int F_148 ( struct V_200 * V_35 )
{
struct V_19 * V_20 = F_117 ( V_35 ) ;
F_57 ( V_20 ) ;
F_98 ( V_20 ) ;
