...
T_5
F_104 ( struct V_94 * V_95 , unsigned char * V_205 )
{
struct V_96 * V_97 = V_95 -> V_98 ;
T_5 V_33 ;
if ( F_105 ( V_205 ) > V_206 ) {
F_4 ( L_100
L_101 ,
F_105 ( V_205 ) , V_206 ) ;
return V_195 ;
}
if ( F_105 ( V_205 ) > sizeof( V_95 -> V_207 ) ) {
V_95 -> V_193 = F_21 ( F_105 ( V_205 ) ,
V_38 ) ;
if ( ! V_95 -> V_193 ) {
F_4 ( L_102
L_103 ,
...
memcpy ( V_95 -> V_193 , V_205 , F_105 ( V_205 ) ) ;
F_106 ( V_95 ) ;
...
if ( V_72 & V_231 )
V_94 -> V_192 = 1 ;
V_33 = F_115 ( V_94 , V_72 & V_232 ) ;
if ( V_33 )
return V_33 ;
if ( V_72 & V_233 )
V_94 -> V_115 |= V_234 ;
V_46 = F_116 ( V_94 , V_225 ) ;
if ( V_46 ) {
F_117 ( V_94 , V_46 , 0 ) ;
F_118 ( V_94 ) ;
return 0 ;
}
V_46 = F_104 ( V_94 , V_205 ) ;
if ( V_46 != 0 ) {
F_70 ( V_94 , V_46 ) ;
return 0 ;
}
...
if ( V_216 )
V_60 = F_119 ( F_120 ( V_216 ) ) + V_216 -> V_238 ;
if ( V_60 ) {
...
T_1 V_145 , int V_196 , int V_226 , int V_72 )
{
return F_114 ( V_94 , V_37 , V_205 , V_224 ,
...
F_100 ( V_94 , V_53 -> V_59 , V_37 ,
0 , V_158 , V_246 , V_224 ) ;
V_33 = F_126 ( V_94 , V_243 , V_244 , V_245 ) ;
if ( V_33 < 0 )
return - V_28 ;
if ( V_244 == V_247 )
...
V_33 = F_128 ( V_94 , V_225 ) ;
if ( V_33 ) {
F_74 ( & V_94 -> V_120 , F_124 ) ;
F_129 ( & V_94 -> V_120 ) ;
return 0 ;
}
F_130 ( V_94 ) ;
...
return;
F_33 ( L_110
L_111 , V_95 , V_95 -> V_107 , V_95 -> V_193 [ 0 ] ) ;
F_33 ( L_112 ,
...
return;
V_278:
F_135 ( V_95 , V_95 -> V_98 , V_33 , false ) ;
}
void F_136 ( struct V_94 * V_95 , bool V_280 )
{
T_5 V_33 ;
if ( ! V_95 -> V_281 ) {
V_33 = V_121 ;
...
break;
V_191 = V_95 -> V_145 >> F_142 ( V_95 -> V_98 -> V_166 . V_167 ) ;
V_95 -> V_285 = F_143 ( V_95 , V_95 -> V_286 ,
...
static bool F_145 ( struct V_94 * V_95 )
{
struct V_96 * V_97 = V_95 -> V_98 ;
if ( V_97 -> V_127 -> V_202 & V_203 )
return false ;
...
static void F_132 ( struct V_94 * V_95 )
{
struct V_96 * V_97 = V_95 -> V_98 ;
if ( V_97 -> V_127 -> V_202 & V_203 )
return;
...
static void F_135 ( struct V_94 * V_95 , struct V_96 * V_97 ,
...
F_129 ( & V_95 -> V_98 -> V_148 ) ;
}
static bool F_153 ( struct V_94 * V_95 )
{
switch ( V_95 -> V_75 ) {
case V_303 :
if ( ! ( V_95 -> V_37 -> V_36 & V_303 ) ) {
T_1 V_191 = V_95 -> V_145 >>
F_142 ( V_95 -> V_98 -> V_166 . V_167 ) ;
V_95 -> V_285 = F_143 ( V_95 , V_95 -> V_286 ,
V_191 , 0 , V_95 -> V_235 ,
0 ) ;
if ( V_95 -> V_285 )
...
V_278:
F_33 ( L_121
L_122 , V_95 , V_95 -> V_157 ) ;
F_135 ( V_95 , V_95 -> V_98 , V_33 , false ) ;
}
void F_155 ( struct V_215 * V_216 , int V_310 )
{
struct V_215 * V_311 ;
int V_312 ;
F_156 (sgl, sg, nents, count)
F_157 ( F_120 ( V_311 ) ) ;
F_52 ( V_216 ) ;
}
...
static inline void F_159 ( struct V_94 * V_95 )
{
if ( ! ( V_95 -> V_115 & V_237 ) ) {
F_155 ( V_95 -> V_235 , V_95 -> V_236 ) ;
V_95 -> V_235 = NULL ;
V_95 -> V_236 = 0 ;
}
if ( V_95 -> V_115 & V_223 ) {
...
F_158 ( V_95 ) ;
F_155 ( V_95 -> V_134 , V_95 -> V_220 ) ;
V_95 -> V_134 = NULL ;
V_95 -> V_220 = 0 ;
F_155 ( V_95 -> V_221 , V_95 -> V_222 ) ;
V_95 -> V_221 = NULL ;
V_95 -> V_222 = 0 ;
}
...
F_10 ( ! V_311 ) ;
if ( V_95 -> V_220 == 1 )
return F_119 ( F_120 ( V_311 ) ) + V_311 -> V_238 ;
V_315 = F_161 ( V_95 -> V_220 , sizeof( * V_315 ) , V_38 ) ;
if ( ! V_315 )
return NULL ;
F_156 (cmd->t_data_sg, sg, cmd->t_data_nents, i) {
V_315 [ V_183 ] = F_120 ( V_311 ) ;
}
V_95 -> V_316 = F_162 ( V_315 , V_95 -> V_220 , V_317 , V_318 ) ;
F_52 ( V_315 ) ;
if ( ! V_95 -> V_316 )
return NULL ;
return V_95 -> V_316 + V_95 -> V_134 [ 0 ] . V_238 ;
}
void F_163 ( struct V_94 * V_95 )
{
if ( ! V_95 -> V_220 ) {
return;
} else if ( V_95 -> V_220 == 1 ) {
F_121 ( F_120 ( V_95 -> V_134 ) ) ;
return;
}
F_164 ( V_95 -> V_316 ) ;
V_95 -> V_316 = NULL ;
...
int
F_165 ( struct V_215 * * V_216 , unsigned int * V_310 , T_1 V_143 ,
...
int V_183 = 0 ;
V_323 = V_324 = F_166 ( V_143 , V_83 ) ;
if ( V_320 )
V_323 ++ ;
V_311 = F_161 ( V_323 , sizeof( struct V_215 ) , V_38 ) ;
if ( ! V_311 )
return - V_28 ;
F_167 ( V_311 , V_323 ) ;
while ( V_143 ) {
...
if ( V_95 -> V_75 != V_326 &&
! ( V_95 -> V_115 & V_237 ) ) {
V_33 = F_165 ( & V_95 -> V_235 , & V_95 -> V_236 ,
...
V_327 = V_95 -> V_145 ;
V_33 = F_165 ( & V_95 -> V_221 ,
& V_95 -> V_222 ,
V_327 , V_321 , false ) ;
if ( V_33 < 0 )
return V_121 ;
}
V_33 = F_165 ( & V_95 -> V_134 , & V_95 -> V_220 ,
...
V_278:
F_33 ( L_123 , V_95 ) ;
F_135 ( V_95 , V_95 -> V_98 , V_33 , true ) ;
return 0 ;
}
...
int F_115 ( struct V_94 * V_94 , bool V_114 )
{
...
static int F_152 ( struct V_94 * V_95 , T_5 V_347 )
{
...
static int F_149 ( struct V_94 * V_95 , int V_363 )
__releases( &cmd->t_state_lock
int F_131 ( struct V_94 * V_95 , int V_363 )
{
int V_33 ;
F_30 ( & V_95 -> V_103 ) ;
V_33 = F_149 ( V_95 , V_363 ) ;
F_32 ( & V_95 -> V_103 ) ;
return V_33 ;
}
