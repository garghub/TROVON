...
goto V_99;
V_159 = (struct V_158 * ) F_79 ( V_9 -> V_42 , F_78 ( V_67 ) ) ;
V_159 -> V_161 = V_162 ;
V_159 -> V_163 = V_160 ;
...
if ( V_200 [ V_204 ] ) {
T_1 V_68 = V_83 -> V_91 ;
V_202 = F_81 ( V_200 [ V_204 ] ) ;
switch ( V_202 -> V_205 ) {
case V_206 :
return F_94 ( V_2 , V_68 , & V_207 ) ;
case V_208 :
F_95 ( V_2 , V_68 ) ;
return 0 ;
}
...
if ( V_200 [ V_220 ] ) {
T_6 V_50 = F_107 ( V_200 [ V_220 ] ) ;
F_41 ( V_9 , F_106 ( V_50 ) ) ;
}
if ( V_200 [ V_221 ] ) {
T_6 V_35 = F_107 ( V_200 [ V_221 ] ) ;
F_40 ( V_9 , F_106 ( V_35 ) ) ;
}
if ( V_200 [ V_222 ] ) {
T_6 V_51 = F_107 ( V_200 [ V_222 ] ) ;
F_42 ( V_9 , F_106 ( V_51 ) ) ;
}
if ( V_200 [ V_211 ] )
F_43 ( V_9 , V_52 ) ;
...
static struct V_194 * F_108 ( struct V_2 * V_2 , struct V_223 * V_224 )
{
struct V_1 * log ;
if ( ! V_224 )
return NULL ;
...
static struct V_194 * F_112 ( struct V_2 * V_2 , struct V_223 * V_224 ,
struct V_194 * V_226 )
{
V_226 = F_110 ( F_113 ( V_226 ) ) ;
while ( ! V_226 ) {
struct V_1 * log ;
struct V_7 * V_8 ;
if ( ++ V_224 -> V_225 >= V_5 )
...
V_226 = F_110 ( F_111 ( V_8 ) ) ;
}
return V_226 ;
}
static struct V_194 * F_114 ( struct V_2 * V_2 , struct V_223 * V_224 ,
T_9 V_227 )
{
struct V_194 * V_8 ;
V_8 = F_108 ( V_2 , V_224 ) ;
if ( V_8 )
while ( V_227 && ( V_8 = F_112 ( V_2 , V_224 , V_8 ) ) )
V_227 -- ;
return V_227 ? NULL : V_8 ;
}
static void * F_115 ( struct V_228 * V_229 , T_9 * V_227 )
__acquires( T_10 )
{
F_9 () ;
return F_114 ( F_116 ( V_229 ) , V_229 -> V_230 , * V_227 ) ;
}
static void * F_117 ( struct V_228 * V_229 , void * V_231 , T_9 * V_227 )
{
( * V_227 ) ++ ;
return F_112 ( F_116 ( V_229 ) , V_229 -> V_230 , V_231 ) ;
}
static void F_118 ( struct V_228 * V_229 , void * V_231 )
__releases( T_10 )
{
F_11 () ;
}
static int F_119 ( struct V_228 * V_229 , void * V_231 )
{
...
static int F_122 ( struct V_232 * V_232 , struct V_140 * V_140 )
{
return F_123 ( V_232 , V_140 , & V_233 ,
sizeof( struct V_223 ) ) ;
}
...
F_25 ( & log -> V_19 ) ;
#ifdef F_125
V_235 = F_127 ( L_5 , 0440 ,
V_2 -> V_238 . V_239 , & V_240 ) ;
if ( ! V_235 )
return - V_23 ;
V_236 = F_128 ( V_2 -> V_17 , 0 ) ;
V_237 = F_129 ( V_2 -> V_17 , 0 ) ;
if ( F_130 ( V_236 ) && F_131 ( V_237 ) )
F_132 ( V_235 , V_236 , V_237 ) ;
#endif
return 0 ;
}
