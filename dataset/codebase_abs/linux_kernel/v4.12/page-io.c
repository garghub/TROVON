...
( unsigned long long )
V_71 >> ( V_39 -> V_77 - 9 ) ) ;
F_12 ( V_39 -> V_78 , V_10 -> V_25 ) ;
}
if ( V_31 -> V_34 & V_35 ) {
V_10 -> V_37 = F_66 ( & V_31 -> V_10 , V_10 ) ;
F_56 ( V_31 ) ;
} else {
F_56 ( V_31 ) ;
F_7 ( V_10 ) ;
...
void F_67 ( struct F_67 * V_38 )
{
struct V_10 * V_10 = V_38 -> V_79 ;
if ( V_10 ) {
int V_80 = V_38 -> V_81 -> V_82 == V_83 ?
V_84 : 0 ;
F_68 ( V_38 -> V_79 , V_85 , V_80 ) ;
F_69 ( V_38 -> V_79 ) ;
}
V_38 -> V_79 = NULL ;
}
void F_70 ( struct F_67 * V_38 ,
struct V_86 * V_87 )
{
V_38 -> V_81 = V_87 ;
V_38 -> V_79 = NULL ;
...
static int F_71 ( struct F_67 * V_38 ,
struct V_5 * V_6 )
{
struct V_10 * V_10 ;
V_10 = F_72 ( V_88 , V_89 ) ;
...
static int F_74 ( struct F_67 * V_38 ,
struct V_39 * V_39 ,
struct V_14 * V_14 ,
struct V_5 * V_6 )
{
int V_42 ;
if ( V_38 -> V_79 && V_6 -> V_9 != V_38 -> V_90 ) {
V_91:
F_67 ( V_38 ) ;
}
if ( V_38 -> V_79 == NULL ) {
...
V_42 = F_75 ( V_38 -> V_79 , V_14 , V_6 -> V_29 , F_16 ( V_6 ) ) ;
if ( V_42 != V_6 -> V_29 )
goto V_91;
F_76 ( V_38 -> V_81 , V_14 , V_6 -> V_29 ) ;
V_38 -> V_90 ++ ;
return 0 ;
}
int F_77 ( struct F_67 * V_38 ,
struct V_14 * V_14 ,
int V_92 ,
struct V_86 * V_87 ,
bool V_93 )
{
struct V_14 * V_16 = NULL ;
struct V_39 * V_39 = V_14 -> V_24 -> V_94 ;
unsigned V_95 ;
struct V_5 * V_6 , * V_17 ;
int V_42 = 0 ;
int V_96 = 0 ;
...
V_6 = V_17 = F_13 ( V_14 ) ;
if ( F_94 ( V_39 ) && F_95 ( V_39 -> V_99 ) &&
V_97 ) {
T_6 V_100 = V_101 ;
V_102:
V_16 = F_96 ( V_39 , V_14 , V_98 , 0 ,
V_14 -> V_103 , V_100 ) ;
if ( F_97 ( V_16 ) ) {
V_42 = F_98 ( V_16 ) ;
if ( V_42 == - V_4 && V_87 -> V_82 == V_83 ) {
if ( V_38 -> V_79 ) {
F_67 ( V_38 ) ;
F_99 ( V_104 , V_105 / 50 ) ;
}
