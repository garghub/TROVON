...
if ( V_3 -> V_43 > 0 )
F_24 ( V_2 , 1 ) ;
V_3 -> V_48 = F_25 ( V_2 , V_54 , & V_57 ,
V_58 ) ;
if ( F_26 ( V_3 -> V_48 ) )
return F_27 ( V_3 -> V_48 ) ;
if ( V_3 -> V_43 > 0 ) {
V_4 = F_28 ( V_2 , V_3 -> V_43 , NULL ,
F_17 ,
V_59 | V_60 ,
V_54 , V_2 ) ;
if ( V_4 ) {
...
V_73 -> V_79 = 8 ;
F_45 ( V_73 ) ;
V_74 = F_3 ( V_7 , V_29 , & V_75 ) ;
if ( V_74 )
return V_74 ;
V_74 = F_3 ( V_7 , V_12 , & V_75 ) ;
if ( V_74 )
return V_74 ;
V_74 = F_5 ( V_7 , V_12 , V_75 & 0x1c ) ;
if ( V_74 )
return V_74 ;
V_74 = F_3 ( V_7 , V_8 , & V_75 ) ;
if ( V_74 )
return V_74 ;
V_74 = F_5 ( V_7 , V_8 , V_75 & 0x88 ) ;
if ( V_74 )
return V_74 ;
V_74 = F_3 ( V_7 , V_12 , & V_75 ) ;
if ( V_74 )
return V_74 ;
F_46 ( & V_73 -> V_2 , L_9 , V_75 ) ;
V_74 = F_3 ( V_7 , V_8 , & V_75 ) ;
if ( V_74 )
return V_74 ;
F_46 ( & V_73 -> V_2 , L_10 , V_75 ) ;
return F_21 ( & V_73 -> V_2 , V_7 , V_73 -> V_43 , L_11 ) ;
}
