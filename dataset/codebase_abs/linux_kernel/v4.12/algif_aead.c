...
static int F_77 ( struct V_48 * V_1 )
{
int V_38 = 0 ;
struct V_1 * V_115 ;
struct V_3 * V_116 ;
...
static int F_80 ( struct V_48 * V_1 , struct V_49 * V_50 ,
T_1 V_51 )
{
int V_38 ;
V_38 = F_77 ( V_1 ) ;
if ( V_38 )
return V_38 ;
return F_31 ( V_1 , V_50 , V_51 ) ;
}
static T_2 F_81 ( struct V_48 * V_1 , struct V_75 * V_75 ,
int V_66 , T_1 V_51 , int V_35 )
{
int V_38 ;
V_38 = F_77 ( V_1 ) ;
if ( V_38 )
return V_38 ;
return F_41 ( V_1 , V_75 , V_66 , V_51 , V_35 ) ;
}
static int F_82 ( struct V_48 * V_1 , struct V_49 * V_50 ,
T_1 V_110 , int V_35 )
{
int V_38 ;
V_38 = F_77 ( V_1 ) ;
if ( V_38 )
return V_38 ;
return F_73 ( V_1 , V_50 , V_110 , V_35 ) ;
}
static void * F_83 ( const char * V_124 , V_101 type , V_101 V_112 )
{
struct V_117 * V_84 ;
struct V_83 * V_125 ;
V_84 = F_84 ( sizeof( * V_84 ) , V_71 ) ;
if ( ! V_84 )
return F_85 ( - V_72 ) ;
V_125 = F_86 ( V_124 , type , V_112 ) ;
if ( F_87 ( V_125 ) ) {
F_88 ( V_84 ) ;
return F_89 ( V_125 ) ;
}
...
static void F_90 ( void * V_7 )
{
struct V_117 * V_84 = V_7 ;
F_91 ( V_84 -> V_125 ) ;
F_88 ( V_84 ) ;
}
static int F_92 ( void * V_7 , unsigned int V_126 )
{
struct V_117 * V_84 = V_7 ;
return F_93 ( V_84 -> V_125 , V_126 ) ;
}
static int F_94 ( void * V_7 , const T_4 * V_127 , unsigned int V_128 )
{
struct V_117 * V_84 = V_7 ;
int V_38 ;
V_38 = F_95 ( V_84 -> V_125 , V_127 , V_128 ) ;
V_84 -> V_123 = ! V_38 ;
return V_38 ;
}
...
F_7 ( & V_6 -> V_13 ) ) ;
F_97 ( F_98 ( & V_2 -> V_129 ) != 0 ) ;
F_10 ( V_2 ) ;
F_99 ( V_2 , V_6 -> V_62 , V_63 ) ;
F_49 ( V_2 , V_6 , V_6 -> V_65 ) ;
F_100 ( V_2 ) ;
}
static int F_101 ( void * V_7 , struct V_1 * V_2 )
{
struct V_5 * V_6 ;
struct V_3 * V_4 = F_2 ( V_2 ) ;
struct V_117 * V_84 = V_7 ;
struct V_83 * V_125 = V_84 -> V_125 ;
unsigned int V_65 = sizeof( * V_6 ) + F_102 ( V_125 ) ;
unsigned int V_63 = F_32 ( V_125 ) ;
...
static int F_104 ( void * V_7 , struct V_1 * V_2 )
{
struct V_117 * V_84 = V_7 ;
if ( ! V_84 -> V_123 )
return - V_121 ;
return F_101 ( V_7 , V_2 ) ;
}
