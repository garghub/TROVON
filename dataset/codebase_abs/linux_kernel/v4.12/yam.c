...
static void F_47 ( struct V_44 * V_32 , struct V_45 * V_46 )
{
...
static void F_48 ( struct V_44 * V_32 )
{
struct V_45 * V_46 = F_28 ( V_32 ) ;
...
static void F_54 ( struct V_44 * V_32 , struct V_45 * V_46 )
{
struct V_68 * V_69 ;
...
static T_2 F_58 ( int V_118 , void * V_119 )
{
struct V_44 * V_32 ;
struct V_45 * V_46 ;
unsigned char V_120 ;
...
static void * F_60 ( struct V_135 * V_136 , T_3 * V_137 )
{
return ( * V_137 < V_101 ) ? V_102 [ * V_137 ] : NULL ;
}
static void * F_61 ( struct V_135 * V_136 , void * V_138 , T_3 * V_137 )
{
++ * V_137 ;
return ( * V_137 < V_101 ) ? V_102 [ * V_137 ] : NULL ;
}
static void F_62 ( struct V_135 * V_136 , void * V_138 )
{
}
static int F_63 ( struct V_135 * V_136 , void * V_138 )
{
struct V_44 * V_32 = V_138 ;
const struct V_45 * V_46 = F_28 ( V_32 ) ;
F_64 ( V_136 , L_9 , V_32 -> V_73 ) ;
F_64 ( V_136 , L_10 , F_52 ( V_32 ) ) ;
F_64 ( V_136 , L_11 , V_46 -> V_17 ) ;
F_64 ( V_136 , L_12 , V_46 -> V_5 ) ;
F_64 ( V_136 , L_13 , V_46 -> V_48 ) ;
F_64 ( V_136 , L_14 , V_46 -> V_118 ) ;
F_64 ( V_136 , L_15 , V_46 -> V_88 ) ;
F_64 ( V_136 , L_16 , V_46 -> V_96 ) ;
F_64 ( V_136 , L_17 , V_46 -> V_116 ) ;
F_64 ( V_136 , L_18 , V_46 -> V_90 ) ;
F_64 ( V_136 , L_19 , V_46 -> V_115 ) ;
F_64 ( V_136 , L_20 , V_46 -> V_98 ) ;
F_64 ( V_136 , L_21 , V_46 -> V_99 ) ;
F_64 ( V_136 , L_22 , V_32 -> V_74 . V_117 ) ;
F_64 ( V_136 , L_23 , V_32 -> V_74 . V_79 ) ;
F_64 ( V_136 , L_24 , V_46 -> V_131 ) ;
F_64 ( V_136 , L_25 , V_46 -> V_133 ) ;
F_64 ( V_136 , L_26 , V_32 -> V_74 . V_128 ) ;
F_64 ( V_136 , L_27 ) ;
return 0 ;
}
static int F_65 ( struct V_139 * V_139 , struct V_140 * V_140 )
{
return F_66 ( V_140 , & V_141 ) ;
}
static int F_67 ( struct V_44 * V_32 )
{
struct V_45 * V_46 = F_28 ( V_32 ) ;
enum V_53 V_57 ;
int V_40 ;
...
if ( ! F_68 ( V_32 -> V_49 , V_145 , V_32 -> V_73 ) )
{
...
F_5 ( 0 , F_6 ( V_32 -> V_49 ) ) ;
if ( F_69 ( V_32 -> V_118 , F_58 , V_149 , V_32 -> V_73 , V_32 ) ) {
...
return 0 ;
V_148:
F_71 ( V_32 -> V_49 , V_145 ) ;
return V_142 ;
}
static int F_72 ( struct V_44 * V_32 )
{
struct V_68 * V_69 ;
struct V_45 * V_46 = F_28 ( V_32 ) ;
if ( ! V_32 )
...
F_73 ( V_32 -> V_118 , V_32 ) ;
F_71 ( V_32 -> V_49 , V_145 ) ;
F_74 ( V_32 ) ;
while ( ( V_69 = F_55 ( & V_46 -> V_86 ) ) )
F_75 ( V_69 ) ;
F_20 ( V_143 L_34 ,
V_154 , V_32 -> V_49 , V_32 -> V_118 ) ;
return 0 ;
}
static int F_76 ( struct V_44 * V_32 , struct V_155 * V_156 , int V_157 )
{
struct V_45 * V_46 = F_28 ( V_32 ) ;
struct V_158 V_159 ;
struct V_160 * V_161 ;
int V_162 ;
if ( F_77 ( & V_162 , V_156 -> V_163 , sizeof( int ) ) )
return - V_164 ;
if ( V_46 -> V_93 != V_94 )
return - V_153 ;
if ( ! F_78 ( V_165 ) )
...
if ( ! F_78 ( V_172 ) )
return - V_166 ;
if ( F_77 ( & V_159 , V_156 -> V_163 , sizeof( struct V_158 ) ) )
return - V_164 ;
if ( ( V_159 . V_173 . V_174 & V_175 ) && F_52 ( V_32 ) )
return - V_153 ;
if ( ( V_159 . V_173 . V_174 & V_176 ) && F_52 ( V_32 ) )
return - V_153 ;
if ( ( V_159 . V_173 . V_174 & V_177 ) && F_52 ( V_32 ) )
return - V_153 ;
if ( ( V_159 . V_173 . V_174 & V_178 ) && F_52 ( V_32 ) )
return - V_153 ;
if ( V_159 . V_173 . V_174 & V_175 ) {
V_46 -> V_5 = V_159 . V_173 . V_5 ;
V_32 -> V_49 = V_159 . V_173 . V_5 ;
}
if ( V_159 . V_173 . V_174 & V_176 ) {
if ( V_159 . V_173 . V_118 > 15 )
return - V_153 ;
V_46 -> V_118 = V_159 . V_173 . V_118 ;
V_32 -> V_118 = V_159 . V_173 . V_118 ;
}
if ( V_159 . V_173 . V_174 & V_177 ) {
if ( V_159 . V_173 . V_17 > V_170 )
return - V_153 ;
V_46 -> V_17 = V_159 . V_173 . V_17 ;
}
if ( V_159 . V_173 . V_174 & V_178 ) {
if ( V_159 . V_173 . V_48 > V_179 )
return - V_153 ;
V_46 -> V_48 = V_159 . V_173 . V_48 ;
}
if ( V_159 . V_173 . V_174 & V_180 ) {
if ( V_159 . V_173 . V_181 > V_182 )
return - V_153 ;
V_46 -> V_96 = V_159 . V_173 . V_181 ;
}
if ( V_159 . V_173 . V_174 & V_183 ) {
if ( V_159 . V_173 . V_184 > V_185 )
return - V_153 ;
V_46 -> V_116 = V_159 . V_173 . V_184 ;
}
if ( V_159 . V_173 . V_174 & V_186 ) {
if ( V_159 . V_173 . V_187 > V_188 )
return - V_153 ;
V_46 -> V_90 = V_159 . V_173 . V_187 ;
}
if ( V_159 . V_173 . V_174 & V_189 ) {
if ( V_159 . V_173 . V_115 > V_190 )
return - V_153 ;
V_46 -> V_115 = V_159 . V_173 . V_115 ;
}
if ( V_159 . V_173 . V_174 & V_191 ) {
if ( V_159 . V_173 . V_192 > V_193 )
return - V_153 ;
V_46 -> V_99 = V_159 . V_173 . V_192 ;
}
if ( V_159 . V_173 . V_174 & V_194 ) {
if ( V_159 . V_173 . V_195 > V_196 )
return - V_153 ;
V_46 -> V_98 = V_159 . V_173 . V_195 ;
V_46 -> V_97 = V_46 -> V_98 / 10 ;
}
break;
case V_197 :
memset ( & V_159 , 0 , sizeof( V_159 ) ) ;
V_159 . V_173 . V_174 = 0xffffffff ;
V_159 . V_173 . V_5 = V_46 -> V_5 ;
V_159 . V_173 . V_118 = V_46 -> V_118 ;
V_159 . V_173 . V_17 = V_46 -> V_17 ;
V_159 . V_173 . V_48 = V_46 -> V_48 ;
V_159 . V_173 . V_181 = V_46 -> V_96 ;
V_159 . V_173 . V_187 = V_46 -> V_90 ;
V_159 . V_173 . V_184 = V_46 -> V_116 ;
V_159 . V_173 . V_115 = V_46 -> V_115 ;
V_159 . V_173 . V_192 = V_46 -> V_99 ;
V_159 . V_173 . V_195 = V_46 -> V_98 ;
if ( F_82 ( V_156 -> V_163 , & V_159 , sizeof( struct V_158 ) ) )
return - V_164 ;
break;
default:
return - V_153 ;
...
static int F_83 ( struct V_44 * V_32 , void * V_198 )
{
struct V_199 * V_200 = (struct V_199 * ) V_198 ;
memcpy ( V_32 -> V_201 , V_200 -> V_202 , V_32 -> V_203 ) ;
return 0 ;
}
static void F_84 ( struct V_44 * V_32 )
{
struct V_45 * V_46 = F_28 ( V_32 ) ;
V_46 -> V_93 = V_94 ;
V_46 -> V_17 = V_204 ;
...
V_32 -> V_217 = V_218 ;
V_32 -> V_203 = V_219 ;
memcpy ( V_32 -> V_220 , & V_221 , V_219 ) ;
memcpy ( V_32 -> V_201 , & V_222 , V_219 ) ;
}
...
V_32 = F_87 ( sizeof( struct V_45 ) , V_73 ,
V_225 , F_84 ) ;
if ( ! V_32 ) {
F_88 ( L_36 ) ;
V_28 = - V_226 ;
...
V_103 . V_104 = V_3 + V_4 / 100 ;
F_53 ( & V_103 ) ;
F_90 ( L_1 , V_228 , V_229 . V_230 , & V_231 ) ;
return 0 ;
error:
while ( -- V_40 >= 0 ) {
F_91 ( V_102 [ V_40 ] ) ;
