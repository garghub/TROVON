...
const struct V_35 *
F_39 ( const struct V_35 * V_38 ,
int V_39 , unsigned int V_34 )
{
return bsearch ( ( void * ) ( V_40 ) V_34 , V_38 , V_39 ,
sizeof( V_38 [ 0 ] ) , F_38 ) ;
}
...
void F_43 ( struct V_1 * V_2 , struct V_41 * V_42 )
{
if ( V_43 . type == V_44 )
F_44 ( V_2 , V_42 ) ;
else
...
{
unsigned long V_45 = F_47 ( V_5 , V_4 ) ;
switch ( V_4 ) {
case 1 :
return V_45 ;
case 2 :
...
void F_51 ( void * V_46 , unsigned int V_4 ,
unsigned long V_45 )
{
switch ( V_4 ) {
case 1 :
...
static
struct V_47 * F_56 ( const struct V_48 * V_49 )
{
return F_57 ( V_49 , struct V_47 , V_49 ) ;
}
static bool F_58 ( const struct V_11 * V_11 ,
const struct V_35 * V_36 ,
T_1 V_3 , int V_4 )
{
int V_50 , V_25 = V_11 -> V_26 . V_27 . V_28 + V_19 ;
switch ( V_4 ) {
case sizeof( V_51 ) :
V_50 = V_52 ;
break;
...
if ( ( V_36 -> V_55 & V_50 ) && F_59 ( V_3 , V_4 ) ) {
if ( ! V_36 -> V_56 )
return true ;
return F_5 ( V_3 , V_36 -> V_56 ) < V_25 ;
}
return false ;
}
const struct V_35 *
F_60 ( struct V_1 * V_2 , struct V_47 * V_57 ,
T_1 V_3 , int V_4 )
{
const struct V_35 * V_36 ;
V_36 = F_39 ( V_57 -> V_38 , V_57 -> V_39 ,
V_3 - V_57 -> V_58 ) ;
if ( ! V_36 || ! F_58 ( V_2 -> V_11 , V_36 , V_3 , V_4 ) )
return NULL ;
return V_36 ;
}
static int F_61 ( struct V_1 * V_2 , struct V_48 * V_49 ,
T_1 V_3 , T_2 * V_5 )
{
struct V_47 * V_57 = F_56 ( V_49 ) ;
const struct V_35 * V_36 ;
struct V_1 * V_59 ;
V_36 = F_60 ( V_2 , V_57 , V_3 , sizeof( T_2 ) ) ;
if ( ! V_36 ) {
* V_5 = 0 ;
return 0 ;
}
V_59 = V_57 -> V_60 ? V_57 -> V_60 : V_2 ;
if ( V_36 -> V_61 )
...
static int F_62 ( struct V_1 * V_2 , struct V_48 * V_49 ,
...
int F_63 ( struct V_1 * V_2 , struct V_47 * V_49 ,
bool V_65 , int V_34 , T_2 * V_5 )
{
if ( V_65 )
return F_62 ( V_2 , & V_49 -> V_49 , V_34 , V_5 ) ;
else
return F_61 ( V_2 , & V_49 -> V_49 , V_34 , V_5 ) ;
}
static int F_64 ( struct V_1 * V_2 , struct V_48 * V_49 ,
T_1 V_3 , int V_4 , void * V_5 )
{
struct V_47 * V_57 = F_56 ( V_49 ) ;
const struct V_35 * V_36 ;
unsigned long V_45 = 0 ;
V_36 = F_60 ( V_2 , V_57 , V_3 , V_4 ) ;
if ( ! V_36 ) {
memset ( V_5 , 0 , V_4 ) ;
return 0 ;
}
switch ( V_57 -> V_66 ) {
case V_67 :
V_45 = V_36 -> V_62 ( V_2 , V_3 , V_4 ) ;
break;
case V_68 :
V_45 = V_36 -> V_62 ( V_2 , V_3 , V_4 ) ;
break;
case V_69 :
V_45 = V_36 -> V_62 ( V_57 -> V_60 , V_3 , V_4 ) ;
break;
case V_70 :
V_45 = V_36 -> V_71 ( V_2 -> V_11 , V_57 -> V_72 , V_3 , V_4 ) ;
break;
}
F_51 ( V_5 , V_4 , V_45 ) ;
return 0 ;
}
static int F_65 ( struct V_1 * V_2 , struct V_48 * V_49 ,
T_1 V_3 , int V_4 , const void * V_5 )
{
struct V_47 * V_57 = F_56 ( V_49 ) ;
const struct V_35 * V_36 ;
unsigned long V_45 = F_46 ( V_5 , V_4 ) ;
V_36 = F_60 ( V_2 , V_57 , V_3 , V_4 ) ;
if ( ! V_36 )
return 0 ;
switch ( V_57 -> V_66 ) {
case V_67 :
V_36 -> V_64 ( V_2 , V_3 , V_4 , V_45 ) ;
break;
case V_68 :
V_36 -> V_64 ( V_2 , V_3 , V_4 , V_45 ) ;
break;
case V_69 :
V_36 -> V_64 ( V_57 -> V_60 , V_3 , V_4 , V_45 ) ;
break;
case V_70 :
V_36 -> V_73 ( V_2 -> V_11 , V_57 -> V_72 , V_3 , V_4 , V_45 ) ;
break;
}
return 0 ;
}
...
enum V_75 type )
{
struct V_47 * V_76 = & V_11 -> V_26 . V_27 . V_77 ;
int V_78 = 0 ;
unsigned int V_4 ;
switch ( type ) {
case V_44 :
