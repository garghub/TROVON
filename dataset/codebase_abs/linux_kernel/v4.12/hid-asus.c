...
{
int V_58 ;
const unsigned char V_55 [] = { V_122 , 0x00 , 0x03 , 0x01 , 0x00 } ;
...
static int F_41 ( struct V_44 * V_45 , const struct V_123 * V_32 )
{
int V_58 ;
struct V_49 * V_50 ;
...
static T_4 * F_48 ( struct V_44 * V_45 , T_4 * V_129 ,
unsigned int * V_130 )
{
struct V_49 * V_50 = F_12 ( V_45 ) ;
if ( V_50 -> V_51 & V_131 &&
* V_130 >= 56 && V_129 [ 54 ] == 0x25 && V_129 [ 55 ] == 0x65 ) {
F_49 ( V_45 , L_16 ) ;
V_129 [ 55 ] = 0xdd ;
}
if ( V_50 -> V_51 & V_132 &&
* V_130 == 76 && V_129 [ 73 ] == 0x81 && V_129 [ 74 ] == 0x01 ) {
F_49 ( V_45 , L_17 ) ;
V_129 [ 74 ] &= ~ V_133 ;
}
return V_129 ;
