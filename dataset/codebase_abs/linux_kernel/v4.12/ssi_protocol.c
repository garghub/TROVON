...
V_23 -> V_62 = F_136 ( 0 , V_138 , V_140 , F_125 ) ;
if ( ! V_23 -> V_62 ) {
F_59 ( V_79 , L_67 ) ;
V_112 = - V_38 ;
goto V_97;
}
V_23 -> V_62 -> V_141 = V_142 ;
V_23 -> V_62 -> V_143 = V_144 ;
