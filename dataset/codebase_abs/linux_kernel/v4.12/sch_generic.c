...
#ifdef F_105
if ( V_22 -> V_53 != & V_113 )
F_121 ( V_22 -> V_53 , false ) ;
#endif
}
static void F_122 ( struct V_26 * V_22 ,
struct V_9 * V_21 ,
void * V_123 )
{
...
return;
V_127 = 0 ;
F_120 ( V_22 , F_122 , & V_127 ) ;
if ( F_125 ( V_22 ) )
F_122 ( V_22 , F_125 ( V_22 ) , NULL ) ;
if ( V_127 ) {
F_126 ( V_22 ) ;
F_52 ( V_22 ) ;
}
}
static void F_127 ( struct V_26 * V_22 ,
struct V_9 * V_21 ,
void * V_128 )
{
...
F_112 ( F_27 ( V_53 ) ) ;
if ( ! ( V_53 -> V_24 & V_107 ) )
F_128 ( V_126 , & V_53 -> V_49 ) ;
F_114 ( V_21 -> V_53 , V_129 ) ;
F_97 ( V_53 ) ;
F_115 ( F_27 ( V_53 ) ) ;
}
}
static bool F_129 ( struct V_26 * V_22 )
{
unsigned int V_35 ;
for ( V_35 = 0 ; V_35 < V_22 -> V_37 ; V_35 ++ ) {
struct V_9 * V_21 ;
...
void F_132 ( struct V_131 * V_71 )
{
struct V_26 * V_22 ;
bool V_132 = false ;
F_133 (dev, head, close_list) {
F_120 ( V_22 , F_127 ,
& V_113 ) ;
if ( F_125 ( V_22 ) )
F_127 ( V_22 , F_125 ( V_22 ) ,
& V_113 ) ;
F_53 ( V_22 ) ;
V_132 |= ! V_22 -> V_133 ;
}
...
void F_136 ( struct V_26 * V_22 )
{
F_137 ( V_134 ) ;
F_138 ( & V_22 -> V_135 , & V_134 ) ;
F_132 ( & V_134 ) ;
F_139 ( & V_134 ) ;
}
static void F_140 ( struct V_26 * V_22 ,
struct V_9 * V_21 ,
void * V_136 )
{
...
void F_141 ( struct V_26 * V_22 )
{
V_22 -> V_53 = & V_113 ;
F_120 ( V_22 , F_140 , & V_113 ) ;
if ( F_125 ( V_22 ) )
F_140 ( V_22 , F_125 ( V_22 ) , & V_113 ) ;
F_142 ( & V_22 -> V_46 , F_37 , ( unsigned long ) V_22 ) ;
}
...
{
F_120 ( V_22 , F_143 , & V_113 ) ;
if ( F_125 ( V_22 ) )
F_143 ( V_22 , F_125 ( V_22 ) , & V_113 ) ;
F_96 ( V_22 -> V_53 ) ;
V_22 -> V_53 = & V_113 ;
F_145 ( F_146 ( & V_22 -> V_46 ) ) ;
}
void F_147 ( struct V_137 * V_138 ,
const struct V_139 * V_140 ,
T_2 V_141 )
{
memset ( V_138 , 0 , sizeof( * V_138 ) ) ;
V_138 -> V_142 = V_140 -> V_142 ;
V_138 -> V_143 = F_148 ( T_2 , V_140 -> V_144 , V_141 ) ;
V_138 -> V_145 = ( V_140 -> V_145 & V_146 ) ;
V_138 -> V_147 = 1 ;
if ( V_138 -> V_143 > 0 ) {
T_2 V_148 = V_149 ;
for (; ; ) {
V_138 -> V_147 = F_149 ( V_148 , V_138 -> V_143 ) ;
