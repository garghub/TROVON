...
void
F_13 ( const struct V_17 * V_3 ,
struct V_6 * V_7 , int V_11 ,
struct V_1 * V_2 )
{
const char * V_18 = V_19 [ V_11 ] ;
V_2 -> V_3 = V_3 ;
V_2 -> V_7 = V_7 ;
V_2 -> V_11 = V_11 ;
F_14 ( & V_2 -> V_20 , V_18 , & V_21 [ V_11 ] ) ;
V_2 -> V_22 = F_15 ( V_7 -> V_23 , V_18 ) ;
}
