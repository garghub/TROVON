...
int F_20 ( struct V_9 * V_10 , struct V_14 * V_15 )
{
int V_76 ;
V_76 = F_8 ( V_10 , V_15 ) ;
if ( V_76 < 0 )
...
void F_21 ( struct V_9 * V_10 , struct V_14 * V_15 )
{
struct V_11 * V_12 = ( void * ) & V_10 -> V_13 ;
struct V_42 * V_43 = F_9 ( V_15 ) ;
if ( V_12 -> V_13 == V_12 -> V_16 )
...
static void F_22 ( struct V_9 * V_10 , T_3 * V_78 )
{
F_23 ( V_10 , V_79 , V_10 -> V_18 ,
L_18 ,
F_24 ( V_78 [ 0 ] ) / 1000 ,
F_24 ( V_78 [ 1 ] ) / 1000 ) ;
}
void F_25 ( struct V_9 * V_10 , struct V_80 * V_80 )
{
struct V_73 * V_81 ;
if ( V_80 -> V_82 < sizeof( * V_81 ) )
return;
if ( F_26 ( V_83 , & V_10 -> V_22 ) ) {
F_22 ( V_10 , ( T_3 * ) V_80 -> V_84 ) ;
return;
}
V_81 = V_80 -> V_84 ;
switch ( V_81 -> V_85 ) {
case V_86 :
F_27 ( V_10 , V_79 , V_10 -> V_18 , L_19 ,
V_81 -> V_87 ? L_20 : L_21 ) ;
F_28 ( V_10 , ! ! V_81 -> V_87 , 0 ) ;
break;
case V_88 :
F_27 ( V_10 , V_79 , V_10 -> V_18 , L_22 ,
V_80 -> V_82 ) ;
if ( V_80 -> V_82 != ( sizeof( * V_81 ) + 8 ) )
F_29 ( V_83 , & V_10 -> V_22 ) ;
else
F_22 ( V_10 , ( T_3 * ) & V_81 [ 1 ] ) ;
break;
default:
F_30 ( V_10 -> V_18 , L_23 ,
V_81 -> V_85 ) ;
...
static void F_40 ( struct V_9 * V_10 , struct V_80 * V_80 )
{
struct V_73 * V_81 ;
if ( V_80 -> V_82 < sizeof( * V_81 ) )
return;
