...
V_151 = F_53 ( & V_5 -> V_4 , V_5 -> V_204 , NULL ) ;
if ( V_151 ) {
...
int V_213 ;
int V_151 ;
V_5 = F_57 ( V_152 , sizeof( * V_5 ) , V_214 ) ;
if ( ! V_5 )
return - V_215 ;
V_5 -> V_152 = V_152 ;
V_210 = F_58 ( V_208 , V_216 , 0 ) ;
...
V_5 -> V_217 = F_63 ( V_208 , 0 ) ;
if ( V_5 -> V_217 <= 0 ) {
F_32 ( V_152 , L_15 , V_5 -> V_217 ) ;
return - V_218 ;
}
V_212 = F_64 ( V_152 -> V_197 , 0 , 0 ) ;
if ( ! V_212 )
return - V_219 ;
F_65 ( V_152 , L_16 , V_212 -> V_198 ) ;
V_5 -> V_204 = F_66 ( V_212 ) ;
F_67 ( V_212 ) ;
if ( ! V_5 -> V_204 )
return - V_220 ;
V_213 = F_68 ( V_152 -> V_197 , V_221 ) ;
if ( V_213 < 0 ) {
F_32 ( V_152 , L_17 , V_213 ) ;
return V_213 ;
}
V_151 = F_69 ( V_152 , V_152 -> V_197 , & V_5 -> V_191 , V_213 ,
& V_222 ) ;
if ( V_151 ) {
