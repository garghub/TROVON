...
continue;
V_66 = F_89 ( V_157 -> V_161 , 1024 * 1024 ) ;
if ( ! V_66 )
goto error;
...
return - V_181 ;
F_53 ( V_84 L_45 ) ;
V_175 = ( unsigned long ) F_105 ( F_106 () ) ;
V_154 = NULL ;
V_190 = 0 ;
V_14 = 0x180 ;
while ( V_14 > V_190 ) {
...
static int T_7 F_109 ( char * V_200 )
{
unsigned int V_201 ;
unsigned long V_76 ;
T_2 V_202 ;
