...
V_46 = F_26 ( V_43 ) ;
if ( V_46 )
F_27 ( V_1 -> V_20 -> V_55 , V_46 ) ;
else
F_28 ( & V_41 -> V_37 , L_3 ) ;
V_1 -> V_56 = F_29 ( V_41 , 0 ) ;
if ( V_1 -> V_56 < 0 ) {
F_22 ( & V_41 -> V_37 , L_4 ) ;
return V_1 -> V_56 ;
}
V_45 = F_30 ( V_41 , V_57 , L_5 ) ;
if ( ! V_45 ) {
F_22 ( & V_41 -> V_37 , L_6 ) ;
return - V_58 ;
}
...
static int F_39 ( struct V_71 * V_37 )
{
struct V_1 * V_1 = F_40 ( V_37 ) ;
return F_41 ( V_1 ) ;
}
static int F_42 ( struct V_71 * V_37 )
{
struct V_1 * V_1 = F_40 ( V_37 ) ;
return F_43 ( V_1 ) ;
}
