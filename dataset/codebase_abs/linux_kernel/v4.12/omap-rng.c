...
static int F_26 ( struct V_1 * V_65 )
{
V_65 -> V_5 = & V_66 ;
return 0 ;
}
...
struct V_55 * V_56 = & V_52 -> V_56 ;
int V_69 ;
V_2 = F_28 ( V_56 , sizeof( struct V_1 ) , V_70 ) ;
if ( ! V_2 )
return - V_71 ;
V_2 -> V_9 . V_72 = F_5 ;
V_2 -> V_9 . V_20 = F_8 ;
...
F_29 ( V_52 , V_2 ) ;
V_2 -> V_56 = V_56 ;
V_68 = F_30 ( V_52 , V_73 , 0 ) ;
V_2 -> V_4 = F_31 ( V_56 , V_68 ) ;
if ( F_32 ( V_2 -> V_4 ) ) {
V_69 = F_33 ( V_2 -> V_4 ) ;
goto V_74;
}
V_2 -> V_9 . V_75 = F_34 ( V_56 , F_25 ( V_56 ) , V_70 ) ;
if ( ! V_2 -> V_9 . V_75 ) {
V_69 = - V_71 ;
goto V_74;
}
...
V_69 = F_36 ( & V_52 -> V_56 ) ;
if ( V_69 < 0 ) {
F_21 ( & V_52 -> V_56 , L_6 , V_69 ) ;
F_37 ( & V_52 -> V_56 ) ;
goto V_74;
}
V_2 -> V_76 = F_38 ( & V_52 -> V_56 , NULL ) ;
if ( F_32 ( V_2 -> V_76 ) && F_33 ( V_2 -> V_76 ) == - V_77 )
return - V_77 ;
if ( ! F_32 ( V_2 -> V_76 ) ) {
V_69 = F_39 ( V_2 -> V_76 ) ;
if ( V_69 ) {
