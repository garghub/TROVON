...
V_4 -> V_182 = F_106 ( V_179 ) ;
F_21 ( L_29 ,
V_183 [ V_4 -> V_30 ] , V_12 -> V_13 , V_12 -> V_15 ,
V_12 -> V_16 , V_12 -> V_18 , V_12 -> V_184 ) ;
F_84 ( & V_4 -> V_185 ) ;
F_84 ( & V_4 -> V_186 ) ;
F_107 ( & V_4 -> V_187 . V_188 , 0 ) ;
F_84 ( & V_4 -> V_189 . V_144 ) ;
F_84 ( & V_4 -> V_106 . V_144 ) ;
F_84 ( & V_4 -> V_190 ) ;
F_84 ( & V_4 -> V_191 ) ;
F_84 ( & V_4 -> V_192 ) ;
F_108 ( & V_4 -> V_106 . V_193 ) ;
F_108 ( & V_4 -> V_194 ) ;
F_109 ( & V_4 -> V_195 . V_196 ) ;
F_84 ( & V_4 -> V_197 ) ;
F_110 ( V_4 -> V_198 ) ;
V_57 = F_111 ( V_4 ) ;
if ( V_57 )
...
V_57 = F_114 ( V_4 -> V_12 , F_115 ( V_172 ) ) ;
if ( V_57 ) {
V_4 -> V_204 = true ;
V_172 = 32 ;
F_116 ( L_30 ) ;
}
V_57 = F_117 ( V_4 -> V_12 , F_115 ( V_172 ) ) ;
if ( V_57 ) {
...
F_118 ( & V_4 -> V_218 ) ;
if ( V_4 -> V_30 >= V_83 ) {
V_4 -> V_219 = F_17 ( V_4 -> V_12 , 5 ) ;
V_4 -> V_220 = F_18 ( V_4 -> V_12 , 5 ) ;
} else {
V_4 -> V_219 = F_17 ( V_4 -> V_12 , 2 ) ;
V_4 -> V_220 = F_18 ( V_4 -> V_12 , 2 ) ;
}
V_4 -> V_221 = F_20 ( V_4 -> V_219 , V_4 -> V_220 ) ;
if ( V_4 -> V_221 == NULL )
return - V_48 ;
if ( V_4 -> V_30 >= V_83 )
F_16 ( V_4 ) ;
for ( V_28 = 0 ; V_28 < V_222 ; V_28 ++ ) {
if ( F_119 ( V_4 -> V_12 , V_28 ) & V_223 ) {
V_4 -> V_224 = F_18 ( V_4 -> V_12 , V_28 ) ;
V_4 -> V_137 = F_120 ( V_4 -> V_12 , V_28 , V_4 -> V_224 ) ;
break;
}
}
if ( V_4 -> V_137 == NULL )
...
int F_103 ( struct V_1 * V_2 , bool V_235 ,
bool V_236 , bool V_237 )
{
struct V_3 * V_4 ;
struct V_238 * V_239 ;
struct V_240 * V_241 ;
...
struct V_244 * V_244 = F_148 ( V_239 ) ;
struct V_245 * V_246 = F_149 ( V_239 -> V_247 -> V_248 ) ;
struct V_249 * V_250 ;
if ( V_244 -> V_251 ) {
struct V_249 * V_250 = F_150 ( V_244 -> V_251 ) ;
V_57 = F_32 ( V_250 , false ) ;
if ( V_57 == 0 ) {
F_34 ( V_250 ) ;
F_35 ( V_250 ) ;
}
...
F_157 ( V_4 ) ;
F_158 ( V_2 -> V_12 ) ;
if ( V_237 && V_4 -> V_30 >= V_203 ) {
V_4 -> V_253 -> V_254 ( V_4 , true ) ;
F_159 ( V_2 -> V_12 ) ;
} else if ( V_235 ) {
F_160 ( V_2 -> V_12 ) ;
...
int F_100 ( struct V_1 * V_2 , bool V_256 , bool V_236 )
{
struct V_240 * V_241 ;
struct V_3 * V_4 = V_2 -> V_5 ;
struct V_238 * V_239 ;
...
if ( V_57 )
F_81 ( L_35 , V_57 ) ;
if ( ( V_4 -> V_106 . V_229 == V_230 ) && V_4 -> V_106 . V_228 ) {
V_57 = F_168 ( V_4 ) ;
if ( V_57 ) {
V_4 -> V_106 . V_228 = false ;
F_81 ( L_40 ) ;
}
} else {
F_169 ( V_4 ) ;
...
F_182 ( & V_4 -> V_268 ) ;
F_154 ( V_4 ) ;
V_266 = F_183 ( & V_4 -> V_269 . V_270 ) ;
F_155 ( V_4 ) ;
F_156 ( V_4 ) ;
for ( V_28 = 0 ; V_28 < V_179 ; ++ V_28 ) {
V_263 [ V_28 ] = F_184 ( V_4 , & V_4 -> V_180 [ V_28 ] ,
& V_264 [ V_28 ] ) ;
if ( V_263 [ V_28 ] ) {
V_265 = true ;
F_43 ( V_4 -> V_2 , L_42
L_43 , V_263 [ V_28 ] , V_28 ) ;
}
}
V_57 = F_128 ( V_4 ) ;
if ( ! V_57 ) {
...
for ( V_28 = 0 ; V_28 < V_179 ; ++ V_28 ) {
if ( ! V_57 && V_264 [ V_28 ] ) {
F_185 ( V_4 , & V_4 -> V_180 [ V_28 ] ,
V_263 [ V_28 ] , V_264 [ V_28 ] ) ;
} else {
F_153 ( V_4 , V_28 ) ;
F_87 ( V_264 [ V_28 ] ) ;
}
...
{
unsigned V_28 ;
for ( V_28 = 0 ; V_28 < V_4 -> V_276 ; V_28 ++ ) {
if ( V_4 -> V_277 [ V_28 ] . V_274 == V_274 ) {
return 0 ;
}
}
V_28 = V_4 -> V_276 + 1 ;
...
V_4 -> V_277 [ V_4 -> V_276 ] . V_274 = V_274 ;
V_4 -> V_277 [ V_4 -> V_276 ] . V_279 = V_275 ;
V_4 -> V_276 = V_28 ;
#if F_190 ( V_280 )
F_191 ( V_274 , V_275 ,
V_4 -> V_117 -> V_247 -> V_281 ,
V_4 -> V_117 -> V_247 ) ;
#endif
return 0 ;
}
