...
static void F_22 ( void * V_64 )
{
struct V_1 * V_2 = V_64 ;
V_2 -> V_40 += F_19 ( & V_2 -> V_61 ) ;
F_16 ( V_2 ) ;
}
static void F_23 ( struct V_1 * V_2 )
{
struct V_26 * V_27 = F_9 ( V_2 ) ;
struct V_65 * V_45 = V_2 -> V_45 ;
bool V_39 = V_45 -> V_42 & V_66 ;
enum V_67 V_68 = V_39 ? V_55 : V_63 ;
...
unsigned char * V_73 ;
int V_74 ;
if ( F_24 ( V_53 ) || V_45 -> V_74 < 8 )
return;
if ( V_39 ) {
V_73 = V_2 -> V_45 -> V_73 ;
V_74 = V_2 -> V_45 -> V_74 - 2 ;
} else {
V_73 = V_2 -> V_45 -> V_73 + 1 ;
V_74 = V_2 -> V_45 -> V_74 - 1 ;
}
V_71 = F_25 ( V_53 -> V_26 -> V_27 , V_73 , V_74 , V_68 ) ;
if ( F_26 ( V_53 -> V_26 -> V_27 , V_71 ) ) {
F_12 ( V_27 , L_5 ) ;
return;
}
F_19 ( & V_2 -> V_61 ) = V_74 ;
...
if ( ! ( V_84 & V_85 ) )
return;
if ( V_2 -> V_40 < V_45 -> V_74 ) {
F_1 ( V_2 , V_86 , V_45 -> V_73 [ V_2 -> V_40 ] ) ;
V_2 -> V_40 ++ ;
if ( V_84 & V_87 )
F_23 ( V_2 ) ;
} else {
...
if ( V_84 & V_87 ) {
F_23 ( V_2 ) ;
} else if ( V_2 -> V_40 < V_45 -> V_74 ) {
V_45 -> V_73 [ V_2 -> V_40 ] = F_3 ( V_2 , V_86 ) ;
V_2 -> V_40 ++ ;
}
if ( V_2 -> V_40 + 1 >= V_45 -> V_74 )
F_1 ( V_2 , V_7 , V_88 ) ;
if ( V_2 -> V_40 == V_45 -> V_74 && ! ( V_2 -> V_42 & V_43 ) )
F_15 ( V_2 ) ;
else
F_1 ( V_2 , V_9 , V_91 ) ;
}
...
return;
V_68 = V_39 ? V_75 : V_76 ;
V_53 = F_37 ( V_27 , V_68 , V_2 -> V_139 -> V_140 + V_86 ) ;
if ( V_39 )
V_2 -> V_56 = V_53 ;
else
V_2 -> V_57 = V_53 ;
