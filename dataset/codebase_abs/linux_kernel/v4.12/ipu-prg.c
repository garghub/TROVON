...
T_3 V_36 ;
int V_31 , V_21 ;
V_9 = F_38 ( V_3 , sizeof( * V_9 ) , V_64 ) ;
if ( ! V_9 )
return - V_65 ;
V_63 = F_39 ( V_61 , V_66 , 0 ) ;
V_9 -> V_45 = F_40 ( & V_61 -> V_3 , V_63 ) ;
if ( F_41 ( V_9 -> V_45 ) )
return F_42 ( V_9 -> V_45 ) ;
V_9 -> V_24 = F_43 ( V_3 , L_2 ) ;
if ( F_41 ( V_9 -> V_24 ) )
return F_42 ( V_9 -> V_24 ) ;
V_9 -> V_22 = F_43 ( V_3 , L_3 ) ;
if ( F_41 ( V_9 -> V_22 ) )
return F_42 ( V_9 -> V_22 ) ;
V_9 -> V_39 =
F_44 ( L_4 ) ;
if ( F_41 ( V_9 -> V_39 ) )
return F_42 ( V_9 -> V_39 ) ;
for ( V_31 = 0 ; V_31 < 3 ; V_31 ++ ) {
V_9 -> V_32 [ V_31 ] = F_45 ( V_3 , L_5 , V_31 ) ;
if ( ! V_9 -> V_32 [ V_31 ] )
return - V_67 ;
}
V_21 = F_12 ( V_9 -> V_24 ) ;
