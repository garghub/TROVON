...
if ( 3 + V_60 [ V_64 ] . V_71 > sizeof( V_62 ) ) {
F_16 ( L_15 , V_60 [ V_64 ] . V_71 ) ;
break;
}
if ( V_65 ) {
if ( 3 + V_60 [ V_64 + 1 ] . V_71 > sizeof( V_63 ) ) {
F_16 ( L_16 , V_60 [ V_64 + 1 ] . V_71 ) ;
break;
}
} else if ( V_66 ) {
if ( 3 + V_60 [ V_64 ] . V_71 > sizeof( V_63 ) ) {
F_16 ( L_16 , V_60 [ V_64 ] . V_71 ) ;
break;
}
}
V_62 [ 0 ] = ( V_60 [ V_64 ] . V_72 << 1 ) | ( V_65 | V_66 ) ;
if ( V_66 )
V_62 [ 1 ] = 0 ;
else
V_62 [ 1 ] = V_60 [ V_64 ] . V_71 ;
if ( V_65 )
V_62 [ 2 ] = V_60 [ V_64 + 1 ] . V_71 ;
else if ( V_66 )
V_62 [ 2 ] = V_60 [ V_64 ] . V_71 ;
else
V_62 [ 2 ] = 0 ;
memcpy ( & V_62 [ 3 ] , V_60 [ V_64 ] . V_28 , V_60 [ V_64 ] . V_71 ) ;
if ( F_1 ( V_2 , V_73 , V_62 , V_62 [ 1 ] + 3 , V_63 , V_62 [ 2 ] + 3 ) < 0 ) {
F_16 ( L_17 ) ;
break;
}
if ( V_65 ) {
memcpy ( V_60 [ V_64 + 1 ] . V_28 , & V_63 [ 3 ] , V_60 [ V_64 + 1 ] . V_71 ) ;
V_64 ++ ;
} else if ( V_66 )
memcpy ( V_60 [ V_64 ] . V_28 , & V_63 [ 3 ] , V_60 [ V_64 ] . V_71 ) ;
}
F_9 ( & V_2 -> V_67 ) ;
return V_64 ;
}
