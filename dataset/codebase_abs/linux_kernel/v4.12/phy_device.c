...
if ( ! ( V_194 & 1 ) )
continue;
F_102 ( V_2 , V_192 , V_196 ) ;
V_193 = F_102 ( V_2 , V_192 , V_196 ) ;
...
int F_122 ( struct V_1 * V_2 , T_1 V_222 )
{
int V_42 ;
V_42 = F_121 ( V_2 , V_222 ) ;
if ( V_42 )
return V_42 ;
V_2 -> V_140 = V_2 -> V_141 ;
return 0 ;
...
V_242 -> V_48 . V_10 . V_124 = F_128 ;
V_242 -> V_48 . V_10 . remove = F_130 ;
