...
static void F_74 ( struct V_56 * V_49 ,
struct V_57 * V_46 )
{
struct V_47 * V_48 = F_20 ( V_46 , F_21 ( * V_48 ) , V_58 ) ;
F_75 ( & V_48 -> V_54 ) ;
if ( V_48 -> V_54 . V_55 )
F_49 ( V_48 -> V_5 ) ;
F_73 ( V_48 -> V_49 ) ;
...
if ( V_59 ) {
V_48 -> V_49 = F_80 ( V_49 ) ;
F_81 ( & V_48 -> V_54 , F_82 ( V_62 + V_59 ) ) ;
}
V_60 = F_83 ( V_49 , & V_48 -> V_58 , F_74 ) ;
if ( V_60 == 0 ) {
V_60 = 1 ;
} else {
F_74 ( V_49 , & V_48 -> V_58 ) ;
