...
static void F_65 ( struct V_9 * V_10 , unsigned int V_116 ,
bool V_33 )
{
struct V_1 * V_2 = V_10 -> V_2 ;
...
V_2 -> V_118 |= V_116 ;
if ( V_2 -> V_118 != V_117 )
F_14 ( V_10 , 0x01 , 0 , V_120 ,
V_2 -> V_118 ) ;
}
static void F_66 ( void * V_32 , int V_33 )
{
struct V_9 * V_10 = V_32 ;
struct V_1 * V_2 = V_10 -> V_2 ;
F_65 ( V_10 , V_2 -> V_121 , V_33 ) ;
}
...
if ( V_65 )
F_65 ( V_10 , V_2 -> V_122 ,
V_65 -> V_97 . integer . V_97 [ 0 ] ||
V_65 -> V_97 . integer . V_97 [ 1 ] ) ;
}
...
F_69 ( V_10 , L_2 , V_43 , V_2 -> V_118 ) ;
if ( V_43 == V_45 ) {
V_2 -> V_6 . V_113 . V_114 = F_66 ;
V_2 -> V_6 . V_69 = F_67 ;
V_2 -> V_118 = 0 ;
V_2 -> V_119 = 0 ;
V_2 -> V_121 = 0x01 ;
...
F_28 ( V_10 , * V_128 , V_21 ,
V_129 |
F_72 ( V_10 , * V_128 , V_21 ) ) ;
V_2 -> V_6 . V_130 = true ;
}
...
struct V_1 * V_2 ;
int V_11 ;
F_69 ( V_10 , L_3 , V_10 -> V_36 . V_131 ) ;
V_2 = F_74 ( sizeof( * V_2 ) , V_132 ) ;
if ( ! V_2 )
return - V_18 ;
F_75 ( & V_2 -> V_6 ) ;
V_10 -> V_2 = V_2 ;
...
switch ( V_10 -> V_36 . V_151 >> 16 ) {
case 0x103c :
V_2 -> V_6 . V_152 = 1 ;
break;
}
F_21 ( V_10 , V_45 ) ;
V_11 = F_77 ( V_10 , & V_2 -> V_6 . V_53 , NULL ,
V_2 -> V_66 ) ;
if ( V_11 < 0 )
goto error;
V_11 = F_78 ( V_10 , & V_2 -> V_6 . V_53 ) ;
if ( V_11 < 0 )
goto error;
if ( ! V_10 -> V_153 -> V_36 . V_154 ) {
F_69 ( V_10 ,
L_4 ) ;
V_10 -> V_153 -> V_36 . V_154 = 1 ;
V_10 -> V_153 -> V_155 = 1 ;
}
F_21 ( V_10 , V_68 ) ;
return 0 ;
