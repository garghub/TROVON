...
V_48 -> V_57 [ V_46 -> V_56 ] . V_65 ++ ;
goto exit;
}
if ( F_17 ( V_36 -> V_55 ) ) {
if ( V_46 -> V_62 & V_66 )
V_48 -> V_67 [ V_46 -> V_56 ] . V_68 ++ ;
else
V_48 -> V_67 [ V_46 -> V_56 ] . V_69 ++ ;
goto exit;
}
if ( F_18 ( V_36 -> V_55 ) ) {
if ( V_43 -> V_70 -> V_71 -> V_72 == V_73 )
V_48 -> V_74 [ V_46 -> V_56 - 4 ] . V_75 ++ ;
else
V_48 -> V_74 [ V_46 -> V_56 ] . V_75 ++ ;
}
exit:
F_19 () ;
}
...
return - V_20 ;
V_82 = & V_6 -> V_83 ;
V_14 += F_3 ( V_16 + V_14 , V_15 - V_14 , L_43 , V_82 -> V_84 ) ;
V_14 += F_3 ( V_16 + V_14 , V_15 - V_14 , L_44 , V_82 -> V_85 ) ;
V_14 += F_3 ( V_16 + V_14 , V_15 - V_14 , L_45 ) ;
for ( V_77 = 0 ; V_77 < 4 ; V_77 ++ )
V_14 += F_3 ( V_16 + V_14 , V_15 - V_14 , L_46 , V_86 [ V_77 ] , V_6 -> V_87 [ V_77 ] ) ;
if ( V_14 < V_15 )
V_16 [ V_14 ++ ] = '\n' ;
V_17 = F_8 ( V_2 , V_3 , V_4 , V_16 , V_14 ) ;
F_9 ( V_16 ) ;
...
void F_25 ( struct V_88 * V_51 ,
struct V_89 * V_90 ,
struct V_49 * V_21 ,
struct V_91 * V_92 )
{
struct V_5 * V_6 = (struct V_5 * ) V_21 -> V_53 ;
F_26 ( L_47 , V_93 , V_92 , V_6 , & V_94 ) ;
F_26 ( L_48 , V_93 , V_92 , V_6 , & V_95 ) ;
F_26 ( L_49 , V_93 , V_92 , V_6 , & V_96 ) ;
}
