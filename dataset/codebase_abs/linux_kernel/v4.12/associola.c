...
static T_8 F_124 ( const struct V_123 * V_250 )
{
switch ( V_250 -> V_19 ) {
case V_150 :
return 3 ;
...
static struct V_123 * F_125 ( struct V_123 * V_256 ,
struct V_123 * V_257 )
{
if ( V_256 -> V_258 > V_257 -> V_258 ) {
return V_257 ;
} else if ( V_256 -> V_258 == V_257 -> V_258 &&
F_126 ( V_257 -> V_243 ,
V_256 -> V_243 ) ) {
return V_257 ;
} else {
...
static struct V_123 * F_127 ( struct V_123 * V_259 ,
struct V_123 * V_260 )
{
T_8 V_261 , V_262 ;
if ( V_260 == NULL || V_259 == V_260 )
return V_259 ;
V_261 = F_124 ( V_259 ) ;
V_262 = F_124 ( V_260 ) ;
if ( V_261 > V_262 )
...
struct V_123 * V_263 = NULL ;
if ( V_2 -> V_68 . V_139 == 1 )
return;
if ( V_2 -> V_68 . V_152 == V_2 -> V_68 . V_161 &&
V_2 -> V_68 . V_152 -> V_19 == V_150 )
return;
for ( V_250 = F_128 ( V_250 , V_138 ) ; 1 ;
V_250 = F_128 ( V_250 , V_138 ) ) {
if ( & V_250 -> V_138 == & V_2 -> V_68 . V_84 )
continue;
if ( V_250 -> V_19 == V_190 )
continue;
V_263 = F_127 ( V_250 , V_263 ) ;
if ( V_263 -> V_19 == V_150 )
break;
if ( V_250 == V_2 -> V_68 . V_161 )
break;
}
V_2 -> V_68 . V_161 = V_263 ;
F_30 ( L_6 ,
V_159 , V_2 , & V_2 -> V_68 . V_161 -> V_148 . V_160 ) ;
}
static void F_92 ( struct V_1 * V_2 )
{
struct V_123 * V_250 , * V_264 = NULL , * V_265 = NULL ;
struct V_123 * V_266 = NULL ;
...
V_2 -> V_68 . V_146 != V_264 ) {
V_265 = V_264 ;
V_264 = V_2 -> V_68 . V_146 ;
}
if ( V_265 == NULL )
V_265 = V_264 ;
if ( V_264 == NULL ) {
V_264 = F_127 ( V_2 -> V_68 . V_152 , V_266 ) ;
V_265 = V_264 ;
}
V_2 -> V_68 . V_152 = V_264 ;
V_2 -> V_68 . V_161 = V_265 ;
}
struct V_123 *
...
F_66 (t, &asoc->peer.transport_addr_list,
transports) {
if ( V_192 -> V_181 && V_192 -> V_269 ) {
F_131 (
V_192 , F_132 ( F_133 ( V_192 -> V_269 ) ) ) ;
V_192 -> V_181 = 0 ;
}
if ( ! V_268 || ( V_192 -> V_38 < V_268 ) )
V_268 = V_192 -> V_38 ;
}
if ( V_268 ) {
V_2 -> V_38 = V_268 ;
V_2 -> V_182 = F_77 ( V_2 , V_268 ) ;
}
F_30 ( L_7 , V_159 , V_2 ,
V_2 -> V_38 , V_2 -> V_182 ) ;
}
static inline bool F_134 ( struct V_1 * V_2 )
{
struct V_9 * V_9 = F_2 ( V_2 -> V_14 . V_6 ) ;
switch ( V_2 -> V_19 ) {
case V_253 :
...
( V_2 -> V_14 . V_6 -> V_64 >> V_9 -> V_28 . V_273 ) ,
V_2 -> V_38 ) ) )
return true ;
break;
default:
...
void F_135 ( struct V_1 * V_2 , unsigned int V_274 )
{
struct V_169 * V_275 ;
struct V_276 * V_277 ;
if ( V_2 -> V_278 ) {
...
if ( V_2 -> V_279 ) {
int V_280 = F_79 ( V_2 -> V_38 , V_2 -> V_279 ) ;
V_2 -> V_66 += V_280 ;
V_2 -> V_279 -= V_280 ;
}
F_30 ( L_8 ,
V_159 , V_2 , V_274 , V_2 -> V_66 , V_2 -> V_278 ,
V_2 -> V_67 ) ;
if ( F_134 ( V_2 ) ) {
V_2 -> V_67 = V_2 -> V_66 ;
F_30 ( L_9
...
return;
V_2 -> V_68 . V_85 = 0 ;
F_137 ( & V_2 -> V_91 , V_275 , V_211 ) ;
V_277 = & V_2 -> V_54 [ V_48 ] ;
if ( F_43 ( V_277 ) )
F_44 ( V_2 ) ;
}
}
void F_138 ( struct V_1 * V_2 , unsigned int V_274 )
{
int V_281 ;
int V_282 = 0 ;
if ( F_54 ( ! V_2 -> V_66 || V_2 -> V_278 ) )
F_30 ( L_11
L_12 , V_159 , V_2 ,
V_2 -> V_66 , V_2 -> V_278 ) ;
if ( V_2 -> V_4 -> V_283 )
...
V_281 = F_60 ( & V_2 -> V_14 . V_6 -> V_284 ) ;
if ( V_281 >= V_2 -> V_14 . V_6 -> V_64 )
V_282 = 1 ;
if ( V_2 -> V_66 >= V_274 ) {
V_2 -> V_66 -= V_274 ;
if ( V_282 ) {
...
{
int V_285 ;
V_285 = ( V_96 == V_2 -> V_14 . V_6 -> V_95 ) ? V_286 : 0 ;
if ( V_2 -> V_68 . V_94 )
V_285 |= V_287 ;
if ( V_2 -> V_68 . V_97 )
V_285 |= V_288 ;
return F_140 ( F_2 ( V_2 -> V_14 . V_6 ) ,
& V_2 -> V_14 . V_17 ,
& V_2 -> V_4 -> V_14 . V_17 ,
V_7 , V_8 , V_285 ) ;
}
...
T_2 V_8 )
{
int V_290 = F_21 ( V_134 -> V_291 -> V_236 . V_114 ) ;
int V_292 = V_134 -> V_293 ;
T_9 * V_294 = ( T_9 * ) V_134 -> V_291 + V_290 ;
return F_142 ( & V_2 -> V_14 . V_17 , V_294 , V_292 ,
...
int F_122 ( struct V_1 * V_2 , T_2 V_8 )
{
bool V_296 = F_144 ( V_8 ) ;
int V_297 ;
if ( V_2 -> V_142 )
return 0 ;
if ( V_296 )
F_145 ( V_8 ) ;
F_56 ( & V_143 ) ;
V_297 = F_146 ( & V_144 , V_2 , 1 , 0 , V_298 ) ;
F_58 ( & V_143 ) ;
if ( V_296 )
F_147 () ;
if ( V_297 < 0 )
return V_297 ;
V_2 -> V_142 = ( V_299 ) V_297 ;
return 0 ;
}
...
void F_150 ( const struct V_1 * V_2 )
{
struct V_169 * V_303 ;
struct V_169 * V_301 ;
F_87 (ack, tmp, &asoc->asconf_ack_list,
transmitted_list) {
if ( V_303 -> V_226 . V_305 -> V_306 ==
F_101 ( V_2 -> V_68 . V_80 ) )
break;
F_114 ( & V_303 -> V_304 ) ;
F_41 ( V_303 ) ;
...
if ( F_152 ( V_303 ) )
continue;
if ( V_303 -> V_226 . V_305 -> V_306 == V_306 ) {
F_153 ( V_303 ) ;
return V_303 ;
}
}
