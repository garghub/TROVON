...
if ( V_146 ) {
unsigned long V_148 = V_49 ;
F_4 ( L_34 ,
V_41 , V_148 , V_23 -> V_48 ) ;
if ( F_53 ( V_148 , V_23 -> V_48 ) )
F_34 ( V_23 ) ;
}
}
F_31 ( V_23 ) ;
...
{
struct V_149 * V_150 = V_23 -> V_89 -> V_151 ;
struct V_21 * V_152 = V_150 -> V_152 ;
int V_11 = V_150 -> V_11 ;
int V_5 ;
...
return - V_18 ;
for ( V_5 = 0 ; V_5 < V_11 ; V_5 ++ ) {
V_23 -> V_37 -> V_15 [ V_5 ] . V_19 = V_152 [ V_5 ] ;
V_23 -> V_37 -> V_15 [ V_5 ] . V_19 . V_141 = 0 ;
V_23 -> V_37 -> V_15 [ V_5 ] . V_154 . type =
V_51 ;
V_23 -> V_37 -> V_15 [ V_5 ] . V_154 . V_62 = F_47 ( V_5 ) ;
}
V_23 -> V_37 -> V_11 = V_11 ;
return 0 ;
}
int F_108 ( struct V_22 * V_23 , struct V_92 * V_155 )
{
int V_6 = 0 ;
F_4 ( L_35 ) ;
...
if ( V_6 )
goto V_94;
V_23 -> V_35 = F_110 ( V_155 -> V_151 -> V_154 ,
V_155 -> V_151 -> V_156 ) ;
if ( F_58 ( V_23 -> V_35 ) ) {
V_6 = F_59 ( V_23 -> V_35 ) ;
goto V_157;
...
V_160 | V_161 ;
V_6 = - V_18 ;
V_23 -> V_34 = F_91 ( V_162 ,
sizeof( struct V_75 ) ,
V_153 , true ) ;
if ( ! V_23 -> V_34 )
goto V_163;
V_23 -> V_33 = F_91 ( V_164 , 128 ,
V_153 , true ) ;
if ( ! V_23 -> V_33 )
goto V_165;
V_23 -> V_32 = F_91 ( V_166 , 4096 ,
V_153 , true ) ;
if ( ! V_23 -> V_32 )
goto V_167;
V_23 -> V_25 = F_91 ( V_168 , 4096 , V_153 , true ) ;
V_23 -> V_24 = 0 ;
if ( ! V_23 -> V_25 )
goto V_169;
F_111 ( & V_23 -> V_30 , V_23 , & V_170 ,
& V_23 -> V_89 -> V_171 ) ;
V_23 -> V_31 = - 1 ;
V_23 -> V_44 = false ;
V_23 -> V_45 = 1 ;
...
F_118 ( V_23 ) ;
if ( V_42 < 0 ) {
V_23 -> V_89 -> V_174 = V_42 ;
} else if ( ! V_173 && F_104 ( V_23 -> V_35 ) ) {
F_4 ( L_38 ) ;
V_23 -> V_89 -> V_171 . V_175 . V_154 . type = V_176 ;
V_23 -> V_89 -> V_171 . V_175 . V_154 . V_62 =
F_47 ( V_23 -> V_35 -> V_177 ) ;
F_34 ( V_23 ) ;
F_100 ( V_23 ) ;
F_30 ( L_39 , V_23 -> V_31 ,
...
break;
case V_179 :
F_125 ( & V_23 -> V_89 -> V_180 , V_61 ) ;
break;
default:
if ( V_23 -> V_89 -> V_181 &&
V_23 -> V_89 -> V_181 ( V_23 -> V_89 , V_61 ) == 0 )
break;
F_44 ( L_40 , type ,
F_126 ( type ) ) ;
}
...
F_128 ( L_42 ,
V_29 , V_4 -> V_53 ,
( unsigned int ) V_30 -> V_184 . type ,
F_38 ( V_30 -> V_184 . V_62 ) ) ;
F_66 ( V_4 ) ;
V_4 = F_91 ( type , V_29 , V_17 , false ) ;
}
return V_4 ;
