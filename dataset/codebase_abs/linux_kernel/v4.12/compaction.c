...
static bool F_46 ( T_2 * V_47 , unsigned long * V_48 ,
struct V_29 * V_30 )
{
if ( V_30 -> V_45 == V_46 ) {
if ( ! F_47 ( V_47 , * V_48 ) ) {
...
static inline bool F_53 ( struct V_29 * V_30 )
{
if ( F_52 () ) {
if ( V_30 -> V_45 == V_46 ) {
V_30 -> V_49 = true ;
