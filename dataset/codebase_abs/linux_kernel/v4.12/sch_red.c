...
if ( V_37 == NULL )
return - V_44 ;
V_42 = F_29 ( V_38 , V_39 , V_37 , V_45 , NULL ) ;
if ( V_42 < 0 )
return V_42 ;
if ( V_38 [ V_46 ] == NULL ||
V_38 [ V_47 ] == NULL )
...
V_2 -> V_49 = V_41 -> V_49 ;
if ( V_11 ) {
F_37 ( V_2 -> V_12 , V_2 -> V_12 -> V_2 . V_29 ,
V_2 -> V_12 -> V_17 . V_18 ) ;
F_27 ( V_2 -> V_12 ) ;
V_2 -> V_12 = V_11 ;
}
...
F_40 ( & V_2 -> V_35 ) ;
if ( V_41 -> V_3 & V_57 )
F_41 ( & V_2 -> V_35 , V_58 + V_59 / 2 ) ;
if ( ! V_2 -> V_12 -> V_2 . V_29 )
F_20 ( & V_2 -> V_14 ) ;
F_42 ( V_9 ) ;
return 0 ;
}
static inline void F_43 ( unsigned long V_60 )
{
struct V_8 * V_9 = (struct V_8 * ) V_60 ;
struct V_1 * V_2 = F_4 ( V_9 ) ;
T_2 * V_61 = F_44 ( F_45 ( V_9 ) ) ;
F_46 ( V_61 ) ;
F_47 ( & V_2 -> V_16 , & V_2 -> V_14 ) ;
F_41 ( & V_2 -> V_35 , V_58 + V_59 / 2 ) ;
F_48 ( V_61 ) ;
}
static int F_49 ( struct V_8 * V_9 , struct V_36 * V_37 )
{
struct V_1 * V_2 = F_4 ( V_9 ) ;
V_2 -> V_12 = & V_51 ;
F_50 ( & V_2 -> V_35 , F_43 , ( unsigned long ) V_9 ) ;
...
. V_49 = V_2 -> V_49 ,
. V_3 = V_2 -> V_3 ,
. V_52 = V_2 -> V_16 . V_52 >> V_2 -> V_16 . V_54 ,
. V_53 = V_2 -> V_16 . V_53 >> V_2 -> V_16 . V_54 ,
. V_54 = V_2 -> V_16 . V_54 ,
. V_55 = V_2 -> V_16 . V_55 ,
. V_56 = V_2 -> V_16 . V_56 ,
} ;
...
if ( V_62 == NULL )
goto V_64;
if ( F_53 ( V_7 , V_46 , sizeof( V_37 ) , & V_37 ) ||
F_54 ( V_7 , V_48 , V_2 -> V_16 . V_43 ) )
goto V_64;
return F_55 ( V_7 , V_62 ) ;
V_64:
F_56 ( V_7 , V_62 ) ;
return - V_65 ;
}
static int F_57 ( struct V_8 * V_9 , struct V_66 * V_67 )
{
struct V_1 * V_2 = F_4 ( V_9 ) ;
struct V_68 V_69 = {
...
return F_58 ( V_67 , & V_69 , sizeof( V_69 ) ) ;
}
static int F_59 ( struct V_8 * V_9 , unsigned long V_73 ,
...
static int F_61 ( struct V_8 * V_9 , unsigned long V_60 , struct V_8 * V_79 ,
struct V_8 * * V_80 )
{
struct V_1 * V_2 = F_4 ( V_9 ) ;
if ( V_79 == NULL )
V_79 = & V_51 ;
* V_80 = F_62 ( V_9 , V_79 , & V_2 -> V_12 ) ;
return 0 ;
}
static struct V_8 * F_63 ( struct V_8 * V_9 , unsigned long V_60 )
{
struct V_1 * V_2 = F_4 ( V_9 ) ;
return V_2 -> V_12 ;
}
static unsigned long F_64 ( struct V_8 * V_9 , T_1 V_81 )
{
return 1 ;
}
static void F_65 ( struct V_8 * V_9 , unsigned long V_60 )
{
}
static void F_66 ( struct V_8 * V_9 , struct V_82 * V_83 )
{
if ( ! V_83 -> V_84 ) {
