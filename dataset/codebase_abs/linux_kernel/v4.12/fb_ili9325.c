...
F_9 ( V_24 , V_25 ) &= V_23 [ V_24 * V_2 -> gamma . V_26 + V_25 ] ;
F_3 ( V_2 , 0x0030 , F_9 ( 0 , 5 ) << 8 | F_9 ( 0 , 4 ) ) ;
F_3 ( V_2 , 0x0031 , F_9 ( 0 , 7 ) << 8 | F_9 ( 0 , 6 ) ) ;
F_3 ( V_2 , 0x0032 , F_9 ( 0 , 9 ) << 8 | F_9 ( 0 , 8 ) ) ;
F_3 ( V_2 , 0x0035 , F_9 ( 0 , 3 ) << 8 | F_9 ( 0 , 2 ) ) ;
F_3 ( V_2 , 0x0036 , F_9 ( 0 , 1 ) << 8 | F_9 ( 0 , 0 ) ) ;
F_3 ( V_2 , 0x0037 , F_9 ( 1 , 5 ) << 8 | F_9 ( 1 , 4 ) ) ;
F_3 ( V_2 , 0x0038 , F_9 ( 1 , 7 ) << 8 | F_9 ( 1 , 6 ) ) ;
F_3 ( V_2 , 0x0039 , F_9 ( 1 , 9 ) << 8 | F_9 ( 1 , 8 ) ) ;
F_3 ( V_2 , 0x003C , F_9 ( 1 , 3 ) << 8 | F_9 ( 1 , 2 ) ) ;
F_3 ( V_2 , 0x003D , F_9 ( 1 , 1 ) << 8 | F_9 ( 1 , 0 ) ) ;
return 0 ;
}
