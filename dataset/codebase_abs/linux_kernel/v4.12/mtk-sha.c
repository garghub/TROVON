...
V_81 -> V_99 [ V_118 ] ^= 0x36 ;
V_81 -> V_83 [ V_118 ] ^= 0x5c ;
}
return 0 ;
}
static int F_79 ( struct V_79 * V_72 , void * V_138 )
{
const struct V_24 * V_25 = F_22 ( V_72 ) ;
memcpy ( V_138 , V_25 , sizeof( * V_25 ) ) ;
return 0 ;
}
static int F_80 ( struct V_79 * V_72 , const void * V_139 )
{
struct V_24 * V_25 = F_22 ( V_72 ) ;
memcpy ( V_25 , V_139 , sizeof( * V_25 ) ) ;
return 0 ;
}
static int F_81 ( struct V_140 * V_49 ,
const char * V_141 )
{
...
static int F_88 ( struct V_140 * V_49 )
{
return F_81 ( V_49 , NULL ) ;
}
static int F_89 ( struct V_140 * V_49 )
{
return F_81 ( V_49 , L_8 ) ;
}
static int F_90 ( struct V_140 * V_49 )
{
return F_81 ( V_49 , L_9 ) ;
}
static int F_91 ( struct V_140 * V_49 )
{
return F_81 ( V_49 , L_10 ) ;
}
static int F_92 ( struct V_140 * V_49 )
{
return F_81 ( V_49 , L_11 ) ;
}
static int F_93 ( struct V_140 * V_49 )
{
return F_81 ( V_49 , L_12 ) ;
}
static void F_94 ( struct V_140 * V_49 )
{
struct V_17 * V_18 = F_29 ( V_49 ) ;
if ( V_18 -> V_38 & V_98 ) {
struct V_80 * V_81 = V_18 -> V_4 ;
...
F_58 ( V_69 -> V_2 , V_69 -> V_22 - V_145 , NULL ) ;
}
static void F_97 ( unsigned long V_144 )
{
struct V_68 * V_69 = (struct V_68 * ) V_144 ;
...
static T_7 F_98 ( int V_146 , void * V_147 )
{
struct V_68 * V_69 = (struct V_68 * ) V_147 ;
struct V_1 * V_2 = V_69 -> V_2 ;
T_1 V_148 = F_1 ( V_2 , F_99 ( V_69 -> V_22 ) ) ;
F_3 ( V_2 , F_99 ( V_69 -> V_22 ) , V_148 ) ;
if ( F_56 ( ( V_119 & V_69 -> V_38 ) ) ) {
F_3 ( V_2 , F_100 ( V_69 -> V_22 ) , V_149 ) ;
...
int V_118 , V_103 = - V_154 ;
for ( V_118 = 0 ; V_118 < V_155 ; V_118 ++ ) {
V_69 [ V_118 ] = F_104 ( sizeof( * * V_69 ) , V_156 ) ;
if ( ! V_69 [ V_118 ] )
goto V_157;
V_69 [ V_118 ] -> V_2 = V_2 ;
F_105 ( & V_69 [ V_118 ] -> V_21 ) ;
F_106 ( & V_69 [ V_118 ] -> V_126 , V_158 ) ;
F_107 ( & V_69 [ V_118 ] -> V_121 , F_96 ,
( unsigned long ) V_69 [ V_118 ] ) ;
F_107 ( & V_69 [ V_118 ] -> V_152 , F_97 ,
( unsigned long ) V_69 [ V_118 ] ) ;
}
V_69 [ 0 ] -> V_22 = V_145 ;
V_69 [ 1 ] -> V_22 = V_159 ;
...
{
int V_118 ;
for ( V_118 = 0 ; V_118 < F_112 ( V_160 ) ; V_118 ++ )
F_113 ( & V_160 [ V_118 ] ) ;
for ( V_118 = 0 ; V_118 < F_112 ( V_161 ) ; V_118 ++ )
F_113 ( & V_161 [ V_118 ] ) ;
}
...
int V_103 , V_118 ;
for ( V_118 = 0 ; V_118 < F_112 ( V_160 ) ; V_118 ++ ) {
V_103 = F_115 ( & V_160 [ V_118 ] ) ;
if ( V_103 )
goto V_162;
}
for ( V_118 = 0 ; V_118 < F_112 ( V_161 ) ; V_118 ++ ) {
V_103 = F_115 ( & V_161 [ V_118 ] ) ;
if ( V_103 )
goto V_163;
}
return 0 ;
...
if ( V_103 )
goto V_165;
V_103 = F_118 ( V_2 -> V_75 , V_2 -> V_146 [ V_145 ] , F_98 ,
0 , L_14 , V_2 -> V_69 [ 0 ] ) ;
if ( V_103 ) {
F_27 ( V_2 -> V_75 , L_15 ) ;
goto V_166;
}
V_103 = F_118 ( V_2 -> V_75 , V_2 -> V_146 [ V_159 ] , F_98 ,
0 , L_14 , V_2 -> V_69 [ 1 ] ) ;
if ( V_103 ) {
F_27 ( V_2 -> V_75 , L_16 ) ;
goto V_166;
}
F_3 ( V_2 , F_119 ( V_145 ) , V_167 ) ;
F_3 ( V_2 , F_119 ( V_159 ) , V_168 ) ;
F_120 ( & V_20 . V_21 ) ;
F_121 ( & V_2 -> V_164 , & V_20 . V_169 ) ;
F_122 ( & V_20 . V_21 ) ;
V_103 = F_114 () ;
if ( V_103 )
goto V_170;
