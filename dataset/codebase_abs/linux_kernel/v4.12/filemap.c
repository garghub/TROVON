...
T_1 V_179 ;
V_179 = F_75 ( V_146 ) ;
V_176 = F_78 ( V_2 , V_174 -> V_180 ,
V_174 -> V_180 + V_155 - 1 ) ;
if ( V_176 < 0 )
goto V_56;
F_205 ( V_137 ) ;
V_176 = V_2 -> V_31 -> V_181 ( V_174 , V_134 ) ;
if ( V_176 >= 0 ) {
V_174 -> V_180 += V_176 ;
V_155 -= V_176 ;
}
F_207 ( V_134 , V_155 - F_200 ( V_134 ) ) ;
if ( V_176 < 0 || ! V_155 || V_174 -> V_180 >= V_179 ||
F_208 ( V_146 ) )
goto V_56;
}
V_176 = F_190 ( V_137 , & V_174 -> V_180 , V_134 , V_176 ) ;
V_56:
return V_176 ;
}
...
static void F_210 ( struct V_183 * V_184 ,
struct V_139 * V_140 ,
struct V_137 * V_137 ,
T_2 V_70 )
{
...
if ( V_140 -> V_188 < V_189 * 10 )
V_140 -> V_188 ++ ;
if ( V_140 -> V_188 > V_189 )
return;
V_140 -> V_38 = F_211 ( long , 0 , V_70 - V_140 -> V_141 / 2 ) ;
V_140 -> V_179 = V_140 -> V_141 ;
V_140 -> V_190 = V_140 -> V_141 / 4 ;
F_212 ( V_140 , V_2 , V_137 ) ;
}
static void F_213 ( struct V_183 * V_184 ,
struct V_139 * V_140 ,
struct V_137 * V_137 ,
struct V_3 * V_3 ,
T_2 V_70 )
...
int F_214 ( struct V_191 * V_192 )
{
int error ;
struct V_137 * V_137 = V_192 -> V_184 -> V_193 ;
struct V_1 * V_2 = V_137 -> V_145 ;
...
struct V_3 * V_3 ;
int V_33 = 0 ;
V_195 = F_215 ( F_75 ( V_146 ) , V_154 ) ;
if ( F_27 ( V_70 >= V_195 ) )
return V_196 ;
V_3 = F_193 ( V_2 , V_70 ) ;
if ( F_125 ( V_3 ) && ! ( V_192 -> V_30 & V_197 ) ) {
F_213 ( V_192 -> V_184 , V_140 , V_137 , V_3 , V_70 ) ;
} else if ( ! V_3 ) {
F_210 ( V_192 -> V_184 , V_140 , V_137 , V_70 ) ;
F_216 ( V_198 ) ;
F_217 ( V_192 -> V_184 -> V_199 , V_198 ) ;
V_33 = V_200 ;
V_201:
V_3 = F_193 ( V_2 , V_70 ) ;
if ( ! V_3 )
...
if ( ! F_218 ( V_3 , V_192 -> V_184 -> V_199 , V_192 -> V_30 ) ) {
F_52 ( V_3 ) ;
return V_33 | V_202 ;
}
if ( F_27 ( V_3 -> V_2 != V_2 ) ) {
...
return V_33 | V_204 ;
V_160:
error = F_209 ( V_137 , V_70 , V_192 -> V_68 ) ;
if ( error >= 0 )
goto V_201;
if ( error == - V_171 )
return V_205 ;
...
goto V_212;
V_209 = F_215 ( F_75 ( V_2 -> V_29 ) , V_154 ) ;
if ( V_3 -> V_9 >= V_209 )
goto V_212;
if ( V_137 -> V_147 . V_188 > 0 )
V_137 -> V_147 . V_188 -- ;
V_192 -> V_213 += ( V_134 . V_9 - V_208 ) << V_52 ;
if ( V_192 -> V_214 )
V_192 -> V_214 += V_134 . V_9 - V_208 ;
V_208 = V_134 . V_9 ;
if ( F_221 ( V_192 , NULL , V_3 ) )
goto V_212;
F_140 ( V_3 ) ;
goto V_210;
V_212:
...
int F_223 ( struct V_191 * V_192 )
{
struct V_3 * V_3 = V_192 -> V_3 ;
struct V_146 * V_146 = F_224 ( V_192 -> V_184 -> V_193 ) ;
int V_33 = V_204 ;
F_225 ( V_146 -> V_151 ) ;
F_226 ( V_192 -> V_184 -> V_193 ) ;
F_173 ( V_3 ) ;
if ( V_3 -> V_2 != V_146 -> V_216 ) {
F_140 ( V_3 ) ;
V_33 = V_217 ;
goto V_56;
}
...
int F_230 ( struct V_137 * V_137 , struct V_183 * V_184 )
{
struct V_1 * V_2 = V_137 -> V_145 ;
if ( ! V_2 -> V_31 -> V_169 )
return - V_218 ;
...
int F_231 ( struct V_137 * V_137 , struct V_183 * V_184 )
{
if ( ( V_184 -> V_185 & V_221 ) && ( V_184 -> V_185 & V_222 ) )
return - V_223 ;
return F_230 ( V_137 , V_184 ) ;
}
int F_230 ( struct V_137 * V_137 , struct V_183 * V_184 )
{
return - V_224 ;
...
void * V_225 )
{
return F_235 ( V_2 , V_9 , F_236 , V_225 , F_238 ( V_2 ) ) ;
}
...
inline T_7 F_240 ( struct V_173 * V_174 , struct V_143 * V_226 )
{
struct V_137 * V_137 = V_174 -> V_175 ;
struct V_146 * V_146 = V_137 -> V_145 -> V_29 ;
unsigned long V_227 = F_241 ( V_228 ) ;
T_1 V_229 ;
if ( ! F_200 ( V_226 ) )
return 0 ;
if ( V_174 -> V_177 & V_230 )
V_174 -> V_180 = F_75 ( V_146 ) ;
V_229 = V_174 -> V_180 ;
if ( V_227 != V_231 ) {
if ( V_174 -> V_180 >= V_227 ) {
F_242 ( V_232 , V_22 , 0 ) ;
return - V_233 ;
}
F_191 ( V_226 , V_227 - ( unsigned long ) V_229 ) ;
}
if ( F_27 ( V_229 + F_200 ( V_226 ) > V_234 &&
! ( V_137 -> V_235 & V_236 ) ) ) {
if ( V_229 >= V_234 )
return - V_233 ;
F_191 ( V_226 , V_234 - ( unsigned long ) V_229 ) ;
}
if ( F_27 ( V_229 >= V_146 -> V_151 -> V_152 ) )
return - V_233 ;
F_191 ( V_226 , V_146 -> V_151 -> V_152 - V_229 ) ;
return F_200 ( V_226 ) ;
}
int F_243 ( struct V_137 * V_137 , struct V_1 * V_2 ,
T_1 V_229 , unsigned V_237 , unsigned V_30 ,
struct V_3 * * V_117 , void * * V_238 )
{
const struct V_239 * V_240 = V_2 -> V_31 ;
return V_240 -> V_241 ( V_137 , V_2 , V_229 , V_237 , V_30 ,
V_117 , V_238 ) ;
}
int F_244 ( struct V_137 * V_137 , struct V_1 * V_2 ,
T_1 V_229 , unsigned V_237 , unsigned V_242 ,
struct V_3 * V_3 , void * V_238 )
{
const struct V_239 * V_240 = V_2 -> V_31 ;
return V_240 -> V_243 ( V_137 , V_2 , V_229 , V_237 , V_242 , V_3 , V_238 ) ;
}
T_7
F_245 ( struct V_173 * V_174 , struct V_143 * V_226 )
{
struct V_137 * V_137 = V_174 -> V_175 ;
struct V_1 * V_2 = V_137 -> V_145 ;
struct V_146 * V_146 = V_2 -> V_29 ;
T_1 V_229 = V_174 -> V_180 ;
T_7 V_144 ;
T_8 V_244 ;
T_2 V_39 ;
V_244 = F_200 ( V_226 ) ;
V_39 = ( V_229 + V_244 - 1 ) >> V_52 ;
V_144 = F_78 ( V_2 , V_229 , V_229 + V_244 - 1 ) ;
if ( V_144 )
goto V_56;
V_144 = F_246 ( V_2 ,
V_229 >> V_52 , V_39 ) ;
...
V_144 = V_2 -> V_31 -> V_181 ( V_174 , V_226 ) ;
F_246 ( V_2 ,
V_229 >> V_52 , V_39 ) ;
if ( V_144 > 0 ) {
V_229 += V_144 ;
V_244 -= V_144 ;
if ( V_229 > F_75 ( V_146 ) && ! F_247 ( V_146 -> V_246 ) ) {
F_248 ( V_146 , V_229 ) ;
F_249 ( V_146 ) ;
}
V_174 -> V_180 = V_229 ;
}
F_207 ( V_226 , V_244 - F_200 ( V_226 ) ) ;
V_56:
return V_144 ;
}
...
struct V_143 * V_18 , T_1 V_229 )
{
struct V_1 * V_2 = V_137 -> V_145 ;
const struct V_239 * V_31 = V_2 -> V_31 ;
long V_248 = 0 ;
T_7 V_144 = 0 ;
unsigned int V_30 = 0 ;
do {
...
void * V_238 ;
V_70 = ( V_229 & ( V_154 - 1 ) ) ;
V_249 = F_252 (unsigned long, PAGE_SIZE - offset,
iov_iter_count(i)) ;
V_250:
if ( F_27 ( F_253 ( V_18 , V_249 ) ) ) {
V_248 = - V_168 ;
break;
}
if ( F_192 ( V_22 ) ) {
...
V_248 = V_31 -> V_241 ( V_137 , V_2 , V_229 , V_249 , V_30 ,
& V_3 , & V_238 ) ;
if ( F_27 ( V_248 < 0 ) )
break;
if ( F_197 ( V_2 ) )
F_198 ( V_3 ) ;
V_242 = F_254 ( V_3 , V_18 , V_70 , V_249 ) ;
F_198 ( V_3 ) ;
V_248 = V_31 -> V_243 ( V_137 , V_2 , V_229 , V_249 , V_242 ,
V_3 , V_238 ) ;
if ( F_27 ( V_248 < 0 ) )
break;
V_242 = V_248 ;
...
return V_144 ? V_144 : V_248 ;
}
T_7 F_257 ( struct V_173 * V_174 , struct V_143 * V_226 )
{
struct V_137 * V_137 = V_174 -> V_175 ;
struct V_1 * V_2 = V_137 -> V_145 ;
struct V_146 * V_146 = V_2 -> V_29 ;
...
if ( V_174 -> V_177 & V_178 ) {
T_1 V_229 , V_252 ;
V_144 = F_245 ( V_174 , V_226 ) ;
if ( V_144 < 0 || ! F_200 ( V_226 ) || F_208 ( V_146 ) )
goto V_56;
V_248 = F_251 ( V_137 , V_226 , V_229 = V_174 -> V_180 ) ;
if ( F_27 ( V_248 < 0 ) ) {
V_62 = V_248 ;
goto V_56;
}
V_252 = V_229 + V_248 - 1 ;
V_62 = F_78 ( V_2 , V_229 , V_252 ) ;
if ( V_62 == 0 ) {
V_174 -> V_180 = V_252 + 1 ;
V_144 += V_248 ;
F_260 ( V_2 ,
...
V_144 = F_251 ( V_137 , V_226 , V_174 -> V_180 ) ;
if ( F_125 ( V_144 > 0 ) )
V_174 -> V_180 += V_144 ;
}
V_56:
...
T_7 F_261 ( struct V_173 * V_174 , struct V_143 * V_226 )
{
struct V_137 * V_137 = V_174 -> V_175 ;
struct V_146 * V_146 = V_137 -> V_145 -> V_29 ;
T_7 V_33 ;
F_262 ( V_146 ) ;
V_33 = F_240 ( V_174 , V_226 ) ;
if ( V_33 > 0 )
V_33 = F_257 ( V_174 , V_226 ) ;
F_263 ( V_146 ) ;
if ( V_33 > 0 )
...
if ( F_266 ( V_3 ) )
return 0 ;
if ( V_2 && V_2 -> V_31 -> V_253 )
return V_2 -> V_31 -> V_253 ( V_3 , V_68 ) ;
return F_267 ( V_3 ) ;
}
