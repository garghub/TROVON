...
V_3 -> V_13 . V_28 = V_46 -> V_261 ;
if ( V_46 -> V_261 ) {
memcpy ( V_3 -> V_13 . V_24 , V_46 -> V_262 ,
V_46 -> V_261 ) ;
V_3 -> V_13 . V_29 =
V_3 -> V_13 . V_24 + V_46 -> V_261 ;
}
V_8 -> V_81 = V_81 -> V_40 ;
V_8 -> V_263 = NULL ;
return F_55 ( V_46 ) ;
...
static struct V_66 *
F_64 ( struct V_9 * V_10 , struct V_268 * V_150 ,
int V_269 )
{
struct V_1 * V_2 ;
struct V_66 * V_67 ;
...
V_127 = V_2 -> V_127 ;
V_276 = V_2 -> V_276 ;
if ( F_66 ( V_284 , & V_2 -> V_200 ) ||
F_66 ( V_285 , & V_2 -> V_200 ) ) {
V_282 = - V_41 ;
return F_65 ( V_282 ) ;
}
...
V_72 -> V_87 = ( T_3 ) - 1 ;
V_72 -> V_2 = V_2 ;
if ( V_150 -> V_287 == V_288 ) {
V_271 = (struct V_270 * ) V_150 ;
memcpy ( V_72 -> V_150 , & V_271 -> V_289 . V_290 ,
sizeof( struct V_291 ) ) ;
V_72 -> V_157 = F_68 ( V_271 -> V_292 ) ;
V_72 -> V_151 = V_152 ;
F_10 ( & V_2 -> V_35 , V_154 ,
L_28 ,
V_72 -> V_150 , V_72 -> V_157 ) ;
} else if ( V_150 -> V_287 == V_293 ) {
V_273 = (struct V_272 * ) V_150 ;
memcpy ( V_72 -> V_150 , & V_273 -> V_294 ,
sizeof( struct V_295 ) ) ;
V_72 -> V_157 = F_68 ( V_273 -> V_296 ) ;
V_72 -> V_151 = V_191 ;
F_10 ( & V_2 -> V_35 , V_154 ,
L_29 ,
V_72 -> V_150 , V_72 -> V_157 ) ;
...
if ( V_282 )
goto V_299;
V_282 = V_125 -> V_300 ( V_2 -> V_127 , & V_72 -> V_128 ,
& V_72 -> V_97 , & V_72 -> V_301 ) ;
if ( V_282 ) {
F_18 ( & V_2 -> V_35 , L_32 ) ;
V_282 = - V_129 ;
goto V_302;
...
V_204 = ( char * ) & V_278 ;
V_205 = sizeof( V_278 ) ;
memset ( & V_278 , 0 , V_205 ) ;
V_279 = V_307 ;
V_278 . V_128 = ( T_4 ) V_72 -> V_87 ;
V_278 . V_130 = V_2 -> V_308 ;
V_72 -> V_130 = V_2 -> V_308 ;
if ( V_72 -> V_151 == V_152 ) {
memcpy ( & V_278 . V_146 . V_309 , & V_72 -> V_150 ,
sizeof( struct V_291 ) ) ;
V_278 . V_310 = 4 ;
} else {
memcpy ( & V_278 . V_146 . V_311 , & V_72 -> V_150 ,
sizeof( struct V_295 ) ) ;
V_278 . V_310 = 16 ;
}
V_282 = F_72 ( V_10 , & V_75 , V_279 , V_204 ,
V_205 ) ;
if ( V_282 ) {
F_18 ( & V_2 -> V_35 ,
L_33 ,
...
V_312:
V_2 -> V_306 [ V_87 ] = NULL ;
V_282 = V_125 -> V_314 ( V_2 -> V_127 , V_72 -> V_128 ) ;
if ( V_282 )
F_70 ( & V_2 -> V_35 , L_34 ,
V_282 ) ;
V_302:
...
static int F_76 ( struct V_66 * V_67 , int V_315 )
{
struct V_71 * V_72 ;
int V_282 = 0 ;
if ( V_283 )
...
V_72 -> V_94 = V_325 ;
V_282 = V_125 -> V_326 ( V_2 -> V_127 , V_72 -> V_128 , V_201 ) ;
if ( V_282 ) {
F_70 ( & V_2 -> V_35 ,
L_38 , V_282 ) ;
} else {
...
V_325 ) ,
V_319 ) ;
if ( ( V_282 <= 0 ) || ( V_72 -> V_94 == V_325 ) ) {
F_70 ( & V_2 -> V_35 ,
L_39 ,
V_282 , V_319 , V_72 -> V_87 ) ;
}
}
V_324:
V_282 = V_125 -> V_314 ( V_2 -> V_127 , V_72 -> V_128 ) ;
...
V_323:
V_72 -> V_94 = V_286 ;
V_2 -> V_306 [ V_72 -> V_87 ] = NULL ;
V_2 -> V_88 . V_89 [ V_72 -> V_87 ] = NULL ;
F_89 ( & V_2 -> V_327 , V_72 -> V_156 ) ;
F_74 ( V_2 , V_72 ) ;
if ( V_3 )
V_3 -> V_67 = NULL ;
V_72 -> V_81 = NULL ;
...
static int F_91 ( struct V_1 * V_2 , T_1 V_328 )
{
struct V_274 * V_127 = V_2 -> V_127 ;
struct V_275 * V_276 ;
struct V_329 * V_330 ;
struct V_331 * V_332 ;
T_3 V_205 ;
...
V_330 = (struct V_329 * ) V_276 -> V_330 ;
if ( ! V_330 ) {
F_18 ( & V_2 -> V_35 , L_42 ) ;
return - V_93 ;
}
...
V_332 = F_92 ( V_205 , V_334 ) ;
if ( ! V_332 ) {
F_18 ( & V_2 -> V_35 , L_44 ) ;
return - V_93 ;
}
F_93 ( V_332 , V_205 ) ;
memcpy ( V_332 -> V_262 , V_276 -> V_335 , V_205 ) ;
V_332 -> V_336 = V_337 ;
if ( V_328 )
F_94 ( V_332 , F_95 ( V_338 ) , V_328 ) ;
V_253 = V_125 -> V_339 -> V_340 ( V_127 , V_332 ) ;
if ( V_253 ) {
F_18 ( & V_2 -> V_35 , L_45 ,
V_253 ) ;
F_96 ( V_332 ) ;
...
static void F_97 ( struct V_342 * V_343 )
{
struct V_71 * V_72 =
F_98 ( V_343 , struct V_71 , V_322 ) ;
struct V_1 * V_2 ;
int V_319 = 20 * V_320 ;
int V_282 ;
V_2 = V_72 -> V_2 ;
...
F_18 ( & V_2 -> V_35 ,
L_46 ,
V_72 -> V_87 , V_72 , V_282 ) ;
V_72 -> V_94 = V_316 ;
return;
}
V_282 = F_77 ( V_72 -> V_304 ,
( V_72 -> V_94 ==
V_317 ) ,
V_319 ) ;
if ( ( V_282 <= 0 ) || ( V_72 -> V_94 != V_317 ) ) {
V_72 -> V_94 = V_316 ;
F_18 ( & V_2 -> V_35 ,
L_47 ,
V_72 -> V_87 , V_72 ) ;
...
static int F_99 ( struct V_9 * V_10 , struct V_277 * V_344 )
{
struct V_1 * V_2 ;
struct V_71 * V_72 ;
int V_282 = 0 ;
...
if ( strcmp ( V_10 -> V_346 -> V_347 , L_48 ) ) {
V_282 = - V_129 ;
F_18 ( NULL , L_49 ,
V_10 -> V_346 -> V_347 ) ;
return V_282 ;
...
V_2 = F_5 ( V_10 ) ;
if ( V_344 -> V_128 == V_348 ) {
V_282 = F_91 ( V_2 , V_344 -> V_162 ) ;
goto V_349;
}
V_87 = ( T_3 ) V_344 -> V_128 ;
V_72 = V_2 -> V_306 [ V_87 ] ;
F_10 ( & V_2 -> V_35 , V_196 ,
L_50 , V_87 , V_72 ) ;
if ( ! V_72 ) {
...
if ( ! F_100 ( & V_344 -> V_350 [ 0 ] ) ) {
F_101 ( & V_2 -> V_35 , L_51 ) ;
V_282 = - V_351 ;
goto V_349;
}
F_42 ( & V_72 -> V_145 [ 0 ] , & V_2 -> V_144 [ 0 ] ) ;
F_42 ( & V_72 -> V_147 [ 0 ] , & V_344 -> V_350 [ 0 ] ) ;
V_72 -> V_162 = V_344 -> V_162 ;
if ( V_344 -> V_130 < V_352 ) {
V_72 -> V_130 = V_2 -> V_308 ;
F_10 ( & V_2 -> V_35 , V_196 ,
L_52 ,
V_344 -> V_130 , V_72 -> V_130 ) ;
}
if ( V_344 -> V_130 != V_2 -> V_308 ) {
if ( V_344 -> V_130 > V_353 ) {
V_282 = - V_93 ;
F_18 ( NULL , L_53 , V_344 -> V_130 ) ;
goto V_349;
}
F_102 ( V_2 , V_344 -> V_130 ) ;
V_72 -> V_130 = V_2 -> V_308 ;
}
V_345 = V_72 -> V_156 ;
if ( V_345 >= V_354 &&
V_345 < V_355 ) {
if ( F_103 ( & V_2 -> V_327 , V_345 ) )
V_345 = 0 ;
} else {
V_345 = 0 ;
}
if ( ! V_345 ) {
V_345 = F_104 ( & V_2 -> V_327 ) ;
if ( V_345 == V_356 ) {
F_18 ( & V_2 -> V_35 ,
L_54 ,
V_87 ) ;
...
V_72 -> V_156 = V_345 ;
if ( V_72 -> V_151 == V_152 ) {
memcpy ( & V_72 -> V_149 [ 0 ] , & V_344 -> V_143 . V_309 ,
sizeof( struct V_291 ) ) ;
memcpy ( & V_2 -> V_214 [ 0 ] , & V_344 -> V_143 . V_309 ,
sizeof( struct V_291 ) ) ;
V_2 -> V_151 = V_152 ;
F_10 ( & V_2 -> V_35 , V_154 ,
L_55 ,
...
memcpy ( & V_72 -> V_149 [ 0 ] , & V_344 -> V_143 . V_311 ,
sizeof( struct V_295 ) ) ;
memcpy ( & V_2 -> V_214 [ 0 ] , & V_344 -> V_143 . V_311 ,
sizeof( struct V_295 ) ) ;
V_2 -> V_151 = V_191 ;
F_10 ( & V_2 -> V_35 , V_154 ,
L_56 ,
...
F_105 ( & V_72 -> V_322 , F_97 ) ;
F_106 ( V_2 -> V_357 , & V_72 -> V_322 ) ;
V_282 = 0 ;
V_349:
return V_282 ;
}
static T_6 F_107 ( int V_358 , int V_203 )
{
switch ( V_358 ) {
case V_359 :
switch ( V_203 ) {
...
{
if ( ! V_46 -> V_264 || V_46 -> V_94 == V_393 ) {
F_10 ( NULL , V_394 , L_57 ,
F_109 ( & V_46 -> V_395 ) ) ;
return;
}
F_110 ( V_46 -> V_40 ) ;
...
char * F_113 ( enum V_398 V_399 )
{
int V_4 ;
char * V_400 = NULL ;
for ( V_4 = 0 ; V_4 < F_114 ( V_401 ) ; V_4 ++ ) {
if ( V_401 [ V_4 ] . V_402 == V_399 ) {
V_400 = V_401 [ V_4 ] . V_403 ;
break;
}
}
return V_400 ;
}
void F_115 ( struct V_71 * V_67 , struct V_404 * V_262 )
{
struct V_3 * V_3 ;
struct V_1 * V_2 ;
char V_405 [] = L_59 ;
...
void F_116 ( struct V_71 * V_67 , struct V_404 * V_262 )
{
struct V_3 * V_3 ;
if ( ! V_67 )
return;
