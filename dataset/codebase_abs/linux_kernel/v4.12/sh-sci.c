...
struct V_1 * V_114 = F_1 ( V_4 ) ;
long V_116 ;
if ( F_67 ( V_82 , 0 , & V_116 ) == - V_117 )
return - V_117 ;
V_114 -> V_115 = F_61 ( V_4 , V_116 ) ;
if ( V_4 -> type == V_26 || V_4 -> type == V_27 )
F_61 ( V_4 , 1 ) ;
return V_80 ;
}
...
{
unsigned int V_13 ;
for ( V_13 = 0 ; V_13 < F_77 ( V_24 -> V_125 ) ; V_13 ++ )
if ( V_24 -> V_126 == V_24 -> V_125 [ V_13 ] )
return V_13 ;
return - 1 ;
}
static void F_78 ( struct V_1 * V_24 , bool V_127 )
{
struct V_128 * V_129 = V_24 -> V_130 ;
struct V_2 * V_4 = & V_24 -> V_4 ;
unsigned long V_120 ;
F_72 ( & V_4 -> V_122 , V_120 ) ;
V_24 -> V_130 = NULL ;
V_24 -> V_125 [ 0 ] = V_24 -> V_125 [ 1 ] = - V_117 ;
F_73 ( & V_4 -> V_122 , V_120 ) ;
F_79 ( V_129 ) ;
F_80 ( V_129 -> V_111 -> V_14 , V_24 -> V_131 * 2 , V_24 -> V_132 [ 0 ] ,
F_81 ( & V_24 -> V_133 [ 0 ] ) ) ;
F_82 ( V_129 ) ;
if ( V_127 )
F_27 ( V_4 ) ;
...
V_136 = F_76 ( V_24 ) ;
if ( V_136 >= 0 )
V_80 = F_74 ( V_24 , V_24 -> V_132 [ V_136 ] , V_24 -> V_131 ) ;
F_84 ( & V_24 -> V_137 , V_138 + V_24 -> V_139 ) ;
if ( V_80 )
F_54 ( & V_4 -> V_33 -> V_4 ) ;
V_135 = F_85 ( V_24 -> V_130 , & V_24 -> V_133 [ V_136 ] , 1 ,
V_140 ,
V_141 | V_142 ) ;
if ( ! V_135 )
goto V_143;
V_135 -> V_144 = F_83 ;
V_135 -> V_145 = V_24 ;
V_24 -> V_125 [ V_136 ] = F_86 ( V_135 ) ;
if ( F_24 ( V_24 -> V_125 [ V_136 ] ) )
goto V_143;
V_24 -> V_126 = V_24 -> V_125 [ ! V_136 ] ;
F_87 ( V_129 ) ;
F_73 ( & V_4 -> V_122 , V_120 ) ;
F_57 ( V_4 -> V_14 , L_11 ,
V_121 , V_24 -> V_125 [ V_136 ] , V_136 , V_24 -> V_126 ) ;
return;
V_143:
F_73 ( & V_4 -> V_122 , V_120 ) ;
F_88 ( V_4 -> V_14 , L_12 ) ;
...
static void F_89 ( struct V_1 * V_24 , bool V_127 )
{
struct V_128 * V_129 = V_24 -> V_31 ;
struct V_2 * V_4 = & V_24 -> V_4 ;
unsigned long V_120 ;
F_72 ( & V_4 -> V_122 , V_120 ) ;
V_24 -> V_31 = NULL ;
...
F_73 ( & V_4 -> V_122 , V_120 ) ;
F_79 ( V_129 ) ;
F_90 ( V_129 -> V_111 -> V_14 , V_24 -> V_146 , V_84 ,
V_147 ) ;
F_82 ( V_129 ) ;
if ( V_127 )
F_19 ( V_4 ) ;
...
struct V_148 * V_149 = & V_24 -> V_133 [ V_13 ] ;
struct V_134 * V_135 ;
V_135 = F_85 ( V_129 ,
V_149 , 1 , V_140 ,
V_141 | V_142 ) ;
...
V_135 -> V_144 = F_83 ;
V_135 -> V_145 = V_24 ;
V_24 -> V_125 [ V_13 ] = F_86 ( V_135 ) ;
if ( F_24 ( V_24 -> V_125 [ V_13 ] ) )
goto V_143;
}
V_24 -> V_126 = V_24 -> V_125 [ 0 ] ;
F_87 ( V_129 ) ;
return;
V_143:
if ( V_13 )
F_79 ( V_129 ) ;
for ( V_13 = 0 ; V_13 < 2 ; V_13 ++ )
V_24 -> V_125 [ V_13 ] = - V_117 ;
V_24 -> V_126 = - V_117 ;
F_78 ( V_24 , true ) ;
}
static void F_92 ( struct V_150 * V_151 )
{
struct V_1 * V_24 = F_2 ( V_151 , struct V_1 , V_36 ) ;
struct V_134 * V_135 ;
struct V_128 * V_129 = V_24 -> V_31 ;
struct V_2 * V_4 = & V_24 -> V_4 ;
struct V_78 * V_34 = & V_4 -> V_33 -> V_34 ;
T_4 V_82 ;
F_93 ( & V_4 -> V_122 ) ;
V_82 = V_24 -> V_146 + ( V_34 -> V_83 & ( V_84 - 1 ) ) ;
V_24 -> V_123 = F_94 (unsigned int,
CIRC_CNT(xmit->head, xmit->tail, UART_XMIT_SIZE),
CIRC_CNT_TO_END(xmit->head, xmit->tail, UART_XMIT_SIZE)) ;
F_95 ( & V_4 -> V_122 ) ;
V_135 = F_96 ( V_129 , V_82 , V_24 -> V_123 ,
V_152 ,
V_141 | V_142 ) ;
if ( ! V_135 ) {
F_88 ( V_4 -> V_14 , L_13 ) ;
...
F_97 ( V_129 -> V_111 -> V_14 , V_82 , V_24 -> V_123 ,
V_147 ) ;
F_93 ( & V_4 -> V_122 ) ;
V_135 -> V_144 = F_71 ;
V_135 -> V_145 = V_24 ;
F_95 ( & V_4 -> V_122 ) ;
V_24 -> V_35 = F_86 ( V_135 ) ;
if ( F_24 ( V_24 -> V_35 ) ) {
F_88 ( V_4 -> V_14 , L_14 ) ;
F_89 ( V_24 , true ) ;
return;
...
F_57 ( V_4 -> V_14 , L_15 ,
V_121 , V_34 -> V_82 , V_34 -> V_83 , V_34 -> V_153 , V_24 -> V_35 ) ;
F_87 ( V_129 ) ;
}
...
V_47 = F_99 ( V_24 -> V_130 , V_24 -> V_126 , & V_33 ) ;
if ( V_47 == V_157 ) {
F_73 ( & V_4 -> V_122 , V_120 ) ;
F_57 ( V_4 -> V_14 , L_17 ,
V_24 -> V_126 , V_136 ) ;
...
F_79 ( V_24 -> V_130 ) ;
V_156 = F_101 ( & V_24 -> V_133 [ V_136 ] ) - V_33 . V_158 ;
if ( V_156 ) {
V_80 = F_74 ( V_24 , V_24 -> V_132 [ V_136 ] , V_156 ) ;
if ( V_80 )
F_54 ( & V_4 -> V_33 -> V_4 ) ;
}
if ( V_4 -> type == V_26 || V_4 -> type == V_27 )
...
struct V_163 V_21 ;
int V_164 ;
V_129 = F_104 ( V_4 -> V_14 ,
V_162 == V_152 ? L_19 : L_20 ) ;
if ( ! V_129 ) {
F_88 ( V_4 -> V_14 ,
L_21 ) ;
return NULL ;
...
V_164 = F_105 ( V_129 , & V_21 ) ;
if ( V_164 ) {
F_88 ( V_4 -> V_14 , L_22 , V_164 ) ;
F_82 ( V_129 ) ;
return NULL ;
}
return V_129 ;
...
return;
V_24 -> V_35 = - V_117 ;
V_129 = F_103 ( V_4 , V_152 ) ;
F_57 ( V_4 -> V_14 , L_24 , V_121 , V_129 ) ;
if ( V_129 ) {
V_24 -> V_31 = V_129 ;
V_24 -> V_146 = F_107 ( V_129 -> V_111 -> V_14 ,
V_4 -> V_33 -> V_34 . V_82 ,
V_84 ,
V_147 ) ;
if ( F_108 ( V_129 -> V_111 -> V_14 , V_24 -> V_146 ) ) {
F_88 ( V_4 -> V_14 , L_25 ) ;
F_82 ( V_129 ) ;
V_24 -> V_31 = NULL ;
} else {
F_57 ( V_4 -> V_14 , L_26 ,
V_121 , V_84 ,
V_4 -> V_33 -> V_34 . V_82 , & V_24 -> V_146 ) ;
}
F_109 ( & V_24 -> V_36 , F_92 ) ;
}
V_129 = F_103 ( V_4 , V_140 ) ;
F_57 ( V_4 -> V_14 , L_27 , V_121 , V_129 ) ;
if ( V_129 ) {
unsigned int V_13 ;
T_4 V_173 ;
void * V_82 ;
V_24 -> V_130 = V_129 ;
V_24 -> V_131 = 2 * F_110 ( T_3 , 16 , V_4 -> V_73 ) ;
V_82 = F_111 ( V_129 -> V_111 -> V_14 , V_24 -> V_131 * 2 ,
& V_173 , V_174 ) ;
if ( ! V_82 ) {
F_88 ( V_4 -> V_14 ,
L_28 ) ;
...
struct V_148 * V_149 = & V_24 -> V_133 [ V_13 ] ;
F_112 ( V_149 , 1 ) ;
V_24 -> V_132 [ V_13 ] = V_82 ;
F_81 ( V_149 ) = V_173 ;
F_101 ( V_149 ) = V_24 -> V_131 ;
V_82 += V_24 -> V_131 ;
V_173 += V_24 -> V_131 ;
}
F_70 ( & V_24 -> V_137 , F_98 , ( unsigned long ) V_24 ) ;
if ( V_4 -> type == V_26 || V_4 -> type == V_27 )
F_91 ( V_24 ) ;
}
}
...
static T_5 F_114 ( int V_175 , void * V_176 )
{
...
if ( ! F_62 ( V_4 ) )
F_61 ( V_4 , V_24 -> V_115 ) ;
F_84 ( & V_24 -> V_119 , V_138 + F_116 (
V_24 -> V_180 * V_24 -> V_118 , 1000 ) ) ;
}
F_47 ( V_176 ) ;
return V_179 ;
}
static T_5 F_117 ( int V_175 , void * V_176 )
{
struct V_2 * V_4 = V_176 ;
unsigned long V_120 ;
F_72 ( & V_4 -> V_122 , V_120 ) ;
...
static T_5 F_121 ( int V_175 , void * V_176 )
{
...
! V_24 -> V_31 )
V_164 = F_117 ( V_175 , V_176 ) ;
if ( ( ( V_181 & F_33 ( V_4 ) ) || V_24 -> V_130 ) &&
( V_182 & V_20 ) )
V_164 = F_114 ( V_175 , V_176 ) ;
if ( ( V_181 & F_31 ( V_4 ) ) && V_183 )
V_164 = F_118 ( V_175 , V_176 ) ;
if ( ( V_181 & F_60 ( V_4 ) ) && V_183 )
V_164 = F_119 ( V_175 , V_176 ) ;
...
V_175 = V_4 -> V_159 [ V_13 ] ;
if ( F_124 ( V_175 < 0 ) )
continue;
}
V_135 = V_189 + V_13 ;
V_4 -> V_191 [ V_187 ] = F_125 ( V_174 , L_30 ,
F_126 ( V_186 -> V_14 ) , V_135 -> V_135 ) ;
if ( ! V_4 -> V_191 [ V_187 ] ) {
V_164 = - V_192 ;
goto V_193;
}
V_164 = F_127 ( V_175 , V_135 -> V_194 , V_186 -> V_195 ,
V_4 -> V_191 [ V_187 ] , V_4 ) ;
if ( F_124 ( V_164 ) ) {
F_128 ( V_186 -> V_14 , L_31 , V_135 -> V_135 ) ;
goto V_196;
}
}
return 0 ;
V_196:
while ( -- V_13 >= 0 )
F_129 ( V_4 -> V_159 [ V_13 ] , V_4 ) ;
V_193:
while ( -- V_187 >= 0 )
F_130 ( V_4 -> V_191 [ V_187 ] ) ;
return V_164 ;
}
...
int V_175 = V_4 -> V_159 [ V_13 ] ;
if ( F_124 ( V_175 < 0 ) )
continue;
F_129 ( V_4 -> V_159 [ V_13 ] , V_4 ) ;
F_130 ( V_4 -> V_191 [ V_13 ] ) ;
if ( F_123 ( V_4 ) ) {
return;
}
}
...
static void F_135 ( struct V_2 * V_4 , unsigned int V_61 )
{
struct V_1 * V_24 = F_1 ( V_4 ) ;
if ( V_61 & V_201 ) {
const struct V_7 * V_8 ;
...
if ( F_134 ( V_4 ) )
V_61 |= V_206 ;
} else if ( F_139 ( F_140 ( V_203 , V_207 ) ) ) {
V_61 |= V_206 ;
}
if ( F_139 ( F_140 ( V_203 , V_208 ) ) )
V_61 |= V_209 ;
if ( F_139 ( F_140 ( V_203 , V_210 ) ) )
V_61 |= V_211 ;
return V_61 ;
}
...
#ifdef F_20
V_24 -> V_139 = F_116 ( V_24 -> V_131 * 2 * V_24 -> V_180 , 1000 ) ;
F_57 ( V_4 -> V_14 , L_40 ,
V_24 -> V_139 * 1000 / V_294 , V_4 -> V_295 ) ;
if ( V_24 -> V_139 < F_161 ( 20 ) )
V_24 -> V_139 = F_161 ( 20 ) ;
#endif
...
V_4 -> V_10 = F_166 ( V_4 -> V_167 , V_300 -> V_302 ) ;
if ( F_124 ( ! V_4 -> V_10 ) ) {
...
struct V_1 * V_300 = F_1 ( V_4 ) ;
int V_164 ;
V_307 = F_171 ( V_4 -> V_167 , V_300 -> V_302 ,
F_126 ( V_4 -> V_14 ) ) ;
if ( F_124 ( V_307 == NULL ) ) {
F_128 ( V_4 -> V_14 , L_48 ) ;
return - V_308 ;
...
static void F_173 ( struct V_2 * V_4 , int V_120 )
{
if ( V_120 & V_309 ) {
struct V_1 * V_300 = F_1 ( V_4 ) ;
...
static int F_175 ( struct V_1 * V_1 , struct V_111 * V_14 )
{
const char * V_313 [] = {
[ V_19 ] = L_49 ,
[ V_222 ] = L_50 ,
...
for ( V_13 = 0 ; V_13 < F_77 ( V_1 -> V_159 ) ; ++ V_13 )
V_1 -> V_159 [ V_13 ] = F_184 ( V_14 , V_13 ) ;
if ( V_1 -> V_159 [ 0 ] < 0 )
return - V_303 ;
if ( V_1 -> V_159 [ 1 ] < 0 ) {
...
return V_164 ;
if ( V_350 )
F_200 ( V_350 , & V_245 , & V_96 , & V_104 , & V_351 ) ;
return F_201 ( V_4 , V_343 , V_245 , V_96 , V_104 , V_351 ) ;
}
...
if ( ! V_368 )
return NULL ;
V_5 = F_212 ( & V_354 -> V_14 , sizeof( struct V_317 ) , V_174 ) ;
if ( ! V_5 )
return NULL ;
...
V_369 = & V_344 [ V_357 ] ;
* V_364 = V_357 ;
V_5 -> type = F_214 ( V_368 -> V_55 ) ;
V_5 -> V_318 = F_215 ( V_368 -> V_55 ) ;
...
V_164 = F_181 ( V_14 , V_372 , V_327 , V_5 , false ) ;
if ( V_164 )
return V_164 ;
V_372 -> V_203 = F_218 ( & V_372 -> V_4 , 0 ) ;
if ( F_178 ( V_372 -> V_203 ) && F_177 ( V_372 -> V_203 ) != - V_373 )
return F_177 ( V_372 -> V_203 ) ;
if ( V_372 -> V_60 ) {
if ( ! F_139 ( F_140 ( V_372 -> V_203 ,
V_207 ) ) ||
! F_139 ( F_140 ( V_372 -> V_203 ,
V_374 ) ) ) {
...
V_369 = & V_344 [ V_364 ] ;
F_222 ( V_14 , V_369 ) ;
V_164 = F_217 ( V_14 , V_364 , V_5 , V_369 ) ;
if ( V_164 )
return V_164 ;
if ( V_369 -> V_4 . V_73 > 1 ) {
V_164 = F_223 ( & V_14 -> V_14 . V_361 ,
& V_362 . V_113 ) ;
if ( V_164 )
return V_164 ;
}
...
static T_6 int F_226 ( struct V_111 * V_14 )
{
...
static T_6 int F_228 ( struct V_111 * V_14 )
{
struct V_1 * V_300 = F_65 ( V_14 ) ;
if ( V_300 )
...
static int T_7 F_238 ( struct V_378 * V_111 ,
int type )
{
if ( ! V_111 -> V_4 . V_10 )
return - V_353 ;
...
V_111 -> V_380 -> V_381 = F_190 ;
return 0 ;
}
static int T_7 F_239 ( struct V_378 * V_111 ,
const char * V_382 )
{
return F_238 ( V_111 , V_40 ) ;
}
static int T_7 F_240 ( struct V_378 * V_111 ,
const char * V_382 )
{
return F_238 ( V_111 , V_106 ) ;
}
static int T_7 F_241 ( struct V_378 * V_111 ,
const char * V_382 )
{
return F_238 ( V_111 , V_26 ) ;
}
static int T_7 F_242 ( struct V_378 * V_111 ,
const char * V_382 )
{
return F_238 ( V_111 , V_27 ) ;
}
static int T_7 F_243 ( struct V_378 * V_111 ,
const char * V_382 )
{
return F_238 ( V_111 , V_227 ) ;
}
