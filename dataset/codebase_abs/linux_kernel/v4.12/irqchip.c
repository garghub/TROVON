...
F_23 ( & V_7 -> V_39 , & V_37 -> V_45 [ V_7 -> V_4 ] ) ;
return 0 ;
}
bool __weak F_24 ( struct V_1 * V_1 )
{
return true ;
}
...
unsigned V_19 )
{
struct V_5 * V_47 , * V_48 ;
struct V_2 * V_7 ;
T_1 V_34 , V_49 , V_12 = 0 ;
int V_36 ;
for ( V_34 = 0 ; V_34 < V_46 ; ++ V_34 ) {
if ( V_41 [ V_34 ] . V_4 >= V_50 )
return - V_21 ;
V_12 = F_26 ( V_12 , V_41 [ V_34 ] . V_4 ) ;
}
V_12 += 1 ;
V_47 = F_27 ( sizeof( * V_47 ) + ( V_12 * sizeof( struct V_51 ) ) ,
V_52 ) ;
if ( ! V_47 )
return - V_53 ;
V_47 -> V_12 = V_12 ;
...
V_47 -> V_15 [ V_34 ] [ V_49 ] = - 1 ;
for ( V_34 = 0 ; V_34 < V_46 ; ++ V_34 ) {
V_36 = - V_53 ;
V_7 = F_27 ( sizeof( * V_7 ) , V_52 ) ;
if ( ! V_7 )
goto V_55;
V_36 = - V_21 ;
switch ( V_41 -> type ) {
