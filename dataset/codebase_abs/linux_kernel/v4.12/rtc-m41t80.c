...
static int F_22 ( struct V_44 * V_26 , struct V_54 * V_55 )
{
struct V_3 * V_4 = F_17 ( V_26 ) ;
T_2 V_56 [ 5 ] ;
int V_57 , V_24 ;
...
static int F_24 ( struct V_44 * V_26 )
{
struct V_3 * V_4 = F_17 ( V_26 ) ;
...
static int F_27 ( struct V_44 * V_26 )
{
struct V_3 * V_4 = F_17 ( V_26 ) ;
if ( V_4 -> V_1 >= 0 && F_25 ( V_26 ) )
F_28 ( V_4 -> V_1 ) ;
...
static T_3 F_29 ( struct V_44 * V_26 ,
...
static T_3 F_30 ( struct V_44 * V_26 ,
struct V_59 * V_60 , char * V_23 )
{
struct V_3 * V_4 = F_17 ( V_26 ) ;
struct V_5 * V_47 = F_2 ( V_4 ) ;
...
static T_3 F_31 ( struct V_44 * V_26 ,
struct V_59 * V_60 ,
...
V_71 [ 0 ] = 0x09 ;
F_36 ( V_75 -> V_80 , V_82 , 2 ) ;
V_71 [ 0 ] = 0x09 ;
V_71 [ 1 ] = 0x00 ;
F_36 ( V_75 -> V_80 , V_73 , 1 ) ;
}
static T_3 F_38 ( struct V_84 * V_84 , const char T_5 * V_23 ,
T_4 V_66 , T_6 * V_85 )
{
if ( V_66 ) {
F_35 () ;
...
static T_3 F_39 ( struct V_84 * V_84 , char T_5 * V_23 ,
T_4 V_66 , T_6 * V_85 )
{
return 0 ;
}
static int F_40 ( struct V_84 * V_84 , unsigned int V_86 ,
unsigned long V_87 )
{
int V_88 , V_89 ;
...
switch ( V_86 ) {
case V_98 :
return F_41 ( (struct V_90 T_5 * ) V_87 , & V_91 ,
sizeof( V_91 ) ) ? - V_99 : 0 ;
case V_100 :
case V_101 :
return F_42 ( V_102 , ( int T_5 * ) V_87 ) ;
case V_103 :
F_35 () ;
return 0 ;
case V_104 :
if ( F_43 ( V_88 , ( int T_5 * ) V_87 ) )
return - V_99 ;
if ( V_88 < 1 || V_88 > 124 )
return - V_27 ;
V_77 = V_88 ;
F_35 () ;
case V_105 :
return F_42 ( V_77 , ( int T_5 * ) V_87 ) ;
case V_106 :
if ( F_44 ( & V_89 , ( int T_5 * ) V_87 , sizeof( int ) ) )
return - V_99 ;
if ( V_89 & V_107 ) {
F_45 ( L_14 ) ;
F_37 () ;
...
static long F_46 ( struct V_84 * V_84 , unsigned int V_86 ,
unsigned long V_87 )
{
int V_57 ;
F_3 ( & V_110 ) ;
V_57 = F_40 ( V_84 , V_86 , V_87 ) ;
F_5 ( & V_110 ) ;
return V_57 ;
}
static int F_47 ( struct V_111 * V_111 , struct V_84 * V_84 )
{
if ( F_48 ( V_111 -> V_112 ) == V_113 ) {
F_3 ( & V_110 ) ;
if ( F_49 ( 0 , & V_114 ) ) {
F_5 ( & V_110 ) ;
return - V_115 ;
...
V_114 = 1 ;
F_5 ( & V_110 ) ;
return F_50 ( V_111 , V_84 ) ;
}
return - V_116 ;
}
static int F_51 ( struct V_111 * V_111 , struct V_84 * V_84 )
{
if ( F_48 ( V_111 -> V_112 ) == V_113 )
F_52 ( 0 , & V_114 ) ;
return 0 ;
}
static int F_53 ( struct V_117 * V_118 , unsigned long V_119 ,
void * V_120 )
{
...
static void F_54 ( void * V_124 )
{
struct V_44 * V_26 = V_124 ;
F_55 ( & V_26 -> V_125 , & V_126 ) ;
}
static int F_56 ( struct V_3 * V_4 ,
const struct V_127 * V_128 )
{
struct V_129 * V_80 = F_57 ( V_4 -> V_26 . V_130 ) ;
int V_69 = 0 ;
struct V_131 * V_9 = NULL ;
struct V_21 V_22 ;
struct V_5 * V_5 = NULL ;
if ( ! F_58 ( V_4 -> V_80 , V_132 |
V_133 ) ) {
F_9 ( & V_80 -> V_26 , L_16 ) ;
return - V_116 ;
}
V_5 = F_59 ( & V_4 -> V_26 , sizeof( * V_5 ) ,
V_134 ) ;
if ( ! V_5 )
return - V_135 ;
if ( V_4 -> V_26 . V_136 )
V_5 -> V_49 = ( unsigned long )
F_60 ( & V_4 -> V_26 ) ;
else
V_5 -> V_49 = V_128 -> V_137 ;
F_61 ( V_4 , V_5 ) ;
if ( V_4 -> V_1 > 0 ) {
V_69 = F_62 ( & V_4 -> V_26 , V_4 -> V_1 ,
NULL , F_1 ,
V_138 | V_139 ,
L_17 , V_4 ) ;
if ( V_69 ) {
...
V_9 = F_65 ( & V_4 -> V_26 , V_4 -> V_144 ,
& V_140 , V_145 ) ;
if ( F_66 ( V_9 ) )
return F_67 ( V_9 ) ;
V_5 -> V_9 = V_9 ;
V_69 = F_4 ( V_4 , V_146 ) ;
if ( V_69 >= 0 && V_69 & V_147 ) {
if ( V_5 -> V_49 & V_148 ) {
F_8 ( V_4 , & V_22 ) ;
F_68 ( & V_4 -> V_26 , L_19 ) ;
F_68 ( & V_4 -> V_26 ,
...
V_69 = F_69 ( & ( & V_4 -> V_26 ) -> V_125 , & V_126 ) ;
if ( V_69 ) {
F_9 ( & V_4 -> V_26 , L_23 , V_69 ) ;
return V_69 ;
}
V_69 = F_70 ( & V_4 -> V_26 , F_54 ,
& V_4 -> V_26 ) ;
if ( V_69 ) {
F_9 ( & V_4 -> V_26 ,
L_24 , V_69 ) ;
