...
static void F_147 ( struct V_9 * V_10 , void * V_192 )
{
F_141 ( * (struct V_2 * * ) V_192 ) ;
}
int F_148 ( struct V_9 * V_10 , struct V_2 * V_3 )
{
struct V_2 * * V_195 ;
int V_15 ;
V_195 = F_116 ( F_147 , sizeof( * V_195 ) , V_125 ) ;
if ( ! V_195 )
return - V_57 ;
* V_195 = V_3 ;
V_15 = F_132 ( V_3 ) ;
...
void F_149 ( struct V_9 * V_10 , struct V_2 * V_3 )
{
int V_196 ;
V_196 = F_120 ( V_10 , F_147 ,
F_113 , V_3 ) ;
F_114 ( V_196 ) ;
}
