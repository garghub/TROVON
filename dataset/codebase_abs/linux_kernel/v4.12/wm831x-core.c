...
int F_23 ( struct V_1 * V_1 , int V_187 )
{
...
F_26 ( V_1 -> V_12 , L_12 , 'A' + V_190 ) ;
break;
case V_207 :
V_193 = V_207 ;
V_1 -> V_201 = 12 ;
F_26 ( V_1 -> V_12 , L_13 , 'A' + V_190 ) ;
break;
case V_208 :
V_193 = V_208 ;
V_1 -> V_201 = 12 ;
F_26 ( V_1 -> V_12 , L_14 , 'A' + V_190 ) ;
break;
case V_209 :
V_193 = V_209 ;
V_1 -> V_201 = 12 ;
F_26 ( V_1 -> V_12 , L_15 , 'A' + V_190 ) ;
break;
case V_210 :
V_193 = V_210 ;
V_1 -> V_201 = 12 ;
F_26 ( V_1 -> V_12 , L_16 , 'A' + V_190 ) ;
break;
default:
...
V_1 -> V_3 = 1 ;
if ( V_189 && V_189 -> V_211 ) {
V_10 = V_189 -> V_211 ( V_1 ) ;
if ( V_10 != 0 ) {
...
if ( V_189 ) {
for ( V_184 = 0 ; V_184 < F_28 ( V_189 -> V_212 ) ; V_184 ++ ) {
if ( ! V_189 -> V_212 [ V_184 ] )
continue;
F_3 ( V_1 ,
V_62 + V_184 ,
V_189 -> V_212 [ V_184 ] & 0xffff ) ;
}
}
if ( V_189 && V_189 -> V_191 )
V_191 = V_189 -> V_191 * 10 ;
else
V_191 = - 1 ;
V_10 = F_29 ( V_1 , V_187 ) ;
if ( V_10 != 0 )
...
if ( V_189 && V_189 -> V_222 ) {
V_10 = F_31 ( V_1 -> V_12 , V_191 , V_223 ,
F_28 ( V_223 ) , NULL ,
0 , NULL ) ;
if ( V_10 < 0 )
F_8 ( V_1 -> V_12 , L_26 ,
...
F_33 ( V_1 ) ;
if ( V_189 && V_189 -> V_224 ) {
V_10 = V_189 -> V_224 ( V_1 ) ;
if ( V_10 != 0 ) {
