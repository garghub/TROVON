...
T_4 F_18 ( struct V_52 * V_53 , struct V_54 * V_55 ,
char * V_56 )
{
T_1 * V_1 = F_19 ( V_53 ) ;
T_2 * V_3 = V_1 -> V_3 ;
...
if ( V_1 -> V_12 & V_13 &&
F_20 ( V_1 -> V_15 , V_57 ) )
V_58 = F_21 ( V_1 -> V_15 - V_57 ) ;
else
V_58 = 0 ;
F_6 ( & V_3 -> V_11 ) ;
return snprintf ( V_56 , 20 , L_1 , V_58 ) ;
}
T_4 F_22 ( struct V_52 * V_53 , struct V_54 * V_55 ,
