...
V_51 &= 0xffff ;
if ( V_51 != 0 ) {
V_68 = F_32 ( V_43 , V_45 , L_13 , L_14 ,
V_70 ) ;
goto V_71;
}
if ( V_46 > V_56 ) {
V_68 = F_32 ( V_43 , V_45 , L_15 , L_16 ,
V_73 ) ;
goto V_71;
}
F_10 ( L_17 , V_46 ) ;
...
V_51 &= 0xffff ;
if ( V_51 != 0 ) {
V_68 = F_32 ( V_43 , V_45 , L_24 , L_25 ,
V_70 ) ;
goto V_71;
}
if ( V_46 > V_56 ) {
V_68 = F_32 ( V_43 , V_45 , L_26 , L_27 ,
V_73 ) ;
goto V_71;
}
F_10 ( L_17 , V_46 ) ;
...
{
struct V_23 V_47 ;
if ( F_34 ( V_45 , * V_79 , & V_47 , sizeof( V_47 ) ) < 0 )
F_9 () ;
* V_79 += sizeof( V_47 ) ;
* V_80 = F_30 ( V_47 . V_46 ) & 0xffff ;
}
...
V_82 . V_93 = F_14 ( 0 ) ;
V_82 . V_94 = 0 ;
V_86 . V_95 = & V_2 -> V_9 . V_96 -> V_97 . V_98 . sin ;
V_86 . V_99 = sizeof( V_2 -> V_9 . V_96 -> V_97 . V_98 . sin ) ;
V_86 . V_100 = NULL ;
V_86 . V_101 = 0 ;
V_86 . V_102 = 0 ;
...
V_84 . V_52 = 0 ;
V_84 . type = V_104 ;
V_84 . V_105 = V_2 -> V_106 ;
V_84 . V_107 = 0 ;
V_84 . V_108 = V_2 -> V_13 ;
V_84 . V_109 = 0 ;
V_84 . V_110 = F_44 ( V_2 -> V_9 . V_111 ) ;
V_88 [ 0 ] . V_112 = & V_84 ;
V_88 [ 0 ] . V_113 = sizeof( V_84 ) ;
V_88 [ 1 ] . V_112 = & V_82 ;
V_88 [ 1 ] . V_113 = sizeof( V_82 ) ;
V_56 = V_88 [ 0 ] . V_113 + V_88 [ 1 ] . V_113 ;
V_89 = F_45 ( & V_2 -> V_89 ) ;
V_84 . V_89 = F_14 ( V_89 ) ;
F_46 ( L_32 , V_89 ) ;
V_7 = F_47 ( V_2 -> V_9 . V_114 -> V_115 , & V_86 , V_88 , 2 , V_56 ) ;
if ( V_7 < 0 ) {
F_6 ( L_33 , V_7 ) ;
return - V_116 ;
}
...
V_84 . type = V_122 ;
V_84 . V_105 = V_2 -> V_106 ;
V_84 . V_108 = V_50 -> V_108 ;
V_84 . V_110 = F_44 ( V_50 -> V_110 ) ;
V_88 [ 0 ] . V_112 = & V_84 ;
V_88 [ 0 ] . V_113 = sizeof( V_84 ) ;
V_88 [ 1 ] . V_112 = V_119 ;
V_88 [ 1 ] . V_113 = sizeof( * V_119 ) ;
V_88 [ 2 ] . V_112 = ( void * ) V_121 -> V_123 ;
V_88 [ 2 ] . V_113 = V_121 -> V_124 ;
V_56 = V_88 [ 0 ] . V_113 + V_88 [ 1 ] . V_113 + V_88 [ 2 ] . V_113 ;
V_89 = F_45 ( & V_2 -> V_89 ) ;
V_84 . V_89 = F_14 ( V_89 ) ;
F_46 ( L_34 , V_89 ) ;
V_7 = F_47 ( V_2 -> V_9 . V_114 -> V_115 , & V_86 , V_88 , 3 , V_56 ) ;
if ( V_7 < 0 ) {
F_6 ( L_33 , V_7 ) ;
return - V_116 ;
}
...
static void F_49 ( struct V_118 * V_125 )
{
T_3 V_126 = 1000003 ;
int V_127 ;
T_6 * V_128 = ( T_6 * ) V_125 ;
...
struct V_31 V_32 ;
struct V_29 V_30 [ 1 ] ;
memcpy ( & V_32 , V_121 -> V_17 , sizeof( V_32 ) ) ;
F_26 ( V_30 , 1 ) ;
F_51 ( V_30 , & V_119 -> V_129 , sizeof( V_119 -> V_129 ) ) ;
F_16 ( V_28 , V_2 -> V_27 ) ;
F_17 ( V_28 , 0 , NULL , NULL ) ;
F_18 ( V_28 , V_30 , V_30 , sizeof( V_119 -> V_129 ) , V_32 . V_40 ) ;
F_19 ( V_28 ) ;
F_20 ( V_28 ) ;
}
...
V_132 = F_54 ( L_36 ) ;
V_133 = V_137 ;
if ( F_34 ( V_45 , sizeof( struct V_83 ) ,
& V_82 , sizeof( V_82 ) ) < 0 )
goto V_71;
V_91 = F_30 ( V_82 . V_91 ) ;
V_92 = F_30 ( V_82 . V_92 ) ;
...
V_119 . V_91 = F_14 ( V_139 ) ;
V_119 . V_129 . V_38 = F_14 ( V_2 -> V_37 . V_38 ) ;
V_119 . V_129 . V_39 = F_14 ( V_2 -> V_37 . V_39 ) ;
V_119 . V_129 . V_108 = F_14 ( V_2 -> V_13 ) ;
V_119 . V_129 . V_142 = F_14 ( V_92 + 1 ) ;
V_119 . V_129 . V_143 = F_14 ( V_2 -> V_9 . V_18 ) ;
V_119 . V_144 = F_14 ( V_6 -> V_16 -> V_144 ) ;
V_119 . V_124 = F_14 ( V_6 -> V_16 -> V_124 ) ;
V_119 . V_129 . V_53 [ 0 ] = F_14 ( V_2 -> V_145 [ 0 ] . V_146 ) ;
V_119 . V_129 . V_53 [ 1 ] = F_14 ( V_2 -> V_145 [ 1 ] . V_146 ) ;
V_119 . V_129 . V_53 [ 2 ] = F_14 ( V_2 -> V_145 [ 2 ] . V_146 ) ;
V_119 . V_129 . V_53 [ 3 ] = F_14 ( V_2 -> V_145 [ 3 ] . V_146 ) ;
F_49 ( & V_119 ) ;
F_50 ( V_2 , & V_119 , V_6 -> V_16 ) ;
return F_48 ( V_2 , & V_49 -> V_50 , & V_119 , V_6 -> V_16 ) ;
V_71:
F_55 ( NULL , V_49 -> V_50 . V_89 , V_132 ) ;
V_7 = - V_74 ;
V_136:
* V_130 = V_133 ;
return V_7 ;
...
int V_7 ;
T_3 V_133 ;
T_6 * V_128 , * V_156 , * V_157 , * V_158 ;
F_2 ( L_1 , V_2 -> V_8 , F_3 ( V_2 -> V_159 ) ) ;
* V_148 = 0 ;
V_7 = F_29 ( V_2 -> V_159 ) ;
if ( V_7 < 0 ) {
switch ( V_7 ) {
...
ASSERT ( V_2 -> V_159 -> V_11 . V_12 [ 0 ] != NULL ) ;
F_57 ( ( unsigned long ) V_123 & 7UL , == , 0 ) ;
memcpy ( & V_32 , & V_2 -> V_159 -> V_11 . V_12 [ 2 ] , sizeof( V_32 ) ) ;
V_7 = - V_36 ;
V_28 = F_58 ( V_2 -> V_159 -> V_11 . V_12 [ 0 ] ,
V_162 ) ;
if ( ! V_28 )
goto V_163;
F_15 ( & V_30 [ 0 ] , V_123 , V_124 ) ;
F_17 ( V_28 , 0 , NULL , NULL ) ;
F_18 ( V_28 , V_30 , V_30 , V_124 , V_32 . V_40 ) ;
F_33 ( V_28 ) ;
F_59 ( V_28 ) ;
V_128 = V_123 ;
V_158 = V_128 + V_124 ;
...
F_6 ( L_42 , V_157 ) ;
V_132 = F_54 ( L_43 ) ;
if ( V_158 - V_128 < 4 + 8 + 4 + 2 )
goto V_167;
memcpy ( & V_151 , V_128 , sizeof( V_151 ) ) ;
V_128 += 4 ;
F_6 ( L_44 , & V_151 ) ;
memcpy ( & V_10 , V_128 , sizeof( V_10 ) ) ;
V_128 += 8 ;
F_6 ( L_45 , F_30 ( V_10 . V_168 [ 0 ] ) , F_30 ( V_10 . V_168 [ 1 ] ) ) ;
memcpy ( V_147 , & V_10 , sizeof( V_10 ) ) ;
V_152 = * V_128 ++ * 5 * 60 ;
F_6 ( L_46 , V_152 ) ;
if ( V_155 ) {
T_9 V_169 ;
memcpy ( & V_169 , V_128 , 4 ) ;
V_153 = F_61 ( V_169 ) ;
} else {
T_1 V_169 ;
memcpy ( & V_169 , V_128 , 4 ) ;
...
V_128 += 4 ;
V_154 = F_63 () ;
F_6 ( L_47 , V_153 , V_154 ) ;
if ( V_153 > V_154 ) {
V_133 = V_161 ;
V_7 = - V_26 ;
goto V_136;
}
if ( V_153 < V_154 - V_152 ) {
V_133 = V_135 ;
V_7 = - V_160 ;
goto V_136;
}
...
struct V_31 V_32 ;
F_2 ( L_50 ,
F_30 ( V_17 -> V_168 [ 0 ] ) , F_30 ( V_17 -> V_168 [ 1 ] ) ) ;
ASSERT ( V_172 != NULL ) ;
F_65 ( & V_173 ) ;
if ( F_8 ( V_172 , V_17 -> V_40 ,
sizeof( * V_17 ) ) < 0 )
F_9 () ;
...
T_7 V_174 ;
void * V_123 ;
T_3 V_133 , V_91 , V_144 , V_124 , V_143 ;
T_1 V_126 ;
int V_7 , V_175 ;
F_2 ( L_31 , V_2 -> V_8 , F_3 ( V_2 -> V_159 ) ) ;
V_132 = F_54 ( L_51 ) ;
V_133 = V_137 ;
if ( F_34 ( V_45 , sizeof( struct V_83 ) ,
& V_125 , sizeof( V_125 ) ) < 0 )
goto V_71;
if ( ! F_68 ( V_45 , sizeof( V_125 ) ) )
F_9 () ;
V_91 = F_30 ( V_125 . V_91 ) ;
V_124 = F_30 ( V_125 . V_124 ) ;
V_144 = F_30 ( V_125 . V_144 ) ;
F_46 ( L_52 ,
V_49 -> V_50 . V_89 , V_91 , V_144 , V_124 ) ;
V_132 = F_54 ( L_53 ) ;
V_133 = V_138 ;
if ( V_91 != V_139 )
goto V_71;
...
V_123 , V_124 ) < 0 )
goto V_180;
V_7 = F_56 ( V_2 , V_45 , V_123 , V_124 , & V_17 ,
& V_174 , V_130 ) ;
if ( V_7 < 0 )
goto V_181;
F_64 ( V_2 , & V_125 , & V_17 ) ;
V_132 = F_54 ( L_57 ) ;
V_133 = V_70 ;
if ( F_30 ( V_125 . V_129 . V_38 ) != V_2 -> V_37 . V_38 )
goto V_180;
if ( F_30 ( V_125 . V_129 . V_39 ) != V_2 -> V_37 . V_39 )
goto V_180;
if ( F_30 ( V_125 . V_129 . V_108 ) != V_2 -> V_13 )
goto V_180;
...
struct V_42 * V_43 ;
T_3 V_53 = F_30 ( V_125 . V_129 . V_53 [ V_175 ] ) ;
V_132 = F_54 ( L_59 ) ;
if ( V_53 > V_184 )
goto V_185;
V_132 = F_54 ( L_60 ) ;
if ( V_53 < V_2 -> V_145 [ V_175 ] . V_146 )
goto V_185;
V_132 = F_54 ( L_61 ) ;
if ( V_53 > V_2 -> V_145 [ V_175 ] . V_146 ) {
V_43 = F_70 (
V_2 -> V_145 [ V_175 ] . V_43 ,
F_71 ( & V_2 -> V_182 ) ) ;
if ( V_43 && V_43 -> V_186 < V_187 )
goto V_185;
V_2 -> V_145 [ V_175 ] . V_146 = V_53 ;
}
}
F_72 ( & V_2 -> V_182 ) ;
V_132 = F_54 ( L_62 ) ;
V_133 = V_188 ;
if ( F_30 ( V_125 . V_129 . V_142 ) != V_2 -> V_90 + 1 )
goto V_180;
V_132 = F_54 ( L_63 ) ;
V_133 = V_140 ;
V_143 = F_30 ( V_125 . V_129 . V_143 ) ;
if ( V_143 > V_24 )
goto V_180;
V_2 -> V_9 . V_18 = V_143 ;
V_7 = F_73 ( V_2 , & V_17 , V_174 , V_144 ) ;
if ( V_7 < 0 )
goto V_181;
F_21 ( V_123 ) ;
F_10 ( L_6 ) ;
