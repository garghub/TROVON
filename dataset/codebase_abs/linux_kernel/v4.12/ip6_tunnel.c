...
int V_48 = - 1 ;
if ( V_25 -> V_30 . V_43 ) {
V_197 = F_113 ( V_64 ) -> V_198 . V_199 ;
goto V_200;
} else {
V_197 = V_25 -> V_30 . V_197 ;
}
if ( F_13 ( & V_25 -> V_30 . V_32 ) ) {
if ( V_64 -> V_172 == F_114 ( V_201 ) ) {
struct V_1 * V_202 ;
struct V_203 * V_204 ;
int V_205 ;
if ( ! F_63 ( V_64 ) )
goto V_206;
V_204 = F_115 ( F_63 ( V_64 ) ,
& F_70 ( V_64 ) -> V_102 ) ;
if ( ! V_204 )
goto V_206;
...
if ( ! V_131 ) {
V_200:
V_189 -> V_210 = F_118 ( V_140 , V_189 -> V_210 ) ;
...
V_106 = F_64 ( V_131 ) - V_193 - V_25 -> V_213 ;
if ( V_111 >= 0 ) {
V_195 += 8 ;
V_106 -= 8 ;
}
...
if ( V_64 -> V_100 - V_25 -> V_213 > V_106 && ! F_126 ( V_64 ) ) {
* V_190 = V_106 ;
V_48 = - V_214 ;
goto V_212;
}
...
V_195 += F_129 ( V_192 ) ;
if ( F_130 ( V_64 ) < V_195 || F_131 ( V_64 ) ||
( F_132 ( V_64 ) && ! F_133 ( V_64 , 0 ) ) ) {
struct V_63 * V_219 ;
V_219 = F_134 ( V_64 , V_195 ) ;
if ( ! V_219 )
goto V_212;
if ( V_64 -> V_220 )
F_135 ( V_219 , V_64 -> V_220 ) ;
F_136 ( V_64 ) ;
V_64 = V_219 ;
}
if ( V_25 -> V_30 . V_43 ) {
if ( V_25 -> V_221 . type != V_222 )
goto V_212;
} else {
if ( V_196 && V_191 )
...
V_195 = F_129 ( V_131 -> V_8 ) + sizeof( struct V_66 )
+ V_131 -> V_223 + V_25 -> V_224 ;
if ( V_195 > V_8 -> V_225 )
V_8 -> V_225 = V_195 ;
V_48 = F_139 ( V_64 , V_25 , & V_104 , V_189 ) ;
if ( V_48 )
return V_48 ;
F_140 ( V_64 , sizeof( struct V_66 ) ) ;
F_55 ( V_64 ) ;
V_67 = F_70 ( V_64 ) ;
F_141 ( V_67 , V_140 ,
F_142 ( V_22 , V_64 , V_189 -> V_210 , true , V_189 ) ) ;
V_67 -> V_197 = V_197 ;
V_67 -> V_71 = V_104 ;
...
V_140 = F_148 ( V_25 -> V_30 . V_241 ) ;
if ( V_25 -> V_30 . V_33 & V_209 )
V_189 . V_242 = V_64 -> V_243 ;
else
V_189 . V_242 = V_25 -> V_30 . V_244 ;
}
V_189 . V_245 = F_149 ( F_26 ( V_8 ) , NULL ) ;
if ( F_150 ( V_64 , V_246 ) )
return - 1 ;
V_140 = F_151 ( V_140 , F_147 ( V_227 ) ) ;
F_152 ( V_64 , V_122 ) ;
...
V_92 = F_40 ( V_64 , F_154 ( V_64 ) ) ;
V_67 = F_70 ( V_64 ) ;
if ( V_92 > 0 ) {
struct V_82 * V_83 ;
V_83 = ( void * ) & F_154 ( V_64 ) [ V_92 ] ;
if ( V_83 -> V_111 == 0 ) {
F_71 ( V_64 , V_109 ,
V_110 , V_92 + 2 ) ;
return - 1 ;
...
static T_9
F_156 ( struct V_63 * V_64 , struct V_7 * V_8 )
{
struct V_21 * V_25 = F_21 ( V_8 ) ;
struct V_6 * V_20 = & V_25 -> V_8 -> V_20 ;
int V_154 ;
...
static void F_157 ( struct V_21 * V_25 )
{
...
V_189 -> V_210 = 0 ;
if ( ! ( V_38 -> V_33 & V_208 ) )
V_189 -> V_210 |= V_257 & V_38 -> V_241 ;
if ( ! ( V_38 -> V_33 & V_247 ) )
V_189 -> V_210 |= V_258 & V_38 -> V_241 ;
...
V_8 -> V_33 &= ~ V_259 ;
V_25 -> V_213 = 0 ;
V_25 -> V_224 = V_25 -> V_194 + V_25 -> V_213 ;
V_253 = V_25 -> V_224 + sizeof( struct V_66 ) ;
if ( V_38 -> V_33 & V_152 ) {
...
static int
F_158 ( struct V_21 * V_25 , const struct V_37 * V_38 )
{
...
V_25 -> V_30 . V_241 = V_38 -> V_241 ;
V_25 -> V_30 . V_151 = V_38 -> V_151 ;
V_25 -> V_30 . V_104 = V_38 -> V_104 ;
V_25 -> V_30 . V_244 = V_38 -> V_244 ;
F_38 ( & V_25 -> V_47 ) ;
F_157 ( V_25 ) ;
return 0 ;
}
...
F_19 ( V_27 , V_25 ) ;
F_160 () ;
V_48 = F_158 ( V_25 , V_38 ) ;
F_16 ( V_27 , V_25 ) ;
F_161 ( V_25 -> V_8 ) ;
return V_48 ;
}
static int F_162 ( struct V_21 * V_25 , struct V_37 * V_38 )
{
V_25 -> V_30 . V_104 = V_38 -> V_104 ;
F_161 ( V_25 -> V_8 ) ;
return 0 ;
...
static void
F_163 ( struct V_37 * V_38 , const struct V_262 * V_235 )
{
...
case V_267 :
if ( V_8 == V_27 -> V_62 ) {
if ( F_166 ( & V_38 , V_264 -> V_268 . V_269 , sizeof( V_38 ) ) ) {
V_48 = - V_270 ;
break;
}
F_163 ( & V_266 , & V_38 ) ;
...
F_164 ( & V_38 , & V_25 -> V_30 ) ;
if ( F_167 ( V_264 -> V_268 . V_269 , & V_38 , sizeof( V_38 ) ) ) {
V_48 = - V_270 ;
}
break;
case V_271 :
...
V_25 = F_21 ( V_8 ) ;
if ( V_8 == V_27 -> V_62 )
V_48 = F_162 ( V_25 , & V_266 ) ;
else
V_48 = F_159 ( V_25 , & V_266 ) ;
}
if ( ! F_59 ( V_25 ) ) {
V_48 = 0 ;
F_164 ( & V_38 , & V_25 -> V_30 ) ;
...
int F_170 ( struct V_7 * V_8 , int V_278 )
{
...
int F_171 ( const struct V_7 * V_8 )
{
struct V_21 * V_25 = F_21 ( V_8 ) ;
...
if ( V_282 >= V_283 )
return - V_284 ;
return ! F_173 ( ( const struct V_281 * * )
& V_285 [ V_282 ] ,
NULL , V_135 ) ? 0 : - 1 ;
}
int F_174 ( const struct V_281 * V_135 ,
unsigned int V_282 )
{
int V_154 ;
if ( V_282 >= V_283 )
return - V_284 ;
V_154 = ( F_173 ( ( const struct V_281 * * )
& V_285 [ V_282 ] ,
V_135 , NULL ) == V_135 ) ? 0 : - 1 ;
F_160 () ;
return V_154 ;
}
int F_175 ( struct V_21 * V_25 ,
struct V_286 * V_287 )
{
int V_224 ;
memset ( & V_25 -> V_221 , 0 , sizeof( V_25 -> V_221 ) ) ;
V_224 = F_176 ( V_287 ) ;
if ( V_224 < 0 )
return V_224 ;
V_25 -> V_221 . type = V_287 -> type ;
V_25 -> V_221 . V_288 = V_287 -> V_288 ;
V_25 -> V_221 . V_289 = V_287 -> V_289 ;
V_25 -> V_221 . V_33 = V_287 -> V_33 ;
V_25 -> V_194 = V_224 ;
V_25 -> V_224 = V_25 -> V_194 + V_25 -> V_213 ;
return 0 ;
}
...
V_25 -> V_8 = V_8 ;
V_25 -> V_22 = F_26 ( V_8 ) ;
V_8 -> V_14 = F_180 ( struct V_9 ) ;
if ( ! V_8 -> V_14 )
return - V_54 ;
V_154 = F_181 ( & V_25 -> V_47 , V_304 ) ;
if ( V_154 )
goto V_305;
V_154 = F_182 ( & V_25 -> V_46 , V_8 ) ;
if ( V_154 )
goto V_306;
V_25 -> V_213 = 0 ;
V_25 -> V_224 = V_25 -> V_194 + V_25 -> V_213 ;
V_253 = V_25 -> V_224 + sizeof( struct V_66 ) ;
V_8 -> type = V_294 ;
V_8 -> V_261 = V_307 + V_253 ;
V_8 -> V_106 = V_308 - V_253 ;
if ( ! ( V_25 -> V_30 . V_33 & V_238 ) )
V_8 -> V_106 -= 8 ;
V_8 -> V_309 = V_280 ;
V_8 -> V_310 = 0xFFF8 - V_8 -> V_261 ;
return 0 ;
V_306:
F_23 ( & V_25 -> V_47 ) ;
V_305:
...
static int T_10 F_184 ( struct V_7 * V_8 )
{
struct V_21 * V_25 = F_21 ( V_8 ) ;
struct V_22 * V_22 = F_26 ( V_8 ) ;
struct V_26 * V_27 = F_10 ( V_22 , V_28 ) ;
...
static int F_185 ( struct V_312 * V_313 [] , struct V_312 * V_69 [] )
{
T_5 V_104 ;
if ( ! V_69 || ! V_69 [ V_314 ] )
return 0 ;
V_104 = F_186 ( V_69 [ V_314 ] ) ;
if ( V_104 != V_138 &&
V_104 != V_122 &&
V_104 != 0 )
return - V_276 ;
...
static void F_187 ( struct V_312 * V_69 [] ,
struct V_37 * V_30 )
{
...
return;
if ( V_69 [ V_315 ] )
V_30 -> V_151 = F_188 ( V_69 [ V_315 ] ) ;
if ( V_69 [ V_316 ] )
V_30 -> V_31 = F_189 ( V_69 [ V_316 ] ) ;
if ( V_69 [ V_317 ] )
V_30 -> V_32 = F_189 ( V_69 [ V_317 ] ) ;
if ( V_69 [ V_318 ] )
V_30 -> V_197 = F_186 ( V_69 [ V_318 ] ) ;
if ( V_69 [ V_319 ] )
V_30 -> V_111 = F_186 ( V_69 [ V_319 ] ) ;
if ( V_69 [ V_320 ] )
V_30 -> V_241 = F_190 ( V_69 [ V_320 ] ) ;
if ( V_69 [ V_321 ] )
V_30 -> V_33 = F_188 ( V_69 [ V_321 ] ) ;
if ( V_69 [ V_314 ] )
V_30 -> V_104 = F_186 ( V_69 [ V_314 ] ) ;
if ( V_69 [ V_322 ] )
V_30 -> V_43 = true ;
if ( V_69 [ V_323 ] )
V_30 -> V_244 = F_188 ( V_69 [ V_323 ] ) ;
}
static bool F_191 ( struct V_312 * V_69 [] ,
struct V_286 * V_287 )
{
bool V_154 = false ;
...
if ( V_69 [ V_324 ] ) {
V_154 = true ;
V_287 -> type = F_192 ( V_69 [ V_324 ] ) ;
}
if ( V_69 [ V_325 ] ) {
V_154 = true ;
V_287 -> V_33 = F_192 ( V_69 [ V_325 ] ) ;
}
if ( V_69 [ V_326 ] ) {
V_154 = true ;
V_287 -> V_288 = F_193 ( V_69 [ V_326 ] ) ;
}
if ( V_69 [ V_327 ] ) {
V_154 = true ;
V_287 -> V_289 = F_193 ( V_69 [ V_327 ] ) ;
}
return V_154 ;
}
static int F_194 ( struct V_22 * V_328 , struct V_7 * V_8 ,
struct V_312 * V_313 [] , struct V_312 * V_69 [] )
{
struct V_22 * V_22 = F_26 ( V_8 ) ;
struct V_26 * V_27 = F_10 ( V_22 , V_28 ) ;
struct V_21 * V_329 , * V_25 ;
struct V_286 V_287 ;
V_329 = F_21 ( V_8 ) ;
if ( F_191 ( V_69 , & V_287 ) ) {
int V_48 = F_175 ( V_329 , & V_287 ) ;
if ( V_48 < 0 )
return V_48 ;
}
F_187 ( V_69 , & V_329 -> V_30 ) ;
if ( V_329 -> V_30 . V_43 ) {
if ( F_18 ( V_27 -> V_35 ) )
return - V_60 ;
} else {
V_25 = F_35 ( V_22 , & V_329 -> V_30 , 0 ) ;
if ( ! F_59 ( V_25 ) )
return - V_60 ;
}
return F_25 ( V_8 ) ;
}
static int F_195 ( struct V_7 * V_8 , struct V_312 * V_313 [] ,
struct V_312 * V_69 [] )
{
struct V_21 * V_25 = F_21 ( V_8 ) ;
struct V_37 V_38 ;
...
V_25 = F_21 ( V_8 ) ;
return F_159 ( V_25 , & V_38 ) ;
}
static void F_196 ( struct V_7 * V_8 , struct V_330 * V_331 )
{
struct V_22 * V_22 = F_26 ( V_8 ) ;
struct V_26 * V_27 = F_10 ( V_22 , V_28 ) ;
if ( V_8 != V_27 -> V_62 )
...
static T_11 F_198 ( const struct V_7 * V_8 )
{
return
F_199 ( 4 ) +
F_199 ( sizeof( struct V_1 ) ) +
F_199 ( sizeof( struct V_1 ) ) +
F_199 ( 1 ) +
F_199 ( 1 ) +
F_199 ( 4 ) +
...
static int F_200 ( struct V_63 * V_64 , const struct V_7 * V_8 )
{
struct V_21 * V_156 = F_21 ( V_8 ) ;
struct V_37 * V_332 = & V_156 -> V_30 ;
if ( F_201 ( V_64 , V_315 , V_332 -> V_151 ) ||
F_202 ( V_64 , V_316 , & V_332 -> V_31 ) ||
F_202 ( V_64 , V_317 , & V_332 -> V_32 ) ||
F_203 ( V_64 , V_318 , V_332 -> V_197 ) ||
F_203 ( V_64 , V_319 , V_332 -> V_111 ) ||
F_204 ( V_64 , V_320 , V_332 -> V_241 ) ||
F_201 ( V_64 , V_321 , V_332 -> V_33 ) ||
F_203 ( V_64 , V_314 , V_332 -> V_104 ) ||
F_201 ( V_64 , V_323 , V_332 -> V_244 ) )
goto V_333;
if ( F_205 ( V_64 , V_324 , V_156 -> V_221 . type ) ||
F_206 ( V_64 , V_326 , V_156 -> V_221 . V_288 ) ||
F_206 ( V_64 , V_327 , V_156 -> V_221 . V_289 ) ||
F_205 ( V_64 , V_325 , V_156 -> V_221 . V_33 ) )
goto V_333;
if ( V_332 -> V_43 )
if ( F_207 ( V_64 , V_322 ) )
goto V_333;
...
struct V_22 * F_208 ( const struct V_7 * V_8 )
{
struct V_21 * V_156 = F_21 ( V_8 ) ;
return V_156 -> V_22 ;
}
static void T_12 F_209 ( struct V_22 * V_22 )
{
struct V_26 * V_27 = F_10 ( V_22 , V_28 ) ;
struct V_7 * V_8 , * V_334 ;
int V_39 ;
struct V_21 * V_25 ;
F_210 ( V_335 ) ;
F_211 (net, dev, aux)
if ( V_8 -> V_49 == & V_50 )
F_197 ( V_8 , & V_335 ) ;
for ( V_39 = 0 ; V_39 < V_336 ; V_39 ++ ) {
V_25 = F_18 ( V_27 -> V_337 [ V_39 ] ) ;
while ( V_25 ) {
if ( ! F_98 ( F_26 ( V_25 -> V_8 ) , V_22 ) )
F_197 ( V_25 -> V_8 , & V_335 ) ;
V_25 = F_18 ( V_25 -> V_44 ) ;
}
}
F_212 ( & V_335 ) ;
}
static int T_10 F_213 ( struct V_22 * V_22 )
{
struct V_26 * V_27 = F_10 ( V_22 , V_28 ) ;
struct V_21 * V_25 = NULL ;
int V_48 ;
V_27 -> V_41 [ 0 ] = V_27 -> V_36 ;
V_27 -> V_41 [ 1 ] = V_27 -> V_337 ;
V_48 = - V_54 ;
...
F_32 ( V_27 -> V_62 , V_22 ) ;
V_27 -> V_62 -> V_49 = & V_50 ;
V_27 -> V_62 -> V_297 |= V_311 ;
V_48 = F_184 ( V_27 -> V_62 ) ;
if ( V_48 < 0 )
goto V_339;
V_48 = F_214 ( V_27 -> V_62 ) ;
if ( V_48 < 0 )
goto V_339;
V_25 = F_21 ( V_27 -> V_62 ) ;
...
static void T_12 F_215 ( struct V_22 * V_22 )
{
F_216 () ;
F_209 ( V_22 ) ;
F_217 () ;
...
if ( V_48 < 0 )
goto V_341;
V_48 = F_220 ( & V_342 , V_343 ) ;
if ( V_48 < 0 ) {
F_221 ( L_11 , V_344 ) ;
goto V_345;
}
V_48 = F_220 ( & V_346 , V_233 ) ;
if ( V_48 < 0 ) {
F_221 ( L_12 , V_344 ) ;
goto V_347;
}
...
{
F_226 ( & V_50 ) ;
if ( F_223 ( & V_342 , V_343 ) )
F_227 ( L_13 , V_344 ) ;
if ( F_223 ( & V_346 , V_233 ) )
F_227 ( L_14 , V_344 ) ;
F_224 ( & V_340 ) ;
}
