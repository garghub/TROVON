...
F_117 ( V_170 , V_157 , V_88 ) ;
F_85 () ;
}
void T_6 F_118 ( unsigned long V_180 ,
unsigned long V_181 ,
unsigned int V_182 , unsigned int V_183 )
{
F_108 ( V_180 , V_181 , V_182 , V_183 , NULL ) ;
}
static int T_6 F_119 ( struct V_147 * V_174 ,
struct V_147 * V_172 )
{
struct V_72 V_198 ;
unsigned int V_182 , V_81 = 0 , V_199 = 0 ;
T_7 V_2 ;
T_8 V_200 ;
while ( ! F_120 ( V_174 , L_7 ,
V_81 ++ , & V_182 ) )
V_199 |= F_121 ( V_182 ) ;
for ( V_182 = 2 ; V_182 < 8 ; V_182 ++ ) {
if ( ! ( V_199 & F_121 ( V_182 ) ) )
break;
}
if ( V_182 == 8 ) {
F_87 ( L_8 ) ;
