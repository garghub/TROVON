...
static struct V_3 * F_57 ( int V_180 )
{
struct V_3 * V_4 ;
if ( V_181 [ V_180 ] . V_159 != 0 ) {
...
static void F_61 ( struct V_3 * V_4 , int V_189 )
{
F_59 ( V_4 ) ;
F_11 ( V_189 , V_4 -> V_16 + V_20 ) ;
}
static void T_3 F_62 ( struct V_190 * V_191 , const char * V_192 ,
unsigned V_193 )
{
struct V_194 * V_89 = V_191 -> V_7 ;
F_63 ( & V_89 -> V_4 , V_192 , V_193 , F_61 ) ;
}
static int T_3 F_64 ( struct V_194 * V_195 ,
const char * V_196 )
{
struct V_3 * V_4 = & V_195 -> V_4 ;
if ( ! V_4 -> V_16 )
return - V_197 ;
...
T_2 V_198 ;
int V_61 ;
F_15 ( V_4 -> V_72 , V_195 -> V_58 ,
& V_63 , & V_62 , & V_61 ) ;
V_198 = V_142 ;
if ( V_61 )
V_198 |= V_74 ;
F_11 ( V_198 , V_4 -> V_16 + V_73 ) ;
F_11 ( V_62 , V_4 -> V_16 + V_75 ) ;
F_11 ( V_63 , V_4 -> V_16 + V_76 ) ;
}
V_195 -> V_191 -> V_199 = F_62 ;
return 0 ;
}
static void F_65 ( struct V_190 * V_200 , const char * V_192 ,
unsigned int V_201 )
{
struct V_3 * V_4 = & V_181 [ V_200 -> V_202 ] ;
unsigned long V_84 ;
...
V_81 = F_66 ( & V_4 -> V_41 , V_84 ) ;
else
F_21 ( & V_4 -> V_41 , V_84 ) ;
V_203 = F_2 ( V_4 -> V_16 + V_149 ) ;
F_11 ( V_203 , V_4 -> V_16 + V_45 ) ;
V_204 = F_2 ( V_4 -> V_16 + V_91 ) ;
V_204 &= ~ V_92 ;
V_204 |= V_100 ;
F_11 ( V_204 , V_4 -> V_16 + V_91 ) ;
F_63 ( V_4 , V_192 , V_201 , F_61 ) ;
F_59 ( V_4 ) ;
F_11 ( V_204 , V_4 -> V_16 + V_91 ) ;
F_11 ( V_203 , V_4 -> V_16 + V_103 ) ;
if ( V_81 )
F_22 ( & V_4 -> V_41 , V_84 ) ;
}
static int T_3 F_67 ( struct V_190 * V_200 , char * V_207 )
{
struct V_3 * V_4 = & V_181 [ V_200 -> V_202 ] ;
int V_58 = 9600 ;
int V_208 = 8 ;
int V_32 = 'n' ;
int V_209 = 'n' ;
if ( V_200 -> V_202 < 0 || V_200 -> V_202 >= V_182 )
return - V_154 ;
if ( ! V_4 -> V_16 ) {
F_68 ( L_4 V_210 L_5 ,
V_200 -> V_202 ) ;
...
if ( V_207 )
F_69 ( V_207 , & V_58 , & V_32 , & V_208 , & V_209 ) ;
return F_70 ( V_4 , V_200 , V_58 , V_32 , V_208 , V_209 ) ;
}
...
static int F_73 ( struct V_195 * V_195 )
{
struct V_3 * V_4 = F_74 ( V_195 ) ;
struct V_212 * V_213 ;
struct V_195 * V_214 ;
int V_215 = 0 ;
V_213 = F_75 ( & V_4 -> V_39 -> V_4 ) ;
if ( V_213 ) {
V_214 = V_213 -> V_89 ;
V_215 = F_76 ( V_214 ) ;
F_77 ( V_213 ) ;
...
static int F_79 ( struct V_195 * V_195 )
{
struct V_3 * V_4 = F_74 ( V_195 ) ;
unsigned long V_84 = 0 ;
T_2 V_80 ;
...
return F_82 ( & V_216 , V_4 ) ;
}
static int T_4 F_83 ( struct V_195 * V_89 )
{
struct V_219 * V_220 = F_84 ( V_89 ) ;
struct V_3 * V_4 = F_85 ( V_220 ) ;
struct V_5 * V_5 = V_4 -> V_6 ;
F_81 ( V_5 -> V_72 ) ;
F_81 ( V_5 -> V_218 ) ;
return 0 ;
}
static int T_4 F_86 ( struct V_195 * V_89 )
{
struct V_219 * V_220 = F_84 ( V_89 ) ;
struct V_3 * V_4 = F_85 ( V_220 ) ;
struct V_5 * V_5 = V_4 -> V_6 ;
...
{
int V_221 , V_180 , V_53 ;
struct V_3 * V_4 ;
struct V_222 * V_223 ;
struct V_5 * V_224 ;
const struct V_225 * V_226 ;
V_224 = F_88 ( & V_220 -> V_89 , sizeof( * V_224 ) ,
V_227 ) ;
if ( ! V_224 )
return - V_161 ;
V_226 = F_89 ( V_228 , V_220 -> V_89 . V_229 ) ;
if ( V_226 && V_226 -> V_7 ) {
const struct V_230 * V_7 = V_226 -> V_7 ;
V_224 -> V_14 = V_7 -> V_14 ;
}
V_224 -> V_218 = F_90 ( & V_220 -> V_89 , L_6 ) ;
if ( F_91 ( V_224 -> V_218 ) ) {
V_224 -> V_218 = F_90 ( & V_220 -> V_89 , L_7 ) ;
if ( ! F_91 ( V_224 -> V_218 ) )
F_37 ( & V_220 -> V_89 , L_8 ) ;
}
if ( F_91 ( V_224 -> V_218 ) ) {
F_37 ( & V_220 -> V_89 , L_9 ) ;
return F_92 ( V_224 -> V_218 ) ;
}
V_224 -> V_72 = F_90 ( & V_220 -> V_89 , L_10 ) ;
if ( F_91 ( V_224 -> V_72 ) ) {
V_224 -> V_72 = F_90 ( & V_220 -> V_89 , L_11 ) ;
if ( ! F_91 ( V_224 -> V_72 ) )
F_37 ( & V_220 -> V_89 , L_12 ) ;
}
if ( F_91 ( V_224 -> V_72 ) ) {
F_37 ( & V_220 -> V_89 , L_13 ) ;
return F_92 ( V_224 -> V_72 ) ;
}
V_221 = F_93 ( V_224 -> V_218 ) ;
if ( V_221 ) {
F_37 ( & V_220 -> V_89 , L_14 ) ;
return V_221 ;
}
V_221 = F_93 ( V_224 -> V_72 ) ;
if ( V_221 ) {
F_37 ( & V_220 -> V_89 , L_15 ) ;
goto V_231;
}
V_223 = F_94 ( V_220 , V_232 , 0 ) ;
if ( ! V_223 ) {
V_221 = - V_197 ;
goto V_233;
}
...
#endif
V_180 = F_98 ( V_220 -> V_89 . V_229 , L_17 ) ;
if ( V_180 < 0 )
V_180 = 0 ;
V_4 = F_57 ( V_180 ) ;
if ( ! V_4 ) {
...
V_4 -> V_53 = V_53 ;
V_4 -> V_89 = & V_220 -> V_89 ;
V_4 -> V_72 = F_99 ( V_224 -> V_72 ) ;
V_4 -> V_6 = V_224 ;
V_224 -> V_4 = V_4 ;
F_100 ( V_220 , V_4 ) ;
F_101 ( & V_220 -> V_89 ) ;
F_102 ( & V_220 -> V_89 , V_239 ) ;
F_103 ( & V_220 -> V_89 ) ;
F_104 ( & V_220 -> V_89 ) ;
V_221 = F_105 ( & V_216 , V_4 ) ;
if ( V_221 ) {
F_37 ( & V_220 -> V_89 ,
L_19 , V_221 ) ;
goto V_237;
