...
V_4 -> V_15 [ V_6 ] = F_6 ( V_5 , V_4 -> V_9 . V_10 ,
V_7 , V_7 , 0 ) ;
if ( ! V_4 -> V_15 [ V_6 ] ) {
F_7 ( V_4 ) ;
return - V_16 ;
...
for ( V_6 = 0 ; V_6 < V_14 ; V_6 ++ ) {
if ( V_7 <= V_2 [ V_6 ] )
return F_12 ( V_4 -> V_15 [ V_6 ] , V_20 , V_21 ) ;
}
return F_13 ( V_4 -> V_9 . V_10 , V_7 , V_21 , V_20 ) ;
}
void F_14 (
struct V_18 * V_19 ,
T_2 V_7 ,
...
for ( V_6 = 0 ; V_6 < V_14 ; V_6 ++ ) {
if ( V_7 <= V_2 [ V_6 ] ) {
F_16 ( V_4 -> V_15 [ V_6 ] , V_22 , V_21 ) ;
return;
}
}
F_17 ( V_4 -> V_9 . V_10 , V_7 , V_22 , V_21 ) ;
}
