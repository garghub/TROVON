...
static int F_47 ( struct V_12 * V_2 , void * V_42 )
{
F_48 ( L_8 ,
F_49 ( V_2 -> V_43 ) ,
F_49 ( V_42 ) ) ;
...
if ( ! V_15 || ! F_54 ( V_15 ) )
continue;
V_48 += F_50 ( V_18 , & V_45 , V_50 , V_15 ) ;
}
if ( V_48 && ! V_45 )
return F_10 ( & V_18 -> V_2 , false ) ;
if ( V_48 ) {
F_57 ( & V_18 -> V_2 , L_9 , V_48 ) ;
return F_58 ( & V_18 -> V_2 ,
& V_51 ,
V_45 ) ;
}
return 0 ;
