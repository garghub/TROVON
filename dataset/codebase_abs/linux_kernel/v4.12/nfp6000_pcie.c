...
int V_69 ;
V_2 = & V_4 -> V_2 [ 0 ] ;
for ( V_67 = 0 ; V_67 < F_46 ( V_4 -> V_2 ) ; V_67 ++ , V_2 ++ ) {
struct V_70 * V_71 ;
...
V_4 -> V_5 -> V_80 == V_82 ) {
V_4 -> V_30 . V_31 = V_2 -> V_30 + F_54 ( 0 ) ;
V_69 = 4 ;
} else {
int V_83 = V_4 -> V_5 -> V_84 & 7 ;
V_4 -> V_30 . V_31 = V_2 -> V_30 + F_54 ( V_83 ) ;
V_69 = 1 ;
}
...
F_55 ( & V_4 -> V_2 [ 0 ] , V_4 -> V_41 , sizeof( V_4 -> V_2 [ 0 ] ) ,
F_44 , NULL ) ;
F_53 ( V_4 -> V_73 , L_6 ,
V_4 -> V_41 , V_68 ) ;
return 0 ;
...
static int F_58 ( struct V_91 * V_92 , T_1 V_93 ,
unsigned long long V_94 , unsigned long V_14 )
{
struct V_95 * V_96 = F_59 ( V_92 ) ;
T_1 V_97 = F_60 ( V_93 ) ;
T_1 V_98 = F_61 ( V_93 ) ;
T_1 V_99 = F_62 ( V_93 ) ;
int V_100 ;
V_100 = F_63 ( F_64 ( V_97 , V_98 , V_99 ) , V_94 ) ;
if ( V_100 < 0 )
return V_100 ;
V_96 -> V_15 . V_101 = F_65 ( V_100 ) ;
V_96 -> V_15 . V_102 = F_66 ( V_100 ) ;
...
{
struct V_95 * V_96 = F_59 ( V_92 ) ;
if ( F_71 ( ! F_29 ( & V_96 -> V_43 ) ) )
return 0 ;
return F_38 ( & V_96 -> V_43 ) ;
}
static int F_72 ( struct V_91 * V_92 )
{
struct V_7 * V_4 = F_73 ( F_74 ( V_92 ) ) ;
struct V_95 * V_96 = F_59 ( V_92 ) ;
int V_48 , V_33 ;
if ( V_96 -> V_2 ) {
F_69 ( V_92 ) ;
...
V_48 = F_42 ( V_4 , V_96 -> V_97 , V_96 -> V_98 , V_96 -> V_99 ,
...
V_96 -> V_30 = F_52 ( V_96 -> V_105 , V_96 -> V_14 ) ;
if ( F_79 ( V_96 -> V_30 ) ) {
F_49 ( V_4 -> V_73 , L_7 ,
( int ) V_96 -> V_14 , V_96 -> V_2 -> V_6 ) ;
V_33 = ! V_96 -> V_30 ? - V_109 : F_80 ( V_96 -> V_30 ) ;
V_96 -> V_30 = NULL ;
goto V_110;
}
F_69 ( V_92 ) ;
...
static void F_81 ( struct V_91 * V_92 )
{
struct V_7 * V_4 = F_73 ( F_74 ( V_92 ) ) ;
struct V_95 * V_96 = F_59 ( V_92 ) ;
if ( ! F_70 ( V_92 ) )
...
static T_6 F_82 ( struct V_91 * V_92 )
{
struct V_95 * V_96 = F_59 ( V_92 ) ;
return V_96 -> V_105 ;
}
static void T_7 * F_83 ( struct V_91 * V_92 )
{
struct V_95 * V_96 = F_59 ( V_92 ) ;
return V_96 -> V_30 ;
}
static struct V_70 * F_84 ( struct V_91 * V_92 )
{
struct V_95 * V_96 = F_59 ( V_92 ) ;
return V_96 -> V_2 -> V_70 ;
}
static int F_85 ( struct V_91 * V_92 , void * V_111 ,
...
static int F_94 ( struct V_122 * V_74 )
{
struct V_7 * V_4 = F_73 ( F_95 ( V_74 ) ) ;
struct V_123 * V_96 = F_96 ( V_74 ) ;
int V_67 , V_87 ;
F_97 ( & V_4 -> V_74 . V_75 ) ;
for ( V_67 = 0 ; V_67 < F_46 ( V_4 -> V_74 . V_89 ) ; V_67 ++ ) {
if ( ! V_4 -> V_74 . V_89 [ V_67 ] . V_16 )
continue;
for ( V_87 = 0 ; V_87 < F_46 ( V_4 -> V_74 . V_89 [ V_67 ] . free ) ; V_87 ++ ) {
T_5 V_124 ;
...
static void F_99 ( struct V_122 * V_74 )
{
struct V_123 * V_96 = F_96 ( V_74 ) ;
...
static int F_100 ( struct V_122 * V_74 ,
...
F_116 ( V_96 -> V_90 + ( V_94 & ( ( 1 << V_96 -> V_16 ) - 1 ) ) ) ;
return V_132 ;
}
static int F_117 ( struct V_122 * V_74 ,
...
static int F_118 ( struct V_141 * V_142 )
{
F_119 ( V_142 , V_143 ) ;
F_119 ( V_142 , V_143 ) ;
F_119 ( V_142 , V_144 ) ;
...
{
struct V_7 * V_4 = F_73 ( V_142 ) ;
F_56 ( V_4 ) ;
F_121 ( V_4 ) ;
}
static void F_122 ( struct V_80 * V_73 , T_9 * V_145 )
{
struct V_146 * V_5 = F_123 ( V_73 ) ;
int V_147 ;
T_1 V_148 ;
V_147 = F_124 ( V_5 , V_149 ) ;
if ( ! V_147 ) {
memset ( V_145 , 0 , V_150 ) ;
return;
}
F_125 ( V_5 , V_147 + 4 , & V_148 ) ;
F_126 ( V_148 >> 16 , V_145 + 4 ) ;
F_125 ( V_5 , V_147 + 8 , & V_148 ) ;
F_127 ( V_148 , V_145 ) ;
}
static T_5 F_128 ( struct V_80 * V_73 )
{
struct V_146 * V_5 = F_123 ( V_73 ) ;
int V_147 ;
T_1 V_148 ;
V_147 = F_124 ( V_5 , V_149 ) ;
if ( ! V_147 )
return F_129 ( V_151 , 0 , 0xff ) ;
F_125 ( V_5 , V_147 + 4 , & V_148 ) ;
return V_148 & 0xffff ;
}
struct V_141 * F_130 ( struct V_146 * V_5 )
{
struct V_7 * V_4 ;
T_5 V_57 ;
int V_33 ;
...
if ( V_33 )
goto V_155;
return F_136 ( & V_157 , & V_5 -> V_73 , V_4 ) ;
V_155:
F_121 ( V_4 ) ;
V_153:
F_49 ( & V_5 -> V_73 , L_11 ) ;
