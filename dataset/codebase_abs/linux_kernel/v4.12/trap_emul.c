...
return;
if ( F_184 ( V_168 , V_11 ) ) {
F_185 ( V_65 -> V_69 , V_169 | V_170 ) ;
F_185 ( V_67 -> V_69 , V_169 | V_171 ) ;
F_186 (i) {
F_170 ( V_78 , V_65 ) = 0 ;
F_170 ( V_78 , V_67 ) = 0 ;
}
...
void F_189 ( struct V_10 * V_11 )
{
F_190 ( F_191 () ) ;
F_192 () ;
F_193 ( V_11 -> V_172 , V_173 ) ;
F_182 ( V_11 , F_194 () , true ) ;
}
void F_195 ( struct V_10 * V_11 )
{
F_196 ( & V_11 -> V_172 , V_174 ) ;
F_197 () ;
}
static void F_198 ( struct V_30 * V_25 ,
struct V_10 * V_11 )
{
struct V_64 * V_65 = & V_11 -> V_13 . V_66 ;
struct V_64 * V_67 = & V_11 -> V_13 . V_68 ;
...
V_162 = V_67 ;
V_175 = F_27 ( V_24 ) & V_54 ;
if ( V_175 != V_11 -> V_13 . V_176 ) {
F_185 ( V_67 -> V_69 , V_171 ) ;
F_186 (i)
F_170 ( V_78 , V_67 ) = 0 ;
V_11 -> V_13 . V_176 = V_175 ;
}
}
if ( ( F_170 ( V_161 , V_162 ) ^ F_171 ( V_161 ) ) &
F_172 ( V_161 ) )
...
static int F_199 ( struct V_30 * V_25 , struct V_10 * V_11 )
{
int V_161 = F_194 () ;
int V_62 ;
F_200 ( V_11 ,
...
F_187 () ;
F_177 ( V_161 ) ;
V_62 = V_11 -> V_13 . V_177 ( V_25 , V_11 ) ;
V_161 = F_194 () ;
if ( ( ( F_170 ( V_161 , V_163 -> V_162 ) ^ F_171 ( V_161 ) ) &
F_172 ( V_161 ) ) )
F_173 ( V_163 -> V_162 , V_161 ) ;
