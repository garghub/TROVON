...
static int F_87 ( struct V_3 * V_4 , T_1 V_6 )
{
int V_109 = 0 ;
T_3 V_5 = F_6 ( V_6 ) ;
struct V_24 * V_34 ;
...
bool F_93 ( struct V_7 * V_7 , int * V_130 )
{
int V_109 ;
F_94 ( ! F_95 ( V_7 ) , V_7 ) ;
if ( F_52 ( F_96 ( V_7 ) ) )
return false ;
V_109 = F_97 ( V_7 , V_130 ) ;
if ( V_109 <= 1 && F_98 ( V_7 ) ) {
V_109 += F_85 ( V_7 ) ;
if ( V_109 != 1 )
goto V_97;
...
int F_107 ( T_4 V_132 , T_2 V_5 , struct V_133 * * V_134 )
{
...
return 0 ;
return F_112 ( F_3 ( type , V_5 ) , & V_17 ) ;
}
unsigned int F_113 ( int type , int free )
{
unsigned int V_31 = 0 ;
F_28 ( & V_135 ) ;
if ( ( unsigned int ) type < V_98 ) {
...
static inline int F_114 ( T_5 V_138 , T_5 V_139 )
{
return F_115 ( F_116 ( V_138 ) , V_139 ) ;
}
static int F_117 ( struct V_140 * V_141 , T_6 * V_142 ,
...
int V_8 = 1 ;
V_144 = V_7 ;
V_7 = F_118 ( V_7 , V_141 , V_143 ) ;
if ( F_52 ( ! V_7 ) )
return - V_148 ;
if ( F_119 ( V_7 , V_141 -> V_149 , V_18 ,
& V_146 , false ) ) {
V_8 = - V_148 ;
goto V_150;
}
V_138 = F_120 ( V_141 -> V_149 , V_142 , V_143 , & V_147 ) ;
if ( F_52 ( ! F_114 ( * V_138 , F_121 ( V_6 ) ) ) ) {
F_122 ( V_7 , V_146 , false ) ;
V_8 = 0 ;
goto V_97;
}
F_123 ( V_141 -> V_149 , V_151 ) ;
F_124 ( V_141 -> V_149 , V_152 ) ;
F_125 ( V_7 ) ;
F_126 ( V_141 -> V_149 , V_143 , V_138 ,
F_127 ( F_128 ( V_7 , V_141 -> V_153 ) ) ) ;
if ( V_7 == V_144 ) {
F_129 ( V_7 , V_141 , V_143 , false ) ;
F_130 ( V_7 , V_146 , true , false ) ;
} else {
F_131 ( V_7 , V_141 , V_143 , false ) ;
F_130 ( V_7 , V_146 , false , false ) ;
F_132 ( V_7 , V_141 ) ;
}
F_81 ( V_6 ) ;
F_133 ( V_7 ) ;
...
static int F_135 ( struct V_140 * V_141 , T_6 * V_142 ,
...
T_5 * V_138 ;
int V_8 = 0 ;
V_138 = F_136 ( V_142 , V_143 ) ;
do {
if ( F_52 ( F_114 ( * V_138 , V_139 ) ) ) {
F_137 ( V_138 ) ;
V_8 = F_117 ( V_141 , V_142 , V_143 , V_6 , V_7 ) ;
if ( V_8 )
goto V_97;
V_138 = F_136 ( V_142 , V_143 ) ;
}
...
static inline int F_138 ( struct V_140 * V_141 , T_8 * V_156 ,
unsigned long V_143 , unsigned long V_154 ,
T_1 V_6 , struct V_7 * V_7 )
{
T_6 * V_142 ;
unsigned long V_64 ;
int V_8 ;
V_142 = F_139 ( V_156 , V_143 ) ;
do {
F_13 () ;
V_64 = F_140 ( V_143 , V_154 ) ;
if ( F_141 ( V_142 ) )
continue;
V_8 = F_135 ( V_141 , V_142 , V_143 , V_64 , V_6 , V_7 ) ;
if ( V_8 )
return V_8 ;
} while ( V_142 ++ , V_143 = V_64 , V_143 != V_154 );
return 0 ;
}
static inline int F_142 ( struct V_140 * V_141 , T_9 * V_157 ,
unsigned long V_143 , unsigned long V_154 ,
T_1 V_6 , struct V_7 * V_7 )
{
T_8 * V_156 ;
unsigned long V_64 ;
int V_8 ;
V_156 = F_143 ( V_157 , V_143 ) ;
do {
V_64 = F_144 ( V_143 , V_154 ) ;
if ( F_145 ( V_156 ) )
continue;
V_8 = F_138 ( V_141 , V_156 , V_143 , V_64 , V_6 , V_7 ) ;
if ( V_8 )
return V_8 ;
} while ( V_156 ++ , V_143 = V_64 , V_143 != V_154 );
return 0 ;
}
static inline int F_146 ( struct V_140 * V_141 , T_10 * V_158 ,
unsigned long V_143 , unsigned long V_154 ,
T_1 V_6 , struct V_7 * V_7 )
{
T_9 * V_157 ;
unsigned long V_64 ;
int V_8 ;
V_157 = F_147 ( V_158 , V_143 ) ;
do {
V_64 = F_148 ( V_143 , V_154 ) ;
if ( F_149 ( V_157 ) )
continue;
V_8 = F_142 ( V_141 , V_157 , V_143 , V_64 , V_6 , V_7 ) ;
if ( V_8 )
return V_8 ;
...
V_158 = F_153 ( V_141 -> V_149 , V_143 ) ;
do {
V_64 = F_154 ( V_143 , V_154 ) ;
if ( F_155 ( V_158 ) )
continue;
V_8 = F_146 ( V_141 , V_158 , V_143 , V_64 , V_6 , V_7 ) ;
if ( V_8 )
return V_8 ;
} while ( V_158 ++ , V_143 = V_64 , V_143 != V_154 );
return 0 ;
}
static int F_156 ( struct V_162 * V_163 ,
T_1 V_6 , struct V_7 * V_7 )
{
struct V_140 * V_141 ;
int V_8 = 0 ;
if ( ! F_157 ( & V_163 -> V_164 ) ) {
F_133 ( V_7 ) ;
F_9 ( V_7 ) ;
F_158 ( & V_163 -> V_164 ) ;
F_159 ( V_7 ) ;
...
if ( V_141 -> V_167 && ( V_8 = F_150 ( V_141 , V_6 , V_7 ) ) )
break;
F_13 () ;
}
F_160 ( & V_163 -> V_164 ) ;
...
static unsigned int F_161 ( struct V_3 * V_4 ,
...
V_109 = F_162 ( V_4 -> V_44 [ V_123 ] ) ;
if ( V_109 && F_1 ( V_109 ) != V_45 )
if ( ! V_168 || F_163 ( V_4 , V_123 ) )
break;
if ( ( V_123 % V_70 ) == 0 )
F_13 () ;
}
...
int F_164 ( unsigned int type , bool V_168 ,
unsigned long V_169 )
{
...
V_170 = & V_173 ;
F_165 ( & V_173 ) ;
while ( ( V_123 = F_161 ( V_4 , V_123 , V_168 ) ) != 0 ) {
if ( F_166 ( V_174 ) ) {
V_172 = - V_175 ;
break;
}
...
V_163 = F_173 ( V_51 , struct V_162 , V_180 ) ;
if ( ! F_174 ( V_163 ) )
continue;
F_30 ( & V_183 ) ;
F_169 ( V_182 ) ;
...
return;
F_28 ( & V_183 ) ;
F_179 (p, next, &init_mm.mmlist)
F_180 ( V_51 ) ;
F_30 ( & V_183 ) ;
}
static T_2 F_112 ( T_1 V_6 , struct V_133 * * V_17 )
{
struct V_3 * V_136 ;
struct V_9 * V_188 ;
struct V_9 * V_10 ;
...
T_2 F_182 ( struct V_7 * V_7 , struct V_133 * * V_17 )
{
T_1 V_6 ;
V_6 . V_96 = F_86 ( V_7 ) ;
return F_112 ( V_6 , V_17 ) ;
}
static void F_183 ( struct V_3 * V_136 )
{
while ( ! F_184 ( & V_136 -> V_14 . V_23 ) ) {
struct V_9 * V_10 ;
V_10 = F_185 ( & V_136 -> V_14 . V_23 ,
struct V_9 , V_23 ) ;
F_186 ( & V_10 -> V_23 ) ;
F_187 ( V_10 ) ;
}
...
int
F_188 ( struct V_3 * V_136 , unsigned long V_19 ,
...
V_10 = F_173 ( V_198 , struct V_9 , V_23 ) ;
F_181 ( V_10 -> V_19 + V_10 -> V_16 != V_19 ) ;
if ( V_10 -> V_11 + V_10 -> V_16 == V_11 ) {
V_10 -> V_16 += V_16 ;
return 0 ;
}
}
V_197 = F_189 ( sizeof( * V_10 ) , V_18 ) ;
if ( V_197 == NULL )
return - V_148 ;
V_197 -> V_19 = V_19 ;
V_197 -> V_16 = V_16 ;
V_197 -> V_11 = V_11 ;
F_190 ( & V_197 -> V_23 , & V_136 -> V_14 . V_23 ) ;
return 1 ;
}
static int F_191 ( struct V_3 * V_136 , T_2 * V_199 )
{
struct V_190 * V_191 = V_136 -> V_191 ;
struct V_192 * V_193 = V_191 -> V_194 ;
struct V_200 * V_200 = V_193 -> V_201 ;
int V_8 ;
if ( F_192 ( V_200 -> V_202 ) ) {
V_8 = F_188 ( V_136 , 0 , V_136 -> V_62 , 0 ) ;
* V_199 = V_136 -> V_77 ;
return V_8 ;
}
...
return F_193 ( V_136 , V_191 , V_199 ) ;
}
static void F_194 ( struct V_3 * V_51 , int V_204 ,
unsigned char * V_44 ,
struct V_24 * V_35 )
{
if ( V_204 >= 0 )
...
static void F_196 ( struct V_3 * V_51 , int V_204 ,
unsigned char * V_44 ,
struct V_24 * V_35 ,
unsigned long * V_208 )
{
F_197 ( V_51 -> type , V_208 ) ;
F_28 ( & V_135 ) ;
F_28 ( & V_51 -> V_37 ) ;
F_194 ( V_51 , V_204 , V_44 , V_35 ) ;
F_30 ( & V_51 -> V_37 ) ;
F_30 ( & V_135 ) ;
}
static void F_198 ( struct V_3 * V_51 )
{
F_28 ( & V_135 ) ;
F_28 ( & V_51 -> V_37 ) ;
F_194 ( V_51 , V_51 -> V_204 , V_51 -> V_44 , V_51 -> V_35 ) ;
F_30 ( & V_51 -> V_37 ) ;
F_30 ( & V_135 ) ;
}
bool F_199 ( void )
...
static unsigned F_201 ( struct V_190 * V_190 , T_11 * V_209 )
{
struct V_210 * V_211 = V_190 -> V_212 ;
F_202 ( V_190 , & V_213 , V_209 ) ;
if ( V_211 -> V_214 != F_168 ( & V_215 ) ) {
V_211 -> V_214 = F_168 ( & V_215 ) ;
return V_216 | V_217 | V_218 | V_219 ;
}
return V_216 | V_217 ;
}
static void * F_203 ( struct V_210 * V_220 , T_12 * V_221 )
{
struct V_3 * V_4 ;
int type ;
T_12 V_222 = * V_221 ;
...
static void * F_206 ( struct V_210 * V_220 , void * V_225 , T_12 * V_221 )
{
...
static void F_207 ( struct V_210 * V_220 , void * V_225 )
{
F_208 ( & V_223 ) ;
}
static int F_209 ( struct V_210 * V_220 , void * V_225 )
{
struct V_3 * V_4 = V_225 ;
struct V_190 * V_190 ;
int V_226 ;
...
V_190 = V_4 -> V_191 ;
V_226 = F_211 ( V_220 , V_190 , L_6 ) ;
F_212 ( V_220 , L_7 ,
V_226 < 40 ? 40 - V_226 : 1 , L_8 ,
F_192 ( F_213 ( V_190 ) -> V_202 ) ?
L_9 : L_10 ,
V_4 -> V_77 << ( V_15 - 10 ) ,
V_4 -> V_78 << ( V_15 - 10 ) ,
V_4 -> V_204 ) ;
...
static int F_214 ( struct V_200 * V_200 , struct V_190 * V_190 )
{
struct V_210 * V_211 ;
int V_8 ;
V_8 = F_215 ( V_190 , & V_227 ) ;
if ( V_8 )
return V_8 ;
V_211 = V_190 -> V_212 ;
V_211 -> V_214 = F_168 ( & V_215 ) ;
...
{
F_217 ( L_11 , 0 , NULL , & V_228 ) ;
return 0 ;
}
static int T_13 F_218 ( void )
{
F_219 () ;
return 0 ;
}
static struct V_3 * F_220 ( void )
{
struct V_3 * V_51 ;
unsigned int type ;
V_51 = F_221 ( sizeof( * V_51 ) , V_18 ) ;
if ( ! V_51 )
return F_222 ( - V_148 ) ;
F_28 ( & V_135 ) ;
for ( type = 0 ; type < V_98 ; type ++ ) {
...
static int F_227 ( struct V_3 * V_51 , struct V_200 * V_200 )
{
int error ;
if ( F_192 ( V_200 -> V_202 ) ) {
V_51 -> V_17 = F_109 ( F_228 ( V_200 ) ) ;
error = F_229 ( V_51 -> V_17 ,
V_231 | V_232 | V_233 , V_51 ) ;
if ( error < 0 ) {
V_51 -> V_17 = NULL ;
return error ;
}
V_51 -> V_234 = F_230 ( V_51 -> V_17 ) ;
error = F_231 ( V_51 -> V_17 , V_155 ) ;
if ( error < 0 )
return error ;
V_51 -> V_27 |= V_115 ;
} else if ( F_232 ( V_200 -> V_202 ) ) {
...
static unsigned long F_235 ( struct V_3 * V_51 ,
union V_239 * V_239 ,
struct V_200 * V_200 )
{
int V_123 ;
...
if ( F_236 ( V_239 -> V_25 . V_244 ) == 1 ) {
F_237 ( & V_239 -> V_25 . V_244 ) ;
F_237 ( & V_239 -> V_25 . V_242 ) ;
F_237 ( & V_239 -> V_25 . V_245 ) ;
if ( V_239 -> V_25 . V_245 > V_246 )
return 0 ;
for ( V_123 = 0 ; V_123 < V_239 -> V_25 . V_245 ; V_123 ++ )
F_237 ( & V_239 -> V_25 . V_247 [ V_123 ] ) ;
}
...
if ( ! V_240 )
return 0 ;
V_241 = F_240 ( V_200 ) >> V_15 ;
if ( V_241 && V_240 > V_241 ) {
F_238 ( L_16 ) ;
return 0 ;
}
if ( V_239 -> V_25 . V_245 && F_232 ( V_200 -> V_202 ) )
return 0 ;
if ( V_239 -> V_25 . V_245 > V_246 )
return 0 ;
return V_240 ;
}
static int F_241 ( struct V_3 * V_51 ,
union V_239 * V_239 ,
unsigned char * V_44 ,
struct V_24 * V_35 ,
unsigned long V_240 ,
...
unsigned int V_251 ;
int V_252 ;
unsigned long V_253 = F_242 ( V_240 , V_36 ) ;
...
for ( V_123 = V_240 ; V_123 < F_243 ( V_240 , V_36 ) ; V_123 ++ )
...
for ( V_123 = 0 ; V_123 < F_242 ( V_253 , V_255 ) ; V_123 ++ ) {
...
static bool F_244 ( struct V_3 * V_4 )
{
struct V_256 * V_108 = F_245 ( V_4 -> V_17 ) ;
if ( ! V_108 || ! F_246 ( V_108 ) )
return false ;
return true ;
}
void F_247 ( struct V_257 * V_96 )
{
unsigned int type ;
...
static int F_248 ( T_1 V_6 , unsigned char V_65 )
{
struct V_3 * V_51 ;
struct V_24 * V_34 ;
unsigned long V_5 , type ;
...
{
int V_13 = 0 ;
while ( ! V_13 && F_248 ( V_6 , 1 ) == - V_148 )
V_13 = F_251 ( V_6 , V_265 ) ;
return V_13 ;
}
int F_252 ( T_1 V_6 )
{
return F_248 ( V_6 , V_2 ) ;
}
struct V_3 * F_253 ( struct V_7 * V_7 )
{
T_1 V_220 = { . V_96 = F_86 (page) } ;
return V_95 [ F_69 ( V_220 ) ] ;
}
struct V_192 * F_254 ( struct V_7 * V_7 )
{
F_94 ( ! F_98 ( V_7 ) , V_7 ) ;
return F_253 ( V_7 ) -> V_191 -> V_194 ;
}
T_3 F_255 ( struct V_7 * V_7 )
{
T_1 V_220 = { . V_96 = F_86 (page) } ;
F_94 ( ! F_98 ( V_7 ) , V_7 ) ;
return F_6 ( V_220 ) ;
}
int F_251 ( T_1 V_6 , T_14 V_266 )
{
struct V_3 * V_4 ;
struct V_24 * V_34 ;
struct V_7 * V_39 ;
...
if ( ! ( V_109 & V_112 ) )
goto V_97;
V_125 = F_91 ( V_267 ) + V_5 ;
V_109 = * V_125 ;
F_92 ( V_125 ) ;
if ( ( V_109 & ~ V_112 ) != V_129 )
goto V_97;
}
F_190 ( & V_7 -> V_128 , & V_39 -> V_128 ) ;
V_7 = NULL ;
V_97:
F_29 ( V_34 ) ;
F_30 ( & V_4 -> V_37 ) ;
...
V_5 &= ~ V_126 ;
V_7 = F_173 ( V_39 -> V_128 . V_64 , struct V_7 , V_128 ) ;
V_125 = F_91 ( V_7 ) + V_5 ;
if ( V_109 == V_113 )
goto V_270;
...
F_92 ( V_125 ) ;
V_7 = F_173 ( V_7 -> V_128 . V_64 , struct V_7 , V_128 ) ;
F_181 ( V_7 == V_39 ) ;
V_125 = F_91 ( V_7 ) + V_5 ;
}
if ( * V_125 == V_129 ) {
...
* V_125 += 1 ;
F_92 ( V_125 ) ;
V_7 = F_173 ( V_7 -> V_128 . V_122 , struct V_7 , V_128 ) ;
while ( V_7 != V_39 ) {
V_125 = F_91 ( V_7 ) + V_5 ;
* V_125 = V_112 ;
F_92 ( V_125 ) ;
