...
static int
F_19 ( struct V_1 * V_2 , T_5 V_18 ,
struct V_19 * V_20 , T_5 V_23 , void * V_24 )
{
...
static int
F_22 ( struct V_1 * V_2 , T_5 V_18 , void * V_27 )
{
struct V_19 V_20 ;
int error ;
...
int
F_25 ( struct V_1 * V_2 , T_5 V_18 , void * V_27 )
{
int V_33 ;
unsigned long V_34 ;
if ( V_2 -> V_35 ) {
...
static int
F_30 ( struct V_1 * V_2 , T_5 V_18 , void * V_27 )
{
struct V_19 V_20 ;
int V_37 ;
V_37 = F_17 ( V_2 , V_18 , & V_20 ) ;
if ( V_37 )
return V_37 ;
V_20 . V_28 = ( V_20 . V_28 + 1 ) % V_20 . V_31 ;
if ( V_20 . V_28 == V_20 . V_29 ) {
V_20 . V_38 ++ ;
V_37 = F_24 ( V_2 , V_18 , & V_20 , V_38 ) ;
if ( V_37 )
return V_37 ;
return - V_14 ;
}
V_37 = F_21 ( V_2 , V_18 , & V_20 , V_20 . V_28 , V_27 ) ;
if ( V_37 )
return V_37 ;
V_20 . V_39 ++ ;
F_23 () ;
V_37 = F_24 ( V_2 , V_18 , & V_20 , V_28 ) ;
if ( V_37 )
return V_37 ;
V_37 = F_24 ( V_2 , V_18 , & V_20 , V_39 ) ;
if ( V_37 )
return V_37 ;
return 0 ;
}
static struct V_1 *
F_31 ( T_1 V_5 , unsigned long V_40 ,
T_6 V_41 , T_3 V_7 , bool V_35 )
{
struct V_1 * V_2 ;
int V_37 ;
...
if ( V_5 == 0 )
return NULL ;
V_2 = F_32 ( sizeof( * V_2 ) , V_41 ) ;
if ( ! V_2 )
return NULL ;
V_2 -> V_35 = V_35 ;
F_33 ( & V_2 -> V_43 ) ;
F_33 ( & V_2 -> V_36 ) ;
V_2 -> V_4 = F_34 ( V_5 , V_42 , V_44 ) ;
if ( ! V_2 -> V_4 && F_35 ( V_7 , V_45 ) )
goto V_46;
V_2 -> V_3 = F_36 ( V_5 , V_42 , V_47 ) ;
if ( ! V_2 -> V_3 ) {
F_3 ( V_5 , V_42 ) ;
goto V_46;
}
V_2 -> V_5 = V_5 ;
V_2 -> V_6 = V_42 ;
V_37 = F_13 ( V_2 , 0 , & V_2 -> V_9 ,
sizeof( struct V_16 ) ) ;
if ( V_37 )
goto V_46;
if ( V_40 == 0 )
V_40 = ( T_2 ) V_2 -> V_9 . V_42 ;
if ( F_35 ( V_7 , V_48 ) == 0 )
V_7 = V_2 -> V_9 . V_49 ;
F_2 ( V_2 -> V_3 ) ;
if ( V_2 -> V_4 )
...
struct V_1 *
F_37 ( T_1 V_5 , unsigned long V_40 ,
T_6 V_41 , T_3 V_7 )
{
return F_31 ( V_5 , V_40 , V_41 , V_7 ,
false ) ;
}
struct V_1 *
F_38 ( T_1 V_5 , unsigned long V_40 ,
T_6 V_41 , T_3 V_7 )
{
return F_31 ( V_5 , V_40 , V_41 , V_7 ,
true ) ;
...
int
F_39 ( struct V_1 * V_2 , T_5 V_18 , void * V_27 )
{
int V_33 ;
unsigned long V_34 ;
if ( V_2 -> V_35 ) {
