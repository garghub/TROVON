...
static int
F_89 ( struct V_11 * V_12 , void * V_108 , int V_177 )
{
struct V_8 * V_64 ;
struct V_66 * V_67 ;
T_16 * V_178 ;
struct V_7 * V_179 ;
long V_29 = - V_144 ;
const unsigned long V_180 = 0 ;
const T_17 V_181 = 512 ;
int V_182 ;
F_90 ( V_12 , V_108 ) ;
V_12 -> V_176 = F_91 ( sizeof( * V_67 ) , V_57 ) ;
if ( V_12 -> V_176 == NULL )
goto V_76;
V_67 = F_12 ( V_12 ) ;
...
V_182 = F_93 ( V_12 , 1024 ) ;
if ( ! V_182 ) {
if ( ! V_177 )
F_7 ( V_12 , L_44 ) ;
goto V_183;
}
V_64 = F_37 ( V_12 , V_180 ) ;
if ( ! V_64 ) {
if ( ! V_177 )
F_7 ( V_12 , L_45 ) ;
goto V_183;
}
V_178 = ( T_16 * ) V_64 -> V_77 ;
...
F_6 ( V_12 , L_47 ) ;
V_178 =
( T_16 * ) ( ( void * ) V_64 -> V_77 + V_181 ) ;
}
if ( ( F_94 ( V_12 , V_178 ) != V_22 ) ||
( F_95 ( V_12 ) != V_22 ) )
goto V_78;
F_96 ( V_12 , V_178 ) ;
F_53 ( V_64 ) ;
...
V_12 -> V_190 = V_191 ;
F_97 ( V_12 , ( T_4 ) V_67 -> V_105 ) ;
V_12 -> V_192 = & V_193 ;
V_12 -> V_194 = & V_195 ;
V_179 = F_18 ( V_12 , F_9 ( V_12 , & ( V_67 -> V_196 ) ) ) ;
if ( F_19 ( V_179 ) ) {
V_29 = F_98 ( V_179 ) ;
goto V_183;
}
V_12 -> V_197 = F_99 ( V_179 ) ;
if ( ! V_12 -> V_197 ) {
if ( ! V_177 )
F_7 ( V_12 , L_49 ) ;
goto V_183;
...
F_6 ( V_12 , L_50 ,
V_67 -> V_83 . V_166 ) ;
V_67 -> V_34 = F_100 ( V_67 -> V_83 . V_166 ) ;
if ( ! V_67 -> V_34 ) {
F_92 ( V_12 , L_51
L_52 ,
V_67 -> V_83 . V_166 ) ;
...
static int
F_102 ( struct V_11 * V_12 , int * V_27 , char * V_108 )
{
F_103 ( V_12 ) ;
if ( ! ( * V_27 & V_185 ) )
return - V_144 ;
...
static int
F_104 ( struct V_25 * V_25 , struct V_198 * V_199 )
{
struct V_11 * V_12 = V_25 -> V_157 ;
T_18 V_200 = F_105 ( V_12 -> V_201 -> V_202 ) ;
F_6 ( V_12 , L_28 , V_23 ) ;
V_199 -> V_203 = V_191 ;
V_199 -> V_204 = V_12 -> V_205 ;
V_199 -> V_206 = F_12 ( V_12 ) -> V_189 ;
V_199 -> V_207 = F_12 ( V_12 ) -> V_189 - F_12 ( V_12 ) -> V_208 ;
V_199 -> V_209 = V_199 -> V_207 ;
V_199 -> V_210 = 0 ;
V_199 -> V_211 = 0 ;
V_199 -> V_212 . V_213 [ 0 ] = ( V_214 ) V_200 ;
V_199 -> V_212 . V_213 [ 1 ] = ( V_214 ) ( V_200 >> 32 ) ;
V_199 -> V_215 = V_45 ;
F_6 ( V_12 , L_10 , V_23 ) ;
return 0 ;
}
static struct V_25 *
F_106 ( struct V_216 * V_217 , int V_27 , const char * V_218 ,
void * V_108 )
{
return F_107 ( V_217 , V_27 , V_218 , V_108 , F_89 ) ;
}
static int T_8
F_108 ( void )
{
