...
L_12 , V_34 -> V_71 ) ;
F_22 ( V_3 -> V_72 , L_13 , sizeof( V_3 -> V_72 ) ) ;
V_8 -> V_70 = V_3 -> V_70 ;
V_8 -> V_72 = V_3 -> V_72 ;
F_23 ( V_73 , V_8 -> V_74 ) ;
F_23 ( V_75 , V_8 -> V_74 ) ;
for ( V_4 = 0 ; V_4 < sizeof( V_6 ) ; V_4 ++ )
F_23 ( V_6 [ V_4 ] , V_8 -> V_76 ) ;
F_23 ( V_77 , V_8 -> V_74 ) ;
F_23 ( V_29 , V_8 -> V_78 ) ;
F_23 ( V_30 , V_8 -> V_78 ) ;
F_23 ( V_31 , V_8 -> V_76 ) ;
...
static int F_31 ( enum V_81 V_82 , T_1 V_18 ,
struct V_35 * V_83 , unsigned int V_84 )
{
struct V_35 * V_85 = V_83 ;
int V_86 , V_68 ;
T_3 V_37 ;
if ( V_82 == V_87 ) {
V_37 = V_18 |
...
V_68 = F_32 ( & V_85 , V_84 , & V_88 , V_86 , V_37 ) ;
if ( V_68 < 0 )
return V_68 ;
return V_85 - V_83 ;
}
