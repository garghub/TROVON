...
& V_19 -> V_6 [ V_57 -> V_1 ] ;
struct V_56 * V_98 ;
struct V_99 * V_100 = F_47 ( V_19 , V_57 -> V_1 ) -> V_100 ;
bool V_54 = false ;
int V_101 ;
F_5 ( L_18 , V_57 ,
V_57 -> V_21 ) ;
...
static void F_69 ( struct V_18 * V_19 , unsigned long V_154 )
{
struct V_155 * V_156 = V_19 -> V_23 -> V_156 ;
struct V_157 * V_75 ;
struct V_56 * V_158 , * V_159 ;
unsigned int V_160 ;
F_70 (engine, dev_priv, engine_mask, tmp) {
F_40 (pos, n,
...
enum V_162 V_111 ;
struct V_157 * V_75 ;
F_75 (engine, vgpu->gvt->dev_priv, i) {
F_68 ( V_19 , V_111 ) ;
F_60 ( & V_19 -> F_47 [ V_111 ] ) ;
}
V_19 -> V_59 = F_76 ( L_32 ,
