...
V_51 -> V_84 . V_20 = V_85 ;
V_51 -> V_86 = V_22 -> V_87 ;
V_51 -> V_88 = V_22 -> V_78 . V_70 ;
F_37 ( V_51 , V_2 -> V_30 [ 0 ] , V_2 -> V_16 -> V_89 ) ;
F_38 ( V_51 , & V_49 -> V_63 ,
V_65 -> V_90 , V_65 -> V_91 ) ;
V_51 -> V_79 . V_92 = 0 ;
V_51 -> V_79 . V_93 = 0 ;
...
int V_95 = 32 ;
int V_71 ;
V_94 = F_46 ( sizeof( struct V_48 ) , V_96 ) ;
if ( ! V_94 )
return - V_97 ;
V_94 -> V_12 = V_12 ;
V_12 -> V_94 = V_94 ;
F_47 ( & V_94 -> V_46 , F_13 ) ;
F_48 ( V_12 -> V_98 , & V_94 -> V_63 ,
& V_99 ) ;
V_71 = F_49 ( V_12 -> V_98 , & V_94 -> V_63 ,
V_100 ) ;
if ( V_71 ) {
F_50 ( V_94 ) ;
return V_71 ;
