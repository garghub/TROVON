...
V_16 -> V_2 = V_2 ;
if ( V_2 -> V_9 . V_87 )
V_16 -> type = (enum V_101 )
F_40 ( & V_2 -> V_9 ) ;
else
V_16 -> type = V_93 -> V_102 ;
F_41 ( V_2 , V_16 ) ;
V_18 = F_1 ( V_2 , V_20 ) ;
if ( V_18 < 0 )
return V_18 ;
...
V_16 -> V_34 = F_43 ( & V_2 -> V_9 , V_2 -> V_109 ,
& V_105 , V_110 ) ;
if ( F_44 ( V_16 -> V_34 ) ) {
F_3 ( & V_2 -> V_9 , L_14 ) ;
return F_45 ( V_16 -> V_34 ) ;
}
V_65 = F_6 ( V_16 -> V_2 , V_111 , V_112 ) ;
if ( V_65 )
return V_65 ;
V_65 = F_33 ( V_16 ) ;
if ( V_65 ) {
