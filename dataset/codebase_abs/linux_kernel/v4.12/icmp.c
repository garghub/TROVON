...
static struct V_24 * F_54 ( struct V_2 * V_2 ,
struct V_26 * V_27 ,
struct V_46 * V_88 ,
...
V_91 -> V_70 . V_71 . V_71 . V_80 : V_90 -> V_68 ) ;
V_27 -> V_68 = V_68 ;
V_27 -> V_81 = V_69 ;
V_27 -> V_82 = F_46 ( V_2 , NULL ) ;
V_27 -> V_83 = F_47 ( V_73 ) ;
...
V_27 -> V_95 = type ;
V_27 -> V_96 = V_19 ;
V_27 -> V_86 = F_14 ( F_55 ( V_88 ) -> V_34 ) ;
F_48 ( V_88 , F_49 ( V_27 ) ) ;
V_25 = F_56 ( V_2 , V_27 , V_88 ) ;
if ( F_51 ( V_25 ) )
return V_25 ;
V_92 = V_25 ;
V_25 = (struct V_24 * ) F_57 ( V_2 , & V_25 -> V_29 ,
F_49 ( V_27 ) , NULL , 0 ) ;
if ( ! F_51 ( V_25 ) ) {
if ( V_25 != V_92 )
return V_25 ;
} else if ( F_58 ( V_25 ) == - V_97 ) {
V_25 = NULL ;
} else
return V_25 ;
V_94 = F_59 ( V_88 , F_49 ( & V_93 ) , V_98 ) ;
if ( V_94 )
goto V_99;
if ( F_60 ( V_2 , F_55 ( V_88 ) -> V_34 ,
V_93 . V_68 ) == V_100 ) {
V_92 = F_61 ( V_2 , & V_93 ) ;
if ( F_51 ( V_92 ) )
V_94 = F_58 ( V_92 ) ;
...
V_102 = V_88 -> V_103 ;
F_62 ( V_88 , NULL ) ;
V_94 = F_63 ( V_88 , V_93 . V_38 , V_93 . V_68 ,
...
if ( V_94 )
goto V_99;
V_92 = (struct V_24 * ) F_57 ( V_2 , & V_92 -> V_29 ,
F_49 ( & V_93 ) , NULL ,
V_104 ) ;
if ( ! F_51 ( V_92 ) ) {
F_64 ( & V_25 -> V_29 ) ;
...
void F_66 ( struct V_46 * V_88 , int type , int V_19 , T_3 V_105 )
{
struct V_89 * V_90 ;
int V_106 ;
struct V_48 V_49 ;
struct V_24 * V_25 = F_39 ( V_88 ) ;
struct V_54 V_55 ;
struct V_26 V_27 ;
T_3 V_68 ;
T_4 V_73 ;
...
V_90 = F_44 ( V_88 ) ;
if ( ( T_4 * ) V_90 < V_88 -> V_107 ||
( F_67 ( V_88 ) + sizeof( * V_90 ) ) >
F_68 ( V_88 ) )
goto V_33;
if ( V_88 -> V_108 != V_109 )
goto V_33;
...
F_42 () ;
if ( ! ( V_88 -> V_34 && ( V_88 -> V_34 -> V_35 & V_36 ) ) &&
! F_12 ( V_2 , type , V_19 ) )
goto V_72;
V_4 = F_3 ( V_2 ) ;
if ( ! V_4 )
...
if ( F_73 ( V_25 ) &&
V_2 -> V_3 . V_121 )
V_34 = F_74 ( V_2 , F_75 ( V_88 ) ) ;
if ( V_34 )
V_68 = F_76 ( V_34 , 0 , V_122 ) ;
else
V_68 = 0 ;
F_77 () ;
}
V_73 = V_51 [ type ] . error ? ( ( V_90 -> V_73 & V_123 ) |
V_124 ) :
V_90 -> V_73 ;
V_69 = F_40 ( V_2 , V_88 -> V_69 ) ;
if ( F_41 ( & V_49 . V_70 . V_71 . V_71 , V_88 ) )
goto V_87;
...
V_55 . V_77 = 0 ;
V_55 . V_73 = - 1 ;
V_25 = F_54 ( V_2 , & V_27 , V_88 , V_90 , V_68 , V_73 , V_69 ,
type , V_19 , & V_49 ) ;
if ( F_51 ( V_25 ) )
goto V_87;
if ( ! F_13 ( V_2 , V_25 , & V_27 , type , V_19 ) )
goto V_127;
V_106 = F_79 ( & V_25 -> V_29 ) ;
if ( V_106 > 576 )
V_106 = 576 ;
V_106 -= sizeof( struct V_89 ) + V_49 . V_70 . V_71 . V_71 . V_78 ;
...
static void F_80 ( struct V_46 * V_47 , T_1 V_105 )
{
const struct V_89 * V_90 = ( const struct V_89 * ) V_47 -> V_52 ;
const struct V_128 * V_129 ;
int V_115 = V_90 -> V_115 ;
if ( ! F_81 ( V_47 , V_90 -> V_118 * 4 + 8 ) ) {
F_28 ( F_26 ( V_47 -> V_34 ) , V_130 ) ;
return;
}
F_82 ( V_47 , V_115 , V_105 ) ;
V_129 = F_83 ( V_131 [ V_115 ] ) ;
if ( V_129 && V_129 -> V_132 )
V_129 -> V_132 ( V_47 , V_105 ) ;
}
static bool F_84 ( int V_133 )
{
bool V_134 ;
F_72 () ;
V_134 = F_83 ( V_131 [ V_133 ] ) -> V_135 ;
F_77 () ;
return V_134 ;
}
static bool F_85 ( struct V_46 * V_47 )
{
const struct V_89 * V_90 ;
struct V_61 * V_53 ;
struct V_2 * V_2 ;
T_1 V_105 = 0 ;
V_2 = F_26 ( F_55 ( V_47 ) -> V_34 ) ;
if ( ! F_81 ( V_47 , sizeof( struct V_89 ) ) )
goto V_136;
V_53 = F_32 ( V_47 ) ;
V_90 = ( const struct V_89 * ) V_47 -> V_52 ;
if ( V_90 -> V_118 < 5 )
goto V_136;
if ( V_53 -> type == V_21 ) {
switch ( V_53 -> V_19 & 15 ) {
...
goto V_33;
case 0 :
V_105 = F_87 ( V_53 -> V_125 . V_142 . V_143 ) ;
}
break;
case V_144 :
F_86 ( L_2 ,
...
V_105 = F_88 ( V_53 -> V_125 . V_126 ) >> 24 ;
if ( ! V_2 -> V_3 . V_147 &&
F_60 ( V_2 , V_47 -> V_34 , V_90 -> V_38 ) == V_148 ) {
F_89 ( L_3 ,
& F_44 ( V_47 ) -> V_68 ,
V_53 -> type , V_53 -> V_19 ,
& V_90 -> V_38 , V_47 -> V_34 -> V_149 ) ;
goto V_33;
}
F_80 ( V_47 , V_105 ) ;
V_33:
...
static bool F_90 ( struct V_46 * V_47 )
{
if ( V_47 -> V_44 < sizeof( struct V_89 ) ) {
F_28 ( F_26 ( V_47 -> V_34 ) , V_130 ) ;
return false ;
}
if ( ! F_81 ( V_47 , sizeof( struct V_89 ) ) ) {
...
F_80 ( V_47 , F_32 ( V_47 ) -> V_125 . V_126 ) ;
return true ;
}
static bool F_91 ( struct V_46 * V_47 )
{
struct V_2 * V_2 ;
V_2 = F_26 ( F_55 ( V_47 ) -> V_34 ) ;
if ( ! V_2 -> V_3 . V_150 ) {
...
if ( V_47 -> V_44 < 4 )
goto V_136;
V_49 . V_52 . V_152 [ 1 ] = F_93 () ;
V_49 . V_52 . V_152 [ 2 ] = V_49 . V_52 . V_152 [ 1 ] ;
if ( F_94 ( V_47 , 0 , & V_49 . V_52 . V_152 [ 0 ] , 4 ) )
F_95 () ;
V_49 . V_52 . V_53 = * F_32 ( V_47 ) ;
...
return true ;
V_136:
F_28 ( F_26 ( F_55 ( V_47 ) -> V_34 ) , V_130 ) ;
return false ;
}
static bool F_96 ( struct V_46 * V_47 )
{
return true ;
}
int F_97 ( struct V_46 * V_47 )
{
struct V_61 * V_53 ;
struct V_24 * V_25 = F_39 ( V_47 ) ;
struct V_2 * V_2 = F_26 ( V_25 -> V_29 . V_34 ) ;
bool V_154 ;
if ( ! F_98 ( NULL , V_155 , V_47 ) ) {
struct V_156 * V_157 = F_99 ( V_47 ) ;
int V_158 ;
if ( ! ( V_157 && V_157 -> V_159 [ V_157 -> V_44 - 1 ] -> V_160 . V_35 &
V_161 ) )
goto V_162;
if ( ! F_81 ( V_47 , sizeof( * V_53 ) + sizeof( struct V_89 ) ) )
goto V_162;
V_158 = F_78 ( V_47 ) ;
F_100 ( V_47 , sizeof( * V_53 ) ) ;
if ( ! F_101 ( NULL , V_155 , V_47 ) )
goto V_162;
F_100 ( V_47 , V_158 ) ;
}
F_28 ( V_2 , V_163 ) ;
...
V_154 = V_51 [ V_53 -> type ] . F_105 ( V_47 ) ;
if ( V_154 ) {
F_106 ( V_47 ) ;
return V_170 ;
}
...
void F_108 ( struct V_46 * V_47 , T_1 V_105 )
{
struct V_89 * V_90 = (struct V_89 * ) V_47 -> V_52 ;
int V_43 = V_90 -> V_118 << 2 ;
struct V_61 * V_53 = (struct V_61 * ) ( V_47 -> V_52 + V_43 ) ;
int type = F_32 ( V_47 ) -> type ;
int V_19 = F_32 ( V_47 ) -> V_19 ;
struct V_2 * V_2 = F_26 ( V_47 -> V_34 ) ;
if ( V_53 -> type != V_151 ) {
F_109 ( V_47 , V_43 , V_105 ) ;
return;
}
if ( type == V_21 && V_19 == V_22 )
F_110 ( V_47 , V_2 , V_105 , 0 , 0 , V_85 , 0 ) ;
else if ( type == V_173 )
F_111 ( V_47 , V_2 , 0 , 0 , V_85 , 0 ) ;
}
static void T_5 F_112 ( struct V_2 * V_2 )
{
int V_174 ;
F_113 (i)
F_114 ( * F_115 ( V_2 -> V_3 . F_1 , V_174 ) ) ;
F_116 ( V_2 -> V_3 . F_1 ) ;
V_2 -> V_3 . F_1 = NULL ;
}
static int T_6 F_117 ( struct V_2 * V_2 )
{
int V_174 , V_94 ;
V_2 -> V_3 . F_1 = F_118 ( struct V_1 * ) ;
if ( ! V_2 -> V_3 . F_1 )
return - V_175 ;
F_113 (i) {
struct V_1 * V_4 ;
V_94 = F_119 ( & V_4 , V_176 ,
V_177 , V_85 , V_2 ) ;
if ( V_94 < 0 )
goto V_178;
* F_115 ( V_2 -> V_3 . F_1 , V_174 ) = V_4 ;
V_4 -> V_179 = 2 * F_120 ( 64 * 1024 ) ;
F_121 ( V_4 , V_180 ) ;
