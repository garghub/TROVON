...
char * * V_13 ;
int V_14 ;
V_13 = F_8 ( V_12 , sizeof( char * ) * V_2 -> V_15 , V_16 ) ;
if ( ! V_13 )
return - V_17 ;
...
{
struct V_24 * V_25 ;
V_25 = F_14 ( V_23 , struct V_24 , V_23 ) ;
F_15 ( F_16 ( V_25 -> V_26 ) ) ;
}
...
struct V_1 * V_2 = & V_5 -> V_2 ;
int V_19 , V_14 ;
V_19 = F_18 ( V_12 , - 1 , 0 , V_2 -> V_15 , 0 ) ;
if ( V_19 < 0 )
return V_19 ;
V_2 -> V_19 = V_19 ;
V_2 -> V_27 = & V_28 ;
for ( V_14 = 0 ; V_14 < V_2 -> V_15 ; V_14 ++ ) {
F_19 ( V_19 + V_14 , V_2 -> V_27 ) ;
F_20 ( V_19 + V_14 , & F_15 ) ;
F_21 ( V_19 + V_14 ,
V_29 | V_30 , V_31 ) ;
}
F_22 ( & V_5 -> V_25 . V_23 , F_13 ) ;
return 0 ;
}
static T_1 F_23 ( struct V_32 * V_32 ,
const char T_2 * V_33 ,
T_3 V_34 , T_4 * V_35 )
{
struct V_36 * V_37 ;
...
return - V_47 ;
F_25 ( V_41 , V_42 ) ;
V_37 -> V_5 -> V_25 . V_26 = V_2 -> V_19 + V_37 -> V_3 ;
F_26 ( & V_37 -> V_5 -> V_25 . V_23 ) ;
return V_34 ;
}
static int F_27 ( struct V_48 * V_48 , struct V_32 * V_32 )
{
return F_28 ( V_32 , NULL , V_48 -> V_49 ) ;
}
...
if ( ! V_52 )
goto V_55;
V_37 = F_8 ( V_12 , sizeof( * V_37 ) , V_16 ) ;
if ( ! V_37 )
goto V_55;
V_37 -> V_5 = V_5 ;
V_37 -> V_3 = V_14 ;
V_37 -> V_41 = & V_2 -> V_56 -> V_57 [ V_14 ] ;
V_51 = F_31 ( V_52 , 0200 , V_5 -> V_53 , V_37 ,
& V_58 ) ;
if ( ! V_51 )
goto V_55;
}
...
V_2 -> V_68 = F_6 ;
V_2 -> V_69 = F_10 ;
V_5 -> V_6 = F_8 ( V_12 , sizeof( * V_5 -> V_6 ) * V_2 -> V_15 ,
V_16 ) ;
if ( ! V_5 -> V_6 )
return - V_17 ;
if ( V_70 ) {
...
return - V_17 ;
F_36 ( V_72 , V_73 ) ;
for ( V_14 = 0 ; V_14 < V_75 > > 1 ; V_14 ++ ) {
V_59 = V_76 [ V_14 * 2 ] ;
if ( V_59 == - 1 )
V_15 = V_76 [ V_14 * 2 + 1 ] ;
else
V_15 = V_76 [ V_14 * 2 + 1 ] - V_59 ;
if ( V_15 >= 0 ) {
V_74 = F_9 ( V_12 , V_16 ,
L_4 , V_77 ,
V_78 + V_14 ) ;
