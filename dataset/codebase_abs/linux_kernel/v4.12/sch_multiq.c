...
V_7 -> V_22 = F_35 ( V_7 -> V_39 , sizeof( struct V_1 * ) , V_49 ) ;
if ( ! V_7 -> V_22 )
return - V_50 ;
...
{
struct V_6 * V_7 = F_2 ( V_4 ) ;
unsigned char * V_51 = F_37 ( V_3 ) ;
struct V_33 V_32 ;
V_32 . V_21 = V_7 -> V_21 ;
V_32 . V_39 = V_7 -> V_39 ;
if ( F_38 ( V_3 , V_52 , sizeof( V_32 ) , & V_32 ) )
goto V_53;
return V_3 -> V_54 ;
V_53:
F_39 ( V_3 , V_51 ) ;
...
if ( V_56 == NULL )
V_56 = & V_40 ;
* V_44 = F_41 ( V_4 , V_56 , & V_7 -> V_22 [ V_8 ] ) ;
return 0 ;
}
static struct V_1 *
...
F_51 ( V_65 , NULL , & V_66 -> V_42 , V_66 -> V_7 . V_26 ) < 0 )
return - 1 ;
return 0 ;
}
static void F_52 ( struct V_1 * V_4 , struct V_68 * V_55 )
{
struct V_6 * V_7 = F_2 ( V_4 ) ;
int V_8 ;
if ( V_55 -> V_69 )
...
static struct V_11 T_3 * * F_53 ( struct V_1 * V_4 ,
unsigned long V_59 )
{
struct V_6 * V_7 = F_2 ( V_4 ) ;
if ( V_59 )
