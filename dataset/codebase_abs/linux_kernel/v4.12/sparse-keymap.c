...
void F_17 ( struct V_1 * V_2 , const struct V_3 * V_14 ,
unsigned int V_44 , bool V_45 )
{
switch ( V_14 -> type ) {
case V_9 :
F_18 ( V_2 , V_38 , V_39 , V_14 -> V_12 ) ;
F_19 ( V_2 , V_14 -> V_7 , V_44 ) ;
F_20 ( V_2 ) ;
if ( V_44 && V_45 ) {
F_19 ( V_2 , V_14 -> V_7 , 0 ) ;
F_20 ( V_2 ) ;
...
V_44 = V_14 -> V_35 . V_44 ;
case V_33 :
F_21 ( V_2 , V_14 -> V_35 . V_12 , V_44 ) ;
break;
}
}
bool F_22 ( struct V_1 * V_2 , unsigned int V_12 ,
unsigned int V_44 , bool V_45 )
{
...
struct V_3 V_46 ;
if ( V_14 ) {
F_17 ( V_2 , V_14 , V_44 , V_45 ) ;
return true ;
}
V_46 . type = V_9 ;
V_46 . V_12 = V_12 ;
V_46 . V_7 = V_37 ;
F_17 ( V_2 , & V_46 , V_44 , true ) ;
return false ;
}
