...
static struct V_1 * F_42 ( struct V_45 * V_40 ,
unsigned int V_3 ,
struct V_86 * V_37 )
{
...
return;
V_88 = F_47 ( F_48 ( F_49 () ) ) ;
if ( V_88 < F_50 ( & V_2 -> V_89 ) )
return;
V_15 = V_88 - F_50 ( & V_2 -> V_89 ) ;
if ( V_15 > V_14 )
F_13 ( V_25 -> V_12 , 10 ) ;
}
...
struct V_1 * V_2 , * V_91 ;
F_53 ( V_67 , & V_90 ) ;
F_54 (rq, next, &rq_list, queuelist) {
unsigned int V_13 ;
V_13 = F_1 ( V_2 ) ;
F_55 ( & V_2 -> V_92 , & V_70 -> V_73 [ V_13 ] ) ;
}
}
static int F_56 ( T_2 * V_93 , unsigned V_94 , int V_95 ,
void * V_96 )
{
struct V_66 * V_67 = F_57 ( V_93 -> V_97 ) ;
F_58 ( & V_93 -> V_75 ) ;
F_59 ( V_67 , true ) ;
return 1 ;
}
...
struct V_98 * V_30 = & V_25 -> V_30 [ V_13 ] ;
T_2 * V_93 = & V_70 -> V_74 [ V_13 ] ;
struct V_99 * V_100 ;
int V_83 ;
V_83 = F_61 ( V_30 ) ;
if ( V_83 >= 0 )
...
V_100 = F_64 ( V_30 ,
& V_70 -> V_76 [ V_13 ] ) ;
F_65 ( & V_100 -> V_93 , V_93 ) ;
V_83 = F_61 ( V_30 ) ;
}
return V_83 ;
}
static struct V_1 *
F_66 ( struct V_24 * V_25 ,
struct V_69 * V_70 ,
struct V_66 * V_67 ,
bool * V_101 )
{
...
static struct V_1 * F_68 ( struct V_66 * V_67 )
{
struct V_24 * V_25 = V_67 -> V_103 -> V_65 -> V_64 ;
...
static bool F_71 ( struct V_66 * V_67 )
{
struct V_69 * V_70 = V_67 -> V_79 ;
int V_49 ;
for ( V_49 = 0 ; V_49 < V_53 ; V_49 ++ ) {
if ( ! F_62 ( & V_70 -> V_73 [ V_49 ] ) )
return true ;
}
return false ;
}
static int F_72 ( void * V_37 , struct V_105 * V_106 )
{
struct V_45 * V_40 = V_37 ;
struct V_24 * V_25 = V_40 -> V_65 -> V_64 ;
F_73 ( V_106 , L_1 , V_25 -> V_57 ) ;
return 0 ;
}
static int F_74 ( void * V_37 , struct V_105 * V_106 )
{
...
break;
default:
F_73 ( V_106 , L_1 , V_70 -> V_77 ) ;
break;
}
return 0 ;
}
static int F_76 ( void * V_37 , struct V_105 * V_106 )
{
struct V_66 * V_67 = V_37 ;
struct V_69 * V_70 = V_67 -> V_79 ;
F_73 ( V_106 , L_1 , V_70 -> V_78 ) ;
return 0 ;
}
