...
static int F_71 ( struct V_87 * V_88 , int V_39 ,
int V_45 , int V_3 )
{
struct V_21 * V_22 = F_60 ( V_88 ) ;
struct V_26 * V_26 ;
...
V_24 = V_26 -> V_77 -> V_24 ;
V_102 = F_10 ( V_24 ) ;
memcpy ( V_100 , V_24 , F_13 ( V_101 , V_102 ) ) ;
}
F_28 ( & V_22 -> V_55 ) ;
return V_102 ;
}
static int F_73 ( struct V_87 * V_104 ,
struct V_87 * V_105 , void * V_106 )
{
struct V_40 * V_41 = V_106 ;
struct V_21 * V_22 = F_60 ( V_104 ) ;
int V_4 ;
if ( F_34 ( V_41 -> V_107 || V_41 -> V_23 ) )
return - V_108 ;
F_74 ( & V_22 -> V_109 ) ;
V_41 -> V_107 = & V_110 ;
V_41 -> V_23 = V_104 ;
...
static void F_77 ( struct V_87 * V_104 ,
struct V_87 * V_105 , void * V_106 )
{
struct V_40 * V_41 = V_106 ;
struct V_21 * V_22 = F_60 ( V_104 ) ;
...
{
int V_102 ;
if ( F_56 ( V_22 ) -> V_113 == 0 )
return;
V_102 = F_79 ( V_22 -> V_109 . V_23 , & V_114 ) ;
if ( V_102 < 0 ) {
F_80 ( L_16 , V_102 ) ;
return;
}
