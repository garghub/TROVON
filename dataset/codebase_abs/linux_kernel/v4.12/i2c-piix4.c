...
static T_4 F_28 ( struct V_47 * V_100 )
{
return V_101 | V_102 |
V_103 | V_104 |
V_105 ;
}
static int F_29 ( struct V_1 * V_13 , unsigned short V_51 ,
bool V_106 , T_1 V_96 ,
const char * V_23 , struct V_47 * * V_107 )
{
struct V_47 * V_64 ;
struct V_49 * V_50 ;
int V_97 ;
V_64 = F_30 ( sizeof( * V_64 ) , V_108 ) ;
if ( V_64 == NULL ) {
F_12 ( V_51 , V_21 ) ;
return - V_109 ;
}
...
V_64 -> V_115 = V_106 ? & V_116
: & V_117 ;
V_50 = F_30 ( sizeof( * V_50 ) , V_108 ) ;
if ( V_50 == NULL ) {
F_31 ( V_64 ) ;
F_12 ( V_51 , V_21 ) ;
return - V_109 ;
...
static int F_34 ( struct V_1 * V_13 , unsigned short V_51 )
{
struct V_49 * V_50 ;
int V_96 ;
int V_97 ;
for ( V_96 = 0 ; V_96 < V_119 ; V_96 ++ ) {
V_97 = F_29 ( V_13 , V_51 , true , V_96 ,
V_120 [ V_96 ] ,
& V_121 [ V_96 ] ) ;
if ( V_97 < 0 )
goto error;
...
static int F_36 ( struct V_1 * V_13 , const struct V_3 * V_4 )
{
int V_97 ;
bool V_122 = false ;
if ( ( V_13 -> V_7 == V_123 &&
...
if ( V_97 < 0 )
return V_97 ;
V_97 = F_29 ( V_13 , V_97 , false , 0 , L_48 ,
& V_121 [ 0 ] ) ;
if ( V_97 < 0 )
return V_97 ;
}
...
V_13 -> V_9 == V_124 ) {
if ( V_13 -> V_38 < 0x40 ) {
V_97 = F_19 ( V_13 , V_4 , 0x58 ) ;
} else {
V_97 = F_14 ( V_13 , V_4 , 1 ) ;
}
}
if ( V_13 -> V_7 == V_36 &&
V_13 -> V_9 == V_37 ) {
...
if ( V_97 > 0 ) {
F_29 ( V_13 , V_97 , false , 0 ,
V_122 ? V_125 : L_48 ,
& V_126 ) ;
}
return 0 ;
}
static void F_37 ( struct V_47 * V_64 )
{
struct V_49 * V_50 = F_21 ( V_64 ) ;
if ( V_50 -> V_51 ) {
F_35 ( V_64 ) ;
