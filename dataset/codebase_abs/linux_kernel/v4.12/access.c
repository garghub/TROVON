...
int F_87 ( const struct V_20 * V_14 , int V_4 , T_8 * V_6 )
{
if ( F_88 ( V_14 ) ) {
* V_6 = ~ 0 ;
return V_10 ;
}
return F_89 ( V_14 -> V_2 , V_14 -> V_3 , V_4 , V_6 ) ;
}
int F_77 ( const struct V_20 * V_14 , int V_4 , T_7 * V_6 )
{
if ( F_88 ( V_14 ) ) {
* V_6 = ~ 0 ;
return V_10 ;
}
return F_90 ( V_14 -> V_2 , V_14 -> V_3 , V_4 , V_6 ) ;
}
int F_80 ( const struct V_20 * V_14 , int V_4 ,
T_1 * V_6 )
{
if ( F_88 ( V_14 ) ) {
* V_6 = ~ 0 ;
...
return F_91 ( V_14 -> V_2 , V_14 -> V_3 , V_4 , V_6 ) ;
}
int F_92 ( const struct V_20 * V_14 , int V_4 , T_8 V_6 )
{
if ( F_88 ( V_14 ) )
return V_10 ;
return F_93 ( V_14 -> V_2 , V_14 -> V_3 , V_4 , V_6 ) ;
}
int F_82 ( const struct V_20 * V_14 , int V_4 , T_7 V_6 )
{
if ( F_88 ( V_14 ) )
return V_10 ;
return F_94 ( V_14 -> V_2 , V_14 -> V_3 , V_4 , V_6 ) ;
}
int F_84 ( const struct V_20 * V_14 , int V_4 ,
T_1 V_6 )
{
if ( F_88 ( V_14 ) )
return V_10 ;
return F_95 ( V_14 -> V_2 , V_14 -> V_3 , V_4 , V_6 ) ;
}
