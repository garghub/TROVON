...
V_266 -> V_5 = V_5 ;
V_266 -> V_186 = V_46 ;
V_266 -> V_48 = F_155 ( V_15 , & V_266 -> V_64 ) ;
if ( F_25 ( V_266 -> V_48 ) )
...
static bool F_156 ( struct V_45 * V_46 )
{
struct V_14 * V_15 = V_46 -> V_5 -> V_15 ;
...
static void * F_158 ( struct V_278 * V_279 , T_9 * V_280 )
{
struct V_4 * V_5 = V_279 -> V_281 ;
if ( F_159 ( & V_5 -> V_267 ) )
return NULL ;
F_160 ( V_279 , L_113 ) ;
return F_161 ( & V_5 -> V_267 , * V_280 ) ;
}
static void * F_162 ( struct V_278 * V_279 , void * V_282 , T_9 * V_280 )
{
struct V_4 * V_5 = V_279 -> V_281 ;
return F_163 ( V_282 , & V_5 -> V_267 , V_280 ) ;
}
static void F_164 ( struct V_278 * V_279 , void * V_282 )
{
}
static int F_165 ( struct V_278 * V_279 , void * V_282 )
{
bool V_283 = false , V_284 = false ;
struct V_45 * V_46 ;
unsigned int V_6 ;
V_46 = F_166 ( V_282 , struct V_45 , V_25 ) ;
V_6 = F_6 ( V_46 -> V_48 + V_273 ) ;
if ( V_6 & V_274 )
V_283 = true ;
V_6 = F_6 ( V_46 -> V_48 + V_276 ) ;
...
{
struct V_290 * V_286 ;
V_5 -> V_291 = F_170 ( L_40 , NULL ) ;
if ( ! V_5 -> V_291 )
return - V_24 ;
V_286 = F_171 ( L_119 , V_292 | V_293 , V_5 -> V_291 ,
V_5 , & V_294 ) ;
if ( ! V_286 )
goto remove;
return 0 ;
...
static int F_173 ( struct V_191 * V_77 )
{
