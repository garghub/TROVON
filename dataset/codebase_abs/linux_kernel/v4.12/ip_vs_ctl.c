...
static void
F_78 ( struct V_99 * V_9 , struct V_100 * V_101 )
{
...
static void
F_81 ( struct V_108 * V_9 , struct V_99 * V_101 )
{
...
static void
F_85 ( struct V_54 * V_55 , struct V_73 * V_74 ,
...
struct V_119 * V_120 ;
int V_121 ;
F_86 ( ! V_117 && V_116 -> V_40 != V_74 -> V_40 ) ;
...
F_72 ( & V_74 -> V_131 ) ;
if ( V_117 ) {
F_87 ( V_55 -> V_15 , & V_74 -> V_75 ) ;
F_88 ( & V_74 -> V_132 , & V_55 -> V_133 ) ;
V_55 -> V_134 ++ ;
...
static int
F_89 ( struct V_54 * V_55 , struct V_115 * V_116 ,
struct V_73 * * V_138 )
{
struct V_73 * V_74 ;
...
#endif
{
V_139 = F_92 ( V_55 -> V_15 -> V_2 , V_116 -> V_4 . V_46 ) ;
if ( V_139 != V_144 && V_139 != V_145 )
return - V_143 ;
}
V_74 = F_93 ( sizeof( struct V_73 ) , V_146 ) ;
if ( V_74 == NULL )
return - V_147 ;
V_74 -> V_75 . V_76 = F_94 ( struct V_148 ) ;
if ( ! V_74 -> V_75 . V_76 )
goto V_149;
F_95 (i) {
struct V_148 * V_150 ;
V_150 = F_96 ( V_74 -> V_75 . V_76 , V_17 ) ;
F_97 ( & V_150 -> V_151 ) ;
}
V_74 -> V_40 = V_116 -> V_40 ;
V_74 -> V_59 = V_55 -> V_59 ;
...
V_74 -> V_66 = V_55 -> V_43 ;
V_74 -> V_86 = V_55 -> V_53 ;
F_98 ( V_116 -> V_40 , & V_74 -> V_4 , & V_116 -> V_4 ) ;
...
F_100 ( & V_74 -> V_83 ) ;
F_101 ( & V_74 -> V_131 ) ;
F_101 ( & V_74 -> V_75 . V_102 ) ;
F_85 ( V_55 , V_74 , V_116 , 1 ) ;
* V_138 = V_74 ;
F_102 ( 2 ) ;
return 0 ;
V_149:
...
#endif
V_55 = F_93 ( sizeof( struct V_54 ) , V_146 ) ;
if ( V_55 == NULL ) {
F_104 ( 1 , L_22 , V_58 ) ;
V_155 = - V_147 ;
goto V_175;
}
V_55 -> V_75 . V_76 = F_94 ( struct V_148 ) ;
if ( ! V_55 -> V_75 . V_76 ) {
V_155 = - V_147 ;
goto V_175;
}
F_95 (i) {
struct V_148 * V_100 ;
V_100 = F_96 ( V_55 -> V_75 . V_76 , V_17 ) ;
F_97 ( & V_100 -> V_151 ) ;
}
F_9 ( & V_55 -> V_64 , 0 ) ;
V_55 -> V_40 = V_170 -> V_40 ;
V_55 -> V_59 = V_170 -> V_59 ;
F_98 ( V_55 -> V_40 , & V_55 -> V_4 , & V_170 -> V_4 ) ;
...
L_48 ) ;
F_95 (i) {
struct V_148 * V_170 = F_96 ( V_76 , V_17 ) ;
unsigned int V_239 ;
...
F_78 ( & V_238 , & V_74 -> V_75 ) ;
F_81 ( & V_301 . V_75 , & V_238 ) ;
if ( F_192 ( & V_299 -> V_302 [ V_300 ] ,
& V_301 , sizeof( V_301 ) ) ) {
V_155 = - V_272 ;
break;
...
F_9 ( & V_15 -> V_72 , 0 ) ;
F_9 ( & V_15 -> V_184 , 0 ) ;
V_15 -> V_205 . V_76 = F_94 ( struct V_148 ) ;
if ( ! V_15 -> V_205 . V_76 )
return - V_147 ;
F_95 (i) {
struct V_148 * V_496 ;
V_496 = F_96 ( V_15 -> V_205 . V_76 , V_17 ) ;
F_97 ( & V_496 -> V_151 ) ;
}
F_101 ( & V_15 -> V_205 . V_102 ) ;
