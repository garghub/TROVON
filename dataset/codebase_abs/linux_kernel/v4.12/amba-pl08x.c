...
while ( F_8 ( V_24 -> V_37 + V_48 ) & F_17 ( V_25 -> V_31 ) )
F_16 () ;
V_20 = F_8 ( V_25 -> V_21 ) ;
...
V_53 ) ;
F_12 ( V_20 , V_19 -> V_21 ) ;
F_12 ( F_17 ( V_19 -> V_31 ) , V_24 -> V_37 + V_54 ) ;
F_12 ( F_17 ( V_19 -> V_31 ) , V_24 -> V_37 + V_55 ) ;
}
static inline T_1 F_23 ( T_1 V_56 )
{
T_1 V_57 = V_56 & V_58 ;
V_56 &= V_59 ;
switch ( V_56 >> V_60 ) {
...
static inline T_1 F_24 ( T_1 V_56 , T_1 V_64 )
{
T_1 V_57 = V_64 & V_65 ;
V_56 &= V_59 ;
switch ( V_56 >> V_60 ) {
...
V_57 = F_23 ( F_8 ( V_19 -> V_37 + V_41 ) ) ;
if ( ! V_69 )
return V_57 ;
V_47 = V_44 -> V_47 ;
V_67 = V_44 -> V_67 ;
V_68 = V_24 -> V_71 * V_72 ;
F_26 ( V_69 < V_67 || V_69 >= V_67 +
sizeof( T_1 ) * V_68 ) ;
...
V_19 = F_27 ( V_24 , V_9 ) ;
if ( ! V_19 ) {
F_32 ( & V_24 -> V_29 -> V_30 , L_5 , V_9 -> V_81 ) ;
V_9 -> V_82 = V_83 ;
return;
}
F_32 ( & V_24 -> V_29 -> V_30 , L_6 ,
V_19 -> V_31 , V_9 -> V_81 ) ;
V_9 -> V_25 = V_19 ;
V_9 -> V_82 = V_84 ;
F_13 ( V_9 ) ;
...
static inline unsigned int F_38 ( unsigned int V_90 )
{
switch ( V_90 ) {
case V_61 :
return 1 ;
...
static inline T_1 F_40 ( T_1 V_56 , T_4 V_91 , T_4 V_92 ,
T_3 V_93 )
{
T_1 V_94 = V_56 ;
V_94 &= ~ V_95 ;
...
int V_108 , T_3 * V_115 )
{
* V_56 = F_40 ( * V_56 , 1 , 1 , V_109 ) ;
F_42 ( V_24 , V_99 , V_108 , V_109 , * V_56 , V_109 ) ;
( * V_115 ) += V_109 ;
}
...
static inline void F_44 ( struct V_23 * V_24 ,
const T_1 * V_47 , int V_108 ) {}
...
T_1 * V_47 , * V_118 ;
struct V_119 * V_120 ;
V_44 -> V_47 = F_46 ( V_24 -> V_121 , V_122 , & V_44 -> V_67 ) ;
if ( ! V_44 -> V_47 ) {
F_47 ( & V_24 -> V_29 -> V_30 , L_19 , V_123 ) ;
return 0 ;
}
V_99 . V_44 = V_44 ;
...
V_56 = F_40 ( V_56 , V_99 . V_105 . V_107 ,
V_99 . V_104 . V_107 , 0 ) ;
F_42 ( V_24 , & V_99 , V_108 ++ ,
0 , V_56 , 0 ) ;
break;
}
...
V_136 = F_49 ( V_99 . V_114 , V_117 ) ;
V_137 = F_50 ( V_101 -> V_107 , V_102 -> V_107 ) ;
...
if ( V_44 -> V_47 )
F_52 ( V_24 -> V_121 , V_44 -> V_47 , V_44 -> V_67 ) ;
...
static void F_55 ( struct V_43 * V_8 )
{
struct V_5 * V_44 = F_3 ( & V_8 -> V_7 ) ;
...
{
struct V_5 * V_44 = F_78 ( sizeof( * V_44 ) , V_122 ) ;
if ( V_44 ) {
F_79 ( & V_44 -> V_172 ) ;
V_44 -> V_27 = V_52 |
V_53 ;
...
V_120 = F_78 ( sizeof( struct V_119 ) , V_122 ) ;
if ( ! V_120 ) {
F_51 ( V_24 , V_44 ) ;
return NULL ;
}
F_81 ( & V_120 -> V_45 , & V_44 -> V_172 ) ;
V_120 -> V_127 = V_152 ;
V_120 -> V_128 = V_173 ;
V_120 -> V_109 = V_109 ;
...
if ( V_24 -> V_8 -> V_177 )
V_44 -> V_56 |= F_69 ( V_24 -> V_178 ,
V_24 -> V_178 ) ;
V_13 = F_45 ( V_9 -> V_12 , V_44 ) ;
if ( ! V_13 ) {
F_51 ( V_24 , V_44 ) ;
return NULL ;
}
return F_82 ( & V_9 -> V_4 , & V_44 -> V_8 , V_74 ) ;
}
static struct V_5 * F_83 (
struct V_2 * V_3 ,
enum V_179 V_180 ,
T_2 * V_181 )
{
...
V_44 = F_77 ( V_9 ) ;
if ( ! V_44 ) {
F_47 ( & V_24 -> V_29 -> V_30 , L_37 , V_123 ) ;
return NULL ;
}
if ( V_180 == V_185 ) {
V_56 = V_106 ;
...
V_44 -> V_56 = V_56 | F_69 ( V_183 , V_184 ) ;
if ( V_9 -> V_186 . V_193 )
...
static int F_84 ( struct V_5 * V_44 ,
enum V_179 V_180 ,
T_2 V_181 ,
T_2 V_200 ,
unsigned int V_109 )
...
int V_13 , V_182 ;
T_2 V_181 ;
F_32 ( & V_24 -> V_29 -> V_30 , L_42 ,
V_123 , F_86 ( V_203 ) , V_9 -> V_81 ) ;
V_44 = F_83 ( V_3 , V_180 , & V_181 ) ;
if ( ! V_44 )
return NULL ;
F_87 (sgl, sg, sg_len, tmp) {
V_13 = F_84 ( V_44 , V_180 , V_181 ,
F_88 ( V_206 ) ,
F_86 ( V_206 ) ) ;
if ( V_13 ) {
F_5 ( V_9 ) ;
F_51 ( V_24 , V_44 ) ;
F_47 ( & V_24 -> V_29 -> V_30 , L_43 ,
V_123 ) ;
return NULL ;
}
}
...
bool F_94 ( struct V_2 * V_3 , void * V_214 )
{
struct V_1 * V_9 ;
char * V_81 = V_214 ;
...
static bool F_95 ( struct V_2 * V_3 , void * V_214 )
{
struct V_1 * V_9 = F_1 ( V_3 ) ;
return V_9 -> V_16 == V_214 ;
}
...
return V_227 ;
for ( V_75 = 0 ; V_75 < V_24 -> V_8 -> V_76 ; V_75 ++ ) {
if ( ( F_17 ( V_75 ) & V_223 ) || ( F_17 ( V_75 ) & V_224 ) ) {
...
static void F_100 ( struct V_1 * V_3 )
{
V_3 -> V_211 = true ;
...
V_3 -> V_81 = F_102 ( V_232 , L_50 , V_75 ) ;
if ( ! V_3 -> V_81 ) {
F_54 ( V_3 ) ;
return - V_201 ;
}
...
static const char * F_106 ( enum V_236 V_82 )
{
switch ( V_82 ) {
case V_89 :
return L_55 ;
...
static int F_107 ( struct V_237 * V_238 , void * V_239 )
{
...
static int F_109 ( struct V_241 * V_241 , struct V_242 * V_242 )
{
return F_110 ( V_242 , F_107 , V_241 -> V_243 ) ;
}
static void F_111 ( struct V_23 * V_24 )
{
( void ) F_112 ( F_113 ( & V_24 -> V_29 -> V_30 ) ,
V_244 | V_245 , NULL , V_24 ,
& V_246 ) ;
}
static inline void F_111 ( struct V_23 * V_24 )
{
}
static struct V_2 * F_114 ( struct V_23 * V_24 ,
T_1 V_31 )
{
struct V_1 * V_3 ;
F_35 (chan, &pl08x->slave.channels, vc.chan.device_node) {
...
static struct V_2 * F_115 ( struct V_247 * V_248 ,
struct V_249 * V_250 )
{
...
static int F_117 ( struct V_253 * V_29 ,
struct V_23 * V_24 ,
struct V_235 * V_254 )
{
struct V_10 * V_11 ;
...
int V_13 ;
int V_75 ;
V_11 = F_118 ( & V_29 -> V_30 , sizeof( * V_11 ) , V_232 ) ;
if ( ! V_11 )
return - V_201 ;
if ( F_119 ( V_254 , L_74 ) )
V_11 -> V_124 |= V_154 ;
...
V_11 -> V_178 |= V_125 ;
if ( ! V_11 -> V_178 ) {
F_104 ( & V_29 -> V_30 , L_79 ) ;
V_11 -> V_178 |= V_154 | V_125 ;
}
V_13 = F_120 ( V_254 , L_80 , & V_20 ) ;
if ( V_13 ) {
F_104 ( & V_29 -> V_30 , L_81 ) ;
V_20 = 1 ;
}
switch ( V_20 ) {
default:
...
V_13 = F_120 ( V_254 , L_83 , & V_20 ) ;
if ( V_13 ) {
F_104 ( & V_29 -> V_30 , L_84 ) ;
V_20 = 8 ;
}
switch ( V_20 ) {
default:
...
V_256 -> V_229 = F_102 ( V_232 , L_86 , V_75 ) ;
V_256 ++ ;
}
V_11 -> V_266 = V_24 -> V_8 -> V_265 ;
V_24 -> V_11 = V_11 ;
return F_122 ( V_29 -> V_30 . V_267 , F_115 ,
V_24 ) ;
}
static inline int F_117 ( struct V_253 * V_29 ,
struct V_23 * V_24 ,
struct V_235 * V_254 )
{
return - V_212 ;
}
static int F_123 ( struct V_253 * V_29 , const struct V_268 * V_31 )
{
struct V_23 * V_24 ;
...
int V_13 = 0 ;
int V_75 ;
V_13 = F_124 ( V_29 , NULL ) ;
if ( V_13 )
return V_13 ;
V_13 = F_125 ( & V_29 -> V_30 , F_126 ( 32 ) ) ;
if ( V_13 )
goto V_271;
V_24 = F_78 ( sizeof( * V_24 ) , V_232 ) ;
if ( ! V_24 ) {
V_13 = - V_201 ;
goto V_271;
}
V_24 -> V_29 = V_29 ;
V_24 -> V_8 = V_8 ;
F_127 ( V_272 , V_24 -> memcpy . V_273 ) ;
V_24 -> memcpy . V_30 = & V_29 -> V_30 ;
V_24 -> memcpy . V_274 = F_61 ;
V_24 -> memcpy . V_275 = F_80 ;
V_24 -> memcpy . V_276 = F_64 ;
V_24 -> memcpy . V_277 = F_65 ;
V_24 -> memcpy . V_278 = F_75 ;
V_24 -> memcpy . V_279 = F_90 ;
V_24 -> memcpy . V_280 = F_92 ;
V_24 -> memcpy . V_281 = F_93 ;
V_24 -> memcpy . V_282 = F_91 ;
V_24 -> memcpy . V_283 = V_284 ;
V_24 -> memcpy . V_285 = V_284 ;
V_24 -> memcpy . V_286 = F_17 ( V_287 ) ;
V_24 -> memcpy . V_288 = V_289 ;
F_127 ( V_290 , V_24 -> V_211 . V_273 ) ;
F_127 ( V_291 , V_24 -> V_211 . V_273 ) ;
V_24 -> V_211 . V_30 = & V_29 -> V_30 ;
V_24 -> V_211 . V_274 = F_61 ;
V_24 -> V_211 . V_276 = F_64 ;
V_24 -> V_211 . V_277 = F_65 ;
V_24 -> V_211 . V_278 = F_75 ;
V_24 -> V_211 . V_292 = F_85 ;
V_24 -> V_211 . V_293 = F_89 ;
V_24 -> V_211 . V_279 = F_90 ;
V_24 -> V_211 . V_280 = F_92 ;
V_24 -> V_211 . V_281 = F_93 ;
V_24 -> V_211 . V_282 = F_91 ;
V_24 -> V_211 . V_283 = V_284 ;
V_24 -> V_211 . V_285 = V_284 ;
V_24 -> V_211 . V_286 = F_17 ( V_190 ) | F_17 ( V_185 ) ;
V_24 -> V_211 . V_288 = V_289 ;
V_24 -> V_11 = F_128 ( & V_29 -> V_30 ) ;
if ( ! V_24 -> V_11 ) {
if ( V_254 ) {
V_13 = F_117 ( V_29 , V_24 , V_254 ) ;
if ( V_13 )
goto V_294;
} else {
F_47 ( & V_29 -> V_30 , L_87 ) ;
...
V_24 -> V_211 . V_295 . V_296 = V_24 -> V_11 -> V_297 ;
V_24 -> V_211 . V_295 . V_298 = V_24 -> V_11 -> V_299 ;
V_24 -> V_211 . V_295 . V_300 = F_95 ;
}
V_24 -> V_124 = V_154 ;
V_24 -> V_178 = V_154 ;
if ( V_24 -> V_8 -> V_177 ) {
...
V_24 -> V_121 = F_129 ( V_303 , & V_24 -> V_29 -> V_30 ,
V_270 , V_304 , 0 ) ;
if ( ! V_24 -> V_121 ) {
V_13 = - V_201 ;
goto V_305;
}
V_24 -> V_37 = F_130 ( V_29 -> V_306 . V_307 , F_131 ( & V_29 -> V_306 ) ) ;
if ( ! V_24 -> V_37 ) {
V_13 = - V_201 ;
goto V_308;
}
...
V_13 = F_132 ( V_29 -> V_221 [ 0 ] , F_97 , 0 , V_303 , V_24 ) ;
if ( V_13 ) {
F_47 ( & V_29 -> V_30 , L_88 ,
V_123 , V_29 -> V_221 [ 0 ] ) ;
goto V_309;
}
V_24 -> V_77 = F_78 ( ( V_8 -> V_76 * sizeof( * V_24 -> V_77 ) ) ,
V_232 ) ;
if ( ! V_24 -> V_77 ) {
V_13 = - V_201 ;
goto V_310;
...
V_19 -> V_31 = V_75 ;
V_19 -> V_37 = V_24 -> V_37 + F_133 ( V_75 ) ;
V_19 -> V_21 = V_19 -> V_37 + V_8 -> V_311 ;
F_134 ( & V_19 -> V_78 ) ;
if ( V_8 -> V_219 ) {
T_1 V_20 ;
V_20 = F_8 ( V_19 -> V_21 ) ;
if ( V_20 & ( V_312 | V_313 ) ) {
F_104 ( & V_29 -> V_30 , L_89 , V_75 ) ;
V_19 -> V_79 = true ;
}
}
F_32 ( & V_29 -> V_30 , L_90 ,
...
V_13 = F_101 ( V_24 , & V_24 -> memcpy ,
V_24 -> V_8 -> V_76 , false ) ;
if ( V_13 <= 0 ) {
F_135 ( & V_24 -> V_29 -> V_30 ,
L_93 ,
V_123 , V_13 ) ;
goto V_314;
}
V_13 = F_101 ( V_24 , & V_24 -> V_211 ,
...
F_137 ( V_29 , V_24 ) ;
F_111 ( V_24 ) ;
F_104 ( & V_24 -> V_29 -> V_30 , L_97 ,
F_138 ( V_29 ) , V_24 -> V_8 -> V_28 ? L_98 : L_10 , F_139 ( V_29 ) ,
( unsigned long long ) V_29 -> V_306 . V_307 , V_29 -> V_221 [ 0 ] ) ;
return 0 ;
V_317:
F_140 ( & V_24 -> memcpy ) ;
V_316:
...
V_143 = F_146 ( & V_217 ) ;
if ( V_143 )
F_147 (KERN_WARNING DRIVER_NAME
L_99 ,
retval) ;
return V_143 ;
}
