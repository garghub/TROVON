...
F_51 ( V_224 -> V_63 ) ) ;
F_87 ( V_2 , F_51 ( V_224 -> V_63 ) ) ;
F_36 ( & V_2 -> V_5 , V_178 ) ;
if ( V_2 -> V_5 . V_15 -> type != V_225 && F_123 ( V_224 -> V_63 ) )
F_16 ( V_2 -> V_5 . V_15 , F_96 ( V_224 ) , NULL ) ;
F_101 ( V_2 -> V_5 . V_15 , V_2 -> V_116 ) ;
F_46 ( V_2 -> V_61 ) ;
F_47 ( V_2 -> V_5 . V_15 , V_2 -> V_62 ) ;
F_9 ( & V_2 -> V_5 ) ;
...
static int F_125 ( struct V_226 * V_2 )
{
struct V_16 * V_17 ;
struct V_227 * V_26 ;
F_2 ( L_1 , V_3 , V_2 ) ;
...
V_26 = (struct V_227 * ) F_18 ( V_17 , sizeof( * V_26 ) ) ;
V_26 -> V_28 . V_29 = F_19 ( F_20 ( V_30 ) ) ;
...
static int F_128 ( struct V_226 * V_2 )
{
struct V_16 * V_17 ;
struct V_236 * V_26 ;
F_2 ( L_1 , V_3 , V_2 ) ;
...
V_26 = (struct V_236 * ) F_18 ( V_17 , sizeof( * V_26 ) ) ;
V_26 -> V_28 . V_29 = F_19 ( F_20 ( V_30 ) ) ;
V_26 -> V_39 = 0 ;
...
V_26 -> V_78 ,
V_26 -> V_79 ,
V_26 -> V_80 , F_133 ( F_99 ( V_26 -> V_257 ) ) ) ;
if ( ! V_82 ) {
F_63 ( L_40 , V_3 ) ;
goto V_251;
}
...
F_5 ( & V_177 -> V_5 ) ;
V_245 -> V_177 = V_177 ;
V_245 -> V_81 = F_133 ( F_99 ( V_26 -> V_257 ) ) ;
V_245 -> V_62 = V_62 ;
V_245 -> V_61 = V_61 ;
V_245 -> V_24 = V_24 ;
F_135 ( & V_245 -> V_4 ) ;
F_98 ( V_15 , & V_156 , V_245 , V_24 ) ;
F_130 ( V_245 , V_26 -> V_78 , V_17 ) ;
goto V_210;
V_251:
...
if ( V_2 -> V_5 . V_165 && V_2 -> V_5 . V_168 ) {
V_186 . V_201 = V_274 ;
V_272 = F_113 ( V_2 -> V_5 . V_168 -> V_208 ,
V_2 -> V_5 . V_168 , V_203 ,
& V_186 , 1 ) ;
if ( V_272 )
F_63 ( L_46 , V_3 ) ;
...
V_271 -> V_32 = V_45 ;
V_224 = (struct V_270 * ) F_18 ( V_271 , sizeof( * V_224 ) ) ;
...
return V_217 ;
F_2 ( L_1 , V_3 , V_2 ) ;
F_118 ( V_17 , sizeof( struct V_277 ) ) ;
F_2 ( L_49 , V_3 , V_17 -> V_74 ) ;
F_112 ( V_17 , V_2 -> V_5 . V_168 -> V_278 . V_279 ,
V_17 -> V_74 ) ;
...
F_34 ( & V_2 -> V_5 . V_53 , V_52 ) ;
if ( abort )
F_102 ( V_2 , NULL , V_285 ) ;
F_9 ( & V_2 -> V_5 ) ;
}
int F_145 ( struct V_286 * V_165 , const void * V_148 , T_6 V_287 )
{
int V_188 ;
...
V_188 = F_93 ( V_2 , V_148 , V_287 ) ;
V_188 = F_138 ( V_2 , 0 , V_27 ) ;
}
F_9 ( & V_2 -> V_5 ) ;
return 0 ;
}
int F_147 ( struct V_286 * V_165 , struct V_288 * V_289 )
{
int V_188 ;
struct V_185 V_186 ;
enum V_187 V_42 ;
struct V_1 * V_2 = F_146 ( V_165 ) ;
struct V_290 * V_291 = F_148 ( V_165 -> V_292 ) ;
struct V_293 * V_168 = F_149 ( V_291 , V_289 -> V_294 ) ;
F_2 ( L_54 , V_3 , V_2 , V_2 -> V_24 ) ;
if ( F_32 ( & V_2 -> V_5 ) == V_178 ) {
V_188 = - V_66 ;
goto V_188;
...
static int F_151 ( struct V_286 * V_165 )
{
struct V_299 * V_76 ;
struct V_300 * V_301 = (struct V_300 * ) & V_165 -> V_302 ;
V_76 = F_152 ( & V_85 , V_301 -> V_120 . V_121 ) ;
if ( ! V_76 )
return 0 ;
F_153 ( V_76 ) ;
return 1 ;
}
int F_154 ( struct V_286 * V_165 , struct V_288 * V_289 )
{
struct V_290 * V_291 = F_148 ( V_165 -> V_292 ) ;
struct V_1 * V_2 ;
struct V_75 * V_82 ;
...
V_165 -> V_297 ( V_165 ) ;
V_2 -> V_5 . V_165 = V_165 ;
V_2 -> V_5 . V_168 = F_149 ( V_291 , V_289 -> V_294 ) ;
F_85 ( ! V_2 -> V_5 . V_168 ) ;
F_2 ( L_57 , V_3 , V_289 -> V_294 ,
V_2 -> V_5 . V_168 , V_165 ) ;
V_2 -> V_116 = F_155 ( V_291 -> V_21 . V_308 , & V_156 , V_2 ) ;
if ( V_2 -> V_116 == - 1 ) {
F_63 ( L_58 , V_3 ) ;
V_188 = - V_35 ;
goto V_309;
...
int F_156 ( struct V_286 * V_165 , int V_313 )
{
int V_188 = 0 ;
struct V_290 * V_291 = F_148 ( V_165 -> V_292 ) ;
struct V_226 * V_2 ;
...
memcpy ( & V_2 -> V_5 . V_117 , & V_165 -> V_304 ,
sizeof( V_2 -> V_5 . V_117 ) ) ;
V_2 -> V_229 = F_158 ( V_291 -> V_21 . V_308 , & V_156 , V_2 ) ;
if ( V_2 -> V_229 == - 1 ) {
F_63 ( L_58 , V_3 ) ;
V_188 = - V_35 ;
goto V_309;
...
int F_160 ( struct V_286 * V_165 )
{
int V_188 ;
struct V_226 * V_2 = F_161 ( V_165 ) ;
F_2 ( L_1 , V_3 , V_2 ) ;
F_157 () ;
F_36 ( & V_2 -> V_5 , V_178 ) ;
V_2 -> V_5 . V_220 = 0 ;
...
int F_138 ( struct V_1 * V_2 , int V_316 , T_3 V_57 )
{
int V_272 = 0 ;
unsigned long V_52 ;
int V_317 = 0 ;
...
int F_163 ( void * V_153 , struct V_247 * V_320 , struct V_247 * V_54 ,
struct V_18 * V_62 )
{
struct V_1 * V_2 = V_153 ;
if ( V_2 -> V_61 != V_320 )
...
static void F_165 ( struct V_321 * V_322 )
{
struct V_16 * V_17 = NULL ;
void * V_2 ;
struct V_14 * V_15 ;
int V_272 ;
while ( ( V_17 = F_166 ( & V_323 ) ) ) {
V_2 = * ( ( void * * ) ( V_17 -> V_324 ) ) ;
V_15 = * ( (struct V_14 * * ) ( V_17 -> V_324 + sizeof( void * ) ) ) ;
V_272 = V_325 [ F_167 ( F_99 ( ( V_326 T_4 ) V_17 -> V_327 ) ) ] ( V_15 , V_17 , V_2 ) ;
if ( V_272 & V_217 )
F_12 ( V_17 ) ;
F_9 ( (struct V_50 * ) V_2 ) ;
}
