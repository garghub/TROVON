...
{
int V_52 , V_14 = 0 ;
F_22 ( sizeof( struct V_17 ) ) ;
V_31 = F_23 ( 65536 , V_53 ) ;
if ( ! V_31 )
return - V_54 ;
if ( V_51 == 0 )
V_55 [ V_51 ++ ] = V_56 ;
for ( V_52 = 0 ; V_52 < V_51 ; V_52 ++ ) {
F_24 ( & V_50 [ 2 * V_52 ] , V_57 , V_48 , L_6 ,
V_56 , V_55 [ V_52 ] , V_55 [ V_52 ] ,
& V_58 , 0 , F_1 , NULL ,
V_59 ) ;
F_24 ( & V_50 [ 2 * V_52 + 1 ] , V_60 , V_48 , L_6 ,
V_56 , V_55 [ V_52 ] , V_55 [ V_52 ] ,
& V_58 , 0 , F_1 , NULL ,
V_59 ) ;
}
V_14 = F_25 ( V_50 , V_51 * 2 ) ;
if ( V_14 < 0 ) {
F_26 ( L_7 ) ;
F_20 ( V_31 ) ;
return V_14 ;
