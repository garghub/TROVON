...
F_21 ( V_111 , & V_2 -> V_6 ) ;
F_21 ( V_103 , & V_2 -> V_6 ) ;
V_2 -> V_7 = F_77 ( V_2 -> V_3 -> V_170 , V_171 ) ;
if ( ! V_2 -> V_7 ) {
F_29 ( V_2 -> V_3 , L_29 ,
V_4 ) ;
V_66 = - V_162 ;
...
F_78 ( & V_2 -> V_47 ) ;
F_79 ( & V_2 -> V_36 ) ;
V_2 -> V_36 . V_173 = ( unsigned long ) V_2 ;
V_2 -> V_36 . V_174 = F_1 ;
F_79 ( & V_2 -> V_175 ) ;
V_2 -> V_175 . V_173 = ( unsigned long ) V_2 ;
V_2 -> V_175 . V_174 = F_50 ;
F_79 ( & V_2 -> V_74 ) ;
V_2 -> V_74 . V_173 = ( unsigned long ) V_2 ;
V_2 -> V_74 . V_174 = F_65 ;
V_66 = V_2 -> V_42 -> V_176 ( V_2 -> V_42 ) ;
if ( V_66 ) {
F_29 ( V_2 -> V_3 ,
L_30 ,
V_4 , V_66 ) ;
...
static void F_83 ( struct V_124 * V_86 )
{
struct V_2 * V_2 = F_67 ( V_86 ) ;
F_84 () ;
F_85 ( V_181 ) ;
...
static void F_87 ( struct V_183 * V_173 [] , struct V_2 * V_2 )
{
int V_23 ;
if ( ! V_173 ) {
F_88 ( L_32 ) ;
...
V_23 = V_184 ;
if ( V_173 [ V_23 ] ) {
T_4 V_38 = F_89 ( V_173 [ V_23 ] ) ;
V_2 -> V_19 . V_38 = V_38 * V_46 / 1000 ;
if ( V_2 -> V_19 . V_38 == 0 )
V_2 -> V_19 . V_38 = 1 ;
else if ( V_2 -> V_19 . V_38 > V_185 )
V_2 -> V_19 . V_38 = V_185 ;
}
V_23 = V_186 ;
if ( V_173 [ V_23 ] )
V_2 -> V_19 . V_24 = F_89 ( V_173 [ V_23 ] ) ;
V_23 = V_187 ;
if ( V_173 [ V_23 ] )
V_2 -> V_19 . V_20 = F_89 ( V_173 [ V_23 ] ) ;
V_23 = V_188 ;
if ( V_173 [ V_23 ] )
V_2 -> V_19 . V_21 = F_89 ( V_173 [ V_23 ] ) ;
V_23 = V_189 ;
if ( V_173 [ V_23 ] )
V_2 -> V_19 . V_139 = F_89 ( V_173 [ V_23 ] ) ;
V_23 = V_190 ;
if ( V_173 [ V_23 ] )
V_2 -> V_19 . V_70 = F_89 ( V_173 [ V_23 ] ) ;
}
static int F_90 ( struct V_124 * V_86 , struct V_183 * V_191 [] ,
struct V_183 * V_173 [] )
{
F_87 ( V_173 , F_67 ( V_86 ) ) ;
F_91 ( V_86 ) ;
return 0 ;
}
static T_1 F_92 ( const struct V_124 * V_86 )
{
int V_23 ;
T_1 V_192 = 0 ;
for ( V_23 = V_193 + 1 ; V_23 < V_194 ; V_23 ++ )
V_192 += F_93 ( V_195 [ V_23 ] . V_16 ) ;
return V_192 ;
}
static int F_94 ( struct V_9 * V_10 , const struct V_124 * V_86 )
{
struct V_2 * V_2 = F_67 ( V_86 ) ;
if ( F_95 ( V_10 , V_184 ,
V_2 -> V_19 . V_38 ) ||
...
static int F_96 ( struct V_197 * V_198 , struct V_124 * V_86 ,
struct V_183 * V_191 [] , struct V_183 * V_173 [] )
{
struct V_2 * V_2 = NULL ;
struct V_199 * ( * V_200 ) ( void ) ;
F_84 () ;
V_2 = F_67 ( V_86 ) ;
F_87 ( V_173 , V_2 ) ;
V_200 = F_97 ( V_201 ) ;
...
V_2 = F_104 ( V_205 , struct V_2 , V_182 ) ;
F_105 ( V_2 -> V_3 ) ;
}
F_61 () ;
}
