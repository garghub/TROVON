...
int F_108 ( struct V_15 * V_7 )
{
char * V_130 = L_12 ;
if ( V_7 -> V_131 ) {
if ( F_109 ( V_7 -> V_131 < sizeof( struct V_132 ) ) ||
F_109 ( V_7 -> V_133 < F_110 ( struct V_132 ) ) )
return - V_36 ;
snprintf ( V_7 -> V_134 , sizeof( V_7 -> V_134 ) ,
L_13 , V_7 -> V_17 ) ;
V_7 -> V_135 = F_111 ( V_7 -> V_134 , V_7 -> V_131 ,
V_7 -> V_133 , 0 , NULL ) ;
if ( ! V_7 -> V_135 )
return - V_136 ;
}
...
static int F_121 ( struct V_4 * V_5 , struct V_15 * V_141 )
{
struct V_6 * V_143 = V_5 -> V_8 ;
bool V_144 = false ;
int V_31 ;
if ( V_5 -> V_37 )
return F_116 ( V_5 , V_141 ) ;
if ( V_143 ) {
V_144 = V_143 -> V_127 ;
F_122 ( V_5 ) ;
if ( V_144 )
...
static int F_124 ( struct V_4 * V_5 , const char * V_16 )
{
char V_17 [ V_147 ] ;
struct V_15 * V_7 ;
if ( V_5 -> V_37 && ! strncmp ( V_16 , L_18 , 4 ) )
return F_121 ( V_5 , NULL ) ;
F_125 ( V_17 , V_16 , sizeof( V_17 ) ) ;
V_7 = F_8 ( F_126 ( V_17 ) , true ) ;
if ( ! V_7 )
return - V_36 ;
if ( V_5 -> V_8 &&
...
return F_121 ( V_5 , V_7 ) ;
}
static inline bool F_127 ( struct V_4 * V_5 )
{
...
T_4 F_128 ( struct V_4 * V_5 , const char * V_16 ,
T_5 V_150 )
{
int V_70 ;
if ( ! ( V_5 -> V_37 || V_5 -> V_151 ) || ! F_127 ( V_5 ) )
return V_150 ;
V_70 = F_124 ( V_5 , V_16 ) ;
if ( ! V_70 )
return V_150 ;
...
T_4 F_129 ( struct V_4 * V_5 , char * V_16 )
{
struct V_6 * V_7 = V_5 -> V_8 ;
...
int V_154 = 0 ;
if ( ! F_130 ( V_5 ) )
return sprintf ( V_16 , L_19 ) ;
if ( ! V_5 -> V_8 )
V_154 += sprintf ( V_16 + V_154 , L_20 ) ;
else
V_152 = V_7 -> type ;
F_9 ( & V_20 ) ;
F_5 (__e, &elv_list, list) {
if ( V_152 && ! strcmp ( V_152 -> V_17 , V_153 -> V_17 ) ) {
V_154 += sprintf ( V_16 + V_154 , L_21 , V_152 -> V_17 ) ;
continue;
}
if ( V_153 -> V_9 && V_5 -> V_37 && F_127 ( V_5 ) )
V_154 += sprintf ( V_16 + V_154 , L_22 , V_153 -> V_17 ) ;
...
V_154 += sprintf ( V_154 + V_16 , L_23 ) ;
return V_154 ;
}
struct V_1 * F_131 ( struct V_4 * V_5 ,
struct V_1 * V_2 )
{
struct V_51 * V_155 = F_132 ( & V_2 -> V_51 ) ;
if ( V_155 )
return F_133 ( V_155 ) ;
return NULL ;
}
...
struct V_1 * V_2 )
{
struct V_51 * V_156 = F_135 ( & V_2 -> V_51 ) ;
if ( V_156 )
return F_133 ( V_156 ) ;
return NULL ;
}
