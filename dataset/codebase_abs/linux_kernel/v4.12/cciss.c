...
F_138 ( V_264 , F_137 ( V_264 ) -> V_273 ? - V_274 : 0 ) ;
F_11 ( & V_1 -> V_14 , V_13 ) ;
F_82 ( V_1 , V_2 ) ;
F_132 ( V_1 ) ;
F_13 ( & V_1 -> V_14 , V_13 ) ;
...
struct V_287 * V_405 = F_137 ( V_264 ) ;
V_405 -> V_273 = 0 ;
if ( V_404 )
V_405 -> V_273 = F_184 ( 0 , 0 , 0 , V_406 ) ;
if ( V_153 -> V_128 -> V_189 == 0 )
goto V_407;
switch ( V_153 -> V_128 -> V_189 ) {
case V_190 :
V_405 -> V_273 = F_185 ( V_1 , V_153 , & V_395 ) ;
break;
case V_360 :
if ( ! F_136 ( V_153 -> V_264 ) ) {
...
static inline T_11 F_188 ( T_11 V_411 )
{
#define F_189 0x10
return V_411 & F_189 ;
}
static inline T_11 F_190 ( T_11 V_411 )
{
#define F_191 5
return V_411 >> F_191 ;
}
static inline T_11 F_85 ( T_1 * V_1 , T_11 V_411 )
{
...
static inline void F_194 ( T_11 * V_411 )
{
* V_411 |= F_189 ;
}
static inline void F_195 ( T_11 * V_411 , T_11 V_412 )
{
* V_411 |= ( V_412 << F_191 ) ;
}
...
if ( ! V_415 )
goto V_420;
F_197 ( V_415 -> V_421 > V_1 -> V_298 ) ;
V_2 = F_75 ( V_1 ) ;
if ( ! V_2 )
goto V_422;
F_198 ( V_415 ) ;
V_417 = V_1 -> V_423 [ V_2 -> V_133 ] ;
F_199 ( V_329 -> V_290 ) ;
V_2 -> V_11 = V_424 ;
V_2 -> V_264 = V_415 ;
V_64 = V_415 -> V_425 -> V_76 ;
V_2 -> V_7 . V_230 = 0 ;
...
( F_200 ( V_415 ) == V_426 ) ? V_235 : V_227 ;
V_2 -> V_178 . V_340 = 0 ;
V_2 -> V_178 . V_336 [ 0 ] =
( F_200 ( V_415 ) == V_426 ) ? V_1 -> V_307 : V_1 -> V_309 ;
V_413 = F_201 ( V_415 ) ;
F_89 ( & V_1 -> V_24 -> V_25 , L_91 ,
( int ) F_201 ( V_415 ) , ( int ) F_202 ( V_415 ) ) ;
F_203 ( V_417 , V_1 -> V_298 ) ;
V_414 = F_204 ( V_329 , V_415 , V_417 ) ;
if ( V_2 -> V_178 . Type . V_225 == V_235 )
V_418 = V_270 ;
else
V_418 = V_38 ;
...
V_267 [ V_269 ] . V_37 = V_417 [ V_20 ] . V_78 ;
V_28 . V_36 = ( V_135 ) F_205 ( V_1 -> V_24 , F_206 ( & V_417 [ V_20 ] ) ,
V_417 [ V_20 ] . V_427 ,
...
if( V_1 -> V_307 == V_311 ) {
V_2 -> V_178 . V_336 [ 1 ] = 0 ;
V_2 -> V_178 . V_336 [ 2 ] = ( V_413 >> 24 ) & 0xff ;
V_2 -> V_178 . V_336 [ 3 ] = ( V_413 >> 16 ) & 0xff ;
V_2 -> V_178 . V_336 [ 4 ] = ( V_413 >> 8 ) & 0xff ;
V_2 -> V_178 . V_336 [ 5 ] = V_413 & 0xff ;
V_2 -> V_178 . V_336 [ 6 ] = 0 ;
V_2 -> V_178 . V_336 [ 7 ] = ( F_202 ( V_415 ) >> 8 ) & 0xff ;
V_2 -> V_178 . V_336 [ 8 ] = F_202 ( V_415 ) & 0xff ;
V_2 -> V_178 . V_336 [ 9 ] = V_2 -> V_178 . V_336 [ 11 ] = V_2 -> V_178 . V_336 [ 12 ] = 0 ;
} else {
T_11 V_431 = F_208 ( V_413 ) ;
V_2 -> V_178 . V_337 = 16 ;
V_2 -> V_178 . V_336 [ 1 ] = 0 ;
V_2 -> V_178 . V_336 [ 2 ] = ( V_431 >> 24 ) & 0xff ;
V_2 -> V_178 . V_336 [ 3 ] = ( V_431 >> 16 ) & 0xff ;
V_2 -> V_178 . V_336 [ 4 ] = ( V_431 >> 8 ) & 0xff ;
V_2 -> V_178 . V_336 [ 5 ] = V_431 & 0xff ;
V_2 -> V_178 . V_336 [ 6 ] = ( V_413 >> 24 ) & 0xff ;
V_2 -> V_178 . V_336 [ 7 ] = ( V_413 >> 16 ) & 0xff ;
V_2 -> V_178 . V_336 [ 8 ] = ( V_413 >> 8 ) & 0xff ;
V_2 -> V_178 . V_336 [ 9 ] = V_413 & 0xff ;
V_2 -> V_178 . V_336 [ 10 ] = ( F_202 ( V_415 ) >> 24 ) & 0xff ;
V_2 -> V_178 . V_336 [ 11 ] = ( F_202 ( V_415 ) >> 16 ) & 0xff ;
V_2 -> V_178 . V_336 [ 12 ] = ( F_202 ( V_415 ) >> 8 ) & 0xff ;
V_2 -> V_178 . V_336 [ 13 ] = F_202 ( V_415 ) & 0xff ;
V_2 -> V_178 . V_336 [ 14 ] = V_2 -> V_178 . V_336 [ 15 ] = 0 ;
}
break;
case V_432 :
case V_433 :
V_2 -> V_178 . V_337 = F_137 ( V_415 ) -> V_434 ;
memcpy ( V_2 -> V_178 . V_336 , F_137 ( V_415 ) -> V_153 , V_435 ) ;
F_137 ( V_415 ) -> V_436 = V_2 -> V_128 -> V_357 ;
break;
default:
...
{
return V_1 -> V_387 . V_439 ( V_1 ) ;
}
static inline long F_214 ( T_1 * V_1 )
{
return ( ( V_1 -> V_387 . V_439 ( V_1 ) == 0 ) ||
( V_1 -> V_440 == 0 ) ) ;
}
static inline int F_215 ( T_1 * V_1 , T_11 V_441 ,
T_11 V_442 )
{
if ( F_216 ( V_441 >= V_1 -> V_19 ) ) {
F_24 ( & V_1 -> V_24 -> V_25 , L_96 , V_442 ) ;
return 1 ;
}
return 0 ;
}
...
if ( V_1 -> V_445 == ( V_1 -> V_448 + V_1 -> V_449 ) ) {
V_1 -> V_445 = V_1 -> V_448 ;
V_1 -> V_446 ^= 1 ;
}
return V_444 ;
}
static inline T_11 F_221 ( T_1 * V_1 , T_11 V_442 )
{
T_11 V_441 ;
T_2 * V_2 ;
V_441 = F_190 ( V_442 ) ;
if ( F_215 ( V_1 , V_441 , V_442 ) )
return F_220 ( V_1 ) ;
V_2 = V_1 -> V_126 + V_441 ;
F_217 ( V_1 , V_2 , V_442 ) ;
return F_220 ( V_1 ) ;
}
static inline T_11 F_222 ( T_1 * V_1 , T_11 V_442 )
{
T_2 * V_2 = NULL ;
V_134 V_450 , V_451 ;
V_451 = F_85 ( V_1 , V_442 ) ;
F_223 (c, &h->cmpQ, list) {
V_450 = F_85 ( V_1 , V_2 -> V_5 ) ;
if ( V_450 == V_451 ) {
F_217 ( V_1 , V_2 , V_442 ) ;
return F_220 ( V_1 ) ;
}
}
F_215 ( V_1 , V_1 -> V_19 + 1 , V_442 ) ;
return F_220 ( V_1 ) ;
}
...
static T_36 F_225 ( int V_453 , void * V_454 )
{
T_1 * V_1 = V_454 ;
unsigned long V_13 ;
T_11 V_442 ;
...
static T_36 F_226 ( int V_453 , void * V_454 )
{
T_1 * V_1 = V_454 ;
unsigned long V_13 ;
T_11 V_442 ;
...
static T_36 F_227 ( int V_453 , void * V_454 )
{
T_1 * V_1 = V_454 ;
unsigned long V_13 ;
T_11 V_442 ;
...
while ( V_442 != V_447 ) {
if ( F_188 ( V_442 ) )
V_442 = F_221 ( V_1 , V_442 ) ;
else
V_442 = F_222 ( V_1 , V_442 ) ;
}
}
F_13 ( & V_1 -> V_14 , V_13 ) ;
return V_456 ;
}
static T_36 F_228 ( int V_453 , void * V_454 )
{
T_1 * V_1 = V_454 ;
unsigned long V_13 ;
T_11 V_442 ;
...
int V_20 ;
char V_474 [ 17 ] ;
T_37 * V_475 = V_1 -> V_201 ;
F_89 ( & V_1 -> V_24 -> V_25 , L_107 ) ;
F_89 ( & V_1 -> V_24 -> V_25 , L_108 ) ;
for ( V_20 = 0 ; V_20 < 4 ; V_20 ++ )
V_474 [ V_20 ] = F_117 ( & ( V_475 -> V_476 [ V_20 ] ) ) ;
V_474 [ 4 ] = '\0' ;
F_89 ( & V_1 -> V_24 -> V_25 , L_109 , V_474 ) ;
...
F_112 ( & ( V_475 -> V_202 . V_480 ) ) ) ;
F_89 ( & V_1 -> V_24 -> V_25 , L_114 ,
F_112 ( & ( V_475 -> V_202 . V_203 ) ) ) ;
F_89 ( & V_1 -> V_24 -> V_25 , L_115 ,
F_112 ( & ( V_475 -> V_202 . V_204 ) ) ) ;
F_89 ( & V_1 -> V_24 -> V_25 , L_116 ,
F_112 ( & ( V_475 -> V_481 ) ) ) ;
F_89 ( & V_1 -> V_24 -> V_25 , L_117 ,
F_112 ( & ( V_475 -> V_214 ) ) ) ;
for ( V_20 = 0 ; V_20 < 16 ; V_20 ++ )
V_474 [ V_20 ] = F_117 ( & ( V_475 -> V_211 [ V_20 ] ) ) ;
V_474 [ 16 ] = '\0' ;
F_89 ( & V_1 -> V_24 -> V_25 , L_118 , V_474 ) ;
F_89 ( & V_1 -> V_24 -> V_25 , L_119 ,
F_112 ( & ( V_475 -> V_213 ) ) ) ;
}
static int F_239 ( struct V_482 * V_24 , unsigned long V_483 )
{
int V_20 , V_427 , V_484 , V_485 ;
if ( V_483 == V_486 )
return 0 ;
V_427 = 0 ;
for ( V_20 = 0 ; V_20 < V_487 ; V_20 ++ ) {
V_485 = F_240 ( V_24 , V_20 ) & V_488 ;
if ( V_485 == V_489 )
V_427 += 4 ;
else {
V_484 = F_240 ( V_24 , V_20 ) &
V_490 ;
switch ( V_484 ) {
case V_491 :
case V_492 :
...
if ( V_427 == V_483 - V_486 )
return V_20 + 1 ;
}
return - 1 ;
}
static void F_241 ( int V_494 [] , int V_495 ,
int V_496 , int * V_497 )
{
int V_20 , V_22 , V_498 , V_332 ;
#define F_242 4
#define F_243 8
for ( V_20 = 0 ; V_20 <= V_496 ; V_20 ++ ) {
V_332 = V_20 + F_242 ;
V_498 = V_495 ;
...
static void F_246 ( T_1 * V_1 , T_11 V_500 )
{
V_134 V_501 ;
int V_502 [ 8 ] = { 5 , 6 , 8 , 10 , 12 , 20 , 28 , V_245 + 4 } ;
unsigned long V_503 ;
F_247 ( 28 > V_245 + 4 ) ;
V_1 -> V_446 = 1 ;
memset ( V_1 -> V_448 , 0 , V_1 -> V_449 * sizeof( V_135 ) ) ;
V_1 -> V_445 = V_1 -> V_448 ;
V_501 = F_112 ( & ( V_1 -> V_201 -> V_504 ) ) ;
F_241 ( V_502 , F_46 ( V_502 ) , V_1 -> V_298 ,
V_1 -> V_6 ) ;
F_114 ( V_502 [ 0 ] , & V_1 -> V_505 -> V_506 ) ;
F_114 ( V_502 [ 1 ] , & V_1 -> V_505 -> V_507 ) ;
F_114 ( V_502 [ 2 ] , & V_1 -> V_505 -> V_508 ) ;
F_114 ( V_502 [ 3 ] , & V_1 -> V_505 -> V_509 ) ;
F_114 ( V_502 [ 4 ] , & V_1 -> V_505 -> V_510 ) ;
F_114 ( V_502 [ 5 ] , & V_1 -> V_505 -> V_511 ) ;
F_114 ( V_502 [ 6 ] , & V_1 -> V_505 -> V_512 ) ;
F_114 ( V_502 [ 7 ] , & V_1 -> V_505 -> V_513 ) ;
F_114 ( V_1 -> V_449 , & V_1 -> V_505 -> V_514 ) ;
F_114 ( 1 , & V_1 -> V_505 -> V_515 ) ;
F_114 ( 0 , & V_1 -> V_505 -> V_516 ) ;
F_114 ( 0 , & V_1 -> V_505 -> V_517 ) ;
F_114 ( V_1 -> V_518 , & V_1 -> V_505 -> V_519 ) ;
F_114 ( 0 , & V_1 -> V_505 -> V_520 ) ;
F_114 ( V_4 | V_500 ,
& ( V_1 -> V_201 -> V_202 . V_480 ) ) ;
F_114 ( V_205 , V_1 -> V_206 + V_207 ) ;
F_244 ( V_1 ) ;
V_503 = F_112 ( & ( V_1 -> V_201 -> V_479 ) ) ;
if ( ! ( V_503 & V_4 ) )
...
V_1 -> V_448 = ( V_135 * ) F_249 (
V_1 -> V_24 , V_1 -> V_449 * sizeof( V_135 ) ,
& ( V_1 -> V_518 ) ) ;
V_1 -> V_6 = F_17 ( ( ( V_1 -> V_298 + 1 ) *
sizeof( V_134 ) ) , V_23 ) ;
if ( ( V_1 -> V_448 == NULL ) || ( V_1 -> V_6 == NULL ) )
goto V_524;
F_246 ( V_1 ,
V_521 & V_525 ) ;
V_1 -> V_387 = V_526 ;
...
V_74 = F_251 ( V_1 -> V_24 , 1 , 1 , V_529 ) ;
V_527:
V_1 -> V_51 [ V_1 -> V_52 ] = F_252 ( V_1 -> V_24 , 0 ) ;
return;
}
static int F_253 ( struct V_482 * V_24 , T_11 * V_49 )
{
int V_20 ;
T_11 V_530 , V_531 ;
V_530 = V_24 -> V_532 ;
V_531 = V_24 -> V_533 ;
* V_49 = ( ( V_531 << 16 ) & 0xffff0000 ) |
V_530 ;
for ( V_20 = 0 ; V_20 < F_46 ( V_534 ) ; V_20 ++ ) {
if ( V_535 )
return - V_536 ;
if ( * V_49 == V_534 [ V_20 ] . V_49 )
return V_20 ;
}
...
{
T_38 V_537 ;
( void ) F_255 ( V_1 -> V_24 , V_538 , & V_537 ) ;
return ( ( V_537 & V_539 ) == 0 ) ;
}
static int F_256 ( struct V_482 * V_24 ,
unsigned long * V_540 )
{
int V_20 ;
for ( V_20 = 0 ; V_20 < V_487 ; V_20 ++ )
if ( F_240 ( V_24 , V_20 ) & V_541 ) {
* V_540 = F_257 ( V_24 , V_20 ) ;
...
static int F_258 ( struct V_482 * V_24 ,
void T_34 * V_206 , int V_542 )
#define F_259 1
#define F_260 0
{
int V_20 , V_543 ;
...
V_543 = V_546 ;
for ( V_20 = 0 ; V_20 < V_543 ; V_20 ++ ) {
V_544 = F_112 ( V_206 + V_547 ) ;
if ( V_542 ) {
if ( V_544 == V_548 )
return 0 ;
} else {
...
static int F_262 ( struct V_482 * V_24 , void T_34 * V_206 ,
T_11 * V_550 , T_39 * V_551 ,
T_39 * V_552 )
{
* V_550 = F_112 ( V_206 + V_553 ) ;
* V_552 = F_112 ( V_206 + V_554 ) ;
* V_550 &= ( T_11 ) 0x0000ffff ;
* V_551 = F_239 ( V_24 , * V_550 ) ;
if ( * V_551 == - 1 ) {
...
T_11 V_501 ;
int V_278 ;
V_278 = F_262 ( V_1 -> V_24 , V_1 -> V_206 , & V_550 ,
& V_551 , & V_552 ) ;
if ( V_278 )
return V_278 ;
V_1 -> V_201 = F_180 ( F_257 ( V_1 -> V_24 ,
V_551 ) + V_552 , sizeof( * V_1 -> V_201 ) ) ;
if ( ! V_1 -> V_201 )
return - V_228 ;
...
return V_278 ;
V_501 = F_112 ( & V_1 -> V_201 -> V_504 ) ;
V_1 -> V_505 = F_180 ( F_257 ( V_1 -> V_24 ,
V_551 ) + V_552 + V_501 ,
sizeof( * V_1 -> V_505 ) ) ;
if ( ! V_1 -> V_505 )
return - V_228 ;
...
{
V_1 -> V_449 = F_112 ( & ( V_1 -> V_201 -> V_555 ) ) ;
if ( V_452 && V_1 -> V_449 > 32 )
V_1 -> V_449 = 32 ;
if ( V_1 -> V_449 < 16 ) {
...
{
F_265 ( V_1 ) ;
V_1 -> V_19 = V_1 -> V_449 - 4 - V_556 ;
V_1 -> V_298 = F_112 ( & ( V_1 -> V_201 -> V_557 ) ) ;
...
{
if ( ! F_268 ( V_1 -> V_201 -> V_476 , L_137 , 4 ) ) {
...
#ifdef F_270
T_11 V_558 ;
V_558 = F_112 ( & ( V_1 -> V_201 -> V_559 ) ) ;
V_558 |= 0x100 ;
F_114 ( V_558 , & ( V_1 -> V_201 -> V_559 ) ) ;
#endif
}
...
if ( V_1 -> V_49 != 0x3225103C )
return;
V_560 = F_112 ( V_1 -> V_206 + V_562 ) ;
V_560 |= 0x8000 ;
F_114 ( V_560 , V_1 -> V_206 + V_562 ) ;
F_272 ( V_1 -> V_24 , V_563 , & V_561 ) ;
V_561 |= 0x1 ;
F_273 ( V_1 -> V_24 , V_563 , V_561 ) ;
}
static int F_274 ( T_1 * V_1 )
{
int V_564 , V_80 ;
V_564 = F_253 ( V_1 -> V_24 , & V_1 -> V_49 ) ;
if ( V_564 < 0 )
return - V_536 ;
V_1 -> V_48 = V_534 [ V_564 ] . V_48 ;
V_1 -> V_387 = * ( V_534 [ V_564 ] . V_387 ) ;
if ( F_254 ( V_1 ) ) {
F_24 ( & V_1 -> V_24 -> V_25 , L_139 ) ;
return - V_536 ;
}
F_275 ( V_1 -> V_24 , V_565 |
V_566 | V_567 ) ;
V_80 = F_276 ( V_1 -> V_24 ) ;
if ( V_80 ) {
...
F_89 ( & V_1 -> V_24 -> V_25 , L_143 , V_1 -> V_24 -> V_453 ) ;
F_89 ( & V_1 -> V_24 -> V_25 , L_144 , V_1 -> V_49 ) ;
F_250 ( V_1 ) ;
V_80 = F_256 ( V_1 -> V_24 , & V_1 -> V_568 ) ;
if ( V_80 )
goto V_569;
V_1 -> V_206 = F_180 ( V_1 -> V_568 , 0x250 ) ;
if ( ! V_1 -> V_206 ) {
V_80 = - V_228 ;
goto V_569;
}
...
static int F_281 ( struct V_482 * V_24 )
{
int V_20 ;
for ( V_20 = 0 ; V_20 < V_570 ; V_20 ++ ) {
if ( ! V_266 [ V_20 ] ) {
T_1 * V_1 ;
...
static int F_283 ( struct V_482 * V_24 , unsigned char V_572 ,
unsigned char type )
{
typedef struct {
T_40 V_573 ;
...
static const T_10 V_575 = sizeof( T_43 ) + sizeof( V_130 ) ;
T_43 * V_153 ;
T_13 V_576 ;
T_28 V_577 , V_411 ;
void T_34 * V_206 ;
...
V_153 -> V_573 . V_8 = 0 ;
V_153 -> V_573 . V_29 = 0 ;
V_153 -> V_573 . V_232 . V_33 = V_577 ;
V_153 -> V_573 . V_232 . V_35 = 0 ;
memset ( & V_153 -> V_573 . V_231 . V_335 , 0 , 8 ) ;
V_153 -> V_178 . V_337 = 16 ;
V_153 -> V_178 . Type . Type = V_349 ;
V_153 -> V_178 . Type . V_338 = V_578 ;
V_153 -> V_178 . Type . V_225 = V_226 ;
V_153 -> V_178 . V_340 = 0 ;
V_153 -> V_178 . V_336 [ 0 ] = V_572 ;
V_153 -> V_178 . V_336 [ 1 ] = type ;
memset ( & V_153 -> V_178 . V_336 [ 2 ] , 0 , 14 ) ;
V_153 -> V_574 . V_34 . V_33 = V_577 + sizeof( T_43 ) ;
V_153 -> V_574 . V_34 . V_35 = 0 ;
V_153 -> V_574 . V_37 = sizeof( V_130 ) ;
F_114 ( V_577 , V_206 + V_579 ) ;
for ( V_20 = 0 ; V_20 < 10 ; V_20 ++ ) {
V_411 = F_112 ( V_206 + V_580 ) ;
if ( ( V_411 & ~ 3 ) == V_577 )
break;
F_261 ( V_581 ) ;
}
...
static int F_288 ( struct V_482 * V_24 ,
void * T_34 V_206 , T_11 V_583 )
{
T_38 V_584 ;
int V_57 ;
if ( V_583 ) {
F_178 ( & V_24 -> V_25 , L_151 ) ;
F_114 ( V_583 , V_206 + V_207 ) ;
} else {
V_57 = F_289 ( V_24 , V_585 ) ;
if ( V_57 == 0 ) {
F_18 ( & V_24 -> V_25 ,
L_152
L_153 ) ;
...
F_255 ( V_24 , V_57 + V_586 , & V_584 ) ;
V_584 &= ~ V_587 ;
V_584 |= V_588 ;
F_290 ( V_24 , V_57 + V_586 , V_584 ) ;
F_261 ( 500 ) ;
V_584 &= ~ V_587 ;
V_584 |= V_589 ;
F_290 ( V_24 , V_57 + V_586 , V_584 ) ;
...
static void F_291 ( char * V_590 , int V_40 )
{
memset ( V_590 , 0 , V_40 ) ;
strncpy ( V_590 , L_155 V_591 , V_40 - 1 ) ;
}
static int F_264 ( T_37 T_34 * V_201 )
{
char * V_590 ;
int V_20 , V_332 = sizeof( V_201 -> V_590 ) ;
V_590 = F_17 ( V_332 , V_23 ) ;
if ( ! V_590 )
return - V_228 ;
F_291 ( V_590 , V_332 ) ;
for ( V_20 = 0 ; V_20 < V_332 ; V_20 ++ )
F_119 ( V_590 [ V_20 ] , & V_201 -> V_590 [ V_20 ] ) ;
F_15 ( V_590 ) ;
return 0 ;
}
...
{
int V_20 ;
for ( V_20 = 0 ; V_20 < sizeof( V_201 -> V_590 ) ; V_20 ++ )
V_592 [ V_20 ] = F_117 ( & V_201 -> V_590 [ V_20 ] ) ;
}
static int F_293 ( T_37 T_34 * V_201 )
{
char * V_592 , * V_593 ;
int V_278 , V_332 = sizeof( V_201 -> V_590 ) ;
V_593 = F_17 ( 2 * V_332 , V_23 ) ;
if ( ! V_593 )
return - V_228 ;
V_592 = V_593 + V_332 ;
F_291 ( V_593 , V_332 ) ;
F_292 ( V_201 , V_592 ) ;
V_278 = ! memcmp ( V_592 , V_593 , V_332 ) ;
F_15 ( V_593 ) ;
return V_278 ;
}
static int F_294 ( struct V_482 * V_24 )
{
T_39 V_552 ;
T_11 V_550 ;
T_39 V_551 ;
...
F_295 ( V_24 ) ;
F_296 ( V_24 ) ;
V_278 = F_256 ( V_24 , & V_568 ) ;
if ( V_278 )
return V_278 ;
V_206 = F_180 ( V_568 , 0x250 ) ;
if ( ! V_206 )
return - V_228 ;
V_278 = F_262 ( V_24 , V_206 , & V_550 ,
& V_551 , & V_552 ) ;
if ( V_278 )
goto V_597;
V_201 = F_180 ( F_257 ( V_24 ,
V_551 ) + V_552 , sizeof( * V_201 ) ) ;
if ( ! V_201 ) {
V_278 = - V_228 ;
goto V_597;
}
...
static int F_298 ( struct V_482 * V_24 )
{
int V_278 , V_20 ;
if ( ! V_452 )
return 0 ;
...
T_36 (* F_307)( int , void * ) )
{
if ( V_1 -> V_24 -> V_605 || V_1 -> V_24 -> V_606 ) {
...
F_15 ( V_1 -> V_6 ) ;
if ( V_1 -> V_448 )
F_81 ( V_1 -> V_24 , V_1 -> V_449 * sizeof( V_135 ) ,
V_1 -> V_448 , V_1 -> V_518 ) ;
if ( V_1 -> V_505 )
F_279 ( V_1 -> V_505 ) ;
if ( V_1 -> V_201 )
...
static int F_314 ( struct V_482 * V_24 , const struct V_609 * V_610 )
{
int V_20 ;
int V_22 = 0 ;
int V_278 ;
...
static void F_324 ( struct V_482 * V_24 )
{
T_1 * V_1 ;
char * V_626 ;
int V_319 ;
...
if ( ! ( V_521 & V_627 ) )
return - V_596 ;
V_1 -> V_449 = F_112 ( & ( V_1 -> V_201 -> V_481 ) ) ;
F_114 ( V_628 , & ( V_1 -> V_201 -> V_202 . V_480 ) ) ;
F_114 ( V_205 , V_1 -> V_206 + V_207 ) ;
F_244 ( V_1 ) ;
F_238 ( V_1 ) ;
if ( ! ( F_112 ( & ( V_1 -> V_201 -> V_479 ) ) & V_628 ) ) {
...
static void F_326 ( struct V_482 * V_24 )
{
T_1 * V_1 ;
int V_20 , V_22 ;
if ( F_325 ( V_24 ) == NULL ) {
