...
struct V_208 * V_135 = (struct V_208 * ) V_6 -> V_5 . V_3 . V_28 [ V_205 ] . V_209 ;
struct V_23 * V_210 = V_6 -> V_5 . V_3 . V_210 ;
struct V_211 V_212 = F_114 ( V_200 ) ;
F_115 ( & V_210 -> V_213 ) ;
F_116 ( V_135 , & V_212 ) ;
F_117 ( & V_210 -> V_213 ) ;
return 0 ;
}
static int F_118 ( struct V_214 * V_214 , struct V_81 * V_215 )
{
struct V_1 * V_6 = V_214 -> V_216 ;
F_119 ( V_214 , V_6 -> V_39 . V_217 ) ;
V_215 -> V_87 = V_214 -> V_216 ;
return 0 ;
}
static T_3 F_120 ( struct V_81 * V_218 , char T_4 * V_219 ,
T_5 V_16 , T_6 * V_220 )
{
struct V_1 * V_6 = V_218 -> V_87 ;
T_3 V_221 = 0 ;
int V_11 ;
if ( V_16 & 0x3 || * V_220 & 0x3 )
return - V_46 ;
while ( V_16 ) {
unsigned long V_26 ;
T_1 V_222 ;
if ( * V_220 >= V_6 -> V_39 . V_217 )
return V_221 ;
F_121 ( & V_6 -> V_223 , V_26 ) ;
F_122 ( V_224 , ( ( T_1 ) * V_220 ) | 0x80000000 ) ;
if ( V_6 -> V_225 >= V_226 )
F_122 ( V_227 , * V_220 >> 31 ) ;
V_222 = F_123 ( V_228 ) ;
F_124 ( & V_6 -> V_223 , V_26 ) ;
V_11 = F_125 ( V_222 , ( T_1 * ) V_219 ) ;
if ( V_11 )
return V_11 ;
V_221 += 4 ;
V_219 += 4 ;
...
static int F_126 ( struct V_214 * V_214 , struct V_81 * V_215 )
{
struct V_1 * V_6 = V_214 -> V_216 ;
F_119 ( V_214 , V_6 -> V_39 . V_183 ) ;
V_215 -> V_87 = V_214 -> V_216 ;
return 0 ;
}
static T_3 F_127 ( struct V_81 * V_218 , char T_4 * V_219 ,
T_5 V_16 , T_6 * V_220 )
{
struct V_1 * V_6 = V_218 -> V_87 ;
T_3 V_221 = 0 ;
int V_11 ;
while ( V_16 ) {
T_6 V_212 = * V_220 / V_101 ;
unsigned V_229 = * V_220 & ~ V_230 ;
T_5 V_231 = F_128 ( T_5 , V_16 , V_101 - V_229 ) ;
struct V_144 * V_144 ;
void * V_232 ;
if ( V_212 >= V_6 -> V_233 . V_234 )
return V_221 ;
V_144 = V_6 -> V_233 . V_145 [ V_212 ] ;
if ( V_144 ) {
V_232 = F_129 ( V_144 ) ;
V_232 += V_229 ;
V_11 = F_130 ( V_219 , V_232 , V_231 ) ;
F_131 ( V_6 -> V_233 . V_145 [ V_212 ] ) ;
} else
V_11 = F_132 ( V_219 , V_231 ) ;
if ( V_11 )
return - V_175 ;
V_221 += V_231 ;
V_219 += V_231 ;
...
V_240 = F_134 ( L_17 , V_243 | V_244 , V_241 ,
V_6 , & V_245 ) ;
if ( F_27 ( V_240 ) )
return F_28 ( V_240 ) ;
V_6 -> V_5 . V_246 = V_240 ;
V_240 = F_134 ( L_18 , V_243 | V_244 , V_241 ,
V_6 , & V_247 ) ;
if ( F_27 ( V_240 ) )
return F_28 ( V_240 ) ;
V_6 -> V_5 . V_124 = V_240 ;
