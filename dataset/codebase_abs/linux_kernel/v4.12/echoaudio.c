...
V_152 -> V_63 = V_152 -> V_167 . V_168 [ 0 ] * V_152 -> V_167 . V_168 [ 1 ] ;
return 0 ;
}
...
unsigned int V_169 = V_158 -> V_170 . V_55 / F_121 ( V_4 ) ;
unsigned int V_171 = V_158 -> V_170 . V_55 % F_121 ( V_4 ) ;
if ( V_169 >= V_172 || V_171 >= V_173 )
return - V_111 ;
V_158 -> V_154 . integer . V_154 [ 0 ] = V_4 -> V_174 [ V_169 ] [ V_171 ] ;
return 0 ;
}
...
struct V_3 * V_4 ;
int V_160 , V_161 ;
unsigned int V_169 , V_171 ;
V_160 = 0 ;
V_4 = F_101 ( V_150 ) ;
V_169 = V_158 -> V_170 . V_55 / F_121 ( V_4 ) ;
...
if ( V_161 < V_155 || V_161 > V_156 )
return - V_111 ;
if ( V_4 -> V_174 [ V_169 ] [ V_171 ] != V_161 ) {
F_52 ( & V_4 -> V_93 ) ;
F_124 ( V_4 , V_169 , V_171 , V_161 ) ;
F_106 ( V_4 ) ;
F_56 ( & V_4 -> V_93 ) ;
V_160 = 1 ;
}
...
V_4 -> V_175 [ V_158 -> V_170 . V_55 / F_41 ( V_4 ) ]
...
V_160 = 0 ;
V_4 = F_101 ( V_150 ) ;
V_169 = V_158 -> V_170 . V_55 / F_41 ( V_4 ) ;
V_176 = V_158 -> V_170 . V_55 % F_41 ( V_4 ) ;
V_161 = V_158 -> V_154 . integer . V_154 [ 0 ] ;
if ( V_161 < V_155 || V_161 > V_156 )
return - V_111 ;
if ( V_4 -> V_175 [ V_169 ] [ V_176 ] != V_158 -> V_154 . integer . V_154 [ 0 ] ) {
F_52 ( & V_4 -> V_93 ) ;
F_128 ( V_4 , V_169 , V_176 , V_158 -> V_154 . integer . V_154 [ 0 ] ) ;
F_129 ( V_4 ) ;
F_56 ( & V_4 -> V_93 ) ;
V_160 = 1 ;
}
...
struct V_151 * V_152 )
{
static const char * const V_177 [ 4 ] = {
L_24 , L_25 , L_26 ,
L_27
} ;
struct V_3 * V_4 ;
V_4 = F_101 ( V_150 ) ;
return F_131 ( V_152 , 1 , V_4 -> V_178 , V_177 ) ;
}
...
V_4 = F_101 ( V_150 ) ;
V_179 = V_4 -> V_65 ;
for ( V_13 = V_4 -> V_178 - 1 ; V_13 >= 0 ; V_13 -- )
if ( V_179 == V_4 -> V_180 [ V_13 ] ) {
V_158 -> V_154 . V_181 . V_182 [ 0 ] = V_13 ;
break;
}
return 0 ;
}
...
struct V_3 * V_4 ;
int V_160 ;
unsigned short V_183 , V_184 ;
V_160 = 0 ;
V_4 = F_101 ( V_150 ) ;
V_183 = V_158 -> V_154 . V_181 . V_182 [ 0 ] ;
if ( V_183 >= V_4 -> V_178 )
return - V_111 ;
V_184 = V_4 -> V_180 [ V_183 ] ;
if ( V_184 != V_4 -> V_65 ) {
F_45 ( & V_4 -> V_80 ) ;
if ( F_38 ( & V_4 -> V_78 ) ) {
V_160 = - V_52 ;
} else {
V_160 = F_134 ( V_4 , V_184 ) ;
if ( V_160 > 0 && V_4 -> V_185 ) {
F_135 ( V_4 -> V_9 ,
V_186 ,
& V_4 -> V_185 -> V_170 ) ;
F_3 ( V_4 -> V_9 -> V_10 ,
...
struct V_151 * V_152 )
{
static const char * const V_177 [ 2 ] = { L_29 , L_30 } ;
return F_131 ( V_152 , 1 , 2 , V_177 ) ;
}
...
struct V_3 * V_4 ;
V_4 = F_101 ( V_150 ) ;
V_158 -> V_154 . V_181 . V_182 [ 0 ] = ! ! V_4 -> V_187 ;
return 0 ;
}
...
int V_179 ;
V_4 = F_101 ( V_150 ) ;
V_179 = ! ! V_158 -> V_154 . V_181 . V_182 [ 0 ] ;
if ( V_179 != V_4 -> V_187 ) {
F_52 ( & V_4 -> V_93 ) ;
F_139 ( V_4 , V_179 ) ;
F_56 ( & V_4 -> V_93 ) ;
...
struct V_151 * V_152 )
{
static const char * const V_177 [ 8 ] = {
L_31 , L_32 , L_33 , L_34 , L_35 , L_36 ,
L_37 , L_38
} ;
struct V_3 * V_4 ;
V_4 = F_101 ( V_150 ) ;
return F_131 ( V_152 , 1 , V_4 -> V_188 , V_177 ) ;
}
...
V_4 = F_101 ( V_150 ) ;
clock = V_4 -> V_189 ;
for ( V_13 = 0 ; V_13 < V_4 -> V_188 ; V_13 ++ )
...
V_160 = 0 ;
V_4 = F_101 ( V_150 ) ;
V_191 = V_158 -> V_154 . V_181 . V_182 [ 0 ] ;
if ( V_191 >= V_4 -> V_193 )
return - V_111 ;
V_192 = V_4 -> V_190 [ V_191 ] ;
if ( V_4 -> V_189 != V_192 ) {
F_45 ( & V_4 -> V_80 ) ;
F_52 ( & V_4 -> V_93 ) ;
if ( ( V_160 = F_143 ( V_4 , V_192 ) ) == 0 )
V_160 = 1 ;
F_56 ( & V_4 -> V_93 ) ;
F_46 ( & V_4 -> V_80 ) ;
}
...
{
struct V_3 * V_4 = F_101 ( V_150 ) ;
V_158 -> V_154 . integer . V_154 [ 0 ] = V_4 -> V_196 ;
return 0 ;
}
...
struct V_3 * V_4 = F_101 ( V_150 ) ;
int V_197 , V_160 = 0 ;
V_197 = ! ! V_158 -> V_154 . integer . V_154 [ 0 ] ;
if ( V_4 -> V_196 != V_197 ) {
F_52 ( & V_4 -> V_93 ) ;
V_160 = F_149 ( V_4 , V_197 ) ;
F_56 ( & V_4 -> V_93 ) ;
if ( V_160 == 0 )
V_160 = 1 ;
}
...
V_152 -> V_63 = V_152 -> V_167 . V_168 [ 0 ] * V_152 -> V_167 . V_168 [ 1 ] * V_152 -> V_167 . V_168 [ 2 ] ;
return 0 ;
}
...
V_152 -> V_63 = 6 ;
V_152 -> V_154 . integer . V_32 = 0 ;
V_152 -> V_154 . integer . V_37 = 1 << V_198 ;
return 0 ;
}
...
V_200 = 0 ;
V_202 = V_4 -> V_188 - 1 ;
for ( V_201 = V_198 - 1 ; V_201 >= 0 ; V_201 -- )
if ( V_199 & ( 1 << V_201 ) )
for (; V_202 >= 0 ; V_202 -- )
if ( V_201 == V_4 -> V_190 [ V_202 ] ) {
V_200 |= 1 << V_202 ;
break;
}
V_158 -> V_154 . integer . V_154 [ 5 ] = V_200 ;
return 0 ;
}
static T_5 F_158 ( int V_203 , void * V_204 )
{
struct V_3 * V_4 = V_204 ;
struct V_49 * V_50 ;
int V_205 , V_135 , V_206 ;
F_85 ( & V_4 -> V_93 ) ;
V_206 = F_159 ( V_4 ) ;
if ( V_206 < 0 ) {
F_89 ( & V_4 -> V_93 ) ;
...
V_205 = F_90 ( V_50 ) /
V_50 -> V_15 -> V_208 ;
if ( V_205 != V_4 -> V_95 [ V_135 ] ) {
V_4 -> V_95 [ V_135 ] = V_205 ;
F_89 ( & V_4 -> V_93 ) ;
F_160 ( V_50 ) ;
F_85 ( & V_4 -> V_93 ) ;
}
...
F_89 ( & V_4 -> V_93 ) ;
#ifdef F_161
if ( V_206 > 0 && V_4 -> V_209 ) {
F_162 ( V_4 -> V_209 , V_4 -> V_210 , V_206 ) ;
F_3 ( V_4 -> V_9 -> V_10 , L_40 , V_206 ) ;
}
#endif
return V_211 ;
}
...
static int F_169 ( struct V_216 * V_134 )
{
struct V_3 * V_4 = V_134 -> V_217 ;
return F_163 ( V_4 ) ;
}
static int F_170 ( struct V_218 * V_9 ,
struct V_219 * V_75 ,
struct V_3 * * V_220 )
{
struct V_3 * V_4 ;
int V_6 ;
T_4 V_221 ;
static struct V_222 V_223 = {
. V_224 = F_169 ,
} ;
* V_220 = NULL ;
F_171 ( V_75 , V_225 , 0xC0 ) ;
if ( ( V_6 = F_172 ( V_75 ) ) < 0 )
return V_6 ;
F_173 ( V_75 ) ;
if ( ! * V_220 ) {
...
V_4 -> V_226 = F_177 ( V_75 , 0 ) ;
V_221 = F_178 ( V_75 , 0 ) ;
if ( V_221 > V_76 )
V_221 = V_76 ;
if ( ( V_4 -> V_215 = F_179 ( V_4 -> V_226 , V_221 ,
V_227 ) ) == NULL ) {
F_6 ( V_4 -> V_9 -> V_10 , L_42 ) ;
F_163 ( V_4 ) ;
return - V_228 ;
}
V_4 -> V_214 = ( volatile V_42 V_229 * )
F_180 ( V_4 -> V_226 , V_221 ) ;
if ( F_181 ( V_75 -> V_203 , F_158 , V_230 ,
V_231 , V_4 ) ) {
F_6 ( V_4 -> V_9 -> V_10 , L_43 ) ;
F_163 ( V_4 ) ;
return - V_228 ;
}
V_4 -> V_203 = V_75 -> V_203 ;
F_3 ( V_9 -> V_10 , L_44 ,
V_4 -> V_75 , V_4 -> V_203 , V_4 -> V_75 -> V_232 ) ;
...
V_4 -> V_233 = V_4 -> V_213 . V_94 ;
V_4 -> V_212 = (struct V_212 * ) V_4 -> V_213 . V_20 ;
V_6 = F_182 ( V_4 , V_4 -> V_75 -> V_134 , V_4 -> V_75 -> V_232 ) ;
if ( V_6 >= 0 )
V_6 = F_183 ( V_4 ) ;
if ( V_6 < 0 ) {
...
if ( ( V_6 = F_184 ( V_9 , V_234 , V_4 , & V_223 ) ) < 0 ) {
F_163 ( V_4 ) ;
return V_6 ;
}
* V_220 = V_4 ;
...
static int F_185 ( struct V_219 * V_75 ,
...
V_13 = 0 ;
V_6 = F_186 ( & V_75 -> V_10 , V_55 [ V_10 ] , V_170 [ V_10 ] , V_242 ,
0 , & V_9 ) ;
if ( V_6 < 0 )
return V_6 ;
V_4 = NULL ;
...
strcpy ( V_9 -> V_243 , L_47 V_227 ) ;
strcpy ( V_9 -> V_141 , V_4 -> V_244 ) ;
V_237 = L_48 ;
if ( V_236 -> V_134 == 0x3410 )
V_237 = L_49 ;
sprintf ( V_9 -> V_245 , L_50 ,
V_9 -> V_141 , V_236 -> V_246 & 0x000f , V_237 ,
V_4 -> V_226 , V_4 -> V_203 ) ;
if ( ( V_6 = F_96 ( V_4 ) ) < 0 ) {
...
#endif
#ifdef F_40
V_248 . V_63 = F_41 ( V_4 ) * F_102 ( V_4 ) ;
if ( ( V_6 = F_189 ( V_4 -> V_9 , F_190 ( & V_248 , V_4 ) ) ) < 0 )
goto V_249;
#ifdef F_191
V_6 = F_189 ( V_4 -> V_9 ,
F_190 ( & V_250 , V_4 ) ) ;
...
goto V_249;
#ifdef F_195
V_258 . V_63 = F_121 ( V_4 ) * F_102 ( V_4 ) ;
if ( ( V_6 = F_189 ( V_4 -> V_9 , F_190 ( & V_258 , V_4 ) ) ) < 0 )
goto V_249;
#endif
#ifdef F_196
if ( ( V_6 = F_189 ( V_4 -> V_9 , F_190 ( & V_259 , V_4 ) ) ) < 0 )
goto V_249;
#endif
...
if ( V_4 -> V_193 & ( 1 << V_13 ) )
V_4 -> V_190 [ V_4 -> V_188 ++ ] = V_13 ;
if ( V_4 -> V_188 > 1 ) {
V_4 -> V_185 = F_190 ( & V_263 , V_4 ) ;
if ( ( V_6 = F_189 ( V_4 -> V_9 , V_4 -> V_185 ) ) < 0 )
goto V_249;
}
#endif
#ifdef F_99
...
#ifdef F_199
if ( V_4 -> V_265 )
if ( ( V_6 = F_189 ( V_4 -> V_9 , F_190 ( & V_266 , V_4 ) ) ) < 0 )
goto V_249;
#endif
V_6 = F_200 ( V_9 ) ;
if ( V_6 < 0 )
goto V_249;
F_201 ( V_9 -> V_10 , L_53 , V_9 -> V_245 ) ;
F_202 ( V_75 , V_4 ) ;
V_10 ++ ;
return 0 ;
V_249:
...
static int F_210 ( struct V_134 * V_10 )
{
struct V_219 * V_75 = F_211 ( V_10 ) ;
struct V_3 * V_4 = F_204 ( V_10 ) ;
struct V_212 * V_271 , * V_272 ;
V_42 V_273 ;
int V_6 ;
V_272 = F_212 ( sizeof( * V_271 ) , V_53 ) ;
if ( V_272 == NULL )
return - V_54 ;
V_271 = V_4 -> V_212 ;
memcpy ( V_272 , V_271 , sizeof( * V_271 ) ) ;
V_6 = F_182 ( V_4 , V_4 -> V_75 -> V_134 , V_4 -> V_75 -> V_232 ) ;
if ( V_6 < 0 ) {
F_12 ( V_272 ) ;
F_6 ( V_10 , L_55 , V_6 ) ;
...
memcpy ( & V_271 -> V_274 , & V_272 -> V_274 ,
sizeof( V_271 -> V_274 ) ) ;
memcpy ( & V_271 -> V_275 , & V_272 -> V_275 ,
sizeof( V_271 -> V_275 ) ) ;
memcpy ( & V_271 -> V_276 , & V_272 -> V_276 ,
sizeof( V_271 -> V_276 ) ) ;
F_12 ( V_272 ) ;
if ( F_181 ( V_75 -> V_203 , F_158 , V_230 ,
V_231 , V_4 ) ) {
...
static void F_215 ( struct V_219 * V_75 )
{
struct V_3 * V_4 ;
V_4 = F_216 ( V_75 ) ;
if ( V_4 )
