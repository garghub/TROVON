...
F_45 ( F_127 ( & V_5 -> V_141 ) ) ;
F_128 ( & V_5 -> V_141 , & V_129 ) ;
exp = V_5 -> V_11 ;
if ( F_129 ( exp ) ) {
V_114 = F_68 ( F_85 ( exp ) ,
& V_186 ,
...
int F_130 ( struct V_128 * V_129 , int V_130 ,
enum V_181 V_32 )
{
F_71 ( V_135 ) ;
...
static enum V_221
F_133 ( struct V_46 * V_47 , struct V_4 * V_5 ,
...
static enum V_221 F_135 ( struct V_46 * V_47 ,
struct V_4 * V_5 ,
int V_222 , int V_223 ,
int V_130 )
{
...
return V_233 ;
if ( F_5 ( F_6 () ,
F_136 ( V_5 -> V_234 , V_47 -> V_235 ) ) )
return V_224 ;
V_229 = F_137 ( V_228 ) ;
V_230 = F_138 ( V_228 ) ;
V_232 = F_139 ( F_140 ( V_227 , V_5 -> V_234 ) ) ;
...
static enum V_221 F_142 ( struct V_46 * V_47 ,
struct V_4 * V_5 ,
int V_222 , int V_223 ,
int V_130 )
{
...
static enum V_221 F_143 ( struct V_46 * V_47 ,
struct V_4 * V_5 ,
int V_222 , int V_223 ,
int V_130 )
{
...
{
enum V_221 V_30 ;
V_30 = F_135 ( V_47 , V_5 , V_222 , V_223 , V_130 ) ;
if ( V_30 == V_233 )
return V_30 ;
return F_133 ( V_47 , V_5 , V_222 , V_223 , V_130 ) ;
}
static enum V_221
F_146 ( struct V_46 * V_47 , struct V_4 * V_5 ,
int V_222 , int V_223 , int V_130 )
{
return ( V_223 >= V_130 ) ?
V_233 : V_224 ;
...
static T_5
F_147 ( struct V_46 * V_47 , int V_32 )
{
if ( V_32 & V_236 )
return F_133 ;
if ( F_74 ( V_47 ) ) {
...
static int F_148 ( struct V_46 * V_47 ,
...
V_239 = F_147 ( V_47 , V_32 ) ;
F_45 ( V_239 ) ;
while ( ! F_127 ( & V_47 -> V_245 ) ) {
enum V_221 V_30 ;
T_6 V_246 = 0 ;
if ( V_240 -- <= 0 )
break;
...
{
int V_223 ;
V_223 = F_148 ( V_47 , V_129 , V_130 , F_16 , V_32 ) ;
if ( V_223 <= 0 )
return V_223 ;
return F_130 ( V_129 , V_223 , V_214 ) ;
}
int F_156 ( struct V_46 * V_47 , int V_253 ,
enum V_181 V_214 ,
int V_32 )
{
F_71 ( V_129 ) ;
int V_130 , V_38 ;
V_130 = F_148 ( V_47 , & V_129 , V_253 , 0 , V_32 ) ;
V_38 = F_157 ( V_47 , NULL , & V_129 , V_130 , V_214 ) ;
if ( V_38 == 0 )
return V_130 ;
return 0 ;
}
...
F_161 ( V_255 ) ;
return F_130 ( V_129 , V_130 , V_214 ) ;
}
...
struct V_4 * V_5 ;
int V_255 = 0 ;
if ( F_127 ( V_129 ) || V_130 == 0 )
return 0 ;
while ( V_130 > 0 ) {
F_45 ( ! F_127 ( V_129 ) ) ;
V_5 = F_162 ( V_129 -> V_218 , struct V_4 , V_141 ) ;
F_45 ( V_5 -> V_11 ) ;
if ( F_129 ( V_5 -> V_11 ) ) {
V_255 = V_130 ;
if ( V_62 )
...
int V_130 ;
int V_38 ;
V_255 = F_164 ( V_47 , NULL , V_150 , 0 , 0 ) ;
if ( F_92 ( V_255 ) ) {
F_54 ( V_94 , L_45 , V_150 -> V_260 [ 0 ] ) ;
return 0 ;
}
F_165 ( V_255 ) ;
V_130 = F_158 ( V_255 , & V_129 , V_152 , V_48 ,
0 , V_32 | V_217 , V_256 ) ;
V_38 = F_81 ( & V_129 , V_130 , NULL , V_32 ) ;
if ( V_38 != V_78 )
F_166 ( L_46 V_101 L_47 ,
F_56 ( V_255 ) , V_38 ) ;
F_167 ( V_255 ) ;
F_168 ( V_255 ) ;
return 0 ;
...
V_5 = F_162 ( V_276 , struct V_4 , V_278 ) ;
...
static int F_176 ( struct V_4 * V_5 , void * V_275 )
{
...
return 0 ;
F_165 ( V_255 ) ;
V_38 = F_174 ( V_255 , V_274 , V_1 ) ;
F_167 ( V_255 ) ;
F_168 ( V_255 ) ;
return V_38 ;
}
static int F_180 ( struct V_4 * V_5 , void * V_275 )
{
struct V_128 * V_282 = V_275 ;
F_46 ( F_127 ( & V_5 -> V_283 ) ,
L_49 ,
V_5 , & V_5 -> V_283 . V_218 ,
& V_5 -> V_283 . V_284 ) ;
if ( ! ( V_5 -> V_52 & ( V_54 | V_285 ) ) ) {
F_128 ( & V_5 -> V_283 , V_282 ) ;
F_151 ( V_5 ) ;
}
return V_277 ;
}
...
V_32 = V_72 | V_296 ;
else if ( ! F_127 ( & V_5 -> V_278 ) )
V_32 = V_72 | V_297 ;
else
V_32 = V_72 ;
V_62 = F_189 ( V_8 , & V_145 ,
V_143 , V_139 ) ;
if ( ! V_62 )
return - V_102 ;
V_62 -> V_298 = V_299 ;
...
if ( V_5 -> V_77 > 0 )
F_190 ( & V_62 -> V_81 , & V_300 ) ;
F_76 ( & V_62 -> V_81 , & V_85 , V_86 ,
V_5 -> V_77 ) ;
F_88 ( V_62 ) ;
F_191 ( V_62 -> V_301 , V_302 ) ;
F_20 ( V_5 , L_54 ) ;
F_192 ( & V_62 -> V_196 -> V_290 ) ;
F_193 ( sizeof( * V_289 ) > sizeof( V_62 -> V_303 ) ) ;
V_289 = F_194 ( V_62 ) ;
V_289 -> V_90 = V_155 -> V_90 [ 0 ] ;
V_62 -> V_304 = ( V_305 ) F_181 ;
F_112 ( V_62 ) ;
return 0 ;
}
static void F_195 ( struct V_46 * V_47 )
{
int V_306 ;
F_71 ( V_129 ) ;
F_54 ( V_16 , L_55 ,
F_196 ( V_47 ) , V_47 -> V_243 ) ;
...
struct V_4 * V_5 , * V_218 ;
int V_38 = 0 ;
F_45 ( F_198 ( & V_8 -> V_290 ) == 0 ) ;
if ( V_8 -> V_307 )
return 0 ;
F_192 ( & V_8 -> V_290 ) ;
if ( V_308 )
F_195 ( V_47 ) ;
F_178 ( V_47 , F_180 , & V_282 ) ;
