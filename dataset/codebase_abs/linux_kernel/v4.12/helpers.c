...
if ( ! V_3 )
V_3 = V_2 -> V_6 -> V_44 ;
return F_4 ( V_2 -> V_5 , V_2 -> V_6 -> V_45 ,
V_2 -> V_6 -> V_44 , V_3 ) ;
}
...
if ( ! V_3 )
V_3 = V_2 -> V_6 -> V_47 ;
return F_4 ( V_2 -> V_5 , V_2 -> V_6 -> V_48 ,
V_2 -> V_6 -> V_47 , V_3 ) ;
}
int F_21 ( struct V_1 * V_2 , bool * V_38 )
{
unsigned int V_3 ;
unsigned int V_49 = V_2 -> V_6 -> V_39 ;
int V_4 ;
