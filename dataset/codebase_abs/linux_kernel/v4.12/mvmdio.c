...
V_6 -> V_17 = & V_40 -> V_2 ;
V_2 = V_6 -> V_7 ;
V_2 -> V_3 = F_20 ( & V_40 -> V_2 , V_42 -> V_51 , F_21 ( V_42 ) ) ;
if ( ! V_2 -> V_3 ) {
F_8 ( & V_40 -> V_2 , L_6 ) ;
return - V_29 ;
}
F_22 ( & V_2 -> V_16 ) ;
for ( V_43 = 0 ; V_43 < F_23 ( V_2 -> V_52 ) ; V_43 ++ ) {
V_2 -> V_52 [ V_43 ] = F_24 ( V_40 -> V_2 . V_53 , V_43 ) ;
if ( F_25 ( V_2 -> V_52 [ V_43 ] ) )
break;
F_26 ( V_2 -> V_52 [ V_43 ] ) ;
}
...
F_11 ( V_36 ,
V_2 -> V_3 + V_54 ) ;
} else if ( V_2 -> V_13 == - V_57 ) {
return - V_57 ;
}
F_29 ( & V_2 -> V_23 ) ;
if ( V_40 -> V_2 . V_53 )
V_22 = F_30 ( V_6 , V_40 -> V_2 . V_53 ) ;
else
V_22 = F_31 ( V_6 ) ;
if ( V_22 < 0 ) {
