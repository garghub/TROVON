...
struct V_10 * V_11 = F_6 ( V_9 ) ;
F_143 ( F_6 ( V_9 ) ) ;
if ( F_108 ( V_11 ) || F_7 ( V_11 ) )
return 0 ;
F_144 ( V_124 ) ;
return F_145 ( V_124 , V_170 , F_135 ) ;
}
STATIC int
F_146 (
struct V_171 * V_172 ,
...
unsigned V_174 )
{
F_150 ( V_124 -> V_126 , V_174 ) ;
return F_151 ( V_124 , V_173 , V_174 , F_135 ) ;
}
STATIC int
F_152 (
struct V_1 * V_1 )
...
F_162 ( & V_124 -> V_177 , V_144 ) ;
}
F_163 ( V_1 ) ;
if ( V_175 )
F_164 ( V_124 -> V_126 , V_180 ) ;
return V_175 ;
}
