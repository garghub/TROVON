...
if ( V_370 -> V_386 )
memcpy ( F_28 ( V_382 , V_370 -> V_386 ) , V_370 -> V_388 ,
V_370 -> V_386 ) ;
F_39 () ;
...
static int F_165 ( struct V_86 * V_51 ,
struct V_1 * V_2 ,
struct V_389 * V_390 )
{
struct V_47 * V_336 = V_51 -> V_87 ;
...
F_137 ( & V_336 -> V_292 ) ;
F_20 ( V_51 -> V_27 , L_34 ) ;
F_163 ( V_336 -> V_51 , & V_336 -> V_368 , 0 ) ;
return 0 ;
}
static void F_167 ( struct V_86 * V_51 ,
struct V_1 * V_2 )
{
struct V_47 * V_336 = V_51 -> V_87 ;
struct V_375 V_99 = {
...
static void F_172 ( struct V_366 * V_367 )
{
struct V_47 * V_336 =
...
F_173 ( V_336 -> V_51 ) ;
F_163 ( V_336 -> V_51 , & V_336 -> V_397 ,
F_164 ( V_336 -> V_398 ) ) ;
F_137 ( & V_336 -> V_292 ) ;
}
static void F_174 ( struct V_366 * V_367 )
{
struct V_47 * V_336 =
...
F_20 ( V_51 -> V_27 , L_41 ,
V_62 -> V_118 , V_399 ) ;
F_163 ( V_51 , & V_336 -> V_395 , V_401 / 50 ) ;
return 0 ;
}
...
static int F_181 ( struct V_86 * V_51 ,
struct V_1 * V_2 ,
struct V_15 * V_402 )
{
F_1 ( V_2 ) ;
...
static int F_184 ( struct V_86 * V_51 ,
...
static void F_185 ( struct V_86 * V_51 ,
struct V_1 * V_2 ,
...
static void F_186 ( struct V_32 * V_410 ,
struct V_411 * V_99 )
{
if ( V_99 )
F_187 ( & V_158 , V_410 , V_99 ,
V_412 , V_43 ) ;
else
F_188 ( & V_158 , V_410 , 0 ,
V_412 , V_43 ) ;
}
static int F_189 ( struct V_32 * V_33 , int V_413 ,
struct V_414 * V_415 )
{
int V_137 ;
...
if ( V_415 -> V_423 ) {
V_137 = F_190 ( V_33 , V_424 ) ;
if ( V_137 < 0 )
return V_137 ;
}
if ( V_415 -> V_425 ) {
V_137 = F_190 ( V_33 , V_426 ) ;
if ( V_137 < 0 )
return V_137 ;
}
if ( V_415 -> V_242 ) {
V_137 = F_190 ( V_33 , V_427 ) ;
if ( V_137 < 0 )
return V_137 ;
}
if ( V_415 -> V_428 ) {
...
static void F_191 ( int V_413 , struct V_411 * V_99 ,
struct V_414 * V_415 )
{
struct V_32 * V_410 ;
void * V_30 ;
...
static int F_193 ( struct V_411 * V_99 ,
struct V_414 * V_415 )
{
int V_37 ;
T_2 V_8 [ V_58 ] ;
...
if ( V_415 -> V_242 )
V_434 = & V_437 ;
V_51 = F_196 ( sizeof( * V_30 ) , V_434 , V_415 -> V_428 ) ;
if ( ! V_51 ) {
F_81 ( V_160 L_46 ) ;
V_37 = - V_44 ;
goto V_438;
}
V_415 -> V_428 = F_197 ( V_51 -> V_27 ) ;
if ( V_99 )
V_20 = F_198 ( V_99 ) ;
else
V_20 = & V_439 ;
F_199 ( V_51 -> V_27 , V_20 ) ;
V_30 = V_51 -> V_87 ;
V_30 -> V_51 = V_51 ;
V_30 -> V_82 = F_200 ( V_440 , NULL , 0 , V_51 , L_47 , V_172 ) ;
if ( F_201 ( V_30 -> V_82 ) ) {
F_81 ( V_160
L_48 ,
F_202 ( V_30 -> V_82 ) ) ;
...
F_206 ( & V_30 -> V_395 , F_172 ) ;
F_206 ( & V_30 -> V_397 , F_174 ) ;
F_206 ( & V_30 -> V_368 , F_160 ) ;
V_51 -> V_364 = 5 ;
V_51 -> V_459 = 4 ;
...
F_210 ( V_51 -> V_27 , V_415 -> V_420 ) ;
F_211 ( 1 ) ;
}
if ( V_415 -> V_544 )
F_207 ( V_51 , V_545 ) ;
F_208 ( V_51 -> V_27 , V_546 ) ;
V_37 = F_212 ( V_51 ) ;
if ( V_37 < 0 ) {
F_81 ( V_160 L_50 ,
V_37 ) ;
...
F_213 ( V_51 -> V_27 , V_415 -> V_418 ) ;
}
V_30 -> V_550 = F_214 ( L_52 , V_51 -> V_27 -> V_551 ) ;
F_215 ( L_53 , 0666 , V_30 -> V_550 , V_30 , & V_552 ) ;
F_215 ( L_54 , 0666 , V_30 -> V_550 , V_30 ,
& V_553 ) ;
if ( ! V_30 -> V_242 )
F_215 ( L_55 , 0222 ,
V_30 -> V_550 ,
...
V_555 , V_273 ) ;
F_194 ( & V_228 ) ;
F_217 ( & V_30 -> V_556 , & V_557 ) ;
F_195 ( & V_228 ) ;
if ( V_172 > 0 )
F_191 ( V_172 , V_99 , V_415 ) ;
return V_172 ;
V_547:
F_218 ( V_30 -> V_82 ) ;
V_444:
...
static void F_221 ( int V_413 , const char * V_428 ,
struct V_411 * V_99 )
{
struct V_32 * V_33 ;
void * V_30 ;
...
static void F_222 ( struct V_47 * V_30 ,
const char * V_428 ,
struct V_411 * V_99 )
{
F_221 ( V_30 -> V_172 , V_428 , V_99 ) ;
F_223 ( V_30 -> V_550 ) ;
F_224 ( V_30 -> V_51 ) ;
F_218 ( V_30 -> V_82 ) ;
F_219 ( V_30 -> V_82 ) ;
...
static int F_225 ( struct V_32 * V_33 ,
struct V_47 * V_30 ,
T_1 V_26 , T_1 V_559 ,
...
V_415 . V_428 = F_197 ( V_30 -> V_51 -> V_27 ) ;
V_141 = F_189 ( V_33 , V_30 -> V_172 , & V_415 ) ;
if ( V_141 < 0 )
goto V_431;
F_84 ( V_33 , V_65 ) ;
return 0 ;
...
struct V_47 * V_30 ;
F_194 ( & V_228 ) ;
while ( ( V_30 = F_228 ( & V_557 ,
struct V_47 ,
V_556 ) ) ) {
F_229 ( & V_30 -> V_556 ) ;
F_195 ( & V_228 ) ;
F_222 ( V_30 , F_197 ( V_30 -> V_51 -> V_27 ) ,
NULL ) ;
F_194 ( & V_228 ) ;
}
F_195 ( & V_228 ) ;
...
static struct V_47 * F_233 ( const T_2 * V_8 )
{
struct V_47 * V_30 ;
bool V_570 = false ;
F_194 ( & V_228 ) ;
...
static void F_234 ( struct V_20 * V_20 , T_1 V_26 )
{
struct V_47 * V_30 ;
F_16 ( V_20 , V_26 ) ;
F_194 ( & V_228 ) ;
...
static int F_235 ( struct V_32 * V_571 ,
struct V_411 * V_99 )
{
struct V_64 * V_65 ;
struct V_47 * V_198 ;
...
! V_99 -> V_575 [ V_176 ] )
goto V_272;
V_574 = ( void * ) F_236 ( V_99 -> V_575 [ V_161 ] ) ;
V_146 = F_19 ( V_99 -> V_575 [ V_169 ] ) ;
V_572 = F_237 ( V_99 -> V_575 [ V_179 ] ) ;
V_198 = F_233 ( V_574 ) ;
if ( ! V_198 )
goto V_272;
if ( F_12 ( F_198 ( V_99 ) ) != V_198 -> V_23 )
goto V_272;
if ( V_99 -> V_447 != V_198 -> V_25 )
goto V_272;
F_238 (&data2->pending, skb, tmp) {
T_3 V_577 ;
V_240 = F_58 ( V_33 ) ;
V_577 = ( T_3 ) ( T_7 ) V_240 -> V_178 [ 0 ] ;
if ( V_577 == V_572 ) {
F_239 ( V_33 , & V_198 -> V_152 ) ;
V_140 = true ;
break;
}
}
...
static int F_240 ( struct V_32 * V_571 ,
struct V_411 * V_99 )
{
struct V_47 * V_198 ;
struct V_200 V_201 ;
...
! V_99 -> V_575 [ V_576 ] )
goto V_272;
V_580 = ( void * ) F_236 ( V_99 -> V_575 [ V_583 ] ) ;
V_581 = F_241 ( V_99 -> V_575 [ V_163 ] ) ;
V_582 = ( void * ) F_236 ( V_99 -> V_575 [ V_163 ] ) ;
V_33 = F_242 ( V_581 , V_43 ) ;
if ( V_33 == NULL )
goto V_37;
if ( V_581 > V_450 )
goto V_37;
memcpy ( F_28 ( V_33 , V_581 ) , V_582 , V_581 ) ;
V_198 = F_233 ( V_580 ) ;
if ( ! V_198 )
goto V_272;
if ( F_12 ( F_198 ( V_99 ) ) != V_198 -> V_23 )
...
static int F_243 ( struct V_32 * V_571 ,
struct V_411 * V_99 )
{
struct V_20 * V_20 = F_198 ( V_99 ) ;
struct V_47 * V_30 ;
int V_585 = 1 ;
F_194 ( & V_228 ) ;
F_102 (data, &hwsim_radios, list)
V_585 = F_244 ( V_585 , V_30 -> V_378 ) ;
F_195 ( & V_228 ) ;
if ( V_585 > 1 )
return - V_351 ;
if ( F_15 ( V_20 ) )
return - V_391 ;
F_234 ( V_20 , V_99 -> V_447 ) ;
F_81 ( V_160 L_56
L_57 , V_99 -> V_447 ) ;
return 0 ;
}
static int F_245 ( struct V_32 * V_586 , struct V_411 * V_99 )
{
...
V_415 . V_544 = true ;
if ( V_99 -> V_575 [ V_429 ] ) {
V_428 = F_246 ( V_43 , L_58 ,
F_241 ( V_99 -> V_575 [ V_429 ] ) ,
( char * ) F_236 ( V_99 -> V_575 [ V_429 ] ) ) ;
if ( ! V_428 )
return - V_44 ;
V_415 . V_428 = V_428 ;
}
...
return F_193 ( V_99 , & V_415 ) ;
}
static int F_247 ( struct V_32 * V_586 , struct V_411 * V_99 )
{
struct V_47 * V_30 ;
V_93 V_172 = - 1 ;
const char * V_428 = NULL ;
...
if ( ! V_428 ||
strcmp ( V_428 , F_197 ( V_30 -> V_51 -> V_27 ) ) )
continue;
}
if ( ! F_248 ( F_249 ( V_30 -> V_51 -> V_27 ) , F_198 ( V_99 ) ) )
continue;
F_229 ( & V_30 -> V_556 ) ;
F_195 ( & V_228 ) ;
F_222 ( V_30 , F_197 ( V_30 -> V_51 -> V_27 ) ,
...
static int F_251 ( struct V_32 * V_586 , struct V_411 * V_99 )
{
struct V_47 * V_30 ;
struct V_32 * V_33 ;
...
if ( ! F_248 ( F_249 ( V_30 -> V_51 -> V_27 ) , F_198 ( V_99 ) ) )
continue;
V_33 = F_252 ( V_590 , V_43 ) ;
if ( ! V_33 ) {
V_141 = - V_44 ;
goto V_431;
}
V_141 = F_225 ( V_33 , V_30 , V_99 -> V_447 ,
V_99 -> V_591 , NULL , 0 ) ;
if ( V_141 < 0 ) {
F_74 ( V_33 ) ;
goto V_431;
...
if ( V_30 -> V_172 < V_172 )
continue;
if ( ! F_248 ( F_249 ( V_30 -> V_51 -> V_27 ) , F_255 ( V_33 -> V_593 ) ) )
continue;
V_141 = F_225 ( V_33 , V_30 ,
F_256 ( V_130 -> V_33 ) . V_26 ,
...
F_222 ( V_30 , F_197 ( V_30 -> V_51 -> V_27 ) , NULL ) ;
}
static void F_258 ( T_1 V_26 )
{
struct V_47 * V_598 , * V_573 ;
F_194 ( & V_228 ) ;
F_259 (entry, tmp, &hwsim_radios, list) {
if ( V_598 -> V_446 && V_598 -> V_26 == V_26 ) {
F_229 ( & V_598 -> V_556 ) ;
F_260 ( & V_598 -> V_597 , F_257 ) ;
F_261 ( & V_598 -> V_597 ) ;
}
}
F_195 ( & V_228 ) ;
...
static T_10 int F_267 ( struct V_20 * V_20 )
{
F_14 ( V_20 ) ;
return 0 ;
}
static void T_11 F_268 ( struct V_20 * V_20 )
{
struct V_47 * V_30 , * V_573 ;
F_194 ( & V_228 ) ;
F_259 (data, tmp, &hwsim_radios, list) {
if ( ! F_248 ( F_249 ( V_30 -> V_51 -> V_27 ) , V_20 ) )
continue;
if ( V_30 -> V_23 == F_12 ( & V_439 ) )
continue;
F_229 ( & V_30 -> V_556 ) ;
F_260 ( & V_30 -> V_597 , F_257 ) ;
F_261 ( & V_30 -> V_597 ) ;
}
F_195 ( & V_228 ) ;
}
...
V_415 . V_425 = V_630 ;
V_415 . V_242 = V_378 > 1 ;
V_37 = F_193 ( NULL , & V_415 ) ;
if ( V_37 < 0 )
goto V_631;
}
V_102 = F_276 ( 0 , L_47 , V_632 ,
F_231 ) ;
if ( V_102 == NULL ) {
V_37 = - V_44 ;
goto V_631;
