...
F_87 ( V_187 , V_13 -> V_203 ) ;
} else {
V_200 = 1 ;
}
V_196 = V_13 -> V_73 ;
if ( ! V_196 ) {
V_196 = F_88 ( V_13 -> V_44 , V_204 ) ;
if ( V_196 == NULL ) {
if ( V_183 != NULL ) {
F_39 ( V_183 ) ;
V_11 -> V_60 -> V_8 . V_205 ++ ;
...
V_190 -> V_193 = F_33 ( V_207 ) ;
V_190 -> V_208 = F_51 ( sizeof( struct V_34 ) ) ;
V_190 -> V_209 = F_51 ( V_13 -> V_210 ++ ) ;
V_13 -> V_211 = 0 ;
V_13 -> V_212 = 0 ;
}
for ( V_197 = V_13 -> V_211 ; V_197 < V_13 -> V_102 ; V_197 ++ ) {
if ( V_183 == NULL ) {
V_183 = V_13 -> V_135 ;
V_187 = V_13 -> V_203 ;
V_13 -> V_135 = NULL ;
...
V_189 -> V_214 [ V_198 ] . V_215 = F_51 ( V_183 -> V_47 ) ;
V_189 -> V_214 [ V_198 ] . V_216 = F_51 ( V_196 -> V_47 ) ;
V_189 -> V_195 = F_51 ( V_199 + sizeof( struct V_106 ) ) ;
memcpy ( F_84 ( V_196 , V_183 -> V_47 ) , V_183 -> V_9 , V_183 -> V_47 ) ;
V_13 -> V_212 += V_183 -> V_47 ;
F_39 ( V_183 ) ;
V_183 = NULL ;
if ( V_198 >= V_104 ) {
V_200 = 1 ;
...
V_202 = V_13 -> V_44 - V_196 -> V_47 ;
memset ( F_84 ( V_196 , V_202 ) , 0 , V_202 ) ;
} else if ( V_196 -> V_47 < V_13 -> V_44 &&
( V_196 -> V_47 % V_11 -> V_224 ) == 0 ) {
* F_84 ( V_196 , 1 ) = 0 ;
}
V_190 = (struct V_34 * ) V_196 -> V_9 ;
V_190 -> V_225 = F_51 ( V_196 -> V_47 ) ;
V_13 -> V_73 = NULL ;
V_13 -> V_226 += V_196 -> V_47 - V_13 -> V_212 ;
V_13 -> V_227 ++ ;
F_89 ( V_196 , V_197 ,
( long ) V_13 -> V_212 - V_196 -> V_47 ) ;
return V_196 ;
V_206:
...
static enum V_228 V_147 ( struct V_229 * V_230 )
{
struct V_12 * V_13 =
F_93 ( V_230 , struct V_12 , V_143 ) ;
if ( ! F_91 ( & V_13 -> V_151 ) )
F_94 ( & V_13 -> V_148 ) ;
return V_231 ;
}
static void V_150 ( unsigned long V_232 )
{
...
struct V_182 *
F_95 ( struct V_10 * V_11 , struct V_182 * V_183 , T_8 V_222 )
{
struct V_182 * V_196 ;
struct V_12 * V_13 = (struct V_12 * ) V_11 -> V_9 [ 0 ] ;
if ( V_13 == NULL )
goto error;
F_24 ( & V_13 -> V_52 ) ;
V_196 = F_86 ( V_11 , V_183 , F_33 ( V_234 ) ) ;
F_25 ( & V_13 -> V_52 ) ;
return V_196 ;
error:
if ( V_183 != NULL )
...
int F_96 ( struct V_12 * V_13 , struct V_182 * V_235 )
{
...
sizeof( struct V_105 ) ) ) {
F_97 ( V_11 , V_236 , V_11 -> V_60 , L_31 ) ;
goto error;
}
V_190 = (struct V_34 * ) V_235 -> V_9 ;
if ( V_190 -> V_193 != F_33 ( V_207 ) ) {
F_97 ( V_11 , V_236 , V_11 -> V_60 ,
L_32 ,
F_8 ( V_190 -> V_193 ) ) ;
goto error;
}
V_47 = F_46 ( V_190 -> V_225 ) ;
if ( V_47 > V_13 -> V_43 ) {
F_97 ( V_11 , V_236 , V_11 -> V_60 ,
L_33 , V_47 ,
V_13 -> V_43 ) ;
...
if ( ( V_13 -> V_237 + 1 ) != F_46 ( V_190 -> V_209 ) &&
( V_13 -> V_237 || F_46 ( V_190 -> V_209 ) ) &&
! ( ( V_13 -> V_237 == 0xffff ) && ! F_46 ( V_190 -> V_209 ) ) ) {
F_97 ( V_11 , V_236 , V_11 -> V_60 ,
L_34 ,
V_13 -> V_237 , F_46 ( V_190 -> V_209 ) ) ;
}
...
int F_98 ( struct V_182 * V_235 , int V_191 )
{
struct V_10 * V_11 = F_4 ( V_235 -> V_11 ) ;
struct V_105 * V_189 ;
int V_49 = - V_48 ;
if ( ( V_191 + sizeof( struct V_105 ) ) > V_235 -> V_47 ) {
F_97 ( V_11 , V_236 , V_11 -> V_60 , L_35 ,
V_191 ) ;
goto error;
}
V_189 = (struct V_105 * ) ( V_235 -> V_9 + V_191 ) ;
if ( F_46 ( V_189 -> V_195 ) < V_238 ) {
F_97 ( V_11 , V_236 , V_11 -> V_60 , L_36 ,
F_46 ( V_189 -> V_195 ) ) ;
goto error;
}
...
V_49 * ( sizeof( struct V_106 ) ) ) > V_235 -> V_47 ) {
F_97 ( V_11 , V_236 , V_11 -> V_60 , L_37 , V_49 ) ;
V_49 = - V_48 ;
}
error:
return V_49 ;
}
int F_99 ( struct V_10 * V_11 , struct V_182 * V_235 )
{
struct V_182 * V_183 ;
struct V_12 * V_13 = (struct V_12 * ) V_11 -> V_9 [ 0 ] ;
int V_47 ;
...
int V_242 = 50 ;
V_18 V_243 = 0 ;
V_191 = F_96 ( V_13 , V_235 ) ;
if ( V_191 < 0 )
goto error;
V_244:
V_239 = F_98 ( V_235 , V_191 ) ;
if ( V_239 < 0 )
goto error;
V_189 = (struct V_105 * ) ( V_235 -> V_9 + V_191 ) ;
if ( V_189 -> V_193 != F_33 ( V_234 ) ) {
F_97 ( V_11 , V_236 , V_11 -> V_60 ,
L_38 ,
F_8 ( V_189 -> V_193 ) ) ;
goto V_245;
...
V_241 = F_46 ( V_214 -> V_216 ) ;
V_47 = F_46 ( V_214 -> V_215 ) ;
if ( ( V_241 == 0 ) || ( V_47 == 0 ) ) {
if ( ! V_240 )
goto V_245;
break;
...
if ( ! V_183 )
goto error;
memcpy ( F_84 ( V_183 , V_47 ) , V_235 -> V_9 + V_241 , V_47 ) ;
F_101 ( V_11 , V_183 ) ;
V_243 += V_47 ;
}
}
...
static void F_104 ( struct V_10 * V_11 , struct V_254 * V_254 )
{
struct V_12 * V_13 ;
struct V_255 * V_256 ;
...
F_106 ( V_11 , ! ! V_256 -> V_262 , 0 ) ;
break;
case V_263 :
if ( V_254 -> V_257 < ( sizeof( * V_256 ) +
sizeof( struct V_248 ) ) )
F_107 ( V_258 , & V_11 -> V_222 ) ;
else
F_102 ( V_11 ,
