...
static int F_23 ( struct V_1 * V_36 ,
struct V_37 * V_38 ,
struct V_37 * V_39 ,
...
T_1 V_66 = ( V_27 & ~ V_32 ) ;
if ( V_41 == V_33 )
V_3 = F_26 ( ( ( const struct V_26 * ) V_40 ) -> V_3 ) ;
else
V_3 = NULL ;
if ( ! V_36 -> V_67 &&
( ! V_3 || ! V_3 -> V_68 ) )
...
V_39 = NULL ;
if ( V_58 ) {
V_38 = F_29 ( F_28 ( V_58 , & V_71 ) ,
struct V_37 , V_74 ) ;
V_60 = V_38 -> V_47 ;
}
if ( V_59 ) {
V_39 = F_29 ( F_28 ( V_59 , & V_71 ) ,
struct V_37 , V_74 ) ;
V_61 = V_39 -> V_47 ;
}
if ( V_60 && V_61 ) {
