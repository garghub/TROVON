...
return V_21 -> V_162 ( V_154 , V_160 , V_147 , V_161 ) ;
}
...
struct V_4 * F_68 ( struct V_4 * V_21 )
{
F_35 ( & V_21 -> V_142 ) ;
F_35 ( & V_21 -> V_166 ) ;
F_35 ( & V_21 -> V_167 ) ;
...
int F_69 ( struct V_4 * V_21 )
{
int V_170 ;
int V_171 = - 1 ;
F_15 ( & V_172 ) ;
for ( V_170 = 0 ; V_170 < sizeof( V_173 ) * 8 ; V_170 ++ ) {
if ( ( V_173 & ( 1 << V_170 ) ) == 0 ) {
V_173 |= ( 1 << V_170 ) ;
V_21 -> V_165 = V_170 ;
F_35 ( & V_21 -> V_174 ) ;
F_50 ( & V_21 -> V_175 , & V_176 ) ;
V_171 = 0 ;
break;
}
}
...
void F_70 ( struct V_4 * V_21 )
{
struct V_1 * V_51 ;
struct V_1 * V_177 ;
F_15 ( & V_172 ) ;
V_173 &= ~ ( 1 << V_21 -> V_165 ) ;
F_71 (vdev, tmp, &bridge->devices, bridge_list) {
F_52 ( & V_51 -> V_178 ) ;
F_52 ( & V_51 -> V_179 ) ;
F_72 ( & V_51 -> V_3 ) ;
}
...
struct V_4 * V_21 , unsigned int V_182 )
{
int V_183 ;
unsigned int V_170 ;
struct V_1 * V_51 ;
struct V_1 * V_177 ;
for ( V_170 = 0 ; V_170 < V_182 ; V_170 ++ ) {
V_51 = F_74 ( sizeof( struct V_1 ) , V_63 ) ;
if ( ! V_51 ) {
V_183 = - V_184 ;
goto V_185;
}
V_51 -> V_165 = V_170 ;
V_51 -> V_21 = V_21 ;
V_51 -> V_3 . V_186 = V_181 ;
V_51 -> V_3 . V_187 = F_67 ;
V_51 -> V_3 . V_11 = V_21 -> V_11 ;
V_51 -> V_3 . V_188 = & V_189 ;
F_75 ( & V_51 -> V_3 , L_56 , V_181 -> V_22 , V_21 -> V_165 ,
V_51 -> V_165 ) ;
V_183 = F_76 ( & V_51 -> V_3 ) ;
if ( V_183 )
goto V_190;
if ( V_51 -> V_3 . V_186 ) {
F_50 ( & V_51 -> V_178 , & V_181 -> V_174 ) ;
F_50 ( & V_51 -> V_179 , & V_21 -> V_174 ) ;
} else
F_72 ( & V_51 -> V_3 ) ;
}
return 0 ;
...
F_20 ( V_51 ) ;
V_185:
F_71 (vdev, tmp, &drv->devices, drv_list) {
F_52 ( & V_51 -> V_178 ) ;
F_52 ( & V_51 -> V_179 ) ;
F_72 ( & V_51 -> V_3 ) ;
}
...
static int F_78 ( struct V_180 * V_181 , unsigned int V_182 )
{
struct V_4 * V_21 ;
int V_183 = 0 ;
F_15 ( & V_172 ) ;
F_79 (bridge, &vme_bus_list, bus_list) {
V_183 = F_73 ( V_181 , V_21 , V_182 ) ;
if ( V_183 )
break;
}
F_16 ( & V_172 ) ;
...
int F_80 ( struct V_180 * V_181 , unsigned int V_182 )
{
int V_183 ;
V_181 -> V_191 . V_22 = V_181 -> V_22 ;
V_181 -> V_191 . V_188 = & V_189 ;
F_35 ( & V_181 -> V_174 ) ;
V_183 = F_81 ( & V_181 -> V_191 ) ;
if ( V_183 )
return V_183 ;
V_183 = F_78 ( V_181 , V_182 ) ;
if ( V_183 )
F_82 ( & V_181 -> V_191 ) ;
return V_183 ;
}
void F_83 ( struct V_180 * V_181 )
{
struct V_1 * V_3 , * V_192 ;
F_15 ( & V_172 ) ;
F_71 (dev, dev_tmp, &drv->devices, drv_list) {
F_52 ( & V_3 -> V_178 ) ;
F_52 ( & V_3 -> V_179 ) ;
F_72 ( & V_3 -> V_3 ) ;
}
...
static int F_84 ( struct V_2 * V_3 , struct V_193 * V_181 )
{
struct V_180 * V_194 ;
V_194 = F_2 ( V_181 , struct V_180 , V_191 ) ;
if ( V_3 -> V_186 == V_194 ) {
struct V_1 * V_51 = F_1 ( V_3 ) ;
if ( V_194 -> V_195 && V_194 -> V_195 ( V_51 ) )
return 1 ;
V_3 -> V_186 = NULL ;
}
return 0 ;
...
struct V_1 * V_51 = F_1 ( V_3 ) ;
V_191 = V_3 -> V_186 ;
if ( V_191 -> remove != NULL )
V_27 = V_191 -> remove ( V_51 ) ;
return V_27 ;
}
