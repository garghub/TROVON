...
break;
case V_538 :
if ( V_2 -> V_29 -> V_539 == V_540 )
V_2 -> V_29 -> V_539 = V_541 ;
V_514 -> V_6 = F_2 ( V_508 ) ;
V_514 -> V_8 = F_2 ( V_10 ) ;
break;
case V_542 :
V_2 -> V_29 -> V_539 = V_540 ;
V_514 -> V_6 = F_2 ( V_508 ) ;
V_514 -> V_8 = F_2 ( V_10 ) ;
break;
case V_543 :
...
V_514 -> V_6 = F_2 ( V_508 ) ;
if ( V_2 -> V_223 == V_224 )
V_514 -> V_11 . V_223 . V_553 =
V_554 ;
else if ( V_2 -> V_223 == V_555 ||
V_2 -> V_223 == V_556 )
V_514 -> V_11 . V_223 . V_553 =
V_557 ;
else if ( V_2 -> V_223 == V_558 ||
V_2 -> V_223 == V_559 )
V_514 -> V_11 . V_223 . V_553 = V_560 ;
...
int F_78 ( struct V_1 * V_2 , V_57 V_563 , bool V_564 )
{
struct V_105 * V_29 = V_2 -> V_29 ;
int V_236 ;
struct V_565 V_566 ;
...
V_236 = F_44 ( V_2 , V_546 ,
V_28 , 0 ,
& V_2 -> V_29 -> V_579 , true ) ;
if ( V_236 )
return - 1 ;
if ( V_2 -> V_580 != V_581 ) {
V_2 -> V_29 -> V_582 = V_583 ;
V_236 = F_44 ( V_2 ,
V_516 ,
V_584 , V_585 , NULL ,
true ) ;
