...
{
struct V_70 V_75 ;
struct V_76 * V_3 = V_4 -> V_57 ;
T_3 V_77 ;
T_3 V_78 ;
T_3 V_79 ;
int V_80 ;
int error = 0 ;
if ( V_71 -> V_81 > V_72 -> V_81 )
return - V_82 ;
else if ( V_71 -> V_81 == V_72 -> V_81 )
return 0 ;
V_77 = V_71 -> V_81 ;
V_79 = V_72 -> V_81 - V_77 ;
while ( V_79 ) {
error = F_28 ( V_3 , V_4 , V_77 , 1 , 1 , & V_78 ,
& V_80 ) ;
if ( error )
break;
error = F_15 ( V_3 , V_4 , V_77 ,
V_72 -> V_81 - 1 , & V_78 ) ;
if ( error )
break;
if ( V_80 ) {
V_75 . V_81 = V_77 ;
V_75 . V_83 = V_78 - V_77 + 1 ;
error = V_73 ( V_4 , & V_75 , V_74 ) ;
if ( error )
break;
}
V_79 -= V_78 - V_77 + 1 ;
...
struct V_70 V_84 [ 2 ] ;
V_84 [ 0 ] . V_81 = 0 ;
V_84 [ 1 ] . V_81 = V_4 -> V_57 -> V_51 . V_85 ;
V_84 [ 0 ] . V_83 = V_84 [ 1 ] . V_83 = 0 ;
return F_35 ( V_4 , & V_84 [ 0 ] , & V_84 [ 1 ] , V_73 , V_74 ) ;
}
