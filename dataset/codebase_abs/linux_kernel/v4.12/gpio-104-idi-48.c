...
V_25 &= 0x3F ;
F_21 (boundary, &cos_status, 6 ) {
V_15 = V_5 -> V_15 [ V_13 ] ;
F_21 (bit_num, &irq_mask, 8 ) {
V_27 = V_26 + V_13 * 8 ;
F_22 ( F_23 ( V_2 -> V_30 ,
V_27 ) ) ;
}
...
static int F_24 ( struct V_32 * V_33 , unsigned int V_34 )
{
struct V_4 * V_5 ;
const char * const V_35 = F_25 ( V_33 ) ;
int V_36 ;
V_5 = F_26 ( V_33 , sizeof( * V_5 ) , V_37 ) ;
if ( ! V_5 )
return - V_38 ;
if ( ! F_27 ( V_33 , V_10 [ V_34 ] , V_39 , V_35 ) ) {
F_28 ( V_33 , L_1 ,
...
F_12 ( 0 , V_10 [ V_34 ] + 7 ) ;
F_6 ( V_10 [ V_34 ] + 7 ) ;
V_36 = F_32 ( & V_5 -> V_2 , & V_52 , 0 ,
V_53 , V_20 ) ;
if ( V_36 ) {
F_28 ( V_33 , L_3 , V_36 ) ;
return V_36 ;
}
V_36 = F_33 ( V_33 , V_23 [ V_34 ] , F_16 , V_54 ,
V_35 , V_5 ) ;
if ( V_36 ) {
F_28 ( V_33 , L_4 , V_36 ) ;
return V_36 ;
