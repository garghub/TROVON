...
switch ( V_33 -> type ) {
case V_41 :
V_16 = F_23 ( V_6 -> V_11 -> V_42 , V_33 -> V_40 ) ;
break;
case V_43 :
case V_44 :
case V_45 :
...
if ( V_33 -> type == V_44 ) {
V_16 = F_25 ( V_33 -> V_40 , 1 , & V_38 ,
V_6 -> V_18 + V_33 -> V_47 ) ;
} else {
V_16 = F_26 ( NULL , V_33 -> V_40 ,
V_38 , 0 ,
V_33 -> V_48 , div ) ;
}
break;
...
void T_2 F_70 ( struct V_32 * V_104 ,
unsigned int V_31 ,
unsigned int V_107 ,
unsigned int V_108 )
{
...
if ( V_104 [ V_14 ] . V_37 >= V_107 &&
V_104 [ V_14 ] . V_37 <= V_108 )
V_104 [ V_14 ] . V_40 = NULL ;
}
void T_2 F_71 ( struct V_50 * V_105 ,
unsigned int V_30 ,
const unsigned int * V_28 , unsigned int V_109 )
{
unsigned int V_14 , V_110 ;
for ( V_14 = 0 , V_110 = 0 ; V_14 < V_30 && V_110 < V_109 ; V_14 ++ )
if ( V_105 [ V_14 ] . V_37 == V_28 [ V_110 ] ) {
V_105 [ V_14 ] . V_40 = NULL ;
V_110 ++ ;
}
}
void T_2 F_72 ( struct V_50 * V_105 ,
unsigned int V_30 ,
const struct F_72 * V_28 ,
unsigned int V_109 )
{
unsigned int V_14 , V_110 ;
for ( V_14 = 0 , V_110 = 0 ; V_14 < V_30 && V_110 < V_109 ; V_14 ++ )
if ( V_105 [ V_14 ] . V_37 == V_28 [ V_110 ] . V_16 ) {
V_105 [ V_14 ] . V_36 = V_28 [ V_110 ] . V_36 ;
V_110 ++ ;
}
}
