...
static int F_60 ( T_6 V_37 , unsigned long V_17 , unsigned long V_18 ,
int V_11 , struct V_8 * * V_9 , int * V_6 )
{
unsigned long V_33 ;
T_5 * V_38 ;
...
return 0 ;
} while ( V_38 ++ , V_17 = V_33 , V_17 != V_18 );
return 1 ;
}
int F_66 ( unsigned long V_39 , int V_40 , int V_11 ,
struct V_8 * * V_9 )
{
struct V_41 * V_42 = V_43 -> V_42 ;
unsigned long V_17 , V_44 , V_18 ;
unsigned long V_33 ;
unsigned long V_45 ;
T_6 * V_46 ;
int V_6 = 0 ;
V_39 &= V_47 ;
V_17 = V_39 ;
V_44 = ( unsigned long ) V_40 << V_27 ;
V_18 = V_39 + V_44 ;
if ( F_5 ( ! F_67 ( V_11 ? V_48 : V_49 ,
( void V_50 * ) V_39 , V_44 ) ) )
return 0 ;
F_68 ( V_45 ) ;
V_46 = F_69 ( V_42 , V_17 ) ;
...
if ( F_71 ( V_37 ) )
break;
if ( ! F_60 ( V_37 , V_17 , V_33 , V_11 , V_9 , & V_6 ) )
break;
} while ( V_46 ++ , V_17 = V_33 , V_17 != V_18 );
F_72 ( V_45 ) ;
return V_6 ;
}
int F_73 ( unsigned long V_39 , int V_40 , int V_11 ,
struct V_8 * * V_9 )
{
struct V_41 * V_42 = V_43 -> V_42 ;
unsigned long V_17 , V_44 , V_18 ;
