...
static int F_56 ( struct V_1 * V_2 , unsigned int V_10 )
{
int V_28 ;
T_1 * V_8 ;
V_8 = F_28 ( 5 , V_6 ) ;
...
F_3 ( V_8 ) ;
if ( V_28 != V_51 )
F_11 ( & V_2 -> V_19 , L_30 , V_20 , V_28 ) ;
else
F_11 ( & V_2 -> V_19 , L_31 , V_20 ) ;
return V_28 ;
}
static T_7 F_57 ( struct V_84 * V_19 ,
struct V_154 * V_155 , char * V_8 )
{
struct V_1 * V_2 = F_58 ( V_19 ) ;
struct V_3 * V_4 = F_8 ( V_2 ) ;
return sprintf ( V_8 , L_32 , V_4 -> V_10 ) ;
}
static T_7 F_59 ( struct V_84 * V_19 ,
struct V_154 * V_155 , const char * V_8 , T_8 V_48 )
{
struct V_1 * V_2 = F_58 ( V_19 ) ;
struct V_3 * V_4 = F_8 ( V_2 ) ;
unsigned long V_156 ;
if ( F_60 ( V_8 , 10 , & V_156 ) ) {
F_55 ( V_19 , L_33 ,
V_20 , V_8 ) ;
goto V_157;
}
F_11 ( V_19 , L_34 , V_20 , V_156 ) ;
if ( ( V_156 != 3 ) && ( V_156 != 5 ) ) {
F_55 ( V_19 , L_35 , V_20 , V_156 ) ;
} else {
F_56 ( V_2 , V_156 ) ;
V_4 -> V_10 = V_156 ;
}
