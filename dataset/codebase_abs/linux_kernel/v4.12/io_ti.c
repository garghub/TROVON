...
V_245 = F_102 ( V_245 , 461550 ) ;
F_103 ( V_157 , V_245 , V_245 ) ;
}
V_152 -> V_281 = V_245 ;
V_56 -> V_282 = ( T_2 ) ( ( 461550L + V_245 / 2 ) / V_245 ) ;
F_4 ( V_2 , L_114 , V_12 , V_245 , V_56 -> V_282 ) ;
F_4 ( V_2 , L_115 , ( int ) ( 461550L / V_56 -> V_282 ) ) ;
F_4 ( V_2 , L_116 , V_56 -> V_248 ) ;
F_4 ( V_2 , L_117 , V_56 -> V_254 ) ;
F_4 ( V_2 , L_118 , V_56 -> V_265 ) ;
F_4 ( V_2 , L_119 , V_56 -> V_270 ) ;
F_4 ( V_2 , L_120 , V_56 -> V_276 ) ;
F_4 ( V_2 , L_121 , V_56 -> V_277 ) ;
F_4 ( V_2 , L_122 , V_56 -> V_251 ) ;
F_104 ( & V_56 -> V_248 ) ;
F_104 ( & V_56 -> V_282 ) ;
...
static int F_106 ( struct V_156 * V_157 )
{
struct V_19 * V_20 = V_157 -> V_236 ;
struct V_45 * V_152 = F_61 ( V_20 ) ;
...
V_153 = V_152 -> V_167 ;
V_144 = V_152 -> V_218 ;
V_232 = ( ( V_144 & V_146 ) ? V_287 : 0 )
| ( ( V_144 & V_148 ) ? V_286 : 0 )
| ( ( V_153 & V_168 ) ? V_289 : 0 )
| ( ( V_153 & V_290 ) ? V_291 : 0 )
| ( ( V_153 & V_292 ) ? V_293 : 0 )
| ( ( V_153 & V_294 ) ? V_295 : 0 ) ;
F_4 ( & V_20 -> V_2 , L_124 , V_12 , V_232 ) ;
F_82 ( & V_152 -> V_200 , V_228 ) ;
return V_232 ;
}
static int F_107 ( struct V_45 * V_152 ,
...
if ( V_299 != V_301 )
V_299 = F_108 ( V_299 ) / 10 ;
memset ( & V_298 , 0 , sizeof( V_298 ) ) ;
V_298 . type = V_302 ;
V_298 . line = V_152 -> V_20 -> V_303 ;
V_298 . V_20 = V_152 -> V_20 -> V_22 ;
V_298 . V_304 = 0 ;
V_298 . V_305 = V_152 -> V_20 -> V_233 ;
V_298 . V_306 = 9600 ;
V_298 . V_307 = 5 * V_308 ;
V_298 . V_300 = V_299 ;
if ( F_109 ( V_297 , & V_298 , sizeof( * V_297 ) ) )
return - V_309 ;
return 0 ;
}
static int F_110 ( struct V_156 * V_157 ,
unsigned int V_310 , unsigned long V_311 )
{
struct V_19 * V_20 = V_157 -> V_236 ;
struct V_45 * V_152 = F_61 ( V_20 ) ;
switch ( V_310 ) {
...
return F_107 ( V_152 ,
(struct V_296 T_7 * ) V_311 ) ;
}
return - V_313 ;
}
static void F_111 ( struct V_156 * V_157 , int V_314 )
{
struct V_19 * V_20 = V_157 -> V_236 ;
struct V_45 * V_152 = F_61 ( V_20 ) ;
int V_8 ;
...
if ( V_314 == - 1 )
V_315 = 1 ;
V_8 = F_46 ( V_152 , V_316 , V_315 ) ;
if ( V_8 )
F_4 ( & V_20 -> V_2 , L_126 ,
V_12 , V_8 ) ;
}
static void F_112 ( struct V_34 * V_181 )
{
if ( ! V_181 -> V_317 )
return;
F_113 ( & V_181 -> V_318 ,
...
static void F_114 ( struct V_320 * V_321 )
{
struct V_34 * V_23 ;
struct V_67 * V_68 ;
V_23 = F_115 ( V_321 , struct V_34 ,
V_318 . V_321 ) ;
V_68 = F_15 ( sizeof( * V_68 ) , V_39 ) ;
...
static int F_116 ( struct V_107 * V_23 ,
struct V_322 * V_323 )
{
struct V_42 * V_2 = & V_23 -> V_118 -> V_2 ;
unsigned char V_190 = V_23 -> type -> V_190 ;
if ( V_23 -> V_118 -> V_124 -> V_57 . V_125 > 1 ) {
if ( V_323 -> V_324 < V_190 ||
V_323 -> V_325 < V_190 ||
V_323 -> V_326 < 1 ) {
F_18 ( V_2 , L_128 ) ;
return - V_60 ;
...
int V_8 ;
T_4 V_327 ;
V_181 = F_118 ( sizeof( struct V_34 ) , V_39 ) ;
if ( ! V_181 )
return - V_40 ;
F_119 ( & V_181 -> V_219 ) ;
V_181 -> V_23 = V_23 ;
F_120 ( & V_181 -> V_318 , F_114 ) ;
F_121 ( V_23 , V_181 ) ;
V_8 = F_40 ( V_181 ) ;
if ( V_8 < 0 ) {
F_16 ( V_181 ) ;
...
static void F_124 ( struct V_107 * V_23 )
{
struct V_34 * V_181 = F_79 ( V_23 ) ;
F_123 ( & V_181 -> V_318 ) ;
F_16 ( V_181 ) ;
...
if ( V_239 )
goto V_337;
V_20 -> V_20 . V_300 = F_129 ( V_300 * 10 ) ;
V_20 -> V_20 . V_338 = 1 ;
return 0 ;
V_337:
F_16 ( V_152 ) ;
...
{
struct V_19 * V_20 = F_133 ( V_2 ) ;
struct V_45 * V_152 = F_61 ( V_20 ) ;
return sprintf ( V_341 , L_64 , V_152 -> V_251 ) ;
}
static T_8 F_134 ( struct V_42 * V_2 ,
struct V_339 * V_340 , const char * V_342 , T_9 V_231 )
{
struct V_19 * V_20 = F_133 ( V_2 ) ;
struct V_45 * V_152 = F_61 ( V_20 ) ;
unsigned int V_343 = F_135 ( V_342 , NULL , 0 ) ;
F_4 ( V_2 , L_131 , V_12 , V_343 ) ;
if ( V_343 < 256 )
V_152 -> V_251 = V_343 ;
else
F_18 ( V_2 , L_132 , V_12 , V_343 ) ;
return V_231 ;
}
static int F_128 ( struct V_19 * V_20 )
{
return F_136 ( & V_20 -> V_2 , & V_344 ) ;
}
static int F_131 ( struct V_19 * V_20 )
{
F_137 ( & V_20 -> V_2 , & V_344 ) ;
return 0 ;
}
static int F_138 ( struct V_107 * V_23 , T_10 V_345 )
{
struct V_34 * V_181 = F_79 ( V_23 ) ;
F_123 ( & V_181 -> V_318 ) ;
return 0 ;
}
static int F_139 ( struct V_107 * V_23 )
{
struct V_34 * V_181 = F_79 ( V_23 ) ;
F_112 ( V_181 ) ;
return 0 ;
