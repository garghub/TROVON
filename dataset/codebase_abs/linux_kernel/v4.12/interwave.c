...
static T_1 F_21 ( int V_39 , void * V_40 )
{
...
static void F_26 ( struct V_11 * V_12 , int * V_47 )
{
unsigned int V_48 ;
unsigned int V_49 ;
unsigned char V_32 ;
...
if ( strncmp ( V_56 , L_10 , 8 ) )
continue;
V_57 = 0 ;
for ( V_53 = 0 ; V_53 < sizeof( struct V_70 ) ; V_53 ++ )
V_57 += F_28 ( V_12 , V_51 + V_53 ) ;
if ( V_57 != 0 )
continue;
V_12 -> V_21 . V_68 ++ ;
V_12 -> V_21 . V_71 |= 1 << ( V_51 >> 22 ) ;
...
static void F_34 ( int V_13 , struct V_11 * V_12 )
{
unsigned long V_29 ;
F_17 ( & V_12 -> V_34 , V_29 ) ;
F_19 ( V_12 , V_72 , 0x00 ) ;
...
{
struct V_15 * V_16 = V_83 -> V_16 ;
struct V_84 V_85 , V_86 ;
unsigned int V_48 ;
int V_18 ;
memset ( & V_85 , 0 , sizeof( V_85 ) ) ;
memset ( & V_86 , 0 , sizeof( V_86 ) ) ;
V_85 . V_87 = V_86 . V_87 = V_88 ;
#if 0
...
return err;
#endif
for ( V_48 = 0 ; V_48 < F_33 ( V_89 ) ; V_48 ++ )
if ( ( V_18 = F_36 ( V_16 , F_37 ( & V_89 [ V_48 ] , V_83 ) ) ) < 0 )
return V_18 ;
F_38 ( V_83 , V_90 , 0x9f ) ;
F_38 ( V_83 , V_91 , 0x9f ) ;
F_38 ( V_83 , V_92 , 0x9f ) ;
F_38 ( V_83 , V_93 , 0x9f ) ;
strcpy ( V_85 . V_17 , L_11 ) ;
strcpy ( V_86 . V_17 , L_12 ) ;
if ( ( V_18 = F_39 ( V_16 , & V_85 , & V_86 ) ) < 0 )
return V_18 ;
strcpy ( V_85 . V_17 , L_13 ) ;
strcpy ( V_86 . V_17 , L_14 ) ;
if ( ( V_18 = F_39 ( V_16 , & V_85 , & V_86 ) ) < 0 )
return V_18 ;
strcpy ( V_85 . V_17 , L_11 ) ; V_85 . V_94 = 1 ;
strcpy ( V_86 . V_17 , L_15 ) ;
if ( ( V_18 = F_39 ( V_16 , & V_85 , & V_86 ) ) < 0 )
return V_18 ;
strcpy ( V_85 . V_17 , L_13 ) ;
strcpy ( V_86 . V_17 , L_16 ) ;
if ( ( V_18 = F_39 ( V_16 , & V_85 , & V_86 ) ) < 0 )
return V_18 ;
return 0 ;
}
static int F_40 ( int V_13 , struct V_9 * V_10 ,
struct V_95 * V_16 ,
const struct V_96 * V_97 )
{
struct V_98 * V_99 ;
int V_18 ;
V_10 -> V_13 = F_41 ( V_16 , V_97 -> V_100 [ 0 ] . V_97 , NULL ) ;
if ( V_10 -> V_13 == NULL )
return - V_101 ;
#ifdef F_13
V_10 -> V_102 = F_41 ( V_16 , V_97 -> V_100 [ 1 ] . V_97 , NULL ) ;
if ( V_10 -> V_102 == NULL )
return - V_101 ;
#endif
V_99 = V_10 -> V_13 ;
...
if ( F_43 ( V_99 , 0 ) + 0x100 != F_43 ( V_99 , 1 ) ||
F_43 ( V_99 , 0 ) + 0x10c != F_43 ( V_99 , 2 ) ) {
F_9 ( V_23 L_18 ) ;
return - V_103 ;
}
V_5 [ V_13 ] = F_43 ( V_99 , 0 ) ;
V_104 [ V_13 ] = F_44 ( V_99 , 0 ) ;
if ( V_105 [ V_13 ] >= 0 )
V_105 [ V_13 ] = F_44 ( V_99 , 1 ) ;
V_39 [ V_13 ] = F_45 ( V_99 , 0 ) ;
F_16 ( L_19 ,
( unsigned long long ) F_43 ( V_99 , 0 ) ,
( unsigned long long ) F_43 ( V_99 , 1 ) ,
( unsigned long long ) F_43 ( V_99 , 2 ) ) ;
F_16 ( L_20 , V_104 [ V_13 ] , V_105 [ V_13 ] , V_39 [ V_13 ] ) ;
#ifdef F_13
V_99 = V_10 -> V_102 ;
V_18 = F_42 ( V_99 ) ;
if ( V_18 < 0 ) {
...
#endif
if ( V_10 -> V_39 >= 0 )
F_48 ( V_10 -> V_39 , ( void * ) V_10 ) ;
}
static int F_49 ( struct V_107 * V_99 , int V_13 ,
struct V_15 * * V_108 )
{
struct V_15 * V_16 ;
struct V_9 * V_10 ;
int V_18 ;
V_18 = F_50 ( V_99 , V_94 [ V_13 ] , V_97 [ V_13 ] , V_109 ,
...
static int F_51 ( struct V_15 * V_16 , int V_13 )
{
...
return V_18 ;
V_10 -> V_44 = V_12 -> V_21 . V_118 ;
V_10 -> V_45 = V_12 -> V_21 . V_5 + 0x10c + 2 ;
F_34 ( V_13 , V_12 ) ;
F_29 ( V_12 ) ;
if ( ( V_18 = F_53 ( V_12 ) ) < 0 )
return V_18 ;
if ( F_54 ( V_111 , F_21 , 0 ,
L_23 , V_10 ) ) {
F_9 (KERN_ERR PFX L_24 , xirq) ;
return - V_101 ;
}
V_10 -> V_39 = V_111 ;
V_18 = F_55 ( V_16 ,
...
if ( V_18 < 0 )
return V_18 ;
sprintf ( V_46 -> V_123 -> V_17 + strlen ( V_46 -> V_123 -> V_17 ) , L_25 ,
V_12 -> V_38 + 'A' ) ;
strcat ( V_46 -> V_123 -> V_17 , L_26 ) ;
V_18 = F_57 ( V_46 , 2 ) ;
if ( V_18 < 0 )
return V_18 ;
V_18 = F_58 ( V_46 ) ;
...
memset ( & V_86 , 0 , sizeof( V_86 ) ) ;
V_85 . V_87 = V_86 . V_87 = V_88 ;
strcpy ( V_85 . V_17 , L_27 ) ;
strcpy ( V_86 . V_17 , V_85 . V_17 ) ;
V_86 . V_94 = 1 ;
if ( ( V_18 = F_39 ( V_16 , & V_85 , & V_86 ) ) < 0 )
return V_18 ;
strcpy ( V_85 . V_17 , L_28 ) ;
strcpy ( V_86 . V_17 , V_85 . V_17 ) ;
if ( ( V_18 = F_39 ( V_16 , & V_85 , & V_86 ) ) < 0 )
return V_18 ;
if ( ( V_18 = F_60 ( V_16 , V_114 , 0 , 1 ) ) < 0 )
return V_18 ;
}
#endif
V_12 -> V_124 = V_125 [ V_13 ] ;
if ( ( V_18 = F_61 ( V_12 , 0 ) ) < 0 )
return V_18 ;
#ifndef F_13
V_115 = L_8 ;
if ( V_12 -> V_21 . V_68 == 1 && V_12 -> V_21 . V_71 == 8 )
V_115 = L_29 ;
#else
V_115 = L_30 ;
#endif
strcpy ( V_16 -> V_126 , V_115 ) ;
strcpy ( V_16 -> V_37 , V_115 ) ;
sprintf ( V_16 -> V_127 , L_31 ,
V_115 ,
V_12 -> V_21 . V_5 ,
V_111 ,
V_112 ) ;
if ( V_113 >= 0 )
sprintf ( V_16 -> V_127 + strlen ( V_16 -> V_127 ) , L_32 , V_113 ) ;
V_18 = F_62 ( V_16 ) ;
if ( V_18 < 0 )
return V_18 ;
V_10 -> V_46 = V_46 ;
...
static int F_63 ( int V_13 , struct V_107 * V_128 )
{
struct V_15 * V_16 ;
int V_18 ;
V_18 = F_49 ( V_128 , V_13 , & V_16 ) ;
if ( V_18 < 0 )
return V_18 ;
if ( ( V_18 = F_51 ( V_16 , V_13 ) ) < 0 ) {
F_64 ( V_16 ) ;
return V_18 ;
}
F_65 ( V_128 , V_16 ) ;
...
static int F_66 ( struct V_107 * V_99 ,
unsigned int V_13 )
{
if ( ! V_129 [ V_13 ] )
return 0 ;
...
static int F_68 ( struct V_107 * V_99 ,
unsigned int V_13 )
{
int V_18 ;
static int V_131 [] = { 5 , 11 , 12 , 9 , 7 , 15 , 3 , - 1 } ;
static int V_132 [] = { 0 , 1 , 3 , 5 , 6 , 7 , - 1 } ;
if ( V_39 [ V_13 ] == V_133 ) {
if ( ( V_39 [ V_13 ] = F_69 ( V_131 ) ) < 0 ) {
F_9 (KERN_ERR PFX L_33 ) ;
return - V_101 ;
}
}
if ( V_104 [ V_13 ] == V_134 ) {
if ( ( V_104 [ V_13 ] = F_70 ( V_132 ) ) < 0 ) {
F_9 (KERN_ERR PFX L_34 ) ;
return - V_101 ;
}
}
if ( V_105 [ V_13 ] == V_134 ) {
if ( ( V_105 [ V_13 ] = F_70 ( V_132 ) ) < 0 ) {
F_9 (KERN_ERR PFX L_35 ) ;
return - V_101 ;
}
}
if ( V_5 [ V_13 ] != V_20 )
return F_63 ( V_13 , V_99 ) ;
else {
static long V_135 [] = { 0x210 , 0x220 , 0x230 , 0x240 , 0x250 , 0x260 } ;
int V_53 ;
for ( V_53 = 0 ; V_53 < F_33 ( V_135 ) ; V_53 ++ ) {
V_5 [ V_13 ] = V_135 [ V_53 ] ;
V_18 = F_63 ( V_13 , V_99 ) ;
if ( ! V_18 )
return 0 ;
...
static int F_71 ( struct V_107 * V_128 , unsigned int V_13 )
{
F_64 ( F_72 ( V_128 ) ) ;
return 0 ;
}
static int F_73 ( struct V_95 * V_136 ,
const struct V_96 * V_137 )
{
static int V_13 ;
struct V_15 * V_16 ;
int V_7 ;
for ( ; V_13 < V_138 ; V_13 ++ ) {
if ( V_129 [ V_13 ] && V_130 [ V_13 ] )
break;
}
if ( V_13 >= V_138 )
return - V_24 ;
V_7 = F_49 ( & V_136 -> V_16 -> V_13 , V_13 , & V_16 ) ;
if ( V_7 < 0 )
return V_7 ;
if ( ( V_7 = F_40 ( V_13 , V_16 -> V_106 , V_136 , V_137 ) ) < 0 ) {
F_64 ( V_16 ) ;
return V_7 ;
}
if ( ( V_7 = F_51 ( V_16 , V_13 ) ) < 0 ) {
F_64 ( V_16 ) ;
return V_7 ;
}
F_74 ( V_136 , V_16 ) ;
...
static void F_75 ( struct V_95 * V_136 )
{
F_64 ( F_76 ( V_136 ) ) ;
F_74 ( V_136 , NULL ) ;
}
