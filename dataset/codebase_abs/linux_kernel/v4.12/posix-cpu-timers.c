...
if ( V_114 ) {
F_73 ( L_1 ,
V_47 -> V_115 , F_74 ( V_47 ) ) ;
}
F_75 ( V_116 , V_117 , V_47 ) ;
return;
}
...
struct V_30 * V_145 , struct V_149 T_5 * V_150 )
{
...
if ( V_57 & V_91 )
return - V_153 ;
V_152 = F_98 ( V_21 . V_88 ) ;
if ( V_150 && F_99 ( V_150 , & V_152 , sizeof( * V_150 ) ) )
return - V_154 ;
V_151 -> V_155 = V_156 ;
V_151 -> V_157 . V_158 = V_9 ;
V_151 -> V_157 . V_150 = V_150 ;
V_151 -> V_157 . V_23 = F_65 ( V_145 ) ;
}
return error ;
}
static long V_156 ( struct V_151 * V_151 )
{
T_2 V_9 = V_151 -> V_157 . V_158 ;
struct V_81 V_21 ;
struct V_30 V_99 ;
struct V_149 V_159 ;
int error ;
V_99 = F_34 ( V_151 -> V_157 . V_23 ) ;
error = F_91 ( V_9 , V_91 , & V_99 , & V_21 ) ;
if ( error == - V_148 ) {
struct V_149 T_5 * V_150 = V_151 -> V_157 . V_150 ;
V_159 = F_98 ( V_21 . V_88 ) ;
if ( V_150 && F_99 ( V_150 , & V_159 , sizeof( * V_150 ) ) )
return - V_154 ;
V_151 -> V_157 . V_23 = F_65 ( & V_99 ) ;
}
return error ;
}
static int F_100 ( const T_2 V_9 ,
struct V_30 * V_31 )
{
...
static int F_102 ( struct V_15 * V_16 )
{
V_16 -> V_54 = V_160 ;
return F_36 ( V_16 ) ;
}
static int F_103 ( const T_2 V_9 , int V_57 ,
struct V_30 * V_145 ,
struct V_149 T_5 * V_150 )
{
return F_96 ( V_160 , V_57 , V_145 , V_150 ) ;
}
static long F_104 ( struct V_151 * V_151 )
{
return - V_13 ;
}
