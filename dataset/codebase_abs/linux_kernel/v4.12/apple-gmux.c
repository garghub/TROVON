...
static void F_41 ( T_4 V_45 , T_2 V_51 , void * V_52 )
{
T_1 V_50 ;
...
static int F_44 ( struct V_45 * V_56 )
{
struct V_53 * V_54 = F_45 ( V_56 ) ;
struct V_1 * V_2 = F_42 ( V_54 ) ;
F_37 ( V_2 ) ;
return 0 ;
}
static int F_46 ( struct V_45 * V_56 )
{
struct V_53 * V_54 = F_45 ( V_56 ) ;
struct V_1 * V_2 = F_42 ( V_54 ) ;
F_38 ( V_2 ) ;
...
static struct V_40 * F_47 ( void )
{
struct V_40 * V_41 = NULL ;
while ( ( V_41 = F_48 ( V_58 << 8 , V_41 ) ) ) {
T_3 V_59 ;
F_49 ( V_41 , V_60 , & V_59 ) ;
if ( ! ( V_59 & V_61 ) )
continue;
...
static int F_50 ( struct V_45 * V_56 , void * V_62 )
{
return F_51 ( V_56 ) -> F_50 ;
}
static int F_52 ( struct V_53 * V_54 , const struct V_63 * V_31 )
{
struct V_1 * V_2 ;
struct V_64 * V_65 ;
struct V_66 V_19 ;
...
if ( V_1 )
return - V_73 ;
V_2 = F_53 ( sizeof( * V_2 ) , V_74 ) ;
if ( ! V_2 )
return - V_75 ;
F_54 ( V_54 , V_2 ) ;
V_65 = F_55 ( V_54 , V_76 , 0 ) ;
if ( ! V_65 ) {
F_56 ( L_6 ) ;
goto V_77;
}
V_2 -> V_4 = V_65 -> V_78 ;
V_2 -> V_79 = V_65 -> V_80 - V_65 -> V_78 ;
if ( V_2 -> V_79 < V_81 ) {
F_56 ( L_7 ,
V_2 -> V_79 , V_81 ) ;
goto V_77;
}
if ( ! F_57 ( V_2 -> V_4 , V_2 -> V_79 ,
L_8 ) ) {
F_56 ( L_9 ) ;
goto V_77;
}
...
V_69 = F_17 ( V_2 , V_83 ) ;
V_70 = F_17 ( V_2 , V_84 ) ;
if ( V_68 == 0xff && V_69 == 0xff && V_70 == 0xff ) {
if ( F_21 ( V_2 ) ) {
T_2 V_85 ;
F_58 ( & V_2 -> V_11 ) ;
V_2 -> V_13 = true ;
...
V_19 . type = V_90 ;
V_19 . V_91 = F_19 ( V_2 , V_92 ) ;
if ( F_62 ( V_19 . V_91 > V_93 ) )
V_19 . V_91 = V_93 ;
V_67 = F_63 ( L_16 , & V_54 -> V_56 ,
V_2 , & V_94 , & V_19 ) ;
if ( F_64 ( V_67 ) ) {
V_71 = F_65 ( V_67 ) ;
goto V_87;
...
V_2 -> V_67 = V_67 ;
V_67 -> V_19 . V_18 = F_22 ( V_67 ) ;
F_66 ( V_67 ) ;
F_67 ( V_95 ) ;
F_68 () ;
V_2 -> V_38 = V_36 ;
V_2 -> V_96 = F_69 ( & V_54 -> V_56 ) ;
if ( ! V_2 -> V_96 ) {
F_56 ( L_17 ,
F_70 ( & V_54 -> V_56 ) ) ;
V_71 = - V_86 ;
...
V_50 = F_71 ( V_2 -> V_96 , L_18 , NULL , & V_39 ) ;
if ( F_72 ( V_50 ) ) {
V_2 -> V_39 = ( int ) V_39 ;
V_50 = F_73 ( V_2 -> V_96 ,
V_98 ,
