...
static int F_32 ( struct V_39 * V_51 ,
unsigned int V_52 , const void * V_53 ,
struct V_2 * * V_54 )
{
struct V_39 * V_42 [ V_55 + 1 ] ;
struct V_2 * V_56 ;
struct V_1 * V_19 ;
int V_11 ;
if ( V_52 != V_57 && V_52 != V_58 )
return - V_59 ;
V_11 = F_26 ( V_42 , V_55 , V_51 , V_60 , NULL ) ;
if ( V_11 < 0 )
return V_11 ;
if ( ! V_42 [ V_61 ] && ! V_42 [ V_62 ] && ! V_42 [ V_63 ] )
return - V_18 ;
V_56 = F_33 ( sizeof( * V_19 ) ) ;
if ( ! V_56 )
return - V_34 ;
V_56 -> type = V_64 ;
V_19 = F_1 ( V_56 ) ;
...
if ( V_42 [ V_63 ] ) {
V_56 -> V_65 |= V_71 ;
V_11 = F_25 ( V_42 [ V_63 ] , & V_19 -> V_35 ,
V_72 ) ;
if ( V_11 < 0 )
goto V_68;
}
if ( V_42 [ V_73 ] ) {
T_1 V_74 = F_28 ( V_42 [ V_73 ] ) ;
if ( V_74 > V_75 ) {
V_11 = - V_76 ;
goto V_68;
}
...
{
struct V_1 * V_19 = F_1 ( V_3 ) ;
if ( F_34 ( V_6 , V_61 , & V_19 -> V_21 ) < 0 ||
F_34 ( V_6 , V_62 , & V_19 -> V_24 ) < 0 ||
F_34 ( V_6 , V_63 , & V_19 -> V_35 ) < 0 )
return - V_78 ;
return 0 ;
}
static int F_39 ( struct V_2 * V_20 )
{
int V_79 = F_40 ( sizeof( struct V_39 ) ) +
F_40 ( V_80 ) +
0 ;
return V_79 +
V_79 +
...
static int F_41 ( struct V_7 * V_81 , struct V_7 * V_82 )
{
if ( ! V_81 -> V_15 && ! V_82 -> V_15 )
return 0 ;
if ( ! V_81 -> V_15 || ! V_82 -> V_15 )
return 1 ;
return strcmp ( V_81 -> V_15 , V_82 -> V_15 ) ;
}
static int F_42 ( struct V_2 * V_81 , struct V_2 * V_82 )
{
struct V_1 * V_83 = F_1 ( V_81 ) ;
struct V_1 * V_84 = F_1 ( V_82 ) ;
return F_41 ( & V_83 -> V_21 , & V_84 -> V_21 ) ||
F_41 ( & V_83 -> V_24 , & V_84 -> V_24 ) ||
F_41 ( & V_83 -> V_35 , & V_84 -> V_35 ) ;
}
static int T_2 F_43 ( void )
{
return F_44 ( & V_85 , V_64 ) ;
}
