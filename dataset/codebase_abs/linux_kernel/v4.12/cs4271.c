...
bool V_83 = false ;
#ifdef F_27
if ( F_28 ( V_84 , V_11 -> V_2 ) ) {
if ( F_29 ( V_11 -> V_2 -> V_85 ,
L_4 , NULL ) )
V_83 = true ;
if ( F_29 ( V_11 -> V_2 -> V_85 ,
L_5 , NULL ) )
...
struct V_12 * V_13 ;
int V_36 , V_17 ;
V_13 = F_33 ( V_2 , sizeof( * V_13 ) , V_89 ) ;
if ( ! V_13 )
return - V_90 ;
if ( F_28 ( V_84 , V_2 ) )
V_13 -> V_78 =
...
int F_37 ( struct V_1 * V_2 , struct V_27 * V_27 )
{
struct V_12 * V_13 ;
int V_17 ;
if ( F_38 ( V_27 ) )
