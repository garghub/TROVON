...
V_128 = ( unsigned char * ) ( V_28 -> V_40 + V_62 ) ;
V_129 = F_72 ( V_127 -> V_130 ) ;
if ( V_129 > V_28 -> V_45 - V_62 )
goto V_63;
...
V_131 = F_27 ( V_2 , V_133 -> V_16 ) ;
if ( ! V_131 )
goto V_63;
V_28 -> V_134 = V_133 -> V_134 + 256 ;
if ( ! F_39 ( V_2 , V_133 -> V_95 ) &&
F_75 ( V_28 , V_6 , V_131 ) ) {
V_28 = NULL ;
V_38 = V_54 ;
goto V_67;
...
goto V_63;
V_139 = (struct V_138 * ) V_28 -> V_40 ;
if ( F_39 ( V_2 , V_139 -> V_16 ) )
goto V_63;
if ( V_139 -> V_51 < 2 )
goto V_63;
V_4 = F_27 ( V_2 , V_139 -> V_16 ) ;
if ( ! V_4 )
goto V_63;
F_3 ( & V_4 -> V_142 ) ;
V_141 = F_79 ( V_139 -> V_141 ) ;
if ( F_80 ( V_4 -> V_143 , V_4 -> V_144 ,
V_141 ) )
goto V_145;
V_140 = V_141 - V_4 -> V_144 ;
if ( F_14 ( V_2 , V_140 ,
V_146 ,
& V_4 -> V_147 , NULL ) )
goto V_145;
if ( F_81 ( V_2 , V_4 -> V_143 , V_140 , 1 ) )
V_4 -> V_144 = V_141 ;
F_7 ( & V_4 -> V_142 ) ;
if ( F_82 ( V_2 , V_28 ) )
goto V_63;
F_51 ( V_28 , sizeof( struct V_138 ) ) ;
