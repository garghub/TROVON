...
if ( V_102 & 1 << V_103 ) {
F_37 ( & V_7 -> V_7 , L_10 , V_103 ) ;
F_38 ( V_2 , V_103 , V_106 ) ;
}
}
return 0 ;
}
...
if ( ! V_116 )
return - V_107 ;
V_8 -> V_100 = F_43 ( V_89 , NULL , V_116 ) ;
F_44 ( V_116 ) ;
if ( ! V_8 -> V_100 ) {
F_27 ( V_64 , L_15 ) ;
return - V_94 ;
}
V_5 = F_45 ( V_8 -> V_1 , V_8 -> V_100 ) ;
if ( V_5 ) {
F_27 ( V_64 , L_16 ) ;
return V_5 ;
}
V_8 -> V_93 = F_46 ( V_89 , L_17 , 0 ) ;
if ( ! V_8 -> V_93 && F_47 ( V_89 ) ) {
V_5 = F_48 ( V_89 ) ;
if ( V_5 )
return V_5 ;
V_8 -> V_93 = F_49 ( V_89 ) ;
