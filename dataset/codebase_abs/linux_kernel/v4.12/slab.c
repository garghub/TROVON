...
F_151 ( V_25 , V_175 , V_15 ) ;
F_134 ( V_25 , V_175 ) ;
}
static void F_152 ( struct V_136 * V_181 )
{
struct V_14 * V_15 ;
struct V_25 * V_25 ;
V_25 = F_153 ( V_181 , struct V_25 , V_136 ) ;
V_15 = V_25 -> V_26 ;
F_144 ( V_15 , V_25 ) ;
}
...
static void F_157 ( struct V_14 * V_15 , unsigned long * V_182 ,
unsigned long V_183 )
{
int V_20 = V_15 -> V_184 ;
...
return;
if ( V_183 )
F_157 ( V_15 , V_16 , V_183 ) ;
F_162 ( F_78 ( V_16 ) , V_15 -> V_20 / V_39 , V_187 ) ;
}
static inline void F_161 ( struct V_14 * V_15 , void * V_16 ,
int V_187 , unsigned long V_183 ) {}
static void F_163 ( struct V_14 * V_15 , void * V_182 , unsigned char V_188 )
{
int V_20 = V_15 -> V_184 ;
...
static void F_164 ( char * V_190 , int V_30 , int V_66 )
{
int V_90 ;
...
static void F_167 ( struct V_14 * V_15 , void * V_16 , int V_194 )
{
int V_90 , V_20 ;
char * V_195 ;
if ( V_15 -> V_17 & V_18 ) {
...
{
int V_90 ;
if ( F_171 ( V_15 ) && V_15 -> V_17 & V_197 ) {
F_163 ( V_15 , V_25 -> V_198 - F_4 ( V_15 ) ,
V_192 ) ;
}
...
unsigned long F_184 ( unsigned long V_184 ,
...
struct V_14 *
F_185 ( const char * V_45 , T_2 V_20 , T_2 V_208 ,
unsigned long V_17 , void (* V_174)( void * ) )
{
struct V_14 * V_15 ;
V_15 = F_186 ( V_20 , V_208 , V_17 , V_45 , V_174 ) ;
if ( V_15 ) {
V_15 -> V_209 ++ ;
V_15 -> V_184 = F_187 ( int , V_15 -> V_184 , V_20 ) ;
}
return V_15 ;
}
...
if ( V_17 & V_213 )
return false ;
V_210 = F_178 ( V_15 , V_20 , V_17 | V_41 ) ;
if ( ! V_15 -> V_37 )
return false ;
...
if ( V_214 > F_193 (unsigned long long) )
V_17 &= ~ ( V_18 | V_19 ) ;
V_15 -> V_208 = V_214 ;
V_15 -> V_212 = F_194 () ;
...
V_20 = F_197 ( V_20 , V_15 -> V_208 ) ;
if ( V_216 && V_20 < V_217 )
V_20 = F_197 ( V_217 , V_15 -> V_208 ) ;
#if V_160
if ( F_155 () && ( V_17 & V_197 ) &&
V_20 >= 256 && V_15 -> V_184 > F_194 () ) {
if ( V_20 < V_39 || V_20 % V_39 == 0 ) {
T_2 V_218 = F_197 ( V_20 , V_39 ) ;
if ( F_189 ( V_15 , V_218 , V_17 ) ) {
V_17 |= V_41 ;
V_15 -> F_4 += V_218 - V_20 ;
V_20 = V_218 ;
goto V_219;
...
V_25 = F_213 ( V_227 , struct V_25 , V_135 ) ;
F_177 ( & V_25 -> V_135 ) ;
V_74 -> V_7 -- ;
V_74 -> V_6 -- ;
V_74 -> V_12 -= V_27 -> V_37 ;
...
{
void * V_198 ;
void * V_182 = F_220 ( V_25 ) ;
V_25 -> V_29 = V_182 + V_212 ;
V_25 -> V_230 = 0 ;
if ( F_171 ( V_15 ) )
V_198 = NULL ;
else if ( F_156 ( V_15 ) ) {
V_198 = F_221 ( V_15 -> V_201 ,
V_229 , V_84 ) ;
if ( ! V_198 )
return NULL ;
} else {
...
static inline V_42 F_222 ( struct V_25 * V_25 , unsigned int V_28 )
{
...
static void F_224 ( struct V_14 * V_15 , struct V_25 * V_25 )
{
#if V_160
int V_90 ;
for ( V_90 = 0 ; V_90 < V_15 -> V_37 ; V_90 ++ ) {
...
if ( V_15 -> V_17 & V_197 ) {
F_163 ( V_15 , V_16 , V_192 ) ;
F_161 ( V_15 , V_16 , 0 , 0 ) ;
}
}
#endif
}
static bool F_227 ( union V_231 * V_232 ,
struct V_14 * V_15 ,
unsigned int V_233 )
{
bool V_100 ;
...
static V_42 F_230 ( union V_231 * V_232 )
{
if ( V_232 -> V_236 >= V_232 -> V_233 )
V_232 -> V_236 = 0 ;
return V_232 -> V_76 [ V_232 -> V_236 ++ ] ;
}
static void F_231 ( struct V_25 * V_25 , unsigned int V_237 , unsigned int V_238 )
{
F_232 ( ( ( V_42 * ) V_25 -> V_198 ) [ V_237 ] ,
( ( V_42 * ) V_25 -> V_198 ) [ V_238 ] ) ;
}
static bool F_233 ( struct V_14 * V_15 , struct V_25 * V_25 )
{
...
F_223 ( V_25 , V_90 , V_90 ) ;
for ( V_90 = V_233 - 1 ; V_90 > 0 ; V_90 -- ) {
rand = F_234 ( & V_232 . V_235 ) ;
rand %= ( V_90 + 1 ) ;
F_231 ( V_25 , V_90 , rand ) ;
}
} else {
for ( V_90 = 0 ; V_90 < V_233 ; V_90 ++ )
F_223 ( V_25 , V_90 , F_230 ( & V_232 ) ) ;
}
if ( F_171 ( V_15 ) )
F_223 ( V_25 , V_15 -> V_37 - 1 , V_239 ) ;
return true ;
}
static inline bool F_233 ( struct V_14 * V_15 ,
struct V_25 * V_25 )
{
return false ;
}
...
static void * F_237 ( struct V_14 * V_15 , struct V_25 * V_25 )
{
void * V_16 ;
V_16 = F_16 ( V_15 , V_25 , F_222 ( V_25 , V_25 -> V_230 ) ) ;
V_25 -> V_230 ++ ;
#if V_160
if ( V_15 -> V_17 & V_19 )
F_13 ( V_15 ) ;
...
F_223 ( V_25 , V_25 -> V_230 , V_196 ) ;
}
static void F_239 ( struct V_14 * V_27 , struct V_25 * V_25 ,
void * V_198 )
{
V_25 -> V_26 = V_27 ;
V_25 -> V_198 = V_198 ;
}
static struct V_25 * F_240 ( struct V_14 * V_15 ,
T_4 V_17 , int V_84 )
{
void * V_198 ;
T_2 V_30 ;
...
V_30 = 0 ;
V_30 *= V_15 -> V_212 ;
V_198 = F_219 ( V_15 , V_25 , V_30 ,
V_229 & ~ V_244 , V_75 ) ;
if ( F_156 ( V_15 ) && ! V_198 )
goto V_247;
F_239 ( V_15 , V_25 , V_198 ) ;
F_243 ( V_25 ) ;
F_235 ( V_15 , V_25 ) ;
if ( F_241 ( V_229 ) )
F_244 () ;
...
static void F_245 ( struct V_14 * V_15 , struct V_25 * V_25 )
{
struct V_1 * V_74 ;
void * V_76 = NULL ;
F_200 () ;
...
V_74 -> V_6 ++ ;
if ( ! V_25 -> V_230 ) {
F_246 ( & V_25 -> V_135 , & ( V_74 -> V_5 ) ) ;
V_74 -> V_7 ++ ;
} else
F_247 ( V_15 , V_74 , V_25 , & V_76 ) ;
F_248 ( V_15 ) ;
V_74 -> V_12 += V_15 -> V_37 - V_25 -> V_230 ;
F_51 ( & V_74 -> V_11 ) ;
F_249 ( V_15 , & V_76 ) ;
}
static void F_250 ( const void * V_16 )
{
if ( ! F_251 ( V_16 ) ) {
F_23 ( L_23 ,
( unsigned long ) V_16 ) ;
...
static inline void F_252 ( struct V_14 * V_27 , void * V_24 )
{
...
static void * F_253 ( struct V_14 * V_15 , void * V_16 ,
unsigned long V_183 )
{
unsigned int V_196 ;
struct V_25 * V_25 ;
...
if ( V_15 -> V_17 & V_197 ) {
F_163 ( V_15 , V_16 , V_192 ) ;
F_161 ( V_15 , V_16 , 0 , V_183 ) ;
}
return V_16 ;
}
static inline void F_249 ( struct V_14 * V_15 ,
void * * V_76 )
{
#if V_160
void * V_251 = * V_76 ;
...
struct V_25 * F_254 ( struct V_1 * V_74 , bool V_252 )
{
struct V_25 * V_25 ;
F_207 ( & V_74 -> V_11 ) ;
V_25 = F_255 ( & V_74 -> V_4 , struct V_25 , V_135 ) ;
if ( ! V_25 ) {
V_74 -> V_13 = 1 ;
V_25 = F_255 ( & V_74 -> V_5 , struct V_25 ,
V_135 ) ;
if ( V_25 )
V_74 -> V_7 -- ;
}
if ( F_138 () )
V_25 = F_256 ( V_74 , V_25 , V_252 ) ;
return V_25 ;
}
static T_5 void * F_257 ( struct V_14 * V_15 ,
...
return NULL ;
F_49 ( & V_74 -> V_11 ) ;
V_25 = F_254 ( V_74 , true ) ;
if ( ! V_25 ) {
F_51 ( & V_74 -> V_11 ) ;
return NULL ;
}
V_24 = F_237 ( V_15 , V_25 ) ;
V_74 -> V_12 -- ;
F_247 ( V_15 , V_74 , V_25 , & V_76 ) ;
F_51 ( & V_74 -> V_11 ) ;
F_249 ( V_15 , & V_76 ) ;
...
static T_9 int F_259 ( struct V_14 * V_15 ,
...
F_261 ( V_15 ) ;
F_262 ( V_15 ) ;
V_65 -> V_81 [ V_65 -> V_68 ++ ] = F_237 ( V_15 , V_25 ) ;
}
return V_69 ;
}
static void * F_263 ( struct V_14 * V_15 , T_4 V_17 )
{
int V_69 ;
struct V_1 * V_74 ;
...
while ( V_69 > 0 ) {
V_25 = F_254 ( V_74 , false ) ;
if ( ! V_25 )
goto V_256;
F_205 ( V_15 ) ;
V_69 = F_259 ( V_15 , V_65 , V_25 , V_69 ) ;
F_247 ( V_15 , V_74 , V_25 , & V_76 ) ;
}
V_256:
V_74 -> V_12 -= V_65 -> V_68 ;
...
if ( F_76 ( ! V_65 -> V_68 ) ) {
if ( F_138 () ) {
void * V_24 = F_257 ( V_15 , V_74 , V_17 ) ;
if ( V_24 )
return V_24 ;
}
V_25 = F_240 ( V_15 , F_60 ( V_17 ) , V_57 ) ;
V_65 = F_19 ( V_15 ) ;
if ( ! V_65 -> V_68 && V_25 )
F_259 ( V_15 , V_65 , V_25 , V_69 ) ;
F_245 ( V_15 , V_25 ) ;
if ( ! V_65 -> V_68 )
return NULL ;
}
...
static inline void F_265 ( struct V_14 * V_15 ,
T_4 V_17 )
{
F_266 ( F_241 ( V_17 ) ) ;
}
...
static inline void * F_268 ( struct V_14 * V_15 , T_4 V_17 )
{
void * V_16 ;
struct V_32 * V_65 ;
F_200 () ;
...
F_270 ( V_15 ) ;
V_16 = F_263 ( V_15 , V_17 ) ;
V_65 = F_19 ( V_15 ) ;
V_124:
if ( V_16 )
F_271 ( & V_65 -> V_81 [ V_65 -> V_68 ] ) ;
return V_16 ;
}
...
static void * F_276 ( struct V_14 * V_27 , T_4 V_17 )
{
struct V_263 * V_263 ;
struct V_264 * V_265 ;
struct V_266 * V_266 ;
enum V_267 V_268 = F_277 ( V_17 ) ;
void * V_24 = NULL ;
struct V_25 * V_25 ;
int V_122 ;
unsigned int V_269 ;
...
V_256:
F_51 ( & V_74 -> V_11 ) ;
V_25 = F_240 ( V_15 , F_60 ( V_17 ) , V_84 ) ;
if ( V_25 ) {
V_24 = F_237 ( V_15 , V_25 ) ;
}
F_245 ( V_15 , V_25 ) ;
return V_24 ? V_24 : F_276 ( V_15 , V_17 ) ;
}
static T_9 void *
F_286 ( struct V_14 * V_15 , T_4 V_17 , int V_84 ,
unsigned long V_183 )
{
unsigned long V_273 ;
void * V_131 ;
...
V_131 = F_276 ( V_15 , V_17 ) ;
goto V_124;
}
if ( V_84 == V_274 ) {
V_131 = F_268 ( V_15 , V_17 ) ;
if ( V_131 )
goto V_124;
}
...
V_124:
F_289 ( V_273 ) ;
V_131 = F_267 ( V_15 , V_17 , V_131 , V_183 ) ;
if ( F_76 ( V_17 & V_277 ) && V_131 )
memset ( V_131 , 0 , V_15 -> V_184 ) ;
F_290 ( V_15 , V_17 , 1 , & V_131 ) ;
return V_131 ;
}
static T_9 void *
F_291 ( struct V_14 * V_27 , T_4 V_17 )
{
void * V_16 ;
if ( V_178 -> V_262 || F_273 () ) {
V_16 = F_58 ( V_27 , V_17 ) ;
if ( V_16 )
goto V_124;
}
V_16 = F_268 ( V_27 , V_17 ) ;
if ( ! V_16 )
...
static T_9 void *
F_291 ( struct V_14 * V_15 , T_4 V_17 )
{
return F_268 ( V_15 , V_17 ) ;
}
static T_9 void *
F_292 ( struct V_14 * V_15 , T_4 V_17 , unsigned long V_183 )
{
unsigned long V_273 ;
void * V_16 ;
V_17 &= V_275 ;
...
F_265 ( V_15 , V_17 ) ;
F_288 ( V_273 ) ;
V_16 = F_291 ( V_15 , V_17 ) ;
F_289 ( V_273 ) ;
V_16 = F_267 ( V_15 , V_17 , V_16 , V_183 ) ;
F_293 ( V_16 ) ;
if ( F_76 ( V_17 & V_277 ) && V_16 )
memset ( V_16 , 0 , V_15 -> V_184 ) ;
F_290 ( V_15 , V_17 , 1 , & V_16 ) ;
return V_16 ;
}
...
F_177 ( & V_25 -> V_135 ) ;
F_208 ( V_15 , V_57 ) ;
F_238 ( V_15 , V_25 , V_16 ) ;
F_294 ( V_15 ) ;
if ( V_25 -> V_230 == 0 ) {
F_114 ( & V_25 -> V_135 , & V_74 -> V_5 ) ;
V_74 -> V_7 ++ ;
} else {
F_246 ( & V_25 -> V_135 , & V_74 -> V_4 ) ;
}
}
while ( V_74 -> V_12 > V_74 -> V_95 && ! F_102 ( & V_74 -> V_5 ) ) {
V_74 -> V_12 -= V_15 -> V_37 ;
V_25 = F_295 ( & V_74 -> V_5 , struct V_25 , V_135 ) ;
F_296 ( & V_25 -> V_135 , V_76 ) ;
V_74 -> V_7 -- ;
V_74 -> V_6 -- ;
}
}
static void F_297 ( struct V_14 * V_15 , struct V_32 * V_65 )
{
int V_69 ;
struct V_1 * V_74 ;
int V_57 = F_79 () ;
...
static inline void F_299 ( struct V_14 * V_15 , void * V_16 ,
unsigned long V_183 )
{
if ( F_300 ( V_15 , V_16 ) )
return;
F_301 ( V_15 , V_16 , V_183 ) ;
}
void F_301 ( struct V_14 * V_15 , void * V_16 ,
unsigned long V_183 )
{
struct V_32 * V_65 = F_19 ( V_15 ) ;
F_200 () ;
F_302 ( V_16 , V_15 -> V_17 ) ;
V_16 = F_253 ( V_15 , V_16 , V_183 ) ;
F_303 ( V_15 , V_16 , V_15 -> V_184 ) ;
...
void * F_307 ( struct V_14 * V_15 , T_4 V_17 )
{
void * V_100 = F_292 ( V_15 , V_17 , V_284 ) ;
F_308 ( V_15 , V_100 , V_17 ) ;
F_309 ( V_284 , V_100 ,
V_15 -> V_184 , V_15 -> V_20 , V_17 ) ;
return V_100 ;
}
static T_9 void
F_310 ( struct V_14 * V_48 , T_4 V_17 ,
T_2 V_20 , void * * V_227 , unsigned long V_183 )
{
T_2 V_90 ;
for ( V_90 = 0 ; V_90 < V_20 ; V_90 ++ )
V_227 [ V_90 ] = F_267 ( V_48 , V_17 , V_227 [ V_90 ] , V_183 ) ;
}
int F_311 ( struct V_14 * V_48 , T_4 V_17 , T_2 V_20 ,
void * * V_227 )
{
T_2 V_90 ;
V_48 = F_287 ( V_48 , V_17 ) ;
if ( ! V_48 )
return 0 ;
F_265 ( V_48 , V_17 ) ;
F_244 () ;
for ( V_90 = 0 ; V_90 < V_20 ; V_90 ++ ) {
void * V_16 = F_291 ( V_48 , V_17 ) ;
if ( F_76 ( ! V_16 ) )
goto error;
V_227 [ V_90 ] = V_16 ;
}
F_242 () ;
F_310 ( V_48 , V_17 , V_20 , V_227 , V_284 ) ;
if ( F_76 ( V_17 & V_277 ) )
for ( V_90 = 0 ; V_90 < V_20 ; V_90 ++ )
memset ( V_227 [ V_90 ] , 0 , V_48 -> V_184 ) ;
F_290 ( V_48 , V_17 , V_20 , V_227 ) ;
return V_20 ;
error:
F_242 () ;
F_310 ( V_48 , V_17 , V_90 , V_227 , V_284 ) ;
F_290 ( V_48 , V_17 , V_90 , V_227 ) ;
F_312 ( V_48 , V_90 , V_227 ) ;
return 0 ;
}
void *
F_313 ( struct V_14 * V_15 , T_4 V_17 , T_2 V_20 )
{
void * V_100 ;
V_100 = F_292 ( V_15 , V_17 , V_284 ) ;
F_314 ( V_15 , V_100 , V_20 , V_17 ) ;
F_315 ( V_284 , V_100 ,
V_20 , V_15 -> V_20 , V_17 ) ;
return V_100 ;
}
void * F_221 ( struct V_14 * V_15 , T_4 V_17 , int V_84 )
{
void * V_100 = F_286 ( V_15 , V_17 , V_84 , V_284 ) ;
F_308 ( V_15 , V_100 , V_17 ) ;
F_316 ( V_284 , V_100 ,
...
void * F_317 ( struct V_14 * V_15 ,
T_4 V_17 ,
int V_84 ,
T_2 V_20 )
{
void * V_100 ;
V_100 = F_286 ( V_15 , V_17 , V_84 , V_284 ) ;
F_314 ( V_15 , V_100 , V_20 , V_17 ) ;
F_318 ( V_284 , V_100 ,
V_20 , V_15 -> V_20 ,
V_17 , V_84 ) ;
...
static T_9 void *
F_319 ( T_2 V_20 , T_4 V_17 , int V_57 , unsigned long V_183 )
{
struct V_14 * V_15 ;
void * V_100 ;
...
if ( F_76 ( F_320 ( V_15 ) ) )
return V_15 ;
V_100 = F_317 ( V_15 , V_17 , V_57 , V_20 ) ;
F_314 ( V_15 , V_100 , V_20 , V_17 ) ;
return V_100 ;
}
void * F_321 ( T_2 V_20 , T_4 V_17 , int V_57 )
{
return F_319 ( V_20 , V_17 , V_57 , V_284 ) ;
}
void * F_322 ( T_2 V_20 , T_4 V_17 ,
int V_57 , unsigned long V_183 )
{
return F_319 ( V_20 , V_17 , V_57 , V_183 ) ;
}
static T_9 void * F_323 ( T_2 V_20 , T_4 V_17 ,
unsigned long V_183 )
{
struct V_14 * V_15 ;
void * V_100 ;
...
if ( F_76 ( F_320 ( V_15 ) ) )
return V_15 ;
V_100 = F_292 ( V_15 , V_17 , V_183 ) ;
F_314 ( V_15 , V_100 , V_20 , V_17 ) ;
F_315 ( V_183 , V_100 ,
V_20 , V_15 -> V_20 , V_17 ) ;
return V_100 ;
}
void * F_324 ( T_2 V_20 , T_4 V_17 )
{
return F_323 ( V_20 , V_17 , V_284 ) ;
}
void * F_325 ( T_2 V_20 , T_4 V_17 , unsigned long V_183 )
{
return F_323 ( V_20 , V_17 , V_183 ) ;
}
void F_175 ( struct V_14 * V_15 , void * V_16 )
{
unsigned long V_17 ;
V_15 = F_326 ( V_15 , V_16 ) ;
if ( ! V_15 )
return;
F_288 ( V_17 ) ;
F_327 ( V_16 , V_15 -> V_184 ) ;
if ( ! ( V_15 -> V_17 & V_285 ) )
F_328 ( V_16 , V_15 -> V_184 ) ;
F_299 ( V_15 , V_16 , V_284 ) ;
F_289 ( V_17 ) ;
F_329 ( V_284 , V_16 ) ;
}
void F_330 ( struct V_14 * V_286 , T_2 V_20 , void * * V_227 )
{
struct V_14 * V_48 ;
T_2 V_90 ;
F_244 () ;
...
V_48 = F_326 ( V_286 , V_16 ) ;
F_327 ( V_16 , V_48 -> V_184 ) ;
if ( ! ( V_48 -> V_17 & V_285 ) )
F_328 ( V_16 , V_48 -> V_184 ) ;
F_299 ( V_48 , V_16 , V_284 ) ;
}
F_242 () ;
}
...
F_250 ( V_16 ) ;
V_287 = F_14 ( V_16 ) ;
F_327 ( V_16 , V_287 -> V_184 ) ;
F_328 ( V_16 , V_287 -> V_184 ) ;
F_299 ( V_287 , ( void * ) V_16 , V_284 ) ;
F_289 ( V_17 ) ;
}
static int F_332 ( struct V_14 * V_15 , T_4 V_72 )
{
int V_100 ;
int V_57 ;
struct V_1 * V_74 ;
...
static int F_333 ( struct V_14 * V_15 , int V_66 ,
...
F_218 ( V_228 ) ;
V_288:
return F_332 ( V_15 , V_72 ) ;
}
static int F_336 ( struct V_14 * V_15 , int V_66 ,
int V_69 , int V_8 , T_4 V_72 )
{
int V_100 ;
struct V_14 * V_287 ;
V_100 = F_333 ( V_15 , V_66 , V_69 , V_8 , V_72 ) ;
if ( V_145 < V_156 )
return V_100 ;
if ( ( V_100 < 0 ) || ! F_337 ( V_15 ) )
return V_100 ;
F_338 ( & V_114 ) ;
F_339 (c, cachep) {
F_333 ( V_287 , V_66 , V_69 , V_8 , V_72 ) ;
}
return V_100 ;
}
...
int V_8 = 0 ;
int V_69 = 0 ;
V_112 = F_340 ( V_15 , V_15 -> V_37 , V_72 ) ;
if ( V_112 )
goto V_289;
if ( ! F_337 ( V_15 ) ) {
struct V_14 * V_290 = F_341 ( V_15 ) ;
V_66 = V_290 -> V_66 ;
V_8 = V_290 -> V_8 ;
V_69 = V_290 -> V_69 ;
}
...
V_69 = ( V_66 + 1 ) / 2 ;
V_291:
V_112 = F_336 ( V_15 , V_66 , V_69 , V_8 , V_72 ) ;
V_289:
if ( V_112 )
F_23 ( L_29 ,
V_15 -> V_45 , - V_112 ) ;
...
static void F_343 ( struct V_14 * V_15 , struct V_1 * V_74 ,
struct V_32 * V_65 , int V_57 )
{
F_46 ( V_76 ) ;
F_203 () ;
...
F_67 ( V_294 , V_74 ) ;
F_343 ( V_294 , V_74 , F_19 ( V_294 ) , V_57 ) ;
if ( F_346 ( V_74 -> V_97 , V_98 ) )
goto V_251;
V_74 -> V_97 = V_98 + V_99 ;
F_343 ( V_294 , V_74 , V_74 -> V_8 , V_57 ) ;
if ( V_74 -> V_13 )
V_74 -> V_13 = 0 ;
else {
int V_295 ;
...
F_34 () ;
V_124:
F_349 ( V_61 , F_350 ( V_296 ) ) ;
}
void F_351 ( struct V_14 * V_15 , struct V_297 * V_298 )
{
...
void F_352 ( struct V_306 * V_307 , struct V_14 * V_15 )
{
#if V_282
{
...
static inline int F_356 ( unsigned long * V_74 , unsigned long V_333 )
{
unsigned long * V_227 ;
int V_334 ;
if ( ! V_333 )
...
static void F_357 ( unsigned long * V_74 , struct V_14 * V_287 ,
struct V_25 * V_25 )
{
void * V_227 ;
int V_90 , V_336 ;
...
if ( ! V_230 )
continue;
if ( F_358 ( & V_333 , F_8 ( V_287 , V_227 ) , sizeof( V_333 ) ) )
continue;
if ( ! F_356 ( V_74 , V_333 ) )
return;
}
...
if ( F_361 ( V_337 , & V_20 , & V_30 , V_338 , V_45 ) == 0 ) {
F_353 ( V_307 , L_33 , V_45 , V_30 , V_20 ) ;
if ( V_338 [ 0 ] )
F_353 ( V_307 , L_34 , V_338 ) ;
return;
}
#endif
F_353 ( V_307 , L_35 , ( void * ) V_337 ) ;
}
static int F_362 ( struct V_306 * V_307 , void * V_227 )
{
struct V_14 * V_15 = F_213 ( V_227 , struct V_14 , V_76 ) ;
struct V_25 * V_25 ;
struct V_1 * V_74 ;
const char * V_45 ;
...
if ( V_341 [ 0 ] == V_341 [ 1 ] ) {
F_96 ( & V_114 ) ;
V_307 -> V_342 = F_363 ( V_341 [ 0 ] * 4 * sizeof( unsigned long ) , V_101 ) ;
if ( ! V_307 -> V_342 ) {
V_307 -> V_342 = V_341 ;
F_95 ( & V_114 ) ;
return - V_96 ;
...
F_353 ( V_307 , L_36 , V_45 , V_341 [ 2 * V_90 + 3 ] ) ;
F_359 ( V_307 , V_341 [ 2 * V_90 + 2 ] ) ;
F_364 ( V_307 , '\n' ) ;
}
return 0 ;
}
...
{
#ifdef F_368
F_369 ( L_37 , 0 , NULL , & V_345 ) ;
#endif
return 0 ;
}
const char * F_370 ( const void * V_131 , unsigned long V_74 ,
struct V_25 * V_25 )
{
struct V_14 * V_15 ;
unsigned int V_196 ;
