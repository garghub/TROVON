...
static int F_194 ( struct V_101 * V_24 , struct V_33 * V_307 ,
struct V_308 * V_309 )
{
...
unsigned int V_38 ;
int V_153 ;
V_153 = F_195 ( V_307 , & V_314 ) ;
if ( V_153 )
return V_153 ;
F_20 ( V_24 , L_70 , V_307 -> V_315 ,
V_314 . V_316 . V_317 ) ;
switch ( V_314 . V_316 . V_317 ) {
case V_318 :
V_311 -> V_261 = V_262 ;
V_311 -> V_312 . V_319 . V_88 =
V_314 . V_312 . V_319 . V_320 ;
V_311 -> V_312 . V_319 . V_86 =
! ! ( V_314 . V_312 . V_319 . V_18
& V_321 ) ;
V_311 -> V_312 . V_319 . V_322 =
! ! ( V_314 . V_312 . V_319 . V_18 & V_323 ) ;
V_311 -> V_312 . V_319 . V_324 =
! ! ( V_314 . V_312 . V_319 . V_18 & V_325 ) ;
V_311 -> V_312 . V_319 . V_326 =
! ! ( V_314 . V_312 . V_319 . V_18 & V_327 ) ;
V_311 -> V_312 . V_319 . V_328 =
! ! ( V_314 . V_312 . V_319 . V_18 & V_329 ) ;
break;
case V_330 :
case V_331 :
switch ( V_314 . V_316 . V_317 ) {
...
V_311 -> V_312 . V_332 . V_333 . V_26 . V_334 = V_314 . V_312 . V_335 . V_336 ;
V_311 -> V_312 . V_332 . V_333 . V_26 . V_337 =
V_314 . V_312 . V_335 . V_338 [ 0 ] ;
F_20 ( V_24 , L_71 ,
V_311 -> V_312 . V_332 . V_333 . V_26 . V_337 ,
V_311 -> V_312 . V_332 . V_333 . V_26 . V_334 ) ;
for ( V_38 = 0 ; V_38 < V_339 ; V_38 ++ ) {
V_311 -> V_312 . V_332 . V_333 . V_29 [ V_38 ] . V_334 =
V_314 . V_312 . V_335 . V_340 [ V_38 ] ;
V_311 -> V_312 . V_332 . V_333 . V_29 [ V_38 ] . V_337 =
V_314 . V_312 . V_335 . V_338 [ V_38 + 1 ] ;
F_20 ( V_24 , L_72 , V_38 ,
V_311 -> V_312 . V_332 . V_333 . V_29 [ V_38 ] . V_337 ,
V_311 -> V_312 . V_332 . V_333 . V_29 [ V_38 ] . V_334 ) ;
}
V_311 -> V_312 . V_332 . V_341 = 1 ;
break;
default:
F_122 ( V_24 , L_73 , V_307 -> V_315 ,
V_314 . V_316 . V_317 ) ;
break;
}
return 0 ;
}
static int F_196 ( struct V_101 * V_24 ,
struct V_342 * V_306 )
{
struct V_33 * V_307 = NULL ;
V_306 -> V_343 = F_197 (
V_24 , V_344 , sizeof( * V_306 -> V_343 ) , V_345 ) ;
if ( ! V_306 -> V_343 )
return - V_346 ;
while ( V_306 -> V_347 < V_344 &&
( V_307 = F_198 ( V_24 -> V_35 , V_307 ) ) ) {
struct V_308 * V_309 ;
V_309 = F_199 ( V_24 , sizeof( * V_309 ) , V_345 ) ;
if ( ! V_309 )
goto error;
V_306 -> V_343 [ V_306 -> V_347 ] = & V_309 -> V_348 ;
if ( F_194 ( V_24 , V_307 , V_309 ) )
goto error;
V_309 -> V_348 . V_349 . V_350 . V_307 = F_200 ( V_307 ) ;
if ( ! V_309 -> V_348 . V_349 . V_350 . V_307 ) {
F_122 ( V_24 , L_74 ) ;
goto error;
}
V_309 -> V_348 . V_351 = V_352 ;
V_306 -> V_347 ++ ;
}
return V_306 -> V_347 ;
error:
...
static int F_202 ( struct V_342 * V_353 ,
struct V_152 * V_110 ,
struct V_354 * V_348 )
{
struct V_308 * V_309 =
F_203 ( V_348 , struct V_308 , V_348 ) ;
V_309 -> V_355 = V_110 ;
V_309 -> V_355 -> V_356 = & V_309 -> V_312 ;
return 0 ;
}
static int F_204 ( struct V_342 * V_353 )
{
struct V_1 * V_2 = F_203 ( V_353 , struct V_1 ,
V_306 ) ;
struct V_357 * V_258 = & V_2 -> V_258 ;
struct V_152 * V_355 ;
struct V_310 * V_312 ;
int V_153 ;
V_153 = F_205 ( & V_2 -> V_155 , & V_2 -> V_259 ) ;
if ( V_153 )
return V_153 ;
F_206 (sd, &v4l2_dev->subdevs, list) {
if ( V_355 -> V_356 ) {
V_312 = (struct V_310 * ) V_355 -> V_356 ;
V_153 = F_153 ( V_2 , & V_355 -> V_111 , V_312 -> V_261 ) ;
if ( V_153 < 0 )
return V_153 ;
}
}
V_153 = F_207 ( & V_2 -> V_258 ) ;
if ( V_153 < 0 )
return V_153 ;
return F_208 ( & V_2 -> V_259 ) ;
}
static int F_209 ( struct V_304 * V_305 )
{
struct V_1 * V_2 ;
struct V_358 * V_359 ;
int V_153 ;
int V_38 , V_360 ;
V_2 = F_199 ( & V_305 -> V_24 , sizeof( * V_2 ) , V_345 ) ;
if ( ! V_2 ) {
F_119 ( & V_305 -> V_24 , L_75 ) ;
return - V_346 ;
}
V_153 = F_210 ( V_305 -> V_24 . V_35 , L_76 ,
& V_2 -> V_361 ) ;
if ( V_153 )
return V_153 ;
V_2 -> V_362 = F_211 ( V_305 -> V_24 . V_35 ,
L_77 ) ;
if ( F_27 ( V_2 -> V_362 ) )
return F_28 ( V_2 -> V_362 ) ;
V_153 = F_212 ( V_305 -> V_24 . V_35 , L_77 , 1 ,
& V_2 -> V_363 ) ;
if ( V_153 )
return V_153 ;
V_153 = F_196 ( & V_305 -> V_24 , & V_2 -> V_306 ) ;
if ( V_153 < 0 )
return V_153 ;
V_2 -> V_69 = V_69 ;
F_213 ( & V_2 -> V_235 ) ;
...
V_2 -> V_24 = & V_305 -> V_24 ;
V_2 -> V_236 = 0 ;
V_153 = F_214 ( V_2 -> V_24 , F_215 ( 32 ) ) ;
if ( V_153 )
goto error;
F_216 ( V_305 , V_2 ) ;
V_2 -> V_365 . V_366 = F_217 ( & V_305 -> V_24 , L_78 ) ;
V_2 -> V_367 . V_366 = F_217 ( & V_305 -> V_24 , L_79 ) ;
for ( V_38 = 0 ; V_38 < 2 ; V_38 ++ ) {
unsigned int V_368 = V_38 ? V_369 : 0 ;
V_359 = F_218 ( V_305 , V_370 , V_38 ) ;
V_2 -> V_371 [ V_368 ] =
F_219 ( V_2 -> V_24 , V_359 ) ;
...
V_2 -> V_383 = V_153 ;
if ( F_223 ( V_2 -> V_24 , V_2 -> V_383 , F_46 , V_384 ,
L_84 , V_2 ) ) {
F_119 ( V_2 -> V_24 , L_85 ) ;
V_153 = - V_39 ;
goto V_382;
...
if ( V_153 < 0 )
goto V_386;
V_2 -> V_306 . V_387 = F_202 ;
V_2 -> V_306 . V_388 = F_204 ;
V_153 = F_224 ( & V_2 -> V_258 , & V_2 -> V_306 ) ;
if ( V_153 )
goto V_386;
F_35 ( V_2 , 1 ) ;
F_10 ( V_2 ) ;
