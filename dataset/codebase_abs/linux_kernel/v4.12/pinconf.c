...
F_19 ( V_35 , L_16 , V_15 [ V_13 ] ) ;
F_18 ( V_35 , L_17 ) ;
}
}
void F_20 ( struct V_34 * V_35 , struct V_11 const * V_12 )
{
struct V_1 * V_2 ;
V_2 = F_8 ( V_12 -> V_37 ) ;
switch ( V_12 -> type ) {
...
F_19 ( V_35 , L_20 , V_12 -> V_14 . V_15 . V_16 ) ;
F_17 ( V_35 , V_2 , V_12 -> V_14 . V_15 . V_15 ,
V_12 -> V_14 . V_15 . V_18 ) ;
}
void F_21 ( struct V_34 * V_35 ,
...
{
const struct V_3 * V_4 = V_2 -> V_5 -> V_6 ;
F_24 ( V_2 , V_35 , NULL , V_19 ) ;
if ( V_4 && V_4 -> V_42 )
V_4 -> V_42 ( V_2 , V_35 , V_19 ) ;
}
static int F_25 ( struct V_34 * V_35 , void * V_43 )
{
...
{
const struct V_3 * V_4 = V_2 -> V_5 -> V_6 ;
F_24 ( V_2 , V_35 , V_48 , 0 ) ;
if ( V_4 && V_4 -> V_49 )
V_4 -> V_49 ( V_2 , V_35 , V_25 ) ;
}
static int F_27 ( struct V_34 * V_35 , void * V_43 )
{
struct V_1 * V_2 = V_35 -> V_44 ;
const struct V_38 * V_39 = V_2 -> V_5 -> V_39 ;
...
F_19 ( V_35 , L_28 , V_25 , V_48 ) ;
F_26 ( V_2 , V_35 , V_25 , V_48 ) ;
F_19 ( V_35 , L_17 ) ;
V_25 ++ ;
}
return 0 ;
...
{
return F_29 ( V_53 , F_25 , V_52 -> V_54 ) ;
}
static int F_30 ( struct V_52 * V_52 , struct V_53 * V_53 )
{
return F_29 ( V_53 , F_27 , V_52 -> V_54 ) ;
}
static int F_31 ( struct V_34 * V_35 , void * V_55 )
{
struct V_56 * V_57 ;
...
if ( ! V_58 ) {
F_19 ( V_35 , L_29 ) ;
F_19 ( V_35 , L_30 , V_60 -> V_23 ) ;
F_19 ( V_35 , L_31 , V_60 -> V_64 ) ;
F_19 ( V_35 , L_32 , V_60 -> V_65 ) ;
F_19 ( V_35 , L_33\
L_34 ) ;
goto exit;
}
...
static T_2 F_33 ( struct V_53 * V_53 ,
...
char * V_74 ;
int V_13 ;
V_73 = F_34 ( V_67 , sizeof( V_71 ) - 1 ) ;
if ( F_35 ( V_71 , V_66 , V_73 ) )
return - V_75 ;
V_71 [ V_73 ] = 0 ;
V_74 = F_36 ( & V_72 , L_36 ) ;
if ( ! V_74 )
...
static int F_37 ( struct V_52 * V_52 , struct V_53 * V_53 )
{
return F_29 ( V_53 , F_31 , V_52 -> V_54 ) ;
}
void F_38 ( struct V_77 * V_78 ,
struct V_1 * V_2 )
{
F_39 ( L_40 , V_79 | V_80 ,
V_78 , V_2 , & V_81 ) ;
