...
static void
V_887 ( struct V_6 * V_7 , unsigned long V_608 ,
int V_23 , T_3 * V_18 ,
T_4 V_609 )
{
struct V_762 * V_763 = V_7 -> V_112 ;
...
static bool F_313 ( struct V_6 * V_7 , T_1 V_888 ,
unsigned int V_764 )
{
struct V_762 * V_763 = V_7 -> V_112 ;
struct V_746 * V_753 =
...
for ( V_118 = 0 ; V_118 < V_927 ; ++ V_118 )
if ( V_102 -> V_928 [ V_118 ] == V_764 )
V_102 -> V_928 [ V_118 ] =
V_2 ;
F_54 ( V_753 ) ;
F_279 ( V_763 , V_764 , NULL , 0 ) ;
...
struct V_762 * V_763 = V_7 -> V_112 ;
unsigned int V_118 ;
for ( V_118 = 0 ; V_118 < V_763 -> V_929 ; V_118 ++ )
F_332 ( V_7 , & V_102 -> V_930 [ V_118 ] ) ;
for ( V_118 = 0 ; V_118 < V_763 -> V_931 ; V_118 ++ )
F_332 ( V_7 , & V_102 -> V_932 [ V_118 ] ) ;
for ( V_118 = 0 ; V_118 < V_927 ; V_118 ++ )
F_332 ( V_7 , & V_102 -> V_928 [ V_118 ] ) ;
}
...
unsigned int V_118 ;
V_934 = F_336 ( V_34 ) ;
V_763 -> V_935 = ! ! ( V_34 -> V_259 & V_936 ) ;
V_763 -> V_929 = 1 + V_934 ;
F_32 ( V_763 -> V_937 [ 0 ] . V_337 , V_34 -> V_938 ) ;
V_118 = 1 ;
F_337 (uc, net_dev) {
if ( V_118 >= V_939 ) {
V_763 -> V_935 = true ;
...
F_32 ( V_763 -> V_937 [ V_118 ] . V_337 , V_930 -> V_337 ) ;
V_118 ++ ;
}
}
...
struct V_915 * V_34 = V_7 -> V_34 ;
struct V_933 * V_932 ;
unsigned int V_118 , V_934 ;
V_763 -> V_940 = false ;
V_763 -> V_941 = ! ! ( V_34 -> V_259 & ( V_936 | V_942 ) ) ;
V_934 = F_339 ( V_34 ) ;
V_118 = 0 ;
F_340 (mc, net_dev) {
if ( V_118 >= V_943 ) {
...
F_32 ( V_763 -> V_944 [ V_118 ] . V_337 , V_932 -> V_337 ) ;
V_118 ++ ;
}
V_763 -> V_931 = V_118 ;
}
...
for ( V_118 = 0 ; V_118 < V_934 ; V_118 ++ ) {
F_312 ( V_953 [ V_118 ] != V_2 ) ;
...
V_7 -> V_34 -> V_938 ) ;
if ( ! V_23 ) {
F_32 ( V_21 -> V_980 , V_7 -> V_34 -> V_938 ) ;
} else {
...
struct V_762 * V_763 = V_7 -> V_112 ;
struct V_20 * V_21 = V_7 -> V_21 ;
if ( ( V_102 -> V_101 == V_148 ) == V_763 -> V_922 )
return;
if ( V_763 -> V_935 ) {
...
F_338 ( V_7 ) ;
F_362 ( V_34 ) ;
V_922 = ! ! ( V_34 -> V_918 & V_916 ) ;
if ( V_763 -> V_922 != V_922 ) {
V_763 -> V_922 = V_922 ;
F_350 ( V_7 ) ;
}
F_43 (vlan, &table->vlan_list, list)
...
static struct V_903 * F_363 ( struct V_6 * V_7 , T_2 V_101 )
{
struct V_762 * V_763 = V_7 -> V_112 ;
struct V_903 * V_102 ;
F_36 ( ! F_329 ( & V_7 -> V_114 ) ) ;
...
return - V_107 ;
V_102 -> V_101 = V_101 ;
for ( V_118 = 0 ; V_118 < F_209 ( V_102 -> V_930 ) ; V_118 ++ )
V_102 -> V_930 [ V_118 ] = V_2 ;
for ( V_118 = 0 ; V_118 < F_209 ( V_102 -> V_932 ) ; V_118 ++ )
V_102 -> V_932 [ V_118 ] = V_2 ;
for ( V_118 = 0 ; V_118 < V_927 ; V_118 ++ )
V_102 -> V_928 [ V_118 ] = V_2 ;
...
return - V_48 ;
V_23 = F_377 ( V_7 , type , & V_881 , & V_1014 , & V_1015 ) ;
if ( V_23 )
return V_23 ;
if ( V_1015 )
return - V_48 ;
...
V_1009 -> V_1027 . V_1030 . V_881 = V_881 ;
