...
int V_92 ;
if ( V_86 ) {
V_92 = F_50 ( V_87 , V_88 , V_86 , V_93 , NULL ) ;
if ( V_92 < 0 )
return - V_94 ;
if ( V_87 [ V_95 ] == NULL )
return - V_94 ;
...
F_56 ( V_55 , true ) ;
F_57 ( V_53 ) ;
F_58 ( V_13 -> V_56 , V_13 -> V_56 -> V_13 . V_22 ,
V_13 -> V_56 -> V_83 . V_84 ) ;
F_48 ( V_13 -> V_56 ) ;
V_13 -> V_56 = V_55 ;
V_13 -> V_66 = F_59 ( V_90 -> V_66 ) ;
V_13 -> V_68 = F_59 ( V_90 -> V_68 ) ;
V_13 -> V_67 = V_38 ;
V_13 -> V_62 = V_62 ;
V_13 -> V_26 = V_90 -> V_26 ;
V_13 -> V_25 = V_90 -> V_25 ;
...
static int F_61 ( struct V_52 * V_53 , struct V_85 * V_86 )
{
struct V_12 * V_13 = F_25 ( V_53 ) ;
V_13 -> V_56 = & V_98 ;
return F_49 ( V_53 , V_86 ) ;
}
static int F_62 ( struct V_52 * V_53 , struct V_2 * V_3 )
{
struct V_12 * V_13 = F_25 ( V_53 ) ;
struct V_85 * V_99 ;
struct V_89 V_86 = {
...
if ( V_99 == NULL )
goto V_101;
if ( F_65 ( V_3 , V_95 , sizeof( V_86 ) , & V_86 ) )
goto V_101;
return F_66 ( V_3 , V_99 ) ;
V_101:
F_67 ( V_3 , V_99 ) ;
return - V_102 ;
}
static int F_68 ( struct V_52 * V_53 , struct V_103 * V_104 )
{
struct V_12 * V_13 = F_25 ( V_53 ) ;
struct V_105 V_106 = {
. V_76 = V_13 -> V_63 . V_76 ,
...
return F_69 ( V_104 , & V_106 , sizeof( V_106 ) ) ;
}
static int F_70 ( struct V_52 * V_53 , unsigned long V_110 ,
struct V_2 * V_3 , struct V_111 * V_112 )
{
return - V_113 ;
}
static int F_71 ( struct V_52 * V_53 , unsigned long V_114 , struct V_52 * V_115 ,
struct V_52 * * V_116 )
{
struct V_12 * V_13 = F_25 ( V_53 ) ;
if ( V_115 == NULL )
V_115 = & V_98 ;
* V_116 = F_72 ( V_53 , V_115 , & V_13 -> V_56 ) ;
return 0 ;
}
static struct V_52 * F_73 ( struct V_52 * V_53 , unsigned long V_114 )
{
struct V_12 * V_13 = F_25 ( V_53 ) ;
return V_13 -> V_56 ;
}
static unsigned long F_74 ( struct V_52 * V_53 , T_1 V_51 )
{
return 1 ;
}
static void F_75 ( struct V_52 * V_53 , unsigned long V_114 )
{
}
static int F_76 ( struct V_52 * V_53 , T_1 V_51 , T_1 V_117 ,
struct V_85 * * V_118 , unsigned long * V_114 )
{
return - V_113 ;
}
static int F_77 ( struct V_52 * V_53 , unsigned long V_110 )
{
return - V_113 ;
}
static void F_78 ( struct V_52 * V_53 , struct V_119 * V_120 )
{
if ( ! V_120 -> V_121 ) {
...
static struct V_40 T_2 * * F_79 ( struct V_52 * V_53 ,
unsigned long V_110 )
{
struct V_12 * V_13 = F_25 ( V_53 ) ;
if ( V_110 )
...
static unsigned long F_80 ( struct V_52 * V_53 , unsigned long V_125 ,
T_1 V_51 )
{
return 0 ;
}
