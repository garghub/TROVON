...
V_1 = F_41 ( V_8 , sizeof( * V_1 ) , V_55 ) ;
if ( ! V_1 )
return - V_41 ;
V_42 = F_41 ( V_8 , sizeof( * V_42 ) , V_55 ) ;
if ( ! V_42 )
return - V_41 ;
V_6 = F_42 ( V_48 , V_56 , 0 ) ;
if ( ! V_6 ) {
F_16 ( & V_48 -> V_8 , L_3 ) ;
return - V_57 ;
}
V_1 -> V_6 = F_43 ( V_8 , V_6 ) ;
if ( F_44 ( V_1 -> V_6 ) )
return F_45 ( V_1 -> V_6 ) ;
V_1 -> V_9 = F_46 ( V_8 , NULL ) ;
if ( F_44 ( V_1 -> V_9 ) ) {
F_16 ( & V_48 -> V_8 , L_4 ) ;
return F_45 ( V_1 -> V_9 ) ;
}
...
if ( V_14 < 0 )
return V_14 ;
V_14 = F_48 ( & V_1 -> V_17 , V_49 -> V_18 ) ;
if ( V_14 < 0 )
goto V_60;
F_49 ( V_48 , V_1 ) ;
F_50 ( & V_1 -> V_3 . V_61 . V_62 ) ;
...
{
struct V_1 * V_1 = F_57 ( V_48 ) ;
int V_14 ;
V_14 = F_54 ( & V_1 -> V_3 . V_61 ) ;
if ( V_14 < 0 ) {
F_16 ( & V_48 -> V_8 , L_6 ,
V_14 ) ;
return V_14 ;
