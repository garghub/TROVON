...
static void F_20 ( struct V_2 * V_40 , int error )
{
...
struct V_28 * V_22 = V_3 -> V_22 ;
struct V_45 * V_46 ;
struct V_59 * V_60 = V_3 -> V_44 ;
unsigned long V_43 ;
struct V_26 * V_27 = F_21 ( V_22 , V_60 ) ;
V_46 = F_23 ( V_22 , V_60 -> V_48 ) ;
F_22 ( & V_27 -> V_47 , V_43 ) ;
...
! ( V_4 & ( V_9 | V_12 ) ) ) {
if ( V_22 -> V_23 )
F_38 ( V_3 , false , true , false , false ) ;
else
...
int F_42 ( struct V_64 * V_65 , T_1 V_66 ,
T_2 * V_67 )
{
struct V_28 * V_22 ;
struct V_15 * V_15 ;
...
struct V_26 * F_47 ( struct V_28 * V_22 ,
int V_77 , int V_78 )
{
struct V_26 * V_27 ;
int V_79 = sizeof( struct V_2 ) ;
V_27 = F_48 ( sizeof( * V_27 ) , V_80 , V_77 ) ;
if ( ! V_27 )
goto V_81;
if ( V_22 -> V_23 )
F_49 ( & V_27 -> V_47 ) ;
V_79 = F_50 ( V_79 + V_78 , F_51 () ) ;
V_27 -> V_40 = F_48 ( V_79 , V_80 , V_77 ) ;
if ( ! V_27 -> V_40 )
goto V_82;
F_39 ( & V_27 -> V_31 [ 0 ] ) ;
F_39 ( & V_27 -> V_31 [ 1 ] ) ;
