...
int V_101 , V_124 ;
V_2 = F_84 ( V_12 , sizeof( struct V_1 ) , V_171 ) ;
if ( ! V_2 )
return - V_167 ;
V_2 -> V_13 = V_13 ;
V_198 = F_85 ( V_13 , V_201 , 0 ) ;
V_2 -> V_5 = F_86 ( V_12 , V_198 ) ;
if ( F_87 ( V_2 -> V_5 ) )
return F_88 ( V_2 -> V_5 ) ;
V_124 = F_89 ( V_13 , 0 ) ;
V_101 = F_90 ( V_12 , V_124 , F_72 ,
V_207 | V_208 , L_18 ,
V_2 ) ;
if ( V_101 ) {
F_9 ( V_12 , L_19 ) ;
