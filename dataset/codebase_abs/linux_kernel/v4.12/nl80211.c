...
! V_30 -> V_5 [ V_1382 ] )
return - V_16 ;
if ( V_1379 && ! V_30 -> V_5 [ V_1383 ] )
return - V_16 ;
V_1380 = F_4 ( V_30 -> V_5 [ V_1382 ] ) ;
if ( V_1380 > 255 )
return - V_16 ;
V_139 . V_1384 = V_1380 ;
if ( ! V_1379 )
goto V_1385;
V_35 = F_161 ( V_30 -> V_5 , & V_139 . V_1386 ) ;
if ( V_35 )
return V_35 ;
...
if ( V_35 )
return V_35 ;
V_35 = F_161 ( V_1377 , & V_139 . V_1387 ) ;
if ( V_35 )
return V_35 ;
if ( ! V_1377 [ V_1388 ] )
return - V_16 ;
V_45 = F_22 ( V_1377 [ V_1388 ] ) ;
if ( ! V_45 || ( V_45 % sizeof( T_3 ) ) )
return - V_16 ;
V_139 . V_1389 = V_45 / sizeof( T_3 ) ;
if ( V_7 -> V_18 . V_496 &&
( V_139 . V_1389 >
V_7 -> V_18 . V_496 ) )
return - V_16 ;
V_139 . V_1390 =
F_21 ( V_1377 [ V_1388 ] ) ;
for ( V_160 = 0 ; V_160 < V_139 . V_1389 ; V_160 ++ ) {
T_3 V_1391 = V_139 . V_1390 [ V_160 ] ;
if ( V_1391 >= V_139 . V_1387 . V_759 )
return - V_16 ;
if ( V_139 . V_1387 . V_758 [ V_1391 ] != V_139 . V_1384 )
return - V_16 ;
}
if ( V_1377 [ V_1392 ] ) {
V_45 = F_22 ( V_1377 [ V_1392 ] ) ;
if ( ! V_45 || ( V_45 % sizeof( T_3 ) ) )
return - V_16 ;
V_139 . V_1393 = V_45 / sizeof( T_3 ) ;
if ( V_7 -> V_18 . V_496 &&
( V_139 . V_1393 >
V_7 -> V_18 . V_496 ) )
return - V_16 ;
V_139 . V_1394 =
F_21 ( V_1377 [ V_1392 ] ) ;
for ( V_160 = 0 ; V_160 < V_139 . V_1393 ; V_160 ++ ) {
T_3 V_1391 = V_139 . V_1394 [ V_160 ] ;
if ( V_1391 >= V_139 . V_1387 . V_768 )
return - V_16 ;
if ( V_139 . V_1387 . V_767 [ V_1391 ] !=
V_139 . V_1384 )
return - V_16 ;
}
}
...
{
struct V_1400 * V_430 = & V_1399 -> V_1401 ;
const struct V_1402 * V_776 ;
void * V_360 ;
struct V_4 * V_1403 ;
F_41 ( V_17 ) ;
...
V_606 ) )
goto V_59;
V_1403 = F_45 ( V_51 , V_1406 ) ;
if ( ! V_1403 )
goto V_59;
if ( ( ! F_299 ( V_430 -> V_566 ) &&
F_49 ( V_51 , V_1407 , V_607 , V_430 -> V_566 ) ) )
goto V_59;
F_245 () ;
...
if ( V_776 ) {
if ( F_104 ( V_51 , V_1410 , V_776 -> V_1411 ,
V_1412 ) )
goto V_1409;
if ( V_776 -> V_45 && F_49 ( V_51 , V_1413 ,
V_776 -> V_45 , V_776 -> V_140 ) )
goto V_1409;
}
V_776 = F_246 ( V_430 -> V_760 ) ;
if ( V_776 && V_776 -> V_1414 ) {
if ( F_104 ( V_51 , V_1415 , V_776 -> V_1411 ,
V_1412 ) )
goto V_1409;
if ( V_776 -> V_45 && F_49 ( V_51 , V_1416 ,
V_776 -> V_45 , V_776 -> V_140 ) )
goto V_1409;
}
F_247 () ;
if ( V_430 -> V_561 &&
F_53 ( V_51 , V_1417 , V_430 -> V_561 ) )
goto V_59;
if ( F_53 ( V_51 , V_1418 , V_430 -> V_1029 ) ||
F_26 ( V_51 , V_1419 , V_430 -> V_1420 -> V_58 ) ||
F_26 ( V_51 , V_1421 , V_430 -> V_1422 ) ||
F_26 ( V_51 , V_1423 ,
F_300 ( V_1320 - V_1399 -> V_1424 ) ) )
goto V_59;
if ( V_1399 -> V_1425 &&
( F_104 ( V_51 , V_1426 ,
V_1399 -> V_1425 , V_1412 ) ||
F_49 ( V_51 , V_1427 , V_607 ,
V_1399 -> V_1428 ) ) )
goto V_59;
if ( V_1399 -> V_1429 &&
F_104 ( V_51 , V_1430 ,
V_1399 -> V_1429 , V_1412 ) )
goto V_59;
switch ( V_7 -> V_18 . V_900 ) {
case V_901 :
if ( F_26 ( V_51 , V_1431 , V_430 -> signal ) )
goto V_59;
break;
case V_1432 :
if ( F_54 ( V_51 , V_1433 , V_430 -> signal ) )
goto V_59;
break;
default:
break;
...
V_1440 -> V_1420 -> V_58 ) )
goto V_59;
if ( ( V_1440 -> V_883 & V_1445 ) &&
F_54 ( V_51 , V_1446 , V_1440 -> V_1447 ) )
goto V_59;
if ( ( V_1440 -> V_883 & V_1448 ) &&
F_27 ( V_51 , V_1449 ) )
goto V_59;
if ( ( V_1440 -> V_883 & V_1450 ) &&
F_104 ( V_51 , V_1451 ,
V_1440 -> time , V_1452 ) )
goto V_59;
if ( ( V_1440 -> V_883 & V_1453 ) &&
F_104 ( V_51 , V_1454 ,
V_1440 -> V_1455 , V_1452 ) )
goto V_59;
if ( ( V_1440 -> V_883 & V_1456 ) &&
F_104 ( V_51 , V_1457 ,
V_1440 -> V_1458 , V_1452 ) )
goto V_59;
if ( ( V_1440 -> V_883 & V_1459 ) &&
F_104 ( V_51 , V_1460 ,
V_1440 -> V_1461 , V_1452 ) )
goto V_59;
if ( ( V_1440 -> V_883 & V_1462 ) &&
F_104 ( V_51 , V_1463 ,
V_1440 -> V_1464 , V_1452 ) )
goto V_59;
if ( ( V_1440 -> V_883 & V_1465 ) &&
F_104 ( V_51 , V_1466 ,
V_1440 -> V_1467 , V_1452 ) )
goto V_59;
F_46 ( V_51 , V_1441 ) ;
F_65 ( V_51 , V_360 ) ;
return 0 ;
...
{
struct V_4 * * V_1468 = F_15 ( & V_38 ) ;
struct V_1439 V_1440 ;
struct V_6 * V_7 ;
struct V_1 * V_17 ;
int V_1469 = V_34 -> args [ 2 ] ;
int V_430 ;
bool V_1470 ;
F_69 () ;
...
while ( 1 ) {
V_430 = F_307 ( V_7 , V_17 -> V_19 , V_1469 , & V_1440 ) ;
if ( V_430 == - V_681 )
break;
if ( V_430 )
goto V_967;
if ( V_1440 . V_1420 &&
V_1440 . V_1420 -> V_49 & V_60 ) {
V_1469 ++ ;
continue;
}
if ( F_305 ( V_32 ,
...
static bool F_308 ( V_22 V_1473 )
{
return ! ( V_1473 & ~ ( V_1474 |
V_1475 ) ) ;
}
...
struct V_25 * V_559 = V_30 -> V_523 [ 1 ] ;
struct V_52 * V_53 ;
const T_2 * V_566 , * V_614 , * V_1214 = NULL , * V_1476 = NULL ;
int V_35 , V_612 , V_1215 = 0 , V_1477 = 0 ;
enum V_781 V_782 ;
struct V_91 V_90 ;
bool V_1478 ;
if ( ! F_20 ( V_30 -> V_5 [ V_752 ] ) )
...
V_90 . V_105 . V_106 != V_1479 ) &&
( V_90 . V_105 . V_110 != V_138 ||
V_90 . V_105 . V_106 != V_1480 ) )
return - V_16 ;
if ( V_90 . V_103 > 3 )
return - V_16 ;
} else {
...
V_782 != V_790 )
return - V_16 ;
V_1476 = F_21 ( V_30 -> V_5 [ V_1482 ] ) ;
V_1477 = F_22 ( V_30 -> V_5 [ V_1482 ] ) ;
if ( V_1477 < 4 )
return - V_16 ;
}
V_1478 = ! ! V_30 -> V_5 [ V_1483 ] ;
if ( V_1478 )
return 0 ;
F_116 ( V_559 -> V_28 ) ;
...
V_1485 -> V_1487 = V_30 -> V_5 [ V_1488 ] ;
if ( V_30 -> V_5 [ V_419 ] ) {
T_3 V_1489 ;
V_1489 = F_79 (
V_30 -> V_5 [ V_419 ] ) ;
V_1485 -> V_1490 = F_311 ( V_1489 ) ;
if ( ! ( V_7 -> V_18 . V_49 & V_418 ) &&
V_1489 != V_1491 )
return - V_16 ;
if ( V_30 -> V_5 [ V_1492 ] )
...
V_1485 -> V_1490 = F_311 ( V_1491 ) ;
if ( V_30 -> V_5 [ V_1494 ] ) {
void * V_140 ;
int V_45 , V_160 ;
V_140 = F_21 ( V_30 -> V_5 [ V_1494 ] ) ;
V_45 = F_22 ( V_30 -> V_5 [ V_1494 ] ) ;
V_1485 -> V_1495 = V_45 / sizeof( V_22 ) ;
if ( V_45 % sizeof( V_22 ) )
return - V_16 ;
if ( V_1485 -> V_1495 > V_1486 )
return - V_16 ;
memcpy ( V_1485 -> V_1496 , V_140 , V_45 ) ;
for ( V_160 = 0 ; V_160 < V_1485 -> V_1495 ; V_160 ++ )
if ( ! F_312 (
& V_7 -> V_18 ,
V_1485 -> V_1496 [ V_160 ] ) )
return - V_16 ;
...
V_1485 -> V_1473 =
F_4 ( V_30 -> V_5 [ V_1499 ] ) ;
if ( ! F_308 ( V_1485 -> V_1473 ) )
return - V_16 ;
}
if ( V_30 -> V_5 [ V_1500 ] ) {
void * V_140 ;
int V_45 ;
V_140 = F_21 ( V_30 -> V_5 [ V_1500 ] ) ;
V_45 = F_22 ( V_30 -> V_5 [ V_1500 ] ) ;
V_1485 -> V_1501 = V_45 / sizeof( V_22 ) ;
if ( V_45 % sizeof( V_22 ) )
return - V_16 ;
if ( V_1485 -> V_1501 > V_1502 )
return - V_16 ;
memcpy ( V_1485 -> V_1503 , V_140 , V_45 ) ;
}
return 0 ;
}
...
if ( V_1507 == V_1508 )
V_1367 . V_1509 = true ;
else if ( V_1507 != V_1510 )
return - V_16 ;
}
if ( V_30 -> V_5 [ V_1511 ] )
V_1367 . V_1512 = F_21 ( V_30 -> V_5 [ V_1511 ] ) ;
if ( F_170 ( V_30 -> V_5 [ V_1513 ] ) )
V_1367 . V_49 |= V_1514 ;
if ( V_30 -> V_5 [ V_472 ] )
memcpy ( & V_1367 . V_1515 ,
F_21 ( V_30 -> V_5 [ V_472 ] ) ,
sizeof( V_1367 . V_1515 ) ) ;
if ( V_30 -> V_5 [ V_1019 ] ) {
if ( ! V_30 -> V_5 [ V_472 ] )
return - V_16 ;
memcpy ( & V_1367 . V_989 ,
...
if ( F_170 ( V_30 -> V_5 [ V_1516 ] ) )
V_1367 . V_49 |= V_1517 ;
if ( V_30 -> V_5 [ V_481 ] )
memcpy ( & V_1367 . V_1518 ,
F_21 ( V_30 -> V_5 [ V_481 ] ) ,
sizeof( V_1367 . V_1518 ) ) ;
if ( V_30 -> V_5 [ V_1020 ] ) {
if ( ! V_30 -> V_5 [ V_481 ] )
return - V_16 ;
memcpy ( & V_1367 . V_990 ,
...
if ( V_30 -> V_5 [ V_1524 ] ) {
V_1367 . V_1525 = F_21 ( V_30 -> V_5 [ V_1524 ] ) ;
V_1367 . V_1526 = F_22 ( V_30 -> V_5 [ V_1524 ] ) ;
if ( ! V_30 -> V_5 [ V_1527 ] )
return - V_16 ;
V_1367 . V_1528 =
F_21 ( V_30 -> V_5 [ V_1527 ] ) ;
}
...
continue;
for ( V_160 = 0 ; V_160 < V_243 -> V_264 ; V_160 ++ ) {
if ( V_243 -> V_265 [ V_160 ] . V_267 == V_1532 ) {
V_1531 [ V_367 ] = V_160 + 1 ;
V_27 = true ;
break;
}
}
...
struct V_18 * V_18 ;
struct V_129 * V_1535 = NULL ;
int V_35 ;
memset ( & V_1534 , 0 , sizeof( V_1534 ) ) ;
if ( ! F_20 ( V_30 -> V_5 [ V_752 ] ) )
return - V_16 ;
if ( ! V_30 -> V_5 [ V_613 ] ||
! F_22 ( V_30 -> V_5 [ V_613 ] ) )
...
V_18 = & V_7 -> V_18 ;
if ( V_30 -> V_5 [ V_567 ] ) {
V_1534 . V_566 = F_21 ( V_30 -> V_5 [ V_567 ] ) ;
if ( ! F_123 ( V_1534 . V_566 ) )
return - V_16 ;
}
V_1534 . V_614 = F_21 ( V_30 -> V_5 [ V_613 ] ) ;
V_1534 . V_612 = F_22 ( V_30 -> V_5 [ V_613 ] ) ;
if ( V_30 -> V_5 [ V_752 ] ) {
V_1534 . V_1214 = F_21 ( V_30 -> V_5 [ V_752 ] ) ;
V_1534 . V_1215 = F_22 ( V_30 -> V_5 [ V_752 ] ) ;
}
V_35 = F_81 ( V_7 , V_30 , & V_1534 . V_540 ) ;
if ( V_35 )
return V_35 ;
if ( ! F_321 ( & V_7 -> V_18 , & V_1534 . V_540 ,
V_146 ) )
return - V_16 ;
switch ( V_1534 . V_540 . V_543 ) {
case V_557 :
case V_558 :
case V_544 :
break;
...
V_1534 . V_1541 = ! ! V_30 -> V_5 [ V_1542 ] ;
V_1534 . V_802 = ! ! V_30 -> V_5 [ V_803 ] ;
if ( V_30 -> V_5 [ V_1103 ] ) {
T_2 * V_705 =
F_21 ( V_30 -> V_5 [ V_1103 ] ) ;
int V_1543 =
F_22 ( V_30 -> V_5 [ V_1103 ] ) ;
struct V_242 * V_243 =
V_18 -> V_438 [ V_1534 . V_540 . V_53 -> V_367 ] ;
V_35 = F_269 ( V_243 , V_705 , V_1543 ,
& V_1534 . V_1104 ) ;
if ( V_35 )
return V_35 ;
}
if ( V_30 -> V_5 [ V_472 ] )
memcpy ( & V_1534 . V_1515 ,
F_21 ( V_30 -> V_5 [ V_472 ] ) ,
sizeof( V_1534 . V_1515 ) ) ;
if ( V_30 -> V_5 [ V_1019 ] ) {
if ( ! V_30 -> V_5 [ V_472 ] )
return - V_16 ;
memcpy ( & V_1534 . V_989 ,
...
if ( V_30 -> V_5 [ V_1544 ] &&
! F_319 ( V_7 , V_1534 . V_1531 ,
F_4 ( V_30 -> V_5 [ V_1544 ] ) ) )
return - V_16 ;
if ( V_1534 . V_802 && V_30 -> V_5 [ V_1545 ] ) {
bool V_131 = false ;
V_1535 = F_35 ( V_7 ,
V_30 -> V_5 [ V_1545 ] ,
& V_131 ) ;
...
V_1534 . V_1487 =
F_170 ( V_30 -> V_5 [ V_1488 ] ) ;
V_1534 . V_1546 =
F_170 ( V_30 -> V_5 [ V_1547 ] ) ;
V_35 = F_323 ( V_7 , V_559 , & V_1534 , V_1535 ) ;
if ( V_35 )
F_322 ( V_1535 ) ;
return V_35 ;
}
...
if ( ! V_7 -> V_328 -> V_349 )
return - V_560 ;
memset ( V_1531 , 0 , sizeof( V_1531 ) ) ;
if ( ! V_30 -> V_5 [ V_1544 ] )
return - V_16 ;
V_1549 = F_4 ( V_30 -> V_5 [ V_1544 ] ) ;
if ( ! F_319 ( V_7 , V_1531 , V_1549 ) )
return - V_16 ;
V_35 = F_327 ( V_7 , V_559 , V_1531 ) ;
return V_35 ;
}
static struct V_31 *
F_328 ( struct V_6 * V_7 ,
struct V_1 * V_17 , int V_1550 ,
...
V_1557 >= V_18 -> V_492 ) )
return NULL ;
V_30 = & V_18 -> V_494 [ V_1557 ] ;
break;
default:
F_60 ( 1 ) ;
return NULL ;
}
return F_328 ( V_7 , V_17 , V_1550 , 0 , 0 ,
V_50 , V_43 , V_30 , V_1552 ) ;
}
void F_331 ( struct V_31 * V_32 , T_10 V_1552 )
{
struct V_6 * V_7 = ( ( void * * ) V_32 -> V_34 ) [ 0 ] ;
void * V_360 = ( ( void * * ) V_32 -> V_34 ) [ 1 ] ;
struct V_4 * V_140 = ( ( void * * ) V_32 -> V_34 ) [ 2 ] ;
enum V_1560 V_1561 = V_1562 ;
...
V_7 -> V_1565 = V_30 ;
V_35 = F_334 ( V_7 , V_17 ,
F_21 ( V_30 -> V_5 [ V_1564 ] ) ,
F_22 ( V_30 -> V_5 [ V_1564 ] ) ) ;
V_7 -> V_1565 = NULL ;
return V_35 ;
}
...
V_1566 = V_7 -> V_14 ;
if ( V_1468 [ V_1564 ] )
V_34 -> args [ 1 ] = ( long ) V_1468 [ V_1564 ] ;
}
if ( V_34 -> args [ 1 ] ) {
V_140 = F_21 ( ( void * ) V_34 -> args [ 1 ] ) ;
V_1567 = F_22 ( ( void * ) V_34 -> args [ 1 ] ) ;
}
if ( ! V_7 -> V_328 -> V_1568 ) {
V_35 = - V_560 ;
goto V_967;
...
if ( ! V_360 )
break;
if ( F_26 ( V_32 , V_26 , V_1566 ) ) {
F_66 ( V_32 , V_360 ) ;
break;
}
V_1569 = F_45 ( V_32 , V_1564 ) ;
if ( ! V_1569 ) {
F_66 ( V_32 , V_360 ) ;
break;
}
V_35 = F_336 ( V_7 , V_32 , V_34 , V_140 , V_1567 ) ;
F_46 ( V_32 , V_1569 ) ;
...
( V_18 -> V_49 & V_407 ) ) {
V_353 . V_1571 =
F_79 ( V_30 -> V_5 [ V_1572 ] ) ;
}
if ( V_30 -> V_5 [ V_567 ] )
V_353 . V_566 = F_21 ( V_30 -> V_5 [ V_567 ] ) ;
else if ( V_30 -> V_5 [ V_1573 ] )
V_353 . V_1574 =
F_21 ( V_30 -> V_5 [ V_1573 ] ) ;
...
if ( V_30 -> V_5 [ V_1505 ] ) {
V_353 . V_1507 = F_4 ( V_30 -> V_5 [ V_1505 ] ) ;
if ( V_353 . V_1507 != V_1508 &&
V_353 . V_1507 != V_1510 )
return - V_16 ;
} else {
V_353 . V_1507 = V_1510 ;
...
if ( V_30 -> V_5 [ V_1511 ] )
V_353 . V_1512 =
F_21 ( V_30 -> V_5 [ V_1511 ] ) ;
if ( V_30 -> V_5 [ V_542 ] ) {
V_353 . V_1420 = F_42 (
V_18 , V_30 -> V_5 [ V_542 ] ) ;
if ( ! V_353 . V_1420 )
return - V_16 ;
} else if ( V_30 -> V_5 [ V_1575 ] ) {
V_353 . V_1576 = F_42 (
V_18 , V_30 -> V_5 [ V_1575 ] ) ;
if ( ! V_353 . V_1576 )
return - V_16 ;
}
if ( V_353 . V_802 && V_30 -> V_5 [ V_1545 ] ) {
V_1535 = F_35 ( V_7 ,
V_30 -> V_5 [ V_1545 ] , NULL ) ;
if ( F_17 ( V_1535 ) )
return F_18 ( V_1535 ) ;
}
if ( F_170 ( V_30 -> V_5 [ V_1513 ] ) )
...
V_30 -> V_5 [ V_1580 ] ) {
V_353 . V_1581 =
F_21 ( V_30 -> V_5 [ V_1577 ] ) ;
V_353 . V_1582 =
F_22 ( V_30 -> V_5 [ V_1577 ] ) ;
V_353 . V_1583 =
F_21 ( V_30 -> V_5 [ V_1578 ] ) ;
V_353 . V_1584 =
F_22 ( V_30 -> V_5 [ V_1578 ] ) ;
V_353 . V_1585 =
F_79 (
V_30 -> V_5 [ V_1579 ] ) ;
V_353 . V_1586 =
F_21 ( V_30 -> V_5 [ V_1580 ] ) ;
V_353 . V_1587 =
F_22 ( V_30 -> V_5 [ V_1580 ] ) ;
} else if ( V_30 -> V_5 [ V_1577 ] ||
V_30 -> V_5 [ V_1578 ] ||
V_30 -> V_5 [ V_1579 ] ||
V_30 -> V_5 [ V_1580 ] ) {
F_322 ( V_1535 ) ;
...
F_116 ( V_559 -> V_28 ) ;
V_35 = F_338 ( V_7 , V_559 , & V_353 , V_1535 ,
V_353 . V_1512 ) ;
if ( V_35 )
F_322 ( V_1535 ) ;
if ( ! V_35 && V_30 -> V_5 [ V_659 ] ) {
V_559 -> V_28 -> V_1529 = V_30 -> V_524 ;
if ( V_353 . V_566 )
memcpy ( V_559 -> V_28 -> V_1530 ,
V_353 . V_566 , V_607 ) ;
else
memset ( V_559 -> V_28 -> V_1530 ,
0 , V_607 ) ;
}
F_118 ( V_559 -> V_28 ) ;
return V_35 ;
...
return - V_560 ;
F_116 ( V_559 -> V_28 ) ;
V_516 = F_342 ( V_7 , V_559 , V_1589 , true ) ;
F_118 ( V_559 -> V_28 ) ;
return V_516 ;
}
...
int V_35 ;
if ( V_30 -> V_5 [ V_1591 ] ) {
V_22 V_1592 = F_4 ( V_30 -> V_5 [ V_1591 ] ) ;
V_2 = F_344 ( V_1592 ) ;
} else if ( V_30 -> V_5 [ V_1593 ] ) {
V_22 V_1594 = F_4 ( V_30 -> V_5 [ V_1593 ] ) ;
V_2 = F_345 ( V_1594 ) ;
} else {
return - V_16 ;
}
...
struct V_1595 * V_1596 ) = NULL ;
struct V_25 * V_559 = V_30 -> V_523 [ 1 ] ;
struct V_1595 V_1596 ;
memset ( & V_1596 , 0 , sizeof( struct V_1595 ) ) ;
if ( ! V_30 -> V_5 [ V_1597 ] )
return - V_16 ;
V_1596 . V_1598 = F_21 ( V_30 -> V_5 [ V_1597 ] ) ;
if ( V_30 -> V_5 [ V_567 ] ) {
V_1596 . V_566 = F_21 ( V_30 -> V_5 [ V_567 ] ) ;
} else if ( V_30 -> V_5 [ V_613 ] &&
V_30 -> V_5 [ V_1599 ] &&
( V_30 -> V_1600 -> V_50 == V_1601 ||
V_30 -> V_5 [ V_1602 ] ) ) {
V_1596 . V_614 = F_21 ( V_30 -> V_5 [ V_613 ] ) ;
V_1596 . V_612 = F_22 ( V_30 -> V_5 [ V_613 ] ) ;
V_1596 . V_1603 =
F_21 ( V_30 -> V_5 [ V_1599 ] ) ;
} else {
return - V_16 ;
}
if ( V_30 -> V_5 [ V_1602 ] ) {
V_1596 . V_1604 = F_21 ( V_30 -> V_5 [ V_1602 ] ) ;
V_1596 . V_1605 = F_22 ( V_30 -> V_5 [ V_1602 ] ) ;
}
if ( V_559 -> V_28 -> V_141 != V_147 &&
V_559 -> V_28 -> V_141 != V_148 )
return - V_560 ;
switch ( V_30 -> V_1600 -> V_50 ) {
case V_1606 :
...
if ( ! F_349 )
return - V_560 ;
return F_349 ( & V_7 -> V_18 , V_559 , & V_1596 ) ;
}
...
! V_30 -> V_5 [ V_567 ] )
return - V_16 ;
V_1611 = F_21 ( V_30 -> V_5 [ V_567 ] ) ;
V_1607 = F_32 ( V_30 -> V_5 [ V_1613 ] ) ;
V_1610 = F_79 ( V_30 -> V_5 [ V_1614 ] ) ;
V_1608 = F_32 ( V_30 -> V_5 [ V_1615 ] ) ;
V_1612 = F_170 ( V_30 -> V_5 [ V_1616 ] ) ;
if ( V_30 -> V_5 [ V_1617 ] )
V_1609 =
F_4 ( V_30 -> V_5 [ V_1617 ] ) ;
return F_353 ( V_7 , V_559 , V_1611 , V_1607 ,
V_1608 , V_1610 , V_1609 ,
V_1612 ,
F_21 ( V_30 -> V_5 [ V_752 ] ) ,
F_22 ( V_30 -> V_5 [ V_752 ] ) ) ;
}
...
! V_30 -> V_5 [ V_567 ] )
return - V_16 ;
V_1619 = F_32 ( V_30 -> V_5 [ V_1620 ] ) ;
V_1611 = F_21 ( V_30 -> V_5 [ V_567 ] ) ;
return F_355 ( V_7 , V_559 , V_1611 , V_1619 ) ;
}
...
struct V_6 * V_7 = V_30 -> V_523 [ 0 ] ;
struct V_1 * V_17 = V_30 -> V_523 [ 1 ] ;
T_3 V_1626 = V_280 | V_1627 ;
if ( ! V_30 -> V_5 [ V_1628 ] )
return - V_16 ;
if ( V_30 -> V_5 [ V_279 ] )
V_1626 = F_79 ( V_30 -> V_5 [ V_279 ] ) ;
switch ( V_17 -> V_141 ) {
case V_147 :
case V_146 :
case V_148 :
...
if ( ! V_7 -> V_328 -> V_322 )
return - V_560 ;
return F_365 ( V_17 , V_30 -> V_524 , V_1626 ,
F_21 ( V_30 -> V_5 [ V_1628 ] ) ,
F_22 ( V_30 -> V_5 [ V_1628 ] ) ) ;
}
...
if ( ! ( V_7 -> V_18 . V_49 & V_462 ) )
return - V_16 ;
V_139 . V_1633 = F_4 ( V_30 -> V_5 [ V_1622 ] ) ;
if ( V_139 . V_1633 < V_1623 ||
V_139 . V_1633 > V_7 -> V_18 . V_461 )
return - V_16 ;
}
V_139 . V_1634 = V_30 -> V_5 [ V_463 ] ;
if ( V_139 . V_1634 && ! ( V_7 -> V_18 . V_49 & V_462 ) )
return - V_16 ;
...
if ( ! V_540 . V_53 && V_139 . V_1634 )
return - V_16 ;
F_116 ( V_17 ) ;
if ( V_139 . V_1634 && ! F_264 ( V_17 ) ) {
F_118 ( V_17 ) ;
return - V_564 ;
}
F_118 ( V_17 ) ;
V_139 . V_1635 = F_21 ( V_30 -> V_5 [ V_1632 ] ) ;
V_139 . V_45 = F_22 ( V_30 -> V_5 [ V_1632 ] ) ;
if ( V_30 -> V_5 [ V_1636 ] ) {
int V_45 = F_22 ( V_30 -> V_5 [ V_1636 ] ) ;
int V_160 ;
if ( V_45 % sizeof( T_3 ) )
return - V_16 ;
V_139 . V_1637 = V_45 / sizeof( T_3 ) ;
V_139 . V_1638 =
F_21 ( V_30 -> V_5 [ V_1636 ] ) ;
for ( V_160 = 0 ; V_160 < V_139 . V_1637 ; V_160 ++ ) {
if ( V_139 . V_1638 [ V_160 ] >= V_139 . V_45 )
return - V_16 ;
}
}
if ( ! V_139 . V_1630 ) {
...
if ( ! V_30 -> V_5 [ V_1641 ] )
return - V_16 ;
V_1640 = F_4 ( V_30 -> V_5 [ V_1641 ] ) ;
if ( V_1640 != V_1642 && V_1640 != V_1643 )
return - V_16 ;
V_17 = V_559 -> V_28 ;
if ( ! V_7 -> V_328 -> V_1644 )
return - V_560 ;
V_359 = ( V_1640 == V_1643 ) ? true : false ;
if ( V_359 == V_17 -> V_1645 )
return 0 ;
V_35 = F_371 ( V_7 , V_559 , V_359 , V_17 -> V_1646 ) ;
if ( ! V_35 )
V_17 -> V_1645 = V_359 ;
return V_35 ;
}
...
V_22 V_247 , V_22 V_1649 , V_22 V_1650 )
{
struct V_6 * V_7 = V_30 -> V_523 [ 0 ] ;
struct V_25 * V_559 = V_30 -> V_523 [ 1 ] ;
struct V_1 * V_17 = V_559 -> V_28 ;
if ( V_247 > 100 || V_1650 > V_1651 )
return - V_16 ;
if ( ! V_7 -> V_328 -> V_1652 )
return - V_560 ;
if ( V_17 -> V_141 != V_147 &&
V_17 -> V_141 != V_148 )
return - V_560 ;
return F_374 ( V_7 , V_559 , V_247 , V_1649 , V_1650 ) ;
}
static int F_375 ( struct V_6 * V_7 ,
struct V_25 * V_559 )
{
struct V_1 * V_17 = V_559 -> V_28 ;
T_7 V_1653 , V_1654 , V_1655 ;
V_22 V_1656 ;
int V_160 , V_1657 ;
int V_35 ;
if ( ! V_17 -> V_1658 )
return F_376 ( V_7 , V_559 , 0 , 0 ) ;
if ( ! V_17 -> V_1658 -> V_1659 && V_17 -> V_149 &&
V_7 -> V_328 -> V_970 ) {
struct V_873 V_874 ;
T_2 * V_675 ;
V_675 = V_17 -> V_149 -> V_1401 . V_566 ;
V_35 = F_187 ( V_7 , V_559 , V_675 , & V_874 ) ;
if ( V_35 )
return V_35 ;
if ( V_874 . V_883 & F_113 ( V_1660 ) )
V_17 -> V_1658 -> V_1659 =
( T_5 ) V_874 . V_947 ;
}
V_1653 = V_17 -> V_1658 -> V_1659 ;
V_1656 = V_17 -> V_1658 -> V_1661 ;
V_1657 = V_17 -> V_1658 -> V_1662 ;
for ( V_160 = 0 ; V_160 < V_1657 ; V_160 ++ )
if ( V_1653 < V_17 -> V_1658 -> V_1663 [ V_160 ] )
break;
V_1654 = V_160 > 0 ?
( V_17 -> V_1658 -> V_1663 [ V_160 - 1 ] - V_1656 ) : V_1664 ;
V_1655 = V_160 < V_1657 ?
( V_17 -> V_1658 -> V_1663 [ V_160 ] + V_1656 - 1 ) : V_1665 ;
return F_376 ( V_7 , V_559 , V_1654 , V_1655 ) ;
}
static int F_377 ( struct V_29 * V_30 ,
const T_7 * V_1666 , int V_1667 ,
V_22 V_1668 )
{
struct V_6 * V_7 = V_30 -> V_523 [ 0 ] ;
struct V_25 * V_559 = V_30 -> V_523 [ 1 ] ;
...
int V_160 , V_35 ;
T_7 V_1669 = V_1664 ;
for ( V_160 = 0 ; V_160 < V_1667 ; V_160 ++ ) {
if ( V_1666 [ V_160 ] > 0 || V_1666 [ V_160 ] <= V_1669 )
return - V_16 ;
V_1669 = V_1666 [ V_160 ] ;
}
if ( V_17 -> V_141 != V_147 &&
...
F_378 ( V_17 ) ;
F_118 ( V_17 ) ;
if ( V_1667 <= 1 && V_7 -> V_328 -> V_1670 ) {
if ( V_1667 == 0 || V_1666 [ 0 ] == 0 )
...
V_1671 ) )
return - V_560 ;
if ( V_1667 == 1 && V_1666 [ 0 ] == 0 )
V_1667 = 0 ;
F_116 ( V_17 ) ;
if ( V_1667 ) {
struct V_1672 * V_1658 ;
V_1658 = F_37 ( sizeof( struct V_1672 ) +
V_1667 * sizeof( T_7 ) , V_135 ) ;
if ( ! V_1658 ) {
V_35 = - V_136 ;
goto V_1300;
}
V_1658 -> V_1661 = V_1668 ;
V_1658 -> V_1662 = V_1667 ;
memcpy ( V_1658 -> V_1663 , V_1666 ,
V_1667 * sizeof( T_7 ) ) ;
V_17 -> V_1658 = V_1658 ;
}
...
{
struct V_4 * V_5 [ V_1673 + 1 ] ;
struct V_4 * V_1674 ;
int V_35 ;
V_1674 = V_30 -> V_5 [ V_1675 ] ;
if ( ! V_1674 )
return - V_16 ;
V_35 = F_31 ( V_5 , V_1673 , V_1674 ,
V_1676 , V_30 -> V_127 ) ;
if ( V_35 )
return V_35 ;
if ( V_5 [ V_1677 ] &&
...
const T_7 * V_1666 =
F_21 ( V_5 [ V_1677 ] ) ;
int V_45 = F_22 ( V_5 [ V_1677 ] ) ;
V_22 V_1668 = F_4 ( V_5 [ V_1678 ] ) ;
if ( V_45 % 4 )
return - V_16 ;
return F_377 ( V_30 , V_1666 , V_45 / 4 ,
V_1668 ) ;
}
if ( V_5 [ V_1679 ] &&
V_5 [ V_1680 ] &&
V_5 [ V_1681 ] ) {
V_22 V_247 = F_4 ( V_5 [ V_1679 ] ) ;
V_22 V_1649 = F_4 ( V_5 [ V_1680 ] ) ;
V_22 V_1650 = F_4 ( V_5 [ V_1681 ] ) ;
return F_373 ( V_30 , V_247 , V_1649 , V_1650 ) ;
}
return - V_16 ;
}
...
memcpy ( & V_1196 , & V_1683 , sizeof( V_1196 ) ) ;
if ( V_30 -> V_5 [ V_1125 ] ) {
...
! F_22 ( V_30 -> V_5 [ V_649 ] ) )
return - V_16 ;
V_1196 . V_1684 = F_21 ( V_30 -> V_5 [ V_649 ] ) ;
V_1196 . V_1122 = F_22 ( V_30 -> V_5 [ V_649 ] ) ;
if ( V_30 -> V_5 [ V_1544 ] &&
! F_319 ( V_7 , V_1196 . V_1531 ,
F_4 ( V_30 -> V_5 [ V_1544 ] ) ) )
return - V_16 ;
if ( V_30 -> V_5 [ V_794 ] ) {
V_1196 . V_561 =
...
struct V_6 * V_7 )
{
struct V_1685 * V_192 = V_7 -> V_18 . V_1686 ;
struct V_4 * V_1687 , * V_1688 ;
int V_160 , V_1689 ;
if ( ! V_192 -> V_222 )
return 0 ;
V_1687 = F_45 ( V_51 , V_231 ) ;
if ( ! V_1687 )
return - V_89 ;
for ( V_160 = 0 ; V_160 < V_192 -> V_222 ; V_160 ++ ) {
V_1688 = F_45 ( V_51 , V_160 + 1 ) ;
if ( ! V_1688 )
return - V_89 ;
V_1689 = V_192 -> V_1690 [ V_160 ] . V_1691 ;
if ( F_49 ( V_51 , V_1692 , F_277 ( V_1689 , 8 ) ,
V_192 -> V_1690 [ V_160 ] . V_707 ) ||
F_49 ( V_51 , V_1693 , V_1689 ,
V_192 -> V_1690 [ V_160 ] . V_1694 ) ||
F_26 ( V_51 , V_1695 ,
V_192 -> V_1690 [ V_160 ] . V_1696 ) )
return - V_89 ;
F_46 ( V_51 , V_1688 ) ;
}
F_46 ( V_51 , V_1687 ) ;
...
if ( ! V_193 )
return - V_89 ;
if ( F_391 ( V_51 , V_1698 , V_191 -> V_1699 ) ||
F_391 ( V_51 , V_1700 , V_191 -> V_1058 ) ||
F_49 ( V_51 , V_1701 , V_607 , V_191 -> V_1702 ) ||
F_53 ( V_51 , V_1703 , V_191 -> V_1704 ) ||
F_53 ( V_51 , V_1705 , V_191 -> V_1706 ) ||
F_49 ( V_51 , V_195 ,
V_191 -> V_1707 , V_191 -> V_1708 ) ||
F_26 ( V_51 , V_200 ,
V_191 -> V_1709 ) ||
F_49 ( V_51 , V_202 ,
V_191 -> V_1710 , V_191 -> V_1711 ) ||
F_49 ( V_51 , V_1712 ,
F_277 ( V_191 -> V_1710 , 8 ) , V_191 -> V_1713 ) )
return - V_89 ;
if ( V_191 -> V_1714 . V_45 &&
F_49 ( V_51 , V_197 ,
sizeof( V_191 -> V_1714 ) , & V_191 -> V_1714 ) )
return - V_89 ;
if ( V_191 -> V_1715 . V_45 &&
F_49 ( V_51 , V_199 ,
sizeof( V_191 -> V_1715 ) + V_191 -> V_1716 ,
& V_191 -> V_1715 ) )
return - V_89 ;
F_46 ( V_51 , V_193 ) ;
return 0 ;
...
struct V_1323 * V_1367 )
{
struct V_4 * V_1717 , * V_1271 , * V_1718 , * V_1719 , * V_1327 , * V_1720 ;
int V_160 ;
if ( ! V_1367 )
return 0 ;
V_1717 = F_45 ( V_51 , V_233 ) ;
if ( ! V_1717 )
return - V_89 ;
if ( V_1367 -> V_1349 == 1 &&
F_26 ( V_51 , V_1326 ,
...
F_46 ( V_51 , V_1271 ) ;
if ( V_1367 -> V_1335 ) {
V_1718 = F_45 ( V_51 , V_1339 ) ;
if ( ! V_1718 )
return - V_89 ;
for ( V_160 = 0 ; V_160 < V_1367 -> V_1335 ; V_160 ++ ) {
V_1719 = F_45 ( V_51 , V_160 ) ;
if ( ! V_1719 )
return - V_89 ;
if ( F_49 ( V_51 , V_1342 ,
...
if ( ! V_7 -> V_18 . V_192 )
return - V_560 ;
if ( V_7 -> V_18 . V_1686 && V_7 -> V_18 . V_1686 -> V_191 ) {
V_1721 += V_7 -> V_18 . V_1686 -> V_191 -> V_1716 +
V_7 -> V_18 . V_1686 -> V_191 -> V_1707 +
V_7 -> V_18 . V_1686 -> V_191 -> V_1710 +
V_7 -> V_18 . V_1686 -> V_191 -> V_1710 / 8 ;
}
V_51 = F_75 ( V_1721 , V_135 ) ;
if ( ! V_51 )
return - V_136 ;
V_360 = F_23 ( V_51 , V_30 -> V_524 , V_30 -> V_525 , 0 ,
V_1722 ) ;
...
if ( V_7 -> V_18 . V_1686 ) {
struct V_4 * V_204 ;
V_204 = F_45 ( V_51 , V_1723 ) ;
if ( ! V_204 )
goto V_59;
if ( ( V_7 -> V_18 . V_1686 -> V_1724 &&
F_27 ( V_51 , V_207 ) ) ||
( V_7 -> V_18 . V_1686 -> V_355 &&
F_27 ( V_51 , V_209 ) ) ||
( V_7 -> V_18 . V_1686 -> V_1725 &&
F_27 ( V_51 , V_211 ) ) ||
( V_7 -> V_18 . V_1686 -> V_1726 &&
F_27 ( V_51 , V_215 ) ) ||
( V_7 -> V_18 . V_1686 -> V_1727 &&
F_27 ( V_51 , V_217 ) ) ||
( V_7 -> V_18 . V_1686 -> V_1728 &&
F_27 ( V_51 , V_219 ) ) ||
( V_7 -> V_18 . V_1686 -> V_1729 &&
F_27 ( V_51 , V_221 ) ) )
goto V_59;
if ( F_389 ( V_51 , V_7 ) )
goto V_59;
if ( F_390 ( V_51 ,
V_7 -> V_18 . V_1686 -> V_191 ) )
goto V_59;
if ( F_392 (
V_51 ,
V_7 -> V_18 . V_1686 -> V_1730 ) )
goto V_59;
F_46 ( V_51 , V_204 ) ;
}
F_65 ( V_51 , V_360 ) ;
...
struct V_4 * V_43 ,
struct V_1685 * V_1731 )
{
struct V_4 * V_93 [ V_1732 ] ;
struct V_1697 * V_1183 ;
struct V_1733 * V_198 = NULL ;
struct V_1734 * V_48 = NULL ;
V_22 V_1721 ;
V_22 V_1735 , V_1736 , V_1716 = 0 , V_1737 ;
int V_35 , V_1738 ;
if ( ! V_7 -> V_18 . V_192 -> V_191 )
return - V_16 ;
V_35 = F_31 ( V_93 , V_1739 , V_43 ,
V_1740 , NULL ) ;
if ( V_35 )
return V_35 ;
if ( ! V_93 [ V_1698 ] ||
...
! V_93 [ V_1712 ] )
return - V_16 ;
V_1735 = F_22 ( V_93 [ V_195 ] ) ;
if ( V_1735 > V_7 -> V_18 . V_192 -> V_191 -> V_196 )
return - V_16 ;
if ( F_4 ( V_93 [ V_200 ] ) >
V_7 -> V_18 . V_192 -> V_191 -> V_201 ||
F_4 ( V_93 [ V_200 ] ) == 0 )
return - V_16 ;
V_1736 = F_22 ( V_93 [ V_202 ] ) ;
if ( V_1736 > V_7 -> V_18 . V_192 -> V_191 -> V_203 )
return - V_16 ;
V_1737 = F_22 ( V_93 [ V_1712 ] ) ;
if ( V_1737 != F_277 ( V_1736 , 8 ) )
return - V_16 ;
if ( V_93 [ V_199 ] ) {
V_22 V_1741 = F_22 ( V_93 [ V_199 ] ) ;
V_198 = F_21 ( V_93 [ V_199 ] ) ;
V_1716 = V_1741 - sizeof( * V_198 ) ;
if ( ! V_198 -> V_45 || V_1716 % V_198 -> V_45 )
return - V_16 ;
if ( ! V_7 -> V_18 . V_192 -> V_191 -> V_198 )
return - V_16 ;
if ( V_198 -> V_45 > V_7 -> V_18 . V_192 -> V_191 -> V_198 -> V_1742 )
return - V_16 ;
if ( V_198 -> V_45 < V_7 -> V_18 . V_192 -> V_191 -> V_198 -> V_1743 )
return - V_16 ;
if ( V_1716 > V_7 -> V_18 . V_192 -> V_191 -> V_198 -> V_1744 )
return - V_16 ;
if ( V_198 -> V_1391 + V_198 -> V_45 > V_1735 )
return - V_16 ;
}
if ( V_93 [ V_197 ] ) {
...
return - V_16 ;
if ( V_48 -> V_45 + V_48 -> V_1391 > V_1735 )
return - V_16 ;
}
V_1721 = sizeof( * V_1183 ) ;
V_1721 += V_1735 ;
V_1721 += V_1736 + V_1737 ;
V_1721 += V_1716 ;
V_1183 = F_37 ( V_1721 , V_135 ) ;
if ( ! V_1183 )
return - V_136 ;
V_1183 -> V_1699 = F_396 ( V_93 [ V_1698 ] ) ;
V_1183 -> V_1058 = F_396 ( V_93 [ V_1700 ] ) ;
memcpy ( V_1183 -> V_1702 , F_21 ( V_93 [ V_1701 ] ) ,
V_607 ) ;
if ( V_93 [ V_1703 ] )
V_1738 = F_79 ( V_93 [ V_1703 ] ) ;
else
V_1738 = 0 ;
#ifdef F_397
V_35 = F_398 ( F_7 ( & V_7 -> V_18 ) , V_1745 , V_1746 ,
V_1747 , & V_1183 -> V_1748 , 1 ) ;
if ( V_35 ) {
F_39 ( V_1183 ) ;
return V_35 ;
}
if ( F_399 ( V_1183 -> V_1748 -> V_42 , V_1738 ) ) {
F_400 ( V_1183 -> V_1748 ) ;
F_39 ( V_1183 ) ;
return - V_1749 ;
}
V_1183 -> V_1704 = F_401 ( V_1183 -> V_1748 -> V_42 ) -> V_1750 ;
#else
if ( ! V_1738 ) {
F_39 ( V_1183 ) ;
return - V_16 ;
}
V_1183 -> V_1704 = V_1738 ;
#endif
V_1183 -> V_1706 = F_79 ( V_93 [ V_1705 ] ) ;
V_1183 -> V_1707 = V_1735 ;
V_1183 -> V_1708 = ( T_2 * ) V_1183 + sizeof( * V_1183 ) + V_1716 ;
memcpy ( ( void * ) V_1183 -> V_1708 ,
F_21 ( V_93 [ V_195 ] ) ,
V_1735 ) ;
if ( V_48 )
V_1183 -> V_1714 = * V_48 ;
V_1183 -> V_1709 = F_4 ( V_93 [ V_200 ] ) ;
V_1183 -> V_1710 = V_1736 ;
V_1183 -> V_1711 = ( T_2 * ) V_1183 + sizeof( * V_1183 ) + V_1716 + V_1735 ;
memcpy ( ( void * ) V_1183 -> V_1711 ,
F_21 ( V_93 [ V_202 ] ) ,
V_1736 ) ;
V_1183 -> V_1713 = ( T_2 * ) V_1183 + sizeof( * V_1183 ) + V_1716 +
V_1735 + V_1736 ;
memcpy ( ( void * ) V_1183 -> V_1713 ,
F_21 ( V_93 [ V_1712 ] ) ,
V_1737 ) ;
if ( V_198 ) {
V_1183 -> V_1716 = V_1716 ;
memcpy ( & V_1183 -> V_1715 , V_198 , sizeof( * V_198 ) + V_1716 ) ;
}
V_1731 -> V_191 = V_1183 ;
return 0 ;
}
static int F_402 ( struct V_6 * V_7 ,
const struct V_1751 * V_192 ,
struct V_4 * V_43 ,
struct V_1685 * V_1731 )
{
struct V_4 * * V_93 ;
int V_35 ;
V_93 = F_37 ( V_1752 * sizeof( * V_93 ) , V_135 ) ;
if ( ! V_93 )
return - V_136 ;
if ( ! ( V_192 -> V_49 & V_232 ) ) {
V_35 = - V_560 ;
...
if ( V_35 )
goto V_620;
V_1731 -> V_1730 = F_278 ( & V_7 -> V_18 , NULL , V_93 ,
V_192 -> V_234 ) ;
V_35 = F_281 ( V_1731 -> V_1730 ) ;
if ( V_35 )
V_1731 -> V_1730 = NULL ;
V_620:
F_39 ( V_93 ) ;
...
{
struct V_6 * V_7 = V_30 -> V_523 [ 0 ] ;
struct V_4 * V_93 [ V_1753 ] ;
struct V_1685 V_1754 = {} ;
struct V_1685 * V_1755 ;
const struct V_1751 * V_192 = V_7 -> V_18 . V_192 ;
int V_35 , V_160 ;
bool V_1756 = V_7 -> V_18 . V_1686 ;
bool V_1757 = false ;
if ( ! V_192 )
return - V_560 ;
if ( ! V_30 -> V_5 [ V_1723 ] ) {
F_404 ( V_7 ) ;
V_7 -> V_18 . V_1686 = NULL ;
goto V_1758;
}
V_35 = F_31 ( V_93 , V_1759 ,
V_30 -> V_5 [ V_1723 ] ,
V_1760 , V_30 -> V_127 ) ;
if ( V_35 )
return V_35 ;
...
struct V_4 * V_224 ;
int V_222 = 0 ;
int V_133 , V_1689 , V_1761 , V_1696 ;
struct V_4 * V_1762 [ V_1763 ] ;
V_1757 = true ;
...
return - V_16 ;
V_1754 . V_1690 = F_405 ( V_222 ,
sizeof( V_1754 . V_1690 [ 0 ] ) ,
V_135 ) ;
if ( ! V_1754 . V_1690 )
return - V_136 ;
V_1754 . V_222 = V_222 ;
...
rem) {
T_2 * V_1764 ;
F_31 ( V_1762 , V_1765 , V_224 ,
NULL , V_30 -> V_127 ) ;
V_35 = - V_16 ;
if ( ! V_1762 [ V_1692 ] ||
! V_1762 [ V_1693 ] )
goto error;
V_1689 = F_22 ( V_1762 [ V_1693 ] ) ;
V_1761 = F_277 ( V_1689 , 8 ) ;
if ( F_22 ( V_1762 [ V_1692 ] ) != V_1761 )
goto error;
if ( V_1689 > V_192 -> V_229 ||
V_1689 < V_192 -> V_227 )
goto error;
if ( ! V_1762 [ V_1695 ] )
V_1696 = 0 ;
...
V_1696 = F_4 (
V_1762 [ V_1695 ] ) ;
if ( V_1696 > V_192 -> V_230 )
goto error;
V_1754 . V_1690 [ V_160 ] . V_1696 = V_1696 ;
V_1764 = F_406 ( V_1761 + V_1689 , V_135 ) ;
if ( ! V_1764 ) {
V_35 = - V_136 ;
goto error;
}
V_1754 . V_1690 [ V_160 ] . V_707 = V_1764 ;
memcpy ( V_1764 , F_21 ( V_1762 [ V_1692 ] ) ,
V_1761 ) ;
V_1764 += V_1761 ;
V_1754 . V_1690 [ V_160 ] . V_1694 = V_1764 ;
V_1754 . V_1690 [ V_160 ] . V_1691 = V_1689 ;
memcpy ( V_1764 ,
F_21 ( V_1762 [ V_1693 ] ) ,
V_1689 ) ;
V_160 ++ ;
...
if ( V_1754 . V_1724 && V_1757 ) {
V_35 = - V_16 ;
goto error;
}
V_1755 = F_407 ( & V_1754 , sizeof( V_1754 ) , V_135 ) ;
if ( ! V_1755 ) {
V_35 = - V_136 ;
goto error;
}
F_404 ( V_7 ) ;
V_7 -> V_18 . V_1686 = V_1755 ;
V_1758:
if ( V_7 -> V_328 -> V_1758 &&
V_1756 != ! ! V_7 -> V_18 . V_1686 )
F_408 ( V_7 , V_7 -> V_18 . V_1686 ) ;
return 0 ;
error:
for ( V_160 = 0 ; V_160 < V_1754 . V_222 ; V_160 ++ )
F_39 ( V_1754 . V_1690 [ V_160 ] . V_707 ) ;
F_39 ( V_1754 . V_1690 ) ;
if ( V_1754 . V_191 && V_1754 . V_191 -> V_1748 )
F_400 ( V_1754 . V_191 -> V_1748 ) ;
F_39 ( V_1754 . V_191 ) ;
F_39 ( V_1754 . V_1730 ) ;
return V_35 ;
}
...
struct V_6 * V_7 )
{
struct V_4 * V_1687 , * V_1688 , * V_1766 , * V_1767 ;
int V_160 , V_162 , V_1689 ;
struct V_1768 * V_236 ;
if ( ! V_7 -> V_237 -> V_239 )
return 0 ;
V_1767 = F_45 ( V_51 , V_241 ) ;
if ( ! V_1767 )
return - V_89 ;
for ( V_160 = 0 ; V_160 < V_7 -> V_237 -> V_239 ; V_160 ++ ) {
V_1766 = F_45 ( V_51 , V_160 + 1 ) ;
if ( ! V_1766 )
return - V_89 ;
V_236 = & V_7 -> V_237 -> V_1769 [ V_160 ] ;
if ( F_26 ( V_51 , V_1770 ,
V_236 -> V_1357 ) )
return - V_89 ;
if ( F_26 ( V_51 , V_1771 ,
...
V_1688 = F_45 ( V_51 , V_162 + 1 ) ;
if ( ! V_1688 )
return - V_89 ;
V_1689 = V_236 -> V_1690 [ V_162 ] . V_1691 ;
if ( F_49 ( V_51 , V_1692 ,
F_277 ( V_1689 , 8 ) ,
V_236 -> V_1690 [ V_162 ] . V_707 ) ||
F_49 ( V_51 , V_1693 , V_1689 ,
V_236 -> V_1690 [ V_162 ] . V_1694 ) ||
F_26 ( V_51 , V_1695 ,
V_236 -> V_1690 [ V_162 ] . V_1696 ) )
return - V_89 ;
F_46 ( V_51 , V_1688 ) ;
}
F_46 ( V_51 , V_1687 ) ;
...
{
struct V_1775 * V_237 = V_7 -> V_237 ;
int V_160 , V_162 ;
struct V_1768 * V_236 ;
if ( ! V_237 )
return;
for ( V_160 = 0 ; V_160 < V_237 -> V_239 ; V_160 ++ ) {
V_236 = & V_237 -> V_1769 [ V_160 ] ;
for ( V_162 = 0 ; V_162 < V_236 -> V_222 ; V_162 ++ )
F_39 ( V_236 -> V_1690 [ V_162 ] . V_707 ) ;
F_39 ( V_236 -> V_1690 ) ;
}
F_39 ( V_237 -> V_1769 ) ;
F_39 ( V_237 ) ;
...
struct V_4 * V_236 ,
struct V_1768 * V_1776 )
{
int V_35 , V_160 ;
const struct V_1777 * V_237 = V_7 -> V_18 . V_237 ;
struct V_4 * V_93 [ V_1778 ] , * V_224 ;
int V_133 , V_1689 , V_1761 , V_1696 , V_222 = 0 ;
struct V_4 * V_1762 [ V_1763 ] ;
V_35 = F_31 ( V_93 , V_1779 , V_236 ,
V_1780 , NULL ) ;
if ( V_35 )
return V_35 ;
if ( V_93 [ V_1770 ] )
V_1776 -> V_1357 =
F_4 ( V_93 [ V_1770 ] ) ;
if ( V_1776 -> V_1357 > V_237 -> V_240 )
return - V_16 ;
if ( V_93 [ V_1771 ] )
V_1776 -> V_1772 =
F_4 ( V_93 [ V_1771 ] ) ;
if ( V_1776 -> V_1772 != V_1781 &&
V_1776 -> V_1772 != V_1782 )
return - V_16 ;
if ( ! V_93 [ V_1773 ] )
return - V_16 ;
...
return - V_16 ;
V_1776 -> V_1690 = F_405 ( V_222 , sizeof( V_1776 -> V_1690 [ 0 ] ) ,
V_135 ) ;
if ( ! V_1776 -> V_1690 )
return - V_136 ;
V_1776 -> V_222 = V_222 ;
...
rem) {
T_2 * V_1764 ;
F_31 ( V_1762 , V_1765 , V_224 , NULL , NULL ) ;
if ( ! V_1762 [ V_1692 ] ||
! V_1762 [ V_1693 ] )
return - V_16 ;
V_1689 = F_22 ( V_1762 [ V_1693 ] ) ;
...
if ( F_22 ( V_1762 [ V_1692 ] ) != V_1761 )
return - V_16 ;
if ( V_1689 > V_237 -> V_229 ||
V_1689 < V_237 -> V_227 )
return - V_16 ;
if ( ! V_1762 [ V_1695 ] )
V_1696 = 0 ;
else
V_1696 = F_4 ( V_1762 [ V_1695 ] ) ;
if ( V_1696 > V_237 -> V_230 )
return - V_16 ;
V_1776 -> V_1690 [ V_160 ] . V_1696 = V_1696 ;
V_1764 = F_406 ( V_1761 + V_1689 , V_135 ) ;
if ( ! V_1764 )
return - V_136 ;
V_1776 -> V_1690 [ V_160 ] . V_707 = V_1764 ;
memcpy ( V_1764 , F_21 ( V_1762 [ V_1692 ] ) ,
V_1761 ) ;
V_1764 += V_1761 ;
V_1776 -> V_1690 [ V_160 ] . V_1694 = V_1764 ;
V_1776 -> V_1690 [ V_160 ] . V_1691 = V_1689 ;
memcpy ( V_1764 , F_21 ( V_1762 [ V_1693 ] ) ,
V_1689 ) ;
V_160 ++ ;
}
return 0 ;
...
struct V_1775 * V_1784 ;
int V_35 , V_1785 , V_239 = 0 , V_160 , V_162 ;
struct V_4 * V_236 ;
struct V_1768 * V_1786 ;
if ( ! V_7 -> V_18 . V_237 || ! V_7 -> V_328 -> V_1787 )
return - V_560 ;
if ( ! V_30 -> V_5 [ V_241 ] ) {
F_411 ( V_7 ) ;
F_414 ( V_7 , NULL ) ;
...
return - V_16 ;
V_1783 . V_1769 = F_405 ( V_239 , sizeof( V_1783 . V_1769 [ 0 ] ) ,
V_135 ) ;
if ( ! V_1783 . V_1769 )
return - V_136 ;
V_1783 . V_239 = V_239 ;
...
V_35 = F_414 ( V_7 , & V_1783 ) ;
if ( V_35 )
goto error;
V_1784 = F_407 ( & V_1783 , sizeof( V_1783 ) , V_135 ) ;
if ( ! V_1784 ) {
V_35 = - V_136 ;
goto error;
}
...
return 0 ;
error:
for ( V_160 = 0 ; V_160 < V_1783 . V_239 ; V_160 ++ ) {
V_1786 = & V_1783 . V_1769 [ V_160 ] ;
for ( V_162 = 0 ; V_162 < V_1786 -> V_222 ; V_162 ++ )
F_39 ( V_1786 -> V_1690 [ V_162 ] . V_707 ) ;
F_39 ( V_1786 -> V_1690 ) ;
}
F_39 ( V_1783 . V_1769 ) ;
return V_35 ;
...
struct V_25 * V_559 = V_30 -> V_523 [ 1 ] ;
struct V_1 * V_17 = V_559 -> V_28 ;
struct V_4 * V_93 [ V_1788 ] ;
struct V_1789 V_1790 ;
int V_35 ;
if ( ! V_30 -> V_5 [ V_1791 ] )
return - V_16 ;
V_35 = F_31 ( V_93 , V_1792 ,
V_30 -> V_5 [ V_1791 ] ,
V_1793 , V_30 -> V_127 ) ;
if ( V_35 )
return V_35 ;
if ( F_22 ( V_93 [ V_1794 ] ) != V_1795 )
return - V_1796 ;
if ( F_22 ( V_93 [ V_1797 ] ) != V_1798 )
return - V_1796 ;
if ( F_22 ( V_93 [ V_1799 ] ) != V_1800 )
return - V_1796 ;
V_1790 . V_1801 = F_21 ( V_93 [ V_1797 ] ) ;
V_1790 . V_1802 = F_21 ( V_93 [ V_1799 ] ) ;
V_1790 . V_1803 = F_21 ( V_93 [ V_1794 ] ) ;
F_116 ( V_17 ) ;
if ( ! V_17 -> V_149 ) {
V_35 = - V_1381 ;
goto V_620;
...
{
struct V_6 * V_7 = V_30 -> V_523 [ 0 ] ;
struct V_1807 * V_1808 , * V_1809 ;
int V_1810 ;
if ( ! ( V_7 -> V_18 . V_49 & V_345 ) )
return - V_560 ;
V_1809 = F_37 ( sizeof( * V_1809 ) , V_135 ) ;
if ( ! V_1809 )
return - V_136 ;
F_302 ( & V_7 -> V_1811 ) ;
F_6 (reg, &rdev->beacon_registrations, list) {
if ( V_1808 -> V_1812 == V_30 -> V_524 ) {
V_1810 = - V_793 ;
goto V_967;
}
}
V_1809 -> V_1812 = V_30 -> V_524 ;
F_421 ( & V_1809 -> V_666 , & V_7 -> V_1813 ) ;
F_304 ( & V_7 -> V_1811 ) ;
return 0 ;
V_967:
F_304 ( & V_7 -> V_1811 ) ;
...
return - V_560 ;
if ( V_438 && ! ( V_438 & F_113 ( V_1824 ) ) )
return - V_16 ;
V_1820 . V_438 = V_438 ;
}
V_35 = F_429 ( V_7 , V_17 , & V_1820 ) ;
if ( V_35 )
return V_35 ;
V_17 -> V_1816 = true ;
V_7 -> V_1817 ++ ;
...
static int F_432 ( struct V_4 * V_1825 )
{
struct V_4 * V_43 ;
...
static int F_433 ( struct V_4 * V_1827 ,
...
if ( V_691 < 0 )
return V_691 ;
F_117 ( sizeof( * V_1829 -> V_1832 ) != sizeof( * V_1829 -> V_1833 ) ) ;
V_1831 = F_405 ( V_691 , sizeof( * V_1829 -> V_1832 ) , V_135 ) ;
if ( ! V_1831 )
return - V_136 ;
V_160 = 0 ;
F_36 (attr, attr_filter, rem) {
V_1831 [ V_160 ] . V_1831 = F_434 ( V_43 , V_135 ) ;
V_1831 [ V_160 ] . V_45 = F_22 ( V_43 ) ;
V_160 ++ ;
}
if ( V_278 ) {
V_1829 -> V_1834 = V_691 ;
V_1829 -> V_1833 = V_1831 ;
} else {
V_1829 -> V_1835 = V_691 ;
V_1829 -> V_1832 = V_1831 ;
}
return 0 ;
}
...
V_17 -> V_660 != V_30 -> V_524 )
return - V_1381 ;
V_35 = F_31 ( V_93 , V_1839 ,
V_30 -> V_5 [ V_1838 ] ,
V_1840 , V_30 -> V_127 ) ;
if ( V_35 )
return V_35 ;
V_1829 = F_37 ( sizeof( * V_1829 ) , V_135 ) ;
if ( ! V_1829 )
return - V_136 ;
V_1829 -> V_673 = V_17 -> V_18 -> V_1365 ++ ;
if ( ! V_93 [ V_1841 ] ||
F_32 ( V_93 [ V_1841 ] ) > V_1842 ) {
V_35 = - V_16 ;
goto V_620;
}
V_1829 -> type = F_32 ( V_93 [ V_1841 ] ) ;
if ( ! V_93 [ V_1843 ] ) {
V_35 = - V_16 ;
goto V_620;
}
memcpy ( V_1829 -> V_1844 , F_21 ( V_93 [ V_1843 ] ) ,
sizeof( V_1829 -> V_1844 ) ) ;
V_1829 -> V_1845 =
F_170 ( V_93 [ V_1846 ] ) ;
if ( V_93 [ V_1847 ] ) {
V_1829 -> V_1848 =
...
V_1829 -> V_1865 =
F_32 ( V_93 [ V_1863 ] ) ;
memcpy ( V_1829 -> V_1866 . V_703 ,
F_21 ( V_93 [ V_1867 ] ) ,
sizeof( V_1829 -> V_1866 . V_703 ) ) ;
if ( V_1829 -> V_1851 ) {
V_35 = - V_16 ;
goto V_620;
}
...
if ( V_93 [ V_1868 ] ) {
struct V_4 * V_1869 [ V_1870 ] ;
V_35 = F_31 ( V_1869 , V_1871 ,
V_93 [ V_1868 ] ,
V_1872 , V_30 -> V_127 ) ;
if ( V_35 )
goto V_620;
...
V_1829 -> V_1882 = V_691 ;
V_1829 -> V_1883 =
F_37 ( sizeof( * V_1829 -> V_1883 ) * V_691 ,
V_135 ) ;
if ( ! V_1829 -> V_1883 ) {
V_35 = - V_136 ;
goto V_620;
...
memcpy ( V_1829 -> V_1883 [ V_160 ++ ] . V_703 , F_21 ( V_43 ) ,
sizeof( * V_1829 -> V_1883 ) ) ;
}
}
if ( V_93 [ V_1884 ] ) {
V_35 = F_433 ( V_93 [ V_1884 ] ,
V_1829 , true ) ;
if ( V_35 )
goto V_620;
}
if ( V_93 [ V_1885 ] ) {
V_35 = F_433 ( V_93 [ V_1885 ] ,
V_1829 , false ) ;
if ( V_35 )
goto V_620;
}
...
if ( F_104 ( V_51 , V_1369 , V_1829 -> V_673 ,
V_606 ) )
goto V_59;
V_1837 = F_45 ( V_51 , V_1838 ) ;
if ( ! V_1837 )
goto V_59;
if ( F_54 ( V_51 , V_1887 ,
V_1829 -> V_1888 ) )
...
V_1820 . V_1823 =
F_32 ( V_30 -> V_5 [ V_1822 ] ) ;
if ( V_1820 . V_1823 <= 1 || V_1820 . V_1823 == 255 )
return - V_16 ;
V_570 |= V_1889 ;
}
if ( V_30 -> V_5 [ V_513 ] ) {
...
if ( ! V_570 )
return - V_16 ;
return F_441 ( V_7 , V_17 , & V_1820 , V_570 ) ;
}
void F_442 ( struct V_1 * V_17 ,
struct V_1891 * V_1719 , T_10 V_1552 )
{
struct V_18 * V_18 = V_17 -> V_18 ;
struct V_6 * V_7 = F_11 ( V_18 ) ;
struct V_4 * V_1892 , * V_1893 , * V_1894 ;
struct V_31 * V_51 ;
void * V_360 ;
if ( F_60 ( ! V_1719 -> V_1895 || ! V_1719 -> V_1896 || ! V_1719 -> V_703 ) )
return;
V_51 = F_75 ( V_621 , V_1552 ) ;
if ( ! V_51 )
return;
V_360 = F_23 ( V_51 , 0 , 0 , 0 , V_1897 ) ;
if ( ! V_360 ) {
F_76 ( V_51 ) ;
return;
}
...
V_606 ) )
goto V_59;
if ( F_104 ( V_51 , V_1369 , V_1719 -> V_673 ,
V_606 ) ||
F_49 ( V_51 , V_567 , V_607 , V_1719 -> V_703 ) )
goto V_59;
V_1892 = F_45 ( V_51 , V_1898 ) ;
if ( ! V_1892 )
goto V_59;
V_1893 = F_45 ( V_51 , V_1899 ) ;
if ( ! V_1893 )
goto V_59;
if ( F_54 ( V_51 , V_1887 , V_1719 -> V_1895 ) )
goto V_59;
F_46 ( V_51 , V_1893 ) ;
V_1894 = F_45 ( V_51 , V_1900 ) ;
if ( ! V_1894 )
goto V_59;
if ( F_54 ( V_51 , V_1841 , V_1719 -> type ) ||
F_54 ( V_51 , V_1887 , V_1719 -> V_1896 ) )
goto V_59;
if ( V_1719 -> V_30 && V_1719 -> V_1901 &&
F_49 ( V_51 , V_1847 , V_1719 -> V_1901 ,
V_1719 -> V_30 ) )
goto V_59;
F_46 ( V_51 , V_1894 ) ;
F_46 ( V_51 , V_1892 ) ;
...
if ( ! V_1837 )
goto V_59;
if ( F_54 ( V_51 , V_1887 , V_1895 ) ||
F_54 ( V_51 , V_1905 , V_1589 ) )
goto V_59;
F_46 ( V_51 , V_1837 ) ;
F_65 ( V_51 , V_360 ) ;
if ( ! V_17 -> V_660 )
...
! F_20 ( V_30 -> V_5 [ V_752 ] ) )
return - V_16 ;
memset ( & V_1910 , 0 , sizeof( V_1910 ) ) ;
V_1910 . V_1913 = F_79 ( V_30 -> V_5 [ V_1912 ] ) ;
V_1910 . V_1214 = F_21 ( V_30 -> V_5 [ V_752 ] ) ;
V_1910 . V_1215 = F_22 ( V_30 -> V_5 [ V_752 ] ) ;
return F_447 ( V_7 , V_559 , & V_1910 ) ;
}
...
return - V_564 ;
if ( V_30 -> V_5 [ V_1917 ] )
V_1489 = F_79 ( V_30 -> V_5 [ V_1917 ] ) ;
if ( V_1489 >= V_1918 )
return - V_16 ;
if ( ! V_30 -> V_5 [ V_1919 ] )
return - V_16 ;
V_1308 =
F_79 ( V_30 -> V_5 [ V_1919 ] ) ;
if ( V_1308 > V_1920 )
return - V_1796 ;
V_516 = F_449 ( V_7 , V_17 , V_1489 , V_1308 ) ;
if ( ! V_516 )
V_7 -> V_1916 = V_30 -> V_524 ;
return V_516 ;
}
...
! V_30 -> V_5 [ V_1555 ] )
return - V_16 ;
V_1921 = F_4 ( V_30 -> V_5 [ V_1553 ] ) ;
V_1556 = F_4 ( V_30 -> V_5 [ V_1555 ] ) ;
for ( V_160 = 0 ; V_160 < V_7 -> V_18 . V_487 ; V_160 ++ ) {
const struct V_1922 * V_1923 ;
void * V_140 = NULL ;
int V_45 = 0 ;
V_1923 = & V_7 -> V_18 . V_491 [ V_160 ] ;
if ( V_1923 -> V_30 . V_1554 != V_1921 || V_1923 -> V_30 . V_1556 != V_1556 )
continue;
if ( V_1923 -> V_49 & ( V_1924 |
V_1925 ) ) {
if ( ! V_17 )
return - V_16 ;
if ( V_1923 -> V_49 & V_1925 &&
! V_17 -> V_19 )
return - V_16 ;
if ( V_1923 -> V_49 & V_1926 ) {
if ( ! F_423 ( V_17 ) )
return - V_574 ;
}
if ( ! V_1923 -> V_1927 )
...
V_7 -> V_1565 = V_30 ;
V_35 = V_7 -> V_18 . V_491 [ V_160 ] . V_1927 ( & V_7 -> V_18 , V_17 ,
V_140 , V_45 ) ;
V_7 -> V_1565 = NULL ;
return V_35 ;
}
...
V_35 = F_14 ( V_34 -> V_36 , V_37 + V_38 . V_39 , V_1468 ,
V_38 . V_40 , V_41 , NULL ) ;
if ( V_35 )
return V_35 ;
if ( ! V_1468 [ V_1553 ] ||
! V_1468 [ V_1555 ] )
return - V_16 ;
* V_17 = F_1 ( F_16 ( V_32 -> V_42 ) , V_1468 ) ;
if ( F_17 ( * V_17 ) )
* V_17 = NULL ;
* V_7 = F_8 ( F_16 ( V_32 -> V_42 ) , V_1468 ) ;
if ( F_17 ( * V_7 ) )
return F_18 ( * V_7 ) ;
V_1921 = F_4 ( V_1468 [ V_1553 ] ) ;
V_1556 = F_4 ( V_1468 [ V_1555 ] ) ;
for ( V_160 = 0 ; V_160 < ( * V_7 ) -> V_18 . V_487 ; V_160 ++ ) {
const struct V_1922 * V_1923 ;
V_1923 = & ( * V_7 ) -> V_18 . V_491 [ V_160 ] ;
if ( V_1923 -> V_30 . V_1554 != V_1921 || V_1923 -> V_30 . V_1556 != V_1556 )
...
return - V_560 ;
if ( V_1468 [ V_490 ] ) {
V_140 = F_21 ( V_1468 [ V_490 ] ) ;
V_1567 = F_22 ( V_1468 [ V_490 ] ) ;
}
V_34 -> args [ 0 ] = ( * V_7 ) -> V_14 + 1 ;
...
V_1930 = F_45 ( V_32 , V_490 ) ;
if ( ! V_1930 ) {
F_66 ( V_32 , V_360 ) ;
break;
}
V_35 = V_1923 -> V_1929 ( & V_7 -> V_18 , V_17 , V_32 , V_140 , V_1567 ,
...
F_46 ( V_32 , V_140 ) ;
F_65 ( V_32 , V_360 ) ;
return F_77 ( V_32 , V_7 -> V_1565 ) ;
}
static int F_457 ( struct V_31 * V_32 ,
struct V_29 * V_30 )
{
struct V_6 * V_7 = V_30 -> V_523 [ 0 ] ;
struct V_1931 * V_1932 = NULL ;
struct V_25 * V_559 = V_30 -> V_523 [ 1 ] ;
T_2 * V_44 , V_45 , V_1933 , V_1934 , V_1935 ;
int V_516 ;
if ( ! V_7 -> V_328 -> V_451 )
return - V_560 ;
if ( V_30 -> V_5 [ V_1936 ] ) {
V_44 = F_21 ( V_30 -> V_5 [ V_1936 ] ) ;
V_45 = F_22 ( V_30 -> V_5 [ V_1936 ] ) ;
if ( V_45 % 2 || V_45 < V_1937 ||
V_45 > V_1938 )
return - V_16 ;
V_1932 = F_37 ( sizeof( struct V_1931 ) , V_135 ) ;
if ( ! V_1932 )
return - V_136 ;
V_1933 = ( V_45 - V_1937 ) >> 1 ;
if ( V_1933 ) {
V_1934 = V_1933 *
sizeof( struct V_1939 ) ;
memcpy ( V_1932 -> V_1940 , V_44 , V_1934 ) ;
V_1932 -> V_1933 = V_1933 ;
for ( V_1935 = 0 ; V_1935 < V_1933 ; V_1935 ++ ) {
if ( V_1932 -> V_1940 [ V_1935 ] . V_1941 > 7 ) {
F_39 ( V_1932 ) ;
return - V_16 ;
}
}
...
memcpy ( V_1932 -> V_1941 , V_44 , V_1937 ) ;
}
F_116 ( V_559 -> V_28 ) ;
V_516 = F_40 ( V_559 -> V_28 ) ;
if ( ! V_516 )
V_516 = F_458 ( V_7 , V_559 , V_1932 ) ;
F_118 ( V_559 -> V_28 ) ;
F_39 ( V_1932 ) ;
return V_516 ;
}
...
return - V_560 ;
if ( ! V_30 -> V_5 [ V_1944 ] || ! V_30 -> V_5 [ V_567 ] ||
! V_30 -> V_5 [ V_1945 ] )
return - V_16 ;
V_1942 = F_32 ( V_30 -> V_5 [ V_1944 ] ) ;
if ( V_1942 >= V_951 )
return - V_16 ;
V_1941 = F_32 ( V_30 -> V_5 [ V_1945 ] ) ;
if ( V_1941 >= V_1946 )
return - V_16 ;
if ( V_1942 >= V_1947 ) {
return - V_16 ;
...
V_35 = F_460 ( V_7 , V_559 , V_1942 , V_1611 , V_1941 , V_1943 ) ;
V_620:
F_118 ( V_17 ) ;
return V_35 ;
}
...
V_1611 = F_21 ( V_30 -> V_5 [ V_567 ] ) ;
F_116 ( V_17 ) ;
V_35 = F_462 ( V_7 , V_559 , V_1942 , V_1611 ) ;
F_118 ( V_17 ) ;
return V_35 ;
}
...
return - V_16 ;
V_703 = F_21 ( V_30 -> V_5 [ V_567 ] ) ;
V_1949 = F_32 ( V_30 -> V_5 [ V_1952 ] ) ;
F_116 ( V_17 ) ;
V_35 = F_464 ( V_7 , V_559 , V_703 , V_1949 , & V_540 ) ;
F_118 ( V_17 ) ;
return V_35 ;
}
...
V_17 -> V_141 != V_144 )
return - V_560 ;
V_622 = V_30 -> V_5 [ V_1955 ] ;
V_1954 = F_170 ( V_622 ) ;
return F_468 ( V_7 , V_559 , V_1954 ) ;
}
static int F_469 ( const struct V_1956 * V_328 , struct V_31 * V_32 ,
struct V_29 * V_30 )
{
struct V_6 * V_7 ;
struct V_1 * V_17 ;
struct V_25 * V_559 ;
bool V_1957 = V_328 -> V_1958 & V_1959 ;
if ( V_1957 )
F_69 () ;
if ( V_328 -> V_1958 & V_1960 ) {
V_7 = F_12 ( F_95 ( V_30 ) , V_30 ) ;
if ( F_17 ( V_7 ) ) {
if ( V_1957 )
F_70 () ;
...
static void F_470 ( const struct V_1956 * V_328 , struct V_31 * V_32 ,
struct V_29 * V_30 )
{
if ( V_30 -> V_523 [ 1 ] ) {
if ( V_328 -> V_1958 & V_1962 ) {
struct V_1 * V_17 = V_30 -> V_523 [ 1 ] ;
if ( V_17 -> V_19 )
F_191 ( V_17 -> V_19 ) ;
} else {
...
if ( V_328 -> V_1958 & V_1959 )
F_70 () ;
if ( V_328 -> V_1958 & V_1964 ) {
struct V_1965 * V_36 = F_471 ( V_32 ) ;
memset ( F_472 ( V_36 ) , 0 , F_473 ( V_36 ) ) ;
}
}
...
static int F_475 ( struct V_31 * V_51 ,
struct V_6 * V_7 )
{
...
goto V_59;
if ( V_1367 -> V_30 . V_1968 &&
( F_104 ( V_51 , V_1969 ,
V_1367 -> V_30 . V_1968 , V_1412 ) ||
F_49 ( V_51 , V_1970 , V_607 ,
V_1367 -> V_30 . V_1971 ) ) )
goto V_59;
return 0 ;
V_59:
...
static int F_476 ( struct V_31 * V_51 ,
struct V_6 * V_7 ,
struct V_1 * V_17 ,
...
struct V_31 * F_478 ( struct V_6 * V_7 ,
struct V_1 * V_17 , bool V_1974 )
{
struct V_31 * V_51 ;
V_51 = F_75 ( V_621 , V_135 ) ;
if ( ! V_51 )
...
static bool F_480 ( struct V_31 * V_51 ,
struct V_1976 * V_1295 )
{
if ( F_54 ( V_51 , V_1977 , V_1295 -> V_1612 ) )
goto V_59;
...
if ( ! V_51 )
return;
V_360 = F_23 ( V_51 , 0 , 0 , 0 , V_1985 ) ;
if ( ! V_360 ) {
F_76 ( V_51 ) ;
return;
}
if ( F_480 ( V_51 , V_1295 ) == false )
goto V_59;
F_65 ( V_51 , V_360 ) ;
F_245 () ;
F_482 ( & V_38 , V_51 , 0 ,
...
static void F_483 ( struct V_6 * V_7 ,
struct V_25 * V_19 ,
const T_2 * V_1635 , T_4 V_45 ,
enum V_357 V_50 , T_10 V_1552 ,
int V_1007 )
{
struct V_31 * V_51 ;
void * V_360 ;
V_51 = F_75 ( 100 + V_45 , V_1552 ) ;
if ( ! V_51 )
return;
V_360 = F_23 ( V_51 , 0 , 0 , 0 , V_50 ) ;
if ( ! V_360 ) {
...
struct V_25 * V_19 , const T_2 * V_1635 ,
T_4 V_45 , T_10 V_1552 )
{
F_483 ( V_7 , V_19 , V_1635 , V_45 ,
V_784 , V_1552 , - 1 ) ;
}
void F_485 ( struct V_6 * V_7 ,
struct V_25 * V_19 , const T_2 * V_1635 ,
T_4 V_45 , T_10 V_1552 , int V_1007 )
{
F_483 ( V_7 , V_19 , V_1635 , V_45 ,
V_1990 , V_1552 , V_1007 ) ;
}
void F_486 ( struct V_6 * V_7 ,
struct V_25 * V_19 , const T_2 * V_1635 ,
T_4 V_45 , T_10 V_1552 )
{
F_483 ( V_7 , V_19 , V_1635 , V_45 ,
...
void F_488 ( struct V_25 * V_559 , const T_2 * V_1635 ,
T_4 V_45 )
{
struct V_1 * V_17 = V_559 -> V_28 ;
struct V_18 * V_18 = V_17 -> V_18 ;
struct V_6 * V_7 = F_11 ( V_18 ) ;
const struct V_1993 * V_1994 = ( void * ) V_1635 ;
V_22 V_50 ;
if ( F_60 ( V_45 < 2 ) )
return;
if ( F_489 ( V_1994 -> V_1995 ) )
V_50 = V_1996 ;
else
V_50 = V_1997 ;
F_490 ( V_559 , V_1635 , V_45 ) ;
F_483 ( V_7 , V_559 , V_1635 , V_45 , V_50 , V_1987 , - 1 ) ;
}
static void F_491 ( struct V_6 * V_7 ,
struct V_25 * V_19 , int V_50 ,
const T_2 * V_703 , T_10 V_1552 )
{
struct V_31 * V_51 ;
void * V_360 ;
V_51 = F_75 ( V_621 , V_1552 ) ;
...
void F_492 ( struct V_6 * V_7 ,
struct V_25 * V_19 , const T_2 * V_703 ,
T_10 V_1552 )
{
F_491 ( V_7 , V_19 , V_784 ,
V_703 , V_1552 ) ;
}
void F_493 ( struct V_6 * V_7 ,
struct V_25 * V_19 , const T_2 * V_703 ,
T_10 V_1552 )
{
F_491 ( V_7 , V_19 , V_1990 ,
V_703 , V_1552 ) ;
}
void F_494 ( struct V_6 * V_7 ,
struct V_25 * V_19 ,
struct V_1999 * V_2000 ,
T_10 V_1552 )
{
struct V_31 * V_51 ;
void * V_360 ;
V_51 = F_75 ( 100 + V_2000 -> V_2001 + V_2000 -> V_2002 +
V_2000 -> V_1526 + V_2000 -> V_1605 +
( V_2000 -> V_1598 ? V_2003 : 0 ) , V_1552 ) ;
if ( ! V_51 )
return;
...
F_26 ( V_51 , V_10 , V_19 -> V_20 ) ||
( V_2000 -> V_566 &&
F_49 ( V_51 , V_567 , V_607 , V_2000 -> V_566 ) ) ||
F_53 ( V_51 , V_1614 ,
V_2000 -> V_2004 < 0 ? V_2005 :
V_2000 -> V_2004 ) ||
( V_2000 -> V_2004 < 0 &&
( F_27 ( V_51 , V_1998 ) ||
F_26 ( V_51 , V_2006 ,
V_2000 -> V_2007 ) ) ) ||
( V_2000 -> V_2008 &&
F_49 ( V_51 , V_2009 , V_2000 -> V_2001 , V_2000 -> V_2008 ) ) ||
( V_2000 -> V_2010 &&
F_49 ( V_51 , V_2011 , V_2000 -> V_2002 ,
V_2000 -> V_2010 ) ) ||
( V_2000 -> V_2012 &&
F_53 ( V_51 , V_1579 ,
V_2000 -> V_1585 ) ) ||
( V_2000 -> V_2004 == V_2013 &&
( ( V_2000 -> V_1525 &&
F_49 ( V_51 , V_1524 , V_2000 -> V_1526 ,
V_2000 -> V_1525 ) ) ||
( V_2000 -> V_1604 &&
F_49 ( V_51 , V_1602 , V_2000 -> V_1605 , V_2000 -> V_1604 ) ) ||
( V_2000 -> V_1598 &&
F_49 ( V_51 , V_1597 , V_2003 , V_2000 -> V_1598 ) ) ) ) )
goto V_59;
F_65 ( V_51 , V_360 ) ;
F_332 ( & V_38 , F_7 ( & V_7 -> V_18 ) , V_51 , 0 ,
V_1989 , V_1552 ) ;
...
void F_495 ( struct V_6 * V_7 ,
struct V_25 * V_19 ,
struct V_2014 * V_30 , T_10 V_1552 )
{
struct V_31 * V_51 ;
void * V_360 ;
const T_2 * V_566 = V_30 -> V_1403 ? V_30 -> V_1403 -> V_566 : V_30 -> V_566 ;
V_51 = F_75 ( 100 + V_30 -> V_2001 + V_30 -> V_2002 , V_1552 ) ;
if ( ! V_51 )
return;
V_360 = F_23 ( V_51 , 0 , 0 , 0 , V_2015 ) ;
if ( ! V_360 ) {
F_76 ( V_51 ) ;
return;
}
...
( V_30 -> V_2008 &&
F_49 ( V_51 , V_2009 , V_30 -> V_2001 ,
V_30 -> V_2008 ) ) ||
( V_30 -> V_2010 &&
F_49 ( V_51 , V_2011 , V_30 -> V_2002 ,
V_30 -> V_2010 ) ) )
goto V_59;
F_65 ( V_51 , V_360 ) ;
F_332 ( & V_38 , F_7 ( & V_7 -> V_18 ) , V_51 , 0 ,
...
struct V_25 * V_19 , T_3 V_1589 ,
const T_2 * V_1214 , T_4 V_1215 , bool V_2016 )
{
struct V_31 * V_51 ;
void * V_360 ;
...
void F_498 ( struct V_25 * V_559 , const T_2 * V_703 ,
const T_2 * V_1214 , T_2 V_1215 , T_10 V_1552 )
{
struct V_1 * V_17 = V_559 -> V_28 ;
...
return;
F_499 ( V_559 , V_703 ) ;
V_51 = F_75 ( 100 + V_1215 , V_1552 ) ;
if ( ! V_51 )
return;
V_360 = F_23 ( V_51 , 0 , 0 , 0 , V_2019 ) ;
if ( ! V_360 ) {
F_76 ( V_51 ) ;
return;
}
...
struct V_25 * V_19 , const T_2 * V_703 ,
enum V_2020 V_2021 , int V_2022 ,
const T_2 * V_2023 , T_10 V_1552 )
{
struct V_31 * V_51 ;
void * V_360 ;
V_51 = F_75 ( V_621 , V_1552 ) ;
...
F_26 ( V_51 , V_125 , V_2021 ) ||
( V_2022 != - 1 &&
F_54 ( V_51 , V_121 , V_2022 ) ) ||
( V_2023 && F_49 ( V_51 , V_120 , 6 , V_2023 ) ) )
goto V_59;
F_65 ( V_51 , V_360 ) ;
F_332 ( & V_38 , F_7 ( & V_7 -> V_18 ) , V_51 , 0 ,
V_1989 , V_1552 ) ;
...
void * V_360 ;
struct V_4 * V_364 ;
V_51 = F_75 ( V_621 , V_1987 ) ;
if ( ! V_51 )
return;
V_360 = F_23 ( V_51 , 0 , 0 , 0 , V_2027 ) ;
if ( ! V_360 ) {
F_76 ( V_51 ) ;
return;
}
...
goto V_59;
V_364 = F_45 ( V_51 , V_2028 ) ;
if ( ! V_364 )
goto V_59;
if ( F_25 ( V_51 , V_2025 , false ) )
goto V_59;
F_46 ( V_51 , V_364 ) ;
V_364 = F_45 ( V_51 , V_2029 ) ;
if ( ! V_364 )
goto V_59;
if ( F_25 ( V_51 , V_2026 , false ) )
goto V_59;
F_46 ( V_51 , V_364 ) ;
F_65 ( V_51 , V_360 ) ;
F_245 () ;
...
struct V_52 * V_53 ,
unsigned int V_1308 , T_10 V_1552 )
{
struct V_31 * V_51 ;
void * V_360 ;
V_51 = F_75 ( V_621 , V_1552 ) ;
...
void F_503 ( struct V_1 * V_17 , T_1 V_673 ,
struct V_52 * V_53 ,
unsigned int V_1308 , T_10 V_1552 )
{
struct V_18 * V_18 = V_17 -> V_18 ;
struct V_6 * V_7 = F_11 ( V_18 ) ;
F_504 ( V_17 , V_673 , V_53 , V_1308 ) ;
F_502 ( V_1624 ,
V_7 , V_17 , V_673 , V_53 ,
V_1308 , V_1552 ) ;
}
void F_505 ( struct V_1 * V_17 , T_1 V_673 ,
struct V_52 * V_53 ,
T_10 V_1552 )
{
struct V_18 * V_18 = V_17 -> V_18 ;
struct V_6 * V_7 = F_11 ( V_18 ) ;
F_506 ( V_17 , V_673 , V_53 ) ;
F_502 ( V_2030 ,
V_7 , V_17 , V_673 , V_53 , 0 , V_1552 ) ;
}
void F_507 ( struct V_25 * V_559 , const T_2 * V_675 ,
struct V_873 * V_874 , T_10 V_1552 )
{
struct V_18 * V_18 = V_559 -> V_28 -> V_18 ;
struct V_6 * V_7 = F_11 ( V_18 ) ;
struct V_31 * V_51 ;
F_508 ( V_559 , V_675 , V_874 ) ;
V_51 = F_75 ( V_621 , V_1552 ) ;
if ( ! V_51 )
return;
...
void F_509 ( struct V_25 * V_559 , const T_2 * V_675 ,
struct V_873 * V_874 , T_10 V_1552 )
{
struct V_18 * V_18 = V_559 -> V_28 -> V_18 ;
struct V_6 * V_7 = F_11 ( V_18 ) ;
...
static bool F_512 ( struct V_25 * V_559 , T_2 V_50 ,
const T_2 * V_703 , T_10 V_1552 )
{
struct V_1 * V_17 = V_559 -> V_28 ;
struct V_6 * V_7 = F_11 ( V_17 -> V_18 ) ;
struct V_31 * V_51 ;
void * V_360 ;
V_22 V_1812 = F_513 ( V_17 -> V_1805 ) ;
if ( ! V_1812 )
return false ;
V_51 = F_75 ( 100 , V_1552 ) ;
if ( ! V_51 )
return true ;
V_360 = F_23 ( V_51 , 0 , 0 , 0 , V_50 ) ;
if ( ! V_360 ) {
...
goto V_59;
F_65 ( V_51 , V_360 ) ;
F_443 ( F_7 ( & V_7 -> V_18 ) , V_51 , V_1812 ) ;
return true ;
V_59:
F_66 ( V_51 , V_360 ) ;
F_76 ( V_51 ) ;
...
V_516 = F_512 ( V_559 , V_2037 ,
V_703 , V_1552 ) ;
F_516 ( V_516 ) ;
return V_516 ;
}
bool F_517 ( struct V_25 * V_559 ,
const T_2 * V_703 , T_10 V_1552 )
{
struct V_1 * V_17 = V_559 -> V_28 ;
bool V_516 ;
...
int F_519 ( struct V_6 * V_7 ,
struct V_1 * V_17 , V_22 V_1812 ,
int V_2039 , int V_2040 ,
const T_2 * V_1635 , T_4 V_45 , V_22 V_49 , T_10 V_1552 )
{
...
F_104 ( V_51 , V_12 , V_13 ( V_17 ) ,
V_606 ) ||
F_26 ( V_51 , V_542 , V_2039 ) ||
( V_2040 &&
F_26 ( V_51 , V_2041 , V_2040 ) ) ||
F_49 ( V_51 , V_1632 , V_45 , V_1635 ) ||
( V_49 &&
F_26 ( V_51 , V_2042 , V_49 ) ) )
goto V_59;
F_65 ( V_51 , V_360 ) ;
return F_443 ( F_7 ( & V_7 -> V_18 ) , V_51 , V_1812 ) ;
V_59:
F_66 ( V_51 , V_360 ) ;
F_76 ( V_51 ) ;
return - V_89 ;
}
void F_520 ( struct V_1 * V_17 , T_1 V_673 ,
const T_2 * V_1635 , T_4 V_45 , bool V_2043 , T_10 V_1552 )
{
struct V_18 * V_18 = V_17 -> V_18 ;
struct V_6 * V_7 = F_11 ( V_18 ) ;
struct V_25 * V_19 = V_17 -> V_19 ;
...
static struct V_31 * F_522 ( struct V_25 * V_559 ,
const char * V_1049 , T_10 V_1552 )
{
struct V_1 * V_17 = V_559 -> V_28 ;
struct V_6 * V_7 = F_11 ( V_17 -> V_18 ) ;
struct V_31 * V_51 = F_75 ( V_621 , V_1552 ) ;
void * * V_34 ;
if ( ! V_51 )
return NULL ;
V_34 = ( void * * ) V_51 -> V_34 ;
V_34 [ 0 ] = F_23 ( V_51 , 0 , 0 , 0 , V_2046 ) ;
if ( ! V_34 [ 0 ] ) {
F_76 ( V_51 ) ;
return NULL ;
}
...
static void F_523 ( struct V_31 * V_51 , T_10 V_1552 )
{
...
void F_524 ( struct V_25 * V_559 ,
enum V_2047 V_2048 ,
T_7 V_2049 , T_10 V_1552 )
{
struct V_31 * V_51 ;
struct V_1 * V_17 = V_559 -> V_28 ;
struct V_6 * V_7 = F_11 ( V_17 -> V_18 ) ;
F_525 ( V_559 , V_2048 , V_2049 ) ;
if ( F_60 ( V_2048 != V_2050 &&
V_2048 != V_2051 ) )
return;
if ( V_17 -> V_1658 ) {
V_17 -> V_1658 -> V_1659 = V_2049 ;
F_375 ( V_7 , V_559 ) ;
if ( V_2049 == 0 )
V_2049 = V_17 -> V_1658 -> V_1659 ;
}
V_51 = F_522 ( V_559 , NULL , V_1552 ) ;
if ( ! V_51 )
return;
if ( F_26 ( V_51 , V_2052 ,
V_2048 ) )
goto V_59;
if ( V_2049 && F_226 ( V_51 , V_2053 ,
V_2049 ) )
goto V_59;
F_523 ( V_51 , V_1552 ) ;
return;
...
void F_526 ( struct V_25 * V_559 ,
const T_2 * V_1611 , V_22 V_2054 ,
V_22 V_247 , V_22 V_1650 , T_10 V_1552 )
{
struct V_31 * V_51 ;
V_51 = F_522 ( V_559 , V_1611 , V_1552 ) ;
if ( ! V_51 )
return;
if ( F_26 ( V_51 , V_1680 , V_2054 ) )
goto V_59;
if ( F_26 ( V_51 , V_1679 , V_247 ) )
goto V_59;
if ( F_26 ( V_51 , V_1681 , V_1650 ) )
goto V_59;
F_523 ( V_51 , V_1552 ) ;
return;
V_59:
...
void F_527 ( struct V_25 * V_559 ,
const T_2 * V_1611 , V_22 V_2054 , T_10 V_1552 )
{
struct V_31 * V_51 ;
F_528 ( V_559 , V_1611 , V_2054 ) ;
V_51 = F_522 ( V_559 , V_1611 , V_1552 ) ;
if ( ! V_51 )
return;
if ( F_26 ( V_51 , V_2055 , V_2054 ) )
goto V_59;
F_523 ( V_51 , V_1552 ) ;
return;
V_59:
...
void F_529 ( struct V_25 * V_559 , T_10 V_1552 )
{
struct V_31 * V_51 ;
V_51 = F_522 ( V_559 , NULL , V_1552 ) ;
if ( ! V_51 )
...
static void F_530 ( struct V_6 * V_7 ,
struct V_25 * V_19 , const T_2 * V_566 ,
const T_2 * V_1803 , T_10 V_1552 )
{
struct V_31 * V_51 ;
struct V_4 * V_2057 ;
void * V_360 ;
...
void F_531 ( struct V_25 * V_559 , const T_2 * V_566 ,
const T_2 * V_1803 , T_10 V_1552 )
{
struct V_1 * V_17 = V_559 -> V_28 ;
struct V_18 * V_18 = V_17 -> V_18 ;
struct V_6 * V_7 = F_11 ( V_18 ) ;
F_532 ( V_559 , V_566 ) ;
F_530 ( V_7 , V_559 , V_566 , V_1803 , V_1552 ) ;
}
static void
F_533 ( struct V_6 * V_7 ,
struct V_25 * V_19 , int V_2059 ,
const T_2 * V_566 , bool V_2060 , T_10 V_1552 )
{
struct V_31 * V_51 ;
struct V_4 * V_43 ;
void * V_360 ;
...
F_26 ( V_51 , V_10 , V_19 -> V_20 ) )
goto V_59;
V_43 = F_45 ( V_51 , V_2062 ) ;
if ( ! V_43 )
goto V_59;
if ( F_26 ( V_51 , V_2063 , V_2059 ) ||
F_49 ( V_51 , V_2064 , V_607 , V_566 ) ||
( V_2060 &&
F_27 ( V_51 , V_2065 ) ) )
goto V_59;
F_46 ( V_51 , V_43 ) ;
...
void F_534 ( struct V_25 * V_559 , int V_2059 ,
const T_2 * V_566 , bool V_2060 , T_10 V_1552 )
{
struct V_1 * V_17 = V_559 -> V_28 ;
struct V_18 * V_18 = V_17 -> V_18 ;
struct V_6 * V_7 = F_11 ( V_18 ) ;
F_535 ( V_559 , V_2059 , V_566 , V_2060 ) ;
F_533 ( V_7 , V_559 , V_2059 , V_566 , V_2060 , V_1552 ) ;
}
static void F_536 ( struct V_6 * V_7 ,
struct V_25 * V_19 ,
struct V_539 * V_540 ,
T_10 V_1552 ,
enum V_357 V_2066 ,
...
V_17 -> V_540 = * V_540 ;
V_17 -> V_565 = * V_540 ;
F_536 ( V_7 , V_559 , V_540 , V_135 ,
V_2068 , 0 ) ;
}
void F_539 ( struct V_25 * V_559 ,
struct V_539 * V_540 ,
T_2 V_1384 )
{
struct V_1 * V_17 = V_559 -> V_28 ;
...
void
F_541 ( struct V_6 * V_7 ,
const struct V_539 * V_540 ,
enum V_2069 V_2070 ,
struct V_25 * V_19 , T_10 V_1552 )
{
struct V_31 * V_51 ;
void * V_360 ;
V_51 = F_75 ( V_621 , V_1552 ) ;
...
void F_542 ( struct V_25 * V_559 , const T_2 * V_703 ,
T_1 V_673 , bool V_2073 , T_10 V_1552 )
{
struct V_1 * V_17 = V_559 -> V_28 ;
struct V_6 * V_7 = F_11 ( V_17 -> V_18 ) ;
struct V_31 * V_51 ;
void * V_360 ;
F_543 ( V_559 , V_703 , V_673 , V_2073 ) ;
V_51 = F_75 ( V_621 , V_1552 ) ;
if ( ! V_51 )
return;
V_360 = F_23 ( V_51 , 0 , 0 , 0 , V_1806 ) ;
if ( ! V_360 ) {
F_76 ( V_51 ) ;
return;
}
...
void F_544 ( struct V_18 * V_18 ,
const T_2 * V_2074 , T_4 V_45 ,
int V_2039 , int V_2040 )
{
struct V_6 * V_7 = F_11 ( V_18 ) ;
struct V_31 * V_51 ;
...
F_545 ( V_18 , V_2074 , V_45 , V_2039 , V_2040 ) ;
F_302 ( & V_7 -> V_1811 ) ;
F_6 (reg, &rdev->beacon_registrations, list) {
V_51 = F_75 ( V_45 + 100 , V_1987 ) ;
if ( ! V_51 ) {
F_304 ( & V_7 -> V_1811 ) ;
return;
}
...
( V_2040 &&
F_26 ( V_51 , V_2041 , V_2040 ) ) ||
F_49 ( V_51 , V_1632 , V_45 , V_2074 ) )
goto V_59;
F_65 ( V_51 , V_360 ) ;
F_443 ( F_7 ( & V_7 -> V_18 ) , V_51 , V_1808 -> V_1812 ) ;
}
F_304 ( & V_7 -> V_1811 ) ;
return;
V_59:
...
static int F_546 ( struct V_31 * V_51 ,
struct V_2075 * V_2076 )
{
struct V_2077 * V_1717 = V_2076 -> V_2078 ;
struct V_4 * V_2079 , * V_2080 , * V_363 ;
int V_160 , V_162 ;
V_2079 = F_45 (
V_51 , V_2081 ) ;
if ( ! V_2079 )
return - V_515 ;
for ( V_160 = 0 ; V_160 < V_1717 -> V_2082 ; V_160 ++ ) {
struct V_2083 * V_1719 = V_1717 -> V_1718 [ V_160 ] ;
V_2080 = F_45 ( V_51 , V_160 ) ;
if ( ! V_2080 )
break;
if ( F_49 ( V_51 , V_613 , V_1719 -> V_614 . V_612 ,
V_1719 -> V_614 . V_614 ) ) {
F_547 ( V_51 , V_2080 ) ;
goto V_620;
}
...
for ( V_162 = 0 ; V_162 < V_1719 -> V_441 ; V_162 ++ ) {
if ( F_26 ( V_51 , V_162 , V_1719 -> V_442 [ V_162 ] ) ) {
F_547 ( V_51 , V_363 ) ;
F_547 ( V_51 , V_2080 ) ;
goto V_620;
}
...
void * V_360 ;
int V_1721 = 200 ;
F_549 ( V_17 -> V_18 , V_17 , V_2076 ) ;
if ( V_2076 )
V_1721 += V_2076 -> V_2084 ;
V_51 = F_75 ( V_1721 , V_1552 ) ;
if ( ! V_51 )
return;
V_360 = F_23 ( V_51 , 0 , 0 , 0 , V_2085 ) ;
if ( ! V_360 )
goto V_683;
if ( F_26 ( V_51 , V_26 , V_7 -> V_14 ) ||
F_104 ( V_51 , V_12 , V_13 ( V_17 ) ,
...
if ( V_2076 -> V_2102 &&
F_26 ( V_51 , V_2097 , V_2076 -> V_2102 ) )
goto V_683;
if ( F_49 ( V_51 , V_2095 , V_2076 -> V_2084 ,
V_2076 -> V_2094 ) )
goto V_683;
}
if ( V_2076 -> V_2078 &&
...
void F_550 ( struct V_25 * V_559 , const T_2 * V_1611 ,
enum V_1618 V_2103 ,
T_3 V_1056 , T_10 V_1552 )
{
struct V_1 * V_17 = V_559 -> V_28 ;
struct V_6 * V_7 = F_11 ( V_17 -> V_18 ) ;
struct V_31 * V_51 ;
void * V_360 ;
F_551 ( V_17 -> V_18 , V_559 , V_1611 , V_2103 ,
V_1056 ) ;
V_51 = F_75 ( V_621 , V_1552 ) ;
if ( ! V_51 )
return;
V_360 = F_23 ( V_51 , 0 , 0 , 0 , V_2104 ) ;
if ( ! V_360 ) {
F_76 ( V_51 ) ;
return;
}
if ( F_26 ( V_51 , V_26 , V_7 -> V_14 ) ||
F_26 ( V_51 , V_10 , V_559 -> V_20 ) ||
F_54 ( V_51 , V_1620 , V_2103 ) ||
F_49 ( V_51 , V_567 , V_607 , V_1611 ) ||
( V_1056 > 0 &&
...
static int F_552 ( struct V_2105 * V_2106 ,
unsigned long V_359 ,
void * V_2107 )
{
struct V_2108 * V_2109 = V_2107 ;
struct V_6 * V_7 ;
struct V_1 * V_17 ;
struct V_1807 * V_1808 , * V_24 ;
if ( V_359 != V_2110 || V_2109 -> V_2111 != V_2112 )
return V_2113 ;
F_245 () ;
F_553 (rdev, &cfg80211_rdev_list, list) {
struct V_1323 * V_1361 ;
F_553 (sched_scan_req,
&rdev->sched_scan_req_list,
list) {
if ( V_1361 -> V_660 == V_2109 -> V_47 ) {
V_1361 -> V_2114 = true ;
F_554 ( & V_7 -> V_2115 ) ;
}
}
F_553 (wdev, &rdev->wiphy.wdev_list, list) {
F_555 ( V_17 , V_2109 -> V_47 ) ;
if ( V_17 -> V_660 == V_2109 -> V_47 ) {
V_17 -> V_2114 = true ;
F_554 ( & V_7 -> V_2116 ) ;
} else if ( V_17 -> V_1529 == V_2109 -> V_47 ) {
F_554 ( & V_17 -> V_2117 ) ;
}
}
F_302 ( & V_7 -> V_1811 ) ;
F_556 (reg, tmp, &rdev->beacon_registrations,
list) {
if ( V_1808 -> V_1812 == V_2109 -> V_47 ) {
F_557 ( & V_1808 -> V_666 ) ;
F_39 ( V_1808 ) ;
break;
}
...
void F_559 ( struct V_25 * V_19 ,
struct V_2119 * V_2120 )
{
struct V_18 * V_18 = V_19 -> V_28 -> V_18 ;
struct V_6 * V_7 = F_11 ( V_18 ) ;
struct V_31 * V_51 ;
void * V_360 ;
F_560 ( V_18 , V_19 , V_2120 ) ;
if ( ! V_2120 -> V_2121 )
return;
V_51 = F_75 ( 100 + V_2120 -> V_2122 , V_135 ) ;
if ( ! V_51 )
return;
V_360 = F_23 ( V_51 , 0 , 0 , 0 , V_2123 ) ;
if ( ! V_360 )
goto V_620;
if ( F_26 ( V_51 , V_26 , V_7 -> V_14 ) ||
F_26 ( V_51 , V_10 , V_19 -> V_20 ) ||
F_49 ( V_51 , V_567 , V_607 , V_2120 -> V_2121 ) )
goto V_620;
if ( V_2120 -> V_776 &&
F_49 ( V_51 , V_752 , V_2120 -> V_775 , V_2120 -> V_776 ) )
goto V_620;
if ( V_2120 -> V_2124 &&
F_49 ( V_51 , V_2125 , V_2120 -> V_2122 ,
V_2120 -> V_2124 ) )
goto V_620;
F_65 ( V_51 , V_360 ) ;
F_332 ( & V_38 , F_7 ( & V_7 -> V_18 ) , V_51 , 0 ,
...
void F_561 ( struct V_1 * V_17 , T_10 V_1552 )
{
struct V_6 * V_7 ;
struct V_31 * V_51 ;
void * V_360 ;
