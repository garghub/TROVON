...
unsigned int V_69 ;
F_22 ( L_7 ,
V_4 -> V_39 , V_59 -> V_41 . V_19 , V_59 -> V_39 ,
V_59 -> V_70 , V_59 -> clock ,
V_59 -> V_71 , V_59 -> V_72 , V_59 -> V_73 , V_59 -> V_74 ,
V_59 -> V_75 , V_59 -> V_76 , V_59 -> V_77 , V_59 -> V_78 ,
V_59 -> type , V_59 -> V_8 ) ;
F_47 ( V_59 , & V_4 -> V_5 ) ;
...
struct V_86 * V_60 )
{
if ( V_60 -> V_87 && V_60 -> V_88 ) {
T_3 V_89 = V_60 -> V_88 -> V_89 /
sizeof( struct V_90 ) ;
if ( V_89 < 2 )
return - V_17 ;
}
...
V_102 = F_54 ( V_60 -> V_60 , V_104 ) ;
if ( F_55 ( V_102 ) )
return F_56 ( V_102 ) ;
return F_57 ( V_104 , V_102 ,
V_96 , V_100 ) ;
}
return - V_17 ;
}
static int F_58 ( struct V_2 * V_3 ,
const struct V_86 * V_60 ,
struct V_95 * V_96 ,
T_4 * V_100 )
{
if ( F_52 ( V_3 , V_96 ) ) {
return F_59 ( & V_3 -> V_98 -> V_41 ,
V_96 , V_100 ) ;
}
return - V_17 ;
}
...
struct V_2 * F_64 ( struct V_22 * V_10 ,
...
T_3 V_115 = 256 ;
F_72 ( V_3 , 0 , false , V_115 ) ;
F_73 ( V_3 , V_115 ) ;
}
F_74 ( V_3 -> V_98 , & V_3 -> V_41 ) ;
V_40 [ V_7 ] = V_4 ;
return V_3 ;
}
