...
static T_1 F_50 ( struct V_21 * V_22 ,
struct V_58 * V_62 , char * V_60 )
{
struct V_1 * V_2 = F_13 ( V_22 ) ;
...
F_64 ( & V_2 -> V_24 ) ;
if ( V_11 -> V_22 . V_125 )
V_2 -> V_48 = (enum V_126 ) F_65 ( & V_11 -> V_22 ) ;
else
V_2 -> V_48 = V_120 -> V_127 ;
V_2 -> V_48 = V_120 -> V_127 ;
if ( V_2 -> V_48 == V_90 )
V_2 -> V_9 = 16000 ;
F_60 ( V_2 ) ;
...
if ( V_2 -> V_48 == V_49 ) {
V_2 -> V_122 [ V_122 ++ ] = & V_130 ;
V_2 -> V_122 [ V_122 ++ ] = & V_131 ;
}
V_121 = F_66 ( V_22 , V_11 -> V_132 ,
V_2 , V_2 -> V_122 ) ;
return F_67 ( V_121 ) ;
}
