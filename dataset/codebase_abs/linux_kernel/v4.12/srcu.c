...
F_15 (cpu) {
struct V_21 * V_30 = F_16 ( V_10 -> V_20 , V_28 ) ;
V_29 += F_17 ( V_30 -> V_31 [ V_27 ] ) ;
}
return V_29 ;
}
...
F_15 (cpu) {
struct V_21 * V_30 = F_16 ( V_10 -> V_20 , V_28 ) ;
V_29 += F_17 ( V_30 -> V_31 [ 0 ] ) ;
V_29 += F_17 ( V_30 -> V_31 [ 1 ] ) ;
V_29 -= F_17 ( V_30 -> V_32 [ 0 ] ) ;
V_29 -= F_17 ( V_30 -> V_32 [ 1 ] ) ;
}
return V_29 ;
}
...
static bool F_28 ( struct V_9 * V_10 , int V_27 , int V_34 )
{
for (; ; ) {
if ( F_19 ( V_10 , V_27 ) )
return true ;
...
if ( ! V_10 -> V_13 ) {
V_10 -> V_13 = true ;
F_35 ( V_38 , & V_10 -> V_18 , 0 ) ;
}
F_36 ( & V_10 -> V_12 , V_37 ) ;
}
static void F_37 ( struct V_9 * V_10 , int V_34 )
{
struct V_39 V_40 ;
struct V_5 * V_3 = & V_40 . V_3 ;
bool V_41 = false ;
F_38 ( F_39 ( & V_10 -> V_26 ) ||
F_39 ( & V_42 ) ||
F_39 ( & V_43 ) ||
...
unsigned long F_53 ( struct V_9 * V_10 )
{
return V_10 -> V_11 ;
}
...
static void F_44 ( struct V_9 * V_10 , int V_34 )
{
int V_27 = 1 ^ ( V_10 -> V_11 & 1 ) ;
if ( F_3 ( & V_10 -> V_15 ) &&
F_3 ( & V_10 -> V_16 ) )
return;
if ( ! F_28 ( V_10 , V_27 , V_34 ) )
return;
...
void V_19 ( struct V_53 * V_18 )
{
struct V_9 * V_10 ;
V_10 = F_58 ( V_18 , struct V_9 , V_18 . V_18 ) ;
F_54 ( V_10 ) ;
F_44 ( V_10 , 1 ) ;
F_55 ( V_10 ) ;
F_46 ( V_10 ) ;
