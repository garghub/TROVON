...
void F_184 ( struct V_25 * V_25 , struct V_152 * V_153 )
{
struct V_5 * V_5 ;
struct V_2 * V_2 ;
int V_154 = 0 ;
...
V_2 -> V_40 >= V_23 -> V_84 )
continue;
if ( ( V_2 -> V_15 == V_23 -> V_73 ) == V_154 )
continue;
if ( V_153 -> V_157 && V_153 -> V_157 ( V_23 , V_153 -> V_158 ) )
continue;
if ( ! V_153 -> V_159 ( V_25 , V_23 ,
V_2 -> V_40 , V_153 -> V_158 ) ) {
F_189 ( V_39 ) ;
return;
}
if ( V_153 -> V_160 && V_153 -> V_160 ( V_25 ) ) {
F_189 ( V_39 ) ;
return;
}
}
...
void F_190 ( struct V_25 * V_161 , struct V_25 * V_162 )
{
struct V_5 * V_5 ;
F_185 ( ! F_186 ( V_162 ) , V_162 ) ;
F_185 ( ! F_186 ( V_161 ) , V_161 ) ;
F_185 ( V_161 -> V_59 != V_162 -> V_59 , V_161 ) ;
V_5 = F_131 ( V_161 ) ;
if ( V_5 ) {
F_185 ( V_5 -> V_42 != F_91 ( V_162 ) , V_162 ) ;
V_5 -> V_42 = F_91 ( V_161 ) ;
F_191 () ;
F_64 ( V_162 , NULL ) ;
}
...
while ( V_129 & V_163 ) {
F_159 ( & V_132 ) ;
F_192 ( & V_129 , F_193 ( V_163 ) ,
V_164 ) ;
F_157 ( & V_132 ) ;
}
}
static void F_194 ( unsigned long V_165 ,
unsigned long V_166 )
{
struct V_5 * V_5 , * V_45 ;
struct V_78 * V_52 ;
...
static int F_197 ( struct V_167 * V_168 ,
unsigned long V_169 , void * V_158 )
{
struct V_170 * V_171 = V_158 ;
switch ( V_169 ) {
case V_172 :
F_157 ( & V_132 ) ;
V_129 |= V_163 ;
...
case V_173 :
F_194 ( V_171 -> V_165 ,
V_171 -> V_165 + V_171 -> V_174 ) ;
case V_175 :
F_157 ( & V_132 ) ;
V_129 &= ~ V_163 ;
F_159 ( & V_132 ) ;
F_198 () ;
F_199 ( & V_129 , F_193 ( V_163 ) ) ;
break;
}
return V_176 ;
}
...
static T_6 F_200 ( struct V_177 * V_178 ,
struct V_179 * V_180 , char * V_181 )
{
return sprintf ( V_181 , L_2 , V_134 ) ;
}
static T_6 F_201 ( struct V_177 * V_178 ,
struct V_179 * V_180 ,
const char * V_181 , T_7 V_182 )
{
unsigned long V_183 ;
int V_71 ;
V_71 = F_202 ( V_181 , 10 , & V_183 ) ;
if ( V_71 || V_183 > V_184 )
return - V_185 ;
V_134 = V_183 ;
return V_182 ;
}
static T_6 F_203 ( struct V_177 * V_178 ,
struct V_179 * V_180 , char * V_181 )
{
return sprintf ( V_181 , L_2 , V_133 ) ;
}
static T_6 F_204 ( struct V_177 * V_178 ,
struct V_179 * V_180 ,
const char * V_181 , T_7 V_182 )
{
int V_71 ;
unsigned long V_174 ;
V_71 = F_202 ( V_181 , 10 , & V_174 ) ;
if ( V_71 || V_174 > V_184 )
return - V_185 ;
V_133 = V_174 ;
return V_182 ;
}
static T_6 F_205 ( struct V_177 * V_178 , struct V_179 * V_180 ,
char * V_181 )
{
return sprintf ( V_181 , L_3 , V_129 ) ;
}
static T_6 F_206 ( struct V_177 * V_178 , struct V_179 * V_180 ,
const char * V_181 , T_7 V_182 )
{
int V_71 ;
unsigned long V_86 ;
V_71 = F_202 ( V_181 , 10 , & V_86 ) ;
if ( V_71 || V_86 > V_184 )
return - V_185 ;
if ( V_86 > V_147 )
return - V_185 ;
...
static T_6 F_209 ( struct V_177 * V_178 ,
struct V_179 * V_180 , char * V_181 )
{
return sprintf ( V_181 , L_2 , V_43 ) ;
}
static T_6 F_210 ( struct V_177 * V_178 ,
struct V_179 * V_180 ,
const char * V_181 , T_7 V_182 )
{
int V_71 ;
unsigned long V_187 ;
V_71 = F_202 ( V_181 , 10 , & V_187 ) ;
if ( V_71 )
return V_71 ;
if ( V_187 > 1 )
return - V_185 ;
...
struct V_112 * V_181 ;
V_181 = F_211 ( V_189 + V_189 , sizeof( * V_181 ) ,
V_11 ) ;
if ( ! V_181 )
V_71 = - V_10 ;
else {
...
F_159 ( & V_132 ) ;
return V_71 ? V_71 : V_182 ;
}
static T_6 F_212 ( struct V_177 * V_178 ,
struct V_179 * V_180 , char * V_181 )
{
return sprintf ( V_181 , L_2 , V_123 ) ;
}
static T_6 F_213 ( struct V_177 * V_178 ,
struct V_179 * V_180 ,
const char * V_181 , T_7 V_182 )
{
int V_71 ;
bool V_191 ;
V_71 = F_214 ( V_181 , & V_191 ) ;
if ( V_71 )
return - V_185 ;
V_123 = V_191 ;
return V_182 ;
}
static T_6 F_215 ( struct V_177 * V_178 ,
struct V_179 * V_180 , char * V_181 )
{
return sprintf ( V_181 , L_3 , V_47 ) ;
}
static T_6 F_216 ( struct V_177 * V_178 ,
struct V_179 * V_180 , char * V_181 )
{
return sprintf ( V_181 , L_3 , V_46 ) ;
}
static T_6 F_217 ( struct V_177 * V_178 ,
struct V_179 * V_180 , char * V_181 )
{
return sprintf ( V_181 , L_3 , V_67 ) ;
}
static T_6 F_218 ( struct V_177 * V_178 ,
struct V_179 * V_180 , char * V_181 )
{
long V_192 ;
V_192 = V_14 - V_47
...
if ( V_192 < 0 )
V_192 = 0 ;
return sprintf ( V_181 , L_4 , V_192 ) ;
}
static T_6 F_219 ( struct V_177 * V_178 ,
struct V_179 * V_180 , char * V_181 )
{
return sprintf ( V_181 , L_3 , V_64 . V_65 ) ;
}
