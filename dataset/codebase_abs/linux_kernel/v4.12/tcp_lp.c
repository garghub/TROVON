...
static void F_9 ( struct V_1 * V_2 , const struct V_32 * V_33 )
{
struct V_17 * V_18 = F_6 ( V_2 ) ;
struct V_3 * V_3 = F_2 ( V_2 ) ;
T_1 V_34 ;
if ( V_33 -> V_35 > 0 )
F_8 ( V_2 , V_33 -> V_35 ) ;
V_34 = V_36 - V_18 -> V_22 . V_24 ;
if ( ( V_37 ) V_34 > 0 )
V_3 -> V_13 = 3 * V_34 ;
if ( V_3 -> V_12 && ( V_36 - V_3 -> V_12 < V_3 -> V_13 ) )
V_3 -> V_4 |= V_16 ;
else
V_3 -> V_4 &= ~ V_16 ;
if ( V_3 -> V_5 >> 3 <
...
V_3 -> V_4 &= ~ V_38 ;
F_10 ( L_1 , V_3 -> V_4 ,
V_18 -> V_39 , V_3 -> V_9 , V_3 -> V_6 , V_3 -> V_7 ,
V_3 -> V_5 >> 3 ) ;
if ( V_3 -> V_4 & V_38 )
return;
V_3 -> V_6 = V_3 -> V_5 >> 3 ;
...
V_18 -> V_39 = F_11 ( V_18 -> V_39 >> 1U , 1U ) ;
V_3 -> V_12 = V_36 ;
}
static int T_3 F_12 ( void )
{
F_13 ( sizeof( struct V_3 ) > V_40 ) ;
return F_14 ( & V_41 ) ;
}
