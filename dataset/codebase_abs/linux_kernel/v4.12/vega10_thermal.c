...
T_1 V_80 = 0 ;
T_1 V_36 ;
if ( V_28 -> V_33 [ V_102 ] . V_35 ) {
if ( V_28 -> V_33 [ V_102 ] . V_54 )
F_25 ( L_6 ) ;
...
L_7 ,
return -1 ) ;
V_28 -> V_33 [ V_102 ] . V_54 = true ;
}
V_80 |= ( 1 << V_103 ) ;
V_80 |= ( 1 << V_104 ) ;
V_80 |= ( 1 << V_105 ) ;
V_36 = F_7 ( V_37 , 0 , V_106 , V_107 ) ;
F_11 ( V_2 -> V_40 , V_36 , V_80 ) ;
return 0 ;
}
...
void * V_108 , void * V_109 , void * V_110 , int V_32 )
{
int V_111 ;
struct V_27 * V_28 = (struct V_27 * ) ( V_2 -> V_29 ) ;
T_3 * V_112 = & ( V_28 -> V_113 . V_114 ) ;
if ( ! V_28 -> V_33 [ V_34 ] . V_35 )
return 0 ;
V_112 -> V_115 = ( V_116 ) V_2 -> V_6 .
V_25 . V_26 ;
V_112 -> V_117 = V_2 -> V_6 .
V_25 . V_118 ;
V_112 -> V_119 = ( V_116 ) ( V_2 -> V_6 .
V_25 . V_120 ) ;
V_112 -> V_121 = V_2 -> V_6 .
V_25 . V_122 ;
F_29 ( V_2 -> V_123 ,
...
V_112 -> V_147 = V_2 -> V_6 .
V_25 . V_148 ;
V_111 = F_30 ( V_2 -> V_123 ,
( V_149 * ) ( & ( V_28 -> V_113 . V_114 ) ) , V_150 ) ;
if ( V_111 )
F_31 ( L_10 ) ;
return V_111 ;
}
...
void * V_108 , void * V_109 , void * V_110 , int V_32 )
{
struct V_74 * V_75 = (struct V_74 * ) V_108 ;
if ( V_75 == NULL )
return - V_43 ;
