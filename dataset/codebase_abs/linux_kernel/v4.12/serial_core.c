...
switch ( V_9 -> V_112 ) {
case V_270 :
snprintf ( V_296 , sizeof( V_296 ) , L_33 , V_9 -> V_101 ) ;
break;
case V_297 :
...
break;
default:
F_162 ( V_296 , L_36 , sizeof( V_296 ) ) ;
break;
}
F_163 ( L_37 ,
V_9 -> V_146 ? F_164 ( V_9 -> V_146 ) : L_24 ,
V_9 -> V_146 ? L_38 : L_24 ,
V_9 -> V_295 ,
V_296 , V_9 -> V_104 , V_9 -> V_69 / 16 , F_126 ( V_9 ) ) ;
}
static void
F_165 ( struct V_227 * V_228 , struct V_5 * V_6 ,
struct V_1 * V_9 )
{
unsigned int V_14 ;
...
static int F_167 ( struct V_252 * V_229 , int line , char * V_265 )
{
...
F_69 ( & V_302 -> V_10 ) ;
V_9 = F_7 ( V_6 ) ;
if ( ! V_9 || ! ( V_9 -> V_15 -> V_303 && V_9 -> V_15 -> V_304 ) ) {
V_81 = - 1 ;
goto V_100;
}
if ( V_9 -> V_15 -> V_305 ) {
...
static int F_168 ( struct V_252 * V_229 , int line )
{
struct V_227 * V_228 = V_229 -> V_230 ;
struct V_5 * V_6 = V_228 -> V_6 + line ;
struct V_1 * V_9 ;
...
V_9 = F_2 ( V_6 ) ;
if ( V_9 ) {
V_81 = V_9 -> V_15 -> V_303 ( V_9 ) ;
F_4 ( V_9 ) ;
}
return V_81 ;
}
static void F_169 ( struct V_252 * V_229 , int line , char V_89 )
{
struct V_227 * V_228 = V_229 -> V_230 ;
struct V_5 * V_6 = V_228 -> V_6 + line ;
struct V_1 * V_9 ;
...
return;
if ( V_89 == '\n' )
V_9 -> V_15 -> V_304 ( V_9 , '\r' ) ;
V_9 -> V_15 -> V_304 ( V_9 , V_89 ) ;
F_4 ( V_9 ) ;
}
int F_170 ( struct V_227 * V_228 )
{
struct V_252 * V_306 ;
int V_245 , V_26 ;
F_10 ( V_228 -> V_6 ) ;
V_228 -> V_6 = F_171 ( sizeof( struct V_5 ) * V_228 -> V_255 , V_31 ) ;
if ( ! V_228 -> V_6 )
goto V_100;
V_306 = F_172 ( V_228 -> V_255 ) ;
if ( ! V_306 )
goto V_307;
V_228 -> V_252 = V_306 ;
V_306 -> V_308 = V_228 -> V_308 ;
V_306 -> V_295 = V_228 -> F_164 ;
V_306 -> V_286 = V_228 -> V_286 ;
V_306 -> V_287 = V_228 -> V_309 ;
V_306 -> type = V_310 ;
V_306 -> V_311 = V_312 ;
V_306 -> V_313 = V_314 ;
V_306 -> V_313 . V_37 = V_315 | V_277 | V_275 | V_276 | V_75 ;
V_306 -> V_313 . V_223 = V_306 -> V_313 . V_222 = 9600 ;
V_306 -> V_14 = V_316 | V_317 ;
V_306 -> V_230 = V_228 ;
F_173 ( V_306 , & V_293 ) ;
for ( V_245 = 0 ; V_245 < V_228 -> V_255 ; V_245 ++ ) {
struct V_5 * V_6 = V_228 -> V_6 + V_245 ;
...
struct V_252 * F_181 ( struct V_259 * V_260 , int * V_87 )
{
struct V_227 * V_263 = V_260 -> V_281 ;
* V_87 = V_260 -> V_87 ;
return V_263 -> V_252 ;
}
static T_8 F_182 ( struct V_280 * V_146 ,
struct V_319 * V_320 , char * V_30 )
{
struct V_97 V_117 ;
struct V_41 * V_9 = F_183 ( V_146 ) ;
F_67 ( V_9 , & V_117 ) ;
return snprintf ( V_30 , V_321 , L_39 , V_117 . V_106 * 16 ) ;
}
...
struct V_41 * V_9 = F_183 ( V_146 ) ;
F_67 ( V_9 , & V_117 ) ;
return snprintf ( V_30 , V_321 , L_39 , V_117 . type ) ;
}
...
struct V_41 * V_9 = F_183 ( V_146 ) ;
F_67 ( V_9 , & V_117 ) ;
return snprintf ( V_30 , V_321 , L_39 , V_117 . line ) ;
}
...
V_322 = V_117 . V_9 ;
if ( V_102 )
V_322 |= ( unsigned long ) V_117 . V_103 << V_102 ;
return snprintf ( V_30 , V_321 , L_40 , V_322 ) ;
}
...
struct V_41 * V_9 = F_183 ( V_146 ) ;
F_67 ( V_9 , & V_117 ) ;
return snprintf ( V_30 , V_321 , L_39 , V_117 . V_104 ) ;
}
...
struct V_41 * V_9 = F_183 ( V_146 ) ;
F_67 ( V_9 , & V_117 ) ;
return snprintf ( V_30 , V_321 , L_41 , V_117 . V_14 ) ;
}
...
struct V_41 * V_9 = F_183 ( V_146 ) ;
F_67 ( V_9 , & V_117 ) ;
return snprintf ( V_30 , V_321 , L_39 , V_117 . V_105 ) ;
}
...
struct V_41 * V_9 = F_183 ( V_146 ) ;
F_67 ( V_9 , & V_117 ) ;
return snprintf ( V_30 , V_321 , L_39 , V_117 . V_107 ) ;
}
...
struct V_41 * V_9 = F_183 ( V_146 ) ;
F_67 ( V_9 , & V_117 ) ;
return snprintf ( V_30 , V_321 , L_39 , V_117 . V_108 ) ;
}
...
struct V_41 * V_9 = F_183 ( V_146 ) ;
F_67 ( V_9 , & V_117 ) ;
return snprintf ( V_30 , V_321 , L_39 , V_117 . V_68 ) ;
}
...
struct V_41 * V_9 = F_183 ( V_146 ) ;
F_67 ( V_9 , & V_117 ) ;
return snprintf ( V_30 , V_321 , L_39 , V_117 . V_111 ) ;
}
...
struct V_41 * V_9 = F_183 ( V_146 ) ;
F_67 ( V_9 , & V_117 ) ;
return snprintf ( V_30 , V_321 , L_40 , ( unsigned long ) V_117 . V_115 ) ;
}
static T_8 F_195 ( struct V_280 * V_146 ,
struct V_319 * V_320 , char * V_30 )
{
struct V_97 V_117 ;
struct V_41 * V_9 = F_183 ( V_146 ) ;
F_67 ( V_9 , & V_117 ) ;
return snprintf ( V_30 , V_321 , L_39 , V_117 . V_113 ) ;
}
int F_196 ( struct V_227 * V_228 , struct V_1 * V_2 )
{
struct V_5 * V_6 ;
struct V_41 * V_9 ;
int V_81 = 0 ;
...
V_6 -> V_247 = V_325 ;
V_2 -> V_34 = V_228 -> V_34 ;
V_2 -> V_309 = V_228 -> V_252 -> V_287 + V_2 -> line ;
V_2 -> V_295 = F_200 ( V_31 , L_42 , V_228 -> F_164 ,
V_228 -> V_252 -> V_326 + V_2 -> line ) ;
if ( ! V_2 -> V_295 ) {
V_81 = - V_32 ;
goto V_100;
}
...
F_201 ( V_2 -> V_146 -> V_327 , V_2 -> V_34 -> V_295 , V_2 -> line ) ;
F_165 ( V_228 , V_6 , V_2 ) ;
V_9 -> V_259 = F_25 ( V_2 ) ;
V_323 = 2 ;
if ( V_2 -> V_328 )
V_323 ++ ;
V_2 -> V_329 = F_202 ( V_323 , sizeof( * V_2 -> V_329 ) ,
V_31 ) ;
if ( ! V_2 -> V_329 ) {
V_81 = - V_32 ;
goto V_100;
...
V_288 = F_203 ( V_9 , V_228 -> V_252 ,
V_2 -> line , V_2 -> V_146 , V_9 , V_2 -> V_329 ) ;
if ( F_204 ( ! F_205 ( V_288 ) ) ) {
F_206 ( V_288 , 1 ) ;
} else {
F_155 ( V_2 -> V_146 , L_43 ,
V_2 -> line ) ;
}
V_2 -> V_14 &= ~ V_240 ;
V_100:
...
int F_207 ( struct V_227 * V_228 , struct V_1 * V_2 )
{
struct V_5 * V_6 = V_228 -> V_6 + V_2 -> line ;
struct V_41 * V_9 = & V_6 -> V_9 ;
struct V_1 * V_1 ;
...
V_2 -> V_14 |= V_240 ;
F_71 ( & V_9 -> V_10 ) ;
F_209 ( V_9 , V_228 -> V_252 , V_2 -> line ) ;
V_12 = F_210 ( V_9 ) ;
if ( V_12 ) {
F_211 ( V_9 -> V_12 ) ;
F_212 ( V_12 ) ;
...
V_2 -> type = V_27 ;
F_69 ( & V_9 -> V_10 ) ;
F_44 ( F_214 ( & V_6 -> V_7 ) < 0 ) ;
F_215 ( V_6 -> V_8 , ! F_216 ( & V_6 -> V_7 ) ) ;
V_6 -> V_1 = NULL ;
F_71 ( & V_9 -> V_10 ) ;
V_100:
F_71 ( & V_324 ) ;
...
int F_217 ( struct V_1 * V_331 , struct V_1 * V_332 )
{
if ( V_331 -> V_112 != V_332 -> V_112 )
return 0 ;
switch ( V_331 -> V_112 ) {
case V_270 :
return ( V_331 -> V_101 == V_332 -> V_101 ) ;
case V_297 :
return ( V_331 -> V_101 == V_332 -> V_101 ) &&
( V_331 -> V_110 == V_332 -> V_110 ) ;
case V_250 :
case V_266 :
case V_267 :
case V_268 :
case V_298 :
case V_299 :
return ( V_331 -> V_116 == V_332 -> V_116 ) ;
}
return 0 ;
}
void F_218 ( struct V_1 * V_2 , unsigned int V_3 )
{
...
void F_223 ( struct V_1 * V_2 , unsigned int V_3 )
{
F_219 ( & V_2 -> V_21 ) ;
V_2 -> V_168 . V_177 ++ ;
if ( F_48 ( V_2 ) ) {
...
void F_224 ( struct V_1 * V_9 , unsigned int V_3 ,
unsigned int V_183 , unsigned int V_89 , unsigned int V_336 )
{
struct V_41 * V_302 = & V_9 -> V_6 -> V_9 ;
if ( ( V_3 & V_9 -> V_337 & ~ V_183 ) == 0 )
if ( F_225 ( V_302 , V_89 , V_336 ) == 0 )
++ V_9 -> V_168 . V_186 ;
if ( V_3 & ~ V_9 -> V_337 & V_183 )
if ( F_225 ( V_302 , 0 , V_338 ) == 0 )
++ V_9 -> V_168 . V_186 ;
}
