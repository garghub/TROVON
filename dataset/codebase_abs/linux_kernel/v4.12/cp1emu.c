...
V_264 = F_39 ( V_220 , V_229 , V_293 , V_165 ) ;
if ( V_264 < 0 )
break;
if ( V_264 )
V_220 -> V_173 = V_293 ;
...
switch ( F_40 ( V_229 ) ) {
case V_61 :
V_305 = ( void T_2 * ) ( V_220 -> V_162 [ F_54 ( V_229 ) ] +
...
F_34 ( V_306 , F_56 ( V_229 ) ) ;
break;
case V_63 :
V_305 = ( void T_2 * ) ( V_220 -> V_162 [ F_54 ( V_229 ) ] +
V_220 -> V_162 [ F_55 ( V_229 ) ] ) ;
F_25 ( V_276 ) ;
F_35 ( V_306 , F_57 ( V_229 ) ) ;
...
V_228 -> V_166 = ( V_228 -> V_166 & ~ V_240 ) | V_301 ;
if ( ( V_228 -> V_166 >> 5 ) & V_228 -> V_166 & V_237 ) {
return V_284 ;
}
break;
...
F_31 ( V_306 , F_56 ( V_229 ) ) ;
break;
case V_59 :
V_305 = ( void T_2 * ) ( V_220 -> V_162 [ F_54 ( V_229 ) ] +
V_220 -> V_162 [ F_55 ( V_229 ) ] ) ;
F_25 ( V_276 ) ;
F_32 ( V_306 , F_57 ( V_229 ) ) ;
...
if ( ! V_286 )
return V_28 ;
V_159 = V_287 [ F_55 ( V_229 ) >> 2 ] ;
if ( ( ( V_228 -> V_166 & V_159 ) != 0 ) !=
( ( F_55 ( V_229 ) & 1 ) != 0 ) )
return 0 ;
F_59 ( V_340 . V_300 , F_57 ( V_229 ) ) ;
break;
case V_90 :
if ( ! V_286 )
return V_28 ;
...
goto V_312;
default:
if ( ! V_177 && F_40 ( V_229 ) >= V_372 ) {
unsigned V_373 = F_40 ( V_229 ) - V_372 ;
union V_299 V_52 , V_51 ;
F_59 ( V_52 , F_57 ( V_229 ) ) ;
F_59 ( V_51 , F_55 ( V_229 ) ) ;
...
break;
case V_329 :
F_63 ( V_340 . V_298 , F_56 ( V_229 ) ) ;
break;
case V_303 :
F_60 ( V_340 . V_300 , F_56 ( V_229 ) ) ;
break;
case V_356 :
F_34 ( V_340 . V_338 , F_56 ( V_229 ) ) ;
break;
case V_371 :
if ( ! V_370 )
return V_28 ;
F_31 ( V_340 . V_339 , F_56 ( V_229 ) ) ;
break;
default:
return V_28 ;
}
...
V_385 = V_220 -> V_173 ;
if ( F_96 ( V_385 ) && V_265 ) {
if ( ( F_97 ( V_386 [ 0 ] , ( T_5 T_2 * ) F_98 ( V_220 -> V_173 ) ) ) ||
( F_97 ( V_386 [ 1 ] , ( T_5 T_2 * ) F_98 ( V_220 -> V_173 + 2 ) ) ) ||
( F_97 ( V_386 [ 2 ] , ( T_5 T_2 * ) F_98 ( V_220 -> V_173 + 4 ) ) ) ||
( F_97 ( V_386 [ 3 ] , ( T_5 T_2 * ) F_98 ( V_220 -> V_173 + 6 ) ) ) ) {
F_25 ( V_273 ) ;
return V_274 ;
}
V_387 = V_386 ;
...
break;
F_100 () ;
} while ( V_220 -> V_173 > V_385 );
if ( V_264 == V_28 && V_220 -> V_173 != V_384 )
V_264 = 0 ;
return V_264 ;
}
