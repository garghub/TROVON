...
memset ( & V_11 -> V_19 [ V_12 ] . V_29 , 0 ,
sizeof( V_11 -> V_19 [ V_12 ] . V_29 ) ) ;
return F_31 ( V_11 -> V_30 ,
& V_11 -> V_19 [ V_12 ] . V_29 ,
V_12 ) ;
}
static void F_32 ( struct V_13 * V_14 , T_1 V_12 ,
struct V_10 * V_11 )
{
F_33 ( & V_11 -> V_19 [ V_12 ] . V_29 ) ;
F_34 ( V_14 ) ;
}
...
memset ( & V_11 -> V_19 [ V_12 ] . V_29 , 0 ,
sizeof( V_11 -> V_19 [ V_12 ] . V_29 ) ) ;
V_26 = F_31 ( V_11 -> V_30 , & V_11 -> V_19 [ V_12 ] . V_29 ,
V_12 ) ;
return V_26 ;
}
static void F_36 ( struct V_13 * V_14 , T_1 V_12 ,
struct V_10 * V_11 )
{
F_33 ( & V_11 -> V_19 [ V_12 ] . V_29 ) ;
F_34 ( V_14 ) ;
...
static int F_37 ( struct V_13 * V_14 , T_1 V_12 ,
struct V_10 * V_11 )
{
...
if ( ! V_16 )
V_16 = L_8 ;
V_26 = F_39 ( V_11 , V_11 -> V_28 , V_12 , V_16 ) ;
if ( V_26 ) {
F_30 ( V_11 -> V_28 , L_9 ,
V_12 , V_26 ) ;
V_11 -> V_19 [ V_12 ] . V_32 = NULL ;
return V_26 ;
}
memset ( & V_11 -> V_19 [ V_12 ] . V_29 , 0 ,
sizeof( V_11 -> V_19 [ V_12 ] . V_29 ) ) ;
...
if ( V_26 )
return V_26 ;
F_40 ( & V_11 -> V_19 [ V_12 ] . V_29 ,
V_11 -> V_19 [ V_12 ] . V_32 ) ;
return 0 ;
}
static void F_41 ( struct V_13 * V_14 , T_1 V_12 ,
struct V_10 * V_11 )
{
F_33 ( & V_11 -> V_19 [ V_12 ] . V_29 ) ;
if ( V_11 -> V_19 [ V_12 ] . V_32 ) {
F_42 ( V_11 -> V_19 [ V_12 ] . V_32 ) ;
V_11 -> V_19 [ V_12 ] . V_32 = NULL ;
V_11 -> V_33 &= ~ ( 1 << V_12 ) ;
}
}
...
return V_26 ;
if ( V_11 -> V_37 -> V_39 ) {
V_26 = V_11 -> V_37 -> V_39 ( V_11 , V_3 -> V_40 -> V_41 ) ;
if ( V_26 < 0 )
return V_26 ;
}
...
struct V_17 * V_51 ;
if ( V_14 -> V_15 ) {
V_51 = F_19 ( V_14 -> V_15 , L_4 , 0 ) ;
if ( ! V_51 )
return - V_52 ;
V_50 = F_62 ( V_51 ) ;
} else {
V_50 = F_63 ( V_11 -> V_53 -> V_32 [ V_12 ] ) ;
F_64 ( V_50 ) ;
}
if ( ! V_50 )
return - V_54 ;
...
V_48 = V_11 -> V_37 -> V_56 ( V_11 ) ;
V_3 -> V_57 = F_65 ( V_48 ) ;
if ( F_66 ( V_3 -> V_57 ) ) {
F_30 ( V_11 -> V_28 , L_11 ) ;
return F_67 ( V_3 -> V_57 ) ;
}
V_3 -> V_58 = V_3 -> V_57 -> V_58 ;
return 0 ;
}
...
T_1 V_59 ;
F_72 (ports, port) {
V_26 = F_73 ( V_14 , L_15 , & V_59 ) ;
if ( V_26 )
return V_26 ;
if ( V_59 >= V_11 -> V_18 )
return - V_52 ;
V_11 -> V_19 [ V_59 ] . V_15 = V_14 ;
if ( ! F_20 ( & V_11 -> V_19 [ V_59 ] ) )
V_11 -> V_33 |= 1 << V_59 ;
}
return 0 ;
}
static int F_74 ( struct V_60 * V_53 , struct V_10 * V_11 )
{
bool V_61 = false ;
unsigned int V_62 ;
...
if ( ! V_53 -> V_64 [ V_62 ] )
continue;
V_11 -> V_19 [ V_62 ] . V_16 = V_53 -> V_64 [ V_62 ] ;
if ( ! F_20 ( & V_11 -> V_19 [ V_62 ] ) )
V_11 -> V_33 |= 1 << V_62 ;
V_61 = true ;
}
if ( ! V_61 && V_62 == V_63 )
...
static int F_75 ( struct V_17 * V_65 , T_1 * V_2 , T_1 * V_12 )
{
int V_26 ;
* V_2 = * V_12 = 0 ;
V_26 = F_76 ( V_65 , L_16 , 0 , V_2 ) ;
if ( V_26 ) {
if ( V_26 == - V_52 )
return 0 ;
return V_26 ;
}
V_26 = F_76 ( V_65 , L_16 , 1 , V_12 ) ;
if ( V_26 )
return V_26 ;
if ( * V_12 >= V_20 )
return - V_52 ;
...
static int F_77 ( struct V_60 * V_66 , T_1 * V_2 , T_1 * V_12 )
{
if ( ! V_66 )
return - V_67 ;
* V_2 = 0 ;
...
static int F_82 ( struct V_10 * V_11 , struct V_68 * V_28 )
{
struct V_60 * V_69 = V_28 -> V_70 ;
struct V_17 * V_65 = V_28 -> V_71 ;
struct V_1 * V_3 ;
struct V_17 * V_19 ;
T_1 V_2 , V_12 ;
int V_62 , V_26 ;
if ( V_65 ) {
V_26 = F_75 ( V_65 , & V_2 , & V_12 ) ;
if ( V_26 )
return V_26 ;
V_19 = F_78 ( V_11 , V_65 ) ;
if ( F_66 ( V_19 ) )
...
struct V_10 * F_83 ( struct V_68 * V_28 , T_2 V_76 )
{
T_2 V_77 = sizeof( struct V_10 ) + V_76 * sizeof( struct V_13 ) ;
struct V_10 * V_11 ;
int V_62 ;
V_11 = F_84 ( V_28 , V_77 , V_8 ) ;
if ( ! V_11 )
return NULL ;
V_11 -> V_28 = V_28 ;
V_11 -> V_18 = V_76 ;
for ( V_62 = 0 ; V_62 < V_11 -> V_18 ; ++ V_62 ) {
V_11 -> V_19 [ V_62 ] . V_12 = V_62 ;
V_11 -> V_19 [ V_62 ] . V_11 = V_11 ;
}
return V_11 ;
}
int F_85 ( struct V_10 * V_11 , struct V_68 * V_28 )
{
int V_26 ;
F_86 ( & V_78 ) ;
V_26 = F_82 ( V_11 , V_28 ) ;
