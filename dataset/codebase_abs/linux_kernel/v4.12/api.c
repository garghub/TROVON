...
int F_64 ( struct V_9 * V_10 , bool V_83 )
{
if ( V_10 -> V_48 == V_49 ) {
return - V_50 ;
}
...
int F_65 ( struct V_23 * V_23 , struct V_15 * V_15 )
{
return F_66 ( V_23 , V_15 ) ;
}
int F_67 ( struct V_23 * V_23 , struct V_15 * V_15 )
{
return F_68 ( V_23 , V_15 ) ;
}
long F_69 ( struct V_15 * V_15 , unsigned int V_89 , unsigned long V_90 )
{
return F_70 ( V_15 , V_89 , V_90 ) ;
}
int F_71 ( struct V_15 * V_15 , struct V_91 * V_92 )
{
return F_72 ( V_15 , V_92 ) ;
}
unsigned int F_73 ( struct V_15 * V_15 , struct V_93 * V_94 )
{
return F_74 ( V_15 , V_94 ) ;
}
T_5 F_75 ( struct V_15 * V_15 , char T_6 * V_95 , T_7 V_96 ,
T_8 * V_97 )
{
return F_76 ( V_15 , V_95 , V_96 , V_97 ) ;
}
struct V_15 * F_77 ( struct V_9 * V_10 , struct V_17 * V_18 ,
int * V_98 )
{
struct V_15 * V_15 ;
int V_24 , V_4 , V_99 ;
...
V_16 = F_80 ( V_110 , L_6 , V_10 -> V_78 ) ;
V_15 = F_5 ( V_16 , V_18 , V_10 , V_4 ) ;
F_25 ( V_16 ) ;
if ( F_11 ( V_15 ) )
goto V_111;
F_81 ( V_10 , V_15 -> V_112 ) ;
* V_98 = V_99 ;
return V_15 ;
V_111:
F_82 ( V_99 ) ;
...
struct V_9 * F_83 ( struct V_15 * V_15 )
{
return V_15 -> V_40 ;
}
...
V_24 = F_91 ( V_10 , V_122 -> V_124 ) ;
if ( V_24 )
return V_24 ;
V_24 = F_46 ( V_10 , V_122 -> V_126 , V_85 ) ;
if ( V_24 < 0 ) {
F_92 ( V_10 , V_10 ) ;
return V_24 ;
}
...
void T_9 * F_93 ( struct V_9 * V_10 )
{
if ( V_10 -> V_48 != V_49 )
return NULL ;
F_47 ( L_7 ,
V_77 , V_10 -> V_127 , V_10 -> V_128 ) ;
return F_94 ( V_10 -> V_127 , V_10 -> V_128 ) ;
}
void F_95 ( void T_9 * V_129 )
{
F_96 ( V_129 ) ;
}
...
int V_24 ;
V_24 = V_66 -> V_130 ( V_44 ) ;
if ( V_24 )
return V_24 ;
return V_66 -> V_131 ( V_44 ) ;
}
void F_98 ( struct V_43 * V_44 ,
bool V_132 )
{
V_44 -> V_65 -> V_133 = V_132 ;
}
T_5 F_99 ( struct V_41 * V_42 , void * V_95 , T_7 V_96 )
{
struct V_43 * V_44 = F_22 ( V_42 ) ;
if ( F_11 ( V_44 ) )
return - V_134 ;
return V_66 -> V_135 ( V_44 -> V_65 , V_95 , V_96 ) ;
}
int F_100 ( struct V_41 * V_42 , int V_55 )
{
struct V_43 * V_44 = F_22 ( V_42 ) ;
if ( F_11 ( V_44 ) )
return - V_134 ;
if ( V_55 > V_44 -> V_65 -> V_136 )
return - V_60 ;
V_44 -> V_65 -> V_136 = V_55 ;
V_44 -> V_125 = V_55 ;
return 0 ;
}
...
int F_101 ( struct V_41 * V_57 , int V_137 , int type )
{
struct V_9 * V_10 , * V_138 , * V_139 ;
int V_140 ;
int V_24 ;
V_10 = V_139 = F_26 ( V_57 ) ;
if ( F_85 ( ! V_139 ) )
return - V_134 ;
V_140 = V_137 ;
while ( V_140 > 0 ) {
V_24 = F_35 ( V_10 , F_102 ( V_140 , V_10 -> V_44 -> V_125 ) ) ;
if ( V_24 ) {
F_103 ( L_8 , F_104 ( V_57 ) ) ;
return V_24 ;
}
V_140 -= V_10 -> V_44 -> V_125 ;
if ( V_10 != V_139 && V_139 -> V_48 == V_49 ) {
F_85 ( F_46 ( V_10 ,
F_105 ( V_139 -> V_141 -> V_142 . V_73 ) ,
NULL ) ) ;
}
if ( V_140 > 0 ) {
V_138 = F_21 ( V_57 ) ;
if ( F_11 ( V_138 ) ) {
F_103 ( L_9 , F_104 ( V_57 ) ) ;
return - V_143 ;
}
F_106 ( & V_138 -> V_59 , & V_10 -> V_59 ) ;
V_10 = V_138 ;
}
}
return 0 ;
}
void F_107 ( struct V_41 * V_57 )
{
struct V_9 * V_10 , * V_144 , * V_145 ;
V_10 = F_26 ( V_57 ) ;
if ( F_85 ( ! V_10 ) )
return;
F_40 ( V_10 ) ;
F_108 (pos, tmp, &ctx->extra_irq_contexts, extra_irq_contexts) {
F_61 ( V_144 ) ;
F_40 ( V_144 ) ;
F_109 ( & V_144 -> V_59 ) ;
F_27 ( V_144 ) ;
