...
if ( V_281 == 0 )
return 0 ;
F_70 ( & V_33 -> V_268 , V_281 ) ;
F_79 ( V_11 -> V_104 , F_60 ) ;
V_275 = & V_33 -> V_327 ;
...
if ( V_62 )
goto V_324;
if ( V_275 -> V_25 . V_329 . V_336 . V_45 != V_337 ) {
V_62 = - V_249 ;
goto V_324;
}
F_37 ( & V_33 -> V_269 ) ;
V_33 -> V_237 = 1 +
V_275 -> V_25 . V_329 . V_336 . V_333 ;
F_45 ( V_1 , V_338 ,
V_33 -> V_237 ) ;
V_324:
if ( V_62 ) {
...
int F_82 ( struct V_116 * V_133 )
{
if ( ! V_133 )
return - V_127 ;
if ( F_8 ( & V_133 -> V_339 ) != 1 )
return 0 ;
