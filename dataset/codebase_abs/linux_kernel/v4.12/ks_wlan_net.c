...
#define F_55 0xdd
#define F_56 0x30
if ( V_224 -> V_274 . V_275 == F_56 && V_224 -> V_274 . V_83 != 0 ) {
V_253 = & V_250 [ 0 ] ;
...
if ( V_224 -> V_276 . V_275 == F_55 && V_224 -> V_276 . V_83 != 0 ) {
V_253 = & V_252 [ 0 ] ;
memset ( & V_245 , 0 , sizeof( V_245 ) ) ;
V_245 . V_254 = V_208 ;
...
F_66 ( & V_339 -> V_347 , & V_2 -> V_342 . V_343 ) ;
V_2 -> V_342 . V_83 ++ ;
break;
}
F_67 (ptr, &priv->pmklist.head) {
V_339 = F_68 ( V_19 , struct V_338 , V_347 ) ;
if ( memcmp ( V_337 -> V_91 . V_92 , V_339 -> V_91 , V_93 ) == 0 ) {
memcpy ( V_339 -> V_345 , V_337 -> V_345 , V_346 ) ;
F_69 ( & V_339 -> V_347 , & V_2 -> V_342 . V_343 ) ;
break;
}
}
...
V_339 = F_68 ( V_2 -> V_342 . V_343 . V_348 , struct V_338 ,
V_347 ) ;
memcpy ( V_339 -> V_91 , V_337 -> V_91 . V_92 , V_93 ) ;
memcpy ( V_339 -> V_345 , V_337 -> V_345 , V_346 ) ;
F_69 ( & V_339 -> V_347 , & V_2 -> V_342 . V_343 ) ;
...
F_71 ( & V_2 -> V_342 . V_343 ) ;
for ( V_100 = 0 ; V_100 < V_344 ; V_100 ++ )
F_71 ( & V_2 -> V_342 . V_339 [ V_100 ] . V_347 ) ;
break;
default:
return - V_70 ;
}
...
static struct V_3 * F_72 ( struct V_49 * V_50 )
{
struct V_1 * V_2 = F_13 ( V_50 ) ;
struct V_3 * V_4 = & V_2 -> V_4 ;
if ( ! F_4 ( & V_8 ) ) {
...
case V_364 :
V_262 = 1 ;
return F_73 ( V_50 , NULL , & V_262 , NULL ) ;
default:
return - V_68 ;
}
}
...
static int F_88 ( struct V_49 * V_50 ,
struct V_51 * V_52 ,
T_2 * V_129 , char * V_54 )
{
struct V_1 * V_2 = F_13 ( V_50 ) ;
...
static void F_100 ( struct V_49 * V_50 , int V_397 )
{
switch ( V_397 ) {
case V_398 :
F_89 ( V_50 , L_34 ) ;
...
static int F_101 ( struct V_49 * V_50 , struct V_51 * V_52 ,
T_2 * V_129 , char * V_54 )
{
int V_100 , V_397 ;
struct V_1 * V_2 = F_13 ( V_50 ) ;
...
static int F_102 ( struct V_49 * V_50 , struct V_438 * V_439 ,
int V_254 )
{
int V_440 ;
...
switch ( V_254 ) {
case V_443 + 20 :
V_440 = F_73 ( V_50 , NULL , & V_442 -> V_255 . V_262 , NULL ) ;
break;
default:
V_440 = - V_68 ;
}
...
static
struct V_444 * F_103 ( struct V_49 * V_50 )
{
struct V_1 * V_2 = F_13 ( V_50 ) ;
if ( V_2 -> V_5 < V_6 )
return NULL ;
...
static
int F_104 ( struct V_49 * V_50 , void * V_324 )
{
struct V_1 * V_2 = F_13 ( V_50 ) ;
...
V_2 -> V_450 = 0 ;
F_5 ( V_2 , V_451 ) ;
F_89 ( V_50 , L_70 , V_2 -> V_449 ) ;
return 0 ;
}
static
void F_106 ( struct V_49 * V_50 )
{
struct V_1 * V_2 = F_13 ( V_50 ) ;
...
static
int F_110 ( struct V_455 * V_456 , struct V_49 * V_50 )
{
struct V_1 * V_2 = F_13 ( V_50 ) ;
int V_440 ;
F_2 ( 3 , L_72 , F_3 () ) ;
...
if ( F_105 ( V_50 ) )
F_108 ( V_50 ) ;
V_440 = F_112 ( V_2 , V_456 ) ;
F_113 ( V_50 ) ;
if ( V_440 )
F_2 ( 4 , L_74 , V_440 ) ;
return 0 ;
}
void F_114 ( struct V_1 * V_2 , struct V_455 * V_456 )
{
F_2 ( 3 , L_3 ) ;
V_2 -> V_445 . V_457 ++ ;
if ( F_107 ( V_2 -> V_458 ) )
