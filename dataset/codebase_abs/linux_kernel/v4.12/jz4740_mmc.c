...
{
T_5 V_191 = F_81 ( V_192 ) ;
if ( V_2 -> V_167 && V_2 -> V_167 -> V_193 )
V_191 -= 3 ;
return V_191 ;
}
...
V_8 = F_83 ( sizeof( struct V_1 ) , & V_181 -> V_22 ) ;
if ( ! V_8 ) {
F_7 ( & V_181 -> V_22 , L_10 ) ;
return - V_57 ;
}
V_2 = F_22 ( V_8 ) ;
V_2 -> V_167 = V_167 ;
V_2 -> V_62 = F_84 ( V_181 , 0 ) ;
if ( V_2 -> V_62 < 0 ) {
V_30 = V_2 -> V_62 ;
F_7 ( & V_181 -> V_22 , L_11 , V_30 ) ;
goto V_194;
}
V_2 -> V_160 = F_85 ( & V_181 -> V_22 , L_12 ) ;
if ( F_86 ( V_2 -> V_160 ) ) {
V_30 = F_87 ( V_2 -> V_160 ) ;
F_7 ( & V_181 -> V_22 , L_13 ) ;
goto V_194;
}
V_2 -> V_45 = F_88 ( V_181 , V_195 , 0 ) ;
V_2 -> V_66 = F_89 ( & V_181 -> V_22 , V_2 -> V_45 ) ;
if ( F_86 ( V_2 -> V_66 ) ) {
V_30 = F_87 ( V_2 -> V_66 ) ;
F_7 ( & V_181 -> V_22 , L_14 ) ;
goto V_194;
}
V_30 = F_90 ( V_192 , F_80 ( V_2 ) ) ;
if ( V_30 ) {
...
V_8 -> V_204 = ( V_167 && V_167 -> V_193 ) ? 0 : V_205 ;
V_8 -> V_204 |= V_206 ;
V_8 -> V_207 = ( 1 << 10 ) - 1 ;
V_8 -> V_208 = ( 1 << 15 ) - 1 ;
V_8 -> V_209 = V_8 -> V_207 * V_8 -> V_208 ;
V_8 -> V_210 = 128 ;
V_8 -> V_211 = V_8 -> V_209 ;
V_2 -> V_8 = V_8 ;
V_2 -> V_181 = V_181 ;
F_91 ( & V_2 -> V_64 ) ;
V_2 -> V_65 = 0xffff ;
V_30 = F_92 ( V_2 -> V_62 , F_58 , F_57 , 0 ,
F_93 ( & V_181 -> V_22 ) , V_2 ) ;
if ( V_30 ) {
...
V_30 = F_96 ( V_8 ) ;
if ( V_30 ) {
F_7 ( & V_181 -> V_22 , L_17 , V_30 ) ;
goto V_213;
}
F_97 ( & V_181 -> V_22 , L_18 ) ;
F_97 ( & V_181 -> V_22 , L_19 ,
V_2 -> V_3 ? L_20 : L_21 ,
( V_8 -> V_204 & V_205 ) ? 4 : 1 ) ;
return 0 ;
V_213:
...
static int F_101 ( struct V_180 * V_181 )
{
struct V_1 * V_2 = F_102 ( V_181 ) ;
F_103 ( & V_2 -> V_83 ) ;
F_26 ( V_2 , 0xff , false ) ;
F_33 ( V_2 ) ;
F_104 ( V_2 -> V_8 ) ;
...
{
struct V_1 * V_2 = F_106 ( V_22 ) ;
F_107 ( V_192 , F_80 ( V_2 ) ) ;
return 0 ;
}
static int F_108 ( struct V_21 * V_22 )
{
struct V_1 * V_2 = F_106 ( V_22 ) ;
F_109 ( V_192 , F_80 ( V_2 ) ) ;
return 0 ;
}
