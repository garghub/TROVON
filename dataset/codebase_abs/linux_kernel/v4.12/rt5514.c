...
static int F_56 ( struct V_192 * V_194 ,
const struct V_195 * V_104 )
{
struct V_196 * V_85 = F_57 ( & V_194 -> V_5 ) ;
struct V_1 * V_2 ;
int V_149 ;
unsigned int V_171 = ~ 0 ;
V_2 = F_58 ( & V_194 -> V_5 , sizeof( struct V_1 ) ,
V_197 ) ;
if ( V_2 == NULL )
return - V_198 ;
F_59 ( V_194 , V_2 ) ;
...
V_2 -> V_73 = F_61 ( & V_194 -> V_5 , NULL , V_194 , & V_201 ) ;
if ( F_42 ( V_2 -> V_73 ) ) {
V_149 = F_47 ( V_2 -> V_73 ) ;
F_14 ( & V_194 -> V_5 , L_18 ,
V_149 ) ;
...
F_22 ( & V_194 -> V_5 , L_20 ,
V_149 ) ;
V_149 = F_62 ( V_2 -> V_73 , V_204 ,
F_17 ( V_204 ) ) ;
if ( V_149 != 0 )
F_22 ( & V_194 -> V_5 , L_21 , V_149 ) ;
return F_63 ( & V_194 -> V_5 , & V_205 ,
V_206 , F_17 ( V_206 ) ) ;
}
static int F_64 ( struct V_192 * V_194 )
{
F_65 ( & V_194 -> V_5 ) ;
return 0 ;
}
