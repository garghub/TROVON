...
V_23 = (struct V_22 * ) F_20 ( V_27 , sizeof( * V_23 ) ) ;
V_23 -> V_33 = sizeof( * V_25 ) ;
V_25 = (struct V_24 * ) F_20 ( V_27 , sizeof( * V_25 ) ) ;
V_25 -> V_34 = V_35 ;
F_21 ( V_15 , V_27 ) ;
F_22 ( V_15 ) ;
F_23 ( V_9 , L_3 ) ;
...
return - V_31 ;
F_19 ( V_27 ) = V_46 ;
V_41 = (struct V_40 * ) F_20 ( V_27 , sizeof( * V_41 ) ) ;
V_41 -> V_33 = sizeof( * V_39 ) ;
V_39 = (struct V_38 * ) F_20 ( V_27 , sizeof( * V_39 ) ) ;
V_39 -> V_47 = V_48 ;
V_39 -> V_42 = F_28 ( V_42 ) ;
V_39 -> V_49 = 0x0000 ;
V_39 -> V_50 = V_51 ;
...
static int F_54 ( struct V_89 * V_65 ,
struct V_26 * V_27 )
{
struct V_14 * V_15 = F_55 ( V_65 ) ;
struct V_6 * V_7 = V_15 -> V_16 ;
struct V_8 * V_9 = & V_7 -> V_2 -> V_9 ;
struct V_40 * V_23 ;
struct V_90 * V_91 ;
...
V_91 = (struct V_90 * ) F_56 ( V_27 , sizeof( * V_23 ) ) ;
if ( V_91 -> V_47 != V_95 ) {
F_12 ( V_9 , L_20 ) ;
V_7 -> V_37 = - V_96 ;
V_92 = - V_96 ;
...
static int F_58 ( struct V_89 * V_65 , struct V_26 * V_27 )
{
struct V_14 * V_15 = F_55 ( V_65 ) ;
struct V_6 * V_7 = V_15 -> V_16 ;
struct V_8 * V_9 = & V_7 -> V_2 -> V_9 ;
...
V_25 = (struct V_24 * ) F_56 ( V_27 , sizeof( * V_23 ) ) ;
if ( V_25 -> V_34 != V_99 ) {
F_12 ( V_9 , L_23 ,
V_25 -> V_34 ) ;
V_7 -> V_37 = - V_96 ;
...
{
F_19 ( V_27 ) = V_100 ;
return F_60 ( V_65 , V_27 ) ;
}
static int F_61 ( struct V_14 * V_15 , const void * V_5 , int V_101 )
{
struct V_6 * V_7 = V_15 -> V_16 ;
struct V_8 * V_9 = & V_7 -> V_2 -> V_9 ;
int V_17 ;
if ( ! F_62 ( V_102 , & V_15 -> V_103 ) )
return - V_104 ;
V_7 -> V_88 = F_63 ( V_15 -> V_65 , V_7 -> V_88 , V_5 , V_101 ,
V_105 , F_64 ( V_105 ) ) ;
if ( F_34 ( V_7 -> V_88 ) ) {
V_17 = F_35 ( V_7 -> V_88 ) ;
F_12 ( V_9 , L_25 , V_17 ) ;
...
static struct V_26 * F_65 ( struct V_14 * V_15 )
{
struct V_6 * V_7 = V_15 -> V_16 ;
struct V_8 * V_9 = & V_7 -> V_2 -> V_9 ;
struct V_26 * V_106 = F_66 ( & V_7 -> V_87 ) ;
if ( ! V_7 -> V_79 )
return V_106 ;
if ( V_7 -> V_80 == ! ! V_106 )
return V_106 ;
...
struct V_107 * V_45 ;
int V_17 = 0 ;
V_7 = F_69 ( V_9 , sizeof( * V_7 ) , V_30 ) ;
if ( ! V_7 )
return - V_31 ;
V_7 -> V_15 . V_2 = V_7 -> V_2 = V_2 ;
F_70 ( V_2 , V_7 ) ;
V_7 -> V_18 = F_71 ( V_9 , L_26 , V_108 ) ;
if ( F_34 ( V_7 -> V_18 ) ) {
V_17 = F_35 ( V_7 -> V_18 ) ;
F_12 ( V_9 , L_27 , V_17 ) ;
return V_17 ;
}
V_7 -> V_11 = F_71 ( V_9 , L_28 , V_109 ) ;
if ( F_34 ( V_7 -> V_11 ) ) {
V_17 = F_35 ( V_7 -> V_11 ) ;
F_12 ( V_9 , L_29 , V_17 ) ;
return V_17 ;
}
V_7 -> V_110 = F_72 ( V_7 -> V_11 ) ;
V_17 = F_73 ( V_9 , V_7 -> V_110 , NULL ,
F_4 ,
V_111 | V_112 | V_113 ,
L_30 , V_7 ) ;
if ( V_17 ) {
...
{
struct V_6 * V_7 = F_81 ( V_2 ) ;
struct V_14 * V_15 = & V_7 -> V_15 ;
struct V_89 * V_65 = V_15 -> V_65 ;
F_82 ( & V_15 -> V_117 ) ;
F_83 ( V_65 ) ;
F_84 ( V_65 ) ;
V_15 -> V_50 -> V_118 ( V_15 ) ;
F_48 ( & V_7 -> V_2 -> V_9 ) ;
}
