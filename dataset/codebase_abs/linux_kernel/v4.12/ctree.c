...
return F_213 ( V_23 , V_139 , V_284 , V_251 ,
...
static T_1 int F_222 ( struct V_22 * V_23 ,
...
static T_1 int F_231 ( struct V_22 * V_23 ,
struct V_1 * V_139 ,
const struct V_153 * V_250 ,
unsigned long V_303 )
{
...
if ( V_38 )
return V_38 ;
V_38 = F_231 ( V_18 -> V_23 , V_139 , V_250 , V_303 ) ;
return V_38 ;
}
...
const struct V_153 * V_315 , T_4 * V_272 ,
...
int F_251 ( struct V_32 * V_33 , struct V_17 * V_18 ,
const struct V_153 * V_315 , void * V_318 ,
T_4 V_272 )
{
int V_38 = 0 ;
struct V_1 * V_139 ;
...
static int F_259 ( struct V_1 * V_139 ,
int * V_39 , int V_325 )
{
int V_38 = 0 ;
int V_95 ;
...
int V_38 ;
if ( * V_39 == 0 || ! V_326 ) {
V_38 = F_259 ( V_139 , V_39 , V_325 ) ;
} else {
V_38 = F_258 ( V_23 , V_139 , V_39 ) ;
}
if ( V_38 >= 0 ) {
if ( * V_39 == 0 )
...
V_77 = F_88 ( V_258 ) - 1 ;
if ( V_39 == 0 )
F_188 ( V_258 , & V_362 , V_77 ) ;
else
F_257 ( V_258 , & V_362 , V_77 ) ;
V_361 = V_139 -> V_236 ;
F_8 ( V_139 ) ;
V_139 -> V_236 = V_39 ;
V_38 = F_186 ( NULL , V_18 , & V_362 , V_139 ,
0 , 0 ) ;
V_139 -> V_236 = V_361 ;
if ( V_38 < 0 )
return V_38 ;
