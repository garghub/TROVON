...
V_116 = F_31 ( V_6 -> V_142 , V_163 , V_112 -> V_125 ) ;
return V_116 ;
}
...
static int F_36 ( struct V_175 * V_176 )
{
struct V_5 * V_6 ;
...
V_6 -> V_157 = 16 ;
V_6 -> V_118 = V_181 ;
V_6 -> V_141 = F_37 ( & V_176 -> V_7 , L_37 ) ;
if ( F_38 ( V_6 -> V_141 ) ) {
V_116 = ( int ) F_39 ( V_6 -> V_141 ) ;
F_5 ( & V_176 -> V_7 ,
L_38 ,
V_27 , V_116 ) ;
return V_116 ;
}
F_40 ( V_149 , ( char * ) V_176 -> V_182 , 50 ) ;
V_6 -> V_143 = F_41 ( & V_176 -> V_7 , L_39 ) ;
if ( F_38 ( V_6 -> V_143 ) ) {
V_116 = ( int ) F_39 ( V_6 -> V_143 ) ;
F_5 ( & V_176 -> V_7 ,
L_40 ,
V_27 , V_116 ) ;
return V_116 ;
}
V_6 -> V_145 = F_41 ( & V_176 -> V_7 , NULL ) ;
if ( F_38 ( V_6 -> V_145 ) ) {
V_116 = ( int ) F_39 ( V_6 -> V_145 ) ;
F_5 ( & V_176 -> V_7 ,
L_41 ,
V_27 , V_116 ) ;
return V_116 ;
}
V_116 = F_42 ( V_176 , & V_6 -> V_142 ,
V_176 -> V_7 . V_174 ) ;
if ( ! V_6 -> V_142 ) {
F_5 ( & V_176 -> V_7 ,
L_42 ,
...
static int F_47 ( struct V_175 * V_176 )
{
struct V_5 * V_6 = F_2 ( & V_176 -> V_7 ) ;
F_48 ( V_176 ) ;
F_46 ( & V_176 -> V_7 ) ;
F_49 ( V_149 , L_21 ) ;
F_50 ( V_176 , V_6 -> V_142 ) ;
return 0 ;
}
