...
void F_96 ( struct V_148 * V_149 )
{
T_4 V_137 = F_97 ( V_149 -> V_167 ) ;
int V_45 = F_89 () ;
if ( F_98 ( & V_149 -> V_168 ) == 1 ) {
F_99 ( F_79 ( V_149 ) , F_64 ( V_45 ) ) ;
goto V_169;
}
F_62 ( & V_170 ,
V_137 , 0 , 0 ,
...
static void F_101 ( void * V_146 )
{
struct V_172 * V_41 = V_146 ;
F_102 ( V_41 -> V_137 , V_41 -> V_112 , V_41 -> V_173 ) ;
}
void F_103 ( struct V_148 * V_149 , unsigned long V_112 , unsigned long * V_173 )
{
T_4 V_137 = F_97 ( V_149 -> V_167 ) ;
struct V_172 V_146 ;
int V_45 = F_89 () ;
...
V_146 . V_112 = V_112 ;
V_146 . V_173 = V_173 ;
if ( V_149 == V_13 -> V_149 && F_98 ( & V_149 -> V_168 ) == 1 )
F_99 ( F_79 ( V_149 ) , F_64 ( V_45 ) ) ;
else
F_78 ( F_79 ( V_149 ) , F_101 ,
& V_146 , 1 ) ;
F_102 ( V_137 , V_112 , V_173 ) ;
F_90 () ;
}
void F_104 ( struct V_148 * V_149 , unsigned long V_70 )
{
unsigned long V_167 = F_97 ( V_149 -> V_167 ) ;
int V_45 = F_89 () ;
if ( V_149 == V_13 -> V_149 && F_98 ( & V_149 -> V_168 ) == 1 )
F_99 ( F_79 ( V_149 ) , F_64 ( V_45 ) ) ;
else
...
void F_106 ( unsigned long V_175 , unsigned long V_176 )
{
V_175 &= V_177 ;
V_176 = F_107 ( V_176 ) ;
if ( V_175 != V_176 ) {
...
void T_5 F_116 ( int V_143 , struct V_144 * V_145 )
{
F_68 ( 1 << V_143 ) ;
F_19 () ;
...
int F_118 ( unsigned int V_184 )
{
return - V_185 ;
}
void T_6 F_119 ( unsigned int V_186 )
{
}
void F_120 ( void )
{
...
if ( F_5 ( V_3 ) . V_193 ==
F_5 ( V_190 ) . V_193 )
F_128 ( V_190 , & V_194 [ V_3 ] ) ;
if ( F_5 ( V_3 ) . V_195 == F_5 ( V_190 ) . V_195 )
F_128 ( V_190 , & V_196 [ V_3 ] ) ;
}
}
F_126 (i) {
unsigned int V_190 ;
F_127 ( & F_129 ( V_197 , V_3 ) ) ;
if ( F_5 ( V_3 ) . V_198 == - 1 ) {
F_128 ( V_3 , & F_129 ( V_197 , V_3 ) ) ;
continue;
}
F_126 (j) {
if ( F_5 ( V_3 ) . V_198 ==
F_5 ( V_190 ) . V_198 )
F_128 ( V_190 , & F_129 ( V_197 , V_3 ) ) ;
}
}
}
int F_130 ( unsigned int V_45 , struct V_73 * V_199 )
{
int V_81 = F_41 ( V_45 , V_199 ) ;
if ( ! V_81 ) {
F_128 ( V_45 , & V_15 ) ;
while ( ! F_60 ( V_45 ) )
F_131 () ;
...
F_135 ( V_45 , & V_191 [ V_3 ] ) ;
F_127 ( & V_191 [ V_45 ] ) ;
F_59 (i, &per_cpu(cpu_sibling_map, cpu))
F_135 ( V_45 , & F_129 ( V_197 , V_3 ) ) ;
F_127 ( & F_129 ( V_197 , V_45 ) ) ;
V_208 = & F_5 ( V_45 ) ;
V_208 -> V_192 = 0 ;
V_208 -> V_198 = - 1 ;
F_139 () ;
...
void T_6 F_148 ( unsigned int V_186 )
{
}
void F_149 ( int V_45 )
{
...
void T_5 F_153 ( int V_143 , struct V_144 * V_145 )
{
F_68 ( 1 << V_143 ) ;
F_154 () ;
}
static void F_155 ( void * V_212 )
{
F_18 ( F_24 () , false ) ;
F_156 () ;
}
...
static void * T_6 F_162 ( unsigned int V_45 , T_8 V_213 ,
T_8 V_214 )
{
const unsigned long V_215 = F_40 ( V_216 ) ;
#ifdef F_163
int V_217 = F_164 ( V_45 ) ;
void * V_218 ;
if ( ! F_165 ( V_217 ) || ! F_166 ( V_217 ) ) {
V_218 = F_167 ( V_213 , V_214 , V_215 ) ;
F_168 ( L_35 ,
V_45 , V_217 ) ;
F_169 ( L_36 ,
V_45 , V_213 , F_40 ( V_218 ) ) ;
} else {
V_218 = F_170 ( F_166 ( V_217 ) ,
V_213 , V_214 , V_215 ) ;
F_169 ( L_37
L_38 , V_45 , V_213 , V_217 , F_40 ( V_218 ) ) ;
}
return V_218 ;
#else
return F_167 ( V_213 , V_214 , V_215 ) ;
#endif
}
static void T_6 F_171 ( void * V_218 , T_8 V_213 )
{
F_172 ( F_40 ( V_218 ) , V_213 ) ;
}
static int T_6 F_173 ( unsigned int V_219 , unsigned int V_220 )
{
if ( F_164 ( V_219 ) == F_164 ( V_220 ) )
return V_221 ;
else
return V_222 ;
}
static void T_6 F_174 ( unsigned long V_223 )
{
T_9 * V_151 = F_175 ( V_223 ) ;
T_10 * V_224 ;
T_11 * V_225 ;
if ( F_176 ( * V_151 ) ) {
T_10 * V_226 ;
V_226 = F_167 ( V_227 , V_227 , V_227 ) ;
F_177 ( & V_12 , V_151 , V_226 ) ;
}
V_224 = F_178 ( V_151 , V_223 ) ;
if ( F_179 ( * V_224 ) ) {
T_11 * V_226 ;
V_226 = F_167 ( V_227 , V_227 , V_227 ) ;
F_180 ( & V_12 , V_224 , V_226 ) ;
}
V_225 = F_181 ( V_224 , V_223 ) ;
if ( ! F_182 ( * V_225 ) ) {
T_12 * V_226 ;
V_226 = F_167 ( V_227 , V_227 , V_227 ) ;
F_183 ( & V_12 , V_225 , V_226 ) ;
}
}
void T_6 F_184 ( void )
{
...
if ( V_228 < 0 )
F_25 ( L_41 , V_228 ) ;
V_32 = ( unsigned long ) V_234 - ( unsigned long ) V_235 ;
F_188 (cpu)
F_8 ( V_45 ) = V_32 + V_236 [ V_45 ] ;
V_6 = F_8 ( F_24 () ) ;
F_189 () ;
if ( V_7 == V_8 )
F_190 ( V_237 ) ;
