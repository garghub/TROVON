...
const struct V_118 * V_165 )
{
struct V_154 * V_18 = F_104 ( V_148 ) ;
struct V_13 * V_10 ;
int V_15 = 0 ;
if ( V_165 -> V_119 == V_166 )
return F_103 ( V_148 ) ;
...
{
T_5 V_170 = 0xffffffff ;
void * V_49 ;
int V_15 ;
V_49 = F_115 ( & V_170 , 4 , V_16 ) ;
if ( ! V_49 )
return;
...
bool V_171 = ( V_18 -> V_172 == V_173 ) ? true : false ;
if ( ! V_10 )
return;
F_118 ( & V_10 -> V_127 ) ;
if ( V_10 -> V_26 & V_152 ) {
F_119 ( V_10 -> V_11 , V_171 ) ;
F_102 ( V_10 -> V_11 ) ;
F_91 ( V_10 ) ;
}
F_108 ( V_148 , NULL ) ;
if ( ! V_171 && ( V_10 -> V_26 & V_152 ) )
F_114 ( V_18 ) ;
F_3 ( V_10 ) ;
F_89 ( & V_18 -> V_67 , L_20 ) ;
F_113 ( V_18 ) ;
