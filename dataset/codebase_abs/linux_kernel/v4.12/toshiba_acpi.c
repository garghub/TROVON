...
static int F_169 ( struct V_209 * V_26 )
{
...
static int F_181 ( struct V_209 * V_26 )
{
struct V_9 * V_10 ;
const char * V_289 ;
T_1 V_290 ;
...
F_12 ( L_126 ,
V_150 ) ;
V_289 = F_180 ( V_26 -> V_27 ) ;
if ( ! V_289 ) {
F_11 ( L_127 ) ;
return - V_69 ;
}
V_10 = F_182 ( sizeof( * V_10 ) , V_142 ) ;
if ( ! V_10 )
return - V_143 ;
V_10 -> V_26 = V_26 ;
V_10 -> V_28 = V_289 ;
V_10 -> V_287 . V_292 = V_293 ;
V_10 -> V_287 . V_270 = L_128 ;
V_10 -> V_287 . V_294 = & V_295 ;
V_108 = F_183 ( & V_10 -> V_287 ) ;
if ( V_108 ) {
F_11 ( L_129 ) ;
F_75 ( V_10 ) ;
return V_108 ;
...
V_108 = F_26 ( V_10 , & V_290 ) ;
V_10 -> V_193 = ! V_108 ;
F_30 ( V_10 ) ;
if ( V_10 -> V_79 ) {
V_10 -> V_223 = F_186 ( sizeof( * V_10 ) ) ;
if ( ! V_10 -> V_223 ) {
F_11 ( L_134 ) ;
goto V_299;
}
F_12 ( L_135 ) ;
V_10 -> V_223 -> V_300 = & V_301 ;
V_10 -> V_223 -> V_270 = L_136 ;
V_10 -> V_223 -> V_10 . V_302 = & V_26 -> V_10 ;
V_10 -> V_223 -> V_303 = V_304 ;
V_10 -> V_223 -> V_305 = V_306 ;
V_10 -> V_223 -> V_307 =
F_187 ( V_306 ) ;
V_108 = F_188 ( V_10 -> V_223 ) ;
if ( V_108 < 0 ) {
F_11 ( L_137 ) ;
F_173 ( V_10 -> V_223 ) ;
}
...
V_299:
F_32 ( V_10 ) ;
V_108 = F_37 ( V_10 , & V_290 ) ;
V_10 -> V_197 = ! V_108 ;
V_108 = F_39 ( V_10 , & V_290 ) ;
V_10 -> V_199 = ! V_108 ;
V_108 = F_43 ( V_10 , & V_290 ) ;
V_10 -> V_203 = ! V_108 ;
V_108 = F_45 ( V_10 , & V_290 ) ;
V_10 -> V_205 = ! V_108 ;
V_108 = F_70 ( V_10 , & V_290 ) ;
V_10 -> V_156 = ! V_108 ;
V_108 = F_76 ( V_10 , & V_290 ) ;
V_10 -> V_158 = ! V_108 ;
F_49 ( V_10 ) ;
if ( V_10 -> V_99 )
F_133 ( V_10 ) ;
F_51 ( V_10 ) ;
F_167 ( V_10 ) ;
V_108 = F_189 ( & V_10 -> V_26 -> V_10 . V_184 ,
& V_210 ) ;
if ( V_108 ) {
V_10 -> V_288 = 0 ;
goto error;
...
static void F_190 ( struct V_209 * V_26 , T_1 V_308 )
{
struct V_9 * V_10 = F_170 ( V_26 ) ;
switch ( V_308 ) {
case 0x80 :
...
static int F_191 ( struct V_163 * V_163 )
{
struct V_9 * V_10 = F_170 ( F_192 ( V_163 ) ) ;
if ( V_10 -> V_160 ) {
T_1 V_55 ;
V_55 = F_6 ( V_10 , V_248 , V_309 ) ;
if ( V_55 != V_49 )
F_12 ( L_142 ) ;
}
return 0 ;
}
static int F_193 ( struct V_163 * V_163 )
{
struct V_9 * V_10 = F_170 ( F_192 ( V_163 ) ) ;
if ( V_10 -> V_160 ) {
if ( F_137 ( V_10 ) )
