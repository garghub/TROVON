...
switch ( V_288 ) {
case V_290 :
return F_73 ( V_268 , V_289 ) ;
case V_291 :
return F_79 ( V_268 , V_289 ) ;
default:
return - V_292 ;
}
}
void F_82 ( struct V_293 * V_294 , int V_4 )
{
struct V_295 * V_296 = & V_294 -> V_297 ;
struct V_14 * V_15 = & V_294 -> V_298 ;
unsigned char V_299 ;
if ( V_15 -> V_300 == V_301 )
return;
if ( V_296 -> V_300 == V_302 && V_4 ) {
do {
V_299 = F_83 ( V_294 -> V_298 . V_25 ,
V_303 ) ;
} while ( V_299 );
}
F_84 ( V_294 -> V_298 . V_25 , V_4 , V_303 ) ;
}
static int F_85 ( struct V_267 * V_268 , int V_304 )
{
struct V_14 * V_15 = F_74 ( V_268 ) ;
struct V_293 * V_294 = F_86 ( V_15 ) ;
if ( V_304 && V_15 -> V_300 != V_301 &&
V_15 -> V_305 != V_306 ) {
if ( F_87 ( V_15 ) < 0 )
return - V_8 ;
}
...
struct V_308 * V_270 , unsigned int V_309 ,
enum V_310 V_311 )
{
if ( V_311 == V_312 )
return F_89 ( & V_15 -> V_22 , V_270 , V_309 ) ;
return & V_15 -> V_313 [ V_309 ] ;
}
static void
...
V_315 = V_318 ;
if ( V_309 == V_319 ) {
for ( V_3 = 0 ; V_3 < F_75 ( V_320 ) ; V_3 ++ )
if ( V_314 -> V_321 == V_320 [ V_3 ] )
break;
if ( V_3 >= F_75 ( V_320 ) )
V_314 -> V_321 = V_322 ;
} else if ( V_309 == V_323 ) {
for ( V_3 = 0 ; V_3 < F_75 ( V_324 ) ; V_3 ++ )
if ( V_314 -> V_321 == V_324 [ V_3 ] )
break;
if ( V_3 >= F_75 ( V_324 ) )
V_314 -> V_321 = V_325 ;
}
V_314 -> V_326 = F_91 ( T_1 , V_314 -> V_326 , V_327 , V_316 ) ;
V_314 -> V_328 = F_91 ( T_1 , V_314 -> V_328 , V_329 , V_315 ) ;
}
static int
F_92 ( struct V_267 * V_268 , struct V_308 * V_270 ,
struct V_330 * V_314 )
{
struct V_14 * V_15 = F_74 ( V_268 ) ;
struct V_307 * V_331 ;
V_331 = F_88 ( V_15 , V_270 , V_314 -> V_309 , V_314 -> V_311 ) ;
if ( V_331 == NULL )
return - V_8 ;
F_90 ( V_15 , V_270 , V_314 -> V_309 , & V_314 -> V_331 , V_314 -> V_311 ) ;
* V_331 = V_314 -> V_331 ;
if ( V_314 -> V_311 == V_312 )
return 0 ;
if ( V_314 -> V_309 == V_319 &&
( V_15 -> V_300 == V_332 ||
V_15 -> V_300 == V_333 ) )
V_15 -> V_313 [ V_314 -> V_309 ] = V_314 -> V_331 ;
else if ( V_314 -> V_309 == V_323 &&
V_15 -> V_305 == V_334 )
V_15 -> V_313 [ V_314 -> V_309 ] = V_314 -> V_331 ;
else
return - V_8 ;
...
static int
F_93 ( struct V_267 * V_268 , struct V_308 * V_270 ,
struct V_330 * V_314 )
{
struct V_14 * V_15 = F_74 ( V_268 ) ;
if ( V_314 -> V_311 == V_335 )
V_314 -> V_331 = V_15 -> V_313 [ V_314 -> V_309 ] ;
else
V_314 -> V_331 = * ( F_89 ( V_268 , V_270 , V_314 -> V_309 ) ) ;
return 0 ;
}
static int
F_94 ( struct V_267 * V_268 ,
struct V_308 * V_270 ,
struct V_336 * V_337 )
{
struct V_14 * V_15 = F_74 ( V_268 ) ;
...
if ( V_337 -> V_338 != 0 )
return - V_8 ;
V_331 . V_321 = V_337 -> V_321 ;
V_331 . V_326 = 1 ;
V_331 . V_328 = 1 ;
F_90 ( V_15 , V_270 , V_337 -> V_309 , & V_331 , V_337 -> V_311 ) ;
V_337 -> V_339 = V_331 . V_326 ;
V_337 -> V_340 = V_331 . V_328 ;
if ( V_331 . V_321 != V_337 -> V_321 )
return - V_8 ;
V_331 . V_321 = V_337 -> V_321 ;
V_331 . V_326 = - 1 ;
V_331 . V_328 = - 1 ;
F_90 ( V_15 , V_270 , V_337 -> V_309 , & V_331 , V_337 -> V_311 ) ;
V_337 -> V_341 = V_331 . V_326 ;
V_337 -> V_342 = V_331 . V_328 ;
return 0 ;
}
static int
F_95 ( struct V_267 * V_268 , struct V_308 * V_270 ,
struct V_343 * V_321 )
{
switch ( V_321 -> V_309 ) {
case V_319 :
if ( V_321 -> V_338 >= F_75 ( V_320 ) )
return - V_8 ;
V_321 -> V_321 = V_320 [ V_321 -> V_338 ] ;
break;
case V_323 :
if ( V_321 -> V_338 >= F_75 ( V_324 ) )
return - V_8 ;
V_321 -> V_321 = V_324 [ V_321 -> V_338 ] ;
break;
default:
return - V_8 ;
}
...
static int F_96 ( struct V_344 * V_345 )
{
struct V_14 * V_15 =
F_97 ( V_345 -> V_346 , struct V_14 , V_347 ) ;
struct V_348 * V_349 = & V_15 -> V_17 . V_349 ;
switch ( V_345 -> V_74 ) {
case V_350 :
V_349 -> V_351 = V_345 -> V_299 ;
F_98 ( V_15 -> V_25 , V_349 ) ;
break;
case V_352 :
V_349 -> V_353 = V_345 -> V_299 ;
F_98 ( V_15 -> V_25 , V_349 ) ;
break;
default:
return - V_8 ;
...
static int
F_99 ( struct V_267 * V_268 , struct V_354 * V_355 )
{
struct V_330 V_331 ;
memset ( & V_331 , 0 , sizeof( V_331 ) ) ;
V_331 . V_309 = V_319 ;
V_331 . V_311 = V_312 ;
V_331 . V_331 . V_321 = V_322 ;
V_331 . V_331 . V_326 = V_317 ;
V_331 . V_331 . V_328 = V_318 ;
F_92 ( V_268 , V_355 -> V_309 , & V_331 ) ;
memset ( & V_331 , 0 , sizeof( V_331 ) ) ;
V_331 . V_309 = V_323 ;
V_331 . V_311 = V_312 ;
V_331 . V_331 . V_321 = V_325 ;
V_331 . V_331 . V_326 = V_317 ;
V_331 . V_331 . V_328 = V_318 ;
F_92 ( V_268 , V_355 -> V_309 , & V_331 ) ;
return 0 ;
...
struct V_14 * V_15 = F_74 ( V_268 ) ;
struct V_293 * V_294 = F_86 ( V_15 ) ;
T_4 V_362 = V_294 -> V_297 . V_300 ;
if ( ! F_102 ( V_360 -> V_357 ) )
return - V_8 ;
switch ( V_359 -> V_338 ) {
case V_319 :
if ( ! ( V_361 & V_363 ) ) {
...
void F_103 ( struct V_14 * V_298 )
{
F_104 ( & V_298 -> V_22 ) ;
F_105 ( & V_298 -> V_22 . V_357 ) ;
}
int
...
F_116 ( V_268 , V_15 ) ;
V_268 -> V_361 |= V_385 ;
V_370 [ V_319 ] . V_361 = V_386 ;
V_370 [ V_323 ] . V_361 = V_387 ;
V_15 -> V_300 = V_301 ;
V_15 -> V_305 = V_306 ;
V_371 -> V_388 = & V_389 ;
F_117 ( & V_15 -> V_347 , 2 ) ;
F_118 ( & V_15 -> V_347 , & V_390 ,
V_350 , 0 ,
V_391 , 1 , 16 ) ;
F_118 ( & V_15 -> V_347 , & V_390 ,
V_352 , 0 ,
V_392 , 1 , 16 ) ;
F_119 ( & V_15 -> V_347 ) ;
V_268 -> V_393 = & V_15 -> V_347 ;
return F_120 ( V_371 , V_394 , V_370 ) ;
V_380:
F_121 ( V_15 -> V_25 ) ;
V_379:
F_122 ( V_374 -> V_377 , V_372 ) ;
return - V_395 ;
}
