...
V_65 = F_16 ( V_63 ) ;
F_17 ( V_63 , V_19 -> V_76 ) ;
V_67 = (struct V_66 * ) F_18 ( V_63 , V_72 ) ;
memset ( V_67 , 0 , V_72 ) ;
V_67 -> V_84 = F_19 ( V_85 |
V_86 ) ;
...
if ( V_60 == V_96 ) {
V_70 = F_18 ( V_63 , 2 ) ;
F_20 ( V_4 -> V_4 . V_97 , V_70 ) ;
}
if ( F_21 ( V_2 , V_63 , true , V_26 ) ||
F_22 ( V_2 , V_63 , true , V_26 ) ||
F_23 ( V_2 , V_63 ) ||
F_24 ( V_2 , V_63 ) ||
F_25 ( V_2 , V_63 ) )
goto free;
...
if ( F_26 ( F_27 ( V_63 ) < 2 + V_71 ) )
goto free;
V_70 = F_18 ( V_63 , 2 + V_71 ) ;
* V_70 ++ = V_100 ;
* V_70 ++ = V_71 ;
memcpy ( V_70 , & V_69 , 2 ) ;
V_70 += 2 ;
...
if ( ! V_21 )
return;
V_109 = F_46 ( V_2 , V_107 , V_21 -> V_26 ,
& V_110 ) ;
F_40 ( & V_4 -> V_7 -> V_11 ) ;
...
F_54 ( V_4 -> V_4 . V_97 , V_124 ) ;
F_10 () ;
V_97 = F_55 ( V_124 , V_125 + 1 ) ;
F_56 ( V_124 ) ;
if ( V_97 > V_125 )
return - V_127 ;
return V_97 ;
...
V_4 = F_65 ( V_2 , V_40 ) ;
if ( V_4 ) {
F_45 ( V_2 , V_4 , V_107 , false ) ;
} else {
F_10 () ;
V_4 = F_60 ( V_2 , V_40 , V_107 ) ;
if ( ! V_4 ) {
F_8 () ;
return NULL ;
}
F_45 ( V_2 , V_4 , V_107 , true ) ;
if ( F_66 ( V_4 ) )
return NULL ;
}
return V_4 ;
...
static void F_71 ( unsigned long V_142 )
{
struct V_3 * V_4 ;
T_3 V_16 = 0 ;
struct V_1 * V_2 ;
...
return;
F_40 ( & V_4 -> V_7 -> V_11 ) ;
if ( F_72 ( V_115 , V_4 -> V_7 -> V_105 . V_145 ) ) {
F_11 ( V_4 -> V_2 ,
L_5 ,
...
V_4 -> V_7 -> V_150 ) ;
F_73 ( & rand , sizeof( T_2 ) ) ;
V_4 -> V_7 -> V_150 = V_4 -> V_7 -> V_150 +
rand % V_4 -> V_7 -> V_150 ;
++ V_4 -> V_7 -> V_17 ;
F_74 ( V_4 , V_4 -> V_7 -> V_150 ) ;
V_60 = V_99 ;
break;
}
V_16 = V_151 ;
...
static inline void F_76 ( struct V_3 * V_4 , T_2 V_156 )
{
V_4 -> V_7 -> V_105 . V_145 = V_115 + F_77 ( V_156 ) ;
V_4 -> V_7 -> V_105 . V_142 = ( unsigned long ) V_4 ;
V_4 -> V_7 -> V_105 . V_157 = F_71 ;
V_4 -> V_7 -> V_150 = V_156 ;
F_78 ( & V_4 -> V_7 -> V_105 ) ;
}
...
T_3 V_14 ;
do {
F_73 ( & V_14 , sizeof( V_14 ) ) ;
} while ( F_79 ( V_2 , V_14 ) );
return V_14 ;
}
T_2 F_68 ( struct V_3 * V_4 )
{
struct V_1 * V_2 = V_4 -> V_2 ;
T_2 V_23 ;
if ( ! F_81 ( V_4 , V_159 ) )
...
V_4 -> V_7 -> V_12 = V_148 ;
F_76 ( V_4 , V_2 -> V_6 . V_7 . V_8 . V_160 ) ;
F_41 ( & V_4 -> V_7 -> V_11 ) ;
F_11 ( V_2 ,
L_9 ,
V_4 -> V_4 . V_40 ) ;
...
V_15 = F_92 ( F_93 ( V_107 -> V_181 ) ) ;
if ( V_174 == V_96 ||
( V_174 == V_93 && V_71 == 8 ) )
V_14 = F_92 ( F_94 ( V_107 -> V_181 ) ) ;
F_8 () ;
V_4 = F_65 ( V_2 , V_67 -> V_88 ) ;
if ( V_174 == V_99 &&
! F_1 ( V_2 , V_4 ) ) {
F_11 ( V_2 , L_20 ,
V_67 -> V_88 ) ;
...
V_162 = F_88 ( V_2 , V_4 , V_107 , V_174 , V_14 , V_15 ) ;
if ( V_162 == V_169 ) {
F_10 () ;
V_4 = F_64 ( V_2 , V_67 -> V_88 , V_107 ) ;
if ( ! V_4 ) {
F_11 ( V_2 , L_21 ) ;
goto V_185;
}
...
if ( ! V_4 -> V_7 -> V_15 )
V_4 -> V_7 -> V_15 = V_15 ;
V_4 -> V_7 -> V_97 = F_92 ( F_95 ( V_67 ) ) ;
}
V_23 |= F_87 ( V_2 , V_4 , V_162 ) ;
V_185:
F_10 () ;
if ( V_23 )
F_70 ( V_2 , V_23 ) ;
...
F_98 ( V_190 , V_186 - V_189 , true , & V_107 ) ;
F_91 ( V_2 , V_67 , & V_107 ) ;
}
