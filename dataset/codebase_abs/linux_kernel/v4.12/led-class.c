...
int F_34 ( struct V_1 * V_36 , struct V_37 * V_38 ,
struct V_6 * V_7 )
{
char V_31 [ V_39 ] ;
int V_11 ;
...
static void F_56 ( struct V_1 * V_2 , void * V_52 )
{
F_50 ( * (struct V_6 * * ) V_52 ) ;
}
...
struct V_6 * * V_53 ;
int V_54 ;
V_53 = F_58 ( F_56 , sizeof( * V_53 ) , V_55 ) ;
if ( ! V_53 )
return - V_35 ;
V_54 = F_34 ( V_36 , V_38 , V_7 ) ;
if ( V_54 ) {
F_59 ( V_53 ) ;
return V_54 ;
}
...
static int F_61 ( struct V_1 * V_2 , void * V_52 , void * V_29 )
{
struct V_7 * * V_56 = V_52 ;
if ( F_21 ( ! V_56 || ! * V_56 ) )
return 0 ;
return * V_56 == V_29 ;
}
