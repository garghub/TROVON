...
struct V_42 * V_42 = F_55 ( V_65 -> V_84 ) ;
struct V_85 V_86 ;
...
return - V_92 ;
if ( ( V_12 -> V_68 & V_93 ) &&
! F_59 ( V_65 , V_42 -> V_94 , V_91 ) )
return - V_92 ;
if ( ( V_70 -> V_95 & V_96 ) == V_96 ) {
int V_80 ;
if ( V_12 -> V_46 == NULL )
return - V_89 ;
if ( ! V_7 -> V_54 ) {
...
F_3 () ;
V_80 = F_60 ( V_42 -> V_40 , V_65 , V_70 , & V_98 ) ;
F_1 () ;
} else {
struct V_97 V_98 = {
. V_99 = V_7 -> V_99 ,
...
V_55 = V_7 -> V_55 ;
if ( V_55 ) {
V_27 = F_61 ( V_70 , V_87 , V_55 , V_7 -> V_53 ,
V_12 -> V_101 , V_83 ) ;
if ( V_27 < 0 )
goto V_102;
}
V_86 . V_103 = V_70 -> V_104 ;
V_86 . V_105 = F_62 ( V_65 ) . V_66 ;
V_86 . V_106 = V_70 ;
V_86 . V_107 = F_50 ( V_70 ) ;
V_86 . V_108 = F_50 ( V_70 ) + V_73 ;
V_86 . V_109 = V_55 ;
V_86 . V_83 = V_83 ;
F_63 ( & V_86 , V_42 ) ;
memset ( & V_86 . V_110 , 0 , sizeof( V_86 . V_110 ) ) ;
if ( V_7 -> V_111 ) {
V_27 = V_7 -> V_111 ( V_12 , V_65 , & V_86 ) ;
if ( V_27 )
goto V_102;
}
V_27 = V_12 -> V_47 ( V_65 , & V_86 ) ;
if ( V_7 -> V_112 )
V_7 -> V_112 ( V_12 , V_65 , & V_86 ) ;
V_102:
if ( V_7 -> V_54 )
F_44 ( V_55 ) ;
return V_27 ;
...
if ( V_72 == NULL )
return - 1 ;
if ( F_70 ( V_65 , V_114 , V_7 -> V_6 ) ||
F_71 ( V_65 , V_115 , V_7 -> V_4 ) ||
F_72 ( V_65 , V_116 , V_7 -> V_75 ) ||
F_72 ( V_65 , V_117 , V_7 -> V_74 ) ||
F_72 ( V_65 , V_118 , V_7 -> V_53 ) )
goto V_119;
if ( V_7 -> V_11 ) {
struct V_56 * V_120 ;
int V_10 ;
V_120 = F_73 ( V_65 , V_121 ) ;
if ( V_120 == NULL )
goto V_119;
for ( V_10 = 0 ; V_10 < V_7 -> V_11 ; V_10 ++ ) {
struct V_56 * V_122 ;
...
if ( V_12 -> V_101 )
V_123 |= V_126 ;
V_122 = F_73 ( V_65 , V_10 + 1 ) ;
if ( V_122 == NULL )
goto V_119;
if ( F_72 ( V_65 , V_127 , V_12 -> V_9 ) ||
F_72 ( V_65 , V_128 , V_123 ) )
goto V_119;
F_74 ( V_65 , V_122 ) ;
}
F_74 ( V_65 , V_120 ) ;
...
struct V_3 * V_135 ;
struct V_42 * V_42 = F_55 ( V_65 -> V_84 ) ;
int V_136 = V_78 -> args [ 0 ] ;
unsigned int V_4 ;
F_14 (&genl_fam_idr, rt, id) {
if ( ! V_135 -> V_41 && ! F_56 ( V_42 , & V_39 ) )
continue;
if ( V_134 ++ < V_136 )
continue;
if ( F_69 ( V_135 , F_62 ( V_78 -> V_65 ) . V_66 ,
V_78 -> V_70 -> V_104 , V_137 ,
V_65 , V_58 ) < 0 ) {
V_134 -- ;
break;
}
...
static int F_84 ( struct V_64 * V_65 , struct V_85 * V_86 )
{
struct V_64 * V_141 ;
const struct V_3 * V_142 = NULL ;
int V_27 = - V_32 ;
if ( V_86 -> V_109 [ V_115 ] ) {
T_4 V_4 = F_85 ( V_86 -> V_109 [ V_115 ] ) ;
V_142 = F_11 ( V_4 ) ;
V_27 = - V_60 ;
}
if ( V_86 -> V_109 [ V_114 ] ) {
char * V_6 ;
V_6 = F_86 ( V_86 -> V_109 [ V_114 ] ) ;
V_142 = F_13 ( V_6 ) ;
#ifdef F_87
if ( V_142 == NULL ) {
F_3 () ;
...
if ( V_142 == NULL )
return V_27 ;
if ( ! V_142 -> V_41 && ! F_56 ( F_89 ( V_86 ) , & V_39 ) ) {
return - V_60 ;
}
V_141 = F_79 ( V_142 , V_86 -> V_105 , V_86 -> V_103 ,
V_58 ) ;
if ( F_90 ( V_141 ) )
return F_91 ( V_141 ) ;
return F_92 ( V_141 , V_86 ) ;
}
static int F_38 ( int V_145 , const struct V_3 * V_7 ,
const struct V_29 * V_30 ,
int V_43 )
{
struct V_64 * V_141 ;
...
case V_63 :
F_26 ( V_30 ) ;
V_141 = F_79 ( V_7 , 0 , 0 , V_145 ) ;
break;
case V_59 :
case V_44 :
F_27 ( ! V_30 ) ;
V_141 = F_83 ( V_7 , V_30 , V_43 , 0 , 0 , V_145 ) ;
break;
default:
return - V_32 ;
}
...
static int F_95 ( struct V_42 * V_42 , int V_147 )
{
struct V_3 * V_148 ;
int V_27 = - V_60 ;
unsigned int V_4 ;
...
if ( V_147 >= V_148 -> V_38 &&
V_147 < V_148 -> V_38 + V_148 -> V_26 ) {
int V_149 = V_147 - V_148 -> V_38 ;
if ( ! V_148 -> V_41 && V_42 != & V_39 )
V_27 = - V_60 ;
else if ( V_148 -> V_150 )
V_27 = V_148 -> V_150 ( V_42 , V_149 ) ;
else
V_27 = 0 ;
break;
}
...
static void F_96 ( struct V_42 * V_42 , int V_147 )
{
struct V_3 * V_148 ;
unsigned int V_4 ;
F_66 ( & V_2 ) ;
...
V_42 -> V_40 = F_98 ( V_42 , V_144 , & V_153 ) ;
...
static int F_106 ( struct V_64 * V_65 , T_3 V_66 , unsigned long V_147 ,
T_8 V_68 )
{
struct V_64 * V_160 ;
struct V_42 * V_42 , * V_161 = NULL ;
int V_27 ;
F_30 (net) {
if ( V_161 ) {
V_160 = F_107 ( V_65 , V_68 ) ;
if ( ! V_160 ) {
V_27 = - V_25 ;
goto error;
}
V_27 = F_108 ( V_161 -> V_40 , V_160 ,
V_66 , V_147 , V_68 ) ;
if ( V_27 )
goto error;
}
...
return F_108 ( V_161 -> V_40 , V_65 , V_66 , V_147 , V_68 ) ;
error:
F_109 ( V_65 ) ;
return V_27 ;
}
...
unsigned int V_147 , T_8 V_68 )
{
if ( F_110 ( V_147 >= V_7 -> V_26 ) )
return - V_32 ;
V_147 = V_7 -> V_38 + V_147 ;
return F_106 ( V_65 , V_66 , V_147 , V_68 ) ;
}
void F_111 ( const struct V_3 * V_7 , struct V_64 * V_65 ,
struct V_85 * V_86 , T_3 V_147 , T_8 V_68 )
{
struct V_42 * V_42 = F_89 ( V_86 ) ;
struct V_162 * V_84 = V_42 -> V_40 ;
int V_163 = 0 ;
if ( V_86 -> V_106 )
V_163 = F_112 ( V_86 -> V_106 ) ;
if ( F_110 ( V_147 >= V_7 -> V_26 ) )
return;
V_147 = V_7 -> V_38 + V_147 ;
F_113 ( V_84 , V_65 , V_86 -> V_105 , V_147 , V_163 , V_68 ) ;
}
