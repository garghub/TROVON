...
return V_2 -> V_21 ;
V_12 = V_22 ;
V_20 = V_2 -> V_4 -> V_8 ( V_2 -> V_6 , V_16 , & V_12 , 1 ) ;
if ( V_20 < 0 )
return V_20 ;
V_19 = V_23 + V_10 -> V_24 ;
do {
...
V_12 = V_66 ;
V_20 = V_2 -> V_4 -> V_8 ( V_2 -> V_6 , V_14 , & V_12 , 1 ) ;
if ( V_20 < 0 )
goto V_63;
if ( V_10 -> V_39 & V_40 ) {
V_60 = F_23 ( * ( ( V_67 * ) ( V_48 + 6 ) ) ) ;
V_20 = F_12 ( V_10 , V_52 | V_53 ,
F_24 ( V_10 , V_60 ) ,
& V_2 -> V_55 , false ) ;
if ( V_20 < 0 )
goto V_63;
...
| V_84
| V_85 ;
V_20 = V_2 -> V_4 -> V_8 ( V_2 -> V_6 , V_86 ,
& V_73 , 1 ) ;
if ( V_20 < 0 )
goto V_81;
V_73 = V_87 ;
V_20 = V_2 -> V_4 -> V_8 ( V_2 -> V_6 , ( V_86 + 3 ) ,
& V_73 , 1 ) ;
if ( V_20 < 0 )
goto V_81;
V_2 -> V_42 = V_42 ;
