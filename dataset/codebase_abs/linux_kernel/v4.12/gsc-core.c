...
static T_2 F_48 ( int V_168 , void * V_169 )
{
struct V_49 * V_50 = V_169 ;
struct V_65 * V_66 ;
int V_170 ;
V_170 = F_49 ( V_50 ) ;
F_50 ( V_50 , V_170 ) ;
...
F_51 ( & V_50 -> V_151 ) ;
if ( F_52 ( V_173 , & V_50 -> V_146 ) ) {
F_53 ( V_50 , false ) ;
if ( F_52 ( V_174 , & V_50 -> V_146 ) ) {
F_54 ( V_175 , & V_50 -> V_146 ) ;
F_55 ( & V_50 -> V_176 ) ;
goto V_177;
}
V_66 = F_56 ( V_50 -> V_178 . V_179 ) ;
if ( ! V_66 || ! V_66 -> V_180 )
goto V_177;
F_57 ( & V_50 -> V_151 ) ;
F_58 ( V_66 , V_181 ) ;
...
static int F_59 ( struct V_183 * V_127 )
{
struct V_49 * V_50 ;
struct V_184 * V_185 ;
struct V_125 * V_126 = & V_127 -> V_126 ;
const struct V_186 * V_187 = F_60 ( V_126 ) ;
int V_128 ;
int V_8 ;
V_50 = F_61 ( V_126 , sizeof( struct V_49 ) , V_188 ) ;
if ( ! V_50 )
return - V_189 ;
V_128 = F_62 ( V_127 -> V_126 . V_190 , L_30 ) ;
if ( V_128 < 0 )
return V_128 ;
V_50 -> V_140 = V_128 ;
if ( V_50 -> V_140 >= V_187 -> V_191 ) {
F_34 ( V_126 , L_31 , V_50 -> V_140 ) ;
return - V_25 ;
}
V_50 -> V_192 = V_187 -> V_192 ;
V_50 -> V_68 = V_187 -> V_68 [ V_50 -> V_140 ] ;
V_50 -> V_127 = V_127 ;
F_63 ( & V_50 -> V_176 ) ;
F_64 ( & V_50 -> V_151 ) ;
F_65 ( & V_50 -> V_193 ) ;
V_185 = F_66 ( V_127 , V_194 , 0 ) ;
V_50 -> V_195 = F_67 ( V_126 , V_185 ) ;
if ( F_26 ( V_50 -> V_195 ) )
return F_27 ( V_50 -> V_195 ) ;
V_185 = F_66 ( V_127 , V_196 , 0 ) ;
if ( ! V_185 ) {
F_34 ( V_126 , L_32 ) ;
return - V_197 ;
}
for ( V_8 = 0 ; V_8 < V_50 -> V_192 ; V_8 ++ ) {
V_50 -> clock [ V_8 ] = F_68 ( V_126 , V_187 -> V_198 [ V_8 ] ) ;
...
V_128 = F_71 ( V_126 , V_185 -> V_199 , F_48 ,
0 , V_127 -> V_42 , V_50 ) ;
if ( V_128 ) {
F_34 ( V_126 , L_35 , V_128 ) ;
goto V_200;
}
V_128 = F_72 ( V_126 , & V_50 -> V_201 ) ;
if ( V_128 )
goto V_200;
V_128 = F_73 ( V_50 ) ;
if ( V_128 )
...
F_82 ( & V_50 -> V_201 ) ;
V_200:
for ( V_8 = V_50 -> V_192 - 1 ; V_8 >= 0 ; V_8 -- )
F_70 ( V_50 -> clock [ V_8 ] ) ;
return V_128 ;
}
static int F_83 ( struct V_183 * V_127 )
{
...
F_92 ( V_175 , & V_50 -> V_146 ) ;
F_54 ( V_174 , & V_50 -> V_146 ) ;
F_39 ( & V_50 -> V_151 , V_136 ) ;
V_203 = F_93 ( V_50 -> V_176 ,
F_94 ( V_175 , & V_50 -> V_146 ) ,
V_204 ) ;
F_92 ( V_174 , & V_50 -> V_146 ) ;
...
unsigned long V_136 ;
F_38 ( & V_50 -> V_151 , V_136 ) ;
V_66 = V_50 -> V_178 . V_66 ;
V_50 -> V_178 . V_66 = NULL ;
F_39 ( & V_50 -> V_151 , V_136 ) ;
if ( F_52 ( V_175 , & V_50 -> V_146 ) )
F_58 ( V_66 , V_206 ) ;
}
static int F_96 ( struct V_125 * V_126 )
{
struct V_49 * V_50 = F_97 ( V_126 ) ;
int V_128 = 0 ;
int V_8 ;
