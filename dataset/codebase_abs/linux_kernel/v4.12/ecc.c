...
const T_4 * V_79 , unsigned int V_80 )
{
int V_81 ;
...
if ( V_80 != V_81 )
return - V_83 ;
if ( F_10 ( ( const T_1 * ) & V_79 [ 0 ] , V_8 ) )
return - V_83 ;
if ( F_15 ( V_82 -> V_85 , ( const T_1 * ) & V_79 [ 0 ] , V_8 ) != 1 )
return - V_83 ;
return 0 ;
}
int F_44 ( unsigned int V_2 , unsigned int V_8 ,
const T_4 * V_79 , unsigned int V_80 ,
...
F_41 ( ( const T_1 * ) V_79 , V_90 , V_8 ) ;
V_89 = F_6 ( V_8 ) ;
if ( ! V_89 ) {
V_88 = - V_91 ;
goto V_78;
}
F_40 ( V_89 , & V_82 -> V_92 , V_90 , NULL , V_82 -> V_13 , V_8 ) ;
if ( F_34 ( V_89 ) ) {
V_88 = - V_93 ;
goto V_94;
}
V_81 = V_8 << V_84 ;
F_41 ( V_89 -> V_14 , ( T_1 * ) V_86 , V_8 ) ;
F_41 ( V_89 -> V_16 , ( T_1 * ) & V_86 [ V_81 ] , V_8 ) ;
V_94:
F_8 ( V_89 ) ;
V_78:
return V_88 ;
}
int F_45 ( unsigned int V_2 , unsigned int V_8 ,
const T_4 * V_79 , unsigned int V_80 ,
const T_4 * V_86 , unsigned int V_87 ,
T_4 * V_95 , unsigned int V_96 )
{
int V_88 = 0 ;
struct V_12 * V_52 , * V_89 ;
T_1 V_90 [ V_8 ] ;
T_1 V_97 [ V_8 ] ;
unsigned int V_81 ;
const struct V_1 * V_82 = F_1 ( V_2 ) ;
...
F_41 ( ( const T_1 * ) V_86 , V_89 -> V_14 , V_8 ) ;
F_41 ( ( const T_1 * ) & V_86 [ V_81 ] , V_89 -> V_16 , V_8 ) ;
F_41 ( ( const T_1 * ) V_79 , V_90 , V_8 ) ;
F_40 ( V_52 , V_89 , V_90 , V_97 , V_82 -> V_13 , V_8 ) ;
F_41 ( V_52 -> V_14 , ( T_1 * ) V_95 , V_8 ) ;
if ( F_34 ( V_52 ) )
V_88 = - V_99 ;
F_8 ( V_52 ) ;
V_98:
