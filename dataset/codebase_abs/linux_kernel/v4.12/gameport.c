...
if ( V_4 -> V_76 )
F_81 ( & V_4 -> V_27 , L_10 ,
V_4 -> V_32 , V_4 -> V_31 , V_4 -> V_76 , V_4 -> V_73 ) ;
else
F_81 ( & V_4 -> V_27 , L_11 ,
V_4 -> V_32 , V_4 -> V_31 , V_4 -> V_73 ) ;
error = F_82 ( & V_4 -> V_27 ) ;
if ( error )
F_83 ( & V_4 -> V_27 ,
L_12 ,
...
{
do {
if ( ! V_4 -> V_26 || ! V_4 -> V_26 -> V_77 || V_4 -> V_26 -> V_77 ( V_4 ) ) {
F_65 ( V_4 ) ;
F_32 ( V_4 ) ;
break;
}
...
{
struct V_4 * V_78 , * V_59 ;
if ( V_4 -> V_60 ) {
for ( V_78 = V_4 ; V_78 -> V_60 ; V_78 = V_78 -> V_60 )
;
do {
V_59 = V_78 -> V_59 ;
F_88 ( & V_78 -> V_27 ) ;
...
int F_7 ( struct V_4 * V_4 , struct V_25 * V_26 , int V_83 )
{
if ( V_4 -> V_84 ) {
if ( V_4 -> V_84 ( V_4 , V_83 ) ) {
return - 1 ;
}
} else {
if ( V_83 != V_11 )
