...
F_75 ( & V_113 [ V_20 ] . V_116 , 0 ) ;
F_76 ( & V_113 [ V_20 ] . V_117 ) ;
V_112 = V_118 [ V_20 ] -> F_77 () ;
if ( F_78 ( V_112 ) ) {
F_79 ( L_2 ) ;
} else {
F_75 ( & V_113 [ V_20 ] . V_116 , 1 ) ;
V_113 [ V_20 ] . V_119 = 1 ;
F_80 ( V_112 , & V_113 [ V_20 ] . V_114 ) ;
}
}
}
static struct V_111 * F_81 ( int type )
{
struct V_111 * V_112 ;
int V_120 = F_82 () ;
int V_121 = type - 1 ;
...
F_88 ( V_123 ) ;
F_86 ( V_115 ) ;
F_89 ( V_117 , & V_123 , V_124 ) ;
if ( F_87 ( V_116 ) > V_120 && ! * V_119 )
F_90 () ;
F_91 ( V_117 , & V_123 ) ;
goto V_122;
}
...
static void F_97 ( int type , struct V_111 * V_112 )
{
int V_121 = type - 1 ;
struct V_111 * V_114 = & V_113 [ V_121 ] . V_114 ;
T_8 * V_115 = & V_113 [ V_121 ] . V_115 ;
...
int V_20 ;
for ( V_20 = 0 ; V_20 < V_110 ; V_20 ++ ) {
while ( ! F_84 ( & V_113 [ V_20 ] . V_114 ) ) {
V_112 = V_113 [ V_20 ] . V_114 . V_91 ;
F_85 ( V_112 ) ;
V_118 [ V_20 ] -> F_97 ( V_112 ) ;
F_93 ( & V_113 [ V_20 ] . V_116 ) ;
}
}
}
int F_101 ( int type , struct V_84 * V_47 ,
...
int V_18 ;
V_112 = F_81 ( type ) ;
V_18 = V_118 [ type - 1 ] -> F_102 ( V_112 , V_47 ,
V_44 , V_54 ,
V_128 ,
V_129 , V_130 ) ;
F_97 ( type , V_112 ) ;
...
int V_18 ;
V_112 = F_81 ( type ) ;
V_18 = V_118 [ type - 1 ] -> F_103 ( V_112 , V_131 ,
V_17 , V_45 ,
V_132 ) ;
F_97 ( type , V_112 ) ;
return V_18 ;
}
int F_104 ( int type , unsigned char * V_133 , struct V_19 * V_134 ,
unsigned long V_135 , T_6 V_132 , T_6 V_136 )
{
struct V_111 * V_112 ;
int V_18 ;
V_112 = F_81 ( type ) ;
V_18 = V_118 [ type - 1 ] -> F_105 ( V_112 , V_133 ,
V_134 , V_135 ,
V_132 , V_136 ) ;
F_97 ( type , V_112 ) ;
return V_18 ;
...
int F_107 ( const char * V_137 , unsigned long V_138 ,
...
unsigned long V_143 ;
char * V_21 ;
struct V_48 V_49 = F_108 ( V_8 , V_8 -> V_40 ) ;
