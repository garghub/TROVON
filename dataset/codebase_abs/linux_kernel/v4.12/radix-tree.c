...
static int F_52 ( T_2 V_18 , unsigned V_53 )
{
struct V_47 * V_48 ;
struct V_1 * V_5 ;
int V_46 = - V_58 ;
...
struct V_30 * V_31 , T_2 V_73 , int V_90 )
{
struct V_1 * V_5 = NULL , * V_80 ;
void T_1 * * V_8 = ( void T_1 * * ) & V_17 -> V_38 ;
unsigned long V_72 , V_108 = V_31 -> F_31 ;
unsigned long V_83 = V_90 > 0 ? V_90 - 1 : V_109 ;
unsigned int V_12 , V_11 = 0 ;
V_110:
V_12 = F_59 ( V_17 , & V_80 , & V_72 ) ;
if ( ! F_111 ( V_17 , V_75 ) )
...
void F_121 ( struct V_112 * V_112 )
{
struct V_1 * V_5 = F_6 ( V_112 -> V_113 . V_38 ) ;
if ( F_8 ( V_5 ) )
F_67 ( V_5 ) ;
V_112 -> V_113 . V_38 = NULL ;
F_16 ( & V_112 -> V_113 , V_75 ) ;
}
static void
F_122 ( void * V_114 )
{
...
static T_5 unsigned long F_123 ( unsigned int V_115 )
{
unsigned int V_116 = V_115 * V_64 ;
int V_12 = V_117 - V_116 ;
if ( V_12 < 0 )
return ~ 0UL ;
if ( V_12 >= V_29 )
return 0UL ;
...
static T_5 void F_124 ( void )
{
unsigned long V_118 [ V_70 + 1 ] ;
unsigned int V_32 , V_119 ;
for ( V_32 = 0 ; V_32 < F_125 ( V_118 ) ; V_32 ++ )
V_118 [ V_32 ] = F_123 ( V_32 ) ;
for ( V_32 = 0 ; V_32 < F_125 ( V_71 ) ; V_32 ++ ) {
for ( V_119 = V_32 ; V_119 > 0 ; V_119 -- )
V_71 [ V_32 ] += V_118 [ V_119 - 1 ] + 1 ;
}
}
static int F_126 ( unsigned int V_120 )
{
struct V_47 * V_48 ;
struct V_1 * V_5 ;
V_48 = & F_127 ( V_52 , V_120 ) ;
while ( V_48 -> V_53 ) {
V_5 = V_48 -> V_54 ;
V_48 -> V_54 = V_5 -> V_4 ;
F_49 ( V_49 , V_5 ) ;
...
F_117 ( F_127 ( V_41 , V_120 ) ) ;
F_127 ( V_41 , V_120 ) = NULL ;
return 0 ;
}
void T_5 F_128 ( void )
{
