...
V_124 . V_180 = V_3 -> V_136 [ V_124 . V_56 ] . V_180 ;
V_129 = F_43 ( V_97 , & V_124 , sizeof( V_124 ) ) ?
- V_91 : 0 ;
break;
default:
if ( F_59 ( V_96 ) != 'H' || F_60 ( V_96 ) != V_181 )
break;
...
int V_119 = strlen ( V_3 -> V_183 ) + 1 ;
if ( V_119 > F_63 ( V_96 ) )
V_119 = F_63 ( V_96 ) ;
V_129 = F_43 ( V_97 , V_3 -> V_183 , V_119 ) ?
- V_91 : V_119 ;
break;
}
}
...
static char * F_67 ( struct V_184 * V_117 , T_8 * V_185 )
{
return F_68 ( V_100 , L_1 , F_69 ( V_117 ) ) ;
}
int F_70 ( struct V_2 * V_3 , unsigned int V_186 )
{
struct V_36 * V_36 ;
struct V_139 * V_140 = V_3 -> V_141 ;
int V_79 ;
...
V_36 -> V_162 = V_3 -> V_188 & V_189 ;
V_36 -> V_190 = V_140 -> V_67 -> V_190 ;
return 0 ;
}
