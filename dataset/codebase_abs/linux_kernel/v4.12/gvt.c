...
void F_29 ( struct V_41 * V_20 )
{
struct V_13 * V_14 = F_30 ( V_20 ) ;
if ( F_31 ( ! V_14 ) )
return;
F_21 ( V_14 ) ;
F_32 ( V_14 ) ;
...
if ( F_31 ( V_20 -> V_14 ) )
return - V_47 ;
V_14 = F_46 ( sizeof( struct V_13 ) , V_48 ) ;
if ( ! V_14 )
return - V_49 ;
F_7 ( L_8 ) ;
F_47 ( & V_14 -> V_43 ) ;
...
if ( V_34 )
goto V_59;
V_34 = F_58 ( & V_20 -> V_21 . V_19 -> V_42 , V_14 ,
& V_60 ) ;
if ( V_34 ) {
F_27 ( L_9 , V_34 ) ;
goto V_61;
