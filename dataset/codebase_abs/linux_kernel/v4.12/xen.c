...
F_24 ( & V_2 -> V_2 , L_15 , V_36 ) ;
free:
F_23 ( V_40 ) ;
return V_36 ;
}
static void F_25 ( struct V_1 * V_46 , unsigned int V_5 ,
struct V_47 * V_48 )
{
V_48 -> V_49 = V_50 | F_26 ( V_5 ) ;
V_48 -> V_51 =
V_52 |
V_53 |
V_54 |
...
error:
F_24 ( & V_2 -> V_2 , L_20 ,
type == V_41 ? L_21 : L_22 , V_8 ) ;
return V_8 ;
}
static int F_32 ( struct V_1 * V_2 , int V_35 , int type )
{
int V_36 = 0 ;
struct V_38 * V_39 ;
F_21 (msidesc, dev) {
...
if ( ! V_65 || ( V_65 & V_71 ) )
return - V_72 ;
V_13 . V_73 = F_37 ( V_2 , V_67 ) ;
V_13 . V_63 = V_39 -> V_74 . V_63 ;
}
V_36 = - V_72 ;
if ( V_75 )
V_36 = F_9 ( V_20 ,
...
if ( V_75 ) {
struct V_77 V_78 ;
V_78 . V_79 = F_34 ( V_2 -> V_59 ) ;
V_78 . V_59 = V_2 -> V_59 -> V_60 ;
V_78 . V_61 = V_2 -> V_61 ;
V_36 = F_9 ( V_80 ,
& V_78 ) ;
if ( V_36 == - V_45 )
V_75 = false ;
F_39 ( V_36 && V_36 != - V_45 , L_24 , V_36 ) ;
}
if ( ! V_75 ) {
struct V_81 V_82 ;
V_82 . V_59 = V_2 -> V_59 -> V_60 ;
V_82 . V_61 = V_2 -> V_61 ;
V_36 = F_9 ( V_83 , & V_82 ) ;
F_39 ( V_36 && V_36 != - V_45 , L_25 , V_36 ) ;
}
}
...
static void F_45 ( unsigned int V_8 )
{
F_46 ( V_8 ) ;
}
int T_4 F_47 ( void )
...
static struct V_109 * F_60 ( struct V_1 * V_2 )
{
struct V_109 * V_110 ;
F_61 (owner, &dev_domain_list, list) {
if ( V_110 -> V_2 == V_2 )
return V_110 ;
}
return NULL ;
...
int F_64 ( struct V_1 * V_2 , T_6 V_111 )
{
struct V_109 * V_110 ;
V_110 = F_17 ( sizeof( struct V_109 ) , V_42 ) ;
if ( ! V_110 )
return - V_57 ;
F_62 ( & V_112 ) ;
if ( F_60 ( V_2 ) ) {
