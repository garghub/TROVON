...
F_16 ( V_51 ) ;
F_17 ( V_51 ) -> type = V_55 ;
F_18 ( V_1 -> V_52 , NULL , V_51 , 0 ) ;
V_10 = F_19 ( V_51 ) -> V_56 ? - V_57 : 0 ;
F_20 ( V_51 ) ;
return V_10 ;
}
if ( F_21 ( args , ( void V_20 * ) V_5 , 4 ) )
return - V_36 ;
...
static int F_25 ( T_1 * V_1 , unsigned long V_5 )
{
...
F_17 ( V_51 ) -> type = V_87 ;
F_19 ( V_51 ) -> V_88 = 1 ;
F_19 ( V_51 ) -> V_4 [ 0 ] = V_89 ;
F_18 ( V_1 -> V_52 , NULL , V_51 , 1 ) ;
V_86 = F_19 ( V_51 ) -> V_56 ;
F_20 ( V_51 ) ;
return V_86 ;
}
