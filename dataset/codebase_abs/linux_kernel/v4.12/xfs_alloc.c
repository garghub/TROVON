...
struct V_298 V_299 ;
V_299 . V_15 = F_22 ( V_21 -> V_22 . V_15 ) ;
V_299 . V_16 = F_22 ( V_21 -> V_22 . V_16 ) ;
return V_297 -> V_300 ( V_9 , & V_299 , V_297 -> V_295 ) ;
}
int
F_163 (
struct V_8 * V_9 ,
...
union V_303 V_305 ;
struct V_296 V_297 ;
ASSERT ( V_9 -> V_306 == V_131 ) ;
V_304 . V_14 = * V_301 ;
V_305 . V_14 = * V_302 ;
V_297 . V_295 = V_295 ;
V_297 . V_300 = V_300 ;
return F_164 ( V_9 , & V_304 , & V_305 ,
F_162 , & V_297 ) ;
}
int
F_165 (
