...
if ( V_39 < 0 )
return V_39 ;
V_39 = F_20 ( V_32 -> V_2 , & V_35 -> V_56 , V_55 ) ;
if ( V_39 < 0 )
return V_39 ;
return 0 ;
}
...
struct V_61 * V_62 = F_23 ( V_35 , V_59 ) ;
struct V_36 * V_37 = F_10 ( V_35 , V_59 ) ;
struct V_63 * V_40 = & V_37 -> V_40 ;
struct V_63 * V_42 = & V_37 -> V_42 ;
...
if ( ! V_53 || ! V_52 ) {
V_39 = - V_66 ;
F_25 ( V_8 , L_11 , V_67 , V_11 ) ;
goto V_68;
}
V_39 = F_26 ( V_8 , V_58 , V_52 ,
V_6 , & V_62 -> V_69 ) ;
if ( V_39 < 0 )
goto V_68;
F_27 ( V_58 , L_12 , & V_37 -> V_47 ) ;
V_39 = F_28 ( V_53 , V_62 ,
V_70 , V_71 , & V_65 ) ;
if ( V_39 < 0 )
goto V_68;
V_39 = F_29 ( V_52 , V_62 , V_70 , V_71 ) ;
if ( V_39 < 0 )
goto V_68;
V_39 = F_30 ( V_64 , V_62 , V_70 , V_71 ) ;
if ( V_39 < 0 )
goto V_68;
V_39 = F_31 ( V_53 , & V_40 -> V_72 ,
& V_40 -> V_73 ,
& V_40 -> V_74 ,
& V_40 -> V_75 ) ;
if ( V_39 < 0 )
goto V_68;
V_39 = F_31 ( V_52 , & V_42 -> V_72 ,
& V_42 -> V_73 ,
& V_42 -> V_74 ,
& V_42 -> V_75 ) ;
if ( V_39 < 0 )
goto V_68;
V_39 = F_32 ( V_8 , V_53 , V_62 , V_40 ) ;
if ( V_39 < 0 )
goto V_68;
V_39 = F_33 ( V_8 , V_52 , V_62 , V_42 ) ;
if ( V_39 < 0 )
goto V_68;
V_39 = F_34 ( V_62 ) ;
if ( V_39 < 0 )
...
V_62 -> V_78 = & V_79 ;
V_62 -> V_80 = F_17 ;
F_36 ( V_8 , L_14 , V_62 -> V_81 ) ;
F_36 ( V_8 , L_15 , V_62 -> V_69 ) ;
F_36 ( V_8 , L_16 ,
V_62 -> V_76 ,
V_37 -> V_40 . V_82 ) ;
F_36 ( V_8 , L_17 ,
...
int V_84 , V_85 , V_86 ;
if ( ! F_41 ( V_58 , V_55 L_18 , & V_86 ) )
return 0 ;
V_85 = V_86 / sizeof( V_87 ) ;
if ( V_85 <= 0 )
return - V_66 ;
V_2 -> V_88 = F_42 ( V_8 ,
V_85 * sizeof( * V_2 -> V_88 ) , V_89 ) ;
if ( ! V_2 -> V_88 )
return - V_90 ;
for ( V_84 = 0 ; V_84 < V_85 ; V_84 ++ ) {
V_83 = F_43 ( V_58 , V_55 L_18 , V_84 ) ;
if ( ! V_83 )
return - V_66 ;
V_2 -> V_88 [ V_84 ] . V_91 = V_83 ;
}
V_2 -> V_92 = V_85 ;
return 0 ;
}
...
if ( ! V_58 )
return - V_66 ;
V_62 = F_24 ( V_58 , V_55 L_19 ) ;
if ( F_45 ( V_58 , V_55 L_20 ) ) {
V_39 = F_46 ( V_2 ,
V_55 L_20 ) ;
if ( V_39 )
goto V_93;
}
if ( F_45 ( V_58 , V_55 L_21 ) ) {
V_39 = F_47 ( V_2 ,
V_55 L_21 ) ;
if ( V_39 )
goto V_93;
}
F_27 ( V_58 , V_55 L_12 , & V_35 -> V_47 ) ;
if ( V_62 ) {
struct V_57 * V_94 = NULL ;
int V_84 = 0 ;
F_48 (node, np) {
F_36 ( V_8 , L_22 , V_84 ) ;
V_39 = F_21 ( V_94 , V_35 ,
...
V_38 = 1 ;
V_35 = F_42 ( V_8 , sizeof( * V_35 ) , V_89 ) ;
if ( ! V_35 )
return - V_90 ;
V_37 = F_42 ( V_8 , sizeof( * V_37 ) * V_38 , V_89 ) ;
V_62 = F_42 ( V_8 , sizeof( * V_62 ) * V_38 , V_89 ) ;
if ( ! V_37 || ! V_62 )
return - V_90 ;
V_35 -> V_37 = V_37 ;
V_35 -> V_62 = V_62 ;
...
V_2 -> V_23 = ( V_101 -> V_2 ) ? V_101 -> V_2 : V_101 -> V_23 ;
V_62 -> V_23 = V_101 -> V_23 ;
V_62 -> V_81 = V_101 -> V_23 ;
V_62 -> V_104 = V_101 -> V_103 ;
V_62 -> V_105 = V_101 -> V_52 ;
V_62 -> V_76 = V_101 -> V_40 . V_23 ;
V_62 -> V_77 = V_101 -> V_42 . V_23 ;
V_62 -> V_69 = V_101 -> V_106 ;
V_62 -> V_80 = F_17 ;
