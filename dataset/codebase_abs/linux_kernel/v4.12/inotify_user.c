...
L_7
L_8 , V_31 , V_69 ,
V_69 -> V_36 , V_69 -> V_72 . V_16 , V_76 ,
V_76 -> V_36 , V_76 -> V_72 . V_16 ) ;
goto V_77;
}
if ( F_50 ( F_46 ( & V_69 -> V_72 . V_75 ) < 2 ) ) {
F_51 ( V_78 L_5 ,
V_31 , V_69 , V_69 -> V_36 , V_69 -> V_72 . V_16 ) ;
F_52 () ;
}
...
void F_55 ( struct V_74 * V_72 ,
struct V_15 * V_16 )
{
struct V_68 * V_69 ;
F_56 ( V_16 , NULL , V_72 , NULL , V_3 ,
NULL , V_79 , NULL , 0 , NULL ) ;
V_69 = F_57 ( V_72 , struct V_68 , V_72 ) ;
F_48 ( V_16 , V_69 ) ;
F_58 ( V_16 -> V_73 . V_80 ) ;
}
...
if ( V_18 )
goto V_94;
if ( ! F_65 ( V_16 -> V_73 . V_80 ) ) {
F_48 ( V_16 , V_91 ) ;
V_18 = - V_95 ;
goto V_94;
}
V_18 = F_66 ( & V_91 -> V_72 , V_52 , NULL , 0 ) ;
if ( V_18 ) {
F_48 ( V_16 , V_91 ) ;
goto V_94;
}
...
static int F_67 ( struct V_15 * V_16 , struct V_52 * V_52 , T_2 V_1 )
{
int V_18 = 0 ;
F_68 ( & V_16 -> V_96 ) ;
V_18 = F_59 ( V_16 , V_52 , V_1 ) ;
if ( V_18 == - V_86 )
V_18 = F_62 ( V_16 , V_52 , V_1 ) ;
F_69 ( & V_16 -> V_96 ) ;
return V_18 ;
}
static struct V_15 * F_70 ( unsigned int V_97 )
{
struct V_15 * V_16 ;
struct V_25 * V_98 ;
V_16 = F_71 ( & V_99 ) ;
if ( F_23 ( V_16 ) )
return V_16 ;
V_98 = F_72 ( sizeof( struct V_25 ) , V_70 ) ;
if ( F_50 ( ! V_98 ) ) {
F_29 ( V_16 ) ;
return F_14 ( - V_93 ) ;
}
V_16 -> V_100 = & V_98 -> V_101 ;
F_73 ( V_16 -> V_100 , NULL , V_102 ) ;
V_98 -> V_36 = - 1 ;
V_98 -> V_38 = 0 ;
V_98 -> V_27 = 0 ;
V_16 -> V_97 = V_97 ;
...
F_80 ( V_7 != V_131 ) ;
F_45 ( F_81 ( V_132 ) != 21 ) ;
V_92 = F_82 ( V_68 , V_133 ) ;
V_134 = 16384 ;
V_135 . V_136 [ V_103 ] = 128 ;
V_135 . V_136 [ V_137 ] = 8192 ;
return 0 ;
}
