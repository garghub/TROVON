...
F_2 ( V_28 L_13 , V_2 -> V_8 ,
V_26 . V_27 ) ;
}
void F_9 ( struct V_1 * V_2 )
{
static T_1 V_29 [ 256 ] ;
if ( V_2 -> V_30 [ 0 ] . V_31 == 0 ) {
if ( F_10 ( V_2 , & V_29 [ 0 ] ,
sizeof( V_29 ) ) < 0 )
return;
}
...
int F_11 ( struct V_32 * V_33 , int V_34 )
{
struct V_1 * V_2 = V_33 -> V_2 ;
struct V_35 * V_36 ;
int V_3 ;
for ( V_3 = 0 ; V_3 < V_37 ; V_3 ++ ) {
V_36 = & V_10 [ V_2 -> V_11 ] . V_36 [ V_3 ] ;
if ( V_36 -> type == V_38 )
continue;
if ( ( V_33 -> V_39 == V_36 -> V_40 ) &&
( V_34 == V_36 -> V_41 ) )
return V_36 -> V_42 ;
}
return - 1 ;
}
int F_12 ( struct V_32 * V_33 , int V_34 )
{
struct V_1 * V_2 = V_33 -> V_2 ;
struct V_35 * V_36 ;
int V_3 ;
...
char * F_13 ( struct V_1 * V_2 , T_1 V_44 )
{
char * V_45 = L_14 ;
char * V_46 = L_15 ;
struct V_35 * V_36 ;
