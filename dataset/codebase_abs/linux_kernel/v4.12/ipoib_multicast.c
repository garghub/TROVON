...
void F_87 ( struct V_15 * V_16 , T_2 * V_124 , struct V_68 * V_69 )
{
struct V_1 * V_2 = F_7 ( V_16 ) ;
struct V_41 * V_42 = F_26 ( V_16 ) ;
struct V_3 * V_4 ;
...
if ( F_88 ( & V_4 -> V_22 ) < V_127 ) {
F_89 ( V_69 , sizeof( struct V_128 ) ) ;
F_90 ( & V_4 -> V_22 , V_69 ) ;
} else {
++ V_16 -> V_23 . V_17 ;
F_11 ( V_69 ) ;
...
struct V_129 * V_130 ;
F_75 ( & V_2 -> V_48 , V_7 ) ;
V_130 = F_91 ( V_16 , V_124 ) ;
F_74 ( & V_2 -> V_48 , V_7 ) ;
if ( ! V_130 ) {
V_130 = F_92 ( V_124 , V_16 ) ;
if ( V_130 ) {
F_93 ( & V_4 -> V_21 -> V_131 ) ;
V_130 -> V_21 = V_4 -> V_21 ;
...
static int F_98 ( const T_2 * V_135 , const T_2 * V_47 )
{
if ( memcmp ( V_135 , V_47 , 6 ) )
return 0 ;
if ( memcmp ( V_135 + 7 , V_47 + 7 , 3 ) )
return 0 ;
return 1 ;
}
...
! F_104 ( V_2 -> V_64 , V_2 -> V_66 , & V_19 , & V_86 ) ) {
F_6 ( V_2 , L_30 ,
V_19 . V_20 ) ;
continue;
}
...
F_63 ( V_139 , & V_140 -> V_7 ) ;
V_140 -> V_18 . V_19 = V_19 ;
if ( V_4 ) {
F_105 ( & V_4 -> V_28 , & V_123 ) ;
F_106 ( & V_4 -> V_30 ,
& V_140 -> V_30 ,
& V_2 -> V_32 ) ;
} else
F_22 ( V_16 , V_140 ) ;
F_84 ( & V_140 -> V_28 , & V_2 -> V_126 ) ;
}
if ( V_4 )
F_63 ( V_139 , & V_4 -> V_7 ) ;
}
...
struct V_142 * F_110 ( struct V_15 * V_16 )
{
struct V_142 * V_143 ;
V_143 = F_111 ( sizeof *V_143 , V_25 ) ;
if ( ! V_143 )
return NULL ;
V_143 -> V_16 = V_16 ;
...
V_143 -> V_27 = V_4 -> V_27 ;
V_143 -> V_144 = F_88 ( & V_4 -> V_22 ) ;
V_143 -> F_60 = ! ! V_4 -> V_21 ;
V_143 -> V_145 = ! ! ( V_4 -> V_7 & ( 1 << V_61 ) ) ;
V_33 = 0 ;
break;
}
V_31 = F_114 ( V_31 ) ;
