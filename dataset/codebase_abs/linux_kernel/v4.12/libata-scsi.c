...
static unsigned int F_184 ( struct V_151 * V_152 )
{
struct V_74 * V_75 = & V_152 -> V_75 ;
struct V_63 * V_162 = V_152 -> V_155 ;
...
static unsigned int F_186 ( struct V_314 * args , T_3 * V_315 )
{
struct V_12 * V_13 = args -> V_13 ;
...
static void F_187 ( struct V_151 * V_152 )
{
struct V_63 * V_162 = V_152 -> V_155 ;
struct V_471 V_472 ;
unsigned long V_16 ;
unsigned int V_473 = 0 ;
F_188 ( & V_472 , F_61 ( V_162 ) , F_62 ( V_162 ) ,
V_474 | V_475 ) ;
F_189 ( V_16 ) ;
while ( F_190 ( & V_472 ) ) {
...
V_480 = F_192 ( & V_318 [ 4 ] ) ;
V_478 = F_193 ( & V_318 [ 8 ] ) ;
V_479 = F_193 ( & V_318 [ 16 ] ) ;
F_142 ( V_477 , & V_318 [ 0 ] ) ;
V_318 [ 4 ] = V_480 & 0xf ;
F_141 ( V_478 , & V_318 [ 8 ] ) ;
F_141 ( V_479 , & V_318 [ 16 ] ) ;
V_476 += 64 ;
V_473 += 64 ;
}
...
V_486 = ( V_483 [ 1 ] & 1 ) ;
V_445 = F_193 ( & V_483 [ 8 ] ) ;
V_487 = F_193 ( & V_483 [ 16 ] ) ;
V_488 = F_193 ( & V_483 [ 24 ] ) ;
V_483 [ 0 ] = type ;
V_483 [ 1 ] = ( V_484 << 4 ) | V_485 | V_486 ;
F_141 ( V_445 , & V_483 [ 8 ] ) ;
F_141 ( V_487 , & V_483 [ 16 ] ) ;
F_141 ( V_488 , & V_483 [ 24 ] ) ;
F_182 ( V_476 + 64 > V_472 . V_482 ) ;
V_476 += 64 ;
V_473 += 64 ;
}
}
...
static unsigned int F_196 ( struct V_151 * V_152 )
{
struct V_74 * V_75 = & V_152 -> V_75 ;
struct V_63 * V_162 = V_152 -> V_155 ;
const T_3 * V_240 = V_162 -> V_241 ;
T_5 V_276 , V_242 = ( T_5 ) - 1 ;
T_3 V_489 , V_490 , V_243 = 0xff ;
T_4 V_212 ;
T_8 V_269 ;
if ( F_20 ( V_162 -> V_244 < 16 ) ) {
...
V_75 -> V_248 = V_398 ;
V_75 -> V_167 = V_492 ;
V_75 -> V_208 = V_493 & 0x1f ;
V_75 -> V_203 = V_152 -> V_154 << 3 ;
V_75 -> V_169 = V_276 & 0xff ;
V_75 -> V_401 = ( V_276 >> 8 ) & 0xff ;
V_75 -> V_451 = V_494 | ( V_490 << 8 ) ;
} else {
V_75 -> V_167 = V_495 ;
V_75 -> V_169 = V_494 ;
V_75 -> V_248 = V_396 ;
...
static unsigned int F_198 ( struct V_151 * V_152 )
{
struct V_74 * V_75 = & V_152 -> V_75 ;
struct V_63 * V_162 = V_152 -> V_155 ;
struct V_12 * V_13 = V_152 -> V_13 ;
...
static int F_200 ( struct V_151 * V_152 ,
...
V_506 = V_4 [ 0 ] & ( 1 << 2 ) ;
F_149 ( V_13 -> V_107 , V_504 , false ) ;
for ( V_188 = 0 ; V_188 < V_505 - 2 ; V_188 ++ ) {
if ( V_188 == 0 )
continue;
if ( V_504 [ V_188 + 2 ] != V_4 [ V_188 ] ) {
* V_242 = V_188 ;
return - V_20 ;
}
}
...
V_75 -> V_203 = 0 ;
V_75 -> V_167 = V_437 ;
V_75 -> V_169 = V_506 ? V_507 : V_508 ;
return 0 ;
}
static int F_201 ( struct V_151 * V_152 ,
const T_3 * V_4 , int V_45 , T_5 * V_242 )
{
struct V_12 * V_13 = V_152 -> V_13 ;
T_3 V_504 [ V_509 ] ;
...
V_68 = V_4 [ 0 ] & ( 1 << 2 ) ;
F_152 ( V_13 , V_504 , false ) ;
for ( V_188 = 0 ; V_188 < V_509 - 2 ; V_188 ++ ) {
if ( V_188 == 0 )
continue;
if ( V_504 [ 2 + V_188 ] != V_4 [ V_188 ] ) {
* V_242 = V_188 ;
return - V_20 ;
}
}
...
static unsigned int F_202 ( struct V_151 * V_152 )
{
struct V_63 * V_162 = V_152 -> V_155 ;
const T_3 * V_240 = V_162 -> V_241 ;
const T_3 * V_350 ;
T_3 V_352 , V_353 ;
unsigned V_356 , V_510 , V_511 , V_512 ;
int V_45 ;
T_5 V_242 = ( T_5 ) - 1 ;
T_3 V_243 = 0xff ;
F_106 ( L_32 ) ;
...
if ( ! F_62 ( V_162 ) || F_61 ( V_162 ) -> V_482 < V_45 )
goto V_448;
V_350 = F_203 ( F_204 ( F_61 ( V_162 ) ) ) ;
if ( V_45 < V_511 )
goto V_448;
if ( V_356 )
V_512 = V_350 [ 3 ] ;
else
V_512 = ( V_350 [ 6 ] << 8 ) + V_350 [ 7 ] ;
V_45 -= V_511 ;
V_350 += V_511 ;
if ( V_45 < V_512 )
goto V_448;
...
switch ( V_352 ) {
case V_362 :
if ( F_200 ( V_152 , V_350 , V_510 , & V_242 ) < 0 ) {
V_242 += V_511 + V_512 ;
goto V_513;
}
break;
case V_363 :
if ( F_201 ( V_152 , V_350 , V_510 , & V_242 ) < 0 ) {
V_242 += V_511 + V_512 ;
goto V_513;
} else {
goto V_257;
...
static inline T_9 F_205 ( struct V_12 * V_13 , T_3 V_64 )
{
switch ( V_64 ) {
case V_289 :
case V_287 :
...
static inline void F_207 ( struct V_8 * V_9 ,
struct V_63 * V_64 )
{
#ifdef F_208
...
static inline int F_209 ( struct V_63 * V_162 ,
struct V_12 * V_13 )
{
T_3 V_515 = V_162 -> V_241 [ 0 ] ;
T_9 V_295 ;
int V_33 = 0 ;
if ( V_13 -> V_49 == V_50 || V_13 -> V_49 == V_51 ) {
if ( F_20 ( ! V_162 -> V_244 || V_162 -> V_244 > V_13 -> V_377 ) )
goto V_516;
V_295 = F_205 ( V_13 , V_515 ) ;
} else {
if ( F_20 ( ! V_162 -> V_244 ) )
goto V_516;
V_295 = NULL ;
if ( F_75 ( ( V_515 != V_133 ) || ! V_517 ) ) {
int V_45 = F_210 ( V_515 ) ;
...
V_516:
F_112 ( L_56 ,
V_162 -> V_244 , V_515 , V_13 -> V_377 ) ;
V_162 -> V_70 = V_305 << 16 ;
V_162 -> V_157 ( V_162 ) ;
return 0 ;
}
int F_212 ( struct V_6 * V_7 , struct V_63 * V_64 )
{
struct V_8 * V_9 ;
struct V_12 * V_13 ;
struct V_28 * V_116 = V_64 -> V_1 ;
...
void F_211 ( struct V_12 * V_13 , struct V_63 * V_64 )
{
struct V_314 args ;
...
int F_214 ( struct V_523 * V_34 , struct V_524 * V_525 )
{
int V_188 , V_33 ;
for ( V_188 = 0 ; V_188 < V_34 -> V_526 ; V_188 ++ ) {
struct V_8 * V_9 = V_34 -> V_527 [ V_188 ] ;
struct V_6 * V_7 ;
V_33 = - V_128 ;
V_7 = F_215 ( V_525 , sizeof( struct V_8 * ) ) ;
if ( ! V_7 )
goto V_528;
V_7 -> V_529 = 1 ;
* (struct V_8 * * ) & V_7 -> V_530 [ 0 ] = V_9 ;
V_9 -> V_531 = V_7 ;
V_7 -> V_532 = V_533 ;
V_7 -> V_534 = V_9 -> V_202 ;
V_7 -> V_535 = 16 ;
...
V_7 -> V_538 = 16 ;
V_7 -> V_539 = 1 ;
V_33 = F_216 ( V_9 -> V_531 ,
& V_9 -> V_540 , V_9 -> V_34 -> V_13 ) ;
if ( V_33 )
goto V_541;
}
return 0 ;
V_541:
F_217 ( V_34 -> V_527 [ V_188 ] -> V_531 ) ;
V_528:
while ( -- V_188 >= 0 ) {
struct V_6 * V_7 = V_34 -> V_527 [ V_188 ] -> V_531 ;
F_218 ( V_7 ) ;
F_217 ( V_7 ) ;
}
return V_33 ;
}
void F_219 ( struct V_8 * V_9 , int V_542 )
{
int V_543 = 5 ;
struct V_12 * V_544 = NULL ;
struct V_10 * V_11 ;
struct V_12 * V_13 ;
V_545:
F_6 (link, ap, EDGE) {
...
V_393 = V_11 -> V_546 ;
V_29 = F_221 ( V_9 -> V_531 , V_393 , V_107 , 0 ,
NULL ) ;
if ( ! F_222 ( V_29 ) ) {
V_13 -> V_29 = V_29 ;
F_223 ( V_29 ) ;
...
F_226 ( V_548 , & V_9 -> V_549 ,
F_227 ( V_135 ) ) ;
}
int F_228 ( struct V_12 * V_13 )
{
if ( V_13 -> V_29 ) {
F_229 ( V_13 -> V_29 , V_550 ) ;
return 1 ;
}
return 0 ;
}
static void F_230 ( struct V_12 * V_13 )
{
struct V_8 * V_9 = V_13 -> V_11 -> V_9 ;
struct V_28 * V_29 ;
unsigned long V_16 ;
F_231 ( & V_9 -> V_531 -> V_551 ) ;
F_5 ( V_9 -> V_21 , V_16 ) ;
V_29 = V_13 -> V_29 ;
V_13 -> V_29 = NULL ;
if ( V_29 ) {
...
void F_239 ( struct V_12 * V_13 )
{
if ( V_13 -> V_29 )
F_240 ( V_13 -> V_29 , V_229 ,
V_554 ) ;
}
void F_241 ( struct V_555 * V_556 )
{
struct V_8 * V_9 =
F_242 ( V_556 , struct V_8 , V_549 . V_556 ) ;
int V_188 ;
if ( V_9 -> V_39 & V_557 ) {
F_112 ( L_59 ) ;
return;
...
F_236 ( & V_9 -> V_11 ) ;
if ( V_9 -> V_392 )
for ( V_188 = 0 ; V_188 < V_560 ; V_188 ++ )
F_236 ( & V_9 -> V_392 [ V_188 ] ) ;
F_219 ( V_9 , 0 ) ;
F_233 ( & V_9 -> V_559 ) ;
F_112 ( L_34 ) ;
}
int F_244 ( struct V_6 * V_7 , unsigned int V_393 ,
...
if ( ! V_9 -> V_82 -> V_200 )
return - V_24 ;
if ( V_394 != V_561 && V_394 )
return - V_20 ;
if ( ! F_175 ( V_9 ) ) {
if ( V_393 != V_561 && V_393 )
return - V_20 ;
V_43 = V_107 ;
} else {
if ( V_107 != V_561 && V_107 )
return - V_20 ;
V_43 = V_393 ;
}
F_5 ( V_9 -> V_21 , V_16 ) ;
...
if ( V_13 ) {
struct V_562 * V_563 = & V_13 -> V_11 -> V_52 ;
V_563 -> V_564 |= 1 << V_13 -> V_43 ;
V_563 -> V_58 |= V_103 ;
} else
V_33 = - V_20 ;
}
...
void F_245 ( struct V_555 * V_556 )
{
struct V_8 * V_9 =
F_242 ( V_556 , struct V_8 , V_566 ) ;
struct V_10 * V_11 ;
struct V_12 * V_13 ;
unsigned long V_16 ;
F_231 ( & V_9 -> V_559 ) ;
...
struct V_8 * F_247 ( struct V_523 * V_34 ,
struct V_567 * V_568 ,
struct V_6 * V_7 )
{
struct V_8 * V_9 ;
...
V_9 -> V_569 = 0 ;
V_9 -> V_21 = & V_34 -> V_21 ;
V_9 -> V_570 = V_568 -> V_570 ;
V_9 -> V_571 = V_568 -> V_571 ;
V_9 -> V_572 = V_568 -> V_572 ;
V_9 -> V_16 |= V_568 -> V_16 ;
V_9 -> V_82 = V_568 -> V_573 ;
V_9 -> V_574 = V_575 ;
return V_9 ;
}
...
int F_253 ( struct V_8 * V_9 )
{
return F_254 ( V_9 ) ;
}
int F_255 ( struct V_8 * V_9 )
{
int V_33 = V_9 -> V_82 -> V_577 ( V_9 ) ;
if ( V_33 )
return V_33 ;
V_9 -> V_202 = F_256 ( & V_578 ) ;
return 0 ;
}
...
int F_258 ( struct V_28 * V_29 , struct V_8 * V_9 )
{
F_73 ( V_29 ) ;
F_82 ( V_29 , V_9 -> V_11 . V_1 ) ;
return 0 ;
}
int F_259 ( struct V_63 * V_64 , struct V_8 * V_9 )
{
int V_33 = 0 ;
F_207 ( V_9 , V_64 ) ;
if ( F_75 ( F_99 ( V_9 -> V_11 . V_1 ) ) )
V_33 = F_209 ( V_64 , V_9 -> V_11 . V_1 ) ;
else {
V_64 -> V_70 = ( V_519 << 16 ) ;
V_64 -> V_157 ( V_64 ) ;
}
...
{
unsigned int V_580 = V_9 -> V_34 -> V_581 ;
unsigned int V_188 , V_154 ;
for ( V_188 = 0 , V_154 = V_9 -> V_582 + 1 ; V_188 < V_580 ; V_188 ++ , V_154 ++ ) {
V_154 = V_154 < V_580 ? V_154 : 0 ;
if ( V_154 == V_583 )
continue;
if ( ! F_261 ( V_154 , & V_9 -> V_584 ) ) {
V_9 -> V_582 = V_154 ;
return V_154 ;
}
}
...
void F_262 ( unsigned int V_154 , struct V_8 * V_9 )
{
F_263 ( V_154 , & V_9 -> V_584 ) ;
}
