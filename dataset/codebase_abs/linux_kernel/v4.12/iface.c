...
T_3 V_128 ;
V_4 -> V_7 . V_69 = type ;
F_52 ( & V_128 , sizeof( V_128 ) ) ;
F_53 ( & V_7 -> V_129 , V_128 ) ;
F_52 ( & V_128 , sizeof( V_128 ) ) ;
F_53 ( & V_7 -> V_108 , V_128 ) ;
V_7 -> V_58 = 3 ;
V_7 -> V_59 = 5 ;
V_7 -> V_60 = 4 ;
V_7 -> V_62 = 3 ;
...
struct V_1 *
F_57 ( struct V_47 * V_48 , const char * V_142 ,
unsigned char V_143 , enum V_68 type ,
T_2 V_16 )
{
...
int V_49 = - V_145 ;
F_22 () ;
V_144 = F_58 ( sizeof( * V_4 ) , V_142 ,
V_143 , F_50 ) ;
if ( ! V_144 )
return F_59 ( - V_145 ) ;
V_144 -> V_146 = V_48 -> V_50 . V_147 +
V_148 ;
V_49 = F_60 ( V_144 , V_144 -> V_142 ) ;
if ( V_49 < 0 )
goto V_25;
F_47 ( V_144 -> V_149 ,
& V_48 -> V_50 . V_150 -> V_151 ) ;
switch ( type ) {
case V_71 :
V_144 -> type = V_152 ;
if ( F_12 ( V_16 ) )
F_47 ( V_144 -> V_45 , & V_16 ) ;
else
memcpy ( V_144 -> V_45 , V_144 -> V_149 ,
V_116 ) ;
break;
case V_140 :
V_144 -> type = V_153 ;
...
F_61 ( V_144 , & V_48 -> V_150 -> V_2 ) ;
F_62 ( V_144 , F_63 ( V_48 -> V_50 . V_150 ) ) ;
V_4 = F_64 ( V_144 ) ;
V_144 -> V_107 = & V_4 -> V_7 ;
memcpy ( V_4 -> V_142 , V_144 -> V_142 , V_154 ) ;
V_4 -> V_2 = V_144 ;
V_4 -> V_7 . V_155 = V_48 -> V_50 . V_150 ;
V_4 -> V_48 = V_48 ;
V_49 = F_51 ( V_4 , type ) ;
if ( V_49 )
goto V_25;
...
unsigned long V_65 , void * V_161 )
{
struct V_1 * V_2 = F_78 ( V_161 ) ;
struct V_3 * V_4 ;
if ( V_65 != V_162 )
return V_163 ;
if ( ! V_2 -> V_107 || ! V_2 -> V_107 -> V_155 )
return V_163 ;
if ( V_2 -> V_107 -> V_155 -> V_164 != V_165 )
return V_163 ;
V_4 = F_2 ( V_2 ) ;
memcpy ( V_4 -> V_142 , V_2 -> V_142 , V_154 ) ;
return V_166 ;
}
int F_79 ( void )
{
