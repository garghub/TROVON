...
struct V_23 * V_24 , * V_37 = F_29 ( V_38 , V_6 ) ;
struct V_41 * V_42 = F_34 ( & V_43 ) ;
struct V_21 * V_22 = F_43 ( V_42 ) ;
if ( V_2 -> V_10 . V_48 == V_50 )
return;
if ( ! V_37 )
return;
V_24 = F_11 ( V_22 -> V_26 [ V_6 ] ) ;
...
static int F_46 ( struct V_1 * V_2 , int V_51 )
{
int V_12 = 0 ;
...
static void F_47 ( struct V_1 * V_2 , int V_51 )
{
F_42 ( V_2 , V_52 ) ;
}
static int F_48 ( struct V_30 * V_4 )
{
bool V_59 = false , V_60 = false ;
int V_61 = 0 ;
struct V_62 * V_63 ;
F_49 (filter, filters, entry) {
if ( ++ V_61 > V_64 )
return - V_65 ;
if ( ( V_63 -> V_59 == 1 ) && V_60 )
return - V_65 ;
...
int F_52 ( struct V_23 * V_37 , bool V_81 )
{
char V_82 [ sizeof( L_1 ) ] ;
int V_12 = 0 , V_6 = F_38 ( V_37 ) -> F_53 ( V_37 ) ;
...
return - V_88 ;
if ( V_81 ) {
V_12 = F_54 ( & V_84 -> V_89 , & V_86 -> V_89 , V_82 ) ;
if ( V_12 )
return V_12 ;
F_29 ( V_38 , V_6 ) = V_37 ;
} else {
