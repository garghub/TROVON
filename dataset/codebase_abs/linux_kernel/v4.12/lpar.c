...
static unsigned long F_101 ( unsigned long V_73 , int V_30 )
{
unsigned long V_186 ;
...
if ( V_30 == V_194 ) {
V_189 = V_195 ;
V_190 = ( ( 1UL << ( V_187 - V_196 ) ) - 1 ) ;
} else {
V_189 = V_197 ;
V_190 = ( ( 1UL << ( V_187 - V_198 ) ) - 1 ) ;
}
if ( V_73 >= V_190 )
return 0 ;
V_191 = 0x7fffffffffffffffull / V_73 ;
if ( V_189 < V_191 )
return ( V_73 * V_189 ) % V_190 ;
V_192 = V_189 / V_191 ;
V_189 %= V_191 ;
V_186 = ( ( ( V_73 * V_191 ) % V_190 ) * V_192 ) % V_190 ;
V_186 = ( V_186 + V_73 * V_189 ) % V_190 ;
return V_186 ;
}
static int T_2 F_102 ( void )
{
unsigned long V_186 ;
V_186 = F_101 ( V_199 , V_200 ) ;
F_103 ( V_186 >> V_201 ) ;
return 0 ;
}
