...
struct V_6 * V_7 = V_19 -> V_9 ;
int V_12 = 0 ;
V_12 = F_34 ( V_7 , F_35 ( V_7 ) , V_26 ) ;
if ( V_12 < 0 )
return V_12 ;
return F_36 ( V_7 , V_26 ) ;
}
struct V_18 * F_37 ( struct V_27 * V_28 ,
...
struct V_6 * F_40 ( struct V_27 * V_28 ,
struct V_18 * V_18 )
{
struct V_2 * V_33 ;
struct V_6 * V_7 ;
