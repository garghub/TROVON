...
V_589 = F_42 ( sizeof( * V_589 ) , V_195 | V_196 ) ;
if ( ! V_589 ) {
F_46 ( V_168 , V_31 ) ;
F_3 ( V_7 , V_31 -> V_2 , L_1 ,
L_130 ) ;
...
V_256 -> V_258 = V_259 ;
V_256 -> V_260 = V_592 ;
V_256 -> V_593 = V_33 -> V_130 -> V_133 ;
V_256 -> V_594 = V_33 -> V_130 -> V_131 ;
V_45 = V_168 -> V_171 ;
V_45 -> V_54 = V_261 ;
V_45 -> V_42 = sizeof( struct V_255 ) ;
V_45 -> V_43 |= V_262 ;
...
V_45 ++ ;
V_45 -> V_54 = V_263 ;
V_45 -> V_42 = sizeof( struct V_588 ) ;
V_45 -> V_43 |= V_44 ;
V_45 -> V_56 = ( T_1 ) ( V_173 ) V_589 ;
V_168 -> V_182 = F_33 () ;
V_168 -> V_183 = V_184 ;
...
F_222 ( V_606 , L_11 , V_597 -> V_608 [ V_365 ] ) ;
F_223 ( V_606 , '\n' ) ;
F_222 ( V_606 , L_134 , V_597 -> V_603 ) ;
memcpy ( & V_607 , & V_597 -> V_609 , sizeof( V_607 ) - 1 ) ;
F_25 ( V_607 , sizeof( V_607 ) ) ;
F_222 ( V_606 , L_135 , V_607 ) ;
F_222 ( V_606 , L_136 , V_597 -> V_610 ) ;
F_222 ( V_606 , L_137 , ( unsigned long )
V_597 -> V_611 ) ;
}
F_47 ( V_595 ) ;
return 0 ;
...
V_45 = V_168 -> V_171 ;
V_45 -> V_54 = V_261 ;
V_45 -> V_56 = ( T_1 ) ( V_173 ) V_615 ;
V_45 -> V_43 = V_44 ;
V_45 -> V_42 = sizeof( struct V_614 ) ;
V_168 -> V_119 = V_31 ;
V_168 -> V_177 = V_31 ;
V_168 -> V_178 = NULL ;
V_168 -> V_181 = 256 ;
...
V_379:
return V_31 -> V_208 [ F_55 ( V_586 ) ] . V_201 ;
}
...
V_213 = 8 - F_227 ( V_620 -> V_627 ) ;
V_130 = ( char * ) & V_201 -> V_629 [ V_213 ] ;
if ( memcmp ( V_625 , V_130 , sizeof( * V_130 ) ) != 0 )
continue;
...
struct V_30 * V_31 ;
int V_34 ;
V_29 = F_69 ( V_237 , struct V_643 , V_245 ) ;
V_31 = V_29 -> V_31 ;
V_585 = F_42 ( sizeof( * V_585 ) , V_195 ) ;
if ( ! V_585 ) {
F_18 ( V_7 , V_31 , L_1 ,
L_143 ) ;
goto V_379;
