...
static struct V_23 * F_159 ( struct V_1 * V_2 , T_7 V_3 , int V_110 )
{
if ( F_3 ( V_3 & V_173 ) ) {
T_7 V_174 = V_3 & V_173 ;
V_3 &= ~ V_173 ;
...
static void F_161 ( struct V_1 * V_2 , struct V_23 * V_23 )
{
int V_16 = F_82 ( V_23 ) ;
int V_169 = 1 << V_16 ;
if ( V_2 -> V_3 & V_114 ) {
void * V_5 ;
F_81 ( V_2 , V_23 ) ;
F_162 (p, s, page_address(page),
page->objects)
F_83 ( V_2 , V_23 , V_5 , V_113 ) ;
}
F_163 ( V_23 , F_82 ( V_23 ) ) ;
F_157 ( F_158 ( V_23 ) ,
( V_2 -> V_3 & V_170 ) ?
V_171 : V_172 ,
- V_169 ) ;
...
static void F_168 ( struct V_179 * V_180 )
{
struct V_23 * V_23 ;
if ( V_181 )
V_23 = F_169 ( V_180 ) ;
else
V_23 = F_170 ( (struct V_182 * ) V_180 , struct V_23 , V_108 ) ;
F_161 ( V_23 -> V_116 , V_23 ) ;
}
static void F_171 ( struct V_1 * V_2 , struct V_23 * V_23 )
{
...
static void F_173 ( struct V_1 * V_2 , struct V_23 * V_23 )
{
F_100 ( V_2 , F_108 ( V_23 ) , V_23 -> V_30 ) ;
F_171 ( V_2 , V_23 ) ;
}
static inline void
F_174 ( struct V_106 * V_34 , struct V_23 * V_23 , int V_118 )
{
V_34 -> V_184 ++ ;
if ( V_118 == V_185 )
F_175 ( & V_23 -> V_108 , & V_34 -> V_186 ) ;
else
...
{
F_88 ( & V_34 -> V_107 ) ;
F_174 ( V_34 , V_23 , V_118 ) ;
}
static inline void F_177 ( struct V_106 * V_34 ,
struct V_23 * V_23 )
{
F_88 ( & V_34 -> V_107 ) ;
F_91 ( & V_23 -> V_108 ) ;
...
static void * F_180 ( struct V_1 * V_2 , struct V_106 * V_34 ,
...
return NULL ;
F_181 ( & V_34 -> V_107 ) ;
F_182 (page, page2, &n->partial, lru) {
void * V_68 ;
if ( ! F_183 ( V_23 , V_3 ) )
continue;
V_68 = F_178 ( V_2 , V_34 , V_23 , V_11 == NULL , & V_30 ) ;
if ( ! V_68 )
break;
V_192 += V_30 ;
if ( ! V_11 ) {
...
struct V_197 * V_198 ;
struct V_199 * V_199 ;
enum V_200 V_201 = F_188 ( V_3 ) ;
void * V_11 ;
unsigned int V_202 ;
if ( ! V_2 -> V_203 ||
F_189 () % 1024 > V_2 -> V_203 )
return NULL ;
do {
V_202 = F_190 () ;
V_196 = F_191 ( F_192 () , V_3 ) ;
F_193 (zone, z, zonelist, high_zoneidx) {
struct V_106 * V_34 ;
V_34 = F_93 ( V_2 , F_194 ( V_199 ) ) ;
if ( V_34 && F_195 ( V_199 , V_3 ) &&
V_34 -> V_184 > V_2 -> V_204 ) {
V_11 = F_180 ( V_2 , V_34 , V_190 , V_3 ) ;
if ( V_11 ) {
return V_11 ;
}
}
...
V_205 = F_200 ( V_110 ) ;
V_11 = F_180 ( V_2 , F_93 ( V_2 , V_205 ) , V_190 , V_3 ) ;
if ( V_11 || V_110 != V_143 )
return V_11 ;
return F_186 ( V_2 , V_3 , V_190 ) ;
}
static inline unsigned long F_201 ( unsigned long V_206 )
{
return V_206 + V_207 ;
}
static inline unsigned int F_202 ( unsigned long V_206 )
{
return V_206 % V_207 ;
}
static inline unsigned long F_203 ( unsigned long V_206 )
{
return V_206 / V_207 ;
}
...
{
#ifdef F_39
unsigned long V_208 = F_206 ( V_2 -> V_10 -> V_206 ) ;
...
#endif
if ( F_203 ( V_206 ) != F_203 ( V_208 ) )
F_160 ( L_54 ,
F_203 ( V_206 ) , F_203 ( V_208 ) ) ;
else
F_160 ( L_55 ,
V_208 , V_206 , F_201 ( V_206 ) ) ;
#endif
F_11 ( V_2 , V_209 ) ;
}
...
int V_60 ;
F_209 (cpu)
F_210 ( V_2 -> V_10 , V_60 ) -> V_206 = F_204 ( V_60 ) ;
}
...
while ( V_38 && ( V_217 = F_14 ( V_2 , V_38 ) ) ) {
void * V_221 ;
unsigned long V_27 ;
do {
V_221 = V_23 -> V_38 ;
...
static void F_184 ( struct V_1 * V_2 , struct V_23 * V_23 , int V_229 )
{
#ifdef F_6
struct V_23 * V_230 ;
int V_169 ;
...
V_23 -> V_231 = V_231 ;
V_23 -> V_154 = V_230 ;
} while ( F_216 ( V_2 -> V_10 -> V_186 , V_230 , V_23 )
!= V_230 );
if ( F_3 ( ! V_2 -> V_195 ) ) {
unsigned long V_3 ;
F_42 ( V_3 ) ;
...
{
F_11 ( V_2 , V_233 ) ;
F_211 ( V_2 , V_190 -> V_23 , V_190 -> V_38 ) ;
V_190 -> V_206 = F_201 ( V_190 -> V_206 ) ;
V_190 -> V_23 = NULL ;
V_190 -> V_38 = NULL ;
}
...
{
F_223 ( F_221 , F_220 , V_2 , 1 , V_236 ) ;
}
static int F_224 ( unsigned int V_60 )
{
struct V_1 * V_2 ;
unsigned long V_3 ;
F_139 ( & V_148 ) ;
...
static inline int F_225 ( struct V_23 * V_23 , int V_110 )
{
#ifdef F_187
...
static int F_226 ( struct V_23 * V_23 )
{
return V_23 -> V_30 - V_23 -> V_29 ;
}
static inline unsigned long F_227 ( struct V_106 * V_34 )
{
return F_94 ( & V_34 -> V_112 ) ;
}
static unsigned long F_228 ( struct V_106 * V_34 ,
int (* F_229)( struct V_23 * ) )
{
unsigned long V_3 ;
...
static T_4 void
F_230 ( struct V_1 * V_2 , T_7 V_237 , int V_238 )
{
#ifdef F_2
static F_231 ( V_239 , V_240 ,
V_241 ) ;
int V_110 ;
struct V_106 * V_34 ;
if ( ( V_237 & V_159 ) || ! F_232 ( & V_239 ) )
return;
F_160 ( L_58 ,
V_238 , V_237 , & V_237 ) ;
F_160 ( L_59 ,
...
F_24 ( V_2 -> V_163 ) ) ;
if ( F_24 ( V_2 -> V_163 ) > F_233 ( V_2 -> V_77 ) )
F_160 ( L_60 ,
V_2 -> V_40 ) ;
F_234 (s, node, n) {
unsigned long V_111 ;
...
static inline void * F_235 ( struct V_1 * V_2 , T_7 V_3 ,
...
if ( V_38 )
return V_38 ;
V_23 = F_159 ( V_2 , V_3 , V_110 ) ;
if ( V_23 ) {
V_190 = F_236 ( V_2 -> V_10 ) ;
if ( V_190 -> V_23 )
F_218 ( V_2 , V_190 ) ;
V_38 = V_23 -> V_38 ;
V_23 -> V_38 = NULL ;
...
static inline bool F_183 ( struct V_23 * V_23 , T_7 V_237 )
{
if ( F_3 ( F_237 ( V_23 ) ) )
return F_238 ( V_237 ) ;
return true ;
}
static inline void * F_239 ( struct V_1 * V_2 , struct V_23 * V_23 )
{
struct V_23 V_188 ;
unsigned long V_27 ;
void * V_38 ;
...
goto F_159;
V_222:
if ( F_3 ( ! F_225 ( V_23 , V_110 ) ) ) {
int V_205 = V_110 ;
if ( V_110 != V_143 && ! F_199 ( V_110 ) )
V_205 = F_200 ( V_110 ) ;
if ( F_3 ( ! F_225 ( V_23 , V_205 ) ) ) {
F_11 ( V_2 , V_246 ) ;
F_211 ( V_2 , V_23 , V_190 -> V_38 ) ;
V_190 -> V_23 = NULL ;
V_190 -> V_38 = NULL ;
goto F_159;
}
}
if ( F_3 ( ! F_183 ( V_23 , V_237 ) ) ) {
F_211 ( V_2 , V_23 , V_190 -> V_38 ) ;
V_190 -> V_23 = NULL ;
V_190 -> V_38 = NULL ;
goto F_159;
...
V_38 = F_235 ( V_2 , V_237 , V_110 , & V_190 ) ;
if ( F_3 ( ! V_38 ) ) {
F_230 ( V_2 , V_237 , V_110 ) ;
return NULL ;
}
V_23 = V_190 -> V_23 ;
if ( F_97 ( ! F_1 ( V_2 ) && F_183 ( V_23 , V_237 ) ) )
goto V_247;
if ( F_1 ( V_2 ) &&
! F_105 ( V_2 , V_23 , V_38 , V_14 ) )
goto F_159;
F_211 ( V_2 , V_23 , F_14 ( V_2 , V_38 ) ) ;
V_190 -> V_23 = NULL ;
V_190 -> V_38 = NULL ;
return V_38 ;
}
...
#endif
V_5 = F_240 ( V_2 , V_237 , V_110 , V_14 , V_190 ) ;
F_43 ( V_3 ) ;
return V_5 ;
}
static T_1 void * F_242 ( struct V_1 * V_2 ,
...
V_222:
do {
V_206 = F_214 ( V_2 -> V_10 -> V_206 ) ;
V_190 = F_236 ( V_2 -> V_10 ) ;
} while ( F_244 ( F_207 ) &&
F_3 ( V_206 != F_245 ( V_190 -> V_206 ) ) );
F_246 () ;
V_11 = V_190 -> V_38 ;
V_23 = V_190 -> V_23 ;
if ( F_3 ( ! V_11 || ! F_225 ( V_23 , V_110 ) ) ) {
V_11 = F_241 ( V_2 , V_237 , V_110 , V_14 , V_190 ) ;
F_11 ( V_2 , V_251 ) ;
} else {
...
F_248 ( V_2 , V_237 , 1 , & V_11 ) ;
return V_11 ;
}
static T_1 void * F_249 ( struct V_1 * V_2 ,
T_7 V_237 , unsigned long V_14 )
{
return F_242 ( V_2 , V_237 , V_143 , V_14 ) ;
}
void * F_250 ( struct V_1 * V_2 , T_7 V_237 )
{
void * V_122 = F_249 ( V_2 , V_237 , V_254 ) ;
F_251 ( V_254 , V_122 , V_2 -> V_77 ,
V_2 -> V_15 , V_237 ) ;
return V_122 ;
}
void * F_252 ( struct V_1 * V_2 , T_7 V_237 , T_6 V_15 )
{
void * V_122 = F_249 ( V_2 , V_237 , V_254 ) ;
F_253 ( V_254 , V_122 , V_15 , V_2 -> V_15 , V_237 ) ;
F_254 ( V_2 , V_122 , V_15 , V_237 ) ;
return V_122 ;
}
void * F_255 ( struct V_1 * V_2 , T_7 V_237 , int V_110 )
{
void * V_122 = F_242 ( V_2 , V_237 , V_110 , V_254 ) ;
F_256 ( V_254 , V_122 ,
...
static void F_259 ( struct V_1 * V_2 , struct V_23 * V_23 ,
...
static T_1 void F_260 ( struct V_1 * V_2 ,
...
V_190 -> V_38 , V_206 ,
V_117 , F_201 ( V_206 ) ) ) ) {
F_205 ( L_65 , V_2 , V_206 ) ;
goto V_222;
}
F_11 ( V_2 , V_261 ) ;
} else
F_259 ( V_2 , V_23 , V_117 , V_140 , V_120 , V_14 ) ;
}
static T_1 void F_261 ( struct V_1 * V_2 , struct V_23 * V_23 ,
void * V_117 , void * V_118 , int V_120 ,
unsigned long V_14 )
{
...
return;
F_260 ( V_2 , V_23 , V_117 , V_118 , V_120 , V_14 ) ;
}
void F_262 ( struct V_1 * V_263 , void * V_20 , unsigned long V_14 )
{
F_260 ( V_263 , F_169 ( V_20 ) , V_20 , NULL , 1 , V_14 ) ;
}
void F_263 ( struct V_1 * V_2 , void * V_20 )
{
V_2 = F_264 ( V_2 , V_20 ) ;
if ( ! V_2 )
return;
F_261 ( V_2 , F_169 ( V_20 ) , V_20 , NULL , 1 , V_254 ) ;
F_265 ( V_254 , V_20 ) ;
}
static inline
int F_266 ( struct V_1 * V_2 , T_6 V_15 ,
...
void F_269 ( struct V_1 * V_2 , T_6 V_15 , void * * V_5 )
{
if ( F_179 ( ! V_15 ) )
return;
do {
struct V_264 V_265 ;
V_15 = F_266 ( V_2 , V_15 , V_5 , & V_265 ) ;
if ( ! V_265 . V_23 )
continue;
F_261 ( V_265 . V_2 , V_265 . V_23 , V_265 . V_38 , V_265 . V_118 , V_265 . V_120 , V_254 ) ;
} while ( F_97 ( V_15 ) );
}
int F_270 ( struct V_1 * V_2 , T_7 V_3 , T_6 V_15 ,
void * * V_5 )
{
struct V_189 * V_190 ;
int V_52 ;
...
F_248 ( V_2 , V_3 , V_15 , V_5 ) ;
return V_52 ;
error:
F_147 () ;
F_248 ( V_2 , V_3 , V_52 , V_5 ) ;
F_271 ( V_2 , V_52 , V_5 ) ;
return 0 ;
}
static inline int F_272 ( int V_15 , int V_269 ,
...
return F_233 ( V_15 * V_103 ) - 1 ;
for ( V_16 = F_273 ( V_273 , F_233 ( V_269 * V_15 + V_17 ) ) ;
V_16 <= V_270 ; V_16 ++ ) {
...
static inline int F_274 ( int V_15 , int V_17 )
{
int V_16 ;
int V_269 ;
int V_276 ;
...
V_16 = F_272 ( V_15 , 1 , V_279 , 1 , V_17 ) ;
if ( V_16 <= V_279 )
return V_16 ;
V_16 = F_272 ( V_15 , 1 , V_280 , 1 , V_17 ) ;
if ( V_16 < V_280 )
return V_16 ;
return - V_281 ;
}
static void
F_276 ( struct V_106 * V_34 )
{
V_34 -> V_184 = 0 ;
F_277 ( & V_34 -> V_107 ) ;
F_278 ( & V_34 -> V_186 ) ;
...
V_2 -> V_10 = F_282 ( sizeof( struct V_189 ) ,
2 * sizeof( void * ) ) ;
if ( ! V_2 -> V_10 )
return 0 ;
F_208 ( V_2 ) ;
...
static void F_283 ( int V_110 )
{
struct V_23 * V_23 ;
struct V_106 * V_34 ;
F_267 ( V_106 -> V_15 < sizeof( struct V_106 ) ) ;
V_23 = F_159 ( V_106 , V_284 , V_110 ) ;
F_267 ( ! V_23 ) ;
if ( F_108 ( V_23 ) != V_110 ) {
F_63 ( L_66 , V_110 ) ;
F_63 ( L_67 ) ;
...
F_61 ( V_106 , V_34 ) ;
#endif
F_254 ( V_106 , V_34 , sizeof( struct V_106 ) ,
V_147 ) ;
F_276 ( V_34 ) ;
F_96 ( V_106 , V_110 , V_23 -> V_30 ) ;
F_174 ( V_34 , V_23 , V_218 ) ;
}
...
static void F_290 ( struct V_1 * V_2 , unsigned long V_163 )
{
if ( V_163 < V_287 )
V_163 = V_287 ;
else if ( V_163 > V_288 )
...
static int F_291 ( struct V_1 * V_2 , int V_289 )
{
unsigned long V_3 = V_2 -> V_3 ;
T_6 V_15 = V_2 -> V_77 ;
int V_16 ;
V_15 = F_292 ( V_15 , sizeof( void * ) ) ;
#ifdef F_2
...
#endif
F_293 ( V_2 , & V_15 , & V_2 -> V_3 ) ;
#ifdef F_2
if ( V_3 & V_6 ) {
V_15 += sizeof( void * ) ;
V_2 -> V_7 = sizeof( void * ) ;
V_2 -> V_7 = F_292 ( V_2 -> V_7 , V_2 -> V_290 ) ;
V_15 += V_2 -> V_7 ;
}
#endif
V_15 = F_292 ( V_15 , V_2 -> V_290 ) ;
V_2 -> V_15 = V_15 ;
if ( V_289 >= 0 )
V_16 = V_289 ;
else
V_16 = F_274 ( V_15 , V_2 -> V_17 ) ;
if ( V_16 < 0 )
return 0 ;
V_2 -> V_158 = 0 ;
if ( V_16 )
...
V_2 -> V_163 = F_23 ( F_233 ( V_15 ) , V_15 , V_2 -> V_17 ) ;
if ( F_25 ( V_2 -> V_141 ) > F_25 ( V_2 -> F_273 ) )
V_2 -> F_273 = V_2 -> V_141 ;
return ! ! F_25 ( V_2 -> V_141 ) ;
}
static int F_294 ( struct V_1 * V_2 , unsigned long V_3 )
{
...
goto error;
if ( V_130 ) {
if ( F_233 ( V_2 -> V_15 ) > F_233 ( V_2 -> V_77 ) ) {
V_2 -> V_3 &= ~ V_295 ;
V_2 -> V_12 = 0 ;
if ( ! F_291 ( V_2 , - 1 ) )
goto error;
...
#if F_36 ( V_35 ) && \
F_36 ( V_36 )
if ( F_295 () && ( V_2 -> V_3 & V_296 ) == 0 )
V_2 -> V_3 |= V_37 ;
#endif
F_290 ( V_2 , F_296 ( V_2 -> V_15 ) / 2 ) ;
if ( ! F_5 ( V_2 ) )
V_2 -> V_195 = 0 ;
...
static void F_298 ( struct V_1 * V_2 , struct V_23 * V_23 ,
const char * V_44 )
{
#ifdef F_2
void * V_14 = F_45 ( V_23 ) ;
void * V_5 ;
unsigned long * V_41 = F_299 ( F_300 ( V_23 -> V_30 ) *
sizeof( long ) , V_236 ) ;
if ( ! V_41 )
return;
...
F_26 ( V_23 ) ;
F_44 ( V_2 , V_23 , V_41 ) ;
F_162 (p, s, addr, page->objects) {
if ( ! F_301 ( F_21 ( V_5 , V_2 , V_14 ) , V_41 ) ) {
...
static void F_303 ( struct V_1 * V_2 , struct V_106 * V_34 )
{
F_304 ( V_300 ) ;
struct V_23 * V_23 , * V_180 ;
F_267 ( F_35 () ) ;
F_305 ( & V_34 -> V_107 ) ;
F_182 (page, h, &n->partial, lru) {
if ( ! V_23 -> V_29 ) {
F_177 ( V_34 , V_23 ) ;
...
static int T_5 F_308 ( char * V_125 )
{
F_309 ( & V_125 , & V_274 ) ;
return 1 ;
}
...
void * F_312 ( T_6 V_15 , T_7 V_3 )
{
struct V_1 * V_2 ;
void * V_122 ;
if ( F_3 ( V_15 > V_301 ) )
return F_313 ( V_15 , V_3 ) ;
V_2 = F_314 ( V_15 , V_3 ) ;
if ( F_3 ( F_315 ( V_2 ) ) )
return V_2 ;
V_122 = F_249 ( V_2 , V_3 , V_254 ) ;
F_253 ( V_254 , V_122 , V_15 , V_2 -> V_15 , V_3 ) ;
F_254 ( V_2 , V_122 , V_15 , V_3 ) ;
return V_122 ;
}
static void * F_316 ( T_6 V_15 , T_7 V_3 , int V_110 )
{
struct V_23 * V_23 ;
void * V_132 = NULL ;
V_3 |= V_291 | V_142 ;
V_23 = F_317 ( V_110 , V_3 , F_233 ( V_15 ) ) ;
if ( V_23 )
V_132 = F_45 ( V_23 ) ;
F_114 ( V_132 , V_15 , V_3 ) ;
return V_132 ;
}
void * F_318 ( T_6 V_15 , T_7 V_3 , int V_110 )
{
struct V_1 * V_2 ;
void * V_122 ;
if ( F_3 ( V_15 > V_301 ) ) {
V_122 = F_316 ( V_15 , V_3 , V_110 ) ;
F_258 ( V_254 , V_122 ,
V_15 , V_18 << F_233 ( V_15 ) ,
V_3 , V_110 ) ;
return V_122 ;
}
V_2 = F_314 ( V_15 , V_3 ) ;
if ( F_3 ( F_315 ( V_2 ) ) )
return V_2 ;
V_122 = F_242 ( V_2 , V_3 , V_110 , V_254 ) ;
F_258 ( V_254 , V_122 , V_15 , V_2 -> V_15 , V_3 , V_110 ) ;
F_254 ( V_2 , V_122 , V_15 , V_3 ) ;
return V_122 ;
}
const char * F_319 ( const void * V_132 , unsigned long V_34 ,
struct V_23 * V_23 )
{
struct V_1 * V_2 ;
unsigned long V_12 ;
...
static T_6 F_321 ( const void * V_11 )
{
struct V_23 * V_23 ;
if ( F_3 ( V_11 == V_302 ) )
return 0 ;
...
return F_320 ( V_23 -> V_116 ) ;
}
T_6 F_322 ( const void * V_11 )
{
T_6 V_15 = F_321 ( V_11 ) ;
F_323 ( V_11 , V_15 ) ;
return V_15 ;
}
void F_302 ( const void * V_20 )
{
struct V_23 * V_23 ;
void * V_11 = ( void * ) V_20 ;
F_324 ( V_254 , V_20 ) ;
...
F_261 ( V_23 -> V_116 , V_23 , V_11 , NULL , 1 , V_254 ) ;
}
...
F_278 ( V_303 + V_52 ) ;
F_109 ( & V_34 -> V_107 , V_3 ) ;
F_182 (page, t, &n->partial, lru) {
int free = V_23 -> V_30 - V_23 -> V_29 ;
F_246 () ;
F_267 ( free <= 0 ) ;
if ( free == V_23 -> V_30 ) {
F_326 ( & V_23 -> V_108 , & V_300 ) ;
V_34 -> V_184 -- ;
} else if ( free <= V_304 )
F_326 ( & V_23 -> V_108 , V_303 + free - 1 ) ;
}
for ( V_52 = V_304 - 1 ; V_52 >= 0 ; V_52 -- )
F_327 ( V_303 + V_52 , & V_34 -> V_186 ) ;
F_110 ( & V_34 -> V_107 , V_3 ) ;
F_182 (page, t, &discard, lru)
F_173 ( V_2 , V_23 ) ;
if ( F_92 ( V_2 , V_110 ) )
V_122 = 1 ;
}
...
static int F_334 ( struct V_311 * V_312 ,
...
static struct V_1 * T_5 F_336 ( struct V_1 * V_321 )
{
int V_110 ;
struct V_1 * V_2 = F_337 ( V_1 , V_284 ) ;
struct V_106 * V_34 ;
...
struct V_1 *
F_350 ( const char * V_40 , T_6 V_15 , T_6 V_290 ,
unsigned long V_3 , void (* F_113)( void * ) )
{
struct V_1 * V_2 , * V_190 ;
V_2 = F_351 ( V_15 , V_290 , V_3 , V_40 , F_113 ) ;
if ( V_2 ) {
V_2 -> V_332 ++ ;
V_2 -> V_77 = F_273 ( V_2 -> V_77 , ( int ) V_15 ) ;
V_2 -> V_29 = F_352 ( int , V_2 -> V_29 , F_292 ( V_15 , sizeof( void * ) ) ) ;
F_353 (c, s) {
V_190 -> V_77 = V_2 -> V_77 ;
V_190 -> V_29 = F_352 ( int , V_190 -> V_29 ,
F_292 ( V_15 , sizeof( void * ) ) ) ;
}
if ( F_8 ( V_2 , V_40 ) ) {
V_2 -> V_332 -- ;
V_2 = NULL ;
...
int F_354 ( struct V_1 * V_2 , unsigned long V_3 )
{
int V_144 ;
V_144 = F_294 ( V_2 , V_3 ) ;
if ( V_144 )
...
void * F_355 ( T_6 V_15 , T_7 V_237 , unsigned long V_333 )
{
struct V_1 * V_2 ;
void * V_122 ;
if ( F_3 ( V_15 > V_301 ) )
return F_313 ( V_15 , V_237 ) ;
V_2 = F_314 ( V_15 , V_237 ) ;
if ( F_3 ( F_315 ( V_2 ) ) )
return V_2 ;
V_122 = F_249 ( V_2 , V_237 , V_333 ) ;
F_253 ( V_333 , V_122 , V_15 , V_2 -> V_15 , V_237 ) ;
return V_122 ;
}
void * F_356 ( T_6 V_15 , T_7 V_237 ,
int V_110 , unsigned long V_333 )
{
struct V_1 * V_2 ;
void * V_122 ;
if ( F_3 ( V_15 > V_301 ) ) {
V_122 = F_316 ( V_15 , V_237 , V_110 ) ;
F_258 ( V_333 , V_122 ,
V_15 , V_18 << F_233 ( V_15 ) ,
V_237 , V_110 ) ;
return V_122 ;
...
if ( F_3 ( F_315 ( V_2 ) ) )
return V_2 ;
V_122 = F_242 ( V_2 , V_237 , V_110 , V_333 ) ;
F_258 ( V_333 , V_122 , V_15 , V_2 -> V_15 , V_237 , V_110 ) ;
return V_122 ;
}
static int F_357 ( struct V_23 * V_23 )
{
return V_23 -> V_29 ;
}
static int F_358 ( struct V_23 * V_23 )
{
return V_23 -> V_30 ;
}
static int F_359 ( struct V_1 * V_2 , struct V_23 * V_23 ,
unsigned long * V_41 )
{
void * V_5 ;
void * V_14 = F_45 ( V_23 ) ;
...
static void F_361 ( struct V_1 * V_2 , struct V_23 * V_23 ,
unsigned long * V_41 )
{
F_26 ( V_23 ) ;
F_359 ( V_2 , V_23 , V_41 ) ;
...
static long F_363 ( struct V_1 * V_2 )
{
int V_110 ;
unsigned long V_145 = 0 ;
unsigned long * V_41 = F_364 ( F_300 ( F_25 ( V_2 -> F_273 ) ) *
...
F_222 ( V_2 ) ;
F_234 (s, node, n)
V_145 += F_362 ( V_2 , V_34 , V_41 ) ;
F_302 ( V_41 ) ;
return V_145 ;
}
static void F_365 ( struct V_334 * V_68 )
{
if ( V_68 -> F_273 )
F_366 ( ( unsigned long ) V_68 -> V_335 ,
F_233 ( sizeof( struct V_336 ) * V_68 -> F_273 ) ) ;
}
static int F_367 ( struct V_334 * V_68 , unsigned long F_273 , T_7 V_3 )
{
struct V_336 * V_215 ;
int V_16 ;
V_16 = F_233 ( sizeof( struct V_336 ) * F_273 ) ;
V_215 = ( void * ) F_368 ( V_3 , V_16 ) ;
if ( ! V_215 )
return 0 ;
if ( V_68 -> V_145 ) {
...
static int F_369 ( struct V_334 * V_68 , struct V_1 * V_2 ,
...
F_372 ( F_108 ( F_373 ( V_47 ) ) , V_215 -> V_345 ) ;
return 1 ;
}
if ( V_47 -> V_14 < V_337 )
V_93 = V_149 ;
...
if ( V_68 -> V_145 >= V_68 -> F_273 && ! F_367 ( V_68 , 2 * V_68 -> F_273 , V_236 ) )
return 0 ;
V_215 = V_68 -> V_335 + V_149 ;
if ( V_149 < V_68 -> V_145 )
...
V_215 -> V_342 = V_47 -> V_61 ;
V_215 -> V_343 = V_47 -> V_61 ;
F_374 ( F_371 ( V_215 -> V_344 ) ) ;
F_370 ( V_47 -> V_60 , F_371 ( V_215 -> V_344 ) ) ;
F_375 ( V_215 -> V_345 ) ;
F_372 ( F_108 ( F_373 ( V_47 ) ) , V_215 -> V_345 ) ;
return 1 ;
}
static void F_376 ( struct V_334 * V_68 , struct V_1 * V_2 ,
...
F_162 (p, s, addr, page->objects)
if ( ! F_301 ( F_21 ( V_5 , V_2 , V_14 ) , V_41 ) )
F_369 ( V_68 , V_2 , F_56 ( V_2 , V_5 , V_49 ) ) ;
}
static int F_377 ( struct V_1 * V_2 , char * V_79 ,
enum V_48 V_49 )
{
int V_346 = 0 ;
unsigned long V_52 ;
...
sizeof( unsigned long ) , V_147 ) ;
struct V_106 * V_34 ;
if ( ! V_41 || ! F_367 ( & V_68 , V_18 / sizeof( struct V_336 ) ,
V_347 ) ) {
F_302 ( V_41 ) ;
...
V_215 -> V_340 ,
( long ) F_378 ( V_215 -> V_339 , V_215 -> V_145 ) ,
V_215 -> V_341 ) ;
} else
...
V_215 -> V_342 ) ;
if ( F_379 () > 1 &&
! F_380 ( F_371 ( V_215 -> V_344 ) ) &&
V_346 < V_18 - 60 )
V_346 += F_381 ( V_79 + V_346 , V_18 - V_346 - 50 ,
L_85 ,
F_382 ( F_371 ( V_215 -> V_344 ) ) ) ;
if ( V_349 > 1 && ! F_383 ( V_215 -> V_345 ) &&
V_346 < V_18 - 60 )
V_346 += F_381 ( V_79 + V_346 , V_18 - V_346 - 50 ,
L_86 ,
F_384 ( & V_215 -> V_345 ) ) ;
...
static void T_5 F_385 ( void )
{
T_2 * V_5 ;
F_281 ( V_350 > 16 || V_283 < 10 ) ;
F_63 ( L_89 ) ;
F_63 ( L_90 ) ;
F_63 ( L_91 ) ;
V_5 = F_299 ( 16 , V_147 ) ;
...
static int T_5 F_386 ( char * V_125 )
{
int V_352 ;
if ( F_309 ( & V_125 , & V_352 ) > 0 )
V_353 = V_352 ;
return 1 ;
}
...
int V_20 ;
unsigned long * V_345 ;
V_345 = F_299 ( sizeof( unsigned long ) * V_330 , V_147 ) ;
if ( ! V_345 )
return - V_310 ;
if ( V_3 & V_355 ) {
int V_60 ;
...
F_234 (s, node, n) {
if ( V_3 & V_356 )
V_20 = F_228 ( V_34 , F_358 ) ;
else if ( V_3 & V_357 )
V_20 = F_228 ( V_34 , F_357 ) ;
else
V_20 = V_34 -> V_184 ;
V_354 += V_20 ;
V_345 [ V_110 ] += V_20 ;
...
static T_9 F_402 ( struct V_1 * V_2 , const char * V_79 ,
T_6 V_45 )
{
unsigned long V_30 ;
int V_144 ;
V_144 = F_397 ( V_79 , 10 , & V_30 ) ;
if ( V_144 )
return V_144 ;
if ( V_30 && ! F_5 ( V_2 ) )
return - V_299 ;
...
int V_346 ;
F_410 (cpu) {
struct V_23 * V_23 = F_210 ( V_2 -> V_10 , V_60 ) -> V_186 ;
if ( V_23 ) {
V_169 += V_23 -> V_169 ;
V_30 += V_23 -> V_231 ;
}
...
{
return F_387 ( V_2 , V_79 , V_358 ) ;
}
static T_9 F_419 ( struct V_1 * V_2 , char * V_79 )
{
return F_387 ( V_2 , V_79 , V_358 | V_356 ) ;
}
...
static T_9 F_423 ( struct V_1 * V_2 , const char * V_79 ,
T_6 V_45 )
{
if ( V_2 -> V_332 > 1 )
return - V_299 ;
...
static T_9 F_427 ( struct V_1 * V_2 ,
const char * V_79 , T_6 V_45 )
{
if ( F_391 ( V_2 ) )
return - V_360 ;
...
static T_9 F_429 ( struct V_1 * V_2 ,
const char * V_79 , T_6 V_45 )
{
if ( F_391 ( V_2 ) )
return - V_360 ;
...
static T_9 F_432 ( struct V_1 * V_2 , char * V_79 )
{
if ( ! ( V_2 -> V_3 & V_65 ) )
return - V_281 ;
return F_377 ( V_2 , V_79 , V_67 ) ;
}
static T_9 F_433 ( struct V_1 * V_2 , char * V_79 )
{
if ( ! ( V_2 -> V_3 & V_65 ) )
return - V_281 ;
return F_377 ( V_2 , V_79 , V_66 ) ;
}
static T_9 F_434 ( struct V_1 * V_2 , char * V_79 )
{
return sprintf ( V_79 , L_102 , ! ! ( V_2 -> V_3 & V_129 ) ) ;
}
static T_9 F_435 ( struct V_1 * V_2 , const char * V_79 ,
T_6 V_45 )
{
if ( V_2 -> V_332 > 1 )
return - V_299 ;
...
static T_9 F_436 ( struct V_1 * V_2 , char * V_79 )
{
return 0 ;
}
static T_9 F_437 ( struct V_1 * V_2 ,
const char * V_79 , T_6 V_45 )
{
if ( V_79 [ 0 ] == '1' )
F_438 ( V_2 ) ;
...
static int F_441 ( struct V_1 * V_2 , char * V_79 , enum V_8 V_9 )
{
unsigned long V_362 = 0 ;
int V_60 ;
int V_346 ;
int * V_85 = F_364 ( V_278 * sizeof( int ) , V_147 ) ;
if ( ! V_85 )
return - V_310 ;
F_410 (cpu) {
...
static void F_442 ( struct V_1 * V_2 , enum V_8 V_9 )
{
int V_60 ;
F_410 (cpu)
F_210 ( V_2 -> V_10 , V_60 ) -> F_11 [ V_9 ] = 0 ;
}
static T_9 F_443 ( struct V_363 * V_364 ,
struct V_365 * V_366 ,
char * V_79 )
{
struct V_367 * V_365 ;
...
static T_9 F_446 ( struct V_363 * V_364 ,
struct V_365 * V_366 ,
...
#ifdef F_447
if ( V_285 >= V_371 && V_144 >= 0 && F_448 ( V_2 ) ) {
struct V_1 * V_190 ;
F_139 ( & V_148 ) ;
if ( V_2 -> V_372 < V_346 )
V_2 -> V_372 = V_346 ;
...
if ( ! V_374 -> V_372 )
return;
for ( V_52 = 0 ; V_52 < F_449 ( V_376 ) ; V_52 ++ ) {
char V_377 [ 64 ] ;
char * V_79 ;
struct V_367 * V_366 = F_444 ( V_376 [ V_52 ] ) ;
T_9 V_346 ;
if ( ! V_366 || ! V_366 -> V_370 || ! V_366 -> V_368 )
continue;
if ( V_373 )
V_79 = V_373 ;
else if ( V_374 -> V_372 < F_449 ( V_377 ) )
V_79 = V_377 ;
else {
V_373 = ( char * ) F_450 ( V_147 ) ;
if ( F_179 ( ! V_373 ) )
continue;
V_79 = V_373 ;
}
...
if ( V_373 )
F_451 ( ( unsigned long ) V_373 ) ;
#endif
}
static void F_452 ( struct V_363 * V_378 )
{
F_453 ( F_445 ( V_378 ) ) ;
}
static int F_454 ( struct V_379 * V_379 , struct V_363 * V_364 )
{
struct V_380 * V_381 = F_455 ( V_364 ) ;
if ( V_381 == & V_382 )
return 1 ;
return 0 ;
}
static inline struct V_379 * F_456 ( struct V_1 * V_2 )
{
#ifdef F_447
if ( ! F_448 ( V_2 ) )
...
static char * F_457 ( struct V_1 * V_2 )
{
char * V_40 = F_364 ( V_385 , V_147 ) ;
char * V_5 = V_40 ;
F_267 ( ! V_40 ) ;
* V_5 ++ = ':' ;
if ( V_2 -> V_3 & V_292 )
...
F_267 ( V_5 > V_40 + V_385 - 1 ) ;
return V_40 ;
}
static void F_458 ( struct V_387 * V_388 )
{
struct V_1 * V_2 =
F_170 ( V_388 , struct V_1 , V_389 ) ;
if ( ! V_2 -> V_364 . V_390 )
return;
#ifdef F_447
F_459 ( V_2 -> V_383 ) ;
#endif
F_460 ( & V_2 -> V_364 , V_391 ) ;
F_461 ( & V_2 -> V_364 ) ;
F_462 ( & V_2 -> V_364 ) ;
}
...
int V_144 ;
const char * V_40 ;
struct V_379 * V_379 = F_456 ( V_2 ) ;
int V_392 = F_463 ( V_2 ) ;
F_464 ( & V_2 -> V_389 , F_458 ) ;
if ( ! V_379 ) {
F_465 ( & V_2 -> V_364 , & V_382 ) ;
return 0 ;
}
if ( V_392 ) {
F_466 ( & V_384 -> V_364 , V_2 -> V_40 ) ;
V_40 = V_2 -> V_40 ;
} else {
V_40 = F_457 ( V_2 ) ;
}
V_2 -> V_364 . V_379 = V_379 ;
V_144 = F_467 ( & V_2 -> V_364 , & V_382 , NULL , L_16 , V_40 ) ;
if ( V_144 )
goto V_123;
V_144 = F_468 ( & V_2 -> V_364 , & V_393 ) ;
if ( V_144 )
goto V_394;
#ifdef F_447
if ( F_448 ( V_2 ) && V_353 ) {
V_2 -> V_383 = F_469 ( L_110 , NULL , & V_2 -> V_364 ) ;
if ( ! V_2 -> V_383 ) {
V_144 = - V_310 ;
goto V_394;
}
...
struct V_396 * V_397 ;
if ( V_285 == V_371 ) {
F_466 ( & V_384 -> V_364 , V_40 ) ;
return F_473 ( & V_384 -> V_364 , & V_2 -> V_364 , V_40 ) ;
}
V_397 = F_364 ( sizeof( struct V_396 ) , V_147 ) ;
if ( ! V_397 )
return - V_310 ;
V_397 -> V_2 = V_2 ;
V_397 -> V_40 = V_40 ;
...
static int T_5 F_474 ( void )
{
struct V_1 * V_2 ;
int V_144 ;
F_139 ( & V_148 ) ;
V_384 = F_469 ( L_111 , & V_399 , V_400 ) ;
if ( ! V_384 ) {
F_141 ( & V_148 ) ;
F_63 ( L_112 ) ;
return - V_281 ;
...
void F_475 ( struct V_1 * V_2 , struct V_401 * V_402 )
{
...
void F_476 ( struct V_409 * V_216 , struct V_1 * V_2 )
{
}
T_9 F_477 ( struct V_410 * V_410 , const char T_10 * V_373 ,
