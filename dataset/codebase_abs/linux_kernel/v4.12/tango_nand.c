...
static void F_39 ( struct V_12 * V_13 , T_1 * * V_21 , int V_22 , int * V_107 )
{
struct V_1 * V_2 = F_17 ( V_13 ) ;
* V_107 += V_22 ;
if ( ! * V_21 ) {
V_13 -> V_108 ( V_2 , V_109 , * V_107 , - 1 ) ;
} else {
F_10 ( V_2 , * V_21 , V_22 ) ;
* V_21 += V_22 ;
}
}
static void F_40 ( struct V_12 * V_13 , const T_1 * * V_21 , int V_22 , int * V_107 )
{
struct V_1 * V_2 = F_17 ( V_13 ) ;
* V_107 += V_22 ;
if ( ! * V_21 ) {
V_13 -> V_108 ( V_2 , V_110 , * V_107 , - 1 ) ;
} else {
F_12 ( V_2 , * V_21 , V_22 ) ;
* V_21 += V_22 ;
}
}
static void F_41 ( struct V_12 * V_13 , T_1 * V_21 , T_1 * V_111 )
{
struct V_1 * V_2 = F_17 ( V_13 ) ;
T_1 * V_112 = V_111 ;
const int V_113 = V_2 -> V_99 ;
const int V_42 = V_13 -> V_40 . V_43 ;
const int V_44 = V_13 -> V_40 . V_45 ;
int V_107 = 0 ;
int V_114 = V_113 ;
if ( V_111 )
V_111 += V_39 ;
F_39 ( V_13 , & V_111 , V_41 , & V_107 ) ;
while ( V_114 > V_44 ) {
F_39 ( V_13 , & V_21 , V_44 , & V_107 ) ;
F_39 ( V_13 , & V_111 , V_42 , & V_107 ) ;
V_114 = V_113 - V_107 ;
}
F_39 ( V_13 , & V_21 , V_114 , & V_107 ) ;
F_39 ( V_13 , & V_112 , V_39 , & V_107 ) ;
F_39 ( V_13 , & V_21 , V_44 - V_114 , & V_107 ) ;
F_39 ( V_13 , & V_111 , V_42 , & V_107 ) ;
}
static void F_42 ( struct V_12 * V_13 , const T_1 * V_21 , const T_1 * V_111 )
{
struct V_1 * V_2 = F_17 ( V_13 ) ;
const T_1 * V_112 = V_111 ;
const int V_113 = V_2 -> V_99 ;
const int V_42 = V_13 -> V_40 . V_43 ;
const int V_44 = V_13 -> V_40 . V_45 ;
int V_107 = 0 ;
...
if ( V_111 )
V_111 += V_39 ;
F_40 ( V_13 , & V_111 , V_41 , & V_107 ) ;
while ( V_114 > V_44 ) {
F_40 ( V_13 , & V_21 , V_44 , & V_107 ) ;
F_40 ( V_13 , & V_111 , V_42 , & V_107 ) ;
V_114 = V_113 - V_107 ;
}
F_40 ( V_13 , & V_21 , V_114 , & V_107 ) ;
F_40 ( V_13 , & V_112 , V_39 , & V_107 ) ;
F_40 ( V_13 , & V_21 , V_44 - V_114 , & V_107 ) ;
F_40 ( V_13 , & V_111 , V_42 , & V_107 ) ;
}
static int F_43 ( struct V_1 * V_2 , struct V_12 * V_13 ,
T_1 * V_21 , int V_98 , int V_65 )
{
V_13 -> V_108 ( V_2 , V_115 , 0 , V_65 ) ;
...
const T_1 * V_21 , int V_98 , int V_65 )
{
V_13 -> V_108 ( V_2 , V_110 , 0 , V_65 ) ;
F_42 ( V_13 , V_21 , V_13 -> V_38 ) ;
V_13 -> V_108 ( V_2 , V_116 , - 1 , - 1 ) ;
return 0 ;
}
...
static int F_47 ( struct V_1 * V_2 , int V_23 , struct V_118 * V_47 )
{
struct V_12 * V_13 = F_3 ( V_2 ) ;
struct V_119 * V_40 = & V_13 -> V_40 ;
if ( V_23 >= V_40 -> V_50 )
return - V_120 ;
V_47 -> V_121 = V_39 + V_41 + V_40 -> V_43 * V_23 ;
V_47 -> V_122 = V_40 -> V_43 ;
return 0 ;
}
static int F_48 ( struct V_1 * V_2 , int V_23 , struct V_118 * V_47 )
{
return - V_120 ;
}
static T_2 F_49 ( int V_123 , int V_124 )
{
return F_50 ( ( V_125 ) V_123 * V_124 , V_126 ) ;
}
static int F_51 ( struct V_1 * V_2 ,
const struct V_127 * V_128 ,
bool V_129 )
{
const struct V_130 * V_131 = F_52 ( V_128 ) ;
struct V_12 * V_13 = F_3 ( V_2 ) ;
struct V_14 * V_15 = F_6 ( V_13 -> V_16 ) ;
struct V_5 * V_6 = F_2 ( V_13 ) ;
T_2 V_132 , V_133 , V_134 , V_135 , V_136 , V_137 , V_138 , V_139 ;
int V_123 = V_15 -> V_140 ;
if ( F_53 ( V_131 ) )
return F_54 ( V_131 ) ;
if ( V_129 )
return 0 ;
V_132 = F_49 ( V_123 , V_131 -> V_141 - V_131 -> V_142 ) ;
V_133 = F_49 ( V_123 , V_131 -> V_143 ) ;
V_134 = F_49 ( V_123 , V_131 -> V_144 ) ;
V_135 = F_49 ( V_123 , V_131 -> V_144 - V_131 -> V_145 ) ;
V_136 = F_49 ( V_123 , V_131 -> V_142 ) ;
V_137 = F_49 ( V_123 , V_131 -> V_146 ) ;
V_138 = F_49 ( V_123 , V_131 -> V_147 - V_131 -> V_146 ) ;
V_139 = F_49 ( V_123 , V_131 -> V_148 ) ;
V_6 -> V_24 = F_55 ( V_132 , V_133 , V_134 , V_135 ) ;
V_6 -> V_27 = F_55 ( V_136 , V_137 , V_138 , V_139 ) ;
return 0 ;
}
static int F_56 ( struct V_81 * V_82 , struct V_149 * V_150 )
{
T_2 V_151 ;
int V_78 , V_47 ;
struct V_1 * V_2 ;
...
V_6 = F_58 ( V_82 , sizeof( * V_6 ) , V_152 ) ;
if ( ! V_6 )
return - V_153 ;
V_47 = F_59 ( V_150 , L_1 ) ;
if ( V_47 < 0 )
...
V_165 |
V_166 ;
V_13 -> V_16 = & V_15 -> V_167 ;
V_6 -> V_8 = V_15 -> V_17 + ( V_151 * 256 ) ;
F_61 ( V_13 , V_150 ) ;
F_62 ( V_2 , & V_168 ) ;
V_2 -> V_82 . V_169 = V_82 ;
...
V_40 -> V_170 = V_171 ;
V_40 -> V_172 = V_173 ;
V_40 -> V_43 = F_64 ( V_40 -> V_51 * V_174 , V_175 ) ;
V_40 -> V_176 = F_43 ;
V_40 -> V_177 = F_44 ;
V_40 -> V_178 = F_37 ;
V_40 -> V_179 = F_38 ;
...
if ( V_78 )
return V_78 ;
V_6 -> V_29 = F_66 ( V_151 , 1 , V_40 -> V_50 , V_41 ) ;
...
if ( V_78 )
return V_78 ;
V_15 -> V_182 [ V_151 ] = V_6 ;
return 0 ;
}
static int F_70 ( struct V_183 * V_184 )
{
int V_151 ;
struct V_14 * V_15 = F_71 ( V_184 ) ;
F_72 ( V_15 -> V_69 ) ;
for ( V_151 = 0 ; V_151 < V_154 ; ++ V_151 ) {
if ( V_15 -> V_182 [ V_151 ] )
F_73 ( F_17 ( & V_15 -> V_182 [ V_151 ] -> V_12 ) ) ;
}
return 0 ;
}
...
struct V_14 * V_15 ;
struct V_149 * V_150 ;
V_15 = F_58 ( & V_184 -> V_82 , sizeof( * V_15 ) , V_152 ) ;
if ( ! V_15 )
return - V_153 ;
V_47 = F_75 ( V_184 , V_187 , 0 ) ;
V_15 -> V_25 = F_76 ( & V_184 -> V_82 , V_47 ) ;
if ( F_53 ( V_15 -> V_25 ) )
return F_54 ( V_15 -> V_25 ) ;
V_47 = F_75 ( V_184 , V_187 , 1 ) ;
V_15 -> V_58 = F_76 ( & V_184 -> V_82 , V_47 ) ;
if ( F_53 ( V_15 -> V_58 ) )
return F_54 ( V_15 -> V_58 ) ;
V_47 = F_75 ( V_184 , V_187 , 2 ) ;
V_15 -> V_17 = F_76 ( & V_184 -> V_82 , V_47 ) ;
if ( F_53 ( V_15 -> V_17 ) )
return F_54 ( V_15 -> V_17 ) ;
F_15 ( V_97 , V_15 -> V_17 + V_91 ) ;
V_185 = F_77 ( & V_184 -> V_82 , NULL ) ;
if ( F_53 ( V_185 ) )
return F_54 ( V_185 ) ;
V_15 -> V_69 = F_78 ( & V_184 -> V_82 , L_2 ) ;
if ( F_53 ( V_15 -> V_69 ) )
return F_54 ( V_15 -> V_69 ) ;
F_79 ( V_184 , V_15 ) ;
F_80 ( & V_15 -> V_167 ) ;
V_15 -> V_140 = F_81 ( V_185 ) / 1000 ;
F_82 (pdev->dev.of_node, np) {
V_78 = F_56 ( & V_184 -> V_82 , V_150 ) ;
if ( V_78 ) {
F_70 ( V_184 ) ;
return V_78 ;
}
