...
int V_100 )
{
return F_157 ( V_6 , V_330 ) + ( V_100 / 8 * 4 ) ;
}
static T_1 F_158 ( int V_100 )
{
return 0x0f << ( 28 - ( ( V_100 % 8 ) * 4 ) ) ;
}
static T_1 F_159 ( struct V_5 * V_6 , int V_100 )
{
return ( 0x08 >> ( V_6 -> V_389 << 1 ) ) << ( 28 - ( ( V_100 % 8 ) * 4 ) ) ;
}
...
V_8 = F_156 ( V_6 , V_100 ) ;
V_390 = F_6 ( V_8 ) ;
F_4 ( V_390 | F_159 ( V_6 , V_100 ) , V_8 ) ;
}
static bool F_161 ( struct V_1 * V_2 ,
int V_100 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
T_1 V_391 , V_392 , V_390 ;
void * V_8 ;
V_8 = F_156 ( V_6 , V_100 ) ;
V_391 = F_158 ( V_100 ) ;
V_392 = F_159 ( V_6 , V_100 ) & ~ V_391 ;
V_390 = F_6 ( V_8 ) ;
F_4 ( V_390 & ~ V_391 , V_8 ) ;
return V_390 & V_392 ;
}
...
static int F_165 ( struct V_1 * V_2 , void * T_7 ,
const T_10 * V_10 )
{
T_1 V_396 ;
V_396 = V_10 [ 0 ] << 24 | V_10 [ 1 ] << 16 | V_10 [ 2 ] << 8 | V_10 [ 3 ] ;
F_4 ( V_396 , T_7 ) ;
if ( F_162 ( V_2 ) < 0 )
return - V_397 ;
V_396 = V_10 [ 4 ] << 8 | V_10 [ 5 ] ;
F_4 ( V_396 , T_7 + 4 ) ;
if ( F_162 ( V_2 ) < 0 )
return - V_397 ;
return 0 ;
}
static void F_166 ( void * T_7 , T_10 * V_10 )
{
T_1 V_396 ;
V_396 = F_6 ( T_7 ) ;
V_10 [ 0 ] = ( V_396 >> 24 ) & 0xff ;
V_10 [ 1 ] = ( V_396 >> 16 ) & 0xff ;
V_10 [ 2 ] = ( V_396 >> 8 ) & 0xff ;
V_10 [ 3 ] = V_396 & 0xff ;
V_396 = F_6 ( T_7 + 4 ) ;
V_10 [ 4 ] = ( V_396 >> 8 ) & 0xff ;
...
int V_54 ;
T_10 V_399 [ V_81 ] ;
F_14 ( V_6 , F_163 ( V_6 , V_329 ) &
~ ( 1 << ( 31 - V_100 ) ) , V_329 ) ;
memset ( V_399 , 0 , sizeof( V_399 ) ) ;
V_54 = F_165 ( V_2 , V_8 + V_100 * 8 , V_399 ) ;
if ( V_54 < 0 )
return V_54 ;
return 0 ;
}
static int F_171 ( struct V_1 * V_2 , const T_10 * V_10 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
void * V_8 = F_157 ( V_6 , V_334 ) ;
int V_36 , V_54 ;
...
if ( V_36 < 0 )
return - V_143 ;
V_54 = F_165 ( V_2 , V_8 + V_36 * 8 , V_10 ) ;
if ( V_54 < 0 )
return V_54 ;
F_14 ( V_6 , F_163 ( V_6 , V_329 ) |
( 1 << ( 31 - V_36 ) ) , V_329 ) ;
...
static int F_172 ( struct V_1 * V_2 , const T_10 * V_10 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
int V_36 , V_54 ;
if ( ! V_6 -> V_38 -> V_306 )
...
if ( V_2 -> V_276 & V_407 ) {
F_173 ( V_2 ) ;
V_401 = ( V_401 & ~ V_404 ) | V_403 ;
} else if ( V_6 -> V_38 -> V_306 ) {
struct V_408 * V_409 ;
F_177 (ha, ndev) {
if ( V_402 && F_175 ( V_409 -> V_10 ) )
continue;
if ( F_171 ( V_2 , V_409 -> V_10 ) < 0 ) {
if ( ! V_402 ) {
F_174 ( V_2 ) ;
V_401 &= ~ V_404 ;
V_402 = 1 ;
...
int V_54 ;
struct V_87 * V_88 ;
struct V_421 * V_221 = V_6 -> V_221 ;
struct V_422 * V_110 = & V_6 -> V_221 -> V_110 ;
V_88 = F_186 ( V_110 , sizeof( struct V_87 ) , V_142 ) ;
if ( ! V_88 )
return - V_143 ;
V_88 -> V_10 = V_6 -> V_10 + V_6 -> V_8 [ V_288 ] ;
V_88 -> V_90 = V_420 -> V_423 ;
V_88 -> V_85 . V_424 = & V_425 ;
V_6 -> V_272 = F_187 ( & V_88 -> V_85 ) ;
if ( ! V_6 -> V_272 )
return - V_143 ;
...
if ( V_110 -> V_266 ) {
V_54 = F_188 ( V_6 -> V_272 , V_110 -> V_266 ) ;
} else {
if ( V_420 -> V_426 > 0 )
V_6 -> V_272 -> V_245 [ V_420 -> V_427 ] = V_420 -> V_426 ;
V_54 = F_189 ( V_6 -> V_272 ) ;
}
if ( V_54 )
goto V_428;
return 0 ;
...
static const T_2 * F_190 ( int V_429 )
{
const T_2 * V_8 = NULL ;
switch ( V_429 ) {
case V_430 :
...
static struct V_419 * F_191 ( struct V_422 * V_110 )
{
struct V_263 * V_264 = V_110 -> V_266 ;
struct V_419 * V_438 ;
const char * V_439 ;
V_438 = F_186 ( V_110 , sizeof( * V_438 ) , V_142 ) ;
if ( ! V_438 )
return NULL ;
V_438 -> V_16 = F_192 ( V_264 ) ;
V_439 = F_193 ( V_264 ) ;
if ( V_439 )
memcpy ( V_438 -> V_439 , V_439 , V_81 ) ;
V_438 -> V_224 =
F_194 ( V_264 , L_21 ) ;
V_438 -> V_226 =
F_194 ( V_264 , L_22 ) ;
...
static inline struct V_419 * F_191 ( struct V_422 * V_110 )
{
return NULL ;
}
static int F_195 ( struct V_421 * V_221 )
{
struct V_440 * V_441 ;
struct V_419 * V_420 = F_196 ( & V_221 -> V_110 ) ;
const struct V_442 * V_273 = F_197 ( V_221 ) ;
struct V_5 * V_6 ;
struct V_1 * V_2 ;
int V_54 , V_443 ;
V_441 = F_198 ( V_221 , V_444 , 0 ) ;
V_2 = F_199 ( sizeof( struct V_5 ) ) ;
if ( ! V_2 )
return - V_143 ;
F_200 ( & V_221 -> V_110 ) ;
F_118 ( & V_221 -> V_110 ) ;
...
goto V_445;
V_2 -> V_245 = V_54 ;
F_202 ( V_2 , & V_221 -> V_110 ) ;
V_6 = F_2 ( V_2 ) ;
V_6 -> V_104 = V_446 ;
V_6 -> V_120 = V_447 ;
V_6 -> V_10 = F_203 ( & V_221 -> V_110 , V_441 ) ;
if ( F_98 ( V_6 -> V_10 ) ) {
V_54 = F_99 ( V_6 -> V_10 ) ;
goto V_445;
}
V_6 -> V_368 = F_204 ( & V_221 -> V_110 , NULL ) ;
if ( F_98 ( V_6 -> V_368 ) )
V_6 -> V_368 = NULL ;
V_2 -> V_448 = V_441 -> V_449 ;
F_205 ( & V_6 -> V_249 ) ;
V_6 -> V_221 = V_221 ;
if ( V_221 -> V_110 . V_266 )
V_420 = F_191 ( & V_221 -> V_110 ) ;
if ( ! V_420 ) {
F_206 ( & V_221 -> V_110 , L_23 ) ;
V_54 = - V_359 ;
goto V_445;
}
V_6 -> V_269 = V_420 -> V_427 ;
V_6 -> V_16 = V_420 -> V_16 ;
V_6 -> V_224 = V_420 -> V_224 ;
V_6 -> V_226 = V_420 -> V_226 ;
if ( V_273 )
V_6 -> V_38 = (struct V_37 * ) V_273 -> V_450 ;
else
V_6 -> V_38 = (struct V_37 * ) F_207 ( & V_221 -> V_110 ) ;
V_6 -> V_8 = F_190 ( V_6 -> V_38 -> V_429 ) ;
if ( ! V_6 -> V_8 ) {
F_206 ( & V_221 -> V_110 , L_24 ,
V_6 -> V_38 -> V_429 ) ;
V_54 = - V_359 ;
goto V_445;
}
...
if ( V_6 -> V_38 -> V_306 ) {
struct V_440 * V_459 ;
V_459 = F_198 ( V_221 , V_444 , 1 ) ;
V_6 -> V_336 = F_203 ( & V_221 -> V_110 , V_459 ) ;
if ( F_98 ( V_6 -> V_336 ) ) {
V_54 = F_99 ( V_6 -> V_336 ) ;
goto V_445;
}
...
if ( V_6 -> V_38 -> V_145 )
F_1 ( V_2 , 0x1 , V_146 ) ;
V_54 = F_185 ( V_6 , V_420 ) ;
if ( V_54 ) {
if ( V_54 != - V_464 )
F_206 ( & V_221 -> V_110 , L_26 , V_54 ) ;
goto V_445;
}
F_211 ( V_2 , & V_6 -> V_254 , F_87 , 64 ) ;
V_54 = F_212 ( V_2 ) ;
if ( V_54 )
goto V_465;
if ( V_6 -> V_38 -> V_367 && V_6 -> V_368 )
F_213 ( & V_221 -> V_110 , 1 ) ;
F_214 ( V_2 , L_27 ,
( T_1 ) V_2 -> V_448 , V_2 -> V_77 , V_2 -> V_245 ) ;
F_215 ( & V_221 -> V_110 ) ;
F_216 ( V_221 , V_2 ) ;
return V_54 ;
V_465:
...
static int F_220 ( struct V_421 * V_221 )
{
struct V_1 * V_2 = F_221 ( V_221 ) ;
struct V_5 * V_6 = F_2 ( V_2 ) ;
F_222 ( V_2 ) ;
F_217 ( & V_6 -> V_254 ) ;
F_182 ( V_6 ) ;
...
F_143 ( & V_6 -> V_254 ) ;
F_1 ( V_2 , V_228 , V_149 ) ;
F_7 ( V_2 , V_21 , V_466 , V_466 ) ;
F_224 ( V_6 -> V_368 ) ;
return F_225 ( V_2 -> V_245 ) ;
}
...
return V_54 ;
F_227 ( V_6 -> V_368 ) ;
return F_228 ( V_2 -> V_245 ) ;
}
static int F_229 ( struct V_422 * V_110 )
{
struct V_1 * V_2 = F_230 ( V_110 ) ;
struct V_5 * V_6 = F_2 ( V_2 ) ;
int V_54 = 0 ;
if ( ! F_129 ( V_2 ) )
return 0 ;
...
static int F_231 ( struct V_422 * V_110 )
{
struct V_1 * V_2 = F_230 ( V_110 ) ;
struct V_5 * V_6 = F_2 ( V_2 ) ;
int V_54 = 0 ;
...
static int F_232 ( struct V_422 * V_110 )
{
return 0 ;
}
