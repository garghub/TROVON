...
if ( F_93 ( V_160 -> V_403 ) ) {
F_94 ( & V_422 -> V_5 , L_28 ) ;
V_166 = F_95 ( V_160 -> V_403 ) ;
if ( V_166 != - V_431 )
return V_166 ;
}
for ( V_7 = 0 ; V_7 < F_4 ( V_160 -> V_432 ) ; V_7 ++ )
V_160 -> V_432 [ V_7 ] . V_433 = V_434 [ V_7 ] ;
V_166 = F_96 ( & V_422 -> V_5 ,
F_4 ( V_160 -> V_432 ) ,
V_160 -> V_432 ) ;
if ( V_166 ) {
...
V_166 = F_97 ( F_4 ( V_160 -> V_432 ) ,
V_160 -> V_432 ) ;
if ( V_166 ) {
F_24 ( & V_422 -> V_5 , L_30 , V_166 ) ;
return V_166 ;
}
V_167 = F_98 ( V_422 , & V_435 ) ;
if ( F_93 ( V_167 ) ) {
V_166 = F_95 ( V_167 ) ;
F_24 ( & V_422 -> V_5 , L_31 ,
V_166 ) ;
...
switch ( V_165 ) {
case V_436 :
V_160 -> V_167 = F_98 ( V_422 , & V_437 ) ;
V_160 -> V_218 = V_243 ;
break;
case V_438 :
V_160 -> V_167 = F_98 ( V_422 , & V_439 ) ;
V_160 -> V_218 = V_219 ;
break;
default:
F_24 ( & V_422 -> V_5 ,
...
if ( F_93 ( V_160 -> V_167 ) ) {
V_166 = F_95 ( V_160 -> V_167 ) ;
F_24 ( & V_422 -> V_5 , L_33 ,
V_166 ) ;
return V_166 ;
}
F_30 ( V_160 -> V_167 , V_3 , 0 ) ;
V_166 = F_99 ( V_160 -> V_167 , V_442 ,
F_4 ( V_442 ) ) ;
if ( V_166 != 0 )
F_100 ( & V_422 -> V_5 , L_34 , V_166 ) ;
if ( V_160 -> V_218 == V_219 ) {
V_166 = F_99 ( V_160 -> V_167 , V_443 ,
F_4 ( V_443 ) ) ;
if ( V_166 != 0 )
F_100 ( & V_422 -> V_5 , L_35 ,
V_166 ) ;
}
...
F_102 ( & V_160 -> V_373 , F_65 ) ;
F_102 ( & V_160 -> V_171 , F_70 ) ;
if ( V_160 -> V_422 -> V_411 ) {
V_166 = F_103 ( V_160 -> V_422 -> V_411 , NULL , F_64 ,
V_486 | V_487
| V_488 , L_36 , V_160 ) ;
if ( V_166 ) {
...
V_491:
if ( V_160 -> V_422 -> V_411 )
F_105 ( V_160 -> V_422 -> V_411 , V_160 ) ;
V_441:
F_106 ( F_4 ( V_160 -> V_432 ) , V_160 -> V_432 ) ;
return V_166 ;
}
static int F_107 ( struct V_421 * V_422 )
{
struct V_159 * V_160 = F_108 ( V_422 ) ;
if ( V_422 -> V_411 )
F_105 ( V_422 -> V_411 , V_160 ) ;
F_109 ( & V_160 -> V_373 ) ;
F_109 ( & V_160 -> V_171 ) ;
F_110 ( & V_422 -> V_5 ) ;
F_106 ( F_4 ( V_160 -> V_432 ) , V_160 -> V_432 ) ;
