...
{
T_3 V_194 = F_196 ( V_72 ) ? F_197 ( V_72 ) : 0 ;
F_198 ( V_72 ) -> V_195 = V_72 -> V_120 ;
if ( F_199 ( V_194 >= V_3 -> V_181 ) ) {
do {
V_194 -= V_3 -> V_181 ;
...
static void F_200 ( struct V_2 * V_3 , int V_196 )
{
struct V_14 * V_14 = F_182 ( V_3 ) ;
struct V_1 * V_5 ;
int V_197 ;
...
static int F_206 ( struct V_2 * V_3 , void * V_200 )
{
struct V_8 * V_9 = V_200 ;
struct V_14 * V_14 = F_182 ( V_3 ) ;
struct V_1 * V_5 ;
if ( V_3 -> type == V_201 && ! F_207 ( V_9 -> V_10 ) )
return - V_202 ;
...
static int F_208 ( struct V_2 * V_3 , int V_204 )
{
struct V_14 * V_14 = F_182 ( V_3 ) ;
struct V_1 * V_5 ;
int V_34 ;
...
static void
F_210 ( struct V_2 * V_3 , struct V_207 * V_208 )
{
struct V_14 * V_14 = F_182 ( V_3 ) ;
struct V_101 * V_200 ;
...
int V_33 ;
F_211 (i) {
V_200 = F_212 ( V_14 -> V_102 , V_33 ) ;
do {
V_209 = F_213 ( & V_200 -> V_103 ) ;
V_104 = V_200 -> V_104 ;
V_105 = V_200 -> V_105 ;
V_109 = V_200 -> V_109 ;
V_188 = V_200 -> V_188 ;
V_189 = V_200 -> V_189 ;
} while ( F_214 ( & V_200 -> V_103 , V_209 ) );
V_208 -> V_104 += V_104 ;
V_208 -> V_105 += V_105 ;
V_208 -> V_210 += V_109 ;
V_208 -> V_188 += V_188 ;
...
static int F_215 ( struct V_2 * V_3 , T_10 V_211 , T_3 V_212 )
{
struct V_14 * V_14 = F_182 ( V_3 ) ;
struct V_1 * V_5 ;
int V_34 ;
F_122 ( & V_14 -> V_145 ) ;
F_17 (port, &team->port_list, list) {
V_34 = F_216 ( V_5 -> V_3 , V_211 , V_212 ) ;
if ( V_34 )
goto V_206;
}
F_123 ( & V_14 -> V_145 ) ;
...
V_206:
F_209 (port, &team->port_list, list)
F_217 ( V_5 -> V_3 , V_211 , V_212 ) ;
F_123 ( & V_14 -> V_145 ) ;
return V_34 ;
}
static int F_218 ( struct V_2 * V_3 , T_10 V_211 , T_3 V_212 )
{
struct V_14 * V_14 = F_182 ( V_3 ) ;
struct V_1 * V_5 ;
F_122 ( & V_14 -> V_145 ) ;
...
F_204 () ;
V_160 = F_226 ( V_160 , V_215 ) ;
return V_160 ;
}
static int F_227 ( struct V_2 * V_3 , bool V_217 )
{
struct V_14 * V_14 = F_182 ( V_3 ) ;
V_14 -> V_75 = true ;
if ( V_217 )
...
struct V_218 * V_219 )
{
F_230 ( V_219 -> V_220 , V_221 , sizeof( V_219 -> V_220 ) ) ;
F_230 ( V_219 -> V_222 , V_223 , sizeof( V_219 -> V_222 ) ) ;
}
...
V_3 -> V_234 = true ;
V_3 -> V_235 = F_191 ;
V_3 -> V_142 &= ~ ( V_139 | V_236 ) ;
V_3 -> V_142 |= V_237 ;
V_3 -> V_142 |= V_238 ;
V_3 -> V_142 |= V_239 | V_240 ;
V_3 -> V_160 |= V_241 ;
V_3 -> V_160 |= V_242 ;
V_3 -> V_160 |= V_243 ;
V_3 -> V_244 = V_132 |
...
static int F_238 ( struct V_248 * V_249 , struct V_2 * V_3 ,
struct V_250 * V_251 [] , struct V_250 * V_176 [] )
{
if ( V_251 [ V_252 ] == NULL )
F_239 ( V_3 ) ;
return F_240 ( V_3 ) ;
}
static int F_241 ( struct V_250 * V_251 [] , struct V_250 * V_176 [] )
{
if ( V_251 [ V_252 ] ) {
if ( F_242 ( V_251 [ V_252 ] ) != V_253 )
return - V_66 ;
if ( ! F_207 ( F_243 ( V_251 [ V_252 ] ) ) )
return - V_202 ;
}
return 0 ;
}
...
static int F_246 ( struct V_71 * V_72 , struct V_256 * V_16 )
{
struct V_71 * V_257 ;
void * V_258 ;
int V_34 ;
V_257 = F_247 ( V_259 , V_35 ) ;
if ( ! V_257 )
return - V_36 ;
V_258 = F_248 ( V_257 , V_16 -> V_260 , V_16 -> V_261 ,
& V_262 , 0 , V_263 ) ;
if ( ! V_258 ) {
V_34 = - V_264 ;
goto V_265;
...
F_249 ( V_257 , V_258 ) ;
return F_250 ( F_251 ( V_16 ) , V_257 , V_16 -> V_260 ) ;
V_265:
F_252 ( V_257 ) ;
return V_34 ;
}
static struct V_14 * F_253 ( struct V_256 * V_16 )
{
struct V_248 * V_248 = F_251 ( V_16 ) ;
int V_266 ;
struct V_2 * V_3 ;
struct V_14 * V_14 ;
if ( ! V_16 -> V_267 [ V_268 ] )
return NULL ;
V_266 = F_254 ( V_16 -> V_267 [ V_268 ] ) ;
V_3 = F_255 ( V_248 , V_266 ) ;
...
static int F_257 ( struct V_71 * V_72 , struct V_14 * V_14 , T_4 V_269 )
{
return F_250 ( F_258 ( V_14 -> V_3 ) , V_72 , V_269 ) ;
}
static int F_259 ( struct V_71 * V_72 , struct V_14 * V_14 ,
struct V_28 * V_29 )
{
struct V_250 * V_270 ;
...
if ( V_34 )
return V_34 ;
V_270 = F_260 ( V_72 , V_271 ) ;
if ( ! V_270 )
return - V_264 ;
if ( F_261 ( V_72 , V_272 , V_26 -> V_27 ) )
goto V_273;
if ( V_58 -> V_5 &&
F_262 ( V_72 , V_274 ,
V_58 -> V_5 -> V_3 -> V_266 ) )
...
switch ( V_26 -> type ) {
case V_276 :
if ( F_263 ( V_72 , V_277 , V_278 ) )
goto V_273;
if ( F_262 ( V_72 , V_279 , V_53 . V_176 . V_178 ) )
goto V_273;
break;
case V_280 :
if ( F_263 ( V_72 , V_277 , V_281 ) )
goto V_273;
if ( F_261 ( V_72 , V_279 ,
V_53 . V_176 . V_177 ) )
goto V_273;
break;
case V_282 :
if ( F_263 ( V_72 , V_277 , V_283 ) )
goto V_273;
if ( F_264 ( V_72 , V_279 , V_53 . V_176 . V_284 . V_106 ,
V_53 . V_176 . V_284 . V_285 ) )
goto V_273;
break;
case V_286 :
if ( F_263 ( V_72 , V_277 , V_287 ) )
goto V_273;
if ( V_53 . V_176 . V_179 &&
F_265 ( V_72 , V_279 ) )
goto V_273;
break;
case V_288 :
if ( F_263 ( V_72 , V_277 , V_289 ) )
goto V_273;
if ( F_266 ( V_72 , V_279 , V_53 . V_176 . V_180 ) )
goto V_273;
break;
default:
F_267 () ;
}
if ( V_29 -> V_39 && F_265 ( V_72 , V_290 ) )
goto V_273;
if ( V_29 -> V_38 ) {
if ( F_265 ( V_72 , V_291 ) )
goto V_273;
...
static int F_270 ( struct V_71 * * V_96 ,
struct V_14 * V_14 , T_4 V_269 ,
T_11 * V_292 )
{
int V_34 ;
if ( * V_96 ) {
V_34 = V_292 ( * V_96 , V_14 , V_269 ) ;
if ( V_34 )
return V_34 ;
}
* V_96 = F_271 ( V_293 , V_35 ) ;
if ( ! * V_96 )
return - V_36 ;
return 0 ;
}
static int F_272 ( struct V_14 * V_14 , T_4 V_269 , T_4 V_294 ,
int V_158 , T_11 * V_292 ,
struct V_112 * V_295 )
{
struct V_250 * V_50 ;
struct V_296 * V_297 ;
...
struct V_28 , V_299 ) ;
V_300:
V_34 = F_270 ( & V_72 , V_14 , V_269 , V_292 ) ;
if ( V_34 )
return V_34 ;
V_258 = F_248 ( V_72 , V_269 , V_294 , & V_262 , V_158 | V_301 ,
V_302 ) ;
if ( ! V_258 ) {
F_252 ( V_72 ) ;
return - V_264 ;
}
if ( F_262 ( V_72 , V_268 , V_14 -> V_3 -> V_266 ) )
goto V_303;
V_50 = F_260 ( V_72 , V_304 ) ;
if ( ! V_50 )
goto V_303;
V_33 = 0 ;
V_298 = false ;
F_274 (opt_inst, sel_opt_inst_list, tmp_list) {
V_34 = F_259 ( V_72 , V_14 , V_29 ) ;
if ( V_34 ) {
if ( V_34 == - V_264 ) {
if ( ! V_33 )
goto V_305;
...
goto V_300;
V_306:
V_297 = F_275 ( V_72 , V_269 , V_294 , V_307 , 0 , V_158 | V_301 ) ;
if ( ! V_297 ) {
V_34 = F_270 ( & V_72 , V_14 , V_269 , V_292 ) ;
if ( V_34 )
goto V_305;
...
static int F_277 ( struct V_71 * V_72 , struct V_256 * V_16 )
{
struct V_14 * V_14 ;
struct V_28 * V_29 ;
int V_34 ;
...
return - V_66 ;
F_17 (opt_inst, &team->option_inst_list, list)
F_25 ( & V_29 -> V_299 , & V_295 ) ;
V_34 = F_272 ( V_14 , V_16 -> V_260 , V_16 -> V_261 ,
V_308 , F_257 ,
& V_295 ) ;
F_256 ( V_14 ) ;
return V_34 ;
}
static int F_279 ( struct V_71 * V_72 , struct V_256 * V_16 )
{
struct V_14 * V_14 ;
int V_34 = 0 ;
int V_33 ;
...
char * V_25 ;
bool V_321 = false ;
if ( F_282 ( V_309 ) != V_271 ) {
V_34 = - V_66 ;
goto V_311;
}
V_34 = F_283 ( V_312 , V_313 ,
V_309 , V_322 ,
V_16 -> V_323 ) ;
if ( V_34 )
goto V_311;
...
V_315 = V_312 [ V_279 ] ;
if ( V_317 != V_286 && ! V_315 ) {
V_34 = - V_66 ;
goto V_311;
}
V_25 = F_243 ( V_312 [ V_272 ] ) ;
V_314 = V_312 [ V_274 ] ;
if ( V_314 )
V_318 = F_254 ( V_314 ) ;
V_314 = V_312 [ V_275 ] ;
...
switch ( V_317 ) {
case V_276 :
V_53 . V_176 . V_178 = F_254 ( V_315 ) ;
break;
case V_280 :
if ( F_242 ( V_315 ) > V_325 ) {
V_34 = - V_66 ;
goto V_311;
}
V_53 . V_176 . V_177 = F_243 ( V_315 ) ;
break;
case V_282 :
V_53 . V_176 . V_284 . V_106 = F_242 ( V_315 ) ;
V_53 . V_176 . V_284 . V_285 = F_243 ( V_315 ) ;
break;
case V_286 :
V_53 . V_176 . V_179 = V_315 ? true : false ;
break;
case V_288 :
V_53 . V_176 . V_180 = F_285 ( V_315 ) ;
break;
default:
F_267 () ;
}
...
static int F_288 ( struct V_71 * V_72 ,
struct V_1 * V_5 )
{
struct V_250 * V_326 ;
V_326 = F_260 ( V_72 , V_327 ) ;
if ( ! V_326 )
goto V_273;
if ( F_262 ( V_72 , V_328 , V_5 -> V_3 -> V_266 ) )
goto V_273;
if ( V_5 -> V_38 ) {
if ( F_265 ( V_72 , V_329 ) )
goto V_273;
...
( V_5 -> V_23 . V_18 &&
F_265 ( V_72 , V_331 ) ) ||
F_262 ( V_72 , V_332 , V_5 -> V_23 . V_333 ) ||
F_263 ( V_72 , V_334 , V_5 -> V_23 . V_335 ) )
goto V_273;
F_268 ( V_72 , V_326 ) ;
return 0 ;
V_273:
...
static int F_289 ( struct V_14 * V_14 , T_4 V_269 , T_4 V_294 ,
int V_158 , T_11 * V_292 ,
struct V_1 * V_336 )
{
struct V_250 * V_83 ;
...
if ( F_262 ( V_72 , V_268 , V_14 -> V_3 -> V_266 ) )
goto V_303;
V_83 = F_260 ( V_72 , V_338 ) ;
if ( ! V_83 )
goto V_303;
V_33 = 0 ;
V_298 = false ;
if ( V_336 ) {
V_34 = F_288 ( V_72 , V_336 ) ;
if ( V_34 )
goto V_305;
} else if ( V_5 ) {
...
static int F_291 ( struct V_71 * V_72 ,
struct V_256 * V_16 )
{
struct V_14 * V_14 ;
int V_34 ;
...
if ( ! V_14 )
return - V_66 ;
V_34 = F_289 ( V_14 , V_16 -> V_260 , V_16 -> V_261 ,
V_308 , F_257 , NULL ) ;
F_256 ( V_14 ) ;
return V_34 ;
}
...
struct V_14 * V_14 , T_4 V_269 )
{
return F_293 ( & V_262 , F_258 ( V_14 -> V_3 ) ,
V_72 , 0 , 0 , V_35 ) ;
}
static int F_287 ( struct V_14 * V_14 ,
struct V_112 * V_295 )
{
return F_272 ( V_14 , 0 , 0 , 0 , F_292 ,
V_295 ) ;
}
static int F_294 ( struct V_14 * V_14 ,
struct V_1 * V_5 )
{
return F_289 ( V_14 , 0 , 0 , 0 , F_292 ,
V_5 ) ;
}
...
V_34 = F_287 ( V_14 , & V_295 ) ;
if ( V_34 && V_34 != - V_339 )
F_299 ( V_14 -> V_3 , L_29 ,
V_34 ) ;
}
static void F_300 ( struct V_1 * V_5 , bool V_18 )
{
int V_34 ;
V_5 -> V_38 = true ;
V_5 -> V_23 . V_18 = V_18 ;
...
if ( V_18 ) {
struct V_340 V_341 ;
V_34 = F_301 ( V_5 -> V_3 , & V_341 ) ;
if ( ! V_34 ) {
V_5 -> V_23 . V_333 = V_341 . V_342 . V_333 ;
V_5 -> V_23 . V_335 = V_341 . V_342 . V_335 ;
goto V_343;
}
}
V_5 -> V_23 . V_333 = 0 ;
V_5 -> V_23 . V_335 = 0 ;
V_343:
V_34 = F_294 ( V_5 -> V_14 , V_5 ) ;
if ( V_34 && V_34 != - V_339 )
F_299 ( V_5 -> V_14 -> V_3 , L_30 ,
V_5 -> V_3 -> V_27 , V_34 ) ;
}
...
static int F_304 ( struct V_345 * V_346 ,
unsigned long V_347 , void * V_285 )
{
struct V_2 * V_3 = F_305 ( V_285 ) ;
struct V_1 * V_5 ;
V_5 = F_3 ( V_3 ) ;
if ( ! V_5 )
return V_348 ;
