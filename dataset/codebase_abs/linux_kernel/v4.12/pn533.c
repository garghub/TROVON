...
{
struct V_31 * V_32 ;
T_1 * V_98 , * V_147 , * V_148 ;
T_1 * V_149 = V_17 -> V_148 ;
...
return NULL ;
* F_24 ( V_32 , 1 ) = V_155 ;
memcpy ( F_24 ( V_32 , 6 ) , V_153 , 6 ) ;
V_98 = F_24 ( V_32 , 18 ) ;
memcpy ( V_98 , V_152 , 18 ) ;
F_79 ( V_98 + 2 , 6 ) ;
V_147 = F_24 ( V_32 , 10 ) ;
memset ( V_147 , 0 , 10 ) ;
memcpy ( V_147 , V_98 , 8 ) ;
* F_24 ( V_32 , 1 ) = V_150 ;
V_148 = F_24 ( V_32 , V_150 ) ;
memcpy ( V_148 , V_149 , V_150 ) ;
* F_24 ( V_32 , 1 ) = 0 ;
return V_32 ;
}
static int F_80 ( struct V_16 * V_17 , void * V_68 ,
struct V_31 * V_41 )
{
struct V_31 * V_32 ;
...
int V_43 ;
F_26 ( V_17 -> V_17 , L_8 , V_44 ) ;
V_32 = F_89 ( & V_17 -> V_167 ) ;
if ( V_32 == NULL ) {
F_90 ( & V_17 -> V_167 ) ;
goto error;
}
if ( F_91 ( & V_17 -> V_167 ) == 0 ) {
...
static int F_94 ( struct V_16 * V_17 , struct V_31 * V_41 )
{
T_1 V_173 , * V_29 , V_174 = V_175 , * V_148 ;
T_5 V_151 ;
int V_43 ;
F_26 ( V_17 -> V_17 , L_8 , V_44 ) ;
...
V_17 -> V_183 = 1 ;
F_74 ( V_17 ) ;
F_97 ( V_17 -> V_64 , & V_17 -> V_184 ,
F_98 ( V_185 ) ) ;
}
static int F_99 ( struct V_16 * V_17 , void * V_68 ,
struct V_31 * V_41 )
{
int V_43 = 0 ;
F_26 ( V_17 -> V_17 , L_8 , V_44 ) ;
...
static int F_101 ( struct V_16 * V_17 , void * V_68 ,
struct V_31 * V_41 )
{
struct V_190 * V_191 ;
struct V_79 V_79 ;
...
V_17 -> V_194 = V_195 ;
V_192 = V_41 -> V_15 - 17 ;
V_43 = F_102 ( V_17 -> V_136 ,
V_191 -> V_196 , V_192 ) ;
if ( ! V_43 ) {
V_43 = F_103 ( V_17 -> V_136 ,
...
static int F_104 ( struct V_136 * V_136 )
{
struct V_16 * V_17 = F_105 ( V_136 ) ;
struct V_31 * V_32 ;
int V_43 , V_154 ;
...
if ( ! V_17 -> V_148 ) {
V_17 -> V_148 = F_106 ( V_136 , & V_17 -> V_151 ) ;
if ( ! V_17 -> V_148 || ! V_17 -> V_151 ) {
V_17 -> V_146 = 0 ;
F_44 ( V_17 -> V_64 , & V_17 -> V_186 ) ;
}
}
...
V_200 = F_24 ( V_32 , 1 ) ;
* V_200 = 0 ;
memcpy ( F_24 ( V_32 , V_203 ) , V_202 , V_203 ) ;
* V_200 |= 1 ;
memcpy ( F_24 ( V_32 , V_201 ) , V_147 ,
V_201 ) ;
* V_200 |= 2 ;
memcpy ( F_24 ( V_32 , V_17 -> V_151 ) , V_17 -> V_148 , V_17 -> V_151 ) ;
* V_200 |= 4 ;
...
static int F_107 ( struct V_16 * V_17 , void * V_68 ,
struct V_31 * V_41 )
{
struct V_140 * V_205 ;
int V_43 ;
...
if ( ! V_32 )
return NULL ;
memcpy ( F_24 ( V_32 , V_209 -> V_15 ) , & V_209 -> V_2 , V_209 -> V_15 ) ;
return V_32 ;
}
...
V_7 = V_211 ;
V_32 = F_109 ( V_17 , V_209 ) ;
}
if ( ! V_32 ) {
F_71 ( V_17 -> V_17 , L_21 ) ;
return - V_52 ;
}
V_43 = F_40 ( V_17 , V_7 , V_32 , F_107 ,
NULL ) ;
if ( V_43 < 0 ) {
F_27 ( V_32 ) ;
...
F_112 ( & V_17 -> V_208 , V_214 + V_215 * V_216 ) ;
}
static int F_113 ( struct V_136 * V_136 ,
T_4 V_142 , T_4 V_143 )
{
struct V_16 * V_17 = F_105 ( V_136 ) ;
struct V_140 * V_205 ;
...
static void F_114 ( struct V_136 * V_136 )
{
struct V_16 * V_17 = F_105 ( V_136 ) ;
F_108 ( & V_17 -> V_208 ) ;
if ( ! V_17 -> V_137 ) {
...
V_221 = V_41 -> V_15 - 16 ;
V_43 = F_102 ( V_17 -> V_136 , V_191 -> V_196 , V_221 ) ;
F_27 ( V_41 ) ;
return V_43 ;
}
static int F_117 ( struct V_136 * V_136 ,
...
static int F_118 ( struct V_16 * V_17 , void * V_68 ,
struct V_31 * V_41 )
{
int V_43 = 0 ;
F_26 ( V_17 -> V_17 , L_8 , V_44 ) ;
...
static void F_119 ( struct V_136 * V_136 ,
...
static int F_120 ( struct V_16 * V_17 , void * V_68 ,
struct V_31 * V_41 )
{
struct V_190 * V_191 ;
T_1 V_192 ;
...
static int F_121 ( struct V_136 * V_136 , struct V_79 * V_223 ,
T_1 V_174 , T_1 * V_148 , T_5 V_151 )
{
struct V_16 * V_17 = F_105 ( V_136 ) ;
struct V_31 * V_32 ;
int V_43 , V_154 ;
...
V_201 ) ;
* V_200 |= 2 ;
if ( V_148 != NULL && V_151 > 0 ) {
memcpy ( F_24 ( V_32 , V_151 ) , V_148 , V_151 ) ;
* V_200 |= 4 ;
} else {
* V_200 = 0 ;
}
V_68 = F_122 ( sizeof( * V_68 ) , V_51 ) ;
if ( ! V_68 ) {
F_27 ( V_32 ) ;
return - V_52 ;
}
...
static int F_124 ( struct V_136 * V_136 )
{
struct V_16 * V_17 = F_105 ( V_136 ) ;
F_26 ( V_17 -> V_17 , L_8 , V_44 ) ;
F_72 ( V_17 ) ;
...
if ( F_125 ( & V_17 -> V_158 ) )
return NULL ;
if ( F_91 ( & V_17 -> V_158 ) == 1 ) {
V_32 = F_89 ( & V_17 -> V_158 ) ;
goto V_230;
}
...
static int F_127 ( struct V_16 * V_17 , void * V_66 ,
struct V_31 * V_41 )
{
...
void F_128 ( struct V_16 * V_17 , struct V_31 * V_32 , int V_42 )
{
if ( ! V_17 -> V_29 )
goto V_239;
V_17 -> V_29 -> V_42 = V_42 ;
...
F_130 ( L_47 , V_240 , 16 , 1 , V_32 -> V_2 ,
...
F_56 ( V_243 , 1 ) ;
if ( V_244 == V_245 )
* F_23 ( V_243 , sizeof( T_1 ) ) =
( V_160 | 1 ) ;
else
* F_23 ( V_243 , sizeof( T_1 ) ) = 1 ;
}
memcpy ( F_24 ( V_243 , V_244 ) , V_32 -> V_2 , V_244 ) ;
F_30 ( V_32 , V_244 ) ;
F_83 ( & V_17 -> V_167 , V_243 ) ;
} while ( V_32 -> V_15 > 0 );
F_27 ( V_32 ) ;
return F_91 ( & V_17 -> V_167 ) ;
}
static int F_132 ( struct V_136 * V_136 ,
...
static int F_133 ( struct V_136 * V_136 , struct V_31 * V_32 )
{
struct V_16 * V_17 = F_105 ( V_136 ) ;
int V_43 ;
F_26 ( V_17 -> V_17 , L_8 , V_44 ) ;
...
static void F_134 ( struct V_60 * V_61 )
{
...
static void F_135 ( struct V_60 * V_61 )
{
...
static int F_136 ( struct V_16 * V_17 , T_1 V_253 , T_1 * V_254 ,
T_1 V_255 )
{
struct V_31 * V_32 ;
struct V_31 * V_41 ;
...
if ( ! V_32 )
return - V_52 ;
* F_24 ( V_32 , sizeof( V_253 ) ) = V_253 ;
memcpy ( F_24 ( V_32 , V_255 ) , V_254 , V_255 ) ;
...
static int F_123 ( struct V_136 * V_136 , T_1 V_263 )
{
struct V_16 * V_17 = F_105 ( V_136 ) ;
T_1 V_264 = ! ! V_263 ;
int V_43 ;
V_264 |= V_188 ;
V_43 = F_136 ( V_17 , V_187 ,
( T_1 * ) & V_264 , 1 ) ;
if ( V_43 ) {
F_71 ( V_17 -> V_17 , L_52 ) ;
return V_43 ;
...
static int F_139 ( struct V_136 * V_136 )
{
struct V_16 * V_17 = F_105 ( V_136 ) ;
struct V_31 * V_32 ;
struct V_31 * V_41 ;
...
static int F_140 ( struct V_136 * V_136 )
{
struct V_16 * V_17 = F_105 ( V_136 ) ;
if ( V_17 -> V_246 == V_266 ) {
int V_43 = F_139 ( V_136 ) ;
if ( V_43 )
return V_43 ;
}
return F_123 ( V_136 , 1 ) ;
}
static int F_141 ( struct V_136 * V_136 )
{
return F_123 ( V_136 , 0 ) ;
}
...
V_43 = F_137 ( V_17 , & V_286 ) ;
if ( V_43 ) {
F_71 ( V_17 -> V_17 , L_57 ) ;
return V_43 ;
}
F_144 ( V_17 -> V_17 , L_58 ,
...
V_295 -> V_246 = V_246 ;
F_146 ( & V_295 -> V_53 ) ;
F_147 ( & V_295 -> V_65 , F_45 ) ;
F_147 ( & V_295 -> V_62 , F_42 ) ;
F_147 ( & V_295 -> V_234 , F_134 ) ;
F_147 ( & V_295 -> V_236 , F_135 ) ;
F_147 ( & V_295 -> V_172 , F_93 ) ;
F_147 ( & V_295 -> V_163 , F_87 ) ;
F_147 ( & V_295 -> V_166 , F_88 ) ;
F_148 ( & V_295 -> V_184 , F_111 ) ;
F_147 ( & V_295 -> V_186 , F_100 ) ;
V_295 -> V_64 = F_149 ( L_59 , 0 ) ;
if ( V_295 -> V_64 == NULL )
goto error;
F_150 ( & V_295 -> V_208 ) ;
V_295 -> V_208 . V_2 = ( unsigned long ) V_295 ;
V_295 -> V_208 . V_297 = F_96 ;
F_90 ( & V_295 -> V_158 ) ;
F_90 ( & V_295 -> V_167 ) ;
F_36 ( & V_295 -> V_59 ) ;
V_295 -> V_136 = F_151 ( & V_298 , V_287 ,
V_295 -> V_20 -> V_35 +
V_252 ,
V_295 -> V_20 -> V_36 ) ;
if ( ! V_295 -> V_136 ) {
...
F_152 ( V_295 -> V_136 , V_294 ) ;
F_153 ( V_295 -> V_136 , V_295 ) ;
V_43 = F_154 ( V_295 -> V_136 ) ;
if ( V_43 )
goto V_300;
return V_295 ;
V_300:
...
F_81 ( & V_295 -> V_158 ) ;
F_108 ( & V_295 -> V_208 ) ;
F_159 (cmd, n, &priv->cmd_queue, queue) {
F_48 ( & V_29 -> V_58 ) ;
F_32 ( V_29 ) ;
}
F_32 ( V_295 ) ;
