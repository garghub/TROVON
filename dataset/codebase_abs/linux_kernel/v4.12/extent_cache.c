...
bool F_45 ( struct V_43 * V_43 , struct V_57 * V_58 )
{
struct V_12 * V_13 = F_31 ( V_43 ) ;
struct V_31 * V_32 ;
struct V_30 * V_35 ;
...
static bool F_51 ( struct V_43 * V_43 , T_2 V_61 ,
struct V_33 * V_34 )
{
struct V_12 * V_13 = F_31 ( V_43 ) ;
...
F_52 ( V_43 , V_61 ) ;
F_53 ( & V_32 -> V_51 ) ;
if ( V_32 -> V_54 . V_56 <= V_61 &&
V_32 -> V_54 . V_56 + V_32 -> V_54 . V_4 > V_61 ) {
* V_34 = V_32 -> V_54 ;
V_62 = true ;
F_54 ( V_13 ) ;
goto V_59;
...
static struct V_30 * F_61 ( struct V_43 * V_43 ,
struct V_31 * V_32 , struct V_33 * V_34 ,
struct V_30 * V_63 ,
struct V_30 * V_64 )
{
...
if ( V_63 && F_62 ( V_34 , & V_63 -> V_34 ) ) {
V_63 -> V_34 . V_4 += V_34 -> V_4 ;
V_34 = & V_63 -> V_34 ;
V_35 = V_63 ;
}
if ( V_64 && F_63 ( V_34 , & V_64 -> V_34 ) ) {
V_64 -> V_34 . V_56 = V_34 -> V_56 ;
V_64 -> V_34 . V_65 = V_34 -> V_65 ;
...
static struct V_30 * F_65 ( struct V_43 * V_43 ,
struct V_31 * V_32 , struct V_33 * V_34 ,
struct V_7 * * V_18 ,
struct V_7 * V_19 )
{
...
static void F_66 ( struct V_43 * V_43 ,
T_2 V_56 , T_3 V_67 , unsigned int V_4 )
{
struct V_12 * V_13 = F_31 ( V_43 ) ;
struct V_31 * V_32 = F_39 ( V_43 ) -> V_31 ;
struct V_30 * V_35 = NULL , * V_68 = NULL ;
struct V_30 * V_69 = NULL , * V_70 = NULL ;
struct V_33 V_34 , V_71 , V_72 ;
struct V_7 * * V_18 = NULL , * V_19 = NULL ;
unsigned int V_73 = V_56 + V_4 ;
unsigned int V_74 = ( unsigned int ) V_56 ;
if ( ! V_32 )
return;
F_67 ( V_43 , V_56 , V_67 , V_4 ) ;
F_48 ( & V_32 -> V_51 ) ;
if ( F_68 ( V_43 , V_75 ) ) {
F_50 ( & V_32 -> V_51 ) ;
return;
...
if ( ! V_35 )
V_35 = V_70 ;
while ( V_35 && V_35 -> V_34 . V_56 < V_73 ) {
unsigned int V_76 ;
int V_77 = 0 ;
V_70 = V_68 = NULL ;
V_71 = V_35 -> V_34 ;
V_76 = V_71 . V_56 + V_71 . V_4 ;
F_5 ( V_13 , V_74 >= V_76 ) ;
if ( V_74 > V_71 . V_56 && V_74 - V_71 . V_56 >= V_78 ) {
V_35 -> V_34 . V_4 = V_74 - V_35 -> V_34 . V_56 ;
V_69 = V_35 ;
V_77 = 1 ;
}
if ( V_73 < V_76 && V_76 - V_73 >= V_78 ) {
if ( V_77 ) {
F_69 ( & V_34 , V_73 ,
V_73 - V_71 . V_56 + V_71 . V_65 ,
V_76 - V_73 ) ;
V_68 = F_65 ( V_43 , V_32 , & V_34 ,
NULL , NULL ) ;
V_70 = V_68 ;
} else {
V_35 -> V_34 . V_56 = V_73 ;
V_35 -> V_34 . V_65 += V_73 - V_71 . V_56 ;
V_35 -> V_34 . V_4 -= V_73 - V_71 . V_56 ;
V_70 = V_35 ;
}
V_77 ++ ;
}
...
if ( V_67 ) {
F_69 ( & V_34 , V_56 , V_67 , V_4 ) ;
if ( ! F_61 ( V_43 , V_32 , & V_34 , V_69 , V_70 ) )
F_65 ( V_43 , V_32 , & V_34 ,
V_18 , V_19 ) ;
if ( V_71 . V_4 >= 1 &&
V_72 . V_4 < V_78 &&
...
unsigned int F_71 ( struct V_12 * V_13 , int V_80 )
{
...
if ( ! F_73 ( & V_13 -> V_46 ) )
goto V_59;
F_74 (et, next, &sbi->zombie_list, list) {
if ( F_42 ( & V_32 -> V_39 ) ) {
F_48 ( & V_32 -> V_51 ) ;
V_39 += F_41 ( V_13 , V_32 ) ;
F_50 ( & V_32 -> V_51 ) ;
...
unsigned int F_80 ( struct V_43 * V_43 )
{
struct V_12 * V_13 = F_31 ( V_43 ) ;
struct V_31 * V_32 = F_39 ( V_43 ) -> V_31 ;
unsigned int V_39 = 0 ;
...
bool F_85 ( struct V_43 * V_43 , T_2 V_61 ,
struct V_33 * V_34 )
{
if ( ! F_46 ( V_43 ) )
return false ;
return F_51 ( V_43 , V_61 , V_34 ) ;
}
...
V_67 = V_89 -> V_90 ;
V_56 = F_87 ( F_88 ( V_89 -> V_93 ) , V_89 -> V_43 ) +
V_89 -> V_94 ;
F_66 ( V_89 -> V_43 , V_56 , V_67 , 1 ) ;
}
void F_89 ( struct V_88 * V_89 ,
T_2 V_56 , T_3 V_67 , unsigned int V_4 )
{
if ( ! F_46 ( V_89 -> V_43 ) )
return;
F_66 ( V_89 -> V_43 , V_56 , V_67 , V_4 ) ;
}
