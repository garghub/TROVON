...
static void F_149 ( struct V_9 * V_10 , struct V_18 * V_19 )
{
struct V_299 * V_289 = V_10 -> V_256 -> V_257 ;
if ( F_150 ( V_289 , V_19 -> V_6 . V_52 , V_19 -> V_6 . V_64 >> 9 ,
V_213 , 0 ) )
V_19 -> V_69 |= V_300 ;
F_151 ( V_19 ) ;
}
...
if ( F_153 ( V_289 , V_203 , V_301 , V_213 , V_19 -> V_67 ) )
V_19 -> V_69 |= V_300 ;
F_151 ( V_19 ) ;
}
...
F_155 ( V_19 -> V_29 -> V_27 ) ;
V_19 -> V_65 = V_66 ;
V_19 -> V_69 |= V_310 ;
if ( F_62 ( & V_19 -> V_20 . V_21 ) ) {
F_20 ( & V_10 -> V_24 -> V_25 ) ;
F_156 ( & V_19 -> V_20 . V_21 , & V_10 -> V_311 ) ;
F_21 ( & V_10 -> V_24 -> V_25 ) ;
}
if ( V_19 -> V_69 & V_308 )
F_149 ( V_10 , V_19 ) ;
...
static int F_163 ( struct V_26 * V_27 , struct V_171 * V_172 )
{
int V_95 ;
...
F_11 ( & V_27 -> V_274 ) ;
if ( F_26 ( & V_27 -> V_282 -> V_271 ) ) {
F_164 ( & V_268 -> V_21 , & V_27 -> V_282 -> V_21 ) ;
V_27 -> V_282 = V_268 ;
V_27 -> V_284 ++ ;
} else {
F_52 ( V_268 ) ;
...
static void F_165 ( struct V_324 * V_194 ,
struct V_18 * V_325 , void * V_326 ,
unsigned int V_54 )
{
unsigned int V_4 = V_325 -> V_6 . V_64 ;
V_325 -> V_6 . V_64 = V_54 ;
F_166 ( V_194 , V_325 , V_326 ) ;
V_325 -> V_6 . V_64 = V_4 ;
}
static struct V_18 *
F_167 ( struct V_28 * V_29 , T_2 V_51 , T_3 V_52 ,
struct V_171 * V_172 ) __must_hold( T_5 )
{
struct V_9 * V_10 = V_29 -> V_10 ;
const T_3 V_327 = F_168 ( V_10 -> V_328 ) ;
struct V_18 * V_19 ;
struct V_1 * V_1 ;
int V_329 , V_77 ;
...
if ( V_306 != F_170 ( V_10 -> V_341 ) ) {
F_45 ( V_29 , L_36 ,
V_306 , F_170 ( V_10 -> V_341 ) ) ;
return NULL ;
}
if ( V_306 != F_171 ( V_10 -> V_256 -> V_257 ) ) {
F_45 ( V_29 , L_37 ,
V_306 , F_171 ( V_10 -> V_256 -> V_257 ) ) ;
return NULL ;
}
V_330 = F_125 ( V_338 -> V_64 ) ;
}
if ( ! F_55 ( F_172 ( V_330 , 512 ) ) )
return NULL ;
if ( V_336 || V_338 ) {
...
if ( V_329 ) {
F_165 ( V_29 -> V_27 -> V_340 , V_19 , V_333 , V_306 ) ;
...
static int F_175 ( struct V_28 * V_29 , int V_306 )
{
struct V_1 * V_1 ;
int V_77 = 0 ;
void * V_96 ;
...
static int F_176 ( struct V_28 * V_29 , struct V_346 * V_347 ,
T_3 V_52 , int V_306 )
{
struct V_348 V_349 ;
struct V_350 V_351 ;
...
F_177 (bvec, bio, iter) {
void * V_353 = F_173 ( V_349 . V_354 ) + V_349 . V_355 ;
...
if ( V_329 ) {
F_178 ( V_29 -> V_27 -> V_340 , V_244 , V_333 ) ;
if ( memcmp ( V_331 , V_333 , V_329 ) ) {
F_45 ( V_29 , L_42 ) ;
return - V_234 ;
}
...
static int F_179 ( struct V_357 * V_20 , int V_358 )
{
struct V_18 * V_19 =
F_180 ( V_20 , struct V_18 , V_20 ) ;
struct V_28 * V_29 = V_19 -> V_29 ;
struct V_9 * V_10 = V_29 -> V_10 ;
T_3 V_52 = V_19 -> V_6 . V_52 ;
int V_77 ;
F_53 ( V_10 , F_54 ( & V_19 -> V_6 ) ) ;
if ( F_181 ( ( V_19 -> V_69 & V_300 ) == 0 ) ) {
F_182 ( V_10 , V_52 , V_19 -> V_6 . V_64 ) ;
V_77 = F_183 ( V_29 , V_359 , V_19 ) ;
} else {
F_184 ( V_10 , V_52 , V_19 -> V_6 . V_64 ) ;
V_77 = F_183 ( V_29 , V_360 , V_19 ) ;
}
F_185 ( V_10 ) ;
return V_77 ;
}
static int F_186 ( struct V_28 * V_29 , T_3 V_52 ,
struct V_171 * V_172 ) __releases( T_5 )
{
struct V_9 * V_10 = V_29 -> V_10 ;
struct V_18 * V_19 ;
V_19 = F_167 ( V_29 , V_361 , V_52 , V_172 ) ;
if ( ! V_19 )
goto V_63;
F_187 ( V_10 ) ;
F_188 ( V_10 ) ;
V_19 -> V_20 . V_80 = F_179 ;
V_19 -> V_65 = V_66 ;
F_20 ( & V_10 -> V_24 -> V_25 ) ;
F_156 ( & V_19 -> V_20 . V_21 , & V_10 -> V_362 ) ;
F_21 ( & V_10 -> V_24 -> V_25 ) ;
F_38 ( V_172 -> V_64 >> 9 , & V_10 -> V_363 ) ;
if ( F_154 ( V_10 , V_19 , V_364 , 0 ,
V_365 ) == 0 )
return 0 ;
F_45 ( V_10 , L_43 ) ;
F_20 ( & V_10 -> V_24 -> V_25 ) ;
...
static struct V_346 *
F_189 ( struct V_9 * V_10 , struct V_366 * V_367 , T_2 V_51 ,
T_3 V_52 , bool V_368 , const char * V_369 )
{
struct V_346 * V_347 ;
V_347 = (struct V_346 * ) ( unsigned long ) V_51 ;
if ( F_190 ( V_367 , V_52 , & V_347 -> V_6 ) && V_347 -> V_6 . T_5 )
return V_347 ;
if ( ! V_368 ) {
...
static int F_191 ( struct V_26 * V_27 , struct V_171 * V_172 )
{
struct V_28 * V_29 ;
struct V_9 * V_10 ;
struct V_346 * V_347 ;
...
V_29 = F_192 ( V_27 , V_172 -> V_30 ) ;
if ( ! V_29 )
return - V_108 ;
V_10 = V_29 -> V_10 ;
V_52 = F_193 ( V_322 -> V_52 ) ;
F_20 ( & V_10 -> V_24 -> V_25 ) ;
V_347 = F_189 ( V_10 , & V_10 -> V_371 , V_322 -> V_68 , V_52 , false , V_62 ) ;
F_21 ( & V_10 -> V_24 -> V_25 ) ;
if ( F_194 ( ! V_347 ) )
return - V_108 ;
V_77 = F_176 ( V_29 , V_347 , V_52 , V_172 -> V_64 ) ;
if ( ! V_77 )
F_195 ( V_347 , V_372 ) ;
return V_77 ;
}
static int F_196 ( struct V_26 * V_27 , struct V_171 * V_172 )
{
struct V_28 * V_29 ;
struct V_9 * V_10 ;
T_3 V_52 ;
...
if ( F_139 ( V_10 ) ) {
V_77 = F_186 ( V_29 , V_52 , V_172 ) ;
} else {
if ( F_197 ( & V_373 ) )
F_45 ( V_10 , L_45 ) ;
V_77 = F_175 ( V_29 , V_172 -> V_64 ) ;
F_198 ( V_29 , V_360 , V_322 , V_172 -> V_64 ) ;
}
...
struct V_317 * V_6 ;
struct V_346 * V_347 ;
F_200 (i, &device->write_requests, sector, size) {
if ( ! V_6 -> T_5 )
continue;
V_347 = F_180 ( V_6 , struct V_346 , V_6 ) ;
if ( V_347 -> V_375 & V_376 ||
! ( V_347 -> V_375 & V_377 ) )
continue;
F_201 ( V_347 , V_378 , NULL ) ;
}
}
static int F_202 ( struct V_357 * V_20 , int V_379 )
{
struct V_18 * V_19 =
F_180 ( V_20 , struct V_18 , V_20 ) ;
struct V_28 * V_29 = V_19 -> V_29 ;
...
F_161 ( V_10 , V_19 ) ;
if ( V_19 -> V_69 & V_388 )
F_199 ( V_10 , V_52 , V_19 -> V_6 . V_64 ) ;
F_21 ( & V_10 -> V_24 -> V_25 ) ;
} else
F_53 ( V_10 , F_54 ( & V_19 -> V_6 ) ) ;
F_142 ( V_29 -> V_27 , V_19 -> V_268 , V_276 + ( V_379 ? V_275 : 0 ) ) ;
return V_77 ;
}
static int F_203 ( struct V_357 * V_20 , enum V_168 V_389 )
{
struct V_18 * V_19 =
F_180 ( V_20 , struct V_18 , V_20 ) ;
struct V_28 * V_29 = V_19 -> V_29 ;
int V_77 ;
V_77 = F_183 ( V_29 , V_389 , V_19 ) ;
F_185 ( V_29 -> V_10 ) ;
return V_77 ;
}
static int F_204 ( struct V_357 * V_20 , int V_358 )
{
return F_203 ( V_20 , V_390 ) ;
}
...
return F_203 ( V_20 , V_27 -> V_186 >= 100 ?
V_391 : V_390 ) ;
}
static bool F_206 ( T_7 V_47 , T_7 V_392 )
{
return ( V_393 ) V_47 - ( V_393 ) V_392 > 0 ;
}
static T_7 F_207 ( T_7 V_47 , T_7 V_392 )
{
return F_206 ( V_47 , V_392 ) ? V_47 : V_392 ;
}
static void F_208 ( struct V_28 * V_29 , unsigned int V_184 )
{
struct V_9 * V_10 = V_29 -> V_10 ;
unsigned int V_394 ;
if ( F_69 ( V_205 , & V_29 -> V_27 -> V_69 ) ) {
F_11 ( & V_10 -> V_395 ) ;
V_394 = F_207 ( V_10 -> V_184 , V_184 ) ;
V_10 -> V_184 = V_394 ;
F_12 ( & V_10 -> V_395 ) ;
if ( V_184 == V_394 )
F_41 ( & V_10 -> V_396 ) ;
...
static inline int F_209 ( T_3 V_397 , int V_398 , T_3 V_399 , int V_400 )
{
return ! ( ( V_397 + ( V_398 >> 9 ) <= V_399 ) || ( V_397 >= V_399 + ( V_400 >> 9 ) ) ) ;
}
static bool F_210 ( struct V_9 * V_10 , struct V_18 * V_19 )
{
struct V_18 * V_401 ;
bool V_95 = false ;
F_20 ( & V_10 -> V_24 -> V_25 ) ;
F_211 (rs_req, &device->sync_ee, w.list) {
if ( F_209 ( V_19 -> V_6 . V_52 , V_19 -> V_6 . V_64 ,
...
static int F_212 ( struct V_28 * V_29 , const T_7 V_184 )
{
struct V_9 * V_10 = V_29 -> V_10 ;
F_31 ( V_37 ) ;
long V_180 ;
...
F_11 ( & V_10 -> V_395 ) ;
for (; ; ) {
if ( ! F_206 ( V_184 - 1 , V_10 -> V_184 ) ) {
V_10 -> V_184 = F_207 ( V_10 -> V_184 , V_184 ) ;
break;
}
if ( F_34 ( V_43 ) ) {
V_402 = - V_98 ;
...
static unsigned long F_213 ( T_7 V_405 )
{
...
static void F_215 ( struct V_9 * V_10 , T_3 V_52 ,
unsigned int V_64 )
{
struct V_317 * V_6 ;
V_413:
...
V_420 ? L_50 : L_51 ) ;
V_19 -> V_20 . V_80 = V_420 ? F_204 :
F_205 ;
F_156 ( & V_19 -> V_20 . V_21 , & V_10 -> V_78 ) ;
F_221 ( V_27 -> V_225 , & V_19 -> V_29 -> V_421 ) ;
V_77 = - V_422 ;
goto V_104;
} else {
struct V_346 * V_347 =
F_180 ( V_6 , struct V_346 , V_6 ) ;
if ( ! V_418 )
F_220 ( V_10 , L_47
L_52 ,
( unsigned long long ) V_6 -> V_52 , V_6 -> V_64 ,
...
if ( V_347 -> V_375 & V_376 ||
! ( V_347 -> V_375 & V_377 ) ) {
V_77 = F_219 ( V_10 , & V_347 -> V_6 ) ;
if ( V_77 ) {
F_222 ( V_27 , F_72 ( V_105 , V_423 ) , V_107 ) ;
F_215 ( V_10 , V_52 , V_64 ) ;
goto V_104;
}
goto V_413;
}
...
static int F_223 ( struct V_26 * V_27 , struct V_171 * V_172 )
{
struct V_28 * V_29 ;
struct V_9 * V_10 ;
struct V_35 * V_36 ;
...
if ( ! F_139 ( V_10 ) ) {
int V_79 ;
V_77 = F_212 ( V_29 , V_184 ) ;
F_198 ( V_29 , V_360 , V_322 , V_172 -> V_64 ) ;
F_135 ( & V_27 -> V_282 -> V_271 ) ;
V_79 = F_175 ( V_29 , V_172 -> V_64 ) ;
if ( ! V_77 )
V_77 = V_79 ;
return V_77 ;
}
V_52 = F_193 ( V_322 -> V_52 ) ;
V_19 = F_167 ( V_29 , V_322 -> V_68 , V_52 , V_172 ) ;
if ( ! V_19 ) {
F_130 ( V_10 ) ;
return - V_108 ;
}
V_19 -> V_20 . V_80 = F_202 ;
V_19 -> V_65 = V_66 ;
V_19 -> V_69 |= V_426 ;
...
F_224 ( V_10 -> V_81 , ! F_210 ( V_10 , V_19 ) ) ;
if ( V_10 -> V_382 . V_436 < V_437 ) {
F_225 ( V_10 , V_19 -> V_6 . V_52 , V_19 -> V_6 . V_64 ) ;
V_19 -> V_69 &= ~ V_385 ;
F_226 ( V_10 , & V_19 -> V_6 ) ;
V_19 -> V_69 |= V_73 ;
}
V_77 = F_154 ( V_10 , V_19 , V_302 , V_303 ,
V_438 ) ;
if ( ! V_77 )
return 0 ;
F_45 ( V_10 , L_43 ) ;
...
bool F_227 ( struct V_9 * V_10 , T_3 V_52 ,
bool V_439 )
{
struct V_440 * V_4 ;
bool V_441 = F_228 ( V_10 ) ;
if ( ! V_441 || V_439 )
return V_441 ;
F_20 ( & V_10 -> V_442 ) ;
V_4 = F_229 ( V_10 -> V_443 , F_230 ( V_52 ) ) ;
if ( V_4 ) {
struct V_444 * V_445 = F_231 ( V_4 , struct V_444 , V_446 ) ;
...
if ( V_455 == 0 )
return false ;
V_456 = ( int ) F_232 ( & V_449 -> V_457 , V_458 [ 0 ] ) +
( int ) F_232 ( & V_449 -> V_457 , V_458 [ 1 ] ) -
F_26 ( & V_10 -> V_363 ) ;
if ( F_26 ( & V_10 -> V_459 )
|| V_456 - V_10 -> V_460 > 64 ) {
unsigned long V_461 ;
...
V_461 = F_233 ( V_10 ) - V_10 -> V_467 ;
V_453 = ( ( long ) V_66 - ( long ) V_10 -> V_468 [ V_6 ] ) / V_44 ;
if ( ! V_453 )
V_453 ++ ;
V_452 = V_10 -> V_469 [ V_6 ] - V_461 ;
V_454 = F_234 ( V_452 / V_453 ) ;
if ( V_454 > V_455 )
return true ;
}
return false ;
}
static int F_235 ( struct V_26 * V_27 , struct V_171 * V_172 )
{
struct V_28 * V_29 ;
struct V_9 * V_10 ;
T_3 V_52 ;
...
return - V_108 ;
V_10 = V_29 -> V_10 ;
V_327 = F_168 ( V_10 -> V_328 ) ;
V_52 = F_193 ( V_322 -> V_52 ) ;
V_64 = F_125 ( V_322 -> V_474 ) ;
if ( V_64 <= 0 || ! F_172 ( V_64 , 512 ) || V_64 > V_48 ) {
...
switch ( V_172 -> V_169 ) {
case V_476 :
F_237 ( V_29 , V_477 , V_322 ) ;
break;
case V_478 :
case V_479 :
case V_480 :
case V_481 :
F_237 ( V_29 , V_482 , V_322 ) ;
break;
case V_483 :
V_472 = 0 ;
F_187 ( V_10 ) ;
F_238 ( V_29 , V_484 , V_52 , V_64 , V_485 ) ;
break;
default:
F_239 () ;
}
if ( V_472 && F_197 ( & V_373 ) )
F_45 ( V_10 , L_54
L_55 ) ;
return F_175 ( V_29 , V_172 -> V_64 ) ;
}
...
V_304 = V_491 ;
V_10 -> V_492 = F_240 ( V_52 ) ;
break;
case V_483 :
case V_480 :
V_304 = V_491 ;
V_471 = F_134 ( sizeof( * V_471 ) + V_172 -> V_64 , V_213 ) ;
if ( ! V_471 )
goto V_493;
...
V_10 -> V_498 = V_52 ;
V_10 -> V_500 = V_52 ;
V_10 -> V_466 = F_241 ( V_10 ) - F_240 ( V_52 ) ;
...
F_20 ( & V_10 -> V_24 -> V_25 ) ;
F_156 ( & V_19 -> V_20 . V_21 , & V_10 -> V_503 ) ;
F_21 ( & V_10 -> V_24 -> V_25 ) ;
F_242 ( V_27 , F_227 ) ;
if ( V_10 -> V_382 . V_504 != V_505
&& F_227 ( V_10 , V_52 , false ) )
F_243 ( V_44 / 10 ) ;
F_242 ( V_27 , V_506 ) ;
if ( V_506 ( V_10 , V_52 ) )
goto V_493;
...
static int F_244 ( struct V_28 * V_29 ) __must_hold( T_5 )
{
struct V_9 * V_10 = V_29 -> V_10 ;
...
if ( V_530 == - 1 && V_10 -> V_382 . V_532 == V_505 ) {
enum V_196 V_534 ;
V_534 = F_246 ( V_10 , V_198 , F_72 ( V_532 , V_533 ) ) ;
if ( V_534 != V_199 ) {
F_247 ( V_10 , L_60 ) ;
} else {
F_35 ( V_10 , L_61 ) ;
...
static int F_248 ( struct V_28 * V_29 ) __must_hold( T_5 )
{
struct V_9 * V_10 = V_29 -> V_10 ;
int V_530 , V_95 = - 100 ;
enum V_511 V_535 ;
...
static void F_249 ( struct V_9 * V_10 , char * V_536 , T_2 * V_514 ,
T_2 V_537 , T_2 V_69 )
{
if ( ! V_514 ) {
...
static int F_250 ( struct V_9 * const V_10 , enum V_541 const V_542 , int * V_543 ) __must_hold( T_5 )
{
struct V_28 * const V_29 = F_251 ( V_10 ) ;
...
F_249 ( V_10 , L_65 , V_10 -> V_256 -> V_513 . V_514 ,
V_10 -> V_382 . V_449 >= V_547 ? F_233 ( V_10 ) : 0 , 0 ) ;
* V_543 = 34 ;
} else {
F_68 ( V_10 , L_66 ) ;
* V_543 = 36 ;
...
F_249 ( V_10 , L_68 , V_10 -> V_516 , V_10 -> V_516 [ V_517 ] , V_10 -> V_516 [ V_548 ] ) ;
* V_543 = 35 ;
} else {
F_68 ( V_10 , L_69 ) ;
* V_543 = 37 ;
...
if ( V_27 -> V_186 < 91 )
return - 1091 ;
F_253 ( V_10 , V_515 , V_10 -> V_256 -> V_513 . V_514 [ V_539 ] ) ;
F_253 ( V_10 , V_539 , V_10 -> V_256 -> V_513 . V_514 [ V_539 + 1 ] ) ;
F_68 ( V_10 , L_73 ) ;
F_249 ( V_10 , L_65 , V_10 -> V_256 -> V_513 . V_514 ,
V_10 -> V_382 . V_449 >= V_547 ? F_233 ( V_10 ) : 0 , 0 ) ;
return 1 ;
...
static enum V_554 F_254 ( struct V_28 * V_29 ,
enum V_541 V_542 ,
...
F_249 ( V_10 , L_65 , V_10 -> V_256 -> V_513 . V_514 , V_10 -> V_518 , 0 ) ;
F_249 ( V_10 , L_68 , V_10 -> V_516 ,
V_10 -> V_516 [ V_517 ] , V_10 -> V_516 [ V_548 ] ) ;
V_530 = F_250 ( V_10 , V_542 , & V_543 ) ;
...
F_68 ( V_10 , L_98 ,
F_255 ( V_530 > 0 ? V_383 : V_435 ) ,
abs ( V_530 ) >= 2 ? L_99 : L_100 ) ;
return V_557 ;
}
if ( abs ( V_530 ) >= 2 ) {
F_68 ( V_10 , L_101 ) ;
if ( F_256 ( V_10 , & V_571 , L_102 ,
V_572 ) )
return V_557 ;
}
if ( V_530 > 0 ) {
...
static enum V_511 F_257 ( enum V_511 V_504 )
{
if ( V_504 == V_529 )
return V_528 ;
if ( V_504 == V_528 )
...
if ( F_257 ( V_577 ) != V_36 -> V_512 ) {
F_45 ( V_27 , L_105 , L_107 ) ;
goto V_593;
}
if ( F_257 ( V_578 ) != V_36 -> V_531 ) {
F_45 ( V_27 , L_105 , L_108 ) ;
goto V_593;
}
if ( F_257 ( V_579 ) != V_36 -> V_535 ) {
...
V_594 = F_169 ( V_340 ) ;
V_332 = F_134 ( V_594 , V_597 ) ;
V_334 = F_134 ( V_594 , V_597 ) ;
if ( ! ( V_332 && V_334 ) ) {
F_45 ( V_27 , L_114 ) ;
goto V_596;
}
}
V_585 = F_134 ( sizeof( struct V_35 ) , V_597 ) ;
if ( ! V_585 ) {
F_45 ( V_27 , L_115 ) ;
goto V_596;
}
...
* V_585 = * V_584 ;
V_585 -> V_428 = V_580 ;
V_585 -> V_512 = F_257 ( V_577 ) ;
V_585 -> V_531 = F_257 ( V_578 ) ;
V_585 -> V_535 = F_257 ( V_579 ) ;
V_585 -> V_404 = V_582 ;
F_261 ( V_27 -> V_35 , V_585 ) ;
F_120 ( & V_27 -> V_24 -> V_228 ) ;
...
static struct V_324 * F_264 ( const struct V_9 * V_10 ,
const char * V_598 , const char * V_227 )
{
struct V_324 * V_599 ;
if ( ! V_598 [ 0 ] )
return NULL ;
V_599 = F_259 ( V_598 , 0 , V_595 ) ;
if ( F_260 ( V_599 ) ) {
F_45 ( V_10 , L_118 ,
V_598 , V_227 , F_265 ( V_599 ) ) ;
return V_599 ;
}
return V_599 ;
}
...
{
F_35 ( V_27 , L_119 ,
F_268 ( V_172 -> V_169 ) , V_172 -> V_30 ) ;
return F_266 ( V_27 , V_172 ) ;
}
static int F_269 ( struct V_26 * V_27 , struct V_171 * V_172 )
{
struct V_28 * V_29 ;
struct V_9 * V_10 ;
struct V_601 * V_322 ;
...
if ( F_139 ( V_10 ) ) {
V_606 = F_270 ( sizeof( struct V_291 ) , V_597 ) ;
if ( ! V_606 ) {
F_130 ( V_10 ) ;
F_120 ( & V_27 -> V_24 -> V_228 ) ;
F_45 ( V_10 , L_121 ) ;
...
if ( V_603 || V_604 ) {
V_585 = F_270 ( sizeof( struct V_35 ) , V_597 ) ;
if ( ! V_585 ) {
F_45 ( V_10 , L_115 ) ;
goto V_596;
}
...
if ( V_606 ) {
F_261 ( V_10 -> V_256 -> V_291 , V_606 ) ;
F_130 ( V_10 ) ;
}
if ( V_610 ) {
V_609 = V_10 -> V_623 ;
F_261 ( V_10 -> V_623 , V_610 ) ;
}
F_120 ( & V_27 -> V_24 -> V_228 ) ;
F_263 () ;
if ( V_585 )
...
static void F_272 ( struct V_9 * V_10 ,
...
return F_267 ( V_27 , V_172 ) ;
V_10 = V_29 -> V_10 ;
V_633 = F_193 ( V_322 -> V_640 ) ;
V_634 = F_193 ( V_322 -> V_641 ) ;
V_635 = F_193 ( V_322 -> V_642 ) ;
V_10 -> V_633 = V_633 ;
if ( F_139 ( V_10 ) ) {
T_3 V_643 , V_644 ;
F_24 () ;
...
F_28 () ;
F_272 ( V_10 , L_132 ,
V_633 , F_274 ( V_10 -> V_256 ) ) ;
F_272 ( V_10 , L_133 ,
V_634 , V_636 ) ;
if ( V_10 -> V_382 . V_105 == V_103 )
V_634 = F_275 ( V_636 , V_634 ) ;
V_643 = F_276 ( V_10 , V_10 -> V_256 , V_634 , 0 ) ;
V_644 = F_168 ( V_10 -> V_328 ) ;
if ( V_643 < V_644 &&
...
if ( F_139 ( V_10 ) ) {
F_277 ( V_10 , V_10 -> V_256 , V_628 ) ;
V_631 = F_278 ( V_10 , V_639 , NULL ) ;
F_130 ( V_10 ) ;
if ( V_631 == V_649 )
return - V_108 ;
F_279 ( V_10 ) ;
} else {
F_277 ( V_10 , NULL , V_628 ) ;
F_280 ( V_10 , V_635 ? : V_634 ? : V_633 ) ;
}
if ( F_139 ( V_10 ) ) {
if ( V_10 -> V_256 -> V_650 != F_168 ( V_10 -> V_256 -> V_257 ) ) {
V_10 -> V_256 -> V_650 = F_168 ( V_10 -> V_256 -> V_257 ) ;
V_637 = 1 ;
}
F_130 ( V_10 ) ;
}
if ( V_10 -> V_382 . V_105 > V_103 ) {
if ( F_193 ( V_322 -> V_642 ) !=
F_168 ( V_10 -> V_328 ) || V_637 ) {
F_103 ( V_29 , 0 , V_639 ) ;
}
if ( F_281 ( V_190 , & V_10 -> V_69 ) ||
...
static int F_283 ( struct V_26 * V_27 , struct V_171 * V_172 )
{
struct V_28 * V_29 ;
struct V_9 * V_10 ;
...
return F_267 ( V_27 , V_172 ) ;
V_10 = V_29 -> V_10 ;
V_516 = F_134 ( sizeof( T_2 ) * V_656 , V_213 ) ;
if ( ! V_516 ) {
F_45 ( V_10 , L_137 ) ;
return false ;
}
for ( V_6 = V_538 ; V_6 < V_656 ; V_6 ++ )
V_516 [ V_6 ] = F_193 ( V_322 -> V_514 [ V_6 ] ) ;
F_52 ( V_10 -> V_516 ) ;
V_10 -> V_516 = V_516 ;
...
L_140 ,
V_660 ) ;
F_284 ( V_10 , V_538 , V_516 [ V_538 ] ) ;
F_284 ( V_10 , V_515 , 0 ) ;
F_285 ( F_286 ( V_10 , V_449 , V_475 , V_436 , V_475 ) ,
V_198 , NULL ) ;
F_279 ( V_10 ) ;
V_655 = 1 ;
}
...
static union V_661 F_289 ( union V_661 V_662 )
{
union V_661 V_663 ;
...
V_672 = F_289 ( V_672 ) ;
V_673 = F_289 ( V_673 ) ;
V_95 = F_246 ( V_10 , V_198 , V_672 , V_673 ) ;
F_292 ( V_29 , V_95 ) ;
F_279 ( V_10 ) ;
return 0 ;
}
static int F_293 ( struct V_26 * V_27 , struct V_171 * V_172 )
{
struct V_671 * V_322 = V_172 -> V_96 ;
union V_661 V_672 , V_673 ;
enum V_196 V_95 ;
...
static int F_295 ( struct V_26 * V_27 , struct V_171 * V_172 )
{
struct V_28 * V_29 ;
struct V_9 * V_10 ;
...
F_68 ( V_10 , L_142 , F_296 ( V_681 ) ) ;
}
F_20 ( & V_10 -> V_24 -> V_25 ) ;
V_34:
V_678 = V_679 = F_297 ( V_10 ) ;
F_21 ( & V_10 -> V_24 -> V_25 ) ;
...
V_680 . V_105 <= V_574 ) ) ;
if ( V_686 )
V_679 . V_105 = F_254 ( V_29 , V_680 . V_532 , V_681 ) ;
F_130 ( V_10 ) ;
if ( V_679 . V_105 == V_557 ) {
V_679 . V_105 = V_575 ;
if ( V_10 -> V_382 . V_449 == V_547 ) {
F_300 ( V_10 , F_72 ( V_449 , V_688 ) ) ;
} else if ( V_680 . V_449 == V_547 ) {
F_45 ( V_10 , L_143 ) ;
V_680 . V_449 = V_689 ;
V_681 = V_689 ;
} else {
if ( F_281 ( V_570 , & V_29 -> V_27 -> V_69 ) )
return - V_108 ;
...
if ( V_679 . V_436 == V_569 && F_301 ( V_10 ) && V_679 . V_105 == V_575 && V_678 . V_105 < V_575 &&
...
F_71 ( V_29 -> V_27 , F_304 ( V_105 , V_691 , V_692 , 0 ) , V_107 ) ;
return - V_108 ;
}
V_95 = F_285 ( V_10 , V_679 , V_683 , NULL ) ;
V_679 = F_297 ( V_10 ) ;
F_21 ( & V_10 -> V_24 -> V_25 ) ;
if ( V_95 < V_199 ) {
F_71 ( V_29 -> V_27 , F_72 ( V_105 , V_151 ) , V_107 ) ;
...
static int F_305 ( struct V_26 * V_27 , struct V_171 * V_172 )
{
struct V_28 * V_29 ;
struct V_9 * V_10 ;
...
if ( F_236 ( V_10 , V_547 ) ) {
F_284 ( V_10 , V_538 , F_193 ( V_322 -> V_514 ) ) ;
F_284 ( V_10 , V_515 , 0UL ) ;
F_288 ( V_10 , L_145 ) ;
F_306 ( V_10 , V_435 ) ;
F_130 ( V_10 ) ;
} else
...
static int
F_307 ( struct V_28 * V_29 , unsigned int V_64 ,
...
if ( V_77 )
return V_77 ;
F_308 ( V_29 -> V_10 , V_696 -> V_699 , V_697 , V_322 ) ;
V_696 -> V_699 += V_697 ;
...
static enum V_704 F_309 ( struct V_705 * V_322 )
{
return (enum V_704 ) ( V_322 -> V_706 & 0x0f ) ;
}
static int F_310 ( struct V_705 * V_322 )
{
...
unsigned long V_711 ;
int V_712 = F_310 ( V_322 ) ;
int V_713 ;
int V_537 ;
F_313 ( & V_708 , V_322 -> V_714 , V_5 , F_311 ( V_322 ) ) ;
V_537 = F_314 ( & V_708 , & V_709 , 64 ) ;
if ( V_537 < 0 )
return - V_108 ;
for ( V_713 = V_537 ; V_713 > 0 ; V_203 += V_710 , V_712 = ! V_712 ) {
V_537 = F_315 ( & V_710 , V_709 ) ;
if ( V_537 <= 0 )
return - V_108 ;
if ( V_712 ) {
V_711 = V_203 + V_710 - 1 ;
...
V_709 = 0 ;
V_713 -= V_537 ;
V_537 = F_314 ( & V_708 , & V_4 , 64 - V_713 ) ;
if ( V_537 < 0 )
return - V_108 ;
V_709 |= V_4 << V_713 ;
V_713 += V_537 ;
...
static int
F_318 ( struct V_28 * V_29 ,
struct V_705 * V_322 ,
struct V_695 * V_696 ,
unsigned int V_5 )
{
if ( F_309 ( V_322 ) == V_717 )
return F_312 ( V_29 , V_322 , V_696 , V_5 - sizeof( * V_322 ) ) ;
...
{
unsigned int V_170 = F_95 ( F_251 ( V_10 ) -> V_27 ) ;
unsigned int V_306 = V_600 - V_170 ;
unsigned int V_719 =
V_170 * ( F_320 ( V_696 -> V_698 , V_306 ) + 1 ) +
...
static int F_321 ( struct V_26 * V_27 , struct V_171 * V_172 )
{
struct V_28 * V_29 ;
struct V_9 * V_10 ;
struct V_695 V_696 ;
...
V_77 = F_307 ( V_29 , V_172 -> V_64 , V_172 -> V_96 , & V_696 ) ;
...
if ( V_77 )
goto V_104;
V_77 = F_318 ( V_29 , V_322 , & V_696 , V_172 -> V_64 ) ;
} else {
...
F_319 ( V_10 , L_157 , & V_696 ) ;
if ( V_10 -> V_382 . V_105 == V_574 ) {
enum V_196 V_95 ;
V_77 = F_324 ( V_10 ) ;
if ( V_77 )
goto V_104;
V_95 = F_325 ( V_10 , F_72 ( V_105 , V_694 ) , V_198 ) ;
F_53 ( V_10 , V_95 == V_199 ) ;
} else if ( V_10 -> V_382 . V_105 != V_573 ) {
F_68 ( V_10 , L_158 ,
F_255 ( V_10 -> V_382 . V_105 ) ) ;
}
V_77 = 0 ;
V_104:
F_326 ( V_10 ) ;
...
static int F_327 ( struct V_26 * V_27 , struct V_171 * V_172 )
{
F_35 ( V_27 , L_159 ,
...
{
F_329 ( V_27 -> V_96 . V_83 ) ;
return 0 ;
}
static int F_330 ( struct V_26 * V_27 , struct V_171 * V_172 )
{
struct V_28 * V_29 ;
struct V_9 * V_10 ;
...
F_225 ( V_10 , F_193 ( V_322 -> V_52 ) , F_125 ( V_322 -> V_474 ) ) ;
return 0 ;
}
...
F_21 ( & V_10 -> V_24 -> V_25 ) ;
F_38 ( V_172 -> V_64 >> 9 , & V_10 -> V_363 ) ;
V_77 = F_154 ( V_10 , V_19 , V_302 , 0 , V_365 ) ;
if ( V_77 ) {
F_20 ( & V_10 -> V_24 -> V_25 ) ;
F_146 ( & V_19 -> V_20 . V_21 ) ;
F_21 ( & V_10 -> V_24 -> V_25 ) ;
...
V_63:
F_332 ( V_10 , V_52 ) ;
F_238 ( V_29 , V_360 , V_52 , V_64 , V_361 ) ;
}
F_38 ( V_64 >> 9 , & V_10 -> V_374 ) ;
return V_77 ;
}
static void F_333 ( struct V_26 * V_27 )
{
struct V_171 V_172 ;
T_6 V_726 ;
int V_77 ;
...
if ( F_194 ( V_172 . V_169 >= F_335 ( V_730 ) || ! V_169 -> V_731 ) ) {
F_45 ( V_27 , L_161 ,
F_268 ( V_172 . V_169 ) , V_172 . V_169 ) ;
goto V_729;
}
V_726 = V_169 -> V_732 ;
...
F_45 ( V_27 , L_162 ,
F_268 ( V_172 . V_169 ) , V_172 . V_64 ) ;
goto V_729;
}
if ( V_172 . V_64 < V_726 ) {
F_45 ( V_27 , L_163 ,
F_268 ( V_172 . V_169 ) , ( int ) V_726 , V_172 . V_64 ) ;
goto V_729;
}
if ( V_726 ) {
F_242 ( V_27 , F_74 ) ;
...
F_242 ( V_27 , V_169 -> V_731 ) ;
V_77 = V_169 -> V_731 ( V_27 , & V_172 ) ;
if ( V_77 ) {
F_45 ( V_27 , L_164 ,
F_268 ( V_172 . V_169 ) , V_77 , V_172 . V_64 ) ;
goto V_729;
}
}
return;
...
static void F_336 ( struct V_26 * V_27 )
{
struct V_28 * V_29 ;
enum V_554 V_735 ;
int V_30 ;
...
F_68 ( V_27 , L_166 ) ;
if ( F_341 ( V_27 ) == V_505 && F_342 ( V_27 ) >= V_740 )
F_343 ( V_27 ) ;
F_20 ( & V_27 -> V_24 -> V_25 ) ;
V_735 = V_27 -> V_102 ;
if ( V_735 >= V_741 )
F_222 ( V_27 , F_72 ( V_105 , V_741 ) , V_198 ) ;
F_21 ( & V_27 -> V_24 -> V_25 ) ;
if ( V_735 == V_151 )
F_71 ( V_27 , F_72 ( V_105 , V_736 ) , V_198 | V_107 ) ;
}
static int F_340 ( struct V_28 * V_29 )
{
struct V_9 * V_10 = V_29 -> V_10 ;
unsigned int V_6 ;
F_20 ( & V_10 -> V_24 -> V_25 ) ;
...
F_41 ( & V_10 -> V_320 ) ;
F_345 ( & V_10 -> V_743 ) ;
F_346 ( ( unsigned long ) V_10 ) ;
F_347 ( & V_29 -> V_27 -> V_744 ) ;
F_59 ( V_10 ) ;
F_347 ( & V_29 -> V_27 -> V_744 ) ;
F_344 ( V_10 ) ;
F_52 ( V_10 -> V_516 ) ;
...
static int F_348 ( struct V_26 * V_27 )
{
struct V_167 * V_84 ;
struct V_747 * V_322 ;
V_84 = & V_27 -> V_96 ;
...
V_765 -> V_69 = 0 ;
V_95 = F_350 ( V_27 -> V_219 , ( V_767 * ) V_763 , V_762 ) ;
if ( V_95 ) {
...
V_764 = F_352 ( V_27 -> V_219 ) ;
V_759 = F_134 ( V_764 , V_213 ) ;
if ( V_759 == NULL ) {
F_45 ( V_27 , L_190 ) ;
V_95 = - 1 ;
goto V_63;
}
V_95 = F_353 ( V_765 , V_761 , V_172 . V_64 , V_759 ) ;
if ( V_95 ) {
...
V_760 = F_134 ( V_764 , V_213 ) ;
if ( V_760 == NULL ) {
F_45 ( V_27 , L_194 ) ;
V_95 = - 1 ;
goto V_63;
}
V_95 = F_353 ( V_765 , V_757 , V_758 ,
V_760 ) ;
if ( V_95 ) {
F_45 ( V_27 , L_191 , V_95 ) ;
V_95 = - 1 ;
...
static int F_358 ( struct V_26 * V_27 , struct V_171 * V_172 )
{
struct V_28 * V_29 ;
struct V_9 * V_10 ;
struct V_772 * V_322 = V_172 -> V_96 ;
...
static int F_361 ( struct V_26 * V_27 , struct V_171 * V_172 )
{
V_27 -> V_202 . V_83 -> V_111 -> V_138 = V_27 -> V_35 -> V_217 * V_44 ;
if ( ! F_362 ( V_780 , & V_27 -> V_69 ) )
F_41 ( & V_27 -> V_101 ) ;
return 0 ;
}
...
V_10 = V_29 -> V_10 ;
F_53 ( V_10 , V_29 -> V_27 -> V_186 >= 89 ) ;
F_208 ( V_29 , F_125 ( V_322 -> V_424 ) ) ;
if ( F_139 ( V_10 ) ) {
F_332 ( V_10 , V_52 ) ;
F_182 ( V_10 , V_52 , V_474 ) ;
...
static int
F_364 ( struct V_9 * V_10 , T_2 V_51 , T_3 V_52 ,
...
struct V_414 V_415 ;
F_20 ( & V_10 -> V_24 -> V_25 ) ;
V_347 = F_189 ( V_10 , V_367 , V_51 , V_52 , V_368 , V_369 ) ;
if ( F_194 ( ! V_347 ) ) {
F_21 ( & V_10 -> V_24 -> V_25 ) ;
return - V_108 ;
}
F_201 ( V_347 , V_117 , & V_415 ) ;
F_21 ( & V_10 -> V_24 -> V_25 ) ;
if ( V_415 . V_244 )
F_216 ( V_10 , & V_415 ) ;
return 0 ;
...
return F_364 ( V_10 , V_322 -> V_68 , V_52 ,
& V_10 -> V_318 , V_62 ,
V_117 , false ) ;
}
...
if ( V_322 -> V_68 == V_361 ) {
F_187 ( V_10 ) ;
F_184 ( V_10 , V_52 , V_64 ) ;
return 0 ;
}
V_77 = F_364 ( V_10 , V_322 -> V_68 , V_52 ,
& V_10 -> V_318 , V_62 ,
V_416 , true ) ;
if ( V_77 ) {
F_225 ( V_10 , V_52 , V_64 ) ;
}
return 0 ;
}
...
struct V_28 * V_29 ;
int V_30 ;
F_370 ( V_27 , V_322 -> V_323 , F_125 ( V_322 -> V_791 ) ) ;
F_24 () ;
F_25 (&connection->peer_devices, peer_device, vnr) {
struct V_9 * V_10 = V_29 -> V_10 ;
if ( V_10 -> V_382 . V_105 == V_684 &&
F_26 ( & V_10 -> V_191 ) == 0 &&
! F_362 ( V_792 , & V_10 -> V_69 ) ) {
...
V_64 = F_125 ( V_322 -> V_474 ) ;
F_208 ( V_29 , F_125 ( V_322 -> V_424 ) ) ;
if ( F_193 ( V_322 -> V_68 ) == V_797 )
F_373 ( V_10 , V_52 , V_64 ) ;
else
F_299 ( V_10 ) ;
if ( ! F_139 ( V_10 ) )
return 0 ;
...
F_374 ( V_10 , V_10 -> V_466 ) ;
if ( V_10 -> V_466 == 0 ) {
V_796 = F_134 ( sizeof( * V_796 ) , V_213 ) ;
if ( V_796 ) {
V_796 -> V_20 . V_80 = V_798 ;
V_796 -> V_10 = V_10 ;
F_375 ( & V_29 -> V_27 -> V_744 , & V_796 -> V_20 ) ;
} else {
F_45 ( V_10 , L_201 ) ;
F_299 ( V_10 ) ;
F_298 ( V_10 ) ;
...
static void F_377 ( struct V_26 * V_27 , bool V_799 )
{
long V_23 ;
struct V_35 * V_36 ;
F_24 () ;
...
static void F_378 ( struct V_26 * V_27 )
{
F_377 ( V_27 , 1 ) ;
}
...
V_95 = F_381 ( V_43 , V_807 , & V_805 ) ;
if ( V_95 < 0 )
F_45 ( V_27 , L_202 , V_95 ) ;
while ( F_114 ( V_771 ) == V_727 ) {
F_334 ( V_771 ) ;
F_23 ( V_27 ) ;
if ( F_281 ( V_808 , & V_27 -> V_69 ) ) {
if ( F_382 ( V_27 ) ) {
F_45 ( V_27 , L_203 ) ;
goto V_616;
}
...
if ( V_172 . V_169 >= F_335 ( V_809 ) || ! V_169 -> V_731 ) {
F_45 ( V_27 , L_206 ,
F_268 ( V_172 . V_169 ) , V_172 . V_169 ) ;
goto V_596;
}
...
void F_385 ( struct V_811 * V_812 )
{
struct V_28 * V_29 =
F_180 ( V_812 , struct V_28 , V_421 ) ;
