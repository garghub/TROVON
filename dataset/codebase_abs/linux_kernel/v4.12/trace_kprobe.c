...
static int F_61 ( int V_63 , char * * V_64 )
{
struct V_1 * V_2 ;
int V_37 , V_25 = 0 ;
...
if ( F_64 ( V_64 [ 1 ] , 0 , ( unsigned long * ) & V_16 ) ) {
V_5 = V_64 [ 1 ] ;
V_25 = F_65 ( V_5 , & V_7 ) ;
if ( V_25 ) {
F_62 ( L_16 ) ;
...
V_25 = F_70 ( V_66 , & V_2 -> V_32 . V_75 , V_74 ,
V_24 , true ,
V_76 ) ;
if ( V_25 ) {
F_62 ( L_26 , V_37 , V_25 ) ;
...
while ( ! F_39 ( & V_56 ) ) {
V_2 = F_72 ( V_56 . V_77 , struct V_1 , V_35 ) ;
V_25 = F_52 ( V_2 ) ;
if ( V_25 )
goto V_55;
F_25 ( V_2 ) ;
...
static void * F_73 ( struct V_78 * V_79 , T_2 * V_80 )
{
F_56 ( & V_54 ) ;
return F_74 ( & V_56 , * V_80 ) ;
}
static void * F_75 ( struct V_78 * V_79 , void * V_81 , T_2 * V_80 )
{
return F_76 ( V_81 , & V_56 , V_80 ) ;
}
static void F_77 ( struct V_78 * V_79 , void * V_81 )
{
F_59 ( & V_54 ) ;
}
static int F_78 ( struct V_78 * V_79 , void * V_81 )
{
struct V_1 * V_2 = V_81 ;
int V_37 ;
F_79 ( V_79 , F_1 ( V_2 ) ? 'r' : 'p' ) ;
F_80 ( V_79 , L_27 , V_2 -> V_32 . V_33 . V_34 -> system ,
F_29 ( & V_2 -> V_32 . V_33 ) ) ;
if ( ! V_2 -> V_5 )
F_80 ( V_79 , L_28 , V_2 -> V_3 . V_6 . V_16 ) ;
else if ( V_2 -> V_3 . V_6 . V_7 )
F_80 ( V_79 , L_29 , F_2 ( V_2 ) ,
V_2 -> V_3 . V_6 . V_7 ) ;
else
F_80 ( V_79 , L_30 , F_2 ( V_2 ) ) ;
for ( V_37 = 0 ; V_37 < V_2 -> V_32 . V_38 ; V_37 ++ )
F_80 ( V_79 , L_31 , V_2 -> V_32 . args [ V_37 ] . V_11 , V_2 -> V_32 . args [ V_37 ] . V_82 ) ;
F_79 ( V_79 , '\n' ) ;
return 0 ;
}
static int F_81 ( struct V_83 * V_83 , struct V_40 * V_40 )
{
int V_25 ;
...
return F_82 ( V_40 , & V_88 ) ;
}
static T_3 F_83 ( struct V_40 * V_40 , const char T_4 * V_89 ,
T_5 V_90 , T_2 * V_91 )
{
return F_84 ( V_40 , V_89 , V_90 , V_91 ,
F_61 ) ;
}
static int F_85 ( struct V_78 * V_79 , void * V_81 )
{
struct V_1 * V_2 = V_81 ;
F_80 ( V_79 , L_32 ,
F_29 ( & V_2 -> V_32 . V_33 ) ,
...
static int F_86 ( struct V_83 * V_83 , struct V_40 * V_40 )
{
return F_82 ( V_40 , & V_93 ) ;
}
static T_1 void
F_87 ( struct V_1 * V_2 , struct V_94 * V_95 ,
struct V_39 * V_96 )
{
struct V_97 * V_98 ;
struct V_99 * V_20 ;
...
F_88 ( V_33 != V_96 -> V_105 ) ;
if ( F_89 ( V_96 ) )
return;
F_90 ( V_103 ) ;
V_102 = F_91 () ;
V_101 = F_92 ( & V_2 -> V_32 , V_95 ) ;
...
F_95 ( sizeof( * V_98 ) , & V_2 -> V_32 , V_95 , ( V_107 * ) & V_98 [ 1 ] , V_101 ) ;
F_96 ( V_96 , V_89 , V_20 ,
V_98 , V_103 , V_102 , V_95 ) ;
}
static void
F_97 ( struct V_1 * V_2 , struct V_94 * V_95 )
{
struct V_41 * V_42 ;
F_98 (link, &tk->tp.files, list)
F_87 ( V_2 , V_95 , V_42 -> V_40 ) ;
}
static T_1 void
F_99 ( struct V_1 * V_2 , struct V_108 * V_109 ,
struct V_94 * V_95 ,
struct V_39 * V_96 )
{
struct V_110 * V_98 ;
...
struct V_41 * V_42 ;
F_98 (link, &tk->tp.files, list)
F_99 ( V_2 , V_109 , V_95 , V_42 -> V_40 ) ;
}
static enum V_114
F_101 ( struct V_115 * V_116 , int V_44 ,
struct V_117 * V_20 )
{
struct V_97 * V_118 ;
...
V_32 = F_102 ( V_20 , struct V_122 , V_33 . V_20 ) ;
F_103 ( V_120 , L_33 , F_29 ( & V_32 -> V_33 ) ) ;
if ( ! F_104 ( V_120 , V_118 -> V_106 , V_44 | V_124 ) )
goto V_43;
F_105 ( V_120 , ')' ) ;
V_60 = ( V_107 * ) & V_118 [ 1 ] ;
...
static enum V_114
F_107 ( struct V_115 * V_116 , int V_44 ,
struct V_117 * V_20 )
{
struct V_110 * V_118 ;
struct V_119 * V_120 = & V_116 -> V_121 ;
...
V_32 = F_102 ( V_20 , struct V_122 , V_33 . V_20 ) ;
F_103 ( V_120 , L_33 , F_29 ( & V_32 -> V_33 ) ) ;
if ( ! F_104 ( V_120 , V_118 -> V_112 , V_44 | V_124 ) )
goto V_43;
F_108 ( V_120 , L_34 ) ;
if ( ! F_104 ( V_120 , V_118 -> V_111 , V_44 & ~ V_124 ) )
goto V_43;
F_105 ( V_120 , ')' ) ;
V_60 = ( V_107 * ) & V_118 [ 1 ] ;
for ( V_37 = 0 ; V_37 < V_32 -> V_38 ; V_37 ++ )
...
F_110 (unsigned long, ip, FIELD_STRING_IP, 0 ) ;
for ( V_37 = 0 ; V_37 < V_2 -> V_32 . V_38 ; V_37 ++ ) {
struct V_73 * V_74 = & V_2 -> V_32 . args [ V_37 ] ;
V_25 = F_111 ( V_105 , V_74 -> type -> V_126 ,
V_74 -> V_11 ,
...
struct V_110 V_118 ;
struct V_1 * V_2 = (struct V_1 * ) V_105 -> V_60 ;
F_110 (unsigned long, func, FIELD_STRING_FUNC, 0 ) ;
F_110 (unsigned long, ret_ip, FIELD_STRING_RETIP, 0 ) ;
for ( V_37 = 0 ; V_37 < V_2 -> V_32 . V_38 ; V_37 ++ ) {
struct V_73 * V_74 = & V_2 -> V_32 . args [ V_37 ] ;
V_25 = F_111 ( V_105 , V_74 -> type -> V_126 ,
V_74 -> V_11 ,
...
static void
F_113 ( struct V_1 * V_2 , struct V_94 * V_95 )
{
struct V_104 * V_33 = & V_2 -> V_32 . V_33 ;
...
int V_134 ;
if ( V_130 && ! F_114 ( V_130 , V_95 ) )
return;
V_132 = F_115 ( V_33 -> V_135 ) ;
if ( F_116 ( V_132 ) )
return;
V_101 = F_92 ( & V_2 -> V_32 , V_95 ) ;
V_133 = sizeof( * V_98 ) + V_2 -> V_32 . V_75 + V_101 ;
V_75 = F_117 ( V_133 + sizeof( V_136 ) , sizeof( V_137 ) ) ;
V_75 -= sizeof( V_136 ) ;
V_98 = F_118 ( V_75 , NULL , & V_134 ) ;
if ( ! V_98 )
return;
V_98 -> V_106 = ( unsigned long ) V_2 -> V_3 . V_6 . V_16 ;
memset ( & V_98 [ 1 ] , 0 , V_101 ) ;
F_95 ( sizeof( * V_98 ) , & V_2 -> V_32 , V_95 , ( V_107 * ) & V_98 [ 1 ] , V_101 ) ;
F_119 ( V_98 , V_75 , V_134 , V_33 -> V_20 . type , 1 , V_95 ,
V_132 , NULL ) ;
}
static void
F_120 ( struct V_1 * V_2 , struct V_108 * V_109 ,
struct V_94 * V_95 )
{
struct V_104 * V_33 = & V_2 -> V_32 . V_33 ;
struct V_129 * V_130 = V_33 -> V_130 ;
...
static int F_121 ( struct V_104 * V_20 ,
...
{
struct V_1 * V_2 = F_102 ( V_6 , struct V_1 , V_3 . V_6 ) ;
F_123 ( * V_2 -> V_12 ) ;
...
{
struct V_1 * V_2 = F_102 ( V_109 -> V_3 , struct V_1 , V_3 ) ;
F_123 ( * V_2 -> V_12 ) ;
if ( V_2 -> V_32 . V_44 & V_45 )
F_100 ( V_2 , V_109 , V_95 ) ;
#ifdef F_122
if ( V_2 -> V_32 . V_44 & V_46 )
F_120 ( V_2 , V_109 , V_95 ) ;
#endif
return 0 ;
}
...
V_33 -> V_34 -> V_151 = F_112 ;
} else {
V_33 -> V_20 . V_149 = & V_152 ;
V_33 -> V_34 -> V_151 = F_109 ;
}
if ( F_124 ( & V_2 -> V_32 , F_1 ( V_2 ) ) < 0 )
return - V_26 ;
V_25 = F_125 ( & V_33 -> V_20 ) ;
if ( ! V_25 ) {
F_14 ( V_33 -> V_153 ) ;
return - V_154 ;
}
V_33 -> V_44 = V_155 ;
V_33 -> V_34 -> V_156 = F_121 ;
V_33 -> V_60 = V_2 ;
V_25 = F_126 ( V_33 ) ;
if ( V_25 ) {
F_62 ( L_35 ,
...
{
int V_25 ;
V_25 = F_128 ( & V_2 -> V_32 . V_33 ) ;
if ( ! V_25 )
F_14 ( V_2 -> V_32 . V_33 . V_153 ) ;
return V_25 ;
}
static T_6 int F_129 ( void )
{
struct V_157 * V_158 ;
struct V_157 * V_98 ;
if ( F_130 ( & V_159 ) )
...
if ( F_67 ( V_158 ) )
return 0 ;
V_98 = F_132 ( L_36 , 0644 , V_158 ,
NULL , & V_160 ) ;
if ( ! V_98 )
F_48 ( L_37 ) ;
V_98 = F_132 ( L_38 , 0444 , V_158 ,
NULL , & V_161 ) ;
if ( ! V_98 )
F_48 ( L_39 ) ;
return 0 ;
...
F_133 ( int V_162 , int V_163 , int V_164 , int V_165 , int V_166 , int V_167 )
{
...
{
int V_25 , V_168 = 0 ;
int (* F_135)( int , int , int , int , int , int );
struct V_1 * V_2 ;
struct V_39 * V_40 ;
if ( F_136 () )
return - V_154 ;
...
V_25 = F_137 ( L_56 , F_61 ) ;
if ( F_138 ( V_25 ) ) {
F_48 ( L_57 ) ;
V_168 ++ ;
}
V_25 = F_137 ( L_58 , F_61 ) ;
if ( F_138 ( V_25 ) ) {
F_48 ( L_57 ) ;
V_168 ++ ;
}
