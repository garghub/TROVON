...
F_123 ( & V_99 , (struct V_144 * ) & V_109 -> V_222 . V_103 ,
& V_2 -> V_145 [ 0 ] ) ;
F_124 ( & V_143 , & V_99 , & V_2 -> V_145 [ 1 ] ) ;
F_125 ( & V_2 -> V_145 [ 1 ] , & V_99 ) ;
F_126 (cgr, &p->cgr_cbs, node)
if ( V_219 -> V_223 && F_127 ( & V_143 , V_219 -> V_224 ) )
V_219 -> V_223 ( V_2 , V_219 , F_127 ( & V_99 , V_219 -> V_224 ) ) ;
F_115 ( & V_2 -> V_168 ) ;
F_122 ( V_2 , V_221 ) ;
}
...
case V_206 :
case V_204 :
V_113 = F_86 ( F_129 ( & V_136 -> V_113 ) ) ;
if ( F_85 ( ! V_113 ) )
break;
F_119 ( V_2 , V_113 , V_136 , V_71 ) ;
if ( V_113 -> V_223 . V_210 )
V_113 -> V_223 . V_210 ( V_2 , V_113 , V_136 ) ;
break;
case V_215 :
V_113 = F_87 ( F_2 ( V_136 -> V_113 . V_225 ) ) ;
F_119 ( V_2 , V_113 , V_136 , V_71 ) ;
if ( V_113 -> V_223 . V_210 )
V_113 -> V_223 . V_210 ( V_2 , V_113 , V_136 ) ;
break;
...
V_113 -> V_223 . V_190 ( V_2 , V_113 , V_136 ) ;
}
V_93 ++ ;
F_58 ( & V_2 -> V_2 ) ;
}
...
if ( V_72 -> V_234 & V_236 )
F_71 ( V_113 , V_212 ) ;
V_69 = V_113 -> V_223 . V_58 ( V_2 , V_113 , V_72 ) ;
if ( V_69 == V_237 )
break;
if ( V_72 -> V_234 & V_238 )
F_136 ( V_2 , V_113 ) ;
} else {
V_113 = F_87 ( F_2 ( V_72 -> V_225 ) ) ;
V_69 = V_113 -> V_223 . V_58 ( V_2 , V_113 , V_72 ) ;
if ( V_69 == V_237 )
break;
}
...
void F_122 ( struct V_116 * V_2 , T_1 V_173 )
{
unsigned long V_243 ;
F_137 ( V_243 ) ;
...
void F_132 ( struct V_116 * V_2 , T_1 V_173 )
{
unsigned long V_243 ;
T_1 V_245 ;
F_137 ( V_243 ) ;
...
V_262 -> V_271 . V_276 . V_225 = F_6 ( F_88 ( V_113 ) ) ;
...
V_136 . V_113 . V_225 = F_6 ( F_88 ( V_113 ) ) ;
V_113 -> V_223 . V_210 ( V_2 , V_113 , & V_136 ) ;
}
} else if ( V_69 == V_253 ) {
V_146 = 1 ;
...
int F_164 ( struct V_112 * V_113 , struct V_306 * V_307 )
{
union V_105 * V_262 ;
union V_107 * V_109 ;
struct V_116 * V_2 = F_75 () ;
...
struct V_218 V_219 ;
int V_335 = 0 ;
for ( V_219 . V_224 = 0 ; V_219 . V_224 < V_336 ; V_219 . V_224 ++ ) {
...
int V_146 ;
struct V_116 * V_2 ;
if ( V_219 -> V_224 >= V_336 )
return - V_258 ;
F_128 () ;
V_2 = F_75 () ;
V_338 [ V_219 -> V_224 ] = F_134 () ;
F_131 () ;
...
if ( V_219 -> V_223 && V_337 . V_219 . V_343 &&
F_127 ( & V_2 -> V_145 [ 1 ] , V_219 -> V_224 ) )
V_219 -> V_223 ( V_2 , V_219 , 1 ) ;
V_270:
F_115 ( & V_2 -> V_168 ) ;
F_77 () ;
return V_146 ;
...
F_186 ( & V_219 -> V_342 ) ;
F_126 (i, &p->cgr_cbs, node)
if ( V_344 -> V_224 == V_219 -> V_224 && V_344 -> V_223 )
goto V_346;
V_146 = F_165 ( V_219 , & V_337 ) ;
if ( V_146 ) {
F_182 ( & V_219 -> V_342 , & V_2 -> V_167 ) ;
...
while ( V_58 ) {
if ( F_129 ( V_58 ) == V_38 && ( V_58 -> V_234 & V_353 ) )
V_352 = 1 ;
F_47 ( V_2 , V_58 , 0 ) ;
F_43 ( V_2 ) ;
F_42 ( V_2 ) ;
