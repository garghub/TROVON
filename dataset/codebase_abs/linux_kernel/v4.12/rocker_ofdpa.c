...
static struct V_262 *
F_132 ( const struct V_127 * V_127 , int V_263 )
{
struct V_262 * V_129 ;
F_45 (ofdpa->internal_vlan_tbl, found,
entry, ifindex) {
if ( V_129 -> V_263 == V_263 )
return V_129 ;
}
return NULL ;
}
...
return 0 ;
V_29 -> V_263 = V_263 ;
F_48 ( & V_127 -> V_264 , V_131 ) ;
V_129 = F_132 ( V_127 , V_263 ) ;
if ( V_129 ) {
V_23 ( V_29 ) ;
goto V_129;
}
V_129 = V_29 ;
F_50 ( V_127 -> V_265 , & V_129 -> V_29 , V_129 -> V_263 ) ;
for ( V_114 = 0 ; V_114 < V_266 ; V_114 ++ ) {
if ( F_134 ( V_114 , V_127 -> V_267 ) )
continue;
...
V_129:
V_129 -> V_180 ++ ;
F_51 ( & V_127 -> V_264 , V_131 ) ;
return V_129 -> V_1 ;
}
static int F_135 ( struct V_6 * V_6 ,
struct V_15 * V_16 , T_7 V_158 ,
int V_268 , struct V_160 * V_161 ,
T_5 V_269 , int V_13 )
{
const struct V_270 * V_271 ;
T_1 V_48 = F_4 ( V_73 ) ;
T_7 V_159 = F_85 ( V_268 ) ;
T_1 V_9 = V_6 -> V_9 ;
T_5 V_97 = V_161 -> V_272 ;
enum V_140 V_38 =
V_106 ;
T_5 V_62 ;
bool V_273 ;
...
if ( -- V_129 -> V_180 <= 0 ) {
V_277 = F_2 ( V_129 -> V_1 ) - V_3 ;
F_137 ( V_277 , V_127 -> V_267 ) ;
F_49 ( & V_129 -> V_29 ) ;
V_23 ( V_129 ) ;
}
V_278:
...
F_48 ( & V_127 -> V_264 , V_13 ) ;
F_119 (ofdpa->internal_vlan_tbl, bkt,
tmp, internal_vlan_entry, entry)
F_49 ( & V_283 -> V_29 ) ;
F_51 ( & V_127 -> V_264 , V_13 ) ;
...
int V_90 = 0 ;
if ( F_166 ( V_302 ) )
V_90 = F_162 ( V_6 , V_302 ) ;
else if ( F_167 ( V_302 ) )
V_90 = F_164 ( V_6 , V_302 ) ;
return V_90 ;
}
...
if ( V_127 -> V_306 )
return 0 ;
V_6 = F_172 ( V_305 -> V_161 -> V_275 , V_199 ) ;
if ( ! V_6 )
return 0 ;
V_90 = F_135 ( V_6 , NULL , F_175 ( V_305 -> V_158 ) ,
V_305 -> V_268 , V_305 -> V_161 ,
V_305 -> V_269 , 0 ) ;
if ( V_90 )
return V_90 ;
F_176 ( V_305 -> V_161 ) ;
...
return 0 ;
F_178 ( V_305 -> V_161 ) ;
return F_135 ( V_6 , NULL , F_175 ( V_305 -> V_158 ) ,
V_305 -> V_268 , V_305 -> V_161 ,
V_305 -> V_269 , V_139 ) ;
}
