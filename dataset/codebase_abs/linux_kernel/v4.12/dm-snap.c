...
static long F_188 ( struct V_116 * V_45 , T_10 V_220 ,
long V_221 , void * * V_222 , T_11 * V_223 )
{
F_126 ( L_48 ) ;
return - V_158 ;
}
...
static void F_191 ( struct V_116 * V_45 , T_8 type ,
unsigned V_196 , char * V_197 , unsigned V_198 )
{
struct V_36 * V_33 = V_45 -> V_144 ;
switch ( type ) {
...
break;
case V_205 :
snprintf ( V_197 , V_198 , L_49 , V_33 -> V_37 -> V_206 ) ;
break;
}
}
