...
struct V_6 * V_6 ;
int V_45 , V_46 ;
V_2 -> V_5 . V_7 [ V_3 ] = F_18 ( V_40 , V_38 ) ;
if ( ! V_2 -> V_5 . V_7 [ V_3 ] )
return - V_47 ;
...
static int F_23 ( struct V_14 * V_57 ,
T_1 V_58 )
{
...
F_28 ( & V_2 -> V_61 ) ;
if ( V_2 -> V_62 )
V_60 = F_29 ( V_2 , V_63 , 1 ) ;
else
V_60 = F_29 ( V_2 , V_63 , 0 ) ;
F_30 ( & V_2 -> V_61 ) ;
if ( V_60 < 0 ) {
F_15 ( V_2 -> V_2 ,
L_10 ) ;
...
{
struct V_1 * V_2 = F_41 ( V_75 , struct V_1 , V_71 ) ;
if ( F_10 ( & V_2 -> V_24 ) ) {
F_2 ( V_2 -> V_2 , L_18 ) ;
if ( F_42 ( V_2 ) == 0 )
F_43 ( V_2 , V_76 , V_77 ) ;
...
T_2 V_85 ;
V_2 = F_24 ( V_15 ) ;
F_48 ( & V_2 -> V_5 . V_80 , V_84 ) ;
V_85 = V_2 -> V_5 . V_32 ;
F_49 ( & V_2 -> V_5 . V_80 , V_84 ) ;
return V_85 ;
}
static struct V_86 * F_50 ( struct V_14 * V_57 ,
unsigned long V_31 )
{
...
F_2 ( V_2 -> V_2 ,
L_20 ) ;
V_94 = F_53 ( V_2 -> V_2 , V_99 [ V_93 ] , L_21 ,
V_100 , 0 , & V_92 ) ;
if ( V_94 < 0 )
return V_94 ;
F_54 ( & V_5 -> V_80 ) ;
V_94 = F_55 ( V_92 , L_21 , 0 , 0 , 1 , & V_90 ) ;
if ( V_94 < 0 )
goto V_101;
F_56 ( V_90 , V_102 ,
& V_103 ) ;
V_90 -> V_104 = 0 ;
V_90 -> V_69 = V_2 ;
strcpy ( V_90 -> V_105 , L_22 ) ;
strcpy ( V_92 -> V_106 , L_23 ) ;
strcpy ( V_92 -> V_107 , L_21 ) ;
strcpy ( V_92 -> V_108 , L_24 ) ;
F_57 ( & V_2 -> V_71 , F_40 ) ;
V_94 = F_58 ( V_92 ) ;
if ( V_94 < 0 )
goto V_101;
...
V_113 [ 0 ] . V_114 .
V_115 + 1 ] ;
if ( V_96 -> V_116 [ 0 ] . V_117 . V_118 < V_97 + 1 ) {
V_94 = - V_42 ;
goto V_101;
}
V_5 -> V_50 =
V_96 -> V_116 [ 0 ] . V_119 [ V_97 ] . V_117 .
V_120 ;
V_5 -> V_121 = V_96 -> V_122 ;
F_59 ( V_2 -> V_2 ,
L_25 ,
V_5 -> V_50 , V_5 -> V_121 ) ;
V_5 -> V_123 = F_18 ( 32 * V_5 -> V_121 , V_124 ) ;
if ( ! V_5 -> V_123 ) {
V_94 = - V_47 ;
goto V_101;
}
...
T_3 V_125 ;
if ( V_96 -> V_116 [ V_3 ] . V_117 . V_118 < V_97 + 1 ) {
V_94 = - V_42 ;
goto V_126;
}
V_125 = F_60 ( V_96 -> V_116 [ V_3 ] . V_119 [ V_97 ] . V_117 .
V_127 ) ;
V_5 -> V_123 [ V_3 ] =
