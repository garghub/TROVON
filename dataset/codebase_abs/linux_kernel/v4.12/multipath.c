...
static void F_53 ( struct V_64 * V_19 )
{
...
if ( F_55 ( V_66 ) )
break;
V_14 = F_56 ( V_66 -> V_67 , struct V_13 , V_18 ) ;
F_57 ( V_66 -> V_67 ) ;
F_11 ( & V_2 -> V_17 , V_10 ) ;
V_21 = & V_14 -> V_21 ;
...
static T_1 F_58 ( struct V_15 * V_15 , T_1 V_69 , int V_5 )
{
F_59 ( V_69 || V_5 ,
L_18 , V_70 ) ;
return V_15 -> V_71 ;
...
V_2 = F_63 ( sizeof( struct V_1 ) , V_79 ) ;
V_15 -> V_16 = V_2 ;
if ( ! V_2 )
goto V_78;
...
static void F_72 ( struct V_15 * V_15 , void * V_82 )
{
struct V_1 * V_2 = V_82 ;
F_70 ( V_2 -> V_24 ) ;
F_71 ( V_2 -> V_8 ) ;
