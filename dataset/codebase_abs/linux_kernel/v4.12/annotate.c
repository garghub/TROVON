...
int F_100 ( struct V_26 * V_27 , struct V_19 * V_19 , const char * V_190 , T_1 V_107 )
{
struct V_172 * V_172 = V_19 -> V_172 ;
char V_194 [ V_181 * 2 ] ;
struct V_1 * V_1 = NULL ;
...
int V_201 ;
T_6 V_202 ;
int V_96 = F_90 ( V_172 , V_195 , sizeof( V_195 ) ) ;
if ( V_96 )
return V_96 ;
V_190 = F_97 ( V_190 ) ;
if ( ! V_190 )
...
V_195 , V_27 -> V_10 , V_19 -> V_87 ( V_19 , V_27 -> V_76 ) ,
V_19 -> V_87 ( V_19 , V_27 -> V_88 ) ) ;
F_51 ( L_47 ,
V_172 , V_172 -> V_189 , V_27 , V_27 -> V_10 ) ;
if ( F_91 ( V_172 ) ) {
V_197 . V_205 = V_195 ;
V_197 . V_22 = F_83 ( V_19 , V_27 -> V_76 ) ;
V_197 . V_206 = V_27 -> V_76 ;
V_197 . V_144 = V_27 -> V_88 - V_27 -> V_76 ;
if ( ! F_102 ( & V_197 ) ) {
V_198 = true ;
F_103 ( V_195 , V_197 . V_207 ,
sizeof( V_195 ) ) ;
}
} else if ( F_104 ( V_172 ) ) {
char V_105 [ V_208 ] ;
if ( F_105 ( V_172 , V_195 ,
V_105 , sizeof( V_105 ) ) < 0 )
goto V_209;
strcpy ( V_195 , V_105 ) ;
}
snprintf ( V_194 , sizeof( V_194 ) ,
L_48 V_29
L_49 V_29
L_50 ,
V_210 ? V_210 : L_51 ,
...
F_83 ( V_19 , V_27 -> V_76 ) ,
F_83 ( V_19 , V_27 -> V_88 ) ,
V_69 . V_212 ? L_43 : L_53 ,
V_69 . V_213 ? L_54 : L_43 ,
V_195 , V_195 ) ;
F_51 ( L_55 , V_194 ) ;
V_96 = - 1 ;
if ( F_106 ( V_199 ) < 0 ) {
...
F_109 ( V_199 [ 1 ] , 1 ) ;
F_108 ( V_199 [ 1 ] ) ;
F_110 ( L_58 , L_59 , L_60 , V_194 , NULL ) ;
perror ( V_194 ) ;
exit ( - 1 ) ;
}
F_108 ( V_199 [ 1 ] ) ;
V_161 = fdopen ( V_199 [ 0 ] , L_61 ) ;
if ( ! V_161 ) {
F_101 ( L_62 , V_194 ) ;
goto V_214;
}
...
static void F_114 ( struct V_216 * V_217 , struct V_117 * V_118 )
{
struct V_117 * V_218 ;
struct V_219 * * V_136 = & V_217 -> V_219 ;
struct V_219 * V_220 = NULL ;
int V_153 , V_221 ;
while ( * V_136 != NULL ) {
V_220 = * V_136 ;
V_218 = F_115 ( V_220 , struct V_117 , V_113 ) ;
V_221 = strcmp ( V_218 -> V_115 , V_118 -> V_115 ) ;
if ( V_221 == 0 ) {
for ( V_153 = 0 ; V_153 < V_118 -> V_123 ; V_153 ++ )
V_218 -> V_122 [ V_153 ] . V_222 += V_118 -> V_122 [ V_153 ] . V_120 ;
return;
}
if ( V_221 < 0 )
V_136 = & ( * V_136 ) -> V_223 ;
...
for ( V_153 = 0 ; V_153 < V_118 -> V_123 ; V_153 ++ )
V_118 -> V_122 [ V_153 ] . V_222 = V_118 -> V_122 [ V_153 ] . V_120 ;
F_116 ( & V_118 -> V_113 , V_220 , V_136 ) ;
F_117 ( & V_118 -> V_113 , V_217 ) ;
}
static int F_118 ( struct V_117 * V_51 , struct V_117 * V_52 )
{
int V_153 ;
for ( V_153 = 0 ; V_153 < V_51 -> V_123 ; V_153 ++ ) {
if ( V_51 -> V_122 [ V_153 ] . V_222 == V_52 -> V_122 [ V_153 ] . V_222 )
continue;
return V_51 -> V_122 [ V_153 ] . V_222 > V_52 -> V_122 [ V_153 ] . V_222 ;
}
return 0 ;
}
static void F_119 ( struct V_216 * V_217 , struct V_117 * V_118 )
{
struct V_117 * V_218 ;
struct V_219 * * V_136 = & V_217 -> V_219 ;
struct V_219 * V_220 = NULL ;
...
static void F_120 ( struct V_216 * V_225 , struct V_216 * V_226 )
{
struct V_117 * V_118 ;
struct V_219 * V_113 ;
V_113 = F_121 ( V_226 ) ;
...
double V_231 = 0.0 ;
V_118 -> V_123 = V_123 ;
for ( V_227 = 0 ; V_227 < V_123 ; V_227 ++ ) {
double V_120 = 0.0 ;
V_85 = F_52 ( V_64 , V_84 + V_227 ) ;
V_116 = V_85 -> V_22 [ V_153 ] ;
if ( V_85 -> V_90 )
V_120 = 100.0 * V_116 / V_85 -> V_90 ;
if ( V_120 > V_231 )
V_231 = V_120 ;
V_118 -> V_122 [ V_227 ] . V_120 = V_120 ;
V_118 -> V_122 [ V_227 ] . V_124 = V_116 ;
}
if ( V_231 <= 0.5 )
goto V_156;
V_34 = V_76 + V_153 ;
...
static void F_128 ( struct V_216 * V_217 , const char * V_178 )
{
struct V_117 * V_118 ;
struct V_219 * V_113 ;
printf ( L_64 , V_178 ) ;
...
V_113 = F_121 ( V_217 ) ;
while ( V_113 ) {
double V_120 , V_231 = 0.0 ;
const char * V_155 ;
char * V_115 ;
int V_153 ;
V_118 = F_115 ( V_113 , struct V_117 , V_113 ) ;
for ( V_153 = 0 ; V_153 < V_118 -> V_123 ; V_153 ++ ) {
V_120 = V_118 -> V_122 [ V_153 ] . V_222 ;
V_155 = F_77 ( V_120 ) ;
F_78 ( stdout , V_155 , L_28 , V_120 ) ;
if ( V_120 > V_231 )
V_231 = V_120 ;
...
if ( V_85 -> V_22 [ V_34 ] != 0 )
printf ( L_68 V_29 L_69 V_91 L_10 , V_233 / 2 ,
V_27 -> V_76 + V_34 , V_85 -> V_22 [ V_34 ] ) ;
printf ( L_70 V_91 L_10 , V_233 / 2 , L_71 , V_85 -> V_90 ) ;
}
int F_131 ( struct V_26 * V_27 , struct V_19 * V_19 ,
struct V_142 * V_143 , bool V_234 ,
int V_145 , int V_146 , int V_235 )
{
struct V_172 * V_172 = V_19 -> V_172 ;
char * V_178 ;
const char * V_236 ;
const char * V_237 = F_132 ( V_143 ) ;
struct V_63 * V_64 = F_41 ( V_27 ) ;
struct V_67 * V_85 = F_52 ( V_64 , V_143 -> V_158 ) ;
...
if ( F_75 ( V_143 ) )
V_160 *= V_143 -> V_157 ;
V_240 = printf ( L_72 V_91 L_73 ,
V_160 , V_160 , L_74 , V_236 , V_237 , V_85 -> V_90 ) ;
printf ( L_75 ,
V_240 , V_240 , V_241 ) ;
if ( V_242 > 0 )
F_130 ( V_27 , V_143 ) ;
...
{
struct V_102 * V_114 , * V_243 ;
F_140 (pos, n, head, node) {
F_141 ( & V_114 -> V_113 ) ;
F_62 ( V_114 ) ;
}
}
static T_1 F_142 ( struct V_102 * V_103 , T_4 * V_244 )
{
T_1 V_45 ;
if ( V_103 -> V_34 == - 1 )
return fprintf ( V_244 , L_76 , V_103 -> line ) ;
V_45 = fprintf ( V_244 , L_14 V_29 L_26 , V_103 -> V_34 , V_103 -> V_2 . V_10 ) ;
if ( V_103 -> V_12 . V_15 [ 0 ] != '\0' ) {
V_45 += fprintf ( V_244 , L_77 , 6 - ( int ) V_45 , L_34 ,
V_103 -> V_12 . V_15 ) ;
}
return V_45 + fprintf ( V_244 , L_10 ) ;
}
T_1 F_143 ( struct V_111 * V_112 , T_4 * V_244 )
{
struct V_102 * V_114 ;
T_1 V_45 = 0 ;
F_134 (pos, head, node)
V_45 += F_142 ( V_114 , V_244 ) ;
return V_45 ;
}
int F_144 ( struct V_26 * V_27 , struct V_19 * V_19 ,
struct V_142 * V_143 , bool V_245 ,
bool V_234 , int V_145 , int V_146 )
{
struct V_172 * V_172 = V_19 -> V_172 ;
struct V_216 V_117 = V_229 ;
T_2 V_144 ;
if ( F_100 ( V_27 , V_19 , F_145 ( V_143 ) , 0 ) < 0 )
return - 1 ;
V_144 = F_42 ( V_27 ) ;
if ( V_245 ) {
V_246 = V_234 ;
