...
return - V_348 ;
if ( F_91 ( & V_345 , V_343 , sizeof( V_345 ) ) )
return - V_328 ;
V_346 = V_345 . V_349 ;
...
unsigned long V_350 )
{
F_18 ( V_347 , L_84 , V_350 ? L_85 : L_86 ) ;
if ( ! F_21 ( V_74 ) )
return - V_204 ;
V_2 -> V_179 = V_350 ? 1 : 0 ;
if ( V_2 -> V_172 != 1 && ! V_350 && ! F_101 ( V_352 ) )
return - V_206 ;
...
unsigned long V_350 )
{
F_18 ( V_347 , L_87 , V_350 ? L_88 : L_89 ) ;
if ( ! F_101 ( V_352 ) )
return - V_353 ;
V_354 = V_350 ? 1 : 0 ;
return V_354 ;
...
T_11 V_216 , V_361 ;
int V_21 ;
if ( F_91 ( & V_330 , V_343 , sizeof( V_330 ) ) )
return - V_328 ;
V_216 = V_330 . V_308 ;
...
struct V_140 V_141 ;
int V_21 ;
if ( F_91 ( & V_141 , V_343 , sizeof( V_141 ) ) )
return - V_328 ;
V_21 = V_2 -> V_16 -> V_149 ( V_2 , V_150 , & V_141 ) ;
if ( V_21 )
return V_21 ;
...
T_11 V_346 ;
int V_21 ;
if ( F_91 ( & V_143 , V_343 , sizeof( V_143 ) ) )
return - V_328 ;
V_346 = V_143 . V_154 ;
if ( V_346 != V_155 && V_346 != V_217 )
return - V_62 ;
...
if ( ! F_21 ( V_365 ) )
return - V_348 ;
if ( F_91 ( & V_219 , V_343 , sizeof( V_219 ) ) )
return - V_328 ;
...
if ( ! F_21 ( V_365 ) )
return - V_348 ;
if ( F_91 ( & V_368 , V_343 , sizeof( V_368 ) ) )
return - V_328 ;
...
if ( ! F_21 ( V_365 ) )
return - V_348 ;
if ( F_91 ( & V_371 , V_343 , sizeof( V_371 ) ) )
return - V_328 ;
...
int F_120 ( struct V_1 * V_2 , long * V_382 )
{
struct V_142 V_383 ;
T_1 V_18 ;
T_13 V_368 ;
...
+ sizeof( V_368 . V_393 ) ) ) {
* V_382 = F_121 ( V_368 . V_393 ) ;
} else {
* V_382 = F_121 ( V_368 . V_389 ) +
F_121 ( V_368 . V_391 ) ;
if ( V_368 . V_394 )
* V_382 -= ( F_121 ( V_368 . V_394 ) + 7 ) ;
}
return 0 ;
V_386:
V_383 . V_154 = V_155 ;
...
+ sizeof( V_368 . V_396 ) ) {
* V_396 = F_121 ( V_368 . V_396 ) ;
return 0 ;
}
V_397:
V_21 = F_120 ( V_2 , V_396 ) ;
if ( V_21 ) {
* V_396 = 0 ;
return V_21 ;
} else {
...
if ( F_91 ( & V_219 , (struct V_364 T_10 * ) V_350 , sizeof( V_219 ) ) )
return - V_328 ;
V_218 = F_124 ( V_219 . V_403 , V_219 . V_404 , V_219 . V_405 ) ;
if ( V_218 < 0 )
return - V_62 ;
...
struct V_406 V_407 ;
int V_218 ;
if ( F_91 ( & V_407 , (struct V_406 T_10 * ) V_350 ,
sizeof( V_407 ) ) )
return - V_328 ;
if ( V_407 . V_349 == V_155 )
V_218 = F_124 ( V_407 . V_215 . V_219 . V_222 ,
...
return - V_62 ;
return F_89 ( V_2 , V_407 . V_182 , V_218 , V_407 . V_325 ) ;
}
...
struct V_304 V_330 ;
T_5 V_216 , V_361 ;
if ( F_91 ( & V_330 , (struct V_304 T_10 * ) V_350 , sizeof( V_330 ) ) )
return - V_328 ;
V_216 = V_330 . V_308 ;
if ( ! ( ( V_216 == V_155 ) ||
( V_216 == V_217 ) ) )
...
struct V_413 V_414 ;
F_18 ( V_347 , L_102 ) ;
if ( F_91 ( & V_414 , (struct V_413 T_10 * ) V_350 , sizeof( V_414 ) ) )
return - V_328 ;
V_4 -> V_12 [ 0 ] = V_415 ;
...
int V_21 ;
F_18 ( V_347 , L_103 ) ;
if ( F_91 ( & V_417 , (struct V_370 T_10 * ) V_350 ,
sizeof( V_417 ) ) )
return - V_328 ;
V_4 -> V_27 = V_27 ;
V_4 -> V_22 = 24 ;
...
return - V_348 ;
F_18 ( V_347 , L_107 ) ;
if ( F_91 ( & V_229 , ( T_6 T_10 * ) V_350 , sizeof( V_229 ) ) )
return - V_328 ;
V_21 = F_64 ( V_2 , & V_229 ) ;
if ( V_21 )
return V_21 ;
...
case V_400 :
case V_402 :
return F_123 ( V_2 , V_430 , & V_4 , V_12 ) ;
case V_431 :
return F_126 ( V_2 , V_430 ) ;
case V_362 :
return F_127 ( V_2 , V_430 ) ;
case V_366 :
return F_128 ( V_2 , V_430 , & V_4 ) ;
case V_432 :
return F_129 ( V_2 , V_430 , & V_4 ) ;
case V_372 :
case V_373 :
return F_130 ( V_2 , V_430 , & V_4 , V_12 ) ;
case V_425 :
case V_433 :
...
case V_435 :
return F_133 ( V_2 , V_430 , & V_4 ) ;
case V_436 :
return F_135 ( V_2 , V_430 ) ;
case V_437 :
...
int V_21 ;
V_21 = F_140 ( V_170 , V_171 , V_12 , V_343 ) ;
if ( V_21 != - V_266 )
return V_21 ;
switch ( V_12 ) {
case V_439 :
return F_90 ( V_2 , V_343 ) ;
case V_440 :
return F_92 ( V_2 ) ;
case V_441 :
return F_93 ( V_2 ) ;
...
static int F_141 ( const char * V_141 , int V_456 , char * V_196 ,
int * V_457 , enum V_458 V_459 )
{
const int V_460 = sizeof( V_461 . V_196 ) ;
struct V_1 * V_2 ;
int V_21 ;
V_21 = F_142 ( V_196 + * V_457 , V_460 - * V_457 , V_141 ) ;
if ( ! V_21 )
return 1 ;
* V_457 += V_21 ;
...
switch ( V_459 ) {
case V_462 :
V_21 = F_142 ( V_196 + * V_457 , V_460 - * V_457 ,
L_110 , V_2 -> V_54 ) ;
break;
case V_463 :
V_21 = F_142 ( V_196 + * V_457 , V_460 - * V_457 ,
...
static int F_144 ( struct V_467 * V_468 , int V_31 ,
...
F_23 ( & V_101 ) ;
V_457 = sprintf ( V_196 , L_113 V_471 L_9 ) ;
if ( F_141 ( L_114 , 0 , V_196 , & V_457 , V_462 ) )
goto V_472;
if ( F_141 ( L_115 , 0 , V_196 , & V_457 , V_463 ) )
goto V_472;
if ( F_141 ( L_116 , 0 , V_196 , & V_457 , V_465 ) )
goto V_472;
if ( F_141 ( L_117 ,
...
goto V_472;
if ( ! F_142 ( V_196 + V_457 , V_460 - V_457 , L_134 ) )
goto V_472;
V_473:
F_25 ( & V_101 ) ;
return F_145 ( V_468 , V_31 , V_27 , V_469 , V_470 ) ;
V_472:
F_10 ( L_135 ) ;
goto V_473;
}
...
static int F_147 ( struct V_467 * V_468 , int V_31 ,
void T_10 * V_27 , T_16 * V_469 , T_17 * V_470 )
{
int V_21 ;
V_21 = F_148 ( V_468 , V_31 , V_27 , V_469 , V_470 ) ;
if ( V_31 ) {
V_87 = ! ! V_461 . V_87 ;
V_89 = ! ! V_461 . V_89 ;
V_354 = ! ! V_461 . V_354 ;
