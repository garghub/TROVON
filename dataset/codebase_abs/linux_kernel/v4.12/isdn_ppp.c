...
V_319 = F_61 ( sizeof( struct V_320 ) , V_153 ) ;
if ( ! V_319 )
return NULL ;
V_319 -> V_24 = V_330 ;
V_319 -> V_14 = V_14 ;
...
V_341 . V_2 = V_342 ;
V_341 . V_344 = V_343 ;
V_339 = F_75 ( V_14 -> V_63 + V_345 ) ;
if ( ! V_339 ) {
F_56 ( V_170 ) ;
F_2 ( V_17 L_109 ) ;
return NULL ;
}
V_3 = V_114 -> V_346 ( V_338 , V_170 , V_339 , & V_341 ) ;
F_56 ( V_170 ) ;
if ( V_3 <= 0 ) {
switch ( V_3 ) {
case V_347 :
...
V_114 -> V_350 ( V_338 , V_170 , * V_151 ) ;
return V_170 ;
}
}
static struct V_169 * F_93 ( struct V_169 * V_351 , int * V_151 ,
...
V_339 = F_53 ( V_351 -> V_3 + V_351 -> V_3 / 2 + 32 +
F_85 ( V_351 ) , V_153 ) ;
if ( ! V_339 )
return V_351 ;
F_54 ( V_339 , F_85 ( V_351 ) ) ;
