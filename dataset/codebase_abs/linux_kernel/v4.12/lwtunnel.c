...
int F_31 ( struct V_41 * V_42 , struct V_11 * V_43 )
{
const struct V_15 * V_16 ;
struct V_22 * V_44 ;
int V_21 ;
...
V_21 = - V_27 ;
F_10 () ;
V_16 = F_11 ( V_20 [ V_43 -> type ] ) ;
if ( F_12 ( V_16 && V_16 -> V_47 ) )
V_21 = V_16 -> V_47 ( V_42 , V_43 ) ;
F_15 () ;
if ( V_21 )
goto V_48;
F_33 ( V_42 , V_44 ) ;
V_21 = F_34 ( V_42 , V_38 , V_43 -> type ) ;
if ( V_21 )
goto V_48;
return 0 ;
V_48:
...
int F_39 ( struct V_53 * V_53 , struct V_54 * V_55 , struct V_41 * V_42 )
{
struct V_56 * V_57 = F_40 ( V_42 ) ;
const struct V_15 * V_16 ;
struct V_11 * V_43 ;
int V_21 = - V_26 ;
if ( ! V_57 )
