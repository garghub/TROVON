...
( V_24 -> V_29 & V_410 ) &&
V_2 -> V_413 < V_24 -> V_25 &&
V_14 == V_24 -> V_14 [ V_2 -> V_413 ] )
return;
if ( V_2 -> type == V_9 &&
( ! F_42 ( V_2 -> V_10 , V_125 -> V_414 ) ) == V_14 )
...
static void F_56 ( struct V_417 * V_418 )
{
struct V_12 * V_5 = F_57 ( V_418 , struct V_12 ,
V_419 ) ;
struct V_38 * V_24 ;
struct V_19 * V_20 ;
int V_34 , V_74 ;
...
V_20 = V_24 -> V_20 ;
if ( V_5 -> V_420 -> V_421 )
return V_5 -> V_420 -> V_421 ( V_5 , V_20 , V_422 ) ;
V_34 = F_58 ( V_20 ) ;
V_75 = F_59 ( V_20 , V_80 ) ;
if ( ! V_75 )
return;
...
if ( type != V_416 )
return - 1 ;
if ( ( V_424 = F_53 ( V_5 , type , V_10 , & V_24 ) ) == - 1 ) {
F_30 ( V_32 , L_8 ) ;
return - 1 ;
}
F_64 ( V_24 , V_424 , V_14 ) ;
F_65 ( & V_5 -> V_419 ) ;
return 0 ;
}
...
{
struct V_426 * V_427 = V_5 -> V_132 ;
struct V_428 * V_429 ;
struct V_19 * V_430 ;
int V_16 , V_17 ;
V_429 = & V_5 -> V_431 [ V_120 ] ;
F_5 (rep, &rep_enum->report_list, list)
for ( V_16 = 0 ; V_16 < V_430 -> V_23 ; V_16 ++ ) {
if ( V_430 -> V_24 [ V_16 ] -> V_130 < 1 )
continue;
for ( V_17 = 0 ; V_17 < V_430 -> V_24 [ V_16 ] -> V_25 ; V_17 ++ ) {
F_23 ( V_5 , V_120 , V_430 -> V_24 [ V_16 ] ) ;
if ( V_427 -> V_432 )
V_427 -> V_432 ( V_5 , V_430 -> V_24 [ V_16 ] ,
V_430 -> V_24 [ V_16 ] -> V_2 + V_17 ) ;
}
}
}
...
for ( V_16 = 0 ; V_16 < F_78 ( V_444 ) ; V_16 ++ )
V_443 |= V_124 -> V_125 -> V_138 [ V_16 ] ;
for ( V_16 = 0 ; V_16 < F_78 ( V_445 ) ; V_16 ++ )
V_443 |= V_124 -> V_125 -> V_37 [ V_16 ] ;
for ( V_16 = 0 ; V_16 < F_78 ( V_446 ) ; V_16 ++ )
V_443 |= V_124 -> V_125 -> V_447 [ V_16 ] ;
for ( V_16 = 0 ; V_16 < F_78 ( V_448 ) ; V_16 ++ )
V_443 |= V_124 -> V_125 -> V_402 [ V_16 ] ;
for ( V_16 = 0 ; V_16 < F_78 ( V_449 ) ; V_16 ++ )
V_443 |= V_124 -> V_125 -> V_223 [ V_16 ] ;
for ( V_16 = 0 ; V_16 < F_78 ( V_450 ) ; V_16 ++ )
V_443 |= V_124 -> V_125 -> V_451 [ V_16 ] ;
for ( V_16 = 0 ; V_16 < F_78 ( V_452 ) ; V_16 ++ )
V_443 |= V_124 -> V_125 -> V_453 [ V_16 ] ;
for ( V_16 = 0 ; V_16 < F_78 ( V_454 ) ; V_16 ++ )
V_443 |= V_124 -> V_125 -> V_455 [ V_16 ] ;
for ( V_16 = 0 ; V_16 < F_78 ( V_456 ) ; V_16 ++ )
V_443 |= V_124 -> V_125 -> V_457 [ V_16 ] ;
return ! ! V_443 ;
}
...
int F_83 ( struct V_12 * V_5 , unsigned int V_459 )
{
struct V_426 * V_427 = V_5 -> V_132 ;
struct V_19 * V_20 ;
struct V_123 * V_460 , * V_124 = NULL ;
int V_16 , V_18 ;
F_84 ( & V_5 -> V_442 ) ;
F_85 ( & V_5 -> V_419 , F_56 ) ;
if ( ! V_459 ) {
for ( V_16 = 0 ; V_16 < V_5 -> V_461 ; V_16 ++ ) {
struct V_462 * V_463 = & V_5 -> V_464 [ V_16 ] ;
if ( V_463 -> type == V_465 ||
V_463 -> type == V_466 )
if ( F_86 ( V_463 -> V_2 ) )
break;
