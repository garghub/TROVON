...
static void F_89 ( struct V_210 * V_213 )
{
...
F_100 ( & V_213 -> V_211 , & V_229 ) ;
V_213 -> V_211 . V_230 = V_231 ;
F_101 ( & V_213 -> V_211 . V_232 , L_5 , V_213 -> V_214 ) ;
V_213 -> V_212 . V_233 = & V_234 ;
V_213 -> V_212 . V_235 = V_143 -> V_212 . V_235 ;
V_213 -> V_212 . V_236 = V_224 ;
F_102 ( & V_213 -> V_212 , L_5 , V_213 -> V_214 ) ;
if ( F_103 ( & V_213 -> V_211 , & V_213 -> V_212 ) )
goto V_237;
...
static void F_108 ( struct V_223 * V_143 , void * V_241 )
{
...
{
int V_221 ;
V_221 = F_110 ( V_228 , V_215 ,
L_3 ) ;
if ( V_221 ) {
F_94 ( L_6 ) ;
goto V_242;
}
V_221 = F_111 ( & V_234 , & V_243 . V_219 ) ;
if ( V_221 ) {
F_94 ( L_7 ) ;
goto V_244;
}
