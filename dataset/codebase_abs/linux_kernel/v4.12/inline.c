...
if ( ( void * ) V_176 - ( ( void * ) F_8 ( & V_5 ) -> V_48 ) <
V_31 ) {
V_101 = ( void * ) F_8 ( & V_5 ) -> V_48 +
V_130 ;
V_92 = V_31 -
...
if ( V_111 )
goto V_25;
V_111 = F_143 ( V_50 , V_100 , V_176 , V_30 ,
V_101 , V_92 , 0 ) ;
if ( V_111 )
goto V_25;
F_94 ( V_100 , V_5 . V_30 , V_101 , V_92 ) ;
...
if ( V_101 )
* V_101 = V_178 ;
return (struct V_104 * ) ( V_178 + V_102 ) ;
}
...
struct V_179 * V_180 ,
int * V_181 , T_5 V_182 , T_5 V_46 )
{
T_5 V_183 = 0 ;
T_5 V_184 ;
V_20 V_72 = V_185 | V_186 |
V_187 ;
int error = 0 ;
struct V_4 V_5 ;
F_18 ( & F_2 ( V_1 ) -> V_29 ) ;
...
if ( error )
goto V_25;
V_183 = ( T_5 ) V_5 . V_30 -> V_188 << V_1 -> V_13 -> V_189 ;
V_183 += ( char * ) F_8 ( & V_5 ) - V_5 . V_30 -> V_128 ;
V_183 += F_150 ( struct V_10 , V_48 ) ;
if ( V_183 )
error = F_151 ( V_180 , V_182 , V_183 ,
V_184 , V_72 ) ;
F_20 ( V_5 . V_30 ) ;
V_25:
F_19 ( & F_2 ( V_1 ) -> V_29 ) ;
...
int F_153 ( struct V_1 * V_1 , int * V_181 )
{
T_3 * V_50 ;
