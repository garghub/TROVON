...
static int F_24 ( struct V_3 * V_4 , unsigned long V_24 , bool * V_25 )
{
struct V_8 * V_9 = F_7 ( V_4 -> V_10 ) ;
...
struct V_28 * * V_44 , unsigned long * V_24 , bool V_31 )
{
int V_32 ;
struct V_8 * V_9 = F_7 ( V_4 -> V_10 ) ;
...
if ( V_46 ) {
F_37 ( & V_46 -> V_23 , & V_47 -> V_23 ) ;
F_21 ( V_4 , & V_46 -> V_6 ) ;
F_22 ( & V_46 -> V_21 , F_13 ) ;
} else {
F_38 ( & V_47 -> V_23 , & V_9 -> V_19 ) ;
}
return 0 ;
V_39:
F_15 ( & V_47 -> V_14 ) ;
...
static void F_39 ( struct V_3 * V_4 , struct V_54 * V_24 )
{
struct V_8 * V_9 = F_7 ( V_4 -> V_10 ) ;
struct V_11 * V_12 ;
F_8 (f, &head->flist, link) {
