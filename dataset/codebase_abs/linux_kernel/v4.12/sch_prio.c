...
if ( V_7 -> V_23 [ V_41 ] != & V_50 )
F_31 ( V_7 -> V_23 [ V_41 ] , true ) ;
}
F_32 ( V_4 ) ;
return 0 ;
}
static int F_33 ( struct V_1 * V_4 , struct V_37 * V_38 )
{
if ( ! V_38 )
return - V_44 ;
...
if ( F_36 ( V_3 , V_52 , sizeof( V_38 ) , & V_38 ) )
goto V_53;
return V_3 -> V_54 ;
V_53:
F_37 ( V_3 , V_51 ) ;
...
static int F_38 ( struct V_1 * V_4 , unsigned long V_55 , struct V_1 * V_56 ,
struct V_1 * * V_57 )
{
struct V_6 * V_7 = F_2 ( V_4 ) ;
...
if ( V_56 == NULL )
V_56 = & V_50 ;
* V_57 = F_39 ( V_4 , V_56 , & V_7 -> V_23 [ V_8 ] ) ;
return 0 ;
}
static struct V_1 *
F_40 ( struct V_1 * V_4 , unsigned long V_55 )
{
struct V_6 * V_7 = F_2 ( V_4 ) ;
unsigned long V_8 = V_55 - 1 ;
return V_7 -> V_23 [ V_8 ] ;
...
F_48 ( V_65 , NULL , & V_66 -> V_35 , V_66 -> V_7 . V_31 ) < 0 )
return - 1 ;
return 0 ;
}
static void F_49 ( struct V_1 * V_4 , struct V_68 * V_55 )
{
struct V_6 * V_7 = F_2 ( V_4 ) ;
int V_32 ;
if ( V_55 -> V_69 )
...
if ( V_55 -> V_72 ( V_4 , V_32 + 1 , V_55 ) < 0 ) {
V_55 -> V_69 = 1 ;
break;
}
V_55 -> V_70 ++ ;
...
static struct V_12 T_2 * * F_50 ( struct V_1 * V_4 ,
unsigned long V_59 )
{
struct V_6 * V_7 = F_2 ( V_4 ) ;
if ( V_59 )
