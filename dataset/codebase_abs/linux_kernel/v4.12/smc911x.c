...
V_224 | V_225 ;
if ( V_13 -> V_141 == 10 )
V_219 -> V_226 . V_227 = V_228 ;
else if ( V_13 -> V_141 == 100 )
V_219 -> V_226 . V_227 = V_229 ;
V_219 -> V_226 . V_230 = V_231 ;
V_219 -> V_226 . V_232 = 0 ;
...
if ( V_219 -> V_226 . V_230 != V_231 ||
V_219 -> V_226 . V_227 != V_228 ||
( V_219 -> V_226 . V_233 != V_237 &&
V_219 -> V_226 . V_233 != V_236 ) ||
( V_219 -> V_226 . V_232 != V_239 &&
V_219 -> V_226 . V_232 != V_240 ) )
return - V_241 ;
V_13 -> V_109 = V_219 -> V_226 . V_233 == V_236 ;
V_220 = 0 ;
}
return V_220 ;
}
...
if ( ( V_220 = F_143 ( V_11 , V_264 , V_3 ) ) != 0 )
return V_220 ;
if ( ( V_220 = F_145 ( V_11 , & V_262 [ V_3 ] ) ) != 0 )
return V_220 ;
}
...
return V_220 ;
if ( ( V_220 = F_143 ( V_11 , V_268 , V_3 ) ) != 0 )
return V_220 ;
}
return 0 ;
}
