...
if ( memcmp ( & V_23 -> V_64 , & V_61 -> V_64 ,
sizeof( V_61 -> V_64 ) ) )
F_28 ( V_23 -> V_7 , L_15 ,
V_61 -> V_64 . type , V_61 -> V_64 . V_65 ,
V_61 -> V_64 . V_66 , V_61 -> V_64 . V_67 ) ;
F_2 ( V_23 -> V_7 , L_16 ,
V_61 -> V_68 . V_69 , V_61 -> V_68 . time ) ;
V_23 -> V_64 . type = V_61 -> V_64 . type ;
V_23 -> V_64 . V_65 = V_61 -> V_64 . V_65 ;
V_23 -> V_64 . V_66 = V_61 -> V_64 . V_66 ;
V_23 -> V_64 . V_67 = V_61 -> V_64 . V_67 ;
V_63:
F_7 ( V_23 , V_30 , V_70 , 0 , NULL , 0 ) ;
}
static void F_29 ( struct V_2 * V_23 ,
struct V_24 * V_6 )
{
T_1 V_4 ;
int V_71 ;
...
struct V_75 * V_76 ;
T_1 V_77 , V_78 ;
V_77 = V_6 -> V_44 . V_36 . V_45 ;
V_4 = ( (struct V_79 * ) V_6 -> V_49 ) -> V_80 ;
V_74 = ( V_6 -> V_49 + sizeof( struct V_79 ) ) ;
V_72 = V_77 - ( sizeof( struct V_79 ) ) ;
switch ( V_4 ) {
case V_81 :
V_78 = ( (struct V_79 * ) V_6 -> V_49 ) -> V_78 ;
V_71 = F_30 ( V_23 , V_78 ) ;
if ( V_71 > 0 ) {
F_2 ( V_23 -> V_7 ,
L_17 ,
...
case V_92 :
F_15 ( V_23 -> V_7 , L_18 ) ;
for ( V_73 = 0 ; V_73 < ( V_72 / 4 ) ; V_73 ++ )
F_31 ( V_93 , NULL , V_94 ,
16 , 4 , V_74 , V_72 , false ) ;
break;
case V_95 :
F_26 ( V_23 , V_74 ) ;
break;
...
if ( V_98 . V_38 . V_14 && V_5 && ! V_98 . V_38 . V_46 ) {
F_15 ( V_23 -> V_7 , L_22 , V_77 ) ;
F_7 ( V_23 , V_98 . V_38 . V_14 ,
V_98 . V_38 . V_5 ,
V_98 . V_38 . V_4 , NULL , 0 ) ;
return;
}
if ( V_98 . V_38 . V_46 ) {
V_16 = F_33 ( ( void * ) V_6 -> V_49 , V_77 , V_8 ) ;
if ( ! V_16 )
return;
V_99 = (struct V_79 * ) V_16 ;
F_2 ( V_23 -> V_7 , L_23 , V_99 -> V_80 ) ;
if ( F_7 ( V_23 , V_98 . V_38 . V_14 ,
V_98 . V_38 . V_5 ,
V_98 . V_38 . V_4 , V_16 , V_77 ) )
F_14 ( V_16 ) ;
} else {
F_7 ( V_23 , V_98 . V_38 . V_14 ,
V_98 . V_38 . V_5 ,
