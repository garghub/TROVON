...
static int F_52 ( struct V_91 * V_81 , int V_124 )
{
struct V_8 * V_9 = V_81 -> V_101 ;
struct V_17 * V_18 = F_3 ( V_9 ) ;
F_4 ( V_18 , L_20 , V_36 , V_124 ) ;
switch ( V_124 ) {
case V_125 :
F_49 ( & V_9 -> V_52 ) ;
break;
...
V_127 | V_129 , V_9 -> V_130 , V_18 ) ;
if ( V_21 < 0 ) {
F_57 ( & V_9 -> V_52 ,
L_22
L_23 ,
V_9 -> V_130 , V_9 -> V_83 , V_21 ) ;
return V_21 ;
}
return 0 ;
}
...
if ( F_13 ( V_49 -> V_133 ) != 0x0100 ) {
F_14 ( & V_9 -> V_52 ,
L_26 ,
F_13 ( V_49 -> V_133 ) ) ;
return - V_132 ;
}
V_131 = F_13 ( V_49 -> V_134 ) ;
if ( V_131 != sizeof( struct V_112 ) ) {
F_14 ( & V_9 -> V_52 , L_27 ,
V_131 ) ;
return - V_132 ;
}
F_4 ( V_18 , L_28 , V_131 , V_18 -> V_33 ) ;
return 0 ;
}
...
T_6 V_142 ;
V_142 = F_60 ( & V_9 -> V_52 ) ;
if ( ! V_142 || F_61 ( V_142 , & V_141 ) )
return - V_132 ;
V_139 = F_62 ( V_142 , V_137 , 1 , 1 , NULL ,
V_143 ) ;
if ( ! V_139 ) {
F_14 ( & V_9 -> V_52 , L_29 ) ;
return - V_132 ;
}
V_136 -> V_144 = V_139 -> integer . V_145 ;
F_63 ( V_139 ) ;
return 0 ;
}
static void F_64 ( struct V_88 * V_52 )
{
T_6 V_142 = F_60 ( V_52 ) ;
struct V_140 * V_141 ;
if ( V_142 && F_61 ( V_142 , & V_141 ) == 0 )
F_65 ( V_141 ) ;
}
...
static inline void F_64 ( struct V_88 * V_52 ) {}
...
T_1 V_146 ;
int V_21 ;
V_21 = F_67 ( V_52 -> V_147 , L_30 , & V_146 ) ;
if ( V_21 ) {
F_14 ( & V_9 -> V_52 , L_31 ) ;
return - V_132 ;
}
...
const struct V_149 * V_84 )
{
int V_21 ;
struct V_17 * V_18 ;
struct V_91 * V_81 ;
V_6 V_150 ;
struct V_135 * V_151 = V_9 -> V_52 . V_151 ;
F_40 ( L_34 , V_9 -> V_37 ) ;
if ( ! V_9 -> V_83 ) {
F_14 ( & V_9 -> V_52 ,
L_35 ) ;
...
return - V_97 ;
if ( V_9 -> V_52 . V_147 ) {
V_21 = F_66 ( V_9 , & V_18 -> V_136 ) ;
if ( V_21 )
goto V_153;
} else if ( ! V_151 ) {
V_21 = F_59 ( V_9 , & V_18 -> V_136 ) ;
if ( V_21 ) {
F_14 ( & V_9 -> V_52 ,
L_31 ) ;
goto V_153;
...
V_18 -> V_136 . V_154 = F_69 ( & V_9 -> V_52 , L_37 ) ;
if ( F_70 ( V_18 -> V_136 . V_154 ) ) {
V_21 = F_71 ( V_18 -> V_136 . V_154 ) ;
if ( V_21 != - V_152 )
F_14 ( & V_9 -> V_52 , L_38 ,
V_21 ) ;
goto V_153;
}
V_21 = F_72 ( V_18 -> V_136 . V_154 ) ;
if ( V_21 < 0 ) {
F_14 ( & V_9 -> V_52 , L_39 ,
V_21 ) ;
goto V_153;
...
if ( V_18 -> V_136 . V_148 )
F_41 ( V_18 -> V_136 . V_148 ) ;
F_73 ( V_9 , V_18 ) ;
V_18 -> V_9 = V_9 ;
V_150 = V_18 -> V_136 . V_144 ;
V_18 -> V_31 = F_74 ( V_150 ) ;
F_75 ( & V_18 -> V_26 ) ;
F_76 ( & V_18 -> V_73 ) ;
...
V_81 -> V_161 = V_162 ;
V_81 -> V_163 = F_13 ( V_18 -> V_49 . V_133 ) ;
V_81 -> V_164 = F_13 ( V_18 -> V_49 . V_165 ) ;
V_81 -> V_166 = F_13 ( V_18 -> V_49 . V_167 ) ;
snprintf ( V_81 -> V_130 , sizeof( V_81 -> V_130 ) , L_40 ,
V_9 -> V_130 , V_81 -> V_164 , V_81 -> V_166 ) ;
F_82 ( V_81 -> V_168 , F_83 ( & V_9 -> V_52 ) , sizeof( V_81 -> V_168 ) ) ;
...
static int F_93 ( struct V_88 * V_52 )
{
struct V_8 * V_9 = F_94 ( V_52 ) ;
struct V_17 * V_18 = F_3 ( V_9 ) ;
