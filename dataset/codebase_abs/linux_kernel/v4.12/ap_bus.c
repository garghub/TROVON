...
int V_71 , V_12 , V_141 , V_142 , V_143 ;
F_68 ( V_92 , L_12 ) ;
F_8 () ;
if ( F_110 () != 0 )
goto V_144;
...
V_50 -> V_88 . V_73 . V_147 = & V_63 -> V_88 . V_73 ;
...
if ( V_71 )
goto V_144;
for ( V_134 = 0 ; V_155 [ V_134 ] ; V_134 ++ ) {
V_71 = F_136 ( & V_94 , V_155 [ V_134 ] ) ;
if ( V_71 )
goto V_156;
}
V_148 = F_137 ( L_15 ) ;
