...
V_161 -> V_165 . V_166 = V_168 ;
switch ( V_2 -> V_14 & V_169 ) {
case V_170 :
V_161 -> V_165 . V_171 = V_172 ;
break;
case V_173 :
V_161 -> V_165 . V_171 = V_174 ;
break;
case V_175 :
V_161 -> V_165 . V_171 = V_176 ;
break;
default:
F_16 ( L_33 , V_5 ) ;
V_161 -> V_165 . V_171 = V_172 ;
...
V_163 = V_162 ;
if ( V_2 -> V_28 & V_184 ) {
V_161 -> V_165 . V_185 = V_186 ;
} else {
V_161 -> V_165 . V_185 = V_187 ;
V_163 &= ~ V_188 ;
}
V_161 -> V_165 . V_189 = V_190 ;
F_103 ( V_161 -> V_191 . V_162 ,
V_162 ) ;
F_103 ( V_161 -> V_191 . V_163 ,
V_163 ) ;
return 0 ;
}
static int
F_104 ( struct V_10 * V_15 ,
const struct V_160 * V_161 )
{
struct V_1 * V_2 = F_60 ( V_15 ) ;
T_1 V_23 ;
int V_68 ;
if ( V_161 -> V_165 . V_185 == V_186 ) {
V_23 = V_184 ;
} else {
switch ( V_161 -> V_165 . V_171 ) {
case V_172 :
V_23 = V_170 ;
break;
case V_174 :
...
if ( V_161 -> V_165 . V_166 == V_167 ) {
V_23 |= V_164 ;
} else if ( V_161 -> V_165 . V_171 == V_176 ) {
F_16 ( L_34 ) ;
return - V_192 ;
}
}
...
V_194 -> V_162 = 0 ;
V_194 -> V_196 = F_107 () ? V_194 -> V_162 : 0 ;
memset ( & V_194 -> V_197 , 0 , sizeof( V_194 -> V_197 ) ) ;
}
...
0 , 0 , 0 , & V_24 , & V_9 ) ;
V_24 <<= 16 ;
if ( V_4 || ! F_121 ( ( V_225 * ) & V_24 ) ) {
F_5 ( F_6 ( V_2 ) ,
L_40 ,
V_5 , V_4 ) ;
return - V_192 ;
}
memcpy ( V_15 -> V_226 , & V_24 , V_96 ) ;
if ( V_2 -> V_117 ) {
V_15 -> V_227 += V_111 ;
V_15 -> V_127 |= V_228 ;
}
...
V_234 =
sizeof( struct V_1 ) +
sizeof( struct V_19 ) * V_235 +
sizeof( struct V_19 ) * V_45 +
V_236 - 1 ;
V_90 = F_126 ( V_234 , V_237 ) ;
if ( ! V_90 )
return NULL ;
V_2 = F_127 ( V_90 , V_236 ) ;
V_2 -> V_238 = V_90 ;
* V_15 = F_128 ( sizeof( struct V_233 ) ) ;
if ( ! * V_15 ) {
F_129 ( V_2 -> V_238 ) ;
return NULL ;
}
...
for ( V_50 = 0 ; V_50 < F_136 ( V_240 ) ; V_50 ++ ) {
V_4 = F_10 ( F_3 ( V_2 ) , F_4 ( V_2 ) ,
V_244 ,
V_240 [ V_50 ] . V_121 ,
0 , 0 , & V_24 , & V_9 ) ;
...
static int F_137 ( struct V_246 * V_78 )
{
struct V_1 * V_2 ;
struct V_10 * V_15 ;
int V_123 ;
...
V_123 = F_139 ( V_78 ) ;
if ( V_123 ) {
F_89 ( & V_78 -> V_247 , L_49 ,
V_5 ) ;
goto V_248;
}
V_123 = F_140 ( V_78 -> V_249 ) ;
if ( V_123 ) {
F_89 ( & V_78 -> V_247 , L_50 ,
V_5 , V_123 ) ;
F_52 ( L_51 ) ;
goto V_250;
}
...
if ( V_123 )
goto V_257;
V_2 -> V_258 = V_2 -> V_76 . V_30 ;
V_2 -> V_69 = V_2 -> V_29 . V_30 ;
F_89 ( F_6 ( V_2 ) , L_56 ,
V_2 -> V_69 , V_2 -> V_258 , sizeof( struct V_19 ) ,
V_235 ) ;
V_123 = F_50 ( V_2 ) ;
if ( V_123 )
goto V_259;
...
F_149 ( V_15 , & V_2 -> V_78 -> V_247 ) ;
F_118 ( V_15 , & V_2 -> V_42 ) ;
V_123 = F_120 ( V_15 , V_2 ) ;
if ( V_123 ) {
F_89 ( & V_78 -> V_247 , L_57 ,
V_5 , V_123 ) ;
goto V_260;
}
#ifdef F_95
...
static int F_156 ( struct V_246 * V_78 )
{
