...
if ( V_493 -> V_511 > 1 )
F_186 ( V_485 , V_493 -> V_511 - 1 ) ;
for ( V_26 = 0 ; V_26 < V_493 -> V_511 ; V_26 ++ ) {
T_7 * V_512 = & V_493 -> V_512 [ V_505 + V_26 ] ;
* V_512 = F_187 ( V_362 >> V_513 ) ;
V_362 += V_493 -> V_514 ;
}
return 0 ;
}
...
{
int V_375 = V_493 -> V_515 ;
V_493 -> V_516 ++ ;
if ( ( V_493 -> V_516 % V_493 -> V_511 ) == 0 ) {
int V_10 = F_183 ( V_4 , V_493 , V_61 , V_375 ) ;
if ( F_70 ( V_10 ) ) {
V_493 -> V_516 -- ;
return;
}
V_493 -> V_515 += V_493 -> V_511 ;
F_189 ( V_493 -> V_515 > V_493 -> V_517 ) ;
if ( V_493 -> V_515 == V_493 -> V_517 )
V_493 -> V_515 = 0 ;
if ( V_493 -> V_516 >= V_493 -> V_518 ) {
F_18 ( F_190 ( V_493 -> V_519 ) , V_493 -> V_516 ) ;
V_493 -> V_516 = 0 ;
}
}
}
...
{
unsigned int V_375 = V_493 -> V_520 ;
int V_521 = 0 ;
V_493 -> V_522 ++ ;
while ( 1 ) {
...
T_3 V_523 ;
V_521 ++ ;
V_2 = F_192 ( & V_493 -> V_524 [ V_375 ] ) ;
V_362 = ( V_2 & V_525 ) <<
V_526 ;
V_485 = F_180 ( V_493 , V_362 , & V_309 ) ;
V_523 = V_493 -> V_527 [ ( V_2 & V_528 ) >>
V_529 ] ;
if ( ( V_485 -> V_375 + V_509 ) - V_523 == V_362 ) {
* V_309 = (struct V_485 * ) V_485 -> V_502 ;
V_4 -> V_304 -> V_530 ( V_4 -> V_508 , V_485 -> V_375 ,
V_509 , V_510 ) ;
V_485 -> V_375 = 0 ;
V_485 -> V_502 = NULL ;
F_185 ( V_485 ) ;
...
static int F_194 ( struct V_533 * V_534 , struct V_3 * V_4 ,
struct V_492 * V_493 )
{
unsigned int V_375 = V_493 -> V_520 ;
struct V_535 * V_536 ;
...
V_538 = V_490 - V_484 -> V_490 ;
F_175 ( V_484 , V_485 , V_335 , V_538 , V_523 ) ;
if ( ( V_485 -> V_375 + V_493 -> V_514 ) - V_523 == V_362 ) {
* V_309 = (struct V_485 * ) V_485 -> V_502 ;
V_4 -> V_304 -> V_530 ( V_4 -> V_508 , V_485 -> V_375 ,
V_509 , V_510 ) ;
V_485 -> V_375 = 0 ;
...
V_493 -> V_520 = V_375 ;
V_490 += sizeof( * V_536 ) ;
V_490 = F_198 ( int , V_490 , sizeof( * V_536 ) + V_550 ) ;
F_199 ( V_484 , V_490 ) ;
V_536 = (struct V_535 * ) V_484 -> V_35 ;
if ( V_4 -> V_11 -> V_551 & V_552 )
F_200 ( V_484 ,
( ( T_3 ) V_536 -> V_553 << 24 |
( T_3 ) V_536 -> V_554 << 16 |
( T_3 ) V_536 -> V_555 << 8 |
...
int V_10 , V_375 = V_493 -> V_515 ;
V_10 = 0 ;
while ( V_375 < ( V_493 -> V_517 - V_561 ) ) {
...
V_4 -> V_304 -> V_530 ( V_4 -> V_508 , V_458 , V_509 ,
V_510 ) ;
V_485 -> V_375 = 0 ;
V_485 -> V_502 = NULL ;
F_185 ( V_485 ) ;
...
for ( V_26 = 0 ; V_26 < V_493 -> V_517 ; V_26 ++ )
V_493 -> V_512 [ V_26 ] = F_187 ( 0 ) ;
V_493 -> V_515 = 0 ;
}
...
F_189 ( V_565 -> V_484 != NULL ) ;
V_4 -> V_304 -> V_530 ( V_4 -> V_508 , V_565 -> V_502 ,
...
const int V_6 )
{
int V_519 = V_493 -> V_519 ;
T_3 V_595 , V_596 ;
V_595 = F_16 ( F_224 ( V_519 ) ) ;
...
L_30 ,
V_519 , V_595 , V_595 - V_6 ) ;
}
V_596 = F_16 ( F_226 ( V_519 ) ) ;
if ( F_70 ( ( V_596 & V_601 ) > V_6 ) ) {
F_18 ( F_226 ( V_519 ) , 0 ) ;
V_493 -> V_522 += V_596 & V_601 ;
if ( F_70 ( V_596 & V_602 ) )
F_225 ( V_4 -> V_508 , L_31 , V_519 ) ;
F_166 ( V_4 , V_600 , V_473 , V_4 -> V_11 ,
L_32 ,
V_519 , V_596 , V_596 - V_6 ) ;
}
}
static int F_227 ( struct V_533 * V_534 , struct V_3 * V_4 ,
...
T_1 V_609 ;
#if 1
V_609 = F_16 ( F_228 ( V_493 -> V_519 ) ) ;
V_604 = F_16 ( F_229 ( V_493 -> V_519 ) ) & V_610 ;
#else
V_609 = F_192 ( & V_608 -> V_611 ) ;
V_604 = ( F_192 ( & V_608 -> V_612 ) & V_610 ) ;
#endif
V_608 -> V_611 = 0 ;
V_608 -> V_612 = 0 ;
F_166 ( V_4 , V_613 , V_473 , V_4 -> V_11 ,
L_33 ,
V_67 , V_493 -> V_519 , ( unsigned long long ) V_609 , V_604 ) ;
V_605 = V_606 = 0 ;
V_604 = F_230 ( V_604 , V_603 ) ;
while ( V_606 < V_604 ) {
V_605 += F_194 ( V_534 , V_4 , V_493 ) ;
V_606 ++ ;
}
if ( V_493 -> V_531 >= V_493 -> V_518 ) {
unsigned int V_26 ;
for ( V_26 = 0 ; V_26 < V_493 -> V_531 ; V_26 ++ )
F_188 ( V_4 , V_493 , V_614 ) ;
V_493 -> V_531 = 0 ;
}
V_609 = ( V_615 |
( ( T_1 ) V_606 << V_616 ) |
( ( T_1 ) V_605 << V_617 ) ) ;
F_18 ( F_228 ( V_493 -> V_519 ) , V_609 ) ;
if ( V_604 > 10 )
...
if ( V_620 & ( 1 << V_493 -> V_519 ) ) {
int V_626 ;
V_626 = F_227 ( & V_13 -> V_534 , V_4 , V_493 ,
V_603 ) ;
V_603 -= V_626 ;
V_606 += V_626 ;
}
F_18 ( F_22 ( F_233 ( V_493 -> V_519 ) ) , 0 ) ;
}
return V_606 ;
}
static int F_234 ( struct V_533 * V_534 , int V_603 )
{
struct V_12 * V_13 = F_235 ( V_534 , struct V_12 , V_534 ) ;
...
T_1 V_609 )
{
F_10 ( V_4 -> V_11 , L_35 , V_493 -> V_519 ) ;
if ( V_609 & V_627 )
F_238 ( L_36 ) ;
if ( V_609 & V_628 )
F_238 ( L_37 ) ;
...
{
T_1 V_609 = F_16 ( F_228 ( V_493 -> V_519 ) ) ;
int V_10 = 0 ;
if ( V_609 & ( V_641 |
V_642 ) )
V_10 = - V_21 ;
...
{
struct V_607 * V_608 = V_493 -> V_608 ;
T_1 V_779 , V_609 = F_192 ( & V_608 -> V_611 ) ;
V_779 = ( V_780 |
V_781 ) ;
F_18 ( F_228 ( V_493 -> V_519 ) , V_779 ) ;
F_166 ( V_4 , V_621 , V_473 , V_4 -> V_11 ,
...
V_493 -> V_524 = V_4 -> V_304 -> V_801 ( V_4 -> V_508 ,
V_789 * sizeof( V_790 ) ,
& V_493 -> V_791 , V_800 ) ;
if ( ! V_493 -> V_524 )
return - V_506 ;
if ( ( unsigned long ) V_493 -> V_524 & ( 64UL - 1 ) ) {
F_10 ( V_4 -> V_11 , L_82 ,
V_493 -> V_524 ) ;
return - V_21 ;
}
V_493 -> V_792 = V_789 ;
V_493 -> V_520 = 0 ;
V_493 -> V_512 = V_4 -> V_304 -> V_801 ( V_4 -> V_508 ,
V_496 * sizeof( T_7 ) ,
& V_493 -> V_793 , V_800 ) ;
if ( ! V_493 -> V_512 )
return - V_506 ;
if ( ( unsigned long ) V_493 -> V_512 & ( 64UL - 1 ) ) {
F_10 ( V_4 -> V_11 , L_83 ,
V_493 -> V_512 ) ;
return - V_21 ;
}
...
V_493 -> V_817 = 8 ;
V_493 -> V_518 = V_818 ;
if ( V_493 -> V_518 < V_493 -> V_511 )
V_493 -> V_518 = V_493 -> V_511 ;
...
int V_26 ;
for ( V_26 = 0 ; V_26 < V_4 -> V_28 ; V_26 ++ )
F_395 ( & V_4 -> V_29 [ V_26 ] . V_534 ) ;
}
static void F_396 ( struct V_3 * V_4 )
{
int V_26 ;
for ( V_26 = 0 ; V_26 < V_4 -> V_28 ; V_26 ++ )
F_397 ( & V_4 -> V_29 [ V_26 ] . V_534 ) ;
}
...
static void F_415 ( struct V_308 * V_11 ,
struct V_1130 * V_1131 )
{
struct V_3 * V_4 = F_399 ( V_11 ) ;
if ( F_416 ( V_11 ) ) {
...
T_1 V_458 = V_485 -> V_375 ;
V_458 = V_458 >> V_513 ;
V_493 -> V_512 [ V_1154 ++ ] = F_187 ( V_458 ) ;
V_485 = V_562 ;
}
}
for (; V_1154 < V_496 ; V_1154 ++ ) {
V_10 = F_183 ( V_4 , V_493 , V_614 , V_1154 ) ;
if ( F_70 ( V_10 ) )
break;
}
V_493 -> V_515 = V_493 -> V_517 - 1 ;
V_493 -> V_520 = 0 ;
V_493 -> V_516 = 0 ;
V_493 -> V_531 = 0 ;
}
...
static void F_436 ( struct V_1155 * V_1156 )
{
struct V_3 * V_4 = F_235 ( V_1156 , struct V_3 , V_1123 ) ;
unsigned long V_87 ;
int V_10 ;
F_63 ( & V_4 -> V_155 , V_87 ) ;
if ( ! F_416 ( V_4 -> V_11 ) ) {
...
static void F_439 ( struct V_563 * V_493 , int V_375 ,
...
static T_1 F_441 ( struct V_483 * V_484 , struct V_1163 * V_1164 ,
...
switch ( V_484 -> V_560 ) {
case F_443 ( V_1176 ) :
V_1171 = F_444 ( V_484 ) -> V_560 ;
V_1170 = F_444 ( V_484 ) -> V_1170 ;
break;
case F_443 ( V_1177 ) :
V_1171 = F_445 ( V_484 ) -> V_1178 ;
V_1170 = ( 40 >> 2 ) ;
V_428 = 1 ;
break;
default:
...
( ( V_1169 / 2 ) << V_1192 ) |
( V_1170 << V_1193 ) |
( ( V_1167 < V_1194 ) ? V_1195 : 0 ) |
( ( V_1166 == V_1173 ) ? V_1196 : 0 ) |
( V_428 ? V_1197 : 0 ) |
V_1168 ) ;
return V_860 ;
}
...
{
struct V_3 * V_4 = F_399 ( V_11 ) ;
unsigned long V_1198 , V_1199 ;
struct V_581 * V_582 ;
struct V_563 * V_493 ;
struct V_567 * V_341 ;
unsigned int V_490 , V_1200 ;
struct V_1163 * V_1164 ;
int V_798 , V_26 , V_1201 ;
T_1 V_502 , V_1202 ;
V_26 = F_449 ( V_484 ) ;
...
F_455 ( V_484 ) ;
V_1198 = ( ( unsigned long ) V_484 -> V_35 & ( 16 - 1 ) ) ;
V_1199 = V_1198 + sizeof( struct V_567 ) ;
V_1164 = (struct V_1163 * ) V_484 -> V_35 ;
V_341 = (struct V_567 * ) F_456 ( V_484 , V_1199 ) ;
V_490 = V_484 -> V_490 - sizeof( struct V_567 ) ;
V_341 -> V_87 = F_440 ( F_441 ( V_484 , V_1164 , V_1198 , V_490 ) ) ;
V_341 -> V_1206 = 0 ;
V_490 = F_208 ( V_484 ) ;
...
if ( V_1210 > V_579 )
V_1210 = V_579 ;
F_439 ( V_493 , V_798 , V_502 , V_1210 , V_1202 , V_1200 ) ;
V_1202 = V_1200 = 0 ;
...
for ( V_26 = 0 ; V_26 < F_177 ( V_484 ) -> V_489 ; V_26 ++ ) {
const T_11 * V_1211 = & F_177 ( V_484 ) -> V_580 [ V_26 ] ;
V_490 = F_211 ( V_1211 ) ;
V_502 = V_4 -> V_304 -> V_507 ( V_4 -> V_508 , F_457 ( V_1211 ) ,
V_1211 -> V_1212 , V_490 ,
V_575 ) ;
V_493 -> V_566 [ V_798 ] . V_484 = NULL ;
V_493 -> V_566 [ V_798 ] . V_502 = V_502 ;
F_439 ( V_493 , V_798 , V_502 , V_490 , 0 , 0 ) ;
V_798 = F_210 ( V_493 , V_798 ) ;
}
...
static int F_458 ( struct V_308 * V_11 , int V_1216 )
{
struct V_3 * V_4 = F_399 ( V_11 ) ;
...
{
struct V_3 * V_4 = F_399 ( V_11 ) ;
struct V_1221 * V_1222 = & V_4 -> V_1222 ;
F_460 ( V_1220 -> V_1223 , V_1224 , sizeof( V_1220 -> V_1223 ) ) ;
F_460 ( V_1220 -> V_1225 , V_1226 , sizeof( V_1220 -> V_1225 ) ) ;
snprintf ( V_1220 -> V_1227 , sizeof( V_1220 -> V_1227 ) , L_124 ,
V_1222 -> V_1228 , V_1222 -> V_1229 ) ;
if ( V_4 -> V_25 -> V_339 != V_343 )
F_460 ( V_1220 -> V_1230 , F_461 ( V_4 -> V_1231 ) ,
sizeof( V_1220 -> V_1230 ) ) ;
}
static int F_462 ( struct V_308 * V_11 ,
struct V_1232 * V_1152 )
{
struct V_3 * V_4 = F_399 ( V_11 ) ;
struct V_38 * V_13 ;
V_13 = & V_4 -> V_39 ;
memset ( V_1152 , 0 , sizeof( * V_1152 ) ) ;
V_1152 -> V_458 . V_1233 = V_4 -> V_175 ;
F_463 ( V_1152 -> V_1234 . V_173 ,
V_13 -> V_173 ) ;
F_463 ( V_1152 -> V_1234 . V_174 ,
V_13 -> V_215 ) ;
V_1152 -> V_458 . V_285 = V_13 -> V_201 ;
V_1152 -> V_458 . V_302 = V_13 -> V_160 ;
V_1152 -> V_458 . V_301 = V_13 -> V_161 ;
V_1152 -> V_458 . V_30 = ( V_4 -> V_87 & V_344 ) ? V_1235 : V_1236 ;
return 0 ;
}
static int F_464 ( struct V_308 * V_11 ,
const struct V_1232 * V_1152 )
{
struct V_3 * V_4 = F_399 ( V_11 ) ;
struct V_38 * V_13 = & V_4 -> V_39 ;
F_465 ( & V_13 -> V_174 ,
V_1152 -> V_1234 . V_174 ) ;
V_13 -> V_302 = V_1152 -> V_458 . V_302 ;
V_13 -> V_301 = V_1152 -> V_458 . V_301 ;
V_13 -> V_285 = V_1152 -> V_458 . V_285 ;
return F_114 ( V_4 ) ;
}
...
static void F_467 ( struct V_308 * V_11 , T_3 V_1238 )
{
struct V_3 * V_4 = F_399 ( V_11 ) ;
V_4 -> V_1237 = V_1238 ;
}
...
if ( V_486 >= V_4 -> V_1239 )
return - V_21 ;
if ( V_486 + V_490 > V_4 -> V_1239 )
V_490 = V_1241 -> V_490 = V_4 -> V_1239 - V_486 ;
if ( V_486 & 3 ) {
T_3 V_1242 , V_1243 ;
V_1242 = V_486 & 3 ;
V_1243 = 4 - V_1242 ;
if ( V_1243 > V_490 )
V_1243 = V_490 ;
V_2 = F_16 ( F_471 ( ( V_486 - V_1242 ) / 4 ) ) ;
memcpy ( V_35 , ( ( char * ) & V_2 ) + V_1242 , V_1243 ) ;
V_35 += V_1243 ;
V_490 -= V_1243 ;
V_486 += V_1243 ;
}
...
static void F_472 ( int V_1244 , T_5 * V_1245 )
{
switch ( V_1244 ) {
case V_1246 :
case V_1247 :
...
static int F_473 ( T_1 V_421 , int * V_1244 )
{
switch ( V_421 ) {
case V_1259 :
* V_1244 = V_1246 ;
...
static int F_474 ( int V_1244 , T_1 * V_421 )
{
switch ( V_1244 ) {
case V_1246 :
* V_421 = V_1259 ;
...
if ( V_928 & V_1280 )
V_1271 |= V_1281 ;
if ( V_928 & ( V_1282 << V_1283 ) )
V_1271 |= V_1284 ;
if ( V_928 & ( V_1282 << V_1285 ) )
V_1271 |= V_1286 ;
return V_1271 ;
}
static int F_476 ( T_1 V_1271 , T_1 * V_928 )
{
T_1 V_403 = 0 ;
if ( V_1271 & V_1273 )
V_403 |= V_1272 ;
...
static int F_477 ( struct V_3 * V_4 , struct V_1287 * V_1288 )
{
T_1 V_421 ;
V_1288 -> V_35 = 0 ;
if ( ! F_474 ( V_1288 -> V_1244 , & V_421 ) )
return - V_21 ;
if ( V_4 -> V_25 -> V_927 [ V_421 - V_425 ] &
V_1289 )
V_1288 -> V_35 = V_1290 ;
else
V_1288 -> V_35 = F_475 ( V_4 -> V_25 -> V_928 [ V_421 -
V_425 ] ) ;
return 0 ;
}
...
T_3 V_584 ;
T_4 V_1293 ;
V_584 = ( V_341 -> V_403 [ 3 ] & V_1294 ) >> V_1295 ;
V_1292 -> V_1296 . V_1297 . V_1298 = F_479 ( V_584 ) ;
V_584 = ( V_341 -> V_403 [ 3 ] & V_1299 ) >> V_1300 ;
V_1292 -> V_1296 . V_1297 . V_1301 = F_479 ( V_584 ) ;
V_584 = ( V_341 -> V_911 [ 3 ] & V_1294 ) >> V_1295 ;
V_1292 -> V_1302 . V_1297 . V_1298 = F_479 ( V_584 ) ;
V_584 = ( V_341 -> V_911 [ 3 ] & V_1299 ) >> V_1300 ;
V_1292 -> V_1302 . V_1297 . V_1301 = F_479 ( V_584 ) ;
V_1292 -> V_1296 . V_1297 . V_1303 = ( V_341 -> V_403 [ 2 ] & V_1304 ) >>
V_1305 ;
V_1292 -> V_1302 . V_1297 . V_1303 = ( V_341 -> V_911 [ 2 ] & V_1304 ) >>
V_1305 ;
switch ( V_1292 -> V_1244 ) {
case V_1246 :
case V_1248 :
case V_1250 :
V_1293 = ( ( V_341 -> V_403 [ 2 ] & V_1306 ) >>
V_1307 ) >> 16 ;
V_1292 -> V_1296 . V_1297 . V_1308 = F_443 ( V_1293 ) ;
V_1293 = ( ( V_341 -> V_403 [ 2 ] & V_1306 ) >>
V_1307 ) & 0xffff ;
V_1292 -> V_1296 . V_1297 . V_1309 = F_443 ( V_1293 ) ;
V_1293 = ( ( V_341 -> V_911 [ 2 ] & V_1306 ) >>
V_1307 ) >> 16 ;
V_1292 -> V_1302 . V_1297 . V_1308 = F_443 ( V_1293 ) ;
V_1293 = ( ( V_341 -> V_911 [ 2 ] & V_1306 ) >>
V_1307 ) & 0xffff ;
V_1292 -> V_1302 . V_1297 . V_1309 = F_443 ( V_1293 ) ;
break;
case V_1253 :
case V_1256 :
V_584 = ( V_341 -> V_403 [ 2 ] & V_1306 ) >>
V_1307 ;
V_1292 -> V_1296 . V_1310 . V_1311 = F_479 ( V_584 ) ;
V_584 = ( V_341 -> V_911 [ 2 ] & V_1306 ) >>
V_1307 ;
V_1292 -> V_1302 . V_1310 . V_1311 = F_479 ( V_584 ) ;
break;
case V_1268 :
V_584 = ( V_341 -> V_403 [ 2 ] & V_1306 ) >>
V_1307 ;
V_1292 -> V_1296 . V_1312 . V_1313 = F_479 ( V_584 ) ;
V_584 = ( V_341 -> V_911 [ 2 ] & V_1306 ) >>
V_1307 ;
V_1292 -> V_1302 . V_1312 . V_1313 = F_479 ( V_584 ) ;
V_1292 -> V_1296 . V_1312 . V_1314 =
( V_341 -> V_403 [ 2 ] & V_1315 ) >>
V_1316 ;
V_1292 -> V_1302 . V_1312 . V_1314 =
( V_341 -> V_911 [ 2 ] & V_1315 ) >>
V_1316 ;
V_1292 -> V_1296 . V_1312 . V_1317 = V_1318 ;
break;
default:
break;
}
...
struct V_24 * V_25 = V_4 -> V_25 ;
struct V_908 * V_341 ;
struct V_1291 * V_1292 = & V_1288 -> V_1319 ;
T_4 V_386 ;
T_1 V_421 ;
int V_860 = 0 ;
V_386 = F_172 ( V_4 , ( T_4 ) V_1288 -> V_1319 . V_1320 ) ;
V_341 = & V_25 -> V_909 [ V_386 ] ;
if ( ! V_341 -> V_914 ) {
F_481 ( V_4 -> V_11 , L_125 ,
V_25 -> V_375 , ( T_4 ) V_1288 -> V_1319 . V_1320 , V_386 ) ;
return - V_21 ;
}
V_421 = ( V_341 -> V_403 [ 0 ] & V_1321 ) >>
V_1322 ;
V_860 = F_473 ( V_421 , & V_1292 -> V_1244 ) ;
if ( V_860 < 0 ) {
F_481 ( V_4 -> V_11 , L_126 ,
V_25 -> V_375 ) ;
goto V_217;
}
if ( V_1292 -> V_1244 == V_1253 || V_1292 -> V_1244 == V_1254 ) {
T_3 V_1314 = ( V_341 -> V_403 [ 2 ] & V_1315 ) >>
V_1316 ;
if ( V_1314 == V_1258 ) {
if ( V_1292 -> V_1244 == V_1253 )
V_1292 -> V_1244 = V_1256 ;
else
V_1292 -> V_1244 = V_1257 ;
}
}
switch ( V_1292 -> V_1244 ) {
case V_1246 :
...
if ( V_860 < 0 )
goto V_217;
if ( V_341 -> V_410 & V_1323 )
V_1292 -> V_1324 = V_1325 ;
else
V_1292 -> V_1324 = ( V_341 -> V_410 & V_1326 ) >>
V_913 ;
V_1288 -> V_35 = F_173 ( V_4 ) ;
V_217:
return V_860 ;
}
...
struct V_24 * V_25 = V_4 -> V_25 ;
struct V_908 * V_341 ;
int V_26 , V_386 , V_1328 ;
unsigned long V_87 ;
int V_860 = 0 ;
V_1288 -> V_35 = F_173 ( V_4 ) ;
F_165 ( V_4 , V_87 ) ;
for ( V_1328 = 0 , V_26 = 0 ; V_26 < V_1288 -> V_35 ; V_26 ++ ) {
V_386 = F_172 ( V_4 , V_26 ) ;
V_341 = & V_25 -> V_909 [ V_386 ] ;
if ( ! V_341 -> V_914 )
continue;
if ( V_1328 == V_1288 -> V_1329 ) {
V_860 = - V_1330 ;
break;
}
V_1327 [ V_1328 ] = V_26 ;
...
F_167 ( V_4 , V_87 ) ;
V_1288 -> V_1329 = V_1328 ;
return V_860 ;
}
static int F_483 ( struct V_308 * V_11 , struct V_1287 * V_1152 ,
T_3 * V_1327 )
{
struct V_3 * V_4 = F_399 ( V_11 ) ;
int V_860 = 0 ;
...
break;
case V_1333 :
V_1152 -> V_1329 = F_174 ( V_4 ) ;
break;
case V_1334 :
V_860 = F_480 ( V_4 , V_1152 ) ;
break;
case V_1335 :
V_860 = F_482 ( V_4 , V_1152 , V_1327 ) ;
break;
default:
V_860 = - V_21 ;
break;
...
static int F_484 ( struct V_3 * V_4 , struct V_1287 * V_1288 )
{
T_1 V_421 ;
T_1 V_928 = 0 ;
unsigned long V_87 ;
...
static void F_485 ( struct V_1291 * V_1292 ,
struct V_908 * V_341 ,
int V_1336 , T_1 V_421 )
{
T_5 V_1245 = 0 ;
T_3 V_1337 , V_1338 , V_1339 , V_1340 , V_1311 , V_1341 ;
T_4 V_1342 , V_1343 , V_1344 , V_1345 ;
V_1337 = F_486 ( V_1292 -> V_1296 . V_1297 . V_1298 ) ;
V_1339 = F_486 ( V_1292 -> V_1302 . V_1297 . V_1298 ) ;
V_1338 = F_486 ( V_1292 -> V_1296 . V_1297 . V_1301 ) ;
V_1340 = F_486 ( V_1292 -> V_1302 . V_1297 . V_1301 ) ;
V_341 -> V_403 [ 0 ] = V_421 << V_1322 ;
V_341 -> V_911 [ 0 ] = V_1321 ;
V_341 -> V_403 [ 1 ] = ( T_1 ) V_1336 << V_1346 ;
V_341 -> V_911 [ 1 ] = V_1347 ;
V_341 -> V_403 [ 3 ] = ( T_1 ) V_1337 << V_1295 ;
V_341 -> V_403 [ 3 ] |= V_1338 ;
V_341 -> V_911 [ 3 ] = ( T_1 ) V_1339 << V_1295 ;
V_341 -> V_911 [ 3 ] |= V_1340 ;
V_341 -> V_403 [ 2 ] |= ( ( T_1 ) V_1292 -> V_1296 . V_1297 . V_1303 <<
V_1305 ) ;
V_341 -> V_911 [ 2 ] |= ( ( T_1 ) V_1292 -> V_1302 . V_1297 . V_1303 <<
V_1305 ) ;
switch ( V_1292 -> V_1244 ) {
case V_1246 :
case V_1248 :
case V_1250 :
V_1342 = F_442 ( V_1292 -> V_1296 . V_1297 . V_1308 ) ;
V_1344 = F_442 ( V_1292 -> V_1302 . V_1297 . V_1308 ) ;
V_1343 = F_442 ( V_1292 -> V_1296 . V_1297 . V_1309 ) ;
V_1345 = F_442 ( V_1292 -> V_1302 . V_1297 . V_1309 ) ;
V_341 -> V_403 [ 2 ] |= ( ( ( T_1 ) V_1342 << 16 ) | V_1343 ) ;
V_341 -> V_911 [ 2 ] |= ( ( ( T_1 ) V_1344 << 16 ) | V_1345 ) ;
F_472 ( V_1292 -> V_1244 , & V_1245 ) ;
break;
case V_1253 :
case V_1256 :
V_1311 = F_486 ( V_1292 -> V_1296 . V_1310 . V_1311 ) ;
V_1341 = F_486 ( V_1292 -> V_1302 . V_1310 . V_1311 ) ;
V_341 -> V_403 [ 2 ] |= V_1311 ;
V_341 -> V_911 [ 2 ] |= V_1341 ;
F_472 ( V_1292 -> V_1244 , & V_1245 ) ;
break;
case V_1268 :
V_1311 = F_486 ( V_1292 -> V_1296 . V_1312 . V_1313 ) ;
V_1341 = F_486 ( V_1292 -> V_1302 . V_1312 . V_1313 ) ;
V_341 -> V_403 [ 2 ] |= V_1311 ;
V_341 -> V_911 [ 2 ] |= V_1341 ;
V_1245 = V_1292 -> V_1296 . V_1312 . V_1314 ;
break;
default:
break;
}
V_341 -> V_403 [ 2 ] |= ( ( T_1 ) V_1245 << V_1316 ) ;
if ( V_1245 ) {
V_341 -> V_911 [ 2 ] |= V_1315 ;
}
}
...
int V_1348 = V_393 -> V_837 ;
T_4 V_386 ;
T_1 V_421 ;
unsigned long V_87 ;
int V_10 , V_860 ;
V_860 = 0 ;
V_386 = V_1288 -> V_1319 . V_1320 ;
if ( V_386 >= F_173 ( V_4 ) )
return - V_21 ;
if ( V_1292 -> V_1244 == V_1268 ) {
int V_26 ;
int V_1349 = 0 ;
struct V_1350 * V_1351 = & V_1292 -> V_1296 . V_1312 ;
struct V_1350 * V_1352 = & V_1292 -> V_1302 . V_1312 ;
if ( V_1351 -> V_1317 != V_1318 )
return - V_21 ;
F_165 ( V_4 , V_87 ) ;
for ( V_26 = 0 ; V_26 < V_1353 ; V_26 ++ ) {
if ( V_25 -> V_1354 [ V_26 ] ) {
if ( V_1351 -> V_1314 == V_25 -> V_1355 [ V_26 ] ) {
V_421 = V_25 -> V_1354 [ V_26 ] ;
V_25 -> V_1356 [ V_26 ] ++ ;
V_1349 = 1 ;
break;
}
...
if ( V_860 )
goto V_217;
V_25 -> V_1354 [ V_26 ] = V_421 ;
V_25 -> V_1355 [ V_26 ] = V_1351 -> V_1314 ;
V_25 -> V_1356 [ V_26 ] ++ ;
V_1349 = 1 ;
break;
}
...
V_25 -> V_375 , V_67 , V_1351 -> V_1314 ) ;
V_860 = - V_21 ;
goto V_217;
}
F_167 ( V_4 , V_87 ) ;
} else {
if ( ! F_474 ( V_1292 -> V_1244 , & V_421 ) ) {
return - V_21 ;
}
}
F_165 ( V_4 , V_87 ) ;
...
case V_1253 :
case V_1256 :
F_485 ( V_1292 , V_341 , V_1348 , V_421 ) ;
break;
case V_1247 :
case V_1249 :
case V_1251 :
...
if ( V_1292 -> V_1324 == V_1325 ) {
V_341 -> V_410 = V_1323 ;
} else {
if ( V_1292 -> V_1324 >= V_4 -> V_624 ) {
F_481 ( V_4 -> V_11 , L_130 ,
V_25 -> V_375 , V_67 ,
( long long ) V_1292 -> V_1324 ) ;
V_860 = - V_21 ;
goto V_217;
}
V_341 -> V_410 = ( V_912 |
...
static int F_488 ( struct V_3 * V_4 , T_3 V_1357 )
{
struct V_24 * V_25 = V_4 -> V_25 ;
struct V_908 * V_341 ;
T_4 V_386 ;
...
static int F_489 ( struct V_308 * V_11 , struct V_1287 * V_1152 )
{
struct V_3 * V_4 = F_399 ( V_11 ) ;
int V_860 = 0 ;
switch ( V_1152 -> V_1152 ) {
...
break;
case V_1360 :
V_860 = F_488 ( V_4 , V_1152 -> V_1319 . V_1320 ) ;
break;
default:
V_860 = - V_21 ;
break;
...
static void F_490 ( struct V_308 * V_11 , T_3 V_1361 , T_5 * V_35 )
{
struct V_3 * V_4 = F_399 ( V_11 ) ;
int V_26 ;
if ( V_1361 != V_1362 )
...
static int F_491 ( struct V_308 * V_11 , int V_1361 )
{
struct V_3 * V_4 = F_399 ( V_11 ) ;
if ( V_1361 != V_1362 )
return - V_21 ;
...
static int F_499 ( struct V_3 * V_4 , int V_1382 )
{
if ( V_1382 < 0 || V_1382 > V_1383 )
return - V_21 ;
F_18 ( V_1384 , V_1382 ) ;
return 0 ;
}
static int F_500 ( struct V_3 * V_4 , int V_29 , int V_1385 , int V_1386 )
{
if ( ( V_29 < V_1380 || V_29 > V_1381 ) ||
( V_1385 < 0 || V_1385 > 3 ) ||
( V_1386 < 0 || V_1386 > 0x1f ) )
return - V_21 ;
F_18 ( F_501 ( V_29 ) , ( V_1385 << V_1387 ) | V_1386 ) ;
return 0 ;
}
static int F_502 ( struct V_3 * V_4 , T_3 V_362 )
{
T_1 V_1388 , V_1389 = ( V_1390 |
( V_362 << V_1391 ) ) ;
int V_6 ;
if ( V_362 > ( V_1392 >> V_1391 ) )
return - V_21 ;
V_1388 = V_1389 ;
F_18 ( V_1393 , V_1388 ) ;
V_6 = 64 ;
...
static int F_505 ( struct V_3 * V_4 , T_3 V_335 , char * V_1397 ,
int V_1398 )
{
int V_26 ;
for ( V_26 = 0 ; V_26 < V_1398 ; V_26 ++ ) {
...
{
struct V_1221 * V_1222 = & V_4 -> V_1222 ;
int V_490 = strlen ( V_1222 -> V_1225 ) + 1 ;
const char * V_1399 = V_1222 -> V_1225 ;
int V_26 ;
for ( V_26 = 0 ; V_26 < V_490 - 5 ; V_26 ++ ) {
if ( ! strncmp ( V_1399 + V_26 , L_134 , 6 ) )
break;
}
if ( V_26 >= V_490 - 5 )
return;
V_1399 += V_26 + 5 ;
sscanf ( V_1399 , L_124 , & V_1222 -> V_1228 , & V_1222 -> V_1229 ) ;
F_166 ( V_4 , V_472 , V_473 , V_4 -> V_11 ,
L_135 ,
V_1222 -> V_1228 , V_1222 -> V_1229 ) ;
if ( V_1222 -> V_1228 > V_1400 ||
( V_1222 -> V_1228 == V_1400 &&
V_1222 -> V_1229 >= V_1401 ) )
V_4 -> V_87 |= V_1402 ;
}
static int F_507 ( struct V_3 * V_4 , T_3 V_1181 , T_3 V_1403 )
{
unsigned int V_1404 = 0 ;
...
V_10 = F_502 ( V_4 , V_1181 + 2 ) ;
if ( V_10 < 0 )
return V_10 ;
V_490 = V_10 ;
V_1181 += 3 ;
V_1405 = F_502 ( V_4 , V_1181 + 4 ) ;
V_10 = F_505 ( V_4 , V_1181 + 5 , V_1397 , 64 ) ;
if ( V_10 < 0 )
return V_10 ;
V_1406 = NULL ;
V_1407 = 0 ;
if ( ! strcmp ( V_1397 , L_137 ) ) {
V_1406 = V_4 -> V_1222 . V_1408 ;
V_1407 = V_1409 ;
V_1404 |= F_508 ;
} else if ( ! strcmp ( V_1397 , L_138 ) ) {
V_1406 = V_4 -> V_1222 . V_1410 ;
V_1407 = V_1411 ;
V_1404 |= F_509 ;
} else if ( ! strcmp ( V_1397 , L_139 ) ) {
V_1406 = V_4 -> V_1222 . V_1225 ;
V_1407 = V_1412 ;
V_1404 |= F_510 ;
} else if ( ! strcmp ( V_1397 , L_140 ) ) {
V_1406 = V_4 -> V_1222 . V_1413 ;
V_1407 = V_1146 ;
V_1404 |= F_511 ;
} else if ( ! strcmp ( V_1397 , L_141 ) ) {
V_1406 = & V_4 -> V_1222 . V_1414 ;
V_1407 = 1 ;
V_1404 |= F_512 ;
} else if ( ! strcmp ( V_1397 , L_142 ) ) {
V_1406 = V_4 -> V_1222 . V_1415 ;
V_1407 = V_1416 ;
V_1404 |= F_513 ;
}
if ( V_1407 && V_1405 > V_1407 ) {
F_225 ( V_4 -> V_508 , L_143 , V_1397 , V_1405 ) ;
return - V_21 ;
}
if ( V_1406 ) {
...
L_144 ,
V_1397 , V_1405 ) ;
for ( V_26 = 0 ; V_26 < V_1405 ; V_26 ++ )
* V_1406 ++ = F_502 ( V_4 , V_335 + V_26 ) ;
}
V_1181 += V_490 ;
}
return 0 ;
}
static void F_515 ( struct V_3 * V_4 , T_3 V_1181 )
{
T_3 V_486 ;
int V_10 ;
V_10 = F_504 ( V_4 , V_1181 + 1 ) ;
if ( V_10 < 0 )
return;
V_486 = V_10 + 3 ;
while ( V_1181 + V_486 < V_1417 ) {
T_3 V_1418 = V_1181 + V_486 ;
T_3 V_1403 ;
V_10 = F_502 ( V_4 , V_1418 ) ;
if ( V_10 != 0x90 )
return;
V_10 = F_504 ( V_4 , V_1418 + 1 ) ;
if ( V_10 < 0 )
return;
V_1418 = V_1181 + V_486 + 3 ;
V_1403 = V_1181 + V_486 + V_10 ;
V_486 += V_10 ;
V_10 = F_507 ( V_4 , V_1418 , V_1403 ) ;
if ( V_10 < 0 || V_10 == 1 )
return;
}
}
...
{
T_3 V_1181 = 0 , V_1403 = V_1417 , V_860 ;
int V_10 ;
while ( V_1181 < V_1403 ) {
V_860 = V_1181 ;
V_10 = F_503 ( V_4 , V_1181 + 0 ) ;
if ( V_10 != 0x55aa )
return 0 ;
V_10 = F_503 ( V_4 , V_1181 + 23 ) ;
if ( V_10 < 0 )
return 0 ;
V_1181 += V_10 ;
V_10 = F_503 ( V_4 , V_1181 + 0 ) ;
if ( V_10 != 0x5043 )
return 0 ;
V_10 = F_503 ( V_4 , V_1181 + 2 ) ;
if ( V_10 != 0x4952 )
return 0 ;
V_10 = F_502 ( V_4 , V_1181 + 20 ) ;
if ( V_10 < 0 )
return 0 ;
if ( V_10 != 0x01 ) {
...
static int F_517 ( struct V_3 * V_4 , const char * V_1419 )
{
if ( ! strcmp ( V_1419 , L_145 ) ) {
V_4 -> V_87 &= ~ ( V_344 |
V_88 ) ;
V_4 -> V_89 = V_1420 ;
} else if ( ! strcmp ( V_1419 , L_146 ) ) {
V_4 -> V_87 |= ( V_88 |
V_344 ) ;
V_4 -> V_89 = V_1421 ;
} else if ( ! strcmp ( V_1419 , L_147 ) ) {
V_4 -> V_87 &= ~ V_88 ;
V_4 -> V_87 |= V_344 ;
V_4 -> V_89 = V_90 ;
} else if ( ! strcmp ( V_1419 , L_148 ) ) {
V_4 -> V_87 |= V_88 ;
V_4 -> V_87 &= ~ V_344 ;
V_4 -> V_89 = V_1421 ;
} else if ( ! strcmp ( V_1419 , L_149 ) || ! strcmp ( V_1419 , L_150 ) ) {
V_4 -> V_87 |= V_88 ;
V_4 -> V_87 &= ~ V_344 ;
V_4 -> V_87 |= V_345 ;
V_4 -> V_89 = V_1421 ;
...
{
int V_1422 = 0 ;
if ( ( ! strcmp ( V_4 -> V_1222 . V_1408 , V_1423 ) ) ||
( ! strcmp ( V_4 -> V_1222 . V_1408 , V_1424 ) ) ||
( ! strcmp ( V_4 -> V_1222 . V_1408 , V_1425 ) ) ||
( ! strcmp ( V_4 -> V_1222 . V_1408 , V_1426 ) ) ||
( ! strcmp ( V_4 -> V_1222 . V_1408 , V_1427 ) ) ) {
V_1422 = 4 ;
} else if ( ( ! strcmp ( V_4 -> V_1222 . V_1408 , V_1428 ) ) ||
( ! strcmp ( V_4 -> V_1222 . V_1408 , V_1429 ) ) ||
( ! strcmp ( V_4 -> V_1222 . V_1408 , V_1430 ) ) ||
( ! strcmp ( V_4 -> V_1222 . V_1408 , V_1431 ) ) ) {
V_1422 = 2 ;
}
return V_1422 ;
}
...
struct V_1221 * V_1222 = & V_4 -> V_1222 ;
T_5 V_1432 ;
if ( ! F_428 ( & V_1222 -> V_1413 [ 0 ] ) ) {
F_225 ( V_4 -> V_508 , L_151 ) ;
V_4 -> V_87 &= ~ V_1402 ;
return;
}
if ( ! strcmp ( V_4 -> V_1222 . V_1408 , V_1427 ) ||
! strcmp ( V_4 -> V_1222 . V_1408 , V_1426 ) ) {
V_4 -> V_87 |= V_88 ;
V_4 -> V_87 &= ~ V_344 ;
V_4 -> V_87 |= V_345 ;
...
if ( V_4 -> V_87 & V_88 )
V_4 -> V_89 = V_1421 ;
} else if ( ! strcmp ( V_4 -> V_1222 . V_1408 , V_1430 ) ) {
V_4 -> V_87 |= ( V_88 | V_344 |
V_134 ) ;
} else if ( F_517 ( V_4 , V_4 -> V_1222 . V_1415 ) ) {
...
memcpy ( V_11 -> V_1104 , V_1222 -> V_1413 , V_1146 ) ;
V_1432 = V_11 -> V_1104 [ 5 ] ;
V_11 -> V_1104 [ 5 ] += V_4 -> V_30 ;
if ( V_11 -> V_1104 [ 5 ] < V_1432 )
V_11 -> V_1104 [ 4 ] ++ ;
}
...
F_166 ( V_4 , V_472 , V_473 , V_4 -> V_11 ,
L_155 , ( int ) ( V_1433 & 0xff ) ) ;
if ( ( V_1433 & 0xff ) != 0xab ) {
F_225 ( V_4 -> V_508 , L_156 , ( int ) ( V_1433 & 0xff ) ) ;
return - V_21 ;
}
V_2 = F_16 ( V_1437 ) ;
switch ( V_4 -> V_30 ) {
...
V_4 -> V_1222 . V_1408 [ V_26 + 3 ] = ( V_584 >> 0 ) & 0xff ;
V_4 -> V_1222 . V_1408 [ V_26 + 2 ] = ( V_584 >> 8 ) & 0xff ;
V_4 -> V_1222 . V_1408 [ V_26 + 1 ] = ( V_584 >> 16 ) & 0xff ;
V_4 -> V_1222 . V_1408 [ V_26 + 0 ] = ( V_584 >> 24 ) & 0xff ;
}
V_4 -> V_1222 . V_1408 [ V_2 ] = '\0' ;
V_2 = F_16 ( V_1453 ) ;
F_166 ( V_4 , V_472 , V_473 , V_4 -> V_11 ,
...
V_4 -> V_1222 . V_1410 [ V_26 + 3 ] = ( V_584 >> 0 ) & 0xff ;
V_4 -> V_1222 . V_1410 [ V_26 + 2 ] = ( V_584 >> 8 ) & 0xff ;
V_4 -> V_1222 . V_1410 [ V_26 + 1 ] = ( V_584 >> 16 ) & 0xff ;
V_4 -> V_1222 . V_1410 [ V_26 + 0 ] = ( V_584 >> 24 ) & 0xff ;
}
V_4 -> V_1222 . V_1410 [ V_2 ] = '\0' ;
V_4 -> V_1222 . V_1414 =
F_16 ( V_1454 ) & V_1455 ;
F_166 ( V_4 , V_472 , V_473 , V_4 -> V_11 ,
L_165 , V_4 -> V_1222 . V_1414 ) ;
return 0 ;
}
...
int V_1456 , int V_1457 , T_5 V_1458 , int type )
{
T_3 V_1459 = ( V_1456 << 16 ) | V_1457 ;
T_5 V_386 ;
if ( V_1456 < 0 || V_1457 < 0 )
return 0 ;
if ( type == V_1460 || type == V_1461 ) {
if ( ( ( V_1459 & V_277 ) != V_1462 ) &&
( ( V_1459 & V_277 ) != V_278 ) )
return 0 ;
} else {
if ( ( V_1459 & V_277 ) != V_1463 )
return 0 ;
}
F_48 ( L_166 ,
V_25 -> V_375 , V_1459 ,
type == V_1460 ? L_167 :
type == V_1461 ? L_168 : L_169 ,
V_1458 ) ;
if ( V_498 -> V_1464 [ type ] >= V_1465 ) {
F_523 ( L_170 ) ;
return - V_21 ;
}
V_386 = V_498 -> V_1464 [ type ] ;
V_498 -> V_274 [ type ] [ V_386 ] = V_1459 ;
V_498 -> V_1458 [ type ] [ V_386 ] = V_1458 ;
V_498 -> V_1464 [ type ] = V_386 + 1 ;
return 0 ;
}
static int F_524 ( struct V_276 * V_498 , int V_30 )
{
int V_26 ;
for ( V_26 = 0 ; V_26 < V_498 -> V_1464 [ V_1460 ] ; V_26 ++ ) {
if ( V_498 -> V_1458 [ V_1460 ] [ V_26 ] == V_30 )
return 1 ;
}
for ( V_26 = 0 ; V_26 < V_498 -> V_1464 [ V_1461 ] ; V_26 ++ ) {
if ( V_498 -> V_1458 [ V_1461 ] [ V_26 ] == V_30 )
return 1 ;
}
return 0 ;
}
static int F_525 ( struct V_276 * V_498 , int * V_1466 )
{
int V_30 , V_1328 ;
V_1328 = 0 ;
* V_1466 = 32 ;
...
static int F_526 ( struct V_276 * V_498 , int * V_1466 )
{
* V_1466 = 32 ;
if ( V_498 -> V_1464 [ V_1467 ] )
* V_1466 = V_498 -> V_1458 [ V_1467 ] [ 0 ] ;
return V_498 -> V_1464 [ V_1467 ] ;
}
...
int V_1468 , int V_1469 )
{
int V_481 = V_25 -> V_481 ;
int V_1470 , V_1471 ;
int V_1472 , V_1473 ;
int V_26 , V_1474 , V_1475 ;
if ( ! V_1468 || ! V_1469 ) {
V_1470 = V_1471 =
( V_1476 / V_481 ) ;
V_1472 = V_1473 =
...
if ( type == V_846 ) {
V_25 -> V_809 [ V_26 ] = V_1470 ;
V_25 -> V_810 [ V_26 ] = V_1472 ;
} else {
V_25 -> V_809 [ V_26 ] = V_1471 ;
V_25 -> V_810 [ V_26 ] = V_1473 ;
}
F_48 ( L_171 ,
V_25 -> V_375 , V_26 ,
V_25 -> V_809 [ V_26 ] ,
V_25 -> V_810 [ V_26 ] ) ;
V_1474 += V_25 -> V_809 [ V_26 ] ;
V_1475 += V_25 -> V_810 [ V_26 ] ;
}
if ( V_1474 > V_1476 ) {
F_523 ( L_172 ,
V_25 -> V_375 , V_1474 ) ;
...
if ( V_1474 < V_1476 || V_1475 < V_1477 ) {
F_529 ( L_174 ,
V_25 -> V_375 , V_1474 , V_1475 ) ;
}
}
...
int V_1482 , V_1483 = V_25 -> V_809 [ V_26 ] ;
int V_1484 ;
V_341 -> V_837 = V_1478 ;
V_341 -> V_838 = V_1479 ;
V_1484 = 0 ;
for ( V_1482 = 0 ; V_1482 < V_341 -> V_838 ; V_1482 ++ ) {
struct V_393 * V_1485 = & V_341 -> V_840 [ V_1482 ] ;
int V_842 ;
F_48 ( L_175 ,
V_25 -> V_375 , V_26 , V_341 -> V_837 + V_1482 ) ;
for ( V_842 = 0 ; V_842 < V_843 ; V_842 ++ ) {
V_1485 -> V_844 [ V_842 ] =
V_1480 + V_1484 ;
F_238 ( L_176 , V_1485 -> V_844 [ V_842 ] ) ;
if ( ++ V_1484 == V_1483 )
V_1484 = 0 ;
}
F_238 ( L_177 ) ;
}
V_25 -> V_845 [ V_26 ] = V_1480 ;
V_1480 += V_1483 ;
V_1478 += V_1479 ;
}
}
...
for ( V_30 = 8 ; V_30 < 32 ; V_30 ++ ) {
int V_1456 , V_1457 ;
V_1456 = F_29 ( V_4 , V_30 ,
V_1486 , V_1487 ) ;
V_1457 = F_29 ( V_4 , V_30 ,
V_1486 , V_1488 ) ;
V_10 = F_522 ( V_25 , V_1220 , V_1456 , V_1457 , V_30 ,
V_1460 ) ;
if ( V_10 )
break;
V_1456 = F_29 ( V_4 , V_30 ,
...
if ( V_10 )
break;
V_1456 = F_34 ( V_4 , V_30 , V_1487 ) ;
V_1457 = F_34 ( V_4 , V_30 , V_1488 ) ;
V_10 = F_522 ( V_25 , V_1220 , V_1456 , V_1457 , V_30 ,
V_1467 ) ;
if ( V_10 )
break;
...
{
struct V_276 * V_1220 = & V_25 -> V_276 ;
int V_1490 , V_1491 ;
int V_1468 , V_1469 ;
T_3 V_2 ;
int V_10 ;
...
V_10 = F_531 ( V_4 , V_25 , V_1220 ) ;
if ( V_10 )
return V_10 ;
V_1468 = F_525 ( V_1220 , & V_1490 ) ;
V_1469 = F_526 ( V_1220 , & V_1491 ) ;
switch ( ( V_1468 << 4 ) | V_1469 ) {
case 0x24 :
if ( V_1491 == 10 )
V_25 -> V_339 = V_351 ;
else if ( V_1491 == 26 )
...
F_528 ( V_25 , V_1468 , V_1469 ) ;
F_530 ( V_25 , V_1468 , V_1469 ) ;
return 0 ;
V_1493:
F_523 ( L_179 , V_1491 ) ;
return - V_21 ;
...
switch ( V_4 -> V_30 ) {
case 0 :
V_4 -> V_1497 = V_4 -> V_1498 + V_1499 ;
V_4 -> V_1500 = 0x00000 ;
V_4 -> V_1501 = 0x04000 ;
V_4 -> V_1502 = 0x02000 ;
break;
case 1 :
V_4 -> V_1497 = V_4 -> V_1498 + V_1503 ;
V_4 -> V_1500 = 0x08000 ;
V_4 -> V_1501 = 0x0a000 ;
V_4 -> V_1502 = 0x08000 ;
break;
case 2 :
V_4 -> V_1497 = V_4 -> V_1498 + V_1504 ;
V_4 -> V_1500 = 0x04000 ;
V_4 -> V_1501 = 0x0e000 ;
V_4 -> V_1502 = ~ 0UL ;
break;
case 3 :
V_4 -> V_1497 = V_4 -> V_1498 + V_1505 ;
V_4 -> V_1500 = 0x0c000 ;
V_4 -> V_1501 = 0x12000 ;
V_4 -> V_1502 = ~ 0UL ;
break;
...
static void F_537 ( struct V_3 * V_4 , T_5 * V_1506 )
{
struct V_1507 V_1508 [ V_1509 ] ;
struct V_24 * V_25 = V_4 -> V_25 ;
struct V_1510 * V_1231 = V_4 -> V_1231 ;
int V_26 , V_1511 ;
T_5 V_1512 ;
V_1512 = ( V_1509 / V_25 -> V_481 ) * V_4 -> V_30 ;
for ( V_26 = 0 ; V_26 < ( V_1509 / V_25 -> V_481 ) ; V_26 ++ )
V_1506 [ V_26 ] = V_1512 + V_26 ;
V_1511 = ( V_25 -> V_809 [ V_4 -> V_30 ] +
V_25 -> V_810 [ V_4 -> V_30 ] +
( V_4 -> V_30 == 0 ? 3 : 1 ) ) ;
F_189 ( V_1511 > ( V_1509 / V_25 -> V_481 ) ) ;
for ( V_26 = 0 ; V_26 < V_1511 ; V_26 ++ ) {
V_1508 [ V_26 ] . V_1386 = 0 ;
V_1508 [ V_26 ] . V_1513 = V_26 ;
}
V_1511 = F_538 ( V_1231 , V_1508 , 1 , V_1511 ) ;
if ( V_1511 < 0 ) {
V_4 -> V_87 &= ~ V_1514 ;
return;
}
V_4 -> V_87 |= V_1514 ;
for ( V_26 = 0 ; V_26 < V_1511 ; V_26 ++ )
V_4 -> V_29 [ V_26 ] . V_782 = V_1508 [ V_26 ] . V_1386 ;
V_4 -> V_28 = V_1511 ;
}
static int F_539 ( struct V_3 * V_4 , T_5 * V_1506 )
{
#ifdef F_540
struct V_1515 * V_1516 = V_4 -> V_1516 ;
const T_3 * V_1517 ;
int V_26 ;
V_1517 = F_541 ( V_1516 -> V_11 . V_1518 , L_181 , NULL ) ;
if ( ! V_1517 )
return - V_8 ;
for ( V_26 = 0 ; V_26 < V_1516 -> V_1519 . V_1511 ; V_26 ++ ) {
V_1506 [ V_26 ] = V_1517 [ V_26 ] ;
V_4 -> V_29 [ V_26 ] . V_782 = V_1516 -> V_1519 . V_1520 [ V_26 ] ;
}
V_4 -> V_28 = V_1516 -> V_1519 . V_1511 ;
return 0 ;
#else
return - V_21 ;
#endif
...
T_5 V_1506 [ V_1509 ] ;
int V_1521 , V_1522 ;
int V_26 , V_10 , V_1523 ;
T_5 V_30 ;
V_4 -> V_28 = 1 ;
V_4 -> V_29 [ 0 ] . V_782 = V_4 -> V_11 -> V_782 ;
if ( V_25 -> V_339 == V_343 ) {
V_10 = F_539 ( V_4 , V_1506 ) ;
if ( V_10 )
return V_10 ;
} else
F_537 ( V_4 , V_1506 ) ;
...
for ( V_26 = 0 ; V_26 < V_4 -> V_28 ; V_26 ++ ) {
struct V_12 * V_13 = & V_4 -> V_29 [ V_26 ] ;
F_543 ( V_4 -> V_11 , & V_13 -> V_534 , F_234 , 64 ) ;
V_13 -> V_4 = V_4 ;
V_13 -> V_17 = V_1506 [ V_26 ] ;
V_13 -> V_15 = 2 ;
if ( V_4 -> V_25 -> V_339 != V_343 ) {
...
V_1523 = 0 ;
V_10 = F_497 ( V_4 , V_25 , V_1506 [ V_1523 ] ,
F_544 ( V_30 ) ) ;
if ( V_10 )
return V_10 ;
V_1523 ++ ;
...
V_1521 = 0 ;
for ( V_26 = 0 ; V_26 < V_30 ; V_26 ++ )
V_1521 += V_25 -> V_809 [ V_26 ] ;
V_1522 = V_25 -> V_809 [ V_30 ] ;
for ( V_26 = V_1521 ; V_26 < ( V_1521 + V_1522 ) ; V_26 ++ ) {
V_10 = F_497 ( V_4 , V_25 ,
V_1506 [ V_1523 ] ,
F_233 ( V_26 ) ) ;
if ( V_10 )
...
V_1521 = 0 ;
for ( V_26 = 0 ; V_26 < V_30 ; V_26 ++ )
V_1521 += V_25 -> V_810 [ V_26 ] ;
V_1522 = V_25 -> V_810 [ V_30 ] ;
for ( V_26 = V_1521 ; V_26 < ( V_1521 + V_1522 ) ; V_26 ++ ) {
V_10 = F_497 ( V_4 , V_25 ,
V_1506 [ V_1523 ] ,
F_232 ( V_26 ) ) ;
...
int V_1405 ;
if ( V_4 -> V_25 -> V_339 == V_343 )
V_1526 = V_4 -> V_1516 -> V_11 . V_1518 ;
else
V_1526 = F_548 ( V_4 -> V_1231 ) ;
V_1415 = F_541 ( V_1526 , L_142 , & V_1405 ) ;
if ( ! V_1415 ) {
F_10 ( V_11 , L_182 ,
V_1526 -> V_1528 ) ;
return - V_21 ;
}
if ( ! strcmp ( V_1415 , L_183 ) )
return - V_8 ;
strcpy ( V_4 -> V_1222 . V_1415 , V_1415 ) ;
if ( F_517 ( V_4 , V_4 -> V_1222 . V_1415 ) ) {
F_10 ( V_11 , L_184 ,
V_1526 -> V_1528 , V_4 -> V_1222 . V_1415 ) ;
return - V_21 ;
}
V_1527 = F_541 ( V_1526 , L_140 , & V_1405 ) ;
if ( ! V_1527 ) {
F_10 ( V_11 , L_185 ,
V_1526 -> V_1528 ) ;
return - V_21 ;
}
if ( V_1405 != V_11 -> V_1529 ) {
F_10 ( V_11 , L_186 ,
V_1526 -> V_1528 , V_1405 ) ;
}
memcpy ( V_11 -> V_1104 , V_1527 , V_11 -> V_1529 ) ;
if ( ! F_428 ( & V_11 -> V_1104 [ 0 ] ) ) {
F_10 ( V_11 , L_187 ,
V_1526 -> V_1528 ) ;
F_10 ( V_11 , L_188 , V_1526 -> V_1528 , V_11 -> V_1104 ) ;
return - V_21 ;
}
V_1408 = F_541 ( V_1526 , L_137 , & V_1405 ) ;
if ( V_1408 )
strcpy ( V_4 -> V_1222 . V_1408 , V_1408 ) ;
if ( F_549 ( V_1526 , L_189 , & V_1405 ) ) {
V_4 -> V_87 |= ( V_88 | V_344 |
V_134 ) ;
}
return 0 ;
...
struct V_1533 * V_1534 , char * V_1535 )
{
struct V_1515 * V_1536 = F_552 ( V_11 ) ;
struct V_24 * V_498 = F_553 ( & V_1536 -> V_11 ) ;
...
V_1538 = L_192 ;
V_1535 += sprintf ( V_1535 ,
( V_26 == 0 ) ? L_193 : L_194 ,
V_1538 ) ;
}
V_1535 += sprintf ( V_1535 , L_195 ) ;
return V_1535 - V_1537 ;
}
...
return sprintf ( V_1535 , L_201 , V_1538 ) ;
}
...
T_5 * V_1541 ;
int V_26 ;
V_1541 = ( V_1540 ? V_498 -> V_809 : V_498 -> V_810 ) ;
for ( V_26 = 0 ; V_26 < V_498 -> V_481 ; V_26 ++ ) {
V_1535 += sprintf ( V_1535 ,
( V_26 == 0 ) ? L_202 : L_203 ,
V_1541 [ V_26 ] ) ;
...
struct V_1533 * V_1534 , char * V_1535 )
{
return F_555 ( V_11 , V_1534 , V_1535 , 1 ) ;
}
...
struct V_1515 * V_1536 = F_552 ( V_11 ) ;
struct V_24 * V_498 = F_553 ( & V_1536 -> V_11 ) ;
return sprintf ( V_1535 , L_204 , V_498 -> V_481 ) ;
}
static struct V_24 * F_559 ( struct V_3 * V_4 ,
union V_1542 * V_1459 , T_5 V_542 )
{
struct V_1515 * V_1536 ;
struct V_24 * V_498 ;
int V_26 ;
V_1536 = F_560 ( L_205 , V_1543 ,
NULL , 0 ) ;
if ( F_561 ( V_1536 ) )
return NULL ;
for ( V_26 = 0 ; V_1544 [ V_26 ] . V_1534 . V_1117 ; V_26 ++ ) {
int V_10 = F_562 ( & V_1536 -> V_11 ,
& V_1544 [ V_26 ] ) ;
if ( V_10 )
goto V_1545;
}
...
goto V_1545;
V_498 -> V_375 = V_1543 ++ ;
V_1536 -> V_11 . V_1546 = V_498 ;
V_498 -> V_1536 = V_1536 ;
memcpy ( & V_498 -> V_1459 , V_1459 , sizeof( * V_1459 ) ) ;
V_498 -> V_339 = V_542 ;
F_564 ( & V_498 -> V_1547 ) ;
F_565 ( & V_498 -> V_1548 , 0 ) ;
F_566 ( & V_498 -> V_1547 , & V_1549 ) ;
F_567 ( & V_498 -> V_155 ) ;
V_498 -> V_902 = 7500 ;
V_498 -> V_441 = V_1550 ;
...
for ( V_26 = V_425 ; V_26 <= V_477 ; V_26 ++ ) {
int V_375 = V_26 - V_425 ;
V_498 -> V_927 [ V_375 ] = V_1552 ;
V_498 -> V_928 [ V_375 ] = ( V_1276 |
V_1278 |
V_1280 |
( V_1282 <<
V_1283 ) |
...
if ( ! memcmp ( V_1459 , & V_584 -> V_1459 , sizeof( * V_1459 ) ) ) {
V_498 = V_584 ;
break;
}
}
if ( ! V_498 )
V_498 = F_559 ( V_4 , V_1459 , V_542 ) ;
if ( V_498 ) {
char V_1555 [ 6 ] ;
int V_10 ;
sprintf ( V_1555 , L_206 , V_30 ) ;
V_10 = F_572 ( & V_498 -> V_1536 -> V_11 . V_1556 ,
& V_4 -> V_508 -> V_1556 ,
V_1555 ) ;
if ( ! V_10 ) {
V_498 -> V_1422 [ V_30 ] = V_4 ;
F_573 ( & V_498 -> V_1548 ) ;
}
}
F_574 ( & V_1554 ) ;
...
T_5 V_30 = V_4 -> V_30 ;
char V_1555 [ 6 ] ;
F_189 ( ! V_498 || V_498 -> V_1422 [ V_30 ] != V_4 ) ;
F_166 ( V_4 , V_472 , V_473 , V_4 -> V_11 ,
L_207 , V_67 , V_30 ) ;
sprintf ( V_1555 , L_206 , V_30 ) ;
F_570 ( & V_1554 ) ;
F_576 ( & V_498 -> V_1536 -> V_11 . V_1556 , V_1555 ) ;
V_498 -> V_1422 [ V_30 ] = NULL ;
V_4 -> V_25 = NULL ;
if ( F_577 ( & V_498 -> V_1548 ) ) {
F_578 ( & V_498 -> V_1547 ) ;
F_568 ( V_498 -> V_1536 ) ;
}
F_574 ( & V_1554 ) ;
...
T_1 * V_1557 , T_6 V_1558 )
{
T_14 V_1559 ;
void * V_860 ;
V_860 = F_580 ( V_11 , V_487 , & V_1559 , V_1558 ) ;
if ( V_860 )
* V_1557 = V_1559 ;
return V_860 ;
}
static void F_581 ( struct V_508 * V_11 , T_13 V_487 ,
void * V_1560 , T_1 V_1557 )
{
F_582 ( V_11 , V_487 , V_1560 , V_1557 ) ;
}
static T_1 F_583 ( struct V_508 * V_11 , struct V_485 * V_485 ,
unsigned long V_486 , T_13 V_487 ,
enum V_1561 V_1562 )
{
return F_584 ( V_11 , V_485 , V_486 , V_487 , V_1562 ) ;
}
static void F_585 ( struct V_508 * V_11 , T_1 V_1563 ,
T_13 V_487 , enum V_1561 V_1562 )
{
F_586 ( V_11 , V_1563 , V_487 , V_1562 ) ;
}
static T_1 F_587 ( struct V_508 * V_11 , void * V_1560 ,
T_13 V_487 ,
enum V_1561 V_1562 )
{
return F_588 ( V_11 , V_1560 , V_487 , V_1562 ) ;
}
static void F_589 ( struct V_508 * V_11 , T_1 V_1563 ,
T_13 V_487 ,
enum V_1561 V_1562 )
{
F_590 ( V_11 , V_1563 , V_487 , V_1562 ) ;
}
...
static struct V_308 * F_592 ( struct V_508 * V_1565 ,
struct V_1510 * V_1231 ,
struct V_1515 * V_1516 ,
const struct V_1566 * V_304 , T_5 V_30 )
{
struct V_308 * V_11 ;
struct V_3 * V_4 ;
V_11 = F_593 ( sizeof( struct V_3 ) , V_1477 ) ;
if ( ! V_11 )
return NULL ;
F_594 ( V_11 , V_1565 ) ;
V_4 = F_399 ( V_11 ) ;
...
{
V_11 -> V_1574 = V_1575 | V_1576 | V_552 ;
V_11 -> V_551 |= V_11 -> V_1574 | V_1577 ;
}
static int F_599 ( struct V_1510 * V_1231 ,
const struct V_1578 * V_468 )
{
union V_1542 V_1579 ;
struct V_308 * V_11 ;
struct V_3 * V_4 ;
...
V_10 = F_600 ( V_1231 ) ;
if ( V_10 ) {
F_225 ( & V_1231 -> V_11 , L_217 ) ;
return V_10 ;
}
if ( ! ( F_601 ( V_1231 , 0 ) & V_1581 ) ||
! ( F_601 ( V_1231 , 2 ) & V_1581 ) ) {
F_225 ( & V_1231 -> V_11 , L_218 ) ;
V_10 = - V_8 ;
goto V_1582;
}
V_10 = F_602 ( V_1231 , V_1224 ) ;
if ( V_10 ) {
F_225 ( & V_1231 -> V_11 , L_219 ) ;
goto V_1582;
}
if ( ! F_603 ( V_1231 ) ) {
F_225 ( & V_1231 -> V_11 , L_220 ) ;
V_10 = - V_8 ;
goto V_1583;
}
V_11 = F_592 ( & V_1231 -> V_11 , V_1231 , NULL ,
& V_1584 , F_604 ( V_1231 -> V_1585 ) ) ;
if ( ! V_11 ) {
V_10 = - V_506 ;
goto V_1583;
}
V_4 = F_399 ( V_11 ) ;
memset ( & V_1579 , 0 , sizeof( V_1579 ) ) ;
V_1579 . V_1586 . V_1587 = F_605 ( V_1231 -> V_1588 ) ;
V_1579 . V_1586 . V_1588 = V_1231 -> V_1588 -> V_1589 ;
V_1579 . V_1586 . V_508 = F_606 ( V_1231 -> V_1585 ) ;
V_4 -> V_25 = F_569 ( V_4 , & V_1579 ,
V_1539 ) ;
if ( ! V_4 -> V_25 ) {
V_10 = - V_506 ;
goto V_1590;
...
V_1597 ) ;
V_1580 = F_608 ( 44 ) ;
V_10 = F_609 ( V_1231 , V_1580 ) ;
if ( ! V_10 ) {
V_11 -> V_551 |= V_1598 ;
V_10 = F_610 ( V_1231 , V_1580 ) ;
if ( V_10 ) {
F_225 ( & V_1231 -> V_11 , L_221 ) ;
goto V_1599;
}
}
if ( V_10 ) {
V_10 = F_609 ( V_1231 , F_608 ( 32 ) ) ;
if ( V_10 ) {
F_225 ( & V_1231 -> V_11 , L_222 ) ;
goto V_1599;
}
}
F_598 ( V_11 ) ;
V_11 -> V_1600 |= V_1601 ;
V_4 -> V_1498 = F_611 ( V_1231 , 0 ) ;
if ( ! V_4 -> V_1498 ) {
F_225 ( & V_1231 -> V_11 , L_223 ) ;
V_10 = - V_506 ;
goto V_1599;
}
F_612 ( V_1231 ) ;
F_613 ( V_1231 ) ;
V_11 -> V_782 = V_1231 -> V_782 ;
V_11 -> V_1602 = V_1603 ;
V_11 -> V_1604 = V_1605 ;
F_596 ( V_11 ) ;
V_10 = F_550 ( V_4 ) ;
if ( V_10 ) {
if ( V_10 != - V_8 )
F_225 ( & V_1231 -> V_11 , L_224 ) ;
goto V_1606;
}
V_10 = F_614 ( V_11 ) ;
if ( V_10 ) {
F_225 ( & V_1231 -> V_11 , L_225 ) ;
goto V_1606;
}
F_615 ( V_1231 , V_11 ) ;
F_597 ( V_4 ) ;
...
static void F_620 ( struct V_1510 * V_1231 )
{
struct V_308 * V_11 = F_621 ( V_1231 ) ;
if ( V_11 ) {
struct V_3 * V_4 = F_399 ( V_11 ) ;
F_622 ( V_11 ) ;
if ( V_4 -> V_1498 ) {
...
static int F_623 ( struct V_1510 * V_1231 , T_15 V_1373 )
{
struct V_308 * V_11 = F_621 ( V_1231 ) ;
struct V_3 * V_4 = F_399 ( V_11 ) ;
unsigned long V_87 ;
...
static int F_626 ( struct V_1510 * V_1231 )
{
struct V_308 * V_11 = F_621 ( V_1231 ) ;
struct V_3 * V_4 = F_399 ( V_11 ) ;
unsigned long V_87 ;
...
T_1 * V_1607 , T_6 V_1558 )
{
unsigned long V_1608 = F_630 ( V_487 ) ;
unsigned long V_485 = F_631 ( V_1558 , V_1608 ) ;
if ( V_485 == 0UL )
return NULL ;
memset ( ( char * ) V_485 , 0 , V_509 << V_1608 ) ;
* V_1607 = F_632 ( V_485 ) ;
return ( void * ) V_485 ;
}
...
{
unsigned long V_1608 = F_630 ( V_487 ) ;
F_634 ( ( unsigned long ) V_1560 , V_1608 ) ;
}
...
static void F_637 ( struct V_508 * V_11 , T_1 V_1563 ,
T_13 V_487 , enum V_1561 V_1562 )
{
}
static T_1 F_638 ( struct V_508 * V_11 , void * V_1560 ,
T_13 V_487 ,
enum V_1561 V_1562 )
{
return F_632 ( V_1560 ) ;
}
static void F_639 ( struct V_508 * V_11 , T_1 V_1563 ,
T_13 V_487 ,
enum V_1561 V_1562 )
{
}
static int F_640 ( struct V_1515 * V_1516 )
{
union V_1542 V_1579 ;
struct V_308 * V_11 ;
struct V_3 * V_4 ;
...
int V_10 ;
F_591 () ;
V_1 = F_541 ( V_1516 -> V_11 . V_1518 , L_226 , NULL ) ;
if ( ! V_1 ) {
F_225 ( & V_1516 -> V_11 , L_227 ,
V_1516 -> V_11 . V_1518 -> V_1528 ) ;
return - V_8 ;
}
V_11 = F_592 ( & V_1516 -> V_11 , NULL , V_1516 ,
& V_1609 , V_1 [ 0 ] & 0x1 ) ;
if ( ! V_11 ) {
V_10 = - V_506 ;
goto V_1610;
...
V_4 = F_399 ( V_11 ) ;
memset ( & V_1579 , 0 , sizeof( V_1579 ) ) ;
V_1579 . V_1611 = F_641 ( V_1516 -> V_11 . V_1518 ) ;
V_4 -> V_25 = F_569 ( V_4 , & V_1579 ,
V_343 ) ;
if ( ! V_4 -> V_25 ) {
V_10 = - V_506 ;
...
F_598 ( V_11 ) ;
V_4 -> V_1498 = F_642 ( & V_1516 -> V_1612 [ 1 ] , 0 ,
F_643 ( & V_1516 -> V_1612 [ 1 ] ) ,
L_228 ) ;
if ( ! V_4 -> V_1498 ) {
F_225 ( & V_1516 -> V_11 , L_223 ) ;
V_10 = - V_506 ;
goto V_1599;
}
V_4 -> V_1613 = F_642 ( & V_1516 -> V_1612 [ 2 ] , 0 ,
F_643 ( & V_1516 -> V_1612 [ 2 ] ) ,
L_229 ) ;
if ( ! V_4 -> V_1613 ) {
F_225 ( & V_1516 -> V_11 , L_230 ) ;
V_10 = - V_506 ;
goto V_1606;
}
V_4 -> V_1614 = F_642 ( & V_1516 -> V_1612 [ 3 ] , 0 ,
F_643 ( & V_1516 -> V_1612 [ 3 ] ) ,
L_231 ) ;
if ( ! V_4 -> V_1614 ) {
F_225 ( & V_1516 -> V_11 , L_232 ) ;
V_10 = - V_506 ;
goto V_1606;
}
F_596 ( V_11 ) ;
...
if ( V_10 ) {
if ( V_10 != - V_8 )
F_225 ( & V_1516 -> V_11 , L_224 ) ;
goto V_1606;
}
V_10 = F_614 ( V_11 ) ;
if ( V_10 ) {
F_225 ( & V_1516 -> V_11 , L_225 ) ;
goto V_1606;
}
F_644 ( V_1516 , V_11 ) ;
F_597 ( V_4 ) ;
...
V_1606:
if ( V_4 -> V_1613 ) {
F_645 ( & V_1516 -> V_1612 [ 2 ] , V_4 -> V_1613 ,
F_643 ( & V_1516 -> V_1612 [ 2 ] ) ) ;
V_4 -> V_1613 = NULL ;
}
if ( V_4 -> V_1614 ) {
F_645 ( & V_1516 -> V_1612 [ 3 ] , V_4 -> V_1614 ,
F_643 ( & V_1516 -> V_1612 [ 3 ] ) ) ;
V_4 -> V_1614 = NULL ;
}
if ( V_4 -> V_1498 ) {
F_645 ( & V_1516 -> V_1612 [ 1 ] , V_4 -> V_1498 ,
F_643 ( & V_1516 -> V_1612 [ 1 ] ) ) ;
V_4 -> V_1498 = NULL ;
}
V_1599:
...
static int F_646 ( struct V_1515 * V_1516 )
{
struct V_308 * V_11 = F_647 ( V_1516 ) ;
if ( V_11 ) {
struct V_3 * V_4 = F_399 ( V_11 ) ;
F_622 ( V_11 ) ;
if ( V_4 -> V_1613 ) {
