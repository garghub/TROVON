...
static int F_87 ( struct V_162 * V_23 )
{
struct V_1 * V_2 = F_88 ( V_23 ) ;
struct V_88 * V_89 = V_2 -> V_89 ;
F_35 ( L_40 ) ;
F_37 ( V_76 ) ;
F_89 ( & V_2 -> V_159 ) ;
...
static int F_91 ( struct V_178 * V_93 )
{
struct V_162 * V_23 = F_92 ( V_93 ) ;
struct V_1 * V_2 = F_88 ( V_23 ) ;
if ( ! V_2 -> V_160 ) {
F_93 ( V_2 -> V_89 ) ;
F_94 ( V_2 -> V_144 ) ;
...
static int F_96 ( struct V_178 * V_93 )
{
struct V_162 * V_23 = F_92 ( V_93 ) ;
struct V_1 * V_2 = F_88 ( V_23 ) ;
F_97 ( & V_2 -> V_159 ) ;
