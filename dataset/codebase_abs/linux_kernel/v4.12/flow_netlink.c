...
if ( V_28 < 0 )
return V_28 ;
V_304 = F_122 ( V_51 . V_88 , V_271 ) ;
if ( ! V_304 )
return - V_272 ;
V_100 = F_123 ( & V_304 -> V_108 . V_141 . V_340 , V_271 ) ;
if ( V_100 ) {
...
const struct V_279 * V_344 ,
struct V_296 * * V_297 , bool * V_345 ,
T_4 V_158 , T_5 V_155 , bool V_346 , bool log )
{
const struct V_1 * V_300 = F_20 ( V_78 ) ;
int V_347 = F_3 ( V_300 ) ;
T_2 V_348 ;
...
V_348 /= 2 ;
if ( V_347 > V_82 ||
! F_16 ( V_348 , V_84 [ V_347 ] . V_85 ) )
return - V_83 ;
if ( V_346 && ! F_126 ( F_20 ( V_300 ) , V_348 ) )
return - V_83 ;
switch ( V_347 ) {
const struct V_205 * V_206 ;
const struct V_212 * V_213 ;
...
if ( V_206 -> V_193 != V_344 -> V_56 . V_59 )
return - V_83 ;
if ( V_206 -> V_207 != V_344 -> V_56 . V_57 )
return - V_83 ;
}
break;
case V_37 :
...
if ( V_213 -> V_197 != V_344 -> V_56 . V_59 )
return - V_83 ;
if ( V_213 -> V_214 != V_344 -> V_56 . V_57 )
return - V_83 ;
}
...
if ( ( V_155 != F_8 ( V_55 ) &&
V_155 != F_8 ( V_64 ) ) ||
V_344 -> V_56 . V_59 != V_62 )
return - V_83 ;
break;
case V_41 :
if ( ( V_155 != F_8 ( V_55 ) &&
V_155 != F_8 ( V_64 ) ) ||
V_344 -> V_56 . V_59 != V_60 )
return - V_83 ;
break;
case V_47 :
if ( ! F_9 ( V_155 ) )
...
if ( V_28 < 0 )
return V_28 ;
V_349 = F_110 ( V_297 , V_347 , NULL , V_85 , log ) ;
if ( F_109 ( V_349 ) )
return F_124 ( V_349 ) ;
memcpy ( F_20 ( V_349 ) , F_20 ( V_300 ) , V_348 ) ;
memset ( F_20 ( V_349 ) + V_348 , 0xff , V_348 ) ;
if ( V_347 == V_37 ) {
struct V_212 * V_30 = F_20 ( V_349 ) + V_348 ;
...
{
static const struct V_351 V_352 [ V_353 + 1 ] = {
[ V_354 ] = { . type = V_355 } ,
[ V_356 ] = { . type = V_357 } ,
[ V_358 ] = { . type = V_355 } ,
} ;
struct V_1 * V_78 [ V_353 + 1 ] ;
int error ;
error = F_129 ( V_78 , V_353 , V_77 ,
V_352 , NULL ) ;
if ( error )
return error ;
if ( ! V_78 [ V_354 ] ||
...
static int F_130 ( const struct V_1 * V_359 ,
struct V_296 * * V_297 , bool log )
{
int V_360 = F_106 ( V_359 -> F_19 ) ;
struct V_1 * V_361 ;
V_361 = F_105 ( V_297 , V_359 -> F_19 , log ) ;
if ( F_109 ( V_361 ) )
return F_124 ( V_361 ) ;
memcpy ( V_361 , V_359 , V_360 ) ;
return 0 ;
}
...
int V_4 , V_100 ;
F_2 (a, attr, rem) {
static const T_6 V_362 [ V_363 + 1 ] = {
[ V_6 ] = sizeof( T_6 ) ,
[ V_7 ] = sizeof( T_6 ) ,
[ V_9 ] = ( T_6 ) - 1 ,
[ V_16 ] = sizeof( struct V_364 ) ,
[ V_13 ] = sizeof( T_5 ) ,
[ V_17 ] = sizeof( struct V_365 ) ,
[ V_14 ] = 0 ,
[ V_19 ] = ( T_6 ) - 1 ,
[ V_20 ] = ( T_6 ) - 1 ,
[ V_18 ] = ( T_6 ) - 1 ,
[ V_11 ] = sizeof( struct V_366 ) ,
[ V_10 ] = ( T_6 ) - 1 ,
[ V_8 ] = sizeof( struct V_367 ) ,
[ V_15 ] = sizeof( struct V_368 ) ,
[ V_12 ] = 0 ,
} ;
const struct V_365 * V_147 ;
int type = F_3 ( V_78 ) ;
bool V_345 ;
if ( type > V_363 ||
( V_362 [ type ] != F_19 ( V_78 ) &&
V_362 [ type ] != ( T_6 ) - 1 ) )
return - V_83 ;
V_345 = false ;
switch ( type ) {
...
break;
case V_8 : {
const struct V_367 * V_370 = F_20 ( V_78 ) ;
if ( V_370 -> V_371 < V_372 )
return - V_83 ;
break;
}
case V_11 : {
const struct V_366 * V_373 = F_20 ( V_78 ) ;
switch ( V_373 -> V_374 ) {
case V_375 :
break;
default:
...
break;
case V_16 : {
const struct V_364 * V_231 = F_20 ( V_78 ) ;
if ( ! F_9 ( V_231 -> V_377 ) )
return - V_83 ;
if ( V_319 & F_8 ( V_151 ) ||
( V_155 != F_8 ( V_55 ) &&
...
struct V_134 * V_135 )
{
struct V_1 * V_28 , * V_378 = NULL , * V_323 ;
...
const struct V_1 * V_300 = F_20 ( V_78 ) ;
struct V_1 * V_3 ;
T_2 V_348 = F_19 ( V_300 ) / 2 ;
V_3 = F_38 ( V_135 , V_19 ) ;
if ( ! V_3 )
return - V_137 ;
if ( F_48 ( V_135 , F_3 ( V_300 ) , V_348 , F_20 ( V_300 ) ) )
return - V_137 ;
F_40 ( V_135 , V_3 ) ;
return 0 ;
}
