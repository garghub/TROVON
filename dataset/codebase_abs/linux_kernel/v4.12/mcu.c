...
if ( ! V_5 )
return - V_58 ;
return F_24 ( V_2 , V_5 , V_59 , V_52 == 5 ) ;
}
int F_35 ( struct V_1 * V_2 , int V_60 )
{
int V_26 ;
if ( ! F_27 ( V_61 , & V_2 -> V_46 ) )
return 0 ;
V_26 = F_33 ( V_2 , V_62 ,
V_60 ) ;
if ( V_26 ) {
...
int
F_36 ( struct V_1 * V_2 , enum V_64 V_65 , T_1 V_6 )
{
struct V_4 * V_5 ;
struct {
T_3 V_53 ;
...
if ( ! V_5 )
return - V_58 ;
return F_24 ( V_2 , V_5 , V_66 , true ) ;
}
int F_37 ( struct V_1 * V_2 , T_1 V_67 ,
...
V_26 = F_24 ( V_2 , V_5 , V_74 , V_72 == V_69 ) ;
if ( V_26 )
return V_26 ;
return F_37 ( V_2 , V_67 , V_18 + V_72 , V_69 - V_72 ) ;
}
...
for ( V_15 = 0 ; V_15 < V_72 ; V_15 ++ )
F_3 ( V_5 , V_18 [ V_15 ] ) ;
V_26 = F_24 ( V_2 , V_5 , V_78 , V_72 == V_69 ) ;
if ( V_26 )
return V_26 ;
return F_39 ( V_2 , V_75 + V_72 * 4 ,
V_18 + V_72 , V_69 - V_72 ) ;
}
...
return 0 ;
V_69 = F_38 ( V_92 , V_17 ) ;
V_26 = F_40 ( V_2 , V_80 , V_18 , V_69 , V_81 ) ;
if ( V_26 )
return V_26 ;
if ( ! F_47 ( V_2 , V_93 , F_48 ( 31 ) , F_48 ( 31 ) , 500 ) )
return - V_37 ;
return F_46 ( V_2 , V_80 , V_18 + V_69 , V_17 - V_69 , V_81 + V_69 ) ;
}
static int
