...
if ( V_52 < 0 )
return V_52 ;
V_2 -> V_72 = F_24 ( V_2 -> V_7 , sizeof( * V_2 -> V_72 ) ,
V_73 ) ;
if ( ! V_2 -> V_72 ) {
V_52 = - V_74 ;
goto V_75;
...
static int F_30 ( const struct V_76 * V_54 )
{
V_77 = V_78 ;
return 1 ;
}
static int F_31 ( const struct V_76 * V_54 )
{
V_77 = V_79 ;
return 1 ;
}
static struct V_55 * F_32 ( void * V_80 )
{
...
static struct V_55 * F_34 ( void * V_80 )
{
struct V_55 * V_56 = V_80 ;
F_33 ( V_83 ) ;
if ( V_77 == V_79 )
