...
{
int V_157 = ( V_2 -> V_4 . V_5 -> V_158 & ~ V_59 ) >> 3 ;
unsigned long * V_158 ;
struct V_159 * V_159 ;
int V_160 ;
F_3 ( V_2 , 4 , L_16 , V_157 ) ;
V_159 = V_2 -> V_4 . V_159 ;
V_2 -> V_36 . V_161 ++ ;
...
if ( V_2 -> V_4 . V_5 -> V_29 . V_30 & V_31 )
return F_5 ( V_2 , V_32 ) ;
if ( ( ( V_2 -> V_4 . V_5 -> V_24 & 0xf0000000 ) >> 28 ) > 6 )
return F_5 ( V_2 , V_33 ) ;
F_4 ( V_2 ) ;
V_2 -> V_4 . V_5 -> V_158 &= V_59 ;
V_158 = F_83 ( V_2 -> V_4 . V_5 -> V_158 ) ;
F_41 ( & V_159 -> V_60 -> V_61 ) ;
for ( V_160 = 0 ; V_160 < V_157 ; ++ V_160 )
F_84 ( V_159 , V_158 [ V_160 ] ) ;
F_43 ( & V_159 -> V_60 -> V_61 ) ;
return 0 ;
}
int F_85 ( struct V_1 * V_2 )
{
T_8 V_140 ;
V_140 = V_163 [ V_2 -> V_4 . V_5 -> V_9 & 0x00ff ] ;
if ( V_140 )
return V_140 ( V_2 ) ;
return - V_10 ;
}
...
int V_164 = V_2 -> V_4 . V_5 -> V_9 & 0x000f ;
int V_165 , V_25 , V_166 ;
T_3 V_167 [ 16 ] ;
T_2 V_41 ;
T_1 V_26 ;
V_2 -> V_36 . V_168 ++ ;
...
if ( V_41 & 3 )
return F_5 ( V_2 , V_33 ) ;
F_3 ( V_2 , 4 , L_17 , V_56 , V_164 , V_41 ) ;
F_88 ( V_2 , 0 , V_56 , V_164 , V_41 ) ;
V_166 = ( ( V_164 - V_56 ) & 0xf ) + 1 ;
V_25 = F_15 ( V_2 , V_41 , V_26 , V_167 , V_166 * sizeof( T_3 ) ) ;
if ( V_25 )
return F_16 ( V_2 , V_25 ) ;
V_165 = V_56 ;
V_166 = 0 ;
do {
V_2 -> V_4 . V_5 -> V_82 [ V_165 ] &= 0xffffffff00000000ul ;
V_2 -> V_4 . V_5 -> V_82 [ V_165 ] |= V_167 [ V_166 ++ ] ;
if ( V_165 == V_164 )
break;
V_165 = ( V_165 + 1 ) % 16 ;
} while ( 1 );
...
if ( V_41 & 3 )
return F_5 ( V_2 , V_33 ) ;
F_3 ( V_2 , 4 , L_18 , V_56 , V_164 , V_41 ) ;
F_91 ( V_2 , 0 , V_56 , V_164 , V_41 ) ;
V_165 = V_56 ;
V_166 = 0 ;
do {
V_167 [ V_166 ++ ] = V_2 -> V_4 . V_5 -> V_82 [ V_165 ] ;
if ( V_165 == V_164 )
break;
V_165 = ( V_165 + 1 ) % 16 ;
} while ( 1 );
V_25 = F_25 ( V_2 , V_41 , V_26 , V_167 , V_166 * sizeof( T_3 ) ) ;
...
if ( V_41 & 7 )
return F_5 ( V_2 , V_33 ) ;
F_3 ( V_2 , 4 , L_19 , V_56 , V_164 , V_41 ) ;
F_88 ( V_2 , 1 , V_56 , V_164 , V_41 ) ;
V_166 = ( ( V_164 - V_56 ) & 0xf ) + 1 ;
V_25 = F_15 ( V_2 , V_41 , V_26 , V_167 , V_166 * sizeof( T_2 ) ) ;
if ( V_25 )
return F_16 ( V_2 , V_25 ) ;
V_165 = V_56 ;
V_166 = 0 ;
...
if ( V_41 & 7 )
return F_5 ( V_2 , V_33 ) ;
F_3 ( V_2 , 4 , L_20 , V_56 , V_164 , V_41 ) ;
F_91 ( V_2 , 1 , V_56 , V_164 , V_41 ) ;
V_165 = V_56 ;
V_166 = 0 ;
do {
V_167 [ V_166 ++ ] = V_2 -> V_4 . V_5 -> V_82 [ V_165 ] ;
...
V_25 = F_25 ( V_2 , V_41 , V_26 , V_167 , V_166 * sizeof( T_2 ) ) ;
return V_25 ? F_16 ( V_2 , V_25 ) : 0 ;
}
int F_95 ( struct V_1 * V_2 )
{
T_8 V_140 ;
V_140 = V_173 [ V_2 -> V_4 . V_5 -> V_24 & 0xff ] ;
if ( V_140 )
return V_140 ( V_2 ) ;
return - V_10 ;
}
...
if ( V_2 -> V_4 . V_5 -> V_29 . V_30 & V_31 )
return F_5 ( V_2 , V_32 ) ;
F_97 ( V_2 , & V_174 , & V_175 , & V_26 , NULL ) ;
if ( V_175 & 0xf0 )
return - V_10 ;
if ( V_2 -> V_4 . V_5 -> V_29 . V_30 & V_182 )
F_98 ( V_2 ) ;
V_178 = F_99 ( V_2 , V_174 , V_26 , & V_177 , V_183 ) ;
if ( V_178 == V_184 ) {
V_179 = 1 ;
V_178 = F_99 ( V_2 , V_174 , V_26 , & V_177 ,
V_185 ) ;
}
if ( V_178 ) {
if ( V_178 == V_38 || V_178 == V_186 ) {
V_178 = F_5 ( V_2 , V_178 ) ;
} else if ( V_178 > 0 ) {
F_18 ( V_2 , 3 ) ;
V_178 = 0 ;
...
V_176 = F_100 ( V_2 -> V_3 , F_39 ( V_177 ) , & V_180 ) ;
if ( F_40 ( V_176 ) ) {
V_178 = F_5 ( V_2 , V_38 ) ;
} else {
if ( ! V_180 )
...
return F_5 ( V_2 ,
V_33 ) ;
V_188 = V_2 -> V_14 -> V_15 . V_16 . V_58 [ 0 ] & 0x000000000000ffff ;
V_2 -> V_4 . V_5 -> V_189 = V_188 ;
return 0 ;
}
...
{
T_8 V_140 ;
V_140 = V_190 [ V_2 -> V_4 . V_5 -> V_9 & 0x00ff ] ;
if ( V_140 )
return V_140 ( V_2 ) ;
return - V_10 ;
}
