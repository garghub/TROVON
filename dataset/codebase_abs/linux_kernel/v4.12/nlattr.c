...
{
struct V_1 * V_2 ;
V_2 = (struct V_1 * ) F_21 ( V_48 , F_11 ( V_8 ) ) ;
V_2 -> F_3 = V_36 ;
V_2 -> F_2 = F_22 ( V_8 ) ;
...
{
void * V_50 ;
V_50 = F_21 ( V_48 , F_7 ( V_8 ) ) ;
memset ( V_50 , 0 , F_7 ( V_8 ) ) ;
return V_50 ;
}
struct V_1 * F_28 ( struct V_47 * V_48 , int V_36 , int V_8 )
{
if ( F_13 ( F_29 ( V_48 ) < F_11 ( V_8 ) ) )
return NULL ;
return F_20 ( V_48 , V_36 , V_8 ) ;
}
struct V_1 * F_30 ( struct V_47 * V_48 , int V_36 , int V_8 ,
int V_49 )
{
T_2 V_13 ;
if ( F_25 ( V_48 ) )
...
V_13 = F_11 ( V_8 ) ;
if ( F_13 ( F_29 ( V_48 ) < V_13 ) )
return NULL ;
return F_24 ( V_48 , V_36 , V_8 , V_49 ) ;
}
void * F_32 ( struct V_47 * V_48 , int V_8 )
{
if ( F_13 ( F_29 ( V_48 ) < F_7 ( V_8 ) ) )
return NULL ;
return F_27 ( V_48 , V_8 ) ;
}
void F_33 ( struct V_47 * V_48 , int V_36 , int V_8 ,
const void * V_43 )
{
struct V_1 * V_2 ;
...
void F_35 ( struct V_47 * V_48 , int V_8 , const void * V_43 )
{
void * V_50 ;
V_50 = F_27 ( V_48 , V_8 ) ;
memcpy ( V_50 , V_43 , V_8 ) ;
}
int F_36 ( struct V_47 * V_48 , int V_36 , int V_8 , const void * V_43 )
{
if ( F_13 ( F_29 ( V_48 ) < F_11 ( V_8 ) ) )
return - V_51 ;
F_33 ( V_48 , V_36 , V_8 , V_43 ) ;
return 0 ;
}
int F_37 ( struct V_47 * V_48 , int V_36 , int V_8 ,
const void * V_43 , int V_49 )
{
T_2 V_13 ;
if ( F_25 ( V_48 ) )
...
if ( F_13 ( F_29 ( V_48 ) < V_13 ) )
return - V_51 ;
F_34 ( V_48 , V_36 , V_8 , V_43 , V_49 ) ;
return 0 ;
}
int F_38 ( struct V_47 * V_48 , int V_8 , const void * V_43 )
{
if ( F_13 ( F_29 ( V_48 ) < F_7 ( V_8 ) ) )
return - V_51 ;
F_35 ( V_48 , V_8 , V_43 ) ;
