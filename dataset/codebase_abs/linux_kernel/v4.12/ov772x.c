...
struct V_145 * V_22 )
{
if ( V_22 -> V_128 || V_22 -> V_146 >= F_20 ( V_67 ) )
return - V_46 ;
V_22 -> V_22 = V_67 [ V_22 -> V_146 ] . V_22 ;
return 0 ;
}
...
struct V_5 * V_6 = F_11 ( V_3 ) ;
struct V_52 * V_53 = F_17 ( V_6 ) ;
V_112 -> V_34 = V_148 | V_149 |
V_150 | V_151 |
V_152 ;
V_112 -> type = V_153 ;
V_112 -> V_34 = F_33 ( V_53 , V_112 ) ;
return 0 ;
}
...
struct V_1 * V_19 ;
struct V_52 * V_53 = F_17 ( V_6 ) ;
struct V_156 * V_157 = F_35 ( V_6 -> V_20 . V_158 ) ;
int V_13 ;
if ( ! V_53 || ! V_53 -> V_159 ) {
F_28 ( & V_6 -> V_20 , L_6 ) ;
return - V_46 ;
...
V_19 = F_37 ( & V_6 -> V_20 , sizeof( * V_19 ) , V_162 ) ;
if ( ! V_19 )
return - V_163 ;
V_19 -> V_33 = V_53 -> V_159 ;
F_38 ( & V_19 -> V_4 , V_6 , & V_164 ) ;
F_39 ( & V_19 -> V_28 , 3 ) ;
F_40 ( & V_19 -> V_28 , & V_165 ,
V_30 , 0 , 1 , 1 , 0 ) ;
F_40 ( & V_19 -> V_28 , & V_165 ,
V_37 , 0 , 1 , 1 , 0 ) ;
F_40 ( & V_19 -> V_28 , & V_165 ,
