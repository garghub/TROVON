...
if ( F_67 ( ! ( V_142 & V_162 ) || ! ( V_142 & V_163 ) ) ) {
...
if ( F_60 ( V_142 & V_167 ) )
V_120 -> V_168 = V_169 ;
F_69 ( V_120 , sizeof( * V_144 ) + 2 ) ;
V_141 -= ( sizeof( * V_144 ) + 2 ) ;
if ( V_2 -> V_29 ) {
F_70 ( V_120 , V_141 - V_170 ) ;
V_141 -= V_170 ;
}
V_120 -> V_171 = F_71 ( V_120 , V_123 ) ;
V_123 -> V_83 . V_172 ++ ;
V_123 -> V_83 . V_173 += V_141 ;
F_72 ( & V_2 -> V_174 , V_120 ) ;
V_155:
V_138 ++ ;
V_2 -> V_152 ++ ;
...
static void F_73 ( struct V_84 * V_85 ,
struct V_118 * V_119 ,
unsigned int * V_175 ,
unsigned int * V_176 )
{
...
( * V_176 ) ++ ;
F_52 ( V_119 ) ;
} else if ( F_62 ( V_119 , V_121 ) ) {
V_85 -> V_88 += F_74 ( V_119 , V_177 ) ;
F_75 ( V_99 , F_62 ( V_119 , V_121 ) ,
F_74 ( V_119 , V_177 ) , V_178 ) ;
F_54 ( V_119 , V_121 , 0 ) ;
}
}
...
T_1 V_183 ;
if ( ! V_85 -> V_2 -> V_4 )
F_77 ( V_85 -> V_2 , F_6 ( V_85 -> V_184 ) , V_146 ) ;
else
F_66 ( V_85 -> V_2 , F_6 ( V_85 -> V_184 +
V_185 ) , V_146 ) ;
V_183 = F_21 ( V_2 , F_78 ( V_85 -> V_184 ) ) ;
...
unsigned int V_195 ;
unsigned long V_196 ;
V_194 = F_80 ( V_2 -> V_81 , V_85 -> V_184 ) ;
F_81 ( & V_85 -> V_197 , V_196 ) ;
V_195 = F_76 ( V_2 , V_85 ) ;
if ( V_195 )
F_82 ( V_194 ) ;
F_83 ( & V_85 -> V_197 , V_196 ) ;
return V_195 ;
}
...
static int F_85 ( struct V_198 * V_174 , int V_137 )
{
struct V_84 * V_85 =
F_86 ( V_174 , struct V_84 , V_174 ) ;
unsigned int V_199 = 0 ;
V_199 = F_79 ( V_85 -> V_2 , V_85 ) ;
if ( V_199 == 0 ) {
F_87 ( V_174 ) ;
if ( ! V_85 -> V_2 -> V_4 )
F_88 ( V_85 -> V_2 , F_6 ( V_85 -> V_184 ) ) ;
else
...
F_79 ( V_2 , & V_2 -> V_86 [ V_200 ] ) ;
}
static int F_91 ( struct V_198 * V_174 , int V_137 )
{
struct V_1 * V_2 =
F_86 ( V_174 , struct V_1 , V_174 ) ;
unsigned int V_199 = 0 ;
V_199 = F_65 ( V_2 , V_137 ) ;
V_2 -> V_150 += V_199 ;
V_2 -> V_150 &= V_151 ;
if ( ! V_2 -> V_4 )
...
static T_8 F_95 ( int V_204 , void * V_205 )
{
struct V_21 * V_22 = V_205 ;
struct V_1 * V_2 = F_16 ( V_22 ) ;
struct V_84 * V_206 ;
unsigned int V_85 , V_207 ;
V_2 -> V_208 = F_96 ( V_2 , V_209 ) &
~ F_96 ( V_2 , V_210 ) ;
F_66 ( V_2 , V_2 -> V_208 , V_146 ) ;
if ( F_67 ( V_2 -> V_208 == 0 ) ) {
F_97 ( V_2 -> V_81 , L_18 ) ;
return V_211 ;
}
if ( V_2 -> V_208 & V_145 ) {
if ( F_60 ( F_98 ( & V_2 -> V_174 ) ) ) {
F_94 ( V_2 , V_145 ) ;
F_99 ( & V_2 -> V_174 ) ;
}
}
...
static T_8 F_102 ( int V_204 , void * V_205 )
{
struct V_21 * V_22 = V_205 ;
struct V_1 * V_2 = F_16 ( V_22 ) ;
struct V_84 * V_206 ;
unsigned int V_85 ;
V_2 -> V_215 = F_103 ( V_2 , V_209 ) &
~ F_103 ( V_2 , V_210 ) ;
...
static T_8 F_105 ( int V_204 , void * V_205 )
{
struct V_1 * V_2 = V_205 ;
F_106 ( & V_2 -> V_100 -> V_22 , 0 ) ;
return V_214 ;
}
...
static struct V_122 * F_110 ( struct V_122 * V_120 ,
struct V_21 * V_22 )
{
struct V_122 * V_218 ;
struct V_219 * V_220 ;
...
T_7 V_223 ;
T_7 V_224 ;
if ( F_67 ( F_111 ( V_120 ) < sizeof( * V_220 ) ) ) {
V_218 = F_112 ( V_120 , sizeof( * V_220 ) ) ;
F_64 ( V_120 ) ;
if ( ! V_218 ) {
V_22 -> V_83 . V_225 ++ ;
V_22 -> V_83 . V_226 ++ ;
...
V_220 = (struct V_219 * ) F_113 ( V_120 , sizeof( * V_220 ) ) ;
memset ( V_220 , 0 , sizeof( * V_220 ) ) ;
if ( V_120 -> V_168 == V_227 ) {
V_224 = F_114 ( V_120 -> V_171 ) ;
switch ( V_224 ) {
case V_228 :
V_222 = F_115 ( V_120 ) -> V_171 ;
break;
case V_229 :
V_222 = F_116 ( V_120 ) -> V_230 ;
break;
default:
return V_120 ;
}
V_223 = F_117 ( V_120 ) - sizeof( * V_220 ) ;
...
static T_9 F_118 ( struct V_122 * V_120 ,
struct V_21 * V_22 )
{
struct V_1 * V_2 = F_16 ( V_22 ) ;
struct V_98 * V_99 = & V_2 -> V_100 -> V_22 ;
...
int V_40 ;
V_241 = F_119 ( V_120 ) ;
V_194 = F_80 ( V_22 , V_241 ) ;
V_85 = & V_2 -> V_86 [ V_241 ] ;
F_81 ( & V_85 -> V_197 , V_196 ) ;
if ( F_67 ( V_85 -> V_192 == 0 ) ) {
F_120 ( V_194 ) ;
F_121 ( V_22 , L_21 , V_241 ) ;
V_40 = V_242 ;
goto V_213;
}
if ( F_122 ( V_120 , V_243 + V_244 ) ) {
V_40 = V_245 ;
goto V_213;
}
if ( V_2 -> V_32 ) {
V_120 = F_110 ( V_120 , V_22 ) ;
if ( ! V_120 ) {
V_40 = V_245 ;
goto V_213;
}
...
T_1 V_24 ;
V_189 = 256 ;
V_71 = F_131 ( V_99 , sizeof( struct V_16 ) , & V_85 -> V_277 ,
V_278 ) ;
if ( ! V_71 ) {
F_57 ( V_2 , V_80 , V_2 -> V_81 , L_25 ) ;
return - V_136 ;
}
V_85 -> V_191 = F_132 ( V_189 , sizeof( struct V_118 ) , V_278 ) ;
if ( ! V_85 -> V_191 ) {
...
F_133 ( & V_85 -> V_197 ) ;
V_85 -> V_2 = V_2 ;
F_134 ( V_2 -> V_81 , & V_85 -> V_174 , F_85 , 64 ) ;
V_85 -> V_184 = V_184 ;
V_85 -> V_189 = V_189 ;
...
V_85 -> V_248 = 0 ;
F_12 ( V_2 , V_280 , F_135 ( V_184 ) ) ;
F_12 ( V_2 , 0 , F_136 ( V_184 ) ) ;
F_12 ( V_2 , 1 , F_49 ( V_184 ) ) ;
F_12 ( V_2 , 0 , F_78 ( V_184 ) ) ;
F_12 ( V_2 , V_281 , F_137 ( V_184 ) ) ;
...
V_2 -> V_150 = 0 ;
V_2 -> V_152 = 0 ;
V_2 -> V_135 = F_132 ( V_2 -> V_134 , sizeof( struct V_118 ) ,
V_278 ) ;
if ( ! V_2 -> V_135 ) {
F_57 ( V_2 , V_80 , V_2 -> V_81 , L_26 ) ;
return - V_136 ;
...
V_24 = F_153 ( V_2 , V_308 ) ;
if ( V_48 )
V_24 |= V_307 ;
else
V_24 &= ~ V_307 ;
F_154 ( V_2 , V_24 , V_308 ) ;
}
if ( V_48 == 0 )
F_147 ( 1000 , 2000 ) ;
}
...
F_154 ( V_2 , V_310 , V_314 ) ;
F_154 ( V_2 , V_311 , V_315 ) ;
}
}
static void F_158 ( struct V_1 * V_2 )
{
F_159 ( V_2 , V_316 , V_317 ) ;
F_159 ( V_2 , V_318 , V_319 ) ;
F_160 ( 1 ) ;
F_159 ( V_2 , 0 , V_317 ) ;
F_159 ( V_2 , 0 , V_319 ) ;
}
static int F_161 ( struct V_21 * V_22 , void * V_71 )
{
struct V_1 * V_2 = F_16 ( V_22 ) ;
...
if ( ! F_36 ( V_22 ) )
return 0 ;
F_157 ( V_2 , V_22 -> V_322 ) ;
return 0 ;
}
static struct V_324 * F_163 ( struct V_21 * V_22 )
{
struct V_1 * V_2 = F_16 ( V_22 ) ;
...
V_2 -> V_29 = ! ! ( F_153 ( V_2 , V_308 ) &
V_340 ) ;
V_253 = F_171 ( V_22 , V_2 -> V_341 , F_128 ,
0 , V_2 -> V_342 ) ;
if ( ! V_253 ) {
F_121 ( V_22 , L_36 ) ;
return - V_343 ;
...
V_2 -> V_271 = - 1 ;
F_168 ( V_2 ) ;
V_40 = F_172 ( V_2 -> V_216 , F_95 , 0 , V_22 -> V_344 , V_22 ) ;
if ( V_40 ) {
F_121 ( V_22 , L_37 ) ;
goto V_345;
}
if ( ! V_2 -> V_4 ) {
V_40 = F_172 ( V_2 -> V_217 , F_102 , 0 ,
V_22 -> V_344 , V_22 ) ;
if ( V_40 ) {
F_121 ( V_22 , L_38 ) ;
goto V_346;
...
if ( V_40 )
goto V_350;
F_152 ( V_2 , V_335 | V_336 , 1 ) ;
F_164 ( V_22 ) ;
return 0 ;
V_350:
F_94 ( V_2 , V_145 | V_212 ) ;
V_349:
F_150 ( V_2 ) ;
V_347:
for ( V_57 = 0 ; V_57 < V_22 -> V_62 ; V_57 ++ )
F_141 ( V_2 , V_57 ) ;
if ( ! V_2 -> V_4 )
F_173 ( V_2 -> V_217 , V_22 ) ;
V_346:
F_173 ( V_2 -> V_216 , V_22 ) ;
V_345:
F_174 ( V_253 ) ;
return V_40 ;
}
...
static int F_179 ( struct V_351 * V_100 )
{
...
V_360 = F_180 ( V_100 , V_363 , 0 ) ;
V_355 = F_181 ( V_364 , V_357 ) ;
if ( ! V_355 || ! V_355 -> V_66 )
return - V_102 ;
V_353 = V_355 -> V_66 ;
if ( F_182 ( V_357 , L_43 , & V_194 ) )
V_194 = V_365 ;
if ( F_182 ( V_357 , L_44 , & V_361 ) )
V_361 = 1 ;
if ( ! V_194 || V_194 > V_365 )
return - V_102 ;
V_22 = F_183 ( sizeof( * V_2 ) , V_194 , V_361 ) ;
if ( ! V_22 )
return - V_136 ;
V_2 = F_16 ( V_22 ) ;
V_2 -> V_86 = F_184 ( & V_100 -> V_22 , V_194 ,
sizeof( struct V_84 ) ,
V_278 ) ;
if ( ! V_2 -> V_86 )
return - V_136 ;
...
V_2 -> V_216 = F_185 ( V_100 , 0 ) ;
if ( ! V_2 -> V_4 ) {
V_2 -> V_217 = F_185 ( V_100 , 1 ) ;
V_2 -> V_104 = F_185 ( V_100 , 2 ) ;
} else {
V_2 -> V_104 = F_185 ( V_100 , 1 ) ;
}
if ( V_2 -> V_216 <= 0 || ( V_2 -> V_217 <= 0 && ! V_2 -> V_4 ) ) {
F_186 ( & V_100 -> V_22 , L_45 ) ;
V_40 = - V_102 ;
goto V_366;
}
V_2 -> V_6 = F_187 ( & V_100 -> V_22 , V_360 ) ;
if ( F_188 ( V_2 -> V_6 ) ) {
V_40 = F_189 ( V_2 -> V_6 ) ;
goto V_366;
}
V_2 -> V_81 = V_22 ;
V_2 -> V_100 = V_100 ;
V_2 -> V_342 = F_190 ( V_357 ) ;
if ( V_2 -> V_342 < 0 )
V_2 -> V_342 = V_367 ;
if ( F_191 ( V_357 ) ) {
V_40 = F_192 ( V_357 ) ;
if ( V_40 ) {
F_186 ( & V_100 -> V_22 , L_46 ) ;
goto V_366;
}
V_2 -> V_341 = V_357 ;
}
V_358 = F_193 ( V_357 ) ;
if ( ! V_358 || ! F_162 ( V_358 ) ) {
F_194 ( & V_100 -> V_22 , L_47 ) ;
F_195 ( V_22 ) ;
} else {
F_196 ( V_22 -> V_322 , V_358 ) ;
}
F_197 ( V_22 , & V_100 -> V_22 ) ;
F_198 ( & V_100 -> V_22 , V_22 ) ;
V_22 -> V_368 = & V_369 ;
V_22 -> V_370 = & V_371 ;
F_199 ( V_22 , & V_2 -> V_174 , F_91 , 64 ) ;
V_22 -> V_372 |= V_26 | V_373 |
V_33 | V_34 ;
V_2 -> V_103 = 1 ;
V_40 = F_200 ( & V_100 -> V_22 , V_2 -> V_104 ,
F_105 , 0 , V_22 -> V_344 , V_2 ) ;
if ( ! V_40 )
F_201 ( & V_100 -> V_22 , 1 ) ;
F_202 ( sizeof( struct V_219 ) != 8 ) ;
V_22 -> V_374 += sizeof( struct V_219 ) ;
F_203 ( V_22 ) ;
V_40 = F_204 ( V_22 ) ;
if ( V_40 ) {
F_186 ( & V_100 -> V_22 , L_48 ) ;
goto V_375;
}
V_2 -> V_376 = F_205 ( V_2 , V_377 ) & V_378 ;
F_206 ( & V_100 -> V_22 ,
L_49 V_379
L_50 ,
V_2 -> V_4 ? L_51 : L_52 ,
...
static int F_209 ( struct V_351 * V_100 )
{
struct V_21 * V_22 = F_210 ( & V_100 -> V_22 ) ;
struct V_356 * V_357 = V_100 -> V_22 . V_362 ;
F_211 ( V_22 ) ;
if ( F_191 ( V_357 ) )
F_207 ( V_357 ) ;
F_208 ( V_22 ) ;
F_198 ( & V_100 -> V_22 , NULL ) ;
return 0 ;
}
...
static int F_213 ( struct V_98 * V_11 )
{
struct V_21 * V_22 = F_210 ( V_11 ) ;
struct V_1 * V_2 = F_16 ( V_22 ) ;
unsigned int V_57 ;
int V_40 = 0 ;
T_1 V_24 ;
...
F_141 ( V_2 , V_57 ) ;
F_150 ( V_2 ) ;
if ( F_216 ( V_11 ) && V_2 -> V_94 )
V_40 = F_212 ( V_2 ) ;
return V_40 ;
}
static int F_217 ( struct V_98 * V_11 )
{
struct V_21 * V_22 = F_210 ( V_11 ) ;
struct V_1 * V_2 = F_16 ( V_22 ) ;
unsigned int V_57 ;
