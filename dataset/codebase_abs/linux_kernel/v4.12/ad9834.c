...
return V_28 ;
F_14 ( & V_7 -> V_30 ) ;
switch ( ( V_31 ) V_27 -> V_32 ) {
case V_33 :
case V_34 :
V_28 = F_4 ( V_7 , V_27 -> V_32 , V_29 ) ;
break;
case V_35 :
case V_36 :
V_28 = F_8 ( V_7 , V_27 -> V_32 , V_29 ) ;
break;
case V_37 :
if ( V_7 -> V_38 & V_39 ) {
V_28 = - V_10 ;
...
{
struct V_52 * V_53 = F_21 ( & V_12 -> V_19 ) ;
struct V_6 * V_7 ;
struct V_24 * V_25 ;
struct V_54 * V_55 ;
int V_28 ;
...
V_7 -> V_1 = V_53 -> V_1 ;
V_7 -> V_12 = V_12 ;
V_7 -> V_47 = F_31 ( V_12 ) -> V_58 ;
V_7 -> V_55 = V_55 ;
V_25 -> V_19 . V_59 = & V_12 -> V_19 ;
V_25 -> V_60 = F_31 ( V_12 ) -> V_60 ;
switch ( V_7 -> V_47 ) {
case V_48 :
case V_49 :
V_25 -> V_61 = & V_62 ;
...
V_25 -> V_64 = V_65 ;
V_7 -> V_66 . V_67 = & V_7 -> V_16 ;
V_7 -> V_66 . V_23 = 2 ;
F_32 ( & V_7 -> V_17 ) ;
F_33 ( & V_7 -> V_66 , & V_7 -> V_17 ) ;
V_7 -> V_68 [ 0 ] . V_67 = & V_7 -> V_11 [ 0 ] ;
V_7 -> V_68 [ 0 ] . V_23 = 2 ;
V_7 -> V_68 [ 0 ] . V_69 = 1 ;
V_7 -> V_68 [ 1 ] . V_67 = & V_7 -> V_11 [ 1 ] ;
V_7 -> V_68 [ 1 ] . V_23 = 2 ;
F_32 ( & V_7 -> V_13 ) ;
F_33 ( & V_7 -> V_68 [ 0 ] , & V_7 -> V_13 ) ;
F_33 ( & V_7 -> V_68 [ 1 ] , & V_7 -> V_13 ) ;
V_7 -> V_38 = V_70 | V_44 ;
if ( ! V_53 -> V_71 )
V_7 -> V_38 |= V_72 ;
if ( ! V_53 -> V_73 && ( V_7 -> V_47 == V_74 ) )
V_7 -> V_38 |= V_75 ;
V_7 -> V_16 = F_5 ( V_40 | V_7 -> V_38 ) ;
V_28 = F_7 ( V_7 -> V_12 , & V_7 -> V_17 ) ;
if ( V_28 ) {
...
V_28 = F_4 ( V_7 , V_33 , V_53 -> V_76 ) ;
if ( V_28 )
goto V_57;
V_28 = F_4 ( V_7 , V_34 , V_53 -> V_77 ) ;
if ( V_28 )
goto V_57;
V_28 = F_8 ( V_7 , V_35 , V_53 -> V_78 ) ;
if ( V_28 )
goto V_57;
V_28 = F_8 ( V_7 , V_36 , V_53 -> V_79 ) ;
if ( V_28 )
goto V_57;
V_28 = F_34 ( V_25 ) ;
if ( V_28 )
...
static int F_36 ( struct V_51 * V_12 )
{
