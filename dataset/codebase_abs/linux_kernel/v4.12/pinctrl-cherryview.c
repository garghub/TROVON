...
int V_87 , V_41 , V_3 ;
* V_92 = V_130 ;
V_92 -> V_131 = V_2 -> V_17 -> V_132 ;
V_92 -> V_133 = F_66 ( V_2 -> V_42 ) ;
V_92 -> V_134 = V_2 -> V_42 ;
V_92 -> V_96 = - 1 ;
V_92 -> V_135 = V_128 ;
...
for ( V_41 = 0 , V_3 = 0 ; V_41 < V_2 -> V_17 -> V_136 ; V_41 ++ ) {
V_54 = & V_2 -> V_17 -> V_137 [ V_41 ] ;
...
const struct V_138 * V_122 ;
T_2 V_108 ;
V_122 = & V_2 -> V_17 -> V_22 [ V_41 ] ;
V_108 = F_4 ( F_1 ( V_2 , V_122 -> V_90 , V_31 ) ) ;
V_108 &= V_101 ;
V_108 >>= V_102 ;
if ( V_128 && V_108 >= V_2 -> V_17 -> V_139 )
F_70 ( V_41 , V_92 -> V_140 ) ;
}
F_2 ( 0xffff , V_2 -> V_11 + V_103 ) ;
V_87 = F_71 ( V_92 , & V_141 , 0 ,
V_142 , V_106 ) ;
if ( V_87 ) {
F_68 ( V_2 -> V_42 , L_12 ) ;
return V_87 ;
}
F_72 ( V_92 , & V_141 , V_125 ,
F_56 ) ;
return 0 ;
}
static T_5 F_73 ( T_2 V_37 ,
T_6 V_143 , T_2 V_144 , T_7 * V_12 ,
void * V_145 , void * V_146 )
{
...
F_11 ( & V_30 , V_26 ) ;
if ( V_37 == V_148 )
F_2 ( ( T_2 ) ( * V_12 ) , V_2 -> V_11 + ( T_2 ) V_143 ) ;
else if ( V_37 == V_149 )
* V_12 = F_4 ( V_2 -> V_11 + ( T_2 ) V_143 ) ;
else
V_87 = V_150 ;
F_12 ( & V_30 , V_26 ) ;
return V_87 ;
...
T_5 V_157 ;
int V_87 , V_125 , V_41 ;
V_154 = F_75 ( & V_152 -> V_42 ) ;
if ( ! V_154 )
return - V_158 ;
V_2 = F_76 ( & V_152 -> V_42 , sizeof( * V_2 ) , V_159 ) ;
if ( ! V_2 )
return - V_160 ;
for ( V_41 = 0 ; V_41 < F_22 ( V_161 ) ; V_41 ++ )
if ( ! strcmp ( V_154 -> V_162 . V_163 , V_161 [ V_41 ] -> V_164 ) ) {
V_2 -> V_17 = V_161 [ V_41 ] ;
break;
}
if ( V_41 == F_22 ( V_161 ) )
...
V_2 -> V_42 = & V_152 -> V_42 ;
#ifdef F_77
V_2 -> V_165 = F_78 ( V_2 -> V_42 ,
V_2 -> V_17 -> V_23 , sizeof( * V_2 -> V_165 ) ,
V_159 ) ;
if ( ! V_2 -> V_165 )
return - V_160 ;
#endif
V_156 = F_79 ( V_152 , V_166 , 0 ) ;
V_2 -> V_11 = F_80 ( & V_152 -> V_42 , V_156 ) ;
if ( F_81 ( V_2 -> V_11 ) )
return F_82 ( V_2 -> V_11 ) ;
V_125 = F_83 ( V_152 , 0 ) ;
if ( V_125 < 0 ) {
F_68 ( & V_152 -> V_42 , L_13 ) ;
return V_125 ;
}
V_2 -> V_167 = V_168 ;
V_2 -> V_167 . V_21 = F_66 ( & V_152 -> V_42 ) ;
V_2 -> V_167 . V_22 = V_2 -> V_17 -> V_22 ;
V_2 -> V_167 . V_23 = V_2 -> V_17 -> V_23 ;
V_2 -> V_16 = F_84 ( & V_152 -> V_42 , & V_2 -> V_167 ,
V_2 ) ;
if ( F_81 ( V_2 -> V_16 ) ) {
F_68 ( & V_152 -> V_42 , L_14 ) ;
return F_82 ( V_2 -> V_16 ) ;
}
V_87 = F_64 ( V_2 , V_125 ) ;
if ( V_87 )
return V_87 ;
V_157 = F_85 ( V_154 -> V_169 ,
V_2 -> V_17 -> V_170 ,
F_73 ,
NULL , V_2 ) ;
if ( F_86 ( V_157 ) )
F_68 ( & V_152 -> V_42 , L_15 ) ;
F_87 ( V_152 , V_2 ) ;
return 0 ;
}
static int F_88 ( struct V_151 * V_152 )
{
struct V_1 * V_2 = F_89 ( V_152 ) ;
F_90 ( F_75 ( & V_152 -> V_42 ) ,
V_2 -> V_17 -> V_170 ,
F_73 ) ;
return 0 ;
}
static int F_91 ( struct V_171 * V_42 )
{
struct V_151 * V_152 = F_92 ( V_42 ) ;
struct V_1 * V_2 = F_89 ( V_152 ) ;
unsigned long V_26 ;
int V_41 ;
F_11 ( & V_30 , V_26 ) ;
V_2 -> V_172 = F_4 ( V_2 -> V_11 + V_105 ) ;
for ( V_41 = 0 ; V_41 < V_2 -> V_17 -> V_23 ; V_41 ++ ) {
const struct V_138 * V_122 ;
struct V_173 * V_174 ;
void T_1 * V_4 ;
...
continue;
V_174 = & V_2 -> V_165 [ V_41 ] ;
V_4 = F_1 ( V_2 , V_122 -> V_90 , V_31 ) ;
V_174 -> V_175 = F_4 ( V_4 ) & ~ V_94 ;
...
static int F_93 ( struct V_171 * V_42 )
{
struct V_151 * V_152 = F_92 ( V_42 ) ;
struct V_1 * V_2 = F_89 ( V_152 ) ;
unsigned long V_26 ;
