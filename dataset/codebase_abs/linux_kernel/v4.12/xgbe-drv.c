...
if ( V_425 -> type != V_427 )
return - V_265 ;
V_425 -> V_428 -> V_429 = V_430 ;
V_426 = V_425 -> V_428 -> V_431 ;
...
struct V_1 * V_2 = F_72 ( V_30 ) ;
struct V_51 * V_39 = & V_2 -> V_39 ;
T_7 V_435 , V_436 , V_437 , V_438 ;
int V_11 = 0 ;
V_435 = V_2 -> V_439 & V_440 ;
V_436 = V_2 -> V_439 & V_441 ;
V_437 = V_2 -> V_439 & V_442 ;
V_438 = V_2 -> V_439 & V_443 ;
if ( ( V_434 & V_440 ) && ! V_435 )
V_11 = V_39 -> V_444 ( V_2 ) ;
else if ( ! ( V_434 & V_440 ) && V_435 )
V_11 = V_39 -> V_445 ( V_2 ) ;
if ( V_11 )
return V_11 ;
if ( ( V_434 & V_441 ) && ! V_436 )
V_39 -> V_446 ( V_2 ) ;
else if ( ! ( V_434 & V_441 ) && V_436 )
V_39 -> V_447 ( V_2 ) ;
if ( ( V_434 & V_442 ) && ! V_437 )
V_39 -> V_448 ( V_2 ) ;
else if ( ! ( V_434 & V_442 ) && V_437 )
V_39 -> V_449 ( V_2 ) ;
if ( ( V_434 & V_443 ) && ! V_438 )
V_39 -> V_450 ( V_2 ) ;
else if ( ! ( V_434 & V_443 ) && V_438 )
V_39 -> V_451 ( V_2 ) ;
V_2 -> V_439 = V_434 ;
F_42 ( L_68 ) ;
return 0 ;
}
const struct V_452 * F_145 ( void )
{
return & V_453 ;
}
...
V_252 -> V_256 ( V_2 , V_254 ) ;
if ( V_252 -> V_454 ( V_2 , V_32 , V_254 ) )
break;
V_39 -> V_455 ( V_2 , V_254 , V_32 -> V_35 ) ;
V_32 -> V_35 ++ ;
}
F_147 () ;
...
struct V_330 * V_331 ;
T_6 * V_333 ;
V_331 = F_150 ( V_112 , V_254 -> V_458 . V_459 . V_460 ) ;
if ( ! V_331 )
return NULL ;
F_151 ( V_2 -> V_65 , V_254 -> V_458 . V_459 . V_461 ,
V_254 -> V_458 . V_459 . V_462 ,
V_254 -> V_458 . V_459 . V_460 , V_463 ) ;
V_333 = F_152 ( V_254 -> V_458 . V_459 . V_464 . V_465 ) +
V_254 -> V_458 . V_459 . V_464 . V_466 ;
...
struct V_332 * V_333 )
{
if ( ! F_32 ( V_333 -> V_334 , V_467 , V_468 ) )
return 0 ;
if ( V_254 -> V_458 . V_469 )
return V_254 -> V_458 . V_469 ;
if ( ! F_32 ( V_333 -> V_334 , V_467 , V_470 ) )
return V_254 -> V_458 . V_459 . V_460 ;
...
{
if ( ! F_32 ( V_333 -> V_334 , V_467 , V_470 ) )
return V_254 -> V_458 . V_471 . V_460 ;
return V_254 -> V_458 . V_344 - V_344 ;
}
...
if ( V_39 -> V_477 ( V_473 ) ) {
V_347 += V_254 -> V_36 . V_478 ;
V_349 += V_254 -> V_36 . V_479 ;
}
V_252 -> V_256 ( V_2 , V_254 ) ;
V_39 -> V_480 ( V_254 ) ;
V_474 ++ ;
...
static int F_164 ( struct V_3 * V_5 , int V_482 )
{
struct V_1 * V_2 = V_5 -> V_2 ;
struct V_51 * V_39 = & V_2 -> V_39 ;
struct V_6 * V_32 = V_5 -> V_8 ;
...
struct V_330 * V_331 ;
struct V_285 * V_286 ;
unsigned int V_483 , error , V_484 , V_485 ;
unsigned int V_344 , V_486 , V_487 , V_488 ;
...
while ( V_490 < V_482 ) {
F_42 ( L_72 , V_32 -> V_34 ) ;
if ( ! V_489 && V_254 -> V_491 ) {
V_331 = V_254 -> V_492 . V_331 ;
error = V_254 -> V_492 . error ;
V_344 = V_254 -> V_492 . V_344 ;
} else {
memset ( V_333 , 0 , sizeof( * V_333 ) ) ;
V_331 = NULL ;
error = 0 ;
...
V_489 ++ ;
V_32 -> V_34 ++ ;
V_483 = F_32 ( V_333 -> V_334 , V_467 ,
V_470 ) ;
V_484 = F_32 ( V_333 -> V_334 ,
V_467 ,
V_496 ) ;
V_485 = F_32 ( V_333 -> V_334 ,
V_467 ,
V_497 ) ;
if ( ( ! V_483 || V_484 ) && error )
goto V_493;
if ( error || V_333 -> V_498 ) {
if ( V_333 -> V_498 )
F_126 ( V_2 , V_499 , V_30 ,
L_73 ) ;
F_165 ( V_331 ) ;
goto V_500;
}
if ( ! V_485 ) {
V_486 = F_155 ( V_254 , V_333 ) ;
V_344 += V_486 ;
V_487 = F_156 ( V_254 , V_333 , V_344 ) ;
V_344 += V_487 ;
if ( ! V_331 ) {
...
if ( V_487 ) {
F_151 ( V_2 -> V_65 ,
V_254 -> V_458 . V_471 . V_461 ,
V_254 -> V_458 . V_471 . V_462 ,
V_254 -> V_458 . V_471 . V_460 ,
V_463 ) ;
F_166 ( V_331 , F_105 ( V_331 ) -> V_360 ,
V_254 -> V_458 . V_471 . V_464 . V_465 ,
V_254 -> V_458 . V_471 . V_464 . V_466 ,
V_487 ,
V_254 -> V_458 . V_471 . V_460 ) ;
V_254 -> V_458 . V_471 . V_464 . V_465 = NULL ;
}
}
V_501:
if ( ! V_483 || V_484 )
...
if ( ! V_331 )
goto V_500;
V_488 = V_30 -> V_43 + V_45 ;
if ( ! ( V_30 -> V_434 & V_442 ) &&
( V_331 -> V_502 == F_167 ( V_503 ) ) )
V_488 += V_47 ;
if ( V_331 -> V_344 > V_488 ) {
F_126 ( V_2 , V_499 , V_30 ,
L_74 ) ;
F_165 ( V_331 ) ;
goto V_500;
...
if ( F_32 ( V_333 -> V_334 ,
V_467 , V_508 ) )
F_171 ( V_331 , V_333 -> V_509 ,
V_333 -> V_510 ) ;
V_331 -> V_65 = V_30 ;
V_331 -> V_502 = F_172 ( V_331 , V_30 ) ;
F_173 ( V_331 , V_5 -> V_20 ) ;
F_174 ( V_112 , V_331 ) ;
V_500:
V_490 ++ ;
}
if ( V_489 && ( ! V_483 || V_484 ) ) {
V_254 = F_68 ( V_32 , V_32 -> V_34 ) ;
V_254 -> V_491 = 1 ;
V_254 -> V_492 . V_331 = V_331 ;
V_254 -> V_492 . V_344 = V_344 ;
V_254 -> V_492 . error = error ;
}
F_42 ( L_75 , V_490 ) ;
return V_490 ;
}
static int V_231 ( struct V_148 * V_112 , int V_482 )
{
...
F_42 ( L_76 , V_482 ) ;
F_157 ( V_5 ) ;
V_474 = F_164 ( V_5 , V_482 ) ;
if ( ( V_474 < V_482 ) && F_175 ( V_112 , V_474 ) ) {
if ( V_2 -> V_147 )
F_15 ( V_2 , V_5 ) ;
else
F_142 ( V_5 -> V_26 ) ;
...
static int V_233 ( struct V_148 * V_112 , int V_482 )
{
...
F_42 ( L_78 , V_482 ) ;
V_474 = 0 ;
V_511 = V_482 / V_2 -> V_17 ;
do {
V_512 = V_474 ;
V_5 = V_2 -> V_5 ;
for ( V_10 = 0 ; V_10 < V_2 -> V_31 ; V_10 ++ , V_5 ++ ) {
F_157 ( V_5 ) ;
if ( V_511 > ( V_482 - V_474 ) )
V_511 = V_482 - V_474 ;
V_474 += F_164 ( V_5 , V_511 ) ;
}
} while ( ( V_474 < V_482 ) && ( V_474 != V_512 ) );
if ( ( V_474 < V_482 ) && F_175 ( V_112 , V_474 ) ) {
F_16 ( V_2 ) ;
}
F_42 ( L_79 , V_474 ) ;
...
unsigned int V_513 , unsigned int V_9 , unsigned int V_514 )
{
struct V_253 * V_254 ;
struct V_472 * V_473 ;
while ( V_9 -- ) {
V_254 = F_68 ( V_32 , V_513 ) ;
V_473 = V_254 -> V_473 ;
F_176 ( V_2 -> V_30 ,
L_80 , V_513 ,
( V_514 == 1 ) ? L_81 : L_82 ,
...
F_176 ( V_2 -> V_30 ,
L_83 ,
V_513 , F_177 ( V_473 -> V_515 ) , F_177 ( V_473 -> V_516 ) ,
F_177 ( V_473 -> V_517 ) , F_177 ( V_473 -> V_518 ) ) ;
}
void F_129 ( struct V_42 * V_30 , struct V_330 * V_331 , bool V_519 )
{
struct V_520 * V_521 = (struct V_520 * ) V_331 -> V_70 ;
unsigned char * V_471 = V_331 -> V_70 ;
unsigned char V_522 [ 128 ] ;
unsigned int V_10 , V_255 ;
F_176 ( V_30 , L_84 ) ;
F_176 ( V_30 , L_85 ,
( V_519 ? L_86 : L_87 ) , V_331 -> V_344 ) ;
F_176 ( V_30 , L_88 , V_521 -> V_523 ) ;
F_176 ( V_30 , L_89 , V_521 -> V_524 ) ;
F_176 ( V_30 , L_90 , F_179 ( V_521 -> V_525 ) ) ;
for ( V_10 = 0 , V_255 = 0 ; V_10 < V_331 -> V_344 ; ) {
V_255 += snprintf ( V_522 + V_255 , sizeof( V_522 ) - V_255 , L_91 ,
V_471 [ V_10 ++ ] ) ;
if ( ( V_10 % 32 ) == 0 ) {
F_176 ( V_30 , L_92 , V_10 - 32 , V_522 ) ;
V_255 = 0 ;
} else if ( ( V_10 % 16 ) == 0 ) {
V_522 [ V_255 ++ ] = ' ' ;
V_522 [ V_255 ++ ] = ' ' ;
...
if ( V_10 % 32 )
F_176 ( V_30 , L_92 , V_10 - ( V_10 % 32 ) , V_522 ) ;
F_176 ( V_30 , L_84 ) ;
}
