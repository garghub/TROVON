...
void F_220 ( struct V_46 * V_313 , int V_78 )
{
...
memset ( V_2 -> V_48 -> V_326 . V_327 , 0 , V_328 ) ;
V_12 = F_41 ( V_2 , V_4 ) ;
if ( V_12 ) {
F_153 ( L_42 ,
...
{
int V_12 = 0 ;
const char * V_329 = L_45 , * V_330 = L_45 ;
do {
