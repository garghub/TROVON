...
static struct V_1 * F_146 ( char * V_163 , char * V_15 )
{
struct V_3 * V_67 ;
struct V_1 * V_2 ;
V_2 = F_147 ( sizeof( struct V_3 ) , L_51 ,
V_212 , F_145 ) ;
if ( ! V_2 )
return NULL ;
F_148 () ;
if ( F_149 ( V_2 , V_2 -> V_6 ) < 0 )
goto V_213;
V_67 = F_2 ( V_2 ) ;
V_67 -> V_46 = F_135 ( L_52 , V_214 ,
V_215 , V_216 , V_217 ,
V_218 , V_219 , V_127 ) ;
if ( ! V_67 -> V_46 )
goto V_213;
...
static T_5 F_152 ( struct V_221 * V_222 ,
const char * V_14 , T_6 V_162 )
{
char V_163 [ 9 ] ;
char V_15 [ 17 ] ;
...
static T_5 F_155 ( struct V_221 * V_222 ,
const char * V_14 , T_6 V_162 )
{
struct V_10 * V_166 ;
struct V_1 * V_152 ;
...
V_227 = F_125 ( sizeof( struct V_151 ) , V_127 ) ;
if ( ! V_227 ) {
V_53 = - V_33 ;
goto V_231;
}
...
V_227 -> V_177 = & V_178 ;
V_227 -> V_179 = V_180 ;
V_227 -> V_183 = ( void ( * ) ( struct V_151 * ) ) F_67 ;
V_227 -> V_184 = & V_185 ;
V_53 = F_127 ( V_227 ) ;
if ( V_53 ) {
F_128 ( V_227 ) ;
