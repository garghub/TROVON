...
V_43 = F_38 ( & V_4 -> V_2 , & V_4 -> V_21 , false , false ) ;
if ( F_15 ( V_43 != 0 ) )
F_18 ( V_49 -> V_8 , L_4 , V_4 ) ;
return V_43 ;
}
int F_42 ( struct V_3 * V_4 , T_1 V_15 , T_2 * V_77 )
{
int V_43 ;
V_43 = F_43 ( V_4 , false ) ;
if ( V_43 )
return V_43 ;
V_43 = F_36 ( V_4 , V_4 -> type , NULL ) ;
F_44 ( V_4 ) ;
return V_43 ;
}
...
{
struct V_3 * V_4 , * V_79 ;
if ( F_47 ( & V_6 -> V_10 . V_80 ) )
return;
F_18 ( V_6 -> V_49 . V_8 , L_5 ) ;
F_48 (bo, n, &qdev->gem.objects, list) {
F_18 ( V_6 -> V_49 . V_8 , L_6 ,
...
{
return F_57 ( & V_6 -> V_52 . V_53 , V_71 ) ;
}
int F_58 ( struct V_5 * V_6 )
{
return F_57 ( & V_6 -> V_52 . V_53 , V_69 ) ;
}
