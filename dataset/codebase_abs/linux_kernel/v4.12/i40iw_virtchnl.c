...
static void F_18 ( struct V_2 * V_3 , struct V_90 * V_91 , V_38 V_92 )
{
V_91 -> V_66 = V_3 -> V_66 ;
F_19 ( V_91 , ( V_20 ) V_92 , false ) ;
F_20 ( & V_91 -> V_93 ) ;
}
...
if ( ! V_56 &&
( V_98 != V_99 ) ) {
V_6 = F_22 ( V_3 -> V_66 , & V_58 , sizeof( struct V_55 ) +
( sizeof( struct V_103 ) * V_104 ) ) ;
if ( ! V_6 ) {
V_56 = V_58 . V_64 ;
V_56 -> V_105 = false ;
V_56 -> V_76 = V_3 ;
...
V_56 -> V_61 = V_98 ;
V_56 -> V_75 = false ;
V_56 -> V_72 . V_85 = (struct V_103 * ) ( & V_56 [ 1 ] ) ;
F_2 ( V_3 , V_21 ,
L_7 ,
...
L_8 ,
V_42 ) ;
F_10 ( V_3 , V_42 , V_9 , ( V_38 ) V_106 ) ;
return V_47 ;
}
memcpy ( & V_56 -> V_62 . V_9 , V_9 , V_95 ) ;
V_97 . V_107 = F_11 ;
V_97 . V_42 = V_42 ;
V_97 . V_61 = V_56 -> V_61 ;
V_97 . V_108 = V_56 ;
...
V_38 V_95 )
{
struct V_44 * V_45 = (struct V_44 * ) V_94 ;
struct V_4 * V_5 ;
V_5 = (struct V_4 * ) ( V_12 ) V_45 -> V_11 ;
V_5 -> V_6 = (enum V_1 ) V_45 -> V_46 ;
if ( V_95 == ( sizeof( * V_45 ) + V_5 -> V_114 - 1 ) ) {
if ( V_5 -> V_114 && V_5 -> V_115 )
memcpy ( V_5 -> V_115 , V_45 -> V_34 , V_5 -> V_114 ) ;
F_2 ( V_3 , V_21 ,
L_11 , V_22 ,
V_5 -> V_114 ) ;
} else {
F_2 ( V_3 , V_21 ,
L_12 , V_22 ,
V_95 , ( T_1 ) ( sizeof( * V_45 ) + V_5 -> V_114 - 1 ) ) ;
}
return V_47 ;
}
enum V_1 F_27 ( struct V_2 * V_3 ,
T_1 * V_116 )
{
struct V_4 V_5 ;
enum V_1 V_6 ;
...
V_5 . V_3 = V_3 ;
V_5 . V_115 = V_116 ;
V_5 . V_114 = sizeof( * V_116 ) ;
V_5 . V_9 = & V_3 -> V_118 . V_9 ;
V_6 = F_1 ( V_3 , & V_5 ) ;
if ( V_6 ) {
F_2 ( V_3 , V_21 ,
L_13 , V_22 , V_6 ) ;
