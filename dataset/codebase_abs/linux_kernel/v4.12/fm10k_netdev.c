...
static int F_120 ( struct V_68 * V_4 , T_6 V_158 , T_3 V_80 ,
struct V_159 * V_153 )
{
if ( V_153 -> type != V_160 )
return - V_105 ;
V_153 -> V_161 -> V_42 = V_162 ;
return F_111 ( V_4 , V_153 -> V_161 -> V_163 ) ;
}
...
{
struct V_16 * V_17 = F_45 ( V_4 ) ;
struct V_164 * V_165 = V_17 -> V_165 ;
struct V_164 * V_167 = NULL ;
struct V_168 V_169 = { 0 } ;
struct V_41 * V_42 = & V_17 -> V_42 ;
int V_5 = 0 , V_18 ;
T_1 V_47 ;
if ( ! V_165 ) {
if ( V_17 -> V_49 < 7 )
return F_124 ( - V_170 ) ;
V_5 = F_125 ( struct V_164 , V_171 [ 7 ] ) ;
V_165 = F_126 ( V_5 , V_14 ) ;
if ( ! V_165 )
return F_124 ( - V_15 ) ;
V_165 -> V_5 = 7 ;
V_165 -> V_169 = V_17 -> V_47 ;
F_121 ( V_17 , V_165 ) ;
} else if ( ( V_165 -> V_7 == V_172 ) ||
( V_165 -> V_7 == ( V_17 -> V_49 - 1 ) ) ) {
return F_124 ( - V_170 ) ;
} else if ( V_165 -> V_7 == V_165 -> V_5 ) {
V_167 = V_165 ;
V_5 = F_125 ( struct V_164 ,
V_171 [ ( V_165 -> V_5 * 2 ) + 1 ] ) ;
V_165 = F_126 ( V_5 , V_14 ) ;
if ( ! V_165 )
return F_124 ( - V_15 ) ;
...
F_125 ( struct V_164 ,
V_171 [ V_167 -> V_5 ] ) ) ;
V_165 -> V_5 = ( V_167 -> V_5 * 2 ) + 1 ;
F_121 ( V_17 , V_165 ) ;
F_127 ( V_167 , V_173 ) ;
}
for ( V_18 = 0 ; V_18 < V_165 -> V_5 ; V_18 ++ ) {
if ( ! V_165 -> V_171 [ V_18 ] )
break;
}
V_165 -> V_171 [ V_18 ] = V_166 ;
V_165 -> V_7 ++ ;
V_169 . V_174 = V_175 ;
V_169 . V_176 = 1 ;
V_169 . V_177 = F_128 ( V_17 -> V_178 [ V_179 ] . V_43 ) ;
V_169 . V_180 = F_128 ( V_17 -> V_178 [ V_181 ] . V_43 ) ;
V_169 . V_47 = V_17 -> V_47 ;
V_169 . V_182 = F_128 ( V_165 -> V_5 ) ;
V_42 -> V_44 . V_101 . V_183 ( V_42 , & V_169 ) ;
F_82 ( V_17 ) ;
V_47 = V_165 -> V_169 + 1 + V_18 ;
if ( F_75 ( V_17 ) ) {
V_42 -> V_44 . V_101 . V_141 ( V_42 , V_47 ,
V_138 ) ;
V_42 -> V_44 . V_101 . V_102 ( V_42 , V_47 , V_166 -> V_128 ,
0 , true , 0 ) ;
}
F_85 ( V_17 ) ;
return V_166 ;
}
static void F_129 ( struct V_68 * V_4 , void * V_184 )
{
struct V_16 * V_17 = F_45 ( V_4 ) ;
struct V_164 * V_165 = F_107 ( V_17 -> V_165 ) ;
struct V_168 V_169 = { 0 } ;
struct V_41 * V_42 = & V_17 -> V_42 ;
struct V_68 * V_166 = V_184 ;
int V_18 ;
T_1 V_47 ;
if ( ! V_165 )
return;
for ( V_18 = 0 ; V_18 < V_165 -> V_5 ; V_18 ++ ) {
if ( V_165 -> V_171 [ V_18 ] == V_166 )
break;
}
if ( V_18 == V_165 -> V_5 )
return;
...
T_9 V_185 )
{
if ( ! V_30 -> V_186 || F_131 ( V_30 ) )
return V_185 ;
return V_185 & ~ ( V_187 | V_188 ) ;
}
struct V_68 * F_132 ( const struct V_189 * V_190 )
{
T_9 V_191 ;
struct V_16 * V_17 ;
struct V_68 * V_4 ;
V_4 = F_133 ( sizeof( struct V_16 ) , V_192 ) ;
if ( ! V_4 )
return NULL ;
V_4 -> V_193 = & V_194 ;
F_134 ( V_4 ) ;
V_17 = F_45 ( V_4 ) ;
V_17 -> V_195 = F_135 ( V_196 ) - 1 ;
V_4 -> V_185 |= V_197 |
V_198 |
V_199 |
V_200 |
