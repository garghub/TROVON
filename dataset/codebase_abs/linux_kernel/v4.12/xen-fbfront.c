...
V_74 [ V_75 ] = F_32 ( V_92 -> V_100 , L_4 ,
V_74 [ V_75 ] ) ;
V_74 [ V_76 ] = F_32 ( V_92 -> V_100 , L_5 ,
V_74 [ V_76 ] ) ;
V_95 = V_74 [ V_101 ] * 1024 * 1024 ;
if ( V_74 [ V_75 ] * V_74 [ V_76 ] * V_79 / 8
> V_95 ) {
F_33 ( L_6 ,
V_74 [ V_101 ] , V_74 [ V_75 ] ,
V_74 [ V_76 ] ) ;
V_74 [ V_75 ] = V_102 ;
V_74 [ V_76 ] = V_103 ;
V_95 = V_104 ;
...
V_2 -> V_109 = F_37 ( sizeof( unsigned long ) * V_2 -> V_108 ) ;
if ( ! V_2 -> V_109 )
goto V_107;
V_2 -> V_6 = ( void * ) F_38 ( V_97 | V_110 ) ;
if ( ! V_2 -> V_6 )
goto V_107;
V_30 = F_39 ( sizeof( T_1 ) * 256 , NULL ) ;
if ( V_30 == NULL )
goto V_107;
V_30 -> V_57 = V_30 -> V_33 ;
V_30 -> V_33 = V_2 ;
...
F_50 () ;
F_51 (c) {
if ( ! strcmp ( V_131 -> V_133 , L_12 ) && V_131 -> V_38 == 0 )
break;
}
F_52 () ;
if ( V_131 ) {
...
{
struct V_1 * V_2 = F_56 ( & V_92 -> V_92 ) ;
F_57 ( V_2 ) ;
F_43 ( V_2 , V_2 -> V_30 ) ;
return F_44 ( V_92 , V_2 ) ;
}
...
F_59 ( ( unsigned long ) V_2 -> V_6 ) ;
F_60 ( V_2 -> V_109 ) ;
F_60 ( V_2 -> V_106 ) ;
F_61 ( V_2 ) ;
return 0 ;
}
static unsigned long F_62 ( void * V_136 )
{
return F_63 ( F_64 ( V_136 ) ) ;
}
...
V_2 -> V_109 [ V_137 ] = F_62 ( V_2 -> V_106 + V_137 * V_40 ) ;
for ( V_137 = 0 ; V_137 * V_138 < V_2 -> V_108 ; V_137 ++ )
V_2 -> V_6 -> V_139 [ V_137 ] = F_62 ( & V_2 -> V_109 [ V_137 * V_138 ] ) ;
...
V_96 = F_69 ( V_143 , V_92 -> V_147 , L_15 , L_16 ,
F_70 ( V_2 -> V_6 ) ) ;
if ( V_96 )
goto V_148;
V_96 = F_69 ( V_143 , V_92 -> V_147 , L_17 , L_18 ,
V_141 ) ;
if ( V_96 )
goto V_148;
V_96 = F_69 ( V_143 , V_92 -> V_147 , L_19 , L_20 ,
V_149 ) ;
if ( V_96 )
goto V_148;
V_96 = F_69 ( V_143 , V_92 -> V_147 , L_21 , L_22 ) ;
if ( V_96 )
goto V_148;
V_96 = F_71 ( V_143 , 0 ) ;
if ( V_96 ) {
...
static void F_74 ( struct V_91 * V_92 ,
enum V_152 V_153 )
{
struct V_1 * V_2 = F_56 ( & V_92 -> V_92 ) ;
switch ( V_153 ) {
...
if ( V_92 -> V_160 != V_159 )
F_72 ( V_92 , V_159 ) ;
if ( F_32 ( V_2 -> V_105 -> V_100 ,
L_25 , 0 ) )
V_2 -> V_27 = 1 ;
V_2 -> V_73 = F_32 ( V_92 -> V_100 ,
L_26 , 0 ) ;
break;
case V_161 :
if ( V_92 -> V_160 == V_161 )
