...
V_27 -> V_37 = - 1 ;
V_31 . type = V_82 ;
V_31 . V_36 . V_83 . V_80 = V_79 -> V_80 ;
V_31 . V_36 . V_83 . V_81 = V_79 -> V_81 ;
F_49 ( & V_27 -> V_39 ) ;
V_28 = F_1 ( V_27 -> V_33 [ 0 ] ,
& V_31 , sizeof( V_31 ) ) ;
if ( V_28 ) {
...
int V_49 ;
int V_9 = 0 ;
F_24 ( L_32 , V_79 -> V_80 , V_79 -> V_81 ) ;
for ( V_49 = 0 ; V_49 < V_84 ; V_49 ++ ) {
if ( V_79 -> V_85 & ( 1 << V_49 ) ) {
if ( ! V_79 -> V_12 [ V_49 ] ) {
F_24 ( L_34 , V_49 , V_79 -> V_12 [ V_49 ] , V_79 -> V_85 ) ;
V_9 = 0 ;
} else if ( F_48 ( V_79 -> V_12 [ V_49 ] , V_79 ) != 0 ) {
F_8 ( L_35 , V_49 ) ;
V_9 = - 1 ;
} else {
F_24 ( L_36 , V_49 ) ;
...
V_27 -> V_37 = - 1 ;
V_31 . type = V_89 ;
V_31 . V_36 . V_90 . V_86 = V_86 ;
V_31 . V_36 . V_90 . V_87 = V_87 ;
V_31 . V_36 . V_90 . V_88 = V_88 ;
F_49 ( & V_27 -> V_39 ) ;
V_28 = F_1 ( V_27 -> V_33 [ 0 ] ,
& V_31 , sizeof( V_31 ) ) ;
if ( V_28 ) {
...
F_38 ( V_27 -> V_33 [ 0 ] ) ;
if ( V_27 -> V_96 == 0 &&
F_55 ( V_27 -> V_33 [ 0 ] , & V_27 -> V_96 ) == 0 )
F_24 ( L_42 , V_50 , V_27 -> V_96 ) ;
V_31 . type = V_97 ;
V_31 . V_36 . V_98 . V_15 = V_15 ;
V_31 . V_36 . V_98 . V_99 = V_27 -> V_96 < 2 || V_100 ? 0 : 4000 ;
V_31 . V_36 . V_98 . V_41 = V_42 ;
V_31 . V_36 . V_98 . V_43 = V_44 ;
V_31 . V_36 . V_98 . V_101 = V_16 == NULL ;
V_28 = F_1 ( V_27 -> V_33 [ 0 ] ,
& V_31 , sizeof( V_31 ) ) ;
if ( V_28 ) {
F_8 ( L_31 ,
...
if ( ! V_31 . V_36 . V_98 . V_101 ) {
if ( ! V_31 . V_36 . V_98 . V_99 ) {
...
while ( V_15 > 0 ) {
int V_104 = F_57 ( int , V_31 . V_36 . V_98 . V_99 , V_15 ) ;
V_28 = F_1 ( V_27 -> V_33 [ 0 ] ,
V_16 , V_104 ) ;
V_16 = ( char * ) V_16 + V_104 ;
V_15 -= V_104 ;
}
}
if ( V_28 ) {
