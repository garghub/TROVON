...
if ( V_17 )
goto V_361;
if ( F_7 ( V_129 , & V_352 , L_111 , L_105 ) ) {
F_17 ( V_55 | V_311 ,
L_112 ,
V_352 ) ;
switch ( V_352 >> 8 ) {
...
{
int V_374 = 0 ;
if ( ! F_7 ( V_129 , & V_374 , L_130 , L_7 , 0 ) ) {
F_8 ( L_131 ) ;
return - V_50 ;
}
return V_374 ;
...
V_375 > V_306 )
return - V_94 ;
if ( ! F_7 ( V_129 , NULL , L_132 , L_9 , V_375 ) ) {
F_8 ( L_133 ) ;
return - V_50 ;
}
return 0 ;
...
if ( F_6 () )
F_188 ( V_455 ) ;
if ( V_456 && F_7 ( NULL , & V_453 , L_202 , L_64 ) && V_453 )
V_457 = V_456 ;
if ( ! V_457 )
V_458 = V_459 ;
else if ( F_6 () &&
F_7 ( V_457 , & V_460 , L_203 , L_105 ) )
V_458 = V_461 ;
else if ( F_6 () &&
F_7 ( V_457 , & V_460 , L_204 , L_105 ) )
V_458 = V_462 ;
else
V_458 = V_463 ;
F_17 ( V_55 , L_205 ,
...
switch ( V_458 ) {
case V_461 :
if ( ! F_7 ( V_457 , & V_470 , L_203 , L_64 ) )
return - V_50 ;
break;
case V_462 :
case V_463 :
if ( ! F_7 ( V_457 , & V_470 , L_218 , L_64 ) )
return - V_50 ;
break;
default:
return - V_469 ;
...
{
if ( ! F_7 ( V_457 , NULL , L_219 , L_9 , ( V_209 ) ? 1 : 0 ) )
return - V_50 ;
return 0 ;
}
...
if ( V_17 )
return V_17 ;
V_17 = F_7 ( V_457 , NULL , L_222 , L_221 ) ;
break;
default:
return - V_469 ;
}
...
0 : - V_50 ;
case V_462 :
return F_7 ( V_457 , NULL , L_224 , L_221 ) ?
0 : - V_50 ;
case V_463 :
...
T_4 V_30 ;
if ( F_6 () ) {
V_30 = F_18 ( V_192 , L_274 , & V_511 ) ;
if ( F_19 ( V_30 ) )
return V_505 ;
V_30 = F_18 ( V_192 , L_275 , & V_511 ) ;
if ( F_19 ( V_30 ) )
return V_512 ;
}
V_30 = F_18 ( V_192 , L_276 , & V_511 ) ;
if ( F_19 ( V_30 ) )
return V_516 ;
V_511 = NULL ;
return V_528 ;
...
case V_546 :
if ( V_537 <= 7 ) {
snprintf ( V_539 , sizeof( V_539 ) , L_290 , '0' + V_537 ) ;
if ( ! F_7 ( V_192 , NULL , L_291 , L_221 ) )
return - V_50 ;
if ( ! F_7 ( V_192 , & V_157 , V_539 , L_64 ) )
return - V_50 ;
* V_38 = ( V_157 - 2732 ) * 100 ;
return 0 ;
}
...
F_304 ( L_293 , ( int ) ( V_157 . V_551 [ V_42 ] / 1000 ) ) ;
else
F_304 ( L_294 ) ;
}
F_304 ( L_295 ) ;
...
int V_17 ;
F_17 ( V_55 , L_296 ) ;
V_558 = F_7 ( V_192 , NULL , L_297 , L_263 ) ;
if ( V_7 . V_12 ) {
V_556 = V_557 = 0 ;
for ( V_42 = 0 ; V_42 < 8 ; V_42 ++ ) {
...
F_84 ( V_91 , L_304 , V_157 . V_551 [ V_42 ] / 1000 ) ;
F_84 ( V_91 , L_44 , V_157 . V_551 [ V_42 ] / 1000 ) ;
} else
F_84 ( V_91 , L_305 ) ;
return 0 ;
}
...
{
int V_628 ;
if ( ! F_7 ( V_192 , & V_628 , L_354 , L_249 , V_626 )
|| V_628 != V_626 )
F_62 ( L_357 ) ;
}
...
sizeof( V_644 -> V_651 ) ) ;
snprintf ( V_644 -> V_653 , sizeof( V_644 -> V_653 ) , L_364 ,
( V_7 . V_654 ) ?
V_7 . V_654 : L_365 ) ;
snprintf ( V_644 -> V_655 , sizeof( V_644 -> V_655 ) ,
L_366 , V_644 -> V_651 , V_622 ,
( V_7 . V_654 ) ?
V_7 . V_654 : L_367 ) ;
if ( V_615 ) {
V_656 . V_657 = F_352 ;
...
V_678 -- ;
continue;
} else if ( sscanf ( V_159 , L_394 , & V_680 ) == 1 &&
V_680 >= 0 && V_680 <= V_624 ) {
V_678 = V_680 ;
continue;
}
...
case V_692 : {
int V_17 ;
if ( F_142 ( ! F_7 ( V_693 , & V_17 , NULL , L_64 ) ) )
return - V_50 ;
if ( F_140 ( V_30 ) )
* V_30 = V_17 & 0x07 ;
break;
...
case V_703 :
if ( V_56 >= 0 && V_56 <= 7 ) {
if ( ! F_7 ( V_704 , NULL , NULL , L_9 , V_56 ) )
return - V_50 ;
} else
return - V_94 ;
break;
...
V_118 &= 0x07 ;
V_118 |= 4 ;
if ( ! F_7 ( V_704 , NULL , NULL , L_9 , V_118 ) )
V_73 = - V_50 ;
else
V_73 = 0 ;
break;
...
break;
case V_703 :
if ( ! F_7 ( V_704 , NULL , NULL , L_9 , 0x00 ) )
V_73 = - V_50 ;
else
V_690 = 0 ;
break;
...
V_374 = 1 ;
return snprintf ( V_126 , V_102 , L_44 , V_374 ) ;
}
...
if ( V_17 < 0 )
return V_17 ;
return snprintf ( V_126 , V_102 , L_410 , V_697 ) ;
}
...
char * V_126 )
{
return snprintf ( V_126 , V_102 , L_410 , V_711 ) ;
}
...
if ( ! F_7 ( V_129 , & V_738 , V_157 -> V_51 , L_7 ,
