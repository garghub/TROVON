...
F_69 ( V_2 ) ;
if ( V_98 )
F_70 ( & V_2 -> V_27 , & V_98 -> V_27 ) ;
else
F_70 ( & V_2 -> V_27 , & V_15 -> V_28 ) ;
if ( V_15 -> V_122 ) {
F_20 (r, &ops->rules_list, list) {
if ( V_18 -> V_23 == V_75 &&
V_18 -> V_76 == V_2 -> V_16 &&
...
if ( V_2 -> V_6 )
F_73 () ;
F_74 ( V_124 , V_2 , V_15 , V_94 , F_75 ( V_60 ) . V_125 ) ;
F_17 ( V_15 ) ;
F_15 ( V_15 ) ;
return 0 ;
V_114:
...
int F_76 ( struct V_59 * V_60 , struct V_93 * V_94 ,
struct V_95 * V_96 )
{
struct V_32 * V_32 = F_55 ( V_60 -> V_97 ) ;
struct V_83 * V_84 = F_56 ( V_94 ) ;
...
continue;
if ( V_54 [ V_105 ] &&
F_77 ( V_54 [ V_105 ] , V_2 -> V_90 ) )
continue;
if ( V_54 [ V_109 ] &&
F_77 ( V_54 [ V_109 ] , V_2 -> V_92 ) )
continue;
if ( V_54 [ V_110 ] &&
( V_2 -> V_5 != F_59 ( V_54 [ V_110 ] ) ) )
continue;
...
V_127 = NULL ;
F_20 (r, &ops->rules_list, list) {
if ( F_71 ( V_18 -> V_77 ) != V_2 )
continue;
F_72 ( V_18 -> V_77 , V_127 ) ;
if ( ! V_127 )
V_15 -> V_122 ++ ;
}
}
F_74 ( V_128 , V_2 , V_15 , V_94 ,
F_75 ( V_60 ) . V_125 ) ;
F_31 ( V_2 ) ;
F_17 ( V_15 ) ;
F_15 ( V_15 ) ;
...
static inline T_2 F_80 ( struct V_14 * V_15 ,
struct V_1 * V_2 )
{
T_2 V_130 = F_81 ( sizeof( struct V_83 ) )
+ F_82 ( V_91 )
+ F_82 ( V_91 )
+ F_82 ( 4 )
+ F_82 ( 4 )
...
+ F_82 ( 4 )
+ F_83 ( 8 )
+ F_82 ( sizeof( struct V_51 ) ) ;
if ( V_15 -> V_131 )
V_130 += V_15 -> V_131 ( V_2 ) ;
return V_130 ;
}
static int F_84 ( struct V_59 * V_60 , struct V_1 * V_2 ,
T_1 V_132 , T_1 V_133 , int type , int V_7 ,
struct V_14 * V_15 )
{
struct V_93 * V_94 ;
struct V_83 * V_84 ;
V_94 = F_85 ( V_60 , V_132 , V_133 , type , sizeof( * V_84 ) , V_7 ) ;
if ( V_94 == NULL )
return - V_134 ;
V_84 = F_56 ( V_94 ) ;
V_84 -> V_33 = V_15 -> V_33 ;
V_84 -> V_17 = V_2 -> V_17 ;
if ( F_86 ( V_60 , V_135 , V_2 -> V_17 ) )
goto V_136;
if ( F_86 ( V_60 , V_115 , V_2 -> V_9 ) )
goto V_136;
V_84 -> V_137 = 0 ;
V_84 -> V_138 = 0 ;
V_84 -> V_23 = V_2 -> V_23 ;
...
V_84 -> V_7 |= V_139 ;
if ( V_2 -> V_90 [ 0 ] ) {
if ( F_88 ( V_60 , V_105 , V_2 -> V_90 ) )
goto V_136;
if ( V_2 -> V_3 == - 1 )
V_84 -> V_7 |= V_140 ;
}
if ( V_2 -> V_92 [ 0 ] ) {
if ( F_88 ( V_60 , V_109 , V_2 -> V_92 ) )
goto V_136;
if ( V_2 -> V_4 == - 1 )
V_84 -> V_7 |= V_141 ;
}
if ( ( V_2 -> V_16 &&
F_86 ( V_60 , V_104 , V_2 -> V_16 ) ) ||
( V_2 -> V_5 &&
F_86 ( V_60 , V_110 , V_2 -> V_5 ) ) ||
( ( V_2 -> V_69 || V_2 -> V_5 ) &&
F_86 ( V_60 , V_111 , V_2 -> V_69 ) ) ||
( V_2 -> V_76 &&
F_86 ( V_60 , V_117 , V_2 -> V_76 ) ) ||
( V_2 -> V_6 &&
F_89 ( V_60 , V_112 , V_2 -> V_6 , V_142 ) ) ||
( V_2 -> V_71 &&
F_90 ( V_60 , V_113 , V_2 -> V_71 ) ) ||
( F_34 ( & V_2 -> V_10 ) &&
F_40 ( V_60 , & V_2 -> V_10 ) ) )
goto V_136;
if ( V_2 -> V_8 != - 1 ) {
if ( F_86 ( V_60 , V_116 , V_2 -> V_8 ) )
goto V_136;
}
...
goto V_146;
V_36 = F_84 ( V_60 , V_2 , F_75 ( V_144 -> V_60 ) . V_125 ,
...
static int F_94 ( struct V_59 * V_60 , struct V_143 * V_144 )
{
struct V_32 * V_32 = F_55 ( V_60 -> V_97 ) ;
struct V_14 * V_15 ;
int V_145 = 0 , V_33 ;
V_33 = F_95 ( V_144 -> V_94 ) ;
if ( V_33 != V_149 ) {
V_15 = F_10 ( V_32 , V_33 ) ;
if ( V_15 == NULL )
return - V_102 ;
F_93 ( V_60 , V_144 , V_15 ) ;
return V_60 -> V_150 ;
}
F_11 () ;
F_12 (ops, &net->rules_ops, list) {
...
static void F_74 ( int V_151 , struct V_1 * V_2 ,
...
int V_36 = - V_152 ;
V_32 = V_15 -> V_26 ;
V_60 = F_96 ( F_80 ( V_15 , V_2 ) , V_20 ) ;
if ( V_60 == NULL )
goto V_45;
V_36 = F_84 ( V_60 , V_2 , V_132 , V_94 -> V_147 , V_151 , 0 , V_15 ) ;
if ( V_36 < 0 ) {
F_97 ( V_36 == - V_134 ) ;
F_98 ( V_60 ) ;
goto V_45;
}
F_99 ( V_60 , V_32 , V_132 , V_15 -> V_153 , V_94 , V_20 ) ;
return;
V_45:
if ( V_36 < 0 )
F_100 ( V_32 , V_15 -> V_153 , V_36 ) ;
}
...
static void F_102 ( struct V_29 * V_154 , struct V_106 * V_107 )
{
struct V_1 * V_2 ;
F_20 (rule, rules, list) {
...
static int F_103 ( struct V_156 * V_157 , unsigned long V_151 ,
void * V_158 )
{
struct V_106 * V_107 = F_104 ( V_158 ) ;
struct V_32 * V_32 = F_105 ( V_107 ) ;
struct V_14 * V_15 ;
F_106 () ;
switch ( V_151 ) {
case V_159 :
...
static int T_3 F_107 ( struct V_32 * V_32 )
{
F_26 ( & V_32 -> V_46 ) ;
F_108 ( & V_32 -> V_44 ) ;
return 0 ;
...
{
int V_36 ;
F_110 ( V_163 , V_124 , F_54 , NULL , NULL ) ;
F_110 ( V_163 , V_128 , F_76 , NULL , NULL ) ;
F_110 ( V_163 , V_164 , NULL , F_94 , NULL ) ;
V_36 = F_111 ( & V_165 ) ;
if ( V_36 < 0 )
goto V_166;
V_36 = F_112 ( & V_167 ) ;
