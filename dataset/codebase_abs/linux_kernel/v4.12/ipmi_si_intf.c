...
struct V_9 * V_196 , * V_197 ;
F_125 ( & V_195 ) ;
F_129 (e, tmp_e, &smi_infos, link) {
if ( V_196 -> V_70 . V_190 != V_181 )
continue;
if ( V_196 -> V_83 != V_83 )
continue;
if ( V_196 -> V_70 . V_150 == V_149 )
F_128 ( V_196 ) ;
}
F_127 ( & V_195 ) ;
}
...
if ( V_196 -> V_70 . V_190 != V_143 -> V_70 . V_190 )
continue;
if ( V_196 -> V_70 . V_150 == V_143 -> V_70 . V_150 ) {
if ( V_143 -> V_194 && ! V_196 -> V_194 )
V_196 -> V_194 = V_143 -> V_194 ;
return 0 ;
}
}
return 1 ;
...
F_125 ( & V_195 ) ;
F_213 (e, &smi_infos, link) {
if ( V_196 -> V_50 && ( ! type || V_196 -> V_141 == type ) ) {
if ( ! F_126 ( V_196 ) ) {
type = V_196 -> V_141 ;
}
}
...
static void F_128 ( struct V_9 * V_350 )
{
int V_19 = 0 ;
if ( ! V_350 )
return;
