...
F_31 ( & V_42 [ V_52 ] . V_43 , V_10 ) ;
}
return V_86 ;
}
static int F_81 ( struct V_106 * V_107 , unsigned long V_108 , void * V_109 )
{
...
static T_8 int F_87 ( char * V_116 )
{
if ( ! V_116 )
return - V_117 ;
...
static T_8 int F_88 ( char * V_116 )
{
int V_118 ;
if ( ! V_116 )
return - V_117 ;
V_118 = F_89 ( & V_116 , & V_115 ) ;
if ( ! V_118 )
V_115 = 0 ;
return 0 ;
}
static void F_90 ( struct V_3 * V_26 )
{
struct V_3 * V_4 ;
struct V_21 * V_22 ;
unsigned long V_10 ;
...
{
void * V_122 ;
struct V_123 * V_124 = F_93 ( V_125 ) ;
if ( ! V_124 ) {
if ( F_94 ( V_60 ) )
return;
V_122 = F_95 ( V_60 ) + V_39 ;
if ( F_96 ( V_122 ) )
...
void F_99 ( struct V_6 * V_7 , struct V_60 * V_60 , T_6 V_39 ,
...
F_92 ( V_7 , V_60 , V_39 ) ;
if ( ! F_94 ( V_60 ) ) {
void * V_122 = F_95 ( V_60 ) + V_39 ;
F_97 ( V_7 , V_122 , V_25 ) ;
}
F_49 ( V_4 ) ;
}
void F_101 ( struct V_6 * V_7 , T_9 V_145 )
{
struct V_3 V_26 ;
struct V_3 * V_4 ;
struct V_21 * V_22 ;
...
void F_102 ( struct V_6 * V_7 , T_9 V_122 ,
...
void F_103 ( struct V_6 * V_7 , struct V_150 * V_151 ,
...
if ( F_100 ( F_1 () ) )
return;
F_104 (sg, s, mapped_ents, i) {
V_4 = F_53 () ;
if ( ! V_4 )
return;
V_4 -> type = V_120 ;
V_4 -> V_7 = V_7 ;
V_4 -> V_38 = F_46 ( F_105 ( V_153 ) ) ;
V_4 -> V_39 = V_153 -> V_39 ,
V_4 -> V_25 = F_106 ( V_153 ) ;
V_4 -> V_18 = F_107 ( V_153 ) ;
V_4 -> V_31 = V_31 ;
V_4 -> V_32 = V_64 ;
V_4 -> V_154 = V_152 ;
F_92 ( V_7 , F_105 ( V_153 ) , V_153 -> V_39 ) ;
if ( ! F_94 ( F_105 ( V_153 ) ) ) {
F_97 ( V_7 , F_108 ( V_153 ) , F_106 ( V_153 ) ) ;
}
F_49 ( V_4 ) ;
}
}
...
void F_110 ( struct V_6 * V_7 , struct V_150 * V_155 ,
int V_156 , int V_157 )
{
struct V_150 * V_153 ;
int V_152 = 0 , V_52 ;
if ( F_100 ( F_1 () ) )
return;
F_104 (sglist, s, nelems, i) {
struct V_3 V_26 = {
. type = V_120 ,
. V_7 = V_7 ,
. V_38 = F_46 ( F_105 ( V_153 ) ) ,
. V_39 = V_153 -> V_39 ,
. V_18 = F_107 ( V_153 ) ,
. V_25 = F_106 ( V_153 ) ,
. V_31 = V_157 ,
...
break;
if ( ! V_52 )
V_152 = F_109 ( V_7 , & V_26 ) ;
F_90 ( & V_26 ) ;
}
}
void F_111 ( struct V_6 * V_7 , T_6 V_25 ,
...
V_4 -> type = V_119 ;
V_4 -> V_7 = V_7 ;
V_4 -> V_38 = F_46 ( F_112 ( V_158 ) ) ;
V_4 -> V_39 = F_113 ( V_158 ) ;
V_4 -> V_25 = V_25 ;
V_4 -> V_18 = V_145 ;
V_4 -> V_31 = V_143 ;
F_49 ( V_4 ) ;
}
void F_114 ( struct V_6 * V_7 , T_6 V_25 ,
void * V_158 , T_9 V_122 )
{
struct V_3 V_26 = {
. type = V_119 ,
. V_7 = V_7 ,
. V_38 = F_46 ( F_112 ( V_158 ) ) ,
. V_39 = F_113 ( V_158 ) ,
. V_18 = V_122 ,
. V_25 = V_25 ,
. V_31 = V_143 ,
...
void F_115 ( struct V_6 * V_7 , T_2 V_122 , T_6 V_25 ,
int V_31 , T_9 V_145 )
{
struct V_3 * V_4 ;
if ( F_100 ( F_1 () ) )
...
V_4 -> type = V_37 ;
V_4 -> V_7 = V_7 ;
V_4 -> V_38 = F_116 ( V_122 ) ;
V_4 -> V_39 = F_113 ( V_122 ) ;
V_4 -> V_25 = V_25 ;
V_4 -> V_18 = V_145 ;
V_4 -> V_31 = V_31 ;
V_4 -> V_47 = V_121 ;
...
void F_117 ( struct V_6 * V_7 , T_9 V_145 ,
T_6 V_25 , int V_31 )
{
struct V_3 V_26 = {
. type = V_37 ,
...
void F_118 ( struct V_6 * V_7 , T_9 V_159 ,
T_6 V_25 , int V_31 )
{
struct V_3 V_26 ;
if ( F_100 ( F_1 () ) )
...
void F_122 ( struct V_6 * V_7 , struct V_150 * V_151 ,
int V_156 , int V_31 )
{
struct V_150 * V_153 ;
int V_152 = 0 , V_52 ;
...
void F_123 ( struct V_6 * V_7 , struct V_150 * V_151 ,
int V_156 , int V_31 )
{
struct V_150 * V_153 ;
int V_152 = 0 , V_52 ;
...
static int T_8 F_124 ( char * V_116 )
{
int V_52 ;
