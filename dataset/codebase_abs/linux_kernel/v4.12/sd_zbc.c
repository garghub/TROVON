...
void F_35 ( struct V_33 * V_24 )
{
struct V_34 * V_35 = V_24 -> V_34 ;
struct V_1 * V_2 = V_1 ( V_35 -> V_36 ) ;
if ( V_2 -> V_78 ) {
unsigned int V_74 = F_29 ( V_2 , F_13 ( V_35 ) ) ;
F_36 ( ! F_37 ( V_74 , V_2 -> V_78 ) ) ;
F_38 ( V_74 , V_2 -> V_78 ) ;
F_39 () ;
}
}
...
T_1 V_105 ;
V_2 -> V_65 = 0 ;
V_3 = F_46 ( V_106 , V_107 ) ;
if ( ! V_3 )
return - V_108 ;
V_39 = F_4 ( V_2 , V_3 , V_106 , 0 ) ;
if ( V_39 ) {
V_65 = 0 ;
goto V_109;
}
...
V_2 -> V_64 = V_2 -> V_99 >> V_2 -> V_66 ;
if ( V_2 -> V_99 & ( V_2 -> V_65 - 1 ) )
V_2 -> V_64 ++ ;
if ( ! V_2 -> V_78 ) {
