...
static struct V_80 T_3 * * F_56 ( struct V_2 * V_3 ,
unsigned long V_11 )
{
struct V_5 * V_6 = F_2 ( V_3 ) ;
if ( V_11 )
...
* V_107 = V_113 | V_114 ;
V_110 = F_75 ( V_6 -> V_81 ) ;
V_111 = F_76 ( V_86 , V_110 , & V_109 , false ) ;
if ( V_111 >= 0 ) {
#ifdef F_77
switch ( V_111 ) {
case V_115 :
...
static inline int F_78 ( T_2 V_120 , T_2 V_121 )
{
return ( V_122 ) ( V_120 - V_121 ) > 0 ;
}
static inline T_2 F_79 ( T_2 V_123 , unsigned int V_124 )
{
return V_123 & ~ ( ( 1ULL << V_124 ) - 1 ) ;
}
static inline struct V_125 * F_80 ( struct V_5 * V_6 ,
unsigned long V_126 )
{
int V_22 = F_81 ( V_126 ) ;
return & V_6 -> V_40 [ V_22 ] ;
}
static inline unsigned long F_82 ( unsigned long V_126 , int V_127 )
{
return V_126 & ~ ( ( 1UL << V_127 ) - 1 ) ;
}
static int F_83 ( struct V_5 * V_6 , const struct V_125 * V_38 )
{
unsigned int V_128 = F_78 ( V_38 -> V_129 , V_6 -> V_130 ) ;
unsigned long V_131 = F_82 ( V_6 -> V_132 [ V_133 ] , V_38 -> V_22 ) ;
struct V_125 * V_134 ;
if ( V_131 ) {
V_134 = F_80 ( V_6 , V_131 ) ;
if ( F_78 ( V_38 -> V_135 , V_134 -> V_135 ) )
V_128 |= V_136 ;
}
return V_128 ;
}
static inline void F_84 ( struct V_5 * V_6 , unsigned long V_131 ,
int V_137 , int V_138 )
{
V_6 -> V_132 [ V_138 ] |= V_6 -> V_132 [ V_137 ] & V_131 ;
V_6 -> V_132 [ V_137 ] &= ~ V_131 ;
}
static void F_85 ( struct V_5 * V_6 , int V_22 , T_2 V_139 )
{
unsigned long V_131 = F_82 ( V_6 -> V_132 [ V_133 ] , V_22 + 1 ) ;
struct V_125 * V_134 ;
if ( V_131 ) {
V_134 = F_80 ( V_6 , V_131 ) ;
if ( ! F_78 ( V_134 -> V_135 , V_139 ) )
return;
}
V_131 = ( 1UL << V_22 ) - 1 ;
F_84 ( V_6 , V_131 , V_136 , V_133 ) ;
F_84 ( V_6 , V_131 , V_140 , V_141 ) ;
}
...
if ( V_142 != V_143 ) {
unsigned long V_131 ;
int V_145 = F_87 ( V_142 ^ V_143 ) ;
if ( V_145 > 31 )
V_131 = ~ 0UL ;
else
V_131 = ( 1UL << V_145 ) - 1 ;
F_84 ( V_6 , V_131 , V_141 , V_133 ) ;
F_84 ( V_6 , V_131 , V_140 , V_136 ) ;
}
}
static void F_88 ( struct V_125 * V_38 , struct V_25 * V_26 ,
T_2 V_146 )
{
T_2 V_147 = ( V_146 - V_38 -> V_129 ) >> V_38 -> V_148 ;
unsigned int V_39 ;
if ( F_89 ( V_147 > V_149 - 2 ) ) {
...
F_90 ( V_147 , & V_38 -> V_153 ) ;
}
static struct V_25 * F_91 ( struct V_125 * V_38 )
{
return F_92 ( V_38 -> V_152 [ V_38 -> V_151 ] . V_154 ,
struct V_25 , V_134 ) ;
}
static void F_93 ( struct V_125 * V_38 )
{
struct V_25 * V_26 = F_91 ( V_38 ) ;
F_53 ( ! V_26 ) ;
F_94 ( & V_26 -> V_134 ) ;
if ( F_95 ( & V_38 -> V_152 [ V_38 -> V_151 ] ) )
F_96 ( 0 , & V_38 -> V_153 ) ;
}
static struct V_25 * F_97 ( struct V_125 * V_38 )
{
unsigned int V_39 ;
F_10 ( L_7 ,
...
static void F_98 ( struct V_125 * V_38 , T_2 V_146 )
{
...
if ( V_11 -> V_13 -> V_6 . V_14 == 0 )
F_26 ( & V_11 -> V_43 ) ;
else if ( V_11 -> V_73 < F_102 ( V_11 -> V_13 -> V_156 -> V_157 ( V_11 -> V_13 ) ) ) {
V_11 -> V_73 += V_26 -> V_27 ;
...
V_162 = F_79 ( V_26 -> V_135 , V_148 ) ;
V_161 = F_79 ( V_6 -> V_130 , V_148 ) + ( 1ULL << V_148 ) ;
if ( ! F_78 ( V_26 -> V_135 , V_6 -> V_130 ) || F_78 ( V_162 , V_161 ) ) {
V_131 = F_82 ( V_6 -> V_132 [ V_133 ] , V_26 -> V_38 -> V_22 ) ;
if ( V_131 ) {
struct V_125 * V_134 = F_80 ( V_6 , V_131 ) ;
if ( F_78 ( V_162 , V_134 -> V_135 ) ) {
if ( F_78 ( V_161 , V_134 -> V_135 ) )
...
if ( ! V_6 -> V_132 [ V_133 ] )
return NULL ;
V_38 = F_80 ( V_6 , V_6 -> V_132 [ V_133 ] ) ;
V_139 = V_38 -> V_135 ;
V_26 = F_91 ( V_38 ) ;
F_93 ( V_38 ) ;
V_166 = F_97 ( V_38 ) ;
if ( V_166 == NULL )
F_96 ( V_38 -> V_22 , & V_6 -> V_132 [ V_133 ] ) ;
else {
T_2 V_146 = F_79 ( V_166 -> V_129 ,
V_38 -> V_148 ) ;
unsigned int V_167 ;
if ( V_38 -> V_129 == V_146 )
return V_26 ;
...
F_96 ( V_38 -> V_22 , & V_6 -> V_132 [ V_133 ] ) ;
V_167 = F_83 ( V_6 , V_38 ) ;
F_90 ( V_38 -> V_22 , & V_6 -> V_132 [ V_167 ] ) ;
}
F_85 ( V_6 , V_38 -> V_22 , V_139 ) ;
return V_26 ;
}
...
if ( V_56 ) {
V_11 -> V_16 . V_169 ++ ;
return F_117 ( V_86 , V_3 , V_168 ) ;
}
}
V_56 = F_118 ( V_86 , V_11 -> V_13 , V_168 ) ;
if ( F_89 ( V_56 != V_113 ) ) {
F_10 ( L_12 , V_56 ) ;
if ( F_119 ( V_56 ) ) {
V_11 -> V_16 . V_169 ++ ;
...
if ( F_89 ( V_86 == V_11 -> V_13 -> V_156 -> V_157 ( V_11 -> V_13 ) ) &&
...
T_2 V_146 ;
int V_167 ;
V_146 = F_79 ( V_26 -> V_129 , V_38 -> V_148 ) ;
if ( V_38 -> V_153 ) {
if ( ! F_78 ( V_38 -> V_129 , V_26 -> V_129 ) )
goto V_170;
F_98 ( V_38 , V_146 ) ;
F_96 ( V_38 -> V_22 , & V_6 -> V_132 [ V_141 ] ) ;
F_96 ( V_38 -> V_22 , & V_6 -> V_132 [ V_140 ] ) ;
} else if ( ! V_6 -> V_132 [ V_133 ] && F_78 ( V_146 , V_6 -> V_130 ) &&
V_6 -> V_44 == NULL )
V_6 -> V_130 = V_146 ;
V_38 -> V_129 = V_146 ;
V_38 -> V_135 = V_146 + ( 2ULL << V_38 -> V_148 ) ;
...
static void F_122 ( struct V_5 * V_6 , struct V_125 * V_38 ,
struct V_25 * V_26 )
{
unsigned int V_39 , V_171 ;
T_2 V_146 ;
V_146 = F_79 ( V_26 -> V_129 , V_38 -> V_148 ) ;
V_171 = ( V_146 - V_38 -> V_129 ) >> V_38 -> V_148 ;
V_39 = ( V_38 -> V_151 + V_171 ) % V_149 ;
F_94 ( & V_26 -> V_134 ) ;
if ( F_95 ( & V_38 -> V_152 [ V_39 ] ) )
F_96 ( V_171 , & V_38 -> V_153 ) ;
}
...
if ( ! V_38 -> V_153 ) {
F_96 ( V_38 -> V_22 , & V_6 -> V_132 [ V_141 ] ) ;
F_96 ( V_38 -> V_22 , & V_6 -> V_132 [ V_136 ] ) ;
F_96 ( V_38 -> V_22 , & V_6 -> V_132 [ V_140 ] ) ;
if ( F_123 ( V_38 -> V_22 , & V_6 -> V_132 [ V_133 ] ) &&
...
F_96 ( V_38 -> V_22 , & V_6 -> V_132 [ V_133 ] ) ;
} else if ( F_95 ( & V_38 -> V_152 [ V_38 -> V_151 ] ) ) {
V_26 = F_97 ( V_38 ) ;
V_146 = F_79 ( V_26 -> V_129 , V_38 -> V_148 ) ;
if ( V_38 -> V_129 != V_146 ) {
F_96 ( V_38 -> V_22 , & V_6 -> V_132 [ V_133 ] ) ;
...
static int F_125 ( struct V_2 * V_3 , struct V_50 * V_172 )
{
struct V_5 * V_6 = F_2 ( V_3 ) ;
struct V_125 * V_38 ;
int V_39 , V_173 , V_56 ;
...
if ( V_56 < 0 )
return V_56 ;
if ( F_38 ( V_3 ) -> V_177 + 1 > V_178 )
V_176 = V_178 ;
else
V_176 = F_38 ( V_3 ) -> V_177 + 1 ;
V_174 = F_9 ( V_176 ) ;
V_6 -> V_35 = 1 << V_174 ;
V_175 = V_65 + V_174 ;
V_6 -> V_19 = V_179 + V_175 - V_180 ;
for ( V_39 = 0 ; V_39 <= V_180 ; V_39 ++ ) {
V_38 = & V_6 -> V_40 [ V_39 ] ;
V_38 -> V_22 = V_39 ;
V_38 -> V_148 = V_6 -> V_19 + V_39 ;
for ( V_173 = 0 ; V_173 < V_149 ; V_173 ++ )
F_127 ( & V_38 -> V_152 [ V_173 ] ) ;
}
F_127 ( & V_6 -> V_31 ) ;
return 0 ;
}
