...
static void F_37 ( struct V_1 * V_2 , bool V_120 )
{
T_1 V_12 ;
...
{
V_2 -> V_132 . V_193 [ 0 ] . V_194 = V_195 ;
V_2 -> V_132 . V_196 = 1 ;
F_50 ( V_2 ) ;
if ( V_2 -> V_102 & V_197 ) {
T_5 V_12 = F_4 ( V_198 ) ;
V_12 <<= 22 ;
V_2 -> V_132 . V_199 = V_12 ;
} else
V_2 -> V_132 . V_199 = 0 ;
return 0 ;
}
...
T_1 V_200 , T_1 V_101 , T_1 V_201 )
{
T_1 V_202 ;
T_1 V_96 = F_5 ( V_200 , V_203 , V_204 ) ;
T_1 V_205 = F_5 ( V_200 , V_203 ,
V_206 ) ;
char V_207 [ 5 ] = { V_201 >> 24 , ( V_201 >> 16 ) & 0xff ,
( V_201 >> 8 ) & 0xff , V_201 & 0xff , 0 } ;
V_202 = F_5 ( V_200 , V_203 ,
V_208 ) ;
F_16 ( V_2 -> V_29 , L_16 ,
V_205 , V_96 , V_101 ,
F_5 ( V_200 , V_203 ,
V_209 ) ?
L_17 : L_18 , V_207 , V_201 , V_202 ) ;
}
static int F_53 ( int V_210 )
{
switch ( V_210 ) {
case V_211 :
return V_212 ;
...
static int F_54 ( void * V_224 )
{
struct V_1 * V_2 = (struct V_1 * ) V_224 ;
F_55 ( V_2 ) ;
F_56 ( V_2 ) ;
if ( V_2 -> V_102 & V_197 ) {
V_2 -> V_27 . V_225 = V_223 ;
} else {
T_1 V_12 = F_4 ( V_26 ) ;
V_12 &= V_226 ;
V_2 -> V_27 . V_225 = F_53 ( V_12 ) ;
}
return 0 ;
}
static int F_57 ( void * V_224 )
{
struct V_1 * V_2 = (struct V_1 * ) V_224 ;
if ( V_187 != V_188 )
return F_58 ( V_2 , & V_2 -> V_27 . V_227 , 0 ) ;
else
return 0 ;
}
static int F_59 ( void * V_224 )
{
int V_142 ;
int V_228 ;
struct V_1 * V_2 = (struct V_1 * ) V_224 ;
V_142 = F_60 ( V_2 , V_229 , 146 , & V_2 -> V_27 . V_227 ) ;
if ( V_142 )
return V_142 ;
V_142 = F_60 ( V_2 , V_229 , 147 , & V_2 -> V_27 . V_227 ) ;
if ( V_142 )
return V_142 ;
F_61 ( V_2 , 64 ) ;
V_2 -> V_132 . V_133 = V_2 -> V_132 . V_230 << 18 ;
V_2 -> V_27 . V_231 = 0xffffffffffULL ;
V_2 -> V_232 = false ;
V_228 = V_2 -> V_232 ? 32 : 40 ;
V_142 = F_62 ( V_2 -> V_88 , F_63 ( V_228 ) ) ;
if ( V_142 ) {
V_2 -> V_232 = true ;
V_228 = 32 ;
F_23 ( V_2 -> V_29 , L_19 ) ;
}
V_142 = F_64 ( V_2 -> V_88 , F_63 ( V_228 ) ) ;
if ( V_142 ) {
F_64 ( V_2 -> V_88 , F_63 ( 32 ) ) ;
F_23 ( V_2 -> V_29 , L_20 ) ;
}
V_142 = F_11 ( V_2 ) ;
if ( V_142 ) {
...
V_142 = F_49 ( V_2 ) ;
if ( V_142 ) {
F_16 ( V_2 -> V_29 , L_22 , V_142 ) ;
return V_142 ;
}
V_2 -> V_132 . V_233 = true ;
}
return V_142 ;
}
static int F_66 ( void * V_224 )
{
struct V_1 * V_2 = (struct V_1 * ) V_224 ;
if ( V_2 -> V_132 . V_233 ) {
F_51 ( V_2 ) ;
V_2 -> V_132 . V_233 = false ;
}
F_46 ( V_2 ) ;
F_67 ( V_2 ) ;
F_68 ( V_2 ) ;
...
static int F_70 ( void * V_224 )
{
struct V_1 * V_2 = (struct V_1 * ) V_224 ;
F_71 ( V_2 , & V_2 -> V_27 . V_227 , 0 ) ;
F_44 ( V_2 ) ;
return 0 ;
}
static int F_72 ( void * V_224 )
{
struct V_1 * V_2 = (struct V_1 * ) V_224 ;
F_70 ( V_2 ) ;
return 0 ;
}
static int F_73 ( void * V_224 )
{
int V_142 ;
struct V_1 * V_2 = (struct V_1 * ) V_224 ;
V_142 = F_69 ( V_2 ) ;
...
static int F_3 ( void * V_224 )
{
unsigned V_34 ;
T_1 V_12 ;
struct V_1 * V_2 = (struct V_1 * ) V_224 ;
for ( V_34 = 0 ; V_34 < V_2 -> V_53 ; V_34 ++ ) {
V_12 = F_4 ( V_234 ) & ( V_235 |
V_236 |
V_237 |
V_238 |
V_239 ) ;
...
F_16 ( V_2 -> V_29 , L_28 ,
V_200 ) ;
F_52 ( V_2 , V_200 , V_101 , 0 ) ;
}
return 0 ;
}
static int F_81 ( void * V_224 ,
enum V_267 V_249 )
{
return 0 ;
}
static int F_82 ( void * V_224 ,
enum V_268 V_249 )
{
return 0 ;
}
...
{
V_2 -> V_27 . V_227 . V_271 = 1 ;
V_2 -> V_27 . V_227 . V_272 = & V_273 ;
}
