...
F_87 ( V_45 , V_7 ) ;
V_7 -> V_101 = 0 ;
if ( ! F_83 ( V_45 ) || ! ( V_97 = F_88 ( V_45 , V_7 ) ) )
return 0 ;
if ( F_85 ( V_97 ) ) {
if ( F_89 ( V_97 ) == - V_102 ) {
F_72 ( V_103 L_18 ,
...
int F_93 ( struct V_1 * V_45 , struct V_6 * V_7 )
{
int V_88 ;
if ( ! V_7 -> V_101 )
return 0 ;
...
unsigned char * F_95 ( struct V_6 * V_7 , T_4 V_111 , T_6 * V_16 )
{
struct V_112 * V_113 = V_7 -> V_114 -> V_115 ;
struct V_116 * V_116 ;
V_116 = F_96 ( V_113 , ( V_117 ) ( V_111 >> ( V_118 - 9 ) ) , NULL ) ;
if ( ! F_85 ( V_116 ) ) {
if ( F_97 ( V_116 ) )
goto V_119;
V_16 -> V_120 = V_116 ;
return ( unsigned char * ) F_98 ( V_116 ) + ( ( V_111 & ( ( 1 << ( V_118 - 9 ) ) - 1 ) ) << 9 ) ;
V_119:
F_99 ( V_116 ) ;
}
V_16 -> V_120 = NULL ;
