...
if ( ! V_90 )
V_90 = F_44 ( V_46 , V_101 , 0 ) ;
if ( F_40 ( V_90 == NULL ) ) {
F_43 ( & V_46 -> V_33 , L_8 ) ;
return - V_96 ;
}
V_2 -> V_102 = F_45 ( V_90 ) ;
V_2 -> V_90 = F_46 ( & V_46 -> V_33 , V_90 -> V_103 ,
V_2 -> V_102 , V_46 -> V_104 ) ;
if ( F_40 ( ! V_2 -> V_90 ) )
return - V_105 ;
V_2 -> V_5 = F_47 ( & V_46 -> V_33 , V_2 -> V_90 -> V_103 ,
V_2 -> V_102 ) ;
if ( F_40 ( ! V_2 -> V_5 ) )
return - V_106 ;
if ( ! V_46 -> V_33 . V_107 ) {
...
static int T_3 F_62 ( struct V_45 * V_46 )
{
struct V_1 * V_2 = F_26 ( V_46 ) ;
F_14 ( & V_46 -> V_33 , 0 ) ;
F_19 ( & V_46 -> V_33 , 0 ) ;
...
static void F_63 ( struct V_32 * V_33 , int V_42 )
{
struct V_45 * V_46 = F_25 ( V_33 ) ;
struct V_1 * V_2 = F_26 ( V_46 ) ;
F_64 ( V_2 -> V_97 , V_42 ) ;
...
static int T_4 F_65 ( struct V_32 * V_33 )
{
if ( F_66 ( V_33 ) )
F_63 ( V_33 , 1 ) ;
return 0 ;
}
static int T_4 F_67 ( struct V_32 * V_33 )
{
if ( F_66 ( V_33 ) )
F_63 ( V_33 , 0 ) ;
return 0 ;
