...
void F_51 ( struct V_3 * V_4 , int V_68 )
{
struct V_6 * V_7 ;
V_7 = F_3 ( V_4 -> V_12 . V_13 ) ;
if ( F_30 ( V_7 ) ) {
...
case 0 :
F_39 ( V_4 , V_81 ) ;
if ( V_4 -> V_9 -> V_30 . V_117 ) {
F_50 ( & V_4 -> V_9 -> V_82 ,
V_4 -> V_9 -> V_30 . V_117 ) ;
V_4 -> V_9 -> V_30 . V_117 = 0 ;
if ( V_4 -> V_118 )
V_4 -> V_118 ( V_4 , V_4 -> V_9 -> V_119 ,
& V_4 -> V_9 -> V_82 ) ;
memset ( & V_4 -> V_9 -> V_82 , 0 , sizeof( struct V_82 ) ) ;
}
F_48 ( V_4 ) ;
...
if ( F_30 ( V_7 ) )
return - V_114 ;
if ( F_56 ( & V_7 -> V_5 . V_104 ) != 0 )
return - V_123 ;
if ( V_4 -> V_9 -> V_29 != V_81 )
return - V_71 ;
if ( ! V_4 -> V_9 -> V_30 . V_124 ) {
F_39 ( V_4 , V_64 ) ;
return 0 ;
}
V_4 -> V_9 -> V_29 = V_125 ;
...
static void
F_61 ( struct V_3 * V_4 , enum V_90 V_90 )
{
struct V_6 * V_7 ;
if ( V_4 -> V_9 -> V_29 == V_126 ) {
V_4 -> V_9 -> V_30 . V_116 = 1 ;
return;
}
V_7 = F_3 ( V_4 -> V_12 . V_13 ) ;
if ( F_30 ( V_7 ) ) {
...
if ( F_56 ( & V_7 -> V_5 . V_104 ) != 0 ||
( F_62 ( & V_7 -> V_5 . V_104 ) & V_110 ) ||
( F_62 ( & V_4 -> V_9 -> V_82 . V_104 ) & V_110 ) ) {
V_4 -> V_9 -> V_30 . V_116 = 1 ;
return;
}
V_4 -> V_9 -> V_29 = V_122 ;
...
static void
F_65 ( struct V_3 * V_4 , enum V_90 V_90 )
{
struct V_82 * V_82 ;
int V_135 ;
V_82 = F_66 ( & V_136 ) ;
V_135 = ! F_67 ( & V_82 -> V_104 ) ;
if ( ! F_68 ( & V_82 -> V_104 ) ) {
if ( V_135 && ( V_82 -> V_104 . V_24 . V_137 & V_138 ) &&
! V_82 -> V_139 . V_140 . V_141 . V_142 ) {
if ( F_69 ( V_4 , V_82 ) != 0 )
goto V_143;
...
V_143:
if ( V_4 -> V_118 )
V_4 -> V_118 ( V_4 , 0 , V_82 ) ;
if ( V_4 -> V_9 -> V_30 . V_116 )
F_61 ( V_4 , 0 ) ;
return;
}
F_70 ( V_4 , V_82 ) ;
if ( V_135 && V_4 -> V_9 -> V_30 . V_144 ) {
if ( F_69 ( V_4 , V_82 ) == 0 ) {
V_4 -> V_9 -> V_29 = V_126 ;
}
return;
}
if ( F_64 ( V_4 ) && V_4 -> V_9 -> V_30 . V_116 )
F_61 ( V_4 , 0 ) ;
}
static void
F_71 ( struct V_3 * V_4 , enum V_90 V_90 )
{
int V_38 ;
F_14 ( V_4 , 0 ) ;
V_4 -> V_9 -> V_39 = 255 ;
...
if ( F_75 ( & V_82 -> V_104 ) &
( V_148 | V_149 ) ) {
V_4 -> V_9 -> V_30 . V_144 = 0 ;
memset ( & V_4 -> V_9 -> V_82 , 0 , sizeof( struct V_82 ) ) ;
F_70 ( V_4 , V_82 ) ;
goto V_150;
}
F_76 ( V_4 , V_82 ) ;
if ( V_4 -> V_9 -> V_30 . V_144 ) {
F_69 ( V_4 , V_82 ) ;
return;
}
V_150:
...
static void
F_77 ( struct V_3 * V_4 , enum V_90 V_90 )
{
F_14 ( V_4 , 0 ) ;
F_61 ( V_4 , 0 ) ;
if ( V_4 -> V_118 )
...
static void
F_78 ( struct V_3 * V_4 , enum V_90 V_90 )
{
int V_38 ;
V_38 = F_19 ( V_4 ) ;
if ( V_38 == - V_123 ) {
...
static void
F_81 ( struct V_3 * V_4 , enum V_90 V_90 )
{
struct V_6 * V_7 ;
V_7 = F_3 ( V_4 -> V_12 . V_13 ) ;
...
static void
F_86 ( struct V_3 * V_4 , enum V_90 V_90 )
{
F_87 ( V_4 ) ;
V_4 -> V_9 -> V_29 = V_81 ;
F_12 ( V_4 , V_90 ) ;
...
static void
F_90 ( struct V_3 * V_4 , enum V_90 V_90 )
{
F_14 ( V_4 , 0 ) ;
V_4 -> V_9 -> V_29 = V_56 ;
F_31 ( & V_4 -> V_9 -> V_62 ) ;
...
static void
F_91 ( struct V_3 * V_4 , enum V_90 V_90 )
{
int V_38 ;
V_38 = F_19 ( V_4 ) ;
if ( V_38 == - V_123 ) {
