...
F_235 ( int V_103 , int V_88 , int V_89 )
{
struct V_170 * V_171 ;
...
if ( ! V_79 ) {
struct V_170 * V_271 ;
V_271 = F_235 ( V_32 -> V_103 , V_88 , V_89 ) ;
if ( V_271 ) {
V_79 = V_271 -> V_42 ;
V_271 -> V_96 = V_96 ;
}
...
F_241 ( & V_171 -> V_266 , & V_42 -> V_107 ) ;
F_241 ( & V_171 -> V_267 , & V_272 ) ;
if ( V_96 )
V_96 -> V_97 . V_32 = V_171 ;
F_106 ( & V_172 , V_33 ) ;
if ( V_96 && F_215 ( V_42 , V_96 ) ) {
F_123 ( L_32 , F_242 ( V_96 ) ) ;
F_243 ( V_42 , V_96 ) ;
return NULL ;
}
return V_42 ;
}
static int F_244 ( struct V_100 * V_102 , T_4 V_237 , void * V_238 )
{
* ( T_4 * ) V_238 = V_237 ;
return 0 ;
}
static struct V_39 * F_245 ( struct V_95 * V_96 , int V_135 )
{
struct V_170 * V_171 = NULL ;
...
F_216 ( V_102 , F_244 , & V_274 ) ;
F_105 ( & V_172 , V_33 ) ;
V_171 = F_235 ( F_98 ( V_102 -> V_88 ) ,
F_214 ( V_274 ) ,
V_274 & 0xff ) ;
if ( V_171 ) {
V_32 = V_171 -> V_32 ;
...
static struct V_39 * F_246 ( struct V_95 * V_96 ,
struct V_39 * V_42 )
{
struct V_31 * V_32 ;
struct V_39 * V_99 ;
...
F_216 ( V_102 , F_244 , & V_274 ) ;
if ( V_273 != V_274 ) {
V_99 = F_236 ( V_32 , F_214 ( V_274 ) ,
V_274 & 0xff , NULL , V_42 ) ;
if ( ! V_99 || V_99 != V_42 )
return V_99 ;
}
}
V_99 = F_236 ( V_32 , V_88 , V_89 , V_96 , V_42 ) ;
if ( ! V_99 || V_99 != V_42 )
return V_99 ;
return V_42 ;
}
static struct V_39 * F_247 ( struct V_95 * V_96 , int V_135 )
{
struct V_39 * V_42 , * V_99 ;
V_42 = F_234 ( V_96 ) ;
if ( V_42 )
goto V_108;
V_42 = F_245 ( V_96 , V_135 ) ;
if ( ! V_42 )
goto V_108;
V_99 = F_246 ( V_96 , V_42 ) ;
if ( ! V_99 || V_42 != V_99 ) {
F_181 ( V_42 ) ;
V_42 = V_99 ;
}
...
static int F_249 ( struct V_95 * V_96 ,
struct V_39 * V_42 ,
unsigned long long V_221 ,
unsigned long long V_112 )
{
...
return F_248 ( V_42 , V_221 , V_112 ) ;
}
static int F_253 ( struct V_95 * V_96 ,
unsigned long long V_221 ,
unsigned long long V_112 )
{
struct V_39 * V_42 ;
int V_84 ;
V_42 = F_247 ( V_96 , V_73 ) ;
if ( ! V_42 )
return - V_140 ;
V_84 = F_249 ( V_96 , V_42 , V_221 , V_112 ) ;
if ( V_84 )
F_181 ( V_42 ) ;
return V_84 ;
}
static inline int F_254 ( struct V_282 * V_283 ,
struct V_95 * V_96 )
{
if ( V_96 -> V_97 . V_32 == V_98 )
return 0 ;
return F_253 ( V_96 , V_283 -> V_284 ,
V_283 -> V_285 ) ;
}
...
struct V_100 * V_102 ;
int V_84 ;
V_102 = F_256 ( V_286 << 8 , NULL ) ;
if ( ! V_102 )
return;
F_48 ( L_40 ) ;
V_84 = F_253 ( & V_102 -> V_96 , 0 , 16 * 1024 * 1024 - 1 ) ;
if ( V_84 )
F_123 ( L_41 ) ;
F_257 ( V_102 ) ;
}
...
static int T_3 F_258 ( int V_287 )
{
int V_123 , V_84 = 0 ;
V_277 = F_186 ( V_67 ) ;
if ( ! V_277 )
...
static int F_263 ( struct V_95 * V_96 )
{
struct V_170 * V_171 ;
if ( F_264 ( ! V_53 ) )
return 0 ;
...
if ( ! V_32 )
return - V_216 ;
V_289 = F_236 ( V_32 , V_88 , V_89 , V_96 , V_42 ) ;
if ( V_289 != V_42 )
return - V_290 ;
return 0 ;
}
...
V_108:
if ( ! V_42 )
F_123 ( L_59 , F_242 ( V_96 ) ) ;
return V_42 ;
}
static inline struct V_39 * F_312 ( struct V_95 * V_96 )
{
struct V_170 * V_171 ;
V_171 = V_96 -> V_97 . V_32 ;
if ( F_264 ( V_171 ) )
...
static int F_313 ( struct V_95 * V_96 )
{
int V_79 ;
if ( F_93 ( V_96 ) )
return 1 ;
...
static V_261 F_314 ( struct V_95 * V_96 , T_1 V_341 ,
...
error:
if ( V_339 )
F_316 ( & V_42 -> V_222 , V_339 , F_12 ( V_59 ) ) ;
F_123 ( L_62 ,
F_242 ( V_96 ) , V_59 , ( unsigned long long ) V_341 , V_342 ) ;
return 0 ;
}
static V_261 F_317 ( struct V_95 * V_96 , struct V_14 * V_14 ,
unsigned long V_119 , T_5 V_59 ,
enum V_349 V_342 ,
unsigned long V_350 )
{
return F_314 ( V_96 , F_223 ( V_14 ) + V_119 , V_59 ,
V_342 , * V_96 -> V_297 ) ;
}
static void F_318 ( struct V_326 * V_351 )
{
int V_80 , V_352 ;
V_351 -> V_353 = 0 ;
...
static void F_319 ( struct V_39 * V_41 , unsigned long V_339 ,
...
V_92 -> V_136 = V_136 ;
if ( ! V_351 -> V_353 ) {
F_322 ( & V_351 -> V_332 , V_360 + F_323 ( 10 ) ) ;
V_351 -> V_353 = 1 ;
}
V_351 -> V_59 ++ ;
F_106 ( & V_351 -> V_115 , V_33 ) ;
...
static void F_325 ( struct V_95 * V_96 , V_261 V_361 , T_5 V_59 )
{
struct V_39 * V_42 ;
...
V_130 = V_129 + V_338 - 1 ;
F_143 ( L_63 ,
F_242 ( V_96 ) , V_129 , V_130 ) ;
V_136 = F_120 ( V_42 , V_129 , V_130 ) ;
if ( V_48 ) {
F_161 ( V_32 , V_42 , V_129 ,
V_338 , ! V_136 , 0 ) ;
F_316 ( & V_42 -> V_222 , V_339 , F_12 ( V_338 ) ) ;
F_121 ( V_136 ) ;
} else {
F_319 ( V_42 , V_339 , V_338 , V_136 ) ;
}
}
static void F_326 ( struct V_95 * V_96 , V_261 V_361 ,
T_5 V_59 , enum V_349 V_342 ,
unsigned long V_350 )
{
F_325 ( V_96 , V_361 , V_59 ) ;
}
static void * F_327 ( struct V_95 * V_96 , T_5 V_59 ,
...
V_14 = F_330 ( V_96 , V_206 , V_363 , V_33 ) ;
if ( V_14 && F_313 ( V_96 ) &&
F_223 ( V_14 ) + V_59 > V_96 -> V_298 ) {
F_331 ( V_96 , V_14 , V_206 ) ;
V_14 = NULL ;
}
}
if ( ! V_14 )
V_14 = F_332 ( V_33 , V_363 ) ;
if ( ! V_14 )
return NULL ;
memset ( F_56 ( V_14 ) , 0 , V_59 ) ;
* V_362 = F_314 ( V_96 , F_223 ( V_14 ) , V_59 ,
V_347 ,
V_96 -> V_298 ) ;
if ( * V_362 )
return F_56 ( V_14 ) ;
if ( ! F_331 ( V_96 , V_14 , V_59 >> V_11 ) )
F_333 ( V_14 , V_363 ) ;
return NULL ;
}
static void F_334 ( struct V_95 * V_96 , T_5 V_59 , void * V_62 ,
...
V_59 = F_220 ( V_59 ) ;
V_363 = F_328 ( V_59 ) ;
F_325 ( V_96 , V_362 , V_59 ) ;
if ( ! F_331 ( V_96 , V_14 , V_59 >> V_11 ) )
F_333 ( V_14 , V_363 ) ;
}
static void F_335 ( struct V_95 * V_96 , struct V_249 * V_366 ,
int V_367 , enum V_349 V_342 ,
unsigned long V_350 )
{
V_261 V_368 = F_336 ( V_366 ) & V_242 ;
unsigned long V_338 = 0 ;
struct V_249 * V_250 ;
int V_80 ;
F_337 (sglist, sg, nelems, i) {
V_338 += F_219 ( F_336 ( V_250 ) , F_338 ( V_250 ) ) ;
}
F_325 ( V_96 , V_368 , V_338 << V_12 ) ;
}
static int F_339 ( struct V_95 * V_369 ,
...
static int F_340 ( struct V_95 * V_96 , struct V_249 * V_366 , int V_367 ,
...
F_75 ( V_342 == V_345 ) ;
if ( F_313 ( V_96 ) )
return F_339 ( V_96 , V_366 , V_367 , V_342 ) ;
V_42 = F_312 ( V_96 ) ;
if ( ! V_42 )
return 0 ;
V_32 = F_74 ( V_42 ) ;
...
static int F_341 ( struct V_95 * V_96 , V_261 V_371 )
{
return ! V_371 ;
}
...
static void F_350 ( struct V_100 * V_102 )
{
struct V_77 * V_78 ;
T_2 V_374 ;
int V_375 ;
V_375 = F_351 ( V_102 -> V_88 , F_352 ( 0 , 0 ) , 0xb0 , & V_374 ) ;
if ( V_375 ) {
F_353 ( & V_102 -> V_96 , L_68 ) ;
return;
}
V_374 &= 0xffff0000 ;
V_78 = F_354 ( V_102 ) ;
if ( F_355 ( ! V_78 || V_78 -> V_376 - V_374 != 0xa000 ,
V_377 ,
L_69 ) )
...
int T_3 F_366 ( struct V_392 * V_393 , void * V_394 )
{
struct V_395 * V_283 ;
...
V_396 -> V_398 = F_367 ( V_283 -> V_284 , V_259 , V_253 ,
V_399 ) ;
if ( ! V_396 -> V_398 )
goto V_400;
V_396 -> V_107 = F_368 ( ( void * ) ( V_283 + 1 ) ,
( ( void * ) V_283 ) + V_283 -> V_393 . V_259 ,
& V_396 -> V_378 ) ;
if ( V_396 -> V_378 && V_396 -> V_107 == NULL )
goto V_401;
F_241 ( & V_396 -> V_402 , & V_403 ) ;
return 0 ;
V_401:
F_176 ( V_396 -> V_398 ) ;
V_400:
...
static struct V_404 * F_369 ( struct V_405 * V_406 )
{
struct V_404 * V_407 ;
struct V_405 * V_99 ;
F_370 (atsru, &dmar_atsr_units, list) {
...
int F_371 ( struct V_392 * V_397 , void * V_394 )
{
struct V_405 * V_406 ;
struct V_404 * V_407 ;
...
if ( ! V_407 -> V_113 ) {
V_407 -> V_107 = F_368 ( ( void * ) ( V_406 + 1 ) ,
...
F_372 ( & V_407 -> V_402 , & V_411 ) ;
return 0 ;
}
static void F_373 ( struct V_404 * V_407 )
{
F_374 ( & V_407 -> V_107 , & V_407 -> V_378 ) ;
F_176 ( V_407 ) ;
}
int F_375 ( struct V_392 * V_397 , void * V_394 )
{
struct V_405 * V_406 ;
struct V_404 * V_407 ;
V_406 = F_46 ( V_397 , struct V_405 , V_393 ) ;
...
int F_378 ( struct V_392 * V_397 , void * V_394 )
{
int V_80 ;
struct V_95 * V_96 ;
struct V_405 * V_406 ;
...
static int F_379 ( struct V_77 * V_412 )
{
int V_413 , V_84 = 0 ;
...
int F_380 ( struct V_77 * V_412 , bool V_416 )
{
int V_84 = 0 ;
struct V_31 * V_32 = V_412 -> V_32 ;
if ( ! V_410 )
...
continue;
F_382 (atsru->devices, atsru->devices_cnt, i, tmp)
if ( V_99 == & V_420 -> V_96 )
goto V_108;
if ( V_407 -> V_113 )
goto V_108;
...
return 0 ;
F_243 ( V_42 , V_96 ) ;
if ( ! F_67 ( V_42 ) && F_387 ( & V_42 -> V_107 ) )
F_181 ( V_42 ) ;
return 0 ;
}
static int F_388 ( struct V_427 * V_428 ,
...
struct V_31 * V_32 ;
struct V_14 * V_136 ;
V_208 = F_389 ( & V_277 -> V_222 , V_370 ) ;
if ( V_208 == NULL ) {
F_143 ( L_76 ,
V_370 ) ;
break;
}
V_208 = F_390 ( & V_277 -> V_222 , V_208 ,
V_370 , V_276 ) ;
if ( V_208 == NULL ) {
F_250 ( L_77 ,
V_370 , V_276 ) ;
...
static void F_393 ( unsigned int V_226 )
{
int V_80 ;
for ( V_80 = 0 ; V_80 < V_75 ; V_80 ++ ) {
struct V_31 * V_32 = V_76 [ V_80 ] ;
...
if ( ! V_42 )
continue;
F_394 ( V_226 , & V_42 -> V_222 ) ;
}
}
}
static int F_395 ( unsigned int V_226 )
{
F_393 ( V_226 ) ;
F_205 ( V_226 ) ;
return 0 ;
...
static inline struct V_31 * F_397 ( struct V_95 * V_96 )
{
return F_46 ( V_96 , struct V_31 , V_32 . V_96 ) ;
}
static T_9 F_398 ( struct V_95 * V_96 ,
struct V_440 * V_441 ,
char * V_442 )
{
struct V_31 * V_32 = F_397 ( V_96 ) ;
T_2 V_443 = F_44 ( V_32 -> V_36 + V_444 ) ;
return sprintf ( V_442 , L_78 ,
F_399 ( V_443 ) , F_400 ( V_443 ) ) ;
}
...
{
struct V_31 * V_32 = F_397 ( V_96 ) ;
return sprintf ( V_442 , L_79 , V_32 -> V_445 ) ;
}
...
{
struct V_31 * V_32 = F_397 ( V_96 ) ;
return sprintf ( V_442 , L_79 , V_32 -> V_72 ) ;
}
...
{
struct V_31 * V_32 = F_397 ( V_96 ) ;
return sprintf ( V_442 , L_79 , V_32 -> V_82 ) ;
}
...
{
struct V_31 * V_32 = F_397 ( V_96 ) ;
return sprintf ( V_442 , L_80 , F_171 ( V_32 -> V_72 ) ) ;
}
static T_9 F_405 ( struct V_95 * V_96 ,
struct V_440 * V_441 ,
char * V_442 )
{
struct V_31 * V_32 = F_397 ( V_96 ) ;
return sprintf ( V_442 , L_81 , F_406 ( V_32 -> V_198 ,
F_171 ( V_32 -> V_72 ) ) ) ;
}
int T_3 F_407 ( void )
{
...
F_364 () ;
F_80 (iommu, drhd) {
F_414 ( & V_32 -> V_32 , NULL ,
V_453 ,
L_91 , V_32 -> V_139 ) ;
F_415 ( & V_32 -> V_32 , & V_454 ) ;
F_416 ( & V_32 -> V_32 ) ;
}
F_417 ( & V_455 , & V_454 ) ;
F_418 ( & V_455 , & V_456 ) ;
...
static int F_421 ( struct V_100 * V_102 , T_4 V_237 , void * V_238 )
{
struct V_31 * V_32 = V_238 ;
F_231 ( V_32 , F_214 ( V_237 ) , V_237 & 0xff ) ;
return 0 ;
}
static void F_422 ( struct V_31 * V_32 , struct V_95 * V_96 )
{
if ( ! V_32 || ! V_96 || ! F_95 ( V_96 ) )
return;
F_216 ( F_96 ( V_96 ) , & F_421 , V_32 ) ;
}
...
static int F_259 ( struct V_39 * V_42 , int V_223 )
{
int V_224 ;
F_193 ( & V_42 -> V_222 , V_124 , V_210 ,
V_211 ) ;
...
static struct V_40 * F_423 ( unsigned type )
{
struct V_39 * V_39 ;
struct V_40 * V_42 ;
if ( type != V_460 )
...
V_42 = & V_39 -> V_42 ;
V_42 -> V_461 . V_462 = 0 ;
V_42 -> V_461 . V_463 = F_424 ( V_39 -> V_135 ) ;
V_42 -> V_461 . V_464 = true ;
return V_42 ;
}
static void F_425 ( struct V_40 * V_42 )
{
F_181 ( F_45 ( V_42 ) ) ;
}
static int F_426 ( struct V_40 * V_42 ,
struct V_95 * V_96 )
{
...
if ( V_39 -> V_459 > ( 1LL << V_68 ) ) {
F_123 ( L_96
L_97 ,
V_467 , V_68 , V_39 -> V_459 ) ;
return - V_288 ;
}
V_39 -> V_135 = V_68 ;
...
static void F_428 ( struct V_40 * V_42 ,
struct V_95 * V_96 )
{
F_243 ( F_45 ( V_42 ) , V_96 ) ;
}
static int F_429 ( struct V_40 * V_42 ,
unsigned long V_208 , T_1 V_468 ,
T_5 V_59 , int V_469 )
{
struct V_39 * V_39 = F_45 ( V_42 ) ;
V_24 V_459 ;
...
if ( V_469 & V_471 )
V_253 |= V_126 ;
if ( ( V_469 & V_472 ) && V_39 -> V_86 )
V_253 |= V_258 ;
V_459 = V_208 + V_59 ;
if ( V_39 -> V_459 < V_459 ) {
V_24 V_112 ;
V_112 = F_424 ( V_39 -> V_135 ) + 1 ;
if ( V_112 < V_459 ) {
F_123 ( L_96
L_97 ,
V_467 , V_39 -> V_135 , V_459 ) ;
return - V_288 ;
}
V_39 -> V_459 = V_459 ;
}
V_59 = F_219 ( V_468 , V_59 ) ;
V_84 = F_230 ( V_39 , V_208 >> V_12 ,
V_468 >> V_12 , V_59 , V_253 ) ;
return V_84 ;
}
static T_5 F_430 ( struct V_40 * V_42 ,
...
F_121 ( V_136 ) ;
if ( V_39 -> V_459 == V_208 + V_59 )
V_39 -> V_459 = V_208 ;
return V_59 ;
}
static T_1 F_431 ( struct V_40 * V_42 ,
V_261 V_208 )
{
struct V_39 * V_39 = F_45 ( V_42 ) ;
struct V_27 * V_28 ;
...
static bool F_432 ( enum V_475 V_72 )
{
if ( V_72 == V_476 )
return F_82 ( NULL ) == 1 ;
if ( V_72 == V_477 )
...
static int F_433 ( struct V_95 * V_96 )
{
struct V_31 * V_32 ;
struct V_479 * V_480 ;
T_6 V_88 , V_89 ;
...
static void F_439 ( struct V_95 * V_96 )
{
struct V_31 * V_32 ;
T_6 V_88 , V_89 ;
V_32 = F_94 ( V_96 , & V_88 , & V_89 ) ;
...
return;
F_440 ( V_96 ) ;
F_441 ( & V_32 -> V_32 , V_96 ) ;
}
static void F_442 ( struct V_95 * V_95 ,
struct V_481 * V_482 )
{
struct V_483 * V_36 ;
struct V_282 * V_283 ;
...
if ( ! V_36 )
return;
F_443 ( & V_36 -> V_402 , V_482 ) ;
}
static void F_444 ( struct V_95 * V_96 ,
struct V_481 * V_482 )
{
struct V_483 * V_92 , * V_134 ;
F_179 (entry, next, head, list) {
if ( V_92 -> type == V_485 )
F_176 ( V_92 ) ;
}
}
static inline unsigned long F_445 ( struct V_31 * V_32 )
{
if ( F_446 ( V_32 -> V_82 ) < 5 )
return 0 ;
return F_447 ( ( unsigned long * ) & V_32 -> V_486 ,
V_487 ) - 5 ;
}
int F_448 ( struct V_31 * V_32 , struct V_488 * V_489 )
{
struct V_170 * V_171 ;
struct V_22 * V_23 ;
struct V_39 * V_42 ;
...
V_24 V_490 ;
int V_84 ;
V_42 = F_312 ( V_489 -> V_96 ) ;
if ( ! V_42 )
return - V_44 ;
F_105 ( & V_172 , V_33 ) ;
F_211 ( & V_32 -> V_115 ) ;
V_84 = - V_44 ;
V_171 = V_489 -> V_96 -> V_97 . V_32 ;
...
goto V_108;
V_490 = V_23 [ 0 ] . V_19 ;
V_489 -> V_56 = V_42 -> V_187 [ V_32 -> V_188 ] ;
V_489 -> V_182 = F_449 ( V_171 -> V_88 , V_171 -> V_89 ) ;
if ( ! ( V_490 & V_491 ) ) {
V_23 [ 1 ] . V_21 = ( V_24 ) F_92 ( V_32 -> V_492 ) ;
V_23 [ 1 ] . V_19 = ( V_24 ) F_92 ( V_32 -> V_493 ) |
F_445 ( V_32 ) ;
F_450 () ;
if ( ( V_490 & V_494 ) == ( V_230 << 2 ) ) {
V_490 &= ~ V_494 ;
if ( V_171 -> V_174 )
V_490 |= V_495 << 2 ;
else
...
V_23 [ 0 ] . V_19 = V_490 ;
F_450 () ;
V_32 -> V_189 . V_233 ( V_32 , V_489 -> V_56 , V_489 -> V_182 ,
V_234 ,
V_158 ) ;
}
if ( ! V_171 -> V_178 )
...
if ( V_171 -> V_176 ) {
V_489 -> V_499 = 1 ;
V_489 -> V_183 = V_171 -> V_181 ;
if ( V_489 -> V_183 >= V_500 )
V_489 -> V_183 = 0 ;
}
V_84 = 0 ;
V_108:
...
struct V_31 * F_451 ( struct V_95 * V_96 )
{
struct V_31 * V_32 ;
T_6 V_88 , V_89 ;
if ( F_93 ( V_96 ) ) {
...
static void F_454 ( struct V_100 * V_96 )
{
unsigned short V_501 ;
if ( F_455 ( V_96 , V_502 , & V_501 ) )
return;
if ( ! ( V_501 & V_503 ) ) {
F_48 ( L_103 ) ;
V_46 = 0 ;
...
struct V_100 * V_102 ;
T_10 V_504 ;
V_102 = F_456 ( V_505 , 0x3a3e , NULL ) ;
if ( ! V_102 )
return;
F_257 ( V_102 ) ;
V_102 = F_456 ( V_505 , 0x342e , NULL ) ;
if ( ! V_102 )
return;
if ( F_457 ( V_102 , 0x188 , & V_504 ) ) {
F_257 ( V_102 ) ;
return;
}
F_257 ( V_102 ) ;
