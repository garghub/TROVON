...
if ( V_40 == NULL )
return false ;
if ( F_24 ( V_3 ) == V_43 && V_40 -> V_44 -> V_45 != NULL &&
( V_40 -> V_46 & V_47 ) )
return true ;
if ( F_24 ( V_3 ) == V_48 && V_40 -> V_44 -> V_49 != NULL &&
( V_40 -> V_46 & V_50 ) )
return true ;
return false ;
}
...
static inline unsigned int F_26 ( struct V_39 * V_40 ,
unsigned int V_51 )
{
return F_25 ( V_40 , V_51 ) * V_40 -> V_53 ;
}
...
struct V_39 * V_40 = F_21 ( V_3 -> V_37 ) ;
V_3 -> V_94 = F_27 ( V_3 , V_40 -> V_44 -> V_45 ) ;
V_3 -> V_89 = V_6 -> V_88 ;
F_41 ( V_3 ) ;
}
...
struct V_2 * V_6 = F_12 ( V_3 ) ;
struct V_39 * V_40 = F_21 ( V_3 -> V_37 ) ;
unsigned V_75 = F_26 ( V_40 , V_95 >> 9 ) ;
