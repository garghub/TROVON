...
static int T_3 F_71 ( struct V_79 * V_43 )
{
struct V_122 * V_123 = F_72 ( V_43 ) ;
struct V_1 * V_1 = F_73 ( V_123 ) ;
int V_66 , V_124 ;
for ( V_66 = 0 ; V_66 < V_1 -> V_42 ; V_66 ++ ) {
V_1 -> V_125 [ V_66 ] . V_126 =
F_1 ( V_1 , V_66 , V_45 ) ;
F_3 ( V_1 , V_66 , V_30 ,
~ V_1 -> V_34 [ V_66 ] ) ;
V_1 -> V_125 [ V_66 ] . V_127 =
F_1 ( V_1 , V_66 , V_128 ) ;
for ( V_124 = 0 ; V_124 < V_46 ; V_124 ++ ) {
F_3 ( V_1 , V_66 ,
V_13 , F_8 ( V_124 ) ) ;
V_1 -> V_125 [ V_66 ] . V_129 [ V_124 ] =
F_1 ( V_1 , V_66 ,
V_14 ) ;
}
}
...
static int T_3 F_74 ( struct V_79 * V_43 )
{
struct V_122 * V_123 = F_72 ( V_43 ) ;
struct V_1 * V_1 = F_73 ( V_123 ) ;
int V_66 , V_124 ;
...
struct V_1 * V_1 ;
struct V_135 * V_135 ;
V_1 = F_76 ( V_43 , sizeof( * V_1 ) , V_136 ) ;
if ( ! V_1 )
return - V_137 ;
V_1 -> V_43 = V_43 ;
V_1 -> V_78 = V_43 -> V_138 ;
F_77 ( V_123 , V_1 ) ;
V_133 = F_78 ( V_139 , V_43 -> V_138 ) ;
if ( ! V_133 ) {
F_20 ( V_43 , L_18 ) ;
return - V_140 ;
}
V_135 = (struct V_135 * ) V_133 -> V_141 ;
V_1 -> V_42 = V_135 -> V_42 ;
V_1 -> V_60 = V_1 -> V_42 * V_46 ;
V_103 = F_79 ( V_123 , V_142 , 0 ) ;
if ( ! V_103 ) {
F_20 ( V_43 , L_19 ) ;
return - V_29 ;
}
...
if ( F_81 ( V_1 -> V_4 ) )
return - V_29 ;
V_1 -> V_143 = F_82 ( V_43 , NULL ) ;
if ( F_81 ( V_1 -> V_143 ) ) {
F_20 ( V_43 , L_20 ) ;
return F_83 ( V_1 -> V_143 ) ;
}
V_1 -> V_11 = F_76 ( V_43 , sizeof( * V_1 -> V_11 )
* V_1 -> V_60 , V_136 ) ;
if ( ! V_1 -> V_11 )
return - V_137 ;
V_131 = F_76 ( V_43 , sizeof( * V_131 )
* V_1 -> V_60 , V_136 ) ;
if ( ! V_131 )
return - V_137 ;
V_144 . V_11 = V_131 ;
...
sizeof( * * V_1 -> V_11 ) , V_136 ) ;
if ( ! V_1 -> V_11 [ V_66 ] )
return - V_137 ;
V_1 -> V_11 [ V_66 ] -> V_57 = V_66 ;
V_1 -> V_11 [ V_66 ] -> V_2 = V_2 ;
V_1 -> V_11 [ V_66 ] -> line = line ;
V_131 [ V_66 ] . V_145 = V_66 ;
V_131 [ V_66 ] . V_63 = F_84 ( V_136 , L_21 ,
V_2 + 'A' , line ) ;
V_91 -> V_63 = V_97 [ V_66 ] = V_131 [ V_66 ] . V_63 ;
V_91 -> V_10 = V_131 [ V_66 ] . V_145 ;
F_62 ( V_43 , L_22 , V_66 , V_2 , line ) ;
}
V_1 -> V_47 = & V_146 ;
V_1 -> V_47 -> V_138 = V_43 -> V_138 ;
V_1 -> V_47 -> V_147 = V_1 -> V_60 ;
V_1 -> V_47 -> V_148 = F_85 ( V_43 ) ;
V_1 -> V_47 -> V_77 = V_43 ;
V_1 -> V_47 -> V_149 = V_1 -> V_97 ;
V_1 -> V_34 = F_76 ( V_43 ,
sizeof( * V_1 -> V_34 )
* V_1 -> V_42 , V_136 ) ;
if ( ! V_1 -> V_34 )
...
return - V_137 ;
for ( V_66 = 0 ; V_66 < V_1 -> V_42 ; V_66 ++ ) {
V_103 = F_79 ( V_123 , V_150 , V_66 ) ;
if ( ! V_103 ) {
F_20 ( V_43 , L_23 ,
'A' + V_66 ) ;
return - V_29 ;
}
V_1 -> V_33 [ V_66 ] = V_103 -> V_151 ;
F_86 ( V_103 -> V_151 , F_16 ) ;
F_87 ( V_103 -> V_151 , V_1 ) ;
F_62 ( V_43 , L_24 , V_66 , V_103 ) ;
}
V_1 -> V_54 = F_88 ( V_43 -> V_138 ,
V_1 -> V_47 -> V_147 ,
& V_152 , NULL ) ;
if ( ! V_1 -> V_54 ) {
F_20 ( V_43 , L_25 ) ;
