...
static int F_71 ( struct V_130 * V_143 )
{
int V_31 , V_144 , V_145 ;
struct V_88 * V_11 ;
struct V_132 * V_140 , * V_146 ;
struct V_4 * V_5 ;
struct V_130 * V_147 ;
struct V_148 V_17 ;
struct V_6 * V_7 ;
...
V_131 = ( T_4 ) ( V_150 + 1 ) ;
V_7 -> V_26 = F_80 ( & V_147 -> V_11 ) ;
if ( ! V_7 -> V_26 ) {
F_2 ( V_11 , L_21 , V_146 -> V_153 ) ;
V_31 = - V_156 ;
goto V_155;
}
F_81 ( V_146 ) ;
...
V_5 -> V_17 = F_83 ( V_11 ,
F_84 ( V_7 -> V_26 ) ,
V_17 . V_18 , V_17 . V_157 + 1 - V_17 . V_18 ,
L_23 ) ;
if ( ! V_5 -> V_17 ) {
F_2 ( V_11 , L_24 ) ;
V_31 = - V_158 ;
...
V_7 -> V_159 = F_6 ( V_11 , V_5 -> V_17 -> V_18 ,
V_5 -> V_17 -> V_157 + 1 - V_5 -> V_17 -> V_18 ) ;
if ( ! V_7 -> V_159 ) {
F_2 ( V_11 , L_25 ) ;
V_31 = - V_160 ;
goto V_154;
...
memcpy ( V_5 -> V_19 , V_149 , sizeof( V_5 -> V_19 ) ) ;
V_145 = F_90 ( V_140 , L_27 , NULL ) ;
if ( F_91 ( V_145 < 0 ) ) {
F_2 ( V_11 , L_28 ,
V_140 -> V_153 ) ;
V_31 = V_145 ;
...
if ( V_145 != F_92 ( V_5 -> V_161 ) ) {
F_2 ( V_11 , L_29 ,
V_140 -> V_153 ) ;
V_31 = - V_33 ;
goto V_154;
}
for ( V_144 = 0 ; V_144 < F_92 ( V_5 -> V_161 ) ; V_144 ++ ) {
V_146 = F_74 ( V_140 , L_27 , V_144 ) ;
if ( ! V_146 ) {
F_2 ( V_11 , L_30 ,
V_140 -> V_153 ) ;
V_31 = - V_33 ;
...
V_5 -> V_161 [ V_144 ] = F_93 ( & V_147 -> V_11 ) ;
if ( ! V_5 -> V_161 [ V_144 ] ) {
F_2 ( V_11 , L_31 ,
V_146 -> V_153 ) ;
V_31 = - V_33 ;
...
V_7 -> V_95 = F_99 ( V_140 ) ;
V_169 = F_100 ( V_7 -> V_95 ) ;
if ( ! V_169 ) {
V_31 = - V_33 ;
goto V_154;
}
V_7 -> V_40 -> V_93 = V_169 -> V_93 ;
V_7 -> V_40 -> V_94 = V_169 -> V_94 ;
V_7 -> V_40 -> V_73 = V_169 -> V_73 ;
V_7 -> V_40 -> V_82 = V_169 -> V_82 ;
V_7 -> V_40 -> V_84 = V_169 -> V_84 ;
F_101 ( & V_169 -> V_170 . V_11 ) ;
}
V_31 = V_5 -> V_100 ( V_5 ) ;
if ( V_31 < 0 ) {
F_2 ( V_11 , L_34 , V_31 ) ;
...
V_7 -> V_171 = F_61 ( V_131 , V_5 , V_140 ) ;
if ( F_102 ( V_7 -> V_171 ) ) {
F_2 ( V_11 , L_36 ,
V_7 -> V_24 ) ;
V_7 -> V_171 = NULL ;
