...
struct V_1 * V_2 = V_40 -> V_2 ;
int V_43 = ( V_40 == & V_40 -> V_2 -> V_9 . V_11 [ 0 ] . V_40 ) ? 0 : 1 ;
F_18 ( V_45 + V_46 [ V_43 ] , F_19 ( V_40 -> V_44 ) << 2 ) ;
}
static void F_20 ( struct V_39 * V_40 , T_2 V_47 )
{
struct V_48 * V_9 = F_21 ( V_40 ) ;
int V_8 ;
for ( V_8 = 0 ; V_8 < V_47 ; V_8 ++ )
if ( V_9 && V_9 -> V_29 && ( V_8 == 0 ) )
F_22 ( V_40 , V_40 -> V_49 -> V_50 |
F_23 ( V_47 - 1 ) ) ;
else
F_22 ( V_40 , V_40 -> V_49 -> V_50 ) ;
}
...
{
V_6 V_55 = V_53 & 0xf ;
F_20 ( V_40 , ( 10 - ( F_19 ( V_40 -> V_44 ) & 7 ) ) % 8 ) ;
F_22 ( V_40 , F_25 ( V_56 ) |
F_26 ( V_55 ) ) ;
F_22 ( V_40 , F_19 ( V_52 -> V_57 ) & 0xffffffe0 ) ;
F_22 ( V_40 , F_27 ( V_52 -> V_57 ) ) ;
F_22 ( V_40 , V_52 -> V_58 ) ;
F_22 ( V_40 , 0 ) ;
F_22 ( V_40 , 0 ) ;
}
...
static void F_36 ( struct V_39 * V_40 , T_3 V_68 , T_3 V_69 ,
unsigned V_70 )
{
bool V_71 = V_70 & V_72 ;
F_22 ( V_40 , F_25 ( V_73 ) ) ;
...
F_22 ( V_40 , F_25 ( V_134 ) |
F_61 ( V_135 ) ) ;
F_22 ( V_40 , F_19 ( V_57 ) ) ;
F_22 ( V_40 , F_27 ( V_57 ) ) ;
F_22 ( V_40 , F_62 ( 1 ) ) ;
F_22 ( V_40 , 0xDEADBEEF ) ;
F_63 ( V_40 ) ;
...
V_52 . V_141 [ 0 ] = F_25 ( V_134 ) |
F_61 ( V_135 ) ;
V_52 . V_141 [ 1 ] = F_19 ( V_57 ) ;
V_52 . V_141 [ 2 ] = F_27 ( V_57 ) ;
V_52 . V_141 [ 3 ] = F_62 ( 1 ) ;
V_52 . V_141 [ 4 ] = 0xDEADBEEF ;
V_52 . V_141 [ 5 ] = F_25 ( V_142 ) ;
V_52 . V_141 [ 6 ] = F_25 ( V_142 ) ;
V_52 . V_141 [ 7 ] = F_25 ( V_142 ) ;
V_52 . V_58 = 8 ;
V_98 = F_68 ( V_40 , 1 , & V_52 , NULL , & V_139 ) ;
if ( V_98 )
goto V_143;
...
V_52 -> V_141 [ V_52 -> V_58 ++ ] = F_25 ( V_148 ) |
F_61 ( V_149 ) ;
V_52 -> V_141 [ V_52 -> V_58 ++ ] = V_147 ;
V_52 -> V_141 [ V_52 -> V_58 ++ ] = 0 ;
V_52 -> V_141 [ V_52 -> V_58 ++ ] = F_19 ( V_146 ) ;
V_52 -> V_141 [ V_52 -> V_58 ++ ] = F_27 ( V_146 ) ;
V_52 -> V_141 [ V_52 -> V_58 ++ ] = F_19 ( V_145 ) ;
V_52 -> V_141 [ V_52 -> V_58 ++ ] = F_27 ( V_145 ) ;
}
static void F_73 ( struct V_51 * V_52 , T_1 V_145 ,
T_1 V_150 , unsigned V_47 ,
T_2 V_151 )
{
unsigned V_152 = V_47 * 2 ;
V_52 -> V_141 [ V_52 -> V_58 ++ ] = F_25 ( V_134 ) |
F_61 ( V_135 ) ;
V_52 -> V_141 [ V_52 -> V_58 ++ ] = V_145 ;
V_52 -> V_141 [ V_52 -> V_58 ++ ] = F_27 ( V_145 ) ;
V_52 -> V_141 [ V_52 -> V_58 ++ ] = V_152 ;
for (; V_152 > 0 ; V_152 -= 2 ) {
V_52 -> V_141 [ V_52 -> V_58 ++ ] = F_19 ( V_150 ) ;
V_52 -> V_141 [ V_52 -> V_58 ++ ] = F_27 ( V_150 ) ;
V_150 += V_151 ;
}
}
static void F_74 ( struct V_51 * V_52 , T_1 V_145 ,
T_1 V_68 , unsigned V_47 ,
T_2 V_151 , T_1 V_70 )
{
V_52 -> V_141 [ V_52 -> V_58 ++ ] = F_25 ( V_153 ) ;
V_52 -> V_141 [ V_52 -> V_58 ++ ] = F_19 ( V_145 ) ;
V_52 -> V_141 [ V_52 -> V_58 ++ ] = F_27 ( V_145 ) ;
V_52 -> V_141 [ V_52 -> V_58 ++ ] = F_19 ( V_70 ) ;
V_52 -> V_141 [ V_52 -> V_58 ++ ] = F_27 ( V_70 ) ;
V_52 -> V_141 [ V_52 -> V_58 ++ ] = F_19 ( V_68 ) ;
...
{
T_2 V_69 = V_40 -> V_155 . V_156 ;
T_1 V_68 = V_40 -> V_155 . V_57 ;
F_22 ( V_40 , F_25 ( V_63 ) |
F_30 ( 0 ) |
F_31 ( 3 ) |
F_77 ( 1 ) ) ;
F_22 ( V_40 , V_68 & 0xfffffffc ) ;
F_22 ( V_40 , F_27 ( V_68 ) & 0xffffffff ) ;
F_22 ( V_40 , V_69 ) ;
F_22 ( V_40 , 0xfffffff ) ;
F_22 ( V_40 , F_32 ( 0xfff ) |
F_33 ( 4 ) ) ;
...
unsigned V_53 , T_1 V_157 )
{
F_22 ( V_40 , F_25 ( V_66 ) |
F_35 ( 0xf ) ) ;
if ( V_53 < 8 ) {
F_22 ( V_40 , ( V_158 + V_53 ) ) ;
} else {
F_22 ( V_40 , ( V_159 + V_53 - 8 ) ) ;
}
F_22 ( V_40 , V_157 >> 12 ) ;
F_22 ( V_40 , F_25 ( V_66 ) |
F_35 ( 0xf ) ) ;
...
int V_98 , V_8 ;
struct V_1 * V_2 = (struct V_1 * ) V_161 ;
V_98 = F_85 ( V_2 , V_163 , 224 ,
& V_2 -> V_9 . V_164 ) ;
if ( V_98 )
return V_98 ;
V_98 = F_85 ( V_2 , V_163 , 241 ,
& V_2 -> V_9 . V_165 ) ;
if ( V_98 )
return V_98 ;
V_98 = F_85 ( V_2 , V_163 , 247 ,
& V_2 -> V_9 . V_165 ) ;
if ( V_98 )
return V_98 ;
V_98 = F_6 ( V_2 ) ;
...
V_6 V_132 = F_16 ( V_171 ) ;
if ( V_132 & V_172 ) {
V_132 = F_16 ( V_92 + V_175 ) ;
V_132 = F_29 ( V_132 , V_93 , V_94 , 0 ) ;
F_18 ( V_92 + V_175 , V_132 ) ;
V_174 |= V_176 ;
}
if ( V_132 & V_173 ) {
...
switch ( V_182 ) {
case V_184 :
V_183 = F_16 ( V_185 + V_175 ) ;
V_183 = F_29 ( V_183 , V_186 , V_187 , 0 ) ;
F_18 ( V_185 + V_175 , V_183 ) ;
break;
case V_188 :
V_183 = F_16 ( V_185 + V_175 ) ;
V_183 = F_29 ( V_183 , V_186 , V_187 , 1 ) ;
F_18 ( V_185 + V_175 , V_183 ) ;
break;
default:
break;
...
switch ( V_182 ) {
case V_184 :
V_183 = F_16 ( V_185 + V_177 ) ;
V_183 = F_29 ( V_183 , V_186 , V_187 , 0 ) ;
F_18 ( V_185 + V_177 , V_183 ) ;
break;
case V_188 :
V_183 = F_16 ( V_185 + V_177 ) ;
V_183 = F_29 ( V_183 , V_186 , V_187 , 1 ) ;
...
int V_8 ;
for ( V_8 = 0 ; V_8 < V_2 -> V_9 . V_10 ; V_8 ++ )
V_2 -> V_9 . V_11 [ V_8 ] . V_40 . V_49 = & V_198 ;
}
static void F_83 ( struct V_1 * V_2 )
{
V_2 -> V_9 . V_164 . V_199 = V_200 ;
V_2 -> V_9 . V_164 . V_49 = & V_201 ;
V_2 -> V_9 . V_165 . V_49 = & V_202 ;
}
...
V_52 -> V_141 [ V_52 -> V_58 ++ ] = 0 ;
V_52 -> V_141 [ V_52 -> V_58 ++ ] = F_19 ( V_203 ) ;
V_52 -> V_141 [ V_52 -> V_58 ++ ] = F_27 ( V_203 ) ;
V_52 -> V_141 [ V_52 -> V_58 ++ ] = F_19 ( V_204 ) ;
V_52 -> V_141 [ V_52 -> V_58 ++ ] = F_27 ( V_204 ) ;
}
...
T_2 V_205 )
{
V_52 -> V_141 [ V_52 -> V_58 ++ ] = F_25 ( V_207 ) ;
V_52 -> V_141 [ V_52 -> V_58 ++ ] = F_19 ( V_204 ) ;
V_52 -> V_141 [ V_52 -> V_58 ++ ] = F_27 ( V_204 ) ;
V_52 -> V_141 [ V_52 -> V_58 ++ ] = V_206 ;
V_52 -> V_141 [ V_52 -> V_58 ++ ] = V_205 ;
}
static void F_81 ( struct V_1 * V_2 )
{
if ( V_2 -> V_79 . V_208 == NULL ) {
V_2 -> V_79 . V_208 = & V_209 ;
