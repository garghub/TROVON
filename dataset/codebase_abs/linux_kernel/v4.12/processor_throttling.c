...
F_11 ( ( V_30 , L_38 ) ) ;
return - V_21 ;
} else if ( ! V_8 -> V_19 . V_119 ) {
F_11 ( ( V_30 , L_39 ) ) ;
return - V_21 ;
}
else if ( ( V_8 -> V_19 . V_99 + V_8 -> V_19 . V_119 ) > 4 ) {
F_13 (KERN_WARNING PREFIX L_40 ) ;
return - V_21 ;
}
V_8 -> V_19 . V_47 = 1 << V_120 . V_119 ;
V_118 = ( 1000 / V_8 -> V_19 . V_47 ) ;
for ( V_4 = 0 ; V_4 < V_8 -> V_19 . V_47 ; V_4 ++ ) {
V_8 -> V_19 . V_100 [ V_4 ] . V_101 = 1000 - V_118 * V_4 ;
V_8 -> V_19 . V_100 [ V_4 ] . V_121 = 1000 - V_118 * V_4 ;
}
return 0 ;
}
...
static long F_55 ( void * V_32 )
{
struct V_124 * V_125 = V_32 ;
struct V_7 * V_8 = V_125 -> V_8 ;
return V_8 -> V_19 . F_19 ( V_8 ,
V_125 -> V_36 , V_125 -> V_122 ) ;
}
static int F_56 ( int V_35 , long (* F_57)( void * ) , void * V_125 , bool V_126 )
{
if ( V_126 )
return F_57 ( V_125 ) ;
return F_50 ( V_35 , F_57 , V_125 ) ;
}
static int F_47 ( struct V_7 * V_8 ,
int V_50 , bool V_122 , bool V_126 )
{
int V_105 = 0 ;
unsigned int V_4 ;
struct V_7 * V_9 ;
...
V_127 . V_36 = V_50 ;
V_39 = & ( V_8 -> V_19 ) ;
F_59 (i, cpu_online_mask, p_throttling->shared_cpu_map) {
V_127 . V_35 = V_4 ;
F_12 ( V_41 ,
& V_127 ) ;
}
...
V_125 . V_36 = V_50 ;
V_125 . V_122 = V_122 ;
V_105 = F_56 ( V_8 -> V_92 , F_55 , & V_125 ,
V_126 ) ;
} else {
F_59 (i, cpu_online_mask,
...
bool V_122 )
{
return F_47 ( V_8 , V_50 , V_122 , false ) ;
}
