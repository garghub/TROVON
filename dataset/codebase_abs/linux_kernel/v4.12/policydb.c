...
int F_107 ( struct V_6 * V_7 , void * V_161 )
{
...
V_9 = - V_13 ;
V_246 = F_77 ( V_169 + 1 , V_12 ) ;
if ( ! V_246 ) {
F_31 ( V_156 L_42
L_43 , V_169 ) ;
goto V_173;
}
V_9 = F_71 ( V_246 , V_161 , V_169 ) ;
if ( V_9 ) {
F_31 ( V_156 L_44 ) ;
F_7 ( V_246 ) ;
goto V_173;
...
F_31 ( V_156 L_47
L_48 ,
F_72 ( V_162 [ 0 ] ) , V_249 , V_250 ) ;
goto V_173;
}
if ( ( F_72 ( V_162 [ 1 ] ) & V_251 ) ) {
V_7 -> V_103 = 1 ;
V_9 = - V_14 ;
if ( V_7 -> V_165 < V_166 ) {
F_31 ( V_156 L_49
...
V_7 -> V_252 = ! ! ( F_72 ( V_162 [ 1 ] ) & V_253 ) ;
V_7 -> V_254 = ! ! ( F_72 ( V_162 [ 1 ] ) & V_255 ) ;
if ( V_7 -> V_165 >= V_256 ) {
...
V_142 -> V_261 = F_72 ( V_162 [ 1 ] ) ;
if ( ! F_65 ( V_7 , V_142 -> V_11 ) ||
! F_65 ( V_7 , V_142 -> V_261 ) )
goto V_173;
V_143 = V_142 ;
}
V_9 = F_103 ( V_7 , V_161 ) ;
...
goto V_173;
V_9 = - V_14 ;
V_7 -> V_263 = F_100 ( V_7 , V_7 -> V_219 , L_56 ) ;
V_7 -> V_263 |= F_100 ( V_7 , V_7 -> V_219 , L_57 ) ;
if ( ! V_7 -> V_263 )
goto V_173;
...
static int F_110 ( struct V_210 * V_226 , void * V_161 )
{
T_2 V_162 [ 1 ] ;
int V_9 ;
V_162 [ 0 ] = F_111 ( V_226 -> V_87 ) ;
V_9 = F_112 ( V_162 , sizeof( T_1 ) , 1 , V_161 ) ;
if ( V_9 )
return V_9 ;
V_9 = F_113 ( & V_226 -> V_125 , V_161 ) ;
if ( V_9 )
return V_9 ;
return 0 ;
}
static int F_114 ( struct V_127 * V_160 , void * V_161 )
{
T_2 V_162 [ 3 ] ;
T_5 V_163 ;
int V_9 , V_265 ;
V_265 = F_115 ( & V_160 -> V_86 [ 1 ] , & V_160 -> V_86 [ 0 ] ) ;
if ( V_265 )
V_163 = 2 ;
else
V_163 = 3 ;
V_162 [ 0 ] = F_111 ( V_163 - 1 ) ;
V_162 [ 1 ] = F_111 ( V_160 -> V_86 [ 0 ] . V_87 ) ;
if ( ! V_265 )
V_162 [ 2 ] = F_111 ( V_160 -> V_86 [ 1 ] . V_87 ) ;
F_97 ( V_163 > F_2 ( V_162 ) ) ;
V_9 = F_112 ( V_162 , sizeof( T_1 ) , V_163 , V_161 ) ;
if ( V_9 )
return V_9 ;
V_9 = F_113 ( & V_160 -> V_86 [ 0 ] . V_125 , V_161 ) ;
if ( V_9 )
return V_9 ;
if ( ! V_265 ) {
V_9 = F_113 ( & V_160 -> V_86 [ 1 ] . V_125 , V_161 ) ;
if ( V_9 )
return V_9 ;
}
return 0 ;
...
V_169 = strlen ( V_8 ) ;
V_162 [ 0 ] = F_111 ( V_169 ) ;
V_162 [ 1 ] = F_111 ( V_84 -> V_85 ) ;
V_9 = F_112 ( V_162 , sizeof( T_1 ) , 2 , V_161 ) ;
if ( V_9 )
return V_9 ;
V_9 = F_112 ( V_8 , 1 , V_169 , V_161 ) ;
if ( V_9 )
return V_9 ;
V_9 = F_110 ( V_84 -> V_86 , V_161 ) ;
if ( V_9 )
return V_9 ;
return 0 ;
}
static int F_117 ( void * V_266 , void * V_54 , void * V_267 )
{
char * V_8 = V_266 ;
...
V_169 = strlen ( V_8 ) ;
V_162 [ 0 ] = F_111 ( V_169 ) ;
V_162 [ 1 ] = F_111 ( V_91 -> V_15 ) ;
V_162 [ 2 ] = F_111 ( V_91 -> V_85 ) ;
V_9 = F_112 ( V_162 , sizeof( T_1 ) , 3 , V_161 ) ;
if ( V_9 )
return V_9 ;
V_9 = F_112 ( V_8 , 1 , V_169 , V_161 ) ;
if ( V_9 )
...
static int F_118 ( struct V_6 * V_7 , void * V_161 )
{
...
return V_9 ;
for ( V_145 = V_160 ; V_145 ; V_145 = V_145 -> V_119 ) {
V_162 [ 0 ] = F_111 ( V_145 -> V_11 ) ;
V_162 [ 1 ] = F_111 ( V_145 -> type ) ;
V_162 [ 2 ] = F_111 ( V_145 -> V_261 ) ;
V_9 = F_112 ( V_162 , sizeof( T_1 ) , 3 , V_161 ) ;
if ( V_9 )
return V_9 ;
if ( V_7 -> V_165 >= V_262 ) {
V_162 [ 0 ] = F_111 ( V_145 -> V_32 ) ;
V_9 = F_112 ( V_162 , sizeof( T_1 ) , 1 , V_161 ) ;
if ( V_9 )
return V_9 ;
}
...
static int F_119 ( struct V_141 * V_160 , void * V_161 )
{
struct V_141 * V_142 ;
T_1 V_162 [ 2 ] ;
T_5 V_97 ;
...
return V_9 ;
for ( V_142 = V_160 ; V_142 ; V_142 = V_142 -> V_119 ) {
V_162 [ 0 ] = F_111 ( V_142 -> V_11 ) ;
V_162 [ 1 ] = F_111 ( V_142 -> V_261 ) ;
V_9 = F_112 ( V_162 , sizeof( T_1 ) , 2 , V_161 ) ;
if ( V_9 )
return V_9 ;
}
...
static int F_120 ( struct V_6 * V_7 , struct V_131 * V_130 ,
void * V_161 )
{
int V_9 ;
T_2 V_162 [ 3 ] ;
V_162 [ 0 ] = F_111 ( V_130 -> V_157 ) ;
V_162 [ 1 ] = F_111 ( V_130 -> V_11 ) ;
V_162 [ 2 ] = F_111 ( V_130 -> type ) ;
V_9 = F_112 ( V_162 , sizeof( T_1 ) , 3 , V_161 ) ;
if ( V_9 )
return V_9 ;
V_9 = F_114 ( & V_130 -> V_124 , V_161 ) ;
if ( V_9 )
return V_9 ;
return 0 ;
}
static int F_121 ( void * V_266 , void * V_54 , void * V_161 )
{
char * V_8 = V_266 ;
...
static int F_122 ( void * V_266 , void * V_54 , void * V_267 )
{
char * V_8 = V_266 ;
...
V_169 = strlen ( V_8 ) ;
V_162 [ 0 ] = F_111 ( V_169 ) ;
V_162 [ 1 ] = F_111 ( V_57 -> V_15 ) ;
V_162 [ 2 ] = F_111 ( V_57 -> V_106 . V_17 ) ;
V_162 [ 3 ] = F_111 ( V_57 -> V_106 . V_21 -> V_97 ) ;
V_9 = F_112 ( V_162 , sizeof( T_1 ) , 4 , V_161 ) ;
if ( V_9 )
return V_9 ;
V_9 = F_112 ( V_8 , 1 , V_169 , V_161 ) ;
if ( V_9 )
return V_9 ;
V_9 = F_40 ( V_57 -> V_106 . V_21 , F_121 , V_161 ) ;
if ( V_9 )
return V_9 ;
return 0 ;
}
static int F_123 ( struct V_175 * V_176 , void * V_161 )
{
int V_9 ;
T_2 V_162 [ 1 ] ;
if ( F_113 ( & V_176 -> V_111 , V_161 ) )
return - V_14 ;
if ( F_113 ( & V_176 -> V_112 , V_161 ) )
return - V_14 ;
V_162 [ 0 ] = F_111 ( V_176 -> V_168 ) ;
V_9 = F_112 ( V_162 , sizeof( T_1 ) , 1 , V_161 ) ;
if ( V_9 )
return - V_14 ;
return 0 ;
}
static int F_124 ( struct V_6 * V_7 , struct V_113 * V_215 ,
void * V_161 )
{
struct V_113 * V_130 ;
struct V_107 * V_116 ;
...
V_97 ++ ;
V_162 [ 0 ] = F_111 ( V_130 -> V_106 ) ;
V_162 [ 1 ] = F_111 ( V_97 ) ;
V_9 = F_112 ( V_162 , sizeof( T_1 ) , 2 , V_161 ) ;
if ( V_9 )
return V_9 ;
for ( V_116 = V_130 -> V_108 ; V_116 ; V_116 = V_116 -> V_119 ) {
V_162 [ 0 ] = F_111 ( V_116 -> V_185 ) ;
V_162 [ 1 ] = F_111 ( V_116 -> V_186 ) ;
V_162 [ 2 ] = F_111 ( V_116 -> V_187 ) ;
V_9 = F_112 ( V_162 , sizeof( T_1 ) , 3 , V_161 ) ;
if ( V_9 )
return V_9 ;
switch ( V_116 -> V_185 ) {
case V_193 :
V_9 = F_113 ( & V_116 -> V_109 , V_161 ) ;
if ( V_9 )
return V_9 ;
if ( V_7 -> V_165 >=
V_195 ) {
V_9 = F_123 ( V_116 -> V_110 , V_161 ) ;
if ( V_9 )
return V_9 ;
}
break;
...
V_162 [ 0 ] = F_111 ( V_169 ) ;
V_162 [ 1 ] = F_111 ( V_196 ) ;
V_162 [ 2 ] = F_111 ( V_65 -> V_15 ) ;
V_162 [ 3 ] = F_111 ( V_65 -> V_106 . V_17 ) ;
if ( V_65 -> V_106 . V_21 )
V_162 [ 4 ] = F_111 ( V_65 -> V_106 . V_21 -> V_97 ) ;
else
V_162 [ 4 ] = 0 ;
V_162 [ 5 ] = F_111 ( V_178 ) ;
V_9 = F_112 ( V_162 , sizeof( T_1 ) , 6 , V_161 ) ;
if ( V_9 )
return V_9 ;
V_9 = F_112 ( V_8 , 1 , V_169 , V_161 ) ;
if ( V_9 )
return V_9 ;
if ( V_65 -> V_121 ) {
V_9 = F_112 ( V_65 -> V_121 , 1 , V_196 , V_161 ) ;
if ( V_9 )
return V_9 ;
}
V_9 = F_40 ( V_65 -> V_106 . V_21 , F_121 , V_161 ) ;
if ( V_9 )
return V_9 ;
V_9 = F_124 ( V_7 , V_65 -> V_118 , V_161 ) ;
if ( V_9 )
return V_9 ;
V_178 = 0 ;
...
if ( V_9 )
return V_9 ;
V_9 = F_124 ( V_7 , V_65 -> V_120 , V_161 ) ;
if ( V_9 )
return V_9 ;
if ( V_7 -> V_165 >= V_198 ) {
V_162 [ 0 ] = F_111 ( V_65 -> V_199 ) ;
V_162 [ 1 ] = F_111 ( V_65 -> V_200 ) ;
V_162 [ 2 ] = F_111 ( V_65 -> V_201 ) ;
V_9 = F_112 ( V_162 , sizeof( V_270 ) , 3 , V_161 ) ;
if ( V_9 )
return V_9 ;
}
if ( V_7 -> V_165 >= V_202 ) {
V_162 [ 0 ] = F_111 ( V_65 -> V_203 ) ;
V_9 = F_112 ( V_162 , sizeof( V_270 ) , 1 , V_161 ) ;
if ( V_9 )
return V_9 ;
}
return 0 ;
...
V_169 = strlen ( V_8 ) ;
V_163 = 0 ;
V_162 [ V_163 ++ ] = F_111 ( V_169 ) ;
V_162 [ V_163 ++ ] = F_111 ( V_11 -> V_15 ) ;
if ( V_7 -> V_165 >= V_205 )
V_162 [ V_163 ++ ] = F_111 ( V_11 -> V_69 ) ;
F_97 ( V_163 > F_2 ( V_162 ) ) ;
V_9 = F_112 ( V_162 , sizeof( T_1 ) , V_163 , V_161 ) ;
if ( V_9 )
return V_9 ;
...
if ( V_9 )
return V_9 ;
V_9 = F_113 ( & V_11 -> V_122 , V_161 ) ;
if ( V_9 )
return V_9 ;
V_9 = F_113 ( & V_11 -> V_111 , V_161 ) ;
if ( V_9 )
return V_9 ;
return 0 ;
}
...
if ( V_73 -> V_209 )
V_271 |= V_208 ;
V_162 [ V_163 ++ ] = F_111 ( V_271 ) ;
V_162 [ V_163 ++ ] = F_111 ( V_73 -> V_69 ) ;
} else {
V_162 [ V_163 ++ ] = F_111 ( V_73 -> V_74 ) ;
}
F_97 ( V_163 > F_2 ( V_162 ) ) ;
V_9 = F_112 ( V_162 , sizeof( T_1 ) , V_163 , V_161 ) ;
if ( V_9 )
...
static int F_128 ( void * V_266 , void * V_54 , void * V_267 )
{
char * V_8 = V_266 ;
...
V_163 = 0 ;
V_162 [ V_163 ++ ] = F_111 ( V_169 ) ;
V_162 [ V_163 ++ ] = F_111 ( V_79 -> V_15 ) ;
if ( V_7 -> V_165 >= V_205 )
V_162 [ V_163 ++ ] = F_111 ( V_79 -> V_69 ) ;
F_97 ( V_163 > F_2 ( V_162 ) ) ;
V_9 = F_112 ( V_162 , sizeof( T_1 ) , V_163 , V_161 ) ;
if ( V_9 )
return V_9 ;
...
if ( V_9 )
return V_9 ;
V_9 = F_113 ( & V_79 -> V_123 , V_161 ) ;
if ( V_9 )
return V_9 ;
V_9 = F_114 ( & V_79 -> V_124 , V_161 ) ;
if ( V_9 )
return V_9 ;
V_9 = F_110 ( & V_79 -> V_126 , V_161 ) ;
if ( V_9 )
return V_9 ;
return 0 ;
}
static int F_129 ( struct V_6 * V_7 , struct V_1 * V_4 ,
void * V_161 )
{
...
switch ( V_3 ) {
case V_132 :
V_162 [ 0 ] = F_111 ( V_130 -> V_158 [ 0 ] ) ;
V_9 = F_112 ( V_162 , sizeof( T_1 ) , 1 , V_161 ) ;
if ( V_9 )
return V_9 ;
V_9 = F_120 ( V_7 , & V_130 -> V_131 [ 0 ] , V_161 ) ;
if ( V_9 )
return V_9 ;
break;
case V_133 :
...
if ( V_9 )
return V_9 ;
V_9 = F_112 ( V_130 -> V_136 . V_33 , 1 , V_169 , V_161 ) ;
if ( V_9 )
return V_9 ;
V_9 = F_120 ( V_7 , & V_130 -> V_131 [ 0 ] , V_161 ) ;
if ( V_9 )
return V_9 ;
V_9 = F_120 ( V_7 , & V_130 -> V_131 [ 1 ] , V_161 ) ;
if ( V_9 )
return V_9 ;
break;
case V_233 :
V_162 [ 0 ] = F_111 ( V_130 -> V_136 . V_234 . V_235 ) ;
V_162 [ 1 ] = F_111 ( V_130 -> V_136 . V_234 . V_236 ) ;
V_162 [ 2 ] = F_111 ( V_130 -> V_136 . V_234 . V_237 ) ;
V_9 = F_112 ( V_162 , sizeof( T_1 ) , 3 , V_161 ) ;
if ( V_9 )
return V_9 ;
V_9 = F_120 ( V_7 , & V_130 -> V_131 [ 0 ] , V_161 ) ;
...
V_9 = F_112 ( V_231 , sizeof( T_1 ) , 2 , V_161 ) ;
if ( V_9 )
return V_9 ;
V_9 = F_120 ( V_7 , & V_130 -> V_131 [ 0 ] , V_161 ) ;
if ( V_9 )
...
break;
case V_135 :
V_162 [ 0 ] = F_111 ( V_130 -> V_39 . V_241 ) ;
V_169 = strlen ( V_130 -> V_136 . V_33 ) ;
V_162 [ 1 ] = F_111 ( V_169 ) ;
V_9 = F_112 ( V_162 , sizeof( T_1 ) , 2 , V_161 ) ;
if ( V_9 )
...
V_9 = F_112 ( V_231 , sizeof( T_1 ) , 8 , V_161 ) ;
if ( V_9 )
return V_9 ;
V_9 = F_120 ( V_7 , & V_130 -> V_131 [ 0 ] , V_161 ) ;
if ( V_9 )
...
static int F_130 ( struct V_6 * V_7 , void * V_161 )
{
struct V_138 * V_138 ;
struct V_129 * V_130 ;
T_5 V_169 ;
...
if ( V_9 )
return V_9 ;
V_9 = F_112 ( V_138 -> V_150 , 1 , V_169 , V_161 ) ;
if ( V_9 )
return V_9 ;
V_169 = 0 ;
...
if ( V_9 )
return V_9 ;
V_162 [ 0 ] = F_111 ( V_130 -> V_39 . V_230 ) ;
V_9 = F_112 ( V_162 , sizeof( T_1 ) , 1 , V_161 ) ;
if ( V_9 )
return V_9 ;
V_9 = F_120 ( V_7 , & V_130 -> V_131 [ 0 ] , V_161 ) ;
...
static int F_132 ( void * V_8 , void * V_272 , void * V_267 )
{
T_2 V_162 [ 2 ] ;
...
struct V_6 * V_7 = V_269 -> V_7 ;
int V_9 ;
V_162 [ 0 ] = F_111 ( V_128 -> V_41 ) ;
V_162 [ 1 ] = F_111 ( V_128 -> V_42 ) ;
V_9 = F_112 ( V_162 , sizeof( T_1 ) , 2 , V_161 ) ;
if ( V_9 )
return V_9 ;
if ( V_7 -> V_165 >= V_218 ) {
V_162 [ 0 ] = F_111 ( V_128 -> V_43 ) ;
V_9 = F_112 ( V_162 , sizeof( T_1 ) , 1 , V_161 ) ;
if ( V_9 )
return V_9 ;
}
V_9 = F_114 ( V_160 , V_161 ) ;
if ( V_9 )
return V_9 ;
return 0 ;
}
static int F_133 ( struct V_6 * V_7 , void * V_161 )
{
T_2 V_162 [ 1 ] ;
int V_9 , V_97 ;
struct V_268 V_269 ;
...
if ( V_9 )
return V_9 ;
V_9 = F_40 ( V_7 -> V_50 , F_132 , & V_269 ) ;
if ( V_9 )
return V_9 ;
return 0 ;
}
static int F_134 ( void * V_8 , void * V_272 , void * V_267 )
{
T_2 V_162 [ 4 ] ;
struct V_25 * V_26 = V_8 ;
...
if ( V_9 )
return V_9 ;
V_9 = F_112 ( V_26 -> V_33 , sizeof( char ) , V_169 , V_161 ) ;
if ( V_9 )
return V_9 ;
V_162 [ 0 ] = F_111 ( V_26 -> V_30 ) ;
V_162 [ 1 ] = F_111 ( V_26 -> V_31 ) ;
V_162 [ 2 ] = F_111 ( V_26 -> V_32 ) ;
V_162 [ 3 ] = F_111 ( V_222 -> V_222 ) ;
V_9 = F_112 ( V_162 , sizeof( T_1 ) , 4 , V_161 ) ;
if ( V_9 )
return V_9 ;
return 0 ;
...
if ( V_9 )
return V_9 ;
V_9 = F_40 ( V_7 -> V_25 , F_134 , V_161 ) ;
if ( V_9 )
return V_9 ;
return 0 ;
}
int F_136 ( struct V_6 * V_7 , void * V_161 )
{
...
V_162 [ 0 ] = F_111 ( V_7 -> V_165 ) ;
V_162 [ 1 ] = F_111 ( V_275 ) ;
V_162 [ 2 ] = F_111 ( V_4 -> V_258 ) ;
V_162 [ 3 ] = F_111 ( V_4 -> V_232 ) ;
V_9 = F_112 ( V_162 , sizeof( T_1 ) , 4 , V_161 ) ;
if ( V_9 )
return V_9 ;
if ( V_7 -> V_165 >= V_256 ) {
V_9 = F_113 ( & V_7 -> V_52 , V_161 ) ;
if ( V_9 )
return V_9 ;
}
if ( V_7 -> V_165 >= V_257 ) {
V_9 = F_113 ( & V_7 -> V_53 , V_161 ) ;
if ( V_9 )
return V_9 ;
}
V_274 = V_4 -> V_258 ;
...
V_269 . V_161 = V_161 ;
V_269 . V_7 = V_7 ;
V_162 [ 0 ] = F_111 ( V_7 -> V_47 [ V_3 ] . V_17 ) ;
V_162 [ 1 ] = F_111 ( V_7 -> V_47 [ V_3 ] . V_21 -> V_97 ) ;
V_9 = F_112 ( V_162 , sizeof( T_1 ) , 2 , V_161 ) ;
if ( V_9 )
return V_9 ;
V_9 = F_40 ( V_7 -> V_47 [ V_3 ] . V_21 , V_276 [ V_3 ] , & V_269 ) ;
if ( V_9 )
return V_9 ;
}
V_9 = F_137 ( V_7 , & V_7 -> V_49 , V_161 ) ;
if ( V_9 )
return V_9 ;
V_9 = F_138 ( V_7 , V_7 -> V_277 , V_161 ) ;
if ( V_9 )
return V_9 ;
V_9 = F_118 ( V_7 , V_161 ) ;
if ( V_9 )
return V_9 ;
V_9 = F_119 ( V_7 -> V_141 , V_161 ) ;
if ( V_9 )
return V_9 ;
V_9 = F_135 ( V_7 , V_161 ) ;
if ( V_9 )
return V_9 ;
V_9 = F_129 ( V_7 , V_4 , V_161 ) ;
if ( V_9 )
return V_9 ;
V_9 = F_130 ( V_7 , V_161 ) ;
if ( V_9 )
