...
F_23 ( V_44 ) -> V_51 = 0 ;
memcpy ( F_24 ( V_44 , V_29 -> V_47 ) , V_45 , V_29 -> V_47 ) ;
V_44 -> V_17 = V_17 ;
F_25 ( V_44 , V_29 -> V_7 ) ;
F_26 ( V_44 , 1 ) ;
V_29 -> V_48 ++ ;
...
if ( ! V_44 )
return;
memcpy ( F_24 ( V_44 , sizeof( * V_53 ) ) , V_53 , sizeof( * V_53 ) ) ;
if ( V_53 -> V_37 ) {
V_55 = (struct V_1 * ) F_29 ( V_44 ) ;
memcpy ( F_24 ( V_44 , V_58 ) , V_46 , V_58 ) ;
if ( V_53 -> V_37 == 1 )
V_55 -> V_35 &= V_60 ;
}
if ( V_54 ) {
...
return - V_132 ;
F_22 ( V_44 ) ;
V_59 = F_73 ( F_24 ( V_44 , V_47 ) , V_123 , V_47 ) ;
if ( V_59 < 0 ) {
F_32 ( V_44 ) ;
return V_59 ;
}
...
static int F_83 ( struct V_143 * V_6 , struct V_122 * V_123 , T_3 V_144 )
{
...
return - V_120 ;
if ( ! V_15 && V_123 -> V_148 ) {
F_84 ( struct V_56 * , V_57 , V_123 -> V_148 ) ;
...
static int F_87 ( struct V_160 * V_161 , unsigned long V_123 ,
void * V_162 )
{
struct V_16 * V_17 = F_88 ( V_162 ) ;
struct V_5 * V_27 = F_39 ( V_161 , struct V_5 , V_163 ) ;
struct V_6 * V_7 = & V_27 -> V_7 ;
struct V_28 * V_29 ;
int V_164 = 0 ;
if ( ! F_89 ( F_64 ( V_17 ) , F_19 ( V_7 ) ) )
return V_165 ;
if ( V_17 -> type != V_150 )
return V_165 ;
switch ( V_123 ) {
...
F_92 ( & V_27 -> V_126 ) ;
F_92 ( & V_27 -> V_141 ) ;
V_27 -> V_163 . V_173 = F_87 ;
F_93 ( & V_27 -> V_163 ) ;
return 0 ;
}
static int F_94 ( struct V_143 * V_6 )
{
struct V_6 * V_7 = V_6 -> V_7 ;
...
F_97 ( V_27 -> V_178 , V_13 -> V_176 . V_177 ) ;
#endif
if ( V_27 -> V_146 ) {
V_27 -> V_146 = 0 ;
V_27 -> V_15 = 0 ;
...
static int F_100 ( struct V_143 * V_6 , struct V_179 * V_180 , int V_94 ,
int V_35 )
{
...
#if F_96 ( V_175 )
if ( V_13 -> V_176 . V_177 ) {
sprintf ( V_27 -> V_178 , L_28 , F_101 ( V_7 ) ) ;
V_27 -> V_172 = F_102 ( V_27 -> V_178 , 0644 ,
V_13 -> V_176 . V_177 ,
& V_183 , V_7 ) ;
if ( ! V_27 -> V_172 ) {
V_145 = - V_132 ;
...
static int F_103 ( struct V_143 * V_6 , struct V_122 * V_123 , T_3 V_144 ,
int V_35 )
{
struct V_6 * V_7 = V_6 -> V_7 ;
struct V_43 * V_44 ;
...
V_184 = V_35 & V_185 ;
V_35 &= ~ V_185 ;
V_44 = F_104 ( V_7 , V_35 , V_184 , & error ) ;
if ( ! V_44 )
return error ;
if ( V_44 -> V_94 < V_144 )
V_144 = V_44 -> V_94 ;
V_59 = F_105 ( V_123 , V_44 -> V_4 , V_144 ) ;
if ( V_59 < 0 ) {
F_106 ( V_7 , V_44 ) ;
return V_59 ;
}
F_107 ( V_123 , V_7 , V_44 ) ;
if ( V_123 -> V_148 ) {
F_108 ( sizeof( struct V_56 ) ) ;
...
static int F_109 ( struct V_13 * V_13 )
{
#if F_96 ( V_175 )
V_13 -> V_176 . V_177 = F_110 ( V_13 , L_29 , V_13 -> V_186 ) ;
#endif
return 0 ;
}
static void F_111 ( struct V_13 * V_13 )
{
#if F_96 ( V_175 )
if ( V_13 -> V_176 . V_177 )
F_97 ( L_29 , V_13 -> V_186 ) ;
#endif
}
static int T_4 F_112 ( void )
{
int V_59 ;
F_113 ( L_30 V_187 L_31 ) ;
V_59 = F_114 ( & V_188 ) ;
if ( V_59 < 0 ) {
F_66 ( V_117 L_32 ) ;
return V_59 ;
