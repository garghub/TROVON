...
V_20 -> V_126 [ V_4 ] . V_110 =
V_20 -> V_127 + V_4 * V_112 ;
V_20 -> V_126 [ V_4 ] . V_113 = V_112 ;
V_20 -> V_126 [ V_4 ] . V_115 = V_20 -> V_116 -> V_117 ;
V_20 -> V_128 [ V_4 ] . V_118 = NULL ;
V_20 -> V_128 [ V_4 ] . V_119 = & V_20 -> V_126 [ V_4 ] ;
V_20 -> V_128 [ V_4 ] . V_120 = 1 ;
}
}
...
if ( ! V_20 -> V_54 )
return;
V_130 = V_20 -> V_54 -> V_130 ;
if ( V_20 -> V_127 ) {
F_44 ( V_130 , V_20 -> V_127 ,
V_112 * V_20 -> V_74 ,
V_131 ) ;
V_20 -> V_127 = 0 ;
}
if ( V_20 -> V_111 ) {
F_44 ( V_130 , V_20 -> V_111 ,
V_112 * V_20 -> V_5 ,
V_132 ) ;
V_20 -> V_111 = 0 ;
}
...
{
V_2 -> V_16 = F_48 ( V_105 , V_112 , V_133 ) ;
if ( ! V_2 -> V_16 )
goto V_134;
...
{
struct V_129 * V_130 = V_20 -> V_54 -> V_130 ;
int V_29 = 0 ;
F_55 ( & V_20 -> V_143 , 0 ) ;
V_20 -> V_144 = 0 ;
V_20 -> V_127 = F_56 (
V_130 , V_20 -> V_63 , V_112 * V_20 -> V_74 ,
V_131 ) ;
if ( F_57 ( V_130 , V_20 -> V_127 ) ) {
V_20 -> V_127 = 0 ;
V_29 = - V_145 ;
goto V_146;
}
V_20 -> V_111 = F_56 (
V_130 , V_20 -> V_16 , V_112 * V_20 -> V_5 ,
V_132 ) ;
if ( F_57 ( V_130 , V_20 -> V_111 ) ) {
V_29 = - V_145 ;
goto V_147;
}
F_41 ( V_20 ) ;
