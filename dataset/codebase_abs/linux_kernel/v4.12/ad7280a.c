...
0644 ;
V_10 -> V_88 [ V_4 ] . V_90 . V_92 =
F_18 ;
V_10 -> V_88 [ V_4 ] . V_90 . V_93 =
F_22 ;
V_10 -> V_88 [ V_4 ] . V_90 . V_51 . V_94 =
F_33 ( V_66 ,
L_3 ,
V_49 * V_89 + V_59 ,
V_49 * V_89 + V_59 + 1 ) ;
...
case V_98 :
V_8 = 1000 + ( V_10 -> V_99 * 1568 ) / 100 ;
break;
case V_100 :
V_8 = 1000 + ( V_10 -> V_101 * 1568 ) / 100 ;
break;
case V_102 :
V_8 = ( V_10 -> V_103 * 196 ) / 10 ;
break;
case V_104 :
...
unsigned int * V_64 ;
int V_5 , V_13 ;
V_64 = F_30 ( V_10 -> V_108 , sizeof( * V_64 ) , V_66 ) ;
if ( ! V_64 )
return V_109 ;
V_13 = F_15 ( V_10 , V_10 -> V_108 , V_64 ) ;
if ( V_13 < 0 )
goto V_110;
for ( V_5 = 0 ; V_5 < V_10 -> V_108 ; V_5 ++ ) {
...
if ( ( ( V_64 [ V_5 ] >> 11 ) & 0xFFF ) >= V_10 -> V_103 )
F_39 ( V_53 ,
F_42 (
V_74 ,
0 ,
...
F_24 ( & V_10 -> V_60 ) ;
if ( V_115 -> V_57 == V_86 )
V_13 = F_15 ( V_10 , V_10 -> V_108 , NULL ) ;
else
V_13 = F_14 ( V_10 , V_115 -> V_57 >> 8 ,
V_115 -> V_57 & 0xFF ) ;
F_25 ( & V_10 -> V_60 ) ;
if ( V_13 < 0 )
return V_13 ;
...
static int F_45 ( struct V_121 * V_21 )
{
const struct V_122 * V_123 = F_46 ( & V_21 -> V_49 ) ;
struct V_9 * V_10 ;
int V_13 ;
...
V_123 = & V_126 ;
F_1 ( V_10 -> V_1 ) ;
V_10 -> V_21 -> V_127 = V_128 ;
V_10 -> V_21 -> V_91 = V_129 ;
F_50 ( V_10 -> V_21 ) ;
V_10 -> V_46 = F_51 ( V_123 -> V_130 & 0x3 ) ;
V_10 -> V_31 = F_52 ( V_123 -> V_131
& 0x3 ) | ( V_123 -> V_132 ?
V_133 : 0 ) ;
V_13 = F_16 ( V_10 ) ;
if ( V_13 < 0 )
...
V_10 -> V_12 += 5 ;
V_53 -> V_94 = F_54 ( V_21 ) -> V_94 ;
V_53 -> V_49 . V_135 = & V_21 -> V_49 ;
V_53 -> V_136 = V_137 ;
V_13 = F_29 ( V_10 ) ;
if ( V_13 < 0 )
return V_13 ;
...
static int F_58 ( struct V_121 * V_21 )
{
struct V_52 * V_53 = F_59 ( V_21 ) ;
struct V_9 * V_10 = F_20 ( V_53 ) ;
if ( V_21 -> V_106 > 0 )
F_60 ( V_21 -> V_106 , V_53 ) ;
F_57 ( V_53 ) ;
