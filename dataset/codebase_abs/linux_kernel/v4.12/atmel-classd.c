...
struct V_46 * V_47 = V_63 -> V_47 ;
int V_69 ;
int V_70 , V_71 , V_72 , V_73 , V_9 ;
T_1 V_49 , V_50 ;
V_69 = F_28 ( V_32 ) ;
V_71 = 0 ;
V_72 = abs ( V_69 - V_74 [ 0 ] . V_75 ) ;
for ( V_70 = 1 ; V_70 < F_29 ( V_74 ) ; V_70 ++ ) {
V_73 = abs ( V_69 - V_74 [ V_70 ] . V_75 ) ;
if ( V_73 < V_72 ) {
V_71 = V_70 ;
V_72 = V_73 ;
}
...
F_30 ( V_47 -> V_3 ,
L_12 ,
V_74 [ V_71 ] . V_75 , V_74 [ V_71 ] . V_76 ) ;
F_12 ( V_26 -> V_65 ) ;
F_12 ( V_26 -> V_64 ) ;
V_9 = F_31 ( V_26 -> V_64 , V_74 [ V_71 ] . V_76 ) ;
if ( V_9 )
return V_9 ;
V_49 = V_77 | V_78 ;
V_50 = ( V_74 [ V_71 ] . V_79 << V_80 )
| ( V_74 [ V_71 ] . V_81 << V_82 ) ;
F_19 ( V_47 , V_83 , V_49 , V_50 ) ;
V_9 = F_10 ( V_26 -> V_64 ) ;
if ( V_9 )
return V_9 ;
return F_10 ( V_26 -> V_65 ) ;
...
V_27 -> V_98 = V_98 ;
V_27 -> V_106 = 1 ;
V_27 -> V_99 = V_26 -> V_7 -> V_17 ;
V_27 -> V_3 = V_3 ;
return 0 ;
}
static int F_37 ( struct V_107 * V_108 )
{
struct V_2 * V_3 = & V_108 -> V_3 ;
struct V_25 * V_26 ;
struct V_109 * V_110 ;
void T_2 * V_111 ;
...
V_26 -> V_65 = F_42 ( V_3 , L_17 ) ;
if ( F_39 ( V_26 -> V_65 ) ) {
V_9 = F_40 ( V_26 -> V_65 ) ;
F_2 ( V_3 , L_18 , V_9 ) ;
return V_9 ;
}
V_26 -> V_64 = F_42 ( V_3 , L_19 ) ;
if ( F_39 ( V_26 -> V_64 ) ) {
V_9 = F_40 ( V_26 -> V_64 ) ;
F_2 ( V_3 , L_20 , V_9 ) ;
return V_9 ;
}
V_110 = F_43 ( V_108 , V_113 , 0 ) ;
V_111 = F_44 ( V_3 , V_110 ) ;
if ( F_39 ( V_111 ) ) {
V_9 = F_40 ( V_111 ) ;
F_2 ( V_3 , L_21 , V_9 ) ;
return V_9 ;
}
V_26 -> V_42 = V_110 -> V_114 ;
V_26 -> V_28 = F_45 ( V_3 , V_111 ,
& V_115 ) ;
if ( F_39 ( V_26 -> V_28 ) ) {
V_9 = F_40 ( V_26 -> V_28 ) ;
F_2 ( V_3 , L_22 , V_9 ) ;
