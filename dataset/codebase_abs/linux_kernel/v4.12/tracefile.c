...
int V_42 ;
va_start ( args , V_41 ) ;
V_42 = F_33 ( V_40 , V_41 , args , NULL ) ;
va_end ( args ) ;
return V_42 ;
}
int F_33 ( struct V_39 * V_40 ,
...
int V_54 ;
int V_55 = V_40 -> V_56 ;
const char * V_57 = F_34 ( V_40 -> V_58 ) ;
...
V_40 -> V_69 , V_40 -> V_66 ) ;
V_46 . V_70 = V_49 + V_50 ;
V_48 = ( char * ) F_40 ( V_7 -> V_6 ) + V_7 -> V_21 ;
if ( V_67 ) {
...
V_60 -> V_76 = V_75 ;
V_60 -> V_73 = ( F_45 () + V_60 -> V_76 ) | 1 ;
}
if ( V_12 ) {
F_47 ( & V_46 , V_55 , V_47 , V_50 , V_57 ,
V_40 -> V_66 ) ;
F_38 ( V_12 ) ;
} else {
V_47 = F_48 () ;
...
F_51 () ;
F_36 ( & V_81 , V_40 , F_37 () ) ;
F_47 ( & V_81 , V_84 , V_80 , strlen ( V_80 ) ,
V_40 -> V_58 , V_40 -> V_66 ) ;
F_52 ( L_9 ) ;
}
static void
...
F_27 ( & V_35 -> V_37 ) ;
F_54 (tcd, i, j) {
F_55 ( & V_12 -> V_19 , & V_35 -> V_37 ) ;
V_12 -> V_18 = 0 ;
if ( V_35 -> V_86 ) {
F_55 ( & V_12 -> V_87 , & V_35 -> V_37 ) ;
V_12 -> V_88 = 0 ;
}
}
}
...
V_6 = V_7 -> V_6 ;
V_92 = F_40 ( V_6 ) ;
while ( V_92 < ( ( char * ) F_40 ( V_6 ) + V_7 -> V_21 ) ) {
struct V_45 * V_81 ;
int V_17 ;
V_81 = ( void * ) V_92 ;
V_92 += sizeof( * V_81 ) ;
...
F_47 ( V_81 , V_84 , V_92 , V_17 , V_57 , V_93 ) ;
V_92 += V_17 ;
}
F_63 ( & V_7 -> V_4 ) ;
F_10 ( V_7 ) ;
...
int V_42 ;
F_67 () ;
V_95 = F_68 ( V_94 , V_98 | V_99 | V_100 | V_101 ,
0600 ) ;
if ( F_69 ( V_95 ) ) {
V_42 = F_70 ( V_95 ) ;
V_95 = NULL ;
...
F_61 ( V_7 ) ;
V_96 = F_74 ( V_7 -> V_6 ) ;
V_42 = F_75 ( V_95 , ( V_104 const char V_105 * ) V_96 ,
V_7 -> V_21 , & V_95 -> V_106 ) ;
F_76 ( V_7 -> V_6 ) ;
...
int F_81 ( char * V_107 , int V_108 ,
const char V_105 * V_109 , int V_110 )
{
int V_111 ;
if ( V_110 > V_108 )
return - V_112 ;
...
V_109 , V_110 ) )
return - V_113 ;
V_111 = F_83 ( V_107 , V_110 ) ;
while ( V_111 -- >= 0 )
if ( ! isspace ( V_107 [ V_111 ] ) )
break;
if ( V_111 < 0 )
return - V_114 ;
if ( V_111 == V_108 )
...
int F_84 ( char V_105 * V_109 , int V_110 ,
const char * V_107 , char * V_115 )
{
int V_111 = strlen ( V_107 ) ;
if ( V_111 > V_110 )
V_111 = V_110 ;
if ( F_85 ( V_109 , V_107 , V_111 ) )
return - V_113 ;
if ( V_115 && V_111 < V_110 ) {
if ( F_85 ( V_109 + V_111 , V_115 , 1 ) )
return - V_113 ;
V_111 ++ ;
}
return V_111 ;
}
int F_86 ( char * * V_80 , int V_111 )
{
if ( V_111 > 2 * V_22 )
return - V_114 ;
* V_80 = F_7 ( V_111 , V_116 | V_117 ) ;
if ( ! * V_80 )
return - V_118 ;
return 0 ;
}
int F_87 ( void V_105 * V_119 , int V_120 )
{
char * V_80 ;
int V_42 ;
V_42 = F_86 ( & V_80 , V_120 + 1 ) ;
if ( V_42 )
return V_42 ;
V_42 = F_81 ( V_80 , V_120 + 1 ,
V_119 , V_120 ) ;
if ( V_42 )
goto V_102;
if ( V_80 [ 0 ] != '/' ) {
...
} else if ( strlen ( V_80 ) >= sizeof( V_121 ) ) {
V_42 = - V_124 ;
} else if ( V_80 [ 0 ] != '/' ) {
V_42 = - V_114 ;
} else {
...
int F_92 ( void V_105 * V_119 , int V_120 )
{
char * V_80 ;
int V_42 ;
V_42 = F_86 ( & V_80 , V_120 + 1 ) ;
...
F_67 () ;
F_54 (tcd, i, j)
V_12 -> V_23 = ( V_125 * V_12 -> V_128 ) / 100 ;
F_79 () ;
return 0 ;
}
int F_96 ( void )
...
V_129 += V_12 -> V_23 ;
F_98 () ;
return ( V_129 >> ( 20 - V_127 ) ) + 1 ;
}
static int F_99 ( void * V_130 )
{
struct V_34 V_35 ;
struct V_29 * V_30 = V_130 ;
struct V_1 * V_7 ;
struct V_1 * V_36 ;
T_3 V_97 ;
struct V_57 * V_95 ;
...
static T_5 V_106 ;
F_61 ( V_7 ) ;
if ( V_106 >= ( V_136 ) V_122 )
V_106 = 0 ;
else if ( V_106 > F_101 ( F_102 ( V_95 ) ) )
V_106 = F_101 ( F_102 ( V_95 ) ) ;
V_96 = F_74 ( V_7 -> V_6 ) ;
V_42 = F_75 ( V_95 , ( V_104 const char V_105 * ) V_96 ,
V_7 -> V_21 , & V_106 ) ;
F_76 ( V_7 -> V_6 ) ;
...
F_107 ( & V_133 , V_138 ) ;
F_108 ( & V_30 -> V_32 , & V_133 ) ;
F_109 ( V_139 ) ;
F_110 ( F_46 ( 1 ) ) ;
F_111 ( & V_30 -> V_32 , & V_133 ) ;
}
F_100 ( & V_30 -> V_140 ) ;
return 0 ;
}
