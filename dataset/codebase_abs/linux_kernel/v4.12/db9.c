...
snprintf ( V_33 -> V_93 [ V_8 ] , sizeof( V_33 -> V_93 [ V_8 ] ) ,
L_7 , V_33 -> V_34 -> V_2 -> V_94 , V_8 ) ;
V_12 -> V_94 = V_70 -> V_94 ;
V_12 -> V_93 = V_33 -> V_93 [ V_8 ] ;
V_12 -> V_11 . V_95 = V_96 ;
V_12 -> V_11 . V_97 = 0x0002 ;
V_12 -> V_11 . V_98 = V_25 ;
V_12 -> V_11 . V_99 = 0x0100 ;
F_37 ( V_12 , V_33 ) ;
V_12 -> V_100 = F_18 ;
V_12 -> V_101 = F_24 ;
V_12 -> V_102 [ 0 ] = F_38 ( V_103 ) | F_38 ( V_104 ) ;
for ( V_9 = 0 ; V_9 < V_70 -> V_82 ; V_9 ++ )
F_39 ( V_70 -> V_105 [ V_9 ] , V_12 -> V_106 ) ;
for ( V_9 = 0 ; V_9 < V_70 -> V_107 ; V_9 ++ ) {
if ( V_9 < 2 )
...
if ( V_109 [ V_8 ] && V_109 [ V_8 ] -> V_91 == V_2 -> V_79 )
break;
}
if ( V_8 == V_75 )
return;
