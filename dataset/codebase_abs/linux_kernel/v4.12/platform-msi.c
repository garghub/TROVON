...
if ( ! V_11 )
goto V_68;
V_63 = F_41 ( V_11 -> V_49 , V_39 , V_41 , & V_22 -> V_8 ) ;
if ( V_63 )
goto V_69;
return V_11 ;
V_69:
...
void F_43 ( struct V_10 * V_11 , unsigned int V_14 ,
unsigned int V_41 )
{
struct V_25 * V_22 = V_11 -> V_66 ;
struct V_1 * V_2 ;
F_44 (desc, data->dev) {
if ( F_45 ( ! V_2 -> V_45 || V_2 -> V_70 != 1 ) )
return;
if ( ! ( V_2 -> V_45 >= V_14 && V_2 -> V_45 < ( V_14 + V_41 ) ) )
continue;
F_46 ( V_11 , V_2 -> V_45 , 1 ) ;
}
}
int F_47 ( struct V_10 * V_11 , unsigned int V_14 ,
unsigned int V_71 )
{
struct V_25 * V_22 = V_11 -> V_66 ;
int V_63 ;
