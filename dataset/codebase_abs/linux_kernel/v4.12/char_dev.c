...
void F_49 ( struct V_34 * V_41 , struct V_40 * V_39 )
{
F_50 ( ! V_39 -> V_63 ) ;
V_41 -> V_39 . V_62 = V_39 ;
}
int F_51 ( struct V_34 * V_34 , struct V_64 * V_31 )
{
int V_65 = 0 ;
if ( V_31 -> V_66 ) {
F_49 ( V_34 , & V_31 -> V_39 ) ;
V_65 = F_24 ( V_34 , V_31 -> V_66 , 1 ) ;
if ( V_65 )
return V_65 ;
}
V_65 = F_52 ( V_31 ) ;
...
void F_53 ( struct V_34 * V_34 , struct V_64 * V_31 )
{
F_54 ( V_31 ) ;
if ( V_31 -> V_66 )
F_28 ( V_34 ) ;
}
static void F_55 ( T_2 V_31 , unsigned V_27 )
{
F_56 ( V_50 , V_31 , V_27 ) ;
}
void F_28 ( struct V_34 * V_41 )
{
F_55 ( V_41 -> V_31 , V_41 -> V_27 ) ;
F_25 ( & V_41 -> V_39 ) ;
}
static void F_57 ( struct V_40 * V_39 )
{
...
static void F_58 ( struct V_40 * V_39 )
{
struct V_34 * V_41 = F_38 ( V_39 , struct V_34 , V_39 ) ;
struct V_40 * V_62 = V_39 -> V_62 ;
F_44 ( V_41 ) ;
...
void F_61 ( struct V_34 * V_34 , const struct V_32 * V_33 )
{
...
static struct V_40 * F_62 ( T_2 V_31 , int * V_60 , void * V_61 )
{
if ( F_63 ( L_4 , F_16 ( V_31 ) , F_17 ( V_31 ) ) > 0 )
F_63 ( L_5 , F_16 ( V_31 ) ) ;
return NULL ;
}
void T_3 F_64 ( void )
