...
int V_5 = 0 ;
struct V_6 * V_7 = F_2 ( V_2 ) ;
if ( F_85 ( F_86 ( V_4 ) == V_131 ) ) {
if ( F_85 ( V_7 -> V_29 > 1 ) )
V_5 = F_66 ( V_2 , V_4 ) ;
else
goto V_14;
} else if ( F_86 ( V_4 ) == V_133 ) {
if ( F_85 ( V_7 -> V_29 > 1 ) )
V_5 = F_1 ( V_2 , V_4 ) ;
else
goto V_14;
...
struct V_6 * V_7 = F_2 ( V_2 ) ;
V_7 -> V_29 = V_134 ;
V_7 -> V_135 = V_7 -> V_136 = 2 ;
V_7 -> V_137 = V_7 -> V_138 = 1 ;
F_88 ( & V_7 -> V_139 . V_140 , V_141 ,
( unsigned long ) V_2 ) ;
V_7 -> V_139 . V_142 = V_143 ;
F_88 ( & V_7 -> V_144 . V_140 , V_145 ,
( unsigned long ) V_2 ) ;
V_7 -> V_144 . V_142 = V_146 ;
F_88 ( & V_7 -> V_147 . V_140 , V_148 ,
( unsigned long ) V_2 ) ;
V_7 -> V_147 . V_142 = V_149 ;
F_88 ( & V_7 -> V_150 . V_140 , V_151 ,
( unsigned long ) V_2 ) ;
V_7 -> V_150 . V_142 = V_152 ;
V_7 -> V_153 = 2 ;
V_7 -> V_154 = 2 ;
V_7 -> V_155 = 128 ;
F_89 ( & V_7 -> V_49 ) ;
...
struct V_1 * F_68 ( struct V_157 * V_157 , int V_158 , T_6 V_159 , struct V_160 * V_161 , int V_162 )
{
struct V_1 * V_2 = F_90 ( V_157 , V_158 , V_159 , V_161 , V_162 ) ;
if ( ! V_2 )
goto V_48;
F_87 ( V_2 ) ;
F_91 ( NULL , V_2 ) ;
