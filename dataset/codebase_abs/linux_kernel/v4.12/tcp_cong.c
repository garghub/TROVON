...
int F_50 ( struct V_23 * V_24 , const char * V_2 )
{
struct V_25 * V_26 = F_25 ( V_24 ) ;
const struct V_1 * V_4 ;
int V_49 = 0 ;
...
T_1 F_53 ( struct V_54 * V_55 , T_1 V_56 )
{
T_1 V_57 = F_54 ( V_55 -> V_58 + V_56 , V_55 -> V_59 ) ;
V_56 -= V_57 - V_55 -> V_58 ;
V_55 -> V_58 = F_54 ( V_57 , V_55 -> V_60 ) ;
return V_56 ;
}
void F_55 ( struct V_54 * V_55 , T_1 V_61 , T_1 V_56 )
{
if ( V_55 -> V_62 >= V_61 ) {
V_55 -> V_62 = 0 ;
V_55 -> V_58 ++ ;
...
V_55 -> V_58 = F_54 ( V_55 -> V_58 , V_55 -> V_60 ) ;
}
void F_56 ( struct V_23 * V_24 , T_1 V_64 , T_1 V_56 )
{
struct V_54 * V_55 = F_31 ( V_24 ) ;
if ( ! F_57 ( V_24 ) )
return;
if ( F_58 ( V_55 ) ) {
V_56 = F_53 ( V_55 , V_56 ) ;
...
F_55 ( V_55 , V_55 -> V_58 , V_56 ) ;
}
T_1 F_59 ( struct V_23 * V_24 )
{
const struct V_54 * V_55 = F_31 ( V_24 ) ;
