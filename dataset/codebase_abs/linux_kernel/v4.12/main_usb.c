...
F_40 ( V_2 , V_130 ) ;
V_2 -> V_132 = 0 ;
if ( ! F_41 ( V_133 , & V_2 -> V_127 ) )
F_42 ( V_2 ) ;
F_43 ( V_120 ) ;
F_44 ( V_126 , & V_2 -> V_127 ) ;
F_45 ( & V_2 -> V_134 ) ;
V_2 -> V_135 = false ;
F_18 ( V_2 ) ;
F_22 ( V_2 ) ;
...
static int F_46 ( struct V_119 * V_120 , struct V_136 * V_137 )
{
struct V_1 * V_2 = V_120 -> V_2 ;
V_2 -> V_137 = V_137 ;
switch ( V_137 -> type ) {
...
static int F_50 ( struct V_119 * V_120 , T_2 V_152 )
{
struct V_1 * V_2 = V_120 -> V_2 ;
...
F_51 ( V_2 , V_154 -> V_157 ) ;
else
F_52 ( V_2 ) ;
}
if ( ( V_152 & V_158 ) ||
( V_154 -> V_127 & V_159 ) ) {
F_53 ( V_2 , V_154 -> V_160 . V_161 -> V_162 ) ;
...
F_14 ( V_2 , V_150 ,
V_151 ) ;
F_65 ( V_2 , V_154 -> V_189 -> V_162 ,
V_154 -> V_190 , V_2 -> V_191 ) ;
F_66 ( V_2 , V_154 -> V_192 ) ;
F_67 ( V_2 , V_154 -> V_192 ) ;
} else {
F_68 ( V_2 ) ;
F_15 ( V_2 , V_150 ,
V_151 ) ;
...
static T_3 F_69 ( struct V_119 * V_120 ,
struct V_193 * V_194 )
{
struct V_1 * V_2 = V_120 -> V_2 ;
struct V_195 * V_196 ;
...
T_2 V_198 = 0 ;
F_70 (ha, mc_list) {
V_198 = F_71 ( V_199 , V_196 -> V_200 ) >> 26 ;
...
static int F_74 ( struct V_119 * V_120 , enum V_214 V_215 ,
...
switch ( V_215 ) {
case V_220 :
if ( F_75 ( V_120 , V_217 , V_137 , V_219 ) )
return - V_146 ;
break;
case V_221 :
if ( F_41 ( V_219 -> V_222 , & V_2 -> V_132 ) )
...
static T_3 F_79 ( struct V_119 * V_120 , struct V_136 * V_137 )
{
struct V_1 * V_2 = V_120 -> V_2 ;
return V_2 -> V_191 ;
}
static void F_80 ( struct V_119 * V_120 , struct V_136 * V_137 ,
T_3 V_226 )
{
struct V_1 * V_2 = V_120 -> V_2 ;
F_81 ( V_2 , V_226 , V_137 -> V_227 . V_192 ) ;
}
...
static int
F_87 ( struct V_231 * V_232 , const struct V_233 * V_234 )
{
struct V_235 * V_236 ;
struct V_1 * V_2 ;
struct V_119 * V_120 ;
struct V_237 * V_237 ;
int V_207 = 0 ;
V_236 = F_88 ( F_89 ( V_232 ) ) ;
F_90 ( & V_236 -> V_41 , L_16 ,
V_238 , V_239 ) ;
F_90 ( & V_236 -> V_41 ,
L_17 ) ;
V_120 = F_91 ( sizeof( struct V_1 ) , & V_240 ) ;
if ( ! V_120 ) {
...
F_92 ( & V_2 -> V_242 ) ;
F_93 ( & V_2 -> V_243 ) ;
F_94 ( & V_2 -> V_134 , V_244 ) ;
F_95 ( V_232 , V_2 ) ;
V_237 = V_2 -> V_120 -> V_237 ;
V_237 -> V_245 = V_246 ;
V_237 -> V_247 = V_248 ;
V_237 -> V_249 = F_96 ( V_138 ) |
F_96 ( V_139 ) | F_96 ( V_144 ) ;
F_97 ( V_2 -> V_120 , V_250 ) ;
F_97 ( V_2 -> V_120 , V_251 ) ;
F_97 ( V_2 -> V_120 , V_252 ) ;
F_97 ( V_2 -> V_120 , V_253 ) ;
F_97 ( V_2 -> V_120 , V_254 ) ;
V_2 -> V_120 -> V_255 = 100 ;
F_98 ( V_2 -> V_120 , & V_232 -> V_41 ) ;
V_207 = F_99 ( V_2 -> V_40 ) ;
if ( V_207 )
F_100 ( & V_2 -> V_40 -> V_41 ,
L_19 , V_256 , V_207 ) ;
...
F_95 ( V_232 , NULL ) ;
F_103 ( F_89 ( V_232 ) ) ;
F_44 ( V_133 , & V_2 -> V_127 ) ;
F_107 ( V_2 -> V_120 ) ;
}
static int F_108 ( struct V_231 * V_232 , T_4 V_258 )
{
return 0 ;
}
static int F_109 ( struct V_231 * V_232 )
{
return 0 ;
}
