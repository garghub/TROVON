...
V_19 = F_6 ( sizeof( * V_19 ) , V_6 ) ;
if ( ! V_19 ) {
V_15 = - V_7 ;
goto V_20;
}
V_19 -> V_12 = V_12 ;
if ( F_7 ( & V_19 -> V_13 , V_13 ) ) {
F_8 ( V_19 ) ;
V_15 = - V_7 ;
goto V_20;
}
...
static struct V_13 * F_10 ( struct V_1 * V_2 , T_1 V_12 , int V_23 )
{
int V_14 ;
struct V_16 * V_18 ;
if ( ! V_2 )
...
return & V_18 -> V_13 ;
if ( ! V_18 || V_12 != V_18 -> V_12 || V_18 -> V_13 . V_24 ) {
V_12 = V_25 ;
V_14 = F_5 ( V_12 ) ;
V_18 = V_2 -> V_4 [ V_14 ] ;
while ( V_18 && V_12 > V_18 -> V_12 )
...
V_18 = V_2 -> V_4 [ V_3 ] ;
while ( V_18 ) {
V_15 = F_14 ( V_18 -> V_12 , & V_18 -> V_13 , args ) ;
if ( V_15 )
goto V_20;
V_18 = V_18 -> V_21 ;
}
...
static void F_15 ( struct V_1 * V_2 , struct V_16 * V_26 , int V_27 )
{
F_16 ( V_27 >= V_28 ) ;
while ( V_27 > 0 ) {
...
V_18 = V_2 -> V_4 [ V_3 ] ;
while ( V_18 ) {
if ( F_18 ( & V_18 -> V_13 , V_13 ) ) {
F_15 ( V_2 , V_18 , V_28 - 1 ) ;
return V_18 -> V_12 ;
}
V_18 = V_18 -> V_21 ;
}
