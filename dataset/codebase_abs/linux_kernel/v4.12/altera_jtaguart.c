...
static void F_43 ( struct V_56 * V_57 , const char * V_58 ,
unsigned int V_34 )
{
struct V_65 * V_66 = V_57 -> V_43 ;
F_39 ( & V_66 -> V_2 , V_58 , V_34 , F_36 ) ;
}
static int T_2 F_44 ( struct V_65 * V_66 ,
const char * V_61 )
{
if ( ! V_66 -> V_2 . V_3 )
return - V_63 ;
