...
{
struct V_5 * V_6 = F_3 ( V_4 ) ;
F_8 ( V_4 , V_66 , V_6 -> V_40 ) ;
F_8 ( V_4 , V_67 , V_6 -> V_45 |
V_6 -> V_35 |
V_6 -> V_46 ) ;
}
...
return 0 ;
if ( V_76 )
V_77 = F_4 ( V_4 ) ? 0x0e000000 : 0x0f000000 ;
F_8 ( V_4 , V_78 , V_77 ) ;
return 0 ;
}
...
if ( F_29 ( V_2 ) )
F_8 ( V_4 , V_87 , ( * V_84 ) << V_86 ) ;
else
* V_84 = ( F_10 ( V_4 , V_88 ) >> V_86 ) ;
V_80 = F_61 ( V_2 , sizeof( * V_84 ) ) ;
}
if ( V_79 && ( V_15 & ( V_89 | V_90 ) ) )
V_81 = true ;
F_7 ( V_4 ) ;
V_83:
F_62 ( & V_12 -> V_82 ) ;
...
static struct V_101 * F_82 ( struct V_1 * V_2 ,
struct V_3 * V_4 )
{
struct V_11 * V_12 = F_12 ( V_4 ) ;
int V_102 = F_29 ( V_2 ) ;
...
struct V_3 * F_70 ( struct V_11 * V_12 , int V_111 )
{
if ( F_91 ( V_111 < 0 || V_111 >= F_92 ( V_12 ) ) )
V_111 = 0 ;
return F_93 ( F_94 ( V_12 , V_111 ) ) ;
}
int F_68 ( struct V_3 * V_4 )
{
struct V_5 * V_6 = F_3 ( V_4 ) ;
return ! ! ( F_5 ( V_6 ) & V_112 ) ;
}
...
V_6 = F_99 ( V_14 , sizeof( * V_6 ) * V_117 , V_119 ) ;
if ( ! V_6 ) {
V_29 = - V_120 ;
goto V_118;
}
...
F_89 (node, np) {
V_6 = F_94 ( V_12 , V_16 ) ;
snprintf ( V_103 , V_116 , L_11 ,
V_122 , V_16 ) ;
V_115 = F_100 ( V_14 , V_103 ) ;
if ( F_101 ( V_115 ) ) {
V_29 = F_102 ( V_115 ) ;
goto V_118;
}
if ( F_103 ( V_110 , L_12 , NULL ) )
V_6 -> V_123 |= V_112 ;
if ( F_103 ( V_110 , L_13 , NULL ) )
V_6 -> V_123 |= V_8 ;
V_6 -> V_91 = F_104 ( V_110 , 0 ) ;
if ( ! V_6 -> V_91 ) {
V_29 = - V_34 ;
goto V_118;
}
...
V_99 = & V_104 ;
V_29 = F_106 ( V_12 , F_93 ( V_6 ) , V_99 , V_115 ,
F_95 , V_105 , V_16 ) ;
if ( V_29 )
goto V_118;
V_16 ++ ;
