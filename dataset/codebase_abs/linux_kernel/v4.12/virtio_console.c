...
V_55 = F_148 ( V_9 -> V_21 , V_191 , V_188 ,
V_186 ,
...
F_155 ( & V_9 -> V_162 ) ;
F_156 ( V_9 -> V_21 ) ;
F_157 ( & V_9 -> V_184 , & F_145 ) ;
F_157 ( & V_9 -> V_180 , & F_137 ) ;
if ( V_194 ) {
unsigned int V_145 ;
F_118 ( & V_9 -> V_182 ) ;
F_118 ( & V_9 -> V_62 ) ;
...
static int F_164 ( struct V_20 * V_21 )
{
struct V_8 * V_9 ;
struct V_1 * V_1 ;
int V_52 ;
...
{
int V_55 ;
V_132 . V_158 = F_166 ( V_206 , L_38 ) ;
if ( F_101 ( V_132 . V_158 ) ) {
V_55 = F_102 ( V_132 . V_158 ) ;
F_167 ( L_39 , V_55 ) ;
return V_55 ;
}
V_132 . V_164 = F_168 ( L_38 , NULL ) ;
if ( ! V_132 . V_164 )
F_169 ( L_40 ) ;
F_155 ( & V_132 . V_134 ) ;
F_155 ( & V_132 . V_201 ) ;
