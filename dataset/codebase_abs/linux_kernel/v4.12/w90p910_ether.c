...
V_6 = F_2 ( V_2 ) ;
V_15 = V_6 -> V_15 ;
V_123 = & V_6 -> V_46 -> V_58 [ V_6 -> V_102 ] ;
V_60 = V_6 -> V_46 -> V_61 [ V_6 -> V_102 ] ;
if ( V_122 > 1514 ) {
F_45 ( & V_15 -> V_2 , L_7 , V_122 ) ;
V_122 = 1514 ;
}
V_123 -> V_62 = V_122 & 0xFFFF ;
memcpy ( V_60 , V_105 , V_122 ) ;
V_123 -> V_63 = V_124 | V_125 | V_126 | V_127 ;
F_29 ( V_2 , 1 ) ;
F_23 ( V_2 ) ;
if ( ++ V_6 -> V_102 >= V_56 )
V_6 -> V_102 = 0 ;
...
static int F_46 ( struct V_128 * V_129 , struct V_1 * V_2 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
if ( ! ( F_44 ( V_2 , V_129 -> V_105 , V_129 -> V_130 ) ) ) {
V_6 -> V_129 = V_129 ;
F_47 ( V_129 ) ;
return 0 ;
}
...
static T_1 F_48 ( int V_132 , void * V_35 )
{
struct V_5 * V_6 ;
struct V_45 * V_123 ;
struct V_14 * V_15 ;
...
V_15 = V_6 -> V_15 ;
F_25 ( V_2 , & V_135 ) ;
V_133 = F_3 ( V_6 -> V_8 + V_136 ) ;
V_134 = V_6 -> V_51 +
F_19 ( struct V_50 , V_58 [ V_6 -> V_103 ] ) ;
while ( V_134 != V_133 ) {
V_123 = & V_6 -> V_46 -> V_58 [ V_6 -> V_103 ] ;
if ( ++ V_6 -> V_103 >= V_56 )
V_6 -> V_103 = 0 ;
if ( V_123 -> V_62 & V_137 ) {
V_2 -> V_138 . V_139 ++ ;
V_2 -> V_138 . V_140 += V_123 -> V_62 & 0xFFFF ;
} else {
V_2 -> V_138 . V_141 ++ ;
}
V_123 -> V_62 = 0x0 ;
...
struct V_128 * V_129 ;
unsigned char * V_105 ;
unsigned int V_122 , V_135 , V_7 , V_134 ;
V_6 = F_2 ( V_2 ) ;
V_15 = V_6 -> V_15 ;
V_146 = & V_6 -> V_48 -> V_58 [ V_6 -> V_104 ] ;
do {
V_7 = F_3 ( V_6 -> V_8 + V_147 ) ;
V_134 = V_6 -> V_55 +
...
F_51 ( V_129 , 2 ) ;
F_52 ( V_129 , V_122 ) ;
F_53 ( V_129 , V_105 , V_122 ) ;
V_129 -> V_150 = F_54 ( V_129 , V_2 ) ;
V_2 -> V_138 . V_151 ++ ;
V_2 -> V_138 . V_152 += V_122 ;
F_55 ( V_129 ) ;
} else {
V_2 -> V_138 . V_153 ++ ;
if ( V_135 & V_154 ) {
...
static T_1 F_56 ( int V_132 , void * V_35 )
{
struct V_1 * V_2 ;
struct V_5 * V_6 ;
struct V_14 * V_15 ;
...
V_6 -> V_151 = 0x0 ;
V_6 -> V_152 = 0x0 ;
if ( F_59 ( V_6 -> V_120 , F_48 ,
0x0 , V_15 -> V_21 , V_2 ) ) {
F_45 ( & V_15 -> V_2 , L_15 ) ;
return - V_131 ;
}
if ( F_59 ( V_6 -> V_121 , F_56 ,
0x0 , V_15 -> V_21 , V_2 ) ) {
F_45 ( & V_15 -> V_2 , L_16 ) ;
F_43 ( V_6 -> V_120 , V_2 ) ;
return - V_131 ;
...
V_6 = F_2 ( V_2 ) ;
if ( V_2 -> V_166 & V_167 )
V_165 = V_168 | V_95 | V_94 | V_93 ;
else if ( ( V_2 -> V_166 & V_169 ) || ! F_62 ( V_2 ) )
V_165 = V_95 | V_94 | V_93 ;
else
V_165 = V_93 | V_94 ;
F_4 ( V_165 , V_6 -> V_8 + V_96 ) ;
}
static int F_63 ( struct V_1 * V_2 ,
struct V_170 * V_171 , int V_172 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
struct V_173 * V_105 = F_64 ( V_171 ) ;
return F_65 ( & V_6 -> V_19 , V_105 , V_172 , NULL ) ;
}
static void F_66 ( struct V_1 * V_2 ,
struct V_174 * V_175 )
{
F_67 ( V_175 -> V_176 , V_177 , sizeof( V_175 -> V_176 ) ) ;
F_67 ( V_175 -> V_178 , V_179 , sizeof( V_175 -> V_178 ) ) ;
}
static int F_68 ( struct V_1 * V_2 ,
struct V_180 * V_172 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
return F_69 ( & V_6 -> V_19 , V_172 ) ;
}
static int F_70 ( struct V_1 * V_2 ,
const struct V_180 * V_172 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
return F_71 ( & V_6 -> V_19 , V_172 ) ;
}
...
struct V_1 * V_2 ;
int error ;
V_2 = F_79 ( sizeof( struct V_5 ) ) ;
if ( ! V_2 )
return - V_53 ;
V_6 = F_2 ( V_2 ) ;
V_6 -> V_194 = F_80 ( V_15 , V_195 , 0 ) ;
if ( V_6 -> V_194 == NULL ) {
F_45 ( & V_15 -> V_2 , L_19 ) ;
error = - V_196 ;
goto V_197;
}
if ( ! F_81 ( V_6 -> V_194 -> V_198 ,
F_82 ( V_6 -> V_194 ) , V_15 -> V_21 ) ) {
F_45 ( & V_15 -> V_2 , L_20 ) ;
error = - V_199 ;
goto V_197;
}
V_6 -> V_8 = F_83 ( V_6 -> V_194 -> V_198 , F_82 ( V_6 -> V_194 ) ) ;
if ( V_6 -> V_8 == NULL ) {
F_45 ( & V_15 -> V_2 , L_21 ) ;
error = - V_196 ;
goto V_200;
}
V_6 -> V_120 = F_84 ( V_15 , 0 ) ;
if ( V_6 -> V_120 < 0 ) {
F_45 ( & V_15 -> V_2 , L_22 ) ;
error = - V_196 ;
goto V_201;
}
V_6 -> V_121 = F_84 ( V_15 , 1 ) ;
if ( V_6 -> V_121 < 0 ) {
F_45 ( & V_15 -> V_2 , L_23 ) ;
error = - V_196 ;
goto V_201;
...
F_85 ( V_15 , V_2 ) ;
V_6 -> V_119 = F_86 ( & V_15 -> V_2 , NULL ) ;
if ( F_87 ( V_6 -> V_119 ) ) {
F_45 ( & V_15 -> V_2 , L_24 ) ;
error = F_88 ( V_6 -> V_119 ) ;
goto V_201;
}
V_6 -> V_118 = F_86 ( & V_15 -> V_2 , L_25 ) ;
if ( F_87 ( V_6 -> V_118 ) ) {
F_45 ( & V_15 -> V_2 , L_24 ) ;
error = F_88 ( V_6 -> V_118 ) ;
goto V_202;
}
V_6 -> V_15 = V_15 ;
F_76 ( V_2 ) ;
...
F_91 ( V_6 -> V_8 ) ;
V_200:
F_92 ( V_6 -> V_194 -> V_198 , F_82 ( V_6 -> V_194 ) ) ;
V_197:
F_93 ( V_2 ) ;
return error ;
}
