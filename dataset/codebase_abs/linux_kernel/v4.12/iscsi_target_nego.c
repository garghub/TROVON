...
! V_40 -> V_162 )
return 0 ;
if ( strncmp ( V_66 -> V_71 , V_37 , 4 ) && ! V_40 -> V_162 )
return 0 ;
if ( ( V_45 -> V_53 & V_163 ) &&
( V_45 -> V_53 & V_55 ) ) {
V_79 -> V_53 |= V_163 |
...
return 0 ;
V_171:
return F_71 ( V_12 , V_40 ) ;
}
static int F_77 ( struct V_11 * V_12 , struct V_39 * V_40 )
{
int V_166 ;
T_1 V_43 ;
struct V_44 * V_45 ;
...
struct V_24 * V_25 ;
T_1 V_43 , V_194 = 0 ;
int V_195 = 0 , V_166 = 0 , V_196 , V_197 ;
F_80 ( & V_12 -> V_115 , F_54 ) ;
F_80 ( & V_12 -> V_153 , F_65 ) ;
F_41 ( V_12 ) ;
V_40 -> V_132 = V_132 ;
V_45 = (struct V_44 * ) V_40 -> V_46 ;
V_43 = F_13 ( V_45 -> V_47 ) ;
V_188 = F_81 ( V_43 + 1 , V_198 ) ;
if ( ! V_188 ) {
F_4 ( L_87 ) ;
return - 1 ;
}
memcpy ( V_188 , V_40 -> V_160 , V_43 ) ;
V_188 [ V_43 ] = '\0' ;
V_189 = V_188 ;
V_190 = ( V_189 + V_43 ) ;
while ( V_189 < V_190 ) {
if ( F_82 ( V_189 , & V_191 , & V_71 ) < 0 ) {
V_166 = - 1 ;
goto V_199;
}
if ( ! strncmp ( V_191 , L_88 , 13 ) )
V_185 = V_71 ;
else if ( ! strncmp ( V_191 , L_89 , 11 ) )
V_186 = V_71 ;
else if ( ! strncmp ( V_191 , L_90 , 10 ) )
V_187 = V_71 ;
...
F_25 ( L_97 , V_193 -> V_193 ) ;
V_12 -> V_140 = F_86 ( V_193 , V_132 , & V_142 ) ;
if ( ! V_12 -> V_140 ) {
F_4 ( L_98
L_99 , V_193 -> V_193 ) ;
F_87 ( V_193 ) ;
...
V_12 -> V_142 = V_142 ;
F_25 ( L_100 , V_12 -> V_140 -> V_204 ) ;
if ( F_83 ( V_12 ) < 0 ) {
F_4 ( L_91 ) ;
F_88 ( & V_142 -> V_205 , V_206 ) ;
F_87 ( V_193 ) ;
V_12 -> V_140 = NULL ;
V_166 = - 1 ;
goto V_199;
...
V_194 = V_25 -> V_194 ;
V_203:
V_196 = F_90 ( T_1 , V_208 , V_194 ) ;
V_196 = ( V_196 * 2 ) + V_209 ;
V_197 = sizeof( struct V_210 ) + V_12 -> V_95 -> V_211 ;
V_166 = F_91 ( V_17 -> V_28 , V_196 , V_197 ) ;
if ( V_166 < 0 ) {
F_14 ( V_12 , V_93 ,
V_94 ) ;
V_166 = - 1 ;
...
struct V_107 * V_108 = V_12 -> V_107 -> V_108 ;
F_36 ( & V_108 -> V_110 ) ;
F_67 ( V_111 , & V_12 -> V_112 ) ;
F_67 ( V_146 , & V_12 -> V_112 ) ;
F_37 ( & V_108 -> V_110 ) ;
}
V_166 = F_62 ( V_12 , V_40 ) ;
if ( ! V_166 && F_48 ( V_12 , V_146 ) )
V_166 = - 1 ;
if ( V_166 < 0 ) {
F_66 ( & V_12 -> V_115 ) ;
F_66 ( & V_12 -> V_153 ) ;
