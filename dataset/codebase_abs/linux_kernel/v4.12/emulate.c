...
return V_95 ;
V_2 -> V_6 -> V_132 ( V_2 ) ;
V_95 = F_199 ( L_2 , , [ V_415 ] L_3 ( V_414 ) ) ;
V_2 -> V_6 -> V_133 ( V_2 ) ;
if ( V_95 != V_94 )
return V_95 ;
if ( V_2 -> V_6 -> V_134 ( V_2 , 4 ) & V_416 )
V_74 = F_143 ( struct V_413 , V_417 [ 8 * 16 / 4 ] ) ;
else
V_74 = F_143 ( struct V_413 , V_417 [ 0 ] ) ;
return F_45 ( V_2 , V_2 -> V_174 . V_82 . V_173 , & V_414 , V_74 ) ;
}
...
int V_95 = V_94 ;
struct V_413 V_268 ;
V_95 = F_199 ( L_2 , , [ V_415 ] L_3 ( V_268 ) ) ;
if ( V_95 != V_94 )
return V_95 ;
#ifdef F_42
memcpy ( & V_418 -> V_417 [ 8 * 16 / 4 ] , & V_268 . V_417 [ 8 * 16 / 4 ] , 8 * 16 ) ;
#endif
if ( ! ( V_2 -> V_6 -> V_134 ( V_2 , 4 ) & V_416 ) )
memcpy ( V_418 -> V_417 , V_268 . V_417 , 8 * 16 ) ;
return V_95 ;
}
...
if ( V_95 != V_94 )
return V_95 ;
V_95 = F_44 ( V_2 , V_2 -> V_174 . V_82 . V_173 , & V_414 , 512 ) ;
if ( V_95 != V_94 )
return V_95 ;
if ( V_414 . V_419 >> 16 )
return F_25 ( V_2 , 0 ) ;
V_2 -> V_6 -> V_132 ( V_2 ) ;
if ( V_2 -> V_41 < V_42 )
V_95 = F_200 ( V_2 , & V_414 ) ;
if ( V_95 == V_94 )
V_95 = F_199 ( L_4 , : [ V_415 ] L_5 ( V_414 ) ) ;
V_2 -> V_6 -> V_133 ( V_2 ) ;
return V_95 ;
}
...
if ( ! F_202 ( V_421 ) )
return F_27 ( V_2 ) ;
if ( V_420 & V_422 [ V_421 ] )
return F_25 ( V_2 , 0 ) ;
switch ( V_421 ) {
case 0 : {
T_2 V_283 ;
if ( ( ( V_420 & V_300 ) && ! ( V_420 & V_299 ) ) ||
( ( V_420 & V_425 ) && ! ( V_420 & V_426 ) ) )
return F_25 ( V_2 , 0 ) ;
V_283 = V_2 -> V_6 -> V_134 ( V_2 , 4 ) ;
V_2 -> V_6 -> V_103 ( V_2 , V_104 , & V_102 ) ;
if ( ( V_420 & V_300 ) && ( V_102 & V_427 ) &&
! ( V_283 & V_301 ) )
return F_25 ( V_2 , 0 ) ;
break;
}
...
return F_27 ( V_2 ) ;
V_283 = V_2 -> V_6 -> V_134 ( V_2 , 4 ) ;
if ( ( V_283 & V_432 ) && ( V_431 == 4 || V_431 == 5 ) )
return F_27 ( V_2 ) ;
if ( F_205 ( V_2 ) ) {
T_1 V_433 ;
V_2 -> V_6 -> V_379 ( V_2 , 6 , & V_433 ) ;
V_433 &= ~ 15 ;
V_433 |= V_434 | V_435 ;
V_2 -> V_6 -> V_287 ( V_2 , 6 , V_433 ) ;
return F_24 ( V_2 ) ;
}
return V_94 ;
}
...
T_2 V_420 = V_2 -> V_22 . V_23 ;
int V_431 = V_2 -> V_19 ;
if ( ( V_431 == 6 || V_431 == 7 ) && ( V_420 & 0xffffffff00000000ULL ) )
return F_25 ( V_2 , 0 ) ;
return F_206 ( V_2 ) ;
}
...
{
T_2 V_437 = F_1 ( V_2 , V_250 ) ;
if ( V_437 & 0xffff000000000000ULL )
return F_25 ( V_2 , 0 ) ;
return F_208 ( V_2 ) ;
}
...
if ( V_283 & V_438 && V_2 -> V_6 -> V_204 ( V_2 ) )
return F_27 ( V_2 ) ;
return V_94 ;
}
...
if ( ( ! ( V_283 & V_439 ) && V_2 -> V_6 -> V_204 ( V_2 ) ) ||
V_2 -> V_6 -> V_440 ( V_2 , V_328 ) )
return F_25 ( V_2 , 0 ) ;
return V_94 ;
}
...
V_131 -> V_82 . V_173 . V_91 =
F_15 ( V_2 , V_166 ) ;
V_131 -> V_82 . V_173 . V_52 = V_2 -> V_465 ;
V_131 -> V_34 = 0 ;
V_131 -> V_191 = 1 ;
break;
case V_466 :
...
int F_219 ( struct V_1 * V_2 , void * V_476 , int V_477 )
{
int V_95 = V_94 ;
int V_41 = V_2 -> V_41 ;
...
V_2 -> V_85 . V_113 = V_2 -> V_85 . V_108 + V_477 ;
V_2 -> V_485 = 1 ;
if ( V_477 > 0 )
memcpy ( V_2 -> V_85 . V_108 , V_476 , V_477 ) ;
else {
V_95 = F_46 ( V_2 , 1 ) ;
if ( V_95 != V_94 )
return V_95 ;
...
case 0x3e :
V_483 = true ;
V_2 -> V_465 = ( V_2 -> V_140 >> 3 ) & 3 ;
break;
case 0x64 :
case 0x65 :
V_483 = true ;
V_2 -> V_465 = V_2 -> V_140 & 7 ;
break;
case 0x40 ... 0x4f :
if ( V_41 != V_42 )
goto V_486;
...
if ( V_2 -> V_120 & 8 )
V_2 -> V_97 = 8 ;
V_484 = V_487 [ V_2 -> V_140 ] ;
if ( V_2 -> V_140 == 0x0f ) {
V_2 -> V_485 = 2 ;
V_2 -> V_140 = F_69 ( V_35 , V_2 ) ;
V_484 = V_488 [ V_2 -> V_140 ] ;
if ( V_2 -> V_140 == 0x38 ) {
V_2 -> V_485 = 3 ;
V_2 -> V_140 = F_69 ( V_35 , V_2 ) ;
V_484 = V_489 [ V_2 -> V_140 ] ;
}
}
V_2 -> V_45 = V_484 . V_126 ;
if ( V_2 -> V_45 & V_139 )
V_2 -> V_158 = F_69 ( V_35 , V_2 ) ;
if ( V_2 -> V_485 == 1 && ( V_2 -> V_140 == 0xc5 || V_2 -> V_140 == 0xc4 ) &&
( V_41 == V_42 || ( V_2 -> V_158 & 0xc0 ) == 0xc0 ) ) {
V_2 -> V_45 = V_490 ;
}
while ( V_2 -> V_45 & V_491 ) {
switch ( V_2 -> V_45 & V_491 ) {
case V_492 :
V_480 = ( V_2 -> V_158 >> 3 ) & 7 ;
V_484 = V_484 . V_493 . V_494 [ V_480 ] ;
break;
case V_495 :
V_480 = ( V_2 -> V_158 >> 3 ) & 7 ;
if ( ( V_2 -> V_158 >> 6 ) == 3 )
V_484 = V_484 . V_493 . V_496 -> V_497 [ V_480 ] ;
else
V_484 = V_484 . V_493 . V_496 -> V_498 [ V_480 ] ;
break;
case V_499 :
V_480 = V_2 -> V_158 & 7 ;
V_484 = V_484 . V_493 . V_494 [ V_480 ] ;
...
if ( V_2 -> V_17 && V_482 )
return V_382 ;
V_481 = V_482 ? 0x66 : V_2 -> V_17 ;
switch ( V_481 ) {
case 0x00 : V_484 = V_484 . V_493 . V_501 -> V_502 ; break;
case 0x66 : V_484 = V_484 . V_493 . V_501 -> V_503 ; break;
case 0xf2 : V_484 = V_484 . V_493 . V_501 -> V_504 ; break;
case 0xf3 : V_484 = V_484 . V_493 . V_501 -> V_505 ; break;
}
break;
case V_506 :
if ( V_2 -> V_158 > 0xbf )
V_484 = V_484 . V_493 . V_507 -> V_508 [ V_2 -> V_158 - 0xc0 ] ;
else
V_484 = V_484 . V_493 . V_507 -> V_131 [ ( V_2 -> V_158 >> 3 ) & 7 ] ;
break;
case V_509 :
if ( ( V_2 -> V_158 >> 6 ) == 3 )
V_484 = V_484 . V_493 . V_510 -> V_497 ;
else
V_484 = V_484 . V_493 . V_510 -> V_498 ;
break;
case V_511 :
if ( V_2 -> V_41 == V_42 )
V_484 = V_484 . V_493 . V_512 -> V_513 ;
else
V_484 = V_484 . V_493 . V_512 -> V_514 ;
break;
default:
return V_382 ;
}
...
if ( V_2 -> V_45 == 0 )
return V_382 ;
V_2 -> V_515 = V_484 . V_493 . V_515 ;
if ( F_47 ( V_2 -> V_516 ) && F_34 ( ! ( V_2 -> V_45 & V_517 ) ) )
return V_382 ;
if ( F_47 ( V_2 -> V_45 &
( V_490 | V_518 | V_519 | V_141 | V_145 | V_520 | V_521 | V_522 |
V_523 ) ) ) {
V_2 -> V_524 = V_484 . V_524 ;
V_2 -> V_12 = V_484 . V_12 ;
if ( V_2 -> V_45 & V_490 )
return V_382 ;
if ( V_41 == V_42 ) {
if ( V_2 -> V_97 == 4 && ( V_2 -> V_45 & V_518 ) )
V_2 -> V_97 = 8 ;
else if ( V_2 -> V_45 & V_522 )
V_2 -> V_97 = 8 ;
}
if ( V_2 -> V_45 & V_519 ) {
if ( V_41 == V_42 )
...
} else if ( V_2 -> V_45 & V_525 )
V_95 = F_70 ( V_2 , & V_2 -> V_174 ) ;
if ( V_95 != V_94 )
goto V_175;
if ( ! V_483 )
V_2 -> V_465 = V_159 ;
V_2 -> V_174 . V_82 . V_173 . V_52 = V_2 -> V_465 ;
V_95 = F_217 ( V_2 , & V_2 -> V_22 , ( V_2 -> V_45 >> V_526 ) & V_527 ) ;
if ( V_95 != V_94 )
goto V_175;
V_95 = F_217 ( V_2 , & V_2 -> V_245 , ( V_2 -> V_45 >> V_528 ) & V_527 ) ;
if ( V_95 != V_94 )
goto V_175;
V_95 = F_217 ( V_2 , & V_2 -> V_25 , ( V_2 -> V_45 >> V_529 ) & V_527 ) ;
if ( V_2 -> V_172 && F_34 ( V_2 -> V_446 ) )
V_2 -> V_446 -> V_82 . V_173 . V_91 = F_14 ( V_2 ,
V_2 -> V_446 -> V_82 . V_173 . V_91 + V_2 -> V_98 ) ;
V_175:
return ( V_95 != V_94 ) ? V_382 : V_383 ;
}
bool F_220 ( struct V_1 * V_2 )
{
return V_2 -> V_45 & V_530 ;
}
...
{
register void * T_7 V_534 ( V_535 ) ;
T_1 V_126 = ( V_2 -> V_193 & V_128 ) | V_129 ;
if ( ! ( V_2 -> V_45 & V_149 ) )
F_56 += F_224 ( V_2 -> V_25 . V_27 ) * V_536 ;
...
unsigned V_538 ;
V_2 -> V_181 . V_182 = 0 ;
if ( V_2 -> V_226 && ( ! ( V_2 -> V_45 & V_539 ) || V_2 -> V_25 . type != V_161 ) ) {
V_95 = F_27 ( V_2 ) ;
goto V_175;
}
if ( ( V_2 -> V_45 & V_540 ) == V_541 && V_2 -> V_22 . type != V_161 ) {
V_95 = F_27 ( V_2 ) ;
goto V_175;
}
V_538 = V_2 -> V_6 -> V_297 ( V_2 ) ;
if ( F_47 ( V_2 -> V_45 &
( V_542 | V_543 | V_141 | V_145 | V_520 | V_521 | V_544 | V_545 | String ) ) ) {
...
|| ( ( V_2 -> V_45 & V_141 ) && ! ( V_6 -> V_134 ( V_2 , 4 ) & V_416 ) ) ) {
V_95 = F_27 ( V_2 ) ;
goto V_175;
}
...
if ( F_47 ( V_538 & V_547 ) && V_2 -> V_12 ) {
V_95 = F_7 ( V_2 , V_2 -> V_12 ,
V_548 ) ;
if ( V_95 != V_94 )
goto V_175;
}
if ( ( V_2 -> V_45 & V_545 ) && V_2 -> V_41 < V_100 ) {
V_95 = F_27 ( V_2 ) ;
goto V_175;
}
if ( ( V_2 -> V_45 & V_544 ) && V_6 -> V_204 ( V_2 ) ) {
if ( V_2 -> V_45 & V_549 )
V_95 = F_27 ( V_2 ) ;
else
V_95 = F_25 ( V_2 , 0 ) ;
...
if ( F_47 ( V_538 & V_547 ) && ( V_2 -> V_45 & V_520 ) ) {
V_95 = F_7 ( V_2 , V_2 -> V_12 ,
V_550 ) ;
if ( V_95 != V_94 )
goto V_175;
...
if ( ( V_2 -> V_22 . type == V_161 ) && ! ( V_2 -> V_45 & V_551 ) ) {
...
goto V_554;
if ( ( V_2 -> V_25 . type == V_161 ) && ! ( V_2 -> V_45 & V_546 ) ) {
...
if ( V_2 -> V_515 ) {
if ( V_2 -> V_45 & V_559 ) {
void (* F_56)( struct F_53 * ) = ( void * ) V_2 -> V_515 ;
V_95 = F_53 ( V_2 , F_56 ) ;
if ( V_95 != V_94 )
goto V_175;
goto F_89;
