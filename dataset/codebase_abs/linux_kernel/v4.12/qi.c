...
V_13 -> V_85 = * V_85 ;
V_13 -> V_30 = F_62 ( V_24 . V_30 , V_13 -> V_85 ) ;
...
void * F_63 ( T_5 V_65 )
{
return F_64 ( V_92 , V_65 ) ;
}
void F_65 ( void * V_93 )
{
F_66 ( V_92 , V_93 ) ;
}
static int F_67 ( struct V_94 * V_95 , int V_96 )
{
struct V_97 * V_73 = F_68 ( V_95 , struct V_97 , V_98 ) ;
int V_99 = F_35 ( V_73 -> V_64 , V_96 ) ;
if ( V_99 < V_96 ) {
F_69 ( V_95 ) ;
F_70 ( V_73 -> V_64 , V_100 ) ;
}
return V_99 ;
}
void F_71 ( struct V_75 * V_13 )
{
if ( F_47 ( V_13 ) )
return;
...
{
int V_101 , V_8 ;
struct V_102 * V_103 = F_73 ( V_2 ) ;
const T_4 * V_87 = F_55 () ;
struct V_104 V_105 = V_106 -> V_107 ;
F_74 (i, cpus) {
struct V_94 * V_98 ;
V_98 = & F_75 ( & V_24 . V_97 , V_101 ) -> V_98 ;
F_76 ( V_98 ) ;
F_77 ( V_98 ) ;
if ( F_36 ( V_2 , F_62 ( V_24 . V_30 , V_101 ) ) )
F_7 ( V_2 , L_21 , V_101 ) ;
F_31 ( F_62 ( V_24 . V_30 , V_101 ) ) ;
}
F_78 ( V_106 , F_79 ( V_108 ) ) ;
V_8 = F_80 ( & V_103 -> V_56 ) ;
if ( V_8 )
F_7 ( V_2 , L_22 , V_8 ) ;
else
F_81 ( V_103 -> V_56 . V_57 ) ;
F_82 ( V_92 ) ;
F_78 ( V_106 , & V_105 ) ;
F_83 ( V_103 -> V_109 ) ;
return V_8 ;
}
static void F_84 ( struct V_17 * V_18 , struct V_110 * V_56 , int V_111 )
{
V_112 = V_111 ;
if ( V_111 ) {
#ifdef F_85
...
static int F_87 ( struct V_17 * V_64 , struct V_97 * V_73 )
{
if ( F_46 ( F_88 () || ! F_89 () ) ) {
F_90 ( V_64 , V_100 ) ;
V_73 -> V_64 = V_64 ;
...
static enum V_114 F_92 ( struct V_17 * V_64 ,
struct V_19 * V_30 ,
...
static int F_94 ( struct V_1 * V_2 , unsigned int V_85 )
{
struct V_33 V_34 ;
struct V_19 * V_20 ;
int V_8 ;
...
V_50 | V_51 ) ;
F_23 ( & V_34 . V_48 , F_95 ( V_85 ) , 3 ) ;
V_34 . V_48 . V_54 = V_55 . V_56 . V_57 ;
V_34 . V_48 . V_82 . V_125 . V_126 = V_127 |
V_128 ;
F_96 ( & V_34 . V_48 , 0 , 1 , 1 ) ;
...
const int V_130 = F_98 ( V_87 ) ;
const T_6 V_131 = V_130 * V_132 ;
V_8 = F_99 ( & V_55 . V_56 . V_57 ) ;
if ( V_8 ) {
F_7 ( V_2 , L_30 , V_8 ) ;
return V_8 ;
}
...
F_100 ( & V_34 . V_56 . V_140 , V_131 , 1 ) ;
V_8 = F_101 ( & V_55 . V_56 , V_141 , & V_34 ) ;
if ( V_8 ) {
F_7 ( V_2 , L_31 , V_8 ,
V_55 . V_56 . V_57 ) ;
return V_8 ;
