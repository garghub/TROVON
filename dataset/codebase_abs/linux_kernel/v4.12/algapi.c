...
T_1 V_124 ;
if ( F_111 ( V_125 ) ||
F_112 ( ( unsigned long ) V_123 , F_113 ( * V_123 ) ) )
for (; V_122 >= 4 ; V_122 -= 4 ) {
V_124 = F_114 ( * -- V_123 ) + 1 ;
* V_123 = F_115 ( V_124 ) ;
if ( F_116 ( V_124 ) )
...
int F_121 ( const char * V_57 , const struct V_79 * V_80 ,
T_1 type , T_1 V_43 )
{
int V_47 = 0 ;
