...
int V_65 ;
struct V_1 * V_2 = (struct V_1 * ) V_461 ;
V_65 = F_151 ( V_2 , V_463 , 230 ,
& V_2 -> V_8 . V_9 . V_207 . V_202 ) ;
if ( V_65 )
return V_65 ;
V_65 = F_151 ( V_2 , V_463 , 231 ,
& V_2 -> V_8 . V_9 . V_207 . V_202 ) ;
if ( V_65 )
return V_65 ;
...
if ( V_462 == 0 )
return 0 ;
F_152 ( & V_2 -> V_8 . V_9 . V_207 . V_472 , V_473 ) ;
F_153 ( & V_2 -> V_8 . V_474 ) ;
V_65 = F_129 ( V_2 ) ;
if ( V_65 )
goto V_475;
...
static inline bool F_174 ( const struct V_398 * V_493 ,
const struct V_398 * V_494 )
{
return ( ( V_493 -> V_94 == V_494 -> V_94 ) &&
( V_493 -> V_289 == V_494 -> V_289 ) &&
( V_493 -> V_291 == V_494 -> V_291 ) &&
( V_493 -> V_294 == V_494 -> V_294 ) ) ;
}
...
struct V_32 * V_498 ;
int V_12 ;
if ( V_2 == NULL || V_495 == NULL || V_34 == NULL || V_496 == NULL )
return - V_45 ;
V_497 = F_6 ( V_495 ) ;
V_498 = F_6 ( V_34 ) ;
if ( V_497 == NULL ) {
...
if ( V_497 -> V_262 != V_498 -> V_262 ) {
* V_496 = false ;
return 0 ;
}
for ( V_12 = 0 ; V_12 < V_497 -> V_262 ; V_12 ++ ) {
if ( ! F_174 ( & ( V_497 -> V_260 [ V_12 ] ) ,
& ( V_498 -> V_260 [ V_12 ] ) ) ) {
* V_496 = false ;
return 0 ;
}
}
* V_496 = ( ( V_495 -> V_147 == V_34 -> V_147 ) && ( V_495 -> V_149 == V_34 -> V_149 ) ) ;
* V_496 &= ( ( V_495 -> V_165 == V_34 -> V_165 ) && ( V_495 -> V_314 == V_34 -> V_314 ) ) ;
return 0 ;
}
static int F_176 ( struct V_1 * V_2 , int V_280 ,
void * V_48 , int * V_499 )
{
struct V_37 * V_38 = F_7 ( V_2 ) ;
T_4 V_94 ;
...
{
V_2 -> V_8 . V_9 . V_207 . V_202 . V_504 = V_505 ;
V_2 -> V_8 . V_9 . V_207 . V_202 . V_68 = & V_506 ;
}
