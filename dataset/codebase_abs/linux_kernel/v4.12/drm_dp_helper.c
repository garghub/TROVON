...
static int F_55 ( struct V_31 * V_32 , T_1 * V_157 )
{
T_1 V_154 , V_158 ;
int V_42 ;
V_42 = F_23 ( V_32 , V_159 , & V_154 ) ;
if ( V_42 < 0 )
return V_42 ;
F_56 ( ! ( V_154 & V_160 ) ) ;
V_42 = F_23 ( V_32 , V_161 , & V_154 ) ;
if ( V_42 < 0 )
return V_42 ;
V_158 = V_154 & V_162 ;
if ( V_158 == V_32 -> V_163 )
return - V_164 ;
V_32 -> V_163 = V_158 ;
V_42 = F_18 ( V_32 , V_165 , V_157 , 6 ) ;
if ( V_42 < 0 )
return V_42 ;
return 0 ;
}
static void F_57 ( struct V_166 * V_167 )
{
struct V_31 * V_32 = F_50 ( V_167 , struct V_31 ,
V_168 ) ;
struct V_169 * V_170 ;
T_1 V_171 [ 6 ] ;
T_6 V_172 [ 3 ] ;
...
return;
V_170 = V_32 -> V_170 ;
while ( V_170 -> V_157 . V_173 ) {
F_58 ( V_170 ) ;
if ( ! V_170 -> V_157 . V_173 )
break;
V_42 = F_55 ( V_32 , V_171 ) ;
if ( V_42 == - V_164 ) {
F_15 ( 1000 , 2000 ) ;
V_42 = F_55 ( V_32 , V_171 ) ;
}
...
V_172 [ 0 ] = V_171 [ 0 ] | V_171 [ 1 ] << 8 ;
V_172 [ 1 ] = V_171 [ 2 ] | V_171 [ 3 ] << 8 ;
V_172 [ 2 ] = V_171 [ 4 ] | V_171 [ 5 ] << 8 ;
F_59 ( V_170 , false , 0 , V_172 ) ;
}
}
void F_60 ( struct V_31 * V_32 )
{
F_61 ( & V_32 -> V_44 ) ;
F_62 ( & V_32 -> V_168 , F_57 ) ;
V_32 -> V_156 . V_174 = & V_175 ;
V_32 -> V_156 . V_148 = V_32 ;
V_32 -> V_156 . V_176 = 3 ;
V_32 -> V_156 . V_177 = & V_178 ;
}
...
if ( ! V_32 -> V_156 . V_174 )
F_60 ( V_32 ) ;
V_32 -> V_156 . V_179 = V_180 ;
V_32 -> V_156 . V_181 = V_182 ;
V_32 -> V_156 . V_183 . V_184 = V_32 -> V_183 ;
V_32 -> V_156 . V_183 . V_185 = V_32 -> V_183 -> V_185 ;
F_64 ( V_32 -> V_156 . V_186 , V_32 -> V_186 ? V_32 -> V_186 : F_65 ( V_32 -> V_183 ) ,
sizeof( V_32 -> V_156 . V_186 ) ) ;
V_42 = F_66 ( V_32 ) ;
if ( V_42 )
return V_42 ;
V_42 = F_67 ( & V_32 -> V_156 ) ;
if ( V_42 ) {
F_68 ( V_32 ) ;
return V_42 ;
}
...
int F_71 ( const T_1 V_187 [ V_188 ] )
{
static const T_7 V_189 [] = {
F_72 ( 330 ) ,
F_72 ( 275 ) ,
F_72 ( 165 ) ,
F_72 ( 110 ) ,
...
int V_6 ;
V_6 = ( V_187 [ 1 ] & V_190 ) >> V_191 ;
if ( V_6 >= F_73 ( V_189 ) )
return - V_192 ;
return V_189 [ V_6 ] ;
}
int F_74 ( struct V_31 * V_32 , struct V_169 * V_170 )
{
T_1 V_154 ;
int V_42 ;
V_42 = F_23 ( V_32 , V_159 , & V_154 ) ;
if ( V_42 < 0 )
return V_42 ;
V_42 = F_24 ( V_32 , V_159 , V_154 | V_160 ) ;
if ( V_42 < 0 )
return V_42 ;
V_32 -> V_163 = 0 ;
V_32 -> V_170 = V_170 ;
...
static T_5
F_78 ( const struct V_193 * V_194 , bool V_195 )
{
const struct V_196 * V_197 ;
T_5 V_198 = 0 ;
int V_6 ;
for ( V_6 = 0 ; V_6 < F_73 ( V_199 ) ; V_6 ++ ) {
V_197 = & V_199 [ V_6 ] ;
if ( V_197 -> V_195 != V_195 )
continue;
if ( memcmp ( V_197 -> V_200 , V_194 -> V_200 , sizeof( V_194 -> V_200 ) ) != 0 )
continue;
V_198 |= V_197 -> V_198 ;
}
return V_198 ;
}
int F_79 ( struct V_31 * V_32 , struct V_201 * V_202 ,
bool V_195 )
{
struct V_193 * V_194 = & V_202 -> V_194 ;
unsigned int V_34 = V_195 ? V_203 : V_204 ;
int V_42 , V_205 ;
V_42 = F_18 ( V_32 , V_34 , V_194 , sizeof( * V_194 ) ) ;
if ( V_42 < 0 )
return V_42 ;
V_202 -> V_198 = F_78 ( V_194 , V_195 ) ;
V_205 = F_80 ( V_194 -> V_206 , sizeof( V_194 -> V_206 ) ) ;
F_16 ( L_31 ,
V_195 ? L_32 : L_33 ,
( int ) sizeof( V_194 -> V_200 ) , V_194 -> V_200 ,
V_205 , V_194 -> V_206 ,
V_194 -> V_207 >> 4 , V_194 -> V_207 & 0xf ,
V_194 -> V_208 , V_194 -> V_209 ,
V_202 -> V_198 ) ;
return 0 ;
}
