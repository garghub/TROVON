...
static inline struct V_150 * F_39 ( struct V_151 * V_152 )
{
return V_152 -> V_153 ;
}
static struct V_1 * F_40 ( struct V_150 * V_51 ,
struct V_34 * V_35 ,
int V_36 )
{
int V_17 ;
for ( V_17 = 0 ; V_17 < V_51 -> V_154 ; V_17 ++ ) {
struct V_1 * V_2 = & V_51 -> V_155 [ V_17 ] ;
...
{
struct V_150 * V_51 = F_39 ( V_35 -> V_156 ) ;
struct V_1 * V_2 ;
int V_49 ;
...
static int F_43 ( int V_10 , struct V_151 * V_152 )
{
struct V_150 * V_51 = F_39 ( V_152 ) ;
int V_145 , V_17 ;
V_51 -> V_158 . V_159 = L_3 ;
V_51 -> V_160 . V_159 = L_4 ;
if ( F_44 ( & V_51 -> V_160 ) != 0 )
F_45 ( & V_152 -> V_161 , & V_51 -> V_160 ,
V_152 -> V_162 ) ;
F_45 ( & V_152 -> V_161 , & V_51 -> V_158 , V_152 -> V_163 ) ;
F_46 ( & V_152 -> V_161 , & V_51 -> V_164 ) ;
V_145 = F_47 ( & V_51 -> V_52 -> V_53 , & V_152 -> V_161 ) ;
if ( V_145 )
return 0 ;
for ( V_17 = 0 ; V_17 < V_51 -> V_154 ; V_17 ++ ) {
struct V_1 * V_2 = & V_51 -> V_155 [ V_17 ] ;
...
static T_5 F_48 ( struct V_165 * V_53 ,
...
F_51 ( V_16 ) ) ) ;
else if ( V_167 -> V_169 & V_172 )
return F_49 ( V_66 , F_50 ( T_5 , V_173 ,
F_51 ( V_16 ) ) ) ;
else
return V_66 ;
}
static void F_52 ( struct V_150 * V_51 )
{
struct V_174 V_175 ;
memset ( & V_175 , 0 , sizeof( V_175 ) ) ;
#ifdef F_53
V_175 . V_176 = V_51 -> V_177 ;
#endif
V_175 . V_178 = 1 ;
V_175 . V_153 = ( void * * ) & V_51 ;
V_175 . V_179 = F_43 ;
V_175 . V_180 = V_181 ;
V_175 . V_182 = & V_183 ;
V_175 . V_184 = F_48 ;
F_54 ( & V_51 -> V_52 -> V_53 , & V_175 ) ;
}
static void T_2 * F_55 ( struct V_185 * V_52 ,
struct V_186 * V_187 ,
struct V_1 * V_2 )
{
struct V_166 V_188 ;
int V_49 = 0 ;
V_49 = F_56 ( V_187 , 0 , & V_188 ) ;
if ( V_49 )
return F_57 ( V_49 ) ;
return F_58 ( & V_52 -> V_53 , & V_188 ) ;
}
static int F_59 ( struct V_186 * V_187 , int V_36 ,
unsigned long type ,
unsigned int * V_189 ,
unsigned int * V_190 )
{
const int V_191 = 3 , V_192 = 2 ;
const T_6 * V_193 ;
int V_194 , V_195 , V_196 , V_197 , V_17 ;
* V_189 = - 1 ;
* V_190 = - 1 ;
V_193 = F_60 ( V_187 , L_5 , & V_194 ) ;
if ( ! V_193 )
return - V_198 ;
V_197 = F_61 ( V_187 ) ;
V_196 = V_197 + V_191 + V_192 ;
V_195 = V_194 / sizeof( T_6 ) / V_196 ;
for ( V_17 = 0 ; V_17 < V_195 ; V_17 ++ , V_193 += V_196 ) {
T_1 V_169 = F_62 ( V_193 , 1 ) ;
T_1 V_199 = F_62 ( V_193 + 1 , 1 ) ;
T_7 V_200 = F_62 ( V_193 + V_191 , V_197 ) ;
unsigned long V_201 ;
if ( F_63 ( V_169 ) == V_202 )
V_201 = V_170 ;
else if ( F_63 ( V_169 ) == V_203 )
V_201 = V_172 ;
else
continue;
if ( V_199 == F_64 ( V_36 ) && type == V_201 ) {
* V_189 = F_65 ( V_200 ) ;
* V_190 = F_66 ( V_200 ) ;
return 0 ;
}
...
static int F_67 ( struct V_77 * V_53 )
{
struct V_150 * V_51 ;
int V_17 ;
V_51 = F_68 ( V_53 ) ;
...
static int F_69 ( struct V_77 * V_53 )
{
struct V_150 * V_51 ;
int V_17 ;
V_51 = F_68 ( V_53 ) ;
...
static void F_70 ( void * V_206 )
{
struct V_1 * V_2 = V_206 ;
F_71 ( V_2 -> V_207 ) ;
}
static int F_72 ( struct V_150 * V_51 ,
struct V_1 * V_2 , struct V_186 * V_208 )
{
struct V_77 * V_53 = & V_51 -> V_52 -> V_53 ;
enum V_209 V_169 ;
int V_210 , V_49 ;
V_2 -> V_51 = V_51 ;
if ( F_73 ( V_208 , L_6 , & V_2 -> V_2 ) ) {
F_74 ( V_53 , L_7 ,
F_75 ( V_208 ) ) ;
goto V_211;
}
if ( F_73 ( V_208 , L_8 , & V_2 -> V_212 ) )
V_2 -> V_212 = 0 ;
V_2 -> V_159 = F_76 ( V_53 , V_213 , L_9 , V_2 -> V_2 ,
V_2 -> V_212 ) ;
if ( ! V_2 -> V_159 ) {
V_49 = - V_214 ;
goto V_145;
...
if ( V_2 -> V_36 < 0 )
goto V_211;
V_49 = F_59 ( V_53 -> V_215 , V_2 -> V_36 , V_172 ,
& V_2 -> V_69 , & V_2 -> V_70 ) ;
if ( V_49 < 0 ) {
F_31 ( V_53 , L_10 ,
V_2 -> V_159 ) ;
...
if ( F_44 ( & V_51 -> V_65 ) != 0 ) {
F_59 ( V_53 -> V_215 , V_2 -> V_36 , V_170 ,
& V_2 -> V_6 , & V_2 -> V_7 ) ;
} else {
V_2 -> V_6 = - 1 ;
V_2 -> V_7 = - 1 ;
}
V_210 = F_78 ( V_208 , L_11 , 0 , & V_169 ) ;
if ( V_210 == - V_216 ) {
V_49 = V_210 ;
goto V_145;
}
if ( F_79 ( V_210 ) ) {
unsigned long V_217 ;
V_2 -> V_218 = F_76 ( V_53 , V_213 , L_12 ,
V_2 -> V_159 ) ;
if ( ! V_2 -> V_218 ) {
V_49 = - V_214 ;
goto V_145;
...
V_2 -> V_210 = F_82 ( V_210 ) ;
}
V_2 -> V_207 = F_83 ( V_208 , NULL ) ;
if ( F_84 ( V_2 -> V_207 ) ) {
F_31 ( V_53 , L_14 , V_2 -> V_159 ) ;
goto V_211;
}
V_49 = F_85 ( V_53 , F_70 , V_2 ) ;
if ( V_49 < 0 ) {
F_71 ( V_2 -> V_207 ) ;
goto V_145;
}
...
static int F_94 ( struct V_185 * V_52 )
{
struct V_77 * V_53 = & V_52 -> V_53 ;
struct V_150 * V_51 ;
struct V_186 * V_187 = V_53 -> V_215 ;
struct V_186 * V_208 ;
int V_226 , V_17 , V_49 ;
V_51 = F_95 ( V_53 , sizeof( * V_51 ) , V_213 ) ;
if ( ! V_51 )
return - V_214 ;
V_51 -> V_52 = V_52 ;
F_96 ( V_52 , V_51 ) ;
...
F_98 ( & V_51 -> V_65 ) ;
if ( F_44 ( & V_51 -> V_65 ) != 0 ) {
V_51 -> V_160 . V_169 = V_51 -> V_65 . V_169 ;
V_51 -> V_160 . V_66 = V_227 ;
V_51 -> V_160 . V_50 = F_99 ( T_5 ,
V_228 ,
F_44 ( & V_51 -> V_65 ) ) ;
} else
V_51 -> V_160 = V_51 -> V_65 ;
V_49 = F_100 ( V_187 , & V_51 -> V_164 ) ;
if ( V_49 ) {
F_31 ( V_53 , L_17 , V_49 ) ;
return V_49 ;
}
V_226 = F_101 ( V_187 ) ;
V_51 -> V_155 = F_102 ( V_53 , V_226 , sizeof( * V_51 -> V_155 ) , V_213 ) ;
if ( ! V_51 -> V_155 )
return - V_214 ;
V_17 = 0 ;
F_103 (np, child) {
struct V_1 * V_2 = & V_51 -> V_155 [ V_17 ] ;
V_49 = F_72 ( V_51 , V_2 , V_208 ) ;
if ( V_49 < 0 ) {
F_104 ( V_208 ) ;
return V_49 ;
} else if ( V_49 == 0 ) {
...
V_51 -> V_154 = V_17 ;
for ( V_17 = 0 ; V_17 < ( V_228 - V_171 ) ; V_17 += V_171 )
F_105 ( V_17 , V_51 -> V_65 . V_66 + V_17 ) ;
F_52 ( V_51 ) ;
F_96 ( V_52 , V_51 ) ;
return 0 ;
}
