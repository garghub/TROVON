...
static struct V_53 * F_308 ( struct V_13 * V_14 )
{
struct V_53 * V_54 = NULL ;
unsigned long V_76 ;
F_32 ( & V_14 -> V_74 , V_76 ) ;
...
static int
F_315 ( struct V_114 * V_115 , unsigned long time )
{
struct V_13 * V_14 = F_70 ( V_115 ) ;
if ( V_683 > 0 ) {
V_14 -> V_57 = 0 ;
...
static int
F_318 ( struct V_780 * V_547 , const struct V_834 * V_89 )
{
struct V_13 * V_14 ;
...
static int
F_330 ( struct V_780 * V_547 , T_51 V_169 )
{
struct V_114 * V_115 = F_300 ( V_547 ) ;
struct V_13 * V_14 = F_70 ( V_115 ) ;
T_52 V_884 ;
...
F_332 () ;
F_333 ( V_115 ) ;
V_884 = F_334 ( V_547 , V_169 ) ;
F_13 ( V_42
L_368 ,
V_14 -> V_43 , V_547 , F_335 ( V_547 ) , V_884 ) ;
F_336 ( V_547 ) ;
F_337 ( V_14 ) ;
F_338 ( V_547 , V_884 ) ;
return 0 ;
...
static T_53
F_344 ( struct V_780 * V_547 , T_54 V_169 )
{
struct V_114 * V_115 = F_300 ( V_547 ) ;
struct V_13 * V_14 = F_70 ( V_115 ) ;
F_13 ( V_42 L_370 ,
...
bool F_349 ( struct V_112 * V_75 )
{
unsigned char * V_895 ;
bool V_896 = false ;
if ( ! F_350 ( V_75 ) )
return V_896 ;
V_895 = F_351 ( V_897 , V_132 ) ;
if ( ! V_895 )
return V_896 ;
if ( ! F_352 ( V_75 , 0x89 , V_895 , V_897 ) )
V_896 = ( V_895 [ 213 ] >> 4 ) & 1 ;
F_2 ( V_895 ) ;
return V_896 ;
}
