...
if ( V_2 -> V_106 != V_107 )
return - V_108 ;
if ( V_103 -> V_60 == & V_4 -> V_109 . V_69 . V_60 )
V_2 -> V_106 = V_110 ;
break;
case V_44 :
if ( V_104 & V_105 ) {
...
struct V_101 * V_113 = V_2 -> V_113 ;
struct V_100 * V_114 = & V_46 -> V_60 ;
int V_47 ;
V_2 -> V_106 = V_107 ;
F_31 ( V_46 , & V_115 ) ;
V_46 -> V_116 = & V_117 ;
F_32 ( V_46 -> V_118 , L_3 , sizeof( V_46 -> V_118 ) ) ;
V_46 -> V_119 = F_33 ( 16 ) ;
F_34 ( V_46 , V_2 ) ;
V_46 -> V_104 |= V_120 ;
V_113 [ V_23 ] . V_104 = V_121 ;
V_113 [ V_44 ] . V_104 = V_122 ;
V_114 -> V_123 = & V_124 ;
V_47 = F_35 ( V_114 , V_125 , V_113 ) ;
if ( V_47 < 0 )
return V_47 ;
F_26 ( V_46 , NULL ) ;
return 0 ;
