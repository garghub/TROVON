...
V_9 -> V_57 ) ;
F_10 ( V_2 , L_42 ,
V_9 -> V_27 -> V_58 , V_9 -> V_59 ) ;
F_10 ( V_2 , L_43 , V_9 -> V_60 ) ;
if ( F_12 ( V_5 ) == V_38 ) {
const struct V_61 * V_61 = & F_23 ( V_9 ) -> V_61 ;
const struct V_62 * V_63 = V_61 -> V_62 ;
if ( V_63 ) {
F_10 ( V_2 , L_44 ,
V_63 -> V_64 ) ;
F_10 ( V_2 , L_45 ,
...
static int F_26 ( struct V_82 * V_82 , struct V_83 * V_83 )
{
struct V_1 * V_2 ;
int V_84 ;
V_84 = F_27 ( V_83 , & V_85 ) ;
...
{
struct V_87 * V_88 = V_5 -> V_27 ;
struct V_89 * V_90 = F_30 ( F_31 ( V_88 ) , V_91 ) ;
if ( V_90 -> V_92 ) {
V_5 -> V_93 = F_32 ( V_88 -> V_28 ,
V_94 , V_90 -> V_92 ,
& V_95 , V_5 ) ;
if ( V_5 -> V_93 == NULL )
F_33 ( V_88 , L_60 ,
...
memcpy ( V_5 -> V_97 , V_88 -> V_28 , V_98 ) ;
}
}
...
struct V_87 * V_88 = V_5 -> V_27 ;
struct V_89 * V_90 = F_30 ( F_31 ( V_88 ) , V_91 ) ;
if ( V_90 -> V_92 && V_5 -> V_93 ) {
F_35 ( V_5 -> V_97 , V_90 -> V_92 ) ;
memset ( V_5 -> V_97 , 0 , V_98 ) ;
V_5 -> V_93 = NULL ;
}
}
void T_3 F_36 ( struct V_89 * V_90 )
{
if ( ! V_90 -> V_92 ) {
V_90 -> V_92 = F_37 ( V_96 , V_90 -> V_99 -> V_100 ) ;
if ( ! V_90 -> V_92 )
F_38 ( L_61 ,
V_96 ) ;
}
}
void T_4 F_39 ( struct V_89 * V_90 )
{
if ( V_90 -> V_92 ) {
F_35 ( V_96 , V_90 -> V_99 -> V_100 ) ;
V_90 -> V_92 = NULL ;
}
}
