...
F_29 ( V_8 ) ;
F_45 (
V_8 -> V_2 , F_108 ( V_8 -> V_33 , V_8 -> V_67 ) ) ;
} else {
F_30 ( V_8 ) ;
}
V_196 = 0 ;
...
{
struct V_7 * V_8 = & V_2 -> V_8 [ F_61 ( V_214 ) ] ;
if ( F_96 ( & V_8 -> V_135 ) )
return;
F_45 ( V_8 -> V_2 , F_108 ( V_8 -> V_33 , V_8 -> V_67 ) ) ;
F_56 ( V_8 ) ;
...
V_2 -> V_167 = 0 ;
F_28 ( & V_2 -> V_31 ) ;
V_2 -> V_29 -> V_264 ( & V_2 -> V_32 , & V_2 -> V_255 ) ;
F_27 ( & V_2 -> V_31 ) ;
}
...
V_8 -> V_67 = V_141 / 2 ;
V_8 -> V_33 = ~ V_141 & 1 ;
V_8 -> V_8 . V_175 = V_274 [ V_141 ] ;
V_8 -> V_8 . V_276 = & V_277 ;
if ( V_8 -> V_33 ) {
V_8 -> V_9 = V_8 -> V_67 * V_278 ;
V_8 -> V_8 . V_279 . V_280 = true ;
} else {
V_8 -> V_9 = ( V_273 + V_8 -> V_67 ) *
V_278 ;
V_8 -> V_8 . V_279 . V_281 = true ;
}
if ( V_141 == V_169 || V_141 == V_226 ) {
V_8 -> V_8 . V_279 . V_282 = true ;
} else {
V_8 -> V_8 . V_279 . V_283 = true ;
V_8 -> V_8 . V_279 . V_284 = true ;
V_8 -> V_8 . V_279 . V_285 = true ;
}
F_146 ( & V_8 -> V_8 , V_286 ) ;
F_118 ( & V_8 -> V_8 . V_275 , & V_2 -> V_32 . V_275 ) ;
F_110 ( & V_8 -> V_135 ) ;
}
F_146 ( & V_2 -> V_8 [ V_169 ] . V_8 , V_230 ) ;
F_146 ( & V_2 -> V_8 [ V_226 ] . V_8 , V_233 ) ;
F_147 ( & V_2 -> V_8 [ V_169 ] . V_8 . V_275 ) ;
F_147 ( & V_2 -> V_8 [ V_226 ] . V_8 . V_275 ) ;
V_2 -> V_32 . V_287 = & V_2 -> V_8 [ V_169 ] . V_8 ;
F_110 ( & V_2 -> V_32 . V_287 -> V_275 ) ;
}
...
struct V_138 * V_140 ;
void * V_288 ;
V_2 -> V_144 = F_150 ( L_58 , & V_2 -> V_13 -> V_2 ,
...
V_2 -> V_289 = F_150 ( L_60 , & V_2 -> V_13 -> V_2 ,
...
V_288 = F_151 ( & V_2 -> V_13 -> V_2 , V_232 * 4 ,
V_290 ) ;
if ( ! V_288 )
return - V_160 ;
V_2 -> V_150 = F_117 ( & V_2 -> V_13 -> V_2 , V_288 ,
V_232 * 4 ,
V_189 ) ;
return 0 ;
}
static int F_152 ( struct V_104 * V_291 ,
struct V_292 * V_29 )
{
struct V_1 * V_2 = F_153 ( V_291 ) ;
...
static int F_154 ( struct V_104 * V_291 )
{
struct V_1 * V_2 = F_153 ( V_291 ) ;
F_42 ( V_2 , V_91 ) ;
V_2 -> V_29 = NULL ;
...
{
struct V_295 * V_13 = F_162 ( V_297 ) ;
struct V_1 * V_2 = F_156 ( V_13 ) ;
F_42 ( V_2 , V_91 ) ;
F_44 ( V_2 , V_92 ) ;
return 0 ;
}
static int F_163 ( struct V_296 * V_297 )
{
return 0 ;
}
static int F_164 ( struct V_295 * V_13 ,
const struct V_298 * V_299 )
{
int V_300 ;
int V_162 ;
struct V_1 * V_2 ;
V_2 = F_151 ( & V_13 -> V_2 , sizeof( * V_2 ) , V_290 ) ;
if ( ! V_2 )
return - V_160 ;
V_162 = F_165 ( V_13 ) ;
if ( V_162 )
return V_162 ;
F_166 ( V_13 , V_2 ) ;
if ( V_299 -> V_296 == V_301 )
V_300 = V_302 ;
else
V_300 = V_303 ;
V_162 = F_167 ( V_13 , 1 << V_300 , F_168 ( V_13 ) ) ;
if ( V_162 )
return V_162 ;
V_2 -> V_4 = F_169 ( V_13 ) [ V_300 ] ;
if ( F_148 ( V_2 ) )
return - V_304 ;
F_170 ( V_13 ) ;
V_162 = F_171 ( & V_13 -> V_2 , V_13 -> V_124 , F_143 ,
V_305 , V_306 , V_2 ) ;
if ( V_162 ) {
...
F_174 ( & V_2 -> V_31 ) ;
V_2 -> V_13 = V_13 ;
V_2 -> V_32 . V_276 = & V_308 ;
V_162 = F_149 ( V_2 ) ;
if ( V_162 )
goto V_307;
V_2 -> V_32 . V_175 = V_306 ;
V_2 -> V_32 . V_309 = V_242 ;
F_22 ( V_2 ) ;
V_162 = F_175 ( & V_13 -> V_2 , & V_2 -> V_32 ) ;
if ( V_162 )
goto V_307;
return 0 ;
V_307:
