...
static bool F_102 ( enum V_139 V_140 , enum V_139 V_42 )
{
if ( V_140 == V_42 ||
( V_140 == V_141 && V_42 == V_142 ) )
return true ;
return false ;
}
...
struct V_150 * V_151 ;
struct V_152 * V_153 ;
V_153 = F_48 ( V_41 , V_52 , & V_57 ) ;
F_116 (tmp, dm_table_get_devices(table))
V_148 ++ ;
V_59 = sizeof( * V_153 ) + ( sizeof( * V_153 -> V_16 ) * V_148 ) ;
if ( V_57 < V_59 ) {
V_41 -> V_45 |= V_65 ;
return;
}
...
V_153 -> V_16 [ V_148 ++ ] = F_51 ( V_151 -> V_154 -> V_155 -> V_156 ) ;
V_41 -> V_54 = V_41 -> V_58 + V_59 ;
}
...
static int F_119 ( struct V_17 * V_14 , unsigned V_157 , char * * V_158 ,
char * V_159 , unsigned V_160 )
{
int V_88 ;
if ( * * V_158 != '@' )
return 2 ;
if ( ! strcasecmp ( V_158 [ 0 ] , L_26 ) ) {
if ( V_157 != 1 ) {
F_120 ( L_27 ) ;
return - V_48 ;
}
...
V_88 = F_122 ( V_14 , V_157 , V_158 , V_159 , V_160 ) ;
if ( V_88 < 2 )
return V_88 ;
F_120 ( L_28 , V_158 [ 0 ] ) ;
return - V_48 ;
...
struct V_28 * V_29 ;
struct V_125 * V_126 ;
struct V_161 * V_162 = ( void * ) V_41 + V_41 -> V_58 ;
T_2 V_160 ;
char * V_159 = F_48 ( V_41 , V_52 , & V_160 ) ;
int V_30 ;
V_14 = F_76 ( V_41 ) ;
if ( ! V_14 )
return - V_47 ;
if ( V_162 < (struct V_161 * ) V_41 -> V_94 ||
F_79 ( V_162 -> V_163 , ( void * ) V_41 + V_52 ) ) {
F_39 ( L_29 ) ;
V_88 = - V_48 ;
goto V_66;
}
V_88 = F_124 ( & V_157 , & V_158 , V_162 -> V_163 ) ;
if ( V_88 ) {
F_39 ( L_30 ) ;
goto V_66;
}
...
V_88 = F_119 ( V_14 , V_157 , V_158 , V_159 , V_160 ) ;
if ( V_88 <= 1 )
goto V_164;
V_29 = F_30 ( V_14 , & V_30 ) ;
if ( ! V_29 )
...
V_126 = F_126 ( V_29 , V_162 -> V_166 ) ;
if ( ! F_127 ( V_126 ) ) {
F_39 ( L_32 ) ;
V_88 = - V_48 ;
} else if ( V_126 -> type -> V_163 )
V_88 = V_126 -> type -> V_163 ( V_126 , V_157 , V_158 ) ;
else {
F_39 ( L_33 ) ;
V_88 = - V_48 ;
}
...
if ( V_88 == 1 ) {
V_41 -> V_45 |= V_167 ;
if ( F_128 ( V_159 , V_160 ) )
V_41 -> V_45 |= V_65 ;
else
V_41 -> V_54 = V_41 -> V_58 + strlen ( V_159 ) + 1 ;
V_88 = 0 ;
}
F_15 ( V_14 ) ;
return V_88 ;
}
static T_5 F_129 ( unsigned int V_168 , int * V_169 )
{
static struct {
int V_168 ;
int V_45 ;
...
if ( F_130 ( V_168 >= F_131 ( V_171 ) ) )
return NULL ;
* V_169 = V_171 [ V_168 ] . V_45 ;
return V_171 [ V_168 ] . V_170 ;
}
static int F_132 ( unsigned int V_168 , struct V_40 T_6 * V_189 )
{
V_68 V_76 [ 3 ] ;
int V_88 = 0 ;
if ( F_133 ( V_76 , V_189 -> V_76 , sizeof( V_76 ) ) )
return - V_190 ;
if ( ( V_191 != V_76 [ 0 ] ) ||
( V_192 < V_76 [ 1 ] ) ) {
F_39 ( L_34
...
V_191 , V_192 ,
V_193 ,
V_76 [ 0 ] , V_76 [ 1 ] , V_76 [ 2 ] , V_168 ) ;
V_88 = - V_48 ;
}
V_76 [ 0 ] = V_191 ;
V_76 [ 1 ] = V_192 ;
V_76 [ 2 ] = V_193 ;
if ( F_134 ( V_189 -> V_76 , V_76 , sizeof( V_76 ) ) )
return - V_190 ;
return V_88 ;
}
static void F_135 ( struct V_40 * V_41 , T_2 V_52 , int V_194 )
{
if ( V_194 & V_195 )
memset ( V_41 , 0 , V_52 ) ;
if ( V_194 & V_196 )
...
static int F_137 ( struct V_40 T_6 * V_189 , struct V_40 * V_197 ,
int V_169 ,
struct V_40 * * V_41 , int * V_194 )
{
struct V_40 * V_198 ;
int V_199 ;
const T_2 V_200 = F_138 ( struct V_40 , V_94 ) ;
unsigned V_201 ;
if ( F_133 ( V_197 , V_189 , V_200 ) )
return - V_190 ;
if ( V_197 -> V_54 < V_200 )
return - V_48 ;
V_199 = V_197 -> V_45 & V_202 ;
* V_194 = V_199 ? V_195 : 0 ;
if ( V_169 & V_174 ) {
V_198 = V_197 ;
V_198 -> V_54 = V_200 ;
...
V_198 = NULL ;
V_201 = F_139 () ;
V_198 = F_140 ( V_197 -> V_54 , V_18 | V_204 ) ;
F_141 ( V_201 ) ;
if ( ! V_198 ) {
if ( V_199 && F_142 ( V_189 , V_197 -> V_54 ) )
return - V_190 ;
return - V_23 ;
}
* V_194 |= V_196 ;
if ( F_133 ( V_198 , V_189 , V_197 -> V_54 ) )
goto V_25;
V_203:
if ( V_198 -> V_54 != V_197 -> V_54 ) {
F_120 ( L_36 ) ;
goto V_25;
}
if ( V_199 && F_142 ( V_189 , V_197 -> V_54 ) )
...
return 0 ;
V_25:
F_135 ( V_198 , V_197 -> V_54 , * V_194 ) ;
return - V_190 ;
}
static int F_143 ( T_7 V_168 , struct V_40 * V_41 )
{
V_41 -> V_45 &= ~ V_65 ;
V_41 -> V_45 &= ~ V_51 ;
V_41 -> V_45 &= ~ V_202 ;
...
static int F_144 ( T_7 V_205 , struct V_40 T_6 * V_189 )
{
int V_88 = 0 ;
int V_169 ;
int V_194 ;
unsigned int V_168 ;
struct V_40 * V_206 ( V_41 ) ;
T_5 V_170 = NULL ;
T_2 V_207 ;
struct V_40 V_197 ;
if ( ! F_145 ( V_208 ) )
return - V_209 ;
if ( F_146 ( V_205 ) != V_210 )
return - V_211 ;
V_168 = F_147 ( V_205 ) ;
V_88 = F_132 ( V_168 , V_189 ) ;
if ( V_88 )
return V_88 ;
if ( V_168 == V_172 )
return 0 ;
V_170 = F_129 ( V_168 , & V_169 ) ;
if ( ! V_170 ) {
F_39 ( L_39 , V_205 ) ;
return - V_211 ;
}
V_88 = F_137 ( V_189 , & V_197 , V_169 , & V_41 , & V_194 ) ;
if ( V_88 )
return V_88 ;
V_207 = V_41 -> V_54 ;
V_88 = F_143 ( V_168 , V_41 ) ;
if ( V_88 )
goto V_66;
V_41 -> V_54 = F_138 ( struct V_40 , V_94 ) ;
V_88 = V_170 ( V_41 , V_207 ) ;
if ( F_130 ( V_41 -> V_45 & V_65 ) &&
F_130 ( V_169 & V_174 ) )
F_120 ( L_40 , V_168 ) ;
if ( ! V_88 && F_134 ( V_189 , V_41 , V_41 -> V_54 ) )
V_88 = - V_190 ;
V_66:
F_135 ( V_41 , V_207 , V_194 ) ;
return V_88 ;
}
static long F_148 ( struct V_212 * V_212 , T_7 V_205 , T_8 V_213 )
{
return ( long ) F_144 ( V_205 , (struct V_40 T_6 * ) V_213 ) ;
}
static long F_149 ( struct V_212 * V_212 , T_7 V_205 , T_8 V_213 )
{
return ( long ) F_148 ( V_212 , V_205 , ( T_8 ) F_150 ( V_213 ) ) ;
}
int T_9 F_151 ( void )
{
int V_88 ;
