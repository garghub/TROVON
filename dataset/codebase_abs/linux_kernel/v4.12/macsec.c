...
if ( V_64 [ V_362 ] )
V_26 -> V_129 = ! ! F_145 ( V_64 [ V_362 ] ) ;
if ( V_64 [ V_363 ] )
V_26 -> V_131 = F_145 ( V_64 [ V_363 ] ) ;
}
static int F_233 ( struct V_2 * V_3 , struct V_189 * V_364 [] ,
struct V_189 * V_64 [] )
{
if ( ! V_64 )
return 0 ;
...
static void F_235 ( struct V_2 * V_3 , struct V_369 * V_12 )
{
struct V_1 * V_76 = F_1 ( V_3 ) ;
struct V_2 * V_77 = V_76 -> V_77 ;
F_236 ( V_3 , V_12 ) ;
...
static void F_239 ( struct V_2 * V_3 , struct V_369 * V_12 )
{
struct V_1 * V_76 = F_1 ( V_3 ) ;
struct V_2 * V_77 = V_76 -> V_77 ;
struct V_4 * V_156 = F_5 ( V_77 ) ;
F_235 ( V_3 , V_12 ) ;
if ( F_240 ( & V_156 -> V_370 ) ) {
F_241 ( V_77 ) ;
F_12 ( V_156 ) ;
}
}
...
V_26 -> V_34 = V_34 ;
V_26 -> V_28 . V_9 = true ;
V_26 -> V_28 . V_60 = V_373 ;
V_26 -> V_28 . V_55 = V_374 ;
V_26 -> V_28 . F_25 = V_375 ;
V_26 -> V_28 . V_30 = false ;
V_26 -> V_28 . V_31 = false ;
return 0 ;
}
static int F_249 ( struct V_188 * V_188 , struct V_2 * V_3 ,
struct V_189 * V_364 [] , struct V_189 * V_64 [] )
{
struct V_1 * V_76 = F_1 ( V_3 ) ;
struct V_2 * V_77 ;
int V_96 ;
...
if ( ! V_364 [ V_377 ] )
return - V_113 ;
V_77 = F_138 ( V_188 , F_137 ( V_364 [ V_377 ] ) ) ;
if ( ! V_77 )
return - V_193 ;
V_3 -> V_348 |= V_378 ;
V_76 -> V_77 = V_77 ;
if ( V_64 && V_64 [ V_366 ] )
V_57 = F_145 ( V_64 [ V_366 ] ) ;
V_3 -> V_119 = V_77 -> V_119 - V_57 - F_30 ( true ) ;
V_376 = F_6 ( V_77 -> V_376 ) ;
if ( V_376 && V_376 != F_113 )
return - V_220 ;
V_96 = F_250 ( V_3 ) ;
if ( V_96 < 0 )
return V_96 ;
...
goto V_381;
if ( V_64 && V_64 [ V_367 ] )
V_34 = F_140 ( V_64 [ V_367 ] ) ;
else if ( V_64 && V_64 [ V_368 ] )
V_34 = F_247 ( V_3 , F_255 ( V_64 [ V_368 ] ) ) ;
else
V_34 = F_247 ( V_3 , V_42 ) ;
if ( V_376 && F_246 ( V_77 , V_34 ) ) {
V_96 = - V_220 ;
goto V_382;
}
...
static int F_257 ( struct V_189 * V_364 [] , struct V_189 * V_64 [] )
{
V_199 V_384 = V_272 ;
T_3 V_57 = V_58 ;
int V_385 ;
bool V_386 , V_31 , V_34 ;
if ( ! V_64 )
return 0 ;
if ( V_64 [ V_365 ] )
V_384 = F_141 ( V_64 [ V_365 ] ) ;
if ( V_64 [ V_366 ] ) {
V_57 = F_145 ( V_64 [ V_366 ] ) ;
if ( V_57 != V_58 ) {
char V_387 [ V_371 ] = { 0 } ;
...
V_385 ++ ) {
if ( V_64 [ V_385 ] ) {
if ( F_145 ( V_64 [ V_385 ] ) > 1 )
return - V_113 ;
}
}
V_386 = V_64 [ V_360 ] ? F_145 ( V_64 [ V_360 ] ) : false ;
V_34 = V_64 [ V_359 ] ? F_145 ( V_64 [ V_359 ] ) : false ;
V_31 = V_64 [ V_361 ] ? F_145 ( V_64 [ V_361 ] ) : false ;
if ( ( V_34 && ( V_31 || V_386 ) ) || ( V_31 && V_386 ) )
return - V_113 ;
if ( V_64 [ V_363 ] &&
F_145 ( V_64 [ V_363 ] ) > V_392 )
return - V_113 ;
if ( ( V_64 [ V_362 ] &&
F_145 ( V_64 [ V_362 ] ) ) &&
! V_64 [ V_356 ] )
...
static struct V_188 * F_258 ( const struct V_2 * V_3 )
{
...
struct V_27 * V_28 = & V_26 -> V_28 ;
if ( F_142 ( V_23 , V_367 , V_26 -> V_34 ,
V_393 ) ||
F_184 ( V_23 , V_366 , V_26 -> V_57 ) ||
F_143 ( V_23 , V_365 ,
V_272 , V_393 ) ||
...
F_184 ( V_23 , V_362 , V_26 -> V_129 ) ||
F_184 ( V_23 , V_363 , V_26 -> V_131 ) ||
0 )
goto V_296;
if ( V_26 -> V_129 ) {
if ( F_175 ( V_23 , V_356 , V_26 -> V_128 ) )
goto V_296;
}
return 0 ;
V_296:
...
{
return F_265 ( V_3 -> V_376 ) == F_113 ;
}
static int F_266 ( struct V_394 * V_395 , unsigned long V_396 ,
void * V_7 )
{
...
switch ( V_396 ) {
case V_398 : {
struct V_1 * V_399 , * V_400 ;
struct V_4 * V_156 ;
V_156 = F_5 ( V_77 ) ;
F_269 (m, n, &rxd->secys, secys) {
F_235 ( V_399 -> V_26 . V_151 , & V_12 ) ;
}
F_241 ( V_77 ) ;
F_12 ( V_156 ) ;
F_270 ( & V_12 ) ;
...
struct V_2 * V_3 = V_399 -> V_26 . V_151 ;
unsigned int V_119 = V_77 -> V_119 - ( V_399 -> V_26 . V_57 +
F_30 ( true ) ) ;
if ( V_3 -> V_119 > V_119 )
F_271 ( V_3 , V_119 ) ;
}
