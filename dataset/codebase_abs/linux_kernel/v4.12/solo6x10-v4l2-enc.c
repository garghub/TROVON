...
switch ( V_250 -> type ) {
case V_93 :
return F_130 ( V_248 , V_250 , 30 , NULL ) ;
default:
return F_131 ( V_248 , V_250 ) ;
}
}
static struct V_1 * F_132 ( struct V_3 * V_3 ,
T_2 V_5 , unsigned V_251 )
{
struct V_1 * V_2 ;
struct V_252 * V_222 ;
int V_8 ;
V_2 = F_133 ( sizeof( * V_2 ) , V_253 ) ;
if ( ! V_2 )
return F_134 ( - V_254 ) ;
V_222 = & V_2 -> V_222 ;
F_135 ( V_222 , 10 ) ;
...
V_2 -> V_234 = true ;
V_2 -> V_233 = V_258 ;
V_2 -> V_187 . type = V_262 ;
V_2 -> V_187 . V_263 = V_264 | V_265 | V_266 ;
V_2 -> V_187 . V_267 = & V_268 ;
V_2 -> V_187 . V_269 = & V_270 ;
V_2 -> V_187 . V_271 = V_2 ;
V_2 -> V_187 . V_272 = V_273 | V_274 ;
V_2 -> V_187 . V_275 = V_276 ;
V_2 -> V_187 . V_277 = sizeof( struct V_102 ) ;
...
goto V_278;
* V_2 -> V_99 = V_279 ;
V_2 -> V_99 -> V_280 = & V_3 -> V_280 ;
V_2 -> V_99 -> V_281 = V_222 ;
V_2 -> V_99 -> V_282 = & V_2 -> V_187 ;
V_2 -> V_99 -> V_103 = & V_2 -> V_103 ;
F_146 ( V_2 -> V_99 , V_2 ) ;
V_8 = F_147 ( V_2 -> V_99 , V_283 , V_251 ) ;
if ( V_8 < 0 )
goto V_284;
snprintf ( V_2 -> V_99 -> V_162 , sizeof( V_2 -> V_99 -> V_162 ) ,
L_9 , V_138 , V_3 -> V_99 -> V_285 ,
V_2 -> V_99 -> V_285 ) ;
return V_2 ;
V_284:
F_148 ( V_2 -> V_99 ) ;
...
int F_154 ( struct V_3 * V_3 , unsigned V_251 )
{
int V_61 ;
F_155 ( & V_3 -> V_109 ) ;
...
V_3 -> V_116 [ V_61 ] = F_132 ( V_3 , V_61 , V_251 ) ;
...
V_3 -> V_116 [ 0 ] -> V_99 -> V_285 ,
V_3 -> V_116 [ V_3 -> V_287 - 1 ] -> V_99 -> V_285 ) ;
return F_89 ( V_3 ) ;
}
