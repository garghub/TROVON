...
static unsigned int F_48 ( struct V_65 * V_66 ,
const void * V_67 , unsigned int V_68 )
{
...
static unsigned int F_49 ( struct V_65 * V_66 ,
const void * V_67 , unsigned int V_68 )
{
const struct V_69 * V_70 = V_67 ;
struct V_74 V_75 ;
...
struct V_25 * F_71 ( struct V_93 * V_94 , char * V_73 ,
enum V_89 V_90 ,
enum V_95 V_96 ,
enum V_97 V_98 )
{
...
V_26 = F_73 ( sizeof( * V_26 ) , V_108 ) ;
if ( ! V_26 )
goto V_107;
V_26 -> V_109 = F_74 ( V_73 ,
V_102 -> V_110 , V_102 -> V_110 ,
V_102 -> V_111 , sizeof( * V_100 ) ,
V_112 ,
V_113 ,
V_102 -> V_114 ,
V_115 |
...
V_100 = F_75 ( V_26 -> V_109 , & V_30 ) ;
F_76 ( & V_100 -> V_120 , V_121 , 0 ) ;
V_100 -> V_122 = V_26 ;
}
V_26 -> V_123 = V_94 ;
V_26 -> V_124 = V_96 ;
...
V_103 = F_81 ( V_90 ) ;
V_8 = F_82 ( & V_26 -> V_137 , V_26 , V_103 , V_90 ) ;
if ( V_8 ) {
F_6 ( L_23 , V_8 ) ;
goto V_138;
}
...
static void F_87 ( struct V_61 * V_28 , struct V_139 * V_140 ,
T_5 V_141 )
{
struct V_139 * V_39 ;
int V_8 = 0 ;
bool V_142 = ! ! ( V_141 & V_143 ) ;
do {
struct V_144 * V_145 = NULL ;
struct V_146 V_147 ;
F_88 ( V_28 ) ;
F_89 (tmp, q) {
V_145 = F_90 ( V_39 , struct V_144 , V_148 ) ;
if ( F_91 ( V_145 ) ) {
V_145 = NULL ;
continue;
}
...
if ( V_142 )
F_97 ( V_145 ) ;
if ( V_142 && ( V_145 -> V_150 || V_145 -> V_151 ) ) {
F_94 ( V_28 ) ;
F_98 ( V_145 , L_24 ) ;
...
struct V_85 * V_86 , void * V_158 )
{
struct V_61 * V_28 = F_106 ( V_66 , V_86 ) ;
T_5 V_141 = * ( T_5 * ) V_158 ;
F_87 ( V_28 , & V_28 -> V_159 , V_141 ) ;
F_87 ( V_28 , & V_28 -> V_160 , V_141 ) ;
return 0 ;
}
...
int F_83 ( struct V_25 * V_26 , T_5 V_141 )
{
if ( ! V_26 ) {
F_21 ( V_64 , L_28 ) ;
return V_163 ;
}
F_111 ( V_26 -> V_109 , F_105 ,
& V_141 , 0 ) ;
F_111 ( V_26 -> V_109 , F_107 ,
NULL , 0 ) ;
return V_163 ;
}
static int F_112 ( struct V_25 * V_26 , int V_164 )
{
F_83 ( V_26 , V_164 ? V_143 : 0 ) ;
if ( F_47 ( & V_26 -> V_128 ) > 0 ) {
struct V_165 V_166 = F_113 ( V_167 , NULL ) ;
int V_8 ;
F_21 ( V_6 ,
L_29 ,
F_22 ( V_26 ) , F_47 ( & V_26 -> V_128 ) ) ;
V_168:
if ( V_164 )
V_166 = F_114 ( F_115 ( V_169 *
V_170 ) / 4 , NULL , NULL ) ;
V_8 = F_116 ( V_26 -> V_129 ,
F_47 ( & V_26 -> V_128 ) == 0 , & V_166 ) ;
if ( V_164 && V_8 == - V_171 ) {
F_117 ( L_30 ,
F_22 ( V_26 ) ,
F_47 ( & V_26 -> V_128 ) , V_8 ) ;
...
{
return F_130 ( & V_26 -> V_128 ) ;
}
void F_131 ( struct V_25 * V_26 )
{
if ( F_132 ( & V_26 -> V_128 , & V_26 -> V_127 ) ) {
F_133 ( & V_26 -> V_129 ) ;
F_120 ( & V_26 -> V_127 ) ;
}
}
...
{
F_45 ( ! F_67 ( & V_26 -> V_91 ) ) ;
F_45 ( F_135 ( F_66 ( V_90 ) ) ) ;
F_136 ( & V_26 -> V_91 , F_137 ( V_90 ) ) ;
}
...
F_45 ( ! F_67 ( & V_26 -> V_91 ) ) ;
F_45 ( F_135 ( F_66 ( V_90 ) ) ) ;
F_136 ( & V_26 -> V_91 , & V_92 ) ;
}
struct V_25 * F_139 ( enum V_89 V_90 )
{
F_45 ( F_135 ( F_66 ( V_90 ) ) ) ;
F_45 ( ! F_67 ( F_137 ( V_90 ) ) ) ;
return F_12 ( F_137 ( V_90 ) -> V_175 ,
struct V_25 , V_91 ) ;
}
...
struct V_61 * V_28 ;
int V_103 ;
V_28 = F_141 ( V_176 , V_108 ) ;
if ( ! V_28 )
return NULL ;
F_77 ( & V_28 -> V_159 ) ;
F_77 ( & V_28 -> V_160 ) ;
for ( V_103 = 0 ; V_103 < V_177 ; V_103 ++ ) {
V_28 -> V_178 [ V_103 ] . V_179 = 0 ;
V_28 -> V_178 [ V_103 ] . V_180 = 1 << V_103 ;
V_28 -> V_178 [ V_103 ] . V_181 = NULL ;
}
F_79 ( & V_28 -> V_63 , 1 ) ;
F_78 ( & V_28 -> V_182 ) ;
F_142 ( & V_28 -> V_183 ) ;
...
struct V_61 *
F_144 ( struct V_25 * V_26 , struct V_61 * V_185 ,
const struct V_69 * V_73 , enum V_186 type ,
int V_187 )
{
struct V_85 * V_86 ;
...
F_45 ( V_26 -> V_109 ) ;
F_45 ( V_73 -> V_73 [ 0 ] != 0 ) ;
F_145 ( V_26 -> V_109 , ( void * ) V_73 , & V_30 , 0 ) ;
V_86 = F_146 ( V_26 -> V_109 , & V_30 , ( void * ) V_73 ) ;
if ( V_86 ) {
F_147 ( V_26 -> V_109 , & V_30 , 0 ) ;
goto V_190;
}
V_188 = F_148 ( & V_30 ) ;
F_147 ( V_26 -> V_109 , & V_30 , 0 ) ;
if ( V_187 == 0 )
return F_149 ( - V_191 ) ;
F_150 ( type >= V_192 && type < V_193 ,
L_33 , type ) ;
V_28 = F_140 () ;
if ( ! V_28 )
return F_149 ( - V_12 ) ;
V_28 -> V_194 = F_75 ( V_26 -> V_109 , & V_30 ) ;
V_28 -> V_88 = * V_73 ;
V_28 -> V_195 = type ;
F_151 ( V_26 -> V_109 , & V_30 , 1 ) ;
V_86 = ( V_188 == F_148 ( & V_30 ) ) ? NULL :
F_146 ( V_26 -> V_109 , & V_30 , ( void * ) V_73 ) ;
if ( V_86 ) {
F_147 ( V_26 -> V_109 , & V_30 , 1 ) ;
F_152 ( & V_28 -> V_183 ) ;
F_70 ( & V_28 -> V_184 ) ;
F_153 ( V_176 , V_28 ) ;
V_190:
V_28 = F_55 ( V_86 , struct V_61 , V_87 ) ;
if ( V_26 -> V_196 && V_26 -> V_196 -> V_190 ) {
F_65 ( & V_28 -> V_184 ) ;
F_70 ( & V_28 -> V_184 ) ;
}
if ( F_154 ( V_28 -> V_197 < 0 ) ) {
V_8 = V_28 -> V_197 ;
F_63 ( V_28 ) ;
V_28 = F_149 ( V_8 ) ;
}
...
F_155 ( V_26 -> V_109 , & V_30 , & V_28 -> V_87 ) ;
if ( F_14 ( & V_30 ) == 1 )
V_189 = F_129 ( V_26 ) ;
F_147 ( V_26 -> V_109 , & V_30 , 1 ) ;
if ( V_26 -> V_196 && V_26 -> V_196 -> V_190 ) {
F_156 ( V_198 , 2 ) ;
V_8 = V_26 -> V_196 -> V_190 ( V_28 ) ;
if ( V_8 < 0 ) {
F_6 ( L_34 ,
V_26 -> V_123 -> V_199 , V_73 -> V_73 [ 0 ] ,
V_73 -> V_73 [ 1 ] , V_8 ) ;
V_28 -> V_197 = V_8 ;
F_70 ( & V_28 -> V_184 ) ;
F_63 ( V_28 ) ;
...
struct V_29 V_30 ;
F_160 ( & V_28 -> V_63 , 0 , V_200 ) ;
F_21 ( V_64 , L_35 ,
V_28 , F_47 ( & V_28 -> V_63 ) - 1 ) ;
F_161 ( V_26 -> V_109 , & V_28 -> V_88 , & V_30 ) ;
if ( F_162 ( V_26 -> V_109 , & V_30 , & V_28 -> V_63 ) ) {
F_157 ( & V_30 , V_28 ) ;
F_147 ( V_26 -> V_109 , & V_30 , 1 ) ;
if ( V_26 -> V_196 && V_26 -> V_196 -> V_201 )
V_26 -> V_196 -> V_201 ( V_28 ) ;
F_153 ( V_176 , V_28 ) ;
return 1 ;
}
return 0 ;
...
void F_164 ( struct V_61 * V_28 , struct V_139 * V_202 ,
struct V_144 * V_145 )
{
F_165 ( V_28 ) ;
F_98 ( V_145 , L_36 ) ;
...
F_45 ( F_67 ( & V_145 -> V_148 ) ) ;
F_167 ( & V_145 -> V_148 , V_202 ) ;
}
void F_168 ( struct V_144 * V_145 )
{
int type = V_145 -> V_204 -> V_195 ;
F_165 ( V_145 -> V_204 ) ;
if ( type == V_205 || type == V_206 )
F_169 ( V_145 ) ;
else if ( type == V_207 )
F_170 ( V_145 ) ;
F_124 ( & V_145 -> V_148 ) ;
}
void F_171 ( struct V_61 * V_28 , struct V_208 * V_209 )
{
V_209 -> V_195 = V_28 -> V_195 ;
V_209 -> V_88 = V_28 -> V_88 ;
}
void F_2 ( enum V_89 V_90 , int V_210 )
{
struct V_139 * V_39 ;
if ( ! ( ( V_211 | V_162 ) & V_210 ) )
return;
F_65 ( F_66 ( V_90 ) ) ;
F_89 (tmp, ldlm_namespace_list(client)) {
struct V_25 * V_26 ;
V_26 = F_90 ( V_39 , struct V_25 , V_91 ) ;
F_172 ( V_210 , V_26 ) ;
}
F_70 ( F_66 ( V_90 ) ) ;
}
...
{
struct V_61 * V_28 = F_106 ( V_66 , V_86 ) ;
int V_210 = ( int ) ( unsigned long ) V_158 ;
F_88 ( V_28 ) ;
F_110 ( V_210 , V_28 ) ;
F_94 ( V_28 ) ;
return 0 ;
}
void F_172 ( int V_210 , struct V_25 * V_26 )
{
if ( ! ( ( V_211 | V_162 ) & V_210 ) )
return;
F_21 ( V_210 , L_38 ,
F_22 ( V_26 ) , F_47 ( & V_26 -> V_128 ) ) ;
if ( F_174 ( F_175 () , V_26 -> V_212 ) )
return;
F_111 ( V_26 -> V_109 ,
F_173 ,
( void * ) ( unsigned long ) V_210 , 0 ) ;
F_119 ( & V_26 -> V_127 ) ;
V_26 -> V_212 = F_176 ( 10 ) ;
F_120 ( & V_26 -> V_127 ) ;
}
void F_110 ( int V_210 , struct V_61 * V_28 )
{
struct V_144 * V_145 ;
