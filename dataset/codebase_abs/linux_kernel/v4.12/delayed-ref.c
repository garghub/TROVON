...
int V_101 ;
F_42 ( V_81 && V_81 -> V_55 ) ;
V_37 = F_54 ( V_95 , V_102 ) ;
if ( ! V_37 )
return - V_103 ;
V_88 = F_54 ( V_104 , V_102 ) ;
if ( ! V_88 )
goto V_105;
if ( F_55 ( V_106 , & V_54 -> V_107 ) &&
F_45 ( V_89 ) ) {
V_100 = F_56 ( sizeof( * V_100 ) , V_102 ) ;
if ( ! V_100 )
goto V_108;
}
V_88 -> V_81 = V_81 ;
V_29 = & V_26 -> V_30 -> V_29 ;
F_16 ( & V_29 -> V_31 ) ;
V_88 = F_57 ( V_54 , V_26 , & V_88 -> V_8 , V_100 ,
V_19 , V_68 , 0 , 0 , V_51 , 0 ,
& V_101 ) ;
F_44 ( V_54 , V_26 , V_88 , & V_37 -> V_8 , V_19 ,
V_68 , V_6 , V_89 , V_90 , V_51 ) ;
F_14 ( & V_29 -> V_31 ) ;
if ( V_101 )
return F_58 ( V_54 , V_100 ) ;
return 0 ;
V_108:
F_50 ( V_104 , V_88 ) ;
V_105:
...
V_51 , 1 , & V_101 ) ;
F_51 ( V_54 , V_26 , V_88 , & V_37 -> V_8 , V_19 ,
...
V_29 = & V_26 -> V_30 -> V_29 ;
F_16 ( & V_29 -> V_31 ) ;
F_57 ( V_54 , V_26 , & V_88 -> V_8 , NULL , V_19 ,
V_68 , 0 , 0 , V_110 ,
V_81 -> V_55 , NULL ) ;
F_14 ( & V_29 -> V_31 ) ;
return 0 ;
