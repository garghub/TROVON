...
V_70 = F_3 ( V_2 -> V_5 + V_44 ) ;
if ( V_70 & V_45 ) {
F_31 ( V_59 , V_72 ) ;
V_71 = V_69 ;
V_39 = V_40 ;
} else {
V_71 = F_32 ( V_40 , V_39 , V_2 -> V_8 ) ;
V_71 *= V_43 ;
}
if ( ! V_46 -> V_55 && V_71 > V_59 -> V_68 ) {
T_1 V_73 = ~ ( V_43 - 1 ) ;
V_71 = V_59 -> V_68 & V_73 ;
V_39 = ( V_40 + V_2 -> V_8 ) -
V_71 / V_43 ;
...
return sprintf ( V_46 , L_12 , V_22 ) ;
}
static T_3 F_43 ( struct V_84 * V_4 ,
struct V_85 * V_86 ,
const char * V_46 , T_5 V_68 )
{
int V_61 ;
unsigned long V_22 ;
struct V_1 * V_2 = F_10 ( V_4 -> V_24 ) ;
