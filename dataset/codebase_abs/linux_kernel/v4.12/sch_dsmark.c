...
static int F_59 ( struct V_5 * V_6 , unsigned long V_18 ,
...
if ( ! F_1 ( V_2 , V_18 ) )
return - V_26 ;
V_84 -> V_86 = F_60 ( F_28 ( V_6 -> V_13 ) , V_18 - 1 ) ;
V_84 -> V_87 = V_2 -> V_15 -> V_13 ;
V_85 = F_61 ( V_46 , V_22 ) ;
if ( V_85 == NULL )
goto V_88;
if ( F_62 ( V_46 , V_33 , V_2 -> V_31 [ V_18 - 1 ] . V_34 ) ||
F_62 ( V_46 , V_30 , V_2 -> V_31 [ V_18 - 1 ] . V_32 ) )
goto V_88;
return F_63 ( V_46 , V_85 ) ;
V_88:
F_64 ( V_46 , V_85 ) ;
return - V_89 ;
}
static int F_65 ( struct V_5 * V_6 , struct V_45 * V_46 )
{
struct V_1 * V_2 = F_3 ( V_6 ) ;
struct V_19 * V_85 = NULL ;
V_85 = F_61 ( V_46 , V_22 ) ;
if ( V_85 == NULL )
goto V_88;
if ( F_66 ( V_46 , V_74 , V_2 -> V_4 ) )
goto V_88;
if ( V_2 -> V_68 != V_69 &&
F_66 ( V_46 , V_75 , V_2 -> V_68 ) )
goto V_88;
if ( V_2 -> V_48 &&
F_67 ( V_46 , V_80 ) )
goto V_88;
