...
static struct V_48 *
F_167 ( struct V_8 * V_8 , int (* F_168)( struct V_48 * V_12 , void * V_199 ) ,
...
return;
while ( ( V_49 = F_167 ( V_8 , F_168 , V_199 , & V_90 ) ) != NULL ) {
F_66 ( V_49 , V_78 , V_79 ) ;
F_61 ( V_49 ) ;
F_169 () ;
}
}
static int F_176 ( struct V_48 * V_12 , void * V_199 )
{
return 1 ;
}
void F_177 ( void * V_26 , unsigned int V_28 )
{
if ( F_178 ( V_26 ) )
F_179 ( V_26 ) ;
else
F_180 ( ( unsigned long ) V_26 ,
F_181 ( sizeof( struct V_201 ) * V_28 ) ) ;
}
void F_182 ( void )
{
V_143 . V_153 = true ;
...
void F_196 ( struct V_8 * V_8 )
{
F_197 ( V_204 ) ;
F_198 ( & V_8 -> V_205 , & V_204 ) ;
F_199 ( & V_204 ) ;
}
void F_199 ( struct V_206 * V_207 )
{
int V_208 ;
struct V_8 * V_8 ;
F_200 () ;
V_209:
V_208 = 0 ;
F_201 (net, net_exit_list, exit_list) {
...
F_207 ( V_8 ) ;
F_208 ( V_8 ) ;
F_209 ( V_8 -> V_49 . V_210 ) ;
F_209 ( V_8 -> V_49 . V_56 ) ;
}
}
void * F_210 ( unsigned int * V_211 , int V_212 )
{
struct V_87 * V_26 ;
unsigned int V_213 , V_12 ;
T_7 V_214 ;
if ( * V_211 > ( V_215 / sizeof( struct V_87 ) ) )
return NULL ;
F_129 ( sizeof( struct V_87 ) != sizeof( struct V_201 ) ) ;
V_213 = * V_211 = F_211 ( * V_211 , V_216 / sizeof( struct V_87 ) ) ;
if ( V_213 > ( V_215 / sizeof( struct V_87 ) ) )
return NULL ;
V_214 = V_213 * sizeof( struct V_87 ) ;
V_26 = ( void * ) F_212 ( V_217 | V_218 | V_219 ,
F_181 ( V_214 ) ) ;
if ( ! V_26 )
V_26 = F_213 ( V_214 ) ;
if ( V_26 && V_212 )
for ( V_12 = 0 ; V_12 < V_213 ; V_12 ++ )
F_214 ( & V_26 [ V_12 ] , V_12 ) ;
return V_26 ;
}
int F_215 ( unsigned int V_220 )
{
int V_12 , V_90 ;
unsigned int V_221 ;
struct V_87 * V_26 , * V_222 ;
struct V_85 * V_86 ;
struct V_48 * V_49 ;
if ( ! V_220 )
return - V_194 ;
...
while ( ! F_217 ( & V_94 [ V_12 ] ) ) {
V_86 = F_218 ( V_94 [ V_12 ] . V_223 ,
struct V_85 , V_51 ) ;
V_49 = F_74 ( V_86 ) ;
F_32 ( & V_86 -> V_51 ) ;
V_90 = F_21 ( F_37 ( V_49 ) ,
...
int F_220 ( const char * V_224 , struct V_225 * V_226 )
{
unsigned int V_220 ;
int V_227 ;
if ( V_228 -> V_229 -> V_230 != & V_231 )
return - V_232 ;
if ( ! V_27 )
return F_221 ( V_224 , V_226 ) ;
V_227 = F_222 ( V_224 , 0 , & V_220 ) ;
if ( V_227 )
return V_227 ;
return F_215 ( V_220 ) ;
}
static T_8 unsigned int F_223 ( void )
{
F_129 ( V_233 > 9 ) ;
return sizeof( struct V_234 ) +
sizeof( struct V_114 )
#if F_224 ( V_235 )
+ sizeof( struct V_236 )
#endif
...
= ( ( ( V_244 << V_245 ) / 16384 )
/ sizeof( struct V_201 ) ) ;
if ( V_244 > ( 4 * ( 1024 * 1024 * 1024 / V_216 ) ) )
V_27 = 65536 ;
else if ( V_244 > ( 1024 * 1024 * 1024 / V_216 ) )
V_27 = 16384 ;
if ( V_27 < 32 )
V_27 = 32 ;
V_243 = 4 ;
...
int F_243 ( struct V_8 * V_8 )
{
int V_42 = - V_160 ;
int V_55 ;
F_129 ( V_172 == V_260 ) ;
F_48 ( & V_8 -> V_49 . V_152 , 0 ) ;
V_8 -> V_49 . V_56 = F_244 ( struct V_53 ) ;
if ( ! V_8 -> V_49 . V_56 )
goto V_261;
F_170 (cpu) {
struct V_53 * V_54 = F_36 ( V_8 -> V_49 . V_56 , V_55 ) ;
F_138 ( & V_54 -> V_1 ) ;
F_214 ( & V_54 -> V_58 , V_262 ) ;
F_214 ( & V_54 -> V_57 , V_263 ) ;
}
V_8 -> V_49 . V_210 = F_244 ( struct V_264 ) ;
if ( ! V_8 -> V_49 . V_210 )
goto V_265;
V_42 = F_245 ( V_8 ) ;
if ( V_42 < 0 )
