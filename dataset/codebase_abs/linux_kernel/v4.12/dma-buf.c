...
F_73 ( V_119 , L_3 ,
L_4 , L_5 , L_6 , L_7 ) ;
F_74 (buf_obj, &db_list.head, list_node) {
...
F_73 ( V_119 , L_9 ,
V_121 -> V_22 ,
V_121 -> V_2 -> V_126 , V_121 -> V_2 -> V_88 ,
F_75 ( V_121 -> V_2 ) ,
V_121 -> V_86 ) ;
V_123 = V_121 -> V_16 ;
while ( true ) {
V_44 = F_20 ( & V_123 -> V_44 ) ;
F_21 () ;
V_40 = F_22 ( V_123 -> V_32 ) ;
V_43 = V_40 ? V_40 -> V_43 : 0 ;
V_32 = F_22 ( V_123 -> V_41 ) ;
if ( ! F_23 ( & V_123 -> V_44 , V_44 ) )
break;
F_24 () ;
}
if ( V_32 )
F_73 ( V_119 , L_10 ,
V_32 -> V_11 -> V_127 ( V_32 ) ,
V_32 -> V_11 -> V_128 ( V_32 ) ,
F_76 ( V_32 ) ? L_11 : L_12 ) ;
for ( V_50 = 0 ; V_50 < V_43 ; V_50 ++ ) {
V_32 = F_22 ( V_40 -> V_52 [ V_50 ] ) ;
if ( ! F_27 ( V_32 ) )
continue;
F_73 ( V_119 , L_13 ,
V_32 -> V_11 -> V_127 ( V_32 ) ,
...
F_72 ( V_119 , L_14 ) ;
V_125 = 0 ;
F_74 (attach_obj, &buf_obj->attachments, node) {
F_72 ( V_119 , L_15 ) ;
F_73 ( V_119 , L_16 , F_77 ( V_122 -> V_95 ) ) ;
V_125 ++ ;
}
F_73 ( V_119 , L_17 ,
V_125 ) ;
...
F_73 ( V_119 , L_18 , V_124 , V_22 ) ;
F_6 ( & V_13 . V_14 ) ;
return 0 ;
}
static int F_78 ( struct V_1 * V_1 , struct V_2 * V_2 )
{
return F_79 ( V_2 , F_70 , NULL ) ;
}
static int F_80 ( void )
{
struct V_129 * V_130 ;
int V_131 = 0 ;
V_130 = F_81 ( L_19 , NULL ) ;
if ( F_42 ( V_130 ) )
return F_43 ( V_130 ) ;
V_132 = V_130 ;
V_130 = F_82 ( L_20 , V_133 , V_132 ,
NULL , & V_134 ) ;
if ( F_42 ( V_130 ) ) {
F_83 ( L_21 ) ;
F_84 ( V_132 ) ;
