...
V_26 -> V_85 = F_45 ( V_29 -> V_83 ) ;
V_26 -> V_86 = F_46 ( V_29 -> V_83 ) ;
V_26 -> V_87 = 0 ;
...
F_75 ( V_4 ) ;
V_12:
F_76 ( & V_22 -> V_59 . V_119 , F_67 ) ;
if ( V_123 )
F_77 ( V_22 ) ;
return V_45 ;
}
static struct V_3 * F_78 ( struct V_126 * V_126 ,
struct V_21 * V_24 ,
struct V_106 * V_106 )
{
struct V_3 * V_4 ;
...
F_81 ( & V_4 -> V_125 , 1 ) ;
F_71 ( & V_124 ) ;
F_82 ( & V_4 -> V_117 , F_14 ( F_83 ( V_126 ) ) ) ;
strncpy ( V_4 -> V_16 , F_84 ( V_24 -> V_59 . V_60 ) , sizeof( V_4 -> V_16 ) - 1 ) ;
F_13 ( L_12 ,
F_85 ( V_100 , V_126 -> V_127 ) , V_4 -> V_11 ) ;
F_73 ( & V_124 ) ;
return V_4 ;
}
static struct V_3 * F_86 ( int V_128 , struct V_21 * V_22 )
{
struct V_3 * V_4 ;
F_71 ( & V_124 ) ;
...
static struct V_3 * F_89 ( struct V_126 * V_126 , struct V_106 * V_106 )
{
struct V_3 * V_4 ;
struct V_57 * V_58 ;
F_71 ( & V_124 ) ;
V_58 = F_90 ( & V_130 , F_83 ( V_126 ) ) ;
if ( V_58 )
F_91 ( & V_58 -> V_119 ) ;
F_73 ( & V_124 ) ;
if ( ! V_58 )
return F_7 ( - V_131 ) ;
V_4 = F_86 ( F_83 ( V_126 ) , V_58 -> V_53 ) ;
if ( V_4 )
return V_4 ;
V_4 = F_78 ( V_126 , V_58 -> V_53 , V_106 ) ;
if ( F_25 ( V_4 ) )
F_76 ( & V_58 -> V_119 , F_67 ) ;
return V_4 ;
}
static int F_92 ( struct V_126 * V_126 , struct V_106 * V_106 )
{
struct V_3 * V_4 ;
V_4 = F_89 ( V_126 , V_106 ) ;
if ( F_25 ( V_4 ) )
return F_28 ( V_4 ) ;
V_106 -> V_112 = V_4 ;
return 0 ;
...
static unsigned int F_94 ( struct V_106 * V_106 , T_5 * V_132 )
{
struct V_3 * V_4 = V_106 -> V_112 ;
unsigned int V_133 = 0 ;
F_95 ( V_106 , & V_4 -> V_75 , V_132 ) ;
F_95 ( V_106 , & V_4 -> V_9 , V_132 ) ;
F_8 ( & V_4 -> V_7 ) ;
if ( ! F_96 ( & V_4 -> V_73 ) )
V_133 |= V_134 | V_135 ;
if ( V_4 -> V_8 < V_4 -> V_11 )
...
static long F_97 ( struct V_106 * V_106 , unsigned int V_32 , unsigned long V_137 )
{
struct V_3 * V_4 = V_106 -> V_112 ;
...
return F_100 ( V_4 -> V_53 , NULL , V_106 -> V_114 , V_32 , V_138 ) ;
}
case V_150 : {
struct V_23 * V_24 ;
...
F_101 ( V_4 -> V_53 , NULL , V_24 , V_76 ) ;
V_45 = F_44 ( V_24 , & V_26 , V_68 , V_78 ) ;
if ( F_48 ( V_138 , & V_26 , sizeof( V_26 ) ) )
return - V_34 ;
return V_45 ;
}
default:
...
return;
F_71 ( & V_124 ) ;
F_103 ( & V_130 , V_58 -> V_128 ) ;
if ( V_22 -> V_152 . V_153 )
F_104 ( & V_22 -> V_152 , L_13 ) ;
F_105 ( V_58 -> V_60 ) ;
V_58 -> V_60 = NULL ;
F_76 ( & V_58 -> V_119 , F_67 ) ;
F_73 ( & V_124 ) ;
}
int F_106 ( struct V_21 * V_22 , struct V_120 * V_121 ,
...
F_71 ( & V_124 ) ;
V_45 = F_108 ( & V_130 , V_58 , 0 , V_156 , V_13 ) ;
if ( V_45 < 0 ) {
if ( V_45 == - V_109 ) {
F_109 ( V_157 L_14 ) ;
V_45 = - V_10 ;
...
V_58 -> V_128 = V_45 ;
V_58 -> V_53 = V_22 ;
V_58 -> V_121 = F_110 ( V_121 ) ;
V_58 -> V_122 = V_122 ;
F_111 ( & V_58 -> V_119 ) ;
V_154 = F_112 ( V_159 , V_58 -> V_128 ) ;
V_60 = F_113 ( V_160 , V_121 , V_154 , NULL , L_15 , V_155 ) ;
if ( F_25 ( V_60 ) ) {
V_45 = F_28 ( V_60 ) ;
goto V_161;
}
V_58 -> V_60 = V_60 ;
if ( V_22 -> V_152 . V_153 ) {
V_45 = F_114 ( & V_22 -> V_152 , & V_58 -> V_60 -> V_152 , L_13 ) ;
if ( V_45 )
goto V_162;
}
F_73 ( & V_124 ) ;
...
static char * F_115 ( struct V_120 * V_154 , T_7 * V_163 )
{
return F_116 ( V_13 , L_16 , F_84 ( V_154 ) ) ;
}
...
V_160 -> V_168 = F_115 ;
V_45 = F_121 ( & V_165 , 0 , V_156 , L_13 ) ;
if ( V_45 )
goto V_169;
V_159 = F_122 ( V_165 ) ;
F_123 ( & V_170 , & V_171 ) ;
V_45 = F_124 ( & V_170 , F_112 ( V_159 , 0 ) , V_156 ) ;
if ( V_45 )
goto V_172;
