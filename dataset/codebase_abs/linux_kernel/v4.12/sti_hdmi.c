...
F_39 ( V_2 -> V_126 ) ;
V_2 -> V_83 = false ;
F_54 ( V_2 -> V_127 , V_128 ) ;
}
static int F_55 ( unsigned int V_129 )
{
unsigned int V_130 ;
switch ( V_129 ) {
case 32000 :
...
V_73 = F_59 ( V_2 -> V_126 , V_27 -> clock * 1000 ) ;
if ( V_73 < 0 ) {
F_18 ( L_64 ,
V_27 -> clock * 1000 ) ;
return;
}
V_73 = F_59 ( V_2 -> V_124 , V_27 -> clock * 1000 ) ;
if ( V_73 < 0 ) {
F_18 ( L_65 ,
V_27 -> clock * 1000 ) ;
return;
...
static int F_61 ( struct V_149 * V_150 )
{
struct V_151 * V_152
= F_62 ( V_150 ) ;
...
F_66 ( V_2 -> V_127 , V_153 ) ;
V_154 = F_67 ( V_150 , V_153 ) ;
F_68 ( V_150 , V_153 ) ;
F_69 ( V_150 , V_153 ) ;
F_70 ( V_153 ) ;
return V_154 ;
...
static int F_71 ( struct V_149 * V_150 ,
struct V_68 * V_27 )
{
...
static enum V_166
F_73 ( struct V_149 * V_150 , bool V_167 )
{
struct V_151 * V_152
= F_62 ( V_150 ) ;
struct V_1 * V_2 = V_152 -> V_2 ;
...
static void F_74 ( struct V_170 * V_13 ,
struct V_149 * V_150 )
{
struct V_151 * V_152
= F_62 ( V_150 ) ;
...
V_152 -> V_175 = V_172 ;
F_76 ( & V_150 -> V_176 , V_172 , V_2 -> V_74 ) ;
}
static int
F_77 ( struct V_149 * V_150 ,
struct V_177 * V_178 ,
struct V_171 * V_179 ,
T_5 V_5 )
{
...
static int F_79 ( struct V_149 * V_150 )
{
struct V_151 * V_152
= F_62 ( V_150 ) ;
struct V_1 * V_2 = V_152 -> V_2 ;
if ( F_50 ( V_2 , V_2 -> V_13 -> V_180 ) ) {
F_18 ( L_78 ) ;
return - V_145 ;
}
return 0 ;
}
static struct V_181 * F_80 ( struct V_170 * V_182 )
{
struct V_181 * V_183 ;
...
static void F_82 ( struct V_186 * V_182 , void * V_60 )
{
struct V_1 * V_2 = F_83 ( V_182 ) ;
int V_131 ;
F_14 ( L_2 ) ;
V_131 = V_136 | V_137 |
V_138 ;
...
static int F_84 ( struct V_186 * V_182 ,
void * V_60 ,
struct V_187 * V_188 ,
struct V_189 * V_132 )
{
...
static int F_86 ( struct V_186 * V_182 , void * V_60 , bool V_197 )
{
struct V_1 * V_2 = F_83 ( V_182 ) ;
F_14 ( L_80 , V_197 ? L_10 : L_11 ) ;
if ( V_197 )
F_3 ( V_2 , V_198 , V_199 ) ;
else
F_3 ( V_2 , V_200 , V_199 ) ;
...
static int F_87 ( struct V_186 * V_182 , void * V_60 , T_6 * V_201 , T_4 V_202 )
{
struct V_1 * V_2 = F_83 ( V_182 ) ;
struct V_149 * V_150 = V_2 -> V_149 ;
F_14 ( L_2 ) ;
memcpy ( V_201 , V_150 -> V_203 , F_88 ( sizeof( V_150 -> V_203 ) , V_202 ) ) ;
return 0 ;
}
static int F_89 ( struct V_186 * V_182 ,
struct V_1 * V_2 )
{
struct V_204 V_205 = {
. V_206 = & V_207 ,
...
& V_205 , sizeof( V_205 ) ) ;
if ( F_91 ( V_2 -> V_210 ) )
return F_92 ( V_2 -> V_210 ) ;
F_8 ( L_81 , V_211 , F_93 ( V_182 ) ) ;
return 0 ;
}
static int F_94 ( struct V_186 * V_182 , struct V_186 * V_213 , void * V_60 )
{
struct V_1 * V_2 = F_83 ( V_182 ) ;
...
if ( ! V_183 )
return - V_145 ;
V_150 = F_95 ( V_182 , sizeof( * V_150 ) , V_215 ) ;
if ( ! V_150 )
return - V_145 ;
V_150 -> V_2 = V_2 ;
V_117 = F_95 ( V_182 , sizeof( * V_117 ) , V_215 ) ;
if ( ! V_117 )
return - V_145 ;
V_117 -> V_118 = V_2 ;
V_117 -> V_216 = & V_217 ;
F_96 ( V_183 , V_117 , NULL ) ;
V_150 -> V_183 = V_183 ;
...
F_74 ( V_13 , V_149 ) ;
V_2 -> V_149 = V_149 ;
V_214 = F_99 ( V_149 , V_183 ) ;
if ( V_214 ) {
F_18 ( L_82 ) ;
goto V_223;
}
V_214 = F_89 ( V_182 , V_2 ) ;
if ( V_214 ) {
F_18 ( L_83 ) ;
goto V_223;
}
V_214 = F_100 ( & V_2 -> V_80 . V_84 ) ;
if ( V_214 ) {
F_18 ( L_84 ) ;
goto V_223;
}
...
static void F_102 ( struct V_186 * V_182 ,
...
int V_73 ;
F_8 ( L_80 , V_82 ) ;
V_2 = F_95 ( V_182 , sizeof( * V_2 ) , V_215 ) ;
if ( ! V_2 )
return - V_233 ;
V_232 = F_104 ( V_226 -> V_182 . V_229 , L_85 , 0 ) ;
if ( V_232 ) {
V_2 -> V_155 = F_105 ( V_232 ) ;
F_106 ( V_232 ) ;
if ( ! V_2 -> V_155 )
return - V_234 ;
}
V_2 -> V_182 = V_226 -> V_182 ;
V_231 = F_107 ( V_226 , V_235 , L_86 ) ;
if ( ! V_231 ) {
F_18 ( L_87 ) ;
V_73 = - V_233 ;
goto V_236;
}
V_2 -> V_4 = F_108 ( V_182 , V_231 -> V_146 , F_109 ( V_231 ) ) ;
if ( ! V_2 -> V_4 ) {
V_73 = - V_233 ;
goto V_236;
}
V_2 -> V_119 = (struct V_237 * )
F_110 ( V_238 , V_228 ) -> V_60 ;
V_2 -> V_126 = F_111 ( V_182 , L_88 ) ;
if ( F_91 ( V_2 -> V_126 ) ) {
F_18 ( L_89 ) ;
V_73 = F_92 ( V_2 -> V_126 ) ;
goto V_236;
}
V_2 -> V_125 = F_111 ( V_182 , L_90 ) ;
if ( F_91 ( V_2 -> V_125 ) ) {
F_18 ( L_91 ) ;
V_73 = F_92 ( V_2 -> V_125 ) ;
goto V_236;
}
V_2 -> V_124 = F_111 ( V_182 , L_92 ) ;
if ( F_91 ( V_2 -> V_124 ) ) {
F_18 ( L_93 ) ;
V_73 = F_92 ( V_2 -> V_124 ) ;
goto V_236;
}
V_2 -> V_87 = F_111 ( V_182 , L_94 ) ;
if ( F_91 ( V_2 -> V_87 ) ) {
F_18 ( L_95 ) ;
V_73 = F_92 ( V_2 -> V_87 ) ;
goto V_236;
...
V_2 -> V_10 = F_2 ( V_2 -> V_4 + V_11 ) & V_12 ;
F_112 ( & V_2 -> V_17 ) ;
V_2 -> V_6 = F_113 ( V_226 , L_96 ) ;
V_73 = F_114 ( V_182 , V_2 -> V_6 , F_9 ,
F_5 , V_239 , F_93 ( V_182 ) , V_2 ) ;
if ( V_73 ) {
F_18 ( L_97 ) ;
goto V_236;
}
V_2 -> V_127 = F_115 ( & V_226 -> V_182 ) ;
if ( ! V_2 -> V_127 )
goto V_236;
V_2 -> V_240 = F_116 ( V_182 , L_98 ) ;
if ( ! F_91 ( V_2 -> V_240 ) )
F_117 ( V_2 -> V_240 ) ;
F_118 ( V_226 , V_2 ) ;
return F_119 ( & V_226 -> V_182 , & V_241 ) ;
V_236:
F_120 ( V_2 -> V_155 ) ;
return V_73 ;
}
...
{
struct V_1 * V_2 = F_83 ( & V_226 -> V_182 ) ;
F_54 ( V_2 -> V_127 , V_128 ) ;
F_120 ( V_2 -> V_155 ) ;
if ( V_2 -> V_210 )
F_122 ( V_2 -> V_210 ) ;
F_123 ( & V_226 -> V_182 , & V_241 ) ;
F_124 ( V_2 -> V_127 ) ;
return 0 ;
}
