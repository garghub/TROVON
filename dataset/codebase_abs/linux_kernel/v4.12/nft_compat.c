...
if ( V_30 < 0 )
return V_30 ;
V_139 = F_48 ( V_140 , V_141 ) ;
if ( V_139 == NULL )
return - V_142 ;
if ( F_38 ( V_139 , F_49 ( V_29 ) . V_117 ,
V_122 -> V_143 ,
F_50 ( V_122 -> V_144 ) ,
V_145 ,
V_124 -> V_128 ,
...
V_30 = F_52 ( V_137 , V_139 , F_49 ( V_29 ) . V_117 ,
V_147 ) ;
if ( V_30 > 0 )
V_30 = 0 ;
return V_30 == - V_148 ? - V_149 : V_30 ;
}
...
( V_107 -> V_53 == V_150 || V_107 -> V_53 == V_53 ) ;
}
static const struct V_151 *
...
V_84 [ V_113 ] == NULL )
return F_55 ( - V_11 ) ;
V_153 = F_19 ( V_84 [ V_115 ] ) ;
V_120 = F_15 ( F_16 ( V_84 [ V_116 ] ) ) ;
V_53 = V_44 -> V_52 -> V_53 ;
F_56 (nft_match, &nft_match_list, head) {
struct V_106 * V_107 = V_152 -> V_26 . V_27 ;
if ( F_53 ( V_107 , V_153 , V_120 , V_53 ) ) {
if ( ! F_57 ( V_107 -> V_97 ) )
return F_55 ( - V_154 ) ;
V_152 -> V_3 ++ ;
return & V_152 -> V_26 ;
...
V_152 = F_60 ( sizeof( struct V_1 ) , V_141 ) ;
if ( V_152 == NULL ) {
V_86 = - V_142 ;
goto V_86;
}
V_152 -> V_3 = 1 ;
V_152 -> V_26 . type = & V_155 ;
V_152 -> V_26 . V_92 = F_61 ( F_12 ( V_107 -> V_112 ) ) ;
V_152 -> V_26 . V_156 = F_30 ;
V_152 -> V_26 . V_157 = F_33 ;
V_152 -> V_26 . V_99 = F_35 ;
V_152 -> V_26 . V_158 = F_36 ;
V_152 -> V_26 . V_159 = F_37 ;
V_152 -> V_26 . V_27 = V_107 ;
F_62 ( & V_152 -> V_4 , & V_160 ) ;
return & V_152 -> V_26 ;
V_86:
F_21 ( V_107 -> V_97 ) ;
return F_55 ( V_86 ) ;
}
static bool F_63 ( const struct V_25 * V_161 ,
const char * V_51 , T_2 V_120 , T_2 V_53 )
{
return strcmp ( V_161 -> V_51 , V_51 ) == 0 && V_161 -> V_102 == V_120 &&
( V_161 -> V_53 == V_150 || V_161 -> V_53 == V_53 ) ;
}
static const struct V_151 *
...
V_84 [ V_93 ] == NULL )
return F_55 ( - V_11 ) ;
V_163 = F_19 ( V_84 [ V_100 ] ) ;
V_120 = F_15 ( F_16 ( V_84 [ V_101 ] ) ) ;
V_53 = V_44 -> V_52 -> V_53 ;
F_56 (nft_target, &nft_target_list, head) {
struct V_25 * V_15 = V_162 -> V_26 . V_27 ;
if ( F_63 ( V_15 , V_163 , V_120 , V_53 ) ) {
if ( ! F_57 ( V_15 -> V_97 ) )
return F_55 ( - V_154 ) ;
V_162 -> V_3 ++ ;
return & V_162 -> V_26 ;
...
V_162 = F_60 ( sizeof( struct V_1 ) , V_141 ) ;
if ( V_162 == NULL ) {
V_86 = - V_142 ;
goto V_86;
}
V_162 -> V_3 = 1 ;
V_162 -> V_26 . type = & V_164 ;
V_162 -> V_26 . V_92 = F_61 ( F_12 ( V_15 -> V_81 ) ) ;
V_162 -> V_26 . V_157 = F_17 ;
V_162 -> V_26 . V_99 = F_22 ;
V_162 -> V_26 . V_158 = F_24 ;
V_162 -> V_26 . V_159 = F_29 ;
V_162 -> V_26 . V_27 = V_15 ;
if ( V_53 == V_65 )
V_162 -> V_26 . V_156 = F_9 ;
else
V_162 -> V_26 . V_156 = F_7 ;
F_62 ( & V_162 -> V_4 , & V_165 ) ;
return & V_162 -> V_26 ;
V_86:
F_21 ( V_15 -> V_97 ) ;
return F_55 ( V_86 ) ;
