...
#ifdef F_54
struct V_95 * V_96 = F_55 ( & V_58 -> V_97 ) ;
int V_9 ;
#endif
int V_27 ;
F_3 ( L_19 , V_12 ) ;
for ( V_27 = 0 ; V_27 < V_15 -> V_66 ; V_27 ++ ) {
if ( F_42 ( V_98 , V_58 -> V_41 [ V_27 ] , V_15 ,
& V_99 ) == NULL )
return - V_70 ;
V_58 -> V_41 [ V_27 ] -> V_67 . V_100 = V_58 -> V_41 [ V_27 ] -> V_67 . V_91 . V_92 ;
}
#ifdef F_54
V_15 -> V_101 . V_102 = V_103 ;
V_15 -> V_101 . V_104 = L_22 ;
V_15 -> V_105 [ V_106 ] . V_107 = V_108 ;
V_15 -> V_105 [ V_109 ] . V_107 = V_110 ;
V_9 = F_56 ( & V_15 -> V_101 ,
V_111 , V_15 -> V_105 ) ;
if ( V_9 )
return V_9 ;
V_9 = F_57 ( V_96 , & V_15 -> V_101 ) ;
if ( V_9 )
return V_9 ;
#endif
return 0 ;
}
static T_3 F_58 ( struct V_112 * V_113 )
{
return V_114 ;
}
...
struct V_14 * V_15 = F_41 ( V_2 ) ;
int V_9 ;
static T_1 V_115 [ 256 ] ;
T_1 V_116 = 0 ;
struct V_117 V_118 [ 2 ] = {
{ . V_16 = 0xa0 >> 1 , . V_119 = 1 , . V_18 = & V_116 } ,
{ . V_16 = 0xa0 >> 1 , . V_107 = V_120 ,
. V_119 = sizeof( V_115 ) , . V_18 = V_115 } ,
} ;
V_9 = F_44 ( V_15 ) ;
if ( F_6 ( V_9 ) )
F_9 ( L_23 ) ;
...
if ( V_15 -> V_36 > V_37 )
F_25 ( V_15 , V_51 ) ;
V_9 = F_61 ( & V_2 -> V_65 , V_118 , 2 ) ;
if ( F_6 ( V_9 ) )
return 0 ;
F_62 ( & V_15 -> V_121 , ( 0x84 == V_115 [ 0xa0 ] ) ?
V_115 + 0xa0 : V_115 + 0x80 ) ;
#if 0
...
static void F_69 ( struct V_123 * V_124 , T_1 V_125 )
{
F_3 ( L_25 , V_12 , V_125 ) ;
V_124 -> type = V_126 ;
V_124 -> V_127 = 5 ;
V_124 -> V_125 = V_125 ;
V_124 -> V_128 . V_129 . V_130 = 8192 ;
}
static void F_70 ( struct V_123 * V_124 ,
T_1 V_125 , int V_131 , int V_132 )
{
F_3 ( L_26 , V_12 , V_125 ,
V_131 * V_132 ) ;
V_124 -> type = V_133 ;
V_124 -> V_127 = 5 ;
V_124 -> V_125 = V_125 ;
V_124 -> V_128 . V_134 . V_131 = V_131 ;
V_124 -> V_128 . V_134 . V_132 = V_132 ;
V_124 -> V_128 . V_134 . V_135 = 1 ;
}
static int F_71 ( struct V_40 * V_41 ,
T_1 * V_136 , struct V_123 * V_124 )
{
...
static int F_76 ( struct V_40 * V_41 ,
T_1 * V_136 , struct V_123 * V_124 )
{
F_3 ( L_27 , V_12 , V_41 -> V_28 ) ;
if ( V_41 -> V_28 == 0 ) {
...
static int F_77 ( struct V_40 * V_41 , int V_55 )
{
F_3 ( L_28 , V_12 , V_41 -> V_28 , V_55 ) ;
if ( V_41 -> V_28 == 0 )
return F_31 ( V_41 , V_55 ) ;
...
static int F_79 ( struct V_40 * V_41 , int V_55 )
{
F_3 ( L_28 , V_12 , V_41 -> V_28 , V_55 ) ;
if ( V_41 -> V_28 == 0 )
return F_38 ( V_41 , V_55 ) ;
