...
return error ;
F_82 ( F_9 ( V_2 ) ) ;
error = F_83 ( V_8 , & F_84 ( V_8 ) -> V_186 , 0 , 0 , 0 ,
& V_32 ) ;
if ( error ) {
ASSERT ( F_72 ( V_8 ) ) ;
return error ;
...
V_203 *= V_191 ;
V_204 = V_193 + V_190 ;
if ( ( V_192 = F_13 ( V_193 , V_191 ) ) )
V_204 += V_192 ;
if ( ( V_192 = F_13 ( V_204 , V_191 ) ) )
V_204 += V_191 - V_192 ;
} else {
V_203 = 0 ;
V_204 = V_190 ;
}
V_200 = F_92 ( T_8 , ( V_204 - V_203 ) , ( V_28 * V_167 ) ) ;
if ( F_36 ( V_196 ) ) {
V_201 = V_199 = V_200 ;
V_201 /= V_8 -> V_20 . V_21 ;
V_200 = F_93 ( V_8 , 0 ) ;
...
V_201 = 0 ;
V_200 = V_199 = F_93 ( V_8 , V_200 ) ;
V_195 = V_206 ;
}
error = F_83 ( V_8 , & F_84 ( V_8 ) -> V_207 , V_200 ,
V_201 , 0 , & V_32 ) ;
if ( error ) {
ASSERT ( error == - V_208 || F_72 ( V_8 ) ) ;
break;
}
F_14 ( V_2 , V_30 ) ;
error = F_94 ( V_32 , V_2 , V_199 ,
0 , V_195 ) ;
if ( error )
goto V_209;
F_15 ( V_32 , V_2 , 0 ) ;
F_75 ( & V_170 , & V_194 ) ;
error = F_95 ( V_32 , V_2 , V_193 ,
V_190 , V_188 , & V_194 ,
V_200 , V_198 , & V_167 , & V_170 ) ;
if ( error )
goto V_210;
...
V_210:
F_97 ( & V_170 ) ;
F_98 ( V_32 , V_2 , ( long ) V_199 , 0 , V_195 ) ;
V_209:
F_86 ( V_32 ) ;
F_69 ( V_2 , V_30 ) ;
return error ;
...
struct V_169 V_170 ;
T_2 V_194 ;
T_23 V_200 = F_93 ( V_8 , 0 ) ;
int error ;
error = F_83 ( V_8 , & F_84 ( V_8 ) -> V_207 , V_200 , 0 , 0 , & V_32 ) ;
if ( error ) {
ASSERT ( error == - V_208 || F_72 ( V_8 ) ) ;
return error ;
}
F_14 ( V_2 , V_30 ) ;
error = F_100 ( V_32 , V_8 , V_2 -> V_212 , V_2 -> V_213 ,
V_2 -> V_214 , V_200 , 0 , V_206 ) ;
if ( error )
goto V_215;
F_15 ( V_32 , V_2 , 0 ) ;
F_75 ( & V_170 , & V_194 ) ;
error = F_76 ( V_32 , V_2 , V_193 , V_211 , 0 , 2 , & V_194 ,
& V_170 , V_165 ) ;
if ( error )
goto V_216;
...
T_6 V_220 = 0 ;
V_219 = 1 ;
error = F_67 ( V_2 , * V_193 , 1 , & V_166 , & V_219 , 0 ) ;
if ( error )
return error ;
if ( V_219 && V_166 . V_108 != V_94 ) {
ASSERT ( V_166 . V_108 != V_98 ) ;
V_220 = F_13 ( V_166 . V_108 , V_8 -> V_20 . V_21 ) ;
if ( V_220 )
* V_193 += V_8 -> V_20 . V_21 - V_220 ;
}
V_219 = 1 ;
error = F_67 ( V_2 , * V_218 - 1 , 1 , & V_166 , & V_219 , 0 ) ;
if ( error )
return error ;
if ( V_219 && V_166 . V_108 != V_94 ) {
ASSERT ( V_166 . V_108 != V_98 ) ;
V_220 ++ ;
if ( V_220 && V_220 != V_8 -> V_20 . V_21 )
* V_218 -= V_220 ;
}
return 0 ;
}
...
{
struct V_7 * V_8 = V_2 -> V_4 ;
struct V_221 * V_221 = F_9 ( V_2 ) ;
T_3 V_222 , V_223 , V_88 ;
int error ;
F_82 ( V_221 ) ;
V_222 = F_59 ( T_3 , 1 << V_8 -> V_20 . V_224 , V_225 ) ;
V_223 = F_103 ( V_26 , V_222 ) ;
V_88 = F_104 ( V_26 + V_187 , V_222 ) - 1 ;
error = F_105 ( V_221 -> V_148 , V_223 , V_88 ) ;
if ( error )
return error ;
F_106 ( V_221 , V_223 , V_88 ) ;
return 0 ;
}
int
F_107 (
...
if ( V_187 <= 0 )
return 0 ;
error = F_102 ( V_2 , V_26 , V_187 ) ;
if ( error )
return error ;
V_193 = F_47 ( V_8 , V_26 ) ;
V_218 = F_91 ( V_8 , V_26 + V_187 ) ;
if ( F_2 ( V_2 ) &&
! F_109 ( & V_8 -> V_20 ) ) {
error = F_101 ( V_2 , & V_193 ,
& V_218 ) ;
if ( error )
return error ;
}
...
if ( V_26 >= F_48 ( V_2 ) )
return 0 ;
if ( V_26 + V_187 > F_48 ( V_2 ) )
V_187 = F_48 ( V_2 ) - V_26 ;
return F_110 ( V_2 , V_26 , V_187 , NULL ) ;
}
int
F_111 (
struct V_1 * V_2 ,
...
int error ;
F_112 ( V_2 ) ;
V_226 = 1 << V_8 -> V_20 . V_224 ;
error = F_107 ( V_2 , V_26 , V_187 ) ;
if ( error )
goto V_86;
error = F_89 ( V_2 , F_103 ( V_26 , V_226 ) ,
F_104 ( V_26 + V_187 , V_226 ) -
F_103 ( V_26 , V_226 ) ,
V_227 ) ;
V_86:
return error ;
...
T_8 V_233 ;
T_23 V_200 ;
ASSERT ( V_229 == V_234 || V_229 == V_235 ) ;
if ( V_229 == V_234 ) {
V_200 = F_93 ( V_8 , 0 ) ;
V_232 = F_47 ( V_8 , V_26 + V_187 ) ;
V_231 = F_47 ( V_8 , F_9 ( V_2 ) -> V_176 ) ;
} else {
V_200 = 0 ;
V_232 = V_39 ;
V_231 = F_47 ( V_8 , V_26 ) ;
}
V_233 = F_47 ( V_8 , V_187 ) ;
if ( F_78 ( V_2 , true ) ) {
error = F_80 ( V_2 ) ;
if ( error )
return error ;
...
return error ;
if ( V_229 == V_235 ) {
error = F_115 ( V_2 , V_231 ) ;
if ( error )
return error ;
}
while ( ! error && ! V_165 ) {
error = F_83 ( V_8 , & F_84 ( V_8 ) -> V_207 , V_200 , 0 , 0 ,
& V_32 ) ;
if ( error )
break;
F_14 ( V_2 , V_30 ) ;
error = F_100 ( V_32 , V_8 , V_2 -> V_212 ,
V_2 -> V_213 , V_2 -> V_214 , V_200 , 0 ,
V_206 ) ;
if ( error )
goto V_215;
F_15 ( V_32 , V_2 , V_30 ) ;
F_75 ( & V_170 , & V_230 ) ;
error = F_116 ( V_32 , V_2 , & V_232 , V_233 ,
& V_165 , V_231 , & V_230 , & V_170 ,
V_229 , V_237 ) ;
if ( error )
goto V_216;
error = F_96 ( & V_32 , & V_170 , NULL ) ;
...
{
int error ;
ASSERT ( F_71 ( V_2 , V_238 ) ) ;
F_118 ( V_2 ) ;
error = F_107 ( V_2 , V_26 , V_187 ) ;
if ( error )
return error ;
return F_113 ( V_2 , V_26 , V_187 , V_234 ) ;
}
int
F_119 (
struct V_1 * V_2 ,
...
ASSERT ( F_71 ( V_2 , V_238 ) ) ;
F_120 ( V_2 ) ;
return F_113 ( V_2 , V_26 , V_187 , V_235 ) ;
}
static int
F_121 (
struct V_1 * V_2 ,
