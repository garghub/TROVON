...
int F_129 ( struct V_1 * V_2 , T_2 * V_21 ,
bool V_205 )
{
int V_177 , V_176 ;
T_18 V_206 ;
...
V_209 = F_132 ( V_2 -> V_8 , V_176 , & V_206 ) ;
if ( strcmp ( V_209 , L_82 ) == 0 ) {
V_207 = F_133 ( V_162 , V_206 ) ;
if ( ! V_207 )
return - V_10 ;
V_165 = F_134 ( V_207 , & V_208 ) ;
if ( ! V_165 )
return - V_10 ;
* V_21 = V_165 -> V_210 ;
if ( V_205 )
...
T_2 V_216 = 0 , V_217 = 0 ;
const char * V_122 = NULL , * V_218 = NULL , * V_219 = NULL , * V_32 ;
int V_220 = 0 , V_124 = 0 , V_37 = 0 ;
if ( F_129 ( V_2 , & V_217 , false ) == 0 )
V_25 += V_217 ;
if ( ! F_136 ( V_2 -> V_2 , ( T_2 ) V_25 , & V_213 ) ) {
F_28 ( L_83 ,
V_25 ) ;
V_37 = - V_42 ;
goto V_189;
}
F_137 ( & V_213 , V_25 , & V_122 , & V_124 ) ;
if ( F_57 ( & V_213 , ( T_2 ) V_25 , & V_214 ) ) {
V_218 = V_219 = F_26 ( & V_214 ) ;
if ( ! V_218 ||
F_23 ( & V_214 , & V_217 ) != 0 ||
F_65 ( & V_214 , & V_220 ) != 0 ) {
V_124 = 0 ;
...
V_122 = F_63 ( & V_214 ) ;
if ( V_25 == ( unsigned long ) V_217 ) {
V_124 = V_220 ;
goto V_221;
}
while ( F_138 ( & V_214 , ( T_2 ) V_25 ,
& V_215 ) ) {
if ( F_23 ( & V_215 , & V_216 ) == 0 &&
V_216 == V_25 ) {
V_124 = F_139 ( & V_215 ) ;
V_122 = F_140 ( & V_215 ) ;
break;
...
V_221:
if ( V_124 )
V_212 -> line = V_124 - V_220 ;
else if ( V_219 ) {
V_212 -> V_23 = V_25 - ( unsigned long ) V_217 ;
V_218 = V_219 ;
}
if ( V_218 ) {
V_212 -> V_96 = F_29 ( V_218 ) ;
if ( V_212 -> V_96 == NULL ) {
V_37 = - V_52 ;
goto V_189;
}
