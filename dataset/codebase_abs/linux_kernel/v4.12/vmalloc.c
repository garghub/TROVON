...
static void F_5 ( const void * V_10 , int V_130 )
{
struct V_116 * V_123 ;
if ( ! V_10 )
return;
...
if ( V_130 ) {
int V_120 ;
for ( V_120 = 0 ; V_120 < V_123 -> V_132 ; V_120 ++ ) {
...
{
struct V_21 * * V_22 ;
unsigned int V_132 , V_134 , V_120 ;
const T_7 V_135 = ( V_52 & V_55 ) | V_136 ;
const T_7 V_137 = V_52 | V_138 | V_69 ;
V_132 = F_176 ( V_123 ) >> V_83 ;
V_134 = ( V_132 * sizeof( struct V_21 * ) ) ;
V_123 -> V_132 = V_132 ;
if ( V_134 > V_15 ) {
V_22 = F_208 ( V_134 , 1 , V_135 | V_138 ,
V_139 , V_51 , V_123 -> V_124 ) ;
} else {
V_22 = F_74 ( V_134 , V_135 , V_51 ) ;
}
V_123 -> V_22 = V_22 ;
if ( ! V_123 -> V_22 ) {
F_192 ( V_123 -> V_10 ) ;
...
V_47 = F_182 ( V_47 ) ;
if ( ! V_47 || ( V_47 >> V_83 ) > V_133 )
goto V_142;
V_123 = F_180 ( V_47 , V_48 , V_145 | V_125 |
V_143 , V_26 , V_11 , V_51 , V_52 , V_124 ) ;
if ( ! V_123 )
goto V_142;
...
int V_51 , T_7 V_66 )
{
return F_208 ( V_47 , 1 , V_66 , V_139 ,
V_51 , F_187 ( 0 ) ) ;
}
void * F_218 ( unsigned long V_47 , int V_51 , T_7 V_66 ,
void * V_124 )
{
return F_208 ( V_47 , 1 , V_66 , V_139 , V_51 , V_124 ) ;
}
...
{
return F_208 ( V_47 , 1 , V_115 , V_139 ,
V_51 , F_187 ( 0 ) ) ;
}
...
{
return F_208 ( V_47 , 1 , V_115 , V_148 ,
V_129 , F_187 ( 0 ) ) ;
}
void * F_225 ( unsigned long V_47 )
{
return F_208 ( V_47 , 1 , V_149 , V_139 ,
V_129 , F_187 ( 0 ) ) ;
}
...
struct V_116 * V_123 ;
void * V_28 ;
V_28 = F_208 ( V_47 , 1 , V_149 | V_136 , V_139 ,
V_129 , F_187 ( 0 ) ) ;
if ( V_28 ) {
V_123 = F_191 ( V_28 ) ;
V_123 -> V_66 |= V_147 ;
...
static int F_227 ( char * V_150 , char * V_10 , unsigned long V_114 )
{
struct V_21 * V_4 ;
int V_151 = 0 ;
while ( V_114 ) {
unsigned long V_108 , V_152 ;
V_108 = F_71 ( V_10 ) ;
V_152 = V_15 - V_108 ;
if ( V_152 > V_114 )
V_152 = V_114 ;
V_4 = F_48 ( V_10 ) ;
if ( V_4 ) {
void * V_153 = F_228 ( V_4 ) ;
memcpy ( V_150 , V_153 + V_108 , V_152 ) ;
F_229 ( V_153 ) ;
} else
...
static int F_230 ( char * V_150 , char * V_10 , unsigned long V_114 )
{
struct V_21 * V_4 ;
int V_151 = 0 ;
while ( V_114 ) {
...
if ( V_4 ) {
void * V_153 = F_228 ( V_4 ) ;
memcpy ( V_153 + V_108 , V_150 , V_152 ) ;
F_229 ( V_153 ) ;
}
V_10 += V_152 ;
V_150 += V_152 ;
...
long F_231 ( char * V_150 , char * V_10 , unsigned long V_114 )
{
struct V_35 * V_39 ;
struct V_116 * V_117 ;
char * V_95 , * V_154 = V_150 ;
unsigned long V_155 = V_114 ;
unsigned long V_37 ;
...
long F_233 ( char * V_150 , char * V_10 , unsigned long V_114 )
{
struct V_35 * V_39 ;
struct V_116 * V_117 ;
char * V_95 ;
...
int F_234 ( struct V_157 * V_158 , unsigned long V_159 ,
void * V_160 , unsigned long V_47 )
{
struct V_116 * V_123 ;
V_47 = F_182 ( V_47 ) ;
if ( ! F_161 ( V_159 ) || ! F_161 ( V_160 ) )
return - V_161 ;
V_123 = F_191 ( V_160 ) ;
if ( ! V_123 )
return - V_161 ;
if ( ! ( V_123 -> V_66 & V_147 ) )
return - V_161 ;
if ( V_160 + V_47 > V_123 -> V_10 + V_123 -> V_47 )
return - V_161 ;
do {
struct V_21 * V_21 = F_48 ( V_160 ) ;
int V_28 ;
V_28 = F_235 ( V_158 , V_159 , V_21 ) ;
if ( V_28 )
return V_28 ;
V_159 += V_15 ;
V_160 += V_15 ;
...
int F_236 ( struct V_157 * V_158 , void * V_10 ,
unsigned long V_164 )
{
return F_234 ( V_158 , V_158 -> V_165 ,
V_10 + ( V_164 << V_83 ) ,
...
static int F_238 ( T_2 * V_12 , T_11 V_167 , unsigned long V_10 , void * V_168 )
{
T_2 * * * V_4 = V_168 ;
if ( V_4 ) {
* ( * V_4 ) = V_12 ;
...
struct V_116 * F_239 ( T_9 V_47 , T_2 * * V_169 )
{
struct V_116 * V_123 ;
...
if ( V_39 -> va_end > V_11 ) {
* V_170 = V_39 ;
* V_171 = F_242 ( F_68 ( & ( * V_170 ) -> V_36 ) ) ;
} else {
* V_171 = V_39 ;
* V_170 = F_242 ( F_245 ( & ( * V_171 ) -> V_36 ) ) ;
}
return true ;
}
static unsigned long F_246 ( struct V_35 * * V_170 ,
struct V_35 * * V_171 ,
unsigned long V_48 )
{
const unsigned long V_172 = V_74 & ~ ( V_48 - 1 ) ;
unsigned long V_10 ;
if ( * V_170 )
V_10 = F_158 ( ( * V_170 ) -> va_start & ~ ( V_48 - 1 ) , V_172 ) ;
else
V_10 = V_172 ;
...
struct V_116 * * F_247 ( const unsigned long * V_173 ,
const T_9 * V_174 , int V_175 ,
T_9 V_48 )
{
const unsigned long V_176 = F_79 ( V_73 , V_48 ) ;
const unsigned long V_172 = V_74 & ~ ( V_48 - 1 ) ;
struct V_35 * * V_177 , * V_45 , * V_17 ;
struct V_116 * * V_178 ;
int V_123 , V_179 , V_180 , V_181 ;
unsigned long V_182 , V_26 , V_11 , V_183 ;
bool V_53 = false ;
F_28 ( F_71 ( V_48 ) || ! F_72 ( V_48 ) ) ;
for ( V_180 = 0 , V_123 = 0 ; V_123 < V_175 ; V_123 ++ ) {
V_26 = V_173 [ V_123 ] ;
V_11 = V_26 + V_174 [ V_123 ] ;
F_28 ( ! F_83 ( V_173 [ V_123 ] , V_48 ) ) ;
F_28 ( ! F_83 ( V_174 [ V_123 ] , V_48 ) ) ;
if ( V_26 > V_173 [ V_180 ] )
V_180 = V_123 ;
...
V_178 = F_248 ( V_175 , sizeof( V_178 [ 0 ] ) , V_115 ) ;
V_177 = F_248 ( V_175 , sizeof( V_177 [ 0 ] ) , V_115 ) ;
if ( ! V_177 || ! V_178 )
goto V_186;
for ( V_123 = 0 ; V_123 < V_175 ; V_123 ++ ) {
V_177 [ V_123 ] = F_171 ( sizeof( struct V_35 ) , V_115 ) ;
V_178 [ V_123 ] = F_171 ( sizeof( struct V_116 ) , V_115 ) ;
if ( ! V_177 [ V_123 ] || ! V_178 [ V_123 ] )
goto V_187;
}
V_57:
F_78 ( & V_58 ) ;
...
V_182 = F_246 ( & V_17 , & V_45 , V_48 ) - V_11 ;
while ( true ) {
...
V_123 = ( V_123 + V_175 - 1 ) % V_175 ;
if ( V_123 == V_181 )
break;
V_26 = V_173 [ V_123 ] ;
V_11 = V_26 + V_174 [ V_123 ] ;
F_244 ( V_182 + V_11 , & V_17 , & V_45 ) ;
}
V_65:
for ( V_123 = 0 ; V_123 < V_175 ; V_123 ++ ) {
struct V_35 * V_39 = V_177 [ V_123 ] ;
V_39 -> va_start = V_182 + V_173 [ V_123 ] ;
V_39 -> va_end = V_39 -> va_start + V_174 [ V_123 ] ;
F_64 ( V_39 ) ;
}
V_75 = V_182 + V_173 [ V_180 ] ;
F_82 ( & V_58 ) ;
for ( V_123 = 0 ; V_123 < V_175 ; V_123 ++ )
F_177 ( V_178 [ V_123 ] , V_177 [ V_123 ] , V_145 ,
F_247 ) ;
F_89 ( V_177 ) ;
return V_178 ;
V_187:
...
void F_249 ( struct V_116 * * V_178 , int V_175 )
{
int V_120 ;
for ( V_120 = 0 ; V_120 < V_175 ; V_120 ++ )
F_241 ( V_178 [ V_120 ] ) ;
F_89 ( V_178 ) ;
}
static void * F_250 ( struct V_188 * V_189 , T_12 * V_190 )
__acquires( &vmap_area_lock
static void * F_251 ( struct V_188 * V_189 , void * V_4 , T_12 * V_190 )
{
return F_252 ( V_4 , & V_46 , V_190 ) ;
}
static void F_253 ( struct V_188 * V_189 , void * V_4 )
__releases( &vmap_area_lock
static void F_254 ( struct V_188 * V_189 , struct V_116 * V_191 )
{
if ( F_255 ( V_192 ) ) {
...
for ( V_23 = 0 ; V_23 < V_191 -> V_132 ; V_23 ++ )
V_193 [ F_257 ( V_191 -> V_22 [ V_23 ] ) ] ++ ;
F_258 (nr, N_HIGH_MEMORY)
if ( V_193 [ V_23 ] )
F_259 ( V_189 , L_6 , V_23 , V_193 [ V_23 ] ) ;
}
}
static int F_260 ( struct V_188 * V_189 , void * V_4 )
{
struct V_35 * V_39 ;
struct V_116 * V_191 ;
...
if ( V_191 -> V_124 )
F_259 ( V_189 , L_8 , V_191 -> V_124 ) ;
if ( V_191 -> V_132 )
F_259 ( V_189 , L_9 , V_191 -> V_132 ) ;
if ( V_191 -> V_196 )
F_259 ( V_189 , L_10 , & V_191 -> V_196 ) ;
if ( V_191 -> V_66 & V_126 )
F_262 ( V_189 , L_11 ) ;
if ( V_191 -> V_66 & V_145 )
F_262 ( V_189 , L_12 ) ;
...
static int F_264 ( struct V_198 * V_198 , struct V_199 * V_199 )
{
if ( F_255 ( V_192 ) )
return F_265 ( V_199 , & V_200 ,
V_195 * sizeof( unsigned int ) ) ;
else
return F_266 ( V_199 , & V_200 ) ;
}
static int T_8 F_267 ( void )
{
F_268 ( L_16 , V_201 , NULL , & V_202 ) ;
return 0 ;
}
