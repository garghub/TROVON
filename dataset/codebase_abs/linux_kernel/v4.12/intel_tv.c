...
int type ;
F_21 ( L_7 ,
V_6 -> V_4 . V_237 , V_6 -> V_26 ,
V_234 ) ;
V_29 = V_238 [ 0 ] ;
if ( V_234 ) {
struct V_239 V_12 ;
int V_240 ;
V_240 = F_42 ( V_6 , & V_29 , & V_12 , V_233 ) ;
if ( V_240 < 0 )
return V_240 ;
if ( V_240 > 0 ) {
type = F_32 ( V_1 , V_6 ) ;
...
static int
F_52 ( struct V_5 * V_6 , struct V_263 * V_264 ,
T_3 V_265 )
{
struct V_8 * V_9 = V_6 -> V_9 ;
struct V_1 * V_1 = F_3 ( V_6 ) ;
...
int V_240 = 0 ;
bool V_266 = false ;
V_240 = F_40 ( & V_6 -> V_4 , V_264 , V_265 ) ;
if ( V_240 < 0 )
goto V_267;
if ( V_264 == V_9 -> V_230 . V_268 &&
V_1 -> V_192 [ V_193 ] != V_265 ) {
V_1 -> V_192 [ V_193 ] = V_265 ;
V_266 = true ;
} else if ( V_264 == V_9 -> V_230 . V_269 &&
V_1 -> V_192 [ V_195 ] != V_265 ) {
V_1 -> V_192 [ V_195 ] = V_265 ;
V_266 = true ;
} else if ( V_264 == V_9 -> V_230 . V_270 &&
V_1 -> V_192 [ V_194 ] != V_265 ) {
V_1 -> V_192 [ V_194 ] = V_265 ;
V_266 = true ;
} else if ( V_264 == V_9 -> V_230 . V_271 &&
V_1 -> V_192 [ V_196 ] != V_265 ) {
V_1 -> V_192 [ V_196 ] = V_265 ;
V_266 = true ;
} else if ( V_264 == V_9 -> V_230 . V_231 ) {
if ( V_265 >= F_15 ( V_25 ) ) {
V_240 = - V_272 ;
goto V_267;
}
...
{
struct V_8 * V_9 = & V_11 -> V_273 ;
struct V_5 * V_6 ;
struct V_1 * V_1 ;
struct V_2 * V_2 ;
struct V_274 * V_274 ;
T_1 V_275 , V_276 , V_206 ;
