...
static int
F_39 ( struct V_13 * V_50 , const struct V_51 * V_52 )
{
struct V_109 V_43 = {
. V_44 = F_16 ( V_50 ) ,
. V_52 = * V_52 ,
...
static int
F_47 ( struct V_13 * V_13 , struct V_13 * V_50 , const struct V_51 * V_52 )
{
struct V_121 V_43 = {
. V_122 = F_16 ( V_13 ) ,
. V_123 = F_16 ( V_50 ) ,
...
static int
F_50 ( struct V_13 * V_50 , const struct V_51 * V_52 )
{
struct V_36 * V_57 ;
struct V_53 V_43 = {
. V_44 = F_16 ( V_50 ) ,
...
if ( V_175 && F_71 ( V_176 , & V_175 -> V_177 -> V_5 ) ) {
F_72 ( V_175 -> V_177 ) ;
F_73 ( V_175 -> V_177 ) ;
}
}
static bool F_74 ( struct V_11 * V_12 , void * V_86 )
{
struct V_174 * V_175 = V_86 ;
if ( V_175 && F_71 ( V_176 , & V_175 -> V_177 -> V_5 ) )
return F_75 ( V_12 , V_175 ) ;
return false ;
}
static void F_76 ( void * V_86 )
{
struct V_174 * V_175 = V_86 ;
struct V_178 * V_179 ;
if ( V_175 && F_71 ( V_176 , & V_175 -> V_177 -> V_5 ) ) {
...
static int
F_79 ( struct V_180 * V_181 , int V_182 , struct V_183 * V_184 )
{
struct V_13 * V_13 = F_80 ( V_181 ) ;
struct V_174 * V_175 = NULL ;
struct V_178 * V_179 = F_81 ( V_181 ) ;
int V_26 ;
...
F_83 ( V_176 , & V_179 -> V_5 ) ;
}
V_26 = F_84 ( F_85 ( V_13 ) -> V_187 , V_182 , V_184 , V_175 ) ;
if ( V_175 )
F_77 ( V_175 ) ;
return V_26 ;
}
static int F_86 ( struct V_13 * V_13 , T_4 V_5 )
{
return 0 ;
}
static int F_87 ( struct V_13 * V_13 )
{
F_88 ( V_13 ) ;
return 0 ;
}
