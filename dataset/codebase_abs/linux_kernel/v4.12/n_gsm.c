...
struct V_230 * V_231 ;
struct V_7 * V_8 ;
V_231 = F_77 ( V_184 , struct V_230 , V_184 ) ;
V_8 = V_231 -> V_8 ;
if ( V_8 -> V_90 ) {
F_146 ( V_8 -> V_90 ) ;
F_143 ( V_8 ) ;
...
static inline void F_147 ( struct V_230 * V_231 )
{
F_106 ( & V_231 -> V_184 ) ;
}
static inline void F_148 ( struct V_230 * V_231 )
{
F_108 ( & V_231 -> V_184 , F_145 ) ;
}
static int F_149 ( struct V_232 * V_85 ,
struct V_226 * V_90 )
{
struct V_230 * V_231 = F_150 ( V_90 ) ;
...
static void F_153 ( struct V_226 * V_90 )
{
F_154 ( & V_90 -> V_236 , L_32 ) ;
V_90 -> V_233 . V_237 ++ ;
}
...
F_157 ( V_85 , V_239 ) ;
memcpy ( F_158 ( V_85 , V_74 ) , V_238 , V_74 ) ;
V_85 -> V_236 = V_90 ;
V_85 -> V_241 = F_159 ( V_242 ) ;
F_160 ( V_85 ) ;
V_90 -> V_233 . V_243 ++ ;
...
static void F_161 ( struct V_226 * V_90 )
{
...
if ( ! V_8 -> V_90 )
return;
V_231 = F_150 ( V_8 -> V_90 ) ;
F_148 ( V_231 ) ;
}
static int F_162 ( struct V_7 * V_8 , struct V_259 * V_260 )
{
char * V_261 ;
int V_262 = 0 ;
struct V_226 * V_90 ;
...
if ( V_260 -> V_266 [ 0 ] != '\0' )
V_261 = V_260 -> V_266 ;
V_90 = F_164 ( sizeof( struct V_230 ) , V_261 ,
V_267 , F_161 ) ;
if ( ! V_90 ) {
F_165 ( L_36 ) ;
return - V_80 ;
...
static int F_167 ( struct V_7 * V_8 , T_1 V_99 )
{
T_1 V_9 [ 5 ] ;
struct V_125 * V_55 ;
int V_4 = 2 ;
...
static int F_168 ( struct V_107 * V_104 )
{
struct V_7 * V_8 = F_77 ( V_104 , struct V_7 , V_104 ) ;
if ( V_8 -> V_142 != V_144 )
return 0 ;
...
static void F_169 ( struct V_107 * V_104 , int V_273 )
{
struct V_7 * V_8 = F_77 ( V_104 , struct V_7 , V_104 ) ;
...
static int F_170 ( struct V_274 * V_275 , struct V_94 * V_95 )
{
struct V_47 * V_48 ;
struct V_7 * V_8 ;
...
V_192 = F_171 ( & V_8 -> V_104 , V_275 , V_95 ) ;
if ( V_192 ) {
if ( V_278 )
F_84 ( V_8 ) ;
F_89 ( & V_48 -> V_148 ) ;
...
static int F_172 ( struct V_94 * V_95 , struct V_202 * V_285 )
{
...
F_173 ( V_104 , 1 ) ;
F_65 ( V_8 ) ;
return F_174 ( V_104 , V_95 , V_285 ) ;
}
static void F_175 ( struct V_94 * V_95 , struct V_202 * V_285 )
{
struct V_7 * V_8 = V_95 -> V_284 ;
struct V_47 * V_48 ;
if ( V_8 == NULL )
...
F_89 ( & V_8 -> V_148 ) ;
V_48 = V_8 -> V_48 ;
if ( F_176 ( & V_8 -> V_104 , V_95 , V_285 ) == 0 )
return;
F_49 ( V_8 ) ;
if ( F_177 ( & V_8 -> V_104 ) && F_178 ( V_95 ) )
F_179 ( & V_8 -> V_104 ) ;
F_180 ( & V_8 -> V_104 , V_95 ) ;
F_91 ( & V_8 -> V_104 , NULL ) ;
return;
}
static void F_181 ( struct V_94 * V_95 )
{
struct V_7 * V_8 = V_95 -> V_284 ;
if ( V_8 -> V_142 == V_143 )
return;
...
static int F_183 ( struct V_94 * V_95 , const unsigned char * V_114 ,
int V_4 )
{
int V_286 ;
struct V_7 * V_8 = V_95 -> V_284 ;
if ( V_8 -> V_142 == V_143 )
return - V_200 ;
V_286 = F_184 ( V_8 -> V_77 , V_114 , V_4 , & V_8 -> V_81 ) ;
F_36 ( V_8 ) ;
return V_286 ;
}
...
static void F_187 ( struct V_94 * V_95 )
{
struct V_7 * V_8 = V_95 -> V_284 ;
if ( V_8 -> V_142 == V_143 )
return;
...
static void F_188 ( struct V_94 * V_95 , int V_288 )
{
}
...
switch ( V_93 ) {
case V_291 :
if ( F_137 ( & V_260 , ( void T_4 * ) V_221 , sizeof( V_260 ) ) )
return - V_224 ;
V_260 . V_266 [ V_271 - 1 ] = '\0' ;
F_87 ( & V_8 -> V_148 ) ;
V_276 = F_162 ( V_8 , & V_260 ) ;
F_89 ( & V_8 -> V_148 ) ;
if ( F_136 ( ( void T_4 * ) V_221 , & V_260 , sizeof( V_260 ) ) )
return - V_224 ;
return V_276 ;
case V_292 :
if ( ! F_163 ( V_263 ) )
...
static void F_192 ( struct V_94 * V_95 , struct V_294 * V_295 )
{
struct V_7 * V_8 = V_95 -> V_284 ;
if ( V_8 -> V_142 == V_143 )
return;
F_193 ( & V_95 -> V_296 , V_295 ) ;
}
...
static int F_197 ( struct V_94 * V_95 , int V_142 )
{
struct V_7 * V_8 = V_95 -> V_284 ;
int V_297 = 0 ;
if ( V_8 -> V_142 == V_143 )
