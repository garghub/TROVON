...
int F_97 ( struct V_148 * V_148 , struct V_1 * V_2 )
{
int V_149 , V_150 ;
struct V_151 V_152 ;
if ( ! V_2 -> V_4 . V_153 ) {
...
static int F_102 ( struct V_148 * V_142 , struct V_1 * V_2 )
{
enum V_163 V_164 ;
V_164 = F_103 ( V_142 , V_2 ) ;
switch ( V_164 ) {
case V_165 :
F_104 ( V_2 , V_166 ) ;
return V_167 ;
...
static int F_106 ( struct V_148 * V_142 , struct V_1 * V_2 )
{
...
static void F_107 ( struct V_200 * V_17 )
{
...
break;
case V_215 :
V_2 -> V_4 . V_179 = F_116 ( V_216 ) ;
F_117 () ;
break;
}
}
static int F_118 ( struct V_148 * V_142 , struct V_1 * V_2 ,
...
int F_120 ( struct V_148 * V_142 , struct V_1 * V_2 ,
unsigned int V_206 )
{
int V_134 = V_177 ;
int V_150 ;
...
V_142 -> V_227 = 1 ;
if ( V_217 != V_165 ) {
V_134 = F_118 ( V_142 , V_2 , V_217 , V_173 ) ;
goto V_156;
}
switch ( V_206 ) {
case V_211 :
...
break;
case V_222 :
V_134 = F_102 ( V_142 , V_2 ) ;
break;
case V_224 :
if ( ( V_2 -> V_27 & V_225 ) &&
( V_173 == V_235 ) ) {
V_134 = F_106 ( V_142 , V_2 ) ;
V_142 -> V_143 = V_236 ;
F_125 ( V_2 , V_237 ) ;
break;
}
...
V_218 = F_132 ( & V_2 -> V_267 -> V_268 ) ;
V_261 = F_133 ( V_2 , V_260 , V_259 ) ;
V_262 = V_261 >> V_269 ;
if ( F_134 ( V_2 -> V_267 , V_262 ) ) {
F_135 ( V_2 , V_259 , V_261 , V_260 ) ;
F_125 ( V_2 , V_265 ) ;
V_134 = V_169 ;
} else {
V_2 -> V_4 . V_270 = V_261 ;
V_2 -> V_4 . V_271 = V_259 ;
V_134 = F_136 ( V_142 , V_2 ) ;
F_125 ( V_2 , V_272 ) ;
}
F_137 ( & V_2 -> V_267 -> V_268 , V_218 ) ;
break;
}
case V_273 : {
...
V_150 = F_98 ( V_2 ) ;
if ( V_150 <= 0 )
V_134 = ( V_150 << 2 ) | V_177 | ( V_134 & V_277 ) ;
else {
F_100 () ;
F_13 ( V_2 ) ;
F_22 ( V_2 ) ;
...
static void F_140 ( struct V_1 * V_2 , T_1 V_122 )
{
...
int F_151 ( struct V_1 * V_2 , struct V_286 * V_17 )
{
int V_3 ;
V_17 -> V_5 = V_2 -> V_4 . V_5 ;
V_17 -> V_287 = F_152 ( V_2 ) ;
V_17 -> V_9 = V_2 -> V_4 . V_9 ;
V_17 -> V_8 = V_2 -> V_4 . V_8 ;
V_17 -> V_288 = F_153 ( V_2 ) ;
V_17 -> V_7 = V_2 -> V_4 . V_6 -> V_7 ;
V_17 -> V_10 = F_154 ( V_2 ) ;
V_17 -> V_11 = F_155 ( V_2 ) ;
V_17 -> V_289 = V_2 -> V_4 . V_289 ;
V_17 -> V_290 = F_156 ( V_2 ) ;
V_17 -> V_291 = F_157 ( V_2 ) ;
V_17 -> V_292 = F_158 ( V_2 ) ;
V_17 -> V_293 = F_159 ( V_2 ) ;
V_17 -> V_294 = F_160 ( V_2 ) ;
V_17 -> V_295 = F_161 ( V_2 ) ;
V_17 -> V_296 = F_162 ( V_2 ) ;
V_17 -> V_297 = F_163 ( V_2 ) ;
for ( V_3 = 0 ; V_3 < F_164 ( V_17 -> V_203 ) ; V_3 ++ )
V_17 -> V_203 [ V_3 ] = F_3 ( V_2 , V_3 ) ;
return 0 ;
}
int F_165 ( struct V_1 * V_2 , struct V_286 * V_17 )
{
int V_3 ;
V_2 -> V_4 . V_5 = V_17 -> V_5 ;
F_166 ( V_2 , V_17 -> V_287 ) ;
V_2 -> V_4 . V_9 = V_17 -> V_9 ;
V_2 -> V_4 . V_8 = V_17 -> V_8 ;
F_167 ( V_2 , V_17 -> V_288 ) ;
F_31 ( V_2 , V_17 -> V_7 ) ;
F_55 ( V_2 , V_17 -> V_10 ) ;
F_56 ( V_2 , V_17 -> V_11 ) ;
F_168 ( V_2 , V_17 -> V_289 ) ;
F_169 ( V_2 , V_17 -> V_290 ) ;
F_170 ( V_2 , V_17 -> V_291 ) ;
F_171 ( V_2 , V_17 -> V_292 ) ;
F_172 ( V_2 , V_17 -> V_293 ) ;
F_173 ( V_2 , V_17 -> V_294 ) ;
F_174 ( V_2 , V_17 -> V_295 ) ;
F_175 ( V_2 , V_17 -> V_296 ) ;
F_176 ( V_2 , V_17 -> V_297 ) ;
for ( V_3 = 0 ; V_3 < F_164 ( V_17 -> V_203 ) ; V_3 ++ )
F_127 ( V_2 , V_3 , V_17 -> V_203 [ V_3 ] ) ;
return 0 ;
}
...
V_299 -> V_300 . V_301 . V_53 = V_2 -> V_4 . V_53 ;
V_299 -> V_300 . V_301 . V_304 = V_2 -> V_4 . V_304 ;
V_299 -> V_300 . V_301 . V_305 = F_178 ( V_2 ) ;
V_299 -> V_300 . V_301 . V_306 = F_179 ( V_2 ) ;
V_299 -> V_300 . V_301 . V_113 = V_2 -> V_4 . V_113 ;
V_299 -> V_300 . V_301 . V_110 = V_2 -> V_4 . V_110 ;
V_299 -> V_300 . V_301 . V_307 = F_180 ( V_2 , V_105 ) ;
...
V_299 -> V_300 . V_301 . V_58 = V_2 -> V_4 . V_58 ;
...
V_2 -> V_4 . V_58 = V_299 -> V_300 . V_301 . V_58 ;
V_2 -> V_4 . V_313 = V_299 -> V_300 . V_301 . V_313 ;
V_2 -> V_4 . V_92 = V_299 -> V_300 . V_301 . V_92 ;
return 0 ;
}
int F_186 ( struct V_1 * V_2 , struct V_298 * V_299 )
{
...
V_299 -> V_300 . V_301 . V_315 [ 4 ] = V_2 -> V_4 . V_93 [ V_47 ] ;
V_299 -> V_300 . V_301 . V_315 [ 5 ] = V_2 -> V_4 . V_93 [ V_40 ] ;
V_299 -> V_300 . V_301 . V_315 [ 6 ] = V_2 -> V_4 . V_93 [ V_41 ] ;
V_299 -> V_300 . V_301 . V_315 [ 7 ] = V_2 -> V_4 . V_93 [ V_42 ] ;
V_299 -> V_300 . V_301 . V_315 [ 8 ] = V_2 -> V_4 . V_93 [ V_73 ] ;
V_299 -> V_300 . V_301 . V_315 [ 9 ] = V_2 -> V_4 . V_93 [ V_79 ] ;
V_299 -> V_300 . V_301 . V_315 [ 10 ] = V_2 -> V_4 . V_93 [ V_43 ] ;
V_299 -> V_300 . V_301 . V_315 [ 11 ] = V_2 -> V_4 . V_93 [ V_88 ] ;
V_299 -> V_300 . V_301 . V_315 [ 12 ] = V_2 -> V_4 . V_93 [ V_50 ] ;
V_299 -> V_300 . V_301 . V_315 [ 13 ] = V_2 -> V_4 . V_93 [ V_36 ] ;
V_299 -> V_300 . V_301 . V_315 [ 14 ] = V_2 -> V_4 . V_93 [ V_38 ] ;
V_299 -> V_300 . V_301 . V_315 [ 15 ] = V_2 -> V_4 . V_93 [ V_51 ] ;
return 0 ;
}
int F_187 ( struct V_1 * V_2 , struct V_298 * V_299 )
{
...
V_2 -> V_4 . V_93 [ V_47 ] = V_299 -> V_300 . V_301 . V_315 [ 4 ] ;
V_2 -> V_4 . V_93 [ V_40 ] = V_299 -> V_300 . V_301 . V_315 [ 5 ] ;
V_2 -> V_4 . V_93 [ V_41 ] = V_299 -> V_300 . V_301 . V_315 [ 6 ] ;
V_2 -> V_4 . V_93 [ V_42 ] = V_299 -> V_300 . V_301 . V_315 [ 7 ] ;
V_2 -> V_4 . V_93 [ V_73 ] = V_299 -> V_300 . V_301 . V_315 [ 8 ] ;
V_2 -> V_4 . V_93 [ V_79 ] = V_299 -> V_300 . V_301 . V_315 [ 9 ] ;
V_2 -> V_4 . V_93 [ V_43 ] = V_299 -> V_300 . V_301 . V_315 [ 10 ] ;
V_2 -> V_4 . V_93 [ V_88 ] = V_299 -> V_300 . V_301 . V_315 [ 11 ] ;
V_2 -> V_4 . V_93 [ V_50 ] = V_299 -> V_300 . V_301 . V_315 [ 12 ] ;
V_2 -> V_4 . V_93 [ V_36 ] = V_299 -> V_300 . V_301 . V_315 [ 13 ] ;
V_2 -> V_4 . V_93 [ V_38 ] = V_299 -> V_300 . V_301 . V_315 [ 14 ] ;
V_2 -> V_4 . V_93 [ V_51 ] = V_299 -> V_300 . V_301 . V_315 [ 15 ] ;
return 0 ;
}
...
return - V_155 ;
V_149 = F_181 ( V_2 , V_299 ) ;
if ( V_149 < 0 )
return V_149 ;
V_149 = F_185 ( V_2 , V_299 ) ;
if ( V_149 < 0 )
return V_149 ;
return V_2 -> V_267 -> V_4 . V_317 -> V_319 ( V_2 , V_299 ) ;
}
int F_190 ( struct V_1 * V_2 , T_3 V_320 ,
union V_321 * V_322 )
{
int V_134 = 0 ;
switch ( V_320 ) {
case V_323 :
* V_322 = F_191 ( V_320 , V_2 -> V_4 . V_157 . V_324 ) ;
break;
case V_325 :
* V_322 = F_191 ( V_320 , V_2 -> V_4 . V_157 . V_326 ) ;
break;
#if V_327 > 2
case V_328 :
* V_322 = F_191 ( V_320 , V_2 -> V_4 . V_157 . V_329 ) ;
break;
case V_330 :
* V_322 = F_191 ( V_320 , V_2 -> V_4 . V_157 . V_331 ) ;
break;
#endif
case V_332 :
* V_322 = F_191 ( V_320 , V_2 -> V_4 . V_157 . V_198 ) ;
break;
case V_333 :
* V_322 = F_191 ( V_320 , V_2 -> V_4 . V_157 . V_199 ) ;
break;
case V_334 : {
T_1 V_145 = F_192 ( V_2 ) ;
* V_322 = F_191 ( V_320 , V_145 ) ;
break;
}
#if F_21 ( V_99 )
case V_335 :
* V_322 = F_191 ( V_320 , V_2 -> V_4 . V_100 ) ;
break;
#endif
case V_336 :
* V_322 = F_191 ( V_320 , V_2 -> V_4 . V_110 ) ;
break;
case V_337 :
* V_322 = F_191 ( V_320 , V_2 -> V_4 . V_113 ) ;
break;
case V_338 :
* V_322 = F_191 ( V_320 , V_235 ) ;
break;
case V_339 :
* V_322 = F_191 ( V_320 , V_2 -> V_4 . V_308 ) ;
break;
default:
V_134 = V_2 -> V_267 -> V_4 . V_317 -> V_340 ( V_2 , V_320 , V_322 ) ;
break;
}
return V_134 ;
}
int F_193 ( struct V_1 * V_2 , T_3 V_320 ,
union V_321 * V_322 )
{
int V_134 = 0 ;
switch ( V_320 ) {
case V_323 :
V_2 -> V_4 . V_157 . V_324 = F_194 ( V_320 , * V_322 ) ;
break;
case V_325 :
V_2 -> V_4 . V_157 . V_326 = F_194 ( V_320 , * V_322 ) ;
break;
#if V_327 > 2
case V_328 :
V_2 -> V_4 . V_157 . V_329 = F_194 ( V_320 , * V_322 ) ;
break;
case V_330 :
V_2 -> V_4 . V_157 . V_331 = F_194 ( V_320 , * V_322 ) ;
break;
#endif
case V_332 :
V_2 -> V_4 . V_157 . V_198 = F_194 ( V_320 , * V_322 ) ;
break;
case V_333 :
V_2 -> V_4 . V_157 . V_199 = F_194 ( V_320 , * V_322 ) ;
break;
case V_334 : {
T_1 V_341 = F_194 ( V_320 , * V_322 ) ;
F_195 ( V_2 , V_341 ) ;
break;
}
#if F_21 ( V_99 )
case V_335 : {
T_1 V_342 = F_194 ( V_320 , * V_322 ) ;
F_196 ( V_2 , V_342 ) ;
break;
}
#endif
case V_343 : {
T_1 V_344 = F_194 ( V_320 , * V_322 ) ;
F_197 ( V_2 , V_344 ) ;
break;
}
case V_345 : {
...
case V_337 : {
T_1 V_113 = F_194 ( V_320 , * V_322 ) ;
F_140 ( V_2 , V_113 ) ;
break;
}
case V_336 : {
T_1 V_110 = F_194 ( V_320 , * V_322 ) ;
F_182 ( V_2 , V_110 ) ;
break;
}
case V_339 :
V_2 -> V_4 . V_308 = F_194 ( V_320 , * V_322 ) ;
break;
default:
V_134 = V_2 -> V_267 -> V_4 . V_317 -> V_346 ( V_2 , V_320 , V_322 ) ;
break;
}
return V_134 ;
}
int F_199 ( struct V_1 * V_2 , struct V_347 * V_348 )
{
return - V_349 ;
}
int F_200 ( struct V_1 * V_2 , struct V_347 * V_348 )
{
return - V_349 ;
}
...
{
int V_134 ;
V_134 = F_202 ( V_2 , V_351 ) ;
return V_134 ;
}
int F_203 ( struct V_267 * V_267 , struct V_352 * log )
{
return - V_349 ;
}
void F_204 ( struct V_267 * V_267 , struct V_353 * free ,
struct V_353 * V_354 )
{
}
int F_205 ( struct V_267 * V_267 , struct V_353 * V_355 ,
unsigned long V_356 )
{
return 0 ;
}
int F_206 ( struct V_267 * V_267 ,
struct V_353 * V_357 ,
const struct V_358 * V_359 )
{
return 0 ;
}
void F_207 ( struct V_267 * V_267 ,
const struct V_358 * V_359 ,
const struct V_353 * V_360 ,
const struct V_353 * V_361 )
{
}
void F_208 ( struct V_267 * V_267 , struct V_353 * V_357 )
{
}
void F_196 ( struct V_1 * V_2 , T_1 V_342 )
{
#if F_21 ( V_99 )
V_2 -> V_4 . V_100 = V_342 ;
#ifdef V_21
...
void F_182 ( struct V_1 * V_2 , T_1 V_364 )
{
V_2 -> V_4 . V_110 = V_364 ;
F_73 ( V_2 ) ;
F_83 ( V_2 ) ;
}
void F_197 ( struct V_1 * V_2 , T_1 V_344 )
{
F_209 ( V_344 , & V_2 -> V_4 . V_113 ) ;
F_81 () ;
F_64 ( V_124 , V_2 ) ;
F_82 ( V_2 ) ;
}
void F_198 ( struct V_1 * V_2 , T_1 V_344 )
{
F_210 ( V_344 , & V_2 -> V_4 . V_113 ) ;
...
static int F_212 ( struct V_151 * V_157 ,
T_6 V_366 , int V_367 )
{
switch ( V_367 ) {
case 0 :
...
static int F_213 ( struct V_151 * V_157 , T_6 V_366 ,
int type , int V_367 )
{
switch ( V_367 ) {
case 0 :
...
void F_214 ( struct V_1 * V_2 , T_2 V_376 , bool V_377 )
{
#ifdef V_21
F_65 ( V_376 & ~ ( V_378 | V_379 | V_380 ) ) ;
if ( V_377 ) {
if ( V_376 & V_381 )
V_2 -> V_4 . V_382 |= V_378 ;
if ( V_376 & V_26 )
...
int F_215 ( struct V_1 * V_2 , T_2 V_259 , enum V_384 V_385 ,
...
return - V_155 ;
if ( type & V_191 ) {
if ( F_212 ( V_157 , V_366 , V_402 ++ ) )
return - V_155 ;
} else {
if ( F_213 ( V_157 , V_366 ,
type , V_403 ++ ) )
return - V_155 ;
}
}
...
void F_217 ( struct V_1 * V_2 , int V_421 )
{
V_2 -> V_421 = F_218 () ;
V_15 -> V_16 . V_1 = V_2 ;
}
...
int F_221 ( struct V_267 * V_267 )
{
return V_267 -> V_4 . V_317 -> V_423 ( V_267 ) ;
}
struct V_1 * F_222 ( struct V_267 * V_267 , unsigned int V_320 )
{
...
void F_224 ( struct V_267 * V_267 )
{
V_267 -> V_4 . V_317 -> V_426 ( V_267 ) ;
}
void F_225 ( struct V_1 * V_2 , int V_421 )
{
