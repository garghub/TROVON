...
return F_37 ( V_40 ) ;
V_43 = V_45 |
F_38 ( V_40 -> type , V_40 -> V_43 ,
V_46 ) ;
V_42 = F_39 ( V_38 [ 1 ] , V_47 , V_43 ) ;
if ( F_29 ( V_42 ) )
return F_37 ( V_42 ) ;
V_9 = - V_48 ;
if ( V_42 -> V_49 < 4 )
...
V_32 -> V_42 . V_57 . V_68 = F_21 ;
V_32 -> V_42 . V_57 . V_69 = F_21 ;
...
{
struct V_71 * V_14 = F_52 ( V_76 ) ;
struct V_72 * V_6 = F_46 ( V_14 ) ;
struct V_71 * V_8 = V_6 -> V_8 ;
unsigned long V_77 = F_53 ( V_14 ) ;
struct V_78 * V_79 =
( void * ) F_12 ( ( T_1 * ) F_54 ( V_76 ) , V_77 + 1 ) ;
...
F_55 ( 1 ) ;
F_56 ( V_80 , V_8 ) ;
F_57 ( V_80 , V_76 -> V_83 . V_84 ,
V_76 -> V_83 . V_85 , V_76 -> V_83 . V_86 ) ;
F_58 ( V_80 , V_76 -> V_21 , V_76 -> V_24 ,
V_76 -> V_87 , V_18 ) ;
return F_59 ( V_80 ) ;
}
static int F_60 ( struct V_71 * V_14 )
{
struct V_88 * V_32 = F_61 ( V_14 ) ;
struct V_89 * V_35 = F_62 ( V_32 ) ;
struct V_72 * V_6 = F_46 ( V_14 ) ;
struct V_71 * V_36 ;
unsigned long V_77 ;
unsigned int V_90 ;
...
static void F_67 ( struct V_71 * V_14 )
{
struct V_72 * V_6 = F_46 ( V_14 ) ;
F_68 ( V_6 -> V_8 ) ;
}
static void F_69 ( struct V_88 * V_32 )
{
struct V_89 * V_35 = F_62 ( V_32 ) ;
F_70 ( V_35 ) ;
F_44 ( V_32 ) ;
...
if ( ! V_32 )
return - V_97 ;
V_43 = F_74 ( V_40 -> type , V_40 -> V_43 ) |
F_38 ( V_40 -> type , V_40 -> V_43 ,
V_46 ) ;
V_35 = F_62 ( V_32 ) ;
F_75 ( V_35 , F_76 ( V_32 ) ) ;
V_9 = F_77 ( V_35 , V_94 , 0 , V_43 ) ;
if ( V_9 )
goto V_98;
V_42 = F_78 ( V_35 ) ;
V_9 = - V_48 ;
...
V_32 -> V_42 . V_58 = V_81 ;
V_32 -> V_42 . V_106 = F_80 ( V_42 ) ;
V_32 -> V_42 . V_59 = F_81 ( V_42 ) +
V_73 ;
V_32 -> V_42 . V_62 = F_82 ( V_42 ) +
V_73 ;
V_32 -> V_42 . V_67 = F_45 ;
V_32 -> V_42 . V_68 = F_51 ;
V_32 -> V_42 . V_69 = F_51 ;
V_32 -> V_42 . V_83 . V_64 = sizeof( struct V_72 ) ;
V_32 -> V_42 . V_107 = F_60 ;
V_32 -> V_42 . exit = F_67 ;
V_32 -> free = F_69 ;
V_9 = F_83 ( V_92 , V_32 ) ;
if ( V_9 )
