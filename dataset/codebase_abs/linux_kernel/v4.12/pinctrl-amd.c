...
static int F_40 ( struct V_119 * V_83 )
{
int V_15 = 0 ;
int V_120 ;
struct V_121 * V_122 ;
struct V_6 * V_7 ;
V_7 = F_41 ( & V_83 -> V_84 ,
sizeof( struct V_6 ) , V_123 ) ;
if ( ! V_7 )
return - V_124 ;
F_42 ( & V_7 -> V_8 ) ;
V_122 = F_43 ( V_83 , V_125 , 0 ) ;
if ( ! V_122 ) {
F_26 ( & V_83 -> V_84 , L_36 ) ;
return - V_22 ;
}
V_7 -> V_9 = F_44 ( & V_83 -> V_84 , V_122 -> V_126 ,
F_45 ( V_122 ) ) ;
if ( ! V_7 -> V_9 )
return - V_124 ;
V_120 = F_46 ( V_83 , 0 ) ;
...
V_7 -> V_2 . V_132 = F_15 ;
V_7 -> V_2 . V_9 = - 1 ;
V_7 -> V_2 . V_133 = V_83 -> V_104 ;
V_7 -> V_2 . V_134 = V_135 ;
V_7 -> V_2 . V_136 = & V_83 -> V_84 ;
V_7 -> V_2 . V_137 = F_45 ( V_122 ) / 4 ;
#if F_47 ( V_138 )
V_7 -> V_2 . V_139 = V_83 -> V_84 . V_139 ;
#endif
V_7 -> V_44 = V_7 -> V_2 . V_137 / 64 ;
V_7 -> V_103 = V_140 ;
V_7 -> V_101 = F_48 ( V_140 ) ;
V_141 . V_104 = F_49 ( & V_83 -> V_84 ) ;
V_7 -> V_142 = F_50 ( & V_83 -> V_84 , & V_141 ,
V_7 ) ;
if ( F_51 ( V_7 -> V_142 ) ) {
F_26 ( & V_83 -> V_84 , L_38 ) ;
return F_52 ( V_7 -> V_142 ) ;
}
V_15 = F_53 ( & V_7 -> V_2 , V_7 ) ;
if ( V_15 )
return V_15 ;
V_15 = F_54 ( & V_7 -> V_2 , F_49 ( & V_83 -> V_84 ) ,
0 , 0 , V_7 -> V_2 . V_137 ) ;
if ( V_15 ) {
F_26 ( & V_83 -> V_84 , L_39 ) ;
goto V_143;
...
V_15 = F_56 ( & V_83 -> V_84 , V_120 , F_28 , 0 ,
V_147 , V_7 ) ;
if ( V_15 )
goto V_143;
F_57 ( V_83 , V_7 ) ;
...
static int F_60 ( struct V_119 * V_83 )
{
struct V_6 * V_7 ;
V_7 = F_61 ( V_83 ) ;
F_59 ( & V_7 -> V_2 ) ;
