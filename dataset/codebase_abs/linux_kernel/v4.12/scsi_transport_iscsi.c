...
struct V_378 *
F_149 ( struct V_380 * V_388 , int V_14 , T_5 V_385 )
{
...
if ( ! F_31 ( & V_388 -> V_2 ) )
goto V_436;
F_15 ( & V_379 -> V_2 , L_39 , V_388 -> V_382 , V_385 ) ;
V_379 -> V_2 . V_29 = & V_388 -> V_2 ;
V_379 -> V_2 . V_191 = F_137 ;
V_15 = F_16 ( & V_379 -> V_2 ) ;
if ( V_15 ) {
F_105 ( V_18 , V_388 , L_40
L_41 ) ;
goto V_437;
}
F_133 ( & V_379 -> V_2 ) ;
...
static int
F_151 ( struct V_441 * V_442 , T_5 V_443 , T_7 V_444 )
{
return F_152 ( V_445 , V_442 , 0 , V_443 , V_444 ) ;
}
int F_153 ( struct V_378 * V_379 , struct V_446 * V_447 ,
char * V_12 , T_5 V_448 )
{
struct V_449 * V_450 ;
struct V_441 * V_442 ;
...
char * V_453 ;
struct V_3 * V_4 ;
int V_454 = F_154 ( sizeof( * V_452 ) + sizeof( struct V_446 ) +
V_448 ) ;
V_4 = F_150 ( V_379 -> V_34 ) ;
if ( ! V_4 )
return - V_455 ;
V_442 = F_155 ( V_454 , V_456 ) ;
if ( ! V_442 ) {
F_156 ( V_379 , V_457 ) ;
F_157 ( V_18 , V_379 , L_44
L_45 ) ;
return - V_458 ;
}
V_450 = F_158 ( V_442 , 0 , 0 , 0 , ( V_454 - sizeof( * V_450 ) ) , 0 ) ;
V_452 = F_159 ( V_450 ) ;
...
return F_151 ( V_442 , V_463 , V_456 ) ;
}
int F_160 ( struct V_188 * V_189 ,
...
struct V_441 * V_442 ;
struct V_451 * V_452 ;
int V_454 = F_154 ( sizeof( * V_452 ) + V_448 ) ;
V_442 = F_155 ( V_454 , V_456 ) ;
if ( ! V_442 ) {
F_13 ( V_18 L_46 ) ;
return - V_458 ;
...
return F_151 ( V_442 , V_468 , V_456 ) ;
}
void F_156 ( struct V_378 * V_379 , enum V_469 error )
{
struct V_449 * V_450 ;
struct V_441 * V_442 ;
struct V_451 * V_452 ;
struct V_3 * V_4 ;
int V_454 = F_154 ( sizeof( * V_452 ) ) ;
V_4 = F_150 ( V_379 -> V_34 ) ;
if ( ! V_4 )
return;
V_442 = F_155 ( V_454 , V_456 ) ;
if ( ! V_442 ) {
F_157 ( V_18 , V_379 , L_47
L_48 , error ) ;
return;
}
V_450 = F_158 ( V_442 , 0 , 0 , 0 , ( V_454 - sizeof( * V_450 ) ) , 0 ) ;
...
F_151 ( V_442 , V_463 , V_456 ) ;
F_157 ( V_413 , V_379 , L_49 ,
error ) ;
}
void F_161 ( struct V_378 * V_379 ,
enum V_472 V_181 )
{
struct V_449 * V_450 ;
struct V_441 * V_442 ;
...
if ( V_448 )
memcpy ( ( char * ) V_452 + sizeof( * V_452 ) , V_12 , V_448 ) ;
F_151 ( V_442 , V_463 , V_477 ) ;
}
void F_163 ( T_5 V_194 , struct V_8 * V_34 ,
...
static int
F_164 ( T_5 V_443 , int V_484 , int type , int V_485 , int V_486 ,
void * V_487 , int V_488 )
{
struct V_441 * V_442 ;
struct V_449 * V_450 ;
int V_454 = F_154 ( V_488 ) ;
...
V_450 = F_158 ( V_442 , 0 , 0 , V_33 , ( V_454 - sizeof( * V_450 ) ) , 0 ) ;
V_450 -> V_491 = V_383 ;
memcpy ( F_159 ( V_450 ) , V_487 , V_488 ) ;
return F_151 ( V_442 , V_443 , V_456 ) ;
}
static int
F_165 ( struct V_8 * V_34 , struct V_449 * V_450 )
{
struct V_451 * V_452 = F_159 ( V_450 ) ;
struct V_492 * V_493 ;
struct V_441 * V_494 ;
struct V_378 * V_379 ;
struct V_449 * V_495 ;
...
do {
int V_502 ;
V_494 = F_155 ( V_454 , V_456 ) ;
if ( ! V_494 ) {
F_157 ( V_18 , V_379 , L_55
L_56 ) ;
return - V_458 ;
}
V_495 = F_158 ( V_494 , 0 , 0 , 0 ,
...
V_502 = F_154 ( sizeof( struct V_451 ) +
sizeof( struct V_492 ) +
sizeof( struct V_497 ) *
V_493 -> V_504 ) ;
V_502 -= sizeof( * V_495 ) ;
V_502 = F_166 ( V_502 ) ;
F_167 ( V_494 , F_168 ( V_502 ) ) ;
V_495 -> V_505 = V_502 ;
V_15 = F_151 ( V_494 , V_463 ,
V_456 ) ;
...
struct V_441 * V_442 ;
struct V_449 * V_450 ;
int V_509 , V_454 = F_154 ( sizeof( * V_452 ) ) ;
V_4 = F_150 ( V_388 -> V_34 ) ;
if ( ! V_4 )
return - V_455 ;
V_189 = F_85 ( V_388 ) ;
V_442 = F_155 ( V_454 , V_19 ) ;
if ( ! V_442 ) {
F_105 ( V_18 , V_388 ,
L_57
L_58 , V_508 ) ;
...
break;
default:
F_105 ( V_18 , V_388 , L_59
L_60 , V_508 ) ;
F_169 ( V_442 ) ;
return - V_455 ;
}
V_509 = F_151 ( V_442 , V_463 , V_19 ) ;
if ( V_509 == - V_359 )
F_105 ( V_18 , V_388 ,
L_57
L_61 ,
...
static int
F_170 ( struct V_3 * V_4 , struct V_9 * V_10 ,
...
static int
F_173 ( struct V_8 * V_34 , struct V_451 * V_452 )
{
...
return - V_455 ;
if ( V_524 == V_529 ) {
V_189 = F_175 ( V_452 -> V_499 . V_530 . V_194 ) ;
if ( ! V_189 ) {
F_13 ( V_18 L_69
L_70 ,
...
if ( ! V_34 -> V_542 )
return - V_455 ;
V_189 = F_175 ( V_452 -> V_499 . V_542 . V_194 ) ;
if ( ! V_189 ) {
F_13 ( V_18 L_71 ,
...
if ( ! V_34 -> V_544 )
return - V_545 ;
V_189 = F_175 ( V_452 -> V_499 . V_544 . V_194 ) ;
if ( ! V_189 ) {
F_13 ( V_18 L_72 ,
...
static int
F_180 ( struct V_8 * V_34 , struct V_451 * V_452 )
{
struct V_188 * V_189 ;
struct V_546 * V_547 ;
int V_15 ;
if ( ! V_34 -> V_548 )
return - V_545 ;
V_189 = F_175 ( V_452 -> V_499 . V_548 . V_194 ) ;
if ( ! V_189 ) {
F_13 ( V_18 L_73 ,
...
if ( ! V_34 -> V_549 )
return - V_545 ;
V_189 = F_175 ( V_452 -> V_499 . V_550 . V_194 ) ;
if ( ! V_189 ) {
F_13 ( V_18 L_74 ,
...
static int
F_182 ( struct V_8 * V_34 , struct V_451 * V_452 )
{
struct V_188 * V_189 ;
struct V_525 * V_526 ;
int V_15 ;
if ( ! V_34 -> V_551 )
return - V_545 ;
V_189 = F_175 ( V_452 -> V_499 . V_552 . V_194 ) ;
if ( ! V_189 ) {
F_13 ( V_18 L_75 ,
...
static int
F_183 ( struct V_8 * V_34 , struct V_449 * V_450 )
{
struct V_451 * V_452 = F_159 ( V_450 ) ;
struct V_188 * V_189 = NULL ;
struct V_554 * V_555 ;
...
V_454 = F_154 ( sizeof( * V_452 ) + V_559 ) ;
V_189 = F_175 ( V_452 -> V_499 . V_560 . V_194 ) ;
if ( ! V_189 ) {
F_13 ( V_18 L_76 ,
...
do {
int V_502 ;
V_556 = F_155 ( V_454 , V_19 ) ;
if ( ! V_556 ) {
F_13 ( V_18 L_77 ) ;
V_15 = - V_458 ;
goto V_563;
}
V_557 = F_158 ( V_556 , 0 , 0 , 0 ,
...
V_502 = F_154 ( sizeof( * V_452 ) + V_559 ) ;
F_167 ( V_556 , F_168 ( V_502 ) ) ;
V_557 -> V_505 = V_502 ;
V_15 = F_151 ( V_556 , V_463 ,
V_19 ) ;
} while ( V_15 < 0 && V_15 != - V_506 );
V_563:
F_86 ( V_189 ) ;
...
if ( ! V_34 -> V_566 )
return - V_545 ;
V_189 = F_175 ( V_452 -> V_499 . V_566 . V_194 ) ;
if ( ! V_189 ) {
F_13 ( V_18 L_78 ,
...
V_189 = F_175 ( V_452 -> V_499 . V_571 . V_194 ) ;
if ( ! V_189 ) {
F_53 ( L_78 ,
...
V_189 = F_175 ( V_452 -> V_499 . V_575 . V_194 ) ;
if ( ! V_189 ) {
F_53 ( L_78 ,
...
V_189 = F_175 ( V_452 -> V_499 . V_579 . V_194 ) ;
if ( ! V_189 ) {
F_53 ( L_78 ,
...
V_189 = F_175 ( V_452 -> V_499 . V_581 . V_194 ) ;
if ( ! V_189 ) {
F_53 ( L_78 ,
...
V_189 = F_175 ( V_452 -> V_499 . V_583 . V_194 ) ;
if ( ! V_189 ) {
F_53 ( L_78 ,
...
V_189 = F_175 ( V_452 -> V_499 . V_585 . V_194 ) ;
if ( ! V_189 ) {
F_53 ( L_78 ,
V_562 , V_452 -> V_499 . V_583 . V_194 ) ;
V_15 = - V_531 ;
...
static int
F_193 ( struct V_8 * V_34 , struct V_449 * V_450 )
{
struct V_451 * V_452 = F_159 ( V_450 ) ;
struct V_188 * V_189 = NULL ;
struct V_3 * V_4 ;
...
V_454 = F_154 ( sizeof( * V_452 ) + V_590 ) ;
V_189 = F_175 ( V_452 -> V_499 . V_591 . V_194 ) ;
if ( ! V_189 ) {
F_53 ( L_82 ,
...
do {
int V_502 ;
V_587 = F_155 ( V_454 , V_19 ) ;
if ( ! V_587 ) {
F_53 ( L_83 ) ;
V_15 = - V_458 ;
goto V_593;
}
V_588 = F_158 ( V_587 , 0 , 0 , 0 ,
...
V_502 = F_154 ( sizeof( * V_452 ) + V_590 ) ;
F_167 ( V_587 , F_168 ( V_502 ) ) ;
V_588 -> V_505 = V_502 ;
V_15 = F_151 ( V_587 , V_463 ,
V_19 ) ;
} while ( V_15 < 0 && V_15 != - V_506 );
V_593:
F_86 ( V_189 ) ;
...
static int
F_194 ( struct V_441 * V_442 , struct V_449 * V_450 , T_5 * V_443 )
{
int V_15 = 0 ;
struct V_451 * V_452 = F_159 ( V_450 ) ;
...
break;
case V_620 :
V_15 = F_165 ( V_34 , V_450 ) ;
break;
case V_536 :
case V_537 :
case V_541 :
case V_529 :
V_15 = F_177 ( V_34 , V_452 , V_450 -> V_503 ) ;
break;
case V_621 :
...
F_198 ( V_450 , sizeof( * V_452 ) ) ) ;
break;
case V_624 :
V_15 = F_182 ( V_34 , V_452 ) ;
break;
case V_625 :
V_15 = F_183 ( V_34 , V_450 ) ;
break;
case V_626 :
V_15 = F_185 ( V_34 , V_452 ) ;
break;
case V_627 :
...
T_5 V_443 ;
V_450 = F_201 ( V_442 ) ;
if ( V_450 -> V_505 < sizeof( * V_450 ) ||
V_442 -> V_454 < V_450 -> V_505 ) {
break;
}
V_452 = F_159 ( V_450 ) ;
V_637 = F_168 ( V_450 -> V_505 ) ;
if ( V_637 > V_442 -> V_454 )
V_637 = V_442 -> V_454 ;
V_15 = F_194 ( V_442 , V_450 , & V_443 ) ;
if ( V_15 ) {
V_452 -> type = V_638 ;
V_452 -> V_639 = V_15 ;
}
...
struct V_378 * V_379 = F_204 ( V_374 ) ;
...
return sprintf ( V_7 , L_87 , F_81 ( V_388 -> V_181 ) ) ;
}
static T_1
...
{
struct V_380 * V_388 = F_75 ( V_2 -> V_29 ) ;
return sprintf ( V_7 , L_88 , V_388 -> V_426 ) ;
}
static T_1
...
{
struct V_380 * V_388 = F_75 ( V_2 -> V_29 ) ;
return sprintf ( V_7 , L_88 , V_388 -> V_332 ) ;
}
static T_4 F_208 ( struct V_30 * V_22 ,
struct V_31 * V_6 , int V_32 )
{
struct V_1 * V_374 = F_25 ( V_22 , struct V_1 , V_22 ) ;
struct V_380 * V_388 = F_209 ( V_374 ) ;
...
{
struct V_1 * V_374 = F_25 ( V_22 , struct V_1 , V_22 ) ;
struct V_188 * V_189 = F_211 ( V_374 ) ;
...
static int F_216 ( struct V_805 * V_806 ,
struct V_1 * V_2 )
{
struct V_188 * V_189 ;
struct V_3 * V_4 ;
