...
{
struct V_5 * V_17 = F_12 ( V_7 ) ;
struct V_66 * V_67 = (struct V_66 * ) F_85 ( V_58 , V_17 -> V_159 ) ;
T_3 * V_36 = ( T_3 * ) ( V_67 + 1 ) ;
F_86 ( V_67 , 0 ,
F_87 ( F_5 ( V_7 ) , V_58 ,
...
V_32 = 0 ;
if ( V_70 [ V_221 ] )
V_32 |= F_110 ( V_70 [ V_221 ] ) ;
if ( V_70 [ V_222 ] )
V_32 |= F_110 ( V_70 [ V_222 ] ) ;
if ( V_32 & ( V_71 | V_72 ) )
return - V_186 ;
return 0 ;
}
...
struct V_1 V_75 ;
if ( V_220 [ V_223 ] ) {
if ( F_112 ( V_220 [ V_223 ] ) != V_224 )
return - V_186 ;
if ( ! F_113 ( F_114 ( V_220 [ V_223 ] ) ) )
return - V_225 ;
}
if ( ! V_70 )
goto V_226;
if ( V_70 [ V_227 ] ) {
V_75 = F_115 ( V_70 [ V_227 ] ) ;
if ( F_14 ( & V_75 ) )
return - V_186 ;
}
V_226:
return F_109 ( V_220 , V_70 ) ;
}
...
F_110 ( V_70 [ V_222 ] ) ) ;
if ( V_70 [ V_229 ] )
V_28 -> V_31 = F_118 ( V_70 [ V_229 ] ) ;
if ( V_70 [ V_230 ] )
V_28 -> V_115 = F_118 ( V_70 [ V_230 ] ) ;
if ( V_70 [ V_231 ] )
V_28 -> V_29 = F_115 ( V_70 [ V_231 ] ) ;
if ( V_70 [ V_227 ] )
V_28 -> V_30 = F_115 ( V_70 [ V_227 ] ) ;
if ( V_70 [ V_232 ] )
V_28 -> V_169 = F_119 ( V_70 [ V_232 ] ) ;
if ( V_70 [ V_233 ] )
V_28 -> V_87 = F_119 ( V_70 [ V_233 ] ) ;
if ( V_70 [ V_234 ] )
V_28 -> V_125 = F_118 ( V_70 [ V_234 ] ) ;
if ( V_70 [ V_235 ] )
V_28 -> V_32 = F_117 ( V_70 [ V_235 ] ) ;
if ( V_70 [ V_236 ] )
V_28 -> V_129 = F_117 ( V_70 [ V_236 ] ) ;
}
...
if ( V_70 [ V_243 ] ) {
V_140 = true ;
V_242 -> type = F_124 ( V_70 [ V_243 ] ) ;
}
if ( V_70 [ V_244 ] ) {
V_140 = true ;
V_242 -> V_32 = F_124 ( V_70 [ V_244 ] ) ;
}
if ( V_70 [ V_245 ] ) {
V_140 = true ;
V_242 -> V_246 = F_110 ( V_70 [ V_245 ] ) ;
}
if ( V_70 [ V_247 ] ) {
V_140 = true ;
V_242 -> V_248 = F_110 ( V_70 [ V_247 ] ) ;
}
return V_140 ;
}
static int F_125 ( struct V_12 * V_249 , struct V_6 * V_7 ,
...
V_44 -> V_7 = V_7 ;
V_44 -> V_12 = F_5 ( V_7 ) ;
F_25 ( V_44 , ! V_220 [ V_250 ] ) ;
V_7 -> V_54 |= V_251 ;
V_7 -> V_252 |= V_251 ;
if ( ! ( V_44 -> V_28 . V_52 & V_53 ) ) {
if ( ! ( V_44 -> V_28 . V_52 & V_131 ) ||
( V_44 -> V_253 . type == V_254 ) ) {
V_7 -> V_54 |= V_255 ;
V_7 -> V_252 |= V_255 ;
}
V_7 -> V_54 |= V_55 ;
...
struct V_5 * V_17 = F_12 ( V_7 ) ;
struct V_35 * V_36 = & V_17 -> V_28 ;
if ( F_133 ( V_58 , V_228 , V_36 -> V_13 ) ||
F_134 ( V_58 , V_221 ,
F_76 ( V_36 -> V_170 ) ) ||
F_134 ( V_58 , V_222 ,
F_76 ( V_36 -> V_52 ) ) ||
F_135 ( V_58 , V_229 , V_36 -> V_31 ) ||
F_135 ( V_58 , V_230 , V_36 -> V_115 ) ||
F_136 ( V_58 , V_231 , & V_36 -> V_29 ) ||
F_136 ( V_58 , V_227 , & V_36 -> V_30 ) ||
F_137 ( V_58 , V_232 , V_36 -> V_169 ) ||
F_137 ( V_58 , V_233 , V_36 -> V_87 ) ||
F_135 ( V_58 , V_234 , V_36 -> V_125 ) ||
F_133 ( V_58 , V_235 , V_36 -> V_32 ) ||
F_133 ( V_58 , V_236 , V_36 -> V_129 ) )
goto V_256;
if ( F_138 ( V_58 , V_243 ,
V_17 -> V_253 . type ) ||
F_134 ( V_58 , V_245 ,
