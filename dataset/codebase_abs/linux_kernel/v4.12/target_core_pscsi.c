...
struct V_117 * V_118 = V_111 -> V_119 ;
V_118 -> V_121 = F_74 ( V_160 ) -> V_116 ;
V_118 -> V_202 = F_74 ( V_160 ) -> V_203 ;
V_111 -> V_204 = F_44 ( V_118 -> V_121 ) << 1 ;
if ( V_111 -> V_204 ) {
F_6 ( L_79
...
memcpy ( V_118 -> V_133 , F_74 ( V_160 ) -> V_207 , V_134 ) ;
