...
static struct V_41 T_2 * * F_31 ( struct V_2 * V_3 ,
unsigned long V_11 )
{
struct V_5 * V_6 = F_2 ( V_3 ) ;
if ( V_11 )
...
* V_72 = V_78 | V_79 ;
V_75 = F_53 ( V_6 -> V_42 ) ;
V_76 = F_54 ( V_49 , V_75 , & V_74 , false ) ;
if ( V_76 >= 0 ) {
#ifdef F_55
switch ( V_76 ) {
case V_80 :
...
goto V_88;
while ( 1 ) {
V_11 = F_66 ( & V_6 -> V_87 , struct V_1 , V_47 ) ;
