...
int V_148 = F_33 ( V_133 -> V_145 , V_133 -> V_146 ) ;
if ( V_2 -> V_13 . V_14 & V_149 ) {
V_147 = V_147 >> 1 ;
V_148 = V_148 >> 1 ;
}
F_34 ( V_50 , V_83 , V_86 , V_133 -> V_150 ) ;
F_34 ( V_50 , V_83 , V_89 , V_133 -> V_151 ) ;
F_34 ( V_50 , V_83 , V_84 , V_133 -> V_152 ) ;
F_34 ( V_50 , V_83 , V_88 , V_133 -> V_153 ) ;
F_34 ( V_50 , V_83 , V_93 ,
! V_133 -> V_141 ) ;
F_34 ( V_50 , V_83 , V_111 , V_144 ) ;
F_34 ( V_50 , V_83 , V_113 , V_133 -> V_154 ) ;
...
{
if ( V_34 -> V_155 & V_156 && V_34 -> V_157 )
V_34 -> V_157 ( V_34 , V_31 , V_33 , V_43 ) ;
return 1 ;
}
...
T_4 V_14 = V_2 -> V_13 . V_14 ;
struct V_49 * V_50 = V_31 -> V_158 -> V_50 ;
if ( V_34 -> V_155 & V_159 ) {
switch ( V_33 -> V_34 ) {
case V_91 :
if ( V_14 & V_160 )
...
if ( V_33 -> V_34 == V_2 -> V_163 )
F_29 ( V_2 , V_31 -> V_158 -> V_50 ) ;
}
}
}
...
for ( V_164 = 0 ; V_164 < V_21 -> V_117 ; V_164 ++ ) {
V_31 = V_21 -> V_31 [ V_164 ] ;
V_15 = V_31 -> V_37 ;
if ( ! ( V_166 & V_31 -> V_167 ) )
continue;
for ( V_165 = 0 ; V_165 < V_15 ; V_165 ++ )
F_39 ( V_34 , V_31 , & V_31 -> V_33 [ V_165 ] ,
V_31 -> V_43 [ V_165 ] ) ;
}
if ( V_2 -> V_5 >= V_2 -> V_127 )
F_35 ( V_2 , V_21 -> V_31 [ 0 ] -> V_158 -> V_50 ) ;
}
...
if ( V_31 && V_31 -> V_158 && V_31 -> V_158 -> V_50 )
F_37 ( V_31 -> V_158 -> V_50 ) ;
}
...
if ( V_2 -> V_38 < 0 )
return;
V_181 = & ( V_12 -> V_183 [ V_28 ] ) ;
V_164 = V_181 -> V_184 [ V_2 -> V_38 ] ;
if ( V_164 ) {
if ( V_68 -> V_14 & V_185 ) {
V_182 = F_8 ( V_164 ) ;
V_10 = F_9 ( V_164 , V_26 ) ;
...
F_10 ( V_12 , V_164 -> V_27 , V_10 , V_182 ,
V_28 ,
V_29 ) ;
F_13 ( V_10 ) ;
}
V_164 -> V_31 [ 0 ] -> V_43 [ V_2 -> V_39 ] = V_2 -> V_78 ;
F_52 ( V_12 , V_164 , V_186 ) ;
}
}
...
return;
V_181 = & V_12 -> V_183 [ V_28 ] ;
V_164 = V_181 -> V_184 [ V_2 -> V_41 ] ;
if ( V_164 ) {
V_66 = V_2 -> V_13 . V_42 ;
V_187 = V_164 -> V_31 [ 0 ] -> V_44 ;
V_66 = F_33 ( V_187 , V_66 ) ;
if ( V_164 -> V_31 [ 0 ] -> V_43 [ 0 ] != V_66 ) {
V_164 -> V_31 [ 0 ] -> V_43 [ 0 ] = V_66 ;
F_52 ( V_12 , V_164 , V_186 ) ;
}
}
}
...
struct V_67 * V_68 = & V_2 -> V_13 ;
if ( V_2 -> V_102 > 0 ) {
int V_188 = V_60 -> V_62 / V_2 -> V_102 ;
V_2 -> V_163 = V_60 -> V_64 [ V_188 - 1 ] ;
}
if ( V_2 -> V_18 < 0 )
V_68 -> V_14 &= ~ V_19 ;
}
...
if ( V_58 -> V_21 -> V_31 [ 0 ] -> V_178 == V_179 ) {
V_189 = L_8 ;
F_44 ( V_190 , V_58 -> V_50 -> V_191 ) ;
} else {
switch ( V_31 -> V_70 ) {
case V_176 :
V_189 = L_9 ;
...
strlen ( V_12 -> V_95 ) + strlen ( V_189 ) + 2 ,
V_26 ) ;
if ( V_95 ) {
sprintf ( V_95 , L_16 , V_12 -> V_95 , V_189 ) ;
V_58 -> V_50 -> V_95 = V_95 ;
}
}
return 0 ;
}
static void F_56 ( struct V_30 * V_31 , unsigned int V_33 )
{
...
static void F_57 ( struct V_11 * V_12 , unsigned int V_33 )
{
struct V_20 * V_21 ;
int V_196 ;
F_58 (report,
...
if ( ! V_21 -> V_117 )
continue;
for ( V_196 = 0 ; V_196 < V_21 -> V_117 ; V_196 ++ )
if ( V_21 -> V_31 [ V_196 ] -> V_197 >= 1 )
F_56 ( V_21 -> V_31 [ V_196 ] , V_33 ) ;
}
}
static int F_59 ( struct V_11 * V_12 , const struct V_198 * V_27 )
{
int V_22 , V_196 ;
struct V_1 * V_2 ;
struct V_67 * V_13 = V_199 ;
for ( V_196 = 0 ; V_199 [ V_196 ] . V_95 ; V_196 ++ ) {
if ( V_27 -> V_200 == V_199 [ V_196 ] . V_95 ) {
V_13 = & ( V_199 [ V_196 ] ) ;
break;
}
}
...
if ( V_27 -> V_203 == V_204 && V_27 -> V_205 == V_204 )
V_2 -> V_169 = true ;
V_2 -> V_24 = V_12 -> V_14 ;
V_12 -> V_14 |= V_206 ;
V_12 -> V_14 |= V_207 ;
...
if ( V_13 -> V_14 & V_209 )
F_57 ( V_12 , V_101 ) ;
V_22 = F_62 ( V_12 , V_210 ) ;
if ( V_22 )
return V_22 ;
V_22 = F_63 ( & V_12 -> V_7 . V_211 , & V_212 ) ;
if ( V_22 )
F_11 ( & V_12 -> V_7 , L_19 ,
V_12 -> V_95 ) ;
F_53 ( V_12 ) ;
F_50 ( V_12 ) ;
F_64 ( & V_12 -> V_7 , V_2 -> V_61 ) ;
V_2 -> V_61 = NULL ;
return 0 ;
}
...
{
struct V_57 * V_158 ;
F_58 (hidinput, &hid->inputs, list) {
struct V_49 * V_49 = V_158 -> V_50 ;
struct V_134 * V_135 = V_49 -> V_135 ;
int V_196 ;
if ( V_135 ) {
for ( V_196 = 0 ; V_196 < V_135 -> V_213 ; V_196 ++ ) {
V_137 ( V_49 , V_196 ) ;
F_32 ( V_49 ,
V_143 ,
false ) ;
