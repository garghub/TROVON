...
static int F_150 ( struct V_32 * V_23 )
{
struct V_1 * V_2 = F_22 ( V_23 ) ;
struct V_208 * V_76 = & V_2 -> V_44 -> V_76 ;
int V_247 , V_145 ;
...
if ( ! F_151 ( V_251 , V_76 ) )
return 0 ;
V_247 = F_152 ( V_76 -> V_211 , L_89 ) ;
if ( V_247 <= 0 ) {
F_153 ( V_23 , L_90 , V_212 ) ;
return 0 ;
}
V_145 = F_154 ( & V_23 -> V_76 , V_247 , F_145 ,
0 , L_91 , V_2 ) ;
if ( V_145 ) {
F_127 ( V_23 , L_92 , V_212 ) ;
return V_145 ;
}
V_145 = F_155 ( V_76 , true ) ;
if ( V_145 ) {
...
V_2 -> V_252 = V_247 ;
F_156 ( V_247 ) ;
F_157 ( V_23 , L_94 , V_247 ) ;
return 0 ;
}
static int F_158 ( struct V_115 * V_84 ,
...
struct V_216 * V_44 = F_160 ( V_84 ) ;
if ( F_32 ( V_44 -> V_263 . V_264 ) <= 0x0001 )
return - V_47 ;
}
V_2 = F_161 ( & V_84 -> V_76 , sizeof( * V_2 ) , V_87 ) ;
if ( ! V_2 )
return - V_16 ;
for ( V_62 = 0 ; V_62 < V_84 -> V_120 -> V_121 . V_122 ; V_62 ++ ) {
V_118 = & V_84 -> V_120 -> V_123 [ V_62 ] . V_121 ;
if ( ! V_2 -> V_52 && F_162 ( V_118 ) ) {
V_2 -> V_52 = V_118 ;
continue;
}
...
V_23 -> V_286 = F_144 ;
V_23 -> V_287 = V_288 ;
V_2 -> V_89 = F_171 ( V_2 -> V_44 , V_255 + 2 ) ;
}
...
V_2 -> V_116 = F_171 ( V_2 -> V_44 , V_255 + 1 ) ;
}
if ( ! V_310 )
...
static void F_177 ( struct V_115 * V_84 )
{
struct V_1 * V_2 = F_178 ( V_84 ) ;
struct V_32 * V_23 ;
F_23 ( L_97 , V_84 ) ;
if ( ! V_2 )
return;
...
F_175 ( V_2 -> V_84 , NULL ) ;
if ( V_2 -> V_116 )
F_175 ( V_2 -> V_116 , NULL ) ;
if ( V_2 -> V_89 )
F_175 ( V_2 -> V_89 , NULL ) ;
F_179 ( V_23 ) ;
if ( V_84 == V_2 -> V_84 ) {
if ( V_2 -> V_116 )
F_180 ( & V_319 , V_2 -> V_116 ) ;
if ( V_2 -> V_89 )
F_180 ( & V_319 , V_2 -> V_89 ) ;
} else if ( V_84 == V_2 -> V_116 ) {
if ( V_2 -> V_89 )
F_180 ( & V_319 , V_2 -> V_89 ) ;
F_180 ( & V_319 , V_2 -> V_84 ) ;
...
if ( V_2 -> V_252 )
F_155 ( & V_2 -> V_44 -> V_76 , false ) ;
F_176 ( V_23 ) ;
}
static int F_181 ( struct V_115 * V_84 , T_11 V_320 )
{
struct V_1 * V_2 = F_178 ( V_84 ) ;
F_23 ( L_97 , V_84 ) ;
if ( V_2 -> V_321 ++ )
...
F_58 ( V_2 ) ;
F_54 ( & V_2 -> V_93 ) ;
if ( V_2 -> V_252 && F_185 ( & V_2 -> V_44 -> V_76 ) ) {
F_55 ( V_249 , & V_2 -> V_3 ) ;
F_186 ( V_2 -> V_252 ) ;
F_187 ( V_2 -> V_252 ) ;
}
...
static int F_190 ( struct V_115 * V_84 )
{
struct V_1 * V_2 = F_178 ( V_84 ) ;
struct V_32 * V_23 = V_2 -> V_23 ;
int V_12 = 0 ;
