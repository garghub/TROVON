...
static void F_41 ( struct V_65 * V_50 , struct V_65 * V_66 ,
void * V_67 )
{
struct V_1 * V_2 = F_39 ( V_50 ) ;
F_30 ( & V_57 ) ;
...
struct V_1 * V_2 = F_39 ( V_50 ) ;
int V_44 ;
for ( V_44 = V_70 - 1 ; V_44 > - 1 ; V_44 -- )
F_44 ( V_2 -> V_71 [ V_44 ] ) ;
return 0 ;
}
static int F_45 ( struct V_65 * V_50 )
{
struct V_1 * V_2 = F_39 ( V_50 ) ;
int V_4 , V_44 ;
for ( V_44 = 0 ; V_44 < V_70 ; V_44 ++ ) {
V_4 = F_46 ( V_2 -> V_71 [ V_44 ] ) ;
if ( V_4 < 0 ) {
F_3 ( L_6 ,
V_72 [ V_44 ] ) ;
while ( -- V_44 > - 1 )
...
{
struct V_65 * V_50 = & V_74 -> V_50 ;
struct V_1 * V_2 ;
struct V_75 V_76 ;
int V_4 , V_44 ;
V_2 = F_48 ( V_50 , sizeof( * V_2 ) , V_77 ) ;
if ( ! V_2 ) {
F_3 ( L_7 ) ;
V_4 = - V_78 ;
goto V_79;
...
if ( V_4 )
goto V_79;
V_4 = F_49 ( V_50 -> V_51 , 0 , & V_76 ) ;
if ( V_4 ) {
F_3 ( L_8 ) ;
goto V_79;
}
V_2 -> V_14 = F_50 ( V_50 , V_76 . V_80 , F_51 ( & V_76 ) ) ;
if ( ! V_2 -> V_14 ) {
F_3 ( L_9 ) ;
V_4 = - V_78 ;
goto V_79;
}
V_2 -> V_6 = F_52 ( V_50 -> V_51 ,
L_10 ) ;
if ( F_53 ( V_2 -> V_6 ) ) {
F_3 ( L_11 ) ;
V_4 = F_54 ( V_2 -> V_6 ) ;
...
for ( V_44 = 0 ; V_44 < V_70 ; V_44 ++ ) {
V_2 -> V_71 [ V_44 ] = F_55 ( V_50 , V_72 [ V_44 ] ) ;
if ( F_53 ( V_2 -> V_71 [ V_44 ] ) ) {
F_3 ( L_12 ,
V_72 [ V_44 ] ) ;
V_4 = F_54 ( V_2 -> V_71 [ V_44 ] ) ;
goto V_79;
}
}
F_56 ( V_74 , V_2 ) ;
...
static int F_61 ( struct V_73 * V_74 )
{
F_62 ( & V_74 -> V_50 , & V_81 ) ;
F_60 ( & V_74 -> V_50 ) ;
return 0 ;
