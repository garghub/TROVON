...
static int F_19 ( const char * V_27 )
{
char V_32 [ V_29 ] ;
T_4 V_33 [ V_34 ] ;
int V_16 ;
if ( F_20 ( V_27 , & V_33 , sizeof( V_33 ) ) < 0 ) {
F_15 ( L_10 , V_27 ) ;
return - 1 ;
}
F_21 ( V_33 , sizeof( V_33 ) , V_32 ) ;
V_16 = F_22 ( V_32 , V_27 ,
false , false ) ;
F_15 ( L_11 , V_32 , V_27 ,
V_16 ? L_12 : L_13 ) ;
...
F_31 ( L_16 ,
V_27 ) ;
} else if ( memcmp ( V_42 -> V_33 , V_33 , sizeof( V_42 -> V_33 ) ) ) {
F_31 ( L_16 ,
V_27 ) ;
}
return true ;
...
static int F_34 ( const char * V_27 )
{
T_4 V_33 [ V_34 ] ;
char V_32 [ V_29 ] ;
int V_16 = 0 ;
...
V_16 = F_24 ( V_32 ) ;
if ( ! V_16 )
V_16 = F_22 ( V_32 , V_27 , false , false ) ;
F_15 ( L_17 , V_32 , V_27 ,
V_16 ? L_12 : L_13 ) ;
return V_16 ;
}
