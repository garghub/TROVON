...
int error ;
ASSERT ( F_133 ( V_55 ) ) ;
V_216 = F_134 ( V_55 , V_218 ) ;
if ( ! ( V_216 -> V_219 & V_220 ) ) {
if ( ( error = F_135 ( NULL , V_55 , V_218 ) ) )
return error ;
}
V_207 = 0 ;
V_217 = F_136 ( V_216 ) ;
...
error = F_98 ( V_2 , NULL , V_157 , V_227 , V_59 ,
& V_55 ) ;
if ( error ) {
* V_224 = V_225 ;
return error ;
...
if ( F_44 ( V_2 ) ) {
V_234 = F_1 ( V_2 , V_45 , F_140 ,
& V_183 ) ;
if ( ! error )
error = V_234 ;
}
if ( F_45 ( V_2 ) ) {
V_234 = F_1 ( V_2 , V_47 , F_140 ,
& V_183 ) ;
if ( ! error )
error = V_234 ;
}
...
V_247:
F_65 ( & V_2 -> V_163 ) ;
V_245 = V_2 -> V_63 . V_129 ;
V_2 -> V_63 . V_129 = V_2 -> V_128 & V_248 ;
F_60 ( & V_2 -> V_163 ) ;
if ( V_245 != ( V_2 -> V_128 & V_248 ) ) {
if ( F_149 ( V_2 , false ) ) {
ASSERT ( ! ( F_38 ( V_2 ) ) ) ;
F_108 ( V_2 , L_10 ,
V_30 ) ;
...
V_259 = V_59 ;
F_48 ( V_55 , V_259 ) ;
if ( ( V_41 & V_260 ) && F_151 ( V_55 ) )
V_251 = V_55 -> V_66 . V_71 ;
if ( F_40 ( V_2 , V_55 ) ) {
...
ASSERT ( V_55 -> V_65 ) ;
V_256 = F_152 ( V_55 -> V_65 ) ;
}
}
if ( ( V_41 & V_44 ) && F_44 ( V_2 ) ) {
if ( V_55 -> V_66 . V_71 != V_251 ) {
F_49 ( V_55 , V_259 ) ;
...
ASSERT ( V_55 -> V_70 ) ;
V_257 = F_152 ( V_55 -> V_70 ) ;
}
}
if ( ( V_41 & V_46 ) && F_45 ( V_2 ) ) {
if ( F_46 ( V_55 ) != V_252 ) {
F_49 ( V_55 , V_259 ) ;
error = F_35 ( V_2 , NULL , ( T_5 ) V_252 ,
V_47 ,
V_68 |
V_61 ,
& V_258 ) ;
...
ASSERT ( V_264 ) ;
ASSERT ( V_264 != V_263 ) ;
F_155 ( V_154 , V_264 , V_265 , - ( V_55 -> V_66 . V_195 ) ) ;
F_155 ( V_154 , V_264 , V_268 , - 1 ) ;
F_155 ( V_154 , V_263 , V_265 , V_55 -> V_66 . V_195 ) ;
F_155 ( V_154 , V_263 , V_268 , 1 ) ;
* V_262 = F_152 ( V_263 ) ;
return V_264 ;
}
int
...
int error ;
ASSERT ( F_33 ( V_55 , V_59 | V_261 ) ) ;
ASSERT ( F_38 ( V_2 ) ) ;
V_273 = V_55 -> V_228 ;
V_274 = F_133 ( V_55 ) ?
V_282 : V_283 ;
if ( F_43 ( V_2 ) && V_270 &&
V_55 -> V_66 . V_67 != F_7 ( V_270 -> V_20 . V_21 ) ) {
V_279 = V_270 ;
if ( V_273 ) {
ASSERT ( V_55 -> V_65 ) ;
V_276 = V_55 -> V_65 ;
...
if ( F_44 ( V_55 -> V_60 ) && V_271 &&
V_55 -> V_66 . V_71 != F_7 ( V_271 -> V_20 . V_21 ) ) {
V_280 = V_271 ;
if ( V_273 ) {
ASSERT ( V_55 -> V_70 ) ;
V_277 = V_55 -> V_70 ;
...
if ( F_45 ( V_55 -> V_60 ) && V_272 &&
F_46 ( V_55 ) != F_7 ( V_272 -> V_20 . V_21 ) ) {
V_275 = V_284 ;
V_281 = V_272 ;
if ( V_273 ) {
ASSERT ( V_55 -> V_72 ) ;
...
struct V_62 * * V_285 )
{
struct V_1 * V_2 = V_285 [ 0 ] -> V_60 ;
int V_18 ;
if ( ! F_38 ( V_2 ) || ! F_39 ( V_2 ) )
return 0 ;
for ( V_18 = 0 ; ( V_18 < 4 && V_285 [ V_18 ] ) ; V_18 ++ ) {
struct V_62 * V_55 = V_285 [ V_18 ] ;
int error ;
if ( V_18 == 0 || V_55 != V_285 [ V_18 - 1 ] ) {
if ( F_40 ( V_2 , V_55 ) ) {
error = F_47 ( V_55 , 0 ) ;
if ( error )
return error ;
...
ASSERT ( V_55 -> V_66 . V_67 == F_7 ( V_270 -> V_20 . V_21 ) ) ;
V_55 -> V_65 = F_152 ( V_270 ) ;
F_155 ( V_154 , V_270 , V_268 , 1 ) ;
}
if ( V_271 && F_44 ( V_2 ) ) {
ASSERT ( V_55 -> V_70 == NULL ) ;
ASSERT ( V_55 -> V_66 . V_71 == F_7 ( V_271 -> V_20 . V_21 ) ) ;
V_55 -> V_70 = F_152 ( V_271 ) ;
F_155 ( V_154 , V_271 , V_268 , 1 ) ;
}
if ( V_272 && F_45 ( V_2 ) ) {
ASSERT ( V_55 -> V_72 == NULL ) ;
ASSERT ( F_46 ( V_55 ) == F_7 ( V_272 -> V_20 . V_21 ) ) ;
V_55 -> V_72 = F_152 ( V_272 ) ;
F_155 ( V_154 , V_272 , V_268 , 1 ) ;
}
}
