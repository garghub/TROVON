...
static void F_83 ( int V_162 , struct V_163 * V_163 )
{
F_11 ( V_162 ) ;
}
static void F_84 ( int V_162 )
{
F_10 ( V_162 ) ;
}
static int F_85 ( const char * V_164 , char * V_165 )
{
if ( V_165 )
strcpy ( V_165 , V_166 ) ;
if ( ! V_164 )
return 0 ;
if ( strcmp ( V_164 , L_24 ) == 0 )
V_68 = V_140 ;
else if ( strcmp ( V_164 , L_25 ) == 0 )
V_68 = V_37 ;
else if ( strcmp ( V_164 , L_26 ) == 0 )
V_68 = V_167 ;
else if ( strcmp ( V_164 , L_27 ) == 0 )
V_68 = V_168 ;
else
return - V_7 ;
strcpy ( V_166 , V_164 ) ;
...
static int F_86 ( const char * V_164 , char * V_165 )
{
if ( V_165 )
strcpy ( V_165 , V_169 ) ;
if ( ! V_164 )
return 0 ;
if ( strcmp ( V_164 , L_28 ) == 0 )
V_39 = V_40 ;
else if ( strcmp ( V_164 , L_29 ) == 0 )
V_39 = V_170 ;
#ifdef F_75
else if ( strcmp ( V_164 , L_30 ) == 0 )
V_39 = V_149 ;
#endif
else if ( strcmp ( V_164 , L_31 ) == 0 )
V_39 = V_171 ;
else
return - V_7 ;
strcpy ( V_169 , V_164 ) ;
...
static int F_87 ( const char * V_164 , char * V_165 )
{
if ( V_165 )
strcpy ( V_165 , V_172 ) ;
if ( ! V_164 )
return 0 ;
if ( strcmp ( V_164 , L_32 ) == 0 )
V_127 = V_141 ;
else if ( strcmp ( V_164 , L_33 ) == 0 )
V_127 = V_128 ;
else if ( strcmp ( V_164 , L_34 ) == 0 )
V_127 = V_130 ;
else
return - V_7 ;
strcpy ( V_172 , V_164 ) ;
