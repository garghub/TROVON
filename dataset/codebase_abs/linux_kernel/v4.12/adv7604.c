...
if ( ! V_353 )
return - V_56 ;
V_76 = F_167 ( V_353 , & V_351 ) ;
if ( V_76 ) {
F_168 ( V_353 ) ;
return V_76 ;
}
F_168 ( V_353 ) ;
if ( ! F_169 ( V_354 , L_156 , & V_355 ) )
...
static int F_170 ( struct V_1 * V_2 , int V_371 )
{
int V_20 ;
if ( ! V_2 -> V_19 [ V_371 ] )
return - V_372 ;
V_2 -> V_22 [ V_371 ] =
F_171 ( V_2 -> V_19 [ V_371 ] ,
& V_373 [ V_371 ] ) ;
if ( F_172 ( V_2 -> V_22 [ V_371 ] ) ) {
V_20 = F_173 ( V_2 -> V_22 [ V_371 ] ) ;
F_12 ( V_2 -> V_19 [ V_371 ] ,
L_157 ,
V_371 , V_20 ) ;
return - V_56 ;
...
int V_20 ;
if ( ! F_178 ( V_18 -> V_349 , V_381 ) )
return - V_269 ;
F_179 ( 1 , V_37 , V_18 , L_158 ,
V_18 -> V_23 << 1 ) ;
V_2 = F_180 ( & V_18 -> V_310 , sizeof( * V_2 ) , V_382 ) ;
if ( ! V_2 ) {
F_12 ( V_18 , L_159 ) ;
return - V_383 ;
}
...
V_386 = F_181 ( V_387 , V_18 -> V_310 . V_356 ) ;
V_2 -> V_3 = V_386 -> V_285 ;
V_20 = F_165 ( V_2 ) ;
if ( V_20 < 0 ) {
F_12 ( V_18 , L_160 ) ;
...
for ( V_8 = 0 ; V_8 < V_2 -> V_3 -> V_40 ; ++ V_8 ) {
V_2 -> V_41 [ V_8 ] =
F_182 ( & V_18 -> V_310 , L_162 , V_8 ,
V_390 ) ;
if ( F_172 ( V_2 -> V_41 [ V_8 ] ) )
return F_173 ( V_2 -> V_41 [ V_8 ] ) ;
if ( V_2 -> V_41 [ V_8 ] )
F_183 ( V_18 , L_163 , V_8 ) ;
}
V_2 -> V_375 = F_184 ( & V_18 -> V_310 , L_164 ,
V_391 ) ;
if ( F_172 ( V_2 -> V_375 ) )
return F_173 ( V_2 -> V_375 ) ;
F_175 ( V_2 ) ;
V_2 -> V_86 = V_377 ;
V_2 -> V_214 = V_60 ( V_2 , V_248 ) ;
V_13 = & V_2 -> V_13 ;
F_185 ( V_13 , V_18 , & V_392 ) ;
snprintf ( V_13 -> V_200 , sizeof( V_13 -> V_200 ) , L_165 ,
V_133 -> V_200 , F_186 ( V_18 -> V_349 ) ,
V_18 -> V_23 ) ;
...
F_188 ( V_7 , & V_399 ,
V_137 , 0 , 128 , 1 , 0 ) ;
V_131 = F_189 ( V_7 , & V_399 ,
V_142 , V_143 ,
0 , V_143 ) ;
if ( V_131 )
V_131 -> V_126 |= V_400 ;
V_2 -> V_82 = F_188 ( V_7 , NULL ,
V_401 , 0 ,
...
if ( F_1 ( V_2 ) )
V_2 -> V_403 =
F_190 ( V_7 , & V_404 , NULL ) ;
V_2 -> V_405 =
F_190 ( V_7 , & V_406 , NULL ) ;
V_2 -> V_407 =
F_190 ( V_7 , & V_408 , NULL ) ;
V_13 -> V_347 = V_7 ;
if ( V_7 -> error ) {
V_20 = V_7 -> error ;
goto V_409;
...
V_20 = F_192 ( & V_13 -> V_414 , V_2 -> V_167 + 1 ,
V_2 -> V_411 ) ;
if ( V_20 )
goto V_415;
V_20 = F_174 ( V_2 ) ;
...
goto V_416;
#if F_131 ( V_282 )
V_2 -> V_250 = F_193 ( & V_417 ,
V_2 , F_194 ( & V_18 -> V_310 ) ,
V_418 | V_419 |
V_420 | V_421 , V_267 ) ;
V_20 = F_195 ( V_2 -> V_250 ) ;
if ( V_20 )
goto V_416;
#endif
