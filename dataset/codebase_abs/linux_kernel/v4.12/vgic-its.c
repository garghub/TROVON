...
V_28 -> V_143 = V_237 |
( ( T_2 ) V_139 << V_222 ) ;
V_103 -> V_2 -> V_8 . V_9 . V_46 = V_238 ;
V_103 -> V_239 = V_28 ;
return F_17 ( V_28 , V_85 - 1 ) ;
}
static void F_122 ( struct V_2 * V_2 , struct V_34 * V_103 )
{
struct V_37 * V_39 , * V_240 ;
F_79 (ite, tmp, &dev->itt_head, ite_list)
F_53 ( V_2 , V_39 ) ;
F_54 ( & V_103 -> V_159 ) ;
F_10 ( V_103 ) ;
}
static void F_123 ( struct V_233 * V_241 )
{
struct V_2 * V_2 = V_241 -> V_2 ;
struct V_27 * V_28 = V_241 -> V_239 ;
struct V_242 * V_243 , * V_158 ;
if ( ! V_28 -> V_161 . V_244 )
return;
F_51 ( & V_28 -> V_119 ) ;
F_124 (cur, temp, &its->device_list) {
struct V_34 * V_103 ;
V_103 = F_125 ( V_243 , struct V_34 , V_159 ) ;
F_122 ( V_2 , V_103 ) ;
}
F_124 (cur, temp, &its->collection_list) {
struct V_40 * V_56 ;
V_56 = F_125 ( V_243 , struct V_40 , V_146 ) ;
F_54 ( V_243 ) ;
F_10 ( V_56 ) ;
}
F_52 ( & V_28 -> V_119 ) ;
...
T_4 V_249 = V_246 -> V_246 ;
int V_250 ;
V_250 = ( V_249 < V_251 ) || ( V_249 >= V_91 ) ? 0x3 : 0x7 ;
if ( V_249 & V_250 )
return - V_86 ;
V_248 = F_127 ( V_229 ,
F_117 ( V_229 ) ,
...
V_28 = V_103 -> V_239 ;
V_249 = V_246 -> V_246 ;
if ( ( V_249 < V_251 ) || ( V_249 >= V_91 ) )
V_250 = 0x3 ;
else
V_250 = 0x7 ;
if ( V_249 & V_250 )
return - V_86 ;
F_51 ( & V_103 -> V_2 -> V_254 ) ;
if ( F_116 ( V_28 -> V_227 ) ) {
V_12 = - V_252 ;
goto V_213;
}
...
V_69 = V_28 -> V_227 + V_249 ;
V_70 = V_248 -> V_255 & V_256 ? 8 : 4 ;
if ( V_253 ) {
if ( V_248 -> V_257 )
V_12 = V_248 -> V_257 ( V_103 -> V_2 , V_28 , V_69 ,
V_70 , * V_71 ) ;
else
V_248 -> V_258 ( V_103 -> V_2 , V_28 , V_69 , V_70 , * V_71 ) ;
} else {
* V_71 = V_248 -> V_259 ( V_103 -> V_2 , V_28 , V_69 , V_70 ) ;
}
F_130 ( V_103 -> V_2 ) ;
V_213:
F_52 ( & V_103 -> V_2 -> V_254 ) ;
return V_12 ;
}
static T_1 F_131 ( struct V_242 * V_260 ,
struct V_34 * V_103 )
{
struct V_34 * V_244 ;
T_1 V_261 ;
if ( F_132 ( & V_103 -> V_159 , V_260 ) )
return 0 ;
V_244 = F_133 ( V_103 , V_159 ) ;
V_261 = V_244 -> V_35 - V_103 -> V_35 ;
return F_134 ( T_1 , V_261 , V_262 ) ;
}
static T_1 F_135 ( struct V_242 * V_260 , struct V_37 * V_39 )
{
struct V_37 * V_244 ;
T_1 V_261 ;
if ( F_132 ( & V_39 -> V_121 , V_260 ) )
return 0 ;
V_244 = F_133 ( V_39 , V_121 ) ;
V_261 = V_244 -> V_38 - V_39 -> V_38 ;
return F_134 ( T_1 , V_261 , V_263 ) ;
}
static int F_136 ( struct V_27 * V_28 , T_4 V_264 , int V_125 , int V_135 ,
int V_265 , T_8 V_266 , void * V_267 )
{
void * V_268 = F_3 ( V_135 , V_13 ) ;
...
int V_261 ;
T_9 V_64 ;
V_12 = F_22 ( V_2 , V_269 , V_268 , V_135 ) ;
if ( V_12 )
goto V_213;
V_261 = V_266 ( V_28 , V_130 , V_268 , V_267 ) ;
if ( V_261 <= 0 ) {
V_12 = V_261 ;
goto V_213;
}
...
T_1 V_261 ;
T_2 V_79 ;
V_261 = F_135 ( & V_103 -> V_150 , V_39 ) ;
V_79 = ( ( T_2 ) V_261 << V_270 ) |
( ( T_2 ) V_39 -> V_149 << V_271 ) |
V_39 -> V_42 -> V_43 ;
V_79 = F_138 ( V_79 ) ;
return F_139 ( V_2 , V_269 , & V_79 , V_77 ) ;
}
static int F_140 ( struct V_27 * V_28 , T_1 V_38 ,
void * V_272 , void * V_267 )
{
struct V_34 * V_103 = (struct V_34 * ) V_267 ;
struct V_40 * V_42 ;
struct V_2 * V_2 = V_28 -> V_103 -> V_2 ;
struct V_4 * V_5 = NULL ;
T_2 V_79 ;
...
V_79 = F_56 ( V_79 ) ;
V_41 = V_79 & V_274 ;
V_148 = ( V_79 & V_275 ) >> V_271 ;
if ( ! V_148 )
return 1 ;
if ( V_148 < V_276 )
return - V_86 ;
V_249 = V_79 >> V_270 ;
if ( V_38 + V_249 >= F_57 ( V_103 -> V_154 ) )
return - V_86 ;
V_42 = F_20 ( V_28 , V_41 ) ;
if ( ! V_42 )
return - V_86 ;
...
static int F_141 ( void * V_277 , struct V_242 * V_278 ,
struct V_242 * V_279 )
{
struct V_37 * V_280 = F_47 ( V_278 , struct V_37 , V_121 ) ;
struct V_37 * V_281 = F_47 ( V_279 , struct V_37 , V_121 ) ;
if ( V_280 -> V_38 < V_281 -> V_38 )
return - 1 ;
else
return 1 ;
}
...
{
const struct V_26 * V_32 = F_16 ( V_28 ) ;
T_4 V_264 = V_36 -> V_160 ;
struct V_37 * V_39 ;
int V_12 ;
int V_77 = V_32 -> V_77 ;
F_143 ( NULL , & V_36 -> V_150 , F_141 ) ;
F_9 (ite, &device->itt_head, ite_list) {
T_4 V_269 = V_264 + V_39 -> V_38 * V_77 ;
...
{
const struct V_26 * V_32 = F_16 ( V_28 ) ;
T_4 V_264 = V_103 -> V_160 ;
int V_12 ;
int V_77 = V_32 -> V_77 ;
T_9 V_282 = F_57 ( V_103 -> V_154 ) * V_77 ;
V_12 = F_136 ( V_28 , V_264 , V_282 , V_77 , 0 ,
F_140 , V_103 ) ;
return V_12 ;
}
...
T_1 V_261 ;
V_283 = V_103 -> V_160 >> 8 ;
V_261 = F_131 ( & V_28 -> V_161 , V_103 ) ;
V_79 = ( 1ULL << V_284 |
( ( T_2 ) V_261 << V_285 ) |
( V_283 << V_286 ) |
( V_103 -> V_154 - 1 ) ) ;
V_79 = F_138 ( V_79 ) ;
return F_139 ( V_2 , V_272 , & V_79 , V_218 ) ;
}
...
static int F_147 ( void * V_277 , struct V_242 * V_278 ,
struct V_242 * V_279 )
{
struct V_34 * V_290 = F_47 ( V_278 , struct V_34 , V_159 ) ;
struct V_34 * V_291 = F_47 ( V_279 , struct V_34 , V_159 ) ;
if ( V_290 -> V_35 < V_291 -> V_35 )
return - 1 ;
else
return 1 ;
}
...
{
const struct V_26 * V_32 = F_16 ( V_28 ) ;
int V_292 = V_130 * ( V_133 / V_32 -> V_218 ) ;
T_2 V_268 = * ( T_2 * ) V_69 ;
int V_218 = V_32 -> V_218 ;
T_4 V_269 ;
int V_12 ;
...
return 1 ;
V_269 = V_268 & V_294 ;
V_12 = F_136 ( V_28 , V_269 , V_133 , V_218 ,
V_292 , F_146 , NULL ) ;
if ( V_12 <= 0 )
return V_12 ;
return 1 ;
...
if ( V_129 & V_140 ) {
V_295 = V_298 ;
V_12 = F_136 ( V_28 , V_296 , V_132 , V_295 , 0 ,
F_149 , NULL ) ;
} else {
V_295 = V_32 -> V_218 ;
V_12 = F_136 ( V_28 , V_296 , V_132 , V_295 , 0 ,
...
V_269 = F_67 ( V_28 -> V_143 ) ;
if ( ! V_269 )
return 0 ;
V_282 = F_64 ( V_28 -> V_143 ) * V_133 ;
F_9 (collection, &its->collection_list, coll_list) {
V_12 = F_151 ( V_28 , V_42 , V_269 , V_219 ) ;
if ( V_12 )
return V_12 ;
V_269 += V_219 ;
V_304 += V_219 ;
...
V_12 = F_139 ( V_28 -> V_103 -> V_2 , V_269 , & V_79 , V_219 ) ;
return V_12 ;
}
...
struct V_245 * V_246 )
{
struct V_27 * V_28 = V_103 -> V_239 ;
int V_12 ;
switch ( V_246 -> V_307 ) {
case V_308 : {
T_2 T_10 * V_315 = ( T_2 T_10 * ) ( long ) V_246 -> V_69 ;
unsigned long type = ( unsigned long ) V_246 -> V_246 ;
T_2 V_69 ;
if ( type != V_309 )
return - V_113 ;
if ( F_161 ( & V_69 , V_315 , sizeof( V_69 ) ) )
return - V_316 ;
...
if ( F_163 ( V_71 , V_315 ) )
return - V_316 ;
return F_128 ( V_103 , V_246 , & V_71 , true ) ;
}
}
return - V_252 ;
}
...
if ( type != V_309 )
return - V_113 ;
if ( F_165 ( V_315 , & V_69 , sizeof( V_69 ) ) )
return - V_316 ;
break;
}
case V_314 : {
...
T_2 V_71 ;
int V_12 ;
V_12 = F_128 ( V_103 , V_246 , & V_71 , false ) ;
if ( V_12 )
return V_12 ;
return F_166 ( V_71 , V_315 ) ;
}
default:
return - V_252 ;
}
