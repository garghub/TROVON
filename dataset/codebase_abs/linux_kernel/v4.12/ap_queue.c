...
struct V_1 * F_46 ( T_1 V_6 , int V_87 )
{
struct V_1 * V_2 ;
V_2 = F_47 ( sizeof( * V_2 ) , V_88 ) ;
if ( ! V_2 )
return NULL ;
V_2 -> V_70 . V_71 . V_89 = F_43 ;
V_2 -> V_70 . V_71 . type = & V_90 ;
V_2 -> V_70 . V_87 = V_87 ;
if ( V_87 == V_91 )
V_2 -> V_70 . V_87 = V_92 ;
V_2 -> V_6 = V_6 ;
...
F_49 ( & V_2 -> V_42 ) ;
F_49 ( & V_2 -> V_43 ) ;
F_50 ( & V_2 -> V_36 , V_93 , ( unsigned long ) V_2 ) ;
return V_2 ;
}
void F_51 ( struct V_1 * V_2 , struct V_31 * V_33 )
{
V_2 -> V_33 = V_33 ;
F_34 ( & V_2 -> V_72 ) ;
V_29 ( F_30 ( V_2 , V_74 ) ) ;
...
void F_52 ( struct V_1 * V_2 , struct V_31 * V_32 )
{
F_53 ( ! V_32 -> V_41 ) ;
F_34 ( & V_2 -> V_72 ) ;
F_54 ( & V_32 -> V_39 , & V_2 -> V_43 ) ;
V_2 -> V_44 ++ ;
V_2 -> V_80 ++ ;
F_55 ( & V_2 -> V_52 -> V_80 ) ;
V_29 ( F_31 ( V_2 , V_74 ) ) ;
...
void F_56 ( struct V_1 * V_2 , struct V_31 * V_32 )
{
struct V_31 * V_94 ;
F_34 ( & V_2 -> V_72 ) ;
if ( ! F_44 ( & V_32 -> V_39 ) ) {
F_14 (tmp, &aq->pendingq, list)
if ( V_94 -> V_18 == V_32 -> V_18 ) {
V_2 -> V_40 -- ;
goto V_95;
}
V_2 -> V_44 -- ;
