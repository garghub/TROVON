...
int V_145 = 0 ;
if ( V_11 -> V_16 ) {
unsigned char V_16 = F_2 ( F_3 ( V_2 ) ) ;
unsigned char V_60 ;
...
return 0 ;
V_2 -> V_103 |= V_147 ;
V_2 -> V_148 -> V_149 = F_22 ;
V_2 -> V_148 -> V_150 = F_26 ;
V_2 -> V_148 -> V_151 = F_29 ;
V_2 -> V_148 -> V_152 = F_31 ;
return 1 ;
}
...
F_14 ( V_2 , V_14 ) ;
if ( V_146 ) {
V_2 -> V_148 -> V_149 = F_32 ;
V_2 -> V_148 -> V_150 = F_35 ;
V_2 -> V_148 -> V_151 = F_37 ;
V_2 -> V_148 -> V_152 = F_38 ;
}
return V_146 ;
}
...
static const int V_154 [ 8 ] = {
V_38 , 7 , 9 , 10 , 11 , 14 , 15 , 5
} ;
F_14 ( V_2 , V_155 << 5 ) ;
V_153 = ( F_2 ( F_94 ( V_2 ) ) >> 3 ) & 0x07 ;
V_37 = V_154 [ V_153 ] ;
F_14 ( V_2 , V_14 ) ;
return V_37 ;
}
...
V_2 -> V_37 = F_104 ( V_2 ) ;
F_15 ( V_2 ) ;
if ( V_2 -> V_37 == V_38 && ( V_2 -> V_103 & V_147 ) )
V_2 -> V_37 = F_104 ( V_2 ) ;
F_15 ( V_2 ) ;
if ( V_2 -> V_37 == V_38 )
V_2 -> V_37 = F_107 ( V_2 ) ;
...
static int F_109 ( struct V_1 * V_7 )
{
...
struct V_1 * F_111 ( unsigned long int V_130 ,
unsigned long int V_158 ,
int V_37 , int V_78 ,
struct V_67 * V_30 ,
int V_159 )
{
...
return NULL ;
V_30 = & V_167 -> V_30 ;
V_53 = F_114 ( V_30 , F_115 ( 24 ) ) ;
if ( V_53 ) {
F_116 ( V_30 , L_96 ) ;
V_78 = V_80 ;
}
}
V_148 = F_117 ( sizeof( struct V_160 ) , V_168 ) ;
if ( ! V_148 )
goto V_169;
V_11 = F_117 ( sizeof( struct V_10 ) , V_168 ) ;
if ( ! V_11 )
goto V_170;
V_7 = F_118 ( V_130 , V_37 , V_78 , V_148 ) ;
if ( ! V_7 )
goto V_171;
V_163 = F_76 ( V_130 , 3 , V_7 -> V_48 ) ;
if ( ! V_163 )
goto V_172;
memcpy ( V_148 , & V_173 , sizeof( struct V_160 ) ) ;
V_11 -> V_17 = 0xc ;
V_11 -> V_40 = ~ 0x10 ;
V_11 -> V_16 = 0 ;
V_11 -> V_57 = 0 ;
...
V_7 -> V_30 = V_30 ;
V_7 -> V_158 = V_158 ;
V_7 -> V_103 = V_132 | V_175 ;
V_7 -> V_13 = V_11 ;
if ( V_158 ) {
V_164 = F_76 ( V_158 , 3 , V_7 -> V_48 ) ;
if ( V_164 )
F_90 ( V_7 ) ;
}
if ( V_130 != 0x3bc ) {
V_165 = F_76 ( V_130 + 0x3 , 5 , V_7 -> V_48 ) ;
if ( V_165 )
if ( ! F_98 ( V_7 ) )
F_99 ( V_7 ) ;
}
...
F_91 ( V_7 ) ;
V_7 -> V_177 = ( V_7 -> V_103 & V_147 ) ? 8 : 3 ;
F_8 ( V_15 L_97 , V_7 -> V_48 , V_7 -> V_130 ) ;
if ( V_7 -> V_158 && V_11 -> V_16 )
F_8 ( V_178 L_98 , V_7 -> V_158 ) ;
if ( V_7 -> V_37 == V_179 ) {
V_7 -> V_37 = V_38 ;
F_108 ( V_7 ) ;
...
V_7 -> V_148 -> V_185 = F_62 ;
#ifdef F_121
V_7 -> V_148 -> V_186 = F_66 ;
#endif
if ( V_7 -> V_78 != V_80 ) {
F_8 ( V_178 L_100 , V_7 -> V_78 ) ;
V_7 -> V_103 |= V_187 ;
} else
F_8 ( V_178 L_101 ) ;
} else
...
F_8 ( V_178 L_104 ) ;
if ( V_161 != V_38 )
F_8 ( V_15 L_105 , V_7 -> V_48 , V_161 ) ;
if ( V_164 && ( V_7 -> V_103 & V_183 ) == 0 ) {
F_77 ( V_158 , 3 ) ;
V_164 = NULL ;
}
if ( V_165 && ( V_7 -> V_103 & V_147 ) == 0 ) {
F_77 ( V_130 + 3 , 5 ) ;
V_165 = NULL ;
}
if ( V_7 -> V_37 != V_38 ) {
if ( F_123 ( V_7 -> V_37 , V_194 ,
V_159 , V_7 -> V_48 , V_7 ) ) {
F_8 ( V_144 L_106
L_107 ,
V_7 -> V_48 , V_7 -> V_37 ) ;
...
void F_134 ( struct V_1 * V_7 )
{
struct V_10 * V_11 = V_7 -> V_13 ;
struct V_160 * V_148 = V_7 -> V_148 ;
F_135 ( V_7 ) ;
F_127 ( & V_195 ) ;
F_136 ( & V_11 -> V_174 ) ;
F_129 ( & V_195 ) ;
#if F_137 ( F_120 ) && F_137 ( F_61 )
if ( V_7 -> V_78 != V_80 )
F_126 ( V_7 -> V_78 ) ;
#endif
if ( V_7 -> V_37 != V_38 )
...
F_77 ( V_7 -> V_130 , 3 ) ;
if ( V_7 -> V_177 > 3 )
F_77 ( V_7 -> V_130 + 3 , V_7 -> V_177 - 3 ) ;
if ( V_7 -> V_103 & V_183 )
F_77 ( V_7 -> V_158 , 3 ) ;
#if F_137 ( F_120 ) && F_137 ( F_61 )
if ( V_11 -> V_77 )
F_139 ( V_7 -> V_12 -> V_30 , V_75 ,
V_11 -> V_77 ,
V_11 -> V_69 ) ;
#endif
F_132 ( V_7 -> V_13 ) ;
...
static int F_140 ( struct V_197 * V_167 , int V_198 , int V_199 ,
...
F_142 ( V_167 , 0x3c , & V_206 ) ;
F_143 ( V_167 , 0x1c , & V_204 ) ;
V_204 &= 0x0000ff00 ;
F_143 ( V_167 , 0x20 , & V_205 ) ;
V_205 &= 0x0000ff00 ;
F_141 ( V_167 , 0x6c , 0xe3000000 | V_204 ) ;
F_141 ( V_167 , 0x70 , 0xe3000000 | V_205 ) ;
F_141 ( V_167 , 0x80 , ( V_205 << 16 ) | V_204 ) ;
F_141 ( V_167 , 0x9c ,
V_203 | ( V_206 * 0x11111 ) ) ;
F_4 ( V_6 L_123 , V_206 ) ;
F_4 ( V_6 L_124 ,
...
V_37 = V_38 ;
F_77 ( V_202 [ V_60 ] , 32 ) ;
if ( F_111 ( V_204 , V_205 ,
V_37 , V_80 , & V_167 -> V_30 , 0 ) ) {
F_8 ( V_15
L_126 ,
V_204 ) ;
if ( V_37 != V_38 )
...
static int F_144 ( struct V_197 * V_167 , int V_198 , int V_199 ,
const struct V_200 * V_201 )
{
T_4 V_208 , V_209 , V_210 ;
T_4 V_211 = 0 ;
int V_78 , V_37 ;
...
F_142 ( V_167 , V_201 -> V_222 , & V_208 ) ;
V_208 |= V_201 -> V_223 ;
F_145 ( V_167 , V_201 -> V_222 , V_208 ) ;
...
F_142 ( V_167 , V_201 -> V_230 , & V_208 ) ;
V_37 = ( ( V_208 & V_231 ) >> 4 ) ;
if ( V_210 == V_219 ) {
F_142 ( V_167 , V_201 -> V_232 , & V_208 ) ;
V_78 = ( ( V_208 & V_233 ) >> 2 ) ;
} else
V_78 = V_80 ;
if ( V_198 == V_38 ) {
...
if ( F_111 ( V_212 , V_213 , V_37 , V_78 , & V_167 -> V_30 , 0 ) ) {
F_8 ( V_15
L_140 , V_212 ) ;
if ( V_37 != V_38 )
F_8 ( L_127 , V_37 ) ;
...
static int F_146 ( struct V_197 * V_30 ,
...
if ( V_235 )
return V_235 ;
V_238 = F_117 ( sizeof( struct V_237 ) , V_168 ) ;
if ( ! V_238 )
return - V_240 ;
if ( V_241 [ V_60 ] . V_242 &&
...
V_248 = F_148 ( V_30 , V_245 ) ;
V_249 = 0 ;
if ( ( V_247 >= 0 ) && ( V_247 <= 6 ) )
V_249 = F_148 ( V_30 , V_247 ) ;
else if ( V_247 > 6 )
V_248 += V_247 ;
V_37 = V_30 -> V_37 ;
if ( V_37 == V_250 ) {
F_8 ( V_6
L_143 ,
V_117 -> V_251 , V_117 -> V_67 , V_248 , V_249 ) ;
V_37 = V_38 ;
} else {
F_8 ( V_6
L_144 ,
V_117 -> V_251 , V_117 -> V_67 , V_248 , V_249 , V_37 ) ;
}
V_238 -> V_252 [ V_76 ] =
F_111 ( V_248 , V_249 , V_37 ,
V_80 , & V_30 -> V_30 ,
V_253 ) ;
if ( V_238 -> V_252 [ V_76 ] )
V_76 ++ ;
...
static void F_150 ( struct V_197 * V_30 )
{
struct V_237 * V_238 = F_151 ( V_30 ) ;
int V_60 ;
if ( V_238 ) {
for ( V_60 = V_238 -> V_254 - 1 ; V_60 >= 0 ; V_60 -- )
F_134 ( V_238 -> V_252 [ V_60 ] ) ;
F_132 ( V_238 ) ;
}
}
static int T_7 F_152 ( int V_198 , int V_199 )
{
const struct V_234 * V_117 ;
struct V_197 * V_167 = NULL ;
int V_53 = 0 ;
F_153 (pdev) {
V_117 = F_154 ( V_256 , V_167 ) ;
if ( V_117 == NULL || V_117 -> V_236 >= V_239 )
continue;
if ( V_257 [ V_117 -> V_236 ] . F_155 (
V_167 , V_198 , V_199 ,
...
static int F_156 ( struct V_258 * V_30 ,
...
V_78 = V_80 ;
F_166 ( & V_30 -> V_30 , L_145 , V_30 -> V_263 -> V_48 ) ;
V_260 = F_111 ( V_248 , V_249 , V_37 , V_78 , & V_30 -> V_30 , 0 ) ;
if ( V_260 == NULL )
return - V_243 ;
F_167 ( V_30 , V_260 ) ;
return 0 ;
}
static void F_168 ( struct V_258 * V_30 )
{
struct V_1 * V_260 = (struct V_1 * ) F_169 ( V_30 ) ;
if ( ! V_260 )
return;
F_134 ( V_260 ) ;
}
static int F_170 ( struct V_166 * V_167 )
{
return 0 ;
}
static void T_7 F_171 ( int V_198 , int V_199 )
{
int V_76 = 0 , V_235 ;
#ifdef F_172
F_82 () ;
...
static int T_7 F_176 ( const char * V_32 , int * V_268 ,
...
* V_268 = V_270 ;
else if ( V_271 && ! strncmp ( V_32 , L_148 , 6 ) )
* V_268 = V_271 ;
else {
char * V_272 ;
unsigned long V_28 = F_177 ( V_32 , & V_272 , 0 ) ;
if ( V_272 != V_32 )
* V_268 = V_28 ;
else {
F_8 ( V_273 L_149 , V_32 ) ;
return - 1 ;
}
}
return 0 ;
}
static int T_7 F_178 ( const char * V_274 , int * V_268 )
{
return F_176 ( V_274 , V_268 , V_179 ,
V_38 , 0 ) ;
}
static int T_7 F_179 ( const char * V_275 , int * V_268 )
{
return F_176 ( V_275 , V_268 , V_181 ,
V_80 , V_182 ) ;
}
static int T_7 F_180 ( char * V_276 )
{
F_8 ( V_6
L_150 , V_276 ) ;
...
if ( F_178 ( V_37 [ V_60 ] , & V_268 ) )
return 1 ;
V_279 [ V_60 ] = V_268 ;
if ( F_179 ( V_78 [ V_60 ] , & V_268 ) )
return 1 ;
V_280 [ V_60 ] = V_268 ;
}
if ( ! V_95 [ 0 ] ) {
if ( V_37 [ 0 ] && ! F_178 ( V_37 [ 0 ] , & V_268 ) )
switch ( V_268 ) {
case V_38 :
case V_179 :
V_279 [ 0 ] = V_268 ;
...
static int T_7 F_183 ( char * V_276 )
{
char * V_281 ;
char * V_282 ;
int V_268 ;
...
if ( ! strncmp ( V_276 , L_146 , 4 ) ) {
V_279 [ 0 ] = V_179 ;
V_280 [ 0 ] = V_181 ;
return 1 ;
}
V_268 = F_177 ( V_276 , & V_281 , 0 ) ;
if ( V_281 == V_276 ) {
F_8 ( V_144 L_160 , V_276 ) ;
return 1 ;
}
if ( V_284 == V_278 ) {
F_8 ( V_273 L_161 , V_276 ) ;
return 1 ;
}
V_95 [ V_284 ] = V_268 ;
V_279 [ V_284 ] = V_38 ;
...
V_282 = strchr ( V_276 , ',' ) ;
if ( V_282 ++ ) {
if ( F_178 ( V_282 , & V_268 ) )
return 1 ;
V_279 [ V_284 ] = V_268 ;
V_282 = strchr ( V_282 , ',' ) ;
if ( V_282 ++ ) {
if ( F_179 ( V_282 , & V_268 ) )
return 1 ;
V_280 [ V_284 ] = V_268 ;
}
}
...
F_111 ( V_95 [ V_60 ] , V_249 [ V_60 ] ,
V_279 [ V_60 ] , V_280 [ V_60 ] , NULL , 0 ) ;
}
} else
F_171 ( V_279 [ 0 ] , V_280 [ 0 ] ) ;
return 0 ;
}
...
struct V_1 * V_36 ;
struct V_67 * V_30 ;
V_11 = F_191 ( V_196 . V_287 ,
struct V_10 , V_174 ) ;
V_36 = V_11 -> V_36 ;
V_30 = V_36 -> V_30 ;
F_134 ( V_36 ) ;
if ( V_30 && V_30 -> V_288 == & V_289 )
F_133 ( F_192 ( V_30 ) ) ;
}
}
