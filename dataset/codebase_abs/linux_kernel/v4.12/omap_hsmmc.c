...
static struct V_152 * F_61 ( struct V_3 * V_4 ,
struct V_128 * V_129 )
{
return V_129 -> V_50 & V_153 ? V_4 -> V_154 : V_4 -> V_155 ;
}
static void F_62 ( struct V_3 * V_4 , struct V_156 * V_138 )
{
int V_157 ;
unsigned long V_50 ;
F_36 ( & V_4 -> V_57 , V_50 ) ;
...
F_37 ( & V_4 -> V_57 , V_50 ) ;
F_38 ( V_4 ) ;
if ( V_138 -> V_129 && V_4 -> V_51 && V_157 != - 1 )
return;
V_4 -> V_138 = NULL ;
F_63 ( V_4 -> V_5 , V_138 ) ;
}
static void
F_64 ( struct V_3 * V_4 , struct V_128 * V_129 )
{
if ( ! V_129 ) {
struct V_156 * V_138 = V_4 -> V_138 ;
...
V_4 -> V_129 = NULL ;
if ( ! V_129 -> error )
V_129 -> V_158 += V_129 -> V_159 * ( V_129 -> V_160 ) ;
else
V_129 -> V_158 = 0 ;
if ( V_129 -> V_139 && ( V_129 -> error || ! V_4 -> V_138 -> V_141 ) )
F_58 ( V_4 , V_129 -> V_139 , NULL ) ;
else
F_62 ( V_4 , V_129 -> V_138 ) ;
}
static void
F_65 ( struct V_3 * V_4 , struct V_46 * V_47 )
{
...
if ( V_47 -> V_50 & V_135 ) {
if ( V_47 -> V_50 & V_136 ) {
V_47 -> V_161 [ 3 ] = F_33 ( V_4 -> V_43 , V_162 ) ;
V_47 -> V_161 [ 2 ] = F_33 ( V_4 -> V_43 , V_163 ) ;
V_47 -> V_161 [ 1 ] = F_33 ( V_4 -> V_43 , V_164 ) ;
V_47 -> V_161 [ 0 ] = F_33 ( V_4 -> V_43 , V_165 ) ;
} else {
V_47 -> V_161 [ 0 ] = F_33 ( V_4 -> V_43 , V_162 ) ;
}
}
if ( ( V_4 -> V_129 == NULL && ! V_4 -> V_134 ) || V_47 -> error )
F_62 ( V_4 , V_4 -> V_138 ) ;
}
static void F_67 ( struct V_3 * V_4 , int V_166 )
{
int V_157 ;
unsigned long V_50 ;
V_4 -> V_129 -> error = V_166 ;
F_36 ( & V_4 -> V_57 , V_50 ) ;
V_157 = V_4 -> V_157 ;
V_4 -> V_157 = - 1 ;
F_37 ( & V_4 -> V_57 , V_50 ) ;
if ( V_4 -> V_51 && V_157 != - 1 ) {
struct V_152 * V_167 = F_61 ( V_4 , V_4 -> V_129 ) ;
F_68 ( V_167 ) ;
F_69 ( V_167 -> V_1 -> V_2 ,
V_4 -> V_129 -> V_168 , V_4 -> V_129 -> V_169 ,
F_70 ( V_4 -> V_129 ) ) ;
V_4 -> V_129 -> V_170 = 0 ;
}
V_4 -> V_129 = NULL ;
...
char * V_125 = V_172 ;
int V_173 , V_174 ;
V_173 = sprintf ( V_125 , L_43 , V_16 ) ;
V_125 += V_173 ;
for ( V_174 = 0 ; V_174 < F_72 ( V_171 ) ; V_174 ++ )
if ( V_16 & ( 1 << V_174 ) ) {
V_173 = sprintf ( V_125 , L_44 , V_171 [ V_174 ] ) ;
V_125 += V_173 ;
}
F_43 ( F_10 ( V_4 -> V_5 ) , L_20 , V_172 ) ;
}
...
F_32 ( V_4 -> V_43 , V_44 ,
F_33 ( V_4 -> V_43 , V_44 ) | V_175 ) ;
if ( F_16 ( V_4 ) -> V_77 & V_178 ) {
while ( ( ! ( F_33 ( V_4 -> V_43 , V_44 ) & V_175 ) )
&& ( V_174 ++ < V_176 ) )
F_74 ( 1 ) ;
}
V_174 = 0 ;
...
F_73 ( V_4 , V_182 ) ;
if ( V_4 -> V_47 )
V_4 -> V_47 -> error = V_180 ;
}
if ( V_4 -> V_129 ) {
F_73 ( V_4 , V_183 ) ;
F_67 ( V_4 , V_180 ) ;
} else if ( V_4 -> V_138 && V_4 -> V_138 -> V_47 )
V_4 -> V_138 -> V_47 -> error = V_180 ;
}
...
if ( V_16 & ( V_186 | V_56 ) )
F_75 ( V_4 , - V_189 , V_181 ) ;
else if ( V_16 & ( V_187 | V_190 | V_191 | V_188 |
V_192 ) )
F_75 ( V_4 , - V_193 , V_181 ) ;
if ( V_16 & V_194 ) {
T_1 V_195 ;
V_195 = F_33 ( V_4 -> V_43 , V_196 ) ;
if ( ! ( V_195 & V_197 ) && V_4 -> V_138 -> V_141 ) {
V_181 = 1 ;
if ( V_195 & V_198 )
error = - V_189 ;
...
F_75 ( V_4 , error , V_181 ) ;
}
F_24 ( F_10 ( V_4 -> V_5 ) , L_47 , V_195 ) ;
}
}
F_32 ( V_4 -> V_43 , V_58 , V_16 ) ;
if ( V_181 || ( ( V_16 & V_121 ) && V_4 -> V_47 ) )
F_65 ( V_4 , V_4 -> V_47 ) ;
if ( ( V_184 || ( V_16 & V_202 ) ) && V_4 -> V_138 )
F_64 ( V_4 , V_129 ) ;
}
static T_4 F_77 ( int V_117 , void * V_203 )
{
...
goto V_180;
F_32 ( V_4 -> V_43 , V_84 ,
F_33 ( V_4 -> V_43 , V_84 ) & V_208 ) ;
V_206 = F_33 ( V_4 -> V_43 , V_84 ) ;
if ( ( 1 << V_12 ) <= V_106 )
V_206 |= V_107 ;
else
V_206 |= V_108 ;
F_32 ( V_4 -> V_43 , V_84 , V_206 ) ;
F_79 ( V_4 ) ;
return 0 ;
V_180:
...
static T_4 V_39 ( int V_117 , void * V_203 )
{
struct V_3 * V_4 = V_203 ;
F_85 ( & V_4 -> V_5 -> V_126 . V_210 , NULL , L_53 ) ;
F_83 ( V_4 ) ;
F_86 ( V_4 -> V_5 , ( V_211 * 200 ) / 1000 ) ;
return V_204 ;
}
...
V_167 = F_61 ( V_4 , V_129 ) ;
if ( ! V_129 -> V_170 )
F_69 ( V_167 -> V_1 -> V_2 ,
V_129 -> V_168 , V_129 -> V_169 ,
F_70 ( V_129 ) ) ;
V_150 = V_4 -> V_150 ;
V_4 -> V_157 = - 1 ;
F_89 ( & V_4 -> V_57 ) ;
...
{
int V_215 ;
if ( ! V_214 && V_129 -> V_170 &&
V_129 -> V_170 != V_4 -> V_216 . V_217 ) {
F_91 ( V_4 -> V_2 , L_54
L_55 ,
V_179 , V_129 -> V_170 , V_4 -> V_216 . V_217 ) ;
V_129 -> V_170 = 0 ;
}
if ( V_214 || V_129 -> V_170 != V_4 -> V_216 . V_217 ) {
V_215 = F_92 ( V_167 -> V_1 -> V_2 , V_129 -> V_168 , V_129 -> V_169 ,
F_70 ( V_129 ) ) ;
} else {
...
if ( V_214 ) {
V_214 -> V_215 = V_215 ;
V_129 -> V_170 = ++ V_214 -> V_217 < 0 ? 1 : V_214 -> V_217 ;
} else
V_4 -> V_215 = V_215 ;
return 0 ;
}
...
struct V_220 * V_221 ;
int V_7 = 0 , V_174 ;
struct V_128 * V_129 = V_219 -> V_129 ;
struct V_152 * V_167 ;
struct V_222 V_223 = {
. V_224 = V_4 -> V_225 + V_226 ,
. V_227 = V_4 -> V_225 + V_226 ,
. V_228 = V_229 ,
. V_230 = V_229 ,
. V_231 = V_129 -> V_160 / 4 ,
. V_232 = V_129 -> V_160 / 4 ,
} ;
for ( V_174 = 0 ; V_174 < V_129 -> V_169 ; V_174 ++ ) {
struct V_233 * V_234 ;
V_234 = V_129 -> V_168 + V_174 ;
if ( V_234 -> V_235 % V_129 -> V_160 )
return - V_218 ;
}
if ( ( V_129 -> V_160 % 4 ) != 0 )
return - V_218 ;
F_94 ( V_4 -> V_157 != - 1 ) ;
V_167 = F_61 ( V_4 , V_129 ) ;
V_7 = F_95 ( V_167 , & V_223 ) ;
if ( V_7 )
return V_7 ;
V_7 = F_90 ( V_4 , V_129 , NULL , V_167 ) ;
if ( V_7 )
return V_7 ;
V_221 = F_96 ( V_167 , V_129 -> V_168 , V_129 -> V_169 ,
V_129 -> V_50 & V_153 ? V_236 : V_237 ,
V_238 | V_239 ) ;
if ( ! V_221 ) {
...
unsigned int V_243 )
{
unsigned long long V_68 = V_242 ;
unsigned int V_244 ;
T_5 V_29 , V_245 , V_246 = 0 ;
V_29 = F_33 ( V_4 -> V_43 , V_44 ) ;
V_245 = ( V_29 & V_70 ) >> V_247 ;
if ( V_245 == 0 )
V_245 = 1 ;
V_244 = 1000000000 / ( V_4 -> V_248 / V_245 ) ;
F_99 ( V_68 , V_244 ) ;
V_68 += V_243 ;
if ( V_68 ) {
...
{
struct V_156 * V_219 = V_4 -> V_138 ;
struct V_152 * V_167 ;
if ( ! V_219 -> V_129 )
return;
F_32 ( V_4 -> V_43 , V_250 , ( V_219 -> V_129 -> V_160 )
| ( V_219 -> V_129 -> V_159 << 16 ) ) ;
F_98 ( V_4 , V_219 -> V_129 -> V_242 ,
V_219 -> V_129 -> V_243 ) ;
V_167 = F_61 ( V_4 , V_219 -> V_129 ) ;
F_100 ( V_167 ) ;
}
static int
F_101 ( struct V_3 * V_4 , struct V_156 * V_219 )
{
int V_7 ;
unsigned long long V_68 ;
V_4 -> V_129 = V_219 -> V_129 ;
if ( V_219 -> V_129 == NULL ) {
F_32 ( V_4 -> V_43 , V_250 , 0 ) ;
if ( V_219 -> V_47 -> V_50 & V_137 ) {
V_68 = V_219 -> V_47 -> V_251 * V_252 ;
if ( ! V_68 )
V_68 = 100000000U ;
F_98 ( V_4 , V_68 , 0 ) ;
}
...
static void F_102 ( struct V_6 * V_5 , struct V_156 * V_138 ,
int V_180 )
{
struct V_3 * V_4 = F_6 ( V_5 ) ;
struct V_128 * V_129 = V_138 -> V_129 ;
if ( V_4 -> V_51 && V_129 -> V_170 ) {
struct V_152 * V_253 = F_61 ( V_4 , V_129 ) ;
F_69 ( V_253 -> V_1 -> V_2 , V_129 -> V_168 , V_129 -> V_169 ,
F_70 ( V_129 ) ) ;
V_129 -> V_170 = 0 ;
}
}
static void F_103 ( struct V_6 * V_5 , struct V_156 * V_138 )
{
struct V_3 * V_4 = F_6 ( V_5 ) ;
if ( V_138 -> V_129 -> V_170 ) {
V_138 -> V_129 -> V_170 = 0 ;
return ;
}
if ( V_4 -> V_51 ) {
struct V_152 * V_253 = F_61 ( V_4 , V_138 -> V_129 ) ;
if ( F_90 ( V_4 , V_138 -> V_129 ,
& V_4 -> V_216 , V_253 ) )
V_138 -> V_129 -> V_170 = 0 ;
}
}
static void F_104 ( struct V_6 * V_5 , struct V_156 * V_219 )
{
struct V_3 * V_4 = F_6 ( V_5 ) ;
int V_180 ;
F_94 ( V_4 -> V_150 ) ;
...
V_219 -> V_47 -> error = - V_254 ;
if ( V_219 -> V_129 )
V_219 -> V_129 -> error = - V_254 ;
V_219 -> V_47 -> V_255 = 0 ;
F_63 ( V_5 , V_219 ) ;
return;
} else if ( V_4 -> V_209 )
...
V_4 -> V_138 = V_219 ;
V_4 -> V_248 = F_41 ( V_4 -> V_65 ) ;
V_180 = F_101 ( V_4 , V_219 ) ;
if ( V_180 ) {
V_219 -> V_47 -> error = V_180 ;
if ( V_219 -> V_129 )
V_219 -> V_129 -> error = V_180 ;
V_4 -> V_138 = NULL ;
F_63 ( V_5 , V_219 ) ;
return;
}
if ( V_219 -> V_141 && ! ( V_4 -> V_50 & V_140 ) ) {
F_58 ( V_4 , V_219 -> V_141 , NULL ) ;
return;
}
F_66 ( V_4 ) ;
F_58 ( V_4 , V_219 -> V_47 , V_219 -> V_129 ) ;
}
...
static void F_108 ( struct V_6 * V_5 , struct V_262 * V_263 )
{
struct V_3 * V_4 = F_6 ( V_5 ) ;
if ( F_16 ( V_4 ) -> V_264 )
F_16 ( V_4 ) -> V_264 ( V_263 ) ;
}
static void F_109 ( struct V_6 * V_5 , int V_265 )
{
struct V_3 * V_4 = F_6 ( V_5 ) ;
T_1 V_48 , V_86 ;
unsigned long V_50 ;
...
return - V_31 ;
V_7 = F_111 ( V_4 -> V_2 , V_4 -> V_268 ) ;
if ( V_7 ) {
F_9 ( F_10 ( V_4 -> V_5 ) , L_59 ) ;
goto V_180;
}
if ( V_4 -> V_36 -> V_102 & V_269 ) {
struct V_270 * V_271 = F_112 ( V_4 -> V_2 ) ;
if ( F_22 ( V_271 ) ) {
V_7 = F_23 ( V_271 ) ;
goto V_272;
}
if ( F_22 ( F_113 ( V_271 , V_273 ) ) ) {
F_84 ( V_4 -> V_2 , L_60 ) ;
F_114 ( V_271 ) ;
V_7 = - V_218 ;
goto V_272;
}
if ( F_22 ( F_113 ( V_271 , V_274 ) ) ) {
F_84 ( V_4 -> V_2 , L_61 ) ;
F_114 ( V_271 ) ;
V_7 = - V_218 ;
goto V_272;
...
static int F_117 ( struct V_262 * V_263 ,
...
static int F_118 ( struct V_279 * V_280 , void * V_129 )
{
struct V_6 * V_5 = V_280 -> V_281 ;
struct V_3 * V_4 = F_6 ( V_5 ) ;
F_119 ( V_280 , L_63 , V_5 -> V_282 ) ;
F_119 ( V_280 , L_64 ,
...
static int F_124 ( struct V_284 * V_284 , struct V_285 * V_285 )
{
return F_125 ( V_285 , F_118 , V_284 -> V_286 ) ;
}
static void F_126 ( struct V_6 * V_5 )
{
if ( V_5 -> V_287 )
F_127 ( L_79 , V_288 , V_5 -> V_287 ,
V_5 , & V_289 ) ;
}
static void F_126 ( struct V_6 * V_5 )
{
...
V_36 = F_129 ( V_2 , sizeof( * V_36 ) , V_293 ) ;
if ( ! V_36 )
return F_130 ( - V_294 ) ;
V_290 = F_131 ( V_2 ) ;
if ( V_290 && V_290 -> V_127 )
V_36 -> V_127 = V_290 -> V_127 ;
if ( F_132 ( V_292 , L_80 , NULL ) )
V_36 -> V_102 |= V_103 ;
V_36 -> V_40 = - V_218 ;
V_36 -> V_37 = - V_218 ;
V_36 -> V_42 = - V_218 ;
if ( F_132 ( V_292 , L_81 , NULL ) ) {
V_36 -> V_295 = true ;
V_36 -> V_34 = true ;
}
if ( F_132 ( V_292 , L_82 , NULL ) )
V_36 -> V_77 |= V_178 ;
if ( F_132 ( V_292 , L_83 , NULL ) )
V_36 -> V_77 |= V_78 ;
return V_36 ;
}
...
static int F_133 ( struct V_296 * V_297 )
{
...
void T_6 * V_43 ;
V_301 = F_134 ( F_135 ( V_303 ) , & V_297 -> V_2 ) ;
if ( V_301 ) {
V_36 = F_128 ( & V_297 -> V_2 ) ;
if ( F_22 ( V_36 ) )
return F_23 ( V_36 ) ;
if ( V_301 -> V_129 ) {
V_129 = V_301 -> V_129 ;
...
V_172 = F_136 ( V_297 , V_306 , 0 ) ;
V_117 = F_137 ( V_297 , 0 ) ;
if ( V_172 == NULL || V_117 < 0 )
return - V_305 ;
V_43 = F_138 ( & V_297 -> V_2 , V_172 ) ;
if ( F_22 ( V_43 ) )
return F_23 ( V_43 ) ;
V_5 = F_139 ( sizeof( struct V_3 ) , & V_297 -> V_2 ) ;
if ( ! V_5 ) {
V_7 = - V_294 ;
goto V_180;
}
...
V_4 -> V_157 = - 1 ;
V_4 -> V_117 = V_117 ;
V_4 -> V_225 = V_172 -> V_308 + V_36 -> V_304 ;
...
F_141 ( V_297 , V_4 ) ;
if ( V_297 -> V_2 . V_32 )
V_4 -> V_268 = F_142 ( V_297 -> V_2 . V_32 , 1 ) ;
V_5 -> V_310 = & V_311 ;
V_5 -> V_312 = V_313 ;
if ( V_36 -> V_314 > 0 )
...
F_145 ( & V_297 -> V_2 , true ) ;
F_146 ( V_4 -> V_2 ) ;
F_120 ( V_4 -> V_2 ) ;
F_147 ( V_4 -> V_2 , V_319 ) ;
F_148 ( V_4 -> V_2 ) ;
F_50 ( V_4 ) ;
V_4 -> V_207 = F_144 ( & V_297 -> V_2 , L_87 ) ;
if ( F_22 ( V_4 -> V_207 ) ) {
V_4 -> V_207 = NULL ;
} else if ( F_82 ( V_4 -> V_207 ) != 0 ) {
...
F_116 ( V_4 ) ;
V_4 -> V_155 = F_149 ( & V_297 -> V_2 , L_89 ) ;
if ( F_22 ( V_4 -> V_155 ) ) {
F_9 ( F_10 ( V_4 -> V_5 ) , L_90 ) ;
V_7 = F_23 ( V_4 -> V_155 ) ;
goto V_333;
}
V_4 -> V_154 = F_149 ( & V_297 -> V_2 , L_91 ) ;
if ( F_22 ( V_4 -> V_154 ) ) {
F_9 ( F_10 ( V_4 -> V_5 ) , L_92 ) ;
V_7 = F_23 ( V_4 -> V_154 ) ;
goto V_333;
}
V_7 = F_150 ( & V_297 -> V_2 , V_4 -> V_117 , F_77 , 0 ,
F_59 ( V_5 ) , V_4 ) ;
if ( V_7 ) {
...
static int F_160 ( struct V_296 * V_297 )
{
struct V_3 * V_4 = F_161 ( V_297 ) ;
F_120 ( V_4 -> V_2 ) ;
F_153 ( V_4 -> V_5 ) ;
F_155 ( V_4 -> V_154 ) ;
F_155 ( V_4 -> V_155 ) ;
...
F_32 ( V_4 -> V_43 , V_60 , 0 ) ;
F_32 ( V_4 -> V_43 , V_63 , 0 ) ;
if ( ! ( F_33 ( V_4 -> V_43 , V_283 ) & F_166 ( 1 ) ) ) {
F_24 ( V_2 , L_95 ) ;
F_32 ( V_4 -> V_43 , V_58 , V_59 ) ;
