...
return F_132 ( V_205 , V_2 , V_110 , & V_212 ) ;
}
V_102 = F_115 ( V_167 [ V_128 ] , & V_24 ) ;
if ( V_102 < 0 )
return V_102 ;
...
V_29 = F_102 ( V_178 ) ;
V_102 = - V_170 ;
V_208 = F_80 ( V_215 , V_169 ) ;
if ( V_208 == NULL ) {
F_85 ( V_29 ) ;
return - V_170 ;
}
F_8 () ;
V_102 = F_56 ( V_208 , F_106 ( V_2 ) . V_108 , V_110 -> V_188 ,
F_107 ( V_110 -> V_189 ) , V_29 ) ;
F_11 () ;
F_85 ( V_29 ) ;
if ( V_102 <= 0 )
goto free;
V_102 = F_133 ( V_205 , V_208 , F_106 ( V_2 ) . V_108 , V_216 ) ;
if ( V_102 < 0 )
goto V_43;
return 0 ;
free:
...
static int
F_135 ( struct V_1 * V_2 , struct V_163 * V_164 , bool V_217 )
{
struct V_28 * V_29 , * V_176 ;
struct V_177 * V_178 ;
struct V_179 * V_180 ;
...
return 0 ;
V_176 = (struct V_28 * ) V_164 -> args [ 1 ] ;
for ( V_218 = V_164 -> args [ 0 ] ; V_218 < V_221 ; V_218 ++ ) {
struct V_222 * V_223 ;
if ( ! F_136 ( V_218 ) )
continue;
V_223 = F_137 ( V_141 -> V_29 . V_224 , V_218 ) ;
F_51 ( & V_223 -> V_100 ) ;
V_220 = V_217 ? & V_223 -> V_217 : & V_223 -> V_225 ;
V_185:
...
static void
F_148 ( struct V_28 * V_29 , unsigned long V_230 ,
unsigned long V_231 )
{
unsigned int V_232 ;
V_230 &= ~ V_233 ;
V_231 &= ~ V_233 ;
for ( V_232 = 0 ; V_232 < V_234 ; V_232 ++ ) {
if ( V_230 & ( 1 << V_232 ) )
F_149 ( V_232 , & V_29 -> V_31 ) ;
else if ( V_231 & ( 1 << V_232 ) )
F_150 ( V_232 , & V_29 -> V_31 ) ;
}
}
static int
...
V_235 = V_29 -> V_31 ^ V_31 ;
if ( V_235 & ( V_87 | V_236 | V_237 ) )
return - V_238 ;
if ( V_235 & V_239 && ! ( V_31 & V_239 ) )
return - V_238 ;
if ( V_235 & V_240 && ! ( V_31 & V_240 ) )
return - V_238 ;
F_148 ( V_29 , V_31 , 0 ) ;
return 0 ;
}
...
#ifdef F_74
int V_7 ;
if ( ! V_167 [ V_241 ] && ! V_167 [ V_242 ] )
return 0 ;
V_7 = F_142 ( V_29 , V_243 ,
V_167 [ V_241 ] ) ;
if ( V_7 < 0 )
return V_7 ;
V_7 = F_142 ( V_29 , V_244 ,
V_167 [ V_242 ] ) ;
return V_7 ;
#else
if ( ! V_167 [ V_241 ] && ! V_167 [ V_242 ] )
...
int V_102 ;
V_102 = F_121 ( V_167 [ V_44 ] , & V_245 , & V_200 ) ;
if ( V_102 < 0 )
return V_102 ;
if ( V_29 -> V_246 ) {
V_102 = - V_238 ;
...
F_8 () ;
V_42 = F_25 ( V_40 -> V_42 ) ;
if ( V_42 && ! strcmp ( V_42 -> V_46 , V_245 ) )
V_102 = 0 ;
F_11 () ;
}
return V_102 ;
...
V_29 -> V_32 = V_248 + V_32 * V_33 ;
if ( F_158 ( V_249 , & V_29 -> V_31 ) )
return - V_250 ;
return 0 ;
}
...
struct V_8 * V_190 [ V_251 + 1 ] ;
struct V_5 * V_6 ;
int V_102 = 0 ;
V_102 = F_111 ( V_190 , V_251 , V_51 , V_252 ,
NULL ) ;
if ( V_102 < 0 )
return V_102 ;
F_8 () ;
...
{
int V_102 ;
struct V_8 * V_167 [ V_253 + 1 ] ;
V_102 = F_111 ( V_167 , V_253 , V_51 , V_254 , NULL ) ;
if ( V_102 < 0 )
return V_102 ;
if ( ! V_167 [ V_91 ] )
return - V_196 ;
...
const void * V_172 = V_167 [ V_256 ] ;
if ( V_77 & ( sizeof( T_2 ) - 1 ) )
return - V_196 ;
if ( V_172 ) {
if ( F_164 ( V_167 [ V_256 ] ) == 0 ||
F_164 ( V_167 [ V_256 ] ) != V_77 )
return - V_196 ;
V_172 = F_122 ( V_167 [ V_256 ] ) ;
}
V_77 /= sizeof( T_2 ) ;
...
{
int V_102 ;
if ( V_167 [ V_242 ] || V_167 [ V_241 ] || V_167 [ V_88 ] )
return - V_174 ;
if ( V_167 [ V_44 ] ) {
...
struct V_41 * V_42 ;
struct V_66 * V_67 ;
V_29 = F_169 ( V_141 , V_24 , V_257 , V_258 , V_153 ) ;
if ( F_124 ( V_29 ) )
return F_89 ( - V_170 ) ;
if ( ! V_167 [ V_34 ] )
goto V_259;
V_29 -> V_32 = V_248 + F_90 ( F_91 ( V_167 [ V_34 ] ) ) * V_33 ;
F_8 () ;
if ( V_167 [ V_44 ] ) {
char * V_245 = NULL ;
struct V_8 * V_200 = NULL ;
...
memset ( & V_29 -> V_261 , 0 , sizeof( V_29 -> V_261 ) ) ;
if ( V_167 [ V_37 ] ) {
V_102 = F_159 ( V_29 , V_167 ) ;
if ( V_102 < 0 )
goto V_260;
...
struct V_177 * V_262 ;
struct V_28 * V_263 ;
V_102 = F_120 ( V_167 , & V_246 , V_88 ,
V_206 , NULL ) ;
if ( V_102 < 0 )
goto V_260;
V_262 = F_129 ( V_141 , V_24 , & V_246 ) ;
if ( V_262 == NULL ) {
V_102 = - V_207 ;
goto V_260;
}
V_263 = F_102 ( V_262 ) ;
F_178 ( V_264 , & V_29 -> V_31 ) ;
V_29 -> V_246 = V_263 ;
}
V_67 = F_35 ( V_29 ) ;
if ( V_67 )
...
return V_102 ;
if ( V_167 [ V_123 ] ) {
V_102 = F_120 ( V_167 , & V_257 , V_123 ,
V_206 , & V_24 ) ;
if ( V_102 < 0 )
return V_102 ;
}
if ( V_167 [ V_126 ] ) {
V_102 = F_120 ( V_167 , & V_258 , V_126 ,
V_206 , & V_24 ) ;
if ( V_102 < 0 )
return V_102 ;
}
if ( V_167 [ V_123 ] )
V_178 = F_129 ( V_141 , & V_24 , & V_257 ) ;
else if ( V_167 [ V_126 ] )
V_178 = F_129 ( V_141 , & V_24 , & V_258 ) ;
if ( V_178 == NULL ) {
V_102 = - V_207 ;
if ( V_110 -> V_209 & V_148 ) {
enum V_265 V_138 ;
if ( ! V_167 [ V_123 ] || ! V_167 [ V_126 ] )
return - V_196 ;
if ( V_257 . V_14 . V_15 != V_258 . V_14 . V_15 )
return - V_196 ;
V_29 = F_168 ( V_141 , & V_24 , V_167 , & V_257 ,
& V_258 , V_206 ) ;
if ( F_124 ( V_29 ) )
return F_125 ( V_29 ) ;
V_102 = 0 ;
if ( F_158 ( V_264 , & V_29 -> V_31 ) )
V_138 = 1 << V_147 ;
else
V_138 = 1 << V_146 ;
if ( V_167 [ V_86 ] &&
...
T_6 V_218 , const struct V_269 * V_270 )
{
struct V_109 * V_110 ;
struct V_111 * V_112 ;
unsigned int V_113 = V_108 ? V_114 : 0 , V_115 ;
...
if ( F_16 ( V_2 , V_273 , F_17 ( V_270 -> V_274 ) ) ||
F_16 ( V_2 , V_275 , F_17 ( V_270 -> V_276 ) ) ||
F_16 ( V_2 , V_277 , F_17 ( V_270 -> V_278 ) ) ||
F_16 ( V_2 , V_279 , F_17 ( V_270 -> V_280 ) ) ||
F_16 ( V_2 , V_281 ,
F_17 ( V_270 -> V_282 ) ) ||
F_16 ( V_2 , V_283 , F_17 ( V_270 -> V_284 ) ) ||
F_16 ( V_2 , V_285 , F_17 ( V_270 -> V_286 ) ) ||
F_16 ( V_2 , V_287 , F_17 ( V_270 -> error ) ) ||
F_16 ( V_2 , V_288 ,
F_17 ( V_270 -> V_289 ) ) )
goto V_12;
F_62 ( V_2 , V_110 ) ;
...
int V_218 ;
struct V_141 * V_141 = F_94 ( V_2 -> V_175 ) ;
if ( V_164 -> args [ 0 ] == V_221 )
return 0 ;
for ( V_218 = V_164 -> args [ 0 ] ; V_218 < V_221 ; V_218 ++ ) {
const struct V_269 * V_270 ;
if ( ! F_136 ( V_218 ) )
continue;
V_270 = F_137 ( V_141 -> V_29 . V_290 , V_218 ) ;
if ( F_184 ( V_2 ,
...
struct V_111 * V_112 ;
unsigned int V_113 = V_108 ? V_114 : 0 , V_115 ;
unsigned int V_291 = F_55 ( & V_141 -> V_29 . V_292 ) ;
V_115 = F_57 ( V_116 , V_293 ) ;
V_110 = F_58 ( V_2 , V_108 , V_90 , V_115 , sizeof( * V_112 ) , V_113 ) ;
if ( V_110 == NULL )
goto V_118;
V_112 = F_59 ( V_110 ) ;
...
if ( V_208 == NULL )
return - V_170 ;
V_102 = F_187 ( V_208 , F_106 ( V_2 ) . V_108 ,
V_110 -> V_188 ,
F_107 ( V_110 -> V_189 ) ,
F_94 ( V_2 -> V_175 ) ) ;
if ( V_102 <= 0 )
...
enum V_295 V_296 ,
V_137 V_298 , V_137 V_299 )
{
struct V_8 * V_9 ;
V_9 = F_2 ( V_2 , V_298 | V_11 ) ;
if ( ! V_9 )
goto V_12;
if ( F_192 ( V_2 , V_29 ) < 0 )
goto V_12;
...
{
unsigned int V_31 = F_90 ( F_91 ( V_167 [ V_30 ] ) ) ;
unsigned long V_235 = V_29 -> V_31 ^ V_31 ;
if ( V_235 & V_239 && ! ( V_31 & V_239 ) )
return - V_238 ;
if ( V_235 & V_240 && ! ( V_31 & V_240 ) )
return - V_238 ;
...
{
struct V_8 * V_167 [ V_301 + 1 ] ;
int V_7 ;
V_7 = F_111 ( V_167 , V_301 , V_51 , V_302 , NULL ) ;
if ( V_7 < 0 )
return V_7 ;
...
{
int V_102 ;
V_102 = F_120 ( V_167 , V_4 , V_303 ,
F_21 ( V_29 ) , NULL ) ;
if ( V_102 < 0 )
return V_102 ;
return F_120 ( V_167 , V_172 , V_304 ,
F_21 ( V_29 ) , NULL ) ;
}
static int
...
T_2 V_108 , T_2 V_152 )
{
struct V_8 * V_167 [ V_305 + 1 ] ;
struct V_3 V_4 , V_172 ;
struct V_41 * V_42 = NULL ;
struct V_306 * exp ;
int V_102 ;
V_102 = F_111 ( V_167 , V_305 , V_51 , V_307 ,
NULL ) ;
if ( V_102 < 0 )
return V_102 ;
...
return V_102 ;
if ( V_167 [ V_308 ] ) {
const char * V_245 = F_122 ( V_167 [ V_308 ] ) ;
V_42 = F_156 ( V_245 , F_21 ( V_29 ) ,
F_22 ( V_29 ) ) ;
if ( V_42 == NULL )
return - V_174 ;
...
enum V_295 V_296 , int V_309 )
{
if ( ! ( V_29 -> V_31 & V_310 ) )
return;
F_203 ( V_2 , V_29 , V_296 , V_309 ) ;
}
...
struct V_3 V_312 ;
struct V_8 * V_9 ;
memset ( & V_312 , 0xFF , sizeof( V_312 ) ) ;
memcpy ( & V_312 . V_20 . V_206 , & V_172 -> V_20 . V_206 , sizeof( V_312 . V_20 . V_206 ) ) ;
V_312 . V_20 . V_313 . V_314 = V_172 -> V_20 . V_313 . V_314 ;
V_312 . V_14 . V_15 = V_4 -> V_14 . V_15 ;
V_9 = F_2 ( V_2 , V_304 | V_11 ) ;
if ( ! V_9 )
goto V_12;
F_8 () ;
V_18 = F_9 ( V_4 -> V_20 . V_21 ) ;
V_7 = F_6 ( V_2 , & V_312 , V_18 ) ;
if ( V_7 >= 0 ) {
V_6 = F_10 ( V_4 -> V_20 . V_21 ,
V_4 -> V_14 . V_15 ) ;
V_7 = F_1 ( V_2 , & V_312 , V_6 ) ;
}
F_11 () ;
if ( F_206 ( V_7 < 0 ) )
goto V_12;
...
const struct V_306 * exp )
{
struct V_28 * V_246 = exp -> V_246 ;
long V_32 = ( ( long ) exp -> V_32 . V_315 - ( long ) V_316 ) / V_33 ;
struct V_39 * V_40 ;
#ifdef F_74
struct V_8 * V_9 ;
struct V_3 V_317 = {} ;
...
if ( V_32 < 0 )
V_32 = 0 ;
if ( F_204 ( V_2 , & exp -> V_4 , V_303 ) < 0 )
goto V_12;
if ( F_205 ( V_2 , & exp -> V_4 , & exp -> V_172 ) < 0 )
goto V_12;
if ( F_204 ( V_2 ,
& V_246 -> V_320 [ V_64 ] . V_4 ,
V_321 ) < 0 )
goto V_12;
#ifdef F_74
if ( ! F_208 ( & exp -> V_322 , & V_323 ) ||
exp -> V_324 . V_314 ) {
V_9 = F_2 ( V_2 , V_325 | V_11 ) ;
if ( ! V_9 )
goto V_12;
if ( F_16 ( V_2 , V_326 , F_17 ( exp -> V_25 ) ) )
goto V_12;
V_317 . V_20 . V_21 = F_21 ( V_246 ) ;
V_317 . V_20 . V_206 = exp -> V_322 ;
V_317 . V_14 . V_15 = F_22 ( V_246 ) ;
V_317 . V_20 . V_313 = exp -> V_324 ;
if ( F_204 ( V_2 , & V_317 ,
V_327 ) < 0 )
goto V_12;
F_5 ( V_2 , V_9 ) ;
...
#endif
if ( F_16 ( V_2 , V_328 , F_17 ( V_32 ) ) ||
F_16 ( V_2 , V_329 , F_17 ( ( unsigned long ) exp ) ) ||
F_16 ( V_2 , V_330 , F_17 ( exp -> V_113 ) ) ||
F_16 ( V_2 , V_331 , F_17 ( exp -> V_332 ) ) )
goto V_12;
V_40 = F_24 ( V_246 ) ;
if ( V_40 ) {
struct V_41 * V_42 ;
V_42 = F_25 ( V_40 -> V_42 ) ;
if ( V_42 &&
F_26 ( V_2 , V_308 , V_42 -> V_46 ) )
goto V_12;
}
V_319 = F_209 ( exp -> V_333 ) ;
if ( V_319 != NULL &&
F_26 ( V_2 , V_334 , V_319 -> V_46 ) )
goto V_12;
return 0 ;
V_12:
return - 1 ;
...
int V_115 , const struct V_306 * exp )
{
struct V_109 * V_110 ;
struct V_111 * V_112 ;
unsigned int V_113 = V_108 ? V_114 : 0 ;
V_115 = F_57 ( V_335 , V_115 ) ;
V_110 = F_58 ( V_2 , V_108 , V_90 , V_115 , sizeof( * V_112 ) , V_113 ) ;
if ( V_110 == NULL )
goto V_118;
V_112 = F_59 ( V_110 ) ;
...
static int
F_211 ( unsigned int V_138 , struct V_336 * V_140 )
{
struct V_306 * exp = V_140 -> exp ;
...
if ( ! V_140 -> V_152 && ! F_79 ( V_141 , V_142 ) )
return 0 ;
V_2 = F_80 ( V_215 , V_153 ) ;
if ( V_2 == NULL )
goto V_154;
type = F_57 ( V_335 , type ) ;
V_110 = F_58 ( V_2 , V_140 -> V_108 , 0 , type , sizeof( * V_112 ) , V_113 ) ;
if ( V_110 == NULL )
goto V_118;
V_112 = F_59 ( V_110 ) ;
...
{
if ( V_164 -> args [ 1 ] )
F_201 ( (struct V_306 * ) V_164 -> args [ 1 ] ) ;
return 0 ;
}
static int
...
{
struct V_141 * V_141 = F_94 ( V_2 -> V_175 ) ;
struct V_306 * exp , * V_176 ;
struct V_111 * V_112 = F_59 ( V_164 -> V_110 ) ;
V_134 V_18 = V_112 -> V_119 ;
F_8 () ;
V_176 = (struct V_306 * ) V_164 -> args [ 1 ] ;
for (; V_164 -> args [ 0 ] < V_343 ; V_164 -> args [ 0 ] ++ ) {
V_185:
F_215 (exp, &nf_ct_expect_hash[cb->args[0]],
hnode) {
if ( V_18 && exp -> V_4 . V_20 . V_21 != V_18 )
continue;
if ( ! F_105 ( F_78 ( exp -> V_246 ) , V_141 ) )
continue;
if ( V_164 -> args [ 1 ] ) {
if ( exp != V_176 )
continue;
...
V_102 = F_120 ( V_167 , & V_4 , V_321 ,
V_206 , NULL ) ;
if ( V_102 < 0 )
return V_102 ;
V_102 = F_115 ( V_167 [ V_344 ] , & V_24 ) ;
if ( V_102 < 0 )
return V_102 ;
V_178 = F_129 ( V_141 , & V_24 , & V_4 ) ;
if ( ! V_178 )
...
V_212 . V_165 = V_29 ;
V_102 = F_132 ( V_205 , V_2 , V_110 , & V_212 ) ;
F_85 ( V_29 ) ;
return V_102 ;
}
...
F_8 () ;
V_102 = F_210 ( V_208 , F_106 ( V_2 ) . V_108 ,
V_110 -> V_188 , V_341 , exp ) ;
F_11 () ;
F_201 ( exp ) ;
if ( V_102 <= 0 )
goto free;
...
static int F_221 ( struct V_141 * V_141 , struct V_204 * V_205 ,
struct V_1 * V_2 , const struct V_109 * V_110 ,
const struct V_8 * const V_167 [] )
{
struct V_306 * exp ;
...
char * V_46 = F_122 ( V_167 [ V_308 ] ) ;
struct V_39 * V_348 ;
F_51 ( & V_347 ) ;
for ( V_85 = 0 ; V_85 < V_343 ; V_85 ++ ) {
F_224 (exp, next,
&nf_ct_expect_hash[i],
hnode) {
if ( ! F_105 ( F_212 ( exp ) , V_141 ) )
continue;
V_348 = F_24 ( exp -> V_246 ) ;
if ( ! strcmp ( V_348 -> V_42 -> V_46 , V_46 ) &&
F_222 ( & exp -> V_32 ) ) {
F_223 ( exp ,
F_106 ( V_2 ) . V_108 ,
F_128 ( V_110 ) ) ;
...
static int
F_225 ( struct V_306 * V_349 ,
const struct V_8 * const V_167 [] )
{
if ( V_167 [ V_328 ] ) {
if ( ! F_222 ( & V_349 -> V_32 ) )
return - V_250 ;
V_349 -> V_32 . V_315 = V_316 +
F_90 ( F_91 ( V_167 [ V_328 ] ) ) * V_33 ;
F_226 ( & V_349 -> V_32 ) ;
}
return 0 ;
}
static int
F_227 ( const struct V_8 * V_51 ,
struct V_306 * exp ,
V_134 V_206 )
{
#ifdef F_74
...
if ( V_102 < 0 )
return V_102 ;
exp -> V_322 = V_317 . V_20 . V_206 ;
exp -> V_324 = V_317 . V_20 . V_313 ;
exp -> V_25 = F_90 ( F_91 ( V_190 [ V_326 ] ) ) ;
return 0 ;
#else
return - V_174 ;
#endif
...
return F_89 ( - V_170 ) ;
if ( V_167 [ V_330 ] ) {
exp -> V_113 = F_90 ( F_91 ( V_167 [ V_330 ] ) ) ;
exp -> V_113 &= ~ V_353 ;
} else {
exp -> V_113 = 0 ;
}
if ( V_167 [ V_334 ] ) {
const char * V_46 = F_122 ( V_167 [ V_334 ] ) ;
struct V_318 * V_319 ;
V_319 = F_229 ( V_46 ) ;
if ( V_319 == NULL ) {
V_102 = - V_196 ;
...
exp -> V_42 = V_42 ;
exp -> V_4 = * V_4 ;
exp -> V_172 . V_20 . V_206 = V_172 -> V_20 . V_206 ;
exp -> V_172 . V_20 . V_313 . V_314 = V_172 -> V_20 . V_313 . V_314 ;
if ( V_167 [ V_325 ] ) {
V_102 = F_227 ( V_167 [ V_325 ] ,
exp , F_21 ( V_29 ) ) ;
if ( V_102 < 0 )
goto V_354;
}
...
static int
F_230 ( struct V_141 * V_141 ,
const struct V_23 * V_24 ,
const struct V_8 * const V_167 [] ,
V_134 V_206 , T_2 V_108 , int V_152 )
{
...
if ( V_102 < 0 )
return V_102 ;
V_102 = F_120 ( V_167 , & V_172 , V_304 ,
V_206 , NULL ) ;
if ( V_102 < 0 )
return V_102 ;
V_102 = F_120 ( V_167 , & F_47 , V_321 ,
V_206 , NULL ) ;
if ( V_102 < 0 )
return V_102 ;
...
static int F_231 ( struct V_141 * V_141 , struct V_204 * V_205 ,
struct V_1 * V_2 , const struct V_109 * V_110 ,
const struct V_8 * const V_167 [] )
{
struct V_3 V_4 ;
...
return V_102 ;
F_51 ( & V_347 ) ;
exp = F_232 ( V_141 , & V_24 , & V_4 ) ;
if ( ! exp ) {
F_52 ( & V_347 ) ;
V_102 = - V_207 ;
if ( V_110 -> V_209 & V_148 ) {
V_102 = F_230 ( V_141 , & V_24 , V_167 , V_206 ,
F_106 ( V_2 ) . V_108 ,
F_128 ( V_110 ) ) ;
}
return V_102 ;
...
V_102 = - V_268 ;
if ( ! ( V_110 -> V_209 & V_149 ) )
V_102 = F_225 ( exp , V_167 ) ;
F_52 ( & V_347 ) ;
return V_102 ;
}
static int
F_233 ( struct V_1 * V_2 , T_2 V_108 , T_2 V_90 , int V_218 ,
const struct V_269 * V_270 )
{
struct V_109 * V_110 ;
struct V_111 * V_112 ;
...
V_112 -> V_120 = V_121 ;
V_112 -> V_122 = F_14 ( V_218 ) ;
if ( F_16 ( V_2 , V_358 , F_17 ( V_270 -> V_359 ) ) ||
F_16 ( V_2 , V_360 , F_17 ( V_270 -> V_361 ) ) ||
F_16 ( V_2 , V_362 , F_17 ( V_270 -> V_363 ) ) )
goto V_12;
F_62 ( V_2 , V_110 ) ;
return V_2 -> V_77 ;
V_12:
...
static int
F_234 ( struct V_1 * V_2 , struct V_163 * V_164 )
{
int V_218 ;
struct V_141 * V_141 = F_94 ( V_2 -> V_175 ) ;
if ( V_164 -> args [ 0 ] == V_221 )
...
continue;
V_270 = F_137 ( V_141 -> V_29 . V_290 , V_218 ) ;
if ( F_233 ( V_2 , F_106 ( V_164 -> V_2 ) . V_108 ,
V_164 -> V_110 -> V_188 ,
V_218 , V_270 ) < 0 )
break;
}
...
static int F_235 ( struct V_141 * V_141 , struct V_204 * V_205 ,
struct V_1 * V_2 ,
const struct V_109 * V_110 ,
const struct V_8 * const V_167 [] )
{
...
static int T_8 F_236 ( struct V_141 * V_141 )
{
#ifdef F_237
int V_7 ;
V_7 = F_238 ( V_141 , & V_364 ) ;
if ( V_7 < 0 ) {
F_239 ( L_5 ) ;
goto V_354;
}
V_7 = F_240 ( V_141 , & V_365 ) ;
if ( V_7 < 0 ) {
F_239 ( L_6 ) ;
goto V_366;
}
...
static void F_242 ( struct V_141 * V_141 )
{
#ifdef F_237
F_243 ( V_141 , & V_365 ) ;
F_241 ( V_141 , & V_364 ) ;
...
static void T_9 F_244 ( struct V_367 * V_368 )
{
struct V_141 * V_141 ;
F_245 (net, net_exit_list, exit_list)
F_242 ( V_141 ) ;
}
