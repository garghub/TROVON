...
F_42 ( 10000 , 15000 ) ;
V_28 |= V_11 -> V_160 -> V_164 ( V_45 , 1 ) ;
F_42 ( 10000 , 15000 ) ;
} else {
V_28 = V_11 -> V_160 -> V_164 ( V_45 , 0 ) ;
...
F_2 ( & V_2 -> V_11 , L_32 , V_145 ) ;
F_2 ( & V_2 -> V_11 , L_33 ) ;
F_2 ( & V_2 -> V_11 , L_34 ) ;
return 0 ;
}
static int F_55 ( struct V_44 * V_45 , int V_202 )
{
struct V_50 * V_11 = F_19 ( V_45 ) ;
struct V_1 * V_2 = F_20 ( V_45 ) ;
int V_28 ;
...
static int F_62 ( struct V_44 * V_45 , V_26 * V_241 )
{
struct V_50 * V_11 = F_19 ( V_45 ) ;
F_26 ( & V_11 -> V_110 ) ;
...
F_72 ( & V_11 -> V_110 ) ;
V_11 -> V_52 = 0 ;
F_73 ( & ( V_11 -> V_45 ) , V_2 , & V_248 ) ;
if ( F_74 ( & V_2 -> V_11 ) )
V_245 = F_75 ( & V_11 -> V_45 ,
V_249 ,
V_127 ) ;
else
...
V_28 = F_56 ( & V_11 -> V_45 , V_2 -> V_206 , V_245 ) ;
if ( V_28 )
goto V_250;
V_28 = F_76 ( & V_11 -> V_45 , V_245 , V_251 ) ;
if ( V_28 )
goto V_250;
...
for ( V_177 = 0 ; V_177 < F_78 ( V_256 ) ; V_177 ++ )
F_79 ( & V_11 -> V_144 , & V_256 [ V_177 ] ,
NULL ) ;
if ( V_11 -> V_144 . error ) {
F_63 ( V_2 ) ;
...
V_28 = F_80 ( & V_11 -> V_45 . V_243 , 1 , & V_11 -> V_188 ) ;
if ( V_28 )
{
F_63 ( V_2 ) ;
F_13 ( & V_2 -> V_11 , L_46 ) ;
