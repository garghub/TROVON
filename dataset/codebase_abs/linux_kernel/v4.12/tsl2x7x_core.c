...
F_62 ( & V_19 -> V_49 ) ;
V_19 -> V_25 = V_200 ;
V_19 -> V_65 = F_63 ( & V_194 -> V_7 ) ;
V_19 -> V_51 = V_51 -> V_199 ;
V_19 -> V_201 =
& V_202 [ V_203 [ V_51 -> V_199 ] ] ;
V_9 -> V_168 = V_19 -> V_201 -> V_168 ;
V_9 -> V_7 . V_204 = & V_194 -> V_7 ;
V_9 -> V_205 = V_206 ;
V_9 -> V_80 = V_19 -> V_2 -> V_80 ;
V_9 -> V_207 = V_19 -> V_201 -> V_177 ;
V_9 -> V_208 = V_19 -> V_201 -> V_209 ;
if ( V_194 -> V_186 ) {
V_5 = F_64 ( & V_194 -> V_7 , V_194 -> V_186 ,
NULL ,
& F_54 ,
V_210 |
V_211 ,
...
static int F_66 ( struct V_143 * V_7 )
{
struct V_8 * V_9 = F_67 ( V_7 ) ;
struct V_18 * V_19 = F_6 ( V_9 ) ;
int V_5 = 0 ;
if ( V_19 -> V_25 == V_26 ) {
V_5 = F_19 ( V_9 ) ;
...
if ( V_19 -> V_65 && V_19 -> V_65 -> V_212 ) {
T_9 V_213 = { V_214 } ;
V_19 -> V_65 -> V_212 ( V_7 , V_213 ) ;
}
return V_5 ;
}
static int F_68 ( struct V_143 * V_7 )
{
struct V_8 * V_9 = F_67 ( V_7 ) ;
struct V_18 * V_19 = F_6 ( V_9 ) ;
int V_5 = 0 ;
