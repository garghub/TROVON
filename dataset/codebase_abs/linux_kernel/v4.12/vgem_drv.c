...
struct V_3 * V_2 = V_8 -> V_9 ;
unsigned long V_10 = V_6 -> V_11 ;
struct V_12 * V_12 ;
...
static int F_29 ( struct V_29 * V_14 , struct V_7 * V_8 )
{
unsigned long V_50 = V_8 -> V_51 ;
int V_32 ;
V_32 = F_30 ( V_14 , V_8 ) ;
if ( V_32 )
return V_32 ;
V_8 -> V_51 = V_50 | V_52 | V_53 ;
return 0 ;
}
...
{
int V_32 ;
if ( V_2 -> V_36 < V_8 -> V_60 - V_8 -> V_16 )
return - V_24 ;
if ( ! V_2 -> V_14 )
return - V_61 ;
V_32 = F_44 ( V_2 -> V_14 , V_8 ) ;
if ( V_32 )
return V_32 ;
F_45 ( V_8 -> V_62 ) ;
V_8 -> V_62 = F_46 ( V_2 -> V_14 ) ;
V_8 -> V_51 |= V_52 | V_53 ;
V_8 -> V_63 = F_40 ( F_47 ( V_8 -> V_51 ) ) ;
return 0 ;
}
