...
T_1 * V_5 = & V_4 -> V_6 . V_7 ;
int V_8 , V_9 ;
F_4 ( sizeof( V_4 -> V_10 -> V_11 ) != sizeof( T_1 ) ) ;
memcpy ( & V_4 -> V_10 -> V_11 , V_5 , sizeof( T_1 ) ) ;
if ( V_4 -> V_12 & V_13 )
return 0 ;
if ( F_5 ( V_5 ) ) {
F_6 ( V_4 , L_1 ) ;
...
if ( F_78 ( & V_4 -> V_6 ) ) {
int V_144 = V_4 -> V_142 ;
V_144 *= V_4 -> V_6 . V_145 / V_146 ;
if ( V_4 -> V_6 . V_108 >= F_79 ( V_4 , V_144 ) )
V_4 -> V_142 = V_144 ;
}
if ( F_80 ( & V_4 -> V_6 ) &&
V_4 -> V_6 . V_147 !=
...
F_26 ( & V_4 -> V_25 ) ;
F_28 ( & V_4 -> V_26 , V_47 ) ;
error = F_22 ( V_4 , V_27 -> V_24 , & V_4 -> V_151 ) ;
if ( error ) {
F_6 ( V_4 , L_19 , error ) ;
goto V_152;
}
...
! F_89 ( V_4 ) &&
! V_4 -> V_6 . V_157 ) {
error = F_90 ( V_4 , V_27 -> V_24 ) ;
if ( error )
goto V_158;
}
error = F_91 ( V_4 , NULL , V_27 -> V_159 , 0 , V_160 , & V_120 ) ;
if ( error ) {
F_6 ( V_4 , L_23 ) ;
goto V_158;
}
ASSERT ( V_120 != NULL ) ;
if ( F_92 ( ! F_93 ( F_94 ( V_120 ) -> V_161 ) ) ) {
F_6 ( V_4 , L_24 ,
( unsigned long long ) V_120 -> V_162 ) ;
F_95 ( V_120 , V_160 ) ;
F_85 ( L_25 , V_153 ,
V_4 ) ;
error = - V_69 ;
...
if ( F_97 ( V_4 ) ) {
error = F_98 ( V_4 , & V_121 , & V_122 ) ;
if ( error )
goto V_166;
} else {
ASSERT ( ! F_99 ( V_4 ) ) ;
if ( V_4 -> V_6 . V_115 & V_167 ) {
F_100 ( V_4 , L_28 ) ;
error = F_61 ( V_4 ) ;
if ( error )
goto V_166;
...
V_4 -> V_10 -> V_168 |= V_169 ;
error = F_101 ( V_4 ) ;
if ( error ) {
F_6 ( V_4 , L_29 ) ;
goto V_166;
}
if ( ( V_4 -> V_12 & ( V_165 | V_170 ) ) ==
V_165 ) {
F_102 ( V_4 ) ;
}
if ( V_121 ) {
...
T_9 V_189 )
{
F_132 ( & V_4 -> V_190 , V_189 , V_191 ) ;
if ( F_133 ( & V_4 -> V_190 , 0 , V_191 ) < 0 ) {
ASSERT ( 0 ) ;
F_134 ( & V_4 -> V_190 , - V_189 ) ;
return - V_14 ;
}
return 0 ;
}
...
T_9 V_189 )
{
F_134 ( & V_4 -> V_192 , V_189 ) ;
if ( F_136 ( & V_4 -> V_192 , 0 ) < 0 ) {
ASSERT ( 0 ) ;
F_134 ( & V_4 -> V_192 , - V_189 ) ;
return - V_14 ;
}
...
T_10 V_196 ;
if ( V_189 > 0 ) {
if ( F_138 ( V_4 -> V_197 == V_4 -> V_198 ) ) {
F_134 ( & V_4 -> V_199 , V_189 ) ;
return 0 ;
}
F_16 ( & V_4 -> V_116 ) ;
...
if ( F_133 ( & V_4 -> V_199 , 2 * V_200 ,
V_200 ) < 0 )
V_196 = 1 ;
else
V_196 = V_200 ;
F_132 ( & V_4 -> V_199 , V_189 , V_196 ) ;
if ( F_133 ( & V_4 -> V_199 , V_4 -> V_201 ,
V_200 ) >= 0 ) {
return 0 ;
}
F_16 ( & V_4 -> V_116 ) ;
...
if ( F_147 ( V_4 -> V_64 ) ||
F_147 ( V_4 -> V_112 ) ||
( V_4 -> V_210 && F_147 ( V_4 -> V_210 ) ) ) {
F_100 ( V_4 , L_37 , V_209 ) ;
F_100 ( V_4 , L_38 ) ;
return - V_211 ;
}
return 0 ;
