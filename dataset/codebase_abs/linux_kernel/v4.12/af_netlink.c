...
T_1 V_5 , T_2 V_203 ,
int (* F_197)( struct V_1 * V_230 , struct V_6 * V_7 , void * V_14 ) ,
void * V_231 )
{
...
static int F_201 ( struct V_1 * V_2 , struct V_234 * V_214 )
{
struct V_50 * V_51 = F_2 ( V_2 ) ;
int V_28 = 0 ;
if ( V_2 == V_214 -> V_216 )
...
int F_202 ( struct V_1 * V_187 , T_1 V_11 , T_1 V_5 , int V_235 )
{
struct V_234 V_232 ;
struct V_1 * V_2 ;
int V_28 = 0 ;
...
static int F_206 ( struct V_112 * V_1 , int V_237 , int V_238 ,
...
return - V_242 ;
if ( V_240 >= sizeof( int ) &&
F_207 ( V_215 , ( unsigned int T_5 * ) V_239 ) )
return - V_243 ;
switch ( V_238 ) {
case V_244 :
if ( V_215 )
...
if ( F_209 ( ( T_1 ) ( V_51 -> V_72 [ V_257 ] >> V_258 ) ,
( T_1 T_5 * ) ( V_239 + V_256 ) ) ) {
V_100 = - V_243 ;
break;
}
}
if ( F_209 ( F_210 ( V_51 -> V_98 / 8 , sizeof( T_1 ) ) , V_240 ) )
V_100 = - V_243 ;
F_80 () ;
break;
}
...
if ( F_209 ( V_9 , V_240 ) || F_209 ( V_215 , V_239 ) )
return - V_243 ;
V_100 = 0 ;
break;
default:
...
static void F_211 ( struct V_259 * V_260 , struct V_6 * V_7 )
{
struct V_261 V_232 ;
V_232 . V_5 = F_7 ( V_7 ) . V_12 ;
F_212 ( V_260 , V_241 , V_244 , sizeof( V_232 ) , & V_232 ) ;
}
static void F_213 ( struct V_1 * V_2 , struct V_259 * V_260 ,
struct V_6 * V_7 )
{
if ( ! F_7 ( V_7 ) . V_227 )
return;
F_212 ( V_260 , V_241 , V_250 , sizeof( int ) ,
& F_7 ( V_7 ) . V_225 ) ;
}
static int F_214 ( struct V_112 * V_1 , struct V_259 * V_260 , T_6 V_9 )
{
struct V_1 * V_2 = V_1 -> V_2 ;
struct V_50 * V_51 = F_2 ( V_2 ) ;
F_156 ( struct V_167 * , V_165 , V_260 -> V_262 ) ;
T_1 V_180 ;
T_1 V_12 ;
struct V_6 * V_7 ;
int V_100 ;
...
return - V_268 ;
V_100 = F_215 ( V_1 , V_260 , & V_264 , true ) ;
if ( V_100 < 0 )
return V_100 ;
if ( V_260 -> V_269 ) {
V_100 = - V_19 ;
...
F_7 ( V_7 ) . V_3 = V_265 ;
V_100 = - V_243 ;
if ( F_216 ( F_8 ( V_7 , V_9 ) , V_260 , V_9 ) ) {
F_57 ( V_7 ) ;
goto V_26;
}
V_100 = F_217 ( V_2 , V_7 ) ;
...
V_100 = F_182 ( V_2 , V_7 , V_180 , V_260 -> V_266 & V_273 ) ;
V_26:
F_218 ( & V_264 ) ;
return V_100 ;
}
static int F_219 ( struct V_112 * V_1 , struct V_259 * V_260 , T_6 V_9 ,
int V_3 )
{
struct V_263 V_264 ;
struct V_1 * V_2 = V_1 -> V_2 ;
...
#endif
V_51 -> V_279 = F_222 ( V_51 -> V_279 , V_9 ) ;
V_51 -> V_279 = F_223 ( T_6 , V_51 -> V_279 ,
F_224 ( 32768 ) ) ;
V_275 = V_276 -> V_9 ;
if ( V_9 < V_275 ) {
V_260 -> V_266 |= V_280 ;
...
F_225 ( V_276 ) ;
V_100 = F_226 ( V_276 , 0 , V_260 , V_275 ) ;
if ( V_260 -> V_262 ) {
F_156 ( struct V_167 * , V_165 , V_260 -> V_262 ) ;
V_165 -> V_170 = V_171 ;
V_165 -> V_184 = 0 ;
...
struct V_1 *
F_233 ( struct V_87 * V_87 , int V_281 , struct V_23 * V_23 ,
struct V_282 * V_283 )
{
struct V_112 * V_1 ;
struct V_1 * V_2 ;
...
return NULL ;
if ( F_234 ( V_118 , V_127 , V_281 , & V_1 ) )
return NULL ;
if ( F_107 ( V_87 , V_1 , V_114 , V_281 , 1 ) < 0 )
goto V_284;
V_2 = V_1 -> V_2 ;
...
F_236 ( V_93 [ V_281 ] . V_97 , V_97 ) ;
V_93 [ V_281 ] . V_114 = V_114 ;
V_93 [ V_281 ] . V_23 = V_23 ;
if ( V_283 ) {
V_93 [ V_281 ] . F_114 = V_283 -> F_114 ;
...
void F_241 ( struct V_1 * V_288 , unsigned int V_5 )
{
struct V_1 * V_2 ;
...
struct V_289 *
F_242 ( struct V_6 * V_7 , T_1 V_11 , T_1 V_290 , int type , int V_9 , int V_3 )
{
struct V_289 * V_291 ;
int V_194 = F_243 ( V_9 ) ;
V_291 = (struct V_289 * ) F_8 ( V_7 , F_244 ( V_194 ) ) ;
V_291 -> V_292 = type ;
V_291 -> V_293 = V_194 ;
V_291 -> V_294 = V_3 ;
V_291 -> V_295 = V_11 ;
...
memset ( F_246 ( V_291 ) + V_9 , 0 , F_244 ( V_194 ) - V_194 ) ;
return V_291 ;
}
...
goto V_300;
V_67 = & V_51 -> V_67 ;
V_298 = F_248 ( int , V_67 -> V_301 , V_196 ) ;
if ( V_298 < V_51 -> V_279 ) {
V_299 = V_51 -> V_279 ;
V_7 = F_6 ( V_299 ,
( V_119 & ~ V_207 ) |
...
V_291 = F_252 ( V_7 , V_67 , V_303 , sizeof( V_9 ) , V_304 ) ;
if ( ! V_291 )
goto V_300;
F_253 ( V_67 , V_291 ) ;
memcpy ( F_246 ( V_291 ) , & V_9 , sizeof( V_9 ) ) ;
if ( F_187 ( V_2 , V_7 ) )
F_57 ( V_7 ) ;
else
F_173 ( V_2 , V_7 ) ;
...
void F_255 ( struct V_6 * V_311 , struct V_289 * V_291 , int V_100 ,
...
if ( V_313 -> V_320 )
V_318 += F_256 ( strlen ( V_313 -> V_320 ) + 1 ) ;
if ( V_313 -> V_321 )
V_318 += F_256 ( sizeof( T_1 ) ) ;
}
} else {
V_3 |= V_319 ;
if ( V_51 -> V_3 & V_254 &&
V_313 && V_313 -> V_322 )
V_318 += F_256 ( V_313 -> V_322 ) ;
}
if ( V_318 )
V_3 |= V_323 ;
V_7 = F_257 ( V_317 + V_318 , V_119 ) ;
if ( ! V_7 ) {
struct V_1 * V_2 ;
V_2 = F_92 ( F_84 ( V_311 -> V_2 ) ,
V_311 -> V_2 -> V_29 ,
F_7 ( V_311 ) . V_11 ) ;
if ( V_2 ) {
V_2 -> V_55 = V_56 ;
...
V_314 = F_242 ( V_7 , F_7 ( V_311 ) . V_11 , V_291 -> V_296 ,
V_324 , V_317 , V_3 ) ;
V_316 = F_246 ( V_314 ) ;
V_316 -> error = V_100 ;
...
if ( V_100 ) {
if ( V_313 -> V_320 )
F_53 ( F_258 ( V_7 , V_325 ,
V_313 -> V_320 ) ) ;
if ( V_313 -> V_321 &&
! F_53 ( ( V_326 * ) V_313 -> V_321 < V_311 -> V_14 ||
( V_326 * ) V_313 -> V_321 >= V_311 -> V_14 +
V_311 -> V_9 ) )
F_53 ( F_259 ( V_7 , V_327 ,
( V_326 * ) V_313 -> V_321 -
V_311 -> V_14 ) ) ;
} else {
if ( V_313 -> V_322 )
F_53 ( F_260 ( V_7 , V_328 ,
V_313 -> V_322 ,
V_313 -> V_329 ) ) ;
}
}
F_261 ( V_7 , V_314 ) ;
F_182 ( V_311 -> V_2 , V_7 , F_7 ( V_311 ) . V_11 , V_273 ) ;
}
int F_262 ( struct V_6 * V_7 , int (* V_67)( struct V_6 * ,
struct V_289 * ,
struct V_312 * ) )
{
struct V_312 V_313 = {} ;
...
F_255 ( V_7 , V_291 , V_100 , & V_313 ) ;
V_335:
V_330 = F_244 ( V_291 -> V_293 ) ;
if ( V_330 > V_7 -> V_9 )
V_330 = V_7 -> V_9 ;
F_265 ( V_7 , V_330 ) ;
}
...
int F_266 ( struct V_1 * V_2 , struct V_6 * V_7 , T_1 V_11 ,
...
V_100 = F_267 ( V_2 , V_7 , V_338 , V_5 , V_3 ) ;
}
if ( V_337 ) {
int V_339 ;
V_339 = F_268 ( V_2 , V_7 , V_11 ) ;
if ( ! V_100 || V_100 == - V_233 )
V_100 = V_339 ;
}
return V_100 ;
}
static int F_269 ( struct V_340 * V_341 )
{
int V_100 ;
V_100 = F_270 ( & V_93 [ V_341 -> V_342 ] . V_90 , & V_341 -> V_343 ,
V_119 ) ;
if ( V_100 ) {
V_341 -> V_342 = V_129 ;
return V_100 ;
}
V_100 = F_271 ( & V_341 -> V_343 ) ;
return V_100 == - V_200 ? 0 : V_100 ;
}
static void F_272 ( struct V_340 * V_341 )
{
F_273 ( & V_341 -> V_343 ) ;
F_274 ( & V_341 -> V_343 ) ;
}
static void * F_275 ( struct V_344 * V_290 )
{
...
} while ( F_84 ( & V_51 -> V_2 ) != F_277 ( V_290 ) );
return V_51 ;
}
static void * F_278 ( struct V_344 * V_290 , T_7 * V_346 )
{
struct V_340 * V_341 = V_290 -> V_345 ;
void * V_347 = V_348 ;
T_7 V_256 ;
...
if ( V_100 )
return F_159 ( V_100 ) ;
for ( V_256 = * V_346 ; V_256 && V_347 && ! F_185 ( V_347 ) ; V_256 -- )
V_347 = F_275 ( V_290 ) ;
return V_347 ;
}
static void * F_279 ( struct V_344 * V_290 , void * V_349 , T_7 * V_256 )
{
++ * V_256 ;
return F_275 ( V_290 ) ;
}
static void F_280 ( struct V_344 * V_290 , void * V_349 )
{
struct V_340 * V_341 = V_290 -> V_345 ;
if ( V_341 -> V_342 >= V_129 )
return;
...
static int F_281 ( struct V_344 * V_290 , void * V_349 )
{
if ( V_349 == V_348 ) {
F_282 ( V_290 ,
L_4
...
static int F_287 ( struct V_190 * V_190 , struct V_155 * V_155 )
{
return F_288 ( V_190 , V_155 , & V_351 ,
sizeof( struct V_340 ) ) ;
}
int F_289 ( struct V_352 * V_353 )
{
return F_290 ( & V_141 , V_353 ) ;
}
int F_291 ( struct V_352 * V_353 )
{
return F_292 ( & V_141 , V_353 ) ;
}
static int T_8 F_293 ( struct V_87 * V_87 )
{
#ifdef F_294
if ( ! F_295 ( L_7 , 0 , V_87 -> V_354 , & V_355 ) )
return - V_40 ;
#endif
return 0 ;
}
static void T_9 F_296 ( struct V_87 * V_87 )
{
#ifdef F_294
F_297 ( L_7 , V_87 -> V_354 ) ;
#endif
}
...
static inline T_1 F_300 ( const void * V_14 , T_1 V_9 , T_1 V_357 )
{
const struct V_50 * V_51 = V_14 ;
struct V_83 V_81 ;
F_86 ( & V_81 , F_84 ( & V_51 -> V_2 ) , V_51 -> V_11 ) ;
return F_301 ( ( T_1 * ) & V_81 , V_358 / sizeof( T_1 ) , V_357 ) ;
}
static int T_10 F_302 ( void )
{
int V_96 ;
int V_100 = F_303 ( & V_120 , 0 ) ;
if ( V_100 != 0 )
goto V_26;
F_304 ( sizeof( struct V_148 ) > F_305 ( struct V_6 , V_67 ) ) ;
V_93 = F_306 ( V_129 , sizeof( * V_93 ) , V_119 ) ;
if ( ! V_93 )
goto F_299;
for ( V_96 = 0 ; V_96 < V_129 ; V_96 ++ ) {
if ( F_307 ( & V_93 [ V_96 ] . V_90 ,
& V_91 ) < 0 ) {
while ( -- V_96 > 0 )
F_308 ( & V_93 [ V_96 ] . V_90 ) ;
F_132 ( V_93 ) ;
goto F_299;
}
}
