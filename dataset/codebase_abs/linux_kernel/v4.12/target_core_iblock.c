...
int V_20 = 0 , V_119 ;
unsigned long V_120 ;
V_117 = F_68 ( V_98 , V_12 ) ;
if ( ! V_117 )
return - V_21 ;
V_114 = V_117 ;
while ( ( V_115 = F_69 ( & V_117 , L_26 ) ) != NULL ) {
if ( ! * V_115 )
continue;
V_119 = F_70 ( V_115 , V_121 , args ) ;
switch ( V_119 ) {
case V_122 :
if ( V_11 -> V_36 ) {
F_8 ( L_27
...
static T_6 F_74 ( struct V_2 * V_3 , char * V_127 )
{
struct V_1 * V_11 = F_1 ( V_3 ) ;
...
F_76 ( V_16 -> V_131 ) , F_77 ( V_16 -> V_131 ) , ( ! V_16 -> V_132 ) ?
...
static int
F_78 ( struct V_59 * V_60 , struct V_69 * V_69 )
{
struct V_2 * V_3 = V_60 -> V_76 ;
struct V_17 * V_18 ;
struct V_134 * V_135 ;
...
V_135 = F_79 ( V_69 , V_78 , V_60 -> V_139 ) ;
if ( F_12 ( V_135 ) ) {
F_8 ( L_43 ) ;
return F_13 ( V_135 ) ;
}
...
V_137 = F_81 ( V_69 , F_58 ( V_96 ) , V_96 -> V_107 ,
V_96 -> V_99 ) ;
if ( V_137 != V_96 -> V_107 ) {
F_8 ( L_45 , V_137 ) ;
return - V_21 ;
...
static T_5
F_82 ( struct V_59 * V_60 , struct V_95 * V_144 , T_1 V_145 ,
enum V_146 V_147 )
{
struct V_2 * V_3 = V_60 -> V_76 ;
T_4 V_104 = F_51 ( V_3 , V_60 -> V_102 ) ;
...
V_74 = V_90 ;
if ( F_83 ( V_151 , & V_14 -> V_152 ) ) {
if ( V_60 -> V_153 & V_154 )
V_75 = V_155 ;
else if ( ! F_83 ( V_156 , & V_14 -> V_152 ) )
V_75 = V_155 ;
}
} else {
V_74 = V_157 ;
...
static T_5
F_94 ( struct V_59 * V_60 )
{
return F_95 ( V_60 , & V_161 ) ;
}
