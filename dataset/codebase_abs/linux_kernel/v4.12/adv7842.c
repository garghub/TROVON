...
static int F_127 ( struct V_271 * V_272 , T_2 V_22 )
{
struct V_8 * V_40 = F_126 ( V_272 ) ;
struct V_9 * V_10 = & V_40 -> V_10 ;
unsigned int V_4 , V_275 = V_276 ;
if ( ! V_40 -> V_273 )
return V_22 == V_277 ? 0 : - V_27 ;
if ( V_22 == V_277 ) {
...
bool V_278 = V_40 -> V_274 & ( 1 << V_4 ) ;
if ( V_275 == V_276 && ! V_278 )
V_275 = V_4 ;
if ( V_278 && V_40 -> V_279 [ V_4 ] == V_22 )
return 0 ;
}
if ( V_4 == V_276 ) {
V_4 = V_275 ;
...
static int F_128 ( struct V_271 * V_272 , T_2 V_281 ,
T_3 V_282 , struct V_268 * V_269 )
{
struct V_8 * V_40 = F_126 ( V_272 ) ;
struct V_9 * V_10 = & V_40 -> V_10 ;
T_2 V_270 = V_269 -> V_270 ;
unsigned int V_4 ;
F_30 ( V_10 , 0x12 , 0x70 , F_129 ( 1 , V_281 - 1 ) << 4 ) ;
if ( V_270 > 16 ) {
...
static int F_130 ( struct V_9 * V_10 , T_3 V_148 , bool * V_266 )
{
struct V_8 * V_40 = F_3 ( V_10 ) ;
T_2 V_283 , V_284 , V_285 ;
T_2 V_286 [ 6 ] ;
F_120 ( V_10 , false ) ;
V_286 [ 0 ] = F_21 ( V_10 , 0x43 ) ;
V_286 [ 1 ] = F_21 ( V_10 , 0x57 ) ;
V_286 [ 2 ] = F_21 ( V_10 , 0x70 ) ;
V_286 [ 3 ] = F_21 ( V_10 , 0x75 ) ;
V_286 [ 4 ] = F_21 ( V_10 , 0x9d ) ;
V_286 [ 5 ] = F_21 ( V_10 , 0x66 ) ;
if ( V_286 [ 0 ] )
F_23 ( V_10 , 0x44 , V_286 [ 0 ] ) ;
if ( V_286 [ 1 ] )
F_23 ( V_10 , 0x58 , V_286 [ 1 ] ) ;
if ( V_286 [ 2 ] )
F_23 ( V_10 , 0x71 , V_286 [ 2 ] ) ;
if ( V_286 [ 3 ] )
F_23 ( V_10 , 0x76 , V_286 [ 3 ] ) ;
if ( V_286 [ 4 ] )
F_23 ( V_10 , 0x9e , V_286 [ 4 ] ) ;
if ( V_286 [ 5 ] )
F_23 ( V_10 , 0x67 , V_286 [ 5 ] ) ;
F_120 ( V_10 , true ) ;
F_56 ( 1 , V_52 , V_10 , L_60 , V_53 ,
V_286 [ 0 ] , V_286 [ 1 ] , V_286 [ 2 ] ,
V_286 [ 3 ] , V_286 [ 4 ] , V_286 [ 5 ] ) ;
V_283 = V_286 [ 0 ] & 0x9c ;
if ( V_40 -> V_57 == V_150 )
V_285 = ( V_286 [ 1 ] & 0x30 ) | ( V_286 [ 4 ] & 0x09 ) ;
else
V_285 = 0 ;
if ( F_60 ( V_10 ) )
V_284 = V_286 [ 3 ] & 0x03 ;
...
static int F_132 ( struct V_9 * V_10 , struct V_288 * V_74 )
{
struct V_8 * V_40 = F_3 ( V_10 ) ;
T_2 * V_20 = NULL ;
memset ( V_74 -> V_289 , 0 , sizeof( V_74 -> V_289 ) ) ;
switch ( V_74 -> V_168 ) {
case V_71 :
case V_72 :
...
if ( V_74 -> V_291 >= 2 )
return - V_79 ;
if ( V_74 -> V_291 + V_74 -> V_292 > 2 )
V_74 -> V_292 = 2 - V_74 -> V_291 ;
memcpy ( V_74 -> V_74 , V_20 + V_74 -> V_291 * 128 , V_74 -> V_292 * 128 ) ;
return 0 ;
}
static int F_133 ( struct V_9 * V_10 , struct V_288 * T_8 )
{
struct V_8 * V_40 = F_3 ( V_10 ) ;
int V_30 = 0 ;
memset ( T_8 -> V_289 , 0 , sizeof( T_8 -> V_289 ) ) ;
if ( T_8 -> V_168 > V_290 )
return - V_79 ;
if ( T_8 -> V_291 != 0 )
return - V_79 ;
...
V_40 -> V_164 = F_134 ( T_8 -> V_74 [ 0x15 ] ,
T_8 -> V_74 [ 0x16 ] ) ;
switch ( T_8 -> V_168 ) {
case V_290 :
memset ( & V_40 -> V_73 . V_74 , 0 , 256 ) ;
V_40 -> V_73 . V_69 = T_8 -> V_292 ? 0x1 : 0x0 ;
memcpy ( & V_40 -> V_73 . V_74 , T_8 -> V_74 , 128 * T_8 -> V_292 ) ;
V_30 = F_65 ( V_10 ) ;
break;
case V_71 :
case V_72 :
...
memcpy ( & V_40 -> V_70 . V_74 , T_8 -> V_74 , 128 * T_8 -> V_292 ) ;
...
static void F_135 ( struct V_9 * V_10 , struct V_294 * V_295 )
{
int V_4 ;
T_2 V_296 [ 32 ] ;
union V_297 V_298 ;
T_2 V_270 ;
struct V_15 * V_16 = F_22 ( V_10 ) ;
struct V_299 * V_300 = & V_16 -> V_300 ;
if ( ! ( F_21 ( V_10 , 0x60 ) & V_295 -> V_301 ) ) {
F_72 ( V_10 , L_67 , V_295 -> V_302 ) ;
return;
}
for ( V_4 = 0 ; V_4 < 3 ; V_4 ++ )
V_296 [ V_4 ] = F_31 ( V_10 , V_295 -> V_303 + V_4 ) ;
V_270 = V_296 [ 2 ] + 1 ;
if ( V_270 + 3 > sizeof( V_296 ) ) {
F_80 ( V_10 , L_68 , V_53 , V_295 -> V_302 , V_270 ) ;
return;
}
for ( V_4 = 0 ; V_4 < V_270 ; V_4 ++ )
V_296 [ V_4 + 3 ] = F_31 ( V_10 , V_295 -> V_304 + V_4 ) ;
if ( F_136 ( & V_298 , V_296 ) < 0 ) {
F_80 ( V_10 , L_69 , V_53 , V_295 -> V_302 ) ;
return;
}
F_137 ( V_305 , V_300 , & V_298 ) ;
}
...
struct V_8 * V_40 = F_3 ( V_10 ) ;
struct V_1 V_88 ;
T_2 V_308 = F_21 ( V_10 , 0x02 ) ;
T_2 V_309 = F_21 ( V_10 , 0x21 ) ;
T_2 V_310 = F_42 ( V_10 , 0x77 ) ;
T_2 V_311 = F_42 ( V_10 , 0x7d ) ;
bool V_312 = F_47 ( V_10 , 0x04 ) & 0x01 ;
bool V_313 = F_47 ( V_10 , 0x18 ) & 0x01 ;
bool V_314 = F_21 ( V_10 , 0x65 ) & 0x40 ;
...
F_72 ( V_10 , L_138 ,
( ( V_311 & 0x04 ) && ( V_310 & 0x04 ) ) ?
L_105 : L_106 ,
( ( V_311 & 0x08 ) && ( V_310 & 0x08 ) ) ?
L_105 : L_106 ) ;
F_72 ( V_10 , L_139 ,
V_309 & 0x02 ? L_105 : L_106 ,
V_309 & 0x01 ? L_105 : L_106 ) ;
F_72 ( V_10 , L_140 , V_40 -> V_273 ?
L_105 : L_106 ) ;
if ( V_40 -> V_273 ) {
int V_4 ;
for ( V_4 = 0 ; V_4 < V_276 ; V_4 ++ ) {
...
T_3 V_319 = ( ( F_50 ( V_10 , 0xb8 ) & 0x1f ) << 8 ) | F_50 ( V_10 , 0xb9 ) ;
...
V_316 [ V_308 >> 4 ] ) ;
F_72 ( V_10 , L_160 ,
( V_308 & 0x02 ) ? L_161 : L_162 ,
( ( ( V_308 >> 2 ) & 0x01 ) ^ ( V_308 & 0x01 ) ) ?
L_163 : L_164 ,
( V_308 & 0x08 ) ? L_105 : L_106 ) ;
F_72 ( V_10 , L_165 ,
V_315 [ F_50 ( V_10 , 0xf4 ) >> 4 ] ) ;
if ( ! F_60 ( V_10 ) )
return 0 ;
...
static int F_142 ( struct V_9 * V_10 , T_11 * V_320 )
{
struct V_8 * V_40 = F_3 ( V_10 ) ;
F_56 ( 1 , V_52 , V_10 , L_5 , V_53 ) ;
if ( V_40 -> V_57 != V_150 )
...
static void F_143 ( struct V_9 * V_10 , struct V_329 * V_330 )
{
if ( V_330 && V_330 -> V_331 ) {
F_34 ( V_10 , 0x94 , ( V_330 -> V_332 >> 8 ) & 0xf ) ;
F_34 ( V_10 , 0x95 , V_330 -> V_332 & 0xff ) ;
F_34 ( V_10 , 0x96 , ( V_330 -> V_333 >> 8 ) & 0xf ) ;
F_34 ( V_10 , 0x97 , V_330 -> V_333 & 0xff ) ;
F_34 ( V_10 , 0x98 , ( V_330 -> V_334 >> 8 ) & 0xf ) ;
F_34 ( V_10 , 0x99 , V_330 -> V_334 & 0xff ) ;
F_34 ( V_10 , 0x9a , ( V_330 -> V_335 >> 8 ) & 0xf ) ;
F_34 ( V_10 , 0x9b , V_330 -> V_335 & 0xff ) ;
F_34 ( V_10 , 0xa8 , V_330 -> V_336 ) ;
F_34 ( V_10 , 0xa9 , V_330 -> V_337 ) ;
F_34 ( V_10 , 0xaa , V_330 -> V_338 ) ;
F_34 ( V_10 , 0xab , V_330 -> V_339 ) ;
F_34 ( V_10 , 0xac , V_330 -> V_340 ) ;
F_34 ( V_10 , 0xad , V_330 -> V_341 ) ;
F_34 ( V_10 , 0xae , V_330 -> V_342 ) ;
F_34 ( V_10 , 0xaf , V_330 -> V_343 ) ;
} else {
F_34 ( V_10 , 0x94 , 0x00 ) ;
F_34 ( V_10 , 0x95 , 0x00 ) ;
F_34 ( V_10 , 0x96 , 0x00 ) ;
...
{
struct V_8 * V_40 = F_3 ( V_10 ) ;
struct V_344 * V_240 = & V_40 -> V_240 ;
F_56 ( 1 , V_52 , V_10 , L_5 , V_53 ) ;
if ( V_40 -> V_57 != V_150 )
return - V_170 ;
if ( V_251 & V_345 )
F_143 ( V_10 , & V_240 -> V_346 ) ;
else if ( V_251 & V_252 )
F_143 ( V_10 , & V_240 -> V_347 ) ;
else
F_143 ( V_10 , NULL ) ;
if ( V_251 & V_328 ) {
V_40 -> V_251 = V_251 ;
...
static int F_145 ( struct V_9 * V_10 , T_11 * V_251 )
{
struct V_8 * V_40 = F_3 ( V_10 ) ;
F_56 ( 1 , V_52 , V_10 , L_5 , V_53 ) ;
if ( V_40 -> V_57 != V_150 )
...
F_23 ( V_10 , 0x0c , 0x42 ) ;
F_23 ( V_10 , 0x15 , 0x80 ) ;
F_23 ( V_10 , 0x02 , 0xf0 | V_240 -> V_350 << 3 ) ;
F_24 ( V_10 , 0x05 , 0xf0 , V_240 -> V_351 << 3 |
V_240 -> V_352 << 2 |
V_240 -> V_353 << 1 ) ;
F_116 ( V_40 ) ;
...
V_240 -> V_355 << 2 |
V_240 -> V_356 ) ;
F_52 ( V_10 , 0xba , 0xfc , V_240 -> V_357 |
( V_240 -> V_358 << 1 ) ) ;
F_38 ( V_10 , 0xdd , 0xf0 , V_240 -> V_359 |
( V_240 -> V_360 << 1 ) |
( V_240 -> V_361 << 2 ) |
( V_240 -> V_362 << 3 ) ) ;
F_51 ( V_10 , 0x69 , 0x14 ) ;
...
F_51 ( V_10 , 0xf3 , 0xdc ) ;
F_40 ( V_10 , 0xb5 , 0x01 ) ;
F_40 ( V_10 , 0x02 , V_240 -> V_363 ) ;
F_24 ( V_10 , 0x30 , ~ ( 1 << 4 ) , V_240 -> V_364 << 4 ) ;
...
F_23 ( V_10 , 0x19 , 0x80 | V_240 -> V_368 ) ;
F_23 ( V_10 , 0x33 , 0x40 ) ;
F_23 ( V_10 , 0x40 , 0xf2 ) ;
F_120 ( V_10 , true ) ;
return F_147 ( V_10 -> V_369 ) ;
}
...
struct V_15 * V_16 = F_22 ( V_10 ) ;
struct V_8 * V_40 = F_3 ( V_10 ) ;
struct V_344 * V_240 = V_16 -> V_300 . V_374 ;
struct V_1 V_88 ;
int V_28 = 0 ;
if ( ! V_240 )
return - V_375 ;
if ( ! V_240 -> V_365 || ! V_240 -> V_366 ) {
F_72 ( V_10 , L_188 ) ;
return - V_79 ;
}
F_55 ( V_10 ) ;
...
static long F_151 ( struct V_9 * V_10 , unsigned int V_376 , void * V_377 )
{
switch ( V_376 ) {
case V_378 :
return F_150 ( V_10 ) ;
...
switch ( V_383 -> type ) {
case V_384 :
return F_153 ( V_10 , V_381 , V_383 ) ;
case V_385 :
return F_154 ( V_10 , V_381 , V_383 ) ;
default:
return - V_79 ;
}
}
...
struct V_15 * V_16 = F_22 ( V_10 ) ;
int V_30 ;
V_30 = F_156 ( V_40 -> V_80 , & V_16 -> V_300 ) ;
if ( V_30 )
F_157 ( V_40 -> V_80 ) ;
return V_30 ;
}
...
static struct V_15 * F_162 ( struct V_9 * V_10 , const char * V_302 ,
T_2 V_22 , T_2 V_386 )
{
struct V_15 * V_16 = F_22 ( V_10 ) ;
struct V_15 * V_387 ;
F_23 ( V_10 , V_386 , V_22 << 1 ) ;
if ( V_22 == 0 ) {
F_80 ( V_10 , L_189 , V_302 ) ;
return NULL ;
}
V_387 = F_163 ( V_16 -> V_21 , F_21 ( V_10 , V_386 ) >> 1 ) ;
if ( ! V_387 )
F_80 ( V_10 , L_190 , V_302 , V_22 ) ;
return V_387 ;
}
...
struct V_8 * V_40 = F_3 ( V_10 ) ;
struct V_344 * V_240 = & V_40 -> V_240 ;
V_40 -> V_41 = F_162 ( V_10 , L_191 , V_240 -> V_41 , 0xf3 ) ;
V_40 -> V_42 = F_162 ( V_10 , L_192 , V_240 -> V_42 , 0xf4 ) ;
V_40 -> V_43 = F_162 ( V_10 , L_193 , V_240 -> V_43 , 0xf5 ) ;
V_40 -> V_44 = F_162 ( V_10 , L_194 , V_240 -> V_44 , 0xf2 ) ;
V_40 -> V_45 = F_162 ( V_10 , L_195 , V_240 -> V_45 , 0xf1 ) ;
V_40 -> V_46 = F_162 ( V_10 , L_196 , V_240 -> V_46 , 0xf8 ) ;
V_40 -> V_47 = F_162 ( V_10 , L_197 , V_240 -> V_47 , 0xf9 ) ;
V_40 -> V_48 = F_162 ( V_10 , L_198 , V_240 -> V_48 , 0xfa ) ;
V_40 -> V_49 = F_162 ( V_10 , L_199 , V_240 -> V_49 , 0xfb ) ;
V_40 -> V_50 = F_162 ( V_10 , L_200 , V_240 -> V_50 , 0xfd ) ;
V_40 -> V_51 = F_162 ( V_10 , L_201 , V_240 -> V_51 , 0xfe ) ;
if ( ! V_40 -> V_41 ||
! V_40 -> V_42 ||
! V_40 -> V_43 ||
! V_40 -> V_44 ||
...
const struct V_388 * V_131 )
{
struct V_8 * V_40 ;
static const struct V_1 V_389 =
V_390 ;
struct V_344 * V_240 = V_16 -> V_300 . V_374 ;
struct V_391 * V_3 ;
struct V_11 * V_12 ;
...
T_4 V_392 ;
int V_30 ;
if ( ! F_166 ( V_16 -> V_21 , V_393 ) )
return - V_27 ;
F_167 ( 1 , V_52 , V_16 , L_202 ,
V_16 -> V_22 << 1 ) ;
if ( ! V_240 ) {
F_16 ( V_16 , L_203 ) ;
return - V_375 ;
}
V_40 = F_168 ( & V_16 -> V_300 , sizeof( struct V_8 ) , V_394 ) ;
if ( ! V_40 ) {
F_16 ( V_16 , L_204 ) ;
return - V_395 ;
}
...
V_10 = & V_40 -> V_10 ;
F_169 ( V_10 , V_16 , & V_396 ) ;
V_10 -> V_23 |= V_397 | V_398 ;
V_10 -> V_399 = & V_400 ;
V_40 -> V_57 = V_240 -> V_57 ;
V_40 -> V_207 = V_240 -> V_208 == V_211 ;
V_40 -> V_171 = true ;
V_392 = F_14 ( V_16 , 0xea , false ) << 8 |
F_14 ( V_16 , 0xeb , false ) ;
if ( V_392 != 0x2012 ) {
F_72 ( V_10 , L_205 , V_392 ) ;
V_392 = F_14 ( V_16 , 0xea , false ) << 8 |
F_14 ( V_16 , 0xeb , false ) ;
}
if ( V_392 != 0x2012 ) {
...
F_171 ( V_3 , & V_402 ,
V_135 , 0 , 128 , 1 , 0 ) ;
V_12 = F_172 ( V_3 , & V_402 ,
V_146 , V_147 ,
0 , V_147 ) ;
if ( V_12 )
V_12 -> V_23 |= V_403 ;
V_40 -> V_84 = F_171 ( V_3 , NULL ,
V_404 , 0 , 3 , 0 , 0 ) ;
V_40 -> V_405 = F_173 ( V_3 ,
& V_406 , NULL ) ;
V_40 -> V_407 = F_173 ( V_3 ,
& V_408 , NULL ) ;
V_40 -> V_409 = F_173 ( V_3 ,
& V_410 , NULL ) ;
V_40 -> V_411 =
F_172 ( V_3 , & V_402 ,
V_145 , V_130 ,
...
F_174 ( & V_40 -> V_68 ,
F_63 ) ;
V_40 -> V_168 . V_23 = V_414 ;
V_30 = F_175 ( & V_10 -> V_415 , 1 , & V_40 -> V_168 ) ;
if ( V_30 )
goto V_416;
V_30 = F_146 ( V_10 ) ;
if ( V_30 )
goto V_417;
#if F_131 ( V_287 )
V_40 -> V_80 = F_176 ( & V_418 ,
V_40 , F_177 ( & V_16 -> V_300 ) ,
V_419 | V_420 |
V_421 | V_422 , V_276 ) ;
V_30 = F_178 ( V_40 -> V_80 ) ;
if ( V_30 )
goto V_417;
#endif
