...
static inline void F_43 ( struct V_11 * V_12 , int V_65 )
{
if ( V_63 . type == V_64 )
F_44 ( V_12 , V_65 ) ;
else
...
bool F_66 ( struct V_11 * V_12 , unsigned int V_53 )
{
struct V_1 * V_8 = F_6 ( V_12 -> V_2 , V_12 , V_53 ) ;
bool V_73 ;
F_2 ( & V_8 -> V_25 ) ;
