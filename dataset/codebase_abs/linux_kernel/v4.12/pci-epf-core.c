...
static void F_31 ( struct V_15 * V_4 )
{
...
static int
F_33 ( const struct V_35 * V_36 , const struct V_1 * V_2 )
{
while ( V_36 -> V_26 [ 0 ] ) {
...
static int F_34 ( struct V_15 * V_4 , struct V_37 * V_38 )
{
struct V_1 * V_2 = F_32 ( V_4 ) ;
struct V_20 * V_3 = F_35 ( V_38 ) ;
if ( V_3 -> V_39 )
return F_33 ( V_3 -> V_39 , V_2 ) ;
return ! strcmp ( V_2 -> V_26 , V_38 -> V_26 ) ;
}
static int F_36 ( struct V_15 * V_4 )
{
struct V_1 * V_2 = F_32 ( V_4 ) ;
struct V_20 * V_3 = F_35 ( V_4 -> V_3 ) ;
if ( ! V_3 -> V_40 )
return - V_41 ;
V_2 -> V_3 = V_3 ;
return V_3 -> V_40 ( V_2 ) ;
