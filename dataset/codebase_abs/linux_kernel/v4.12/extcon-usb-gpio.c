...
if ( ! V_23 )
return - V_26 ;
V_6 = F_9 ( & V_19 -> V_21 , sizeof( * V_6 ) , V_27 ) ;
if ( ! V_6 )
return - V_28 ;
V_6 -> V_21 = V_21 ;
V_6 -> V_8 = F_10 ( & V_19 -> V_21 , L_1 , V_29 ) ;
V_6 -> V_9 = F_10 ( & V_19 -> V_21 , L_2 ,
V_29 ) ;
if ( ! V_6 -> V_8 && ! V_6 -> V_9 ) {
F_11 ( V_21 , L_3 ) ;
return - V_30 ;
...
if ( F_12 ( V_6 -> V_9 ) )
return F_13 ( V_6 -> V_9 ) ;
V_6 -> V_10 = F_14 ( V_21 , V_31 ) ;
if ( F_12 ( V_6 -> V_10 ) ) {
F_11 ( V_21 , L_4 ) ;
return - V_28 ;
}
V_25 = F_15 ( V_21 , V_6 -> V_10 ) ;
if ( V_25 < 0 ) {
F_11 ( V_21 , L_5 ) ;
return V_25 ;
}
...
F_18 ( & V_6 -> V_7 , F_1 ) ;
if ( V_6 -> V_8 ) {
V_6 -> V_33 = F_19 ( V_6 -> V_8 ) ;
if ( V_6 -> V_33 < 0 ) {
F_11 ( V_21 , L_6 ) ;
return V_6 -> V_33 ;
}
V_25 = F_20 ( V_21 , V_6 -> V_33 , NULL ,
F_6 ,
V_34 |
V_35 | V_36 ,
V_19 -> V_37 , V_6 ) ;
...
if ( V_6 -> V_9 ) {
V_6 -> V_38 = F_19 ( V_6 -> V_9 ) ;
if ( V_6 -> V_38 < 0 ) {
F_11 ( V_21 , L_8 ) ;
return V_6 -> V_38 ;
}
V_25 = F_20 ( V_21 , V_6 -> V_38 , NULL ,
F_6 ,
V_34 |
V_35 | V_36 ,
V_19 -> V_37 , V_6 ) ;
