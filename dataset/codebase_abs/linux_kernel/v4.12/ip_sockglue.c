...
V_232 = F_42 ( V_17 , V_105 ) ;
if ( ! V_232 ) {
V_38 = - V_108 ;
break;
}
V_38 = - V_178 ;
if ( F_93 ( V_232 , V_161 , V_17 ) ) {
F_39 ( V_232 ) ;
break;
}
...
V_38 = F_101 ( V_240 , V_239 , V_52 , & V_238 , 0 ) ;
break;
}
case V_154 :
case V_156 :
...
V_38 = F_101 ( V_240 , V_239 , V_52 , & V_238 ,
V_251 . V_256 ) ;
break;
}
case V_153 :
...
V_258 = F_42 ( V_17 , V_105 ) ;
if ( ! V_258 ) {
V_38 = - V_108 ;
break;
}
V_38 = - V_178 ;
if ( F_93 ( V_258 , V_161 , V_17 ) )
goto V_261;
if ( V_258 -> V_262 >= 0x1ffffff ||
V_258 -> V_262 > V_71 -> V_235 . V_236 ) {
V_38 = - V_108 ;
goto V_261;
}
if ( F_102 ( V_258 -> V_262 ) > V_17 ) {
V_38 = - V_72 ;
goto V_261;
}
V_259 = F_99 ( V_258 -> V_262 ) ;
...
V_232 -> V_234 = V_258 -> V_262 ;
V_38 = - V_217 ;
for ( V_260 = 0 ; V_260 < V_258 -> V_262 ; ++ V_260 ) {
...
case V_274 :
V_38 = - V_275 ;
if ( ! F_103 ( F_26 ( V_52 ) -> V_276 , V_277 ) )
break;
V_38 = F_104 ( V_52 , V_144 , V_161 , V_17 ) ;
break;
case V_169 :
if ( ! ! V_25 && ! F_103 ( F_26 ( V_52 ) -> V_276 , V_278 ) &&
! F_103 ( F_26 ( V_52 ) -> V_276 , V_277 ) ) {
V_38 = - V_275 ;
break;
}
if ( V_17 < 1 )
...
void F_107 ( const struct V_51 * V_52 , struct V_3 * V_4 )
{
...
if ( V_282 && F_109 ( V_4 ) ) {
if ( V_281 -> V_88 == V_283 )
V_281 -> V_88 = F_110 ( V_4 ) ;
V_281 -> V_89 . V_8 = F_111 ( V_4 ) ;
} else {
V_281 -> V_88 = 0 ;
V_281 -> V_89 . V_8 = 0 ;
}
...
int F_114 ( struct V_51 * V_52 , int V_160 ,
int V_144 , char T_6 * V_161 , unsigned int V_17 )
{
int V_38 ;
if ( V_160 != V_10 )
...
! F_77 ( V_144 ) ) {
F_80 ( V_52 ) ;
V_38 = F_116 ( V_52 , V_188 , V_144 , V_161 , V_17 ) ;
F_105 ( V_52 ) ;
}
#endif
return V_38 ;
}
int F_117 ( struct V_51 * V_52 , int V_160 , int V_144 ,
...
return F_118 ( V_52 , V_160 , V_144 , V_161 , V_17 ,
F_114 ) ;
V_38 = F_75 ( V_52 , V_160 , V_144 , V_161 , V_17 ) ;
#ifdef F_115
if ( V_38 == - V_202 && V_144 != V_165 &&
...
static int F_121 ( struct V_51 * V_52 , int V_160 , int V_144 ,
char T_6 * V_161 , int T_6 * V_17 , unsigned int V_55 )
{
struct V_53 * V_54 = F_24 ( V_52 ) ;
bool V_162 = F_120 ( V_144 ) ;
int V_25 , V_38 = 0 ;
int V_44 ;
if ( V_160 != V_10 )
return - V_284 ;
if ( F_77 ( V_144 ) )
return F_122 ( V_52 , V_144 , V_161 , V_17 ) ;
if ( F_76 ( V_44 , V_17 ) )
return - V_178 ;
if ( V_44 < 0 )
return - V_72 ;
...
return F_123 ( 0 , V_17 ) ;
F_11 ( V_16 ) ;
V_44 = F_124 (unsigned int, len, opt->optlen) ;
if ( F_123 ( V_44 , V_17 ) )
return - V_178 ;
if ( F_125 ( V_161 , V_16 -> V_24 , V_44 ) )
return - V_178 ;
return 0 ;
}
case V_11 :
...
{
struct V_223 V_84 ;
V_44 = F_124 (unsigned int, len, sizeof(struct in_addr)) ;
V_84 . V_8 = V_54 -> V_229 ;
F_105 ( V_52 ) ;
if ( F_123 ( V_44 , V_17 ) )
return - V_178 ;
if ( F_125 ( V_161 , & V_84 , V_44 ) )
return - V_178 ;
return 0 ;
}
case V_150 :
...
if ( F_93 ( & V_258 , V_161 , F_102 ( 0 ) ) ) {
V_38 = - V_178 ;
goto V_140;
}
V_38 = F_130 ( V_52 , & V_258 ,
...
if ( F_123 ( V_44 , V_17 ) )
return - V_178 ;
if ( F_125 ( V_161 , & V_179 , 1 ) )
return - V_178 ;
} else {
V_44 = F_124 (unsigned int, sizeof(int), len) ;
if ( F_123 ( V_44 , V_17 ) )
return - V_178 ;
if ( F_125 ( V_161 , & V_25 , V_44 ) )
return - V_178 ;
}
return 0 ;
V_140:
...
int F_131 ( struct V_51 * V_52 , int V_160 ,
int V_144 , char T_6 * V_161 , int T_6 * V_17 )
{
int V_38 ;
V_38 = F_121 ( V_52 , V_160 , V_144 , V_161 , V_17 , 0 ) ;
#ifdef F_115
...
return - V_178 ;
F_80 ( V_52 ) ;
V_38 = F_132 ( V_52 , V_188 , V_144 , V_161 ,
& V_44 ) ;
F_105 ( V_52 ) ;
if ( V_38 >= 0 )
V_38 = F_123 ( V_44 , V_17 ) ;
return V_38 ;
}
#endif
return V_38 ;
}
int F_133 ( struct V_51 * V_52 , int V_160 , int V_144 ,
char T_6 * V_161 , int T_6 * V_17 )
{
int V_38 ;
if ( V_144 == V_153 )
return F_134 ( V_52 , V_160 , V_144 , V_161 , V_17 ,
F_131 ) ;
V_38 = F_121 ( V_52 , V_160 , V_144 , V_161 , V_17 ,
V_297 ) ;
#ifdef F_115
if ( V_38 == - V_202 && V_144 != V_291 &&
! F_77 ( V_144 ) ) {
...
return - V_178 ;
F_80 ( V_52 ) ;
V_38 = F_135 ( V_52 , V_188 , V_144 , V_161 , & V_44 ) ;
F_105 ( V_52 ) ;
if ( V_38 >= 0 )
V_38 = F_123 ( V_44 , V_17 ) ;
return V_38 ;
