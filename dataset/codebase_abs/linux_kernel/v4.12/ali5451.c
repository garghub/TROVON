...
F_114 ( V_170 -> V_86 [ V_110 ] ) ;
F_115 ( V_170 -> V_24 [ V_110 ] ) ;
}
F_54 ( & V_170 -> V_85 ) ;
...
static int F_116 ( struct V_182 * V_9 )
{
struct V_215 * V_8 = F_112 ( V_9 ) ;
struct V_1 * V_170 = V_8 -> V_25 ;
struct V_216 * V_217 ;
...
unsigned char V_227 ;
struct V_31 * V_31 ;
F_10 ( V_2 -> V_8 -> V_9 , L_35 ) ;
if ( F_17 ( V_2 ) ) {
F_12 ( V_2 -> V_8 -> V_9 , L_36 ) ;
return - 1 ;
}
if ( V_2 -> V_20 == V_21 ) {
V_31 = V_2 -> V_34 ;
F_43 ( V_31 , 0x59 , & V_227 ) ;
V_227 |= 0x80 ;
F_44 ( V_31 , 0x59 , V_227 ) ;
V_31 = V_2 -> V_225 ;
F_43 ( V_31 , 0xb8 , & V_227 ) ;
V_227 |= 0x20 ;
F_44 ( V_31 , 0xB8 , V_227 ) ;
}
F_18 ( V_2 -> V_35 , 0x44 , & V_226 ) ;
V_226 &= 0xff00ff00 ;
V_226 |= 0x000800aa ;
F_19 ( V_2 -> V_35 , 0x44 , V_226 ) ;
F_5 ( 0x80000001 , F_3 ( V_2 , V_38 ) ) ;
F_5 ( 0x00000000 , F_3 ( V_2 , V_148 ) ) ;
F_5 ( 0xffffffff , F_3 ( V_2 , V_228 ) ) ;
F_5 ( 0x00000000 , F_3 ( V_2 , V_229 ) ) ;
F_35 ( 0x10 , F_3 ( V_2 , V_230 ) ) ;
V_2 -> V_231 = F_14 ( V_2 , 0 , V_232 ) ;
V_2 -> V_233 = F_14 ( V_2 , 0 ,
V_234 ) ;
if ( V_2 -> V_55 ) {
F_42 ( V_2 ) ;
...
F_10 ( V_2 -> V_8 -> V_9 , L_37 ) ;
return 0 ;
}
static void F_126 ( struct V_239 * V_240 ,
struct V_241 * V_242 )
{
struct V_1 * V_2 = V_240 -> V_25 ;
int V_110 ;
for ( V_110 = 0 ; V_110 < 256 ; V_110 += 4 )
F_127 ( V_242 , L_38 , V_110 , F_2 ( F_3 ( V_2 , V_110 ) ) ) ;
}
static void F_128 ( struct V_1 * V_2 )
{
struct V_239 * V_240 ;
if ( ! F_129 ( V_2 -> V_8 , L_39 , & V_240 ) )
F_130 ( V_240 , V_2 , F_126 ) ;
}
static int F_131 ( struct V_1 * V_2 )
{
int V_152 ;
F_10 ( V_2 -> V_8 -> V_9 , L_40 ) ;
V_152 = F_132 ( V_2 -> V_35 , L_41 ) ;
if ( V_152 < 0 )
return V_152 ;
V_2 -> V_3 = F_133 ( V_2 -> V_35 , 0 ) ;
if ( F_134 ( V_2 -> V_35 -> V_92 , F_52 ,
V_243 , V_244 , V_2 ) ) {
F_12 ( V_2 -> V_8 -> V_9 , L_42 ) ;
return - V_245 ;
}
V_2 -> V_92 = V_2 -> V_35 -> V_92 ;
F_10 ( V_2 -> V_8 -> V_9 , L_43 ) ;
return 0 ;
}
static int F_135 ( struct V_246 * V_182 )
{
struct V_1 * V_2 = V_182 -> V_247 ;
F_118 ( V_2 ) ;
return 0 ;
}
static int F_136 ( struct V_215 * V_8 ,
struct V_31 * V_35 ,
int V_248 ,
int V_55 ,
struct V_1 * * V_249 )
...
if ( V_152 < 0 )
return V_152 ;
if ( F_138 ( & V_35 -> V_9 , F_139 ( 31 ) ) < 0 ||
F_140 ( & V_35 -> V_9 , F_139 ( 31 ) ) < 0 ) {
F_12 ( V_8 -> V_9 ,
L_45 ) ;
F_121 ( V_35 ) ;
return - V_253 ;
}
V_2 = F_141 ( sizeof( * V_2 ) , V_254 ) ;
if ( ! V_2 ) {
F_121 ( V_35 ) ;
return - V_153 ;
}
...
V_248 = 32 ;
F_143 ( V_35 ) ;
F_144 ( V_35 , V_255 , & V_250 ) ;
if ( ( V_250 & V_256 ) != V_256 ) {
V_250 |= V_256 ;
F_145 ( V_35 , V_255 , V_250 ) ;
}
F_143 ( V_35 ) ;
if ( F_131 ( V_2 ) ) {
F_118 ( V_2 ) ;
...
V_2 -> V_49 . V_257 = 0 ;
if ( V_2 -> V_20 == V_21 )
V_2 -> V_17 . V_18 . V_22 = V_258 ;
else
V_2 -> V_17 . V_18 . V_22 = V_259 ;
V_2 -> V_17 . V_18 . V_19 = V_258 ;
V_2 -> V_17 . V_18 . V_260 = V_149 ;
V_2 -> V_17 . V_18 . V_61 = V_147 ;
V_2 -> V_17 . V_18 . V_83 = V_228 ;
V_2 -> V_17 . V_18 . V_47 = V_148 ;
V_2 -> V_17 . V_46 . V_260 = 0x00 ;
V_2 -> V_17 . V_46 . V_61 = 0x00 ;
V_2 -> V_17 . V_46 . V_83 = 0x00 ;
V_2 -> V_17 . V_46 . V_47 = 0x00 ;
V_2 -> V_34 = F_147 ( 0x10b9 , 0x1533 , NULL ) ;
if ( ! V_2 -> V_34 ) {
F_12 ( V_8 -> V_9 , L_46 ) ;
F_118 ( V_2 ) ;
return - V_261 ;
}
V_2 -> V_225 = F_147 ( 0x10b9 , 0x7101 , NULL ) ;
if ( ! V_2 -> V_225 && V_2 -> V_20 == V_21 ) {
F_12 ( V_8 -> V_9 , L_47 ) ;
F_118 ( V_2 ) ;
return - V_261 ;
}
F_10 ( V_8 -> V_9 , L_48 ) ;
V_152 = F_148 ( V_8 , V_262 , V_2 , & V_210 ) ;
if ( V_152 < 0 ) {
F_118 ( V_2 ) ;
return V_152 ;
}
...
#ifdef F_122
V_2 -> V_219 = F_149 ( sizeof( * V_2 -> V_219 ) , V_254 ) ;
if ( ! V_2 -> V_219 )
F_79 ( V_8 -> V_9 , L_50 ) ;
#endif
F_24 ( V_2 ) ;
...
static int F_150 ( struct V_31 * V_35 ,
...
int V_152 ;
F_10 ( & V_35 -> V_9 , L_52 ) ;
V_152 = F_151 ( & V_35 -> V_9 , V_265 , V_266 , V_267 , 0 , & V_8 ) ;
if ( V_152 < 0 )
return V_152 ;
V_152 = F_136 ( V_8 , V_35 , V_268 , V_269 , & V_2 ) ;
if ( V_152 < 0 )
goto error;
V_8 -> V_25 = V_2 ;
F_10 ( & V_35 -> V_9 , L_53 ) ;
...
goto error;
F_128 ( V_2 ) ;
strcpy ( V_8 -> V_270 , L_55 ) ;
strcpy ( V_8 -> V_271 , L_41 ) ;
sprintf ( V_8 -> V_272 , L_56 ,
V_8 -> V_271 , V_2 -> V_3 , V_2 -> V_92 ) ;
F_10 ( & V_35 -> V_9 , L_57 ) ;
V_152 = F_152 ( V_8 ) ;
if ( V_152 < 0 )
goto error;
...
static void F_155 ( struct V_31 * V_35 )
{
F_154 ( F_156 ( V_35 ) ) ;
}
