...
if ( V_26 -> V_75 & V_116 ) {
int V_19 ;
for ( V_19 = 0 ; V_19 < V_117 ; V_19 ++ ) {
T_1 V_118 ;
if ( V_26 -> V_119 [ V_19 ] . V_30 == 0 )
break;
if ( V_26 -> V_119 [ V_19 ] . V_120 != 0 ) {
T_1 V_99 =
V_26 -> V_119 [ V_19 ] . V_121 ;
T_1 V_122 = V_28 [ V_99 ] &
V_26 -> V_119 [ V_19 ] . V_120 ;
if ( V_122 == 0 )
continue;
}
V_118 = V_28 [ V_26 -> V_119 [ V_19 ] . V_99 ] &
V_26 -> V_119 [ V_19 ] . V_30 ;
if ( V_118 != V_26 -> V_119 [ V_19 ] . V_123 ) {
F_2 ( L_17 ,
* V_28 ,
V_26 -> V_119 [ V_19 ] . V_30 ,
V_26 -> V_119 [ V_19 ] . V_123 ,
V_118 , V_15 -> V_113 ) ;
return false ;
}
}
...
{
T_1 * V_28 , * V_126 ;
struct V_25 V_72 = V_127 ;
const struct V_25 * V_26 = & V_72 ;
bool V_88 = false ;
int V_20 = 0 ;
V_28 = F_30 ( V_125 , V_124 ,
V_86 , V_87 ,
& V_88 ) ;
if ( F_35 ( V_28 ) ) {
F_2 ( L_18 ) ;
...
V_126 = V_28 + ( V_87 / sizeof( * V_126 ) ) ;
do {
T_1 V_74 ;
if ( * V_28 == V_128 ) {
if ( V_88 ) {
void * V_98 = F_52 ( V_125 -> V_129 . V_130 ) ;
F_45 ( V_98 ,
( void * ) ( V_28 + 1 ) - V_98 ) ;
}
break;
...
if ( V_26 -> V_28 . V_29 == V_132 ) {
V_20 = - V_133 ;
break;
}
if ( V_26 -> V_75 & V_134 )
V_74 = V_26 -> V_74 . V_135 ;
else
V_74 = ( ( * V_28 & V_26 -> V_74 . V_30 ) + V_136 ) ;
if ( ( V_126 - V_28 ) < V_74 ) {
F_2 ( L_20 ,
* V_28 ,
V_74 ,
