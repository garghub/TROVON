...
F_63 ( V_91 , V_197 , V_198 ) ;
F_63 ( V_91 , V_199 , V_200 ) ;
if ( V_91 -> V_201 || V_91 -> V_202 )
F_9 ( F_64 ( V_203 ) , V_88 ) ;
if ( V_91 -> V_204 || V_91 -> V_205 )
F_9 ( F_64 ( V_206 ) , V_88 ) ;
F_63 ( V_91 , V_207 , V_202 ) ;
F_63 ( V_91 , V_208 , V_205 ) ;
if ( V_91 -> V_209 || V_91 -> V_202 )
F_9 ( F_64 ( V_210 ) , V_88 ) ;
} else if ( V_95 ) {
if ( ( V_102 && ( V_91 -> V_211 ||
V_91 -> V_212 ) ) ||
...
if ( V_105 && ( V_97 || V_98 ) ) {
F_63 ( V_91 , V_300 , V_144 ) ;
F_63 ( V_91 , V_301 , V_302 ) ;
}
if ( V_102 ) {
F_63 ( V_91 , V_303 , V_143 ) ;
F_63 ( V_91 , V_304 , V_305 ) ;
F_63 ( V_91 , V_306 , V_307 ) ;
}
...
V_7 -> V_32 . V_321 . V_23 . V_322 = V_323 ;
V_7 -> V_32 . V_321 . V_23 . V_27 = V_7 -> V_27 ;
...
int F_71 ( struct V_6 * V_7 , int type , int V_331 ,
int V_332 , struct V_333 * V_334 )
{
int V_87 = 0 ;
int V_54 ;
int V_335 = 0 ;
...
#endif
F_24 ( & V_26 ) ;
V_331 = F_12 ( V_7 , V_331 == - 1 ? 0 : V_331 , V_336 ) ;
if ( V_331 == V_336 )
V_331 = F_12 ( V_7 , 0 , V_336 ) ;
if ( V_331 == V_336 ) {
F_47 ( V_340 L_18 ) ;
F_26 ( & V_26 ) ;
return - V_342 ;
...
V_7 -> V_28 -> V_91 = & V_344 ;
V_7 -> V_28 -> V_334 = V_334 ;
V_54 = F_76 ( V_7 -> V_28 , F_77 ( V_323 , V_7 -> V_27 ) , 1 ) ;
if ( V_54 < 0 ) {
F_47 ( V_340 L_20 , V_325 ) ;
F_17 ( V_7 -> V_28 ) ;
V_7 -> V_28 = NULL ;
goto V_343;
}
V_7 -> V_23 . V_345 = & V_346 ;
V_7 -> V_23 . V_347 = F_77 ( V_323 , V_7 -> V_27 ) ;
V_7 -> V_23 . V_348 = V_7 -> V_341 ;
F_78 ( & V_7 -> V_23 , L_21 , V_337 , V_7 -> V_19 ) ;
V_54 = F_79 ( & V_7 -> V_23 ) ;
if ( V_54 < 0 ) {
F_47 ( V_340 L_22 , V_325 ) ;
goto V_343;
}
V_7 -> V_23 . V_35 = F_23 ;
if ( V_331 != - 1 && V_331 != V_7 -> V_19 && V_332 )
F_47 ( V_324 L_23 , V_325 ,
V_337 , V_331 , F_48 ( V_7 ) ) ;
F_80 ( V_7 -> V_25 ) ;
V_54 = F_67 ( V_7 , type ) ;
F_9 ( V_349 , & V_7 -> V_77 ) ;
return 0 ;
...
{
T_8 V_23 = F_77 ( V_323 , 0 ) ;
int V_54 ;
F_47 ( V_350 L_24 ) ;
V_54 = F_84 ( V_23 , V_86 , V_351 ) ;
if ( V_54 < 0 ) {
F_47 ( V_324 L_25 ,
V_323 ) ;
return V_54 ;
