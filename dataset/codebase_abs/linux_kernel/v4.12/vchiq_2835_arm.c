...
V_96 ++ ) {
struct V_93 * V_104 = F_56 ( V_75 + ( V_96 *
V_28 ) ) ;
...
unsigned int V_76 = V_28 - V_57 ;
if ( V_76 > V_90 )
V_76 = V_90 ;
F_61 ( V_83 + V_18 , V_87 [ V_18 ] , V_76 , V_57 ) ;
V_57 = 0 ;
V_90 -= V_76 ;
}
V_99 = F_62 ( V_43 ,
...
V_61 -> V_82 = 1 ;
V_95 = 0 ;
F_63 (scatterlist, sg, dma_buffers, i) {
T_4 V_76 = F_64 ( V_98 ) ;
T_4 V_109 = F_65 ( V_98 ) ;
F_9 ( V_76 == 0 ) ;
F_9 ( V_18 && ( V_18 != ( V_99 - 1 ) ) && ( V_76 & ~ V_110 ) ) ;
F_9 ( V_18 && ( V_109 & ~ V_110 ) ) ;
if ( V_95 > 0 &&
( ( V_94 [ V_95 - 1 ] & V_110 ) +
( ( ( V_94 [ V_95 - 1 ] & ~ V_110 ) + 1 ) << V_111 ) )
== ( V_109 & V_110 ) )
V_94 [ V_95 - 1 ] += ( ( V_76 + V_28 - 1 ) >> V_111 ) ;
else
V_94 [ V_95 ++ ] = ( V_109 & V_110 ) |
( ( ( V_76 + V_28 - 1 ) >> V_111 ) - 1 ) ;
}
if ( ( type == V_65 ) &&
( ( V_89 -> V_57 & ( V_20 - 1 ) ) ||
