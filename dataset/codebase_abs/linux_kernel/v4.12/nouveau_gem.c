...
int V_12 = 0 ;
unsigned V_103 ;
V_133 = F_74 ( V_76 -> V_121 , V_76 -> V_134 , sizeof( * V_133 ) ) ;
if ( F_79 ( V_133 ) )
return F_80 ( V_133 ) ;
for ( V_103 = 0 ; V_103 < V_76 -> V_134 ; V_103 ++ ) {
struct V_132 * V_135 = & V_133 [ V_103 ] ;
struct V_88 * V_90 ;
struct V_3 * V_4 ;
T_2 V_28 ;
if ( F_51 ( V_135 -> V_136 > V_76 -> V_101 ) ) {
F_40 ( V_77 , V_20 , L_13 ) ;
V_12 = - V_67 ;
break;
}
V_90 = & V_7 [ V_135 -> V_136 ] ;
if ( V_90 -> V_122 . V_123 )
continue;
if ( F_51 ( V_135 -> V_137 > V_76 -> V_101 ) ) {
F_40 ( V_77 , V_20 , L_14 ) ;
V_12 = - V_67 ;
break;
}
V_4 = ( void * ) ( unsigned long ) V_7 [ V_135 -> V_137 ] . V_114 ;
...
if ( ! V_4 -> V_96 . V_139 ) {
V_12 = F_81 ( & V_4 -> V_7 , 0 , V_4 -> V_7 . V_30 . V_68 ,
& V_4 -> V_96 ) ;
if ( V_12 ) {
F_40 ( V_77 , V_20 , L_16 ) ;
break;
...
if ( V_135 -> V_48 & V_140 )
V_28 = V_90 -> V_122 . V_66 + V_135 -> V_28 ;
else
if ( V_135 -> V_48 & V_141 )
V_28 = ( V_90 -> V_122 . V_66 + V_135 -> V_28 ) >> 32 ;
else
V_28 = V_135 -> V_28 ;
if ( V_135 -> V_48 & V_142 ) {
...
F_82 ( V_4 , V_135 -> V_138 >> 2 , V_28 ) ;
}
F_72 ( V_133 ) ;
return V_12 ;
}
int
F_83 ( struct V_72 * V_11 , void * V_28 ,
struct V_17 * V_18 )
{
struct V_145 * V_146 = F_84 ( V_18 ) ;
struct V_19 * V_20 = V_19 ( V_18 ) ;
struct V_147 * V_148 ;
struct V_5 * V_6 = V_5 ( V_11 ) ;
struct V_131 * V_76 = V_28 ;
struct V_149 * V_150 ;
struct V_88 * V_7 ;
struct V_99 * V_100 = NULL ;
struct V_85 V_86 ;
struct V_87 * V_38 = NULL ;
int V_103 , V_151 , V_12 = 0 , V_152 = 0 ;
if ( F_51 ( ! V_146 ) )
return - V_25 ;
F_66 (temp, &abi16->channels, head) {
if ( V_148 -> V_100 -> V_153 == V_76 -> V_154 ) {
V_100 = V_148 -> V_100 ;
break;
}
}
if ( ! V_100 )
return F_85 ( V_146 , - V_111 ) ;
V_76 -> V_155 = V_6 -> V_2 . V_155 ;
V_76 -> V_156 = V_6 -> V_2 . V_156 ;
if ( F_51 ( V_76 -> V_157 == 0 ) )
goto V_158;
if ( F_51 ( V_76 -> V_157 > V_159 ) ) {
F_40 ( V_77 , V_20 , L_18 ,
V_76 -> V_157 , V_159 ) ;
return F_85 ( V_146 , - V_67 ) ;
}
if ( F_51 ( V_76 -> V_101 > V_160 ) ) {
F_40 ( V_77 , V_20 , L_19 ,
V_76 -> V_101 , V_160 ) ;
return F_85 ( V_146 , - V_67 ) ;
}
if ( F_51 ( V_76 -> V_134 > V_161 ) ) {
F_40 ( V_77 , V_20 , L_20 ,
V_76 -> V_134 , V_161 ) ;
return F_85 ( V_146 , - V_67 ) ;
}
V_150 = F_74 ( V_76 -> V_150 , V_76 -> V_157 , sizeof( * V_150 ) ) ;
if ( F_79 ( V_150 ) )
return F_85 ( V_146 , F_80 ( V_150 ) ) ;
V_7 = F_74 ( V_76 -> V_162 , V_76 -> V_101 , sizeof( * V_7 ) ) ;
if ( F_79 ( V_7 ) ) {
F_72 ( V_150 ) ;
return F_85 ( V_146 , F_80 ( V_7 ) ) ;
}
for ( V_103 = 0 ; V_103 < V_76 -> V_157 ; V_103 ++ ) {
if ( V_150 [ V_103 ] . V_136 >= V_76 -> V_101 ) {
F_40 ( V_77 , V_20 , L_21 , V_103 ) ;
V_12 = - V_67 ;
goto V_163;
}
}
V_12 = F_70 ( V_100 , V_18 , V_7 , V_76 -> V_162 ,
V_76 -> V_101 , & V_86 , & V_152 ) ;
if ( V_12 ) {
if ( V_12 != - V_113 )
...
if ( V_152 ) {
V_12 = F_78 ( V_20 , V_76 , V_7 ) ;
if ( V_12 ) {
F_40 ( V_77 , V_20 , L_23 , V_12 ) ;
goto V_26;
}
}
if ( V_100 -> V_164 . V_165 ) {
V_12 = F_86 ( V_100 , V_76 -> V_157 + 1 , 16 ) ;
if ( V_12 ) {
...
V_7 [ V_150 [ V_103 ] . V_136 ] . V_114 ;
F_87 ( V_100 , V_4 , V_150 [ V_103 ] . V_66 ,
V_150 [ V_103 ] . V_166 ) ;
}
} else
if ( V_6 -> V_58 . V_10 . V_59 . V_167 >= 0x25 ) {
V_12 = F_88 ( V_100 , V_76 -> V_157 * 2 ) ;
if ( V_12 ) {
...
struct V_3 * V_4 = ( void * ) ( unsigned long )
V_7 [ V_150 [ V_103 ] . V_136 ] . V_114 ;
F_89 ( V_100 , ( V_4 -> V_7 . V_66 + V_150 [ V_103 ] . V_66 ) | 2 ) ;
F_89 ( V_100 , 0 ) ;
}
} else {
V_12 = F_88 ( V_100 , V_76 -> V_157 * ( 2 + V_168 ) ) ;
if ( V_12 ) {
...
V_7 [ V_150 [ V_103 ] . V_136 ] . V_114 ;
T_2 V_169 ;
V_169 = V_100 -> V_150 . V_22 . V_66 + ( ( V_100 -> V_164 . V_170 + 2 ) << 2 ) ;
V_169 |= 0x20000000 ;
if ( F_51 ( V_169 != V_76 -> V_171 ) ) {
if ( ! V_4 -> V_96 . V_139 ) {
V_12 = F_81 ( & V_4 -> V_7 , 0 ,
V_4 -> V_7 . V_30 .
V_68 ,
...
F_82 ( V_4 , ( V_150 [ V_103 ] . V_66 +
V_150 [ V_103 ] . V_166 - 8 ) / 4 , V_169 ) ;
}
F_89 ( V_100 , 0x20000000 |
( V_4 -> V_7 . V_66 + V_150 [ V_103 ] . V_66 ) ) ;
F_89 ( V_100 , 0 ) ;
for ( V_151 = 0 ; V_151 < V_168 ; V_151 ++ )
F_89 ( V_100 , 0 ) ;
}
}
V_12 = F_91 ( V_100 , false , & V_38 ) ;
if ( V_12 ) {
...
V_158:
if ( V_100 -> V_164 . V_165 ) {
V_76 -> V_171 = 0x00000000 ;
V_76 -> V_172 = 0x00000000 ;
} else
if ( V_6 -> V_58 . V_10 . V_59 . V_167 >= 0x25 ) {
V_76 -> V_171 = 0x00020000 ;
V_76 -> V_172 = 0x00000000 ;
} else {
V_76 -> V_171 = 0x20000000 |
( V_100 -> V_150 . V_22 . V_66 + ( ( V_100 -> V_164 . V_170 + 2 ) << 2 ) ) ;
V_76 -> V_172 = 0x00000000 ;
}
return F_85 ( V_146 , V_12 ) ;
}
int
F_93 ( struct V_72 * V_11 , void * V_28 ,
struct V_17 * V_18 )
{
struct V_173 * V_76 = V_28 ;
struct V_1 * V_2 ;
struct V_3 * V_4 ;
bool V_174 = ! ! ( V_76 -> V_48 & V_175 ) ;
bool V_176 = ! ! ( V_76 -> V_48 & V_177 ) ;
long V_178 ;
int V_12 ;
...
return - V_111 ;
V_4 = F_2 ( V_2 ) ;
V_178 = F_94 ( V_4 -> V_7 . V_34 , V_176 , true ,
V_174 ? 0 : 30 * V_179 ) ;
if ( ! V_178 )
V_12 = - V_180 ;
else if ( V_178 > 0 )
...
int
F_96 ( struct V_72 * V_11 , void * V_28 ,
struct V_17 * V_18 )
{
struct V_181 * V_76 = V_28 ;
struct V_1 * V_2 ;
struct V_3 * V_4 ;
V_2 = F_59 ( V_18 , V_76 -> V_78 ) ;
if ( ! V_2 )
...
int
F_98 ( struct V_72 * V_11 , void * V_28 ,
struct V_17 * V_18 )
{
