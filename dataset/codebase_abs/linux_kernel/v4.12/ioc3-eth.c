...
static int F_140 ( struct V_6 * V_9 , struct V_1 * V_3 )
{
unsigned long V_11 ;
struct V_2 * V_37 = F_27 ( V_3 ) ;
struct V_19 * V_19 = V_37 -> V_38 ;
...
int V_268 ;
if ( V_9 -> V_77 == V_269 ) {
const struct V_63 * V_64 = F_141 ( V_9 ) ;
const int V_62 = F_142 ( V_64 -> V_70 ) ;
unsigned int V_270 ;
T_4 V_60 , V_61 ;
T_5 * V_59 ;
V_59 = ( T_5 * ) V_9 -> V_11 ;
...
V_61 = ( V_61 & 0xffff ) + ( V_61 >> 16 ) ;
V_61 = ( V_61 & 0xffff ) + ( V_61 >> 16 ) ;
V_60 = F_143 ( V_64 -> V_75 , V_64 -> V_76 ,
V_64 -> V_73 - ( V_64 -> V_74 << 2 ) ,
V_62 , 0xffff ^ V_61 ) ;
V_60 = ( V_60 & 0xffff ) + ( V_60 >> 16 ) ;
V_60 = ( V_60 & 0xffff ) + ( V_60 >> 16 ) ;
...
if ( V_62 == V_72 ) {
V_270 += F_144 ( struct V_271 , V_272 ) ;
F_145 ( V_9 ) -> V_272 = V_60 ;
}
if ( V_62 == V_71 ) {
V_270 += F_144 ( struct V_273 , V_272 ) ;
F_146 ( V_9 ) -> V_272 = V_60 ;
}
...
V_57 = V_9 -> V_57 ;
V_268 = V_37 -> V_155 ;
V_267 = & V_37 -> V_153 [ V_268 ] ;
if ( V_57 <= 104 ) {
F_147 ( V_9 , V_267 -> V_11 , V_9 -> V_57 ) ;
if ( V_57 < V_276 ) {
memset ( V_267 -> V_11 + V_57 , 0 , V_276 - V_57 ) ;
V_57 = V_276 ;
}
V_267 -> V_154 = F_148 ( V_57 | V_277 | V_278 | V_85 ) ;
V_267 -> V_279 = F_148 ( V_57 ) ;
} else if ( ( V_11 ^ ( V_11 + V_57 - 1 ) ) & 0x4000 ) {
unsigned long V_280 = ( V_11 | 0x3fffUL ) + 1UL ;
unsigned long V_281 = V_280 - V_11 ;
unsigned long V_282 = V_11 + V_57 - V_280 ;
V_267 -> V_154 = F_148 ( V_57 | V_277 |
V_283 | V_284 | V_85 ) ;
V_267 -> V_279 = F_148 ( ( V_281 << V_285 ) |
( V_282 << V_286 ) ) ;
V_267 -> V_287 = F_51 ( F_7 ( V_9 -> V_11 , 1 ) ) ;
V_267 -> V_288 = F_51 ( F_7 ( ( void * ) V_280 , 1 ) ) ;
} else {
V_267 -> V_154 = F_148 ( V_57 | V_277 | V_283 | V_85 ) ;
V_267 -> V_279 = F_148 ( V_57 << V_285 ) ;
V_267 -> V_287 = F_51 ( F_7 ( V_9 -> V_11 , 1 ) ) ;
}
F_149 () ;
V_37 -> V_115 [ V_268 ] = V_9 ;
V_268 = ( V_268 + 1 ) & 127 ;
V_37 -> V_155 = V_268 ;
F_89 ( V_268 << 7 ) ;
V_37 -> V_118 ++ ;
...
static void F_150 ( struct V_1 * V_3 )
{
struct V_2 * V_37 = F_27 ( V_3 ) ;
...
static inline unsigned int F_151 ( const unsigned char * V_4 )
{
unsigned int V_290 = 0 ;
T_1 V_33 ;
int V_291 ;
V_33 = F_152 ( V_292 , V_4 ) ;
V_33 &= 0x3f ;
for ( V_291 = 6 ; -- V_291 >= 0 ; ) {
V_290 <<= 1 ;
V_290 |= ( V_33 & 0x1 ) ;
...
{
struct V_2 * V_37 = F_27 ( V_3 ) ;
F_154 ( V_294 -> V_295 , V_296 , sizeof( V_294 -> V_295 ) ) ;
F_154 ( V_294 -> V_297 , V_298 , sizeof( V_294 -> V_297 ) ) ;
F_154 ( V_294 -> V_299 , F_122 ( V_37 -> V_181 ) , sizeof( V_294 -> V_299 ) ) ;
}
static int F_155 ( struct V_1 * V_3 ,
struct V_300 * V_154 )
{
struct V_2 * V_37 = F_27 ( V_3 ) ;
int V_301 ;
F_31 ( & V_37 -> V_46 ) ;
V_301 = F_156 ( & V_37 -> V_135 , V_154 ) ;
F_32 ( & V_37 -> V_46 ) ;
return V_301 ;
}
static int F_157 ( struct V_1 * V_3 ,
const struct V_300 * V_154 )
{
struct V_2 * V_37 = F_27 ( V_3 ) ;
int V_301 ;
F_31 ( & V_37 -> V_46 ) ;
V_301 = F_158 ( & V_37 -> V_135 , V_154 ) ;
F_32 ( & V_37 -> V_46 ) ;
return V_301 ;
}
static int F_159 ( struct V_1 * V_3 )
{
struct V_2 * V_37 = F_27 ( V_3 ) ;
int V_301 ;
F_31 ( & V_37 -> V_46 ) ;
V_301 = F_160 ( & V_37 -> V_135 ) ;
F_32 ( & V_37 -> V_46 ) ;
return V_301 ;
}
static T_1 F_161 ( struct V_1 * V_3 )
{
struct V_2 * V_37 = F_27 ( V_3 ) ;
int V_301 ;
F_31 ( & V_37 -> V_46 ) ;
V_301 = F_162 ( & V_37 -> V_135 ) ;
F_32 ( & V_37 -> V_46 ) ;
return V_301 ;
}
static int F_163 ( struct V_1 * V_3 , struct V_302 * V_303 , int V_154 )
{
struct V_2 * V_37 = F_27 ( V_3 ) ;
int V_301 ;
F_31 ( & V_37 -> V_46 ) ;
V_301 = F_164 ( & V_37 -> V_135 , F_165 ( V_303 ) , V_154 , NULL ) ;
F_32 ( & V_37 -> V_46 ) ;
return V_301 ;
}
static void F_166 ( struct V_1 * V_3 )
{
struct V_304 * V_305 ;
struct V_2 * V_37 = F_27 ( V_3 ) ;
struct V_19 * V_19 = V_37 -> V_38 ;
...
F_168 (ha, dev) {
V_306 |= ( 1UL << F_151 ( V_305 -> V_4 ) ) ;
}
V_37 -> V_169 = V_306 >> 32 ;
V_37 -> V_170 = V_306 & 0xffffffff ;
}
F_97 ( V_37 -> V_169 ) ;
F_98 ( V_37 -> V_170 ) ;
}
