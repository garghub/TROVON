...
if ( V_2 -> V_60 -> V_134 [ V_2 -> V_135 ] . V_145 &&
V_2 -> V_146 [ 0 ] . V_147 )
V_113 += V_2 -> V_148 *
( sizeof( * V_4 ) +
sizeof( struct V_149 ) +
...
if ( V_2 -> V_48 -> V_143 == V_151 &&
F_36 ( V_2 -> V_9 -> V_152 ) == V_153 )
V_113 += sizeof( * V_4 ) + sizeof( * V_102 ) +
V_154 ;
if ( V_2 -> V_73 )
...
V_106 -> V_155 = V_98 ;
V_98 -> V_156 = F_3 ( V_157 ) ;
V_4 = ( void * ) V_98 -> V_6 ;
V_4 -> type = F_3 ( V_158 ) ;
V_4 -> V_11 = F_3 ( sizeof( * V_100 ) ) ;
V_100 = ( void * ) V_4 -> V_6 ;
V_100 -> V_143 =
V_2 -> V_48 -> V_143 == V_144 ?
F_3 ( V_159 ) :
F_3 ( V_160 ) ;
V_100 -> V_161 = F_3 ( F_36 ( V_2 -> V_9 -> V_152 ) ) ;
memcpy ( V_100 -> V_162 , V_2 -> V_60 -> V_163 ,
sizeof( V_100 -> V_162 ) ) ;
strncpy ( V_100 -> V_164 , V_2 -> V_48 -> V_165 ,
sizeof( V_100 -> V_164 ) ) ;
strncpy ( V_100 -> V_166 , V_2 -> V_167 -> V_168 -> V_165 ,
sizeof( V_100 -> V_166 ) ) ;
V_4 = F_6 ( V_4 ) ;
if ( F_32 ( V_138 , & V_2 -> V_9 -> V_126 ) ) {
F_12 ( V_2 , & V_4 ) ;
...
T_2 V_174 = F_35 ( V_111 [ V_8 ] . V_174 ) ;
bool V_78 ;
V_4 -> type = F_3 ( V_172 ) ;
V_4 -> V_11 = F_3 ( V_11 + sizeof( * V_102 ) ) ;
V_102 = ( void * ) V_4 -> V_6 ;
V_102 -> type = V_111 [ V_8 ] . V_175 ;
V_102 -> V_19 = F_3 ( V_174 ) ;
switch ( V_102 -> type & F_3 ( V_176 ) ) {
case F_3 ( V_177 ) :
F_38 ( V_2 -> V_9 , V_174 ,
V_102 -> V_6 ,
V_11 ) ;
...
V_102 = ( void * ) V_4 -> V_6 ;
V_102 -> type = F_3 ( V_179 ) ;
V_102 -> V_19 = F_3 ( V_2 -> V_48 -> V_180 ) ;
F_38 ( V_2 -> V_9 , V_2 -> V_48 -> V_180 ,
V_102 -> V_6 , V_117 ) ;
V_4 = F_6 ( V_4 ) ;
}
if ( V_119 ) {
...
V_102 = ( void * ) V_4 -> V_6 ;
V_102 -> type = F_3 ( V_173 ) ;
V_102 -> V_19 = F_3 ( V_2 -> V_48 -> V_181 ) ;
F_38 ( V_2 -> V_9 , V_2 -> V_48 -> V_181 ,
V_102 -> V_6 , V_119 ) ;
V_4 = F_6 ( V_4 ) ;
}
if ( V_2 -> V_48 -> V_143 == V_151 &&
...
if ( V_2 -> V_60 -> V_134 [ V_2 -> V_135 ] . V_145 &&
V_2 -> V_146 [ 0 ] . V_147 ) {
for ( V_8 = 1 ; V_8 < V_2 -> V_148 + 1 ; V_8 ++ ) {
struct V_149 * V_183 ;
struct V_91 * V_184 =
V_2 -> V_146 [ V_8 ] . V_147 ;
T_4 V_185 = V_2 -> V_146 [ V_8 ] . V_186 ;
V_4 -> type = F_3 ( V_187 ) ;
V_4 -> V_11 = F_3 ( sizeof( * V_183 ) +
V_150 ) ;
V_183 = ( void * ) V_4 -> V_6 ;
V_183 -> V_188 = F_3 ( V_8 ) ;
F_40 ( V_2 -> V_9 -> V_167 , V_185 ,
V_150 ,
V_189 ) ;
memcpy ( V_183 -> V_6 , F_41 ( V_184 ) ,
V_150 ) ;
V_4 = F_6 ( V_4 ) ;
}
}
...
V_171:
V_106 -> V_190 = F_42 ( V_2 -> V_9 ,
V_2 -> V_128 ) ;
V_106 -> V_191 = V_113 ;
if ( V_106 -> V_190 )
V_113 += V_106 -> V_190 -> V_11 ;
...
V_106 -> V_190 -> V_11 ,
V_106 -> V_191 ) ;
F_45 ( V_2 -> V_9 -> V_167 , V_107 , V_113 ,
V_96 ) ;
}
F_46 ( V_106 -> V_155 ) ;
F_46 ( V_106 -> V_190 ) ;
...
if ( V_196 )
V_197 = F_49 ( F_35 ( V_196 -> V_198 ) ) ;
if ( F_50 ( V_192 , & V_2 -> V_126 ) )
return - V_199 ;
if ( F_39 ( V_2 -> V_73 ) )
F_15 ( V_2 ) ;
F_51 ( V_2 , L_2 ,
F_35 ( V_194 -> V_170 . type ) ) ;
V_2 -> V_73 = V_194 ;
V_2 -> V_128 = V_196 ;
F_52 ( V_200 , & V_2 -> V_201 , V_197 ) ;
return 0 ;
}
int F_53 ( struct V_1 * V_2 , enum V_202 V_203 ,
const char * V_204 , T_5 V_11 ,
const struct V_195 * V_196 )
{
struct V_193 * V_194 ;
V_194 = F_34 ( sizeof( * V_194 ) + V_11 , V_205 ) ;
if ( ! V_194 )
return - V_206 ;
V_194 -> V_11 = V_11 ;
V_194 -> V_170 . type = F_3 ( V_203 ) ;
memcpy ( V_194 -> V_170 . V_6 , V_204 , V_11 ) ;
return F_48 ( V_2 , V_194 , V_196 ) ;
}
int F_54 ( struct V_1 * V_2 ,
struct V_195 * V_196 ,
const char * V_207 , ... )
{
T_6 V_208 = F_55 ( V_196 -> V_208 ) ;
int V_209 , V_11 = 0 ;
char V_210 [ 64 ] ;
if ( ! V_208 )
return 0 ;
if ( V_207 ) {
T_7 V_211 ;
V_210 [ sizeof( V_210 ) - 1 ] = '\0' ;
va_start ( V_211 , V_207 ) ;
vsnprintf ( V_210 , sizeof( V_210 ) , V_207 , V_211 ) ;
va_end ( V_211 ) ;
if ( F_56 ( V_210 [ sizeof( V_210 ) - 1 ] ) )
V_210 [ sizeof( V_210 ) - 1 ] = '\0' ;
V_11 = strlen ( V_210 ) + 1 ;
}
V_209 = F_53 ( V_2 , F_35 ( V_196 -> V_212 ) , V_210 , V_11 ,
V_196 ) ;
if ( V_209 )
return V_209 ;
V_196 -> V_208 = F_57 ( V_208 - 1 ) ;
return 0 ;
}
int F_58 ( struct V_1 * V_2 , T_1 V_213 )
{
T_1 * V_214 ;
int V_209 ;
int V_8 ;
if ( F_59 ( V_213 >= F_14 ( V_2 -> V_60 -> V_215 ) ,
L_3 , V_213 ) )
return - V_216 ;
if ( ( ! V_2 -> V_60 -> V_215 [ V_213 ] ||
! V_2 -> V_60 -> V_215 [ V_213 ] -> V_217 ) &&
V_213 == V_218 )
return 0 ;
if ( ! V_2 -> V_60 -> V_215 [ V_213 ] )
return - V_216 ;
...
F_51 ( V_2 , L_4 ,
V_2 -> V_219 ) ;
V_214 = ( void * ) & V_2 -> V_60 -> V_215 [ V_213 ] -> V_221 ;
for ( V_8 = 0 ; V_8 < V_2 -> V_60 -> V_215 [ V_213 ] -> V_217 ; V_8 ++ ) {
struct V_222 * V_223 = ( void * ) V_214 ;
V_209 = F_60 ( V_2 , V_223 -> V_212 , 0 ,
F_55 ( V_223 -> V_11 ) , V_223 -> V_6 ) ;
if ( V_209 )
return V_209 ;
V_214 += sizeof( * V_223 ) ;
V_214 += F_55 ( V_223 -> V_11 ) ;
}
V_2 -> V_219 = V_213 ;
return 0 ;
}
