...
if ( ! V_29 )
return - V_90 ;
V_29 -> V_52 . V_122 = V_12 -> V_52 . V_122 ;
V_16 = F_47 ( V_29 , V_12 -> V_52 . V_123 ) ;
if ( V_16 < 0 )
return V_16 ;
V_18 = F_10 ( V_29 ) ;
V_18 -> V_124 = F_48 ( & V_12 -> V_52 , L_2 ) ;
if ( F_49 ( V_18 -> V_124 ) ) {
V_16 = F_50 ( V_18 -> V_124 ) ;
goto V_125;
}
V_16 = F_51 ( V_18 -> V_124 ) ;
if ( V_16 )
goto V_125;
F_52 ( V_12 , V_29 ) ;
V_121 = F_53 ( F_54 ( V_126 ) ,
& V_12 -> V_52 ) ;
if ( V_121 )
V_18 -> V_41 = F_55 ( & V_12 -> V_52 ) ;
else
V_18 -> V_41 = & V_127 [ V_118 -> V_128 ] ;
V_18 -> V_12 = V_12 ;
V_18 -> V_48 = V_18 -> V_41 -> V_129 * 1000 ;
V_100 = F_56 ( & V_12 -> V_52 , L_3 ) ;
if ( ! F_49 ( V_100 ) ) {
int V_48 ;
V_16 = F_51 ( V_100 ) ;
if ( V_16 )
...
if ( F_58 ( V_12 -> V_131 , V_132 ) ) {
V_18 -> V_22 = V_133 ;
V_18 -> V_43 = V_134 ;
} else if ( F_58 ( V_12 -> V_131 , V_135 )
&& V_18 -> V_41 -> V_42 == 8 ) {
V_18 -> V_22 = F_3 ;
V_18 -> V_43 = F_5 ;
} else {
...
if ( V_16 )
goto V_130;
V_29 -> V_52 . V_137 = & V_12 -> V_52 ;
V_29 -> V_52 . V_122 = V_12 -> V_52 . V_122 ;
V_29 -> V_138 = V_118 -> V_138 ;
V_29 -> V_139 = V_18 -> V_41 -> V_139 ;
V_29 -> V_140 = V_18 -> V_41 -> V_140 ;
...
goto V_130;
if ( V_12 -> V_69 ) {
V_16 = F_60 ( & V_12 -> V_52 , V_18 -> V_12 -> V_69 ,
NULL ,
& F_22 ,
V_143 | V_144 ,
L_4 ,
