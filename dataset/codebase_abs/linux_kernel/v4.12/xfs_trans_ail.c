...
T_1 * V_3 ;
V_3 = F_10 ( V_2 ) ;
if ( ! V_3 || F_47 ( V_2 -> V_24 ) ||
F_4 ( V_57 , V_2 -> V_35 ) <= 0 )
return;
F_48 () ;
F_49 ( V_2 , & V_2 -> V_35 , & V_57 ) ;
F_48 () ;
F_50 ( V_2 -> V_58 ) ;
}
void
...
struct V_19 * V_3 )
{
struct V_19 * V_64 = F_10 ( V_2 ) ;
F_65 ( V_3 , V_64 -> V_10 , V_3 -> V_10 ) ;
F_26 ( V_2 , V_3 ) ;
V_3 -> V_6 &= ~ V_7 ;
V_3 -> V_10 = 0 ;
return V_64 == V_3 ;
...
{
struct V_1 * V_2 ;
V_2 = F_71 ( sizeof( struct V_1 ) , V_72 ) ;
if ( ! V_2 )
return - V_73 ;
V_2 -> V_24 = V_23 ;
F_72 ( & V_2 -> V_5 ) ;
