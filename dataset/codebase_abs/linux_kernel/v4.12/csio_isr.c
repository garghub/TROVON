...
struct V_50 * V_51 = & V_4 -> V_52 [ 0 ] ;
struct V_59 * V_60 ;
struct V_61 * V_8 = V_4 -> V_8 ;
if ( V_4 -> V_45 != V_62 ) {
V_5 = F_44 ( F_45 ( V_8 , 0 ) , F_34 ,
V_4 -> V_45 == V_63 ? 0 : V_64 ,
V_65 , V_4 ) ;
if ( V_5 ) {
F_46 ( V_4 , L_7 ) ;
goto V_66;
...
for ( V_49 = 0 ; V_49 < V_4 -> V_68 ; V_49 ++ ) {
V_60 = & V_4 -> V_69 [ V_49 ] ;
for ( V_58 = 0 ; V_58 < V_60 -> V_70 ; V_58 ++ , V_53 ++ ) {
struct V_71 * V_72 = & V_4 -> V_72 [ V_49 ] [ V_58 ] ;
struct V_32 * V_73 = V_4 -> V_74 . V_75 [ V_72 -> V_76 ] ;
V_5 = F_44 ( F_45 ( V_8 , V_53 ) , F_32 , 0 ,
V_51 [ V_53 ] . V_55 , V_73 ) ;
if ( V_5 ) {
F_46 ( V_4 ,
L_8 ,
...
F_47 ( F_45 ( V_8 , V_49 ) , V_4 -> V_52 [ V_49 ] . V_2 ) ;
F_48 ( V_4 -> V_8 ) ;
return - V_78 ;
}
static void
F_49 ( struct V_3 * V_4 , int V_56 )
{
int V_49 ;
struct V_59 * V_60 ;
while ( V_56 < V_4 -> V_57 ) {
...
int V_81 = V_54 ;
struct V_59 * V_60 ;
struct V_82 V_55 = { . V_83 = 2 } ;
V_80 = V_4 -> V_68 + V_81 ;
V_56 = V_4 -> V_57 + V_81 ;
if ( V_4 -> V_6 & V_84 || ! F_51 ( V_4 ) )
V_56 = F_52 ( T_3 , V_4 -> V_85 , V_56 ) ;
F_18 ( V_4 , L_10 , V_4 -> V_85 , V_56 ) ;
V_56 = F_53 ( V_4 -> V_8 , V_80 , V_56 ,
V_86 | V_87 , & V_55 ) ;
if ( V_56 < 0 )
return V_56 ;
if ( V_56 < ( V_4 -> V_57 + V_81 ) ) {
F_18 ( V_4 , L_11 , V_56 - V_81 ) ;
F_49 ( V_4 , V_56 - V_81 ) ;
}
V_53 = 0 ;
F_54 ( V_4 , V_53 ) ;
...
for ( V_49 = 0 ; V_49 < V_4 -> V_68 ; V_49 ++ ) {
V_60 = & V_4 -> V_69 [ V_49 ] ;
for ( V_58 = 0 ; V_58 < V_4 -> V_88 ; V_58 ++ ) {
V_79 = ( V_58 % V_60 -> V_70 ) + V_53 ;
V_4 -> V_72 [ V_49 ] [ V_58 ] . V_89 = V_79 ;
}
V_53 += V_60 -> V_70 ;
}
return 0 ;
...
! F_51 ( V_4 ) ) {
int V_81 = V_92 ;
if ( V_4 -> V_85 < ( V_4 -> V_57 + V_81 ) ) {
F_18 ( V_4 , L_11 ,
V_4 -> V_85 - V_81 ) ;
F_49 ( V_4 , V_4 -> V_85 - V_81 ) ;
}
}
if ( ( V_91 == 1 ) && ! F_59 ( V_4 -> V_8 ) )
V_4 -> V_45 = V_63 ;
else
V_4 -> V_45 = V_46 ;
}
F_18 ( V_4 , L_12 ,
( V_4 -> V_45 == V_62 ) ? L_13 :
( ( V_4 -> V_45 == V_63 ) ? L_14 : L_15 ) ) ;
}
void
F_60 ( struct V_3 * V_4 , bool free )
{
F_61 ( V_4 ) ;
if ( free ) {
int V_49 ;
switch ( V_4 -> V_45 ) {
case V_62 :
for ( V_49 = 0 ; V_49 < V_4 -> V_57 + V_54 ; V_49 ++ ) {
F_47 ( F_45 ( V_4 -> V_8 , V_49 ) ,
V_4 -> V_52 [ V_49 ] . V_2 ) ;
}
break;
case V_63 :
case V_46 :
F_47 ( F_45 ( V_4 -> V_8 , 0 ) , V_4 ) ;
break;
default:
break;
}
