...
T_3 V_56 ;
V_56 = F_19 ( V_9 -> V_30 ) ;
V_9 -> V_31 = F_20 ( V_56 , V_57 ) ;
if ( ! V_9 -> V_31 )
return - V_58 ;
V_56 = F_19 ( V_9 -> V_27 ) ;
V_9 -> V_14 = F_20 ( V_56 , V_57 ) ;
if ( ! V_9 -> V_14 ) {
F_21 ( V_9 -> V_31 ) ;
return - V_58 ;
}
...
for ( V_42 = 0 ; V_42 < V_62 -> V_66 . V_67 ; V_42 ++ ) {
V_65 = & V_62 -> V_70 [ V_42 ] . V_66 ;
if ( F_25 ( V_65 ) ) {
if ( ! V_9 -> V_30 )
V_9 -> V_30 = V_65 ;
continue;
...
V_44 = & V_2 -> V_72 [ 1 ] ;
V_44 -> type = V_83 ;
V_44 -> V_74 = V_75 | V_76 | V_84 ;
V_44 -> V_77 = 1 ;
V_44 -> V_78 = 0xffffffff ;
V_44 -> V_85 = F_16 ;
V_44 -> V_86 = F_17 ;
V_44 -> V_82 = F_15 ;
return 0 ;
...
{
return F_34 ( V_60 , & V_89 , V_88 -> V_90 ) ;
}
