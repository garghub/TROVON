...
static int F_64 ( struct V_67 * V_54 , unsigned long V_51 )
{
struct V_23 * V_24 ;
...
static int F_72 ( struct V_155 * V_156 , struct V_157 * V_158 )
{
struct V_1 * V_2 = V_156 -> V_105 ;
switch ( V_158 -> V_159 ) {
case V_160 :
return F_69 ( V_2 , V_158 -> V_158 , V_158 -> V_135 ) ;
}
return - V_161 ;
}
static int F_73 ( struct V_155 * V_156 , struct V_157 * V_158 )
{
struct V_1 * V_2 = V_156 -> V_105 ;
switch ( V_158 -> V_159 ) {
case V_160 :
return F_67 ( V_2 , V_158 -> V_158 , V_158 -> V_135 ) ;
}
return - V_161 ;
}
static int F_74 ( struct V_155 * V_156 , struct V_157 * V_158 )
{
switch ( V_158 -> V_159 ) {
case V_160 :
if ( V_158 -> V_158 >= V_150 &&
V_158 -> V_158 < V_151 )
return 0 ;
break;
}
...
static int F_77 ( struct V_155 * V_156 , T_1 type )
{
struct V_1 * V_2 ;
struct V_37 * V_37 = V_156 -> V_37 ;
int V_136 = 0 ;
...
{
struct V_1 * V_2 = (struct V_1 * ) V_156 -> V_105 ;
F_54 ( V_2 ) ;
}
int F_81 ( struct V_155 * V_156 , struct V_67 * V_54 ,
T_1 V_166 )
{
struct V_1 * V_2 = V_156 -> V_105 ;
int V_167 = - V_168 ;
if ( V_156 -> V_169 != & V_170 )
return - V_171 ;
if ( V_2 -> V_37 != V_54 -> V_37 )
return - V_171 ;
if ( V_54 -> V_38 . V_172 )
return - V_168 ;
V_167 = F_64 ( V_54 , V_166 ) ;
if ( ! V_167 )
V_54 -> V_38 . V_172 = V_173 ;
return V_167 ;
}
void F_82 ( struct V_67 * V_54 )
{
if ( ! V_54 -> V_38 . V_24 )
return;
F_59 ( V_54 -> V_38 . V_24 ) ;
V_54 -> V_38 . V_24 = NULL ;
V_54 -> V_38 . V_172 = V_174 ;
}
void F_83 ( struct V_37 * V_37 , unsigned long V_3 ,
unsigned long V_21 )
{
struct V_1 * V_2 = V_37 -> V_38 . V_2 ;
struct V_7 * V_8 ;
...
void F_84 ( struct V_37 * V_37 , unsigned long V_3 ,
unsigned long V_21 )
{
struct V_1 * V_2 = V_37 -> V_38 . V_2 ;
struct V_7 * V_8 ;
