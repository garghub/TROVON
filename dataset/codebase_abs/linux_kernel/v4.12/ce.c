...
unsigned int V_48 = V_66 -> V_48 ;
T_1 V_49 = V_61 -> V_49 ;
T_1 V_73 = F_3 ( V_2 , V_49 ) ;
if ( ( V_73 + V_72 ) == V_66 -> V_47 )
V_72 -= 1 ;
...
void F_65 ( struct V_1 * V_2 , unsigned int V_82 )
{
struct V_62 * V_63 = F_43 ( V_2 ) ;
struct V_34 * V_35 = & V_63 -> V_83 [ V_82 ] ;
T_1 V_49 = V_35 -> V_49 ;
F_47 ( & V_63 -> V_64 ) ;
F_32 ( V_2 , V_49 ,
V_84 ) ;
...
static struct V_41 *
F_76 ( struct V_1 * V_2 , unsigned int V_82 ,
const struct V_92 * V_93 )
{
struct V_41 * V_42 ;
T_1 V_72 = V_93 -> V_94 ;
