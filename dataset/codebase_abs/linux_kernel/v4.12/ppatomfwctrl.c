...
struct V_182 * V_183 )
{
struct V_184 * V_164 = NULL ;
T_2 V_185 ;
V_185 = F_5 ( V_186 ) ;
V_164 = (struct V_184 * )
F_6 ( V_16 -> V_20 ,
V_185 , NULL , NULL , NULL ) ;
if ( ! V_164 ) {
F_20 ( L_7 ) ;
return - V_187 ;
}
V_183 -> V_188 = V_164 -> V_189 ;
V_183 -> V_190 = V_164 -> V_191 ;
V_183 -> V_192 = V_164 -> V_193 ;
V_183 -> V_194 = 0 ;
V_183 -> V_195 = V_164 -> V_196 ;
V_183 -> V_197 = V_164 -> V_198 ;
V_183 -> V_199 = V_164 -> V_200 ;
V_183 -> V_201 = V_164 -> V_202 ;
return 0 ;
}
