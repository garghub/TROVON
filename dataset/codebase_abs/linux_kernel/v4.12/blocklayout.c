...
V_71 -> V_113 . V_116 = type == 0x02 ?
V_117 : V_118 ;
V_71 -> V_113 . V_119 = V_101 ;
memcpy ( V_71 -> V_113 . V_120 , V_103 + 4 , V_101 ) ;
if ( V_101 == 16 )
break;
}
V_107:
...
{
return ( ( T_6 ) V_84 -> V_121 . V_122 << 32 ) | V_84 -> V_121 . V_123 ;
}
static int
F_28 ( struct V_8 * V_9 ,
struct V_83 * V_84 ,
...
V_71 = & V_69 -> V_74 [ 0 ] ;
V_71 -> type = V_126 ;
V_71 -> V_113 . V_127 = F_27 ( V_84 ) ;
error = F_17 ( V_9 -> V_85 , V_71 ) ;
if ( error )
return error ;
V_125 = V_9 -> V_85 -> V_94 -> V_128 -> V_124 ;
if ( ! V_125 ) {
F_25 ( L_8 ,
V_9 -> V_129 ) ;
return - V_130 ;
}
error = V_125 -> V_131 ( V_9 -> V_85 , 0 , V_132 , true ) ;
if ( error ) {
F_25 ( L_9 ,
V_9 -> V_129 ) ;
return - V_130 ;
}
error = V_125 -> V_133 ( V_9 -> V_85 , V_132 ,
V_134 , 0 ) ;
if ( error ) {
F_25 ( L_10 ,
V_9 -> V_129 ) ;
...
V_91 -> V_94 -> V_128 -> V_124 -> V_143 ( V_91 , V_132 ,
F_27 ( V_84 ) , 0 , true ) ;
}
