...
if ( ! V_6 )
return;
memcpy ( F_5 ( V_6 , V_2 ) , V_1 , V_2 ) ;
V_10 = (struct V_9 * ) F_6 ( V_6 , sizeof( * V_10 ) ) ;
...
return;
memcpy ( F_5 ( V_6 , V_2 ) , V_1 , V_2 ) ;
V_8 = (struct V_7 * ) F_6 ( V_6 , sizeof( * V_8 ) ) ;
...
if ( ! V_47 )
return - V_42 ;
memcpy ( F_5 ( V_47 , V_6 -> V_38 ) , V_6 -> V_48 , V_6 -> V_38 ) ;
V_10 = (struct V_9 * ) F_6 ( V_47 , sizeof( * V_10 ) ) ;
memset ( V_10 , 0 , sizeof( struct V_9 ) ) ;
V_10 -> V_8 . V_14 = 0 ;
V_10 -> V_8 . V_15 = F_7 ( sizeof( struct V_9 ) ) ;
V_10 -> V_8 . V_16 = F_8 (
