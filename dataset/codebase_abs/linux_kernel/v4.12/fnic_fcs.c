...
V_79 -> V_82 . V_88 = F_32 ( V_89 ) ;
V_79 -> V_45 . V_90 = F_33 ( V_91 ) ;
V_79 -> V_45 . V_64 = F_32 ( V_92 ) ;
V_79 -> V_45 . V_65 = V_93 ;
V_79 -> V_45 . V_68 = F_32 ( sizeof( V_79 -> V_51 ) / V_70 ) ;
...
F_34 ( V_45 -> V_26 -> V_98 , & V_79 -> V_51 . V_98 . V_100 ) ;
F_35 ( & V_75 -> V_101 . V_102 ) ;
F_36 ( V_28 , sizeof( * V_79 ) ) ;
V_28 -> V_103 = F_32 ( V_89 ) ;
F_37 ( V_28 ) ;
F_38 ( V_28 ) ;
V_45 -> V_104 ( V_45 , V_28 ) ;
V_80 = V_105 + F_39 ( V_106 ) ;
F_40 ( & V_3 -> V_23 , F_41 ( V_80 ) ) ;
}
static void F_42 ( struct V_3 * V_3 , struct V_27 * V_28 )
{
struct V_44 * V_45 = & V_3 -> V_20 ;
struct V_46 * V_47 ;
struct V_50 * V_51 ;
...
if ( F_19 ( & V_3 -> V_117 ) ) {
F_35 ( & V_75 -> V_101 . V_118 ) ;
F_8 ( V_74 , V_3 -> V_13 -> V_14 ,
L_20 ) ;
F_4 ( & V_3 -> V_110 , V_5 ) ;
goto V_115;
}
V_79 = F_45 ( & V_3 -> V_117 , struct V_108 , V_39 ) ;
V_3 -> V_81 ( V_3 , V_79 -> V_107 ) ;
V_79 -> V_32 = V_119 ;
V_79 -> V_120 ++ ;
F_4 ( & V_3 -> V_110 , V_5 ) ;
F_11 ( V_45 ) ;
V_109 = V_105 + F_39 ( V_121 ) ;
F_40 ( & V_3 -> V_23 , F_41 ( V_109 ) ) ;
V_115:
return;
}
...
static int F_46 ( struct V_3 * V_3 , T_2 V_122 )
{
unsigned long V_5 ;
struct V_108 * V_123 ;
F_3 ( & V_3 -> V_110 , V_5 ) ;
...
V_123 = F_45 ( & V_3 -> V_117 , struct V_108 , V_39 ) ;
if ( V_123 -> V_32 == V_125 ) {
F_4 ( & V_3 -> V_110 , V_5 ) ;
return 0 ;
}
...
static void F_47 ( struct V_3 * V_3 , enum V_126 V_127 )
{
struct V_35 * V_36 ;
unsigned long V_5 ;
V_36 = F_43 ( sizeof( * V_36 ) , V_114 ) ;
if ( ! V_36 )
return;
V_36 -> V_3 = V_3 ;
V_36 -> V_41 = V_127 ;
F_3 ( & V_3 -> V_8 , V_5 ) ;
F_44 ( & V_36 -> V_39 , & V_3 -> V_38 ) ;
F_4 ( & V_3 -> V_8 , V_5 ) ;
F_48 ( & V_3 -> V_40 ) ;
}
static int F_49 ( struct V_3 * V_3 , struct V_27 * V_28 )
{
struct V_46 * V_47 ;
int V_128 = 1 ;
T_2 V_56 ;
...
if ( V_138 -> V_88 == F_32 ( V_89 ) ) {
F_52 ( V_28 , sizeof( * V_138 ) ) ;
if ( F_49 ( V_3 , V_28 ) <= 0 ) {
F_15 ( V_28 ) ;
continue;
}
...
static inline int F_54 ( struct V_3 * V_3 , struct V_27 * V_28 )
{
struct V_29 * V_30 ;
struct V_137 * V_138 ;
struct V_141 * V_141 ;
struct V_142 * V_143 ;
V_138 = (struct V_137 * ) V_28 -> V_63 ;
if ( V_138 -> V_88 == F_32 ( V_144 ) ) {
memmove ( ( T_3 * ) V_138 + V_145 , V_138 , V_85 * 2 ) ;
V_138 = (struct V_137 * ) F_52 ( V_28 , V_145 ) ;
F_37 ( V_28 ) ;
}
if ( V_138 -> V_88 == F_32 ( V_89 ) ) {
if ( ! ( V_3 -> V_21 . V_5 & V_22 ) ) {
...
F_56 ( & V_3 -> V_139 , V_28 ) ;
F_57 ( V_148 , & V_3 -> V_136 ) ;
return 1 ;
}
if ( V_138 -> V_88 != F_32 ( V_149 ) )
goto V_129;
F_58 ( V_28 , sizeof( * V_138 ) ) ;
F_52 ( V_28 , sizeof( * V_138 ) ) ;
...
V_30 = (struct V_29 * ) V_28 ;
F_60 ( V_30 ) ;
F_61 ( V_30 ) = V_141 -> V_151 ;
F_52 ( V_28 , sizeof( struct V_141 ) ) ;
F_62 ( V_28 ) ;
V_143 = (struct V_142 * ) ( V_28 -> V_63 + V_28 -> V_62 - sizeof( * V_143 ) ) ;
F_63 ( V_30 ) = V_143 -> V_152 ;
F_64 ( V_28 , V_28 -> V_62 - sizeof( * V_143 ) ) ;
return 0 ;
V_129:
F_65 ( V_28 ) ;
return - 1 ;
}
void F_66 ( struct V_3 * V_3 , T_3 * V_153 )
{
...
if ( ! F_67 ( V_63 ) && ! F_68 ( V_63 , V_154 ) )
F_69 ( V_3 -> V_12 , V_63 ) ;
memcpy ( V_63 , V_153 , V_85 ) ;
if ( ! F_68 ( V_153 , V_154 ) )
F_70 ( V_3 -> V_12 , V_153 ) ;
}
void F_71 ( struct V_25 * V_13 , T_3 * V_153 )
{
struct V_3 * V_3 = F_72 ( V_13 ) ;
F_73 ( & V_3 -> V_8 ) ;
F_66 ( V_3 , V_153 ) ;
F_74 ( & V_3 -> V_8 ) ;
}
void F_75 ( struct V_25 * V_13 , T_1 V_156 , struct V_29 * V_30 )
{
struct V_3 * V_3 = F_72 ( V_13 ) ;
T_3 * V_94 ;
int V_128 ;
...
V_156 , V_30 ) ;
if ( ! V_156 ) {
F_71 ( V_13 , V_3 -> V_20 . V_84 ) ;
F_76 ( V_3 ) ;
return;
}
if ( V_30 ) {
V_94 = F_77 ( V_30 ) -> V_157 ;
if ( F_67 ( V_94 ) ) {
F_78 ( & V_3 -> V_20 , V_13 , V_30 ) ;
}
F_71 ( V_13 , V_94 ) ;
}
F_73 ( & V_3 -> V_8 ) ;
...
static int F_81 ( struct V_159 * V_12 ,
struct V_160 * V_160 , T_3 type ,
T_2 V_161 , T_2 V_162 ,
void * V_163 )
{
struct V_3 * V_3 = F_82 ( V_12 ) ;
F_83 ( & V_3 -> V_164 [ V_161 ] , V_160 , V_162 ,
V_165 , V_166 ,
NULL ) ;
return 0 ;
}
int F_84 ( struct V_3 * V_3 , int V_167 )
{
unsigned int V_168 = 0 , V_169 ;
unsigned int V_170 ;
int V_171 ;
for ( V_170 = 0 ; V_170 < V_3 -> V_172 ; V_170 ++ ) {
V_169 = F_85 ( & V_3 -> V_173 [ V_170 ] , V_167 ,
F_81 ,
NULL ) ;
if ( V_169 ) {
V_171 = F_86 ( & V_3 -> V_164 [ V_170 ] , V_174 ) ;
if ( V_171 )
...
{
struct V_3 * V_3 = F_82 ( V_164 -> V_12 ) ;
struct V_27 * V_28 ;
T_2 V_62 ;
T_6 V_176 ;
int V_177 ;
...
F_38 ( V_28 ) ;
F_36 ( V_28 , V_62 ) ;
V_176 = F_87 ( V_3 -> V_182 , V_28 -> V_63 , V_62 , V_183 ) ;
if ( F_88 ( V_3 -> V_182 , V_176 ) ) {
V_177 = - V_181 ;
F_55 ( V_146 L_33 , V_177 ) ;
goto V_184;
}
F_89 ( V_164 , V_28 , V_176 , V_62 ) ;
return 0 ;
V_184:
F_90 ( V_28 ) ;
return V_177 ;
}
void F_91 ( struct V_175 * V_164 , struct V_185 * V_186 )
{
struct V_29 * V_30 = V_186 -> V_187 ;
struct V_3 * V_3 = F_82 ( V_164 -> V_12 ) ;
F_92 ( V_3 -> V_182 , V_186 -> V_188 , V_186 -> V_62 ,
V_183 ) ;
F_15 ( F_93 ( V_30 ) ) ;
V_186 -> V_187 = NULL ;
}
void F_94 ( struct V_44 * V_45 , struct V_27 * V_28 )
{
struct V_3 * V_3 = F_95 ( V_45 ) ;
...
int V_177 ;
if ( ! V_3 -> V_194 ) {
V_191 = (struct V_137 * ) F_96 ( V_28 ) ;
V_193 = (struct V_192 * ) F_97 ( V_28 ,
sizeof( * V_193 ) - sizeof( * V_191 ) ) ;
memcpy ( V_193 , V_191 , 2 * V_85 ) ;
V_193 -> V_195 = F_32 ( V_144 ) ;
V_193 -> V_196 = V_191 -> V_88 ;
V_193 -> V_197 = F_32 ( V_3 -> V_198 ) ;
if ( ( F_7 ( V_3 -> V_13 -> V_14 -> V_15 ,
...
V_176 = F_87 ( V_3 -> V_182 , V_28 -> V_63 , V_28 -> V_62 , V_200 ) ;
V_177 = F_88 ( V_3 -> V_182 , V_176 ) ;
if ( V_177 ) {
F_55 ( V_146 L_33 , V_177 ) ;
goto V_184;
}
...
if ( ! F_98 ( V_190 ) )
goto V_202;
F_99 ( V_190 , V_28 , V_176 , V_28 -> V_62 ,
0 ,
V_3 -> V_198 , 1 ) ;
F_4 ( & V_3 -> V_201 [ 0 ] , V_5 ) ;
return;
V_202:
F_4 ( & V_3 -> V_201 [ 0 ] , V_5 ) ;
F_92 ( V_3 -> V_182 , V_176 , V_28 -> V_62 , V_200 ) ;
V_184:
F_90 ( V_28 ) ;
}
static int F_100 ( struct V_3 * V_3 , struct V_29 * V_30 )
{
struct V_189 * V_190 = & V_3 -> V_190 [ 0 ] ;
struct V_27 * V_28 ;
T_6 V_176 ;
...
V_49 = F_101 ( V_30 ) ;
V_28 = F_93 ( V_30 ) ;
if ( F_102 ( V_49 -> V_205 == V_206 ) &&
F_103 ( & V_3 -> V_20 , V_3 -> V_13 , V_28 ) )
return 0 ;
if ( ! V_3 -> V_194 ) {
V_204 = sizeof( * V_193 ) + sizeof( * V_141 ) ;
V_193 = (struct V_192 * ) F_97 ( V_28 , V_204 ) ;
V_191 = (struct V_137 * ) V_193 ;
V_193 -> V_195 = F_32 ( V_144 ) ;
V_193 -> V_196 = F_32 ( V_149 ) ;
V_193 -> V_197 = F_32 ( V_3 -> V_198 ) ;
V_141 = (struct V_141 * ) ( V_193 + 1 ) ;
} else {
V_204 = sizeof( * V_191 ) + sizeof( * V_141 ) ;
V_191 = (struct V_137 * ) F_97 ( V_28 , V_204 ) ;
V_191 -> V_88 = F_32 ( V_149 ) ;
V_141 = (struct V_141 * ) ( V_191 + 1 ) ;
}
if ( V_3 -> V_20 . V_207 )
F_104 ( V_191 -> V_86 , V_49 -> V_208 ) ;
else
...
V_141 -> V_151 = F_61 ( V_30 ) ;
if ( V_150 )
F_106 ( V_141 , V_150 ) ;
V_176 = F_87 ( V_3 -> V_182 , V_191 , V_203 , V_200 ) ;
if ( F_88 ( V_3 -> V_182 , V_176 ) ) {
V_128 = - V_181 ;
F_55 ( V_146 L_34 , V_128 ) ;
goto V_210;
}
...
F_3 ( & V_3 -> V_201 [ 0 ] , V_5 ) ;
if ( ! F_98 ( V_190 ) ) {
F_92 ( V_3 -> V_182 , V_176 ,
V_203 , V_200 ) ;
V_128 = - 1 ;
goto V_202;
}
F_107 ( V_190 , V_28 , V_176 , V_203 , F_63 ( V_30 ) ,
0 ,
V_3 -> V_198 , 1 , 1 , 1 ) ;
V_202:
F_4 ( & V_3 -> V_201 [ 0 ] , V_5 ) ;
...
int F_109 ( struct V_25 * V_26 , struct V_29 * V_30 )
{
struct V_3 * V_3 = F_72 ( V_26 ) ;
unsigned long V_5 ;
if ( V_3 -> V_211 ) {
F_15 ( F_93 ( V_30 ) ) ;
return - 1 ;
...
F_56 ( & V_3 -> V_212 , F_93 ( V_30 ) ) ;
F_4 ( & V_3 -> V_8 , V_5 ) ;
return 0 ;
}
F_4 ( & V_3 -> V_8 , V_5 ) ;
return F_100 ( V_3 , V_30 ) ;
}
...
static void F_76 ( struct V_3 * V_3 )
{
unsigned long V_5 ;
enum V_213 V_214 ;
int V_128 ;
...
static void F_112 ( struct V_189 * V_190 ,
struct V_160 * V_160 ,
struct V_217 * V_186 , void * V_163 )
{
struct V_27 * V_28 = V_186 -> V_187 ;
struct V_29 * V_30 = (struct V_29 * ) V_28 ;
struct V_3 * V_3 = F_82 ( V_190 -> V_12 ) ;
F_92 ( V_3 -> V_182 , V_186 -> V_188 ,
V_186 -> V_62 , V_200 ) ;
F_65 ( F_93 ( V_30 ) ) ;
V_186 -> V_187 = NULL ;
}
static int F_113 ( struct V_159 * V_12 ,
struct V_160 * V_160 , T_3 type ,
T_2 V_161 , T_2 V_162 ,
void * V_163 )
{
...
F_114 ( & V_3 -> V_190 [ V_161 ] , V_160 , V_162 ,
F_112 , NULL ) ;
F_4 ( & V_3 -> V_201 [ V_161 ] , V_5 ) ;
return 0 ;
}
int F_115 ( struct V_3 * V_3 , int V_218 )
{
unsigned int V_219 = 0 ;
unsigned int V_170 ;
for ( V_170 = 0 ; V_170 < V_3 -> V_220 ; V_170 ++ ) {
V_219 += F_85 ( & V_3 -> V_173 [ V_3 -> V_172 + V_170 ] ,
V_218 ,
F_113 ,
NULL ) ;
}
...
void F_116 ( struct V_189 * V_190 , struct V_217 * V_186 )
{
struct V_29 * V_30 = V_186 -> V_187 ;
struct V_3 * V_3 = F_82 ( V_190 -> V_12 ) ;
F_92 ( V_3 -> V_182 , V_186 -> V_188 ,
...
V_79 = F_45 ( & V_3 -> V_117 , struct V_108 ,
V_39 ) ;
V_3 -> V_81 ( V_3 , V_79 -> V_107 ) ;
V_79 -> V_32 = V_119 ;
}
F_4 ( & V_3 -> V_110 , V_5 ) ;
F_35 ( & V_75 -> V_101 . V_225 ) ;
V_79 -> V_120 ++ ;
V_109 = V_105 + F_39
( V_121 ) ;
F_40 ( & V_3 -> V_23 , F_41 ( V_109 ) ) ;
