...
{
struct V_9 * V_10 = F_31 ( V_225 ) ;
int V_194 , V_118 , V_245 , V_246 ;
for ( V_194 = 0 ; V_194 < F_29 ( V_247 ) ; V_194 ++ ) {
V_245 = V_247 [ V_194 ] . V_248 ;
V_246 = V_247 [ V_194 ] . V_31 ;
V_118 = F_43 ( V_10 -> V_249 , V_246 , V_245 ) ;
if ( V_118 )
F_18 ( & V_225 -> V_88 ,
L_9 ,
V_119 , V_118 , V_246 , V_245 ) ;
}
}
...
{
struct V_9 * V_10 ;
int V_118 , V_31 , V_252 ;
struct V_253 * V_254 = V_225 -> V_88 . V_255 ;
T_1 V_26 ;
T_2 V_188 ;
V_10 = F_45 ( & V_225 -> V_88 , sizeof( * V_10 ) , V_256 ) ;
if ( ! V_10 )
return - V_257 ;
F_46 ( V_225 , V_10 ) ;
V_118 = F_30 ( V_225 ) ;
if ( V_118 )
return V_118 ;
V_10 -> V_249 = F_47 ( V_225 , & V_258 ) ;
if ( F_33 ( V_10 -> V_249 ) ) {
V_118 = F_34 ( V_10 -> V_249 ) ;
F_18 ( & V_225 -> V_88 , L_10 , V_118 ) ;
goto V_259;
}
V_10 -> V_260 = F_48 ( & V_225 -> V_88 , NULL ) ;
if ( F_33 ( V_10 -> V_260 ) ) {
V_118 = F_34 ( V_10 -> V_260 ) ;
F_18 ( & V_225 -> V_88 , L_11 , V_118 ) ;
if ( V_118 == - V_261 )
V_118 = - V_230 ;
goto V_259;
}
V_118 = F_49 ( V_10 -> V_260 ) ;
if ( V_118 ) {
F_18 ( & V_225 -> V_88 , L_12 , V_118 ) ;
goto V_259;
}
F_50 ( 1 ) ;
V_118 = F_51 ( V_10 -> V_249 , V_143 , & V_31 ) ;
if ( V_118 ) {
...
V_252 = ( V_31 & V_267 ) >> V_268 ;
F_52 ( & V_225 -> V_88 , L_15 , V_252 ) ;
V_10 -> V_269 = V_252 ;
V_118 = F_43 ( V_10 -> V_249 ,
V_109 ,
V_270 ) ;
if ( V_118 )
F_18 ( & V_225 -> V_88 ,
...
V_118 = F_43 ( V_10 -> V_249 , V_20 , V_188 ) ;
if ( V_118 )
F_18 ( & V_225 -> V_88 ,
L_20 ,
V_118 , V_188 ) ;
