...
return;
if ( V_133 [ V_190 ] )
V_15 -> V_147 = F_107 ( V_133 [ V_190 ] ) ;
if ( V_133 [ V_191 ] )
V_15 -> V_16 = F_108 ( V_133 [ V_191 ] ) ;
if ( V_133 [ V_192 ] )
V_15 -> V_17 = F_108 ( V_133 [ V_192 ] ) ;
if ( V_133 [ V_193 ] )
V_15 -> V_74 = F_109 ( V_133 [ V_193 ] ) ;
if ( V_133 [ V_194 ] )
V_15 -> V_117 = F_109 ( V_133 [ V_194 ] ) ;
if ( V_133 [ V_195 ] )
V_15 -> V_148 = F_107 ( V_133 [ V_195 ] ) ;
}
static int F_110 ( struct V_7 * V_196 , struct V_30 * V_18 ,
struct V_188 * V_189 [] , struct V_188 * V_133 [] )
{
struct V_7 * V_7 = F_19 ( V_18 ) ;
struct V_6 * V_197 ;
V_197 = F_18 ( V_18 ) ;
F_106 ( V_133 , & V_197 -> V_15 ) ;
V_197 -> V_15 . V_50 = V_51 ;
if ( F_27 ( V_7 , & V_197 -> V_15 , 0 ) )
return - V_167 ;
return F_17 ( V_18 ) ;
}
static void F_111 ( struct V_30 * V_18 , struct V_198 * V_199 )
{
struct V_7 * V_7 = F_19 ( V_18 ) ;
struct V_11 * V_12 = F_5 ( V_7 , V_13 ) ;
if ( V_18 != V_12 -> V_43 )
...
struct V_22 * V_200 = & V_63 -> V_15 ;
if ( F_117 ( V_45 , V_190 , V_200 -> V_147 ) ||
F_118 ( V_45 , V_191 , & V_200 -> V_16 ) ||
F_118 ( V_45 , V_192 , & V_200 -> V_17 ) ||
F_119 ( V_45 , V_193 , V_200 -> V_74 ) ||
F_119 ( V_45 , V_194 , V_200 -> V_117 ) ||
F_117 ( V_45 , V_195 , V_200 -> V_148 ) )
goto V_201;
return 0 ;
V_201:
return - V_106 ;
...
V_10 = F_13 ( V_12 -> V_204 [ V_24 ] ) ;
while ( V_10 ) {
F_112 ( V_10 -> V_18 , & V_202 ) ;
V_10 = F_13 ( V_10 -> V_28 ) ;
}
}
...
unsigned long V_209 , void * V_210 )
{
struct V_30 * V_18 = F_130 ( V_210 ) ;
struct V_6 * V_10 = F_18 ( V_18 ) ;
if ( ! F_128 ( V_18 ) )
return V_211 ;
switch ( V_209 ) {
...
goto V_216;
V_213 = L_5 ;
V_32 = F_135 ( & V_217 , V_135 ) ;
if ( V_32 < 0 )
goto V_218;
V_32 = F_135 ( & V_219 , V_136 ) ;
if ( V_32 < 0 )
goto V_220;
V_32 = F_135 ( & V_221 , V_137 ) ;
if ( V_32 < 0 )
goto V_222;
V_213 = L_6 ;
V_32 = F_136 ( & V_34 ) ;
