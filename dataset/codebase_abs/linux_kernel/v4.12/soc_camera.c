...
if ( ! V_249 )
return - V_112 ;
V_249 -> V_225 . V_221 . V_239 . V_250 . V_251 = V_247 ;
V_249 -> V_225 . V_221 . V_229 = V_252 ;
...
struct V_245 * V_253 = V_2 -> V_254 ;
struct V_245 * V_255 = NULL , * V_256 ;
unsigned int V_34 ;
for ( V_34 = 0 ; ; V_34 ++ ) {
V_255 = F_148 ( V_253 , V_255 ) ;
if ( ! V_255 )
break;
V_256 = F_149 ( V_255 ) ;
if ( ! V_256 ) {
...
static inline void F_147 ( struct V_26 * V_27 ) { }
...
int V_7 ;
F_152 ( V_19 -> V_57 , L_29 , F_153 ( V_19 -> V_57 ) ) ;
V_7 = F_154 ( & V_19 -> V_144 , 16 ) ;
if ( V_7 < 0 )
return V_7 ;
V_7 = F_155 ( V_19 ) ;
if ( V_7 < 0 )
...
if ( V_7 < 0 && V_7 != - V_207 )
goto V_123;
} else if ( ! V_200 -> V_258 || ! V_200 -> V_259 ) {
V_7 = - V_67 ;
goto V_123;
} else {
V_7 = F_16 ( V_27 ) ;
...
goto V_123;
if ( V_200 -> V_260 )
V_7 = F_156 ( V_200 -> V_260 ) ;
V_7 = V_200 -> V_258 ( V_19 ) ;
if ( V_7 < 0 )
goto V_261;
V_136 = F_65 ( V_19 ) ;
if ( ! V_136 || ! V_136 -> V_163 || ! F_157 ( V_136 ) ||
...
struct V_264 * V_265 = V_2 ? V_2 -> V_163 : NULL ;
if ( V_265 ) {
V_133 -> V_201 . V_259 ( V_19 ) ;
F_71 ( V_265 -> V_127 ) ;
}
}
if ( V_19 -> V_35 )
...
int V_7 ;
V_7 = F_14 ( V_21 , V_108 , V_170 , NULL , & V_268 ) ;
if ( V_7 )
return V_7 ;
V_266 -> V_174 = V_268 . V_174 ;
return 0 ;
}
...
int V_7 ;
V_7 = F_14 ( V_21 , V_108 , V_176 , NULL , & V_268 ) ;
if ( V_7 )
return V_7 ;
V_266 -> V_174 = V_268 . V_174 ;
return 0 ;
...
{
struct V_20 * V_21 = F_13 ( V_19 ) ;
return F_14 ( V_21 , V_82 , V_270 , V_269 ) ;
}
static int F_166 ( struct V_18 * V_19 ,
struct V_177 * V_269 )
{
struct V_20 * V_21 = F_13 ( V_19 ) ;
return F_14 ( V_21 , V_82 , V_271 , V_269 ) ;
}
...
V_53 = F_20 ( V_19 , V_87 -> V_274 ) ;
if ( ! V_53 )
return - V_67 ;
V_273 . V_105 = V_53 -> V_105 ;
V_7 = F_14 ( V_21 , V_108 , V_275 , NULL , & V_273 ) ;
if ( V_7 < 0 )
return V_7 ;
if ( V_273 . V_276 == V_273 . V_277 &&
V_273 . V_278 == V_273 . V_279 ) {
V_87 -> type = V_280 ;
V_87 -> V_281 . V_59 = V_273 . V_276 ;
V_87 -> V_281 . V_60 = V_273 . V_278 ;
return 0 ;
}
V_87 -> type = V_282 ;
V_87 -> V_283 . V_276 = V_273 . V_276 ;
V_87 -> V_283 . V_277 = V_273 . V_277 ;
V_87 -> V_283 . V_278 = V_273 . V_278 ;
V_87 -> V_283 . V_279 = V_273 . V_279 ;
V_87 -> V_283 . V_284 = 1 ;
V_87 -> V_283 . V_285 = 1 ;
return 0 ;
}
...
return - V_67 ;
if ( ! V_27 -> V_28 -> V_176 )
V_27 -> V_28 -> V_176 = F_164 ;
if ( ! V_27 -> V_28 -> V_170 )
V_27 -> V_28 -> V_170 = F_163 ;
if ( ! V_27 -> V_28 -> V_179 )
V_27 -> V_28 -> V_179 = F_166 ;
if ( ! V_27 -> V_28 -> V_178 )
V_27 -> V_28 -> V_178 = F_165 ;
if ( ! V_27 -> V_28 -> V_88 )
V_27 -> V_28 -> V_88 = F_167 ;
F_17 ( & V_125 ) ;
F_96 (ix, &hosts, list) {
if ( V_286 -> V_181 == V_27 -> V_181 ) {
V_7 = - V_92 ;
goto V_287;
}
}
V_7 = F_169 ( V_27 -> V_182 . V_2 , & V_27 -> V_182 ) ;
if ( V_7 < 0 )
goto V_287;
F_170 ( & V_27 -> V_288 , & V_289 ) ;
F_18 ( & V_125 ) ;
F_171 ( & V_27 -> V_129 ) ;
F_171 ( & V_27 -> V_30 ) ;
if ( V_27 -> V_182 . V_2 -> V_254 )
F_147 ( V_27 ) ;
else if ( V_27 -> V_244 )
F_142 ( V_27 ) ;
else
...
F_175 ( V_19 -> V_57 ) ;
F_176 ( & V_19 -> V_184 -> V_288 , & V_291 ) ;
}
F_18 ( & V_125 ) ;
F_96 (sasc, &notifiers, list) {
F_177 ( & V_184 -> V_219 ) ;
F_178 ( & V_184 -> V_57 -> V_2 ) ;
}
F_17 ( & V_125 ) ;
F_179 (icd, tmp, &devices, list)
if ( V_19 -> V_180 == V_27 -> V_181 )
F_160 ( V_19 ) ;
F_18 ( & V_125 ) ;
F_180 ( & V_27 -> V_182 ) ;
...
int V_292 = - 1 , V_34 ;
F_17 ( & V_125 ) ;
for ( V_34 = 0 ; V_34 < 256 && V_292 < 0 ; V_34 ++ ) {
V_292 = V_34 ;
F_96 (ix, &devices, list) {
if ( V_286 -> V_180 == V_19 -> V_180 && V_286 -> V_293 == V_34 ) {
V_292 = - 1 ;
break;
}
}
...
V_78 -> V_302 = & V_27 -> V_129 ;
V_19 -> V_78 = V_78 ;
return 0 ;
}
static int F_113 ( struct V_18 * V_19 )
{
const struct V_303 * type = V_19 -> V_78 -> V_2 . type ;
int V_7 ;
if ( ! V_19 -> V_52 )
return - V_25 ;
F_184 ( V_19 -> V_78 , V_19 ) ;
if ( V_19 -> V_78 -> V_79 == 0 ) {
F_185 ( V_19 -> V_78 , V_304 ) ;
F_185 ( V_19 -> V_78 , V_305 ) ;
F_185 ( V_19 -> V_78 , V_306 ) ;
}
V_7 = F_186 ( V_19 -> V_78 , V_307 , - 1 ) ;
if ( V_7 < 0 ) {
...
static int F_187 ( struct V_185 * V_57 )
{
...
static int F_189 ( struct V_185 * V_57 )
{
