...
static int F_100 ( struct V_82 * V_159 )
{
V_159 -> V_160 = V_161 ;
return 0 ;
}
static int F_101 ( struct V_82 * V_83 , int V_162 )
{
struct V_1 * V_84 = V_83 -> V_152 ;
int V_163 = V_84 -> V_164 ;
return F_102 ( V_83 , F_6 ( V_163 , V_162 ) ) ;
}
...
static int F_104 ( struct F_9 * V_166 )
{
struct V_1 * V_58 = F_105 ( V_166 -> V_167 . V_168 ) ;
struct V_9 * V_10 = F_28 ( V_58 ) ;
struct V_16 * V_17 =
F_106 ( sizeof( * V_17 ) , V_169 ) ;
if ( ! V_17 )
return - V_170 ;
F_107 ( & V_17 -> V_145 ) ;
F_108 ( & V_17 -> V_50 , 0 ) ;
...
static void F_109 ( struct F_9 * V_166 )
{
struct V_16 * V_17 = V_166 -> V_19 ;
F_110 ( V_17 ) ;
}
static int F_111 ( struct V_1 * V_84 )
{
struct V_9 * V_10 = F_28 ( V_84 ) ;
return F_112 ( & V_84 -> V_171 , V_10 -> V_3 , 2 ) ;
}
...
const char * * V_176 ;
struct V_55 * * V_177 ;
struct V_178 V_179 = { . V_180 = 2 } ;
V_64 = V_10 -> V_65 + V_60 ;
V_177 = F_106 ( V_64 * sizeof( struct V_55 * ) , V_169 ) ;
V_175 = F_106 ( V_64 * sizeof( T_5 * ) , V_169 ) ;
V_176 = F_106 ( V_64 * sizeof( char * ) , V_169 ) ;
if ( ! V_175 || ! V_177 || ! V_176 ) {
V_70 = - V_170 ;
goto V_104;
}
V_175 [ 0 ] = F_32 ;
...
V_70 = F_117 ( V_3 , V_64 , V_177 , V_175 , V_176 , & V_179 ) ;
if ( V_70 )
goto V_104;
F_113 ( & V_10 -> V_67 , V_177 [ 0 ] ) ;
F_113 ( & V_10 -> V_77 , V_177 [ 1 ] ) ;
for ( V_63 = V_60 ; V_63 < V_64 ; V_63 ++ )
F_113 ( & V_10 -> V_62 [ V_63 - V_60 ] ,
V_177 [ V_63 ] ) ;
F_118 ( V_3 , V_181 , V_137 ) ;
F_118 ( V_3 , V_182 , V_45 ) ;
V_70 = 0 ;
V_104:
F_110 ( V_176 ) ;
F_110 ( V_175 ) ;
...
struct V_185 * V_186 ;
if ( ! V_3 -> V_172 -> V_187 ) {
F_120 ( & V_3 -> V_167 , L_12 ,
V_188 ) ;
return - V_189 ;
}
V_65 = F_121 ( V_3 , V_65 ) ? : 1 ;
V_184 = F_121 ( V_3 , V_190 ) + 1 ;
if ( V_65 == 1 )
V_186 = & V_191 ;
else
V_186 = & V_192 ;
...
if ( V_70 )
goto V_194;
V_164 = F_121 ( V_3 , V_164 ) ? : 1 ;
V_84 -> V_164 = F_15 ( T_1 , V_164 , V_84 -> V_195 ) ;
V_84 -> V_196 = F_121 ( V_3 , V_196 ) ? : 0xFFFF ;
V_84 -> V_197 = F_121 ( V_3 , V_197 ) + 1 + 0x4000 ;
V_84 -> V_198 = V_184 ;
V_84 -> V_199 = 0 ;
V_84 -> V_200 = V_137 ;
V_84 -> V_201 = V_65 ;
