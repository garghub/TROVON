...
V_66 -> V_135 ) ;
V_179:
F_79 ( V_2 , V_67 -> V_165 . V_227 . V_128 , V_221 , V_186 ) ;
F_46 ( V_2 , V_66 ) ;
F_130 ( 1 ) ;
return - V_188 ;
V_232:
...
static void F_79 ( struct V_1 * V_2 , T_8 V_128 ,
...
switch ( V_2 -> V_19 -> V_206 ) {
case V_207 :
V_242 = F_131 ( & V_198 -> V_208 ,
V_198 -> V_208 . V_205 ) ;
break;
case V_209 :
V_242 = F_131 ( & V_198 -> V_210 ,
V_198 -> V_210 . V_205 ) ;
break;
case V_211 :
V_242 = F_131 ( & V_198 -> V_212 ,
V_198 -> V_212 . V_205 ) ;
break;
default:
F_117 () ;
