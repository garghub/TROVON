...
bool F_59 ( struct V_44 * V_45 , T_3 * V_104 ,
struct V_18 * V_105 )
{
unsigned long V_106 = 0 ;
int V_107 = 0 ;
F_60 ( V_45 , V_104 , V_105 , & V_107 , & V_106 ) ;
if ( V_107 > 1 &&
F_61 ( V_92 , V_106 + ( 60 * V_108 << V_107 ) ) ) {
V_105 -> V_10 = - 1 ;
return false ;
}
if ( F_62 ( V_45 ) ) {
...
bool F_63 ( struct V_44 * V_45 , int * V_11 )
{
struct V_18 V_105 = { . V_10 = 0 } ;
struct V_47 * V_48 = F_30 ( V_45 ) ;
T_3 V_104 ;
if ( V_48 -> V_110 && ! V_48 -> V_111 ) {
if ( F_59 ( V_45 , & V_104 , & V_105 ) ) {
F_64 ( V_45 ) -> V_112 = 1 ;
return true ;
}
V_48 -> V_111 = F_65 ( sizeof( * V_48 -> V_111 ) ,
V_45 -> V_113 ) ;
if ( V_48 -> V_111 )
V_48 -> V_111 -> V_105 = V_105 ;
else
* V_11 = - V_114 ;
}
return false ;
...
F_67 ( & V_115 ) ;
V_116 = V_92 ;
F_58 ( F_55 ( V_45 ) , V_117 ) ;
}
void F_68 ( void )
{
F_47 ( & V_115 , 0 ) ;
}
bool F_62 ( struct V_44 * V_45 )
{
int V_118 = F_69 ( & V_115 ) ;
int V_119 ;
unsigned long V_120 ;
if ( ! V_118 )
return false ;
V_119 = 1 << F_70 ( V_118 - 1 , 6 ) ;
V_120 = V_119 * V_121 * V_108 ;
if ( F_61 ( V_92 , V_116 + V_120 ) )
return true ;
F_30 ( V_45 ) -> V_122 = 1 ;
return false ;
}
...
return;
if ( ! V_48 -> V_126 ) {
V_124 = F_72 ( & V_48 -> V_127 ) ;
if ( V_124 && ! F_73 ( V_124 ) ) {
V_46 = F_74 ( V_124 , struct V_25 , V_128 ) ;
if ( F_31 ( V_46 ) -> V_55 & V_60 ) {
F_66 ( V_45 ) ;
return;
}
...
F_69 ( & V_115 ) ) {
V_62 = F_75 ( V_45 ) ;
if ( ! ( V_62 && V_62 -> V_129 && ( V_62 -> V_129 -> V_130 & V_131 ) ) )
F_68 () ;
F_76 ( V_62 ) ;
}
}
