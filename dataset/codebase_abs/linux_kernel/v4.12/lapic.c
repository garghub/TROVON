...
{
V_37 V_227 = V_7 -> V_58 . V_227 ;
if ( ( F_153 ( & V_7 -> V_58 . V_225 ) &&
! F_49 ( V_7 ) ) ||
V_85 -> V_243 ( V_7 -> V_4 , V_227 ) ) {
if ( V_7 -> V_58 . V_242 )
F_178 ( V_7 ) ;
} else {
V_7 -> V_58 . V_242 = true ;
...
F_182 ( V_7 -> V_4 -> V_13 ,
V_7 -> V_58 . V_242 ) ;
return V_7 -> V_58 . V_242 ;
}
void F_183 ( struct V_3 * V_4 )
{
struct V_6 * V_7 = V_4 -> V_8 . V_7 ;
F_184 ( ! V_7 -> V_58 . V_242 ) ;
F_184 ( F_156 ( & V_4 -> V_222 ) ) ;
F_178 ( V_7 ) ;
F_152 ( V_7 ) ;
...
{
F_188 ( & V_7 -> V_58 . V_225 , 0 ) ;
if ( F_49 ( V_7 ) || F_48 ( V_7 ) ) {
if ( F_174 ( V_7 ) &&
! ( V_85 -> V_243 && F_181 ( V_7 ) ) )
F_172 ( V_7 ) ;
} else if ( F_50 ( V_7 ) ) {
if ( ! ( V_85 -> V_243 && F_181 ( V_7 ) ) )
F_165 ( V_7 ) ;
}
}
static void F_189 ( struct V_6 * V_7 , T_2 V_244 )
{
...
F_190 ( & V_7 -> V_4 -> V_31 -> V_8 . V_246 ) ;
}
}
int F_191 ( struct V_6 * V_7 , T_2 V_74 , T_2 V_47 )
{
int V_144 = 0 ;
F_192 ( V_74 , V_47 ) ;
switch ( V_74 ) {
...
case V_258 :
if ( F_29 ( V_7 ) ) {
F_191 ( V_7 , V_175 , 0x40000 | ( V_47 & 0xff ) ) ;
} else
V_144 = 1 ;
break;
default:
...
static int F_193 ( struct V_3 * V_4 , struct V_203 * V_210 ,
...
F_191 ( V_7 , V_21 & 0xff0 , V_47 ) ;
return 0 ;
}
void F_194 ( struct V_3 * V_4 )
{
F_191 ( V_4 -> V_8 . V_7 , V_247 , 0 ) ;
}
void F_195 ( struct V_3 * V_4 , T_2 V_21 )
{
T_2 V_47 = 0 ;
V_21 &= 0xff0 ;
F_145 ( V_4 -> V_8 . V_7 , V_21 , 4 , & V_47 ) ;
F_191 ( V_4 -> V_8 . V_7 , V_21 , V_47 ) ;
}
...
F_40 ( & V_52 ) ;
if ( V_7 -> V_9 )
F_197 ( ( unsigned long ) V_7 -> V_9 ) ;
F_198 ( V_7 ) ;
}
V_37 F_199 ( struct V_3 * V_4 )
{
struct V_6 * V_7 = V_4 -> V_8 . V_7 ;
if ( ! F_53 ( V_4 ) )
return 0 ;
...
void F_201 ( struct V_3 * V_4 , V_37 V_97 )
{
struct V_6 * V_7 = V_4 -> V_8 . V_7 ;
...
void F_202 ( struct V_3 * V_4 , unsigned long V_262 )
{
struct V_6 * V_7 = V_4 -> V_8 . V_7 ;
...
void F_204 ( struct V_3 * V_4 , V_37 V_263 )
{
...
void F_207 ( struct V_3 * V_4 , bool V_270 )
{
struct V_6 * V_7 ;
int V_34 ;
F_81 ( L_43 , V_241 ) ;
...
F_150 ( V_7 ) ;
if ( F_208 ( V_4 ) &&
F_209 ( V_4 -> V_31 , V_271 ) )
F_39 ( V_7 , V_251 ,
F_210 ( 0 , V_272 ) ) ;
F_189 ( V_7 , F_16 ( V_7 , V_251 ) ) ;
...
static bool F_212 ( struct V_6 * V_7 )
{
return F_49 ( V_7 ) ;
}
...
int F_214 ( struct V_6 * V_7 , int V_55 )
{
...
static enum V_274 F_216 ( struct V_275 * V_97 )
{
...
if ( F_212 ( V_7 ) ) {
F_176 ( V_7 ) ;
F_217 ( & V_224 -> V_219 , V_224 -> V_188 ) ;
return V_276 ;
} else
return V_277 ;
}
int F_218 ( struct V_3 * V_4 )
{
struct V_6 * V_7 ;
ASSERT ( V_4 != NULL ) ;
F_81 ( L_47 , V_4 -> V_13 ) ;
V_7 = F_219 ( sizeof( * V_7 ) , V_38 ) ;
if ( ! V_7 )
goto V_278;
V_4 -> V_8 . V_7 = V_7 ;
V_7 -> V_9 = ( void * ) F_220 ( V_38 ) ;
if ( ! V_7 -> V_9 ) {
F_100 ( V_164 L_48 ,
V_4 -> V_13 ) ;
goto V_279;
...
V_7 -> V_4 = V_4 ;
F_221 ( & V_7 -> V_58 . V_219 , V_280 ,
V_235 ) ;
V_7 -> V_58 . V_219 . V_281 = F_216 ;
V_4 -> V_8 . V_259 = V_260 ;
F_41 ( & V_52 . V_53 ) ;
F_207 ( V_4 , false ) ;
F_222 ( & V_7 -> V_204 , & V_282 ) ;
return 0 ;
V_279:
F_198 ( V_7 ) ;
V_278:
...
int F_229 ( struct V_3 * V_4 , struct V_286 * V_287 )
{
memcpy ( V_287 -> V_9 , V_4 -> V_8 . V_7 -> V_9 , sizeof( * V_287 ) ) ;
return F_228 ( V_4 , V_287 , false ) ;
}
int F_230 ( struct V_3 * V_4 , struct V_286 * V_287 )
{
struct V_6 * V_7 = V_4 -> V_8 . V_7 ;
int V_143 ;
F_204 ( V_4 , V_4 -> V_8 . V_259 ) ;
F_38 ( V_7 , * ( ( T_2 * ) ( V_287 -> V_9 + V_50 ) ) ) ;
V_143 = F_228 ( V_4 , V_287 , true ) ;
if ( V_143 )
return V_143 ;
...
int F_240 ( struct V_3 * V_4 , T_6 V_295 )
{
if ( V_295 ) {
if ( F_241 ( V_4 -> V_31 ,
& V_4 -> V_8 . V_7 -> V_293 ,
...
int F_242 ( struct V_3 * V_4 , T_2 V_296 , V_37 V_97 )
{
struct V_6 * V_7 = V_4 -> V_8 . V_7 ;
...
return 1 ;
if ( V_74 == V_175 )
F_191 ( V_7 , V_177 , ( T_2 ) ( V_97 >> 32 ) ) ;
return F_191 ( V_7 , V_74 , ( T_2 ) V_97 ) ;
}
int F_243 ( struct V_3 * V_4 , T_2 V_296 , V_37 * V_97 )
{
struct V_6 * V_7 = V_4 -> V_8 . V_7 ;
...
int F_244 ( struct V_3 * V_4 , T_2 V_74 , V_37 V_97 )
{
struct V_6 * V_7 = V_4 -> V_8 . V_7 ;
if ( ! F_53 ( V_4 ) )
return 1 ;
...
int F_245 ( struct V_3 * V_4 , T_2 V_74 , V_37 * V_97 )
{
struct V_6 * V_7 = V_4 -> V_8 . V_7 ;
T_2 V_298 , V_299 = 0 ;
if ( ! F_53 ( V_4 ) )
...
int F_246 ( struct V_3 * V_4 , V_37 V_97 )
{
...
if ( ! F_79 ( V_4 ) )
return 0 ;
return F_241 ( V_4 -> V_31 , & V_4 -> V_8 . V_96 . V_97 ,
V_208 , sizeof( T_1 ) ) ;
}
