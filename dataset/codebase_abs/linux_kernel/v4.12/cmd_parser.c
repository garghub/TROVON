...
V_173 [ V_18 ] = F_11 ( V_23 , V_18 ) ;
F_114 ( V_23 -> V_27 -> V_28 , V_23 -> V_2 , V_23 -> V_37 , V_173 ,
V_57 , V_23 -> V_33 == V_34 ,
V_171 , V_172 ) ;
}
...
V_177 = F_116 () ;
F_112 ( & V_178 , V_176 - V_175 , V_177 - V_176 ) ;
if ( ! ( V_14 -> V_44 & V_180 ) ) {
V_48 = F_46 ( V_23 ) ;
if ( V_48 ) {
F_26 ( L_48 , V_14 -> V_19 ) ;
...
static inline bool F_117 ( unsigned long V_63 ,
unsigned long V_181 , unsigned int V_182 )
{
if ( V_182 >= V_181 )
return ( V_63 < V_181 ) || ( V_63 > V_182 ) ;
else
return ( V_63 > V_182 ) && ( V_63 < V_181 ) ;
}
static int F_118 ( struct V_22 * V_23 ,
unsigned long V_183 , unsigned long V_184 ,
unsigned long V_185 , unsigned long V_186 )
{
unsigned long V_181 , V_182 , V_187 ;
int V_48 = 0 ;
struct V_51 * V_27 = V_23 -> V_27 ;
V_181 = V_185 + V_183 ;
V_182 = V_185 + V_184 ;
V_187 = V_185 + V_186 ;
F_8 ( L_49 , V_181 , V_182 ) ;
while ( V_23 -> V_37 != V_182 ) {
if ( V_23 -> V_33 == V_34 ) {
if ( ! ( V_23 -> V_37 >= V_185 ) ||
! ( V_23 -> V_37 < V_187 ) ) {
F_26 ( L_50
...
if ( F_117 ( V_23 -> V_37 , V_181 , V_182 ) ) {
F_26 ( L_52
L_53 ,
V_23 -> V_37 , V_185 ,
V_183 , V_184 ) ;
...
static int F_119 ( struct V_188 * V_72 )
{
unsigned long V_181 , V_182 , V_187 ;
struct V_22 V_23 ;
int V_48 = 0 ;
if ( F_14 ( ! F_16 ( V_72 -> V_185 , V_136 ) ) )
return - V_50 ;
V_181 = V_72 -> V_185 + V_72 -> V_183 ;
V_182 = V_72 -> V_185 + V_72 -> V_184 ;
V_187 = V_72 -> V_185 + F_120 ( V_72 -> V_189 ) ;
V_23 . V_33 = V_34 ;
V_23 . V_35 = V_36 ;
V_23 . V_27 = V_72 -> V_27 ;
V_23 . V_2 = V_72 -> V_2 ;
V_23 . V_29 = V_72 -> V_185 ;
V_23 . V_30 = F_120 ( V_72 -> V_189 ) ;
V_23 . V_31 = V_181 ;
V_23 . V_32 = V_182 ;
V_23 . V_41 = V_72 -> V_190 ;
V_23 . V_72 = V_72 ;
if ( ( V_191 & ( 1 << V_72 -> V_2 ) ) ||
V_181 == V_182 )
return 0 ;
V_48 = F_15 ( & V_23 , V_181 ) ;
if ( V_48 )
goto V_192;
V_48 = F_118 ( & V_23 , V_72 -> V_183 , V_72 -> V_184 ,
V_72 -> V_185 , F_120 ( V_72 -> V_189 ) ) ;
V_192:
return V_48 ;
}
static int F_121 ( struct V_193 * V_194 )
{
unsigned long V_181 , V_182 , V_187 , V_30 , V_32 ;
struct V_22 V_23 ;
int V_48 = 0 ;
struct V_188 * V_72 = F_122 ( V_194 ,
struct V_188 ,
V_194 ) ;
if ( F_14 ( ! F_16 ( V_194 -> V_195 . V_133 , V_136 ) ) )
return - V_50 ;
V_32 = V_194 -> V_195 . V_196 + 3 * sizeof( T_2 ) ;
V_30 = F_123 ( V_194 -> V_195 . V_196 + V_197 ,
V_160 ) ;
V_181 = V_194 -> V_195 . V_133 ;
V_182 = V_194 -> V_195 . V_133 + V_32 ;
V_187 = V_194 -> V_195 . V_133 + V_30 ;
V_23 . V_33 = V_34 ;
V_23 . V_35 = V_36 ;
V_23 . V_27 = V_72 -> V_27 ;
V_23 . V_2 = V_72 -> V_2 ;
V_23 . V_29 = V_194 -> V_195 . V_133 ;
V_23 . V_30 = V_30 ;
V_23 . V_31 = V_181 ;
V_23 . V_32 = V_182 ;
V_23 . V_41 = V_194 -> V_195 . V_198 ;
V_23 . V_72 = V_72 ;
V_48 = F_15 ( & V_23 , V_181 ) ;
if ( V_48 )
goto V_192;
V_48 = F_118 ( & V_23 , 0 , V_32 ,
V_194 -> V_195 . V_133 , V_30 ) ;
V_192:
return V_48 ;
}
static int F_124 ( struct V_188 * V_72 )
{
struct V_51 * V_27 = V_72 -> V_27 ;
unsigned long V_181 , V_182 , V_199 , V_200 ;
T_1 * V_201 ;
int V_48 ;
V_200 = F_120 ( V_72 -> V_189 ) ;
V_72 -> V_186 = ( V_72 -> V_184 + V_200 -
V_72 -> V_183 ) % V_200 ;
V_181 = V_72 -> V_185 + V_72 -> V_183 ;
V_182 = V_72 -> V_185 + V_72 -> V_184 ;
V_199 = V_72 -> V_185 + V_200 ;
V_201 = F_125 ( V_72 -> V_202 , V_72 -> V_186 / sizeof( T_1 ) ) ;
if ( F_100 ( V_201 ) )
return F_101 ( V_201 ) ;
V_72 -> V_190 = V_201 ;
if ( V_181 > V_182 ) {
...
V_201 += V_48 / sizeof( T_1 ) ;
V_181 = V_72 -> V_185 ;
}
V_48 = F_90 ( V_27 , V_27 -> V_150 . V_151 , V_181 , V_182 , V_201 ) ;
if ( V_48 < 0 ) {
F_26 ( L_41 ) ;
return V_48 ;
}
V_201 += V_48 / sizeof( T_1 ) ;
F_126 ( V_72 -> V_202 , V_201 ) ;
return 0 ;
}
int F_127 ( struct V_188 * V_72 )
{
int V_48 ;
struct V_51 * V_27 = V_72 -> V_27 ;
V_48 = F_124 ( V_72 ) ;
...
{
int V_203 = V_194 -> V_195 . V_196 ;
unsigned long V_133 = V_194 -> V_195 . V_133 ;
struct V_188 * V_72 = F_122 ( V_194 ,
struct V_188 ,
V_194 ) ;
struct V_51 * V_27 = V_72 -> V_27 ;
...
V_194 -> V_195 . V_159 = V_159 ;
V_194 -> V_195 . V_198 = V_205 ;
return 0 ;
V_165:
F_106 ( V_159 ) ;
V_164:
F_107 ( V_194 -> V_195 . V_159 ) ;
return V_48 ;
}
static int F_129 ( struct V_193 * V_194 )
{
T_2 V_206 [ V_207 ] = { 0 } ;
unsigned char * V_208 ;
V_206 [ 0 ] = 0x18800001 ;
V_206 [ 1 ] = V_194 -> V_209 . V_133 ;
V_208 = ( unsigned char * ) V_194 -> V_195 . V_198 +
V_194 -> V_195 . V_196 ;
memcpy ( V_208 , V_206 , V_197 ) ;
return 0 ;
}
int F_130 ( struct V_193 * V_194 )
{
int V_48 ;
struct V_188 * V_72 = F_122 ( V_194 ,
struct V_188 ,
...
static struct V_8 * F_131 ( struct V_9 * V_10 ,
unsigned int V_11 , int V_15 )
{
struct V_8 * V_14 = NULL ;
unsigned int V_210 ;
F_132 (ring, (unsigned long *)&rings, I915_NUM_ENGINES) {
V_14 = F_3 ( V_10 , V_11 , V_210 ) ;
if ( V_14 )
break;
}
return V_14 ;
...
if ( ! ( V_8 [ V_18 ] . V_212 & V_211 ) )
continue;
V_13 = F_135 ( sizeof( * V_13 ) , V_157 ) ;
if ( ! V_13 )
return - V_158 ;
V_13 -> V_14 = & V_8 [ V_18 ] ;
V_14 = F_131 ( V_10 ,
...
V_13 -> V_14 -> V_212 , V_13 -> V_14 -> V_15 ) ;
}
return 0 ;
}
...
struct V_12 * V_13 ;
int V_18 ;
F_138 (gvt->cmd_table, i, tmp, e, hlist)
F_108 ( V_13 ) ;
F_139 ( V_10 -> V_169 ) ;
}
