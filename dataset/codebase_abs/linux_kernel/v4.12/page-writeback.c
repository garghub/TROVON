...
int F_163 ( struct V_241 * V_241 , int V_252 )
{
...
int F_186 ( struct V_241 * V_241 )
{
F_187 ( V_241 ) ;
if ( ! F_169 ( V_241 ) ) {
struct V_165 * V_166 = F_188 ( V_241 ) ;
unsigned long V_59 ;
if ( ! V_166 ) {
F_189 ( V_241 ) ;
return 1 ;
}
F_190 ( & V_166 -> V_215 , V_59 ) ;
F_135 ( F_188 ( V_241 ) != V_166 ) ;
F_77 ( ! F_191 ( V_241 ) && ! F_192 ( V_241 ) ) ;
F_170 ( V_241 , V_166 ) ;
F_193 ( & V_166 -> V_217 , F_194 ( V_241 ) ,
V_238 ) ;
F_195 ( & V_166 -> V_215 , V_59 ) ;
F_189 ( V_241 ) ;
if ( V_166 -> V_188 ) {
F_196 ( V_166 -> V_188 , V_256 ) ;
}
return 1 ;
}
F_189 ( V_241 ) ;
...
int F_222 ( struct V_241 * V_241 , bool V_262 )
{
struct V_165 * V_166 = F_188 ( V_241 ) ;
int V_77 ;
F_187 ( V_241 ) ;
...
int F_219 ( struct V_165 * V_166 , int V_230 )
{
return F_226 ( & V_166 -> V_217 , V_230 ) ;
}
void F_227 ( struct V_241 * V_241 )
{
if ( F_228 ( F_112 ( V_241 -> V_166 -> V_188 ) ) )
F_152 ( V_241 ) ;
}
