...
* V_106 = V_99 . V_69 ;
* V_107 = V_99 . V_70 ;
for ( V_108 = 1 ; V_108 < V_2 -> V_77 ;
V_108 ++ ) {
F_36 ( V_2 , V_2 -> V_9 ,
V_2 -> V_77 - 1 - V_108 , & V_99 ) ;
if ( V_99 . V_69 != * V_106 - V_108 ||
V_99 . V_70 != * V_107 - V_108 )
break;
}
return V_108 ;
}
...
static int F_69 ( struct V_85 * V_6 , char * V_110 )
{
struct V_1 * V_2 ;
int V_3 ;
V_2 = F_70 ( sizeof( * V_2 ) , V_111 ) ;
if ( ! V_2 )
return - V_4 ;
V_2 -> V_6 = V_6 ;
V_2 -> V_62 = 1 ;
