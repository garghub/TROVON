...
V_3 -> V_50 = V_43 -> V_51 ;
V_3 -> V_11 = F_27 ( 0 , V_47 ) ;
if ( ! V_3 -> V_11 )
goto error;
V_3 -> V_12 = F_28 ( V_14 , V_47 ) ;
if ( ! V_3 -> V_12 )
goto error;
...
V_3 -> V_12 -> V_52 = V_53 | V_54 |
V_55 ;
V_3 -> V_12 -> V_56 = V_57 ;
V_3 -> V_12 -> V_58 = F_30 ( ( V_59 + 1 ) << 8 ) ;
V_3 -> V_12 -> V_60 = F_30 ( V_41 -> V_61 . V_62 ) ;
V_3 -> V_12 -> V_63 = F_30 ( V_14 ) ;
...
F_3 ( & V_3 -> V_7 ) ;
F_38 ( & V_3 -> V_8 , F_4 ) ;
F_37 ( & V_9 -> V_3 , L_15 , V_68 ) ;
}
static int F_44 ( int V_69 , struct V_70 * V_70 , int V_71 )
{
struct V_2 * V_3 ;
V_3 = V_70 -> V_72 ;
return F_45 ( V_69 , V_70 , V_71 , & V_3 -> V_32 ) ;
}
static int F_46 ( struct V_73 * V_73 , struct V_70 * V_70 )
{
struct V_2 * V_3 ;
struct V_37 * V_9 ;
int V_74 ;
...
static int F_51 ( struct V_73 * V_73 , struct V_70 * V_70 )
{
struct V_2 * V_3 ;
V_3 = V_70 -> V_72 ;
if ( V_3 == NULL )
...
static T_1 F_52 ( struct V_70 * V_70 , char T_2 * V_78 , T_3 V_79 ,
T_4 * V_80 )
{
struct V_2 * V_3 ;
int V_19 = 0 ;
...
F_13 ( & V_3 -> V_30 , V_18 ) ;
V_81 = snprintf ( V_82 , 20 , L_17 , V_3 -> V_31 ) ;
F_14 ( & V_3 -> V_30 , V_18 ) ;
if ( * V_80 < V_81 ) {
...
static T_1 F_54 ( struct V_70 * V_70 , const char T_2 * V_84 ,
T_3 V_79 , T_4 * V_80 )
{
struct V_2 * V_3 ;
...
F_6 ( & V_3 -> V_9 -> V_3 , L_18 , V_6 ,
V_3 -> V_13 [ 0 ] ) ;
V_19 = F_16 ( V_3 -> V_11 , V_47 ) ;
if ( V_19 >= 0 )
V_89 = F_59 ( V_97 ) ;
F_60 ( & V_3 -> V_7 , & V_45 ) ;
F_43 ( & V_3 -> V_48 ) ;
