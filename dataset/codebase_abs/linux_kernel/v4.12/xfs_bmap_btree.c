...
struct V_102 * V_103 )
{
struct V_12 * V_13 = V_103 -> V_121 -> V_122 ;
struct V_9 * V_123 = F_58 ( V_103 ) ;
unsigned int V_106 ;
switch ( V_123 -> V_49 ) {
case F_32 ( V_50 ) :
if ( ! F_31 ( & V_13 -> V_48 ) )
return false ;
if ( ! F_33 ( & V_123 -> V_51 . V_52 . V_53 , & V_13 -> V_48 . V_54 ) )
return false ;
if ( F_18 ( V_123 -> V_51 . V_52 . V_55 ) != V_103 -> V_124 )
return false ;
if ( F_18 ( V_123 -> V_51 . V_52 . V_125 ) == 0 )
return false ;
case F_32 ( V_56 ) :
break;
default:
...
V_106 = F_4 ( V_123 -> V_24 ) ;
if ( V_106 > F_59 ( V_13 -> V_126 [ 0 ] , V_13 -> V_126 [ 1 ] ) )
return false ;
if ( F_4 ( V_123 -> V_25 ) > V_13 -> V_112 [ V_106 != 0 ] )
return false ;
if ( ! V_123 -> V_51 . V_52 . V_57 ||
( V_123 -> V_51 . V_52 . V_57 != F_24 ( V_58 ) &&
! F_60 ( V_13 , F_18 ( V_123 -> V_51 . V_52 . V_57 ) ) ) )
return false ;
if ( ! V_123 -> V_51 . V_52 . V_59 ||
( V_123 -> V_51 . V_52 . V_59 != F_24 ( V_58 ) &&
! F_60 ( V_13 , F_18 ( V_123 -> V_51 . V_52 . V_59 ) ) ) )
return false ;
return true ;
}
static void
...
union V_114 * V_132 )
{
return F_18 ( V_131 -> V_118 . V_32 ) <
F_18 ( V_132 -> V_118 . V_32 ) ;
}
STATIC int
F_69 (
struct V_60 * V_61 ,
...
if ( ! V_61 )
return - V_162 ;
error = F_75 ( V_61 , V_155 , V_157 ) ;
F_76 ( V_61 , error ? V_163 : V_164 ) ;
return error ;
}
