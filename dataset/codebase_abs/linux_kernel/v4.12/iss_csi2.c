...
V_2 -> V_178 . V_284 = F_91 ( 4096 * 4096 ) * 3 ;
V_251 = F_92 ( & V_2 -> V_178 , V_267 ) ;
if ( V_251 < 0 )
goto V_285;
return 0 ;
V_285:
F_93 ( & V_2 -> V_203 . V_170 ) ;
return V_251 ;
}
...
int F_96 ( struct V_181 * V_7 )
{
struct V_1 * V_286 = & V_7 -> V_286 ;
struct V_1 * V_287 = & V_7 -> V_287 ;
int V_251 ;
V_251 = F_97 ( & V_286 -> V_203 . V_170 , V_177 ,
& V_286 -> V_178 . V_210 . V_170 , 0 , 0 ) ;
if ( V_251 < 0 )
return V_251 ;
V_251 = F_97 ( & V_287 -> V_203 . V_170 , V_177 ,
& V_287 -> V_178 . V_210 . V_170 , 0 , 0 ) ;
if ( V_251 < 0 )
return V_251 ;
return 0 ;
}
void F_98 ( struct V_181 * V_7 )
{
struct V_1 * V_286 = & V_7 -> V_286 ;
struct V_1 * V_287 = & V_7 -> V_287 ;
F_99 ( & V_286 -> V_178 ) ;
F_93 ( & V_286 -> V_203 . V_170 ) ;
F_99 ( & V_287 -> V_178 ) ;
F_93 ( & V_287 -> V_203 . V_170 ) ;
}
