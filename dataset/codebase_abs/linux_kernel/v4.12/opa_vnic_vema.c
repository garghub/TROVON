...
V_107 = V_76 -> V_84 ;
V_107 -> V_3 . V_38 = V_39 ;
V_107 -> V_3 . V_126 = V_127 ;
V_107 -> V_3 . V_40 = V_41 ;
V_107 -> V_3 . V_96 = V_128 ;
V_7 -> V_129 ++ ;
V_107 -> V_3 . V_129 = F_66 ( V_7 -> V_129 ) ;
V_107 -> V_3 . V_53 = V_130 ;
V_107 -> V_131 [ 0 ] = V_132 ;
V_107 -> V_131 [ 1 ] = V_133 ;
V_107 -> V_131 [ 2 ] = V_134 ;
V_107 -> V_135 . V_136 = V_137 << 1 ;
V_107 -> V_135 . V_138 = V_132 ;
V_107 -> V_135 . V_139 = V_133 ;
V_107 -> V_135 . V_140 = V_134 ;
V_107 -> V_135 . V_141 = F_16 ( V_103 ) ;
V_112 = (struct V_111 * ) V_107 -> V_135 . V_142 ;
V_112 -> V_143 = F_8 ( V_36 -> V_143 ) ;
V_112 -> V_144 = F_8 ( V_36 -> V_144 ) ;
V_112 -> V_145 = F_16 ( V_36 -> V_145 ) ;
V_112 -> V_115 = F_8 ( V_36 -> V_115 ) ;
V_112 -> V_146 = V_36 -> V_146 ;
...
static int F_69 ( int V_149 , void * V_150 , void * V_36 )
{
struct V_5 * V_29 = V_150 ;
F_13 ( V_29 ) ;
return 0 ;
}
static int F_70 ( int V_149 , void * V_150 , void * V_36 )
{
struct V_5 * V_29 = V_150 ;
F_71 ( V_29 -> V_151 ) ;
return 0 ;
}
static int F_72 ( int V_149 , void * V_150 , void * V_36 )
{
struct V_5 * V_29 = V_150 ;
F_73 ( V_29 -> V_151 ) ;
return 0 ;
...
{
struct V_6 * V_7 =
F_75 ( V_153 , struct V_6 , V_156 ) ;
struct V_27 * V_28 = V_7 -> V_28 ;
if ( V_155 -> V_157 . V_31 != V_7 -> V_31 )
return;
F_76 ( L_9 ,
V_155 -> V_158 , V_155 -> V_159 -> V_160 , V_155 -> V_157 . V_31 ) ;
if ( V_155 -> V_158 == V_161 )
F_77 ( & V_7 -> V_9 , F_72 , NULL ) ;
if ( V_155 -> V_158 == V_162 )
F_77 ( & V_7 -> V_9 , F_70 , NULL ) ;
}
static void F_78 ( struct V_27 * V_28 )
{
int V_163 ;
for ( V_163 = 1 ; V_163 <= V_28 -> V_101 ; V_163 ++ ) {
struct V_6 * V_7 = F_52 ( V_28 , V_163 ) ;
if ( ! V_7 -> V_73 )
continue;
F_48 ( & V_7 -> V_98 ) ;
...
int V_163 ;
F_84 ( V_99 , V_165 . V_167 ) ;
F_84 ( V_100 , V_165 . V_167 ) ;
for ( V_163 = 1 ; V_163 <= V_28 -> V_101 ; V_163 ++ ) {
struct V_6 * V_7 = F_52 ( V_28 , V_163 ) ;
int V_168 ;
V_7 -> V_28 = V_28 ;
...
static void F_90 ( struct V_104 * V_159 )
{
struct V_27 * V_28 ;
int V_32 , V_171 = sizeof( * V_28 ) ;
if ( ! F_91 ( V_159 ) )
return;
V_171 += V_159 -> V_172 * sizeof( struct V_6 ) ;
V_28 = F_92 ( V_171 , V_94 ) ;
if ( ! V_28 )
return;
V_28 -> V_101 = V_159 -> V_172 ;
V_28 -> V_30 = V_159 ;
V_32 = F_83 ( V_28 ) ;
if ( ! V_32 )
F_93 ( L_11 ) ;
F_94 ( V_159 , & V_173 , V_28 ) ;
}
static void F_95 ( struct V_104 * V_159 ,
void * V_174 )
{
