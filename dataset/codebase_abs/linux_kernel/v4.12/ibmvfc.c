...
if ( ( V_47 = F_266 ( V_4 ) ) )
goto V_562;
V_4 -> V_563 = F_279 ( F_254 , V_4 , L_115 , V_535 ,
V_146 -> V_561 ) ;
if ( F_280 ( V_4 -> V_563 ) ) {
F_24 ( V_98 , L_116 ,
F_281 ( V_4 -> V_563 ) ) ;
...
if ( ! F_299 ( V_576 ) )
return - V_577 ;
F_300 (KERN_INFO IBMVFC_NAMEL_120 ,
