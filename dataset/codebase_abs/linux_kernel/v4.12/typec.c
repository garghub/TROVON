...
static struct V_17 *
F_32 ( struct V_2 * V_27 , struct V_60 * V_31 )
{
struct V_17 * V_18 ;
int V_37 ;
...
struct V_26 * V_34 = F_15 ( V_3 ) ;
if ( V_34 -> V_38 -> type == V_46 )
return sprintf ( V_11 , L_8 , V_34 -> V_87 == V_88 ?
L_35 : L_36 ) ;
return sprintf ( V_11 , L_37 , V_86 [ V_34 -> V_87 ] ) ;
}
...
if ( V_37 < 0 )
return V_37 ;
V_37 = V_34 -> V_38 -> V_90 ( V_34 -> V_38 , V_37 ) ;
if ( V_37 )
return V_37 ;
return V_33 ;
}
...
struct V_26 * V_34 = F_15 ( V_3 ) ;
if ( V_34 -> V_38 -> type == V_46 )
return sprintf ( V_11 , L_8 , V_34 -> V_94 == V_95 ?
L_41 : L_42 ) ;
return sprintf ( V_11 , L_37 , V_82 [ V_34 -> V_94 ] ) ;
}
...
{
struct V_26 * V_34 = F_15 ( V_3 ) ;
return sprintf ( V_11 , L_8 , V_96 [ V_34 -> V_91 ] ) ;
}
...
if ( V_37 )
return V_37 ;
V_37 = V_34 -> V_38 -> V_98 ( V_34 -> V_38 , (enum V_99 ) V_97 ) ;
if ( V_37 )
return V_37 ;
return V_33 ;
}
...
T_1 V_37 = 0 ;
int V_49 ;
for ( V_49 = 0 ; V_49 < F_71 ( V_34 -> V_38 -> V_65 ) ; V_49 ++ ) {
if ( V_34 -> V_38 -> V_65 [ V_49 ] )
V_37 += sprintf ( V_11 + V_37 , L_45 ,
V_64 [ V_34 -> V_38 -> V_65 [ V_49 ] ] ) ;
}
if ( ! V_37 )
return sprintf ( V_11 , L_46 ) ;
V_11 [ V_37 - 1 ] = '\n' ;
return V_37 ;
}
...
{
struct V_26 * V_34 = F_15 ( V_3 ) ;
T_3 V_101 = V_34 -> V_38 -> V_102 ;
return sprintf ( V_11 , L_47 , ( V_101 >> 8 ) & 0xff , ( V_101 >> 4 ) & 0xf ) ;
}
...
return sprintf ( V_11 , L_48 , ( V_63 -> V_38 -> V_89 >> 8 ) & 0xff ) ;
}
static int F_74 ( struct V_2 * V_3 , struct V_103 * V_104 )
{
int V_37 ;
V_37 = F_75 ( V_104 , L_49 , F_45 ( V_3 ) ) ;
if ( V_37 )
F_26 ( V_3 , L_50 ) ;
return V_37 ;
}
...
{
struct V_26 * V_34 = F_15 ( V_3 ) ;
F_77 ( & V_105 , V_34 -> V_12 ) ;
F_31 ( V_34 ) ;
}
void F_78 ( struct V_26 * V_34 , enum V_106 V_80 )
{
if ( V_34 -> V_87 == V_80 )
return;
V_34 -> V_87 = V_80 ;
F_10 ( & V_34 -> V_3 . V_16 , NULL , L_51 ) ;
F_12 ( & V_34 -> V_3 . V_16 , V_25 ) ;
}
void F_79 ( struct V_26 * V_34 , enum V_99 V_80 )
{
if ( V_34 -> V_94 == V_80 )
return;
V_34 -> V_94 = V_80 ;
...
void F_80 ( struct V_26 * V_34 , enum V_99 V_80 )
{
if ( V_34 -> V_100 == V_80 )
return;
V_34 -> V_100 = V_80 ;
...
struct V_17 *
F_82 ( struct V_26 * V_34 ,
struct V_60 * V_31 )
{
return F_32 ( & V_34 -> V_3 , V_31 ) ;
}
struct V_26 * F_83 ( struct V_2 * V_27 ,
const struct V_109 * V_38 )
{
struct V_26 * V_34 ;
int V_80 ;
int V_37 ;
...
V_34 -> V_3 . V_70 = V_71 ;
V_34 -> V_3 . V_27 = V_27 ;
V_34 -> V_3 . V_112 = V_38 -> V_112 ;
V_34 -> V_3 . type = & V_113 ;
F_34 ( & V_34 -> V_3 , L_55 , V_12 ) ;
V_37 = F_35 ( & V_34 -> V_3 ) ;
if ( V_37 ) {
F_26 ( V_27 , L_56 , V_37 ) ;
F_36 ( & V_34 -> V_3 ) ;
