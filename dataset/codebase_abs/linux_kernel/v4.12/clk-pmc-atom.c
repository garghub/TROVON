...
V_27 -> V_41 = F_21 ( & V_27 -> V_19 , V_29 . V_34 , NULL ) ;
if ( ! V_27 -> V_41 ) {
V_27 = F_17 ( - V_33 ) ;
goto V_40;
}
...
static struct V_42 * F_25 ( struct V_21 * V_22 ,
const char * V_34 ,
const char * V_43 ,
unsigned long V_44 )
{
...
if ( ! V_27 )
return F_17 ( - V_33 ) ;
V_27 -> V_12 = F_26 ( & V_22 -> V_31 , V_34 , V_43 ,
0 , V_44 ) ;
if ( F_27 ( V_27 -> V_12 ) )
return F_28 ( V_27 -> V_12 ) ;
V_27 -> V_41 = F_21 ( V_27 -> V_12 , V_34 , NULL ) ;
if ( ! V_27 -> V_41 ) {
F_29 ( V_27 -> V_12 ) ;
return F_17 ( - V_33 ) ;
}
...
static void F_30 ( struct V_42 * V_27 )
{
F_24 ( V_27 -> V_41 ) ;
F_29 ( V_27 -> V_12 ) ;
}
...
int V_52 = 0 ;
V_46 -> V_52 = 0 ;
while ( V_49 [ V_52 ] . V_34 )
V_52 ++ ;
V_46 -> V_48 = F_36 ( & V_22 -> V_31 , V_52 ,
sizeof( * V_46 -> V_48 ) , V_32 ) ;
if ( ! V_46 -> V_48 )
return F_17 ( - V_33 ) ;
V_25 = F_37 ( V_52 , sizeof( * V_25 ) ,
V_32 ) ;
if ( ! V_25 )
return F_17 ( - V_33 ) ;
for ( V_47 = 0 ; V_47 < V_52 ; V_47 ++ ) {
V_46 -> V_48 [ V_47 ] =
F_25 ( V_22 , V_49 [ V_47 ] . V_34 ,
V_49 [ V_47 ] . V_43 ,
V_49 [ V_47 ] . V_53 ) ;
if ( F_27 ( V_46 -> V_48 [ V_47 ] ) ) {
V_51 = F_38 ( V_46 -> V_48 [ V_47 ] ) ;
goto V_54;
}
V_25 [ V_47 ] = F_39 ( V_49 [ V_47 ] . V_34 , V_32 ) ;
}
V_46 -> V_52 = V_52 ;
return V_25 ;
V_54:
...
if ( ! V_56 || ! V_56 -> V_49 )
return - V_57 ;
V_46 = F_16 ( & V_22 -> V_31 , sizeof( * V_46 ) , V_32 ) ;
if ( ! V_46 )
return - V_33 ;
V_25 = F_35 ( V_22 , V_46 , V_56 -> V_49 ) ;
if ( F_27 ( V_25 ) )
return F_38 ( V_25 ) ;
for ( V_47 = 0 ; V_47 < V_58 ; V_47 ++ ) {
V_46 -> V_49 [ V_47 ] = F_15 ( V_22 , V_47 , V_56 -> V_24 ,
V_25 , V_46 -> V_52 ) ;
if ( F_27 ( V_46 -> V_49 [ V_47 ] ) ) {
V_51 = F_38 ( V_46 -> V_49 [ V_47 ] ) ;
goto V_59;
}
}
V_46 -> V_60 = F_21 ( & V_46 -> V_49 [ 3 ] -> V_19 , L_2 , NULL ) ;
if ( ! V_46 -> V_60 ) {
V_51 = - V_33 ;
goto V_59;
}
