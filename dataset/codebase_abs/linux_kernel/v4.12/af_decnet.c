...
V_40 = F_30 ( V_38 ) ;
V_3 -> V_228 -- ;
V_226 = F_37 ( F_101 ( V_3 ) , V_225 , V_3 -> V_66 , V_55 ) ;
if ( V_226 == NULL ) {
F_59 ( V_3 ) ;
F_102 ( V_38 ) ;
return - V_164 ;
...
if ( V_5 -> V_93 == V_289 )
return - V_155 ;
V_5 -> V_93 = ( V_273 . V_253 == 0 ) ? 0 : V_290 ;
break;
case V_291 :
if ( V_270 != sizeof( int ) )
return - V_155 ;
if ( V_5 -> V_93 == V_290 )
return - V_155 ;
V_5 -> V_93 = ( V_273 . V_253 == 0 ) ? 0 : V_289 ;
break;
case V_292 :
...
void * V_297 = NULL ;
unsigned int V_253 ;
if( F_125 ( V_296 , V_270 ) )
return - V_274 ;
switch ( V_268 ) {
case V_275 :
if ( V_296 > sizeof( struct V_219 ) )
V_296 = sizeof( struct V_219 ) ;
V_297 = & V_5 -> V_236 ;
break;
case V_276 :
if ( V_296 > sizeof( struct V_219 ) )
...
break;
case V_277 :
if ( V_296 > sizeof( struct V_212 ) )
V_296 = sizeof( struct V_212 ) ;
V_297 = & V_5 -> V_99 ;
break;
case V_279 :
if ( V_296 > sizeof( unsigned char ) )
V_296 = sizeof( unsigned char ) ;
V_297 = & V_5 -> V_95 ;
break;
case V_283 :
if ( V_296 > sizeof( struct V_294 ) )
V_296 = sizeof( struct V_294 ) ;
...
if ( F_125 ( V_29 , V_270 ) )
return - V_274 ;
V_305 = F_126 ( V_3 , V_56 , V_268 , V_269 , & V_29 ) ;
if ( V_305 >= 0 )
V_305 = F_113 ( V_29 , V_270 ) ;
return V_305 ;
}
#endif
case V_284 :
...
return - V_286 ;
case V_287 :
if ( V_296 > sizeof( unsigned long ) )
V_296 = sizeof( unsigned long ) ;
V_297 = & V_5 -> V_102 ;
break;
case V_288 :
if ( V_296 > sizeof( int ) )
V_296 = sizeof( int ) ;
V_253 = ( V_5 -> V_93 == V_290 ) ;
V_297 = & V_253 ;
break;
case V_291 :
if ( V_296 > sizeof( int ) )
V_296 = sizeof( int ) ;
V_253 = ( V_5 -> V_93 == V_289 ) ;
V_297 = & V_253 ;
break;
case V_292 :
if ( V_296 > sizeof( unsigned char ) )
...
if ( V_297 ) {
if ( F_127 ( V_269 , V_297 , V_296 ) )
return - V_274 ;
if ( F_113 ( V_296 , V_270 ) )
return - V_274 ;
}
return 0 ;
}
static int F_128 ( struct V_2 * V_3 , struct V_306 * V_307 , int V_194 , int V_308 )
{
struct V_37 * V_38 ;
int V_29 = 0 ;
if ( V_194 & V_309 )
return ! F_43 ( V_307 ) ? 1 : 0 ;
F_115 (q, skb) {
struct V_39 * V_40 = F_30 ( V_38 ) ;
V_29 += V_38 -> V_29 ;
if ( V_40 -> V_310 & 0x40 ) {
...
static int F_129 ( struct V_53 * V_2 , struct V_313 * V_314 , T_6 V_32 ,
int V_194 )
{
struct V_2 * V_3 = V_2 -> V_3 ;
struct V_4 * V_5 = F_2 ( V_3 ) ;
struct V_306 * V_315 = & V_3 -> V_224 ;
T_6 V_308 = V_32 > 1 ? 1 : 0 ;
T_6 V_316 = 0 ;
int V_16 = 0 ;
struct V_37 * V_38 , * V_317 ;
struct V_39 * V_40 = NULL ;
unsigned char V_318 = 0 ;
long V_181 = F_98 ( V_3 , V_194 & V_319 ) ;
F_58 ( V_3 ) ;
if ( F_66 ( V_3 , V_177 ) ) {
V_16 = - V_176 ;
goto V_19;
...
if ( V_16 )
goto V_19;
if ( V_194 & ~ ( V_321 | V_322 | V_309 | V_312 | V_319 | V_323 ) ) {
V_16 = - V_251 ;
goto V_19;
}
if ( V_194 & V_309 )
...
if ( F_128 ( V_3 , V_315 , V_194 , V_308 ) )
break;
if ( V_194 & V_319 ) {
V_16 = - V_328 ;
goto V_19;
...
F_132 ( V_329 , V_3 ) ;
F_133 ( V_3 , & V_181 , F_128 ( V_3 , V_315 , V_194 , V_308 ) , & V_183 ) ;
F_134 ( V_329 , V_3 ) ;
F_135 ( F_77 ( V_3 ) , & V_183 ) ;
}
F_136 (queue, skb, n) {
unsigned int V_330 = V_38 -> V_29 ;
V_40 = F_30 ( V_38 ) ;
if ( ( V_330 + V_316 ) > V_32 )
V_330 = V_32 - V_316 ;
if ( F_137 ( V_314 , V_38 -> V_30 , V_330 ) ) {
V_16 = - V_274 ;
break;
}
V_316 += V_330 ;
if ( ! ( V_194 & V_322 ) )
F_92 ( V_38 , V_330 ) ;
V_318 = V_40 -> V_310 & 0x40 ;
if ( V_38 -> V_29 == 0 ) {
F_138 ( V_38 , V_315 ) ;
F_102 ( V_38 ) ;
if ( ( V_5 -> V_81 == V_331 ) && ! F_139 ( V_3 ) ) {
V_5 -> V_81 = V_80 ;
F_44 ( V_3 , V_80 , 0 ) ;
}
}
...
V_16 = V_316 ;
if ( V_318 && ( V_3 -> V_311 == V_158 ) )
V_314 -> V_326 |= V_332 ;
V_19:
if ( V_16 == 0 )
V_16 = ( V_194 & V_322 ) ? - V_3 -> V_325 : F_79 ( V_3 ) ;
if ( ( V_16 >= 0 ) && V_314 -> V_333 ) {
F_140 ( sizeof( struct V_21 ) ) ;
memcpy ( V_314 -> V_333 , & V_5 -> V_42 , sizeof( struct V_21 ) ) ;
V_314 -> V_334 = sizeof( struct V_21 ) ;
}
F_59 ( V_3 ) ;
return V_16 ;
}
static inline int F_141 ( struct V_4 * V_5 , struct V_306 * V_315 , int V_194 )
{
unsigned char V_335 = V_5 -> V_86 & V_232 ;
if ( F_142 ( V_315 ) >= V_5 -> V_104 )
return 1 ;
if ( V_335 != V_88 ) {
if ( V_194 & V_309 ) {
if ( V_5 -> V_83 == 0 )
...
unsigned int F_143 ( struct V_169 * V_170 , int V_336 )
{
unsigned int V_337 = 230 - V_92 ;
if ( V_170 ) {
struct V_338 * V_339 = F_144 ( V_170 -> V_175 ) ;
V_336 -= F_145 ( V_170 ) ;
if ( V_339 -> V_340 )
V_336 -= 21 ;
else
...
struct V_4 * V_5 = F_2 ( V_3 ) ;
int V_341 = F_147 ( int , V_5 -> V_186 , V_5 -> V_91 ) ;
if ( V_194 & V_309 )
return 16 ;
if ( V_199 ) {
T_7 V_336 = F_148 ( V_199 ) ;
V_341 = F_147 ( int , F_143 ( V_199 -> V_170 , V_336 ) , V_341 ) ;
}
return V_341 ;
}
...
int * V_344 )
{
struct V_37 * V_38 = F_150 ( V_3 , V_342 ,
V_343 , V_344 ) ;
if ( V_38 ) {
V_38 -> V_153 = F_151 ( V_345 ) ;
V_38 -> V_346 = V_347 ;
}
return V_38 ;
}
static int F_152 ( struct V_53 * V_2 , struct V_313 * V_314 , T_6 V_32 )
{
struct V_2 * V_3 = V_2 -> V_3 ;
struct V_4 * V_5 = F_2 ( V_3 ) ;
T_6 V_337 ;
struct V_306 * V_315 = & V_5 -> V_47 ;
int V_194 = V_314 -> V_326 ;
int V_184 = 0 ;
T_6 V_348 = 0 ;
int V_167 = V_314 -> V_334 ;
F_153 ( struct V_21 * , V_6 , V_314 -> V_333 ) ;
struct V_37 * V_38 = NULL ;
struct V_39 * V_40 ;
T_6 V_29 ;
unsigned char V_335 ;
long V_181 ;
if ( V_194 & ~ ( V_349 | V_309 | V_319 | V_332 | V_323 | V_350 | V_321 ) )
return - V_251 ;
if ( V_167 && ( V_167 != sizeof( struct V_21 ) ) )
return - V_155 ;
F_58 ( V_3 ) ;
V_181 = F_89 ( V_3 , V_194 & V_319 ) ;
if ( V_2 -> type == V_161 ) {
if ( V_194 & V_332 ) {
V_184 = - V_155 ;
goto V_19;
...
if ( ( V_194 & V_349 ) && V_3 -> V_50 )
F_155 ( V_3 ) ;
V_337 = V_5 -> V_91 ;
V_335 = V_5 -> V_86 & V_232 ;
V_337 = F_146 ( V_3 , V_194 ) ;
if ( V_194 & V_309 ) {
V_315 = & V_5 -> V_48 ;
if ( V_32 > V_337 ) {
V_184 = - V_355 ;
...
V_40 = F_30 ( V_38 ) ;
F_156 ( V_38 , 64 + V_92 ) ;
if ( F_157 ( F_158 ( V_38 , V_29 ) , V_314 , V_29 ) ) {
V_184 = - V_274 ;
goto V_19;
}
if ( V_194 & V_309 ) {
...
V_40 -> V_310 |= 0x20 ;
V_5 -> V_357 += V_29 ;
if ( ( ( V_348 + V_29 ) == V_32 ) && ( V_194 & V_332 ) ) {
V_40 -> V_310 |= 0x40 ;
V_5 -> V_357 = 0 ;
if ( V_335 == V_358 )
V_5 -> V_82 -- ;
...
V_348 += V_29 ;
F_159 ( V_3 , V_38 , V_3 -> V_66 , V_194 & V_309 ) ;
V_38 = NULL ;
V_5 -> V_111 = F_46 ( V_3 ) ;
}
V_19:
...
static int F_161 ( struct V_360 * V_361 , unsigned long V_362 ,
void * V_214 )
{
...
static struct V_2 * F_166 ( struct V_366 * V_367 )
{
struct V_368 * V_71 = V_367 -> V_369 ;
struct V_2 * V_317 = NULL ;
for( V_71 -> V_370 = 0 ;
V_71 -> V_370 < V_371 ;
++ V_71 -> V_370 ) {
V_317 = F_28 ( & V_10 [ V_71 -> V_370 ] ) ;
if ( V_317 )
break;
}
return V_317 ;
}
static struct V_2 * F_167 ( struct V_366 * V_367 ,
struct V_2 * V_317 )
{
struct V_368 * V_71 = V_367 -> V_369 ;
V_317 = F_168 ( V_317 ) ;
...
static struct V_2 * F_169 ( struct V_366 * V_367 , T_8 * V_373 )
{
struct V_2 * V_3 = F_166 ( V_367 ) ;
if ( V_3 ) {
while( * V_373 && ( V_3 = F_167 ( V_367 , V_3 ) ) )
-- * V_373 ;
}
return * V_373 ? NULL : V_3 ;
}
static void * F_170 ( struct V_366 * V_367 , T_8 V_373 )
{
void * V_374 ;
F_171 ( & V_18 ) ;
V_374 = F_169 ( V_367 , & V_373 ) ;
if ( ! V_374 ) {
F_172 ( & V_18 ) ;
}
return V_374 ;
}
static void * F_173 ( struct V_366 * V_367 , T_8 * V_373 )
{
return * V_373 ? F_170 ( V_367 , * V_373 - 1 ) : V_375 ;
}
static void * F_174 ( struct V_366 * V_367 , void * V_376 , T_8 * V_373 )
{
void * V_374 ;
if ( V_376 == V_375 ) {
V_374 = F_170 ( V_367 , 0 ) ;
...
static void F_175 ( struct V_366 * V_367 , void * V_376 )
{
if ( V_376 && V_376 != V_375 )
F_172 ( & V_18 ) ;
}
static void F_176 ( struct V_21 * V_377 , unsigned char * V_28 )
{
int V_22 ;
switch ( F_4 ( V_377 -> V_25 ) ) {
case 0 :
sprintf ( V_28 , L_4 , V_377 -> V_24 ) ;
break;
default:
for ( V_22 = 0 ; V_22 < F_4 ( V_377 -> V_25 ) ; V_22 ++ ) {
V_28 [ V_22 ] = V_377 -> V_26 [ V_22 ] ;
if ( F_177 ( V_28 [ V_22 ] ) )
V_28 [ V_22 ] = '.' ;
}
V_28 [ V_22 ] = 0 ;
...
static inline void F_179 ( struct V_366 * V_367 , struct V_2 * V_3 )
{
struct V_4 * V_5 = F_2 ( V_3 ) ;
char V_379 [ V_380 ] ;
char V_381 [ V_380 ] ;
...
char V_383 [ V_34 + 3 ] ;
F_176 ( & V_5 -> V_6 , V_382 ) ;
F_176 ( & V_5 -> V_42 , V_383 ) ;
F_180 ( V_367 ,
L_22
L_23 ,
F_53 ( F_4 ( F_31 ( & V_5 -> V_6 ) ) , V_379 ) ,
V_5 -> V_11 ,
V_5 -> V_73 ,
V_5 -> V_74 ,
V_5 -> V_75 ,
...
static int F_181 ( struct V_366 * V_367 , void * V_376 )
{
if ( V_376 == V_375 ) {
F_182 ( V_367 , L_26 ) ;
} else {
...
static int F_183 ( struct V_386 * V_386 , struct V_246 * V_246 )
{
return F_184 ( V_246 , & V_387 ,
sizeof( struct V_368 ) ) ;
}
...
F_192 ( & V_390 ) ;
F_193 ( & V_391 ) ;
F_194 ( L_27 , V_392 , V_156 . V_393 , & V_394 ) ;
F_195 () ;
V_19:
return V_374 ;
}
