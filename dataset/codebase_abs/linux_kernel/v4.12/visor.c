...
struct V_58 * V_59 )
{
unsigned int V_60 = F_16 ( V_13 -> V_7 -> V_49 . V_45 ) ;
...
V_59 -> V_63 == 0 )
goto V_64;
if ( V_59 -> V_65 < 2 || V_59 -> V_63 < 2 ) {
F_2 ( & V_13 -> V_66 -> V_7 , L_20 ) ;
return - V_8 ;
}
F_25 ( V_59 -> V_67 [ 0 ] , V_59 -> V_67 [ 1 ] ) ;
F_25 ( V_59 -> V_68 [ 0 ] , V_59 -> V_68 [ 1 ] ) ;
V_64:
return V_31 ;
}
...
struct V_58 * V_59 )
{
V_59 -> V_69 [ 0 ] = V_59 -> V_69 [ 1 ] ;
return V_13 -> type -> V_31 ;
}
static int F_27 ( struct V_23 * V_13 )
{
struct V_26 * V_7 = & V_13 -> V_7 -> V_7 ;
int V_5 ;
T_1 * V_70 ;
