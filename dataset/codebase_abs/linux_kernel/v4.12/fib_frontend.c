...
struct V_212 * V_213 )
{
struct V_1 * V_1 = F_86 ( V_49 -> V_214 ) ;
struct V_111 V_112 ;
struct V_2 * V_15 ;
int V_168 ;
...
static int F_88 ( struct V_48 * V_49 , struct V_215 * V_216 )
{
struct V_1 * V_1 = F_86 ( V_49 -> V_214 ) ;
...
struct V_23 * V_24 ;
int V_220 = 0 , V_168 ;
if ( F_89 ( V_216 -> V_176 ) >= sizeof( struct V_179 ) &&
( (struct V_179 * ) F_77 ( V_216 -> V_176 ) ) -> V_192 & V_221 )
return V_49 -> V_104 ;
V_217 = V_216 -> args [ 0 ] ;
V_219 = V_216 -> args [ 1 ] ;
F_23 () ;
...
static void F_92 ( int V_109 , int type , T_3 V_70 , int V_225 , struct V_145 * V_146 )
{
...
V_230 = F_94 ( V_51 , V_232 , V_121 ) ;
if ( ! V_230 ) {
F_95 ( L_1 , V_236 ) ;
return;
}
}
F_92 ( V_229 , V_84 , V_33 , 32 , V_230 ) ;
if ( ! ( V_32 -> V_237 & V_238 ) )
return;
if ( V_146 -> V_239 && V_146 -> V_239 != F_96 ( 0xFFFFFFFF ) )
F_92 ( V_229 , V_40 , V_146 -> V_239 , 32 , V_230 ) ;
...
if ( V_146 -> V_240 < 31 ) {
F_92 ( V_229 , V_40 , V_232 , 32 , V_230 ) ;
F_92 ( V_229 , V_40 , V_232 | ~ V_121 ,
32 , V_230 ) ;
}
}
}
void F_97 ( struct V_145 * V_146 , struct V_145 * V_243 )
{
struct V_50 * V_51 = V_146 -> V_226 ;
struct V_31 * V_32 = V_51 -> V_32 ;
struct V_145 * V_244 ;
...
int V_251 = 0 ;
if ( V_146 -> V_234 & V_235 ) {
V_230 = F_94 ( V_51 , V_247 , V_146 -> V_231 ) ;
if ( ! V_230 ) {
if ( ! V_51 -> V_252 )
F_95 ( L_1 , V_236 ) ;
return;
...
F_102 ( V_244 -> V_233 , V_243 ) )
continue;
if ( V_244 -> V_234 & V_235 ) {
if ( V_244 -> V_231 == V_230 -> V_231 &&
F_102 ( V_244 -> V_233 , V_230 ) )
V_245 = V_230 ;
else {
if ( ! V_251 )
continue;
...
V_254:
if ( ! ( V_248 & F_99 ) )
F_92 ( V_253 , V_40 , V_146 -> V_239 , 32 , V_230 ) ;
if ( V_249 && V_146 -> V_240 < 31 ) {
if ( ! ( V_248 & F_101 ) )
F_92 ( V_253 , V_40 , V_246 , 32 , V_230 ) ;
if ( ! ( V_248 & F_100 ) )
F_92 ( V_253 , V_40 , V_247 , 32 , V_230 ) ;
}
if ( ! ( V_248 & F_98 ) ) {
unsigned int V_152 ;
F_92 ( V_253 , V_84 , V_146 -> V_150 , 32 , V_230 ) ;
V_152 = F_30 ( F_36 ( V_32 ) , V_32 ,
V_146 -> V_150 ) ;
if ( V_250 && V_152 != V_84 ) {
if ( F_103 ( V_32 , V_146 -> V_150 ) )
F_15 ( F_36 ( V_32 ) ) ;
}
}
#undef F_98
...
static void F_104 ( struct V_1 * V_1 , struct V_257 * V_258 )
{
struct V_37 V_38 ;
struct V_34 V_35 = {
. V_66 = V_258 -> V_259 ,
...
static void F_107 ( struct V_48 * V_49 )
{
struct V_1 * V_1 ;
struct V_257 * V_258 ;
struct V_175 * V_176 ;
...
V_1 = F_86 ( V_49 -> V_214 ) ;
V_176 = F_108 ( V_49 ) ;
if ( V_49 -> V_104 < F_109 ( sizeof( * V_258 ) ) ||
V_49 -> V_104 < V_176 -> F_89 ||
F_89 ( V_176 ) < sizeof( * V_258 ) )
return;
V_49 = F_110 ( V_49 , V_158 ) ;
if ( ! V_49 )
return;
V_176 = F_108 ( V_49 ) ;
...
F_78 ( V_49 ) . V_194 = 0 ;
F_78 ( V_49 ) . V_267 = 0 ;
F_111 ( V_1 -> V_10 . V_268 , V_49 , V_194 , V_269 ) ;
}
static int T_1 F_112 ( struct V_1 * V_1 )
{
struct V_270 * V_214 ;
struct V_271 V_112 = {
. V_272 = F_107 ,
} ;
V_214 = F_113 ( V_1 , V_273 , & V_112 ) ;
if ( ! V_214 )
return - V_119 ;
...
{
F_115 ( V_1 -> V_10 . V_268 ) ;
V_1 -> V_10 . V_268 = NULL ;
}
static void F_116 ( struct V_31 * V_32 , unsigned long V_274 ,
bool V_275 )
{
if ( F_117 ( V_32 , V_274 , V_275 ) )
F_15 ( F_36 ( V_32 ) ) ;
else
F_18 ( F_36 ( V_32 ) ) ;
F_118 ( V_32 ) ;
}
static int F_119 ( struct V_276 * V_277 , unsigned long V_274 , void * V_278 )
{
...
static int F_122 ( struct V_276 * V_277 , unsigned long V_274 , void * V_278 )
{
struct V_31 * V_32 = F_123 ( V_278 ) ;
struct V_284 * V_285 ;
struct V_50 * V_51 ;
struct V_1 * V_1 = F_36 ( V_32 ) ;
unsigned int V_237 ;
...
case V_292 :
V_285 = V_278 ;
if ( V_285 -> V_293 && F_128 ( V_285 -> V_293 ) )
F_116 ( V_32 , V_282 , true ) ;
break;
}
return V_283 ;
}
static int T_1 F_129 ( struct V_1 * V_1 )
{
int V_168 ;
T_6 V_294 = sizeof( struct V_23 ) * V_22 ;
V_1 -> V_10 . V_295 = 0 ;
V_294 = F_130 ( T_6 , V_294 , V_296 ) ;
...
F_70 () ;
#ifdef F_10
F_132 ( V_1 -> V_10 . V_19 , NULL ) ;
F_132 ( V_1 -> V_10 . V_21 , NULL ) ;
#endif
...
static int T_1 F_135 ( struct V_1 * V_1 )
{
int error ;
#ifdef F_136
V_1 -> V_10 . F_47 = 0 ;
...
static void T_7 F_138 ( struct V_1 * V_1 )
{
F_139 ( V_1 ) ;
F_114 ( V_1 ) ;
F_131 ( V_1 ) ;
...
void T_8 F_140 ( void )
{
F_141 ( V_300 , V_229 , F_87 , NULL , NULL ) ;
F_141 ( V_300 , V_253 , F_85 , NULL , NULL ) ;
F_141 ( V_300 , V_301 , NULL , F_88 , NULL ) ;
F_142 ( & V_302 ) ;
F_143 ( & V_303 ) ;
F_144 ( & V_304 ) ;
F_145 () ;
