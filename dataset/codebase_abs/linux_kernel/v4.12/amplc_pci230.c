...
static unsigned short F_3 ( struct V_3 * V_4 )
{
...
static unsigned short F_5 ( struct V_3 * V_4 ,
unsigned short V_16 )
{
const struct V_5 * V_6 = V_4 -> V_7 ;
struct V_8 * V_9 = V_4 -> V_10 ;
...
unsigned int V_23 )
{
F_12 ( V_4 , ( unsigned char ) ~ 0 , V_23 ) ;
}
static unsigned int F_14 ( T_1 V_29 , unsigned int V_30 ,
unsigned int V_31 )
{
T_1 div ;
unsigned int V_32 ;
...
static unsigned int F_18 ( T_1 V_29 , unsigned int * V_38 ,
unsigned int V_31 )
{
unsigned int V_39 , V_40 ;
for ( V_39 = V_41 ; ; V_39 ++ ) {
V_40 = F_14 ( V_29 , V_42 [ V_39 ] , V_31 ) ;
...
static void F_19 ( unsigned int * V_29 , unsigned int V_31 )
{
unsigned int V_38 ;
unsigned int V_39 ;
V_39 = F_18 ( * V_29 , & V_38 , V_31 ) ;
* V_29 = V_38 * V_42 [ V_39 ] ;
}
...
unsigned int V_39 ;
unsigned int V_38 ;
F_21 ( V_4 -> V_46 , V_44 , V_45 ) ;
V_39 = F_18 ( V_29 , & V_38 , V_31 ) ;
F_22 ( F_1 ( V_44 , V_39 ) , V_4 -> V_47 + V_48 ) ;
if ( V_38 >= 65536 )
V_38 = 0 ;
...
V_63 |= V_81 ;
F_7 ( V_64 , V_9 -> V_12 + V_82 ) ;
F_7 ( V_9 -> V_78 , V_9 -> V_12 + V_83 ) ;
V_9 -> V_63 = V_63 ;
F_7 ( V_63 | V_84 , V_9 -> V_12 + V_56 ) ;
for ( V_59 = 0 ; V_59 < V_53 -> V_59 ; V_59 ++ ) {
F_21 ( V_4 -> V_46 , 2 , V_74 ) ;
F_21 ( V_4 -> V_46 , 2 , V_49 ) ;
...
F_7 ( V_170 , V_9 -> V_12 + V_171 ) ;
V_129 |= V_172 | V_131 |
V_132 |
V_162 | V_173 ;
}
F_7 ( V_129 , V_9 -> V_12 + V_88 ) ;
...
V_9 -> V_129 = F_4 ( V_9 -> V_12 + V_88 ) &
V_130 ;
if ( F_80 ( V_236 , 3 ) >= 32 ) {
unsigned short V_245 = 0 ;
V_9 -> V_75 = F_4 ( V_9 -> V_12 + V_246 ) ;
...
F_7 ( V_245 , V_9 -> V_12 + V_250 ) ;
if ( V_245 & V_249 ) {
F_7 ( V_9 -> V_129 | V_172 |
V_131 ,
V_9 -> V_12 + V_88 ) ;
F_7 ( 0 , V_9 -> V_12 + V_171 ) ;
F_7 ( V_9 -> V_129 , V_9 -> V_12 + V_88 ) ;
}
}
F_22 ( 0 , V_4 -> V_47 + V_128 ) ;
V_9 -> V_78 = 0 ;
V_9 -> V_63 = V_205 | V_77 |
V_80 ;
F_7 ( 1 << 0 , V_9 -> V_12 + V_82 ) ;
F_7 ( V_9 -> V_78 , V_9 -> V_12 + V_83 ) ;
F_7 ( V_9 -> V_63 | V_84 ,
V_9 -> V_12 + V_56 ) ;
if ( V_236 -> V_223 ) {
