...
int F_155 ( struct V_307 * V_308 )
{
if ( F_156 ( & V_308 -> V_309 ) != V_128 )
return - V_20 ;
return 0 ;
}
...
if ( V_312 >= V_97 )
return - V_20 ;
V_68 -> V_98 [ V_312 ] . V_99 . V_44 = V_311 -> V_44 ;
V_68 -> V_98 [ V_312 ] . V_99 . V_45 = V_311 -> V_45 ;
return 0 ;
}
...
struct V_67 * V_68 =
& V_27 -> V_29 [ V_214 ] . V_72 ;
V_68 -> V_103 . V_99 . V_44 = V_311 -> V_44 ;
V_68 -> V_103 . V_99 . V_45 = V_311 -> V_45 ;
return 0 ;
}
...
F_159 ( V_27 , V_214 , V_311 ,
V_318 ) ;
F_165 ( V_27 , V_214 ,
V_68 -> V_103 . V_101 ,
V_318 ) ;
F_163 ( V_27 , V_214 , V_319 ,
V_318 ) ;
...
struct V_67 * V_68 =
& V_27 -> V_29 [ V_214 ] . V_72 ;
V_68 -> V_98 [ V_321 ] . V_99 . V_44 =
V_68 -> V_98 [ V_317 ] . V_99 . V_44 ;
V_68 -> V_98 [ V_321 ] . V_99 . V_45 =
V_68 -> V_98 [ V_317 ] . V_99 . V_45 / 2 ;
V_68 -> V_98 [ V_321 ] . V_100
= V_317 ;
V_68 -> V_98 [ V_317 ] . V_101 =
V_322 ;
V_68 -> V_98 [ V_321 ] . V_101 =
V_323 ;
V_68 -> V_98 [ V_321 ] . V_102 = true ;
return 0 ;
}
void F_169 (
struct V_26 * V_27 ,
...
V_68 -> V_98 [ V_317 ] . V_99 . V_44 =
V_44 ;
V_68 -> V_98 [ V_317 ] . V_99 . V_45 =
V_45 ;
V_68 -> V_98 [ V_317 ] . V_101 =
V_320 ;
V_68 -> V_98 [ V_317 ] . V_102 = true ;
}
void F_170 (
struct V_26 * V_27 ,
enum V_213 V_214 ,
...
{
V_27 -> V_29 [ V_246 ]
. V_38 [ V_153 ] . V_51 . V_44 = V_324 ;
V_27 -> V_29 [ V_246 ]
. V_38 [ V_153 ] . V_51 . V_45 = V_325 ;
}
void F_173 (
struct V_26 * V_27 ,
bool V_326 )
...
if ( V_32 -> V_329 [ V_27 -> V_330 ] . type == V_331 ) {
struct V_67 * V_68 =
& V_27 -> V_29 [ V_246 ] . V_72 ;
V_68 -> V_41 = V_83 ;
V_68 -> V_75 . V_84 . V_41 = V_332 ;
...
F_187 ( ( ( V_338 / 46000 ) - 1280 ) >> 10 , 0xffU ) * 0x01010101U ;
for ( V_11 = 0 ; V_11 < V_132 ; V_11 ++ ) {
V_29 = & V_27 -> V_29 [ V_11 ] ;
...
V_120 . V_121 = V_339 ;
V_29 -> V_72 .
V_120 . V_122 . V_44 = V_340 ;
V_29 -> V_72 .
V_120 . V_122 . V_45 = V_341 ;
}
return 0 ;
}
int F_188 ( struct V_342 * * V_221 ,
unsigned int V_44 , unsigned int V_45 ,
enum V_343 V_101 ,
unsigned int V_48 ,
unsigned int V_344 )
...
int F_190 ( struct V_342 * * V_221 ,
const struct V_345 * V_208 )
{
if ( F_191 ( V_221 , V_208 ) != V_128 )
return - V_294 ;
return 0 ;
}
void F_192 ( struct V_342 * V_221 )
{
F_193 ( V_221 ) ;
}
int F_194 ( struct V_342 * * V_221 ,
const struct V_345 * V_208 ,
const void * V_5 , T_3 V_346 ,
void * V_1 )
{
if ( F_195 ( V_221 , V_208 , V_5 , V_346 , V_1 )
!= V_128 )
return - V_294 ;
return 0 ;
}
int F_196 ( struct V_26 * V_27 ,
const struct V_342 * V_347 )
{
if ( F_197 (
V_27 -> V_29 [ V_246 ] . V_124 ,
V_347 ) != V_128 )
...
while ( ! F_204 ( & V_27 -> V_350 ) ) {
V_229 = F_205 ( V_27 -> V_350 . V_351 ,
struct V_228 , V_278 ) ;
F_136 ( & V_229 -> V_278 ) ;
F_206 ( & V_229 -> V_278 , & V_27 -> V_352 ) ;
}
while ( ! F_204 ( & V_27 -> V_353 ) ) {
V_229 = F_205 ( V_27 -> V_353 . V_351 ,
struct V_228 , V_278 ) ;
F_136 ( & V_229 -> V_278 ) ;
F_206 ( & V_229 -> V_278 , & V_27 -> V_352 ) ;
}
F_9 ( & V_27 -> V_354 , V_349 ) ;
while ( ! F_204 ( & V_27 -> V_355 ) ) {
V_234 = F_205 ( V_27 -> V_355 . V_351 ,
struct V_233 , V_278 ) ;
F_136 ( & V_234 -> V_278 ) ;
F_206 ( & V_234 -> V_278 , & V_27 -> V_356 ) ;
}
V_27 -> V_154 . V_277 = false ;
F_11 ( & V_27 -> V_354 , V_349 ) ;
for ( V_11 = 0 ; V_11 < V_282 ; V_11 ++ ) {
while ( ! F_204 ( & V_27 -> V_357 [ V_11 ] ) ) {
V_254 = F_205 ( V_27 -> V_357 [ V_11 ] . V_351 ,
struct V_223 , V_278 ) ;
F_136 ( & V_254 -> V_278 ) ;
F_206 ( & V_254 -> V_278 , & V_27 -> V_227 [ V_11 ] ) ;
}
while ( ! F_204 ( & V_27 -> V_358 [ V_11 ] ) ) {
V_254 = F_205 ( V_27 -> V_358 [ V_11 ] . V_351 ,
struct V_223 , V_278 ) ;
F_136 ( & V_254 -> V_278 ) ;
F_206 ( & V_254 -> V_278 , & V_27 -> V_227 [ V_11 ] ) ;
}
...
for ( V_11 = 0 ; V_11 < V_71 ; V_11 ++ )
V_27 -> V_29 [ V_246 ]
. V_39 [ V_11 ] . V_66 = ! ! V_366 ;
}
static enum V_367 F_211 (
struct V_26 * V_27 ,
enum V_145 V_30 )
{
struct V_31 * V_32 = V_27 -> V_32 ;
struct V_368 * V_369 = F_212 (
V_32 -> V_329 [ V_27 -> V_330 ] . V_370 ) ;
switch ( V_30 ) {
case V_159 :
if ( V_369 && V_369 -> V_320 ==
V_371 )
return V_372 ;
return V_373 ;
case V_157 :
...
V_29 -> V_38 [ V_30 ] . V_42 [ 0 ] . V_48 = V_377 ;
...
V_29 -> V_125 [ V_30 ] = true ;
if ( V_27 -> V_171 -> V_138 )
V_380 = & V_29 -> V_38 [ V_30 ] .
V_42 [ V_381 ] ;
else
V_380 = & V_29 -> V_38 [ V_30 ] .
V_42 [ V_382 ] ;
V_380 -> V_43 . V_44 = V_44 ;
V_380 -> V_43 . V_45 = V_45 ;
V_380 -> V_101 = V_101 ;
V_380 -> V_48 = V_377 ;
...
struct V_36 * V_39 =
& V_29 -> V_39 [ V_30 ] ;
unsigned int V_383 = 0 , V_384 = 0 ;
#define F_217 ( T_7 , T_8 ) ((b) ? ((a) + (b) - 1) / (b) : 0)
if ( V_44 == 0 && V_45 == 0 )
return;
...
struct V_394 * V_104 =
& V_72 -> V_103 . V_104 ;
const struct V_395 V_396 [] = { { 2 , 1 } , { 3 , 2 } , { 5 , 4 } } ;
const unsigned int V_397 [] = { 2 } ;
unsigned int V_11 ;
if ( V_44 == 0 && V_45 == 0 )
return;
V_38 -> V_41 = F_211 ( V_27 , V_30 ) ;
V_29 -> V_125 [ V_30 ] = true ;
V_390 = V_38 -> V_42 [ 0 ] . V_43 . V_44 ;
V_391 = V_38 -> V_42 [ 0 ] . V_43 . V_45 ;
...
for ( V_11 = 0 ; V_11 < F_219 ( V_396 ) ; V_11 ++ ) {
if ( V_104 -> V_44 >= V_390 *
V_396 [ V_11 ] . V_398 / V_396 [ V_11 ] . V_399 &&
V_104 -> V_45 >= V_391 *
V_396 [ V_11 ] . V_398 / V_396 [ V_11 ] . V_399 ) {
V_50 -> V_44 =
V_104 -> V_44 *
...
if ( V_392 >= V_390 * V_397 [ V_11 ] &&
V_393 >= V_391 * V_397 [ V_11 ] ) {
V_46 -> V_44 = V_392 / V_397 [ V_11 ] ;
V_46 -> V_45 = V_393 / V_397 [ V_11 ] ;
break;
}
}
if ( V_46 -> V_44 == V_390 &&
...
V_39 -> V_62 = false ;
if ( V_27 -> V_154 . V_155 ) {
V_390 = V_38 -> V_42 [ 0 ] . V_43 . V_44 * 110 / 100 ;
V_391 = V_38 -> V_42 [ 0 ] . V_43 . V_45 * 110 / 100 ;
} else {
V_390 = V_38 -> V_42 [ 0 ] . V_43 . V_44 ;
V_391 = V_38 -> V_42 [ 0 ] . V_43 . V_45 ;
}
...
V_50 -> V_44 = V_104 -> V_44 ;
V_50 -> V_45 = V_104 -> V_45 ;
for ( V_11 = 0 ; V_11 < sizeof( V_400 ) / sizeof( struct V_395 ) ;
V_11 ++ ) {
if ( V_104 -> V_44 >= V_390 *
V_400 [ V_11 ] . V_398 / V_400 [ V_11 ] . V_399 &&
V_104 -> V_45 >= V_391 *
V_400 [ V_11 ] . V_398 / V_400 [ V_11 ] . V_399 ) {
V_50 -> V_44 = V_104 -> V_44 *
V_400 [ V_11 ] . V_399 /
...
V_208 -> V_43 . V_44 , V_208 -> V_43 . V_45 , V_286 . V_409 ) ;
return 0 ;
}
V_244:
F_52 ( V_27 , true ) ;
...
case V_413 :
if ( ! F_225 (
V_27 -> V_15 [ V_27 -> V_414 ] . V_15 . V_415 ) )
return V_147 ;
case V_416 :
if ( V_27 -> V_411 )
return V_158 ;
...
{
if ( F_184 ( V_27 ) )
F_222 ( V_27 , V_44 , V_45 , V_377 , V_101 ,
V_158 ) ;
else
F_221 ( V_27 , V_44 , V_45 , V_377 , V_101 ,
V_153 ) ;
return 0 ;
}
int F_236 (
...
int F_249 ( struct V_26 * V_27 , int V_423 )
{
enum V_176 V_8 ;
V_8 = F_250 (
V_27 -> V_29 [ V_246 ] . V_124 ,
...
int F_251 ( struct V_26 * V_27 , int V_423 )
{
enum V_176 V_8 ;
V_8 = F_252 (
V_27 -> V_29 [ V_246 ] . V_124 ,
...
struct V_428 * V_429 )
{
V_27 -> V_154 . V_25 . V_429 = V_429 ;
}
void F_261 ( struct V_26 * V_27 ,
struct V_430 * V_431 )
{
V_27 -> V_154 . V_25 . V_431 = V_431 ;
}
void F_262 ( struct V_26 * V_27 ,
struct V_432 * V_433 )
{
V_27 -> V_154 . V_25 . V_433 = V_433 ;
}
void F_263 ( struct V_26 * V_27 ,
struct V_434 * V_435 )
{
V_27 -> V_154 . V_25 . V_435 = V_435 ;
}
void F_264 ( struct V_26 * V_27 ,
struct V_436 * V_437 )
{
V_27 -> V_154 . V_25 . V_437 = V_437 ;
}
void F_265 ( struct V_26 * V_27 )
{
V_27 -> V_154 . V_25 . V_435 = NULL ;
}
void F_266 ( struct V_26 * V_27 ,
struct V_438 * V_439 )
{
V_27 -> V_154 . V_25 . V_439 = V_439 ;
}
void F_267 ( struct V_26 * V_27 ,
struct V_440 * V_441 )
{
V_27 -> V_154 . V_25 . V_441 = V_441 ;
}
void F_268 ( struct V_26 * V_27 ,
struct V_442 * V_443 )
{
V_27 -> V_154 . V_25 . V_443 = V_443 ;
}
void F_269 ( struct V_26 * V_27 ,
struct V_444 * V_445 )
{
V_27 -> V_154 . V_25 . V_445 = V_445 ;
}
void F_270 ( struct V_26 * V_27 ,
struct V_446 * V_447 )
{
V_27 -> V_154 . V_25 . V_447 = V_447 ;
}
void F_271 ( struct V_26 * V_27 ,
struct V_448 * V_449 )
{
V_27 -> V_154 . V_25 . V_449 = V_449 ;
}
void F_272 ( struct V_26 * V_27 ,
struct V_450 * V_451 )
{
V_27 -> V_154 . V_25 . V_451 = V_451 ;
}
void F_273 ( struct V_26 * V_27 ,
struct V_452 * V_453 )
{
V_27 -> V_154 . V_25 . V_453 = V_453 ;
}
void F_274 ( struct V_26 * V_27 ,
struct V_454 * V_455 )
{
V_27 -> V_154 . V_25 . V_455 = V_455 ;
}
void F_275 ( struct V_26 * V_27 ,
struct V_456 * V_457 )
{
V_27 -> V_154 . V_25 . V_457 = V_457 ;
}
void F_276 ( struct V_26 * V_27 ,
struct V_458 * V_459 )
{
V_27 -> V_154 . V_25 . V_459 = V_459 ;
}
void F_277 ( struct V_26 * V_27 ,
struct V_460 * V_461 )
{
V_27 -> V_154 . V_25 . V_461 = V_461 ;
}
void F_278 ( struct V_26 * V_27 ,
struct V_462 * V_463 )
{
V_27 -> V_154 . V_25 . V_463 = V_463 ;
}
void F_279 ( struct V_26 * V_27 ,
struct V_464 * V_465 )
{
V_27 -> V_154 . V_25 . V_465 = V_465 ;
}
void F_280 ( struct V_26 * V_27 ,
struct V_466 * V_467 )
{
V_27 -> V_154 . V_25 . V_467 = V_467 ;
}
void F_281 ( struct V_26 * V_27 ,
struct V_468 * V_469 )
{
V_27 -> V_154 . V_25 . V_469 = V_469 ;
}
...
struct V_472 * V_473 )
{
V_27 -> V_154 . V_25 . V_473 = V_473 ;
}
void F_285 ( struct V_26 * V_27 ,
struct V_474 * V_475 )
{
V_27 -> V_154 . V_25 . V_475 = V_475 ;
}
...
struct V_478 * V_479 )
{
V_27 -> V_154 . V_25 . V_479 = V_479 ;
}
void F_289 ( struct V_26 * V_27 ,
struct V_480 * V_481 )
{
int V_11 ;
T_3 * V_482 = V_481 -> V_5 . V_483 ;
int V_484 = V_485 ;
bool V_102 = false ;
if ( V_481 -> V_486 == V_487 ) {
V_482 = V_481 -> V_5 . V_488 ;
V_484 = V_489 ;
}
for ( V_11 = 0 ; V_11 < V_484 ; V_11 ++ ) {
if ( * ( V_482 + V_11 ) ) {
V_102 = true ;
break;
}
...
struct V_490 * V_491 )
{
V_27 -> V_154 . V_25 . V_491 = V_491 ;
}
void F_291 ( struct V_26 * V_27 ,
struct V_492 * V_281 )
{
V_27 -> V_154 . V_25 . V_493 = V_281 ;
}
void F_292 ( struct V_26 * V_27 ,
struct V_494 * V_495 )
{
V_27 -> V_154 . V_25 . V_495 = V_495 ;
}
void F_293 ( struct V_26 * V_27 ,
struct V_496 * V_497 )
{
V_27 -> V_154 . V_25 . V_497 = V_497 ;
}
void F_294 ( struct V_26 * V_27 ,
struct V_498 * V_499 )
{
if ( ! V_27 -> V_154 . V_25 . V_500 )
V_27 -> V_154 . V_25 . V_500 = & V_27 -> V_154 . V_270 . V_500 ;
memset ( V_27 -> V_154 . V_25 . V_500 ,
0 , sizeof( struct V_501 ) ) ;
V_27 -> V_154 . V_270 . V_500 . V_502 = V_499 -> V_502 ;
V_27 -> V_154 . V_270 . V_500 . V_503 = V_499 -> V_503 ;
}
...
return memcmp ( V_505 , V_506 , sizeof( * V_506 ) ) ;
}
void F_296 ( struct V_26 * V_27 ,
struct V_507 * V_508 )
{
V_27 -> V_154 . V_25 . V_509 = V_508 ;
}
int F_297 ( struct V_26 * V_27 ,
struct V_510 * V_508 )
{
if ( F_295 ( V_27 , & V_508 -> V_291 ) != 0 )
return - V_426 ;
if ( V_508 -> V_297 . V_298 == NULL ||
V_508 -> V_297 . V_511 == NULL ||
V_508 -> V_297 . V_512 == NULL ||
V_508 -> V_297 . V_513 == NULL ||
V_508 -> V_300 . V_298 == NULL ||
V_508 -> V_300 . V_511 == NULL ||
V_508 -> V_300 . V_512 == NULL ||
V_508 -> V_300 . V_513 == NULL ||
V_27 -> V_154 . V_270 . V_271 -> V_297 . V_298 == NULL ||
V_27 -> V_154 . V_270 . V_271 -> V_297 . V_511 == NULL ||
V_27 -> V_154 . V_270 . V_271 -> V_297 . V_512 == NULL ||
V_27 -> V_154 . V_270 . V_271 -> V_297 . V_513 == NULL ||
V_27 -> V_154 . V_270 . V_271 -> V_300 . V_298 == NULL ||
V_27 -> V_154 . V_270 . V_271 -> V_300 . V_511 == NULL ||
...
V_508 -> V_297 . V_298 , V_27 -> V_154 . V_275 ) )
return - V_514 ;
if ( F_298 ( V_27 -> V_154 . V_270 . V_271 -> V_297 . V_511 ,
V_508 -> V_297 . V_511 , V_27 -> V_154 . V_275 ) )
return - V_514 ;
if ( F_298 ( V_27 -> V_154 . V_270 . V_271 -> V_297 . V_512 ,
V_508 -> V_297 . V_512 , V_27 -> V_154 . V_275 ) )
return - V_514 ;
if ( F_298 ( V_27 -> V_154 . V_270 . V_271 -> V_297 . V_513 ,
V_508 -> V_297 . V_513 , V_27 -> V_154 . V_275 ) )
return - V_514 ;
if ( F_298 ( V_27 -> V_154 . V_270 . V_271 -> V_300 . V_298 ,
V_508 -> V_300 . V_298 , V_27 -> V_154 . V_276 ) )
return - V_514 ;
if ( F_298 ( V_27 -> V_154 . V_270 . V_271 -> V_300 . V_511 ,
V_508 -> V_300 . V_511 , V_27 -> V_154 . V_276 ) )
return - V_514 ;
if ( F_298 ( V_27 -> V_154 . V_270 . V_271 -> V_300 . V_512 ,
V_508 -> V_300 . V_512 , V_27 -> V_154 . V_276 ) )
return - V_514 ;
if ( F_298 ( V_27 -> V_154 . V_270 . V_271 -> V_300 . V_513 ,
V_508 -> V_300 . V_513 , V_27 -> V_154 . V_276 ) )
return - V_514 ;
V_27 -> V_154 . V_270 . V_515 . V_509 =
(struct V_516 * )
...
{
struct V_31 * V_32 = V_27 -> V_32 ;
if ( V_517 == V_27 -> V_154 . V_270 . V_437 . V_518 &&
V_517 == V_27 -> V_154 . V_270 . V_437 . V_519 ) {
F_35 ( V_32 -> V_40 , L_133 ) ;
return;
}
memset ( & V_27 -> V_154 . V_270 . V_437 , 0 ,
sizeof( struct V_520 ) ) ;
V_27 -> V_154 . V_270 . V_437 . V_518 = V_517 ;
V_27 -> V_154 . V_270 . V_437 . V_519 = V_517 ;
V_27 -> V_154 . V_270 . V_515 . V_437 =
(struct V_521 * ) & V_27 -> V_154 . V_270 . V_437 ;
V_27 -> V_154 . V_203 = true ;
}
void F_300 ( struct V_26 * V_27 ,
struct V_522 * V_523 )
{
V_27 -> V_154 . V_25 . V_523 = V_523 ;
}
...
memset ( & V_526 , 0 , sizeof( struct V_525 ) ) ;
V_526 . V_429 = & V_429 ;
F_302 (
V_27 -> V_29 [ V_246 ] . V_124 ,
& V_526 ) ;
memcpy ( V_25 , & V_429 , sizeof( * V_25 ) ) ;
return 0 ;
}
...
memset ( & V_435 , 0 , sizeof( struct V_434 ) ) ;
memset ( & V_526 , 0 , sizeof( struct V_525 ) ) ;
V_526 . V_435 = & V_435 ;
F_302 (
V_27 -> V_29 [ V_246 ] . V_124 ,
& V_526 ) ;
memcpy ( V_25 , & V_435 , sizeof( * V_25 ) ) ;
return 0 ;
}
...
V_534 = F_310 ( sizeof( struct V_480 ) ) ;
if ( ! V_534 )
return - V_294 ;
memset ( & V_526 , 0 , sizeof( struct V_525 ) ) ;
V_526 . V_481 = V_534 ;
...
V_27 -> V_29 [ V_246 ] . V_124 ,
& V_526 ) ;
memcpy ( V_25 , V_534 , sizeof( * V_534 ) ) ;
F_311 ( V_534 ) ;
return 0 ;
}
...
V_534 = F_310 ( sizeof( struct V_478 ) ) ;
if ( ! V_534 )
return - V_294 ;
memset ( & V_526 , 0 , sizeof( struct V_525 ) ) ;
V_526 . V_479 = V_534 ;
...
memset ( & V_437 , 0 , sizeof( struct V_520 ) ) ;
memset ( & V_526 , 0 , sizeof( struct V_525 ) ) ;
V_526 . V_437 = & V_437 ;
F_302 (
V_27 -> V_29 [ V_246 ] . V_124 ,
...
F_11 ( & V_32 -> V_541 , V_6 ) ;
if ( F_295 ( V_27 , & V_540 -> V_542 . V_291 ) != 0 )
return - V_426 ;
F_9 ( & V_27 -> V_354 , V_6 ) ;
if ( ! V_27 -> V_154 . V_277 || F_204 ( & V_27 -> V_356 ) ) {
F_11 ( & V_27 -> V_354 , V_6 ) ;
F_32 ( V_32 -> V_40 , L_135 ) ;
return - V_426 ;
}
V_234 = F_205 ( V_27 -> V_356 . V_351 ,
struct V_233 , V_278 ) ;
F_318 ( & V_234 -> V_278 ) ;
F_11 ( & V_27 -> V_354 , V_6 ) ;
if ( V_234 -> V_263 )
...
F_154 ( V_27 -> V_154 . V_272 ,
V_234 -> V_237 ) ;
V_540 -> V_423 = V_234 -> V_237 -> V_423 ;
F_9 ( & V_27 -> V_354 , V_6 ) ;
F_206 ( & V_234 -> V_278 , & V_27 -> V_356 ) ;
F_11 ( & V_27 -> V_354 , V_6 ) ;
if ( F_319 ( V_540 -> V_542 . V_304 . V_298 ,
V_27 -> V_154 . V_272 -> V_304 . V_298 ,
V_27 -> V_154 . V_274 ) )
return - V_514 ;
if ( F_319 ( V_540 -> V_542 . V_304 . V_511 ,
V_27 -> V_154 . V_272 -> V_304 . V_511 ,
V_27 -> V_154 . V_274 ) )
return - V_514 ;
if ( F_319 ( V_540 -> V_542 . V_304 . V_512 ,
V_27 -> V_154 . V_272 -> V_304 . V_512 ,
V_27 -> V_154 . V_274 ) )
return - V_514 ;
if ( F_319 ( V_540 -> V_542 . V_304 . V_513 ,
V_27 -> V_154 . V_272 -> V_304 . V_513 ,
V_27 -> V_154 . V_274 ) )
return - V_514 ;
if ( F_319 ( V_540 -> V_542 . V_303 . V_298 ,
V_27 -> V_154 . V_272 -> V_303 . V_298 ,
V_27 -> V_154 . V_273 ) )
return - V_514 ;
if ( F_319 ( V_540 -> V_542 . V_303 . V_511 ,
V_27 -> V_154 . V_272 -> V_303 . V_511 ,
V_27 -> V_154 . V_273 ) )
return - V_514 ;
if ( F_319 ( V_540 -> V_542 . V_303 . V_512 ,
V_27 -> V_154 . V_272 -> V_303 . V_512 ,
V_27 -> V_154 . V_273 ) )
return - V_514 ;
if ( F_319 ( V_540 -> V_542 . V_303 . V_513 ,
...
struct V_543 * V_544 )
{
V_27 -> V_154 . V_25 . V_545 = V_544 ;
}
void F_323 ( struct V_543 * V_544 )
{
F_324 ( V_544 ) ;
}
struct V_546 * F_325 (
...
memset ( V_544 , 0 , sizeof( struct V_546 ) ) ;
memset ( & V_526 , 0 , sizeof( struct V_525 ) ) ;
V_526 . V_547 = V_544 ;
F_302 (
V_27 -> V_29 [ V_246 ] . V_124 ,
...
int F_338 ( struct V_553 * V_554 )
{
unsigned int V_555 ;
for ( V_555 = 0 ; V_555 < V_556 ; V_555 ++ ) {
if ( V_554 -> args [ V_555 ] . V_557 == 0 )
continue;
F_339 ( & V_554 -> V_558 -> V_559 ,
V_560 , V_555 ,
V_554 -> args [ V_555 ] . V_561 ,
V_554 -> args [ V_555 ] . V_557 ) ;
}
return 0 ;
}
...
V_564 = & V_29 -> V_38 [ V_162 ] ;
F_89 ( V_564 ) ;
V_27 -> V_549 . V_55 = F_343 ( V_567 *
sizeof( void * ) , V_568 ) ;
if ( ! V_27 -> V_549 . V_55 )
return - V_294 ;
V_564 -> V_55 = V_27 -> V_549 . V_55 ;
V_564 -> V_41 = V_161 ;
V_564 -> V_56 = 0 ;
return 0 ;
}
...
V_29 -> V_566 = V_143 ;
F_345 ( & V_27 -> V_549 . V_550 ) ;
V_27 -> V_549 . V_571 = V_29 -> V_33 [ V_160 ] ;
...
V_27 -> V_549 . V_571 = NULL ;
F_107 () ;
F_137 ( V_27 -> V_549 . V_55 ) ;
V_27 -> V_549 . V_55 = NULL ;
...
#endif
return - V_20 ;
} else if ( V_308 . V_309 . type == V_587 ) {
F_42 ( V_32 -> V_40 , L_147 ,
V_205 , V_308 . V_309 . V_588 ,
V_308 . V_309 . V_423 ) ;
continue;
}
V_27 = F_350 ( V_308 . V_309 . V_247 ,
V_32 , & V_214 ) ;
if ( ! V_27 ) {
if ( V_308 . V_309 . type == V_589 )
F_35 ( V_32 -> V_40 ,
L_148 ) ;
else
...
F_157 ( V_27 , & V_308 ) ;
switch ( V_308 . V_309 . type ) {
case V_590 :
V_578 [ V_27 -> V_574 ] = true ;
F_355 ( V_27 , 0 , V_591 ,
V_308 . V_247 , true , V_214 ) ;
#ifndef F_55
