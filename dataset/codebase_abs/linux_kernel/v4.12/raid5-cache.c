...
F_44 ( V_23 ) ;
F_45 ( V_18 -> V_80 , log -> V_81 ) ;
F_46 ( & log -> V_72 , V_37 ) ;
F_7 ( V_18 , V_73 ) ;
if ( log -> V_82 && ! F_47 ( & V_18 -> V_83 ) )
F_41 ( log ) ;
else
F_38 ( log ) ;
if ( ! F_47 ( & log -> V_84 ) ) {
...
F_50 ( & log -> V_72 , V_37 ) ;
if ( log -> V_82 )
F_51 ( log -> V_51 -> V_31 -> V_86 ) ;
if ( V_18 -> V_87 ) {
struct V_23 * V_88 ;
F_8 ( F_52 ( & V_18 -> V_89 ) ) ;
while ( ( V_88 = F_53 ( & V_18 -> V_89 ) ) != NULL ) {
F_12 ( V_88 ) ;
F_54 ( & V_18 -> V_90 ) ;
}
}
...
{
struct V_6 * log = F_59 ( V_100 , struct V_6 ,
V_85 ) ;
struct V_17 * V_18 = NULL ;
unsigned long V_37 ;
F_46 ( & log -> V_72 , V_37 ) ;
if ( ! F_47 ( & log -> V_84 ) ) {
V_18 = F_48 ( & log -> V_84 , struct V_17 ,
V_74 ) ;
if ( ! V_18 -> V_78 )
V_18 = NULL ;
else
...
if ( ! V_18 )
return;
V_107 = F_67 ( V_18 -> V_80 ) ;
V_107 -> V_110 = F_68 ( V_18 -> V_111 ) ;
V_108 = F_69 ( log -> V_112 , V_107 , V_113 ) ;
V_107 -> V_114 = F_68 ( V_108 ) ;
V_23 = V_18 -> V_98 ;
log -> V_105 = NULL ;
F_46 ( & log -> V_72 , V_37 ) ;
if ( V_18 -> V_93 || V_18 -> V_96 ) {
if ( V_18 != F_48 ( & log -> V_84 ,
struct V_17 , V_74 ) ) {
V_18 -> V_78 = 1 ;
V_109 = false ;
}
...
{
struct V_23 * V_23 = F_71 ( V_115 , V_116 , log -> V_117 ) ;
F_72 ( V_23 , V_118 , 0 ) ;
V_23 -> V_119 = log -> V_51 -> V_120 ;
...
F_77 ( & V_18 -> V_89 ) ;
V_18 -> V_20 = V_126 ;
V_18 -> V_80 = F_75 ( log -> V_81 , V_115 ) ;
V_107 = F_67 ( V_18 -> V_80 ) ;
F_78 ( V_107 ) ;
V_107 -> V_127 = F_68 ( V_128 ) ;
V_107 -> V_129 = V_130 ;
V_107 -> V_131 = F_79 ( log -> V_131 ) ;
V_107 -> V_132 = F_79 ( log -> V_16 ) ;
V_18 -> V_16 = log -> V_16 ;
V_18 -> V_111 = sizeof( struct V_106 ) ;
V_18 -> V_131 = log -> V_131 ++ ;
V_18 -> V_98 = F_70 ( log ) ;
V_18 -> V_98 -> V_133 = F_42 ;
V_18 -> V_98 -> V_77 = V_18 ;
F_80 ( V_18 -> V_98 , V_18 -> V_80 , V_113 , 0 ) ;
F_73 ( log , V_18 ) ;
F_81 ( & log -> V_72 ) ;
F_82 ( & V_18 -> V_74 , & log -> V_84 ) ;
F_83 ( & log -> V_72 ) ;
return V_18 ;
}
...
struct V_17 * V_18 = log -> V_105 ;
struct V_140 * V_141 ;
V_141 = F_67 ( V_18 -> V_80 ) + V_18 -> V_111 ;
V_141 -> V_142 . type = F_86 ( type ) ;
V_141 -> V_142 . V_37 = F_86 ( 0 ) ;
V_141 -> V_13 = F_68 ( ( 1 + ! ! V_139 ) <<
( V_143 - 9 ) ) ;
V_141 -> V_136 = F_79 ( V_136 ) ;
V_141 -> V_114 [ 0 ] = F_68 ( V_137 ) ;
if ( V_139 )
V_141 -> V_114 [ 1 ] = F_68 ( V_138 ) ;
V_18 -> V_111 += sizeof( struct V_140 ) +
...
V_18 -> V_92 = V_18 -> V_98 ;
V_18 -> V_98 = F_70 ( log ) ;
F_88 ( V_18 -> V_98 , V_18 -> V_92 ) ;
V_18 -> V_122 = false ;
}
if ( ! F_80 ( V_18 -> V_98 , V_145 , V_113 , 0 ) )
F_89 () ;
F_73 ( log , V_18 ) ;
}
...
return;
F_91 ( & log -> V_148 ) ;
V_110 = sizeof( struct V_146 ) + sizeof( V_149 ) ;
if ( F_84 ( log , V_110 ) ) {
F_92 ( & log -> V_148 ) ;
return;
}
V_18 = log -> V_105 ;
V_141 = F_67 ( V_18 -> V_80 ) + V_18 -> V_111 ;
V_141 -> V_142 . type = F_86 ( V_150 ) ;
V_141 -> V_142 . V_37 = F_86 ( 0 ) ;
V_141 -> V_13 = F_68 ( sizeof( V_149 ) ) ;
V_141 -> V_151 [ 0 ] = F_79 ( V_3 ) ;
V_18 -> V_111 += V_110 ;
F_92 ( & log -> V_148 ) ;
}
...
F_87 ( log , V_33 -> V_22 [ V_35 ] . V_145 ) ;
}
if ( V_153 == 2 ) {
F_85 ( log , V_160 ,
V_33 -> V_29 , V_33 -> V_22 [ V_33 -> V_68 ] . V_159 ,
V_33 -> V_22 [ V_33 -> V_156 ] . V_159 , true ) ;
F_87 ( log , V_33 -> V_22 [ V_33 -> V_68 ] . V_145 ) ;
F_87 ( log , V_33 -> V_22 [ V_33 -> V_156 ] . V_145 ) ;
} else if ( V_153 == 1 ) {
F_85 ( log , V_160 ,
V_33 -> V_29 , V_33 -> V_22 [ V_33 -> V_68 ] . V_159 ,
0 , false ) ;
...
continue;
V_172 = F_99 ( V_33 -> V_22 [ V_35 ] . V_145 ) ;
V_33 -> V_22 [ V_35 ] . V_159 = F_69 ( log -> V_112 ,
V_172 , V_113 ) ;
F_100 ( V_172 ) ;
}
...
V_154 = F_93 ( log , V_33 , V_152 , V_153 ) ;
if ( V_154 ) {
F_81 ( & log -> V_72 ) ;
F_82 ( & V_33 -> V_70 ,
& log -> V_175 ) ;
...
return;
F_117 ( & log -> V_184 ) ;
log -> V_184 . V_119 = log -> V_51 -> V_120 ;
log -> V_184 . V_133 = F_113 ;
log -> V_184 . V_94 = V_118 | V_95 ;
F_57 ( & log -> V_184 ) ;
}
...
static void F_134 ( struct V_204 * V_86 )
{
struct V_31 * V_31 = V_86 -> V_31 ;
struct V_1 * V_2 = V_31 -> V_52 ;
struct V_6 * log = V_2 -> log ;
if ( ! log )
return;
...
{
struct V_145 * V_145 ;
V_213 -> V_214 = F_71 ( V_215 , V_116 , log -> V_117 ) ;
if ( ! V_213 -> V_214 )
return - V_135 ;
V_213 -> V_216 = 0 ;
V_213 -> V_217 = 0 ;
...
{
F_117 ( V_213 -> V_214 ) ;
V_213 -> V_214 -> V_119 = log -> V_51 -> V_120 ;
...
F_80 ( V_213 -> V_214 ,
V_213 -> V_219 [ V_213 -> V_216 ] , V_113 , 0 ) ;
V_213 -> V_216 += 1 ;
...
return - V_226 ;
V_108 = F_69 ( log -> V_112 , V_223 , V_113 ) ;
if ( V_224 != V_108 )
return - V_226 ;
if ( F_151 ( V_223 -> V_110 ) > V_113 )
return - V_226 ;
V_213 -> V_227 = V_46 ;
return 0 ;
}
...
V_223 -> V_129 = V_130 ;
V_223 -> V_110 = F_68 ( sizeof( struct V_106 ) ) ;
V_223 -> V_131 = F_79 ( V_131 ) ;
V_223 -> V_132 = F_79 ( V_225 ) ;
}
...
V_223 = F_67 ( V_145 ) ;
V_223 -> V_114 = F_68 ( F_69 ( log -> V_112 ,
V_223 , V_113 ) ) ;
if ( ! F_155 ( log -> V_51 , V_225 , V_113 , V_145 , V_118 ,
V_228 | V_97 , false ) ) {
F_156 ( V_145 ) ;
return - V_229 ;
}
...
F_29 ( & V_51 -> V_237 ) ;
F_142 () ;
F_155 ( V_51 , V_33 -> V_29 , V_113 ,
V_33 -> V_22 [ V_234 ] . V_145 , V_118 , 0 ,
false ) ;
...
V_172 = F_99 ( V_145 ) ;
V_114 = F_69 ( log -> V_112 , V_172 , V_113 ) ;
F_100 ( V_172 ) ;
return ( F_151 ( V_159 ) == V_114 ) ? 0 : - V_226 ;
}
static int
...
struct V_31 * V_31 = log -> V_51 -> V_31 ;
struct V_1 * V_2 = V_31 -> V_52 ;
struct V_106 * V_223 = F_67 ( V_213 -> V_80 ) ;
T_1 V_244 = sizeof( struct V_106 ) ;
...
V_141 -> V_136 = F_79 (
F_94 ( V_33 , V_35 , 0 ) ) ;
V_172 = F_99 ( V_22 -> V_145 ) ;
V_141 -> V_114 [ 0 ] = F_68 (
F_69 ( log -> V_112 , V_172 ,
V_113 ) ) ;
F_100 ( V_172 ) ;
F_155 ( log -> V_51 , V_250 , V_113 ,
V_22 -> V_145 , V_118 , 0 , false ) ;
V_250 = F_4 ( log , V_250 ,
V_46 ) ;
V_4 += sizeof( V_144 ) +
sizeof( struct V_140 ) ;
...
V_223 -> V_110 = F_68 ( V_4 ) ;
V_223 -> V_114 = F_68 ( F_69 ( log -> V_112 ,
V_223 , V_113 ) ) ;
F_155 ( log -> V_51 , V_213 -> V_225 , V_113 , V_145 ,
V_118 , V_228 | V_97 , false ) ;
V_33 -> V_16 = V_213 -> V_225 ;
F_82 ( & V_33 -> V_163 , & log -> V_165 ) ;
F_29 ( & log -> V_48 ) ;
V_213 -> V_225 = V_250 ;
V_213 -> V_131 += 1 ;
V_179 = V_33 -> V_16 ;
...
int F_183 ( struct V_31 * V_31 , int V_256 )
{
struct V_1 * V_2 = V_31 -> V_52 ;
struct V_6 * log = V_2 -> log ;
if ( ! log )
...
const char * V_145 , T_6 V_257 )
{
int V_256 = F_186 ( V_255 ) ;
T_6 V_258 = V_257 ;
if ( V_258 < 2 )
return - V_226 ;
if ( V_145 [ V_258 - 1 ] == '\n' )
V_258 -- ;
while ( V_256 -- )
if ( strlen ( V_255 [ V_256 ] ) == V_258 &&
! strncmp ( V_145 , V_255 [ V_256 ] , V_258 ) )
break;
return F_183 ( V_31 , V_256 ) ? : V_257 ;
}
...
F_27 ( ! F_3 ( log ) ) ;
if ( ! F_16 ( V_60 , & V_33 -> V_20 ) ) {
if ( V_260 -> V_265 > 0 || V_260 -> V_26 > 0 )
return - V_170 ;
F_14 ( V_60 , & V_33 -> V_20 ) ;
}
if ( V_260 -> V_266 || F_16 ( V_171 , & V_33 -> V_20 ) ) {
F_26 ( V_33 ) ;
return - V_170 ;
}
for ( V_35 = V_34 ; V_35 -- ; ) {
V_22 = & V_33 -> V_22 [ V_35 ] ;
if ( V_22 -> V_267 && ! F_16 ( V_268 , & V_22 -> V_37 ) &&
! F_16 ( V_64 , & V_22 -> V_37 ) ) {
F_26 ( V_33 ) ;
return - V_170 ;
}
...
if ( ! F_16 ( V_193 , & V_33 -> V_20 ) &&
! F_16 ( V_269 , & V_33 -> V_20 ) ) {
V_263 = F_1 ( V_2 , V_33 -> V_29 ) ;
F_96 ( & log -> V_270 ) ;
V_262 = F_188 ( & log -> V_271 ,
V_263 ) ;
if ( V_262 ) {
V_264 = ( T_7 ) F_189 (
V_262 , & log -> V_270 ) >>
...
if ( V_22 -> V_267 ) {
F_14 ( V_63 , & V_22 -> V_37 ) ;
F_14 ( V_273 , & V_22 -> V_37 ) ;
F_14 ( V_65 , & V_22 -> V_37 ) ;
V_261 ++ ;
}
}
if ( V_261 ) {
F_14 ( V_274 , & V_260 -> V_275 ) ;
F_14 ( V_66 , & V_33 -> V_20 ) ;
}
return 0 ;
}
...
bool V_276 ;
V_276 =
V_33 -> V_22 [ 0 ] . V_277 == V_2 -> V_34 [ 0 ] . V_278 ;
for ( V_35 = V_33 -> V_34 ; V_35 -- ; )
if ( V_33 -> V_22 [ V_35 ] . V_145 != V_33 -> V_22 [ V_35 ] . V_277 ) {
struct V_145 * V_279 = V_33 -> V_22 [ V_35 ] . V_277 ;
V_33 -> V_22 [ V_35 ] . V_277 = V_33 -> V_22 [ V_35 ] . V_145 ;
F_25 ( V_280 , & V_33 -> V_22 [ V_35 ] . V_37 ) ;
if ( ! V_276 )
F_146 ( V_279 ) ;
}
if ( V_276 ) {
...
for ( V_35 = V_33 -> V_34 ; V_35 -- ; ) {
V_22 = & V_33 -> V_22 [ V_35 ] ;
if ( V_22 -> V_277 != V_22 -> V_145 )
F_146 ( V_22 -> V_277 ) ;
V_22 -> V_277 = V_2 -> V_34 [ V_35 ] . V_278 ;
}
}
...
if ( F_31 ( V_283 , & V_33 -> V_22 [ V_35 ] . V_37 ) )
V_282 = 1 ;
}
V_260 -> V_265 = 0 ;
if ( F_31 ( V_284 , & V_33 -> V_20 ) )
if ( F_112 ( & V_2 -> V_285 ) )
F_51 ( V_2 -> V_31 -> V_86 ) ;
if ( V_282 )
F_110 ( & V_2 -> V_286 ) ;
...
if ( F_31 ( V_269 , & V_33 -> V_20 ) ) {
F_27 ( F_18 ( & V_2 -> V_42 ) == 0 ) ;
F_54 ( & V_2 -> V_195 ) ;
F_54 ( & V_2 -> V_42 ) ;
}
F_90 ( log , V_33 -> V_29 ) ;
if ( F_16 ( V_287 , & V_33 -> V_20 ) )
F_14 ( V_71 , & V_33 -> V_20 ) ;
}
int F_196 ( struct V_6 * log , struct V_32 * V_33 )
{
struct V_1 * V_2 = V_33 -> V_59 ;
int V_288 = 0 ;
int V_169 ;
...
V_154 = F_93 ( log , V_33 , V_288 , 0 ) ;
if ( V_154 ) {
F_81 ( & log -> V_72 ) ;
F_82 ( & V_33 -> V_70 , & log -> V_175 ) ;
F_83 ( & log -> V_72 ) ;
}
}
F_92 ( & log -> V_148 ) ;
...
bool F_197 ( struct V_1 * V_2 , T_1 V_3 )
{
struct V_6 * log = V_2 -> log ;
T_1 V_263 ;
void * V_289 ;
...
F_198 ( ! F_199 () ) ;
V_263 = F_1 ( V_2 , V_3 ) ;
V_289 = F_200 ( & log -> V_271 , V_263 ) ;
return V_289 != NULL ;
}
static int F_201 ( struct V_6 * log )
{
...
bool V_291 = false ;
int V_154 = 0 ;
if ( V_253 >= V_51 -> V_292 || F_202 ( V_253 , V_46 ) != V_253 )
V_253 = 0 ;
V_145 = F_144 ( V_215 ) ;
if ( ! V_145 )
return - V_135 ;
if ( ! F_155 ( V_51 , V_253 , V_113 , V_145 , V_221 , 0 , false ) ) {
V_154 = - V_229 ;
goto V_293;
}
V_223 = F_67 ( V_145 ) ;
...
V_224 = F_151 ( V_223 -> V_114 ) ;
V_223 -> V_114 = 0 ;
V_290 = F_69 ( log -> V_112 , V_223 , V_113 ) ;
if ( V_224 != V_290 ) {
V_291 = true ;
goto V_294;
}
...
log -> V_11 = F_202 ( V_51 -> V_292 , V_46 ) ;
log -> V_182 = log -> V_11 >> V_295 ;
if ( log -> V_182 > V_296 )
log -> V_182 = V_296 ;
log -> V_15 = V_253 ;
F_156 ( V_145 ) ;
...
void F_204 ( struct V_31 * V_31 , struct V_232 * V_51 )
{
struct V_1 * V_2 = V_31 -> V_52 ;
struct V_6 * log = V_2 -> log ;
if ( ! log )
return;
if ( ( F_184 ( V_2 ) > 0 ||
F_16 ( V_297 , & V_51 -> V_37 ) ) &&
V_2 -> log -> V_7 == V_8 )
F_49 ( & log -> V_101 ) ;
}
int F_205 ( struct V_1 * V_2 , struct V_232 * V_51 )
{
struct V_298 * V_299 = F_121 ( V_51 -> V_120 ) ;
struct V_6 * log ;
char V_300 [ V_301 ] ;
F_172 ( L_11 ,
F_62 ( V_2 -> V_31 ) , F_206 ( V_51 -> V_120 , V_300 ) ) ;
if ( V_113 != 4096 )
return - V_226 ;
if ( sizeof( struct V_106 ) +
( ( sizeof( struct V_140 ) + sizeof( V_144 ) ) *
V_2 -> V_49 ) > V_113 ) {
F_174 ( L_12 ,
...
return - V_135 ;
log -> V_51 = V_51 ;
log -> V_82 = F_16 ( V_302 , & V_299 -> V_303 ) != 0 ;
log -> V_112 = F_69 ( ~ 0 , V_51 -> V_31 -> V_304 ,
sizeof( V_51 -> V_31 -> V_304 ) ) ;
F_207 ( & log -> V_148 ) ;
F_208 ( & log -> V_72 ) ;
F_76 ( & log -> V_84 ) ;
F_76 ( & log -> V_76 ) ;
F_76 ( & log -> V_185 ) ;
F_76 ( & log -> V_75 ) ;
F_209 ( & log -> V_184 , NULL , 0 ) ;
log -> V_305 = F_210 ( V_17 , 0 ) ;
if ( ! log -> V_305 )
goto V_305;
log -> V_124 = F_211 ( V_306 , log -> V_305 ) ;
if ( ! log -> V_124 )
goto V_124;
log -> V_117 = F_212 ( V_306 , 0 ) ;
if ( ! log -> V_117 )
goto V_307;
log -> V_81 = F_213 ( V_306 , 0 ) ;
if ( ! log -> V_81 )
goto V_308;
F_208 ( & log -> V_270 ) ;
F_214 ( & log -> V_271 , V_309 | V_310 ) ;
log -> V_208 = F_215 ( F_134 ,
log -> V_51 -> V_31 , L_13 ) ;
if ( ! log -> V_208 )
goto V_208;
log -> V_208 -> V_311 = V_312 ;
F_216 ( & log -> V_183 ) ;
F_76 ( & log -> V_175 ) ;
F_76 ( & log -> V_167 ) ;
F_208 ( & log -> V_166 ) ;
F_217 ( & log -> V_85 , F_58 ) ;
F_217 ( & log -> V_101 , F_60 ) ;
log -> V_7 = V_67 ;
F_76 ( & log -> V_165 ) ;
F_208 ( & log -> V_164 ) ;
F_218 ( & log -> V_48 , 0 ) ;
