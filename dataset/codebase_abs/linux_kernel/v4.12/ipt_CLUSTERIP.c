...
char V_101 [ F_72 ] ;
int V_102 , V_103 ;
for ( V_103 = 0 , V_102 = 0 ; V_103 < F_72 - 3 && V_102 < V_28 ; V_102 ++ ) {
V_101 [ V_103 ++ ] = F_73 ( V_100 -> V_104 [ V_102 ] ) ;
V_101 [ V_103 ++ ] = F_74 ( V_100 -> V_104 [ V_102 ] ) ;
V_101 [ V_103 ++ ] = ':' ;
}
V_101 [ -- V_103 ] = '\0' ;
F_60 ( L_15 ,
...
{
struct V_110 * V_111 = F_76 ( V_41 ) ;
struct V_99 * V_100 ;
struct V_1 * V_2 ;
struct V_7 * V_7 = V_109 -> V_7 ;
if ( V_111 -> V_112 != F_77 ( V_113 ) ||
V_111 -> V_114 != F_77 ( V_115 ) ||
V_111 -> V_116 != 4 || V_111 -> V_117 != V_28 )
return V_118 ;
if ( V_111 -> V_119 != F_77 ( V_120 ) &&
V_111 -> V_119 != F_77 ( V_121 ) )
return V_118 ;
V_100 = ( void * ) ( V_111 + 1 ) ;
...
static void * F_78 ( struct V_124 * V_125 , T_5 * V_126 )
{
...
if ( * V_126 >= V_128 )
return NULL ;
V_130 = F_80 ( sizeof( struct V_129 ) , V_131 ) ;
if ( ! V_130 )
return F_32 ( - V_27 ) ;
V_130 -> V_126 = * V_126 ;
V_130 -> V_128 = V_128 ;
V_130 -> V_132 = F_81 ( V_23 ) ;
V_130 -> V_133 = V_23 ;
F_82 ( V_130 -> V_132 - 1 , & V_130 -> V_133 ) ;
return V_130 ;
}
static void * F_83 ( struct V_124 * V_125 , void * V_134 , T_5 * V_126 )
{
...
V_130 -> V_132 = F_81 ( V_130 -> V_133 ) ;
F_82 ( V_130 -> V_132 - 1 , & V_130 -> V_133 ) ;
return V_130 ;
}
static void F_84 ( struct V_124 * V_125 , void * V_134 )
{
if ( ! F_65 ( V_134 ) )
F_4 ( V_134 ) ;
}
static int F_85 ( struct V_124 * V_125 , void * V_134 )
{
struct V_129 * V_130 = V_134 ;
if ( V_130 -> V_126 != 0 )
F_86 ( V_125 , ',' ) ;
F_87 ( V_125 , L_19 , V_130 -> V_132 ) ;
...
{
int V_84 = F_89 ( V_136 , & V_137 ) ;
if ( ! V_84 ) {
struct V_124 * V_138 = V_136 -> V_139 ;
struct V_1 * V_2 = F_90 ( V_135 ) ;
V_138 -> V_127 = V_2 ;
F_1 ( V_2 ) ;
}
return V_84 ;
}
static int F_91 ( struct V_135 * V_135 , struct V_136 * V_136 )
{
struct V_1 * V_2 = F_90 ( V_135 ) ;
int V_84 ;
V_84 = F_92 ( V_135 , V_136 ) ;
if ( ! V_84 )
F_6 ( V_2 ) ;
return V_84 ;
}
static T_6 F_93 ( struct V_136 * V_136 , const char T_7 * V_140 ,
T_8 V_141 , T_5 * V_142 )
{
struct V_1 * V_2 = F_90 ( F_94 ( V_136 ) ) ;
#define F_95 10
char V_34 [ F_95 + 1 ] ;
unsigned long V_39 ;
int V_143 ;
if ( V_141 > F_95 )
return - V_144 ;
if ( F_96 ( V_34 , V_140 , V_141 ) )
return - V_145 ;
V_34 [ V_141 ] = 0 ;
if ( * V_34 == '+' ) {
V_143 = F_97 ( V_34 + 1 , 10 , & V_39 ) ;
if ( V_143 )
return V_143 ;
if ( F_38 ( V_2 , V_39 ) )
return - V_27 ;
...
F_100 ( & V_10 -> V_13 ) ;
#ifdef F_19
V_10 -> V_37 = F_101 ( L_20 , V_7 -> V_146 ) ;
if ( ! V_10 -> V_37 ) {
F_62 ( L_21 ) ;
return - V_27 ;
}
