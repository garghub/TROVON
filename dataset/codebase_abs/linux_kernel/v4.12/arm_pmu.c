...
static int F_65 ( struct V_5 * V_7 , int V_73 )
{
struct V_33 T_6 * V_34 = V_7 -> V_34 ;
return F_47 ( V_34 -> V_57 , V_73 ) ;
}
static int F_66 ( unsigned int V_73 , struct V_92 * V_93 )
{
struct V_5 * V_7 = F_67 ( V_93 , struct V_5 , V_93 ) ;
int V_57 ;
...
static int F_72 ( unsigned int V_73 , struct V_92 * V_93 )
{
struct V_5 * V_7 = F_67 ( V_93 , struct V_5 , V_93 ) ;
int V_57 ;
if ( ! F_20 ( V_73 , & V_7 -> V_40 ) )
...
static void F_74 ( struct V_5 * V_6 , unsigned long V_96 )
{
struct V_33 * V_34 = F_17 ( V_6 -> V_34 ) ;
struct V_3 * V_4 ;
int V_35 ;
...
static int F_77 ( struct V_100 * V_101 , unsigned long V_96 ,
void * V_102 )
{
struct V_5 * V_6 = F_78 ( V_101 , struct V_5 , V_103 ) ;
struct V_33 * V_34 = F_17 ( V_6 -> V_34 ) ;
int V_74 = F_38 ( V_34 -> V_38 , V_6 -> V_75 ) ;
if ( ! F_20 ( F_21 () , & V_6 -> V_40 ) )
return V_104 ;
if ( V_96 == V_98 && V_6 -> V_94 )
V_6 -> V_94 ( V_6 ) ;
if ( ! V_74 )
return V_105 ;
switch ( V_96 ) {
...
static int F_79 ( struct V_5 * V_106 )
{
V_106 -> V_103 . V_107 = F_77 ;
return F_80 ( & V_106 -> V_103 ) ;
}
static void F_81 ( struct V_5 * V_106 )
{
F_82 ( & V_106 -> V_103 ) ;
}
static inline int F_79 ( struct V_5 * V_106 ) { return 0 ; }
static inline void F_81 ( struct V_5 * V_106 ) { }
static int F_83 ( struct V_5 * V_106 )
{
int V_86 ;
V_86 = F_84 ( V_108 ,
& V_106 -> V_93 ) ;
...
static void F_86 ( struct V_5 * V_106 )
{
F_81 ( V_106 ) ;
F_85 ( V_108 ,
& V_106 -> V_93 ) ;
