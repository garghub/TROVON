...
V_161 = F_117 ( V_18 ) ;
V_220 = ! ! ( V_161 -> V_233 & V_234 ) ;
V_221 = ! ! ( V_161 -> V_235 == V_236 ) ;
V_222 = ! ! ( V_161 -> V_233 & V_237 ) ;
if ( ! ! ( V_161 -> V_238 == V_239 ) ) {
V_224 += F_118 ( V_2 , V_161 -> V_240 , V_130 ,
V_221 , V_220 , V_222 ) ;
} else {
V_223 = F_119 ( V_150 -> V_185 ) ? V_241 : V_242 ;
V_219 = & V_14 -> V_243 [ V_161 -> V_188 ] . V_244 [ V_161 -> V_240 ] ;
V_224 += F_120 ( V_12 , V_223 , V_219 -> V_245 * 100 ,
V_130 , V_161 -> V_240 , V_222 ) ;
}
if ( ! ! ( V_2 -> V_246 & V_247 ) ) {
F_56 ( & V_213 -> V_248 ) ;
V_211 -> V_249 [ V_226 ] -= V_224 ;
if ( V_211 -> V_249 [ V_226 ] <= 0 )
...
int F_67 ( struct V_1 * V_2 , int V_10 , bool V_250 )
{
struct V_8 * V_9 ;
struct V_17 * V_18 = NULL , * V_251 , * V_252 ;
struct V_160 * V_161 ;
struct V_11 * V_12 = V_2 -> V_4 ;
struct V_13 * V_14 = F_3 ( V_12 ) ;
struct V_169 * V_74 = V_2 -> V_74 ;
...
struct V_149 V_150 ;
enum V_36 V_37 ;
bool V_254 = ! ! ( V_12 -> V_5 . V_6 & V_64 ) ;
int V_255 ;
T_3 V_162 = 0 ;
unsigned long V_256 ;
T_5 V_257 ;
unsigned int V_258 = 512 ;
struct V_143 * V_144 ;
if ( V_254 )
V_255 = V_51 ;
else
V_255 = V_69 ;
V_37 = V_250 ? V_50 : V_49 ;
V_162 = F_125 ( V_12 ) ;
do {
bool V_168 = false ;
...
continue;
if ( V_2 -> V_27 . V_259 )
V_252 = V_2 -> V_27 . V_259 ;
else
V_252 = V_18 ;
V_161 = F_117 ( V_252 ) ;
memset ( V_161 , 0 , sizeof( struct V_160 ) ) ;
V_253 = F_96 ( V_2 , V_252 , & V_150 , V_161 ,
& V_168 , V_162 ) ;
if ( V_253 )
goto V_260;
V_251 = F_41 ( V_14 , V_14 -> V_26 , V_261 ) ;
if ( ! V_251 ) {
F_97 ( V_262 ) ;
goto V_260;
}
V_257 = F_42 ( V_2 -> V_45 , V_251 -> V_25 ,
V_14 -> V_26 , V_255 ) ;
if ( F_43 ( F_44 ( V_2 -> V_45 , V_257 ) ) ) {
F_34 ( V_251 ) ;
goto V_260;
}
F_33 ( V_2 -> V_45 , V_9 -> V_22 ,
...
if ( V_2 -> V_27 . V_259 ) {
int V_266 = V_18 -> V_130 - F_129 ( V_252 ) ;
if ( F_130 ( V_252 , 0 , V_266 , V_261 ) < 0 ) {
F_54 ( V_18 ) ;
F_97 ( V_262 ) ;
goto V_260;
}
V_2 -> V_27 . V_259 = NULL ;
F_131 ( V_18 , F_126 ( V_252 , V_18 -> V_130 ) ,
V_18 -> V_130 ) ;
F_34 ( V_18 ) ;
V_18 = V_252 ;
}
if ( V_161 -> V_192 & V_267 )
F_132 ( V_18 , V_18 -> V_130 - 8 ) ;
F_133 ( & V_2 -> V_268 , V_256 ) ;
if ( ( V_2 -> V_135 & ( V_136 |
V_141 |
V_147 ) ) ||
F_1 ( V_2 ) )
F_78 ( V_2 , V_18 , V_150 . V_182 ) ;
F_134 ( & V_2 -> V_268 , V_256 ) ;
F_110 ( V_2 , & V_150 ) ;
