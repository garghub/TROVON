...
if ( V_36 -> V_53 ) {
V_4 -> V_53 = true ;
for ( V_46 = V_4 -> V_44 ; V_46 != V_36 ; V_46 = V_46 -> V_44 )
V_46 -> V_53 = true ;
F_14 ( L_14 ) ;
return 0 ;
}
...
continue;
F_14 ( L_20 ,
V_46 -> V_13 , V_46 -> V_60 -> V_45 , V_46 -> V_60 -> V_24 ) ;
if ( F_20 ( V_46 -> V_60 , V_48 ) )
goto V_61;
}
}
F_14 ( L_21 ) ;
...
if ( F_25 ( V_62 , & V_4 -> V_63 ) ) {
if ( V_4 -> V_64 < V_4 -> V_44 -> V_65 ||
V_4 -> V_64 > V_4 -> V_44 -> V_66 ) {
F_13 ( L_27 ) ;
return - V_29 ;
}
}
...
for ( V_4 = V_2 -> V_79 ; V_4 ; V_4 = V_4 -> V_39 ) {
V_12 = F_24 ( V_2 , V_4 ) ;
if ( V_4 -> V_53 && V_69 == - V_15 )
V_69 = - V_29 ;
if ( V_12 < 0 ) {
if ( V_12 == - V_15 ) {
V_4 -> V_80 = true ;
