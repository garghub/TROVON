...
V_45 [ V_44 ++ ] = V_39 ;
F_16 ( V_39 , true ) ;
F_26 ( & V_39 -> V_3 . V_23 , F_1 ,
( unsigned long ) & V_39 -> V_3 ) ;
V_5 = F_27 () ;
if ( ! V_5 )
return - V_61 ;
V_39 -> V_3 . V_5 = V_5 ;
snprintf ( V_39 -> V_3 . V_69 , sizeof( V_39 -> V_3 . V_69 ) ,
L_5 , F_28 ( V_39 -> V_70 -> V_71 ) ) ;
V_5 -> V_72 = L_6 ;
V_5 -> V_73 = V_39 -> V_3 . V_69 ;
V_5 -> V_74 . V_75 = V_76 ;
V_5 -> V_74 . V_77 = 2 ;
if ( V_39 -> V_70 -> V_71 -> V_78 ) {
V_5 -> V_74 . V_79 = V_39 -> V_70 -> V_71 -> V_78 ;
V_5 -> V_74 . V_80 = V_39 -> V_70 -> V_71 -> V_81 ;
} else {
V_5 -> V_74 . V_79 = V_39 -> V_70 -> V_71 -> V_79 ;
V_5 -> V_74 . V_80 = V_39 -> V_70 -> V_71 -> V_82 ;
}
V_5 -> V_70 . V_83 = & V_39 -> V_70 -> V_71 -> V_70 ;
memcpy ( V_39 -> V_3 . V_21 , V_84 , sizeof V_39 -> V_3 . V_21 ) ;
F_12 ( & V_39 -> V_3 ) ;
V_67 = F_29 ( V_5 ) ;
if ( V_67 ) {
F_30 ( V_5 ) ;
...
V_5 -> V_85 . V_86 = F_15 ;
V_5 -> V_85 . V_9 = ( unsigned long ) & V_39 -> V_3 ;
if ( V_44 == 1 ) {
V_66 = F_31 ( L_7 , V_87 , NULL , & V_88 ) ;
if ( V_66 )
F_32 ( V_66 , 4 + 256 * sizeof( T_3 ) ) ;
}
F_33 ( & V_39 -> V_3 . V_64 , F_5 , ( unsigned long ) & V_39 -> V_3 ) ;
V_39 -> V_3 . F_23 = F_23 ;
return 0 ;
}
void F_34 ( struct V_39 * V_39 )
{
int V_30 ;
if ( V_44 == 0 )
return;
