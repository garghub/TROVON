...
if ( F_16 () )
return - V_26 ;
V_2 = F_17 ( & V_27 , V_14 -> V_10 -> V_28 ,
V_14 -> V_10 , F_18 ( V_14 -> V_10 ) , NULL ) ;
if ( ! V_2 )
return - V_29 ;
F_19 ( V_14 -> V_10 , V_14 ) ;
V_2 -> V_30 = V_14 -> V_31 . V_32 ;
V_2 -> V_33 = V_14 -> V_31 . V_34 ;
V_2 -> V_35 = V_14 -> V_31 . abs ;
V_2 -> V_36 = 1 ;
V_2 -> V_37 = V_14 -> V_19 -> V_37 ;
V_2 -> V_38 = V_14 -> V_19 -> V_38 ;
if ( V_14 -> V_39 )
V_2 -> V_39 = V_14 -> V_39 ;
else
V_2 -> V_40 = V_14 -> V_40 ;
V_6 = F_2 ( V_2 ) ;
V_6 -> V_41 = V_14 -> V_31 . V_42 ;
V_6 -> V_43 = V_14 -> V_31 . V_44 ;
V_6 -> V_45 = V_14 -> V_31 . V_44 ;
V_6 -> V_46 = V_14 -> V_46 ;
V_8 = (struct V_7 * ) V_6 -> V_8 ;
V_8 -> V_18 = NULL ;
if ( V_14 -> V_19 -> V_18 && ! F_20 ( V_14 ) ) {
if ( V_14 -> V_19 -> V_47 & V_48 ) {
...
V_16 = F_4 ( V_6 -> V_17 ) ;
while ( V_16 -- ) {
T_2 T_3 * V_60 = & V_6 -> V_35 -> V_61 [ V_16 ] ;
T_2 V_62 = F_29 ( V_6 , V_60 ) ;
if ( V_62 & V_63 ) {
V_59 = F_29 ( V_6 , & V_6 -> V_35 -> V_64 ) ;
V_59 |= V_65 ;
F_30 ( V_6 , V_59 , & V_6 -> V_35 -> V_64 ) ;
F_31 ( 150 , 200 ) ;
break;
}
}
...
{
struct V_66 * V_67 ;
if ( ! F_33 ( V_14 , V_68 , V_69 ) )
return - V_70 ;
V_67 = F_34 ( V_14 -> V_10 , sizeof( struct V_66 ) , V_71 ) ;
if ( ! V_67 )
return - V_29 ;
V_67 -> V_72 = F_15 ;
V_67 -> V_73 = F_23 ;
