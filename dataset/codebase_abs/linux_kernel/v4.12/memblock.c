...
T_3 T_5 F_95 ( unsigned long V_108 )
{
...
V_110 = F_97 ( V_33 ) ;
V_111 = F_98 ( V_33 ) ;
V_110 = F_99 (unsigned long, start_pfn, limit_pfn) ;
V_111 = F_99 (unsigned long, end_pfn, limit_pfn) ;
V_109 += V_111 - V_110 ;
}
return F_69 ( V_109 ) ;
}
...
static T_3 T_2 F_102 ( T_3 V_112 )
{
T_3 V_98 = ( T_3 ) V_6 ;
struct V_39 * V_33 ;
F_96 (memory, r) {
...
void T_5 F_104 ( T_3 V_4 , T_3 V_5 )
{
int V_69 , V_70 ;
int V_12 , V_24 ;
if ( ! V_5 )
...
static int T_2 F_106 ( struct V_11 * type , T_3 V_36 )
{
...
bool T_5 F_107 ( T_3 V_36 )
{
return F_106 ( & V_26 . V_37 , V_36 ) != - 1 ;
}
bool T_2 F_108 ( T_3 V_36 )
{
return F_106 ( & V_26 . V_40 , V_36 ) != - 1 ;
}
int T_2 F_109 ( T_3 V_36 )
{
int V_12 = F_106 ( & V_26 . V_40 , V_36 ) ;
if ( V_12 == - 1 )
return false ;
return ! F_63 ( & V_26 . V_40 . V_14 [ V_12 ] ) ;
}
int T_2 F_110 ( unsigned long V_91 ,
unsigned long * V_110 , unsigned long * V_111 )
{
struct V_11 * type = & V_26 . V_40 ;
int V_94 = F_106 ( type , F_69 ( V_91 ) ) ;
if ( V_94 == - 1 )
return - 1 ;
...
int T_2 F_111 ( T_3 V_4 , T_3 V_5 )
{
int V_59 = F_106 ( & V_26 . V_40 , V_4 ) ;
T_3 V_16 = V_4 + F_2 ( V_4 , & V_5 ) ;
if ( V_59 == - 1 )
return 0 ;
...
bool T_2 F_112 ( T_3 V_4 , T_3 V_5 )
{
F_2 ( V_4 , & V_5 ) ;
return F_5 ( & V_26 . V_37 , V_4 , V_5 ) ;
}
void T_2 F_113 ( T_3 V_17 )
{
...
static void T_2 F_116 ( struct V_11 * type )
{
T_3 V_4 , V_16 , V_5 ;
unsigned long V_19 ;
int V_59 ;
struct V_39 * V_60 ;
F_117 ( L_13 , type -> V_56 , type -> V_13 ) ;
F_42 (type, rgn) {
char V_115 [ 32 ] = L_14 ;
V_4 = V_60 -> V_4 ;
V_5 = V_60 -> V_5 ;
...
static int T_5 F_122 ( char * V_119 )
{
if ( V_119 && strstr ( V_119 , L_19 ) )
V_120 = 1 ;
return 0 ;
}
static int F_123 ( struct V_121 * V_82 , void * V_122 )
{
...
F_124 ( V_82 , L_20 , V_12 ) ;
F_124 ( V_82 , L_21 , & V_123 -> V_4 , & V_16 ) ;
}
return 0 ;
}
static int F_125 ( struct V_124 * V_124 , struct V_125 * V_125 )
{
return F_126 ( V_125 , F_123 , V_124 -> V_126 ) ;
}
static int T_5 F_127 ( void )
{
struct V_127 * V_128 = F_128 ( L_22 , NULL ) ;
if ( ! V_128 )
return - V_129 ;
F_129 ( L_23 , V_130 , V_128 , & V_26 . V_40 , & V_131 ) ;
F_129 ( L_24 , V_130 , V_128 , & V_26 . V_37 , & V_131 ) ;
#ifdef F_120
F_129 ( L_25 , V_130 , V_128 , & V_26 . V_118 , & V_131 ) ;
#endif
return 0 ;
}
