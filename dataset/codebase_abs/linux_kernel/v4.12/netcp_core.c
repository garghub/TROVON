...
if ( V_293 -> type != V_295 )
return - V_62 ;
V_293 -> V_296 -> V_297 = V_298 ;
V_294 = V_293 -> V_296 -> V_294 ;
if ( ( V_36 -> V_299 <= 1 ) ||
( V_36 -> V_299 < V_294 ) )
return - V_62 ;
if ( V_294 ) {
...
static int F_207 ( struct V_342 * V_343 )
{
...
static int F_213 ( struct V_342 * V_343 )
{
struct V_32 * V_32 = F_214 ( V_343 ) ;
struct V_27 * V_27 , * V_69 ;
