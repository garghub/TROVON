...
V_90 -> V_99 & F_34 ( V_52 + V_97 ) ) ;
}
return;
}
if ( V_59 -> V_73 ) {
T_1 V_129 ;
V_129 = F_70 ( V_90 -> V_99 ) |
F_71 ( V_90 -> V_99 ) << 1 |
F_72 ( V_90 -> V_99 ) << 2 ;
F_46 ( V_59 -> V_73 ,
V_130 , V_131 ) ;
...
static T_4 F_88 ( struct V_1 * V_1 )
{
struct V_58 * V_59 = V_1 -> V_60 ;
if ( V_1 -> V_165 >= 6 ) {
if ( F_89 ( V_59 -> V_155 == V_161 ) )
V_59 -> V_155 = F_87 ( V_1 ) ;
if ( F_90 ( V_59 -> V_20 . V_34 ) &&
F_44 ( V_1 -> V_75 ) ) {
if ( V_59 -> V_73 )
F_45 ( V_59 -> V_73 ,
V_1 -> V_75 ) ;
...
return F_86 ( V_1 , V_1 -> V_165 - 1 , V_59 -> V_155 ) ?
V_167 : V_168 ;
}
...
int V_173 = F_92 ( V_20 -> V_36 ) ?
V_174 : 0 ;
F_93 ( V_118 , V_169 , V_47 , V_44 , V_173 , 0 ) ;
F_93 ( V_118 , V_170 , V_48 , V_45 , V_173 , 0 ) ;
F_94 ( V_118 , V_169 , V_20 -> V_41 ) ;
F_94 ( V_118 , V_170 , V_20 -> V_42 ) ;
}
...
struct V_19 * V_20 = & V_59 -> V_20 ;
int V_52 ;
F_96 ( V_175 , V_118 -> V_176 ) ;
F_96 ( V_177 , V_118 -> V_178 ) ;
F_96 ( V_132 , V_118 -> V_179 ) ;
F_96 ( V_133 , V_118 -> V_179 ) ;
if ( F_60 ( V_20 -> V_34 ) )
F_96 ( V_134 , V_118 -> V_179 ) ;
if ( ! V_59 -> V_61 ) {
F_96 ( V_180 , V_118 -> V_178 ) ;
F_96 ( V_181 , V_118 -> V_182 ) ;
F_96 ( V_183 , V_118 -> V_182 ) ;
return;
}
F_96 ( V_184 , V_118 -> V_178 ) ;
F_91 ( V_118 , & V_59 -> V_20 , V_146 , V_147 ) ;
F_93 ( V_118 , V_148 , 0 , 255 , 0 , 0 ) ;
if ( V_144 )
F_93 ( V_118 , V_142 , 0 , 255 , 0 , 0 ) ;
if ( F_33 ( V_20 -> V_36 ) ) {
F_91 ( V_118 , V_20 ,
V_122 , V_123 ) ;
F_93 ( V_118 , V_142 , 0 , 255 , 0 , 0 ) ;
F_97 ( V_118 , 2 , V_185 | V_186 ) ;
F_96 ( V_187 , V_118 -> V_179 ) ;
F_96 ( V_188 , V_118 -> V_179 ) ;
...
if ( F_85 ( V_20 -> V_34 ) )
F_93 ( V_118 , V_149 , 0 , 15 , 0 , 0 ) ;
F_96 ( V_145 , V_118 -> V_179 ) ;
F_96 ( V_150 , V_118 -> V_179 ) ;
if ( F_83 ( V_20 -> V_34 ) ) {
F_96 ( V_151 , V_118 -> V_179 ) ;
F_96 ( V_152 , V_118 -> V_179 ) ;
}
if ( F_61 ( V_20 -> V_34 ) ||
F_60 ( V_20 -> V_34 ) ) {
F_96 ( V_135 , V_118 -> V_179 ) ;
F_96 ( V_136 , V_118 -> V_179 ) ;
}
if ( ! F_68 ( V_20 -> V_32 ) )
for ( V_52 = 0 ; V_52 < F_21 ( V_20 -> V_35 ) ; V_52 ++ )
F_96 ( V_127 + V_52 , V_118 -> V_179 ) ;
F_98 ( V_180 , V_118 -> V_178 ) ;
F_98 ( V_181 , V_118 -> V_182 ) ;
F_98 ( V_183 , V_118 -> V_182 ) ;
if ( F_59 ( V_20 -> V_36 ) ) {
F_96 ( V_190 , V_118 -> V_176 ) ;
if ( F_30 ( V_1 , V_191 ) &&
! F_68 ( V_20 -> V_32 ) )
F_96 ( V_192 , V_118 -> V_176 ) ;
F_98 ( V_133 , V_118 -> V_179 ) ;
F_98 ( V_134 , V_118 -> V_179 ) ;
}
}
static T_5 F_99 ( struct V_1 * V_1 ,
void * V_193 , char * V_17 )
{
struct V_58 * V_59 = V_1 -> V_60 ;
return sprintf ( V_17 , L_18 , V_59 -> V_63 ? '1' : '0' ) ;
}
static T_5 F_100 ( struct V_1 * V_1 ,
...
F_103 ( V_1 ) ;
if ( ! V_59 -> V_61 &&
F_104 ( V_59 -> V_20 . V_22 ) )
F_105 ( & V_1 -> V_5 . V_68 -> V_118 ,
& V_199 . V_200 ) ;
F_5 ( V_1 ) ;
F_106 ( V_59 ) ;
V_1 -> V_60 = NULL ;
...
L_23 ,
F_114 ( V_20 -> V_22 ) ,
F_23 ( V_20 -> V_22 ) , F_115 ( V_20 -> V_22 ) ,
V_20 -> V_25 ,
...
if ( ! V_59 -> V_61 && F_104 ( V_20 -> V_22 ) ) {
V_196 = F_117 ( & V_1 -> V_5 . V_68 -> V_118 ,
& V_199 . V_200 ) ;
if ( V_196 ) {
F_36 ( V_1 ,
L_25 ,
...
static int F_118 ( struct V_1 * V_1 , bool V_61 )
{
struct V_19 V_20 ;
int error ;
F_108 ( V_1 ) ;
...
return F_113 ( V_1 , & V_20 , V_61 ) ;
}
int F_119 ( struct V_1 * V_1 )
{
return F_118 ( V_1 , true ) ;
}
int F_120 ( struct V_1 * V_1 )
{
return F_118 ( V_1 , false ) ;
}
...
error = F_125 ( V_1 , & V_20 , true ) ;
if ( ! error )
return V_248 ;
}
V_245 = F_121 ( V_1 , & V_20 ) ;
if ( V_245 < 0 ) {
F_103 ( V_1 ) ;
}
return V_245 ;
