...
V_8 -> V_18 = F_23 ( V_8 -> V_23 ) ;
V_8 -> V_37 = F_24 ( & V_28 -> V_32 , L_1 ) ;
if ( F_19 ( V_8 -> V_37 ) ) {
V_31 = F_20 ( V_8 -> V_37 ) ;
F_25 ( & V_28 -> V_32 , L_2 , V_31 ) ;
return V_31 ;
}
F_26 ( V_8 -> V_37 ) ;
...
V_8 -> V_3 . V_38 = & V_39 ;
V_8 -> V_3 . V_40 = - 1 ;
V_8 -> V_3 . V_41 = V_8 -> V_35 -> V_42 ;
V_31 = F_27 ( & V_8 -> V_3 ) ;
if ( V_31 < 0 ) {
F_25 ( & V_28 -> V_32 , L_3 , V_31 ) ;
F_28 ( V_8 -> V_37 ) ;
return V_31 ;
}
return 0 ;
...
if ( V_15 < 0 )
return V_15 ;
for ( V_43 = 0 ; V_43 < V_11 -> V_3 . V_41 ; V_43 ++ ) {
struct V_7 * V_8 = & V_11 -> V_3 . V_45 [ V_43 ] ;
if ( ! F_9 ( V_8 ) )
if ( F_10 ( V_11 -> V_23 ) < 0 )
continue;
F_5 ( V_11 , V_43 , 0 ) ;
...
static int F_33 ( struct V_46 * V_32 )
{
return F_34 ( V_32 ) ;
}
