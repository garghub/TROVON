...
static void F_36 ( struct V_11 * V_5 , T_6 type ,
unsigned V_66 , char * V_36 , unsigned V_67 )
{
struct V_3 * V_4 = (struct V_3 * ) V_5 -> V_34 ;
char V_68 [ V_4 -> V_7 + 1 ] ;
unsigned int V_69 = 0 ;
...
F_37 ( L_13 , V_4 -> V_7 ) ;
for ( V_24 = 0 ; V_24 < V_4 -> V_7 ; V_24 ++ ) {
F_37 ( L_14 , V_4 -> V_9 [ V_24 ] . V_17 -> V_71 ) ;
V_68 [ V_24 ] = F_38 ( & ( V_4 -> V_9 [ V_24 ] . V_33 ) ) ?
'D' : 'A' ;
}
V_68 [ V_24 ] = '\0' ;
F_37 ( L_15 , V_68 ) ;
...
for ( V_24 = 0 ; V_24 < V_4 -> V_7 ; V_24 ++ )
F_37 ( L_17 , V_4 -> V_9 [ V_24 ] . V_17 -> V_71 ,
( unsigned long long ) V_4 -> V_9 [ V_24 ] . V_18 ) ;
break;
}
}
static int F_39 ( struct V_11 * V_5 , struct V_40 * V_40 , int error )
{
unsigned V_24 ;
char V_73 [ 16 ] ;
struct V_3 * V_4 = V_5 -> V_34 ;
if ( ! error )
return 0 ;
if ( ( error == - V_74 ) && ( V_40 -> V_51 & V_75 ) )
return error ;
if ( error == - V_76 )
return error ;
memset ( V_73 , 0 , sizeof( V_73 ) ) ;
sprintf ( V_73 , L_18 ,
F_40 ( F_41 ( V_40 -> V_45 -> V_77 ) ) ,
F_42 ( F_41 ( V_40 -> V_45 -> V_77 ) ) ) ;
for ( V_24 = 0 ; V_24 < V_4 -> V_7 ; V_24 ++ )
if ( ! strcmp ( V_4 -> V_9 [ V_24 ] . V_17 -> V_71 , V_73 ) ) {
F_43 ( & ( V_4 -> V_9 [ V_24 ] . V_33 ) ) ;
if ( F_38 ( & ( V_4 -> V_9 [ V_24 ] . V_33 ) ) <
V_78 )
F_44 ( & V_4 -> F_1 ) ;
}
return error ;
}
static int F_45 ( struct V_11 * V_5 ,
T_7 V_79 , void * V_80 )
{
struct V_3 * V_4 = V_5 -> V_34 ;
int V_15 = 0 ;
unsigned V_24 = 0 ;
do {
V_15 = V_79 ( V_5 , V_4 -> V_9 [ V_24 ] . V_17 ,
V_4 -> V_9 [ V_24 ] . V_18 ,
V_4 -> V_26 , V_80 ) ;
} while ( ! V_15 && ++ V_24 < V_4 -> V_7 );
return V_15 ;
}
static void F_46 ( struct V_11 * V_5 ,
struct V_81 * V_82 )
{
struct V_3 * V_4 = V_5 -> V_34 ;
unsigned V_22 = V_4 -> V_22 << V_83 ;
F_47 ( V_82 , V_22 ) ;
F_48 ( V_82 , V_22 * V_4 -> V_7 ) ;
}
int T_8 F_49 ( void )
{
int V_23 ;
