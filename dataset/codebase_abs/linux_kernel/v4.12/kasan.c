...
void F_73 ( const void * V_61 , T_1 V_4 , T_9 V_47 )
{
struct V_39 * V_39 ;
unsigned long V_85 ;
unsigned long V_86 ;
...
void F_75 ( const void * V_60 , T_1 V_4 , T_9 V_47 )
{
struct V_39 * V_39 ;
if ( F_14 ( V_60 == V_89 ) )
return;
...
void F_79 ( const void * V_61 )
{
struct V_39 * V_39 = F_74 ( V_61 ) ;
F_3 ( V_61 , V_41 << F_49 ( V_39 ) ,
V_42 ) ;
}
int F_80 ( void * V_16 , T_1 V_4 )
{
void * V_25 ;
T_1 V_91 ;
unsigned long V_6 ;
...
void F_85 ( const struct V_101 * V_102 )
{
if ( V_102 -> V_47 & V_99 )
F_86 ( F_4 ( V_102 -> V_16 ) ) ;
}
...
{
T_1 V_105 = F_52 ( V_104 -> V_4 , V_20 ) ;
F_5 ( V_104 -> V_106 , V_104 -> V_4 ) ;
F_3 ( V_104 -> V_106 + V_105 ,
V_104 -> V_107 - V_105 ,
V_108 ) ;
}
void F_88 ( struct V_103 * V_109 , T_1 V_4 )
{
int V_68 ;
for ( V_68 = 0 ; V_68 < V_4 ; V_68 ++ )
F_87 ( & V_109 [ V_68 ] ) ;
}
void F_89 ( struct V_103 * V_109 , T_1 V_4 )
{
}
