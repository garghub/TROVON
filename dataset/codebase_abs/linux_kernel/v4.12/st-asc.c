...
V_164 = F_93 ( & V_3 -> V_63 , V_77 ) ;
else
F_47 ( & V_3 -> V_63 , V_77 ) ;
V_7 = F_3 ( V_3 , V_8 ) ;
F_6 ( V_3 , V_8 , 0 ) ;
( void ) F_3 ( V_3 , V_8 ) ;
F_94 ( V_3 , V_161 , V_162 , F_90 ) ;
...
static int F_95 ( struct V_159 * V_160 , char * V_167 )
{
struct V_1 * V_67 ;
int V_91 = 115200 ;
int V_168 = 8 ;
...
return - V_170 ;
if ( V_167 )
F_96 ( V_167 , & V_91 , & V_54 , & V_168 , & V_169 ) ;
return F_97 ( & V_67 -> V_3 , V_160 , V_91 , V_54 , V_168 , V_169 ) ;
}
static int T_5 F_98 ( void )
{
int V_141 ;
static const char V_171 [] V_172 =
V_173 L_9 ;
F_99 ( V_171 ) ;
V_141 = F_100 ( & V_155 ) ;
if ( V_141 )
