...
int V_6 ;
unsigned long V_100 ;
if ( V_8 -> V_53 . V_101 && ! F_55 ( V_102 , & V_8 -> V_53 ) ) {
F_56 ( & V_8 -> V_53 , L_13 ) ;
F_52 ( V_8 -> V_53 . V_101 &&
! F_55 ( V_102 , & V_8 -> V_53 ) ) ;
}
F_49 ( V_8 ) ;
V_2 = F_57 ( sizeof( * V_2 ) , V_43 ) ;
if ( ! V_2 )
return - V_44 ;
V_2 -> V_8 = V_8 ;
F_58 ( & V_2 -> V_9 ) ;
...
F_60 ( & V_2 -> V_103 ) ;
F_11 ( & V_88 ) ;
V_100 = F_61 ( V_104 , V_105 ) ;
if ( V_100 < V_105 ) {
struct V_106 * V_53 ;
V_2 -> V_89 = F_62 ( V_107 , V_100 ) ;
V_53 = F_63 ( V_108 , & V_8 -> V_53 , V_2 -> V_89 ,
V_2 , L_14 ,
V_8 -> V_109 -> V_110 , V_8 -> V_111 ) ;
V_6 = F_64 ( V_53 ) ;
} else {
F_20 ( & V_8 -> V_53 , L_15 ) ;
V_6 = - V_112 ;
...
int V_6 ;
F_75 ( V_105 > 256 ) ;
V_6 = F_76 ( V_107 , L_16 , & V_114 ) ;
if ( V_6 < 0 )
return V_6 ;
V_108 = F_77 ( V_115 , L_17 ) ;
if ( F_37 ( V_108 ) ) {
F_78 ( V_107 , V_116 . V_117 . V_118 ) ;
return F_38 ( V_108 ) ;
}
V_6 = F_79 ( & V_116 ) ;
if ( V_6 < 0 ) {
