...
static int F_20 ( struct V_71 T_1 * V_72 , struct V_27 * V_73 )
{
if ( sizeof V_72 -> V_52 == 4 ) {
if ( ( V_73 -> V_52 | V_73 -> V_53 | V_73 -> V_54 |
V_73 -> V_35 | V_73 -> V_34 ) & 0xffffffff00000000ULL )
return - V_55 ;
if ( V_73 -> V_56 != 0xffffffffffffffffULL
&& ( V_73 -> V_56 & 0xffffffff00000000ULL ) )
return - V_55 ;
if ( V_73 -> V_57 != 0xffffffffffffffffULL
&& ( V_73 -> V_57 & 0xffffffff00000000ULL ) )
return - V_55 ;
}
if ( ! F_21 ( V_74 , V_72 , sizeof( * V_72 ) ) ||
F_22 ( V_73 -> V_58 , & V_72 -> V_58 ) ||
F_22 ( V_73 -> V_35 , & V_72 -> V_35 ) ||
F_22 ( V_73 -> V_52 , & V_72 -> V_52 ) ||
F_22 ( V_73 -> V_53 , & V_72 -> V_53 ) ||
F_22 ( V_73 -> V_54 , & V_72 -> V_54 ) ||
F_22 ( V_73 -> V_56 , & V_72 -> V_56 ) ||
F_22 ( V_73 -> V_57 , & V_72 -> V_57 ) ||
F_22 ( V_73 -> V_60 , & V_72 -> V_60 ) ||
F_22 ( V_73 -> V_59 . V_75 [ 0 ] , & V_72 -> V_59 . V_75 [ 0 ] ) ||
F_22 ( V_73 -> V_59 . V_75 [ 1 ] , & V_72 -> V_59 . V_75 [ 1 ] ) ||
F_22 ( V_73 -> V_34 , & V_72 -> V_34 ) ||
F_22 ( V_73 -> V_37 , & V_72 -> V_37 ) ||
F_23 ( V_72 -> V_61 , sizeof( V_72 -> V_61 ) ) )
return - V_62 ;
return 0 ;
}
static int F_24 ( struct V_76 T_1 * V_72 , struct V_27 * V_73 )
{
if ( sizeof( V_72 -> V_35 ) == 4 ) {
if ( ( V_73 -> V_58 | V_73 -> V_35 | V_73 -> V_60 |
V_73 -> V_34 | V_73 -> V_37 ) & 0xffffffff00000000ULL )
return - V_55 ;
if ( V_73 -> V_56 != 0xffffffffffffffffULL
&& ( V_73 -> V_56 & 0xffffffff00000000ULL ) )
return - V_55 ;
