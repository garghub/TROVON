...
int
F_58 ( struct V_1 * V_2 , void * V_42 )
{
F_59 ( & V_2 -> V_12 , V_192 , F_6 ) ;
V_2 -> V_12 . V_42 = V_42 ;
...
static void
F_60 ( struct V_200 * V_201 )
{
T_1 V_202 , V_203 = 50 ;
while ( V_203 ) {
V_202 = F_61 ( V_201 , V_204 ) ;
if ( ! ( V_202 & 0x04 ) )
break;
F_62 ( 1 ) ;
V_203 -- ;
...
static void
F_64 ( struct V_200 * V_201 , T_1 V_135 )
{
if ( V_201 -> V_205 -> type & V_208 )
F_65 ( V_201 , V_209 , V_135 ) ;
else {
F_60 ( V_201 ) ;
F_65 ( V_201 , V_210 , V_135 ) ;
}
}
static void
F_66 ( struct V_200 * V_211 , T_1 V_33 )
{
T_1 * V_212 ;
int V_37 ;
...
T_1 V_222 ;
if ( V_201 -> V_205 -> type & V_208 )
V_222 = F_61 ( V_201 , V_223 ) ;
else
V_222 = F_61 ( V_201 , V_224 ) ;
...
if ( V_201 -> V_205 -> type & V_208 )
V_33 = F_61 ( V_201 , V_226 ) ;
else
V_33 = F_61 ( V_201 , V_227 ) ;
V_33 &= ( V_201 -> V_218 - 1 ) ;
if ( V_33 == 0 )
V_33 = V_201 -> V_218 ;
F_66 ( V_201 , V_33 ) ;
...
T_2
F_75 ( struct V_249 * V_250 , int V_251 )
{
int V_252 = V_251 + 1 ;
T_1 V_228 , V_253 ;
struct V_1 * V_2 = & V_250 -> V_2 ;
if ( V_250 -> type & V_208 ) {
V_228 = F_76 ( V_250 , V_176 ) ;
while ( V_228 && -- V_252 ) {
F_2 ( L_72 , V_250 -> V_4 , V_228 ) ;
if ( V_228 & V_254 )
F_74 ( & V_250 -> V_211 [ 0 ] , V_228 ) ;
if ( V_228 & V_255 )
F_74 ( & V_250 -> V_211 [ 1 ] , V_228 ) ;
if ( V_228 & ( V_105 | V_104 ) )
F_36 ( & V_250 -> V_2 , V_228 ) ;
V_228 = F_76 ( V_250 , V_176 ) ;
}
} else if ( V_250 -> type & V_233 ) {
V_228 = F_76 ( V_250 , V_256 ) ;
while ( V_228 && -- V_252 ) {
F_2 ( L_72 , V_250 -> V_4 , V_228 ) ;
...
while ( -- V_252 ) {
V_228 = F_76 ( V_250 , V_234 + V_250 -> V_211 [ 1 ] . V_43 ) ;
...
static int
F_78 ( struct V_200 * V_211 , T_3 V_263 )
{
F_2 ( L_77 , V_211 -> V_205 -> V_4 ,
'@' + V_211 -> V_206 . V_207 , V_211 -> V_206 . V_8 , V_263 , V_211 -> V_206 . V_207 ) ;
if ( V_211 -> V_205 -> type & V_208 ) {
if ( V_211 -> V_206 . V_207 & 1 ) {
F_79 ( V_211 -> V_205 , V_264 , 0x80 ) ;
F_79 ( V_211 -> V_205 , V_265 , 0x88 ) ;
} else {
F_79 ( V_211 -> V_205 , V_266 , 0x81 ) ;
F_79 ( V_211 -> V_205 , V_267 , 0x88 ) ;
}
switch ( V_263 ) {
case V_268 :
F_65 ( V_211 , V_269 , 0xC0 ) ;
F_65 ( V_211 , V_270 , 0x30 ) ;
F_65 ( V_211 , V_271 , 0xFF ) ;
F_64 ( V_211 , 0x41 ) ;
F_25 ( V_272 , & V_211 -> V_206 . V_55 ) ;
F_25 ( V_220 , & V_211 -> V_206 . V_55 ) ;
break;
case V_273 :
F_65 ( V_211 , V_269 , 0x88 ) ;
F_65 ( V_211 , V_270 , 0x00 ) ;
F_64 ( V_211 , 0x41 ) ;
F_65 ( V_211 , V_271 , V_274 ) ;
...
F_65 ( V_211 , V_277 , 0x82 ) ;
F_65 ( V_211 , V_278 , 0x30 ) ;
F_65 ( V_211 , V_279 , 0x07 ) ;
F_65 ( V_211 , V_280 , 0x07 ) ;
F_65 ( V_211 , V_281 , V_211 -> V_282 ) ;
F_65 ( V_211 , V_283 , V_211 -> V_282 ) ;
switch ( V_263 ) {
case V_268 :
F_65 ( V_211 , V_281 , 0x1F ) ;
F_65 ( V_211 , V_283 , 0x1F ) ;
F_65 ( V_211 , V_284 , 0x84 ) ;
F_65 ( V_211 , V_277 , 0x82 ) ;
F_65 ( V_211 , V_285 , 0xFF ) ;
F_25 ( V_272 , & V_211 -> V_206 . V_55 ) ;
F_25 ( V_220 , & V_211 -> V_206 . V_55 ) ;
break;
case V_273 :
F_65 ( V_211 , V_284 , 0xe4 ) ;
F_65 ( V_211 , V_277 , 0x82 ) ;
F_64 ( V_211 , 0x41 ) ;
F_65 ( V_211 , V_285 , 0 ) ;
F_15 ( V_220 , & V_211 -> V_206 . V_55 ) ;
break;
case V_275 :
F_65 ( V_211 , V_284 , 0x8c ) ;
F_65 ( V_211 , V_277 , 0x8a ) ;
F_64 ( V_211 , 0x41 ) ;
F_65 ( V_211 , V_285 , 0 ) ;
F_15 ( V_272 , & V_211 -> V_206 . V_55 ) ;
break;
...
static int
F_80 ( struct V_116 * V_117 , struct V_118 * V_119 )
{
...
static int
F_83 ( struct V_286 * V_206 , struct V_287 * V_288 )
{
return F_84 ( V_206 , V_288 ) ;
}
static int
F_85 ( struct V_116 * V_117 , T_3 V_135 , void * V_289 )
{
struct V_286 * V_206 = F_7 ( V_117 , struct V_286 , V_117 ) ;
struct V_200 * V_201 = F_7 ( V_206 , struct V_200 , V_206 ) ;
int V_67 = - V_123 ;
...
V_117 -> V_169 = V_268 ;
V_117 -> V_292 = NULL ;
F_87 ( V_201 -> V_205 -> V_293 ) ;
V_67 = 0 ;
break;
case V_294 :
V_67 = F_83 ( V_206 , V_289 ) ;
break;
default:
F_11 ( L_81 ,
...
static void
F_89 ( struct V_200 * V_201 )
{
T_1 V_61 ;
F_65 ( V_201 , V_295 , 0xFF ) ;
F_65 ( V_201 , V_296 , 0x00 ) ;
F_65 ( V_201 , V_297 , 0x00 ) ;
if ( V_201 -> V_205 -> type & V_262 ) {
F_65 ( V_201 , V_277 , 0x85 ) ;
V_61 = F_61 ( V_201 , V_298 ) ;
F_2 ( L_82 , V_201 -> V_205 -> V_4 , V_61 ) ;
if ( V_201 -> V_206 . V_44 & V_181 )
F_57 ( L_83 , V_201 -> V_205 -> V_4 ,
V_299 [ V_61 & 0x0f ] ) ;
} else
F_65 ( V_201 , V_277 , 0x82 ) ;
F_65 ( V_201 , V_278 , 0x30 ) ;
F_65 ( V_201 , V_279 , 0x07 ) ;
F_65 ( V_201 , V_280 , 0x07 ) ;
}
static int
F_90 ( struct V_249 * V_250 )
{
T_1 V_61 ;
if ( V_250 -> type & V_262 ) {
F_89 ( & V_250 -> V_211 [ 0 ] ) ;
F_89 ( & V_250 -> V_211 [ 1 ] ) ;
V_61 = F_76 ( V_250 , V_300 ) ;
} else if ( V_250 -> type & V_233 ) {
F_89 ( & V_250 -> V_211 [ 0 ] ) ;
F_89 ( & V_250 -> V_211 [ 1 ] ) ;
F_79 ( V_250 , V_301 , V_302 ) ;
V_61 = F_76 ( V_250 , V_303 ) ;
F_2 ( L_84 , V_250 -> V_4 ,
V_61 , V_250 -> V_304 ) ;
F_79 ( V_250 , V_303 , V_250 -> V_304 ) ;
V_61 = F_76 ( V_250 , V_300 ) ;
if ( V_250 -> V_211 [ 0 ] . V_206 . V_44 & V_181 )
F_57 ( L_85 , V_250 -> V_4 , V_61 ) ;
}
return F_54 ( & V_250 -> V_2 ) ;
}
static int
F_91 ( struct V_249 * V_250 , struct V_166 * V_167 )
{
struct V_286 * V_206 ;
...
static int
F_92 ( struct V_249 * V_250 , struct V_287 * V_288 )
{
int V_67 = 0 ;
switch ( V_288 -> V_306 ) {
case V_307 :
...
static int
F_93 ( struct V_116 * V_117 , T_3 V_135 , void * V_289 )
{
struct V_120 * V_121 = F_7 ( V_117 , struct V_120 , V_122 ) ;
struct V_14 * V_12 = F_7 ( V_121 , struct V_14 , V_121 ) ;
struct V_1 * V_2 = F_7 ( V_12 , struct V_1 , V_12 ) ;
...
T_3
F_95 ( struct V_249 * V_250 , void * V_42 )
{
T_3 V_67 ;
T_1 V_312 ;
V_250 -> V_42 = V_42 ;
if ( V_250 -> V_2 . V_12 . V_44 & V_181 )
F_57 ( L_91 , V_250 -> V_4 , V_250 -> type ) ;
if ( V_250 -> type & V_262 ) {
...
return 0 ;
F_58 ( & V_250 -> V_2 , V_42 ) ;
V_250 -> V_2 . V_12 . V_121 . V_122 . V_196 = F_93 ;
for ( V_312 = 0 ; V_312 < 2 ; V_312 ++ ) {
V_250 -> V_211 [ V_312 ] . V_206 . V_207 = V_312 + 1 ;
F_96 ( V_312 + 1 , V_250 -> V_2 . V_12 . V_121 . V_316 ) ;
F_97 ( & V_250 -> V_211 [ V_312 ] . V_206 . V_117 . V_317 ,
& V_250 -> V_2 . V_12 . V_121 . V_318 ) ;
F_98 ( & V_250 -> V_211 [ V_312 ] . V_206 , V_319 ,
V_250 -> V_211 [ V_312 ] . V_218 ) ;
V_250 -> V_211 [ V_312 ] . V_206 . V_117 . V_207 = V_312 + 1 ;
V_250 -> V_211 [ V_312 ] . V_206 . V_117 . V_193 = & F_80 ;
V_250 -> V_211 [ V_312 ] . V_206 . V_117 . V_196 = F_85 ;
