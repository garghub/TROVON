...
static void F_62 ( struct V_67 * V_9 )
{
...
static int F_67 ( struct V_67 * V_9 , void * V_79 )
{
return V_9 -> V_80 == V_79 ;
}
static int F_68 ( struct V_7 * V_8 )
{
struct V_81 * V_82 ;
struct V_83 * V_84 = NULL ;
V_82 = F_69 ( V_8 -> V_9 . V_80 , 0 , 0 ) ;
if ( ! V_82 )
return - V_27 ;
F_70 ( & V_8 -> V_9 , & V_84 , F_67 , V_82 ) ;
F_71 ( V_82 ) ;
