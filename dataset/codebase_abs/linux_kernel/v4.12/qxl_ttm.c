...
struct V_28 * V_29 ;
int V_11 ;
V_29 = (struct V_28 * ) V_27 -> V_30 -> V_31 ;
if ( V_29 == NULL )
return V_32 ;
V_11 = V_33 -> V_34 ( V_27 ) ;
return V_11 ;
}
int F_13 ( struct V_35 * V_36 , struct V_37 * V_30 )
{
struct V_38 * V_39 ;
struct V_1 * V_6 ;
int V_11 ;
if ( F_14 ( V_30 -> V_40 < V_41 ) ) {
F_15 ( L_4 ,
V_42 , V_30 -> V_40 ) ;
return - V_43 ;
}
...
F_16 ( V_6 , L_6 ,
V_42 , V_36 -> V_44 , V_30 -> V_40 ) ;
V_11 = F_17 ( V_36 , V_30 , & V_6 -> V_5 . V_3 ) ;
if ( F_14 ( V_11 != 0 ) )
return V_11 ;
if ( F_14 ( V_33 == NULL ) ) {
V_33 = V_30 -> V_48 ;
...
static int F_24 ( struct V_28 * V_29 , struct V_35 * V_36 )
{
struct V_67 * V_68 = F_22 ( V_29 ) ;
return F_25 ( & V_68 -> V_78 . V_79 ,
V_36 -> V_44 ) ;
}
...
struct V_80 * V_106 = & V_29 -> V_81 ;
int V_111 ;
V_111 = F_44 ( V_29 , V_109 , V_110 ) ;
if ( V_111 )
return V_111 ;
if ( V_106 -> V_82 == V_53 && V_29 -> V_94 == NULL ) {
F_41 ( V_29 , V_105 ) ;
return 0 ;
}
return F_45 ( V_29 , V_109 , V_110 ,
V_105 ) ;
}
...
if ( V_29 -> V_81 . V_82 == V_60 && V_68 -> V_112 )
...
{
#if F_61 ( V_138 )
static struct V_139 V_140 [ V_141 ] ;
static char V_142 [ V_141 ] [ 32 ] ;
unsigned V_143 ;
for ( V_143 = 0 ; V_143 < V_141 ; V_143 ++ ) {
if ( V_143 == 0 )
sprintf ( V_142 [ V_143 ] , L_16 ) ;
else
sprintf ( V_142 [ V_143 ] , L_17 ) ;
V_140 [ V_143 ] . V_144 = V_142 [ V_143 ] ;
V_140 [ V_143 ] . V_145 = & F_55 ;
V_140 [ V_143 ] . V_146 = 0 ;
if ( V_143 == 0 )
V_140 [ V_143 ] . V_125 = V_6 -> V_5 . V_3 . V_52 [ V_59 ] . V_147 ;
else
V_140 [ V_143 ] . V_125 = V_6 -> V_5 . V_3 . V_52 [ V_60 ] . V_147 ;
}
return F_62 ( V_6 , V_140 , V_143 ) ;
#else
return 0 ;
#endif
}
