...
V_19 = F_36 ( V_1 -> V_30 , V_90 , V_91 , 1 ) ;
if ( V_19 != 0 )
F_5 ( L_28 , V_19 ) ;
if ( V_88 )
return 0 ;
...
static int
F_39 ( struct V_2 * V_87 , T_5 V_101 , T_5 V_95 ,
...
T_5 V_76 = F_40 ( T_5 , V_103 , V_106 - V_107 ) ;
T_2 V_19 = F_41 ( V_104 , V_102 , V_76 , V_77 + V_107 ) ;
if ( V_19 != V_76 ) {
F_5 ( L_35 , V_19 ) ;
...
static int
F_42 ( struct V_62 * V_63 , T_5 V_101 , T_5 V_95 )
{
void * V_102 ;
int V_109 ;
V_102 = ( void * ) F_43 ( V_8 ) ;
...
V_109 = F_39 ( V_63 -> V_87 , V_101 , V_95 , V_102 , V_110 ) ;
F_44 ( ( unsigned long ) V_102 ) ;
return V_109 ;
}
static T_4
F_45 ( struct V_62 * V_63 , T_5 V_101 , T_5 V_95 )
{
struct V_16 * V_16 = F_1 ( V_63 -> V_87 ) -> V_30 ;
struct V_17 * V_17 = V_16 -> V_31 -> V_32 ;
int V_19 ;
if ( V_63 -> V_87 -> V_39 . V_111 ) {
V_19 = F_42 ( V_63 , V_101 , V_95 ) ;
if ( V_19 )
return V_97 ;
}
if ( F_14 ( V_17 -> V_33 ) ) {
...
static T_4
F_49 ( struct V_62 * V_63 , struct V_66 * V_67 , T_1 V_68 ,
enum V_119 V_120 )
{
struct V_2 * V_3 = V_63 -> V_87 ;
struct V_1 * V_1 = F_1 ( V_3 ) ;
...
T_1 V_127 = V_63 -> V_69 >>
F_50 ( V_3 -> V_39 . V_65 ) ;
V_109 = F_51 ( V_63 , V_63 -> V_78 , V_127 ,
0 , V_63 -> V_124 , 0 ) ;
if ( V_109 )
return V_109 ;
}
...
V_135 = F_53 ( V_130 , V_8 ) ;
if ( ! V_135 )
return - V_9 ;
V_132 = V_135 ;
while ( ( V_133 = F_54 ( & V_135 , L_41 ) ) != NULL ) {
if ( ! * V_133 )
continue;
V_138 = F_55 ( V_133 , V_139 , args ) ;
switch ( V_138 ) {
case V_140 :
if ( F_56 ( V_1 -> V_28 , & args [ 0 ] ,
V_141 ) == 0 ) {
V_19 = - V_20 ;
break;
}
...
static T_2 F_60 ( struct V_2 * V_3 , char * V_145 )
{
struct V_1 * V_1 = F_1 ( V_3 ) ;
T_2 V_146 = 0 ;
...
static T_5 F_61 ( struct V_2 * V_3 )
{
struct V_1 * V_1 = F_1 ( V_3 ) ;
...
V_19 = F_39 ( V_3 , 0 , V_3 -> V_153 -> V_154 ( V_3 ) + 1 ,
V_102 , V_151 ) ;
F_65 ( V_102 ) ;
return V_19 ;
}
...
static T_4
F_67 ( struct V_62 * V_63 )
{
return F_68 ( V_63 , & V_155 ) ;
}
