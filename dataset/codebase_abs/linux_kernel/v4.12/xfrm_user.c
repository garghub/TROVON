...
if ( ! V_363 )
return 0 ;
V_340 ( & V_361 -> V_93 , V_361 -> V_261 , type , V_157 , V_363 , V_362 , V_118 ) ;
return 0 ;
}
static int F_177 ( struct V_142 * V_143 , struct V_144 * V_145 ,
struct V_1 * * V_2 )
...
static inline T_4 F_180 ( int V_348 , int V_365 )
{
return F_92 ( sizeof( struct V_312 ) )
+ ( V_365 ? F_93 ( sizeof( struct V_342 ) ) : 0 )
...
const struct V_366 * V_93 , T_2 V_261 , T_2 type )
{
const struct V_340 * V_367 ;
struct V_312 * V_368 ;
struct V_144 * V_145 ;
int V_284 , V_37 ;
V_145 = F_73 ( V_143 , 0 , 0 , V_369 , sizeof( * V_368 ) , 0 ) ;
if ( V_145 == NULL )
return - V_168 ;
V_368 = F_45 ( V_145 ) ;
memset ( V_368 , 0 , sizeof( * V_368 ) ) ;
memcpy ( & V_368 -> V_93 , V_93 , sizeof( V_368 -> V_93 ) ) ;
V_368 -> V_261 = V_261 ;
if ( V_343 != NULL ) {
...
if ( V_37 )
goto V_324;
for ( V_284 = 0 , V_367 = V_157 ; V_284 < V_348 ; V_284 ++ , V_367 ++ ) {
V_37 = F_178 ( V_367 , V_143 ) ;
if ( V_37 )
goto V_324;
}
F_76 ( V_143 , V_145 ) ;
...
static int F_182 ( const struct V_366 * V_93 , T_2 V_261 , T_2 type ,
const struct V_340 * V_157 , int V_348 ,
const struct V_342 * V_343 )
{
struct V_118 * V_118 = & V_370 ;
struct V_142 * V_143 ;
V_143 = F_85 ( F_180 ( V_348 , ! ! V_343 ) , V_206 ) ;
if ( V_143 == NULL )
return - V_68 ;
if ( F_181 ( V_143 , V_157 , V_348 , V_343 , V_93 , V_261 , type ) < 0 )
F_103 () ;
return F_88 ( V_118 , V_143 , 0 , V_371 ) ;
}
static int F_182 ( const struct V_366 * V_93 , T_2 V_261 , T_2 type ,
const struct V_340 * V_157 , int V_348 ,
const struct V_342 * V_343 )
...
V_37 = F_81 ( V_145 , V_387 [ type ] , V_2 ,
V_375 -> V_388 ? : V_199 ,
V_375 -> V_389 ? : V_202 , V_373 ) ;
if ( V_37 < 0 )
return V_37 ;
if ( V_375 -> V_390 == NULL )
return - V_7 ;
return V_375 -> V_390 ( V_143 , V_145 , V_2 ) ;
}
static void F_188 ( struct V_142 * V_143 )
{
struct V_118 * V_118 = F_44 ( V_143 -> V_146 ) ;
F_189 ( & V_118 -> V_135 . V_391 ) ;
F_190 ( V_143 , & F_183 ) ;
F_191 ( & V_118 -> V_135 . V_391 ) ;
}
...
struct V_144 * V_145 ;
int V_37 ;
V_145 = F_73 ( V_143 , V_148 -> V_152 , 0 , V_392 , sizeof( * V_333 ) , 0 ) ;
if ( V_145 == NULL )
return - V_168 ;
V_333 = F_45 ( V_145 ) ;
...
static int F_194 ( struct V_56 * V_57 , const struct V_147 * V_148 )
{
struct V_118 * V_118 = F_195 ( V_57 ) ;
struct V_142 * V_143 ;
...
return F_88 ( V_118 , V_143 , 0 , V_393 ) ;
}
...
F_103 () ;
return F_88 ( V_118 , V_143 , 0 , V_394 ) ;
}
static int F_197 ( const struct V_147 * V_148 )
{
...
if ( V_143 == NULL )
return - V_68 ;
V_145 = F_73 ( V_143 , V_148 -> V_152 , V_148 -> V_134 , V_395 , sizeof( * V_23 ) , 0 ) ;
if ( V_145 == NULL ) {
F_87 ( V_143 ) ;
return - V_168 ;
}
...
static inline T_4 F_198 ( struct V_56 * V_57 )
{
T_4 V_397 = 0 ;
if ( V_57 -> V_82 )
V_397 += F_93 ( F_8 ( V_57 -> V_82 ) ) ;
if ( V_57 -> V_123 ) {
V_397 += F_93 ( sizeof( struct V_5 ) +
( V_57 -> V_123 -> V_75 + 7 ) / 8 ) ;
V_397 += F_93 ( F_6 ( V_57 -> V_123 ) ) ;
}
if ( V_57 -> V_70 )
V_397 += F_93 ( F_4 ( V_57 -> V_70 ) ) ;
if ( V_57 -> V_125 )
V_397 += F_93 ( sizeof( * V_57 -> V_125 ) ) ;
if ( V_57 -> V_128 )
V_397 += F_93 ( sizeof( * V_57 -> V_128 ) ) ;
if ( V_57 -> V_129 )
V_397 += F_93 ( sizeof( V_57 -> V_129 ) ) ;
if ( V_57 -> V_83 )
V_397 += F_93 ( F_12 ( V_57 -> V_83 ) ) ;
else
V_397 += F_93 ( sizeof( struct V_106 ) ) ;
if ( V_57 -> V_184 )
V_397 += F_93 ( sizeof( struct V_18 ) +
V_57 -> V_184 -> V_21 ) ;
if ( V_57 -> V_130 )
V_397 += F_93 ( sizeof( * V_57 -> V_130 ) ) ;
if ( V_57 -> V_63 . V_122 )
V_397 += F_93 ( sizeof( V_57 -> V_63 . V_122 ) ) ;
if ( V_57 -> V_174 . V_178 )
V_397 += F_93 ( sizeof( V_57 -> V_174 ) ) ;
V_397 += F_158 ( sizeof( V_398 ) ) ;
return V_397 ;
}
static int F_199 ( struct V_56 * V_57 , const struct V_147 * V_148 )
{
struct V_118 * V_118 = F_195 ( V_57 ) ;
struct V_22 * V_23 ;
struct V_155 * V_32 ;
...
if ( V_143 == NULL )
return - V_68 ;
V_145 = F_73 ( V_143 , V_148 -> V_152 , V_148 -> V_134 , V_148 -> V_154 , V_399 , 0 ) ;
V_37 = - V_168 ;
if ( V_145 == NULL )
goto V_401;
V_23 = F_45 ( V_145 ) ;
...
V_166 = F_64 ( V_143 , V_402 , sizeof( * V_23 ) ) ;
V_37 = - V_168 ;
if ( V_166 == NULL )
goto V_401;
V_23 = F_2 ( V_166 ) ;
...
static int F_200 ( struct V_56 * V_57 , const struct V_147 * V_148 )
{
switch ( V_148 -> V_154 ) {
case V_392 :
return F_194 ( V_57 , V_148 ) ;
case V_321 :
return F_196 ( V_57 , V_148 ) ;
case V_400 :
case V_403 :
case V_150 :
return F_199 ( V_57 , V_148 ) ;
case V_395 :
return F_197 ( V_148 ) ;
default:
F_201 ( V_404 L_1 ,
...
static inline T_4 F_202 ( struct V_56 * V_57 ,
struct V_278 * V_280 )
{
...
static int F_203 ( struct V_142 * V_143 , struct V_56 * V_57 ,
struct V_286 * V_405 , struct V_278 * V_280 )
{
V_87 V_134 = F_204 () ;
struct V_334 * V_335 ;
struct V_144 * V_145 ;
int V_37 ;
V_145 = F_73 ( V_143 , 0 , 0 , V_406 , sizeof( * V_335 ) , 0 ) ;
if ( V_145 == NULL )
return - V_168 ;
V_335 = F_45 ( V_145 ) ;
...
V_335 -> V_291 = V_405 -> V_291 ;
V_335 -> V_292 = V_405 -> V_292 ;
V_335 -> V_293 = V_405 -> V_293 ;
...
static int F_205 ( struct V_56 * V_57 , struct V_286 * V_405 ,
struct V_278 * V_280 )
{
struct V_118 * V_118 = F_195 ( V_57 ) ;
struct V_142 * V_143 ;
V_143 = F_85 ( F_202 ( V_57 , V_280 ) , V_206 ) ;
if ( V_143 == NULL )
return - V_68 ;
if ( F_203 ( V_143 , V_57 , V_405 , V_280 ) < 0 )
F_103 () ;
return F_88 ( V_118 , V_143 , 0 , V_407 ) ;
}
static struct V_278 * F_206 ( struct V_196 * V_146 , int V_408 ,
...
static inline T_4 F_207 ( struct V_278 * V_280 )
{
...
static int F_208 ( struct V_142 * V_143 , struct V_278 * V_280 ,
...
struct V_144 * V_145 ;
int V_37 ;
V_145 = F_73 ( V_143 , V_148 -> V_152 , 0 , V_414 , sizeof( * V_413 ) , 0 ) ;
if ( V_145 == NULL )
return - V_168 ;
V_413 = F_45 ( V_145 ) ;
F_129 ( V_280 , & V_413 -> V_279 , V_261 ) ;
V_37 = F_139 ( V_280 , V_143 ) ;
if ( ! V_37 )
V_37 = F_141 ( V_280 , V_143 ) ;
if ( ! V_37 )
...
static int F_209 ( struct V_278 * V_280 , int V_261 , const struct V_147 * V_148 )
{
struct V_118 * V_118 = F_210 ( V_280 ) ;
struct V_142 * V_143 ;
V_143 = F_85 ( F_207 ( V_280 ) , V_206 ) ;
if ( V_143 == NULL )
return - V_68 ;
if ( F_208 ( V_143 , V_280 , V_261 , V_148 ) < 0 )
F_103 () ;
return F_88 ( V_118 , V_143 , 0 , V_393 ) ;
}
...
V_166 = F_64 ( V_143 , V_415 , sizeof( * V_23 ) ) ;
V_37 = - V_168 ;
if ( V_166 == NULL )
goto V_401;
V_23 = F_2 ( V_166 ) ;
...
goto V_401;
F_76 ( V_143 , V_145 ) ;
return F_88 ( V_118 , V_143 , 0 , V_416 ) ;
V_401:
F_87 ( V_143 ) ;
return V_37 ;
}
static int F_212 ( const struct V_147 * V_148 )
{
struct V_118 * V_118 = V_148 -> V_118 ;
struct V_144 * V_145 ;
struct V_142 * V_143 ;
...
if ( V_143 == NULL )
return - V_68 ;
V_145 = F_73 ( V_143 , V_148 -> V_152 , V_148 -> V_134 , V_417 , 0 , 0 ) ;
V_37 = - V_168 ;
if ( V_145 == NULL )
goto V_401;
...
return F_212 ( V_148 ) ;
case V_414 :
return F_209 ( V_280 , V_261 , V_148 ) ;
default:
F_201 ( V_404 L_2 ,
V_148 -> V_154 ) ;
}
...
{
return F_92 ( sizeof( struct V_419 ) ) ;
}
static int F_215 ( struct V_142 * V_143 , T_2 V_33 ,
struct V_366 * V_93 , T_1 * V_420 )
{
struct V_419 * V_421 ;
struct V_144 * V_145 ;
V_145 = F_73 ( V_143 , 0 , 0 , V_422 , sizeof( * V_421 ) , 0 ) ;
if ( V_145 == NULL )
return - V_168 ;
V_421 = F_45 ( V_145 ) ;
V_421 -> V_33 = V_33 ;
memcpy ( & V_421 -> V_93 , V_93 , sizeof( V_421 -> V_93 ) ) ;
if ( V_420 ) {
int V_37 = F_69 ( V_143 , V_52 , sizeof( * V_420 ) , V_420 ) ;
if ( V_37 ) {
F_75 ( V_143 , V_145 ) ;
return V_37 ;
}
...
static int F_216 ( struct V_118 * V_118 , T_2 V_33 ,
struct V_366 * V_93 , T_1 * V_420 )
{
struct V_142 * V_143 ;
V_143 = F_85 ( F_214 () , V_206 ) ;
if ( V_143 == NULL )
return - V_68 ;
if ( F_215 ( V_143 , V_33 , V_93 , V_420 ) < 0 )
F_103 () ;
return F_88 ( V_118 , V_143 , 0 , V_423 ) ;
}
static inline T_4 F_217 ( void )
{
return F_92 ( sizeof( struct V_424 ) ) ;
}
static int F_218 ( struct V_142 * V_143 , struct V_56 * V_57 ,
T_1 * V_358 , T_6 V_425 )
{
struct V_424 * V_347 ;
struct V_144 * V_145 ;
V_145 = F_73 ( V_143 , 0 , 0 , V_426 , sizeof( * V_347 ) , 0 ) ;
if ( V_145 == NULL )
return - V_168 ;
V_347 = F_45 ( V_145 ) ;
...
V_347 -> V_425 = V_425 ;
V_347 -> V_427 = V_57 -> V_128 -> V_428 ;
V_347 -> V_95 = V_57 -> V_63 . V_95 ;
F_76 ( V_143 , V_145 ) ;
return 0 ;
}
static int F_219 ( struct V_56 * V_57 , T_1 * V_429 ,
T_6 V_430 )
{
struct V_118 * V_118 = F_195 ( V_57 ) ;
struct V_142 * V_143 ;
...
if ( ! V_57 -> V_128 )
return - V_7 ;
V_143 = F_85 ( F_217 () , V_206 ) ;
if ( V_143 == NULL )
return - V_68 ;
if ( F_218 ( V_143 , V_57 , V_429 , V_430 ) < 0 )
F_103 () ;
return F_88 ( V_118 , V_143 , 0 , V_431 ) ;
}
static bool F_220 ( const struct V_147 * V_148 )
{
return ( bool ) F_221 ( V_148 -> V_118 ) ;
}
static int T_7 F_222 ( struct V_118 * V_118 )
{
struct V_196 * V_209 ;
struct V_432 V_433 = {
. V_434 = V_435 ,
...
V_209 = F_223 ( V_118 , V_437 , & V_433 ) ;
if ( V_209 == NULL )
return - V_68 ;
V_118 -> V_135 . V_438 = V_209 ;
F_224 ( V_118 -> V_135 . V_209 , V_209 ) ;
return 0 ;
}
static void T_8 F_225 ( struct V_439 * V_440 )
{
struct V_118 * V_118 ;
F_226 (net, net_exit_list, exit_list)
F_227 ( V_118 -> V_135 . V_209 , NULL ) ;
F_228 () ;
F_226 (net, net_exit_list, exit_list)
F_229 ( V_118 -> V_135 . V_438 ) ;
}
