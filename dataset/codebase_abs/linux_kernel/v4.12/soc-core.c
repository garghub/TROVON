...
int F_135 ( struct V_63 * V_50 , const char * V_215 )
{
const char * V_216 , * V_217 , * V_218 , * V_219 ;
T_1 V_220 = sizeof( V_50 -> V_88 -> V_221 ) ;
T_1 V_8 ;
if ( V_50 -> V_222 )
return 0 ;
V_216 = F_136 ( V_223 ) ;
...
snprintf ( V_50 -> V_224 , sizeof( V_50 -> V_88 -> V_221 ) ,
L_51 , V_216 ) ;
F_134 ( V_50 -> V_224 ) ;
V_217 = F_136 ( V_225 ) ;
if ( V_217 ) {
V_8 = strlen ( V_50 -> V_224 ) ;
snprintf ( V_50 -> V_224 + V_8 ,
V_220 - V_8 ,
L_67 , V_217 ) ;
V_8 ++ ;
if ( V_8 < V_220 )
F_134 ( V_50 -> V_224 + V_8 ) ;
V_218 = F_136 ( V_226 ) ;
if ( V_218 ) {
V_8 = strlen ( V_50 -> V_224 ) ;
snprintf ( V_50 -> V_224 + V_8 ,
...
V_50 -> V_222 = V_50 -> V_224 ;
return 0 ;
}
static int F_137 ( struct V_63 * V_50 )
{
struct V_4 * V_5 ;
struct V_26 * V_27 ;
struct V_77 * V_71 ;
int V_14 , V_3 , V_144 ;
F_35 ( & V_58 ) ;
F_138 ( & V_50 -> V_228 , V_229 ) ;
for ( V_3 = 0 ; V_3 < V_50 -> V_230 ; V_3 ++ ) {
...
V_14 = F_139 ( V_50 -> V_23 , V_233 , V_234 ,
...
#endif
#ifdef F_140
F_141 ( & V_50 -> V_113 , F_73 ) ;
#endif
if ( V_50 -> V_167 )
F_101 ( & V_50 -> V_105 , V_50 -> V_167 ,
V_50 -> V_168 ) ;
if ( V_50 -> V_235 )
F_101 ( & V_50 -> V_105 , V_50 -> V_235 ,
V_50 -> V_236 ) ;
if ( V_50 -> V_170 ) {
...
F_143 ( V_50 ) ;
if ( V_50 -> V_173 )
F_144 ( V_50 , V_50 -> V_173 , V_50 -> V_174 ) ;
if ( V_50 -> V_175 )
F_105 ( & V_50 -> V_105 , V_50 -> V_175 ,
V_50 -> V_176 ) ;
if ( V_50 -> V_239 )
F_105 ( & V_50 -> V_105 , V_50 -> V_239 ,
V_50 -> V_240 ) ;
F_135 ( V_50 , NULL ) ;
snprintf ( V_50 -> V_88 -> V_241 , sizeof( V_50 -> V_88 -> V_241 ) ,
L_51 , V_50 -> V_53 ) ;
snprintf ( V_50 -> V_88 -> V_221 , sizeof( V_50 -> V_88 -> V_221 ) ,
L_51 , V_50 -> V_222 ? V_50 -> V_222 : V_50 -> V_53 ) ;
snprintf ( V_50 -> V_88 -> V_10 , sizeof( V_50 -> V_88 -> V_10 ) ,
L_51 , V_50 -> V_242 ? V_50 -> V_242 : V_50 -> V_53 ) ;
for ( V_3 = 0 ; V_3 < F_145 ( V_50 -> V_88 -> V_10 ) ; V_3 ++ ) {
...
static int F_149 ( struct V_245 * V_246 )
{
struct V_63 * V_50 = F_150 ( V_246 ) ;
if ( ! V_50 )
return - V_15 ;
F_26 ( & V_246 -> V_23 ,
L_73 ,
V_50 -> V_53 ) ;
V_50 -> V_23 = & V_246 -> V_23 ;
return F_151 ( V_50 ) ;
}
static int F_152 ( struct V_63 * V_50 )
{
struct V_26 * V_27 ;
F_36 (rtd, &card->rtd_list, list)
F_66 ( & V_27 -> V_101 ) ;
...
struct V_247 * F_157 ( const struct V_248 * V_249 ,
void * V_250 , const char * V_222 ,
const char * V_251 )
{
struct V_248 V_252 ;
struct V_247 * V_253 ;
char * V_53 = NULL ;
memcpy ( & V_252 , V_249 , sizeof( V_252 ) ) ;
V_252 . V_254 = 0 ;
if ( ! V_222 )
V_222 = V_252 . V_53 ;
if ( V_251 ) {
V_53 = F_24 ( V_40 , L_74 , V_251 , V_222 ) ;
if ( ! V_53 )
return NULL ;
V_252 . V_53 = V_53 ;
} else {
...
V_253 = F_158 ( & V_252 , V_250 ) ;
F_16 ( V_53 ) ;
return V_253 ;
}
static int F_159 ( struct V_88 * V_50 , struct V_22 * V_23 ,
const struct V_248 * V_173 , int V_174 ,
const char * V_251 , void * V_250 )
{
int V_145 , V_3 ;
for ( V_3 = 0 ; V_3 < V_174 ; V_3 ++ ) {
const struct V_248 * V_255 = & V_173 [ V_3 ] ;
V_145 = F_160 ( V_50 , F_157 ( V_255 , V_250 ,
V_255 -> V_53 , V_251 ) ) ;
if ( V_145 < 0 ) {
F_78 ( V_23 , L_75 ,
V_255 -> V_53 , V_145 ) ;
...
struct V_247 * F_161 ( struct V_63 * V_256 ,
const char * V_53 )
{
struct V_88 * V_50 = V_256 -> V_88 ;
struct V_247 * V_257 ;
if ( F_162 ( ! V_53 ) )
return NULL ;
F_36 (kctl, &card->controls, list)
if ( ! strncmp ( V_257 -> V_129 . V_53 , V_53 , sizeof( V_257 -> V_129 . V_53 ) ) )
return V_257 ;
return NULL ;
}
int F_104 ( struct V_48 * V_49 ,
const struct V_248 * V_173 , unsigned int V_174 )
{
struct V_88 * V_50 = V_49 -> V_50 -> V_88 ;
return F_159 ( V_50 , V_49 -> V_23 , V_173 ,
...
int F_164 ( struct V_61 * V_62 ,
const struct V_248 * V_173 , unsigned int V_174 )
{
return F_104 ( & V_62 -> V_49 , V_173 ,
V_174 ) ;
}
int F_144 ( struct V_63 * V_256 ,
const struct V_248 * V_173 , int V_174 )
{
struct V_88 * V_50 = V_256 -> V_88 ;
return F_159 ( V_50 , V_256 -> V_23 , V_173 , V_174 ,
NULL , V_256 ) ;
}
int F_165 ( struct V_59 * V_60 ,
const struct V_248 * V_173 , int V_174 )
{
struct V_88 * V_50 = V_60 -> V_49 -> V_50 -> V_88 ;
return F_159 ( V_50 , V_60 -> V_23 , V_173 , V_174 ,
NULL , V_60 ) ;
}
int F_166 ( struct V_59 * V_60 , int V_258 ,
unsigned int V_259 , int V_260 )
{
if ( V_60 -> V_10 && V_60 -> V_10 -> V_94 -> V_261 )
return V_60 -> V_10 -> V_94 -> V_261 ( V_60 , V_258 , V_259 , V_260 ) ;
else if ( V_60 -> V_5 && V_60 -> V_5 -> V_10 -> V_261 )
return V_60 -> V_5 -> V_10 -> V_261 ( V_60 -> V_5 , V_258 , 0 ,
V_259 , V_260 ) ;
else
return - V_208 ;
}
int F_167 ( struct V_4 * V_5 , int V_258 ,
int V_192 , unsigned int V_259 , int V_260 )
{
if ( V_5 -> V_10 -> V_261 )
return V_5 -> V_10 -> V_261 ( V_5 , V_258 , V_192 ,
V_259 , V_260 ) ;
else
return - V_208 ;
}
int F_168 ( struct V_59 * V_60 ,
int V_262 , int div )
{
if ( V_60 -> V_10 && V_60 -> V_10 -> V_94 -> V_263 )
return V_60 -> V_10 -> V_94 -> V_263 ( V_60 , V_262 , div ) ;
else
return - V_15 ;
}
int F_169 ( struct V_59 * V_60 , int V_264 , int V_192 ,
unsigned int V_265 , unsigned int V_266 )
{
if ( V_60 -> V_10 && V_60 -> V_10 -> V_94 -> V_267 )
return V_60 -> V_10 -> V_94 -> V_267 ( V_60 , V_264 , V_192 ,
V_265 , V_266 ) ;
else if ( V_60 -> V_5 && V_60 -> V_5 -> V_10 -> V_267 )
return V_60 -> V_5 -> V_10 -> V_267 ( V_60 -> V_5 , V_264 , V_192 ,
V_265 , V_266 ) ;
else
return - V_15 ;
}
int F_170 ( struct V_4 * V_5 , int V_264 , int V_192 ,
unsigned int V_265 , unsigned int V_266 )
{
if ( V_5 -> V_10 -> V_267 )
return V_5 -> V_10 -> V_267 ( V_5 , V_264 , V_192 ,
V_265 , V_266 ) ;
else
return - V_15 ;
}
int F_171 ( struct V_59 * V_60 , unsigned int V_268 )
{
if ( V_60 -> V_10 && V_60 -> V_10 -> V_94 -> V_269 )
return V_60 -> V_10 -> V_94 -> V_269 ( V_60 , V_268 ) ;
else
return - V_15 ;
}
int F_133 ( struct V_59 * V_60 , unsigned int V_270 )
{
if ( V_60 -> V_10 == NULL )
return - V_15 ;
if ( V_60 -> V_10 -> V_94 -> V_271 == NULL )
return - V_208 ;
return V_60 -> V_10 -> V_94 -> V_271 ( V_60 , V_270 ) ;
}
static int F_172 ( unsigned int V_272 ,
unsigned int * V_273 ,
unsigned int * V_274 )
{
if ( * V_273 || * V_274 )
...
unsigned int V_273 , unsigned int V_274 , int V_272 , int V_275 )
{
if ( V_60 -> V_10 && V_60 -> V_10 -> V_94 -> V_276 )
V_60 -> V_10 -> V_94 -> V_276 ( V_272 ,
& V_273 , & V_274 ) ;
else
F_172 ( V_272 , & V_273 , & V_274 ) ;
V_60 -> V_273 = V_273 ;
V_60 -> V_274 = V_274 ;
if ( V_60 -> V_10 && V_60 -> V_10 -> V_94 -> V_277 )
return V_60 -> V_10 -> V_94 -> V_277 ( V_60 , V_273 , V_274 ,
V_272 , V_275 ) ;
else
return - V_208 ;
}
...
{
if ( V_60 -> V_10 && V_60 -> V_10 -> V_94 -> V_282 )
return V_60 -> V_10 -> V_94 -> V_282 ( V_60 , V_278 , V_279 ,
V_280 , V_281 ) ;
else
return - V_15 ;
}
int F_175 ( struct V_59 * V_60 , int V_283 )
{
if ( V_60 -> V_10 && V_60 -> V_10 -> V_94 -> V_284 )
return V_60 -> V_10 -> V_94 -> V_284 ( V_60 , V_283 ) ;
else
return - V_15 ;
}
...
if ( ! V_60 -> V_10 )
return - V_208 ;
if ( V_60 -> V_10 -> V_94 -> V_287 )
return V_60 -> V_10 -> V_94 -> V_287 ( V_60 , V_285 , V_286 ) ;
else if ( V_286 == V_102 &&
V_60 -> V_10 -> V_94 -> V_95 )
return V_60 -> V_10 -> V_94 -> V_95 ( V_60 , V_285 ) ;
else
return - V_208 ;
}
int F_151 ( struct V_63 * V_50 )
{
int V_3 , V_14 ;
struct V_26 * V_27 ;
...
static char * F_178 ( struct V_22 * V_23 , int * V_129 )
{
char * V_291 , V_53 [ V_292 ] ;
int V_293 , V_294 ;
if ( V_164 ( V_23 ) == NULL )
return NULL ;
F_179 ( V_53 , V_164 ( V_23 ) , V_292 ) ;
V_291 = strstr ( V_53 , V_23 -> V_10 -> V_53 ) ;
if ( V_291 ) {
if ( sscanf ( & V_291 [ strlen ( V_23 -> V_10 -> V_53 ) ] , L_78 , V_129 ) == 1 ) {
if ( * V_129 == - 1 )
V_291 [ strlen ( V_23 -> V_10 -> V_53 ) ] = '\0' ;
}
} else {
if ( sscanf ( V_53 , L_79 , & V_293 , & V_294 ) == 2 ) {
char V_295 [ V_292 ] ;
* V_129 = ( ( V_293 & 0xffff ) << 16 ) + V_294 ;
snprintf ( V_295 , V_292 , L_80 , V_23 -> V_10 -> V_53 , V_53 ) ;
F_179 ( V_53 , V_295 , V_292 ) ;
} else
* V_129 = 0 ;
}
return F_180 ( V_53 , V_40 ) ;
}
static inline char * F_181 ( struct V_22 * V_23 ,
struct V_92 * V_296 )
{
if ( V_296 -> V_53 == NULL ) {
F_78 ( V_23 ,
...
return F_180 ( V_296 -> V_53 , V_40 ) ;
}
static void F_182 ( struct V_48 * V_49 )
{
struct V_59 * V_60 , * V_297 ;
...
static struct V_59 * F_183 ( struct V_48 * V_49 ,
struct V_92 * V_296 ,
bool V_298 )
{
...
return NULL ;
if ( V_298 &&
( V_296 -> V_129 == 0 || V_296 -> V_53 == NULL ) ) {
V_60 -> V_53 = F_178 ( V_23 , & V_60 -> V_129 ) ;
} else {
V_60 -> V_53 = F_181 ( V_23 , V_296 ) ;
if ( V_296 -> V_129 )
V_60 -> V_129 = V_296 -> V_129 ;
else
V_60 -> V_129 = V_49 -> V_299 ;
}
if ( V_60 -> V_53 == NULL ) {
F_16 ( V_60 ) ;
return NULL ;
...
V_60 -> V_10 = V_296 ;
if ( ! V_60 -> V_10 -> V_94 )
V_60 -> V_10 -> V_94 = & V_300 ;
F_106 ( & V_60 -> V_80 , & V_49 -> V_301 ) ;
V_49 -> V_299 ++ ;
F_49 ( V_23 , L_84 , V_60 -> V_53 ) ;
return V_60 ;
}
static int F_184 ( struct V_48 * V_49 ,
struct V_92 * V_296 , T_1 V_16 ,
bool V_298 )
{
struct V_22 * V_23 = V_49 -> V_23 ;
struct V_59 * V_60 ;
...
struct V_59 * V_60 ;
int V_14 ;
if ( V_296 -> V_151 . type != V_302 ) {
F_78 ( V_49 -> V_23 , L_86 ,
V_296 -> V_151 . type ) ;
return - V_15 ;
}
F_80 ( & V_58 ) ;
V_60 = F_183 ( V_49 , V_296 , false ) ;
if ( ! V_60 )
return - V_41 ;
V_14 = F_102 ( V_105 , V_60 ) ;
if ( V_14 != 0 ) {
...
static void F_186 ( struct V_106 * V_105 ,
enum V_303 type , int V_304 )
{
struct V_48 * V_49 = V_105 -> V_49 ;
V_49 -> V_10 -> V_305 ( V_49 , type , V_304 ) ;
}
static int F_187 ( struct V_106 * V_105 ,
int V_306 )
{
struct V_48 * V_49 = V_105 -> V_49 ;
return V_49 -> V_10 -> V_307 ( V_49 , V_306 ) ;
}
static int F_188 ( struct V_48 * V_49 ,
const struct V_308 * V_10 , struct V_22 * V_23 )
{
struct V_106 * V_105 ;
V_49 -> V_53 = F_178 ( V_23 , & V_49 -> V_129 ) ;
if ( ! V_49 -> V_53 ) {
F_78 ( V_23 , L_87 ) ;
return - V_41 ;
}
...
V_49 -> V_189 = V_49 -> V_10 -> V_189 ;
V_49 -> V_309 = V_49 -> V_10 -> V_309 ;
V_105 = & V_49 -> V_105 ;
V_105 -> V_23 = V_23 ;
V_105 -> V_49 = V_49 ;
V_105 -> V_171 = V_110 ;
...
static void F_189 ( struct V_48 * V_49 )
{
int V_311 = F_190 ( V_49 -> V_111 ) ;
if ( V_311 > 0 )
V_49 -> V_311 = V_311 ;
}
void F_191 ( struct V_48 * V_49 ,
struct V_111 * V_111 )
{
V_49 -> V_111 = V_111 ;
F_189 ( V_49 ) ;
...
{
if ( ! V_49 -> V_312 && ! V_49 -> V_313 ) {
if ( ! V_49 -> V_111 )
V_49 -> V_111 = F_195 ( V_49 -> V_23 , NULL ) ;
if ( V_49 -> V_111 )
F_189 ( V_49 ) ;
}
F_106 ( & V_49 -> V_80 , & V_314 ) ;
F_113 ( & V_49 -> V_289 ) ;
}
...
int F_199 ( struct V_22 * V_23 ,
const struct V_308 * V_315 ,
struct V_92 * V_296 ,
int V_299 )
{
struct V_48 * V_316 ;
int V_14 ;
V_316 = F_51 ( sizeof( * V_316 ) , V_40 ) ;
if ( ! V_316 ) {
F_78 ( V_23 , L_88 ) ;
return - V_41 ;
}
V_14 = F_188 ( V_316 , V_315 , V_23 ) ;
if ( V_14 )
goto V_317;
V_316 -> V_318 = true ;
V_316 -> V_319 = true ;
V_14 = F_184 ( V_316 , V_296 , V_299 , true ) ;
if ( V_14 < 0 ) {
F_78 ( V_23 , L_89 , V_14 ) ;
goto V_320;
}
...
void F_200 ( struct V_22 * V_23 )
{
struct V_48 * V_316 ;
F_35 ( & V_58 ) ;
F_36 (cmpnt, &component_list, list) {
if ( V_23 == V_316 -> V_23 && V_316 -> V_319 )
goto V_291;
}
F_37 ( & V_58 ) ;
return;
...
static int F_205 ( struct V_26 * V_27 )
{
struct V_61 * V_62 = V_27 -> V_62 ;
if ( V_62 -> V_10 -> V_189 )
return V_62 -> V_10 -> V_189 ( V_27 ) ;
else
return 0 ;
}
static void F_206 ( struct V_322 * V_74 )
{
struct V_26 * V_27 = V_74 -> V_39 ;
struct V_61 * V_62 = V_27 -> V_62 ;
if ( V_62 -> V_10 -> V_309 )
V_62 -> V_10 -> V_309 ( V_74 ) ;
}
int F_207 ( struct V_22 * V_23 , struct V_61 * V_62 ,
const struct V_323 * V_324 )
{
int V_14 ;
V_14 = F_188 ( & V_62 -> V_49 ,
& V_324 -> V_325 , V_23 ) ;
if ( V_14 )
return V_14 ;
V_62 -> V_23 = V_23 ;
V_62 -> V_10 = V_324 ;
if ( V_324 -> V_170 )
V_62 -> V_49 . V_170 = F_202 ;
if ( V_324 -> remove )
V_62 -> V_49 . remove = F_204 ;
if ( V_324 -> V_189 )
V_62 -> V_49 . V_189 = F_205 ;
if ( V_324 -> V_309 )
V_62 -> V_49 . V_309 = F_206 ;
#ifdef F_123
V_62 -> V_49 . V_52 = L_90 ;
#endif
F_35 ( & V_58 ) ;
...
if ( V_62 == NULL )
return - V_41 ;
V_14 = F_207 ( V_23 , V_62 , V_324 ) ;
if ( V_14 )
F_16 ( V_62 ) ;
return V_14 ;
}
void F_209 ( struct V_61 * V_62 )
{
F_35 ( & V_58 ) ;
F_57 ( & V_62 -> V_80 ) ;
F_198 ( & V_62 -> V_49 ) ;
...
struct V_61 * F_210 ( struct V_22 * V_23 )
{
struct V_61 * V_62 ;
F_35 ( & V_58 ) ;
F_36 (platform, &platform_list, list) {
...
static void F_212 ( struct V_327 * V_72 )
{
int V_3 ;
for ( V_3 = 0 ; V_3 < F_145 ( V_328 ) ; V_3 ++ )
...
static void F_214 ( struct V_48 * V_49 )
{
struct V_4 * V_5 = F_32 ( V_49 ) ;
V_5 -> V_10 -> remove ( V_5 ) ;
}
...
{
struct V_4 * V_5 = F_32 ( V_49 ) ;
return V_5 -> V_10 -> V_312 ( V_5 , V_6 , V_1 ) ;
}
static int F_218 ( struct V_48 * V_49 ,
unsigned int V_6 , unsigned int * V_1 )
{
struct V_4 * V_5 = F_32 ( V_49 ) ;
* V_1 = V_5 -> V_10 -> V_313 ( V_5 , V_6 ) ;
return 0 ;
}
static int F_219 ( struct V_106 * V_105 ,
enum V_330 V_331 )
{
struct V_4 * V_5 = F_220 ( V_105 ) ;
return V_5 -> V_10 -> V_332 ( V_5 , V_331 ) ;
}
int F_221 ( struct V_22 * V_23 ,
...
goto V_317;
if ( V_334 -> V_170 )
V_5 -> V_49 . V_170 = F_213 ;
if ( V_334 -> remove )
V_5 -> V_49 . remove = F_214 ;
if ( V_334 -> V_99 )
V_5 -> V_49 . V_99 = F_215 ;
if ( V_334 -> V_116 )
V_5 -> V_49 . V_116 = F_216 ;
if ( V_334 -> V_312 )
V_5 -> V_49 . V_312 = F_217 ;
if ( V_334 -> V_313 )
V_5 -> V_49 . V_313 = F_218 ;
V_5 -> V_49 . V_318 = V_334 -> V_318 ;
V_105 = F_222 ( V_5 ) ;
V_105 -> V_109 = V_334 -> V_109 ;
V_105 -> V_335 = V_334 -> V_335 ;
if ( V_334 -> V_305 )
V_105 -> V_305 = V_334 -> V_305 ;
if ( V_334 -> V_332 )
V_105 -> V_332 = F_219 ;
V_5 -> V_23 = V_23 ;
V_5 -> V_10 = V_334 ;
V_5 -> V_49 . V_311 = V_334 -> V_13 ;
#ifdef F_123
V_5 -> V_49 . V_55 = F_31 ;
V_5 -> V_49 . V_52 = L_95 ;
#endif
...
F_212 ( & V_296 [ V_3 ] . V_337 ) ;
F_212 ( & V_296 [ V_3 ] . V_338 ) ;
}
V_14 = F_184 ( & V_5 -> V_49 , V_296 , V_299 , false ) ;
if ( V_14 < 0 ) {
F_78 ( V_23 , L_89 , V_14 ) ;
goto V_320;
}
...
V_14 = F_227 ( V_341 , V_340 , 0 , & V_50 -> V_53 ) ;
if ( V_14 < 0 && V_14 != - V_15 ) {
F_78 ( V_50 -> V_23 ,
L_99 ,
V_340 , V_14 ) ;
...
int F_228 ( struct V_63 * V_50 ,
const char * V_340 )
{
struct V_122 * V_341 = V_50 -> V_23 -> V_123 ;
struct V_190 * V_343 ;
const char * V_252 , * V_344 ;
int V_3 , V_119 , V_345 , V_14 ;
V_345 = F_229 ( V_341 , V_340 ) ;
if ( V_345 < 0 ) {
F_78 ( V_50 -> V_23 ,
L_100 , V_340 ) ;
return - V_15 ;
...
V_343 = F_230 ( V_50 -> V_23 , V_345 , sizeof( * V_343 ) ,
V_40 ) ;
if ( ! V_343 ) {
F_78 ( V_50 -> V_23 ,
L_103 ) ;
...
for ( V_119 = 0 ; V_119 < F_145 ( V_346 ) ; V_119 ++ ) {
if ( ! strncmp ( V_252 , V_346 [ V_119 ] . V_53 ,
strlen ( V_346 [ V_119 ] . V_53 ) ) ) {
V_343 [ V_3 ] = V_346 [ V_119 ] ;
break;
}
}
if ( V_119 >= F_145 ( V_346 ) ) {
F_78 ( V_50 -> V_23 ,
L_105 ,
V_252 ) ;
return - V_15 ;
...
static int F_231 ( struct V_122 * V_341 ,
const char * V_347 ,
unsigned int * V_348 )
{
T_6 V_1 ;
const T_7 * V_349 = F_232 ( V_341 , V_347 , & V_1 ) ;
int V_3 ;
if ( ! V_349 )
return 0 ;
V_1 /= sizeof( T_6 ) ;
...
int V_14 ;
if ( V_273 )
F_231 ( V_341 , L_106 , V_273 ) ;
if ( V_274 )
F_231 ( V_341 , L_107 , V_274 ) ;
if ( F_235 ( V_341 , L_108 ) ) {
V_14 = F_236 ( V_341 , L_108 , & V_1 ) ;
if ( V_14 )
return V_14 ;
if ( V_272 )
* V_272 = V_1 ;
}
if ( F_235 ( V_341 , L_109 ) ) {
V_14 = F_236 ( V_341 , L_109 , & V_1 ) ;
if ( V_14 )
return V_14 ;
if ( V_275 )
* V_275 = V_1 ;
...
unsigned int F_240 ( struct V_122 * V_341 ,
const char * V_251 ,
struct V_122 * * V_354 ,
struct V_122 * * V_355 )
{
...
if ( ! V_251 )
V_251 = L_122 ;
snprintf ( V_356 , sizeof( V_356 ) , L_123 , V_251 ) ;
V_14 = F_238 ( V_341 , V_356 , & V_350 ) ;
if ( V_14 == 0 ) {
for ( V_3 = 0 ; V_3 < F_145 ( V_360 ) ; V_3 ++ ) {
...
snprintf ( V_356 , sizeof( V_356 ) , L_124 , V_251 ) ;
if ( F_235 ( V_341 , V_356 ) )
V_357 |= V_370 ;
else
V_357 |= V_371 ;
snprintf ( V_356 , sizeof( V_356 ) , L_125 , V_251 ) ;
V_358 = ! ! F_232 ( V_341 , V_356 , NULL ) ;
snprintf ( V_356 , sizeof( V_356 ) , L_126 , V_251 ) ;
V_359 = ! ! F_232 ( V_341 , V_356 , NULL ) ;
...
snprintf ( V_356 , sizeof( V_356 ) , L_127 , V_251 ) ;
V_358 = ! ! F_232 ( V_341 , V_356 , NULL ) ;
if ( V_358 && V_354 )
* V_354 = F_241 ( V_341 , V_356 , 0 ) ;
snprintf ( V_356 , sizeof( V_356 ) , L_128 , V_251 ) ;
V_359 = ! ! F_232 ( V_341 , V_356 , NULL ) ;
if ( V_359 && V_355 )
* V_355 = F_241 ( V_341 , V_356 , 0 ) ;
switch ( ( V_358 << 4 ) + V_359 ) {
case 0x11 :
V_357 |= V_211 ;
break;
...
if ( V_129 < 0 || V_129 >= V_17 -> V_299 ) {
V_14 = - V_15 ;
continue;
}
V_14 = 0 ;
* V_128 = V_17 -> V_296 [ V_129 ] . V_53 ;
if ( ! * V_128 )
* V_128 = V_17 -> V_53 ;
}
break;
...
int F_243 ( struct V_122 * V_123 ,
const char * * V_128 )
{
struct V_375 args ;
int V_14 ;
V_14 = F_244 ( V_123 , L_129 ,
L_130 , 0 , & args ) ;
if ( V_14 )
return V_14 ;
V_14 = F_242 ( & args , V_128 ) ;
F_245 ( args . V_341 ) ;
return V_14 ;
}
int F_246 ( struct V_22 * V_23 ,
struct V_122 * V_123 ,
struct V_77 * V_71 )
{
struct V_375 args ;
...
V_71 -> V_133 = V_49 ;
V_71 -> V_79 = V_79 ;
for ( V_254 = 0 , V_49 = V_71 -> V_133 ;
V_254 < V_71 -> V_79 ;
V_254 ++ , V_49 ++ ) {
V_14 = F_244 ( V_123 , V_53 ,
L_130 ,
V_254 , & args ) ;
if ( V_14 )
goto V_145;
V_49 -> V_123 = args . V_341 ;
V_14 = F_242 ( & args , & V_49 -> V_128 ) ;
if ( V_14 < 0 )
goto V_145;
}
return 0 ;
