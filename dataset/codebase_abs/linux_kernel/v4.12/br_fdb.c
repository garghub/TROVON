...
int F_107 ( struct V_109 * V_110 , struct V_151 * V_152 [] ,
struct V_73 * V_33 ,
...
int F_112 ( struct V_109 * V_110 , struct V_151 * V_152 [] ,
struct V_73 * V_33 ,
const unsigned char * V_25 , T_4 V_17 )
{
struct V_45 * V_46 ;
...
V_30 = - V_146 ;
V_30 &= F_111 ( V_7 , V_32 , V_25 , 0 ) ;
if ( ! V_46 || ! V_46 -> V_57 )
return V_30 ;
F_27 (v, &vg->vlan_list, vlist) {
if ( ! F_44 ( V_48 ) )
continue;
V_30 &= F_111 ( V_7 , V_32 , V_25 , V_48 -> V_17 ) ;
}
}
return V_30 ;
}
int F_113 ( struct V_6 * V_7 , struct V_31 * V_32 )
{
...
void F_115 ( struct V_6 * V_7 , struct V_31 * V_32 )
{
struct V_2 * V_11 ;
int V_54 ;
F_26 () ;
