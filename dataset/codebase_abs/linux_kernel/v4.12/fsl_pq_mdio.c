...
snprintf ( V_55 -> V_44 , V_64 , L_14 , V_40 -> V_60 ,
( unsigned long long ) V_42 . V_36 ) ;
V_7 -> V_65 = F_26 ( V_40 , 0 ) ;
if ( ! V_7 -> V_65 ) {
V_56 = - V_59 ;
goto error;
}
if ( V_52 -> V_66 > F_27 ( & V_42 ) ) {
F_10 ( & V_48 -> V_21 , L_15 ) ;
V_56 = - V_67 ;
goto error;
}
V_7 -> V_9 = V_7 -> V_65 + V_52 -> V_66 ;
V_55 -> V_68 = & V_48 -> V_21 ;
F_28 ( V_48 , V_55 ) ;
if ( V_52 -> V_69 ) {
F_29 (np, tbi) {
if ( strcmp ( V_54 -> type , L_16 ) == 0 ) {
F_6 ( & V_48 -> V_21 , L_17 ,
strrchr ( V_54 -> V_46 , '/' ) + 1 ) ;
break;
}
...
if ( V_54 ) {
const T_5 * V_70 = F_20 ( V_54 , L_18 , NULL ) ;
T_3 T_2 * V_30 ;
if ( ! V_70 ) {
F_10 ( & V_48 -> V_21 ,
L_19 ,
...
V_30 = V_52 -> V_69 ( V_7 -> V_65 ) ;
if ( ( void * ) V_30 > V_7 -> V_65 + F_27 ( & V_42 ) - 4 )
F_10 ( & V_48 -> V_21 , L_20 ,
( ( void * ) V_30 - V_7 -> V_65 ) + 4 ) ;
F_2 ( F_21 ( V_70 ) , V_30 ) ;
}
}
if ( V_52 -> F_16 )
...
{
struct V_71 * V_71 = & V_48 -> V_21 ;
struct V_1 * V_2 = F_34 ( V_71 ) ;
struct V_6 * V_7 = V_2 -> V_7 ;
F_35 ( V_2 ) ;
F_31 ( V_7 -> V_65 ) ;
F_36 ( V_2 ) ;
