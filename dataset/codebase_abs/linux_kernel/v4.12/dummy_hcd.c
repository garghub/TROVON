...
static void F_66 ( struct V_17 * V_13 )
{
int V_31 ;
...
struct V_17 * V_13 ;
int V_137 ;
V_13 = * ( ( void * * ) F_70 ( & V_136 -> V_19 ) ) ;
F_71 ( & V_13 -> V_18 , sizeof( struct V_21 ) ) ;
V_13 -> V_18 . V_65 = V_138 ;
V_13 -> V_18 . V_127 = & V_139 ;
V_13 -> V_18 . V_114 = V_23 ;
V_13 -> V_18 . V_19 . V_20 = & V_136 -> V_19 ;
F_66 ( V_13 ) ;
V_137 = F_72 ( & V_136 -> V_19 , & V_13 -> V_18 ) ;
if ( V_137 < 0 )
goto V_140;
V_137 = F_73 ( & V_13 -> V_18 . V_19 , & V_141 ) ;
if ( V_137 < 0 )
goto V_142;
F_74 ( V_136 , V_13 ) ;
return V_137 ;
...
{
struct V_17 * V_13 = F_77 ( V_136 ) ;
F_78 ( & V_13 -> V_18 . V_19 , & V_141 ) ;
F_75 ( & V_13 -> V_18 ) ;
return 0 ;
}
static void F_79 ( struct V_17 * V_13 , struct V_9 * V_34 ,
int V_59 )
{
F_64 ( & V_13 -> V_30 ) ;
V_13 -> V_39 = V_59 ;
...
for ( V_31 = 0 ; V_31 < V_112 . V_314 ; V_31 ++ ) {
struct V_17 * V_13 ;
V_13 = * ( ( void * * ) F_70 ( & V_317 [ V_31 ] -> V_19 ) ) ;
F_170 ( V_317 [ V_31 ] ) ;
F_170 ( V_315 [ V_31 ] ) ;
F_38 ( V_13 ) ;
}
