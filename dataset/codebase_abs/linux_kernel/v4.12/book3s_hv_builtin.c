...
static struct V_70 * F_52 ( struct V_71 * V_72 ,
T_5 V_73 )
{
int V_64 ;
for ( V_64 = 0 ; V_64 < V_72 -> V_74 ; V_64 ++ ) {
if ( V_73 == V_72 -> V_75 [ V_64 ] . V_76 ) {
F_53 () ;
return & V_72 -> V_75 [ V_64 ] ;
}
}
return NULL ;
}
static int F_54 ( T_5 V_73 , T_6 V_77 , bool * V_78 )
{
struct V_71 * V_72 ;
struct V_70 * V_79 ;
struct V_18 * V_19 ;
...
return 1 ;
V_24 -> V_25 . V_80 = 0 ;
return F_56 ( V_19 , V_77 , V_79 , V_72 , V_78 ) ;
}
static inline int F_54 ( T_5 V_73 , T_6 V_77 , bool * V_78 )
{
return 1 ;
}
long F_57 ( void )
...
unsigned long F_71 ( struct V_18 * V_19 , unsigned long V_90 )
{
if ( F_45 () ) {
if ( F_66 () )
return F_72 ( V_19 , V_90 ) ;
if ( F_65 ( ! V_91 ) )
return V_89 ;
return V_91 ( V_19 , V_90 ) ;
} else
return V_37 ;
}
int F_73 ( struct V_18 * V_19 , unsigned long V_90 ,
unsigned long V_92 )
{
if ( F_45 () ) {
if ( F_66 () )
return F_74 ( V_19 , V_90 , V_92 ) ;
if ( F_65 ( ! V_93 ) )
return V_89 ;
return V_93 ( V_19 , V_90 , V_92 ) ;
} else
return F_75 ( V_19 , V_90 , V_92 ) ;
}
int F_76 ( struct V_18 * V_19 , unsigned long V_94 )
{
if ( F_45 () ) {
if ( F_66 () )
return F_77 ( V_19 , V_94 ) ;
if ( F_65 ( ! V_95 ) )
return V_89 ;
return V_95 ( V_19 , V_94 ) ;
} else
return F_78 ( V_19 , V_94 ) ;
}
int F_79 ( struct V_18 * V_19 , unsigned long V_77 )
{
if ( F_45 () ) {
if ( F_66 () )
return F_80 ( V_19 , V_77 ) ;
if ( F_65 ( ! V_96 ) )
return V_89 ;
return V_96 ( V_19 , V_77 ) ;
} else
return F_81 ( V_19 , V_77 ) ;
}
