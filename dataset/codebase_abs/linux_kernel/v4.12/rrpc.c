...
V_152 = F_56 ( V_1 , V_32 , V_26 , V_160 ) ;
switch ( V_152 ) {
case V_145 :
return V_159 ;
case V_148 :
...
F_113 ( & V_165 ) ;
F_3 ( & V_1 -> V_161 ) ;
F_114 ( & V_165 , & V_1 -> V_162 ) ;
F_113 ( & V_1 -> V_162 ) ;
F_7 ( & V_1 -> V_161 ) ;
while ( ( V_32 = F_115 ( & V_165 ) ) )
...
{
V_1 -> V_73 = F_119 ( L_17 , V_168 | V_169 ,
V_1 -> V_67 ) ;
if ( ! V_1 -> V_73 )
return - V_31 ;
V_1 -> V_113 = F_119 ( L_18 , V_168 , 1 ) ;
if ( ! V_1 -> V_113 )
return - V_31 ;
...
static int F_123 ( T_2 V_18 , T_5 V_170 , T_6 * V_171 , void * V_135 )
{
...
V_179 = F_129 ( V_5 , V_1 -> V_180 , V_1 -> V_115 ,
F_123 , V_1 ) ;
if ( V_179 ) {
F_20 ( L_22 ) ;
return - V_178 ;
...
if ( ! V_1 -> V_102 )
return - V_31 ;
V_1 -> V_29 = F_136 ( 64 , V_183 ) ;
if ( ! V_1 -> V_29 )
return - V_31 ;
F_137 ( & V_1 -> V_185 . V_12 ) ;
F_138 ( & V_1 -> V_185 . V_186 ) ;
return 0 ;
}
...
V_188 = F_144 ( V_189 , V_147 ) ;
if ( ! V_188 )
return - V_31 ;
V_44 . V_44 = 0 ;
V_44 . V_45 . V_46 = V_40 -> V_47 . V_45 . V_46 ;
V_44 . V_45 . V_48 = V_40 -> V_47 . V_45 . V_48 ;
V_179 = F_145 ( V_5 , V_44 , V_188 ) ;
if ( V_179 ) {
F_20 ( L_25 ) ;
goto V_53;
}
V_189 = F_146 ( V_5 -> V_138 , V_188 , V_189 ) ;
if ( V_189 < 0 ) {
V_179 = V_189 ;
goto V_53;
}
...
static int F_150 ( struct V_1 * V_1 , T_1 * V_197 )
{
struct V_4 * V_5 = V_1 -> V_5 ;
T_1 V_198 = V_1 -> V_115 * V_5 -> V_13 . V_153 ;
int V_179 ;
V_198 >>= 9 ;
V_179 = F_151 ( V_5 , V_197 , V_198 ) ;
if ( ! V_179 )
* V_197 >>= ( F_152 ( V_5 -> V_13 . V_153 ) - 9 ) ;
return V_179 ;
}
static void F_153 ( struct V_1 * V_1 )
{
struct V_4 * V_5 = V_1 -> V_5 ;
T_1 V_197 = V_1 -> V_180 << ( F_152 ( V_5 -> V_13 . V_153 ) - 9 ) ;
F_154 ( V_5 , V_197 ) ;
}
...
static void * F_165 ( struct V_4 * V_5 , struct V_206 * V_207 ,
int V_59 )
{
...
F_113 ( & V_1 -> V_162 ) ;
F_137 ( & V_1 -> V_161 ) ;
F_72 ( & V_1 -> V_163 , F_112 ) ;
V_1 -> V_67 = V_13 -> V_67 ;
V_1 -> V_115 = ( unsigned long long ) V_13 -> V_213 * V_1 -> V_67 ;
F_33 ( & V_1 -> V_72 , - 1 ) ;
V_179 = F_150 ( V_1 , & V_180 ) ;
if ( V_179 < 0 ) {
F_20 ( L_29 ) ;
return F_11 ( V_179 ) ;
}
V_1 -> V_180 = V_180 ;
V_179 = F_148 ( V_1 , V_5 -> V_68 ) ;
if ( V_179 ) {
F_20 ( L_30 ) ;
goto V_152;
}
...
F_167 ( V_209 , F_168 ( V_208 ) ) ;
F_169 ( V_209 , F_170 ( V_208 ) ) ;
F_171 ( L_36 ,
