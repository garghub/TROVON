...
! V_18 -> V_21 -> V_130 )
return - V_23 ;
V_29 = F_9 ( V_124 , V_125 , V_20 [ V_128 ] ,
V_131 , NULL ) ;
if ( V_29 )
return V_29 ;
...
! V_18 -> V_21 -> V_140 )
return - V_23 ;
V_29 = F_9 ( V_25 , V_125 , V_20 [ V_128 ] ,
V_35 , NULL ) ;
if ( V_29 )
return V_29 ;
for ( V_30 = V_133 ; V_30 <= V_134 ; V_30 ++ ) {
...
if ( ! V_20 [ V_161 ] )
return - V_33 ;
V_150 = F_9 ( V_155 , V_227 , V_20 [ V_161 ] ,
V_228 , NULL ) ;
if ( V_150 )
return V_150 ;
...
struct V_245 * V_246 )
{
struct V_222 * V_222 = F_71 ( V_8 -> V_247 ) ;
struct V_17 * V_18 ;
struct V_9 * V_10 = F_5 ( V_11 ) ;
struct V_19 * V_20 [ V_248 + 1 ] ;
T_2 V_220 = V_8 ? F_72 ( V_8 ) . V_220 : 0 ;
int V_29 = - V_33 ;
struct V_1 * V_249 ;
struct V_6 * V_250 = NULL ;
const struct V_251 * V_252 ;
if ( ( V_11 -> V_253 == V_79 ) && ! F_73 ( V_8 , V_254 ) )
return - V_255 ;
V_29 = F_74 ( V_11 , sizeof( * V_10 ) , V_20 , V_248 ,
V_256 , V_246 ) ;
if ( V_29 < 0 )
return V_29 ;
if ( V_10 -> V_2 > V_257 )
return - V_33 ;
V_252 = & V_258 [ V_10 -> V_2 ] ;
if ( ! V_252 -> V_259 )
return - V_23 ;
if ( ! V_20 [ V_159 ] )
return - V_33 ;
...
if ( ! V_18 -> V_21 )
return - V_23 ;
V_249 = F_1 ( V_252 -> type , V_10 -> V_2 , V_220 , V_11 -> V_261 ,
V_11 -> V_262 , & V_250 ) ;
if ( ! V_249 )
return - V_223 ;
V_29 = V_252 -> V_259 ( V_18 , V_11 , V_11 -> V_261 , V_20 , V_249 ) ;
if ( V_29 < 0 ) {
F_53 ( V_249 ) ;
goto V_263;
}
F_55 ( V_249 , V_250 ) ;
V_29 = F_76 ( V_249 , V_222 , V_220 ) ;
V_263:
return V_29 ;
}
...
{
struct V_156 * V_264 ;
V_264 = F_42 ( sizeof( * V_264 ) , V_265 ) ;
if ( ! V_264 )
return - V_152 ;
memcpy ( & V_264 -> V_72 , V_72 , sizeof( * V_72 ) ) ;
V_264 -> V_184 = V_184 ;
F_79 ( & V_264 -> V_266 , & V_267 ) ;
return 0 ;
}
...
int F_26 ( struct V_17 * V_194 , struct V_71 * V_268 )
{
struct V_156 * V_157 ;
struct V_156 V_219 ;
int V_150 = 0 ;
V_219 . V_184 = V_194 -> V_184 ;
memcpy ( & V_219 . V_72 , V_268 , sizeof( V_219 . V_72 ) ) ;
if ( V_194 -> V_21 -> V_186 )
V_219 . V_158 = V_194 -> V_21 -> V_186 ( V_194 ) ;
F_46 ( & V_183 ) ;
if ( ( V_157 = F_77 ( V_268 , V_194 -> V_184 , 0 ) ) ) {
if ( V_268 -> V_78 )
V_157 -> V_72 . V_78 = V_268 -> V_78 ;
else {
F_80 ( & V_157 -> V_266 ) ;
F_43 ( V_157 ) ;
}
...
int F_61 ( struct V_17 * V_194 , struct V_71 * V_268 )
{
struct V_156 V_219 ;
int V_150 = 0 ;
V_219 . V_184 = V_194 -> V_184 ;
...
V_219 . V_158 = V_194 -> V_21 -> V_186 ( V_194 ) ;
F_46 ( & V_183 ) ;
if ( F_77 ( V_268 , V_194 -> V_184 , V_268 -> V_78 ) ) {
V_150 = - V_270 ;
goto V_263;
}
V_150 = F_78 ( V_268 , V_194 -> V_184 ) ;
...
int F_64 ( struct V_17 * V_194 , struct V_71 * V_271 )
{
struct V_156 * V_157 ;
struct V_156 V_219 ;
int V_150 = - V_272 ;
V_219 . V_184 = V_194 -> V_184 ;
memcpy ( & V_219 . V_72 , V_271 , sizeof( V_219 . V_72 ) ) ;
if ( V_194 -> V_21 -> V_186 )
V_219 . V_158 = V_194 -> V_21 -> V_186 ( V_194 ) ;
F_46 ( & V_183 ) ;
if ( ( V_157 = F_77 ( V_271 , V_194 -> V_184 , V_271 -> V_78 ) ) ) {
F_80 ( & V_157 -> V_266 ) ;
F_43 ( V_157 ) ;
V_150 = 0 ;
}
...
{
F_84 ( & V_267 ) ;
F_85 ( V_273 , V_274 , F_70 , NULL , NULL ) ;
F_85 ( V_273 , V_79 , F_70 , NULL , NULL ) ;
return 0 ;
}
