...
{
unsigned int V_40 = V_37 & ~ V_41 ;
unsigned long V_42 = V_37 >> V_43 ;
int V_44 = 0 ;
while ( V_44 < V_38 && V_42 < V_3 -> V_9 ) {
int V_45 = F_32 ( int , V_38 - V_44 , V_16 - V_40 ) ;
void * V_46 = V_3 -> V_8 [ V_42 ] . V_11 + V_40 ;
if ( V_39 )
memcpy ( V_46 , V_6 , V_45 ) ;
else
memcpy ( V_6 , V_46 , V_45 ) ;
V_6 += V_45 ;
V_44 += V_45 ;
V_42 ++ ;
V_40 = 0 ;
...
return V_3 && ( F_35 ( & V_3 -> V_4 ) > 1 ) ;
}
int F_36 ( struct V_18 * V_19 , struct V_20 * V_21 ,
unsigned long V_47 )
{
struct V_22 * V_23 = V_21 -> V_23 ;
V_47 = ( V_47 + V_16 - 1 ) & V_41 ;
if ( V_23 -> V_24 && V_23 -> V_25 == V_47 )
return 0 ;
F_11 ( V_19 , V_21 ) ;
if ( V_47 ) {
unsigned int V_9 = V_47 >> V_43 ;
F_16 ( V_19 , V_21 , V_9 ) ;
if ( ! V_23 -> V_24 ) {
F_11 ( V_19 , V_21 ) ;
return - V_48 ;
...
static unsigned int F_38 ( struct V_20 * V_21 )
{
struct V_22 * V_23 = V_21 -> V_23 ;
...
static unsigned int F_42 ( struct V_20 * V_21 ,
unsigned int V_65 )
{
struct V_22 * V_23 = V_21 -> V_23 ;
unsigned int V_66 = 0 ;
const unsigned int V_67 = F_43 ( V_21 ) ;
...
{
struct V_22 * V_23 = V_21 -> V_23 ;
unsigned int V_75 = F_45 ( V_21 ) ;
if ( V_63 > V_75 )
V_63 = V_75 ;
V_23 -> V_50 += V_63 ;
V_23 -> V_53 += V_63 ;
F_42 ( V_21 , V_23 -> V_50 - V_23 -> V_59 ) ;
...
static unsigned int F_50 ( struct V_22 * V_23 )
{
return V_23 -> V_51 - V_23 -> V_52 ;
}
unsigned int F_51 ( struct V_20 * V_21 ,
unsigned int V_63 )
{
struct V_22 * V_23 = V_21 -> V_23 ;
unsigned int V_75 ;
...
unsigned int V_83 ;
unsigned int V_63 ;
V_83 = F_55 ( V_21 , F_38 ( V_21 ) ) ;
if ( V_82 > V_83 ) {
F_56 ( V_21 -> V_73 -> V_31 , L_2 ) ;
V_21 -> V_23 -> V_61 |= V_84 ;
V_82 = V_83 ;
}
if ( V_82 == 0 )
...
unsigned int F_59 ( struct V_20 * V_21 ,
