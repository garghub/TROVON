...
F_13 ( V_51 , L_118 ,
V_309 ) ;
V_311 = F_59 ( V_309 , V_177 ) ;
if ( V_311 == NULL )
return - V_101 ;
memcpy ( V_311 -> V_176 , V_307 , V_306 ) ;
} else {
F_63 ( V_51 , L_119 ) ;
return 0 ;
}
...
static void F_151 ( struct V_146 * V_90 , struct V_81 * V_1 )
{
F_152 ( V_90 -> V_52 , V_1 -> V_316 , V_1 -> V_317 ) ;
F_153 ( V_90 -> V_52 , V_1 -> V_42 ) ;
}
static void F_154 ( struct V_146 * V_90 , const char * V_318 )
{
struct V_127 * V_128 = V_90 -> V_52 ;
T_1 V_319 , V_148 , V_320 , V_147 ;
V_147 = F_42 ( V_128 , V_152 ) ;
V_319 = F_42 ( V_128 , V_321 ) ;
V_148 = F_42 ( V_128 , V_76 ) ;
V_320 = F_42 ( V_128 , V_79 ) ;
F_24 ( V_90 -> V_51 ,
L_121 ,
V_318 , V_147 , V_319 , V_148 , V_320 ) ;
}
static void F_155 ( struct V_81 * V_1 , char * V_316 ,
T_6 V_317 )
{
memcpy ( V_1 -> V_316 , V_316 , V_317 ) ;
}
static T_5 F_156 ( T_5 V_42 , T_5 * V_322 )
{
V_42 &= ~ ( V_82 | V_4 ) ;
* V_322 = ( T_5 ) - 1 ;
return V_42 ;
}
static bool F_157 ( struct V_127 * V_52 )
{
T_5 V_147 ;
V_147 = F_42 ( V_52 , V_152 ) ;
return ( V_147 & ( V_323 | V_151 ) ) ;
}
int F_158 ( struct V_278 * V_51 , struct V_324 * V_75 )
{
struct V_156 V_157 ;
struct V_36 * V_37 ;
struct V_146 * V_90 ;
int V_122 ;
F_13 ( V_51 , L_122 ) ;
V_37 = F_159 ( V_51 , sizeof( * V_37 ) , V_177 ) ;
if ( V_37 == NULL )
return - V_101 ;
V_37 -> V_51 = V_51 ;
V_90 = & V_37 -> V_90 ;
V_90 -> V_51 = V_51 ;
V_90 -> V_325 . V_326 = F_151 ;
V_90 -> V_325 . V_327 = F_154 ;
V_90 -> V_325 . V_328 = F_155 ;
V_90 -> V_325 . V_329 = F_156 ;
V_90 -> V_325 . V_330 = F_157 ;
V_90 -> V_331 = V_47 ;
V_90 -> V_332 = V_47 ;
V_122 = F_160 ( V_90 ) ;
if ( V_122 != 0 )
...
F_162 ( & V_37 -> V_58 ) ;
V_334 . V_335 = V_37 ;
V_37 -> V_52 = F_163 ( V_51 , & V_334 , V_75 ) ;
if ( V_37 -> V_52 == NULL ) {
V_122 = - V_276 ;
goto V_336;
}
V_90 -> V_52 = V_37 -> V_52 ;
V_37 -> V_337 = F_164 ( V_37 -> V_52 -> V_338 ,
...
F_166 ( V_37 -> V_52 ) ;
V_340:
F_167 ( V_37 -> V_52 -> V_338 , V_270 ,
V_37 -> V_337 , V_37 -> V_271 ) ;
V_339:
F_168 ( V_37 -> V_52 ) ;
V_336:
F_169 ( V_90 ) ;
...
void F_170 ( struct V_278 * V_51 , struct V_324 * V_75 )
{
