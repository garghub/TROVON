...
T_2 V_39 = F_12 ( V_29 + V_31 ) ;
T_2 V_11 = F_12 ( V_29 + V_31 + 1 ) ;
T_2 V_40 = F_12 ( V_29 + V_31 + 2 ) ;
T_2 V_41 = F_12 ( V_29 + V_31 + 3 ) ;
int V_12 ;
if ( V_39 != V_33 ) {
V_33 = V_39 ;
...
static inline T_3 F_16 ( T_3 V_55 )
{
T_3 V_56 = 0 ;
if ( V_55 & V_57 )
V_56 |= V_58 ;
...
static int F_33 ( struct V_1 * V_2 , int V_118 )
{
int V_119 ;
if ( V_118 ) {
V_119 = F_2 ( V_2 , V_120 ) ;
...
static int F_35 ( struct V_1 * V_2 , int V_123 )
{
int V_67 ;
int V_3 ;
int V_115 ;
...
static void F_45 ( struct V_1 * V_2 , struct V_150 * V_151 )
{
V_151 -> V_71 = V_152 ;
V_151 -> V_153 = 0 ;
if ( F_4 ( V_2 , V_38 ,
...
return F_48 ( V_170 ) - V_171 ;
}
static void F_49 ( struct V_1 * V_2 , T_4 * V_172 )
{
int V_31 ;
for ( V_31 = 0 ; V_31 < F_48 ( V_170 ) ; V_31 ++ ) {
memcpy ( V_172 + V_31 * V_173 ,
V_170 [ V_31 ] . string , V_173 ) ;
}
}
static T_5 F_50 ( struct V_1 * V_2 , int V_31 )
{
...
int V_31 ;
for ( V_31 = 0 ; V_31 < F_48 ( V_170 ) ; V_31 ++ )
V_172 [ V_31 ] = F_50 ( V_2 , V_31 ) ;
}
static int F_52 ( struct V_1 * V_2 , long * V_79 )
{
int V_34 ;
int V_12 ;
* V_79 = 0 ;
...
static int F_56 ( struct V_186 * V_36 ,
enum V_187 type ,
T_3 V_188 , int V_189 , long * V_79 )
{
struct V_1 * V_2 = F_57 ( V_36 ) ;
int V_3 ;
switch ( V_188 ) {
case V_190 :
V_3 = F_52 ( V_2 , V_79 ) ;
...
static T_6 F_58 ( const void * V_172 ,
enum V_187 type ,
T_3 V_188 , int V_189 )
{
if ( type != V_192 )
...
static int F_59 ( struct V_1 * V_2 , long * V_79 )
{
int V_34 ;
* V_79 = 0 ;
F_53 ( & V_2 -> V_182 ) ;
...
int F_61 ( struct V_1 * V_2 , long V_79 )
{
int V_34 ;
F_53 ( & V_2 -> V_182 ) ;
V_34 = F_4 ( V_2 , V_95 , 0x6 ) ;
...
goto error;
V_79 = V_79 / 1000 ;
V_79 = F_62 ( F_63 ( V_79 , 5 ) + 5 , 0 , 0x1f ) ;
V_34 = F_4 ( V_2 , V_183 ,
( V_34 & ~ V_195 ) |
( V_79 << V_196 ) ) ;
error:
...
int F_64 ( struct V_1 * V_2 , long * V_197 )
{
int V_34 ;
* V_197 = false ;
F_53 ( & V_2 -> V_182 ) ;
...
static int F_66 ( struct V_186 * V_36 ,
enum V_187 type ,
T_3 V_188 , int V_189 , long V_79 )
{
struct V_1 * V_2 = F_57 ( V_36 ) ;
...
static T_6 F_67 ( const void * V_172 ,
enum V_187 type ,
T_3 V_188 , int V_189 )
{
if ( type != V_192 )
...
const char * V_201 = F_69 ( V_36 ) ;
T_7 V_30 = strlen ( V_201 ) ;
int V_31 , V_202 ;
V_177 -> V_203 = F_70 ( V_36 , V_30 , V_204 ) ;
if ( ! V_177 -> V_203 )
return - V_205 ;
...
return F_73 ( V_177 -> V_208 ) ;
}
static int F_74 ( struct V_1 * V_2 )
{
return F_71 ( V_2 , & V_209 ) ;
}
static int F_75 ( struct V_1 * V_2 )
{
return F_71 ( V_2 , & V_210 ) ;
}
static int F_74 ( struct V_1 * V_2 )
{
return 0 ;
...
{
struct V_176 * V_177 ;
V_177 = F_70 ( & V_2 -> V_35 . V_36 , sizeof( * V_177 ) , V_204 ) ;
if ( ! V_177 )
return - V_205 ;
V_2 -> V_177 = V_177 ;
return 0 ;
