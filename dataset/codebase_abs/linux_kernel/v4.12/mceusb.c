...
snprintf ( V_23 -> V_153 , sizeof( V_23 -> V_153 ) , L_52 ,
V_154 [ V_23 -> V_155 ] . V_153 ?
V_154 [ V_23 -> V_155 ] . V_153 :
L_53 ,
F_47 ( V_23 -> V_76 -> V_156 . V_157 ) ,
F_47 ( V_23 -> V_76 -> V_156 . V_158 ) ) ;
F_48 ( V_23 -> V_76 , V_23 -> V_159 , sizeof( V_23 -> V_159 ) ) ;
V_115 -> V_160 = V_23 -> V_153 ;
V_115 -> V_161 = V_23 -> V_159 ;
F_49 ( V_23 -> V_76 , & V_115 -> V_162 ) ;
V_115 -> V_36 . V_163 = V_36 ;
V_115 -> V_87 = V_23 ;
V_115 -> V_164 = V_165 ;
...
if ( V_154 [ V_23 -> V_155 ] . V_177 )
V_115 -> V_172 = V_154 [ V_23 -> V_155 ] . V_177 ;
V_90 = F_51 ( V_115 ) ;
if ( V_90 < 0 ) {
F_8 ( V_36 , L_54 ) ;
goto V_27;
...
{
struct V_150 * V_36 = F_54 ( V_179 ) ;
struct V_182 * V_183 ;
struct V_184 * V_185 = NULL ;
struct V_184 * V_186 = NULL ;
struct V_184 * V_187 = NULL ;
struct V_22 * V_23 = NULL ;
int V_71 , V_188 , V_88 , V_70 ;
char V_24 [ 63 ] , V_153 [ 128 ] = L_13 ;
enum V_189 V_155 = V_181 -> V_190 ;
bool V_191 ;
bool V_192 ;
bool V_104 ;
int V_193 ;
F_4 ( & V_179 -> V_36 , L_55 , V_134 ) ;
V_183 = V_179 -> V_194 ;
V_191 = V_154 [ V_155 ] . V_195 ;
V_192 = V_154 [ V_155 ] . V_196 ;
V_104 = V_154 [ V_155 ] . V_104 ;
V_193 = V_154 [ V_155 ] . V_193 ;
if ( V_183 -> V_197 . V_198 != V_193 )
return - V_199 ;
for ( V_88 = 0 ; V_88 < V_183 -> V_197 . V_200 ; ++ V_88 ) {
V_185 = & V_183 -> V_201 [ V_88 ] . V_197 ;
if ( V_186 == NULL ) {
if ( F_55 ( V_185 ) ) {
V_186 = V_185 ;
F_4 ( & V_179 -> V_36 , L_56 ) ;
...
if ( F_15 ( V_186 ) )
V_71 = F_59 ( V_36 , V_186 -> V_77 ) ;
else
V_71 = F_60 ( V_36 , V_186 -> V_77 ) ;
V_188 = F_61 ( V_36 , V_71 , F_62 ( V_71 ) ) ;
V_23 = F_38 ( sizeof( struct V_22 ) , V_74 ) ;
if ( ! V_23 )
goto V_202;
V_23 -> V_112 = F_63 ( V_36 , V_188 , V_80 , & V_23 -> V_203 ) ;
if ( ! V_23 -> V_112 )
goto V_204;
V_23 -> V_205 = F_12 ( 0 , V_74 ) ;
if ( ! V_23 -> V_205 )
goto V_206;
V_23 -> V_76 = F_64 ( V_36 ) ;
V_23 -> V_36 = & V_179 -> V_36 ;
V_23 -> V_207 = V_188 ;
V_23 -> V_41 . V_42 = V_192 ;
V_23 -> V_41 . V_104 = V_104 ;
V_23 -> V_41 . V_145 = V_154 [ V_155 ] . V_145 ;
V_23 -> V_155 = V_155 ;
V_23 -> V_75 = V_187 ;
if ( V_36 -> V_156 . V_208
&& F_65 ( V_36 , V_36 -> V_156 . V_208 ,
V_24 , sizeof( V_24 ) ) > 0 )
F_66 ( V_153 , V_24 , sizeof( V_153 ) ) ;
if ( V_36 -> V_156 . V_209
&& F_65 ( V_36 , V_36 -> V_156 . V_209 ,
V_24 , sizeof( V_24 ) ) > 0 )
...
if ( ! V_23 -> V_115 )
goto V_210;
F_17 ( V_23 -> V_205 , V_36 , V_71 , V_23 -> V_112 , V_188 ,
F_34 , V_23 , V_186 -> V_78 ) ;
V_23 -> V_205 -> V_211 = V_23 -> V_203 ;
V_23 -> V_205 -> V_212 |= V_213 ;
F_4 ( & V_179 -> V_36 , L_62 ) ;
V_70 = F_20 ( V_23 -> V_205 , V_74 ) ;
if ( V_70 )
F_8 ( & V_179 -> V_36 , L_63 , V_70 ) ;
F_36 ( V_23 ) ;
if ( V_23 -> V_41 . V_42 )
F_37 ( V_23 ) ;
else if ( ! V_191 )
...
F_68 ( V_23 -> V_36 , true ) ;
F_69 ( V_23 -> V_36 , true ) ;
F_70 ( & V_179 -> V_36 , L_64 ,
V_153 , V_23 -> V_118 ) ;
F_70 ( & V_179 -> V_36 , L_65 ,
...
F_10 ( V_23 -> V_205 ) ;
V_206:
F_73 ( V_36 , V_188 , V_23 -> V_112 , V_23 -> V_203 ) ;
V_204:
F_9 ( V_23 ) ;
V_202:
F_8 ( & V_179 -> V_36 , L_66 , V_134 ) ;
return - V_214 ;
}
static void F_74 ( struct V_178 * V_179 )
{
struct V_150 * V_36 = F_54 ( V_179 ) ;
...
F_72 ( V_23 -> V_205 ) ;
F_10 ( V_23 -> V_205 ) ;
F_73 ( V_36 , V_23 -> V_207 , V_23 -> V_112 , V_23 -> V_203 ) ;
F_71 ( V_36 ) ;
F_9 ( V_23 ) ;
}
static int F_77 ( struct V_178 * V_179 , T_3 V_215 )
{
struct V_22 * V_23 = F_75 ( V_179 ) ;
F_70 ( V_23 -> V_36 , L_67 ) ;
F_72 ( V_23 -> V_205 ) ;
