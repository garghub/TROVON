...
V_92 = & V_93 -> V_11 ;
if ( strncmp ( V_92 -> V_46 , V_91 , V_47 ) )
continue;
if ( ( V_20 . V_30 . V_31 != V_92 -> V_20 . V_30 . V_31 ||
V_20 . V_32 . V_33 != V_92 -> V_20 . V_32 . V_33 ) )
continue;
if ( V_90 -> V_94 & V_95 )
return - V_96 ;
V_11 = V_92 ;
...
{
int V_51 ;
struct V_21 * V_99 , * V_100 ;
V_99 = F_33 ( V_2 , V_67 | V_98 ) ;
if ( V_99 == NULL )
goto V_37;
if ( F_39 ( V_2 , V_56 ,
F_40 ( V_11 -> V_62 + 1 ) ) )
...
static int
F_42 ( struct V_1 * V_2 , T_1 V_101 , T_1 V_102 , T_1 type ,
int V_103 , struct V_10 * V_11 )
{
struct V_89 * V_90 ;
struct V_104 * V_105 ;
unsigned int V_13 = V_101 ? V_106 : 0 ;
int V_78 ;
V_103 = F_43 ( V_107 , V_103 ) ;
V_90 = F_44 ( V_2 , V_101 , V_102 , V_103 , sizeof( * V_105 ) , V_13 ) ;
if ( V_90 == NULL )
goto V_108;
V_105 = F_45 ( V_90 ) ;
V_105 -> V_109 = V_110 ;
...
static int
F_48 ( struct V_1 * V_2 , struct V_115 * V_116 )
{
struct V_10 * V_92 , * V_117 ;
F_49 () ;
V_117 = (struct V_10 * ) V_116 -> args [ 1 ] ;
for (; V_116 -> args [ 0 ] < V_118 ; V_116 -> args [ 0 ] ++ ) {
V_119:
F_50 (cur,
...
if ( F_42 ( V_2 ,
F_51 ( V_116 -> V_2 ) . V_101 ,
V_116 -> V_90 -> V_120 ,
F_52 ( V_116 -> V_90 -> V_121 ) ,
V_122 , V_92 ) < 0 ) {
V_116 -> args [ 1 ] = ( unsigned long ) V_92 ;
goto V_123;
}
}
}
...
return F_55 ( V_88 , V_2 , V_90 , & V_129 ) ;
}
if ( V_24 [ V_70 ] )
V_91 = F_12 ( V_24 [ V_70 ] ) ;
if ( V_24 [ V_66 ] ) {
...
V_92 = & V_93 -> V_11 ;
if ( V_91 &&
strncmp ( V_92 -> V_46 , V_91 , V_47 ) )
continue;
if ( V_126 &&
( V_20 . V_30 . V_31 != V_92 -> V_20 . V_30 . V_31 ||
V_20 . V_32 . V_33 != V_92 -> V_20 . V_32 . V_33 ) )
continue;
V_125 = F_56 ( V_131 , V_59 ) ;
if ( V_125 == NULL ) {
V_52 = - V_60 ;
break;
}
V_52 = F_42 ( V_125 , F_51 ( V_2 ) . V_101 ,
V_90 -> V_120 ,
F_52 ( V_90 -> V_121 ) ,
V_122 , V_92 ) ;
if ( V_52 <= 0 ) {
...
V_52 = F_58 ( V_88 , V_125 , F_51 ( V_2 ) . V_101 ,
V_132 ) ;
if ( V_52 > 0 )
V_52 = 0 ;
return V_52 == - V_133 ? - V_134 : V_52 ;
}
return V_52 ;
}
...
struct V_10 * V_92 ;
struct V_19 V_20 ;
bool V_126 = false , V_135 = false ;
struct V_63 * V_93 , * V_136 ;
int V_137 = 0 , V_52 ;
if ( V_24 [ V_70 ] )
V_91 = F_12 ( V_24 [ V_70 ] ) ;
if ( V_24 [ V_66 ] ) {
