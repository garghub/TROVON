...
{
struct V_66 V_67 ;
if ( ! F_35 ( V_64 , & V_67 ) && ( V_67 . V_14 ^ V_65 ) & V_19 ) {
if ( F_36 ( V_67 . V_14 ) )
F_37 ( V_64 ) ;
else
F_38 ( V_64 ) ;
...
static long T_2 F_57 ( char * V_35 , unsigned long V_77 )
{
V_46 = V_77 ;
V_44 = V_35 ;
while ( ! V_78 [ V_48 ] ( ) )
...
static long T_2 F_58 ( void * V_79 , unsigned long V_77 )
{
char * V_35 = ( char * ) V_79 ;
long V_80 ;
long V_81 = V_77 ;
if ( V_9 )
return - 1 ;
while ( ( V_80 = F_57 ( V_35 , V_77 ) ) < V_77 && ! V_9 ) {
char V_82 = V_35 [ V_80 ] ;
if ( V_82 == '0' ) {
V_35 += V_80 ;
V_77 -= V_80 ;
...
static char * T_2 F_59 ( char * V_35 , unsigned long V_77 )
{
long V_80 ;
T_6 V_84 ;
const char * V_85 ;
static T_7 char V_86 [ 64 ] ;
V_54 = F_5 ( 110 , V_20 ) ;
...
V_45 = 0 ;
V_84 = F_60 ( V_35 , V_77 , & V_85 ) ;
F_61 ( L_12 , V_85 ) ;
if ( V_84 ) {
int V_88 = V_84 ( V_35 , V_77 , NULL , F_58 , NULL ,
& V_89 , error ) ;
if ( V_88 )
error ( L_13 ) ;
} else if ( V_85 ) {
...
{
#ifdef F_64
unsigned long V_92 = ( unsigned long ) F_65 ( V_93 . V_94 ) ;
unsigned long V_95 = ( unsigned long ) F_65 ( V_93 . V_96 ) ;
#endif
if ( V_91 )
goto V_97;
#ifdef F_64
if ( V_98 < V_95 && V_99 > V_92 ) {
memset ( ( void * ) V_98 , 0 , V_99 - V_98 ) ;
if ( V_98 < V_92 )
F_66 ( V_98 , V_92 ) ;
if ( V_99 > V_95 )
F_66 ( V_95 , V_99 ) ;
...
struct V_100 * V_101 ;
int V_102 ;
V_1 = F_40 ( L_15 , V_103 , 0 ) ;
F_68 ( V_1 < 0 ) ;
if ( V_1 < 0 )
return;
V_35 = F_69 ( V_104 , V_20 ) ;
F_68 ( ! V_35 ) ;
if ( ! V_35 ) {
F_53 ( V_1 ) ;
return;
...
V_101 = V_35 ;
V_102 = F_70 ( V_1 , V_101 , V_104 ) ;
while ( V_102 > 0 ) {
while ( V_102 > 0 ) {
struct V_66 V_67 ;
int V_105 ;
V_105 = F_35 ( V_101 -> V_106 , & V_67 ) ;
F_71 ( V_105 ) ;
if ( ! V_105 ) {
if ( F_36 ( V_67 . V_14 ) )
F_37 ( V_101 -> V_106 ) ;
