...
F_25 ( F_11 ( V_4 -> V_60 ) - 1 ) , & V_19 ) ;
V_31 = F_26 ( & V_19 ) ;
if ( ! V_31 ) {
V_31 = F_14 ( & V_19 , V_53 , & V_4 -> V_70 ,
F_25 ( F_11 ( V_4 -> V_71 ) - 1 ) ,
V_6 , V_4 -> V_58 ,
V_23 -> V_59 ) ;
if ( ! V_31 )
return 0 ;
...
static int T_4 F_27 ( struct V_72 * V_72 )
{
int V_20 , V_34 ;
struct V_1 * V_2 ;
struct V_73 * V_52 = F_28 ( V_72 ) ;
if ( ! V_52 )
return - V_74 ;
V_2 = F_29 ( V_52 , & V_75 ) ;
if ( F_30 ( V_2 ) )
...
if ( ! V_77 [ V_20 ] )
continue;
V_34 = F_32 ( V_52 , V_2 , V_2 -> V_54 , V_77 [ V_20 ] ) ;
if ( V_34 )
goto V_78;
F_33 ( L_7 ,
...
static void F_35 ( struct V_72 * V_72 )
{
struct V_73 * V_52 = F_28 ( V_72 ) ;
if ( ! V_52 )
return;
