...
static int F_86 ( struct V_9 * V_10 , T_3 * V_148 )
{
struct V_8 * V_40 = F_3 ( V_10 ) ;
* V_148 = 0 ;
...
continue;
if ( V_6 -> V_108 != V_153 -> V_159 )
continue;
V_156 = V_154 * F_8 ( V_6 ) ;
if ( ( V_156 < V_6 -> V_111 + 1000000 ) &&
( V_156 > V_6 -> V_111 - 1000000 ) ) {
* V_92 = V_157 [ V_4 ] ;
return 0 ;
}
}
if ( F_89 ( V_153 -> V_158 + 1 , V_154 , V_153 -> V_159 ,
( V_153 -> V_160 == '+' ? V_161 : 0 ) |
( V_153 -> V_162 == '+' ? V_163 : 0 ) ,
false , V_92 ) )
return 0 ;
if ( F_90 ( V_153 -> V_158 + 1 , V_154 , V_153 -> V_159 ,
( V_153 -> V_160 == '+' ? V_161 : 0 ) |
( V_153 -> V_162 == '+' ? V_163 : 0 ) ,
false , V_40 -> V_164 , V_92 ) )
return 0 ;
F_56 ( 2 , V_52 , V_10 ,
L_39 ,
...
static int F_91 ( struct V_9 * V_10 , struct V_152 * V_153 )
{
T_3 V_148 ;
F_86 ( V_10 , & V_148 ) ;
if ( V_148 & V_151 ) {
...
if ( V_40 -> V_57 == V_150 )
return - V_170 ;
if ( F_2 ( & V_40 -> V_92 , V_92 , 0 ) ) {
F_56 ( 1 , V_52 , V_10 , L_51 , V_53 ) ;
return 0 ;
}
V_6 = & V_92 -> V_6 ;
if ( ! F_88 ( V_92 , F_61 ( V_10 ) ,
F_1 , NULL ) )
return - V_186 ;
F_95 ( V_10 , V_92 ) ;
V_40 -> V_92 = * V_92 ;
...
struct V_224 * V_55 )
{
if ( V_55 -> V_225 >= F_58 ( V_56 ) )
return - V_78 ;
V_55 -> V_55 = V_56 [ V_55 -> V_225 ] . V_55 ;
return 0 ;
}
static void F_109 ( struct V_8 * V_40 ,
struct V_226 * V_227 )
{
memset ( V_227 , 0 , sizeof( * V_227 ) ) ;
V_227 -> V_7 = V_40 -> V_92 . V_6 . V_7 ;
V_227 -> V_99 = V_40 -> V_92 . V_6 . V_99 ;
V_227 -> V_228 = V_229 ;
V_227 -> V_230 = V_231 ;
if ( V_40 -> V_92 . V_6 . V_23 & V_130 )
V_227 -> V_230 = ( V_40 -> V_92 . V_6 . V_99 <= 576 ) ?
V_232 : V_233 ;
}
static unsigned int F_110 ( struct V_8 * V_40 )
{
#define F_111 ( T_5 , T_6 , V_189 , V_77 , T_7 , T_8 ) { \
...
#define F_112 ( T_9 ) [ADV7842_BUS_ORDER_##x]
static const unsigned int V_234 [ 6 ] [ 6 ] = {
F_112 ( V_235 ) = F_111 ( V_236 , V_237 , V_238 , V_235 , V_239 , V_240 ) ,
F_112 ( V_237 ) = F_111 ( V_238 , V_235 , V_236 , V_237 , V_240 , V_239 ) ,
F_112 ( V_240 ) = F_111 ( V_237 , V_236 , V_239 , V_240 , V_238 , V_235 ) ,
F_112 ( V_238 ) = F_111 ( V_240 , V_239 , V_235 , V_238 , V_237 , V_236 ) ,
F_112 ( V_239 ) = F_111 ( V_239 , V_240 , V_237 , V_236 , V_235 , V_238 ) ,
F_112 ( V_236 ) = F_111 ( V_235 , V_238 , V_240 , V_239 , V_236 , V_237 ) ,
} ;
return V_234 [ V_40 -> V_241 . V_242 ] [ V_40 -> V_227 -> V_234 >> 5 ] ;
}
static void F_113 ( struct V_8 * V_40 )
{
struct V_9 * V_10 = & V_40 -> V_10 ;
F_25 ( V_10 , 0x02 , 0x02 ,
V_40 -> V_227 -> V_243 ? V_244 : 0 ) ;
F_23 ( V_10 , 0x03 , V_40 -> V_227 -> V_245 |
V_40 -> V_241 . V_246 ) ;
F_25 ( V_10 , 0x04 , 0xe0 , F_110 ( V_40 ) ) ;
F_25 ( V_10 , 0x05 , 0x01 ,
V_40 -> V_227 -> V_247 ? V_248 : 0 ) ;
}
...
{
struct V_8 * V_40 = F_3 ( V_10 ) ;
if ( V_227 -> V_168 != V_250 )
return - V_78 ;
if ( V_40 -> V_57 == V_150 ) {
if ( ! ( F_36 ( V_10 , 0x5a ) & 0x01 ) )
return - V_78 ;
V_227 -> V_227 . V_55 = V_251 ;
V_227 -> V_227 . V_7 = 720 ;
if ( V_40 -> V_252 & V_253 )
V_227 -> V_227 . V_99 = 480 ;
else
V_227 -> V_227 . V_99 = 576 ;
V_227 -> V_227 . V_230 = V_232 ;
return 0 ;
}
F_109 ( V_40 , & V_227 -> V_227 ) ;
if ( V_227 -> V_254 == V_255 ) {
struct V_226 * V_256 ;
V_256 = F_115 ( V_10 , V_223 , V_227 -> V_168 ) ;
V_227 -> V_227 . V_55 = V_256 -> V_55 ;
} else {
V_227 -> V_227 . V_55 = V_40 -> V_227 -> V_55 ;
}
return 0 ;
}
...
{
struct V_8 * V_40 = F_3 ( V_10 ) ;
const struct V_54 * V_257 ;
if ( V_227 -> V_168 != V_250 )
return - V_78 ;
if ( V_40 -> V_57 == V_150 )
return F_114 ( V_10 , V_223 , V_227 ) ;
V_257 = V_54 ( V_40 , V_227 -> V_227 . V_55 ) ;
if ( V_257 == NULL )
V_257 = V_54 ( V_40 , V_251 ) ;
F_109 ( V_40 , & V_227 -> V_227 ) ;
V_227 -> V_227 . V_55 = V_257 -> V_55 ;
if ( V_227 -> V_254 == V_255 ) {
struct V_226 * V_256 ;
V_256 = F_115 ( V_10 , V_223 , V_227 -> V_168 ) ;
V_256 -> V_55 = V_227 -> V_227 . V_55 ;
} else {
V_40 -> V_227 = V_257 ;
F_113 ( V_40 ) ;
}
...
static void F_117 ( struct V_9 * V_10 , bool V_258 )
{
if ( V_258 ) {
F_23 ( V_10 , 0x46 , 0x9c ) ;
F_23 ( V_10 , 0x5a , 0x10 ) ;
...
static int F_118 ( struct V_9 * V_10 , T_3 V_148 , bool * V_259 )
{
struct V_8 * V_40 = F_3 ( V_10 ) ;
T_2 V_260 , V_261 , V_262 ;
T_2 V_263 [ 6 ] ;
F_117 ( V_10 , false ) ;
V_263 [ 0 ] = F_21 ( V_10 , 0x43 ) ;
V_263 [ 1 ] = F_21 ( V_10 , 0x57 ) ;
V_263 [ 2 ] = F_21 ( V_10 , 0x70 ) ;
V_263 [ 3 ] = F_21 ( V_10 , 0x75 ) ;
V_263 [ 4 ] = F_21 ( V_10 , 0x9d ) ;
V_263 [ 5 ] = F_21 ( V_10 , 0x66 ) ;
if ( V_263 [ 0 ] )
F_23 ( V_10 , 0x44 , V_263 [ 0 ] ) ;
if ( V_263 [ 1 ] )
F_23 ( V_10 , 0x58 , V_263 [ 1 ] ) ;
if ( V_263 [ 2 ] )
F_23 ( V_10 , 0x71 , V_263 [ 2 ] ) ;
if ( V_263 [ 3 ] )
F_23 ( V_10 , 0x76 , V_263 [ 3 ] ) ;
if ( V_263 [ 4 ] )
F_23 ( V_10 , 0x9e , V_263 [ 4 ] ) ;
if ( V_263 [ 5 ] )
F_23 ( V_10 , 0x67 , V_263 [ 5 ] ) ;
F_117 ( V_10 , true ) ;
F_56 ( 1 , V_52 , V_10 , L_54 , V_53 ,
V_263 [ 0 ] , V_263 [ 1 ] , V_263 [ 2 ] ,
V_263 [ 3 ] , V_263 [ 4 ] , V_263 [ 5 ] ) ;
V_260 = V_263 [ 0 ] & 0x9c ;
if ( V_40 -> V_57 == V_150 )
V_262 = ( V_263 [ 1 ] & 0x30 ) | ( V_263 [ 4 ] & 0x09 ) ;
else
V_262 = 0 ;
if ( F_60 ( V_10 ) )
V_261 = V_263 [ 3 ] & 0x03 ;
...
static int F_119 ( struct V_9 * V_10 , struct V_264 * V_74 )
{
struct V_8 * V_40 = F_3 ( V_10 ) ;
T_2 * V_20 = NULL ;
memset ( V_74 -> V_265 , 0 , sizeof( V_74 -> V_265 ) ) ;
switch ( V_74 -> V_168 ) {
case V_71 :
case V_72 :
...
if ( V_74 -> V_267 >= 2 )
return - V_78 ;
if ( V_74 -> V_267 + V_74 -> V_268 > 2 )
V_74 -> V_268 = 2 - V_74 -> V_267 ;
memcpy ( V_74 -> V_74 , V_20 + V_74 -> V_267 * 128 , V_74 -> V_268 * 128 ) ;
return 0 ;
}
static int F_120 ( struct V_9 * V_10 , struct V_264 * T_7 )
{
struct V_8 * V_40 = F_3 ( V_10 ) ;
int V_30 = 0 ;
memset ( T_7 -> V_265 , 0 , sizeof( T_7 -> V_265 ) ) ;
if ( T_7 -> V_168 > V_266 )
return - V_78 ;
if ( T_7 -> V_267 != 0 )
return - V_78 ;
...
V_40 -> V_164 = F_121 ( T_7 -> V_74 [ 0x15 ] ,
T_7 -> V_74 [ 0x16 ] ) ;
switch ( T_7 -> V_168 ) {
case V_266 :
memset ( & V_40 -> V_73 . V_74 , 0 , 256 ) ;
V_40 -> V_73 . V_69 = T_7 -> V_268 ? 0x1 : 0x0 ;
memcpy ( & V_40 -> V_73 . V_74 , T_7 -> V_74 , 128 * T_7 -> V_268 ) ;
V_30 = F_64 ( V_10 ) ;
break;
case V_71 :
case V_72 :
...
if ( T_7 -> V_268 )
V_40 -> V_70 . V_69 |= 0x04 << T_7 -> V_168 ;
else
V_40 -> V_70 . V_69 &= ~ ( 0x04 << T_7 -> V_168 ) ;
memcpy ( & V_40 -> V_70 . V_74 , T_7 -> V_74 , 128 * T_7 -> V_268 ) ;
V_30 = F_67 ( V_10 , T_7 -> V_168 ) ;
break;
default:
return - V_78 ;
}
if ( V_30 < 0 )
F_78 ( V_10 , L_60 , V_30 , T_7 -> V_168 ) ;
return V_30 ;
}
static void F_122 ( struct V_9 * V_10 , struct V_270 * V_271 )
{
int V_4 ;
T_2 V_272 [ 32 ] ;
union V_273 V_274 ;
T_2 V_81 ;
struct V_15 * V_16 = F_22 ( V_10 ) ;
struct V_275 * V_276 = & V_16 -> V_276 ;
if ( ! ( F_21 ( V_10 , 0x60 ) & V_271 -> V_277 ) ) {
F_69 ( V_10 , L_61 , V_271 -> V_278 ) ;
return;
}
for ( V_4 = 0 ; V_4 < 3 ; V_4 ++ )
V_272 [ V_4 ] = F_31 ( V_10 , V_271 -> V_279 + V_4 ) ;
V_81 = V_272 [ 2 ] + 1 ;
if ( V_81 + 3 > sizeof( V_272 ) ) {
F_78 ( V_10 , L_62 , V_53 , V_271 -> V_278 , V_81 ) ;
return;
}
for ( V_4 = 0 ; V_4 < V_81 ; V_4 ++ )
V_272 [ V_4 + 3 ] = F_31 ( V_10 , V_271 -> V_280 + V_4 ) ;
if ( F_123 ( & V_274 , V_272 ) < 0 ) {
F_78 ( V_10 , L_63 , V_53 , V_271 -> V_278 ) ;
return;
}
F_124 ( V_281 , V_276 , & V_274 ) ;
}
...
for ( V_4 = 0 ; V_4 < F_58 ( V_271 ) ; V_4 ++ )
F_122 ( V_10 , & V_271 [ V_4 ] ) ;
}
static int F_126 ( struct V_9 * V_10 )
{
T_2 V_282 = F_36 ( V_10 , 0x5A ) & 0x01 ;
F_69 ( V_10 , L_69 , F_83 ( V_10 ) ? L_70 : L_71 ) ;
F_69 ( V_10 , L_72 ,
F_21 ( V_10 , 0x01 ) & 0x0f , F_21 ( V_10 , 0x00 ) & 0x3f ) ;
F_69 ( V_10 , L_73 ,
( F_36 ( V_10 , 0x56 ) & 0x01 ) ? L_71 : L_70 ) ;
F_69 ( V_10 , L_74 , V_282 ?
L_75 : L_76 ) ;
if ( V_282 ) {
...
struct V_8 * V_40 = F_3 ( V_10 ) ;
struct V_1 V_92 ;
T_2 V_284 = F_21 ( V_10 , 0x02 ) ;
T_2 V_285 = F_21 ( V_10 , 0x21 ) ;
T_2 V_286 = F_42 ( V_10 , 0x77 ) ;
T_2 V_287 = F_42 ( V_10 , 0x7d ) ;
bool V_288 = F_47 ( V_10 , 0x04 ) & 0x01 ;
bool V_289 = F_47 ( V_10 , 0x18 ) & 0x01 ;
bool V_290 = F_21 ( V_10 , 0x65 ) & 0x40 ;
static const char * const V_291 [ 16 ] = {
...
static const char * const V_294 [ 4 ] = {
L_123 ,
L_124 ,
L_125 ,
L_126
...
F_69 ( V_10 , L_127 ) ;
F_69 ( V_10 , L_128 , F_83 ( V_10 ) ? L_70 : L_71 ) ;
F_69 ( V_10 , L_129 ,
V_40 -> V_207 ? L_130 : L_131 ) ;
F_69 ( V_10 , L_132 ,
( ( V_287 & 0x04 ) && ( V_286 & 0x04 ) ) ?
L_99 : L_100 ,
( ( V_287 & 0x08 ) && ( V_286 & 0x08 ) ) ?
L_99 : L_100 ) ;
F_69 ( V_10 , L_133 ,
V_285 & 0x02 ? L_99 : L_100 ,
V_285 & 0x01 ? L_99 : L_100 ) ;
...
T_3 V_295 = ( ( F_50 ( V_10 , 0xb8 ) & 0x1f ) << 8 ) | F_50 ( V_10 , 0xb9 ) ;
...
F_98 ( V_10 -> V_187 , L_148 ,
& V_92 , true ) ;
F_98 ( V_10 -> V_187 , L_149 ,
& V_40 -> V_92 , true ) ;
if ( F_84 ( V_10 ) )
return 0 ;
F_69 ( V_10 , L_150 ) ;
...
V_292 [ V_284 >> 4 ] ) ;
F_69 ( V_10 , L_153 ,
( V_284 & 0x02 ) ? L_154 : L_155 ,
( V_284 & 0x04 ) ? L_156 : L_157 ,
( ( V_284 & 0x04 ) ^ ( V_284 & 0x01 ) ) ?
L_99 : L_100 ) ;
F_69 ( V_10 , L_158 ,
V_291 [ F_50 ( V_10 , 0xf4 ) >> 4 ] ) ;
if ( ! F_60 ( V_10 ) )
return 0 ;
F_69 ( V_10 , L_159 , F_85 ( V_10 ) ? L_57 : L_160 ) ;
F_69 ( V_10 , L_161 ,
...
static int F_129 ( struct V_9 * V_10 , T_10 * V_296 )
{
struct V_8 * V_40 = F_3 ( V_10 ) ;
F_56 ( 1 , V_52 , V_10 , L_5 , V_53 ) ;
if ( V_40 -> V_57 != V_150 )
...
static void F_130 ( struct V_9 * V_10 , struct V_305 * V_306 )
{
if ( V_306 && V_306 -> V_307 ) {
F_34 ( V_10 , 0x94 , ( V_306 -> V_308 >> 8 ) & 0xf ) ;
F_34 ( V_10 , 0x95 , V_306 -> V_308 & 0xff ) ;
F_34 ( V_10 , 0x96 , ( V_306 -> V_309 >> 8 ) & 0xf ) ;
F_34 ( V_10 , 0x97 , V_306 -> V_309 & 0xff ) ;
F_34 ( V_10 , 0x98 , ( V_306 -> V_310 >> 8 ) & 0xf ) ;
F_34 ( V_10 , 0x99 , V_306 -> V_310 & 0xff ) ;
F_34 ( V_10 , 0x9a , ( V_306 -> V_311 >> 8 ) & 0xf ) ;
F_34 ( V_10 , 0x9b , V_306 -> V_311 & 0xff ) ;
F_34 ( V_10 , 0xa8 , V_306 -> V_312 ) ;
F_34 ( V_10 , 0xa9 , V_306 -> V_313 ) ;
F_34 ( V_10 , 0xaa , V_306 -> V_314 ) ;
F_34 ( V_10 , 0xab , V_306 -> V_315 ) ;
F_34 ( V_10 , 0xac , V_306 -> V_316 ) ;
F_34 ( V_10 , 0xad , V_306 -> V_317 ) ;
F_34 ( V_10 , 0xae , V_306 -> V_318 ) ;
F_34 ( V_10 , 0xaf , V_306 -> V_319 ) ;
} else {
F_34 ( V_10 , 0x94 , 0x00 ) ;
F_34 ( V_10 , 0x95 , 0x00 ) ;
F_34 ( V_10 , 0x96 , 0x00 ) ;
...
static int F_131 ( struct V_9 * V_10 , T_10 V_252 )
{
struct V_8 * V_40 = F_3 ( V_10 ) ;
struct V_320 * V_241 = & V_40 -> V_241 ;
F_56 ( 1 , V_52 , V_10 , L_5 , V_53 ) ;
if ( V_40 -> V_57 != V_150 )
return - V_170 ;
if ( V_252 & V_321 )
F_130 ( V_10 , & V_241 -> V_322 ) ;
else if ( V_252 & V_253 )
F_130 ( V_10 , & V_241 -> V_323 ) ;
else
F_130 ( V_10 , NULL ) ;
if ( V_252 & V_304 ) {
V_40 -> V_252 = V_252 ;
...
static int F_132 ( struct V_9 * V_10 , T_10 * V_252 )
{
struct V_8 * V_40 = F_3 ( V_10 ) ;
F_56 ( 1 , V_52 , V_10 , L_5 , V_53 ) ;
if ( V_40 -> V_57 != V_150 )
...
V_241 -> V_327 << 2 |
V_241 -> V_328 << 0 ) ;
F_24 ( V_10 , 0x05 , 0xf0 , V_241 -> V_329 << 3 |
V_241 -> V_330 << 2 |
V_241 -> V_331 << 1 ) ;
F_113 ( V_40 ) ;
...
V_241 -> V_333 << 2 |
V_241 -> V_334 ) ;
F_52 ( V_10 , 0xba , 0xfc , V_241 -> V_335 |
( V_241 -> V_336 << 1 ) ) ;
F_38 ( V_10 , 0xdd , 0xf0 , V_241 -> V_337 |
( V_241 -> V_338 << 1 ) |
( V_241 -> V_339 << 2 ) |
( V_241 -> V_340 << 3 ) ) ;
F_51 ( V_10 , 0x69 , 0x14 ) ;
...
F_51 ( V_10 , 0xf3 , 0xdc ) ;
F_40 ( V_10 , 0xb5 , 0x01 ) ;
F_40 ( V_10 , 0x02 , V_241 -> V_341 ) ;
F_24 ( V_10 , 0x30 , ~ ( 1 << 4 ) , V_241 -> V_342 << 4 ) ;
F_104 ( V_10 , & V_241 -> F_104 ) ;
if ( V_241 -> V_343 >= 128 ) {
F_37 ( V_10 , 0x12 , 0x0d ) ;
if ( V_241 -> V_344 ) {
F_34 ( V_10 , 0x6f , 0x00 ) ;
...
F_23 ( V_10 , 0x19 , 0x80 | V_241 -> V_346 ) ;
F_23 ( V_10 , 0x33 , 0x40 ) ;
F_23 ( V_10 , 0x40 , 0xf2 ) ;
F_117 ( V_10 , true ) ;
return F_134 ( V_10 -> V_347 ) ;
}
...
struct V_320 * V_241 )
{
F_23 ( V_10 , 0xf1 , V_241 -> V_45 << 1 ) ;
F_23 ( V_10 , 0xf2 , V_241 -> V_44 << 1 ) ;
F_23 ( V_10 , 0xf3 , V_241 -> V_41 << 1 ) ;
F_23 ( V_10 , 0xf4 , V_241 -> V_42 << 1 ) ;
F_23 ( V_10 , 0xf5 , V_241 -> V_43 << 1 ) ;
F_23 ( V_10 , 0xf8 , V_241 -> V_46 << 1 ) ;
F_23 ( V_10 , 0xf9 , V_241 -> V_47 << 1 ) ;
F_23 ( V_10 , 0xfa , V_241 -> V_48 << 1 ) ;
F_23 ( V_10 , 0xfb , V_241 -> V_49 << 1 ) ;
F_23 ( V_10 , 0xfd , V_241 -> V_50 << 1 ) ;
F_23 ( V_10 , 0xfe , V_241 -> V_51 << 1 ) ;
}
static int F_137 ( struct V_9 * V_10 )
{
struct V_15 * V_16 = F_22 ( V_10 ) ;
struct V_8 * V_40 = F_3 ( V_10 ) ;
struct V_320 * V_241 = V_16 -> V_276 . V_352 ;
struct V_1 V_92 ;
int V_28 = 0 ;
if ( ! V_241 )
return - V_353 ;
if ( ! V_241 -> V_343 || ! V_241 -> V_344 ) {
F_69 ( V_10 , L_181 ) ;
return - V_78 ;
}
F_55 ( V_10 ) ;
...
static long F_138 ( struct V_9 * V_10 , unsigned int V_354 , void * V_355 )
{
switch ( V_354 ) {
case V_356 :
return F_137 ( V_10 ) ;
...
static struct V_15 * F_141 ( struct V_9 * V_10 , const char * V_278 ,
T_2 V_22 , T_2 V_358 )
{
struct V_15 * V_16 = F_22 ( V_10 ) ;
struct V_15 * V_359 ;
F_23 ( V_10 , V_358 , V_22 << 1 ) ;
if ( V_22 == 0 ) {
F_78 ( V_10 , L_182 , V_278 ) ;
return NULL ;
}
V_359 = F_142 ( V_16 -> V_21 , F_21 ( V_10 , V_358 ) >> 1 ) ;
if ( ! V_359 )
F_78 ( V_10 , L_183 , V_278 , V_22 ) ;
return V_359 ;
}
...
struct V_8 * V_40 = F_3 ( V_10 ) ;
struct V_320 * V_241 = & V_40 -> V_241 ;
V_40 -> V_41 = F_141 ( V_10 , L_184 , V_241 -> V_41 , 0xf3 ) ;
V_40 -> V_42 = F_141 ( V_10 , L_185 , V_241 -> V_42 , 0xf4 ) ;
V_40 -> V_43 = F_141 ( V_10 , L_186 , V_241 -> V_43 , 0xf5 ) ;
V_40 -> V_44 = F_141 ( V_10 , L_187 , V_241 -> V_44 , 0xf2 ) ;
V_40 -> V_45 = F_141 ( V_10 , L_188 , V_241 -> V_45 , 0xf1 ) ;
V_40 -> V_46 = F_141 ( V_10 , L_189 , V_241 -> V_46 , 0xf8 ) ;
V_40 -> V_47 = F_141 ( V_10 , L_190 , V_241 -> V_47 , 0xf9 ) ;
V_40 -> V_48 = F_141 ( V_10 , L_191 , V_241 -> V_48 , 0xfa ) ;
V_40 -> V_49 = F_141 ( V_10 , L_192 , V_241 -> V_49 , 0xfb ) ;
V_40 -> V_50 = F_141 ( V_10 , L_193 , V_241 -> V_50 , 0xfd ) ;
V_40 -> V_51 = F_141 ( V_10 , L_194 , V_241 -> V_51 , 0xfe ) ;
if ( ! V_40 -> V_41 ||
! V_40 -> V_42 ||
! V_40 -> V_43 ||
! V_40 -> V_44 ||
...
const struct V_360 * V_133 )
{
struct V_8 * V_40 ;
static const struct V_1 V_361 =
V_362 ;
struct V_320 * V_241 = V_16 -> V_276 . V_352 ;
struct V_363 * V_3 ;
struct V_9 * V_10 ;
T_4 V_364 ;
int V_30 ;
if ( ! F_145 ( V_16 -> V_21 , V_365 ) )
return - V_27 ;
F_146 ( 1 , V_52 , V_16 , L_195 ,
V_16 -> V_22 << 1 ) ;
if ( ! V_241 ) {
F_16 ( V_16 , L_196 ) ;
return - V_353 ;
}
V_40 = F_147 ( & V_16 -> V_276 , sizeof( struct V_8 ) , V_366 ) ;
if ( ! V_40 ) {
F_16 ( V_16 , L_197 ) ;
return - V_367 ;
}
V_40 -> V_241 = * V_241 ;
V_40 -> V_92 = V_361 ;
V_40 -> V_227 = V_54 ( V_40 , V_251 ) ;
V_10 = & V_40 -> V_10 ;
F_148 ( V_10 , V_16 , & V_368 ) ;
V_10 -> V_23 |= V_369 ;
V_40 -> V_57 = V_241 -> V_57 ;
V_40 -> V_207 = V_241 -> V_208 == V_211 ;
V_40 -> V_171 = true ;
V_364 = F_14 ( V_16 , 0xea , false ) << 8 |
F_14 ( V_16 , 0xeb , false ) ;
if ( V_364 != 0x2012 ) {
F_69 ( V_10 , L_198 , V_364 ) ;
V_364 = F_14 ( V_16 , 0xea , false ) << 8 |
F_14 ( V_16 , 0xeb , false ) ;
}
if ( V_364 != 0x2012 ) {
...
F_150 ( V_3 , & V_371 ,
V_137 , 0 , 128 , 1 , 0 ) ;
V_40 -> V_87 = F_150 ( V_3 , NULL ,
V_372 , 0 , 3 , 0 , 0 ) ;
V_40 -> V_373 = F_151 ( V_3 ,
& V_374 , NULL ) ;
V_40 -> V_375 = F_151 ( V_3 ,
& V_376 , NULL ) ;
V_40 -> V_377 = F_151 ( V_3 ,
& V_378 , NULL ) ;
V_40 -> V_379 =
F_152 ( V_3 , & V_371 ,
V_147 , V_132 ,
...
V_40 -> V_87 -> V_381 = true ;
V_40 -> V_379 -> V_381 = true ;
V_40 -> V_373 -> V_381 = true ;
V_40 -> V_375 -> V_381 = true ;
V_40 -> V_377 -> V_381 = true ;
if ( F_72 ( V_10 ) ) {
V_30 = - V_353 ;
goto V_380;
}
...
F_154 ( & V_40 -> V_68 ,
F_62 ) ;
V_40 -> V_168 . V_23 = V_383 ;
V_30 = F_155 ( & V_10 -> V_384 , 1 , & V_40 -> V_168 , 0 ) ;
if ( V_30 )
goto V_385;
V_30 = F_133 ( V_10 ) ;
if ( V_30 )
goto V_386;
F_69 ( V_10 , L_202 , V_16 -> V_187 ,
