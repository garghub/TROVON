...
if ( V_69 )
goto V_97;
if ( ! F_44 ( V_55 , V_96 , V_57 , V_75 ) )
goto V_98;
if ( F_45 ( V_55 , V_96 , V_75 ) < 0 )
goto V_98;
* type = V_75 ;
return 0 ;
V_98:
...
void F_46 ( T_4 V_55 , T_4 V_56 )
{
F_38 ( V_55 , V_56 ) ;
}
T_5 F_47 ( struct V_99 * V_99 , unsigned long V_76 ,
unsigned long V_96 , T_5 V_100 )
{
return V_100 ;
}
static inline int F_48 ( unsigned long V_76 , unsigned long V_96 )
{
return 1 ;
}
static inline int F_48 ( unsigned long V_76 , unsigned long V_96 )
...
int F_50 ( struct V_99 * V_99 , unsigned long V_76 ,
unsigned long V_96 , T_5 * V_100 )
{
enum V_5 V_104 = V_12 ;
if ( ! F_48 ( V_76 , V_96 ) )
...
F_52 ( V_109 ) ||
F_52 ( V_110 ) ) &&
( V_76 << V_71 ) >= F_53 ( V_111 ) ) {
V_104 = V_79 ;
}
#endif
* V_100 = F_54 ( ( F_55 ( * V_100 ) & ~ V_112 ) |
F_56 ( V_104 ) ) ;
return 1 ;
}
int F_45 ( T_2 V_113 , unsigned long V_96 ,
enum V_5 V_104 )
{
unsigned long V_114 ;
if ( V_113 > F_53 ( V_111 - 1 ) )
return 0 ;
if ( ! F_57 ( V_113 >> V_71 ) )
return 0 ;
V_114 = ( F_53 ( V_111 - 1 ) <= V_113 + V_96 ) ?
F_53 ( V_111 ) - V_113 :
V_96 ;
if ( F_58 ( ( unsigned long ) F_59 ( V_113 ) , V_114 , V_104 ) < 0 ) {
F_2 ( L_20 ,
V_91 -> V_92 , V_91 -> V_93 ,
F_34 ( V_104 ) ,
...
static int F_60 ( T_2 V_94 , unsigned long V_96 , T_5 * V_100 ,
int V_115 )
{
int V_116 = 0 ;
int V_69 ;
enum V_5 V_117 = F_61 ( * V_100 ) ;
...
if ( F_45 ( V_94 , V_96 , V_104 ) < 0 ) {
F_38 ( V_94 , V_94 + V_96 ) ;
return - V_78 ;
}
return 0 ;
}
static void F_64 ( T_2 V_94 , unsigned long V_96 )
{
int V_116 ;
V_116 = F_23 ( V_94 , V_94 + V_96 ) ;
if ( V_116 == 0 )
...
if ( F_66 ( V_119 , V_119 -> V_123 , 0 , & V_120 , & V_94 ) ) {
F_26 ( 1 ) ;
return - V_78 ;
}
V_124 = F_54 ( V_120 ) ;
return F_60 ( V_94 , V_121 , & V_124 , 1 ) ;
}
return 0 ;
}
int F_67 ( struct V_118 * V_119 , T_5 * V_120 ,
...
* V_120 = F_54 ( ( F_55 ( V_119 -> V_128 ) & ( ~ V_112 ) ) |
F_56 ( V_104 ) ) ;
return 0 ;
}
...
if ( ! F_4 () )
return 0 ;
V_104 = F_40 ( ( T_4 ) V_76 << V_71 ) ;
* V_120 = F_54 ( ( F_55 ( V_119 -> V_128 ) & ( ~ V_112 ) ) |
F_56 ( V_104 ) ) ;
return 0 ;
}
void F_69 ( struct V_118 * V_119 , unsigned long V_76 ,
unsigned long V_96 )
{
T_4 V_94 ;
unsigned long V_120 ;
...
static struct V_18 * F_72 ( T_6 V_129 )
{
struct V_18 * V_130 ;
int V_69 ;
...
static void * F_74 ( struct V_131 * V_132 , T_6 * V_129 )
{
if ( * V_129 == 0 ) {
++ * V_129 ;
F_75 ( V_132 , L_23 ) ;
...
static void * F_76 ( struct V_131 * V_132 , void * V_133 , T_6 * V_129 )
{
++ * V_129 ;
return F_72 ( * V_129 ) ;
}
static void F_77 ( struct V_131 * V_132 , void * V_133 )
{
}
static int F_78 ( struct V_131 * V_132 , void * V_133 )
{
struct V_18 * V_130 = (struct V_18 * ) V_133 ;
F_79 ( V_132 , L_24 , F_34 ( V_130 -> type ) ,
V_130 -> V_55 , V_130 -> V_56 ) ;
F_35 ( V_130 ) ;
return 0 ;
}
static int F_80 ( struct V_134 * V_134 , struct V_99 * V_99 )
{
return F_81 ( V_99 , & V_135 ) ;
}
