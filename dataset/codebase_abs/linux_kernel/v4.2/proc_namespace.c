...
int V_47 = 0 ;
struct V_48 V_49 = { . V_50 = V_32 -> V_51 , . V_32 = V_32 } ;
struct V_19 * V_20 = V_49 . V_50 -> V_52 ;
if ( V_20 -> V_53 -> V_54 ) {
V_47 = V_20 -> V_53 -> V_54 ( V_4 , V_49 . V_50 ) ;
if ( V_47 )
goto V_55;
} else {
...
F_11 ( V_4 , ' ' ) ;
V_47 = F_14 ( V_4 , & V_49 , & V_7 -> V_57 , L_11 ) ;
if ( V_47 )
goto V_55;
F_11 ( V_4 , ' ' ) ;
F_10 ( V_4 , V_20 ) ;
...
F_7 ( V_4 , V_32 ) ;
if ( V_20 -> V_53 -> V_58 )
V_47 = V_20 -> V_53 -> V_58 ( V_4 , V_49 . V_50 ) ;
F_5 ( V_4 , L_15 ) ;
V_55:
return V_47 ;
}
...
if ( V_20 -> V_53 -> V_63 )
V_47 = V_20 -> V_53 -> V_63 ( V_4 , V_32 -> V_51 ) ;
else
F_20 ( V_4 , V_32 -> V_51 , L_11 ) ;
if ( V_47 )
goto V_55;
F_11 ( V_4 , ' ' ) ;
V_47 = F_14 ( V_4 , & V_49 , & V_7 -> V_57 , L_11 ) ;
...
F_11 ( V_4 , ' ' ) ;
if ( V_20 -> V_53 -> V_54 )
V_47 = V_20 -> V_53 -> V_54 ( V_4 , V_32 -> V_51 ) ;
else
F_8 ( V_4 , V_46 -> V_56 ? V_46 -> V_56 : L_12 ) ;
if ( V_47 )
goto V_55;
...
goto V_55;
if ( V_20 -> V_53 -> V_58 )
V_47 = V_20 -> V_53 -> V_58 ( V_4 , V_32 -> V_51 ) ;
F_11 ( V_4 , '\n' ) ;
V_55:
return V_47 ;
}
...
F_11 ( V_4 , ' ' ) ;
if ( ! V_47 )
V_47 = V_20 -> V_53 -> V_70 ( V_4 , V_49 . V_50 ) ;
}
F_11 ( V_4 , '\n' ) ;
V_55:
return V_47 ;
