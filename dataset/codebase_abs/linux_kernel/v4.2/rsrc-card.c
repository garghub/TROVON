...
static int F_22 ( struct V_34 * V_36 ,
struct V_6 * V_7 ,
int V_37 , bool V_38 )
{
struct V_14 * V_15 = F_8 ( V_7 , V_37 ) ;
struct V_9 * V_10 = F_3 ( V_7 , V_37 ) ;
struct V_11 * V_11 ;
struct V_34 * V_77 = V_38 ? V_15 -> V_54 :
V_15 -> V_50 ;
T_1 V_78 ;
if ( F_23 ( V_36 , L_9 ) ) {
V_11 = F_24 ( V_36 , 0 ) ;
...
return - V_44 ;
V_16 = F_32 ( V_35 ) ;
V_79 = F_33 ( V_23 , sizeof( * V_79 ) * V_16 , V_82 ) ;
V_80 = F_33 ( V_23 , sizeof( * V_80 ) * V_16 , V_82 ) ;
if ( ! V_79 || ! V_80 )
return - V_83 ;
V_7 -> V_10 = V_79 ;
V_7 -> V_15 = V_80 ;
...
V_7 -> V_85 . V_86 = V_87 ;
V_7 -> V_85 . V_23 = V_23 ;
V_7 -> V_85 . V_15 = V_7 -> V_15 ;
V_7 -> V_85 . V_88 = V_16 ;
V_7 -> V_85 . V_65 = & V_7 -> V_65 ;
V_7 -> V_85 . V_89 = 1 ;
V_7 -> V_85 . V_90 = V_61 -> V_91 ;
V_7 -> V_85 . V_92 = V_61 -> V_93 ;
F_34 ( & V_7 -> V_85 , L_13 ) ;
F_28 ( V_35 , L_14 , & V_7 -> V_31 ) ;
F_30 ( V_23 , L_15 ,
V_7 -> V_85 . V_72 ? V_7 -> V_85 . V_72 : L_16 ,
V_7 -> V_31 ) ;
V_81 = 0 ;
F_35 (node, np) {
V_17 = F_29 ( V_35 , V_36 , V_7 , V_81 ) ;
if ( V_17 < 0 )
return V_17 ;
V_81 ++ ;
}
if ( ! V_7 -> V_85 . V_72 )
V_7 -> V_85 . V_72 = V_7 -> V_85 . V_15 -> V_72 ;
return 0 ;
}
static int F_36 ( struct V_94 * V_8 )
{
struct V_14 * V_15 ;
int V_88 ;
...
int V_17 ;
V_7 = F_33 ( V_23 , sizeof( * V_7 ) , V_82 ) ;
if ( ! V_7 )
return - V_83 ;
V_17 = F_31 ( V_36 , V_7 , V_23 ) ;
if ( V_17 < 0 ) {
if ( V_17 != - V_97 )
F_10 ( V_23 , L_17 , V_17 ) ;
goto V_24;
