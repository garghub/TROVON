...
V_53 = ( ( ( V_2 -> V_59 - 1 ) / F_48 ( V_2 -> V_27 ) ) *
F_48 ( V_2 -> V_27 ) ) + 1 ;
V_54 [ 0 ] = F_49 ( V_2 ) ;
V_54 [ 1 ] = F_50 ( V_2 ) ;
V_34 = F_51 ( V_1 , F_52 ( V_2 -> V_27 -> V_60 ) ,
V_61 , NULL , V_53 , V_54 ) ;
if ( F_8 ( V_34 ) ) {
V_5 = F_9 ( V_34 ) ;
F_53 ( V_1 ) ;
...
{
struct V_49 * V_50 ;
struct V_64 * V_65 = F_66 ( V_2 -> V_27 ) -> V_66 ;
struct V_35 * V_36 = F_6 ( V_2 ) ;
struct V_7 * V_67 ;
unsigned int V_25 , V_68 ;
T_6 V_69 , V_70 ;
T_2 V_71 ;
T_1 * V_1 ;
int V_72 ;
...
for ( V_25 = V_69 ; V_25 <= V_70 ; V_25 ++ )
V_36 -> V_24 [ V_25 ] = F_2 ( V_71 ++ ) ;
F_37 ( V_1 , V_2 ) ;
V_76:
F_53 ( V_1 ) ;
F_12 ( & F_6 ( V_2 ) -> V_16 ) ;
