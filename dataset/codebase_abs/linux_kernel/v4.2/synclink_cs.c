...
V_206 = F_163 ( & V_1 -> V_27 , V_10 , V_322 ) ;
if ( V_206 ) {
if ( V_21 >= V_22 )
F_9 ( L_86 ,
...
static inline void F_164 ( struct V_338 * V_339 , T_1 * V_1 )
{
char V_340 [ 30 ] ;
unsigned long V_12 ;
F_165 ( V_339 , L_88 ,
...
if ( V_1 -> V_106 . V_201 )
F_165 ( V_339 , L_96 , V_1 -> V_106 . V_201 ) ;
if ( V_1 -> V_106 . V_200 )
F_165 ( V_339 , L_97 , V_1 -> V_106 . V_200 ) ;
if ( V_1 -> V_106 . V_342 )
F_165 ( V_339 , L_98 , V_1 -> V_106 . V_342 ) ;
if ( V_1 -> V_106 . V_343 )
F_165 ( V_339 , L_99 , V_1 -> V_106 . V_343 ) ;
if ( V_1 -> V_106 . V_344 )
F_165 ( V_339 , L_100 , V_1 -> V_106 . V_344 ) ;
if ( V_1 -> V_106 . V_345 )
F_165 ( V_339 , L_101 , V_1 -> V_106 . V_345 ) ;
} else {
F_165 ( V_339 , L_102 ,
V_1 -> V_106 . V_299 , V_1 -> V_106 . V_117 ) ;
if ( V_1 -> V_106 . V_122 )
F_165 ( V_339 , L_103 , V_1 -> V_106 . V_122 ) ;
if ( V_1 -> V_106 . V_121 )
F_165 ( V_339 , L_104 , V_1 -> V_106 . V_121 ) ;
if ( V_1 -> V_106 . V_127 )
F_165 ( V_339 , L_105 , V_1 -> V_106 . V_127 ) ;
if ( V_1 -> V_106 . V_128 )
F_165 ( V_339 , L_106 , V_1 -> V_106 . V_128 ) ;
}
F_165 ( V_339 , L_107 , V_340 + 1 ) ;
F_165 ( V_339 , L_108 ,
V_1 -> V_129 , V_1 -> V_84 , V_1 -> V_83 ,
V_1 -> V_79 ) ;
}
static int F_166 ( struct V_338 * V_339 , void * V_346 )
{
T_1 * V_1 ;
F_165 ( V_339 , L_109 , V_347 ) ;
V_1 = V_329 ;
while ( V_1 ) {
F_164 ( V_339 , V_1 ) ;
V_1 = V_1 -> V_330 ;
...
static int F_167 ( struct V_348 * V_348 , struct V_321 * V_321 )
{
return F_168 ( V_321 , F_166 , NULL ) ;
}
...
goto V_47;
#endif
V_353 = F_174 ( & V_1 -> V_27 , V_356 , V_1 -> line ,
& V_1 -> V_45 -> V_357 ) ;
if ( F_175 ( V_353 ) ) {
V_20 = F_176 ( V_353 ) ;
#if V_140
...
static void F_189 ( T_1 * V_1 , unsigned char V_2 , unsigned int V_378 )
{
...
if ( V_1 -> V_39 . V_131 == V_145 && V_1 -> V_39 . V_383 )
F_189 ( V_1 , V_8 , V_1 -> V_39 . V_383 ) ;
else
F_189 ( V_1 , V_8 , 921600 ) ;
}
...
if ( V_1 -> V_39 . V_383 )
F_189 ( V_1 , V_4 , V_1 -> V_39 . V_383 ) ;
else
F_189 ( V_1 , V_4 , 1843200 ) ;
...
if ( V_1 -> V_39 . V_12 & V_391 )
F_189 ( V_1 , V_4 , V_1 -> V_39 . V_383 * 16 ) ;
else
F_189 ( V_1 , V_4 , V_1 -> V_39 . V_383 ) ;
...
F_189 ( V_1 , V_4 , V_1 -> V_39 . V_234 * 16 ) ;
V_252 = 0x00 ;
if ( V_1 -> V_39 . V_222 != 8 )
V_252 |= V_186 ;
if ( V_1 -> V_39 . V_227 != 1 )
...
static bool F_196 ( T_1 * V_1 )
{
static unsigned char V_440 [] =
{ 0x00 , 0xff , 0xaa , 0x55 , 0x69 , 0x96 , 0x0f } ;
static unsigned int V_13 = F_197 ( V_440 ) ;
unsigned int V_70 ;
bool V_78 = true ;
unsigned long V_12 ;
F_38 ( & V_1 -> V_37 , V_12 ) ;
...
static void F_194 ( T_1 * V_1 , const char * V_11 , int V_13 , int V_449 )
{
int V_70 ;
int V_450 ;
if ( V_449 )
...
static int F_199 ( struct V_453 * V_357 , unsigned short V_396 ,
...
static T_8 F_201 ( struct V_467 * V_468 ,
struct V_453 * V_357 )
{
T_1 * V_1 = F_200 ( V_357 ) ;
unsigned long V_12 ;
...
F_202 ( V_357 ) ;
F_203 ( V_468 , V_1 -> V_148 , V_468 -> V_469 ) ;
V_1 -> V_135 = 0 ;
...
static int F_205 ( struct V_453 * V_357 )
{
T_1 * V_1 = F_200 ( V_357 ) ;
struct V_9 * V_10 ;
int V_78 ;
...
static int F_208 ( struct V_453 * V_357 )
{
T_1 * V_1 = F_200 ( V_357 ) ;
struct V_9 * V_10 = F_45 ( & V_1 -> V_27 ) ;
unsigned long V_12 ;
...
static int F_210 ( struct V_453 * V_357 , struct V_475 * V_476 , int V_73 )
{
...
if ( F_212 ( line , & V_479 , V_477 ) )
return - V_247 ;
return 0 ;
case V_485 :
if( ! F_84 ( V_498 ) )
return - V_499 ;
if ( F_213 ( & V_479 , line , V_477 ) )
return - V_247 ;
switch ( V_479 . V_491 )
{
...
static void F_214 ( struct V_453 * V_357 )
{
T_1 * V_1 = F_200 ( V_357 ) ;
unsigned long V_12 ;
if ( V_21 >= V_22 )
...
static void F_195 ( T_1 * V_1 , char * V_96 , int V_477 )
{
struct V_467 * V_468 = F_217 ( V_477 ) ;
...
memcpy ( F_218 ( V_468 , V_477 ) , V_96 , V_477 ) ;
V_468 -> V_504 = F_219 ( V_468 , V_357 ) ;
V_357 -> V_434 . V_505 ++ ;
V_357 -> V_434 . V_506 += V_477 ;
F_220 ( V_468 ) ;
}
static int F_173 ( T_1 * V_1 )
{
int V_78 ;
struct V_453 * V_357 ;
T_10 * V_507 ;
