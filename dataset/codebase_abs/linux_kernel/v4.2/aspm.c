...
static void F_45 ( struct V_1 * V_102 )
{
struct V_1 * V_2 ;
F_12 ( V_102 -> V_33 ) ;
...
static void F_51 ( struct V_11 * V_15 , int V_89 , bool V_111 )
{
struct V_11 * V_33 = V_15 -> V_64 -> V_65 ;
struct V_1 * V_2 ;
if ( ! F_13 ( V_15 ) )
...
static int F_55 ( const char * V_17 , struct V_113 * V_114 )
{
int V_115 ;
struct V_1 * V_2 ;
if ( V_95 )
return - V_116 ;
for ( V_115 = 0 ; V_115 < F_56 ( V_117 ) ; V_115 ++ )
if ( ! strncmp ( V_17 , V_117 [ V_115 ] , strlen ( V_117 [ V_115 ] ) ) )
break;
if ( V_115 >= F_56 ( V_117 ) )
return - V_94 ;
if ( V_115 == V_3 )
...
static int F_57 ( char * V_118 , struct V_113 * V_114 )
{
int V_115 , V_119 = 0 ;
for ( V_115 = 0 ; V_115 < F_56 ( V_117 ) ; V_115 ++ )
if ( V_115 == V_3 )
V_119 += sprintf ( V_118 + V_119 , L_4 , V_117 [ V_115 ] ) ;
else
V_119 += sprintf ( V_118 + V_119 , L_5 , V_117 [ V_115 ] ) ;
return V_119 ;
}
static T_3 F_58 ( struct V_120 * V_45 ,
struct V_121 * V_122 ,
char * V_123 )
{
struct V_11 * V_124 = F_59 ( V_45 ) ;
struct V_1 * V_66 = V_124 -> V_66 ;
return sprintf ( V_123 , L_6 , V_66 -> V_77 ) ;
}
static T_3 F_60 ( struct V_120 * V_45 ,
struct V_121 * V_122 ,
const char * V_123 ,
T_4 V_125 )
{
...
struct V_11 * V_124 = F_59 ( V_45 ) ;
struct V_1 * V_66 = V_124 -> V_66 ;
return sprintf ( V_123 , L_6 , V_66 -> V_20 ) ;
}
...
return;
if ( V_66 -> V_80 )
F_68 ( & V_15 -> V_45 . V_126 ,
& V_127 . V_122 , V_128 ) ;
if ( V_66 -> V_21 )
F_68 ( & V_15 -> V_45 . V_126 ,
& V_129 . V_122 , V_128 ) ;
}
static int T_5 F_69 ( char * V_130 )
{
if ( ! strcmp ( V_130 , L_7 ) ) {
V_3 = V_7 ;
V_95 = 1 ;
