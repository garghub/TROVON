...
} else if ( V_50 == 0x197b && ( V_51 == 0x2352 || V_51 == 0x0325 ) ) {
F_30 (link, ap, EDGE) {
V_2 -> V_17 |= V_77 |
V_78 |
V_79 ;
}
} else if ( V_50 == 0x11ab && V_51 == 0x4140 ) {
F_30 (link, ap, EDGE) {
if ( V_2 -> V_22 == 4 )
V_2 -> V_17 |= V_83 ;
}
...
static int F_40 ( struct V_7 * V_33 , const T_1 * V_91 )
{
const T_1 * V_92 = V_33 -> V_44 ;
...
static int F_41 ( struct V_7 * V_33 , unsigned int V_99 )
{
struct V_1 * V_2 = V_33 -> V_2 ;
struct V_5 * V_6 = V_2 -> V_6 ;
T_1 * V_44 = ( void * ) V_6 -> V_100 ;
int V_54 ;
F_42 ( L_25 ) ;
F_43 ( V_2 , NULL , V_101 ) ;
if ( ! F_44 ( V_33 ) ) {
...
memcpy ( V_33 -> V_44 , V_44 , sizeof( V_44 [ 0 ] ) * V_104 ) ;
V_54 = F_17 ( V_33 , 0 ) ;
if ( V_54 )
goto V_56;
F_46 ( V_2 , NULL , V_101 ) ;
...
struct V_1 * V_84 ;
V_54 = F_49 ( V_2 , 0 , V_107 , V_108 , V_109 ,
V_110 ) ;
if ( V_54 ) {
F_50 ( V_2 , L_31 ) ;
goto V_56;
...
F_30 (tlink, ap, EDGE) {
struct V_70 * V_71 = & V_84 -> V_72 ;
V_71 -> V_46 . V_73 |= V_74 ;
V_71 -> V_46 . V_75 |= V_76 ;
}
}
if ( V_71 -> V_46 . V_75 & V_101 )
V_54 = F_41 ( V_33 , V_71 -> V_117 [ 0 ] ) ;
else
V_54 = F_47 ( V_33 ) ;
if ( V_54 ) {
V_111 -- ;
...
V_116:
if ( ! F_60 ( V_6 ) ) {
V_54 = F_61 ( V_6 , V_88 -> V_107 , V_88 -> V_108 ,
V_88 -> V_109 , V_88 -> V_110 , NULL ) ;
if ( V_54 ) {
...
V_54 = F_48 ( V_6 , V_88 -> V_107 , V_88 -> V_108 ,
V_88 -> V_109 , V_88 -> V_110 ) ;
if ( V_54 )
goto V_132;
if ( V_44 [ V_64 ] & V_59 ) {
V_44 [ V_64 ] &= ~ V_59 ;
...
if ( V_54 )
goto V_132;
V_54 = F_61 ( V_6 , V_88 -> V_133 , V_88 -> V_134 ,
V_88 -> V_135 , V_88 -> V_136 , & V_2 ) ;
if ( V_54 )
goto V_137;
