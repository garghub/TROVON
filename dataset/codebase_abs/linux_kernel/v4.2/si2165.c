...
break;
default:
F_25 ( & V_2 -> V_10 -> V_11 , L_14 ,
V_12 , V_2 -> V_58 ) ;
return 0 ;
}
V_6 = F_26 ( & V_54 , V_55 , V_2 -> V_10 -> V_11 . V_60 ) ;
if ( V_6 ) {
...
goto error;
V_51 = 8 ;
F_25 ( & V_2 -> V_10 -> V_11 , L_20 ,
V_12 , V_56 , V_47 , V_57 ) ;
V_6 = F_22 ( V_2 , V_45 , V_18 , & V_51 , 1 ) ;
if ( V_6 < 0 )
goto error;
V_6 = F_11 ( V_2 , 0x0344 , V_56 ) ;
if ( V_6 < 0 )
goto error;
...
{
int V_6 = 0 ;
struct V_1 * V_2 = V_31 -> V_63 ;
T_2 V_23 ;
T_2 V_56 = 0x00 ;
F_29 ( L_25 , V_21 ) ;
V_6 = F_11 ( V_2 , 0x0000 , V_2 -> V_15 . V_64 ) ;
if ( V_6 < 0 )
goto error;
...
if ( V_6 < 0 )
return V_6 ;
V_6 = F_11 ( V_2 , 0x0000 , V_65 ) ;
if ( V_6 < 0 )
return V_6 ;
return 0 ;
}
static int F_31 ( struct V_30 * V_31 , enum V_66 * V_67 )
{
int V_6 ;
T_2 V_68 = 0 ;
struct V_1 * V_2 = V_31 -> V_63 ;
...
static int F_32 ( struct V_1 * V_2 , T_3 V_75 )
{
T_4 V_76 ;
T_3 V_77 ;
V_76 = F_19 ( V_2 ) ;
V_76 <<= 23 ;
F_33 ( V_76 , V_75 ) ;
V_77 = V_76 & 0x3fffffff ;
return F_14 ( V_2 , 0x00e4 , V_77 ) ;
}
...
if ( V_2 -> V_15 . V_80 )
V_77 = - V_77 ;
V_77 = V_77 & 0x1fffffff ;
return F_14 ( V_2 , 0x00e8 , V_77 ) ;
}
static int F_35 ( struct V_30 * V_31 )
{
int V_6 ;
struct V_81 * V_82 = & V_31 -> V_83 ;
struct V_1 * V_2 = V_31 -> V_63 ;
T_2 V_23 [ 3 ] ;
T_3 IF ;
T_3 V_75 = 0 ;
...
if ( V_6 < 0 )
return V_6 ;
if ( V_31 -> V_85 . V_86 . V_89 )
V_31 -> V_85 . V_86 . V_89 ( V_31 ) ;
V_31 -> V_85 . V_86 . V_87 ( V_31 , & IF ) ;
V_6 = F_34 ( V_2 , IF ) ;
if ( V_6 < 0 )
return V_6 ;
...
struct V_30 * F_38 ( const struct V_90 * V_15 ,
struct V_91 * V_10 )
{
struct V_1 * V_2 = NULL ;
int V_92 ;
...
goto error;
V_2 = F_39 ( sizeof( struct V_1 ) , V_96 ) ;
if ( V_2 == NULL )
goto error;
V_2 -> V_10 = V_10 ;
V_2 -> V_15 = * V_15 ;
...
F_5 ( & V_2 -> V_10 -> V_11 , L_28 ,
V_12 , V_2 -> V_15 . V_35 ) ;
goto error;
}
memcpy ( & V_2 -> V_97 . V_85 , & V_98 ,
sizeof( struct V_99 ) ) ;
V_2 -> V_97 . V_63 = V_2 ;
V_93 = F_11 ( V_2 , 0x0000 , V_2 -> V_15 . V_64 ) ;
if ( V_93 < 0 )
goto error;
V_93 = F_8 ( V_2 , 0x0000 , & V_23 ) ;
if ( V_93 < 0 )
goto error;
if ( V_23 != V_2 -> V_15 . V_64 )
goto error;
V_93 = F_8 ( V_2 , 0x0023 , & V_2 -> V_58 ) ;
if ( V_93 < 0 )
goto error;
V_93 = F_8 ( V_2 , 0x0118 , & V_2 -> V_100 ) ;
if ( V_93 < 0 )
goto error;
V_93 = F_11 ( V_2 , 0x0000 , V_65 ) ;
if ( V_93 < 0 )
goto error;
if ( V_2 -> V_58 < 26 )
V_94 = 'A' + V_2 -> V_58 ;
...
break;
default:
F_5 ( & V_2 -> V_10 -> V_11 , L_31 ,
V_12 , V_2 -> V_100 , V_2 -> V_58 ) ;
goto error;
}
F_25 ( & V_2 -> V_10 -> V_11 ,
L_32 ,
V_12 , V_95 , V_94 , V_2 -> V_100 ,
V_2 -> V_58 ) ;
F_40 ( V_2 -> V_97 . V_85 . V_102 . V_103 , V_95 ,
sizeof( V_2 -> V_97 . V_85 . V_102 . V_103 ) ) ;
V_92 = 0 ;
if ( V_2 -> V_69 ) {
V_2 -> V_97 . V_85 . V_104 [ V_92 ++ ] = V_105 ;
F_40 ( V_2 -> V_97 . V_85 . V_102 . V_103 , L_33 ,
sizeof( V_2 -> V_97 . V_85 . V_102 . V_103 ) ) ;
}
if ( V_2 -> V_101 )
