...
int V_223 , T_6 V_224 , int V_225 )
{
struct V_2 * V_12 ;
struct V_13 * V_14 ;
V_12 = F_118 ( V_222 , V_226 , V_224 , & V_227 , V_225 ) ;
if ( ! V_12 )
return NULL ;
F_119 ( V_2 , V_12 ) ;
...
static int F_125 ( struct V_222 * V_222 , struct V_1 * V_2 , int V_232 ,
int V_225 )
{
struct V_2 * V_12 ;
F_7 ( L_12 , V_2 ) ;
...
return - V_234 ;
if ( V_2 -> type == V_137 && ! V_225 && ! F_3 ( V_235 ) )
return - V_163 ;
V_2 -> V_3 = & V_4 ;
V_12 = F_90 ( V_222 , V_2 , V_232 , V_196 , V_225 ) ;
if ( ! V_12 )
return - V_199 ;
F_93 ( V_12 , NULL ) ;
F_126 ( & V_191 , V_12 ) ;
