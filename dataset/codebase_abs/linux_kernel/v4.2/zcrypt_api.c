...
if ( ! V_56 || ! F_49 ( V_50 -> V_51 ) )
V_50 = NULL ;
F_38 ( & V_52 ) ;
return V_50 ;
}
struct V_49 * F_50 ( unsigned char * V_54 , int V_55 )
{
...
V_7 -> V_26 ++ ;
F_17 ( V_7 ) ;
if ( F_49 ( V_7 -> V_15 -> V_71 -> V_72 . V_51 ) ) {
F_38 ( & V_45 ) ;
...
F_88 ( V_194 , L_7 , ( unsigned int ) V_195 [ V_196 ] ) ;
F_89 ( V_194 , ' ' ) ;
}
...
F_88 ( V_194 , L_12 ,
V_206 , V_207 , V_208 ) ;
F_88 ( V_194 , L_13 , V_133 ) ;
F_88 ( V_194 , L_14 , V_46 ) ;
F_88 ( V_194 , L_15 , F_77 ( V_126 ) ) ;
F_88 ( V_194 , L_16 , F_77 ( V_128 ) ) ;
F_88 ( V_194 , L_17 ,
F_77 ( V_155 ) ) ;
F_88 ( V_194 , L_18 ,
F_77 ( V_157 ) ) ;
F_88 ( V_194 , L_19 , F_77 ( V_160 ) ) ;
F_88 ( V_194 , L_20 , F_77 ( V_162 ) ) ;
F_88 ( V_194 , L_21 , F_77 ( V_209 ) ) ;
F_88 ( V_194 , L_22 , F_77 ( V_210 ) ) ;
F_88 ( V_194 , L_23 , F_76 () ) ;
F_88 ( V_194 , L_24 , F_75 () ) ;
F_88 ( V_194 , L_25 ,
F_8 ( & V_63 ) ) ;
F_70 ( V_205 ) ;
F_91 ( L_26
...
V_213 [ V_215 ] = '\0' ;
V_214 = strstr ( V_213 , L_30 ) ;
if ( ! V_214 )
goto V_44;
V_214 = strstr ( V_214 , L_31 ) ;
if ( ! V_214 )
goto V_44;
V_214 ++ ;
if ( strstr ( V_214 , L_28 ) == NULL )
goto V_44;
...
int T_6 F_108 ( void )
{
V_227 = F_109 ( L_32 , NULL ) ;
V_228 = F_110 ( L_33 , 1 , 1 , 16 ) ;
F_111 ( V_228 , & V_229 ) ;
F_112 ( V_228 , V_230 ) ;
V_38 = F_110 ( L_34 , 1 , 1 , 16 ) ;
F_111 ( V_38 , & V_229 ) ;
F_112 ( V_38 , V_230 ) ;
return 0 ;
}
...
if ( V_39 < 0 )
goto V_44;
V_232 = F_118 ( L_35 , 0644 , NULL , & V_233 ) ;
if ( ! V_232 ) {
V_39 = - V_107 ;
goto V_234;
}
