...
static inline unsigned long F_98 ( T_5 V_125 )
{
...
static int F_156 ( struct V_4 * V_5 , T_7 V_179 , int V_180 )
{
struct V_148 * V_149 ;
struct V_181 * V_152 ;
int V_62 ;
...
int F_167 ( struct V_4 * V_5 , T_7 V_179 , void * V_141 )
{
struct V_4 * V_140 = NULL ;
int V_43 ;
F_7 ( ( V_179 & V_200 ) && ! V_141 ) ;
if ( ( V_179 & V_200 ) && V_141 ) {
...
struct V_4 * F_170 ( const char * V_204 , T_7 V_179 ,
void * V_141 )
{
struct V_4 * V_5 ;
int V_115 ;
...
struct V_4 * F_174 ( T_5 V_125 , T_7 V_179 , void * V_141 )
{
struct V_4 * V_5 ;
int V_115 ;
V_5 = F_103 ( V_125 ) ;
...
if ( V_66 -> V_206 & V_211 )
V_66 -> V_209 |= V_200 ;
if ( ( V_66 -> V_206 & V_212 ) == 3 )
V_66 -> V_209 |= V_213 ;
V_5 = F_114 ( V_2 ) ;
if ( V_5 == NULL )
return - V_153 ;
V_66 -> V_39 = V_5 -> V_11 -> V_12 ;
return F_167 ( V_5 , V_66 -> V_209 , V_66 ) ;
}
static void F_166 ( struct V_4 * V_5 , T_7 V_179 , int V_180 )
{
struct V_148 * V_149 = V_5 -> V_75 ;
struct V_4 * V_214 = NULL ;
F_159 ( & V_5 -> V_98 , V_180 ) ;
if ( V_180 )
V_5 -> V_130 -- ;
if ( ! -- V_5 -> V_188 ) {
...
void F_173 ( struct V_4 * V_5 , T_7 V_179 )
{
F_37 ( & V_5 -> V_98 ) ;
if ( V_179 & V_200 ) {
bool V_216 ;
...
F_173 ( V_5 , V_66 -> V_209 ) ;
return 0 ;
}
static long F_178 ( struct V_37 * V_37 , unsigned V_217 , unsigned long V_218 )
{
struct V_4 * V_5 = F_3 ( V_37 -> V_39 -> V_40 ) ;
T_7 V_179 = V_37 -> V_209 ;
if ( V_37 -> V_206 & V_208 )
V_179 |= V_210 ;
else
V_179 &= ~ V_210 ;
return F_179 ( V_5 , V_179 , V_217 , V_218 ) ;
}
...
if ( V_33 -> V_222 >= V_15 )
return - V_223 ;
F_182 ( V_156 , V_15 - V_33 -> V_222 ) ;
F_183 ( & V_220 ) ;
V_62 = F_184 ( V_33 , V_156 ) ;
if ( V_62 > 0 ) {
T_2 V_115 ;
V_115 = F_185 ( V_37 , V_33 -> V_222 - V_62 , V_62 ) ;
if ( V_115 < 0 )
V_62 = V_115 ;
}
F_186 ( & V_220 ) ;
...
static int F_189 ( struct V_50 * V_50 , T_8 V_42 )
{
struct V_20 * V_224 = F_1 ( V_50 -> V_10 -> V_40 ) -> V_5 . V_129 ;
if ( V_224 && V_224 -> V_47 -> V_225 )
return V_224 -> V_47 -> V_225 ( V_224 , V_50 , V_42 ) ;
return F_190 ( V_50 ) ;
}
int F_191 ( struct V_4 * V_5 , unsigned V_217 , unsigned long V_218 )
{
int V_43 ;
T_9 V_226 = F_192 () ;
F_193 ( V_227 ) ;
V_43 = F_179 ( V_5 , 0 , V_217 , V_218 ) ;
F_193 ( V_226 ) ;
return V_43 ;
}
struct V_4 * F_171 ( const char * V_228 )
{
struct V_4 * V_5 ;
struct V_2 * V_2 ;
struct V_204 V_204 ;
...
if ( ! V_228 || ! * V_228 )
return F_41 ( - V_17 ) ;
error = F_194 ( V_228 , V_229 , & V_204 ) ;
if ( error )
return F_41 ( error ) ;
V_2 = F_195 ( V_204 . V_108 ) ;
error = - V_230 ;
if ( ! F_196 ( V_2 -> V_132 ) )
goto V_231;
error = - V_205 ;
if ( V_204 . V_232 -> V_233 & V_234 )
goto V_231;
error = - V_153 ;
V_5 = F_114 ( V_2 ) ;
if ( ! V_5 )
...
void F_200 ( void (* F_201)( struct V_4 * , void * ) , void * V_218 )
{
struct V_2 * V_2 , * V_235 = NULL ;
F_5 ( & V_236 ) ;
F_111 (inode, &blockdev_superblock->s_inodes, i_sb_list) {
struct V_9 * V_10 = V_2 -> V_12 ;
F_5 ( & V_2 -> V_6 ) ;
if ( V_2 -> V_7 & ( V_237 | V_238 | V_127 ) ||
V_10 -> V_13 == 0 ) {
F_6 ( & V_2 -> V_6 ) ;
continue;
}
