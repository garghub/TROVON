...
static void T_1 F_93 ( int V_62 , unsigned long V_32 )
{
V_80 [ V_62 ] = F_83 ( V_85 [ V_62 ] . V_6 ,
V_85 [ V_62 ] . V_7 , V_32 ) ;
}
void T_1 F_94 ( unsigned long V_32 )
{
int V_81 ;
for ( V_81 = V_84 ; V_81 <= V_86 ; V_81 ++ ) {
if ( ! V_80 [ V_81 ] )
F_93 ( V_81 , V_32 ) ;
...
void * F_96 ( T_2 V_7 , T_3 V_32 , unsigned int V_89 )
{
void * V_31 ;
struct V_90 * V_90 ;
V_32 |= V_91 ;
V_90 = F_97 ( V_32 , V_89 ) ;
V_31 = V_90 ? F_98 ( V_90 ) : NULL ;
F_99 ( V_31 , V_7 , 1 , V_32 ) ;
F_100 ( V_31 , V_7 ) ;
return V_31 ;
}
void * F_101 ( T_2 V_7 , T_3 V_32 , unsigned int V_89 )
{
void * V_31 = F_96 ( V_7 , V_32 , V_89 ) ;
F_102 ( V_92 , V_31 , V_7 , V_93 << V_89 , V_32 ) ;
return V_31 ;
}
static void F_103 ( struct V_94 * V_95 )
{
#ifdef F_104
F_105 ( V_95 , L_11 ) ;
#else
...
void * F_107 ( struct V_94 * V_95 , T_4 * V_96 )
{
F_23 ( & V_27 ) ;
return F_108 ( & V_45 , * V_96 ) ;
}
void * F_109 ( struct V_94 * V_95 , void * V_97 , T_4 * V_96 )
{
return F_110 ( V_97 , & V_45 , V_96 ) ;
}
void F_111 ( struct V_94 * V_95 , void * V_97 )
{
F_24 ( & V_27 ) ;
}
static void
F_112 ( struct V_3 * V_4 , struct V_98 * V_99 )
{
struct V_3 * V_65 ;
struct V_98 V_100 ;
if ( ! V_13 ( V_4 ) )
...
V_99 -> V_103 += V_100 . V_103 ;
V_99 -> V_104 += V_100 . V_104 ;
V_99 -> V_105 += V_100 . V_105 ;
}
}
static void F_115 ( struct V_3 * V_4 , struct V_94 * V_95 )
{
struct V_98 V_100 ;
memset ( & V_100 , 0 , sizeof( V_100 ) ) ;
F_114 ( V_4 , & V_100 ) ;
F_112 ( V_4 , & V_100 ) ;
F_116 ( V_95 , L_20 ,
V_46 ( V_4 ) , V_100 . V_104 , V_100 . V_105 , V_4 -> V_7 ,
V_100 . V_106 , ( 1 << V_100 . V_107 ) ) ;
F_116 ( V_95 , L_21 ,
V_100 . V_108 , V_100 . V_109 , V_100 . V_110 ) ;
F_116 ( V_95 , L_22 ,
V_100 . V_101 , V_100 . V_102 , V_100 . V_103 ) ;
F_117 ( V_95 , V_4 ) ;
F_106 ( V_95 , '\n' ) ;
}
static int F_118 ( struct V_94 * V_95 , void * V_97 )
{
struct V_3 * V_4 = F_119 ( V_97 , struct V_3 , V_14 ) ;
if ( V_97 == V_45 . V_111 )
F_103 ( V_95 ) ;
if ( V_13 ( V_4 ) )
F_115 ( V_4 , V_95 ) ;
...
int F_120 ( struct V_94 * V_95 , void * V_97 )
{
struct V_3 * V_4 = F_119 ( V_97 , struct V_3 , V_14 ) ;
struct V_16 * V_17 = F_121 ( F_122 ( V_95 ) ) ;
if ( V_97 == V_45 . V_111 )
F_103 ( V_95 ) ;
if ( ! V_13 ( V_4 ) && V_4 -> V_12 . V_17 == V_17 )
F_115 ( V_4 , V_95 ) ;
...
static int F_123 ( struct V_112 * V_112 , struct V_113 * V_113 )
{
return F_124 ( V_113 , & V_114 ) ;
}
static int T_1 F_125 ( void )
{
F_126 ( L_23 , V_115 , NULL ,
& V_116 ) ;
return 0 ;
}
static T_5 void * F_127 ( const void * V_97 , T_2 V_117 ,
T_3 V_32 )
{
void * V_31 ;
T_2 V_118 = 0 ;
...
V_118 = F_128 ( V_97 ) ;
if ( V_118 >= V_117 ) {
F_129 ( ( void * ) V_97 , V_117 ) ;
return ( void * ) V_97 ;
}
V_31 = F_130 ( V_117 , V_32 ) ;
if ( V_31 && V_97 )
memcpy ( V_31 , V_97 , V_118 ) ;
return V_31 ;
}
void * F_131 ( const void * V_97 , T_2 V_117 , T_3 V_32 )
{
if ( F_86 ( ! V_117 ) )
return V_76 ;
return F_127 ( V_97 , V_117 , V_32 ) ;
}
void * F_132 ( const void * V_97 , T_2 V_117 , T_3 V_32 )
{
void * V_31 ;
if ( F_86 ( ! V_117 ) ) {
F_15 ( V_97 ) ;
...
V_31 = F_127 ( V_97 , V_117 , V_32 ) ;
if ( V_31 && V_97 != V_31 )
F_15 ( V_97 ) ;
return V_31 ;
}
void F_133 ( const void * V_97 )
{
T_2 V_118 ;
void * V_119 = ( void * ) V_97 ;
if ( F_86 ( F_134 ( V_119 ) ) )
return;
V_118 = F_128 ( V_119 ) ;
memset ( V_119 , 0 , V_118 ) ;
F_15 ( V_119 ) ;
}
