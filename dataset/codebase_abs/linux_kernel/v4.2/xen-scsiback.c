...
static T_11 F_151 ( struct V_217 * V_116 ,
char * V_5 )
{
...
T_11 V_245 ;
F_35 ( & V_24 -> V_45 ) ;
V_245 = snprintf ( V_5 , V_103 , L_47 , V_24 -> V_176 ) ;
F_36 ( & V_24 -> V_45 ) ;
return V_245 ;
}
static T_11 F_152 ( struct V_217 * V_116 ,
const char * V_5 , T_12 V_246 )
{
struct V_23 * V_24 = F_34 ( V_116 , struct V_23 ,
V_116 ) ;
int V_54 ;
...
V_116 = & V_24 -> V_116 ;
V_248 = F_67 ( sizeof( struct V_247 ) , V_105 ) ;
if ( ! V_248 ) {
F_36 ( & V_24 -> V_45 ) ;
return - V_83 ;
}
V_248 -> V_70 = F_154 ( V_249 ) ;
if ( F_112 ( V_248 -> V_70 ) ) {
F_36 ( & V_24 -> V_45 ) ;
F_28 ( V_248 ) ;
return - V_83 ;
...
static T_11 F_160 ( struct V_217 * V_116 ,
char * V_5 )
{
struct V_23 * V_24 = F_34 ( V_116 ,
struct V_23 , V_116 ) ;
...
V_253 = snprintf ( V_5 , V_103 , L_47 ,
V_248 -> V_70 -> V_235 -> V_252 ) ;
F_36 ( & V_24 -> V_45 ) ;
return V_253 ;
}
static T_11 F_161 ( struct V_217 * V_116 ,
const char * V_5 ,
T_12 V_246 )
{
struct V_23 * V_24 = F_34 ( V_116 ,
...
unsigned char V_254 [ V_191 ] , * V_225 , * V_255 ;
int V_253 ;
if ( ! strncmp ( V_5 , L_54 , 4 ) ) {
V_253 = F_158 ( V_24 ) ;
return ( ! V_253 ) ? V_246 : V_253 ;
}
if ( strlen ( V_5 ) >= V_191 ) {
F_22 ( L_55 ,
V_5 , V_191 ) ;
...
snprintf ( & V_254 [ 0 ] , V_191 , L_44 , V_5 ) ;
V_225 = strstr ( V_254 , L_39 ) ;
if ( V_225 ) {
...
return - V_99 ;
V_256:
if ( V_254 [ strlen ( V_254 ) - 1 ] == '\n' )
V_254 [ strlen ( V_254 ) - 1 ] = '\0' ;
V_253 = F_153 ( V_24 , V_255 ) ;
if ( V_253 < 0 )
return V_253 ;
return V_246 ;
}
static T_11
F_162 ( struct V_220 * V_221 ,
char * V_5 )
{
return sprintf ( V_5 , L_60
V_257 L_61 ,
V_258 , F_163 () -> V_259 , F_163 () -> V_260 ) ;
}
static char * F_164 ( void )
{
return L_62 ;
}
static int F_165 ( struct V_217 * V_116 ,
struct V_173 * V_28 )
{
struct V_23 * V_24 = F_34 ( V_116 ,
struct V_23 , V_116 ) ;
...
static void F_166 ( struct V_217 * V_116 ,
struct V_173 * V_28 )
{
struct V_23 * V_24 = F_34 ( V_116 ,
struct V_23 , V_116 ) ;
...
V_24 -> V_26 = V_26 ;
V_24 -> V_218 = V_261 ;
V_253 = F_170 ( V_231 , & V_24 -> V_116 , V_26 -> V_213 ) ;
if ( V_253 < 0 ) {
F_28 ( V_24 ) ;
return NULL ;
}
F_35 ( & V_175 ) ;
F_102 ( & V_24 -> V_262 , & V_264 ) ;
F_36 ( & V_175 ) ;
return & V_24 -> V_116 ;
}
static void F_171 ( struct V_217 * V_116 )
{
struct V_23 * V_24 = F_34 ( V_116 ,
struct V_23 , V_116 ) ;
F_35 ( & V_175 ) ;
...
static int F_173 ( struct V_217 * V_116 )
{
return 1 ;
}
static int F_174 ( struct V_217 * V_116 )
{
return 0 ;
}
static void F_175 ( void * V_265 )
{
struct V_16 * V_266 = V_265 ;
int V_8 ;
memset ( V_266 , 0 , sizeof( * V_266 ) ) ;
for ( V_8 = 0 ; V_8 < V_267 ; V_8 ++ )
V_266 -> V_39 [ V_8 ] = V_40 ;
}
static int T_13 F_176 ( void )
{
int V_253 ;
if ( ! F_177 () )
return - V_138 ;
F_56 ( L_64 V_257 L_61 ,
V_258 , F_163 () -> V_259 , F_163 () -> V_260 ) ;
V_126 = F_178 ( L_65 ,
sizeof( struct V_16 ) , 0 , 0 , F_175 ) ;
if ( ! V_126 )
return - V_83 ;
V_253 = F_179 ( & V_268 ) ;
if ( V_253 )
...
V_269:
F_182 ( V_126 ) ;
F_22 ( L_66 , V_208 , V_253 ) ;
return V_253 ;
}
static void T_14 F_183 ( void )
{
struct V_5 * V_5 ;
while ( V_9 ) {
if ( F_12 ( & V_5 ) )
