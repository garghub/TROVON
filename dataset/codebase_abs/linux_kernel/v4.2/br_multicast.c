...
F_111 ( & V_61 -> V_146 ) ;
#endif
if ( V_61 -> V_140 == 2 && F_43 ( & V_61 -> V_142 ) )
F_114 ( V_27 , V_61 ) ;
V_53:
F_35 ( & V_27 -> V_50 ) ;
}
void F_115 ( struct V_122 * V_61 )
{
struct V_26 * V_27 = V_61 -> V_27 ;
struct V_47 * V_57 ;
struct V_163 * V_164 ;
...
if ( ( V_167 -> V_171 == V_188 ||
V_167 -> V_171 == V_186 ) &&
F_119 ( * V_184 ) == 0 ) {
F_125 ( V_27 , V_61 , & V_167 -> V_170 ,
V_5 ) ;
} else {
V_65 = F_91 ( V_27 , V_61 ,
& V_167 -> V_170 , V_5 ) ;
...
static bool F_126 ( struct V_26 * V_27 ,
struct V_122 * V_61 ,
T_1 V_89 )
{
...
goto V_192;
if ( F_127 ( V_89 ) <= F_127 ( V_27 -> V_147 . V_24 . V_7 . V_8 ) )
goto V_192;
return false ;
V_192:
...
static bool F_128 ( struct V_26 * V_27 ,
struct V_122 * V_61 ,
struct V_19 * V_89 )
{
...
goto V_192;
if ( F_129 ( V_89 , & V_27 -> V_148 . V_24 . V_7 . V_11 ) <= 0 )
goto V_192;
return false ;
V_192:
...
switch ( V_89 -> V_4 ) {
case F_2 ( V_6 ) :
return F_126 ( V_27 , V_61 , V_89 -> V_7 . V_8 ) ;
#if F_3 ( V_9 )
case F_2 ( V_10 ) :
return F_128 ( V_27 , V_61 , & V_89 -> V_7 . V_11 ) ;
#endif
}
return false ;
}
...
unsigned long V_193 )
{
if ( ! F_130 ( V_27 , V_61 , V_89 ) )
return;
F_131 ( V_27 , V_144 , V_193 ) ;
F_133 ( V_27 , V_61 ) ;
}
...
} else if ( V_29 -> V_42 >= sizeof( * V_199 ) ) {
V_199 = F_136 ( V_29 ) ;
if ( V_199 -> V_184 )
goto V_53;
V_193 = V_199 -> V_96 ?
F_137 ( V_199 -> V_96 ) * ( V_99 / V_100 ) : 1 ;
} else {
goto V_53;
}
if ( ! V_69 ) {
...
if ( V_23 -> V_54 &&
( F_31 ( & V_23 -> V_52 ) ?
F_138 ( V_23 -> V_52 . V_201 , V_133 + V_193 ) :
F_112 ( & V_23 -> V_52 ) >= 0 ) )
...
V_58 = & V_48 -> V_59 ) {
if ( F_31 ( & V_48 -> V_52 ) ?
F_138 ( V_48 -> V_52 . V_201 , V_133 + V_193 ) :
F_112 ( & V_48 -> V_52 ) >= 0 )
...
if ( ! F_120 ( V_29 , sizeof( * V_202 ) ) ) {
V_65 = - V_46 ;
goto V_53;
}
V_202 = (struct V_104 * ) F_69 ( V_29 ) ;
V_193 = F_140 ( F_119 ( V_202 -> V_119 ) ) ;
if ( V_193 )
V_69 = & V_202 -> V_121 ;
} else {
if ( ! F_120 ( V_29 , sizeof( * V_204 ) ) ) {
V_65 = - V_46 ;
goto V_53;
}
...
if ( ! V_204 -> V_206 )
V_69 = & V_204 -> V_207 ;
V_193 = V_18 ( F_140 ( F_141 ( V_204 ) ) , 1UL ) ;
}
V_205 = V_69 && F_70 ( V_69 ) ;
if ( V_205 ) {
V_89 . V_4 = F_2 ( V_10 ) ;
V_89 . V_7 . V_11 = V_103 -> V_89 ;
F_134 ( V_27 , V_61 , & V_27 -> V_157 ,
& V_89 , V_193 ) ;
goto V_53;
} else if ( ! V_69 ) {
goto V_53;
...
F_40 ( & V_48 -> V_52 ) ;
F_34 ( & V_48 -> V_36 , F_26 ) ;
F_88 ( V_27 -> V_51 , V_61 , V_69 , V_210 ) ;
if ( ! V_23 -> V_55 && ! V_23 -> V_54 &&
F_30 ( V_27 -> V_51 ) )
F_41 ( & V_23 -> V_52 , V_60 ) ;
}
...
V_139 . V_4 = F_2 ( V_6 ) ;
V_139 . V_5 = V_5 ;
F_142 ( V_27 , V_61 , & V_139 , & V_27 -> V_156 ,
V_152 ) ;
}
...
V_139 . V_4 = F_2 ( V_10 ) ;
V_139 . V_5 = V_5 ;
F_142 ( V_27 , V_61 , & V_139 , & V_27 -> V_157 ,
V_152 ) ;
}
...
break;
case V_216 :
V_65 = F_117 ( V_27 , V_61 , V_211 , V_5 ) ;
break;
case V_95 :
V_65 = F_135 ( V_27 , V_61 , V_211 , V_5 ) ;
break;
case V_217 :
F_121 ( V_27 , V_61 , V_71 -> V_69 , V_5 ) ;
break;
}
if ( V_211 && V_211 != V_29 )
F_67 ( V_211 ) ;
...
break;
case V_219 :
V_65 = F_122 ( V_27 , V_61 , V_211 , V_5 ) ;
break;
case V_116 :
V_65 = F_139 ( V_27 , V_61 , V_211 , V_5 ) ;
break;
case V_220 :
F_125 ( V_27 , V_61 , & V_202 -> V_121 , V_5 ) ;
break;
}
if ( V_211 && V_211 != V_29 )
F_67 ( V_211 ) ;
...
int F_148 ( struct V_26 * V_27 , struct V_122 * V_61 ,
struct V_28 * V_29 , T_3 V_5 )
{
F_17 ( V_29 ) -> V_31 = 0 ;
F_17 ( V_29 ) -> V_213 = 0 ;
...
switch ( V_29 -> V_32 ) {
case F_2 ( V_6 ) :
return F_143 ( V_27 , V_61 , V_29 , V_5 ) ;
#if F_3 ( V_9 )
case F_2 ( V_10 ) :
return F_145 ( V_27 , V_61 , V_29 , V_5 ) ;
#endif
}
return 0 ;
}
static void F_149 ( struct V_26 * V_27 ,
struct V_143 * V_144 ,
struct V_221 * V_222 )
{
F_29 ( & V_27 -> V_50 ) ;
if ( V_144 -> V_158 < V_27 -> V_159 )
V_144 -> V_158 ++ ;
F_150 ( V_222 -> V_61 , NULL ) ;
F_104 ( V_27 , NULL , V_144 ) ;
F_35 ( & V_27 -> V_50 ) ;
}
static void F_151 ( unsigned long V_49 )
{
struct V_26 * V_27 = ( void * ) V_49 ;
F_149 ( V_27 , & V_27 -> V_145 , & V_27 -> V_147 ) ;
}
static void F_152 ( unsigned long V_49 )
{
struct V_26 * V_27 = ( void * ) V_49 ;
F_149 ( V_27 , & V_27 -> V_146 , & V_27 -> V_148 ) ;
}
...
F_83 ( & V_27 -> V_145 . V_52 , F_151 ,
( unsigned long ) V_27 ) ;
#if F_3 ( V_9 )
F_83 ( & V_27 -> V_157 . V_52 ,
F_99 , ( unsigned long ) V_27 ) ;
F_83 ( & V_27 -> V_146 . V_52 , F_152 ,
( unsigned long ) V_27 ) ;
#endif
}
...
void F_156 ( struct V_26 * V_27 )
{
F_155 ( V_27 , & V_27 -> V_145 ) ;
#if F_3 ( V_9 )
...
int F_161 ( struct V_26 * V_27 , unsigned long V_223 )
{
int V_65 = - V_46 ;
F_158 ( & V_27 -> V_50 ) ;
switch ( V_223 ) {
...
int F_162 ( struct V_122 * V_48 , unsigned long V_223 )
{
...
int F_165 ( struct V_26 * V_27 , unsigned long V_223 )
{
unsigned long V_193 ;
V_223 = ! ! V_223 ;
F_158 ( & V_27 -> V_50 ) ;
...
int F_166 ( struct V_26 * V_27 , unsigned long V_223 )
{
int V_65 = - V_46 ;
V_16 V_37 ;
struct V_12 * V_13 ;
...
goto V_224;
V_27 = V_61 -> V_27 ;
F_172 (port, &br->port_list, list) {
if ( ! V_61 -> V_51 || V_61 -> V_51 == V_51 )
continue;
F_11 (group, &port->mglist, mglist) {
V_229 = F_46 ( sizeof( * V_229 ) , V_66 ) ;
if ( ! V_229 )
goto V_224;
V_229 -> V_24 = V_69 -> V_24 ;
F_173 ( & V_229 -> V_230 , V_228 ) ;
V_123 ++ ;
}
}
V_224:
...
bool F_175 ( struct V_226 * V_51 , int V_4 )
{
struct V_26 * V_27 ;
struct V_122 * V_61 ;
struct V_72 V_73 ;
...
V_73 . V_79 = F_2 ( V_4 ) ;
V_231 = F_176 ( V_27 , & V_73 ) ;
V_224:
F_174 () ;
return V_231 ;
}
bool F_177 ( struct V_226 * V_51 , int V_4 )
{
struct V_26 * V_27 ;
struct V_122 * V_61 ;
bool V_231 = false ;
