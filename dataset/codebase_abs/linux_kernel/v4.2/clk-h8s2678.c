...
int V_5 = 1 << ( F_3 ( ( unsigned long ) V_4 -> V_6 ) & 3 ) ;
return V_3 * V_5 ;
}
...
V_14 = ( ( V_7 / V_3 ) / 2 ) & 0x03 ;
F_6 ( & V_17 , V_16 ) ;
V_15 = F_3 ( ( unsigned long ) V_4 -> V_18 ) ;
V_15 |= 0x08 ;
F_7 ( V_15 , ( unsigned long ) V_4 -> V_18 ) ;
V_15 = F_3 ( ( unsigned long ) V_4 -> V_6 ) ;
V_15 &= ~ 0x03 ;
V_15 |= V_14 ;
F_7 ( V_15 , ( unsigned long ) V_4 -> V_6 ) ;
F_8 ( & V_17 , V_16 ) ;
return 0 ;
}
...
V_4 = F_12 ( sizeof( struct V_4 ) , V_28 ) ;
if ( ! V_4 ) {
F_11 ( L_2 , V_23 ) ;
return;
}
