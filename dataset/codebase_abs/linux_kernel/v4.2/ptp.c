...
static int F_163 ( struct V_305 * V_40 , struct V_320 * V_25 )
{
struct V_39 * V_4 = F_88 ( V_40 ,
struct V_39 ,
V_208 ) ;
...
struct V_320 V_327 ;
struct V_320 V_306 ;
V_14 = F_163 ( V_40 , & V_327 ) ;
if ( V_14 != 0 )
return V_14 ;
V_306 = F_166 ( * V_326 , V_327 ) ;
...
if ( V_2 -> type -> V_335 )
V_2 -> type -> V_335 ( V_2 , true , true ) ;
}
void F_171 ( struct V_1 * V_2 )
{
if ( V_2 -> type -> V_335 )
V_2 -> type -> V_335 ( V_2 , false , true ) ;
F_84 ( V_2 ) ;
}
