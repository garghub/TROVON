...
if ( F_93 ( V_7 -> V_11 ) ) {
int V_55 , V_199 ;
V_7 -> V_200 = F_90 ( V_7 -> V_11 -> V_39 -> V_201 ,
F_94 ( 0 , 0 ) ) ;
...
F_75 ( V_7 ) ;
V_7 -> V_206 = F_95 ( & V_7 -> V_11 -> V_11 , V_7 ,
V_207 , L_34 ,
V_7 -> V_154 ) ;
...
if ( V_7 -> V_42 & ( 1 << V_209 ) ) {
F_62 ( L_46 ) ;
for ( V_55 = 0 ; V_55 < F_99 ( V_208 ) ; ++ V_55 ) {
if ( F_54 ( V_7 , ( 1ULL << V_55 ) ) )
F_100 ( L_47 , V_208 [ V_55 ] ) ;
}
F_100 ( L_48 ) ;
}
}
...
{
int V_211 ;
V_211 = F_106 ( V_7 -> V_11 ) ;
if ( V_211 )
return V_211 ;
V_211 = F_107 ( V_7 -> V_11 -> V_212 ,
V_213 ,
V_214 ,
0 , L_50 ,
V_7 ) ;
...
V_134 -> V_225 = F_114 ( V_125 -> V_128 ) ;
V_134 -> V_226 = V_134 -> V_225 + F_114 ( V_125 -> V_129 ) ;
...
case V_282 :
V_119 = F_101 () ;
V_273 = V_119 ? V_277 : V_283 ;
F_121 () ;
break;
case V_283 :
V_119 = F_125 () ;
V_273 = V_119 ? V_277 : V_284 ;
break;
case V_284 :
V_119 = F_145 () ;
V_273 = V_119 ? V_277 : V_285 ;
break;
case V_285 :
V_273 = V_286 ;
break;
...
static int T_6 F_147 ( enum V_287 V_288 )
{
int V_119 = 0 ;
while ( V_273 != V_288 ) {
V_119 = F_143 () ;
...
V_263 = true ;
V_291 = 1 ;
V_294 . V_7 . V_295 = F_153 ;
return 0 ;
}
static int T_6 F_155 ( char * V_296 )
{
V_297 = true ;
return 1 ;
}
static int T_6 F_156 ( char * V_296 )
{
for (; * V_296 ; ++ V_296 ) {
if ( strncmp ( V_296 , L_63 , 9 ) == 0 )
V_298 = true ;
if ( strncmp ( V_296 , L_64 , 3 ) == 0 )
V_293 = true ;
if ( strncmp ( V_296 , L_65 , 15 ) == 0 )
V_299 = true ;
}
return 1 ;
}
static int T_6 F_157 ( char * V_296 )
{
unsigned int V_39 , V_11 , V_40 ;
int V_119 , V_108 , V_55 ;
T_1 V_1 ;
V_119 = sscanf ( V_296 , L_66 , & V_108 , & V_39 , & V_11 , & V_40 ) ;
if ( V_119 != 4 ) {
F_24 ( L_67 , V_296 ) ;
return 1 ;
}
...
static int T_6 F_158 ( char * V_296 )
{
unsigned int V_39 , V_11 , V_40 ;
int V_119 , V_108 , V_55 ;
T_1 V_1 ;
...
int F_85 ( T_1 V_1 , T_3 V_301 , T_3 V_302 , T_3 V_303 ,
T_4 * V_148 , bool V_304 )
{
struct V_6 * V_7 ;
T_2 V_305 ;
T_2 V_306 ;
...
return - V_57 ;
V_7 = V_93 [ V_1 ] ;
if ( F_39 ( ( V_7 == NULL ) || ( V_303 > 0x28 ) || ( V_303 & 7 ) ) )
return - V_57 ;
V_305 = ( T_2 ) ( ( ( 0x40 | V_301 ) << 12 ) | ( V_302 << 8 ) | V_303 ) ;
V_306 = ( T_2 ) ( ( ( 0x40 | V_7 -> V_168 ) << 12 ) |
( V_7 -> V_169 << 8 ) | 0x28 ) ;
if ( ( V_305 < V_307 ) ||
( V_305 > V_306 ) )
return - V_117 ;
if ( V_304 ) {
F_17 ( ( T_2 ) * V_148 , V_7 -> V_19 + V_305 ) ;
F_17 ( ( * V_148 >> 32 ) , V_7 -> V_19 + V_305 + 4 ) ;
} else {
* V_148 = F_16 ( V_7 -> V_19 + V_305 + 4 ) ;
* V_148 <<= 32 ;
* V_148 = F_16 ( V_7 -> V_19 + V_305 ) ;
}
return 0 ;
}
