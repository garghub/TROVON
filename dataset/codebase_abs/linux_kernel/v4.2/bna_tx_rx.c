...
V_105 -> V_107 . V_108 -> V_418 =
V_105 -> V_107 . V_2 . V_3 ;
V_105 -> V_107 . V_108 -> V_419 . V_420 = 0 ;
V_105 -> V_107 . V_108 -> V_419 . V_421 = 0 ;
...
V_29 -> V_251 = V_208 -> V_416 ;
F_67 ( & V_29 -> V_8 , V_29 , V_208 , V_119 ) ;
F_6 ( V_29 , F_104 ) ;
V_261 -> V_422 |= F_48 ( V_29 -> V_30 ) ;
return V_29 ;
}
void
...
enum V_147
F_176 ( struct V_103 * V_29 , enum V_424 V_425 ,
enum V_424 V_426 )
{
struct V_7 * V_8 = & V_29 -> V_8 ;
int V_168 = 0 ;
...
struct V_104 * V_105 ;
F_33 (rxp, &rx->rxp_q, qe) {
V_105 -> V_107 . V_108 -> V_418 = V_3 ;
F_1 ( & V_105 -> V_107 . V_2 , V_3 ) ;
}
}
void
F_180 ( struct V_35 * V_35 , const V_6 V_401 [] [ V_428 ] )
{
int V_53 , V_54 ;
for ( V_53 = 0 ; V_53 < V_429 ; V_53 ++ )
for ( V_54 = 0 ; V_54 < V_428 ; V_54 ++ )
V_35 -> V_261 . V_430 [ V_53 ] [ V_54 ] = V_401 [ V_53 ] [ V_54 ] ;
}
void
...
V_6 V_431 , V_432 ;
V_6 V_433 , V_434 , V_435 ;
T_1 V_3 ;
if ( ( V_108 -> V_419 . V_420 == 0 ) &&
( V_108 -> V_419 . V_421 == 0 ) )
return;
V_434 = V_108 -> V_419 . V_420 ;
V_435 = V_108 -> V_419 . V_421 ;
V_433 = V_434 + V_435 ;
if ( V_433 < V_436 )
V_431 = V_437 ;
else if ( V_433 < V_438 )
...
V_108 -> V_419 . V_420 = 0 ;
V_108 -> V_419 . V_421 = 0 ;
V_3 = V_35 -> V_261 . V_430 [ V_431 ] [ V_432 ] ;
V_108 -> V_418 = V_3 ;
F_1 ( & V_108 -> V_107 -> V_2 , V_3 ) ;
}
static void
F_182 ( struct V_451 * V_452 )
{
F_183 ( V_452 ) ;
}
static void
F_184 ( struct V_451 * V_452 , enum V_453 V_10 )
{
switch ( V_10 ) {
case V_454 :
F_6 ( V_452 , V_455 ) ;
...
static void
F_185 ( struct V_451 * V_452 )
{
F_186 ( V_452 ) ;
}
static void
V_455 ( struct V_451 * V_452 , enum V_453 V_10 )
{
switch ( V_10 ) {
case V_456 :
V_452 -> V_302 &= ~ V_459 ;
...
static void
F_187 ( struct V_451 * V_452 )
{
struct V_464 * V_465 ;
int V_196 = ( V_452 -> type == V_466 ) ;
F_33 (txq, &tx->txq_q, qe) {
V_465 -> V_467 -> V_468 = V_465 -> V_468 ;
F_116 ( V_452 -> V_35 , & V_465 -> V_2 , V_196 ) ;
}
V_452 -> V_469 ( V_452 -> V_35 -> V_152 , V_452 ) ;
}
static void
V_463 ( struct V_451 * V_452 , enum V_453 V_10 )
{
switch ( V_10 ) {
case V_456 :
F_6 ( V_452 , V_460 ) ;
V_452 -> V_470 ( V_452 -> V_35 -> V_152 , V_452 ) ;
F_188 ( V_452 ) ;
break;
case V_457 :
F_6 ( V_452 , V_471 ) ;
V_452 -> V_470 ( V_452 -> V_35 -> V_152 , V_452 ) ;
V_452 -> V_472 ( V_452 -> V_35 -> V_152 , V_452 ) ;
break;
case V_458 :
F_6 ( V_452 , V_462 ) ;
break;
...
static void
F_189 ( struct V_451 * V_452 )
{
}
static void
V_460 ( struct V_451 * V_452 , enum V_453 V_10 )
{
switch ( V_10 ) {
case V_457 :
case V_473 :
...
static void
F_190 ( struct V_451 * V_452 )
{
}
static void
V_474 ( struct V_451 * V_452 , enum V_453 V_10 )
{
switch ( V_10 ) {
case V_457 :
case V_458 :
...
static void
F_191 ( struct V_451 * V_452 )
{
V_452 -> V_470 ( V_452 -> V_35 -> V_152 , V_452 ) ;
F_188 ( V_452 ) ;
}
static void
V_462 ( struct V_451 * V_452 , enum V_453 V_10 )
{
switch ( V_10 ) {
case V_456 :
F_6 ( V_452 , V_460 ) ;
...
static void
F_192 ( struct V_451 * V_452 )
{
V_452 -> V_472 ( V_452 -> V_35 -> V_152 , V_452 ) ;
}
static void
V_476 ( struct V_451 * V_452 , enum V_453 V_10 )
{
switch ( V_10 ) {
case V_456 :
F_6 ( V_452 , V_474 ) ;
...
static void
F_193 ( struct V_451 * V_452 )
{
}
static void
V_471 ( struct V_451 * V_452 , enum V_453 V_10 )
{
switch ( V_10 ) {
case V_454 :
F_6 ( V_452 , V_477 ) ;
...
static void
F_194 ( struct V_451 * V_452 )
{
}
static void
V_477 ( struct V_451 * V_452 , enum V_453 V_10 )
{
switch ( V_10 ) {
case V_456 :
F_6 ( V_452 , V_474 ) ;
...
static void
F_186 ( struct V_451 * V_452 )
{
struct V_478 * V_203 = & V_452 -> V_25 . V_203 ;
struct V_464 * V_465 = NULL ;
int V_53 ;
F_16 ( V_203 -> V_27 , V_28 ,
V_479 , 0 , V_452 -> V_30 ) ;
V_203 -> V_27 . V_31 = F_17 (
F_18 ( sizeof( struct V_478 ) ) ) ;
V_203 -> V_480 = V_452 -> V_481 ;
for ( V_53 = 0 ; V_53 < V_452 -> V_481 ; V_53 ++ ) {
V_465 = V_465 ? F_124 ( V_465 , V_88 )
: F_44 ( & V_452 -> V_482 , struct V_464 , V_88 ) ;
F_126 ( & V_203 -> V_215 [ V_53 ] . V_217 . V_217 , & V_465 -> V_218 ) ;
V_203 -> V_215 [ V_53 ] . V_217 . V_468 = V_465 -> V_468 ;
V_203 -> V_215 [ V_53 ] . V_2 . V_224 . V_225 . V_226 =
V_465 -> V_2 . V_227 . V_228 ;
V_203 -> V_215 [ V_53 ] . V_2 . V_224 . V_225 . V_229 =
V_465 -> V_2 . V_227 . V_230 ;
V_203 -> V_215 [ V_53 ] . V_2 . V_231 . V_232 =
F_17 ( ( T_2 ) V_465 -> V_2 . V_233 ) ;
}
V_203 -> V_234 . V_235 = V_58 ;
V_203 -> V_234 . V_236 = V_58 ;
V_203 -> V_234 . V_237 = V_132 ;
V_203 -> V_234 . V_238 = V_58 ;
V_203 -> V_234 . V_239 = ( V_465 -> V_2 . V_240 == V_241 )
? V_58 : V_132 ;
V_203 -> V_234 . V_242 =
F_27 ( ( V_6 ) V_465 -> V_2 . V_3 ) ;
V_203 -> V_234 . V_243 =
F_27 ( ( V_6 ) V_465 -> V_2 . V_244 ) ;
V_203 -> V_234 . V_245 = ( T_1 ) V_465 -> V_2 . V_246 ;
V_203 -> V_483 . V_484 = V_485 ;
V_203 -> V_483 . V_169 = F_17 ( ( T_2 ) V_452 -> V_486 ) ;
V_203 -> V_483 . V_487 = V_58 ;
V_203 -> V_483 . V_488 = V_132 ;
F_20 ( & V_452 -> V_34 , NULL , NULL ,
sizeof( struct V_478 ) , & V_203 -> V_27 ) ;
F_21 ( & V_452 -> V_35 -> V_36 , & V_452 -> V_34 ) ;
}
static void
F_195 ( struct V_451 * V_452 )
{
struct V_258 * V_24 = & V_452 -> V_25 . V_24 ;
F_16 ( V_24 -> V_27 , V_28 ,
V_489 , 0 , V_452 -> V_30 ) ;
V_24 -> V_27 . V_31 = F_17 (
F_18 ( sizeof( struct V_258 ) ) ) ;
F_20 ( & V_452 -> V_34 , NULL , NULL , sizeof( struct V_258 ) ,
& V_24 -> V_27 ) ;
F_21 ( & V_452 -> V_35 -> V_36 , & V_452 -> V_34 ) ;
}
static void
F_188 ( struct V_451 * V_452 )
{
struct V_464 * V_465 ;
F_33 (txq, &tx->txq_q, qe)
F_129 ( V_452 -> V_35 , & V_465 -> V_2 ) ;
F_195 ( V_452 ) ;
}
static void
F_196 ( struct V_464 * V_465 , int V_280 , int V_281 ,
struct V_282 * V_283 ,
struct V_282 * V_284 ,
struct V_282 * V_285 )
{
...
struct V_287 V_288 ;
int V_53 ;
V_465 -> V_218 . V_289 . V_228 = V_283 -> V_286 . V_228 ;
V_465 -> V_218 . V_289 . V_230 = V_283 -> V_286 . V_230 ;
V_465 -> V_218 . V_290 = V_283 -> V_129 ;
V_465 -> V_218 . V_280 = V_280 ;
V_465 -> V_218 . V_281 = V_281 ;
V_465 -> V_467 -> V_292 = ( void * * ) V_284 -> V_129 ;
V_465 -> V_467 -> V_293 = V_285 -> V_129 ;
V_129 = V_285 -> V_129 ;
F_142 ( & V_285 -> V_286 , V_286 ) ;
for ( V_53 = 0 ; V_53 < V_280 ; V_53 ++ ) {
V_465 -> V_467 -> V_292 [ V_53 ] = V_129 ;
V_129 += V_294 ;
F_143 ( V_286 , & V_288 ) ;
( (struct V_287 * ) V_465 -> V_218 . V_290 ) [ V_53 ] . V_228 =
V_288 . V_228 ;
( (struct V_287 * ) V_465 -> V_218 . V_290 ) [ V_53 ] . V_230 =
V_288 . V_230 ;
V_286 += V_294 ;
}
}
static struct V_451 *
F_197 ( struct V_490 * V_491 , enum V_492 type )
{
struct V_451 * V_452 = NULL ;
if ( F_43 ( & V_491 -> V_493 ) )
return NULL ;
if ( type == V_466 )
V_452 = F_44 ( & V_491 -> V_493 , struct V_451 , V_88 ) ;
else
V_452 = F_136 ( & V_491 -> V_493 , struct V_451 , V_88 ) ;
F_40 ( & V_452 -> V_88 ) ;
V_452 -> type = type ;
return V_452 ;
}
static void
F_198 ( struct V_451 * V_452 )
{
struct V_490 * V_491 = & V_452 -> V_35 -> V_491 ;
struct V_464 * V_465 ;
struct V_159 * V_88 ;
while ( ! F_43 ( & V_452 -> V_482 ) ) {
V_465 = F_44 ( & V_452 -> V_482 , struct V_464 , V_88 ) ;
V_465 -> V_467 = NULL ;
V_465 -> V_452 = NULL ;
F_45 ( & V_465 -> V_88 , & V_491 -> V_494 ) ;
}
...
if ( ( (struct V_451 * ) V_88 ) -> V_30 < V_452 -> V_30 )
break;
F_139 ( & V_452 -> V_88 , V_88 ) ;
}
static void
F_199 ( struct V_451 * V_452 )
{
V_452 -> V_302 |= V_495 ;
if ( V_452 -> V_302 & V_496 )
F_62 ( V_452 , V_454 ) ;
}
static void
F_200 ( struct V_451 * V_452 )
{
V_452 -> V_145 = V_497 ;
V_452 -> V_146 = & V_452 -> V_35 -> V_491 ;
V_452 -> V_302 &= ~ V_495 ;
F_62 ( V_452 , V_456 ) ;
}
static void
F_201 ( struct V_451 * V_452 )
{
V_452 -> V_302 &= ~ V_495 ;
F_62 ( V_452 , V_457 ) ;
}
void
F_202 ( struct V_451 * V_452 , struct V_110 * V_111 )
{
struct V_498 * V_317 = & V_452 -> V_25 . V_317 ;
struct V_464 * V_465 = NULL ;
int V_53 ;
F_160 ( & V_452 -> V_35 -> V_36 , ( T_1 * ) V_317 ,
sizeof( struct V_498 ) ) ;
V_452 -> V_318 = V_317 -> V_318 ;
for ( V_53 = 0 , V_465 = F_44 ( & V_452 -> V_482 , struct V_464 , V_88 ) ;
V_53 < V_452 -> V_481 ; V_53 ++ , V_465 = F_124 ( V_465 , V_88 ) ) {
V_465 -> V_467 -> V_319 -> V_320 =
V_452 -> V_35 -> V_321 . V_322
+ F_161 ( V_317 -> V_323 [ V_53 ] . V_319 ) ;
V_465 -> V_467 -> V_325 =
V_452 -> V_35 -> V_321 . V_322
+ F_161 ( V_317 -> V_323 [ V_53 ] . V_325 ) ;
V_465 -> V_318 = V_317 -> V_323 [ V_53 ] . V_499 ;
( * V_465 -> V_467 -> V_500 ) = 0 ;
V_465 -> V_467 -> V_331 = V_465 -> V_467 -> V_332 = 0 ;
}
F_62 ( V_452 , V_461 ) ;
}
void
F_203 ( struct V_451 * V_452 , struct V_110 * V_111 )
{
F_62 ( V_452 , V_473 ) ;
}
void
F_204 ( struct V_490 * V_491 )
{
struct V_451 * V_452 ;
...
void
F_205 ( int V_481 , int V_501 , struct V_118 * V_119 )
{
V_6 V_502 ;
V_6 V_280 ;
struct V_339 * V_127 ;
V_119 [ V_503 ] . V_348 = V_349 ;
V_127 = & V_119 [ V_503 ] . V_126 . V_127 ;
V_127 -> V_350 = V_351 ;
V_127 -> V_352 = sizeof( struct V_504 ) ;
V_127 -> V_354 = V_481 ;
V_502 = V_501 * V_505 ;
V_502 = F_165 ( V_502 , V_294 ) ;
V_280 = V_502 >> V_506 ;
V_119 [ V_507 ] . V_348 = V_349 ;
V_127 = & V_119 [ V_507 ] . V_126 . V_127 ;
V_127 -> V_350 = V_358 ;
...
V_127 -> V_352 = V_368 ;
V_127 -> V_354 = V_481 ;
V_119 [ V_511 ] . V_348 = V_371 ;
V_119 [ V_511 ] . V_126 . V_372 . V_240 =
V_241 ;
V_119 [ V_511 ] . V_126 . V_372 . V_354 = V_481 ;
}
struct V_451 *
...
{
struct V_376 * V_372 ;
struct V_490 * V_491 = & V_35 -> V_491 ;
struct V_451 * V_452 ;
struct V_464 * V_465 ;
int V_280 ;
int V_53 ;
V_372 = & V_119 [ V_511 ] . V_126 . V_372 ;
V_280 = ( V_119 [ V_509 ] . V_126 . V_127 . V_352 ) /
V_294 ;
if ( ( V_372 -> V_354 != 1 ) && ( V_372 -> V_354 != V_483 -> V_481 ) )
return NULL ;
V_452 = F_197 ( V_491 , V_483 -> V_515 ) ;
if ( ! V_452 )
return NULL ;
V_452 -> V_35 = V_35 ;
V_452 -> V_375 = V_375 ;
F_68 ( & V_452 -> V_482 ) ;
for ( V_53 = 0 ; V_53 < V_483 -> V_481 ; V_53 ++ ) {
if ( F_43 ( & V_491 -> V_494 ) )
goto V_164;
V_465 = F_44 ( & V_491 -> V_494 , struct V_464 , V_88 ) ;
F_45 ( & V_465 -> V_88 , & V_452 -> V_482 ) ;
V_465 -> V_452 = V_452 ;
}
V_452 -> V_516 = V_514 -> V_516 ;
V_452 -> V_517 = V_514 -> V_517 ;
V_452 -> V_470 = V_514 -> V_470 ;
V_452 -> V_469 = V_514 -> V_469 ;
V_452 -> V_472 = V_514 -> V_472 ;
F_38 ( & V_452 -> V_88 , & V_491 -> V_518 ) ;
V_452 -> V_481 = V_483 -> V_481 ;
V_452 -> V_302 = 0 ;
if ( V_452 -> V_35 -> V_491 . V_302 & V_519 ) {
switch ( V_452 -> type ) {
case V_466 :
if ( ! ( V_452 -> V_35 -> V_491 . V_302 &
V_520 ) )
V_452 -> V_302 |= V_495 ;
break;
case V_521 :
if ( V_452 -> V_35 -> V_491 . V_302 & V_520 )
V_452 -> V_302 |= V_495 ;
break;
}
}
V_53 = 0 ;
F_33 (txq, &tx->txq_q, qe) {
V_465 -> V_467 = (struct V_504 * )
V_119 [ V_503 ] . V_126 . V_127 . V_128 [ V_53 ] . V_129 ;
V_465 -> V_522 = 0 ;
V_465 -> V_523 = 0 ;
V_465 -> V_2 . V_227 . V_228 =
V_119 [ V_510 ] . V_126 . V_127 . V_128 [ V_53 ] . V_286 . V_228 ;
V_465 -> V_2 . V_227 . V_230 =
V_119 [ V_510 ] . V_126 . V_127 . V_128 [ V_53 ] . V_286 . V_230 ;
V_465 -> V_2 . V_403 =
V_119 [ V_510 ] . V_126 . V_127 . V_128 [ V_53 ] . V_129 ;
V_465 -> V_2 . V_240 = V_372 -> V_240 ;
V_465 -> V_2 . V_233 = ( V_372 -> V_354 == 1 ) ?
V_372 -> V_402 [ 0 ] . V_401 :
V_372 -> V_402 [ V_53 ] . V_401 ;
if ( V_372 -> V_240 == V_524 )
V_465 -> V_2 . V_233 = F_48 ( V_465 -> V_2 . V_233 ) ;
V_465 -> V_2 . V_3 = V_483 -> V_3 ;
V_465 -> V_2 . V_244 = V_525 ;
V_465 -> V_2 . V_246 = V_526 ;
V_465 -> V_467 -> V_407 = V_483 -> V_501 ;
V_465 -> V_467 -> V_406 = ( void * )
V_119 [ V_527 ] . V_126 . V_127 . V_128 [ V_53 ] . V_129 ;
V_465 -> V_467 -> V_500 =
( V_6 * ) V_465 -> V_2 . V_403 ;
V_465 -> V_467 -> V_319 = & V_465 -> V_2 . V_4 ;
V_465 -> V_467 -> V_240 = V_465 -> V_2 . V_240 ;
V_465 -> V_467 -> V_233 = V_465 -> V_2 . V_233 ;
V_465 -> V_467 -> V_465 = V_465 ;
V_465 -> V_467 -> V_152 = V_152 ;
V_465 -> V_467 -> V_109 = V_53 ;
F_196 ( V_465 , V_280 , V_294 ,
& V_119 [ V_507 ] . V_126 . V_127 . V_128 [ V_53 ] ,
& V_119 [ V_508 ] . V_126 . V_127 . V_128 [ V_53 ] ,
& V_119 [ V_509 ] .
V_126 . V_127 . V_128 [ V_53 ] ) ;
if ( V_452 -> V_516 )
( V_452 -> V_516 ) ( V_35 -> V_152 , V_465 -> V_467 ) ;
if ( V_483 -> V_481 == V_528 )
V_465 -> V_468 = V_465 -> V_467 -> V_109 ;
else
V_465 -> V_468 = V_491 -> V_529 ;
V_53 ++ ;
}
V_452 -> V_486 = 0 ;
F_6 ( V_452 , F_184 ) ;
V_491 -> V_422 |= F_48 ( V_452 -> V_30 ) ;
return V_452 ;
V_164:
F_198 ( V_452 ) ;
return NULL ;
...
void
F_207 ( struct V_451 * V_452 )
{
struct V_464 * V_465 ;
F_33 (txq, &tx->txq_q, qe)
if ( V_452 -> V_517 )
( V_452 -> V_517 ) ( V_452 -> V_35 -> V_152 , V_465 -> V_467 ) ;
V_452 -> V_35 -> V_491 . V_422 &= ~ F_48 ( V_452 -> V_30 ) ;
F_198 ( V_452 ) ;
}
void
F_208 ( struct V_451 * V_452 )
{
if ( V_452 -> V_300 != ( V_423 ) F_184 )
return;
V_452 -> V_302 |= V_496 ;
if ( V_452 -> V_302 & V_495 )
F_62 ( V_452 , V_454 ) ;
}
void
F_209 ( struct V_451 * V_452 , enum V_90 type ,
void (* F_80)( void * , struct V_451 * ) )
{
if ( type == V_102 ) {
(* F_80)( V_452 -> V_35 -> V_152 , V_452 ) ;
return;
}
V_452 -> V_145 = F_80 ;
V_452 -> V_146 = V_452 -> V_35 -> V_152 ;
V_452 -> V_302 &= ~ V_496 ;
F_62 ( V_452 , V_456 ) ;
}
void
F_210 ( struct V_451 * V_452 )
{
F_62 ( V_452 , V_475 ) ;
}
static void
V_497 ( void * V_295 , struct V_451 * V_452 )
{
struct V_490 * V_491 = (struct V_490 * ) V_295 ;
F_146 ( & V_491 -> V_530 ) ;
}
static void
F_211 ( void * V_295 )
...
struct V_490 * V_491 = (struct V_490 * ) V_295 ;
if ( V_491 -> V_145 )
V_491 -> V_145 ( & V_491 -> V_35 -> V_210 ) ;
V_491 -> V_145 = NULL ;
}
void
F_212 ( struct V_490 * V_491 , struct V_35 * V_35 ,
struct V_118 * V_119 )
{
int V_53 ;
V_491 -> V_35 = V_35 ;
V_491 -> V_302 = 0 ;
V_491 -> V_452 = (struct V_451 * )
V_119 [ V_531 ] . V_126 . V_127 . V_128 [ 0 ] . V_129 ;
V_491 -> V_465 = (struct V_464 * )
V_119 [ V_532 ] . V_126 . V_127 . V_128 [ 0 ] . V_129 ;
F_68 ( & V_491 -> V_493 ) ;
F_68 ( & V_491 -> V_518 ) ;
F_68 ( & V_491 -> V_494 ) ;
for ( V_53 = 0 ; V_53 < V_35 -> V_313 . V_314 . V_481 ; V_53 ++ ) {
V_491 -> V_452 [ V_53 ] . V_30 = V_53 ;
F_38 ( & V_491 -> V_452 [ V_53 ] . V_88 , & V_491 -> V_493 ) ;
F_38 ( & V_491 -> V_465 [ V_53 ] . V_88 , & V_491 -> V_494 ) ;
}
V_491 -> V_533 = V_534 ;
V_491 -> V_529 = 0 ;
V_491 -> V_535 = V_132 ;
...
void
F_213 ( struct V_490 * V_491 )
{
V_491 -> V_35 = NULL ;
}
void
F_214 ( struct V_490 * V_491 , enum V_492 type )
{
struct V_451 * V_452 ;
V_491 -> V_302 |= V_519 ;
if ( type == V_521 )
...
void
F_215 ( struct V_490 * V_491 , enum V_492 type )
{
struct V_451 * V_452 ;
V_491 -> V_302 &= ~ V_519 ;
V_491 -> V_302 &= ~ V_520 ;
V_491 -> V_145 = V_537 ;
F_153 ( & V_491 -> V_530 , F_211 , V_491 ) ;
F_33 (tx, &tx_mod->tx_active_q, qe)
if ( V_452 -> type == type ) {
F_154 ( & V_491 -> V_530 ) ;
F_200 ( V_452 ) ;
...
void
F_217 ( struct V_451 * V_452 , int V_3 )
{
struct V_464 * V_465 ;
F_33 (txq, &tx->txq_q, qe)
F_1 ( & V_465 -> V_2 , V_3 ) ;
