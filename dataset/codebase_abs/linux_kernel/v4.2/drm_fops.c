...
F_47 ( & V_70 -> V_40 ) ;
if ( V_70 -> V_92 )
F_58 ( & V_70 -> V_53 -> V_93 , V_70 -> V_92 ) ;
F_30 ( & V_2 -> V_58 ) ;
if ( V_2 -> V_4 -> V_94 )
V_2 -> V_4 -> V_94 ( V_2 , V_70 ) ;
F_4 ( L_7 ,
F_14 ( V_30 ) ,
( long ) F_59 ( V_70 -> V_11 -> V_95 -> V_96 ) ,
V_2 -> V_14 ) ;
if ( V_70 -> V_11 -> V_53 )
F_40 ( V_2 , V_9 ) ;
if ( F_2 ( V_2 , V_97 ) )
...
T_1 F_69 ( struct V_8 * V_9 , char T_2 * V_101 ,
T_3 V_102 , T_4 * V_103 )
{
struct V_21 * V_70 = V_9 -> V_34 ;
struct V_1 * V_2 = V_70 -> V_11 -> V_2 ;
T_1 V_3 = 0 ;
if ( ! F_70 ( V_104 , V_101 , V_102 ) )
return - V_105 ;
F_71 ( & V_2 -> V_80 ) ;
for (; ; ) {
if ( F_66 ( & V_70 -> V_44 ) ) {
...
V_70 -> V_46 += V_74 -> V_108 -> V_109 ;
V_3 += V_74 -> V_108 -> V_109 ;
F_47 ( & V_74 -> V_82 ) ;
V_74 -> V_84 ( V_74 ) ;
}
}
...
unsigned int F_76 ( struct V_8 * V_9 , struct V_110 * V_111 )
{
struct V_21 * V_70 = V_9 -> V_34 ;
unsigned int V_112 = 0 ;
F_77 ( V_9 , & V_70 -> V_45 , V_111 ) ;
if ( ! F_66 ( & V_70 -> V_44 ) )
V_112 |= V_113 | V_114 ;
return V_112 ;
}
