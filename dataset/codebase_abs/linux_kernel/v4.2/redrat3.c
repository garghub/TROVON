...
static int F_22 ( int V_43 , struct V_1 * V_2 )
{
struct V_44 * V_45 ;
T_3 * V_25 ;
int V_3 ;
...
V_2 -> V_127 . V_177 = L_66 ;
V_2 -> V_127 . V_178 = F_56 ;
...
V_2 -> V_180 . V_181 = 0xc0 ;
V_2 -> V_180 . V_182 = V_183 ;
V_2 -> V_180 . V_184 = F_75 ( 1 ) ;
F_76 ( V_2 -> V_56 , V_45 , F_25 ( V_45 , 0 ) ,
( unsigned char * ) & V_2 -> V_180 ,
& V_2 -> V_185 , sizeof( V_2 -> V_185 ) ,
F_60 , V_2 ) ;
V_2 -> V_26 = F_62 ( V_2 ) ;
if ( ! V_2 -> V_26 ) {
V_163 = - V_47 ;
...
static int F_84 ( struct V_153 * V_154 , T_5 V_186 )
{
struct V_1 * V_2 = F_81 ( V_154 ) ;
F_85 ( & V_2 -> V_127 ) ;
F_30 ( V_2 -> V_4 ) ;
