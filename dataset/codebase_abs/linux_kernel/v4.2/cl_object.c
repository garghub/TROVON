...
void F_26 ( struct V_17 * V_27 )
__releases( cl_object_attr_guard( V_27 )
int F_27 ( const struct V_18 * V_19 , struct V_17 * V_33 ,
struct V_34 * V_35 )
{
struct V_36 * V_30 ;
int V_3 ;
...
V_30 = V_33 -> V_28 . V_37 ;
V_3 = 0 ;
F_29 (obj, &top->loh_layers, co_lu.lo_linkage) {
...
F_9 ( V_29 -> V_11 == 0 ) ;
F_36 ( V_54 , & V_29 -> V_4 . V_55 ) ;
F_37 ( V_19 , V_33 , 0 ) ;
}
void F_38 ( const struct V_18 * V_19 , struct V_17 * V_33 )
{
F_39 ( V_19 , V_33 ) ;
F_37 ( V_19 , V_33 , 1 ) ;
}
int F_40 ( struct V_17 * V_33 )
{
