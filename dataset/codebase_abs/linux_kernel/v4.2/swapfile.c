...
int F_80 ( T_4 V_110 , T_2 V_5 , struct V_111 * * V_112 )
{
...
return 0 ;
return F_85 ( F_3 ( type , V_5 ) , & V_18 ) ;
}
unsigned int F_86 ( int type , int free )
{
unsigned int V_35 = 0 ;
F_30 ( & V_113 ) ;
if ( ( unsigned int ) type < V_88 ) {
...
static inline int F_87 ( T_5 V_116 , T_5 V_117 )
{
#ifdef F_88
T_5 V_118 = F_89 ( V_117 ) ;
return F_90 ( V_116 , V_117 ) || F_90 ( V_116 , V_118 ) ;
#else
return F_90 ( V_116 , V_117 ) ;
#endif
}
static int F_91 ( struct V_119 * V_120 , T_6 * V_121 ,
...
int V_8 = 1 ;
V_123 = V_7 ;
V_7 = F_92 ( V_7 , V_120 , V_122 ) ;
if ( F_40 ( ! V_7 ) )
return - V_127 ;
if ( F_93 ( V_7 , V_120 -> V_128 , V_19 , & V_125 ) ) {
V_8 = - V_127 ;
goto V_129;
}
V_116 = F_94 ( V_120 -> V_128 , V_121 , V_122 , & V_126 ) ;
if ( F_40 ( ! F_87 ( * V_116 , F_95 ( V_6 ) ) ) ) {
F_96 ( V_7 , V_125 ) ;
V_8 = 0 ;
goto V_87;
}
F_97 ( V_120 -> V_128 , V_130 ) ;
F_98 ( V_120 -> V_128 , V_131 ) ;
F_99 ( V_7 ) ;
F_100 ( V_120 -> V_128 , V_122 , V_116 ,
F_101 ( F_102 ( V_7 , V_120 -> V_132 ) ) ) ;
if ( V_7 == V_123 ) {
F_103 ( V_7 , V_120 , V_122 ) ;
F_104 ( V_7 , V_125 , true ) ;
} else {
F_105 ( V_7 , V_120 , V_122 ) ;
F_104 ( V_7 , V_125 , false ) ;
F_106 ( V_7 , V_120 ) ;
}
F_63 ( V_6 ) ;
F_107 ( V_7 ) ;
...
do {
if ( F_40 ( F_87 ( * V_116 , V_117 ) ) ) {
F_112 ( V_116 ) ;
V_8 = F_91 ( V_120 , V_121 , V_122 , V_6 , V_7 ) ;
if ( V_8 )
goto V_87;
V_116 = F_111 ( V_121 , V_122 ) ;
}
...
static T_2 F_85 ( T_1 V_6 , struct V_111 * * V_18 )
{
struct V_3 * V_114 ;
struct V_10 * V_167 ;
struct V_10 * V_11 ;
...
V_52 -> V_214 = F_198 ( V_52 -> V_18 ) ;
error = F_199 ( V_52 -> V_18 , V_134 ) ;
if ( error < 0 )
return error ;
V_52 -> V_31 |= V_104 ;
} else if ( F_200 ( V_178 -> V_180 ) ) {
V_52 -> V_18 = V_178 -> V_215 -> V_216 ;
F_172 ( & V_178 -> V_217 ) ;
if ( F_201 ( V_178 ) )
return - V_218 ;
} else
...
unsigned long V_221 ;
unsigned long V_222 ;
if ( memcmp ( L_12 , V_219 -> V_223 . V_223 , 10 ) ) {
F_56 ( L_13 ) ;
return 0 ;
}
if ( F_203 ( V_219 -> V_29 . V_224 ) == 1 ) {
F_204 ( & V_219 -> V_29 . V_224 ) ;
F_204 ( & V_219 -> V_29 . V_222 ) ;
F_204 ( & V_219 -> V_29 . V_225 ) ;
for ( V_148 = 0 ; V_148 < V_219 -> V_29 . V_225 ; V_148 ++ )
F_204 ( & V_219 -> V_29 . V_226 [ V_148 ] ) ;
}
if ( V_219 -> V_29 . V_224 != 1 ) {
F_205 ( L_14 ,
V_219 -> V_29 . V_224 ) ;
return 0 ;
}
...
if ( V_220 > V_222 ) {
V_220 = V_222 + 1 ;
if ( ( unsigned int ) V_220 == 0 )
V_220 = V_227 ;
}
V_52 -> V_75 = V_220 - 1 ;
if ( ! V_220 )
return 0 ;
V_221 = F_207 ( V_178 ) >> V_16 ;
if ( V_221 && V_220 > V_221 ) {
F_205 ( L_16 ) ;
return 0 ;
}
if ( V_219 -> V_29 . V_225 && F_200 ( V_178 -> V_180 ) )
return 0 ;
if ( V_219 -> V_29 . V_225 > V_228 )
return 0 ;
return V_220 ;
}
...
unsigned int V_229 ;
int V_230 ;
unsigned long V_231 = F_209 ( V_220 , V_40 ) ;
...
F_25 ( & V_52 -> V_43 ) ;
for ( V_148 = 0 ; V_148 < V_219 -> V_29 . V_225 ; V_148 ++ ) {
unsigned int V_53 = V_219 -> V_29 . V_226 [ V_148 ] ;
if ( V_53 == 0 || V_53 > V_219 -> V_29 . V_222 )
return - V_213 ;
if ( V_53 < V_220 ) {
V_39 [ V_53 ] = V_41 ;
V_229 -- ;
...
for ( V_148 = V_220 ; V_148 < F_210 ( V_220 , V_40 ) ; V_148 ++ )
...
{
struct V_232 * V_233 = F_212 ( V_4 -> V_18 ) ;
if ( ! V_233 || ! F_213 ( V_233 ) )
return false ;
return true ;
}
void F_214 ( struct V_234 * V_9 )
{
unsigned int type ;
...
V_9 -> V_236 = F_44 ( & V_82 ) + V_235 ;
V_9 -> V_237 = V_184 + V_235 ;
F_29 ( & V_113 ) ;
}
...
if ( ! ( V_98 & V_101 ) )
goto V_87;
V_251 = F_226 ( V_245 ) + V_5 ;
V_98 = * V_251 ;
F_227 ( V_251 ) ;
if ( ( V_98 & ~ V_101 ) != V_252 )
goto V_87;
}
F_159 ( & V_7 -> V_249 , & V_244 -> V_249 ) ;
V_7 = NULL ;
V_87:
F_29 ( & V_4 -> V_47 ) ;
V_247:
...
V_5 &= ~ V_248 ;
V_7 = F_15 ( V_244 -> V_249 . V_27 , struct V_7 , V_249 ) ;
V_251 = F_226 ( V_7 ) + V_5 ;
if ( V_98 == V_102 )
goto V_253;
if ( V_98 == ( V_102 | V_101 ) ) {
while ( * V_251 == ( V_252 | V_101 ) ) {
F_227 ( V_251 ) ;
V_7 = F_15 ( V_7 -> V_249 . V_27 , struct V_7 , V_249 ) ;
F_151 ( V_7 == V_244 ) ;
V_251 = F_226 ( V_7 ) + V_5 ;
}
if ( * V_251 == V_252 ) {
...
* V_251 += 1 ;
F_227 ( V_251 ) ;
V_7 = F_15 ( V_7 -> V_249 . V_146 , struct V_7 , V_249 ) ;
while ( V_7 != V_244 ) {
V_251 = F_226 ( V_7 ) + V_5 ;
* V_251 = V_101 ;
F_227 ( V_251 ) ;
...
struct V_7 * V_7 ;
V_7 = F_15 ( V_254 , struct V_7 , V_249 ) ;
F_155 ( V_254 ) ;
F_228 ( V_7 ) ;
}
}
