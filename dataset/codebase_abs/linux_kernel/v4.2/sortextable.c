...
break;
case V_59 :
if ( V_36 ( & V_32 -> V_60 ) != sizeof( T_7 )
|| V_36 ( & V_32 -> V_61 ) != sizeof( V_62 ) ) {
fprintf ( V_10 ,
L_7 , V_6 ) ;
F_7 () ;
}
...
break;
case V_63 : {
T_8 * const V_64 = ( T_8 * ) V_32 ;
if ( V_36 ( & V_64 -> V_60 ) != sizeof( T_8 )
|| V_36 ( & V_64 -> V_61 ) != sizeof( V_65 ) ) {
fprintf ( V_10 ,
L_7 , V_6 ) ;
F_7 () ;
}
...
for ( V_17 = 1 ; V_17 < V_66 ; V_17 ++ ) {
char * V_69 = V_67 [ V_17 ] ;
int const V_70 = setjmp ( V_71 ) ;
switch ( V_70 ) {
default:
fprintf ( V_10 , L_9 , V_69 ) ;
exit ( 1 ) ;
break;
case V_72 :
V_5 = - 1 ;
