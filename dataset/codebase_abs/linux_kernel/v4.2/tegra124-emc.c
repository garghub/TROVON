...
static void F_35 ( struct V_126 * V_13 )
{
struct V_127 * V_128 , * V_129 ;
struct V_124 * V_124 ;
V_128 = F_36 ( L_27 , NULL ) ;
if ( ! V_128 ) {
F_6 ( V_13 , L_28 ) ;
return;
}
V_124 = F_37 ( L_29 , L_27 ) ;
if ( F_38 ( V_124 ) ) {
F_6 ( V_13 , L_30 , F_39 ( V_124 ) ) ;
return;
}
V_129 = F_40 ( L_31 , V_130 | V_131 , V_128 , V_124 ,
& V_132 ) ;
if ( ! V_129 )
F_6 ( V_13 , L_32 ) ;
}
...
T_1 V_121 ;
int V_111 ;
V_2 = F_42 ( & V_134 -> V_13 , sizeof( * V_2 ) , V_119 ) ;
if ( ! V_2 )
return - V_120 ;
V_2 -> V_13 = & V_134 -> V_13 ;
V_136 = F_43 ( V_134 , V_137 , 0 ) ;
V_2 -> V_5 = F_44 ( & V_134 -> V_13 , V_136 ) ;
if ( F_38 ( V_2 -> V_5 ) )
return F_39 ( V_2 -> V_5 ) ;
V_122 = F_45 ( V_134 -> V_13 . V_138 , L_33 , 0 ) ;
if ( ! V_122 ) {
F_6 ( & V_134 -> V_13 , L_34 ) ;
return - V_33 ;
}
...
return - V_139 ;
V_121 = F_48 () ;
V_122 = F_29 ( V_134 -> V_13 . V_138 , V_121 ) ;
if ( ! V_122 ) {
F_6 ( & V_134 -> V_13 ,
L_35 ,
V_121 ) ;
