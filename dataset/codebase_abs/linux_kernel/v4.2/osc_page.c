...
if ( F_84 ( V_2 ) )
return F_85 ( V_2 ) ;
V_134 = F_86 ( V_2 ) -> V_144 ;
V_30 = & F_86 ( V_2 ) -> V_145 ;
F_87 ( & V_61 -> V_146 ) ;
F_88 ( & V_61 -> V_147 ) ;
V_142 = F_75 ( V_138 << 1 , F_52 ( & V_61 -> V_126 ) ) ;
while ( ! F_47 ( & V_61 -> V_148 ) ) {
struct V_13 * V_14 ;
if ( -- V_142 < 0 )
break;
V_4 = F_89 ( V_61 -> V_148 . V_149 , struct V_3 ,
V_110 ) ;
V_14 = F_7 ( V_4 -> V_15 . V_16 ) ;
if ( F_90 ( V_14 ) ) {
F_91 ( & V_4 -> V_110 , & V_61 -> V_148 ) ;
continue;
}
F_5 ( V_14 -> V_150 != NULL ) ;
if ( V_141 != V_14 -> V_150 ) {
...
F_93 ( & V_61 -> V_146 ) ;
if ( V_141 != NULL ) {
V_136 -= F_76 ( V_2 , V_30 , V_134 , V_143 ) ;
V_143 = 0 ;
F_94 ( V_2 , V_30 ) ;
F_95 ( V_2 , V_141 ) ;
V_141 = NULL ;
...
int V_46 ;
F_5 ( V_123 != NULL ) ;
F_5 ( ! F_47 ( & V_123 -> V_161 ) ) ;
V_46 = F_82 ( V_61 , V_133 ) ;
if ( V_46 != 0 ) {
F_4 ( V_162 , L_10 ,
V_61 -> V_163 -> V_164 -> V_165 , V_46 , V_61 ) ;
return V_46 ;
}
F_4 ( V_162 , L_11 ,
V_61 -> V_163 -> V_164 -> V_165 , V_61 ,
F_52 ( & V_61 -> V_126 ) ,
F_52 ( & V_61 -> V_157 ) ) ;
F_17 ( & V_123 -> V_166 ) ;
V_123 -> V_167 ++ ;
F_91 ( & V_61 -> V_168 , & V_123 -> V_161 ) ;
V_160 = F_52 ( & V_123 -> V_132 ) ;
while ( -- V_160 > 0 && ! F_47 ( & V_123 -> V_161 ) ) {
V_61 = F_89 ( V_123 -> V_161 . V_149 , struct V_60 ,
V_168 ) ;
F_4 ( V_162 , L_12 ,
V_61 -> V_163 -> V_164 -> V_165 , V_61 ,
F_52 ( & V_61 -> V_126 ) ,
