...
static int F_129 ( struct V_157 * V_158 )
{
...
static unsigned int F_139 ( unsigned int V_425 ,
unsigned int V_426 )
{
...
if ( V_427 >= F_141 ( 256 ) )
V_429 = V_431 ;
else if ( V_427 >= F_141 ( 128 ) )
V_429 = V_432 ;
else if ( V_427 >= F_141 ( 64 ) )
V_429 = V_433 ;
else if ( V_427 >= F_141 ( 32 ) )
V_429 = V_434 ;
else if ( V_427 >= F_141 ( 16 ) )
V_429 = V_435 ;
else if ( V_427 >= F_141 ( 8 ) )
V_429 = V_436 ;
else if ( V_427 >= F_141 ( 4 ) )
V_429 = V_437 ;
else if ( V_427 >= F_141 ( 2 ) )
V_429 = V_438 ;
else if ( V_427 >= F_141 ( 1 ) )
V_429 = V_439 ;
else if ( V_427 >= F_140 ( 512 ) )
V_429 = V_440 ;
else if ( V_427 >= F_140 ( 256 ) )
V_429 = V_430 ;
return V_429 ;
}
...
enum V_428 V_425 ;
unsigned int V_10 ;
V_425 = F_139 ( V_2 -> V_63 . V_441 ,
V_2 -> V_28 ) ;
for ( V_10 = 0 ; V_10 < V_2 -> V_28 ; V_10 ++ )
F_13 ( V_2 , V_10 , V_29 , V_442 , V_425 ) ;
F_143 ( V_2 , V_117 , V_2 -> V_69 ,
L_29 ,
...
static T_5 F_152 ( struct V_1 * V_2 , unsigned int V_478 )
{
bool V_479 ;
T_5 V_24 ;
switch ( V_478 ) {
...
while ( F_158 ( V_285 , V_616 ) ) {
V_615 = F_41 ( V_2 , V_612 ) ;
V_615 = F_159 ( V_615 , V_613 , V_627 ) ;
if ( ( V_615 == V_628 ) ||
( V_615 == V_629 ) )
break;
F_27 ( 500 , 1000 ) ;
}
if ( ! F_158 ( V_285 , V_616 ) )
F_160 ( V_2 -> V_69 ,
L_33 ,
V_9 -> V_340 ) ;
}
