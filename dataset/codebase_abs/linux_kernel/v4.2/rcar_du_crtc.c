...
static T_2 F_61 ( int V_112 , void * V_113 )
{
struct V_1 * V_2 = V_113 ;
T_2 V_13 = V_114 ;
T_1 V_115 ;
V_115 = F_1 ( V_2 , V_116 ) ;
F_3 ( V_2 , V_117 , V_115 & V_118 ) ;
if ( V_115 & V_119 ) {
...
int F_63 ( struct V_121 * V_122 , unsigned int V_30 )
{
static const unsigned int V_123 [] = {
V_124 , V_125 , V_126
} ;
struct V_4 * V_5 = V_122 -> V_7 ;
struct V_127 * V_128 = F_64 ( V_5 -> V_7 ) ;
struct V_1 * V_2 = & V_5 -> V_129 [ V_30 ] ;
struct V_62 * V_19 = & V_2 -> V_19 ;
unsigned int V_130 ;
struct V_23 * V_23 ;
char V_131 [ 9 ] ;
...
int V_13 ;
if ( F_65 ( V_5 , V_133 ) ) {
sprintf ( V_131 , L_3 , V_30 ) ;
V_132 = V_131 ;
} else {
V_132 = NULL ;
}
V_2 -> clock = F_66 ( V_5 -> V_7 , V_132 ) ;
if ( F_67 ( V_2 -> clock ) ) {
F_68 ( V_5 -> V_7 , L_4 , V_30 ) ;
return F_69 ( V_2 -> clock ) ;
}
sprintf ( V_131 , L_5 , V_30 ) ;
V_23 = F_66 ( V_5 -> V_7 , V_131 ) ;
if ( ! F_67 ( V_23 ) ) {
V_2 -> V_14 = V_23 ;
} else if ( F_69 ( V_2 -> clock ) == - V_134 ) {
...
V_2 -> V_30 = V_30 ;
V_2 -> V_111 = false ;
V_13 = F_72 ( V_5 -> V_135 , V_19 ,
& V_122 -> V_73 [ V_30 % 2 ] . V_69 ,
NULL , & V_136 ) ;
if ( V_13 < 0 )
return V_13 ;
F_73 ( V_19 , & V_137 ) ;
...
V_13 = F_75 ( V_5 -> V_7 , V_112 , F_61 , V_130 ,
F_76 ( V_5 -> V_7 ) , V_2 ) ;
if ( V_13 < 0 ) {
F_68 ( V_5 -> V_7 ,
L_8 , V_30 ) ;
...
void F_77 ( struct V_1 * V_2 , bool V_139 )
{
if ( V_139 ) {
F_3 ( V_2 , V_117 , V_140 ) ;
F_6 ( V_2 , V_141 , V_142 ) ;
