...
F_14 ( & V_22 -> V_32 , V_26 ) ;
if ( ! V_22 -> V_33 ) {
memcpy ( V_25 -> V_29 , & V_22 -> V_32 , sizeof( V_22 -> V_32 ) ) ;
V_22 -> V_33 = true ;
} else {
memcpy ( V_25 -> V_29 , & V_22 -> V_32 , sizeof( V_22 -> V_32 . V_34 ) ) ;
}
F_15 ( V_25 , V_35 ) ;
F_16 ( V_36 , V_25 -> V_37 + V_38 ) ;
F_16 ( V_39 , V_25 -> V_37 + V_40 ) ;
}
...
static int F_19 ( struct V_43 * V_4 ,
T_2 V_41 )
{
struct V_3 * V_44 = F_20 ( V_4 ) ;
struct V_12 * V_13 = F_7 ( V_44 ) ;
struct V_21 * V_22 = & V_13 -> V_4 . V_23 ;
struct V_24 * V_25 = V_22 -> V_5 . V_25 ;
int V_45 ;
if ( V_13 -> V_4 . V_5 . type == V_20 )
V_45 = F_21 ( & V_13 -> V_4 . V_19 , V_41 ) ;
else
V_45 = F_17 ( V_44 , V_41 ) ;
if ( V_45 )
return V_45 ;
memcpy ( V_44 -> V_46 , V_25 -> V_29 + V_47 ,
F_22 ( F_23 ( V_44 ) ) ) ;
return 0 ;
}
static void F_24 ( struct V_43 * V_4 )
{
struct V_3 * V_44 = F_20 ( V_4 ) ;
struct V_12 * V_13 = F_7 ( V_44 ) ;
if ( V_13 -> V_4 . V_5 . type == V_20 )
...
static inline void F_30 ( struct V_43 * V_4 ,
struct V_24 * V_25 )
{
struct V_3 * V_44 = F_20 ( V_4 ) ;
struct V_12 * V_13 = F_7 ( V_44 ) ;
...
static int F_34 ( struct V_58 * V_59 , const T_3 * V_60 ,
unsigned int V_26 )
{
struct V_50 * V_51 = F_35 ( V_59 ) ;
struct V_52 * V_53 = F_33 ( V_51 ) ;
int V_61 ;
int V_27 ;
int V_45 ;
int V_62 ;
V_45 = F_36 ( & V_53 -> V_63 , V_60 , V_26 ) ;
if ( V_45 ) {
F_37 ( V_59 , V_64 ) ;
return V_45 ;
}
...
F_38 ( V_53 -> V_63 . V_67 [ V_27 + V_62 ] ) ;
return 0 ;
}
static int F_39 ( struct V_58 * V_59 , const T_3 * V_60 ,
unsigned int V_26 )
{
struct V_50 * V_51 = F_35 ( V_59 ) ;
struct V_68 * V_53 = F_33 ( V_51 ) ;
T_2 V_69 [ V_70 ] ;
int V_45 ;
if ( V_26 != V_71 ) {
F_37 ( V_59 , V_64 ) ;
...
V_49 -> V_84 . V_86 = NULL ;
if ( V_4 -> V_7 != V_4 -> V_9 ) {
V_45 = F_43 ( V_14 -> V_15 , V_4 -> V_7 , V_13 -> V_17 ,
V_8 ) ;
if ( ! V_45 )
return - V_87 ;
V_45 = F_43 ( V_14 -> V_15 , V_4 -> V_9 , V_13 -> V_16 ,
V_10 ) ;
if ( ! V_45 ) {
V_45 = - V_87 ;
goto V_88;
...
{
struct V_12 * V_13 = F_7 ( V_4 ) ;
struct V_58 * V_51 = F_23 ( V_4 ) ;
unsigned int V_93 = F_52 ( V_51 ) ;
int V_45 ;
if ( ! F_53 ( V_4 -> V_6 , V_93 ) )
return - V_72 ;
V_13 -> V_17 = F_54 ( V_4 -> V_7 , V_4 -> V_6 ) ;
V_13 -> V_16 = F_54 ( V_4 -> V_9 , V_4 -> V_6 ) ;
F_55 ( V_92 , V_94 ,
V_95 ) ;
if ( V_14 -> V_96 -> V_97 )
V_45 = F_42 ( V_4 , V_92 ) ;
...
struct V_77 * V_92 )
{
struct V_68 * V_53 = F_33 ( V_4 -> V_5 . V_51 ) ;
int V_45 ;
F_55 ( V_92 , V_98 ,
V_99 ) ;
...
struct V_77 * V_92 )
{
struct V_108 * V_53 = F_33 ( V_4 -> V_5 . V_51 ) ;
int V_45 ;
F_55 ( V_92 , V_109 ,
V_99 ) ;
...
struct V_77 * V_92 )
{
struct V_52 * V_53 = F_33 ( V_4 -> V_5 . V_51 ) ;
int V_45 , V_62 ;
T_2 * V_60 ;
T_2 V_112 ;
V_112 = V_113 ;
...
V_92 -> V_53 . V_100 . V_60 [ V_62 ] = F_38 ( V_60 [ V_62 ] ) ;
