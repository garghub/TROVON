...
void * V_202 )
{
struct V_203 * V_206 = F_12 ( V_200 , struct V_203 , V_200 ) ;
struct V_1 * V_2 = F_12 ( V_206 , struct V_1 , V_206 ) ;
if ( V_201 )
F_49 ( V_161 , & V_2 -> V_162 ) ;
else
F_55 ( V_161 , & V_2 -> V_162 ) ;
...
const struct V_212 * V_206 ;
struct V_213 * V_214 = V_208 -> V_10 . V_215 ;
struct V_216 * V_217 ;
int V_218 , V_4 , V_219 ;
T_1 V_32 , V_220 [ 3 ] ;
V_35 = F_107 ( & V_208 -> V_10 , sizeof( * V_35 ) , V_221 ) ;
if ( ! V_35 )
return - V_222 ;
V_2 -> V_35 = V_35 ;
V_206 = F_108 ( V_223 , & V_208 -> V_10 ) ;
V_35 -> V_64 = (enum V_224 ) V_206 -> V_170 ;
...
V_211 = F_116 ( - V_126 ) ;
if ( F_115 ( V_214 , L_60 ) ) {
V_211 = F_117 ( & V_208 -> V_10 , 0 ) ;
if ( F_36 ( V_211 ) && F_110 ( V_211 ) != - V_126 )
return F_110 ( V_211 ) ;
V_210 = F_117 ( & V_208 -> V_10 , 1 ) ;
if ( F_36 ( V_210 ) && F_110 ( V_210 ) != - V_126 )
return F_110 ( V_210 ) ;
}
if ( ! F_36 ( V_211 ) ) {
V_2 -> V_204 . V_200 . V_228 = F_104 ;
V_4 = F_118 ( & V_2 -> V_204 . V_229 , V_211 -> V_230 ,
L_61 , & V_2 -> V_204 . V_200 ) ;
if ( V_4 < 0 ) {
F_3 ( & V_208 -> V_10 , L_62 ) ;
return V_4 ;
}
V_4 = F_119 ( V_211 , L_61 ) ;
if ( V_4 )
F_55 ( V_164 , & V_2 -> V_162 ) ;
else
F_49 ( V_164 , & V_2 -> V_162 ) ;
...
if ( ! F_36 ( V_210 ) ) {
V_2 -> V_206 . V_200 . V_228 = F_105 ;
V_4 = F_118 ( & V_2 -> V_206 . V_229 , V_210 -> V_230 ,
L_63 , & V_2 -> V_206 . V_200 ) ;
if ( V_4 < 0 ) {
F_3 ( & V_208 -> V_10 , L_64 ) ;
return V_4 ;
}
V_4 = F_119 ( V_210 , L_63 ) ;
if ( V_4 )
F_49 ( V_161 , & V_2 -> V_162 ) ;
else
F_55 ( V_161 , & V_2 -> V_162 ) ;
}
V_217 = F_120 ( V_214 , L_65 , & V_218 ) ;
if ( ! V_217 || ! V_218 )
return 0 ;
V_219 = V_218 / sizeof( T_1 ) ;
if ( V_219 >= V_40 ) {
F_121 ( & V_208 -> V_10 , L_66 , V_219 ) ;
return 0 ;
}
V_35 -> V_37 = F_107 ( & V_208 -> V_10 , V_218 , V_221 ) ;
if ( ! V_35 -> V_37 )
return 0 ;
V_4 = F_114 ( V_214 , L_65 ,
V_35 -> V_37 , V_219 ) ;
if ( ! V_4 )
V_35 -> V_41 = V_219 ;
return 0 ;
}
static int F_122 ( struct V_207 * V_208 )
{
struct V_231 V_232 [ 3 ] ;
int V_4 = 0 ;
struct V_213 * V_233 = V_208 -> V_10 . V_215 ;
struct V_34 * V_35 ;
struct V_234 * V_235 ;
struct V_1 * V_2 ;
struct V_24 * V_9 ;
void T_2 * V_236 ;
V_2 = F_107 ( & V_208 -> V_10 , sizeof( struct V_1 ) , V_221 ) ;
if ( ! V_2 )
return - V_222 ;
V_35 = F_123 ( & V_208 -> V_10 ) ;
if ( ! V_35 ) {
if ( ! V_233 )
return - V_237 ;
V_4 = F_106 ( V_208 , V_2 ) ;
...
V_2 -> V_9 . V_93 = F_107 ( & V_208 -> V_10 , sizeof( struct V_125 ) ,
V_221 ) ;
if ( ! V_2 -> V_9 . V_93 )
return - V_222 ;
V_9 = & V_2 -> V_9 ;
V_9 -> V_10 = & V_208 -> V_10 ;
V_2 -> V_105 = F_124 ( & V_208 -> V_10 , V_233 ? L_67 : L_68 ) ;
if ( F_36 ( V_2 -> V_105 ) ) {
F_3 ( & V_208 -> V_10 , L_69 ) ;
return F_110 ( V_2 -> V_105 ) ;
}
V_2 -> V_104 = F_124 ( & V_208 -> V_10 , V_233 ? L_70 : L_71 ) ;
if ( F_36 ( V_2 -> V_104 ) ) {
F_3 ( & V_208 -> V_10 , L_72 ) ;
return F_110 ( V_2 -> V_104 ) ;
}
V_2 -> V_68 = F_124 ( & V_208 -> V_10 ,
V_233 ? L_73 : L_74 ) ;
V_235 = F_125 ( V_208 , V_238 , 0 ) ;
if ( ! V_235 )
return - V_193 ;
V_2 -> V_232 = F_126 ( & V_208 -> V_10 , V_235 -> V_239 , F_127 ( V_235 ) ) ;
if ( ! V_2 -> V_232 )
return - V_222 ;
if ( V_2 -> V_53 ) {
V_236 = F_128 ( & V_208 -> V_10 , V_240 , 4 ) ;
if ( ! V_236 )
return - V_222 ;
F_13 ( 0x1 , V_236 ) ;
}
F_52 ( & V_208 -> V_10 , L_75 , V_2 -> V_232 ) ;
V_2 -> V_96 = F_129 ( V_208 , 0 ) ;
if ( V_2 -> V_96 < 0 ) {
F_3 ( & V_208 -> V_10 , L_76 ) ;
return V_2 -> V_96 ;
}
...
V_232 [ 1 ] . V_241 = L_78 ;
V_232 [ 2 ] . V_241 = L_79 ;
V_4 = F_130 ( V_2 -> V_9 . V_10 , F_131 ( V_232 ) , V_232 ) ;
if ( V_4 )
return V_4 ;
V_2 -> V_5 = V_232 [ 0 ] . V_242 ;
V_2 -> V_12 = V_232 [ 1 ] . V_242 ;
V_2 -> V_15 = V_232 [ 2 ] . V_242 ;
F_132 ( V_2 -> V_105 , 60000000 ) ;
F_37 ( V_2 -> V_105 ) ;
F_37 ( V_2 -> V_104 ) ;
if ( ! F_36 ( V_2 -> V_68 ) )
F_37 ( V_2 -> V_68 ) ;
...
F_13 ( 0 , V_246 ) ;
F_13 ( 0 , V_72 ) ;
F_133 ( & V_2 -> V_128 , F_84 ) ;
F_134 ( & V_2 -> V_139 , F_81 ) ;
V_4 = F_135 ( & V_208 -> V_10 , V_2 -> V_96 , F_88 , V_121 ,
L_52 , V_2 ) ;
if ( V_4 ) {
F_3 ( & V_208 -> V_10 , L_83 ) ;
goto V_245;
...
return - V_254 ;
if ( V_2 -> V_206 . V_229 . V_255 )
F_143 ( & V_2 -> V_206 . V_229 ) ;
if ( V_2 -> V_204 . V_229 . V_255 )
F_143 ( & V_2 -> V_204 . V_229 ) ;
F_103 () ;
F_86 ( & V_2 -> V_139 ) ;
F_144 ( & V_2 -> V_128 ) ;
F_145 ( & V_208 -> V_10 ) ;
...
static int F_149 ( struct V_256 * V_10 )
{
...
static int F_152 ( struct V_256 * V_10 )
{
struct V_1 * V_2 = F_150 ( V_10 ) ;
F_60 ( V_10 , L_87 ) ;
return F_43 ( V_2 ) ;
}
static int F_153 ( struct V_256 * V_10 )
{
struct V_1 * V_2 = F_150 ( V_10 ) ;
F_60 ( V_10 , L_88 ) ;
return F_53 ( V_2 ) ;
}
static int F_154 ( struct V_256 * V_10 )
{
struct V_1 * V_2 = F_150 ( V_10 ) ;
F_60 ( V_10 , L_89 ) ;
return F_43 ( V_2 ) ;
}
static int F_155 ( struct V_256 * V_10 )
{
struct V_1 * V_2 = F_150 ( V_10 ) ;
int V_4 ;
F_60 ( V_10 , L_90 ) ;
