...
static int F_153 ( struct V_226 * V_227 )
{
struct V_50 * V_51 ;
struct V_228 * V_229 ;
int V_172 , V_37 ;
...
V_229 -> V_241 = & V_242 ;
V_229 -> V_243 = & V_244 ;
V_229 -> V_104 = F_155 ( & V_227 -> V_117 ) ;
V_51 -> V_245 = F_156 ( V_229 , & V_227 -> V_117 , V_51 ) ;
if ( F_100 ( V_51 -> V_245 ) ) {
F_63 ( & V_227 -> V_117 , L_33 ) ;
return F_138 ( V_51 -> V_245 ) ;
}
for ( V_37 = 0 ; V_37 < V_51 -> V_146 ; V_37 ++ )
F_157 ( V_51 -> V_245 , & V_51 -> V_159 [ V_37 ] . V_6 ) ;
return 0 ;
}
