...
return NULL ;
F_126 ( V_15 , ',' , ' ' ) ;
V_199 = F_127 ( V_67 , V_15 , V_173 ) ;
F_22 ( V_15 ) ;
return V_199 ;
}
static int F_128 ( struct V_200 * V_53 , int V_59 ,
int V_201 , char * V_199 , int V_11 )
{
int V_43 ;
if ( V_59 )
V_43 = F_129 ( V_53 , V_199 , V_11 , V_201 ) ;
else
V_43 = F_130 ( V_53 , V_199 , V_11 , V_201 ) ;
return V_43 ;
}
static int F_131 ( int V_59 , char * V_71 , int V_11 ,
struct V_202 * V_38 )
{
...
V_199 = F_124 ( V_71 , V_11 , & V_203 ) ;
if ( ! V_199 )
return - V_41 ;
for ( V_22 = 0 ; V_22 < V_203 ; V_22 ++ ) {
V_43 = F_128 ( V_38 -> V_53 , V_59 , * V_201 ,
...
static int F_133 ( struct V_1 * V_2 , int V_206 )
{
...
static int F_134 ( enum V_30 V_31 ,
struct V_1 * V_2 ,
int * V_42 , void * V_38 )
{
if ( ( V_31 != V_39 ) ||
...
static int F_135 ( struct V_198 * V_3 ,
struct V_58 * V_59 )
{
struct V_202 V_38 = {
. V_204 = 1 ,
...
int F_136 ( struct V_198 * V_3 , int V_207 ,
char * V_189 )
{
int V_42 ;
struct V_58 * V_59 ;
...
static int F_138 ( struct V_1 * V_2 , void * V_3 )
{
struct V_107 * V_108 = V_2 -> V_108 ;
V_211 = 1 ;
F_139 ( V_212 L_10 , V_108 -> V_130 ) ;
return 1 ;
}
static int F_140 ( enum V_30 V_31 , struct V_1 * V_2 ,
int * V_42 , void * V_38 )
{
char * V_213 = V_38 ;
if ( ( V_31 == V_39 ) &&
