...
V_65 = strpbrk ( V_64 , L_9 ) ;
if ( V_65 )
* V_65 = '\0' ;
snprintf ( V_53 , V_54 , L_10 , 'p' , V_64 , V_17 ) ;
V_27 = V_53 ;
F_18 ( V_64 ) ;
}
V_16 = F_12 ( V_26 , V_27 , V_50 , V_57 ) ;
if ( F_43 ( V_16 ) ) {
F_35 ( L_11 , ( int ) F_44 ( V_16 ) ) ;
V_5 = F_44 ( V_16 ) ;
goto V_60;
}
V_16 -> V_17 = V_17 ;
...
int V_42 ;
F_55 ( V_73 , L_20 , V_76 , V_16 -> V_33 . V_34 . V_35 -> system ,
F_24 ( & V_16 -> V_33 . V_34 ) ) ;
F_55 ( V_73 , L_21 , V_16 -> V_45 , ( void * ) V_16 -> V_17 ) ;
for ( V_42 = 0 ; V_42 < V_16 -> V_33 . V_43 ; V_42 ++ )
F_55 ( V_73 , L_22 , V_16 -> V_33 . args [ V_42 ] . V_36 , V_16 -> V_33 . args [ V_42 ] . V_77 ) ;
F_56 ( V_73 , '\n' ) ;
return 0 ;
}
...
V_108 = F_84 ( F_11 ( V_16 ) ) ;
V_69 = V_108 + V_16 -> V_33 . V_69 + V_100 ;
V_69 = F_125 ( V_69 + sizeof( V_153 ) , sizeof( V_154 ) ) - sizeof( V_153 ) ;
if ( F_126 ( V_69 > V_155 , L_26 ) )
return;
F_127 () ;
V_151 = F_128 ( V_34 -> V_22 ) ;
if ( F_129 ( V_151 ) )
goto V_124;
V_104 = F_130 ( V_69 , V_34 -> V_27 . type , NULL , & V_152 ) ;
if ( ! V_104 )
goto V_124;
if ( F_11 ( V_16 ) ) {
V_104 -> V_14 [ 0 ] = V_99 ;
...
int V_156 = V_16 -> V_33 . V_69 + V_100 ;
memset ( V_107 + V_156 , 0 , V_69 - V_108 - V_156 ) ;
}
F_131 ( V_104 , V_69 , V_152 , 0 , 1 , V_4 , V_151 , NULL ) ;
V_124:
F_132 () ;
}
static int F_133 ( struct V_23 * V_16 , struct V_3 * V_4 ,
struct V_91 * V_98 , int V_100 )
{
...
static void F_134 ( struct V_23 * V_16 , unsigned long V_99 ,
struct V_3 * V_4 ,
struct V_91 * V_98 , int V_100 )
{
...
static int
F_135 ( struct V_109 * V_27 , enum V_158 type ,
void * V_107 )
{
...
static int V_40 ( struct V_146 * V_165 , struct V_3 * V_4 )
{
struct V_23 * V_16 ;
struct V_10 V_11 ;
struct V_91 * V_98 ;
int V_100 , V_108 ;
int V_5 = 0 ;
V_16 = F_96 ( V_165 , struct V_23 , V_24 ) ;
V_16 -> V_87 ++ ;
V_11 . V_16 = V_16 ;
V_11 . V_15 = F_87 ( V_4 ) ;
...
if ( F_82 ( ! V_91 ) )
return 0 ;
V_100 = F_137 ( & V_16 -> V_33 , V_4 ) ;
V_108 = F_84 ( F_11 ( V_16 ) ) ;
V_98 = F_77 () ;
F_138 ( V_108 , & V_16 -> V_33 , V_4 , V_98 -> V_53 , V_100 ) ;
if ( V_16 -> V_33 . V_117 & V_128 )
V_5 |= F_90 ( V_16 , V_4 , V_98 , V_100 ) ;
#ifdef F_136
if ( V_16 -> V_33 . V_117 & V_126 )
V_5 |= F_133 ( V_16 , V_4 , V_98 , V_100 ) ;
#endif
F_79 ( V_98 ) ;
return V_5 ;
}
static int V_41 ( struct V_146 * V_165 ,
unsigned long V_99 , struct V_3 * V_4 )
{
struct V_23 * V_16 ;
struct V_10 V_11 ;
...
#ifdef F_136
if ( V_16 -> V_33 . V_117 & V_126 )
F_134 ( V_16 , V_99 , V_4 , V_98 , V_100 ) ;
#endif
F_79 ( V_98 ) ;
return 0 ;
}
...
int V_5 ;
F_8 ( & V_34 -> V_35 -> V_166 ) ;
V_34 -> V_27 . V_167 = & V_168 ;
V_34 -> V_35 -> V_169 = F_110 ;
if ( F_139 ( & V_16 -> V_33 , F_11 ( V_16 ) ) < 0 )
return - V_32 ;
V_5 = F_140 ( & V_34 -> V_27 ) ;
if ( ! V_5 ) {
F_18 ( V_34 -> V_170 ) ;
...
{
int V_5 ;
V_5 = F_143 ( & V_16 -> V_33 . V_34 ) ;
if ( V_5 )
return V_5 ;
F_18 ( V_16 -> V_33 . V_34 . V_170 ) ;
V_16 -> V_33 . V_34 . V_170 = NULL ;
return 0 ;
}
...
if ( F_43 ( V_173 ) )
return 0 ;
F_146 ( L_28 , 0644 , V_173 ,
NULL , & V_174 ) ;
F_146 ( L_29 , 0444 , V_173 ,
NULL , & V_175 ) ;
return 0 ;
}
