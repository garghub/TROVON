...
F_14 ( V_4 -> V_8 + V_20 ,
V_4 -> V_21 , V_23 ) ;
F_15 ( V_4 -> V_8 + V_20 , V_24 ) ;
F_16 ( V_4 -> V_8 + V_20 , V_4 ) ;
}
}
static int T_3 F_17 ( struct V_3 * * V_25 , int V_26 ,
struct V_27 * V_28 )
{
...
static int T_3 F_29 ( struct V_27 * V_28 ,
struct V_27 * V_37 )
{
return F_17 ( V_38 ,
F_30 ( V_38 ) , V_28 ) ;
}
static int T_3 F_31 ( struct V_27 * V_28 ,
struct V_27 * V_37 )
{
return F_17 ( V_39 ,
F_30 ( V_39 ) , V_28 ) ;
