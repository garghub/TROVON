...
static int F_84 ( struct V_124 * V_124 , struct V_96 * V_4 , int V_125 )
{
int error = - V_126 ;
struct V_4 * V_23 ;
struct V_1 * V_25 ;
struct V_5 * V_6 ;
V_23 = F_85 ( V_124 , V_127 , V_128 , & V_129 , V_125 ) ;
if ( ! V_23 )
goto V_130;
F_86 ( V_4 , V_23 ) ;
V_4 -> V_131 = V_132 ;
