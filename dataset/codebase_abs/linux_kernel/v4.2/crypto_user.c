...
static struct V_1 * F_46 ( const char * V_85 , T_1 type ,
T_1 V_86 )
{
int V_58 ;
struct V_1 * V_6 ;
...
case V_91 :
V_6 = F_46 ( V_85 , V_3 -> V_10 , V_3 -> V_11 ) ;
break;
case V_93 :
case V_94 :
case V_95 :
...
break;
default:
V_6 = F_49 ( V_85 , V_3 -> V_10 , V_3 -> V_11 ) ;
}
if ( F_42 ( V_6 ) )
return F_43 ( V_6 ) ;
F_31 ( & V_7 ) ;
...
static int F_52 ( struct V_16 * V_17 , struct V_56 * V_57 )
{
struct V_64 * V_65 [ V_96 + 1 ] ;
...
return F_53 ( V_72 , V_17 , V_57 , & V_108 ) ;
}
}
V_58 = F_54 ( V_57 , V_111 [ type ] , V_65 , V_96 ,
V_112 ) ;
if ( V_58 < 0 )
return V_58 ;
if ( V_98 -> V_113 == NULL )
return - V_66 ;
return V_98 -> V_113 ( V_17 , V_57 , V_65 ) ;
}
