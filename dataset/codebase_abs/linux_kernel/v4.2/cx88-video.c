...
static int F_19 ( struct V_67 * V_36 , const struct V_68 * V_48 ,
...
struct V_5 * V_6 = V_34 -> V_6 ;
struct V_37 * V_38 = F_21 ( V_64 , struct V_37 , V_64 ) ;
struct V_77 * V_78 = F_22 ( V_64 , 0 ) ;
V_38 -> V_41 = V_6 -> V_44 * V_34 -> V_48 -> V_74 >> 3 ;
if ( F_23 ( V_64 , 0 ) < V_6 -> V_45 * V_38 -> V_41 )
return - V_79 ;
F_24 ( V_64 , 0 , V_6 -> V_45 * V_38 -> V_41 ) ;
switch ( V_6 -> V_46 ) {
case V_80 :
F_25 ( V_34 -> V_81 , & V_38 -> V_42 ,
V_78 -> V_82 , 0 , V_83 ,
...
static void F_26 ( struct V_76 * V_64 )
{
struct V_33 * V_34 = V_64 -> V_67 -> V_73 ;
struct V_37 * V_38 = F_21 ( V_64 , struct V_37 , V_64 ) ;
struct V_89 * V_42 = & V_38 -> V_42 ;
if ( V_42 -> V_90 )
F_27 ( V_34 -> V_81 , V_42 -> V_91 , V_42 -> V_90 , V_42 -> V_43 ) ;
memset ( V_42 , 0 , sizeof( * V_42 ) ) ;
}
static void F_28 ( struct V_76 * V_64 )
{
struct V_33 * V_34 = V_64 -> V_67 -> V_73 ;
struct V_37 * V_38 = F_21 ( V_64 , struct V_37 , V_64 ) ;
struct V_37 * V_92 ;
...
V_38 -> V_42 . V_90 [ 1 ] = F_29 ( V_38 -> V_42 . V_43 + 8 ) ;
V_38 -> V_42 . V_94 [ 0 ] = F_29 ( V_95 | V_96 ) ;
V_38 -> V_42 . V_94 [ 1 ] = F_29 ( V_38 -> V_42 . V_43 + 8 ) ;
if ( F_17 ( & V_36 -> V_61 ) ) {
F_30 ( & V_38 -> V_63 , & V_36 -> V_61 ) ;
F_4 ( 2 , L_4 ,
V_38 , V_38 -> V_64 . V_65 . V_66 ) ;
} else {
V_38 -> V_42 . V_90 [ 0 ] |= F_29 ( V_97 ) ;
V_92 = F_18 ( V_36 -> V_61 . V_92 , struct V_37 , V_63 ) ;
F_30 ( & V_38 -> V_63 , & V_36 -> V_61 ) ;
V_92 -> V_42 . V_94 [ 1 ] = F_29 ( V_38 -> V_42 . V_43 ) ;
F_4 ( 2 , L_5 ,
V_38 , V_38 -> V_64 . V_65 . V_66 ) ;
}
}
static int F_31 ( struct V_67 * V_36 , unsigned int V_53 )
{
struct V_33 * V_34 = V_36 -> V_73 ;
...
static void F_32 ( struct V_67 * V_36 )
{
struct V_33 * V_34 = V_36 -> V_73 ;
struct V_5 * V_6 = V_34 -> V_6 ;
struct V_35 * V_98 = & V_34 -> V_93 ;
...
F_9 ( V_60 , 0x11 ) ;
F_9 ( V_58 , 0x06 ) ;
F_33 ( & V_34 -> V_100 , V_99 ) ;
while ( ! F_17 ( & V_98 -> V_61 ) ) {
struct V_37 * V_38 = F_18 ( V_98 -> V_61 . V_62 ,
struct V_37 , V_63 ) ;
F_34 ( & V_38 -> V_63 ) ;
F_35 ( & V_38 -> V_64 , V_101 ) ;
}
F_36 ( & V_34 -> V_100 , V_99 ) ;
}
static int F_37 ( struct V_102 * V_102 )
{
struct V_33 * V_34 = F_38 ( V_102 ) ;
struct V_5 * V_6 = V_34 -> V_6 ;
int V_103 = F_39 ( V_102 ) ;
if ( V_103 )
return V_103 ;
...
{
struct V_5 * V_6 =
F_21 ( V_111 -> V_112 , struct V_5 , V_113 ) ;
...
if ( V_115 -> V_129 )
F_42 ( V_115 -> V_129 , V_115 -> V_128 , V_118 , V_117 ) ;
else
...
{
struct V_5 * V_6 =
F_21 ( V_111 -> V_112 , struct V_5 , V_130 ) ;
const struct V_114 * V_115 = V_111 -> V_116 ;
T_1 V_117 , V_118 ;
if ( V_6 -> V_23 ) {
switch ( V_111 -> V_119 ) {
case V_131 :
F_44 ( V_6 , V_111 -> V_119 , V_111 -> V_121 ) ;
break;
case V_132 :
F_44 ( V_6 , V_111 -> V_119 , ( V_111 -> V_121 ) ?
...
break;
case V_133 :
F_44 ( V_6 , V_111 -> V_119 , V_111 -> V_121 << 9 ) ;
break;
default:
break;
}
...
static int F_45 ( struct V_102 * V_102 , void * V_116 ,
struct V_68 * V_134 )
{
struct V_33 * V_34 = F_38 ( V_102 ) ;
struct V_5 * V_6 = V_34 -> V_6 ;
...
if ( NULL == V_48 )
return - V_79 ;
V_142 = F_47 ( V_6 -> V_124 ) ;
V_143 = F_48 ( V_6 -> V_124 ) ;
...
if ( F_49 ( V_46 ) )
V_143 /= 2 ;
F_50 ( & V_134 -> V_48 . V_135 . V_44 , 48 , V_142 , 2 ,
...
static int F_51 ( struct V_102 * V_102 , void * V_116 ,
struct V_68 * V_134 )
{
struct V_33 * V_34 = F_38 ( V_102 ) ;
struct V_5 * V_6 = V_34 -> V_6 ;
int V_144 = F_46 ( V_102 , V_116 , V_134 ) ;
if ( 0 != V_144 )
return V_144 ;
if ( F_52 ( & V_34 -> V_145 ) || F_52 ( & V_34 -> V_146 ) )
return - V_147 ;
if ( V_6 -> V_148 && F_52 ( & V_6 -> V_148 -> V_149 ) )
return - V_147 ;
...
void F_53 ( struct V_102 * V_102 , struct V_5 * V_6 ,
struct V_150 * V_151 )
{
struct V_152 * V_153 = F_54 ( V_102 ) ;
F_55 ( V_151 -> V_154 , V_6 -> V_104 . V_88 , sizeof( V_151 -> V_154 ) ) ;
...
static int F_56 ( struct V_102 * V_102 , void * V_116 ,
struct V_150 * V_151 )
{
struct V_33 * V_34 = F_38 ( V_102 ) ;
struct V_5 * V_6 = V_34 -> V_6 ;
strcpy ( V_151 -> V_170 , L_9 ) ;
sprintf ( V_151 -> V_171 , L_10 , F_57 ( V_34 -> V_81 ) ) ;
F_53 ( V_102 , V_6 , V_151 ) ;
return 0 ;
}
static int F_58 ( struct V_102 * V_102 , void * V_116 ,
struct V_172 * V_134 )
{
if ( F_59 ( V_134 -> V_66 >= F_2 ( V_4 ) ) )
return - V_79 ;
F_55 ( V_134 -> V_173 , V_4 [ V_134 -> V_66 ] . V_88 , sizeof( V_134 -> V_173 ) ) ;
V_134 -> V_136 = V_4 [ V_134 -> V_66 ] . V_2 ;
return 0 ;
}
static int F_60 ( struct V_102 * V_102 , void * V_116 , T_2 * V_124 )
{
struct V_33 * V_34 = F_38 ( V_102 ) ;
struct V_5 * V_6 = V_34 -> V_6 ;
* V_124 = V_6 -> V_124 ;
...
static int F_61 ( struct V_102 * V_102 , void * V_116 , T_2 V_174 )
{
struct V_33 * V_34 = F_38 ( V_102 ) ;
struct V_5 * V_6 = V_34 -> V_6 ;
return F_62 ( V_6 , V_174 ) ;
}
int F_63 ( struct V_5 * V_6 , struct V_175 * V_3 )
{
...
static int F_64 ( struct V_102 * V_102 , void * V_116 ,
struct V_175 * V_3 )
{
struct V_33 * V_34 = F_38 ( V_102 ) ;
struct V_5 * V_6 = V_34 -> V_6 ;
...
static int F_65 ( struct V_102 * V_102 , void * V_116 , unsigned int * V_3 )
{
struct V_33 * V_34 = F_38 ( V_102 ) ;
struct V_5 * V_6 = V_34 -> V_6 ;
* V_3 = V_6 -> V_7 ;
...
static int F_68 ( struct V_102 * V_102 , void * V_116 ,
struct V_188 * V_189 )
{
struct V_33 * V_34 = F_38 ( V_102 ) ;
struct V_5 * V_6 = V_34 -> V_6 ;
T_1 V_128 ;
if ( F_59 ( V_83 == V_6 -> V_104 . V_158 ) )
return - V_79 ;
if ( 0 != V_189 -> V_66 )
return - V_79 ;
...
static int F_71 ( struct V_102 * V_102 , void * V_116 ,
...
static int F_75 ( struct V_102 * V_102 , void * V_116 ,
const struct V_196 * V_134 )
{
struct V_33 * V_34 = F_38 ( V_102 ) ;
struct V_5 * V_6 = V_34 -> V_6 ;
return F_73 ( V_6 , V_134 ) ;
}
static int F_76 ( struct V_102 * V_102 , void * V_202 ,
struct V_203 * V_128 )
{
struct V_33 * V_34 = F_38 ( V_102 ) ;
struct V_5 * V_6 = V_34 -> V_6 ;
V_128 -> V_121 = F_70 ( V_128 -> V_128 & 0xfffffc ) ;
V_128 -> V_91 = 4 ;
return 0 ;
}
...
static int F_78 ( struct V_102 * V_102 , void * V_116 ,
struct V_188 * V_189 )
{
struct V_33 * V_34 = F_38 ( V_102 ) ;
struct V_5 * V_6 = V_34 -> V_6 ;
if ( F_59 ( V_189 -> V_66 > 0 ) )
return - V_79 ;
...
F_84 ( & V_34 -> V_100 ) ;
V_53 = F_70 ( V_210 ) ;
F_85 ( V_6 , & V_34 -> V_93 , V_53 ) ;
F_86 ( & V_34 -> V_100 ) ;
}
if ( V_205 & 0x08 ) {
F_84 ( & V_34 -> V_100 ) ;
V_53 = F_70 ( V_211 ) ;
F_85 ( V_6 , & V_34 -> V_212 , V_53 ) ;
F_86 ( & V_34 -> V_100 ) ;
}
}
static T_3 F_87 ( int V_213 , void * V_214 )
{
...
static int F_92 ( struct V_222 * V_222 ,
...
F_96 ( V_222 , V_231 , & V_34 -> V_232 ) ;
F_82 ( V_233 L_24
L_25 , V_6 -> V_88 ,
F_57 ( V_222 ) , V_34 -> V_229 , V_222 -> V_213 ,
V_34 -> V_232 , ( unsigned long long ) F_97 ( V_222 , 0 ) ) ;
F_98 ( V_222 ) ;
if ( ! F_99 ( V_222 , F_100 ( 32 ) ) ) {
F_82 ( L_26 , V_6 -> V_88 ) ;
V_144 = - V_227 ;
goto V_234;
}
V_34 -> V_75 = F_101 ( & V_222 -> V_34 ) ;
if ( F_102 ( V_34 -> V_75 ) ) {
V_144 = F_103 ( V_34 -> V_75 ) ;
goto V_234;
}
F_104 ( & V_34 -> V_100 ) ;
F_105 ( & V_34 -> V_93 . V_61 ) ;
F_105 ( & V_34 -> V_212 . V_61 ) ;
V_144 = F_106 ( V_222 -> V_213 , F_87 ,
V_235 , V_6 -> V_88 , V_34 ) ;
if ( V_144 < 0 ) {
F_82 ( V_236 L_27 ,
...
F_108 ( & V_6 -> V_113 , & V_6 -> V_130 , NULL ) ;
...
V_257 = F_109 ( & V_6 -> V_261 , & V_6 -> V_262 ,
& V_252 , NULL ) ;
if ( V_257 != NULL ) {
V_6 -> V_23 = V_257 ;
V_257 -> V_263 = V_264 ;
...
F_113 ( L_31 ) ;
V_6 -> V_269 = F_114 ( & V_6 -> V_262 , & V_268 ) ;
}
case V_270 :
F_113 ( L_32 ) ;
}
...
if ( V_144 < 0 )
goto V_290;
F_119 ( V_6 , V_34 -> V_81 , & V_34 -> V_221 ,
& V_293 , L_33 ) ;
F_120 ( & V_34 -> V_221 , V_34 ) ;
V_34 -> V_221 . V_294 = & V_6 -> V_113 ;
V_34 -> V_221 . V_295 = & V_34 -> V_145 ;
V_144 = F_121 ( & V_34 -> V_221 , V_163 ,
V_296 [ V_6 -> V_297 ] ) ;
if ( V_144 < 0 ) {
F_82 ( V_236 L_34 ,
V_6 -> V_88 ) ;
...
F_82 ( V_233 L_35 ,
V_6 -> V_88 , F_122 ( & V_34 -> V_221 ) ) ;
F_119 ( V_6 , V_34 -> V_81 , & V_34 -> V_220 ,
& V_298 , L_36 ) ;
F_120 ( & V_34 -> V_220 , V_34 ) ;
V_34 -> V_220 . V_295 = & V_34 -> V_146 ;
V_144 = F_121 ( & V_34 -> V_220 , V_165 ,
V_299 [ V_6 -> V_297 ] ) ;
if ( V_144 < 0 ) {
F_82 ( V_236 L_37 ,
V_6 -> V_88 ) ;
...
F_82 ( V_233 L_38 ,
V_6 -> V_88 , F_122 ( & V_34 -> V_220 ) ) ;
if ( V_6 -> V_104 . V_105 . type == V_169 ) {
F_119 ( V_6 , V_34 -> V_81 , & V_34 -> V_219 ,
& V_300 , L_39 ) ;
F_120 ( & V_34 -> V_219 , V_34 ) ;
V_34 -> V_219 . V_294 = & V_6 -> V_130 ;
V_144 = F_121 ( & V_34 -> V_219 , V_161 ,
V_301 [ V_6 -> V_297 ] ) ;
if ( V_144 < 0 ) {
F_82 ( V_236 L_40 ,
V_6 -> V_88 ) ;
...
F_82 ( V_233 L_38 ,
V_6 -> V_88 , F_122 ( & V_34 -> V_219 ) ) ;
}
if ( V_6 -> V_104 . V_158 != V_83 ) {
V_6 -> V_302 = F_123 ( V_303 , V_6 , L_41 ) ;
if ( F_102 ( V_6 -> V_302 ) ) {
V_144 = F_103 ( V_6 -> V_302 ) ;
F_82 ( V_236 L_42 ,
V_6 -> V_88 , V_144 ) ;
}
}
...
static void F_129 ( struct V_222 * V_222 )
{
struct V_33 * V_34 = F_130 ( V_222 ) ;
struct V_5 * V_6 = V_34 -> V_6 ;
if ( V_6 -> V_302 ) {
F_131 ( V_6 -> V_302 ) ;
V_6 -> V_302 = NULL ;
...
static int F_135 ( struct V_222 * V_222 , T_4 V_305 )
{
struct V_33 * V_34 = F_130 ( V_222 ) ;
struct V_5 * V_6 = V_34 -> V_6 ;
unsigned long V_99 ;
...
F_133 ( V_6 ) ;
F_137 ( V_222 ) ;
if ( 0 != F_138 ( V_222 , F_139 ( V_222 , V_305 ) ) ) {
F_134 ( V_222 ) ;
V_34 -> V_305 . V_306 = 1 ;
}
return 0 ;
}
static int F_140 ( struct V_222 * V_222 )
{
struct V_33 * V_34 = F_130 ( V_222 ) ;
struct V_5 * V_6 = V_34 -> V_6 ;
unsigned long V_99 ;
...
V_144 = F_138 ( V_222 , V_307 ) ;
if ( V_144 ) {
F_82 ( V_236 L_46 , V_6 -> V_88 ) ;
F_134 ( V_222 ) ;
V_34 -> V_305 . V_306 = 1 ;
return V_144 ;
}
