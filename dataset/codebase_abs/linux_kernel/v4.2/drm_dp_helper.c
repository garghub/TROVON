...
{
unsigned int V_39 , V_80 ;
int V_81 ;
for ( V_39 = 0 , V_80 = 0 ; V_39 < ( 7 + V_80 ) ; V_39 ++ ) {
F_14 ( & V_32 -> V_42 ) ;
V_81 = V_32 -> V_43 ( V_32 , V_38 ) ;
F_15 ( & V_32 -> V_42 ) ;
if ( V_81 < 0 ) {
if ( V_81 == - V_44 )
continue;
...
switch ( V_38 -> V_45 & V_83 ) {
case V_84 :
return V_81 ;
case V_85 :
F_17 ( L_6 , V_81 , V_38 -> V_36 ) ;
V_32 -> V_86 ++ ;
return - V_82 ;
case V_87 :
F_17 ( L_7 ) ;
...
static int F_30 ( struct V_31 * V_32 , struct V_37 * V_89 )
{
int V_40 , V_81 = V_89 -> V_36 ;
struct V_37 V_38 = * V_89 ;
while ( V_38 . V_36 > 0 ) {
V_40 = F_28 ( V_32 , & V_38 ) ;
if ( V_40 <= 0 )
return V_40 == 0 ? - V_48 : V_40 ;
if ( V_40 < V_38 . V_36 && V_40 < V_81 ) {
F_17 ( L_9 ,
V_38 . V_36 , V_40 ) ;
V_81 = V_40 ;
}
...
static int F_31 ( struct V_73 * V_74 , struct V_90 * V_91 ,
int V_92 )
{
struct V_31 * V_32 = V_74 -> V_93 ;
unsigned int V_6 , V_94 ;
unsigned V_95 ;
struct V_37 V_38 ;
int V_40 = 0 ;
V_96 = F_32 ( V_96 , 1 , V_97 ) ;
memset ( & V_38 , 0 , sizeof( V_38 ) ) ;
for ( V_6 = 0 ; V_6 < V_92 ; V_6 ++ ) {
V_38 . V_41 = V_91 [ V_6 ] . V_98 ;
V_38 . V_33 = ( V_91 [ V_6 ] . V_99 & V_100 ) ?
V_101 :
V_102 ;
V_38 . V_33 |= V_103 ;
V_38 . V_35 = NULL ;
...
break;
V_95 = V_96 ;
for ( V_94 = 0 ; V_94 < V_91 [ V_6 ] . V_104 ; V_94 += V_38 . V_36 ) {
V_38 . V_35 = V_91 [ V_6 ] . V_105 + V_94 ;
V_38 . V_36 = F_33 ( V_95 , V_91 [ V_6 ] . V_104 - V_94 ) ;
V_40 = F_30 ( V_32 , & V_38 ) ;
if ( V_40 < 0 )
break;
V_95 = V_40 ;
...
V_32 -> V_106 . V_93 = V_32 ;
V_32 -> V_106 . V_109 = 3 ;
V_32 -> V_106 . V_110 = V_111 ;
V_32 -> V_106 . V_112 = V_113 ;
V_32 -> V_106 . V_114 . V_115 = V_32 -> V_114 ;
V_32 -> V_106 . V_114 . V_116 = V_32 -> V_114 -> V_116 ;
F_36 ( V_32 -> V_106 . V_117 , V_32 -> V_117 ? V_32 -> V_117 : F_37 ( V_32 -> V_114 ) ,
sizeof( V_32 -> V_106 . V_117 ) ) ;
return F_38 ( & V_32 -> V_106 ) ;
}
