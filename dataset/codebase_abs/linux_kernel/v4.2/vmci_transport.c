...
static int F_113 ( struct V_65 * V_66 ,
struct V_186 * V_187 , T_6 V_188 ,
int V_88 )
{
int V_2 ;
int V_191 ;
...
struct V_98 * V_99 ;
V_191 = V_88 & V_193 ;
if ( V_88 & V_194 || V_88 & V_195 )
return - V_196 ;
V_2 = 0 ;
V_99 = F_114 ( & V_66 -> V_64 , V_88 , V_191 , & V_2 ) ;
if ( V_2 )
return V_2 ;
if ( ! V_99 )
return - V_197 ;
...
goto V_90;
V_192 = V_32 -> V_35 ;
if ( V_192 != V_99 -> V_188 - sizeof( * V_32 ) ) {
V_2 = - V_15 ;
goto V_90;
}
if ( V_192 > V_188 ) {
...
V_2 = F_115 ( V_99 , sizeof( * V_32 ) , V_187 , V_192 ) ;
if ( V_2 )
goto V_90;
if ( V_187 -> V_200 ) {
F_116 ( struct V_22 * , V_201 , V_187 -> V_200 ) ;
F_6 ( V_201 , V_32 -> V_23 . V_58 , V_32 -> V_23 . V_108 ) ;
V_187 -> V_202 = sizeof( * V_201 ) ;
}
V_2 = V_192 ;
V_90:
...
static void F_134 ( struct V_65 * V_66 , T_4 V_206 )
{
if ( V_206 < F_63 ( V_66 ) -> V_143 )
F_63 ( V_66 ) -> V_143 = V_206 ;
if ( V_206 > F_63 ( V_66 ) -> V_144 )
F_63 ( V_66 ) -> V_144 = V_206 ;
F_63 ( V_66 ) -> V_145 = V_206 ;
}
static void F_135 ( struct V_65 * V_66 ,
T_4 V_206 )
{
if ( V_206 > F_63 ( V_66 ) -> V_145 )
F_63 ( V_66 ) -> V_145 = V_206 ;
F_63 ( V_66 ) -> V_143 = V_206 ;
}
...
bool * V_208 )
{
return F_63 ( V_66 ) -> V_113 -> V_209 (
& V_66 -> V_64 , V_207 , V_208 ) ;
}
static int F_138 (
struct V_65 * V_66 ,
T_6 V_207 ,
bool * V_210 )
{
return F_63 ( V_66 ) -> V_113 -> V_211 (
& V_66 -> V_64 , V_207 , V_210 ) ;
}
static int F_139 (
struct V_65 * V_66 ,
T_6 V_207 ,
