...
F_97 ( & V_33 -> V_34 -> V_232 ) ;
F_98 ( & V_62 -> V_233 ,
F_99 ( V_234 ) ) ;
F_100 ( & V_33 -> V_34 -> V_232 ) ;
...
F_18 ( V_10 ) ;
V_62 -> V_192 . V_203 = V_21 -> V_235 ;
F_102 ( V_2 , V_236 , 1 ) ;
F_102 ( V_2 , V_237 , V_21 -> V_235 ) ;
if ( V_21 -> V_235 ) {
memcpy ( V_62 -> V_192 . V_200 , V_21 -> V_238 ,
V_21 -> V_235 ) ;
V_62 -> V_192 . V_204 =
V_62 -> V_192 . V_200 + V_21 -> V_235 ;
}
V_10 -> V_33 = V_33 -> V_22 ;
V_10 -> V_36 = NULL ;
return F_85 ( V_21 ) ;
...
struct V_9 * V_10 = V_21 -> V_22 ;
struct V_239 * V_105 = (struct V_239 * ) V_21 -> V_105 ;
if ( F_105 ( & V_62 -> V_82 -> V_240 ) + 1 >
V_2 -> V_171 )
return - V_80 ;
if ( ! V_43 )
return F_101 ( V_33 , V_21 ) ;
F_18 ( V_10 ) ;
V_10 -> V_26 . V_58 = V_241 ;
V_10 -> V_33 = V_62 ;
V_10 -> V_36 = V_43 ;
V_10 -> V_26 . V_27 = F_14 ( V_43 ) ;
V_10 -> V_26 . V_242 = F_93 ( V_105 -> V_243 ) ;
F_15 ( V_10 ) ;
F_91 ( V_43 , V_10 ) ;
V_10 -> V_26 . V_244 = V_245 ;
if ( V_43 -> V_246 == V_247 ) {
V_10 -> V_26 . V_244 |= V_248 ;
V_10 -> V_26 . V_249 = V_21 -> V_249 |
( V_250 << V_251 ) ;
F_4 ( V_21 ) ;
} else {
if ( F_14 ( V_43 ) )
V_10 -> V_26 . V_244 |= V_252 ;
V_10 -> V_26 . V_249 = V_21 -> V_249 |
( V_253 << V_251 ) ;
}
V_10 -> V_26 . V_254 = V_10 -> V_16 . V_39 ;
if ( ! V_10 -> V_16 . V_39 ) {
...
static struct V_261 *
F_111 ( struct V_117 * V_118 , T_6 V_262 )
{
struct V_127 * V_128 = F_104 ( V_118 ) ;
struct V_1 * V_2 = F_64 ( V_128 ) ;
struct V_62 * V_62 ;
...
( V_84 -> V_88 == V_271 ) )
return - V_268 ;
if ( F_118 ( V_118 , V_66 , V_266 ) )
return - V_268 ;
if ( V_84 -> V_2 != V_2 ) {
F_7 ( V_38 , V_66 -> V_22 ,
L_17 ,
V_84 , V_84 -> V_2 -> V_149 -> V_272 ) ;
F_7 ( V_38 , V_66 -> V_22 ,
L_18 ,
V_2 -> V_149 -> V_272 ) ;
return - V_273 ;
...
V_84 -> V_33 = V_62 ;
V_62 -> V_82 = V_84 ;
V_62 -> V_274 = V_84 -> V_90 ;
V_62 -> V_275 = V_84 -> V_276 ;
V_267 = F_19 ( V_2 , V_62 ,
V_84 -> V_90 ) ;
if ( F_2 ( V_135 , & V_84 -> V_2 -> V_130 ) )
F_119 ( V_62 , 0 ) ;
F_120 ( V_62 -> V_82 , V_277 ) ;
return V_267 ;
}
static void F_121 ( struct V_261 * V_66 )
{
struct V_228 * V_33 = V_66 -> V_22 ;
struct V_62 * V_62 = V_33 -> V_22 ;
struct V_127 * V_128 ;
struct V_1 * V_2 ;
struct V_278 * V_279 , * V_125 ;
unsigned V_280 = 0 ;
struct V_281 * V_282 ;
...
if ( F_105 ( & V_62 -> V_263 ) ) {
F_123 (cpu) {
V_282 = & F_124 ( V_283 , V_280 ) ;
F_100 ( & V_282 -> V_284 ) ;
F_125 (work, tmp,
&p->work_list, list) {
if ( V_279 -> V_34 == V_33 -> V_34 &&
V_279 -> V_62 == V_62 ) {
F_51 ( & V_279 -> V_124 ) ;
F_26 ( V_279 ) ;
if ( ! F_126 (
...
F_128 ( & V_2 -> V_182 ) ;
if ( V_84 -> V_290 )
V_287 = sprintf ( V_211 , L_19 , V_84 -> V_290 -> V_291 ) ;
F_129 ( & V_2 -> V_182 ) ;
break;
case V_292 :
F_128 ( & V_2 -> V_182 ) ;
if ( V_84 -> V_290 )
V_287 = sprintf ( V_211 , L_20 , & V_84 -> V_290 -> V_293 ) ;
F_129 ( & V_2 -> V_182 ) ;
break;
default:
return - V_294 ;
...
enum V_295 V_286 , char * V_211 )
{
struct V_1 * V_2 = F_64 ( V_128 ) ;
int V_287 = 0 ;
switch ( V_286 ) {
case V_296 :
V_287 = F_131 ( V_211 , V_2 -> V_138 -> V_297 , 6 ) ;
break;
case V_298 :
V_287 = sprintf ( V_211 , L_21 , V_2 -> V_149 -> V_272 ) ;
break;
case V_299 : {
struct V_123 * V_300 = & V_2 -> V_126 ;
F_55 ( & V_2 -> V_120 ) ;
if ( ! F_132 ( & V_2 -> V_126 ) ) {
struct V_83 * V_84 ;
struct V_301 * V_302 ;
...
V_87 ) ;
V_302 = V_84 -> V_290 ;
if ( F_2 ( V_303 , & V_302 -> V_55 ) )
V_287 = sprintf ( V_211 , L_22 , V_302 -> V_304 ) ;
else
V_287 = sprintf ( V_211 , L_20 , V_302 -> V_304 ) ;
}
F_57 ( & V_2 -> V_120 ) ;
break;
}
default:
return F_134 ( V_128 , V_286 , V_211 ) ;
}
return V_287 ;
}
static int F_135 ( struct V_261 * V_66 )
{
struct V_228 * V_33 = V_66 -> V_22 ;
struct V_62 * V_62 = V_33 -> V_22 ;
V_62 -> V_82 -> V_88 = V_305 ;
F_136 ( V_33 ) ;
V_62 -> V_82 -> V_306 . V_307 = 1 * V_185 + V_308 ;
V_62 -> V_82 -> V_306 . V_309 = V_310 ;
V_62 -> V_82 -> V_306 . V_238 = ( unsigned long ) V_62 -> V_82 ;
F_137 ( & V_62 -> V_82 -> V_306 ) ;
F_138 ( V_62 -> V_82 -> V_96 ,
V_62 -> V_82 -> V_88 != V_305 ) ;
if ( F_139 ( V_311 ) )
F_140 ( V_311 ) ;
F_141 ( & V_62 -> V_82 -> V_306 ) ;
F_142 ( V_66 ) ;
return 0 ;
}
static void F_143 ( struct V_261 * V_66 ,
struct V_312 * V_189 )
{
struct V_228 * V_33 = V_66 -> V_22 ;
V_189 -> V_313 = V_33 -> V_313 ;
V_189 -> V_314 = V_33 -> V_314 ;
...
V_189 -> V_327 = V_33 -> V_328 ;
V_189 -> V_329 = 0 ;
V_189 -> V_330 = 0 ;
strcpy ( V_189 -> V_331 [ 0 ] . V_332 , L_23 ) ;
V_189 -> V_331 [ 0 ] . V_333 = V_33 -> V_334 ;
V_189 -> V_335 = 1 ;
}
static struct V_1 * F_144 ( struct V_336 * V_337 )
{
struct V_338 * V_339 = (struct V_338 * ) V_337 ;
struct V_1 * V_2 ;
struct V_137 * V_138 = NULL ;
V_2 = F_145 () ;
if ( V_2 && V_2 -> V_138 )
V_138 = V_2 -> V_138 -> V_340 ( V_339 , V_341 ) ;
if ( ! V_138 ) {
F_21 ( V_38 L_24
L_25 ) ;
goto V_342;
...
if ( V_2 -> V_149 -> V_343 > V_2 -> V_166 ) {
F_21 ( V_38 L_27 ,
V_2 -> V_149 -> V_272 , V_2 -> V_149 -> V_343 ) ;
F_21 ( V_38 L_28 ,
V_2 -> V_166 ) ;
goto V_342;
}
...
struct V_83 * V_82 )
{
if ( F_2 ( V_344 , & V_2 -> V_345 ) && V_82 -> V_290 )
V_2 -> V_138 -> V_346 ( V_82 -> V_290 ) ;
if ( F_2 ( V_135 , & V_2 -> V_130 ) &&
V_82 -> V_88 == V_347 ) {
if ( V_82 -> V_33 && V_82 -> V_33 -> V_66 &&
V_82 -> V_33 -> V_66 -> V_22 ) {
struct V_228 * V_33 = V_82 -> V_33 -> V_66 -> V_22 ;
F_148 ( V_348 , & V_33 -> V_349 ) ;
}
F_21 ( V_38 L_29
L_30
L_31 ,
...
V_82 -> V_88 = V_350 ;
F_149 ( & V_82 -> V_306 ) ;
V_82 -> V_306 . V_307 = V_2 -> V_187 + V_308 ;
V_82 -> V_306 . V_309 = V_310 ;
V_82 -> V_306 . V_238 = ( unsigned long ) V_82 ;
F_137 ( & V_82 -> V_306 ) ;
F_46 ( V_2 , V_82 ) ;
if ( F_150 ( V_2 , V_82 ) )
V_82 -> V_88 = V_351 ;
...
F_52 ( V_2 , V_84 ) ;
F_149 ( & V_84 -> V_306 ) ;
V_84 -> V_306 . V_307 = 2 * V_185 + V_308 ;
V_84 -> V_306 . V_309 = V_310 ;
V_84 -> V_306 . V_238 = ( unsigned long ) V_84 ;
F_137 ( & V_84 -> V_306 ) ;
if ( F_153 ( V_2 , V_84 ) ) {
if ( V_84 -> V_88 == V_362 ) {
F_21 ( V_38 L_37 ,
V_2 -> V_149 -> V_272 , V_84 -> V_90 ) ;
V_109 = - V_67 ;
} else
V_109 = - V_363 ;
F_21 ( V_38 L_38
...
V_109 = V_138 -> V_366 ( V_138 , V_341 , V_84 -> V_276 ,
V_63 , & V_84 -> V_290 , V_84 ) ;
if ( V_109 ) {
V_109 = - V_268 ;
goto V_367;
}
V_84 -> V_290 -> V_368 = 256 * 1024 ;
V_84 -> V_290 -> V_369 = 256 * 1024 ;
F_154 ( V_370 , & V_84 -> V_290 -> V_371 ) ;
memset ( & V_357 , 0 , sizeof( V_357 ) ) ;
if ( V_337 -> V_372 == V_373 ) {
V_339 = (struct V_338 * ) V_337 ;
V_357 . V_374 . V_375 = * V_339 ;
V_357 . V_376 . V_375 . V_377 = V_339 -> V_377 ;
} else if ( V_337 -> V_372 == V_378 ) {
V_355 = (struct V_354 * ) V_337 ;
V_357 . V_374 . V_379 = * V_355 ;
V_357 . V_376 . V_379 . V_380 = V_355 -> V_380 ;
}
V_84 -> V_381 = V_308 ;
V_84 -> V_88 = V_382 ;
if ( ! F_2 ( V_344 , & V_2 -> V_345 ) ) {
V_109 = - V_268 ;
goto V_364;
} else
V_109 = V_138 -> V_383 ( V_84 -> V_290 , & V_357 ) ;
if ( V_109 )
goto V_367;
F_59 ( V_2 , V_84 ) ;
if ( F_155 ( V_84 ) )
...
static int F_158 ( struct V_81 * V_82 , int V_385 )
{
struct V_83 * V_84 ;
int V_109 = 0 ;
V_84 = V_82 -> V_22 ;
...
F_149 ( & V_84 -> V_306 ) ;
V_84 -> V_306 . V_307 = V_2 -> V_186 + V_308 ;
V_84 -> V_306 . V_309 = V_310 ;
V_84 -> V_306 . V_238 = ( unsigned long ) V_84 ;
F_137 ( & V_84 -> V_306 ) ;
if ( ! F_2 ( V_344 , & V_2 -> V_345 ) )
...
V_84 -> V_88 = V_400 ;
if ( V_396 )
V_397 = V_138 -> V_401 ( V_84 -> V_290 ) ;
else
V_397 = V_138 -> V_402 ( V_84 -> V_290 ) ;
if ( V_397 )
F_21 ( V_38 L_42 ,
V_84 -> V_2 -> V_149 -> V_272 , V_396 , V_397 ) ;
else
F_138 ( V_84 -> V_96 ,
( ( V_84 -> V_88 != V_400 )
&& ( V_84 -> V_88 != V_270 ) ) ) ;
...
struct V_1 * V_2 ;
V_84 = V_82 -> V_22 ;
while ( ( V_84 -> V_88 == V_382 ) &&
! F_163 ( V_308 , V_84 -> V_381 + ( 12 * V_185 ) ) )
F_164 ( 250 ) ;
if ( V_84 -> V_33 ) {
V_62 = V_84 -> V_33 ;
V_33 = V_62 -> V_66 -> V_22 ;
...
T_3 V_287 = sizeof( * V_405 ) ;
V_2 -> V_138 -> V_406 ( V_2 -> V_138 , V_407 , V_211 ,
V_287 ) ;
return 0 ;
}
static T_8 F_168 ( int V_408 , int V_286 )
{
switch ( V_408 ) {
case V_409 :
switch ( V_286 ) {
