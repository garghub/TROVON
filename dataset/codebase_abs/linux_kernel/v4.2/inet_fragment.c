...
void F_40 ( struct V_46 * V_47 , struct V_1 * V_2 )
{
unsigned int V_48 ;
int V_10 ;
V_47 -> V_28 = 0 ;
...
F_24 () ;
F_42 () ;
if ( F_43 ( & V_2 -> V_11 , V_48 ) ||
F_44 ( & V_47 -> V_50 ) )
goto V_49;
F_45 ( & V_47 -> V_50 ) ;
}
static struct V_15 *
F_46 ( struct V_3 * V_29 , struct V_1 * V_2 )
...
static inline void F_47 ( struct V_3 * V_29 , struct V_1 * V_2 )
{
struct V_15 * V_16 ;
V_16 = F_46 ( V_29 , V_2 ) ;
F_9 ( & V_29 -> V_23 ) ;
...
void F_48 ( struct V_3 * V_29 , struct V_1 * V_2 )
{
if ( F_18 ( & V_29 -> V_32 ) )
F_49 ( & V_29 -> V_54 ) ;
if ( ! ( V_29 -> V_52 & V_53 ) ) {
...
static inline void F_50 ( struct V_46 * V_47 , struct V_1 * V_2 ,
struct V_55 * V_56 )
{
if ( V_2 -> V_57 )
V_2 -> V_57 ( V_56 ) ;
...
void F_52 ( struct V_3 * V_4 , struct V_1 * V_2 )
{
struct V_55 * V_58 ;
struct V_46 * V_47 ;
unsigned int V_59 , V_60 = 0 ;
F_53 ( ! ( V_4 -> V_52 & V_53 ) ) ;
F_53 ( F_18 ( & V_4 -> V_32 ) != 0 ) ;
V_58 = V_4 -> V_61 ;
V_47 = V_4 -> V_27 ;
while ( V_58 ) {
...
static struct V_3 * F_56 ( struct V_46 * V_47 ,
struct V_3 * V_66 ,
struct V_1 * V_2 ,
void * V_67 )
{
struct V_15 * V_16 = F_46 ( V_66 , V_2 ) ;
struct V_3 * V_68 ;
#ifdef F_57
F_58 (qp, &hb->chain, list) {
...
#endif
V_68 = V_66 ;
if ( ! F_61 ( & V_68 -> V_32 , V_7 + V_47 -> V_70 ) )
F_59 ( & V_68 -> V_54 ) ;
F_59 ( & V_68 -> V_54 ) ;
...
static struct V_3 * F_62 ( struct V_46 * V_47 ,
struct V_1 * V_2 ,
void * V_67 )
{
struct V_3 * V_4 ;
...
V_4 = F_63 ( V_2 -> V_42 , V_72 ) ;
if ( ! V_4 )
return NULL ;
V_4 -> V_27 = V_47 ;
V_2 -> V_73 ( V_4 , V_67 ) ;
F_64 ( V_47 , V_2 -> V_44 ) ;
F_65 ( & V_4 -> V_32 , V_2 -> V_34 , ( unsigned long ) V_4 ) ;
F_31 ( & V_4 -> V_74 ) ;
F_66 ( & V_4 -> V_54 , 1 ) ;
return V_4 ;
}
static struct V_3 * F_67 ( struct V_46 * V_47 ,
struct V_1 * V_2 ,
void * V_67 )
{
struct V_3 * V_4 ;
V_4 = F_62 ( V_47 , V_2 , V_67 ) ;
if ( ! V_4 )
return NULL ;
return F_56 ( V_47 , V_4 , V_2 , V_67 ) ;
}
struct V_3 * F_68 ( struct V_46 * V_47 ,
