...
static void F_84 ( struct V_1 * V_172 ,
struct V_201 * * V_202 )
{
int V_89 , V_183 ;
T_6 V_206 = 0 ;
...
static void F_87 ( struct V_1 * V_172 , int * V_226 )
{
struct V_201 * V_202 ;
int V_89 ;
...
F_89 ( V_202 , L_27 , & V_172 -> V_260 . V_261 . V_262 ) ;
F_89 ( V_202 , L_28 , & V_172 -> V_260 . V_261 . V_263 ) ;
F_89 ( V_202 , L_29 , & V_172 -> V_260 . V_261 . V_264 ) ;
break; }
case V_265 : {
...
static inline int F_90 ( char * V_181 , int V_183 )
{
...
V_207 = F_85 ( V_273 , V_36 ) ;
if ( ! V_207 )
goto V_274;
V_270 = F_92 ( V_50 , V_207 , V_273 ) ;
if ( V_270 == 0 ) {
F_17 ( V_207 ) ;
goto V_274;
}
V_270 = F_90 ( V_207 , V_270 ) ;
if ( V_270 == 0 ) {
F_17 ( V_207 ) ;
goto V_274;
}
...
V_274:
F_93 ( V_202 , V_271 , V_183 ) ;
F_74 ( V_202 ) ;
}
static void F_94 ( struct V_1 * V_172 , struct V_49 * V_50 )
{
int V_89 , V_226 = 0 ;
struct V_201 * V_202 ;
struct V_189 * V_190 ;
...
F_89 ( V_202 , L_40 , & V_279 -> V_281 . V_263 ) ;
F_89 ( V_202 , L_41 , & V_279 -> V_281 . V_262 ) ;
F_69 ( V_202 , L_42 , V_279 -> V_281 . V_282 ) ;
F_89 ( V_202 , L_43 , & V_279 -> V_283 . V_263 ) ;
F_89 ( V_202 , L_44 , & V_279 -> V_283 . V_262 ) ;
F_89 ( V_202 , L_45 , & V_279 -> V_283 . V_264 ) ;
F_89 ( V_202 , L_46 , & V_279 -> V_284 . V_263 ) ;
F_89 ( V_202 , L_47 , & V_279 -> V_284 . V_262 ) ;
F_89 ( V_202 , L_48 , & V_279 -> V_284 . V_264 ) ;
break; }
}
F_74 ( V_202 ) ;
}
...
if ( V_4 -> V_298 )
continue;
F_98 ( V_172 , V_4 , NULL , V_89 ++ , & V_226 ) ;
}
F_91 ( V_50 , V_172 ) ;
...
void F_101 ( int V_5 , unsigned long V_300 , unsigned long V_301 ,
...
void F_104 ( int V_309 , long V_115 )
{
struct V_49 * V_50 = V_92 ;
struct V_1 * V_172 ;
if ( V_309 )
...
static inline void F_105 ( const struct V_310 * V_310 )
{
#ifdef F_14
struct V_1 * V_172 ;
struct V_29 * V_30 ;
...
static void F_109 ( const struct V_187 * V_187 )
{
#ifdef F_14
struct V_1 * V_172 ;
struct V_29 * V_30 ;
...
V_315 = F_110 ( & V_317 ) ;
for(; ; ) {
struct V_310 * V_310 = F_111 ( V_312 ) ;
if ( V_310 && F_2 ( ! F_106 ( & V_310 -> V_311 ) ) ) {
struct V_27 * V_28 ;
V_28 = F_107 ( V_310 ) ;
if ( V_28 ) {
...
if ( F_2 ( F_112 ( & V_317 , V_315 ) || V_314 ) ) {
F_43 () ;
if ( ! V_314 ) {
F_13 ( V_172 , V_30 , V_38 ) ;
goto V_316;
...
{
struct V_20 * V_319 ;
if ( V_172 -> V_185 < V_320 ) {
V_319 = & V_172 -> V_321 [ V_172 -> V_185 ] ;
memset ( V_319 , 0 , sizeof( * V_319 ) ) ;
} else {
V_319 = F_12 ( sizeof( * V_319 ) , V_322 ) ;
if ( ! V_319 )
return NULL ;
V_319 -> V_184 = true ;
}
V_319 -> V_22 = ( unsigned long ) - 1 ;
V_319 -> type = type ;
F_114 ( & V_319 -> V_167 , & V_172 -> V_193 ) ;
V_172 -> V_185 ++ ;
return V_319 ;
}
struct V_323 *
F_115 ( const T_7 char * V_324 )
{
...
void F_116 ( struct V_323 * V_43 )
{
struct V_1 * V_172 = V_92 -> V_1 ;
struct V_20 * V_4 ;
if ( ! V_172 -> V_177 )
return;
V_4 = F_113 ( V_172 , V_326 ) ;
if ( ! V_4 )
return;
V_4 -> V_43 = V_43 ;
V_4 -> V_327 = V_328 ;
...
F_117 ( V_92 -> V_329 , & V_172 -> V_186 ) ;
}
void F_118 ( struct V_323 * V_43 , const struct V_187 * V_187 ,
unsigned int V_268 )
{
struct V_1 * V_172 = V_92 -> V_1 ;
const struct V_310 * V_310 = F_111 ( V_187 ) ;
struct V_20 * V_4 ;
bool V_313 = V_268 & V_330 ;
if ( ! V_172 -> V_177 )
return;
if ( ! V_43 )
goto V_331;
...
if ( V_4 -> V_22 ) {
if ( V_4 -> V_22 != V_310 -> V_333 ||
V_4 -> V_120 != V_310 -> V_334 -> V_335 )
continue;
} else if ( V_4 -> V_43 ) {
...
V_274:
if ( V_313 ) {
V_4 -> V_327 = V_4 -> V_43 ? F_120 ( V_4 -> V_43 -> V_43 ) : V_328 ;
V_4 -> type = V_332 ;
if ( V_268 & V_336 )
V_4 -> V_298 = true ;
} else {
...
F_109 ( V_187 ) ;
F_121 ( V_4 , V_187 , V_310 ) ;
}
void F_122 ( const struct V_338 * V_338 )
{
F_118 ( NULL , V_338 -> V_339 . V_187 , 0 ) ;
}
void F_123 ( const struct V_310 * V_313 ,
const struct V_187 * V_187 ,
const unsigned char type )
{
struct V_1 * V_172 = V_92 -> V_1 ;
const struct V_310 * V_310 = F_111 ( V_187 ) ;
const char * V_340 = V_187 -> V_341 . V_43 ;
struct V_20 * V_4 , * V_342 = NULL , * V_343 = NULL ;
if ( ! V_172 -> V_177 )
return;
if ( V_310 )
F_105 ( V_310 ) ;
...
V_4 -> type != V_326 ) )
continue;
if ( V_4 -> V_22 == V_313 -> V_333 && V_4 -> V_120 == V_313 -> V_334 -> V_335 &&
! F_124 ( V_340 ,
V_4 -> V_43 -> V_43 , V_4 -> V_327 ) ) {
if ( V_4 -> type == V_326 )
V_4 -> type = V_332 ;
V_342 = V_4 ;
break;
...
F_7 (n, &context->names_list, list) {
if ( ! V_4 -> V_43 ||
( V_4 -> type != type && V_4 -> type != V_326 ) )
continue;
if ( ! strcmp ( V_340 , V_4 -> V_43 -> V_43 ) ||
! F_124 ( V_340 , V_4 -> V_43 -> V_43 ,
V_342 ?
V_342 -> V_327 :
V_328 ) ) {
if ( V_4 -> type == V_326 )
...
if ( ! V_342 ) {
V_4 = F_113 ( V_172 , V_332 ) ;
if ( ! V_4 )
return;
F_121 ( V_4 , NULL , V_313 ) ;
}
if ( ! V_343 ) {
V_343 = F_113 ( V_172 , type ) ;
if ( ! V_343 )
return;
if ( V_342 ) {
V_343 -> V_43 = V_342 -> V_43 ;
V_343 -> V_327 = V_328 ;
V_343 -> V_43 -> V_325 ++ ;
}
}
if ( V_310 )
F_121 ( V_343 , V_187 , V_310 ) ;
else
V_343 -> V_22 = ( unsigned long ) - 1 ;
}
int F_125 ( struct V_1 * V_2 ,
struct V_344 * V_345 , unsigned int * V_307 )
{
if ( ! V_2 -> V_177 )
return 0 ;
if ( ! V_2 -> V_307 )
V_2 -> V_307 = F_126 () ;
V_345 -> V_250 = V_2 -> ctime . V_250 ;
V_345 -> V_251 = V_2 -> ctime . V_251 ;
* V_307 = V_2 -> V_307 ;
if ( ! V_2 -> V_24 ) {
V_2 -> V_24 = 1 ;
V_2 -> V_25 = V_26 ;
...
unsigned int V_352 , unsigned int V_199 ,
int V_46 )
{
struct V_201 * V_202 ;
T_8 V_42 , V_353 , V_59 ;
if ( ! V_304 )
return;
V_42 = F_70 ( & V_204 , F_132 ( V_92 ) ) ;
V_353 = F_70 ( & V_204 , V_350 ) ;
V_59 = F_70 ( & V_204 , V_351 ) ,
V_202 = F_68 ( NULL , V_36 , V_354 ) ;
if ( ! V_202 )
return;
F_69 ( V_202 , L_54 , F_28 ( V_92 ) , V_42 ) ;
F_133 ( V_202 ) ;
F_69 ( V_202 , L_55 ,
V_353 , V_59 , V_352 , V_199 , ! V_46 ) ;
F_74 ( V_202 ) ;
}
int F_134 ( T_2 V_59 )
{
struct V_49 * V_355 = V_92 ;
unsigned int V_352 , V_199 = ( unsigned int ) - 1 ;
T_2 V_353 ;
int V_46 ;
V_353 = F_135 ( V_92 ) ;
V_352 = F_136 ( V_92 ) ;
...
goto V_274;
if ( F_130 ( V_59 ) )
V_199 = ( unsigned int ) F_137 ( & V_356 ) ;
V_355 -> V_199 = V_199 ;
V_355 -> V_59 = V_59 ;
V_274:
F_131 ( V_353 , V_59 , V_352 , V_199 , V_46 ) ;
return V_46 ;
}
void F_138 ( int V_238 , T_1 V_21 , struct V_256 * V_239 )
{
struct V_1 * V_172 = V_92 -> V_1 ;
if ( V_239 )
...
void F_139 ( T_9 V_246 , T_6 V_247 , unsigned int V_248 ,
const struct V_344 * V_249 )
{
struct V_1 * V_172 = V_92 -> V_1 ;
struct V_344 * V_30 = & V_172 -> V_245 . V_249 ;
if ( V_249 )
memcpy ( V_30 , V_249 , sizeof( struct V_344 ) ) ;
else
...
void F_140 ( T_9 V_246 , const struct V_357 * V_358 )
{
struct V_1 * V_172 = V_92 -> V_1 ;
if ( V_358 )
V_172 -> V_253 . V_254 = V_358 -> V_254 ;
else
V_172 -> V_253 . V_254 = 0 ;
V_172 -> V_253 . V_246 = V_246 ;
V_172 -> type = V_252 ;
}
void F_141 ( T_9 V_246 , struct V_256 * V_258 )
{
struct V_1 * V_172 = V_92 -> V_1 ;
...
void F_144 ( unsigned long V_232 , T_8 V_42 , T_10 V_48 , T_1 V_21 )
{
struct V_1 * V_172 = V_92 -> V_1 ;
...
struct V_1 * V_172 = V_92 -> V_1 ;
V_172 -> type = V_221 ;
V_172 -> V_224 . V_225 = V_362 -> V_225 ;
}
int F_146 ( int V_228 , unsigned long * args )
{
struct V_1 * V_172 = V_92 -> V_1 ;
if ( V_228 <= 0 || V_228 > V_363 || ! args )
return - V_364 ;
V_172 -> type = V_227 ;
...
struct V_1 * V_172 = V_92 -> V_1 ;
if ( ! V_172 -> V_197 ) {
void * V_30 = F_85 ( sizeof( struct V_368 ) , V_36 ) ;
if ( ! V_30 )
return - V_196 ;
V_172 -> V_197 = V_30 ;
}
V_172 -> V_287 = V_183 ;
memcpy ( V_172 -> V_197 , V_367 , V_183 ) ;
return 0 ;
}
void F_149 ( struct V_49 * V_345 )
{
struct V_1 * V_172 = V_92 -> V_1 ;
V_172 -> V_291 = F_28 ( V_345 ) ;
V_172 -> V_292 = F_135 ( V_345 ) ;
V_172 -> V_293 = F_132 ( V_345 ) ;
V_172 -> V_294 = F_136 ( V_345 ) ;
F_37 ( V_345 , & V_172 -> V_295 ) ;
memcpy ( V_172 -> V_296 , V_345 -> V_200 , V_369 ) ;
}
...
if ( ! V_2 -> V_291 ) {
V_2 -> V_291 = F_153 ( V_345 ) ;
V_2 -> V_292 = F_135 ( V_345 ) ;
V_2 -> V_293 = V_372 ;
V_2 -> V_294 = F_136 ( V_345 ) ;
F_37 ( V_345 , & V_2 -> V_295 ) ;
memcpy ( V_2 -> V_296 , V_345 -> V_200 , V_369 ) ;
return 0 ;
}
V_371 = ( void * ) V_2 -> V_191 ;
if ( ! V_371 || V_371 -> V_290 == V_381 ) {
V_371 = F_12 ( sizeof( * V_371 ) , V_154 ) ;
if ( ! V_371 )
return - V_196 ;
V_371 -> V_312 . type = V_203 ;
V_371 -> V_312 . V_35 = V_2 -> V_191 ;
V_2 -> V_191 = ( void * ) V_371 ;
}
F_102 ( V_371 -> V_290 >= V_381 ) ;
V_371 -> V_291 [ V_371 -> V_290 ] = F_153 ( V_345 ) ;
V_371 -> V_292 [ V_371 -> V_290 ] = F_135 ( V_345 ) ;
V_371 -> V_293 [ V_371 -> V_290 ] = V_372 ;
V_371 -> V_294 [ V_371 -> V_290 ] = F_136 ( V_345 ) ;
F_37 ( V_345 , & V_371 -> V_295 [ V_371 -> V_290 ] ) ;
memcpy ( V_371 -> V_296 [ V_371 -> V_290 ] , V_345 -> V_200 , V_369 ) ;
V_371 -> V_290 ++ ;
return 0 ;
}
...
struct V_1 * V_172 = V_92 -> V_1 ;
struct V_385 V_386 ;
V_384 = F_85 ( sizeof( * V_384 ) , V_36 ) ;
if ( ! V_384 )
return - V_196 ;
V_384 -> V_312 . type = V_277 ;
V_384 -> V_312 . V_35 = V_172 -> V_190 ;
V_172 -> V_190 = ( void * ) V_384 ;
F_155 ( V_362 -> V_338 -> V_339 . V_187 , & V_386 ) ;
V_384 -> V_281 . V_263 = V_386 . V_263 ;
V_384 -> V_281 . V_262 = V_386 . V_262 ;
V_384 -> V_281 . V_282 = ! ! ( V_386 . V_387 & V_388 ) ;
V_384 -> V_280 = ( V_386 . V_387 & V_389 ) >> V_390 ;
V_384 -> V_283 . V_263 = V_383 -> V_391 ;
V_384 -> V_283 . V_262 = V_383 -> V_392 ;
V_384 -> V_283 . V_264 = V_383 -> V_393 ;
V_384 -> V_284 . V_263 = V_382 -> V_391 ;
V_384 -> V_284 . V_262 = V_382 -> V_392 ;
V_384 -> V_284 . V_264 = V_382 -> V_393 ;
return 0 ;
}
void F_156 ( const struct V_51 * V_382 , const struct V_51 * V_383 )
{
struct V_1 * V_172 = V_92 -> V_1 ;
V_172 -> V_260 . V_96 = F_28 ( V_92 ) ;
V_172 -> V_260 . V_261 . V_264 = V_382 -> V_393 ;
V_172 -> V_260 . V_261 . V_262 = V_382 -> V_393 ;
V_172 -> V_260 . V_261 . V_263 = V_382 -> V_391 ;
V_172 -> type = V_259 ;
}
void F_157 ( int V_267 , int V_268 )
{
struct V_1 * V_172 = V_92 -> V_1 ;
...
static void F_158 ( struct V_201 * V_202 )
{
T_2 V_198 , V_42 ;
T_3 V_48 ;
unsigned int V_199 ;
...
F_73 ( V_202 , F_160 ( V_200 , V_92 ) ) ;
F_161 ( V_202 , V_92 -> V_222 ) ;
}
void F_162 ( long V_394 )
{
struct V_201 * V_202 ;
if ( ! V_304 )
return;
if ( V_394 == V_395 )
return;
V_202 = F_68 ( NULL , V_36 , V_396 ) ;
if ( F_2 ( ! V_202 ) )
return;
F_158 ( V_202 ) ;
F_69 ( V_202 , L_58 , V_394 ) ;
F_74 ( V_202 ) ;
}
void F_163 ( unsigned long V_397 , long V_394 , int V_398 )
{
struct V_201 * V_202 ;
V_202 = F_68 ( NULL , V_36 , V_399 ) ;
if ( F_2 ( ! V_202 ) )
return;
F_158 ( V_202 ) ;
F_69 ( V_202 , L_59 ,
V_394 , F_103 () , V_397 , F_164 () ,
F_165 ( V_92 ) , V_398 ) ;
F_74 ( V_202 ) ;
}
struct V_166 * F_166 ( void )
{
