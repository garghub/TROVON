...
int F_70 ( struct V_1 * V_2 , T_4 V_100 , T_5 * V_101 )
{
struct V_24 * V_7 = V_2 -> V_7 ;
struct V_3 * V_4 = F_2 ( V_2 ) ;
int V_17 = 0 ;
...
void F_74 ( struct V_1 * V_2 , struct V_103 * V_104 )
{
struct V_24 * V_7 = V_2 -> V_7 ;
struct V_3 * V_4 = F_2 ( V_2 ) ;
T_3 V_105 = F_75 ( & V_2 -> V_60 ) ;
F_43 ( ! F_44 ( & V_7 -> V_33 ) ) ;
F_76 ( V_104 , L_6 ,
V_4 -> V_27 , F_71 ( V_4 ) ? 'A' : 'I' ,
V_4 -> V_96 , V_4 -> V_95 ,
V_2 -> V_106 , V_2 -> V_107 . V_107 . V_108 ,
V_105 , V_4 -> V_84 , V_2 -> V_25 ) ;
}
void F_77 ( struct V_109 * V_110 , struct V_103 * V_104 )
{
struct V_3 * V_4 ;
int V_111 = 0 ;
T_6 V_25 = 0 ;
F_78 (msm_obj, list, mm_list) {
struct V_1 * V_2 = & V_4 -> V_112 ;
F_76 ( V_104 , L_7 ) ;
F_74 ( V_2 , V_104 ) ;
V_111 ++ ;
V_25 += V_2 -> V_25 ;
}
F_76 ( V_104 , L_8 , V_111 , V_25 ) ;
}
...
V_67 -> V_70 -> V_113 ( V_67 , V_61 , V_4 -> V_26 , V_2 -> V_25 ) ;
}
}
if ( V_2 -> V_114 ) {
if ( V_4 -> V_84 )
F_82 ( V_2 -> V_114 -> V_115 , V_4 -> V_84 ) ;
if ( V_4 -> V_23 )
F_8 ( V_4 -> V_23 ) ;
F_83 ( V_2 , V_4 -> V_26 ) ;
} else {
...
if ( V_17 )
return V_17 ;
V_2 = F_87 ( V_7 , V_25 , V_27 ) ;
F_26 ( & V_7 -> V_33 ) ;
if ( F_12 ( V_2 ) )
return F_14 ( V_2 ) ;
V_17 = F_88 ( V_43 , V_2 , V_81 ) ;
F_59 ( V_2 ) ;
return V_17 ;
}
static int F_89 ( struct V_24 * V_7 ,
T_4 V_25 , T_4 V_27 ,
struct V_1 * * V_2 )
{
struct V_5 * V_6 = V_7 -> V_8 ;
...
if ( ! F_49 ( & V_65 ) )
V_119 = true ;
else if ( ( V_27 & V_122 ) && V_6 -> V_12 . V_25 )
V_119 = true ;
if ( F_43 ( V_119 && ! V_6 -> V_12 . V_25 ) )
return - V_69 ;
V_118 = sizeof( * V_4 ) ;
if ( V_119 )
V_118 += sizeof( struct V_123 ) ;
V_4 = F_90 ( V_118 , V_124 ) ;
if ( ! V_4 )
return - V_19 ;
if ( V_119 )
V_4 -> V_9 = ( void * ) & V_4 [ 1 ] ;
...
struct V_1 * F_87 ( struct V_24 * V_7 ,
T_4 V_25 , T_4 V_27 )
{
struct V_1 * V_2 = NULL ;
int V_17 ;
F_43 ( ! F_44 ( & V_7 -> V_33 ) ) ;
V_25 = F_55 ( V_25 ) ;
V_17 = F_89 ( V_7 , V_25 , V_27 , & V_2 ) ;
if ( V_17 )
goto V_83;
if ( F_3 ( V_2 ) ) {
V_17 = F_93 ( V_7 , V_2 , V_25 ) ;
if ( V_17 )
goto V_83;
} else {
F_94 ( V_7 , V_2 , V_25 ) ;
...
struct V_1 * F_96 ( struct V_24 * V_7 ,
T_4 V_25 , struct V_126 * V_26 )
{
struct V_3 * V_4 ;
struct V_1 * V_2 ;
int V_17 , V_15 ;
...
V_17 = F_97 ( V_26 , V_4 -> V_23 , NULL , V_15 ) ;
if ( V_17 )
goto V_83;
return V_2 ;
V_83:
