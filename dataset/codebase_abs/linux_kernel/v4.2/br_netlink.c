...
static int F_78 ( struct V_101 * V_141 , struct V_17 * V_18 ,
struct V_92 * V_127 [] , struct V_92 * V_138 [] )
{
struct V_22 * V_67 = F_11 ( V_18 ) ;
if ( V_127 [ V_88 ] ) {
F_73 ( & V_67 -> V_136 ) ;
F_79 ( V_67 , F_56 ( V_127 [ V_88 ] ) ) ;
F_74 ( & V_67 -> V_136 ) ;
}
return F_80 ( V_18 ) ;
}
static int F_81 ( struct V_17 * V_142 ,
struct V_17 * V_18 ,
struct V_92 * V_127 [] ,
struct V_92 * V_138 [] )
{
struct V_22 * V_67 = F_11 ( V_142 ) ;
int V_143 ;
if ( ! V_138 )
return 0 ;
F_73 ( & V_67 -> V_136 ) ;
V_143 = F_64 ( F_46 ( V_18 ) , V_138 ) ;
F_74 ( & V_67 -> V_136 ) ;
return V_143 ;
}
static int F_82 ( struct V_27 * V_28 ,
const struct V_17 * V_142 ,
const struct V_17 * V_18 )
{
return F_17 ( V_28 , F_46 ( V_18 ) ) ;
}
static T_3 F_83 ( const struct V_17 * V_142 ,
const struct V_17 * V_18 )
{
return F_14 () ;
}
static int F_84 ( struct V_17 * V_142 , struct V_92 * V_127 [] ,
struct V_92 * V_138 [] )
{
struct V_22 * V_67 = F_11 ( V_142 ) ;
int V_62 ;
...
return 0 ;
if ( V_138 [ V_144 ] ) {
V_62 = F_85 ( V_67 , F_66 ( V_138 [ V_144 ] ) ) ;
if ( V_62 )
return V_62 ;
}
if ( V_138 [ V_145 ] ) {
V_62 = F_86 ( V_67 , F_66 ( V_138 [ V_145 ] ) ) ;
if ( V_62 )
return V_62 ;
}
if ( V_138 [ V_146 ] ) {
V_62 = F_87 ( V_67 , F_66 ( V_138 [ V_146 ] ) ) ;
if ( V_62 )
return V_62 ;
}
if ( V_138 [ V_147 ] ) {
T_1 V_148 = F_66 ( V_138 [ V_147 ] ) ;
V_67 -> V_148 = F_88 ( V_148 ) ;
}
if ( V_138 [ V_149 ] ) {
T_1 V_122 = F_66 ( V_138 [ V_149 ] ) ;
F_89 ( V_67 , V_122 ) ;
}
if ( V_138 [ V_150 ] ) {
T_1 V_36 = F_68 ( V_138 [ V_150 ] ) ;
F_90 ( V_67 , V_36 ) ;
}
return 0 ;
}
static T_3 F_91 ( const struct V_17 * V_142 )
{
...
static int F_92 ( struct V_27 * V_28 , const struct V_17 * V_142 )
{
struct V_22 * V_67 = F_11 ( V_142 ) ;
T_1 V_151 = F_93 ( V_67 -> V_151 ) ;
T_1 V_152 = F_93 ( V_67 -> V_152 ) ;
T_1 V_153 = F_93 ( V_67 -> V_154 ) ;
T_1 V_148 = F_93 ( V_67 -> V_148 ) ;
T_1 V_122 = V_67 -> V_122 ;
T_2 V_36 = ( V_67 -> V_155 . V_156 [ 0 ] << 8 ) | V_67 -> V_155 . V_156 [ 1 ] ;
if ( F_20 ( V_28 , V_144 , V_151 ) ||
F_20 ( V_28 , V_145 , V_152 ) ||
F_20 ( V_28 , V_146 , V_153 ) ||
F_20 ( V_28 , V_147 , V_148 ) ||
F_20 ( V_28 , V_149 , V_122 ) ||
F_19 ( V_28 , V_150 , V_36 ) )
return - V_54 ;
return 0 ;
}
static T_3 F_94 ( const struct V_17 * V_18 )
{
struct V_1 * V_2 ;
if ( F_7 ( V_18 ) )
V_2 = F_8 ( F_46 ( V_18 ) ) ;
