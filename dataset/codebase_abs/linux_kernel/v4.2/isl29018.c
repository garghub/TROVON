...
struct V_8 V_9 ;
for ( V_4 = 0 ; V_4 < F_2 ( V_10 [ V_2 -> type ] ) ; ++ V_4 ) {
if ( V_3 == V_10 [ V_2 -> type ] [ V_4 ] ) {
V_7 = V_4 ;
V_9 = V_11 [ V_7 ] [ 0 ] ;
break;
}
}
if ( V_4 >= F_2 ( V_10 [ V_2 -> type ] ) )
return - V_12 ;
...
return V_5 ;
V_6 = V_2 -> V_6 ;
for ( V_4 = 0 ; V_4 < F_2 ( V_11 [ V_6 ] ) ; ++ V_4 ) {
if ( V_2 -> V_17 . V_17 == V_11 [ V_6 ] [ V_4 ] . V_17 &&
V_2 -> V_17 . V_18 == V_11 [ V_6 ] [ V_4 ] . V_18 ) {
V_2 -> V_17 = V_11 [ V_7 ] [ V_4 ] ;
break;
}
}
V_2 -> V_6 = V_7 ;
...
static int F_4 ( struct V_1 * V_2 , int V_17 , int V_18 )
{
int V_4 , V_5 ;
struct V_8 V_9 ;
for ( V_4 = 0 ; V_4 < F_2 ( V_11 [ V_2 -> V_6 ] ) ; ++ V_4 ) {
if ( V_17 == V_11 [ V_2 -> V_6 ] [ V_4 ] . V_17 &&
V_18 == V_11 [ V_2 -> V_6 ] [ V_4 ] . V_18 ) {
V_9 = V_11 [ V_2 -> V_6 ] [ V_4 ] ;
break;
}
}
if ( V_4 >= F_2 ( V_11 [ V_2 -> V_6 ] ) )
return - V_12 ;
V_5 = F_3 ( V_2 -> V_13 , V_14 ,
V_19 ,
V_4 << V_20 ) ;
...
F_8 ( V_28 ) ;
V_22 = F_9 ( V_2 -> V_13 , V_29 , & V_23 ) ;
if ( V_22 < 0 ) {
F_7 ( V_2 -> V_27 ,
L_2 , V_22 ) ;
return V_22 ;
}
V_22 = F_9 ( V_2 -> V_13 , V_30 , & V_24 ) ;
if ( V_22 < 0 ) {
F_7 ( V_2 -> V_27 ,
L_3 , V_22 ) ;
return V_22 ;
...
if ( V_32 < 0 )
return V_32 ;
V_33 = V_32 * V_2 -> V_17 . V_17 +
V_32 * V_2 -> V_17 . V_18 / 1000000 ;
* V_31 = V_33 * V_2 -> V_35 +
...
V_11 [ V_2 -> V_6 ] [ V_4 ] . V_17 ,
V_11 [ V_2 -> V_6 ] [ V_4 ] . V_18 ) ;
V_49 [ V_52 - 1 ] = '\n' ;
return V_52 ;
}
...
V_22 = F_6 ( V_2 -> V_13 , V_81 , 0x0 ) ;
if ( V_22 < 0 ) {
F_7 ( V_2 -> V_27 , L_11 ,
V_22 ) ;
return V_22 ;
}
V_22 = F_6 ( V_2 -> V_13 , V_25 , 0 ) ;
if ( V_22 < 0 ) {
F_7 ( V_2 -> V_27 , L_12 ,
V_22 ) ;
return V_22 ;
