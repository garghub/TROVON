...
F_27 ( & V_1 -> V_47 ) ;
if ( ( V_30 > 0 ) && V_39 )
V_39 ( V_38 , V_22 , V_30 , V_16 . V_50 ) ;
if ( ! ( V_40 & V_49 ) )
F_29 ( V_1 ) ;
V_48:
return V_30 ;
}
static int F_30 ( struct V_44 * V_45 , struct V_51 * V_51 ,
struct V_52 * V_53 )
{
unsigned long V_3 ;
struct V_1 * V_1 = V_45 -> V_54 ;
if ( ! V_51 )
V_51 = F_31 ( V_45 , V_53 -> V_55 ,
V_56 | V_57 ) ;
if ( ! V_51 )
return V_58 ;
V_3 = ( F_17 ( V_1 ) + V_14 - 1 ) >> V_59 ;
if ( V_53 -> V_55 >= V_3 ) {
F_32 ( V_51 ) ;
F_33 ( V_51 ) ;
return V_60 ;
...
static int F_34 ( struct V_51 * V_62 , struct V_15 * V_16 ,
unsigned V_17 , unsigned long V_63 )
{
void * V_64 , * V_65 ;
if ( F_8 ( V_16 , & V_64 , V_17 ) < 0 )
return - V_66 ;
V_65 = F_35 ( V_62 ) ;
F_36 ( V_65 , V_64 , V_63 , V_62 ) ;
F_37 ( V_65 ) ;
return 0 ;
}
static int F_38 ( struct V_1 * V_1 , struct V_15 * V_16 ,
struct V_67 * V_68 , struct V_52 * V_53 )
{
struct V_44 * V_45 = V_1 -> V_46 ;
T_1 V_8 = V_16 -> V_18 << ( V_1 -> V_9 - 9 ) ;
unsigned long V_63 = ( unsigned long ) V_53 -> V_69 ;
void * V_10 ;
unsigned long V_11 ;
T_6 V_3 ;
int error ;
...
if ( F_12 ( V_16 ) || F_19 ( V_16 ) )
F_6 ( V_10 ) ;
error = F_41 ( V_68 , V_63 , V_11 ) ;
V_48:
F_42 ( V_45 ) ;
return error ;
}
int F_43 ( struct V_67 * V_68 , struct V_52 * V_53 ,
T_4 V_29 , T_7 V_70 )
{
struct V_71 * V_71 = V_68 -> V_72 ;
struct V_44 * V_45 = V_71 -> V_73 ;
struct V_1 * V_1 = V_45 -> V_54 ;
struct V_51 * V_51 ;
struct V_15 V_16 ;
unsigned long V_63 = ( unsigned long ) V_53 -> V_69 ;
...
return V_60 ;
memset ( & V_16 , 0 , sizeof( V_16 ) ) ;
V_2 = ( T_1 ) V_53 -> V_55 << ( V_59 - V_17 ) ;
V_16 . V_20 = V_14 ;
V_75:
V_51 = F_44 ( V_45 , V_53 -> V_55 ) ;
if ( V_51 ) {
if ( ! F_45 ( V_51 , V_68 -> V_76 , V_53 -> V_40 ) ) {
F_33 ( V_51 ) ;
return V_77 ;
}
if ( F_40 ( V_51 -> V_45 != V_45 ) ) {
F_32 ( V_51 ) ;
F_33 ( V_51 ) ;
goto V_75;
}
...
if ( error )
goto F_32;
if ( ! F_11 ( & V_16 ) && ! F_12 ( & V_16 ) && ! V_53 -> V_78 ) {
if ( V_53 -> V_40 & V_79 ) {
...
return F_30 ( V_45 , V_51 , V_53 ) ;
}
}
if ( V_53 -> V_78 ) {
struct V_51 * V_82 = V_53 -> V_78 ;
if ( F_10 ( & V_16 ) )
error = F_34 ( V_82 , & V_16 , V_17 , V_63 ) ;
else
F_48 ( V_82 , V_63 ) ;
if ( error )
goto F_32;
...
if ( ! V_51 && V_74 )
V_51 = F_49 ( V_45 , V_53 -> V_55 ) ;
if ( V_51 ) {
F_50 ( V_45 , V_53 -> V_55 << V_59 ,
V_83 , 0 ) ;
F_51 ( V_51 ) ;
F_32 ( V_51 ) ;
F_33 ( V_51 ) ;
}
error = F_38 ( V_1 , & V_16 , V_68 , V_53 ) ;
if ( F_12 ( & V_16 ) ) {
if ( V_70 )
V_70 ( & V_16 , ! error ) ;
else
...
int F_53 ( struct V_67 * V_68 , struct V_52 * V_53 ,
T_4 V_29 , T_7 V_70 )
{
int V_87 ;
struct V_88 * V_89 = F_54 ( V_68 -> V_72 ) -> V_6 ;
if ( V_53 -> V_40 & V_79 ) {
F_55 ( V_89 ) ;
F_56 ( V_68 -> V_72 ) ;
}
V_87 = F_43 ( V_68 , V_53 , V_29 , V_70 ) ;
if ( V_53 -> V_40 & V_79 )
F_57 ( V_89 ) ;
return V_87 ;
}
int F_58 ( struct V_67 * V_68 , struct V_52 * V_53 )
{
struct V_88 * V_89 = F_54 ( V_68 -> V_72 ) -> V_6 ;
F_55 ( V_89 ) ;
F_56 ( V_68 -> V_72 ) ;
...
int F_59 ( struct V_1 * V_1 , T_2 V_90 , unsigned V_91 ,
T_4 V_29 )
{
struct V_15 V_16 ;
T_6 V_92 = V_90 >> V_93 ;
unsigned V_94 = V_90 & ( V_83 - 1 ) ;
int V_95 ;
if ( ! V_91 )
return 0 ;
F_4 ( ( V_94 + V_91 ) > V_83 ) ;
memset ( & V_16 , 0 , sizeof( V_16 ) ) ;
V_16 . V_20 = V_83 ;
V_95 = V_29 ( V_1 , V_92 , & V_16 , 0 ) ;
if ( V_95 < 0 )
return V_95 ;
if ( F_10 ( & V_16 ) ) {
void * V_10 ;
V_95 = F_8 ( & V_16 , & V_10 , V_1 -> V_9 ) ;
if ( V_95 < 0 )
return V_95 ;
memset ( V_10 + V_94 , 0 , V_91 ) ;
}
return 0 ;
}
int F_60 ( struct V_1 * V_1 , T_2 V_90 , T_4 V_29 )
{
unsigned V_91 = F_61 ( V_90 ) - V_90 ;
return F_59 ( V_1 , V_90 , V_91 , V_29 ) ;
}
