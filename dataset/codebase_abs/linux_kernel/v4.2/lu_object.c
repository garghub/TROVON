...
{
V_194 -> V_196 = F_157 ( F_45 ( V_188 ) , sizeof( V_194 -> V_196 [ 0 ] ) ,
V_208 ) ;
if ( F_56 ( V_194 -> V_196 != NULL ) )
return F_153 ( V_194 ) ;
return - V_50 ;
}
int F_158 ( struct V_193 * V_194 , T_5 V_209 )
{
int V_210 ;
...
{
F_141 ( V_194 -> V_201 == V_211 || V_194 -> V_201 == V_215 ) ;
V_194 -> V_201 = V_216 ;
...
int F_166 ( struct V_1 * V_2 , T_5 V_209 )
{
int V_47 ;
V_2 -> V_219 = NULL ;
V_47 = F_158 ( & V_2 -> V_85 , V_209 ) ;
if ( F_56 ( V_47 == 0 ) )
F_160 ( & V_2 -> V_85 ) ;
return V_47 ;
}
...
V_47 = F_118 ( V_2 -> V_219 ) ;
return V_47 ;
}
int F_169 ( struct V_1 * V_2 , T_5 V_220 ,
T_5 V_221 )
{
...
V_222 -> V_227 += F_171 ( & V_13 ) ;
V_222 -> V_228 = F_101 ( ( int ) V_222 -> V_228 ,
F_172 ( & V_13 ) ) ;
if ( ! V_223 ) {
F_15 ( V_114 , & V_13 , 1 ) ;
continue;
...
static unsigned long F_175 ( struct V_230 * V_231 ,
struct V_232 * V_233 )
{
T_6 V_222 ;
struct V_9 * V_61 ;
...
F_170 ( V_61 -> V_26 , & V_222 , 0 ) ;
V_235 += V_222 . V_227 - V_222 . V_226 ;
}
F_113 ( & V_165 ) ;
V_235 = ( V_235 / 100 ) * V_238 ;
F_176 ( V_239 , L_28 , V_235 ) ;
return V_235 ;
}
static unsigned long F_177 ( struct V_230 * V_231 ,
struct V_232 * V_233 )
{
struct V_9 * V_61 ;
struct V_9 * V_234 ;
...
static T_5 F_190 ( struct V_248 * V_222 , int V_249 )
{
struct V_250 V_251 ;
F_191 ( V_222 , V_249 , & V_251 ) ;
return ( T_5 ) V_251 . V_252 ;
}
int F_192 ( const struct V_9 * V_61 , struct V_253 * V_254 )
{
T_6 V_222 ;
memset ( & V_222 , 0 , sizeof( V_222 ) ) ;
F_170 ( V_61 -> V_26 , & V_222 , 1 ) ;
F_193 ( V_254 , L_30 ,
V_222 . V_226 ,
V_222 . V_227 ,
V_222 . V_229 ,
...
void F_199 ( const struct V_1 * V_2 , struct V_3 * V_4 ,
const struct V_14 * V_15 )
{
...
struct V_3 * F_200 ( const struct V_1 * V_2 ,
struct V_36 * V_37 ,
const struct V_39 * V_40 )
{
struct V_14 V_15 ;
...
void F_204 ( struct V_262 * V_263 , int V_266 )
{
F_4 ( V_263 ) ;
F_4 ( V_263 -> V_264 == NULL ) ;
F_4 ( V_263 -> V_265 == 0 ) ;
V_263 -> V_264 = F_205 ( V_266 , V_208 ) ;
if ( F_56 ( V_263 -> V_264 ) )
V_263 -> V_265 = V_266 ;
}
void F_206 ( struct V_262 * V_263 , int V_266 )
{
F_202 ( V_263 ) ;
F_204 ( V_263 , V_266 ) ;
}
struct V_262 * F_207 ( struct V_262 * V_263 , int V_267 )
{
...
int F_208 ( struct V_262 * V_263 , int V_267 )
{
char * V_268 ;
if ( V_267 <= V_263 -> V_265 )
return 0 ;
V_268 = F_205 ( V_267 , V_208 ) ;
if ( V_268 == NULL )
return - V_50 ;
if ( V_263 -> V_264 != NULL ) {
