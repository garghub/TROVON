...
if ( V_8 -> V_25 && V_8 -> V_25 -> V_57 -> V_58 ) {
...
V_48 = V_2 -> V_48 ;
F_52 ( V_2 , V_8 -> V_44 , V_8 -> V_25 , V_42 >> V_56 ) ;
if ( F_53 ( V_2 , V_11 , V_41 ) < 0 ) {
F_54 ( V_47 >> V_56 ) ;
V_47 = 0 ;
}
V_2 -> V_48 = V_48 ;
...
V_71 = F_59 ( V_72 ) ;
V_43 += V_42 - V_41 ;
if ( V_43 > V_71 && ! F_60 ( V_73 ) )
return F_57 ( - V_74 ) ;
}
if ( ! F_61 ( V_2 , ( V_42 - V_41 ) >> V_56 ) )
return F_57 ( - V_52 ) ;
if ( V_8 -> V_44 & V_59 ) {
...
static unsigned long F_63 ( unsigned long V_3 , unsigned long V_41 ,
...
goto V_79;
V_76 = F_53 ( V_2 , V_15 , V_42 ) ;
if ( V_76 )
goto V_79;
if ( V_41 >= V_42 ) {
V_76 = F_53 ( V_2 , V_3 + V_42 , V_41 - V_42 ) ;
if ( V_76 && V_41 != V_42 )
goto V_79;
V_41 = V_42 ;
}
V_8 = F_55 ( V_3 , V_41 , V_42 , & V_75 ) ;
if ( F_64 ( V_8 ) ) {
V_76 = F_65 ( V_8 ) ;
goto V_79;
}
...
if ( V_8 -> V_44 & V_82 )
V_77 |= V_83 ;
V_76 = F_66 ( V_8 -> V_25 , V_15 , V_42 , V_8 -> V_54 +
( ( V_3 - V_8 -> V_55 ) >> V_56 ) ,
V_77 ) ;
if ( V_76 & ~ V_78 )
goto V_84;
...
static int F_67 ( struct V_7 * V_8 , unsigned long V_85 )
{
...
return 0 ;
if ( F_66 ( NULL , V_8 -> V_55 , V_86 - V_8 -> V_55 ,
0 , V_81 ) & ~ V_78 )
return 0 ;
return 1 ;
}
