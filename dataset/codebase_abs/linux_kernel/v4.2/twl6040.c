...
V_43 = F_50 ( V_6 , V_5 -> V_97 , V_5 -> V_101 , V_5 -> V_100 ) ;
if ( V_43 ) {
F_48 ( V_2 -> V_99 , L_7 , V_43 ) ;
return - V_102 ;
}
return 0 ;
}
static int F_51 ( struct V_89 * V_103 ,
...
static int F_53 ( struct V_89 * V_90 , int V_110 )
{
switch ( V_90 -> V_109 ) {
case V_120 :
F_52 ( V_90 -> V_2 , V_114 , V_110 ) ;
F_52 ( V_90 -> V_2 , V_116 , V_110 ) ;
break;
case V_114 :
case V_116 :
F_52 ( V_90 -> V_2 , V_90 -> V_109 , V_110 ) ;
break;
default:
break;
}
...
{
struct V_4 * V_5 ;
struct V_6 * V_6 = F_55 ( V_2 -> V_99 -> V_121 ) ;
struct V_122 * V_123 = F_21 ( V_2 -> V_99 ,
struct V_122 , V_99 ) ;
int V_43 = 0 ;
V_5 = F_56 ( V_2 -> V_99 , sizeof( * V_5 ) , V_124 ) ;
if ( V_5 == NULL )
return - V_125 ;
F_57 ( V_2 , V_5 ) ;
V_5 -> V_2 = V_2 ;
V_2 -> V_7 = V_6 ;
V_5 -> V_126 = F_58 ( V_123 , 0 ) ;
if ( V_5 -> V_126 < 0 ) {
F_48 ( V_2 -> V_99 , L_9 ) ;
return - V_77 ;
}
F_59 ( & V_5 -> V_54 . V_56 , F_20 ) ;
F_60 ( & V_5 -> V_50 ) ;
V_43 = F_61 ( V_5 -> V_126 , NULL ,
F_22 ,
V_127 | V_128 ,
L_10 , V_2 ) ;
if ( V_43 ) {
F_48 ( V_2 -> V_99 , L_11 , V_43 ) ;
return V_43 ;
}
F_62 ( V_2 , V_83 ) ;
F_8 ( V_2 ) ;
