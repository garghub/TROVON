...
static const struct V_188 *
F_127 ( enum V_189 V_190 )
{
switch ( V_190 ) {
case V_191 :
return & V_192 ;
...
static bool F_130 ( int V_214 , int V_215 , enum V_216 type )
{
if ( V_214 < 0 || V_214 >= sizeof( struct V_217 ) )
return false ;
if ( V_214 % V_215 != 0 )
return false ;
if ( V_215 != 4 )
...
static bool F_131 ( int V_214 , int V_215 ,
enum V_216 type )
{
if ( type == V_218 ) {
switch ( V_214 ) {
case F_25 ( struct V_217 , V_219 [ 0 ] ) ...
F_25 ( struct V_217 , V_219 [ 4 ] ) :
break;
default:
return false ;
}
}
return F_130 ( V_214 , V_215 , type ) ;
}
static bool F_132 ( int V_214 , int V_215 ,
enum V_216 type )
{
if ( type == V_218 ) {
switch ( V_214 ) {
case F_25 ( struct V_217 , V_28 ) :
case F_25 ( struct V_217 , V_220 ) :
case F_25 ( struct V_217 , V_219 [ 0 ] ) ...
F_25 ( struct V_217 , V_219 [ 4 ] ) :
break;
default:
...
static T_2 F_133 ( enum V_216 type , int V_22 ,
int V_23 , int V_221 ,
struct V_24 * V_25 )
{
struct V_24 * V_26 = V_25 ;
switch ( V_221 ) {
case F_25 ( struct V_217 , V_18 ) :
F_22 ( F_23 ( struct V_3 , V_18 ) != 4 ) ;
* V_26 ++ = F_24 ( V_29 , V_22 , V_23 ,
F_25 ( struct V_3 , V_18 ) ) ;
break;
case F_25 ( struct V_217 , V_49 ) :
F_22 ( F_23 ( struct V_3 , V_49 ) != 2 ) ;
* V_26 ++ = F_24 ( V_37 , V_22 , V_23 ,
F_25 ( struct V_3 , V_49 ) ) ;
break;
case F_25 ( struct V_217 , V_63 ) :
F_22 ( F_23 ( struct V_3 , V_63 ) != 2 ) ;
* V_26 ++ = F_24 ( V_37 , V_22 , V_23 ,
F_25 ( struct V_3 , V_63 ) ) ;
break;
case F_25 ( struct V_217 , V_222 ) :
F_22 ( F_23 ( struct V_3 , V_222 ) != 4 ) ;
* V_26 ++ = F_24 ( V_29 , V_22 , V_23 ,
F_25 ( struct V_3 , V_222 ) ) ;
break;
case F_25 ( struct V_217 , V_223 ) :
F_22 ( F_23 ( struct V_3 , V_224 ) != 4 ) ;
* V_26 ++ = F_24 ( V_29 , V_22 , V_23 ,
F_25 ( struct V_3 , V_224 ) ) ;
break;
case F_25 ( struct V_217 , V_56 ) :
F_22 ( F_23 ( struct V_55 , V_56 ) != 4 ) ;
* V_26 ++ = F_24 ( F_31 ( F_23 ( struct V_3 , V_57 ) ) ,
V_22 , V_23 ,
F_25 ( struct V_3 , V_57 ) ) ;
...
F_25 ( struct V_3 , V_28 ) ) ;
break;
case F_25 ( struct V_217 , V_225 ) :
return F_21 ( V_30 , V_22 , V_23 , V_26 ) ;
case F_25 ( struct V_217 , V_36 ) :
return F_21 ( V_35 , V_22 , V_23 , V_26 ) ;
case F_25 ( struct V_217 , V_226 ) :
return F_21 ( V_39 ,
V_22 , V_23 , V_26 ) ;
case F_25 ( struct V_217 , V_40 ) :
return F_21 ( V_38 ,
V_22 , V_23 , V_26 ) ;
case F_25 ( struct V_217 , V_219 [ 0 ] ) ...
F_25 ( struct V_217 , V_219 [ 4 ] ) :
F_22 ( F_23 ( struct V_227 , V_19 ) < 20 ) ;
V_221 -= F_25 ( struct V_217 , V_219 [ 0 ] ) ;
V_221 += F_25 ( struct V_3 , V_219 ) ;
V_221 += F_25 ( struct V_227 , V_19 ) ;
if ( type == V_218 )
* V_26 ++ = F_51 ( V_29 , V_22 , V_23 , V_221 ) ;
else
* V_26 ++ = F_24 ( V_29 , V_22 , V_23 , V_221 ) ;
break;
case F_25 ( struct V_217 , V_220 ) :
#ifdef F_134
F_22 ( F_23 ( struct V_3 , V_220 ) != 2 ) ;
if ( type == V_218 )
* V_26 ++ = F_51 ( V_37 , V_22 , V_23 ,
F_25 ( struct V_3 , V_220 ) ) ;
else
* V_26 ++ = F_24 ( V_37 , V_22 , V_23 ,
F_25 ( struct V_3 , V_220 ) ) ;
break;
...
int F_140 ( struct V_1 * V_2 , struct V_42 T_8 * V_232 ,
unsigned int V_18 )
{
struct V_146 * V_144 ;
struct F_1 * V_6 ;
...
goto V_233;
V_136 = - V_167 ;
if ( F_142 ( V_232 , V_144 -> V_6 , F_60 ( V_144 ) ) )
goto V_233;
V_136 = V_144 -> V_18 ;
V_233:
F_143 ( V_2 ) ;
