...
F_218 ( V_34 -> V_291 ,
V_34 -> V_73 ) ;
F_219 ( V_34 -> V_291 , V_315 ) ;
F_220 ( V_34 -> V_291 , - 1L ) ;
F_221 ( V_34 -> V_291 , V_9 ) ;
F_222 ( V_34 -> V_291 , V_9 - 1 ) ;
}
...
static int F_224 ( struct V_317 * V_85 , T_7 V_177 )
{
struct V_1 * V_64 ;
int V_40 ;
V_64 = F_225 ( V_85 -> V_86 ) ;
if ( ! V_64 )
return - V_204 ;
F_226 ( & V_64 -> V_34 -> V_35 ) ;
if ( F_137 ( V_252 , & V_64 -> V_190 ) ) {
V_40 = - V_204 ;
goto V_318;
}
if ( ! F_227 ( V_64 -> V_42 -> V_44 ) ) {
V_40 = - V_169 ;
goto V_318;
}
if ( V_96 ) {
F_228 ( & V_64 -> V_56 -> V_57 ,
L_94
L_95 ) ;
V_40 = - V_89 ;
goto V_68;
...
F_26 ( V_64 -> V_42 -> V_44 ) ;
V_318:
F_229 ( & V_64 -> V_34 -> V_35 ) ;
F_23 ( V_64 ) ;
return V_40 ;
}
static void F_230 ( struct V_74 * V_75 , T_7 V_177 )
{
struct V_1 * V_64 = F_225 ( V_75 ) ;
if ( V_64 ) {
F_229 ( & V_64 -> V_34 -> V_35 ) ;
F_26 ( V_64 -> V_42 -> V_44 ) ;
F_23 ( V_64 ) ;
...
static int F_231 ( struct V_317 * V_85 , struct V_322 * V_323 )
{
struct V_1 * V_64 ;
V_64 = F_225 ( V_85 -> V_86 ) ;
if ( ! V_64 )
...
V_64 -> V_42 -> V_324 ( V_64 -> V_34 , V_323 ) ;
V_323 -> V_325 = F_232 ( V_85 ) >> V_64 -> V_34 -> V_70 ;
F_23 ( V_64 ) ;
return 0 ;
}
static void
...
if ( ! V_332 )
return 0 ;
F_241 ( V_2 -> V_56 , & V_329 ) ;
memset ( & V_331 , 0 , sizeof( V_331 ) ) ;
V_331 . V_333 = V_329 . V_334 ;
V_331 . V_335 = sizeof( V_331 ) ;
V_40 = V_330 ( & V_331 ) ;
if ( V_40 == 0 || V_40 == 2 ) {
return V_331 . V_336 & 0x80 ;
} else {
F_116 ( V_60 , L_98 ,
V_329 . V_334 , V_40 ) ;
return 0 ;
...
static void F_242 ( void * V_19 , T_8 V_337 )
{
...
if ( V_338 )
F_244 ( L_99 ,
F_35 ( & V_56 -> V_57 ) , V_338 ) ;
}
int F_245 ( struct V_225 * V_56 ,
struct V_339 * V_42 )
{
int V_338 ;
V_338 = F_246 ( V_56 ) ;
...
V_56 -> V_340 = & F_152 ;
if ( ( F_247 ( V_56 , V_341 ) > 0 ) ||
( V_342 && F_248 ( F_35 ( & V_56 -> V_57 ) ) != 0 ) )
F_249 ( F_242 , V_56 ) ;
return 0 ;
}
void F_250 ( struct V_225 * V_56 )
{
struct V_1 * V_2 ;
struct V_33 * V_34 ;
V_56 -> V_340 = NULL ;
...
F_262 ( V_347 , & V_2 -> V_190 ) ;
} else
if ( F_137 ( V_252 , & V_2 -> V_190 ) ) {
F_23 ( V_2 ) ;
return - V_207 ;
}
if ( F_263 ( V_347 , & V_2 -> V_190 ) &&
! F_253 ( V_261 , & V_2 -> V_190 ) ) {
V_40 = F_264 ( V_2 -> V_34 -> V_85 ) ;
if ( V_40 != 0 )
goto V_348;
F_75 ( V_2 ) ;
V_40 = F_190 ( V_270 ,
...
int F_267 ( struct V_225 * V_56 , int V_350 )
{
struct V_1 * V_2 ;
int V_338 ;
V_2 = F_149 ( V_56 ) ;
...
void F_268 ( struct V_225 * V_56 , int * V_355 )
{
int V_356 ;
T_9 V_357 , V_358 ;
struct V_1 * V_2 ;
...
int F_269 ( struct V_1 * V_2 , T_9 V_214 )
{
...
int F_270 ( struct V_225 * V_56 )
{
struct V_1 * V_2 = F_251 ( V_56 ) ;
struct V_102 V_362 ;
struct V_98 * V_99 , * V_255 ;
struct V_98 * V_279 ;
int V_40 ;
...
if ( ! F_53 ( & V_362 ) ) {
F_170 ( F_142 ( V_56 ) ) ;
F_273 ( & V_362 , & V_2 -> V_15 ) ;
F_172 ( F_142 ( V_56 ) ) ;
}
F_23 ( V_2 ) ;
return V_40 ;
}
int F_274 ( struct V_225 * V_56 )
{
struct V_1 * V_2 = F_251 ( V_56 ) ;
int V_40 = 0 ;
if ( F_30 ( V_2 ) )
...
if ( V_2 -> V_34 )
F_60 ( V_2 -> V_34 ) ;
F_262 ( V_363 , & V_2 -> V_190 ) ;
F_23 ( V_2 ) ;
return 0 ;
}
static struct V_98 * F_275 ( struct V_1 * V_2 ,
void * V_367 ,
int V_368 ,
int V_184 )
{
...
int F_278 ( struct V_1 * V_2 , int V_184 ,
void * V_367 , int V_368 )
{
int V_338 ;
struct V_98 * V_99 ;
V_99 = F_275 ( V_2 , V_367 , V_368 ,
V_184 ) ;
if ( F_30 ( V_99 ) )
return F_103 ( V_99 ) ;
V_338 = F_195 ( V_99 ) ;
F_128 ( V_99 , V_99 -> V_366 ) ;
return V_338 ;
}
char * F_279 ( struct V_228 * V_228 )
{
struct V_377 * V_377 = NULL ;
char * V_378 = NULL ;
if ( F_280 ( & V_228 -> V_232 ) && ( V_228 -> V_232 . V_379 . V_380 == 0x01 ) ) {
if ( V_228 -> V_232 . V_379 . V_381 )
V_377 = F_281 ( (struct V_381 * ) ( unsigned long )
...
F_284 ( & V_272 ) ;
F_284 ( & V_270 ) ;
V_327 = F_36 ( L_33 , 1 , 1 , 8 * sizeof( long ) ) ;
if ( V_327 == NULL ) {
V_40 = - V_4 ;
goto V_390;
}
