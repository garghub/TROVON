...
struct V_3 * V_4 = NULL ;
struct V_10 * V_11 = F_4 ( V_12 , V_13 ) ;
F_32 ( V_12 , (struct V_43 * ) V_56 , V_15 , & V_4 ) ;
if ( V_4 )
F_42 ( V_4 ) ;
else
F_43 ( V_11 -> V_24 , V_15 -> V_25 ) ;
}
...
struct V_59 * V_24 ;
struct V_54 * V_60 ;
V_60 = F_20 ( sizeof( * V_60 ) , V_38 ) ;
if ( ! V_60 )
return - V_49 ;
V_60 -> V_61 = V_62 ;
V_60 -> V_63 = V_64 ;
V_60 -> V_55 . V_65 . type = V_66 ;
V_60 -> V_55 . V_65 . V_27 = V_66 ;
V_60 -> V_55 . V_65 . V_28 = V_66 ;
V_60 -> V_67 = V_68 ;
...
V_24 -> V_69 = V_70 ;
V_24 -> type = V_71 ;
V_24 -> V_72 = sizeof( struct V_43 ) ;
V_24 -> V_73 = F_41 ;
V_24 -> V_74 = F_44 ;
V_24 -> V_75 = F_40 ;
strncpy ( V_24 -> V_58 , V_58 , strlen ( V_58 ) + 1 ) ;
V_11 -> V_24 = V_24 ;
F_46 ( & V_11 -> V_42 , 0 ) ;
return F_47 ( V_24 ) ;
}
