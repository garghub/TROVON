...
V_53 -> V_104 . V_224 * 64 ) ;
V_48 ( V_49 , L_76 , V_49 -> V_65 . V_32 ) ;
V_26 = F_94 ( & V_239 -> V_239 . V_251 , & V_252 ) ;
if ( V_26 != 0 )
F_95 ( V_49 , L_77 ) ;
return 0 ;
V_250:
F_96 ( V_49 -> V_237 ) ;
V_249:
F_97 ( V_49 -> V_65 . V_227 , V_49 -> V_65 . V_66 ) ;
V_248:
F_98 ( 0x3c0 , 32 ) ;
V_247:
if ( ! F_99 ( & V_49 -> V_145 ) )
F_100 ( & V_49 -> V_145 ) ;
F_101 ( V_49 -> V_129 . V_149 ) ;
F_102 ( & V_49 -> V_174 ) ;
V_36:
F_17 ( V_53 -> V_91 ) ;
F_103 ( V_49 ) ;
...
static int F_104 ( struct V_243 * V_239 )
{
struct V_48 * V_49 = F_78 ( V_239 ) ;
if ( V_49 ) {
struct V_52 * V_53 = V_49 -> V_53 ;
F_105 ( & V_239 -> V_239 . V_251 , & V_252 ) ;
F_106 ( V_49 ) ;
F_98 ( 0x3c0 , 32 ) ;
F_96 ( V_49 -> V_237 ) ;
F_107 ( V_53 -> V_236 ) ;
...
static int F_108 ( char * V_254 )
{
char * V_255 ;
if ( ! V_254 || ! * V_254 )
return 0 ;
while ( ( V_255 = F_109 ( & V_254 , L_78 ) ) != NULL ) {
if ( ! * V_255 ) continue;
if ( ! strcmp ( V_255 , L_79 ) )
V_64 = 0 ;
else if ( ! strcmp ( V_255 , L_60 ) )
V_64 = 1 ;
else if ( ! strcmp ( V_255 , L_59 ) )
V_64 = 2 ;
else if ( ! strcmp ( V_255 , L_80 ) )
V_123 = 0 ;
else if ( ! strcmp ( V_255 , L_81 ) )
V_123 = 1 ;
else if ( ! strncmp ( V_255 , L_82 , 5 ) )
V_232 = F_110 ( V_255 + 5 , NULL , 0 ) ;
else if ( ! strcmp ( V_255 , L_83 ) )
V_232 = 0 ;
else if ( ! strcmp ( V_255 , L_84 ) )
V_136 = 1 ;
else if ( ! strcmp ( V_255 , L_85 ) )
V_131 = 1 ;
else if ( ! strcmp ( V_255 , L_86 ) )
V_179 = 0 ;
else if ( ! strncmp ( V_255 , L_87 , 7 ) )
V_225 = F_110 ( V_255 + 7 , NULL , 0 ) ;
else if ( ! strncmp ( V_255 , L_88 , 7 ) )
V_226 = F_110 ( V_255 + 7 , NULL , 0 ) ;
else if ( ! strncmp ( V_255 , L_89 , 6 ) )
V_139 = F_110 ( V_255 + 6 , NULL , 0 ) ;
else if ( ! strncmp ( V_255 , L_90 , 6 ) )
V_138 = F_110 ( V_255 + 6 , NULL , 0 ) ;
else if ( ! strncmp ( V_255 , L_91 , 7 ) )
V_137 = F_110 ( V_255 + 7 , NULL , 0 ) ;
else if ( ! strncmp ( V_255 , L_92 , 8 ) )
V_156 = F_110 ( V_255 + 8 , NULL , 0 ) ;
else if ( V_255 [ 0 ] >= '0' && V_255 [ 0 ] <= '9' ) {
V_160 = V_255 ;
} else {
F_9 ( V_28
L_93 , V_255 ) ;
...
static T_2 F_112 ( struct V_256 * V_239 , char * V_19 )
{
return snprintf ( V_19 , V_233 , L_64 , V_23 ) ;
}
static T_2 F_113 ( struct V_256 * V_239 , const char * V_19 ,
T_3 V_164 )
{
strncpy ( V_23 , V_19 , V_257 ) ;
return V_164 ;
}
...
F_123 ( & V_33 ) ;
F_126 ( & V_260 . V_262 , & V_263 ) ;
F_127 ( V_261 ) ;
F_122 ( & V_260 ) ;
}
static int F_128 ( const char * V_264 , const struct V_265 * V_266 )
{
V_64 = 0 ;
if ( ! strcmp ( V_264 , L_79 ) )
V_64 = 0 ;
else if ( ! strcmp ( V_264 , L_60 ) )
V_64 = 1 ;
else if ( ! strcmp ( V_264 , L_59 ) )
V_64 = 2 ;
else
return - V_107 ;
return 0 ;
