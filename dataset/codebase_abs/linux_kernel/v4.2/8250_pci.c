...
F_26 ( 0x00 , V_45 + V_238 ) ;
F_26 ( V_239 , V_45 + V_240 ) ;
F_26 ( 128 , V_45 + V_241 ) ;
F_26 ( 128 , V_45 + V_242 ) ;
F_20 ( V_45 ) ;
return F_51 ( V_9 , V_27 , V_11 , V_28 ) ;
...
{
V_11 -> V_11 . V_30 |= V_154 ;
V_11 -> V_11 . type = V_247 ;
return F_51 ( V_9 , V_27 , V_11 , V_28 ) ;
}
static inline int F_126 ( T_1 V_248 , T_1 V_235 )
{
return V_248 == V_249 || V_248 == V_235 ;
}
static struct V_250 * F_127 ( struct V_2 * V_3 )
{
struct V_250 * V_251 ;
for ( V_251 = V_252 ; ; V_251 ++ )
if ( F_126 ( V_251 -> V_4 , V_3 -> V_4 ) &&
F_126 ( V_251 -> V_5 , V_3 -> V_5 ) &&
F_126 ( V_251 -> V_253 , V_3 -> V_6 ) &&
F_126 ( V_251 -> V_254 , V_3 -> V_7 ) )
break;
return V_251 ;
}
...
static int
F_129 ( struct V_2 * V_3 , struct V_26 * V_27 )
{
const struct V_256 * V_257 ;
int V_258 , V_259 , V_260 = - 1 , V_61 ;
if ( ( ( ( V_3 -> V_85 >> 8 ) != V_261 ) &&
( ( V_3 -> V_85 >> 8 ) != V_262 ) ) ||
( V_3 -> V_85 & 0xff ) > 6 )
return - V_43 ;
for ( V_257 = V_263 ;
V_257 < V_263 + F_40 ( V_263 ) ;
V_257 ++ ) {
if ( V_3 -> V_4 == V_257 -> V_4 &&
V_3 -> V_5 == V_257 -> V_5 )
return - V_43 ;
}
V_258 = V_259 = 0 ;
for ( V_61 = 0 ; V_61 < V_15 ; V_61 ++ ) {
if ( F_5 ( V_3 , V_61 ) & V_264 ) {
V_259 ++ ;
if ( V_260 == - 1 )
V_260 = V_61 ;
}
...
static inline int
F_130 ( const struct V_26 * V_27 ,
const struct V_26 * V_265 )
{
return
V_27 -> V_80 == V_265 -> V_80 &&
V_27 -> V_266 == V_265 -> V_266 &&
V_27 -> V_31 == V_265 -> V_31 &&
V_27 -> V_32 == V_265 -> V_32 &&
V_27 -> V_29 == V_265 -> V_29 ;
}
struct V_8 *
F_131 ( struct V_2 * V_3 , const struct V_26 * V_27 )
{
struct V_10 V_267 ;
struct V_8 * V_9 ;
struct V_250 * V_251 ;
...
V_267 . V_11 . V_30 = V_272 | V_273 | V_274 ;
V_267 . V_11 . V_147 = V_27 -> V_266 * 16 ;
V_267 . V_11 . V_224 = F_128 ( V_3 , V_27 ) ;
V_267 . V_11 . V_3 = & V_3 -> V_3 ;
for ( V_61 = 0 ; V_61 < V_268 ; V_61 ++ ) {
if ( V_251 -> V_275 ( V_9 , V_27 , & V_267 , V_61 ) )
break;
F_15 ( & V_3 -> V_3 , L_23 ,
V_267 . V_11 . V_22 , V_267 . V_11 . V_224 , V_267 . V_11 . V_20 ) ;
V_9 -> line [ V_61 ] = F_134 ( & V_267 ) ;
if ( V_9 -> line [ V_61 ] < 0 ) {
F_2 ( & V_3 -> V_3 ,
L_24 ,
V_267 . V_11 . V_22 , V_267 . V_11 . V_224 ,
V_267 . V_11 . V_20 , V_9 -> line [ V_61 ] ) ;
break;
}
}
V_9 -> V_276 = V_61 ;
...
struct V_250 * V_251 ;
int V_61 ;
for ( V_61 = 0 ; V_61 < V_9 -> V_276 ; V_61 ++ )
F_136 ( V_9 -> line [ V_61 ] ) ;
for ( V_61 = 0 ; V_61 < V_15 ; V_61 ++ ) {
if ( V_9 -> V_18 [ V_61 ] )
F_20 ( V_9 -> V_18 [ V_61 ] ) ;
...
F_139 ( V_9 -> line [ V_61 ] ) ;
if ( V_9 -> V_251 -> exit )
V_9 -> V_251 -> exit ( V_9 -> V_3 ) ;
}
void F_140 ( struct V_8 * V_9 )
{
int V_61 ;
if ( V_9 -> V_251 -> V_269 )
V_9 -> V_251 -> V_269 ( V_9 -> V_3 ) ;
for ( V_61 = 0 ; V_61 < V_9 -> V_276 ; V_61 ++ )
if ( V_9 -> line [ V_61 ] >= 0 )
F_141 ( V_9 -> line [ V_61 ] ) ;
}
static int
F_142 ( struct V_2 * V_3 , const struct V_256 * V_277 )
{
struct V_250 * V_251 ;
struct V_8 * V_9 ;
const struct V_26 * V_27 ;
...
V_251 = F_127 ( V_3 ) ;
if ( V_251 -> V_278 ) {
V_33 = V_251 -> V_278 ( V_3 ) ;
if ( V_33 )
return V_33 ;
}
if ( V_277 -> V_279 >= F_40 ( V_280 ) ) {
F_2 ( & V_3 -> V_3 , L_25 ,
V_277 -> V_279 ) ;
return - V_16 ;
}
V_27 = & V_280 [ V_277 -> V_279 ] ;
V_33 = F_143 ( V_3 ) ;
F_144 ( V_3 ) ;
if ( V_33 )
return V_33 ;
if ( V_277 -> V_279 == V_281 ) {
memcpy ( & V_146 , V_27 , sizeof( struct V_26 ) ) ;
V_27 = & V_146 ;
V_33 = F_129 ( V_3 , & V_146 ) ;
if ( V_33 )
goto V_282;
} else {
memcpy ( & V_146 , & V_280 [ V_281 ] ,
sizeof( struct V_26 ) ) ;
V_33 = F_129 ( V_3 , & V_146 ) ;
if ( V_33 == 0 && F_130 ( V_27 , & V_146 ) )
F_1 ( L_26 ,
V_3 ) ;
}
V_9 = F_131 ( V_3 , V_27 ) ;
...
{
struct V_8 * V_9 = F_150 ( V_3 ) ;
F_135 ( V_9 ) ;
F_148 ( V_3 ) ;
}
static int F_151 ( struct V_5 * V_3 )
{
struct V_2 * V_177 = F_152 ( V_3 ) ;
struct V_8 * V_9 = F_150 ( V_177 ) ;
if ( V_9 )
F_138 ( V_9 ) ;
return 0 ;
}
static int F_153 ( struct V_5 * V_3 )
{
struct V_2 * V_177 = F_152 ( V_3 ) ;
struct V_8 * V_9 = F_150 ( V_177 ) ;
int V_283 ;
...
static T_5 F_155 ( struct V_2 * V_3 )
{
int V_33 ;
V_33 = F_143 ( V_3 ) ;
if ( V_33 )
