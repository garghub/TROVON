...
F_34 ( & V_2 -> V_54 ) ;
V_2 -> V_4 = V_4 ;
V_2 -> V_32 = F_35 ( V_52 -> V_32 ) ;
V_2 -> V_41 = F_35 ( V_52 -> V_41 ) ;
F_17 ( & V_2 -> V_3 , 1 ) ;
F_12 ( & V_7 -> V_8 . V_15 ) ;
F_36 ( & V_2 -> V_54 , & V_7 -> V_8 . V_54 ) ;
F_15 ( & V_7 -> V_8 . V_15 ) ;
F_30 ( V_40 , V_7 ,
L_6 ,
V_4 -> V_39 ,
...
int F_48 ( struct V_64 * V_65 , void * V_71 )
{
struct V_72 * V_69 = (struct V_72 * ) V_65 -> V_73 ;
struct V_6 * V_7 = F_49 ( V_69 ) ;
struct V_74 * V_75 ;
struct V_1 * V_2 ;
int V_76 = 0 ;
V_75 = F_50 ( V_65 ) ;
...
enum V_80
F_53 ( struct V_81 * V_82 , unsigned int * V_83 ,
T_2 * V_84 )
{
enum V_80 V_66 = V_85 ;
struct V_86 * V_86 ;
...
T_3 V_93 ;
T_2 * V_94 ;
if ( ! F_54 ( V_82 , * V_83 + V_95 ) )
return V_85 ;
V_86 = F_55 ( V_82 ) ;
V_93 = V_86 -> V_96 ;
* V_83 += V_95 ;
if ( V_93 == F_56 ( V_97 ) ) {
if ( ! F_54 ( V_82 , * V_83 + V_98 ) )
return V_85 ;
V_91 = F_57 ( V_82 ) ;
V_93 = V_91 -> V_99 ;
* V_83 += V_98 ;
...
if ( ! F_54 ( V_82 , * V_83 + sizeof( * V_89 ) ) )
return V_85 ;
V_89 = (struct V_89 * ) ( V_82 -> V_101 + * V_83 ) ;
* V_83 += sizeof( * V_89 ) ;
switch ( V_93 ) {
case F_56 ( V_100 ) :
if ( V_89 -> V_107 == F_56 ( 67 ) )
V_66 = V_108 ;
else if ( V_89 -> V_109 == F_56 ( 67 ) )
V_66 = V_110 ;
break;
case F_56 ( V_105 ) :
if ( V_89 -> V_107 == F_56 ( 547 ) )
V_66 = V_108 ;
else if ( V_89 -> V_109 == F_56 ( 547 ) )
V_66 = V_110 ;
break;
}
V_92 = * V_83 + V_111 ;
if ( V_66 == V_110 &&
F_54 ( V_82 , V_92 + V_112 ) ) {
