...
F_102 ( V_163 ) ;
F_103 ( V_26 , V_163 ) ;
F_104 ( V_26 , V_163 , L_7 , V_22 -> V_66 ) ;
if ( ! V_162 ) {
F_105 ( V_26 , V_163 ) ;
F_106 ( V_26 , V_163 ) ;
F_107 ( V_26 , V_163 ) ;
...
V_170 = * V_93 ;
F_14 ( V_170 ) ;
F_119 ( F_120 ( & V_170 -> V_100 ) != 0 , V_174 L_12 , F_121 ( & V_170 -> V_100 ) ) ;
F_119 ( F_122 ( & V_170 -> V_100 ) == V_175 , V_174 L_12 ,
F_121 ( & V_170 -> V_100 ) ) ;
...
V_69 -> V_86 = V_93 ;
V_172 = & V_27 -> V_185 ;
V_116 = F_125 ( V_172 , & V_170 -> V_100 , 0 ) ;
if ( V_116 != 0 ) {
V_11 = F_84 ( V_116 ) ;
goto V_137;
}
V_59 = F_126 ( V_26 , F_3 ( V_5 ) , V_172 , & V_69 -> V_33 ) ;
if ( F_124 ( V_59 ) ) {
V_11 = ( void * ) V_59 ;
goto V_137;
}
...
F_14 ( & V_11 -> V_106 == F_131 ( V_186 ) ) ;
F_132 ( V_187 , & V_186 -> V_188 ) ;
}
F_127 ( V_26 , V_59 ) ;
F_128 ( V_26 , & V_173 ) ;
return 0 ;
...
V_59 = F_6 ( V_11 ) ;
V_194 -> V_197 = V_59 ;
V_194 -> V_198 = F_134 ( V_59 , V_189 ) ;
V_194 -> V_199 = F_134 ( V_59 , V_190 ) ;
V_194 -> V_200 = V_191 == V_201 ? V_202 : V_203 ;
V_194 -> V_204 = V_192 ;
V_38 -> V_205 = V_59 ;
V_193 = F_135 ( V_26 , V_38 , V_194 , L_7 , V_11 ) ;
if ( V_193 ) {
struct V_74 * V_75 = V_11 -> V_88 -> V_76 ;
struct V_18 * V_63 ;
V_116 = F_136 ( V_26 , V_193 ) ;
if ( V_116 == 0 ) {
V_63 = F_10 ( F_137 ( V_193 , & V_206 ) ) ;
F_55 ( & V_75 -> V_89 ) ;
if ( F_33 ( & V_63 -> V_55 ) ) {
F_138 ( & V_63 -> V_55 , & V_75 -> V_167 ) ;
...
F_104 ( V_26 , V_193 , L_7 , V_209 ) ;
}
}
return V_116 ;
}
static int F_139 ( struct V_10 * V_11 , T_2 V_189 , T_2 V_190 ,
int V_191 , T_3 * V_52 )
{
struct V_24 * V_27 ;
struct V_25 * V_26 ;
...
V_38 = & V_27 -> V_195 ;
V_38 -> V_211 = 1 ;
V_210 = F_140 ( V_26 , V_38 , V_212 , F_6 ( V_11 ) ) ;
if ( V_210 < 0 )
goto V_137;
F_14 ( V_210 == 0 ) ;
V_210 = F_133 ( V_26 , V_11 , V_189 , V_190 , V_191 , V_52 , 0 ) ;
F_141 ( V_26 , V_38 ) ;
V_137:
F_128 ( V_26 , & V_173 ) ;
return V_210 ;
}
static int F_142 ( struct V_25 * V_26 , struct V_1 * V_72 ,
T_3 V_52 )
{
struct V_74 * V_75 = V_72 -> V_76 ;
...
F_111 ( V_164 , L_13 , V_22 , V_22 -> V_207 ) ;
...
if ( ! V_214 )
return - V_215 ;
F_101 ( V_26 , V_22 , V_162 ) ;
return 0 ;
}
static int F_146 ( struct V_1 * V_72 , T_3 V_52 )
{
struct V_25 * V_26 ;
int V_173 ;
int V_116 ;
...
int V_116 ;
V_116 = F_149 ( V_26 , V_38 , V_219 , V_221 ) ;
if ( V_116 == 0 )
continue;
V_210 = V_210 ? : V_116 ;
}
...
static int F_150 ( struct V_10 * V_11 , int V_222 , T_2 V_223 ,
...
F_152 ( V_218 ) ;
V_38 -> V_211 = 1 ;
V_116 = F_140 ( V_26 , V_38 , V_212 , V_59 ) ;
if ( V_116 < 0 )
goto V_137;
F_14 ( V_116 == 0 ) ;
V_116 = F_133 ( V_26 , V_11 , V_223 ,
V_223 + V_225 * V_233 - 1 ,
...
F_14 ( V_224 [ V_230 ] ) ;
V_219 = F_153 ( V_26 , V_59 , F_134 ( V_59 , V_223 ) ,
V_224 [ V_230 ] , V_238 ) ;
if ( F_124 ( V_219 ) ) {
V_116 = F_130 ( V_219 ) ;
break;
...
if ( V_226 )
V_116 = F_147 ( V_26 , V_38 , V_242 , V_218 ) ;
else
V_116 = F_158 ( V_26 , V_38 , V_242 , V_218 , 0 ) ;
F_111 ( V_164 , L_14 ,
V_226 ? L_15 : L_16 , V_116 ) ;
}
F_142 ( V_26 , V_72 , V_228 . V_52 ) ;
V_237:
F_159 ( V_26 , V_38 , V_218 ) ;
F_160 ( V_26 , V_38 , V_218 ) ;
F_161 ( V_26 , V_218 ) ;
F_141 ( V_26 , V_38 ) ;
V_137:
F_128 ( V_26 , & V_173 ) ;
...
static int
F_162 ( struct V_92 * V_170 , void * V_244 , int V_245 )
{
struct V_92 * V_246 = V_244 ;
int V_247 , V_230 ;
V_247 = F_163 ( struct V_92 , V_96 [ V_170 -> V_248 ] ) ;
if ( V_247 > V_245 )
return - V_249 ;
if ( F_164 ( V_246 , V_170 , sizeof( * V_246 ) ) )
return - V_250 ;
for ( V_230 = 0 ; V_230 < V_170 -> V_248 ; V_230 ++ ) {
if ( F_164 ( V_246 -> V_96 [ V_230 ] , V_170 -> V_96 [ V_230 ] ,
sizeof( V_170 -> V_96 [ 0 ] ) ) )
return - V_250 ;
}
return 0 ;
...
static int
F_165 ( struct V_1 * V_72 , struct V_92 * V_170 ,
...
return - V_249 ;
if ( F_166 ( V_170 , V_246 , sizeof( * V_170 ) ) )
return - V_250 ;
...
static int F_167 ( const struct V_25 * V_26 , struct V_1 * V_72 ,
...
if ( V_246 != NULL ) {
int V_230 , V_264 ;
V_116 = F_165 ( V_72 , V_170 , V_246 , V_245 ) ;
if ( V_116 != 0 )
goto V_263;
if ( V_170 -> V_248 == 0 )
...
V_264 = F_168 () ;
for ( V_230 = 0 ; V_230 < V_170 -> V_248 ; V_230 ++ ) {
if ( F_120 ( & V_170 -> V_96 [ V_230 ] -> V_179 ) == 0 )
...
if ( F_120 ( & V_170 -> V_100 ) == 0 )
F_169 ( & V_170 -> V_100 , ++ V_268 ) ;
V_116 = 0 ;
if ( V_255 ) {
F_14 ( ( V_257 -> V_261 & V_266 ) &&
( F_122 ( & V_257 -> V_267 ) == V_175 ) ) ;
V_116 = F_170 ( V_26 , V_75 -> V_95 , V_257 , & V_170 , V_259 ) ;
if ( V_116 != 0 ) {
F_79 ( L_19 , V_116 ) ;
goto V_263;
}
...
V_257 -> V_261 |= V_262 ;
V_11 = F_118 ( V_72 , & V_170 ) ;
if ( F_124 ( V_11 ) ) {
V_116 = F_130 ( V_11 ) ;
goto V_263;
}
F_129 ( V_11 ) ;
F_111 ( V_164 , L_20 V_174 L_12 , F_121 ( & V_257 -> V_267 ) ) ;
V_263:
if ( V_260 && V_116 )
F_171 ( V_26 , V_75 -> V_95 , V_257 , V_170 , V_259 , NULL , NULL ) ;
if ( V_170 )
F_65 ( V_72 , & V_170 ) ;
if ( V_116 )
F_79 ( L_21 , V_116 ) ;
...
static int F_172 ( struct V_10 * * V_269 , struct V_1 * V_72 ,
struct V_256 * V_257 )
{
struct V_92 * V_170 = NULL ;
struct V_10 * V_11 ;
int V_116 ;
if ( ( V_257 -> V_261 & V_262 ) == 0 || F_120 ( & V_257 -> V_267 ) == 0 ) {
F_79 ( L_17 ) ;
return - V_249 ;
}
V_116 = F_58 ( V_72 , & V_170 ) ;
...
static void
F_174 ( struct V_92 * V_170 , T_2 * V_270 , T_2 * V_271 )
{
unsigned long V_272 ;
unsigned long V_273 ;
unsigned long V_274 ;
...
V_272 = V_170 -> V_248 ;
V_274 = V_273 * V_272 ;
V_275 = F_175 ( V_223 , V_274 ) ;
V_276 = V_275 / V_273 ;
* V_271 = F_120 ( & V_170 -> V_96 [ V_276 ] -> V_179 ) ;
* V_270 = V_223 * V_273 + V_275 % V_273 ;
}
static void
F_176 ( struct V_92 * V_170 ,
...
V_280 = V_223 + V_282 ;
V_281 = V_277 ;
F_174 ( V_170 , & V_280 , & V_281 ) ;
} else {
V_280 = 0xdeadbeef00c0ffeeULL ;
V_281 = 0xdeadbeef00c0ffeeULL ;
}
F_178 ( V_279 + V_282 , V_283 ,
V_280 , V_281 ) ;
}
F_179 ( V_34 ) ;
}
static int F_180 ( struct V_92 * V_170 ,
...
static int F_182 ( struct V_1 * V_72 , int V_222 , struct V_256 * V_257 ,
...
T_6 V_290 ;
int V_291 = 0 ;
V_289 = ( F_120 ( & V_257 -> V_267 ) != V_292 &&
( V_257 -> V_261 & V_293 ) != 0 &&
( V_257 -> V_294 & V_295 ) != 0 ) ;
V_290 = ( ( F_120 ( & V_257 -> V_267 ) & 2 ) == 0 ) ? V_296 : V_297 ;
F_14 ( V_222 == V_284 || V_222 == V_298 ) ;
F_14 ( V_170 != NULL ) ;
F_14 ( F_120 ( & V_170 -> V_100 ) == F_120 ( & V_257 -> V_267 ) ) ;
if ( V_278 <= 0 ||
( V_278 & ( ~ V_231 ) ) != 0 )
return - V_249 ;
V_225 = V_278 >> V_299 ;
if ( V_222 == V_284 )
V_291 = V_300 ;
V_286 = F_183 ( V_225 , sizeof( * V_286 ) , V_64 ) ;
if ( V_286 == NULL )
return - V_68 ;
V_224 = F_183 ( V_225 , sizeof( * V_224 ) , V_64 ) ;
if ( V_224 == NULL ) {
F_62 ( V_286 ) ;
return - V_68 ;
}
...
V_287 -> V_302 = V_291 ;
if ( V_289 )
F_176 ( V_170 , V_287 -> V_301 , V_222 ,
F_120 ( & V_257 -> V_267 ) , V_288 ,
V_287 -> V_278 ) ;
}
F_14 ( V_72 -> V_79 != NULL ) ;
V_116 = F_150 ( V_11 , V_222 , V_223 , V_224 , V_225 , V_226 ) ;
V_137:
...
static int F_186 ( const struct V_25 * V_26 ,
...
( V_170 != NULL && F_120 ( & V_170 -> V_100 ) != F_120 ( & V_257 -> V_267 ) ) )
return - V_249 ;
V_225 = V_305 >> V_299 ;
V_312 = V_278 >> V_299 ;
V_309 = F_183 ( V_225 , sizeof( struct V_308 ) , V_64 ) ;
V_311 = F_183 ( V_225 , sizeof( struct V_310 ) , V_64 ) ;
...
V_259 -> V_318 = 0 ;
V_314 = V_225 ;
V_313 = F_188 ( V_26 , V_222 , exp , V_257 , 1 , & V_307 , V_311 , & V_314 ,
V_309 , V_259 , NULL ) ;
if ( V_313 != 0 )
goto V_137;
F_14 ( V_314 == V_225 ) ;
...
if ( F_120 ( & V_257 -> V_267 ) == V_292 ||
( V_257 -> V_261 & V_293 ) == 0 ||
( V_257 -> V_294 & V_295 ) == 0 )
continue;
if ( V_222 == V_284 )
F_176 ( V_170 , V_34 , V_222 ,
F_120 ( & V_257 -> V_267 ) ,
V_311 [ V_230 ] . V_223 ,
V_311 [ V_230 ] . V_315 ) ;
else
...
V_313 = F_189 ( V_26 , V_222 , exp , V_257 , 1 , & V_307 ,
V_311 , V_225 , V_309 , V_259 , V_313 ) ;
if ( V_313 != 0 )
goto V_137;
memset ( V_259 , 0 , sizeof( * V_259 ) ) ;
F_190 ( (struct V_119 * ) & V_26 -> V_28 ) ;
...
static int F_192 ( const struct V_25 * V_26 , int V_222 ,
struct V_304 * exp ,
struct V_319 * V_124 ,
struct V_258 * V_320 )
{
struct V_6 * V_7 = F_193 ( exp ) ;
...
case 1 :
case 2 :
V_116 = F_182 ( V_72 , V_222 , V_257 ,
V_11 , V_124 -> V_328 ,
V_124 -> V_326 , V_226 , V_320 ) ;
break;
case 3 :
V_116 = F_186 ( V_26 , V_75 -> V_95 , V_222 , V_257 ,
V_11 , V_124 -> V_328 ,
...
static int
F_194 ( struct V_304 * exp , struct V_256 * V_257 ,
...
V_116 = F_139 ( V_11 , V_223 , V_190 , V_191 , & V_330 -> V_52 ) ;
if ( V_116 == 0 ) {
V_257 -> V_261 |= V_323 ;
F_111 ( V_164 , L_25 , V_330 -> V_52 ) ;
}
F_173 ( V_11 ) ;
return V_116 ;
}
...
return - V_249 ;
F_111 ( V_164 , L_25 , V_52 ) ;
return F_146 ( V_72 , V_52 ) ;
}
static int
F_196 ( unsigned int V_332 , struct V_304 * exp , int V_315 ,
...
V_116 = F_125 ( & V_172 , & V_257 -> V_267 , 0 ) ;
if ( V_116 < 0 )
return V_116 ;
V_26 = F_61 ( sizeof( * V_26 ) , V_64 ) ;
if ( V_26 == NULL )
return - V_68 ;
V_116 = F_197 ( V_26 , V_337 ) ;
if ( V_116 ) {
V_116 = - V_68 ;
goto V_137;
}
...
V_116 = F_167 ( V_26 , V_72 , 1 , V_257 , V_124 -> V_324 ,
V_124 -> V_325 , & V_320 ) ;
goto V_137;
case V_341 :
if ( ! F_198 ( V_339 ) ) {
...
V_116 = F_172 ( & V_11 , V_72 , V_257 ) ;
if ( V_116 == 0 ) {
V_116 = F_171 ( V_26 , V_75 -> V_95 , V_257 , V_11 -> V_87 ,
& V_320 , NULL , NULL ) ;
if ( V_116 == 0 )
V_11 -> V_165 = 1 ;
F_173 ( V_11 ) ;
...
V_178 . V_345 = V_257 ;
V_116 = F_199 ( V_26 , V_75 -> V_95 , & V_178 ) ;
F_173 ( V_11 ) ;
}
goto V_137;
case V_346 :
...
V_178 . V_345 = V_257 ;
V_178 . V_344 = V_11 -> V_87 ;
V_116 = F_200 ( V_26 , V_75 -> V_95 , & V_178 , NULL ) ;
F_173 ( V_11 ) ;
}
goto V_137;
case V_347 :
...
V_222 = V_284 ;
case V_348 :
V_116 = F_192 ( V_26 , V_222 , exp , V_124 , & V_320 ) ;
goto V_137;
case V_349 :
V_116 = F_172 ( & V_11 , V_72 , V_257 ) ;
if ( V_116 == 0 ) {
V_116 = F_162 ( V_11 -> V_87 , V_124 -> V_324 ,
V_124 -> V_325 ) ;
F_173 ( V_11 ) ;
}
goto V_137;
...
int V_116 ;
if ( V_357 -> V_362 < 2 || F_203 ( V_357 , 1 ) < 1 ) {
F_79 ( L_28 ) ;
return - V_249 ;
}
V_134 = F_92 ( F_93 ( V_357 , 1 ) ) ;
...
V_361 -> V_376 = V_377 ;
V_361 -> V_378 = V_175 ;
V_116 = F_205 ( V_26 , & V_75 -> V_95 , V_134 , & V_359 , V_361 , NULL ) ;
if ( V_116 == 0 ) {
F_55 ( & V_134 -> V_379 ) ;
...
static int F_96 ( struct V_6 * V_356 )
{
struct V_74 * V_75 = & V_356 -> V_147 . V_148 ;
int V_116 ;
if ( ! F_33 ( & V_356 -> V_381 ) ) {
...
V_116 = F_206 ( V_75 -> V_95 ) ;
if ( V_116 != 0 )
F_79 ( L_33 , V_116 ) ;
return V_116 ;
}
static int F_207 ( const struct V_25 * V_26 ,
struct V_304 * * exp ,
...
V_116 = F_208 ( & V_386 , V_383 , V_384 ) ;
if ( V_116 == 0 ) {
* exp = F_209 ( & V_386 ) ;
}
return V_116 ;
}
static int F_210 ( struct V_304 * exp )
{
int V_116 ;
if ( exp == NULL ) {
V_116 = - V_249 ;
