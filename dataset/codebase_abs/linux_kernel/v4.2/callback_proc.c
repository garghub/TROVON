...
F_52 ( args , V_3 , V_11 ) ;
F_12 ( L_14 , V_32 ,
F_13 ( V_11 ) , F_13 ( V_3 -> V_142 ) ) ;
return V_11 ;
}
static bool
F_53 ( unsigned long V_143 )
{
return ( V_143 & ~ V_144 ) == 0 ;
}
T_1 F_54 ( struct V_145 * args , void * V_34 ,
struct V_4 * V_5 )
{
T_1 V_11 ;
T_5 V_125 = 0 ;
...
& args -> V_147 ) )
V_125 |= V_20 ;
if ( F_31 ( V_151 , ( const unsigned long * )
& args -> V_147 ) )
F_42 ( V_5 -> V_13 ) ;
if ( V_125 )
F_55 ( V_5 -> V_13 , V_125 ) ;
...
T_1 F_56 ( struct V_152 * args , void * V_34 ,
struct V_4 * V_5 )
{
struct V_80 * V_153 ;
T_1 V_11 ;
