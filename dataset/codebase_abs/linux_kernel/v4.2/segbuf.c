...
{
struct V_80 * V_80 = V_86 -> V_80 ;
int V_37 ;
if ( V_4 -> V_14 > 0 &&
F_56 ( V_4 -> V_7 -> V_88 ) ) {
F_57 ( & V_4 -> V_12 ) ;
V_4 -> V_14 -- ;
if ( F_3 ( F_58 ( & V_4 -> V_13 ) ) ) {
F_53 ( V_80 ) ;
V_37 = - V_89 ;
goto V_90;
}
...
V_4 -> V_14 ++ ;
V_86 -> V_80 = NULL ;
V_86 -> V_92 -= V_86 -> V_93 - V_86 -> V_94 ;
V_86 -> V_95 = F_60 ( V_86 -> V_96 , V_86 -> V_92 ) ;
V_86 -> V_94 = V_86 -> V_93 ;
return 0 ;
V_90:
V_86 -> V_80 = NULL ;
...
static struct V_80 * F_61 ( struct V_17 * V_18 , T_4 V_94 ,
int V_95 )
{
struct V_80 * V_80 ;
V_80 = F_62 ( V_97 , V_95 ) ;
...
{
V_86 -> V_80 = NULL ;
V_86 -> V_92 = V_4 -> V_25 . V_26 ;
V_86 -> V_96 = F_65 ( V_86 -> V_18 -> V_99 ) ;
V_86 -> V_95 = F_60 ( V_86 -> V_96 , V_86 -> V_92 ) ;
V_86 -> V_94 = V_86 -> V_93 = 0 ;
V_86 -> V_103 = V_4 -> V_22 ;
}
static int F_66 ( struct V_1 * V_4 ,
struct V_85 * V_86 ,
struct V_30 * V_31 , int V_87 )
{
int V_104 , V_37 ;
F_67 ( V_86 -> V_95 <= 0 ) ;
V_105:
if ( ! V_86 -> V_80 ) {
V_86 -> V_80 = F_61 ( V_86 -> V_18 , V_86 -> V_103 + V_86 -> V_93 ,
V_86 -> V_95 ) ;
if ( F_3 ( ! V_86 -> V_80 ) )
return - V_33 ;
}
V_104 = F_68 ( V_86 -> V_80 , V_31 -> V_67 , V_31 -> V_66 , F_32 ( V_31 ) ) ;
if ( V_104 == V_31 -> V_66 ) {
V_86 -> V_93 ++ ;
return 0 ;
}
V_37 = F_55 ( V_4 , V_86 , V_87 ) ;
if ( F_63 ( ! V_37 ) )
goto V_105;
return V_37 ;
}
...
struct V_85 V_86 ;
struct V_30 * V_31 ;
int V_106 = 0 , V_107 = V_108 ;
V_86 . V_18 = V_18 ;
F_64 ( V_4 , & V_86 ) ;
F_30 (bh, &segbuf->sb_segsum_buffers, b_assoc_buffers) {
V_106 = F_66 ( V_4 , & V_86 , V_31 , V_107 ) ;
if ( F_3 ( V_106 ) )
goto V_109;
}
F_30 (bh, &segbuf->sb_payload_buffers, b_assoc_buffers) {
