...
static struct V_59 * F_26 ( struct V_28 * V_29 ,
struct V_60 * V_60 )
{
return F_27 ( V_29 ) && V_60 ? V_60 -> V_38 : NULL ;
}
struct V_59 * F_28 ( struct V_28 * V_29 )
{
struct V_60 * V_60 = F_29 ( V_29 -> V_61 ) ;
return F_26 ( V_29 , V_60 ) ;
}
...
struct V_59 * V_64 ;
int V_21 = 0 ;
sscanf ( V_53 -> string , L_12 , V_62 ) ;
if ( ! strlen ( V_62 ) || V_53 -> string [ 0 ] == '\n' ) {
V_64 = NULL ;
} else {
V_64 = F_31 ( F_32 ( V_29 -> V_38 ) , V_62 ) ;
if ( ! V_64 )
return - V_65 ;
}
if ( V_64 ) {
...
struct V_60 * V_66 = F_38 ( V_29 -> V_61 ) ;
struct V_60 * V_67 = F_39 ( V_64 ) ;
F_40 ( ! V_67 ) ;
if ( V_67 == V_66 ) {
F_25 ( V_29 -> V_38 , L_16 ,
V_67 -> V_38 -> V_2 ) ;
...
V_29 -> V_78 = V_79 ;
F_45 ( & V_29 -> V_72 ) ;
F_46 ( V_29 -> V_74 , & V_29 -> V_73 , 0 ) ;
}
}
return 0 ;
}
static void F_52 ( struct V_28 * V_29 , int V_80 ,
T_3 V_81 ,
unsigned long V_82 )
{
...
F_52 ( V_29 , V_88 , V_81 , V_89 ) ;
return 0 ;
}
static int F_57 ( struct V_28 * V_29 , T_3 V_81 )
{
return F_54 ( V_29 , V_81 ) ;
}
static int F_58 ( struct V_28 * V_29 , T_3 V_81 )
{
T_3 * V_83 = V_29 -> V_31 . V_77 ;
struct V_84 * V_85 ;
struct V_60 * V_60 ;
...
T_3 V_81 ;
if ( V_53 -> string ) {
if ( ! F_61 ( V_53 -> string + 1 , - 1 , ( V_91 * ) & V_81 , - 1 , NULL ) ) {
F_12 ( V_29 -> V_38 , L_41 ,
& V_81 ) ;
return V_21 ;
}
...
F_53 (bond, slave, iter) {
if ( strncmp ( V_60 -> V_38 -> V_2 , V_93 , V_63 ) == 0 ) {
F_25 ( V_29 -> V_38 , L_46 ,
V_60 -> V_38 -> V_2 ) ;
F_65 ( V_29 -> V_94 , V_60 ) ;
strcpy ( V_29 -> V_31 . V_93 , V_60 -> V_38 -> V_2 ) ;
F_37 ( V_29 ) ;
goto V_25;
}
}
...
strncpy ( V_29 -> V_31 . V_93 , V_93 , V_63 ) ;
V_29 -> V_31 . V_93 [ V_63 - 1 ] = 0 ;
F_25 ( V_29 -> V_38 , L_47 ,
V_93 , V_29 -> V_38 -> V_2 ) ;
V_25:
F_43 () ;
...
goto V_112;
V_109 = F_31 ( F_32 ( V_29 -> V_38 ) , V_53 -> string ) ;
if ( ! V_109 )
goto V_112;
V_108 = NULL ;
F_53 (bond, slave, iter) {
if ( V_109 == V_60 -> V_38 )
V_108 = V_60 ;
else if ( V_111 && V_111 == V_60 -> V_114 ) {
goto V_112;
}
}
if ( ! V_108 )
