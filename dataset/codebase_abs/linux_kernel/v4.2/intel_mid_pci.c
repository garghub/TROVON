...
if ( ! V_45 )
return;
if ( F_6 ( V_32 -> V_2 -> V_10 , V_32 -> V_3 , V_46 ) )
return;
V_32 -> V_47 = 0 ;
}
...
F_25 ( V_32 , V_16 + 8 + ( V_49 * 4 ) , & V_17 ) ;
V_32 -> V_52 [ V_49 ] . V_53 = V_32 -> V_52 [ V_49 ] . V_54 + V_17 - 1 ;
V_32 -> V_52 [ V_49 ] . V_55 |= V_56 ;
}
}
