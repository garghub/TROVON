...
static int F_21 ( struct V_17 * V_18 , const struct V_65 * V_66 )
{
struct V_2 * V_3 = F_13 ( V_18 ) ;
struct V_1 * V_27 = F_1 ( V_3 ) ;
struct V_67 V_68 = V_66 -> V_69 ;
int V_11 ;
F_22 ( & V_68 . V_28 , 48 , V_70 , 1 ,
& V_68 . V_30 , 32 , V_71 , 1 , 0 ) ;
V_27 -> V_29 . V_28 = V_68 . V_28 ;
V_27 -> V_29 . V_30 = V_68 . V_30 ;
V_27 -> V_31 = V_68 . V_28 + V_72 ;
...
static int F_24 ( struct V_17 * V_18 , struct V_65 * V_66 )
{
struct V_2 * V_3 = F_13 ( V_18 ) ;
struct V_1 * V_27 = F_1 ( V_3 ) ;
struct V_67 * V_68 = & V_66 -> V_69 ;
...
static int F_25 ( struct V_17 * V_18 , struct V_78 * V_66 )
{
V_66 -> V_79 . V_39 = 0 ;
V_66 -> V_79 . V_40 = 0 ;
V_66 -> V_79 . V_28 = V_70 ;
...
static int F_27 ( struct V_17 * V_18 , int V_90 )
{
struct V_2 * V_3 = F_13 ( V_18 ) ;
struct V_91 * V_92 = F_28 ( V_3 ) ;
struct V_1 * V_27 = F_1 ( V_3 ) ;
int V_11 ;
if ( ! V_90 )
return F_29 ( & V_3 -> V_13 , V_92 , V_27 -> V_93 ) ;
V_11 = F_30 ( & V_3 -> V_13 , V_92 , V_27 -> V_93 ) ;
if ( V_11 < 0 )
return V_11 ;
V_11 = F_15 ( V_3 , V_75 ) ;
if ( ! V_11 )
...
if ( V_11 < 0 )
return V_11 ;
V_11 = F_6 ( V_3 , V_97 , & V_94 ) ;
if ( V_11 < 0 )
goto V_98;
V_96 = V_94 << 8 ;
V_11 = F_6 ( V_3 , V_99 , & V_95 ) ;
if ( V_11 < 0 )
goto V_98;
V_96 |= V_95 ;
F_32 ( & V_3 -> V_13 , L_4 , V_96 ) ;
if ( V_96 != 0x5642 ) {
V_11 = - V_100 ;
goto V_98;
}
...
V_27 = F_34 ( & V_3 -> V_13 , sizeof( struct V_1 ) , V_103 ) ;
if ( ! V_27 )
return - V_104 ;
F_35 ( & V_27 -> V_4 , V_3 , & V_105 ) ;
V_27 -> V_55 = & V_8 [ 0 ] ;
V_27 -> V_29 . V_28 = V_106 ;
V_27 -> V_29 . V_30 = V_107 ;
V_27 -> V_29 . V_39 = ( V_70 - V_106 ) / 2 ;
V_27 -> V_29 . V_40 = ( V_71 - V_107 ) / 2 ;
V_27 -> V_31 = V_106 + V_72 ;
V_27 -> V_32 = V_74 ;
V_27 -> V_93 = F_36 ( & V_3 -> V_13 , L_6 ) ;
if ( F_37 ( V_27 -> V_93 ) )
return F_38 ( V_27 -> V_93 ) ;
V_11 = F_31 ( V_3 ) ;
if ( V_11 < 0 )
F_39 ( V_27 -> V_93 ) ;
return V_11 ;
