...
if ( V_88 -> V_41 )
return false ;
if ( V_88 -> V_22 && V_87 == V_88 &&
! ( F_78 ( V_53 ) & V_88 -> V_22 -> V_89 ) )
return true ;
return false ;
}
static bool
...
if ( F_79 ( V_53 , V_88 ) ) {
F_84 ( V_53 , V_88 ) ;
V_8 = V_88 -> V_22 -> V_92 ( V_88 -> V_22 , V_53 ) ;
if ( V_8 )
goto V_93;
V_88 -> V_22 -> V_89 &= ~ F_78 ( V_53 ) ;
}
if ( V_53 != & V_6 -> V_53 [ V_56 ] ) {
if ( V_87 )
F_33 ( V_87 ) ;
...
if ( V_87 != NULL ) {
V_87 -> V_23 . V_24 -> V_25 . V_98 = V_99 ;
F_87 ( F_88 ( V_87 -> V_23 . V_24 ) , V_53 ) ;
V_87 -> V_23 . V_24 -> V_100 = 1 ;
F_43 ( V_87 -> V_23 . V_24 ) ;
F_33 ( V_87 ) ;
}
V_91 = ! V_88 -> V_23 . V_95 ;
...
{
return V_20 . V_21 || F_91 ( V_2 ) -> V_36 ;
}
int F_92 ( struct V_1 * V_2 , void * V_63 ,
struct V_64 * V_65 )
{
struct V_101 * args = V_63 ;
struct V_32 * V_33 = V_65 -> V_66 ;
struct V_17 * V_18 ;
int V_8 ;
if ( ! F_90 ( V_2 ) )
...
if ( F_29 ( V_18 ) )
return F_30 ( V_18 ) ;
args -> V_103 = V_18 -> V_40 ;
F_38 ( L_12 , args -> V_103 ) ;
return 0 ;
}
int F_94 ( struct V_1 * V_2 , void * V_63 ,
struct V_64 * V_65 )
{
struct V_104 * args = V_63 ;
struct V_32 * V_33 = V_65 -> V_66 ;
struct V_17 * V_18 ;
int V_8 ;
if ( args -> V_103 == V_39 )
...
if ( V_8 )
return V_8 ;
V_18 = F_64 ( V_33 , args -> V_103 ) ;
if ( F_29 ( V_18 ) ) {
F_60 ( & V_2 -> V_46 ) ;
return F_30 ( V_18 ) ;
}
F_95 ( & V_18 -> V_33 -> V_38 , V_18 -> V_40 ) ;
F_33 ( V_18 ) ;
F_60 ( & V_2 -> V_46 ) ;
F_38 ( L_13 , args -> V_103 ) ;
return 0 ;
}
int F_96 ( struct V_1 * V_2 , void * V_63 ,
struct V_64 * V_65 )
{
struct V_32 * V_33 = V_65 -> V_66 ;
...
if ( args -> V_28 )
V_8 = - V_109 ;
else if ( args -> V_108 < V_18 -> V_42 . V_43 &&
! F_98 ( V_110 ) )
V_8 = - V_111 ;
else
V_18 -> V_42 . V_43 = args -> V_108 ;
break;
default:
V_8 = - V_109 ;
break;
