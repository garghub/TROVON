...
V_79 -> V_7 = V_7 ;
V_79 -> V_316 = V_317 ;
V_126 = F_222 ( V_7 -> V_290 ) ;
if ( V_126 )
V_126 = F_223 ( V_126 , 0 ) ;
if ( V_126 ) {
if ( V_126 -> V_226 & V_318 ) {
if ( F_99 ( F_224 ( & V_126 -> V_319 ) ) )
F_225 ( V_79 , V_126 ) ;
} else {
F_226 ( V_79 , V_126 ) ;
}
...
F_229 = F_183 ( V_122 -> F_229 ) ;
if ( F_229 )
F_229 ( V_7 ) ;
}
}
int F_230 ( struct V_6 * V_7 , int V_320 , int V_321 ,
char V_244 * V_322 , unsigned int V_202 ,
int (* F_231)( struct V_6 * ) )
{
struct V_121 * V_122 = F_7 ( V_7 ) ;
int V_323 , V_324 ;
int V_94 = 0 ;
...
if ( V_202 < sizeof( int ) )
return - V_182 ;
if ( F_232 ( V_323 , ( int V_244 * ) V_322 ) )
return - V_325 ;
V_324 = V_323 ? 1 : 0 ;
switch ( V_321 ) {
case V_326 :
...
return F_230 ( V_7 , V_320 , V_321 , V_322 , V_202 ,
F_94 ) ;
return F_234 ( V_7 , V_320 , V_321 , V_322 , V_202 ) ;
}
int F_235 ( struct V_6 * V_7 , int V_320 , int V_321 ,
char V_244 * V_322 , unsigned int V_202 )
{
if ( V_320 == V_343 || V_320 == V_344 )
return F_230 ( V_7 , V_320 , V_321 , V_322 , V_202 ,
F_94 ) ;
return F_236 ( V_7 , V_320 , V_321 , V_322 , V_202 ) ;
}
int F_237 ( struct V_6 * V_7 , int V_320 , int V_321 ,
char V_244 * V_322 , int V_244 * V_202 )
{
struct V_121 * V_122 = F_7 ( V_7 ) ;
int V_323 , V_124 ;
if ( F_232 ( V_124 , V_202 ) )
return - V_325 ;
V_124 = F_238 (unsigned int, len, sizeof(int)) ;
if ( V_124 < 0 )
return - V_182 ;
switch ( V_321 ) {
case V_326 :
...
return - V_325 ;
if ( F_239 ( V_322 , & V_323 , V_124 ) )
return - V_325 ;
return 0 ;
}
int F_240 ( struct V_6 * V_7 , int V_320 , int V_321 ,
char V_244 * V_322 , int V_244 * V_202 )
{
if ( V_320 == V_343 || V_320 == V_344 )
return F_237 ( V_7 , V_320 , V_321 , V_322 , V_202 ) ;
return F_241 ( V_7 , V_320 , V_321 , V_322 , V_202 ) ;
}
int F_242 ( struct V_6 * V_7 , int V_320 , int V_321 ,
char V_244 * V_322 , int V_244 * V_202 )
{
if ( V_320 == V_343 || V_320 == V_344 )
return F_237 ( V_7 , V_320 , V_321 , V_322 , V_202 ) ;
return F_243 ( V_7 , V_320 , V_321 , V_322 , V_202 ) ;
}
unsigned int F_244 ( struct V_345 * V_345 , struct V_346 * V_6 , T_11 * V_347 )
{
unsigned int V_32 = F_245 ( V_345 , V_6 , V_347 ) ;
...
static struct V_6 * F_247 ( struct V_354 * V_355 , int V_356 )
{
struct V_6 * V_7 ;
struct V_357 * V_358 = V_355 -> V_359 ;
struct V_1 * V_1 = F_248 ( V_355 ) ;
for ( V_358 -> V_360 = V_356 ; V_358 -> V_360 <= V_358 -> V_22 -> V_32 ;
++ V_358 -> V_360 ) {
struct V_10 * V_11 ;
struct V_3 * V_4 = & V_358 -> V_22 -> V_73 [ V_358 -> V_360 ] ;
if ( F_249 ( & V_4 -> V_42 ) )
continue;
F_21 ( & V_4 -> V_19 ) ;
...
static struct V_6 * F_250 ( struct V_354 * V_355 , struct V_6 * V_7 )
{
struct V_357 * V_358 = V_355 -> V_359 ;
struct V_1 * V_1 = F_248 ( V_355 ) ;
do {
V_7 = F_251 ( V_7 ) ;
} while ( V_7 && ( ! F_5 ( F_6 ( V_7 ) , V_1 ) || V_7 -> V_60 != V_358 -> V_361 ) );
if ( ! V_7 ) {
if ( V_358 -> V_360 <= V_358 -> V_22 -> V_32 )
F_24 ( & V_358 -> V_22 -> V_73 [ V_358 -> V_360 ] . V_19 ) ;
return F_247 ( V_355 , V_358 -> V_360 + 1 ) ;
}
return V_7 ;
}
static struct V_6 * F_252 ( struct V_354 * V_355 , T_12 V_362 )
{
struct V_6 * V_7 = F_247 ( V_355 , 0 ) ;
if ( V_7 )
while ( V_362 && ( V_7 = F_250 ( V_355 , V_7 ) ) != NULL )
-- V_362 ;
return V_362 ? NULL : V_7 ;
}
static void * F_253 ( struct V_354 * V_355 , T_12 * V_362 )
{
struct V_357 * V_358 = V_355 -> V_359 ;
V_358 -> V_360 = V_363 ;
return * V_362 ? F_252 ( V_355 , * V_362 - 1 ) : V_364 ;
}
static void * F_254 ( struct V_354 * V_355 , void * V_365 , T_12 * V_362 )
{
struct V_6 * V_7 ;
if ( V_365 == V_364 )
V_7 = F_252 ( V_355 , 0 ) ;
else
V_7 = F_250 ( V_355 , V_365 ) ;
++ * V_362 ;
return V_7 ;
}
static void F_255 ( struct V_354 * V_355 , void * V_365 )
{
struct V_357 * V_358 = V_355 -> V_359 ;
if ( V_358 -> V_360 <= V_358 -> V_22 -> V_32 )
F_24 ( & V_358 -> V_22 -> V_73 [ V_358 -> V_360 ] . V_19 ) ;
}
int F_256 ( struct V_366 * V_366 , struct V_345 * V_345 )
{
struct V_367 * V_368 = F_257 ( V_366 ) ;
struct V_357 * V_369 ;
int V_94 ;
V_94 = F_258 ( V_366 , V_345 , & V_368 -> V_370 ,
sizeof( struct V_357 ) ) ;
if ( V_94 < 0 )
return V_94 ;
...
int F_259 ( struct V_1 * V_1 , struct V_367 * V_368 )
{
struct V_372 * V_373 ;
int V_270 = 0 ;
V_368 -> V_370 . V_356 = F_253 ;
V_368 -> V_370 . V_374 = F_254 ;
V_368 -> V_370 . V_375 = F_255 ;
V_373 = F_260 ( V_368 -> V_376 , V_377 , V_1 -> V_378 ,
V_368 -> V_379 , V_368 ) ;
if ( ! V_373 )
V_270 = - V_271 ;
return V_270 ;
}
void F_261 ( struct V_1 * V_1 , struct V_367 * V_368 )
{
F_262 ( V_368 -> V_376 , V_1 -> V_378 ) ;
}
static void F_263 ( struct V_6 * V_380 , struct V_354 * V_381 ,
int V_360 )
{
struct V_44 * V_59 = F_26 ( V_380 ) ;
T_4 V_95 = V_59 -> V_62 ;
T_4 V_125 = V_59 -> V_47 ;
T_1 V_382 = F_51 ( V_59 -> V_63 ) ;
T_1 V_383 = F_51 ( V_59 -> V_146 ) ;
F_264 ( V_381 , L_9
L_10 ,
V_360 , V_125 , V_383 , V_95 , V_382 , V_380 -> V_116 ,
F_143 ( V_380 ) ,
F_265 ( V_380 ) ,
0 , 0L , 0 ,
F_266 ( F_267 ( V_381 ) , F_3 ( V_380 ) ) ,
0 , F_268 ( V_380 ) ,
F_269 ( & V_380 -> V_75 ) , V_380 ,
F_269 ( & V_380 -> V_238 ) ) ;
}
int F_270 ( struct V_354 * V_355 , void * V_365 )
{
F_271 ( V_355 , 127 ) ;
if ( V_365 == V_364 )
F_272 ( V_355 , L_11
...
struct V_357 * V_358 = V_355 -> V_359 ;
F_263 ( V_365 , V_355 , V_358 -> V_360 ) ;
}
F_273 ( V_355 , '\n' ) ;
return 0 ;
}
static int T_13 F_274 ( struct V_1 * V_1 )
{
return F_259 ( V_1 , & V_384 ) ;
}
static void T_14 F_275 ( struct V_1 * V_1 )
{
F_261 ( V_1 , & V_384 ) ;
}
int T_15 F_276 ( void )
...
static int T_15 F_280 ( char * V_386 )
{
T_16 V_230 ;
if ( ! V_386 )
return 0 ;
V_230 = F_281 ( V_386 , 0 , & V_387 ) ;
if ( V_230 )
return 0 ;
...
void T_15 F_282 ( struct V_22 * V_389 , const char * V_376 )
{
unsigned int V_285 ;
V_389 -> V_73 = F_283 ( V_376 ,
2 * sizeof( struct V_3 ) ,
V_387 ,
21 ,
0 ,
...
V_388 ,
64 * 1024 ) ;
V_389 -> V_76 = V_389 -> V_73 + ( V_389 -> V_32 + 1 ) ;
for ( V_285 = 0 ; V_285 <= V_389 -> V_32 ; V_285 ++ ) {
F_284 ( & V_389 -> V_73 [ V_285 ] . V_42 , V_285 ) ;
V_389 -> V_73 [ V_285 ] . V_35 = 0 ;
F_285 ( & V_389 -> V_73 [ V_285 ] . V_19 ) ;
}
for ( V_285 = 0 ; V_285 <= V_389 -> V_32 ; V_285 ++ ) {
F_284 ( & V_389 -> V_76 [ V_285 ] . V_42 , V_285 ) ;
V_389 -> V_76 [ V_285 ] . V_35 = 0 ;
F_285 ( & V_389 -> V_76 [ V_285 ] . V_19 ) ;
}
}
T_3 F_286 ( void )
{
...
void T_15 F_287 ( void )
{
unsigned long V_390 ;
F_282 ( & V_22 , L_14 ) ;
V_390 = F_288 () / 8 ;
V_390 = F_289 ( V_390 , 128UL ) ;
V_391 [ 0 ] = V_390 / 4 * 3 ;
V_391 [ 1 ] = V_390 ;
V_391 [ 2 ] = V_391 [ 0 ] * 2 ;
V_392 = V_393 ;
