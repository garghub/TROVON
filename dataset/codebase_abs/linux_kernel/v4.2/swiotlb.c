...
void
F_56 ( struct V_8 * V_9 , T_3 V_5 , void * V_52 ,
T_2 V_83 )
{
V_29 V_46 = F_57 ( V_9 , V_83 ) ;
F_58 ( F_59 () ) ;
if ( ! F_28 ( V_46 ) )
...
static void
F_60 ( struct V_8 * V_88 , T_3 V_5 , enum V_49 V_50 ,
int V_89 )
{
F_12 ( V_90 L_11
L_12 , V_5 , V_88 ? F_54 ( V_88 ) : L_13 ) ;
if ( V_5 <= V_23 || ! V_89 )
return;
if ( V_50 == V_74 )
F_39 ( L_14 ) ;
...
T_2 F_61 ( struct V_8 * V_88 , struct V_91 * V_91 ,
unsigned long V_53 , T_3 V_5 ,
enum V_49 V_50 ,
struct V_92 * V_93 )
{
V_29 V_94 , V_75 = F_62 ( V_91 ) + V_53 ;
T_2 V_83 = F_7 ( V_88 , V_75 ) ;
F_41 ( V_50 == V_95 ) ;
if ( F_63 ( V_88 , V_83 , V_5 ) && ! V_4 )
return V_83 ;
F_64 ( V_88 , V_83 , V_5 , V_4 ) ;
V_94 = F_47 ( V_88 , V_75 , V_5 , V_50 ) ;
if ( V_94 == V_73 ) {
F_60 ( V_88 , V_5 , V_50 , 1 ) ;
return F_7 ( V_88 , V_26 ) ;
}
V_83 = F_7 ( V_88 , V_94 ) ;
if ( ! F_63 ( V_88 , V_83 , V_5 ) ) {
F_48 ( V_88 , V_94 , V_5 , V_50 ) ;
return F_7 ( V_88 , V_26 ) ;
}
return V_83 ;
}
static void F_65 ( struct V_8 * V_9 , T_2 V_83 ,
T_3 V_5 , enum V_49 V_50 )
{
V_29 V_46 = F_57 ( V_9 , V_83 ) ;
F_41 ( V_50 == V_95 ) ;
...
void F_67 ( struct V_8 * V_9 , T_2 V_83 ,
T_3 V_5 , enum V_49 V_50 ,
struct V_92 * V_93 )
{
F_65 ( V_9 , V_83 , V_5 , V_50 ) ;
}
static void
...
T_3 V_5 , enum V_49 V_50 )
{
F_68 ( V_9 , V_83 , V_5 , V_50 , V_80 ) ;
}
void
F_70 ( struct V_8 * V_9 , T_2 V_83 ,
T_3 V_5 , enum V_49 V_50 )
{
F_68 ( V_9 , V_83 , V_5 , V_50 , V_81 ) ;
}
int
F_71 ( struct V_8 * V_9 , struct V_96 * V_97 , int V_98 ,
enum V_49 V_50 , struct V_92 * V_93 )
{
struct V_96 * V_99 ;
int V_22 ;
F_41 ( V_50 == V_95 ) ;
F_72 (sgl, sg, nelems, i) {
V_29 V_46 = F_73 ( V_99 ) ;
T_2 V_83 = F_7 ( V_9 , V_46 ) ;
if ( V_4 ||
! F_63 ( V_9 , V_83 , V_99 -> V_100 ) ) {
V_29 V_94 = F_47 ( V_9 , F_73 ( V_99 ) ,
V_99 -> V_100 , V_50 ) ;
if ( V_94 == V_73 ) {
F_60 ( V_9 , V_99 -> V_100 , V_50 , 0 ) ;
F_74 ( V_9 , V_97 , V_22 , V_50 ,
V_93 ) ;
F_75 ( V_97 ) = 0 ;
return 0 ;
}
V_99 -> V_101 = F_7 ( V_9 , V_94 ) ;
} else
V_99 -> V_101 = V_83 ;
F_75 ( V_99 ) = V_99 -> V_100 ;
}
return V_98 ;
}
int
F_76 ( struct V_8 * V_9 , struct V_96 * V_97 , int V_98 ,
enum V_49 V_50 )
{
return F_71 ( V_9 , V_97 , V_98 , V_50 , NULL ) ;
}
void
F_74 ( struct V_8 * V_9 , struct V_96 * V_97 ,
int V_98 , enum V_49 V_50 , struct V_92 * V_93 )
{
struct V_96 * V_99 ;
int V_22 ;
F_41 ( V_50 == V_95 ) ;
F_72 (sgl, sg, nelems, i)
F_65 ( V_9 , V_99 -> V_101 , F_75 ( V_99 ) , V_50 ) ;
}
void
F_77 ( struct V_8 * V_9 , struct V_96 * V_97 , int V_98 ,
enum V_49 V_50 )
{
return F_74 ( V_9 , V_97 , V_98 , V_50 , NULL ) ;
}
static void
F_78 ( struct V_8 * V_9 , struct V_96 * V_97 ,
int V_98 , enum V_49 V_50 ,
enum V_78 V_79 )
{
struct V_96 * V_99 ;
int V_22 ;
...
void
F_79 ( struct V_8 * V_9 , struct V_96 * V_99 ,
int V_98 , enum V_49 V_50 )
{
F_78 ( V_9 , V_99 , V_98 , V_50 , V_80 ) ;
}
void
F_80 ( struct V_8 * V_9 , struct V_96 * V_99 ,
int V_98 , enum V_49 V_50 )
{
F_78 ( V_9 , V_99 , V_98 , V_50 , V_81 ) ;
}
int
F_81 ( struct V_8 * V_9 , T_2 V_102 )
{
return ( V_102 == F_7 ( V_9 , V_26 ) ) ;
}
int
F_82 ( struct V_8 * V_9 , T_5 V_64 )
{
