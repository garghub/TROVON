...
const struct V_82 * V_83 , T_3 V_84 ,
struct V_82 * V_85 , T_3 * V_86 ,
T_1 * V_87 )
{
int V_11 ;
struct V_1 * V_2 ;
const struct V_88 * V_89 = ( const struct V_88 * ) V_83 ;
struct V_88 * V_90 = (struct V_88 * ) V_85 ;
if ( F_28 ( V_84 != sizeof( * V_89 ) ||
* V_86 != sizeof( * V_90 ) ) )
return V_91 ;
switch ( V_89 -> V_92 . V_93 ) {
case V_94 :
V_2 = F_9 ( V_60 ) ;
if ( ! F_29 ( V_2 , V_90 ) )
V_11 = V_95 | V_96 ;
