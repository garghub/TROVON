...
void
F_40 ( struct V_5 * V_6 , const char * V_87 , const char * V_88 , ... )
{
struct V_89 V_90 ;
T_5 args ;
va_start ( args , V_88 ) ;
...
void
F_43 ( struct V_5 * V_6 , const char * V_87 , const char * V_88 , ... )
{
struct V_89 V_90 ;
T_5 args ;
va_start ( args , V_88 ) ;
V_90 . V_88 = V_88 ;
V_90 . V_91 = & args ;
F_42 ( L_6 , V_6 -> V_92 , V_87 , & V_90 ) ;
va_end ( args ) ;
}
bool
F_44 ( const struct V_29 * V_29 )
{
struct V_1 * V_1 = F_20 ( V_29 ) ;
return F_45 ( F_30 ( V_1 -> V_7 ) -> V_93 , V_95 ) ;
}
int
F_46 ( const unsigned char * V_13 , int V_96 , bool V_97 )
{
int V_98 ;
if ( V_96 > V_99 ) {
if ( V_97 )
...
int
F_47 ( unsigned char * V_102 , struct V_29 * V_29 )
{
T_1 V_96 = F_48 ( V_29 -> V_103 . V_96 , V_99 ) ;
* V_102 ++ = V_96 ;
memcpy ( V_102 , V_29 -> V_103 . V_13 , V_96 ) ;
return V_96 ;
}
