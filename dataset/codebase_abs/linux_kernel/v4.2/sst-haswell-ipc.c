...
int F_160 ( struct V_275 * V_51 , struct V_326 * V_75 )
{
struct V_157 V_158 ;
struct V_36 * V_37 ;
struct V_146 * V_90 ;
...
V_90 = & V_37 -> V_90 ;
V_90 -> V_51 = V_51 ;
V_90 -> V_327 . V_328 = F_153 ;
V_90 -> V_327 . V_329 = F_156 ;
V_90 -> V_327 . V_330 = F_157 ;
V_90 -> V_327 . V_331 = F_158 ;
V_90 -> V_327 . V_332 = F_159 ;
V_90 -> V_333 = V_47 ;
V_90 -> V_334 = V_47 ;
V_122 = F_162 ( V_90 ) ;
if ( V_122 != 0 )
...
F_164 ( & V_37 -> V_58 ) ;
V_336 . V_337 = V_37 ;
V_37 -> V_52 = F_165 ( V_51 , & V_336 , V_75 ) ;
if ( V_37 -> V_52 == NULL ) {
V_122 = - V_273 ;
goto V_338;
}
V_90 -> V_52 = V_37 -> V_52 ;
V_37 -> V_339 = F_166 ( V_37 -> V_52 -> V_317 ,
...
void F_171 ( struct V_275 * V_51 , struct V_326 * V_75 )
{
