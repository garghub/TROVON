...
struct V_3 * V_4 ;
int V_21 ;
V_4 = F_38 ( & V_82 -> V_22 , sizeof( * V_4 ) , V_83 ) ;
if ( ! V_4 )
return - V_84 ;
V_4 -> V_22 = & V_82 -> V_22 ;
V_4 -> V_22 -> V_85 = V_82 -> V_22 . V_86 -> V_85 ;
V_4 -> V_24 = F_39 ( V_82 -> V_22 . V_86 ) ;
F_40 ( V_82 , V_4 ) ;
V_4 -> V_9 = V_87 ;
V_4 -> V_10 = F_41 ( V_87 ) ;
V_4 -> V_14 = V_88 ;
...
if ( F_44 ( V_4 -> V_91 ) ) {
F_13 ( & V_82 -> V_22 , L_11 ) ;
return F_45 ( V_4 -> V_91 ) ;
}
V_4 -> V_70 = V_92 ;
V_4 -> V_70 . V_22 = & V_82 -> V_22 ;
V_4 -> V_70 . V_85 = V_82 -> V_22 . V_86 -> V_85 ;
V_21 = F_46 ( & V_4 -> V_70 ) ;
if ( V_21 < 0 ) {
F_13 ( & V_82 -> V_22 , L_12 , V_21 ) ;
goto V_93;
}
V_21 = F_47 ( & V_4 -> V_70 , F_42 ( & V_82 -> V_22 ) ,
0 , 0 , V_94 ) ;
if ( V_21 < 0 ) {
