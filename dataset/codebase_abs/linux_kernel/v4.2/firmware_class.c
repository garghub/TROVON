...
static struct V_59 * F_54 ( struct V_38 * V_52 )
{
return F_55 ( V_52 , struct V_59 , V_52 ) ;
}
...
static void F_59 ( struct V_59 * V_61 )
{
...
static T_1 F_63 ( struct V_68 * V_68 , struct V_69 * V_70 ,
char * V_17 )
{
...
static void F_66 ( struct V_38 * V_52 )
{
struct V_59 * V_61 = F_54 ( V_52 ) ;
F_7 ( V_61 ) ;
}
static int F_67 ( struct V_59 * V_61 , struct V_72 * V_73 )
{
if ( F_68 ( V_73 , L_8 , V_61 -> V_17 -> V_19 ) )
return - V_29 ;
if ( F_68 ( V_73 , L_9 , V_10 ) )
return - V_29 ;
if ( F_68 ( V_73 , L_10 , V_61 -> V_74 ) )
return - V_29 ;
return 0 ;
}
static int F_69 ( struct V_38 * V_52 , struct V_72 * V_73 )
{
struct V_59 * V_61 = F_54 ( V_52 ) ;
int V_75 = 0 ;
F_40 ( & V_47 ) ;
...
static T_1 F_70 ( struct V_38 * V_52 ,
...
return 0 ;
F_72 ( V_17 -> V_9 ) ;
V_17 -> V_9 = F_73 ( V_17 -> V_51 , V_17 -> V_80 , 0 , V_81 ) ;
if ( ! V_17 -> V_9 )
return - V_29 ;
return 0 ;
}
static T_1 F_74 ( struct V_38 * V_52 ,
struct V_76 * V_70 ,
const char * V_17 , T_2 V_71 )
{
struct V_59 * V_61 = F_54 ( V_52 ) ;
...
static T_1 F_78 ( struct V_31 * V_85 , struct V_86 * V_87 ,
struct V_88 * V_89 ,
char * V_90 , T_3 V_91 , T_2 V_71 )
{
struct V_38 * V_52 = F_79 ( V_87 ) ;
struct V_59 * V_61 = F_54 ( V_52 ) ;
struct V_13 * V_17 ;
T_1 V_92 ;
F_40 ( & V_47 ) ;
...
int V_99 = F_80 ( T_2 , V_98 - V_97 , V_71 ) ;
V_94 = F_81 ( V_17 -> V_51 [ V_95 ] ) ;
...
static int F_83 ( struct V_59 * V_61 , int V_100 )
{
struct V_13 * V_17 = V_61 -> V_17 ;
int V_101 = F_84 ( V_100 ) >> V_96 ;
if ( V_17 -> V_84 < V_101 ) {
int V_102 = F_85 ( V_101 ,
V_17 -> V_84 * 2 ) ;
struct V_103 * * V_104 ;
V_104 = F_86 ( V_102 * sizeof( void * ) ,
V_58 ) ;
if ( ! V_104 ) {
F_59 ( V_61 ) ;
return - V_29 ;
...
static T_1 F_88 ( struct V_31 * V_85 , struct V_86 * V_87 ,
struct V_88 * V_89 ,
char * V_90 , T_3 V_91 , T_2 V_71 )
{
struct V_38 * V_52 = F_79 ( V_87 ) ;
...
V_17 -> V_8 = F_90 ( T_2 , V_91 , V_17 -> V_8 ) ;
V_83:
F_43 ( & V_47 ) ;
return V_106 ;
}
static struct V_59 *
F_91 ( struct V_1 * V_1 , const char * V_14 ,
...
static int F_95 ( struct V_59 * V_61 ,
...
F_98 ( & V_61 -> V_52 . V_87 , V_120 ) ;
} else {
V_116 = V_12 ;
}
V_106 = F_99 ( & V_17 -> V_21 ,
V_116 ) ;
...
{
struct V_59 * V_61 ;
V_61 = F_91 ( V_1 , V_3 , V_38 , V_109 ) ;
if ( F_35 ( V_61 ) )
return F_104 ( V_61 ) ;
V_61 -> V_17 = V_1 -> V_50 ;
return F_95 ( V_61 , V_109 , V_116 ) ;
}
...
struct V_13 * V_123 ;
F_40 ( & V_47 ) ;
F_106 (buf, next, &pending_fw_head, pending_list) {
if ( ! V_17 -> V_119 )
F_56 ( V_17 ) ;
}
F_43 ( & V_47 ) ;
...
static inline int
F_103 ( struct V_1 * V_1 , const char * V_3 ,
struct V_38 * V_38 , unsigned int V_109 ,
long V_116 )
{
return - V_41 ;
...
static int F_107 ( struct V_13 * V_17 )
{
int V_124 = 0 ;
F_40 ( & V_47 ) ;
...
static int
F_109 ( struct V_1 * * V_125 , const char * V_3 ,
struct V_38 * V_38 )
{
struct V_1 * V_1 ;
struct V_13 * V_17 ;
...
static int F_110 ( struct V_1 * V_2 , struct V_38 * V_38 ,
unsigned int V_109 )
{
struct V_13 * V_17 = V_2 -> V_50 ;
F_40 ( & V_47 ) ;
if ( ! V_17 -> V_8 || F_100 ( V_17 ) ) {
F_43 ( & V_47 ) ;
return - V_41 ;
}
if ( V_38 && ( V_109 & V_118 ) )
...
static int
F_112 ( const struct V_1 * * V_125 , const char * V_3 ,
struct V_38 * V_38 , unsigned int V_109 )
{
struct V_1 * V_2 ;
long V_116 ;
...
if ( V_109 & V_130 ) {
F_37 ( V_38 , L_21 ) ;
V_124 = F_103 ( V_2 , V_3 , V_38 ,
V_109 , V_116 ) ;
}
}
if ( ! V_124 )
V_124 = F_110 ( V_2 , V_38 , V_109 ) ;
F_116 () ;
V_83:
if ( V_124 < 0 ) {
F_117 ( V_2 ) ;
...
int
F_118 ( const struct V_1 * * V_125 , const char * V_3 ,
struct V_38 * V_38 )
{
int V_124 ;
F_119 ( V_131 ) ;
V_124 = F_112 ( V_125 , V_3 , V_38 ,
V_118 | V_132 ) ;
F_120 ( V_131 ) ;
return V_124 ;
}
int F_121 ( const struct V_1 * * V_125 ,
const char * V_3 , struct V_38 * V_38 )
{
int V_124 ;
F_119 ( V_131 ) ;
...
void F_117 ( const struct V_1 * V_2 )
{
if ( V_2 ) {
if ( ! F_2 ( V_2 ) )
F_44 ( V_2 ) ;
...
static void F_122 ( struct V_133 * V_134 )
{
struct V_135 * V_136 ;
const struct V_1 * V_2 ;
V_136 = F_55 ( V_134 , struct V_135 , V_134 ) ;
F_112 ( & V_2 , V_136 -> V_3 , V_136 -> V_38 ,
V_136 -> V_109 ) ;
...
F_125 ( V_136 -> V_38 ) ;
F_126 ( & V_136 -> V_134 , F_122 ) ;
F_127 ( & V_136 -> V_134 ) ;
return 0 ;
}
static int F_128 ( const char * V_14 )
{
int V_124 ;
const struct V_1 * V_2 ;
F_12 ( L_22 , V_23 , V_14 ) ;
V_124 = F_118 ( & V_2 , V_14 , NULL ) ;
if ( ! V_124 )
F_7 ( V_2 ) ;
F_12 ( L_23 , V_23 , V_14 , V_124 ) ;
return V_124 ;
}
static struct V_13 * F_129 ( const char * V_14 )
{
struct V_13 * V_24 ;
struct V_15 * V_16 = & V_25 ;
F_16 ( & V_16 -> V_26 ) ;
...
static int F_130 ( const char * V_14 )
{
struct V_13 * V_17 ;
struct V_1 V_2 ;
F_12 ( L_22 , V_23 , V_14 ) ;
...
static struct V_143 * F_131 ( const char * V_3 )
{
struct V_143 * V_144 ;
...
static int F_132 ( const char * V_3 )
{
struct V_15 * V_16 = & V_25 ;
struct V_143 * V_144 ;
...
static int F_111 ( const char * V_3 )
{
struct V_15 * V_16 = & V_25 ;
struct V_143 * V_144 ;
int V_124 = 0 ;
...
static void F_133 ( struct V_143 * V_144 )
{
F_47 ( V_144 -> V_3 ) ;
F_7 ( V_144 ) ;
}
...
static void F_136 ( struct V_38 * V_52 , void * V_53 ,
void * V_9 )
{
struct V_54 * V_55 = V_53 ;
...
static int F_137 ( struct V_38 * V_52 , void * V_53 ,
void * V_57 )
{
struct V_54 * V_55 = V_53 ;
return ( V_55 -> V_56 == ( unsigned long ) V_57 ) ;
}
static void F_138 ( struct V_38 * V_52 , void * V_9 )
{
F_139 ( V_151 ) ;
struct V_143 * V_144 ;
struct V_143 * V_152 ;
...
struct V_143 * V_144 ;
F_16 ( & V_16 -> V_145 ) ;
while ( ! F_61 ( & V_16 -> V_147 ) ) {
V_144 = F_143 ( V_16 -> V_147 . V_123 ,
struct V_143 , V_27 ) ;
F_135 ( & V_144 -> V_27 ) ;
F_18 ( & V_16 -> V_145 ) ;
F_130 ( V_144 -> V_3 ) ;
...
static void F_151 ( unsigned long V_156 )
{
F_152 ( V_157 , & V_25 . V_134 ,
F_153 ( V_156 ) ) ;
}
static int F_154 ( struct V_62 * V_158 ,
