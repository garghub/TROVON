...
F_95 ( V_132 , L_17 ,
V_133 , 16 , 1 ,
V_120 -> V_52 , V_120 -> V_134 , true ) ;
if ( V_131 == V_135 && V_4 != NULL &&
V_4 -> V_24 == V_136 ) {
F_5 ( & V_13 -> V_23 , V_4 ) ;
F_96 ( V_4 ) ;
F_39 ( V_4 ) ;
...
F_86 ( V_13 , V_120 ,
V_137 ) ;
V_100 = F_98 ( V_13 -> V_26 , V_13 -> V_138 ,
V_120 , V_139 , V_13 ) ;
if ( V_100 ) {
F_13 ( V_130 ) ;
goto V_110;
...
{
T_1 * V_141 = & V_120 -> V_52 [ 2 ] , type , V_142 ;
T_2 V_143 = V_120 -> V_134 - V_144 , V_145 = 0 ;
while ( V_145 < V_143 ) {
type = V_141 [ 0 ] ;
V_142 = V_141 [ 1 ] ;
F_9 ( L_18 , type , V_142 ) ;
...
V_149 = F_111 ( NULL , V_150 -> V_70 , V_125 , 0 ) ;
if ( V_149 == NULL ) {
V_152 = V_155 ;
F_110 ( & V_3 -> V_4 ) ;
F_39 ( & V_3 -> V_4 ) ;
...
V_151 = V_7 ( V_149 ) ;
V_151 -> V_26 = V_13 -> V_26 ;
V_151 -> V_13 = F_21 ( V_13 ) ;
V_151 -> V_156 = V_3 -> V_156 ;
V_151 -> V_107 = V_3 -> V_107 ;
V_151 -> V_157 = V_3 -> V_157 ;
V_151 -> V_48 = V_47 ;
V_151 -> V_138 = V_13 -> V_138 ;
V_151 -> V_150 = V_150 ;
V_151 -> V_47 = V_3 -> V_47 ;
if ( V_3 -> V_47 < V_80 && V_3 -> V_47 >= V_77 ) {
T_3 * V_158 ;
F_9 ( L_23 , V_3 -> V_47 , V_151 ) ;
V_158 =
& V_13 -> V_84 [ V_3 -> V_47 - V_77 ] ;
F_112 ( V_158 ) ;
V_151 -> V_159 = V_3 -> V_47 ;
}
F_113 ( V_151 , & V_120 -> V_52 [ V_144 ] ,
V_120 -> V_134 - V_144 ) ;
F_9 ( L_24 , V_151 , & V_151 -> V_4 ) ;
F_1 ( & V_13 -> V_23 , V_149 ) ;
F_114 ( & V_3 -> V_4 , V_149 ) ;
...
struct V_7 * V_22 ;
struct V_3 * V_4 ;
T_1 V_48 , V_47 , V_131 , V_162 , V_163 ;
V_131 = F_81 ( V_120 ) ;
V_48 = F_80 ( V_120 ) ;
V_47 = F_82 ( V_120 ) ;
V_162 = F_83 ( V_120 ) ;
V_163 = F_84 ( V_120 ) ;
F_9 ( L_26 , V_48 , V_47 , V_163 , V_162 ) ;
V_22 = F_33 ( V_13 , V_48 , V_47 ) ;
if ( V_22 == NULL ) {
F_117 ( V_13 , V_48 , V_47 , V_164 ) ;
return;
}
V_4 = & V_22 -> V_4 ;
F_108 ( V_4 ) ;
...
{
struct V_7 * V_22 ;
T_1 V_48 , V_47 , * V_141 , type , V_142 , V_170 , V_59 ;
T_5 V_171 , V_145 ;
char * V_63 ;
T_2 V_64 ;
struct V_54 * V_55 ;
...
V_141 = & V_120 -> V_52 [ V_144 ] ;
V_171 = V_120 -> V_134 - V_144 ;
V_145 = 0 ;
V_173 = 0 ;
while ( V_145 < V_171 ) {
type = V_141 [ 0 ] ;
...
F_9 ( L_37 , V_22 , V_59 ) ;
V_175:
V_55 = F_127 ( V_170 , V_59 ) ;
if ( V_55 == NULL )
goto exit;
V_173 += V_55 -> V_171 ;
F_52 ( & V_55 -> V_61 , & V_172 ) ;
break;
case V_176 :
F_47 ( & V_13 -> V_56 ) ;
F_9 ( L_38 , V_141 [ 2 ] ) ;
F_128 (sdp, &local->pending_sdreqs, node) {
if ( V_55 -> V_170 != V_141 [ 2 ] )
continue;
V_55 -> V_59 = V_141 [ 3 ] ;
F_9 ( L_39 ,
V_55 -> V_177 , V_55 -> V_59 ) ;
F_51 ( & V_55 -> V_61 ) ;
F_52 ( & V_55 -> V_61 , & V_53 ) ;
break;
}
...
T_5 V_178 ;
struct V_14 * V_179 ;
if ( V_120 -> V_134 <= V_144 ) {
F_43 ( L_41 ) ;
return;
}
F_105 ( V_120 , V_144 ) ;
while ( V_120 -> V_134 > V_180 ) {
V_178 = V_120 -> V_52 [ 0 ] << 8 | V_120 -> V_52 [ 1 ] ;
F_105 ( V_120 , V_180 ) ;
if ( V_178 < V_144 || V_178 > V_120 -> V_134 ) {
F_43 ( L_41 ) ;
return;
}
V_131 = F_81 ( V_120 ) ;
if ( V_131 == V_181 || V_131 == V_182 )
goto V_183;
V_179 = F_131 ( V_178 , V_184 ) ;
if ( V_179 == NULL ) {
F_43 ( L_42 ) ;
return;
}
memcpy ( F_132 ( V_179 , V_178 ) , V_120 -> V_52 , V_178 ) ;
F_133 ( V_13 , V_179 ) ;
F_13 ( V_179 ) ;
V_183:
F_105 ( V_120 , V_178 ) ;
...
if ( V_131 != V_181 )
F_95 ( V_132 , L_44 , V_133 ,
16 , 1 , V_120 -> V_52 , V_120 -> V_134 , true ) ;
switch ( V_131 ) {
case V_181 :
F_9 ( L_45 ) ;
break;
...
void V_139 ( void * V_52 , struct V_14 * V_120 , int V_20 )
{
struct V_12 * V_13 = (struct V_12 * ) V_52 ;
F_9 ( L_55 ) ;
if ( V_20 < 0 ) {
...
void F_139 ( struct V_62 * V_26 , T_6 V_138 ,
T_1 V_193 , T_1 V_194 )
{
struct V_12 * V_13 ;
F_9 ( L_57 , V_194 ) ;
...
int F_140 ( struct V_62 * V_196 )
{
struct V_12 * V_13 ;
V_13 = F_141 ( sizeof( struct V_12 ) , V_184 ) ;
if ( V_13 == NULL )
return - V_197 ;
V_13 -> V_26 = V_196 ;
F_142 ( & V_13 -> V_46 ) ;
...
F_148 ( & V_13 -> V_23 . V_5 ) ;
F_148 ( & V_13 -> V_140 . V_5 ) ;
F_148 ( & V_13 -> V_34 . V_5 ) ;
V_13 -> V_104 = 150 ;
V_13 -> V_156 = V_199 ;
V_13 -> V_107 = F_75 ( V_200 ) ;
V_13 -> V_75 = 0x1 ;
F_74 ( V_13 ) ;
V_13 -> V_10 = V_191 ;
V_13 -> V_58 = V_192 ;
...
V_13 -> V_42 . V_198 = F_57 ;
F_147 ( & V_13 -> V_43 , F_45 ) ;
F_150 ( & V_13 -> V_46 , & V_201 ) ;
return 0 ;
}
