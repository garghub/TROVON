...
int F_91 ( struct V_77 * V_78 , struct V_79 * V_80 )
{
int V_55 ;
struct V_81 V_82 ;
V_82 . type = V_83 ;
...
int V_55 = - V_90 ;
F_87 ( & V_68 ) ;
if ( F_57 () && ! ( V_11 -> V_21 . V_27 . V_30 & V_86 ) ) {
V_89 . V_27 = V_11 -> V_21 . V_27 . V_27 ;
V_89 . V_29 = V_11 -> V_21 . V_27 . V_29 ;
V_55 = F_68 ( V_91 , & V_89 ) ;
if ( ( V_55 == - V_92 && V_11 -> V_21 . V_27 . V_29 != V_73 ) )
F_88 ( L_7 ,
...
continue;
if ( V_108 . V_21 . V_24 == V_24 && V_108 . V_98 == V_13 ) {
V_55 = V_43 ;
break;
}
}
...
int F_102 ( unsigned int V_24 , unsigned int V_13 , bool V_114 )
{
struct V_115 V_116 ;
int V_5 , V_6 , V_14 ;
F_87 ( & V_68 ) ;
...
if ( V_6 < 0 )
return V_6 ;
V_123 = F_105 ( V_6 , V_119 , V_120 , V_121 , V_122 ) ;
if ( V_123 != 0 ) {
F_103 ( V_6 ) ;
return V_123 ;
}
...
{
int V_6 , V_123 ;
V_6 = F_102 ( V_24 , V_13 , V_120 & V_124 ) ;
if ( V_6 < 0 )
return V_6 ;
V_123 = F_105 ( V_6 , V_119 , V_120 , V_121 , V_122 ) ;
if ( V_123 != 0 ) {
...
void F_109 ( unsigned int V_6 , void * V_122 )
{
struct V_10 * V_11 = F_10 ( V_6 ) ;
if ( F_60 ( ! V_11 ) )
return;
...
int F_111 ( unsigned V_6 , unsigned V_128 )
{
struct V_129 V_130 ;
V_130 . V_43 = F_21 ( V_6 ) ;
V_130 . V_128 = V_128 ;
...
void F_115 ( unsigned int V_13 , enum V_19 V_70 )
{
int V_6 ;
#ifdef F_116
if ( F_22 ( V_70 == V_133 ) ) {
int V_55 = F_117 ( V_134 , V_13 , NULL ) ;
if ( V_55 < 0 )
F_118 ( V_135 L_12 , V_13 , V_55 ) ;
return;
}
#endif
...
{
struct V_136 * V_136 = F_120 ( V_137 ) ;
int V_13 = F_121 () ;
unsigned V_138 ;
do {
V_136 -> V_139 = 0 ;
...
V_138 = F_120 ( V_140 ) ;
F_125 ( V_140 , 0 ) ;
} while ( V_138 != 1 || V_136 -> V_139 );
V_59:
F_126 () ;
}
void F_127 ( struct V_141 * V_142 )
{
struct V_141 * V_143 = F_128 ( V_142 ) ;
F_129 () ;
#ifdef F_116
F_130 () ;
F_131 ( V_144 ) ;
...
F_90 ( & V_68 ) ;
F_35 ( V_5 , V_11 -> V_13 ) ;
F_136 ( V_6 , F_39 ( V_11 -> V_13 ) ) ;
F_137 ( V_6 ) ;
}
static int F_138 ( unsigned V_6 , unsigned V_145 )
{
struct V_146 V_147 ;
int V_5 = F_21 ( V_6 ) ;
int V_148 ;
...
V_147 . V_98 = V_145 ;
V_148 = F_140 ( V_5 ) ;
if ( F_65 ( V_150 , & V_147 ) >= 0 )
F_35 ( V_5 , V_145 ) ;
if ( ! V_148 )
F_77 ( V_5 ) ;
return 0 ;
}
static int F_141 ( struct V_51 * V_52 , const struct V_151 * V_152 ,
bool V_153 )
{
unsigned V_145 = F_142 ( V_152 , V_154 ) ;
return F_138 ( V_52 -> V_6 , V_145 ) ;
}
...
F_118 ( V_160 L_14 , V_6 , V_156 . V_27 ) ;
F_75 ( V_6 ) ;
}
}
...
V_165 . V_166 = 1 ;
V_165 . V_163 = V_163 ;
F_156 ( V_165 . V_167 , & V_5 ) ;
if ( F_157 ( V_168 , & V_165 ) != 0 )
F_66 () ;
}
}
void F_158 ( int V_6 )
...
int V_55 ;
struct V_182 V_183 ;
V_33 = ( void * ) F_178 ( V_8 | V_184 ) ;
V_183 . V_185 = F_179 ( V_33 ) ;
V_55 = F_68 ( V_186 , & V_183 ) ;
if ( V_55 != 0 ) {
