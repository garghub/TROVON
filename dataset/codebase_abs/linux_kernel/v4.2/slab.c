...
if ( V_15 -> V_16 & V_190 )
V_16 |= V_191 ;
if ( F_142 ( V_15 , V_16 , V_15 -> V_46 ) )
return NULL ;
V_22 = F_143 ( V_97 , V_16 | V_192 , V_15 -> V_46 ) ;
if ( ! V_22 ) {
F_144 ( V_15 , V_15 -> V_46 ) ;
...
V_15 -> V_235 = F_198 () ;
if ( V_15 -> V_235 < V_15 -> V_39 )
V_15 -> V_235 = V_15 -> V_39 ;
V_15 -> V_236 = V_47 / V_15 -> V_235 ;
V_15 -> V_25 = V_25 ;
V_15 -> V_16 = V_16 ;
V_15 -> V_189 = V_237 ;
if ( V_238 && ( V_16 & V_239 ) )
...
struct V_3 * V_84 , int V_241 )
{
struct V_102 * V_242 ;
int V_198 ;
struct V_22 * V_22 ;
V_198 = 0 ;
while ( V_198 < V_241 && ! F_62 ( & V_84 -> V_7 ) ) {
F_99 ( & V_84 -> V_11 ) ;
V_242 = V_84 -> V_7 . V_243 ;
if ( V_242 == & V_84 -> V_7 ) {
F_88 ( & V_84 -> V_11 ) ;
goto V_86;
}
V_22 = F_215 ( V_242 , struct V_22 , V_155 ) ;
#if V_178
F_9 ( V_22 -> V_187 ) ;
#endif
F_183 ( & V_22 -> V_155 ) ;
...
int F_216 ( struct V_14 * V_15 , bool V_244 )
{
int V_137 = 0 ;
int V_64 ;
struct V_3 * V_84 ;
...
struct V_22 * V_22 , int V_235 ,
T_4 V_246 , int V_97 )
{
void * V_30 ;
void * V_204 = F_219 ( V_22 ) ;
if ( F_176 ( V_15 ) ) {
V_30 = F_220 ( V_15 -> V_220 ,
V_246 , V_97 ) ;
if ( ! V_30 )
return NULL ;
} else {
...
V_22 -> V_187 = 0 ;
V_22 -> V_33 = V_204 + V_235 ;
return V_30 ;
}
static inline V_29 F_221 ( struct V_22 * V_22 , unsigned int V_23 )
{
...
F_222 ( V_22 , V_88 , V_88 ) ;
}
}
static void F_224 ( struct V_14 * V_15 , T_4 V_16 )
{
if ( V_238 ) {
if ( V_16 & V_240 )
F_9 ( ! ( V_15 -> V_189 & V_240 ) ) ;
else
F_9 ( V_15 -> V_189 & V_240 ) ;
}
}
...
{
void * V_1 ;
V_1 = F_16 ( V_15 , V_22 , F_221 ( V_22 , V_22 -> V_187 ) ) ;
V_22 -> V_187 ++ ;
#if V_178
F_226 ( F_95 ( F_96 ( V_1 ) ) != V_97 ) ;
#endif
return V_1 ;
}
static void F_227 ( struct V_14 * V_15 , struct V_22 * V_22 ,
void * V_1 , int V_97 )
{
...
#endif
V_22 -> V_187 -- ;
F_222 ( V_22 , V_22 -> V_187 , V_216 ) ;
}
static void F_228 ( struct V_14 * V_32 , struct V_22 * V_22 ,
void * V_30 )
{
V_22 -> V_27 = V_32 ;
V_22 -> V_30 = V_30 ;
}
static int F_229 ( struct V_14 * V_15 ,
...
if ( ! V_22 )
goto V_251;
V_30 = F_218 ( V_15 , V_22 , V_34 ,
V_246 & ~ V_249 , V_97 ) ;
if ( ! V_30 )
goto V_252;
F_228 ( V_15 , V_22 , V_30 ) ;
F_223 ( V_15 , V_22 ) ;
if ( V_246 & V_107 )
F_232 () ;
F_204 () ;
F_82 ( & V_84 -> V_11 ) ;
F_233 ( & V_22 -> V_155 , & ( V_84 -> V_7 ) ) ;
F_234 ( V_15 ) ;
V_84 -> V_12 += V_15 -> V_28 ;
F_84 ( & V_84 -> V_11 ) ;
return 1 ;
...
static void F_235 ( const void * V_1 )
{
if ( ! F_236 ( V_1 ) ) {
F_27 ( V_53 L_28 ,
( unsigned long ) V_1 ) ;
...
static inline void F_237 ( struct V_14 * V_32 , void * V_31 )
{
...
static void * F_238 ( struct V_14 * V_15 , void * V_1 ,
unsigned long V_205 )
{
unsigned int V_216 ;
struct V_22 * V_22 ;
...
static void * F_239 ( struct V_14 * V_15 , T_4 V_16 ,
bool V_87 )
{
int V_79 ;
struct V_3 * V_84 ;
...
V_22 = F_215 ( V_89 , struct V_22 , V_155 ) ;
F_207 ( V_15 ) ;
...
F_241 ( V_15 ) ;
F_242 ( V_15 ) ;
F_67 ( V_15 , V_75 , F_225 ( V_15 , V_22 ,
V_64 ) ) ;
}
F_183 ( & V_22 -> V_155 ) ;
...
int V_262 ;
V_256:
V_262 = F_229 ( V_15 , F_75 ( V_16 ) , V_64 , NULL ) ;
V_75 = F_19 ( V_15 ) ;
V_64 = F_56 () ;
...
static inline void F_243 ( struct V_14 * V_15 ,
T_4 V_16 )
{
F_244 ( V_16 & V_107 ) ;
#if V_178
...
static bool F_246 ( struct V_14 * V_15 , T_4 V_16 )
{
if ( F_41 ( V_15 == V_14 ) )
return false ;
return F_247 ( V_15 -> V_206 , V_16 , V_15 -> V_16 ) ;
}
static inline void * F_248 ( struct V_14 * V_15 , T_4 V_16 )
{
void * V_1 ;
struct V_36 * V_75 ;
bool V_87 = false ;
...
F_250 ( V_15 ) ;
V_1 = F_239 ( V_15 , V_16 , V_87 ) ;
V_75 = F_19 ( V_15 ) ;
V_86:
if ( V_1 )
F_251 ( & V_75 -> V_89 [ V_75 -> V_78 ] ) ;
return V_1 ;
}
...
static void * F_256 ( struct V_14 * V_32 , T_4 V_16 )
{
struct V_270 * V_270 ;
T_4 V_246 ;
struct V_271 * V_272 ;
struct V_273 * V_273 ;
enum V_274 V_275 = F_257 ( V_16 ) ;
void * V_31 = NULL ;
int V_143 ;
unsigned int V_276 ;
if ( V_16 & V_105 )
...
V_277:
V_276 = F_258 () ;
V_270 = F_259 ( F_255 () , V_16 ) ;
V_257:
F_260 (zone, z, zonelist, high_zoneidx) {
V_143 = F_261 ( V_273 ) ;
if ( F_262 ( V_273 , V_16 ) &&
F_55 ( V_32 , V_143 ) &&
...
V_261:
F_84 ( & V_84 -> V_11 ) ;
V_262 = F_229 ( V_15 , F_75 ( V_16 ) , V_97 , NULL ) ;
if ( V_262 )
goto V_257;
return F_256 ( V_15 , V_16 ) ;
V_278:
return V_31 ;
}
static T_9 void *
F_266 ( struct V_14 * V_15 , T_4 V_16 , int V_97 ,
unsigned long V_205 )
{
unsigned long V_279 ;
void * V_151 ;
...
if ( F_246 ( V_15 , V_16 ) )
return NULL ;
V_15 = F_268 ( V_15 , V_16 ) ;
F_243 ( V_15 , V_16 ) ;
F_269 ( V_279 ) ;
if ( V_97 == V_282 )
V_97 = V_280 ;
if ( F_41 ( ! F_55 ( V_15 , V_97 ) ) ) {
V_151 = F_256 ( V_15 , V_16 ) ;
goto V_86;
}
if ( V_97 == V_280 ) {
V_151 = F_248 ( V_15 , V_16 ) ;
if ( V_151 )
goto V_86;
}
...
V_86:
F_270 ( V_279 ) ;
V_151 = F_245 ( V_15 , V_16 , V_151 , V_205 ) ;
F_271 ( V_151 , V_15 -> V_206 , 1 , V_15 -> V_16 ,
V_16 ) ;
if ( F_97 ( V_151 ) ) {
F_272 ( V_15 , V_16 , V_151 , V_15 -> V_206 ) ;
if ( F_41 ( V_16 & V_283 ) )
...
static T_9 void *
F_274 ( struct V_14 * V_32 , T_4 V_16 )
{
void * V_1 ;
if ( V_200 -> V_269 || F_253 () ) {
V_1 = F_73 ( V_32 , V_16 ) ;
if ( V_1 )
goto V_86;
}
...
static T_9 void *
F_274 ( struct V_14 * V_15 , T_4 V_16 )
{
return F_248 ( V_15 , V_16 ) ;
}
static T_9 void *
F_275 ( struct V_14 * V_15 , T_4 V_16 , unsigned long V_205 )
{
unsigned long V_279 ;
void * V_1 ;
V_16 &= V_281 ;
...
V_1 = F_274 ( V_15 , V_16 ) ;
F_270 ( V_279 ) ;
V_1 = F_245 ( V_15 , V_16 , V_1 , V_205 ) ;
F_271 ( V_1 , V_15 -> V_206 , 1 , V_15 -> V_16 ,
V_16 ) ;
F_276 ( V_1 ) ;
if ( F_97 ( V_1 ) ) {
F_272 ( V_15 , V_16 , V_1 , V_15 -> V_206 ) ;
if ( F_41 ( V_16 & V_283 ) )
...
static void F_83 ( struct V_14 * V_15 , void * * V_284 ,
int V_285 , int V_64 , struct V_102 * V_103 )
{
int V_88 ;
struct V_3 * V_84 = F_55 ( V_15 , V_64 ) ;
for ( V_88 = 0 ; V_88 < V_285 ; V_88 ++ ) {
void * V_1 ;
struct V_22 * V_22 ;
F_3 ( & V_284 [ V_88 ] ) ;
V_1 = V_284 [ V_88 ] ;
...
F_183 ( & V_22 -> V_155 ) ;
F_210 ( V_15 , V_64 ) ;
F_227 ( V_15 , V_22 , V_1 , V_64 ) ;
F_277 ( V_15 ) ;
V_84 -> V_12 ++ ;
if ( V_22 -> V_187 == 0 ) {
if ( V_84 -> V_12 > V_84 -> V_113 ) {
V_84 -> V_12 -= V_15 -> V_28 ;
F_233 ( & V_22 -> V_155 , V_103 ) ;
} else {
F_125 ( & V_22 -> V_155 , & V_84 -> V_7 ) ;
}
} else {
F_233 ( & V_22 -> V_155 , & V_84 -> V_6 ) ;
}
}
}
static void F_278 ( struct V_14 * V_15 , struct V_36 * V_75 )
{
int V_79 ;
struct V_3 * V_84 ;
int V_64 = F_56 () ;
...
F_82 ( & V_84 -> V_11 ) ;
if ( V_84 -> V_8 ) {
struct V_36 * V_286 = V_84 -> V_8 ;
int V_92 = V_286 -> V_76 - V_286 -> V_78 ;
if ( V_92 ) {
if ( V_79 > V_92 )
V_79 = V_92 ;
memcpy ( & ( V_286 -> V_89 [ V_286 -> V_78 ] ) ,
...
int V_88 = 0 ;
struct V_102 * V_242 ;
V_242 = V_84 -> V_7 . V_260 ;
while ( V_242 != & ( V_84 -> V_7 ) ) {
struct V_22 * V_22 ;
V_22 = F_215 ( V_242 , struct V_22 , V_155 ) ;
F_9 ( V_22 -> V_187 ) ;
V_88 ++ ;
...
static inline void F_280 ( struct V_14 * V_15 , void * V_1 ,
unsigned long V_205 )
{
struct V_36 * V_75 = F_19 ( V_15 ) ;
F_204 () ;
F_281 ( V_1 , V_15 -> V_16 ) ;
V_1 = F_238 ( V_15 , V_1 , V_205 ) ;
F_282 ( V_15 , V_1 , V_15 -> V_206 ) ;
if ( V_289 > 1 && F_72 ( V_15 , V_1 ) )
return;
...
void * F_285 ( struct V_14 * V_15 , T_4 V_16 )
{
void * V_137 = F_275 ( V_15 , V_16 , V_290 ) ;
F_286 ( V_290 , V_137 ,
V_15 -> V_206 , V_15 -> V_19 , V_16 ) ;
return V_137 ;
}
void *
F_287 ( struct V_14 * V_15 , T_4 V_16 , T_2 V_19 )
{
void * V_137 ;
V_137 = F_275 ( V_15 , V_16 , V_290 ) ;
F_288 ( V_290 , V_137 ,
V_19 , V_15 -> V_19 , V_16 ) ;
return V_137 ;
}
void * F_220 ( struct V_14 * V_15 , T_4 V_16 , int V_97 )
{
void * V_137 = F_266 ( V_15 , V_16 , V_97 , V_290 ) ;
F_289 ( V_290 , V_137 ,
V_15 -> V_206 , V_15 -> V_19 ,
V_16 , V_97 ) ;
return V_137 ;
}
void * F_290 ( struct V_14 * V_15 ,
T_4 V_16 ,
int V_97 ,
T_2 V_19 )
{
void * V_137 ;
V_137 = F_266 ( V_15 , V_16 , V_97 , V_290 ) ;
F_291 ( V_290 , V_137 ,
V_19 , V_15 -> V_19 ,
V_16 , V_97 ) ;
return V_137 ;
...
static T_9 void *
F_292 ( T_2 V_19 , T_4 V_16 , int V_64 , unsigned long V_205 )
{
struct V_14 * V_15 ;
V_15 = F_201 ( V_19 , V_16 ) ;
if ( F_41 ( F_202 ( V_15 ) ) )
return V_15 ;
return F_290 ( V_15 , V_16 , V_64 , V_19 ) ;
}
void * F_293 ( T_2 V_19 , T_4 V_16 , int V_64 )
{
return F_292 ( V_19 , V_16 , V_64 , V_290 ) ;
}
void * F_294 ( T_2 V_19 , T_4 V_16 ,
int V_64 , unsigned long V_205 )
{
return F_292 ( V_19 , V_16 , V_64 , V_205 ) ;
}
static T_9 void * F_295 ( T_2 V_19 , T_4 V_16 ,
unsigned long V_205 )
{
struct V_14 * V_15 ;
void * V_137 ;
...
if ( F_41 ( F_202 ( V_15 ) ) )
return V_15 ;
V_137 = F_275 ( V_15 , V_16 , V_205 ) ;
F_288 ( V_205 , V_137 ,
V_19 , V_15 -> V_19 , V_16 ) ;
return V_137 ;
}
void * F_296 ( T_2 V_19 , T_4 V_16 )
{
return F_295 ( V_19 , V_16 , V_290 ) ;
}
void * F_297 ( T_2 V_19 , T_4 V_16 , unsigned long V_205 )
{
return F_295 ( V_19 , V_16 , V_205 ) ;
}
...
return;
F_269 ( V_16 ) ;
F_299 ( V_1 , V_15 -> V_206 ) ;
if ( ! ( V_15 -> V_16 & V_291 ) )
F_300 ( V_1 , V_15 -> V_206 ) ;
F_280 ( V_15 , V_1 , V_290 ) ;
F_270 ( V_16 ) ;
F_301 ( V_290 , V_1 ) ;
}
...
F_235 ( V_1 ) ;
V_292 = F_14 ( V_1 ) ;
F_299 ( V_1 , V_292 -> V_206 ) ;
F_300 ( V_1 , V_292 -> V_206 ) ;
F_280 ( V_292 , ( void * ) V_1 , V_290 ) ;
F_270 ( V_16 ) ;
}
static int F_303 ( struct V_14 * V_15 , T_4 V_82 )
{
int V_64 ;
struct V_3 * V_84 ;
struct V_36 * V_293 ;
struct V_94 * * V_294 = NULL ;
F_91 (node) {
if ( V_58 ) {
V_294 = F_70 ( V_64 , V_15 -> V_76 , V_82 ) ;
if ( ! V_294 )
goto V_295;
}
V_293 = NULL ;
...
int V_64 ;
struct V_3 * V_84 ;
struct V_36 * V_75 = F_104 ( V_243 , V_63 ) ;
V_64 = F_36 ( V_63 ) ;
V_84 = F_55 ( V_15 , V_64 ) ;
F_99 ( & V_84 -> V_11 ) ;
F_83 ( V_15 , V_75 -> V_89 , V_75 -> V_78 , V_64 , & V_103 ) ;
...
F_217 ( V_243 ) ;
V_296:
return F_303 ( V_15 , V_82 ) ;
}
static int F_306 ( struct V_14 * V_15 , int V_76 ,
int V_79 , int V_8 , T_4 V_82 )
{
int V_137 ;
struct V_14 * V_292 ;
V_137 = F_304 ( V_15 , V_76 , V_79 , V_8 , V_82 ) ;
if ( V_164 < V_174 )
return V_137 ;
if ( ( V_137 < 0 ) || ! F_307 ( V_15 ) )
return V_137 ;
F_308 ( & V_126 ) ;
F_309 (c, cachep) {
F_304 ( V_292 , V_76 , V_79 , V_8 , V_82 ) ;
}
return V_137 ;
}
...
V_79 = ( V_76 + 1 ) / 2 ;
V_298:
V_118 = F_306 ( V_15 , V_76 , V_79 , V_8 , V_82 ) ;
if ( V_118 )
F_27 ( V_53 L_36 ,
V_15 -> V_54 , - V_118 ) ;
return V_118 ;
...
F_99 ( & V_84 -> V_11 ) ;
if ( V_75 -> V_78 ) {
V_241 = V_299 ? V_75 -> V_78 : ( V_75 -> V_76 + 4 ) / 5 ;
if ( V_241 > V_75 -> V_78 )
V_241 = ( V_75 -> V_78 + 1 ) / 2 ;
F_83 ( V_15 , V_75 -> V_89 , V_241 , V_64 , & V_103 ) ;
V_75 -> V_78 -= V_241 ;
memmove ( V_75 -> V_89 , & ( V_75 -> V_89 [ V_241 ] ) ,
...
F_39 () ;
V_86:
F_317 ( V_71 , F_318 ( V_304 ) ) ;
}
void F_319 ( struct V_14 * V_15 , struct V_305 * V_306 )
{
struct V_22 * V_22 ;
unsigned long V_183 ;
unsigned long V_184 ;
...
void F_320 ( struct V_310 * V_311 , struct V_14 * V_15 )
{
#if V_288
{
...
{
unsigned long V_324 = F_322 ( & V_15 -> V_324 ) ;
unsigned long V_325 = F_322 ( & V_15 -> V_325 ) ;
unsigned long V_326 = F_322 ( & V_15 -> V_326 ) ;
unsigned long V_327 = F_322 ( & V_15 -> V_327 ) ;
F_321 ( V_311 , L_44 ,
V_324 , V_325 , V_326 , V_327 ) ;
}
#endif
}
T_10 F_323 ( struct V_328 * V_328 , const char T_11 * V_329 ,
...
static inline int F_325 ( unsigned long * V_84 , unsigned long V_338 )
{
unsigned long * V_242 ;
int V_339 ;
if ( ! V_338 )
...
while ( V_339 ) {
int V_88 = V_339 / 2 ;
unsigned long * V_340 = V_242 + 2 * V_88 ;
if ( * V_340 == V_338 ) {
V_340 [ 1 ] ++ ;
return 1 ;
}
...
if ( ++ V_84 [ 1 ] == V_84 [ 0 ] )
return 0 ;
memmove ( V_242 + 2 , V_242 , V_84 [ 1 ] * 2 * sizeof( unsigned long ) - ( ( void * ) V_242 - ( void * ) V_84 ) ) ;
V_242 [ 0 ] = V_338 ;
V_242 [ 1 ] = 1 ;
return 1 ;
}
static void F_326 ( unsigned long * V_84 , struct V_14 * V_292 ,
struct V_22 * V_22 )
{
void * V_242 ;
int V_88 ;
if ( V_84 [ 0 ] == V_84 [ 1 ] )
return;
for ( V_88 = 0 , V_242 = V_22 -> V_33 ; V_88 < V_292 -> V_28 ; V_88 ++ , V_242 += V_292 -> V_19 ) {
if ( F_13 ( V_22 , V_88 ) != V_264 )
continue;
if ( ! F_325 ( V_84 , ( unsigned long ) * F_11 ( V_292 , V_242 ) ) )
return;
}
}
static void F_327 ( struct V_310 * V_311 , unsigned long V_341 )
{
#ifdef F_328
unsigned long V_34 , V_19 ;
char V_342 [ V_343 ] , V_54 [ V_344 ] ;
if ( F_329 ( V_341 , & V_19 , & V_34 , V_342 , V_54 ) == 0 ) {
F_321 ( V_311 , L_46 , V_54 , V_34 , V_19 ) ;
if ( V_342 [ 0 ] )
F_321 ( V_311 , L_47 , V_342 ) ;
return;
}
#endif
F_321 ( V_311 , L_48 , ( void * ) V_341 ) ;
}
static int F_330 ( struct V_310 * V_311 , void * V_242 )
{
struct V_14 * V_15 = F_215 ( V_242 , struct V_14 , V_103 ) ;
struct V_22 * V_22 ;
struct V_3 * V_84 ;
const char * V_54 ;
unsigned long * V_262 = V_311 -> V_345 ;
int V_64 ;
int V_88 ;
if ( ! ( V_15 -> V_16 & V_18 ) )
return 0 ;
...
if ( V_262 [ 0 ] == V_262 [ 1 ] ) {
F_111 ( & V_126 ) ;
V_311 -> V_345 = F_331 ( V_262 [ 0 ] * 4 * sizeof( unsigned long ) , V_108 ) ;
if ( ! V_311 -> V_345 ) {
V_311 -> V_345 = V_262 ;
F_110 ( & V_126 ) ;
return - V_109 ;
}
* ( unsigned long * ) V_311 -> V_345 = V_262 [ 0 ] * 2 ;
F_80 ( V_262 ) ;
F_110 ( & V_126 ) ;
...
F_321 ( V_311 , L_49 , V_54 , V_262 [ 2 * V_88 + 3 ] ) ;
F_327 ( V_311 , V_262 [ 2 * V_88 + 2 ] ) ;
F_332 ( V_311 , '\n' ) ;
}
return 0 ;
}
static int F_333 ( struct V_346 * V_346 , struct V_328 * V_328 )
{
unsigned long * V_84 ;
V_84 = F_334 ( V_328 , & V_347 , V_49 ) ;
if ( ! V_84 )
return - V_109 ;
...
{
#ifdef V_40
F_336 ( L_50 , 0 , NULL , & V_348 ) ;
#endif
return 0 ;
}
T_2 F_337 ( const void * V_1 )
{
F_9 ( ! V_1 ) ;
if ( F_41 ( V_1 == V_349 ) )
return 0 ;
