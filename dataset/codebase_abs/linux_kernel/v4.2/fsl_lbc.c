...
V_4 -> V_77 [ 1 ] = F_26 ( V_5 -> V_5 . V_6 , 1 ) ;
if ( V_4 -> V_77 [ 1 ] ) {
V_37 = F_27 ( V_4 -> V_77 [ 1 ] , F_16 ,
V_78 , L_16 , V_4 ) ;
if ( V_37 ) {
F_17 ( & V_5 -> V_5 , L_15 ,
V_4 -> V_77 [ 1 ] ) ;
...
static int F_31 ( struct V_71 * V_82 , T_5 V_83 )
{
struct V_40 * V_41 = F_32 ( & V_82 -> V_5 ) ;
struct V_9 T_3 * V_10 = V_41 -> V_11 ;
V_41 -> V_84 = F_33 ( sizeof( struct V_9 ) , V_73 ) ;
if ( ! V_41 -> V_84 )
return - V_74 ;
F_34 ( V_41 -> V_84 , V_10 , sizeof( struct V_9 ) ) ;
return 0 ;
}
