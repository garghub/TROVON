...
static T_6 F_47 ( struct V_93 * V_93 , struct V_94 * V_95 ,
...
V_106 = F_49 ( L_21 , V_107 ) ;
if ( ! V_106 )
goto V_105;
V_100 = F_49 ( L_22 , V_106 ) ;
if ( ! V_100 )
goto V_105;
V_101 = F_50 ( V_18 , V_15 ) ;
if ( ! V_101 )
goto V_108;
V_109 . V_110 = V_80 ;
V_109 . V_99 = V_81 ;
...
static bool F_59 ( const struct V_113 * V_114 )
{
int V_13 ;
F_60 ( ! V_92 , V_115 L_25 ) ;
for ( V_13 = 0 ; V_13 < F_61 ( V_114 -> V_116 ) ; V_13 ++ ) {
...
static bool F_62 ( const struct V_113 * V_114 )
{
return V_114 -> V_116 [ 0 ] . V_21 == V_117 ;
}
int F_63 ( const struct V_113 * V_33 )
{
int V_35 = 0 ;
...
const struct V_113 * F_64 ( const struct V_113 * V_33 )
{
const struct V_113 * V_22 ;
for ( V_22 = V_33 ; ! F_62 ( V_22 ) ; V_22 ++ )
if ( F_59 ( V_22 ) )
...
bool F_68 ( int V_121 , int * V_129 , int * V_130 , int * V_131 )
{
...
if ( V_132 > 9999 )
V_132 = 0 ;
V_133 = F_69 ( V_3 , & V_137 , 10 ) ;
if ( V_3 == V_137 || * V_137 != '/' || ! V_133 || V_133 > 12 ) {
V_133 = 0 ;
goto V_89;
}
V_3 = V_137 + 1 ;
V_134 = F_69 ( V_3 , & V_137 , 10 ) ;
...
bool F_71 ( enum V_138 V_122 , const char * V_9 )
{
const char * V_76 = F_32 ( V_122 ) ;
if ( V_76 == NULL || V_9 == NULL )
return V_76 == V_9 ;
return ! strcmp ( V_76 , V_9 ) ;
}
void F_72 ( V_46 V_53 , const char * * V_55 , const char * * V_54 )
{
int V_139 ;
if ( V_52 == NULL )
return;
