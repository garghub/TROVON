...
V_1 = ( void * ) V_1 + V_44 ;
F_118 ( V_40 -> V_42 , (struct V_91 * ) V_1 ) ;
}
...
static void F_120 ( struct V_40 * V_40 ,
struct V_12 * V_13 , unsigned long V_51 )
{
#ifdef F_121
...
struct V_12 * V_13 , unsigned long V_51 )
{
F_123 ( V_40 , V_13 , V_51 , 0 ) ;
}
void F_123 ( struct V_40 * V_40 ,
struct V_12 * V_13 , unsigned long V_51 , int V_93 )
{
int V_94 = F_124 ( & V_40 -> V_95 ) ;
if ( V_94 ) {
if ( F_89 ( V_40 ) )
F_125 ( V_40 ,
V_96 ) ;
F_126 ( F_127 ( V_40 ) , V_97 ,
F_128 ( V_40 ) ) ;
}
if ( F_18 ( F_98 ( V_40 ) ) )
return;
F_116 ( ! F_113 ( V_40 ) , V_40 ) ;
if ( V_94 )
F_119 ( V_40 , V_13 , V_51 , V_93 ) ;
else
F_120 ( V_40 , V_13 , V_51 ) ;
}
void F_129 ( struct V_40 * V_40 ,
struct V_12 * V_13 , unsigned long V_51 )
{
F_61 ( V_51 < V_13 -> V_48 || V_51 >= V_13 -> V_52 , V_13 ) ;
F_130 ( V_40 ) ;
...
F_126 ( F_127 ( V_40 ) , V_97 ,
F_128 ( V_40 ) ) ;
F_119 ( V_40 , V_13 , V_51 , 1 ) ;
}
void F_131 ( struct V_40 * V_40 )
{
struct V_78 * V_79 ;
V_79 = F_132 ( V_40 ) ;
if ( F_124 ( & V_40 -> V_95 ) ) {
...
static void F_135 ( struct V_40 * V_40 )
{
struct V_78 * V_79 ;
V_79 = F_132 ( V_40 ) ;
if ( ! F_136 ( - 1 , & V_40 -> V_95 ) )
goto V_45;
if ( F_18 ( F_75 ( V_40 ) ) )
goto V_45;
F_137 ( V_40 , V_98 ) ;
...
static int F_142 ( struct V_40 * V_40 , struct V_12 * V_13 ,
unsigned long V_51 , void * V_66 )
{
struct V_17 * V_18 = V_13 -> V_19 ;
T_7 * V_63 ;
...
T_9 V_89 ;
V_89 = F_156 ( V_40 , F_104 ( V_100 ) ) ;
F_109 ( V_18 , V_51 , V_63 , F_147 ( V_89 ) ) ;
} else
F_146 ( V_18 , V_110 ) ;
F_141 ( V_40 ) ;
F_159 ( V_40 ) ;
...
static bool F_162 ( struct V_12 * V_13 , void * V_66 )
{
return F_161 ( V_13 ) ;
}
...
int F_164 ( struct V_40 * V_40 , enum V_101 V_102 )
{
int V_81 ;
struct V_83 V_84 = {
. V_85 = F_142 ,
...
F_116 ( ! F_113 ( V_40 ) || F_166 ( V_40 ) , V_40 ) ;
V_81 = F_100 ( V_40 , & V_84 ) ;
return V_81 ;
}
...
static struct V_1 * F_167 ( struct V_40 * V_40 ,
struct V_83 * V_84 )
{
struct V_1 * V_1 ;
if ( V_84 -> V_86 )
...
static int F_168 ( struct V_40 * V_40 , struct V_83 * V_84 )
{
struct V_1 * V_1 ;
T_3 V_47 ;
struct V_9 * V_14 ;
...
return V_81 ;
V_47 = F_59 ( V_40 ) ;
F_169 (avc, &anon_vma->rb_root, pgoff, pgoff) {
...
static int F_170 ( struct V_40 * V_40 , struct V_83 * V_84 )
{
...
{
if ( F_18 ( F_98 ( V_40 ) ) )
return F_174 ( V_40 , V_84 ) ;
else if ( F_63 ( V_40 ) )
return F_168 ( V_40 , V_84 ) ;
else
return F_170 ( V_40 , V_84 ) ;
}
static void F_175 ( struct V_40 * V_40 ,
struct V_12 * V_13 , unsigned long V_51 , int V_93 )
{
struct V_1 * V_1 = V_13 -> V_1 ;
F_38 ( ! V_1 ) ;
...
F_38 ( ! F_113 ( V_40 ) ) ;
F_38 ( ! V_1 ) ;
V_94 = F_124 ( & V_40 -> V_95 ) ;
if ( V_94 )
F_175 ( V_40 , V_13 , V_51 , 0 ) ;
}
