...
bool F_56 ( struct V_1 * V_2 , struct V_3 * V_4 )
{
T_2 V_128 = F_57 ( V_2 ) ;
T_2 V_129 ;
if ( V_4 -> V_10 == V_11 )
...
{
while ( V_134 ) {
unsigned V_135 = V_134 * 8 ;
if ( V_135 > 0x1FFFF8 )
V_135 = 0x1FFFF8 ;
V_18 -> V_127 [ V_18 -> V_30 ++ ] = F_8 ( V_120 ,
V_25 , 0 ) ;
V_18 -> V_127 [ V_18 -> V_30 ++ ] = V_135 ;
V_18 -> V_127 [ V_18 -> V_30 ++ ] = 0 ;
V_18 -> V_127 [ V_18 -> V_30 ++ ] = F_14 ( V_133 ) ;
V_18 -> V_127 [ V_18 -> V_30 ++ ] = F_9 ( V_133 ) ;
V_18 -> V_127 [ V_18 -> V_30 ++ ] = F_14 ( V_132 ) ;
V_18 -> V_127 [ V_18 -> V_30 ++ ] = F_9 ( V_132 ) ;
V_132 += V_135 ;
V_133 += V_135 ;
V_134 -= V_135 / 8 ;
}
...
V_25 , 0 ) ;
V_18 -> V_127 [ V_18 -> V_30 ++ ] = V_132 ;
V_18 -> V_127 [ V_18 -> V_30 ++ ] = F_9 ( V_132 ) ;
V_18 -> V_127 [ V_18 -> V_30 ++ ] = V_138 ;
for (; V_138 > 0 ; V_138 -= 2 , -- V_134 , V_132 += 8 ) {
if ( V_137 & V_139 ) {
V_67 = F_62 ( V_2 , V_40 ) ;
} else if ( V_137 & V_140 ) {
V_67 = V_40 ;
...
V_67 = 0 ;
V_18 -> V_127 [ V_18 -> V_30 ++ ] = F_8 ( V_141 , 0 , 0 ) ;
V_18 -> V_127 [ V_18 -> V_30 ++ ] = V_132 ;
V_18 -> V_127 [ V_18 -> V_30 ++ ] = F_9 ( V_132 ) ;
...
unsigned V_142 , T_6 V_143 )
{
T_2 V_19 = ( F_11 ( 0 ) |
F_12 ( 0 ) ) ;
F_7 ( V_4 , F_8 ( V_144 , 0 , 0xf000 ) ) ;
if ( V_142 < 8 ) {
F_7 ( V_4 , ( V_145 + ( V_142 << 2 ) ) >> 2 ) ;
} else {
F_7 ( V_4 , ( V_146 + ( ( V_142 - 8 ) << 2 ) ) >> 2 ) ;
}
F_7 ( V_4 , V_143 >> 12 ) ;
F_7 ( V_4 , F_8 ( V_144 , 0 , 0xf000 ) ) ;
F_7 ( V_4 , V_147 >> 2 ) ;
