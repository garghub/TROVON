...
const struct V_113 * V_114 , unsigned int * V_122 ,
unsigned int * V_123 , unsigned int V_124 [] , void * V_125 [] )
{
struct V_1 * V_1 = F_50 ( V_121 ) ;
unsigned V_44 = V_13 * V_1 -> V_12 * 2 * sizeof( T_3 ) ;
if ( V_121 -> V_126 + * V_122 < 2 )
* V_122 = 2 - V_121 -> V_126 ;
* V_123 = 1 ;
if ( V_114 && V_114 -> V_114 . V_115 . V_117 < V_44 )
return - V_14 ;
V_124 [ 0 ] = V_114 ? V_114 -> V_114 . V_115 . V_117 : V_44 ;
return 0 ;
}
