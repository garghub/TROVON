...
if ( V_6 )
goto V_133;
V_6 = F_37 ( & V_134 , V_110 , V_132 ) ;
if ( V_6 )
goto V_135;
V_6 = F_39 ( & V_136 , V_110 , V_137 ) ;
if ( V_6 )
goto V_138;
V_6 = F_39 ( & V_139 , V_110 , V_137 ) ;
if ( V_6 )
goto V_140;
V_6 = F_37 ( & V_141 , V_110 , V_142 ) ;
if ( V_6 )
goto V_143;
V_6 = F_37 ( & V_144 , V_110 , V_142 ) ;
if ( V_6 )
goto V_145;
V_6 = F_41 ( & V_146 , V_112 , V_147 ,
V_148 ) ;
if ( V_6 )
goto V_149;
V_6 = F_41 ( & V_150 , V_112 , V_147 ,
V_151 ) ;
if ( V_6 )
goto V_152;
V_6 = F_41 ( & V_153 ,
...
goto V_82;
V_155:
F_47 ( & V_150 , V_112 , V_147 ,
V_151 ) ;
V_152:
F_47 ( & V_146 , V_112 , V_147 ,
V_148 ) ;
V_149:
F_43 ( & V_144 , V_110 , V_142 ) ;
V_145:
F_43 ( & V_141 , V_110 , V_142 ) ;
V_143:
F_45 ( & V_139 , V_110 , V_137 ) ;
V_140:
F_45 ( & V_136 , V_110 , V_137 ) ;
V_138:
F_43 ( & V_134 , V_110 , V_132 ) ;
V_135:
...
if ( V_106 == V_137 || V_106 == V_142 )
V_2 -> V_75 = ( 5 * V_32 ) +
sizeof( struct V_157 ) ;
else
V_2 -> V_75 = ( 4 * V_32 ) +
sizeof( struct V_157 ) ;
V_2 -> V_74 = F_52 ( V_2 -> V_75 , V_158 ) ;
if ( ! V_2 -> V_74 )
return - V_159 ;
V_2 -> V_76 = (struct V_157 * ) ( F_53 ( ( T_3 ) V_2 -> V_74 ,
( T_3 ) V_32 ) ) ;
V_2 -> V_62 = (struct V_21 * ) ( ( T_2 * ) V_2 -> V_76 + V_32 ) ;
V_2 -> V_64 = (struct V_21 * ) ( ( T_2 * ) V_2 -> V_62 + V_32 ) ;
if ( V_106 == V_137 || V_106 == V_142 )
V_2 -> V_83 =
(struct V_157 * ) ( ( T_2 * ) V_2 -> V_64 +
V_32 ) ;
V_2 -> V_11 = & V_10 . V_11 ;
...
int F_54 ( struct V_160 * V_161 )
{
F_55 ( F_56 ( V_161 ) ,
sizeof( struct V_162 ) ) ;
return F_51 ( F_57 ( V_161 ) , V_110 ,
V_142 ) ;
}
int F_58 ( struct V_163 * V_161 )
{
F_55 ( V_161 , sizeof( struct V_164 ) ) ;
return F_51 ( F_59 ( V_161 ) , V_110 ,
V_137 ) ;
}
int F_60 ( struct V_160 * V_161 )
{
return F_51 ( F_57 ( V_161 ) , V_110 ,
V_132 ) ;
}
int F_61 ( struct V_160 * V_161 )
{
return F_51 ( F_57 ( V_161 ) , V_110 ,
V_129 ) ;
}
int F_62 ( struct V_160 * V_161 )
{
return F_51 ( F_57 ( V_161 ) , V_110 ,
V_127 ) ;
}
int F_63 ( struct V_160 * V_161 )
{
return F_51 ( F_57 ( V_161 ) , V_112 , V_147 ) ;
}
int F_64 ( struct V_160 * V_161 )
{
return F_51 ( F_57 ( V_161 ) , V_110 ,
V_154 ) ;
}
...
void F_67 ( struct V_163 * V_161 )
{
struct V_1 * V_2 = F_59 ( V_161 ) ;
F_66 ( V_2 -> V_74 ) ;
}
static int F_68 ( struct V_8 * V_9 , const struct V_165 * V_166 )
{
F_4 ( & V_9 -> V_14 , L_28 ,
V_9 -> V_167 , V_9 -> V_168 ) ;
if ( V_10 . V_9 ) {
