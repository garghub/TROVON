...
static inline void *
F_72 ( V_113 V_126 , unsigned V_127 , unsigned V_42 )
{
void * V_30 ;
void T_3 * V_128 = ( void V_117 T_3 * ) ( V_118 ) V_126 ;
V_42 *= V_127 ;
V_30 = F_73 ( V_42 , V_24 | V_129 ) ;
if ( ! V_30 )
V_30 = F_74 ( V_42 ) ;
if ( ! V_30 )
return F_75 ( - V_25 ) ;
if ( F_76 ( V_30 , V_128 , V_42 ) ) {
F_70 ( V_30 ) ;
return F_75 ( - V_122 ) ;
}
return V_30 ;
...
int V_12 = 0 ;
unsigned V_101 ;
V_132 = F_72 ( V_74 -> V_119 , V_74 -> V_133 , sizeof( * V_132 ) ) ;
if ( F_78 ( V_132 ) )
return F_79 ( V_132 ) ;
...
if ( ! V_4 -> V_94 . V_138 ) {
V_12 = F_80 ( & V_4 -> V_7 , 0 , V_4 -> V_7 . V_30 . V_67 ,
& V_4 -> V_94 ) ;
if ( V_12 ) {
...
F_81 ( V_4 , V_134 -> V_137 >> 2 , V_28 ) ;
}
F_70 ( V_132 ) ;
return V_12 ;
}
int
F_82 ( struct V_41 * V_11 , void * V_28 ,
struct V_17 * V_18 )
{
struct V_144 * V_145 = F_83 ( V_18 , V_11 ) ;
struct V_19 * V_20 = V_19 ( V_18 ) ;
struct V_146 * V_147 ;
struct V_5 * V_6 = V_5 ( V_11 ) ;
...
V_149 = F_72 ( V_74 -> V_149 , V_74 -> V_157 , sizeof( * V_149 ) ) ;
if ( F_78 ( V_149 ) )
return F_84 ( V_145 , F_79 ( V_149 ) ) ;
V_7 = F_72 ( V_74 -> V_162 , V_74 -> V_99 , sizeof( * V_7 ) ) ;
if ( F_78 ( V_7 ) ) {
F_70 ( V_149 ) ;
return F_84 ( V_145 , F_79 ( V_7 ) ) ;
}
...
if ( V_98 -> V_164 . V_165 ) {
V_12 = F_85 ( V_98 , V_74 -> V_157 + 1 , 16 ) ;
if ( V_12 ) {
...
F_86 ( V_98 , V_4 , V_149 [ V_101 ] . V_65 ,
V_149 [ V_101 ] . V_166 ) ;
}
} else
if ( V_6 -> V_10 . V_58 . V_167 >= 0x25 ) {
V_12 = F_87 ( V_98 , V_74 -> V_157 * 2 ) ;
if ( V_12 ) {
...
struct V_3 * V_4 = ( void * ) ( unsigned long )
V_7 [ V_149 [ V_101 ] . V_135 ] . V_112 ;
F_88 ( V_98 , ( V_4 -> V_7 . V_65 + V_149 [ V_101 ] . V_65 ) | 2 ) ;
F_88 ( V_98 , 0 ) ;
}
} else {
V_12 = F_87 ( V_98 , V_74 -> V_157 * ( 2 + V_168 ) ) ;
if ( V_12 ) {
...
F_81 ( V_4 , ( V_149 [ V_101 ] . V_65 +
V_149 [ V_101 ] . V_166 - 8 ) / 4 , V_169 ) ;
}
F_88 ( V_98 , 0x20000000 |
...
return F_84 ( V_145 , V_12 ) ;
}
int
F_92 ( struct V_41 * V_11 , void * V_28 ,
struct V_17 * V_18 )
{
...
V_4 = F_2 ( V_2 ) ;
if ( V_174 )
V_12 = F_93 ( V_4 -> V_7 . V_34 , V_176 ) ? 0 : - V_178 ;
else {
long V_179 ;
V_179 = F_94 ( V_4 -> V_7 . V_34 , V_176 , true , 30 * V_180 ) ;
if ( ! V_179 )
V_12 = - V_178 ;
else if ( V_179 > 0 )
V_12 = 0 ;
...
int
F_96 ( struct V_41 * V_11 , void * V_28 ,
struct V_17 * V_18 )
{
