...
static int F_45 ( struct V_35 * V_36 , struct V_14 * V_15 ,
struct V_16 * V_17 , T_2 V_23 ,
T_3 V_44 , int * V_12 )
{
int V_45 = * V_12 , V_21 ;
...
static int F_46 ( struct V_14 * V_15 , T_2 V_23 ,
T_3 * V_34 , T_3 V_62 ,
...
int F_47 ( struct V_14 * V_15 , T_2 V_23 ,
T_3 * V_66 , T_3 V_62 ,
T_2 * V_53 , unsigned * V_63 )
{
int V_21 ;
* V_63 = 0 ;
do {
V_21 = F_46 ( V_15 , V_23 , V_66 , V_62 , & V_23 , V_63 ) ;
if ( ! V_21 )
( * V_63 ) ++ ;
} while ( ! V_21 );
* V_53 = V_23 ;
