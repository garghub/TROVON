...
unsigned int V_38 ;
unsigned int V_37 ;
F_17 ( V_2 -> V_45 , V_43 , V_44 ) ;
V_38 = F_14 ( V_28 , & V_37 , V_30 ) ;
F_18 ( F_19 ( V_43 , V_38 ) , V_2 -> V_46 + V_47 ) ;
if ( V_37 >= 65536 )
V_37 = 0 ;
F_20 ( V_2 -> V_45 , V_43 , V_37 ) ;
}
static void F_21 ( struct V_1 * V_2 , unsigned int V_43 )
{
F_17 ( V_2 -> V_45 , V_43 , V_48 ) ;
}
...
F_18 ( F_51 ( 1 , V_163 ) , V_2 -> V_46 + V_164 ) ;
break;
case V_97 :
V_119 -> V_165 = F_47 ;
break;
...
V_131 ) ;
if ( V_89 -> V_101 == V_98 ) {
F_18 ( F_51 ( 1 , V_173 ) , V_2 -> V_46 + V_164 ) ;
F_16 ( V_2 , 1 , V_174 ,
V_89 -> V_109 ,
V_89 -> V_30 ) ;
}
...
unsigned long V_24 ;
V_224 = F_76 ( V_2 -> V_46 + V_231 ) ;
if ( V_224 == V_232 )
return V_233 ;
F_8 ( & V_7 -> V_122 , V_24 ) ;
V_225 = V_7 -> V_123 & V_224 ;
V_226 = V_7 -> V_123 & ~ V_224 ;
F_18 ( V_226 , V_2 -> V_46 + V_127 ) ;
V_7 -> V_124 = true ;
V_7 -> V_125 = V_126 ;
F_9 ( & V_7 -> V_122 , V_24 ) ;
if ( V_225 & V_120 )
...
static bool F_77 ( const struct V_3 * V_4 ,
struct V_235 * V_235 )
{
...
static const struct V_3 * F_79 ( struct V_235 * V_235 )
{
unsigned int V_86 ;
for ( V_86 = 0 ; V_86 < F_80 ( V_238 ) ; V_86 ++ )
if ( F_77 ( & V_238 [ V_86 ] , V_235 ) )
return & V_238 [ V_86 ] ;
return NULL ;
}
...
if ( V_240 )
return V_240 ;
V_2 -> V_46 = F_87 ( V_235 , 2 ) ;
V_7 -> V_10 = F_87 ( V_235 , 3 ) ;
F_27 ( V_2 -> V_68 ,
L_15 ,
...
V_7 -> V_10 + V_55 ) ;
if ( V_235 -> V_222 ) {
V_240 = F_88 ( V_235 -> V_222 , F_75 , V_250 ,
V_2 -> V_242 , V_2 ) ;
if ( V_240 == 0 )
V_2 -> V_222 = V_235 -> V_222 ;
}
V_2 -> V_45 = F_89 ( V_2 -> V_46 + V_251 ,
0 , V_252 , 0 ) ;
if ( ! V_2 -> V_45 )
return - V_241 ;
V_240 = F_90 ( V_2 , 3 ) ;
...
V_50 = & V_2 -> V_253 [ 2 ] ;
if ( V_4 -> V_184 ) {
V_240 = F_92 ( V_2 , V_50 , NULL , V_274 ) ;
if ( V_240 )
return V_240 ;
} else {
V_50 -> type = V_273 ;
...
static int F_93 ( struct V_235 * V_2 ,
const struct V_275 * V_236 )
{
return F_94 ( V_2 , & V_276 ,
V_236 -> V_277 ) ;
}
