...
static int F_142 ( struct V_81 * V_36 , T_4 V_338 )
{
return 0 ;
}
...
V_342 . V_118 = V_129 -> V_99 ;
V_342 . V_153 = V_343 ;
V_342 . V_43 = F_55 ( V_43 -> V_219 [ V_343 ] . V_344 ) ;
F_37 ( V_345 , & V_342 ) ;
if ( V_10 ) {
F_33 ( V_45 ,
L_53
...
V_342 . V_153 = V_346 ;
V_342 . V_43 = F_55 ( V_43 -> V_219 [ V_346 ] . V_344 ) ;
F_37 ( V_345 , & V_342 ) ;
if ( V_10 ) {
F_33 ( V_45 ,
L_55
...
F_44 ( V_45 , V_90 , L_56 ,
V_43 -> V_219 [ V_343 ] . V_344 ,
V_43 -> V_219 [ V_346 ] . V_344 ) ;
V_247:
return V_10 ;
}
...
struct V_2 * V_3 = V_36 -> V_3 ;
struct V_55 * V_12 = V_3 -> V_12 ;
struct V_349 * V_350 = & V_12 -> V_351 ;
V_348 -> V_352 = V_350 -> V_353 ;
V_348 -> V_354 = V_350 -> V_355 ;
V_348 -> V_356 = V_350 -> V_357 ;
V_348 -> V_358 = V_350 -> V_359 ;
return 0 ;
}
struct V_360 * F_146 ( struct V_2 * V_3 )
{
struct V_360 * V_361 = NULL ;
if ( F_147 ( V_3 -> V_12 ) )
V_361 = (struct V_360 * )
& V_3 -> V_12 -> V_362 . V_363 . V_364 ;
else if ( V_3 -> V_12 -> V_365 . V_366 == V_367 )
V_361 = (struct V_360 * )
& V_3 -> V_12 -> V_362 . V_368 . V_364 ;
else if ( V_3 -> V_12 -> V_365 . V_366 == V_369 )
V_361 = (struct V_360 * )
& V_3 -> V_12 -> V_362 . V_370 . V_364 ;
return V_361 ;
}
static int F_148 ( struct V_81 * V_36 , T_4 * V_371 ,
T_4 * V_372 )
{
struct V_2 * V_3 = V_36 -> V_3 ;
struct V_360 * V_361 = F_146 ( V_3 ) ;
if ( V_361 ) {
* V_371 = V_361 -> V_373 ;
* V_372 = V_361 -> V_374 ;
} else {
