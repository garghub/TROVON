...
static int F_22 ( void * V_65 )
{
int V_66 ;
struct V_1 * V_2 = (struct V_1 * ) V_65 ;
V_66 = F_23 ( V_2 , 4 * 1024 , true ) ;
if ( V_66 )
return V_66 ;
