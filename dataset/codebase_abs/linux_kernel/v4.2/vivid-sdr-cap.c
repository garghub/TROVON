...
{
struct V_1 * V_2 = F_39 ( V_59 ) ;
V_85 -> V_40 . V_88 . V_87 = V_2 -> V_89 ;
V_85 -> V_40 . V_88 . V_90 = V_2 -> V_91 ;
memset ( V_85 -> V_40 . V_88 . V_92 , 0 , sizeof( V_85 -> V_40 . V_88 . V_92 ) ) ;
return 0 ;
}
int F_48 ( struct V_59 * V_59 , void * V_60 , struct V_39 * V_85 )
{
struct V_1 * V_2 = F_39 ( V_59 ) ;
struct V_37 * V_93 = & V_2 -> V_78 ;
int V_94 ;
if ( F_49 ( V_93 ) )
return - V_95 ;
memset ( V_85 -> V_40 . V_88 . V_92 , 0 , sizeof( V_85 -> V_40 . V_88 . V_92 ) ) ;
for ( V_94 = 0 ; V_94 < F_37 ( V_86 ) ; V_94 ++ ) {
if ( V_86 [ V_94 ] . V_87 == V_85 -> V_40 . V_88 . V_87 ) {
V_2 -> V_89 = V_86 [ V_94 ] . V_87 ;
V_2 -> V_91 = V_86 [ V_94 ] . V_90 ;
V_85 -> V_40 . V_88 . V_90 = V_86 [ V_94 ] . V_90 ;
return 0 ;
}
}
V_2 -> V_89 = V_86 [ 0 ] . V_87 ;
V_2 -> V_91 = V_86 [ 0 ] . V_90 ;
V_85 -> V_40 . V_88 . V_87 = V_86 [ 0 ] . V_87 ;
V_85 -> V_40 . V_88 . V_90 = V_86 [ 0 ] . V_90 ;
return 0 ;
}
int F_50 ( struct V_59 * V_59 , void * V_60 , struct V_39 * V_85 )
{
int V_94 ;
memset ( V_85 -> V_40 . V_88 . V_92 , 0 , sizeof( V_85 -> V_40 . V_88 . V_92 ) ) ;
for ( V_94 = 0 ; V_94 < F_37 ( V_86 ) ; V_94 ++ ) {
...
{
T_2 * V_96 = F_51 ( & V_50 -> V_10 , 0 ) ;
unsigned long V_94 ;
unsigned long V_97 = F_23 ( & V_50 -> V_10 , 0 ) ;
T_3 V_98 ;
T_3 V_99 ;
T_3 V_100 ;
T_3 V_101 ;
#define F_52 1000
V_98 = F_53 ( V_102 * F_52 ,
V_2 -> V_33 ) ;
for ( V_94 = 0 ; V_94 < V_97 ; V_94 += 2 ) {
V_99 = F_54 ( V_2 -> V_103 ,
V_102 ) >> ( 31 - V_104 ) ;
V_2 -> V_103 += V_98 ;
V_2 -> V_105 += V_99 / 4 ;
while ( V_2 -> V_105 < V_102 )
V_2 -> V_105 += V_102 ;
while ( V_2 -> V_105 > V_102 )
V_2 -> V_105 -= V_102 ;
while ( V_2 -> V_103 > V_102 )
V_2 -> V_103 -= V_102 ;
V_100 = F_54 ( V_2 -> V_105 , V_102 ) ;
V_101 = F_55 ( V_2 -> V_105 , V_102 ) ;
V_100 >>= ( 31 - V_104 ) ;
V_101 >>= ( 31 - V_104 ) ;
switch ( V_2 -> V_89 ) {
case V_106 :
V_100 = V_100 * 1275 + V_107 * 1275 ;
V_101 = V_101 * 1275 + V_107 * 1275 ;
* V_96 ++ = F_53 ( V_100 , V_107 * 10 ) ;
* V_96 ++ = F_53 ( V_101 , V_107 * 10 ) ;
break;
case V_108 :
V_100 = V_100 * 1275 ;
V_101 = V_101 * 1275 ;
