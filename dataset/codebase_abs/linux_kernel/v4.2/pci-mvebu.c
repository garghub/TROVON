...
static int F_65 ( struct V_77 * V_54 )
{
struct V_110 * V_52 ;
int V_17 ;
V_52 = F_66 ( V_54 ) ;
...
static int F_67 ( struct V_77 * V_54 )
{
struct V_110 * V_52 ;
int V_17 ;
V_52 = F_66 ( V_54 ) ;
...
static int F_68 ( struct V_147 * V_53 )
{
struct V_110 * V_52 ;
struct V_148 * V_149 = V_53 -> V_54 . V_168 ;
struct V_148 * V_170 ;
int V_17 , V_50 ;
V_52 = F_69 ( & V_53 -> V_54 , sizeof( struct V_110 ) ,
V_171 ) ;
if ( ! V_52 )
return - V_172 ;
V_52 -> V_53 = V_53 ;
...
V_52 -> V_120 . V_51 = F_73 ( T_4 ,
V_174 ,
F_40 ( & V_52 -> V_64 ) ) ;
} else
V_52 -> V_120 = V_52 -> V_64 ;
V_50 = F_74 ( V_149 , & V_52 -> V_126 ) ;
if ( V_50 ) {
F_26 ( & V_53 -> V_54 , L_8 ,
V_50 ) ;
return V_50 ;
...
V_17 = 0 ;
F_75 (pdev->dev.of_node, child) {
if ( ! F_76 ( V_170 ) )
continue;
V_17 ++ ;
}
V_52 -> V_115 = F_69 ( & V_53 -> V_54 , V_17 *
sizeof( struct V_1 ) ,
V_171 ) ;
if ( ! V_52 -> V_115 )
return - V_172 ;
...
V_2 -> V_177 = F_81 ( V_170 ,
L_14 , 0 , & V_131 ) ;
if ( F_82 ( V_2 -> V_177 ) ) {
T_1 V_178 = 20000 ;
V_2 -> V_179 = V_131 & V_180 ;
V_2 -> V_181 = F_79 ( V_171 ,
