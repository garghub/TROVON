...
if ( V_83 -> V_69 != 0 )
return - V_65 ;
F_46 ( V_83 -> V_174 , L_26 , sizeof( V_83 -> V_174 ) ) ;
V_83 -> V_175 = V_176 ;
return 0 ;
}
...
struct V_1 * V_2 = V_61 -> V_2 ;
struct V_3 * V_4 = V_2 -> V_4 ;
V_83 -> V_178 . V_179 . V_175 = V_176 ;
V_83 -> V_178 . V_179 . V_180 = 0 ;
V_83 -> V_178 . V_179 . V_181 =
V_2 -> V_182 * V_2 -> V_183 ;
V_83 -> V_178 . V_179 . V_184 = 0 ;
V_83 -> V_178 . V_179 . V_8 = V_2 -> V_8 ;
V_83 -> V_178 . V_179 . V_9 = V_2 -> V_9 ;
F_2 ( V_5 , L_27 ,
V_2 -> V_8 , V_2 -> V_9 ) ;
return 0 ;
}
...
V_83 -> V_178 . V_179 . V_184 = 0 ;
F_2 ( V_5 , L_29 ,
V_83 -> V_178 . V_179 . V_8 , V_83 -> V_178 . V_179 . V_9 , V_83 -> V_178 . V_179 . V_185 ) ;
return 0 ;
}
...
V_189 = ! ! ( V_12 & V_190 ) ;
V_15 -> V_12 = V_12 & ~ V_190 ;
for ( V_33 = 0 ; V_33 < F_22 ( V_191 ) ; V_33 ++ ) {
if ( V_189 ) {
if ( V_15 -> V_12 < V_191 [ V_33 ] )
V_15 -> V_12 = V_191 [ V_33 ] ;
else
continue;
}
if ( V_15 -> V_12 == V_191 [ V_33 ] )
...
V_63 V_205 ;
F_7 ( & V_2 -> V_25 ) ;
if ( ! F_74 ( & V_2 -> V_206 . V_27 ) ) {
V_24 = F_75 ( & V_2 -> V_206 . V_27 ,
struct V_23 , V_27 ) ;
if ( V_207 ) {
V_205 = F_76 ( 0 , V_24 -> V_208 , V_24 -> V_209 ) ;
if ( V_205 != V_24 -> V_205 ) {
F_17 ( V_52
L_48 ,
V_6 ,
V_24 , V_24 -> V_205 , V_205 ) ;
}
}
}
F_13 ( & V_2 -> V_25 ) ;
...
static T_2 F_77 ( struct V_58 * V_58 , char T_3 * V_210 ,
T_4 V_148 , T_5 * V_198 )
{
struct V_60 * V_61 = V_58 -> V_62 ;
struct V_1 * V_2 = V_61 -> V_2 ;
...
V_24 = F_73 ( V_2 ) ;
while ( ( V_148 > 0 ) && V_24 ) {
V_211 = V_24 -> V_209 - V_24 -> V_198 ;
V_212 = V_211 > V_148 ? V_148 : V_211 ;
V_17 = V_24 -> V_208 + V_24 -> V_198 ;
F_2 ( V_5 ,
L_53 ,
V_6 , ( int ) V_148 , V_212 , V_211 , V_24 , V_24 -> V_198 ) ;
if ( F_83 ( V_210 , V_17 , V_212 ) ) {
F_17 ( V_52 L_54 , V_6 ) ;
if ( ! V_119 ) {
F_17 ( V_52 L_55 , V_6 ) ;
V_119 = - V_222 ;
...
static unsigned int F_84 ( struct V_58 * V_58 , T_7 * V_224 )
{
struct V_60 * V_61 =
...
return NULL ;
* V_235 = * V_234 ;
snprintf ( V_235 -> V_70 , sizeof( V_235 -> V_70 ) , L_57 , V_4 -> V_70 ,
type , V_162 [ V_4 -> V_163 ] . V_70 ) ;
V_235 -> V_236 = & V_4 -> V_236 ;
V_235 -> V_237 = V_238 ;
return V_235 ;
}
...
V_2 -> V_7 . V_142 = V_245 ;
V_2 -> V_66 = V_246 ;
if ( V_2 -> V_11 . V_12 & V_247 )
V_2 -> V_9 = 480 ;
else
V_2 -> V_9 = 576 ;
V_2 -> V_229 = F_86 ( V_2 ,
V_4 -> V_165 , & V_248 , L_59 ) ;
if ( ! V_2 -> V_229 ) {
F_17 ( V_249 L_60 ,
V_4 -> V_70 ) ;
V_31 = - V_53 ;
