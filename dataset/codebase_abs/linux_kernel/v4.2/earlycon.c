...
V_11 -> V_29 = V_30 * 16 ;
if ( V_11 -> V_20 )
V_11 -> V_31 = F_1 ( V_11 -> V_20 , 64 ) ;
V_28 . V_32 -> V_33 = & V_28 ;
V_27 = V_26 -> V_34 ( & V_28 , V_24 ) ;
if ( V_27 < 0 )
return V_27 ;
if ( ! V_28 . V_32 -> V_35 )
return - V_36 ;
...
if ( V_37 . V_38 & V_39 )
return - V_40 ;
for ( V_26 = V_41 ; V_26 -> V_42 [ 0 ] ; V_26 ++ ) {
T_3 V_43 = strlen ( V_26 -> V_42 ) ;
if ( strncmp ( V_24 , V_26 -> V_42 , V_43 ) )
continue;
if ( V_24 [ V_43 ] ) {
if ( V_24 [ V_43 ] != ',' )
continue;
...
static int T_2 F_16 ( char * V_24 )
{
int V_27 ;
if ( ! V_24 || ! V_24 [ 0 ] )
return 0 ;
V_27 = F_15 ( V_24 ) ;
if ( V_27 == - V_44 || V_27 == - V_40 )
return 0 ;
return V_27 ;
}
int T_2 F_17 ( unsigned long V_13 ,
int (* V_34)( struct V_7 * , const char * ) )
{
int V_27 ;
struct V_10 * V_11 = & V_28 . V_11 ;
V_11 -> V_14 = V_19 ;
