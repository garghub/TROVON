...
static T_3 F_60 ( const struct V_96 * V_52 )
{
...
case V_105 :
V_10 -> V_63 = V_106 ;
V_10 -> V_26 = F_63 ( V_107 ) ;
break;
case V_108 :
if ( V_99 < 64 ) {
V_10 -> V_63 = F_64 ( V_99 ) ;
V_10 -> V_26 = F_65 ( V_99 , 0 ) ;
break;
}
default:
return V_58 ;
...
if ( V_50 < 0 )
goto V_129;
if ( F_47 ( V_10 -> V_44 , V_123 ) ) {
F_72 ( V_10 ) ;
goto V_129;
}
switch ( F_47 ( V_10 -> V_44 , V_121 ) ) {
case 0 :
F_77 ( V_23 , V_10 ) ;
break;
case V_124 :
...
F_1 ( & V_10 -> V_12 , & V_10 -> V_3 [ V_111 ] ,
V_112 ) ;
V_10 -> V_59 . V_113 = F_69 ;
V_10 -> V_59 . V_114 = F_70 ;
V_10 -> V_59 . V_115 = F_32 ;
V_10 -> V_59 . V_116 = F_33 ;
V_10 -> V_59 . V_117 = F_34 ;
V_10 -> V_59 . V_118 = F_37 ;
