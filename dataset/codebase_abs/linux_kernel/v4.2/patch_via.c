...
if ( F_4 ( V_3 ) == V_8 ) {
F_68 ( V_3 -> V_22 . V_136 ) ;
V_3 -> V_22 . V_136 = F_69 ( L_1 , V_5 ) ;
snprintf ( V_3 -> V_137 -> V_138 ,
sizeof( V_3 -> V_137 -> V_138 ) ,
L_2 , V_3 -> V_22 . V_139 , V_3 -> V_22 . V_136 ) ;
}
if ( V_3 -> V_22 . V_21 == 0x11064397 ) {
F_68 ( V_3 -> V_22 . V_136 ) ;
V_3 -> V_22 . V_136 = F_69 ( L_3 , V_5 ) ;
snprintf ( V_3 -> V_137 -> V_138 ,
sizeof( V_3 -> V_137 -> V_138 ) ,
L_2 , V_3 -> V_22 . V_139 , V_3 -> V_22 . V_136 ) ;
}
...
if ( ! V_4 -> V_6 . V_119 )
return 0 ;
V_142 = F_72 ( V_3 , V_4 -> V_6 . V_119 , V_143 ,
F_60 ( V_143 ) - 1 ) ;
for ( V_85 = 0 ; V_85 < V_142 ; V_85 ++ ) {
if ( F_26 ( F_27 ( V_3 , V_143 [ V_85 ] ) ) == V_144 )
return 0 ;
}
F_25 (nid, codec) {
unsigned int V_145 = F_27 ( V_3 , V_56 ) ;
if ( F_26 ( V_145 ) == V_144 &&
! ( V_145 & V_146 ) ) {
V_143 [ V_142 ++ ] = V_56 ;
return F_73 ( V_3 ,
...
V_49 -> type = V_148 ;
V_49 -> V_149 = 1 ;
V_49 -> V_52 . integer . V_150 = 0 ;
V_49 -> V_52 . integer . V_151 = 1 ;
return 0 ;
}
...
struct V_2 * V_3 = F_16 ( V_47 ) ;
struct V_1 * V_4 = V_3 -> V_4 ;
int V_152 = * V_51 -> V_52 . integer . V_52 ;
F_7 ( V_3 , 0x26 , 0 ,
V_154 , V_152 ) ;
V_4 -> V_155 = V_152 ;
return 1 ;
...
V_4 -> V_105 [ V_4 -> V_104 ++ ] = V_156 ;
V_4 -> V_86 [ V_4 -> V_87 ++ ] = V_157 ;
V_4 -> V_86 [ V_4 -> V_87 ++ ] = V_158 ;
return 0 ;
}
static void F_80 ( struct V_2 * V_3 ,
const struct V_159 * V_160 , int V_93 )
{
if ( V_93 == V_161 )
...
if ( V_4 -> V_7 == V_37 )
V_4 -> V_105 [ V_4 -> V_104 ++ ] = V_166 ;
else
V_4 -> V_105 [ V_4 -> V_104 ++ ] = V_167 ;
return 0 ;
}
