...
int
F_31 ( T_2 V_44 , V_12 * V_45 )
{
int V_46 ;
return F_32 ( & V_44 , 1 , 0 ,
V_45 , & V_46 ) ;
}
int
F_33 ( T_2 V_44 , V_12 * V_45 )
{
int V_46 ;
return F_32 ( & V_44 , 1 , V_47 ,
V_45 , & V_46 ) ;
}
static int
F_34 ( int * V_48 )
...
int
F_32 ( T_2 * V_49 , int V_50 , int V_48 ,
V_12 * V_45 , int * V_46 )
{
int V_51 = 1 ;
int V_29 ;
