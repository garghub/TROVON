...
F_18 ( & V_10 -> V_19 , V_12 + F_11 ( V_28 -> V_41 ) ) ;
F_9 ( V_4 , 0 ) ;
}
...
V_4 -> V_68 = ( V_65 & V_28 -> V_45 ) >> V_28 -> V_36 ;
V_4 -> V_69 = ( V_65 & V_28 -> V_44 ) >> V_28 -> V_34 ;
if ( V_65 )
...
V_93 = F_1 ( V_4 -> V_46 , V_103 ) ;
if ( V_93 & V_104 ) {
V_10 -> V_105 = true ;
V_93 |= V_106 ;
F_5 ( V_4 -> V_46 , V_103 , V_93 ) ;
}
V_63 = F_31 ( V_4 , V_10 ) ;
if ( V_63 )
return V_63 ;
...
struct V_140 * V_141 ;
struct V_25 * V_4 ;
struct V_125 * V_126 = V_11 -> V_7 . V_129 ;
int V_63 , V_93 ;
memset ( V_138 , 0 , sizeof( V_138 ) ) ;
V_139 = F_38 ( V_11 , V_94 , L_24 ) ;
if ( ! V_139 ) {
F_54 ( V_7 , L_25 ) ;
return - V_114 ;
}
V_138 [ 0 ] = * V_139 ;
V_139 = F_38 ( V_11 , V_142 , L_24 ) ;
if ( ! V_139 ) {
F_54 ( V_7 , L_26 ) ;
return - V_114 ;
}
...
V_141 = F_68 ( & V_11 -> V_7 , sizeof( * V_141 ) , V_147 ) ;
if ( ! V_141 ) {
V_63 = - V_82 ;
goto V_75;
}
V_137 . V_141 = V_141 ;
V_137 . V_148 = & V_149 ;
V_141 -> V_150 = F_61 ( V_126 , L_30 ) ;
V_141 -> V_151 = F_61 ( V_126 , L_31 ) ;
V_141 -> V_152 = 1 ;
V_137 . V_107 = F_63 ( V_7 ) ;
V_137 . V_153 = F_61 ( V_126 , L_32 ) / 2 ;
V_63 = F_62 ( V_126 , L_33 , & V_93 ) ;
if ( ! V_63 && V_93 )
V_141 -> V_154 = true ;
V_63 = F_69 ( V_4 , & V_137 , sizeof( V_137 ) ) ;
if ( V_63 ) {
F_54 ( V_7 , L_34 ) ;
goto V_75;
}
...
struct V_9 * V_10 ;
int V_63 ;
if ( ! strcmp ( V_26 -> V_157 , L_27 ) )
return - V_97 ;
V_156 = F_73 ( V_158 , V_26 -> V_7 . V_129 ) ;
if ( ! V_156 ) {
F_54 ( & V_26 -> V_7 , L_36 ) ;
return - V_114 ;
}
V_28 = V_156 -> V_3 ;
if ( F_74 ( V_26 -> V_7 . V_129 , L_37 ) )
V_149 . V_159 = F_58 ;
...
return 0 ;
V_162 = V_4 -> V_30 ;
V_10 -> V_163 . V_98 = F_3 ( V_162 , V_28 -> V_98 ) ;
V_10 -> V_163 . V_65 = F_3 ( V_162 , V_28 -> V_39 ) ;
V_10 -> V_163 . V_164 = F_3 ( V_162 , V_28 -> V_40 ) ;
V_10 -> V_163 . V_101 = F_3 ( V_162 , V_28 -> V_101 ) ;
V_10 -> V_163 . V_107 = F_3 ( V_162 , V_28 -> V_107 ) ;
V_10 -> V_163 . V_165 = F_3 ( V_162 , V_28 -> V_165 ) ;
V_10 -> V_163 . V_166 = F_3 ( V_162 , V_28 -> V_166 ) ;
return 0 ;
}
...
return 0 ;
V_162 = V_4 -> V_30 ;
F_7 ( V_162 , V_28 -> V_98 , V_10 -> V_163 . V_98 ) ;
F_7 ( V_162 , V_28 -> V_39 , V_10 -> V_163 . V_65 ) ;
F_7 ( V_162 , V_28 -> V_40 , V_10 -> V_163 . V_164 ) ;
F_7 ( V_162 , V_28 -> V_101 , V_10 -> V_163 . V_101 ) ;
F_7 ( V_162 , V_28 -> V_107 , V_10 -> V_163 . V_107 ) ;
F_7 ( V_162 , V_28 -> V_165 , V_10 -> V_163 . V_165 ) ;
F_7 ( V_162 , V_28 -> V_166 , V_10 -> V_163 . V_166 ) ;
if ( V_4 -> V_15 -> V_16 -> V_17 == V_54 &&
V_4 -> V_21 == V_22 )
F_18 ( & V_10 -> V_19 , V_12 +
F_11 ( V_28 -> V_41 ) ) ;
