...
static void F_53 ( struct V_102 * V_103 , struct V_84 * V_84 )
{
...
struct V_102 * V_106 ;
struct V_107 * V_107 ;
T_6 V_108 , V_109 , V_110 , V_111 , V_112 ,
V_113 , V_114 ;
char * V_115 ;
...
V_28 = - 1 ;
V_108 = F_63 ( F_64 ( V_27 , & V_115 ) , 1024 * 1024 ) ;
if ( ! V_108 ) {
F_18 ( & V_6 -> V_21 , L_30 ) ;
error = - V_121 ;
goto V_122;
...
V_114 = F_67 ( F_68 ( V_8 -> V_72 ) ) ;
V_28 = F_69 ( V_8 -> V_29 , V_42 ,
V_114 , V_117 ,
V_125 | V_126 |
V_127 ) ;
if ( V_28 ) {
...
V_8 -> V_18 = F_70 ( V_110 , 64 * 1024 ) ;
if ( ! V_8 -> V_18 ) {
F_18 ( & V_6 -> V_21 , L_34 ) ;
error = - V_65 ;
goto V_129;
}
V_8 -> V_1 = F_70 ( V_112 , V_113 ) ;
if ( ! V_8 -> V_1 ) {
F_18 ( & V_6 -> V_21 , L_35 ) ;
error = - V_65 ;
goto V_130;
...
F_77 ( V_107 -> V_144 , V_82 , sizeof( V_107 -> V_144 ) ) ;
F_78 ( V_107 , V_8 -> V_27 >> 9 ) ;
F_32 ( & V_6 -> V_21 , L_39 ,
V_107 -> V_144 , F_79 ( V_107 ) >> 11 ) ;
F_80 ( V_107 ) ;
return 0 ;
V_136:
F_81 ( V_106 ) ;
...
F_86 ( V_6 ) ;
V_120:
F_87 ( ( unsigned long ) V_8 -> V_72 , F_61 ( V_117 ) ) ;
V_118:
F_34 ( V_8 ) ;
F_59 ( V_6 , NULL ) ;
V_116:
