...
static int F_31 ( struct V_119 * V_120 , int V_180 )
{
struct V_105 * V_106 = V_120 -> V_106 ;
int V_135 = V_120 -> V_135 ;
...
static int F_32 ( struct V_163 * V_164 ,
struct V_119 * V_120 )
{
F_33 ( V_164 -> V_181 , 0 ,
V_182 ,
...
static int F_35 ( struct V_187 * V_187 ,
const struct V_188 * V_135 )
{
struct V_108 * V_172 ;
struct V_189 * V_184 = F_36 ( & V_187 -> V_2 ) ;
int V_190 ;
unsigned int V_191 = 0 ;
unsigned int V_3 ;
T_1 V_192 ;
V_172 = F_37 ( & V_187 -> V_2 , sizeof( struct V_108 ) ,
V_193 ) ;
if ( ! V_172 )
return - V_194 ;
V_172 -> V_179 = F_38 ( V_187 , & V_195 ) ;
if ( F_39 ( V_172 -> V_179 ) ) {
V_190 = F_40 ( V_172 -> V_179 ) ;
F_16 ( & V_187 -> V_2 , L_7 , V_190 ) ;
return V_190 ;
}
if ( V_184 ) {
V_172 -> V_184 = * V_184 ;
} else {
V_184 = F_37 ( & V_187 -> V_2 ,
sizeof( struct V_189 ) ,
V_193 ) ;
if ( ! V_184 ) {
F_16 ( & V_187 -> V_2 , L_8 ) ;
...
if ( V_187 -> V_2 . V_196 ) {
if ( F_41 ( V_187 -> V_2 . V_196 ,
L_9 , & V_192 ) >= 0 )
V_184 -> V_185 = V_192 ;
}
V_184 -> V_197 = F_42 ( V_187 -> V_2 . V_196 ,
L_10 , 0 ) ;
V_172 -> V_184 = * V_184 ;
}
F_43 ( V_187 , V_172 ) ;
if ( V_172 -> V_184 . V_197 ) {
V_190 = F_44 ( & V_187 -> V_2 ,
V_172 -> V_184 . V_197 ,
V_198 ,
L_11 ) ;
if ( V_190 < 0 ) {
F_16 ( & V_187 -> V_2 , L_12 ,
V_172 -> V_184 . V_197 , V_190 ) ;
return V_190 ;
}
F_45 ( V_172 -> V_184 . V_197 , 0 ) ;
F_45 ( V_172 -> V_184 . V_197 , 1 ) ;
}
F_46 ( V_172 -> V_179 , true ) ;
V_190 = F_47 ( V_172 -> V_179 , V_6 , & V_3 ) ;
V_191 = ( V_3 & 0xFF ) << 12 ;
V_190 = F_47 ( V_172 -> V_179 , V_7 , & V_3 ) ;
V_191 |= ( V_3 & 0xFF ) << 4 ;
V_190 = F_47 ( V_172 -> V_179 , V_8 , & V_3 ) ;
V_191 |= ( V_3 & 0xF0 ) >> 4 ;
if ( V_191 != V_199 ) {
V_190 = - V_200 ;
F_16 ( & V_187 -> V_2 ,
...
V_190 = F_47 ( V_172 -> V_179 , V_9 , & V_3 ) ;
if ( V_190 < 0 ) {
F_16 ( & V_187 -> V_2 , L_14 ) ;
return V_190 ; ;
}
F_48 ( & V_187 -> V_2 ,
L_15 , V_3 & 0xFF ) ;
F_46 ( V_172 -> V_179 , false ) ;
V_190 = F_49 ( & V_187 -> V_2 ,
& V_201 , V_202 ,
F_10 ( V_202 ) ) ;
if ( V_190 < 0 )
return V_190 ;
...
static int F_50 ( struct V_187 * V_203 )
{
F_51 ( & V_203 -> V_2 ) ;
return 0 ;
}
