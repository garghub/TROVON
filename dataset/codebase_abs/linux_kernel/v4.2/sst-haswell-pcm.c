...
static int F_118 ( struct V_131 * V_27 )
{
struct V_13 * V_14 = F_91 ( V_27 ) ;
struct V_17 * V_18 = V_14 -> V_18 ;
int V_32 ;
...
static void F_122 ( struct V_131 * V_27 )
{
struct V_13 * V_14 = F_91 ( V_27 ) ;
struct V_17 * V_18 = V_14 -> V_18 ;
struct V_15 * V_16 ;
...
if ( ! V_16 -> V_40 )
continue;
V_125 = F_123 ( V_16 -> V_58 ,
& V_16 -> V_158 ) ;
if ( V_125 < 0 )
F_43 ( V_27 , L_24 , V_3 ) ;
}
F_124 ( V_14 -> V_139 -> V_27 ) ;
V_125 = F_120 ( V_18 ) ;
if ( V_125 < 0 )
return;
else if ( V_125 == 1 )
...
static int F_125 ( struct V_131 * V_27 )
{
struct V_13 * V_14 = F_91 ( V_27 ) ;
struct V_15 * V_16 ;
int V_3 , V_125 ;
