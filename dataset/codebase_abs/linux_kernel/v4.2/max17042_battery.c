...
if ( V_91 -> V_224 ) {
V_4 = F_50 ( V_91 -> V_224 , NULL ,
F_34 ,
V_225 | V_226 ,
V_2 -> V_192 -> V_227 -> V_228 , V_2 ) ;
if ( ! V_4 ) {
F_32 ( V_2 -> V_6 , V_100 ,
V_229 ,
V_229 ) ;
...
static int F_53 ( struct V_206 * V_91 )
{
struct V_1 * V_2 = F_54 ( V_91 ) ;
if ( V_91 -> V_224 )
F_55 ( V_91 -> V_224 , V_2 ) ;
F_56 ( V_2 -> V_192 ) ;
return 0 ;
...
static int F_61 ( struct V_198 * V_92 )
{
struct V_1 * V_2 = F_58 ( V_92 ) ;
if ( V_2 -> V_91 -> V_224 ) {
F_62 ( V_2 -> V_91 -> V_224 ) ;
