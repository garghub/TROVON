...
const struct V_39 * V_40 = V_32 -> V_20 ;
T_3 V_41 = V_32 -> V_42 -> V_36 [ V_36 ] ;
struct V_1 V_43 = { . V_16 = { V_47 , V_47 , } , } ;
...
if ( V_55 [ V_67 ] )
* V_56 = F_23 ( V_55 [ V_67 ] ) ;
if ( F_24 ( ! V_55 [ V_21 ] || ! V_55 [ V_22 ] ||
! F_25 ( V_55 , V_23 ) ||
! F_26 ( V_55 , V_68 ) ||
! F_26 ( V_55 , V_27 ) ) )
return - V_69 ;
V_66 = F_27 ( V_55 [ V_21 ] , & V_15 ) ;
if ( V_66 )
return V_66 ;
V_66 = F_27 ( V_55 [ V_22 ] , & V_62 ) ;
if ( V_66 )
return V_66 ;
V_66 = F_28 ( V_32 , V_55 , & V_45 ) ;
if ( V_66 )
return V_66 ;
if ( V_55 [ V_24 ] ) {
V_43 . V_16 [ 0 ] = F_29 ( V_55 [ V_24 ] ) ;
if ( ! V_43 . V_16 [ 0 ] || V_43 . V_16 [ 0 ] > V_47 )
return - V_70 ;
}
if ( V_55 [ V_25 ] ) {
V_43 . V_16 [ 1 ] = F_29 ( V_55 [ V_25 ] ) ;
if ( ! V_43 . V_16 [ 1 ] || V_43 . V_16 [ 1 ] > V_47 )
return - V_70 ;
}
...
if ( ! ( V_65 || V_43 . V_8 == V_73 ) )
V_43 . V_7 = 0 ;
if ( V_55 [ V_27 ] ) {
T_1 V_74 = F_32 ( V_55 [ V_27 ] ) ;
if ( V_74 & V_13 )
V_12 |= ( V_13 << 16 ) ;
}
V_65 = V_65 && V_55 [ V_68 ] ;
...
V_66 = V_41 ( V_32 , & V_43 , & V_45 , & V_45 , V_12 ) ;
return F_34 ( V_66 , V_12 , V_36 , V_32 ) ? - V_66 :
F_35 ( V_66 , V_12 ) ? 0 : V_66 ;
}
V_58 = V_15 ;
if ( V_55 [ V_75 ] ) {
V_66 = F_27 ( V_55 [ V_75 ] , & V_58 ) ;
if ( V_66 )
return V_66 ;
if ( V_15 > V_58 )
F_5 ( V_15 , V_58 ) ;
if ( F_24 ( V_15 + V_77 == V_58 ) )
return - V_78 ;
} else {
...
V_63 = V_62 ;
if ( V_55 [ V_76 ] ) {
V_66 = F_27 ( V_55 [ V_76 ] , & V_63 ) ;
if ( V_66 )
return V_66 ;
if ( V_62 > V_63 )
F_5 ( V_62 , V_63 ) ;
if ( F_24 ( V_62 + V_77 == V_63 ) )
return - V_78 ;
} else {
...
V_59 = F_41 ( V_15 , V_58 , & V_43 . V_16 [ 0 ] ) ;
...
static inline bool
F_43 ( const struct V_79 * V_2 ,
const struct V_79 * V_3 ,
T_1 * V_4 )
{
return F_44 ( & V_2 -> V_15 [ 0 ] . V_80 , & V_3 -> V_15 [ 0 ] . V_80 ) &&
F_44 ( & V_2 -> V_15 [ 1 ] . V_80 , & V_3 -> V_15 [ 1 ] . V_80 ) &&
V_2 -> V_6 == V_3 -> V_6 &&
V_2 -> V_7 == V_3 -> V_7 &&
V_2 -> V_8 == V_3 -> V_8 ;
}
static inline int
F_45 ( const struct V_79 * V_9 )
{
return V_9 -> V_10 ? - V_11 : 1 ;
}
static inline void
F_46 ( struct V_79 * V_9 , T_1 V_12 )
{
V_9 -> V_10 = ! ! ( ( V_12 >> 16 ) & V_13 ) ;
}
static inline void
F_47 ( struct V_79 * V_9 , T_2 * V_12 )
{
F_5 ( * V_12 , V_9 -> V_10 ) ;
}
static inline void
F_48 ( struct V_79 * V_9 ,
struct V_79 * V_14 )
{
V_9 -> V_15 [ 1 ] = V_14 -> V_15 [ 1 ] ;
}
...
{
T_1 V_12 = V_20 -> V_10 ? V_13 : 0 ;
if ( F_52 ( V_19 , V_21 , & V_20 -> V_15 [ 0 ] . V_80 ) ||
F_52 ( V_19 , V_22 , & V_20 -> V_15 [ 1 ] . V_80 ) ||
F_11 ( V_19 , V_23 , V_20 -> V_7 ) ||
F_12 ( V_19 , V_24 , V_20 -> V_16 [ 0 ] ) ||
F_12 ( V_19 , V_25 , V_20 -> V_16 [ 1 ] ) ||
F_12 ( V_19 , V_26 , V_20 -> V_8 ) ||
...
& V_43 . V_7 , & V_43 . V_8 ) )
return - V_50 ;
F_56 ( V_19 , V_38 -> V_12 & V_51 , & V_43 . V_15 [ 0 ] . V_80 ) ;
F_56 ( V_19 , V_38 -> V_12 & V_52 , & V_43 . V_15 [ 1 ] . V_80 ) ;
...
const struct V_39 * V_40 = V_32 -> V_20 ;
T_3 V_41 = V_32 -> V_42 -> V_36 [ V_36 ] ;
struct V_79 V_43 = { . V_16 = { V_47 , V_47 , } , } ;
struct V_44 V_45 = F_22 ( V_32 ) ;
T_1 V_7 , V_61 ;
bool V_65 = false ;
int V_66 ;
...
! F_26 ( V_55 , V_27 ) ) )
return - V_69 ;
if ( F_24 ( V_55 [ V_75 ] || V_55 [ V_76 ] ) )
return - V_81 ;
V_66 = F_58 ( V_55 [ V_21 ] , & V_43 . V_15 [ 0 ] ) ;
if ( V_66 )
return V_66 ;
V_66 = F_58 ( V_55 [ V_22 ] , & V_43 . V_15 [ 1 ] ) ;
if ( V_66 )
return V_66 ;
V_66 = F_28 ( V_32 , V_55 , & V_45 ) ;
if ( V_66 )
