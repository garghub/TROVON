...
return - V_100 ;
if ( ( ( V_148 -> V_176 - V_148 -> V_177 ) >> V_178 ) != 1 )
return - V_100 ;
V_148 -> V_179 |= V_180 | V_181 | V_182 ;
V_148 -> V_183 = & V_184 ;
V_148 -> V_153 = V_156 -> V_158 ;
return 0 ;
}
static int F_118 ( struct V_185 * V_162 , struct V_156 * V_156 )
{
int V_83 = 0 ;
unsigned long V_186 ;
F_69 ( & V_8 . V_9 ) ;
...
V_83 = F_88 ( & V_8 . V_32 , V_8 . V_13 , V_186 , V_187 ) ;
if ( V_83 ) {
...
{
struct V_6 * V_7 ;
struct V_4 * V_189 , * V_22 ;
if ( ! F_17 ( V_5 ) ) {
F_122 (cursor, next, head) {
V_7 = F_12 ( V_189 , struct V_6 , V_16 ) ;
F_13 ( & V_7 -> V_16 ) ;
F_14 ( V_7 ) ;
}
}
}
static int F_123 ( struct V_185 * V_162 , struct V_156 * V_156 )
{
struct V_151 * V_152 = V_156 -> V_158 ;
F_98 ( V_152 -> V_32 ) ;
F_69 ( & V_152 -> V_9 ) ;
...
static int F_124 ( struct V_14 * V_190 )
{
int V_138 = 0 ;
struct V_137 * V_13 = F_125 ( V_190 ) ;
F_18 ( V_190 , L_54 ) ;
F_91 ( & V_8 . V_17 ) ;
F_90 ( & V_8 . V_9 ) ;
V_8 . V_10 = 0 ;
...
if ( V_8 . V_64 < 0 ) {
V_138 = V_8 . V_64 ;
F_7 ( V_190 , L_58 , V_138 ) ;
return V_138 ;
}
V_138 = F_127 ( & V_191 ) ;
if ( V_138 )
F_7 ( V_190 , L_59 , V_138 ) ;
return V_138 ;
}
static int F_128 ( struct V_14 * V_190 )
{
struct V_31 * V_32 ;
F_18 ( V_190 , L_60 ) ;
F_129 ( & V_191 ) ;
