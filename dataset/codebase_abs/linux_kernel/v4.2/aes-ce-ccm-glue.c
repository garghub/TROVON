...
struct V_40 V_31 ;
T_1 V_41 ( 8 ) V_25 [ V_20 ] ;
T_1 V_42 [ V_20 ] ;
T_2 V_28 = V_15 -> V_43 ;
int V_44 ;
V_44 = F_6 ( V_15 , V_25 , V_28 ) ;
if ( V_44 )
return V_44 ;
F_22 ( 6 ) ;
if ( V_15 -> V_24 )
F_10 ( V_15 , V_25 ) ;
memcpy ( V_42 , V_15 -> V_22 , V_20 ) ;
F_23 ( & V_31 , V_15 -> V_45 , V_15 -> V_46 , V_28 ) ;
V_44 = F_24 ( & V_38 , & V_31 , V_18 ,
V_20 ) ;
while ( V_31 . V_47 ) {
T_2 V_48 = V_31 . V_47 % V_20 ;
if ( V_31 . V_47 == V_28 )
V_48 = 0 ;
F_25 ( V_31 . V_45 . V_49 . V_50 , V_31 . V_46 . V_49 . V_50 ,
V_31 . V_47 - V_48 , V_2 -> V_33 ,
F_1 ( V_2 ) , V_25 , V_31 . V_22 ) ;
V_28 -= V_31 . V_47 - V_48 ;
V_44 = F_26 ( & V_38 , & V_31 , V_48 ) ;
}
if ( ! V_44 )
F_27 ( V_25 , V_42 , V_2 -> V_33 , F_1 ( V_2 ) ) ;
F_28 () ;
if ( V_44 )
return V_44 ;
F_29 ( V_25 , V_15 -> V_45 , V_15 -> V_43 ,
F_9 ( V_18 ) , 1 ) ;
return 0 ;
}
...
if ( V_31 . V_47 == V_28 )
V_48 = 0 ;
F_31 ( V_31 . V_45 . V_49 . V_50 , V_31 . V_46 . V_49 . V_50 ,
V_31 . V_47 - V_48 , V_2 -> V_33 ,
F_1 ( V_2 ) , V_25 , V_31 . V_22 ) ;
V_28 -= V_31 . V_47 - V_48 ;
V_44 = F_26 ( & V_38 , & V_31 , V_48 ) ;
...
if ( V_44 )
return V_44 ;
F_29 ( V_42 , V_15 -> V_46 , V_15 -> V_43 - V_13 ,
V_13 , 0 ) ;
if ( memcmp ( V_25 , V_42 , V_13 ) )
return - V_51 ;
return 0 ;
}
