...
V_55 -> V_209 = V_203 ;
V_55 -> V_30 . V_210 = F_138 ( V_3 ) ;
if ( V_3 -> V_76 [ 0 ] != F_48 ||
V_3 -> V_76 [ 1 ] != F_48 )
V_55 -> V_30 . V_211 = true ;
if ( V_3 -> V_212 )
V_55 -> V_30 . V_212 = V_3 -> V_212 [ V_3 -> V_202 ] ;
if ( V_3 -> V_50 & V_213 )
V_55 -> V_30 . V_214 = true ;
if ( V_3 -> V_50 & V_215 ) {
...
int F_139 ( struct V_2 * V_3 , unsigned int V_218 )
{
struct V_54 * V_55 = F_3 ( V_3 ) ;
int V_219 , V_220 , V_35 ;
V_220 = 0 ;
if ( ! V_218 )
V_218 = V_221 ;
for ( V_219 = 0 ; V_219 < V_218 ; V_219 ++ ) {
if ( ( V_55 -> V_222 & ( 1 << V_219 ) ) & V_3 -> V_223 ) {
if ( F_131 ( V_3 , V_219 ) < 0 ) {
F_96 ( V_3 -> V_47 -> V_48 ,
L_13 , V_219 ) ;
V_55 -> V_222 &= ~ ( 1 << V_219 ) ;
F_120 ( V_3 ) ;
...
if ( ( V_55 -> V_222 & ( 1 << V_219 ) ) & V_3 -> V_223 ) {
struct V_117 * V_19 ;
V_35 = F_140 ( & V_3 -> V_55 , V_3 -> V_47 , V_219 , & V_19 ) ;
if ( V_35 < 0 )
continue;
V_19 -> V_224 = F_134 ( V_3 ) ;
V_19 -> V_225 = V_3 -> V_225 ;
V_220 ++ ;
}
}
if ( ! V_220 ) {
...
int V_199 ;
int V_228 [ 2 ] = { 0 , 0 } ;
for ( V_199 = 0 ; V_199 < V_3 -> V_229 ; V_199 ++ ) {
struct V_1 * V_1 = F_80 ( sizeof( * V_1 ) , V_126 ) ;
int V_230 , V_231 ;
if ( ! V_1 )
return - V_127 ;
V_230 = F_144 ( V_3 , V_199 ) ;
if ( V_3 -> V_50 & V_232 )
V_231 = ++ V_228 [ V_230 ] ;
else
V_231 = V_199 + 1 ;
...
struct V_54 * V_55 = F_3 ( V_3 ) ;
struct V_6 * V_7 ;
while ( ! F_148 ( & V_55 -> V_233 ) ) {
V_7 = F_149 ( & V_55 -> V_233 , struct V_6 , V_114 ) ;
F_73 ( & V_7 -> V_114 ) ;
F_74 ( F_4 ( V_7 ) ) ;
}
}
