...
struct V_12 * V_13 = F_4 ( V_2 ) ;
T_1 V_28 ;
if ( V_13 -> V_29 != V_13 -> V_14 -> V_30 ) {
V_13 -> V_29 = V_13 -> V_14 -> V_30 ;
V_28 . V_31 = 0 ;
V_28 . V_21 . V_22 = V_13 -> V_29 ? 1 : 0 ;
V_28 . V_21 . V_25 = V_13 -> V_14 -> V_32 ? 1 : 0 ;
...
{
struct V_12 * V_13 = F_4 ( V_2 ) ;
int V_33 = F_20 ( V_13 -> V_26 ) ;
T_1 V_28 ;
union V_34 V_35 ;
int V_36 = F_21 ( V_13 -> V_26 ) ;
V_35 . V_31 = F_22 ( F_23 ( V_36 , V_33 ) ) ;
V_35 . V_21 . V_37 = 0 ;
F_24 ( F_23 ( V_36 , V_33 ) , V_35 . V_31 ) ;
V_13 -> V_38 = NULL ;
if ( V_13 -> V_14 )
F_25 ( V_13 -> V_14 ) ;
V_13 -> V_14 = NULL ;
...
if ( ! V_40 )
goto V_42;
V_13 -> V_14 = F_28 ( V_2 , V_40 , F_17 , 0 ,
V_43 ) ;
if ( V_13 -> V_14 == NULL )
return - V_44 ;
V_13 -> V_29 = 0 ;
