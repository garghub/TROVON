...
struct V_4 * V_5 = F_4 ( V_12 , struct V_4 , V_12 ) ;
...
static int F_29 ( struct V_22 * V_14 , unsigned int V_39 )
{
...
static void F_35 ( unsigned int V_34 , struct V_46 * V_47 )
{
T_1 V_48 , V_49 ;
unsigned int V_2 ;
struct V_4 * V_5 = F_36 ( V_34 ) ;
...
int V_34 = F_43 ( V_55 , 0 ) ;
struct V_22 * V_14 = F_44 ( V_34 ) ;
if ( ! F_45 ( V_14 ) )
return F_46 ( V_53 ) ;
return 0 ;
}
...
V_5 = F_59 ( & V_55 -> V_53 , sizeof( * V_5 ) , V_62 ) ;
if ( ! V_5 )
return - V_63 ;
V_61 = F_60 ( V_64 , V_55 -> V_53 . V_65 ) ;
if ( ! V_61 ) {
F_61 ( & V_55 -> V_53 , L_2 ) ;
return - V_21 ;
}
V_5 -> V_7 = V_61 -> V_14 ;
F_62 ( V_55 , V_5 ) ;
V_59 = F_63 ( V_55 , V_66 , 0 ) ;
V_5 -> V_15 = F_64 ( & V_55 -> V_53 , V_59 ) ;
if ( F_65 ( V_5 -> V_15 ) )
return F_66 ( V_5 -> V_15 ) ;
V_5 -> V_34 = F_43 ( V_55 , 0 ) ;
if ( V_5 -> V_34 < 0 ) {
F_61 ( & V_55 -> V_53 , L_3 ) ;
return V_5 -> V_34 ;
}
V_12 = & V_5 -> V_12 ;
V_12 -> V_67 = V_5 -> V_7 -> V_67 ;
V_12 -> V_68 = V_69 ;
V_12 -> V_53 = & V_55 -> V_53 ;
V_12 -> V_70 = F_3 ;
V_12 -> V_71 = F_7 ;
...
F_10 ( V_78 , V_5 -> V_15 +
F_18 ( V_2 ) ) ;
V_57 = F_69 ( V_12 , & V_37 , 0 ,
V_38 , V_79 ) ;
if ( V_57 ) {
F_61 ( & V_55 -> V_53 , L_7 ) ;
goto V_80;
}
F_70 ( V_12 , & V_37 , V_5 -> V_34 ,
F_35 ) ;
F_71 ( & V_55 -> V_53 ) ;
F_72 ( & V_55 -> V_53 ) ;
return 0 ;
