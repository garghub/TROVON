...
struct V_68 * V_69 )
{
struct V_70 * V_71 = F_47 ( V_67 ) ;
struct V_32 * V_33 = ( void * ) V_71 -> V_45 ;
struct V_3 * V_4 , * V_63 ;
F_16 ( V_2 , L_18 ,
F_35 ( V_33 -> V_53 ) ,
F_35 ( V_33 -> V_52 ) ) ;
...
static bool F_50 ( struct V_73 * V_74 ,
struct V_70 * V_71 , void * V_45 )
{
struct V_1 * V_2 =
...
struct V_32 * V_75 ;
int V_76 = F_51 ( V_71 ) ;
if ( F_52 ( V_71 -> V_77 . V_69 != V_78 ) )
return true ;
if ( F_29 ( V_76 != sizeof( * V_75 ) ) ) {
F_23 ( V_2 , L_19 ) ;
return true ;
}
V_75 = ( void * ) V_71 -> V_45 ;
if ( F_35 ( V_75 -> V_53 ) != V_4 -> V_9 )
return false ;
F_16 ( V_2 , L_20 ,
V_4 -> V_9 ) ;
if ( ! V_75 -> V_17 )
...
static bool F_53 ( struct V_73 * V_74 ,
struct V_70 * V_71 , void * V_45 )
{
struct V_1 * V_2 =
F_5 ( V_74 , struct V_1 , V_74 ) ;
...
V_75 = ( void * ) V_71 -> V_45 ;
if ( F_29 ( F_35 ( V_75 -> V_10 ) != V_4 -> V_10 ) )
return false ;
V_4 -> V_9 = F_35 ( V_75 -> V_53 ) ;
F_16 ( V_2 , L_23 ,
V_4 -> V_9 ) ;
return true ;
}
...
{
struct V_34 * V_35 = F_26 ( V_6 ) ;
struct V_3 * V_4 = & V_35 -> V_94 ;
const T_2 V_95 [] = { V_78 } ;
struct V_84 V_96 ;
struct V_81 V_97 = {} ;
F_2 ( & V_2 -> V_87 ) ;
if ( V_4 -> V_8 &&
F_61 ( V_4 -> V_58 , F_40 ( V_91 ) ) ) {
F_16 ( V_2 , L_26 ,
F_62 ( V_4 -> V_58 - V_57 ) ) ;
return;
}
...
V_97 . V_52 = F_38 ( V_98 ) ;
V_97 . V_99 =
F_38 ( F_64 ( V_35 -> V_10 , V_35 -> V_100 ) ) ;
V_97 . V_10 = F_38 ( V_101 ) ;
V_97 . V_102 =
F_38 ( F_65 ( V_2 -> V_103 , V_104 ) ) ;
V_97 . V_105 = V_106 ;
V_97 . V_92 = F_38 ( V_92 ) ;
V_97 . V_107 = F_38 ( 1 ) ;
V_97 . V_61 = F_38 ( V_61 ) ;
V_97 . V_108 = 1 ;
V_97 . V_109 = F_66 ( V_55 |
V_56 |
V_110 ) ;
if ( ! V_93 ) {
...
if ( ! F_68 ( V_2 , V_4 , & V_9 ) )
return;
V_112 . V_113 = F_38 ( V_9 ) ;
V_112 . V_52 = F_38 ( V_114 ) ;
V_112 . V_99 =
F_38 ( F_64 ( V_35 -> V_10 , V_35 -> V_100 ) ) ;
F_16 ( V_2 , L_31 ,
F_35 ( V_112 . V_113 ) ) ;
V_86 = F_57 ( V_2 , V_115 , 0 ,
sizeof( V_112 ) , & V_112 ) ;
if ( F_52 ( V_86 ) )
return;
}
...
int F_71 ( struct V_1 * V_2 , struct V_23 * V_6 ,
int V_61 , enum V_116 type )
{
struct V_34 * V_35 = F_26 ( V_6 ) ;
struct V_3 * V_4 = & V_35 -> V_94 ;
struct V_81 V_97 = {} ;
...
V_97 . V_102 = F_38 ( 0 ) ;
V_97 . V_107 = F_38 ( 1 ) ;
V_97 . V_105 = F_74 ( F_75 ( V_61 ) / 50 , V_122 ) ;
V_97 . V_92 = F_38 ( F_75 ( V_61 / 2 ) ) ;
V_97 . V_61 = F_38 ( F_75 ( V_61 ) ) ;
V_97 . V_108 = 1 ;
V_97 . V_109 = F_66 ( V_55 |
V_56 |
V_110 ) ;
