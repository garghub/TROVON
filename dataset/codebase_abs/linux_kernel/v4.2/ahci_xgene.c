...
const struct V_122 * V_123 [] = { & V_124 ,
& V_125 } ;
int V_34 ;
V_18 = F_47 ( V_114 ) ;
if ( F_48 ( V_18 ) )
return F_49 ( V_18 ) ;
V_2 = F_50 ( V_3 , sizeof( * V_2 ) , V_126 ) ;
if ( ! V_2 )
return - V_127 ;
V_18 -> V_33 = V_2 ;
V_2 -> V_18 = V_18 ;
V_2 -> V_3 = V_3 ;
V_116 = F_51 ( V_114 , V_128 , 1 ) ;
V_2 -> V_99 = F_52 ( V_3 , V_116 ) ;
if ( F_48 ( V_2 -> V_99 ) )
return F_49 ( V_2 -> V_99 ) ;
V_116 = F_51 ( V_114 , V_128 , 2 ) ;
V_2 -> V_4 = F_52 ( V_3 , V_116 ) ;
if ( F_48 ( V_2 -> V_4 ) )
return F_49 ( V_2 -> V_4 ) ;
V_116 = F_51 ( V_114 , V_128 , 3 ) ;
V_2 -> V_102 = F_52 ( V_3 , V_116 ) ;
if ( F_48 ( V_2 -> V_102 ) )
return F_49 ( V_2 -> V_102 ) ;
V_116 = F_51 ( V_114 , V_128 , 4 ) ;
if ( V_116 ) {
void T_1 * V_129 = F_52 ( V_3 , V_116 ) ;
if ( F_48 ( V_129 ) )
return F_49 ( V_129 ) ;
V_2 -> V_110 = V_129 ;
}
V_118 = F_53 ( V_130 , V_3 ) ;
if ( V_118 ) {
if ( V_118 -> V_131 )
V_120 = (enum V_119 ) V_118 -> V_131 ;
}
#ifdef F_54
else {
...
struct V_134 * V_135 ;
T_5 V_136 ;
V_133 = F_55 ( V_137 , & V_114 -> V_3 ) ;
if ( ! V_133 ) {
F_34 ( & V_114 -> V_3 , L_7 ) ;
V_120 = V_121 ;
} else if ( V_133 -> V_138 ) {
V_120 = (enum V_119 ) V_133 -> V_138 ;
V_136 = F_56 ( F_57 ( & V_114 -> V_3 ) , & V_135 ) ;
if ( F_58 ( V_136 ) ) {
F_34 ( & V_114 -> V_3 , L_8 ,
V_139 ) ;
V_120 = V_121 ;
...
break;
case V_142 :
V_18 -> V_145 |= V_147 | V_148 ;
break;
default:
break;
}
V_34 = F_63 ( V_114 , V_18 , V_123 [ V_120 - 1 ] ,
& V_149 ) ;
if ( V_34 )
goto V_144;
F_2 ( V_3 , L_12 ) ;
