...
{
struct V_1 * V_1 = F_16 ( V_51 -> V_52 ? V_51 -> V_52 : V_51 -> V_53 ) ;
const struct V_54 * V_41 = V_51 -> V_55 ;
const struct V_56 * V_43 = F_17 ( V_39 ) ;
bool V_13 = true ;
if ( V_41 -> V_44 )
...
{
struct V_1 * V_1 = F_16 ( V_51 -> V_52 ? V_51 -> V_52 : V_51 -> V_53 ) ;
const struct V_40 * V_41 = V_51 -> V_55 ;
const struct V_56 * V_43 ;
const struct V_2 * V_3 = NULL ;
bool V_13 = true ;
if ( V_41 -> V_46 & V_59 )
V_3 = V_51 -> V_52 ;
else if ( V_41 -> V_46 & V_60 )
V_3 = V_51 -> V_53 ;
#if F_19 ( V_61 )
if ( V_51 -> V_62 == V_18 )
...
static int F_20 ( const struct V_63 * V_51 )
{
struct V_40 * V_41 = V_51 -> V_55 ;
if ( V_41 -> V_46 & V_59 &&
V_41 -> V_46 & V_60 ) {
F_21 ( L_1
L_2 ) ;
