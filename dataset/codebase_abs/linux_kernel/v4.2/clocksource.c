...
void F_63 ( struct V_12 * V_13 , T_1 V_75 , T_1 V_76 )
{
T_2 V_77 ;
if ( V_76 ) {
V_77 = V_13 -> V_40 ;
...
F_64 ( V_13 -> V_1 + V_13 -> V_61 < V_13 -> V_1 ,
L_7 ,
V_13 -> V_42 ) ;
F_53 ( V_13 ) ;
F_58 ( L_8 ,
...
int F_65 ( struct V_12 * V_13 , T_1 V_75 , T_1 V_76 )
{
F_63 ( V_13 , V_75 , V_76 ) ;
F_42 ( & V_57 ) ;
F_62 ( V_13 ) ;
...
void F_67 ( struct V_12 * V_13 , int V_54 )
{
F_42 ( & V_57 ) ;
F_41 ( V_13 , V_54 ) ;
F_43 () ;
...
T_6 F_71 ( const char * V_85 , char * V_88 , T_7 V_89 )
{
T_7 V_60 = V_89 ;
if ( ! V_89 || V_89 >= V_90 )
return - V_91 ;
...
static T_6 F_72 ( struct V_81 * V_82 ,
struct V_83 * V_84 ,
const char * V_85 , T_7 V_86 )
{
T_6 V_60 ;
F_42 ( & V_57 ) ;
V_60 = F_71 ( V_85 , V_71 , V_86 ) ;
if ( V_60 >= 0 )
F_43 () ;
F_44 ( & V_57 ) ;
return V_60 ;
...
F_75 ( ( T_6 ) V_87 - V_86 , ( T_6 ) 0 ) ,
L_10 , V_93 -> V_42 ) ;
}
F_44 ( & V_57 ) ;
V_86 += snprintf ( V_85 + V_86 ,
F_75 ( ( T_6 ) V_87 - V_86 , ( T_6 ) 0 ) , L_11 ) ;
return V_86 ;
}
static int T_5 F_76 ( void )
{
int error = F_77 ( & V_94 , NULL ) ;
if ( ! error )
error = F_78 ( & V_95 ) ;
if ( ! error )
error = F_79 (
...
static int T_5 F_80 ( char * V_99 )
{
F_42 ( & V_57 ) ;
if ( V_99 )
F_81 ( V_71 , V_99 , sizeof( V_71 ) ) ;
F_44 ( & V_57 ) ;
return 1 ;
}
static int T_5 F_82 ( char * V_99 )
{
if ( ! strcmp ( V_99 , L_12 ) ) {
F_20 ( L_13 ) ;
return F_80 ( L_14 ) ;
