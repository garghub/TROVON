...
F_77 ( V_12 -> V_34 , F_37 ,
V_12 ) ;
F_78 ( & V_12 -> V_109 , & V_110 ) ;
return 0 ;
}
static int F_79 ( struct V_97 * V_98 )
{
struct V_10 * V_12 = F_80 ( V_98 ) ;
F_81 ( & V_12 -> V_109 ) ;
F_82 ( V_12 -> V_34 , V_111 ) ;
return 0 ;
}
static int F_83 ( struct V_70 * V_23 , unsigned int V_34 ,
T_4 V_7 )
{
...
V_75 -> V_143 = F_98 ( & V_141 , & V_98 -> V_100 , V_75 ) ;
if ( F_73 ( V_75 -> V_143 ) ) {
F_70 ( & V_98 -> V_100 , L_11 ) ;
return F_74 ( V_75 -> V_143 ) ;
}
F_76 ( V_98 , V_75 ) ;
return 0 ;
}
