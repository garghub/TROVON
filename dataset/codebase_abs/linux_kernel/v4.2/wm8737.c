...
struct V_13 * V_14 ;
int V_53 , V_15 ;
V_14 = F_22 ( & V_73 -> V_2 , sizeof( struct V_13 ) ,
V_76 ) ;
if ( V_14 == NULL )
return - V_77 ;
for ( V_15 = 0 ; V_15 < F_6 ( V_14 -> V_60 ) ; V_15 ++ )
V_14 -> V_60 [ V_15 ] . V_78 = V_79 [ V_15 ] ;
V_53 = F_23 ( & V_73 -> V_2 , F_6 ( V_14 -> V_60 ) ,
V_14 -> V_60 ) ;
if ( V_53 != 0 ) {
F_8 ( & V_73 -> V_2 , L_5 , V_53 ) ;
return V_53 ;
}
V_14 -> V_61 = F_24 ( V_73 , & V_80 ) ;
if ( F_25 ( V_14 -> V_61 ) )
return F_26 ( V_14 -> V_61 ) ;
F_27 ( V_73 , V_14 ) ;
V_53 = F_28 ( & V_73 -> V_2 ,
& V_81 , & V_82 , 1 ) ;
return V_53 ;
}
static int F_29 ( struct V_72 * V_83 )
{
F_30 ( & V_83 -> V_2 ) ;
return 0 ;
}
...
struct V_13 * V_14 ;
int V_53 , V_15 ;
V_14 = F_22 ( & V_85 -> V_2 , sizeof( struct V_13 ) ,
V_76 ) ;
if ( V_14 == NULL )
return - V_77 ;
for ( V_15 = 0 ; V_15 < F_6 ( V_14 -> V_60 ) ; V_15 ++ )
V_14 -> V_60 [ V_15 ] . V_78 = V_79 [ V_15 ] ;
V_53 = F_23 ( & V_85 -> V_2 , F_6 ( V_14 -> V_60 ) ,
V_14 -> V_60 ) ;
if ( V_53 != 0 ) {
F_8 ( & V_85 -> V_2 , L_5 , V_53 ) ;
return V_53 ;
}
V_14 -> V_61 = F_32 ( V_85 , & V_80 ) ;
if ( F_25 ( V_14 -> V_61 ) )
return F_26 ( V_14 -> V_61 ) ;
F_33 ( V_85 , V_14 ) ;
V_53 = F_28 ( & V_85 -> V_2 ,
