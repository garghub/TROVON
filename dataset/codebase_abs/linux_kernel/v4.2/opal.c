...
static T_9 F_64 ( struct V_96 * V_97 , struct V_98 * V_99 ,
struct V_100 * V_101 ,
char * V_56 , T_10 V_102 , T_11 V_57 )
{
return F_65 ( V_56 , V_57 , & V_102 , V_101 -> V_103 ,
V_101 -> V_16 ) ;
}
...
if ( ! V_106 )
return;
V_104 = F_68 ( V_106 , L_27 , & V_16 ) ;
if ( ! V_104 || V_16 != 2 * sizeof( T_7 ) )
return;
V_107 . V_103 = F_11 ( F_37 ( V_104 [ 0 ] ) ) ;
V_107 . V_16 = F_37 ( V_104 [ 1 ] ) ;
V_58 = F_69 ( V_93 , & V_107 ) ;
if ( V_58 )
F_63 ( L_28 , V_58 ) ;
}
...
static void F_74 ( struct V_105 * V_112 ,
const char * V_113 )
{
struct V_105 * V_114 ;
F_75 (opal_node, np)
if ( F_76 ( V_114 , V_113 ) )
F_77 ( V_114 , NULL , NULL ) ;
}
...
struct V_121 * F_104 ( void * V_122 ,
unsigned long V_123 )
{
struct V_121 * V_124 , * V_125 = NULL ;
unsigned long V_23 = 0 ;
V_124 = F_105 ( V_126 , V_127 ) ;
if ( ! V_124 )
goto V_128;
V_125 = V_124 ;
while ( V_123 > 0 ) {
T_8 V_6 = F_106 ( V_122 ) << V_129 ;
T_8 V_130 = F_107 ( V_123 , V_126 ) ;
V_124 -> V_15 [ V_23 ] . V_6 = F_38 ( V_6 ) ;
V_124 -> V_15 [ V_23 ] . V_130 = F_38 ( V_130 ) ;
V_23 ++ ;
if ( V_23 >= V_131 ) {
struct V_121 * V_132 ;
V_132 = F_105 ( V_126 , V_127 ) ;
if ( ! V_132 )
goto V_128;
V_124 -> V_130 = F_38 (
V_23 * sizeof( struct V_133 ) + 16 ) ;
V_23 = 0 ;
V_124 -> V_132 = F_38 ( F_26 ( V_132 ) ) ;
V_124 = V_132 ;
}
V_122 += V_130 ;
V_123 -= V_130 ;
}
V_124 -> V_130 = F_38 ( V_23 * sizeof( struct V_133 ) + 16 ) ;
return V_125 ;
V_128:
F_33 ( L_41 , V_44 ) ;
F_108 ( V_125 ) ;
...
void F_108 ( struct V_121 * V_124 )
{
while ( V_124 ) {
T_8 V_132 = F_37 ( V_124 -> V_132 ) ;
F_109 ( V_124 ) ;
if ( V_132 )
V_124 = F_11 ( V_132 ) ;
else
