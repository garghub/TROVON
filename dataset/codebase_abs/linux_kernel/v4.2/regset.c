...
{
struct V_5 * V_6 = & V_2 -> V_7 . V_5 ;
return ( V_10 && V_6 -> V_8 ) ? V_4 -> V_9 : 0 ;
}
int F_3 ( struct V_1 * V_2 , const struct V_3 * V_4 ,
...
F_4 ( V_5 ) ;
F_5 ( V_5 ) ;
return F_6 ( & V_11 , & V_12 , & V_13 , & V_14 ,
& V_5 -> V_16 . V_17 , 0 , - 1 ) ;
}
int F_7 ( struct V_1 * V_2 , const struct V_3 * V_4 ,
unsigned int V_11 , unsigned int V_12 ,
...
int F_10 ( struct V_1 * V_2 , const struct V_3 * V_4 ,
unsigned int V_11 , unsigned int V_12 ,
void * V_13 , void T_1 * V_14 )
{
struct V_5 * V_5 = & V_2 -> V_7 . V_5 ;
...
V_29 , sizeof( V_29 ) ) ;
V_18 = F_6 ( & V_11 , & V_12 , & V_13 , & V_14 , V_22 , 0 , - 1 ) ;
return V_18 ;
}
...
F_8 ( V_5 ) ;
V_22 = & V_5 -> V_16 . V_22 ;
V_18 = F_9 ( & V_11 , & V_12 , & V_13 , & V_14 , V_22 , 0 , - 1 ) ;
V_22 -> V_27 . V_19 &= V_20 ;
V_22 -> V_23 . V_24 &= V_30 ;
memset ( & V_22 -> V_23 . V_31 , 0 , 48 ) ;
return V_18 ;
}
static inline unsigned short F_12 ( unsigned short V_32 )
{
unsigned int V_33 ;
V_33 = ~ V_32 ;
...
static inline T_2 F_13 ( struct V_34 * V_17 )
{
struct V_35 * V_36 ;
...
void
F_15 ( struct V_47 * V_48 , struct V_1 * V_49 )
{
...
int F_20 ( struct V_1 * V_2 , const struct V_3 * V_4 ,
unsigned int V_11 , unsigned int V_12 ,
void * V_13 , void T_1 * V_14 )
{
struct V_5 * V_5 = & V_2 -> V_7 . V_5 ;
...
F_15 ( & V_48 , V_2 ) ;
return F_6 ( & V_11 , & V_12 , & V_13 , & V_14 , & V_48 , 0 , - 1 ) ;
}
...
if ( ! V_10 )
return F_9 ( & V_11 , & V_12 , & V_13 , & V_14 ,
& V_5 -> V_16 . V_67 , 0 ,
- 1 ) ;
if ( V_11 > 0 || V_12 < sizeof( V_48 ) )
F_15 ( & V_48 , V_2 ) ;
V_18 = F_9 ( & V_11 , & V_12 , & V_13 , & V_14 , & V_48 , 0 , - 1 ) ;
if ( ! V_18 )
F_19 ( V_2 , & V_48 ) ;
if ( V_21 )
