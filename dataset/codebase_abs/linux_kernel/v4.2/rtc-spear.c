...
int V_14 = 0 ;
int V_17 ;
V_2 = F_25 ( & V_59 -> V_36 , sizeof( * V_2 ) , V_62 ) ;
if ( ! V_2 )
return - V_63 ;
V_17 = F_26 ( V_59 , 0 ) ;
if ( V_17 < 0 ) {
...
V_14 = F_28 ( & V_59 -> V_36 , V_17 , F_11 , 0 , V_59 -> V_64 ,
V_2 ) ;
if ( V_14 ) {
F_27 ( & V_59 -> V_36 , L_2 ,
V_17 ) ;
...
V_61 = F_29 ( V_59 , V_65 , 0 ) ;
V_2 -> V_6 = F_30 ( & V_59 -> V_36 , V_61 ) ;
if ( F_31 ( V_2 -> V_6 ) )
return F_32 ( V_2 -> V_6 ) ;
V_2 -> V_66 = F_33 ( & V_59 -> V_36 , NULL ) ;
if ( F_31 ( V_2 -> V_66 ) )
return F_32 ( V_2 -> V_66 ) ;
V_14 = F_34 ( V_2 -> V_66 ) ;
if ( V_14 < 0 )
return V_14 ;
F_35 ( & V_2 -> V_5 ) ;
F_36 ( V_59 , V_2 ) ;
V_2 -> V_23 = F_37 ( & V_59 -> V_36 , V_59 -> V_64 ,
& V_67 , V_68 ) ;
if ( F_31 ( V_2 -> V_23 ) ) {
F_27 ( & V_59 -> V_36 , L_3 ,
F_32 ( V_2 -> V_23 ) ) ;
