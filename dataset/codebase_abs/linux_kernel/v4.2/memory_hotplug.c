...
static int F_97 ( unsigned long V_26 , unsigned long V_44 ,
void * V_91 )
{
unsigned long V_30 ;
...
static bool F_99 ( struct V_47 * V_47 )
{
return true ;
}
static bool F_99 ( struct V_47 * V_47 )
{
return F_100 ( F_80 ( V_47 ) , V_93 ) ;
}
static void F_101 ( unsigned long V_44 ,
...
if ( V_97 == V_93 )
V_95 = V_98 ;
if ( F_55 ( V_47 ) <= V_95 && ! F_100 ( V_60 , V_93 ) )
V_91 -> V_99 = V_60 ;
else
V_91 -> V_99 = - 1 ;
#ifdef F_102
...
if ( V_97 == V_101 )
V_95 = V_98 ;
if ( F_55 ( V_47 ) <= V_95 && ! F_100 ( V_60 , V_101 ) )
V_91 -> V_102 = V_60 ;
else
V_91 -> V_102 = - 1 ;
#else
...
static void F_103 ( int V_45 , struct V_94 * V_91 )
{
if ( V_91 -> V_99 >= 0 )
F_104 ( V_45 , V_93 ) ;
if ( V_91 -> V_102 >= 0 )
...
int T_3 F_105 ( unsigned long V_42 , unsigned long V_44 , int V_104 )
{
unsigned long V_14 ;
...
static T_6 T_3 * F_118 ( int V_60 , T_1 V_8 )
{
struct V_40 * V_41 ;
unsigned long V_116 [ V_50 ] = { 0 } ;
unsigned long V_117 [ V_50 ] = { 0 } ;
unsigned long V_26 = F_119 ( V_8 ) ;
V_41 = F_120 ( V_60 ) ;
if ( ! V_41 ) {
V_41 = F_121 ( V_60 ) ;
if ( ! V_41 )
...
static void F_125 ( int V_60 , T_6 * V_41 )
{
F_122 ( V_60 , NULL ) ;
F_126 ( V_41 ) ;
return;
...
static int F_132 ( T_1 V_8 , T_1 V_9 )
{
T_1 V_26 = F_119 ( V_8 ) ;
T_1 V_44 = V_9 >> V_36 ;
if ( ( V_26 & ~ V_83 ) ||
...
static int F_133 ( int V_60 , T_1 V_8 , T_1 V_9 )
{
...
int F_134 ( int V_60 , T_1 V_8 , T_1 V_9 , int V_125 )
{
if ( F_133 ( V_60 , V_8 , V_9 ) )
return V_98 ;
return V_125 ;
}
int T_3 F_135 ( int V_60 , T_1 V_8 , T_1 V_9 )
{
T_6 * V_41 = NULL ;
bool V_126 ;
bool V_127 ;
...
static inline int F_139 ( struct V_19 * V_19 )
{
return F_140 ( V_19 ) && F_141 ( V_19 ) >= V_128 ;
}
static struct V_19 * F_142 ( struct V_19 * V_19 )
{
F_19 ( F_143 ( V_19 ) & ( V_129 - 1 ) ) ;
if ( F_139 ( V_19 ) ) {
int V_130 ;
V_130 = F_141 ( V_19 ) ;
...
int F_144 ( unsigned long V_26 , unsigned long V_44 )
{
struct V_19 * V_19 = F_57 ( V_26 ) ;
struct V_19 * V_132 = V_19 + V_44 ;
for (; V_19 < V_132 ; V_19 = F_142 ( V_19 ) ) {
if ( ! F_145 ( V_19 ) )
return 0 ;
F_146 () ;
}
...
int F_147 ( unsigned long V_26 , unsigned long V_43 )
{
unsigned long V_42 ;
...
V_42 += V_133 ) {
V_30 = 0 ;
while ( ( V_30 < V_133 ) && ! F_148 ( V_42 + V_30 ) )
V_30 ++ ;
if ( V_30 == V_133 )
continue;
V_19 = F_57 ( V_42 + V_30 ) ;
...
static unsigned long F_149 ( unsigned long V_8 , unsigned long V_13 )
{
unsigned long V_42 ;
struct V_19 * V_19 ;
...
static int
F_155 ( unsigned long V_26 , unsigned long V_43 )
{
unsigned long V_42 ;
struct V_19 * V_19 ;
int V_134 = V_135 ;
...
int V_66 = 0 ;
F_156 ( V_137 ) ;
for ( V_42 = V_26 ; V_42 < V_43 && V_134 > 0 ; V_42 ++ ) {
if ( ! F_41 ( V_42 ) )
continue;
V_19 = F_57 ( V_42 ) ;
if ( F_151 ( V_19 ) ) {
struct V_19 * V_138 = F_157 ( V_19 ) ;
V_42 = F_143 ( V_138 ) + ( 1 << F_154 ( V_138 ) ) - 1 ;
if ( F_154 ( V_138 ) > V_139 ) {
V_66 = - V_140 ;
break;
}
if ( F_158 ( V_19 , & V_137 ) )
...
static int
F_171 ( unsigned long V_8 , unsigned long V_44 ,
void * V_146 )
{
F_172 ( V_8 , V_8 + V_44 ) ;
return 0 ;
...
{
F_109 ( V_26 , V_43 - V_26 , NULL ,
F_171 ) ;
}
static int
F_174 ( unsigned long V_26 , unsigned long V_44 ,
void * V_146 )
{
int V_66 ;
long V_147 = * ( long * ) V_146 ;
V_66 = F_175 ( V_26 , V_26 + V_44 , true ) ;
V_147 = V_44 ;
if ( ! V_66 )
* ( long * ) V_146 += V_147 ;
return V_66 ;
...
long V_147 = 0 ;
int V_66 ;
V_66 = F_109 ( V_26 , V_43 - V_26 , & V_147 ,
F_174 ) ;
if ( V_66 < 0 )
V_147 = ( long ) V_66 ;
return V_147 ;
}
static bool F_177 ( struct V_47 * V_47 , unsigned long V_44 )
{
return true ;
}
static bool F_177 ( struct V_47 * V_47 , unsigned long V_44 )
...
V_112 += V_41 -> V_49 [ V_148 ] . V_112 ;
if ( V_112 > V_44 )
return true ;
V_112 = 0 ;
for (; V_148 <= V_98 ; V_148 ++ )
V_112 += V_41 -> V_49 [ V_148 ] . V_112 ;
return V_112 == 0 ;
}
static int T_7 F_178 ( char * V_79 )
{
#ifdef F_179
F_180 ( true ) ;
V_149 = true ;
...
static void F_181 ( unsigned long V_44 ,
struct V_47 * V_47 , struct V_94 * V_91 )
{
struct V_40 * V_41 = V_47 -> V_61 ;
unsigned long V_112 = 0 ;
enum V_58 V_148 , V_95 = V_96 ;
if ( V_97 == V_93 )
V_95 = V_98 ;
for ( V_148 = 0 ; V_148 <= V_95 ; V_148 ++ )
V_112 += V_41 -> V_49 [ V_148 ] . V_112 ;
...
static void F_182 ( int V_45 , struct V_94 * V_91 )
{
if ( V_91 -> V_99 >= 0 )
F_183 ( V_45 , V_93 ) ;
if ( ( V_97 != V_93 ) &&
...
static int T_3 F_184 ( unsigned long V_26 ,
...
V_45 = F_80 ( V_47 ) ;
V_44 = V_43 - V_26 ;
if ( F_55 ( V_47 ) <= V_96 && ! F_177 ( V_47 , V_44 ) )
return - V_81 ;
V_66 = F_186 ( V_26 , V_43 ,
V_155 , true ) ;
if ( V_66 )
return V_66 ;
V_91 . V_26 = V_26 ;
V_91 . V_44 = V_44 ;
F_181 ( V_44 , V_47 , & V_91 ) ;
V_66 = V_94 ( V_156 , & V_91 ) ;
V_66 = F_106 ( V_66 ) ;
if ( V_66 )
goto V_157;
V_42 = V_26 ;
...
V_42 = F_149 ( V_26 , V_43 ) ;
if ( V_42 ) {
V_66 = F_155 ( V_42 , V_43 ) ;
if ( ! V_66 ) {
V_153 = 1 ;
goto V_159;
} else {
...
F_190 ( V_47 ) ;
F_192 ( V_26 , V_43 ) ;
V_152 = F_176 ( V_26 , V_43 ) ;
if ( V_152 < 0 ) {
V_66 = - V_140 ;
goto V_157;
}
F_111 ( V_162 L_10 , V_152 ) ;
F_173 ( V_26 , V_43 ) ;
F_193 ( V_26 , V_43 , V_155 ) ;
F_94 ( F_57 ( V_26 ) , - V_152 ) ;
V_47 -> V_112 -= V_152 ;
F_61 ( V_47 -> V_61 , & V_14 ) ;
V_47 -> V_61 -> V_113 -= V_152 ;
F_62 ( V_47 -> V_61 , & V_14 ) ;
F_113 () ;
if ( ! F_107 ( V_47 ) ) {
F_110 ( V_47 ) ;
...
int F_195 ( unsigned long V_26 , unsigned long V_44 )
{
return F_184 ( V_26 , V_26 + V_44 , 120 * V_165 ) ;
}
int F_196 ( unsigned long V_26 , unsigned long V_43 ,
void * V_91 , int (* F_197)( struct V_166 * , void * ) )
{
...
( V_29 <= V_167 -> V_170 ) )
continue;
V_167 = F_199 ( V_168 , V_167 ) ;
if ( ! V_167 )
continue;
V_66 = F_197 ( V_167 , V_91 ) ;
if ( V_66 ) {
F_200 ( & V_167 -> V_171 . V_172 ) ;
return V_66 ;
}
}
if ( V_167 )
...
static int F_201 ( struct V_166 * V_167 , void * V_91 )
{
int V_66 = ! F_202 ( V_167 ) ;
if ( F_8 ( V_66 ) ) {
T_8 V_173 , V_174 ;
V_173 = F_203 ( F_73 ( V_167 -> V_169 ) ) ;
V_174 = F_203 ( F_73 ( V_167 -> V_170 + 1 ) ) - 1 ;
F_89 ( L_12
L_13 ,
& V_173 , & V_174 ) ;
}
...
int V_175 ;
F_205 (cpu) {
if ( F_206 ( V_175 ) == V_41 -> V_46 )
return - V_140 ;
}
return 0 ;
}
static void F_207 ( T_6 * V_41 )
{
#ifdef F_208
int V_175 ;
F_209 (cpu)
...
void T_3 F_217 ( int V_60 , T_1 V_8 , T_1 V_9 )
{
int V_66 ;
F_19 ( F_132 ( V_8 , V_9 ) ) ;
F_11 () ;
V_66 = F_196 ( F_119 ( V_8 ) , F_218 ( V_8 + V_9 - 1 ) , NULL ,
F_201 ) ;
if ( V_66 )
F_219 () ;
F_220 ( V_8 , V_8 + V_9 , L_1 ) ;
F_221 ( V_8 , V_9 ) ;
F_222 ( V_8 , V_9 ) ;
F_223 ( V_8 , V_9 ) ;
F_212 ( V_60 ) ;
