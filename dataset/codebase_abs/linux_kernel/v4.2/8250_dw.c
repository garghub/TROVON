...
static bool F_42 ( struct V_43 * V_44 , void * V_45 )
{
struct V_84 * V_34 = V_45 ;
if ( V_34 != V_44 -> V_84 -> V_34 -> V_85 )
return false ;
return true ;
}
...
V_2 -> V_66 = F_13 ;
V_2 -> V_21 = 2 ;
if ( F_44 ( F_45 ( V_16 -> V_31 . V_34 ) ,
V_86 , L_11 ) ) {
V_59 -> V_73 . V_87 = V_16 -> V_31 . V_34 -> V_85 ;
V_59 -> V_73 . V_88 = V_16 -> V_31 . V_34 -> V_85 ;
V_59 -> V_73 . V_89 = F_42 ;
}
V_16 -> V_73 = & V_59 -> V_73 ;
V_16 -> V_73 -> V_74 . V_75 = V_2 -> V_53 / 4 ;
...
{
struct V_15 V_93 = {} ;
struct V_94 * V_95 = F_47 ( V_92 , V_86 , 0 ) ;
int V_96 = F_48 ( V_92 , 0 ) ;
struct V_5 * V_59 ;
int V_97 ;
if ( ! V_95 ) {
F_39 ( & V_92 -> V_34 , L_12 ) ;
...
F_49 ( & V_93 . V_31 . V_99 ) ;
V_93 . V_31 . V_100 = V_95 -> V_101 ;
V_93 . V_31 . V_96 = V_96 ;
V_93 . V_31 . V_102 = F_17 ;
V_93 . V_31 . V_103 = F_19 ;
V_93 . V_31 . type = V_104 ;
V_93 . V_31 . V_51 = V_68 | V_105 | V_106 ;
V_93 . V_31 . V_34 = & V_92 -> V_34 ;
V_93 . V_31 . V_20 = F_50 ( & V_92 -> V_34 , V_95 -> V_101 ,
F_51 ( V_95 ) ) ;
if ( ! V_93 . V_31 . V_20 )
return - V_107 ;
V_59 = F_52 ( & V_92 -> V_34 , sizeof( * V_59 ) , V_108 ) ;
if ( ! V_59 )
return - V_107 ;
V_59 -> V_30 = V_109 ;
F_53 ( & V_92 -> V_34 , L_14 ,
& V_93 . V_31 . V_42 ) ;
V_59 -> V_40 = F_54 ( & V_92 -> V_34 , L_15 ) ;
if ( F_25 ( V_59 -> V_40 ) && F_55 ( V_59 -> V_40 ) != - V_98 )
V_59 -> V_40 = F_54 ( & V_92 -> V_34 , NULL ) ;
if ( F_25 ( V_59 -> V_40 ) && F_55 ( V_59 -> V_40 ) == - V_98 )
return - V_98 ;
if ( ! F_56 ( V_59 -> V_40 ) ) {
V_97 = F_29 ( V_59 -> V_40 ) ;
...
V_93 . V_31 . V_42 = F_58 ( V_59 -> V_40 ) ;
}
if ( ! V_93 . V_31 . V_42 ) {
F_39 ( & V_92 -> V_34 , L_17 ) ;
return - V_72 ;
}
V_59 -> V_110 = F_54 ( & V_92 -> V_34 , L_18 ) ;
if ( F_25 ( V_59 -> V_40 ) && F_55 ( V_59 -> V_40 ) == - V_98 ) {
V_97 = - V_98 ;
goto V_111;
}
...
V_59 -> V_112 = F_59 ( & V_92 -> V_34 , NULL ) ;
if ( F_25 ( V_59 -> V_112 ) && F_55 ( V_59 -> V_112 ) == - V_98 ) {
V_97 = - V_98 ;
goto V_113;
}
if ( ! F_25 ( V_59 -> V_112 ) )
...
V_59 -> V_73 . V_88 = V_59 ;
V_59 -> V_73 . V_89 = F_31 ;
V_93 . V_31 . V_70 = V_114 ;
V_93 . V_31 . V_17 = F_7 ;
V_93 . V_31 . V_66 = F_5 ;
V_93 . V_31 . V_7 = V_59 ;
if ( V_92 -> V_34 . V_62 ) {
V_97 = F_35 ( & V_93 . V_31 , V_59 ) ;
if ( V_97 )
goto V_115;
} else if ( F_61 ( & V_92 -> V_34 ) ) {
V_97 = F_43 ( & V_93 , V_59 ) ;
if ( V_97 )
goto V_115;
} else {
...
static int F_77 ( struct V_84 * V_34 )
{
struct V_5 * V_59 = F_73 ( V_34 ) ;
if ( ! F_25 ( V_59 -> V_40 ) )
F_26 ( V_59 -> V_40 ) ;
