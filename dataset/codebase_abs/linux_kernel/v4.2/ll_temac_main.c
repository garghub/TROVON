...
V_127 = V_126 -> V_49 ;
while ( V_127 & V_128 ) {
F_24 ( V_27 -> V_25 . V_33 , V_126 -> V_35 , V_126 -> V_48 ,
V_129 ) ;
if ( V_126 -> V_130 )
F_52 ( (struct V_42 * ) V_126 -> V_130 ) ;
V_126 -> V_49 = 0 ;
V_126 -> V_131 = 0 ;
V_126 -> V_132 = 0 ;
V_126 -> V_133 = 0 ;
...
static inline int F_54 ( struct V_1 * V_2 , int V_137 )
{
struct V_125 * V_126 ;
int V_138 ;
V_138 = V_2 -> V_62 ;
...
static int F_55 ( struct V_42 * V_43 , struct V_26 * V_27 )
{
struct V_1 * V_2 = F_23 ( V_27 ) ;
struct V_125 * V_126 ;
T_2 V_140 , V_141 ;
...
unsigned long V_137 ;
T_3 * V_143 ;
V_137 = F_56 ( V_43 ) -> V_144 ;
V_143 = & F_56 ( V_43 ) -> V_145 [ 0 ] ;
...
V_126 -> V_49 |= V_151 ;
V_126 -> V_48 = F_60 ( V_43 ) ;
V_126 -> V_35 = F_32 ( V_27 -> V_25 . V_33 , V_43 -> V_47 ,
F_60 ( V_43 ) , V_129 ) ;
...
V_2 -> V_62 = 0 ;
V_126 = & V_2 -> V_39 [ V_2 -> V_62 ] ;
V_126 -> V_35 = F_32 ( V_27 -> V_25 . V_33 ,
F_61 ( V_143 ) ,
F_62 ( V_143 ) , V_129 ) ;
V_126 -> V_48 = F_62 ( V_143 ) ;
V_126 -> V_49 = 0 ;
V_143 ++ ;
}
V_126 -> V_49 |= V_152 ;
...
F_24 ( V_27 -> V_25 . V_33 , V_126 -> V_35 , V_157 ,
V_37 ) ;
F_66 ( V_43 , V_157 ) ;
V_43 -> V_159 = F_67 ( V_43 , V_27 ) ;
F_68 ( V_43 ) ;
if ( ( ( V_2 -> V_160 & V_161 ) != 0 ) &&
( V_43 -> V_159 == F_69 ( V_162 ) ) &&
( V_43 -> V_48 > 64 ) ) {
...
V_126 -> V_49 = V_50 ;
V_126 -> V_35 = F_32 ( V_27 -> V_25 . V_33 , V_155 -> V_47 ,
V_36 ,
V_37 ) ;
V_126 -> V_48 = V_36 ;
...
F_21 ( & V_27 -> V_25 , L_11 ) ;
if ( V_2 -> V_176 ) {
V_2 -> V_110 = F_76 ( V_2 -> V_27 , V_2 -> V_176 ,
F_49 , 0 , 0 ) ;
if ( ! V_2 -> V_110 ) {
F_48 ( V_2 -> V_25 , L_12 ) ;
return - V_177 ;
...
F_46 ( V_27 ) ;
V_175 = F_78 ( V_2 -> V_178 , F_73 , 0 , V_27 -> V_179 , V_27 ) ;
if ( V_175 )
goto V_180;
V_175 = F_78 ( V_2 -> V_181 , F_74 , 0 , V_27 -> V_179 , V_27 ) ;
if ( V_175 )
goto V_182;
return 0 ;
V_182:
...
static int F_85 ( struct V_26 * V_27 , struct V_183 * V_184 , int V_185 )
{
struct V_1 * V_2 = F_23 ( V_27 ) ;
if ( ! F_86 ( V_27 ) )
return - V_186 ;
if ( ! V_2 -> V_110 )
return - V_186 ;
return F_87 ( V_2 -> V_110 , V_184 , V_185 ) ;
}
static T_5 F_88 ( struct V_187 * V_25 ,
struct V_188 * V_189 , char * V_190 )
{
struct V_26 * V_27 = F_89 ( V_25 ) ;
struct V_1 * V_2 = F_23 ( V_27 ) ;
int V_28 , V_48 = 0 ;
...
{
struct V_1 * V_2 = F_23 ( V_27 ) ;
return F_91 ( V_2 -> V_110 , V_185 ) ;
}
static int F_92 ( struct V_26 * V_27 , struct V_191 * V_185 )
{
struct V_1 * V_2 = F_23 ( V_27 ) ;
return F_93 ( V_2 -> V_110 , V_185 ) ;
}
static int F_94 ( struct V_26 * V_27 )
{
struct V_1 * V_2 = F_23 ( V_27 ) ;
return F_95 ( V_2 -> V_110 ) ;
}
...
V_2 -> V_160 = 0 ;
V_71 = ( T_6 * ) F_103 ( V_19 -> V_25 . V_201 , L_19 , NULL ) ;
if ( V_71 && F_104 ( * V_71 ) ) {
V_2 -> V_160 |= V_203 ;
V_27 -> V_194 |= V_204 ;
}
V_71 = ( T_6 * ) F_103 ( V_19 -> V_25 . V_201 , L_20 , NULL ) ;
if ( V_71 && F_104 ( * V_71 ) )
V_2 -> V_160 |= V_161 ;
V_21 = F_105 ( V_19 -> V_25 . V_201 , L_21 , 0 ) ;
if ( ! V_21 ) {
F_48 ( & V_19 -> V_25 , L_22 ) ;
V_175 = - V_177 ;
goto V_205;
...
V_73 = F_103 ( V_19 -> V_25 . V_201 , L_26 , & V_192 ) ;
if ( ( ! V_73 ) || ( V_192 != 6 ) ) {
F_48 ( & V_19 -> V_25 , L_27 ) ;
V_175 = - V_177 ;
goto V_206;
...
F_36 ( V_27 , ( void * ) V_73 ) ;
V_175 = F_108 ( V_2 , V_19 -> V_25 . V_201 ) ;
if ( V_175 )
F_109 ( & V_19 -> V_25 , L_28 ) ;
V_2 -> V_176 = F_105 ( V_19 -> V_25 . V_201 , L_29 , 0 ) ;
if ( V_2 -> V_176 )
F_21 ( V_2 -> V_25 , L_30 , V_21 -> V_207 , V_21 ) ;
V_175 = F_110 ( & V_2 -> V_25 -> V_208 , & V_209 ) ;
if ( V_175 ) {
F_48 ( V_2 -> V_25 , L_31 ) ;
goto V_206;
}
