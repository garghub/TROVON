...
V_214 = F_73 ( & V_217 , V_215 , & V_3 -> V_229 -> V_230 ) ;
if ( V_214 ) {
F_4 ( V_3 , L_22 , V_215 ) ;
goto V_228;
}
V_5 = F_74 ( V_217 -> V_231 , V_217 -> V_232 , V_82 ) ;
if ( V_5 == NULL )
goto V_228;
memset ( V_8 , 0 , sizeof( struct V_7 ) ) ;
V_8 -> V_65 = F_21 ( V_66 ) ;
V_8 -> V_17 = V_217 -> V_232 ;
V_8 -> V_67 = 0x00 ;
V_8 -> V_69 [ 0 ] = 0xEF ;
V_12 = F_2 ( V_3 , V_70 , V_5 , 0 ) ;
V_37 -> V_218 = V_213 ;
...
F_77 ( V_238 L_23 ) ;
F_44 ( V_3 ) ;
V_234 = F_31 ( V_119 , V_82 ) ;
V_235 = F_31 ( V_119 , V_82 ) ;
...
switch ( F_35 ( V_3 , V_233 , 0 , ( T_2 * ) V_234 , & V_179 ) ) {
case V_161 :
break;
case V_186 :
break;
...
if ( ( V_179 . V_91 & V_183 ) == V_240 )
continue;
if ( ( ( V_179 . V_93 & V_241 ) == V_242 ) ||
( F_38 ( ( (struct V_120 * ) V_234 ) -> V_243 . V_244 ) != V_245 ) ||
( F_38 ( ( (struct V_120 * ) V_234 ) -> V_243 . V_246 ) != V_247 ) ||
( ( (struct V_120 * ) V_234 ) -> V_243 . V_248 != V_249 ) )
continue;
if ( V_201 != V_83 ) {
V_236 = V_233 ;
break;
...
V_201 = V_233 ;
memcpy ( V_235 , V_234 , V_119 ) ;
if ( V_179 . V_89 & ( V_250 | V_251 | V_252 ) )
V_237 = 1 ;
}
if ( V_201 == V_83 ) {
V_12 = V_164 ;
...
if ( ( V_179 . V_110 & V_253 ) == V_254 )
F_39 ( V_37 , V_255 ) ;
V_12 = V_164 ;
if ( V_237 == 0 )
V_12 = F_37 ( V_3 , V_201 , V_235 ) ;
if ( V_12 && ( V_236 != V_83 ) )
V_12 = F_37 ( V_3 , V_236 , V_234 ) ;
if ( V_12 ) {
V_12 = V_164 ;
goto exit;
}
for ( V_233 = 0 ; V_233 < V_201 ; V_233 ++ )
V_37 -> V_73 . V_76 [ V_233 ] = V_79 ;
V_37 -> V_73 . V_76 [ V_201 ] = V_80 ;
if ( V_236 != V_83 ) {
for ( V_233 = V_201 + 1 ; V_233 < V_236 ; V_233 ++ )
V_37 -> V_73 . V_76 [ V_233 ] = V_79 ;
V_37 -> V_73 . V_76 [ V_236 ] = V_80 ;
}
V_12 = F_66 ( V_3 , V_201 ) ;
if ( V_12 )
goto exit;
for ( V_233 = V_99 ;
V_233 < V_37 -> V_73 . V_75 ;
V_233 += V_99 ) {
if ( F_34 ( V_3 , V_233 ) == 0 ) {
F_39 ( V_37 , V_255 ) ;
break;
...
V_37 -> V_195 = * (struct V_259 * ) & V_5 [ 0 ] ;
if ( V_37 -> V_195 . V_39 && V_37 -> V_195 . V_40 ) {
F_77 ( V_238 L_28 , V_37 -> V_195 . V_39 ) ;
F_77 ( V_238 L_29 , V_37 -> V_195 . V_40 ) ;
F_77 ( V_238 L_30 , V_37 -> V_195 . V_196 ) ;
F_77 ( V_238 L_31 , V_37 -> V_195 . V_260 ) ;
F_77 ( V_238 L_32 , V_37 -> V_195 . V_44 ) ;
if ( V_37 -> V_195 . V_196 ) {
V_256 = ( V_5 [ 6 ] << 8 ) | V_5 [ 7 ] ;
V_257 = ( V_5 [ 10 ] << 8 ) | V_5 [ 11 ] ;
V_37 -> V_197 = V_256 * V_257 ;
} else {
F_76 ( V_3 ) ;
}
F_4 ( V_3 , L_33 ) ;
...
V_37 -> V_38 = * (struct V_261 * ) & V_5 [ 0 ] ;
if ( V_37 -> V_38 . V_39 && V_37 -> V_38 . V_40 ) {
struct V_261 * V_262 = & V_37 -> V_38 ;
F_72 ( V_3 , ( unsigned char * ) & V_5 ) ;
F_4 ( V_3 , L_28 , V_262 -> V_39 ) ;
F_4 ( V_3 , L_29 , V_262 -> V_40 ) ;
F_4 ( V_3 , L_39 , V_262 -> V_51 ) ;
F_4 ( V_3 , L_40 , V_262 -> V_50 ) ;
F_4 ( V_3 , L_41 , V_262 -> V_263 ) ;
F_4 ( V_3 , L_42 , V_262 -> V_44 ) ;
} else {
F_4 ( V_3 , L_43 , V_5 [ 0 ] ) ;
return V_21 ;
}
...
static int F_80 ( struct V_2 * V_3 , struct V_35 * V_25 )
{
int V_12 ;
struct V_36 * V_37 = (struct V_36 * ) V_3 -> V_1 ;
V_37 -> V_266 = V_267 ;
...
static int F_81 ( struct V_35 * V_25 , struct V_2 * V_3 )
{
int V_12 = 0 ;
struct V_36 * V_37 = (struct V_36 * ) ( V_3 -> V_1 ) ;
F_9 ( V_25 , 0 ) ;
if ( F_82 ( ! ( V_37 -> V_38 . V_40 || V_37 -> V_195 . V_40 ) ) ) {
V_12 = F_78 ( V_3 ) ;
} else {
if ( V_37 -> V_38 . V_40 )
V_12 = F_79 ( V_3 , V_25 ) ;
...
T_1 V_264 = 0 ;
struct V_2 * V_3 ;
V_12 = F_84 ( & V_3 , V_277 , V_279 ,
( V_279 - V_280 ) + V_281 ,
& V_282 ) ;
if ( V_12 )
return V_12 ;
if ( ! V_3 -> V_1 ) {
V_3 -> V_1 = F_85 ( sizeof( struct V_36 ) , V_82 ) ;
if ( ! V_3 -> V_1 )
return - V_283 ;
V_3 -> V_284 = F_1 ;
}
...
F_91 ( & V_3 -> V_290 ) ;
V_37 -> V_293 = true ;
V_37 -> V_38 = * (struct V_261 * ) & V_289 ;
V_37 -> V_195 = * (struct V_259 * ) & V_289 ;
V_37 -> V_294 = * (struct V_295 * ) & V_289 ;
return 0 ;
}
