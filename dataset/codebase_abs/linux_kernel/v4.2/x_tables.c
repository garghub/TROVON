...
struct V_102 * F_53 ( struct V_103 * V_103 , T_1 V_3 ,
const char * V_13 )
{
struct V_102 * V_22 ;
F_2 ( & V_5 [ V_3 ] . V_6 ) ;
...
unsigned int V_28 ;
int V_99 ;
V_9 -> V_101 = F_58 (unsigned int) ;
if ( V_9 -> V_101 == NULL )
return - V_59 ;
V_28 = sizeof( void * * ) * V_105 ;
if ( V_28 > V_94 )
V_9 -> V_100 = F_59 ( V_28 ) ;
else
V_9 -> V_100 = F_60 ( V_28 , V_96 ) ;
if ( V_9 -> V_100 == NULL )
return - V_59 ;
V_9 -> V_106 *= V_107 ;
V_28 = sizeof( void * ) * V_9 -> V_106 ;
F_50 (cpu) {
if ( V_28 > V_94 )
V_9 -> V_100 [ V_99 ] = F_61 ( V_28 ,
F_62 ( V_99 ) ) ;
else
V_9 -> V_100 [ V_99 ] = F_63 ( V_28 ,
V_96 , F_62 ( V_99 ) ) ;
...
struct V_102 * F_73 ( struct V_103 * V_103 ,
...
int V_42 ;
struct V_89 * V_110 ;
struct V_102 * V_22 , * V_45 ;
V_45 = F_74 ( V_119 , sizeof( struct V_102 ) , V_96 ) ;
if ( ! V_45 ) {
V_42 = - V_59 ;
goto V_121;
}
...
V_45 -> V_110 = V_120 ;
if ( ! F_64 ( V_45 , 0 , V_109 , & V_42 ) )
goto V_123;
V_110 = V_45 -> V_110 ;
F_66 ( L_24 , V_110 -> V_57 ) ;
V_110 -> V_112 = V_110 -> V_57 ;
F_3 ( & V_45 -> V_7 , & V_103 -> V_5 . V_124 [ V_45 -> V_3 ] ) ;
F_4 ( & V_5 [ V_45 -> V_3 ] . V_6 ) ;
return V_45 ;
V_123:
F_4 ( & V_5 [ V_45 -> V_3 ] . V_6 ) ;
...
static void * F_77 ( struct V_125 * V_126 , T_7 * V_127 )
{
struct V_128 * V_129 = V_126 -> V_110 ;
struct V_103 * V_103 = F_78 ( V_126 ) ;
T_1 V_3 = V_129 -> V_3 ;
F_2 ( & V_5 [ V_3 ] . V_6 ) ;
return F_79 ( & V_103 -> V_5 . V_124 [ V_3 ] , * V_127 ) ;
}
static void * F_80 ( struct V_125 * V_126 , void * V_130 , T_7 * V_127 )
{
struct V_128 * V_129 = V_126 -> V_110 ;
struct V_103 * V_103 = F_78 ( V_126 ) ;
T_1 V_3 = V_129 -> V_3 ;
return F_81 ( V_130 , & V_103 -> V_5 . V_124 [ V_3 ] , V_127 ) ;
}
static void F_82 ( struct V_125 * V_126 , void * V_130 )
{
struct V_128 * V_129 = V_126 -> V_110 ;
T_1 V_3 = V_129 -> V_3 ;
F_4 ( & V_5 [ V_3 ] . V_6 ) ;
}
static int F_83 ( struct V_125 * V_126 , void * V_130 )
{
struct V_102 * V_45 = F_84 ( V_130 , struct V_102 , V_7 ) ;
if ( * V_45 -> V_13 )
F_85 ( V_126 , L_25 , V_45 -> V_13 ) ;
return 0 ;
}
...
int V_42 ;
struct V_128 * V_129 ;
V_42 = F_87 ( V_131 , V_132 , & V_133 ,
sizeof( struct V_128 ) ) ;
if ( ! V_42 ) {
V_129 = ( (struct V_125 * ) V_132 -> V_134 ) -> V_110 ;
V_129 -> V_3 = ( unsigned long ) F_88 ( V_131 ) ;
}
return V_42 ;
}
static void * F_89 ( struct V_125 * V_126 , void * V_130 , T_7 * V_135 ,
bool V_136 )
{
...
struct V_141 * V_142 = V_126 -> V_110 ;
switch ( V_142 -> V_143 ) {
case V_144 :
V_142 -> V_143 = V_138 ;
F_2 ( & V_5 [ V_19 ] . V_6 ) ;
...
break;
F_4 ( & V_5 [ V_19 ] . V_6 ) ;
F_2 ( & V_5 [ V_142 -> V_20 ] . V_6 ) ;
V_142 -> V_145 = V_142 -> V_146 = V_136 ?
& V_5 [ V_142 -> V_20 ] . V_2 : & V_5 [ V_142 -> V_20 ] . V_12 ;
...
if ( F_89 ( V_126 , NULL , NULL , V_136 ) == NULL )
return NULL ;
return V_142 ;
}
static void F_91 ( struct V_125 * V_126 , void * V_130 )
{
struct V_141 * V_142 = V_126 -> V_110 ;
switch ( V_142 -> V_143 ) {
case V_138 :
...
break;
case V_139 :
F_4 ( & V_5 [ V_142 -> V_20 ] . V_6 ) ;
break;
}
}
static void * F_92 ( struct V_125 * V_126 , T_7 * V_127 )
{
return F_90 ( V_126 , V_127 , false ) ;
}
static void * F_93 ( struct V_125 * V_126 , void * V_130 , T_7 * V_135 )
{
return F_89 ( V_126 , V_130 , V_135 , false ) ;
}
static int F_94 ( struct V_125 * V_126 , void * V_130 )
{
const struct V_141 * V_142 = V_126 -> V_110 ;
...
if ( V_142 -> V_146 == V_142 -> V_145 )
return 0 ;
V_12 = F_84 ( V_142 -> V_146 , struct V_11 , V_7 ) ;
if ( * V_12 -> V_13 )
F_85 ( V_126 , L_25 , V_12 -> V_13 ) ;
}
return 0 ;
}
static int F_95 ( struct V_131 * V_131 , struct V_132 * V_132 )
{
struct V_141 * V_142 ;
V_142 = F_96 ( V_132 , & V_149 , sizeof( * V_142 ) ) ;
if ( ! V_142 )
return - V_59 ;
V_142 -> V_20 = ( unsigned long ) F_88 ( V_131 ) ;
return 0 ;
}
static void * F_97 ( struct V_125 * V_126 , T_7 * V_127 )
{
return F_90 ( V_126 , V_127 , true ) ;
}
static void * F_98 ( struct V_125 * V_126 , void * V_130 , T_7 * V_135 )
{
return F_89 ( V_126 , V_130 , V_135 , true ) ;
}
static int F_99 ( struct V_125 * V_126 , void * V_130 )
{
const struct V_141 * V_142 = V_126 -> V_110 ;
...
if ( V_142 -> V_146 == V_142 -> V_145 )
return 0 ;
V_2 = F_84 ( V_142 -> V_146 , struct V_1 , V_7 ) ;
if ( * V_2 -> V_13 )
F_85 ( V_126 , L_25 , V_2 -> V_13 ) ;
}
return 0 ;
}
static int F_100 ( struct V_131 * V_131 , struct V_132 * V_132 )
{
struct V_141 * V_142 ;
V_142 = F_96 ( V_132 , & V_150 , sizeof( * V_142 ) ) ;
if ( ! V_142 )
return - V_59 ;
V_142 -> V_20 = ( unsigned long ) F_88 ( V_131 ) ;
return 0 ;
}
struct V_151 * F_101 ( const struct V_102 * V_45 , T_8 * V_152 )
{
unsigned int V_47 = V_45 -> V_153 ;
T_3 V_9 , V_154 = F_102 ( V_47 ) ;
T_3 V_155 ;
struct V_151 * V_156 ;
int V_42 ;
V_156 = F_48 ( sizeof( * V_156 ) * V_154 , V_96 ) ;
if ( V_156 == NULL )
return F_16 ( - V_59 ) ;
for ( V_9 = 0 , V_155 = 0 ; V_9 < V_154 && V_47 != 0 ;
V_47 >>= 1 , ++ V_155 ) {
if ( ! ( V_47 & 1 ) )
continue;
V_156 [ V_9 ] . V_157 = V_152 ;
V_156 [ V_9 ] . V_158 = V_45 -> V_17 ;
V_156 [ V_9 ] . V_159 = V_45 -> V_3 ;
V_156 [ V_9 ] . V_155 = V_155 ;
V_156 [ V_9 ] . V_160 = V_45 -> V_160 ;
++ V_9 ;
}
V_42 = F_103 ( V_156 , V_154 ) ;
if ( V_42 < 0 ) {
F_75 ( V_156 ) ;
return F_16 ( V_42 ) ;
}
...
void F_104 ( const struct V_102 * V_45 , struct V_151 * V_156 )
{
F_105 ( V_156 , F_102 ( V_45 -> V_153 ) ) ;
F_75 ( V_156 ) ;
}
int F_106 ( struct V_103 * V_103 , T_1 V_3 )
{
#ifdef F_107
char V_27 [ V_161 ] ;
struct V_162 * V_163 ;
...
V_163 = F_110 ( V_27 , 0440 , V_103 -> V_165 , & V_166 ,
( void * ) ( unsigned long ) V_3 ) ;
if ( ! V_163 )
goto V_121;
F_108 ( V_27 , V_21 [ V_3 ] , sizeof( V_27 ) ) ;
F_109 ( V_27 , V_167 , sizeof( V_27 ) ) ;
V_163 = F_110 ( V_27 , 0440 , V_103 -> V_165 , & V_168 ,
( void * ) ( unsigned long ) V_3 ) ;
if ( ! V_163 )
goto V_169;
F_108 ( V_27 , V_21 [ V_3 ] , sizeof( V_27 ) ) ;
F_109 ( V_27 , V_170 , sizeof( V_27 ) ) ;
V_163 = F_110 ( V_27 , 0440 , V_103 -> V_165 , & V_171 ,
( void * ) ( unsigned long ) V_3 ) ;
if ( ! V_163 )
goto V_172;
#endif
...
void F_112 ( struct V_103 * V_103 , T_1 V_3 )
{
#ifdef F_107
char V_27 [ V_161 ] ;
F_108 ( V_27 , V_21 [ V_3 ] , sizeof( V_27 ) ) ;
...
static int T_9 F_113 ( struct V_103 * V_103 )
{
int V_9 ;
for ( V_9 = 0 ; V_9 < V_173 ; V_9 ++ )
F_114 ( & V_103 -> V_5 . V_124 [ V_9 ] ) ;
return 0 ;
}
