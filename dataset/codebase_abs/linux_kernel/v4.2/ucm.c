...
return - V_133 ;
if ( V_197 . V_130 >= F_77 ( V_198 ) )
return - V_9 ;
if ( V_197 . V_199 + sizeof( V_197 ) > V_164 )
return - V_9 ;
V_122 = V_198 [ V_197 . V_130 ] ( V_3 , V_194 + sizeof( V_197 ) ,
V_197 . V_199 , V_197 . V_156 ) ;
if ( ! V_122 )
V_122 = V_164 ;
return V_122 ;
}
static unsigned int F_78 ( struct V_3 * V_134 ,
struct V_200 * V_201 )
{
struct V_2 * V_3 = V_134 -> V_115 ;
unsigned int V_202 = 0 ;
V_125 ( V_134 , & V_3 -> V_125 , V_201 ) ;
if ( ! F_13 ( & V_3 -> V_19 ) )
V_202 = V_203 | V_204 ;
return V_202 ;
}
static int F_79 ( struct V_205 * V_205 , struct V_3 * V_134 )
{
struct V_2 * V_3 ;
...
V_134 -> V_115 = V_3 ;
V_3 -> V_134 = V_134 ;
V_3 -> V_143 = F_82 ( V_205 -> V_206 , struct V_207 , V_208 ) ;
return F_83 ( V_205 , V_134 ) ;
}
static int F_84 ( struct V_205 * V_205 , struct V_3 * V_134 )
{
struct V_2 * V_3 = V_134 -> V_115 ;
struct V_1 * V_5 ;
F_2 ( & V_3 -> V_17 ) ;
...
static void F_85 ( struct V_143 * V_209 )
{
struct V_207 * V_210 ;
V_210 = F_82 ( V_209 , struct V_207 , V_209 ) ;
F_86 ( & V_210 -> V_208 ) ;
if ( V_210 -> V_211 < V_212 )
F_87 ( V_210 -> V_211 , V_213 ) ;
else
F_87 ( V_210 -> V_211 - V_212 , V_214 ) ;
F_16 ( V_210 ) ;
}
static T_1 F_88 ( struct V_143 * V_209 , struct V_215 * V_216 ,
char * V_194 )
{
struct V_207 * V_210 ;
V_210 = F_82 ( V_209 , struct V_207 , V_209 ) ;
return sprintf ( V_194 , L_1 , V_210 -> V_144 -> V_217 ) ;
}
static int F_89 ( void )
{
int V_218 ;
if ( ! V_219 ) {
V_218 = F_90 ( & V_219 , 0 , V_212 ,
L_2 ) ;
if ( V_218 ) {
F_91 ( V_220 L_3 ) ;
return V_218 ;
...
V_218 = F_92 ( V_214 , V_212 ) ;
if ( V_218 >= V_212 )
return - 1 ;
return V_218 ;
}
static void F_93 ( struct V_221 * V_143 )
{
int V_211 ;
T_9 V_222 ;
struct V_207 * V_210 ;
if ( ! V_143 -> V_223 || ! F_94 ( V_143 , 1 ) )
return;
V_210 = F_18 ( sizeof *V_210 , V_24 ) ;
if ( ! V_210 )
return;
V_210 -> V_144 = V_143 ;
V_211 = F_92 ( V_213 , V_212 ) ;
if ( V_211 >= V_212 ) {
V_211 = F_89 () ;
if ( V_211 < 0 )
goto V_224;
...
F_96 ( & V_210 -> V_208 , & V_226 ) ;
V_210 -> V_208 . V_227 = V_228 ;
F_97 ( & V_210 -> V_208 . V_229 , L_4 , V_210 -> V_211 ) ;
if ( F_98 ( & V_210 -> V_208 , V_222 , 1 ) )
goto V_224;
V_210 -> V_209 . V_230 = & V_231 ;
V_210 -> V_209 . V_232 = V_143 -> V_233 ;
V_210 -> V_209 . V_234 = V_210 -> V_208 . V_209 ;
V_210 -> V_209 . V_235 = F_85 ;
F_99 ( & V_210 -> V_209 , L_4 , V_210 -> V_211 ) ;
if ( F_100 ( & V_210 -> V_209 ) )
goto V_236;
if ( F_101 ( & V_210 -> V_209 , & V_237 ) )
goto V_238;
F_102 ( V_143 , & V_239 , V_210 ) ;
return;
V_238:
F_103 ( & V_210 -> V_209 ) ;
V_236:
...
static void F_104 ( struct V_221 * V_143 )
{
struct V_207 * V_210 = F_105 ( V_143 , & V_239 ) ;
if ( ! V_210 )
return;
F_103 ( & V_210 -> V_209 ) ;
}
...
{
int V_218 ;
V_218 = F_107 ( V_225 , V_212 ,
L_2 ) ;
if ( V_218 ) {
F_91 ( V_220 L_5 ) ;
goto V_240;
}
V_218 = F_108 ( & V_231 , & V_241 . V_216 ) ;
if ( V_218 ) {
F_91 ( V_220 L_6 ) ;
goto V_242;
}
