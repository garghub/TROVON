...
F_32 ( & V_62 ) ;
if ( V_62 . V_79 < 0 ) {
F_19 ( V_17 -> V_2 , L_18 , V_62 . V_79 ) ;
goto V_71;
}
F_6 ( V_17 -> V_2 , L_19 ) ;
if ( V_17 -> V_80 == - 1 )
goto V_71;
F_33 ( & V_60 -> V_76 . V_81 . V_82 ) ;
V_60 -> V_76 . V_81 . V_80 = V_17 -> V_80 ++ ;
V_60 -> V_76 . V_81 . V_83 = V_84 ;
F_34 ( & V_60 -> V_76 , V_85 ) ;
F_6 ( V_17 -> V_2 , L_20 ) ;
return;
V_71:
...
F_56 ( & V_17 -> V_130 , V_17 ) ;
error = F_57 ( & V_17 -> V_130 , V_133 , - 1 ) ;
if ( error ) {
F_19 ( & V_95 -> V_2 ,
L_27 ) ;
goto V_134;
...
static void F_63 ( struct V_94 * V_95 )
{
struct V_1 * V_17 = F_64 ( V_95 ) ;
F_59 ( & V_17 -> V_130 ) ;
F_60 ( & V_17 -> V_125 ) ;
F_65 ( V_17 -> V_129 ) ;
F_66 ( V_17 -> V_22 ) ;
...
static int F_67 ( struct V_136 * V_137 , const struct V_138 * V_139 ,
unsigned int * V_140 , unsigned int * V_141 ,
unsigned int V_142 [] , void * V_143 [] )
{
struct V_1 * V_17 = F_68 ( V_137 ) ;
...
static int F_69 ( struct V_147 * V_76 )
{
struct V_1 * V_17 = F_68 ( V_76 -> V_136 ) ;
...
static void F_72 ( struct V_147 * V_76 )
{
struct V_1 * V_17 = F_68 ( V_76 -> V_136 ) ;
struct V_59 * V_148 = (struct V_59 * ) V_76 ;
F_25 ( & V_17 -> V_66 ) ;
F_73 ( & V_148 -> V_69 , & V_17 -> V_67 ) ;
F_27 ( & V_17 -> V_66 ) ;
}
...
F_25 ( & V_17 -> V_66 ) ;
F_75 (buf, node, &sur40->buf_list, list) {
F_34 ( & V_148 -> V_76 , V_150 ) ;
F_29 ( & V_148 -> V_69 ) ;
}
F_27 ( & V_17 -> V_66 ) ;
}
static int F_76 ( struct V_136 * V_152 , unsigned int V_56 )
{
struct V_1 * V_17 = F_68 ( V_152 ) ;
V_17 -> V_80 = 0 ;
return 0 ;
}
static void F_77 ( struct V_136 * V_152 )
{
struct V_1 * V_17 = F_68 ( V_152 ) ;
V_17 -> V_80 = - 1 ;
F_74 ( V_17 , V_86 ) ;
...
struct V_155 * V_156 )
{
struct V_1 * V_17 = F_79 ( V_153 ) ;
F_80 ( V_156 -> V_157 , V_158 , sizeof( V_156 -> V_157 ) ) ;
F_80 ( V_156 -> V_159 , V_120 , sizeof( V_156 -> V_159 ) ) ;
F_47 ( V_17 -> V_7 , V_156 -> V_160 , sizeof( V_156 -> V_160 ) ) ;
V_156 -> V_161 = V_162 |
V_163 |
V_164 ;
...
V_46 -> type = V_168 ;
V_46 -> V_169 = V_170 ;
F_80 ( V_46 -> V_119 , L_31 , sizeof( V_46 -> V_119 ) ) ;
V_46 -> V_165 = 0 ;
return 0 ;
}
static int F_82 ( struct V_153 * V_153 , void * V_154 , unsigned int V_46 )
{
...
if ( V_171 -> V_4 != 0 )
return - V_146 ;
F_80 ( V_171 -> V_173 , L_32 , sizeof( V_171 -> V_173 ) ) ;
V_171 -> V_174 = V_175 ;
V_171 -> V_176 = 0 ;
return 0 ;
}
...
struct V_177 * V_171 )
{
if ( ( V_171 -> V_4 != 0 ) || ( V_171 -> V_178 != V_175 ) )
return - V_146 ;
V_171 -> type = V_179 ;
V_171 -> V_180 . V_181 = V_74 . V_181 ;
V_171 -> V_180 . V_182 = V_74 . V_182 ;
return 0 ;
}
static int F_87 ( struct V_153 * V_153 , void * V_154 ,
struct V_183 * V_171 )
{
if ( ( V_171 -> V_4 > 1 ) || ( V_171 -> V_178 != V_175 )
|| ( V_171 -> V_181 != V_74 . V_181 )
|| ( V_171 -> V_182 != V_74 . V_182 ) )
return - V_146 ;
V_171 -> type = V_184 ;
V_171 -> V_180 . V_185 = 60 / ( V_171 -> V_4 + 1 ) ;
V_171 -> V_180 . V_186 = 1 ;
return 0 ;
}
