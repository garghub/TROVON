...
return 0 ;
V_25 = - V_40 ;
V_10 = F_20 ( sizeof( * V_10 ) , V_41 ) ;
if ( ! V_10 )
goto V_42;
V_10 -> V_13 = * V_16 ;
V_10 -> V_11 = V_11 ;
V_25 = F_21 ( V_1 -> V_43 , V_11 -> V_44 , & V_10 -> V_8 ) ;
if ( V_25 ) {
if ( V_25 == - V_45 )
V_25 = 0 ;
goto V_46;
...
struct V_14 * V_11 )
{
struct V_47 * V_47 = F_23 ( V_11 ) , * V_48 = NULL ;
...
T_2 V_15 , V_13 = V_24 ;
struct V_7 * V_8 ;
ASSERT ( F_31 ( V_11 -> V_28 . V_29 ) ) ;
V_53 = F_22 ( V_11 ) ;
if ( ! V_53 )
return V_24 ;
V_8 = F_32 ( V_1 -> V_43 , V_53 -> V_44 ) ;
if ( V_8 ) {
...
if ( V_1 -> V_54 & V_55 ) {
T_2 V_56 = V_57 ;
V_15 = ( V_1 -> V_58 / V_56 ) % V_1 -> V_30 . V_39 ;
V_1 -> V_58 = ( V_1 -> V_58 + 1 ) %
( V_1 -> V_30 . V_39 * V_56 ) ;
} else
V_15 = F_35 ( V_1 , V_53 -> V_44 ) ;
...
if ( ! V_53 )
goto exit;
V_8 = F_38 ( V_1 -> V_43 , V_53 -> V_44 ) ;
if ( V_8 ) {
struct V_9 * V_10 =
F_10 ( V_8 , struct V_9 , V_8 ) ;
V_15 = ( V_10 -> V_13 + 1 ) % V_1 -> V_30 . V_39 ;
}
V_17 = ( V_60 -> V_62 ? V_37 : 0 ) |
( V_60 -> V_63 -> V_64 ? V_38 : 0 ) ;
...
struct V_14 * V_11 )
{
F_40 ( V_11 -> V_12 -> V_43 , V_11 -> V_44 ) ;
}
int
F_41 (
T_1 * V_1 )
{
return F_42 ( & V_1 -> V_43 , V_65 * 10 ,
10 , F_9 ) ;
}
void
F_43 (
