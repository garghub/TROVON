...
if ( F_30 ( V_46 , F_31 ( 64 ) ) ) {
V_79 = F_30 ( V_46 , F_31 ( 32 ) ) ;
if ( V_79 ) {
F_5 ( L_32 ) ;
goto V_86;
}
...
F_13 ( V_1 ) ;
V_1 -> V_73 = F_33 ( V_46 , 0 , 0 ) ;
V_1 -> V_74 = F_33 ( V_46 , 1 , 0 ) ;
if ( V_1 -> V_74 == NULL ) {
V_1 -> V_74 = F_33 ( V_46 , 2 , 0 ) ;
F_17 ( L_35 ) ;
}
...
V_150 = F_46 ( V_37 [ V_30 ] . V_28 , V_157 , V_158 ,
V_146 , 0 , 0 ) ;
if ( V_150 )
return V_150 ;
V_150 = F_46 ( V_37 [ V_30 ] . V_28 , V_138 , V_159 ,
& V_145 ) ;
if ( V_150 )
return V_150 ;
V_150 = F_46 ( V_37 [ V_30 ] . V_28 , V_138 , V_160 , NULL ,
& V_137 ) ;
if ( V_150 )
return V_150 ;
F_7 ( V_1 ,
...
return 0 ;
F_7 ( V_1 , F_44 ( 4 ) , 1 ) ;
V_37 -> V_28 = F_45 ( & V_1 -> V_29 ,
V_37 -> V_152 , & V_182 , NULL ) ;
if ( V_37 -> V_28 ) {
int V_150 = F_46 ( V_37 -> V_28 , V_138 , V_159 , & V_145 ) ;
if ( V_150 )
return V_150 ;
V_150 = F_46 ( V_37 -> V_28 , V_138 , V_160 , NULL ,
& V_137 ) ;
if ( V_150 )
return V_150 ;
V_1 -> V_17 = true ;
...
V_193 , 1 ) ;
V_1 -> V_21 = true ;
F_46 ( V_37 -> V_28 , V_194 , V_195 , 1 ) ;
F_46 ( V_37 -> V_28 , V_157 , V_196 , 1 ) ;
F_46 ( V_37 -> V_28 , V_197 , V_196 , 1 ) ;
F_50 ( F_51 ( V_37 -> V_28 -> V_198 ,
V_199 ) , V_200 ) ;
V_37 -> V_100 = false ;
...
static int F_52 ( struct V_46 * V_46 ,
const struct V_77 * V_78 )
{
struct V_1 * V_1 ;
int V_201 = 0 ;
int V_30 ;
V_30 = F_53 ( & V_202 ) - 1 ;
V_1 = F_54 ( sizeof( struct V_1 ) , V_203 ) ;
if ( V_1 == NULL )
return - V_204 ;
V_1 -> V_46 = V_46 ;
V_1 -> V_205 = V_30 ;
V_1 -> V_206 = F_55 ( & V_46 -> V_153 ) ;
if ( F_56 ( V_1 -> V_206 ) ) {
F_57 ( V_1 ) ;
return - V_204 ;
}
V_201 = F_58 ( & V_46 -> V_153 , & V_1 -> V_29 ) ;
if ( V_201 ) {
F_59 ( L_42 ,
V_1 -> V_205 ) ;
F_60 ( V_1 -> V_206 ) ;
