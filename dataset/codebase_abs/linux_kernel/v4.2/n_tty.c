...
if ( ! V_8 -> V_167 )
F_94 ( V_119 L_10 ) ;
else if ( F_167 ( V_133 ) != V_8 -> V_167 ) {
F_168 ( & V_8 -> V_55 ) ;
if ( F_144 ( V_168 ) || F_169 () )
return - V_169 ;
F_81 ( F_167 ( V_133 ) , V_168 , 1 ) ;
F_170 ( V_170 ) ;
return - V_171 ;
}
F_168 ( & V_8 -> V_55 ) ;
...
static T_3 F_171 ( struct V_7 * V_8 , struct V_164 * V_164 ,
...
static T_3 F_180 ( struct V_7 * V_8 , struct V_164 * V_164 ,
...
int V_45 ;
T_3 V_67 = 0 ;
if ( F_181 ( V_8 ) && V_164 -> V_165 -> V_65 != V_166 ) {
V_67 = F_182 ( V_8 ) ;
if ( V_67 )
return V_67 ;
}
F_87 ( & V_8 -> V_59 ) ;
F_59 ( V_8 ) ;
F_175 ( & V_8 -> V_41 , & V_172 ) ;
while ( 1 ) {
if ( F_177 ( V_133 ) ) {
V_67 = - V_171 ;
break;
}
if ( F_176 ( V_164 ) || ( V_8 -> V_35 && ! V_8 -> V_35 -> V_40 ) ) {
V_67 = - V_169 ;
break;
}
if ( F_57 ( V_8 ) ) {
...
F_85 ( & V_8 -> V_59 ) ;
F_178 ( & V_172 , V_180 , V_178 ) ;
F_87 ( & V_8 -> V_59 ) ;
}
V_71:
F_179 ( & V_8 -> V_41 , & V_172 ) ;
if ( V_154 - V_22 != V_69 && V_8 -> V_26 )
F_120 ( V_27 , & V_8 -> V_20 ) ;
F_85 ( & V_8 -> V_59 ) ;
return ( V_154 - V_22 ) ? V_154 - V_22 : V_67 ;
}
static unsigned int F_183 ( struct V_7 * V_8 , struct V_164 * V_164 ,
T_4 * V_172 )
{
struct V_1 * V_2 = V_8 -> V_11 ;
unsigned int V_184 = 0 ;
F_184 ( V_164 , & V_8 -> V_58 , V_172 ) ;
F_184 ( V_164 , & V_8 -> V_41 , V_172 ) ;
if ( F_158 ( V_8 ) )
V_184 |= V_185 ;
if ( F_155 ( V_8 , 1 ) )
V_184 |= V_100 | V_186 ;
...
static int F_188 ( struct V_7 * V_8 , struct V_164 * V_164 ,
...
switch ( V_190 ) {
case V_192 :
return F_8 ( F_186 ( V_8 ) , ( int T_2 * ) V_191 ) ;
case V_193 :
F_36 ( & V_8 -> V_59 ) ;
if ( F_147 ( V_8 ) )
V_67 = F_187 ( V_2 ) ;
...
default:
return F_189 ( V_8 , V_164 , V_190 , V_191 ) ;
}
}
static void F_190 ( struct V_7 * V_8 , int V_194 )
{
struct V_1 * V_2 = V_8 -> V_11 ;
if ( ! F_25 ( & V_8 -> V_58 ) ) {
if ( V_194 )
