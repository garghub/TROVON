...
F_65 ( V_3 -> V_7 , V_3 -> clock , V_3 -> V_235 ,
V_3 -> V_127 , V_3 -> V_234 , V_3 -> V_233 ) ;
F_46 ( & V_7 -> V_152 ) ;
F_8 ( F_1 ( V_3 ) , L_30 , V_23 ) ;
}
static int F_66 ( struct V_148 * V_149 , struct V_230 * V_231 )
{
struct V_2 * V_3 = F_43 ( V_149 ) ;
struct V_6 * V_7 = V_3 -> V_7 ;
int V_21 = 0 ;
...
V_3 -> V_258 . V_297 = F_85 ( V_149 ) ;
V_3 -> V_258 . V_298 = F_70 ;
V_21 = F_86 ( F_87 ( V_149 ) , & V_3 -> V_258 ) ;
if ( V_21 )
F_88 ( & ( V_4 -> V_5 ) ,
L_34 , V_21 ) ;
F_89 ( & V_3 -> V_261 , F_73 ) ;
...
static int F_91 ( struct V_292 * V_4 )
{
struct V_2 * V_3 = F_92 ( V_4 ) ;
struct V_148 * V_149 ;
if ( ! V_3 )
return 0 ;
V_149 = V_3 -> V_149 ;
