...
F_23 ( & V_2 -> V_23 ) ;
F_25 ( & V_2 -> V_24 , V_47 ) ;
error = F_19 ( V_2 , V_25 -> V_22 , & V_2 -> V_145 ) ;
if ( error ) {
F_3 ( V_2 , L_18 , error ) ;
goto V_146;
}
...
error = F_84 ( V_2 , NULL , V_25 -> V_153 , 0 , V_154 , & V_121 ) ;
if ( error ) {
F_3 ( V_2 , L_22 ) ;
goto V_152;
}
ASSERT ( V_121 != NULL ) ;
if ( F_85 ( ! F_86 ( V_121 -> V_155 . V_156 ) ) ) {
F_3 ( V_2 , L_23 ,
( unsigned long long ) V_121 -> V_157 ) ;
F_87 ( V_121 , V_154 ) ;
F_78 ( L_24 , V_147 ,
V_2 ) ;
error = - V_71 ;
...
if ( F_89 ( V_2 ) ) {
error = F_90 ( V_2 , & V_122 , & V_123 ) ;
if ( error )
goto V_161;
} else {
ASSERT ( ! F_91 ( V_2 ) ) ;
if ( V_2 -> V_4 . V_117 & V_162 ) {
F_92 ( V_2 , L_27 ) ;
error = F_58 ( V_2 ) ;
if ( error )
goto V_161;
...
{
ASSERT ( V_169 > V_170 ) ;
if ( ( V_2 -> V_171 -> V_172 . V_173 >= V_169 ) ||
F_112 ( V_2 ) || ( V_2 -> V_8 & V_160 ) )
return false ;
return true ;
}
int
...
T_12 V_175 )
{
F_114 ( & V_2 -> V_176 , V_175 , V_177 ) ;
if ( F_115 ( & V_2 -> V_176 , 0 , V_177 ) < 0 ) {
ASSERT ( 0 ) ;
F_116 ( & V_2 -> V_176 , - V_175 ) ;
return - V_10 ;
}
return 0 ;
}
...
T_12 V_175 )
{
F_116 ( & V_2 -> V_178 , V_175 ) ;
if ( F_118 ( & V_2 -> V_178 , 0 ) < 0 ) {
ASSERT ( 0 ) ;
F_116 ( & V_2 -> V_178 , - V_175 ) ;
return - V_10 ;
}
...
T_13 V_182 ;
if ( V_175 > 0 ) {
if ( F_120 ( V_2 -> V_183 == V_2 -> V_184 ) ) {
F_116 ( & V_2 -> V_185 , V_175 ) ;
return 0 ;
}
F_14 ( & V_2 -> V_118 ) ;
V_181 = ( long long ) ( V_2 -> V_183 - V_2 -> V_184 ) ;
if ( V_181 > V_175 ) {
V_2 -> V_184 += V_175 ;
} else {
V_175 -= V_181 ;
...
if ( F_115 ( & V_2 -> V_185 , 2 * V_186 ,
V_186 ) < 0 )
V_182 = 1 ;
else
V_182 = V_186 ;
F_114 ( & V_2 -> V_185 , V_175 , V_182 ) ;
if ( F_115 ( & V_2 -> V_185 , F_121 ( V_2 ) ,
V_186 ) >= 0 ) {
return 0 ;
}
F_14 ( & V_2 -> V_118 ) ;
...
if ( ! V_179 )
goto V_187;
V_180 = ( long long ) V_2 -> V_184 + V_175 ;
if ( V_180 >= 0 ) {
V_2 -> V_184 = V_180 ;
F_16 ( & V_2 -> V_118 ) ;
return 0 ;
