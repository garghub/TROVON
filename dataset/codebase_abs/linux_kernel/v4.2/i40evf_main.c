...
if ( V_39 == V_204 ) {
struct V_127 * V_114 , * V_138 ;
struct V_112 * V_207 , * V_208 ;
F_39 ( & V_8 -> V_12 -> V_13 , L_21 ,
V_187 ) ;
V_8 -> V_27 |= V_155 ;
if ( F_126 ( V_8 -> V_25 ) ) {
F_127 ( V_150 , & V_8 -> V_67 . V_148 ) ;
F_79 ( V_25 ) ;
F_80 ( V_25 ) ;
F_70 ( V_8 ) ;
F_20 ( V_8 ) ;
...
goto V_88;
V_212 . V_218 = V_219 ;
V_212 . V_220 = F_7 ( V_212 . V_218 , V_16 ) ;
if ( ! V_212 . V_220 )
goto V_88;
V_214 = (struct V_213 * ) & V_212 . V_221 ;
do {
V_215 = F_137 ( V_2 , & V_212 , & V_217 ) ;
if ( V_215 || ! V_214 -> V_222 )
break;
F_138 ( V_8 , V_214 -> V_222 ,
V_214 -> V_223 , V_212 . V_220 ,
V_212 . V_224 ) ;
if ( V_217 != 0 )
memset ( V_212 . V_220 , 0 , V_219 ) ;
} while ( V_217 );
if ( ( V_8 -> V_27 &
( V_28 | V_29 ) ) ||
V_8 -> V_148 == V_156 )
...
static int F_145 ( struct V_24 * V_25 , int V_242 )
{
struct V_7 * V_8 = F_13 ( V_25 ) ;
int V_101 = V_242 + V_103 + V_104 ;
if ( ( V_242 < 68 ) || ( V_101 > V_243 ) )
return - V_244 ;
V_25 -> V_102 = V_242 ;
V_8 -> V_27 |= V_29 ;
F_14 ( & V_8 -> V_30 ) ;
...
V_2 -> V_226 . V_248 = V_249 ;
V_2 -> V_226 . V_250 = V_249 ;
V_2 -> V_226 . V_251 = V_219 ;
V_2 -> V_226 . V_252 = V_219 ;
V_86 = F_123 ( V_2 ) ;
if ( V_86 ) {
F_39 ( & V_12 -> V_13 , L_37 ,
V_86 ) ;
...
case V_256 :
if ( ! V_8 -> V_172 ) {
V_247 = sizeof( struct V_257 ) +
( V_258 *
sizeof( struct V_259 ) ) ;
V_8 -> V_172 = F_7 ( V_247 , V_16 ) ;
if ( ! V_8 -> V_172 )
goto V_86;
}
V_86 = F_151 ( V_8 ) ;
...
for ( V_39 = 0 ; V_39 < V_8 -> V_172 -> V_262 ; V_39 ++ ) {
if ( V_8 -> V_172 -> V_163 [ V_39 ] . V_263 == V_264 )
...
if ( V_8 -> V_172 -> V_279
& V_280 ) {
V_25 -> V_281 = V_25 -> V_269 ;
V_25 -> V_269 |= V_282 |
V_283 |
V_284 ;
}
V_25 -> V_285 |= V_25 -> V_269 ;
V_25 -> V_285 &= ~ V_277 ;
if ( ! F_62 ( V_8 -> V_2 . V_137 . V_133 ) ) {
F_34 ( & V_12 -> V_13 , L_43 ,
V_8 -> V_2 . V_137 . V_133 ) ;
F_153 ( V_8 -> V_2 . V_137 . V_133 ) ;
}
F_60 ( V_25 -> V_136 , V_8 -> V_2 . V_137 . V_133 ) ;
F_60 ( V_25 -> V_286 , V_8 -> V_2 . V_137 . V_133 ) ;
V_114 = F_7 ( sizeof( * V_114 ) , V_117 ) ;
if ( ! V_114 )
goto V_287;
...
V_8 -> V_303 = true ;
F_131 ( V_25 ) ;
F_34 ( & V_12 -> V_13 , L_44 , V_8 -> V_2 . V_137 . V_133 ) ;
if ( V_25 -> V_269 & V_278 )
F_34 ( & V_12 -> V_13 , L_45 ) ;
F_34 ( & V_12 -> V_13 , L_46 , V_305 ) ;
V_8 -> V_148 = V_154 ;
F_127 ( V_150 , & V_8 -> V_67 . V_148 ) ;
F_19 ( V_8 ) ;
return;
...
static void F_157 ( struct V_246 * V_12 )
{
struct V_24 * V_25 = F_158 ( V_12 ) ;
struct V_7 * V_8 = F_13 ( V_25 ) ;
F_159 ( V_25 ) ;
if ( F_126 ( V_25 ) )
F_135 ( V_25 ) ;
...
static int F_163 ( struct V_246 * V_12 , const struct V_308 * V_309 )
{
struct V_24 * V_25 ;
struct V_7 * V_8 = NULL ;
struct V_1 * V_2 = NULL ;
...
if ( V_86 )
return V_86 ;
V_86 = F_165 ( & V_12 -> V_13 , F_166 ( 64 ) ) ;
if ( V_86 ) {
V_86 = F_165 ( & V_12 -> V_13 , F_166 ( 32 ) ) ;
if ( V_86 ) {
F_39 ( & V_12 -> V_13 ,
L_48 , V_86 ) ;
goto V_310;
...
F_176 ( V_12 , V_322 , & V_2 -> V_323 ) ;
V_2 -> V_324 = V_12 -> V_325 ;
V_2 -> V_326 = V_12 -> V_327 ;
V_2 -> V_328 . V_321 = F_177 ( V_12 -> V_329 ) ;
V_2 -> V_328 . V_330 = F_178 ( V_12 -> V_329 ) ;
F_51 ( & V_8 -> V_129 ) ;
F_51 ( & V_8 -> V_120 ) ;
F_179 ( & V_8 -> V_30 , F_121 ) ;
F_179 ( & V_8 -> V_53 , F_136 ) ;
F_179 ( & V_8 -> V_184 , F_98 ) ;
F_180 ( & V_8 -> V_193 , F_147 ) ;
F_100 ( & V_8 -> V_193 , 10 ) ;
return 0 ;
V_317:
F_181 ( V_25 ) ;
...
static int F_183 ( struct V_246 * V_12 , T_11 V_148 )
{
struct V_24 * V_25 = F_158 ( V_12 ) ;
struct V_7 * V_8 = F_13 ( V_25 ) ;
int V_331 = 0 ;
...
static int F_186 ( struct V_246 * V_12 )
{
struct V_7 * V_8 = F_158 ( V_12 ) ;
struct V_24 * V_25 = V_8 -> V_25 ;
T_3 V_86 ;
F_187 ( V_12 , V_332 ) ;
F_188 ( V_12 ) ;
...
static void F_191 ( struct V_246 * V_12 )
{
struct V_24 * V_25 = F_158 ( V_12 ) ;
struct V_7 * V_8 = F_13 ( V_25 ) ;
struct V_127 * V_114 , * V_138 ;
