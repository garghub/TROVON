...
void F_77 ( struct V_88 * V_89 , T_3 V_125 ,
const T_1 * V_4 , T_2 V_65 ,
bool V_169 , T_4 V_154 )
{
struct V_1 * V_2 = V_89 -> V_90 ;
struct V_5 * V_6 = F_4 ( V_2 -> V_7 ) ;
struct V_155 * V_156 ;
...
return;
V_156 -> type = V_170 ;
V_156 -> V_171 . V_4 = ( ( T_1 * ) V_156 ) + sizeof( * V_156 ) ;
V_156 -> V_171 . V_65 = V_65 ;
memcpy ( ( void * ) V_156 -> V_171 . V_4 , V_4 , V_65 ) ;
V_156 -> V_171 . V_125 = V_125 ;
V_156 -> V_171 . V_169 = V_169 ;
F_65 ( & V_2 -> V_159 , V_33 ) ;
F_66 ( & V_156 -> V_160 , & V_2 -> V_161 ) ;
F_67 ( & V_2 -> V_159 , V_33 ) ;
F_68 ( V_162 , & V_6 -> V_163 ) ;
...
F_79 ( & V_120 -> V_71 ,
V_6 -> V_7 . V_174 ) ;
if ( V_173 && V_173 -> V_175 >= 0 ) {
int V_176 ;
T_5 V_177 ;
V_176 = V_173 -> V_175 ;
V_177 = V_173 -> V_15 [ V_176 ] . V_177 ;
if ( V_177 == V_178 ||
V_177 == V_179 ) {
V_120 -> V_57 = V_176 ;
V_120 -> V_55 = V_173 -> V_15 [ V_176 ] . V_55 ;
V_120 -> V_56 = V_173 -> V_15 [ V_176 ] . V_56 ;
if ( V_120 -> V_69 . V_180 == 0 )
V_120 -> V_69 . V_180 = V_177 ;
if ( V_120 -> V_69 . V_181 == 0 ) {
V_120 -> V_69 . V_181 = 1 ;
V_120 -> V_69 . V_182 [ 0 ] = V_177 ;
}
}
}
V_2 -> V_101 = V_173 ;
...
if ( V_2 -> V_3 )
V_11 = F_47 ( V_2 , V_125 ) ;
else if ( ! V_6 -> V_49 -> V_183 )
F_82 ( V_6 , V_89 ) ;
else if ( V_2 -> V_121 )
V_11 = F_83 ( V_6 , V_89 , V_125 ) ;
return V_11 ;
}
