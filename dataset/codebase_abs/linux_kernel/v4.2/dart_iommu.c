...
static void F_30 ( struct V_74 * V_71 )
{
F_26 ( & V_71 -> V_71 ) ;
}
...
static bool F_32 ( struct V_70 * V_71 )
{
struct V_36 * V_78 = F_33 ( V_71 -> V_79 ) ;
while( V_78 ) {
if ( F_34 ( V_78 , L_14 ) ||
F_34 ( V_78 , L_15 ) ) {
F_35 ( V_78 ) ;
...
static int F_37 ( struct V_70 * V_71 , T_2 V_80 )
{
if ( ! V_71 -> V_80 || ! F_38 ( V_71 , V_80 ) )
return - V_81 ;
if ( F_32 ( V_71 ) && V_80 >= F_39 ( 40 ) ) {
F_40 ( V_71 , L_16 ) ;
F_41 ( V_71 , & V_72 ) ;
} else {
F_40 ( V_71 , L_17 ) ;
...
void T_1 F_42 ( struct V_83 * V_84 )
{
struct V_36 * V_85 ;
V_85 = F_43 ( NULL , L_18 , L_19 ) ;
if ( V_85 == NULL ) {
V_85 = F_43 ( NULL , L_18 , L_20 ) ;
if ( V_85 == NULL )
return;
V_7 = 1 ;
}
