...
static long F_49 ( struct V_2 * V_2 , unsigned int V_70 , unsigned long V_41 )
{
struct V_3 * V_4 ;
struct V_5 * V_6 = V_2 -> V_16 ;
struct V_53 V_71 ;
...
unsigned int V_70 , unsigned long V_41 )
{
return F_49 ( V_2 , V_70 , ( unsigned long ) F_51 ( V_41 ) ) ;
}
static unsigned int F_52 ( struct V_2 * V_2 , T_5 * V_74 )
{
unsigned long V_75 = F_53 ( V_74 ) ;
struct V_5 * V_6 = V_2 -> V_16 ;
struct V_3 * V_4 ;
unsigned int V_76 = 0 ;
if ( F_12 ( ! V_6 || ! V_6 -> V_4 ) )
...
if ( V_6 == & V_4 -> V_18 ) {
V_76 = F_54 ( V_4 , V_2 , V_74 ) ;
goto V_19;
}
if ( V_75 & ( V_78 | V_79 ) ) {
F_55 ( V_2 , & V_6 -> V_29 , V_74 ) ;
if ( ! F_23 ( & V_6 -> V_28 ) )
V_76 |= V_78 | V_79 ;
else
F_22 ( V_6 , 0 , V_2 ) ;
...
static T_1 F_56 ( struct V_80 * V_80 ,
struct V_81 * V_82 , char * V_38 )
{
struct V_3 * V_4 = F_57 ( V_80 ) ;
struct V_83 V_84 ;
int V_7 , V_85 ;
T_1 V_86 = 0 ;
F_3 ( & V_4 -> V_11 ) ;
...
V_86 += F_58 ( V_38 + V_86 , V_88 - V_86 , L_21 ,
V_84 . V_37 [ V_85 ] ) ;
return V_86 ;
}
...
int V_89 ;
F_3 ( & V_90 ) ;
V_89 = F_60 ( & V_91 , V_4 , 0 , V_92 , V_93 ) ;
if ( V_89 >= 0 )
V_4 -> V_94 = V_89 ;
else if ( V_89 == - V_95 )
F_42 ( V_4 -> V_4 , L_22 ) ;
...
int F_63 ( struct V_3 * V_4 , struct V_80 * V_96 )
{
struct V_80 * V_97 ;
int V_89 , V_98 ;
V_89 = F_59 ( V_4 ) ;
if ( V_89 < 0 )
return V_89 ;
V_98 = F_64 ( F_65 ( V_99 ) , V_4 -> V_94 ) ;
F_66 ( & V_4 -> V_9 , & V_100 ) ;
V_4 -> V_9 . V_101 = V_96 -> V_102 -> V_101 ;
V_89 = F_67 ( & V_4 -> V_9 , V_98 , 1 ) ;
if ( V_89 ) {
F_42 ( V_96 , L_23 ,
F_65 ( V_99 ) , V_4 -> V_94 ) ;
goto V_103;
}
V_97 = F_68 ( V_104 , V_96 , V_98 ,
V_4 , V_105 ,
L_24 , V_4 -> V_94 ) ;
if ( F_7 ( V_97 ) ) {
F_42 ( V_96 , L_25 ,
...
{
int V_89 ;
V_104 = F_76 ( V_108 , L_27 ) ;
if ( F_7 ( V_104 ) ) {
F_77 ( L_28 ) ;
V_89 = F_8 ( V_104 ) ;
goto V_7;
}
V_89 = F_78 ( & V_99 , 0 , V_92 , L_27 ) ;
if ( V_89 < 0 ) {
F_77 ( L_29 ) ;
goto V_109;
}
