...
V_61 = V_87 -> V_61 ;
if ( V_61 == 0 )
V_61 = F_50 ( T_1 , F_51 ( V_53 ) -> V_93 , 1 ) ;
V_54 = F_52 ( V_53 , & V_94 , V_61 ) ;
if ( F_53 ( V_54 ) )
return F_54 ( V_54 ) ;
F_55 ( V_53 ) ;
...
F_46 ( V_13 -> V_55 ) ;
V_13 -> V_55 = V_54 ;
V_13 -> V_65 = F_57 ( V_87 -> V_65 ) ;
V_13 -> V_67 = F_57 ( V_87 -> V_67 ) ;
V_13 -> V_66 = V_38 ;
V_13 -> V_61 = V_61 ;
V_13 -> V_26 = V_87 -> V_26 ;
V_13 -> V_25 = V_87 -> V_25 ;
...
static int F_59 ( struct V_52 * V_53 , struct V_82 * V_83 )
{
struct V_12 * V_13 = F_25 ( V_53 ) ;
V_13 -> V_55 = & V_95 ;
...
if ( V_96 == NULL )
goto V_100;
if ( F_63 ( V_3 , V_92 , sizeof( V_83 ) , & V_83 ) )
goto V_100;
return F_64 ( V_3 , V_96 ) ;
V_100:
F_65 ( V_3 , V_96 ) ;
return - V_101 ;
}
static int F_66 ( struct V_52 * V_53 , struct V_102 * V_103 )
{
struct V_12 * V_13 = F_25 ( V_53 ) ;
struct V_104 V_105 = {
. V_75 = V_13 -> V_62 . V_75 ,
...
return F_67 ( V_103 , & V_105 , sizeof( V_105 ) ) ;
}
static int F_68 ( struct V_52 * V_53 , unsigned long V_109 ,
struct V_2 * V_3 , struct V_110 * V_111 )
{
return - V_112 ;
}
static int F_69 ( struct V_52 * V_53 , unsigned long V_113 , struct V_52 * V_114 ,
struct V_52 * * V_115 )
{
struct V_12 * V_13 = F_25 ( V_53 ) ;
if ( V_114 == NULL )
...
* V_115 = V_13 -> V_55 ;
V_13 -> V_55 = V_114 ;
F_56 ( * V_115 , ( * V_115 ) -> V_13 . V_22 ) ;
F_43 ( * V_115 ) ;
F_58 ( V_53 ) ;
return 0 ;
}
static struct V_52 * F_70 ( struct V_52 * V_53 , unsigned long V_113 )
{
struct V_12 * V_13 = F_25 ( V_53 ) ;
return V_13 -> V_55 ;
}
...
static void F_72 ( struct V_52 * V_53 , unsigned long V_113 )
{
}
static int F_73 ( struct V_52 * V_53 , T_1 V_51 , T_1 V_116 ,
struct V_82 * * V_117 , unsigned long * V_113 )
{
return - V_112 ;
}
static int F_74 ( struct V_52 * V_53 , unsigned long V_109 )
{
return - V_112 ;
}
static void F_75 ( struct V_52 * V_53 , struct V_118 * V_119 )
{
if ( ! V_119 -> V_120 ) {
...
static unsigned long F_77 ( struct V_52 * V_53 , unsigned long V_124 ,
T_1 V_51 )
{
return 0 ;
}
