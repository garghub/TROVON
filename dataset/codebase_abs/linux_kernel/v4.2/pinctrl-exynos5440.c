...
static T_3 F_54 ( int V_140 , void * V_37 )
{
struct V_141 * V_142 = V_37 ;
struct V_3 * V_136 = V_142 -> V_4 ;
int V_84 ;
V_84 = F_55 ( V_136 -> V_86 , V_142 -> V_137 ) ;
if ( ! V_84 )
return V_143 ;
F_56 ( V_84 ) ;
return V_144 ;
}
static int F_57 ( struct V_86 * V_145 , unsigned int V_84 ,
T_4 V_146 )
{
...
V_154 = F_67 ( V_88 , V_156 , 0 ) ;
V_4 -> V_56 = F_68 ( & V_88 -> V_17 , V_154 ) ;
if ( F_44 ( V_4 -> V_56 ) )
return F_45 ( V_4 -> V_56 ) ;
V_105 = F_47 ( V_88 , V_4 ) ;
if ( V_105 )
return V_105 ;
V_105 = F_42 ( V_88 , V_4 ) ;
