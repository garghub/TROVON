...
if ( V_32 -> V_35 ) {
if ( F_20 ( V_32 -> V_35 ) )
V_32 -> V_38 = F_21 ( V_32 -> V_35 ) ;
else
V_32 -> V_38 = F_22 ( V_32 -> V_35 ) ;
} else {
F_3 ( V_32 ) ;
V_32 = NULL ;
}
...
static enum V_39 F_23 ( int V_40 , enum V_41 V_42 )
{
enum V_39 type = V_43 ;
if ( V_40 & V_44 )
type |= V_45 ;
...
static void F_25 ( struct V_24 * V_25 , struct V_52 * V_53 ,
...
static void F_28 ( struct V_24 * V_25 , struct V_31 * V_32 )
{
...
static unsigned F_29 ( struct V_24 * V_25 , unsigned V_57 ,
bool V_58 )
{
...
F_34 ( & V_25 -> V_65 , V_60 ) ;
if ( V_49 )
F_25 ( V_25 , & V_53 , V_62 , V_49 ) ;
V_67:
if ( V_62 != V_59 )
F_3 ( V_62 ) ;
return V_57 ;
}
static void F_36 ( struct V_68 * V_34 , enum V_39 type )
{
struct V_69 * V_38 ;
struct V_24 * V_25 ;
if ( ! V_34 )
...
static void F_41 ( struct V_68 * V_34 , void * V_74 )
{
struct V_24 * V_25 = * (struct V_24 * * ) V_74 ;
if ( V_25 )
F_36 ( V_34 , V_25 -> type ) ;
}
static int F_42 ( struct V_68 * V_34 , void * V_74 , void * V_75 )
{
return * (struct V_24 * * ) V_74 == V_75 ;
}
static struct V_24 * F_43 ( struct V_68 * V_34 , T_4 V_40 ,
enum V_39 type )
{
...
if ( ! V_34 )
return NULL ;
V_79 = F_44 ( F_41 , sizeof( * V_79 ) , V_36 ) ;
if ( ! V_79 )
return NULL ;
V_80 = - V_82 ;
V_25 = F_45 ( sizeof( struct V_24 ) , V_36 ,
F_46 ( V_34 ) ) ;
if ( ! V_25 )
goto V_83;
V_78 = F_45 ( sizeof( struct V_69 ) , V_36 ,
F_46 ( V_34 ) ) ;
if ( ! V_78 )
goto V_83;
F_30 ( & V_78 -> V_71 ) ;
...
F_48 ( V_34 ) , V_29 ( V_34 ) ) ;
F_37 ( & V_70 -> V_65 ) ;
F_49 ( & V_78 -> V_71 , & V_70 -> V_71 ) ;
V_70 -> V_72 ++ ;
F_49 ( & V_25 -> V_71 , & V_34 -> V_88 ) ;
F_40 ( & V_70 -> V_65 ) ;
* V_79 = V_25 ;
F_50 ( V_34 , V_79 ) ;
return V_25 ;
...
static struct V_24 * F_53 ( struct V_68 * V_34 ,
enum V_39 type )
{
...
int F_67 ( struct V_96 * V_97 , struct V_68 * V_34 )
{
struct V_99 * V_100 = & V_97 -> V_100 ;
...
return 0 ;
type = F_23 ( V_100 -> V_109 , V_100 -> V_110 ) ;
if ( V_100 -> V_109 & V_44 )
V_37 = V_111 | V_112 ;
else
V_37 = V_113 ;
...
V_80 = F_64 ( V_25 , V_97 , V_23 ) ;
if ( V_80 != 0 ) {
F_69 ( V_97 , V_34 ) ;
return - V_82 ;
}
V_80 = F_70 ( V_105 , V_100 -> V_21 [ V_23 ] ,
false , false ) ;
if ( F_71 ( V_80 != 0 ) ) {
F_69 ( V_97 , V_34 ) ;
return - V_82 ;
...
void F_69 ( struct V_96 * V_97 , struct V_68 * V_34 )
{
struct V_99 * V_100 = & V_97 -> V_100 ;
struct V_24 * V_25 ;
...
if ( ! V_25 )
return;
V_120 = ( F_53 ( V_25 -> V_34 ,
F_23 ( V_100 -> V_109 , V_46 ) ) == V_25 ) ;
...
continue;
V_57 = V_128 ;
V_128 = F_29 ( V_38 -> V_25 , V_57 , true ) ;
V_130 += V_57 - V_128 ;
F_57 ( L_20 ,
...
F_89 ( V_38 -> V_34 , L_24 , V_38 -> V_25 -> V_87 ,
V_94 -> V_95 ) ;
F_39 ( F_90 ( V_38 -> V_34 , F_41 ,
F_42 , V_38 -> V_25 ) ) ;
F_36 ( V_38 -> V_34 , V_38 -> V_25 -> type ) ;
}
F_87 ( & V_70 -> V_2 ) ;
V_70 = NULL ;
}
