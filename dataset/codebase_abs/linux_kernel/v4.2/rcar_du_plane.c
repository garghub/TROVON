...
return NULL ;
V_12 = F_6 ( V_10 -> V_12 ) ;
V_100 = F_22 ( V_12 , sizeof( * V_12 ) , V_97 ) ;
if ( V_100 == NULL )
return NULL ;
F_23 ( V_10 , & V_100 -> V_12 ) ;
return & V_100 -> V_12 ;
}
static void F_24 ( struct V_85 * V_10 ,
struct V_86 * V_12 )
{
F_25 ( V_10 , V_12 ) ;
F_18 ( F_6 ( V_12 ) ) ;
...
V_87 -> V_37 = V_103 ;
else if ( V_102 == V_90 -> V_104 . V_98 )
V_87 -> V_98 = V_103 ;
else
return - V_94 ;
return 0 ;
}
static int F_27 ( struct V_85 * V_10 ,
const struct V_86 * V_12 , struct V_101 * V_102 ,
T_2 * V_103 )
{
const struct V_11 * V_87 =
F_28 ( V_12 , const struct V_11 , V_12 ) ;
struct V_89 * V_90 = F_12 ( V_10 ) -> V_15 -> V_5 ;
if ( V_102 == V_90 -> V_104 . V_44 )
* V_103 = V_87 -> V_44 ;
else if ( V_102 == V_90 -> V_104 . V_37 )
...
V_10 -> V_15 = V_2 ;
V_107 = F_30 ( V_90 -> V_112 , & V_10 -> V_10 , V_105 ,
& V_113 , V_114 ,
F_31 ( V_114 ) , type ) ;
if ( V_107 < 0 )
return V_107 ;
