...
V_42 -> V_332 ++ ;
while ( 1 ) {
if ( F_163 ( V_10 ) && F_150 ( V_333 , & V_42 -> V_12 ) )
F_164 ( V_42 ) ;
F_134 ( V_278 ) ;
if ( F_165 ( V_321 ) || ! ( V_42 -> V_12 & V_185 ) ) {
...
static int F_169 ( struct V_337 * V_318 , struct V_9 * V_10 )
{
struct V_1 * V_2 ;
int line = V_10 -> V_338 ;
if ( line >= V_339 ) {
...
F_172 ( V_10 , V_2 -> V_42 . V_342 ,
! ( V_2 -> V_42 . V_12 & V_336 ) ) ;
V_184 = ( ( V_2 -> V_42 . V_12 & V_334 ) ?
- V_335 : - V_279 ) ;
goto V_233;
}
V_2 -> V_42 . V_343 = ( V_2 -> V_42 . V_12 & V_344 ) ? 1 : 0 ;
F_9 ( & V_2 -> V_345 , V_12 ) ;
if ( V_2 -> V_86 ) {
V_184 = - V_346 ;
F_11 ( & V_2 -> V_345 , V_12 ) ;
...
static inline void F_173 ( struct V_347 * V_348 , struct V_1 * V_2 )
{
char V_349 [ 30 ] ;
unsigned long V_12 ;
if ( V_2 -> V_350 == V_351 ) {
...
if ( V_2 -> V_54 . V_76 )
F_174 ( V_348 , L_106 , V_2 -> V_54 . V_76 ) ;
if ( V_2 -> V_54 . V_77 )
F_174 ( V_348 , L_107 , V_2 -> V_54 . V_77 ) ;
if ( V_2 -> V_54 . V_356 )
F_174 ( V_348 , L_108 , V_2 -> V_54 . V_356 ) ;
if ( V_2 -> V_54 . V_357 )
F_174 ( V_348 , L_109 , V_2 -> V_54 . V_357 ) ;
if ( V_2 -> V_54 . V_66 )
F_174 ( V_348 , L_110 , V_2 -> V_54 . V_66 ) ;
if ( V_2 -> V_54 . V_358 )
F_174 ( V_348 , L_111 , V_2 -> V_54 . V_358 ) ;
} else {
F_174 ( V_348 , L_112 ,
V_2 -> V_54 . V_298 , V_2 -> V_54 . V_143 ) ;
if ( V_2 -> V_54 . V_146 )
F_174 ( V_348 , L_113 , V_2 -> V_54 . V_146 ) ;
if ( V_2 -> V_54 . V_145 )
F_174 ( V_348 , L_114 , V_2 -> V_54 . V_145 ) ;
if ( V_2 -> V_54 . V_144 )
F_174 ( V_348 , L_115 , V_2 -> V_54 . V_144 ) ;
if ( V_2 -> V_54 . V_148 )
F_174 ( V_348 , L_116 , V_2 -> V_54 . V_148 ) ;
}
F_174 ( V_348 , L_117 , V_349 + 1 ) ;
F_174 ( V_348 , L_118 ,
...
static int F_175 ( struct V_347 * V_348 , void * V_375 )
{
struct V_1 * V_2 ;
F_174 ( V_348 , L_121 , V_376 ) ;
V_2 = V_340 ;
while( V_2 ) {
F_173 ( V_348 , V_2 ) ;
V_2 = V_2 -> V_341 ;
...
static int F_176 ( struct V_377 * V_377 , struct V_320 * V_320 )
{
...
if ( F_179 ( V_2 ) < 0 ||
F_180 ( V_2 , V_2 -> V_385 , V_2 -> V_383 ) < 0 ||
F_180 ( V_2 , V_2 -> V_386 , V_2 -> V_381 ) < 0 ||
F_181 ( V_2 ) < 0 ||
F_182 ( V_2 ) < 0 ) {
...
V_2 -> V_388 = F_185 ( NULL , V_391 , & V_2 -> V_392 , V_187 ) ;
if ( V_2 -> V_388 == NULL )
return - V_188 ;
...
F_187 ( NULL , V_391 , V_2 -> V_388 , V_2 -> V_392 ) ;
V_2 -> V_388 = NULL ;
V_2 -> V_385 = NULL ;
V_2 -> V_386 = NULL ;
}
static int F_180 ( struct V_1 * V_2 , V_394 * V_397 , int V_398 )
{
int V_387 ;
V_393 V_399 ;
...
V_397 [ V_387 ] . V_400 = F_185 ( NULL , V_380 , & V_397 [ V_387 ] . V_401 , V_187 ) ;
...
static void F_188 ( struct V_1 * V_2 , V_394 * V_397 , int V_398 )
{
int V_387 ;
if ( V_397 ) {
for ( V_387 = 0 ; V_387 < V_398 ; V_387 ++ ) {
...
if ( V_2 -> V_350 != V_351 )
F_187 ( NULL , V_380 , V_397 [ V_387 ] . V_400 , V_397 [ V_387 ] . V_401 ) ;
...
{
F_188 ( V_2 , V_2 -> V_385 , V_2 -> V_383 ) ;
F_188 ( V_2 , V_2 -> V_386 , V_2 -> V_381 ) ;
F_186 ( V_2 ) ;
}
static int F_181 ( struct V_1 * V_2 )
{
V_2 -> V_402 = F_190 ( V_2 -> V_238 , V_187 | V_403 ) ;
if ( V_2 -> V_402 == NULL )
return - V_188 ;
V_2 -> V_404 = F_191 ( V_2 -> V_238 , V_187 ) ;
if ( ! V_2 -> V_404 ) {
F_192 ( V_2 -> V_402 ) ;
V_2 -> V_402 = NULL ;
return - V_188 ;
...
V_2 -> V_405 [ V_387 ] . V_406 =
F_190 ( V_2 -> V_238 , V_187 ) ;
if ( V_2 -> V_405 [ V_387 ] . V_406 == NULL ) {
for ( -- V_387 ; V_387 >= 0 ; V_387 -- ) {
F_192 ( V_2 -> V_405 [ V_387 ] . V_406 ) ;
V_2 -> V_405 [ V_387 ] . V_406 = NULL ;
}
return - V_188 ;
}
}
...
& V_2 -> V_405 [ V_2 -> V_407 ] ;
int V_411 = F_195 ( V_2 ) ;
int V_412 = V_410 -> V_413 / V_380 ;
if ( V_410 -> V_413 % V_380 )
++ V_412 ;
if ( V_412 <= V_411 ) {
V_2 -> V_78 = V_410 -> V_413 ;
F_102 ( V_2 , V_410 -> V_406 , V_410 -> V_413 ) ;
-- V_2 -> V_234 ;
...
static int F_104 ( struct V_1 * V_2 , const char * V_414 , unsigned int V_415 )
{
struct V_409 * V_410 ;
if ( V_2 -> V_234 >= V_2 -> V_235 ) {
return 0 ;
}
V_410 = & V_2 -> V_405 [ V_2 -> V_408 ] ;
V_410 -> V_413 = V_415 ;
memcpy ( V_410 -> V_406 , V_414 , V_415 ) ;
++ V_2 -> V_234 ;
...
{
if ( F_198 ( V_2 -> V_136 , V_2 -> V_416 , L_125 ) == NULL ) {
F_4 ( L_126 ,
__FILE__ , __LINE__ , V_2 -> V_21 , V_2 -> V_136 ) ;
return - V_300 ;
}
V_2 -> V_417 = true ;
if ( F_199 ( V_2 -> V_176 , F_67 , V_2 -> V_418 ,
V_2 -> V_21 , V_2 ) < 0 ) {
F_4 ( L_127 ,
__FILE__ , __LINE__ , V_2 -> V_21 , V_2 -> V_176 ) ;
goto V_419;
...
V_2 -> V_420 = true ;
if ( V_2 -> V_350 == V_351 ) {
if ( F_200 ( V_2 -> V_352 , 0x40000 , L_125 ) == NULL ) {
F_4 ( L_128 ,
__FILE__ , __LINE__ , V_2 -> V_21 , V_2 -> V_352 ) ;
goto V_419;
}
V_2 -> V_421 = true ;
if ( F_200 ( V_2 -> V_353 + V_2 -> V_422 , 128 , L_125 ) == NULL ) {
F_4 ( L_129 ,
__FILE__ , __LINE__ , V_2 -> V_21 , V_2 -> V_353 + V_2 -> V_422 ) ;
goto V_419;
}
V_2 -> V_423 = true ;
V_2 -> V_389 = F_201 ( V_2 -> V_352 ,
0x40000 ) ;
if ( ! V_2 -> V_389 ) {
F_4 ( L_130 ,
__FILE__ , __LINE__ , V_2 -> V_21 , V_2 -> V_352 ) ;
...
F_194 ( V_2 ) ;
if ( V_2 -> V_417 ) {
F_209 ( V_2 -> V_136 , V_2 -> V_416 ) ;
V_2 -> V_417 = false ;
}
if ( V_2 -> V_421 ) {
F_210 ( V_2 -> V_352 , 0x40000 ) ;
V_2 -> V_421 = false ;
}
if ( V_2 -> V_423 ) {
F_210 ( V_2 -> V_353 + V_2 -> V_422 , 128 ) ;
V_2 -> V_423 = false ;
}
if ( V_2 -> V_389 ) {
F_211 ( V_2 -> V_389 ) ;
...
if ( V_2 -> line < V_428 ) {
if ( V_429 [ V_2 -> line ] )
V_2 -> V_238 = V_429 [ V_2 -> line ] ;
if ( V_430 [ V_2 -> line ] ) {
V_2 -> V_382 = V_430 [ V_2 -> line ] ;
if ( V_2 -> V_382 < 1 )
V_2 -> V_382 = 1 ;
}
if ( V_431 [ V_2 -> line ] ) {
V_2 -> V_235 = V_431 [ V_2 -> line ] ;
if ( V_2 -> V_235 < 1 )
V_2 -> V_235 = 1 ;
else if ( V_2 -> V_235 > V_432 )
V_2 -> V_235 = V_432 ;
}
}
V_339 ++ ;
...
if ( V_2 -> V_350 == V_351 ) {
F_4 ( L_138 ,
V_2 -> V_434 + 1 , V_2 -> V_21 , V_2 -> V_136 , V_2 -> V_176 ,
V_2 -> V_352 , V_2 -> V_353 ,
V_2 -> V_238 ) ;
} else {
F_4 ( L_139 ,
...
F_216 ( & V_2 -> V_33 , F_15 ) ;
V_2 -> V_238 = 4096 ;
V_2 -> V_42 . V_436 = 5 * V_223 / 10 ;
V_2 -> V_42 . V_437 = 30 * V_223 ;
F_217 ( & V_2 -> V_119 ) ;
F_217 ( & V_2 -> V_64 ) ;
F_218 ( & V_2 -> V_22 ) ;
F_218 ( & V_2 -> V_345 ) ;
memcpy ( & V_2 -> V_36 , & V_438 , sizeof( T_5 ) ) ;
V_2 -> V_247 = V_439 ;
V_2 -> V_382 = 1 ;
V_2 -> V_235 = 0 ;
}
...
V_440 -> V_448 = V_449 ;
V_440 -> V_448 . V_199 =
V_450 | V_212 | V_203 | V_200 | V_226 ;
V_440 -> V_448 . V_451 = 9600 ;
V_440 -> V_448 . V_452 = 9600 ;
V_440 -> V_12 = V_453 ;
F_221 ( V_440 , & V_454 ) ;
if ( ( V_24 = F_222 ( V_440 ) ) < 0 ) {
F_4 ( L_142 ,
__FILE__ , __LINE__ ) ;
F_223 ( V_440 ) ;
V_440 = NULL ;
...
struct V_1 * V_2 ;
int V_387 ;
for ( V_387 = 0 ; ( V_387 < V_455 ) && V_456 [ V_387 ] && V_457 [ V_387 ] ; V_387 ++ ) {
if ( V_19 >= V_20 )
F_4 ( L_144 ,
V_456 [ V_387 ] , V_457 [ V_387 ] , V_458 [ V_387 ] ) ;
V_2 = F_214 () ;
if ( ! V_2 ) {
if ( V_19 >= V_459 )
F_4 ( L_145 ) ;
...
V_2 -> V_136 = ( unsigned int ) V_456 [ V_387 ] ;
V_2 -> V_176 = ( unsigned int ) V_457 [ V_387 ] ;
V_2 -> V_176 = F_225 ( V_2 -> V_176 ) ;
V_2 -> V_354 = ( unsigned int ) V_458 [ V_387 ] ;
V_2 -> V_350 = V_460 ;
V_2 -> V_416 = 16 ;
V_2 -> V_418 = 0 ;
F_212 ( V_2 ) ;
...
F_4 ( L_148 , V_441 , V_376 ) ;
F_224 () ;
if ( ( V_24 = F_233 ( & V_463 ) ) < 0 )
...
{
F_51 ( V_465 + V_2 -> V_466 , V_2 -> V_136 + V_137 ) ;
if ( V_2 -> V_350 == V_351 )
F_52 ( V_2 -> V_136 + V_137 ) ;
}
static void F_34 ( struct V_1 * V_2 , T_2 V_465 )
{
F_51 ( V_465 + V_2 -> V_467 , V_2 -> V_136 ) ;
if ( V_2 -> V_350 == V_351 )
F_52 ( V_2 -> V_136 ) ;
}
static void F_63 ( struct V_1 * V_2 , T_2 V_468 , T_2 V_469 )
{
F_51 ( V_468 + V_2 -> V_467 , V_2 -> V_136 ) ;
F_51 ( V_469 , V_2 -> V_136 ) ;
if ( V_2 -> V_350 == V_351 )
F_52 ( V_2 -> V_136 ) ;
}
static T_2 F_64 ( struct V_1 * V_2 , T_2 V_468 )
{
F_51 ( V_468 + V_2 -> V_467 , V_2 -> V_136 ) ;
...
{
F_51 ( V_468 + V_2 -> V_466 , V_2 -> V_136 + V_137 ) ;
F_51 ( V_469 , V_2 -> V_136 + V_137 ) ;
if ( V_2 -> V_350 == V_351 )
F_52 ( V_2 -> V_136 + V_137 ) ;
}
...
case V_485 : V_469 |= V_196 ; break;
case V_486 : V_469 |= V_196 | V_57 ; break;
case V_487 : V_469 |= V_195 ; break;
case V_488 : V_469 |= V_195 | V_57 ; break;
case V_489 : V_469 |= V_195 | V_196 ; break;
case V_490 : V_469 |= V_195 | V_196 | V_57 ; break;
}
if ( ( V_2 -> V_36 . V_491 & V_492 ) == V_493 )
V_469 |= V_161 ;
else if ( ( V_2 -> V_36 . V_491 & V_492 ) == V_494 )
V_469 |= ( V_197 | V_179 | V_161 ) ;
...
V_469 |= ( V_197 | V_179 | V_161 | V_166 ) ;
F_27 ( V_2 , V_371 , V_469 ) ;
F_125 ( V_2 ) ;
F_130 ( V_2 , V_499 ) ;
if ( V_2 -> V_350 == V_351 )
...
case V_484 :
case V_485 :
case V_486 : V_469 |= V_166 ; break;
case V_487 :
case V_488 : V_469 |= V_161 ; break;
case V_489 :
case V_490 : V_469 |= V_161 | V_166 ; break;
}
}
...
if ( V_2 -> V_350 == V_351 ) {
F_63 ( V_2 , V_524 , 0xa00b ) ;
}
else
F_63 ( V_2 , V_524 , 0x800b ) ;
F_63 ( V_2 , V_163 , 0xf200 ) ;
F_63 ( V_2 , V_168 , 0xf200 ) ;
F_63 ( V_2 , V_525 , 0x9000 ) ;
F_64 ( V_2 , V_163 ) ;
F_64 ( V_2 , V_168 ) ;
F_63 ( V_2 , V_160 , 0x0303 ) ;
V_469 = 0x8080 ;
switch ( V_2 -> V_36 . V_526 ) {
case V_527 : V_469 |= V_179 ; break;
case V_528 : V_469 |= V_515 ; break;
case V_529 : V_469 |= V_515 | V_179 ; break;
}
switch ( V_2 -> V_36 . V_477 ) {
case V_530 : V_469 |= V_166 | V_197 ; break;
case V_531 : V_469 |= V_166 ; break;
case V_532 : V_469 |= V_161 ; break;
case V_533 : V_469 |= V_161 | V_166 ; break;
}
F_27 ( V_2 , V_534 , V_469 ) ;
if ( V_2 -> V_350 == V_351 ) {
F_63 ( V_2 , V_535 , 0x0000 ) ;
}
else
F_63 ( V_2 , V_535 , 0x2000 ) ;
F_10 ( V_2 ) ;
F_87 ( V_2 ) ;
}
...
F_27 ( V_2 , V_519 , ( T_2 ) ( ( F_25 ( V_2 , V_519 ) & ~ V_162 ) | V_167 ) ) ;
...
static void F_238 ( struct V_1 * V_2 , V_393 V_221 )
{
V_393 V_510 ;
T_2 V_512 ;
if ( V_221 ) {
...
V_510 = 14745600 ;
V_512 = ( T_2 ) ( V_510 / V_221 ) ;
if ( ! ( ( ( V_510 % V_221 ) * 2 ) / V_221 ) )
V_512 -- ;
F_27 ( V_2 , V_537 , V_512 ) ;
F_27 ( V_2 , V_519 , ( T_2 ) ( ( F_25 ( V_2 , V_519 ) & ~ V_162 ) | V_167 ) ) ;
F_27 ( V_2 , V_295 , ( T_2 ) ( ( F_25 ( V_2 , V_295 ) & 0xfff8 ) | 0x0004 ) ) ;
} else {
F_27 ( V_2 , V_519 , ( T_2 ) ( F_25 ( V_2 , V_519 ) & ~ V_167 ) ) ;
}
}
...
do
{
* ( ( unsigned long * ) & ( V_2 -> V_385 [ V_538 ++ ] . V_13 ) ) = V_380 ;
if ( V_538 == V_2 -> V_383 )
V_538 = 0 ;
} while( V_538 != V_539 );
V_543 = true ;
...
V_399 = V_2 -> V_385 [ V_540 ] . V_395 ;
F_63 ( V_2 , V_547 , ( T_2 ) V_399 ) ;
F_63 ( V_2 , V_548 , ( T_2 ) ( V_399 >> 16 ) ) ;
F_31 ( V_2 , V_142 ) ;
F_30 ( V_2 , V_131 | V_67 ) ;
F_92 ( V_2 , V_67 ) ;
F_63 ( V_2 , V_549 , V_134 | V_169 ) ;
F_63 ( V_2 , V_525 , ( T_2 ) ( F_64 ( V_2 , V_525 ) | V_162 ) ) ;
F_34 ( V_2 , V_550 ) ;
...
F_34 ( V_2 , V_72 ) ;
V_554 = V_2 -> V_386 [ V_2 -> V_556 ] . V_557 ;
if ( V_2 -> V_36 . V_37 == V_202 )
V_2 -> V_386 [ V_2 -> V_556 ] . V_557 = 0 ;
F_27 ( V_2 , V_558 , ( T_2 ) V_554 ) ;
F_35 ( V_2 , V_73 ) ;
V_399 = V_2 -> V_386 [ V_2 -> V_556 ] . V_395 ;
F_63 ( V_2 , V_559 , ( T_2 ) V_399 ) ;
F_63 ( V_2 , V_560 , ( T_2 ) ( V_399 >> 16 ) ) ;
F_33 ( V_2 , V_500 ) ;
F_30 ( V_2 , V_69 ) ;
F_92 ( V_2 , V_69 ) ;
if ( V_2 -> V_36 . V_37 == V_202 &&
V_2 -> V_382 > 1 ) {
F_63 ( V_2 , V_561 , V_169 | V_134 ) ;
F_63 ( V_2 , V_525 , ( T_2 ) ( F_64 ( V_2 , V_525 ) | V_167 ) ) ;
}
F_34 ( V_2 , V_562 ) ;
F_130 ( V_2 , V_563 ) ;
...
V_565 [ 0 ] = V_2 -> V_186 [ V_2 -> V_80 ++ ] ;
V_2 -> V_80 = V_2 -> V_80 & ( V_230 - 1 ) ;
V_565 [ 1 ] = V_2 -> V_186 [ V_2 -> V_80 ++ ] ;
V_2 -> V_80 = V_2 -> V_80 & ( V_230 - 1 ) ;
F_51 ( * ( ( T_2 * ) V_565 ) , V_2 -> V_136 + V_567 ) ;
V_2 -> V_78 -= 2 ;
V_2 -> V_54 . V_298 += 2 ;
} else {
F_51 ( ( F_52 ( V_2 -> V_136 + V_137 ) & 0x0780 ) | ( V_568 + V_133 ) ,
V_2 -> V_136 + V_137 ) ;
if ( V_2 -> V_239 ) {
...
int V_387 ;
V_393 V_569 ;
volatile V_393 * V_570 = ( V_393 * ) ( V_2 -> V_424 + 0x50 ) ;
V_393 * V_571 = ( V_393 * ) ( V_2 -> V_424 + 0x28 ) ;
V_2 -> V_572 |= V_573 ;
* V_570 = V_2 -> V_572 ;
...
F_35 ( V_2 , V_73 ) ;
F_33 ( V_2 , V_500 ) ;
F_51 ( 0 , V_2 -> V_136 + V_567 ) ;
F_130 ( V_2 , V_563 ) ;
F_239 ( V_2 , V_553 ) ;
for ( V_387 = 0 ; V_387 < 1000 ; V_387 ++ )
if ( F_25 ( V_2 , V_50 ) & ( V_166 | V_482 | V_134 | V_162 ) )
break;
F_237 ( V_2 , 0 ) ;
F_236 ( V_2 ) ;
V_2 -> V_36 . V_37 = V_581 ;
...
V_597 |= V_482 ;
F_27 ( V_2 , V_194 , V_597 ) ;
}
static void F_244 ( struct V_1 * V_2 , V_393 V_221 )
{
if ( V_221 ) {
F_27 ( V_2 , V_509 , 0x0f64 ) ;
if ( V_2 -> V_350 == V_351 )
F_27 ( V_2 , V_537 , ( T_2 ) ( ( 691200 / V_221 ) - 1 ) ) ;
else
F_27 ( V_2 , V_537 , ( T_2 ) ( ( 921600 / V_221 ) - 1 ) ) ;
F_27 ( V_2 , V_519 ,
( T_2 ) ( ( F_25 ( V_2 , V_519 ) & ~ V_162 ) | V_167 ) ) ;
F_27 ( V_2 , V_295 ,
...
static void F_246 ( struct V_1 * V_2 , unsigned int V_600 , unsigned int V_601 )
{
bool V_602 = false ;
V_394 * V_603 ;
unsigned int V_604 ;
V_604 = V_600 ;
while( ! V_602 ) {
V_603 = & ( V_2 -> V_385 [ V_604 ] ) ;
if ( V_604 == V_601 ) {
V_602 = true ;
}
* ( ( unsigned long * ) & ( V_603 -> V_13 ) ) = V_380 ;
V_604 ++ ;
if ( V_604 == V_2 -> V_383 )
V_604 = 0 ;
}
...
while( ! V_2 -> V_385 [ V_601 ] . V_49 ) {
if ( V_2 -> V_385 [ V_601 ] . V_13 )
goto V_608;
V_601 ++ ;
if ( V_601 == V_2 -> V_383 )
V_601 = 0 ;
...
V_607 = true ;
if ( V_607 ) {
V_605 = V_497 - V_2 -> V_385 [ V_601 ] . V_557 ;
...
if ( V_19 >= V_616 )
F_247 ( V_2 , V_2 -> V_385 [ V_600 ] . V_400 ,
F_105 ( int , V_605 , V_380 ) , 0 ) ;
if ( V_605 ) {
if ( ( ( V_2 -> V_36 . V_491 & V_612 ) &&
( ( V_605 + 1 ) > V_2 -> V_238 ) ) ||
( V_605 > V_2 -> V_238 ) )
...
V_619 = V_617 ;
V_603 = & ( V_2 -> V_385 [ V_338 ] ) ;
memcpy ( V_618 , V_603 -> V_400 , V_619 ) ;
V_618 += V_619 ;
V_617 -= V_619 ;
if ( ++ V_338 == V_2 -> V_383 )
V_338 = 0 ;
...
#if V_85
if ( V_2 -> V_86 )
F_248 ( V_2 , V_2 -> V_402 , V_605 ) ;
else
#endif
F_5 ( V_10 , V_2 -> V_402 , V_2 -> V_404 , V_605 ) ;
}
}
F_246 ( V_2 , V_600 , V_601 ) ;
V_606 = true ;
V_608:
if ( V_2 -> V_250 && V_2 -> V_164 ) {
if ( ! V_2 -> V_385 [ V_601 ] . V_49 &&
V_2 -> V_385 [ V_601 ] . V_13 ) {
F_9 ( & V_2 -> V_22 , V_12 ) ;
F_21 ( V_2 ) ;
F_11 ( & V_2 -> V_22 , V_12 ) ;
}
...
if ( V_49 ) {
if ( V_2 -> V_385 [ V_622 ] . V_557 )
V_605 = V_497 - V_2 -> V_385 [ V_622 ] . V_557 ;
else
V_605 = V_380 ;
}
else
...
__FILE__ , __LINE__ , V_2 -> V_21 , V_49 , V_605 ) ;
if ( V_19 >= V_616 )
F_247 ( V_2 , V_2 -> V_385 [ V_622 ] . V_400 ,
F_105 ( int , V_605 , V_380 ) , 0 ) ;
if ( V_605 ) {
V_603 = & ( V_2 -> V_385 [ V_622 ] ) ;
memcpy ( V_2 -> V_402 , V_603 -> V_400 , V_605 ) ;
V_2 -> V_54 . V_355 ++ ;
F_5 ( V_10 , V_2 -> V_402 , V_2 -> V_404 , V_605 ) ;
}
F_246 ( V_2 , V_622 , V_622 ) ;
V_606 = true ;
}
if ( V_2 -> V_250 && V_2 -> V_164 ) {
...
const char * V_414 , unsigned int V_415 )
{
unsigned short V_624 ;
unsigned int V_387 = 0 ;
V_394 * V_603 ;
if ( V_19 >= V_616 )
F_247 ( V_2 , V_414 , F_105 ( int , V_415 , V_380 ) , 1 ) ;
if ( V_2 -> V_36 . V_12 & V_236 ) {
V_2 -> V_56 |= V_57 ;
}
V_387 = V_2 -> V_599 ;
...
V_2 -> V_386 [ V_387 ] . V_557 = V_415 ;
V_2 -> V_386 [ V_387 ] . V_13 = V_415 ;
while( V_415 ) {
V_603 = & V_2 -> V_386 [ V_387 ++ ] ;
if ( V_387 == V_2 -> V_381 )
V_387 = 0 ;
if ( V_415 > V_380 )
V_624 = V_380 ;
...
V_624 = V_415 ;
if ( V_2 -> V_350 == V_351 )
F_249 ( V_603 -> V_400 , V_414 , V_624 ) ;
else
memcpy ( V_603 -> V_400 , V_414 , V_624 ) ;
V_603 -> V_13 = V_624 ;
V_414 += V_624 ;
V_415 -= V_624 ;
++ V_2 -> V_170 ;
...
static unsigned int V_626 = F_251 ( V_625 ) ;
unsigned int V_387 ;
bool V_24 = true ;
unsigned long V_12 ;
F_9 ( & V_2 -> V_22 , V_12 ) ;
...
F_27 ( V_2 , V_537 , V_625 [ V_387 ] ) ;
F_27 ( V_2 , V_517 , V_625 [ ( V_387 + 1 ) % V_626 ] ) ;
F_27 ( V_2 , V_558 , V_625 [ ( V_387 + 2 ) % V_626 ] ) ;
F_27 ( V_2 , V_496 , V_625 [ ( V_387 + 3 ) % V_626 ] ) ;
F_27 ( V_2 , V_481 , V_625 [ ( V_387 + 4 ) % V_626 ] ) ;
F_63 ( V_2 , V_627 , V_625 [ ( V_387 + 5 ) % V_626 ] ) ;
if ( ( F_25 ( V_2 , V_537 ) != V_625 [ V_387 ] ) ||
( F_25 ( V_2 , V_517 ) != V_625 [ ( V_387 + 1 ) % V_626 ] ) ||
( F_25 ( V_2 , V_558 ) != V_625 [ ( V_387 + 2 ) % V_626 ] ) ||
( F_25 ( V_2 , V_496 ) != V_625 [ ( V_387 + 3 ) % V_626 ] ) ||
( F_25 ( V_2 , V_481 ) != V_625 [ ( V_387 + 4 ) % V_626 ] ) ||
...
F_11 ( & V_2 -> V_22 , V_12 ) ;
V_554 = F_254 ;
V_2 -> V_386 [ 0 ] . V_13 = V_554 ;
V_2 -> V_386 [ 0 ] . V_557 = V_554 ;
V_2 -> V_386 [ 0 ] . V_49 = 0x4000 ;
V_630 = V_2 -> V_386 [ 0 ] . V_400 ;
for ( V_387 = 0 ; V_387 < V_554 ; V_387 ++ )
* V_630 ++ = V_387 ;
V_2 -> V_385 [ 0 ] . V_49 = 0 ;
V_2 -> V_385 [ 0 ] . V_13 = V_554 + 4 ;
memset ( V_2 -> V_385 [ 0 ] . V_400 , 0 , V_554 + 4 ) ;
V_2 -> V_386 [ 1 ] . V_13 = 0 ;
V_2 -> V_385 [ 1 ] . V_13 = 0 ;
F_9 ( & V_2 -> V_22 , V_12 ) ;
F_35 ( V_2 , V_147 ) ;
V_399 = V_2 -> V_385 [ 0 ] . V_395 ;
F_63 ( V_2 , V_547 , ( unsigned short ) V_399 ) ;
F_63 ( V_2 , V_548 , ( unsigned short ) ( V_399 >> 16 ) ) ;
F_64 ( V_2 , V_163 ) ;
F_34 ( V_2 , V_550 ) ;
F_27 ( V_2 , V_495 , ( unsigned short ) ( ( F_25 ( V_2 , V_495 ) & 0xfffc ) | 0x0002 ) ) ;
F_11 ( & V_2 -> V_22 , V_12 ) ;
V_628 = V_324 + F_197 ( 100 ) ;
for(; ; ) {
...
F_9 ( & V_2 -> V_22 , V_12 ) ;
F_27 ( V_2 , V_558 , ( unsigned short ) V_2 -> V_386 [ 0 ] . V_13 ) ;
F_35 ( V_2 , V_73 ) ;
V_399 = V_2 -> V_386 [ 0 ] . V_395 ;
F_63 ( V_2 , V_559 , ( unsigned short ) V_399 ) ;
F_63 ( V_2 , V_560 , ( unsigned short ) ( V_399 >> 16 ) ) ;
...
V_49 = F_25 ( V_2 , V_68 ) ;
F_11 ( & V_2 -> V_22 , V_12 ) ;
while ( ! ( V_49 & ( V_536 | V_577 | V_482 | V_169 | V_162 ) ) ) {
if ( F_158 ( V_324 , V_628 ) ) {
V_24 = false ;
break;
}
...
unsigned long V_626 = F_251 ( V_625 ) ;
unsigned long V_387 ;
...
static void F_249 ( char * V_638 , const char * V_639 ,
unsigned short V_13 )
{
#define F_255 64
unsigned short V_640 = V_13 / F_255 ;
unsigned short V_604 ;
unsigned long V_641 ;
for ( V_604 = 0 ; V_604 < V_640 ; V_604 ++ )
{
memcpy ( V_638 , V_639 , F_255 ) ;
V_641 = * ( ( volatile unsigned long * ) V_638 ) ;
V_638 += F_255 ;
V_639 += F_255 ;
}
memcpy ( V_638 , V_639 , V_13 % F_255 ) ;
}
static void F_247 ( struct V_1 * V_2 , const char * V_11 , int V_13 , int V_642 )
{
int V_387 ;
int V_643 ;
if ( V_642 )
...
static int F_256 ( struct V_646 * V_647 , unsigned short V_483 ,
unsigned short V_145 )
{
struct V_1 * V_2 = F_257 ( V_647 ) ;
unsigned char V_648 ;
...
switch ( V_483 )
{
case V_650 : V_648 = V_518 ; break;
case V_651 : V_648 = V_486 ; break;
case V_652 : V_648 = V_487 ; break;
case V_653 : V_648 = V_488 ; break;
case V_654 : V_648 = V_489 ; break;
default: return - V_294 ;
}
switch ( V_145 )
{
case V_655 : V_649 = V_656 ; break;
case V_657 : V_649 = V_493 ; break;
case V_658 : V_649 = V_494 ; break;
default: return - V_294 ;
}
V_2 -> V_36 . V_483 = V_648 ;
V_2 -> V_36 . V_491 = V_649 ;
if ( V_2 -> V_86 )
F_88 ( V_2 ) ;
return 0 ;
}
static T_9 F_258 ( struct V_659 * V_660 ,
struct V_646 * V_647 )
{
struct V_1 * V_2 = F_257 ( V_647 ) ;
unsigned long V_12 ;
...
static int F_261 ( struct V_646 * V_647 )
{
struct V_1 * V_2 = F_257 ( V_647 ) ;
int V_24 ;
unsigned long V_12 ;
...
static int F_264 ( struct V_646 * V_647 )
{
struct V_1 * V_2 = F_257 ( V_647 ) ;
unsigned long V_12 ;
if ( V_19 >= V_20 )
...
static int F_266 ( struct V_646 * V_647 , struct V_668 * V_669 , int V_299 )
{
...
return - V_346 ;
if ( V_299 != V_676 )
return F_267 ( V_647 , V_669 , V_299 ) ;
...
V_12 = V_2 -> V_36 . V_12 & ( V_680 | V_503 |
V_504 | V_505 |
V_681 | V_506 |
V_507 | V_508 ) ;
...
case ( V_504 | V_507 ) : V_672 . V_682 = V_684 ; break;
case ( V_680 | V_507 ) : V_672 . V_682 = V_685 ; break;
case ( V_680 | V_508 ) : V_672 . V_682 = V_686 ; break;
default: V_672 . V_682 = V_687 ;
}
V_672 . V_688 = V_2 -> V_36 . V_516 ;
V_672 . V_580 = V_2 -> V_36 . V_580 ? 1 : 0 ;
if ( F_268 ( line , & V_672 , V_670 ) )
return - V_243 ;
return 0 ;
case V_678 :
if( ! F_79 ( V_689 ) )
return - V_690 ;
if ( F_269 ( & V_672 , line , V_670 ) )
return - V_243 ;
switch ( V_672 . V_682 )
{
case V_683 : V_12 = V_680 | V_681 ; break;
case V_686 : V_12 = V_680 | V_508 ; break;
case V_684 : V_12 = V_504 | V_507 ; break;
case V_685 : V_12 = V_680 | V_507 ; break;
...
if ( V_672 . V_580 != 0 && V_672 . V_580 != 1 )
return - V_294 ;
V_2 -> V_36 . V_12 &= ~ ( V_680 | V_503 |
V_504 | V_505 |
V_681 | V_506 |
V_507 | V_508 ) ;
V_2 -> V_36 . V_12 |= V_12 ;
V_2 -> V_36 . V_580 = V_672 . V_580 ;
if ( V_12 & ( V_504 | V_507 ) )
V_2 -> V_36 . V_516 = V_672 . V_688 ;
else
V_2 -> V_36 . V_516 = 0 ;
if ( V_2 -> V_86 )
F_88 ( V_2 ) ;
...
static void F_270 ( struct V_646 * V_647 )
{
struct V_1 * V_2 = F_257 ( V_647 ) ;
unsigned long V_12 ;
if ( V_19 >= V_20 )
...
static void F_248 ( struct V_1 * V_2 , char * V_231 , int V_670 )
{
struct V_659 * V_660 = F_273 ( V_670 ) ;
...
memcpy ( F_274 ( V_660 , V_670 ) , V_231 , V_670 ) ;
V_660 -> V_695 = F_275 ( V_660 , V_647 ) ;
V_647 -> V_613 . V_696 ++ ;
V_647 -> V_613 . V_697 += V_670 ;
F_276 ( V_660 ) ;
}
...
V_647 -> V_457 = V_2 -> V_176 ;
V_647 -> V_458 = V_2 -> V_354 ;
V_647 -> V_700 = & V_701 ;
...
static int F_282 ( struct V_705 * V_647 ,
...
V_2 -> V_136 = F_284 ( V_647 , 2 ) ;
V_2 -> V_176 = V_647 -> V_457 ;
V_2 -> V_352 = F_284 ( V_647 , 3 ) ;
V_2 -> V_353 = F_284 ( V_647 , 0 ) ;
V_2 -> V_422 = V_2 -> V_353 & ( V_425 - 1 ) ;
V_2 -> V_353 &= ~ ( V_425 - 1 ) ;
V_2 -> V_350 = V_351 ;
V_2 -> V_416 = 8 ;
V_2 -> V_418 = V_708 ;
...
static void F_285 ( struct V_705 * V_647 )
{
}
