...
{
return V_78 - ( T_1 ) V_3 -> V_79 < V_3 -> V_80 ;
}
static inline int
F_23 ( const struct V_2 * V_3 , T_1 V_78 )
{
return V_78 - ( T_1 ) V_3 -> V_81 < V_3 -> V_82 ;
}
static inline int
...
break;
case V_131 :
V_4 -= ( T_1 ) ( F_22 ( V_3 , V_4 ) ? V_3 -> V_79 : V_3 -> V_81 ) ;
break;
case V_132 :
F_29 () ;
break;
...
T_1 V_89 ;
if ( V_3 -> V_82 > V_90 )
V_89 = V_3 -> V_82 - V_90 / 2 ;
else
V_89 = V_3 -> V_82 / 2 ;
V_89 = ( T_1 ) V_3 -> V_81 + ( ( V_89 + 7 ) & - 8 ) ;
V_3 -> V_17 . V_89 = V_89 ;
F_21 ( L_28 , V_77 , V_89 ) ;
}
