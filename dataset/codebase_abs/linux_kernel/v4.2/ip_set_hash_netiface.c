...
if ( V_33 == V_46 )
V_40 . V_6 = V_42 ;
F_22 ( V_15 , V_35 -> V_12 & V_47 , & V_40 . V_5 ) ;
V_40 . V_5 &= F_7 ( V_40 . V_6 ) ;
#define F_23 ( T_4 ) (par->dir ? par->dir->name : "")
#define F_24 (opt->flags & IPSET_DIM_TWO_SRC)
if ( V_35 -> V_48 & V_17 ) {
#if F_25 ( V_49 )
const char * V_50 = F_24 ? F_15 ( V_15 ) :
F_17 ( V_15 ) ;
if ( ! V_50 )
return - V_45 ;
F_26 ( V_40 . V_8 , V_50 ) ;
...
return - V_45 ;
return V_38 ( V_29 , & V_40 , & V_44 , & V_35 -> V_44 , V_35 -> V_48 ) ;
}
static int
...
if ( V_33 == V_46 )
V_40 . V_6 = V_42 ;
F_55 ( V_15 , V_35 -> V_12 & V_47 , & V_40 . V_5 . V_69 ) ;
