...
struct V_57 * V_58 ;
F_34 ( L_10 , V_55 , V_24 ) ;
F_35 ( V_55 > V_4 -> V_14 . V_15 - V_24 ) ;
V_56 = F_36 ( sizeof( * V_56 ) , V_39 ) ;
if ( V_56 == NULL )
return NULL ;
if ( F_37 ( V_56 , 1 , V_39 ) ) {
F_20 ( V_56 ) ;
...
V_58 -> V_55 = 0 ;
V_58 -> V_60 = V_24 ;
F_38 ( V_58 ) = ( V_61 ) V_4 -> V_28 . V_42 + V_55 ;
F_39 ( V_58 ) = V_24 ;
return V_56 ;
}
...
F_49 ( V_63 ) ;
V_63 -> V_13 = V_13 ;
V_63 -> V_8 . V_68 = V_69 | V_70 ;
V_63 -> V_71 = F_50 ( V_2 ) ? V_72 : V_73 ;
return V_63 ;
V_67:
F_51 ( V_63 ) ;
return NULL ;
...
V_79 -> V_83 |= V_84 ;
F_58 ( & V_63 -> V_85 , & V_4 -> V_28 . V_86 ) ;
F_58 ( & V_79 -> V_87 , & V_77 -> V_88 ) ;
F_49 ( V_63 ) ;
return V_63 ;
V_82:
F_59 ( V_79 ) ;
