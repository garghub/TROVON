...
F_46 ( V_6 ) ;
F_4 ( L_13 , V_6 -> V_10 , V_69 , V_33 ) ;
}
F_47 ( & V_12 -> V_56 ) ;
F_56 ( V_29 ) ;
return V_70 ;
}
static struct V_71 * F_57 ( struct V_5 * V_6 )
{
struct V_11 * V_12 = F_27 ( V_6 ) ;
return & V_12 -> V_47 ;
}
...
{
struct V_11 * V_12 = F_27 ( V_6 ) ;
struct V_72 * V_73 = V_7 ;
if ( ! F_6 ( V_73 -> V_74 ) )
return - V_75 ;
F_45 ( & V_12 -> V_56 ) ;
memcpy ( V_6 -> V_8 , V_73 -> V_74 , V_76 ) ;
F_47 ( & V_12 -> V_56 ) ;
return 0 ;
}
static int F_61 ( struct V_5 * V_6 , int V_77 )
{
return - V_20 ;
}
void F_62 ( unsigned long V_78 )
{
}
...
F_36 ( & V_83 ) ;
F_37 (ele, &devices) {
V_95 = F_38 ( V_52 , struct V_11 , V_79 ) ;
if ( V_95 -> V_34 == V_99 )
break;
}
F_40 ( & V_83 ) ;
if ( V_95 && V_95 -> V_34 == V_99 ) {
F_75 ( V_100 L_21 , V_99 ) ;
return 1 ;
}
V_97 = F_77 ( sizeof( * V_97 ) ) ;
if ( V_97 == NULL ) {
F_75 ( V_100 L_22 ) ;
return 1 ;
}
...
V_97 -> V_34 = V_99 ;
V_97 -> V_35 = V_1 + 1 ;
F_79 ( & V_97 -> V_101 , & V_102 ) ;
return 1 ;
}
static int V_96 ( void )
{
struct V_51 * V_52 , * V_103 ;
F_80 (ele, next, &eth_cmd_line) {
struct V_96 * V_104 ;
V_104 = F_38 ( V_52 , struct V_96 , V_101 ) ;
F_63 ( V_104 -> V_34 , V_104 -> V_35 ) ;
}
return 1 ;
}
