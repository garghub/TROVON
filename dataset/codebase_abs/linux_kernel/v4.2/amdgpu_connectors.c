...
struct V_68 * F_12 ( struct V_1 * V_2 )
{
struct V_8 * V_8 = F_2 ( V_2 ) ;
...
struct V_68 * V_68 = F_19 ( V_70 -> V_72 , V_70 -> V_73 , V_74 ) ;
if ( V_68 )
V_8 -> V_68 = V_68 ;
}
return V_8 -> V_68 ;
...
V_92 -> V_94 != 0 ) {
V_27 = F_40 ( V_4 , V_92 -> V_93 , V_92 -> V_94 , 60 , true , false , false ) ;
V_27 -> type = V_95 | V_96 ;
F_39 ( L_9 , V_27 -> V_55 ) ;
}
return V_27 ;
...
continue;
V_27 = F_40 ( V_4 , V_100 [ V_63 ] . V_98 , V_100 [ V_63 ] . V_99 , 60 , false , false , false ) ;
F_42 ( V_2 , V_27 ) ;
}
}
...
static void
F_44 ( struct V_22 * V_23 ,
struct V_1 * V_2 )
{
struct V_48 * V_48 = F_13 ( V_23 ) ;
struct V_89 * V_92 = & V_48 -> V_92 ;
struct V_89 * V_136 , * V_27 ;
F_45 (mode, t, &connector->probed_modes, head) {
if ( V_27 -> type & V_95 ) {
...
static enum V_60
F_49 ( struct V_1 * V_2 , bool V_142 )
{
struct V_8 * V_8 = F_2 ( V_2 ) ;
struct V_22 * V_23 = F_32 ( V_2 ) ;
enum V_60 V_86 = V_143 ;
int V_144 ;
V_144 = F_50 ( V_2 -> V_4 -> V_4 ) ;
if ( V_144 < 0 )
return V_143 ;
if ( V_23 ) {
struct V_48 * V_48 = F_13 ( V_23 ) ;
...
static enum V_60
F_60 ( struct V_1 * V_2 , bool V_142 )
{
struct V_8 * V_8 = F_2 ( V_2 ) ;
struct V_22 * V_23 ;
...
static enum V_60
F_64 ( struct V_1 * V_2 , bool V_142 )
{
struct V_3 * V_4 = V_2 -> V_4 ;
struct V_5 * V_6 = V_4 -> V_7 ;
struct V_8 * V_8 = F_2 ( V_2 ) ;
...
struct V_1 * V_158 ;
struct V_8 * V_159 ;
F_65 (list_connector, &dev->mode_config.connector_list, head) {
if ( V_2 == V_158 )
continue;
V_159 = F_2 ( V_158 ) ;
if ( V_159 -> V_154 &&
...
if ( V_2 -> V_65 [ V_63 ] == 0 )
break;
V_23 = F_16 ( V_2 -> V_4 , V_2 -> V_65 [ V_63 ] ) ;
if ( ! V_23 )
continue;
if ( V_23 -> V_67 != V_163 &&
V_23 -> V_67 != V_164 )
...
static enum V_60
F_74 ( struct V_1 * V_2 , bool V_142 )
{
struct V_3 * V_4 = V_2 -> V_4 ;
struct V_5 * V_6 = V_4 -> V_7 ;
struct V_8 * V_8 = F_2 ( V_2 ) ;
...
if ( V_13 == V_193 )
return;
F_65 (connector, &dev->mode_config.connector_list, head) {
V_8 = F_2 ( V_2 ) ;
if ( V_8 -> V_183 == V_183 ) {
V_8 -> V_101 |= V_184 ;
return;
...
F_65 (encoder, &dev->mode_config.encoder_list, head) {
V_48 = F_13 ( V_23 ) ;
if ( V_48 -> V_101 & V_184 ) {
switch ( V_48 -> V_176 ) {
case V_177 :
...
goto V_199;
V_8 -> V_17 = V_172 ;
F_81 ( V_4 , & V_8 -> V_111 , & V_217 , V_13 ) ;
F_82 ( & V_8 -> V_111 , & V_218 ) ;
if ( V_186 -> V_194 ) {
V_8 -> V_81 = F_80 ( V_6 , V_186 ) ;
if ( ! V_8 -> V_81 )
F_62 ( L_21 ) ;
