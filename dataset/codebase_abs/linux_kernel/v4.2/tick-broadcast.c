...
V_37 = & F_35 ( V_38 , V_1 ) ;
if ( V_37 -> V_20 -> V_46 . V_62 <= V_60 . V_62 ) {
F_25 ( V_1 , V_42 ) ;
F_25 ( V_1 , V_64 ) ;
} else if ( V_37 -> V_20 -> V_46 . V_62 < V_46 . V_62 ) {
V_46 . V_62 = V_37 -> V_20 -> V_46 . V_62 ;
V_61 = V_1 ;
}
}
F_27 ( F_34 () , V_64 ) ;
...
if ( F_69 ( V_3 , F_34 () ) )
return;
if ( V_18 -> V_46 . V_62 < V_3 -> V_46 . V_62 )
return;
}
F_59 ( V_18 , V_67 ) ;
}
...
if ( F_28 ( V_1 , V_55 ) ) {
V_25 = - V_66 ;
} else if ( V_18 -> V_46 . V_62 < V_3 -> V_46 . V_62 ) {
...
V_64 ) )
goto V_71;
if ( V_18 -> V_46 . V_62 == V_63 )
goto V_71;
V_60 = F_64 () ;
if ( V_18 -> V_46 . V_62 <= V_60 . V_62 ) {
F_25 ( V_1 , V_55 ) ;
goto V_71;
}
F_72 ( V_18 -> V_46 , 1 ) ;
