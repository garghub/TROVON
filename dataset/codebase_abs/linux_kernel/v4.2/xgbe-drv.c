...
static int F_153 ( struct V_3 * V_5 , int V_418 )
{
struct V_1 * V_2 = V_5 -> V_2 ;
struct V_54 * V_40 = & V_2 -> V_40 ;
struct V_6 * V_33 = V_5 -> V_8 ;
...
if ( F_23 ( V_275 -> V_276 ,
V_431 , V_444 ) )
F_159 ( V_273 , V_275 -> V_445 ,
V_275 -> V_446 ) ;
V_273 -> V_180 = V_27 ;
V_273 -> V_438 = F_160 ( V_273 , V_27 ) ;
F_161 ( V_273 , V_5 -> V_20 ) ;
F_162 ( V_273 , V_74 ) ;
F_163 ( V_74 , V_273 ) ;
V_437:
V_425 ++ ;
...
void F_167 ( struct V_1 * V_2 , struct V_6 * V_33 ,
unsigned int V_449 )
{
struct V_197 * V_198 ;
struct V_408 * V_409 ;
...
F_165 ( V_2 -> V_27 ,
L_74 ,
V_449 , F_166 ( V_409 -> V_451 ) , F_166 ( V_409 -> V_452 ) ,
F_166 ( V_409 -> V_453 ) , F_166 ( V_409 -> V_454 ) ) ;
}
...
F_165 ( V_27 , L_79 , V_457 -> V_459 ) ;
F_165 ( V_27 , L_80 , V_457 -> V_460 ) ;
F_165 ( V_27 , L_81 , F_168 ( V_457 -> V_461 ) ) ;
for ( V_10 = 0 , V_199 = 0 ; V_10 < V_273 -> V_286 ; ) {
V_199 += snprintf ( V_458 + V_199 , sizeof( V_458 ) - V_199 , L_82 ,
V_407 [ V_10 ++ ] ) ;
if ( ( V_10 % 32 ) == 0 ) {
F_165 ( V_27 , L_83 , V_10 - 32 , V_458 ) ;
V_199 = 0 ;
} else if ( ( V_10 % 16 ) == 0 ) {
V_458 [ V_199 ++ ] = ' ' ;
V_458 [ V_199 ++ ] = ' ' ;
...
if ( V_10 % 32 )
F_165 ( V_27 , L_83 , V_10 - ( V_10 % 32 ) , V_458 ) ;
F_165 ( V_27 , L_75 ) ;
}
