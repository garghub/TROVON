...
V_2 = F_87 ( V_154 , V_159 , V_42 , & V_167 , V_156 ) ;
if ( V_2 == NULL )
return - V_168 ;
V_3 = F_88 ( V_2 ) -> V_169 = F_63 () ;
if ( ! V_3 ) {
F_89 ( V_2 ) ;
return - V_168 ;
}
...
struct V_1 * F_91 ( struct V_1 * V_173 , struct T_2 * T_2 )
{
struct V_1 * V_2 ;
T_1 * V_3 , * V_174 ;
V_2 = F_87 ( F_92 ( V_173 ) , V_159 , V_42 , V_173 -> V_175 , 0 ) ;
if ( V_2 == NULL )
return NULL ;
if ( ( V_3 = F_63 () ) == NULL ) {
F_89 ( V_2 ) ;
...
V_3 -> V_24 = V_174 -> V_24 ;
if ( V_174 -> V_33 != NULL ) {
V_3 -> V_33 = F_94 ( V_174 -> V_33 , sizeof( T_4 ) ,
V_42 ) ;
if ( V_3 -> V_33 == NULL ) {
F_89 ( V_2 ) ;
F_2 ( V_3 ) ;
...
static int F_99 ( struct V_126 * V_1 , struct V_190 * V_191 , int V_192 )
{
struct V_1 * V_2 = V_1 -> V_2 ;
...
if ( ( V_22 = F_108 ( sizeof( T_4 ) , V_221 ) ) == NULL ) {
V_196 = - V_222 ;
goto V_217;
}
...
F_109 ( V_227 L_1 ,
V_228 -> V_229 ) ;
if ( ( V_196 = F_110 ( V_3 , & V_212 -> V_198 . V_204 ) ) < 0 ) {
F_107 ( V_22 ) ;
goto V_217;
}
F_62 ( V_3 , V_3 -> T_2 ) ;
...
static int F_120 ( struct V_126 * V_1 , struct V_126 * V_236 , int V_210 )
{
struct V_34 * V_35 ;
struct V_1 * V_237 ;
F_113 ( V_233 ) ;
...
static int F_122 ( struct V_126 * V_1 , struct V_190 * V_191 ,
int * V_240 , int V_241 )
{
struct V_193 * V_212 = (struct V_193 * ) V_191 ;
struct V_1 * V_2 = V_1 -> V_2 ;
...
static int F_123 ( struct V_126 * V_1 , struct V_245 * V_246 , T_8 V_247 )
{
F_124 ( struct V_197 * , V_248 , V_246 -> V_249 ) ;
struct V_1 * V_2 = V_1 -> V_2 ;
struct V_197 V_250 ;
struct V_34 * V_35 ;
T_4 V_251 , * V_252 ;
T_1 * V_3 ;
T_8 V_253 ;
int V_254 , V_196 , V_192 = V_246 -> V_255 ;
if ( V_246 -> V_256 & ~ ( V_257 | V_258 | V_259 ) )
return - V_64 ;
F_70 ( V_2 ) ;
V_3 = F_3 ( V_2 ) ;
if ( F_104 ( V_2 , V_205 ) ) {
...
if ( V_247 > V_3 -> T_2 -> V_7 -> V_262 ) {
V_196 = - V_263 ;
goto V_152;
}
if ( V_248 != NULL ) {
if ( V_248 -> V_199 != V_200 ) {
V_196 = - V_64 ;
goto V_152;
}
if ( V_192 == sizeof( struct V_197 ) )
...
if ( V_192 > sizeof( struct V_197 ) && V_248 -> V_207 != 0 ) {
int V_213 = 0 ;
struct V_193 * V_212 = (struct V_193 * ) V_248 ;
if ( V_248 -> V_207 < 1 || V_248 -> V_207 > V_63 ) {
V_196 = - V_64 ;
goto V_152;
}
V_251 . V_32 = V_248 -> V_207 ;
while ( V_213 < V_248 -> V_207 ) {
V_251 . V_226 [ V_213 ] = 0 ;
V_251 . V_67 [ V_213 ] = V_212 -> V_208 [ V_213 ] ;
V_213 ++ ;
}
V_251 . V_223 = 0 ;
}
...
V_250 . V_199 = V_200 ;
V_250 . V_204 = V_3 -> V_29 ;
V_252 = V_3 -> V_33 ;
}
V_253 = V_247 + V_3 -> T_2 -> V_7 -> V_264 ;
V_35 = F_126 ( V_2 , V_253 , V_246 -> V_256 & V_257 , & V_196 ) ;
if ( V_35 == NULL )
goto V_152;
F_127 ( V_35 , V_253 - V_247 ) ;
if ( F_128 ( F_129 ( V_35 , V_247 ) , V_246 , V_247 ) ) {
V_196 = - V_59 ;
F_35 ( V_35 ) ;
goto V_152;
}
...
F_131 ( V_35 , 1 + F_133 ( V_252 ) ) ;
V_254 = F_134 ( V_35 -> V_43 , & V_3 -> V_24 , & V_250 . V_204 ,
V_252 , V_72 , V_81 ) ;
F_135 ( V_35 , V_254 ) ;
* F_136 ( V_35 ) = V_265 ;
...
static int F_138 ( struct V_126 * V_1 , struct V_245 * V_246 , T_8 V_253 ,
int V_210 )
{
struct V_1 * V_2 = V_1 -> V_2 ;
struct V_34 * V_35 ;
...
F_142 ( V_35 , 0 , V_246 , V_266 ) ;
if ( V_246 -> V_249 ) {
T_4 V_22 ;
T_3 V_268 ;
const unsigned char * V_269 = F_143 ( V_35 ) ;
F_124 ( struct V_197 * , V_250 , V_246 -> V_249 ) ;
memset ( V_250 , 0 , sizeof( struct V_193 ) ) ;
F_144 ( V_269 + 1 , V_35 -> V_43 - V_269 - 1 , & V_268 , NULL ,
& V_22 , NULL , NULL ) ;
V_250 -> V_199 = V_200 ;
V_250 -> V_207 = V_22 . V_32 ;
V_250 -> V_204 = V_268 ;
if ( V_250 -> V_207 != 0 ) {
int V_213 ;
...
V_246 -> V_255 = sizeof( struct V_193 ) ;
}
F_145 ( V_2 , V_35 ) ;
V_196 = V_266 ;
V_152:
...
static int F_146 ( struct V_126 * V_2 , int V_270 )
{
return - V_153 ;
}
...
{
struct V_1 * V_2 = V_1 -> V_2 ;
void T_5 * V_271 = ( void T_5 * ) V_54 ;
int V_134 = 0 ;
F_70 ( V_2 ) ;
switch ( V_53 ) {
case V_272 : {
long V_273 ;
V_273 = V_2 -> V_177 - F_148 ( V_2 ) ;
if ( V_273 < 0 )
V_273 = 0 ;
V_134 = F_77 ( V_273 , ( int T_5 * ) V_271 ) ;
break;
}
case V_274 : {
struct V_34 * V_35 ;
...
case V_275 :
V_134 = F_150 ( V_2 , V_271 ) ;
break;
case V_276 :
V_134 = F_151 ( V_2 , V_271 ) ;
break;
case V_277 :
case V_278 :
case V_279 : {
struct V_197 V_45 ;
if ( F_55 ( & V_45 , V_271 , sizeof( V_45 ) ) ) {
V_134 = - V_59 ;
break;
}
...
if ( F_69 ( V_273 , ( long T_5 * ) V_271 ) ) {
V_134 = - V_59 ;
break;
}
if ( V_273 < 0 || V_273 > V_282 ) {
V_134 = - V_64 ;
break;
}
V_201 = V_273 ;
...
V_134 = F_54 ( V_53 , V_271 ) ;
break;
case V_287 :
case V_288 : {
T_1 * V_3 = F_3 ( V_2 ) ;
struct V_289 V_290 ;
V_290 . V_86 = V_3 -> V_86 / V_52 ;
V_290 . V_88 = V_3 -> V_88 / V_52 ;
V_290 . V_93 = V_3 -> V_93 / V_52 ;
V_290 . V_95 = V_3 -> V_95 / ( 60 * V_52 ) ;
V_290 . V_91 = V_3 -> V_91 ;
V_290 . V_291 = F_154 ( & V_3 -> V_291 ) / V_52 ;
V_290 . V_292 = F_154 ( & V_3 -> V_292 ) / V_52 ;
V_290 . V_293 = F_154 ( & V_3 -> V_293 ) / V_52 ;
V_290 . V_294 = F_154 ( & V_3 -> V_294 ) / ( 60 * V_52 ) ;
V_290 . V_90 = V_3 -> V_90 ;
V_290 . V_46 = V_3 -> V_46 ;
V_290 . V_295 = F_155 ( V_2 ) ;
V_290 . V_296 = F_148 ( V_2 ) ;
V_290 . V_297 = V_3 -> V_297 ;
V_290 . V_298 = V_3 -> V_298 ;
V_290 . V_299 = V_3 -> V_299 ;
V_290 . V_300 = V_3 -> V_297 ;
V_290 . V_97 = V_3 -> V_97 ;
V_290 . V_83 = V_3 -> V_83 ;
if ( V_53 == V_288 ) {
static int V_301 = 0 ;
...
if ( F_78 ( V_271 , & V_290 , sizeof( struct V_303 ) ) ) {
V_134 = - V_59 ;
break;
}
} else {
if ( F_78 ( V_271 , & V_290 , sizeof( struct V_289 ) ) ) {
V_134 = - V_64 ;
break;
}
}
...
if ( F_55 ( & V_307 , V_271 , sizeof( V_307 ) ) ) {
V_134 = - V_59 ;
break;
}
V_134 = F_156 ( V_53 , & V_307 ) ;
break;
}
case V_308 :
case V_309 :
...
static void * F_157 ( struct V_319 * V_320 , T_9 * V_321 )
__acquires( V_5 )
{
F_6 ( & V_5 ) ;
return F_158 ( & V_20 , * V_321 ) ;
}
static void * F_159 ( struct V_319 * V_320 , void * V_322 , T_9 * V_321 )
{
return F_160 ( V_322 , & V_20 , V_321 ) ;
}
static void F_161 ( struct V_319 * V_320 , void * V_322 )
__releases( V_5 )
{
F_8 ( & V_5 ) ;
}
static int F_162 ( struct V_319 * V_320 , void * V_322 )
{
T_1 * V_3 = F_163 ( V_322 , struct T_1 , V_4 ) ;
char V_323 [ 11 ] ;
int V_57 ;
F_164 ( V_320 , L_3 ,
( long ) V_3 ,
V_3 -> T_2 == NULL ? L_4 : V_3 -> T_2 -> V_7 -> V_149 ,
F_165 ( V_323 , & V_3 -> V_24 ) ,
V_3 -> V_23 ? L_5 : L_6 ) ;
F_164 ( V_320 , L_7 , F_165 ( V_323 , & V_3 -> V_29 ) ) ;
for ( V_57 = 0 ; ( V_3 -> V_33 != NULL ) && ( V_57 < V_3 -> V_33 -> V_32 ) ; V_57 ++ ) {
F_164 ( V_320 , L_8 ,
F_165 ( V_323 , & V_3 -> V_33 -> V_67 [ V_57 ] ) ,
V_3 -> V_33 -> V_226 [ V_57 ] ? L_5 : L_6 ) ;
}
F_164 ( V_320 , L_9 ,
V_3 -> V_46 ,
V_3 -> V_297 , V_3 -> V_298 , V_3 -> V_299 ,
F_154 ( & V_3 -> V_291 ) / V_52 , V_3 -> V_86 / V_52 ,
F_154 ( & V_3 -> V_292 ) / V_52 , V_3 -> V_88 / V_52 ,
F_154 ( & V_3 -> V_293 ) / V_52 , V_3 -> V_93 / V_52 ,
F_154 ( & V_3 -> V_294 ) / ( 60 * V_52 ) ,
V_3 -> V_95 / ( 60 * V_52 ) ,
V_3 -> V_90 , V_3 -> V_91 ,
V_3 -> V_85 / V_52 ,
V_3 -> V_83 ,
...
static int F_168 ( struct V_324 * V_324 , struct V_325 * V_325 )
{
return F_169 ( V_325 , & V_326 ) ;
}
static int T_10 F_170 ( void )
{
int V_327 = F_171 ( & V_167 , 0 ) ;
if ( V_327 != 0 )
goto V_152;
F_172 ( & V_328 ) ;
F_173 ( & V_329 ) ;
F_174 ( & V_330 ) ;
F_175 ( L_12 , V_331 , V_15 . V_332 ,
& V_333 ) ;
F_175 ( L_13 , V_331 , V_15 . V_332 , & V_334 ) ;
F_175 ( L_14 , V_331 , V_15 . V_332 , & V_335 ) ;
V_152:
return V_327 ;
}
static void T_11 F_176 ( void )
{
F_177 ( L_12 , V_15 . V_332 ) ;
F_177 ( L_13 , V_15 . V_332 ) ;
F_177 ( L_14 , V_15 . V_332 ) ;
F_178 ( & V_330 ) ;
F_179 ( & V_329 ) ;
F_180 ( V_159 ) ;
F_181 ( & V_167 ) ;
