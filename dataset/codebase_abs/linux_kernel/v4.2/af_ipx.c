...
static void F_38 ( struct V_1 * V_16 )
{
if ( F_39 ( & V_16 -> V_46 ) )
F_29 ( V_16 ) ;
}
...
if ( F_62 ( V_57 ) -> V_87 == V_115 )
goto V_17;
V_113 = ( ( T_5 * ) V_60 ) + sizeof( struct V_59 ) ;
V_114 = ( T_3 * ) V_113 ;
...
{
T_6 * V_183 = ( T_6 * ) V_181 ;
T_7 V_184 = V_183 [ 1 ] + ( V_183 [ 2 ] & ( V_185 V_186 ) F_65 ( 0x00ff ) ) ;
T_7 V_23 = ( V_182 >> 1 ) - 3 ;
V_183 += 3 ;
while ( V_23 -- )
V_184 += * V_183 ++ ;
...
goto V_17;
V_2 = - V_66 ;
V_15 = F_102 ( V_27 , V_202 , V_203 , & V_204 , V_198 ) ;
if ( ! V_15 )
goto V_17;
F_103 ( V_15 ) ;
F_104 ( V_14 , V_15 ) ;
...
struct V_1 * V_16 ;
struct V_164 * V_216 = (struct V_164 * ) V_215 ;
int V_2 = - V_111 ;
if ( ! F_106 ( V_15 , V_44 ) || V_86 != sizeof( struct V_164 ) )
goto V_17;
V_16 = F_21 ( V_216 -> V_170 ) ;
V_2 = - V_129 ;
if ( ! V_16 )
goto V_17;
if ( ! V_216 -> V_217 ) {
V_216 -> V_217 = F_108 ( V_16 ) ;
V_2 = - V_111 ;
if ( ! V_216 -> V_217 )
goto V_74;
}
V_2 = - V_218 ;
if ( F_53 ( V_216 -> V_217 ) < V_125 &&
! F_110 ( V_219 ) )
goto V_74;
V_37 -> V_32 = V_216 -> V_217 ;
#ifdef F_111
if ( V_16 == V_45 ) {
V_2 = - V_111 ;
if ( ! memcmp ( V_216 -> V_172 , V_63 , V_38 ) )
goto V_74;
if ( ! memcmp ( V_216 -> V_172 , V_220 , V_38 ) )
memcpy ( V_37 -> V_5 , V_16 -> V_97 , V_38 ) ;
else
memcpy ( V_37 -> V_5 , V_216 -> V_172 , V_38 ) ;
V_2 = - V_131 ;
...
static int F_114 ( struct V_189 * V_14 , struct V_214 * V_215 , int V_86 )
{
struct V_14 * V_15 = V_14 -> V_15 ;
int V_2 ;
F_96 ( V_15 ) ;
V_2 = F_109 ( V_14 , V_215 , V_86 ) ;
F_97 ( V_15 ) ;
return V_2 ;
}
static int F_115 ( struct V_189 * V_14 , struct V_214 * V_215 ,
int V_86 , int V_95 )
{
struct V_14 * V_15 = V_14 -> V_15 ;
struct V_36 * V_37 = F_8 ( V_15 ) ;
...
if ( ! V_37 -> V_16 )
goto V_17;
memcpy ( V_215 . V_172 , V_37 -> V_16 -> V_97 ,
V_38 ) ;
#endif
V_2 = F_109 ( V_14 , (struct V_214 * ) & V_215 ,
sizeof( struct V_164 ) ) ;
if ( V_2 )
goto V_17;
}
V_222 = F_116 ( V_216 -> V_170 ) ;
V_2 = - V_227 ;
if ( ! V_222 && ! ( ! V_216 -> V_170 && V_8 ) )
goto V_17;
V_37 -> V_228 . V_27 = V_216 -> V_170 ;
V_37 -> V_228 . V_14 = V_216 -> V_217 ;
memcpy ( V_37 -> V_228 . V_5 , V_216 -> V_172 , V_38 ) ;
V_37 -> type = V_216 -> V_173 ;
if ( V_14 -> type == V_201 ) {
V_14 -> V_225 = V_229 ;
V_15 -> V_223 = V_230 ;
}
...
static int F_118 ( struct V_189 * V_14 , struct V_214 * V_215 ,
int * V_231 , int V_232 )
{
struct V_233 * V_216 ;
struct V_164 V_165 ;
...
goto V_17;
V_216 = & V_37 -> V_228 ;
V_165 . V_170 = V_216 -> V_27 ;
V_165 . V_217 = V_216 -> V_14 ;
memcpy ( V_165 . V_172 , V_216 -> V_5 , V_38 ) ;
} else {
if ( V_37 -> V_16 ) {
...
V_165 . V_217 = V_37 -> V_32 ;
}
V_165 . V_168 = V_169 ;
V_165 . V_173 = V_37 -> type ;
V_165 . V_235 = 0 ;
memcpy ( V_215 , & V_165 , sizeof( V_165 ) ) ;
V_2 = 0 ;
V_17:
F_97 ( V_15 ) ;
return V_2 ;
}
static int F_119 ( struct V_56 * V_57 , struct V_20 * V_21 , struct V_236 * V_237 , struct V_20 * V_238 )
{
struct V_1 * V_16 ;
struct V_59 * V_60 ;
V_186 V_116 ;
...
static int F_122 ( struct V_189 * V_14 , struct V_243 * V_244 , T_8 V_79 )
{
struct V_14 * V_15 = V_14 -> V_15 ;
struct V_36 * V_37 = F_8 ( V_15 ) ;
F_123 ( struct V_164 * , V_245 , V_244 -> V_246 ) ;
struct V_164 V_247 ;
int V_2 = - V_111 ;
...
V_245 -> V_217 = V_37 -> V_228 . V_14 ;
V_245 -> V_170 = V_37 -> V_228 . V_27 ;
memcpy ( V_245 -> V_172 , V_37 -> V_228 . V_5 , V_38 ) ;
}
V_2 = F_124 ( V_15 , V_245 , V_244 , V_79 , V_95 & V_249 ) ;
if ( V_2 >= 0 )
V_2 = V_79 ;
V_17:
F_97 ( V_15 ) ;
...
static int F_125 ( struct V_189 * V_14 , struct V_243 * V_244 , T_8 V_252 ,
int V_95 )
{
struct V_14 * V_15 = V_14 -> V_15 ;
struct V_36 * V_37 = F_8 ( V_15 ) ;
F_123 ( struct V_164 * , V_165 , V_244 -> V_246 ) ;
...
if ( ! V_37 -> V_16 )
goto V_17;
memcpy ( V_215 . V_172 , V_37 -> V_16 -> V_97 , V_38 ) ;
#endif
V_2 = F_109 ( V_14 , (struct V_214 * ) & V_215 ,
sizeof( struct V_164 ) ) ;
if ( V_2 )
...
F_97 ( V_15 ) ;
V_254 = false ;
V_57 = F_126 ( V_15 , V_95 & ~ V_249 ,
V_95 & V_249 , & V_2 ) ;
if ( ! V_57 ) {
if ( V_2 == - V_132 && ( V_15 -> V_208 & V_255 ) )
V_2 = 0 ;
goto V_17;
}
V_60 = F_50 ( V_57 ) ;
V_253 = F_53 ( V_60 -> V_116 ) - sizeof( struct V_59 ) ;
if ( V_253 > V_252 ) {
V_253 = V_252 ;
V_244 -> V_248 |= V_256 ;
}
V_2 = F_127 ( V_57 , sizeof( struct V_59 ) , V_244 , V_253 ) ;
if ( V_2 )
goto V_257;
if ( V_57 -> V_258 . V_259 )
V_15 -> V_260 = V_57 -> V_258 ;
if ( V_165 ) {
V_165 -> V_168 = V_169 ;
V_165 -> V_217 = V_60 -> V_89 . V_14 ;
...
static int F_129 ( struct V_189 * V_14 , unsigned int V_160 , unsigned long V_10 )
{
int V_2 = 0 ;
long V_261 = 0 ;
struct V_14 * V_15 = V_14 -> V_15 ;
void T_1 * V_262 = ( void T_1 * ) V_10 ;
F_96 ( V_15 ) ;
switch ( V_160 ) {
case V_263 :
V_261 = V_15 -> V_264 - F_130 ( V_15 ) ;
if ( V_261 < 0 )
V_261 = 0 ;
V_2 = F_100 ( V_261 , ( int T_1 * ) V_262 ) ;
break;
case V_265 : {
struct V_56 * V_57 = F_131 ( & V_15 -> V_19 ) ;
if ( V_57 )
V_261 = V_57 -> V_79 - sizeof( struct V_59 ) ;
V_2 = F_100 ( V_261 , ( int T_1 * ) V_262 ) ;
break;
}
case V_266 :
...
( const unsigned short T_1 * ) V_262 ) ;
break;
case V_271 :
V_2 = F_133 ( V_15 , V_262 ) ;
break;
case V_272 :
case V_273 :
case V_274 :
...
static int F_134 ( struct V_189 * V_14 , unsigned int V_160 , unsigned long V_10 )
{
switch ( V_160 ) {
case V_179 :
case V_180 :
case V_269 :
case V_270 :
return F_129 ( V_14 , V_160 , V_10 ) ;
default:
return - V_278 ;
}
}
static int F_135 ( struct V_189 * V_14 , int V_279 )
{
struct V_14 * V_15 = V_14 -> V_15 ;
...
F_72 ( V_286 ) ;
V_146 = F_142 ( V_287 , F_119 ) ;
if ( ! V_146 )
F_72 ( V_288 ) ;
V_149 = F_143 ( V_289 , F_119 ) ;
if ( ! V_149 )
F_72 ( V_290 ) ;
F_144 ( & V_291 ) ;
F_145 () ;
