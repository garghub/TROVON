...
F_1 ( & V_12 -> V_2 ) ;
V_12 -> V_17 = 0 ;
} else if ( F_15 ( V_28 -> V_39 ) == V_12 -> V_17 ) {
F_22 ( & V_12 -> V_2 , V_24 ) ;
V_12 -> V_17 = 0 ;
}
V_41:
...
static struct V_23 *
F_23 ( struct V_1 * V_12 )
{
struct V_20 * V_42 ;
struct V_3 * V_4 ;
struct V_23 * V_43 = NULL ;
int V_17 , V_30 = sizeof( struct V_20 ) ;
V_4 = F_24 ( V_12 -> V_44 , struct V_3 , V_7 ) ;
F_3 ( & V_4 -> V_7 ) ;
V_43 = V_4 -> V_8 ;
F_5 ( V_4 ) ;
V_42 = (struct V_20 * ) V_43 -> V_33 ;
V_17 = F_15 ( V_42 -> V_39 ) ;
if ( F_25 ( V_43 , 0 , V_17 - V_43 -> V_36 , V_34 ) < 0 ) {
F_4 ( V_43 ) ;
V_43 = NULL ;
goto free;
}
F_26 ( V_43 , V_30 ) ;
memmove ( V_43 -> V_33 - V_45 , F_27 ( V_43 ) , V_45 ) ;
F_28 ( V_43 , - V_45 ) ;
F_29 ( V_43 ) ;
F_30 ( V_43 ) ;
F_18 (entry, chain, list) {
V_17 = V_4 -> V_8 -> V_36 - V_30 ;
memcpy ( F_31 ( V_43 , V_17 ) , V_4 -> V_8 -> V_33 + V_30 ,
V_17 ) ;
}
free:
F_1 ( V_12 ) ;
...
struct V_9 * V_46 )
{
struct V_51 * V_52 = F_34 ( V_50 -> V_53 ) ;
...
V_54 = F_35 ( V_52 , V_42 -> V_57 ) ;
if ( ! V_54 )
goto V_40;
V_56 = F_36 ( V_52 , V_54 , V_50 ) ;
if ( ! V_56 )
goto V_40;
V_39 = F_15 ( V_42 -> V_39 ) ;
...
V_66 = F_43 ( NULL , V_60 + V_45 ) ;
if ( ! V_66 )
goto V_32;
V_8 -> V_69 = V_70 ;
F_44 ( V_66 , V_67 + V_45 ) ;
F_45 ( V_8 , V_66 , V_8 -> V_36 - V_68 ) ;
F_46 ( V_66 , V_67 ) ;
...
V_72 . V_77 = V_78 ;
V_72 . V_63 = V_79 ;
V_72 . V_22 = F_50 ( F_51 ( & V_52 -> V_80 ) ) ;
V_72 . V_81 = 0 ;
V_72 . V_35 = 0 ;
V_72 . V_39 = F_50 ( V_8 -> V_36 ) ;
F_52 ( V_72 . V_82 , V_71 -> V_59 -> V_83 ) ;
F_52 ( V_72 . V_57 , V_10 -> V_82 ) ;
while ( V_8 -> V_36 > V_73 ) {
V_66 = F_42 ( V_8 , & V_72 , V_60 ) ;
if ( ! V_66 )
goto V_48;
F_37 ( V_52 , V_84 ) ;
F_38 ( V_52 , V_85 ,
...
if ( F_53 ( V_8 , V_67 ) < 0 ||
F_25 ( V_8 , V_67 + V_45 , 0 , V_34 ) < 0 )
goto V_48;
memcpy ( V_8 -> V_33 , & V_72 , V_67 ) ;
F_37 ( V_52 , V_84 ) ;
F_38 ( V_52 , V_85 ,
V_8 -> V_36 + V_45 ) ;
F_39 ( V_8 , V_56 -> V_58 , V_56 -> V_64 ) ;
V_31 = true ;
V_48:
if ( V_71 )
F_54 ( V_71 ) ;
