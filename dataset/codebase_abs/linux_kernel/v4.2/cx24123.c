...
struct V_7 V_8 [] , int V_145 )
{
struct V_1 * V_2 = F_41 ( V_144 ) ;
F_22 ( V_2 , 1 , 1 ) ;
return F_2 ( V_2 -> V_13 , V_8 , V_145 ) ;
}
static T_2 F_42 ( struct V_143 * V_146 )
{
return V_147 ;
}
struct V_143 *
...
struct V_53 * F_44 ( const struct V_148 * V_95 ,
struct V_143 * V_13 )
{
struct V_1 * V_2 =
F_45 ( sizeof( struct V_1 ) , V_149 ) ;
F_7 ( L_30 ) ;
if ( V_2 == NULL ) {
V_12 ( L_40 ) ;
goto error;
...
memcpy ( & V_2 -> V_47 . V_48 , & V_151 ,
sizeof( struct V_152 ) ) ;
V_2 -> V_47 . V_58 = V_2 ;
if ( V_95 -> V_97 )
F_22 ( V_2 , 1 , 0 ) ;
F_46 ( V_2 -> V_142 . V_153 , L_44 ,
sizeof( V_2 -> V_142 . V_153 ) ) ;
V_2 -> V_142 . V_154 = & V_155 ;
V_2 -> V_142 . V_156 = NULL ;
V_2 -> V_142 . V_157 . V_158 = V_13 -> V_157 . V_158 ;
F_47 ( & V_2 -> V_142 , V_2 ) ;
if ( F_48 ( & V_2 -> V_142 ) < 0 ) {
V_12 ( L_45 ) ;
goto error;
