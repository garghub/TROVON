...
if ( V_29 ) {
if ( F_6 () ) {
F_142 ( V_15 , V_17 , V_130 , F_33 ( V_210 ) , V_122 ) ;
F_51 ( V_15 ) ;
} else {
if ( V_22 ) {
F_47 ( V_15 , V_208 , V_209 , V_22 ) ;
V_209 = V_208 ;
}
F_50 ( V_15 , V_208 , V_209 , 1 ) ;
...
F_50 ( V_15 , V_208 , V_209 ,
( V_210 | V_211 ) >> V_22 ) ;
F_143 ( V_15 , V_208 , V_208 ,
( V_210 | V_211 ) >> V_22 ) ;
...
unsigned int V_134 )
{
unsigned int V_148 = V_205 | V_212 ;
...
unsigned int V_134 )
{
unsigned int V_148 = ( V_212 | V_214 | V_205
| V_206 ) ;
F_134 ( V_15 , V_17 , V_130 , V_134 , V_148 ) ;
}
static void
...
{
if ( F_6 () ) {
F_142 ( V_15 , V_17 , V_130 , F_33 ( V_213 ) , V_122 ) ;
F_51 ( V_15 ) ;
} else {
int V_208 = V_170 >= 0 ? V_170 : V_130 ;
...
{
T_3 * V_15 = V_216 ;
const int V_217 = V_218 - V_216 ;
struct V_20 * V_21 = V_180 ;
struct V_16 * V_17 = V_181 ;
memset ( V_216 , 0 , V_217 * sizeof( V_216 [ 0 ] ) ) ;
memset ( V_180 , 0 , sizeof( V_180 ) ) ;
memset ( V_181 , 0 , sizeof( V_181 ) ) ;
F_151 ( & V_15 , V_47 , V_49 ) ;
F_141 ( & V_15 , & V_17 , V_47 , V_49 , - 1 , V_219 ) ;
F_51 ( & V_15 ) ;
...
F_126 ( V_181 , V_180 ) ;
F_19 ( L_32 ,
( unsigned int ) ( V_15 - V_216 ) ) ;
F_23 ( L_33 , V_216 , V_217 ) ;
}
static void F_155 ( void )
{
T_3 * V_15 = V_220 ;
const int V_221 = V_222 - V_220 ;
struct V_20 * V_21 = V_180 ;
struct V_16 * V_17 = V_181 ;
memset ( V_220 , 0 , V_221 * sizeof( V_220 [ 0 ] ) ) ;
memset ( V_180 , 0 , sizeof( V_180 ) ) ;
memset ( V_181 , 0 , sizeof( V_181 ) ) ;
F_151 ( & V_15 , V_47 , V_49 ) ;
F_145 ( & V_15 , & V_17 , V_47 , V_49 , - 1 , V_223 ) ;
F_51 ( & V_15 ) ;
F_146 ( & V_15 , & V_17 , V_47 , V_49 ) ;
F_149 ( & V_15 , & V_21 , & V_17 , V_47 , V_49 ) ;
F_156 ( & V_21 , V_15 ) ;
F_154 ( & V_15 , ( unsigned long ) V_224 & 0x0fffffff ) ;
F_51 ( & V_15 ) ;
if ( V_15 >= V_222 )
F_56 ( L_34 ) ;
F_126 ( V_181 , V_180 ) ;
F_19 ( L_35 ,
( unsigned int ) ( V_15 - V_220 ) ) ;
F_23 ( L_36 , V_220 , V_221 ) ;
}
static void F_157 ( void )
{
T_3 * V_15 = V_225 ;
const int V_226 = V_227 - V_225 ;
struct V_20 * V_21 = V_180 ;
struct V_16 * V_17 = V_181 ;
memset ( V_225 , 0 , V_226 * sizeof( V_225 [ 0 ] ) ) ;
memset ( V_180 , 0 , sizeof( V_180 ) ) ;
memset ( V_181 , 0 , sizeof( V_181 ) ) ;
F_151 ( & V_15 , V_47 , V_49 ) ;
F_147 ( & V_15 , & V_17 , V_47 , V_49 , - 1 , V_228 ) ;
F_51 ( & V_15 ) ;
F_146 ( & V_15 , & V_17 , V_47 , V_49 ) ;
...
F_126 ( V_181 , V_180 ) ;
F_19 ( L_38 ,
( unsigned int ) ( V_15 - V_225 ) ) ;
F_23 ( L_39 , V_225 , V_226 ) ;
}
static struct V_44
F_159 ( T_3 * * V_15 , struct V_20 * * V_21 ,
struct V_16 * * V_17 )
{
struct V_44 V_229 = F_27 ( V_15 ) ;
#ifdef V_185
F_81 ( V_15 , V_21 , V_17 , V_229 . V_46 , V_229 . V_48 ) ;
#else
F_100 ( V_15 , V_229 . V_46 , V_229 . V_48 ) ;
#endif
#ifdef F_20
F_72 ( V_15 , V_17 , V_229 . V_46 , V_229 . V_48 , V_135 ) ;
#endif
F_39 ( V_15 , V_229 . V_46 , V_59 ) ;
F_40 ( V_15 , V_229 . V_48 , 0 , V_229 . V_48 ) ;
F_67 ( V_15 , V_229 . V_46 , V_229 . V_46 , V_139 + V_230 - V_161 ) ;
F_50 ( V_15 , V_229 . V_46 , V_229 . V_46 , ( V_163 - 1 ) << V_161 ) ;
F_35 ( V_15 , V_229 . V_48 , V_229 . V_48 , V_229 . V_46 ) ;
#ifdef F_78
F_160 ( V_21 , * V_15 ) ;
#endif
F_131 ( V_15 , V_229 . V_46 , V_229 . V_48 ) ;
if ( ! F_12 () ) {
F_58 ( V_15 ) ;
if ( V_231 ) {
F_62 ( V_15 ) ;
F_42 ( V_15 , V_229 . V_50 , V_171 ) ;
F_84 ( V_15 , V_17 , V_229 . V_50 , V_127 ) ;
F_51 ( V_15 ) ;
}
}
return V_229 ;
...
V_229 = F_159 ( & V_15 , & V_21 , & V_17 ) ;
F_141 ( & V_15 , & V_17 , V_229 . V_46 , V_229 . V_48 , V_229 . V_50 , V_219 ) ;
if ( F_12 () )
F_58 ( & V_15 ) ;
if ( V_29 && ! V_232 ) {
if ( F_6 () ) {
F_142 ( & V_15 , & V_17 , V_229 . V_46 , F_33 ( V_205 ) ,
V_203 ) ;
} else {
F_50 ( & V_15 , V_229 . V_50 , V_229 . V_46 , V_205 ) ;
F_80 ( & V_15 , & V_17 , V_229 . V_50 , V_203 ) ;
}
F_51 ( & V_15 ) ;
F_163 ( & V_15 ) ;
switch ( F_7 () ) {
...
if ( F_6 () ) {
F_164 ( & V_15 , V_229 . V_48 , F_33 ( sizeof( V_167 ) ) , 8 ) ;
} else {
F_50 ( & V_15 , V_229 . V_50 , V_229 . V_48 , sizeof( V_167 ) ) ;
F_165 ( & V_15 , V_229 . V_50 , 8 ) ;
}
F_39 ( & V_15 , V_229 . V_50 , V_61 ) ;
F_39 ( & V_15 , V_229 . V_50 , V_133 ) ;
if ( F_6 () ) {
F_73 ( & V_15 , & V_17 , V_229 . V_50 , 1 , V_219 ) ;
F_51 ( & V_15 ) ;
F_130 ( & V_21 , V_15 ) ;
} else {
F_50 ( & V_15 , V_229 . V_50 , V_229 . V_50 , 2 ) ;
F_74 ( & V_15 , & V_17 , V_229 . V_50 , V_219 ) ;
F_51 ( & V_15 ) ;
}
F_130 ( & V_21 , V_15 ) ;
}
F_144 ( & V_15 , & V_17 , V_229 . V_46 , V_229 . V_48 ) ;
F_161 ( & V_15 , & V_21 , & V_17 , V_229 . V_46 , V_229 . V_48 ) ;
#ifdef F_20
F_118 ( & V_21 , V_15 ) ;
F_131 ( & V_15 , V_229 . V_46 , V_229 . V_48 ) ;
F_141 ( & V_15 , & V_17 , V_229 . V_46 , V_229 . V_48 , V_229 . V_50 , V_219 ) ;
...
F_50 ( & V_15 , V_229 . V_50 , V_229 . V_46 , V_205 ) ;
F_80 ( & V_15 , & V_17 , V_229 . V_50 , V_233 ) ;
}
F_51 ( & V_15 ) ;
F_163 ( & V_15 ) ;
switch ( F_7 () ) {
...
F_39 ( & V_15 , V_229 . V_50 , V_133 ) ;
if ( F_6 () ) {
F_142 ( & V_15 , & V_17 , V_229 . V_50 , 1 , V_233 ) ;
} else {
F_50 ( & V_15 , V_229 . V_50 , V_229 . V_50 , 2 ) ;
F_80 ( & V_15 , & V_17 , V_229 . V_50 , V_233 ) ;
}
if ( V_124 == 0 )
F_51 ( & V_15 ) ;
F_68 ( & V_15 , & V_17 , V_229 . V_50 , V_219 , 0 ) ;
F_166 ( & V_21 , V_15 ) ;
}
F_69 ( & V_15 , V_229 . V_46 , V_229 . V_46 , ( V_212 | V_205 ) ) ;
F_77 ( & V_15 , & V_17 , & V_21 , V_229 . V_46 , V_229 . V_48 ) ;
#endif
F_153 ( & V_21 , V_15 ) ;
F_38 ( & V_15 ) ;
#ifdef F_167
...
memset ( V_181 , 0 , sizeof( V_181 ) ) ;
V_229 = F_159 ( & V_15 , & V_21 , & V_17 ) ;
F_145 ( & V_15 , & V_17 , V_229 . V_46 , V_229 . V_48 , V_229 . V_50 , V_223 ) ;
if ( F_12 () )
F_58 ( & V_15 ) ;
F_146 ( & V_15 , & V_17 , V_229 . V_46 , V_229 . V_48 ) ;
F_161 ( & V_15 , & V_21 , & V_17 , V_229 . V_46 , V_229 . V_48 ) ;
#ifdef F_20
F_118 ( & V_21 , V_15 ) ;
F_131 ( & V_15 , V_229 . V_46 , V_229 . V_48 ) ;
F_145 ( & V_15 , & V_17 , V_229 . V_46 , V_229 . V_48 , V_229 . V_50 , V_223 ) ;
F_58 ( & V_15 ) ;
F_69 ( & V_15 , V_229 . V_46 , V_229 . V_46 ,
V_212 | V_214 | V_205 | V_206 ) ;
F_77 ( & V_15 , & V_17 , & V_21 , V_229 . V_46 , V_229 . V_48 ) ;
#endif
F_156 ( & V_21 , V_15 ) ;
F_38 ( & V_15 ) ;
#ifdef F_167
if ( ( unsigned long ) V_224 & 1 ) {
F_43 ( & V_15 , V_47 , F_44 ( ( long ) V_224 ) ) ;
F_97 ( & V_15 , V_47 , V_47 , F_46 ( ( long ) V_224 ) ) ;
F_54 ( & V_15 , V_47 ) ;
} else
#endif
F_154 ( & V_15 , ( unsigned long ) V_224 & 0x0fffffff ) ;
...
memset ( V_181 , 0 , sizeof( V_181 ) ) ;
V_229 = F_159 ( & V_15 , & V_21 , & V_17 ) ;
F_147 ( & V_15 , & V_17 , V_229 . V_46 , V_229 . V_48 , V_229 . V_50 , V_228 ) ;
if ( F_12 () )
F_58 ( & V_15 ) ;
F_146 ( & V_15 , & V_17 , V_229 . V_46 , V_229 . V_48 ) ;
F_161 ( & V_15 , & V_21 , & V_17 , V_229 . V_46 , V_229 . V_48 ) ;
...
F_19 ( L_38 ,
( unsigned int ) ( V_15 - V_225 ) ) ;
F_23 ( L_42 , V_225 , V_226 ) ;
}
static void F_170 ( void )
{
F_57 ( ( unsigned long ) V_216 ,
( unsigned long ) V_218 ) ;
F_57 ( ( unsigned long ) V_220 ,
( unsigned long ) V_222 ) ;
F_57 ( ( unsigned long ) V_225 ,
( unsigned long ) V_227 ) ;
...
unsigned long V_234 ;
unsigned int V_235 ;
const int V_236 = 2 * sizeof( unsigned long ) ;
V_234 = F_172 () ;
F_19 ( L_43 ,
V_236 , V_234 ,
( V_234 & V_237 ) >> V_238 ,
...
V_266 = F_33 ( V_143 ) << V_248 ;
V_266 |= F_33 ( V_163 ) << V_254 ;
if ( F_179 () & V_270 )
V_266 |= 1 ;
F_180 ( V_266 ) ;
F_177 () ;
...
F_17 () ;
#ifdef V_185
V_136 = V_11 . V_273 > ( V_137 + V_138 + V_139 - 3 ) ;
#endif
switch ( F_7 () ) {
case V_274 :
case V_275 :
