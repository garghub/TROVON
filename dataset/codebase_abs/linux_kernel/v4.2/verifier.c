...
if ( V_68 )
return V_68 ;
if ( ( V_52 == V_145 || V_52 == V_146 ) &&
F_6 ( V_31 -> V_33 ) == V_147 && V_31 -> V_18 == 0 ) {
F_1 ( L_57 ) ;
return - V_77 ;
}
if ( V_52 == V_148 && F_5 ( V_31 -> V_33 ) == V_35 &&
...
if ( V_68 )
return V_68 ;
if ( F_6 ( V_31 -> V_33 ) == V_147 &&
( V_52 == V_150 || V_52 == V_151 ) &&
V_13 [ V_31 -> V_37 ] . type == V_16 &&
V_13 [ V_31 -> V_37 ] . V_18 == V_31 -> V_18 ) {
if ( V_52 == V_150 ) {
* V_61 += V_31 -> V_43 ;
...
V_149 = F_12 ( V_7 , * V_61 + V_31 -> V_43 + 1 , * V_61 ) ;
if ( ! V_149 )
return - V_114 ;
if ( F_6 ( V_31 -> V_33 ) == V_147 &&
V_31 -> V_18 == 0 && ( V_52 == V_150 ||
V_52 == V_151 ) &&
V_13 [ V_31 -> V_37 ] . type == V_21 ) {
if ( V_52 == V_150 ) {
V_13 [ V_31 -> V_37 ] . type = V_20 ;
V_149 -> V_13 [ V_31 -> V_37 ] . type = V_16 ;
V_149 -> V_13 [ V_31 -> V_37 ] . V_18 = 0 ;
} else {
V_149 -> V_13 [ V_31 -> V_37 ] . type = V_20 ;
V_13 [ V_31 -> V_37 ] . type = V_16 ;
V_13 [ V_31 -> V_37 ] . V_18 = 0 ;
}
} else if ( F_6 ( V_31 -> V_33 ) == V_147 &&
( V_52 == V_150 || V_52 == V_151 ) ) {
if ( V_52 == V_150 ) {
V_149 -> V_13 [ V_31 -> V_37 ] . type = V_16 ;
V_149 -> V_13 [ V_31 -> V_37 ] . V_18 = V_31 -> V_18 ;
} else {
V_13 [ V_31 -> V_37 ] . type = V_16 ;
V_13 [ V_31 -> V_37 ] . V_18 = V_31 -> V_18 ;
}
...
{
T_4 V_152 = ( ( T_4 ) ( T_3 ) V_31 [ 0 ] . V_18 ) | ( ( T_4 ) ( T_3 ) V_31 [ 1 ] . V_18 ) << 32 ;
return (struct V_91 * ) ( unsigned long ) V_152 ;
}
...
( V_158 == V_48 && V_31 -> V_39 != V_135 ) ) {
F_1 ( L_63 ) ;
return - V_77 ;
}
V_68 = F_17 ( V_13 , V_159 , V_78 ) ;
if ( V_68 )
return V_68 ;
if ( V_13 [ V_159 ] . type != V_73 ) {
F_1 ( L_64 ) ;
return - V_77 ;
}
if ( V_158 == V_49 ) {
...
static int F_34 ( int V_9 , int V_160 , int V_161 , struct V_6 * V_7 )
{
if ( V_161 == V_162 && V_163 [ V_9 ] >= ( V_164 | V_162 ) )
return 0 ;
if ( V_161 == V_165 && V_163 [ V_9 ] >= ( V_164 | V_165 ) )
return 0 ;
if ( V_160 < 0 || V_160 >= V_7 -> V_94 -> V_166 ) {
F_1 ( L_65 , V_9 , V_160 ) ;
return - V_77 ;
}
if ( V_161 == V_165 )
V_7 -> V_167 [ V_160 ] = V_168 ;
if ( V_163 [ V_160 ] == 0 ) {
V_163 [ V_9 ] = V_164 | V_161 ;
V_163 [ V_160 ] = V_164 ;
if ( V_169 >= V_7 -> V_94 -> V_166 )
return - V_170 ;
V_171 [ V_169 ++ ] = V_160 ;
return 1 ;
} else if ( ( V_163 [ V_160 ] & 0xF0 ) == V_164 ) {
F_1 ( L_66 , V_9 , V_160 ) ;
return - V_77 ;
} else if ( V_163 [ V_160 ] == V_172 ) {
V_163 [ V_9 ] = V_164 | V_161 ;
} else {
F_1 ( L_67 ) ;
return - V_114 ;
...
{
struct V_30 * V_173 = V_7 -> V_94 -> V_174 ;
int V_175 = V_7 -> V_94 -> V_166 ;
int V_176 = 0 ;
int V_10 , V_9 ;
V_163 = F_36 ( V_175 , sizeof( int ) , V_67 ) ;
if ( ! V_163 )
return - V_177 ;
V_171 = F_36 ( V_175 , sizeof( int ) , V_67 ) ;
if ( ! V_171 ) {
F_11 ( V_163 ) ;
return - V_177 ;
}
...
goto V_179;
V_9 = V_171 [ V_169 - 1 ] ;
if ( F_5 ( V_173 [ V_9 ] . V_33 ) == V_51 ) {
T_2 V_52 = F_7 ( V_173 [ V_9 ] . V_33 ) ;
if ( V_52 == V_55 ) {
goto V_180;
} else if ( V_52 == V_53 ) {
V_176 = F_34 ( V_9 , V_9 + 1 , V_162 , V_7 ) ;
if ( V_176 == 1 )
goto V_178;
else if ( V_176 < 0 )
goto V_181;
} else if ( V_52 == V_54 ) {
if ( F_6 ( V_173 [ V_9 ] . V_33 ) != V_147 ) {
V_176 = - V_77 ;
goto V_181;
}
V_176 = F_34 ( V_9 , V_9 + V_173 [ V_9 ] . V_43 + 1 ,
V_162 , V_7 ) ;
if ( V_176 == 1 )
goto V_178;
else if ( V_176 < 0 )
...
goto V_181;
V_176 = F_34 ( V_9 , V_9 + V_173 [ V_9 ] . V_43 + 1 , V_165 , V_7 ) ;
if ( V_176 == 1 )
goto V_178;
else if ( V_176 < 0 )
goto V_181;
...
static bool F_37 ( struct V_66 * V_182 , struct V_66 * V_183 )
{
int V_10 ;
for ( V_10 = 0 ; V_10 < V_11 ; V_10 ++ ) {
if ( memcmp ( & V_182 -> V_13 [ V_10 ] , & V_183 -> V_13 [ V_10 ] ,
sizeof( V_182 -> V_13 [ 0 ] ) ) != 0 ) {
if ( V_182 -> V_13 [ V_10 ] . type == V_14 ||
( V_182 -> V_13 [ V_10 ] . type == V_75 &&
V_183 -> V_13 [ V_10 ] . type != V_14 ) )
continue;
return false ;
}
}
for ( V_10 = 0 ; V_10 < V_25 ; V_10 ++ ) {
if ( V_182 -> V_27 [ V_10 ] == V_184 )
continue;
if ( V_182 -> V_27 [ V_10 ] != V_183 -> V_27 [ V_10 ] )
return false ;
if ( V_10 % V_26 )
continue;
if ( memcmp ( & V_182 -> V_29 [ V_10 / V_26 ] ,
& V_183 -> V_29 [ V_10 / V_26 ] ,
sizeof( V_182 -> V_29 [ 0 ] ) ) )
return false ;
else
continue;
...
struct V_185 * V_186 ;
struct V_185 * V_187 ;
V_187 = V_7 -> V_167 [ V_61 ] ;
if ( ! V_187 )
return 0 ;
while ( V_187 != V_168 ) {
if ( F_37 ( & V_187 -> V_86 , & V_7 -> V_12 ) )
return 1 ;
V_187 = V_187 -> V_64 ;
}
V_186 = F_13 ( sizeof( struct V_185 ) , V_188 ) ;
if ( ! V_186 )
return - V_177 ;
memcpy ( & V_186 -> V_86 , & V_7 -> V_12 , sizeof( V_7 -> V_12 ) ) ;
V_186 -> V_64 = V_7 -> V_167 [ V_61 ] ;
V_7 -> V_167 [ V_61 ] = V_186 ;
return 0 ;
}
...
if ( V_68 )
return V_68 ;
V_68 = F_17 ( V_13 , V_31 -> V_37 , V_193 ) ;
if ( V_68 )
return V_68 ;
V_192 = V_13 [ V_31 -> V_39 ] . type ;
...
{
struct V_30 * V_31 = V_7 -> V_94 -> V_174 ;
int V_175 = V_7 -> V_94 -> V_166 ;
int V_10 , V_195 ;
for ( V_10 = 0 ; V_10 < V_175 ; V_10 ++ , V_31 ++ ) {
...
for ( V_195 = 0 ; V_195 < V_7 -> V_199 ; V_195 ++ )
if ( V_7 -> V_200 [ V_195 ] == V_92 ) {
F_44 ( V_197 ) ;
goto V_198;
}
if ( V_7 -> V_199 >= V_201 ) {
...
{
int V_10 ;
for ( V_10 = 0 ; V_10 < V_7 -> V_199 ; V_10 ++ )
F_48 ( V_7 -> V_200 [ V_10 ] ) ;
}
...
static void F_50 ( struct V_203 * V_94 , int V_204 , int V_205 )
{
struct V_30 * V_31 = V_94 -> V_174 ;
int V_175 = V_94 -> V_166 ;
int V_10 ;
for ( V_10 = 0 ; V_10 < V_175 ; V_10 ++ , V_31 ++ ) {
...
F_7 ( V_31 -> V_33 ) == V_55 )
continue;
if ( V_10 < V_204 && V_10 + V_31 -> V_43 + 1 > V_204 )
V_31 -> V_43 += V_205 ;
else if ( V_10 > V_204 && V_10 + V_31 -> V_43 + 1 < V_204 )
V_31 -> V_43 -= V_205 ;
}
}
...
struct V_30 * V_31 = V_7 -> V_94 -> V_174 ;
int V_175 = V_7 -> V_94 -> V_166 ;
struct V_30 V_206 [ 16 ] ;
struct V_203 * V_207 ;
T_3 V_208 ;
int V_10 ;
enum V_93 type ;
if ( ! V_7 -> V_94 -> V_95 -> V_96 -> V_209 )
return 0 ;
for ( V_10 = 0 ; V_10 < V_175 ; V_10 ++ , V_31 ++ ) {
...
V_208 = V_7 -> V_94 -> V_95 -> V_96 ->
V_209 ( type , V_31 -> V_37 , V_31 -> V_39 ,
V_31 -> V_43 , V_206 ) ;
if ( V_208 == 0 || V_208 >= F_52 ( V_206 ) ) {
F_1 ( L_88 ) ;
return - V_77 ;
}
if ( V_208 == 1 ) {
memcpy ( V_31 , V_206 , sizeof( * V_31 ) ) ;
continue;
}
V_175 += V_208 - 1 ;
V_207 = F_53 ( V_7 -> V_94 ,
...
return - V_177 ;
V_207 -> V_166 = V_175 ;
memmove ( V_207 -> V_174 + V_10 + V_208 , V_207 -> V_173 + V_10 + 1 ,
sizeof( * V_31 ) * ( V_175 - V_10 - V_208 ) ) ;
memcpy ( V_207 -> V_174 + V_10 , V_206 , sizeof( * V_31 ) * V_208 ) ;
F_50 ( V_207 , V_10 , V_208 - 1 ) ;
V_7 -> V_94 = V_207 ;
V_31 = V_207 -> V_174 + V_10 + V_208 - 1 ;
V_10 += V_208 - 1 ;
}
return 0 ;
}
...
{
struct V_185 * V_187 , * V_210 ;
int V_10 ;
if ( ! V_7 -> V_167 )
return;
for ( V_10 = 0 ; V_10 < V_7 -> V_94 -> V_166 ; V_10 ++ ) {
V_187 = V_7 -> V_167 [ V_10 ] ;
if ( V_187 )
while ( V_187 != V_168 ) {
V_210 = V_187 -> V_64 ;
F_11 ( V_187 ) ;
...
int F_56 ( struct V_203 * * V_94 , union V_211 * V_212 )
{
char T_5 * V_213 = NULL ;
struct V_6 * V_7 ;
int V_176 = - V_77 ;
if ( ( * V_94 ) -> V_166 <= 0 || ( * V_94 ) -> V_166 > V_214 )
return - V_170 ;
...
V_7 -> V_94 = * V_94 ;
F_58 ( & V_215 ) ;
if ( V_212 -> V_2 || V_212 -> V_5 || V_212 -> V_4 ) {
V_2 = V_212 -> V_2 ;
V_213 = ( char T_5 * ) ( unsigned long ) V_212 -> V_5 ;
V_4 = V_212 -> V_4 ;
V_3 = 0 ;
V_176 = - V_77 ;
if ( V_4 < 128 || V_4 > V_216 >> 8 ||
V_2 == 0 || V_213 == NULL )
goto V_217;
V_176 = - V_177 ;
V_5 = F_59 ( V_4 ) ;
...
if ( V_2 && F_60 ( V_213 , V_5 , V_3 + 1 ) != 0 ) {
V_176 = - V_114 ;
goto V_220;
}
if ( V_176 == 0 && V_7 -> V_199 ) {
V_7 -> V_94 -> V_95 -> V_200 = F_61 ( V_7 -> V_199 ,
sizeof( V_7 -> V_200 [ 0 ] ) ,
V_67 ) ;
if ( ! V_7 -> V_94 -> V_95 -> V_200 ) {
V_176 = - V_177 ;
goto V_220;
}
memcpy ( V_7 -> V_94 -> V_95 -> V_200 , V_7 -> V_200 ,
sizeof( V_7 -> V_200 [ 0 ] ) * V_7 -> V_199 ) ;
V_7 -> V_94 -> V_95 -> V_199 = V_7 -> V_199 ;
F_49 ( V_7 ) ;
}
V_220:
if ( V_2 )
