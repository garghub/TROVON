...
T_3 F_58 ( int V_94 , void * V_95 )
{
struct V_6 * V_7 = (struct V_6 * ) V_95 ;
T_1 V_27 = F_10 ( V_7 ) ;
if ( ( V_27 & V_14 ) != V_14 )
return V_96 ;
F_11 ( V_7 , V_27 ) ;
...
F_33 ( & V_7 -> V_41 ) ;
F_60 ( & V_99 ) ;
if ( F_61 ( F_15 ( V_7 -> V_7 ) ) )
F_62 ( V_7 ) ;
if ( ! F_63 ( V_7 ) && V_7 -> V_102 != V_103 ) {
F_25 ( V_7 -> V_7 , L_14 ) ;
F_64 ( & V_7 -> V_104 ) ;
goto V_105;
}
...
V_100 = F_66 ( V_7 ) ;
while ( V_100 > 0 ) {
F_36 ( V_7 -> V_7 , L_17 , V_100 ) ;
V_101 = F_67 ( V_7 , & V_99 , & V_100 ) ;
if ( V_101 == - V_106 )
break;
if ( V_101 && V_7 -> V_102 != V_103 ) {
F_34 ( V_7 -> V_7 , L_18 ,
V_101 ) ;
F_64 ( & V_7 -> V_104 ) ;
goto V_105;
...
F_70 ( V_7 , & V_99 ) ;
V_105:
F_36 ( V_7 -> V_7 , L_19 , V_101 ) ;
F_30 ( & V_7 -> V_41 ) ;
return V_108 ;
}
static bool F_71 ( struct V_17 * V_18 )
{
T_1 V_11 ;
F_16 ( V_18 , V_109 , & V_11 ) ;
return ( V_11 & 0x600 ) == 0x200 ;
}
static bool F_72 ( struct V_17 * V_18 )
{
T_1 V_11 ;
F_16 ( V_18 , V_110 , & V_11 ) ;
return ( V_11 & 0xf0000 ) == 0xf0000 ;
}
struct V_6 * F_73 ( struct V_17 * V_18 ,
const struct V_111 * V_20 )
{
struct V_6 * V_7 ;
struct V_1 * V_2 ;
V_7 = F_74 ( sizeof( struct V_6 ) +
sizeof( struct V_1 ) , V_112 ) ;
if ( ! V_7 )
return NULL ;
V_2 = F_6 ( V_7 ) ;
F_75 ( V_7 , & V_18 -> V_7 , & V_113 ) ;
V_2 -> V_20 = V_20 ;
return V_7 ;
}
