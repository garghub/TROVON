...
if ( ! V_132 )
return;
V_131 = F_18 ( F_80 ( V_132 ) ) ;
free ( V_132 ) ;
if ( ! V_131 )
return;
F_75 ( V_1 , V_131 , true ) ;
}
int F_81 ( const struct V_1 * V_1 )
{
if ( ! V_1 )
return strlen ( L_21 ) ;
if ( V_133 )
...
bool F_82 ( const struct V_1 * V_1 , enum V_134 type )
{
...
void F_84 ( struct V_1 * V_1 , enum V_134 type )
{
V_1 -> V_136 |= ( 1 << type ) ;
}
