...
bool V_205 = F_63 ( V_81 , V_2 -> V_187 ) ;
...
V_206 = V_80 [ V_203 ] * V_82 * 64 ;
if ( V_204 )
V_207 = F_64 ( V_81 , V_206 ) ;
else
V_207 = F_24 ( V_81 ) ;
V_211 = V_207 / 64 ;
V_211 /= V_82 * V_83 ;
...
if ( F_63 ( V_2 -> V_99 [ V_203 ] , V_2 -> V_187 ) )
F_3 ( & V_5 -> V_9 , L_40 ,
...
if ( ! V_215 )
return - V_220 ;
V_2 = F_70 ( & V_5 -> V_9 , sizeof( * V_2 ) , V_221 ) ;
if ( ! V_2 )
return - V_222 ;
V_2 -> V_5 = V_5 ;
memcpy ( & V_2 -> V_223 , & V_224 , sizeof( V_224 ) ) ;
V_2 -> V_223 . V_13 = F_71 ( & V_5 -> V_9 ) ;
V_218 = F_72 ( V_5 , V_225 , 0 ) ;
V_219 = F_73 ( & V_5 -> V_9 , V_218 ) ;
if ( F_67 ( V_219 ) )
return F_68 ( V_219 ) ;
...
V_2 -> V_187 = F_66 ( & V_5 -> V_9 , L_46 ) ;
if ( F_67 ( V_2 -> V_187 ) ) {
F_7 ( & V_5 -> V_9 , L_47 ) ;
return F_68 ( V_2 -> V_187 ) ;
}
...
V_2 -> V_133 = F_66 ( & V_5 -> V_9 , L_49 ) ;
if ( F_67 ( V_2 -> V_133 ) ) {
F_7 ( & V_5 -> V_9 , L_50 ) ;
return F_68 ( V_2 -> V_133 ) ;
}
V_2 -> V_65 = V_227 ;
for ( V_110 = 0 ; V_110 < V_126 ; V_110 ++ ) {
V_84 = F_65 ( V_2 , V_110 ) ;
...
V_142 ;
V_2 -> V_10 = false ;
V_2 -> V_193 . V_231 = V_232 ;
V_2 -> V_194 . V_231 = V_233 ;
V_2 -> V_193 . V_234 = V_218 -> V_235 + V_199 ;
V_2 -> V_194 . V_234 = V_218 -> V_235 + V_197 ;
F_78 ( & V_5 -> V_9 , V_2 ) ;
V_84 = F_79 ( & V_5 -> V_9 , & V_236 ,
& V_2 -> V_223 , 1 ) ;
if ( V_84 ) {
