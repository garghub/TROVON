...
static void F_95 ( struct V_5 * V_5 )
{
...
return;
V_82 = F_96 ( V_5 ) - V_26 -> V_83 . V_84 ;
if ( F_88 ( ( T_3 ) V_82 <= 0 ) )
return;
F_97 ( V_26 -> V_83 . V_85 . V_86 ,
F_98 ( V_26 -> V_83 . V_85 . V_86 , V_82 ) ) ;
V_26 -> V_83 . V_87 += V_82 ;
F_99 ( V_26 , V_82 ) ;
V_26 -> V_83 . V_84 = F_96 ( V_5 ) ;
F_100 ( V_26 , V_82 ) ;
F_101 ( V_5 , V_82 ) ;
...
static inline T_1 F_105 ( struct V_5 * V_5 )
{
struct V_1 * V_27 = F_106 ( V_5 , V_5 -> V_34 ) ;
if ( V_27 && F_107 ( V_27 -> V_92 ) )
return V_27 -> V_4 . V_59 ;
else
return 0 ;
}
static void F_108 ( struct V_6 * V_6 , T_1 V_59 )
{
struct V_5 * V_5 = F_3 ( V_6 ) ;
if ( V_6 -> V_25 . V_26 == 0 ||
...
V_6 -> V_25 . V_26 = V_59 ;
F_109 ( & V_5 -> V_31 -> V_93 , V_5 -> V_34 , V_59 , 1 ) ;
} else if ( V_6 -> V_25 . V_27 == 0 ||
F_66 ( V_59 , V_6 -> V_25 . V_27 ) ) {
V_6 -> V_25 . V_27 = F_105 ( V_5 ) ;
}
}
...
V_6 -> V_25 . V_26 = 0 ;
V_6 -> V_25 . V_27 = 0 ;
F_109 ( & V_5 -> V_31 -> V_93 , V_5 -> V_34 , 0 , 0 ) ;
} else {
...
V_6 -> V_25 . V_27 = F_105 ( V_5 ) ;
F_109 ( & V_5 -> V_31 -> V_93 , V_5 -> V_34 , V_40 -> V_59 , 1 ) ;
}
}
static inline void F_108 ( struct V_6 * V_6 , T_1 V_59 ) {}
...
if ( V_95 && V_7 -> V_4 . V_76 && F_107 ( V_95 -> V_96 ) ) {
V_56 = & V_95 -> V_4 ;
} else if ( ! F_107 ( V_7 -> V_96 ) ) {
F_32 ( ! V_7 -> V_4 . V_76 || V_74 != V_77 ) ;
return;
}
if ( V_7 -> V_4 . V_58 && ! ( V_74 & V_77 ) )
return;
F_117 ( & V_7 -> V_4 , V_56 , V_74 ) ;
if ( ! F_120 ( V_5 , V_7 ) && V_7 -> V_37 > 1 )
F_31 ( V_5 , V_7 ) ;
}
static void F_102 ( struct V_5 * V_5 , struct V_1 * V_7 , int V_74 )
{
F_118 ( & V_7 -> V_4 ) ;
F_37 ( V_5 , V_7 ) ;
}
...
{
if ( V_5 -> V_26 -> V_37 == 1 ||
F_130 ( & V_5 -> V_31 -> V_93 , V_5 -> V_26 , NULL ) == - 1 )
return;
if ( V_7 -> V_37 != 1 &&
F_130 ( & V_5 -> V_31 -> V_93 , V_7 , NULL ) != - 1 )
return;
F_60 ( V_5 ) ;
}
...
struct V_1 * F_135 ( struct V_5 * V_5 , struct V_1 * V_47 )
{
struct V_2 * V_3 ;
struct V_1 * V_7 ;
struct V_6 * V_6 ;
...
static struct V_1 * F_106 ( struct V_5 * V_5 , int V_34 )
{
...
if ( V_106 -> V_37 == 1 )
return - 1 ;
V_113 = F_130 ( & F_5 ( V_106 ) -> V_31 -> V_93 ,
V_106 , V_110 ) ;
if ( V_113 == - 1 )
return - 1 ;
if ( F_151 ( V_34 , V_110 ) )
...
if ( V_5 -> V_4 . V_36 > 0 )
F_109 ( & V_5 -> V_31 -> V_93 , V_5 -> V_34 , V_5 -> V_4 . V_25 . V_26 , 1 ) ;
}
...
void F_178 ( struct V_136 * V_137 , int V_34 )
{
F_179 ( V_137 , V_34 , & F_55 ( V_34 ) -> V_4 ) ;
}
