...
static struct V_41 * T_2
F_19 ( struct V_42 * V_43 , const char * V_15 ,
const char * V_44 , T_1 V_34 )
{
struct V_41 * V_41 ;
struct V_30 * V_31 ;
struct V_45 V_46 ;
...
V_46 . V_15 = V_15 ;
V_46 . V_50 = & V_51 ;
V_46 . V_52 = ( V_44 ? & V_44 : NULL ) ;
V_46 . V_53 = ( V_44 ? 1 : 0 ) ;
V_31 -> V_29 . V_46 = & V_46 ;
V_31 -> V_34 = V_34 ;
F_22 ( L_14 , V_15 ) ;
V_41 = F_23 ( V_43 , & V_31 -> V_29 ) ;
if ( F_24 ( V_41 ) )
F_25 ( V_31 ) ;
return V_41 ;
}
...
static struct V_41 * T_2
F_32 ( struct V_42 * V_43 , const char * V_15 ,
const char * V_44 , T_3 V_34 )
{
struct V_41 * V_41 ;
struct V_54 * V_55 ;
struct V_45 V_46 ;
...
V_55 -> V_34 = V_34 ;
V_55 -> V_57 = ( V_34 > 31 ) ;
V_55 -> V_63 = F_33 ( V_34 & 0x1f ) ;
F_22 ( L_16 ,
V_15 , V_34 , V_55 -> V_57 , V_55 -> V_63 ) ;
V_41 = F_23 ( V_43 , & V_55 -> V_29 ) ;
if ( F_24 ( V_41 ) )
F_25 ( V_55 ) ;
return V_41 ;
}
static int F_34 ( struct V_70 * V_71 , void * V_72 )
{
int V_73 ;
...
{
struct V_41 * V_41 = F_20 ( - V_47 ) ;
const char * V_93 = V_12 -> V_15 ;
const char * V_44 ;
T_1 V_94 ;
if ( ! V_6 )
F_5 () ;
if ( F_42 ( V_12 , L_22 , & V_94 ) ) {
F_8 ( L_23 ,
V_14 , V_93 ) ;
return;
}
V_44 = F_43 ( V_12 , 0 ) ;
V_41 = F_19 ( NULL , V_93 , V_44 , V_94 ) ;
if ( ! F_24 ( V_41 ) )
F_44 ( V_12 , V_95 , V_41 ) ;
}
static void T_2 F_45 ( struct V_11 * V_12 )
{
struct V_41 * V_41 = F_20 ( - V_47 ) ;
const char * V_93 = V_12 -> V_15 ;
const char * V_44 ;
...
static void T_2 F_47 ( struct V_11 * V_12 )
{
struct V_41 * V_41 = F_20 ( - V_47 ) ;
const char * V_93 = V_12 -> V_15 ;
const char * V_44 ;
...
if ( ! V_6 )
F_5 () ;
if ( F_42 ( V_12 , L_24 , & V_98 ) ) {
F_8 ( L_25 ,
V_14 , V_93 ) ;
return;
}
V_44 = F_43 ( V_12 , 0 ) ;
V_41 = F_32 ( NULL , V_93 , V_44 , V_98 ) ;
if ( ! F_24 ( V_41 ) )
F_44 ( V_12 , V_95 , V_41 ) ;
}
