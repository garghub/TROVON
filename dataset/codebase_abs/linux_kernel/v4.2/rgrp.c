...
const struct V_74 * V_75 = V_115 -> V_272 ;
struct V_273 * V_274 ;
T_9 V_275 , V_276 ;
T_9 V_277 , V_278 = 0 ;
T_9 V_279 ;
...
F_127 () ;
F_128 (cpu) {
V_274 = & F_129 ( V_75 -> V_284 , V_282 ) -> V_285 [ V_286 ] ;
if ( V_274 -> V_287 [ V_288 ] ) {
V_278 += V_274 -> V_287 [ V_288 ] ;
V_283 ++ ;
}
}
V_274 = & F_130 ( V_75 -> V_284 ) -> V_285 [ V_286 ] ;
if ( V_283 )
F_131 ( V_278 , V_283 ) ;
V_275 = V_274 -> V_287 [ V_289 ] ;
V_281 = V_274 -> V_287 [ V_290 ] +
V_115 -> V_291 . V_287 [ V_290 ] ;
F_132 () ;
V_277 = V_115 -> V_291 . V_287 [ V_288 ] ;
V_276 = V_115 -> V_291 . V_287 [ V_289 ] ;
if ( ( V_276 < 1 ) || ( V_275 < 1 ) || ( V_278 == 0 ) )
return false ;
V_279 = V_278 - V_277 ;
V_280 = V_279 * V_279 ;
V_281 *= 2 ;
...
if ( V_271 == 1 )
V_281 *= 2 ;
return ( ( V_279 < 0 ) && ( V_280 > V_281 ) ) ;
}
static bool F_133 ( const struct V_35 * V_36 ,
T_2 V_292 )
{
T_2 V_293 ;
V_293 = F_134 ( F_135 ( F_136 () ,
V_36 -> V_38 . V_22 -> V_116 -> V_294 ) ) ;
return V_293 > ( V_292 * 1000 * 1000 ) ;
}
...
static bool F_139 ( struct V_69 * * V_130 , const struct V_69 * V_295 )
{
...
{
struct V_114 * V_115 = V_22 -> V_116 ;
if ( V_115 -> V_296 != V_297 && F_141 ( & V_115 -> V_298 ) &&
! F_101 ( V_299 , & V_115 -> V_196 ) &&
...
{
struct V_74 * V_75 = F_36 ( & V_93 -> V_94 ) ;
struct V_69 * V_295 = NULL ;
struct V_35 * V_36 = V_93 -> V_98 ;
int error = 0 , V_300 , V_301 = 0 ;
T_2 V_262 = V_266 ;
int V_271 = 0 ;
T_4 V_263 = 0 ;
if ( V_75 -> V_188 . V_189 )
...
return - V_48 ;
if ( F_47 ( V_36 ) ) {
V_295 = V_36 -> V_38 . V_22 ;
} else if ( V_93 -> V_302 && F_26 ( V_93 -> V_302 , V_93 -> V_95 ) ) {
V_36 -> V_38 . V_22 = V_295 = V_93 -> V_302 ;
} else {
F_35 ( V_93 ) ;
V_36 -> V_38 . V_22 = V_295 = F_27 ( V_75 , V_93 -> V_95 , 1 ) ;
}
if ( F_118 ( V_93 -> V_94 . V_242 ) && ( V_239 -> V_303 & V_304 ) )
V_263 = F_137 ( V_93 ) ;
...
( V_271 == 2 && V_239 -> V_312 &&
V_36 -> V_38 . V_22 -> V_187 >= V_239 -> V_312 ) ) {
V_93 -> V_302 = V_36 -> V_38 . V_22 ;
V_239 -> V_313 = V_93 -> V_302 -> V_187 ;
return 0 ;
}
V_311:
...
static void F_146 ( const struct V_1 * V_2 , bool V_315 ,
unsigned int * V_59 )
{
struct V_1 V_130 = { . V_22 = V_2 -> V_22 , } ;
const unsigned int V_316 = * V_59 ;
T_2 V_44 ;
int V_222 ;
* V_59 = 1 ;
V_44 = F_12 ( V_2 ) ;
F_113 ( V_2 -> V_22 -> V_116 , F_2 ( V_2 ) -> V_17 ) ;
F_1 ( V_2 , true , V_315 ? V_317 : V_318 ) ;
V_44 ++ ;
while ( * V_59 < V_316 ) {
...
F_1 ( & V_130 , true , V_318 ) ;
( * V_59 ) ++ ;
V_44 ++ ;
}
}
static struct V_69 * F_147 ( struct V_74 * V_75 , T_2 V_319 ,
T_4 V_320 , unsigned char V_4 )
{
struct V_1 V_2 ;
struct V_9 * V_10 , * V_321 = NULL ;
V_2 . V_22 = F_27 ( V_75 , V_319 , 1 ) ;
if ( ! V_2 . V_22 ) {
if ( F_148 ( V_75 ) )
F_25 ( V_75 , L_15 , ( unsigned long long ) V_319 ) ;
return NULL ;
}
F_16 ( & V_2 , V_319 ) ;
while ( V_320 -- ) {
...
F_28 ( & V_22 -> V_112 ) ;
for ( V_59 = F_32 ( & V_22 -> V_107 ) ; V_59 ; V_59 = F_34 ( & V_323 -> V_102 ) ) {
V_323 = F_29 ( V_59 , struct V_35 , V_102 ) ;
F_44 ( V_104 , V_323 ) ;
}
F_30 ( & V_22 -> V_112 ) ;
}
...
V_324 = F_154 ( V_36 -> V_39 , V_34 ) ;
V_36 -> V_39 -= V_324 ;
V_22 -> V_108 -= V_324 ;
F_48 ( V_36 , V_325 ) ;
if ( V_36 -> V_39 && ! V_222 )
goto V_67;
F_155 ( V_326 , & V_36 -> V_243 ) ;
}
F_46 ( V_36 ) ;
}
V_67:
...
const struct V_92 * V_93 , bool V_315 )
{
T_2 V_41 ;
if ( F_47 ( V_93 -> V_98 ) ) {
* V_2 = V_93 -> V_98 -> V_38 ;
...
if ( ! V_315 && F_26 ( V_2 -> V_22 , V_93 -> V_95 ) )
V_41 = V_93 -> V_95 ;
else
V_41 = V_2 -> V_22 -> V_246 + V_2 -> V_22 -> V_46 ;
F_16 ( V_2 , V_41 ) ;
}
int F_157 ( struct V_92 * V_93 , T_2 * V_327 , unsigned int * V_328 ,
bool V_315 , T_2 * V_329 )
{
struct V_74 * V_75 = F_36 ( & V_93 -> V_94 ) ;
struct V_198 * V_330 ;
struct V_1 V_2 = { . V_22 = V_93 -> V_302 , } ;
unsigned int V_331 ;
T_2 V_44 ;
int error ;
F_156 ( & V_2 , V_93 , V_315 ) ;
...
if ( error ) {
F_104 ( V_75 , L_19 ,
( unsigned long long ) V_93 -> V_96 , error , * V_328 ,
F_101 ( V_110 , & V_2 . V_22 -> V_78 -> V_111 ) ,
V_2 . V_22 -> V_109 ) ;
goto V_332;
}
F_146 ( & V_2 , V_315 , V_328 ) ;
V_44 = F_12 ( & V_2 ) ;
V_2 . V_22 -> V_246 = V_44 - V_2 . V_22 -> V_46 ;
if ( F_47 ( V_93 -> V_98 ) )
F_152 ( V_93 , & V_2 , * V_328 ) ;
V_331 = * V_328 ;
if ( V_315 )
V_331 -- ;
if ( ! V_315 ) {
V_93 -> V_95 = V_44 + V_331 - 1 ;
error = F_158 ( V_93 , & V_330 ) ;
if ( error == 0 ) {
struct V_333 * V_334 =
(struct V_333 * ) V_330 -> V_18 ;
F_113 ( V_93 -> V_158 , V_330 ) ;
V_334 -> V_335 = V_334 -> V_336 =
F_84 ( V_93 -> V_95 ) ;
F_95 ( V_330 ) ;
}
}
if ( V_2 . V_22 -> V_79 < * V_328 ) {
F_5 ( L_20 , * V_328 ) ;
goto V_332;
}
V_2 . V_22 -> V_79 -= * V_328 ;
...
F_159 ( V_75 , 0 , - ( T_9 ) * V_328 , V_315 ? 1 : 0 ) ;
if ( V_315 )
F_160 ( V_75 , V_44 , * V_328 ) ;
F_161 ( V_93 , * V_328 , V_93 -> V_94 . V_337 , V_93 -> V_94 . V_338 ) ;
V_2 . V_22 -> V_187 -= * V_328 ;
F_162 ( V_93 , V_2 . V_22 , V_44 , * V_328 ,
V_315 ? V_317 : V_318 ) ;
* V_327 = V_44 ;
return 0 ;
V_332:
...
void F_163 ( struct V_92 * V_93 , T_2 V_319 , T_4 V_320 , int V_339 )
{
struct V_74 * V_75 = F_36 ( & V_93 -> V_94 ) ;
struct V_69 * V_22 ;
V_22 = F_147 ( V_75 , V_319 , V_320 , V_61 ) ;
if ( ! V_22 )
return;
F_162 ( V_93 , V_22 , V_319 , V_320 , V_61 ) ;
V_22 -> V_79 += V_320 ;
V_22 -> V_149 &= ~ V_233 ;
...
if ( V_339 || V_93 -> V_340 )
F_164 ( V_93 , V_319 , V_320 ) ;
}
void F_165 ( struct V_92 * V_93 , T_2 V_319 , T_4 V_320 )
{
struct V_74 * V_75 = F_36 ( & V_93 -> V_94 ) ;
F_163 ( V_93 , V_319 , V_320 , 1 ) ;
F_159 ( V_75 , 0 , + V_320 , 0 ) ;
F_161 ( V_93 , - ( T_9 ) V_320 , V_93 -> V_94 . V_337 , V_93 -> V_94 . V_338 ) ;
}
...
struct V_69 * V_22 ;
T_2 V_341 = V_93 -> V_96 ;
V_22 = F_147 ( V_75 , V_341 , 1 , V_182 ) ;
if ( ! V_22 )
return;
F_162 ( V_93 , V_22 , V_341 , 1 , V_182 ) ;
F_113 ( V_22 -> V_116 , V_22 -> V_78 [ 0 ] . V_17 ) ;
F_82 ( V_22 , V_22 -> V_78 [ 0 ] . V_17 -> V_18 ) ;
F_86 ( V_22 -> V_145 , V_22 -> V_78 [ 0 ] . V_17 -> V_18 ) ;
F_87 ( V_22 , 1 ) ;
}
static void F_167 ( struct V_69 * V_22 , T_2 V_341 )
{
struct V_74 * V_75 = V_22 -> V_55 ;
struct V_69 * V_342 ;
V_342 = F_147 ( V_75 , V_341 , 1 , V_61 ) ;
if ( ! V_342 )
return;
F_168 ( V_75 , V_22 == V_342 ) ;
if ( ! V_22 -> V_80 )
F_7 ( V_22 ) ;
V_22 -> V_80 -- ;
V_22 -> V_79 ++ ;
...
F_161 ( V_93 , - 1 , V_93 -> V_94 . V_337 , V_93 -> V_94 . V_338 ) ;
F_164 ( V_93 , V_93 -> V_96 , 1 ) ;
}
int F_170 ( struct V_74 * V_75 , T_2 V_343 , unsigned int type )
{
struct V_69 * V_22 ;
struct V_159 V_344 ;
int error = - V_48 ;
V_22 = F_27 ( V_75 , V_343 , 1 ) ;
if ( ! V_22 )
goto V_141;
error = F_79 ( V_22 -> V_116 , V_162 , 0 , & V_344 ) ;
if ( error )
goto V_141;
if ( F_145 ( V_22 , V_343 ) != type )
error = - V_345 ;
F_80 ( & V_344 ) ;
V_141:
return error ;
}
void F_171 ( struct V_92 * V_93 , struct V_346 * V_347 ,
T_2 V_44 )
{
struct V_74 * V_75 = F_36 ( & V_93 -> V_94 ) ;
struct V_69 * V_22 ;
...
unsigned int V_348 ;
unsigned int V_77 ;
if ( F_96 ( V_75 , ! V_347 -> V_349 ) )
return;
if ( V_93 -> V_302 && F_26 ( V_93 -> V_302 , V_44 ) )
V_22 = V_93 -> V_302 ;
else
...
V_93 -> V_302 = V_22 ;
for ( V_77 = 0 ; V_77 < V_347 -> V_350 ; V_77 ++ )
if ( V_347 -> V_351 [ V_77 ] == V_22 )
return;
if ( V_347 -> V_350 == V_347 -> V_352 ) {
V_348 = V_347 -> V_352 + 10 ;
V_31 = F_62 ( V_348 , sizeof( struct V_69 * ) ,
V_100 | V_322 ) ;
if ( V_347 -> V_351 ) {
memcpy ( V_31 , V_347 -> V_351 ,
V_347 -> V_352 * sizeof( struct V_69 * ) ) ;
F_38 ( V_347 -> V_351 ) ;
}
V_347 -> V_352 = V_348 ;
V_347 -> V_351 = V_31 ;
}
V_347 -> V_351 [ V_347 -> V_350 ++ ] = V_22 ;
}
void F_172 ( struct V_346 * V_347 , unsigned int V_30 )
{
unsigned int V_77 ;
V_347 -> V_349 = F_62 ( V_347 -> V_350 , sizeof( struct V_159 ) ,
V_100 | V_322 ) ;
for ( V_77 = 0 ; V_77 < V_347 -> V_350 ; V_77 ++ )
F_173 ( V_347 -> V_351 [ V_77 ] -> V_116 ,
V_30 , 0 ,
& V_347 -> V_349 [ V_77 ] ) ;
}
void F_174 ( struct V_346 * V_347 )
{
unsigned int V_77 ;
F_38 ( V_347 -> V_351 ) ;
if ( V_347 -> V_349 ) {
for ( V_77 = 0 ; V_77 < V_347 -> V_350 ; V_77 ++ )
F_175 ( & V_347 -> V_349 [ V_77 ] ) ;
F_38 ( V_347 -> V_349 ) ;
V_347 -> V_349 = NULL ;
}
}
