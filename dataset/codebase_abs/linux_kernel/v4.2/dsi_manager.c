...
struct V_23 * F_52 ( T_1 V_2 )
{
struct V_1 * V_1 = F_1 ( V_2 ) ;
struct V_23 * V_24 = NULL ;
struct V_25 * V_25 ;
int V_18 , V_100 ;
V_25 = F_53 ( V_1 -> V_33 -> V_33 ,
sizeof( * V_25 ) , V_101 ) ;
if ( ! V_25 ) {
V_18 = - V_66 ;
goto V_102;
...
struct V_26 * F_59 ( T_1 V_2 )
{
struct V_1 * V_1 = F_1 ( V_2 ) ;
struct V_26 * V_27 = NULL ;
struct V_28 * V_28 ;
int V_18 ;
V_28 = F_53 ( V_1 -> V_33 -> V_33 ,
sizeof( * V_28 ) , V_101 ) ;
if ( ! V_28 ) {
V_18 = - V_66 ;
goto V_102;
...
int F_62 ( int V_2 ,
const unsigned long V_113 , const unsigned long V_114 ,
T_2 * V_115 , T_2 * V_116 )
{
struct V_1 * V_1 = F_1 ( V_2 ) ;
struct V_117 * V_20 = V_1 -> V_20 ;
int V_18 ;
V_18 = F_63 ( V_20 , F_6 () , V_113 , V_114 ) ;
if ( V_18 )
return V_18 ;
V_1 -> V_118 = true ;
F_64 ( V_20 , V_115 , V_116 ) ;
return 0 ;
}
void F_65 ( int V_2 )
{
...
struct V_1 * V_22 = F_1 ( V_119 ) ;
struct V_117 * V_20 = V_1 -> V_20 ;
V_1 -> V_118 = false ;
if ( F_6 () && V_21 && V_22 ) {
if ( ! V_21 -> V_118 && ! V_22 -> V_118 ) {
F_66 ( V_22 -> V_20 ) ;
F_66 ( V_21 -> V_20 ) ;
}
} else {
...
int F_67 ( int V_2 , const struct V_120 * V_121 )
{
struct V_1 * V_1 = F_1 ( V_2 ) ;
struct V_1 * V_122 = F_1 ( V_123 ) ;
struct V_86 * V_19 = V_1 -> V_19 ;
bool V_124 = ( V_121 -> V_125 && V_121 -> V_126 ) ;
bool V_127 = ( F_68 () && ! V_124 ) ;
int V_18 ;
if ( ! V_121 -> V_128 || ! V_121 -> V_129 )
return 0 ;
if ( V_127 && ( V_2 == V_123 ) )
return V_124 ? V_121 -> V_126 : V_121 -> V_129 ;
if ( V_127 && V_122 ) {
V_18 = F_69 ( V_122 -> V_19 , V_121 ) ;
if ( V_18 ) {
F_20 ( L_24 ,
V_65 , V_18 ) ;
return V_18 ;
...
V_18 = F_69 ( V_19 , V_121 ) ;
if ( V_18 ) {
F_20 ( L_25 , V_65 , V_18 ) ;
goto V_130;
}
V_18 = V_124 ? F_70 ( V_19 , V_121 ) :
F_71 ( V_19 , V_121 ) ;
F_72 ( V_19 , V_121 ) ;
V_130:
if ( V_127 && V_122 )
F_72 ( V_122 -> V_19 , V_121 ) ;
return V_18 ;
}
bool F_73 ( int V_2 , T_2 V_131 , T_2 V_132 )
{
struct V_1 * V_1 = F_1 ( V_2 ) ;
struct V_1 * V_122 = F_1 ( V_123 ) ;
struct V_86 * V_19 = V_1 -> V_19 ;
...
return false ;
if ( F_68 () && V_122 )
F_74 ( V_122 -> V_19 , V_131 , V_132 ) ;
F_74 ( V_19 , V_131 , V_132 ) ;
return true ;
}
...
V_9 -> V_4 [ V_2 ] = V_1 ;
V_18 = F_3 ( V_1 -> V_134 -> V_33 . V_135 , V_2 ) ;
if ( V_18 ) {
F_20 ( L_28 , V_65 ) ;
goto V_102;
}
