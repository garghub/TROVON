...
static void F_36 ( struct V_5 * V_6 , int V_36 )
{
...
static struct V_85 * F_51 ( struct V_5 * V_6 ,
struct V_86 * V_87 )
{
struct V_85 * V_85 ;
V_85 = F_52 ( V_6 , V_87 ) ;
...
struct V_85 * V_85 ;
struct V_86 * V_87 ;
F_59 ( V_13 -> V_4 . type != V_89 ) ;
V_87 = F_60 ( V_11 , V_11 -> V_90 . V_91 ) ;
V_85 = F_51 ( V_6 , V_87 ) ;
if ( V_85 ) {
...
static enum V_95
F_69 ( struct V_5 * V_6 , bool V_123 )
{
struct V_8 * V_9 = V_6 -> V_9 ;
struct V_10 * V_11 = V_9 -> V_12 ;
struct V_1 * V_13 = F_3 ( V_6 ) ;
...
static int F_83 ( const struct V_138 * V_127 )
{
F_84 ( L_17 , V_127 -> V_139 ) ;
return 1 ;
}
...
if ( F_86 ( V_141 ) )
return;
V_13 = F_87 ( sizeof( struct V_1 ) , V_142 ) ;
if ( ! V_13 )
return;
V_140 = F_88 () ;
if ( ! V_140 ) {
