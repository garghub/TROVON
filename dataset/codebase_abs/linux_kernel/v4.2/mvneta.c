...
V_2 -> V_329 = V_329 ;
V_2 -> V_330 = V_378 ;
V_2 -> V_115 = ( V_378 == V_387 ) &&
V_404 ;
V_2 -> V_146 = F_238 ( & V_394 -> V_17 , NULL ) ;
if ( F_239 ( V_2 -> V_146 ) ) {
V_215 = F_240 ( V_2 -> V_146 ) ;
goto V_406;
}
F_241 ( V_2 -> V_146 ) ;
V_397 = F_242 ( V_394 , V_414 , 0 ) ;
V_2 -> V_5 = F_243 ( & V_394 -> V_17 , V_397 ) ;
if ( F_239 ( V_2 -> V_5 ) ) {
V_215 = F_240 ( V_2 -> V_5 ) ;
goto V_415;
}
V_2 -> V_18 = F_244 ( struct V_21 ) ;
if ( ! V_2 -> V_18 ) {
V_215 = - V_199 ;
goto V_415;
}
...
V_2 -> V_306 = V_359 ;
V_2 -> V_17 = V_17 ;
F_249 ( V_17 , & V_394 -> V_17 ) ;
V_215 = F_222 ( & V_394 -> V_17 , V_2 ) ;
if ( V_215 < 0 )
goto V_416;
V_215 = F_228 ( V_2 , V_378 ) ;
if ( V_215 < 0 ) {
F_230 ( & V_394 -> V_17 , L_37 ) ;
goto V_416;
}
V_395 = F_250 () ;
if ( V_395 )
F_224 ( V_2 , V_395 ) ;
F_251 ( V_17 , & V_2 -> V_221 , F_154 , V_417 ) ;
...
V_215 = F_252 ( V_17 ) ;
if ( V_215 < 0 ) {
F_230 ( & V_394 -> V_17 , L_38 ) ;
goto V_416;
}
F_145 ( V_17 , L_39 , V_403 ,
V_17 -> V_273 ) ;
F_253 ( V_394 , V_2 -> V_17 ) ;
if ( V_2 -> V_115 ) {
struct V_278 * V_279 = F_254 ( V_399 ) ;
F_152 ( V_2 , V_279 ) ;
}
return 0 ;
V_416:
...
static int F_260 ( struct V_393 * V_394 )
{
struct V_16 * V_17 = F_261 ( V_394 ) ;
struct V_1 * V_2 = F_9 ( V_17 ) ;
F_262 ( V_17 ) ;
F_256 ( V_2 -> V_146 ) ;
F_255 ( V_2 -> V_18 ) ;
