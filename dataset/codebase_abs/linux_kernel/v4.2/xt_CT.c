...
if ( V_50 < 0 )
goto V_61;
V_4 = F_24 ( V_12 -> V_62 , V_14 -> V_60 , V_37 ) ;
if ( ! V_4 ) {
V_50 = - V_39 ;
goto V_63;
}
...
static int F_30 ( const struct V_17 * V_12 )
{
...
static void F_35 ( const struct V_71 * V_12 ,
struct V_16 * V_14 )
{
struct V_3 * V_4 = V_14 -> V_4 ;
struct V_34 * V_35 ;
...
static void F_39 ( const struct V_71 * V_12 )
{
struct V_13 * V_14 = V_12 -> V_15 ;
struct V_16 V_69 = {
. V_58 = V_14 -> V_58 ,
...
static unsigned int
F_41 ( struct V_1 * V_2 , const struct V_11 * V_12 )
{
if ( V_2 -> V_5 != NULL )
return V_6 ;
V_2 -> V_5 = & F_2 () -> V_7 ;
...
static int F_42 ( const struct V_17 * V_12 )
{
if ( ! V_12 -> V_62 -> V_72 . V_73 ) {
F_8 ( L_9
L_10 ) ;
V_12 -> V_62 -> V_72 . V_73 = true ;
}
return 0 ;
}
