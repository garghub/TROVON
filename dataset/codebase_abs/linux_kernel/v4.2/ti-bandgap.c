...
V_2 -> V_123 = F_66 ( NULL , V_2 -> V_10 -> V_124 ) ;
V_57 = F_25 ( V_2 -> V_123 ) ;
if ( V_57 ) {
F_23 ( & V_103 -> V_39 , L_22 ) ;
V_57 = F_65 ( V_2 -> V_123 ) ;
goto V_125;
}
V_2 -> V_126 = F_66 ( NULL , V_2 -> V_10 -> V_127 ) ;
V_57 = F_25 ( V_2 -> V_126 ) ;
if ( V_57 ) {
...
T_1 V_5 ;
V_18 = V_2 -> V_10 -> V_20 [ V_7 ] . V_21 ;
V_5 = F_1 ( V_2 , V_18 -> V_128 ) ;
if ( V_57 || ! V_5 )
F_67 ( & V_103 -> V_39 ,
L_24 ) ;
}
V_79 = F_68 ( V_2 -> V_126 ,
V_2 -> V_10 -> V_20 [ 0 ] . V_61 -> V_129 ) ;
if ( V_79 < V_2 -> V_10 -> V_20 [ 0 ] . V_61 -> V_130 ||
V_79 <= 0 ) {
V_57 = - V_131 ;
F_23 ( & V_103 -> V_39 , L_25 , V_79 ) ;
goto V_132;
}
V_57 = F_69 ( V_2 -> V_126 , V_79 ) ;
if ( V_57 )
F_23 ( & V_103 -> V_39 , L_26 ) ;
V_2 -> V_79 = V_79 ;
if ( F_6 ( V_2 , V_133 ) )
F_70 ( V_2 -> V_123 ) ;
F_71 ( & V_2 -> V_33 ) ;
...
for ( V_7 = 0 ; V_7 < V_2 -> V_10 -> V_11 ; V_7 ++ ) {
char * V_41 ;
if ( V_2 -> V_10 -> V_20 [ V_7 ] . V_140 ) {
V_57 = V_2 -> V_10 -> V_20 [ V_7 ] . V_140 ( V_2 , V_7 ) ;
if ( V_57 )
goto V_141;
}
if ( V_2 -> V_10 -> V_142 ) {
V_41 = V_2 -> V_10 -> V_20 [ V_7 ] . V_41 ;
V_57 = V_2 -> V_10 -> V_142 ( V_2 , V_7 , V_41 ) ;
if ( V_57 )
goto V_143;
}
}
...
return 0 ;
V_143:
if ( V_2 -> V_10 -> V_20 [ V_7 ] . V_145 )
V_2 -> V_10 -> V_20 [ V_7 ] . V_145 ( V_2 , V_7 ) ;
V_141:
for ( V_7 -- ; V_7 >= 0 ; V_7 -- ) {
if ( V_2 -> V_10 -> V_20 [ V_7 ] . V_145 )
V_2 -> V_10 -> V_20 [ V_7 ] . V_145 ( V_2 , V_7 ) ;
if ( V_2 -> V_10 -> V_146 )
V_2 -> V_10 -> V_146 ( V_2 , V_7 ) ;
}
F_5 ( V_2 , false ) ;
V_144:
if ( F_6 ( V_2 , V_133 ) )
...
static int F_80 ( struct V_152 * V_39 )
{
...
static int F_82 ( struct V_152 * V_39 )
{
struct V_1 * V_2 = F_81 ( V_39 ) ;
if ( F_6 ( V_2 , V_133 ) )
F_70 ( V_2 -> V_123 ) ;
