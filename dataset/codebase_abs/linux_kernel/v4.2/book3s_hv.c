...
goto V_386;
V_488 = V_487 ( V_70 ) ;
V_490 = F_195 ( V_488 , log -> V_492 ) ;
V_47 = - V_167 ;
if ( ! V_490 -> V_494 )
goto V_386;
V_367 = F_196 ( V_490 ) ;
memset ( V_490 -> V_494 , 0 , V_367 ) ;
V_47 = F_197 ( V_70 , V_490 , V_490 -> V_494 ) ;
if ( V_47 )
goto V_386;
V_47 = - V_380 ;
if ( F_107 ( log -> V_494 , V_490 -> V_494 , V_367 ) )
goto V_386;
V_47 = 0 ;
V_386:
F_35 ( & V_70 -> V_491 ) ;
...
static void F_198 ( struct V_489 * free ,
struct V_489 * V_495 )
{
if ( ! V_495 || free -> V_16 . V_496 != V_495 -> V_16 . V_496 ) {
F_199 ( free -> V_16 . V_496 ) ;
free -> V_16 . V_496 = NULL ;
}
}
static int F_200 ( struct V_489 * V_492 ,
unsigned long V_497 )
{
V_492 -> V_16 . V_496 = F_201 ( V_497 * sizeof( * V_492 -> V_16 . V_496 ) ) ;
if ( ! V_492 -> V_16 . V_496 )
return - V_358 ;
return 0 ;
}
...
const struct V_498 * V_499 ,
const struct V_489 * V_500 ,
const struct V_489 * V_501 )
{
unsigned long V_497 = V_499 -> V_502 >> V_503 ;
struct V_487 * V_488 ;
struct V_489 * V_490 ;
if ( V_497 && V_500 -> V_497 ) {
V_488 = V_487 ( V_70 ) ;
V_490 = F_195 ( V_488 , V_499 -> V_492 ) ;
F_197 ( V_70 , V_490 , NULL ) ;
}
}
...
V_490 = F_207 ( V_70 , 0 ) ;
V_94 = - V_45 ;
if ( ! V_490 || ( V_490 -> V_21 & V_512 ) )
goto V_513;
V_505 = V_490 -> V_514 ;
F_208 ( & V_450 -> V_460 -> V_515 ) ;
V_507 = F_209 ( V_450 -> V_460 , V_505 ) ;
if ( ! V_507 || V_507 -> V_516 > V_505 || ( V_507 -> V_517 & V_518 ) )
goto V_519;
V_509 = F_210 ( V_507 ) ;
V_510 = F_211 ( V_509 ) ;
F_212 ( & V_450 -> V_460 -> V_515 ) ;
V_94 = - V_45 ;
if ( ! ( V_509 == 0x1000 || V_509 == 0x10000 ||
V_509 == 0x1000000 ) )
goto V_513;
V_508 = F_213 ( V_509 ) ;
V_70 -> V_16 . V_520 = V_508 | V_521 |
( V_522 << V_523 ) ;
V_69 = V_508 << ( V_524 - 4 ) ;
F_214 ( V_12 , V_490 , V_510 ) ;
F_204 ( V_70 , V_69 , V_525 ) ;
F_54 () ;
V_70 -> V_16 . V_458 = 1 ;
V_94 = 0 ;
V_513:
...
{
unsigned long V_69 , V_526 ;
char V_360 [ 32 ] ;
V_526 = F_216 () ;
if ( ( long ) V_526 < 0 )
return - V_358 ;
V_70 -> V_16 . V_526 = V_526 ;
F_217 ( & V_70 -> V_16 . V_527 ) ;
memcpy ( V_70 -> V_16 . V_155 , V_528 ,
sizeof( V_70 -> V_16 . V_155 ) ) ;
V_70 -> V_16 . V_529 = F_118 ( V_530 ) ;
V_70 -> V_16 . V_531 = F_118 ( V_532 ) ;
V_70 -> V_16 . V_533 = V_69 = F_118 ( V_534 ) ;
V_69 &= V_535 | V_536 ;
V_69 |= ( 4UL << V_537 ) | V_538 |
V_539 | V_540 ;
V_70 -> V_16 . V_520 = V_521 |
( V_522 << V_523 ) ;
if ( F_2 ( V_2 ) )
V_69 |= V_541 ;
V_70 -> V_16 . V_69 = V_69 ;
...
V_70 -> V_16 . V_382 = F_111 ( V_360 , V_542 ) ;
if ( ! F_110 ( V_70 -> V_16 . V_382 ) )
F_219 ( V_70 ) ;
return 0 ;
}
...
unsigned int V_543 , int * V_544 )
{
return V_545 ;
}
static int F_227 ( struct V_11 * V_12 , int V_546 ,
T_4 V_547 )
{
return V_545 ;
}
static int F_228 ( struct V_11 * V_12 , int V_546 ,
T_4 * V_547 )
{
return V_545 ;
}
...
static long F_230 ( struct V_355 * V_551 ,
unsigned int V_552 , unsigned long V_553 )
{
struct V_70 * V_70 V_554 = V_551 -> V_359 ;
void T_6 * V_555 = ( void T_6 * ) V_553 ;
long V_47 ;
switch ( V_552 ) {
case V_556 : {
T_3 V_557 ;
V_47 = - V_380 ;
if ( F_231 ( V_557 , ( T_3 T_6 * ) V_555 ) )
break;
V_47 = F_232 ( V_70 , & V_557 ) ;
if ( V_47 )
break;
V_47 = - V_380 ;
if ( F_233 ( V_557 , ( T_3 T_6 * ) V_555 ) )
break;
V_47 = 0 ;
break;
}
...
struct V_559 V_560 ;
V_47 = - V_380 ;
if ( F_234 ( & V_560 , V_555 , sizeof( V_560 ) ) )
break;
V_47 = F_235 ( V_70 , & V_560 ) ;
break;
}
default:
V_47 = - V_561 ;
