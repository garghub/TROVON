...
break;
V_112 += F_37 ( V_111 + V_112 , V_113 - V_112 , L_3 ,
V_46 [ V_42 ] . V_47 ) ;
}
V_111 [ V_112 - 1 ] = '\n' ;
return V_112 ;
}
static T_8 F_38 ( int V_114 , void * V_115 )
{
struct V_116 * V_117 = V_115 ;
struct V_85 * V_86 = V_117 -> V_86 ;
struct V_21 * V_22 = F_27 ( V_86 ) ;
int V_26 ;
F_29 ( & V_22 -> V_95 ) ;
...
V_26 = F_14 ( V_22 -> V_28 , V_124 , & V_121 ) ;
if ( V_26 < 0 ) {
F_11 ( & V_22 -> V_39 -> V_2 , L_5 ) ;
goto V_125;
}
if ( V_121 != V_126 ) {
F_11 ( & V_22 -> V_39 -> V_2 , L_6 , V_121 ) ;
V_26 = - V_127 ;
goto V_125;
}
F_42 ( & V_22 -> V_39 -> V_2 , L_7 , V_121 ) ;
V_123 = V_128 [ V_129 ] ;
V_26 = F_16 ( V_22 , V_123 . V_50 ) ;
if ( V_26 < 0 ) {
F_11 ( & V_22 -> V_39 -> V_2 , L_8 ,
V_123 . V_50 ) ;
goto V_125;
}
V_26 = F_43 ( V_22 -> V_28 , V_10 ,
F_32 ( V_123 . V_48 ) ) ;
if ( V_26 < 0 ) {
...
V_26 = F_17 ( V_22 , V_123 . V_48 , V_123 . V_49 ,
V_123 . V_50 ) ;
if ( V_26 < 0 )
goto V_125;
V_26 = F_3 ( V_22 , V_35 ,
...
static int F_48 ( struct V_134 * V_39 )
{
struct V_1 * V_2 ;
struct V_135 * V_136 ;
int V_26 ;
...
return V_26 ;
V_26 = F_53 ( V_136 ) ;
F_42 ( V_2 , L_13 , F_54 ( V_136 ) , V_26 ) ;
return V_26 ;
}
static const char * F_55 ( struct V_1 * V_2 )
{
const struct V_138 * V_139 ;
V_139 = F_56 ( V_2 -> V_140 -> V_141 , V_2 ) ;
if ( ! V_139 )
return NULL ;
return F_57 ( V_2 ) ;
}
static int F_58 ( struct V_134 * V_39 ,
const struct V_142 * V_139 )
{
struct V_21 * V_22 ;
struct V_85 * V_86 ;
const char * V_143 = NULL ;
int V_26 ;
V_86 = F_59 ( & V_39 -> V_2 , sizeof( * V_22 ) ) ;
if ( ! V_86 )
return - V_144 ;
V_22 = F_27 ( V_86 ) ;
F_60 ( V_39 , V_86 ) ;
...
if ( V_139 )
V_143 = V_139 -> V_143 ;
else if ( F_61 ( & V_39 -> V_2 ) )
V_143 = F_55 ( & V_39 -> V_2 ) ;
else
return - V_145 ;
F_62 ( & V_22 -> V_95 ) ;
V_22 -> V_28 = F_63 ( V_39 , & V_146 ) ;
if ( F_50 ( V_22 -> V_28 ) ) {
F_11 ( & V_39 -> V_2 , L_14 ) ;
return F_51 ( V_22 -> V_28 ) ;
}
V_26 = F_41 ( V_22 ) ;
if ( V_26 < 0 )
return V_26 ;
V_86 -> V_2 . V_147 = & V_39 -> V_2 ;
V_86 -> V_148 = V_149 ;
V_86 -> V_150 = F_15 ( V_149 ) ;
V_86 -> V_151 = V_152 ;
V_86 -> V_143 = V_143 ;
V_86 -> V_153 = V_154 ;
V_86 -> V_155 = & V_156 ;
if ( V_39 -> V_114 <= 0 )
V_39 -> V_114 = F_48 ( V_39 ) ;
if ( V_39 -> V_114 > 0 ) {
V_22 -> V_108 = F_64 ( & V_39 -> V_2 ,
L_15 ,
V_86 -> V_143 ,
V_86 -> V_139 ) ;
if ( ! V_22 -> V_108 ) {
...
V_22 -> V_108 -> V_2 . V_147 = & V_39 -> V_2 ;
V_22 -> V_108 -> V_157 = & V_158 ;
F_65 ( V_22 -> V_108 , V_86 ) ;
V_26 = F_66 ( V_22 -> V_108 ) ;
if ( V_26 ) {
F_11 ( & V_39 -> V_2 , L_17 ) ;
goto V_125;
}
...
V_168 ) ;
F_73 ( & V_39 -> V_2 ) ;
F_42 ( & V_86 -> V_2 , L_21 , V_143 ) ;
return 0 ;
V_167:
F_74 ( V_86 ) ;
V_166:
if ( V_39 -> V_114 > 0 )
F_75 ( V_39 -> V_114 , V_22 -> V_108 ) ;
V_165:
if ( V_22 -> V_108 )
F_76 ( V_86 ) ;
V_160:
...
static int F_78 ( struct V_134 * V_39 )
{
struct V_85 * V_86 = F_79 ( V_39 ) ;
struct V_21 * V_22 = F_27 ( V_86 ) ;
F_80 ( & V_39 -> V_2 ) ;
F_81 ( & V_39 -> V_2 ) ;
F_12 ( & V_39 -> V_2 ) ;
F_74 ( V_86 ) ;
if ( V_39 -> V_114 > 0 )
F_75 ( V_22 -> V_39 -> V_114 , V_22 -> V_108 ) ;
if ( V_22 -> V_108 ) {
F_76 ( V_86 ) ;
F_77 ( V_22 -> V_108 ) ;
}
...
{
struct V_85 * V_86 = F_79 ( F_83 ( V_2 ) ) ;
struct V_21 * V_22 = F_27 ( V_86 ) ;
int V_26 ;
F_29 ( & V_22 -> V_95 ) ;
V_26 = F_3 ( V_22 , V_31 ,
