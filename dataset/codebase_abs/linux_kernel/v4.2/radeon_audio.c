...
if ( V_13 && V_13 -> V_87 && V_11 -> V_18 &&
V_11 -> V_18 -> V_88 )
V_11 -> V_18 -> V_88 ( V_2 , V_13 -> V_87 -> V_3 ,
V_74 , sizeof( V_74 ) ) ;
return 0 ;
}
static void F_48 ( unsigned int clock , int * V_89 , int * V_90 , int V_91 )
{
int V_92 , V_93 ;
unsigned long div , V_94 ;
V_92 = 128 * V_91 ;
V_93 = clock * 1000 ;
div = F_49 ( V_92 , V_93 ) ;
V_92 /= div ;
V_93 /= div ;
V_94 = ( ( 128 * V_91 / 1000 ) + ( V_92 - 1 ) ) / V_92 ;
V_92 *= V_94 ;
V_93 *= V_94 ;
if ( V_92 < ( 128 * V_91 / 1500 ) )
F_50 ( V_95 L_5 ) ;
if ( V_92 > ( 128 * V_91 / 300 ) )
F_50 ( V_95 L_6 ) ;
* V_90 = V_92 ;
* V_89 = V_93 ;
F_33 ( L_7 ,
...
static const struct V_96 * F_51 ( unsigned int clock )
{
static struct V_96 V_97 ;
T_2 V_34 ;
static const struct V_96 V_98 [] = {
...
for ( V_34 = 0 ; V_34 < F_52 ( V_98 ) ; V_34 ++ )
if ( V_98 [ V_34 ] . clock == clock )
return & V_98 [ V_34 ] ;
F_48 ( clock , & V_97 . V_99 , & V_97 . V_100 , 32000 ) ;
F_48 ( clock , & V_97 . V_101 , & V_97 . V_102 , 44100 ) ;
F_48 ( clock , & V_97 . V_103 , & V_97 . V_104 , 48000 ) ;
return & V_97 ;
}
static void F_53 ( struct V_9 * V_10 , unsigned int clock )
{
const struct V_96 * V_105 = F_51 ( clock ) ;
struct V_11 * V_11 = F_8 ( V_10 ) ;
struct V_12 * V_13 = V_11 -> V_17 ;
if ( ! V_13 || ! V_13 -> V_87 )
return;
if ( V_11 -> V_18 && V_11 -> V_18 -> V_106 )
V_11 -> V_18 -> V_106 ( V_10 , V_13 -> V_87 -> V_3 , V_105 ) ;
}
...
V_11 -> V_18 -> V_107 ( V_10 , V_13 -> V_87 -> V_3 ) ;
}
...
if ( V_11 -> V_18 && V_11 -> V_18 -> V_109 )
V_11 -> V_18 -> V_109 ( V_10 , V_13 -> V_87 -> V_3 , V_108 ) ;
}
...
V_11 -> V_18 -> V_110 ( V_10 , V_13 -> V_87 -> V_3 ) ;
}
static void F_57 ( struct V_9 * V_10 , bool V_111 )
{
struct V_11 * V_11 = F_8 ( V_10 ) ;
struct V_12 * V_13 = V_11 -> V_17 ;
if ( ! V_13 || ! V_13 -> V_87 )
return;
if ( V_11 -> V_18 && V_11 -> V_18 -> V_112 )
V_11 -> V_18 -> V_112 ( V_10 , V_13 -> V_87 -> V_3 , V_111 ) ;
}
...
F_24 ( V_10 ) ;
F_34 ( V_10 , V_57 ) ;
if ( V_2 -> clock . V_116 || F_60 ( V_2 ) )
F_42 ( V_10 , V_2 -> clock . V_117 * 10 ) ;
else
F_42 ( V_10 , V_114 -> V_118 ) ;
F_56 ( V_10 ) ;
F_36 ( V_10 ) ;
if ( F_44 ( V_10 , V_57 ) < 0 )
return;
...
{
struct V_11 * V_11 = F_8 ( V_10 ) ;
if ( V_11 -> V_18 && V_11 -> V_18 -> V_119 )
V_11 -> V_18 -> V_119 ( V_10 , V_57 ) ;
}
void F_62 ( struct V_9 * V_10 , int V_57 )
{
struct V_11 * V_11 = F_8 ( V_10 ) ;
if ( V_11 -> V_18 && V_11 -> V_18 -> V_120 )
V_11 -> V_18 -> V_120 ( V_10 , V_57 == V_121 ) ;
}
