...
static int F_18 ( struct V_19 * V_22 , struct V_23 * V_23 )
{
struct V_19 V_19 = { V_22 -> V_24 , V_23 } ;
return F_16 ( V_25 , & V_19 , NULL ) ;
}
static int F_19 ( struct V_19 * V_22 , struct V_23 * V_23 ,
T_2 V_26 )
{
struct V_19 V_19 = { V_22 -> V_24 , V_23 } ;
...
static int F_21 ( struct V_19 * V_22 , struct V_23 * V_23 )
{
struct V_19 V_19 = { V_22 -> V_24 , V_23 } ;
return F_16 ( V_29 , & V_19 , NULL ) ;
}
static int F_22 ( struct V_19 * V_22 , struct V_23 * V_23 ,
const char * V_30 )
{
struct V_19 V_19 = { V_22 -> V_24 , V_23 } ;
return F_16 ( V_31 , & V_19 , V_30 ) ;
}
static int F_23 ( struct V_19 * V_22 , struct V_23 * V_23 ,
...
static int F_25 ( struct V_23 * V_45 , struct V_19 * V_46 ,
struct V_23 * V_47 )
{
...
static int F_27 ( struct V_19 * V_51 ,
struct V_23 * V_45 ,
struct V_19 * V_52 ,
struct V_23 * V_47 )
{
...
static int F_32 ( struct V_19 * V_19 , T_2 V_26 )
{
return F_20 ( V_65 , V_19 ,
V_26 & V_28 ) ;
}
static int F_33 ( struct V_19 * V_19 , T_3 V_66 , T_4 V_67 )
{
int error = 0 ;
if ( F_34 ( V_66 ) )
...
static int F_39 ( const char * V_72 , struct V_19 * V_19 ,
...
static int F_42 ( struct V_19 * V_77 , struct V_19 * V_78 )
{
