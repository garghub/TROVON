...
char * V_31 )
{
return snprintf ( V_31 , 20 , L_17 , ( int ) sizeof( V_106 ) * 8 ) ;
}
static T_1
...
if ( ! V_45 -> V_109 )
return - V_24 ;
V_107 = F_73 ( V_31 , NULL , 0 ) ;
if ( V_107 < 1 || V_107 > V_61 -> V_70 -> V_110 )
return - V_24 ;
V_108 = V_45 -> V_109 ( V_61 , V_107 ) ;
if ( V_108 < 0 )
return V_108 ;
V_61 -> V_111 = V_61 -> V_112 ;
return V_32 ;
}
static T_1
...
struct V_60 * V_61 = F_39 ( V_28 ) ;
unsigned int V_114 ;
if ( F_58 ( V_31 , 10 , & V_114 ) )
return - V_24 ;
V_61 -> V_113 = F_77 ( V_114 ) ;
return V_114 ;
}
static T_3 F_78 ( struct V_115 * V_116 ,
struct V_117 * V_30 , int V_3 )
{
struct V_27 * V_28 = F_31 ( V_116 , struct V_27 , V_116 ) ;
struct V_60 * V_61 = F_39 ( V_28 ) ;
if ( V_30 == & V_118 . V_30 &&
...
static int F_79 ( struct V_121 * V_122 )
{
int error ;
if ( V_122 -> V_2 != V_123 )
return 0 ;
error = F_80 ( & V_122 -> V_28 ) ;
if ( error ) {
F_81 ( & V_122 -> V_28 , L_22 , error ) ;
return error ;
}
F_82 ( & V_122 -> V_28 ) ;
V_122 -> V_2 = V_124 ;
...
{
int error , V_3 ;
struct V_78 * V_125 = V_61 -> V_78 ;
struct V_121 * V_122 = V_61 -> V_126 ;
error = F_65 ( V_61 , V_127 ) ;
if ( error )
return error ;
error = F_79 ( V_122 ) ;
if ( error )
...
F_82 ( & V_61 -> V_62 ) ;
V_61 -> V_129 = 1 ;
error = F_93 ( V_125 , & V_61 -> V_62 , NULL , NULL ) ;
if ( error )
F_69 ( V_105 , V_61 ,
L_25 , error ) ;
if ( V_61 -> V_70 -> V_39 -> V_130 ) {
for ( V_3 = 0 ; V_61 -> V_70 -> V_39 -> V_130 [ V_3 ] ; V_3 ++ ) {
error = F_94 ( & V_61 -> V_62 ,
V_61 -> V_70 -> V_39 -> V_130 [ V_3 ] ) ;
if ( error )
return error ;
}
}
...
F_100 ( V_61 -> V_78 ) ;
F_33 ( & V_61 -> V_133 ) ;
if ( V_61 -> V_70 -> V_39 -> V_134 )
V_61 -> V_70 -> V_39 -> V_134 ( V_61 ) ;
F_101 ( V_28 ) ;
F_102 ( V_121 ( V_61 ) ) ;
F_29 ( V_28 ) ;
}
...
static void F_105 ( struct V_121 * V_122 )
{
struct V_13 * V_14 = F_106 ( V_122 -> V_28 . V_65 ) ;
unsigned long V_52 ;
struct V_60 * V_61 ;
F_22 ( V_14 -> V_56 , V_52 ) ;
V_136:
F_107 (sdev, &shost->__devices, siblings) {
if ( V_61 -> V_20 != V_122 -> V_20 ||
V_61 -> V_21 != V_122 -> V_21 ||
F_108 ( V_61 ) )
continue;
F_24 ( V_14 -> V_56 , V_52 ) ;
F_63 ( V_61 ) ;
...
struct V_121 * V_122 , * V_11 = NULL ;
unsigned long V_52 ;
F_22 ( V_14 -> V_56 , V_52 ) ;
F_107 (starget, &shost->__targets, siblings) {
if ( V_122 -> V_2 == V_137 )
continue;
if ( V_122 -> V_28 . V_65 == V_28 || & V_122 -> V_28 == V_28 ) {
F_111 ( & V_122 -> V_138 ) ;
F_24 ( V_14 -> V_56 , V_52 ) ;
if ( V_11 )
F_102 ( V_11 ) ;
...
int F_112 ( struct V_83 * V_139 )
{
V_139 -> V_140 = & V_92 ;
return F_113 ( V_139 ) ;
}
int F_114 ( struct V_141 * V_142 )
{
V_142 -> V_143 = & V_93 ;
return F_115 ( V_142 ) ;
}
...
struct V_121 * V_122 = V_61 -> V_126 ;
F_119 ( & V_61 -> V_62 ) ;
V_61 -> V_62 . V_140 = & V_92 ;
V_61 -> V_62 . type = & V_85 ;
F_120 ( & V_61 -> V_62 , L_26 ,
V_61 -> V_70 -> V_147 , V_61 -> V_20 , V_61 -> V_21 , V_61 -> V_22 ) ;
F_119 ( & V_61 -> V_128 ) ;
V_61 -> V_128 . V_65 = F_121 ( & V_61 -> V_62 ) ;
V_61 -> V_128 . V_143 = & V_93 ;
F_120 ( & V_61 -> V_128 , L_26 ,
V_61 -> V_70 -> V_147 , V_61 -> V_20 , V_61 -> V_21 , V_61 -> V_22 ) ;
V_61 -> V_148 = V_122 -> V_148 ;
if ( V_61 -> V_148 <= V_149 &&
V_61 -> V_148 != V_150 &&
! V_14 -> V_151 )
V_61 -> V_152 = 1 ;
F_122 ( & V_61 -> V_62 ) ;
F_22 ( V_14 -> V_56 , V_52 ) ;
F_123 ( & V_61 -> V_72 , & V_122 -> V_153 ) ;
F_123 ( & V_61 -> V_71 , & V_14 -> V_154 ) ;
F_24 ( V_14 -> V_56 , V_52 ) ;
F_111 ( & V_122 -> V_138 ) ;
}
