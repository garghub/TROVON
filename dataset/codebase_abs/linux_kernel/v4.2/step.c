...
V_22 = F_8 ( V_2 , V_5 , V_23 , sizeof( V_23 ) , 0 ) ;
...
void F_16 ( struct V_1 * V_29 , bool V_30 )
{
unsigned long V_31 ;
F_17 () ;
V_31 = F_18 () ;
...
static void F_21 ( struct V_1 * V_2 , bool V_35 )
{
if ( F_11 ( V_2 ) && V_35 )
F_16 ( V_2 , true ) ;
else if ( F_13 ( V_2 , V_33 ) )
F_16 ( V_2 , false ) ;
}
