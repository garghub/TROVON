...
static void F_57 ( void * args )
{
struct V_1 * V_2 = args ;
struct V_8 * V_9 = & V_2 -> V_4 ;
unsigned int V_94 = V_2 -> V_124 ;
struct V_125 * V_115 = F_58 ( & V_2 -> V_4 . V_76 -> V_126 ) ;
struct V_114 * V_126 = & V_9 -> V_76 -> V_126 ;
unsigned long V_93 ;
struct V_92 V_76 ;
enum V_127 V_128 ;
F_33 ( & V_9 -> V_100 , V_93 ) ;
V_128 = F_31 ( V_2 -> V_129 , V_2 -> V_130 , & V_76 ) ;
if ( V_128 == V_131 ) {
F_59 ( V_2 -> V_4 . V_51 , L_9 ) ;
goto V_132;
}
F_32 ( V_2 -> V_133 ) ;
if ( V_2 -> V_23 )
...
struct V_92 V_76 ;
struct V_125 * V_115 = F_58 ( & V_2 -> V_4 . V_76 -> V_126 ) ;
struct V_114 * V_126 = & V_2 -> V_4 . V_76 -> V_126 ;
struct V_8 * V_9 = & V_2 -> V_4 ;
unsigned int V_94 ;
if ( V_2 -> V_23 )
F_8 ( V_2 , false ) ;
F_48 ( V_2 -> V_129 ) ;
F_31 ( V_2 -> V_129 , V_2 -> V_130 , & V_76 ) ;
F_32 ( V_2 -> V_133 ) ;
V_94 = V_2 -> V_124 - V_76 . V_98 ;
F_53 ( V_2 , V_126 , V_94 ) ;
F_50 ( V_2 , V_126 ) ;
if ( V_115 ) {
F_37 ( & V_9 -> V_100 , * V_93 ) ;
...
V_2 -> V_133 -> V_108 = F_57 ;
V_2 -> V_133 -> V_109 = V_2 ;
F_39 ( V_2 -> V_4 . V_51 , V_2 -> V_120 ,
V_94 , V_104 ) ;
V_2 -> V_124 = V_94 ;
V_2 -> V_130 = F_41 ( V_2 -> V_133 ) ;
F_42 ( V_2 -> V_129 ) ;
return 0 ;
}
...
V_2 -> V_4 . V_61 . V_141 ++ ;
if ( V_135 & V_142 )
F_65 ( & V_2 -> V_4 , V_135 & V_143 ) ;
if ( V_135 & V_144 )
F_66 ( & V_2 -> V_4 , V_135 & V_145 ) ;
return;
}
static T_3 F_67 ( int V_146 , void * V_147 )
{
...
V_175 = F_85 ( V_2 -> V_4 . V_51 ,
V_2 -> V_4 . V_76 -> V_75 . V_81 , V_83 ,
V_104 ) ;
if ( F_86 ( V_2 -> V_4 . V_51 , V_175 ) ) {
...
unsigned int V_27 ;
int V_34 = 1 ;
struct V_194 * V_195 = F_96 ( V_2 -> V_50 ) ;
...
V_2 -> V_28 = V_27 ;
V_2 -> V_34 = V_34 ;
V_45 = F_97 ( V_9 , V_192 , V_193 ,
V_196 / V_197 ,
V_196 / 16 ) ;
F_37 ( & V_9 -> V_100 , V_93 ) ;
F_17 ( V_2 , V_45 ) ;
if ( F_98 ( V_192 ) )
F_99 ( V_192 , V_45 , V_45 ) ;
F_33 ( & V_9 -> V_100 , V_93 ) ;
...
static const char * F_101 ( struct V_8 * V_9 )
{
return V_216 ;
}
static int F_102 ( struct V_217 * V_218 ,
struct V_1 * V_2 )
{
struct V_219 * V_220 = V_218 -> V_51 . V_221 ;
int V_126 ;
V_126 = F_103 ( V_220 , L_24 ) ;
if ( V_126 < 0 ) {
F_19 ( & V_218 -> V_51 , L_25 , V_126 ) ;
return V_126 ;
}
V_2 -> V_4 . line = V_126 ;
V_2 -> V_10 = F_104 ( V_220 ,
L_26 ) ;
return 0 ;
}
static int F_105 ( struct V_217 * V_218 )
{
struct V_1 * V_2 ;
struct V_8 * V_9 ;
struct V_222 * V_222 ;
...
V_225 = F_106 ( V_226 , & V_218 -> V_51 ) ;
if ( ! V_225 ) {
F_19 ( & V_218 -> V_51 , L_27 ) ;
return - V_227 ;
}
V_38 = V_225 -> V_147 ;
V_2 = F_107 ( & V_218 -> V_51 , sizeof( * V_2 ) , V_178 ) ;
if ( ! V_2 ) {
F_19 ( & V_218 -> V_51 , L_28 ) ;
return - V_179 ;
}
V_48 = F_102 ( V_218 , V_2 ) ;
if ( V_48 < 0 )
return V_48 ;
V_9 = & V_2 -> V_4 ;
V_9 -> V_51 = & V_218 -> V_51 ;
...
V_2 -> V_38 = V_38 ;
F_108 ( V_218 , V_2 ) ;
V_222 = F_109 ( V_218 , V_231 , 0 ) ;
if ( ! V_222 ) {
F_19 ( & V_218 -> V_51 , L_29 ) ;
return - V_227 ;
}
V_9 -> V_181 = V_222 -> V_232 ;
V_9 -> V_5 = F_110 ( & V_218 -> V_51 , V_222 ) ;
if ( F_82 ( V_9 -> V_5 ) )
return F_83 ( V_9 -> V_5 ) ;
V_2 -> V_50 = F_111 ( & V_218 -> V_51 , NULL ) ;
if ( F_82 ( V_2 -> V_50 ) ) {
F_19 ( & V_218 -> V_51 , L_30 ) ;
return F_83 ( V_2 -> V_50 ) ;
}
V_2 -> V_165 = F_112 ( & V_218 -> V_51 , L_24 ) ;
if ( F_82 ( V_2 -> V_165 ) ) {
F_19 ( & V_218 -> V_51 , L_31 ) ;
return F_83 ( V_2 -> V_165 ) ;
}
V_9 -> V_233 = V_234 ;
V_9 -> V_146 = F_113 ( V_218 , 0 ) ;
V_9 -> V_6 = 2 ;
V_48 = F_114 ( & V_235 , V_9 ) ;
if ( V_48 < 0 ) {
...
{
struct V_1 * V_2 = F_116 ( V_218 ) ;
struct V_8 * V_9 = & V_2 -> V_4 ;
F_117 ( & V_235 , V_9 ) ;
return 0 ;
}
static int F_118 ( struct V_236 * V_51 )
{
struct V_1 * V_2 = F_119 ( V_51 ) ;
struct V_8 * V_9 = & V_2 -> V_4 ;
return F_120 ( & V_235 , V_9 ) ;
}
static int F_121 ( struct V_236 * V_51 )
{
struct V_1 * V_2 = F_119 ( V_51 ) ;
struct V_8 * V_9 = & V_2 -> V_4 ;
return F_122 ( & V_235 , V_9 ) ;
}
