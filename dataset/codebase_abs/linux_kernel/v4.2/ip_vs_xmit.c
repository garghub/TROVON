...
V_19 = F_49 ( & V_29 -> V_7 ) - sizeof( struct V_91 ) ;
if ( V_19 < V_92 ) {
F_20 ( L_11 , V_82 ,
V_92 ) ;
goto V_80;
...
static inline int F_65 ( struct V_17 * V_18 ,
struct V_93 * V_94 )
{
int V_95 = V_96 ;
V_18 -> V_97 = 1 ;
...
static inline int F_72 ( int V_99 , struct V_17 * V_18 ,
struct V_93 * V_94 , int V_72 )
{
int V_95 = V_100 ;
V_18 -> V_97 = 1 ;
if ( F_45 ( ! ( V_94 -> V_39 & V_98 ) ) )
F_73 ( V_18 ) ;
else
F_74 ( V_18 , V_94 , 1 ) ;
if ( ! V_72 || V_94 -> V_101 != V_94 -> V_102 ||
! F_75 ( V_94 -> V_103 , & V_94 -> V_104 , & V_94 -> V_24 ) )
F_70 ( V_18 ) ;
if ( ! V_72 ) {
F_68 ( V_18 ) ;
if ( ! V_18 -> V_56 )
F_69 ( V_18 ) ;
F_76 ( V_99 , V_105 , NULL , V_18 ,
NULL , F_27 ( V_18 ) -> V_38 , V_106 ) ;
} else
V_95 = V_96 ;
return V_95 ;
}
static inline int F_77 ( int V_99 , struct V_17 * V_18 ,
struct V_93 * V_94 , int V_72 )
{
int V_95 = V_100 ;
V_18 -> V_97 = 1 ;
...
int
F_78 ( struct V_17 * V_18 , struct V_93 * V_94 ,
struct V_107 * V_108 , struct V_59 * V_60 )
{
return F_77 ( V_109 , V_18 , V_94 , 1 ) ;
}
int
F_79 ( struct V_17 * V_18 , struct V_93 * V_94 ,
struct V_107 * V_108 , struct V_59 * V_60 )
{
struct V_81 * V_110 = F_29 ( V_18 ) ;
F_80 ( 10 ) ;
F_81 () ;
if ( F_44 ( V_94 -> V_103 , V_18 , NULL , V_110 -> V_24 ,
V_111 , NULL , V_60 ) < 0 )
goto V_112;
F_82 ( V_110 ) ;
V_18 -> V_113 = 1 ;
F_77 ( V_109 , V_18 , V_94 , 0 ) ;
F_83 () ;
F_84 ( 10 ) ;
return V_100 ;
V_112:
...
int
F_86 ( struct V_17 * V_18 , struct V_93 * V_94 ,
struct V_107 * V_108 , struct V_59 * V_60 )
{
F_80 ( 10 ) ;
F_81 () ;
if ( F_63 ( V_94 -> V_103 , V_18 , NULL , & V_60 -> V_24 . V_90 , NULL ,
V_60 , 0 , V_111 ) < 0 )
goto V_112;
V_18 -> V_113 = 1 ;
F_77 ( V_114 , V_18 , V_94 , 0 ) ;
F_83 () ;
F_84 ( 10 ) ;
return V_100 ;
V_112:
...
int
F_87 ( struct V_17 * V_18 , struct V_93 * V_94 ,
struct V_107 * V_108 , struct V_59 * V_60 )
{
struct V_22 * V_29 ;
...
T_3 V_118 , * V_119 ;
V_119 = F_88 ( V_18 , V_60 -> V_21 , sizeof( V_118 ) , & V_118 ) ;
if ( V_119 == NULL )
goto V_112;
F_89 ( V_94 , * V_119 ) ;
F_37 ( 10 , L_12 , F_90 ( * V_119 ) ) ;
}
V_116 = F_91 ( F_30 ( V_18 ) ) ;
V_72 = F_44 ( V_94 -> V_103 , V_18 , V_94 -> V_5 , V_94 -> V_24 . V_76 ,
V_44 |
V_111 |
V_47 , NULL , V_60 ) ;
if ( V_72 < 0 )
...
enum V_122 V_123 ;
struct V_124 * V_125 = F_93 ( V_18 , & V_123 ) ;
if ( V_125 && ! F_94 ( V_125 ) ) {
F_95 ( 10 , V_126 , V_108 , V_18 , 0 ,
L_13
L_14 ) ;
goto V_112;
}
...
F_95 ( 1 , V_126 , V_108 , V_18 , 0 , L_13
L_15 ) ;
goto V_112;
}
if ( ! F_96 ( V_18 , sizeof( struct V_81 ) ) )
goto V_112;
if ( F_97 ( V_18 , V_29 -> V_7 . V_38 -> V_127 ) )
goto V_112;
if ( V_108 -> V_128 && ! V_108 -> V_128 ( V_18 , V_108 , V_94 , V_60 ) )
goto V_112;
F_29 ( V_18 ) -> V_24 = V_94 -> V_24 . V_76 ;
F_82 ( F_29 ( V_18 ) ) ;
F_98 ( 10 , V_126 , V_108 , V_18 , 0 , L_16 ) ;
V_18 -> V_113 = 1 ;
V_115 = F_72 ( V_109 , V_18 , V_94 , V_72 ) ;
F_83 () ;
F_84 ( 10 ) ;
return V_115 ;
V_112:
...
int
F_99 ( struct V_17 * V_18 , struct V_93 * V_94 ,
struct V_107 * V_108 , struct V_59 * V_60 )
{
struct V_37 * V_29 ;
int V_72 , V_115 ;
F_80 ( 10 ) ;
F_81 () ;
if ( F_31 ( V_94 -> V_39 & V_117 && ! V_60 -> V_62 ) ) {
T_3 V_118 , * V_119 ;
V_119 = F_88 ( V_18 , V_60 -> V_21 , sizeof( V_118 ) , & V_118 ) ;
if ( V_119 == NULL )
goto V_112;
...
V_72 = F_63 ( V_94 -> V_103 , V_18 , V_94 -> V_5 , & V_94 -> V_24 . V_90 ,
NULL , V_60 , 0 ,
V_44 |
V_111 |
V_47 ) ;
...
F_95 ( 1 , V_50 , V_108 , V_18 , 0 ,
L_17
L_15 ) ;
goto V_112;
}
if ( ! F_96 ( V_18 , sizeof( struct V_91 ) ) )
goto V_112;
if ( F_97 ( V_18 , V_29 -> V_7 . V_38 -> V_127 ) )
goto V_112;
if ( V_108 -> V_128 && ! V_108 -> V_128 ( V_18 , V_108 , V_94 , V_60 ) )
...
F_98 ( 10 , V_50 , V_108 , V_18 , 0 , L_16 ) ;
V_18 -> V_113 = 1 ;
V_115 = F_72 ( V_114 , V_18 , V_94 , V_72 ) ;
F_83 () ;
F_84 ( 10 ) ;
return V_115 ;
V_112:
...
unsigned int V_129 , T_4 * V_130 ,
T_5 * V_131 , T_4 * V_132 , T_4 * V_133 ,
T_3 * V_134 )
{
struct V_17 * V_135 = NULL ;
struct V_81 * V_136 = NULL ;
#ifdef F_24
struct V_91 * V_137 = NULL ;
#endif
F_70 ( V_18 ) ;
if ( F_101 ( V_18 ) < V_129 || F_102 ( V_18 ) ) {
V_135 = F_103 ( V_18 , V_129 ) ;
if ( ! V_135 )
goto error;
if ( V_18 -> V_56 )
F_104 ( V_135 , V_18 -> V_56 ) ;
F_105 ( V_18 ) ;
V_18 = V_135 ;
}
#ifdef F_24
...
V_136 = F_29 ( V_18 ) ;
if ( V_134 )
* V_134 = ( V_136 -> V_67 & F_41 ( V_68 ) ) ;
* V_130 = V_140 ;
F_82 ( V_136 ) ;
* V_132 = F_107 ( V_136 ) ;
* V_133 = V_136 -> V_133 ;
if ( V_131 )
* V_131 = F_90 ( V_136 -> V_141 ) ;
}
return V_18 ;
error:
F_85 ( V_18 ) ;
...
static inline int F_109 ( int V_143 , int V_144 )
{
if ( V_143 == V_126 ) {
if ( V_144 == V_126 )
return V_145 ;
...
int
F_110 ( struct V_17 * V_18 , struct V_93 * V_94 ,
struct V_107 * V_108 , struct V_59 * V_60 )
{
...
V_29 = F_30 ( V_18 ) ;
V_148 = V_29 -> V_7 . V_38 ;
V_129 = F_111 ( V_148 ) + sizeof( struct V_81 ) ;
V_149 = F_40 ( V_65 ) ? & V_134 : NULL ;
V_18 = F_100 ( V_18 , V_94 -> V_103 , V_129 ,
& V_130 , NULL , & V_132 ,
& V_133 , V_149 ) ;
if ( F_17 ( V_18 ) )
goto V_112;
V_18 = F_112 (
V_18 , false , F_109 ( V_126 , V_94 -> V_103 ) ) ;
if ( F_17 ( V_18 ) )
goto V_112;
V_18 -> V_150 = V_18 -> V_151 ;
F_113 ( V_18 , sizeof( struct V_81 ) ) ;
F_114 ( V_18 ) ;
memset ( & ( F_115 ( V_18 ) -> V_152 ) , 0 , sizeof( F_115 ( V_18 ) -> V_152 ) ) ;
V_110 = F_29 ( V_18 ) ;
V_110 -> V_153 = 4 ;
V_110 -> V_154 = sizeof( struct V_81 ) >> 2 ;
V_110 -> V_67 = V_134 ;
V_110 -> V_155 = V_130 ;
V_110 -> V_156 = V_132 ;
...
if ( V_72 ) {
F_83 () ;
return F_77 ( V_114 , V_18 , V_94 , 1 ) ;
}
V_29 = (struct V_37 * ) F_27 ( V_18 ) ;
V_148 = V_29 -> V_7 . V_38 ;
V_129 = F_111 ( V_148 ) + sizeof( struct V_91 ) ;
V_18 = F_100 ( V_18 , V_94 -> V_103 , V_129 ,
& V_130 , & V_131 ,
& V_132 , & V_133 , NULL ) ;
if ( F_17 ( V_18 ) )
goto V_112;
V_18 = F_112 (
V_18 , false , F_109 ( V_50 , V_94 -> V_103 ) ) ;
if ( F_17 ( V_18 ) )
goto V_112;
V_18 -> V_150 = V_18 -> V_151 ;
F_113 ( V_18 , sizeof( struct V_91 ) ) ;
F_114 ( V_18 ) ;
memset ( & ( F_115 ( V_18 ) -> V_152 ) , 0 , sizeof( F_115 ( V_18 ) -> V_152 ) ) ;
V_110 = F_26 ( V_18 ) ;
V_110 -> V_153 = 6 ;
V_110 -> V_158 = V_130 ;
V_110 -> V_131 = F_41 ( V_131 ) ;
memset ( & V_110 -> V_159 , 0 , sizeof( V_110 -> V_159 ) ) ;
F_119 ( V_110 , 0 , V_132 ) ;
...
int
F_121 ( struct V_17 * V_18 , struct V_93 * V_94 ,
struct V_107 * V_108 , struct V_59 * V_60 )
{
int V_72 ;
F_80 ( 10 ) ;
...
int
F_122 ( struct V_17 * V_18 , struct V_93 * V_94 ,
struct V_107 * V_108 , struct V_59 * V_60 )
{
int V_72 ;
F_80 ( 10 ) ;
...
int
F_123 ( struct V_17 * V_18 , struct V_93 * V_94 ,
struct V_107 * V_108 , int V_160 , unsigned int V_161 ,
struct V_59 * V_110 )
{
struct V_22 * V_29 ;
int V_115 ;
...
if ( F_124 ( V_94 ) != V_162 ) {
if ( V_94 -> V_163 )
V_115 = V_94 -> V_163 ( V_18 , V_94 , V_108 , V_110 ) ;
else
V_115 = V_96 ;
F_125 ( & V_94 -> V_164 ) ;
goto V_165;
...
V_47 : V_111 ;
F_81 () ;
V_72 = F_44 ( V_94 -> V_103 , V_18 , V_94 -> V_5 , V_94 -> V_24 . V_76 , V_25 ,
NULL , V_110 ) ;
if ( V_72 < 0 )
goto V_112;
V_29 = F_30 ( V_18 ) ;
...
int
F_127 ( struct V_17 * V_18 , struct V_93 * V_94 ,
struct V_107 * V_108 , int V_160 , unsigned int V_161 ,
struct V_59 * V_60 )
{
struct V_37 * V_29 ;
...
if ( F_124 ( V_94 ) != V_162 ) {
if ( V_94 -> V_163 )
V_115 = V_94 -> V_163 ( V_18 , V_94 , V_108 , V_60 ) ;
else
V_115 = V_96 ;
F_125 ( & V_94 -> V_164 ) ;
goto V_165;
