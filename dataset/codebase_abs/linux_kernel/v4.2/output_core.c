...
static int F_27 ( struct V_39 * V_40 , struct V_8 * V_9 )
{
int V_41 ;
...
return F_30 ( V_45 , V_46 , V_40 , V_9 ,
NULL , F_31 ( V_9 ) -> V_32 , V_47 ) ;
}
int F_32 ( struct V_8 * V_9 )
{
return F_27 ( V_9 -> V_40 , V_9 ) ;
}
int F_33 ( struct V_39 * V_40 , struct V_8 * V_9 )
{
int V_48 ;
V_48 = F_27 ( V_40 , V_9 ) ;
if ( F_34 ( V_48 == 1 ) )
