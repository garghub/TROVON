...
return V_47 ;
V_142 = F_78 ( V_53 , 1 ) ;
V_141 = F_79 ( V_53 , V_146 , 0 ) ;
V_46 = F_80 ( & V_53 -> V_53 , V_141 ) ;
if ( F_81 ( V_46 ) )
return F_82 ( V_46 ) ;
...
return F_82 ( V_79 ) ;
F_84 ( V_79 ) ;
V_2 = F_85 ( & V_53 -> V_53 , sizeof( * V_2 ) , V_147 ) ;
if ( ! V_2 )
return - V_148 ;
V_2 -> V_119 = V_53 -> V_145 ;
V_2 -> V_79 = V_79 ;
V_2 -> V_8 = V_46 ;
V_2 -> V_149 = V_47 ;
V_2 -> V_150 = V_142 ;
...
V_139 -> V_166 = F_46 ;
V_139 -> V_103 = V_167 ;
V_139 -> V_168 = F_88 ( V_147 , L_34 ,
V_53 -> V_145 ,
V_45 -> V_46 ,
V_45 -> V_46 + V_45 -> V_133 - 1 ) ;
F_23 ( V_2 -> V_79 ) ;
V_2 -> V_28 = F_89 ( V_2 -> V_8 + V_30 ) ;
F_25 ( V_2 -> V_79 ) ;
V_45 -> V_138 = V_137 ;
V_144 = F_90 ( & V_2 -> V_45 ) ;
if ( V_144 )
return V_144 ;
F_91 ( V_2 -> V_119 >= F_92 ( V_77 ) ) ;
V_77 [ V_2 -> V_119 ] = V_2 ;
F_93 ( V_53 , V_2 ) ;
V_144 = F_94 ( V_45 ,
V_139 ,
...
V_2 -> V_150 ,
F_55 ) ;
F_97 ( & V_53 -> V_53 , L_36 , V_2 -> V_8 ) ;
return 0 ;
}
static int F_98 ( struct V_80 * V_81 )
{
struct V_57 * V_58 = F_27 ( V_81 ) ;
return V_58 -> V_67 -> V_171 ;
}
static const char * F_99 ( struct V_80 * V_81 ,
unsigned V_172 )
{
struct V_57 * V_58 = F_27 ( V_81 ) ;
return V_58 -> V_67 -> V_173 [ V_172 ] . V_168 ;
}
static int F_100 ( struct V_80 * V_81 , unsigned V_172 ,
const unsigned * * V_174 ,
unsigned * V_175 )
{
struct V_57 * V_58 = F_27 ( V_81 ) ;
* V_174 = V_58 -> V_67 -> V_173 [ V_172 ] . V_174 ;
* V_175 = V_58 -> V_67 -> V_173 [ V_172 ] . V_176 ;
return 0 ;
}
static struct V_177 *
F_101 ( struct V_80 * V_81 , unsigned V_3 )
{
struct V_57 * V_58 = F_27 ( V_81 ) ;
int V_60 ;
for ( V_60 = 0 ; V_60 < V_58 -> V_67 -> V_178 ; V_60 ++ ) {
struct V_177 * V_179 ;
V_179 = & V_58 -> V_67 -> V_180 [ V_60 ] ;
if ( V_3 >= V_179 -> V_181 &&
V_3 <= ( V_179 -> V_181 + V_179 -> V_176 - 1 ) )
return V_179 ;
}
return NULL ;
}
static void F_102 ( struct V_80 * V_81 , struct V_121 * V_122 ,
unsigned V_3 )
{
struct V_177 * V_179 ;
struct V_85 * V_45 ;
V_179 = F_101 ( V_81 , V_3 ) ;
...
static int F_103 ( struct V_183 * * V_184 , unsigned * V_185 ,
...
if ( * V_186 == * V_185 )
return - V_189 ;
V_195 = F_105 ( V_193 , V_194 * sizeof( * V_195 ) ,
V_147 ) ;
if ( ! V_195 )
return - V_148 ;
...
static int F_106 ( int V_198 , int V_32 , unsigned long * V_199 )
{
int V_144 = 0 ;
...
static const char * F_107 ( struct V_80 * V_81 , const char * V_203 )
{
int V_60 , V_204 ;
struct V_57 * V_58 = F_27 ( V_81 ) ;
if ( sscanf ( ( char * ) V_203 , L_38 , & V_204 ) == 1 )
for ( V_60 = 0 ; V_60 < V_58 -> V_67 -> V_176 ; V_60 ++ )
if ( V_58 -> V_67 -> V_174 [ V_60 ] . V_205 == V_204 )
return V_58 -> V_67 -> V_174 [ V_60 ] . V_168 ;
return NULL ;
}
static bool F_108 ( struct V_136 * V_137 ,
unsigned long * V_193 )
{
bool V_206 = 0 ;
unsigned long V_207 = 0 ;
int V_60 , V_32 , V_144 ;
for ( V_60 = 0 ; V_60 < F_92 ( V_200 ) ; V_60 ++ ) {
V_144 = F_77 ( V_137 ,
V_200 [ V_60 ] . V_208 , & V_32 ) ;
if ( V_144 != - V_84 ) {
if ( F_106 ( V_60 , V_32 , & V_207 ) == 0 ) {
* V_193 |= V_207 ;
V_206 = 1 ;
}
}
...
struct V_208 * V_209 ;
struct V_136 * V_210 ;
V_144 = F_110 ( V_137 , L_39 , & V_188 ) ;
if ( V_144 >= 0 ) {
const char * V_187 ;
V_144 = F_111 ( V_137 , L_40 ) ;
if ( V_144 < 0 )
goto exit;
V_144 = F_112 ( V_81 , V_184 ,
V_185 ,
V_186 , V_144 ) ;
if ( V_144 < 0 )
goto exit;
F_113 (np, L_40 , prop, group) {
V_144 = F_103 ( V_184 , V_185 , V_186 ,
V_187 , V_188 ) ;
if ( V_144 < 0 )
goto exit;
}
}
V_206 = F_108 ( V_137 , & V_193 ) ;
V_210 = F_114 ( V_137 , L_41 , 0 ) ;
if ( V_210 )
V_206 |= F_108 ( V_210 , & V_193 ) ;
if ( V_206 ) {
const char * V_211 ;
const char * V_70 ;
V_144 = F_111 ( V_137 , L_42 ) ;
if ( V_144 < 0 )
goto exit;
V_144 = F_112 ( V_81 , V_184 ,
V_185 ,
...
if ( V_144 < 0 )
goto exit;
F_113 (np, L_42 , prop, pin) {
V_211 = F_107 ( V_81 , V_70 ) ;
V_144 = F_104 ( V_184 , V_185 ,
V_186 ,
V_211 , & V_193 , 1 ) ;
if ( V_144 < 0 )
goto exit;
...
* V_186 = 0 ;
F_116 (np_config, np) {
V_144 = F_109 ( V_81 , V_137 , V_184 ,
& V_185 , V_186 ) ;
if ( V_144 < 0 ) {
F_117 ( V_81 , * V_184 , * V_186 ) ;
return V_144 ;
}
}
return 0 ;
}
static int F_118 ( struct V_80 * V_81 )
{
struct V_57 * V_58 = F_27 ( V_81 ) ;
return V_58 -> V_67 -> V_212 ;
}
static const char * F_119 ( struct V_80 * V_81 ,
unsigned V_188 )
{
struct V_57 * V_58 = F_27 ( V_81 ) ;
return V_58 -> V_67 -> V_213 [ V_188 ] . V_168 ;
}
...
{
struct V_57 * V_58 = F_27 ( V_81 ) ;
* V_173 = V_58 -> V_67 -> V_213 [ V_188 ] . V_173 ;
* V_214 = V_58 -> V_67 -> V_213 [ V_188 ] . V_171 ;
return 0 ;
}
static int F_121 ( struct V_80 * V_81 , unsigned V_188 ,
unsigned V_187 )
{
struct V_57 * V_58 = F_27 ( V_81 ) ;
...
int V_144 = - V_84 ;
int V_60 ;
V_216 = & V_58 -> V_67 -> V_173 [ V_187 ] ;
if ( V_216 -> V_217 < 0 )
return - V_84 ;
F_17 ( V_58 -> V_53 , L_43 , V_216 -> V_168 , V_216 -> V_176 ) ;
V_34 = ( ( V_216 -> V_217 & V_82 ) == V_82 ) ;
if ( V_34 ) {
F_36 ( & V_104 , V_103 ) ;
memset ( V_15 , 0xff , sizeof( V_15 ) ) ;
for ( V_60 = 0 ; V_60 < V_216 -> V_176 ; V_60 ++ )
V_15 [ V_216 -> V_174 [ V_60 ] / V_83 ] &= ~ F_7 ( V_216 -> V_174 [ V_60 ] ) ;
F_22 ( V_15 ) ;
}
for ( V_60 = 0 ; V_60 < V_216 -> V_176 ; V_60 ++ ) {
struct V_177 * V_179 ;
...
struct V_85 * V_45 ;
unsigned V_5 ;
V_179 = F_101 ( V_81 , V_216 -> V_174 [ V_60 ] ) ;
if ( ! V_179 ) {
F_20 ( V_58 -> V_53 ,
L_44 ,
V_216 -> V_174 [ V_60 ] , V_216 -> V_168 , V_60 ) ;
goto V_218;
}
if ( ! V_179 -> V_182 ) {
F_20 ( V_58 -> V_53 , L_45 ,
...
F_17 ( V_58 -> V_53 , L_46 , V_216 -> V_174 [ V_60 ] , V_216 -> V_217 ) ;
F_23 ( V_2 -> V_79 ) ;
V_5 = V_216 -> V_174 [ V_60 ] % V_83 ;
F_13 ( V_2 , V_5 ) ;
F_12 ( V_2 , V_5 ,
( V_216 -> V_217 & V_82 ) , V_34 ) ;
F_25 ( V_2 -> V_79 ) ;
if ( ( V_216 -> V_217 & V_82 ) == V_82 )
F_19 ( V_58 , V_216 -> V_174 [ V_60 ] ,
V_216 -> V_217 >> V_219 ) ;
}
V_144 = 0 ;
V_218:
...
V_225 = F_132 ( V_207 ) ;
if ( V_225 ) {
int V_226 = F_133 ( V_207 ) ;
int V_227 = F_134 ( V_207 ) ;
int V_228 = F_135 ( V_207 ) ;
V_224 = true ;
if ( V_226 )
V_19 = V_226 - 1 ;
if ( V_227 )
...
static int F_136 ( struct V_229 * V_53 )
{
struct V_57 * V_58 ;
V_58 = F_137 ( V_53 ) ;
if ( ! V_58 )
return - V_84 ;
return F_138 ( V_58 -> V_230 ) ;
}
static int F_139 ( struct V_229 * V_53 )
{
struct V_57 * V_58 ;
V_58 = F_137 ( V_53 ) ;
if ( ! V_58 )
return - V_84 ;
return F_140 ( V_58 -> V_230 ) ;
}
static int F_141 ( struct V_135 * V_231 )
{
const struct V_232 * V_233 ;
struct V_136 * V_137 = V_231 -> V_53 . V_138 ;
struct V_136 * V_234 ;
struct V_57 * V_58 ;
unsigned int V_235 = 0 ;
int V_60 ;
V_58 = F_85 ( & V_231 -> V_53 , sizeof( * V_58 ) , V_147 ) ;
if ( ! V_58 )
return - V_148 ;
V_233 = F_142 ( V_236 , & V_231 -> V_53 ) ;
if ( ! V_233 )
return - V_170 ;
V_235 = ( unsigned int ) V_233 -> V_191 ;
if ( V_235 == V_237 )
F_143 ( & V_58 -> V_67 ) ;
if ( V_235 == V_238 )
F_144 ( & V_58 -> V_67 ) ;
if ( V_235 == V_239 )
F_145 ( & V_58 -> V_67 ) ;
V_234 = F_114 ( V_137 , L_69 , 0 ) ;
if ( V_234 )
V_58 -> V_65 = F_146 ( V_234 , 0 ) ;
if ( ! V_58 -> V_65 ) {
if ( V_235 == V_237 ) {
F_97 ( & V_231 -> V_53 ,
L_70
...
F_20 ( & V_231 -> V_53 , L_72 ) ;
return - V_84 ;
}
}
for ( V_60 = 0 ; V_60 < V_58 -> V_67 -> V_178 ; V_60 ++ ) {
if ( ! V_77 [ V_58 -> V_67 -> V_180 [ V_60 ] . V_145 ] ) {
F_21 ( & V_231 -> V_53 , L_73 , V_60 ) ;
return - V_240 ;
}
V_58 -> V_67 -> V_180 [ V_60 ] . V_182 = & V_77 [ V_58 -> V_67 -> V_180 [ V_60 ] . V_145 ] -> V_45 ;
}
V_241 . V_174 = V_58 -> V_67 -> V_174 ;
V_241 . V_176 = V_58 -> V_67 -> V_176 ;
V_58 -> V_53 = & V_231 -> V_53 ;
V_58 -> V_230 = F_147 ( & V_241 , & V_231 -> V_53 , V_58 ) ;
if ( F_81 ( V_58 -> V_230 ) ) {
F_20 ( & V_231 -> V_53 , L_74 ) ;
return F_82 ( V_58 -> V_230 ) ;
}
for ( V_60 = 0 ; V_60 < V_58 -> V_67 -> V_178 ; V_60 ++ )
F_148 ( V_58 -> V_230 , & V_58 -> V_67 -> V_180 [ V_60 ] ) ;
F_93 ( V_231 , V_58 ) ;
F_97 ( & V_231 -> V_53 , L_75 ) ;
return 0 ;
}
