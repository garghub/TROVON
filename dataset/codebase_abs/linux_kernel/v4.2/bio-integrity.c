...
bool F_15 ( struct V_2 * V_2 )
{
struct V_37 * V_38 = F_16 ( V_2 -> V_39 ) ;
if ( ! F_17 ( V_2 ) )
return false ;
if ( F_9 ( V_2 ) )
return false ;
if ( V_38 == NULL )
return false ;
if ( F_18 ( V_2 ) == V_40 && V_38 -> V_41 != NULL &&
( V_38 -> V_42 & V_43 ) )
return true ;
if ( F_18 ( V_2 ) == V_44 && V_38 -> V_45 != NULL &&
( V_38 -> V_42 & V_46 ) )
return true ;
return false ;
}
...
V_5 -> V_15 -> V_28 ;
V_52 . V_58 = V_2 -> V_39 -> V_59 -> V_58 ;
V_52 . V_48 = V_38 -> V_48 ;
V_52 . V_60 = F_23 ( V_5 ) ;
V_52 . V_57 = V_57 ;
F_24 (bv, bio, bviter) {
void * V_61 = F_25 ( V_55 . V_27 ) ;
...
{
struct V_1 * V_5 =
F_35 ( V_89 , struct V_1 , V_90 ) ;
struct V_2 * V_2 = V_5 -> V_21 ;
struct V_37 * V_38 = F_16 ( V_2 -> V_39 ) ;
int error ;
error = F_22 ( V_2 , V_38 -> V_41 ) ;
V_2 -> V_86 = V_5 -> V_85 ;
F_36 ( V_2 , error ) ;
}
void V_87 ( struct V_2 * V_2 , int error )
{
struct V_1 * V_5 = F_9 ( V_2 ) ;
F_29 ( V_5 -> V_21 != V_2 ) ;
if ( error ) {
...
void F_39 ( struct V_2 * V_2 , unsigned int V_92 )
{
struct V_1 * V_5 = F_9 ( V_2 ) ;
struct V_37 * V_38 = F_16 ( V_2 -> V_39 ) ;
unsigned V_70 = F_21 ( V_38 , V_92 >> 9 ) ;
F_40 ( V_5 -> V_15 , & V_5 -> V_79 , V_70 ) ;
}
void F_41 ( struct V_2 * V_2 , unsigned int V_31 ,
unsigned int V_47 )
{
struct V_1 * V_5 = F_9 ( V_2 ) ;
struct V_37 * V_38 = F_16 ( V_2 -> V_39 ) ;
F_39 ( V_2 , V_31 << 9 ) ;
V_5 -> V_79 . V_80 = F_21 ( V_38 , V_47 ) ;
}
int F_42 ( struct V_2 * V_2 , struct V_2 * V_93 ,
T_1 V_3 )
{
struct V_1 * V_94 = F_9 ( V_93 ) ;
struct V_1 * V_5 ;
F_29 ( V_94 == NULL ) ;
V_5 = F_1 ( V_2 , V_3 , V_94 -> V_33 ) ;
if ( V_5 == NULL )
return - V_78 ;
memcpy ( V_5 -> V_15 , V_94 -> V_15 ,
V_94 -> V_33 * sizeof( struct V_13 ) ) ;
V_5 -> V_33 = V_94 -> V_33 ;
V_5 -> V_79 = V_94 -> V_79 ;
return 0 ;
}
int F_43 ( struct V_6 * V_7 , int V_95 )
{
if ( V_7 -> V_12 )
return 0 ;
V_7 -> V_12 = F_44 ( V_95 , V_20 ) ;
if ( ! V_7 -> V_12 )
return - 1 ;
V_7 -> V_16 = F_45 ( V_95 ) ;
if ( ! V_7 -> V_16 ) {
