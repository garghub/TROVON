...
if ( F_10 ( V_17 ) )
return F_11 ( V_17 ) ;
V_7 = F_12 ( V_11 -> V_22 . V_23 , L_4 , 1 , & V_20 ) ;
if ( V_7 < 0 ) {
F_8 ( & V_11 -> V_22 , L_6 ) ;
return - V_25 ;
}
V_7 = F_12 ( V_11 -> V_22 . V_23 , L_4 , 2 , & V_19 ) ;
if ( V_7 < 0 ) {
F_8 ( & V_11 -> V_22 , L_7 ) ;
return - V_25 ;
}
V_18 = V_26 * sizeof( struct V_1 ) ;
V_13 = F_13 ( & V_11 -> V_22 , sizeof( * V_13 ) + V_18 , V_27 ) ;
if ( ! V_13 )
return - V_28 ;
F_14 ( V_11 , V_13 ) ;
...
V_4 . V_30 = 0 ;
V_4 . V_31 = 31 ;
V_13 -> V_2 [ V_21 ] . V_5 = F_15 ( & V_11 -> V_22 ,
V_17 , V_4 ) ;
}
F_16 ( & V_11 -> V_22 ) ;
V_7 = F_17 ( V_13 , & V_11 -> V_22 , & V_32 ,
0 , V_26 ) ;
if ( V_7 )
F_18 ( & V_11 -> V_22 ) ;
return V_7 ;
