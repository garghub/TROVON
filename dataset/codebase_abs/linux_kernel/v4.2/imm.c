...
int V_110 = - V_111 ;
F_70 ( & V_10 ) ;
V_4 = F_71 ( sizeof( T_1 ) , V_112 ) ;
if ( ! V_4 )
return - V_111 ;
V_4 -> V_5 = - 1 ;
V_4 -> V_18 = V_113 ;
F_72 ( & V_4 -> V_114 ) ;
V_4 -> V_4 = F_73 ( V_106 , L_27 , NULL , F_4 ,
NULL , 0 , V_4 ) ;
if ( ! V_4 -> V_4 )
goto V_115;
V_110 = - V_116 ;
V_4 -> V_10 = & V_10 ;
F_74 ( & V_10 , & V_107 , V_117 ) ;
if ( F_8 ( V_4 ) )
F_75 ( 3 * V_91 ) ;
if ( V_4 -> V_14 ) {
F_14 ( V_118 L_28
...
F_77 ( & V_4 -> V_74 , F_53 ) ;
V_110 = - V_111 ;
V_2 = F_78 ( & V_122 , sizeof( T_1 * ) ) ;
if ( ! V_2 )
goto V_120;
V_2 -> V_123 = V_106 -> V_5 ;
V_2 -> V_124 = V_108 ;
V_2 -> V_125 = - 1 ;
V_2 -> V_126 = V_106 -> V_119 ;
* ( T_1 * * ) & V_2 -> V_3 = V_4 ;
V_4 -> V_2 = V_2 ;
F_79 ( & V_4 -> V_114 , & V_127 ) ;
V_110 = F_80 ( V_2 , NULL ) ;
if ( V_110 )
goto V_128;
F_81 ( V_2 ) ;
...
static void F_86 ( struct V_105 * V_106 )
{
F_67 ( V_106 ) ;
}
...
{
T_1 * V_4 ;
F_88 (dev, &imm_hosts, list) {
if ( V_4 -> V_4 -> V_6 == V_106 ) {
F_82 ( & V_4 -> V_114 ) ;
F_89 ( V_4 -> V_2 ) ;
F_83 ( V_4 -> V_2 ) ;
F_84 ( V_4 -> V_4 ) ;
