...
{
return F_35 ( V_80 -> V_6 + V_35 ) ;
}
static void F_36 ( struct V_79 * V_80 , unsigned V_35 )
{
F_37 ( V_80 -> V_6 + V_35 ) ;
}
static int F_38 ( struct V_79 * V_80 , unsigned V_35 )
{
struct V_1 * V_2 = F_39 ( V_80 -> V_23 ) ;
T_1 V_17 = F_10 ( V_35 ) ;
T_1 V_18 = F_11 ( V_35 ) ;
T_1 V_21 = V_2 -> V_20 [ V_17 ] . V_21 ;
T_1 V_5 ;
...
static void F_41 ( struct V_79 * V_80 , unsigned V_35 ,
int V_5 )
{
struct V_1 * V_2 = F_39 ( V_80 -> V_23 ) ;
T_1 V_17 = F_10 ( V_35 ) ;
...
static int F_42 ( struct V_79 * V_80 , unsigned V_35 )
{
return F_43 ( V_80 -> V_6 + V_35 ) ;
}
static int F_44 ( struct V_79 * V_80 , unsigned V_35 ,
int V_85 )
{
F_41 ( V_80 , V_35 , V_85 ) ;
return F_45 ( V_80 -> V_6 + V_35 ) ;
}
int F_46 ( struct V_86 * V_87 ,
struct V_1 * V_2 )
{
int V_68 ;
struct V_88 * V_89 ;
V_89 = F_47 ( V_87 , V_90 , 0 ) ;
V_2 -> V_6 = F_48 ( & V_87 -> V_23 , V_89 ) ;
if ( F_49 ( V_2 -> V_6 ) )
return F_50 ( V_2 -> V_6 ) ;
V_91 . V_31 = V_2 -> V_31 ;
V_91 . V_39 = V_2 -> V_39 ;
...
F_51 ( V_87 , V_2 ) ;
V_2 -> V_23 = & V_87 -> V_23 ;
V_2 -> V_95 = F_52 ( & V_91 , & V_87 -> V_23 , V_2 ) ;
if ( F_49 ( V_2 -> V_95 ) ) {
F_12 ( & V_87 -> V_23 , L_19 ) ;
...
V_68 = F_54 ( & V_2 -> V_79 , F_55 ( V_2 -> V_23 ) ,
0 , 0 , V_2 -> V_71 * 32 ) ;
if ( V_68 )
goto V_97;
F_56 ( & V_87 -> V_23 , L_21 ) ;
