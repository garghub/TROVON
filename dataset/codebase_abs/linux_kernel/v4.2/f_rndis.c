...
F_30 ( V_17 -> V_28 ) ;
V_17 -> V_28 -> V_67 = V_17 ;
} else if ( V_65 == V_17 -> V_70 ) {
struct V_71 * V_72 ;
if ( V_17 -> V_4 . V_73 -> V_67 ) {
F_15 ( V_22 , L_10 ) ;
F_31 ( & V_17 -> V_4 ) ;
}
if ( ! V_17 -> V_4 . V_73 -> V_68 || ! V_17 -> V_4 . V_74 -> V_68 ) {
F_15 ( V_22 , L_11 ) ;
if ( F_29 ( V_22 -> V_63 , V_3 ,
V_17 -> V_4 . V_73 ) ||
F_29 ( V_22 -> V_63 , V_3 ,
V_17 -> V_4 . V_74 ) ) {
V_17 -> V_4 . V_73 -> V_68 = NULL ;
V_17 -> V_4 . V_74 -> V_68 = NULL ;
goto V_69;
}
}
V_17 -> V_4 . V_75 = false ;
...
V_17 -> V_4 . V_73 -> V_35 , V_17 -> V_4 . V_74 -> V_35 ,
V_17 -> V_28 -> V_35 ) ;
return 0 ;
V_131:
F_57 ( V_3 ) ;
...
void F_60 ( struct V_132 * V_3 , struct V_71 * V_72 )
{
struct V_85 * V_133 ;
V_133 = F_2 ( V_3 , struct V_85 , V_88 ) ;
if ( V_133 -> V_96 )
F_61 ( F_62 ( V_133 -> V_72 ) ) ;
else
F_63 ( V_133 -> V_72 ) ;
...
F_77 ( & V_133 -> V_144 ) ;
V_133 -> V_149 ++ ;
F_81 ( V_133 -> V_72 , V_17 -> V_128 ) ;
V_17 -> V_130 = V_133 -> V_151 ;
V_17 -> V_129 = V_133 -> V_129 ;
V_17 -> V_4 . V_152 = F_62 ( V_133 -> V_72 ) ;
F_78 ( & V_133 -> V_144 ) ;
V_17 -> V_4 . V_76 = 0 ;
