...
V_47 = F_66 ( V_30 -> V_47 , V_52 & V_110 ) ;
F_29 ( & V_47 -> V_50 ) ;
...
static void F_75 ( struct V_62 * V_63 )
{
struct V_6 * V_7 = F_37 ( V_63 ) ;
int V_44 ;
F_29 ( & V_7 -> V_43 ) ;
...
static struct V_6 * F_76 ( struct V_60 * V_61 ,
struct V_29 * V_30 ,
struct V_9 * V_10 )
{
struct V_6 * V_7 ;
...
static enum V_116 F_79 ( struct V_60 * V_61 ,
struct V_29 * V_30 ,
struct V_9 * V_10 )
{
struct V_12 * V_13 = F_7 ( V_10 ) ;
...
if ( V_7 -> V_25 == V_56 )
V_7 -> V_25 = F_78 ( V_13 -> V_24 ) ;
else if ( V_7 -> V_25 != F_78 ( V_13 -> V_24 ) ) {
V_117 = V_121 ;
goto V_122;
}
} else {
...
V_7 = F_74 ( V_30 , V_52 ) ;
if ( ( V_11 & V_73 ) && F_81 ( F_8 ( V_10 ) ) ) {
if ( V_7 ) {
F_5 ( & V_30 -> V_100 . V_126 ) ;
V_117 = V_127 ;
goto V_122;
}
V_7 = F_76 ( V_61 , V_30 , V_10 ) ;
if ( ! V_7 ) {
V_117 = V_128 ;
goto V_67;
}
...
static struct V_62 * F_83 ( struct V_29 * V_30 ,
struct V_9 * V_10 )
{
struct V_12 * V_13 = F_7 ( V_10 ) ;
struct V_6 * V_7 ;
...
V_52 = F_78 ( ( V_11 & V_111 ) ? V_13 -> V_22 : V_13 -> V_24 ) ;
V_7 = F_74 ( V_30 , V_52 ) ;
if ( ! V_7 )
return NULL ;
...
static void F_85 ( struct V_9 * V_10 , enum V_134 V_135 ,
struct V_136 * V_137 )
{
switch ( V_135 ) {
case V_138 :
F_86 ( V_10 , V_137 -> V_139 , V_137 -> V_140 ) ;
break;
case V_141 :
F_87 ( V_10 ) ;
break;
...
break;
default:
F_90 ( F_91 ( V_10 ) , L_6 , V_135 ) ;
}
}
static void F_92 ( struct V_62 * V_63 , struct V_9 * V_10 ,
...
static void F_93 ( struct V_62 * V_63 , const struct V_9 * V_148 )
{
struct V_9 * V_10 ;
struct V_12 * V_149 ;
struct V_12 * V_13 ;
...
static void F_95 ( struct V_9 * V_148 ,
enum V_155 V_139 ,
enum V_156 V_140 )
{
struct V_9 * V_10 ;
...
V_11 &= ~ V_73 ;
F_15 ( V_13 -> V_21 , V_11 ) ;
F_8 ( V_10 ) = F_97 ( F_8 ( V_148 ) ) ;
F_10 ( V_10 ) = V_19 ;
if ( F_11 ( F_8 ( V_10 ) ) )
F_10 ( V_10 ) = V_20 ;
V_61 -> V_70 . V_71 ( V_61 , V_10 ) ;
}
static void F_98 ( struct V_6 * V_7 , struct V_9 * V_148 )
{
struct V_9 * V_10 ;
struct V_162 * V_163 ;
struct V_12 * V_13 ;
...
return;
V_117:
F_95 ( V_148 , V_170 , V_171 ) ;
goto free;
}
static struct V_62 * F_99 ( struct V_60 * V_61 , struct V_9 * V_10 )
{
struct V_106 * V_107 ;
F_16 ( V_61 != F_91 ( V_10 ) ) ;
F_16 ( F_82 ( V_10 ) ) ;
...
F_73 (ema, &lport->ema_list, ema_list)
if ( ( ! V_107 -> V_108 || V_107 -> V_108 ( V_10 ) ) &&
F_79 ( V_61 , V_107 -> V_30 , V_10 ) == V_118 )
break;
return F_82 ( V_10 ) ;
}
...
static void F_101 ( struct V_60 * V_61 , struct V_29 * V_30 ,
struct V_9 * V_10 )
{
struct V_12 * V_13 = F_7 ( V_10 ) ;
struct V_62 * V_63 = NULL ;
struct V_6 * V_7 = NULL ;
enum V_116 V_117 ;
V_61 = F_102 ( V_61 , F_39 ( V_13 -> V_112 ) ) ;
if ( ! V_61 ) {
F_38 ( V_10 ) ;
return;
}
...
static void F_104 ( struct V_29 * V_30 , struct V_9 * V_10 )
{
struct V_12 * V_13 = F_7 ( V_10 ) ;
struct V_62 * V_63 ;
struct V_6 * V_7 ;
...
static void F_106 ( struct V_6 * V_7 , struct V_9 * V_10 )
{
struct V_12 * V_13 ;
struct V_162 * V_163 ;
struct V_62 * V_63 ;
...
if ( ! V_163 )
break;
V_178 = F_78 ( V_163 -> V_168 ) ;
V_179 = F_78 ( V_163 -> V_164 ) ;
if ( ( V_7 -> V_34 & V_45 ) == 0 &&
( V_163 -> V_166 != V_167 ||
...
V_11 = F_39 ( V_13 -> V_21 ) ;
F_82 ( V_10 ) = NULL ;
V_7 = F_74 ( V_30 , ( V_11 & V_111 ) ?
F_78 ( V_13 -> V_22 ) : F_78 ( V_13 -> V_24 ) ) ;
if ( V_7 && ( V_11 & V_74 ) ) {
F_29 ( & V_7 -> V_43 ) ;
V_7 -> V_34 |= V_68 ;
F_30 ( & V_7 -> V_43 ) ;
...
static void F_87 ( struct V_9 * V_148 )
{
struct V_60 * V_61 ;
struct V_182 * V_183 ;
struct V_9 * V_10 ;
...
if ( ! V_10 )
return;
V_183 = F_96 ( V_10 , sizeof( * V_183 ) ) ;
memset ( V_183 , 0 , sizeof( * V_183 ) ) ;
V_183 -> V_184 = V_141 ;
F_109 ( V_10 , V_148 , V_185 , 0 ) ;
V_61 -> V_70 . V_71 ( V_61 , V_10 ) ;
}
static void F_86 ( struct V_9 * V_148 , enum V_186 V_139 ,
enum V_187 V_140 )
{
struct V_60 * V_61 ;
struct V_188 * V_189 ;
...
if ( ! V_44 )
F_34 ( V_7 ) ;
F_57 ( V_7 , V_63 , F_62 ( - V_193 ) ) ;
F_47 ( V_63 , NULL , V_7 -> V_33 ) ;
F_18 ( V_7 ) ;
}
static void F_111 ( struct V_60 * V_61 ,
struct V_46 * V_47 ,
T_1 V_84 , T_1 V_87 )
{
struct V_6 * V_7 ;
...
F_29 ( & V_47 -> V_50 ) ;
V_195:
F_112 (ep, next, &pool->ex_list, ex_list) {
if ( ( V_61 == V_7 -> V_85 ) &&
...
void F_113 ( struct V_60 * V_61 , T_1 V_84 , T_1 V_87 )
{
struct V_106 * V_107 ;
unsigned int V_98 ;
F_73 (ema, &lport->ema_list, ema_list) {
...
static struct V_6 * F_115 ( struct V_60 * V_61 , T_1 V_52 )
{
struct V_106 * V_107 ;
F_73 (ema, &lport->ema_list, ema_list)
...
static void F_89 ( struct V_9 * V_196 )
{
struct V_60 * V_61 ;
struct V_9 * V_10 ;
struct V_6 * V_7 ;
...
T_2 V_23 ;
V_61 = F_91 ( V_196 ) ;
V_158 = F_96 ( V_196 , sizeof( * V_158 ) ) ;
V_140 = V_200 ;
if ( ! V_158 )
goto V_117;
V_84 = F_39 ( V_158 -> V_201 ) ;
V_25 = F_78 ( V_158 -> V_202 ) ;
V_23 = F_78 ( V_158 -> V_203 ) ;
V_7 = F_115 ( V_61 ,
V_84 == F_116 ( V_61 -> V_204 ) ? V_23 : V_25 ) ;
V_140 = V_205 ;
if ( ! V_7 )
goto V_117;
...
V_183 -> V_211 = F_94 ( V_7 -> V_16 . V_212 ) ;
V_183 -> V_213 = F_94 ( V_7 -> V_34 & ( V_115 |
V_68 |
V_35 ) ) ;
F_109 ( V_10 , V_196 , V_185 , 0 ) ;
V_61 -> V_70 . V_71 ( V_61 , V_10 ) ;
V_67:
F_18 ( V_7 ) ;
return;
...
F_18 ( V_7 ) ;
V_117:
F_86 ( V_196 , V_139 , V_140 ) ;
}
static void F_117 ( struct V_62 * V_63 , struct V_9 * V_10 , void * V_33 )
{
...
V_7 -> V_34 |= V_68 ;
V_13 = F_7 ( V_10 ) ;
F_84 ( V_7 , F_39 ( V_13 -> V_113 ) , F_39 ( V_13 -> V_112 ) ) ;
V_7 -> F_48 = F_48 ;
V_7 -> V_32 = V_32 ;
V_7 -> V_33 = V_33 ;
V_7 -> V_97 = V_218 ;
...
V_61 -> V_228 , V_229 ,
V_73 | V_18 | V_74 , 0 ) ;
if ( F_120 ( V_61 , V_10 , F_117 , NULL , V_7 ,
V_61 -> V_230 ) )
return;
V_223:
F_29 ( & V_7 -> V_43 ) ;
...
V_52 = F_116 ( V_61 -> V_204 ) == V_84 ?
F_78 ( V_158 -> V_226 ) : F_78 ( V_158 -> V_227 ) ;
V_7 = F_115 ( V_61 , V_52 ) ;
V_140 = V_205 ;
if ( ! V_7 )
goto V_117;
F_29 ( & V_7 -> V_43 ) ;
if ( V_7 -> V_23 != F_78 ( V_158 -> V_226 ) )
goto V_231;
if ( V_7 -> V_25 != F_78 ( V_158 -> V_227 ) &&
V_7 -> V_25 != V_56 )
goto V_231;
V_140 = V_232 ;
if ( V_7 -> V_84 != V_84 )
...
V_107 -> V_30 = V_30 ;
V_107 -> V_108 = V_108 ;
F_69 ( & V_107 -> V_242 , & V_61 -> V_242 ) ;
F_129 ( & V_30 -> V_243 ) ;
return V_107 ;
}
static void F_130 ( struct V_243 * V_243 )
{
struct V_29 * V_30 = F_60 ( V_243 , struct V_29 , V_243 ) ;
F_131 ( V_30 -> V_36 ) ;
F_132 ( V_30 -> V_47 ) ;
F_133 ( V_30 ) ;
}
...
return 0 ;
V_104:
F_112 (ema, tmp, &dst->ema_list, ema_list)
F_134 ( V_107 ) ;
return - V_83 ;
}
...
F_145 ( V_42 ) ;
F_112 (ema, next, &lport->ema_list, ema_list)
F_134 ( V_107 ) ;
}
...
case V_20 :
if ( V_13 -> V_65 == V_72 )
F_108 ( V_107 -> V_30 , V_10 ) ;
else if ( ( V_11 & ( V_111 | V_119 ) ) ==
V_111 )
F_104 ( V_107 -> V_30 , V_10 ) ;
else if ( V_11 & V_119 )
F_105 ( V_107 -> V_30 , V_10 ) ;
else
F_101 ( V_61 , V_107 -> V_30 , V_10 ) ;
break;
default:
F_90 ( V_61 , L_20 ,
F_10 ( V_10 ) ) ;
...
if ( ! V_61 -> V_70 . V_260 )
V_61 -> V_70 . V_260 = F_85 ;
if ( ! V_61 -> V_70 . V_261 )
V_61 -> V_70 . V_261 = F_75 ;
if ( ! V_61 -> V_70 . V_262 )
V_61 -> V_70 . V_262 = F_113 ;
if ( ! V_61 -> V_70 . V_263 )
V_61 -> V_70 . V_263 = F_56 ;
if ( ! V_61 -> V_70 . V_264 )
V_61 -> V_70 . V_264 = F_99 ;
if ( ! V_61 -> V_70 . V_265 )
V_61 -> V_70 . V_265 = F_100 ;
return 0 ;
}
int F_153 ( void )
{
