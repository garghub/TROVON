...
static unsigned int
F_72 ( const struct V_106 * V_107 ,
struct V_38 * V_39 ,
const struct V_108 * V_109 )
{
struct V_110 * V_111 = F_73 ( V_39 ) ;
struct V_98 * V_99 ;
struct V_1 * V_2 ;
struct V_7 * V_7 = F_10 ( V_109 -> V_112 ? V_109 -> V_112 : V_109 -> V_113 ) ;
if ( V_111 -> V_114 != F_74 ( V_115 ) ||
V_111 -> V_116 != F_74 ( V_117 ) ||
V_111 -> V_118 != 4 || V_111 -> V_119 != V_27 )
return V_120 ;
if ( V_111 -> V_121 != F_74 ( V_122 ) &&
V_111 -> V_121 != F_74 ( V_123 ) )
return V_120 ;
V_99 = ( void * ) ( V_111 + 1 ) ;
V_2 = F_23 ( V_7 , V_99 -> V_104 , 0 ) ;
if ( ! V_2 )
return V_120 ;
if ( V_2 -> V_8 != V_109 -> V_113 ) {
F_59 ( L_16
L_17 ,
V_2 -> V_8 -> V_124 , V_109 -> V_113 -> V_124 ) ;
F_6 ( V_2 ) ;
return V_120 ;
}
memcpy ( V_99 -> V_103 , V_2 -> V_15 , V_111 -> V_119 ) ;
#ifdef F_57
F_59 ( L_18 ) ;
F_68 ( V_99 ) ;
#endif
...
static void * F_75 ( struct V_125 * V_126 , T_5 * V_127 )
{
struct V_1 * V_2 = V_126 -> V_128 ;
unsigned int V_129 ;
T_3 V_23 ;
struct V_130 * V_131 ;
V_23 = V_2 -> V_23 ;
...
if ( * V_127 >= V_129 )
return NULL ;
V_131 = F_77 ( sizeof( struct V_130 ) , V_132 ) ;
if ( ! V_131 )
return F_78 ( - V_93 ) ;
V_131 -> V_127 = * V_127 ;
V_131 -> V_129 = V_129 ;
V_131 -> V_133 = F_79 ( V_23 ) ;
V_131 -> V_134 = V_23 ;
F_80 ( V_131 -> V_133 - 1 , & V_131 -> V_134 ) ;
return V_131 ;
}
static void * F_81 ( struct V_125 * V_126 , void * V_135 , T_5 * V_127 )
{
struct V_130 * V_131 = V_135 ;
* V_127 = ++ V_131 -> V_127 ;
if ( * V_127 >= V_131 -> V_129 ) {
F_4 ( V_135 ) ;
return NULL ;
}
V_131 -> V_133 = F_79 ( V_131 -> V_134 ) ;
F_80 ( V_131 -> V_133 - 1 , & V_131 -> V_134 ) ;
return V_131 ;
}
static void F_82 ( struct V_125 * V_126 , void * V_135 )
{
if ( ! F_83 ( V_135 ) )
F_4 ( V_135 ) ;
}
static int F_84 ( struct V_125 * V_126 , void * V_135 )
{
struct V_130 * V_131 = V_135 ;
if ( V_131 -> V_127 != 0 )
F_85 ( V_126 , ',' ) ;
F_86 ( V_126 , L_19 , V_131 -> V_133 ) ;
if ( V_131 -> V_127 == V_131 -> V_129 - 1 )
F_85 ( V_126 , '\n' ) ;
return 0 ;
}
static int F_87 ( struct V_136 * V_136 , struct V_137 * V_137 )
{
int V_82 = F_88 ( V_137 , & V_138 ) ;
if ( ! V_82 ) {
struct V_125 * V_139 = V_137 -> V_140 ;
struct V_1 * V_2 = F_89 ( V_136 ) ;
V_139 -> V_128 = V_2 ;
F_1 ( V_2 ) ;
}
return V_82 ;
}
static int F_90 ( struct V_136 * V_136 , struct V_137 * V_137 )
{
struct V_1 * V_2 = F_89 ( V_136 ) ;
int V_82 ;
V_82 = F_91 ( V_136 , V_137 ) ;
if ( ! V_82 )
F_6 ( V_2 ) ;
return V_82 ;
}
static T_6 F_92 ( struct V_137 * V_137 , const char T_7 * V_141 ,
T_8 V_142 , T_5 * V_143 )
{
struct V_1 * V_2 = F_89 ( F_93 ( V_137 ) ) ;
#define F_94 10
char V_31 [ F_94 + 1 ] ;
unsigned long V_37 ;
int V_144 ;
if ( V_142 > F_94 )
return - V_145 ;
if ( F_95 ( V_31 , V_141 , V_142 ) )
return - V_146 ;
V_31 [ V_142 ] = 0 ;
if ( * V_31 == '+' ) {
V_144 = F_96 ( V_31 + 1 , 10 , & V_37 ) ;
if ( V_144 )
return V_144 ;
if ( F_37 ( V_2 , V_37 ) )
return - V_93 ;
...
F_99 ( & V_10 -> V_13 ) ;
#ifdef F_19
V_10 -> V_34 = F_100 ( L_20 , V_7 -> V_147 ) ;
if ( ! V_10 -> V_34 ) {
F_61 ( L_21 ) ;
return - V_93 ;
}
