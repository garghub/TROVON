...
void
F_126 ( char * V_275 , int * V_45 , int * V_184 , int * V_46 , int * V_279 )
{
char * V_267 = V_275 ;
...
V_307 , V_5 -> V_103 , V_5 -> V_70 / 16 , F_111 ( V_5 ) ) ;
}
static void
...
if ( V_275 ) {
F_126 ( V_275 , & V_45 , & V_184 , & V_46 , & V_279 ) ;
