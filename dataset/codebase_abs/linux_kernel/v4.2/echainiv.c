...
if ( V_8 -> V_6 != V_8 -> V_1 )
F_24 ( V_8 -> V_16 , V_8 -> V_1 ,
V_8 -> V_30 , V_13 , 1 ) ;
return F_28 ( V_10 ) ;
}
static int F_29 ( struct V_38 * V_29 )
{
struct V_11 * V_12 = F_30 ( V_29 ) ;
struct V_20 * V_21 = F_13 ( V_12 ) ;
int V_9 ;
F_31 ( & V_21 -> V_12 . V_39 ) ;
F_32 ( V_12 , sizeof( struct V_7 ) ) ;
V_9 = F_33 () ;
if ( V_9 )
goto V_15;
V_9 = F_34 ( V_40 , V_21 -> V_36 ,
F_8 ( V_12 ) ) ;
F_35 () ;
if ( V_9 )
goto V_15;
...
static void F_41 ( struct V_38 * V_29 )
{
struct V_20 * V_21 = F_42 ( V_29 ) ;
F_43 ( V_21 -> V_12 . V_26 ) ;
F_40 () ;
}
...
struct V_50 * V_51 ;
int V_9 ;
V_47 = F_45 ( V_43 , V_45 , 0 , 0 ) ;
if ( F_38 ( V_47 ) )
return F_37 ( V_47 ) ;
V_49 = F_46 ( V_47 ) ;
V_51 = F_47 ( V_49 ) ;
if ( V_51 -> V_18 . V_52 . V_53 )
goto V_54;
V_9 = - V_25 ;
if ( V_47 -> V_51 . V_13 & ( sizeof( T_2 ) - 1 ) ||
V_47 -> V_51 . V_13 > V_55 )
goto V_56;
V_47 -> V_51 . V_53 = F_12 ;
V_47 -> V_51 . V_57 = F_26 ;
V_47 -> V_51 . V_18 . V_58 = F_29 ;
V_47 -> V_51 . V_18 . V_59 = F_41 ;
V_47 -> V_51 . V_18 . V_60 |= F_48 ( T_2 ) - 1 ;
V_47 -> V_51 . V_18 . V_61 = sizeof( struct V_20 ) ;
V_47 -> V_51 . V_18 . V_61 += V_47 -> V_51 . V_13 ;
V_54:
V_9 = F_49 ( V_43 , V_47 ) ;
if ( V_9 )
goto V_56;
...
static void F_51 ( struct V_62 * V_47 )
{
F_50 ( V_46 ( V_47 ) ) ;
}
