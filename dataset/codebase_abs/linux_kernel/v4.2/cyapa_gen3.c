...
if ( ( V_5 & V_125 ) == V_118 )
return 0 ;
V_121 = F_37 ( V_5 & V_125 ) ;
V_120 = V_5 ;
V_120 &= ~ V_125 ;
V_120 |= V_118 & V_125 ;
V_78 = V_122 ;
while ( V_78 -- ) {
V_5 = F_7 ( V_1 , V_123 , V_120 ) ;
if ( ! V_5 )
break;
F_18 ( V_124 , 2 * V_124 ) ;
}
...
if ( V_1 -> V_25 != V_46 )
return - V_128 ;
V_5 = F_13 ( V_1 , V_129 , V_126 ) ;
if ( V_5 != V_127 )
return ( V_5 < 0 ) ? V_5 : - V_51 ;
memcpy ( & V_1 -> V_130 [ 0 ] , & V_126 [ 0 ] , 5 ) ;
V_1 -> V_130 [ 5 ] = '-' ;
memcpy ( & V_1 -> V_130 [ 6 ] , & V_126 [ 5 ] , 6 ) ;
V_1 -> V_130 [ 12 ] = '-' ;
memcpy ( & V_1 -> V_130 [ 13 ] , & V_126 [ 11 ] , 2 ) ;
V_1 -> V_130 [ 15 ] = '\0' ;
V_1 -> V_131 = V_126 [ 15 ] ;
V_1 -> V_132 = V_126 [ 16 ] ;
V_1 -> V_133 = V_126 [ 19 ] & V_134 ;
V_1 -> V_34 = V_126 [ 20 ] & 0x0f ;
V_1 -> V_135 = ( ( V_126 [ 21 ] & 0xf0 ) << 4 ) | V_126 [ 22 ] ;
V_1 -> V_136 = ( ( V_126 [ 21 ] & 0x0f ) << 8 ) | V_126 [ 23 ] ;
V_1 -> V_137 =
( ( V_126 [ 24 ] & 0xf0 ) << 4 ) | V_126 [ 25 ] ;
V_1 -> V_138 =
( ( V_126 [ 24 ] & 0x0f ) << 8 ) | V_126 [ 26 ] ;
V_1 -> V_139 = 255 ;
return 0 ;
}
...
T_2 V_140 [ V_71 ] ;
int V_5 ;
V_5 = F_9 ( V_1 , 0 , V_71 , V_140 ) ;
if ( V_5 != V_71 )
return ( V_5 < 0 ) ? V_5 : - V_51 ;
if ( V_140 [ V_31 ] ==
( V_32 | V_33 ) ) {
V_1 -> V_131 = V_140 [ V_141 ] ;
V_1 -> V_132 = V_140 [ V_142 ] ;
}
return 0 ;
}
...
int V_5 ;
int V_59 ;
V_5 = F_13 ( V_1 , V_148 , ( T_2 * ) & V_68 ) ;
if ( V_5 != sizeof( V_68 ) ) {
F_25 ( V_64 , L_24 , V_5 ) ;
return - V_12 ;
}
if ( ( V_68 . V_149 & V_42 ) != V_42 ||
( V_68 . V_149 & V_150 ) != V_106 ||
( V_68 . V_151 & V_44 ) != V_44 ) {
F_25 ( V_64 , L_25 ,
V_68 . V_149 , V_68 . V_151 ) ;
return - V_12 ;
}
V_147 = ( V_68 . V_151 >> 4 ) & 0x0f ;
for ( V_59 = 0 ; V_59 < V_147 ; V_59 ++ ) {
const struct V_152 * V_153 = & V_68 . V_154 [ V_59 ] ;
int V_155 = V_153 -> V_156 - 1 ;
F_45 ( V_145 , V_155 ) ;
F_46 ( V_145 , V_157 , true ) ;
F_47 ( V_145 , V_158 ,
( ( V_153 -> V_159 & 0xf0 ) << 4 ) | V_153 -> V_160 ) ;
F_47 ( V_145 , V_161 ,
( ( V_153 -> V_159 & 0x0f ) << 8 ) | V_153 -> V_162 ) ;
F_47 ( V_145 , V_163 , V_153 -> V_164 ) ;
}
F_48 ( V_145 ) ;
if ( V_1 -> V_133 & V_165 )
F_49 ( V_145 , V_166 ,
