...
static int F_28 ( struct V_3 * V_27 , void * V_21 )
{
struct V_2 * V_3 = F_29 ( V_27 ) ;
struct V_24 * V_24 = V_3 -> V_25 ;
int * V_18 = V_21 ;
if ( V_24 -> type == V_9 )
( * V_18 ) ++ ;
...
static int F_30 ( struct V_3 * V_27 , void * V_21 )
{
struct V_2 * V_3 = F_29 ( V_27 ) ;
struct V_24 * V_24 = V_3 -> V_25 ;
bool V_11 = V_21 ;
...
V_24 = F_39 ( & V_3 -> V_27 , sizeof( * V_24 ) , V_50 ) ;
if ( ! V_24 )
return - V_30 ;
V_24 -> type = type ;
V_3 -> V_25 = V_24 ;
...
static void F_41 ( struct V_2 * V_3 , T_2 V_51 )
{
struct V_24 * V_24 = V_3 -> V_25 ;
if ( V_51 != 0x80 ) {
F_37 ( & V_3 -> V_27 , L_9 ,
