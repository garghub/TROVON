...
F_43 ( & V_14 -> V_71 , F_21 ) ;
V_14 -> V_79 . V_141 = F_23 ;
if ( V_14 -> V_23 -> V_120 ) {
struct V_118 * V_142 ;
V_142 = F_44 ( V_14 -> V_23 -> V_120 -> V_101 ,
NULL , L_21 ) ;
if ( V_142 )
V_14 -> V_143 = F_45 (
V_14 -> V_23 , V_142 , & V_14 -> V_79 ) ;
}
...
return 0 ;
V_145:
F_46 ( V_14 -> V_131 , V_14 ) ;
V_140:
F_46 ( V_14 -> V_130 , V_14 ) ;
V_139:
F_47 ( V_14 -> V_54 ) ;
V_136:
F_47 ( V_14 -> V_53 ) ;
...
static int T_5 F_49 ( struct V_126 * V_127 )
{
struct V_13 * V_14 = F_50 ( V_127 ) ;
F_15 ( false ) ;
F_10 ( V_14 , false ) ;
F_16 ( 0 , 0 ) ;
F_3 ( V_58 , 0xff ,
