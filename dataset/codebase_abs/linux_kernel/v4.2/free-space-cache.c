...
struct V_266 * V_267 ;
F_17 ( & V_28 -> V_32 ) ;
F_224 ( V_28 -> V_22 -> V_268 ) ;
V_265 = & V_28 -> V_22 -> V_269 . V_270 ;
F_225 ( & V_265 -> V_32 ) ;
V_267 = F_226 ( V_265 , V_28 -> V_8 . V_17 ,
1 ) ;
F_227 ( ! V_267 ) ;
F_228 ( V_265 , V_267 ) ;
F_229 ( & V_265 -> V_32 ) ;
F_230 ( V_28 -> V_22 -> V_268 ) ;
F_231 ( V_267 ) ;
F_231 ( V_267 ) ;
F_112 ( V_28 -> V_115 ) ;
} else {
...
T_1 F_232 ( struct V_2 * V_271 )
{
struct V_94 * V_95 = V_271 -> V_272 ;
struct V_92 * V_89 = NULL ;
T_1 V_38 = 0 ;
F_15 ( & V_95 -> V_100 ) ;
if ( F_233 ( & V_95 -> V_101 ) )
...
int F_237 ( struct V_114 * V_22 , struct V_2 * V_3 )
{
struct V_94 * V_95 = V_3 -> V_272 ;
struct V_4 * V_5 ;
struct V_1 * V_1 ;
int V_16 = 0 ;
T_1 V_275 = F_238 ( & V_3 -> V_276 ) ;
if ( ! F_211 ( V_3 , V_277 ) )
return 0 ;
if ( F_235 ( V_22 ) )
return 0 ;
...
int F_241 ( struct V_27 * V_281 ,
T_1 V_6 , T_1 V_86 , bool V_87 )
{
struct V_94 * V_95 = V_281 -> V_115 ;
...
V_284 = V_6 ;
V_285 = V_95 -> V_163 ;
V_16 = F_166 ( V_95 , V_169 , & V_284 , & V_285 ) ;
if ( ! V_16 ) {
if ( V_284 == V_6 ) {
V_16 = 1 ;
goto V_108;
