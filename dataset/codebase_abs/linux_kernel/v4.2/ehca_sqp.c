...
const struct V_30 * V_31 , const struct V_32 * V_33 ,
const struct V_34 * V_35 , struct V_34 * V_36 )
{
const struct V_37 * V_38 = ( const struct V_37 * ) V_35 ;
...
const struct V_30 * V_31 , const struct V_32 * V_33 ,
const struct V_83 * V_84 , T_4 V_85 ,
struct V_83 * V_86 , T_4 * V_87 ,
T_5 * V_88 )
{
int V_8 ;
const struct V_34 * V_35 = ( const struct V_34 * ) V_84 ;
struct V_34 * V_36 = (struct V_34 * ) V_86 ;
if ( F_12 ( V_85 != sizeof( * V_35 ) ||
* V_87 != sizeof( * V_36 ) ) )
return V_78 ;
if ( ! V_10 || V_10 > V_29 -> V_89 || ! V_31 )
return V_78 ;
if ( V_35 -> V_46 . V_90 != V_91 )
return V_80 ;
F_4 ( V_29 , L_9 , V_10 , V_31 -> V_92 ) ;
