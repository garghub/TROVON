...
V_175 = V_118 ;
F_104 (pos, evsel) {
struct V_3 * V_181 = F_105 ( V_180 ) ;
if ( V_5 . V_177 ) {
V_170 += V_181 -> V_65 . V_178 ;
V_67 += V_181 -> V_65 . V_179 ;
} else {
V_170 += V_181 -> V_65 . V_67 [ V_171 ] ;
V_67 += V_181 -> V_65 . V_172 ;
}
}
}
...
L_24 ,
( V_165 -> V_184 ? F_107 ( V_165 ) : L_15 ) ,
V_165 -> V_185 ) ;
if ( V_167 )
V_88 += F_70 ( V_100 + V_88 , V_119 - V_88 ,
L_25 , V_167 -> V_186 ) ;
if ( ! F_100 ( V_59 ) ) {
struct V_187 * V_71 = V_59 -> V_64 ;
if ( V_71 -> V_188 )
V_88 += F_70 ( V_100 + V_88 , V_119 - V_88 , L_26 ) ;
}
return V_88 ;
}
static inline void F_108 ( char * * V_189 , int V_37 )
{
int V_190 ;
for ( V_190 = 0 ; V_190 < V_37 ; ++ V_190 )
F_109 ( & V_189 [ V_190 ] ) ;
}
static int F_110 ( void )
{
char * V_191 , * V_189 [ 32 ] , * V_192 [ 32 ] , * V_193 ;
T_10 * V_194 ;
int V_195 = 0 , V_196 = - 1 , V_115 = - 1 ;
struct V_197 * V_198 ;
V_191 = getenv ( L_27 ) ;
if ( ! V_191 )
return V_115 ;
...
memset ( V_189 , 0 , sizeof( V_192 ) ) ;
while ( ( V_198 = F_112 ( V_194 ) ) ) {
char V_199 [ V_200 ] ;
T_3 V_201 ;
char * V_202 = V_198 -> V_203 ;
T_9 * V_204 ;
if ( ! ( V_198 -> V_205 == V_206 ) )
continue;
snprintf ( V_199 , sizeof( V_199 ) , L_28 , V_191 , V_202 ) ;
V_204 = fopen ( V_199 , L_29 ) ;
if ( ! V_204 )
continue;
if ( fread ( & V_201 , 1 , 8 , V_204 ) < 8 )
goto V_207;
if ( F_113 ( V_201 ) ) {
V_189 [ V_195 ] = F_114 ( V_202 ) ;
if ( ! V_189 [ V_195 ] )
goto V_207;
V_192 [ V_195 ] = F_114 ( V_199 ) ;
if ( ! V_192 [ V_195 ] ) {
F_109 ( & V_189 [ V_195 ] ) ;
F_115 ( L_30 ) ;
fclose ( V_204 ) ;
...
F_116 ( V_194 ) ;
if ( V_195 ) {
V_196 = F_117 ( V_195 , V_189 ) ;
if ( V_196 < V_195 && V_196 >= 0 ) {
V_193 = F_114 ( V_192 [ V_196 ] ) ;
if ( V_193 ) {
if ( V_208 )
free ( ( void * ) V_209 ) ;
V_209 = V_193 ;
...
static int
F_118 ( struct V_1 * V_7 , struct V_210 * V_211 )
{
struct V_173 * V_174 ;
struct V_212 * V_213 ;
struct V_12 * V_13 ;
int V_157 ;
if ( ! V_214 && F_119 ( V_7 -> V_160 ) )
return 0 ;
V_213 = F_55 ( V_211 -> V_53 . V_81 ) ;
if ( ! V_213 -> V_82 )
return 0 ;
V_174 = F_79 ( V_7 -> V_3 ) ;
V_157 = F_120 ( & V_211 -> V_53 , V_174 , V_7 -> V_59 ) ;
V_13 = F_98 ( V_7 ) ;
if ( ( V_157 == 'q' || V_157 == F_121 ( 'c' ) ) && V_13 -> V_215 )
return 1 ;
...
struct V_210 * V_211 , char * * V_216 ,
struct V_217 * V_217 , struct V_218 * V_81 )
{
if ( V_81 == NULL || V_217 -> V_167 -> V_219 )
return 0 ;
if ( F_67 ( V_216 , L_34 , V_81 -> V_202 ) < 0 )
return 0 ;
V_211 -> V_53 . V_217 = V_217 ;
V_211 -> V_53 . V_81 = V_81 ;
V_211 -> V_220 = F_118 ;
return 1 ;
}
static int
F_124 ( struct V_1 * V_7 , struct V_210 * V_211 )
{
struct V_165 * V_165 = V_211 -> V_165 ;
if ( V_7 -> V_3 -> V_169 ) {
F_125 ( V_7 -> V_221 , & V_7 -> V_3 -> V_169 ) ;
F_126 ( V_222 , false ) ;
F_127 ( V_7 -> V_3 -> V_169 ) ;
F_51 () ;
} else {
...
static int
F_131 ( struct V_1 * V_7 , struct V_210 * V_211 ,
char * * V_216 , struct V_165 * V_165 )
{
if ( V_165 == NULL )
return 0 ;
if ( F_67 ( V_216 , L_36 ,
V_7 -> V_3 -> V_169 ? L_37 : L_38 ,
V_165 -> V_184 ? F_107 ( V_165 ) : L_15 ,
V_165 -> V_185 ) < 0 )
return 0 ;
V_211 -> V_165 = V_165 ;
...
static int
F_132 ( struct V_1 * V_7 , struct V_210 * V_211 )
{
struct V_167 * V_167 = V_211 -> V_167 ;
if ( V_7 -> V_3 -> V_168 ) {
F_125 ( V_7 -> V_221 , & V_7 -> V_3 -> V_168 ) ;
F_126 ( V_223 , false ) ;
V_7 -> V_3 -> V_168 = NULL ;
F_51 () ;
} else {
...
return 0 ;
F_52 ( L_39 ,
V_167 -> V_224 ? L_40 : V_167 -> V_186 ) ;
V_7 -> V_3 -> V_168 = V_167 ;
F_126 ( V_223 , true ) ;
F_129 ( V_7 -> V_221 , & V_7 -> V_3 -> V_168 ) ;
}
F_133 ( V_7 -> V_3 ) ;
F_16 ( V_7 ) ;
return 0 ;
...
static int
F_134 ( struct V_1 * V_7 , struct V_210 * V_211 ,
char * * V_216 , struct V_167 * V_167 )
{
if ( V_167 == NULL )
return 0 ;
if ( F_67 ( V_216 , L_41 ,
V_7 -> V_3 -> V_168 ? L_37 : L_38 ,
V_167 -> V_224 ? L_40 : V_167 -> V_186 ) < 0 )
return 0 ;
V_211 -> V_167 = V_167 ;
V_211 -> V_220 = F_132 ;
return 1 ;
...
struct V_210 * V_211 )
{
F_136 ( V_211 -> V_53 . V_217 ) ;
return 0 ;
}
static int
F_137 ( struct V_1 * V_7 V_87 ,
struct V_210 * V_211 , char * * V_216 , struct V_217 * V_217 )
{
if ( V_217 == NULL )
return 0 ;
if ( F_67 ( V_216 , L_42 ) < 0 )
return 0 ;
V_211 -> V_53 . V_217 = V_217 ;
V_211 -> V_220 = F_135 ;
return 1 ;
...
if ( V_211 -> V_165 ) {
F_70 ( V_225 , sizeof( V_225 ) , L_43 ,
F_107 ( V_211 -> V_165 ) ) ;
} else if ( V_211 -> V_53 . V_81 ) {
F_70 ( V_225 , sizeof( V_225 ) , L_44 ,
V_211 -> V_53 . V_81 -> V_202 ) ;
}
F_139 ( V_225 ) ;
return 0 ;
}
...
struct V_210 * V_211 , char * * V_216 ,
struct V_165 * V_165 , struct V_218 * V_81 )
{
if ( V_165 ) {
if ( F_67 ( V_216 , L_45 ,
F_107 ( V_165 ) ) < 0 )
...
if ( V_7 -> V_51 != NULL ) {
V_165 = F_99 ( V_7 ) ;
V_167 = V_7 -> V_54 -> V_217 ? V_7 -> V_54 -> V_217 -> V_167 : NULL ;
}
switch ( V_56 ) {
case V_234 :
case V_235 :
...
if ( V_7 -> V_54 == NULL ||
V_7 -> V_54 -> V_81 == NULL ||
V_7 -> V_54 -> V_217 -> V_167 -> V_219 )
continue;
V_230 -> V_53 . V_217 = V_7 -> V_54 -> V_217 ;
V_230 -> V_53 . V_81 = V_7 -> V_54 -> V_81 ;
F_118 ( V_7 , V_230 ) ;
continue;
case 'P' :
F_92 ( V_7 ) ;
...
if ( F_100 ( V_59 ) ) {
V_230 -> V_165 = NULL ;
V_230 -> V_53 . V_81 = NULL ;
F_138 ( V_7 , V_230 ) ;
}
continue;
case 's' :
if ( F_100 ( V_59 ) ) {
V_56 = F_141 ( V_7 , V_230 ) ;
if ( V_56 == V_226 )
goto V_236;
}
continue;
...
V_229 -> V_250 . V_217 ,
V_229 -> V_250 . V_81 ) ;
if ( V_229 -> V_251 . V_81 != V_229 -> V_250 . V_81 )
V_195 += F_123 ( V_7 ,
& V_230 [ V_195 ] ,
& V_189 [ V_195 ] ,
V_229 -> V_251 . V_217 ,
...
V_247:
V_195 += F_131 ( V_7 , & V_230 [ V_195 ] ,
& V_189 [ V_195 ] , V_165 ) ;
V_195 += F_134 ( V_7 , & V_230 [ V_195 ] ,
& V_189 [ V_195 ] , V_167 ) ;
V_195 += F_137 ( V_7 , & V_230 [ V_195 ] ,
& V_189 [ V_195 ] ,
V_7 -> V_54 -> V_217 ) ;
if ( V_7 -> V_51 ) {
V_195 += F_140 ( V_7 ,
...
V_195 += F_140 ( V_7 , & V_230 [ V_195 ] ,
& V_189 [ V_195 ] , NULL , NULL ) ;
V_195 += F_142 ( V_7 , & V_230 [ V_195 ] ,
& V_189 [ V_195 ] ) ;
V_246:
V_195 += F_144 ( V_7 , & V_230 [ V_195 ] ,
& V_189 [ V_195 ] ) ;
do {
struct V_210 * V_211 ;
V_196 = F_117 ( V_195 , V_189 ) ;
if ( V_196 == - 1 || V_196 >= V_195 )
break;
V_211 = & V_230 [ V_196 ] ;
V_56 = V_211 -> V_220 ( V_7 , V_211 ) ;
} while ( V_56 == 1 );
if ( V_56 == V_226 )
break;
}
...
F_104 (pos, evsel) {
struct V_3 * V_181 = F_105 ( V_180 ) ;
V_67 += V_181 -> V_65 . V_67 [ V_171 ] ;
}
}
V_67 = F_106 ( V_67 , & V_166 ) ;
V_88 = F_70 ( V_100 , sizeof( V_100 ) , L_70 , V_67 ,
...
F_57 ( V_7 , V_256 ) ;
V_67 = F_106 ( V_67 , & V_166 ) ;
V_88 += F_70 ( V_100 , sizeof( V_100 ) , L_71 ,
V_67 , V_166 , V_166 == ' ' ? L_15 : L_7 ) ;
V_254 = V_100 ;
}
F_58 ( V_254 , V_7 -> V_28 - V_88 ) ;
if ( V_117 )
V_253 -> V_54 = V_174 ;
}
static int F_165 ( struct V_252 * V_253 ,
int V_67 , const char * V_55 ,
struct V_58 * V_59 )
{
struct V_257 * V_244 = V_253 -> V_20 . V_258 ;
struct V_173 * V_180 ;
const char * V_57 = L_72 ;
int V_60 = V_59 ? V_59 -> V_61 : 0 ;
int V_56 ;
if ( F_47 ( & V_253 -> V_20 , V_57 ,
L_73 ) < 0 )
return - 1 ;
while ( 1 ) {
V_56 = F_48 ( & V_253 -> V_20 , V_60 ) ;
switch ( V_56 ) {
case V_62 :
V_59 -> V_63 ( V_59 -> V_64 ) ;
if ( ! V_253 -> V_259 && V_253 -> V_255 ) {
F_43 ( & V_253 -> V_20 ) ;
V_253 -> V_259 = true ;
}
continue;
...
if ( V_59 )
V_59 -> V_63 ( V_59 -> V_64 ) ;
V_56 = F_145 ( V_180 , V_67 , V_55 ,
true , V_59 ,
V_253 -> V_4 ,
V_253 -> V_160 ) ;
F_50 ( & V_253 -> V_20 , V_57 ) ;
switch ( V_56 ) {
case V_234 :
if ( V_180 -> V_36 . V_44 == & V_244 -> V_11 )
V_180 = F_167 ( V_244 ) ;
else
V_180 = F_168 ( V_180 ) ;
goto V_260;
case V_235 :
if ( V_180 -> V_36 . V_47 == & V_244 -> V_11 )
V_180 = F_169 ( V_244 ) ;
else
V_180 = F_170 ( V_180 ) ;
goto V_260;
...
{
struct V_173 * V_174 = F_32 ( V_133 , struct V_173 , V_36 ) ;
if ( V_5 . V_261 && ! F_172 ( V_174 ) )
return true ;
return false ;
}
static int F_173 ( struct V_257 * V_244 ,
...
F_151 ( L_74 ) ;
F_174 (evlist, pos) {
const char * V_175 = F_101 ( V_180 ) ;
T_8 V_266 = strlen ( V_175 ) + 7 ;
if ( V_253 . V_20 . V_28 < V_266 )
V_253 . V_20 . V_28 = V_266 ;
}
return F_165 ( & V_253 , V_16 , V_55 , V_59 ) ;
}
int F_175 ( struct V_257 * V_244 , const char * V_55 ,
struct V_58 * V_59 ,
float V_4 ,
struct V_159 * V_160 )
{
