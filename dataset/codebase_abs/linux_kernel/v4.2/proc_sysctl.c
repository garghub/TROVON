...
type = V_69 -> V_82 >> 12 ;
F_83 ( V_4 ) ;
return F_85 ( V_119 , V_121 . V_22 , V_121 . V_98 , V_122 , type ) ;
}
static bool F_86 ( struct V_103 * V_103 ,
struct V_118 * V_119 ,
struct V_1 * V_2 ,
struct V_3 * V_40 )
{
...
static int F_87 ( struct V_1 * V_2 , struct V_3 * V_40 ,
unsigned long * V_126 , struct V_103 * V_103 ,
struct V_118 * V_119 )
{
bool V_108 ;
if ( ( * V_126 ) ++ < V_119 -> V_126 )
return true ;
if ( F_26 ( F_65 ( V_40 -> V_60 ) ) )
V_108 = F_86 ( V_103 , V_119 , V_2 , V_40 ) ;
else
...
static int F_88 ( struct V_103 * V_103 , struct V_118 * V_119 )
{
...
if ( ! F_87 ( V_94 , V_24 , & V_126 , V_103 , V_119 ) ) {
F_40 ( V_94 ) ;
break;
}
}
...
static int F_90 ( struct V_69 * V_69 , int V_127 )
{
struct V_1 * V_2 ;
struct V_3 * V_40 ;
int error ;
if ( ( V_127 & V_66 ) && F_91 ( V_69 -> V_82 ) )
return - V_67 ;
V_2 = F_60 ( V_69 ) ;
if ( F_62 ( V_2 ) )
return F_71 ( V_2 ) ;
V_40 = F_57 ( V_69 ) -> V_77 ;
if ( ! V_40 )
error = V_127 & V_65 ? - V_67 : 0 ;
else
error = F_53 ( V_2 , V_40 , V_127 & ~ V_128 ) ;
F_40 ( V_2 ) ;
return error ;
}
static int F_92 ( struct V_92 * V_92 , struct V_129 * V_130 )
{
struct V_69 * V_69 = F_84 ( V_92 ) ;
int error ;
if ( V_130 -> V_131 & ( V_132 | V_133 | V_134 ) )
return - V_109 ;
error = F_93 ( V_69 , V_130 ) ;
if ( error )
return error ;
F_94 ( V_69 , V_130 ) ;
F_95 ( V_69 ) ;
...
static int F_96 ( struct V_135 * V_136 , struct V_92 * V_92 , struct V_137 * V_138 )
{
struct V_69 * V_69 = F_84 ( V_92 ) ;
struct V_1 * V_2 = F_60 ( V_69 ) ;
struct V_3 * V_40 = F_57 ( V_69 ) -> V_77 ;
...
F_97 ( V_69 , V_138 ) ;
if ( V_40 )
V_138 -> V_60 = ( V_138 -> V_60 & V_139 ) | V_40 -> V_60 ;
F_40 ( V_2 ) ;
return 0 ;
}
static int F_98 ( struct V_92 * V_92 , unsigned int V_93 )
{
if ( V_93 & V_140 )
return - V_141 ;
return ! F_57 ( F_84 ( V_92 ) ) -> V_76 -> V_45 ;
}
static int F_99 ( const struct V_92 * V_92 )
{
return ! ! F_57 ( F_84 ( V_92 ) ) -> V_76 -> V_45 ;
}
static int F_100 ( struct V_1 * V_31 )
{
...
V_108 = V_39 -> V_142 ( V_39 ) ;
F_31 ( & V_52 ) ;
return V_108 ;
}
static int F_101 ( const struct V_92 * V_13 , const struct V_92 * V_92 ,
...
return 1 ;
V_2 = F_103 ( F_57 ( V_69 ) -> V_76 ) ;
return ! V_2 || ! F_100 ( V_2 ) ;
}
static struct V_6 * F_104 ( struct V_6 * V_7 ,
const char * V_22 , int V_23 )
{
struct V_1 * V_2 ;
struct V_3 * V_24 ;
...
static struct V_6 * F_105 ( struct V_38 * V_39 ,
const char * V_22 , int V_23 )
{
struct V_3 * V_40 ;
struct V_6 * V_145 ;
struct V_28 * V_26 ;
char * V_146 ;
V_145 = F_106 ( sizeof( * V_145 ) + sizeof( struct V_28 ) +
...
int V_46 ;
F_33 ( & V_52 ) ;
V_150 = F_104 ( V_7 , V_22 , V_23 ) ;
if ( ! F_62 ( V_150 ) )
goto V_151;
if ( F_71 ( V_150 ) != - V_54 )
goto V_152;
F_31 ( & V_52 ) ;
V_145 = F_105 ( V_39 , V_22 , V_23 ) ;
F_33 ( & V_52 ) ;
V_150 = F_34 ( - V_100 ) ;
if ( ! V_145 )
goto V_152;
...
static struct V_6 * F_108 ( struct V_38 * V_39 , struct V_6 * V_7 )
{
struct V_6 * V_13 ;
const char * V_14 ;
if ( ! V_7 -> V_8 . V_13 )
return & V_39 -> V_7 ;
V_13 = F_108 ( V_39 , V_7 -> V_8 . V_13 ) ;
if ( F_62 ( V_13 ) )
return V_13 ;
V_14 = V_7 -> V_8 . V_3 [ 0 ] . V_14 ;
return F_104 ( V_13 , V_14 , strlen ( V_14 ) ) ;
}
...
static int F_109 ( const char * V_154 , struct V_3 * V_40 , char * V_155 , ... )
{
struct V_156 V_157 ;
T_7 args ;
va_start ( args , V_155 ) ;
...
static int F_110 ( const char * V_154 , struct V_3 * V_40 )
{
int V_46 = 0 ;
for (; V_40 -> V_14 ; V_40 ++ ) {
if ( V_40 -> V_4 )
V_46 = F_109 ( V_154 , V_40 , L_7 ) ;
if ( ( V_40 -> V_110 == V_159 ) ||
( V_40 -> V_110 == V_160 ) ||
( V_40 -> V_110 == V_161 ) ||
( V_40 -> V_110 == V_162 ) ||
...
( V_40 -> V_110 == V_166 ) ) {
if ( ! V_40 -> V_153 )
V_46 = F_109 ( V_154 , V_40 , L_8 ) ;
if ( ! V_40 -> V_167 )
V_46 = F_109 ( V_154 , V_40 , L_9 ) ;
}
if ( ! V_40 -> V_110 )
V_46 = F_109 ( V_154 , V_40 , L_10 ) ;
if ( ( V_40 -> V_60 & ( V_148 | V_168 ) ) != V_40 -> V_60 )
V_46 = F_109 ( V_154 , V_40 , L_11 ,
V_40 -> V_60 ) ;
}
return V_46 ;
}
static struct V_1 * F_111 ( struct V_6 * V_7 , struct V_3 * V_40 ,
struct V_37 * V_169 )
{
...
static bool F_112 ( struct V_6 * V_7 ,
...
if ( ! V_171 )
return false ;
if ( F_58 ( V_171 -> V_60 ) && F_58 ( V_24 -> V_60 ) )
continue;
if ( F_65 ( V_171 -> V_60 ) && ( V_171 -> V_153 == V_169 ) )
continue;
return false ;
}
for ( V_24 = V_40 ; V_24 -> V_14 ; V_24 ++ ) {
...
{
struct V_38 * V_178 = & V_91 . V_57 ;
struct V_6 * V_179 = NULL ;
struct V_1 * V_172 ;
int V_46 ;
if ( V_2 -> V_39 == V_178 )
return 0 ;
V_179 = F_108 ( V_178 , V_2 -> V_13 ) ;
if ( F_62 ( V_179 ) )
return 0 ;
if ( F_112 ( V_179 , V_2 -> V_3 , V_2 -> V_27 ) )
return 0 ;
V_179 -> V_8 . V_44 ++ ;
F_31 ( & V_52 ) ;
V_172 = F_111 ( V_179 , V_2 -> V_3 , V_2 -> V_27 ) ;
F_33 ( & V_52 ) ;
V_46 = - V_100 ;
if ( ! V_172 )
goto V_74;
...
struct V_1 * F_116 ( const char * V_154 , struct V_3 * V_40 )
{
return F_114 ( & V_91 . V_57 ,
V_154 , V_40 ) ;
}
static char * F_117 ( const char * V_154 , char * V_126 , const char * V_22 )
{
int V_23 ;
V_23 = strlen ( V_22 ) ;
...
static int F_118 ( struct V_3 * V_40 )
{
int V_183 = 0 ;
int V_184 = 0 ;
struct V_3 * V_24 ;
...
for ( V_24 = V_40 ; V_24 -> V_14 ; V_24 ++ ) {
if ( V_24 -> V_4 )
V_184 += F_118 ( V_24 -> V_4 ) ;
else
V_183 = 1 ;
}
return V_184 + V_183 ;
}
static int F_119 ( const char * V_154 , char * V_126 ,
...
if ( V_188 && V_187 ) {
struct V_3 * V_145 ;
V_186 = F_106 ( sizeof( struct V_3 ) * ( V_187 + 1 ) ,
V_147 ) ;
if ( ! V_186 )
goto V_74;
V_41 = V_186 ;
...
continue;
V_46 = - V_190 ;
V_189 = F_117 ( V_154 , V_126 , V_24 -> V_14 ) ;
if ( ! V_189 )
goto V_74;
V_46 = F_119 ( V_154 , V_189 , V_185 ,
V_39 , V_24 -> V_4 ) ;
V_126 [ 0 ] = '\0' ;
if ( V_46 )
goto V_74;
...
int V_184 = F_118 ( V_40 ) ;
struct V_1 * V_8 = NULL , * * V_192 , * * V_185 ;
const struct V_191 * V_193 ;
char * V_194 , * V_126 ;
V_126 = V_194 = F_121 ( V_182 , V_147 ) ;
if ( ! V_194 )
return NULL ;
V_126 [ 0 ] = '\0' ;
for ( V_193 = V_154 ; V_193 -> V_14 ; V_193 ++ ) {
V_126 = F_117 ( V_194 , V_126 , V_193 -> V_14 ) ;
if ( ! V_126 )
goto V_74;
}
while ( V_40 -> V_14 && V_40 -> V_4 && ! V_40 [ 1 ] . V_14 ) {
V_126 = F_117 ( V_194 , V_126 , V_40 -> V_14 ) ;
if ( ! V_126 )
goto V_74;
V_40 = V_40 -> V_4 ;
}
if ( V_184 == 1 ) {
V_8 = F_114 ( V_39 , V_194 , V_40 ) ;
if ( V_8 )
V_8 -> V_41 = V_41 ;
} else {
V_8 = F_106 ( sizeof( * V_8 ) +
...
struct V_1 * F_123 ( const struct V_191 * V_154 ,
struct V_3 * V_40 )
{
return F_120 ( & V_91 . V_57 ,
V_154 , V_40 ) ;
}
struct V_1 * F_124 ( struct V_3 * V_40 )
{
static const struct V_191 V_197 [] = { {} } ;
return F_123 ( V_197 , V_40 ) ;
}
...
if ( V_171 &&
( ( F_58 ( V_171 -> V_60 ) && F_58 ( V_24 -> V_60 ) ) ||
( F_65 ( V_171 -> V_60 ) && ( V_171 -> V_153 == V_27 ) ) ) ) {
F_24 ( V_198 ) ;
}
else {
F_13 ( L_12 ) ;
...
void F_122 ( struct V_1 * V_8 )
{
int V_184 ;
F_125 () ;
if ( V_8 == NULL )
return;
V_184 = F_118 ( V_8 -> V_41 ) ;
if ( F_26 ( V_184 > 1 ) ) {
struct V_1 * * V_192 ;
int V_199 ;
V_192 = (struct V_1 * * ) ( V_8 + 1 ) ;
...
void F_127 ( struct V_38 * V_39 )
{
F_128 ( ! F_21 ( & V_39 -> V_7 . V_27 ) ) ;
}
int T_8 F_129 ( void )
{
struct V_201 * V_202 ;
V_202 = F_130 ( L_13 , NULL ) ;
V_202 -> V_203 = & V_89 ;
V_202 -> V_204 = & V_90 ;
V_202 -> V_205 = 0 ;
return F_131 () ;
