...
int V_3 , struct V_151 * * V_155 )
{
struct V_4 * V_5 = V_33 -> V_5 ;
struct V_151 * V_152 ;
int V_156 ;
V_152 = F_57 ( sizeof( struct V_151 ) +
sizeof( struct V_145 * ) , V_129 ) ;
if ( V_152 == NULL )
return - V_130 ;
V_156 = F_72 ( V_5 , V_3 , & V_152 ) ;
F_8 ( V_33 -> V_39 , L_48 , V_156 ,
V_3 ? L_40 : L_41 ) ;
* V_155 = V_152 ;
return V_156 ;
}
