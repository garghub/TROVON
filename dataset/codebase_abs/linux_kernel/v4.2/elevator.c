...
char * V_120 = L_11 ;
if ( V_7 -> V_121 ) {
if ( F_103 ( V_7 -> V_121 < sizeof( struct V_122 ) ) ||
F_103 ( V_7 -> V_123 < F_104 ( struct V_122 ) ) )
return - V_32 ;
snprintf ( V_7 -> V_124 , sizeof( V_7 -> V_124 ) ,
L_12 , V_7 -> V_13 ) ;
V_7 -> V_125 = F_105 ( V_7 -> V_124 , V_7 -> V_121 ,
V_7 -> V_123 , 0 , NULL ) ;
if ( ! V_7 -> V_125 )
return - V_126 ;
}
...
static int F_110 ( struct V_4 * V_5 , struct V_11 * V_131 )
{
...
struct V_1 * V_2 )
{
struct V_44 * V_141 = F_125 ( & V_2 -> V_44 ) ;
if ( V_141 )
return F_126 ( V_141 ) ;
return NULL ;
}
...
struct V_1 * V_2 )
{
struct V_44 * V_142 = F_128 ( & V_2 -> V_44 ) ;
if ( V_142 )
return F_126 ( V_142 ) ;
return NULL ;
}
