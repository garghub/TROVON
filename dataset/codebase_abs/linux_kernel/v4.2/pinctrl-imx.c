...
struct V_2 * V_3 )
{
struct V_22 * V_23 = V_88 -> V_21 . V_89 ;
struct V_22 * V_81 ;
T_1 V_90 = 0 ;
T_1 V_6 = 0 ;
bool V_91 ;
...
V_3 -> V_64 = V_90 ;
V_3 -> V_48 = F_32 ( & V_88 -> V_21 , V_90 * sizeof( struct V_82 ) ,
V_33 ) ;
if ( ! V_3 -> V_48 )
return - V_34 ;
if ( V_91 ) {
...
V_3 -> V_8 = F_32 ( & V_88 -> V_21 , V_3 -> V_7 * sizeof( struct V_1 ) ,
V_33 ) ;
if ( ! V_3 -> V_8 )
return - V_34 ;
if ( V_91 ) {
...
V_3 -> V_21 = & V_88 -> V_21 ;
V_12 = F_32 ( & V_88 -> V_21 , sizeof( * V_12 ) , V_33 ) ;
if ( ! V_12 )
return - V_34 ;
V_3 -> V_50 = F_41 ( & V_88 -> V_21 , sizeof( * V_3 -> V_50 ) *
V_3 -> V_15 , V_33 ) ;
if ( ! V_3 -> V_50 )
return - V_34 ;
...
V_94 = F_42 ( V_88 , V_95 , 0 ) ;
V_12 -> V_55 = F_43 ( & V_88 -> V_21 , V_94 ) ;
if ( F_44 ( V_12 -> V_55 ) )
return F_45 ( V_12 -> V_55 ) ;
V_96 . V_4 = F_8 ( & V_88 -> V_21 ) ;
V_96 . V_14 = V_3 -> V_14 ;
V_96 . V_15 = V_3 -> V_15 ;
V_71 = F_39 ( V_88 , V_3 ) ;
if ( V_71 ) {
...
V_12 -> V_21 = V_3 -> V_21 ;
F_46 ( V_88 , V_12 ) ;
V_12 -> V_97 = F_47 ( & V_96 , & V_88 -> V_21 , V_12 ) ;
if ( F_44 ( V_12 -> V_97 ) ) {
F_10 ( & V_88 -> V_21 , L_25 ) ;
return F_45 ( V_12 -> V_97 ) ;
}
F_48 ( & V_88 -> V_21 , L_26 ) ;
return 0 ;
}
int F_49 ( struct V_87 * V_88 )
{
struct V_11 * V_12 = F_50 ( V_88 ) ;
F_51 ( V_12 -> V_97 ) ;
return 0 ;
}
