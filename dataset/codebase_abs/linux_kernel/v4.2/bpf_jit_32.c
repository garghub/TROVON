...
case V_124 | V_155 :
V_14 -> V_29 |= V_32 ;
V_49 = F_23 ( struct V_1 , V_156 ) ;
F_12 ( F_24 ( V_54 , V_33 , V_49 ) , V_14 ) ;
F_12 ( F_67 ( V_54 , 0 ) , V_14 ) ;
F_53 ( V_119 , V_14 ) ;
F_62 ( F_63 ( struct V_157 ,
V_158 ) != 4 ) ;
V_49 = F_23 ( struct V_157 , V_158 ) ;
F_12 ( F_24 ( V_24 , V_54 , V_49 ) , V_14 ) ;
break;
case V_124 | V_159 :
V_14 -> V_29 |= V_32 ;
F_62 ( F_63 ( struct V_1 , V_160 ) != 4 ) ;
V_49 = F_23 ( struct V_1 , V_160 ) ;
F_12 ( F_24 ( V_24 , V_33 , V_49 ) , V_14 ) ;
break;
case V_124 | V_161 :
V_14 -> V_29 |= V_32 ;
F_62 ( F_63 ( struct V_1 , V_162 ) != 4 ) ;
V_49 = F_23 ( struct V_1 , V_162 ) ;
F_12 ( F_24 ( V_24 , V_33 , V_49 ) , V_14 ) ;
break;
case V_124 | V_163 :
case V_124 | V_164 :
V_14 -> V_29 |= V_32 ;
F_62 ( F_63 ( struct V_1 , V_165 ) != 2 ) ;
V_49 = F_23 ( struct V_1 , V_165 ) ;
F_12 ( F_50 ( V_24 , V_33 , V_49 ) , V_14 ) ;
if ( V_21 == ( V_124 | V_163 ) )
F_69 ( V_127 , V_24 , V_24 , ~ V_166 , V_14 ) ;
else {
F_69 ( V_167 , V_24 , V_24 , 12 , V_14 ) ;
...
V_14 . V_18 = V_170 ;
V_14 . V_84 = - 1 ;
V_14 . V_65 = F_84 ( 4 * ( V_14 . V_18 -> V_19 + 1 ) , V_177 ) ;
if ( V_14 . V_65 == NULL )
return;
if ( F_76 ( F_60 ( & V_14 ) ) )
goto V_178;
V_173 = V_14 . V_16 ;
F_19 ( & V_14 ) ;
V_14 . V_66 = ( V_14 . V_16 - V_173 ) * 4 ;
#if V_71 < 7
V_173 = V_14 . V_16 ;
F_27 ( & V_14 ) ;
V_14 . V_67 = ( V_14 . V_16 - V_173 ) * 4 ;
V_14 . V_16 += V_14 . V_63 ;
if ( V_14 . V_63 ) {
V_14 . V_64 = F_84 ( 4 * V_14 . V_63 , V_177 ) ;
if ( V_14 . V_64 == NULL )
goto V_178;
}
#else
...
F_27 ( & V_14 ) ;
F_88 ( ( T_4 ) V_14 . V_15 , ( T_4 ) ( V_14 . V_15 + V_14 . V_16 ) ) ;
#if V_71 < 7
if ( V_14 . V_63 )
F_86 ( V_14 . V_64 ) ;
#endif
if ( V_176 > 1 )
F_89 ( V_170 -> V_19 , V_174 , 2 , V_14 . V_15 ) ;
F_90 ( ( unsigned long ) V_172 , V_172 -> V_179 ) ;
V_170 -> V_180 = ( void * ) V_14 . V_15 ;
V_170 -> V_181 = true ;
V_178:
F_86 ( V_14 . V_65 ) ;
return;
}
void F_91 ( struct V_92 * V_170 )
{
unsigned long V_182 = ( unsigned long ) V_170 -> V_180 & V_183 ;
struct V_171 * V_172 = ( void * ) V_182 ;
if ( ! V_170 -> V_181 )
goto V_184;
F_92 ( V_182 , V_172 -> V_179 ) ;
F_87 ( V_172 ) ;
V_184:
F_93 ( V_170 ) ;
}
