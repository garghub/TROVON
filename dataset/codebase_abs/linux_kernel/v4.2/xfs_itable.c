...
long * V_147 )
{
if ( F_13 ( V_88 , V_7 , V_146 * sizeof( * V_7 ) ) )
return - V_89 ;
...
T_14 V_9 )
{
T_6 V_90 = F_30 ( V_1 , * V_148 ) ;
T_8 V_106 = F_31 ( V_1 , * V_148 ) ;
struct V_104 * V_105 = NULL ;
struct V_149 * V_129 = NULL ;
struct V_145 * V_7 ;
int V_150 ;
int V_151 = * V_146 ;
int V_152 = 0 ;
...
* V_146 = 0 ;
if ( V_90 >= V_1 -> V_3 . V_135 ||
* V_148 != F_28 ( V_1 , V_90 , V_106 ) )
return error ;
V_150 = F_41 ( V_151 , ( int ) ( V_136 / sizeof( * V_7 ) ) ) ;
V_7 = F_5 ( V_150 * sizeof( * V_7 ) , V_20 ) ;
do {
struct V_91 V_140 ;
int V_11 ;
if ( ! V_129 ) {
...
V_7 [ V_152 ] . V_155 = V_140 . V_112 - V_140 . V_111 ;
V_7 [ V_152 ] . V_156 = ~ V_140 . V_102 ;
if ( ++ V_152 == V_150 ) {
long V_147 ;
error = V_9 ( V_88 , V_7 , V_152 , & V_147 ) ;
if ( error )
break;
V_88 += V_147 ;
* V_146 += V_152 ;
