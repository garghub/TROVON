...
F_45 ( V_2 , & V_142 ) ;
V_143 = F_4 ( V_145 ) ;
F_46 ( V_2 -> V_33 , L_9 , V_146 , __LINE__ , V_143 ) ;
F_3 ( V_147 , 0 ) ;
V_11 = F_4 ( V_148 ) ;
...
static int F_75 ( struct V_192 * V_193 ,
struct V_194 * V_195 )
{
struct V_197 * V_198 ;
struct V_199 * V_200 ;
...
V_5 = F_74 ( V_193 , & V_198 , 0 ) ;
if ( V_5 ) {
F_20 ( L_27 , V_195 -> V_312 ) ;
F_72 ( V_193 , V_195 ) ;
return V_5 ;
}
V_201 [ V_196 + 1 ] = F_70 ( V_193 , V_196 + 1 ) + ( ( T_4 ) V_198 -> V_215 ) ;
V_5 = F_77 ( V_193 , V_195 , V_198 -> V_25 ) ;
if ( V_5 ) {
return V_5 ;
}
break;
...
V_200 -> V_316 = V_195 -> V_317 - 1 ;
V_5 = F_78 ( V_193 -> V_2 , V_200 ) ;
if ( V_5 ) {
return V_5 ;
}
break;
...
break;
default:
F_20 ( L_29 , V_195 -> V_312 ) ;
return - V_34 ;
}
return 0 ;
}
int F_79 ( struct V_192 * V_193 )
{
struct V_194 V_195 ;
struct V_199 * V_200 ;
int V_5 ;
V_200 = F_80 ( sizeof( * V_200 ) , V_327 ) ;
if ( V_200 == NULL )
return - V_328 ;
F_81 ( V_193 -> V_2 , V_200 ) ;
V_193 -> V_200 = V_200 ;
do {
V_5 = F_82 ( V_193 , & V_195 , V_193 -> V_196 ) ;
if ( V_5 ) {
return V_5 ;
}
V_193 -> V_196 += V_195 . V_317 + 2 ;
switch ( V_195 . type ) {
case V_329 :
V_5 = F_83 ( V_193 , & V_195 ,
V_193 -> V_2 -> V_67 . V_68 . V_330 ,
V_193 -> V_2 -> V_67 . V_68 . V_331 ,
& F_69 ) ;
break;
case V_332 :
break;
case V_333 :
V_5 = F_75 ( V_193 , & V_195 ) ;
break;
default:
F_20 ( L_30 , V_195 . type ) ;
return - V_34 ;
}
if ( V_5 ) {
return V_5 ;
}
} while ( V_193 -> V_196 < V_193 -> V_334 -> V_335 );
return 0 ;
}
void F_84 ( struct V_1 * V_2 )
{
V_2 -> V_67 . V_68 . V_330 = V_336 ;
V_2 -> V_67 . V_68 . V_331 = F_85 ( V_336 ) ;
}
...
F_3 ( V_338 , F_12 ( V_2 -> V_37 . V_339 ) ) ;
F_3 ( V_340 ,
F_13 ( V_2 -> V_37 . V_339 ) & 0xff ) ;
} else {
F_3 ( V_337 , 0x0FFFFFFF ) ;
F_3 ( V_338 , 0 ) ;
F_3 ( V_340 , 0 ) ;
}
if ( F_38 ( V_2 ) )
...
V_11 = F_94 ( V_344 ) ;
V_11 |= F_95 ( 1 ) | F_96 ( 1 ) ;
if ( ( V_2 -> V_124 == V_309 ) || ( V_2 -> V_124 == V_345 ) )
V_11 |= F_97 ( 1 ) ;
F_98 ( V_344 , V_11 ) ;
}
