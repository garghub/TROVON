...
struct V_1 * V_21 ;
struct V_22 V_23 = { } ;
struct V_24 * V_25 = V_18 -> V_12 . V_26 ;
int V_27 , V_9 ;
if ( ! V_25 ) {
F_6 ( & V_18 -> V_12 , L_3 ) ;
return - V_15 ;
}
V_4 = F_10 ( & V_18 -> V_12 , sizeof( * V_4 ) , V_28 ) ;
if ( ! V_4 )
return - V_29 ;
...
V_30 . V_14 = V_27 / sizeof( * V_4 -> V_11 ) ;
V_4 -> V_11 = F_10 ( & V_18 -> V_12 ,
V_27 , V_28 ) ;
if ( ! V_4 -> V_11 )
return - V_29 ;
V_9 = F_12 ( V_25 , L_4 ,
