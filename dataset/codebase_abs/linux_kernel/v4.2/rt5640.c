...
F_38 ( V_2 , V_277 ) ;
F_1 ( V_2 ) ;
F_44 ( V_134 -> V_145 , true ) ;
F_45 ( V_134 -> V_145 ) ;
if ( F_46 ( V_134 -> V_305 . V_307 ) )
F_47 ( V_134 -> V_305 . V_307 , 0 ) ;
return 0 ;
}
...
struct V_133 * V_134 = F_8 ( V_2 ) ;
if ( F_46 ( V_134 -> V_305 . V_307 ) ) {
F_47 ( V_134 -> V_305 . V_307 , 1 ) ;
F_49 ( 400 ) ;
}
F_44 ( V_134 -> V_145 , false ) ;
F_50 ( V_134 -> V_145 ) ;
return 0 ;
}
static int F_51 ( struct V_133 * V_134 , struct V_308 * V_309 )
{
V_134 -> V_305 . V_310 = F_52 ( V_309 ,
L_14 ) ;
V_134 -> V_305 . V_311 = F_52 ( V_309 ,
L_15 ) ;
V_134 -> V_305 . V_307 = F_53 ( V_309 ,
L_16 , 0 ) ;
if ( ! F_46 ( V_134 -> V_305 . V_307 ) &&
...
static int F_54 ( struct V_313 * V_314 ,
const struct V_315 * V_209 )
{
struct V_316 * V_305 = F_55 ( & V_314 -> V_5 ) ;
struct V_133 * V_134 ;
int V_180 ;
unsigned int V_142 ;
V_134 = F_56 ( & V_314 -> V_5 ,
sizeof( struct V_133 ) ,
V_317 ) ;
if ( NULL == V_134 )
return - V_318 ;
...
V_180 = F_51 ( V_134 , V_314 -> V_5 . V_319 ) ;
if ( V_180 )
return V_180 ;
} else
V_134 -> V_305 . V_307 = - V_136 ;
V_134 -> V_145 = F_58 ( V_314 , & V_320 ) ;
if ( F_59 ( V_134 -> V_145 ) ) {
V_180 = F_60 ( V_134 -> V_145 ) ;
F_10 ( & V_314 -> V_5 , L_17 ,
V_180 ) ;
return V_180 ;
}
if ( F_46 ( V_134 -> V_305 . V_307 ) ) {
V_180 = F_61 ( & V_314 -> V_5 , V_134 -> V_305 . V_307 ,
V_321 ,
L_18 ) ;
if ( V_180 < 0 ) {
F_10 ( & V_314 -> V_5 , L_19 ,
...
V_180 = F_63 ( V_134 -> V_145 , V_323 ,
F_4 ( V_323 ) ) ;
if ( V_180 != 0 )
F_64 ( & V_314 -> V_5 , L_21 , V_180 ) ;
...
V_325 , V_325 ) ;
V_134 -> V_177 = 1 ;
return F_65 ( & V_314 -> V_5 , & V_326 ,
V_327 , F_4 ( V_327 ) ) ;
}
static int F_66 ( struct V_313 * V_314 )
{
F_67 ( & V_314 -> V_5 ) ;
return 0 ;
}
