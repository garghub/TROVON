...
if ( V_361 -> V_390 & V_391 &&
! ( V_361 -> V_390 & ( V_392 | V_393 ) ) ) {
struct V_49 * V_366 ;
F_222 ( V_361 ) ;
...
V_396 . V_298 = V_339 -> V_7 . V_8 ;
V_396 . V_240 = V_50 -> V_240 . V_7 . V_8 ;
V_396 . V_398 = V_21 -> V_246 ;
V_396 . V_399 = V_385 ;
if ( V_211 -> V_400 ( V_46 , & V_394 , & V_396 ) ) {
F_101 ( V_75 , L_12 ,
& V_339 -> V_7 . V_8 ) ;
V_75 -> V_239 . V_386 ++ ;
goto V_387;
...
V_341 = V_341 ? : F_226 ( V_394 ) ;
V_216 . V_117 = F_5 ( V_117 << 8 ) ;
V_216 . V_226 = V_21 -> V_246 ;
V_101 = F_201 ( V_394 , V_46 , V_21 , V_75 , & V_396 . V_240 , & V_396 . V_298 ,
...
V_406 = F_158 ( V_21 ) ;
if ( ( V_50 -> V_43 & V_408 ) ) {
if ( F_21 ( V_406 -> V_309 ) == V_282 )
return F_169 ( V_75 , V_21 ) ;
#if F_112 ( V_179 )
else if ( F_21 ( V_406 -> V_309 ) == V_303 &&
...
V_107 = F_64 ( V_50 , V_406 -> V_308 ) ;
V_375 = false ;
if ( V_107 && ( V_107 -> V_43 & V_332 ) && ( V_50 -> V_43 & V_409 ) &&
( F_21 ( V_406 -> V_309 ) == V_270 ||
F_21 ( V_406 -> V_309 ) == V_303 ) ) {
V_375 = F_199 ( V_75 , V_21 ) ;
if ( V_375 )
V_107 = F_64 ( V_50 , V_406 -> V_308 ) ;
}
if ( V_107 == NULL ) {
V_107 = F_64 ( V_50 , V_410 ) ;
if ( V_107 == NULL ) {
if ( ( V_50 -> V_43 & V_411 ) &&
! F_102 ( V_406 -> V_308 ) )
F_56 ( V_50 , V_406 -> V_308 ) ;
V_75 -> V_239 . V_265 ++ ;
F_51 ( V_21 ) ;
return V_291 ;
}
...
V_412 = F_229 ( V_21 , V_103 ) ;
if ( V_412 )
F_217 ( V_412 , V_75 , V_55 , V_375 ) ;
}
if ( V_407 )
F_217 ( V_21 , V_75 , V_407 , V_375 ) ;
else
F_51 ( V_21 ) ;
return V_291 ;
}
static void F_230 ( unsigned long V_413 )
{
...
V_107 -> V_73 = V_108 ;
F_108 ( V_50 , V_107 ) ;
} else if ( F_233 ( V_417 , V_414 ) )
V_414 = V_417 ;
}
F_119 ( & V_50 -> V_187 ) ;
}
F_234 ( & V_50 -> V_420 , V_414 ) ;
}
...
static int F_247 ( struct V_106 * V_75 , int V_422 )
{
struct V_49 * V_50 = F_55 ( V_75 ) ;
struct V_36 * V_339 = & V_50 -> V_51 ;
struct V_106 * V_423 ;
int V_424 ;
V_423 = F_115 ( V_50 -> V_29 , V_339 -> V_89 ) ;
if ( V_423 == NULL )
return F_248 ( V_75 , V_422 ) ;
if ( V_339 -> V_69 . V_4 . V_5 == V_6 )
V_424 = V_423 -> V_425 - V_426 ;
else
V_424 = V_423 -> V_425 - V_427 ;
if ( V_422 < 68 || V_422 > V_424 )
return - V_181 ;
V_75 -> V_425 = V_422 ;
return 0 ;
}
...
V_75 -> V_429 = V_242 + V_426 ;
else
V_75 -> V_429 = V_242 + V_427 ;
V_75 -> V_156 = & V_430 ;
V_75 -> V_431 = V_432 ;
F_253 ( V_75 , & V_433 ) ;
V_75 -> V_434 = 0 ;
V_75 -> V_435 |= V_436 ;
V_75 -> V_435 |= V_437 | V_438 ;
V_75 -> V_435 |= V_439 ;
V_75 -> V_435 |= V_440 ;
V_75 -> V_441 = V_75 -> V_435 ;
V_75 -> V_435 |= V_442 | V_443 ;
V_75 -> V_444 |= V_437 | V_438 | V_439 ;
V_75 -> V_444 |= V_440 ;
V_75 -> V_444 |= V_442 | V_443 ;
F_254 ( V_75 ) ;
V_75 -> V_445 |= V_446 ;
F_103 ( & V_50 -> V_40 ) ;
F_255 ( & V_50 -> V_187 ) ;
F_256 ( & V_50 -> V_420 ) ;
V_50 -> V_420 . V_447 = F_230 ;
V_50 -> V_420 . V_123 = ( unsigned long ) V_50 ;
V_50 -> V_86 = F_151 ( V_448 ) ;
V_50 -> V_75 = V_75 ;
for ( V_192 = 0 ; V_192 < V_193 ; ++ V_192 )
...
{
if ( V_178 [ V_449 ] ) {
if ( F_11 ( V_178 [ V_449 ] ) != V_83 ) {
F_259 ( L_15 ) ;
return - V_181 ;
}
if ( ! F_260 ( F_261 ( V_178 [ V_449 ] ) ) ) {
F_259 ( L_16 ) ;
return - V_183 ;
}
}
...
return - V_181 ;
if ( V_123 [ V_450 ] ) {
V_98 V_26 = F_114 ( V_123 [ V_450 ] ) ;
if ( V_26 >= V_451 )
return - V_452 ;
}
if ( V_123 [ V_453 ] ) {
const struct V_454 * V_141
= F_261 ( V_123 [ V_453 ] ) ;
if ( F_21 ( V_141 -> V_455 ) < F_21 ( V_141 -> V_456 ) ) {
F_259 ( L_17 ,
F_21 ( V_141 -> V_456 ) , F_21 ( V_141 -> V_455 ) ) ;
return - V_181 ;
}
}
return 0 ;
}
static void F_262 ( struct V_106 * V_457 ,
struct V_458 * V_459 )
{
F_263 ( V_459 -> V_310 , V_460 , sizeof( V_459 -> V_310 ) ) ;
F_263 ( V_459 -> V_461 , L_18 , sizeof( V_459 -> V_461 ) ) ;
}
static void F_264 ( struct V_462 * V_463 )
{
struct V_24 * V_25 = F_79 ( V_463 , struct V_24 , V_205 ) ;
F_265 ( V_25 -> V_45 ) ;
F_123 ( V_25 , V_175 ) ;
}
static struct V_464 * F_266 ( struct V_29 * V_29 , bool V_465 ,
T_2 V_30 , T_1 V_43 )
{
struct V_464 * V_45 ;
struct V_466 V_467 ;
...
struct V_464 * V_45 ;
unsigned int V_192 ;
bool V_465 = ! ! ( V_43 & V_471 ) ;
struct V_472 V_473 ;
V_25 = F_270 ( sizeof( * V_25 ) , V_474 ) ;
if ( ! V_25 )
return F_268 ( - V_171 ) ;
for ( V_192 = 0 ; V_192 < V_475 ; ++ V_192 )
F_257 ( & V_25 -> V_27 [ V_192 ] ) ;
F_271 ( & V_25 -> V_205 , F_264 ) ;
V_45 = F_266 ( V_29 , V_465 , V_30 , V_43 ) ;
if ( F_207 ( V_45 ) ) {
...
V_25 -> V_147 . V_476 . V_477 = F_78 ;
V_25 -> V_147 . V_476 . V_478 = F_88 ;
F_131 ( & V_32 -> V_203 ) ;
...
if ( ! V_483 ) {
F_131 ( & V_32 -> V_203 ) ;
V_25 = F_26 ( V_29 , V_465 ? V_6 : V_18 , V_30 ,
V_43 ) ;
...
static int F_276 ( struct V_29 * V_485 , struct V_106 * V_75 ,
struct V_14 * V_178 [] , struct V_14 * V_123 [] )
{
struct V_31 * V_32 = F_20 ( V_485 , V_33 ) ;
struct V_49 * V_50 = F_55 ( V_75 ) ;
struct V_36 * V_339 = & V_50 -> V_51 ;
V_98 V_117 ;
int V_101 ;
...
return - V_181 ;
V_50 -> V_29 = V_485 ;
V_117 = F_114 ( V_123 [ V_450 ] ) ;
V_339 -> V_52 = V_117 ;
V_339 -> V_69 . V_4 . V_5 = V_18 ;
if ( V_123 [ V_487 ] ) {
V_339 -> V_69 . sin . V_9 . V_10 = F_13 ( V_123 [ V_487 ] ) ;
} else if ( V_123 [ V_488 ] ) {
if ( ! F_112 ( V_179 ) )
return - V_489 ;
V_339 -> V_69 . V_7 . V_8 = F_12 ( V_123 [ V_488 ] ) ;
V_339 -> V_69 . V_4 . V_5 = V_6 ;
V_486 = true ;
}
if ( V_123 [ V_490 ] ) {
V_50 -> V_240 . sin . V_9 . V_10 = F_13 ( V_123 [ V_490 ] ) ;
V_50 -> V_240 . V_4 . V_5 = V_18 ;
} else if ( V_123 [ V_491 ] ) {
if ( ! F_112 ( V_179 ) )
return - V_489 ;
V_50 -> V_240 . V_7 . V_8 = F_12 ( V_123 [ V_491 ] ) ;
V_50 -> V_240 . V_4 . V_5 = V_6 ;
V_486 = true ;
}
if ( V_123 [ V_492 ] &&
( V_339 -> V_89 = F_114 ( V_123 [ V_492 ] ) ) ) {
struct V_106 * V_423
= F_115 ( V_485 , V_339 -> V_89 ) ;
if ( ! V_423 ) {
...
#if F_112 ( V_179 )
if ( V_486 ) {
struct V_327 * V_494 = F_197 ( V_423 ) ;
if ( V_494 && V_494 -> V_495 . V_496 ) {
F_117 ( L_21 ) ;
return - V_497 ;
}
V_50 -> V_43 |= V_471 ;
...
#endif
if ( ! V_178 [ V_498 ] )
V_75 -> V_425 = V_423 -> V_425 - ( V_486 ? V_426 : V_427 ) ;
V_75 -> V_429 = V_423 -> V_499 +
( V_486 ? V_426 : V_427 ) ;
} else if ( V_486 )
V_50 -> V_43 |= V_471 ;
if ( V_123 [ V_500 ] )
V_50 -> V_248 = F_277 ( V_123 [ V_500 ] ) ;
if ( V_123 [ V_501 ] )
V_50 -> V_341 = F_277 ( V_123 [ V_501 ] ) ;
if ( ! V_123 [ V_502 ] || F_277 ( V_123 [ V_502 ] ) )
V_50 -> V_43 |= V_245 ;
if ( V_123 [ V_503 ] )
V_50 -> V_418 = F_114 ( V_123 [ V_503 ] ) ;
else
V_50 -> V_418 = V_504 ;
if ( V_123 [ V_505 ] && F_277 ( V_123 [ V_505 ] ) )
V_50 -> V_43 |= V_408 ;
if ( V_123 [ V_506 ] && F_277 ( V_123 [ V_506 ] ) )
V_50 -> V_43 |= V_409 ;
if ( V_123 [ V_507 ] && F_277 ( V_123 [ V_507 ] ) )
V_50 -> V_43 |= V_411 ;
if ( V_123 [ V_508 ] && F_277 ( V_123 [ V_508 ] ) )
V_50 -> V_43 |= V_289 ;
if ( V_123 [ V_509 ] )
V_50 -> V_168 = F_114 ( V_123 [ V_509 ] ) ;
if ( V_123 [ V_453 ] ) {
const struct V_454 * V_141
= F_261 ( V_123 [ V_453 ] ) ;
V_50 -> V_379 = F_21 ( V_141 -> V_456 ) ;
V_50 -> V_380 = F_21 ( V_141 -> V_455 ) ;
}
if ( V_123 [ V_510 ] )
V_50 -> V_86 = F_113 ( V_123 [ V_510 ] ) ;
if ( V_123 [ V_511 ] && F_277 ( V_123 [ V_511 ] ) )
V_50 -> V_43 |= V_364 ;
if ( V_123 [ V_512 ] &&
F_277 ( V_123 [ V_512 ] ) )
V_50 -> V_43 |= V_346 ;
...
if ( V_123 [ V_517 ] )
V_50 -> V_43 |= V_153 ;
if ( F_30 ( V_485 , V_117 , V_486 ? V_6 : V_18 ,
V_50 -> V_86 , V_50 -> V_43 ) ) {
F_117 ( L_22 , V_117 ) ;
return - V_161 ;
}
...
F_279 ( & V_50 -> V_40 , & V_32 -> V_520 ) ;
return 0 ;
}
static void F_280 ( struct V_106 * V_75 , struct V_521 * V_116 )
{
struct V_49 * V_50 = F_55 ( V_75 ) ;
struct V_31 * V_32 = F_20 ( V_50 -> V_29 , V_33 ) ;
F_131 ( & V_32 -> V_203 ) ;
...
struct V_454 V_522 = {
. V_456 = F_151 ( V_50 -> V_379 ) ,
. V_455 = F_151 ( V_50 -> V_380 ) ,
} ;
if ( F_41 ( V_21 , V_450 , V_339 -> V_52 ) )
goto V_81;
if ( ! F_3 ( & V_339 -> V_69 ) ) {
...
if ( V_339 -> V_89 && F_41 ( V_21 , V_492 , V_339 -> V_89 ) )
goto V_81;
if ( ! F_3 ( & V_50 -> V_240 ) ) {
...
if ( F_286 ( V_21 , V_501 , V_50 -> V_341 ) ||
F_286 ( V_21 , V_500 , V_50 -> V_248 ) ||
F_286 ( V_21 , V_502 ,
! ! ( V_50 -> V_43 & V_245 ) ) ||
F_286 ( V_21 , V_505 ,
! ! ( V_50 -> V_43 & V_408 ) ) ||
F_286 ( V_21 , V_506 , ! ! ( V_50 -> V_43 & V_409 ) ) ||
F_286 ( V_21 , V_507 ,
! ! ( V_50 -> V_43 & V_411 ) ) ||
F_286 ( V_21 , V_508 ,
! ! ( V_50 -> V_43 & V_289 ) ) ||
F_41 ( V_21 , V_503 , V_50 -> V_418 ) ||
F_41 ( V_21 , V_509 , V_50 -> V_168 ) ||
F_40 ( V_21 , V_510 , V_50 -> V_86 ) ||
F_286 ( V_21 , V_511 ,
! ! ( V_50 -> V_43 & V_364 ) ) ||
F_286 ( V_21 , V_512 ,
! ! ( V_50 -> V_43 & V_346 ) ) ||
...
! ! ( V_50 -> V_43 & V_151 ) ) )
goto V_81;
if ( F_39 ( V_21 , V_453 , sizeof( V_522 ) , & V_522 ) )
goto V_81;
if ( V_50 -> V_43 & V_224 &&
F_287 ( V_21 , V_516 ) )
goto V_81;
...
F_280 ( V_50 -> V_75 , & V_523 ) ;
}
F_291 ( & V_523 ) ;
}
static int F_292 ( struct V_524 * V_525 ,
unsigned long V_526 , void * V_527 )
{
struct V_106 * V_75 = F_293 ( V_527 ) ;
