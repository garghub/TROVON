...
static int T_3 F_29 ( struct V_59 * V_9 )
{
...
{
struct V_59 * V_62 = V_61 -> V_9 . V_63 ;
struct V_64 * V_65 ;
struct V_3 * V_4 ;
int V_66 = 0 ;
int V_67 = 0 ;
...
V_4 = F_34 ( & V_61 -> V_9 , sizeof( * V_4 ) , V_70 ) ;
if ( ! V_4 ) {
F_35 ( V_65 ) ;
F_8 ( & V_61 -> V_9 , L_8 ) ;
return - V_71 ;
...
F_39 ( & V_4 -> V_46 ) ;
error = F_40 ( & V_61 -> V_9 , V_4 -> V_1 , NULL ,
F_1 ,
V_72 ,
L_17 , V_4 ) ;
if ( error ) {
F_8 ( V_4 -> V_9 , L_18 , error ) ;
return error ;
}
V_4 -> V_16 [ 0 ] . V_73 = L_19 ;
V_4 -> V_16 [ 1 ] . V_73 = L_20 ;
error = F_41 ( V_62 ,
F_7 ( V_4 -> V_16 ) ,
V_4 -> V_16 ) ;
if ( error ) {
F_8 ( V_4 -> V_9 , L_21 , error ) ;
return error ;
}
if ( V_66 ) {
error = F_42 ( V_4 -> V_16 [ 0 ] . V_34 ,
V_66 , V_66 ) ;
if ( error ) {
F_8 ( V_4 -> V_9 , L_22 ,
error ) ;
...
F_45 ( V_4 -> V_47 , V_4 ) ;
V_4 -> V_47 -> V_74 = L_25 ;
V_4 -> V_47 -> V_75 . V_76 = 1 ;
V_4 -> V_47 -> V_9 . V_63 = V_61 -> V_9 . V_63 ;
V_4 -> V_47 -> V_77 = F_27 ;
F_46 ( V_78 , V_4 -> V_47 -> V_79 ) ;
error = F_47 ( V_4 -> V_47 , NULL , F_22 ) ;
if ( error ) {
F_8 ( V_4 -> V_9 , L_26 ) ;
return error ;
}
