...
if ( ! V_23 )
goto V_27;
V_68 = F_95 ( & V_155 , & V_154 , & V_156 ) ;
if ( V_68 )
goto V_27;
for ( V_125 = 0 ; V_125 < V_155 ; V_125 ++ ) {
V_68 = - V_25 ;
V_143 = F_96 ( V_150 , V_154 [ V_125 ] ) ;
if ( ! V_143 )
goto V_27;
V_68 = - V_25 ;
V_40 = F_85 ( V_150 -> V_157 , V_158 | V_159 | V_160 ) ;
if ( ! V_40 )
goto V_27;
V_68 = - V_161 ;
...
static T_3 F_99 ( struct V_14 * V_15 , char T_4 * V_16 ,
T_5 V_17 , T_6 * V_18 )
{
char V_19 [ V_20 ] ;
T_3 V_21 ;
...
static T_3 F_100 ( struct V_14 * V_14 ,
const char T_4 * V_16 ,
T_5 V_17 , T_6 * V_18 )
{
char * V_23 = NULL ;
...
static T_3 F_101 ( struct V_14 * V_15 , char T_4 * V_16 ,
T_5 V_17 , T_6 * V_18 )
{
char * V_23 ;
T_3 V_21 ;
V_23 = ( char * ) F_102 ( V_29 ) ;
if ( ! V_23 )
return - V_25 ;
V_21 = F_103 ( V_23 ) ;
if ( V_21 >= 0 )
...
static struct V_171 * F_104 ( T_6 * V_172 )
{
int V_173 ;
...
continue;
* V_172 = V_173 + 1 ;
return & F_106 ( V_171 , V_173 ) ;
}
return NULL ;
}
static void * F_107 ( struct V_175 * V_176 , T_6 * V_95 )
{
T_6 V_177 = * V_95 - 1 ;
if ( * V_95 == 0 )
return V_178 ;
...
static void * F_108 ( struct V_175 * V_176 , void * V_179 , T_6 * V_95 )
{
return F_104 ( V_95 ) ;
}
static int F_109 ( struct V_175 * V_176 , void * V_179 )
{
...
F_110 ( V_176 , L_17 , V_181 ,
V_183 , V_182 , V_180 -> V_184 ,
V_180 -> V_185 , V_180 -> V_186 ) ;
}
return 0 ;
}
static void F_111 ( struct V_175 * V_176 , void * V_179 )
{ }
static int F_112 ( struct V_40 * V_40 , struct V_14 * V_14 )
{
return F_113 ( V_14 , & V_187 ) ;
}
static int F_114 ( struct V_143 * V_150 )
{
int V_125 ;
...
struct V_40 * V_40 ;
struct V_143 * V_143 ;
V_143 = F_96 ( V_150 , V_189 [ V_125 ] . V_141 ) ;
if ( ! V_143 )
return - V_25 ;
V_40 = F_85 ( V_150 -> V_157 , V_158 | V_189 [ V_125 ] . V_131 ) ;
if ( ! V_40 )
return - V_25 ;
...
static T_3 F_116 ( struct V_14 * V_14 , char T_4 * V_16 ,
T_5 V_17 , T_6 * V_18 )
{
char * V_121 ;
T_2 V_9 , V_67 ;
...
static int F_117 ( struct V_143 * V_150 )
{
int V_125 ;
for ( V_125 = 1 ; V_125 <= V_195 ; V_125 ++ ) {
struct V_40 * V_40 ;
struct V_143 * V_143 ;
V_143 = F_96 ( V_150 , F_118 ( V_125 ) ) ;
if ( ! V_143 )
return - V_25 ;
V_40 = F_85 ( V_150 -> V_157 , V_158 | V_159 ) ;
if ( ! V_40 )
return - V_25 ;
V_40 -> V_166 = & V_196 ;
...
static inline unsigned long F_119 ( T_8 V_198 )
{
return ( V_198 * ( V_199 + 1 ) ) | V_200 ;
}
static inline T_8 F_120 ( unsigned long V_36 )
{
return ( V_36 & V_140 ) / ( V_199 + 1 ) ;
}
static inline unsigned long F_121 ( T_8 V_198 , T_2 V_201 )
{
return ( V_198 * ( V_199 + 1 ) + V_201 ) | V_200 ;
}
static inline T_2 F_122 ( unsigned long V_36 )
{
return ( V_36 & V_140 ) % ( V_199 + 1 ) ;
}
...
char V_202 [ V_20 ] ;
T_3 V_67 = snprintf ( V_202 , sizeof( V_202 ) , L_1 , F_120 ( V_36 ) ) ;
...
unsigned long V_36 = F_23 ( V_14 ) -> V_37 ;
char V_202 [ V_20 ] ;
T_3 V_67 = snprintf ( V_202 , sizeof( V_202 ) , L_1 , F_122 ( V_36 ) ) ;
return F_10 ( V_16 , V_17 , V_18 , V_202 , V_67 ) ;
}
...
V_203 = F_126 ( V_37 & V_140 ) ;
V_21 = F_9 ( V_19 , V_20 , L_1 , V_203 ) ;
return F_10 ( V_16 , V_17 , V_18 , V_19 , V_21 ) ;
}
static int F_127 ( char * V_204 , int V_205 ,
struct V_143 * V_150 )
{
int V_125 , V_59 , V_206 ;
char * * V_6 ;
V_59 = F_128 ( V_204 , & V_6 , & V_206 ) ;
if ( V_59 )
return V_59 ;
...
static int F_129 ( char * V_208 , int V_139 ,
struct V_143 * V_150 )
{
struct V_143 * V_143 = NULL ;
struct V_40 * V_40 = NULL ;
int V_59 ;
V_143 = F_96 ( V_150 , L_21 ) ;
if ( ! V_143 )
return - V_25 ;
V_40 = F_85 ( V_150 -> V_157 , V_158 | V_159 ) ;
if ( ! V_40 )
return - V_25 ;
V_40 -> V_166 = & V_209 ;
V_40 -> V_37 = F_119 ( V_139 ) ;
F_98 ( V_143 , V_40 ) ;
V_143 = F_130 ( V_150 , L_22 , & V_210 ) ;
if ( F_71 ( V_143 ) )
return F_72 ( V_143 ) ;
V_59 = F_127 ( V_208 , V_139 , V_143 ) ;
return V_59 ;
}
...
char * * V_212 ;
F_92 ( V_213 ) ;
V_59 = F_131 ( & V_212 , & V_211 ) ;
if ( V_59 )
return V_59 ;
V_210 = F_119 ( V_211 + 2 ) ;
for ( V_125 = 0 ; V_125 < V_211 ; V_125 ++ ) {
struct V_143 * V_214 ;
V_214 = F_130 ( V_213 , V_212 [ V_125 ] ,
& V_210 ) ;
if ( F_71 ( V_214 ) ) {
V_59 = F_72 ( V_214 ) ;
goto V_27;
}
V_59 = F_129 ( V_212 [ V_125 ] , V_125 + 1 ,
V_214 ) ;
if ( V_59 )
goto V_27;
}
...
V_143 = F_96 ( V_216 , L_23 ) ;
if ( V_143 == NULL )
return - V_25 ;
V_40 = F_85 ( V_216 -> V_157 , V_158 | V_159 ) ;
if ( V_40 == NULL )
return - V_25 ;
V_40 -> V_166 = & V_219 ;
...
static struct V_143 * F_130 ( struct V_143 * V_150 , const char * V_141 ,
unsigned long * V_36 )
{
struct V_143 * V_143 = F_96 ( V_150 , V_141 ) ;
struct V_40 * V_40 ;
if ( ! V_143 )
return F_132 ( - V_25 ) ;
V_40 = F_85 ( V_150 -> V_157 , V_221 | V_159 | V_222 ) ;
if ( ! V_40 ) {
F_133 ( V_143 ) ;
return F_132 ( - V_25 ) ;
}
...
static int F_136 ( struct V_129 * V_130 , void * V_66 , int V_226 )
{
int V_68 ;
struct V_143 * V_143 ;
struct V_40 * V_40 ;
...
V_68 = F_137 ( V_130 , V_257 , V_227 ) ;
if ( V_68 )
goto V_62;
V_151 = F_130 ( V_130 -> V_258 , V_162 , & V_194 ) ;
if ( F_71 ( V_151 ) ) {
V_68 = F_72 ( V_151 ) ;
V_151 = NULL ;
goto V_62;
...
V_68 = - V_25 ;
V_143 = F_96 ( V_130 -> V_258 , V_259 ) ;
if ( ! V_143 )
goto V_62;
V_68 = - V_25 ;
V_40 = F_85 ( V_130 , V_260 | V_159 | V_235 ) ;
if ( ! V_40 )
goto V_62;
V_40 -> V_37 = ++ V_194 ;
V_153 = (struct V_152 * ) V_40 -> V_163 ;
...
V_153 -> V_262 = V_263 ;
V_153 -> V_165 = 1 ;
F_138 ( V_40 , V_260 | V_159 | V_235 , F_139 ( V_264 , 3 ) ) ;
F_98 ( V_143 , V_40 ) ;
V_265 . V_143 = V_143 ;
V_143 = F_130 ( V_130 -> V_258 , L_42 , & V_194 ) ;
if ( F_71 ( V_143 ) ) {
V_68 = F_72 ( V_143 ) ;
goto V_62;
}
...
if ( V_68 )
goto V_62;
V_143 = F_130 ( V_130 -> V_258 , L_43 , & V_194 ) ;
if ( F_71 ( V_143 ) ) {
V_68 = F_72 ( V_143 ) ;
goto V_62;
}
...
if ( V_68 )
goto V_62;
V_213 = F_130 ( V_130 -> V_258 , L_44 , & V_194 ) ;
if ( F_71 ( V_213 ) ) {
V_68 = F_72 ( V_213 ) ;
V_213 = NULL ;
goto V_62;
}
V_216 = F_130 ( V_130 -> V_258 , L_45 , & V_194 ) ;
if ( F_71 ( V_216 ) ) {
V_68 = F_72 ( V_216 ) ;
V_216 = NULL ;
goto V_62;
...
static struct V_143 * F_140 ( struct V_266 * V_267 ,
int V_73 , const char * V_268 , void * V_66 )
{
return F_141 ( V_267 , V_73 , V_66 , F_136 ) ;
}
