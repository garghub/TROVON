...
V_9 = (struct V_8 * ) V_6 ;
V_7 = F_4 ( V_9 -> V_20 . V_16 ) ;
if ( V_5 < V_7 + sizeof( V_9 -> V_20 ) )
break;
switch ( F_4 ( V_9 -> V_20 . type ) ) {
case V_21 :
V_2 -> V_22 = true ;
break;
case V_23 :
...
V_4 = (struct V_36 * )
( V_18 -> V_44 + V_45 ) ;
if ( F_4 ( V_4 -> type ) == V_46 ) {
V_16 = - 1 ;
if ( F_9 ( V_4 -> V_47 ) )
V_16 = 0 ;
else if ( F_10 ( V_4 -> V_47 ) )
V_16 = V_48 ;
if ( V_16 != - 1 ) {
...
( T_1 * ) & V_4 -> V_47 ;
V_35 . V_50 =
F_4 ( V_4 -> V_16 ) - ( T_2 ) V_16 ;
}
}
F_11 ( V_2 -> V_51 , V_4 -> V_52 , & V_35 ,
V_53 ) ;
V_38 = F_12 ( V_2 , V_4 -> V_52 ) ;
if ( ! V_38 ) {
F_5 ( V_18 , ERROR ,
L_4 ) ;
return - 1 ;
...
F_5 ( V_18 , V_28 ,
L_5 , V_32 ) ;
memcpy ( V_2 -> V_51 -> V_66 , V_18 -> V_44 + 2 ,
V_48 ) ;
if ( V_2 -> V_67 )
F_26 ( V_2 ) ;
F_1 ( V_2 , V_18 -> V_68 ) ;
...
break;
case V_70 :
V_42 = F_4 ( * ( V_71 * ) V_18 -> V_44 ) ;
F_5 ( V_18 , V_28 ,
L_6 , V_42 ) ;
if ( V_2 -> V_63 ) {
V_18 -> V_72 =
F_27 ( T_2 , V_18 -> V_73 , V_42 ) ;
F_5 ( V_18 , V_28 ,
L_7 ,
V_18 -> V_72 ) ;
}
