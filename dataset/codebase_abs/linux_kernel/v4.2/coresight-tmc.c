...
{
struct V_1 * V_2 = F_21 ( V_49 -> V_6 . V_50 ) ;
return F_14 ( V_2 , V_16 ) ;
}
static int F_22 ( struct V_48 * V_49 , int V_51 ,
int V_52 )
{
struct V_1 * V_2 = F_21 ( V_49 -> V_6 . V_50 ) ;
...
T_1 V_57 ;
int V_58 ;
V_54 = F_24 ( F_5 ( V_2 -> V_3 + V_59 ) , 8 , 10 ) ;
if ( V_54 == V_60 )
V_55 = 1 ;
else if ( V_54 == V_61 )
V_55 = 2 ;
...
static void F_32 ( struct V_48 * V_49 , int V_51 ,
int V_52 )
{
struct V_1 * V_2 = F_21 ( V_49 -> V_6 . V_50 ) ;
F_30 ( V_2 , V_36 ) ;
...
V_67:
F_37 ( V_71 , V_72 ) ;
F_38 ( V_2 -> V_6 , L_6 , V_76 ) ;
return 0 ;
}
static T_3 F_39 ( struct V_72 * V_72 , char T_4 * V_77 , T_5 V_78 ,
T_6 * V_79 )
{
struct V_1 * V_2 = F_36 ( V_72 -> V_73 ,
struct V_1 , V_74 ) ;
...
if ( F_40 ( V_77 , V_56 , V_78 ) ) {
F_38 ( V_2 -> V_6 , L_7 , V_76 ) ;
return - V_80 ;
}
* V_79 += V_78 ;
F_38 ( V_2 -> V_6 , L_8 ,
...
static int F_41 ( struct V_71 * V_71 , struct V_72 * V_72 )
{
struct V_1 * V_2 = F_36 ( V_72 -> V_73 ,
struct V_1 , V_74 ) ;
if ( -- V_2 -> V_75 ) {
...
F_34 ( V_2 ) ;
V_67:
F_38 ( V_2 -> V_6 , L_10 , V_76 ) ;
return 0 ;
}
static T_3 F_42 ( struct V_81 * V_6 ,
