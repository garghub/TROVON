...
V_31 = F_83 ( V_2 , 1 << V_133 , V_149 ) ;
if ( V_31 == - V_150 )
F_84 ( V_2 ) ;
if ( V_31 )
return V_31 ;
V_4 = F_85 ( V_8 , sizeof( * V_4 ) , V_151 ) ;
if ( ! V_4 )
return - V_152 ;
V_4 -> V_10 |= ( unsigned long ) V_130 . V_16 ;
if ( V_128 == V_153 &&
( V_2 -> V_154 == 0xa1 || V_2 -> V_154 == 0xa2 ) )
V_4 -> V_10 |= V_117 ;
if ( V_128 == V_155 && V_2 -> V_154 >= 0x40 )
V_4 -> V_10 &= ~ V_156 ;
if ( F_52 ( V_2 ) )
V_4 -> V_10 &= ~ V_157 ;
V_4 -> V_57 = F_86 ( V_2 ) [ V_133 ] ;
if ( F_61 ( V_2 ) )
V_4 -> V_10 |= V_158 ;
F_1 ( V_2 , V_4 ) ;
if ( V_4 -> V_159 & V_160 ) {
...
V_111 = F_88 ( F_89 ( V_4 -> V_159 ) , F_90 ( V_4 -> V_18 ) ) ;
V_14 = F_91 ( & V_2 -> V_8 , V_132 , V_111 ) ;
if ( ! V_14 )
return - V_152 ;
V_14 -> V_16 = V_4 ;
F_75 ( V_2 , V_111 , V_4 ) ;
if ( ! ( V_4 -> V_159 & V_169 ) || V_170 )
V_14 -> V_10 |= V_171 ;
else
F_2 ( & V_2 -> V_8 , L_64 ) ;
if ( V_130 . V_10 & V_172 )
...
for ( V_49 = 0 ; V_49 < V_14 -> V_111 ; V_49 ++ ) {
struct V_28 * V_29 = V_14 -> V_84 [ V_49 ] ;
F_93 ( V_29 , V_133 , - 1 , L_65 ) ;
F_93 ( V_29 , V_133 ,
0x100 + V_29 -> V_53 * 0x80 , L_66 ) ;
if ( V_29 -> V_10 & V_172 )
V_29 -> V_173 = V_4 -> V_174 ;
if ( ! ( V_4 -> V_18 & ( 1 << V_49 ) ) )
V_29 -> V_85 = & V_175 ;
}
F_45 ( V_14 ) ;
F_64 ( V_14 ) ;
V_31 = F_39 ( V_2 , V_4 -> V_159 & V_176 ) ;
if ( V_31 )
return V_31 ;
V_31 = F_4 ( V_14 ) ;
if ( V_31 )
