...
F_29 ( V_10 , V_35 ) ;
if ( F_30 ( V_35 , & V_44 ) )
F_31 ( V_10 , 0 , 0 , NULL , V_44 ) ;
F_17 ( V_39 , V_32 ) ;
V_42 = F_32 ( & V_35 -> V_10 . V_52 , & V_10 -> V_52 ,
V_39 ) ;
if ( V_42 )
F_33 ( & V_35 -> V_10 , L_7 ,
V_39 , V_42 ) ;
V_42 = F_32 ( & V_10 -> V_52 , & V_35 -> V_10 . V_52 ,
L_8 ) ;
if ( V_42 )
F_33 ( V_10 , L_9 ,
V_42 ) ;
F_25 ( & V_35 -> V_48 ) ;
if ( V_35 -> V_53 . V_54 . V_55 )
F_34 ( V_10 , true ) ;
return 0 ;
V_47:
F_29 ( V_10 , NULL ) ;
...
if ( type && type -> V_59 )
type -> V_59 ( V_10 ) ;
else if ( V_14 -> V_60 && V_14 -> V_60 -> V_61 )
V_14 -> V_60 -> V_61 ( V_10 ) ;
V_58:
#if V_62
if ( ! V_12 ) {
struct V_63 V_64 = { V_65 , NULL } ;
F_41 ( F_42 ( V_10 ) , V_66 , & V_64 ) ;
F_39 ( L_11 , F_40 ( V_10 ) , ( char * ) V_64 . V_67 ) ;
F_26 ( V_64 . V_67 ) ;
} else
F_39 ( L_12 , F_40 ( V_10 ) ) ;
#endif
...
if ( type && type -> V_68 )
type -> V_68 ( V_10 ) ;
else if ( V_14 -> V_60 && V_14 -> V_60 -> V_69 )
V_14 -> V_60 -> V_69 ( V_10 ) ;
F_35 ( V_10 ) ;
return 0 ;
}
