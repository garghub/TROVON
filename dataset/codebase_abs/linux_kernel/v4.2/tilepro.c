...
{
struct V_163 * V_164 =
F_101 ( V_162 , struct V_163 , V_108 ) ;
struct V_58 * V_59 =
F_101 ( V_164 , struct V_58 , V_165 ) ;
if ( F_91 ( V_59 -> V_39 ) != 0 )
F_102 ( & V_59 -> V_165 ,
V_166 ) ;
else
...
F_105 ( & V_59 -> V_132 , V_169 ) ;
V_9 = F_106 ( & V_59 -> V_132 ) ;
V_167 = F_107 ( 16 , ( V_159 / V_9 ) & ~ 1 ) ;
...
static unsigned int F_114 ( T_13 * V_172 ,
struct V_35 * V_36 ,
void * V_173 , unsigned int V_174 )
{
unsigned int V_2 , V_53 = 0 ;
struct V_175 * V_176 = F_115 ( V_36 ) ;
V_80 V_177 ;
if ( V_174 != 0 ) {
if ( ! V_41 )
F_116 ( V_173 , V_174 , 0 ) ;
...
unsigned long V_183 = F_117 ( F_118 ( V_182 ) ) ;
int V_180 = V_41 ;
if ( ! V_41 ) {
void * V_25 = F_119 ( V_183 ) + V_182 -> V_184 ;
F_16 ( F_120 ( F_118 ( V_182 ) ) ) ;
F_116 ( V_25 , F_121 ( V_182 ) , 0 ) ;
}
V_177 = ( ( V_80 ) V_183 << V_185 ) + V_182 -> V_184 ;
V_172 [ V_53 ] . V_178 = V_177 ;
V_172 [ V_53 ] . V_179 = V_177 >> 32 ;
V_172 [ V_53 ] . V_6 = F_121 ( V_182 ) ;
...
struct V_186 * V_187 = F_123 ( V_36 ) ;
unsigned int V_188 = V_187 -> V_189 * 4 ;
unsigned char * V_190 = F_124 ( V_36 ) ;
...
unsigned int V_174 = F_125 ( V_36 ) - V_196 ;
...
unsigned int V_206 =
F_114 ( V_205 -> V_172 , V_36 , V_5 + V_196 , V_174 ) ;
T_16 V_207 = F_126 ( V_206 , V_196 ) ;
T_15 V_208 = {
. V_209 = true ,
. V_210 = V_196 ,
. V_211 = V_191 ,
...
F_128 ( & V_49 -> V_217 ) ;
F_98 () ;
F_129 ( & V_59 -> V_63 , V_214 ) ;
if ( F_130 ( V_49 ) == 0 ) {
V_215 = F_27 ( V_49 , V_60 , V_61 , 0 ) ;
if ( V_215 == 0 ) {
V_223:
F_131 ( & V_59 -> V_63 , V_214 ) ;
return V_224 ;
}
}
V_216 = V_49 -> V_216 ;
...
V_206 = F_114 ( V_172 , V_36 , V_5 , F_125 ( V_36 ) ) ;
for ( V_2 = 0 ; V_2 < V_206 ; V_2 ++ ) {
bool V_234 = ( V_2 == V_206 - 1 ) ;
V_232 V_205 = {
...
V_205 . V_237 = 1 ;
V_205 . V_238 . V_239 . V_240 = V_230 ;
V_205 . V_238 . V_239 . V_9 = V_3 - V_230 ;
V_205 . V_238 . V_239 . V_241 =
V_230 + V_36 -> V_242 ;
}
V_226 [ V_2 ] = V_205 ;
}
...
F_49 ( & V_85 -> V_98 ) ;
V_85 -> V_227 ++ ;
V_85 -> V_228 += ( ( V_3 >= V_243 ) ? V_3 : V_243 ) ;
F_54 ( & V_85 -> V_98 ) ;
F_34 ( V_16 ) ;
return V_229 ;
}
...
static int F_137 ( struct V_56 * V_39 , struct V_244 * V_245 , int V_205 )
{
return - V_246 ;
}
static struct V_247 * F_138 ( struct V_56 * V_39 ,
struct V_247 * V_85 )
{
struct V_58 * V_59 = F_30 ( V_39 ) ;
...
F_85 (i) {
struct V_84 * V_248 ;
T_17 V_249 , V_250 , V_251 , V_252 ;
T_17 V_253 , V_254 ;
unsigned int V_255 ;
if ( V_59 -> V_82 [ V_2 ] == NULL )
continue;
V_248 = & V_59 -> V_82 [ V_2 ] -> V_85 ;
do {
V_255 = F_139 ( & V_248 -> V_98 ) ;
V_249 = V_248 -> V_104 ;
V_250 = V_248 -> V_227 ;
V_251 = V_248 -> V_105 ;
V_252 = V_248 -> V_228 ;
...
static int F_141 ( struct V_56 * V_39 , int V_256 )
{
F_74 ( L_39 ) ;
if ( ( V_256 < 68 ) || ( V_256 > 1500 ) )
return - V_257 ;
V_39 -> V_258 = V_256 ;
return 0 ;
}
static int F_142 ( struct V_56 * V_39 , void * V_259 )
{
struct V_260 * V_261 = V_259 ;
if ( ! F_143 ( V_261 -> V_262 ) )
return - V_263 ;
memcpy ( V_39 -> V_97 , V_261 -> V_262 , V_39 -> V_264 ) ;
return 0 ;
}
...
char V_265 [ 32 ] ;
int V_3 ;
T_18 V_266 = { . V_79 = V_267 } ;
int V_115 ;
strcpy ( V_265 , V_39 -> V_137 ) ;
V_3 = strlen ( V_265 ) ;
V_265 [ V_3 ] = V_265 [ V_3 - 1 ] ;
V_265 [ V_3 - 1 ] = '/' ;
V_3 ++ ;
strcpy ( V_265 + V_3 , V_41 ? L_40 : L_41 ) ;
V_59 -> V_118 = F_145 ( ( V_119 ) V_265 , 0 ) ;
F_74 ( L_42 ,
V_265 , V_59 -> V_118 , & V_59 -> V_118 ) ;
if ( V_59 -> V_118 < 0 ) {
if ( V_59 -> V_118 == V_268 )
F_79 ( V_145 L_43 ,
V_265 ) ;
...
V_266 . V_239 . V_269 = V_270 ;
V_266 . V_239 . V_261 = V_271 ;
V_115 = F_63 ( V_59 -> V_118 , 0 ,
( V_119 ) V_39 -> V_97 , V_39 -> V_264 ,
V_266 . V_79 ) ;
F_74 ( L_45 , V_115 ) ;
if ( V_115 <= 0 ) {
F_79 ( V_145 L_46 ,
...
static struct V_56 * F_150 ( const char * V_137 )
{
int V_115 ;
struct V_56 * V_39 ;
struct V_58 * V_59 ;
V_39 = F_151 ( sizeof( * V_59 ) , V_137 , V_285 ,
F_148 ) ;
if ( ! V_39 ) {
F_64 ( L_47 , V_137 ) ;
return NULL ;
...
V_59 -> V_39 = V_39 ;
F_152 ( & V_59 -> V_165 , F_100 ) ;
F_153 ( & V_59 -> V_63 ) ;
V_59 -> V_123 = F_154 ( V_286 | V_287 , V_124 ) ;
if ( ! V_59 -> V_123 ) {
F_155 ( V_39 ) ;
return NULL ;
}
V_59 -> V_49 = F_156 ( V_59 -> V_123 ) ;
V_115 = F_157 ( V_39 ) ;
if ( V_115 ) {
F_64 ( L_48 , V_39 -> V_137 , V_115 ) ;
F_158 ( V_59 -> V_123 , V_124 ) ;
F_155 ( V_39 ) ;
return NULL ;
}
V_115 = F_144 ( V_39 ) ;
...
static int T_20 F_162 ( char * V_290 )
{
int V_291 = F_163 ( V_290 , & V_132 ) ;
if ( V_291 != 0 ) {
F_71 ( L_50 , V_290 ) ;
} else {
F_164 ( & V_132 , & V_132 ,
