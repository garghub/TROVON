...
T_3 V_24 ;
F_6 ( L_21 , V_20 -> V_77 ) ;
V_74 = F_2 ( V_20 , L_22 , & V_6 ) ;
if ( V_74 == NULL || V_6 != 8 ) {
F_7 ( V_78 L_23 ,
V_20 -> V_77 ) ;
return;
}
V_75 = F_2 ( V_20 , L_24 , & V_6 ) ;
if ( V_75 == NULL ) {
F_7 ( V_78 L_25 ,
V_20 -> V_77 ) ;
return;
}
V_40 = F_25 ( F_18 ( V_22 -> V_40 ) ,
F_3 ( V_74 , 1 ) ) ;
if ( ! V_40 ) {
V_40 = F_26 ( V_22 -> V_40 , V_22 ,
F_3 ( V_74 , 1 ) ) ;
if ( ! V_40 ) {
F_7 ( V_37 L_26 ,
V_20 -> V_77 ) ;
...
V_40 -> V_79 = V_22 -> V_40 -> V_50 ;
F_27 ( V_40 , F_3 ( V_74 , 1 ) ,
F_3 ( V_74 + 1 , 1 ) ) ;
V_40 -> V_80 = 0 ;
V_28 = & V_22 -> V_27 [ V_81 ] ;
for ( V_30 = 0 ; V_30 < V_82 - V_81 ; ++ V_30 ) {
V_28 -> V_9 = 0 ;
V_40 -> V_27 [ V_30 ] = V_28 ;
++ V_28 ;
}
V_30 = 1 ;
for (; V_6 >= 32 ; V_6 -= 32 , V_75 += 8 ) {
V_9 = F_4 ( F_3 ( V_75 , 1 ) , 1 ) ;
V_24 = F_3 ( & V_75 [ 6 ] , 2 ) ;
if ( V_9 == 0 || V_24 == 0 )
continue;
if ( V_9 & V_17 ) {
...
static struct V_21 * F_31 ( struct V_41 * V_40 ,
struct V_1 * V_87 )
{
...
int V_89 , V_42 ;
#ifdef F_32
struct V_90 * V_91 = F_33 ( F_34 ( V_87 ) ) ;
#endif
F_6 ( L_33 , V_87 -> V_77 ) ;
if ( ! F_35 ( V_87 ) )
return NULL ;
V_88 = F_2 ( V_87 , L_34 , & V_89 ) ;
if ( V_88 == NULL || V_89 < 20 )
return NULL ;
V_42 = ( F_3 ( V_88 , 1 ) >> 8 ) & 0xff ;
V_22 = F_36 ( V_40 , V_42 ) ;
if ( V_22 ) {
F_37 ( V_22 ) ;
return V_22 ;
...
#ifdef F_32
if ( V_91 && ( V_91 -> V_76 & V_92 ) )
return NULL ;
#endif
V_22 = F_10 ( V_87 , V_40 , V_42 ) ;
if ( ! V_22 )
return NULL ;
F_6 ( L_35 , V_22 -> V_64 ) ;
return V_22 ;
}
static void F_38 ( struct V_1 * V_20 , struct V_41 * V_40 ,
int V_93 )
{
struct V_1 * V_94 ;
struct V_21 * V_22 ;
...
void F_29 ( struct V_1 * V_20 , struct V_41 * V_40 )
{
F_38 ( V_20 , V_40 , 0 ) ;
}
void F_43 ( struct V_1 * V_20 , struct V_41 * V_40 )
{
F_38 ( V_20 , V_40 , 1 ) ;
}
