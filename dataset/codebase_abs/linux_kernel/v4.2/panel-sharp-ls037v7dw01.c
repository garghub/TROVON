...
{
struct V_3 * V_4 = F_21 ( V_38 ) ;
struct V_52 * V_53 = V_38 -> V_29 . V_54 ;
struct V_1 * V_5 ;
int V_6 ;
V_4 -> V_16 = F_28 ( & V_38 -> V_29 , L_7 ) ;
if ( F_18 ( V_4 -> V_16 ) ) {
F_24 ( & V_38 -> V_29 , L_8 ) ;
...
struct V_1 * V_2 ;
int V_6 ;
V_4 = F_31 ( & V_38 -> V_29 , sizeof( * V_4 ) , V_55 ) ;
if ( V_4 == NULL )
return - V_56 ;
F_32 ( V_38 , V_4 ) ;
if ( F_22 ( & V_38 -> V_29 ) ) {
...
static int T_1 F_35 ( struct V_37 * V_38 )
{
struct V_3 * V_4 = F_21 ( V_38 ) ;
