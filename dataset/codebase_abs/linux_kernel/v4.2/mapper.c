...
int V_100 , int V_13 , int * V_51 , int V_101 ,
const T_1 * V_66 , int V_67 ,
int * V_102 )
{
int V_103 ;
int * V_104 = V_102 ;
int * V_105 = V_102 + V_101 ;
int * V_106 = V_102 + V_101 * 2 ;
int V_77 ;
int * V_29 ;
int V_107 = 0 ;
int * V_108 ;
...
V_29 = V_104 ;
V_108 = V_105 ;
for ( V_113 = 0 ; V_113 < V_112 -> V_121 ; V_113 ++ ) {
int V_122 = 0 ;
struct V_123 * V_124 = & V_112 -> V_125 [ V_113 ] ;
switch ( V_124 -> V_126 ) {
case V_127 :
if ( ( V_124 -> V_128 >= 0 &&
V_124 -> V_128 < V_2 -> V_91 ) ||
( - 1 - V_124 -> V_128 < V_2 -> V_93 &&
V_2 -> V_92 [ - 1 - V_124 -> V_128 ] ) ) {
V_29 [ 0 ] = V_124 -> V_128 ;
V_107 = 1 ;
} else {
F_3 ( L_29 , V_124 -> V_128 ) ;
}
break;
case V_129 :
if ( V_124 -> V_128 > 0 )
...
if ( V_77 )
memcpy ( V_108 , V_106 , V_109 * sizeof( * V_108 ) ) ;
V_110 = V_108 ;
V_108 = V_29 ;
V_29 = V_110 ;
V_107 = V_109 ;
break;
case V_140 :
for ( V_5 = 0 ; V_5 < V_107 && V_103 < V_101 ; V_5 ++ ) {
V_51 [ V_103 ] = V_29 [ V_5 ] ;
V_103 ++ ;
}
V_107 = 0 ;
