...
V_66 < V_6 -> V_10 ;
V_66 = F_52 ( & V_6 -> V_9 , V_6 -> V_10 , V_66 + 1 ) ) {
V_65 = F_53 ( V_12 , V_62 + V_66 ) ;
V_63 ( V_65 , V_42 , V_51 ) ;
}
V_62 += ( 1 << V_2 -> V_38 ) ;
}
}
void F_55 ( struct V_11 * V_12 , T_3 * V_63 ,
void * V_69 )
{
if ( V_12 -> V_52 )
F_54 ( V_12 , & V_12 -> V_28 , 0 , V_63 , V_69 , true ) ;
F_54 ( V_12 , & V_12 -> V_13 , V_12 -> V_52 , V_63 , V_69 ,
false ) ;
}
void F_56 ( struct V_18 * V_19 , T_2 * V_63 ,
void * V_69 )
{
struct V_11 * V_12 = V_19 -> V_12 ;
if ( V_12 -> V_52 )
...
int V_3 ;
for ( V_3 = 0 ; V_3 < V_2 -> V_4 ; V_3 ++ ) {
V_2 -> V_7 [ V_3 ] . V_10 = F_60 ( V_72 , V_71 ) ;
...
static int F_61 ( struct V_1 * V_2 , unsigned int V_10 ,
int V_74 , bool V_51 )
{
int V_3 ;
V_2 -> V_38 = F_62 ( V_75 ) ;
...
V_76 = F_63 ( V_10 , V_71 ) / V_71 ;
V_2 -> V_7 = F_64 ( V_76 * sizeof( struct V_5 ) ,
V_77 , V_74 ) ;
if ( ! V_2 -> V_7 )
return - V_78 ;
V_2 -> V_4 = V_76 ;
}
V_2 -> V_26 = F_65 ( V_15 * sizeof( * V_2 -> V_26 ) , V_77 ) ;
if ( ! V_2 -> V_26 ) {
F_66 ( V_2 -> V_7 ) ;
V_2 -> V_7 = NULL ;
return - V_78 ;
...
F_68 ( & V_2 -> V_26 [ V_3 ] . V_56 , V_2 -> V_57 ) ;
}
return 0 ;
}
...
static struct V_11 * F_70 ( struct V_11 * V_12 ,
int V_74 , int V_60 )
{
unsigned int V_10 = V_12 -> V_59 - V_12 -> V_52 ;
V_12 -> V_60 = V_60 ;
if ( F_61 ( & V_12 -> V_13 , V_10 , V_74 , false ) )
goto V_79;
if ( F_61 ( & V_12 -> V_28 , V_12 -> V_52 , V_74 , true ) )
goto V_79;
return V_12 ;
V_79:
F_69 ( & V_12 -> V_13 ) ;
...
struct V_11 * F_71 ( unsigned int V_80 ,
unsigned int V_81 ,
int V_74 , int V_60 )
{
struct V_11 * V_12 ;
...
V_12 = F_64 ( sizeof( * V_12 ) , V_77 , V_74 ) ;
if ( ! V_12 )
return NULL ;
if ( ! F_73 ( & V_12 -> V_83 , V_77 ) ) {
F_66 ( V_12 ) ;
return NULL ;
}
V_12 -> V_59 = V_80 ;
V_12 -> V_52 = V_81 ;
return F_70 ( V_12 , V_74 , V_60 ) ;
}
...
void F_75 ( struct V_11 * V_12 , unsigned int * V_35 )
{
unsigned int V_10 = V_12 -> V_59 - V_12 -> V_52 ;
* V_35 = F_76 () % V_10 ;
}
int F_77 ( struct V_11 * V_12 , unsigned int V_84 )
{
V_84 -= V_12 -> V_52 ;
if ( V_84 > V_12 -> V_59 )
return - V_85 ;
...
T_4 F_78 ( struct V_64 * V_65 )
{
struct V_86 * V_47 = V_65 -> V_47 ;
struct V_18 * V_19 ;
int V_87 = 0 ;
if ( V_47 -> V_48 ) {
...
T_5 F_79 ( struct V_11 * V_12 , char * V_92 )
{
char * V_93 = V_92 ;
