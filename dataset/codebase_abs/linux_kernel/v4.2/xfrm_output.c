...
F_22 ( V_2 ) ;
V_12 = F_2 ( V_2 ) -> V_43 -> V_44 ( V_2 ) ;
if ( F_14 ( V_12 != 1 ) )
goto V_38;
if ( ! F_2 ( V_2 ) -> V_15 )
return F_23 ( V_2 ) ;
V_12 = F_24 ( F_2 ( V_2 ) -> V_43 -> V_45 ,
V_46 , V_2 -> V_47 , V_2 ,
...
static int V_48 ( struct V_49 * V_47 , struct V_1 * V_2 )
{
return F_20 ( V_2 , 1 ) ;
}
static int F_25 ( struct V_49 * V_47 , struct V_1 * V_2 )
{
struct V_1 * V_50 ;
V_50 = F_26 ( V_2 , 0 ) ;
F_19 ( V_2 ) ;
...
int F_30 ( struct V_49 * V_47 , struct V_1 * V_2 )
{
struct V_16 * V_16 = F_31 ( F_2 ( V_2 ) -> V_7 ) ;
int V_12 ;
if ( F_32 ( V_2 ) )
return F_25 ( V_47 , V_2 ) ;
if ( V_2 -> V_53 == V_54 ) {
V_12 = F_33 ( V_2 ) ;
if ( V_12 ) {
F_12 ( V_16 , V_18 ) ;
...
{
struct V_55 * V_56 ;
if ( V_14 -> V_57 . V_45 == V_58 )
V_56 = F_35 ( V_14 ,
F_36 ( F_2 ( V_2 ) -> V_43 -> V_45 ) ) ;
else
V_56 = V_14 -> V_56 ;
if ( V_56 == NULL )
return - V_59 ;
return V_56 -> V_60 -> V_61 ( V_14 , V_2 ) ;
}
void F_37 ( struct V_1 * V_2 , int V_62 )
{
unsigned int V_63 ;
struct V_64 * V_60 ;
if ( V_2 -> V_65 == F_38 ( V_66 ) )
V_63 = V_67 ;
else if ( V_2 -> V_65 == F_38 ( V_68 ) )
V_63 = V_69 ;
else
return;
V_60 = F_39 ( V_63 ) ;
