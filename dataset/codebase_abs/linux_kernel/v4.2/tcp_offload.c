...
if ( V_29 ) {
F_21 ( V_26 -> V_56 , V_2 -> V_56 ) ;
F_21 ( V_26 -> V_49 , V_2 -> V_49 ) ;
V_22 += V_2 -> V_57 ;
F_22 ( V_22 - V_26 -> V_57 ,
& V_2 -> V_56 -> V_59 ) ;
}
V_24 = F_17 ( V_25 + ( F_23 ( V_2 ) -
F_24 ( V_2 ) ) +
V_2 -> V_60 ) ;
...
struct V_1 * * F_25 ( struct V_1 * * V_61 , struct V_1 * V_2 )
{
...
goto V_73;
V_72:
V_68 = F_33 ( V_63 ) -> V_68 | F_33 ( V_63 ) -> V_74 ;
V_68 |= ( V_51 int ) ( V_65 & V_75 ) ;
V_68 |= ( V_51 int ) ( ( V_65 ^ F_32 ( V_64 ) ) &
~ ( V_75 | V_76 | V_77 ) ) ;
...
V_5 = F_3 ( V_63 ) -> V_34 ;
V_68 |= ( V_33 - 1 ) >= V_5 ;
V_68 |= ( F_18 ( V_64 -> V_4 ) + F_31 ( V_63 ) ) ^ F_18 ( V_17 -> V_4 ) ;
if ( V_68 || F_34 ( V_61 , V_2 ) ) {
V_5 = 1 ;
goto V_73;
}
V_63 = * V_61 ;
V_64 = F_9 ( V_63 ) ;
F_32 ( V_64 ) |= V_65 & ( V_76 | V_77 ) ;
V_73:
V_68 = V_33 < V_5 ;
V_68 |= ( V_51 int ) ( V_65 & ( V_80 | V_77 |
V_81 | V_82 |
V_76 ) ) ;
if ( V_63 && ( ! F_33 ( V_2 ) -> V_70 || V_68 ) )
V_62 = V_61 ;
V_31:
F_33 ( V_2 ) -> V_68 |= ( V_68 != 0 ) ;
return V_62 ;
}
...
V_2 -> V_84 = F_36 ( struct V_11 , V_18 ) ;
V_2 -> V_13 = V_14 ;
F_3 ( V_2 ) -> V_48 = F_33 ( V_2 ) -> V_85 ;
if ( V_17 -> V_58 )
F_3 ( V_2 ) -> V_36 |= V_39 ;
return 0 ;
}
static struct V_1 * * F_37 ( struct V_1 * * V_61 , struct V_1 * V_2 )
{
if ( ! F_33 ( V_2 ) -> V_68 &&
F_38 ( V_2 , V_86 ,
V_87 ) ) {
...
return F_25 ( V_61 , V_2 ) ;
}
static int F_39 ( struct V_1 * V_2 , int V_88 )
{
const struct V_15 * V_16 = F_8 ( V_2 ) ;
struct V_11 * V_17 = F_9 ( V_2 ) ;
V_17 -> V_18 = ~ F_40 ( V_2 -> V_33 - V_88 , V_16 -> V_19 ,
V_16 -> V_20 , 0 ) ;
F_3 ( V_2 ) -> V_36 |= V_37 ;
return F_35 ( V_2 ) ;
}
