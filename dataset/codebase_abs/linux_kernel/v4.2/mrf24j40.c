...
static T_4 F_41 ( int V_84 , void * V_18 )
{
struct V_1 * V_2 = V_18 ;
T_1 V_85 ;
int V_5 ;
V_5 = F_10 ( V_2 , V_86 , & V_85 ) ;
if ( V_5 )
goto V_31;
if ( V_85 & 0x1 )
F_42 ( & V_2 -> V_41 ) ;
...
int V_5 ;
T_1 V_16 ;
V_5 = F_1 ( V_2 , V_88 , 0x07 ) ;
if ( V_5 )
goto V_89;
V_5 = F_1 ( V_2 , V_90 , 0x98 ) ;
if ( V_5 )
goto V_89;
V_5 = F_1 ( V_2 , V_91 , 0x95 ) ;
if ( V_5 )
goto V_89;
V_5 = F_14 ( V_2 , V_55 , 0x03 ) ;
if ( V_5 )
goto V_89;
V_5 = F_14 ( V_2 , V_92 , 0x01 ) ;
if ( V_5 )
goto V_89;
V_5 = F_14 ( V_2 , V_93 , 0x80 ) ;
if ( V_5 )
goto V_89;
V_5 = F_14 ( V_2 , V_94 , 0x90 ) ;
if ( V_5 )
goto V_89;
V_5 = F_14 ( V_2 , V_95 , 0x80 ) ;
if ( V_5 )
goto V_89;
V_5 = F_14 ( V_2 , V_96 , 0x10 ) ;
if ( V_5 )
goto V_89;
V_5 = F_14 ( V_2 , V_97 , 0x21 ) ;
if ( V_5 )
goto V_89;
V_5 = F_1 ( V_2 , V_98 , 0x80 ) ;
if ( V_5 )
goto V_89;
V_5 = F_1 ( V_2 , V_99 , 0x60 ) ;
if ( V_5 )
goto V_89;
V_5 = F_1 ( V_2 , V_100 , 0x40 ) ;
if ( V_5 )
goto V_89;
...
static int F_45 ( struct V_107 * V_15 )
{
int V_5 = - V_82 ;
struct V_1 * V_2 ;
F_46 ( & V_15 -> V_108 , L_31 , V_15 -> V_84 ) ;
V_2 = F_47 ( & V_15 -> V_108 , sizeof( struct V_1 ) , V_109 ) ;
if ( ! V_2 )
goto V_89;
V_2 -> V_12 = F_47 ( & V_15 -> V_108 , 3 , V_109 ) ;
if ( ! V_2 -> V_12 )
goto V_89;
V_15 -> V_110 = V_111 ;
if ( V_15 -> V_112 > V_113 )
...
V_2 -> V_15 = V_15 ;
F_50 ( V_15 , V_2 ) ;
V_2 -> V_36 = F_51 ( 0 , & V_114 ) ;
if ( ! V_2 -> V_36 )
goto V_89;
V_2 -> V_36 -> V_39 = V_2 ;
V_2 -> V_36 -> V_115 = & V_2 -> V_15 -> V_108 ;
V_2 -> V_36 -> V_116 -> V_117 . V_118 [ 0 ] = V_119 ;
V_2 -> V_36 -> V_120 = V_121 | V_122 ;
F_22 ( F_8 ( V_2 ) , L_32 ) ;
V_5 = F_52 ( V_2 -> V_36 ) ;
if ( V_5 )
goto V_123;
...
static int F_57 ( struct V_107 * V_15 )
{
