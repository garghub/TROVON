...
V_22 -> V_196 += F_92 ( V_22 ) ;
V_22 -> V_196 += F_93 ( V_22 ) ;
}
static inline int F_94 ( const struct V_21 * V_22 , int V_223 )
{
return ! ! ( V_22 -> V_224 [ V_223 ] . V_37 & V_225 ) ;
}
static inline int F_95 ( struct V_21 * V_22 )
{
...
static void F_97 ( struct V_21 * V_22 , int V_223 )
{
struct V_227 * V_228 = V_22 -> V_224 [ V_223 ] . V_228 ;
struct V_10 * V_11 = F_4 ( F_64 ( V_22 -> V_50 ) , V_15 ) ;
if ( ! V_228 ) {
if ( V_22 -> V_86 ) {
V_228 = F_98 ( V_11 -> V_183 , F_28 ( V_22 -> V_86 ) , V_229 ) ;
} else {
V_228 = F_99 ( V_11 -> V_183 , V_230 ,
( V_231 * ) & V_22 -> V_105 ,
( V_231 * ) & V_22 -> V_104 ,
V_229 ,
V_22 -> V_232 ,
...
V_22 -> V_62 = F_96 () & ( 4096 - 1 ) ;
}
if ( ( V_22 -> V_37 & V_90 ) && ( V_22 -> V_65 != 0xffff ) ) {
V_22 -> V_65 = F_96 () & ( 4096 - 1 ) ;
}
...
static int F_109 ( struct V_243 * V_244 , struct V_21 * V_22 )
{
...
struct V_205 * V_262 ;
int V_155 ;
V_259 = V_228 -> V_234 . V_235 - F_118 ( V_244 ) ;
if ( V_259 > 0 ) {
V_155 = F_119 ( V_244 , V_259 , 0 , V_263 ) ;
if ( V_155 < 0 ) {
F_48 ( L_253 ,
V_155 ) ;
goto V_184;
...
F_120 ( V_244 , V_264 ) ;
V_155 = F_109 ( V_244 , V_22 ) ;
if ( V_155 ) {
F_48 ( L_254 , V_155 ) ;
goto V_184;
}
V_261 = (struct V_260 * ) F_121 ( V_244 , V_264 ) ;
memcpy ( V_261 , V_22 -> V_149 , 2 * V_265 ) ;
V_261 -> V_266 = V_258 ;
V_262 = F_122 ( V_244 ) ;
V_262 -> V_267 = F_123 ( V_244 -> V_120 - V_264 ) ;
F_124 ( V_262 ) ;
}
}
return 1 ;
...
static void F_126 ( V_240 * V_268 , struct V_21 * V_22 )
{
unsigned int V_60 ;
for ( V_60 = 0 ; V_60 < V_22 -> V_59 ; V_60 ++ )
...
static inline T_10 F_127 ( unsigned int V_269 , unsigned int V_270 ,
unsigned int V_271 )
{
return F_123 ( V_269 | ( V_270 << 12 ) | ( V_271 << 13 ) ) ;
}
static void F_128 ( struct V_21 * V_22 , struct V_243 * V_244 ,
int V_272 )
{
struct V_273 V_274 ;
struct V_195 * V_275 ;
V_275 = (struct V_195 * ) F_129 ( V_244 , sizeof( * V_275 ) ) ;
V_272 -= sizeof( * V_275 ) ;
if ( V_22 -> V_28 <= 0 ) {
memset ( F_129 ( V_244 , V_272 ) , 0 , V_272 ) ;
} else {
int V_276 = V_22 -> V_28 ;
int V_60 , V_120 ;
int V_277 ;
...
if ( V_120 > 0 ) {
memset ( F_129 ( V_244 , V_120 ) , 0 , V_120 ) ;
V_272 = V_276 * V_279 ;
}
V_60 = 0 ;
...
V_71 = V_22 -> V_71 ;
V_22 -> V_141 = F_132 ( V_71 , V_280 | V_281 , 0 ) ;
if ( ! V_22 -> V_141 )
break;
}
F_133 ( V_22 -> V_141 ) ;
F_134 ( V_244 , V_60 , V_22 -> V_141 ) ;
F_135 ( V_244 ) -> V_276 [ V_60 ] . V_282 = 0 ;
if ( V_60 == ( V_276 - 1 ) )
F_136 ( & F_135 ( V_244 ) -> V_276 [ V_60 ] ,
( V_272 < V_279 ? V_272 : V_279 ) ) ;
else
F_136 ( & F_135 ( V_244 ) -> V_276 [ V_60 ] , V_277 ) ;
V_272 -= F_137 ( & F_135 ( V_244 ) -> V_276 [ V_60 ] ) ;
V_244 -> V_120 += F_137 ( & F_135 ( V_244 ) -> V_276 [ V_60 ] ) ;
V_244 -> V_283 += F_137 ( & F_135 ( V_244 ) -> V_276 [ V_60 ] ) ;
V_60 ++ ;
F_135 ( V_244 ) -> V_284 = V_60 ;
}
}
...
static struct V_243 * F_139 ( struct V_168 * V_169 ,
struct V_21 * V_22 ,
unsigned int V_289 )
{
...
V_22 -> V_196 ;
if ( V_22 -> V_37 & V_91 ) {
int V_71 = V_22 -> V_71 >= 0 ? V_22 -> V_71 : F_131 () ;
V_244 = F_140 ( V_291 + V_290 , V_292 , 0 , V_71 ) ;
if ( F_85 ( V_244 ) ) {
F_141 ( V_244 , V_291 ) ;
V_244 -> V_169 = V_169 ;
}
} else {
V_244 = F_142 ( V_169 , V_290 , V_292 ) ;
}
return V_244 ;
}
static struct V_243 * F_143 ( struct V_168 * V_50 ,
struct V_21 * V_22 )
{
struct V_243 * V_244 = NULL ;
T_11 * V_261 ;
...
F_144 ( V_244 -> V_9 ) ;
F_141 ( V_244 , V_272 ) ;
V_261 = ( T_11 * ) F_121 ( V_244 , 14 ) ;
V_268 = ( V_240 * ) F_129 ( V_244 , V_22 -> V_59 * sizeof( T_7 ) ) ;
if ( V_22 -> V_59 )
F_126 ( V_268 , V_22 ) ;
if ( V_22 -> V_62 != 0xffff ) {
if ( V_22 -> V_65 != 0xffff ) {
V_298 = ( T_10 * ) F_129 ( V_244 , sizeof( T_10 ) ) ;
* V_298 = F_127 ( V_22 -> V_65 ,
V_22 -> V_67 ,
V_22 -> V_66 ) ;
V_299 = ( T_10 * ) F_129 ( V_244 , sizeof( T_10 ) ) ;
* V_299 = F_123 ( V_302 ) ;
}
V_296 = ( T_10 * ) F_129 ( V_244 , sizeof( T_10 ) ) ;
* V_296 = F_127 ( V_22 -> V_62 ,
V_22 -> V_64 ,
V_22 -> V_63 ) ;
V_297 = ( T_10 * ) F_129 ( V_244 , sizeof( T_10 ) ) ;
* V_297 = F_123 ( V_295 ) ;
}
F_145 ( V_244 , 0 ) ;
F_146 ( V_244 , V_244 -> V_120 ) ;
V_262 = (struct V_205 * ) F_129 ( V_244 , sizeof( struct V_205 ) ) ;
F_147 ( V_244 , V_244 -> V_120 ) ;
V_293 = (struct V_194 * ) F_129 ( V_244 , sizeof( struct V_194 ) ) ;
F_148 ( V_244 , V_300 ) ;
...
V_293 -> V_305 = F_123 ( V_22 -> V_107 ) ;
V_293 -> V_306 = F_123 ( V_22 -> V_106 ) ;
V_293 -> V_120 = F_123 ( V_272 + 8 ) ;
V_293 -> V_307 = 0 ;
V_262 -> V_308 = 5 ;
V_262 -> V_4 = 4 ;
V_262 -> V_309 = 32 ;
...
V_262 -> V_269 = F_123 ( V_22 -> V_313 ) ;
V_22 -> V_313 ++ ;
V_262 -> V_314 = 0 ;
V_294 = 20 + 8 + V_272 ;
V_262 -> V_267 = F_123 ( V_294 ) ;
F_124 ( V_262 ) ;
V_244 -> V_258 = V_258 ;
V_244 -> V_169 = V_50 ;
V_244 -> V_315 = V_316 ;
F_128 ( V_22 , V_244 , V_272 ) ;
if ( ! ( V_22 -> V_37 & V_79 ) ) {
V_244 -> V_317 = V_318 ;
} else if ( V_50 -> V_319 & V_320 ) {
V_244 -> V_317 = V_321 ;
V_244 -> V_322 = 0 ;
F_149 ( V_244 , V_262 -> V_311 , V_262 -> V_312 ) ;
} else {
T_13 V_322 = F_150 ( V_244 , F_151 ( V_244 ) , V_272 + 8 , 0 ) ;
V_293 -> V_307 = F_152 ( V_262 -> V_311 , V_262 -> V_312 ,
V_272 + 8 , V_310 , V_322 ) ;
if ( V_293 -> V_307 == 0 )
V_293 -> V_307 = V_323 ;
}
#ifdef F_17
if ( ! F_117 ( V_22 , V_244 , V_258 ) )
return NULL ;
#endif
return V_244 ;
}
static struct V_243 * F_153 ( struct V_168 * V_50 ,
struct V_21 * V_22 )
{
struct V_243 * V_244 = NULL ;
T_11 * V_261 ;
...
F_145 ( V_244 , 0 ) ;
F_146 ( V_244 , V_244 -> V_120 ) ;
V_262 = (struct V_193 * ) F_129 ( V_244 , sizeof( struct V_193 ) ) ;
F_147 ( V_244 , V_244 -> V_120 ) ;
V_293 = (struct V_194 * ) F_129 ( V_244 , sizeof( struct V_194 ) ) ;
F_148 ( V_244 , V_300 ) ;
V_244 -> V_304 = V_22 -> V_36 ;
...
V_244 -> V_317 = V_321 ;
V_244 -> V_330 = F_155 ( V_244 ) - V_244 -> V_331 ;
V_244 -> V_332 = F_156 ( struct V_194 , V_307 ) ;
V_293 -> V_307 = ~ F_157 ( & V_262 -> V_311 , & V_262 -> V_312 , V_324 , V_310 , 0 ) ;
} else {
T_13 V_322 = F_150 ( V_244 , F_151 ( V_244 ) , V_324 , 0 ) ;
V_293 -> V_307 = F_157 ( & V_262 -> V_311 , & V_262 -> V_312 , V_324 , V_310 , V_322 ) ;
if ( V_293 -> V_307 == 0 )
V_293 -> V_307 = V_323 ;
}
return V_244 ;
}
static struct V_243 * F_158 ( struct V_168 * V_50 ,
struct V_21 * V_22 )
{
if ( V_22 -> V_37 & V_38 )
...
static void F_159 ( struct V_153 * V_154 )
{
struct V_21 * V_22 ;
int V_334 = 0 ;
F_160 () ;
...
static int F_161 ( const struct V_153 * V_154 )
{
const struct V_21 * V_22 ;
F_44 () ;
F_45 (pkt_dev, &t->if_list, list)
...
static int F_162 ( struct V_153 * V_154 )
{
while ( F_161 ( V_154 ) ) {
F_163 ( 100 ) ;
if ( F_88 ( V_12 ) )
...
static void F_165 ( struct V_21 * V_22 , int V_284 )
{
T_14 V_338 , V_339 , V_340 ;
char * V_341 = V_22 -> V_110 ;
T_5 V_342 = F_90 ( V_22 -> V_93 ,
V_22 -> V_98 ) ;
T_5 V_25 = F_166 ( V_22 -> V_94 ) ;
...
{
int V_284 = V_22 -> V_244 ? F_135 ( V_22 -> V_244 ) -> V_284 : - 1 ;
if ( ! V_22 -> V_92 ) {
F_30 ( L_261 ,
V_22 -> V_31 ) ;
return - V_18 ;
...
static struct V_21 * F_169 ( struct V_153 * V_154 )
{
...
static void F_170 ( struct V_153 * V_154 )
{
struct V_21 * V_22 ;
F_160 () ;
F_44 () ;
...
F_160 () ;
F_172 (q, n, &t->if_list) {
V_346 = F_173 ( V_345 , struct V_21 , V_347 ) ;
if ( ! V_346 -> V_163 )
continue;
F_125 ( V_346 -> V_244 ) ;
V_346 -> V_244 = NULL ;
...
static void F_175 ( struct V_153 * V_154 )
{
struct V_344 * V_345 , * V_119 ;
struct V_21 * V_346 ;
F_160 () ;
...
{
F_177 ( V_154 -> V_348 -> V_349 , V_154 -> V_183 -> V_171 ) ;
}
...
{
T_5 V_350 = F_18 () ;
while ( F_180 ( & ( V_22 -> V_244 -> V_351 ) ) != 1 ) {
if ( F_88 ( V_12 ) )
break;
if ( F_181 () )
F_178 ( V_22 ) ;
...
struct V_243 * V_244 ;
int V_155 ;
if ( F_130 ( ! F_69 ( V_50 ) || ! F_185 ( V_50 ) ) ) {
F_168 ( V_22 ) ;
return;
}
if ( F_130 ( V_22 -> V_29 == V_135 ) ) {
...
if ( V_22 -> V_72 == V_73 ) {
V_244 = V_22 -> V_244 ;
V_244 -> V_258 = F_186 ( V_244 , V_244 -> V_169 ) ;
F_187 ( V_70 , & V_244 -> V_351 ) ;
F_188 () ;
do {
V_155 = F_189 ( V_244 ) ;
if ( V_155 == V_358 )
...
V_22 -> V_96 ++ ;
V_22 -> V_99 ++ ;
if ( F_180 ( & V_244 -> V_351 ) != V_70 ) {
F_190 ( V_70 - 1 , & V_244 -> V_351 ) ;
break;
}
#ifdef F_191
V_244 -> V_359 = 0 ;
...
V_353 = F_192 ( V_50 , V_22 -> V_244 ) ;
F_188 () ;
F_193 ( V_50 , V_353 , F_101 () ) ;
if ( F_130 ( F_194 ( V_353 ) ) ) {
V_155 = V_360 ;
V_22 -> V_143 = 0 ;
goto V_361;
}
F_187 ( V_70 , & V_22 -> V_244 -> V_351 ) ;
V_362:
V_155 = F_195 ( V_22 -> V_244 , V_50 , V_353 , -- V_70 > 0 ) ;
switch ( V_155 ) {
case V_363 :
V_22 -> V_143 = 1 ;
V_22 -> V_96 ++ ;
...
case V_367 :
case V_360 :
F_196 ( & ( V_22 -> V_244 -> V_351 ) ) ;
V_22 -> V_143 = 0 ;
}
if ( F_130 ( V_70 ) )
F_190 ( V_70 , & V_22 -> V_244 -> V_351 ) ;
V_361:
F_197 ( V_50 , V_353 ) ;
V_156:
F_198 () ;
...
F_201 ( & V_154 -> V_371 ) ;
F_202 ( & V_154 -> V_372 ) ;
F_32 ( L_264 , V_370 , F_203 ( V_12 ) ) ;
F_204 () ;
while ( ! F_205 () ) {
V_22 = F_169 ( V_154 ) ;
if ( F_130 ( ! V_22 && V_154 -> V_158 == 0 ) ) {
...
static int F_208 ( struct V_153 * V_154 ,
struct V_21 * V_22 )
{
int V_374 = 0 ;
F_209 ( V_154 ) ;
...
struct V_21 * V_22 ;
int V_184 ;
int V_71 = F_212 ( V_154 -> V_370 ) ;
V_22 = F_55 ( V_154 -> V_183 , V_160 , V_162 ) ;
if ( V_22 ) {
F_48 ( L_270 ) ;
return - V_376 ;
}
V_22 = F_213 ( sizeof( struct V_21 ) , V_280 , V_71 ) ;
if ( ! V_22 )
return - V_378 ;
strcpy ( V_22 -> V_31 , V_160 ) ;
V_22 -> V_224 = F_214 ( V_150 * sizeof( struct V_379 ) ,
V_71 ) ;
if ( V_22 -> V_224 == NULL ) {
F_215 ( V_22 ) ;
return - V_378 ;
...
static int T_15 F_218 ( int V_370 , struct V_10 * V_11 )
{
struct V_153 * V_154 ;
struct V_392 * V_393 ;
struct V_394 * V_341 ;
V_154 = F_213 ( sizeof( struct V_153 ) , V_280 ,
F_212 ( V_370 ) ) ;
if ( ! V_154 ) {
F_48 ( L_272 ) ;
return - V_378 ;
...
F_227 ( V_341 , V_370 ) ;
V_154 -> V_348 = V_341 ;
V_393 = F_61 ( V_154 -> V_348 -> V_349 , 0600 , V_11 -> V_171 ,
& V_397 , V_154 ) ;
if ( ! V_393 ) {
F_48 ( L_271 ,
V_384 , V_154 -> V_348 -> V_349 ) ;
F_228 ( V_341 ) ;
F_225 ( & V_154 -> V_395 ) ;
F_215 ( V_154 ) ;
return - V_18 ;
...
static void F_232 ( struct V_153 * V_154 ,
struct V_21 * V_22 )
{
struct V_344 * V_345 , * V_119 ;
struct V_21 * V_341 ;
F_209 ( V_154 ) ;
F_172 (q, n, &t->if_list) {
V_341 = F_173 ( V_345 , struct V_21 , V_347 ) ;
if ( V_341 == V_22 )
F_233 ( & V_341 -> V_347 ) ;
}
F_211 ( V_154 ) ;
}
static int F_174 ( struct V_153 * V_154 ,
struct V_21 * V_22 )
{
F_32 ( L_275 , V_22 ) ;
if ( V_22 -> V_92 ) {
...
static int T_15 F_235 ( struct V_183 * V_183 )
{
...
F_220 ( & V_11 -> V_396 ) ;
V_11 -> V_177 = false ;
V_11 -> V_171 = F_236 ( V_384 , V_11 -> V_183 -> V_399 ) ;
if ( ! V_11 -> V_171 ) {
F_30 ( L_277 , V_384 ) ;
return - V_185 ;
}
V_393 = F_237 ( V_400 , 0600 , V_11 -> V_171 , & V_401 ) ;
if ( V_393 == NULL ) {
F_48 ( L_278 , V_400 ) ;
V_155 = - V_18 ;
goto remove;
...
return 0 ;
V_402:
F_177 ( V_400 , V_11 -> V_171 ) ;
remove:
F_177 ( V_384 , V_11 -> V_183 -> V_399 ) ;
return V_155 ;
}
static void T_16 F_240 ( struct V_183 * V_183 )
{
struct V_10 * V_11 = F_4 ( V_183 , V_15 ) ;
struct V_153 * V_154 ;
struct V_344 * V_345 , * V_119 ;
...
V_11 -> V_177 = true ;
F_49 ( & V_157 ) ;
F_242 ( & V_11 -> V_396 , & V_347 ) ;
F_51 ( & V_157 ) ;
F_172 (q, n, &list) {
V_154 = F_173 ( V_345 , struct V_153 , V_395 ) ;
F_225 ( & V_154 -> V_395 ) ;
F_228 ( V_154 -> V_348 ) ;
F_243 ( V_154 -> V_348 ) ;
F_215 ( V_154 ) ;
