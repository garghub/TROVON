...
unsigned int V_7 = F_58 ( V_38 -> V_44 . V_59 ) ;
...
while ( V_54 + F_67 () <= V_36 ) {
if ( F_68 ( V_14 + V_54 , & V_30 ) ) {
V_54 = - V_81 ;
goto V_80;
}
V_54 += F_67 () ;
...
static int F_83 ( struct V_67 * V_59 ,
...
static int F_84 ( struct V_67 * V_59 , void T_4 * V_96 )
{
struct V_129 V_130 = {
...
static int F_88 ( struct V_67 * V_59 , void T_4 * V_96 )
{
struct V_129 V_130 ;
int error ;
...
return - V_81 ;
return F_91 ( V_59 , & V_130 ) ;
}
static int F_92 ( struct V_67 * V_59 , void T_4 * V_96 )
{
struct V_129 V_130 ;
if ( F_85 ( & V_130 , V_96 , sizeof( V_130 ) ) )
return - V_81 ;
...
static int F_95 ( struct V_67 * V_59 ,
unsigned int V_74 ,
int T_4 * V_131 )
{
...
case V_152 :
if ( F_80 ( V_96 , & V_59 -> V_53 , sizeof( struct V_153 ) ) )
return - V_81 ;
return 0 ;
case V_154 :
if ( ! F_100 ( V_155 , V_59 -> V_103 ) )
return - V_156 ;
if ( F_87 ( V_59 -> V_157 [ V_158 ] , V_131 ) )
return - V_81 ;
if ( F_87 ( V_59 -> V_157 [ V_159 ] , V_131 + 1 ) )
return - V_81 ;
return 0 ;
case V_160 :
if ( ! F_100 ( V_155 , V_59 -> V_103 ) )
...
return 0 ;
case V_161 :
return F_101 ( V_59 , ( int ) ( unsigned long ) V_96 , V_50 ) ;
case V_162 :
V_3 = F_100 ( V_123 , V_59 -> V_103 ) ?
V_59 -> V_163 -> V_164 : 0 ;
if ( F_87 ( V_3 , V_131 ) )
return - V_81 ;
return 0 ;
...
return F_12 ( V_2 , V_3 ) ;
case V_168 :
return F_84 ( V_59 , V_96 ) ;
case V_169 :
return F_89 ( V_59 , V_96 ) ;
case V_170 :
return F_88 ( V_59 , V_96 ) ;
case V_171 :
return F_92 ( V_59 , V_96 ) ;
}
V_74 = F_102 ( V_144 ) ;
#define F_103 ( T_8 ) ((nr) & ~(_IOC_SIZEMASK << _IOC_SIZESHIFT))
switch ( F_103 ( V_144 ) ) {
case F_104 ( 0 ) :
return F_78 ( V_59 -> V_172 , V_173 ,
V_74 , V_96 , V_102 ) ;
case F_105 ( 0 ) :
return F_95 ( V_59 , V_74 , V_131 ) ;
case F_106 ( 0 ) :
return F_93 ( V_2 , V_59 , V_105 , V_59 -> V_174 ,
V_107 , V_74 , V_96 , V_102 ) ;
case F_107 ( 0 ) :
return F_93 ( V_2 , V_59 , V_117 , V_59 -> V_175 ,
V_119 , V_74 , V_96 , V_102 ) ;
case F_108 ( 0 ) :
return F_93 ( V_2 , V_59 , V_120 , V_59 -> V_176 ,
V_122 , V_74 , V_96 , V_102 ) ;
case F_109 ( 0 ) :
return F_93 ( V_2 , V_59 , V_126 , V_59 -> V_177 ,
V_128 , V_74 , V_96 , V_102 ) ;
case F_110 ( 0 ) :
return F_82 ( V_59 -> V_178 , V_74 , V_96 ) ;
case F_111 ( 0 ) :
return F_82 ( V_59 -> V_179 , V_74 , V_96 ) ;
case F_112 ( 0 ) :
return F_82 ( V_59 -> V_180 , V_74 , V_96 ) ;
case F_103 ( V_181 ) :
if ( F_113 ( V_96 , V_74 , & V_147 ) )
return - V_81 ;
error = F_114 ( V_59 , & V_147 , V_50 ) ;
if ( error )
return error ;
...
V_54 = F_99 ( V_50 , V_144 , V_96 , V_102 ) ;
V_80:
F_32 ( & V_38 -> V_55 ) ;
return V_54 ;
}
...
static int F_129 ( struct V_188 * V_189 , struct V_67 * V_59 ,
...
V_192 -= V_193 ;
F_135 ( & V_38 -> V_59 , L_2 , V_192 ) ;
V_38 -> V_44 . V_59 = F_136 ( V_59 ) ;
V_38 -> V_44 . V_178 = F_137 ( & V_38 -> V_59 ) ;
V_38 -> V_44 . V_189 = V_189 ;
V_38 -> V_44 . V_45 = V_38 ;
V_38 -> V_59 . V_196 = F_138 ( V_197 , V_191 ) ;
...
error = F_142 ( & V_38 -> V_73 , V_38 -> V_59 . V_196 , 1 ) ;
if ( error )
goto V_205;
error = F_143 ( & V_38 -> V_59 ) ;
if ( error )
goto V_206;
return 0 ;
V_206:
