...
int F_41 ( struct V_1 * V_3 , int V_29 , T_2 V_49 )
{
int V_50 ;
F_16 ( F_42 () ) ;
F_43 ( & V_3 -> V_44 ) ;
V_50 = V_3 -> V_36 ( V_3 , V_29 , V_49 ) ;
F_44 ( & V_3 -> V_44 ) ;
return V_50 ;
}
int F_45 ( struct V_1 * V_3 , int V_29 , T_2 V_49 , T_3 V_51 )
{
int V_34 ;
F_16 ( F_42 () ) ;
F_43 ( & V_3 -> V_44 ) ;
V_34 = V_3 -> V_37 ( V_3 , V_29 , V_49 , V_51 ) ;
F_44 ( & V_3 -> V_44 ) ;
return V_34 ;
}
static int F_46 ( struct V_11 * V_12 , struct V_52 * V_53 )
{
struct V_26 * V_27 = F_47 ( V_12 ) ;
struct V_54 * V_55 = F_48 ( V_53 ) ;
const int V_56 = F_49 ( V_27 -> V_57 . V_58 ) ;
int V_33 ;
if ( F_50 ( V_12 , V_53 ) )
return 1 ;
if ( V_55 -> V_59 )
return V_55 -> V_59 ( V_27 ) ;
if ( V_27 -> V_60 ) {
for ( V_33 = 1 ; V_33 < V_56 ; V_33 ++ ) {
if ( ! ( V_27 -> V_57 . V_61 & ( 1 << V_33 ) ) )
continue;
...
return ( V_55 -> V_62 & V_55 -> V_63 ) ==
( V_27 -> V_62 & V_55 -> V_63 ) ;
}
}
static bool F_51 ( struct V_26 * V_27 )
{
struct V_52 * V_53 = V_27 -> V_12 . V_64 ;
struct V_54 * V_55 = F_48 ( V_53 ) ;
struct V_65 * V_66 = V_27 -> V_67 ;
if ( ! V_53 || ! V_55 -> V_68 )
return false ;
if ( ! V_66 )
return ! V_27 -> V_69 ;
if ( V_66 -> V_12 . V_40 && F_52 ( V_66 -> V_12 . V_40 ) )
return false ;
if ( F_52 ( & V_66 -> V_12 ) )
return false ;
return true ;
...
static T_4
F_61 ( struct V_11 * V_12 , struct V_74 * V_75 , char * V_76 )
{
struct V_26 * V_27 = F_47 ( V_12 ) ;
return sprintf ( V_76 , L_7 , ( unsigned long ) V_27 -> V_62 ) ;
}
static T_4
F_62 ( struct V_11 * V_12 , struct V_74 * V_75 , char * V_76 )
{
struct V_26 * V_27 = F_47 ( V_12 ) ;
...
V_77 = F_64 ( V_27 -> V_78 ) ;
return sprintf ( V_76 , L_9 , V_77 ) ;
}
static T_4
F_65 ( struct V_11 * V_12 , struct V_74 * V_75 , char * V_76 )
{
struct V_26 * V_27 = F_47 ( V_12 ) ;
return sprintf ( V_76 , L_10 , V_27 -> V_79 ) ;
}
int T_5 F_66 ( void )
{
int V_30 ;
