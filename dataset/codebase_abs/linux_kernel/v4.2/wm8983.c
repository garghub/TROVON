...
int V_74 ;
int V_67 ;
V_74 = F_6 ( V_6 , V_140 , 0 ) ;
if ( V_74 < 0 ) {
F_10 ( V_6 -> V_24 , L_18 , V_74 ) ;
return V_74 ;
}
for ( V_67 = 0 ; V_67 < F_16 ( V_141 ) ; ++ V_67 )
F_5 ( V_6 , V_141 [ V_67 ] ,
0x100 , 0x100 ) ;
for ( V_67 = V_142 ;
V_67 <= V_143 ; ++ V_67 )
...
static int F_28 ( struct V_147 * V_148 )
{
struct V_68 * V_69 ;
int V_74 ;
V_69 = F_29 ( & V_148 -> V_24 , sizeof *V_69 , V_149 ) ;
if ( ! V_69 )
return - V_150 ;
V_69 -> V_129 = F_30 ( V_148 , & V_151 ) ;
if ( F_31 ( V_69 -> V_129 ) ) {
V_74 = F_32 ( V_69 -> V_129 ) ;
F_10 ( & V_148 -> V_24 , L_19 , V_74 ) ;
return V_74 ;
}
F_33 ( V_148 , V_69 ) ;
V_74 = F_34 ( & V_148 -> V_24 ,
& V_152 , & V_153 , 1 ) ;
return V_74 ;
}
...
struct V_68 * V_69 ;
int V_74 ;
V_69 = F_29 ( & V_155 -> V_24 , sizeof *V_69 , V_149 ) ;
if ( ! V_69 )
return - V_150 ;
V_69 -> V_129 = F_38 ( V_155 , & V_151 ) ;
if ( F_31 ( V_69 -> V_129 ) ) {
V_74 = F_32 ( V_69 -> V_129 ) ;
F_10 ( & V_155 -> V_24 , L_19 , V_74 ) ;
return V_74 ;
}
F_39 ( V_155 , V_69 ) ;
V_74 = F_34 ( & V_155 -> V_24 ,
& V_152 , & V_153 , 1 ) ;
return V_74 ;
}
static int F_40 ( struct V_154 * V_158 )
{
F_36 ( & V_158 -> V_24 ) ;
return 0 ;
}
