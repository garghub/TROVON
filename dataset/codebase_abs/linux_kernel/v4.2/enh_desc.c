...
{
V_5 -> V_10 . V_107 = 0 ;
V_5 -> V_10 . V_47 . V_108 = 1 ;
V_5 -> V_10 . V_47 . V_37 = V_109 - 1 ;
if ( V_105 == V_110 )
F_11 ( V_5 , V_106 ) ;
else
F_12 ( V_5 , V_106 ) ;
if ( V_104 )
V_5 -> V_10 . V_47 . V_111 = 1 ;
}
...
{
if ( V_123 == V_124 )
return V_5 -> V_10 . V_47 . V_125 - 2 ;
else
return V_5 -> V_10 . V_47 . V_125 ;
}
...
T_3 V_130 ;
if ( V_129 ) {
struct V_45 * V_5 = (struct V_45 * ) V_128 ;
V_130 = V_5 -> V_131 ;
