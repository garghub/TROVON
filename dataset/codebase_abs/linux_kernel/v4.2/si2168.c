...
static int F_27 ( struct V_81 * V_82 , void * V_83 , T_2 V_84 )
{
struct V_1 * V_2 = V_83 ;
int V_5 ;
struct V_13 V_14 ;
...
static int F_28 ( struct V_81 * V_82 , void * V_83 , T_2 V_84 )
{
struct V_1 * V_2 = V_83 ;
int V_5 ;
struct V_13 V_14 ;
...
{
struct V_87 * V_88 = V_2 -> V_21 . V_89 ;
struct V_28 * V_21 ;
int V_5 ;
F_8 ( & V_2 -> V_21 , L_25 ) ;
V_21 = F_30 ( sizeof( * V_21 ) , V_90 ) ;
if ( ! V_21 ) {
V_5 = - V_91 ;
F_20 ( & V_2 -> V_21 , L_43 ) ;
goto V_17;
...
memcpy ( & V_21 -> V_24 . V_57 , & V_94 , sizeof( struct V_95 ) ) ;
V_21 -> V_24 . V_27 = V_2 ;
* V_88 -> V_81 = V_21 -> V_11 ;
* V_88 -> V_24 = & V_21 -> V_24 ;
V_21 -> V_76 = V_88 -> V_76 ;
