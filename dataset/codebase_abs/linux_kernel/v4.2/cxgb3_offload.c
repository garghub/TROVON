...
static int F_144 ( struct V_185 * V_90 , unsigned int V_220 ,
...
static void F_147 ( struct V_185 * V_90 )
{
F_142 ( V_90 -> V_199 ) ;
}
static inline void F_148 ( struct V_3 * V_303 )
{
F_149 ( & V_281 ) ;
F_6 ( & V_303 -> V_304 , & V_304 ) ;
F_150 ( & V_281 ) ;
}
static inline void F_151 ( struct V_3 * V_303 )
{
F_149 ( & V_281 ) ;
F_10 ( & V_303 -> V_304 ) ;
F_150 ( & V_281 ) ;
}
int F_152 ( struct V_3 * V_3 )
{
...
V_305 = F_144 ( & V_90 -> V_186 , V_121 . V_140 , V_300 ,
V_306 . V_140 , V_315 , V_306 . V_145 ) ;
if ( V_305 )
goto V_316;
V_90 -> V_150 = V_123 . V_150 ;
V_90 -> V_317 = V_123 . V_108 ;
F_154 ( & V_90 -> V_213 , F_69 ) ;
F_146 ( & V_90 -> V_214 ) ;
F_155 ( & V_90 -> V_318 ) ;
V_90 -> V_18 = V_18 ;
F_156 ( V_18 -> V_319 , V_309 ) ;
F_55 ( V_18 ) = V_90 ;
V_18 -> V_182 = F_123 ;
V_18 -> V_183 = F_130 ;
if ( F_157 ( & V_304 ) )
