...
static inline const char * F_51 ( int V_103 )
{
switch ( V_103 ) {
case V_16 :
...
static bool F_52 ( T_3 type , struct V_104 * V_105 )
{
...
struct V_104 * V_105 ;
T_1 V_2 ;
V_105 = F_54 ( sizeof( struct V_104 ) * V_4 . V_5 ) ;
V_106 = V_105 ;
for ( V_3 = 0 ; V_3 < V_4 . V_5 ; V_3 ++ ) {
...
V_105 -> V_108 = F_51 ( V_4 . V_8 [ V_3 ] . type ) ;
V_105 -> V_1 = V_4 . V_8 [ V_3 ] . V_9 ;
V_105 -> V_2 = V_2 ;
V_105 -> V_109 = V_110 ;
if ( F_52 ( V_4 . V_8 [ V_3 ] . type , V_105 ) ) {
V_105 -> V_109 |= V_111 ;
F_55 ( & V_112 , V_105 ) ;
}
V_105 ++ ;
...
struct V_6 * V_113 = & V_60 . V_8 [ V_3 ] ;
F_56 ( V_113 -> V_9 ,
V_113 -> V_9 + V_113 -> V_10 ,
F_51 ( V_113 -> type ) ) ;
}
}
static unsigned long F_57 ( V_107 V_114 )
{
unsigned long V_115 = V_114 >> 20 ;
if ( ! V_115 )
return 64 * 1024 ;
if ( V_115 < 16 )
return 1024 * 1024 ;
...
V_105 = V_106 ;
for ( V_3 = 0 ; V_3 < V_4 . V_5 ; V_3 ++ ) {
if ( ! V_105 -> V_116 && V_105 -> V_2 )
F_59 ( & V_112 , V_105 ) ;
V_105 ++ ;
}
for ( V_3 = 0 ; V_3 < V_4 . V_5 ; V_3 ++ ) {
struct V_6 * V_113 = & V_4 . V_8 [ V_3 ] ;
T_1 V_1 , V_2 ;
if ( V_113 -> type != V_15 )
continue;
V_1 = V_113 -> V_9 + V_113 -> V_10 ;
V_2 = F_60 ( V_1 , F_57 ( V_1 ) ) - 1 ;
if ( V_2 > V_117 )
V_2 = V_117 ;
if ( V_1 >= V_2 )
continue;
...
& V_50 ) ;
V_118 . V_119 = V_50 ;
if ( F_14 ( V_118 . V_120 , V_118 . V_119 )
< 0 ) {
T_1 V_93 ;
if ( V_118 . V_121
< V_118 . V_122 . V_123 ) {
V_93 = V_118 . V_122 . V_123 ;
V_24 = L_38 ;
} else {
V_93 = V_118 . V_121 ;
V_24 = L_39 ;
...
int V_3 ;
T_1 V_131 ;
F_71 (i, MAX_NUMNODES, &start_pfn, &end_pfn, NULL) {
V_89 = F_17 ( V_89 , V_132 ) ;
V_90 = F_17 ( V_90 , V_132 ) ;
V_129 += V_90 - V_89 ;
}
F_72 (u, NUMA_NO_NODE, MEMBLOCK_NONE, &start, &end,
NULL) {
V_89 = F_73 (unsigned long, PFN_UP(start), MAX_DMA_PFN) ;
V_90 = F_73 (unsigned long, PFN_DOWN(end), MAX_DMA_PFN) ;
if ( V_89 < V_90 )
V_130 += V_90 - V_89 ;
}
F_74 ( V_129 - V_130 ) ;
