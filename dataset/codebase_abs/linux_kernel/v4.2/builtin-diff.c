...
static void F_65 ( struct V_69 * V_76 )
{
int V_108 ;
for ( V_108 = 0 ; V_108 < V_109 ; V_108 ++ ) {
struct V_72 * V_71 = & V_76 -> V_71 [ V_108 ] ;
F_66 ( & V_71 -> V_63 ) ;
}
}
...
int V_4 = - V_5 , V_19 ;
F_60 (i, d) {
V_76 -> V_102 = F_68 ( & V_76 -> V_99 , false , & T_5 ) ;
if ( ! V_76 -> V_102 ) {
...
static double F_71 ( struct V_24 * V_25 )
{
T_2 V_27 = F_7 ( V_25 -> V_28 ) ;
...
double V_113 = F_71 ( V_25 ) ;
char V_114 [ 20 ] = L_27 ;
if ( ! V_25 -> V_96 ) {
F_12 ( V_114 , 20 , L_28 , V_73 -> V_115 - 1 ) ;
return F_73 ( V_112 -> V_18 , V_112 -> V_40 ,
V_114 , V_113 ) ;
} else
return F_12 ( V_112 -> V_18 , V_112 -> V_40 , L_29 ,
V_73 -> V_115 , V_114 ) ;
}
static int F_74 ( struct V_24 * V_25 , char * V_18 , T_4 V_40 )
{
double V_113 = F_71 ( V_25 ) ;
const char * V_71 = V_45 . V_116 ? L_30 : L_31 ;
int V_4 = 0 ;
if ( ! V_25 -> V_96 )
V_4 = F_12 ( V_18 , V_40 , V_71 , V_113 ) ;
return V_4 ;
}
...
V_33 = F_8 ( V_25 , V_29 ) ;
F_12 ( V_114 , 20 , L_32 , V_73 -> V_115 - 1 ) ;
return F_73 ( V_112 -> V_18 , V_112 -> V_40 ,
V_114 , V_33 ) ;
case V_49 :
if ( V_25 -> V_96 )
...
V_33 = F_9 ( V_25 , V_29 ) ;
F_12 ( V_114 , 20 , L_33 , V_73 -> V_115 ) ;
return F_76 ( V_112 -> V_18 , V_112 -> V_40 ,
V_114 , V_33 ) ;
case V_11 :
if ( V_25 -> V_96 )
goto V_119;
...
V_39 = F_10 ( V_25 , V_29 ) ;
F_12 ( V_114 , 20 , L_34 , V_73 -> V_115 ) ;
return F_77 ( V_112 -> V_18 , V_112 -> V_40 ,
F_78 ( V_39 ) ,
V_114 , V_39 ) ;
default:
F_16 ( 1 ) ;
...
struct V_111 * V_112 , struct V_24 * V_25 )
{
return F_75 ( V_71 , V_112 , V_25 , V_20 ) ;
}
static int F_80 ( struct V_70 * V_71 ,
struct V_111 * V_112 , struct V_24 * V_25 )
{
return F_75 ( V_71 , V_112 , V_25 , V_49 ) ;
}
static int F_81 ( struct V_70 * V_71 ,
struct V_111 * V_112 , struct V_24 * V_25 )
{
return F_75 ( V_71 , V_112 , V_25 , V_11 ) ;
}
static void
F_82 ( struct V_24 * V_25 , int V_75 , char * V_18 , T_4 V_40 )
{
switch ( V_75 ) {
case V_120 :
...
static void
F_83 ( struct V_24 * V_25 , struct V_24 * V_29 ,
...
if ( V_29 -> V_33 . V_35 )
V_121 = V_29 -> V_33 . V_38 ;
else
V_121 = F_9 ( V_25 , V_29 ) ;
if ( V_121 > 0.0 )
F_12 ( V_18 , V_40 , L_37 , V_121 ) ;
break;
case V_124 :
if ( V_25 -> V_96 ) {
F_12 ( V_18 , V_40 , L_35 ) ;
...
static void
F_84 ( struct V_24 * V_25 , struct V_72 * V_73 ,
char * V_18 , T_4 V_40 )
{
struct V_24 * V_29 = F_34 ( V_25 , V_73 ) ;
int V_75 = V_73 -> V_75 ;
...
if ( V_29 )
F_83 ( V_25 , V_29 , V_75 , V_18 , V_40 ) ;
else
F_82 ( V_25 , V_75 , V_18 , V_40 ) ;
}
}
static int F_85 ( struct V_70 * V_128 , struct V_111 * V_112 ,
struct V_24 * V_25 )
{
struct V_72 * V_73 =
F_30 ( V_128 , struct V_72 , V_71 ) ;
char V_18 [ V_129 ] = L_27 ;
F_84 ( V_25 , V_73 , V_18 , V_129 ) ;
if ( V_45 . V_116 )
return F_12 ( V_112 -> V_18 , V_112 -> V_40 , L_39 , V_18 ) ;
else
return F_12 ( V_112 -> V_18 , V_112 -> V_40 , L_29 ,
V_73 -> V_115 , V_18 ) ;
}
static int F_86 ( struct V_70 * V_71 , struct V_111 * V_112 ,
struct V_60 * V_61 V_14 )
{
struct V_72 * V_73 =
F_30 ( V_71 , struct V_72 , V_71 ) ;
F_16 ( ! V_73 -> V_63 ) ;
return F_12 ( V_112 -> V_18 , V_112 -> V_40 , V_73 -> V_63 ) ;
}
...
static void F_88 ( struct V_69 * V_76 , struct V_72 * V_73 )
{
#define F_89 100
char V_130 [ F_89 ] ;
char V_18 [ F_89 ] ;
...
int V_131 = 0 ;
F_16 ( V_73 -> V_75 >= V_109 ) ;
V_63 = V_132 [ V_73 -> V_75 ] . V_133 ;
V_131 = V_132 [ V_73 -> V_75 ] . V_131 ;
F_16 ( ! V_63 ) ;
if ( V_107 > 2 )
F_12 ( V_18 , F_89 , L_40 , V_63 , V_76 -> V_75 ) ;
#define F_90 (data__files_cnt > 2 ? buf : header)
V_73 -> V_115 = V_131 ;
V_131 = ( int ) strlen ( F_90 ) ;
if ( V_73 -> V_115 < V_131 )
V_73 -> V_115 = V_131 ;
F_12 ( V_130 , F_89 , L_29 ,
V_73 -> V_115 , F_90 ) ;
V_73 -> V_63 = F_91 ( V_130 ) ;
#undef F_89
#undef F_90
}
static void F_92 ( struct V_69 * V_76 , int V_75 )
{
...
int V_19 ;
F_60 (i, d) {
F_92 ( V_76 , V_19 ? V_139 [ V_10 ] :
V_127 ) ;
if ( V_140 && V_19 )
F_92 ( V_76 , V_125 ) ;
if ( V_141 )
F_92 ( V_76 , V_19 ? V_126 :
V_120 ) ;
}
if ( ! V_97 )
return 0 ;
V_71 = F_96 ( sizeof( * V_71 ) ) ;
if ( V_71 == NULL ) {
F_3 ( L_41 ) ;
return - 1 ;
}
...
F_97 ( & V_71 -> V_142 , & V_143 ) ;
return 0 ;
}
static int F_98 ( int V_144 , const char * * V_145 )
{
struct V_69 * V_76 ;
...
V_95 = F_96 ( sizeof( * V_95 ) * V_107 ) ;
if ( ! V_95 )
return - V_54 ;
F_60 (i, d) {
struct V_149 * V_99 = & V_76 -> V_99 ;
...
int F_99 ( int V_144 , const char * * V_145 , const char * T_7 V_14 )
{
int V_4 = F_100 () ;
if ( V_4 < 0 )
return V_4 ;
F_101 ( V_153 , NULL ) ;
V_144 = F_102 ( V_144 , V_145 , V_154 , V_155 , 0 ) ;
if ( F_103 ( NULL ) < 0 )
return - 1 ;
if ( F_98 ( V_144 , V_145 ) < 0 )
return - 1 ;
if ( F_95 () < 0 )
return - 1 ;
V_156 = V_157 ;
