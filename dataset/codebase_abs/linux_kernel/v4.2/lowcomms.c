...
V_192 -> V_201 = V_12 -> V_78 -> V_201 ;
V_190 = V_12 -> V_78 -> V_201 -> V_202 ( V_12 -> V_78 , V_192 , V_203 ) ;
if ( V_190 < 0 )
goto V_200;
memset ( & V_191 , 0 , sizeof( V_191 ) ) ;
if ( V_192 -> V_201 -> V_204 ( V_192 , (struct V_52 * ) & V_191 ,
& V_4 , 2 ) ) {
V_190 = - V_205 ;
goto V_200;
}
...
V_4 = V_208 -> V_4 ;
V_211 = V_208 -> V_211 ;
V_175 [ 0 ] . V_185 = F_75 ( V_208 -> V_209 ) + V_211 ;
V_175 [ 0 ] . V_184 = V_4 ;
F_29 ( & V_12 -> V_19 ) ;
if ( V_213 . V_39 == V_40 ) {
...
V_115 . V_123 = V_117 -> V_130 ;
V_118 -> V_131 |= V_218 ;
V_119 = F_59 ( V_214 -> V_78 , & V_115 , V_175 , 1 , V_4 ) ;
if ( V_119 < 0 ) {
F_60 ( L_29 ,
V_12 -> V_8 , V_119 ) ;
F_40 ( V_90 , & V_12 -> V_81 ) ;
...
F_48 ( & V_219 , 0 , & V_103 ) ;
V_190 = V_78 -> V_201 -> V_224 ( V_78 , (struct V_52 * ) & V_219 ,
V_103 ) ;
if ( V_190 < 0 ) {
F_60 ( L_31 , V_190 ) ;
}
F_48 ( & V_101 , V_93 . V_216 , & V_103 ) ;
F_60 ( L_32 , V_12 -> V_8 ) ;
F_72 ( V_78 , V_225 , V_226 , ( char * ) & V_220 ,
sizeof( V_220 ) ) ;
V_190 = V_78 -> V_201 -> V_227 ( V_78 , (struct V_52 * ) & V_101 , V_103 ,
V_203 ) ;
if ( V_190 == - V_228 )
V_190 = 0 ;
if ( V_190 == 0 )
...
V_12 -> V_25 = F_90 ;
F_48 ( V_101 , V_93 . V_216 , & V_103 ) ;
V_190 = V_78 -> V_201 -> V_224 ( V_78 , (struct V_52 * ) V_101 , V_103 ) ;
if ( V_190 < 0 ) {
F_60 ( L_36 , V_93 . V_216 ) ;
F_51 ( V_78 ) ;
V_78 = NULL ;
V_12 -> V_78 = NULL ;
goto V_234;
}
V_190 = F_72 ( V_78 , V_169 , V_236 ,
( char * ) & V_220 , sizeof( V_220 ) ) ;
if ( V_190 < 0 ) {
F_60 ( L_37 , V_190 ) ;
}
V_190 = V_78 -> V_201 -> V_237 ( V_78 , 5 ) ;
if ( V_190 < 0 ) {
F_60 ( L_38 , V_93 . V_216 ) ;
F_51 ( V_78 ) ;
V_78 = NULL ;
goto V_234;
}
...
int V_190 = 0 ;
if ( V_239 == 1 )
V_190 = F_97 ( V_238 -> V_78 ,
(struct V_52 * ) V_60 ,
V_103 ) ;
else
V_190 = F_72 ( V_238 -> V_78 , V_240 ,
V_241 ,
( char * ) V_60 , V_103 ) ;
if ( V_190 < 0 )
F_60 ( L_39 ,
...
struct V_36 V_242 ;
struct V_243 V_244 ;
int V_190 = - V_232 , V_239 = 1 , V_28 , V_103 ;
...
V_244 . V_251 = 1 ;
V_244 . V_252 = 1 ;
V_190 = F_72 ( V_78 , V_169 , V_253 ,
( char * ) & V_245 , sizeof( V_245 ) ) ;
if ( V_190 )
F_60 ( L_42 , V_190 ) ;
V_190 = F_72 ( V_78 , V_240 , V_254 ,
...
V_190 = F_72 ( V_78 , V_240 , V_256 , ( char * ) & V_220 ,
sizeof( V_220 ) ) ;
if ( V_190 < 0 )
F_60 ( L_44 , V_190 ) ;
V_78 -> V_79 -> V_99 = V_12 ;
...
F_48 ( & V_242 , V_93 . V_216 , & V_103 ) ;
V_190 = F_96 ( V_12 , & V_242 , V_103 , V_239 ) ;
if ( V_190 )
goto V_255;
++ V_239 ;
}
...
{
struct V_207 * V_208 = (struct V_207 * ) V_141 ;
...
V_119 = 0 ;
if ( V_4 ) {
V_119 = F_104 ( V_12 -> V_78 , V_208 -> V_209 , V_211 , V_4 ,
V_124 ) ;
