...
static int F_30 ( char * V_75 )
{
T_5 V_76 = 0 ;
V_76 += sprintf ( V_75 + V_76 , L_35 , V_77 ) ;
V_76 += sprintf ( V_75 + V_76 , L_36 , V_78 ) ;
V_76 += sprintf ( V_75 + V_76 , L_37 , V_79 ) ;
if ( V_80 )
V_77 = V_78 = V_79 = 0 ;
return V_76 ;
}
static int F_31 ( struct V_21 * V_21 , struct V_15 * V_15 )
{
V_15 -> V_81 = ( void * ) F_22 ( V_82 ) ;
return 0 ;
}
static T_6 F_32 ( struct V_15 * V_15 ,
char T_7 * V_83 ,
T_5 V_6 ,
T_8 * V_84 )
{
T_5 V_76 ;
char * V_75 = ( char * ) V_15 -> V_81 ;
if ( * V_84 != 0 )
return 0 ;
V_76 = F_30 ( V_75 ) ;
return F_33 ( V_83 , V_76 , V_84 , V_75 , V_6 ) ;
}
static T_6 F_34 ( struct V_15 * V_15 , const char T_7 * V_83 ,
T_5 V_85 , T_8 * V_84 )
{
V_77 = V_78 = V_79 = 0 ;
return V_85 ;
}
static int F_35 ( struct V_21 * V_21 , struct V_15 * V_15 )
{
F_27 ( ( unsigned long ) ( V_15 -> V_81 ) ) ;
return 0 ;
}
...
V_86 = F_37 ( L_38 , NULL ) ;
#ifdef F_38
V_87 = F_39 ( L_39 , 0444 , V_86 , NULL ,
& V_88 ) ;
#endif
V_89 =
F_40 ( L_40 , 0444 , V_86 , & V_80 ) ;
return 0 ;
}
static void T_10 F_41 ( void )
{
F_42 ( V_89 ) ;
F_42 ( V_87 ) ;
F_42 ( V_86 ) ;
