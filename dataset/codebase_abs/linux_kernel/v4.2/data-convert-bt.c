...
static int F_80 ( struct V_12 * V_13 , const char * V_129 )
{
struct V_116 * V_81 ;
struct V_130 * V_82 ;
struct V_121 * clock ;
...
if ( ! V_131 )
goto V_132;
V_9 = F_86 ( V_131 , V_13 -> V_17 . V_25 , L_23 ) ;
F_15 ( V_131 ) ;
if ( V_9 )
goto V_132;
if ( F_87 ( V_81 , clock ) ) {
...
static int F_89 ( const char * V_133 , const char * V_134 , void * V_135 )
{
struct V_92 * V_93 = V_135 ;
if ( ! strcmp ( V_133 , L_67 ) ) {
V_93 -> V_136 = F_90 ( V_133 , V_134 ) ;
return 0 ;
}
return F_91 ( V_133 , V_134 , V_135 ) ;
}
int F_92 ( const char * V_137 , const char * V_129 , bool V_138 )
{
struct V_105 * V_106 ;
struct V_139 V_140 = {
. V_129 = V_137 ,
