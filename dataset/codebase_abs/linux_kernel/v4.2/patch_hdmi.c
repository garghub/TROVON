...
return F_141 ( V_2 , V_20 -> V_3 , V_288 ) ;
}
...
F_21 ( V_2 , V_321 , 0 ,
V_55 , V_54 ) ;
if ( F_24 ( V_2 , V_321 ) & V_50 )
F_21 ( V_2 , V_321 , 0 , V_51 ,
V_52 ) ;
F_175 ( V_2 , V_321 ) ;
return 0 ;
}
...
V_343 = 0x2 ;
if ( V_2 -> V_345 && ( V_250 -> V_346 & V_347 ) )
F_21 ( V_2 ,
V_339 ,
0 ,
V_348 ,
V_250 -> V_346 & ~ V_347 & 0xff ) ;
F_21 ( V_2 , V_339 , 0 ,
V_340 , ( V_182 << 4 ) | 0x0 ) ;
F_21 ( V_2 , V_339 , 0 ,
V_342 , V_183 ) ;
...
{
struct V_4 * V_5 ;
int V_38 = F_186 ( V_2 , V_339 ,
V_350 ) ;
if ( V_38 < 0 )
return V_38 ;
V_2 -> V_298 . V_299 = F_177 ;
V_5 = V_2 -> V_5 ;
V_5 -> V_320 . V_206 = V_351 ;
V_5 -> V_320 . V_208 = V_352 ;
V_5 -> V_320 . V_207 = V_353 ;
return 0 ;
}
...
case 0x10de0005 :
case 0x10de0006 :
V_144 -> V_355 = ( 1U << 2 ) | ( 1U << 8 ) ;
break;
case 0x10de0007 :
V_144 -> V_355 = ( 1U << 2 ) | ( 1U << 6 ) | ( 1U << 8 ) ;
}
return 0 ;
}
...
V_5 -> V_329 . V_331 = 8 ;
V_5 -> V_320 = V_356 ;
V_2 -> V_298 . V_299 = F_179 ;
V_2 -> V_298 . V_357 = F_191 ;
V_2 -> V_298 . V_358 = F_192 ;
F_187 ( V_2 , 8 ) ;
return 0 ;
}
static int F_194 ( struct V_78 * V_260 ,
int V_81 )
{
...
static int F_195 ( int V_84 , int V_57 , unsigned char * V_105 )
{
if ( V_84 == 0x00 && ( V_105 [ 0 ] != V_360 || V_105 [ 1 ] != V_361 ) )
return - V_8 ;
return 0 ;
}
...
V_5 -> V_92 . V_268 =
F_194 ;
V_5 -> V_92 . V_278 = F_195 ;
return 0 ;
}
static void F_197 ( struct V_1 * V_2 , unsigned int V_183 )
{
unsigned int V_32 ;
V_32 = F_19 ( V_2 , V_362 , 0 ,
V_363 , 0 ) ;
V_32 = ( V_32 >> 24 ) & 0xff ;
F_21 ( V_2 , V_362 , 0 ,
V_364 ,
...
{
F_197 ( V_2 , 0 ) ;
return F_124 ( V_10 , V_2 , V_201 ) ;
}
static struct V_279 * F_200 ( struct V_1 * V_2 , int type )
{
struct V_4 * V_5 = V_2 -> V_5 ;
unsigned int V_76 ;
for ( V_76 = 0 ; V_76 < V_5 -> V_7 ; V_76 ++ ) {
struct V_279 * V_290 = F_5 ( V_5 , V_76 ) ;
if ( V_290 -> V_282 == type )
return V_290 ;
}
return NULL ;
...
if ( V_38 < 0 )
return V_38 ;
V_290 = F_200 ( V_2 , V_283 ) ;
if ( ! V_290 )
return - V_193 ;
V_11 = & V_290 -> V_11 [ V_285 ] ;
V_11 -> V_92 . V_370 = F_198 ;
V_11 -> V_92 . V_371 = F_199 ;
return 0 ;
}
...
if ( V_38 )
return V_38 ;
V_2 -> V_298 . V_357 = F_201 ;
return 0 ;
}
static int F_203 ( struct V_1 * V_2 , T_1 V_146 ,
unsigned char * V_86 , int * V_29 )
{
return F_204 ( V_2 , V_146 , V_86 , V_29 ,
F_205 ( V_2 ) ) ;
}
static void F_206 ( struct V_1 * V_2 , T_1 V_3 , int V_84 ,
int V_132 , int V_133 )
{
F_21 ( V_2 , V_3 , 0 , V_372 , V_84 ) ;
}
static int F_207 ( int V_107 )
{
switch ( V_107 ) {
case 2 : return 3 ;
case 3 : return 2 ;
...
static int F_208 ( int V_84 , int V_57 , unsigned char * V_105 )
{
struct V_78 * V_260 ;
int V_76 , V_77 ;
...
int V_375 = 7 - F_207 ( V_77 ) ;
if ( V_260 -> V_83 [ V_375 ] == V_108 ) {
V_373 = true ;
if ( V_76 % 2 == 0 && V_76 + 1 < V_57 ) {
int V_376 = 7 - F_207 ( V_77 + 1 ) ;
int V_377 = F_45 ( V_105 [ V_76 + 1 ] ) ;
int V_378 = V_260 -> V_83 [ V_376 ] ;
if ( V_377 == V_378 )
V_374 = true ;
else
return - V_8 ;
...
static int F_209 ( struct V_1 * V_2 , T_1 V_3 ,
int V_99 , int V_379 )
{
int V_380 ;
int V_381 = 0 ;
...
if ( ! F_210 ( V_2 ) ) {
V_99 = F_207 ( V_99 ) ;
if ( V_99 % 2 != 0 && V_379 == 0xf )
return 0 ;
V_99 -= V_99 % 2 ;
if ( V_379 != 0xf )
V_379 -= V_379 % 2 ;
}
V_380 = V_382 + V_99 / 2 + ( V_99 % 2 ) * 0x00e ;
if ( V_379 != 0xf )
V_381 = ( V_379 << 4 ) | V_383 ;
return F_21 ( V_2 , V_3 , 0 , V_380 , V_381 ) ;
}
static int F_211 ( struct V_1 * V_2 , T_1 V_3 ,
int V_115 )
{
bool V_384 = false ;
int V_385 = V_115 ;
...
V_380 = V_386 + V_385 / 2 + ( V_385 % 2 ) * 0x00e ;
V_381 = F_19 ( V_2 , V_3 , 0 , V_380 , 0 ) ;
if ( ! ( V_381 & V_383 ) )
return 0xf ;
return ( ( V_381 & 0xf0 ) >> 4 ) + ! ! V_384 ;
}
static int F_212 ( struct V_78 * V_260 ,
int V_81 )
{
int V_68 ;
int V_387 = 0 ;
...
static void F_213 ( struct V_78 * V_260 ,
unsigned int * V_144 , int V_81 )
{
int V_27 = 0 ;
int V_68 ;
for ( V_68 = 7 ; V_68 >= 0 ; V_68 -- ) {
int V_336 = 7 - F_207 ( 7 - V_68 ) ;
int V_109 = V_260 -> V_83 [ V_336 ] ;
if ( ! V_109 ) {
if ( V_260 -> V_83 [ V_336 + ( V_336 % 2 ? - 1 : 1 ) ] )
V_144 [ V_27 ++ ] = V_389 ;
continue;
}
V_144 [ V_27 ++ ] = F_47 ( V_109 ) ;
...
static int F_214 ( struct V_1 * V_2 , T_1 V_3 ,
bool V_174 )
{
int V_390 , V_391 ;
V_390 = F_19 ( V_2 , V_3 , 0 , V_392 , 0 ) ;
if ( V_390 >= 0 && ( V_390 & V_393 ) ) {
if ( V_174 )
V_391 = V_390 | V_394 ;
else
V_391 = V_390 & ~ V_394 ;
...
static int F_215 ( struct V_1 * V_2 , T_1 V_12 ,
T_1 V_3 , T_3 V_182 , int V_183 )
{
if ( F_205 ( V_2 ) ) {
int V_396 = 180 ;
...
if ( V_38 )
return V_38 ;
V_2 -> V_298 . V_299 = F_216 ;
V_5 = V_2 -> V_5 ;
V_5 -> V_92 . V_224 = F_203 ;
V_5 -> V_92 . V_93 = F_211 ;
V_5 -> V_92 . V_101 = F_209 ;
V_5 -> V_92 . V_145 = F_206 ;
V_5 -> V_92 . V_184 = F_214 ;
V_5 -> V_92 . V_254 = F_215 ;
if ( ! F_210 ( V_2 ) ) {
V_5 -> V_92 . V_268 =
F_212 ;
V_5 -> V_92 . V_270 = F_213 ;
V_5 -> V_92 . V_278 = F_208 ;
}
for ( V_13 = 0 ; V_13 < V_5 -> V_14 ; V_13 ++ ) {
V_188 = F_7 ( V_5 , V_13 ) ;
