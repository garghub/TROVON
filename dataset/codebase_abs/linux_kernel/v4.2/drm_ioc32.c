...
unsigned long V_3 )
{
struct V_144 T_2 * V_27 = ( void T_2 * ) V_3 ;
struct V_144 V_66 ;
...
if ( ! F_4 ( V_9 , V_146 , sizeof( * V_146 ) )
|| F_5 ( V_66 . V_147 , & V_146 -> V_147 )
|| F_5 ( V_66 . V_148 , & V_146 -> V_148 )
|| F_5 ( V_66 . V_149 , & V_146 -> V_149 )
|| F_5 ( V_66 . V_36 , & V_146 -> V_36 ) )
return - V_8 ;
for ( V_53 = 0 ; V_53 < 4 ; V_53 ++ ) {
if ( F_5 ( V_66 . V_150 [ V_53 ] , & V_146 -> V_150 [ V_53 ] ) )
return - V_8 ;
if ( F_5 ( V_66 . V_151 [ V_53 ] , & V_146 -> V_151 [ V_53 ] ) )
return - V_8 ;
if ( F_5 ( V_66 . V_152 [ V_53 ] , & V_146 -> V_152 [ V_53 ] ) )
return - V_8 ;
if ( F_5 ( V_66 . V_153 [ V_53 ] , & V_146 -> V_153 [ V_53 ] ) )
return - V_8 ;
}
V_7 = F_6 ( V_1 , V_154 , ( unsigned long ) V_146 ) ;
if ( V_7 )
return V_7 ;
if ( F_7 ( V_66 . V_155 , & V_146 -> V_155 ) )
return - V_8 ;
if ( F_8 ( V_27 , & V_66 , sizeof( V_66 ) ) )
return - V_8 ;
return 0 ;
...
int V_159 ;
if ( V_157 >= F_43 ( V_160 ) )
return F_6 ( V_156 , V_2 , V_3 ) ;
V_158 = V_160 [ V_157 ] ;
if ( V_158 != NULL )
V_159 = (* V_158) ( V_156 , V_2 , V_3 ) ;
else
V_159 = F_6 ( V_156 , V_2 , V_3 ) ;
return V_159 ;
}
