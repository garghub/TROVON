...
struct V_62 * V_63 )
{
struct V_64 * V_65 = F_41 ( V_40 ) ;
unsigned long V_66 = F_42 ( V_63 ) ;
struct V_7 * V_67 , * V_68 ;
struct V_69 * V_70 = NULL , * V_71 = NULL ;
unsigned int V_72 = 0 ;
unsigned long V_12 ;
if ( F_43 ( V_73 , & V_65 -> V_12 ) ) {
struct V_74 * V_75 = V_40 -> V_76 ;
if ( F_44 ( V_75 ) )
V_72 = V_77 ;
else if ( V_66 & V_77 )
F_45 ( V_40 , & V_75 -> V_63 , V_63 ) ;
...
F_48 ( V_3 -> V_86 ) ;
if ( F_6 ( & V_67 -> V_87 ) )
F_45 ( V_40 , & V_67 -> V_88 , V_63 ) ;
if ( F_6 ( & V_68 -> V_87 ) ) {
if ( V_68 -> V_89 )
return V_72 | V_80 | V_81 ;
F_45 ( V_40 , & V_68 -> V_88 , V_63 ) ;
}
if ( V_3 -> V_19 -> V_28 -> V_90 )
V_3 -> V_19 -> V_28 -> V_90 ( V_3 -> V_23 ) ;
else if ( V_3 -> V_86 ) {
if ( F_49 ( V_3 -> V_86 ) ) {
V_72 |= V_83 ;
goto V_84;
...
struct V_96 * V_97 )
{
unsigned long V_54 = V_97 -> V_98 << V_99 ;
struct V_7 * V_43 ;
if ( V_54 < V_53 ) {
V_43 = F_46 ( V_3 ) ;
} else {
...
return F_51 ( V_43 , V_97 ) ;
}
struct V_18 * F_52 ( const struct V_100 * V_28 )
{
struct V_18 * V_19 ;
if ( ! V_28 || F_53 ( ! V_28 -> V_29 ) ||
F_53 ( ! V_28 -> V_38 ) )
return F_54 ( - V_101 ) ;
V_19 = F_55 ( sizeof *V_19 , V_102 ) ;
if ( ! V_19 )
return F_54 ( - V_103 ) ;
V_19 -> V_22 = NULL ;
V_19 -> V_28 = V_28 ;
...
void * V_104 ,
int (* F_60)( void * V_23 , struct V_7 * V_105 , struct V_7 * V_106 ) )
{
struct V_2 * V_3 ;
struct V_1 * V_5 , * V_6 ;
int V_20 ;
V_3 = F_55 ( sizeof *V_3 , V_102 ) ;
if ( ! V_3 )
return F_54 ( - V_103 ) ;
V_3 -> V_23 = V_104 ;
V_3 -> V_19 = V_19 ;
...
F_56 ( & V_6 -> V_13 ) ;
F_39 ( & V_3 -> V_25 ) ;
V_20 = F_60 ( V_104 , & V_5 -> V_9 , & V_6 -> V_9 ) ;
if ( V_20 )
goto V_107;
if ( V_5 -> V_9 . V_90 == V_6 -> V_9 . V_90 )
V_3 -> V_86 = V_5 -> V_9 . V_90 ;
return V_3 ;
V_107:
F_58 ( V_3 ) ;
return F_54 ( V_20 ) ;
...
void F_64 ( struct V_2 * V_3 , struct V_69 * V_16 )
{
...
{
struct V_74 * V_75 = V_40 -> V_76 ;
return F_20 ( V_40 , V_75 -> V_3 , V_108 ) ;
}
int F_67 ( struct V_40 * V_40 , void * V_23 ,
struct V_57 * V_58 )
{
struct V_74 * V_75 = V_40 -> V_76 ;
return F_31 ( V_40 , V_75 -> V_3 , V_58 ) ;
}
...
{
struct V_74 * V_75 = V_40 -> V_76 ;
return F_29 ( V_40 , V_75 -> V_3 , V_45 ) ;
}
int F_72 ( struct V_40 * V_40 , void * V_23 ,
struct V_60 * V_61 )
{
struct V_74 * V_75 = V_40 -> V_76 ;
return F_33 ( V_40 , V_75 -> V_3 , V_61 ) ;
}
...
{
struct V_74 * V_75 = V_40 -> V_76 ;
return F_37 ( V_40 , V_75 -> V_3 , type ) ;
}
int F_75 ( struct V_40 * V_40 , struct V_96 * V_97 )
{
struct V_74 * V_75 = V_40 -> V_76 ;
struct V_2 * V_3 = V_75 -> V_3 ;
int V_20 ;
if ( V_3 -> V_86 && F_49 ( V_3 -> V_86 ) )
return - V_109 ;
V_20 = F_50 ( V_40 , V_3 , V_97 ) ;
if ( V_3 -> V_86 )
F_48 ( V_3 -> V_86 ) ;
return V_20 ;
}
unsigned int F_76 ( struct V_40 * V_40 , T_1 * V_63 )
{
struct V_74 * V_75 = V_40 -> V_76 ;
struct V_2 * V_3 = V_75 -> V_3 ;
unsigned int V_20 ;
