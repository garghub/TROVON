...
if ( F_28 ( & V_2 -> V_3 ) &&
! F_123 ( & V_39 -> V_266 , & V_2 -> V_3 . V_84 ) )
return false ;
if ( V_39 -> V_220 != F_7 ( V_221 ) )
return false ;
if ( ! F_124 ( F_14 ( V_39 -> V_253 ) ) )
return false ;
if ( F_14 ( V_39 -> V_254 ) > V_267 )
return false ;
if ( V_248 -> V_268 && F_14 ( V_39 -> V_41 ) != V_248 -> V_268 -> V_269 )
return false ;
F_121 ( V_39 ) ;
return true ;
}
...
{
struct V_1 * V_2 = V_248 -> V_264 -> V_265 ;
struct V_275 * V_276 = V_248 -> V_277 ;
if ( ! F_122 ( V_248 ) ) {
F_127 ( V_248 , - V_137 ) ;
F_129 ( V_248 ) ;
return;
...
return;
if ( V_276 )
F_20 ( V_248 ) -> V_278 = F_10 ( V_276 -> V_279 . V_280 ) ;
F_131 ( V_248 , V_270 ) ;
}
int
F_132 (
...
F_133 ( V_2 , V_40 ) ;
ASSERT ( V_40 != V_167 ) ;
error = F_134 ( V_2 , V_32 , V_2 -> V_66 ,
F_135 ( V_2 , V_40 , F_136 ( V_2 ) ) ,
F_137 ( V_2 , 1 ) , 0 , V_281 , & V_282 ) ;
if ( error )
return error ;
F_138 ( * V_281 , V_283 ) ;
return 0 ;
...
int error ;
F_139 ( V_2 , V_40 ) ;
error = F_132 ( V_2 , V_32 , V_40 , V_281 ) ;
if ( error )
return error ;
V_39 = F_20 ( * V_281 ) ;
V_103 = F_69 ( V_2 , V_40 ) ;
