...
static bool F_31 ( struct V_56 * V_5 , unsigned int V_79 ,
enum V_80 V_81 )
{
...
static int F_32 ( struct V_1 * V_2 , unsigned V_79 ,
unsigned long * V_87 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
struct V_56 * V_5 = V_4 -> V_5 ;
enum V_80 V_81 = F_33 ( * V_87 ) ;
unsigned long V_59 ;
unsigned int V_88 ;
if ( ! F_31 ( V_5 , V_79 , V_81 ) )
return - V_89 ;
switch ( V_81 ) {
case V_82 :
case V_83 :
...
static int F_34 ( struct V_1 * V_2 , unsigned V_79 ,
...
static int F_35 ( struct V_1 * V_2 , unsigned V_41 ,
unsigned long * V_22 ,
unsigned V_23 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
...
F_34 ( V_2 , V_11 [ V_51 ] , V_22 , V_23 ) ;
return 0 ;
}
static int F_36 ( struct V_56 * V_5 , struct V_3 * V_4 )
{
unsigned int V_51 ;
V_4 -> V_11 = F_37 ( V_5 -> V_29 ,
sizeof( * V_4 -> V_11 ) * V_5 -> V_6 -> V_13 ,
V_25 ) ;
if ( F_38 ( ! V_4 -> V_11 ) )
return - V_26 ;
V_4 -> V_22 = F_37 ( V_5 -> V_29 ,
sizeof( * V_4 -> V_22 ) * V_5 -> V_6 -> V_13 ,
V_25 ) ;
if ( F_38 ( ! V_4 -> V_22 ) )
return - V_26 ;
for ( V_51 = 0 ; V_51 < V_5 -> V_6 -> V_13 ; ++ V_51 ) {
const struct V_69 * V_6 = & V_5 -> V_6 -> V_11 [ V_51 ] ;
struct V_61 * V_62 = & V_4 -> V_22 [ V_51 ] ;
struct V_93 * V_42 = & V_4 -> V_11 [ V_51 ] ;
V_42 -> V_94 = V_6 -> V_42 != ( V_95 ) - 1 ? V_6 -> V_42 : V_51 ;
V_42 -> V_10 = V_6 -> V_10 ;
V_62 -> type = V_63 ;
}
return 0 ;
}
int F_39 ( struct V_56 * V_5 )
{
struct V_3 * V_4 ;
int V_43 ;
V_4 = F_37 ( V_5 -> V_29 , sizeof( * V_4 ) , V_25 ) ;
if ( F_38 ( ! V_4 ) )
return - V_26 ;
V_4 -> V_5 = V_5 ;
V_5 -> V_96 = V_4 ;
...
V_4 -> V_97 . V_10 = V_17 ;
V_4 -> V_97 . V_98 = V_99 ;
V_4 -> V_97 . V_100 = & V_101 ;
V_4 -> V_97 . V_102 = & V_103 ;
V_4 -> V_97 . V_104 = & V_105 ;
V_4 -> V_97 . V_11 = V_4 -> V_11 ;
V_4 -> V_97 . V_106 = V_5 -> V_6 -> V_13 ;
V_4 -> V_107 = F_40 ( & V_4 -> V_97 , V_5 -> V_29 , V_4 ) ;
if ( F_41 ( V_4 -> V_107 ) )
return F_42 ( V_4 -> V_107 ) ;
return 0 ;
}
int F_43 ( struct V_56 * V_5 )
{
struct V_3 * V_4 = V_5 -> V_96 ;
F_44 ( V_4 -> V_107 ) ;
V_5 -> V_96 = NULL ;
return 0 ;
}
