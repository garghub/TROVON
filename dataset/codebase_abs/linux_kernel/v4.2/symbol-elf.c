...
if ( V_167 [ 0 ] == '$' && strchr ( L_22 , V_167 [ 1 ] )
&& ( V_167 [ 2 ] == '\0' || V_167 [ 2 ] == '.' ) )
continue;
}
if ( V_154 -> V_123 && V_9 . V_14 == V_154 -> V_140 ) {
T_19 V_177 = V_9 . V_168 - V_153 -> V_141 . V_30 ;
T_13 * V_178 = V_161 -> V_23 + V_177 ;
V_9 . V_168 = F_73 ( V_38 , T_13 , * V_178 ) ;
...
L_24 , V_38 -> V_181 , V_172 ) ;
V_158 = F_78 ( V_157 , V_41 -> type , V_179 ) ;
if ( V_158 == NULL ) {
...
F_76 ( V_157 , V_158 ) ;
F_82 ( & V_41 -> V_193 -> V_194 -> V_195 , V_159 ) ;
F_83 ( V_159 , V_41 -> type ) ;
} else
V_159 = V_158 -> V_38 ;
goto V_183;
}
if ( ( V_173 && V_154 -> V_145 )
|| ( ! V_173 && V_153 -> V_145 ) ) {
F_84 ( L_25 V_196 L_26
L_27 V_196 L_28 V_196 L_29 , V_75 ,
...
static int F_89 ( T_2 * V_4 , bool V_204 , T_20 V_205 , void * V_79 )
{
T_21 V_206 ;
T_3 V_3 , V_207 ;
int V_59 ;
...
int F_91 ( int V_94 , bool V_204 , T_20 V_205 , void * V_79 ,
bool * V_135 )
{
int V_59 ;
T_2 * V_4 ;
...
V_59 = F_89 ( V_4 , V_204 , V_205 , V_79 ) ;
F_42 ( V_4 ) ;
return V_59 ;
}
enum V_217 F_92 ( int V_94 )
{
...
static int F_93 ( int V_224 , T_22 V_225 , int V_226 , T_22 V_227 , T_13 V_228 )
{
V_100 V_229 ;
T_3 V_101 ;
int V_59 = - 1 ;
...
if ( V_230 == NULL )
return - 1 ;
if ( F_94 ( V_226 , V_227 , V_232 ) != V_227 )
goto V_83;
if ( F_94 ( V_224 , V_225 , V_232 ) != V_225 )
goto V_83;
while ( V_228 ) {
V_101 = V_231 ;
if ( V_228 < V_101 )
...
static int F_96 ( struct V_233 * V_233 , const char * V_93 )
{
T_4 * V_7 ;
...
static int F_97 ( struct V_233 * V_233 , char * V_93 , int V_235 ,
bool V_237 )
{
T_4 * V_7 ;
V_233 -> V_235 = V_235 ;
...
static void F_99 ( struct V_233 * V_233 )
{
F_42 ( V_233 -> V_4 ) ;
F_43 ( V_233 -> V_94 ) ;
}
static int F_100 ( struct V_233 * V_224 , struct V_233 * V_226 , T_3 V_242 )
{
T_4 * V_7 = & V_226 -> V_7 ;
T_4 * V_243 = & V_224 -> V_7 ;
memcpy ( V_7 -> V_129 , V_243 -> V_129 , V_244 ) ;
V_7 -> V_125 = V_243 -> V_125 ;
...
if ( ! F_101 ( V_226 -> V_4 , V_7 ) )
return - 1 ;
if ( ! F_102 ( V_226 -> V_4 , V_242 ) )
return - 1 ;
return 0 ;
}
static int F_103 ( struct V_233 * V_233 , int V_35 , T_22 V_177 ,
T_13 V_27 , T_13 V_228 )
{
T_21 V_259 ;
T_21 * V_206 ;
V_206 = F_90 ( V_233 -> V_4 , V_35 , & V_259 ) ;
if ( ! V_206 )
return - 1 ;
V_206 -> V_208 = V_209 ;
...
V_206 -> V_213 = V_228 ;
V_206 -> V_262 = V_231 ;
if ( ! F_104 ( V_233 -> V_4 , V_35 , V_206 ) )
return - 1 ;
return 0 ;
}
static T_22 F_105 ( struct V_233 * V_233 )
{
return F_106 ( V_233 -> V_4 , V_241 ) ;
}
...
static void F_116 ( struct V_275 * V_276 , T_13 V_184 , T_13 V_185 , T_13 V_186 ,
...
static int F_117 ( T_13 V_184 , T_13 V_228 , T_13 V_186 , void * V_79 )
{
struct V_264 * V_265 = V_79 ;
T_13 V_185 = V_184 + V_228 ;
F_116 ( & V_265 -> V_279 , V_184 , V_185 , V_186 , V_265 -> V_269 ,
V_265 -> V_270 ) ;
F_116 ( & V_265 -> V_280 , V_184 , V_185 , V_186 , V_265 -> V_273 ,
V_265 -> V_266 ) ;
return 0 ;
}
...
return - 1 ;
if ( V_265 -> V_269 )
V_265 -> V_269 = F_120 ( V_265 -> V_269 , V_231 ) ;
else
V_265 -> V_269 = F_120 ( V_265 -> V_267 , V_231 ) ;
if ( V_265 -> V_270 ) {
V_265 -> V_270 = F_121 ( V_265 -> V_270 , V_231 ) ;
} else if ( V_265 -> V_268 ) {
V_265 -> V_270 = F_121 ( V_265 -> V_268 , V_231 ) ;
V_265 -> V_270 += V_231 ;
}
V_265 -> V_273 = F_120 ( V_265 -> V_273 , V_231 ) ;
if ( V_265 -> V_266 ) {
...
char V_283 [ V_180 ] ;
char V_284 [ V_180 ] ;
F_110 ( V_283 , V_180 , L_36 , V_281 , V_34 ) ;
F_110 ( V_284 , V_180 , L_36 , V_282 , V_34 ) ;
return F_123 ( V_283 , V_284 , 0400 ) ;
}
static int F_124 ( const char * V_271 , const char * V_34 )
{
char V_93 [ V_180 ] ;
F_110 ( V_93 , V_180 , L_36 , V_271 , V_34 ) ;
return F_52 ( V_93 ) ;
}
static int F_125 ( int V_224 , int V_226 )
{
char * V_285 ;
char * V_286 ;
V_100 V_287 ;
...
break;
V_228 = V_287 ;
if ( F_126 ( V_226 , V_286 , V_228 ) != ( int ) V_228 )
goto V_83;
...
goto V_293;
F_110 ( V_291 , V_180 , L_39 , V_281 ) ;
F_110 ( V_292 , V_180 , L_39 , V_282 ) ;
if ( F_96 ( & V_233 , V_291 ) )
goto V_294;
if ( F_119 ( & V_265 , V_281 , V_233 . V_4 ) )
goto V_295;
if ( F_97 ( & V_289 , V_292 , V_233 . V_235 , false ) )
goto V_295;
if ( ! V_265 . V_280 . V_27 )
V_242 -= 1 ;
if ( F_100 ( & V_233 , & V_289 , V_242 ) )
goto V_296;
if ( F_103 ( & V_289 , V_35 ++ , V_177 , V_265 . V_279 . V_27 ,
V_265 . V_279 . V_228 ) )
goto V_296;
if ( V_265 . V_280 . V_27 ) {
...
goto V_296;
if ( F_93 ( V_233 . V_94 , V_265 . V_279 . V_177 , V_289 . V_94 , V_177 ,
V_265 . V_279 . V_228 ) )
goto V_296;
if ( V_290 && F_93 ( V_233 . V_94 , V_265 . V_280 . V_177 ,
V_289 . V_94 , V_290 ,
V_265 . V_280 . V_228 ) )
goto V_296;
...
if ( F_96 ( & V_233 , V_298 -> V_291 ) )
return - 1 ;
strcpy ( V_298 -> V_292 , V_299 ) ;
if ( F_97 ( & V_289 , V_298 -> V_292 , V_233 . V_235 , true ) )
goto V_295;
if ( F_100 ( & V_233 , & V_289 , V_242 ) )
goto V_296;
if ( F_103 ( & V_289 , V_35 , V_177 , V_298 -> V_27 , V_298 -> V_228 ) )
goto V_296;
V_92 = F_105 ( & V_289 ) ;
if ( V_92 < 0 || V_92 > V_177 )
goto V_296;
if ( F_93 ( V_233 . V_94 , V_298 -> V_300 , V_289 . V_94 , V_177 , V_298 -> V_228 ) )
goto V_296;
V_59 = 0 ;
V_296:
F_99 ( & V_289 ) ;
