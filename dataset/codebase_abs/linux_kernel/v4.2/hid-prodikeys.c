...
static void F_16 ( struct V_27 * V_10 )
{
struct V_39 * V_40 ;
unsigned V_42 ;
...
static void F_18 ( struct V_27 * V_10 )
{
struct V_39 * V_40 ;
unsigned V_42 ;
for ( V_42 = 0 ; V_42 < V_43 ; V_42 ++ ) {
...
static void F_32 (
struct V_27 * V_10 , struct V_90 * V_91 )
{
unsigned int V_92 [] = {
V_93 ,
V_69 , V_70 ,
...
static int F_39 ( struct V_27 * V_10 )
{
static int V_2 ;
struct V_103 * V_104 ;
struct V_105 * V_106 ;
...
V_107 = F_40 ( & V_10 -> V_9 -> V_7 -> V_2 , V_114 [ V_2 ] , V_48 [ V_2 ] ,
V_115 , 0 , & V_104 ) ;
if ( V_107 < 0 ) {
F_41 ( L_19 ) ;
V_107 = - V_116 ;
...
V_132:
F_18 ( V_10 ) ;
F_48 ( & V_10 -> V_9 -> V_7 -> V_2 , V_130 ) ;
V_131:
F_48 ( & V_10 -> V_9 -> V_7 -> V_2 , V_128 ) ;
V_129:
F_48 ( & V_10 -> V_9 -> V_7 -> V_2 , V_127 ) ;
V_117:
if ( V_10 -> V_104 ) {
F_49 ( V_10 -> V_104 ) ;
V_10 -> V_104 = NULL ;
...
static int F_50 ( struct V_27 * V_10 )
{
if ( V_10 -> V_104 ) {
F_18 ( V_10 ) ;
F_48 ( & V_10 -> V_9 -> V_7 -> V_2 ,
V_127 ) ;
F_48 ( & V_10 -> V_9 -> V_7 -> V_2 ,
V_128 ) ;
F_48 ( & V_10 -> V_9 -> V_7 -> V_2 ,
...
static T_5 * F_53 ( struct V_6 * V_7 , T_5 * V_133 ,
unsigned int * V_134 )
{
if ( * V_134 == 178 &&
...
static int F_55 ( struct V_6 * V_7 , struct V_135 * V_136 ,
...
static int F_56 ( struct V_6 * V_7 , struct V_46 * V_47 ,
T_3 * V_38 , int V_58 )
{
struct V_8 * V_9 = F_3 ( V_7 ) ;
int V_89 = 0 ;
...
static int F_57 ( struct V_6 * V_7 , const struct V_145 * V_48 )
{
int V_89 ;
struct V_146 * V_147 = F_58 ( V_7 -> V_2 . V_148 ) ;
unsigned short V_95 = V_147 -> V_149 -> V_150 . V_151 ;
unsigned long V_152 = V_48 -> V_153 ;
struct V_8 * V_9 ;
struct V_27 * V_10 = NULL ;
V_9 = F_59 ( sizeof( * V_9 ) , V_154 ) ;
if ( V_9 == NULL ) {
F_22 ( V_7 , L_28 ) ;
return - V_116 ;
}
V_9 -> V_7 = V_7 ;
V_10 = F_59 ( sizeof( * V_10 ) , V_154 ) ;
if ( V_10 == NULL ) {
F_22 ( V_7 , L_28 ) ;
V_89 = - V_116 ;
goto V_155;
