...
static unsigned int F_14 ( unsigned int V_24 )
{
if ( V_24 <= 300 )
V_24 = 300 ;
...
static int F_15 ( struct V_25 * V_26 , struct V_1 * V_2 )
{
int V_11 ;
V_11 = F_13 ( V_2 , V_27 ,
V_28 ) ;
if ( V_11 ) {
F_16 ( & V_2 -> V_16 , L_3 , V_20 ) ;
return V_11 ;
}
F_17 ( V_26 , V_2 ) ;
if ( V_26 )
...
{
struct V_36 * V_16 = & V_2 -> V_16 ;
unsigned int V_33 , V_37 [ 4 ] ;
unsigned int V_24 ;
unsigned int V_38 ;
F_1 ( V_2 , V_39 , & V_24 , 4 ) ;
F_8 ( V_16 , L_4 , V_20 , V_24 ) ;
* V_35 = V_24 ;
V_33 = * V_34 ;
F_1 ( V_2 , V_40 , & V_38 , 2 ) ;
V_33 &= ~ V_41 ;
...
V_24 = V_26 -> V_31 . V_71 ;
V_24 = F_14 ( V_24 ) ;
F_8 ( & V_2 -> V_16 , L_23 , V_20 , V_24 ) ;
if ( F_9 ( V_2 , V_72 , & V_24 ,
sizeof( V_24 ) ) ) {
F_24 ( & V_2 -> V_16 , L_24 , V_24 ) ;
if ( V_70 )
V_24 = V_70 -> V_71 ;
else
V_24 = 9600 ;
...
F_8 ( & V_2 -> V_16 , L_31 , V_20 , V_77 ) ;
return F_9 ( V_2 , V_84 , & V_77 , 2 ) ;
}
...
V_97 = V_99 ;
F_8 ( & V_2 -> V_16 , L_33 , V_20 ,
V_97 == V_98 ? L_34 : L_35 ) ;
F_9 ( V_2 , V_100 , & V_97 , 2 ) ;
}
static int F_31 ( struct V_6 * V_7 )
{
struct V_101 * V_102 ;
struct V_8 * V_9 ;
V_9 = F_32 ( sizeof( * V_9 ) , V_14 ) ;
if ( ! V_9 )
return - V_15 ;
V_102 = V_7 -> V_103 -> V_102 ;
V_9 -> V_18 = V_102 -> V_104 . V_18 ;
F_33 ( V_7 , V_9 ) ;
return 0 ;
}
