...
static void F_15 ( struct V_9 * V_10 , struct V_11 * V_12 ,
T_1 V_3 )
{
const struct V_13 * V_14 = V_10 -> V_15 ;
if ( V_14 -> V_37 ) {
...
int F_64 ( struct V_11 * V_12 , unsigned long V_65 )
{
int V_16 = 0 ;
struct V_28 * V_29 ;
struct V_1 * V_43 ;
...
V_71:
V_68 = V_3 ;
F_66 (vid, pv->vlan_bitmap, errvid)
...
static bool F_68 ( struct V_1 * V_43 , T_1 V_3 )
{
...
struct V_28 * V_29 ;
T_1 V_4 = V_12 -> V_72 ;
if ( F_68 ( F_70 ( V_12 ) , V_4 ) )
F_48 ( V_12 , V_4 ) ;
F_65 (p, &br->port_list, list) {
if ( F_68 ( F_71 ( V_29 ) , V_4 ) )
F_72 ( V_29 , V_4 ) ;
}
V_12 -> V_72 = 0 ;
}
static int F_73 ( struct V_11 * V_12 , T_1 V_4 )
{
struct V_28 * V_29 ;
T_1 V_73 ;
int V_16 = 0 ;
unsigned long * V_74 ;
V_74 = F_74 ( F_75 ( V_75 ) , sizeof( unsigned long ) ,
V_55 ) ;
if ( ! V_74 )
return - V_56 ;
V_73 = V_12 -> V_72 ;
if ( ( ! V_73 || F_68 ( F_70 ( V_12 ) , V_73 ) ) &&
! F_51 ( V_12 , V_4 ) ) {
V_16 = F_42 ( V_12 , V_4 ,
V_6 |
V_7 ) ;
...
int F_78 ( struct V_11 * V_12 , unsigned long V_65 )
{
T_1 V_4 = V_65 ;
int V_16 = 0 ;
if ( V_65 >= V_78 )
...
int F_77 ( struct V_28 * V_33 , T_1 V_3 , T_1 V_5 )
{
struct V_1 * V_43 = NULL ;
int V_16 ;
F_43 () ;
...
int F_72 ( struct V_28 * V_33 , T_1 V_3 )
{
struct V_1 * V_43 ;
F_43 () ;
V_43 = F_44 ( V_33 -> V_40 ) ;
...
F_81 ( V_33 -> V_12 , V_33 , V_3 , 0 ) ;
return F_17 ( V_43 , V_3 ) ;
}
void F_82 ( struct V_28 * V_33 )
{
struct V_1 * V_43 ;
T_1 V_3 ;
F_43 () ;
...
bool F_76 ( struct V_28 * V_33 , T_1 V_3 )
{
struct V_1 * V_43 ;
bool V_57 = false ;
F_52 () ;
...
{
return V_29 -> V_12 -> V_72 ?
F_77 ( V_29 , V_29 -> V_12 -> V_72 ,
V_6 |
V_7 ) :
0 ;
}
