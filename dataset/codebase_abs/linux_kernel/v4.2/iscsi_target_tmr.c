...
F_6 ( F_5 ( V_13 -> V_16 ) , V_6 -> V_17 -> V_19 ) ) ?
V_20 : V_21 ;
}
if ( V_4 -> V_22 != F_5 ( V_13 -> V_16 ) ) {
F_3 ( L_3
L_4 ,
V_13 -> V_16 , V_4 -> V_22 ) ;
return V_23 ;
...
V_39 = F_12 ( V_6 -> V_17 , & V_4 , & V_38 , V_13 -> V_14 ) ;
if ( V_39 == - 2 ) {
F_3 ( L_12
...
V_38 = V_2 -> V_38 ;
V_2 -> V_58 = V_2 -> V_59 = 0 ;
F_14 ( V_2 , V_38 , V_6 -> V_17 ) ;
F_20 ( & V_6 -> V_60 ) ;
F_21 ( & V_2 -> V_61 , & V_6 -> V_62 ) ;
F_22 ( & V_6 -> V_60 ) ;
V_2 -> V_63 = V_64 ;
F_23 ( V_2 , V_6 , V_2 -> V_63 ) ;
return 0 ;
}
static int F_24 (
struct V_1 * V_2 ,
...
int F_34 ( struct V_1 * V_2 , struct V_5 * V_6 )
{
struct V_7 * V_8 = V_2 -> V_8 ;
struct V_9 * V_10 = V_2 -> V_11 . V_9 ;
if ( V_8 -> V_55 &&
