...
struct V_158 * V_159 )
{
struct V_160 * V_145 = & V_159 -> V_159 ;
struct V_18 * V_19 = F_16 ( V_17 ) ;
struct V_1 * V_2 = F_17 ( V_17 ) ;
int V_161 , V_162 , V_163 , V_164 , V_165 , V_166 ;
int V_167 = ! ( V_19 -> V_45 & V_71 ) ;
if ( V_159 -> V_168 || V_145 -> V_169 != V_170 )
return - V_105 ;
V_145 -> V_171 = V_172 ;
V_145 -> V_173 = V_174 ;
V_163 = ( F_10 ( V_2 , 0x476 ) & 0x3f ) << 4 ;
V_163 |= ( F_10 ( V_2 , 0x475 ) & 0xf0 ) >> 4 ;
V_164 = ( F_10 ( V_2 , 0x472 ) & 0x3f ) << 4 ;
V_164 |= ( F_10 ( V_2 , 0x471 ) & 0xf0 ) >> 4 ;
V_166 = V_145 -> V_175 + ( V_167 ? 3 : 1 ) ;
if ( ( V_145 -> V_176 * 16 < V_164 ) || ( V_164 < V_145 -> V_176 ) ||
( V_166 * 8 < V_163 ) || ( V_163 < V_166 ) ) {
F_28 ( V_17 , L_16 ,
V_145 -> V_176 , V_145 -> V_175 ) ;
return - V_177 ;
}
if ( V_159 -> V_178 == V_179 )
return 0 ;
V_161 = ( V_164 * ( 1 << 20 ) ) / V_145 -> V_176 - ( 1 << 20 ) ;
V_162 = ( 1 << 16 ) - ( V_163 * ( 1 << 9 ) / V_166 - ( 1 << 9 ) ) ;
V_162 &= 0x1fff ;
if ( V_145 -> V_176 >= 385 )
V_165 = 0 ;
else if ( V_145 -> V_176 > 192 )
V_165 = 1 ;
else if ( V_145 -> V_176 > 96 )
V_165 = 2 ;
else
V_165 = 3 ;
F_23 ( V_17 ,
L_17 ,
V_145 -> V_176 , V_145 -> V_175 , V_161 , V_162 ) ;
F_1 ( V_2 , 0x418 , V_161 & 0xff ) ;
F_1 ( V_2 , 0x419 , ( V_161 >> 8 ) & 0xff ) ;
F_1 ( V_2 , 0x41a , V_161 >> 16 ) ;
F_1 ( V_2 , 0x41c , V_162 & 0xff ) ;
F_1 ( V_2 , 0x41d , V_162 >> 8 ) ;
F_1 ( V_2 , 0x41e , 0x8 | V_165 ) ;
return 0 ;
}
static int F_39 ( struct V_16 * V_17 , int V_180 )
{
struct V_1 * V_2 = F_17 ( V_17 ) ;
F_23 ( V_17 , L_18 , V_180 ? L_19 : L_20 ) ;
if ( V_180 ) {
F_1 ( V_2 , 0x115 , 0x8c ) ;
F_1 ( V_2 , 0x116 , 0x07 ) ;
} else {
...
struct V_18 * V_19 = & V_2 -> V_44 ;
struct V_16 * V_17 = & V_19 -> V_17 ;
T_2 V_182 = F_10 ( V_2 , 0x400 ) & 0xf ;
T_2 V_183 = F_10 ( V_2 , 0x40d ) ;
T_2 V_184 = F_10 ( V_2 , 0x40e ) ;
int V_78 = V_19 -> V_78 ;
F_41 ( V_17 , L_37 ,
( V_184 & 0x20 ) ? L_38 : L_39 ) ;
F_41 ( V_17 , L_40 ,
V_181 [ V_183 & 0xf ] ) ;
F_41 ( V_17 , L_41 ,
V_182 ? V_181 [ V_182 ]
...
struct V_18 * V_19 = & V_2 -> V_44 ;
struct V_16 * V_17 = & V_19 -> V_17 ;
T_2 V_186 = F_10 ( V_2 , 0x803 ) ;
T_2 V_187 = F_10 ( V_2 , 0x804 ) ;
T_2 V_188 = F_10 ( V_2 , 0x805 ) ;
T_2 V_189 = F_10 ( V_2 , 0x808 ) ;
T_2 V_190 = F_10 ( V_2 , 0x809 ) ;
T_2 V_191 = F_10 ( V_2 , 0x80b ) ;
T_2 V_192 = F_10 ( V_2 , 0x8d3 ) ;
int V_80 = V_19 -> V_80 ;
char * V_193 ;
switch ( V_187 ) {
case 0x00 : V_193 = L_47 ; break;
case 0x01 : V_193 = L_48 ; break;
case 0x02 : V_193 = L_49 ; break;
case 0x04 : V_193 = L_50 ; break;
case 0x10 : V_193 = L_51 ; break;
case 0x11 : V_193 = L_52 ; break;
case 0x12 : V_193 = L_53 ; break;
case 0x14 : V_193 = L_54 ; break;
case 0xfe : V_193 = L_55 ; break;
default: V_193 = L_56 ; break;
}
F_41 ( V_17 , L_57 , V_193 ) ;
switch ( V_188 ) {
case 0x00 : V_193 = L_56 ; break;
case 0x01 : V_193 = L_58 ; break;
case 0x02 : V_193 = L_59 ; break;
case 0x03 : V_193 = L_60 ; break;
case 0x04 : V_193 = L_61 ; break;
case 0x05 : V_193 = L_62 ; break;
case 0x06 : V_193 = L_63 ; break;
case 0x07 : V_193 = L_64 ; break;
case 0x08 : V_193 = L_65 ; break;
case 0x09 : V_193 = L_66 ; break;
case 0x0a : V_193 = L_67 ; break;
case 0x0b : V_193 = L_68 ; break;
case 0x0c : V_193 = L_69 ; break;
case 0x0d : V_193 = L_70 ; break;
case 0x0e : V_193 = L_71 ; break;
case 0x0f : V_193 = L_72 ; break;
case 0x10 : V_193 = L_73 ; break;
case 0xfd : V_193 = L_74 ; break;
case 0xfe : V_193 = L_75 ; break;
case 0xff : V_193 = L_76 ; break;
default: V_193 = L_56 ; break;
}
F_41 ( V_17 , L_77 , V_193 ) ;
F_41 ( V_17 , L_78 ,
( V_192 & 0x2 ) ? L_79 : L_80 ) ;
F_41 ( V_17 , L_81 ,
( V_186 & 0x10 ) ? L_82 : L_83 ) ;
switch ( V_189 >> 4 ) {
case 0x00 : V_193 = L_84 ; break;
case 0x01 : V_193 = L_72 ; break;
case 0x02 : V_193 = L_58 ; break;
case 0x03 : V_193 = L_59 ; break;
case 0x04 : V_193 = L_60 ; break;
case 0x05 : V_193 = L_61 ; break;
case 0x06 : V_193 = L_62 ; break;
case 0x07 : V_193 = L_63 ; break;
case 0x08 : V_193 = L_64 ; break;
case 0x09 : V_193 = L_65 ; break;
case 0x0a : V_193 = L_66 ; break;
case 0x0b : V_193 = L_67 ; break;
case 0x0c : V_193 = L_68 ; break;
case 0x0d : V_193 = L_69 ; break;
case 0x0e : V_193 = L_85 ; break;
case 0x0f : V_193 = L_42 ; break;
default: V_193 = L_84 ; break;
}
F_41 ( V_17 , L_86 , V_193 ) ;
if ( ( V_189 >> 4 ) < 0xF ) {
switch ( V_189 & 0xF ) {
case 0x00 : V_193 = L_87 ; break;
case 0x01 : V_193 = L_88 ; break;
case 0x02 : V_193 = L_89 ; break;
case 0x03 : V_193 = L_90 ; break;
case 0x04 : V_193 = L_91 ; break;
case 0x05 : V_193 = L_92 ; break;
case 0x06 : V_193 = L_93 ; break;
case 0x07 : V_193 = L_94 ; break;
default: V_193 = L_84 ;
}
F_41 ( V_17 , L_95 , V_193 ) ;
} else {
switch ( V_189 & 0xF ) {
case 0x00 : V_193 = L_96 ; break;
case 0x01 : V_193 = L_97 ; break;
case 0x02 : V_193 = L_98 ; break;
case 0x03 : V_193 = L_99 ; break;
case 0x04 : V_193 = L_100 ; break;
case 0x05 : V_193 = L_101 ; break;
case 0x06 : V_193 = L_72 ; break;
case 0x07 : V_193 = L_58 ; break;
case 0x08 : V_193 = L_59 ; break;
case 0x09 : V_193 = L_102 ; break;
case 0x0a : V_193 = L_103 ; break;
case 0x0b : V_193 = L_104 ; break;
case 0x0f : V_193 = L_105 ; break;
default: V_193 = L_84 ; break;
}
F_41 ( V_17 , L_106 , V_193 ) ;
}
if ( V_80 )
F_41 ( V_17 , L_107 ,
V_80 ) ;
...
F_41 ( V_17 , L_108 ) ;
switch ( V_190 & 0xf ) {
case 0 : V_193 = L_109 ; break;
case 1 : V_193 = L_110 ; break;
case 2 : V_193 = L_111 ; break;
case 3 : V_193 = L_112 ; break;
case 4 : V_193 = L_48 ; break;
case 5 : V_193 = L_113 ; break;
case 6 : V_193 = L_114 ; break;
case 7 : V_193 = L_115 ; break;
default: V_193 = L_84 ; break;
}
F_41 ( V_17 , L_116 , V_193 ) ;
if ( ( V_189 & 0xf ) == 0xf ) {
switch ( ( V_191 >> 3 ) & 0x1 ) {
case 0 : V_193 = L_117 ; break;
case 1 : V_193 = L_118 ; break;
}
F_41 ( V_17 , L_119 , V_193 ) ;
switch ( V_191 & 0x7 ) {
case 0 : V_193 = L_120 ; break;
case 1 : V_193 = L_72 ; break;
case 2 : V_193 = L_58 ; break;
case 3 : V_193 = L_59 ; break;
case 4 : V_193 = L_121 ; break;
default: V_193 = L_84 ; break;
}
F_41 ( V_17 , L_122 , V_193 ) ;
}
}
...
struct V_16 * V_17 ;
int V_196 ;
V_19 -> V_197 = F_11 ( V_2 , V_31 ) & 0xffff ;
V_19 -> V_78 = V_198 ;
V_19 -> V_80 = V_118 ;
V_19 -> V_185 = 48000 ;
V_19 -> V_138 = V_141 ;
...
F_47 ( V_17 , & V_199 ) ;
F_48 ( V_17 , V_2 ) ;
snprintf ( V_17 -> V_200 , sizeof( V_17 -> V_200 ) ,
L_123 , V_2 -> V_201 . V_200 , ( V_19 -> V_197 >> 4 ) ) ;
V_17 -> V_202 = V_203 ;
F_49 ( & V_19 -> V_42 , 9 ) ;
F_50 ( & V_19 -> V_42 , & V_204 ,
V_152 , 0 , 255 , 1 , 128 ) ;
F_50 ( & V_19 -> V_42 , & V_204 ,
V_153 , 0 , 127 , 1 , 64 ) ;
F_50 ( & V_19 -> V_42 , & V_204 ,
...
V_210 ,
0 , 65535 , 65535 / 100 , 32768 ) ;
V_17 -> V_211 = & V_19 -> V_42 ;
if ( V_19 -> V_42 . error ) {
int V_196 = V_19 -> V_42 . error ;
F_51 ( & V_19 -> V_42 ) ;
return V_196 ;
}
V_196 = F_52 ( & V_2 -> V_201 , V_17 ) ;
if ( V_196 )
F_51 ( & V_19 -> V_42 ) ;
else
F_14 ( V_2 ) ;
