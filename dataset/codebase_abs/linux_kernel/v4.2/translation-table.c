...
T_2 * V_121 ;
F_8 () ;
F_72 (vlan, &orig_node->vlan_list, list) {
V_68 ++ ;
...
V_120 -> V_124 = F_73 ( V_41 -> V_9 . V_124 ) ;
V_120 ++ ;
}
...
V_126 = F_49 ( V_128 ) ;
if ( V_128 > 0 ) {
V_24 -> V_9 . V_133 = F_76 ( V_125 , V_56 ) ;
if ( V_24 -> V_9 . V_133 ) {
...
F_35 ( & V_24 -> V_9 . V_132 ) ;
V_131:
F_77 ( V_24 , V_135 , 1 , V_116 ,
V_119 ) ;
F_23 ( V_116 ) ;
}
int F_78 ( struct V_136 * V_137 , void * V_138 )
{
...
V_25 = & V_30 -> V_28 ;
V_52 = V_25 -> V_52 ;
V_172 = F_103 ( V_24 , V_30 ) ;
if ( V_172 ) {
V_41 = F_107 ( V_172 -> V_38 ,
V_25 -> V_13 ) ;
if ( ! V_41 ) {
F_80 ( V_137 ,
L_21 ,
...
int F_108 ( struct V_136 * V_137 , void * V_138 )
{
struct V_80 * V_139 = (struct V_80 * ) V_137 -> V_140 ;
struct V_23 * V_24 = F_60 ( V_139 ) ;
...
static bool F_115 ( struct V_29 * V_77 ,
char * * V_181 )
{
bool V_182 = false ;
...
F_87 ( V_77 -> V_111 , V_183 ) ) {
V_182 = true ;
* V_181 = L_31 ;
}
if ( ( V_77 -> V_28 . V_52 & V_163 ) &&
F_87 ( V_77 -> V_28 . V_106 , V_185 ) ) {
V_182 = true ;
* V_181 = L_32 ;
}
return V_182 ;
...
struct V_43 * F_119 ( struct V_23 * V_24 ,
const T_2 * V_188 ,
const T_2 * V_11 ,
unsigned short V_13 )
{
...
static T_1 F_121 ( struct V_23 * V_24 ,
struct V_43 * V_38 ,
unsigned short V_13 )
{
struct V_14 * V_10 = V_24 -> V_9 . V_31 ;
...
V_189 = F_122 ( 0 , & V_190 , sizeof( V_190 ) ) ;
V_52 = V_187 -> V_52 & V_191 ;
V_189 = F_122 ( V_189 , & V_52 , sizeof( V_52 ) ) ;
V_124 ^= F_122 ( V_189 , V_187 -> V_11 , V_12 ) ;
}
F_11 () ;
}
return V_124 ;
}
static T_1 F_123 ( struct V_23 * V_24 ,
unsigned short V_13 )
{
struct V_14 * V_10 = V_24 -> V_9 . V_27 ;
struct V_5 * V_187 ;
...
static struct V_192 *
F_127 ( struct V_23 * V_24 ,
struct V_43 * V_38 )
{
struct V_192 * V_199 , * V_200 = NULL ;
F_33 ( & V_24 -> V_9 . V_193 ) ;
F_128 (tt_req_node_tmp, &bat_priv->tt.req_list, list) {
if ( F_3 ( V_199 , V_38 ) &&
! F_87 ( V_199 -> V_197 ,
V_198 ) )
goto V_62;
...
V_200 -> V_197 = V_96 ;
F_129 ( & V_200 -> V_46 , & V_24 -> V_9 . V_201 ) ;
V_62:
F_35 ( & V_24 -> V_9 . V_193 ) ;
return V_200 ;
}
static int F_130 ( const void * V_202 , const void * V_203 )
{
...
static int F_131 ( const void * V_202 ,
const void * V_203 )
{
const struct V_5 * V_25 = V_202 ;
...
struct V_29 ,
V_28 ) ;
return F_95 ( V_30 , V_38 ) ;
}
static void F_132 ( struct V_23 * V_24 ,
struct V_14 * V_10 ,
void * V_204 , T_3 V_67 ,
int (* F_133)( const void * , const void * ) ,
void * V_205 )
{
struct V_5 * V_25 ;
struct V_66 * V_117 ;
...
static bool F_134 ( struct V_43 * V_38 ,
struct V_74 * V_120 ,
T_3 V_68 )
{
struct V_74 * V_208 ;
...
F_8 () ;
F_9 (vlan, &bat_priv->softif_vlan_list, list) {
V_41 -> V_9 . V_124 = F_123 ( V_24 , V_41 -> V_13 ) ;
}
F_11 () ;
}
...
F_8 () ;
F_72 (vlan, &orig_node->vlan_list, list) {
if ( F_100 ( V_24 , V_38 -> V_162 ,
V_41 -> V_13 ) )
continue;
V_124 = F_121 ( V_24 , V_38 , V_41 -> V_13 ) ;
...
static bool F_143 ( struct V_23 * V_24 ,
struct V_73 * V_116 ,
T_2 * V_216 , T_2 * V_217 )
{
struct V_43 * V_218 ;
...
( ( V_116 -> V_52 & V_214 ) ? 'F' : '.' ) ) ;
V_218 = F_144 ( V_24 , V_217 ) ;
if ( ! V_218 )
goto V_102;
V_219 = F_144 ( V_24 , V_216 ) ;
if ( ! V_219 )
goto V_102;
...
static bool F_147 ( struct V_23 * V_24 ,
struct V_73 * V_116 ,
T_2 * V_216 , T_2 * V_217 )
{
if ( F_148 ( V_24 , V_217 ) )
return F_146 ( V_24 , V_116 , V_216 ) ;
return F_143 ( V_24 , V_116 , V_216 ,
V_217 ) ;
}
...
{
struct V_43 * V_38 ;
V_38 = F_144 ( V_24 , V_228 ) ;
if ( ! V_38 )
goto V_102;
F_114 ( V_24 , V_38 , - 1 ,
L_40 ) ;
F_149 ( V_24 , V_38 , V_117 , V_42 ,
V_122 ) ;
F_33 ( & V_38 -> V_196 ) ;
F_23 ( V_38 -> V_194 ) ;
V_38 -> V_195 = 0 ;
...
struct V_66 * V_117 )
{
F_149 ( V_24 , V_38 , V_117 ,
V_226 , V_122 ) ;
F_125 ( V_24 , V_38 , V_117 ,
F_49 ( V_226 ) ) ;
F_66 ( & V_38 -> V_123 , V_122 ) ;
}
bool F_152 ( struct V_23 * V_24 , const T_2 * V_11 ,
unsigned short V_13 )
{
struct V_22 * V_26 ;
bool V_89 = false ;
...
V_118 *= F_135 ( V_116 -> V_68 ) ;
V_118 += sizeof( * V_116 ) ;
V_229 += V_118 ;
V_117 = (struct V_66 * ) V_229 ;
if ( V_116 -> V_52 & V_214 ) {
F_150 ( V_24 , V_117 , V_116 -> V_122 ,
V_228 , V_42 ) ;
} else {
F_151 ( V_24 , V_38 , V_42 ,
V_116 -> V_122 , V_117 ) ;
}
F_138 ( V_24 , V_38 ) ;
F_35 ( & V_38 -> V_230 ) ;
...
static void F_155 ( struct V_23 * V_24 )
{
struct V_231 * V_2 , * V_51 ;
F_33 ( & V_24 -> V_9 . V_232 ) ;
F_44 (node, safe, &bat_priv->tt.roam_list, list) {
...
bool V_89 = false ;
F_33 ( & V_24 -> V_9 . V_232 ) ;
F_128 (tt_roam_node, &bat_priv->tt.roam_list, list) {
if ( ! F_3 ( V_236 -> V_11 , V_235 ) )
continue;
if ( F_87 ( V_236 -> V_233 ,
V_234 ) )
continue;
if ( ! F_157 ( & V_236 -> V_237 ) )
goto V_62;
V_89 = true ;
break;
}
...
F_129 ( & V_236 -> V_46 , & V_24 -> V_9 . V_239 ) ;
V_89 = true ;
}
V_62:
F_35 ( & V_24 -> V_9 . V_232 ) ;
...
static void F_158 ( struct V_244 * V_245 )
{
struct V_246 * V_246 ;
struct V_247 * V_248 ;
struct V_23 * V_24 ;
...
F_126 ( V_24 ) ;
F_155 ( V_24 ) ;
F_159 ( V_250 , & V_24 -> V_9 . V_245 ,
F_160 ( V_251 ) ) ;
}
void F_161 ( struct V_23 * V_24 )
{
F_162 ( V_24 , V_135 , 1 ) ;
F_163 ( V_24 , V_135 , 1 ) ;
F_164 ( & V_24 -> V_9 . V_245 ) ;
F_89 ( V_24 ) ;
F_117 ( V_24 ) ;
F_124 ( V_24 ) ;
F_93 ( V_24 ) ;
...
if ( ! F_157 ( & V_24 -> V_9 . V_254 ) )
F_75 ( V_24 ) ;
return;
}
F_165 ( V_24 , V_104 , false , true ) ;
F_166 ( V_24 ) ;
F_137 ( V_24 ) ;
F_48 ( & V_24 -> V_9 . V_103 ) ;
F_56 ( V_79 , V_24 ,
...
void F_169 ( struct V_23 * V_24 )
{
F_33 ( & V_24 -> V_9 . V_225 ) ;
F_167 ( V_24 ) ;
F_35 ( & V_24 -> V_9 . V_225 ) ;
}
bool F_170 ( struct V_23 * V_24 , T_2 * V_188 ,
T_2 * V_256 , unsigned short V_13 )
{
struct V_22 * V_26 = NULL ;
struct V_29 * V_30 = NULL ;
struct V_40 * V_41 ;
...
bool F_174 ( struct V_23 * V_24 ,
struct V_43 * V_38 ,
const unsigned char * V_11 ,
unsigned short V_13 )
{
bool V_89 = false ;
if ( ! F_99 ( V_24 , V_38 , V_11 , V_13 ,
V_163 ,
F_20 ( & V_38 -> V_123 ) ) )
goto V_102;
F_56 ( V_79 , V_24 ,
...
V_42 = F_50 ( V_263 ) ;
F_171 ( V_24 , V_162 , V_120 , V_68 , V_117 ,
V_42 , V_116 -> V_122 ) ;
}
...
case V_213 :
F_141 ( V_24 , V_268 ) ;
V_89 = F_147 ( V_24 , V_116 , V_188 , V_256 ) ;
if ( ! V_89 ) {
if ( V_116 -> V_52 & V_214 )
V_265 = 'F' ;
else
...
L_50 ,
V_188 , V_271 -> V_235 ) ;
F_99 ( V_24 , V_38 , V_271 -> V_235 ,
F_135 ( V_271 -> V_13 ) , V_99 ,
F_20 ( & V_38 -> V_123 ) + 1 ) ;
V_102:
if ( V_38 )
F_145 ( V_38 ) ;
...
F_178 ,
V_243 , 1 , V_109 ) ;
F_182 ( & V_24 -> V_9 . V_245 , F_158 ) ;
F_159 ( V_250 , & V_24 -> V_9 . V_245 ,
F_160 ( V_251 ) ) ;
return 1 ;
}
bool F_183 ( struct V_23 * V_24 ,
const T_2 * V_11 , unsigned short V_13 )
{
struct V_29 * V_9 ;
bool V_89 ;
