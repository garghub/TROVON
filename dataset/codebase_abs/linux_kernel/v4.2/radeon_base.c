...
#endif
F_68 ( V_2 ) ;
F_95 ( V_2 , V_502 , V_503 ) ;
F_96 ( V_2 , V_504 ) ;
if ( V_2 -> V_470 )
V_477 |= F_97 ( & V_2 -> V_13 -> V_4 . V_467 ,
& V_505 ) ;
if ( V_2 -> V_471 )
V_477 |= F_97 ( & V_2 -> V_13 -> V_4 . V_467 ,
& V_506 ) ;
...
if ( V_508 < - 1 ) {
F_99 ( V_2 , V_2 -> V_128 ? 1 : - 1 , V_509 , V_510 ) ;
} else
F_99 ( V_2 , V_508 , V_509 , V_510 ) ;
F_100 ( V_13 , V_96 ) ;
V_474 = F_101 ( V_96 ) ;
if ( V_474 < 0 ) {
F_7 ( V_12 L_51 ,
...
static int T_9 F_115 ( char * V_516 )
{
char * V_517 ;
if ( ! V_516 || ! * V_516 )
return 0 ;
while ( ( V_517 = F_116 ( & V_516 , L_54 ) ) != NULL ) {
if ( ! * V_517 )
continue;
if ( ! strncmp ( V_517 , L_55 , 7 ) ) {
V_420 = 1 ;
} else if ( ! strncmp ( V_517 , L_56 , 6 ) ) {
V_136 = 1 ;
} else if ( ! strncmp ( V_517 , L_57 , 9 ) ) {
V_518 = 1 ;
} else if ( ! strncmp ( V_517 , L_58 , 11 ) ) {
V_519 = F_117 ( ( V_517 + 11 ) , NULL , 0 ) ;
} else if ( ! strncmp ( V_517 , L_59 , 10 ) ) {
V_514 = F_117 ( V_517 + 10 , NULL , 0 ) ;
} else if ( ! strncmp ( V_517 , L_60 , 6 ) ) {
V_512 = 1 ;
} else if ( ! strncmp ( V_517 , L_61 , 9 ) ) {
V_265 = 1 ;
} else if ( ! strncmp ( V_517 , L_62 , 17 ) ) {
V_90 = 1 ;
} else if ( ! strncmp ( V_517 , L_63 , 11 ) ) {
V_503 = 1 ;
#if F_29 ( V_520 ) && F_29 ( F_92 )
} else if ( ! strncmp ( V_517 , L_64 , 11 ) ) {
V_510 = 1 ;
} else if ( ! strncmp ( V_517 , L_65 , 14 ) ) {
V_509 = 1 ;
#endif
} else
V_504 = V_517 ;
