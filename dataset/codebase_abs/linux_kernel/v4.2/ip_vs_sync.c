...
struct V_219 * V_176 ;
int V_232 ;
V_232 = F_105 ( V_81 , V_233 , V_234 , V_235 , & V_176 ) ;
if ( V_232 < 0 ) {
F_45 ( L_34 ) ;
return F_106 ( V_232 ) ;
}
...
static struct V_219 * F_109 ( struct V_81 * V_81 , int V_85 )
{
struct V_8 * V_9 = F_44 ( V_81 ) ;
struct V_220 V_229 = {
. V_222 = V_88 ,
...
static int
F_110 ( struct V_219 * V_176 , const char * V_148 , const V_118 V_239 )
{
...
V_246 . V_248 = V_239 ;
V_86 = F_112 ( V_176 , & V_241 , & V_246 , 1 , ( V_118 ) ( V_239 ) ) ;
F_113 ( 7 ) ;
return V_86 ;
}
static int
F_114 ( struct V_219 * V_176 , struct V_29 * V_241 )
{
int V_249 ;
int V_216 ;
V_249 = F_46 ( V_241 -> V_28 ) ;
V_216 = F_110 ( V_176 , ( char * ) V_241 , V_249 ) ;
...
static int
F_115 ( struct V_219 * V_176 , char * V_148 , const V_118 V_149 )
{
...
V_86 = F_116 ( V_176 , & V_241 , & V_246 , 1 , V_149 , V_243 ) ;
if ( V_86 < 0 )
return V_86 ;
F_113 ( 7 ) ;
return V_86 ;
}
static void F_117 ( struct V_251 * V_252 )
{
struct V_10 * V_11 =
F_118 ( V_252 , struct V_10 ,
V_39 . V_252 ) ;
...
while ( F_114 ( V_255 -> V_176 , V_12 -> V_21 ) < 0 ) {
F_124 ( * F_125 ( V_177 ) ,
F_126 ( V_177 ) ||
F_122 () ) ;
if ( F_33 ( F_122 () ) )
...
while ( ! F_122 () ) {
F_128 ( * F_125 ( V_255 -> V_176 -> V_177 ) ,
! F_129 ( & V_255 -> V_176 -> V_177 -> V_258 )
|| F_122 () ) ;
while ( ! F_129 ( & ( V_255 -> V_176 -> V_177 -> V_258 ) ) ) {
V_86 = F_115 ( V_255 -> V_176 , V_255 -> V_259 ,
V_9 -> V_211 ) ;
if ( V_86 <= 0 ) {
if ( V_86 != - V_250 )
F_45 ( L_44 ) ;
...
int F_130 ( struct V_81 * V_81 , int V_63 , char * V_260 , T_1 V_26 )
{
struct V_254 * V_255 ;
...
struct V_8 * V_9 = F_44 ( V_81 ) ;
char * V_113 ;
int (* F_131)( void * V_161 );
int V_85 , V_264 ;
int V_232 = - V_135 ;
F_57 ( 7 , L_45 , V_265 , F_132 ( V_266 ) ) ;
F_57 ( 7 , L_46 ,
sizeof( struct F_43 ) ) ;
if ( ! V_9 -> V_37 ) {
V_264 = F_133 ( F_134 ( V_9 ) , 1 , V_267 ) ;
V_9 -> V_47 = V_264 - 1 ;
} else
V_264 = V_9 -> V_47 + 1 ;
if ( V_63 == V_38 ) {
...
if ( V_63 == V_38 ) {
struct V_10 * V_11 ;
V_9 -> V_11 = F_136 ( V_264 * sizeof( V_9 -> V_11 [ 0 ] ) , V_270 ) ;
if ( ! V_9 -> V_11 )
goto V_166;
V_11 = V_9 -> V_11 ;
...
V_262 = F_136 ( V_264 * sizeof( struct V_261 * ) ,
V_270 ) ;
if ( ! V_262 )
goto V_166;
}
...
V_255 -> V_85 = V_85 ;
V_263 = F_141 ( F_131 , V_255 , V_113 , V_9 -> V_273 , V_85 ) ;
if ( F_139 ( V_263 ) ) {
V_232 = F_140 ( V_263 ) ;
goto V_271;
}
...
int T_6 F_147 ( struct V_81 * V_81 )
{
struct V_8 * V_9 = F_44 ( V_81 ) ;
F_148 ( & V_9 -> V_275 , L_51 , & V_276 ) ;
F_149 ( & V_9 -> V_13 ) ;
F_149 ( & V_9 -> V_43 ) ;
return 0 ;
}
...
struct V_8 * V_9 = F_44 ( V_81 ) ;
F_151 ( & V_9 -> V_275 ) ;
V_165 = F_144 ( V_81 , V_38 ) ;
if ( V_165 && V_165 != - V_274 )
F_45 ( L_52 ) ;
V_165 = F_144 ( V_81 , V_209 ) ;
if ( V_165 && V_165 != - V_274 )
F_45 ( L_53 ) ;
F_152 ( & V_9 -> V_275 ) ;
}
