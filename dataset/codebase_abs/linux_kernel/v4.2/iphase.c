...
V_582 = 1 ;
F_88 ( & V_152 -> V_400 , V_158 ) ;
F_132 ( V_152 -> V_402 , ( V_12 -> V_21 <= 0 ) , V_582 ) ;
F_87 ( & V_152 -> V_400 , V_158 ) ;
V_152 -> V_401 -- ;
...
static int F_135 ( struct V_40 * V_41 , struct V_591 * V_53 , int V_158 )
{
F_10 (printk(L_144);)
return 0 ;
}
static int F_136 ( struct V_273 * V_9 , unsigned int V_592 , void T_15 * V_547 )
{
T_16 V_593 ;
T_2 * V_152 ;
int V_31 , V_594 ;
...
if ( F_139 ( V_593 . V_604 , V_152 , sizeof( T_2 ) ) )
return - V_598 ;
V_593 . V_62 = 0 ;
break;
case V_605 :
...
if( F_140 ( ( T_4 ) ( F_7 ( V_152 -> V_14 + V_31 ) & 0xffff ) , V_595 ) ) return - V_598 ;
V_593 . V_62 = 0 ;
V_593 . V_164 = 0x80 ;
break;
case V_606 :
...
V_595 = ( T_4 T_15 * ) V_593 . V_604 ;
for( V_31 = 0 ; V_31 < 0x80 ; V_31 += 2 , V_595 ++ )
if( F_140 ( ( T_4 ) ( F_7 ( V_152 -> V_279 + V_31 ) & 0xffff ) , V_595 ) ) return - V_598 ;
V_593 . V_62 = 0 ;
V_593 . V_164 = 0x80 ;
break;
case V_607 :
...
{
struct V_612 * V_300 ;
V_300 = & F_142 ( V_613 [ V_594 ] ) -> V_614 ;
F_9 ( L_149 , F_143 ( & V_300 -> V_615 ) ) ;
F_9 ( L_150 , F_143 ( & V_300 -> V_616 ) ) ;
F_9 ( L_151 , F_143 ( & V_300 -> V_617 ) ) ;
F_9 ( L_152 , F_143 ( & V_300 -> V_618 ) ) ;
F_9 ( L_153 , F_143 ( & V_300 -> V_619 ) ) ;
F_9 ( L_154 , F_143 ( & V_300 -> V_620 ) ) ;
F_9 ( L_155 , F_143 ( & V_300 -> V_621 ) ) ;
F_9 ( L_156 , F_143 ( & V_300 -> V_622 ) ) ;
F_9 ( L_157 , F_143 ( & V_300 -> V_623 ) ) ;
}
V_593 . V_62 = 0 ;
break;
case 0x9 :
...
static int F_145 ( struct V_40 * V_41 , int V_626 , int V_627 ,
...
static int F_149 ( struct V_273 * V_9 , T_20 * V_642 , char * V_643 )
{
...
V_9 = F_152 ( V_525 , & V_649 -> V_9 , & V_654 , - 1 , NULL ) ;
if ( ! V_9 ) {
V_410 = - V_399 ;
goto V_655;
}
