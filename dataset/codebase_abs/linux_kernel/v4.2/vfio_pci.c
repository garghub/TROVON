...
V_196 -> V_80 [ V_196 -> V_197 ++ ] = V_191 ;
return 0 ;
}
static void F_36 ( struct V_4 * V_5 )
{
struct V_195 V_196 = { . V_197 = 0 } ;
...
F_112 , & V_196 , V_93 ) )
goto V_201;
for ( V_88 = 0 ; V_88 < V_196 . V_197 ; V_88 ++ ) {
...
return;
V_202 = V_204 ;
while ( ( V_87 = F_118 ( & V_202 , L_6 ) ) ) {
unsigned int V_205 , V_191 , V_206 = V_207 ,
V_208 = V_207 , V_18 = 0 , V_209 = 0 ;
int V_210 ;
if ( ! strlen ( V_87 ) )
continue;
V_210 = sscanf ( V_87 , L_7 ,
& V_205 , & V_191 , & V_206 , & V_208 ,
& V_18 , & V_209 ) ;
if ( V_210 < 2 ) {
F_119 ( L_8 , V_87 ) ;
continue;
}
V_203 = F_120 ( & V_199 , V_205 , V_191 ,
V_206 , V_208 , V_18 , V_209 , 0 ) ;
if ( V_203 )
F_119 ( L_9 ,
V_205 , V_191 , V_206 , V_208 ,
V_18 , V_209 , V_203 ) ;
