...
static void F_42 ( struct V_6 * V_86 ,
T_4 V_25 , T_3 V_5 )
{
F_39 ( V_86 , V_25 , V_40 ) ;
if ( V_5 > V_40 )
F_39 ( V_86 , V_25 + V_5 - V_40 ,
V_40 ) ;
}
static T_1 * F_43 ( struct V_6 * V_86 ,
T_4 V_25 )
{
T_1 * V_88 , * V_51 ;
T_1 V_10 ;
...
static T_3 F_47 ( struct V_6 * V_86 ,
...
static int F_48 ( struct V_6 * V_86 , T_1 * V_64 ,
...
return 0 ;
V_105:
F_47 ( V_86 , V_64 , V_25 , V_101 * V_40 ) ;
V_25 += V_101 * V_40 ;
...
static int F_50 ( struct V_7 * V_9 , unsigned long V_107 ,
...
V_64 = & V_88 [ F_15 ( V_25 ) ] ;
V_45 = F_48 ( V_86 , V_64 , V_25 , V_103 , V_5 , V_19 ) ;
F_38 ( & V_86 -> V_89 , V_20 ) ;
return V_45 ;
}
static T_3 F_53 ( struct V_7 * V_9 , unsigned long V_107 ,
T_3 V_5 )
{
struct V_6 * V_86 = F_5 ( V_9 ) ;
unsigned long V_20 ;
...
V_108 = F_47 ( V_86 , V_64 , V_25 , V_5 ) ;
F_38 ( & V_86 -> V_89 , V_20 ) ;
F_39 ( V_86 , V_25 , V_108 ) ;
return V_108 ;
}
static struct V_32 * F_54 ( struct V_109 * V_47 )
{
struct V_110 * V_111 ;
struct V_109 * V_112 ;
struct V_32 * V_32 ;
...
static int F_59 ( struct V_7 * V_9 ,
struct V_109 * V_47 )
{
struct V_32 * V_33 ;
struct V_6 * V_86 = F_5 ( V_9 ) ;
...
return V_45 ;
V_33 -> V_9 = V_9 ;
V_45 = F_60 ( V_47 , V_33 -> V_69 , F_34 ,
V_113 , F_61 ( V_47 ) , V_33 ) ;
if ( V_45 )
return V_45 ;
V_51 = F_2 ( V_86 -> V_90 ) ;
F_19 ( V_33 , V_52 , V_51 ) ;
...
F_19 ( V_33 , V_52 , 0 ) ;
F_28 ( V_33 ) ;
F_66 ( V_47 , V_33 -> V_69 , V_33 ) ;
V_33 -> V_9 = NULL ;
F_63 ( V_47 , L_17 ) ;
}
static struct V_7 * F_67 ( unsigned type )
{
struct V_6 * V_86 ;
if ( type != V_116 )
return NULL ;
V_86 = F_68 ( sizeof( * V_86 ) , V_117 ) ;
if ( ! V_86 )
return NULL ;
V_86 -> V_90 = ( T_1 * ) F_45 ( V_117 | V_98 ) ;
if ( ! V_86 -> V_90 )
goto V_118;
F_1 ( V_86 -> V_90 , V_119 ) ;
F_69 ( & V_86 -> V_94 ) ;
...
static void F_72 ( struct V_7 * V_9 )
{
struct V_6 * V_86 = F_5 ( V_9 ) ;
int V_120 ;
F_73 ( ! F_74 ( & V_86 -> V_115 ) ) ;
for ( V_120 = 0 ; V_120 < V_119 ; V_120 ++ ) {
T_1 V_10 = V_86 -> V_90 [ V_120 ] ;
if ( F_8 ( V_10 ) ) {
T_2 V_14 = F_7 ( V_10 ) ;
T_1 * V_88 = F_33 ( V_14 ) ;
F_75 ( ( unsigned long ) V_88 ) ;
}
}
F_75 ( ( unsigned long ) V_86 -> V_90 ) ;
F_71 ( V_86 ) ;
}
static bool F_76 ( struct V_109 * V_47 )
{
struct V_121 * V_122 = V_47 -> V_123 ;
int V_45 ;
V_45 = F_77 ( V_122 , L_18 , L_19 ) ;
return ( V_45 > 0 ) ;
}
...
V_125 = F_80 ( args . V_122 ) ;
F_81 ( args . V_122 ) ;
if ( ! V_125 ) {
F_27 ( V_47 , L_22 , args . V_122 -> V_127 ) ;
return - V_130 ;
}
F_82 ( V_111 , & V_125 -> V_47 , NULL ) ;
return 0 ;
}
static int F_83 ( struct V_109 * V_47 )
{
struct V_110 * V_111 ;
int V_45 ;
if ( ! F_76 ( V_47 ) )
...
V_45 = F_85 ( V_111 , V_47 ) ;
if ( V_45 )
goto V_132;
V_45 = F_78 ( V_111 , V_47 ) ;
if ( V_45 )
goto V_133;
F_58 ( V_111 ) ;
return 0 ;
...
static void F_87 ( struct V_109 * V_47 )
{
if ( ! F_76 ( V_47 ) )
return;
F_86 ( V_47 ) ;
}
static int F_88 ( struct V_124 * V_134 )
{
struct V_109 * V_47 = & V_134 -> V_47 ;
struct V_32 * V_33 ;
struct V_135 * V_136 ;
V_33 = F_89 ( V_47 , sizeof( * V_33 ) , V_117 ) ;
if ( ! V_33 )
return - V_99 ;
F_90 ( V_134 , V_33 ) ;
V_33 -> V_47 = V_47 ;
V_136 = F_91 ( V_134 , V_137 , 0 ) ;
V_33 -> V_35 = F_92 ( & V_134 -> V_47 , V_136 ) ;
if ( F_51 ( V_33 -> V_35 ) )
return F_52 ( V_33 -> V_35 ) ;
V_33 -> V_69 = F_93 ( V_134 , 0 ) ;
if ( V_33 -> V_69 < 0 ) {
...
static int F_94 ( struct V_124 * V_134 )
{
return 0 ;
}
...
struct V_121 * V_122 ;
int V_45 ;
V_122 = F_96 ( NULL , V_139 ) ;
if ( ! V_122 )
return 0 ;
F_81 ( V_122 ) ;
V_45 = F_97 ( & V_140 , & V_141 ) ;
if ( V_45 )
return V_45 ;
return F_98 ( & V_142 ) ;
}
