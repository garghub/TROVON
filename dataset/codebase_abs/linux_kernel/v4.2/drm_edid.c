...
int F_139 ( struct V_40 * V_41 , struct V_12 * V_12 )
{
int V_338 = 0 ;
T_3 V_59 ;
if ( V_12 == NULL ) {
...
int F_140 ( struct V_40 * V_41 ,
int V_75 , int V_79 )
{
int V_2 , V_289 , V_338 = 0 ;
struct V_60 * V_73 ;
struct V_80 * V_52 = V_41 -> V_52 ;
V_289 = sizeof( V_85 ) / sizeof( struct V_60 ) ;
if ( V_75 < 0 )
V_75 = 0 ;
if ( V_79 < 0 )
V_79 = 0 ;
...
V_345 -> V_376 = F_144 ( V_73 ) ;
return 0 ;
}
static int F_147 ( struct V_40 * V_41 ,
T_1 * V_377 , int V_8 ,
bool V_378 )
{
int V_379 = 0 ;
...
V_397 = F_148 ( V_41 -> V_52 , V_391 -> V_405 ) ;
if ( ! V_397 ) {
...
if ( V_41 -> V_406 != V_397 ) {
if ( V_41 -> V_406 ) {
F_150 ( V_41 -> V_52 , V_41 -> V_406 ) ;
}
V_41 -> V_406 = V_397 ;
} else
F_150 ( V_41 -> V_52 , V_397 ) ;
}
break;
default:
F_9 ( L_46 , V_9 -> V_387 ) ;
...
V_29 = F_147 ( V_41 , V_377 , V_6 , true ) ;
if ( V_29 < 0 )
goto V_407;
if ( ! V_41 -> V_400 )
goto V_407;
