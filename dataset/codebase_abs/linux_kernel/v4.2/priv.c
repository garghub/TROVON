...
case 0x00002000 :
if ( ! F_64 ( V_2 -> V_17 , 78 ) ||
F_27 ( V_2 -> V_10 . V_11 -> V_12 ) . V_124 == V_125 )
return F_2 ( V_2 , V_16 ) ;
...
V_128 = F_35 ( V_2 , V_114 ) ;
else
V_128 = V_114 ;
V_127 = F_65 ( V_2 -> V_17 , F_66 ( V_128 ) ) ;
if ( F_67 ( V_127 ) )
return F_2 ( V_2 , V_24 ) ;
if ( V_2 -> V_39 -> V_40 . V_41 . V_42 [ V_113 ] & V_126 ) {
if ( F_68 ( ( void V_129 * ) V_127 , V_45 ) )
return F_2 ( V_2 , V_24 ) ;
}
...
V_135 = F_72 ( V_2 -> V_10 . V_11 -> V_135 ) ;
F_73 ( & V_137 -> V_132 -> V_139 ) ;
for ( V_6 = 0 ; V_6 < V_134 ; ++ V_6 ) {
V_136 = V_135 [ V_6 ] ;
if ( F_74 ( V_136 & ~ V_43 || V_136 < 2 * V_45 ) )
break;
F_75 ( V_137 , V_136 ) ;
}
F_76 ( & V_137 -> V_132 -> V_139 ) ;
if ( V_6 < V_134 )
return F_2 ( V_2 , V_16 ) ;
return 0 ;
}
...
{
T_10 V_111 ;
V_111 = V_140 [ V_2 -> V_10 . V_11 -> V_67 & 0x00ff ] ;
if ( V_111 )
return V_111 ( V_2 ) ;
return - V_68 ;
}
...
int V_141 = V_2 -> V_10 . V_11 -> V_67 & 0x000f ;
int V_142 , V_7 , V_143 ;
T_4 V_144 [ 16 ] ;
T_3 V_27 ;
T_2 V_8 ;
...
if ( V_27 & 3 )
return F_2 ( V_2 , V_16 ) ;
F_14 ( V_2 , 5 , L_14 , V_113 , V_141 , V_27 ) ;
F_80 ( V_2 , 0 , V_113 , V_141 , V_27 ) ;
V_143 = ( ( V_141 - V_113 ) & 0xf ) + 1 ;
V_7 = F_4 ( V_2 , V_27 , V_8 , V_144 , V_143 * sizeof( T_4 ) ) ;
if ( V_7 )
return F_5 ( V_2 , V_7 ) ;
V_142 = V_113 ;
V_143 = 0 ;
do {
V_2 -> V_10 . V_11 -> V_51 [ V_142 ] &= 0xffffffff00000000ul ;
V_2 -> V_10 . V_11 -> V_51 [ V_142 ] |= V_144 [ V_143 ++ ] ;
if ( V_142 == V_141 )
break;
V_142 = ( V_142 + 1 ) % 16 ;
} while ( 1 );
...
if ( V_27 & 3 )
return F_2 ( V_2 , V_16 ) ;
F_14 ( V_2 , 5 , L_15 , V_113 , V_141 , V_27 ) ;
F_83 ( V_2 , 0 , V_113 , V_141 , V_27 ) ;
V_142 = V_113 ;
V_143 = 0 ;
do {
V_144 [ V_143 ++ ] = V_2 -> V_10 . V_11 -> V_51 [ V_142 ] ;
if ( V_142 == V_141 )
break;
V_142 = ( V_142 + 1 ) % 16 ;
} while ( 1 );
V_7 = F_18 ( V_2 , V_27 , V_8 , V_144 , V_143 * sizeof( T_4 ) ) ;
...
if ( V_27 & 7 )
return F_2 ( V_2 , V_16 ) ;
F_14 ( V_2 , 5 , L_16 , V_113 , V_141 , V_27 ) ;
F_80 ( V_2 , 1 , V_113 , V_141 , V_27 ) ;
V_143 = ( ( V_141 - V_113 ) & 0xf ) + 1 ;
V_7 = F_4 ( V_2 , V_27 , V_8 , V_144 , V_143 * sizeof( T_3 ) ) ;
if ( V_7 )
return F_5 ( V_2 , V_7 ) ;
V_142 = V_113 ;
V_143 = 0 ;
...
if ( V_27 & 7 )
return F_2 ( V_2 , V_16 ) ;
F_14 ( V_2 , 5 , L_17 , V_113 , V_141 , V_27 ) ;
F_83 ( V_2 , 1 , V_113 , V_141 , V_27 ) ;
V_142 = V_113 ;
V_143 = 0 ;
do {
V_144 [ V_143 ++ ] = V_2 -> V_10 . V_11 -> V_51 [ V_142 ] ;
...
V_7 = F_18 ( V_2 , V_27 , V_8 , V_144 , V_143 * sizeof( T_3 ) ) ;
return V_7 ? F_5 ( V_2 , V_7 ) : 0 ;
}
int F_87 ( struct V_1 * V_2 )
{
T_10 V_111 ;
V_111 = V_150 [ V_2 -> V_10 . V_11 -> V_64 & 0xff ] ;
if ( V_111 )
return V_111 ( V_2 ) ;
return - V_68 ;
}
...
if ( V_2 -> V_10 . V_11 -> V_12 . V_13 & V_14 )
return F_2 ( V_2 , V_15 ) ;
F_89 ( V_2 , & V_151 , & V_152 , & V_8 , NULL ) ;
if ( V_152 & 0xf0 )
return - V_68 ;
if ( V_2 -> V_10 . V_11 -> V_12 . V_13 & V_159 )
F_90 ( V_2 ) ;
V_155 = F_91 ( V_2 , V_151 , V_8 , & V_154 , 1 ) ;
if ( V_155 == V_160 ) {
V_156 = 1 ;
V_155 = F_91 ( V_2 , V_151 , V_8 , & V_154 , 0 ) ;
}
if ( V_155 ) {
if ( V_155 == V_24 || V_155 == V_161 ) {
V_155 = F_2 ( V_2 , V_155 ) ;
} else if ( V_155 > 0 ) {
F_7 ( V_2 , 3 ) ;
V_155 = 0 ;
...
V_153 = F_92 ( V_2 -> V_17 , F_66 ( V_154 ) , & V_157 ) ;
if ( F_67 ( V_153 ) ) {
V_155 = F_2 ( V_2 , V_24 ) ;
} else {
if ( ! V_157 )
...
return F_2 ( V_2 ,
V_16 ) ;
V_163 = V_2 -> V_39 -> V_40 . V_41 . V_42 [ 0 ] & 0x000000000000ffff ;
V_2 -> V_10 . V_11 -> V_164 = V_163 ;
return 0 ;
}
int F_96 ( struct V_1 * V_2 )
{
T_10 V_111 ;
V_111 = V_165 [ V_2 -> V_10 . V_11 -> V_67 & 0x00ff ] ;
if ( V_111 )
return V_111 ( V_2 ) ;
return - V_68 ;
}
