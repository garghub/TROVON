...
static T_2 F_131 ( struct V_79 * V_17 , T_2 V_307 )
{
...
static T_9 F_133 ( int V_301 , void * V_302 )
{
...
if ( ! V_256 )
return V_304 ;
V_307 = V_256 & V_16 -> V_51 ;
F_134 ( & V_17 -> V_30 ) ;
F_3 ( V_256 , V_1 + V_168 ) ;
V_129 = F_131 ( V_17 , V_307 ) ;
F_135 ( & V_17 -> V_30 ) ;
F_59 ( L_52 ) ;
return F_136 ( V_129 ) ;
}
static T_9 F_137 ( int V_301 , void * V_302 )
{
struct V_79 * V_17 = V_302 ;
struct V_15 * V_16 ;
unsigned int V_129 = 0 ;
...
unsigned int F_138 ( struct V_230 * V_231 )
{
struct V_13 * V_14 = V_231 -> V_14 ;
void T_1 * V_22 = F_12 ( V_14 ) ;
struct V_98 * V_99 = V_14 -> V_18 ;
...
static bool F_139 ( struct V_230 * V_231 )
{
...
! ( V_231 -> V_28 & V_317 ) ) {
F_140 ( V_223 + V_318 , & V_231 -> V_319 ) ;
V_231 -> V_319 . V_226 = ( V_223 + V_318 ) [ 15 ] ;
} else
F_140 ( V_223 + V_224 , & V_231 -> V_319 ) ;
return true ;
}
...
static int F_152 ( struct V_13 * V_14 , T_10 V_348 )
{
const char * V_138 = NULL ;
int V_129 ;
V_129 = F_42 ( V_14 , & V_138 ) ;
...
T_5 V_350 ;
T_4 V_351 , V_352 ;
V_99 = F_155 ( V_7 , sizeof( * V_99 ) , V_353 ) ;
if ( ! V_99 )
return - V_354 ;
if ( V_14 -> V_17 -> V_169 > 1 ) {
V_99 -> V_355 = F_155 ( V_7 , 8 , V_353 ) ;
if ( ! V_99 -> V_355 ) {
F_156 ( V_7 , V_99 ) ;
return - V_354 ;
}
...
V_349 = F_159 ( V_7 , V_351 , & V_350 , V_353 ) ;
if ( ! V_349 )
return - V_354 ;
...
void F_162 ( struct V_79 * V_17 , const char * V_362 )
{
struct V_15 * V_16 = V_17 -> V_18 ;
void T_1 * V_1 = V_16 -> V_1 ;
...
static int F_164 ( struct V_79 * V_17 , int V_301 ,
struct V_386 * V_387 )
{
int V_2 , V_129 ;
V_129 = F_165 ( V_17 ) ;
...
V_129 = F_167 ( V_17 -> V_7 , V_301 + V_2 ,
F_129 ,
F_125 , V_388 ,
...
for ( V_2 = 0 ; V_2 < V_17 -> V_169 ; V_2 ++ )
F_168 ( V_17 -> V_170 [ V_2 ] , L_97 , V_301 + V_2 ) ;
V_129 = F_169 ( V_17 , V_387 ) ;
if ( V_129 )
goto V_390;
return 0 ;
V_390:
...
V_389:
for ( V_2 -- ; V_2 >= 0 ; V_2 -- )
F_170 ( V_17 -> V_7 , V_301 + V_2 , V_17 -> V_170 [ V_2 ] ) ;
return V_129 ;
}
int F_171 ( struct V_79 * V_17 , struct V_386 * V_387 )
{
struct V_15 * V_16 = V_17 -> V_18 ;
int V_301 = V_16 -> V_301 ;
int V_129 ;
if ( V_16 -> V_28 & V_361 )
V_129 = F_164 ( V_17 , V_301 , V_387 ) ;
else if ( V_16 -> V_28 & V_391 )
V_129 = F_172 ( V_17 , V_301 , F_133 ,
V_388 , V_387 ) ;
else
V_129 = F_172 ( V_17 , V_301 , F_137 ,
V_388 , V_387 ) ;
return V_129 ;
}
