...
struct V_103 * V_104 )
{
struct V_105 * V_106 = & V_104 -> V_104 ;
struct V_2 * V_3 = F_15 ( V_48 ) ;
struct V_1 * V_17 = F_1 ( V_3 ) ;
if ( V_104 -> V_107 )
return - V_52 ;
...
V_106 -> V_37 = V_17 -> V_10 -> V_37 ;
V_106 -> V_38 = V_17 -> V_10 -> V_38 ;
V_106 -> V_108 = V_109 ;
V_106 -> V_110 = V_111 ;
V_106 -> V_112 = V_113 ;
return 0 ;
...
struct V_105 * V_106 )
{
T_4 V_37 = V_106 -> V_37 , V_38 = V_106 -> V_38 ;
int V_11 ;
F_30 ( V_106 -> V_112 != V_114 &&
V_106 -> V_112 != V_113 ) ;
...
if ( V_104 -> V_107 )
return - V_52 ;
if ( V_114 == V_106 -> V_112 ) {
V_106 -> V_112 = V_113 ;
} else if ( V_113 != V_106 -> V_112 ) {
F_16 ( & V_3 -> V_51 , L_4 , V_106 -> V_112 ) ;
return - V_52 ;
}
V_106 -> V_108 = V_109 ;
V_106 -> V_110 = V_111 ;
V_10 = F_12 ( V_17 -> V_36 , V_106 -> V_37 , V_106 -> V_38 ) ;
if ( ! V_10 )
return - V_52 ;
V_106 -> V_37 = V_10 -> V_37 ;
V_106 -> V_38 = V_10 -> V_38 ;
if ( V_104 -> V_115 == V_116 )
return F_29 ( V_48 , V_106 ) ;
V_102 -> V_117 = * V_106 ;
return 0 ;
}
...
struct V_2 * V_3 = F_15 ( V_48 ) ;
struct V_62 * V_63 = F_23 ( V_3 ) ;
V_102 -> V_126 = V_127 | V_128 |
V_129 | V_130 |
V_131 | V_132 |
V_133 ;
V_102 -> type = V_134 ;
V_102 -> V_126 = F_38 ( V_63 , V_102 ) ;
return 0 ;
}
static int F_39 ( struct V_47 * V_48 ,
const struct V_125 * V_102 )
{
struct V_2 * V_3 = F_15 ( V_48 ) ;
struct V_62 * V_63 = F_23 ( V_3 ) ;
T_1 V_8 = V_135 | V_136 ;
unsigned long V_126 = F_38 ( V_63 , V_102 ) ;
if ( V_126 & V_132 )
V_8 |= V_137 ;
if ( V_126 & V_130 )
V_8 |= V_138 ;
return F_6 ( V_3 , V_139 , V_8 ) ;
}
...
V_17 = F_44 ( & V_3 -> V_51 , sizeof( * V_17 ) , V_149 ) ;
if ( ! V_17 )
return - V_150 ;
V_17 -> V_67 = V_67 ;
F_45 ( & V_17 -> V_4 , V_3 , & V_151 ) ;
