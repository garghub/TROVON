...
if ( F_49 () == V_154 ) {
struct V_155 V_30 ;
memset ( & V_30 , 0 , sizeof( struct V_155 ) ) ;
V_30 . type = V_156 ;
V_30 . V_157 = V_9 ;
V_158 = F_50 ( V_159 ,
NULL , NULL ,
...
if ( ! V_131 )
return 0 ;
V_13 = F_61 ( & V_168 -> V_45 , sizeof( struct V_48 ) , V_172 ) ;
if ( ! V_13 )
return - V_143 ;
F_40 ( V_13 ) ;
V_52 = F_62 ( & V_168 -> V_45 . V_173 , & V_174 ) ;
if ( V_52 )
return V_52 ;
V_169 = F_63 ( & V_168 -> V_45 ,
L_12 , V_13 ,
V_175 ) ;
if ( F_51 ( V_169 ) ) {
V_52 = F_52 ( V_169 ) ;
...
F_38 ( V_13 ) ;
V_171 . V_176 = V_13 ;
V_13 -> V_91 = F_64 ( & V_139 -> V_45 , & V_177 ,
& V_171 ) ;
if ( F_51 ( V_13 -> V_91 ) ) {
V_52 = F_52 ( V_13 -> V_91 ) ;
goto remove;
