...
V_15 -> V_99 = V_62 -> V_99 ;
#ifdef F_47
V_15 -> V_100 = F_48 ( V_5 -> V_42 , sizeof( * V_15 -> V_100 ) , V_101 ) ;
if ( ! V_15 -> V_100 )
return - V_102 ;
#endif
...
V_98 = V_5 -> V_9 + V_107 +
( V_62 -> V_99 * V_108 ) ;
V_69 = F_49 ( & V_15 -> V_3 , V_5 -> V_42 , 4 , V_96 , V_97 , NULL , V_98 ,
NULL , false ) ;
if ( V_69 ) {
F_28 ( V_5 -> V_42 , L_6 ,
V_62 -> V_109 ) ;
...
if ( V_120 == 0 )
return F_56 ( - V_121 ) ;
V_119 = F_48 ( V_42 , sizeof( * V_119 ) , V_101 ) ;
if ( ! V_119 )
return F_56 ( - V_102 ) ;
V_119 -> V_122 = F_58 ( V_42 , V_120 , sizeof( * V_62 ) , V_101 ) ;
if ( ! V_119 -> V_122 )
return F_56 ( - V_102 ) ;
V_119 -> V_120 = V_120 ;
V_70 = 0 ;
...
if ( ! V_119 -> V_120 )
return - V_121 ;
V_5 = F_48 ( & V_126 -> V_42 , sizeof( * V_5 ) , V_101 ) ;
if ( ! V_5 )
return - V_102 ;
V_5 -> V_42 = & V_126 -> V_42 ;
V_5 -> V_115 = V_119 -> V_120 ;
V_5 -> V_7 = F_58 ( & V_126 -> V_42 , V_5 -> V_115 ,
sizeof( * V_5 -> V_7 ) , V_101 ) ;
if ( ! V_5 -> V_7 )
return - V_102 ;
V_128 = F_68 ( V_126 , V_129 , 0 ) ;
V_5 -> V_9 = F_69 ( & V_126 -> V_42 , V_128 ) ;
if ( F_66 ( V_5 -> V_9 ) )
return F_67 ( V_5 -> V_9 ) ;
...
static int F_73 ( struct V_117 * V_42 )
{
struct V_125 * V_126 = F_74 ( V_42 ) ;
struct V_4 * V_5 = F_72 ( V_126 ) ;
struct V_2 * V_3 = & V_5 -> V_7 [ 0 ] . V_3 ;
unsigned long V_39 ;
int V_70 ;
...
static int F_76 ( struct V_117 * V_42 )
{
struct V_125 * V_126 = F_74 ( V_42 ) ;
struct V_4 * V_5 = F_72 ( V_126 ) ;
struct V_2 * V_3 = & V_5 -> V_7 [ 0 ] . V_3 ;
