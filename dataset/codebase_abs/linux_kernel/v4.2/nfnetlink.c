...
V_57 = V_21 -> V_56 ;
if ( V_26 -> F_28 < V_70 ||
V_21 -> V_56 < V_70 + sizeof( struct V_30 ) )
return;
V_30 = F_55 ( V_26 ) ;
F_52 ( V_21 , V_57 ) ;
F_46 ( V_21 , V_26 , V_30 -> V_73 ) ;
} else {
F_56 ( V_21 , & F_26 ) ;
}
}
...
static void T_8 F_60 ( struct V_44 * V_85 )
{
struct V_14 * V_14 ;
...
{
int V_86 ;
for ( V_86 = V_74 + 1 ; V_86 <= V_75 ; V_86 ++ )
F_66 ( V_76 [ V_86 ] == V_87 ) ;
for ( V_86 = 0 ; V_86 < V_8 ; V_86 ++ )
F_67 ( & V_2 [ V_86 ] . V_3 ) ;
F_68 ( L_2 , V_88 ) ;
return F_69 ( & V_89 ) ;
}
