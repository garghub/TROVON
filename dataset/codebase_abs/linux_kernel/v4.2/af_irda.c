...
V_8 = F_65 ( V_139 , V_144 , V_35 , & V_145 , V_141 ) ;
if ( V_8 == NULL )
return - V_69 ;
V_6 = F_43 ( V_8 ) ;
F_3 ( L_36 , V_10 , V_6 ) ;
...
static int F_79 ( struct V_93 * V_7 , struct V_161 * V_162 , T_10 V_163 )
{
struct V_7 * V_8 = V_7 -> V_8 ;
struct V_5 * V_6 ;
struct V_3 * V_4 ;
int V_9 = - V_164 ;
F_3 ( L_37 , V_10 , V_163 ) ;
if ( V_162 -> V_165 & ~ ( V_166 | V_167 | V_168 |
V_169 ) ) {
return - V_112 ;
}
F_45 ( V_8 ) ;
...
V_4 = F_80 ( V_8 , V_163 + V_6 -> V_24 + 16 ,
V_162 -> V_165 & V_166 , & V_9 ) ;
if ( ! V_4 )
goto V_170;
F_18 ( V_4 , V_6 -> V_24 + 16 ) ;
F_81 ( V_4 ) ;
F_82 ( V_4 , V_163 ) ;
V_9 = F_83 ( F_84 ( V_4 ) , V_162 , V_163 ) ;
if ( V_9 ) {
F_14 ( V_4 ) ;
goto V_170;
}
...
return V_163 ;
V_170:
V_9 = F_86 ( V_8 , V_162 -> V_165 , V_9 ) ;
V_107:
F_46 ( V_8 ) ;
return V_9 ;
}
static int F_87 ( struct V_93 * V_7 , struct V_161 * V_162 ,
T_10 V_171 , int V_122 )
{
struct V_7 * V_8 = V_7 -> V_8 ;
struct V_5 * V_6 = F_43 ( V_8 ) ;
struct V_3 * V_4 ;
...
F_89 ( V_4 , 0 , V_162 , V_172 ) ;
F_90 ( V_8 , V_4 ) ;
if ( V_6 -> V_11 == V_12 ) {
if ( ( F_91 ( & V_8 -> V_174 ) << 2 ) <= V_8 -> V_175 ) {
F_3 ( L_41 , V_10 ) ;
V_6 -> V_11 = V_40 ;
F_92 ( V_6 -> V_20 , V_40 ) ;
}
...
static int F_93 ( struct V_93 * V_7 , struct V_161 * V_162 ,
T_10 V_171 , int V_122 )
{
struct V_7 * V_8 = V_7 -> V_8 ;
struct V_5 * V_6 = F_43 ( V_8 ) ;
int V_176 = V_122 & V_166 ;
T_10 V_172 = 0 ;
int V_177 , V_9 ;
long V_178 ;
if ( ( V_9 = F_64 ( V_8 ) ) < 0 )
...
return - V_105 ;
V_9 = 0 ;
V_177 = F_94 ( V_8 , V_122 & V_181 , V_171 ) ;
V_178 = F_95 ( V_8 , V_176 ) ;
do {
int V_182 ;
...
if ( V_172 >= V_177 )
break;
F_97 ( F_23 ( V_8 ) , & V_183 , V_184 ) ;
V_9 = F_64 ( V_8 ) ;
if ( V_9 )
;
else if ( V_8 -> V_17 & V_185 )
;
else if ( V_176 )
V_9 = - V_186 ;
else if ( F_98 ( V_187 ) )
...
V_182 = F_102 (unsigned int, skb->len, size) ;
if ( F_103 ( V_162 , V_4 -> V_188 , V_182 ) ) {
F_104 ( & V_8 -> V_32 , V_4 ) ;
if ( V_172 == 0 )
V_172 = - V_189 ;
break;
...
static int F_106 ( struct V_93 * V_7 , struct V_161 * V_162 ,
T_10 V_163 )
{
struct V_7 * V_8 = V_7 -> V_8 ;
struct V_5 * V_6 ;
...
static int F_109 ( struct V_93 * V_7 , struct V_161 * V_162 ,
T_10 V_163 )
{
struct V_7 * V_8 = V_7 -> V_8 ;
struct V_5 * V_6 ;
...
V_6 = F_43 ( V_8 ) ;
if ( V_162 -> V_194 ) {
F_110 ( struct V_98 * , V_111 , V_162 -> V_194 ) ;
V_9 = - V_112 ;
if ( V_162 -> V_195 < sizeof( * V_111 ) )
goto V_107;
...
static int F_112 ( struct V_93 * V_7 , int V_196 )
{
struct V_7 * V_8 = V_7 -> V_8 ;
struct V_5 * V_6 = F_43 ( V_8 ) ;
F_3 ( L_2 , V_10 , V_6 ) ;
...
static unsigned int F_113 ( struct V_197 * V_197 , struct V_93 * V_7 ,
T_11 * V_183 )
{
struct V_7 * V_8 = V_7 -> V_8 ;
struct V_5 * V_6 = F_43 ( V_8 ) ;
unsigned int V_89 ;
F_114 ( V_197 , F_23 ( V_8 ) , V_183 ) ;
V_89 = 0 ;
if ( V_8 -> V_198 )
V_89 |= V_199 ;
if ( V_8 -> V_17 & V_185 ) {
...
static int F_117 ( struct V_93 * V_7 , unsigned int V_206 , unsigned long V_207 )
{
struct V_7 * V_8 = V_7 -> V_8 ;
int V_9 ;
F_3 ( L_49 , V_10 , V_206 ) ;
...
case V_208 : {
long V_209 ;
V_209 = V_8 -> V_210 - F_118 ( V_8 ) ;
if ( V_209 < 0 )
V_209 = 0 ;
V_9 = F_119 ( V_209 , ( unsigned int V_211 * ) V_207 ) ;
break;
}
case V_212 : {
struct V_3 * V_4 ;
...
case V_213 :
if ( V_8 != NULL )
V_9 = F_120 ( V_8 , (struct V_214 V_211 * ) V_207 ) ;
break;
case V_215 :
case V_216 :
case V_217 :
...
static int F_121 ( struct V_93 * V_7 , unsigned int V_206 , unsigned long V_207 )
{
return - V_225 ;
}
static int F_122 ( struct V_93 * V_7 , int V_226 , int V_227 ,
char V_211 * V_228 , unsigned int V_229 )
{
struct V_7 * V_8 = V_7 -> V_8 ;
struct V_5 * V_6 = F_43 ( V_8 ) ;
struct V_230 * V_231 ;
...
switch ( V_227 ) {
case V_239 :
if ( V_229 != sizeof( struct V_230 ) ) {
V_9 = - V_112 ;
goto V_107;
}
V_231 = F_123 ( sizeof( struct V_230 ) , V_240 ) ;
if ( V_231 == NULL ) {
V_9 = - V_69 ;
goto V_107;
}
if ( F_124 ( V_231 , V_228 , V_229 ) ) {
F_41 ( V_231 ) ;
V_9 = - V_189 ;
goto V_107;
}
...
if( V_117 == (struct V_232 * ) NULL ) {
V_117 = F_49 ( V_231 -> V_241 ,
V_119 ) ;
if ( V_117 == NULL ) {
F_41 ( V_231 ) ;
V_9 = - V_69 ;
...
V_117 ,
V_231 -> V_243 ,
V_231 -> V_245 . V_249 . V_251 ,
V_231 -> V_245 . V_249 . V_163 ,
V_247 ) ;
break;
case V_252 :
V_231 -> V_245 . V_253 . string [ V_231 -> V_245 . V_253 . V_163 ] = '\0' ;
F_129 (
V_117 ,
V_231 -> V_243 ,
V_231 -> V_245 . V_253 . string ,
V_247 ) ;
break;
default :
F_41 ( V_231 ) ;
...
V_234 = F_127 ( V_117 ,
V_231 -> V_243 ) ;
if( V_234 == (struct V_233 * ) NULL ) {
F_41 ( V_231 ) ;
V_9 = - V_112 ;
goto V_107;
}
if( V_234 -> V_44 -> V_255 != V_247 ) {
F_3 ( L_51 ,
V_10 ) ;
F_41 ( V_231 ) ;
V_9 = - V_129 ;
...
if ( F_131 ( V_235 , ( int V_211 * ) V_228 ) ) {
V_9 = - V_189 ;
goto V_107;
}
if ( V_8 -> V_26 != V_29 ) {
...
static int F_133 ( struct V_230 * V_231 ,
struct V_43 * V_43 )
{
switch ( V_43 -> type ) {
case V_81 :
V_231 -> V_245 . V_246 = V_43 -> V_82 . integer ;
break;
case V_248 :
V_231 -> V_245 . V_249 . V_163 = V_43 -> V_163 ;
memcpy ( V_231 -> V_245 . V_249 . V_251 ,
V_43 -> V_82 . V_259 , V_43 -> V_163 ) ;
break;
case V_252 :
V_231 -> V_245 . V_253 . V_163 = V_43 -> V_163 ;
V_231 -> V_245 . V_253 . V_260 = V_43 -> V_260 ;
memcpy ( V_231 -> V_245 . V_253 . string ,
V_43 -> V_82 . string , V_43 -> V_163 ) ;
V_231 -> V_245 . V_253 . string [ V_43 -> V_163 ] = '\0' ;
break;
case V_261 :
default :
return - V_112 ;
}
V_231 -> V_244 = V_43 -> type ;
return 0 ;
}
static int F_134 ( struct V_93 * V_7 , int V_226 , int V_227 ,
char V_211 * V_228 , int V_211 * V_229 )
{
struct V_7 * V_8 = V_7 -> V_8 ;
struct V_5 * V_6 = F_43 ( V_8 ) ;
struct V_262 V_263 ;
...
V_84 = F_40 ( & V_263 . V_163 , V_6 -> V_89 . V_90 ,
V_6 -> V_91 ) ;
if ( V_84 == NULL ) {
V_9 = - V_186 ;
goto V_107;
}
if ( F_135 ( V_228 , & V_263 , V_266 ) )
V_9 = - V_189 ;
if ( V_263 . V_163 > 2048 ) {
V_9 = - V_112 ;
goto V_269;
}
V_267 = V_266 + ( V_263 . V_163 * sizeof( struct V_264 ) ) ;
if ( V_267 > V_163 )
V_267 = V_163 ;
if ( F_135 ( V_228 + V_266 , V_84 , V_267 - V_266 ) )
V_9 = - V_189 ;
if ( F_119 ( V_267 , V_229 ) )
V_9 = - V_189 ;
V_269:
F_41 ( V_84 ) ;
break;
...
V_265 = V_6 -> V_28 ;
V_163 = sizeof( int ) ;
if ( F_119 ( V_163 , V_229 ) ) {
V_9 = - V_189 ;
goto V_107;
}
if ( F_135 ( V_228 , & V_265 , V_163 ) ) {
V_9 = - V_189 ;
goto V_107;
}
break;
case V_270 :
if ( V_163 != sizeof( struct V_230 ) ) {
V_9 = - V_112 ;
goto V_107;
}
V_231 = F_123 ( sizeof( struct V_230 ) , V_240 ) ;
...
V_9 = F_133 ( V_231 , V_234 -> V_44 ) ;
if( V_9 ) {
F_41 ( V_231 ) ;
goto V_107;
}
if ( F_135 ( V_228 , V_231 ,
sizeof( struct V_230 ) ) ) {
F_41 ( V_231 ) ;
V_9 = - V_189 ;
goto V_107;
...
if ( F_131 ( V_265 , ( int V_211 * ) V_228 ) ) {
V_9 = - V_189 ;
goto V_107;
}
