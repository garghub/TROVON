...
if ( ! V_2 -> V_13 )
goto V_34;
memset ( V_2 -> V_10 , 0xff , V_2 -> V_12 ) ;
V_2 -> V_31 = F_7 ( 0 , V_2 -> V_10 , V_2 -> V_28 ) ;
memset ( V_2 -> V_13 , 0xff , V_2 -> V_15 ) ;
F_2 ( V_7 , L_7 ,
V_8 , V_2 , V_21 -> V_35 ) ;
F_2 ( V_7 , L_8 ,
...
goto V_23;
V_34:
F_8 ( V_5 -> V_4 -> V_32 , V_2 -> V_12 , V_2 -> V_10 , V_2 -> V_11 ) ;
V_33:
F_9 ( V_2 ) ;
V_2 = NULL ;
V_23:
...
if ( V_2 -> V_25 != V_26 )
F_4 ( L_11 ) ;
F_8 ( V_4 -> V_32 , V_2 -> V_12 , V_2 -> V_10 , V_2 -> V_11 ) ;
F_8 ( V_4 -> V_32 , V_2 -> V_15 , V_2 -> V_13 , V_2 -> V_14 ) ;
F_9 ( V_2 ) ;
return V_37 ;
}
int F_11 ( struct V_18 * V_5 , int V_6 )
{
struct V_3 * V_4 = V_5 -> V_4 ;
if ( ( V_6 < 0 ) || ( V_6 >= V_5 -> V_38 . V_39 ) )
return - V_40 ;
F_2 ( V_7 , L_12 , V_8 , V_6 ) ;
F_12 ( V_5 -> V_41 + ( sizeof( T_1 ) * V_6 ) , 0 ) ;
return 0 ;
}
...
V_2 -> V_27 = 0 ;
F_12 ( V_5 -> V_41 + ( sizeof( T_1 ) * V_6 ) , 0 ) ;
F_12 ( V_5 -> V_43 + ( ( sizeof( T_1 ) * 2 ) * V_6 ) , V_2 -> V_14 ) ;
F_12 ( V_5 -> V_44 + ( ( sizeof( T_1 ) * 2 ) * V_6 ) , 0 ) ;
F_2 ( V_7 , L_13
L_14 ,
V_2 -> V_9 ,
( V_17 ) V_5 -> V_41 + ( V_6 * sizeof( T_1 ) ) ,
F_14 ( V_5 -> V_41 + ( sizeof( T_1 ) * V_6 ) ) ,
( V_17 ) V_5 -> V_43 + ( ( sizeof( T_1 ) * 2 ) * V_6 ) ,
( V_17 ) V_5 -> V_44 + ( ( sizeof( T_1 ) * 2 ) * V_6 ) ,
F_14 ( V_5 -> V_43 + ( ( sizeof( T_1 ) * V_6 ) * 2 ) ) ,
F_14 ( V_5 -> V_44 + ( ( sizeof( T_1 ) * V_6 ) * 2 ) ) ,
V_2 -> V_9 ) ;
return 0 ;
}
int F_15 ( struct V_18 * V_5 )
{
struct V_20 * V_21 = & V_5 -> V_22 ;
struct V_3 * V_4 = V_5 -> V_4 ;
struct V_1 * V_2 ;
...
F_12 ( V_5 -> V_49 , 0 ) ;
F_12 ( V_5 -> V_29 , V_21 -> V_29 ) ;
F_12 ( V_5 -> V_50 , V_21 -> V_29 * V_21 -> V_30 ) ;
F_2 ( V_7 , L_16 ) ;
...
F_16 ( & V_5 -> V_52 ) ;
F_17 (c, n, &port->dmaqueue.list) {
V_2 = F_18 ( V_46 , struct V_1 , V_53 ) ;
if ( V_2 -> V_25 != V_26 )
F_19 () ;
F_13 ( V_2 , V_6 ) ;
...
struct V_54 * F_21 ( struct V_3 * V_4 ,
T_1 V_19 )
{
struct V_54 * V_2 ;
