...
{
struct V_7 * V_7 = F_48 ( V_36 ) ;
struct V_3 * V_4 = F_49 ( V_7 ) ;
int V_21 ;
V_21 = F_50 ( & V_4 -> V_2 ) ;
if ( ! V_21 )
F_51 ( V_7 ) ;
...
static int F_52 ( struct V_64 * V_36 )
{
struct V_7 * V_7 = F_48 ( V_36 ) ;
struct V_3 * V_4 = F_49 ( V_7 ) ;
int V_21 ;
...
struct V_3 * V_4 ;
int V_68 ;
V_4 = F_23 ( sizeof( struct V_3 ) , V_40 ) ;
if ( ! V_4 )
return - V_39 ;
F_59 ( V_7 , V_4 ) ;
V_4 -> V_2 . V_36 . V_69 = & V_7 -> V_36 ;
V_4 -> V_2 . V_36 . V_70 = F_56 ;
V_4 -> V_7 = V_7 ;
F_33 ( & V_4 -> V_48 ) ;
F_60 ( & V_4 -> V_24 ) ;
V_68 = F_53 ( V_7 ) ;
