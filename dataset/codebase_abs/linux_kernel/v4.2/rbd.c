...
default:
F_103 ( NULL , L_30 ,
V_183 -> V_242 , ( unsigned short ) V_224 ) ;
break;
}
if ( F_109 ( V_183 ) )
F_148 ( V_183 ) ;
...
F_17 ( V_246 == 1 || ( ( V_88 == V_90 ) && V_246 == 2 ) ) ;
V_207 = & V_22 -> V_53 -> V_63 -> V_207 ;
V_208 = F_163 ( V_207 , V_113 , V_246 , false ,
V_247 ) ;
if ( ! V_208 )
return NULL ;
if ( V_88 == V_90 || V_88 == V_91 )
V_208 -> V_248 = V_249 | V_250 ;
else
V_208 -> V_248 = V_251 ;
V_208 -> V_252 = F_158 ;
V_208 -> V_223 = V_183 ;
V_208 -> V_253 . V_254 = F_164 ( V_22 -> V_255 ) ;
F_165 ( & V_208 -> V_256 , V_183 -> V_242 ) ;
return V_208 ;
}
static struct V_220 *
...
static struct V_182 * F_169 ( const char * V_242 ,
V_107 V_146 , V_107 V_152 ,
enum V_202 type )
{
struct V_182 * V_183 ;
...
if ( ! V_144 )
return NULL ;
V_183 = F_170 ( V_258 , V_149 ) ;
if ( ! V_183 ) {
F_36 ( V_144 ) ;
return NULL ;
}
V_183 -> V_242 = memcpy ( V_144 , V_242 , V_97 ) ;
V_183 -> V_146 = V_146 ;
V_183 -> V_152 = V_152 ;
V_183 -> V_32 = 0 ;
V_183 -> V_133 = V_198 ;
...
struct V_194 * V_268 ;
struct V_182 * V_270 ;
V_268 = F_53 ( V_61 , struct V_194 , V_61 ) ;
V_270 = V_268 -> V_183 ;
V_268 -> V_183 = NULL ;
F_118 ( V_270 ) ;
F_141 ( V_268 ) ;
...
V_271 = V_183 -> V_133 < V_185 -> V_197 - 1 ;
} else {
F_17 ( V_185 -> V_264 != NULL ) ;
V_271 = F_185 ( V_185 -> V_264 , V_212 , V_213 ) ;
if ( ! V_271 )
F_186 ( V_185 -> V_264 , V_212 ) ;
}
return V_271 ;
}
...
struct V_194 * V_185 = V_183 -> V_185 ;
struct V_21 * V_22 = V_185 -> V_22 ;
V_107 V_273 = F_84 ( & V_22 -> V_110 ) ;
V_107 V_146 = V_183 -> V_146 ;
V_107 V_152 = V_183 -> V_152 ;
V_107 V_274 ;
T_8 V_224 ;
if ( V_88 == V_91 ) {
if ( ! V_146 && V_152 == V_273 &&
( ! F_145 ( V_185 ) ||
! F_114 ( V_183 ) ) ) {
V_224 = V_236 ;
} else if ( ( V_146 + V_152 == V_273 ) ) {
V_224 = V_237 ;
} else {
F_178 ( & V_22 -> V_262 ) ;
V_274 = V_22 -> V_110 . V_125 ;
F_179 ( & V_22 -> V_262 ) ;
if ( V_183 -> V_190 + V_152 == V_274 )
V_224 = V_237 ;
else
V_224 = V_238 ;
}
...
if ( V_224 == V_236 )
F_191 ( V_272 , V_246 , V_224 , 0 ) ;
else
F_192 ( V_272 , V_246 , V_224 ,
V_146 , V_152 , 0 , 0 ) ;
if ( V_183 -> type == V_204 )
F_193 ( V_272 , V_246 ,
V_183 -> V_218 , V_152 ) ;
...
V_107 V_146 ;
V_107 V_152 ;
V_242 = F_80 ( V_22 , V_190 ) ;
if ( ! V_242 )
goto V_279;
V_146 = F_82 ( V_22 , V_190 ) ;
V_152 = F_83 ( V_22 , V_190 , V_277 ) ;
V_183 = F_169 ( V_242 ,
V_146 , V_152 , type ) ;
F_78 ( V_242 ) ;
if ( ! V_183 )
...
V_270 = V_185 -> V_183 ;
F_17 ( V_270 != NULL ) ;
F_17 ( F_124 ( V_270 -> type ) ) ;
V_283 = V_185 -> V_212 ;
V_284 = V_185 -> V_152 ;
F_17 ( V_284 == V_185 -> V_213 ) ;
F_120 ( V_185 ) ;
F_17 ( V_270 -> V_185 ) ;
V_22 = V_270 -> V_185 -> V_22 ;
F_17 ( V_22 ) ;
if ( ! V_22 -> V_191 ) {
struct V_206 * V_207 ;
F_172 ( V_169 , V_259 ) ;
V_207 = & V_22 -> V_53 -> V_63 -> V_207 ;
V_283 = F_125 ( V_207 , V_270 ) ;
if ( ! V_283 )
return;
}
if ( V_283 )
...
V_270 -> V_281 = V_169 ;
V_270 -> V_282 = V_259 ;
F_198 ( V_208 , 0 , V_239 , L_39 , L_40 ) ;
F_199 ( V_208 , 0 , V_169 , V_284 , 0 ,
false , false ) ;
V_88 = F_146 ( V_270 -> V_185 ) ;
F_189 ( V_270 , V_208 , V_88 , 1 ) ;
V_207 = & V_22 -> V_53 -> V_63 -> V_207 ;
V_283 = F_125 ( V_207 , V_270 ) ;
if ( ! V_283 )
return;
...
V_259 = ( T_5 ) F_196 ( 0 , V_152 ) ;
V_169 = F_201 ( V_259 , V_59 ) ;
if ( F_30 ( V_169 ) ) {
V_212 = F_202 ( V_169 ) ;
V_169 = NULL ;
goto V_118;
...
T_6 V_97 ;
int V_39 ;
V_97 = sizeof ( V_106 ) + sizeof ( V_286 ) + sizeof ( V_286 ) ;
V_259 = ( T_5 ) F_196 ( 0 , V_97 ) ;
V_169 = F_201 ( V_259 , V_59 ) ;
if ( F_30 ( V_169 ) )
return F_202 ( V_169 ) ;
V_39 = - V_57 ;
V_285 = F_169 ( V_183 -> V_242 , 0 , 0 ,
V_205 ) ;
if ( ! V_285 )
goto V_49;
F_116 ( V_183 ) ;
...
F_17 ( V_183 -> V_185 ) ;
V_22 = V_183 -> V_185 -> V_22 ;
V_285 -> V_208 = F_162 ( V_22 , V_89 , 1 ,
V_285 ) ;
if ( ! V_285 -> V_208 )
goto V_49;
V_285 -> V_201 = F_204 ;
F_191 ( V_285 -> V_208 , 0 , V_235 , 0 ) ;
F_207 ( V_285 -> V_208 , 0 , V_169 , V_97 , 0 ,
false , false ) ;
F_159 ( V_285 ) ;
V_207 = & V_22 -> V_53 -> V_63 -> V_207 ;
V_39 = F_125 ( V_207 , V_285 ) ;
V_49:
if ( V_39 )
F_118 ( V_183 ) ;
return V_39 ;
...
V_287 = V_183 -> V_190 + V_183 -> V_152 ;
if ( V_287 > V_22 -> V_191 ) {
V_107 V_213 = 0 ;
if ( V_183 -> V_190 < V_22 -> V_191 )
V_213 = V_22 -> V_191 -
V_183 -> V_190 ;
V_183 -> V_213 = F_210 ( V_288 , V_213 ) ;
} else {
V_183 -> V_213 = V_288 ;
}
V_49:
...
static int F_211 ( struct V_21 * V_22 , V_107 V_290 )
{
struct V_182 * V_183 ;
struct V_206 * V_207 = & V_22 -> V_53 -> V_63 -> V_207 ;
int V_39 ;
V_183 = F_169 ( V_22 -> V_291 , 0 , 0 ,
V_203 ) ;
if ( ! V_183 )
return - V_57 ;
V_39 = - V_57 ;
...
static void F_213 ( V_107 V_292 , V_107 V_290 , T_9 V_224 , void * V_293 )
{
struct V_21 * V_22 = (struct V_21 * ) V_293 ;
int V_39 ;
if ( ! V_22 )
return;
F_25 ( L_42 , V_58 ,
V_22 -> V_291 , ( unsigned long long ) V_290 ,
( unsigned int ) V_224 ) ;
V_39 = F_214 ( V_22 ) ;
if ( V_39 )
F_103 ( V_22 , L_43 , V_39 ) ;
V_39 = F_211 ( V_22 , V_290 ) ;
if ( V_39 )
...
{
struct V_206 * V_207 = & V_22 -> V_53 -> V_63 -> V_207 ;
struct V_54 * V_295 = V_207 -> V_63 -> V_101 ;
struct V_182 * V_183 ;
int V_39 ;
V_183 = F_169 ( V_22 -> V_291 , 0 , 0 ,
V_203 ) ;
...
T_5 V_259 ;
int V_39 ;
V_259 = ( T_5 ) F_196 ( 0 , V_305 ) ;
V_169 = F_201 ( V_259 , V_59 ) ;
if ( F_30 ( V_169 ) )
return F_202 ( V_169 ) ;
V_39 = - V_57 ;
V_183 = F_169 ( V_242 , 0 , V_305 ,
V_205 ) ;
if ( ! V_183 )
goto V_49;
V_183 -> V_169 = V_169 ;
...
if ( ! V_183 -> V_208 )
goto V_49;
F_198 ( V_183 -> V_208 , 0 , V_239 ,
V_300 , V_301 ) ;
if ( V_303 ) {
struct V_306 * V_307 ;
V_307 = F_26 ( sizeof ( * V_307 ) , V_308 ) ;
if ( ! V_307 )
goto V_49;
F_222 ( V_307 ) ;
F_223 ( V_307 , V_302 , V_303 ) ;
F_224 ( V_183 -> V_208 , 0 ,
V_307 ) ;
}
F_225 ( V_183 -> V_208 , 0 ,
...
F_226 ( V_169 , V_304 , 0 , V_183 -> V_213 ) ;
V_49:
if ( V_183 )
F_118 ( V_183 ) ;
else
...
static void F_227 ( struct V_309 * V_310 )
{
struct V_311 * V_264 = F_228 ( V_310 ) ;
struct V_21 * V_22 = V_264 -> V_312 -> V_313 ;
struct V_194 * V_185 ;
struct V_105 * V_113 = NULL ;
V_107 V_146 = ( V_107 ) F_229 ( V_264 ) << V_103 ;
V_107 V_152 = F_230 ( V_264 ) ;
enum V_87 V_88 ;
V_107 V_314 ;
int V_212 ;
if ( V_264 -> V_315 != V_316 ) {
F_25 ( L_46 , V_58 ,
( int ) V_264 -> V_315 ) ;
V_212 = - V_132 ;
goto V_317;
}
if ( V_264 -> V_318 & V_319 )
V_88 = V_91 ;
else if ( V_264 -> V_318 & V_320 )
V_88 = V_90 ;
else
V_88 = V_89 ;
if ( ! V_152 ) {
...
F_231 ( V_264 ) ;
F_178 ( & V_22 -> V_262 ) ;
V_314 = V_22 -> V_27 . V_97 ;
if ( V_88 != V_89 ) {
V_113 = V_22 -> V_110 . V_113 ;
F_232 ( V_113 ) ;
}
F_179 ( & V_22 -> V_262 ) ;
if ( V_146 + V_152 > V_314 ) {
...
{
struct V_311 * V_264 = V_328 -> V_264 ;
struct V_309 * V_310 = F_235 ( V_264 ) ;
F_236 ( V_329 , V_310 ) ;
return V_330 ;
}
static int F_237 ( struct V_331 * V_312 , struct V_332 * V_333 ,
struct V_159 * V_334 )
{
struct V_21 * V_22 = V_312 -> V_313 ;
T_10 V_335 ;
T_10 V_336 ;
T_10 V_337 ;
int V_39 ;
V_335 = F_238 ( V_333 -> V_338 ) + V_333 -> V_278 ;
V_336 = 1 << ( V_22 -> V_110 . V_126 - V_103 ) ;
V_337 = V_335 & ( V_336 - 1 ) ;
V_39 = ( int ) ( V_336 - V_337 ) << V_103 ;
if ( V_39 > V_333 -> V_179 )
V_39 -= V_333 -> V_179 ;
else
V_39 = 0 ;
F_17 ( V_334 -> V_165 <= V_175 ) ;
if ( V_39 > ( int ) V_334 -> V_165 || ! V_333 -> V_179 )
V_39 = ( int ) V_334 -> V_165 ;
return V_39 ;
}
...
F_142 ( V_322 , & V_22 -> V_32 ) ;
}
static void F_247 ( struct V_21 * V_22 )
{
T_10 V_97 ;
bool V_25 ;
F_12 ( & V_22 -> V_30 ) ;
...
F_14 ( & V_22 -> V_30 ) ;
if ( ! V_25 ) {
V_97 = ( T_10 ) V_22 -> V_27 . V_97 / V_344 ;
F_25 ( L_54 , ( unsigned long long ) V_97 ) ;
F_248 ( V_22 -> V_36 , V_97 ) ;
F_249 ( V_22 -> V_36 ) ;
}
}
...
V_49:
F_253 ( & V_22 -> V_262 ) ;
if ( ! V_39 && V_314 != V_22 -> V_27 . V_97 )
F_247 ( V_22 ) ;
return V_39 ;
}
static int F_254 ( void * V_293 , struct V_311 * V_264 ,
...
if ( ! V_36 )
return - V_57 ;
snprintf ( V_36 -> V_349 , sizeof( V_36 -> V_349 ) , V_350 L_55 ,
V_22 -> V_5 ) ;
V_36 -> V_351 = V_22 -> V_351 ;
V_36 -> V_352 = V_22 -> V_7 ;
if ( V_13 )
V_36 -> V_32 |= V_353 ;
V_36 -> V_354 = & V_355 ;
V_36 -> V_24 = V_22 ;
memset ( & V_22 -> V_341 , 0 , sizeof( V_22 -> V_341 ) ) ;
V_22 -> V_341 . V_356 = & V_357 ;
V_22 -> V_341 . V_84 = V_22 -> V_295 -> V_84 ;
V_22 -> V_341 . V_347 = V_358 ;
V_22 -> V_341 . V_32 = V_359 | V_360 ;
V_22 -> V_341 . V_361 = 1 ;
V_22 -> V_341 . V_362 = sizeof( struct V_309 ) ;
V_317 = F_258 ( & V_22 -> V_341 ) ;
if ( V_317 )
goto V_363;
V_312 = F_259 ( & V_22 -> V_341 ) ;
if ( F_30 ( V_312 ) ) {
V_317 = F_202 ( V_312 ) ;
goto V_364;
}
...
F_261 ( V_312 , V_151 / V_344 ) ;
F_262 ( V_312 , V_151 / V_344 ) ;
F_263 ( V_312 , V_151 ) ;
F_264 ( V_312 , V_151 ) ;
F_265 ( V_312 , V_151 ) ;
F_260 ( V_366 , V_312 ) ;
V_312 -> V_367 . V_368 = V_151 ;
V_312 -> V_367 . V_369 = V_151 ;
V_312 -> V_367 . V_370 = V_151 / V_344 ;
V_312 -> V_367 . V_371 = 1 ;
F_266 ( V_312 , F_237 ) ;
V_36 -> V_340 = V_312 ;
V_312 -> V_313 = V_22 ;
...
struct V_21 * V_22 = F_267 ( V_18 ) ;
if ( V_22 -> V_351 )
return sprintf ( V_163 , L_58 , V_22 -> V_351 ) ;
...
struct V_21 * V_22 = F_267 ( V_18 ) ;
return sprintf ( V_163 , L_56 ,
( unsigned long long ) V_22 -> V_45 -> V_374 ) ;
}
...
struct V_21 * V_22 = F_267 ( V_18 ) ;
if ( V_22 -> V_45 -> V_375 )
return sprintf ( V_163 , L_61 , V_22 -> V_45 -> V_375 ) ;
...
{
struct V_21 * V_22 = F_267 ( V_18 ) ;
return sprintf ( V_163 , L_61 , V_22 -> V_45 -> V_376 ) ;
}
...
for ( ; V_22 -> V_269 ; V_22 = V_22 -> V_269 ) {
struct V_378 * V_45 = V_22 -> V_260 ;
V_377 += sprintf ( & V_163 [ V_377 ] , L_64
L_65
L_66
L_67
L_68 ,
! V_377 ? L_69 : L_70 ,
V_45 -> V_374 , V_45 -> V_373 ,
V_45 -> V_376 , V_45 -> V_375 ? : L_71 ,
...
static struct V_378 * F_282 ( struct V_378 * V_45 )
{
F_40 ( & V_45 -> V_61 ) ;
return V_45 ;
}
static void F_175 ( struct V_378 * V_45 )
{
if ( V_45 )
F_56 ( & V_45 -> V_61 , V_379 ) ;
}
static struct V_378 * F_283 ( void )
{
struct V_378 * V_45 ;
...
static void V_379 ( struct V_61 * V_61 )
{
struct V_378 * V_45 = F_53 ( V_61 , struct V_378 , V_61 ) ;
F_36 ( V_45 -> V_373 ) ;
F_36 ( V_45 -> V_376 ) ;
F_36 ( V_45 -> V_375 ) ;
F_36 ( V_45 -> V_134 ) ;
...
V_22 -> V_45 = V_45 ;
V_22 -> V_295 = V_295 ;
V_22 -> V_255 . V_381 = F_288 ( 1 << V_382 ) ;
V_22 -> V_255 . V_383 = F_288 ( 1 ) ;
V_22 -> V_255 . V_384 = F_288 ( 1 << V_382 ) ;
V_22 -> V_255 . V_385 = F_288 ( ( T_5 ) V_45 -> V_374 ) ;
return V_22 ;
}
...
{
V_106 V_386 = F_290 ( V_46 ) ;
int V_39 ;
struct {
T_9 V_102 ;
V_106 V_97 ;
} V_387 ( ( V_388 ) ) V_389 = { 0 } ;
V_39 = F_221 ( V_22 , V_22 -> V_291 ,
L_39 , L_72 ,
& V_386 , sizeof ( V_386 ) ,
& V_389 , sizeof ( V_389 ) ) ;
F_25 ( L_73 , V_58 , V_39 ) ;
if ( V_39 < 0 )
return V_39 ;
if ( V_39 < sizeof ( V_389 ) )
return - V_390 ;
if ( V_102 ) {
* V_102 = V_389 . V_102 ;
F_25 ( L_74 , ( unsigned int ) * V_102 ) ;
}
* V_142 = F_60 ( V_389 . V_97 ) ;
F_25 ( L_75 ,
...
goto V_49;
V_392 = V_391 ;
V_22 -> V_110 . V_112 = F_293 ( & V_392 ,
V_392 + V_39 , NULL , V_149 ) ;
V_39 = 0 ;
...
if ( V_39 < 0 )
return V_39 ;
if ( V_39 < sizeof ( V_395 ) )
return - V_390 ;
V_394 = F_60 ( V_395 . V_394 ) ;
if ( V_394 & ~ V_396 )
return - V_323 ;
* V_143 = F_60 ( V_395 . V_131 ) ;
F_25 ( L_79 ,
( unsigned long long ) V_46 ,
( unsigned long long ) * V_143 ,
( unsigned long long ) F_60 ( V_395 . V_394 ) ) ;
return 0 ;
}
...
sizeof ( V_106 ) +
sizeof ( V_106 ) ;
V_391 = F_26 ( V_97 , V_59 ) ;
if ( ! V_391 ) {
V_39 = - V_57 ;
goto V_118;
}
V_386 = F_290 ( V_22 -> V_45 -> V_46 ) ;
V_39 = F_221 ( V_22 , V_22 -> V_291 ,
L_39 , L_80 ,
& V_386 , sizeof ( V_386 ) ,
V_391 , V_97 ) ;
...
V_39 = - V_132 ;
if ( V_374 > ( V_107 ) V_399 ) {
F_103 ( NULL , L_82 ,
( unsigned long long ) V_374 , V_399 ) ;
goto V_118;
}
V_376 = F_293 ( & V_392 , V_170 , NULL , V_59 ) ;
if ( F_30 ( V_376 ) ) {
V_39 = F_202 ( V_376 ) ;
goto V_118;
}
F_295 ( & V_392 , V_170 , V_46 , V_118 ) ;
F_295 ( & V_392 , V_170 , V_397 , V_118 ) ;
if ( ! V_22 -> V_260 ) {
V_260 -> V_374 = V_374 ;
V_260 -> V_376 = V_376 ;
V_260 -> V_46 = V_46 ;
...
return - V_390 ;
V_39 = - V_4 ;
V_401 = ( V_107 ) 1 << V_22 -> V_110 . V_126 ;
V_392 = & V_400 ;
V_129 = F_298 ( & V_392 ) ;
if ( V_129 != V_401 ) {
F_103 ( V_22 , L_86
...
static char * F_299 ( struct V_21 * V_22 )
{
T_6 V_402 ;
char * V_376 ;
void * V_392 ;
...
char * V_375 = NULL ;
int V_39 ;
F_17 ( ! V_22 -> V_45 -> V_375 ) ;
V_117 = strlen ( V_22 -> V_45 -> V_376 ) ;
V_402 = sizeof ( V_286 ) + V_117 ;
V_376 = F_26 ( V_402 , V_59 ) ;
if ( ! V_376 )
return NULL ;
V_392 = V_376 ;
V_170 = V_376 + V_402 ;
F_300 ( & V_392 , V_170 , V_22 -> V_45 -> V_376 , ( T_5 ) V_117 ) ;
V_97 = sizeof ( V_286 ) + V_403 ;
V_391 = F_26 ( V_97 , V_59 ) ;
if ( ! V_391 )
goto V_49;
V_39 = F_221 ( V_22 , V_404 ,
L_39 , L_90 ,
V_376 , V_402 ,
V_391 , V_97 ) ;
if ( V_39 < 0 )
...
V_392 = V_391 ;
V_170 = V_391 + V_39 ;
V_375 = F_293 ( & V_392 , V_170 , & V_117 , V_59 ) ;
if ( F_30 ( V_375 ) )
V_375 = NULL ;
else
F_25 ( L_91 , V_58 , V_375 , V_117 ) ;
V_49:
F_36 ( V_391 ) ;
F_36 ( V_376 ) ;
return V_375 ;
}
static V_107 F_301 ( struct V_21 * V_22 , const char * V_144 )
{
struct V_105 * V_113 = V_22 -> V_110 . V_113 ;
const char * V_134 ;
T_5 V_133 = 0 ;
...
static V_107 F_302 ( struct V_21 * V_22 , const char * V_144 )
{
struct V_105 * V_113 = V_22 -> V_110 . V_113 ;
T_5 V_133 ;
bool V_69 = false ;
...
static V_107 F_303 ( struct V_21 * V_22 , const char * V_144 )
{
if ( V_22 -> V_94 == 1 )
return F_301 ( V_22 , V_144 ) ;
return F_302 ( V_22 , V_144 ) ;
}
static int F_304 ( struct V_21 * V_22 )
{
struct V_378 * V_45 = V_22 -> V_45 ;
F_17 ( V_45 -> V_374 != V_380 && V_45 -> V_373 ) ;
F_17 ( V_45 -> V_376 && V_45 -> V_375 ) ;
F_17 ( V_45 -> V_134 ) ;
if ( strcmp ( V_45 -> V_134 , V_141 ) ) {
V_107 V_46 ;
V_46 = F_303 ( V_22 , V_45 -> V_134 ) ;
if ( V_46 == V_47 )
return - V_34 ;
V_45 -> V_46 = V_46 ;
} else {
...
const char * V_134 ;
int V_39 ;
F_17 ( V_45 -> V_374 != V_380 ) ;
F_17 ( V_45 -> V_376 ) ;
F_17 ( V_45 -> V_46 != V_47 ) ;
V_373 = F_306 ( V_207 -> V_405 , V_45 -> V_374 ) ;
if ( ! V_373 ) {
F_103 ( V_22 , L_92 , V_45 -> V_374 ) ;
return - V_132 ;
}
V_373 = F_66 ( V_373 , V_59 ) ;
if ( ! V_373 )
return - V_57 ;
V_375 = F_299 ( V_22 ) ;
if ( ! V_375 )
...
struct V_105 * V_113 ;
T_5 V_116 ;
V_97 = sizeof ( V_106 ) + sizeof ( V_286 ) +
V_406 * sizeof ( V_106 ) ;
V_391 = F_284 ( V_97 , V_59 ) ;
if ( ! V_391 )
return - V_57 ;
V_39 = F_221 ( V_22 , V_22 -> V_291 ,
L_39 , L_94 , NULL , 0 ,
...
V_170 = V_391 + V_39 ;
V_39 = - V_390 ;
F_295 ( & V_392 , V_170 , V_119 , V_49 ) ;
F_308 ( & V_392 , V_170 , V_98 , V_49 ) ;
if ( V_98 > ( V_104 - sizeof ( struct V_105 ) )
/ sizeof ( V_107 ) ) {
V_39 = - V_4 ;
goto V_49;
}
if ( ! F_309 ( & V_392 , V_170 , V_98 * sizeof ( V_106 ) ) )
goto V_49;
V_39 = 0 ;
V_113 = F_63 ( V_98 , V_59 ) ;
if ( ! V_113 ) {
...
V_392 = V_391 ;
V_170 = V_391 + V_39 ;
V_134 = F_293 ( & V_392 , V_170 , NULL , V_59 ) ;
if ( F_30 ( V_134 ) )
goto V_49;
F_25 ( L_97 ,
...
F_320 ( & V_22 -> V_62 ) ;
F_34 ( & V_417 ) ;
F_321 ( & V_415 , V_22 -> V_5 ) ;
F_25 ( L_100 , V_22 , V_22 -> V_5 ) ;
}
static inline T_6 F_322 ( const char * * V_163 )
{
const char * V_419 = L_101 ;
* V_163 += strspn ( * V_163 , V_419 ) ;
return strcspn ( * V_163 , V_419 ) ;
}
static inline char * F_323 ( const char * * V_163 , T_6 * V_420 )
{
char * V_421 ;
T_6 V_117 ;
V_117 = F_322 ( V_163 ) ;
V_421 = F_324 ( * V_163 , V_117 + 1 , V_59 ) ;
if ( ! V_421 )
return NULL ;
* ( V_421 + V_117 ) = '\0' ;
* V_163 += V_117 ;
...
static int F_327 ( struct V_53 * V_56 , const char * V_373 )
{
struct V_54 * V_295 = V_56 -> V_63 -> V_101 ;
V_107 V_429 ;
int V_430 = 0 ;
int V_39 ;
V_431:
V_39 = F_328 ( V_56 -> V_63 -> V_207 . V_405 , V_373 ) ;
if ( V_39 == - V_34 && V_430 ++ < 1 ) {
V_39 = F_329 ( & V_56 -> V_63 -> V_432 , L_106 ,
& V_429 ) ;
if ( V_39 < 0 )
return V_39 ;
if ( V_56 -> V_63 -> V_207 . V_405 -> V_433 < V_429 ) {
F_330 ( & V_56 -> V_63 -> V_432 ) ;
( void ) F_331 ( & V_56 -> V_63 -> V_432 ,
V_429 ,
V_295 -> V_298 ) ;
goto V_431;
} else {
...
char * V_376 ;
if ( V_22 -> V_45 -> V_376 ) {
V_22 -> V_94 = * V_22 -> V_45 -> V_376 ? 2 : 1 ;
return 0 ;
}
V_97 = sizeof ( V_435 ) + strlen ( V_22 -> V_45 -> V_375 ) ;
V_242 = F_26 ( V_97 , V_149 ) ;
if ( ! V_242 )
return - V_57 ;
sprintf ( V_242 , L_107 , V_435 , V_22 -> V_45 -> V_375 ) ;
F_25 ( L_108 , V_242 ) ;
V_97 = sizeof ( V_286 ) + V_398 ;
V_434 = F_284 ( V_97 , V_149 ) ;
if ( ! V_434 ) {
V_39 = - V_57 ;
goto V_49;
}
V_39 = F_221 ( V_22 , V_242 ,
L_39 , L_109 , NULL , 0 ,
V_434 , V_398 ) ;
F_25 ( L_73 , V_58 , V_39 ) ;
if ( V_39 == - V_34 ) {
V_376 = F_66 ( L_69 , V_59 ) ;
V_39 = V_376 ? 0 : - V_57 ;
if ( ! V_39 )
V_22 -> V_94 = 1 ;
} else if ( V_39 >= 0 ) {
void * V_392 = V_434 ;
V_376 = F_293 ( & V_392 , V_392 + V_39 ,
NULL , V_149 ) ;
V_39 = F_333 ( V_376 ) ;
if ( ! V_39 )
V_22 -> V_94 = 2 ;
...
{
struct V_21 * V_269 = NULL ;
struct V_378 * V_260 ;
struct V_53 * V_56 ;
int V_39 ;
if ( ! V_22 -> V_260 )
return 0 ;
V_260 = F_282 ( V_22 -> V_260 ) ;
V_56 = F_39 ( V_22 -> V_53 ) ;
V_39 = - V_57 ;
V_269 = F_285 ( V_56 , V_260 , NULL ) ;
if ( ! V_269 )
goto V_118;
V_39 = F_336 ( V_269 , false ) ;
if ( V_39 < 0 )
goto V_118;
V_22 -> V_269 = V_269 ;
F_286 ( & V_22 -> V_261 , 1 ) ;
...
F_338 ( V_437
< sizeof ( V_350 ) + V_438 ) ;
sprintf ( V_22 -> V_144 , L_111 , V_350 , V_22 -> V_5 ) ;
if ( ! V_13 ) {
...
if ( V_39 )
goto V_442;
F_248 ( V_22 -> V_36 , V_22 -> V_27 . V_97 / V_344 ) ;
F_21 ( V_22 -> V_36 , V_22 -> V_27 . V_28 ) ;
V_39 = F_312 ( V_22 ) ;
if ( V_39 )
goto V_443;
F_111 ( V_322 , & V_22 -> V_32 ) ;
F_340 ( V_22 -> V_36 ) ;
F_296 ( L_112 , V_22 -> V_36 -> V_349 ,
( unsigned long long ) V_22 -> V_27 . V_97 ) ;
return V_39 ;
V_443:
F_77 ( V_22 ) ;
...
F_17 ( F_57 ( V_22 -> V_94 ) ) ;
if ( V_22 -> V_94 == 1 )
V_97 = strlen ( V_45 -> V_375 ) + sizeof ( V_444 ) ;
else
V_97 = sizeof ( V_445 ) + strlen ( V_45 -> V_376 ) ;
V_22 -> V_291 = F_26 ( V_97 , V_59 ) ;
if ( ! V_22 -> V_291 )
return - V_57 ;
if ( V_22 -> V_94 == 1 )
sprintf ( V_22 -> V_291 , L_107 ,
V_45 -> V_375 , V_444 ) ;
else
sprintf ( V_22 -> V_291 , L_107 ,
V_445 , V_45 -> V_376 ) ;
...
V_22 -> V_291 = NULL ;
V_22 -> V_94 = 0 ;
F_36 ( V_22 -> V_45 -> V_376 ) ;
V_22 -> V_45 -> V_376 = NULL ;
F_289 ( V_22 ) ;
}
static int F_336 ( struct V_21 * V_22 , bool V_27 )
{
int V_39 ;
V_39 = F_332 ( V_22 ) ;
if ( V_39 )
...
static T_11 F_344 ( struct V_451 * V_408 ,
const char * V_163 ,
T_6 V_377 )
{
struct V_21 * V_22 = NULL ;
...
if ( ! F_345 ( V_453 ) )
return - V_454 ;
V_452 = F_325 ( V_163 , & V_55 , & V_74 , & V_45 ) ;
if ( V_452 < 0 )
goto V_455;
V_56 = F_49 ( V_55 ) ;
if ( F_30 ( V_56 ) ) {
...
V_452 = F_327 ( V_56 , V_45 -> V_373 ) ;
if ( V_452 < 0 ) {
if ( V_452 == - V_34 )
F_296 ( L_117 , V_45 -> V_373 ) ;
goto V_457;
}
V_45 -> V_374 = ( V_107 ) V_452 ;
if ( V_45 -> V_374 > ( V_107 ) V_399 ) {
F_103 ( NULL , L_118 ,
( unsigned long long ) V_45 -> V_374 , V_399 ) ;
V_452 = - V_132 ;
goto V_457;
}
...
V_45 = NULL ;
V_74 = NULL ;
V_452 = F_336 ( V_22 , true ) ;
if ( V_452 < 0 )
goto V_458;
V_28 = V_22 -> V_295 -> V_28 ;
if ( V_22 -> V_45 -> V_46 != V_47 )
V_28 = true ;
V_22 -> V_27 . V_28 = V_28 ;
V_452 = F_337 ( V_22 ) ;
...
static T_11 F_347 ( struct V_451 * V_408 ,
const char * V_163 ,
T_6 V_377 )
{
if ( V_13 )
return - V_4 ;
return F_344 ( V_408 , V_163 , V_377 ) ;
}
static T_11 F_348 ( struct V_451 * V_408 ,
const char * V_163 ,
T_6 V_377 )
{
return F_344 ( V_408 , V_163 , V_377 ) ;
}
static void V_413 ( struct V_17 * V_18 )
{
struct V_21 * V_22 = F_267 ( V_18 ) ;
F_239 ( V_22 ) ;
F_142 ( V_322 , & V_22 -> V_32 ) ;
...
struct V_21 * V_460 = V_459 -> V_269 ;
struct V_21 * V_461 ;
while ( V_460 && ( V_461 = V_460 -> V_269 ) ) {
V_459 = V_460 ;
V_460 = V_461 ;
}
F_17 ( V_460 ) ;
...
static T_11 F_349 ( struct V_451 * V_408 ,
const char * V_163 ,
T_6 V_377 )
{
struct V_21 * V_22 = NULL ;
...
V_39 = - V_34 ;
F_32 ( & V_417 ) ;
F_351 (tmp, &rbd_dev_list) {
V_22 = F_352 ( V_156 , struct V_21 , V_62 ) ;
if ( V_22 -> V_5 == V_5 ) {
V_39 = 0 ;
break;
}
...
F_220 ( V_22 ) ;
F_25 ( L_120 , V_58 ) ;
F_353 ( & V_22 -> V_53 -> V_63 -> V_207 ) ;
F_315 ( V_22 ) ;
F_343 ( V_22 ) ;
F_346 ( V_453 ) ;
return V_377 ;
}
static T_11 F_354 ( struct V_451 * V_408 ,
const char * V_163 ,
T_6 V_377 )
{
if ( V_13 )
return - V_4 ;
return F_349 ( V_408 , V_163 , V_377 ) ;
}
static T_11 F_355 ( struct V_451 * V_408 ,
const char * V_163 ,
T_6 V_377 )
{
return F_349 ( V_408 , V_163 , V_377 ) ;
