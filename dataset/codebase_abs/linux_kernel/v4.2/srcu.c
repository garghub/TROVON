...
F_26 () ;
F_27 ( V_10 -> V_20 -> V_32 [ V_27 ] ) ;
F_20 () ;
F_27 ( V_10 -> V_20 -> V_31 [ V_27 ] ) ;
F_28 () ;
return V_27 ;
}
void F_29 ( struct V_9 * V_10 , int V_27 )
{
F_20 () ;
F_30 ( V_10 -> V_20 -> V_32 [ V_27 ] ) ;
}
static bool F_31 ( struct V_9 * V_10 , int V_27 , int V_33 )
{
for (; ; ) {
if ( F_19 ( V_10 , V_27 ) )
return true ;
...
void F_34 ( struct V_9 * V_10 , struct V_5 * V_3 ,
void (* F_35)( struct V_5 * V_3 ) )
{
unsigned long V_35 ;
V_3 -> V_6 = NULL ;
V_3 -> F_35 = F_35 ;
...
if ( ! V_10 -> V_13 ) {
V_10 -> V_13 = true ;
F_37 ( V_36 , & V_10 -> V_18 , 0 ) ;
}
F_38 ( & V_10 -> V_12 , V_35 ) ;
}
static void F_39 ( struct V_9 * V_10 , int V_33 )
{
struct V_37 V_38 ;
struct V_5 * V_3 = & V_38 . V_3 ;
bool V_39 = false ;
F_40 ( ! F_41 ( & V_10 -> V_26 ) &&
! F_41 ( & V_40 ) &&
! F_41 ( & V_41 ) &&
...
unsigned long F_54 ( struct V_9 * V_10 )
{
return V_10 -> V_11 ;
}
...
static void F_46 ( struct V_9 * V_10 , int V_33 )
{
int V_27 = 1 ^ ( V_10 -> V_11 & 1 ) ;
if ( F_3 ( & V_10 -> V_15 ) &&
F_3 ( & V_10 -> V_16 ) )
return;
if ( ! F_31 ( V_10 , V_27 , V_33 ) )
return;
...
void V_19 ( struct V_51 * V_18 )
{
struct V_9 * V_10 ;
V_10 = F_59 ( V_18 , struct V_9 , V_18 . V_18 ) ;
F_55 ( V_10 ) ;
F_46 ( V_10 , 1 ) ;
F_56 ( V_10 ) ;
F_48 ( V_10 ) ;
