...
static void F_32 ( struct V_56 * V_57 , struct V_58 * V_59 ,
...
V_73 = 0 ;
if ( V_60 == V_81 )
V_73 = F_35 ( V_57 , V_57 -> V_65 ) ;
if ( V_73 && V_73 == F_36 ( V_62 ) - 2 ) {
...
T_3 V_11 ;
int V_92 ;
if ( ! F_33 ( V_57 , sizeof( struct V_1 ) ) )
goto V_93;
V_64 = F_39 ( V_57 ) ;
V_37 = V_57 -> V_65 ;
V_32 = * ( T_3 * ) V_37 ;
...
if ( V_91 ) {
struct V_94 * V_95 ;
if ( ! F_42 ( NULL , V_96 , V_57 ) )
goto V_93;
if ( ! F_43 ( V_91 , & V_64 -> V_71 , & V_64 -> V_72 ) ) {
V_91 -> V_7 -> V_97 . V_98 ++ ;
goto V_93;
}
V_57 -> V_99 = V_11 ;
...
V_64 = F_39 ( V_57 ) ;
V_57 -> V_99 = F_47 ( V_57 , V_91 -> V_7 ) ;
F_45 ( V_57 , F_48 ( V_57 ) , V_110 ) ;
}
F_49 ( V_57 , V_91 -> V_7 , V_91 -> V_12 ) ;
F_50 ( V_57 ) ;
V_92 = F_51 ( V_64 , V_57 ) ;
if ( F_52 ( V_92 ) ) {
if ( V_112 )
...
F_59 ( V_57 , V_77 , V_118 , 0 ) ;
V_93:
F_60 ( V_57 ) ;
return 0 ;
}
static void F_61 ( struct V_119 * V_59 , T_8 V_82 )
{
...
static T_9 F_62 ( struct V_56 * V_57 ,
struct V_6 * V_7 ,
T_8 V_127 ,
struct V_128 * V_129 ,
int V_82 ,
...
V_135 = F_64 ( V_91 ) ;
if ( ! V_135 ) {
V_136 = F_65 ( V_12 , NULL , V_129 ) ;
if ( V_136 -> error )
goto V_143;
V_136 = F_66 ( V_12 , V_136 , F_67 ( V_129 ) , NULL , 0 ) ;
if ( F_68 ( V_136 ) ) {
V_92 = F_69 ( V_136 ) ;
V_136 = NULL ;
goto V_143;
...
V_76 = V_84 ;
if ( F_71 ( V_57 ) )
F_71 ( V_57 ) -> V_123 -> V_146 ( F_71 ( V_57 ) , NULL , V_57 , V_76 ) ;
if ( V_57 -> V_117 > V_76 ) {
* V_130 = V_76 ;
V_92 = - V_147 ;
goto V_145;
...
F_73 ( V_57 , ! F_74 ( V_91 -> V_12 , F_5 ( V_7 ) ) ) ;
V_132 += F_75 ( V_131 ) + V_133 + V_135 -> V_148 ;
if ( F_76 ( V_57 ) < V_132 || F_77 ( V_57 ) ||
( F_78 ( V_57 ) && ! F_79 ( V_57 , 0 ) ) ) {
V_139 = F_80 ( V_57 , V_132 ) ;
if ( V_132 > V_7 -> V_149 )
V_7 -> V_149 = V_132 ;
if ( ! V_139 )
goto V_145;
if ( V_57 -> V_150 )
F_81 ( V_139 , V_57 -> V_150 ) ;
F_82 ( V_57 ) ;
V_57 = V_139 ;
}
if ( V_129 -> V_142 ) {
...
if ( V_82 >= 0 ) {
F_61 ( & V_59 , V_82 ) ;
F_85 ( V_57 , & V_59 . V_123 , & V_138 , NULL ) ;
}
if ( F_86 ( ! V_57 -> V_152 ) ) {
F_87 ( V_57 ) ;
V_57 -> V_152 = 1 ;
...
F_88 ( V_57 , V_133 ) ;
F_50 ( V_57 ) ;
F_89 ( V_57 , sizeof( * V_64 ) ) ;
V_64 = F_39 ( V_57 ) ;
F_90 ( V_64 , F_91 ( 0 , V_127 ) ,
F_92 ( V_12 , V_57 , V_129 -> V_153 , false ) ) ;
...
static inline int F_99 ( struct V_56 * V_57 , struct V_6 * V_7 )
{
struct V_5 * V_17 = F_12 ( V_7 ) ;
const struct V_160 * V_161 = F_100 ( V_57 ) ;
int V_82 = - 1 ;
struct V_128 V_129 ;
T_8 V_127 ;
T_6 V_76 ;
...
V_129 . V_153 |= F_93 ( ( T_6 ) V_161 -> V_169 << V_170 )
& V_171 ;
if ( V_17 -> V_28 . V_32 & V_172 )
V_129 . V_142 = V_57 -> V_173 ;
V_92 = F_62 ( V_57 , V_7 , V_127 , & V_129 , V_82 , & V_76 ) ;
if ( V_92 != 0 ) {
if ( V_92 == - V_147 )
F_102 ( V_57 , V_174 , V_175 ,
F_93 ( V_76 ) ) ;
return - 1 ;
}
return 0 ;
}
static inline int F_103 ( struct V_56 * V_57 , struct V_6 * V_7 )
{
struct V_5 * V_17 = F_12 ( V_7 ) ;
...
return - 1 ;
V_61 = F_35 ( V_57 , F_104 ( V_57 ) ) ;
if ( V_61 > 0 ) {
struct V_74 * V_75 ;
V_75 = (struct V_74 * ) & F_104 ( V_57 ) [ V_61 ] ;
if ( V_75 -> V_82 == 0 ) {
F_59 ( V_57 , V_80 ,
V_81 , V_61 + 2 ) ;
return - 1 ;
...
V_129 . V_153 |= F_105 ( V_64 ) ;
if ( V_17 -> V_28 . V_32 & V_172 )
V_129 . V_142 = V_57 -> V_173 ;
V_92 = F_62 ( V_57 , V_7 , V_127 , & V_129 , V_82 , & V_76 ) ;
if ( V_92 != 0 ) {
if ( V_92 == - V_147 )
F_59 ( V_57 , V_83 , 0 , V_76 ) ;
return - 1 ;
}
return 0 ;
}
...
static int F_107 ( struct V_56 * V_57 , struct V_6 * V_7 )
{
struct V_5 * V_17 = F_12 ( V_7 ) ;
int V_82 = - 1 ;
struct V_128 V_129 ;
...
V_92 = F_62 ( V_57 , V_7 , 0 , & V_129 , V_82 , & V_76 ) ;
return V_92 ;
}
static T_9 F_108 ( struct V_56 * V_57 ,
struct V_6 * V_7 )
{
struct V_5 * V_17 = F_12 ( V_7 ) ;
...
break;
case F_8 ( V_101 ) :
V_178 = F_103 ( V_57 , V_7 ) ;
break;
default:
V_178 = F_107 ( V_57 , V_7 ) ;
break;
}
if ( V_178 < 0 )
goto V_179;
...
V_17 -> V_141 = V_185 ;
if ( V_36 -> V_32 & V_191 ) {
int V_195 = ( F_111 ( & V_36 -> V_30 ) &
( V_196 | V_197 ) ) ;
struct V_198 * V_199 = F_112 ( V_17 -> V_12 ,
& V_36 -> V_30 , & V_36 -> V_29 ,
V_36 -> V_13 , V_195 ) ;
if ( ! V_199 )
return;
...
{
struct V_5 * V_17 = F_12 ( V_7 ) ;
struct V_63 * V_64 = (struct V_63 * ) F_88 ( V_57 , V_17 -> V_141 ) ;
T_3 * V_36 = ( T_3 * ) ( V_64 + 1 ) ;
F_90 ( V_64 , 0 ,
F_92 ( F_5 ( V_7 ) , V_57 ,
...
static void F_132 ( struct V_12 * V_12 , struct V_231 * V_232 )
{
struct V_19 * V_20 = F_7 ( V_12 , V_21 ) ;
struct V_6 * V_7 , * V_233 ;
int V_38 ;
F_133 (net, dev, aux)
if ( V_7 -> V_49 == & V_50 ||
V_7 -> V_49 == & V_234 )
...
static int T_11 F_135 ( struct V_12 * V_12 )
{
struct V_19 * V_20 = F_7 ( V_12 , V_21 ) ;
int V_92 ;
...
F_24 ( V_20 -> V_34 , V_12 ) ;
V_20 -> V_34 -> V_54 |= V_237 ;
F_131 ( V_20 -> V_34 ) ;
V_20 -> V_34 -> V_49 = & V_50 ;
V_92 = F_136 ( V_20 -> V_34 ) ;
if ( V_92 )
goto V_238;
F_17 ( V_20 -> V_239 [ 0 ] ,
F_12 ( V_20 -> V_34 ) ) ;
...
static void T_12 F_137 ( struct V_12 * V_12 )
{
F_138 ( V_240 ) ;
F_139 () ;
F_132 ( V_12 , & V_240 ) ;
...
static int F_142 ( struct V_241 * V_242 [] , struct V_241 * V_65 [] )
{
T_3 V_32 ;
if ( ! V_65 )
return 0 ;
V_32 = 0 ;
if ( V_65 [ V_243 ] )
V_32 |= F_143 ( V_65 [ V_243 ] ) ;
if ( V_65 [ V_244 ] )
V_32 |= F_143 ( V_65 [ V_244 ] ) ;
if ( V_32 & ( V_70 | V_69 ) )
return - V_216 ;
return 0 ;
}
static int F_144 ( struct V_241 * V_242 [] , struct V_241 * V_65 [] )
{
struct V_1 V_71 ;
if ( V_242 [ V_245 ] ) {
if ( F_145 ( V_242 [ V_245 ] ) != V_246 )
return - V_216 ;
if ( ! F_146 ( F_147 ( V_242 [ V_245 ] ) ) )
return - V_247 ;
}
if ( ! V_65 )
goto V_248;
if ( V_65 [ V_249 ] ) {
V_71 = F_148 ( V_65 [ V_249 ] ) ;
if ( F_14 ( & V_71 ) )
return - V_216 ;
}
V_248:
return F_142 ( V_242 , V_65 ) ;
}
static void F_149 ( struct V_241 * V_65 [] ,
struct V_35 * V_28 )
{
...
return;
if ( V_65 [ V_250 ] )
V_28 -> V_13 = F_150 ( V_65 [ V_250 ] ) ;
if ( V_65 [ V_243 ] )
V_28 -> V_104 = F_143 ( V_65 [ V_243 ] ) ;
if ( V_65 [ V_244 ] )
V_28 -> V_52 = F_143 ( V_65 [ V_244 ] ) ;
if ( V_65 [ V_251 ] )
V_28 -> V_31 = F_151 ( V_65 [ V_251 ] ) ;
if ( V_65 [ V_252 ] )
V_28 -> V_158 = F_151 ( V_65 [ V_252 ] ) ;
if ( V_65 [ V_253 ] )
V_28 -> V_29 = F_148 ( V_65 [ V_253 ] ) ;
if ( V_65 [ V_249 ] )
V_28 -> V_30 = F_148 ( V_65 [ V_249 ] ) ;
if ( V_65 [ V_254 ] )
V_28 -> V_154 = F_152 ( V_65 [ V_254 ] ) ;
if ( V_65 [ V_255 ] )
V_28 -> V_82 = F_152 ( V_65 [ V_255 ] ) ;
if ( V_65 [ V_256 ] )
V_28 -> V_189 = F_150 ( V_65 [ V_256 ] ) ;
if ( V_65 [ V_257 ] )
V_28 -> V_32 = F_150 ( V_65 [ V_257 ] ) ;
}
...
static int F_156 ( struct V_12 * V_259 , struct V_6 * V_7 ,
struct V_241 * V_242 [] , struct V_241 * V_65 [] )
{
struct V_5 * V_44 ;
struct V_12 * V_12 = F_5 ( V_7 ) ;
struct V_19 * V_20 = F_7 ( V_12 , V_21 ) ;
int V_92 ;
V_44 = F_12 ( V_7 ) ;
F_149 ( V_65 , & V_44 -> V_28 ) ;
if ( F_20 ( V_12 , & V_44 -> V_28 , V_7 -> type ) )
return - V_217 ;
if ( V_7 -> type == V_24 && ! V_242 [ V_245 ] )
F_157 ( V_7 ) ;
V_44 -> V_7 = V_7 ;
V_44 -> V_12 = F_5 ( V_7 ) ;
F_25 ( V_44 , ! V_242 [ V_260 ] ) ;
if ( ! ( V_44 -> V_28 . V_52 & V_53 ) )
V_7 -> V_54 |= V_55 ;
V_92 = F_26 ( V_7 ) ;
if ( V_92 )
...
static int F_158 ( struct V_6 * V_7 , struct V_241 * V_242 [] ,
struct V_241 * V_65 [] )
{
...
V_17 = V_44 ;
F_19 ( V_20 , V_17 ) ;
F_114 ( V_17 , & V_36 , ! V_242 [ V_260 ] ) ;
F_16 ( V_20 , V_17 ) ;
F_122 ( V_7 ) ;
}
return 0 ;
}
static void F_159 ( struct V_6 * V_7 , struct V_231 * V_232 )
{
struct V_12 * V_12 = F_5 ( V_7 ) ;
struct V_19 * V_20 = F_7 ( V_12 , V_21 ) ;
if ( V_7 != V_20 -> V_34 )
...
static int F_162 ( struct V_56 * V_57 , const struct V_6 * V_7 )
{
struct V_5 * V_17 = F_12 ( V_7 ) ;
struct V_35 * V_36 = & V_17 -> V_28 ;
if ( F_163 ( V_57 , V_250 , V_36 -> V_13 ) ||
F_164 ( V_57 , V_243 , V_36 -> V_104 ) ||
F_164 ( V_57 , V_244 , V_36 -> V_52 ) ||
F_165 ( V_57 , V_251 , V_36 -> V_31 ) ||
F_165 ( V_57 , V_252 , V_36 -> V_158 ) ||
F_166 ( V_57 , V_253 , & V_36 -> V_29 ) ||
F_166 ( V_57 , V_249 , & V_36 -> V_30 ) ||
F_167 ( V_57 , V_254 , V_36 -> V_154 ) ||
F_167 ( V_57 , V_255 , V_36 -> V_82 ) ||
F_165 ( V_57 , V_256 , V_36 -> V_189 ) ||
F_163 ( V_57 , V_257 , V_36 -> V_32 ) )
goto V_261;
return 0 ;
V_261:
return - V_147 ;
