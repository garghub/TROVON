...
if ( V_247 < 0 )
return V_247 ;
if ( F_130 ( & V_204 -> V_162 , V_248 ) < 0 ||
F_131 ( & V_204 -> V_162 , V_248 ) < 0 ) {
F_93 ( V_53 -> V_161 -> V_162 ,
L_4 ,
V_248 ) ;
V_247 = - V_249 ;
...
static int F_143 ( struct V_53 * V_53 , struct V_254 * V_152 )
{
...
unsigned long V_47 ;
F_144 (
& F_145 ( V_53 , struct V_269 , V_53 ) -> V_270 , V_47 ) ;
F_146 ( V_267 , V_53 -> V_217 + 0x0 ) ;
V_268 = F_147 ( V_53 -> V_217 + 0x4 ) ;
F_148 (
& F_145 ( V_53 , struct V_269 , V_53 ) -> V_270 , V_47 ) ;
return V_268 ;
}
...
unsigned long V_47 ;
F_144 (
& F_145 ( V_53 , struct V_269 , V_53 ) -> V_271 , V_47 ) ;
F_146 ( V_267 , V_53 -> V_217 + 0x10 ) ;
V_268 = F_147 ( V_53 -> V_217 + 0x14 ) ;
F_148 (
& F_145 ( V_53 , struct V_269 , V_53 ) -> V_271 , V_47 ) ;
return V_268 ;
}
...
& F_145 ( V_53 , struct V_269 , V_53 ) -> V_271 , V_47 ) ;
F_146 ( V_267 , V_53 -> V_217 + 0x10 ) ;
F_146 ( V_48 , V_53 -> V_217 + 0x14 ) ;
F_148 (
& F_145 ( V_53 , struct V_269 , V_53 ) -> V_271 , V_47 ) ;
}
int F_149 ( struct V_53 * * V_272 )
{
struct V_269 * V_269 ;
* V_272 = NULL ;
...
int F_151 ( struct V_53 * V_53 )
{
if ( V_53 -> V_217 )
F_139 ( V_53 ) ;
F_4 ( F_145 ( V_53 , struct V_269 , V_53 ) ) ;
return 0 ;
}
