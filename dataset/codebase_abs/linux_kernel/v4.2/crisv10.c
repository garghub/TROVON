...
static void F_147 ( struct V_74 * V_12 , int V_367 )
{
unsigned long V_368 ;
struct V_8 * V_9 = (struct V_8 * ) V_12 -> V_77 ;
unsigned long V_215 = V_5 ;
...
if ( F_153 ( V_351 ) )
break;
if ( V_367 && F_154 ( V_5 , V_368 + V_367 ) )
break;
V_215 = V_5 ;
V_307 = F_71 () ;
V_216 =
...
int V_29 ;
int V_372 = 0 ;
if ( V_9 -> V_11 . V_36 & V_354 ) {
F_159 ( V_12 , V_9 -> V_11 . V_360 ,
! ( V_9 -> V_11 . V_36 & V_354 ) ) ;
#ifdef F_160
if ( V_9 -> V_11 . V_36 & V_373 )
return - V_374 ;
else
return - V_375 ;
#else
...
if ( ( V_350 -> V_376 & V_377 ) ||
( V_12 -> V_36 & ( 1 << V_241 ) ) ) {
V_9 -> V_11 . V_36 |= V_359 ;
return 0 ;
}
if ( V_12 -> V_13 . V_14 & V_378 ) {
V_372 = 1 ;
}
V_29 = 0 ;
F_161 ( & V_9 -> V_11 . V_358 , & V_371 ) ;
#ifdef F_101
F_5 ( L_100 ,
V_9 -> line , V_9 -> V_11 . V_85 ) ;
#endif
...
static int
F_167 ( struct V_74 * V_12 , struct V_349 * V_350 )
{
struct V_8 * V_9 ;
int V_29 ;
int V_380 = 0 ;
V_9 = V_186 + V_12 -> V_381 ;
if ( ! V_9 -> V_187 )
return - V_382 ;
#ifdef F_101
F_5 ( L_103 , V_351 -> V_352 , V_12 -> V_383 ,
V_9 -> V_11 . V_85 ) ;
#endif
V_9 -> V_11 . V_85 ++ ;
V_12 -> V_77 = V_9 ;
...
#endif
F_87 ( V_388 = 0 ) ;
F_170 ( if (info->line == SERIAL_DEBUG_LINE) {
info->icount.rx = 0;
} ) ;
return 0 ;
}
static void F_171 ( struct V_389 * V_390 , struct V_8 * V_9 )
{
unsigned long V_291 ;
F_172 ( V_390 , L_110 ,
V_9 -> line , ( unsigned long ) V_9 -> V_40 , V_9 -> V_51 ) ;
if ( ! V_9 -> V_40 || ( V_9 -> type == V_391 ) ) {
F_172 ( V_390 , L_111 ) ;
return;
}
F_172 ( V_390 , L_112 , V_9 -> V_21 ) ;
F_172 ( V_390 , L_113 ,
...
#endif
if ( V_9 -> V_122 . V_210 )
F_172 ( V_390 , L_118 , ( unsigned long ) V_9 -> V_122 . V_210 ) ;
if ( V_9 -> V_122 . V_209 )
F_172 ( V_390 , L_119 , ( unsigned long ) V_9 -> V_122 . V_209 ) ;
if ( V_9 -> V_122 . V_213 )
F_172 ( V_390 , L_120 , ( unsigned long ) V_9 -> V_122 . V_213 ) ;
if ( V_9 -> V_122 . V_204 )
F_172 ( V_390 , L_121 , ( unsigned long ) V_9 -> V_122 . V_204 ) ;
if ( ! F_138 ( V_9 ) )
F_173 ( V_390 , L_122 ) ;
if ( ! F_142 ( V_9 ) )
F_173 ( V_390 , L_123 ) ;
...
static int F_174 ( struct V_389 * V_390 , void * V_392 )
{
int V_178 ;
F_172 ( V_390 , L_128 , V_393 ) ;
for ( V_178 = 0 ; V_178 < V_185 ; V_178 ++ ) {
if ( ! V_186 [ V_178 ] . V_187 )
continue;
F_171 ( V_390 , & V_186 [ V_178 ] ) ;
}
#ifdef F_175
...
F_176 ( V_4 [ V_178 ] . V_6 ) ) ;
F_172 ( V_390 , V_4 [ V_178 ] . string , V_4 [ V_178 ] . V_1 ) ;
}
F_172 ( V_390 , L_130 , V_178 , V_3 ) ;
V_2 = 0 ;
#endif
return 0 ;
}
static int F_177 ( struct V_394 * V_394 , struct V_349 * V_349 )
{
return F_178 ( V_349 , F_174 , NULL ) ;
}
...
int V_178 ;
struct V_8 * V_9 ;
struct V_396 * V_397 = F_181 ( V_185 ) ;
if ( ! V_397 )
return - V_237 ;
F_179 () ;
#if ! F_38 ( V_398 )
...
V_397 -> V_407 = V_408 ;
V_397 -> V_407 . V_14 =
V_409 | V_410 | V_411 | V_244 | V_378 ;
V_397 -> V_407 . V_412 = 115200 ;
V_397 -> V_407 . V_413 = 115200 ;
V_397 -> V_36 = V_414 ;
F_185 ( V_397 , & V_415 ) ;
V_416 = V_397 ;
...
V_9 -> V_82 . V_36 &= ~ ( V_87 ) ;
#endif
F_188 ( & V_9 -> V_109 , F_94 ) ;
if ( V_9 -> V_187 ) {
F_5 ( V_395 L_140 ,
V_416 -> V_383 , V_9 -> line , V_9 -> V_40 ) ;
}
F_189 ( & V_9 -> V_11 , V_397 , V_178 ) ;
}
if ( F_190 ( V_397 ) )
F_61 ( L_141 ) ;
#ifdef V_127
