...
const struct V_165 * V_166 =
& V_3 -> V_5 -> V_166 ;
void T_2 * V_161 = V_3 -> V_163 + V_166 -> V_203 ;
unsigned int V_40 ;
...
static inline void
F_82 ( struct V_2 * V_3 , int V_204 )
{
unsigned int V_185 , V_205 ;
unsigned int V_19 , V_187 ;
const struct V_165 * V_166 =
& V_3 -> V_5 -> V_166 ;
V_205 = ( V_204 / 4 ) * 4 + V_166 -> V_206 ;
V_187 = F_70 ( V_3 -> V_163 + V_205 ) ;
V_19 = V_193 << ( ( V_204 % 4 ) * 8 ) ;
if ( ( V_19 & V_187 ) > 0 ) {
V_205 = ( V_204 / 4 ) * 4 + V_166 -> V_189 ;
V_185 = V_194 << ( ( V_204 % 4 ) * 8 ) ;
F_73 ( V_185 , V_3 -> V_163 + V_205 ) ;
}
}
static void F_83 ( unsigned V_152 , struct V_207 * V_148 )
{
struct V_208 * V_22 = F_84 ( V_152 ) ;
struct V_2 * V_3 = F_85 ( V_152 ) ;
unsigned int V_209 , V_145 ;
int V_16 , V_204 , V_180 ;
const struct V_165 * V_166 =
& V_3 -> V_5 -> V_166 ;
void T_2 * V_161 = F_68 ( V_3 , 0 , V_166 -> V_210 ) ;
int V_211 , V_170 , V_171 ;
const struct V_106 * V_4 ;
F_86 ( V_22 , V_148 ) ;
...
V_16 = F_87 ( V_209 ) ;
V_204 = V_145 + V_16 ;
V_180 = F_61 ( V_3 -> V_154 , V_204 ) ;
V_209 &= ~ F_5 ( V_16 ) ;
V_211 = V_3 -> V_178 [ V_204 ] ;
if ( V_211 ) {
F_73 ( F_5 ( V_16 ) , V_161 - V_166 -> V_210 +
V_166 -> V_212 ) ;
V_4 = F_47 ( V_3 , V_204 ) ;
V_170 = F_59 ( V_3 -> V_22 ,
V_4 -> V_4 . V_112 ) ;
...
F_88 ( V_180 ) ;
if ( V_211 ) {
V_171 = F_72 ( V_3 , V_204 ) ;
if ( V_170 != V_171 )
F_73 ( F_5 ( V_16 ) , V_161 -
V_166 -> V_210 +
V_166 -> V_213 ) ;
}
if ( V_204 < V_3 -> V_5 -> V_169 )
F_82 ( V_3 , V_204 ) ;
}
}
F_89 ( V_22 , V_148 ) ;
...
{
struct V_2 * V_3 = F_91 ( V_215 ) ;
int V_40 ;
V_3 -> V_102 = V_3 -> V_5 -> V_54 ;
V_3 -> V_97 = F_92 ( & V_215 -> V_24 , V_3 -> V_102 ,
sizeof( * V_3 -> V_97 ) , V_216 ) ;
if ( ! V_3 -> V_97 )
return - V_217 ;
V_3 -> V_140 = F_92 ( & V_215 -> V_24 , V_3 -> V_102 ,
sizeof( * V_3 -> V_140 ) , V_216 ) ;
if ( ! V_3 -> V_140 )
return - V_217 ;
for ( V_40 = 0 ; V_40 < V_3 -> V_5 -> V_54 ; V_40 ++ ) {
const struct V_106 * V_4 = V_3 -> V_5 -> V_107 + V_40 ;
...
int F_93 ( struct V_214 * V_215 ,
const struct V_218 * V_119 ,
struct V_1 * V_1 )
{
struct V_219 * V_107 ;
struct V_2 * V_3 ;
struct V_123 * V_137 = V_215 -> V_24 . V_220 , * V_124 ;
struct V_125 * V_221 ;
struct V_222 * V_223 ;
int V_40 , V_85 , V_152 ;
V_3 = F_94 ( & V_215 -> V_24 , sizeof( * V_3 ) , V_216 ) ;
if ( ! V_3 )
return - V_217 ;
F_95 ( V_215 , V_3 ) ;
V_221 = F_29 ( V_137 , L_11 , NULL ) ;
if ( ! V_221 ) {
F_18 ( & V_215 -> V_24 , L_12 ) ;
return - V_32 ;
}
V_124 = F_96 ( V_137 , L_13 , 0 ) ;
if ( V_124 ) {
V_3 -> V_9 = F_97 ( V_124 ) ;
if ( F_98 ( V_3 -> V_9 ) )
return F_99 ( V_3 -> V_9 ) ;
...
F_18 ( & V_215 -> V_24 , L_14 ) ;
return - V_32 ;
}
V_124 = F_96 ( V_137 , L_13 , 1 ) ;
if ( V_124 ) {
V_3 -> V_8 = F_97 ( V_124 ) ;
if ( F_98 ( V_3 -> V_8 ) )
return F_99 ( V_3 -> V_8 ) ;
...
V_85 = F_90 ( V_215 ) ;
if ( V_85 ) {
F_18 ( & V_215 -> V_24 , L_15 , V_85 ) ;
return - V_32 ;
}
V_107 = F_92 ( & V_215 -> V_24 , V_3 -> V_5 -> V_54 , sizeof( * V_107 ) ,
V_216 ) ;
if ( ! V_107 )
return - V_217 ;
for ( V_40 = 0 ; V_40 < V_3 -> V_5 -> V_54 ; V_40 ++ )
V_107 [ V_40 ] = V_3 -> V_5 -> V_107 [ V_40 ] . V_4 ;
V_224 . V_110 = F_100 ( & V_215 -> V_24 ) ;
V_224 . V_225 = V_226 ;
V_224 . V_107 = V_107 ;
V_224 . V_54 = V_3 -> V_5 -> V_54 ;
V_3 -> V_24 = & V_215 -> V_24 ;
V_3 -> V_158 = F_101 ( & V_224 , & V_215 -> V_24 , V_3 ) ;
if ( F_98 ( V_3 -> V_158 ) ) {
F_18 ( & V_215 -> V_24 , L_16 ) ;
return F_99 ( V_3 -> V_158 ) ;
}
V_3 -> V_22 = F_94 ( & V_215 -> V_24 , sizeof( * V_3 -> V_22 ) , V_216 ) ;
if ( ! V_3 -> V_22 ) {
V_85 = - V_217 ;
goto V_227;
}
* V_3 -> V_22 = V_228 ;
V_3 -> V_22 -> V_229 = V_3 -> V_5 -> V_54 ;
V_3 -> V_22 -> V_230 = F_100 ( & V_215 -> V_24 ) ;
V_3 -> V_22 -> V_24 = & V_215 -> V_24 ;
V_3 -> V_22 -> V_149 = - 1 ;
V_85 = F_102 ( V_3 -> V_22 ) ;
if ( V_85 ) {
V_85 = - V_32 ;
...
V_85 = F_103 ( V_3 -> V_22 , F_100 ( & V_215 -> V_24 ) ,
0 , 0 , V_3 -> V_5 -> V_54 ) ;
if ( V_85 ) {
V_85 = - V_32 ;
goto V_231;
...
if ( ! F_104 ( V_137 , L_17 ) )
return 0 ;
V_223 = F_105 ( V_215 , V_232 , 0 ) ;
if ( ! V_223 ) {
F_18 ( & V_215 -> V_24 , L_18 ) ;
V_85 = - V_32 ;
goto V_231;
}
V_3 -> V_163 = F_106 ( & V_215 -> V_24 , V_223 ) ;
if ( F_98 ( V_3 -> V_163 ) ) {
V_85 = - V_32 ;
goto V_231;
}
V_3 -> V_178 = F_92 ( & V_215 -> V_24 , V_3 -> V_5 -> V_162 ,
sizeof( int ) , V_216 ) ;
if ( ! V_3 -> V_178 ) {
V_85 = - V_217 ;
goto V_231;
...
V_152 = F_107 ( V_137 , 0 ) ;
if ( ! V_152 ) {
F_18 ( & V_215 -> V_24 , L_19 ) ;
V_85 = - V_32 ;
goto V_231;
}
V_3 -> V_154 = F_108 ( V_137 ,
V_3 -> V_5 -> V_162 , & V_233 , NULL ) ;
if ( ! V_3 -> V_154 ) {
F_18 ( & V_215 -> V_24 , L_20 ) ;
V_85 = - V_217 ;
goto V_231;
}
F_81 ( V_3 ) ;
for ( V_40 = 0 ; V_40 < V_3 -> V_5 -> V_162 ; V_40 ++ ) {
int V_180 = F_109 ( V_3 -> V_154 , V_40 ) ;
F_110 ( V_180 , & V_234 ,
V_235 ) ;
F_111 ( V_180 , V_3 ) ;
F_112 ( V_180 , V_236 ) ;
} ;
F_113 ( V_152 , F_83 , V_3 ) ;
F_112 ( V_152 , V_236 ) ;
return 0 ;
V_231:
F_114 ( V_3 -> V_22 ) ;
