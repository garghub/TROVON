...
static void F_101 ( void * V_106 )
{
struct V_96 * V_97 = V_106 ;
if ( ! V_97 )
return;
F_34 ( L_35 , V_97 -> V_99 ) ;
if ( V_97 -> V_100 )
...
F_102 ( V_97 -> V_89 , NULL , NULL , NULL ) ;
F_34 ( L_36 , V_97 -> V_99 ) ;
F_91 ( V_97 ) ;
}
...
return - V_107 ;
F_60 ( & V_2 -> V_72 ) ;
F_103 (handler, &ec->list, node) {
if ( V_91 == V_97 -> V_99 ) {
V_97 = F_86 ( V_97 ) ;
F_34 ( L_37 ,
V_97 -> V_99 ) ;
V_46 = F_104 ( ( V_97 -> V_100 ) ?
V_108 : V_109 ,
F_101 , V_97 ) ;
if ( F_62 ( V_46 ) )
V_80 = - V_110 ;
...
static void F_106 ( struct V_111 * V_33 )
{
unsigned long V_4 ;
...
static T_6
F_108 ( T_3 V_115 , T_7 V_79 ,
T_3 V_116 , T_8 * V_117 ,
void * V_118 , void * V_119 )
{
struct V_1 * V_2 = V_118 ;
int V_80 = 0 , V_90 , V_120 = V_116 / 8 ;
T_1 * V_91 = ( T_1 * ) V_117 ;
if ( ( V_79 > 0xFF ) || ! V_91 || ! V_118 )
return V_121 ;
if ( V_115 != V_122 && V_115 != V_123 )
return V_121 ;
if ( V_63 || V_116 > 8 )
F_65 ( V_2 ) ;
for ( V_90 = 0 ; V_90 < V_120 ; ++ V_90 , ++ V_79 , ++ V_91 )
V_80 = ( V_115 == V_122 ) ?
F_67 ( V_2 , V_79 , V_91 ) :
F_68 ( V_2 , V_79 , * V_91 ) ;
if ( V_63 || V_116 > 8 )
...
F_112 ( & V_2 -> V_104 ) ;
F_113 ( & V_2 -> V_39 ) ;
F_114 ( & V_2 -> V_33 , F_106 ) ;
V_2 -> V_15 = V_16 ;
return V_2 ;
}
static T_6
F_115 ( T_4 V_89 , T_3 V_127 ,
void * V_128 , void * * V_129 )
{
char V_130 [ 5 ] ;
struct V_131 V_132 = { sizeof( V_130 ) , V_130 } ;
struct V_1 * V_2 = V_128 ;
int V_91 = 0 ;
T_6 V_46 ;
V_46 = F_116 ( V_89 , V_133 , & V_132 ) ;
if ( F_117 ( V_46 ) && sscanf ( V_130 , L_40 , & V_91 ) == 1 )
F_93 ( V_2 , V_91 , V_89 , NULL , NULL ) ;
return V_126 ;
}
static T_6
F_118 ( T_4 V_89 , T_3 V_134 , void * V_128 , void * * V_135 )
{
T_6 V_46 ;
unsigned long long V_68 = 0 ;
struct V_1 * V_2 = V_128 ;
V_2 -> V_8 = V_2 -> V_14 = 0 ;
V_46 = F_119 ( V_89 , V_136 ,
V_137 , V_2 ) ;
if ( F_62 ( V_46 ) )
return V_46 ;
...
static int F_128 ( struct V_142 * V_143 )
{
struct V_1 * V_2 = NULL ;
int V_38 ;
strcpy ( F_129 ( V_143 ) , V_144 ) ;
strcpy ( F_130 ( V_143 ) , V_145 ) ;
if ( V_146 &&
( V_146 -> V_89 == V_143 -> V_89 ||
V_146 -> V_89 == V_147 ) ) {
V_2 = V_146 ;
V_146 = NULL ;
} else {
...
if ( F_118 ( V_143 -> V_89 , 0 , V_2 , NULL ) !=
V_138 ) {
F_90 ( V_2 ) ;
return - V_69 ;
}
F_131 ( V_148 , V_2 -> V_89 , 1 ,
F_115 , NULL , V_2 , NULL ) ;
if ( ! V_86 )
V_86 = V_2 ;
V_143 -> V_149 = V_2 ;
...
static int F_135 ( struct V_142 * V_143 )
{
struct V_1 * V_2 ;
struct V_96 * V_97 , * V_68 ;
if ( ! V_143 )
...
static T_6
V_137 ( struct V_150 * V_151 , void * V_128 )
{
struct V_1 * V_2 = V_128 ;
if ( V_151 -> type != V_152 )
return V_126 ;
if ( V_2 -> V_14 == 0 )
V_2 -> V_14 = V_151 -> V_18 . V_153 . V_154 ;
else if ( V_2 -> V_8 == 0 )
V_2 -> V_8 = V_151 -> V_18 . V_153 . V_154 ;
else
return V_138 ;
return V_126 ;
}
...
static int F_140 ( const struct V_156 * V_157 )
{
V_158 = 1 ;
return 0 ;
}
static int F_141 ( const struct V_156 * V_157 )
{
V_159 = 1 ;
return 0 ;
}
static int F_142 ( const struct V_156 * V_157 )
{
F_55 ( L_52 ) ;
V_95 = 1 ;
V_34 = V_35 ;
...
if ( F_117 ( V_46 ) ) {
F_77 ( L_53 ) ;
V_146 -> V_8 = V_162 -> V_166 . V_79 ;
V_146 -> V_14 = V_162 -> V_18 . V_79 ;
V_146 -> V_21 = V_162 -> V_21 ;
V_146 -> V_89 = V_147 ;
F_146 ( V_147 , V_162 -> V_157 ,
& V_146 -> V_89 ) ;
if ( ! V_159 )
goto V_167;
V_160 = F_147 ( V_146 , sizeof( struct V_1 ) , V_101 ) ;
if ( ! V_160 )
return - V_102 ;
}
if ( V_158 ) {
...
F_55 ( L_54 ) ;
V_46 = F_148 ( V_168 [ 0 ] . V_157 , F_118 ,
V_146 , NULL ) ;
if ( F_62 ( V_46 ) || ! V_146 -> V_89 )
goto error;
if ( V_160 ) {
if ( V_160 -> V_8 != V_146 -> V_8 ||
V_160 -> V_14 != V_146 -> V_14 ||
V_160 -> V_21 != V_146 -> V_21 ||
V_160 -> V_89 != V_146 -> V_89 )
F_77 ( L_55
L_56
L_57
L_58 ) ;
...
static int F_151 ( const char * V_84 , struct V_169 * V_170 )
{
int V_80 = 0 ;
...
static int F_152 ( char * V_132 , struct V_169 * V_170 )
{
switch ( V_34 ) {
case V_35 :
return sprintf ( V_132 , L_61 ) ;
case V_36 :
return sprintf ( V_132 , L_63 ) ;
case V_42 :
return sprintf ( V_132 , L_65 ) ;
default:
return sprintf ( V_132 , L_67 ) ;
}
return 0 ;
}
int T_9 F_153 ( void )
