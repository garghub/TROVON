...
V_149 -> V_157 = V_158 ;
V_149 -> V_157 . V_71 =
V_159 | V_83 | V_160 | V_161 | V_162 ;
V_149 -> V_20 = V_163 ;
F_77 ( V_149 , & V_164 ) ;
F_7 ( V_20 ) ;
for( V_69 = 0 ; V_69 < V_150 ; V_69 ++ ) {
V_2 = & V_90 [ V_69 ] ;
F_78 ( & V_2 -> V_43 ) ;
V_2 -> V_43 . V_165 = & V_166 ;
V_2 -> V_7 = V_8 ;
...
V_170 = V_21 & ~ V_22 ;
V_171:
for ( V_69 = 0 ; V_69 < F_87 ( V_172 ) ; V_69 ++ )
if ( V_172 [ V_69 ] == V_173 )
break;
if ( V_69 >= F_87 ( V_172 ) ) {
V_173 = 9600 ;
...
V_174 = F_33 ( V_15 , V_75 [ V_69 ] . V_76 ) |
F_33 ( V_14 , V_75 [ V_69 ] . V_77 ) ;
V_21 &= ~ ( V_78 | V_79 | V_80 | V_81 ) ;
V_21 |= V_81 ;
V_21 |= V_22 ;
...
int F_88 ( struct V_176 * V_177 , char * V_124 )
{
int V_69 , V_178 = V_179 ;
if ( ! V_177 )
return ( - 1 ) ;
if ( V_124 )
V_178 = F_89 ( V_124 , NULL , 0 ) ;
for ( V_69 = 0 ; V_69 < F_87 ( V_172 ) ; V_69 ++ )
if ( V_172 [ V_69 ] == V_178 )
break;
if ( V_69 < F_87 ( V_172 ) ) {
...
static struct V_180 * F_90 ( struct V_176 * V_91 , int * V_148 )
{
* V_148 = V_91 -> V_148 ;
return V_149 ;
}
void F_91 ( struct V_176 * V_181 , const char * V_182 ,
unsigned int V_96 )
{
if ( ! V_175 )
F_86 () ;
