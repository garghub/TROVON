...
if ( V_25 )
break;
V_25 = memcmp ( V_21 -> V_35 , V_22 . V_35 ,
sizeof( V_22 . V_35 ) ) ;
if ( V_25 )
V_25 = - V_36 ;
break;
...
static int F_16 ( const char * V_39 )
{
char * * V_40 ;
int V_41 ;
int V_42 = 0 ;
...
static enum V_14 F_19 ( struct V_5 * V_5 )
{
struct V_6 * V_6 = F_6 ( V_5 ) ;
if ( ! V_44 || ! F_20 ( V_6 -> V_45 ) || V_2 )
return 0 ;
return F_7 ( V_5 , NULL , NULL , 0 , NULL ) ;
}
static int F_21 ( struct V_5 * V_5 , const char * V_15 ,
...
int F_25 ( struct V_5 * V_5 , const char * V_15 ,
const void * V_16 , T_2 V_17 )
{
...
return F_21 ( V_5 , V_15 , V_16 ,
V_17 ) ;
}
int F_26 ( struct V_5 * V_5 , const char * V_15 )
{
return F_21 ( V_5 , V_15 , NULL , 0 ) ;
}
void F_27 ( struct V_5 * V_5 , const char * V_15 ,
const void * V_16 , T_2 V_17 )
{
if ( ! V_44 || ( ! F_16 ( V_15 )
&& ! F_23 ( V_15 ) ) )
return;
F_14 ( V_5 , V_15 , V_16 , V_17 ) ;
}
void F_28 ( struct V_5 * V_5 , const char * V_15 )
{
if ( ! V_44 || ! F_16 ( V_15 ) )
return;
F_14 ( V_5 , V_15 , NULL , 0 ) ;
}
int F_29 ( struct V_5 * V_5 , struct V_59 * V_60 )
{
...
void F_30 ( struct V_5 * V_5 , int V_61 )
{
if ( ! V_44 )
return;
if ( V_61 & ( V_62 | V_63 | V_64 ) )
F_14 ( V_5 , NULL , NULL , 0 ) ;
}
...
struct V_20 * V_21 ;
int V_25 ;
if ( ! V_44 || ! F_16 ( V_65 -> V_57 ) )
return 0 ;
V_21 = F_32 ( sizeof( * V_21 ) , V_28 ) ;
if ( ! V_21 )
return - V_67 ;
V_21 -> type = V_34 ;
V_25 = F_33 ( V_6 , V_65 , V_21 -> V_35 ) ;
if ( V_25 < 0 )
goto V_33;
V_66 -> V_68 = V_21 ;
