...
void
F_73 ( unsigned int V_1 , T_2 V_57 , int V_58 ,
const char * V_59 )
{
unsigned long V_4 ;
...
if ( ! V_6 )
return;
F_67 ( V_6 , V_57 , V_58 , V_59 ) ;
F_8 ( V_6 , V_4 ) ;
}
void
F_74 ( unsigned int V_1 , T_2 V_57 ,
void * V_13 )
{
unsigned long V_4 ;
struct V_5 * V_6 = F_6 ( V_1 , & V_4 , 0 ) ;
if ( ! V_6 )
return;
F_67 ( V_6 , V_57 , 1 , NULL ) ;
V_6 -> V_9 . V_14 = V_13 ;
F_8 ( V_6 , V_4 ) ;
}
void
F_75 ( unsigned int V_1 , struct V_2 * V_3 ,
T_2 V_57 , const char * V_59 )
{
F_1 ( V_1 , V_3 ) ;
F_73 ( V_1 , V_57 , 0 , V_59 ) ;
}
void F_76 ( unsigned int V_1 , unsigned long V_63 , unsigned long V_64 )
{
unsigned long V_4 ;
struct V_5 * V_6 = F_2 ( V_1 , & V_4 , 0 ) ;
if ( ! V_6 )
...
int F_96 ( struct V_9 * V_13 , unsigned int type )
{
V_13 = V_13 -> V_61 ;
if ( V_13 -> V_3 -> V_76 )
return V_13 -> V_3 -> V_76 ( V_13 , type ) ;
return - V_75 ;
}
int F_97 ( struct V_9 * V_13 )
{
for ( V_13 = V_13 -> V_61 ; V_13 ; V_13 = V_13 -> V_61 )
if ( V_13 -> V_3 && V_13 -> V_3 -> V_77 )
return V_13 -> V_3 -> V_77 ( V_13 ) ;
return 0 ;
}
int F_98 ( struct V_9 * V_13 , void * V_78 )
{
V_13 = V_13 -> V_61 ;
if ( V_13 -> V_3 -> V_79 )
return V_13 -> V_3 -> V_79 ( V_13 , V_78 ) ;
return - V_75 ;
}
int F_99 ( struct V_9 * V_13 , unsigned int V_80 )
{
V_13 = V_13 -> V_61 ;
if ( V_13 -> V_3 -> V_81 )
return V_13 -> V_3 -> V_81 ( V_13 , V_80 ) ;
return - V_75 ;
}
int F_100 ( struct V_9 * V_13 , struct V_82 * V_83 )
{
struct V_9 * V_84 = NULL ;
#ifdef F_68
for (; V_13 ; V_13 = V_13 -> V_61 )
#endif
if ( V_13 -> V_3 && V_13 -> V_3 -> V_85 )
V_84 = V_13 ;
if ( ! V_84 )
return - V_75 ;
V_84 -> V_3 -> V_85 ( V_84 , V_83 ) ;
return 0 ;
}
