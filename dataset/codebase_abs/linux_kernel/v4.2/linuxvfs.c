...
static const char *
F_62 ( struct V_25 * V_25 , void * * V_128 )
{
...
if ( ! V_130 )
return F_14 ( - V_71 ) ;
if ( F_65 ( V_12 , V_110 , V_130 , V_77 ) != V_77 ) {
F_16 ( V_130 ) ;
F_7 ( V_12 , L_28 ) ;
return F_14 ( - V_50 ) ;
}
...
V_141 = F_66 ( & V_132 [ V_137 ] , V_133 - V_137 , & V_139 ) ;
if ( V_141 < 0 )
goto V_144;
if ( V_139 > V_145 )
goto V_144;
...
static int
F_68 ( char * V_150 , struct V_151 * V_152 )
{
char * V_153 ;
T_11 args [ V_154 ] ;
int V_155 ;
...
if ( ! V_150 )
return 1 ;
while ( ( V_153 = F_69 ( & V_150 , L_37 ) ) != NULL ) {
int V_160 ;
if ( ! * V_153 )
continue;
V_160 = F_70 ( V_153 , V_161 , args ) ;
switch ( V_160 ) {
case V_162 :
...
static int
F_78 ( struct V_11 * V_12 , void * V_110 , int V_169 )
{
struct V_8 * V_66 ;
struct V_68 * V_69 ;
T_14 * V_170 ;
...
F_79 ( V_12 , V_110 ) ;
V_12 -> V_168 = F_80 ( sizeof( * V_69 ) , V_59 ) ;
if ( V_12 -> V_168 == NULL ) {
F_58 ( L_45
L_46 , V_12 -> V_174 ) ;
goto V_78;
...
F_6 ( V_12 , L_55 ,
V_69 -> V_85 . V_158 ) ;
V_69 -> V_34 = F_89 ( V_69 -> V_85 . V_158 ) ;
if ( ! V_69 -> V_34 ) {
F_17 ( V_12 , L_56
L_57 ,
V_69 -> V_85 . V_158 ) ;
...
static int
F_91 ( struct V_11 * V_12 , int * V_27 , char * V_110 )
{
F_92 ( V_12 ) ;
if ( ! ( * V_27 & V_177 ) )
return - V_143 ;
...
{
struct V_11 * V_12 = V_25 -> V_129 ;
T_16 V_190 = F_94 ( V_12 -> V_191 -> V_192 ) ;
F_6 ( V_12 , L_29 , V_23 ) ;
V_189 -> V_193 = V_183 ;
...
void * V_110 )
{
return F_96 ( V_207 , V_27 , V_208 , V_110 , F_78 ) ;
}
static int T_8
F_97 ( void )
{
