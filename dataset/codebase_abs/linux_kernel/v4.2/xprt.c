...
static void F_95 ( struct V_15 * V_16 , struct V_17 * V_18 )
{
...
{
if ( F_97 ( & V_16 -> V_133 ) == NULL )
F_18 ( V_138 , & V_16 -> V_24 ) ;
}
static bool F_98 ( struct V_15 * V_16 , struct V_17 * V_18 )
{
bool V_90 = false ;
...
static struct V_19 * F_99 ( struct V_15 * V_16 , T_3 V_140 )
{
struct V_19 * V_20 = F_100 ( - V_31 ) ;
if ( ! F_101 ( & V_16 -> V_128 , 1 , V_16 -> V_141 ) )
goto V_8;
V_20 = F_102 ( sizeof( struct V_19 ) , V_140 ) ;
if ( V_20 != NULL )
goto V_8;
F_103 ( & V_16 -> V_128 ) ;
V_20 = F_100 ( - V_142 ) ;
...
static bool F_104 ( struct V_15 * V_16 , struct V_19 * V_20 )
{
if ( F_101 ( & V_16 -> V_128 , - 1 , V_16 -> V_143 ) ) {
F_105 ( V_20 ) ;
return true ;
}
return false ;
}
void F_106 ( struct V_15 * V_16 , struct V_17 * V_18 )
{
struct V_19 * V_20 ;
F_2 ( & V_16 -> V_139 ) ;
if ( ! F_65 ( & V_16 -> free ) ) {
V_20 = F_107 ( V_16 -> free . V_144 , struct V_19 , V_114 ) ;
F_108 ( & V_20 -> V_114 ) ;
goto V_145;
}
V_20 = F_99 ( V_16 , V_146 | V_147 ) ;
if ( ! F_109 ( V_20 ) )
goto V_145;
switch ( F_110 ( V_20 ) ) {
case - V_142 :
...
void F_112 ( struct V_15 * V_16 , struct V_17 * V_18 )
{
if ( F_24 ( V_16 , V_18 ) ) {
F_106 ( V_16 , V_18 ) ;
F_36 ( V_16 , V_18 ) ;
...
static void F_113 ( struct V_15 * V_16 , struct V_19 * V_20 )
{
F_2 ( & V_16 -> V_139 ) ;
if ( ! F_104 ( V_16 , V_20 ) ) {
memset ( V_20 , 0 , sizeof( * V_20 ) ) ;
F_114 ( & V_20 -> V_114 , & V_16 -> free ) ;
}
F_96 ( V_16 ) ;
F_6 ( & V_16 -> V_139 ) ;
}
...
V_20 = F_116 ( & V_16 -> free , struct V_19 , V_114 ) ;
F_108 ( & V_20 -> V_114 ) ;
F_105 ( V_20 ) ;
}
}
struct V_15 * F_117 ( struct V_148 * V_148 , T_4 V_149 ,
unsigned int V_150 ,
unsigned int V_151 )
{
struct V_15 * V_16 ;
struct V_19 * V_20 ;
int V_152 ;
V_16 = F_102 ( V_149 , V_153 ) ;
if ( V_16 == NULL )
goto V_8;
F_118 ( V_16 , V_148 ) ;
for ( V_152 = 0 ; V_152 < V_150 ; V_152 ++ ) {
V_20 = F_102 ( sizeof( struct V_19 ) , V_153 ) ;
if ( ! V_20 )
goto V_154;
F_114 ( & V_20 -> V_114 , & V_16 -> free ) ;
}
...
static void F_111 ( struct V_17 * V_18 , struct V_15 * V_16 )
{
struct V_19 * V_20 = V_18 -> V_21 ;
F_130 ( & V_20 -> V_114 ) ;
...
static void F_118 ( struct V_15 * V_16 , struct V_148 * V_148 )
{
F_119 ( & V_16 -> V_171 , 1 ) ;
F_138 ( & V_16 -> V_40 ) ;
F_138 ( & V_16 -> V_139 ) ;
...
struct V_15 * F_143 ( struct V_178 * args )
{
struct V_15 * V_16 ;
struct V_1 * V_3 ;
F_2 ( & V_6 ) ;
