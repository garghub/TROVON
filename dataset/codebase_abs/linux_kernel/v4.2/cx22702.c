...
static int F_14 ( struct V_52 * V_53 , enum V_71 * V_72 )
{
struct V_1 * V_2 = V_53 -> V_55 ;
T_1 V_73 ;
T_1 V_74 ;
...
static int F_15 ( struct V_52 * V_53 , T_2 * V_80 )
{
struct V_1 * V_2 = V_53 -> V_55 ;
if ( F_5 ( V_2 , 0xE4 ) & 0x02 ) {
* V_80 = ( F_5 ( V_2 , 0xDE ) & 0x7F ) << 7
| ( F_5 ( V_2 , 0xDF ) & 0x7F ) ;
} else {
* V_80 = ( F_5 ( V_2 , 0xDE ) & 0x7F ) << 7
| F_5 ( V_2 , 0xDF ) ;
...
V_74 = ~ V_74 & 0x7f ;
* V_81 = ( V_74 << 9 ) | ( V_74 << 2 ) | ( V_74 >> 5 ) ;
}
return 0 ;
}
static int F_17 ( struct V_52 * V_53 , T_3 * V_82 )
{
struct V_1 * V_2 = V_53 -> V_55 ;
T_3 V_83 ;
if ( F_5 ( V_2 , 0xE4 ) & 0x02 ) {
V_83 = ( F_5 ( V_2 , 0xDE ) & 0x7F ) << 7
| ( F_5 ( V_2 , 0xDF ) & 0x7F ) ;
} else {
V_83 = ( F_5 ( V_2 , 0xDE ) & 0x7F ) << 8
| F_5 ( V_2 , 0xDF ) ;
}
* V_82 = ~ V_83 ;
return 0 ;
}
static int F_18 ( struct V_52 * V_53 , T_2 * V_84 )
{
struct V_1 * V_2 = V_53 -> V_55 ;
T_1 V_85 ;
V_85 = F_5 ( V_2 , 0xE3 ) ;
...
{
struct V_25 * V_87 = & V_53 -> V_56 ;
struct V_1 * V_2 = V_53 -> V_55 ;
T_1 V_88 = F_5 ( V_2 , 0x0C ) ;
V_87 -> V_18 = V_88 & 0x1 ? V_22 : V_23 ;
return F_7 ( V_2 , V_87 ) ;
}
...
struct V_52 * F_23 ( const struct V_92 * V_10 ,
struct V_93 * V_14 )
{
struct V_1 * V_2 = NULL ;
