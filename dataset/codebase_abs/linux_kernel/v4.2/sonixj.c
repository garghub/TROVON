...
return;
V_19 -> V_48 = V_134 ;
V_126 = F_59 ( & V_19 -> V_206 ) ;
F_5 ( V_114 , L_30 , V_126 ) ;
if ( V_19 -> V_20 == V_63 ) {
F_60 ( V_1 , V_126 , V_204 , V_205 ,
15 , 1024 ) ;
return;
}
if ( V_126 < V_204 - V_205 ||
V_126 > V_204 + V_205 ) {
switch ( V_19 -> V_20 ) {
case V_23 :
V_203 = V_19 -> V_86 ;
...
{
int V_206 ;
V_206 = ( V_13 [ 27 ] << 8 ) + V_13 [ 28 ]
+ ( V_13 [ 31 ] << 8 ) + V_13 [ 32 ]
+ ( V_13 [ 23 ] << 8 ) + V_13 [ 24 ]
+ ( V_13 [ 35 ] << 8 ) + V_13 [ 36 ]
+ ( V_13 [ 29 ] << 10 ) + ( V_13 [ 30 ] << 2 ) ;
V_206 >>= 10 ;
F_62 ( & V_19 -> V_206 , V_206 ) ;
}
...
F_64 ( V_1 , V_210 , V_13 , V_27 ) ;
if ( V_207 == 0 ) {
int V_215 ;
V_215 = ( V_19 -> V_193 * 100 ) /
( V_19 -> V_47 *
V_1 -> V_216 [ 0 ] -> V_217 [ 0 ] . V_218 ) ;
if ( V_215 >= 85 )
V_207 = - 3 ;
else if ( V_215 < 75 )
V_207 = 2 ;
...
static int F_66 ( struct V_221 * V_222 )
{
struct V_1 * V_1 =
F_48 ( V_222 -> V_223 , struct V_1 , V_67 ) ;
V_1 -> V_5 = 0 ;
if ( ! V_1 -> V_224 )
return 0 ;
switch ( V_222 -> V_39 ) {
...
int V_4 = - V_225 ;
if ( V_3 == 1 && V_13 [ 0 ] == 1 ) {
F_68 ( V_1 -> V_226 , V_227 , 1 ) ;
F_69 ( V_1 -> V_226 ) ;
F_68 ( V_1 -> V_226 , V_227 , 0 ) ;
F_69 ( V_1 -> V_226 ) ;
V_4 = 0 ;
}
return V_4 ;
}
static int F_70 ( struct V_228 * V_229 ,
const struct V_38 * V_39 )
{
return F_71 ( V_229 , V_39 , & V_230 , sizeof( struct V_19 ) ,
V_231 ) ;
}
