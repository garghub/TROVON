...
if ( V_4 )
return 0 ;
V_4 = F_25 ( V_8 , V_9 - 1 , type ) ;
if ( ! V_4 ) {
V_4 = F_27 ( sizeof( struct V_1 ) , V_21 ) ;
if ( ! V_4 )
return - V_19 ;
} else {
F_6 ( & V_5 ) ;
...
static T_4 F_32 ( struct V_1 * V_4 , char * V_23 )
{
return snprintf ( V_23 , V_24 , L_3 ,
( unsigned long long ) V_4 -> V_8 ) ;
}
static T_4 F_33 ( struct V_1 * V_4 , char * V_23 )
{
return snprintf ( V_23 , V_24 , L_3 ,
( unsigned long long ) V_4 -> V_9 ) ;
}
static T_4 F_34 ( struct V_1 * V_4 , char * V_23 )
{
return snprintf ( V_23 , V_24 , L_4 , V_4 -> type ) ;
}
static inline struct V_25 * F_35 ( struct V_26 * V_27 )
{
return F_2 ( V_27 , struct V_25 , V_27 ) ;
}
static T_4 F_36 ( struct V_2 * V_3 ,
struct V_26 * V_27 , char * V_23 )
{
struct V_1 * V_4 = F_1 ( V_3 ) ;
struct V_25 * V_28 = F_35 ( V_27 ) ;
return V_28 -> V_29 ( V_4 , V_23 ) ;
}
