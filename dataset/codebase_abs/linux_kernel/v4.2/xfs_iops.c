...
T_7 V_185 = V_167 ;
F_82 ( V_6 , V_185 ) ;
error = F_115 ( F_39 ( V_15 ) , & V_185 , true ) ;
if ( ! error ) {
F_82 ( V_6 , V_168 ) ;
V_185 |= V_168 ;
...
int error ;
F_117 ( V_6 ) ;
V_123 = F_79 ( V_73 , V_188 ) ;
error = F_80 ( V_123 , & F_81 ( V_73 ) -> V_189 , 0 , 0 ) ;
if ( error ) {
F_99 ( V_123 ) ;
return error ;
}
...
if ( V_32 & V_190 ) {
V_1 -> V_93 = * V_187 ;
V_6 -> V_79 . V_118 . V_112 = ( V_191 ) V_187 -> V_113 ;
V_6 -> V_79 . V_118 . V_114 = ( V_191 ) V_187 -> V_115 ;
}
if ( V_32 & V_192 ) {
V_1 -> V_92 = * V_187 ;
V_6 -> V_79 . V_121 . V_112 = ( V_191 ) V_187 -> V_113 ;
V_6 -> V_79 . V_121 . V_114 = ( V_191 ) V_187 -> V_115 ;
}
if ( V_32 & V_193 ) {
V_1 -> V_90 = * V_187 ;
V_6 -> V_79 . V_111 . V_112 = ( V_191 ) V_187 -> V_113 ;
V_6 -> V_79 . V_111 . V_114 = ( V_191 ) V_187 -> V_115 ;
}
F_88 ( V_123 , V_6 , V_107 ) ;
F_92 ( V_123 , V_6 , V_194 ) ;
return F_95 ( V_123 ) ;
}
STATIC int
F_118 (
...
{
int error ;
struct V_199 * V_200 = * V_195 ;
T_9 V_201 = 0 ;
T_10 V_202 , V_203 , V_204 ;
if ( V_197 -> V_205 == - 1LL )
return 0 ;
V_202 = F_119 ( V_197 -> V_206 ) ;
V_203 = F_119 ( V_197 -> V_205 ) ;
V_204 = F_119 ( V_197 -> V_207 ) ;
if ( V_197 -> V_208 & V_209 )
V_201 |= V_210 ;
else if ( V_197 -> V_208 & V_211 ) {
V_201 |= ( V_212 |
V_213 ) ;
V_203 = 0 ;
}
if ( V_197 -> V_208 & V_214 )
V_201 |= V_215 ;
error = F_120 ( V_200 , V_202 , V_203 ,
V_204 , V_201 ) ;
if ( error > 0 ) {
error = 0 ;
* V_198 = 1 ;
...
struct V_196 V_217 ;
int error ;
error = F_122 ( V_200 , V_218 ) ;
if ( error )
return error ;
V_217 . V_206 = F_123 ( V_216 ) ;
if ( V_204 == V_219 )
V_217 . V_207 = - 1LL ;
else
V_217 . V_207 = F_124 ( V_216 + V_204 ) - V_217 . V_206 ;
V_217 . V_220 = ! V_200 -> V_221 ? V_222 :
V_200 -> V_221 + 1 ;
V_217 . V_220 = F_125 ( V_223 , V_217 . V_220 ,
( V_224 * 16 / sizeof( struct V_196 ) ) ) ;
V_217 . V_225 = V_226 | V_227 ;
if ( V_200 -> V_228 & V_229 )
V_217 . V_225 |= V_230 ;
if ( ! ( V_200 -> V_228 & V_231 ) )
V_217 . V_225 |= V_232 ;
error = F_126 ( V_6 , & V_217 , F_118 , V_200 ) ;
if ( error )
return error ;
return 0 ;
}
...
struct V_5 * V_6 )
{
T_12 V_32 = V_6 -> V_79 . V_233 ;
V_1 -> V_234 &= ~ ( V_235 | V_236 | V_237 |
V_238 | V_239 ) ;
if ( V_32 & V_240 )
V_1 -> V_234 |= V_235 ;
if ( V_32 & V_241 )
...
F_128 ( V_1 , V_6 ) ;
V_6 -> V_253 = V_6 -> V_74 -> V_254 ;
F_136 ( & V_6 -> V_255 . V_256 , & V_257 ) ;
switch ( V_1 -> V_42 & V_20 ) {
case V_258 :
V_1 -> V_259 = & V_260 ;
V_1 -> V_261 = & V_262 ;
V_1 -> V_177 -> V_263 = & V_264 ;
break;
case V_33 :
F_136 ( & V_6 -> V_255 . V_256 , & V_265 ) ;
if ( F_43 ( & F_44 ( V_1 -> V_43 ) -> V_44 ) )
V_1 -> V_259 = & V_266 ;
else
V_1 -> V_259 = & V_267 ;
V_1 -> V_261 = & V_268 ;
V_6 -> V_253 = V_6 -> V_74 -> V_269 ;
break;
case V_46 :
V_1 -> V_259 = & V_270 ;
if ( ! ( V_6 -> V_101 . V_271 & V_272 ) )
V_1 -> V_177 -> V_263 = & V_264 ;
break;
default:
V_1 -> V_259 = & V_260 ;
F_137 ( V_1 , V_1 -> V_42 , V_1 -> V_250 ) ;
break;
}
V_246 = F_138 ( V_1 -> V_177 ) ;
F_139 ( V_1 -> V_177 , ( V_246 & ~ ( V_273 ) ) ) ;
if ( ! F_140 ( V_6 ) ) {
F_141 ( V_1 ) ;
F_142 ( V_1 ) ;
}
