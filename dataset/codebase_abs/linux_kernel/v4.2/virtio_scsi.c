...
static void F_118 ( struct V_51 * V_52 ,
struct V_55 * V_56 )
{
F_119 ( & V_52 -> V_57 ) ;
V_52 -> V_56 = V_56 ;
...
struct V_55 * * V_185 ;
V_64 = V_10 -> V_65 + V_60 ;
V_185 = F_105 ( V_64 * sizeof( struct V_55 * ) , V_165 ) ;
V_183 = F_105 ( V_64 * sizeof( T_5 * ) , V_165 ) ;
V_184 = F_105 ( V_64 * sizeof( char * ) , V_165 ) ;
...
if ( V_70 )
goto V_104;
F_118 ( & V_10 -> V_67 , V_185 [ 0 ] ) ;
F_118 ( & V_10 -> V_77 , V_185 [ 1 ] ) ;
for ( V_63 = V_60 ; V_63 < V_64 ; V_63 ++ )
F_118 ( & V_10 -> V_62 [ V_63 - V_60 ] ,
V_185 [ V_63 ] ) ;
F_114 ( V_10 , true ) ;
F_122 ( V_3 , V_187 , V_136 ) ;
F_122 ( V_3 , V_188 , V_45 ) ;
V_70 = 0 ;
V_104:
F_109 ( V_184 ) ;
F_109 ( V_183 ) ;
...
struct V_191 * V_192 ;
if ( ! V_3 -> V_180 -> V_193 ) {
F_124 ( & V_3 -> V_163 , L_12 ,
V_194 ) ;
return - V_195 ;
}
V_65 = F_125 ( V_3 , V_65 ) ? : 1 ;
V_190 = F_125 ( V_3 , V_196 ) + 1 ;
if ( V_65 == 1 )
V_192 = & V_197 ;
else
V_192 = & V_198 ;
...
if ( V_70 )
goto V_200;
V_10 -> V_174 . V_201 = & F_117 ;
V_70 = F_127 ( & V_10 -> V_174 ) ;
if ( V_70 ) {
F_48 ( L_13 ) ;
goto V_202;
}
V_160 = F_125 ( V_3 , V_160 ) ? : 1 ;
V_84 -> V_160 = F_15 ( T_1 , V_160 , V_84 -> V_203 ) ;
V_84 -> V_204 = F_125 ( V_3 , V_204 ) ? : 0xFFFF ;
V_84 -> V_205 = F_125 ( V_3 , V_205 ) + 1 + 0x4000 ;
V_84 -> V_206 = V_190 ;
V_84 -> V_207 = 0 ;
V_84 -> V_208 = V_136 ;
V_84 -> V_209 = V_65 ;
