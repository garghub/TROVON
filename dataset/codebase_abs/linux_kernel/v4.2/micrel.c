...
static int
F_24 ( struct V_1 * V_2 , int V_96 , int V_97 ,
int V_3 )
{
return - 1 ;
}
static void
F_25 ( struct V_1 * V_2 , int V_96 , int V_97 ,
int V_3 , T_1 V_4 )
{
}
...
{
const struct V_11 * type = V_2 -> V_12 -> V_13 ;
const struct V_43 * V_98 = V_2 -> V_30 . V_44 ;
struct V_35 * V_36 ;
struct V_99 * V_99 ;
int V_31 ;
V_36 = F_27 ( & V_2 -> V_30 , sizeof( * V_36 ) , V_100 ) ;
if ( ! V_36 )
return - V_101 ;
V_2 -> V_36 = V_36 ;
V_36 -> type = type ;
...
V_99 = F_28 ( & V_2 -> V_30 , L_19 ) ;
if ( ! F_29 ( V_99 ) ) {
unsigned long V_102 = F_30 ( V_99 ) ;
bool V_103 ;
V_36 -> V_39 = type -> V_104 ;
V_103 = F_31 ( V_98 ,
L_20 ) ;
if ( V_102 > 24500000 && V_102 < 25500000 ) {
V_36 -> V_40 = V_103 ;
} else if ( V_102 > 49500000 && V_102 < 50500000 ) {
V_36 -> V_40 = ! V_103 ;
} else {
F_9 ( & V_2 -> V_30 , L_21 , V_102 ) ;
return - V_28 ;
}
}
if ( V_2 -> V_105 & V_106 ) {
