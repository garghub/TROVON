...
static int F_56 ( struct V_145 * V_7 ,
enum V_146 V_52 )
{
...
if ( V_149 == NULL )
return 0 ;
V_152 = F_57 ( & V_7 -> V_8 , sizeof( * V_152 ) , V_156 ) ;
if ( ! V_152 )
return - V_157 ;
...
static int F_56 ( struct V_145 * V_7 , enum V_146 V_52 )
{
return 0 ;
}
static int F_63 ( struct V_145 * V_7 ,
...
if ( ! V_152 )
return - V_51 ;
V_2 = F_57 ( & V_7 -> V_8 , sizeof( * V_2 ) , V_156 ) ;
if ( V_2 == NULL ) {
F_3 ( & V_7 -> V_8 , L_27 ) ;
return - V_157 ;
}
...
V_2 -> V_7 = V_7 ;
V_2 -> V_52 = V_52 ;
V_2 -> V_176 = F_65 ( & V_7 -> V_8 , L_28 ) ;
V_2 -> V_177 = F_65 ( & V_7 -> V_8 , L_29 ) ;
if ( F_66 ( V_2 -> V_176 ) == - V_178 ||
F_66 ( V_2 -> V_177 ) == - V_178 )
return - V_178 ;
if ( F_67 ( V_2 -> V_176 ) &&
( V_2 -> V_52 != V_53 || F_67 ( V_2 -> V_177 ) ) ) {
F_3 ( & V_7 -> V_8 , L_30 ) ;
return - V_51 ;
}
V_2 -> V_6 = F_68 ( V_7 , & V_179 ) ;
if ( F_67 ( V_2 -> V_6 ) ) {
F_3 ( & V_7 -> V_8 , L_31 ) ;
return F_66 ( V_2 -> V_6 ) ;
}
...
V_171 . V_172 = V_172 ;
V_171 . V_173 = V_173 ;
V_60 = F_70 ( & V_7 -> V_8 , & V_2 -> V_189 [ 0 ] . V_28 ) ;
if ( F_67 ( V_60 ) ) {
F_3 ( & V_7 -> V_8 , L_37 , V_171 . V_159 ) ;
V_5 = F_66 ( V_60 ) ;
goto V_186;
...
V_60 = F_70 ( & V_7 -> V_8 , & V_2 -> V_189 [ 1 ] . V_28 ) ;
if ( F_67 ( V_60 ) ) {
F_3 ( & V_7 -> V_8 , L_37 , V_171 . V_159 ) ;
V_5 = F_66 ( V_60 ) ;
goto V_186;
...
V_172 [ 1 ] = V_190 [ 1 ] ;
V_2 -> V_195 = F_57 ( & V_7 -> V_8 , V_174 *
sizeof( * V_2 -> V_195 ) , V_156 ) ;
V_2 -> V_161 = F_57 ( & V_7 -> V_8 , V_174 *
sizeof( * V_2 -> V_161 ) , V_156 ) ;
V_2 -> V_196 . V_197 = V_174 ;
V_2 -> V_196 . V_198 = F_57 ( & V_7 -> V_8 ,
V_174 * sizeof( * V_2 -> V_196 . V_198 ) , V_156 ) ;
if ( F_71 ( ! V_2 -> V_195 || ! V_2 -> V_161 ||
! V_2 -> V_196 . V_198 ) ) {
V_5 = - V_157 ;
goto V_186;
}
...
V_171 . V_172 = V_172 ;
V_171 . V_173 = 2 ;
V_60 = F_70 ( & V_7 -> V_8 , & V_2 -> V_195 [ V_175 ] . V_28 ) ;
if ( F_67 ( V_60 ) ) {
F_3 ( & V_7 -> V_8 , L_37 ,
V_171 . V_159 ) ;
V_5 = F_66 ( V_60 ) ;
...
V_171 . V_172 = V_172 ;
V_171 . V_173 = V_173 ;
V_60 = F_70 ( & V_7 -> V_8 , & V_2 -> V_161 [ V_175 ] . V_28 ) ;
if ( F_67 ( V_60 ) ) {
F_3 ( & V_7 -> V_8 , L_37 ,
V_171 . V_159 ) ;
V_5 = F_66 ( V_60 ) ;
...
int V_5 ;
V_5 = F_72 ( V_60 , V_152 -> V_161 [ V_175 ] . V_35 ) ;
if ( V_5 != 0 ) {
F_3 ( & V_7 -> V_8 , L_38 ,
V_5 ) ;
}
