...
if ( ! V_7 )
return F_18 ( - V_37 ) ;
for ( V_21 = 0 ; V_21 < V_7 -> V_38 ; V_21 ++ ) {
if ( V_36 == V_7 -> V_39 [ V_21 ] . V_40 )
break;
}
if ( V_21 >= V_7 -> V_38 || args -> args [ 0 ] >= 2 )
return F_18 ( - V_41 ) ;
return V_7 -> V_39 [ V_21 ] . V_42 [ args -> args [ 0 ] ] . V_1 ;
}
...
V_48 = F_24 ( V_44 , V_49 , 0 ) ;
V_15 = F_25 ( V_33 , V_48 ) ;
if ( F_22 ( V_15 ) )
return F_23 ( V_15 ) ;
V_7 = F_26 ( V_33 , sizeof( * V_7 ) , V_50 ) ;
if ( ! V_7 )
return - V_51 ;
F_27 ( & V_7 -> V_14 ) ;
V_7 -> V_13 = V_13 ;
V_7 -> V_15 = V_15 ;
V_7 -> V_38 = F_28 ( V_33 -> V_40 ) ;
V_7 -> V_39 = F_29 ( V_33 , V_7 -> V_38 ,
sizeof( struct V_4 ) ,
V_50 ) ;
if ( ! V_7 -> V_39 )
return - V_51 ;
F_30 (dev->of_node, np) {
struct V_4 * V_5 = V_7 -> V_39 + V_21 ;
T_1 V_52 ;
int error , V_53 ;
V_5 -> V_40 = V_36 ;
V_5 -> V_7 = V_7 ;
V_5 -> V_10 = - 1 ;
error = F_31 ( V_36 , L_4 , & V_52 ) ;
if ( error || V_52 > 2 ) {
F_20 ( V_33 , L_5 ) ;
return error ;
}
