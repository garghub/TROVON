...
{
struct V_2 * V_3 = F_61 ( V_103 ) ;
struct V_106 * V_17 = F_67 ( V_103 , struct V_106 , V_102 ) ;
T_2 V_79 = F_68 ( V_103 -> V_105 ) ;
T_3 V_80 = F_69 ( V_103 -> V_105 ) ;
unsigned long V_61 ;
T_2 V_89 ;
T_3 V_107 ;
switch ( type ) {
...
{
struct V_2 * V_3 = F_61 ( V_103 ) ;
T_2 V_125 = F_71 ( V_103 -> V_105 ) ;
T_3 V_126 = F_72 ( V_103 -> V_105 ) ;
F_30 ( 1 << V_126 , V_3 -> V_66 + V_125 ) ;
}
static void F_73 ( struct V_102 * V_103 )
{
struct V_2 * V_3 = F_61 ( V_103 ) ;
T_2 V_79 = F_74 ( V_103 -> V_105 ) ;
T_3 V_127 = F_75 ( V_103 -> V_105 ) ;
unsigned long V_61 ;
T_2 V_38 ;
F_23 ( & V_3 -> V_65 , V_61 ) ;
V_38 = F_27 ( V_3 -> V_66 + V_79 ) ;
F_30 ( V_38 & ~ ( 1 << V_127 ) , V_3 -> V_66 + V_79 ) ;
F_26 ( & V_3 -> V_65 , V_61 ) ;
}
...
static void F_78 ( unsigned V_128 , struct V_106 * V_17 )
{
struct V_129 * V_77 = F_79 ( V_128 ) ;
struct V_2 * V_3 = F_80 ( V_128 ) ;
unsigned long V_130 , V_79 , V_38 ;
for ( V_130 = 0 ; V_130 < V_3 -> V_17 -> V_131 ; V_130 ++ )
if ( V_128 == V_3 -> V_128 [ V_130 ] )
break;
if ( V_130 == V_3 -> V_17 -> V_131 )
return;
V_79 = F_81 ( V_130 ) ;
V_38 = F_27 ( V_3 -> V_66 + V_79 ) ;
if ( V_38 ) {
int V_132 ;
F_82 ( V_77 , V_17 ) ;
F_83 (irqoffset, &val, IRQ_PER_BANK) {
int V_133 = F_59 ( V_3 -> V_101 ,
V_130 * V_99 + V_132 ) ;
F_84 ( V_133 ) ;
}
F_85 ( V_77 , V_17 ) ;
...
{
struct V_2 * V_3 = F_88 ( V_136 ) ;
int V_5 ;
V_3 -> V_6 = V_3 -> V_17 -> V_18 ;
V_3 -> V_8 = F_89 ( & V_136 -> V_39 ,
...
int F_91 ( struct V_135 * V_136 ,
const struct V_139 * V_17 )
{
struct V_27 * V_28 = V_136 -> V_39 . V_140 ;
struct V_141 * V_142 ;
struct V_143 * V_21 ;
struct V_2 * V_3 ;
struct V_144 * V_145 ;
int V_5 , V_36 , V_146 ;
struct V_147 * V_147 ;
V_3 = F_89 ( & V_136 -> V_39 , sizeof( * V_3 ) , V_41 ) ;
if ( ! V_3 )
return - V_42 ;
F_92 ( V_136 , V_3 ) ;
F_93 ( & V_3 -> V_65 ) ;
V_145 = F_94 ( V_136 , V_148 , 0 ) ;
V_3 -> V_66 = F_95 ( & V_136 -> V_39 , V_145 ) ;
if ( F_96 ( V_3 -> V_66 ) )
return F_97 ( V_3 -> V_66 ) ;
V_3 -> V_39 = & V_136 -> V_39 ;
V_3 -> V_17 = V_17 ;
V_3 -> V_104 = F_98 ( & V_136 -> V_39 ,
V_99 * V_3 -> V_17 -> V_131 ,
sizeof( * V_3 -> V_104 ) ,
V_41 ) ;
if ( ! V_3 -> V_104 )
...
V_36 = F_87 ( V_136 ) ;
if ( V_36 ) {
F_11 ( & V_136 -> V_39 , L_14 , V_36 ) ;
return V_36 ;
}
V_21 = F_89 ( & V_136 -> V_39 ,
...
V_142 = F_89 ( & V_136 -> V_39 ,
sizeof( * V_142 ) ,
V_41 ) ;
if ( ! V_142 )
return - V_42 ;
V_142 -> V_9 = F_99 ( & V_136 -> V_39 ) ;
V_142 -> V_149 = V_150 ;
V_142 -> V_21 = V_21 ;
V_142 -> V_18 = V_3 -> V_17 -> V_18 ;
V_142 -> V_151 = & V_152 ;
V_142 -> V_153 = & V_154 ;
V_142 -> V_155 = & V_156 ;
V_3 -> V_84 = F_100 ( V_142 ,
& V_136 -> V_39 , V_3 ) ;
if ( F_96 ( V_3 -> V_84 ) ) {
F_11 ( & V_136 -> V_39 , L_15 ) ;
return F_97 ( V_3 -> V_84 ) ;
}
V_3 -> V_77 = F_89 ( & V_136 -> V_39 , sizeof( * V_3 -> V_77 ) , V_41 ) ;
if ( ! V_3 -> V_77 ) {
V_36 = - V_42 ;
goto V_157;
}
V_146 = V_3 -> V_17 -> V_21 [ V_3 -> V_17 -> V_18 - 1 ] . V_20 . V_23 ;
V_3 -> V_77 -> V_149 = V_150 ;
V_3 -> V_77 -> V_158 = F_41 ,
V_3 -> V_77 -> free = F_43 ,
V_3 -> V_77 -> V_159 = F_45 ,
V_3 -> V_77 -> V_160 = F_54 ,
...
V_3 -> V_77 -> V_164 = F_57 ,
V_3 -> V_77 -> V_165 = 3 ,
V_3 -> V_77 -> V_166 = false ,
V_3 -> V_77 -> V_94 = F_101 ( V_146 , V_93 ) -
V_3 -> V_17 -> V_62 ;
V_3 -> V_77 -> V_100 = F_99 ( & V_136 -> V_39 ) ;
V_3 -> V_77 -> V_39 = & V_136 -> V_39 ;
...
for ( V_5 = 0 ; V_5 < V_3 -> V_17 -> V_18 ; V_5 ++ ) {
const struct V_19 * V_20 = V_3 -> V_17 -> V_21 + V_5 ;
V_36 = F_103 ( V_3 -> V_77 , F_99 ( & V_136 -> V_39 ) ,
V_20 -> V_20 . V_23 - V_3 -> V_17 -> V_62 ,
V_20 -> V_20 . V_23 , 1 ) ;
if ( V_36 )
goto V_167;
}
V_147 = F_104 ( & V_136 -> V_39 , NULL ) ;
if ( F_96 ( V_147 ) ) {
V_36 = F_97 ( V_147 ) ;
goto V_167;
}
...
for ( V_5 = 0 ; V_5 < V_3 -> V_17 -> V_131 ; V_5 ++ ) {
V_3 -> V_128 [ V_5 ] = F_106 ( V_136 , V_5 ) ;
if ( V_3 -> V_128 [ V_5 ] < 0 ) {
V_36 = V_3 -> V_128 [ V_5 ] ;
goto V_168;
}
}
V_3 -> V_101 = F_107 ( V_28 ,
V_3 -> V_17 -> V_131 * V_99 ,
& V_169 ,
NULL ) ;
if ( ! V_3 -> V_101 ) {
F_11 ( & V_136 -> V_39 , L_16 ) ;
V_36 = - V_42 ;
goto V_168;
}
for ( V_5 = 0 ; V_5 < ( V_3 -> V_17 -> V_131 * V_99 ) ; V_5 ++ ) {
int V_170 = F_108 ( V_3 -> V_101 , V_5 ) ;
F_109 ( V_170 , & V_122 ,
V_123 ) ;
F_110 ( V_170 , V_3 ) ;
} ;
for ( V_5 = 0 ; V_5 < V_3 -> V_17 -> V_131 ; V_5 ++ ) {
F_30 ( 0 , V_3 -> V_66 + F_111 ( V_5 ) ) ;
F_30 ( 0xffffffff ,
V_3 -> V_66 + F_81 ( V_5 ) ) ;
F_112 ( V_3 -> V_128 [ V_5 ] ,
F_78 ,
