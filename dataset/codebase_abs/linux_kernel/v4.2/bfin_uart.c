...
F_55 ( V_4 -> V_89 ) ;
F_56 ( & V_4 -> V_90 , V_88 ) ;
V_4 -> V_91 = F_57 ( V_4 -> V_89 ) ;
V_86 = F_58 ( V_4 -> V_89 ) ;
V_4 -> V_91 = V_92 - V_4 -> V_91 ;
if ( V_4 -> V_91 == V_92 || V_86 == 0 )
V_4 -> V_91 = 0 ;
V_86 = V_93 - V_86 ;
if ( V_86 == V_93 )
V_86 = 0 ;
V_87 = V_4 -> V_91 * V_93 + V_86 ;
if ( V_87 > V_4 -> V_84 . V_23 ||
V_4 -> V_91 < ( V_4 -> V_84 . V_23 / V_93 ) ) {
V_4 -> V_84 . V_72 = V_87 ;
F_53 ( V_4 ) ;
...
static void F_67 ( struct V_1 * V_2 , int V_101 )
{
struct V_3 * V_4 = (struct V_3 * ) V_2 ;
T_3 V_102 = F_68 ( V_4 ) ;
if ( V_101 )
...
F_74 ( V_4 -> V_89 , F_65 , V_4 ) ;
F_74 ( V_4 -> V_22 , F_62 , V_4 ) ;
V_4 -> V_84 . V_73 = ( unsigned char * ) F_75 ( NULL , V_107 , & V_104 , V_108 ) ;
V_4 -> V_84 . V_72 = 0 ;
V_4 -> V_84 . V_23 = 0 ;
V_4 -> V_91 = 0 ;
F_46 ( V_4 -> V_89 ,
...
F_76 ( V_4 -> V_89 , V_92 ) ;
F_77 ( V_4 -> V_89 , 1 ) ;
F_48 ( V_4 -> V_89 , ( unsigned long ) V_4 -> V_84 . V_73 ) ;
F_52 ( V_4 -> V_89 ) ;
...
#ifdef F_7
if ( V_4 -> V_5 >= 0 ) {
if ( F_79 ( V_4 -> V_129 , F_6 ,
0 , L_11 , V_4 ) ) {
V_4 -> V_5 = - 1 ;
F_86 ( V_2 -> V_130 , L_12 ) ;
}
F_87 ( V_4 , F_88 ( V_4 ) | V_131 ) ;
F_22 ( V_4 , V_132 ) ;
}
#endif
F_22 ( V_4 , V_38 ) ;
...
F_73 ( V_4 -> V_89 ) ;
F_90 ( & ( V_4 -> V_94 ) ) ;
F_91 ( NULL , V_107 , V_4 -> V_84 . V_73 , 0 ) ;
#else
#ifdef V_29
switch ( V_4 -> V_2 . V_12 ) {
case V_120 :
...
static void
F_93 ( struct V_1 * V_2 , struct V_133 * V_35 ,
struct V_133 * V_134 )
{
struct V_3 * V_4 = (struct V_3 * ) V_2 ;
unsigned long V_88 ;
...
V_135 = F_95 ( V_2 , V_35 , V_134 , 0 , V_2 -> V_165 / 16 ) ;
V_136 = F_96 ( V_2 , V_135 ) ;
if ( V_35 -> V_36 != V_37 )
V_136 -= V_166 ;
F_97 ( V_4 , V_54 / V_135 * 15 ) ;
V_138 = V_95 + F_98 ( 10 ) ;
while ( F_99 ( V_4 ) & V_167 && ! ( F_13 ( V_4 ) & V_21 ) )
if ( F_100 ( V_95 , V_138 ) ) {
F_101 ( V_2 -> V_130 , L_16 ) ;
break;
}
V_137 = F_102 ( V_4 ) ;
F_103 ( V_4 , F_99 ( V_4 ) & ~ V_167 ) ;
F_104 ( V_4 ) ;
F_105 ( V_4 ) ;
F_106 ( V_4 , V_136 ) ;
F_51 () ;
F_107 ( V_4 ) ;
F_69 ( V_4 , ( F_68 ( V_4 ) & ~ V_168 ) | V_102 ) ;
F_108 ( V_4 , V_137 ) ;
F_103 ( V_4 , F_99 ( V_4 ) | V_167 ) ;
F_109 ( V_2 , V_35 -> V_139 , V_135 ) ;
F_59 ( & V_4 -> V_2 . V_76 , V_88 ) ;
}
...
static void F_113 ( struct V_1 * V_2 , int V_88 )
{
struct V_3 * V_4 = (struct V_3 * ) V_2 ;
if ( V_88 & V_170 &&
F_112 ( & V_4 -> V_2 ) == 0 )
...
static int
F_114 ( struct V_1 * V_2 , struct V_171 * V_172 )
{
return 0 ;
}
...
static void F_116 ( struct V_1 * V_2 , unsigned char V_177 )
{
struct V_3 * V_4 = (struct V_3 * ) V_2 ;
while ( ! ( F_13 ( V_4 ) & V_71 ) )
F_14 () ;
...
static void T_5
F_118 ( struct V_3 * V_4 , int * V_135 ,
int * V_61 , int * V_178 )
{
unsigned int V_15 ;
...
* V_178 = ( ( V_102 & V_180 ) >> V_181 ) + 5 ;
F_105 ( V_4 ) ;
V_179 = F_119 ( V_4 ) ;
F_107 ( V_4 ) ;
* V_135 = F_120 () / ( 16 * V_179 ) ;
}
F_121 ( L_18 , V_147 , * V_135 , * V_61 , * V_178 ) ;
}
...
static void
F_124 ( struct V_182 * V_183 , const char * V_184 , unsigned int V_185 )
{
struct V_3 * V_4 = V_186 [ V_183 -> V_187 ] ;
unsigned long V_88 ;
F_56 ( & V_4 -> V_2 . V_76 , V_88 ) ;
F_125 ( & V_4 -> V_2 , V_184 , V_185 , F_122 ) ;
F_59 ( & V_4 -> V_2 . V_76 , V_88 ) ;
}
static int T_5
F_126 ( struct V_182 * V_183 , char * V_188 )
{
struct V_3 * V_4 ;
int V_135 = 57600 ;
int V_178 = 8 ;
...
return - V_191 ;
if ( V_188 )
F_127 ( V_188 , & V_135 , & V_61 , & V_178 , & V_189 ) ;
else
F_118 ( V_4 , & V_135 , & V_61 , & V_178 ) ;
return F_128 ( & V_4 -> V_2 , V_183 , V_135 , V_61 , V_178 , V_189 ) ;
}
static void
F_129 ( struct V_182 * V_183 , const char * V_184 , unsigned int V_185 )
{
unsigned long V_88 ;
if ( V_192 . V_2 . line != V_183 -> V_187 )
return;
F_56 ( & V_192 . V_2 . V_76 , V_88 ) ;
F_125 ( & V_192 . V_2 , V_184 , V_185 ,
F_122 ) ;
F_59 ( & V_192 . V_2 . V_76 , V_88 ) ;
}
static int F_130 ( struct V_193 * V_194 , T_6 V_20 )
{
struct V_3 * V_4 = F_131 ( V_194 ) ;
return F_132 ( & V_195 , & V_4 -> V_2 ) ;
}
static int F_133 ( struct V_193 * V_194 )
{
struct V_3 * V_4 = F_131 ( V_194 ) ;
return F_134 ( & V_195 , & V_4 -> V_2 ) ;
}
static int F_135 ( struct V_193 * V_194 )
{
struct V_196 * V_197 ;
struct V_3 * V_4 = NULL ;
int V_198 = 0 ;
if ( V_194 -> V_199 < 0 || V_194 -> V_199 >= V_190 ) {
F_136 ( & V_194 -> V_130 , L_19 ) ;
return - V_200 ;
}
if ( V_186 [ V_194 -> V_199 ] == NULL ) {
V_4 = F_137 ( sizeof( * V_4 ) , V_201 ) ;
if ( ! V_4 ) {
F_136 ( & V_194 -> V_130 ,
L_20 ) ;
return - V_202 ;
...
V_4 -> V_2 . V_209 = V_210 ;
V_4 -> V_2 . V_88 = V_211 ;
V_197 = F_142 ( V_194 , V_212 , 0 ) ;
if ( V_197 == NULL ) {
F_136 ( & V_194 -> V_130 , L_22 ) ;
V_198 = - V_200 ;
goto V_213;
}
V_4 -> V_2 . V_203 = F_143 ( V_197 -> V_214 , F_144 ( V_197 ) ) ;
if ( ! V_4 -> V_2 . V_203 ) {
F_136 ( & V_194 -> V_130 , L_23 ) ;
V_198 = - V_215 ;
goto V_213;
}
V_4 -> V_2 . V_216 = V_197 -> V_214 ;
V_4 -> V_117 = F_145 ( V_194 , 0 ) ;
if ( V_4 -> V_117 < 0 ) {
F_136 ( & V_194 -> V_130 , L_24 ) ;
V_198 = - V_200 ;
goto V_217;
}
V_4 -> V_116 = F_145 ( V_194 , 1 ) ;
if ( V_4 -> V_116 < 0 ) {
F_136 ( & V_194 -> V_130 , L_25 ) ;
V_198 = - V_200 ;
goto V_217;
}
V_4 -> V_2 . V_12 = V_4 -> V_116 ;
V_4 -> V_129 = F_145 ( V_194 , 2 ) ;
if ( V_4 -> V_129 < 0 ) {
F_136 ( & V_194 -> V_130 , L_26 ) ;
V_198 = - V_200 ;
goto V_217;
}
#ifdef F_12
...
V_4 -> V_28 = 1 ;
V_4 -> V_24 = 0 ;
V_197 = F_142 ( V_194 , V_218 , 0 ) ;
if ( V_197 == NULL ) {
F_136 ( & V_194 -> V_130 , L_27 ) ;
V_198 = - V_200 ;
goto V_217;
}
V_4 -> V_22 = V_197 -> V_214 ;
V_197 = F_142 ( V_194 , V_218 , 1 ) ;
if ( V_197 == NULL ) {
F_136 ( & V_194 -> V_130 , L_28 ) ;
V_198 = - V_200 ;
goto V_217;
}
V_4 -> V_89 = V_197 -> V_214 ;
F_146 ( & ( V_4 -> V_94 ) ) ;
#endif
#if F_16 ( F_81 ) || \
F_16 ( F_7 )
...
int V_198 ;
if ( V_194 -> V_199 < 0 || V_194 -> V_199 >= V_190 ) {
F_136 ( & V_194 -> V_130 , L_29 ) ;
return - V_200 ;
}
V_198 = F_139 ( F_140 ( & V_194 -> V_130 ) ,
V_128 ) ;
if ( V_198 ) {
F_136 ( & V_194 -> V_130 ,
L_21 ) ;
...
V_192 . V_2 . V_203 = F_143 ( V_197 -> V_214 ,
F_144 ( V_197 ) ) ;
if ( ! V_192 . V_2 . V_203 ) {
F_136 ( & V_194 -> V_130 , L_23 ) ;
V_198 = - V_215 ;
...
V_192 . V_2 . line = V_194 -> V_199 ;
V_192 . V_2 . V_165 = F_120 () ;
V_192 . V_2 . V_205 = V_206 ;
F_141 ( & V_192 . V_2 . V_76 ) ;
return 0 ;
V_213:
F_152 ( F_140 ( & V_194 -> V_130 ) ) ;
return V_198 ;
...
if ( V_2 < 0 || V_2 >= V_190 )
return NULL ;
snprintf ( V_225 , 20 , V_128 L_30 , V_2 ) ;
F_157 ( & V_226 ,
V_225 ) ;
F_158 ( V_227 , 1 , 0 ) ;
if ( ! V_192 . V_2 . V_203 )
