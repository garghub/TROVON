...
if ( V_8 == NULL )
goto V_69;
V_17 = F_22 ( V_8 , V_76 -> V_18 ) ;
if ( V_17 == NULL || V_17 -> V_32 ) {
F_51 ( V_8 -> V_2 , V_76 -> V_18 ,
V_56 , V_47 ) ;
goto V_78;
}
F_5 ( & V_17 -> V_28 , V_9 ) ;
...
void F_72 ( struct V_1 * V_2 , int V_18 )
{
struct V_17 * V_17 ;
struct V_7 * V_8 ;
T_1 V_3 ;
...
int F_73 ( struct V_1 * V_2 , int V_91 )
{
struct V_7 * V_8 ;
struct V_12 * V_13 ;
unsigned long V_9 ;
...
goto V_96;
F_75 ( V_8 -> V_15 ) ;
V_27 = F_76 ( V_8 -> V_15 , V_91 ) ;
if ( V_27 )
goto V_97;
V_13 = F_9 ( & V_2 -> V_14 ) ;
if ( ! V_13 )
goto V_97;
V_27 = F_77 ( V_8 -> V_15 , V_13 ) ;
if ( V_27 != 0 )
goto V_98;
F_12 ( V_13 ) ;
F_5 ( & V_10 , V_9 ) ;
