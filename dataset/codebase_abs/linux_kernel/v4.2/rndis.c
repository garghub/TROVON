...
{
T_3 * V_6 ;
struct V_152 * V_153 , * V_122 ;
F_48 (act, tmp, &(params->resp_queue))
{
V_6 = F_49 ( V_153 , T_3 , V_154 ) ;
if ( V_6 && V_6 -> V_4 == V_4 ) {
F_50 ( & V_6 -> V_154 ) ;
F_39 ( V_6 ) ;
}
...
{
T_3 * V_6 ;
V_6 = F_51 ( sizeof( T_3 ) + V_9 , V_156 ) ;
if ( ! V_6 ) return NULL ;
V_6 -> V_4 = ( T_2 * ) ( V_6 + 1 ) ;
V_6 -> V_9 = V_9 ;
V_6 -> V_155 = 0 ;
F_52 ( & V_6 -> V_154 , & ( V_2 -> V_143 ) ) ;
return V_6 ;
}
int F_53 ( struct V_157 * V_158 ,
struct V_145 * V_146 ,
struct V_159 * V_154 )
{
T_4 * V_122 = ( void * ) V_146 -> V_160 ;
if ( F_4 ( V_148 )
!= F_54 ( V_122 ++ ) ) {
F_55 ( V_146 ) ;
return - V_133 ;
...
V_122 ++ ;
if ( ! F_56 ( V_146 , F_3 ( V_122 ++ ) + 8 ) ) {
F_55 ( V_146 ) ;
return - V_161 ;
}
F_57 ( V_146 , F_3 ( V_122 ++ ) ) ;
F_58 ( V_154 , V_146 ) ;
return 0 ;
}
static int F_59 ( struct V_162 * V_163 , void * V_102 )
{
...
static T_16 F_61 ( struct V_166 * V_166 , const char T_17 * V_167 ,
T_18 V_12 , T_19 * V_168 )
{
V_1 * V_169 = F_62 ( F_63 ( V_166 ) ) ;
T_1 V_35 = 0 ;
int V_11 , V_170 = 0 ;
for ( V_11 = 0 ; V_11 < V_12 ; V_11 ++ ) {
char V_171 ;
...
static int F_65 ( struct V_173 * V_173 , struct V_166 * V_166 )
{
return F_66 ( V_166 , F_59 , F_62 ( V_173 ) ) ;
}
