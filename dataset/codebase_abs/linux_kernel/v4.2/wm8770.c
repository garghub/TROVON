...
struct V_41 * V_42 ;
int V_58 , V_43 ;
V_42 = F_26 ( & V_78 -> V_2 , sizeof( struct V_41 ) ,
V_79 ) ;
if ( ! V_42 )
return - V_80 ;
for ( V_43 = 0 ; V_43 < F_13 ( V_42 -> V_63 ) ; V_43 ++ )
V_42 -> V_63 [ V_43 ] . V_81 = V_82 [ V_43 ] ;
V_58 = F_27 ( & V_78 -> V_2 , F_13 ( V_42 -> V_63 ) ,
V_42 -> V_63 ) ;
if ( V_58 ) {
F_15 ( & V_78 -> V_2 , L_5 , V_58 ) ;
return V_58 ;
}
V_42 -> V_83 [ 0 ] . V_84 = V_85 ;
V_42 -> V_83 [ 1 ] . V_84 = V_86 ;
V_42 -> V_83 [ 2 ] . V_84 = V_87 ;
for ( V_43 = 0 ; V_43 < F_13 ( V_42 -> V_63 ) ; V_43 ++ ) {
V_58 = F_28 ( V_42 -> V_63 [ V_43 ] . V_88 ,
& V_42 -> V_83 [ V_43 ] ) ;
if ( V_58 ) {
F_15 ( & V_78 -> V_2 ,
L_6 ,
...
V_42 -> V_64 = F_29 ( V_78 , & V_89 ) ;
if ( F_30 ( V_42 -> V_64 ) )
return F_31 ( V_42 -> V_64 ) ;
F_32 ( V_78 , V_42 ) ;
V_58 = F_33 ( & V_78 -> V_2 ,
& V_90 , & V_91 , 1 ) ;
return V_58 ;
...
{
struct V_41 * V_42 = F_35 ( V_78 ) ;
int V_43 ;
for ( V_43 = 0 ; V_43 < F_13 ( V_42 -> V_63 ) ; ++ V_43 )
F_36 ( V_42 -> V_63 [ V_43 ] . V_88 ,
& V_42 -> V_83 [ V_43 ] ) ;
F_37 ( & V_78 -> V_2 ) ;
return 0 ;
}
