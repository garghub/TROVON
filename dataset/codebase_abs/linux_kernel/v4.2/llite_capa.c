...
struct V_1 * F_53 ( struct V_26 * V_26 , T_1 V_54 )
{
...
struct V_1 * V_2 ;
F_21 ( V_26 != NULL ) ;
if ( ( F_54 ( V_26 ) -> V_56 & V_65 ) == 0 )
return NULL ;
F_13 ( & V_12 ) ;
V_2 = F_40 ( V_23 -> V_28 ) ;
F_17 ( & V_12 ) ;
if ( ! V_2 && F_25 ( & V_62 ) ) {
F_48 ( L_14 V_63 L_15 , F_60 ( & V_23 -> V_64 ) ) ;
F_61 ( & V_62 , 0 ) ;
}
return V_2 ;
}
...
{
struct V_22 * V_23 = F_24 ( V_26 ) ;
struct V_1 * V_66 = V_23 -> V_28 ;
struct V_67 * V_68 = & V_2 -> V_7 ;
if ( ! V_66 ) {
...
F_68 ( & V_2 -> V_24 . V_25 . V_29 , V_14 ? : & V_23 -> V_70 ) ;
}
...
static inline void F_75 ( struct V_1 * V_21 , unsigned long V_72 )
{
V_21 -> V_9 = F_76 ( V_21 -> V_9 , F_8 ( V_72 ) ) ;
}
static int V_47 ( struct V_1 * V_2 , struct V_67 * V_68 )
{
...
F_13 ( & V_2 -> V_69 ) ;
F_21 ( ! memcmp ( & V_2 -> V_7 , V_68 ,
F_78 ( struct V_67 , V_40 ) ) ) ;
V_2 -> V_7 = * V_68 ;
F_74 ( V_2 ) ;
F_17 ( & V_2 -> V_69 ) ;
F_13 ( & V_12 ) ;
...
void F_86 ( struct V_78 * V_79 )
{
if ( V_79 -> V_56 & ( V_65 | V_57 ) )
F_87 ( L_26
L_27
L_28
L_29 ,
