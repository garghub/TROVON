...
if ( F_82 ( ! V_2 ) )
return;
if ( ! error && ! F_92 ( V_161 , V_162 ) )
error = V_118 ;
F_23 ( V_2 , V_161 -> V_163 . V_164 , V_161 -> V_163 . V_165 ,
V_161 -> V_166 , V_52 , error , 0 , NULL ) ;
}
...
struct V_1 * V_2 = V_75 -> V_1 ;
if ( V_2 )
F_23 ( V_2 , 0 , 0 , V_58 , V_171 , 0 , 0 , NULL ) ;
}
}
static void F_99 ( void * V_155 ,
struct V_74 * V_75 ,
struct V_161 * V_161 , int V_58 )
{
if ( V_161 )
F_91 ( V_75 , V_161 , V_172 , 0 ) ;
else {
struct V_1 * V_2 = V_75 -> V_1 ;
if ( V_2 )
F_23 ( V_2 , 0 , 0 , V_58 , V_172 ,
0 , 0 , NULL ) ;
}
}
...
struct V_1 * V_2 = V_75 -> V_1 ;
if ( V_2 )
F_23 ( V_2 , 0 , 0 , 0 , V_173 , 0 , 0 , NULL ) ;
}
static void F_101 ( void * V_155 , struct V_74 * V_75 ,
unsigned int V_174 , bool V_175 )
{
struct V_1 * V_2 = V_75 -> V_1 ;
if ( V_2 ) {
T_11 V_176 = F_102 ( V_174 ) ;
T_3 V_52 ;
if ( V_175 )
V_52 = V_177 ;
else
V_52 = V_178 ;
F_23 ( V_2 , 0 , 0 , 0 , V_52 , 0 , sizeof( V_176 ) , & V_176 ) ;
}
}
...
struct V_1 * V_2 = V_75 -> V_1 ;
if ( V_2 ) {
T_11 V_176 = F_102 ( V_179 ) ;
F_23 ( V_2 , V_161 -> V_163 . V_164 ,
V_161 -> V_163 . V_165 , V_161 -> V_166 , V_180 ,
! F_92 ( V_161 , V_162 ) ,
sizeof( V_176 ) , & V_176 ) ;
}
}
...
if ( F_82 ( ! V_2 ) )
return;
V_183 . V_184 = F_105 ( V_26 ) ;
V_183 . V_185 = F_105 ( V_161 -> V_186 -> V_137 ) ;
V_183 . V_187 = F_102 ( V_181 ) ;
F_23 ( V_2 , V_161 -> V_163 . V_164 , V_161 -> V_163 . V_165 ,
V_161 -> V_166 , V_188 ,
! F_92 ( V_161 , V_162 ) , sizeof( V_183 ) , & V_183 ) ;
}
...
return;
V_183 . V_184 = F_105 ( V_26 ) ;
V_183 . V_185 = F_105 ( F_107 ( V_146 -> V_189 ) ) ;
V_183 . V_187 = F_102 ( V_181 ) ;
F_23 ( V_2 , F_84 ( V_146 ) , F_86 ( V_146 ) ,
F_108 ( V_146 ) , V_188 , ! ! V_146 -> V_152 ,
sizeof( V_183 ) , & V_183 ) ;
}
void F_109 ( struct V_74 * V_75 ,
struct V_145 * V_146 ,
void * V_5 , T_2 V_6 )
{
struct V_1 * V_2 = V_75 -> V_1 ;
...
F_111 ( V_109 ) ;
V_109 = F_124 ( F_101 , NULL ) ;
F_111 ( V_109 ) ;
V_109 = F_125 ( F_103 , NULL ) ;
F_111 ( V_109 ) ;
V_109 = F_126 ( F_104 , NULL ) ;
F_111 ( V_109 ) ;
V_109 = F_127 ( F_106 , NULL ) ;
F_111 ( V_109 ) ;
}
...
static void F_146 ( char * V_191 , const struct V_7 * V_8 )
{
int V_192 = 0 ;
...
static inline
const struct V_7 * F_147 ( const struct V_202 * V_203 )
{
return ( const struct V_7 * ) V_203 ;
}
static inline const void * F_148 ( const struct V_202 * V_203 )
{
return F_147 ( V_203 ) + 1 ;
}
static inline T_3 F_149 ( const struct V_202 * V_203 )
{
return F_147 ( V_203 ) -> V_4 ;
}
static inline T_3 F_150 ( const struct V_202 * V_203 )
{
return F_147 ( V_203 ) -> V_57 ;
}
static inline T_3 F_151 ( const struct V_202 * V_203 )
{
return F_147 ( V_203 ) -> V_57 >> 9 ;
}
static inline unsigned long long F_152 ( const struct V_202 * V_203 )
{
return F_147 ( V_203 ) -> V_53 ;
}
static inline T_12 F_153 ( const struct V_202 * V_203 )
{
return F_147 ( V_203 ) -> error ;
}
static T_13 F_154 ( const struct V_202 * V_203 )
{
const T_13 * V_204 = F_148 ( V_203 ) ;
return F_155 ( * V_204 ) ;
}
static void F_156 ( const struct V_202 * V_203 ,
struct V_182 * V_183 )
{
const struct V_182 * V_205 = F_148 ( V_203 ) ;
T_13 V_187 = V_205 -> V_187 ;
V_183 -> V_184 = F_157 ( V_205 -> V_184 ) ;
V_183 -> V_185 = F_157 ( V_205 -> V_185 ) ;
V_183 -> V_187 = F_155 ( V_187 ) ;
}
static void F_158 ( struct V_206 * V_207 , const char * V_208 )
{
char V_191 [ V_209 ] ;
unsigned long long V_210 = V_207 -> V_210 ;
unsigned long V_211 = F_159 ( V_210 , V_212 ) ;
unsigned V_213 = ( unsigned long ) V_210 ;
const struct V_7 * V_8 = F_147 ( V_207 -> V_203 ) ;
F_146 ( V_191 , V_8 ) ;
F_160 ( & V_207 -> V_214 ,
L_7 ,
F_161 ( V_8 -> V_25 ) , F_162 ( V_8 -> V_25 ) , V_207 -> V_14 ,
V_213 , V_211 , V_207 -> V_203 -> V_3 , V_208 , V_191 ) ;
}
static void F_163 ( struct V_206 * V_207 , const char * V_208 )
{
char V_191 [ V_209 ] ;
const struct V_7 * V_8 = F_147 ( V_207 -> V_203 ) ;
F_146 ( V_191 , V_8 ) ;
F_160 ( & V_207 -> V_214 , L_8 ,
F_161 ( V_8 -> V_25 ) , F_162 ( V_8 -> V_25 ) , V_208 , V_191 ) ;
}
static void F_164 ( struct V_215 * V_216 , const struct V_202 * V_203 )
{
const unsigned char * V_217 ;
int V_27 ;
int V_192 , V_218 ;
V_217 = F_148 ( V_203 ) ;
V_27 = F_147 ( V_203 ) -> V_27 ;
if ( ! V_27 )
return;
...
static void F_167 ( struct V_215 * V_216 , const struct V_202 * V_203 )
{
char V_131 [ V_219 ] ;
F_168 ( V_203 -> V_3 , V_131 ) ;
if ( F_149 ( V_203 ) & F_83 ( V_150 ) ) {
F_160 ( V_216 , L_14 , F_150 ( V_203 ) ) ;
F_164 ( V_216 , V_203 ) ;
F_160 ( V_216 , L_15 , V_131 ) ;
} else {
if ( F_151 ( V_203 ) )
F_160 ( V_216 , L_16 ,
F_152 ( V_203 ) , F_151 ( V_203 ) , V_131 ) ;
else
F_160 ( V_216 , L_15 , V_131 ) ;
}
}
static void F_169 ( struct V_215 * V_216 ,
const struct V_202 * V_203 )
{
if ( F_149 ( V_203 ) & F_83 ( V_150 ) ) {
F_164 ( V_216 , V_203 ) ;
F_160 ( V_216 , L_17 , F_153 ( V_203 ) ) ;
} else {
if ( F_151 ( V_203 ) )
F_160 ( V_216 , L_18 ,
F_152 ( V_203 ) ,
F_151 ( V_203 ) , F_153 ( V_203 ) ) ;
else
F_160 ( V_216 , L_19 ,
F_152 ( V_203 ) , F_153 ( V_203 ) ) ;
}
}
...
F_156 ( V_203 , & V_183 ) ;
F_160 ( V_216 , L_20 ,
F_152 ( V_203 ) , F_151 ( V_203 ) ,
F_161 ( V_183 . V_184 ) , F_162 ( V_183 . V_184 ) ,
...
char V_131 [ V_219 ] ;
F_168 ( V_203 -> V_3 , V_131 ) ;
F_160 ( V_216 , L_21 , V_131 , F_154 ( V_203 ) ) ;
}
static void F_173 ( struct V_215 * V_216 , const struct V_202 * V_203 )
{
char V_131 [ V_219 ] ;
F_168 ( V_203 -> V_3 , V_131 ) ;
F_160 ( V_216 , L_22 , F_152 ( V_203 ) ,
F_154 ( V_203 ) , V_131 ) ;
}
static void F_174 ( struct V_215 * V_216 , const struct V_202 * V_203 )
{
const struct V_7 * V_8 = F_147 ( V_203 ) ;
F_175 ( V_216 , V_8 + 1 , V_8 -> V_27 ) ;
F_165 ( V_216 , '\n' ) ;
}
static void F_176 ( struct V_220 * V_221 )
{
...
static void F_178 ( struct V_224 * V_225 )
{
V_16 = true ;
}
static int F_179 ( struct V_224 * V_225 )
{
V_17 = V_225 ;
F_178 ( V_225 ) ;
return 0 ;
...
static enum V_226 F_182 ( struct V_206 * V_207 ,
bool V_227 )
{
...
bool V_228 ;
T_14 * V_229 ;
V_8 = F_147 ( V_207 -> V_203 ) ;
V_52 = V_8 -> V_4 & ( ( 1 << V_54 ) - 1 ) ;
V_228 = ! ! ( V_230 & V_231 ) ;
V_229 = V_227 ? & F_158 : & F_163 ;
if ( V_8 -> V_4 == V_51 ) {
V_229 ( V_207 , V_228 ? L_25 : L_26 ) ;
F_174 ( V_216 , V_207 -> V_203 ) ;
}
if ( F_19 ( V_52 == 0 || V_52 >= F_68 ( V_232 ) ) )
F_160 ( V_216 , L_27 , V_52 ) ;
else {
V_229 ( V_207 , V_232 [ V_52 ] . V_208 [ V_228 ] ) ;
V_232 [ V_52 ] . F_183 ( V_216 , V_207 -> V_203 ) ;
}
return F_184 ( V_216 ) ;
}
static enum V_226 F_185 ( struct V_206 * V_207 ,
int V_30 , struct V_233 * V_10 )
{
return F_182 ( V_207 , false ) ;
}
static void F_186 ( struct V_206 * V_207 )
{
struct V_215 * V_216 = & V_207 -> V_214 ;
struct V_7 * V_8 = (struct V_7 * ) V_207 -> V_203 ;
const int V_234 = F_187 ( struct V_7 , V_53 ) ;
struct V_7 V_235 = {
. V_22 = V_23 | V_24 ,
. time = V_207 -> V_210 ,
} ;
F_175 ( V_216 , & V_235 , V_234 ) ;
F_175 ( V_216 , & V_8 -> V_53 ,
sizeof( V_235 ) - V_234 + V_8 -> V_27 ) ;
}
static enum V_226
F_188 ( struct V_206 * V_207 , int V_30 ,
struct V_233 * V_10 )
{
F_186 ( V_207 ) ;
return F_184 ( & V_207 -> V_214 ) ;
}
static enum V_226 F_189 ( struct V_206 * V_207 )
{
if ( ! ( V_222 . V_204 & V_223 ) )
return V_236 ;
return F_182 ( V_207 , true ) ;
}
static int
F_190 ( struct V_224 * V_225 , T_3 V_237 , T_3 V_238 , int V_239 )
{
if ( V_238 == V_223 ) {
if ( V_239 )
V_230 &= ~ V_240 ;
...
static int F_198 ( const char * V_243 )
{
int V_192 ;
int V_244 = 0 ;
char * V_44 , * V_216 , * V_245 ;
V_44 = F_199 ( V_243 , V_84 ) ;
if ( V_44 == NULL )
return - V_85 ;
V_216 = F_200 ( V_44 ) ;
while ( 1 ) {
V_245 = F_201 ( & V_216 , L_30 ) ;
if ( V_245 == NULL )
break;
if ( * V_245 == '\0' )
continue;
...
static T_6 F_202 ( char * V_44 , int V_244 )
{
int V_192 ;
char * V_247 = V_44 ;
for ( V_192 = 0 ; V_192 < F_68 ( V_246 ) ; V_192 ++ ) {
...
static struct V_74 * F_203 ( struct V_98 * V_99 )
{
if ( V_99 -> V_248 == NULL )
return NULL ;
return F_77 ( V_99 ) ;
}
static T_6 F_204 ( struct V_25 * V_26 ,
struct V_249 * V_250 ,
char * V_44 )
{
struct V_100 * V_247 = F_205 ( V_26 ) ;
struct V_74 * V_75 ;
struct V_98 * V_99 ;
T_6 V_109 = - V_134 ;
V_99 = F_206 ( F_207 ( V_247 ) ) ;
if ( V_99 == NULL )
goto V_194;
V_75 = F_203 ( V_99 ) ;
if ( V_75 == NULL )
...
V_109 = F_202 ( V_44 , V_75 -> V_1 -> V_47 ) ;
else if ( V_250 == & V_255 )
...
int F_210 ( struct V_25 * V_26 )
{
return F_211 ( & V_26 -> V_259 , & V_260 ) ;
}
void F_212 ( struct V_25 * V_26 )
{
F_213 ( & V_26 -> V_259 , & V_260 ) ;
}
void F_214 ( char * V_44 , struct V_145 * V_146 )
{
int V_192 , V_218 ;
int V_6 = V_146 -> V_153 ;
...
void F_215 ( char * V_191 , T_3 V_58 , int V_57 )
{
int V_192 = 0 ;
if ( V_58 & V_261 )
V_191 [ V_192 ++ ] = 'F' ;
