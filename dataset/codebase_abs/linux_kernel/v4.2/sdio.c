...
static int F_89 ( struct V_138 * V_32 )
{
F_78 ( V_32 , V_32 -> V_5 -> V_23 ) ;
return F_86 ( V_32 ) ;
}
static int F_90 ( struct V_138 * V_32 )
{
F_91 ( V_32 , V_32 -> V_5 -> V_23 ) ;
return F_86 ( V_32 ) ;
}
int F_92 ( struct V_138 * V_32 )
{
