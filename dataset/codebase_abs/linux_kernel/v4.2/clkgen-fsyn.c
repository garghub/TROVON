...
unsigned long V_5 = 0 ;
F_5 ( V_23 , V_57 [ V_23 -> V_58 ] , 0 ) ;
F_5 ( V_23 , V_36 [ V_23 -> V_58 ] , V_23 -> V_59 ) ;
F_5 ( V_23 , V_37 [ V_23 -> V_58 ] , V_23 -> V_37 ) ;
F_5 ( V_23 , V_35 [ V_23 -> V_58 ] , V_23 -> V_35 ) ;
if ( V_23 -> V_8 )
F_4 ( V_23 -> V_8 , V_5 ) ;
if ( V_23 -> V_9 -> V_60 )
F_5 ( V_23 , V_38 [ V_23 -> V_58 ] , V_23 -> V_38 ) ;
if ( V_23 -> V_8 )
F_6 ( V_23 -> V_8 , V_5 ) ;
}
...
{
unsigned long V_67 = ( 1 << V_23 -> V_35 ) ;
unsigned long V_66 ;
T_5 V_65 ;
V_66 = ( V_23 -> V_38 == 1 ) ? 1 : 3 ;
V_65 = ( V_71 * ( 32 + V_23 -> V_36 ) + 32 * V_23 -> V_37 ) * V_67 * V_66 ;
...
if ( V_23 -> V_9 -> V_60 )
V_27 -> V_38 = F_7 ( V_23 , V_38 [ V_23 -> V_58 ] ) ;
else
V_27 -> V_38 = 1 ;
...
V_73 = * V_27 ;
F_39 ( V_34 , & V_23 -> V_9 -> V_80 [ V_77 ] , & V_24 ) ;
V_75 = abs ( V_72 - V_24 ) ;
if ( V_75 > V_76 ) {
V_24 = V_74 ;
* V_27 = V_73 ;
