...
#endif
if ( V_139 . V_195 > sizeof( long ) ) {
V_52 = - V_135 ;
goto V_194;
}
V_192 -> V_172 = ( V_139 . V_195 < sizeof( long ) ) ;
V_194:
F_66 ( V_192 ) ;
return V_52 ;
}
static void F_111 ( struct V_9 * V_192 ,
struct V_196 * V_139 )
{
V_139 -> V_10 = V_192 -> V_43 ;
V_139 -> type = V_192 -> type ;
strcpy ( V_139 -> V_63 , V_192 -> V_63 ) ;
V_139 -> V_90 = V_192 -> V_90 ;
V_139 -> V_109 = V_192 -> V_109 ;
memcpy ( V_139 -> V_94 , V_192 -> V_94 , 32 ) ;
V_139 -> V_197 = V_192 -> V_197 ;
memset ( V_139 -> V_198 , 0 , sizeof( V_139 -> V_198 ) ) ;
}
...
struct V_9 * V_192 ;
struct V_196 V_199 ;
if ( F_99 ( & V_199 , V_181 , sizeof( V_199 ) ) )
return - V_73 ;
V_192 = F_11 ( V_199 . V_10 ) ;
if ( V_192 == NULL )
return - V_119 ;
F_111 ( V_192 , & V_199 ) ;
F_66 ( V_192 ) ;
if ( F_58 ( V_181 , & V_199 , sizeof( V_199 ) ) )
return - V_73 ;
return 0 ;
}
...
if ( F_99 ( & V_199 , V_181 , sizeof( V_199 ) ) )
return - V_73 ;
if ( V_10 -> V_43 != V_199 . V_10 )
return - V_123 ;
if ( V_10 -> type != V_199 . type )
return - V_135 ;
if ( V_199 . V_63 [ 0 ] )
F_114 ( V_10 -> V_63 , V_199 . V_63 , sizeof( V_10 -> V_63 ) ) ;
V_10 -> V_90 = V_199 . V_90 ;
V_10 -> V_109 = V_199 . V_109 ;
memcpy ( V_10 -> V_94 , V_199 . V_94 , 32 ) ;
return 0 ;
}
...
return - V_123 ;
V_88 = F_116 ( V_10 , ( V_139 . V_15 & V_203 ) ? V_139 . V_144 . V_88 : - 1 ) ;
if ( V_88 == NULL )
return - V_55 ;
if ( V_10 -> type == V_45 && V_139 . V_204 ) {
F_117 ( V_10 , V_88 -> V_144 . V_88 ) ;
return - V_135 ;
}
if ( V_10 -> type == V_46 ) {
if ( ( V_202 = V_139 . V_204 ) != NULL ) {
if ( V_202 -> V_205 )
V_88 -> V_205 = V_202 -> V_205 ;
V_88 -> V_62 = V_202 -> V_62 ;
V_88 -> V_206 = V_202 -> V_206 ;
V_88 -> V_127 = V_202 -> V_127 ;
V_88 -> V_136 . V_207 = V_202 -> V_208 ;
V_88 -> V_136 . V_209 = V_202 -> V_210 ;
V_88 -> V_211 . V_207 = V_202 -> V_212 ;
V_88 -> V_211 . V_209 = V_202 -> V_213 ;
}
}
...
if ( F_99 ( & V_139 , V_181 , sizeof( V_139 ) ) )
return - V_73 ;
V_192 = F_11 ( V_139 . V_144 . V_10 ) ;
if ( V_192 == NULL )
return - V_71 ;
V_88 = F_75 ( V_192 , V_139 . V_144 . V_88 ) ;
if ( V_88 == NULL ) {
F_66 ( V_192 ) ;
return - V_119 ;
}
...
memset ( & V_139 , 0 , sizeof( V_139 ) ) ;
V_139 . V_10 = V_192 -> V_43 ;
V_139 . V_256 = V_192 -> V_11 -> V_166 ;
V_139 . V_257 = V_192 -> V_11 -> V_258 ;
V_139 . V_259 = V_139 . V_256 ;
V_139 . V_259 = F_155 ( V_192 -> V_11 ) ;
if ( V_192 -> type == V_45 ) {
V_139 . V_260 = V_192 -> V_58 . V_51 . V_60 ;
V_139 . V_261 = V_139 . V_260 ;
if ( V_192 -> V_58 . V_51 . V_59 )
V_139 . V_261 = F_155 ( V_192 -> V_58 . V_51 . V_59 -> V_11 ) ;
} else {
V_139 . V_260 = 0 ;
V_139 . V_261 = 0 ;
}
...
if ( F_99 ( & V_129 , V_181 , sizeof( V_129 ) ) )
return - V_73 ;
if ( ( V_192 = F_11 ( V_129 . V_274 . V_10 ) ) == NULL )
goto V_224;
if ( ( V_88 = F_75 ( V_192 , V_129 . V_274 . V_88 ) ) == NULL )
goto V_224;
switch ( V_129 . type ) {
case V_275 :
V_271 = & V_88 -> V_136 ;
...
V_68 = F_91 ( V_192 , V_151 , V_2 , V_161 , V_95 , V_96 ) ;
F_66 ( V_192 ) ;
return V_68 ;
}
...
V_68 = F_87 ( V_192 , V_151 , V_95 , V_96 ) ;
F_66 ( V_192 ) ;
return V_68 ;
}
