...
if ( V_133 ) {
F_45 ( V_112 [ V_3 ] , V_112 [ V_132 ] ) ;
F_45 ( V_113 [ V_3 ] , V_113 [ V_132 ] ) ;
V_133 = false ;
}
}
}
...
static void F_46 ( struct V_21 * V_22 , const T_1 * V_94 )
{
struct V_135 * V_136 ;
struct V_95 * V_96 = & V_22 -> V_97 ;
struct V_23 * V_24 = & V_22 -> V_25 ;
...
void F_49 ( struct V_21 * V_22 , const T_1 * V_94 )
{
unsigned int V_3 ;
T_1 V_164 ;
T_1 V_165 , V_166 ;
...
void F_54 ( struct V_21 * V_22 , const T_1 * V_94 )
{
struct V_23 * V_24 = & V_22 -> V_25 ;
struct V_26 * V_27 = & V_24 -> V_28 ;
if ( V_94 [ 1 ] > 1 )
...
void F_55 ( struct V_21 * V_22 , struct V_155 * V_156 )
{
struct V_117 * V_118 = & V_22 -> V_119 ;
struct V_23 * V_24 = & V_22 -> V_25 ;
struct V_26 * V_27 = & V_24 -> V_28 ;
...
case 2 :
default:
if ( V_27 -> V_185 && V_27 -> V_186 & F_39 ( 1 ) ) {
if ( V_118 -> V_190 == V_191 ) {
V_156 -> V_188 = 1 ;
V_156 -> V_189 = 0 ;
} else {
...
if ( ! F_26 ( V_53 ) )
return V_208 ;
if ( F_57 ( ! F_58 ( V_193 -> V_209 ) ) ) {
F_59 ( V_210 L_4 ,
V_184 ) ;
return V_100 ;
}
if ( ! F_60 ( V_157 -> V_158 . V_77 , V_193 -> V_211 ) ) {
F_43 ( L_5 ,
V_184 , V_193 -> V_211 ,
V_157 -> V_158 . V_77 ) ;
return V_100 ;
}
V_204 = V_194 - F_61 ( struct V_192 , V_212 . V_213 . V_214 ) ;
V_94 = F_62 ( V_215 , V_193 -> V_212 . V_213 . V_214 ,
V_204 ) ;
if ( V_94 )
V_199 = V_94 [ 2 ] ;
else {
...
V_94 = F_62 ( V_219 , V_193 -> V_212 . V_213 . V_214 , V_204 ) ;
if ( V_94 && V_94 [ 1 ] ) {
V_207 = V_94 + 2 ;
V_205 = V_94 [ 1 ] ;
} else {
...
V_94 = F_62 ( V_226 , V_193 -> V_212 . V_213 . V_214 , V_204 ) ;
if ( V_94 && V_94 [ 1 ] ) {
V_198 = V_227 ;
if ( V_94 && V_94 [ 1 ] ) {
...
if ( V_94 && V_94 [ 1 ] ) {
V_198 = V_230 ;
V_203 = F_66 ( V_94 , V_94 [ 1 ] + 2 , & V_200 ,
& V_201 , & V_202 ) ;
if ( V_203 == V_208 )
F_63 ( V_220 , V_221 ,
L_15 ,
...
unsigned int V_47 ;
const T_1 * V_94 ;
V_47 = V_194 - F_61 ( struct V_192 , V_212 . V_213 . V_214 ) ;
V_94 = F_62 ( V_216 , V_193 -> V_212 . V_213 . V_214 ,
V_47 ) ;
if ( V_94 )
F_46 ( V_22 , V_94 ) ;
V_94 = F_62 ( V_236 , V_193 -> V_212 . V_213 . V_214 , V_47 ) ;
if ( V_94 ) {
F_54 ( V_22 , V_94 ) ;
F_55 ( V_22 , V_156 ) ;
}
...
static int F_71 ( unsigned char V_1 )
{
int V_113 = 0 ;
V_1 = V_1 & 0x7f ;
switch ( V_1 ) {
...
if ( ( * ( V_246 + V_3 ) ) & 0x80 )
V_249 |= 0x1 << F_71 ( * ( V_246 + V_3 ) ) ;
}
return V_249 ;
}
unsigned int F_73 ( unsigned char * V_246 , unsigned int V_247 )
{
unsigned int V_3 , V_248 ;
unsigned int V_249 = 0 ;
V_248 = ( V_247 > V_44 ) ? V_44 : V_247 ;
...
unsigned int F_74 ( struct V_167 * V_250 )
{
unsigned int V_249 = 0 ;
...
if ( V_250 -> V_254 & F_76 ( 0x1 << V_251 ) )
return V_208 ;
else
return V_100 ;
}
unsigned char F_77 ( T_2 V_249 )
{
int V_3 ;
...
void F_78 ( struct V_21 * V_22 , struct V_155 * V_156 )
{
F_79 ( V_156 , 0 ) ;
}
...
void F_81 ( struct V_21 * V_22 , struct V_155 * V_156 )
{
F_80 ( V_22 , V_156 ) ;
}
void F_82 ( struct V_21 * V_22 , T_1 V_256 )
{
...
unsigned char F_85 ( T_1 * V_261 , T_4 V_47 )
{
int V_3 ;
T_1 V_262 ;
T_1 V_263 ;
...
void F_88 ( struct V_21 * V_53 , T_3 V_285 )
{
...
F_93 ( V_22 , 0x08 , 0x08 , 0x0a , 0x0a ) ;
if ( V_24 -> V_120 & V_6 )
F_83 ( V_22 , V_32 ) ;
else
F_83 ( V_22 , V_36 ) ;
}
void F_94 ( struct V_21 * V_22 , T_2 V_92 )
{
struct V_23 * V_24 = & V_22 -> V_25 ;
struct V_26 * V_27 = & V_24 -> V_28 ;
if ( V_24 -> V_120 & V_6 ) {
...
int F_95 ( struct V_21 * V_22 , T_1 * V_296 ,
T_4 V_297 , int V_298 )
{
int V_299 = 0 ;
struct V_23 * V_24 = & V_22 -> V_25 ;
struct V_26 * V_27 = & V_24 -> V_28 ;
const T_1 * V_94 ;
V_94 = F_62 ( V_300 , V_296 , V_297 ) ;
if ( ! V_94 )
return V_100 ;
memcpy ( V_27 -> V_84 [ V_298 ] . V_294 , V_94 + 2 , V_94 [ 1 ] ) ;
V_299 = V_94 [ 1 ] ;
V_94 = F_62 ( V_301 , V_296 , V_297 ) ;
if ( V_94 )
