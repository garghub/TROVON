...
static void * F_36 ( struct V_56 * V_7 )
{
return F_27 ( V_7 , & V_68 ) ;
}
static void * F_37 ( struct V_56 * V_7 )
{
return F_27 ( V_7 , & V_69 ) ;
}
static int F_38 ( struct V_56 * V_7 , void * V_70 )
{
struct V_1 * V_2 = V_70 ;
int V_55 ;
V_55 = F_24 ( V_2 , true ) ;
...
static void F_39 ( struct V_56 * V_7 , void * V_70 )
{
struct V_1 * V_71 = V_70 ;
F_24 ( V_71 , false ) ;
F_20 ( V_71 , false ) ;
}
static void F_40 ( void * V_70 , unsigned int V_17 )
{
struct V_1 * V_2 = V_70 ;
struct V_5 * V_6 = & V_2 -> V_7 -> V_6 ;
if ( V_2 -> V_47 == V_65 )
V_2 -> V_58 -> V_72 ( V_2 , V_17 ) ;
else if ( V_2 -> V_47 == V_48 )
V_2 -> V_58 -> V_73 ( V_2 , V_17 ) ;
else
