...
V_1 -> V_84 &= ~ V_169 ;
F_98 ( & V_7 -> V_170 -> V_165 ) ;
if ( V_154 -> V_161 & V_162 )
F_99 ( V_7 -> V_170 , V_154 ,
V_166 ) ;
else
F_100 ( & V_7 -> V_170 -> V_165 ) ;
error = - V_106 ;
goto V_171;
}
...
V_1 -> V_84 &= ~ V_169 ;
F_109 ( V_7 -> V_170 , & V_1 -> V_167 . V_164 ,
...
F_77 ( & V_176 -> V_3 ) ;
F_116 ( & V_175 -> V_3 , V_177 ) ;
} else {
F_77 ( & V_175 -> V_3 ) ;
F_116 ( & V_176 -> V_3 , V_177 ) ;
}
} else if ( V_175 ) {
F_77 ( & V_175 -> V_3 ) ;
} else if ( V_176 ) {
