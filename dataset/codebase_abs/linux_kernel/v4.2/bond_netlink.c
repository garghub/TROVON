...
static int F_33 ( struct V_134 * V_135 , struct V_1 * V_2 ,
struct V_36 * V_37 [] , struct V_36 * V_38 [] )
{
int V_46 ;
...
goto V_12;
V_137 = 0 ;
for ( V_77 = 0 ; V_77 < V_136 ; V_77 ++ ) {
if ( V_22 -> V_83 . V_139 [ V_77 ] ) {
F_42 ( V_9 , V_77 , V_22 -> V_83 . V_139 [ V_77 ] ) ;
V_137 = 1 ;
}
}
if ( V_137 )
...
goto V_12;
if ( F_8 ( V_9 , V_132 ,
sizeof( V_22 -> V_83 . V_148 ) ,
& V_22 -> V_83 . V_148 ) )
goto V_12;
}
if ( ! F_47 ( V_22 , & V_144 ) ) {
struct V_36 * V_149 ;
V_149 = F_41 ( V_9 , V_150 ) ;
if ( ! V_149 )
goto V_12;
if ( F_9 ( V_9 , V_151 ,
V_144 . V_152 ) )
