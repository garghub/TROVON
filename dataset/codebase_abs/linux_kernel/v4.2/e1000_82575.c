...
if ( V_397 == 10 )
F_17 ( L_26 ) ;
F_7 ( V_398 , V_394 & ~ V_403 ) ;
V_392 = F_2 ( V_404 ) ;
F_7 ( V_404 , 0 ) ;
V_391 = F_2 ( V_297 ) ;
V_395 = V_391 & ~ ( V_405 | V_406 ) ;
V_395 |= V_407 ;
F_7 ( V_297 , V_395 ) ;
F_7 ( V_297 , V_395 | V_405 ) ;
F_13 () ;
F_33 ( 2000 , 3000 ) ;
for ( V_263 = 0 ; V_263 < 4 ; V_263 ++ )
...
void F_75 ( struct V_1 * V_2 , bool V_420 , int V_421 )
{
T_1 V_422 , V_423 ;
switch ( V_2 -> V_5 . type ) {
case V_7 :
...
void F_76 ( struct V_1 * V_2 , bool V_420 )
{
T_1 V_429 ;
switch ( V_2 -> V_5 . type ) {
case V_7 :
...
void F_77 ( struct V_1 * V_2 , bool V_420 )
{
T_1 V_431 = F_2 ( V_432 ) ;
if ( V_420 )
V_431 |= V_433 ;
...
if ( ! F_6 ( V_2 ) )
goto V_38;
V_19 = V_2 -> V_102 . V_22 . V_129 ( V_2 , V_436 +
...
T_3 V_446 = 0 ;
T_3 V_263 , V_435 ;
for ( V_263 = V_231 ; V_263 < ( ( V_447 + V_231 ) + 1 ) ; V_263 ++ ) {
V_19 = V_2 -> V_102 . V_22 . V_129 ( V_2 , V_263 , 1 , & V_435 ) ;
if ( V_19 ) {
F_17 ( L_27 ) ;
goto V_38;
}
...
T_3 V_446 = 0 ;
T_3 V_263 , V_435 ;
for ( V_263 = V_231 ; V_263 < ( V_447 + V_231 ) ; V_263 ++ ) {
V_19 = V_2 -> V_102 . V_22 . V_129 ( V_2 , V_263 , 1 , & V_435 ) ;
if ( V_19 ) {
F_17 ( L_30 ) ;
goto V_38;
...
V_19 = V_2 -> V_102 . V_22 . V_123 ( V_2 , ( V_447 + V_231 ) , 1 ,
& V_446 ) ;
if ( V_19 )
F_17 ( L_31 ) ;
V_38:
...
T_3 V_451 , V_435 ;
T_3 V_452 ;
V_19 = V_2 -> V_102 . V_22 . V_129 ( V_2 , V_453 , 1 , & V_435 ) ;
if ( V_19 ) {
F_17 ( L_27 ) ;
goto V_38;
}
...
if ( ( V_435 & V_454 ) == 0 ) {
V_435 = V_435 | V_454 ;
V_19 = V_2 -> V_102 . V_22 . V_123 ( V_2 , V_453 , 1 ,
& V_435 ) ;
if ( V_19 ) {
F_17 ( L_33 ) ;
goto V_38;
...
static T_2 F_85 ( struct V_1 * V_2 , T_3 V_455 ,
T_3 * V_20 , bool V_129 )
{
T_2 V_19 = 0 ;
...
T_2 F_87 ( struct V_1 * V_2 , bool V_458 , bool V_459 )
{
T_1 V_460 , V_461 ;
...
T_2 F_88 ( struct V_1 * V_2 , bool V_458 , bool V_459 )
{
struct V_17 * V_18 = & V_2 -> V_18 ;
T_2 V_19 = 0 ;
T_3 V_472 ;
...
goto V_38;
if ( ! V_2 -> V_30 . V_31 . V_157 ) {
V_19 = V_18 -> V_22 . V_23 ( V_2 , V_473 , 18 ) ;
if ( V_19 )
goto V_38;
V_19 = V_18 -> V_22 . V_25 ( V_2 , V_474 ,
& V_472 ) ;
if ( V_19 )
goto V_38;
V_472 |= V_475 ;
V_19 = V_18 -> V_22 . V_23 ( V_2 , V_474 ,
V_472 ) ;
if ( V_19 )
goto V_38;
V_19 = V_18 -> V_22 . V_23 ( V_2 , V_473 , 0 ) ;
if ( V_19 )
goto V_38;
V_19 = F_89 ( V_2 , V_476 ,
V_477 ,
...
T_4 V_489 ;
T_4 V_263 ;
struct V_490 * V_20 = & V_2 -> V_5 . V_491 ;
if ( ( V_2 -> V_5 . type != V_11 ) || ( V_2 -> V_55 . V_56 != 0 ) )
return V_492 ;
V_20 -> V_493 [ 0 ] . V_494 = ( F_2 ( V_495 ) & 0xFF ) ;
V_2 -> V_102 . V_22 . V_129 ( V_2 , V_496 , 1 , & V_484 ) ;
if ( ( V_484 == 0x0000 ) || ( V_484 == 0xFFFF ) )
return 0 ;
V_2 -> V_102 . V_22 . V_129 ( V_2 , V_484 , 1 , & V_485 ) ;
if ( ( ( V_485 & V_497 ) >> V_498 )
!= V_499 )
return V_492 ;
V_487 = ( V_485 & V_500 ) ;
if ( V_487 > V_501 )
V_487 = V_501 ;
for ( V_263 = 1 ; V_263 < V_487 ; V_263 ++ ) {
V_2 -> V_102 . V_22 . V_129 ( V_2 , ( V_484 + V_263 ) , 1 , & V_486 ) ;
V_488 = ( ( V_486 & V_502 ) >>
V_503 ) ;
V_489 = ( ( V_486 & V_504 ) >>
V_505 ) ;
if ( V_489 != 0 )
V_2 -> V_18 . V_22 . V_506 ( V_2 ,
V_507 [ V_488 ] ,
V_508 ,
& V_20 -> V_493 [ V_263 ] . V_494 ) ;
}
return 0 ;
}
...
if ( ( V_2 -> V_5 . type != V_11 ) || ( V_2 -> V_55 . V_56 != 0 ) )
return V_492 ;
memset ( V_20 , 0 , sizeof( struct V_490 ) ) ;
V_20 -> V_493 [ 0 ] . V_511 = 0x1 ;
V_20 -> V_493 [ 0 ] . V_512 =
( F_2 ( V_513 ) & 0xFF ) ;
V_20 -> V_493 [ 0 ] . V_514 =
( F_2 ( V_515 ) & 0xFF ) ;
...
V_505 ) ;
V_510 = V_486 & V_518 ;
V_2 -> V_18 . V_22 . V_519 ( V_2 ,
V_520 [ V_488 ] ,
V_508 ,
V_510 ) ;
if ( ( V_263 < V_501 ) && ( V_489 != 0 ) ) {
V_20 -> V_493 [ V_263 ] . V_511 = V_489 ;
V_20 -> V_493 [ V_263 ] . V_512 = V_510 ;
V_20 -> V_493 [ V_263 ] . V_514 = V_510 -
V_509 ;
}
}
return 0 ;
