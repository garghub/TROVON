...
void F_144 ( T_9 * V_207 , struct V_55 * V_56 , struct V_50 * V_60 )
{
T_6 V_28 ;
if ( F_145 ( V_60 ) )
V_28 = F_39 ( V_56 ) -> V_79 ;
...
struct V_108 * V_109 ,
struct V_229 * V_230 , T_12 type , T_1 V_231 )
{
bool V_232 = false ;
if ( V_230 ) {
struct V_127 * V_128 = & F_95 ( * V_154 ) ;
...
T_9 V_86 , struct V_58 * V_53 , int V_244 )
{
struct V_50 * V_51 ;
...
V_82 -> V_57 = V_82 -> V_79 ;
if ( ! V_82 -> V_57 )
V_82 -> V_57 = V_82 -> V_79 = F_214 ( V_304 ) ;
V_285 = V_37 -> V_228 ;
V_82 -> V_209 = V_295 ;
V_154 . type = V_279 ;
V_218 |= V_259 ;
...
if ( V_154 . type == V_279 ) {
if ( ! V_82 -> V_79 ) {
if ( V_154 . V_230 -> V_305 )
V_82 -> V_79 = V_154 . V_230 -> V_305 ;
else
V_82 -> V_79 = V_82 -> V_57 ;
}
V_285 = V_37 -> V_228 ;
...
struct V_1 * F_221 ( struct V_37 * V_37 , struct V_1 * V_307 )
{
struct V_50 * V_308 = (struct V_50 * ) V_307 ;
struct V_50 * V_60 ;
V_60 = F_174 ( & V_309 , NULL , 1 , V_310 , 0 ) ;
if ( V_60 ) {
struct V_1 * V_200 = & V_60 -> V_2 ;
V_200 -> V_311 = 1 ;
V_200 -> V_257 = V_312 ;
V_200 -> V_251 = V_313 ;
V_200 -> V_53 = V_308 -> V_2 . V_53 ;
if ( V_200 -> V_53 )
F_167 ( V_200 -> V_53 ) ;
V_60 -> V_255 = V_308 -> V_255 ;
V_60 -> V_256 = V_308 -> V_256 ;
V_60 -> V_119 = V_308 -> V_119 ;
V_60 -> V_52 = F_34 ( V_37 ) ;
V_60 -> V_124 = V_308 -> V_124 ;
V_60 -> V_253 = V_308 -> V_253 ;
V_60 -> V_62 = V_308 -> V_62 ;
V_60 -> V_126 = V_308 -> V_126 ;
F_182 ( & V_60 -> V_226 ) ;
F_222 ( V_200 ) ;
}
F_134 ( V_307 ) ;
...
struct V_50 * F_132 ( struct V_37 * V_37 , struct V_81 * V_314 ,
struct V_83 * V_84 )
{
struct V_50 * V_60 = F_124 ( V_37 , V_314 ) ;
if ( F_92 ( V_60 ) )
return V_60 ;
if ( V_314 -> V_287 )
...
struct V_81 * V_82 , struct V_55 * V_56 , T_1 V_315 ,
T_1 V_5 , int V_316 , int V_317 , unsigned int V_218 )
{
struct V_50 * V_60 = F_105 ( V_56 ) ;
struct V_318 * V_319 ;
struct V_320 * V_321 ;
...
T_1 error ;
T_1 V_322 [ V_323 ] ;
V_321 = F_226 ( V_56 , V_315 , V_5 , V_316 , sizeof( * V_319 ) , V_218 ) ;
if ( ! V_321 )
return - V_324 ;
V_319 = F_227 ( V_321 ) ;
V_319 -> V_325 = V_326 ;
V_319 -> V_327 = 32 ;
V_319 -> V_328 = 0 ;
V_319 -> V_329 = V_82 -> V_208 ;
V_319 -> V_330 = V_331 ;
if ( F_228 ( V_56 , V_332 , V_331 ) )
goto V_333;
V_319 -> V_334 = V_60 -> V_253 ;
V_319 -> V_335 = V_97 ;
V_319 -> V_336 = V_337 ;
V_319 -> V_338 = ( V_60 -> V_124 & ~ 0xFFFF ) | V_339 ;
if ( V_60 -> V_124 & V_340 )
V_319 -> V_338 |= V_341 ;
if ( F_198 ( V_56 ) -> V_218 & V_268 )
V_319 -> V_338 |= V_342 ;
if ( F_229 ( V_56 , V_343 , V_2 ) )
goto V_333;
if ( V_28 ) {
V_319 -> V_328 = 32 ;
if ( F_229 ( V_56 , V_344 , V_28 ) )
goto V_333;
}
if ( V_60 -> V_2 . V_53 &&
F_228 ( V_56 , V_345 , V_60 -> V_2 . V_53 -> V_98 ) )
goto V_333;
#ifdef F_28
if ( V_60 -> V_2 . V_212 &&
F_228 ( V_56 , V_346 , V_60 -> V_2 . V_212 ) )
goto V_333;
#endif
if ( ! F_157 ( V_60 ) &&
V_82 -> V_79 != V_28 ) {
if ( F_229 ( V_56 , V_347 , V_82 -> V_79 ) )
goto V_333;
}
if ( V_60 -> V_126 &&
F_229 ( V_56 , V_348 , V_60 -> V_62 ) )
goto V_333;
...
memcpy ( V_322 , F_230 ( & V_60 -> V_2 ) , sizeof( V_322 ) ) ;
if ( V_60 -> V_119 && V_121 )
V_322 [ V_195 - 1 ] = V_60 -> V_119 ;
if ( F_231 ( V_56 , V_322 ) < 0 )
goto V_333;
if ( V_82 -> V_198 &&
F_228 ( V_56 , V_349 , V_82 -> V_198 ) )
goto V_333;
...
#endif
if ( F_228 ( V_56 , V_351 , V_56 -> V_53 -> V_98 ) )
goto V_333;
}
...
static int F_237 ( struct V_55 * V_352 , struct V_320 * V_321 )
{
struct V_37 * V_37 = F_126 ( V_352 -> V_84 ) ;
struct V_318 * V_353 ;
struct V_354 * V_355 [ V_356 + 1 ] ;
...
int V_88 ;
struct V_55 * V_56 ;
V_245 = F_238 ( V_321 , sizeof( * V_353 ) , V_355 , V_356 , V_358 ) ;
if ( V_245 < 0 )
goto V_359;
V_353 = F_227 ( V_321 ) ;
V_56 = F_239 ( V_360 , V_31 ) ;
if ( ! V_56 ) {
V_245 = - V_261 ;
goto V_359;
}
F_240 ( V_56 ) ;
F_241 ( V_56 ) ;
F_39 ( V_56 ) -> V_80 = V_361 ;
F_242 ( V_56 , V_362 + sizeof( struct V_75 ) ) ;
V_28 = V_355 [ V_344 ] ? F_243 ( V_355 [ V_344 ] ) : 0 ;
V_2 = V_355 [ V_343 ] ? F_243 ( V_355 [ V_343 ] ) : 0 ;
V_357 = V_355 [ V_351 ] ? F_244 ( V_355 [ V_351 ] ) : 0 ;
V_88 = V_355 [ V_349 ] ? F_244 ( V_355 [ V_349 ] ) : 0 ;
memset ( & V_82 , 0 , sizeof( V_82 ) ) ;
V_82 . V_57 = V_2 ;
V_82 . V_79 = V_28 ;
V_82 . V_208 = V_353 -> V_329 ;
V_82 . V_209 = V_355 [ V_345 ] ? F_244 ( V_355 [ V_345 ] ) : 0 ;
V_82 . V_198 = V_88 ;
if ( V_357 ) {
struct V_58 * V_53 ;
V_53 = F_245 ( V_37 , V_357 ) ;
if ( ! V_53 ) {
V_245 = - V_300 ;
goto V_363;
}
...
V_56 -> V_88 = V_88 ;
F_246 () ;
V_245 = F_247 ( V_56 , V_2 , V_28 , V_353 -> V_329 , V_53 ) ;
F_248 () ;
V_60 = F_105 ( V_56 ) ;
...
goto V_363;
F_186 ( V_56 , & V_60 -> V_2 ) ;
if ( V_353 -> V_338 & V_341 )
V_60 -> V_124 |= V_340 ;
V_245 = F_225 ( V_37 , V_2 , V_28 , & V_82 , V_56 ,
F_251 ( V_352 ) . V_315 , V_321 -> V_364 ,
V_365 , 0 , 0 ) ;
if ( V_245 < 0 )
goto V_363;
V_245 = F_252 ( V_56 , V_37 , F_251 ( V_352 ) . V_315 ) ;
V_359:
return V_245 ;
V_363:
F_117 ( V_56 ) ;
...
static int F_254 ( struct V_366 * V_367 , int V_368 ,
void T_14 * V_369 ,
T_15 * V_370 , T_2 * V_371 )
{
struct V_37 * V_37 = (struct V_37 * ) V_367 -> V_372 ;
if ( V_368 ) {
F_36 ( V_37 ) ;
F_255 ( V_37 ) ;
return 0 ;
...
V_373 = V_374 ;
if ( ! F_257 ( V_37 , & V_375 ) ) {
V_373 = F_258 ( V_373 , sizeof( V_374 ) , V_31 ) ;
if ( ! V_373 )
goto V_376;
if ( V_37 -> V_377 != & V_378 )
V_373 [ 0 ] . V_379 = NULL ;
...
V_373 [ 0 ] . V_372 = V_37 ;
V_37 -> V_171 . V_380 = F_259 ( V_37 , L_19 , V_373 ) ;
if ( ! V_37 -> V_171 . V_380 )
goto V_381;
return 0 ;
V_381:
...
{
struct V_366 * V_373 ;
V_373 = V_37 -> V_171 . V_380 -> V_382 ;
F_261 ( V_37 -> V_171 . V_380 ) ;
F_262 ( V_373 == V_374 ) ;
F_23 ( V_373 ) ;
}
...
F_264 ( & V_37 -> V_139 , 0 ) ;
F_265 ( & V_37 -> V_171 . V_383 ,
sizeof( V_37 -> V_171 . V_383 ) ) ;
return 0 ;
}
static int T_3 F_266 ( struct V_37 * V_37 )
{
struct V_384 * V_385 = F_267 ( sizeof( * V_385 ) , V_31 ) ;
if ( ! V_385 )
return - V_32 ;
F_268 ( V_385 ) ;
V_37 -> V_171 . V_172 = V_385 ;
return 0 ;
}
static void T_4 F_269 ( struct V_37 * V_37 )
{
struct V_384 * V_385 = V_37 -> V_171 . V_172 ;
...
int V_386 = 0 ;
int V_12 ;
V_71 = F_267 ( V_69 * sizeof( * V_71 ) , V_31 ) ;
if ( ! V_71 )
F_272 ( L_20 ) ;
F_273 ( V_71 , V_69 * sizeof( * V_71 ) ) ;
...
#endif
V_16 . V_387 =
F_277 ( L_23 , sizeof( struct V_50 ) , 0 ,
V_388 | V_389 , NULL ) ;
V_309 . V_387 = V_16 . V_387 ;
if ( F_278 ( & V_16 ) < 0 )
F_272 ( L_24 ) ;
if ( F_278 ( & V_309 ) < 0 )
F_272 ( L_25 ) ;
...
F_284 () ;
#endif
F_285 ( V_393 , V_394 , F_237 , NULL , NULL ) ;
#ifdef F_286
F_32 ( & V_395 ) ;
#endif
F_32 ( & V_396 ) ;
