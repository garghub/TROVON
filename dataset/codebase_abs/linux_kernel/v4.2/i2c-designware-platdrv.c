...
if ( V_45 < 0 )
return V_45 ;
V_2 = F_17 ( & V_5 -> V_2 , sizeof( struct V_1 ) , V_49 ) ;
if ( ! V_2 )
return - V_50 ;
V_42 = F_18 ( V_5 , V_51 , 0 ) ;
V_2 -> V_52 = F_19 ( & V_5 -> V_2 , V_42 ) ;
if ( F_20 ( V_2 -> V_52 ) )
...
static int F_52 ( struct V_88 * V_2 )
{
return F_53 ( V_2 ) ;
}
static void F_54 ( struct V_88 * V_2 )
{
if ( V_2 -> V_89 . V_90 )
F_55 ( V_2 ) ;
}
static int F_56 ( struct V_88 * V_2 )
{
struct V_4 * V_5 = F_57 ( V_2 ) ;
struct V_1 * V_91 = F_9 ( V_5 ) ;
F_48 ( V_91 ) ;
F_58 ( V_91 -> V_3 ) ;
return 0 ;
}
