...
static void F_106 ( struct V_168 * V_134 )
{
F_107 ( V_134 -> V_167 ) ;
V_134 -> V_169 |= V_170 ;
}
...
V_6 -> V_172 = 2 ;
F_15 ( V_6 -> V_14 [ 1 ] ) ;
V_16 = F_109 ( V_6 -> V_14 [ 1 ] , V_173 ) ;
if ( V_16 ) {
F_10 ( L_32 ) ;
F_21 ( V_6 -> V_14 [ 1 ] ) ;
goto V_174;
}
V_16 = F_109 ( V_6 -> V_14 [ 2 ] , V_175 ) ;
if ( V_16 ) {
F_10 ( L_33 ) ;
F_21 ( V_6 -> V_14 [ 1 ] ) ;
goto V_174;
}
V_6 -> V_14 [ 2 ] -> V_176 = V_177 ;
V_16 = F_110 ( V_6 -> V_14 [ 1 ] ) ;
F_21 ( V_6 -> V_14 [ 1 ] ) ;
if ( V_16 ) {
F_10 ( L_34 , V_16 ) ;
goto V_174;
...
V_6 -> V_144 = V_134 -> V_178 > 1 ;
V_171 = F_54 ( T_4 , V_134 -> V_179 , 511u ) ;
V_6 -> V_115 = F_54 ( T_4 , V_134 -> V_180 ,
V_171 * V_14 -> V_112 ) ;
V_6 -> V_156 = F_54 ( T_4 , V_134 -> V_178 ,
V_181 ) ;
V_6 -> V_129 = V_134 -> V_182 ;
F_75 ( V_6 ) ;
V_16 = F_78 ( V_6 ) ;
if ( V_16 )
goto V_174;
...
static void F_112 ( struct V_184 * V_15 ,
int V_185 )
{
#if F_113 ( V_186 )
struct V_187 * V_188 ;
...
struct V_184 * V_15 ;
F_3 ( V_23 , L_28 ) ;
F_3 ( V_23 , L_35 , V_14 -> V_192 ) ;
F_3 ( V_23 , L_36 , V_14 -> V_193 ) ;
F_3 ( V_23 , L_37 , V_14 -> V_184 ) ;
F_3 ( V_23 , L_38 , V_14 -> V_194 ) ;
V_15 = & V_14 -> V_15 ;
F_112 ( V_15 , 0 ) ;
if ( V_14 -> V_194 == 1 )
return 0 ;
...
V_6 -> V_14 [ 0 ] = F_116 ( V_14 , sizeof( * V_14 ) , V_157 ) ;
V_6 -> V_14 [ 0 ] -> V_194 = 0 ;
...
F_118 ( V_6 ) ;
#ifdef F_119
if ( ( F_120 ( V_6 -> V_14 [ 1 ] ) & V_198 ) &&
( ( F_120 ( V_6 -> V_14 [ 1 ] ) & V_199 ) ||
...
void F_122 ( struct V_184 * V_15 , bool V_202 )
{
...
static int F_123 ( struct V_184 * V_15 )
{
struct V_13 * V_14 ;
struct V_3 * V_4 ;
struct V_5 * V_6 ;
T_7 V_204 ;
V_14 = F_124 ( V_15 , struct V_13 , V_15 ) ;
F_3 ( V_23 , L_44 , V_14 -> V_194 ) ;
if ( V_14 -> V_194 != V_36 )
return 0 ;
V_4 = F_2 ( V_15 ) ;
V_6 = V_4 -> V_7 . V_8 ;
...
if ( F_126 ( V_6 -> V_14 [ 1 ] , V_204 ) )
F_10 ( L_45 , V_204 ) ;
return 0 ;
}
static int F_127 ( struct V_184 * V_15 )
{
struct V_3 * V_4 = F_2 ( V_15 ) ;
struct V_5 * V_6 = V_4 -> V_7 . V_8 ;
struct V_13 * V_14 = F_124 ( V_15 , struct V_13 , V_15 ) ;
F_3 ( V_23 , L_44 , V_14 -> V_194 ) ;
if ( V_14 -> V_194 != V_37 )
return 0 ;
F_91 ( V_6 ) ;
...
static int T_8 F_128 ( struct V_205 * V_206 )
{
F_3 ( V_23 , L_28 ) ;
V_197 = F_129 ( & V_206 -> V_15 ) ;
if ( V_197 -> V_207 )
V_197 -> V_207 () ;
return 0 ;
}
