...
V_6 = F_137 ( V_3 , V_281 , V_282 , V_283 , V_284 , false ) ;
if ( V_6 != V_285 ) {
F_71 ( V_3 , L_38 ,
V_286 , V_287 ) ;
F_71 ( V_3 , L_39
...
F_71 ( V_3 , L_43 ,
V_285 , V_6 ) ;
F_137 ( V_3 , V_281 , V_282 , V_283 , V_284 ,
true ) ;
return - 1 ;
}
return 0 ;
...
F_71 ( V_3 , L_47
L_48 ) ;
V_293 = F_142 ( V_3 , & V_3 -> V_294 -> V_295 ) ;
V_293 &= V_296 ;
V_293 &= ~ V_297 ;
F_35 ( V_3 , V_236 ,
L_49
L_50 ) ;
F_143 ( V_3 , ( ( T_5 ) V_120 & ( T_5 ) ~ V_296 ) | V_293 ,
& V_3 -> V_294 -> V_295 ) ;
}
static void F_144 ( struct V_2 * V_3 , unsigned int V_138 ,
...
static int F_148 ( struct V_2 * V_3 , T_1 V_5 )
{
T_6 T_7 * V_101 , * V_308 ;
T_3 V_309 , V_310 ;
unsigned int V_138 ;
...
if ( V_3 -> V_271 ) {
V_3 -> V_274 = F_154 ( sizeof( * V_3 -> V_274 ) *
V_3 -> V_271 , V_5 ) ;
if ( ! V_3 -> V_274 )
return - V_52 ;
V_311 = 0 ;
...
if ( V_3 -> V_272 ) {
V_3 -> V_275 = F_154 ( sizeof( * V_3 -> V_275 ) *
V_3 -> V_272 , V_5 ) ;
if ( ! V_3 -> V_275 )
return - V_52 ;
V_311 = 0 ;
...
int F_155 ( struct V_2 * V_3 , T_1 V_5 )
{
T_2 V_7 ;
struct V_81 * V_82 = F_44 ( V_3 ) -> V_83 . V_84 ;
...
F_35 ( V_3 , V_236 ,
L_74 , V_3 -> V_247 / 1024 ) ;
V_20 = F_156 ( F_145 ( & V_3 -> V_313 -> V_130 ) ) ;
F_35 ( V_3 , V_236 ,
L_75 , V_20 ) ;
V_322 = F_145 ( & V_3 -> V_319 -> V_324 ) ;
V_20 |= ( V_322 & ~ V_325 ) ;
F_35 ( V_3 , V_236 ,
L_76 , V_20 ) ;
F_157 ( V_20 , & V_3 -> V_319 -> V_324 ) ;
...
F_143 ( V_3 , V_7 , & V_3 -> V_319 -> V_327 ) ;
V_3 -> V_10 = F_158 ( L_78 , V_82 ,
V_11 , V_11 , V_3 -> V_247 ) ;
V_3 -> V_74 = F_158 ( L_79 , V_82 ,
2112 , 64 , V_3 -> V_247 ) ;
...
V_323 = F_142 ( V_3 , & V_3 -> V_319 -> V_266 ) ;
V_323 = ( V_323 & ( T_5 ) V_329 ) |
( V_3 -> V_266 -> V_43 -> V_7 & ( T_5 ) ~ V_329 ) |
V_3 -> V_266 -> V_4 ;
F_35 ( V_3 , V_236 ,
L_84 , V_20 ) ;
F_143 ( V_3 , V_323 , & V_3 -> V_319 -> V_266 ) ;
F_159 ( V_3 ) ;
V_3 -> V_265 = F_51 ( V_3 , true , true , V_5 ) ;
if ( ! V_3 -> V_265 )
goto V_54;
V_3 -> V_102 ++ ;
V_20 = F_145 ( & V_3 -> V_313 -> V_330 ) ;
V_20 &= V_331 ;
F_35 ( V_3 , V_236 ,
L_85
L_86 , V_20 ) ;
...
V_20 = F_145 ( & V_3 -> V_294 -> V_339 ) ;
V_20 &= V_340 ;
V_20 |= V_334 ;
F_35 ( V_3 , V_236 ,
L_90 ,
V_20 ) ;
F_157 ( V_20 , & V_3 -> V_294 -> V_339 ) ;
F_35 ( V_3 , V_236 ,
L_91 ) ;
F_35 ( V_3 , V_236 ,
L_92 ,
( unsigned long long ) V_3 -> V_260 . V_263 ) ;
V_323 = F_142 ( V_3 , & V_3 -> V_294 -> V_341 ) ;
V_323 &= V_296 ;
V_323 |= ( V_3 -> V_260 . V_263 & ( T_5 ) ~ V_296 ) ;
F_143 ( V_3 , V_323 , & V_3 -> V_294 -> V_341 ) ;
F_140 ( V_3 ) ;
F_35 ( V_3 , V_236 ,
L_93 ) ;
F_162 ( V_3 , 0 ) ;
...
if ( F_148 ( V_3 , V_5 ) )
goto V_54;
V_293 = F_145 ( & V_3 -> V_319 -> V_346 ) ;
V_293 &= ~ V_347 ;
V_293 |= V_348 ;
F_157 ( V_293 , & V_3 -> V_319 -> V_346 ) ;
return 0 ;
V_54:
F_71 ( V_3 , L_94 ) ;
F_163 ( V_3 ) ;
