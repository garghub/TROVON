...
break;
default:
F_13 ( V_3 -> V_5 -> V_20 , L_27 ) ;
return - V_21 ;
}
return 0 ;
}
static int F_89 ( struct V_160 * V_161 , struct V_160 * V_162 )
{
if ( V_161 -> V_149 < V_162 -> V_149 || V_161 -> V_150 < V_162 -> V_150 )
return 0 ;
if ( V_161 -> V_149 + V_161 -> V_131 > V_162 -> V_149 + V_162 -> V_131 )
return 0 ;
if ( V_161 -> V_150 + V_161 -> V_51 > V_162 -> V_150 + V_162 -> V_51 )
return 0 ;
return 1 ;
}
...
V_163 = & V_154 -> V_157 ;
V_54 = * V_163 ;
V_54 . V_149 = F_91 ( V_163 -> V_149 , V_47 -> V_11 -> V_141 ) ;
V_54 . V_150 = F_91 ( V_163 -> V_150 , V_47 -> V_11 -> V_144 ) ;
...
V_54 . V_131 = F_91 ( V_163 -> V_131 , V_47 -> V_11 -> V_141 ) ;
V_54 . V_51 = F_91 ( V_163 -> V_51 , V_47 -> V_11 -> V_141 ) ;
...
if ( V_154 -> V_4 & V_164 && ! F_89 ( & V_54 , V_163 ) )
return - V_165 ;
if ( V_154 -> V_4 & V_166 && ! F_89 ( V_163 , & V_54 ) )
return - V_165 ;
if ( ( V_54 . V_149 != V_163 -> V_149 ) || ( V_54 . V_150 != V_163 -> V_150 ) ||
( V_54 . V_131 != V_163 -> V_131 ) || ( V_54 . V_51 != V_163 -> V_51 ) ) {
F_13 ( V_3 -> V_5 -> V_20 ,
L_29 ,
V_28 , V_163 -> V_131 , V_163 -> V_51 , V_163 -> V_149 , V_163 -> V_150 ,
V_54 . V_131 , V_54 . V_51 , V_54 . V_149 , V_54 . V_150 ) ;
* V_163 = V_54 ;
}
V_47 -> V_148 = V_54 ;
...
if ( ! V_36 )
return - V_167 ;
V_36 -> V_106 . V_168 = & V_169 ;
V_36 -> V_106 . V_170 = & V_171 ;
V_36 -> V_106 . V_172 = V_173 ;
V_36 -> V_106 . V_99 = & V_36 -> V_99 ;
V_36 -> V_106 . V_174 = V_175 ;
V_36 -> V_106 . V_176 = & V_36 -> V_176 ;
snprintf ( V_36 -> V_106 . V_117 , sizeof( V_36 -> V_106 . V_117 ) , L_32 ,
V_120 , V_36 -> V_59 ) ;
F_95 ( & V_36 -> V_106 , V_36 ) ;
V_36 -> V_33 . V_106 = & V_36 -> V_106 ;
V_36 -> V_33 . V_34 = F_96 ( & V_177 ) ;
if ( F_47 ( V_36 -> V_33 . V_34 ) ) {
F_9 ( V_36 -> V_20 , L_33 ) ;
return F_48 ( V_36 -> V_33 . V_34 ) ;
}
V_8 = F_97 ( & V_36 -> V_106 , V_178 , - 1 ) ;
if ( V_8 ) {
F_9 ( V_36 -> V_20 ,
L_34 , V_28 ) ;
F_98 ( V_36 -> V_33 . V_34 ) ;
...
static T_3 F_101 ( int V_179 , void * V_45 )
{
...
static T_3 F_106 ( int V_179 , void * V_45 )
{
...
static void F_108 ( struct V_186 * V_187 )
{
struct V_188 * V_189 = F_109 ( V_187 ) ;
struct V_5 * V_36 = F_39 ( V_189 , struct V_5 ,
V_37 ) ;
struct V_2 * V_3 ;
V_3 = F_20 ( V_36 -> V_33 . V_34 ) ;
F_9 ( V_3 -> V_5 -> V_20 , L_35 ) ;
F_102 ( & V_36 -> V_6 ) ;
F_77 ( V_38 , & V_36 -> V_1 ) ;
F_105 ( & V_36 -> V_6 ) ;
F_33 ( V_36 ) ;
...
V_36 -> V_33 . V_3 = NULL ;
F_3 ( & V_36 -> V_6 , V_4 ) ;
if ( F_104 ( V_182 , & V_36 -> V_1 ) )
F_11 ( V_3 , V_44 ) ;
return 0 ;
}
static int F_112 ( struct V_192 * V_20 )
{
...
static int F_115 ( struct V_192 * V_20 )
{
struct V_5 * V_36 = F_113 ( V_20 ) ;
int V_8 = F_110 ( V_36 ) ;
if ( ! V_8 )
...
static int F_117 ( struct V_192 * V_20 )
{
struct V_5 * V_36 = F_113 ( V_20 ) ;
unsigned long V_4 ;
int V_193 ;
F_2 ( & V_36 -> V_6 , V_4 ) ;
V_193 = F_21 ( V_112 , & V_36 -> V_1 ) ;
F_3 ( & V_36 -> V_6 , V_4 ) ;
if ( ! V_193 )
return 0 ;
if ( ! F_118 ( V_20 ) )
...
static int F_119 ( struct V_192 * V_20 )
{
if ( ! F_118 ( V_20 ) )
return F_115 ( V_20 ) ;
return 0 ;
}
static int F_120 ( struct V_194 * V_116 )
{
...
if ( ! F_47 ( V_36 -> clock ) )
F_127 ( V_36 -> clock ) ;
F_13 ( & V_116 -> V_20 , L_36 , V_116 -> V_117 ) ;
return 0 ;
}
static int F_128 ( struct V_194 * V_116 )
{
struct V_5 * V_36 ;
struct V_195 * V_196 ;
struct V_192 * V_20 = & V_116 -> V_20 ;
int V_8 ;
F_13 ( V_20 , L_3 , V_28 ) ;
...
F_130 ( V_116 , V_36 ) ;
if ( V_20 -> V_197 )
V_36 -> V_59 = F_131 ( V_116 -> V_20 . V_197 , V_120 ) ;
else
...
F_135 ( & V_36 -> V_6 ) ;
F_136 ( & V_36 -> V_99 ) ;
V_196 = F_137 ( V_116 , V_198 , 0 ) ;
V_36 -> V_199 = F_138 ( V_20 , V_196 ) ;
if ( F_47 ( V_36 -> V_199 ) ) {
F_9 ( V_20 , L_37 ) ;
return F_48 ( V_36 -> V_199 ) ;
}
...
V_196 = F_137 ( V_116 , V_200 , 0 ) ;
if ( ! V_196 ) {
F_9 ( V_20 , L_40 ) ;
goto V_201;
}
V_8 = F_141 ( V_20 , V_196 -> V_202 , F_106 ,
F_101 , V_203 ,
V_116 -> V_117 , V_36 ) ;
if ( V_8 ) {
F_9 ( V_20 , L_41 ) ;
...
F_147 ( V_20 , L_46 , V_120 ,
V_36 -> V_59 , V_36 -> V_106 . V_209 ) ;
F_58 ( V_20 ) ;
return 0 ;
V_208:
F_122 ( V_36 -> V_20 ) ;
