...
V_8 |= V_6 -> V_23 << V_31 ;
V_8 |= V_6 -> V_32 & V_33 ;
V_9 = F_6 ( V_4 , V_6 , V_34 , V_8 ) ;
if ( V_9 < 0 )
return V_9 ;
V_8 = V_6 -> V_35 << V_36 ;
return F_6 ( V_4 , V_6 , V_37 , V_8 ) ;
}
static int F_17 ( struct V_13 * V_14 ,
unsigned int V_17 , unsigned long * V_38 )
{
unsigned V_39 = F_18 ( * V_38 ) ;
struct V_5 * V_6 ;
unsigned V_40 ;
V_6 = V_14 -> V_15 -> V_18 [ V_17 ] . V_27 ;
switch ( V_39 ) {
...
unsigned long * V_64 , unsigned V_65 )
{
struct V_1 * V_4 = F_16 ( V_14 ) ;
struct V_5 * V_6 ;
unsigned V_39 , V_40 ;
...
V_8 = V_6 -> V_57 << V_71 ;
V_9 = F_6 ( V_4 , V_6 , V_72 , V_8 ) ;
if ( V_9 < 0 )
return V_9 ;
V_8 = V_6 -> V_49 << V_73 ;
V_9 = F_6 ( V_4 , V_6 , V_74 , V_8 ) ;
if ( V_9 < 0 )
return V_9 ;
V_8 = V_6 -> V_42 << V_75 ;
V_8 |= V_6 -> V_62 << V_76 ;
...
F_23 ( V_79 , L_22 , V_6 -> V_57 ) ;
F_23 ( V_79 , L_23 , V_80 [ V_6 -> V_49 ] ) ;
F_23 ( V_79 , L_24 , V_81 [ V_6 -> V_42 ] ) ;
F_23 ( V_79 , L_18 , V_6 -> V_32 ? L_13 : L_15 ) ;
F_23 ( V_79 , L_21 , V_82 [ V_6 -> V_62 ] ) ;
}
}
...
unsigned long V_38 ;
V_38 = F_19 ( V_58 , 1 ) ;
return F_20 ( V_4 -> V_86 , V_17 , & V_38 , 1 ) ;
}
...
struct V_1 * V_4 = F_1 ( V_3 ) ;
unsigned V_66 ;
for ( V_66 = 0 ; V_66 < V_3 -> V_93 ; V_66 ++ ) {
F_22 ( V_4 -> V_86 , V_79 , V_66 ) ;
F_24 ( V_79 , L_25 ) ;
}
}
...
V_6 -> V_23 = V_8 >> V_31 ;
V_6 -> V_23 &= V_105 ;
V_8 = F_3 ( V_4 , V_6 , V_72 ) ;
if ( V_8 < 0 )
return V_8 ;
V_6 -> V_57 = V_8 >> V_71 ;
V_6 -> V_57 &= V_106 ;
V_8 = F_3 ( V_4 , V_6 , V_74 ) ;
if ( V_8 < 0 )
return V_8 ;
V_6 -> V_49 = V_8 >> V_73 ;
V_6 -> V_49 &= V_107 ;
...
V_116 -> V_135 = V_136 ;
#endif
for ( V_66 = 0 ; V_66 < V_16 ; V_66 ++ , V_114 ++ ) {
V_6 = & V_117 [ V_66 ] ;
V_114 -> V_27 = V_6 ;
V_114 -> V_21 = V_66 ;
V_114 -> V_19 = V_26 [ V_66 ] ;
V_6 -> V_92 = F_46 ( V_111 , V_66 ) ;
if ( V_6 -> V_92 < 0 )
return V_6 -> V_92 ;
V_6 -> V_11 = V_118 [ 0 ] + V_66 * V_120 ;
V_9 = F_36 ( V_4 , V_6 ) ;
if ( V_9 < 0 )
return V_9 ;
}
...
if ( F_48 ( V_4 -> V_86 ) )
return F_49 ( V_4 -> V_86 ) ;
V_9 = F_50 ( & V_4 -> V_3 ) ;
if ( V_9 ) {
F_5 ( V_4 -> V_12 , L_31 ) ;
goto V_140;
}
V_9 = F_51 ( & V_4 -> V_3 , F_44 ( V_12 ) , 0 , 0 , V_16 ) ;
if ( V_9 ) {
F_5 ( V_12 , L_32 ) ;
goto V_141;
}
