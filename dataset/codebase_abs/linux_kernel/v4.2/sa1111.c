...
void
F_38 ( struct V_7 * V_8 , int V_67 , unsigned int V_68 ,
unsigned int V_69 )
{
...
static int
F_43 ( struct V_7 * V_8 , struct V_82 * V_83 ,
struct V_84 * V_85 )
{
struct V_81 * V_45 ;
unsigned V_6 ;
...
V_45 -> V_99 = V_85 -> V_99 ;
for ( V_6 = 0 ; V_6 < F_48 ( V_85 -> V_1 ) ; V_6 ++ )
...
static int F_53 ( struct V_79 * V_103 , struct V_82 * V_104 , int V_1 )
{
...
if ( ! V_106 )
return - V_29 ;
V_8 = F_44 ( sizeof( struct V_7 ) , V_86 ) ;
if ( ! V_8 )
return - V_87 ;
V_8 -> V_59 = F_54 ( V_103 , L_7 ) ;
if ( F_55 ( V_8 -> V_59 ) ) {
V_42 = F_56 ( V_8 -> V_59 ) ;
goto V_111;
}
...
V_8 -> V_43 = V_104 -> V_95 ;
V_8 -> V_1 = V_1 ;
V_8 -> V_10 = F_60 ( V_104 -> V_95 , V_114 * 2 ) ;
if ( ! V_8 -> V_10 ) {
V_42 = - V_87 ;
goto V_115;
}
...
if ( V_106 )
V_109 &= ~ V_106 -> V_130 ;
for ( V_6 = 0 ; V_6 < F_48 ( V_131 ) ; V_6 ++ )
if ( V_131 [ V_6 ] . V_90 & V_109 )
F_43 ( V_8 , V_104 , & V_131 [ V_6 ] ) ;
return 0 ;
V_120:
F_66 ( V_8 -> V_10 ) ;
V_115:
...
F_67 ( V_8 -> V_59 ) ;
if ( V_8 -> V_1 != V_123 ) {
F_31 ( V_8 -> V_1 , NULL , NULL ) ;
F_74 ( V_8 -> V_17 , V_44 ) ;
F_75 ( V_8 -> V_43 + V_11 , 512 ) ;
}
F_66 ( V_8 -> V_10 ) ;
F_68 ( V_8 -> V_59 ) ;
F_42 ( V_8 ) ;
...
if ( V_1 < 0 )
return - V_159 ;
return F_53 ( & V_158 -> V_45 , V_104 , V_1 ) ;
}
static int F_85 ( struct V_134 * V_158 )
{
struct V_7 * V_8 = F_77 ( V_158 ) ;
if ( V_8 ) {
#ifdef F_86
F_42 ( V_8 -> V_138 ) ;
V_8 -> V_138 = NULL ;
...
static inline struct V_7 * F_87 ( struct V_81 * V_133 )
{
return (struct V_7 * ) F_88 ( V_133 -> V_45 . V_83 ) ;
}
...
if ( V_133 -> V_90 != V_168 )
return - V_29 ;
div = ( F_89 ( V_8 ) / 256 + V_167 / 2 ) / V_167 ;
if ( div == 0 )
div = 1 ;
if ( div > 128 )
div = 128 ;
