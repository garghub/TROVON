...
struct V_5 * V_6 = V_2 ;
struct V_7 * V_7 = V_6 -> V_7 ;
F_22 ( V_6 -> V_35 , 1 , V_36 | V_39 ) ;
F_15 ( V_7 , V_4 ) ;
return V_38 ;
}
static T_2 F_24 ( int V_4 , void * V_2 )
{
struct V_5 * V_6 = V_2 ;
struct V_7 * V_7 = V_6 -> V_7 ;
V_6 -> V_8 = 0 ;
...
static int T_3 F_25 ( struct V_40 * V_41 )
{
int V_12 ;
struct V_5 * V_6 ;
struct V_7 * V_7 ;
V_6 = F_26 ( & V_41 -> V_2 , sizeof( * V_6 ) , V_42 ) ;
if ( ! V_6 )
return - V_43 ;
V_7 = F_2 ( V_41 -> V_2 . V_44 ) ;
V_6 -> V_7 = V_7 ;
V_6 -> V_8 = 1 ;
F_27 ( V_41 , V_6 ) ;
F_5 ( V_7 ) ;
...
goto V_46;
F_6 ( V_7 ) ;
V_6 -> V_35 = F_30 ( & V_41 -> V_2 , V_41 -> V_48 ,
& V_49 , V_50 ) ;
return 0 ;
V_46:
F_31 ( V_7 , V_13 , V_6 ) ;
...
F_5 ( V_6 -> V_7 ) ;
F_31 ( V_6 -> V_7 , V_13 , V_6 ) ;
F_31 ( V_6 -> V_7 , V_47 , V_6 ) ;
F_31 ( V_6 -> V_7 , V_28 , V_6 ) ;
F_6 ( V_6 -> V_7 ) ;
return 0 ;
}
