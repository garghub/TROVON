...
V_193 -> V_3 . V_220 = F_101 ;
V_193 -> V_3 . V_221 = F_106 ;
V_193 -> V_203 = F_116 ( V_8 -> V_41 -> V_222 , V_196 ,
& V_223 , & V_193 -> V_3 ) ;
if ( ! V_193 -> V_203 ) {
F_19 ( & V_79 -> V_41 , L_50 ) ;
return - V_30 ;
...
static int F_121 ( struct V_4 * V_8 , T_1 V_234 ,
T_1 * V_235 )
{
struct V_236 * V_237 = V_8 -> V_41 -> V_222 ;
if ( F_122 ( V_237 , L_53 ) ) {
switch ( V_234 ) {
case 0x0000104 :
F_100 ( V_8 -> V_41 , L_54 ) ;
...
static bool F_123 ( struct V_236 * V_237 ,
struct V_245 * V_179 ,
unsigned int V_178 )
{
char V_246 [ 32 ] ;
...
snprintf ( V_246 , 32 , L_63 , V_179 [ V_27 ] . V_247 ) ;
if ( F_124 ( V_237 , V_246 , NULL ) == NULL )
return false ;
}
return true ;
}
...
if ( ! V_8 -> V_179 )
return - V_30 ;
V_8 -> V_179 [ 0 ] . V_247 = L_65 ;
V_8 -> V_179 [ 1 ] . V_247 = L_66 ;
if ( V_8 -> V_178 > 2 )
V_8 -> V_179 [ 2 ] . V_247 = L_67 ;
return F_127 ( V_8 -> V_41 , V_8 -> V_178 ,
V_8 -> V_179 ) ;
}
static int F_128 ( struct V_4 * V_8 , T_1 V_250 )
{
struct V_236 * V_237 = V_8 -> V_41 -> V_222 ;
unsigned int V_27 = 0 ;
if ( F_122 ( V_237 , L_53 ) ) {
...
if ( ! V_8 -> V_179 )
return - V_30 ;
V_8 -> V_179 [ V_27 ++ ] . V_247 = L_68 ;
V_8 -> V_179 [ V_27 ++ ] . V_247 = L_69 ;
V_8 -> V_179 [ V_27 ++ ] . V_247 = L_70 ;
V_8 -> V_179 [ V_27 ++ ] . V_247 = L_71 ;
V_8 -> V_179 [ V_27 ++ ] . V_247 = L_72 ;
V_8 -> V_179 [ V_27 ++ ] . V_247 = L_73 ;
V_8 -> V_179 [ V_27 ++ ] . V_247 = L_74 ;
} else if ( F_122 ( V_237 , L_56 ) ) {
bool V_251 = false , V_252 = false ;
if ( V_250 & 0x0f )
V_251 = true ;
if ( V_250 & 0x30 )
V_252 = true ;
V_8 -> V_178 = 4 + ( V_251 ? 2 : 0 ) +
( V_252 ? 2 : 0 ) ;
V_8 -> V_179 = F_126 ( V_8 -> V_41 , V_8 -> V_178 ,
sizeof( * V_8 -> V_179 ) ,
V_29 ) ;
...
V_8 -> V_179 [ V_27 ++ ] . V_247 = L_71 ;
V_8 -> V_179 [ V_27 ++ ] . V_247 = L_73 ;
V_8 -> V_179 [ V_27 ++ ] . V_247 = L_75 ;
if ( V_251 ) {
V_8 -> V_179 [ V_27 ++ ] . V_247 = L_76 ;
V_8 -> V_179 [ V_27 ++ ] . V_247 = L_77 ;
}
if ( V_252 ) {
V_8 -> V_179 [ V_27 ++ ] . V_247 = L_78 ;
V_8 -> V_179 [ V_27 ++ ] . V_247 = L_79 ;
}
} else if ( F_122 ( V_237 , L_60 ) ) {
V_8 -> V_178 = 5 ;
V_8 -> V_179 = F_126 ( V_8 -> V_41 , V_8 -> V_178 ,
...
if ( ! V_8 -> V_179 )
return - V_30 ;
V_8 -> V_179 [ 0 ] . V_247 = L_80 ;
V_8 -> V_179 [ 1 ] . V_247 = L_81 ;
V_8 -> V_179 [ 2 ] . V_247 = L_70 ;
V_8 -> V_179 [ 3 ] . V_247 = L_75 ;
V_8 -> V_179 [ 4 ] . V_247 = L_82 ;
}
if ( F_123 ( V_8 -> V_41 -> V_222 , V_8 -> V_179 ,
V_8 -> V_178 ) )
return F_127 ( V_8 -> V_41 , V_8 -> V_178 ,
V_8 -> V_179 ) ;
F_100 ( V_8 -> V_41 , L_83 ) ;
...
{
const struct V_58 * V_59 = V_8 -> V_60 ;
struct V_236 * V_237 = V_8 -> V_41 -> V_222 , * V_49 ;
struct V_253 V_254 ;
struct V_255 V_256 ;
T_1 V_234 = 0 , V_257 = 0 ;
...
V_8 -> V_71 . V_259 = V_188 ;
V_8 -> V_71 . V_191 = V_237 -> V_248 ;
V_8 -> V_71 . V_25 = ~ 0 ;
V_8 -> V_71 . V_260 = 0 ;
if ( F_130 ( & V_254 , V_237 ) ) {
F_19 ( V_8 -> V_41 , L_84 ) ;
return - V_209 ;
}
F_131 (&parser, &range) {
V_28 = F_132 ( & V_256 , V_237 , & V_187 ) ;
if ( V_28 < 0 )
return V_28 ;
switch ( V_187 . V_259 & V_261 ) {
case V_262 :
memcpy ( & V_8 -> V_77 , & V_187 , sizeof( V_187 ) ) ;
V_8 -> V_77 . V_191 = V_237 -> V_248 ;
V_8 -> V_78 . V_25 = V_256 . V_263 ;
V_8 -> V_78 . V_260 = V_256 . V_263 + V_256 . V_99 - 1 ;
V_8 -> V_78 . V_259 = V_188 ;
V_8 -> V_78 . V_191 = L_85 ;
memcpy ( & V_187 , & V_8 -> V_78 , sizeof( V_187 ) ) ;
break;
case V_188 :
if ( V_187 . V_259 & V_264 ) {
...
if ( V_187 . V_260 >= V_8 -> V_71 . V_260 )
V_8 -> V_71 . V_260 = V_187 . V_260 ;
}
V_28 = F_42 ( V_8 -> V_41 , & V_265 , & V_8 -> V_71 ) ;
if ( V_28 < 0 )
return V_28 ;
V_28 = F_133 ( V_237 , & V_8 -> V_76 ) ;
if ( V_28 < 0 ) {
F_19 ( V_8 -> V_41 , L_88 ,
V_28 ) ;
V_8 -> V_76 . V_191 = V_237 -> V_191 ;
V_8 -> V_76 . V_25 = 0 ;
V_8 -> V_76 . V_260 = 0xff ;
V_8 -> V_76 . V_259 = V_266 ;
}
F_134 (np, port) {
struct V_48 * V_267 ;
unsigned int V_50 ;
...
V_257 |= ( ( 1 << V_9 ) - 1 ) << V_258 ;
V_258 += V_9 ;
V_267 = F_138 ( V_8 -> V_41 , sizeof( * V_267 ) , V_29 ) ;
if ( ! V_267 )
return - V_30 ;
V_28 = F_139 ( V_49 , 0 , & V_267 -> V_65 ) ;
if ( V_28 < 0 ) {
F_19 ( V_8 -> V_41 , L_89 ,
V_28 ) ;
return V_28 ;
...
V_267 -> V_234 = V_9 ;
V_267 -> V_8 = V_8 ;
V_267 -> V_51 = F_81 ( V_8 -> V_41 , & V_267 -> V_65 ) ;
if ( F_24 ( V_267 -> V_51 ) )
return F_73 ( V_267 -> V_51 ) ;
F_25 ( & V_267 -> V_31 , & V_8 -> V_268 ) ;
}
V_28 = F_121 ( V_8 , V_234 , & V_8 -> V_155 ) ;
if ( V_28 < 0 ) {
F_19 ( V_8 -> V_41 , L_94 ) ;
return V_28 ;
}
V_28 = F_128 ( V_8 , V_257 ) ;
if ( V_28 < 0 )
return V_28 ;
return 0 ;
}
...
{
unsigned int V_269 = 3 ;
unsigned long V_9 ;
V_9 = F_7 ( V_49 -> V_51 + V_270 ) ;
V_9 &= ~ V_271 ;
V_9 |= V_272 ;
F_5 ( V_9 , V_49 -> V_51 + V_270 ) ;
do {
unsigned int V_127 = V_273 ;
do {
V_9 = F_7 ( V_49 -> V_51 + V_274 ) ;
if ( V_9 & V_275 )
break;
F_29 ( 1000 , 2000 ) ;
} while ( -- V_127 );
...
{
struct V_48 * V_49 , * V_279 ;
struct V_280 V_281 ;
F_142 (port, tmp, &pcie->ports, list) {
F_100 ( V_8 -> V_41 , L_96 ,
V_49 -> V_50 , V_49 -> V_234 ) ;
F_30 ( V_49 ) ;
if ( F_140 ( V_49 ) )
continue;
...
V_281 . V_285 = F_46 ;
V_281 . V_286 = & V_287 ;
F_144 ( V_8 -> V_41 , & V_281 ) ;
return 0 ;
}
static void * F_145 ( struct V_288 * V_289 , T_9 * V_290 )
{
struct V_4 * V_8 = V_289 -> V_291 ;
if ( F_146 ( & V_8 -> V_268 ) )
return NULL ;
F_147 ( V_289 , L_98 ) ;
return F_148 ( & V_8 -> V_268 , * V_290 ) ;
}
static void * F_149 ( struct V_288 * V_289 , void * V_292 , T_9 * V_290 )
{
struct V_4 * V_8 = V_289 -> V_291 ;
return F_150 ( V_292 , & V_8 -> V_268 , V_290 ) ;
}
static void F_151 ( struct V_288 * V_289 , void * V_292 )
{
}
static int F_152 ( struct V_288 * V_289 , void * V_292 )
{
bool V_293 = false , V_294 = false ;
struct V_48 * V_49 ;
unsigned int V_9 ;
V_49 = F_153 ( V_292 , struct V_48 , V_31 ) ;
V_9 = F_7 ( V_49 -> V_51 + V_274 ) ;
if ( V_9 & V_275 )
V_293 = true ;
V_9 = F_7 ( V_49 -> V_51 + V_277 ) ;
...
static int F_154 ( struct V_295 * V_295 , struct V_296 * V_296 )
{
struct V_4 * V_8 = V_295 -> V_297 ;
struct V_288 * V_289 ;
int V_28 ;
V_28 = F_155 ( V_296 , & V_298 ) ;
if ( V_28 )
return V_28 ;
V_289 = V_296 -> V_7 ;
V_289 -> V_291 = V_8 ;
...
{
struct V_299 * V_296 ;
V_8 -> V_300 = F_157 ( L_36 , NULL ) ;
if ( ! V_8 -> V_300 )
return - V_30 ;
V_296 = F_158 ( L_104 , V_301 | V_302 , V_8 -> V_300 ,
V_8 , & V_303 ) ;
if ( ! V_296 )
goto remove;
return 0 ;
