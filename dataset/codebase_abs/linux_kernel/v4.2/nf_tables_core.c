...
const struct V_7 * V_46 = F_13 ( & F_14 ( V_45 ) -> V_47 ) ;
const struct V_7 * V_7 = F_2 ( V_2 -> V_8 ? V_2 -> V_8 : V_2 -> V_9 ) ;
const struct V_48 * V_49 ;
const struct V_20 * V_21 , * V_50 ;
struct V_22 V_23 ;
unsigned int V_51 = 0 ;
struct V_52 V_53 [ V_54 ] ;
struct V_55 * V_56 ;
int V_5 ;
unsigned int V_57 = F_15 ( V_7 ) ;
if ( ! F_16 ( V_7 , V_46 ) )
return V_58 ;
V_59:
V_5 = 0 ;
V_49 = F_17 ( & V_4 -> V_60 , struct V_48 , V_61 ) ;
V_62:
V_23 . V_30 . V_31 = V_63 ;
F_18 (rule, &chain->rules, list) {
if ( F_5 ( V_49 -> V_64 & ( 1 << V_57 ) ) )
continue;
V_5 ++ ;
F_19 (expr, last, rule) {
if ( V_21 -> V_12 == & V_65 )
F_6 ( V_21 , & V_23 ) ;
else if ( V_21 -> V_12 != & V_66 ||
! F_9 ( V_21 , & V_23 , V_2 ) )
V_21 -> V_12 -> V_67 ( V_21 , & V_23 , V_2 ) ;
if ( V_23 . V_30 . V_31 != V_63 )
break;
}
...
continue;
case V_63 :
F_4 ( V_2 , V_4 , V_5 , V_68 ) ;
continue;
}
break;
}
switch ( V_23 . V_30 . V_31 & V_69 ) {
case V_58 :
case V_70 :
case V_71 :
F_4 ( V_2 , V_4 , V_5 , V_68 ) ;
...
F_4 ( V_2 , V_45 , - 1 , V_76 ) ;
F_22 () ;
V_56 = F_23 ( F_24 ( F_14 ( V_45 ) -> V_56 ) ) ;
F_25 ( & V_56 -> V_77 ) ;
V_56 -> V_78 ++ ;
V_56 -> V_79 += V_2 -> V_14 -> V_27 ;
F_26 ( & V_56 -> V_77 ) ;
F_27 () ;
return F_14 ( V_45 ) -> V_80 ;
}
int T_2 F_28 ( void )
{
int V_81 ;
