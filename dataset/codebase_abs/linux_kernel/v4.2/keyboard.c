...
return - V_259 ;
if ( V_257 ) {
V_249 = F_153 ( sizeof( struct V_248 ) * V_257 ,
V_231 ) ;
if ( ! V_249 )
return - V_232 ;
if ( F_157 ( V_249 , V_247 -> V_248 ,
...
int F_158 ( int V_175 , unsigned int V_261 )
{
struct V_165 * V_166 = V_173 + V_175 ;
int V_177 = 0 ;
unsigned long V_12 ;
...
int F_159 ( int V_175 , unsigned int V_261 )
{
struct V_165 * V_166 = V_173 + V_175 ;
int V_177 = 0 ;
unsigned long V_12 ;
...
int F_162 ( int V_241 , struct V_269 T_3 * V_270 ,
int V_243 )
{
struct V_269 V_271 ;
int V_272 = 0 ;
if ( F_157 ( & V_271 , V_270 , sizeof( struct V_269 ) ) )
return - V_252 ;
switch ( V_241 ) {
case V_273 :
...
int F_163 ( int V_241 , struct V_275 T_3 * V_276 , int V_243 ,
int V_175 )
{
struct V_165 * V_166 = V_173 + V_175 ;
struct V_275 V_271 ;
...
unsigned long V_12 ;
if ( F_157 ( & V_271 , V_276 , sizeof( struct V_275 ) ) )
return - V_252 ;
if ( ! F_164 ( V_279 ) )
V_243 = 0 ;
switch ( V_241 ) {
...
if ( V_287 == V_278 )
goto V_296;
if ( ( ( V_278 == V_99 ) || ( V_287 == V_99 ) ) && ! F_164 ( V_297 ) ) {
F_35 ( & V_60 , V_12 ) ;
return - V_258 ;
}
...
int F_166 ( int V_241 , struct V_298 T_3 * V_299 , int V_243 )
{
struct V_298 * V_300 ;
char * V_301 ;
T_5 * V_302 ;
...
if ( F_157 ( V_300 , V_299 , sizeof( struct V_298 ) ) ) {
V_177 = - V_252 ;
goto V_309;
}
...
int F_167 ( int V_175 , int V_241 , unsigned long V_261 , int V_243 )
{
struct V_165 * V_166 = V_173 + V_175 ;
unsigned long V_12 ;
unsigned char V_320 ;
...
int F_173 ( int V_175 , int V_326 )
{
struct V_165 * V_166 = V_173 + V_175 ;
return F_39 ( V_166 , V_326 ) ;
}
void F_174 ( int V_175 , int V_326 )
{
struct V_165 * V_166 = V_173 + V_175 ;
unsigned long V_12 ;
F_34 ( & V_60 , V_12 ) ;
...
void F_175 ( int V_175 , int V_326 )
{
struct V_165 * V_166 = V_173 + V_175 ;
unsigned long V_12 ;
F_34 ( & V_60 , V_12 ) ;
