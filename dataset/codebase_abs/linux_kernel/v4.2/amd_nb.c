...
struct V_28 * F_11 ( struct V_28 * V_29 )
{
T_3 V_30 ;
T_4 V_31 , V_32 ;
unsigned V_33 ;
...
int F_13 ( int V_45 )
{
struct V_1 * V_10 = F_7 ( F_14 ( V_45 ) ) -> V_10 ;
unsigned int V_46 ;
int V_47 ;
if ( ! F_15 ( V_24 ) )
return 0 ;
F_16 ( V_10 , 0x1d4 , & V_46 ) ;
V_47 = F_17 ( V_45 ) . V_48 ;
return ( V_46 >> ( 4 * V_47 ) ) & 0xf ;
}
int F_18 ( int V_45 , unsigned long V_46 )
{
static unsigned int V_49 , V_50 ;
struct V_7 * V_8 = F_7 ( F_14 ( V_45 ) ) ;
unsigned int V_51 ;
int V_47 ;
if ( ! F_15 ( V_24 ) || V_46 > 0xf )
return - V_52 ;
if ( V_49 == 0 ) {
