...
return - V_17 ;
V_18 = F_59 ( V_137 ) ;
V_131 = F_39 ( sizeof( struct V_111 ) * ( V_18 / V_6 ) , V_106 ) ;
if ( V_131 == NULL ) {
V_138 = - V_107 ;
break;
}
...
static int F_43 ( struct V_111 * V_209 , int V_210 )
{
int V_211 ;
unsigned long V_212 ;
...
if ( V_212 == 0 ) {
while ( V_211 -- != 0 )
F_77 ( ( unsigned long ) V_209 [ V_211 ] . V_7 ) ;
return - V_107 ;
}
V_209 [ V_211 ] . V_7 = ( unsigned char * ) V_212 ;
V_209 [ V_211 ] . V_194 = F_78 ( ( void * ) V_212 ) ;
}
return 0 ;
}
static void F_51 ( struct V_111 * V_209 , int V_210 )
{
int V_211 ;
for ( V_211 = 0 ; V_211 < V_210 ; V_211 ++ )
F_77 ( ( unsigned long ) V_209 [ V_211 ] . V_7 ) ;
}
int F_79 ( struct V_99 * V_100 , const struct V_213 * V_214 )
{
struct V_215 * V_75 ;
unsigned V_216 = V_214 ? V_214 -> V_76 : 0 ;
if ( V_216 >= V_217 )
return 0 ;
V_75 = F_80 ( V_218 , V_214 ? V_214 -> V_219 : NULL ,
F_81 ( F_82 ( V_220 ) , V_216 ) , NULL ,
L_3 , V_216 ) ;
if ( F_83 ( V_75 ) )
return 0 ;
V_100 -> V_221 = V_75 ;
...
{
F_85 ( V_218 , V_100 -> V_221 -> V_222 ) ;
}
int T_6 F_86 ( void )
{
int V_101 ;
V_218 = F_87 ( V_223 , L_4 ) ;
if ( F_83 ( V_218 ) ) {
V_101 = F_88 ( V_218 ) ;
goto V_224;
}
V_101 = F_89 ( & V_220 , 0 , V_217 , L_4 ) ;
if ( V_101 < 0 )
goto V_225;
F_90 ( & V_226 , & V_227 ) ;
V_226 . V_228 = V_223 ;
V_101 = F_91 ( & V_226 , V_220 , V_217 ) ;
if ( V_101 < 0 )
goto V_229;
return 0 ;
V_229:
