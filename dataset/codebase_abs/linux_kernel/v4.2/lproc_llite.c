...
F_30 ( V_149 , L_48 ,
V_170 . V_173 , ( unsigned long ) V_170 . V_174 ) ;
...
( V_7 -> V_190 + 1 ) % V_176 ;
V_181 = V_7 -> V_190 ;
V_148 -> V_163 [ V_181 ] . V_82 = V_82 ;
F_99 ( & V_148 -> V_163 [ V_181 ] . V_165 ) ;
F_99 ( & V_148 -> V_163 [ V_181 ] . V_167 ) ;
}
for( V_98 = 0 ; ( V_44 >= ( 1 << V_168 << V_98 ) ) &&
( V_98 < ( V_164 - 1 ) ) ; V_98 ++ ) ;
if ( V_180 == 0 ) {
V_148 -> V_163 [ V_181 ] . V_165 . V_166 [ V_98 ] ++ ;
V_148 -> V_163 [ V_176 ] . V_165 . V_166 [ V_98 ] ++ ;
} else {
V_148 -> V_163 [ V_181 ] . V_167 . V_166 [ V_98 ] ++ ;
V_148 -> V_163 [ V_176 ] . V_167 . V_166 [ V_98 ] ++ ;
}
F_19 ( & V_7 -> V_175 ) ;
F_18 ( & V_7 -> V_191 ) ;
for ( V_98 = 0 ; V_98 < V_176 ; V_98 ++ ) {
if ( V_183 [ V_98 ] . V_192 == V_82 ) {
if ( V_183 [ V_98 ] . V_193 != V_59 ) {
V_183 [ V_98 ] . V_194 = V_179 ;
V_183 [ V_98 ] . V_195 = V_179 + V_44 ;
V_183 [ V_98 ] . V_196 = V_44 ;
V_183 [ V_98 ] . V_197 = V_44 ;
V_183 [ V_98 ] . V_198 = 0 ;
V_183 [ V_98 ] . V_193 = V_59 ;
F_19 ( & V_7 -> V_191 ) ;
return;
}
if ( V_183 [ V_98 ] . V_195 != V_179 ) {
* V_185 =
( * V_185 + 1 ) % V_199 ;
V_184 [ * V_185 ] . V_200 = V_183 [ V_98 ] . V_200 ;
V_184 [ * V_185 ] . V_192 = V_82 ;
V_184 [ * V_185 ] . V_194 =
V_183 [ V_98 ] . V_194 ;
V_184 [ * V_185 ] . V_201 =
V_183 [ V_98 ] . V_195 ;
...
V_184 [ * V_185 ] . V_198 =
V_183 [ V_98 ] . V_198 ;
V_183 [ V_98 ] . V_200 = V_180 ;
V_183 [ V_98 ] . V_194 = V_179 ;
V_183 [ V_98 ] . V_196 = V_44 ;
V_183 [ V_98 ] . V_197 = V_44 ;
V_183 [ V_98 ] . V_198 = V_179 -
V_183 [ V_98 ] . V_195 ;
}
if ( V_183 [ V_98 ] . V_196 > V_44 )
V_183 [ V_98 ] . V_196 = V_44 ;
if ( V_183 [ V_98 ] . V_197 < V_44 )
V_183 [ V_98 ] . V_197 = V_44 ;
V_183 [ V_98 ] . V_195 = V_179 + V_44 ;
F_19 ( & V_7 -> V_191 ) ;
return;
...
* V_187 = ( * V_187 + 1 ) % V_176 ;
V_183 [ * V_187 ] . V_192 = V_82 ;
V_183 [ * V_187 ] . V_200 = V_180 ;
V_183 [ * V_187 ] . V_194 = V_179 ;
V_183 [ * V_187 ] . V_195 = V_179 + V_44 ;
V_183 [ * V_187 ] . V_196 = V_44 ;
V_183 [ * V_187 ] . V_197 = V_44 ;
V_183 [ * V_187 ] . V_198 = 0 ;
V_183 [ * V_187 ] . V_193 = V_59 ;
F_19 ( & V_7 -> V_191 ) ;
}
...
struct V_169 V_170 ;
struct V_6 * V_7 = V_149 -> V_34 ;
struct V_182 * V_184 = V_7 -> V_189 ;
struct V_182 * V_183 = V_7 -> V_182 ;
int V_98 ;
F_96 ( & V_170 ) ;
if ( ! V_7 -> V_172 ) {
F_30 ( V_149 , L_46
...
L_62 , L_63 , L_64 , L_65 ,
L_66 , L_67 , L_68 ) ;
for ( V_98 = 0 ; V_98 < V_199 ; V_98 ++ ) {
if ( V_184 [ V_98 ] . V_192 != 0 )
F_30 ( V_149 ,
L_69 ,
V_184 [ V_98 ] . V_200 == V_202 ? 'R' : 'W' ,
V_184 [ V_98 ] . V_192 ,
V_184 [ V_98 ] . V_194 ,
V_184 [ V_98 ] . V_201 ,
( unsigned long ) V_184 [ V_98 ] . V_196 ,
( unsigned long ) V_184 [ V_98 ] . V_197 ,
V_184 [ V_98 ] . V_198 ) ;
}
for ( V_98 = 0 ; V_98 < V_176 ; V_98 ++ ) {
if ( V_183 [ V_98 ] . V_192 != 0 )
F_30 ( V_149 ,
L_69 ,
V_183 [ V_98 ] . V_200 == V_202 ? 'R' : 'W' ,
V_183 [ V_98 ] . V_192 ,
V_183 [ V_98 ] . V_194 ,
V_183 [ V_98 ] . V_195 ,
( unsigned long ) V_183 [ V_98 ] . V_196 ,
( unsigned long ) V_183 [ V_98 ] . V_197 ,
V_183 [ V_98 ] . V_198 ) ;
}
F_19 ( & V_7 -> V_191 ) ;
return 0 ;
...
struct V_29 * V_149 = V_59 -> V_61 ;
struct V_6 * V_7 = V_149 -> V_34 ;
struct V_182 * V_203 = V_7 -> V_182 ;
struct V_182 * V_204 = V_7 -> V_189 ;
int V_177 = 1 , V_11 = 0 ;
if ( V_120 == 0 )
return - V_65 ;
V_11 = F_98 ( V_5 , V_120 , & V_177 ) ;
...
V_7 -> V_188 = 0 ;
V_7 -> V_186 = 0 ;
memset ( V_203 , 0 , sizeof( struct V_182 ) *
V_176 ) ;
memset ( V_204 , 0 , sizeof( struct V_182 ) *
V_199 ) ;
F_19 ( & V_7 -> V_191 ) ;
return V_120 ;
}
void F_105 ( struct V_205 * V_206 )
{
V_206 -> V_207 = V_140 ;
}
