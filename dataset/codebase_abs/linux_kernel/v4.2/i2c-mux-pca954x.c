...
{
struct V_1 * V_2 = F_7 ( V_4 -> V_33 . V_34 ) ;
struct V_35 * V_36 = F_8 ( & V_4 -> V_33 ) ;
...
if ( ! F_9 ( V_2 , V_45 ) )
return - V_7 ;
V_17 = F_10 ( & V_4 -> V_33 , sizeof( struct V_22 ) , V_46 ) ;
if ( ! V_17 )
return - V_47 ;
F_11 ( V_4 , V_17 ) ;
V_41 = F_12 ( & V_4 -> V_33 , L_1 , V_48 ) ;
if ( F_13 ( V_41 ) )
return F_14 ( V_41 ) ;
if ( F_15 ( V_4 , 0 ) < 0 ) {
F_16 ( & V_4 -> V_33 , L_2 ) ;
...
static int F_23 ( struct V_60 * V_33 )
{
struct V_3 * V_4 = F_24 ( V_33 ) ;
struct V_22 * V_17 = F_4 ( V_4 ) ;
V_17 -> V_30 = 0 ;
return F_15 ( V_4 , 0 ) ;
}
