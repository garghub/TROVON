...
static void F_56 ( struct V_155 * V_155 , int error )
{
F_57 ( V_155 ) ;
}
...
struct V_138 * V_138 ;
struct V_113 * V_114 ;
T_1 V_164 = V_112 -> V_123 , V_153 , V_165 , V_166 , V_56 ;
int V_167 = ( V_112 -> V_123 + V_158 [ 0 ] . V_168 +
V_169 - 1 ) >> V_170 ;
int V_156 = 0 , V_171 ;
int V_172 = ( V_161 == V_173 ) ;
* V_162 = NULL ;
F_6 ( L_65 , V_167 ) ;
F_61 (sgl, sg, sgl_nents, i) {
V_138 = F_62 ( V_114 ) ;
V_56 = V_114 -> V_168 ;
V_165 = V_114 -> V_174 ;
F_6 ( L_66 , V_153 ,
...
static T_5
F_66 ( struct V_111 * V_112 )
{
if ( V_112 -> V_136 & V_182 )
return V_183 ;
return F_67 ( V_112 , V_184 ) ;
}
static T_5
V_184 ( struct V_111 * V_112 )
{
struct V_113 * V_158 = V_112 -> V_185 ;
T_1 V_159 = V_112 -> V_186 ;
enum V_160 V_161 = V_112 -> V_161 ;
struct V_1 * V_64 = F_1 ( V_112 -> V_116 ) ;
struct V_118 * V_119 ;
struct V_187 * V_188 ;
struct V_155 * V_162 ;
T_5 V_32 ;
V_119 = F_4 ( sizeof( * V_119 ) + F_68 ( V_112 -> V_189 ) , V_9 ) ;
if ( ! V_119 ) {
return V_181 ;
}
V_112 -> V_120 = V_119 ;
memcpy ( V_119 -> V_121 , V_112 -> V_189 ,
F_68 ( V_112 -> V_189 ) ) ;
if ( ! V_158 ) {
V_188 = F_69 ( V_64 -> V_67 -> V_65 ,
( V_161 == V_173 ) ,
V_9 ) ;
if ( F_31 ( V_188 ) ) {
F_5 ( L_77 ) ;
...
F_71 ( ! V_112 -> V_123 ) ;
V_32 = F_60 ( V_112 , V_158 , V_159 , V_161 , & V_162 ) ;
if ( V_32 )
goto V_175;
V_188 = F_72 ( V_64 -> V_67 -> V_65 , V_162 ,
V_9 ) ;
if ( F_31 ( V_188 ) ) {
F_5 ( L_78 ) ;
V_32 = V_181 ;
...
V_188 -> V_191 = V_192 ;
V_188 -> V_193 = V_112 ;
V_188 -> V_194 = F_68 ( V_119 -> V_121 ) ;
V_188 -> V_112 = & V_119 -> V_121 [ 0 ] ;
V_188 -> V_195 = & V_119 -> V_134 [ 0 ] ;
V_188 -> V_196 = 0 ;
...
V_188 -> V_197 = V_199 ;
V_188 -> V_200 = V_201 ;
F_73 ( V_64 -> V_67 -> V_65 , NULL , V_188 ,
( V_112 -> V_202 == V_203 ) ,
V_192 ) ;
return 0 ;
V_190:
...
static T_6 F_75 ( struct V_2 * V_3 )
{
struct V_1 * V_64 = F_1 ( V_3 ) ;
...
{
struct V_111 * V_112 = V_188 -> V_193 ;
struct V_118 * V_119 = V_112 -> V_120 ;
V_119 -> V_122 = V_188 -> V_208 ;
V_119 -> V_209 = V_188 -> V_210 ;
V_112 -> V_211 = F_45 ( V_119 -> V_122 ) << 1 ;
if ( V_112 -> V_211 ) {
F_6 ( L_79
L_80 , V_112 , V_119 -> V_121 [ 0 ] ,
V_119 -> V_122 ) ;
}
switch ( F_77 ( V_119 -> V_122 ) ) {
case V_212 :
F_78 ( V_112 , V_112 -> V_211 ) ;
break;
default:
F_6 ( L_81
L_80 , V_112 , V_119 -> V_121 [ 0 ] ,
