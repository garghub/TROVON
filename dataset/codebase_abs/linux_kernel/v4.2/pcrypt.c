...
if ( F_40 ( V_71 ) )
return F_41 ( V_71 ) ;
V_49 = F_49 ( sizeof( * V_49 ) + sizeof( * V_20 ) , V_72 ) ;
if ( ! V_49 )
return - V_73 ;
V_20 = F_37 ( V_49 ) ;
F_50 ( & V_20 -> V_55 , F_51 ( V_49 ) ) ;
V_32 = F_52 ( & V_20 -> V_55 , V_71 , 0 , 0 ) ;
if ( V_32 )
goto V_74;
V_58 = F_53 ( & V_20 -> V_55 ) ;
V_32 = F_46 ( F_51 ( V_49 ) , & V_58 -> V_27 ) ;
if ( V_32 )
goto V_75;
V_49 -> V_58 . V_76 = F_54 ( V_58 ) ;
V_49 -> V_58 . V_77 = F_55 ( V_58 ) ;
V_49 -> V_58 . V_27 . V_78 = sizeof( struct V_19 ) ;
V_49 -> V_58 . V_79 = F_35 ;
V_49 -> V_58 . exit = F_44 ;
V_49 -> V_58 . V_80 = F_10 ;
V_49 -> V_58 . V_81 = F_13 ;
...
static int F_59 ( struct V_66 * V_67 , struct V_68 * * V_69 )
{
struct V_84 * V_85 ;
V_85 = F_60 ( V_69 ) ;
if ( F_40 ( V_85 ) )
return F_41 ( V_85 ) ;
switch ( V_85 -> type & V_85 -> V_12 & V_86 ) {
case V_87 :
return F_47 ( V_67 , V_69 , V_85 -> type , V_85 -> V_12 ) ;
}
return - V_88 ;
}
...
unsigned long V_91 , void * V_28 )
{
struct V_4 * V_5 ;
struct V_9 * V_92 , * V_93 ;
struct V_94 * V_10 = (struct V_94 * ) V_28 ;
if ( ! ( V_91 & V_95 ) )
return 0 ;
V_5 = F_64 ( V_90 , struct V_4 , V_96 ) ;
V_92 = F_65 ( sizeof( * V_92 ) , V_72 ) ;
if ( ! V_92 )
return - V_73 ;
if ( ! F_66 ( & V_92 -> V_12 , V_72 ) ) {
F_58 ( V_92 ) ;
return - V_73 ;
}
V_93 = V_5 -> V_11 ;
F_67 ( V_92 -> V_12 , V_10 -> V_97 ) ;
F_68 ( V_5 -> V_11 , V_92 ) ;
F_69 () ;
F_70 ( V_93 -> V_12 ) ;
F_58 ( V_93 ) ;
...
static int F_71 ( struct V_98 * V_14 , const char * V_71 )
{
int V_99 ;
V_14 -> V_100 . V_101 = V_102 ;
V_99 = F_72 ( & V_14 -> V_100 , NULL , V_71 ) ;
if ( ! V_99 )
...
struct V_9 * V_12 ;
F_75 () ;
V_5 -> V_104 = F_76 ( L_2 , V_105 | V_106 ,
1 , V_71 ) ;
if ( ! V_5 -> V_104 )
goto V_32;
V_5 -> V_14 = F_77 ( V_5 -> V_104 ) ;
if ( ! V_5 -> V_14 )
goto V_107;
V_12 = F_65 ( sizeof( * V_12 ) , V_72 ) ;
if ( ! V_12 )
goto V_108;
if ( ! F_66 ( & V_12 -> V_12 , V_72 ) ) {
F_58 ( V_12 ) ;
goto V_108;
}
F_78 ( V_12 -> V_12 , V_109 , V_54 ) ;
F_68 ( V_5 -> V_11 , V_12 ) ;
V_5 -> V_96 . V_110 = F_63 ;
V_99 = F_79 ( V_5 -> V_14 , & V_5 -> V_96 ) ;
if ( V_99 )
goto V_111;
V_99 = F_71 ( V_5 -> V_14 , V_71 ) ;
if ( V_99 )
goto V_112;
F_80 () ;
return V_99 ;
V_112:
F_81 ( V_5 -> V_14 , & V_5 -> V_96 ) ;
V_111:
F_70 ( V_12 -> V_12 ) ;
F_58 ( V_12 ) ;
V_108:
