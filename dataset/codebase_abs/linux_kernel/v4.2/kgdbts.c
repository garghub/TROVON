...
V_6 = ( unsigned long ) F_7 ( ( void * ) V_6 ) ;
return V_6 ;
}
static void F_8 ( char * V_10 , char * V_5 , unsigned long V_11 )
{
unsigned long V_6 ;
if ( V_5 )
V_6 = F_6 ( V_5 ) ;
...
{
F_8 ( V_14 ? L_7 : L_8 , V_5 , 0 ) ;
}
static void F_11 ( char * V_5 )
{
F_8 ( V_14 ? L_9 : L_10 , V_5 , 0 ) ;
}
...
static int F_20 ( char * V_16 , char * V_5 )
{
char * V_1 = & V_16 [ 11 ] ;
...
static int F_22 ( char * V_16 , char * V_5 )
{
unsigned long V_6 = F_6 ( V_5 ) ;
unsigned long V_18 ;
int V_19 = 0 ;
F_23 ( & V_16 [ 1 ] , ( char * ) V_20 ,
V_21 ) ;
F_24 ( V_20 , & V_22 ) ;
V_18 = F_25 ( & V_22 ) ;
F_5 ( L_15 , V_18 ) ;
...
static int F_29 ( char * V_16 , char * V_5 )
{
unsigned long V_6 = F_6 ( V_5 ) ;
static int V_27 ;
F_23 ( & V_16 [ 1 ] , ( char * ) V_20 ,
...
V_12 [ 0 ] = 'G' ;
F_31 ( V_20 , & V_22 ) ;
F_32 ( ( char * ) V_20 , & V_12 [ 1 ] , V_21 ) ;
F_9 ( V_12 ) ;
}
static void F_33 ( char * V_5 )
{
int V_34 = F_34 ( V_5 , NULL , 10 ) ;
V_35 -- ;
if ( V_35 <= 0 )
V_30 . V_31 ++ ;
else
V_30 . V_31 -= V_34 ;
F_9 ( V_30 . V_36 [ V_30 . V_31 ] . V_37 ) ;
}
...
static int F_38 ( char * V_16 , char * V_5 )
{
...
static int F_41 ( char * V_16 , char * V_5 )
{
if ( strncmp ( V_16 + 1 , V_5 , 2 ) )
return 1 ;
V_2 = 1 ;
...
strcat ( V_43 , L_36 ) ;
V_43 [ V_41 + 2 ] = F_42 ( V_40 ) ;
V_43 [ V_41 + 3 ] = F_43 ( V_40 ) ;
V_43 [ V_41 + 4 ] = '\0' ;
F_5 ( L_37 , V_30 . V_31 , V_43 ) ;
}
static int F_44 ( char * V_16 )
{
char * V_44 ;
...
static int F_45 ( int V_47 , int V_48 )
{
int V_49 = 0 ;
if ( V_47 ) {
if ( V_50 ) {
...
V_1 = strchr ( V_82 , 'F' ) ;
if ( V_1 )
V_78 = F_34 ( V_1 + 1 , NULL , 10 ) ;
V_1 = strchr ( V_82 , 'S' ) ;
if ( V_1 )
V_79 = F_34 ( V_1 + 1 , NULL , 10 ) ;
V_1 = strchr ( V_82 , 'N' ) ;
if ( V_1 )
V_71 = F_34 ( V_1 + 1 , NULL , 10 ) ;
V_1 = strchr ( V_82 , 'I' ) ;
if ( V_1 )
V_80 = F_34 ( V_1 + 1 , NULL , 10 ) ;
if ( V_83 . V_72 & V_84 ) {
V_67 = 1 ;
F_64 ( L_60 ) ;
F_52 ( 1 ) ;
...
static void F_71 ( T_3 V_48 )
{
if ( V_30 . V_58 )
V_30 . V_58 ( 0 , V_48 ) ;
}
static int F_72 ( const char * V_94 , struct V_95 * V_96 )
{
