...
break;
case V_23 :
V_4 = F_5 ( & V_16 -> V_18 . V_24 ) ;
V_5 = F_5 ( & V_16 -> V_18 . V_25 ) ;
V_18 . V_24 = F_7 ( V_4 ) ;
V_18 . V_25 = F_7 ( V_5 ) ;
F_8 ( V_16 , V_22 , 1 ,
& V_18 , sizeof( V_18 ) ) ;
...
T_2 F_9 ( struct V_1 * V_2 , char * V_3 ,
T_3 V_26 )
{
struct V_15 * V_16 = F_10 ( V_2 ) ;
T_1 V_27 , V_28 , V_29 = 0 , V_30 = 0 ;
bool V_13 ;
V_27 = ( unsigned int ) F_5 ( & V_16 -> V_18 . V_24 ) ;
V_28 = ( unsigned int ) F_5 ( & V_16 -> V_18 . V_25 ) ;
...
F_13 ( & V_16 -> V_18 . V_24 , V_29 ) ;
F_13 ( & V_16 -> V_18 . V_25 , V_30 ) ;
F_4 ( V_16 ) ;
V_31:
return V_26 ;
}
