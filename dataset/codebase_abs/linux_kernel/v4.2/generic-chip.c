...
static void
F_20 ( struct V_3 * V_4 , const char * V_20 ,
...
int F_32 ( struct V_38 * V_2 , unsigned int V_63 ,
T_4 V_61 )
{
struct V_1 * V_64 = F_33 ( V_2 , V_63 ) ;
struct V_43 * V_44 = V_2 -> V_4 ;
struct V_3 * V_4 ;
struct V_5 * V_6 ;
struct V_65 * V_27 ;
...
V_4 = V_44 -> V_4 [ V_62 ] ;
V_62 = V_61 % V_44 -> V_39 ;
if ( F_34 ( V_62 , & V_4 -> V_67 ) )
return - V_68 ;
if ( F_34 ( V_62 , & V_4 -> V_69 ) )
return - V_47 ;
V_6 = V_4 -> V_26 ;
V_27 = & V_6 -> V_27 ;
if ( ! V_4 -> V_69 ) {
...
V_64 -> V_7 = 1 << V_62 ;
F_37 ( V_2 , V_63 , V_61 , V_27 , V_4 , V_6 -> V_24 , NULL , NULL ) ;
F_38 ( V_63 , V_44 -> V_52 , V_44 -> V_51 ) ;
return 0 ;
}
void F_39 ( struct V_3 * V_4 , T_1 V_73 ,
enum V_30 V_31 , unsigned int V_40 ,
unsigned int V_41 )
{
struct V_5 * V_6 = V_4 -> V_26 ;
struct V_65 * V_27 = & V_6 -> V_27 ;
unsigned int V_34 ;
F_40 ( & V_58 ) ;
F_29 ( & V_4 -> V_59 , & V_60 ) ;
F_41 ( & V_58 ) ;
F_24 ( V_4 , V_31 ) ;
for ( V_34 = V_4 -> V_22 ; V_73 ; V_73 >>= 1 , V_34 ++ ) {
if ( ! ( V_73 & 0x01 ) )
continue;
if ( V_31 & V_70 )
F_36 ( V_34 , & V_71 ) ;
if ( ! ( V_31 & V_74 ) ) {
struct V_1 * V_2 = F_42 ( V_34 ) ;
if ( V_27 -> V_72 )
V_27 -> V_72 ( V_2 ) ;
else
V_2 -> V_7 = 1 << ( V_34 - V_4 -> V_22 ) ;
}
F_43 ( V_34 , V_27 , V_6 -> V_24 ) ;
F_44 ( V_34 , V_4 ) ;
F_38 ( V_34 , V_40 , V_41 ) ;
}
V_4 -> V_75 = V_34 - V_4 -> V_22 ;
}
int F_45 ( struct V_1 * V_2 , unsigned int type )
{
struct V_3 * V_4 = F_3 ( V_2 ) ;
struct V_5 * V_6 = V_4 -> V_26 ;
unsigned int V_34 ;
...
if ( V_6 -> type & type ) {
V_2 -> V_27 = & V_6 -> V_27 ;
F_46 ( V_2 ) -> V_76 = V_6 -> V_24 ;
return 0 ;
}
}
return - V_16 ;
}
void F_47 ( struct V_3 * V_4 , T_1 V_73 ,
unsigned int V_40 , unsigned int V_41 )
{
...
static struct V_1 * F_51 ( struct V_3 * V_4 )
{
unsigned int V_63 ;
if ( ! V_4 -> V_54 )
return F_42 ( V_4 -> V_22 ) ;
if ( ! V_4 -> V_69 )
return NULL ;
V_63 = F_52 ( V_4 -> V_54 , V_4 -> V_22 + F_53 ( V_4 -> V_69 ) ) ;
return V_63 ? F_42 ( V_63 ) : NULL ;
}
static int F_54 ( void )
{
struct V_3 * V_4 ;
F_55 (gc, &gc_list, list) {
struct V_5 * V_6 = V_4 -> V_26 ;
if ( V_6 -> V_27 . V_78 ) {
struct V_1 * V_64 = F_51 ( V_4 ) ;
if ( V_64 )
V_6 -> V_27 . V_78 ( V_64 ) ;
}
}
