...
F_5 ( V_6 -> V_7 , V_1 , V_2 / 128 ) ;
V_4 -- ;
}
return V_3 - V_4 ;
}
static void F_6 ( int V_1 , int V_2 , int V_3 )
{
char * V_8 ;
do {
V_8 = F_7 ( V_1 ) ;
...
static int F_10 ( int V_1 , int V_2 , int V_3 )
{
char * V_8 ;
char * V_9 ;
int V_4 = V_3 ;
while ( V_4 ) {
V_8 = F_11 ( V_2 + 256 , V_10 ) ;
if ( F_3 ( V_8 == NULL ) ) {
F_9 ( L_3 ,
V_3 * V_2 , V_1 ) ;
break;
...
static void F_12 ( int V_1 , int V_2 , int V_3 )
{
char * V_8 ;
char * V_9 ;
do {
...
void F_17 ( int V_1 , int V_2 , int V_3 )
{
if ( V_1 == V_11 )
F_6 ( V_1 , V_2 , V_3 ) ;
else
