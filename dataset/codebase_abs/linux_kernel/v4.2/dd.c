...
static int F_56 ( struct V_29 * V_30 , void * V_51 )
{
...
if ( V_54 )
V_53 -> V_55 = true ;
if ( V_53 -> V_56 && V_54 != V_53 -> V_57 )
return 0 ;
return F_50 ( V_30 , V_4 ) ;
}
static void F_58 ( void * V_58 , T_1 V_59 )
{
struct V_3 * V_4 = V_58 ;
struct V_52 V_53 = {
. V_4 = V_4 ,
...
F_59 ( V_4 ) ;
F_60 ( V_4 -> V_24 , NULL , & V_53 , F_56 ) ;
F_12 ( V_4 , L_16 ) ;
F_53 ( V_4 ) ;
F_61 ( V_4 ) ;
F_14 ( V_4 ) ;
}
static int F_62 ( struct V_3 * V_4 , bool V_60 )
{
int V_27 = 0 ;
F_59 ( V_4 ) ;
if ( V_4 -> V_21 ) {
...
V_27 = F_60 ( V_4 -> V_24 , NULL , & V_53 ,
F_56 ) ;
if ( ! V_27 && V_60 && V_53 . V_55 ) {
F_12 ( V_4 , L_17 ) ;
F_7 ( V_4 ) ;
F_63 ( F_58 , V_4 ) ;
} else {
...
static int F_66 ( struct V_3 * V_4 , void * V_53 )
{
...
{
return F_68 ( V_30 -> V_24 , NULL , V_30 , F_66 ) ;
}
...
struct V_3 * V_4 ;
for (; ; ) {
F_75 ( & V_30 -> V_9 -> V_23 . V_66 ) ;
if ( F_3 ( & V_30 -> V_9 -> V_23 . V_67 ) ) {
F_76 ( & V_30 -> V_9 -> V_23 . V_66 ) ;
break;
}
V_65 = F_77 ( V_30 -> V_9 -> V_23 . V_67 . V_68 ,
struct V_5 ,
V_17 . V_69 ) ;
V_4 = V_65 -> V_3 ;
F_7 ( V_4 ) ;
