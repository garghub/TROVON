...
F_96 ( V_33 , V_326 ) ;
F_92 ( V_327 != 0 ) ;
F_101 ( V_33 , V_328 , type ) ;
F_101 ( V_33 , V_329 , V_325 ) ;
return F_65 ( V_2 , V_330 , V_33 , sizeof( V_33 ) ,
NULL , 0 , NULL ) ;
}
int F_135 ( struct V_1 * V_2 , unsigned int * V_331 ,
unsigned int * V_332 )
{
F_96 ( V_106 , V_333 ) ;
T_2 V_109 ;
int V_6 ;
V_6 = F_65 ( V_2 , V_334 , NULL , 0 ,
V_106 , sizeof( V_106 ) , & V_109 ) ;
if ( V_6 )
goto V_9;
if ( V_109 < V_333 ) {
...
if ( V_331 )
* V_331 = F_76 ( V_106 , V_335 ) ;
if ( V_332 )
* V_332 = F_76 ( V_106 , V_336 ) ;
return 0 ;
V_9:
F_13 ( V_2 , V_58 , V_2 -> V_27 , L_27 , V_188 , V_6 ) ;
return V_6 ;
...
F_96 ( V_33 , V_337 ) ;
int V_6 ;
F_101 ( V_33 , V_338 , type ) ;
F_92 ( V_339 != 0 ) ;
V_6 = F_65 ( V_2 , V_340 , V_33 , sizeof( V_33 ) ,
NULL , 0 , NULL ) ;
return V_6 ;
}
static int F_137 ( struct V_1 * V_2 , unsigned int type ,
T_10 V_179 , T_8 * V_341 , T_2 V_342 )
{
F_96 ( V_33 , V_343 ) ;
F_96 ( V_106 ,
F_138 ( V_344 ) ) ;
T_2 V_109 ;
int V_6 ;
F_101 ( V_33 , V_345 , type ) ;
F_101 ( V_33 , V_346 , V_179 ) ;
F_101 ( V_33 , V_347 , V_342 ) ;
V_6 = F_65 ( V_2 , V_348 , V_33 , sizeof( V_33 ) ,
V_106 , sizeof( V_106 ) , & V_109 ) ;
if ( V_6 )
return V_6 ;
memcpy ( V_341 , F_97 ( V_106 , V_349 ) , V_342 ) ;
return 0 ;
}
static int F_139 ( struct V_1 * V_2 , unsigned int type ,
T_10 V_179 , const T_8 * V_341 , T_2 V_342 )
{
F_96 ( V_33 ,
F_140 ( V_344 ) ) ;
int V_6 ;
F_101 ( V_33 , V_350 , type ) ;
F_101 ( V_33 , V_351 , V_179 ) ;
F_101 ( V_33 , V_352 , V_342 ) ;
memcpy ( F_97 ( V_33 , V_353 ) , V_341 , V_342 ) ;
F_92 ( V_354 != 0 ) ;
V_6 = F_65 ( V_2 , V_355 , V_33 ,
F_69 ( F_140 ( V_342 ) , 4 ) ,
NULL , 0 , NULL ) ;
return V_6 ;
}
static int F_141 ( struct V_1 * V_2 , unsigned int type ,
T_10 V_179 , T_2 V_342 )
{
F_96 ( V_33 , V_356 ) ;
int V_6 ;
F_101 ( V_33 , V_357 , type ) ;
F_101 ( V_33 , V_358 , V_179 ) ;
F_101 ( V_33 , V_359 , V_342 ) ;
F_92 ( V_360 != 0 ) ;
V_6 = F_65 ( V_2 , V_361 , V_33 , sizeof( V_33 ) ,
NULL , 0 , NULL ) ;
return V_6 ;
}
...
F_96 ( V_33 , V_362 ) ;
int V_6 ;
F_101 ( V_33 , V_363 , type ) ;
F_92 ( V_364 != 0 ) ;
V_6 = F_65 ( V_2 , V_365 , V_33 , sizeof( V_33 ) ,
NULL , 0 , NULL ) ;
return V_6 ;
}
int F_143 ( struct V_366 * V_367 , T_10 V_368 ,
T_2 V_175 , T_2 * V_369 , T_8 * V_341 )
{
struct V_370 * V_371 = F_144 ( V_367 ) ;
struct V_1 * V_2 = V_367 -> V_372 ;
T_10 V_179 = V_368 ;
T_10 V_373 = F_145 ( T_10 , V_368 + V_175 , V_367 -> V_374 ) ;
T_2 V_375 ;
int V_6 = 0 ;
while ( V_179 < V_373 ) {
V_375 = F_145 ( T_2 , V_373 - V_179 , V_344 ) ;
V_6 = F_137 ( V_2 , V_371 -> V_376 , V_179 ,
V_341 , V_375 ) ;
if ( V_6 )
goto V_377;
V_179 += V_375 ;
...
int F_146 ( struct V_366 * V_367 , T_10 V_368 , T_2 V_175 )
{
struct V_370 * V_371 = F_144 ( V_367 ) ;
struct V_1 * V_2 = V_367 -> V_372 ;
T_10 V_179 = V_368 & ~ ( ( T_10 ) ( V_367 -> V_378 - 1 ) ) ;
T_10 V_373 = F_145 ( T_10 , V_368 + V_175 , V_367 -> V_374 ) ;
T_2 V_375 = V_371 -> V_379 . V_367 . V_378 ;
int V_6 = 0 ;
if ( ! V_371 -> V_380 ) {
V_6 = F_136 ( V_2 , V_371 -> V_376 ) ;
if ( V_6 )
goto V_377;
V_371 -> V_380 = true ;
}
while ( V_179 < V_373 ) {
V_6 = F_141 ( V_2 , V_371 -> V_376 , V_179 ,
V_375 ) ;
if ( V_6 )
goto V_377;
V_179 += V_375 ;
...
int F_147 ( struct V_366 * V_367 , T_10 V_368 ,
T_2 V_175 , T_2 * V_369 , const T_8 * V_341 )
{
struct V_370 * V_371 = F_144 ( V_367 ) ;
struct V_1 * V_2 = V_367 -> V_372 ;
T_10 V_179 = V_368 ;
...
while ( V_179 < V_373 ) {
V_375 = F_145 ( T_2 , V_373 - V_179 , V_344 ) ;
V_6 = F_139 ( V_2 , V_371 -> V_376 , V_179 ,
V_341 , V_375 ) ;
if ( V_6 )
goto V_377;
V_179 += V_375 ;
...
if ( V_371 -> V_380 ) {
V_371 -> V_380 = false ;
V_6 = F_142 ( V_2 , V_371 -> V_376 ) ;
}
return V_6 ;
}
void F_149 ( struct V_381 * V_371 )
{
struct V_370 * V_382 =
F_150 ( V_371 , struct V_370 , V_379 ) ;
struct V_1 * V_2 = V_371 -> V_367 . V_372 ;
snprintf ( V_371 -> T_4 , sizeof( V_371 -> T_4 ) , L_37 ,
V_2 -> T_4 , V_371 -> V_383 , V_382 -> V_384 ) ;
}
