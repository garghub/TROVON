...
static void F_89 ( struct V_336 * V_337 )
{
struct V_8 * V_9 = F_90 ( V_337 , struct V_8 , V_338 ) ;
struct V_1 * V_2 = V_9 -> V_2 ;
F_75 ( & V_9 -> V_339 ) ;
F_75 ( & V_2 -> V_186 ) ;
F_58 ( 1 , V_157 , & V_2 -> V_61 ,
...
if ( V_9 -> V_50 . V_87 )
return 0 ;
V_9 -> V_50 . V_60 = F_95 ( V_97 -> V_182 * 2 ) ;
V_9 -> V_50 . V_87 = F_96 (
...
return;
F_97 ( & V_9 -> V_2 -> V_342 -> V_2 , V_9 -> V_50 . V_60 ,
V_9 -> V_50 . V_87 , V_9 -> V_50 . V_22 ) ;
V_9 -> V_50 . V_87 = NULL ;
F_91 ( & V_9 -> V_45 , NULL , 0 ) ;
}
...
L_37 ,
F_26 ( V_9 ) ) ;
F_102 ( V_9 -> V_2 -> V_62 , V_9 -> V_68 . V_69 ) ;
return - V_360 ;
}
if ( ! V_9 -> V_389 ) {
int V_35 = F_99 ( V_9 ) ;
...
F_86 ( V_301 , 0 , V_403 ) ;
F_88 ( V_9 , V_301 , V_9 -> V_421 [ V_345 ] ?
V_73 : V_81 ) ;
F_58 ( 1 , V_157 , & V_2 -> V_61 ,
L_49 ,
V_301 -> V_57 . V_58 ,
...
T_7 F_111 ( int V_425 , void * V_163 )
{
