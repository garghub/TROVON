...
int F_172 ( struct V_57 * V_202 , struct V_57 * V_203 )
{
struct V_1 * V_4 = F_70 ( F_79 ( V_202 ) ) ;
if ( F_71 ( V_4 ) )
return F_72 ( V_4 ) ;
V_203 -> V_62 = V_4 ;
return 0 ;
...
T_1 V_204 = V_32 ( V_47 ) ;
if ( V_54 -> V_10 & V_51 )
F_35 ( V_54 , & V_204 , V_46 ) ;
else
F_35 ( V_54 , & V_204 , V_44 ) ;
}
F_22 ( & V_54 -> V_41 , 1 ) ;
return V_54 ;
}
bool F_175 ( struct V_1 * V_205 , struct V_1 * V_206 )
{
if ( ! V_205 || ! V_206 )
return false ;
if ( V_205 -> V_8 != V_206 -> V_8 )
return false ;
if ( V_205 -> V_10 != V_206 -> V_10 )
return false ;
if ( F_3 ( V_205 ) )
if ( ! F_36 ( V_205 -> V_30 . V_31 , V_206 -> V_30 . V_31 ) )
return false ;
switch ( V_205 -> V_8 ) {
case V_126 :
case V_125 :
return ! ! F_36 ( V_205 -> V_18 . V_16 , V_206 -> V_18 . V_16 ) ;
case V_27 :
return V_205 -> V_18 . V_20 == V_206 -> V_18 . V_20 ;
default:
F_29 () ;
return false ;
}
...
static struct V_207 *
F_176 ( struct V_208 * V_209 , unsigned long V_87 , unsigned long V_65 )
{
struct V_210 * V_211 = V_209 -> V_212 . V_210 ;
while ( V_211 ) {
struct V_207 * V_3 = F_177 ( V_211 , struct V_207 , V_178 ) ;
if ( V_87 >= V_3 -> V_65 )
V_211 = V_211 -> V_213 ;
...
return NULL ;
for (; ; ) {
struct V_207 * V_30 = NULL ;
struct V_210 * V_95 = F_178 ( V_211 ) ;
if ( ! V_95 )
break;
V_30 = F_177 ( V_95 , struct V_207 , V_178 ) ;
if ( V_30 -> V_65 <= V_87 )
break;
V_211 = V_95 ;
}
return F_177 ( V_211 , struct V_207 , V_178 ) ;
}
static void F_179 ( struct V_208 * V_209 , struct V_207 * V_54 )
{
struct V_210 * * V_3 = & V_209 -> V_212 . V_210 ;
struct V_210 * V_215 = NULL ;
struct V_207 * V_178 ;
while ( * V_3 ) {
V_215 = * V_3 ;
V_178 = F_177 ( V_215 , struct V_207 , V_178 ) ;
...
F_180 ( & V_54 -> V_178 , V_215 , V_3 ) ;
F_181 ( & V_54 -> V_178 , & V_209 -> V_212 ) ;
F_18 ( L_4 , V_54 -> V_87 , V_54 -> V_65 ,
V_54 -> V_34 ? V_54 -> V_34 -> V_8 : 0 ) ;
}
struct V_1 *
F_182 ( struct V_208 * V_209 , unsigned long V_216 )
{
struct V_1 * V_4 = NULL ;
struct V_207 * V_217 ;
if ( ! V_209 -> V_212 . V_210 )
return NULL ;
F_183 ( & V_209 -> V_218 ) ;
V_217 = F_176 ( V_209 , V_216 , V_216 + 1 ) ;
if ( V_217 ) {
F_135 ( V_217 -> V_34 ) ;
V_4 = V_217 -> V_34 ;
}
...
static void F_184 ( struct V_207 * V_211 )
{
F_73 ( V_211 -> V_34 ) ;
F_25 ( V_219 , V_211 ) ;
}
...
if ( V_4 -> V_10 & V_225 ) {
V_223 = V_222 ;
if ( ! F_188 ( V_47 , V_68 , V_220 , V_221 ) )
goto V_123;
}
if ( V_220 != V_223 )
V_12 = V_223 ;
...
static void F_189 ( struct V_208 * V_209 , struct V_207 * V_211 )
{
F_18 ( L_5 , V_211 -> V_87 , V_211 -> V_65 ) ;
F_190 ( & V_211 -> V_178 , & V_209 -> V_212 ) ;
F_184 ( V_211 ) ;
}
static void F_191 ( struct V_207 * V_5 , unsigned long V_87 ,
...
static struct V_207 * F_192 ( unsigned long V_87 , unsigned long V_65 ,
struct V_1 * V_4 )
{
struct V_207 * V_211 ;
struct V_1 * V_226 ;
V_211 = F_21 ( V_219 , V_39 ) ;
if ( ! V_211 )
return NULL ;
V_226 = F_70 ( V_4 ) ;
if ( F_71 ( V_226 ) ) {
...
V_226 -> V_10 |= V_227 ;
F_191 ( V_211 , V_87 , V_65 , V_226 ) ;
return V_211 ;
}
static int F_193 ( struct V_208 * V_209 , unsigned long V_87 ,
unsigned long V_65 , struct V_207 * V_54 )
{
struct V_207 * V_211 ;
struct V_207 * V_228 = NULL ;
struct V_1 * F_17 = NULL ;
int V_12 = 0 ;
V_229:
F_183 ( & V_209 -> V_218 ) ;
V_211 = F_176 ( V_209 , V_87 , V_65 ) ;
while ( V_211 && V_211 -> V_87 < V_65 ) {
struct V_210 * V_114 = F_194 ( & V_211 -> V_178 ) ;
if ( V_211 -> V_87 >= V_87 ) {
if ( V_211 -> V_65 <= V_65 )
F_189 ( V_209 , V_211 ) ;
else
...
* F_17 = * V_211 -> V_34 ;
F_22 ( & F_17 -> V_41 , 1 ) ;
F_191 ( V_228 , V_65 , V_211 -> V_65 , F_17 ) ;
V_211 -> V_65 = V_87 ;
F_179 ( V_209 , V_228 ) ;
V_228 = NULL ;
F_17 = NULL ;
...
if ( ! V_114 )
break;
V_211 = F_177 ( V_114 , struct V_207 , V_178 ) ;
}
if ( V_54 )
F_179 ( V_209 , V_54 ) ;
F_61 ( & V_209 -> V_218 ) ;
...
void F_195 ( struct V_208 * V_209 , struct V_1 * V_191 )
{
int V_12 ;
V_209 -> V_212 = V_231 ;
F_196 ( & V_209 -> V_218 ) ;
...
if ( V_12 )
goto V_235;
memset ( & V_232 , 0 , sizeof( struct V_57 ) ) ;
V_232 . V_89 = V_236 ;
F_197 ( V_209 , & V_232 , V_54 ) ;
V_235:
F_73 ( V_54 ) ;
V_234:
F_86 ( V_124 ) ;
...
int F_197 ( struct V_208 * V_237 ,
struct V_57 * V_58 , struct V_1 * V_238 )
{
int V_106 ;
struct V_207 * V_54 = NULL ;
unsigned long V_239 = F_198 ( V_58 ) ;
F_18 ( L_6 ,
V_58 -> V_108 ,
V_239 , V_238 ? V_238 -> V_8 : - 1 ,
V_238 ? V_238 -> V_10 : - 1 ,
V_238 ? F_19 ( V_238 -> V_18 . V_16 ) [ 0 ] : V_6 ) ;
if ( V_238 ) {
V_54 = F_192 ( V_58 -> V_108 , V_58 -> V_108 + V_239 , V_238 ) ;
if ( ! V_54 )
return - V_40 ;
}
V_106 = F_193 ( V_237 , V_58 -> V_108 , V_58 -> V_108 + V_239 , V_54 ) ;
if ( V_106 && V_54 )
F_184 ( V_54 ) ;
return V_106 ;
}
void F_199 ( struct V_208 * V_3 )
{
struct V_207 * V_211 ;
struct V_210 * V_114 ;
if ( ! V_3 -> V_212 . V_210 )
return;
F_183 ( & V_3 -> V_218 ) ;
V_114 = F_200 ( & V_3 -> V_212 ) ;
while ( V_114 ) {
V_211 = F_177 ( V_114 , struct V_207 , V_178 ) ;
V_114 = F_194 ( & V_211 -> V_178 ) ;
F_189 ( V_3 , V_211 ) ;
}
F_61 ( & V_3 -> V_218 ) ;
}
...
static int T_8 F_205 ( char * V_243 )
{
int V_12 = 0 ;
if ( ! V_243 )
goto V_123;
...
F_88 ( F_146 ) ;
F_211 (nid, N_MEMORY) {
unsigned long V_247 = F_212 ( V_72 ) ;
if ( V_244 < V_247 ) {
V_244 = V_247 ;
V_245 = V_72 ;
}
if ( ( V_247 << V_119 ) >= ( 16 << 20 ) )
F_89 ( V_72 , F_146 ) ;
}
if ( F_141 ( F_9 ( F_146 ) ) )
F_89 ( V_245 , F_146 ) ;
...
int F_215 ( char * V_243 , struct V_1 * * V_191 )
{
struct V_1 * V_54 = NULL ;
unsigned short V_8 ;
unsigned short V_151 ;
T_1 V_16 ;
char * V_249 = strchr ( V_243 , ':' ) ;
char * V_10 = strchr ( V_243 , '=' ) ;
int V_106 = 1 ;
if ( V_249 ) {
* V_249 ++ = '\0' ;
if ( F_216 ( V_249 , V_16 ) )
...
void F_218 ( char * V_253 , int V_254 , struct V_1 * V_4 )
{
char * V_3 = V_253 ;
T_1 V_16 = V_255 ;
unsigned short V_8 = V_35 ;
unsigned short V_10 = 0 ;
if ( V_4 && V_4 != & V_9 && ! ( V_4 -> V_10 & V_225 ) ) {
V_8 = V_4 -> V_8 ;
V_10 = V_4 -> V_10 ;
}
switch ( V_8 ) {
...
default:
F_124 ( 1 ) ;
snprintf ( V_3 , V_254 , L_20 ) ;
return;
}
V_3 += snprintf ( V_3 , V_254 , L_21 , V_251 [ V_8 ] ) ;
if ( V_10 & V_11 ) {
V_3 += snprintf ( V_3 , V_253 + V_254 - V_3 , L_22 ) ;
if ( V_10 & V_36 )
V_3 += snprintf ( V_3 , V_253 + V_254 - V_3 , L_18 ) ;
else if ( V_10 & V_28 )
V_3 += snprintf ( V_3 , V_253 + V_254 - V_3 , L_19 ) ;
}
if ( ! F_9 ( V_16 ) )
V_3 += F_219 ( V_3 , V_253 + V_254 - V_3 , L_23 ,
F_220 ( & V_16 ) ) ;
}
