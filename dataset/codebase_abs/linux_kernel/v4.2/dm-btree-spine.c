...
static void F_33 ( void * V_45 , const void * V_46 )
{
struct V_47 * V_28 = V_45 ;
V_20 V_48 ;
memcpy ( & V_48 , V_46 , sizeof( V_48 ) ) ;
F_34 ( V_28 , F_9 ( V_48 ) ) ;
}
static void F_35 ( void * V_45 , const void * V_46 )
{
struct V_47 * V_28 = V_45 ;
V_20 V_48 ;
memcpy ( & V_48 , V_46 , sizeof( V_48 ) ) ;
...
static int F_37 ( void * V_45 , const void * V_49 , const void * V_50 )
{
V_20 V_51 , V_52 ;
memcpy ( & V_51 , V_49 , sizeof( V_51 ) ) ;
memcpy ( & V_52 , V_50 , sizeof( V_52 ) ) ;
return V_51 == V_52 ;
}
void F_38 ( struct V_47 * V_28 ,
struct V_31 * V_32 )
{
V_32 -> V_45 = V_28 ;
V_32 -> V_53 = sizeof( V_20 ) ;
V_32 -> V_34 = F_33 ;
V_32 -> V_54 = F_35 ;
V_32 -> V_55 = F_37 ;
}
