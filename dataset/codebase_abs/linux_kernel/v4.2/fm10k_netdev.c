...
V_96 < V_98 ;
V_96 = F_89 ( V_17 , V_96 ) ) {
V_43 -> V_45 . V_99 . V_102 ( V_43 , V_48 , V_111 , V_96 , V_115 ) ;
}
return 0 ;
}
...
static void F_101 ( struct V_61 * V_4 )
{
struct V_16 * V_17 = F_41 ( V_4 ) ;
struct V_42 * V_43 = & V_17 -> V_43 ;
int V_125 ;
...
if ( V_125 != V_126 ) {
F_102 ( V_21 , F_94 , F_95 ) ;
if ( V_125 != V_128 )
F_103 ( V_21 , F_99 , F_100 ) ;
}
F_86 ( V_17 ) ;
V_17 -> V_125 = V_125 ;
F_37 ( V_17 ) ;
...
static struct V_140 * F_106 ( struct V_61 * V_21 ,
struct V_140 * V_141 )
{
struct V_16 * V_17 = F_41 ( V_21 ) ;
struct V_1 * V_29 ;
...
F_107 () ;
for ( V_18 = 0 ; V_18 < V_17 -> V_27 ; V_18 ++ ) {
V_29 = F_108 ( V_17 -> V_23 [ V_18 ] ) ;
if ( ! V_29 )
continue;
do {
V_142 = F_109 ( & V_29 -> V_10 ) ;
V_144 = V_29 -> V_141 . V_144 ;
V_143 = V_29 -> V_141 . V_143 ;
} while ( F_110 ( & V_29 -> V_10 , V_142 ) );
V_141 -> V_145 += V_144 ;
V_141 -> V_146 += V_143 ;
}
for ( V_18 = 0 ; V_18 < V_17 -> V_19 ; V_18 ++ ) {
V_29 = F_108 ( V_17 -> V_2 [ V_18 ] ) ;
if ( ! V_29 )
continue;
do {
V_142 = F_109 ( & V_29 -> V_10 ) ;
...
int F_112 ( struct V_61 * V_4 , T_9 V_150 )
{
struct V_16 * V_17 = F_41 ( V_4 ) ;
...
static int F_120 ( struct V_61 * V_21 , struct V_152 * V_153 , int V_154 )
{
switch ( V_154 ) {
case V_155 :
return F_121 ( V_21 , V_153 ) ;
case V_156 :
...
for ( V_18 = 0 ; V_18 < V_17 -> V_27 ; V_18 ++ ) {
V_29 = V_17 -> V_23 [ V_18 ] ;
F_124 ( V_29 -> V_159 , V_159 ) ;
}
V_17 -> V_159 = V_159 ;
}
static void * F_125 ( struct V_61 * V_4 ,
struct V_61 * V_160 )
{
struct V_16 * V_17 = F_41 ( V_4 ) ;
...
if ( V_17 -> V_50 < 7 )
return F_126 ( - V_164 ) ;
V_5 = F_127 ( struct V_158 , V_165 [ 7 ] ) ;
V_159 = F_128 ( V_5 , V_14 ) ;
if ( ! V_159 )
return F_126 ( - V_15 ) ;
V_159 -> V_5 = 7 ;
...
V_163 . V_168 = V_169 ;
V_163 . V_170 = 1 ;
V_163 . V_171 = F_130 ( V_17 -> V_172 [ V_173 ] . V_44 ) ;
V_163 . V_174 = F_130 ( V_17 -> V_172 [ V_175 ] . V_44 ) ;
V_163 . V_48 = V_17 -> V_48 ;
V_163 . V_176 = F_130 ( V_159 -> V_5 ) ;
...
static void F_131 ( struct V_61 * V_4 , void * V_178 )
{
struct V_16 * V_17 = F_41 ( V_4 ) ;
struct V_158 * V_159 = F_108 ( V_17 -> V_159 ) ;
struct V_162 V_163 = { 0 } ;
struct V_42 * V_43 = & V_17 -> V_43 ;
...
static T_10 F_132 ( struct V_68 * V_30 ,
struct V_61 * V_4 ,
T_10 V_137 )
{
if ( ! V_30 -> V_179 || F_133 ( V_30 ) )
return V_137 ;
return V_137 & ~ ( V_180 | V_181 ) ;
}
struct V_61 * F_134 ( void )
{
struct V_16 * V_17 ;
struct V_61 * V_4 ;
V_4 = F_135 ( sizeof( struct V_16 ) , V_182 ) ;
if ( ! V_4 )
return NULL ;
V_4 -> V_183 = & V_184 ;
F_136 ( V_4 ) ;
