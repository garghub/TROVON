...
{
struct V_57 * V_58 = F_65 ( V_97 ) ;
struct V_1 * V_2 ;
struct V_25 * V_26 ;
const struct V_51 * V_52 ;
V_52 = F_66 ( V_98 , & V_58 -> V_29 ) ;
if ( ! V_52 || ! V_52 -> V_60 )
return 0 ;
...
return 0 ;
if ( V_2 -> V_8 &&
V_2 -> V_37 < V_2 -> V_5 -> V_6 + V_99 ) {
F_67 ( & V_58 -> V_29 , L_11 ) ;
return 0 ;
}
switch ( V_96 ) {
case V_100 :
V_58 -> V_29 . V_101 = & V_102 ;
if ( V_2 -> V_5 -> V_42 & V_103 )
return F_68 ( & V_58 -> V_29 . V_104 ,
& V_105 ) ;
break;
case V_106 :
if ( V_2 -> V_5 -> V_42 & V_103 )
F_69 ( & V_58 -> V_29 . V_104 , & V_105 ) ;
V_58 -> V_29 . V_101 = NULL ;
break;
default:
break;
}
...
{
struct V_1 * V_2 = F_42 ( F_47 ( V_29 ) ) ;
if ( ! V_2 || ! V_2 -> V_8 || ! ( V_2 -> V_5 -> V_42 & V_103 ) )
return;
if ( V_2 -> V_37 >= V_2 -> V_5 -> V_6 + V_99 )
V_29 -> V_69 . V_107 = F_46 ;
else
F_67 ( V_29 , L_11 ) ;
}
static void F_71 ( struct V_68 * V_29 )
{
V_29 -> V_69 . V_107 = NULL ;
}
void T_5 F_72 ( void )
{
if ( ! F_73 () ) {
