...
void F_62 ( struct V_1 * V_7 , T_2 V_26 , int V_61 ,
...
F_46 ( V_69 ) ;
F_66 ( L_6 ,
F_67 ( V_69 ) , V_69 -> V_60 , F_71 ( V_69 -> V_9 -> V_59 ) ,
F_71 ( F_16 ( V_69 -> V_9 , V_78 ) ) ,
F_71 ( F_16 ( V_69 -> V_9 , V_79 ) ) ) ;
F_10 ( V_69 ) ;
F_2 () ;
F_37 (p)
if ( V_7 -> V_9 == V_9 && ! F_72 ( V_7 , V_69 ) &&
! ( V_7 -> V_14 & V_15 ) ) {
...
F_67 ( V_7 ) , V_7 -> V_60 ) ;
F_10 ( V_7 ) ;
F_73 ( V_80 , V_81 , V_7 , true ) ;
}
F_6 () ;
F_73 ( V_80 , V_81 , V_69 , true ) ;
F_64 ( V_69 ) ;
}
void F_74 ( enum V_24 V_82 , T_2 V_26 ,
...
{
return F_77 ( & V_86 , V_85 ) ;
}
int F_78 ( struct V_84 * V_85 )
{
return F_79 ( & V_86 , V_85 ) ;
}
bool F_80 ( struct V_25 * V_25 , T_2 V_26 ,
...
& V_16 ) ;
V_87 = ( V_82 == V_40 ) ? V_13 : NULL ;
F_74 ( V_82 , V_26 , V_61 , V_87 , NULL ) ;
if ( V_92 && V_6 -> V_9 &&
! F_11 ( V_6 , NULL , V_13 ) &&
V_6 -> signal -> V_19 != V_20 ) {
F_34 ( V_6 ) ;
F_62 ( V_6 , V_26 , V_61 , 0 , V_16 , NULL ,
V_13 ,
L_11 ) ;
goto V_91;
}
V_7 = F_31 ( & V_17 , V_16 , V_87 , V_45 ) ;
if ( ! V_7 ) {
F_40 ( NULL , V_26 , V_61 , NULL , V_87 ) ;
F_75 ( L_12 ) ;
}
if ( V_7 != ( void * ) - 1UL ) {
F_62 ( V_7 , V_26 , V_61 , V_17 , V_16 , NULL ,
V_13 , L_13 ) ;
V_90 = 1 ;
}
V_91:
