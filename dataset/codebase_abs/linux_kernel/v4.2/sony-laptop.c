...
{
T_1 V_243 , V_244 ;
F_165 ( F_166 ( V_245 . V_246 -> V_247 . V_248 + 4 ) & 2 ,
V_249 ) ;
F_167 ( V_8 , V_245 . V_246 -> V_247 . V_248 + 4 ) ;
V_243 = F_166 ( V_245 . V_246 -> V_247 . V_248 + 4 ) ;
V_244 = F_166 ( V_245 . V_246 -> V_247 . V_248 ) ;
F_13 ( L_106 , V_8 , ( V_244 << 8 ) | V_243 ) ;
return V_244 ;
}
static T_1 F_168 ( T_1 V_8 , T_1 V_250 )
{
T_1 V_243 ;
F_165 ( F_166 ( V_245 . V_246 -> V_247 . V_248 + 4 ) & 2 ,
V_249 ) ;
...
F_165 ( F_166 ( V_245 . V_246 -> V_247 . V_248 + 4 ) & 2 ,
V_249 ) ;
F_167 ( V_250 , V_245 . V_246 -> V_247 . V_248 ) ;
V_243 = F_166 ( V_245 . V_246 -> V_247 . V_248 ) ;
F_13 ( L_107 , V_8 , V_250 , V_243 ) ;
return V_243 ;
}
static T_1 F_169 ( T_1 V_8 , T_1 V_250 , T_1 V_80 )
{
T_1 V_243 ;
F_165 ( F_166 ( V_245 . V_246 -> V_247 . V_248 + 4 ) & 2 , V_249 ) ;
F_167 ( V_8 , V_245 . V_246 -> V_247 . V_248 + 4 ) ;
F_165 ( F_166 ( V_245 . V_246 -> V_247 . V_248 + 4 ) & 2 , V_249 ) ;
F_167 ( V_250 , V_245 . V_246 -> V_247 . V_248 ) ;
F_165 ( F_166 ( V_245 . V_246 -> V_247 . V_248 + 4 ) & 2 , V_249 ) ;
F_167 ( V_80 , V_245 . V_246 -> V_247 . V_248 ) ;
V_243 = F_166 ( V_245 . V_246 -> V_247 . V_248 ) ;
F_13 ( L_108 ,
V_8 , V_250 , V_80 , V_243 ) ;
return V_243 ;
}
static int F_170 ( const T_1 V_251 , const T_1 V_252 )
{
if ( V_251 == 0x31 ) {
if ( V_252 == 0x5c || V_252 == 0x5f )
F_164 ( 0xA0 ) ;
else if ( V_252 == 0x61 )
F_164 ( 0xB3 ) ;
return 0 ;
...
static void F_171 ( struct V_253 * V_8 )
{
struct V_254 * V_255 ;
V_255 = F_172 ( V_256 ,
V_257 , NULL ) ;
...
{
T_1 V_80 ;
V_80 = F_168 ( 0x8f , V_275 ) ;
return ( V_80 != 0xff && ( V_80 & V_276 ) ) ;
}
...
if ( V_245 . V_281 )
return 0 ;
for ( V_282 = 5 ; V_282 > 0 ; V_282 -- ) {
for ( V_283 = 0 ; V_283 < 100 && F_168 ( 0x91 , 0x1 ) ; V_283 ++ )
F_177 ( 10 ) ;
F_164 ( 0x93 ) ;
...
F_165 ( F_169 ( 0x90 , V_284 ,
0x5a ) ,
V_280 ) ;
V_245 . V_281 = 1 ;
return 0 ;
}
int F_178 ( int V_285 , T_1 V_67 )
{
if ( ! V_277 )
return - V_112 ;
F_179 ( & V_245 . V_286 ) ;
...
break;
case V_288 :
F_165 ( F_169 ( 0x90 , V_289 , V_67 ) ,
V_280 ) ;
break;
case V_290 :
F_165 ( F_169 ( 0x90 , V_291 , V_67 ) ,
V_280 ) ;
break;
case V_292 :
F_165 ( F_169 ( 0x90 , V_293 , V_67 ) ,
V_280 ) ;
break;
case V_294 :
F_165 ( F_169 ( 0x90 , V_295 , V_67 ) ,
V_280 ) ;
break;
case V_296 :
F_165 ( F_169 ( 0x90 , V_297 , V_67 ) ,
V_280 ) ;
break;
case V_298 :
F_165 ( F_169 ( 0x90 , V_278 , V_67 ) ,
V_280 ) ;
break;
case V_299 :
...
static void F_181 ( T_1 V_301 )
{
V_301 = ! ! V_301 ;
if ( V_245 . V_302 == V_301 )
return;
F_168 ( 0xB0 , V_301 ) ;
F_164 ( 0x82 ) ;
V_245 . V_302 = V_301 ;
...
T_6 V_77 ;
F_179 ( & V_245 . V_286 ) ;
V_77 = snprintf ( V_82 , V_92 , L_21 , V_245 . V_302 ) ;
F_180 ( & V_245 . V_286 ) ;
return V_77 ;
}
static void F_184 ( T_1 V_301 )
{
V_301 = ! ! V_301 ;
if ( V_245 . V_303 == V_301 )
return;
F_168 ( 0x96 , V_301 ) ;
F_164 ( 0x82 ) ;
V_245 . V_303 = V_301 ;
...
T_6 V_77 = 0 ;
F_179 ( & V_245 . V_286 ) ;
V_77 = snprintf ( V_82 , V_92 , L_21 , V_245 . V_303 ) ;
F_180 ( & V_245 . V_286 ) ;
return V_77 ;
}
static int F_187 ( unsigned long V_67 )
{
return F_188 ( V_304 , V_67 ) ;
}
static int F_189 ( T_1 * V_67 )
{
return F_190 ( V_304 , V_67 ) ;
}
...
static int F_193 ( int V_305 , struct V_306 * V_307 , int V_308 )
{
return F_194 ( V_305 , V_307 , V_308 , & V_309 . V_310 ) ;
}
static int F_195 ( struct V_311 * V_311 , struct V_306 * V_306 )
{
F_30 ( & V_309 . V_312 ) ;
return 0 ;
}
static int F_196 ( struct V_311 * V_311 , struct V_306 * V_306 )
{
unsigned long V_4 ;
F_2 ( & V_309 . V_6 , V_4 ) ;
if ( F_197 ( & V_309 . V_312 ) == 1 )
F_198 ( & V_309 . V_7 ) ;
F_9 ( & V_309 . V_6 , V_4 ) ;
return 0 ;
}
static T_6 F_199 ( struct V_306 * V_306 , char T_8 * V_313 ,
T_5 V_77 , T_9 * V_196 )
{
T_6 V_57 ;
unsigned char V_314 ;
...
( V_306 -> V_315 & V_316 ) )
return - V_317 ;
V_57 = F_200 ( V_309 . V_318 ,
F_6 ( & V_309 . V_7 ) != 0 ) ;
if ( V_57 )
return V_57 ;
while ( V_57 < V_77 &&
( F_201 ( & V_309 . V_7 , & V_314 , sizeof( V_314 ) ,
& V_309 . V_6 ) == sizeof( V_314 ) ) ) {
if ( F_202 ( V_314 , V_313 ++ ) )
return - V_319 ;
V_57 ++ ;
}
if ( V_57 > 0 ) {
struct V_311 * V_311 = F_203 ( V_306 ) ;
V_311 -> V_320 = F_204 ( V_311 -> V_321 ) ;
}
return V_57 ;
}
static unsigned int F_205 ( struct V_306 * V_306 , T_10 * V_322 )
{
F_206 ( V_306 , & V_309 . V_318 , V_322 ) ;
if ( F_6 ( & V_309 . V_7 ) )
return V_323 | V_324 ;
return 0 ;
}
static int F_207 ( T_1 V_325 , T_11 * V_67 )
{
T_1 V_326 , V_327 ;
if ( F_190 ( V_325 , & V_326 ) )
return - 1 ;
if ( F_190 ( V_325 + 1 , & V_327 ) )
return - 1 ;
* V_67 = V_326 | ( V_327 << 8 ) ;
return 0 ;
}
static long F_208 ( struct V_306 * V_328 , unsigned int V_181 ,
unsigned long V_96 )
{
int V_57 = 0 ;
void T_8 * V_329 = ( void T_8 * ) V_96 ;
T_1 V_330 ;
T_11 V_331 ;
int V_67 ;
F_179 ( & V_245 . V_286 ) ;
...
V_330 = ( ( V_67 & 0xff ) - 1 ) << 5 ;
if ( F_209 ( V_329 , & V_330 , sizeof( V_330 ) ) )
V_57 = - V_319 ;
break;
case V_333 :
if ( V_230 . V_8 == NULL ) {
...
if ( F_210 ( & V_330 , V_329 , sizeof( V_330 ) ) ) {
V_57 = - V_319 ;
break;
}
V_67 = ( V_330 >> 5 ) + 1 ;
...
break;
case V_334 :
if ( F_207 ( V_335 , & V_331 ) ) {
V_57 = - V_112 ;
break;
}
if ( F_209 ( V_329 , & V_331 , sizeof( V_331 ) ) )
V_57 = - V_319 ;
break;
case V_336 :
if ( F_207 ( V_337 , & V_331 ) ) {
V_57 = - V_112 ;
break;
}
if ( F_209 ( V_329 , & V_331 , sizeof( V_331 ) ) )
...
{
F_15 ( & V_309 . V_7 , ( unsigned char * ) & V_12 ,
sizeof( V_12 ) , & V_309 . V_6 ) ;
F_212 ( & V_309 . V_310 , V_350 , V_351 ) ;
F_213 ( & V_309 . V_318 ) ;
}
...
static void F_211 ( T_1 V_12 ) { }
static T_4
F_219 ( struct V_354 * V_355 , void * V_137 )
{
T_7 V_32 ;
struct V_253 * V_8 = (struct V_253 * ) V_137 ;
switch ( V_355 -> type ) {
case V_356 :
{
struct V_357 * V_358 = F_52 ( sizeof( * V_358 ) , V_35 ) ;
if ( ! V_358 )
return V_359 ;
F_220 ( & V_358 -> V_360 , & V_8 -> V_361 ) ;
return V_142 ;
}
case V_362 :
return V_142 ;
case V_363 :
{
struct V_364 * V_365 = & V_355 -> V_127 . V_366 ;
struct V_367 * V_368 = NULL ;
if ( ! V_365 || ! V_365 -> V_369 ) {
F_13 ( L_115 ) ;
return V_142 ;
}
for ( V_32 = 0 ; V_32 < V_365 -> V_369 ; V_32 ++ ) {
if ( ! V_365 -> V_370 [ V_32 ] ) {
F_46 ( L_116 ,
V_365 -> V_370 [ V_32 ] ) ;
continue;
}
V_368 = F_52 ( sizeof( * V_368 ) ,
V_35 ) ;
if ( ! V_368 )
return V_359 ;
F_220 ( & V_368 -> V_360 , & V_8 -> V_370 ) ;
V_368 -> V_366 . V_371 = V_365 -> V_371 ;
V_368 -> V_366 . V_372 = V_365 -> V_372 ;
V_368 -> V_366 . V_373 = V_365 -> V_373 ;
V_368 -> V_366 . V_369 = 1 ;
V_368 -> V_366 . V_370 [ 0 ] = V_365 -> V_370 [ V_32 ] ;
}
return V_142 ;
}
case V_374 :
{
struct V_375 * V_376 = & V_355 -> V_127 . V_376 ;
struct V_357 * V_358 =
F_221 ( & V_8 -> V_361 , struct V_357 , V_360 ) ;
if ( ! V_376 ) {
F_13 ( L_117 ) ;
return V_142 ;
}
if ( ! V_358 -> V_247 . V_248 ) {
memcpy ( & V_358 -> V_247 , V_376 , sizeof( * V_376 ) ) ;
F_13 ( L_118 , V_358 -> V_247 . V_248 ,
V_358 -> V_247 . V_377 ) ;
}
else if ( ! V_358 -> V_378 . V_248 ) {
memcpy ( & V_358 -> V_378 , V_376 , sizeof( * V_376 ) ) ;
F_13 ( L_119 , V_358 -> V_378 . V_248 ,
V_358 -> V_378 . V_377 ) ;
}
else {
F_20 ( L_120 ) ;
...
NULL ) ;
if ( F_44 ( V_57 ) && V_57 != V_384 )
return - V_385 ;
F_13 ( L_124 ) ;
return 0 ;
}
static int F_225 ( struct V_31 * V_87 ,
struct V_357 * V_358 , struct V_367 * V_366 )
{
T_4 V_72 ;
int V_68 = 0 ;
struct {
...
if ( ! V_358 || ! V_366 )
return - V_81 ;
V_355 = F_52 ( sizeof( * V_355 ) + 1 , V_35 ) ;
if ( ! V_355 )
return - V_37 ;
V_82 . V_86 = sizeof( * V_355 ) + 1 ;
V_82 . V_78 = V_355 ;
if ( V_245 . V_258 == V_259 ) {
V_355 -> V_386 . type = V_374 ;
V_355 -> V_386 . V_86 = sizeof( struct V_354 ) ;
memcpy ( & V_355 -> V_386 . V_127 . V_376 , & V_358 -> V_247 ,
sizeof( struct V_375 ) ) ;
V_355 -> V_387 . type = V_374 ;
V_355 -> V_387 . V_86 = sizeof( struct V_354 ) ;
memcpy ( & V_355 -> V_387 . V_127 . V_376 , & V_358 -> V_378 ,
sizeof( struct V_375 ) ) ;
V_355 -> V_388 . type = V_363 ;
V_355 -> V_388 . V_86 = sizeof( struct V_354 ) ;
memcpy ( & V_355 -> V_388 . V_127 . V_366 , & V_366 -> V_366 ,
sizeof( struct V_364 ) ) ;
V_355 -> V_388 . V_127 . V_366 . V_373 = V_390 ;
V_355 -> V_389 . type = V_379 ;
V_355 -> V_389 . V_86 = sizeof( struct V_354 ) ;
}
else {
V_355 -> V_386 . type = V_374 ;
V_355 -> V_386 . V_86 = sizeof( struct V_354 ) ;
memcpy ( & V_355 -> V_386 . V_127 . V_376 , & V_358 -> V_247 ,
sizeof( struct V_375 ) ) ;
V_355 -> V_387 . type = V_363 ;
V_355 -> V_387 . V_86 = sizeof( struct V_354 ) ;
memcpy ( & V_355 -> V_387 . V_127 . V_366 , & V_366 -> V_366 ,
sizeof( struct V_364 ) ) ;
V_355 -> V_387 . V_127 . V_366 . V_373 = V_390 ;
V_355 -> V_388 . type = V_379 ;
V_355 -> V_388 . V_86 = sizeof( struct V_354 ) ;
}
F_13 ( L_129 ) ;
...
F_164 ( 0x82 ) ;
F_168 ( 0x81 , 0xff ) ;
F_164 ( V_391 ? 0x92 : 0x82 ) ;
V_381:
F_47 ( V_355 ) ;
return V_68 ;
}
static T_12 V_367 ( int V_366 , void * V_392 )
{
int V_32 , V_282 ;
T_1 V_252 = 0 ;
T_1 V_251 = 0 ;
T_1 V_393 = 0 ;
struct V_253 * V_8 = (struct V_253 * ) V_392 ;
V_252 = F_166 ( V_8 -> V_246 -> V_247 . V_248 ) ;
if ( V_8 -> V_246 -> V_378 . V_248 )
V_251 = F_166 ( V_8 -> V_246 -> V_378 . V_248 ) ;
else
V_251 = F_166 ( V_8 -> V_246 -> V_247 . V_248 +
V_8 -> V_260 ) ;
F_13 ( L_131 ,
V_252 , V_251 , V_8 -> V_246 -> V_247 . V_248 ,
V_8 -> V_260 ) ;
if ( V_252 == 0x00 || V_252 == 0xff )
return V_394 ;
for ( V_32 = 0 ; V_8 -> V_262 [ V_32 ] . V_395 ; V_32 ++ ) {
if ( ( V_251 & V_8 -> V_262 [ V_32 ] . V_127 ) !=
V_8 -> V_262 [ V_32 ] . V_127 )
continue;
if ( ! ( V_395 & V_8 -> V_262 [ V_32 ] . V_395 ) )
continue;
for ( V_282 = 0 ; V_8 -> V_262 [ V_32 ] . V_396 [ V_282 ] . V_12 ; V_282 ++ ) {
if ( V_252 == V_8 -> V_262 [ V_32 ] . V_396 [ V_282 ] . V_127 ) {
V_393 =
V_8 -> V_262 [ V_32 ] . V_396 [ V_282 ] . V_12 ;
if ( ! V_393 )
return V_394 ;
goto V_397;
}
...
if ( V_8 -> V_270 && V_8 -> V_270 ( V_251 , V_252 ) == 0 )
return V_394 ;
F_13 ( L_132 ,
V_252 , V_251 , V_8 -> V_246 -> V_247 . V_248 ,
V_8 -> V_260 ) ;
...
{
struct V_357 * V_376 , * V_398 ;
struct V_367 * V_366 , * V_399 ;
if ( F_224 ( V_87 ) ) {
F_20 ( L_133 ) ;
return - V_385 ;
}
F_228 ( V_245 . V_400 -> V_366 . V_370 [ 0 ] , & V_245 ) ;
F_229 ( V_245 . V_246 -> V_247 . V_248 ,
V_245 . V_246 -> V_247 . V_377 ) ;
if ( V_245 . V_246 -> V_378 . V_248 )
F_229 ( V_245 . V_246 -> V_378 . V_248 ,
V_245 . V_246 -> V_378 . V_377 ) ;
F_217 () ;
F_31 () ;
F_230 ( & V_61 -> V_8 . V_401 , & V_402 ) ;
F_40 () ;
...
if ( F_236 ( V_376 -> V_247 . V_248 , V_376 -> V_247 . V_377 ,
L_135 ) ) {
F_13 ( L_136 ,
V_376 -> V_247 . V_248 , V_376 -> V_247 . V_407 ,
V_376 -> V_247 . V_377 ) ;
if ( V_376 -> V_378 . V_248 ) {
if ( F_236 ( V_376 -> V_378 . V_248 ,
V_376 -> V_378 . V_377 ,
L_135 ) ) {
F_13 ( L_137 ,
V_376 -> V_378 . V_248 , V_376 -> V_378 . V_407 ,
V_376 -> V_378 . V_377 ) ;
V_245 . V_246 = V_376 ;
break;
}
...
if ( ! F_237 ( V_366 -> V_366 . V_370 [ 0 ] , V_367 ,
0 , L_6 , & V_245 ) ) {
F_13 ( L_141
L_142 ,
V_366 -> V_366 . V_370 [ 0 ] ,
...
V_68 = F_225 ( V_87 , V_245 . V_246 , V_245 . V_400 ) ;
if ( V_68 ) {
F_20 ( L_144 ) ;
goto V_410;
}
...
if ( V_68 )
goto V_411;
V_68 = F_238 ( & V_61 -> V_8 . V_401 , & V_402 ) ;
if ( V_68 )
goto V_412;
F_71 ( L_145 ) ;
return 0 ;
...
{
F_225 ( F_240 ( V_8 ) ,
V_245 . V_246 , V_245 . V_400 ) ;
return 0 ;
}
static int T_13 F_242 ( void )
{
int V_68 ;
if ( ! V_413 && F_243 ( V_414 ) ) {
V_68 = F_244 ( & V_415 ) ;
if ( V_68 ) {
F_20 ( L_146 ) ;
goto V_60;
