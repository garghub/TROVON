...
if ( V_83 -> V_84 > V_4 )
return - V_58 ;
F_35 ( V_83 -> V_85 , V_5 [ V_84 ] . V_86 , sizeof( V_83 -> V_85 ) ) ;
...
static int F_40 ( struct V_7 * V_8 , struct V_98 * V_97 )
{
enum V_62 V_11 ;
int V_92 , V_93 ;
...
unsigned long V_107 ;
int V_108 ;
V_108 = F_40 ( V_8 , & V_83 -> V_38 . V_97 ) ;
if ( V_108 )
return V_108 ;
V_45 -> V_97 = V_83 -> V_38 . V_97 ;
F_44 ( & V_8 -> V_109 , V_107 ) ;
F_42 ( V_8 , V_45 ) ;
F_45 ( & V_8 -> V_109 , V_107 ) ;
return 0 ;
}
...
static int F_47 ( struct V_69 * V_69 , void * V_70 , unsigned int V_110 )
{
struct V_44 * V_45 = V_70 ;
struct V_7 * V_8 = (struct V_7 * ) V_45 -> V_8 ;
unsigned long V_107 ;
...
int F_49 ( struct V_69 * V_69 , void * V_70 , const struct V_112 * V_113 )
{
struct V_44 * V_45 = V_70 ;
struct V_7 * V_8 = V_45 -> V_8 ;
const struct V_112 * V_114 = V_113 ;
struct V_1 * V_38 ;
if ( ! F_50 ( V_117 ) && ! F_50 ( V_118 ) )
return - V_119 ;
...
{
struct V_44 * V_45 = V_70 ;
return F_52 ( & V_45 -> V_89 , V_121 ) ;
}
static int F_53 ( struct V_69 * V_69 , void * V_70 ,
struct V_122 * V_121 )
{
struct V_44 * V_45 = V_70 ;
return F_54 ( & V_45 -> V_89 , V_121 ) ;
}
static int F_55 ( struct V_69 * V_69 , void * V_70 , struct V_122 * V_121 )
{
struct V_44 * V_45 = V_70 ;
return F_56 ( & V_45 -> V_89 , V_121 ) ;
}
static int F_57 ( struct V_69 * V_69 , void * V_70 , struct V_122 * V_121 )
{
struct V_44 * V_45 = V_70 ;
return F_58 ( & V_45 -> V_89 , V_121 ,
V_69 -> V_123 & V_124 ) ;
}
static int F_59 ( struct V_69 * V_69 , void * V_70 , enum V_125 V_3 )
{
struct V_44 * V_45 = V_70 ;
struct V_7 * V_8 = V_45 -> V_8 ;
if ( V_45 -> type != V_126 )
...
V_8 -> V_111 = 0 ;
F_3 ( V_45 -> V_8 ) ;
return F_60 ( & V_45 -> V_89 ) ;
}
static int F_61 ( struct V_69 * V_69 , void * V_70 , enum V_125 V_3 )
{
struct V_44 * V_45 = V_70 ;
if ( V_45 -> type != V_126 )
return - V_58 ;
...
return - V_58 ;
F_5 ( V_45 -> V_8 ) ;
return F_62 ( & V_45 -> V_89 ) ;
}
static int F_63 ( struct V_69 * V_69 , void * V_70 , T_2 * V_127 )
{
struct V_44 * V_45 = V_70 ;
F_64 ( V_45 -> V_8 , V_128 , V_129 , V_127 ) ;
return 0 ;
}
static int F_65 ( struct V_69 * V_69 , void * V_70 , T_2 V_130 )
{
struct V_44 * V_45 = V_70 ;
V_45 -> V_8 -> V_131 = V_130 ;
F_64 ( V_45 -> V_8 , V_128 , V_132 , V_130 ) ;
return 0 ;
}
static int F_66 ( struct V_69 * V_69 , void * V_70 , T_2 * V_127 )
{
struct V_44 * V_45 = V_70 ;
...
return - V_58 ;
V_134 -> type = V_135 ;
V_134 -> V_131 = V_45 -> V_8 -> V_136 -> V_137 ;
strcpy ( V_134 -> V_86 , L_26 ) ;
return 0 ;
}
...
if ( V_3 > 1 )
return - V_58 ;
F_64 ( V_45 -> V_8 , V_128 , V_138 , V_3 , 0 , 0 ) ;
return 0 ;
}
...
{
int V_3 ;
for ( V_3 = 0 ; V_3 < F_71 ( V_141 ) ; V_3 ++ ) {
if ( V_140 -> V_130 && V_140 -> V_130 == V_141 [ V_3 ] . V_130 ) {
memcpy ( V_140 , & ( V_141 [ V_3 ] ) , sizeof( * V_140 ) ) ;
return 0 ;
}
}
return - V_58 ;
...
int V_3 ;
for ( V_3 = 0 ; V_3 < F_71 ( V_141 ) ; V_3 ++ ) {
if ( V_143 -> V_130 == V_141 [ V_3 ] . V_130 ) {
V_143 -> V_144 = V_145 [ V_3 ] ;
return 0 ;
}
}
return - V_58 ;
...
for ( V_3 = 0 ; V_3 < F_71 ( V_141 ) ; V_3 ++ ) {
if ( V_143 -> V_130 == V_141 [ V_3 ] . V_130 ) {
if ( V_143 -> V_144 < V_141 [ V_3 ] . V_146
|| V_143 -> V_144 > V_141 [ V_3 ] . V_147 )
return - V_148 ;
V_145 [ V_3 ] = V_143 -> V_144 ;
return 0 ;
}
}
return - V_58 ;
...
{
struct V_9 * V_10 = V_9 ;
F_4 ( & V_10 -> V_150 , 0x9512A254 ) ;
F_4 ( & V_10 -> V_151 , 0x03310000 ) ;
F_4 ( & V_10 -> V_152 , 0x06600F38 ) ;
F_4 ( & V_10 -> V_153 , 0x00000409 ) ;
F_4 ( & V_10 -> V_154 , 0x000000ff ) ;
F_4 ( & V_10 -> V_155 , 0x00000090 ) ;
F_2 ( 1 , L_28 ,
F_6 ( & V_10 -> V_12 ) , F_6 ( & V_10 -> V_55 ) ) ;
}
static void F_76 ( struct V_7 * V_8 , T_1 V_156 )
{
struct V_9 * V_10 = V_8 -> V_10 ;
if ( V_156 & V_17 )
V_8 -> V_157 = 1 ;
...
static void F_77 ( struct V_7 * V_8 , T_1 V_156 )
{
struct V_18 * V_19 = & V_8 -> V_19 ;
struct V_9 * V_10 = V_8 -> V_10 ;
struct V_20 * V_21 ;
...
F_11 ( & V_21 -> V_26 . V_27 ) ;
F_80 ( & V_21 -> V_26 . V_166 ) ;
V_21 -> V_26 . V_28 = V_167 ;
V_21 -> V_26 . V_168 ++ ;
F_12 ( & V_21 -> V_26 . V_30 ) ;
}
F_74 ( V_8 , V_19 ) ;
...
static T_3 F_81 ( int V_169 , void * V_170 )
{
struct V_7 * V_8 = (struct V_7 * ) V_170 ;
struct V_9 * V_10 = V_8 -> V_10 ;
T_1 V_156 ;
T_1 error ;
V_156 = F_6 ( & V_10 -> V_12 ) ;
...
if ( error )
F_2 ( 1 , L_34 ,
error >> 4 , V_8 -> V_172 . V_173 ) ;
F_4 ( & V_10 -> V_12 ,
( V_156 & 0xffc0ffff ) | V_171 ) ;
}
if ( V_156 & V_17 ) {
V_8 -> V_172 . V_175 ++ ;
V_8 -> V_157 = 1 ;
...
{
struct V_183 * V_136 = F_83 ( V_69 ) ;
struct V_7 * V_8 = F_84 ( V_136 ) ;
struct V_44 * V_45 ;
struct V_9 * V_10 ;
int V_184 = V_136 -> V_184 ;
T_1 V_12 ;
int V_3 ;
F_2 ( 1 , L_38 , V_184 ) ;
V_8 -> V_185 ++ ;
...
V_10 = V_8 -> V_10 ;
F_2 ( 1 , L_39 , V_184 ,
V_187 [ V_126 ] , V_8 -> V_185 ) ;
if ( F_85 ( & V_8 -> V_188 ) ) {
V_8 -> V_185 -- ;
return - V_189 ;
}
V_45 = F_86 ( sizeof( * V_45 ) , V_190 ) ;
if ( ! V_45 ) {
V_8 -> V_185 -- ;
F_87 ( & V_8 -> V_188 ) ;
return - V_191 ;
...
V_60 | V_198 | V_199 ) ) ;
V_12 = F_6 ( & V_10 -> V_12 ) ;
F_4 ( & V_10 -> V_12 , V_12 | V_161 ) ;
F_88 ( & V_45 -> V_200 ) ;
F_89 ( & V_45 -> V_89 , & V_201 ,
V_8 -> V_8 , & V_45 -> V_200 ,
V_45 -> type , V_95 ,
...
static unsigned int F_92 ( struct V_69 * V_69 , struct V_203 * V_204 )
{
struct V_44 * V_45 = V_69 -> V_192 ;
...
void F_99 ( struct V_9 * V_208 )
{
F_4 ( & V_208 -> V_12 , 0 ) ;
F_4 ( & V_208 -> V_150 , 0x9512a254 ) ;
F_4 ( & V_208 -> V_151 , 0x03310000 ) ;
F_4 ( & V_208 -> V_152 , 0x06600f38 ) ;
F_4 ( & V_208 -> V_153 , 0x00000409 ) ;
F_4 ( & V_208 -> V_55 , 0 ) ;
F_4 ( & V_208 -> V_57 , 0 ) ;
F_4 ( & V_208 -> V_59 , 0x01e002d0 ) ;
F_4 ( & V_208 -> V_155 , 0x00000090 ) ;
F_4 ( & V_208 -> V_154 , 0x000000ff ) ;
}
static int F_100 ( struct V_69 * V_69 , struct V_209 * V_210 )
{
struct V_44 * V_45 = V_69 -> V_192 ;
struct V_7 * V_8 = V_45 -> V_8 ;
int V_96 ;
F_2 ( 1 , L_45 , ( unsigned long ) V_210 ) ;
if ( F_85 ( & V_8 -> V_188 ) )
return - V_189 ;
V_96 = F_101 ( & V_45 -> V_89 , V_210 ) ;
F_87 ( & V_8 -> V_188 ) ;
F_2 ( 1 , L_46 ,
( unsigned long ) V_210 -> V_211 ,
( unsigned long ) V_210 -> V_212 - ( unsigned long ) V_210 -> V_211 ,
V_96 ) ;
return V_96 ;
}
...
struct V_183 * V_136 ;
struct V_215 V_216 ;
struct V_9 T_8 * V_217 ;
struct V_218 * V_219 ;
int V_96 , V_220 ;
struct V_221 * V_221 ;
V_96 = F_103 ( V_214 -> V_8 . V_222 , 0 , & V_216 ) ;
if ( V_96 ) {
F_104 ( & V_214 -> V_8 , L_47 ) ;
return - V_223 ;
}
V_220 = F_105 ( V_214 -> V_8 . V_222 , 0 ) ;
if ( V_220 == V_224 ) {
F_104 ( & V_214 -> V_8 , L_48 ) ;
return - V_58 ;
}
if ( ! F_106 ( & V_214 -> V_8 , V_216 . V_225 ,
sizeof( struct V_9 ) , V_226 ) ) {
F_104 ( & V_214 -> V_8 , L_49 ) ;
V_96 = - V_186 ;
goto V_108;
}
V_217 = F_107 ( & V_214 -> V_8 , V_216 . V_225 , sizeof( struct V_9 ) ) ;
if ( ! V_217 ) {
F_104 ( & V_214 -> V_8 , L_50 ) ;
V_96 = - V_191 ;
goto V_108;
}
V_7 = F_108 ( & V_214 -> V_8 , sizeof( struct V_7 ) , V_227 ) ;
if ( ! V_7 ) {
F_104 ( & V_214 -> V_8 , L_51 ) ;
V_96 = - V_191 ;
goto V_108;
}
V_7 -> V_10 = V_217 ;
...
F_109 ( & V_7 -> V_19 . V_24 ) ;
F_109 ( & V_7 -> V_19 . V_34 ) ;
snprintf ( V_7 -> V_228 . V_86 ,
sizeof( V_7 -> V_228 . V_86 ) , L_52 , L_53 ) ;
V_96 = F_110 ( V_7 -> V_8 , & V_7 -> V_228 ) ;
if ( V_96 < 0 ) {
F_104 ( & V_214 -> V_8 , L_54 , V_96 ) ;
goto V_108;
}
V_219 = F_111 ( 0 ) ;
V_7 -> V_229 = F_112 ( & V_7 -> V_228 , V_219 ,
L_55 , V_230 , NULL ) ;
V_7 -> V_19 . V_31 . V_231 = F_15 ;
...
memcpy ( V_136 , & V_234 , sizeof( V_234 ) ) ;
V_136 -> V_228 = & V_7 -> V_228 ;
V_7 -> V_136 = V_136 ;
F_115 ( & V_7 -> V_188 ) ;
V_7 -> V_136 -> V_188 = & V_7 -> V_188 ;
F_88 ( & V_7 -> V_109 ) ;
F_116 ( V_7 -> V_136 , V_7 ) ;
F_93 ( & V_7 -> V_188 ) ;
V_96 = F_117 ( V_7 -> V_136 , V_235 , - 1 ) ;
if ( V_96 < 0 ) {
F_118 ( V_7 -> V_136 ) ;
goto V_233;
}
V_221 = F_119 ( & V_214 -> V_8 , L_56 ) ;
if ( F_120 ( V_221 ) ) {
F_104 ( & V_214 -> V_8 , L_57 ) ;
V_96 = F_121 ( V_221 ) ;
goto V_236;
}
V_96 = F_122 ( V_221 ) ;
if ( V_96 ) {
F_104 ( & V_214 -> V_8 , L_58 ) ;
goto V_236;
}
V_7 -> V_221 = V_221 ;
F_99 ( V_7 -> V_10 ) ;
if ( F_123 ( V_7 -> V_169 , F_81 , 0 , L_20 , ( void * ) V_7 ) ) {
F_104 ( & V_214 -> V_8 , L_59 ) ;
V_96 = - V_223 ;
goto V_237;
}
F_87 ( & V_7 -> V_188 ) ;
F_124 ( & V_214 -> V_8 , L_60 ) ;
return V_96 ;
V_237:
F_125 ( V_7 -> V_221 ) ;
V_236:
...
static int F_130 ( struct V_213 * V_214 )
{
struct V_238 * V_228 = F_131 ( & V_214 -> V_8 ) ;
struct V_7 * V_8 = F_26 ( V_228 , struct V_7 , V_228 ) ;
struct V_239 * V_240 = F_9 ( V_228 -> V_241 . V_25 ,
struct V_239 , V_242 ) ;
struct V_243 * V_244 = F_132 ( V_240 ) ;
F_133 ( V_8 -> V_169 , ( void * ) V_8 ) ;
F_129 ( V_8 -> V_169 ) ;
F_125 ( V_8 -> V_221 ) ;
F_126 ( V_8 -> V_136 ) ;
F_127 ( V_244 -> V_245 ) ;
...
static int F_134 ( struct V_213 * V_214 , T_9 V_28 )
{
struct V_238 * V_228 = F_131 ( & V_214 -> V_8 ) ;
struct V_7 * V_8 = F_26 ( V_228 , struct V_7 , V_228 ) ;
F_135 ( V_8 -> V_221 ) ;
