...
V_284 = F_77 ( & V_286 , V_283 -> V_30 , V_13 -> V_289 ) ;
if ( V_284 < 0 )
return V_284 ;
if ( V_13 -> V_245 & V_246 )
V_287 = V_13 -> V_287 ;
V_284 = F_78 ( V_13 , V_287 , V_286 -> V_30 , V_286 -> V_236 , 1 ) ;
F_79 ( V_286 ) ;
if ( ! V_284 )
F_80 ( V_13 -> V_289 ,
L_3 , V_283 -> V_30 ) ;
...
static int F_82 ( struct V_1 * V_2 , T_1 * V_32 , T_2 * V_291 , T_2 * V_292 )
{
const struct V_31 * V_121 = F_34 ( V_2 ) ;
unsigned int V_293 = V_121 -> V_290 ;
if ( V_292 )
* V_292 = V_294 ;
if ( ! V_32 )
return 0 ;
while ( V_293 -- )
V_32 [ V_293 ] = V_121 -> V_295 [ V_293 ] ;
return 0 ;
}
static int F_83 ( struct V_1 * V_2 , const T_1 * V_32 , const T_2 * V_291 ,
const T_2 V_292 )
{
unsigned int V_35 ;
struct V_31 * V_121 = F_34 ( V_2 ) ;
if ( V_291 ||
( V_292 != V_296 && V_292 != V_294 ) )
return - V_11 ;
if ( ! V_32 )
return 0 ;
for ( V_35 = 0 ; V_35 < V_121 -> V_290 ; V_35 ++ )
V_121 -> V_295 [ V_35 ] = V_32 [ V_35 ] ;
if ( V_121 -> V_12 -> V_245 & V_246 )
return F_84 ( V_121 , V_121 -> V_295 ) ;
return 0 ;
}
static int F_85 ( struct V_1 * V_2 , struct V_297 * V_16 ,
T_1 * V_298 )
{
const struct V_31 * V_121 = F_34 ( V_2 ) ;
switch ( V_16 -> V_182 ) {
case V_299 : {
unsigned int V_94 = V_121 -> V_300 ;
V_16 -> V_30 = 0 ;
switch ( V_16 -> V_301 ) {
case V_302 :
if ( V_94 & V_303 )
V_16 -> V_30 = V_304 | V_305 |
V_306 | V_307 ;
else if ( V_94 & V_308 )
V_16 -> V_30 = V_304 | V_305 ;
break;
