...
if ( args -> V_46 == V_72 )
args -> V_71 = V_4 -> V_41 . V_42 ;
else
args -> V_71 = V_4 -> V_41 . V_43 ;
if ( args -> V_71 == V_33 )
args -> V_71 = V_15 ;
if ( args -> V_71 == V_32 )
args -> V_71 = V_14 ;
...
if ( F_28 ( V_54 ) ) {
if ( V_54 -> V_81 == NULL ) {
V_54 -> V_81 = F_29 ( F_30 ( V_54 -> V_55 . V_45 >> V_82 ) ,
sizeof( long ) , V_83 ) ;
}
} else {
F_31 ( V_54 -> V_81 ) ;
...
int
F_34 ( struct V_1 * V_2 , void * V_58 ,
struct V_59 * V_60 )
{
struct V_84 * args = V_58 ;
struct V_3 * V_4 = V_2 -> V_5 ;
struct V_53 * V_54 ;
V_54 = F_20 ( F_21 ( V_2 , V_60 , args -> V_63 ) ) ;
if ( & V_54 -> V_55 == NULL )
...
static void
F_35 ( struct V_86 * V_86 )
{
char V_87 [ 64 ] ;
char * V_88 ;
int V_89 ;
V_88 = F_36 ( V_86 ) ;
for ( V_89 = 0 ; V_89 < V_90 ; V_89 += 128 ) {
memcpy ( V_87 , & V_88 [ V_89 ] , 64 ) ;
memcpy ( & V_88 [ V_89 ] , & V_88 [ V_89 + 64 ] , 64 ) ;
memcpy ( & V_88 [ V_89 + 64 ] , V_87 , 64 ) ;
}
F_37 ( V_86 ) ;
}
void
...
struct V_86 * V_86 = F_40 ( & V_92 ) ;
char V_93 = F_41 ( V_86 ) >> 17 ;
if ( ( V_93 & 0x1 ) !=
( F_42 ( V_89 , V_54 -> V_81 ) != 0 ) ) {
F_35 ( V_86 ) ;
F_43 ( V_86 ) ;
}
V_89 ++ ;
...
{
struct V_91 V_92 ;
int V_94 = V_54 -> V_55 . V_45 >> V_82 ;
int V_89 ;
if ( V_54 -> V_81 == NULL ) {
V_54 -> V_81 = F_29 ( F_30 ( V_94 ) ,
sizeof( long ) , V_83 ) ;
if ( V_54 -> V_81 == NULL ) {
F_11 ( L_4
L_5 ) ;
