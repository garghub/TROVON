...
static void F_80 ( unsigned int V_36 , unsigned int V_63 )
{
struct V_30 * V_30 , * V_88 ;
int V_45 ;
...
static int F_81 ( struct V_1 * V_10 ,
...
int F_82 ( struct V_1 * V_10 , unsigned int V_36 ,
...
return - V_90 ;
V_30 -> V_31 = V_31 ;
V_30 -> V_41 = V_41 ? V_41 : & V_91 ;
V_30 -> V_89 = V_89 ;
return 0 ;
}
void F_83 ( struct V_1 * V_10 , unsigned int V_36 ,
T_1 V_31 , struct V_65 * V_41 ,
void * V_89 , T_4 V_68 ,
void * V_92 , const char * V_93 )
{
F_82 ( V_10 , V_36 , V_31 , V_41 , V_89 ) ;
F_84 ( V_36 , V_68 , 0 , V_93 ) ;
F_85 ( V_36 , V_92 ) ;
}
void F_86 ( struct V_30 * V_30 )
{
V_30 -> V_31 = 0 ;
V_30 -> V_41 = & V_91 ;
V_30 -> V_89 = NULL ;
}
void F_87 ( struct V_1 * V_10 , unsigned int V_36 ,
unsigned int V_63 )
{
struct V_30 * V_30 ;
int V_45 ;
...
void F_89 ( struct V_1 * V_10 , unsigned int V_36 ,
unsigned int V_63 )
{
int V_45 ;
for ( V_45 = 0 ; V_45 < V_63 ; V_45 ++ ) {
...
static bool F_91 ( struct V_1 * V_10 )
{
return V_10 -> V_57 & V_94 ;
}
static void F_92 ( struct V_1 * V_10 ,
unsigned int V_42 ,
unsigned int V_63 )
{
...
static int F_94 ( struct V_1 * V_10 ,
unsigned int V_42 ,
unsigned int V_63 , void * V_95 )
{
int V_37 = 0 ;
...
V_63 , V_95 ) ;
if ( V_37 >= 0 )
V_37 = V_10 -> V_8 -> V_97 ( V_10 , V_42 , V_63 , V_95 ) ;
if ( V_37 < 0 && V_96 )
F_92 ( V_84 , V_42 , V_63 ) ;
return V_37 ;
}
int F_95 ( struct V_1 * V_10 , int V_42 ,
unsigned int V_63 , int V_25 , void * V_95 ,
bool realloc )
{
int V_45 , V_37 , V_36 ;
if ( V_10 == NULL ) {
...
if ( F_81 ( V_10 , V_36 , V_63 ) ) {
F_11 ( L_53 , V_36 ) ;
V_37 = - V_74 ;
goto V_99;
}
F_8 ( & V_15 ) ;
V_37 = F_94 ( V_10 , V_36 , V_63 , V_95 ) ;
if ( V_37 < 0 ) {
F_10 ( & V_15 ) ;
goto V_100;
}
...
void F_97 ( unsigned int V_36 , unsigned int V_63 )
{
...
for ( V_45 = 0 ; V_45 < V_63 ; V_45 ++ )
F_77 ( V_36 + V_45 ) ;
F_92 ( V_53 -> V_10 , V_36 , V_63 ) ;
F_10 ( & V_15 ) ;
F_80 ( V_36 , V_63 ) ;
F_96 ( V_36 , V_63 ) ;
}
int F_98 ( struct V_1 * V_10 ,
...
V_10 = V_10 -> V_84 ;
if ( V_10 )
return F_94 ( V_10 , V_42 ,
V_63 , V_95 ) ;
return - V_98 ;
}
void F_88 ( struct V_1 * V_10 ,
unsigned int V_42 , unsigned int V_63 )
{
if ( ! F_91 ( V_10 ) && V_10 -> V_84 )
F_92 ( V_10 -> V_84 , V_42 ,
V_63 ) ;
}
