...
struct V_372 * V_373 =
& V_4 -> V_11 . V_373 ;
struct V_374 * V_375 = V_79 ;
struct V_376 * V_228 ;
T_1 V_377 , V_378 , V_60 ;
struct V_379 * V_380 ;
V_4 -> V_6 = F_2 ( V_381 ) ;
V_4 -> V_8 = F_2 ( V_10 ) ;
V_373 -> V_13 = F_2 ( V_5 ) ;
V_373 -> V_382 = F_2 ( V_375 -> V_382 ) ;
V_380 = V_373 -> V_380 ;
for ( V_377 = 0 ; V_377 < V_375 -> V_382 ; V_377 ++ ) {
V_380 -> V_231 . type = F_2 ( V_383 ) ;
V_380 -> V_384 =
F_2 ( V_375 -> V_380 [ V_377 ] . V_384 ) ;
V_380 -> V_385 = V_375 -> V_380 [ V_377 ] . V_385 ;
V_380 -> V_386 = V_375 -> V_380 [ V_377 ] . V_386 ;
V_60 = 0 ;
V_228 = V_380 -> V_11 ;
for ( V_378 = 0 ; V_378 < V_375 -> V_380 [ V_377 ] . V_386 ; V_378 ++ ) {
V_228 -> V_387 = V_375 -> V_380 [ V_377 ] . V_11 [ V_378 ] . V_387 ;
V_228 -> V_388 =
V_375 -> V_380 [ V_377 ] . V_11 [ V_378 ] . V_388 ;
V_228 -> V_264 =
F_2 ( V_375 -> V_380 [ V_377 ] . V_11 [ V_378 ] . V_264 ) ;
memcpy ( V_228 -> V_389 ,
V_375 -> V_380 [ V_377 ] . V_11 [ V_378 ] . V_389 ,
V_228 -> V_388 ) ;
V_60 += sizeof( struct V_376 ) ;
V_228 ++ ;
}
V_380 -> V_231 . V_168 = F_2 ( V_60 + sizeof( T_1 ) +
sizeof( V_58 ) + sizeof( V_58 ) ) ;
F_6 ( & V_4 -> V_8 , F_7 ( V_380 -> V_231 . V_168 ) +
sizeof( struct V_61 ) ) ;
V_380 = ( void * ) ( ( V_58 * ) V_380 -> V_11 + V_60 ) ;
}
...
V_58 * V_315 , V_410 ;
T_1 V_411 = 0 ;
struct V_412 * V_11 = V_2 -> V_413 ;
V_4 -> V_6 = F_2 ( V_414 ) ;
V_4 -> V_8 = F_2 ( V_10 ) ;
F_6 ( & V_4 -> V_8 , sizeof( struct V_390 ) ) ;
V_391 -> V_415 = 0 ;
memcpy ( V_391 -> V_416 , V_393 -> V_416 , V_126 ) ;
V_395 = F_47 ( V_2 , V_393 -> V_416 ) ;
V_315 = ( V_58 * ) V_391 + sizeof( struct V_390 ) ;
switch ( V_393 -> V_417 ) {
case V_418 :
V_391 -> V_417 = F_2 ( V_419 ) ;
break;
case V_420 :
V_391 -> V_417 = F_2 ( V_421 ) ;
break;
case V_422 :
V_391 -> V_417 = F_2 ( V_423 ) ;
if ( ! V_11 ) {
F_4 ( V_2 -> V_29 , ERROR ,
L_31 ,
V_393 -> V_416 ) ;
...
* ( V_43 * ) V_315 = F_2 ( V_11 -> V_425 ) ;
V_411 += sizeof( V_11 -> V_425 ) ;
V_410 = V_11 -> V_426 | ( V_11 -> V_427 << 5 ) ;
V_401 = (struct V_400 * ) ( V_315 +
V_411 ) ;
V_401 -> V_231 . type = F_2 ( V_428 ) ;
V_401 -> V_231 . V_168 = F_2 ( sizeof( V_410 ) ) ;
V_401 -> V_410 = V_410 ;
V_411 += sizeof( struct V_400 ) ;
if ( V_11 -> V_429 ) {
V_399 = (struct V_398 * ) ( V_315 +
V_411 ) ;
V_399 -> V_231 . type =
F_2 ( V_430 ) ;
V_399 -> V_231 . V_168 =
F_2 ( sizeof( struct V_431 ) ) ;
memcpy ( & V_399 -> V_432 , V_11 -> V_429 ,
sizeof( struct V_431 ) ) ;
V_411 += sizeof( struct V_398 ) ;
}
if ( V_11 -> V_433 && V_11 -> V_434 ) {
V_397 = (struct V_396 * ) ( V_315 +
V_411 ) ;
V_397 -> V_231 . type =
F_2 ( V_435 ) ;
V_397 -> V_231 . V_168 =
F_2 ( V_11 -> V_434 ) ;
memcpy ( V_397 -> V_436 , V_11 -> V_433 ,
V_11 -> V_434 ) ;
V_411 += sizeof( struct V_396 ) +
V_11 -> V_434 ;
}
if ( V_11 -> V_437 && V_11 -> V_438 ) {
V_403 = (struct V_402 * ) ( V_315 +
V_411 ) ;
V_403 -> V_231 . type =
F_2 ( V_439 ) ;
V_403 -> V_231 . V_168 = F_2 ( V_11 -> V_438 ) ;
memcpy ( V_403 -> V_437 , V_11 -> V_437 ,
V_11 -> V_438 ) ;
V_411 += sizeof( struct V_402 ) +
V_11 -> V_438 ;
}
if ( V_11 -> V_440 ) {
V_405 = (struct V_404 * ) ( V_315 +
V_411 ) ;
V_405 -> V_231 . type =
F_2 ( V_441 ) ;
V_405 -> V_231 . V_168 =
F_2 ( sizeof( struct V_442 ) ) ;
memcpy ( & V_405 -> V_443 , V_11 -> V_440 ,
sizeof( struct V_442 ) ) ;
V_411 += sizeof( struct V_404 ) ;
}
if ( V_11 -> V_407 ) {
V_407 = (struct V_406 * ) ( V_315 + V_411 ) ;
V_407 -> V_231 . type = F_2 ( V_444 ) ;
V_407 -> V_231 . V_168 = F_2 ( sizeof( V_11 -> V_407 ) ) ;
V_407 -> V_407 = F_2 ( V_11 -> V_407 ) ;
V_411 += sizeof( struct V_406 ) ;
}
V_409 = ( void * ) ( V_315 + V_411 ) ;
V_409 -> V_231 . type = F_2 ( V_445 ) ;
V_409 -> V_231 . V_168 = F_2 ( sizeof( V_409 -> V_44 ) ) ;
V_409 -> V_44 = F_2 ( V_446 ) ;
V_411 += sizeof( struct V_408 ) ;
break;
default:
F_4 ( V_2 -> V_29 , ERROR , L_32 ) ;
return - V_447 ;
}
F_6 ( & V_4 -> V_8 , V_411 ) ;
return 0 ;
...
V_375 -> V_13 = V_5 ;
if ( V_5 == V_28 )
V_375 -> V_246 = * ( V_58 * ) V_79 ;
return 0 ;
}
int F_49 ( struct V_1 * V_2 , T_4 V_451 ,
T_1 V_5 , T_2 V_31 ,
void * V_79 , void * V_452 )
{
struct V_3 * V_453 = V_452 ;
int V_223 = 0 ;
switch ( V_451 ) {
case V_454 :
V_223 = F_50 ( V_2 , V_453 ) ;
break;
case V_368 :
V_223 = F_43 ( V_2 , V_453 , V_79 ) ;
break;
case V_30 :
V_223 = F_3 ( V_2 , V_453 , V_5 ,
V_79 ) ;
break;
case V_121 :
V_223 = F_16 ( V_2 , V_453 ,
V_5 ) ;
break;
case V_132 :
V_223 = F_17 ( V_453 , V_5 ,
V_79 ) ;
break;
case V_56 :
V_223 = F_9 ( V_2 , V_453 , V_5 ,
V_79 ) ;
break;
case V_77 :
V_223 = F_11 ( V_453 , V_5 ,
V_79 ) ;
break;
case V_81 :
V_223 = F_12 ( V_2 , V_453 , V_5 ,
V_79 ) ;
break;
case V_88 :
V_223 = F_13 ( V_2 , V_453 , V_5 ,
V_79 ) ;
break;
case V_455 :
V_223 = F_51 ( V_2 , V_453 , V_5 ,
( T_4 ) V_31 , V_79 ) ;
break;
case V_108 :
V_223 = F_14 ( V_2 , V_453 , V_5 ,
(struct V_101 * ) V_79 ) ;
break;
case V_456 :
V_223 = F_52 ( V_453 , V_79 ) ;
break;
case V_457 :
V_223 = F_53 ( V_453 ) ;
break;
case V_458 :
V_223 = F_54 ( V_2 , V_453 , V_79 ) ;
break;
case V_139 :
V_223 = F_18 ( V_2 , V_453 ,
V_79 ) ;
break;
case V_459 :
V_223 = F_55 ( V_2 , V_453 ,
V_79 ) ;
break;
case V_45 :
V_223 = F_8 ( V_453 ) ;
...
break;
case V_7 :
V_223 = F_1 ( V_2 , V_453 , V_5 ) ;
break;
case V_37 :
V_223 = F_5 ( V_2 , V_453 , V_5 ,
V_31 , V_79 ) ;
break;
case V_461 :
V_453 -> V_6 =
...
case V_464 :
V_453 -> V_6 = F_2 ( V_451 ) ;
V_453 -> V_11 . V_465 . V_466 =
( V_58 ) ( * ( ( T_2 * ) V_79 ) ) ;
memcpy ( & V_453 -> V_11 , V_79 ,
sizeof( struct V_467 ) ) ;
V_453 -> V_8 =
...
case V_468 :
V_453 -> V_6 = F_2 ( V_451 ) ;
V_453 -> V_11 . V_469 . V_13 = F_2 ( V_5 ) ;
V_453 -> V_11 . V_469 . V_470 = F_15 ( * ( T_2 * ) V_79 ) ;
V_453 -> V_8 =
F_2 ( sizeof( struct V_471 ) +
V_10 ) ;
V_223 = 0 ;
break;
case V_472 :
...
sizeof( struct V_473 ) ) ;
V_453 -> V_8 =
F_2 ( sizeof( struct V_473 ) +
V_10 ) ;
break;
case V_474 :
V_223 = F_57 ( V_2 , V_453 , V_5 , V_79 ) ;
break;
case V_475 :
V_453 -> V_6 = F_2 ( V_451 ) ;
V_453 -> V_11 . V_476 . V_13 = F_2 ( V_5 ) ;
V_453 -> V_11 . V_476 . V_78 = F_2 ( * ( T_1 * ) V_79 ) ;
V_453 -> V_8 =
F_2 ( sizeof( struct V_477 ) +
V_10 ) ;
break;
case V_478 :
if ( V_2 -> V_29 -> V_479 == V_480 )
V_2 -> V_29 -> V_479 = V_481 ;
V_453 -> V_6 = F_2 ( V_451 ) ;
V_453 -> V_8 = F_2 ( V_10 ) ;
break;
case V_482 :
V_2 -> V_29 -> V_479 = V_480 ;
V_453 -> V_6 = F_2 ( V_451 ) ;
V_453 -> V_8 = F_2 ( V_10 ) ;
break;
case V_483 :
V_223 = F_58 ( V_453 , V_79 ) ;
break;
case V_484 :
V_223 = F_59 ( V_453 , V_79 ) ;
break;
case V_485 :
V_223 = F_60 ( V_2 , V_453 , V_79 ) ;
break;
case V_187 :
V_223 = F_27 ( V_2 , V_453 ,
V_5 , V_31 ,
V_79 ) ;
break;
case V_241 :
V_223 = F_28 ( V_2 , V_453 ,
V_5 ) ;
break;
case V_486 :
V_223 = F_61 ( V_2 , V_453 , V_5 ,
V_79 ) ;
break;
case V_487 :
V_223 = F_62 ( V_453 , V_5 ,
V_79 ) ;
break;
case V_488 :
V_223 = F_63 ( V_2 , V_453 , V_5 , V_79 ) ;
break;
case V_489 :
F_4 ( V_2 -> V_29 , V_36 ,
L_33 ) ;
...
break;
case V_250 :
V_223 = F_29 ( V_453 , V_5 ,
V_79 ) ;
break;
case V_491 :
V_223 = F_64 ( V_2 , V_453 , V_79 ) ;
break;
case V_257 :
V_223 = F_30 ( V_453 , V_5 , V_79 ) ;
break;
case V_261 :
case V_265 :
case V_268 :
...
case V_274 :
case V_276 :
V_223 = F_31 ( V_453 , V_5 , V_79 ) ;
break;
case V_492 :
V_453 -> V_6 = F_2 ( V_451 ) ;
if ( V_2 -> V_210 == V_211 )
V_453 -> V_11 . V_210 . V_493 =
V_494 ;
else if ( V_2 -> V_210 == V_495 )
V_453 -> V_11 . V_210 . V_493 =
V_496 ;
else if ( V_2 -> V_210 == V_497 )
V_453 -> V_11 . V_210 . V_493 = V_498 ;
V_453 -> V_8 = F_2 ( sizeof( struct
V_499 ) + V_10 ) ;
V_223 = 0 ;
break;
case V_288 :
V_223 = F_33 ( V_2 , V_453 , V_5 ) ;
break;
case V_316 :
V_223 = F_34 ( V_2 , V_453 , V_79 ) ;
break;
case V_352 :
V_223 = F_36 ( V_2 , V_453 , V_79 ) ;
break;
case V_381 :
V_223 = F_45 ( V_2 , V_453 , V_5 ,
V_79 ) ;
break;
case V_414 :
V_223 = F_46 ( V_2 , V_453 , V_79 ) ;
break;
case V_500 :
V_223 = F_65 ( V_2 , V_453 ,
V_79 ) ;
break;
case V_450 :
V_223 = F_48 ( V_453 , V_5 ,
V_79 ) ;
break;
default:
F_4 ( V_2 -> V_29 , ERROR ,
...
int F_66 ( struct V_1 * V_2 , V_58 V_501 , bool V_502 )
{
struct V_103 * V_29 = V_2 -> V_29 ;
int V_223 ;
T_1 V_246 = true ;
...
V_223 = F_42 ( V_2 , V_454 ,
V_39 , 0 , NULL , true ) ;
if ( V_223 )
return - 1 ;
if ( V_2 -> V_29 -> V_512 == V_514 &&
F_68 ( V_2 -> V_29 -> V_515 ) ) {
V_511 = true ;
V_223 = F_42 ( V_2 ,
V_450 ,
...
return - 1 ;
if ( ! V_527 &&
V_501 && V_2 -> V_29 -> V_512 != V_528 &&
V_2 -> V_518 != V_519 ) {
V_506 . V_506 = V_529 ;
V_506 . V_530 = V_531 ;
V_223 = F_42 ( V_2 , V_455 ,
V_522 , V_532 ,
& V_506 , true ) ;
if ( V_223 )
return - 1 ;
...
V_510 . V_535 = V_536 ;
V_223 = F_42 ( V_2 , V_488 ,
V_28 , 0 , & V_510 , true ) ;
if ( V_502 ) {
V_2 -> V_29 -> V_537 = V_488 ;
V_223 = - V_538 ;
}
return V_223 ;
}
