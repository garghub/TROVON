...
struct V_96 * V_97 ;
int V_38 = - V_82 ;
V_97 = F_165 ( F_180 ( type ) , V_279 ) ;
if ( ! V_97 )
goto V_104;
V_38 = F_181 ( V_97 , V_84 , V_271 , 0 , 0 ,
V_280 , 0 , type ) ;
if ( V_38 < 0 ) {
F_30 ( V_38 == - V_232 ) ;
F_166 ( V_97 ) ;
...
F_167 ( V_97 , V_1 , 0 , V_281 , NULL , V_279 ) ;
return;
V_104:
if ( V_38 < 0 )
F_168 ( V_1 , V_281 , V_38 ) ;
}
static int F_184 ( struct V_96 * V_282 ,
struct V_56 * V_57 )
{
struct V_1 * V_1 = F_82 ( V_282 -> V_88 ) ;
struct V_98 * V_99 [ V_283 + 1 ] ;
struct V_264 * V_272 ;
struct V_96 * V_97 ;
struct V_270 * V_271 ;
struct V_26 * V_37 ;
...
int V_84 ;
int V_38 ;
V_38 = F_83 ( V_57 , sizeof( * V_272 ) , V_99 , V_283 ,
V_284 ) ;
if ( V_38 < 0 )
goto V_104;
V_38 = V_79 ;
if ( ! V_99 [ V_274 ] )
goto V_104;
V_84 = F_185 ( V_99 [ V_274 ] ) ;
switch ( V_84 ) {
case V_285 :
V_271 = V_1 -> V_42 . V_286 ;
break;
case V_287 :
V_271 = V_1 -> V_42 . V_43 ;
break;
...
V_38 = - V_82 ;
V_97 = F_165 ( F_180 ( - 1 ) , V_279 ) ;
if ( ! V_97 )
goto V_104;
V_38 = F_181 ( V_97 , V_84 , V_271 ,
F_88 ( V_282 ) . V_58 ,
V_57 -> V_250 , V_280 , 0 ,
- 1 ) ;
if ( V_38 < 0 ) {
...
V_38 = F_186 ( V_97 , V_1 , F_88 ( V_282 ) . V_58 ) ;
V_104:
return V_38 ;
}
...
struct V_26 * V_37 ;
V_37 = F_126 ( V_14 ) ;
if ( V_37 && ! F_189 ( V_121 , V_37 -> V_41 . V_288 ) )
...
{
struct V_11 * V_14 ;
int V_289 = F_191 ( V_1 , V_48 ) ;
F_191 ( V_1 , V_290 ) = ! V_289 ;
F_192 ( V_1 , V_48 ) = V_289 ;
F_183 ( V_1 , V_265 ,
V_285 ,
V_1 -> V_42 . V_286 ) ;
F_183 ( V_1 , V_265 ,
...
static int F_194 ( struct V_1 * V_1 , struct V_270 * V_41 )
{
if ( V_41 == V_1 -> V_42 . V_43 )
return V_287 ;
else if ( V_41 == V_1 -> V_42 . V_286 )
return V_285 ;
else {
struct V_26 * V_27
...
static int F_195 ( struct V_291 * V_292 , int V_293 ,
void T_4 * V_294 ,
T_5 * V_295 , T_6 * V_296 )
{
int V_297 = * ( int * ) V_292 -> V_257 ;
int V_95 = F_196 ( V_292 , V_293 , V_294 , V_295 , V_296 ) ;
int V_298 = * ( int * ) V_292 -> V_257 ;
if ( V_293 ) {
struct V_270 * V_41 = V_292 -> V_299 ;
struct V_1 * V_1 = V_292 -> V_300 ;
int V_121 = ( int * ) V_292 -> V_257 - V_41 -> V_257 ;
int V_84 ;
F_197 ( V_121 , V_41 -> V_288 ) ;
if ( V_41 == V_1 -> V_42 . V_43 )
F_188 ( V_1 , V_121 ) ;
if ( V_121 == V_301 - 1 ||
V_121 == V_302 - 1 )
...
static int F_199 ( struct V_291 * V_292 , int V_293 ,
void T_4 * V_294 ,
T_5 * V_295 , T_6 * V_296 )
{
int * V_306 = V_292 -> V_257 ;
int V_3 = * V_306 ;
T_6 V_307 = * V_296 ;
int V_95 = F_196 ( V_292 , V_293 , V_294 , V_295 , V_296 ) ;
if ( V_293 && * V_306 != V_3 ) {
struct V_1 * V_1 = V_292 -> V_300 ;
if ( V_306 != & F_192 ( V_1 , V_48 ) ) {
if ( ! F_200 () ) {
* V_306 = V_3 ;
* V_296 = V_307 ;
return F_201 () ;
}
if ( V_306 == & F_191 ( V_1 , V_48 ) ) {
F_190 ( V_1 ) ;
} else {
struct V_270 * V_41 = V_292 -> V_299 ;
struct V_26 * V_27 =
...
static int F_202 ( struct V_291 * V_292 , int V_293 ,
void T_4 * V_294 ,
T_5 * V_295 , T_6 * V_296 )
{
int * V_306 = V_292 -> V_257 ;
...
static int F_203 ( struct V_1 * V_1 , char * V_308 ,
struct V_270 * V_309 )
{
int V_121 ;
struct V_310 * V_311 ;
char V_312 [ sizeof( L_6 ) + V_146 ] ;
V_311 = F_204 ( & V_313 , sizeof( * V_311 ) , V_28 ) ;
if ( ! V_311 )
goto V_40;
for ( V_121 = 0 ; V_121 < F_205 ( V_311 -> V_314 ) - 1 ; V_121 ++ ) {
V_311 -> V_314 [ V_121 ] . V_257 += ( char * ) V_309 - ( char * ) & V_270 ;
V_311 -> V_314 [ V_121 ] . V_299 = V_309 ;
V_311 -> V_314 [ V_121 ] . V_300 = V_1 ;
}
snprintf ( V_312 , sizeof( V_312 ) , L_7 , V_308 ) ;
V_311 -> V_315 = F_206 ( V_1 , V_312 , V_311 -> V_314 ) ;
if ( ! V_311 -> V_315 )
goto free;
V_309 -> V_44 = V_311 ;
return 0 ;
...
static void F_207 ( struct V_270 * V_41 )
{
struct V_310 * V_311 = V_41 -> V_44 ;
if ( ! V_311 )
return;
V_41 -> V_44 = NULL ;
F_208 ( V_311 -> V_315 ) ;
...
V_317 = & V_322 ;
if ( ! F_12 ( V_1 , & V_323 ) ) {
V_316 = F_204 ( V_316 , sizeof( V_270 ) , V_28 ) ;
if ( ! V_316 )
goto V_324;
V_317 = F_204 ( V_317 , sizeof( V_322 ) , V_28 ) ;
if ( ! V_317 )
goto V_325;
#ifdef F_213
V_318 = F_204 ( V_318 , sizeof( V_319 ) , V_28 ) ;
if ( ! V_318 )
goto V_326;
V_318 [ 0 ] . V_257 = & V_316 -> V_257 [ V_327 - 1 ] ;
V_318 [ 0 ] . V_299 = V_316 ;
V_318 [ 0 ] . V_300 = V_1 ;
#endif
}
#ifdef F_213
V_38 = F_203 ( V_1 , L_8 , V_316 ) ;
if ( V_38 < 0 )
goto V_328;
V_38 = F_203 ( V_1 , L_9 , V_317 ) ;
if ( V_38 < 0 )
goto V_329;
V_38 = - V_39 ;
V_321 = F_206 ( V_1 , L_10 , V_318 ) ;
if ( ! V_321 )
goto V_330;
V_1 -> V_42 . V_321 = V_321 ;
#endif
V_1 -> V_42 . V_286 = V_316 ;
V_1 -> V_42 . V_43 = V_317 ;
return 0 ;
#ifdef F_213
V_330:
...
#ifdef F_213
struct V_291 * V_318 ;
V_318 = V_1 -> V_42 . V_321 -> V_331 ;
F_208 ( V_1 -> V_42 . V_321 ) ;
F_207 ( V_1 -> V_42 . V_43 ) ;
F_207 ( V_1 -> V_42 . V_286 ) ;
F_26 ( V_318 ) ;
#endif
F_26 ( V_1 -> V_42 . V_43 ) ;
F_26 ( V_1 -> V_42 . V_286 ) ;
...
F_65 ( V_81 , & V_80 , 0 ) ;
F_220 ( & V_335 ) ;
F_221 ( V_333 , V_75 , F_106 , NULL , NULL ) ;
F_221 ( V_333 , V_71 , F_81 , NULL , NULL ) ;
F_221 ( V_333 , V_336 , NULL , F_161 , NULL ) ;
F_221 ( V_333 , V_337 , F_184 ,
F_187 , NULL ) ;
}
