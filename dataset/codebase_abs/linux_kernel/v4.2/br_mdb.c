...
F_53 ( * V_33 , V_10 ) ;
if ( V_42 == V_83 )
F_54 ( & V_10 -> V_96 , V_92 + V_8 -> V_97 ) ;
return 0 ;
}
static int F_55 ( struct V_52 * V_52 , struct V_7 * V_8 ,
struct V_40 * V_68 )
{
struct V_80 V_98 ;
struct V_5 * V_6 ;
struct V_9 * V_10 ;
int V_99 ;
if ( ! F_56 ( V_8 -> V_6 ) || V_8 -> V_27 )
return - V_88 ;
V_6 = F_42 ( V_52 , V_68 -> V_18 ) ;
if ( ! V_6 )
return - V_89 ;
V_10 = F_57 ( V_6 ) ;
if ( ! V_10 || V_10 -> V_8 != V_8 || V_10 -> V_42 == V_100 )
return - V_88 ;
memset ( & V_98 , 0 , sizeof( V_98 ) ) ;
V_98 . V_44 = V_68 -> V_43 . V_44 ;
if ( V_98 . V_44 == F_11 ( V_45 ) )
V_98 . V_46 . V_47 = V_68 -> V_43 . V_46 . V_47 ;
#if F_12 ( V_48 )
else
V_98 . V_46 . V_50 = V_68 -> V_43 . V_46 . V_50 ;
#endif
F_58 ( & V_8 -> V_101 ) ;
V_99 = F_45 ( V_8 , V_10 , & V_98 , V_68 -> V_42 ) ;
F_59 ( & V_8 -> V_101 ) ;
return V_99 ;
}
...
return V_24 ;
V_8 = F_2 ( V_6 ) ;
V_24 = F_55 ( V_52 , V_8 , V_68 ) ;
if ( ! V_24 )
F_28 ( V_6 , V_68 , V_102 ) ;
return V_24 ;
}
static int F_61 ( struct V_7 * V_8 , struct V_40 * V_68 )
{
struct V_20 * V_21 ;
struct V_30 * V_31 ;
struct V_32 * V_10 ;
...
static int F_65 ( struct V_1 * V_2 , struct V_54 * V_55 )
{
struct V_5 * V_6 ;
struct V_40 * V_68 ;
struct V_7 * V_8 ;
...
void F_66 ( void )
{
F_67 ( V_108 , V_65 , NULL , F_14 , NULL ) ;
F_67 ( V_108 , V_102 , F_60 , NULL , NULL ) ;
F_67 ( V_108 , V_107 , F_65 , NULL , NULL ) ;
}
void F_68 ( void )
{
F_69 ( V_108 , V_65 ) ;
