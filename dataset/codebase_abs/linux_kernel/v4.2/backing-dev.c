...
static void F_78 ( struct V_108 * V_98 )
{
...
{
F_81 ( & V_93 ) ;
F_56 ( ! F_82 ( & V_9 -> V_6 -> V_109 , V_9 -> V_102 -> V_110 ) ) ;
F_83 ( & V_9 -> V_111 ) ;
F_83 ( & V_9 -> V_112 ) ;
F_84 ( & V_9 -> V_98 ) ;
}
static int F_85 ( struct V_5 * V_6 ,
struct V_113 * V_102 , T_5 V_65 )
{
struct V_114 * V_115 ;
struct V_113 * V_103 ;
struct V_116 * V_116 ;
...
int V_41 = 0 ;
V_115 = F_86 ( V_102 ) ;
V_103 = F_87 ( V_102 -> V_120 , & V_121 ) ;
V_116 = F_88 ( V_103 ) ;
V_118 = F_89 ( V_115 ) ;
V_119 = & V_116 -> V_122 ;
F_59 ( & V_93 , V_91 ) ;
V_9 = F_90 ( & V_6 -> V_109 , V_102 -> V_110 ) ;
if ( V_9 && V_9 -> V_103 != V_103 ) {
F_80 ( V_9 ) ;
V_9 = NULL ;
}
F_63 ( & V_93 , V_91 ) ;
if ( V_9 )
goto V_123;
V_9 = F_91 ( sizeof( * V_9 ) , V_65 ) ;
if ( ! V_9 )
return - V_57 ;
V_41 = F_42 ( V_9 , V_6 , V_103 -> V_110 , V_65 ) ;
if ( V_41 )
goto V_124;
V_41 = F_92 ( & V_9 -> V_98 , F_78 , 0 , V_65 ) ;
if ( V_41 )
goto V_125;
V_41 = F_47 ( & V_9 -> V_104 , V_65 ) ;
if ( V_41 )
goto V_126;
V_9 -> V_102 = V_102 ;
V_9 -> V_103 = V_103 ;
...
V_119 -> V_128 && V_118 -> V_128 ) {
V_41 = F_95 ( & V_6 -> V_109 , V_102 -> V_110 , V_9 ) ;
if ( ! V_41 ) {
F_66 ( & V_6 -> V_106 ) ;
F_96 ( & V_9 -> V_111 , V_118 ) ;
F_96 ( & V_9 -> V_112 , V_119 ) ;
F_97 ( V_102 ) ;
F_97 ( V_103 ) ;
}
}
...
struct V_8 * F_98 ( struct V_5 * V_6 ,
struct V_113 * V_102 ,
T_5 V_65 )
{
struct V_8 * V_9 ;
...
if ( V_9 ) {
struct V_113 * V_103 ;
V_103 = F_87 ( V_102 -> V_120 ,
& V_121 ) ;
if ( F_101 ( V_9 -> V_103 != V_103 ||
! F_102 ( V_9 ) ) )
V_9 = NULL ;
F_73 ( V_103 ) ;
}
F_103 () ;
} while ( ! V_9 && ! F_85 ( V_6 , V_102 , V_65 ) );
return V_9 ;
}
static int F_104 ( struct V_5 * V_6 )
{
int V_41 ;
F_105 ( & V_6 -> V_109 , V_132 ) ;
V_6 -> V_94 = V_133 ;
F_65 ( & V_6 -> V_106 , 1 ) ;
V_41 = F_42 ( & V_6 -> V_9 , V_6 , 1 , V_134 ) ;
if ( ! V_41 ) {
V_6 -> V_9 . V_102 = V_135 ;
V_6 -> V_9 . V_103 = V_136 ;
}
...
{
struct V_137 V_138 ;
struct V_86 * V_80 , * V_139 ;
void * * V_140 ;
F_56 ( F_39 ( V_62 , & V_6 -> V_9 . V_27 ) ) ;
F_107 ( & V_93 ) ;
F_108 (slot, &bdi->cgwb_tree, &iter, 0 )
F_80 ( * V_140 ) ;
F_109 (congested, congested_n,
&bdi->cgwb_congested_tree, rb_node) {
F_71 ( & V_80 -> V_88 , & V_6 -> V_94 ) ;
V_80 -> V_6 = NULL ;
}
F_110 ( & V_93 ) ;
F_111 ( & V_6 -> V_106 ) ;
F_112 ( V_107 , ! F_113 ( & V_6 -> V_106 ) ) ;
}
void F_114 ( struct V_114 * V_115 )
{
F_115 ( V_141 ) ;
struct V_117 * V_118 = F_89 ( V_115 ) ;
struct V_8 * V_9 , * V_128 ;
F_107 ( & V_93 ) ;
F_116 (wb, next, memcg_cgwb_list, memcg_node)
F_80 ( V_9 ) ;
V_118 -> V_128 = NULL ;
F_110 ( & V_93 ) ;
}
void F_117 ( struct V_116 * V_116 )
{
F_115 ( V_141 ) ;
struct V_8 * V_9 , * V_128 ;
F_107 ( & V_93 ) ;
F_116 (wb, next, &blkcg->cgwb_list, blkcg_node)
F_80 ( V_9 ) ;
V_116 -> V_122 . V_128 = NULL ;
F_110 ( & V_93 ) ;
}
static int F_104 ( struct V_5 * V_6 )
{
int V_51 ;
V_6 -> V_142 = F_64 ( sizeof( * V_6 -> V_142 ) , V_134 ) ;
if ( ! V_6 -> V_142 )
return - V_57 ;
V_51 = F_42 ( & V_6 -> V_9 , V_6 , 1 , V_134 ) ;
if ( V_51 ) {
F_67 ( V_6 -> V_142 ) ;
return V_51 ;
}
...
int F_119 ( struct V_5 * V_6 , struct V_34 * V_90 ,
const char * V_148 , ... )
{
T_6 args ;
struct V_34 * V_35 ;
...
return 0 ;
va_start ( args , V_148 ) ;
V_35 = F_120 ( V_47 , V_90 , F_121 ( 0 , 0 ) , V_6 , V_148 , args ) ;
va_end ( args ) ;
if ( F_31 ( V_35 ) )
return F_32 ( V_35 ) ;
V_6 -> V_35 = V_35 ;
F_15 ( V_6 , F_122 ( V_35 ) ) ;
F_94 ( V_62 , & V_6 -> V_9 . V_27 ) ;
F_38 ( & V_149 ) ;
F_123 ( & V_6 -> V_26 , & V_26 ) ;
F_41 ( & V_149 ) ;
F_124 ( V_6 ) ;
...
int F_125 ( struct V_5 * V_6 , T_7 V_35 )
{
return F_119 ( V_6 , NULL , L_19 , F_126 ( V_35 ) , F_127 ( V_35 ) ) ;
}
...
int F_133 ( struct V_5 * V_6 , char * V_30 )
{
int V_51 ;
V_6 -> V_30 = V_30 ;
V_6 -> V_150 = 0 ;
...
void F_135 ( struct V_86 * V_80 , int V_152 )
{
T_8 * V_153 = & V_154 [ V_152 ] ;
enum V_155 V_156 ;
V_156 = V_152 ? V_157 : V_158 ;
if ( F_53 ( V_156 , & V_80 -> V_27 ) )
F_111 ( & V_159 [ V_152 ] ) ;
F_136 () ;
if ( F_137 ( V_153 ) )
F_138 ( V_153 ) ;
}
void F_139 ( struct V_86 * V_80 , int V_152 )
{
enum V_155 V_156 ;
V_156 = V_152 ? V_157 : V_158 ;
if ( ! F_140 ( V_156 , & V_80 -> V_27 ) )
F_66 ( & V_159 [ V_152 ] ) ;
}
long F_141 ( int V_152 , long V_59 )
{
long V_41 ;
unsigned long V_160 = V_68 ;
F_142 ( V_161 ) ;
T_8 * V_153 = & V_154 [ V_152 ] ;
F_143 ( V_153 , & V_161 , V_162 ) ;
V_41 = F_144 ( V_59 ) ;
F_145 ( V_153 , & V_161 ) ;
F_146 ( F_147 ( V_59 ) ,
F_147 ( V_68 - V_160 ) ) ;
...
long F_148 ( struct V_163 * V_163 , int V_152 , long V_59 )
{
long V_41 ;
unsigned long V_160 = V_68 ;
F_142 ( V_161 ) ;
T_8 * V_153 = & V_154 [ V_152 ] ;
if ( F_113 ( & V_159 [ V_152 ] ) == 0 ||
! F_39 ( V_164 , & V_163 -> V_91 ) ) {
F_149 () ;
V_41 = V_59 - ( V_68 - V_160 ) ;
if ( V_41 < 0 )
V_41 = 0 ;
goto V_165;
}
...
int F_151 ( struct V_166 * V_167 , int V_168 ,
void T_9 * V_169 , T_3 * V_170 , T_10 * V_171 )
{
char V_172 [] = L_21 ;
if ( * V_171 || * V_170 < sizeof( V_172 ) ) {
* V_170 = 0 ;
return 0 ;
}
if ( F_152 ( V_169 , V_172 , sizeof( V_172 ) ) )
return - V_173 ;
F_153 ( V_174 L_22 ,
V_167 -> V_175 ) ;
* V_170 = 2 ;
