...
static bool F_49 ( struct V_22 * V_23 )
{
F_4 ( L_20 ,
...
while ( * V_2 ) {
V_89 = * V_2 ;
V_81 = F_58 ( V_89 , struct V_79 , V_85 ) ;
...
F_61 ( & V_88 -> V_85 , V_89 , V_2 ) ;
F_62 ( & V_88 -> V_85 , & V_23 -> V_84 ) ;
}
static void F_63 ( struct V_90 * V_90 )
{
struct V_79 * V_81 =
F_64 ( V_90 , struct V_79 , V_90 ) ;
if ( V_81 -> V_91 )
F_65 ( V_81 -> V_91 ) ;
if ( V_81 -> V_92 )
F_65 ( V_81 -> V_92 ) ;
...
static void F_66 ( struct V_79 * V_81 )
{
F_67 ( & V_81 -> V_90 , F_63 ) ;
}
static void F_68 ( struct V_79 * V_81 )
{
F_69 ( & V_81 -> V_90 ) ;
}
static struct V_49 * F_70 ( struct V_93 * V_30 ,
struct V_94 * V_28 ,
int * V_95 )
{
struct V_22 * V_23 = V_30 -> V_96 ;
struct V_79 * V_81 ;
T_3 V_80 = F_71 ( V_28 -> V_80 ) ;
struct V_49 * V_4 ;
F_37 ( & V_23 -> V_62 ) ;
V_81 = F_57 ( V_23 , V_80 ) ;
if ( ! V_81 ) {
...
static int F_72 ( struct V_22 * V_23 , T_3 V_80 ,
struct V_79 * V_81 )
{
int V_6 ;
...
int F_78 ( struct V_22 * V_23 , struct V_102 * V_103 )
{
struct V_79 * V_81 ;
struct V_105 * V_60 ;
int V_6 ;
V_81 = F_79 ( sizeof( * V_81 ) , V_17 ) ;
if ( ! V_81 )
return - V_18 ;
F_80 ( & V_81 -> V_90 ) ;
V_81 -> V_103 = V_103 ;
F_81 ( & V_81 -> V_99 ) ;
V_6 = - V_18 ;
V_81 -> V_92 = F_82 ( V_106 , sizeof( * V_60 ) , V_17 ,
true ) ;
if ( ! V_81 -> V_92 )
goto V_77;
V_81 -> V_91 = F_82 ( V_107 , 1024 , V_17 ,
true ) ;
if ( ! V_81 -> V_91 )
goto V_77;
V_60 = V_81 -> V_92 -> V_26 . V_44 ;
V_60 -> V_108 . V_109 = 0 ;
V_60 -> V_108 . V_110 = F_83 ( - 1 ) ;
V_60 -> V_108 . V_111 = 0 ;
...
goto V_14;
F_37 ( & V_23 -> V_62 ) ;
V_81 = F_57 ( V_23 , V_112 ) ;
if ( V_81 ) {
* ( T_3 * ) V_81 -> V_103 = F_85 ( & V_2 ) ;
V_81 -> V_100 = 0 ;
F_68 ( V_81 ) ;
}
F_39 ( & V_23 -> V_62 ) ;
...
int F_86 ( struct V_22 * V_23 , const char * V_114 ,
T_3 * V_115 )
{
struct V_79 * V_81 ;
void * V_2 , * V_3 ;
...
struct V_79 * V_81 ;
struct V_82 * V_2 ;
for ( V_2 = F_89 ( & V_23 -> V_84 ) ; V_2 ; V_2 = F_90 ( V_2 ) ) {
V_81 = F_58 ( V_2 , struct V_79 , V_85 ) ;
F_16 ( V_81 -> V_92 ) ;
F_20 ( V_81 -> V_91 ) ;
F_18 ( & V_23 -> V_30 , F_17 ( V_81 -> V_92 ) ) ;
}
...
{
struct V_22 * V_23 =
F_64 ( V_119 , struct V_22 , V_48 . V_119 ) ;
F_4 ( L_30 ) ;
F_37 ( & V_23 -> V_62 ) ;
if ( V_23 -> V_63 ) {
F_19 ( V_23 ) ;
...
int V_11 = V_121 -> V_11 ;
int V_5 ;
V_23 -> V_38 = F_79 ( sizeof( * V_23 -> V_38 ) +
...
int F_95 ( struct V_22 * V_23 , struct V_73 * V_127 )
{
int V_6 = 0 ;
F_4 ( L_31 ) ;
...
if ( V_6 )
goto V_77;
V_23 -> V_35 = F_97 ( V_127 -> V_122 -> V_126 ,
V_127 -> V_122 -> V_128 ) ;
if ( F_51 ( V_23 -> V_35 ) ) {
V_6 = F_52 ( V_23 -> V_35 ) ;
goto V_129;
...
V_132 | V_133 ;
V_6 = - V_18 ;
V_23 -> V_34 = F_82 ( V_134 ,
sizeof( struct V_59 ) ,
V_17 , true ) ;
if ( ! V_23 -> V_34 )
goto V_135;
V_23 -> V_33 = F_82 ( V_136 , 96 , V_17 ,
true ) ;
if ( ! V_23 -> V_33 )
goto V_137;
V_23 -> V_32 = F_82 ( V_138 , 4096 , V_17 ,
true ) ;
if ( ! V_23 -> V_32 )
goto V_139;
V_23 -> V_25 = F_82 ( V_140 , 4096 , V_17 , true ) ;
V_23 -> V_24 = 0 ;
if ( ! V_23 -> V_25 )
goto V_141;
F_98 ( & V_23 -> V_30 , V_23 , & V_142 ,
& V_23 -> V_69 -> V_143 ) ;
V_23 -> V_31 = - 1 ;
V_23 -> V_63 = true ;
V_23 -> V_40 = V_41 ;
...
F_37 ( & V_23 -> V_62 ) ;
V_75 = F_49 ( V_23 ) ;
V_145 = F_93 ( V_23 -> V_35 ) ;
V_23 -> V_24 = 0 ;
V_37 = F_105 ( V_23 -> V_35 , V_50 -> V_26 . V_44 ,
V_50 -> V_26 . V_27 ,
V_23 -> V_25 -> V_26 . V_44 ,
V_23 -> V_25 -> V_45 ) ;
if ( V_37 < 0 ) {
...
if ( V_23 -> V_24 )
return 0 ;
V_37 = F_106 ( V_23 -> V_35 , V_23 -> V_25 -> V_26 . V_44 ,
V_23 -> V_25 -> V_45 ) ;
if ( V_37 <= 0 )
return V_37 ;
F_14 ( V_23 , V_37 ) ;
...
static void F_108 ( struct V_93 * V_30 , struct V_49 * V_50 )
{
struct V_22 * V_23 = V_30 -> V_96 ;
int type = F_109 ( V_50 -> V_28 . type ) ;
if ( ! V_23 )
return;
switch ( type ) {
case V_138 :
...
static struct V_49 * F_112 ( struct V_93 * V_30 ,
struct V_94 * V_28 ,
int * V_95 )
{
struct V_22 * V_23 = V_30 -> V_96 ;
int type = F_109 ( V_28 -> type ) ;
...
F_71 ( V_30 -> V_154 . V_52 ) ) ;
F_65 ( V_4 ) ;
V_4 = F_82 ( type , V_29 , V_17 , false ) ;
}
return V_4 ;
}
static void F_114 ( struct V_93 * V_30 )
{
struct V_22 * V_23 = V_30 -> V_96 ;
if ( ! V_23 )
return;
...
static struct V_93 * F_115 ( struct V_93 * V_30 )
{
return V_30 ;
}
static void F_116 ( struct V_93 * V_30 )
{
}
