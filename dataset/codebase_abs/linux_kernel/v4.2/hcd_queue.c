...
V_4 -> V_35 ) ;
if ( F_44 ( V_4 -> V_32 , V_33 ) )
V_4 -> V_32 = V_33 ;
V_4 -> V_32 |= 0x7 ;
V_4 -> V_41 = V_4 -> V_32 ;
}
}
void F_45 ( struct V_1 * V_2 , struct V_3 * V_4 ,
int V_81 )
{
T_4 V_33 ;
if ( F_38 ( V_4 ) )
