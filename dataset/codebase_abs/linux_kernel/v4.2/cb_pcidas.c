...
struct V_89 * V_90 = & V_121 -> V_90 ;
unsigned int V_24 ;
unsigned long V_41 ;
F_13 ( 0 , V_6 -> V_16 + V_28 ) ;
F_13 ( 0 , V_6 -> V_16 + V_122 ) ;
F_13 ( 0 , V_6 -> V_33 + V_34 ) ;
...
F_13 ( V_6 -> V_125 | V_132 | INT | V_133 ,
V_6 -> V_16 + V_134 ) ;
F_22 ( & V_4 -> V_42 , V_41 ) ;
V_24 = 0 ;
if ( V_90 -> V_98 == V_99 ) {
...
unsigned int V_91 = F_10 ( V_90 -> V_92 [ 0 ] ) ;
if ( V_90 -> V_94 > 1 ) {
unsigned int V_142 = F_10 ( V_90 -> V_92 [ 1 ] ) ;
if ( V_91 != 0 || V_142 != 1 ) {
F_40 ( V_4 -> V_39 ,
L_5 ) ;
return - V_40 ;
...
unsigned long V_41 ;
F_21 ( & V_4 -> V_42 , V_41 ) ;
V_6 -> V_125 &= ~ V_126 & ~ V_146 ;
F_13 ( V_6 -> V_125 , V_6 -> V_16 + V_134 ) ;
F_22 ( & V_4 -> V_42 , V_41 ) ;
F_13 ( 0 , V_6 -> V_16 + V_122 ) ;
...
struct V_5 * V_6 = V_4 -> V_7 ;
unsigned int V_148 ;
V_147 = F_54 ( V_11 , V_147 ) ;
V_148 = F_55 ( V_11 , V_6 -> V_149 , V_147 ) ;
V_147 = F_56 ( V_11 , V_148 ) ;
F_57 ( V_6 -> V_48 + V_52 , V_6 -> V_149 , V_147 ) ;
}
...
if ( V_150 != V_90 -> V_109 )
return - V_40 ;
F_53 ( V_4 , V_11 , V_84 -> V_151 ) ;
F_21 ( & V_4 -> V_42 , V_41 ) ;
V_6 -> V_125 |= V_152 | V_153 ;
F_13 ( V_6 -> V_125 | V_154 | V_155 ,
V_6 -> V_16 + V_134 ) ;
V_6 -> V_43 |= V_51 | V_45 | V_156 ;
F_13 ( V_6 -> V_43 , V_6 -> V_16 + V_46 ) ;
F_22 ( & V_4 -> V_42 , V_41 ) ;
V_121 -> V_157 = NULL ;
return 0 ;
...
const struct V_83 * V_84 = V_4 -> V_85 ;
struct V_5 * V_6 = V_4 -> V_7 ;
struct V_10 * V_11 = V_4 -> V_160 ;
struct V_120 * V_121 = V_11 -> V_121 ;
struct V_89 * V_90 = & V_121 -> V_90 ;
unsigned long V_41 ;
if ( V_15 & V_154 ) {
F_21 ( & V_4 -> V_42 , V_41 ) ;
F_13 ( V_6 -> V_125 | V_154 ,
V_6 -> V_16 + V_134 ) ;
F_22 ( & V_4 -> V_42 , V_41 ) ;
if ( F_8 ( V_6 -> V_48 + V_46 ) & V_156 ) {
if ( V_90 -> V_107 == V_106 &&
V_121 -> V_161 >= V_90 -> V_118 ) {
V_121 -> V_162 |= V_163 ;
} else {
F_19 ( V_4 -> V_39 , L_7 ) ;
V_121 -> V_162 |= V_164 ;
...
F_53 ( V_4 , V_11 , V_84 -> V_151 / 2 ) ;
F_21 ( & V_4 -> V_42 , V_41 ) ;
F_13 ( V_6 -> V_125 | V_155 ,
V_6 -> V_16 + V_134 ) ;
F_22 ( & V_4 -> V_42 , V_41 ) ;
}
F_62 ( V_4 , V_11 ) ;
}
static T_2 F_63 ( int V_165 , void * V_166 )
{
struct V_3 * V_4 = (struct V_3 * ) V_166 ;
const struct V_83 * V_84 = V_4 -> V_85 ;
struct V_5 * V_6 = V_4 -> V_7 ;
struct V_10 * V_11 = V_4 -> V_167 ;
struct V_120 * V_121 ;
struct V_89 * V_90 ;
int V_15 , V_168 ;
int V_169 = V_84 -> V_151 / 2 ;
unsigned int V_170 , V_55 ;
...
V_121 = V_11 -> V_121 ;
V_90 = & V_121 -> V_90 ;
V_168 = F_64 ( V_6 -> V_60 + V_173 ) ;
if ( ( V_174 & V_168 ) == 0 )
return V_172 ;
F_65 ( V_6 -> V_60 + V_175 ) ;
F_66 ( V_6 -> V_176 | V_177 ,
V_6 -> V_60 + V_173 ) ;
V_15 = F_8 ( V_6 -> V_16 + V_134 ) ;
if ( V_15 & ( V_155 | V_154 ) )
F_61 ( V_4 , V_15 ) ;
if ( V_15 & V_178 ) {
V_170 = F_54 ( V_11 , V_169 ) ;
F_67 ( V_6 -> V_33 + V_35 , V_6 -> V_179 ,
V_170 ) ;
F_68 ( V_11 , V_6 -> V_179 , V_170 ) ;
if ( V_90 -> V_107 == V_106 &&
V_121 -> V_161 >= V_90 -> V_118 )
V_121 -> V_162 |= V_163 ;
F_21 ( & V_4 -> V_42 , V_41 ) ;
...
V_6 -> V_16 + V_134 ) ;
F_22 ( & V_4 -> V_42 , V_41 ) ;
} else if ( V_15 & ( V_180 | V_181 ) ) {
for ( V_55 = 0 ; V_55 < V_54 ; V_55 ++ ) {
unsigned short V_75 ;
if ( ( V_182 & F_8 ( V_6 -> V_16 +
V_134 ) ) == 0 )
break;
V_75 = F_8 ( V_6 -> V_33 ) ;
F_68 ( V_11 , & V_75 , 1 ) ;
...
return - V_187 ;
V_4 -> V_85 = V_84 ;
V_4 -> V_188 = V_84 -> V_189 ;
V_6 = F_72 ( V_4 , sizeof( * V_6 ) ) ;
if ( ! V_6 )
return - V_190 ;
V_25 = F_73 ( V_4 ) ;
if ( V_25 )
return V_25 ;
V_6 -> V_60 = F_74 ( V_185 , 0 ) ;
V_6 -> V_16 = F_74 ( V_185 , 1 ) ;
V_6 -> V_33 = F_74 ( V_185 , 2 ) ;
V_4 -> V_59 = F_74 ( V_185 , 3 ) ;
if ( V_84 -> V_191 )
V_6 -> V_48 = F_74 ( V_185 , 4 ) ;
F_66 ( V_177 ,
V_6 -> V_60 + V_173 ) ;
V_25 = F_75 ( V_185 -> V_165 , F_63 , V_192 ,
V_4 -> V_188 , V_4 ) ;
if ( V_25 ) {
F_40 ( V_4 -> V_39 , L_10 ,
V_185 -> V_165 ) ;
...
V_4 -> V_165 = V_185 -> V_165 ;
V_4 -> V_119 = F_76 ( V_4 -> V_59 + V_193 ,
V_194 , V_195 , 0 ) ;
if ( ! V_4 -> V_119 )
return - V_190 ;
V_6 -> V_145 = F_76 ( V_4 -> V_59 + V_196 ,
V_194 ,
V_195 , 0 ) ;
if ( ! V_6 -> V_145 )
return - V_190 ;
...
V_4 -> V_167 = V_11 ;
V_11 -> type = V_198 ;
V_11 -> V_199 = V_200 | V_201 | V_202 | V_203 ;
V_11 -> V_95 = V_84 -> V_204 ;
V_11 -> V_205 = V_84 -> V_204 ;
V_11 -> V_206 = ( 1 << V_84 -> V_207 ) - 1 ;
V_11 -> V_208 = V_84 -> V_209 ;
V_11 -> V_210 = F_9 ;
V_11 -> V_211 = F_18 ;
V_11 -> V_212 = F_47 ;
V_11 -> V_213 = F_41 ;
...
if ( V_84 -> V_191 ) {
V_11 -> type = V_215 ;
V_11 -> V_199 = V_200 | V_216 | V_201 ;
V_11 -> V_95 = V_84 -> V_191 ;
V_11 -> V_206 = ( 1 << V_84 -> V_207 ) - 1 ;
V_11 -> V_208 = & V_217 ;
V_11 -> V_218 = F_20 ;
V_25 = F_78 ( V_11 ) ;
...
V_11 = & V_4 -> V_197 [ 2 ] ;
V_25 = F_79 ( V_4 , V_11 , NULL , V_222 ) ;
if ( V_25 )
return V_25 ;
V_11 = & V_4 -> V_197 [ 3 ] ;
V_11 -> type = V_223 ;
V_11 -> V_199 = V_200 | V_224 ;
V_11 -> V_95 = 256 ;
V_11 -> V_206 = 0xff ;
V_11 -> V_210 = F_29 ;
V_11 = & V_4 -> V_197 [ 4 ] ;
V_11 -> type = V_225 ;
V_11 -> V_199 = V_200 | V_216 | V_224 ;
V_11 -> V_95 = V_226 ;
V_11 -> V_206 = 0xff ;
V_11 -> V_218 = F_32 ;
V_25 = F_78 ( V_11 ) ;
...
F_31 ( V_4 , V_55 , V_11 -> V_206 / 2 ) ;
V_11 -> V_47 [ V_55 ] = V_11 -> V_206 / 2 ;
}
V_11 = & V_4 -> V_197 [ 5 ] ;
V_11 -> type = V_225 ;
V_11 -> V_199 = V_200 | V_216 | V_224 ;
...
static int F_85 ( struct V_184 * V_4 ,
const struct V_232 * V_36 )
{
return F_86 ( V_4 , & V_233 ,
V_36 -> V_234 ) ;
}
