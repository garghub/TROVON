...
V_56 = F_2 ( V_6 ) ;
if ( V_56 < 0 ) {
F_10 ( V_6 -> V_2 , L_5 , V_56 ) ;
return V_56 ;
}
F_5 ( V_6 , V_57 , 0x100 , 0x100 ) ;
F_5 ( V_6 , V_58 , 0x100 , 0x100 ) ;
return V_56 ;
}
...
struct V_36 * V_37 ;
int V_56 ;
V_37 = F_23 ( & V_60 -> V_2 , sizeof( struct V_36 ) ,
V_61 ) ;
if ( V_37 == NULL )
return - V_62 ;
V_37 -> V_54 = F_24 ( V_60 , & V_63 ) ;
if ( F_25 ( V_37 -> V_54 ) )
return F_26 ( V_37 -> V_54 ) ;
F_27 ( V_60 , V_37 ) ;
V_56 = F_28 ( & V_60 -> V_2 ,
& V_64 , V_65 , F_12 ( V_65 ) ) ;
return V_56 ;
...
struct V_36 * V_37 ;
int V_56 ;
V_37 = F_23 ( & V_67 -> V_2 , sizeof( struct V_36 ) ,
V_61 ) ;
if ( V_37 == NULL )
return - V_62 ;
V_37 -> V_54 = F_32 ( V_67 , & V_63 ) ;
if ( F_25 ( V_37 -> V_54 ) )
return F_26 ( V_37 -> V_54 ) ;
F_33 ( V_67 , V_37 ) ;
V_56 = F_28 ( & V_67 -> V_2 ,
...
static int F_34 ( struct V_66 * V_69 )
{
F_30 ( & V_69 -> V_2 ) ;
return 0 ;
}
