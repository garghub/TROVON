...
while ( ! F_30 ( & V_2 -> V_45 ) ) {
V_83 = V_2 -> V_45 . V_84 ;
V_61 = F_65 ( V_83 , struct V_60 , V_45 ) ;
F_66 ( & V_61 -> V_45 ) ;
F_67 ( V_61 ) ;
}
F_68 ( V_34 , V_2 ) ;
...
{
struct V_1 * V_74 ;
V_74 = F_74 ( V_86 , struct V_1 , V_87 ) ;
F_75 ( V_74 -> V_13 , V_74 , 1 ) ;
F_76 ( & V_74 -> V_48 ) ;
}
int F_77 ( struct V_32 * V_7 , int V_88 )
{
struct V_71 V_89 , V_90 ;
struct V_1 * V_74 , * V_84 ;
int V_91 = 0 ;
F_22 ( & V_89 ) ;
F_22 ( & V_90 ) ;
F_78 ( & V_7 -> V_92 ) ;
...
F_54 ( & V_89 , & V_7 -> V_54 ) ;
F_31 ( & V_7 -> V_53 ) ;
F_84 (ordered, next, &works, work_list) {
F_51 ( & V_74 -> V_47 ) ;
F_85 ( & V_74 -> V_48 ) ;
F_52 ( V_74 ) ;
F_83 () ;
...
void F_87 ( struct V_16 * V_17 , int V_88 )
{
struct V_32 * V_7 ;
struct V_71 V_89 ;
int V_95 ;
...
int F_91 ( struct V_13 * V_13 , T_1 V_28 , T_1 V_4 )
{
int V_26 = 0 ;
int V_97 = 0 ;
T_1 V_73 ;
...
V_26 = F_93 ( V_13 , V_28 , V_98 ) ;
if ( V_26 )
return V_26 ;
V_97 = F_94 ( V_13 -> V_82 , V_28 , V_98 ) ;
V_73 = V_98 ;
while ( 1 ) {
V_74 = F_95 ( V_13 , V_73 ) ;
if ( ! V_74 )
...
bool F_98 ( struct V_13 * V_13 ,
T_1 V_3 ,
T_1 V_4 )
{
struct V_1 * V_100 ;
V_100 = F_97 ( V_13 , V_3 , V_4 ) ;
if ( V_100 ) {
F_52 ( V_100 ) ;
return true ;
}
...
int F_99 ( struct V_13 * V_13 , T_1 V_15 ,
struct V_1 * V_74 )
{
struct V_24 * V_25 = & F_16 ( V_13 ) -> V_33 ;
T_1 V_101 ;
T_1 V_102 ;
T_1 V_103 = F_100 ( V_13 ) ;
struct V_5 * V_8 ;
struct V_5 * V_21 = NULL ;
struct V_1 * V_22 ;
int V_26 = 1 ;
...
if ( V_74 ) {
V_15 = F_1 ( V_74 ) ;
if ( F_56 ( V_104 , & V_74 -> V_41 ) )
V_15 = F_39 ( V_15 ,
V_74 -> V_3 +
V_74 -> V_38 ) ;
} else {
V_15 = F_101 ( V_15 , F_16 ( V_13 ) -> V_7 -> V_105 ) ;
}
...
V_102 = F_102 ( T_1 , V_15 , V_103 ) ;
if ( V_74 && V_74 -> V_106 > V_102 )
V_102 = F_102 ( T_1 , V_74 -> V_106 , V_103 ) ;
F_16 ( V_13 ) -> V_101 = V_102 ;
V_26 = 0 ;
V_68:
if ( V_74 )
F_19 ( V_107 , & V_74 -> V_41 ) ;
F_26 ( & V_25 -> V_51 ) ;
return V_26 ;
}
int F_103 ( struct V_13 * V_13 , T_1 V_15 , T_1 V_108 ,
T_3 * V_61 , int V_4 )
{
struct V_60 * V_109 ;
struct V_1 * V_74 ;
...
unsigned long V_110 ;
unsigned long V_111 ;
T_3 V_105 = F_16 ( V_13 ) -> V_7 -> V_105 ;
int V_76 = 0 ;
V_74 = F_96 ( V_13 , V_15 ) ;
if ( ! V_74 )
return 0 ;
F_25 ( & V_25 -> V_51 ) ;
F_104 (ordered_sum, &ordered->list, list) {
...
V_110 = V_109 -> V_4 >>
V_13 -> V_18 -> V_113 ;
V_110 = F_102 ( int , V_4 - V_76 , V_110 - V_111 ) ;
memcpy ( V_61 + V_76 , V_109 -> V_114 + V_111 ,
V_110 ) ;
V_76 += ( int ) V_110 ;
if ( V_76 == V_4 )
goto V_68;
