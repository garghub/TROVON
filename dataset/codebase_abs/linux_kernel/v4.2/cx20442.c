...
const unsigned char * V_43 , char * V_44 , int V_45 )
{
struct V_1 * V_2 = V_32 -> V_37 ;
struct V_18 * V_19 ;
if ( ! V_2 )
...
if ( ! V_19 -> V_26 ) {
V_19 -> V_26 = V_32 ;
V_2 -> V_25 = ( V_46 ) V_32 -> V_35 -> V_36 ;
V_2 -> V_40 . V_41 -> V_42 = 1 ;
}
}
...
{
struct V_18 * V_19 ;
V_19 = F_21 ( sizeof( struct V_18 ) , V_52 ) ;
if ( V_19 == NULL )
return - V_28 ;
V_19 -> V_51 = F_22 ( V_2 -> V_29 , L_5 ) ;
if ( F_16 ( V_19 -> V_51 ) )
F_23 ( V_2 -> V_29 , L_6 ) ;
V_19 -> V_26 = NULL ;
F_24 ( V_2 , V_19 ) ;
