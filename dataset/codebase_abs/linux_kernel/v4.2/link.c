...
const char *
F_55 ( struct V_109 * V_112 , void * * V_127 )
{
struct V_111 * V_111 = F_49 ( V_112 ) ;
int V_4 = - V_14 ;
unsigned int V_39 ;
char * V_128 = NULL ;
char * V_129 = NULL ;
...
F_5 ( V_30 , L_8 , V_128 , V_111 ) ;
V_4 = - V_113 ;
if ( V_43 -> V_130 & V_131 )
V_4 = F_20 ( V_39 , V_41 , V_43 , V_128 ,
& V_129 ) ;
if ( V_4 != 0 && V_49 -> V_50 -> V_132 )
V_4 = V_49 -> V_50 -> V_132 ( V_39 , V_41 , V_128 ,
& V_129 , V_43 ) ;
F_12 ( V_128 ) ;
F_53 ( V_39 ) ;
F_54 ( V_118 ) ;
...
int
F_58 ( struct V_111 * V_111 , struct V_109 * V_112 , const char * V_133 )
{
int V_4 = - V_51 ;
unsigned int V_39 ;
struct V_42 * V_43 = F_39 ( V_111 -> V_116 ) ;
...
F_5 ( V_30 , L_10 , V_133 ) ;
if ( V_43 -> V_130 & V_131 )
V_4 = F_19 ( V_39 , V_134 , V_43 , V_128 , V_133 ) ;
else if ( V_134 -> V_123 )
V_4 = F_59 ( V_39 , V_134 , V_128 , V_133 ,
V_43 -> V_124 ,
F_45 ( V_43 ) ) ;
if ( V_4 == 0 ) {
if ( V_134 -> V_123 )
V_4 = F_60 ( & V_135 , V_128 ,
V_111 -> V_116 , V_39 ) ;
else
V_4 = F_61 ( & V_135 , V_128 , NULL ,
