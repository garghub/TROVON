...
V_32 = V_68 == V_73 || V_68 == V_72 ;
V_33 = V_68 == V_74 || V_68 == V_72 ;
V_13 = F_27 ( V_67 , L_13 ) ;
if ( V_13 < 0 ) {
F_22 ( V_12 ,
L_14 ,
...
static int F_39 ( struct V_120 * V_121 ,
unsigned int V_122 )
{
...
static int F_41 ( struct V_120 * V_121 , unsigned int V_126 )
{
unsigned int V_123 ;
unsigned int V_20 ;
struct V_16 * V_17 = V_121 -> V_17 ;
...
static void F_49 ( struct V_11 * V_12 , struct V_176 * V_177 ,
struct V_178 * V_17 )
{
T_2 V_10 ;
if ( F_50 ( V_177 , L_58 , NULL ) )
V_17 -> V_92 . V_106 = V_7 ;
else
V_17 -> V_92 . V_106 = V_6 ;
if ( F_50 ( V_177 , L_59 , NULL ) )
V_17 -> V_92 . V_109 = V_7 ;
else
V_17 -> V_92 . V_109 = V_6 ;
if ( F_50 ( V_177 , L_60 , NULL ) )
V_17 -> V_92 . V_100 = V_4 ;
else
V_17 -> V_92 . V_100 = V_3 ;
if ( F_50 ( V_177 , L_61 , NULL ) )
V_17 -> V_92 . V_102 = V_4 ;
else
V_17 -> V_92 . V_102 = V_3 ;
if ( F_50 ( V_177 , L_62 , NULL ) )
V_17 -> V_92 . V_104 = V_3 ;
else
V_17 -> V_92 . V_104 = V_4 ;
if ( ! F_51 ( V_177 , L_63 , & V_10 ) ) {
switch ( V_10 ) {
case 950 :
V_17 -> V_112 = V_114 ;
break;
...
V_13 = F_36 ( V_17 , & V_182 -> V_17 -> V_92 ) ;
if ( V_13 < 0 ) {
F_56 ( L_67 , V_36 , V_13 ) ;
return V_13 ;
}
V_13 = F_38 ( V_17 , V_182 -> V_17 -> V_112 ) ;
if ( V_13 < 0 ) {
F_56 ( L_68 ,
V_36 , V_13 ) ;
return V_13 ;
...
static int F_59 ( struct V_194 * V_195 )
{
int V_13 ;
struct V_34 * V_35 ;
F_15 ( & V_195 -> V_12 , L_6 , V_36 ) ;
V_35 = F_55 ( & V_195 -> V_12 , sizeof( struct V_34 ) ,
V_184 ) ;
if ( ! V_35 )
return - V_185 ;
V_35 -> V_46 = V_196 ;
V_35 -> V_65 = V_197 ;
F_60 ( & V_195 -> V_12 , V_35 ) ;
V_35 -> V_198 = F_61 ( & V_195 -> V_12 , NULL , & V_195 -> V_12 ,
& V_199 ) ;
if ( F_62 ( V_35 -> V_198 ) ) {
V_13 = F_63 ( V_35 -> V_198 ) ;
F_22 ( & V_195 -> V_12 , L_71 ,
V_36 , V_13 ) ;
return V_13 ;
}
F_15 ( & V_195 -> V_12 , L_72 , V_36 ) ;
V_13 = F_64 ( & V_195 -> V_12 , & V_200 ,
V_201 ,
F_26 ( V_201 ) ) ;
if ( V_13 < 0 )
F_22 ( & V_195 -> V_12 ,
...
static int F_65 ( struct V_194 * V_195 )
{
