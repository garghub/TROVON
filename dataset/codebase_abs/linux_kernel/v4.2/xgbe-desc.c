...
static int F_28 ( struct V_20 * V_21 , struct V_72 * V_69 )
{
...
V_74 -> V_8 = 0 ;
V_74 -> V_84 = 0 ;
V_80 = F_29 ( V_74 -> V_85 , V_86 ,
V_87 ) ;
V_81 = F_29 ( V_74 -> V_85 , V_86 ,
V_88 ) ;
...
for ( V_82 = F_31 ( V_69 ) - V_79 ; V_82 ; ) {
V_45 = F_32 (unsigned int, datalen, XGBE_TX_MAX_BUF_SIZE) ;
V_65 = F_30 ( V_2 -> V_11 , V_69 -> V_93 + V_79 , V_45 ,
V_68 ) ;
if ( F_19 ( V_2 -> V_11 , V_65 ) ) {
F_15 ( V_2 -> V_28 , L_17 ) ;
goto V_95;
...
for ( V_7 = 0 ; V_7 < F_33 ( V_69 ) -> V_97 ; V_7 ++ ) {
F_13 ( V_2 , V_96 , V_2 -> V_28 ,
L_20 , V_7 ) ;
V_76 = & F_33 ( V_69 ) -> V_98 [ V_7 ] ;
V_79 = 0 ;
for ( V_82 = F_34 ( V_76 ) ; V_82 ; ) {
V_45 = F_32 (unsigned int, datalen,
XGBE_TX_MAX_BUF_SIZE) ;
V_65 = F_35 ( V_2 -> V_11 , V_76 , V_79 ,
V_45 , V_68 ) ;
if ( F_19 ( V_2 -> V_11 , V_65 ) ) {
F_15 ( V_2 -> V_28 ,
L_21 ) ;
