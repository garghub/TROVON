...
V_17 = V_15 -> V_17 ;
V_24 = V_15 -> V_31 . V_20 ;
error = F_34 ( & V_65 -> V_31 -> V_75 , V_15 -> V_76 , & V_68 ,
& V_18 , & V_72 ) ;
if ( error ) {
if ( F_7 ( V_15 ) ||
( V_15 -> V_39 & V_77 ) )
...
F_39 ( V_67 ) ;
V_28:
error = F_40 ( V_15 , & V_21 , V_99 , V_100 , V_45 ,
...
struct V_66 * V_102 = F_31 ( V_65 -> V_74 ) ;
if ( ( V_102 -> V_15 == V_15 ) ||
( F_7 ( V_102 -> V_15 ) ) )
return;
V_11 -> V_103 = 0 ;
F_45 ( V_15 , V_102 -> V_15 ) ;
}
void F_46 ( struct V_64 * V_65 )
{
return;
}
static char * F_47 ( const char * V_104 , const char * V_105 )
{
char * V_18 = F_48 ( strlen ( V_104 ) + strlen ( V_105 ) + 3 , V_99 ) ;
if ( V_18 )
sprintf ( V_18 , L_8 , V_104 , V_105 ) ;
return V_18 ;
}
int F_49 ( const char * V_106 [] , int V_107 , T_2 V_108 , bool V_109 )
{
const struct V_74 * V_74 ;
struct V_66 * V_67 ;
struct V_6 * V_15 , * V_110 , * V_111 = NULL ;
char * V_18 = NULL ;
int V_3 ;
struct V_14 V_21 = {} ;
...
struct V_6 * V_113 ;
if ( F_53 ( V_15 ) )
V_113 = F_54 ( & V_15 -> V_114 ) ;
else
V_113 = F_20 ( V_15 ) ;
for ( V_3 = 0 ; V_3 < V_107 && ! V_111 ; V_3 ++ )
V_111 = F_24 ( V_113 , V_106 [ V_3 ] ) ;
if ( ! V_111 ) {
if ( ! F_36 ( V_113 ) || V_109 ) {
if ( F_55 ( & V_113 -> V_34 . V_62 ) )
error = - V_115 ;
else
error = - V_86 ;
F_10 ( V_113 ) ;
...
V_18 = F_47 ( V_113 -> V_34 . V_59 , V_106 [ 0 ] ) ;
F_10 ( V_113 ) ;
V_71 = V_18 ;
V_111 = F_37 ( V_15 , 1 ) ;
if ( ! V_111 ) {
...
V_28:
if ( ! V_109 )
error = F_40 ( V_15 , & V_21 , V_99 ,
V_117 , V_116 , NULL ,
V_71 , V_118 , V_72 , error ) ;
V_12:
F_10 ( V_111 ) ;
F_41 ( V_18 ) ;
F_58 ( V_74 ) ;
...
int F_59 ( const char * V_48 , const char * V_59 , bool V_79 ,
bool V_109 )
{
const struct V_74 * V_74 ;
...
V_28:
if ( ! V_109 )
error = F_40 ( V_15 , & V_21 , V_99 , V_119 , V_19 ,
V_18 , V_59 , V_118 , V_72 , error ) ;
F_27 ( V_17 ) ;
F_10 ( V_71 ) ;
F_58 ( V_74 ) ;
return error ;
