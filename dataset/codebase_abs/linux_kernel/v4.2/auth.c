...
V_49 -> V_120 = V_121 ;
#endif
V_49 -> V_122 = V_97 -> V_102 ;
}
struct V_48 *
F_74 ( struct V_123 * V_124 , struct V_48 * V_49 , int V_125 )
{
...
static struct V_48 *
F_75 ( struct V_123 * V_124 , int V_125 )
{
...
F_17 ( L_6 ,
V_124 -> V_126 , V_124 -> V_127 -> V_44 -> V_46 -> V_112 ) ;
return V_41 -> V_46 -> V_117 ( V_41 , & V_97 , V_125 ) ;
}
static struct V_48 *
F_76 ( struct V_123 * V_124 , int V_125 )
{
struct V_37 * V_41 = V_124 -> V_127 -> V_44 ;
F_17 ( L_6 ,
V_124 -> V_126 , V_41 -> V_46 -> V_112 ) ;
return F_67 ( V_41 , V_125 ) ;
}
static int
F_77 ( struct V_123 * V_124 , struct V_48 * V_49 , int V_98 )
{
...
V_125 |= V_110 ;
if ( V_49 != NULL )
V_59 = V_49 -> V_68 -> V_134 ( V_124 , V_49 , V_125 ) ;
else if ( V_98 & V_135 )
V_59 = F_75 ( V_124 , V_125 ) ;
else
V_59 = F_76 ( V_124 , V_125 ) ;
if ( F_20 ( V_59 ) )
return F_78 ( V_59 ) ;
if ( V_131 -> V_136 != NULL )
F_41 ( V_131 -> V_136 ) ;
...
T_4 *
F_80 ( struct V_123 * V_124 , T_4 * V_140 )
{
struct V_48 * V_49 = V_124 -> V_132 -> V_136 ;
F_17 ( L_7 ,
V_124 -> V_126 , V_49 -> V_54 -> V_46 -> V_112 , V_49 ) ;
return V_49 -> V_68 -> V_141 ( V_124 , V_140 ) ;
}
T_4 *
F_81 ( struct V_123 * V_124 , T_4 * V_140 )
{
struct V_48 * V_49 = V_124 -> V_132 -> V_136 ;
F_17 ( L_8 ,
V_124 -> V_126 , V_49 -> V_54 -> V_46 -> V_112 , V_49 ) ;
return V_49 -> V_68 -> V_142 ( V_124 , V_140 ) ;
}
static void F_82 ( T_5 V_143 , struct V_130 * V_144 ,
T_4 * V_145 , void * V_146 )
{
struct V_147 V_148 ;
F_83 ( & V_148 , & V_144 -> V_149 , V_145 ) ;
V_143 ( V_144 , & V_148 , V_146 ) ;
}
int
F_84 ( struct V_123 * V_124 , T_5 V_143 , void * V_144 ,
T_4 * V_145 , void * V_146 )
{
struct V_48 * V_49 = V_124 -> V_132 -> V_136 ;
F_17 ( L_9 ,
V_124 -> V_126 , V_49 -> V_68 -> V_150 , V_49 ) ;
if ( V_49 -> V_68 -> V_151 )
return V_49 -> V_68 -> V_151 ( V_124 , V_143 , V_144 , V_145 , V_146 ) ;
F_82 ( V_143 , V_144 , V_145 , V_146 ) ;
return 0 ;
}
static int
F_85 ( T_6 V_152 , struct V_130 * V_144 ,
T_4 * V_145 , void * V_146 )
{
struct V_147 V_148 ;
F_86 ( & V_148 , & V_144 -> V_153 , V_145 ) ;
return V_152 ( V_144 , & V_148 , V_146 ) ;
}
int
F_87 ( struct V_123 * V_124 , T_6 V_152 , void * V_144 ,
T_4 * V_145 , void * V_146 )
{
struct V_48 * V_49 = V_124 -> V_132 -> V_136 ;
F_17 ( L_10 ,
V_124 -> V_126 , V_49 -> V_68 -> V_150 , V_49 ) ;
if ( V_49 -> V_68 -> V_154 )
return V_49 -> V_68 -> V_154 ( V_124 , V_152 , V_144 ,
V_145 , V_146 ) ;
return F_85 ( V_152 , V_144 , V_145 , V_146 ) ;
}
int
...
if ( V_49 == NULL ) {
V_155 = F_77 ( V_124 , V_124 -> V_156 . V_48 , V_124 -> V_157 ) ;
if ( V_155 < 0 )
goto V_42;
V_49 = V_124 -> V_132 -> V_136 ;
}
