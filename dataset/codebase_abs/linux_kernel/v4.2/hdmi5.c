...
static int F_98 ( struct V_95 * V_4 , struct V_95 * V_109 , void * V_7 )
{
struct V_80 * V_3 = F_99 ( V_4 ) ;
int V_1 ;
int V_6 ;
V_2 . V_3 = V_3 ;
F_100 ( & V_3 -> V_4 , & V_2 ) ;
...
static void F_112 ( struct V_95 * V_4 , struct V_95 * V_109 , void * V_7 )
{
struct V_80 * V_3 = F_99 ( V_4 ) ;
if ( V_2 . V_67 )
F_113 ( V_2 . V_67 ) ;
...
static int F_114 ( struct V_80 * V_3 )
{
return F_115 ( & V_3 -> V_4 , & V_111 ) ;
}
static int F_116 ( struct V_80 * V_3 )
{
F_117 ( & V_3 -> V_4 , & V_111 ) ;
return 0 ;
}
static int F_118 ( struct V_95 * V_4 )
{
F_119 () ;
return 0 ;
}
static int F_120 ( struct V_95 * V_4 )
{
int V_1 ;
V_1 = F_121 () ;
if ( V_1 < 0 )
