...
if ( F_24 ( V_5 -> V_6 ) )
return F_25 ( V_5 -> V_6 ) ;
V_5 -> V_14 = F_27 ( & V_10 -> V_11 ) ;
if ( ! V_5 -> V_14 ) {
F_7 ( & V_10 -> V_11 , L_27 ) ;
return - V_53 ;
}
V_5 -> V_14 -> V_65 = L_28 ;
V_5 -> V_14 -> V_11 . V_66 = V_10 -> V_11 . V_66 ;
V_5 -> V_14 -> V_67 = F_11 ;
F_28 ( V_5 -> V_14 , V_5 ) ;
F_29 ( V_5 -> V_14 , V_68 , V_69 ) ;
error = F_30 ( V_5 -> V_14 , NULL ,
F_8 ) ;
if ( error ) {
F_7 ( & V_10 -> V_11 , L_29 ,
error ) ;
...
static int T_1 F_35 ( struct V_41 * V_11 )
{
...
static int T_1 F_40 ( struct V_41 * V_11 )
{
struct V_4 * V_5 = F_36 ( V_11 ) ;
int V_71 = 0 ;
F_37 ( & V_5 -> V_14 -> V_72 ) ;
