...
static void F_41 ( struct V_4 * V_5 , int V_201 )
{
struct V_202 * V_203 = & V_5 -> V_18 . V_204 [ V_201 ] ;
if ( F_42 ( V_201 >= F_3 ( V_5 -> V_18 . V_204 ) ) )
return;
...
int F_48 ( struct V_1 * V_2 , struct V_231 * V_218 )
{
struct V_4 * V_5 = F_2 ( V_2 ) ;
struct V_22 * V_23 = F_49 ( V_2 ) ;
if ( V_218 ) {
V_5 -> V_218 = V_218 ;
V_5 -> V_217 = true ;
V_5 -> V_227 = 0 ;
...
static T_2 F_54 ( int V_196 , void * V_238 )
{
struct V_4 * V_5 = V_238 ;
T_2 V_239 = V_240 ;
unsigned int V_241 , V_242 ;
int V_57 ;
V_57 = F_47 ( V_5 -> V_20 , V_243 , & V_241 ) ;
if ( V_57 < 0 ) {
F_4 ( V_5 -> V_10 , L_68 ,
V_57 ) ;
V_241 = 0 ;
}
V_57 = F_47 ( V_5 -> V_20 , V_235 ,
& V_242 ) ;
if ( V_57 < 0 ) {
F_4 ( V_5 -> V_10 , L_69 ,
V_57 ) ;
...
if ( V_241 & V_245 ) {
F_6 ( V_5 -> V_10 , L_70 ) ;
F_55 ( & V_5 -> V_168 [ 0 ] . V_169 ) ;
}
if ( V_241 & V_246 ) {
F_6 ( V_5 -> V_10 , L_71 ) ;
F_55 ( & V_5 -> V_168 [ 1 ] . V_169 ) ;
}
if ( V_241 & V_247 )
F_46 ( V_5 ) ;
V_57 = F_47 ( V_5 -> V_20 , V_248 , & V_241 ) ;
if ( V_57 < 0 ) {
F_4 ( V_5 -> V_10 , L_72 ,
V_57 ) ;
V_241 = 0 ;
}
V_57 = F_47 ( V_5 -> V_20 , V_249 ,
& V_242 ) ;
if ( V_57 < 0 ) {
F_4 ( V_5 -> V_10 , L_73 ,
V_57 ) ;
...
static T_2 F_56 ( int V_196 , void * V_238 )
{
T_2 V_57 = V_240 ;
T_2 V_27 ;
do {
V_27 = F_54 ( V_196 , V_238 ) ;
if ( V_27 != V_240 )
V_57 = V_27 ;
} while ( V_27 != V_240 );
return V_57 ;
}
static inline struct V_4 * F_57 ( struct V_250 * V_251 )
{
return F_58 ( V_251 , struct V_4 , V_250 ) ;
}
static void F_59 ( struct V_250 * V_251 , unsigned V_252 , int V_253 )
{
struct V_4 * V_5 = F_57 ( V_251 ) ;
F_43 ( V_5 -> V_20 , V_254 + V_252 ,
V_255 , ! ! V_253 << V_256 ) ;
}
static int F_60 ( struct V_250 * V_251 ,
unsigned V_252 , int V_253 )
{
struct V_4 * V_5 = F_57 ( V_251 ) ;
int V_27 , V_57 ;
V_27 = ( 1 << V_257 ) | ( ! ! V_253 << V_256 ) ;
V_57 = F_43 ( V_5 -> V_20 , V_254 + V_252 ,
V_258 | V_259 |
V_255 , V_27 ) ;
if ( V_57 < 0 )
return V_57 ;
...
unsigned int V_38 ;
int V_57 ;
V_57 = F_47 ( V_5 -> V_20 , V_254 + V_252 , & V_38 ) ;
if ( V_57 < 0 )
return V_57 ;
return ( V_38 & V_255 ) != 0 ;
}
static int F_62 ( struct V_250 * V_251 , unsigned V_252 )
{
struct V_4 * V_5 = F_57 ( V_251 ) ;
return F_43 ( V_5 -> V_20 , V_254 + V_252 ,
V_258 | V_259 ,
( 1 << V_257 ) |
( 1 << V_260 ) ) ;
}
static void F_63 ( struct V_164 * V_165 )
{
struct V_4 * V_5 = F_64 ( V_165 ) ;
int V_57 ;
V_5 -> V_250 = V_261 ;
V_5 -> V_250 . V_262 = 6 ;
V_5 -> V_250 . V_10 = & V_165 -> V_10 ;
if ( V_5 -> V_18 . V_263 )
V_5 -> V_250 . V_70 = V_5 -> V_18 . V_263 ;
else
V_5 -> V_250 . V_70 = - 1 ;
V_57 = F_65 ( & V_5 -> V_250 ) ;
if ( V_57 != 0 )
...
static void F_66 ( struct V_164 * V_165 )
{
struct V_4 * V_5 = F_64 ( V_165 ) ;
F_67 ( & V_5 -> V_250 ) ;
}
...
int V_57 , V_8 ;
V_5 -> V_2 = V_2 ;
for ( V_8 = 0 ; V_8 < F_3 ( V_264 ) ; V_8 ++ )
F_7 ( V_2 , V_264 [ V_8 ] , V_265 ,
V_265 ) ;
F_69 ( V_2 , V_266 , 0 ) ;
F_69 ( V_2 , V_267 , 0 ) ;
if ( V_165 -> V_196 )
...
static int F_74 ( struct V_164 * V_165 ,
const struct V_271 * V_96 )
{
struct V_272 * V_18 = F_75 ( & V_165 -> V_10 ) ;
struct V_4 * V_5 ;
unsigned int V_38 ;
int V_57 , V_8 , V_273 ;
V_5 = F_76 ( & V_165 -> V_10 , sizeof( struct V_4 ) ,
V_274 ) ;
if ( V_5 == NULL )
return - V_275 ;
V_5 -> V_10 = & V_165 -> V_10 ;
V_5 -> V_20 = F_77 ( V_165 , & V_276 ) ;
if ( F_78 ( V_5 -> V_20 ) ) {
V_57 = F_79 ( V_5 -> V_20 ) ;
F_4 ( & V_165 -> V_10 , L_77 ,
V_57 ) ;
...
F_80 ( & V_5 -> V_168 [ V_8 ] . V_169 ) ;
if ( V_18 )
V_5 -> V_18 = * V_18 ;
F_81 ( V_165 , V_5 ) ;
for ( V_8 = 0 ; V_8 < F_3 ( V_5 -> V_278 ) ; V_8 ++ )
V_5 -> V_278 [ V_8 ] . V_279 = V_280 [ V_8 ] ;
V_57 = F_82 ( & V_165 -> V_10 ,
F_3 ( V_5 -> V_278 ) ,
V_5 -> V_278 ) ;
if ( V_57 != 0 ) {
F_4 ( & V_165 -> V_10 , L_78 ,
...
V_57 = F_47 ( V_5 -> V_20 , V_285 , & V_38 ) ;
if ( V_57 < 0 ) {
F_4 ( & V_165 -> V_10 , L_86 ) ;
goto V_284;
}
V_5 -> V_286 = V_38 & V_287 ;
F_84 ( & V_165 -> V_10 , L_87 , V_5 -> V_286 + 'A' ) ;
V_57 = F_10 ( V_5 ) ;
if ( V_57 < 0 ) {
F_4 ( & V_165 -> V_10 , L_88 ) ;
goto V_284;
...
if ( V_165 -> V_196 ) {
if ( V_5 -> V_18 . V_273 )
V_273 = V_5 -> V_18 . V_273 ;
else
V_273 = V_297 ;
V_273 |= V_298 ;
if ( V_273 & ( V_299 | V_300 ) )
V_57 = F_86 ( V_165 -> V_196 , NULL ,
F_56 ,
V_273 | V_298 ,
L_90 , V_5 ) ;
else
V_57 = F_86 ( V_165 -> V_196 , NULL , F_54 ,
V_273 | V_298 ,
L_90 ,
V_5 ) ;
if ( V_57 != 0 ) {
...
static int F_95 ( struct V_309 * V_10 )
{
...
static int F_99 ( struct V_309 * V_10 )
{
struct V_4 * V_5 = F_96 ( V_10 ) ;
int V_57 ;
V_57 = F_83 ( F_3 ( V_5 -> V_278 ) ,
