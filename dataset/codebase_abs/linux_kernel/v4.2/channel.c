...
V_136 . type = type ;
V_136 . V_27 = V_27 ;
V_136 . V_142 = sizeof( struct V_135 ) >> 3 ;
V_136 . V_143 = ( V_144 ) ( V_138 >> 3 ) ;
V_136 . V_145 = V_132 ;
V_140 [ 0 ] . V_146 = & V_136 ;
V_140 [ 0 ] . V_147 = sizeof( struct V_135 ) ;
V_140 [ 1 ] . V_146 = V_130 ;
V_140 [ 1 ] . V_147 = V_131 ;
V_140 [ 2 ] . V_146 = & V_141 ;
V_140 [ 2 ] . V_147 = ( V_138 - V_137 ) ;
...
V_136 . V_27 = V_27 ;
V_136 . V_154 = V_151 >> 3 ;
V_136 . V_155 = ( V_144 ) ( V_138 >> 3 ) ;
V_136 . V_156 = V_132 ;
V_136 . V_95 = V_77 ;
for ( V_76 = 0 ; V_76 < V_77 ; V_76 ++ ) {
V_136 . V_97 [ V_76 ] . V_157 = V_149 [ V_76 ] . V_157 ;
V_136 . V_97 [ V_76 ] . V_158 = V_149 [ V_76 ] . V_158 ;
V_136 . V_97 [ V_76 ] . V_104 = V_149 [ V_76 ] . V_104 ;
}
V_140 [ 0 ] . V_146 = & V_136 ;
V_140 [ 0 ] . V_147 = V_151 ;
V_140 [ 1 ] . V_146 = V_130 ;
...
V_92 V_141 = 0 ;
bool signal = false ;
T_1 V_86 = F_51 ( V_163 -> V_158 ,
V_163 -> V_157 ) ;
if ( V_86 > V_165 )
return - V_36 ;
V_151 = sizeof( struct V_164 ) -
( ( V_165 - V_86 ) *
sizeof( V_92 ) ) ;
V_137 = V_151 + V_131 ;
V_138 = F_44 ( V_137 , sizeof( V_92 ) ) ;
...
V_136 . V_156 = V_132 ;
V_136 . V_95 = 1 ;
V_136 . V_97 . V_157 = V_163 -> V_157 ;
V_136 . V_97 . V_158 = V_163 -> V_158 ;
memcpy ( V_136 . V_97 . V_100 , V_163 -> V_100 ,
V_86 * sizeof( V_92 ) ) ;
V_140 [ 0 ] . V_146 = & V_136 ;
V_140 [ 0 ] . V_147 = V_151 ;
V_140 [ 1 ] . V_146 = V_130 ;
...
T_1 V_131 , T_1 * V_166 , V_92 * V_132 )
{
struct V_135 V_136 ;
T_1 V_137 ;
T_1 V_167 ;
...
* V_132 = V_136 . V_145 ;
V_28 = F_54 ( & V_2 -> V_48 , V_130 , V_167 ,
( V_136 . V_142 << 3 ) , & signal ) ;
if ( signal )
F_1 ( V_2 ) ;
return 0 ;
}
