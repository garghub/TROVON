...
struct V_68 * V_69 ;
T_1 V_4 ;
V_16 = F_35 ( & V_67 -> V_70 , sizeof( struct V_11 ) ,
V_71 ) ;
if ( ! V_16 )
return - V_72 ;
V_69 = F_36 ( V_67 , V_73 , L_4 ) ;
V_16 -> V_19 = F_37 ( & V_67 -> V_70 , V_69 ) ;
if ( F_38 ( V_16 -> V_19 ) )
return F_39 ( V_16 -> V_19 ) ;
V_16 -> V_44 = F_40 ( V_67 , 0 ) ;
if ( V_16 -> V_44 < 0 )
return - V_74 ;
V_69 = F_36 ( V_67 , V_75 , L_5 ) ;
if ( ! V_69 )
return - V_74 ;
V_16 -> V_76 . V_77 = V_69 ;
V_16 -> V_76 . V_78 = L_6 ;
