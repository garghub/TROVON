...
enum V_18 V_18 ;
T_3 V_103 [ V_104 ] ;
if ( F_44 ( V_11 , V_98 -> V_101 ) )
V_101 = V_98 -> V_101 ;
else if ( V_98 -> type == V_105 )
V_101 = V_106 ;
else
V_101 = V_107 ;
...
F_45 ( V_100 , true ) ;
F_46 (dev_priv, pipe) {
V_103 [ V_18 ] = F_6 ( F_47 ( V_18 ) ) ;
F_11 ( F_47 ( V_18 ) , V_103 [ V_18 ] | V_108 ) ;
}
V_102 = V_98 -> V_16 -> V_109 ( & V_1 -> V_9 , V_100 ) ;
F_46 (dev_priv, pipe) {
F_11 ( F_47 ( V_18 ) , V_103 [ V_18 ] ) ;
}
F_45 ( V_100 , false ) ;
if ( ! V_102 )
continue;
