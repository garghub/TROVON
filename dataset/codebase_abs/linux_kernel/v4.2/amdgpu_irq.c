...
int F_36 ( struct V_3 * V_4 , unsigned V_42 ,
struct V_23 * V_43 )
{
if ( V_42 >= V_22 )
return - V_44 ;
if ( V_4 -> V_20 . V_25 [ V_42 ] != NULL )
return - V_44 ;
if ( ! V_43 -> V_26 )
return - V_44 ;
if ( V_43 -> V_28 && ! V_43 -> V_29 ) {
T_2 * V_45 ;
V_45 = F_37 ( V_43 -> V_28 , sizeof( T_2 ) ,
V_46 ) ;
if ( ! V_45 )
return - V_47 ;
V_43 -> V_29 = V_45 ;
}
V_4 -> V_20 . V_25 [ V_42 ] = V_43 ;
return 0 ;
}
...
V_24 = V_4 -> V_20 . V_25 [ V_42 ] ;
if ( ! V_24 ) {
F_39 ( L_5 , V_42 ) ;
return;
}
V_19 = V_24 -> V_26 -> V_50 ( V_4 , V_24 , V_49 ) ;
if ( V_19 )
F_13 ( L_6 , V_19 ) ;
}
...
V_52 = V_30 ;
V_19 = V_24 -> V_26 -> V_27 ( V_4 , V_24 , type , V_52 ) ;
F_14 ( & V_4 -> V_20 . V_21 , V_16 ) ;
return V_19 ;
}
