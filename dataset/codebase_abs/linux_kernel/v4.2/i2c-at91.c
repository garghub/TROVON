...
V_133 . V_143 = 1 ;
V_133 . V_144 = false ;
V_30 -> V_35 = F_52 ( V_2 -> V_2 , L_21 ) ;
if ( F_53 ( V_30 -> V_35 ) ) {
V_86 = F_54 ( V_30 -> V_35 ) ;
V_30 -> V_35 = NULL ;
goto error;
}
V_30 -> V_34 = F_52 ( V_2 -> V_2 , L_22 ) ;
if ( F_53 ( V_30 -> V_34 ) ) {
V_86 = F_54 ( V_30 -> V_34 ) ;
V_30 -> V_34 = NULL ;
goto error;
...
F_70 ( V_2 -> V_2 ) , V_2 ) ;
if ( V_156 ) {
F_26 ( V_2 -> V_2 , L_27 , V_2 -> V_75 , V_156 ) ;
return V_156 ;
}
F_71 ( V_148 , V_2 ) ;
...
if ( ! F_74 ( V_148 -> V_2 . V_149 , L_29 ,
& V_2 -> V_13 ) ) {
F_57 ( V_2 -> V_2 , L_30 , V_2 -> V_13 ) ;
}
V_156 = F_74 ( V_2 -> V_2 -> V_149 , L_31 ,
& V_157 ) ;
if ( V_156 )
V_157 = V_163 ;
F_9 ( V_2 , V_157 ) ;
F_8 ( V_2 ) ;
snprintf ( V_2 -> V_98 . V_164 , sizeof( V_2 -> V_98 . V_164 ) , L_32 ) ;
F_75 ( & V_2 -> V_98 , V_2 ) ;
