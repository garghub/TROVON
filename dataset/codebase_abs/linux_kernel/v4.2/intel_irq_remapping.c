...
if ( ! V_72 )
return - V_82 ;
memcpy ( V_2 -> V_13 -> V_36 , V_72 , V_74 ) ;
F_20 ( V_2 , V_2 -> V_13 -> V_36 , V_74 ) ;
for ( V_40 = 0 ; V_40 < V_20 ; V_40 ++ ) {
if ( V_2 -> V_13 -> V_36 [ V_40 ] . V_83 )
F_42 ( V_2 -> V_13 -> V_19 , V_40 , 1 ) ;
}
return 0 ;
}
static void F_43 ( struct V_1 * V_2 , int V_25 )
{
unsigned long V_3 ;
T_6 V_84 ;
T_1 V_85 ;
V_84 = F_44 ( ( void * ) V_2 -> V_13 -> V_36 ) ;
F_10 ( & V_2 -> V_86 , V_3 ) ;
F_45 ( V_2 -> V_6 + V_78 ,
( V_84 ) | F_46 ( V_25 ) | V_80 ) ;
F_47 ( V_2 -> V_87 | V_88 , V_2 -> V_6 + V_89 ) ;
F_48 ( V_2 , V_7 ,
F_4 , ( V_85 & V_90 ) , V_85 ) ;
F_13 ( & V_2 -> V_86 , V_3 ) ;
F_49 ( V_2 ) ;
...
if ( V_2 -> V_13 )
return 0 ;
V_13 = F_53 ( sizeof( struct V_13 ) , V_97 ) ;
if ( ! V_13 )
return - V_82 ;
V_96 = F_54 ( V_2 -> V_98 , V_97 | V_99 ,
V_100 ) ;
if ( ! V_96 ) {
F_9 ( L_9 ,
V_2 -> V_21 , V_100 ) ;
...
F_69 ( ( unsigned long ) V_2 -> V_13 -> V_36 ,
V_100 ) ;
F_65 ( V_2 -> V_13 -> V_19 ) ;
F_65 ( V_2 -> V_13 ) ;
V_2 -> V_13 = NULL ;
...
/ sizeof( struct V_132 ) ;
while ( -- V_12 > 0 ) {
V_60 = F_85 ( V_60 , V_133 -> V_135 , V_133 -> V_136 ,
V_137 ) ;
V_133 ++ ;
}
...
V_42 [ free ] . V_60 = V_60 ;
V_42 [ free ] . V_61 = F_86 ( V_133 -> V_135 , V_133 -> V_136 ) ;
F_64 ( L_31 ,
...
V_46 [ free ] . V_60 = V_60 ;
V_46 [ free ] . V_61 = F_86 ( V_133 -> V_135 , V_133 -> V_136 ) ;
V_46 [ free ] . V_2 = V_2 ;
...
V_143 = F_87 ( V_130 , V_2 , V_50 ) ;
else if ( V_130 -> V_144 == V_146 )
V_143 = F_84 ( V_130 , V_2 , V_50 ) ;
V_51 += V_130 -> V_134 ;
}
return V_143 ;
}
...
static void F_98 ( struct V_33 * V_33 , int V_153 , unsigned int V_154 )
{
...
V_33 -> V_153 = V_153 ;
V_33 -> V_160 = F_99 ( V_154 ) ;
V_33 -> V_161 = 1 ;
}
static struct V_162 * F_100 ( struct V_163 * V_164 )
{
struct V_1 * V_2 = NULL ;
if ( ! V_164 )
return NULL ;
...
static int
F_103 ( struct V_170 * V_69 , const struct V_171 * V_15 ,
bool V_172 )
{
struct V_173 * V_174 = V_69 -> V_175 ;
struct V_33 * V_33 = & V_174 -> V_176 ;
struct V_177 * V_178 = F_104 ( V_69 ) ;
...
V_33 -> V_160 = F_99 ( V_178 -> V_184 ) ;
if ( V_174 -> V_10 . V_25 == V_26 )
F_18 ( & V_174 -> V_10 , V_33 ) ;
F_105 ( V_178 ) ;
return V_183 ;
}
static void F_106 ( struct V_170 * V_170 ,
struct V_185 * V_186 )
{
struct V_173 * V_174 = V_170 -> V_175 ;
* V_186 = V_174 -> V_187 ;
}
static int F_107 ( struct V_170 * V_69 , void * V_164 )
{
struct V_173 * V_174 = V_69 -> V_175 ;
...
static void F_109 ( struct V_173 * V_69 ,
struct V_177 * V_177 ,
struct V_163 * V_164 ,
int V_16 , int V_23 )
{
...
F_98 ( V_33 , V_177 -> V_153 , V_177 -> V_184 ) ;
switch ( V_164 -> type ) {
case V_165 :
F_28 ( V_33 , V_164 -> V_151 ) ;
F_110 ( V_200 , V_201 L_36 ,
...
static void F_113 ( struct V_162 * V_219 ,
...
static int F_116 ( struct V_162 * V_219 ,
unsigned int V_220 , unsigned int V_221 ,
void * V_222 )
{
...
if ( V_164 -> type == V_167 )
V_164 -> V_3 &= ~ V_225 ;
V_143 = F_117 ( V_219 , V_220 , V_221 , V_222 ) ;
if ( V_143 < 0 )
return V_143 ;
V_143 = - V_82 ;
V_69 = F_53 ( sizeof( * V_69 ) , V_97 ) ;
if ( ! V_69 )
goto V_226;
F_29 ( & V_59 ) ;
...
V_170 -> V_175 = V_224 ;
V_170 -> V_181 = & V_229 ;
F_109 ( V_224 , V_177 , V_164 , V_16 , V_40 ) ;
F_118 ( V_220 + V_40 , V_230 ) ;
}
return 0 ;
V_227:
F_113 ( V_219 , V_220 , V_40 ) ;
V_226:
F_119 ( V_219 , V_220 , V_221 ) ;
return V_143 ;
}
static void F_120 ( struct V_162 * V_219 ,
unsigned int V_220 , unsigned int V_221 )
{
F_113 ( V_219 , V_220 , V_221 ) ;
F_119 ( V_219 , V_220 , V_221 ) ;
}
static void F_121 ( struct V_162 * V_219 ,
struct V_170 * V_170 )
{
...
static int F_123 ( struct V_49 * V_231 , struct V_1 * V_2 )
{
int V_143 ;
int V_115 = F_124 () ;
if ( V_115 && ! F_80 ( V_2 -> V_17 ) ) {
...
int F_125 ( struct V_49 * V_231 , bool V_233 )
{
int V_143 = 0 ;
...
if ( V_233 ) {
if ( ! V_2 -> V_13 )
V_143 = F_123 ( V_231 , V_2 ) ;
} else {
if ( V_2 -> V_13 ) {
if ( ! F_127 ( V_2 -> V_13 -> V_19 ,
V_20 ) ) {
V_143 = - V_234 ;
} else {
F_39 ( V_2 ) ;
