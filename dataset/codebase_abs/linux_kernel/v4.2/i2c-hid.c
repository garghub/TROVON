...
if ( F_90 ( & V_2 -> V_45 ) )
F_91 ( V_11 -> V_71 ) ;
if ( V_69 -> V_162 && V_69 -> V_162 -> V_163 )
V_14 = V_69 -> V_162 -> V_163 ( V_69 , V_164 ) ;
F_15 ( V_2 , V_63 ) ;
return V_14 ;
}
static int F_92 ( struct V_76 * V_45 )
{
int V_14 ;
struct V_1 * V_2 = F_88 ( V_45 ) ;
struct V_10 * V_11 = F_2 ( V_2 ) ;
...
if ( F_90 ( & V_2 -> V_45 ) )
F_94 ( V_11 -> V_71 ) ;
if ( V_69 -> V_162 && V_69 -> V_162 -> V_165 ) {
V_14 = V_69 -> V_162 -> V_165 ( V_69 ) ;
return V_14 ;
}
return 0 ;
}
