...
F_3 ( V_18 <= V_1 -> V_70 ) ;
V_2 = F_19 ( V_1 -> V_3 , & V_35 ,
(struct V_27 * ) V_29 , V_85 , V_18 , V_37 ) ;
if ( V_1 -> V_71 . V_25 != 0 ) {
for ( V_38 = 0 , V_68 = V_2 ; V_68 > 0 ; V_38 ++ , V_68 -= V_67 ) {
F_3 ( V_38 < V_30 ) ;
...
V_100 . V_103 = 0 ;
V_100 . V_104 = 0 ;
V_2 = F_17 ( V_17 , V_105 , V_106 ,
( char * ) & V_100 , sizeof( V_100 ) ) ;
if ( V_2 != 0 ) {
F_4 ( L_4 , V_2 ) ;
return V_2 ;
}
V_95 = - 1 ;
V_2 = F_17 ( V_17 , V_61 , V_107 ,
