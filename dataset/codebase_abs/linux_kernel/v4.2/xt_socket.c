...
{
struct V_1 * V_74 = (struct V_1 * ) V_2 ;
...
{
static struct V_72 V_83 = {
. V_76 = 0 ,
} ;
return F_18 ( V_2 , V_71 , & V_83 ) ;
}
static bool
F_22 ( const struct V_1 * V_2 , struct V_70 * V_71 )
{
return F_18 ( V_2 , V_71 , V_71 -> V_84 ) ;
}
static int
...
const struct V_85 * * V_5 ,
T_3 * V_6 ,
T_3 * V_7 ,
struct V_86 * V_87 )
{
const struct V_86 * V_10 ;
struct V_88 * V_13 , V_14 ;
T_3 * V_15 , V_16 [ 2 ] ;
T_1 V_89 ;
T_3 V_90 ;
int V_91 ;
...
const struct V_85 * V_25 , const struct V_85 * V_26 ,
const T_3 V_29 , const T_3 V_30 ,
const struct V_31 * V_32 )
{
switch ( V_3 ) {
...
{
T_3 V_44 ( V_30 ) , V_44 ( V_29 ) ;
const struct V_85 * V_26 = NULL , * V_25 = NULL ;
struct V_86 * V_43 = F_29 ( V_2 ) ;
int V_95 = 0 , V_96 ;
V_96 = F_30 ( V_2 , & V_95 , - 1 , NULL , NULL ) ;
if ( V_96 < 0 ) {
F_31 ( L_1 ) ;
return NULL ;
}
if ( V_96 == V_23 || V_96 == V_22 ) {
struct V_49 V_50 , * V_51 ;
V_51 = F_3 ( V_2 , V_95 , sizeof( V_50 ) , & V_50 ) ;
if ( V_51 == NULL )
return NULL ;
V_25 = & V_43 -> V_25 ;
V_29 = V_51 -> V_52 ;
...
struct V_86 V_87 ;
if ( F_23 ( V_2 , V_95 , & V_96 , & V_25 , & V_26 ,
& V_29 , & V_30 , & V_87 ) )
return NULL ;
} else {
return NULL ;
}
return F_25 ( F_17 ( V_2 -> V_69 ) , V_96 , V_25 , V_26 ,
V_29 , V_30 , V_42 ) ;
}
static bool
F_32 ( const struct V_1 * V_2 , struct V_70 * V_71 )
{
const struct V_72 * V_73 = (struct V_72 * ) V_71 -> V_84 ;
struct V_1 * V_74 = (struct V_1 * ) V_2 ;
struct V_27 * V_35 = V_2 -> V_35 ;
if ( ! V_35 )
...
static int F_34 ( const struct V_99 * V_71 )
{
const struct V_72 * V_73 = (struct V_72 * ) V_71 -> V_84 ;
if ( V_73 -> V_76 & ~ V_100 ) {
F_35 ( L_2 , V_73 -> V_76 & ~ V_100 ) ;
return - V_101 ;
}
return 0 ;
}
static int F_36 ( const struct V_99 * V_71 )
{
const struct V_102 * V_73 = (struct V_102 * ) V_71 -> V_84 ;
if ( V_73 -> V_76 & ~ V_103 ) {
F_35 ( L_2 , V_73 -> V_76 & ~ V_103 ) ;
return - V_101 ;
}
return 0 ;
}
static int F_37 ( const struct V_99 * V_71 )
{
const struct V_104 * V_73 =
(struct V_104 * ) V_71 -> V_84 ;
if ( V_73 -> V_76 & ~ V_105 ) {
F_35 ( L_2 ,
V_73 -> V_76 & ~ V_105 ) ;
return - V_101 ;
...
F_41 () ;
#endif
return F_42 ( V_106 , F_43 ( V_106 ) ) ;
}
static void T_5 F_44 ( void )
{
F_45 ( V_106 , F_43 ( V_106 ) ) ;
}
