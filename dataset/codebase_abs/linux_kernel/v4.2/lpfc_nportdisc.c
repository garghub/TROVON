...
( V_203 == V_205 ) &&
( ! V_200 -> V_38 . V_204 . V_206 ) ) {
V_204 = & V_200 -> V_38 . V_204 ;
V_199 = V_200 -> V_38 . V_204 . V_58 . V_207 [ 0 ] ;
F_55 ( V_41 , V_2 , V_199 ) ;
}
F_3 ( V_2 , V_35 , V_36 ,
L_14
...
struct V_45 * V_219 ;
V_43 = (struct V_42 * ) V_202 ;
if ( ( V_204 = V_41 -> V_64 . V_234 ) ) {
if ( ( V_204 -> V_38 . V_204 . V_235 == V_236 ) &&
( V_4 == (struct V_3 * ) V_204 -> V_52 ) ) {
F_74 ( V_4 ) ;
V_204 -> V_52 = NULL ;
V_204 -> V_132 = V_133 ;
}
...
T_5 * V_200 = ( T_5 * ) V_202 ;
T_9 * V_204 = & V_200 -> V_38 . V_204 ;
T_1 V_238 = V_204 -> V_58 . V_207 [ 1 ] ;
if ( V_204 -> V_206 ) {
F_3 ( V_2 , V_35 , V_36 ,
L_24
L_25 ,
V_238 , V_204 -> V_206 , V_2 -> V_87 ,
V_204 -> V_58 . V_239 . V_136 ,
V_204 -> V_58 . V_239 . V_199 ) ;
