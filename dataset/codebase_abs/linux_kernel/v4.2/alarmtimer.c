...
void F_34 ( struct V_21 * V_21 , T_1 V_55 )
{
struct V_19 * V_20 = & V_29 [ V_21 -> type ] ;
unsigned long V_2 ;
F_2 ( & V_20 -> V_33 , V_2 ) ;
V_21 -> V_25 . V_36 = V_55 ;
F_14 ( V_20 , V_21 ) ;
F_35 ( & V_21 -> V_28 , V_21 -> V_25 . V_36 , V_56 ) ;
F_3 ( & V_20 -> V_33 , V_2 ) ;
}
void F_36 ( struct V_21 * V_21 , T_1 V_55 )
{
struct V_19 * V_20 = & V_29 [ V_21 -> type ] ;
...
static int F_51 ( T_4 V_77 , struct V_78 * V_79 )
{
...
static int F_53 ( struct V_66 * V_84 )
{
enum V_54 type ;
struct V_19 * V_20 ;
if ( ! F_1 () )
...
type = F_47 ( V_84 -> V_88 ) ;
V_20 = & V_29 [ type ] ;
F_55 ( & V_84 -> V_68 . V_21 . V_69 , type , F_48 ) ;
return 0 ;
}
static void F_56 ( struct V_66 * V_89 ,
struct V_90 * V_91 )
{
T_1 V_92 =
...
V_91 -> V_94 = F_52 ( V_89 -> V_68 . V_21 . V_57 ) ;
}
static int F_57 ( struct V_66 * V_89 )
{
if ( ! V_5 )
return - V_85 ;
if ( F_38 ( & V_89 -> V_68 . V_21 . V_69 ) < 0 )
return V_95 ;
return 0 ;
}
static int F_58 ( struct V_66 * V_89 , int V_2 ,
struct V_90 * V_96 ,
struct V_90 * V_97 )
{
T_1 exp ;
...
if ( F_38 ( & V_89 -> V_68 . V_21 . V_69 ) < 0 )
return V_95 ;
V_89 -> V_68 . V_21 . V_57 = F_59 ( V_96 -> V_94 ) ;
exp = F_59 ( V_96 -> V_93 ) ;
if ( V_2 != V_98 ) {
T_1 V_41 ;
...
F_34 ( & V_89 -> V_68 . V_21 . V_69 , exp ) ;
return 0 ;
}
static enum V_65 F_60 ( struct V_21 * V_21 ,
T_1 V_41 )
{
...
static int F_62 ( struct V_21 * V_21 , T_1 V_53 )
{
...
F_65 () ;
F_40 ( V_21 ) ;
} while ( V_21 -> V_101 && ! F_66 ( V_102 ) );
F_67 ( V_104 ) ;
return ( V_21 -> V_101 == NULL ) ;
}
static int F_68 ( T_1 exp , enum V_54 type ,
...
return 0 ;
V_106 = F_52 ( V_107 ) ;
if ( F_69 ( V_105 , & V_106 , sizeof( * V_105 ) ) )
return - V_108 ;
return 1 ;
}
static long T_6 F_70 ( struct V_109 * V_31 )
{
...
static int F_72 ( const T_4 V_77 , int V_2 ,
