...
static void F_54 ( struct V_98 * V_99 , unsigned int V_100 )
{
#ifdef F_51
F_52 ( V_100 , 0 ) ;
#endif
...
if ( V_6 < 0 )
return V_6 ;
V_113 = ( V_70 [ 0 ] << 8 ) | V_70 [ 1 ] ;
if ( ( V_113 & V_3 -> V_115 ) != V_3 -> V_75 ) {
...
V_135 -> V_139 = V_135 -> V_140 = V_20 -> V_69 + V_130 ;
}
V_129 &= ~ V_20 -> V_20 ;
...
{
struct V_141 * V_111 = F_70 ( V_7 -> V_9 ) ;
...
if ( ! V_108 )
return - V_36 ;
V_111 = F_71 ( V_7 -> V_9 , sizeof( * V_111 ) , V_150 ) ;
if ( ! V_111 )
return - V_151 ;
F_63 ( V_111 , V_108 ) ;
if ( F_72 ( V_108 , L_25 , NULL ) == NULL )
V_7 -> V_69 = - 1 ;
}
V_1 = F_71 ( V_7 -> V_9 , sizeof( struct V_1 ) , V_150 ) ;
if ( ! V_1 )
return - V_151 ;
F_73 ( & V_1 -> V_91 ) ;
F_73 ( & V_1 -> V_17 ) ;
...
V_1 -> V_153 = F_74 ( V_7 -> V_9 , L_26 ) ;
if ( ! F_75 ( V_1 -> V_153 ) ) {
V_6 = F_76 ( V_1 -> V_153 ) ;
if ( V_6 )
F_62 ( V_7 -> V_9 , L_27 ) ;
}
V_1 -> V_154 = F_74 ( V_7 -> V_9 , L_28 ) ;
if ( ! F_75 ( V_1 -> V_154 ) ) {
V_6 = F_76 ( V_1 -> V_154 ) ;
if ( V_6 )
F_62 ( V_7 -> V_9 , L_29 ) ;
...
if ( V_6 )
return V_6 ;
V_6 = F_81 ( V_7 -> V_9 , V_1 -> V_69 , NULL ,
F_39 , V_111 -> V_110 | V_159 ,
L_30 , V_1 ) ;
if ( V_6 ) {
F_4 ( V_1 -> V_9 , L_34 ,
V_6 ) ;
...
static int F_85 ( struct V_160 * V_9 )
{
struct V_1 * V_1 = F_86 ( V_9 ) ;
if ( V_1 -> V_69 >= 0 && F_87 ( V_9 ) )
F_88 ( V_1 -> V_69 ) ;
return 0 ;
}
static int F_89 ( struct V_160 * V_9 )
{
struct V_1 * V_1 = F_86 ( V_9 ) ;
if ( V_1 -> V_69 >= 0 && F_87 ( V_9 ) )
F_90 ( V_1 -> V_69 ) ;
