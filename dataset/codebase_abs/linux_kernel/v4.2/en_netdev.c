...
static int F_215 ( struct V_1 * V_390 ,
T_6 V_385 )
{
struct V_4 * V_5 = F_2 ( V_390 ) ;
bool V_391 = false ;
int V_96 = 0 ;
if ( F_216 ( V_390 , V_385 , V_392 ) ) {
F_133 ( V_5 , L_84 ,
( V_385 & V_392 ) ? L_85 : L_86 ) ;
V_391 = true ;
}
if ( F_216 ( V_390 , V_385 , V_393 ) ) {
T_1 V_394 = ( V_385 & V_393 ) ? 1 : 0 ;
F_133 ( V_5 , L_87 ,
V_394 ? L_85 : L_86 ) ;
V_96 = F_217 ( V_5 -> V_82 -> V_2 ,
V_5 -> V_64 , V_394 ) ;
if ( V_96 )
return V_96 ;
}
if ( F_216 ( V_390 , V_385 , V_395 ) ) {
F_133 ( V_5 , L_88 ,
( V_385 & V_395 ) ? L_85 : L_86 ) ;
V_391 = true ;
}
if ( F_216 ( V_390 , V_385 , V_396 ) )
F_133 ( V_5 , L_89 ,
( V_385 & V_396 ) ? L_85 : L_86 ) ;
if ( F_216 ( V_390 , V_385 , V_397 ) ) {
F_133 ( V_5 , L_90 ,
...
static int F_219 ( struct V_1 * V_2 , int V_398 , T_1 * V_137 )
{
...
if ( ! F_84 ( V_137 ) )
return - V_9 ;
return F_220 ( V_82 -> V_2 , V_399 -> V_64 , V_398 , V_400 ) ;
}
static int F_221 ( struct V_1 * V_2 , int V_401 , T_4 V_402 , T_1 V_403 )
{
struct V_4 * V_399 = F_2 ( V_2 ) ;
struct V_122 * V_82 = V_399 -> V_82 ;
return F_222 ( V_82 -> V_2 , V_399 -> V_64 , V_401 , V_402 , V_403 ) ;
}
static int F_223 ( struct V_1 * V_2 , int V_401 , int V_404 ,
int V_405 )
{
struct V_4 * V_399 = F_2 ( V_2 ) ;
struct V_122 * V_82 = V_399 -> V_82 ;
return F_224 ( V_82 -> V_2 , V_399 -> V_64 , V_401 , V_404 ,
V_405 ) ;
}
static int F_225 ( struct V_1 * V_2 , int V_401 , bool V_406 )
{
struct V_4 * V_399 = F_2 ( V_2 ) ;
struct V_122 * V_82 = V_399 -> V_82 ;
return F_226 ( V_82 -> V_2 , V_399 -> V_64 , V_401 , V_406 ) ;
}
static int F_227 ( struct V_1 * V_2 , int V_401 , struct V_407 * V_408 )
{
struct V_4 * V_399 = F_2 ( V_2 ) ;
struct V_122 * V_82 = V_399 -> V_82 ;
return F_228 ( V_82 -> V_2 , V_399 -> V_64 , V_401 , V_408 ) ;
}
static int F_229 ( struct V_1 * V_2 , int V_401 , int V_209 )
{
struct V_4 * V_399 = F_2 ( V_2 ) ;
struct V_122 * V_82 = V_399 -> V_82 ;
return F_230 ( V_82 -> V_2 , V_399 -> V_64 , V_401 , V_209 ) ;
}
static int F_231 ( struct V_1 * V_2 , int V_401 ,
struct V_409 * V_410 )
{
struct V_4 * V_399 = F_2 ( V_2 ) ;
struct V_122 * V_82 = V_399 -> V_82 ;
return F_232 ( V_82 -> V_2 , V_399 -> V_64 , V_401 , V_410 ) ;
}
...
int V_6 ;
T_5 V_413 = V_82 -> V_130 . V_413 [ V_5 -> V_64 ] ;
if ( ! V_413 )
return - V_389 ;
V_412 -> V_414 = sizeof( V_413 ) ;
for ( V_6 = V_415 - 1 ; V_6 >= 0 ; -- V_6 ) {
V_412 -> V_37 [ V_6 ] = V_413 & 0xff ;
V_413 >>= 8 ;
}
return 0 ;
}
...
struct V_4 * V_5 = F_6 ( V_32 , struct V_4 ,
V_416 ) ;
V_96 = F_235 ( V_5 -> V_82 -> V_2 , V_5 -> V_417 ) ;
if ( V_96 )
goto V_112;
...
V_5 -> V_2 -> V_418 |= V_419 | V_420 |
V_421 | V_422 ;
V_5 -> V_2 -> V_423 |= V_422 ;
V_5 -> V_2 -> V_385 |= V_422 ;
}
static void F_236 ( struct V_31 * V_32 )
{
int V_96 ;
struct V_4 * V_5 = F_6 ( V_32 , struct V_4 ,
V_424 ) ;
...
if ( V_426 && V_426 != V_64 ) {
F_15 ( V_5 , L_92 ,
F_238 ( V_426 ) , F_238 ( V_64 ) ) ;
return;
}
V_5 -> V_417 = V_64 ;
F_37 ( V_5 -> V_82 -> V_115 , & V_5 -> V_416 ) ;
}
...
V_426 = V_5 -> V_417 ;
if ( V_426 != V_64 ) {
F_48 ( V_136 , V_5 , L_93 , F_238 ( V_64 ) ) ;
return;
}
F_37 ( V_5 -> V_82 -> V_115 , & V_5 -> V_424 ) ;
}
static T_6 F_240 ( struct V_98 * V_99 ,
struct V_1 * V_2 ,
T_6 V_385 )
{
V_385 = F_241 ( V_99 , V_385 ) ;
return F_242 ( V_99 , V_385 ) ;
}
static int F_243 ( struct V_1 * V_2 , int V_428 , T_3 V_429 )
{
struct V_4 * V_5 = F_2 ( V_2 ) ;
struct V_288 * V_219 = V_5 -> V_219 [ V_428 ] ;
struct V_430 V_431 ;
int V_114 ;
if ( ! ( V_5 -> V_82 -> V_2 -> V_130 . V_279 & V_432 ) )
return - V_389 ;
if ( V_429 >> 12 ) {
V_431 . V_433 = V_434 ;
V_431 . V_435 = V_429 / 1000 ;
} else if ( V_429 ) {
V_431 . V_433 = V_436 ;
V_431 . V_435 = V_429 ;
} else {
...
V_114 = F_244 ( V_5 -> V_82 -> V_2 , V_219 -> V_71 , V_437 ,
& V_431 ) ;
return V_114 ;
}
static void F_245 ( struct V_31 * V_32 )
{
struct V_438 * V_439 = F_6 ( V_32 ,
struct V_438 ,
V_32 ) ;
int V_114 = 0 ;
struct V_138 * V_2 = V_439 -> V_5 -> V_82 -> V_2 ;
if ( V_439 -> V_440 ) {
if ( ! F_246 ( V_2 ) ) {
V_114 = F_247 ( V_2 ) ;
if ( V_114 )
...
static int F_251 ( struct V_4 * V_5 , int V_440 ,
T_1 V_444 , T_1 V_445 )
{
struct V_438 * V_439 = NULL ;
V_439 = F_24 ( sizeof( * V_439 ) , V_90 ) ;
if ( ! V_439 )
return - V_113 ;
F_25 ( & V_439 -> V_32 , F_245 ) ;
V_439 -> V_5 = V_5 ;
V_439 -> V_440 = V_440 ;
V_439 -> V_441 . V_442 = V_444 ;
V_439 -> V_441 . V_443 = V_445 ;
F_252 ( V_5 -> V_2 ) ;
F_37 ( V_5 -> V_82 -> V_115 , & V_439 -> V_32 ) ;
return 0 ;
}
int F_253 ( struct V_446 * V_447 ,
unsigned long V_448 , void * V_449 )
{
struct V_1 * V_450 = F_254 ( V_449 ) ;
T_1 V_64 = 0 ;
struct V_122 * V_82 ;
struct V_138 * V_2 ;
int V_6 , V_451 = 0 ;
...
T_1 V_453 = 0 ;
T_1 V_454 = 0 ;
if ( ! F_255 ( F_256 ( V_450 ) , & V_455 ) )
return V_456 ;
V_82 = F_6 ( V_447 , struct V_122 , V_457 ) ;
V_2 = V_82 -> V_2 ;
F_257 (i, dev, MLX4_PORT_TYPE_ETH) {
++ V_451 ;
if ( ! V_64 && ( V_82 -> V_354 [ V_6 ] == V_450 ) )
V_64 = V_6 ;
V_82 -> V_355 [ V_6 ] = V_82 -> V_354 [ V_6 ] ?
F_258 ( V_82 -> V_354 [ V_6 ] ) : NULL ;
if ( ! V_82 -> V_355 [ V_6 ] )
V_452 = false ;
if ( V_451 < 2 )
continue;
...
V_452 = ( V_451 == 2 ) ? V_452 : false ;
if ( ( V_452 && ( V_448 != V_458 ) ) || ! V_64 )
return V_456 ;
V_5 = F_2 ( V_450 ) ;
if ( V_452 ) {
struct V_459 * V_460 = V_449 ;
struct V_461 * V_462 =
& V_460 -> V_462 ;
if ( ( V_462 -> V_463 . V_464 != V_465 ) &&
( V_462 -> V_463 . V_464 != V_466 ) &&
( V_462 -> V_463 . V_464 != V_467 ) )
V_452 = false ;
if ( V_462 -> V_463 . V_468 != 2 )
V_452 = false ;
if ( V_452 ) {
...
if ( ! F_260 ( V_2 ) &&
( V_2 -> V_130 . V_279 & V_481 ) ) {
F_50 ( & V_476 -> V_482 ) ;
F_261 ( V_476 -> V_483 , V_477 , V_484 ) ;
if ( V_321 )
F_262 ( V_476 -> V_483 , V_477 ,
V_485 ) ;
V_477 += V_485 ;
if ( V_320 && ! ( V_321 ) )
F_262 ( V_476 -> V_483 , V_477 ,
...
F_262 ( V_476 -> V_483 , V_477 , V_478 ) ;
}
V_477 += V_478 ;
F_262 ( V_476 -> V_483 , V_477 , V_479 ) ;
V_477 += V_479 ;
if ( F_267 ( V_2 ) )
F_262 ( V_476 -> V_483 , V_477 ,
V_480 ) ;
...
V_477 += V_484 ;
if ( ! F_260 ( V_2 ) )
F_262 ( V_476 -> V_483 , V_477 , V_494 ) ;
}
int F_268 ( struct V_122 * V_82 , int V_64 ,
struct V_344 * V_317 )
{
struct V_1 * V_2 ;
struct V_4 * V_5 ;
...
int V_114 ;
T_5 V_400 ;
V_2 = F_269 ( sizeof( struct V_4 ) ,
V_495 , V_496 ) ;
if ( V_2 == NULL )
return - V_113 ;
F_270 ( V_2 , V_317 -> V_218 ) ;
F_271 ( V_2 , V_317 -> V_216 ) ;
F_272 ( V_2 , & V_82 -> V_2 -> V_497 -> V_498 -> V_2 ) ;
V_2 -> V_499 = V_64 - 1 ;
V_5 = F_2 ( V_2 ) ;
...
F_274 ( & V_5 -> V_274 , F_125 ) ;
F_274 ( & V_5 -> V_278 , F_129 ) ;
#ifdef F_160
F_25 ( & V_5 -> V_416 , F_234 ) ;
F_25 ( & V_5 -> V_424 , F_236 ) ;
#endif
#ifdef F_190
F_62 ( & V_5 -> V_94 ) ;
F_273 ( & V_5 -> V_111 ) ;
...
V_5 -> V_2 = V_2 ;
V_5 -> V_82 = V_82 ;
V_5 -> V_500 = & V_82 -> V_498 -> V_2 ;
V_5 -> V_317 = V_317 ;
V_5 -> V_64 = V_64 ;
V_5 -> V_19 = false ;
V_5 -> V_167 = V_317 -> V_167 ;
V_5 -> V_501 = V_502 ;
V_5 -> V_503 = F_275 ( V_504 |
V_505 ) ;
V_5 -> V_10 = V_82 -> V_506 . V_10 ;
V_5 -> V_218 = V_317 -> V_218 ;
V_5 -> V_507 = V_508 ;
F_276 ( V_5 -> V_509 , sizeof( V_5 -> V_509 ) ) ;
V_5 -> V_219 = F_24 ( sizeof( struct V_288 * ) * V_495 ,
V_157 ) ;
if ( ! V_5 -> V_219 ) {
V_114 = - V_113 ;
goto V_112;
}
V_5 -> V_246 = F_24 ( sizeof( struct V_13 * ) * V_495 ,
V_157 ) ;
if ( ! V_5 -> V_246 ) {
V_114 = - V_113 ;
goto V_112;
...
V_5 -> V_511 = V_512 ;
#ifdef F_277
if ( ! F_260 ( V_5 -> V_82 -> V_2 ) ) {
if ( V_82 -> V_2 -> V_130 . V_279 & V_513 ) {
V_2 -> V_514 = & V_515 ;
} else {
F_133 ( V_5 , L_97 ) ;
V_2 -> V_514 = & V_516 ;
...
for ( V_6 = 0 ; V_6 < V_165 ; ++ V_6 )
F_278 ( & V_5 -> V_161 [ V_6 ] ) ;
V_5 -> V_296 = V_82 -> V_2 -> V_130 . V_517 [ V_5 -> V_64 ] ;
if ( V_82 -> V_2 -> V_130 . V_518 [ V_5 -> V_64 ] &
V_519 )
V_5 -> V_167 |= V_520 ;
V_2 -> V_521 = V_78 ;
F_57 ( V_2 -> V_77 , V_82 -> V_2 -> V_130 . V_522 [ V_5 -> V_64 ] ) ;
if ( ! F_84 ( V_2 -> V_77 ) ) {
if ( F_260 ( V_5 -> V_82 -> V_2 ) ) {
F_279 ( V_2 ) ;
F_15 ( V_5 , L_98 , V_2 -> V_77 ) ;
V_400 = F_66 ( V_2 -> V_77 ) ;
V_82 -> V_2 -> V_130 . V_522 [ V_5 -> V_64 ] = V_400 ;
} else {
F_18 ( V_5 , L_99 ,
V_5 -> V_64 , V_2 -> V_77 ) ;
V_114 = - V_9 ;
...
V_5 -> V_343 = F_280 ( sizeof( struct V_523 ) +
V_524 * V_525 ) ;
V_114 = F_194 ( V_5 ) ;
if ( V_114 )
goto V_112;
...
V_114 = F_281 ( V_82 -> V_2 , & V_5 -> V_352 ,
V_353 , V_353 ) ;
if ( V_114 ) {
F_18 ( V_5 , L_100 ) ;
goto V_112;
...
F_271 ( V_2 , V_5 -> V_216 ) ;
V_2 -> V_531 = & V_532 ;
V_2 -> V_423 = V_533 | V_419 | V_534 ;
if ( V_82 -> V_535 )
V_2 -> V_423 |= V_421 | V_536 ;
V_2 -> V_537 = V_2 -> V_423 ;
V_2 -> V_423 |= V_420 | V_538 ;
V_2 -> V_385 = V_2 -> V_423 | V_539 |
V_396 | V_395 |
V_540 ;
V_2 -> V_423 |= V_397 |
V_396 | V_395 ;
if ( V_82 -> V_2 -> V_130 . V_167 & V_541 )
V_2 -> V_423 |= V_392 ;
if ( V_82 -> V_2 -> V_130 . V_279 & V_542 )
V_2 -> V_423 |= V_393 ;
if ( V_82 -> V_2 -> V_130 . V_139 ==
V_145 &&
...
V_2 -> V_213 |= V_214 ;
if ( V_82 -> V_2 -> V_130 . V_279 & V_544 ) {
V_5 -> V_545 = V_546 ;
} else if ( V_82 -> V_2 -> V_130 . V_279 & V_547 ) {
V_5 -> V_545 = V_548 ;
} else {
F_15 ( V_5 ,
L_101 ) ;
...
F_134 ( V_2 ) ;
F_122 ( V_5 ) ;
F_15 ( V_5 , L_102 , V_317 -> V_218 ) ;
F_15 ( V_5 , L_103 , V_317 -> V_216 ) ;
F_218 ( V_5 -> V_2 , V_5 -> V_2 -> V_385 ) ;
F_143 ( V_2 ) ;
V_114 = F_155 ( V_82 -> V_2 , V_5 -> V_64 ,
V_5 -> V_297 + V_316 ,
...
F_128 ( V_82 -> V_115 , & V_5 -> V_278 ,
V_281 ) ;
F_263 ( V_82 -> V_2 , & V_5 -> V_476 ,
V_82 -> V_506 . V_317 [ V_5 -> V_64 ] . V_321 ,
V_82 -> V_506 . V_317 [ V_5 -> V_64 ] . V_320 ,
V_82 -> V_506 . V_317 [ V_5 -> V_64 ] . V_319 ,
V_82 -> V_506 . V_317 [ V_5 -> V_64 ] . V_318 ) ;
V_114 = F_282 ( V_2 ) ;
if ( V_114 ) {
F_18 ( V_5 , L_104 , V_64 ) ;
goto V_112;
...
int V_19 = 0 ;
int V_114 = 0 ;
if ( V_5 -> V_361 . V_365 == V_549 . V_365 &&
V_5 -> V_361 . V_369 == V_549 . V_369 &&
! F_216 ( V_2 , V_385 , V_395 ) &&
! F_216 ( V_2 , V_385 , V_392 ) )
return 0 ;
if ( F_216 ( V_2 , V_385 , V_395 ) &&
( V_385 & V_395 ) &&
( V_5 -> V_361 . V_369 != V_370 ) ) {
F_15 ( V_5 , L_105 ) ;
return - V_9 ;
...
F_189 ( V_5 ) ;
F_15 ( V_5 , L_106 ,
V_549 . V_369 , ! ! ( V_385 & V_395 ) ) ;
V_5 -> V_361 . V_365 = V_549 . V_365 ;
V_5 -> V_361 . V_369 = V_549 . V_369 ;
if ( F_216 ( V_2 , V_385 , V_395 ) ) {
if ( V_385 & V_395 )
V_2 -> V_385 |= V_395 ;
...
V_2 -> V_385 &= ~ V_395 ;
} else if ( V_549 . V_369 == V_370 ) {
if ( V_2 -> V_550 & V_395 )
V_2 -> V_385 |= V_395 ;
else
V_2 -> V_385 &= ~ V_395 ;
}
if ( F_216 ( V_2 , V_385 , V_392 ) ) {
if ( V_385 & V_392 )
V_2 -> V_385 |= V_392 ;
else
V_2 -> V_385 &= ~ V_392 ;
}
if ( V_549 . V_369 != V_370 ) {
if ( V_2 -> V_385 & V_395 )
F_15 ( V_5 , L_107 ) ;
V_2 -> V_385 &= ~ V_395 ;
}
