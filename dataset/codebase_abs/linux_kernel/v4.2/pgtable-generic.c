...
F_17 ( V_6 & ~ V_13 ) ;
F_17 ( ! F_30 ( * V_12 ) ) ;
V_3 = F_31 ( V_5 -> V_11 , V_6 , V_12 ) ;
F_19 ( V_5 , V_6 , V_6 + V_14 ) ;
return V_3 ;
}
void F_32 ( struct V_4 * V_5 , unsigned long V_6 ,
T_3 * V_12 )
{
T_3 V_3 = F_33 ( * V_12 ) ;
F_17 ( V_6 & ~ V_13 ) ;
...
void F_34 ( struct V_16 * V_17 , T_3 * V_12 ,
T_5 V_19 )
{
F_35 ( F_36 ( V_17 , V_12 ) ) ;
if ( ! F_37 ( V_17 , V_12 ) )
...
F_39 ( & V_19 -> V_20 , & F_37 ( V_17 , V_12 ) -> V_20 ) ;
F_37 ( V_17 , V_12 ) = V_19 ;
}
T_5 F_40 ( struct V_16 * V_17 , T_3 * V_12 )
{
T_5 V_19 ;
F_35 ( F_36 ( V_17 , V_12 ) ) ;
V_19 = F_37 ( V_17 , V_12 ) ;
...
F_37 ( V_17 , V_12 ) = F_42 ( V_19 -> V_20 . V_21 ,
struct V_22 , V_20 ) ;
F_43 ( & V_19 -> V_20 ) ;
}
return V_19 ;
}
void F_44 ( struct V_4 * V_5 , unsigned long V_6 ,
T_3 * V_12 )
{
T_3 V_8 = * V_12 ;
F_18 ( V_5 -> V_11 , V_6 , V_12 , F_45 ( V_8 ) ) ;
F_19 ( V_5 , V_6 , V_6 + V_14 ) ;
}
T_3 F_46 ( struct V_4 * V_5 , unsigned long V_6 ,
T_3 * V_12 )
{
T_3 V_3 ;
F_17 ( V_6 & ~ V_13 ) ;
