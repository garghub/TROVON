...
if ( V_79 != V_2 || memcmp ( V_1 , V_77 , sizeof( V_1 ) ) )
V_80 [ V_7 ] . V_84 = 1 ;
}
if ( ! V_80 [ V_7 ] . V_84 && ( V_81 - V_78 < V_85 [ V_72 ] ) )
V_85 [ V_72 ] = V_81 - V_78 ;
}
...
char V_89 , V_90 , V_91 ;
V_86 = F_14 ( V_80 [ V_7 ] . V_60 , & V_89 ) ;
V_87 = F_14 ( V_80 [ V_7 ] . V_59 , & V_90 ) ;
V_88 = F_14 ( V_80 [ V_7 ] . V_82 , & V_91 ) ;
F_32 ( L_16 ,
V_80 [ V_7 ] . V_84 ? L_17 : L_18 ,
V_86 , V_89 , V_87 , V_90 ) ;
F_33 ( L_19 ,
V_80 [ V_7 ] . V_72 , V_80 [ V_7 ] . V_84 ? L_20 : L_21 ,
V_88 , V_91 ) ;
}
...
static T_4 T_1
F_41 ( unsigned long V_113 , unsigned long V_114 )
{
T_4 V_115 , V_116 ;
V_115 = V_113 ;
V_115 <<= V_20 ;
...
V_116 <<= V_20 ;
V_116 -= V_115 ;
return F_42 ( V_115 , V_116 , V_117 , V_118 ) ;
}
int T_1 F_43 ( unsigned long V_119 )
{
unsigned long V_7 , V_5 , V_6 , V_120 = 0 , V_95 , V_96 ;
T_2 type ;
T_4 V_121 ;
int V_73 [ V_74 + 1 ] ;
if ( ! F_36 ( V_97 ) || V_103 )
...
V_1 [ V_2 ] . V_17 = V_101 >> V_20 ;
if ( V_120 < V_1 [ V_2 ] . V_17 )
V_120 = V_1 [ V_2 ] . V_17 ;
V_2 ++ ;
}
V_2 = F_1 ( V_1 , V_2 , 0 , 0 ) ;
V_121 = 0 ;
if ( V_1 [ 0 ] . V_16 )
V_121 += F_41 ( 0 , V_1 [ 0 ] . V_16 ) ;
for ( V_7 = 0 ; V_7 < V_2 - 1 ; V_7 ++ ) {
if ( V_1 [ V_7 ] . V_17 < V_1 [ V_7 + 1 ] . V_16 )
V_121 += F_41 ( V_1 [ V_7 ] . V_17 ,
V_1 [ V_7 + 1 ] . V_16 ) ;
}
V_7 = V_2 - 1 ;
if ( V_1 [ V_7 ] . V_17 < V_119 )
V_121 += F_41 ( V_1 [ V_7 ] . V_17 ,
V_119 ) ;
if ( V_121 ) {
F_44 ( L_32 , V_121 >> 20 ) ;
