...
switch ( type ) {
case V_182 :
F_78 ( L_95 , V_14 -> V_6 -> V_7 , V_14 -> V_20 . V_21 ) ;
if ( V_14 -> V_6 -> V_22 ) {
...
F_78 ( L_100 , F_76 ( & V_14 -> V_20 ) ) ;
F_78 ( L_101 ,
( strcmp ( V_14 -> V_20 . V_185 , L_91 ) ) ? 0 :
( unsigned long long )
...
V_14 -> V_20 . V_54 . V_82 ) ;
if ( V_14 -> V_71 & V_84 )
F_78 ( L_107 , V_14 -> V_20 . V_86 ) ;
if ( V_14 -> V_71 & V_87 )
F_78 ( L_108 , V_14 -> V_20 . V_88 ) ;
for ( V_8 = 0 ; V_8 < V_14 -> V_20 . V_21 ; V_8 ++ )
if ( V_14 -> V_17 [ V_8 ] . V_30 &&
F_19 ( V_76 , & V_14 -> V_17 [ V_8 ] . V_28 . V_41 ) )
F_78 ( L_109 , V_8 ) ;
...
F_78 ( L_114 ,
F_1 ( V_14 -> V_20 . V_1 ) ) ;
F_78 ( L_115 , V_14 -> V_20 . V_21 ) ;
for ( V_8 = 0 ; V_8 < V_14 -> V_20 . V_21 ; V_8 ++ ) {
if ( V_14 -> V_17 [ V_8 ] . V_29 )
F_78 ( L_100 , V_14 -> V_17 [ V_8 ] . V_29 -> V_7 ) ;
else
F_78 ( L_116 ) ;
if ( V_14 -> V_17 [ V_8 ] . V_30 )
F_78 ( L_100 , V_14 -> V_17 [ V_8 ] . V_30 -> V_7 ) ;
else
F_78 ( L_116 ) ;
}
}
...
static int F_95 ( struct V_11 * V_12 , struct V_207 * V_208 ,
struct V_209 * V_210 , int V_211 )
{
struct V_10 * V_14 = V_12 -> V_154 ;
struct V_212 * V_162 = V_14 -> V_20 . V_162 ;
if ( V_162 && V_162 -> V_213 )
return F_96 ( V_211 , V_162 -> V_213 ( & V_14 -> V_20 , V_208 , V_210 ) ) ;
return V_14 -> V_20 . V_53 ;
}
