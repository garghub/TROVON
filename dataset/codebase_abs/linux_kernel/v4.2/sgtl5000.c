...
{
int V_219 , V_118 , V_269 , V_270 ;
for ( V_219 = 0 ; V_219 < F_42 ( V_271 ) ; V_219 ++ ) {
V_269 = V_271 [ V_219 ] . V_272 ;
V_270 = V_271 [ V_219 ] . V_31 ;
V_118 = F_61 ( V_10 -> V_167 , V_270 , V_269 ) ;
if ( V_118 )
return V_118 ;
}
return 0 ;
}
static int F_62 ( struct V_273 * V_274 ,
const struct V_275 * V_276 )
{
struct V_9 * V_10 ;
int V_118 , V_31 , V_277 ;
struct V_278 * V_279 = V_274 -> V_88 . V_280 ;
T_1 V_26 ;
V_10 = F_63 ( & V_274 -> V_88 , sizeof( * V_10 ) , V_149 ) ;
if ( ! V_10 )
return - V_150 ;
V_10 -> V_167 = F_64 ( V_274 , & V_281 ) ;
if ( F_35 ( V_10 -> V_167 ) ) {
V_118 = F_36 ( V_10 -> V_167 ) ;
F_18 ( & V_274 -> V_88 , L_15 , V_118 ) ;
return V_118 ;
}
V_10 -> V_282 = F_65 ( & V_274 -> V_88 , NULL ) ;
if ( F_35 ( V_10 -> V_282 ) ) {
V_118 = F_36 ( V_10 -> V_282 ) ;
F_18 ( & V_274 -> V_88 , L_16 , V_118 ) ;
if ( V_118 == - V_283 )
return - V_256 ;
return V_118 ;
}
V_118 = F_66 ( V_10 -> V_282 ) ;
if ( V_118 )
return V_118 ;
F_43 ( 1 ) ;
...
V_277 = ( V_31 & V_289 ) >> V_290 ;
F_52 ( & V_274 -> V_88 , L_18 , V_277 ) ;
V_10 -> V_255 = V_277 ;
if ( V_279 ) {
if ( ! F_68 ( V_279 ,
L_19 , & V_26 ) ) {
...
static int F_72 ( struct V_273 * V_274 )
{
struct V_9 * V_10 = F_73 ( V_274 ) ;
F_74 ( & V_274 -> V_88 ) ;
F_71 ( V_10 -> V_282 ) ;
return 0 ;
}
