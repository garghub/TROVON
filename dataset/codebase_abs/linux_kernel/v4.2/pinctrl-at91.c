...
{
struct V_117 * V_175 = F_102 ( V_120 ) ;
...
static void F_106 ( struct V_119 * V_120 ,
unsigned long * V_50 , unsigned long * V_182 )
{
struct V_117 * V_175 = F_102 ( V_120 ) ;
void T_1 * V_49 = V_175 -> V_42 ;
#define F_107 ( V_182 ) (((bits) == 32) ? ~0U : (BIT(bits) - 1))
T_3 V_183 = ( * V_50 & * V_182 ) & F_107 ( V_120 -> V_174 ) ;
T_3 V_184 = ( * V_50 & ~ ( * V_182 ) ) & F_107 ( V_120 -> V_174 ) ;
F_25 ( V_183 , V_49 + V_180 ) ;
F_25 ( V_184 , V_49 + V_181 ) ;
}
static int F_108 ( struct V_119 * V_120 , unsigned V_18 ,
int V_147 )
{
struct V_117 * V_175 = F_102 ( V_120 ) ;
void T_1 * V_49 = V_175 -> V_42 ;
...
static void F_109 ( struct V_16 * V_17 , struct V_119 * V_120 )
{
enum V_64 V_185 ;
int V_6 ;
struct V_117 * V_175 = F_102 ( V_120 ) ;
...
const char * V_186 ;
V_186 = F_110 ( V_120 , V_6 ) ;
if ( ! V_186 )
continue;
V_185 = V_175 -> V_104 -> V_187 ( V_49 , V_50 ) ;
F_8 ( V_17 , L_43 ,
V_186 , V_120 -> V_188 , V_6 ) ;
if ( V_185 == V_67 ) {
F_8 ( V_17 , L_44 ) ;
F_8 ( V_17 , L_45 ,
...
{
struct V_117 * V_175 = F_112 ( V_190 ) ;
void T_1 * V_49 = V_175 -> V_42 ;
unsigned V_50 = 1 << V_190 -> V_191 ;
if ( V_49 )
F_25 ( V_50 , V_49 + V_51 ) ;
}
static void F_113 ( struct V_189 * V_190 )
{
struct V_117 * V_175 = F_112 ( V_190 ) ;
void T_1 * V_49 = V_175 -> V_42 ;
unsigned V_50 = 1 << V_190 -> V_191 ;
if ( V_49 )
F_25 ( V_50 , V_49 + V_192 ) ;
}
static int F_114 ( struct V_189 * V_190 , unsigned type )
{
switch ( type ) {
case V_193 :
case V_194 :
...
static int F_115 ( struct V_189 * V_190 , unsigned type )
{
struct V_117 * V_175 = F_112 ( V_190 ) ;
void T_1 * V_49 = V_175 -> V_42 ;
unsigned V_50 = 1 << V_190 -> V_191 ;
...
case V_193 :
default:
F_117 ( L_52 , F_118 ( V_190 -> V_196 ) ) ;
return - V_15 ;
}
F_25 ( V_50 , V_49 + V_207 ) ;
return 0 ;
}
static void F_119 ( struct V_189 * V_190 )
{
}
static int F_120 ( struct V_189 * V_190 )
{
struct V_117 * V_175 = F_112 ( V_190 ) ;
unsigned V_43 = V_190 -> V_191 ;
int V_101 ;
V_101 = F_121 ( & V_175 -> V_120 , V_43 ) ;
if ( V_101 )
F_11 ( V_175 -> V_120 . V_9 , L_53 ,
V_190 -> V_191 ) ;
return V_101 ;
}
static void F_122 ( struct V_189 * V_190 )
{
struct V_117 * V_175 = F_112 ( V_190 ) ;
unsigned V_43 = V_190 -> V_191 ;
F_123 ( & V_175 -> V_120 , V_43 ) ;
}
static int F_124 ( struct V_189 * V_190 , unsigned V_208 )
{
struct V_117 * V_175 = F_112 ( V_190 ) ;
unsigned V_40 = V_175 -> V_209 ;
unsigned V_50 = 1 << V_190 -> V_191 ;
if ( F_125 ( V_40 >= V_210 ) )
return - V_15 ;
if ( V_208 )
...
continue;
V_49 = V_41 [ V_6 ] -> V_42 ;
V_213 [ V_6 ] = F_27 ( V_49 + V_214 ) ;
F_25 ( V_213 [ V_6 ] , V_49 + V_51 ) ;
F_25 ( V_211 [ V_6 ] , V_49 + V_192 ) ;
if ( ! V_211 [ V_6 ] )
...
V_49 = V_41 [ V_6 ] -> V_42 ;
if ( ! V_211 [ V_6 ] )
F_131 ( V_41 [ V_6 ] -> clock ) ;
F_25 ( V_211 [ V_6 ] , V_49 + V_51 ) ;
F_25 ( V_213 [ V_6 ] , V_49 + V_192 ) ;
}
}
static void F_132 ( unsigned V_196 , struct V_216 * V_217 )
{
struct V_218 * V_120 = F_133 ( V_196 ) ;
struct V_119 * V_119 = F_134 ( V_217 ) ;
...
F_135 ( V_120 , V_217 ) ;
for (; ; ) {
V_219 = F_27 ( V_49 + V_221 ) & F_27 ( V_49 + V_214 ) ;
if ( ! V_219 ) {
if ( ! V_175 -> V_222 )
break;
V_175 = V_175 -> V_222 ;
...
static int F_140 ( struct V_159 * V_160 ,
struct V_117 * V_175 )
{
struct V_119 * V_224 = NULL ;
struct V_117 * V_225 = NULL ;
struct V_189 * V_190 = F_141 ( V_175 -> V_212 ) ;
int V_101 , V_6 ;
V_175 -> V_226 = F_142 ( V_190 ) ;
V_227 . V_228 = V_175 -> V_104 -> V_229 ;
F_25 ( ~ 0 , V_175 -> V_42 + V_51 ) ;
V_101 = F_143 ( & V_175 -> V_120 ,
& V_227 ,
0 ,
V_230 ,
V_194 ) ;
...
V_225 = F_64 ( V_224 , struct V_117 , V_120 ) ;
for ( V_6 = 0 ; V_6 < 2 ; V_6 ++ ) {
if ( V_225 -> V_222 ) {
V_225 = V_225 -> V_222 ;
} else {
...
static int F_146 ( struct V_159 * V_160 )
{
struct V_19 * V_20 = V_160 -> V_9 . V_161 ;
struct V_231 * V_232 ;
...
V_232 = F_151 ( V_160 , V_237 , 0 ) ;
V_118 -> V_42 = F_152 ( & V_160 -> V_9 , V_232 ) ;
if ( F_90 ( V_118 -> V_42 ) ) {
V_101 = F_91 ( V_118 -> V_42 ) ;
goto V_236;
}
V_118 -> V_104 = (struct V_163 * )
F_84 ( V_238 , & V_160 -> V_9 ) -> V_30 ;
V_118 -> V_212 = V_196 ;
V_118 -> V_209 = V_233 ;
...
V_120 = & V_118 -> V_120 ;
V_120 -> V_161 = V_20 ;
V_120 -> V_188 = F_9 ( & V_160 -> V_9 ) ;
V_120 -> V_9 = & V_160 -> V_9 ;
V_120 -> V_242 = V_243 ;
V_120 -> V_122 = V_233 * V_44 ;
if ( ! F_156 ( V_20 , L_59 , & V_174 ) ) {
if ( V_174 >= V_44 )
F_157 ( L_60 ,
V_233 , V_44 , V_44 ) ;
else
...
V_234 = F_12 ( & V_160 -> V_9 , sizeof( char * ) * V_120 -> V_174 ,
V_27 ) ;
if ( ! V_234 ) {
V_101 = - V_28 ;
goto V_240;
...
for ( V_6 = 0 ; V_6 < V_120 -> V_174 ; V_6 ++ )
V_234 [ V_6 ] = F_87 ( V_27 , L_39 , V_233 + 'A' , V_6 ) ;
V_120 -> V_234 = ( const char * const * ) V_234 ;
V_115 = & V_118 -> V_115 ;
V_115 -> V_4 = V_120 -> V_188 ;
V_115 -> V_123 = V_233 ;
V_115 -> V_244 = V_115 -> V_122 = V_115 -> V_123 * V_44 ;
...
goto V_245;
V_41 [ V_233 ] = V_118 ;
V_92 = F_159 ( V_92 , V_233 + 1 ) ;
V_101 = F_140 ( V_160 , V_118 ) ;
if ( V_101 )
goto V_246;
...
V_239:
V_236:
F_11 ( & V_160 -> V_9 , L_62 , V_101 , V_233 ) ;
return V_101 ;
}
