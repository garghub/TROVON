...
static int F_24 ( const unsigned char * V_15 , unsigned int V_89 ,
...
return V_17 ;
V_97 = 0 ;
V_97 = F_27 ( V_97 , V_106 , V_100 ) ;
V_97 = F_27 ( V_97 , V_107 , 0 ) ;
V_97 = F_27 ( V_97 , V_108 , V_93 ) ;
V_96 = F_4 ( V_27 ) & V_109 ;
V_96 |= V_110 ;
V_95 -> V_96 = F_3 ( V_96 ) ;
V_25 -> V_28 = F_14 () ;
V_17 = F_28 ( F_2 ( V_97 ) , V_95 ) ;
F_23 ( L_40 , V_17 ,
( unsigned int ) V_97 ,
( unsigned int ) F_29 ( V_95 -> V_97 ) ) ;
switch ( V_17 ) {
case V_111 :
V_17 = F_13 ( V_25 , V_27 ) ;
break;
...
void * V_25 )
{
return F_24 ( V_15 , V_89 , V_90 , V_91 ,
V_25 , V_115 ) ;
}
...
V_124 = F_29 ( * ( unsigned int * ) V_122 -> V_127 ) ;
V_123 = F_35 ( V_118 , L_47 , NULL ) ;
if ( ! V_123 ) {
F_34 ( L_48 ) ;
return - V_20 ;
}
V_125 = F_29 ( * ( unsigned int * ) V_123 -> V_127 ) ;
...
if ( ! F_43 ( & V_137 ) ) {
struct V_119 * V_120 , * V_138 ;
F_44 (coproc, n, &nx842_coprocs, list) {
F_45 ( & V_120 -> V_130 ) ;
F_46 ( V_120 ) ;
}
return - V_139 ;
