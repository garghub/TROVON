...
void F_116 ( struct V_125 * V_81 , struct V_111 * V_112 )
{
...
struct V_4 * V_5 , struct V_125 * V_81 )
{
F_112 ( V_9 , V_5 , & V_81 -> V_129 ) ;
F_112 ( V_9 , V_5 , & V_81 -> V_139 ) ;
}
...
void F_120 ( struct V_125 * V_81 , struct V_111 * V_112 )
{
F_73 ( V_81 ) ;
F_116 ( V_81 , V_112 ) ;
}
...
static int F_128 ( const struct V_8 * V_9 , struct V_174 * V_175 ,
struct V_111 * V_112 )
{
struct V_177 * V_178 ;
struct V_109 * V_18 ;
...
V_178 = F_130 ( V_18 -> V_192 -> V_53 . V_114 ) ;
...
void F_131 ( const struct V_8 * V_9 , struct V_174 * V_175 , int V_146 )
{
struct V_176 * V_18 ;
while ( ! F_9 ( & V_175 -> V_181 ) ) {
V_18 = F_132 ( V_175 -> V_181 . V_22 ,
struct V_176 , V_180 ) ;
F_11 ( & V_18 -> V_180 ) ;
...
struct V_174 * F_133 ( const struct V_8 * V_9 , struct V_111 * V_112 ,
enum V_135 V_136 , int V_197 )
{
struct V_174 * V_175 ;
F_8 ( V_197 > 0 ) ;
V_175 = F_63 ( sizeof( * V_175 ) , V_104 ) ;
if ( V_175 != NULL ) {
int V_40 ;
V_175 -> V_198 = V_136 ;
F_15 ( & V_175 -> V_186 ) ;
F_15 ( & V_175 -> V_181 ) ;
V_175 -> V_189 = F_134 ( V_197 , sizeof( V_175 -> V_189 [ 0 ] ) ,
V_104 ) ;
if ( V_175 -> V_189 != NULL ) {
V_175 -> V_188 = V_197 ;
V_40 = F_128 ( V_9 , V_175 , V_112 ) ;
} else
V_40 = - V_105 ;
if ( V_40 != 0 ) {
F_131 ( V_9 , V_175 , V_40 ) ;
V_175 = F_135 ( V_40 ) ;
}
} else
V_175 = F_135 ( - V_105 ) ;
...
void F_136 ( const struct V_8 * V_9 ,
...
void F_140 ( const struct V_8 * V_9 , struct V_111 * V_112 )
{
...
int F_141 ( const struct V_8 * V_9 , struct V_174 * V_175 )
{
int V_185 ;
int V_40 ;
...
void F_142 ( const struct V_8 * V_9 , struct V_174 * V_175 ,
...
int V_185 ;
F_12 ( ! F_9 ( & V_175 -> V_186 ) ) ;
V_112 = F_132 ( V_175 -> V_186 . V_156 , struct V_111 , V_201 ) ;
for ( V_185 = 0 ; V_185 < V_175 -> V_188 ; ++ V_185 ) {
F_35 (slice, &req->crq_layers, crs_linkage) {
...
{
F_143 ( & V_143 -> V_211 ) ;
F_144 ( & V_143 -> V_212 , V_210 ) ;
F_144 ( & V_143 -> V_213 , V_210 > 0 ) ;
V_143 -> V_214 = 0 ;
}
...
long V_141 )
{
struct V_215 V_216 = F_145 ( F_146 ( V_141 ) ,
NULL , NULL , NULL ) ;
int V_146 ;
F_12 ( V_141 >= 0 ) ;
V_146 = F_147 ( V_143 -> V_211 ,
F_148 ( & V_143 -> V_212 ) == 0 ,
& V_216 ) ;
if ( V_146 < 0 ) {
F_86 ( L_8 ,
V_146 , F_148 ( & V_143 -> V_212 ) ) ;
( void ) F_85 ( V_9 , V_5 , V_81 ) ;
V_216 = (struct V_215 ) { 0 } ;
( void ) F_147 ( V_143 -> V_211 ,
F_148 ( & V_143 -> V_212 ) == 0 ,
& V_216 ) ;
} else {
V_146 = V_143 -> V_214 ;
}
F_12 ( F_148 ( & V_143 -> V_212 ) == 0 ) ;
F_110 ( V_9 , V_5 , V_81 ) ;
while ( F_149 ( F_148 ( & V_143 -> V_213 ) != 0 ) ) {
F_150 () ;
}
F_151 ( V_143 , 0x5a , sizeof( * V_143 ) ) ;
return V_146 ;
}
