...
switch ( V_189 ) {
case V_456 :
V_459 -> V_347 = V_23 -> V_451 ;
V_459 -> V_345 = F_107 ( V_452 ) ;
V_459 -> V_461 = V_23 -> V_161 ;
V_459 -> V_462 = F_107 ( V_455 ) ;
break;
case V_463 :
V_459 -> V_347 = V_23 -> V_453 ;
V_459 -> V_345 = F_107 ( V_454 ) ;
V_459 -> V_461 = V_23 -> V_161 + 4 ;
V_459 -> V_462 = F_107 ( V_455 ) - 4 ;
...
V_480 << 12 |
V_480 << 14 ) ;
V_459 -> V_464 . V_478 . V_481 =
V_459 -> V_464 . V_478 . V_479 ;
break;
default:
continue;
}
V_459 -> V_482 . V_483 = true ;
V_459 -> V_482 . V_466 = V_484 |
V_485 |
V_486 |
V_487 |
V_488 ;
V_459 -> V_482 . V_489 = 0x3 ;
V_459 -> V_482 . V_490 = 0x6 ;
memset ( & V_459 -> V_482 . V_491 , 0 ,
sizeof( V_459 -> V_482 . V_491 ) ) ;
V_459 -> V_482 . V_491 . V_492 [ 0 ] = 0xff ;
V_459 -> V_482 . V_491 . V_492 [ 1 ] = 0xff ;
V_459 -> V_482 . V_491 . V_493 = V_494 ;
...
V_44 -> V_495 = 4 ;
V_44 -> V_496 = 11 ;
V_44 -> V_20 -> V_497 = V_498 ;
V_44 -> V_20 -> V_499 =
F_107 ( V_498 ) ;
V_44 -> V_20 -> V_500 = V_501 ;
V_44 -> V_20 -> V_502 = F_107 ( V_501 ) ;
if ( V_380 -> V_388 )
V_44 -> V_20 -> V_503 |= V_504 ;
if ( V_380 -> V_385 ) {
V_23 -> V_385 = V_380 -> V_385 ;
V_44 -> V_20 -> V_503 |= V_505 ;
...
F_15 ( V_44 -> V_20 , L_51 , V_44 -> V_20 -> V_509 ) ;
if ( V_380 -> V_383 ) {
V_23 -> V_510 [ 0 ] = V_380 -> V_383 [ 0 ] ;
V_23 -> V_510 [ 1 ] = V_380 -> V_383 [ 1 ] ;
F_202 ( V_44 -> V_20 , V_380 -> V_383 ) ;
}
V_23 -> V_511 = F_203 ( L_52 , V_44 -> V_20 -> V_512 ) ;
F_204 ( L_53 , 0666 , V_23 -> V_511 , V_23 , & V_513 ) ;
F_204 ( L_54 , 0666 , V_23 -> V_511 , V_23 ,
& V_514 ) ;
if ( ! V_23 -> V_218 )
F_204 ( L_55 , 0222 ,
V_23 -> V_511 ,
...
struct V_40 * V_23 ,
T_1 V_412 , T_1 V_520 ,
struct V_521 * V_122 , int V_89 )
{
void * V_58 ;
struct V_379 V_380 = { } ;
int V_522 = - V_523 ;
V_58 = F_72 ( V_26 , V_412 , V_520 , & V_146 , V_89 ,
V_524 ) ;
if ( ! V_58 )
return - V_523 ;
if ( V_122 )
F_215 ( V_122 , V_58 , & V_146 ) ;
if ( V_23 -> V_510 [ 0 ] && V_23 -> V_510 [ 1 ] )
V_380 . V_383 = V_23 -> V_510 ;
V_380 . V_388 = ! ! ( V_23 -> V_44 -> V_20 -> V_503 &
V_504 ) ;
...
V_522 = F_182 ( V_26 , V_23 -> V_159 , & V_380 ) ;
if ( V_522 < 0 )
goto V_396;
F_76 ( V_26 , V_58 ) ;
return 0 ;
...
static int F_224 ( struct V_25 * V_533 ,
struct V_374 * V_91 )
{
struct V_57 * V_58 ;
struct V_40 * V_183 ;
...
! V_91 -> V_538 [ V_163 ] )
goto V_248;
V_536 = ( void * ) F_225 ( V_91 -> V_538 [ V_149 ] ) ;
V_135 = F_14 ( V_91 -> V_538 [ V_156 ] ) ;
V_534 = F_226 ( V_91 -> V_538 [ V_164 ] ) ;
V_183 = F_223 ( V_536 ) ;
if ( ! V_183 )
goto V_248;
F_227 (&data2->pending, skb, tmp) {
if ( ( unsigned long ) V_26 == V_534 ) {
...
V_216 -> V_160 . V_539 = F_14 ( V_91 -> V_538 [ V_540 ] ) ;
if ( ! ( V_135 & V_155 ) &&
( V_135 & V_541 ) ) {
if ( V_26 -> V_151 >= 16 ) {
...
static int F_229 ( struct V_25 * V_533 ,
struct V_374 * V_91 )
{
struct V_40 * V_183 ;
struct V_185 V_186 ;
...
! V_91 -> V_538 [ V_540 ] )
goto V_248;
V_542 = ( void * ) F_225 ( V_91 -> V_538 [ V_545 ] ) ;
V_543 = F_230 ( V_91 -> V_538 [ V_150 ] ) ;
V_544 = ( void * ) F_225 ( V_91 -> V_538 [ V_150 ] ) ;
V_26 = F_231 ( V_543 , V_36 ) ;
if ( V_26 == NULL )
goto V_30;
if ( V_543 > V_415 )
goto V_30;
memcpy ( F_23 ( V_26 , V_543 ) , V_544 , V_543 ) ;
V_183 = F_223 ( V_542 ) ;
if ( ! V_183 )
goto V_248;
...
V_186 . V_192 = F_14 ( V_91 -> V_538 [ V_546 ] ) ;
V_186 . signal = F_14 ( V_91 -> V_538 [ V_540 ] ) ;
...
static int F_232 ( struct V_25 * V_533 ,
struct V_374 * V_91 )
{
struct V_40 * V_23 ;
int V_547 = 1 ;
...
static int F_234 ( struct V_25 * V_548 , struct V_374 * V_91 )
{
struct V_379 V_380 = { 0 } ;
V_380 . V_388 = V_91 -> V_538 [ V_389 ] ;
V_380 . V_390 = V_91 -> V_538 [ V_391 ] ;
V_380 . V_347 = V_347 ;
V_380 . V_411 =
V_91 -> V_538 [ V_549 ] ;
if ( V_91 -> V_538 [ V_382 ] )
V_380 . V_347 = F_14 ( V_91 -> V_538 [ V_382 ] ) ;
if ( V_91 -> V_538 [ V_550 ] )
V_380 . V_506 = true ;
if ( V_91 -> V_538 [ V_394 ] )
V_380 . V_393 = F_225 ( V_91 -> V_538 [ V_394 ] ) ;
if ( V_91 -> V_538 [ V_392 ] )
V_380 . V_218 = true ;
else
...
if ( V_91 -> V_538 [ V_384 ] )
V_380 . V_383 =
F_225 ( V_91 -> V_538 [ V_384 ] ) ;
if ( V_91 -> V_538 [ V_387 ] ) {
T_1 V_159 = F_14 ( V_91 -> V_538 [ V_387 ] ) ;
...
static int F_235 ( struct V_25 * V_548 , struct V_374 * V_91 )
{
struct V_40 * V_23 ;
T_8 V_159 = - 1 ;
const char * V_393 = NULL ;
if ( V_91 -> V_538 [ V_381 ] )
V_159 = F_14 ( V_91 -> V_538 [ V_381 ] ) ;
else if ( V_91 -> V_538 [ V_394 ] )
V_393 = ( void * ) F_225 ( V_91 -> V_538 [ V_394 ] ) ;
else
return - V_34 ;
F_187 ( & V_204 ) ;
F_96 (data, &hwsim_radios, list) {
...
static int F_236 ( struct V_25 * V_548 , struct V_374 * V_91 )
{
struct V_40 * V_23 ;
struct V_25 * V_26 ;
int V_159 , V_522 = - V_551 ;
if ( ! V_91 -> V_538 [ V_381 ] )
return - V_34 ;
V_159 = F_14 ( V_91 -> V_538 [ V_381 ] ) ;
F_187 ( & V_204 ) ;
...
if ( V_23 -> V_159 != V_159 )
continue;
V_26 = F_237 ( V_552 , V_36 ) ;
if ( ! V_26 ) {
V_522 = - V_37 ;
goto V_396;
}
V_522 = F_214 ( V_26 , V_23 , V_91 -> V_375 ,
V_91 -> V_553 , NULL , 0 ) ;
if ( V_522 < 0 ) {
F_79 ( V_26 ) ;
goto V_396;
...
if ( V_23 -> V_159 < V_159 )
continue;
V_522 = F_214 ( V_26 , V_23 ,
F_240 ( V_122 -> V_26 ) . V_412 ,
V_122 -> V_555 -> V_556 , V_122 ,
V_557 ) ;
if ( V_522 < 0 )
break;
V_159 = V_23 -> V_159 + 1 ;
...
{
struct V_40 * V_23 =
F_124 ( V_337 , struct V_40 , V_558 ) ;
F_211 ( V_23 , F_216 ( V_23 -> V_44 -> V_20 ) , NULL ) ;
}
static void F_242 ( T_1 V_412 )
{
struct V_40 * V_559 , * V_535 ;
F_187 ( & V_204 ) ;
F_243 (entry, tmp, &hwsim_radios, list) {
if ( V_559 -> V_411 && V_559 -> V_412 == V_412 ) {
F_219 ( & V_559 -> V_517 ) ;
F_244 ( & V_559 -> V_558 , F_241 ) ;
F_245 ( & V_559 -> V_558 ) ;
}
}
F_188 ( & V_204 ) ;
}
static int F_246 ( struct V_560 * V_561 ,
unsigned long V_562 ,
void * V_563 )
{
struct V_564 * V_565 = V_563 ;
if ( V_562 != V_566 )
return V_567 ;
F_242 ( V_565 -> V_412 ) ;
if ( V_565 -> V_412 == V_222 ) {
F_73 ( V_568 L_58
L_59 ) ;
V_222 = 0 ;
}
...
if ( V_30 < 0 )
goto V_586;
for ( V_136 = 0 ; V_136 < V_574 ; V_136 ++ ) {
struct V_379 V_380 = { 0 } ;
V_380 . V_347 = V_347 ;
switch ( V_587 ) {
case V_588 :
if ( V_136 < F_107 ( V_589 ) )
V_380 . V_383 = V_589 [ V_136 ] ;
break;
case V_590 :
if ( ! V_136 )
V_380 . V_383 = V_589 [ 0 ] ;
