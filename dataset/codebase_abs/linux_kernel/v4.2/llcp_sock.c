...
struct V_1 * F_83 ( struct V_12 * V_1 , int type , T_5 V_154 , int V_155 )
{
struct V_1 * V_2 ;
struct V_16 * V_17 ;
V_2 = F_84 ( & V_156 , V_157 , V_154 , & V_158 , V_155 ) ;
if ( ! V_2 )
return NULL ;
V_17 = V_16 ( V_2 ) ;
F_85 ( V_1 , V_2 ) ;
...
static int F_91 ( struct V_170 * V_170 , struct V_12 * V_1 ,
const struct V_35 * V_171 , int V_155 )
{
struct V_1 * V_2 ;
F_3 ( L_13 , V_1 ) ;
if ( V_1 -> type != V_48 &&
...
V_1 -> V_173 = & V_175 ;
V_2 = F_83 ( V_1 , V_1 -> type , V_176 , V_155 ) ;
if ( V_2 == NULL )
return - V_125 ;
return 0 ;
}
