...
T_6 V_10 , T_1 * V_15 )
{
struct V_87 V_88 = { . V_20 = V_20 , . V_10 = V_10 } ;
return F_16 ( V_67 , F_65 , ( void * ) & V_88 ,
V_15 ) ;
}
...
T_1 * F_68 ( T_1 * V_95 , const char * V_20 ,
T_1 * V_15 )
{
return F_16 ( V_95 , F_67 , ( void * ) V_20 ,
V_15 ) ;
}
int F_69 ( T_1 * V_24 , struct V_96 * V_97 )
{
T_1 type ;
int V_26 , V_7 ;
const char * V_41 = L_7 ;
...
int F_71 ( T_1 * V_24 , struct V_96 * V_97 )
{
int V_7 ;
V_7 = F_69 ( V_24 , V_97 ) ;
if ( V_7 < 0 ) {
...
F_70 ( V_97 , L_17 , F_18 ( V_24 ) ) ;
return 0 ;
}
static int F_72 ( T_1 * V_67 , T_1 * V_24 ,
struct V_96 * V_97 )
{
T_1 * V_104 ;
int V_105 ;
...
if ( ! V_20 )
return - V_13 ;
V_105 = F_73 ( V_24 , & V_104 ) ;
if ( V_105 <= 1 ) {
V_7 = - V_85 ;
goto V_112;
}
while ( ( V_106 = F_74 ( & V_104 [ 1 ] , V_106 , & V_107 ,
& V_108 , & V_109 ) ) > 0 ) {
V_108 -= V_110 ;
V_109 -= V_110 ;
if ( V_111 ) {
F_70 ( V_97 , L_18 V_113 L_19 V_113 ,
V_20 , V_108 , V_109 ) ;
V_111 = false ;
} else {
F_70 ( V_97 , L_20 V_113 L_19 V_113 ,
V_108 , V_109 ) ;
}
}
if ( ! V_111 )
...
int F_75 ( T_1 * V_67 , T_1 * V_24 , struct V_96 * V_97 )
{
int V_7 = 0 ;
T_6 V_107 ;
T_6 V_108 , V_109 ;
...
if ( ! V_20 )
return - V_13 ;
if ( F_6 ( V_24 , V_92 , & V_8 ) == NULL )
return - V_85 ;
while ( ( V_106 = F_76 (
& V_8 , V_106 , & V_107 ,
& V_108 , & V_109 , & V_114 , & V_115 ) ) > 0 ) {
if ( V_108 == 0 ) {
V_7 = F_72 ( V_67 , V_24 , V_97 ) ;
return V_7 ;
}
V_108 -= V_110 ;
V_109 -= V_110 ;
