...
if ( F_37 ( V_2 -> V_47 ) )
return - V_11 ;
V_52 = F_38 ( & V_2 -> V_9 -> V_75 . V_89 ,
& V_2 -> V_47 -> V_9 . V_89 , L_31 ) ;
if ( V_52 )
return V_52 ;
V_52 = F_38 ( & V_2 -> V_47 -> V_9 . V_89 ,
& V_2 -> V_9 -> V_75 . V_89 , L_21 ) ;
if ( V_52 )
return V_52 ;
...
return - V_11 ;
V_2 -> V_46 = 1 ;
F_40 ( & V_2 -> V_9 -> V_75 , L_32 ,
V_2 -> V_47 -> V_90 ) ;
return 0 ;
}
static void F_41 ( struct V_1 * V_2 )
{
F_42 ( & V_2 -> V_9 -> V_75 . V_89 , L_31 ) ;
F_42 ( & V_2 -> V_47 -> V_9 . V_89 , L_21 ) ;
F_43 ( V_2 -> V_47 ) ;
V_2 -> V_47 = NULL ;
F_44 ( V_2 -> V_9 -> V_10 ) ;
}
static void F_45 ( struct V_80 * V_9 , T_4 V_91 )
{
...
{
struct V_1 * V_2 = F_51 ( V_103 , struct V_1 ,
V_104 ) ;
F_16 ( V_2 ) ;
}
static int F_52 ( struct V_80 * V_9 )
{
int V_52 = 0 ;
struct V_1 * V_2 = NULL ;
if ( ! V_9 )
return - V_6 ;
V_2 = F_53 ( sizeof( struct V_1 ) , V_105 ) ;
if ( ! V_2 )
return - V_106 ;
V_2 -> V_9 = V_9 ;
strcpy ( V_2 -> V_40 , V_9 -> V_73 . V_107 ) ;
strcpy ( F_54 ( V_9 ) , V_108 ) ;
strcpy ( F_55 ( V_9 ) , V_109 ) ;
V_9 -> V_110 = V_2 ;
V_52 = F_48 ( V_2 ) ;
if ( V_52 )
goto V_111;
...
static int F_61 ( struct V_80 * V_9 )
{
struct V_1 * V_2 = NULL ;
if ( ! V_9 || ! F_46 ( V_9 ) )
return - V_6 ;
...
static int F_63 ( struct V_9 * V_75 )
{
F_62 ( V_113 ) ;
return 0 ;
}
static int F_64 ( struct V_9 * V_75 )
{
struct V_1 * V_2 ;
int V_19 , V_81 , V_114 , V_52 ;
if ( ! V_75 )
return - V_6 ;
V_2 = F_46 ( F_65 ( V_75 ) ) ;
if ( ! V_2 )
...
if ( ! V_2 -> V_21 . V_41 [ V_19 ] . V_23 . V_18 )
break;
V_2 -> V_21 . V_41 [ V_19 ] . V_23 . V_115 = 1 ;
for ( V_81 = 0 ; V_81 < V_2 -> V_21 . V_41 [ V_19 ] . V_17 . V_82 ; V_81 ++ ) {
V_52 = F_66 (
V_2 -> V_21 . V_41 [ V_19 ] . V_17 . V_83 [ V_81 ] ,
& V_114 ) ;
if ( V_52 || ( V_114 != V_116 ) ) {
V_2 -> V_21 . V_41 [ V_19 ] . V_23 . V_115 = 0 ;
break;
}
}
V_2 -> V_117 . V_41 |= V_2 -> V_21 . V_41 [ V_19 ] . V_23 . V_115 ;
}
F_67 ( V_113 , & V_2 -> V_104 ) ;
return V_4 ;
}
static int F_68 ( const struct V_118 * V_119 ) {
if ( V_42 == 0 ) {
F_69 ( V_27 L_35
L_36 , V_119 -> V_120 ) ;
V_42 = - 1 ;
...
static int F_70 ( const struct V_118 * V_119 ) {
F_69 ( V_27 L_35
L_37 , V_119 -> V_120 ) ;
V_76 = 1 ;
return 0 ;
}
static int F_71 ( const struct V_118 * V_119 ) {
if ( V_101 == 0 ) {
F_69 ( V_27 L_35
L_38 , V_119 -> V_120 ) ;
V_101 = 300 ;
...
static int F_72 ( const struct V_118 * V_119 ) {
if ( V_33 == 0 ) {
F_69 ( V_27 L_35
L_39 , V_119 -> V_120 ) ;
V_33 = - 1 ;
