...
static int F_59 ( struct V_43 * V_88 ,
...
V_95 -> V_70 = V_70 ;
V_250 -> V_88 = V_88 ;
F_60 ( & V_250 -> V_252 , & V_85 -> V_253 ) ;
} else if ( type == V_254 ) {
struct V_75 * V_76 = ( void * ) V_88 -> V_49 ;
V_76 -> V_70 = V_70 ;
V_250 -> V_88 = V_88 ;
F_60 ( & V_250 -> V_252 , & V_85 -> V_255 ) ;
} else {
F_2 ( V_62 -> V_15 , L_37 ,
type , V_88 -> V_72 . V_57 ) ;
V_19 = - V_16 ;
...
static int F_61 ( struct V_121 * V_70 ,
struct V_256 * V_257 )
{
struct V_43 * V_88 ;
int V_258 , V_19 = 0 ;
...
V_19 = F_59 ( V_88 , V_70 , V_251 ) ;
else if ( strstr ( V_88 -> V_72 . V_57 , L_39 ) )
V_19 = F_59 ( V_88 , V_70 , V_254 ) ;
...
static void F_64 ( struct V_256 * V_257 ,
struct V_84 * V_85 )
{
struct V_121 * V_70 ;
...
int F_67 ( struct V_256 * V_257 )
{
int V_73 , V_19 = 0 ;
struct V_265 * V_122 =
F_68 ( & V_257 -> V_90 ) ;
struct V_1 * V_2 = F_69 ( V_257 ) ;
...
if ( V_19 )
return V_19 ;
V_19 = F_73 ( V_257 , V_233 ,
F_55 ( V_233 ) ) ;
if ( V_19 )
return V_19 ;
V_19 = F_73 ( V_257 , V_274 ,
F_55 ( V_274 ) ) ;
if ( V_19 )
return V_19 ;
V_19 = F_65 ( V_257 ) ;
