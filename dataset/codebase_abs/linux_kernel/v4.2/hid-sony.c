...
F_11 ( V_27 , V_38 , V_39 ) ;
} else if ( ( V_27 -> V_28 & V_62 ) && V_38 [ 0 ] == 0x01 && V_39 == 49 ) {
F_11 ( V_27 , V_38 , V_39 ) ;
...
static int F_22 ( struct V_9 * V_10 , int V_65 ,
int V_66 , int V_67 )
{
struct V_52 * V_52 = V_10 -> V_53 ;
int V_68 ;
V_68 = F_23 ( V_52 , V_65 , 0 ) ;
if ( V_68 < 0 )
return V_68 ;
F_24 ( V_52 , V_58 , 0 , V_66 , 0 , 0 ) ;
F_24 ( V_52 , V_59 , 0 , V_67 , 0 , 0 ) ;
return 0 ;
}
...
if ( ! V_73 )
return - V_75 ;
V_68 = F_29 ( V_2 , 0xf2 , V_73 , V_71 ,
V_76 , V_77 ) ;
if ( V_68 < 0 ) {
F_26 ( V_2 , L_5 ) ;
goto V_78;
}
V_68 = F_29 ( V_2 , 0xf5 , V_73 , V_72 ,
V_76 , V_77 ) ;
if ( V_68 < 0 ) {
F_26 ( V_2 , L_6 ) ;
goto V_78;
}
V_68 = F_30 ( V_2 , V_73 , 1 ) ;
if ( V_68 < 0 )
F_26 ( V_2 , L_7 ) ;
V_78:
F_31 ( V_73 ) ;
...
T_1 * V_73 ;
int V_68 ;
V_73 = F_33 ( V_61 , sizeof( V_61 ) , V_74 ) ;
if ( ! V_73 )
return - V_75 ;
V_68 = F_29 ( V_2 , V_73 [ 0 ] , V_73 , sizeof( V_61 ) ,
V_76 , V_79 ) ;
F_31 ( V_73 ) ;
return V_68 ;
}
...
int V_82 = V_27 -> V_83 ;
F_36 ( V_84 < F_6 ( V_81 [ 0 ] ) ) ;
if ( V_82 < 0 )
return;
V_82 %= 10 ;
memcpy ( V_27 -> V_85 , V_81 [ V_82 ] , sizeof( V_81 [ V_82 ] ) ) ;
}
static void F_37 ( struct V_26 * V_27 )
{
static const T_1 V_86 [ 7 ] [ 3 ] = {
{ 0x00 , 0x00 , 0x01 } ,
{ 0x01 , 0x00 , 0x00 } ,
{ 0x00 , 0x01 , 0x00 } ,
{ 0x02 , 0x00 , 0x01 } ,
...
int V_82 = V_27 -> V_83 ;
F_36 ( V_84 < F_6 ( V_86 [ 0 ] ) ) ;
if ( V_82 < 0 )
return;
V_82 %= 7 ;
memcpy ( V_27 -> V_85 , V_86 [ V_82 ] , sizeof( V_86 [ V_82 ] ) ) ;
}
...
struct V_87 * V_88 =
& V_2 -> V_89 [ V_90 ] . V_88 ;
struct V_60 * V_61 = F_15 ( V_88 -> V_50 ,
struct V_60 , V_51 ) ;
T_4 * V_91 = V_61 -> V_12 [ 0 ] -> V_91 ;
F_36 ( V_84 < 4 ) ;
V_91 [ 0 ] = 0x00 ;
V_91 [ 1 ] = V_27 -> V_85 [ 0 ] ? 0xff : 0x00 ;
V_91 [ 2 ] = V_27 -> V_85 [ 1 ] ? 0xff : 0x00 ;
V_91 [ 3 ] = V_27 -> V_85 [ 2 ] ? 0xff : 0x00 ;
V_91 [ 4 ] = V_27 -> V_85 [ 3 ] ? 0xff : 0x00 ;
V_91 [ 5 ] = 0x00 ;
V_91 [ 6 ] = 0x00 ;
F_39 ( V_2 , V_61 , V_79 ) ;
}
...
enum V_95 V_91 )
{
struct V_96 * V_97 = V_94 -> V_97 -> V_98 ;
struct V_1 * V_2 = F_43 ( V_97 , struct V_1 , V_97 ) ;
struct V_26 * V_99 ;
int V_54 ;
int V_100 ;
V_99 = F_9 ( V_2 ) ;
...
V_100 = ! ! ( V_99 -> V_28 & V_101 ) ;
for ( V_54 = 0 ; V_54 < V_99 -> V_102 ; V_54 ++ ) {
if ( V_94 == V_99 -> V_103 [ V_54 ] && ( V_100 ||
( V_91 != V_99 -> V_85 [ V_54 ] ||
V_99 -> V_104 [ V_54 ] ||
V_99 -> V_105 [ V_54 ] ) ) ) {
V_99 -> V_85 [ V_54 ] = V_91 ;
...
static enum V_95 F_44 ( struct V_93 * V_94 )
{
struct V_96 * V_97 = V_94 -> V_97 -> V_98 ;
struct V_1 * V_2 = F_43 ( V_97 , struct V_1 , V_97 ) ;
struct V_26 * V_99 ;
...
for ( V_54 = 0 ; V_54 < V_99 -> V_102 ; V_54 ++ ) {
if ( V_94 == V_99 -> V_103 [ V_54 ] )
return V_99 -> V_85 [ V_54 ] ;
}
return V_106 ;
}
static int F_45 ( struct V_93 * V_94 , unsigned long * V_107 ,
unsigned long * V_108 )
{
struct V_96 * V_97 = V_94 -> V_97 -> V_98 ;
struct V_1 * V_2 = F_43 ( V_97 , struct V_1 , V_97 ) ;
struct V_26 * V_99 = F_9 ( V_2 ) ;
int V_54 ;
T_1 V_109 , V_110 ;
if ( ! V_99 ) {
F_26 ( V_2 , L_8 ) ;
...
if ( V_54 >= V_99 -> V_102 )
return - V_111 ;
if ( V_109 != V_99 -> V_104 [ V_54 ] ||
V_110 != V_99 -> V_105 [ V_54 ] ) {
V_99 -> V_104 [ V_54 ] = V_109 ;
V_99 -> V_105 [ V_54 ] = V_110 ;
F_41 ( & V_99 -> V_92 ) ;
}
return 0 ;
}
...
for ( V_54 = 0 ; V_54 < V_27 -> V_102 ; V_54 ++ ) {
V_94 = V_27 -> V_103 [ V_54 ] ;
V_27 -> V_103 [ V_54 ] = NULL ;
if ( ! V_94 )
continue;
F_48 ( V_94 ) ;
F_31 ( V_94 ) ;
...
V_116 = strlen ( L_13 ) ;
V_117 = L_14 ;
if ( ! F_50 ( V_2 , V_90 , 0 , 0 , 7 ) )
return - V_121 ;
} else if ( V_27 -> V_28 & V_69 ) {
F_37 ( V_27 ) ;
V_27 -> V_85 [ 3 ] = 1 ;
V_27 -> V_102 = 4 ;
memset ( V_119 , 255 , 3 ) ;
...
memcpy ( V_27 -> V_85 , V_122 , sizeof( V_122 ) ) ;
V_27 -> V_102 = 1 ;
memset ( V_120 , 1 , 4 ) ;
V_113 = 0 ;
V_116 = strlen ( L_16 ) ;
...
F_40 ( V_27 ) ;
V_114 = strlen ( F_51 ( & V_2 -> V_97 ) ) + V_116 + 1 ;
for ( V_54 = 0 ; V_54 < V_27 -> V_102 ; V_54 ++ ) {
if ( V_113 )
V_114 = strlen ( F_51 ( & V_2 -> V_97 ) ) + strlen ( V_118 [ V_54 ] ) + 2 ;
V_94 = F_52 ( sizeof( struct V_93 ) + V_114 , V_74 ) ;
if ( ! V_94 ) {
F_26 ( V_2 , L_18 , V_54 ) ;
V_68 = - V_75 ;
goto V_123;
...
V_115 = ( void * ) ( & V_94 [ 1 ] ) ;
if ( V_113 )
snprintf ( V_115 , V_114 , V_117 , F_51 ( & V_2 -> V_97 ) ,
V_118 [ V_54 ] ) ;
else
snprintf ( V_115 , V_114 , V_117 , F_51 ( & V_2 -> V_97 ) , V_54 + 1 ) ;
V_94 -> V_115 = V_115 ;
V_94 -> V_124 = V_27 -> V_85 [ V_54 ] ;
V_94 -> V_119 = V_119 [ V_54 ] ;
V_94 -> V_125 = F_44 ;
V_94 -> V_126 = F_42 ;
if ( V_120 [ V_54 ] )
V_94 -> V_127 = F_45 ;
V_27 -> V_103 [ V_54 ] = V_94 ;
V_68 = F_53 ( & V_2 -> V_97 , V_94 ) ;
if ( V_68 ) {
F_26 ( V_2 , L_19 , V_54 ) ;
V_27 -> V_103 [ V_54 ] = NULL ;
F_31 ( V_94 ) ;
...
struct V_26 * V_27 = F_43 ( V_129 , struct V_26 , V_92 ) ;
struct V_132 * V_61 =
...
#endif
V_61 -> V_139 |= V_27 -> V_85 [ 0 ] << 1 ;
V_61 -> V_139 |= V_27 -> V_85 [ 1 ] << 2 ;
V_61 -> V_139 |= V_27 -> V_85 [ 2 ] << 3 ;
V_61 -> V_139 |= V_27 -> V_85 [ 3 ] << 4 ;
if ( ( V_61 -> V_139 & 0x1E ) == 0 )
V_61 -> V_139 |= 0x20 ;
for ( V_54 = 0 ; V_54 < 4 ; V_54 ++ ) {
if ( V_27 -> V_104 [ V_54 ] || V_27 -> V_105 [ V_54 ] ) {
V_61 -> V_94 [ 3 - V_54 ] . V_140 = V_27 -> V_105 [ V_54 ] ;
V_61 -> V_94 [ 3 - V_54 ] . V_141 = V_27 -> V_104 [ V_54 ] ;
}
}
...
#ifdef F_55
V_73 [ V_42 ++ ] = V_27 -> V_136 ;
V_73 [ V_42 ++ ] = V_27 -> V_138 ;
#else
V_42 += 2 ;
#endif
if ( V_27 -> V_85 [ 3 ] ) {
V_73 [ V_42 ++ ] = V_27 -> V_85 [ 0 ] ;
V_73 [ V_42 ++ ] = V_27 -> V_85 [ 1 ] ;
V_73 [ V_42 ++ ] = V_27 -> V_85 [ 2 ] ;
} else {
V_42 += 3 ;
}
V_73 [ V_42 ++ ] = V_27 -> V_104 [ 3 ] ;
V_73 [ V_42 ++ ] = V_27 -> V_105 [ 3 ] ;
if ( V_27 -> V_28 & V_30 )
F_30 ( V_2 , V_73 , V_143 ) ;
else
F_29 ( V_2 , 0x11 , V_73 , V_144 ,
V_90 , V_79 ) ;
}
...
memset ( V_61 , 0 , V_146 ) ;
V_61 -> type = 0x02 ;
V_61 -> V_147 = V_27 -> V_85 [ 0 ] ;
V_61 -> V_148 = V_27 -> V_85 [ 1 ] ;
V_61 -> V_149 = V_27 -> V_85 [ 2 ] ;
#ifdef F_55
...
static int F_59 ( struct V_52 * V_97 , void * V_150 ,
struct V_151 * V_152 )
{
struct V_1 * V_18 = F_60 ( V_97 ) ;
...
V_27 -> V_175 . V_181 = 0 ;
V_27 -> V_175 . V_115 = F_67 ( V_74 ,
L_20 ,
V_27 -> V_182 ) ;
if ( ! V_27 -> V_175 . V_115 )
return - V_75 ;
V_27 -> V_183 = F_68 ( & V_2 -> V_97 , & V_27 -> V_175 ,
& V_174 ) ;
if ( F_69 ( V_27 -> V_183 ) ) {
V_68 = F_70 ( V_27 -> V_183 ) ;
F_26 ( V_2 , L_21 ) ;
goto V_184;
}
F_71 ( V_27 -> V_183 , & V_2 -> V_97 ) ;
return 0 ;
V_184:
...
V_68 = memcmp ( V_27 -> V_182 , V_185 -> V_182 ,
sizeof( V_27 -> V_182 ) ) ;
if ( ! V_68 ) {
V_68 = - V_187 ;
F_10 ( V_27 -> V_2 , L_22 ,
...
{
int V_68 ;
V_68 = strlen ( V_27 -> V_2 -> V_191 ) ;
if ( V_68 != 17 )
return - V_111 ;
V_68 = sscanf ( V_27 -> V_2 -> V_191 ,
L_23 ,
...
V_73 = F_28 ( V_194 , V_74 ) ;
if ( ! V_73 )
return - V_75 ;
V_68 = F_29 ( V_27 -> V_2 , 0x81 , V_73 ,
V_194 , V_76 ,
V_77 ) ;
if ( V_68 != V_194 ) {
F_26 ( V_27 -> V_2 , L_25 ) ;
V_68 = V_68 < 0 ? V_68 : - V_111 ;
goto V_195;
}
memcpy ( V_27 -> V_182 , & V_73 [ 1 ] , sizeof( V_27 -> V_182 ) ) ;
} else if ( ( V_27 -> V_28 & V_101 ) ||
( V_27 -> V_28 & V_196 ) ) {
V_73 = F_28 ( V_71 , V_74 ) ;
if ( ! V_73 )
return - V_75 ;
V_68 = F_29 ( V_27 -> V_2 , 0xf2 , V_73 ,
V_71 , V_76 ,
V_77 ) ;
if ( V_68 != V_71 ) {
F_26 ( V_27 -> V_2 , L_26 ) ;
...
static int F_91 ( struct V_1 * V_2 , const struct V_199 * V_82 )
{
int V_68 ;
unsigned long V_28 = V_82 -> V_200 ;
struct V_26 * V_27 ;
unsigned int V_201 = V_202 ;
V_27 = F_92 ( & V_2 -> V_97 , sizeof( * V_27 ) , V_74 ) ;
if ( V_27 == NULL ) {
F_26 ( V_2 , L_27 ) ;
return - V_75 ;
}
