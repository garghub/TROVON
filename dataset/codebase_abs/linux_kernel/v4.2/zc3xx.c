...
if ( V_23 == F_12 ( V_67 ) || ( V_23 > 0 && V_23 == V_194 && V_188 -> V_20 < V_67 [ V_23 ] ) )
V_23 -- ;
if ( V_23 >= 2 && V_1 -> V_170 &&
! V_1 -> V_157 . V_196 )
return - V_197 ;
...
F_38 ( V_202 , 8 ) ;
V_22 -> V_55 = F_39 ( V_202 , & V_204 ,
V_205 , 0 , 255 , 1 , 128 ) ;
V_22 -> V_56 = F_39 ( V_202 , & V_204 ,
V_206 , 0 , 255 , 1 , 128 ) ;
V_22 -> gamma = F_39 ( V_202 , & V_204 ,
V_198 , 1 , 6 , 1 , gamma [ V_22 -> V_53 ] ) ;
if ( V_22 -> V_53 == V_41 )
V_22 -> V_192 = F_39 ( V_202 , & V_204 ,
V_207 , 0x30d , 0x493e , 1 , 0x927 ) ;
V_22 -> V_208 = F_39 ( V_202 , & V_204 ,
V_191 , 0 , 1 , 1 , 1 ) ;
if ( V_22 -> V_53 != V_47 )
V_22 -> V_209 = F_40 ( V_202 , & V_204 ,
V_199 ,
V_210 , 0 ,
V_211 ) ;
V_22 -> V_212 = F_39 ( V_202 , & V_204 ,
V_200 , 0 , 3 , 1 ,
V_22 -> V_53 == V_51 ? 0 : 2 ) ;
V_22 -> V_213 = F_39 ( V_202 , & V_204 ,
V_195 ,
...
F_47 ( V_22 -> V_66 , V_1 -> V_259 . V_260 ,
V_1 -> V_259 . V_261 ,
0x21 ) ;
V_70 = V_1 -> V_157 . V_158 [ V_1 -> V_159 ] . V_160 ;
switch ( V_22 -> V_53 ) {
...
F_20 ( V_1 , F_48 ( V_22 -> V_208 ) ) ;
if ( V_1 -> V_4 < 0 )
return V_1 -> V_4 ;
V_22 -> V_265 = F_49 ( V_266 ) ;
F_50 ( V_22 -> V_265 , & V_22 -> V_162 ) ;
return 0 ;
}
...
F_54 ( V_1 , V_272 , V_267 , V_268 ) ;
}
static int F_55 ( struct V_1 * V_1 ,
const struct V_273 * V_274 )
{
struct V_22 * V_22 = (struct V_22 * ) V_1 ;
return F_56 ( V_22 -> V_213 , V_274 -> V_275 ) ;
}
...
F_59 ( V_1 -> V_279 , V_280 , 1 ) ;
F_60 ( V_1 -> V_279 ) ;
F_59 ( V_1 -> V_279 , V_280 , 0 ) ;
F_60 ( V_1 -> V_279 ) ;
}
return 0 ;
}
static int F_61 ( struct V_281 * V_282 ,
const struct V_179 * V_180 )
{
return F_62 ( V_282 , V_180 , & V_283 , sizeof( struct V_22 ) ,
V_284 ) ;
}
