...
static inline int F_120 ( int V_220 )
{
return V_220 == V_221
|| V_220 == V_222 ;
}
T_1
F_121 ( struct V_1 * V_2 , struct V_21 * V_22 ,
char * V_202 , int V_203 , struct V_41 * V_42 ,
struct V_21 * V_200 , int V_220 , T_5 * V_223 ,
...
* V_224 = ( V_42 -> V_43 & V_71 ) && ! V_42 -> V_56 ;
}
else {
V_42 -> V_43 &= V_71 ;
goto V_229;
...
break;
case V_221 :
if ( F_21 ( V_205 ) -> V_230 . V_76 == V_226
&& F_21 ( V_205 ) -> V_231 . V_76 == V_227
&& F_21 ( V_205 ) -> V_57 == 0 ) {
if ( V_225 )
* V_225 = 1 ;
break;
...
V_42 -> V_43 = V_70 | V_69
| V_233 | V_234 ;
V_42 -> V_235 . V_76 = V_226 ;
V_42 -> V_236 . V_76 = V_227 ;
V_42 -> V_235 . V_237 = 0 ;
V_42 -> V_236 . V_237 = 0 ;
}
V_229:
