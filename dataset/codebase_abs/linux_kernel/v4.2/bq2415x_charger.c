...
static void F_37 ( struct V_1 * V_2 , int V_146 )
{
F_3 ( & V_147 ) ;
if ( V_2 -> V_148 == V_146 ) {
F_6 ( & V_147 ) ;
...
static void F_41 ( struct V_151 * V_145 )
{
struct V_1 * V_2 = F_34 ( V_145 , struct V_1 ,
V_145 . V_145 ) ;
int V_10 ;
int error ;
int V_124 ;
if ( V_2 -> V_144 > 0 && ( V_2 -> V_143 != V_2 -> V_122 ) ) {
...
int V_81 ;
char V_162 [ 8 ] ;
struct V_163 V_164 = { . V_165 = V_2 , } ;
V_2 -> V_166 . V_167 = V_2 -> V_167 ;
V_2 -> V_166 . type = V_168 ;
V_2 -> V_166 . V_169 = V_170 ;
V_2 -> V_166 . V_171 =
F_5 ( V_170 ) ;
V_2 -> V_166 . V_172 = F_42 ;
V_10 = F_14 ( V_2 ) ;
if ( V_10 < 0 )
V_81 = V_90 ;
else
...
sprintf ( V_162 , L_23 , V_10 ) ;
V_2 -> V_161 = F_45 ( V_173 ,
L_24 ,
V_174 [ V_81 ] , V_162 ,
F_16 ( V_2 ) ) ;
if ( ! V_2 -> V_161 ) {
...
V_2 -> V_123 = F_46 ( V_2 -> V_6 , & V_2 -> V_166 ,
& V_164 ) ;
if ( F_47 ( V_2 -> V_123 ) ) {
F_48 ( V_2 -> V_161 ) ;
...
static T_2 F_52 ( struct V_176 * V_6 ,
struct V_177 * V_178 ,
char * V_15 )
{
struct V_134 * V_135 = F_53 ( V_6 ) ;
struct V_1 * V_2 = F_43 ( V_135 ) ;
enum V_25 V_26 ;
int V_10 ;
if ( strcmp ( V_178 -> V_178 . V_167 , L_26 ) == 0 )
V_26 = V_30 ;
else if ( strcmp ( V_178 -> V_178 . V_167 , L_27 ) == 0 )
V_26 = V_36 ;
else if ( strcmp ( V_178 -> V_178 . V_167 , L_28 ) == 0 )
V_26 = V_39 ;
else if ( strcmp ( V_178 -> V_178 . V_167 , L_29 ) == 0 )
V_26 = V_41 ;
else
return - V_21 ;
V_10 = F_13 ( V_2 , V_26 ) ;
...
static T_2 F_54 ( struct V_176 * V_6 ,
struct V_177 * V_178 ,
const char * V_15 ,
T_3 V_179 )
{
...
static T_2 F_55 ( struct V_176 * V_6 ,
struct V_177 * V_178 ,
char * V_15 )
{
struct V_134 * V_135 = F_53 ( V_6 ) ;
...
static T_2 F_56 ( struct V_176 * V_6 ,
struct V_177 * V_178 ,
const char * V_15 ,
T_3 V_179 )
{
...
static T_2 F_57 ( struct V_176 * V_6 ,
struct V_177 * V_178 ,
char * V_15 )
{
struct V_134 * V_135 = F_53 ( V_6 ) ;
...
static T_2 F_58 ( struct V_176 * V_6 ,
struct V_177 * V_178 ,
char * V_15 )
{
struct V_134 * V_135 = F_53 ( V_6 ) ;
...
static T_2 F_59 ( struct V_176 * V_6 ,
struct V_177 * V_178 ,
const char * V_15 ,
T_3 V_179 )
{
...
static T_2 F_61 ( struct V_176 * V_6 ,
struct V_177 * V_178 ,
char * V_15 )
{
struct V_134 * V_135 = F_53 ( V_6 ) ;
...
static T_2 F_62 ( struct V_176 * V_6 ,
struct V_177 * V_178 ,
const char * V_15 ,
T_3 V_179 )
{
...
return - V_21 ;
if ( strcmp ( V_178 -> V_178 . V_167 , L_50 ) == 0 )
V_10 = F_18 ( V_2 , V_9 ) ;
else if ( strcmp ( V_178 -> V_178 . V_167 , L_51 ) == 0 )
V_10 = F_20 ( V_2 , V_9 ) ;
else if ( strcmp ( V_178 -> V_178 . V_167 , L_52 ) == 0 )
V_10 = F_22 ( V_2 , V_9 ) ;
else if ( strcmp ( V_178 -> V_178 . V_167 , L_53 ) == 0 )
V_10 = F_24 ( V_2 , V_9 ) ;
else if ( strcmp ( V_178 -> V_178 . V_167 , L_54 ) == 0 )
V_10 = F_26 ( V_2 , V_9 ) ;
else
return - V_21 ;
if ( V_10 < 0 )
...
static T_2 F_64 ( struct V_176 * V_6 ,
struct V_177 * V_178 ,
char * V_15 )
{
struct V_134 * V_135 = F_53 ( V_6 ) ;
...
static T_2 F_65 ( struct V_176 * V_6 ,
struct V_177 * V_178 ,
const char * V_15 ,
T_3 V_179 )
{
...
if ( F_63 ( V_15 , 10 , & V_9 ) < 0 )
return - V_21 ;
if ( strcmp ( V_178 -> V_178 . V_167 , L_55 ) == 0 )
V_26 = V_9 ? V_47 :
V_48 ;
else if ( strcmp ( V_178 -> V_178 . V_167 , L_56 ) == 0 )
V_26 = V_9 ? V_55 :
V_56 ;
else if ( strcmp ( V_178 -> V_178 . V_167 , L_57 ) == 0 )
V_26 = V_9 ? V_68 :
V_69 ;
else if ( strcmp ( V_178 -> V_178 . V_167 , L_58 ) == 0 )
V_26 = V_9 ? V_34 :
V_35 ;
else
return - V_21 ;
...
static T_2 F_66 ( struct V_176 * V_6 ,
struct V_177 * V_178 ,
char * V_15 )
{
struct V_134 * V_135 = F_53 ( V_6 ) ;
...
{
return F_68 ( & V_2 -> V_123 -> V_6 . V_130 ,
& V_180 ) ;
}
static void F_69 ( struct V_1 * V_2 )
{
F_70 ( & V_2 -> V_123 -> V_6 . V_130 , & V_180 ) ;
}
...
char * V_167 = NULL ;
struct V_1 * V_2 ;
struct V_184 * V_185 = V_5 -> V_6 . V_186 ;
struct V_187 * V_188 = V_5 -> V_6 . V_189 ;
const struct V_190 * V_191 = NULL ;
if ( ! V_185 && ! V_188 && ! F_72 ( & V_5 -> V_6 ) ) {
F_40 ( & V_5 -> V_6 , L_59 ) ;
return - V_12 ;
}
F_3 ( & V_192 ) ;
V_183 = F_73 ( & V_193 , V_5 , 0 , 0 , V_173 ) ;
F_6 ( & V_192 ) ;
if ( V_183 < 0 )
return V_183 ;
if ( V_182 ) {
V_167 = F_45 ( V_173 , L_60 , V_182 -> V_167 , V_183 ) ;
} else if ( F_72 ( & V_5 -> V_6 ) ) {
V_191 =
F_74 ( V_5 -> V_6 . V_194 -> V_195 ,
& V_5 -> V_6 ) ;
V_167 = F_45 ( V_173 , L_60 , V_191 -> V_182 , V_183 ) ;
}
if ( ! V_167 ) {
F_40 ( & V_5 -> V_6 , L_61 ) ;
V_10 = - V_175 ;
...
V_2 = F_75 ( & V_5 -> V_6 , sizeof( * V_2 ) , V_173 ) ;
if ( ! V_2 ) {
V_10 = - V_175 ;
goto V_197;
}
if ( V_185 ) {
V_2 -> V_140 = F_76 ( V_185 ,
L_62 ) ;
if ( F_47 ( V_2 -> V_140 ) ) {
F_77 ( & V_5 -> V_6 ,
L_63 ,
...
} else if ( V_188 && V_188 -> V_199 ) {
V_2 -> V_140 = F_78 ( V_188 -> V_199 ) ;
} else {
V_2 -> V_140 = NULL ;
}
F_79 ( V_5 , V_2 ) ;
...
V_2 -> V_6 = & V_5 -> V_6 ;
if ( V_182 )
V_2 -> V_81 = V_182 -> V_200 ;
else if ( F_72 ( V_2 -> V_6 ) )
V_2 -> V_81 = V_191 -> V_200 ;
V_2 -> V_167 = V_167 ;
V_2 -> V_122 = V_126 ;
V_2 -> V_143 = V_126 ;
V_2 -> V_148 = 0 ;
V_2 -> V_144 = 0 ;
if ( V_185 || F_72 ( V_2 -> V_6 ) ) {
V_10 = F_80 ( V_2 -> V_6 ,
L_64 ,
& V_2 -> V_109 . V_116 ) ;
if ( V_10 )
...
memcpy ( & V_2 -> V_109 , V_188 , sizeof( V_2 -> V_109 ) ) ;
}
F_17 ( V_2 ) ;
V_10 = F_44 ( V_2 ) ;
if ( V_10 ) {
F_40 ( V_2 -> V_6 , L_70 , V_10 ) ;
goto V_201;
}
V_10 = F_67 ( V_2 ) ;
if ( V_10 ) {
...
if ( V_2 -> V_140 ) {
V_2 -> V_132 . V_204 = F_33 ;
V_10 = F_81 ( & V_2 -> V_132 ) ;
if ( V_10 ) {
F_40 ( V_2 -> V_6 , L_73 , V_10 ) ;
goto V_205;
}
F_33 ( & V_2 -> V_132 , V_138 ,
V_2 -> V_140 ) ;
F_30 ( V_2 , V_2 -> V_143 ) ;
V_2 -> V_144 = 1 ;
F_77 ( V_2 -> V_6 , L_74 ) ;
