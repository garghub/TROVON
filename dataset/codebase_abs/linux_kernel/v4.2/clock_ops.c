...
F_4 ( V_2 , V_4 ) ;
F_15 ( & V_14 -> V_19 ) ;
F_16 ( & V_4 -> V_20 , & V_14 -> V_21 ) ;
F_17 ( & V_14 -> V_19 ) ;
return 0 ;
}
int F_18 ( struct V_1 * V_2 , const char * V_11 )
{
return F_9 ( V_2 , V_11 , NULL ) ;
}
int F_19 ( struct V_1 * V_2 , struct V_8 * V_8 )
{
...
void F_24 ( struct V_1 * V_2 , const char * V_11 )
{
struct V_13 * V_14 = F_10 ( V_2 ) ;
struct V_3 * V_4 ;
if ( ! V_14 )
...
V_31 = F_41 ( V_27 , struct V_30 , V_27 ) ;
switch ( V_28 ) {
case V_32 :
if ( V_2 -> V_33 )
break;
...
static void F_46 ( struct V_1 * V_2 , const char * V_11 )
{
struct V_8 * V_8 ;
V_8 = F_5 ( V_2 , V_11 ) ;
if ( ! F_6 ( V_8 ) ) {
...
static void F_49 ( struct V_1 * V_2 , const char * V_11 )
{
struct V_8 * V_8 ;
V_8 = F_5 ( V_2 , V_11 ) ;
if ( ! F_6 ( V_8 ) ) {
