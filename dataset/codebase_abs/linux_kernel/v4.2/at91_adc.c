...
static T_2 F_63 ( T_2 V_152 , T_2 V_153 )
{
return F_64 ( ( V_152 * V_153 / 1000 ) - 1 , 8 ) / 8 ;
}
static T_2 F_65 ( T_2 V_152 , T_2 V_153 )
{
const int V_154 [] = {
0 , 8 , 16 , 24 ,
64 , 80 , 96 , 112 ,
...
if ( V_9 -> V_160 -> V_168 )
return F_67 ( V_157 , V_9 , & V_6 -> V_40 ) ;
else
F_62 ( & V_6 -> V_40 , L_38 ) ;
return 0 ;
V_126:
...
static int F_76 ( struct V_176 * V_40 )
{
...
static void F_78 ( struct V_176 * V_40 )
{
struct V_8 * V_9 = F_77 ( V_40 ) ;
if ( V_9 -> V_160 -> V_161 )
F_23 ( V_9 , V_58 , V_74 ) ;
...
V_25 = V_185 ;
V_25 |= F_81 ( V_9 -> V_160 -> V_186 )
& V_187 ;
V_25 |= F_82 ( V_9 -> V_64 ) & V_188 ;
V_25 |= V_189 ;
V_25 |= V_190 ;
V_25 |= 0x03 << 8 ;
F_23 ( V_9 , V_191 , V_25 ) ;
...
F_85 ( V_48 , V_196 -> V_205 ) ;
if ( V_9 -> V_160 -> V_161 ) {
F_86 ( V_196 , V_45 , 0 , ( 1 << V_39 ) - 1 ,
0 , 0 ) ;
F_86 ( V_196 , V_46 , 0 , ( 1 << V_39 ) - 1 ,
0 , 0 ) ;
F_86 ( V_196 , V_47 , 0 , 0xffffff , 0 , 0 ) ;
} else {
if ( V_9 -> V_82 != V_83 ) {
F_16 ( & V_142 -> V_40 ,
L_40 ) ;
...
F_86 ( V_196 , V_45 , 0 , ( 1 << V_69 ) - 1 ,
0 , 0 ) ;
F_86 ( V_196 , V_46 , 0 , ( 1 << V_69 ) - 1 ,
0 , 0 ) ;
}
V_9 -> V_44 = V_196 ;
F_87 ( V_196 , V_9 ) ;
...
struct V_211 * V_36 ;
T_2 V_25 ;
V_6 = F_93 ( & V_142 -> V_40 , sizeof( struct V_8 ) ) ;
if ( ! V_6 )
return - V_89 ;
V_9 = F_2 ( V_6 ) ;
if ( V_142 -> V_40 . V_145 )
...
V_36 = F_97 ( V_142 , V_216 , 0 ) ;
V_9 -> V_217 = F_98 ( & V_142 -> V_40 , V_36 ) ;
if ( F_99 ( V_9 -> V_217 ) ) {
...
V_122 = F_101 ( V_9 -> V_1 , F_21 , 0 ,
V_142 -> V_40 . V_219 -> V_109 , V_6 ) ;
if ( V_122 ) {
F_16 ( & V_142 -> V_40 , L_43 ) ;
return V_122 ;
}
V_9 -> V_220 = F_102 ( & V_142 -> V_40 , L_44 ) ;
if ( F_99 ( V_9 -> V_220 ) ) {
...
V_9 -> V_209 = F_102 ( & V_142 -> V_40 , L_47 ) ;
if ( F_99 ( V_9 -> V_209 ) ) {
...
V_210 = 0 ;
V_25 = F_105 ( V_207 ) & V_9 -> V_51 -> V_225 ;
V_25 |= F_106 ( V_156 ) & V_9 -> V_51 -> V_226 ;
if ( V_9 -> V_151 )
V_25 |= V_227 ;
if ( V_9 -> V_166 )
V_25 |= V_228 ;
V_25 |= F_107 ( V_210 ) & V_229 ;
F_23 ( V_9 , V_56 , V_25 ) ;
V_122 = F_28 ( V_6 ) ;
if ( V_122 < 0 ) {
