...
V_646 = F_288 ( V_124 , V_124 -> V_58 ) ;
if ( V_646 ) {
F_21 ( V_139 , V_124 , L_293 ) ;
goto V_921;
}
if ( F_10 ( V_49 ) ) {
V_124 -> V_60 =
...
F_20 ( 1 , L_296 ,
V_49 -> V_926 , V_49 -> V_928 ) ;
if ( V_49 -> V_150 == 0x55AA ) {
V_124 -> V_53 = ( ( V_2 ) V_49 -> V_926 << 4 ) ;
} else {
V_124 -> V_53 = 0 ;
}
}
...
V_646 = F_289 ( V_124 -> V_56 , V_930 ) ;
if ( V_646 ) {
F_21 ( V_139 , V_124 , L_297
L_298 ,
V_124 -> V_56 , V_646 ) ;
goto V_915;
}
...
#endif
F_20 ( 2 , L_299 , V_49 -> V_55 , V_124 ) ;
V_646 = F_290 ( V_49 -> V_55 , F_174 , V_907 ,
V_930 , V_124 ) ;
if ( V_646 ) {
if ( V_646 == - V_931 ) {
F_21 ( V_139 , V_124 , L_300
L_301 , V_49 -> V_55 ) ;
} else if ( V_646 == - V_318 ) {
F_21 ( V_139 , V_124 , L_300
L_302 , V_49 -> V_55 ) ;
...
static int F_297 ( struct V_46 * V_124 )
{
struct V_48 * V_302 = F_7 ( V_124 ) ;
F_20 ( 1 , L_63 ) ;
F_298 ( V_124 ) ;
F_294 ( V_302 -> V_55 , V_124 ) ;
#ifdef F_29
if ( V_124 -> V_56 != V_929 ) {
F_20 ( 1 , L_307 ) ;
F_295 ( V_124 -> V_56 ) ;
...
static int F_301 ( struct V_238 * V_50 , unsigned int V_506 )
{
int V_325 = - V_911 ;
T_18 V_3 = V_935 [ V_506 ] ;
struct V_46 * V_124 ;
struct V_48 * V_302 ;
if ( ! F_302 ( V_3 , V_134 , V_930 ) ) {
F_20 ( 1 , L_308 , V_3 ) ;
return - V_911 ;
}
F_20 ( 1 , L_309 , V_3 ) ;
...
goto V_936;
V_325 = - V_310 ;
V_124 = F_303 ( & V_938 , sizeof( * V_302 ) ) ;
if ( ! V_124 )
goto V_936;
V_302 = F_7 ( V_124 ) ;
V_302 -> V_55 = F_300 ( V_3 ) ;
V_302 -> V_50 = V_50 ;
V_302 -> V_124 = V_124 ;
...
static int F_305 ( struct V_238 * V_50 , unsigned int V_506 )
{
...
static int F_308 ( struct V_238 * V_50 , unsigned int V_506 )
{
int V_325 = - V_911 ;
T_18 V_3 = V_935 [ V_506 ] ;
struct V_46 * V_124 ;
...
static unsigned int F_309 ( struct V_941 * V_942 )
{
unsigned short V_763 = F_310 ( V_942 -> V_943 + 0xc86 ) ;
unsigned int V_934 = ( ( V_763 >> 8 ) & 0x07 ) + 10 ;
if ( ( V_934 == 13 ) || ( V_934 > 15 ) )
return 0 ;
return V_934 ;
}
static int F_311 ( struct V_238 * V_50 )
{
int V_70 , V_913 , V_55 = 0 ;
int V_325 ;
struct V_941 * V_942 = F_312 ( V_50 ) ;
struct V_944 * V_334 ;
V_325 = - V_310 ;
...
struct V_48 * V_302 ;
struct V_46 * V_124 ;
if ( ! F_302 ( V_913 , V_134 , V_930 ) ) {
F_2 ( V_848 L_310 , V_913 ,
V_913 + V_134 - 1 ) ;
continue;
}
if ( ! F_60 ( V_913 ) ) {
...
static int F_313 ( struct V_238 * V_50 )
{
int V_70 ;
struct V_944 * V_334 = F_306 ( V_50 ) ;
for ( V_70 = 0 ; V_70 < 2 ; V_70 ++ ) {
int V_913 ;
...
static void F_314 ( struct V_474 * V_475 )
{
if ( ( V_475 -> V_238 == V_851 ) ||
( V_475 -> V_238 == V_852 ) ) {
F_315 ( V_475 , V_947 , 0 ) ;
...
T_30 V_948 ;
F_316 ( V_475 , V_947 , & V_948 ) ;
if ( V_948 < 0x20 )
F_315 ( V_475 , V_947 , 0x20 ) ;
}
}
static int F_317 ( struct V_474 * V_475 ,
...
static void F_324 ( struct V_474 * V_475 )
{
F_297 ( F_325 ( V_475 ) ) ;
F_322 ( V_475 ) ;
F_323 ( V_475 ) ;
}
static int T_33 F_326 ( void )
{
int error ;
error = F_327 ( & V_954 ,
V_955 ) ;
