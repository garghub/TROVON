...
if ( F_110 ( & V_274 -> V_144 . V_117 . V_109 [ V_3 ] . V_115 , & V_7 -> V_109 [ V_3 ] . V_115 ,
sizeof( struct V_290 ) ) )
V_137 = - V_291 ;
}
return V_137 ;
}
static int F_111 ( struct V_239 * V_239 , void * V_232 ,
struct V_190 * V_274 )
{
struct V_6 * V_7 = F_95 ( V_239 ) ;
struct V_1 * V_144 ;
...
V_121 = F_112 ( V_7 -> V_25 . V_16 * 4 , V_7 -> V_12 . V_16 ) ;
V_122 = F_112 ( V_7 -> V_25 . V_21 * 4 , V_7 -> V_12 . V_21 ) ;
if ( V_131 == V_120 ) {
...
if ( F_116 ( V_7 -> V_109 , V_274 -> V_144 . V_117 . V_109 ,
...
int F_117 ( struct V_239 * V_239 , void * V_232 , struct V_292 * V_3 )
{
struct V_6 * V_7 = F_95 ( V_239 ) ;
unsigned int V_293 ;
V_293 = V_3 -> V_294 ;
if ( V_293 >= V_295 )
return - V_126 ;
if ( NULL == F_6 ( V_7 , V_3 -> V_294 ) . V_10 )
return - V_126 ;
V_3 -> V_294 = V_293 ;
V_3 -> type = V_296 ;
strcpy ( V_3 -> V_10 , F_6 ( V_7 , V_293 ) . V_10 ) ;
if ( F_6 ( V_7 , V_293 ) . V_72 )
V_3 -> type = V_297 ;
if ( V_293 == V_7 -> V_27 ) {
int V_298 = F_118 ( V_299 ) ;
int V_300 = F_118 ( V_301 ) ;
if ( 0 != ( V_298 & 0x40 ) )
V_3 -> V_302 |= V_303 ;
if ( 0 != ( V_300 & 0x40 ) )
V_3 -> V_302 |= V_304 ;
...
int F_119 ( struct V_239 * V_239 , void * V_232 , unsigned int * V_3 )
{
struct V_6 * V_7 = F_95 ( V_239 ) ;
* V_3 = V_7 -> V_27 ;
return 0 ;
...
int F_121 ( struct V_239 * V_239 , void * V_232 ,
struct V_308 * V_309 )
{
struct V_6 * V_7 = F_95 ( V_239 ) ;
struct V_240 * V_241 = F_94 ( V_239 ) ;
T_7 V_310 , V_311 , V_312 ;
unsigned int V_313 = V_7 -> V_313 ;
strcpy ( V_309 -> V_314 , L_14 ) ;
F_122 ( V_309 -> F_98 , V_315 [ V_7 -> V_316 ] . V_10 ,
sizeof( V_309 -> F_98 ) ) ;
sprintf ( V_309 -> V_317 , L_15 , F_123 ( V_7 -> V_187 ) ) ;
V_309 -> V_318 = V_319 | V_320 ;
if ( ( V_313 != V_321 ) && ( V_313 != V_322 ) )
V_309 -> V_318 |= V_323 ;
V_310 = V_324 ;
if ( V_7 -> V_325 )
V_310 |= V_326 ;
V_311 = V_327 ;
if ( V_289 <= 0 && ! F_124 ( V_239 ) )
V_311 |= V_328 ;
V_312 = V_329 ;
switch ( V_241 -> V_244 ) {
case V_245 :
...
int F_125 ( struct V_239 * V_239 , void * V_232 , T_8 V_22 )
{
struct V_6 * V_7 = F_95 ( V_239 ) ;
...
unsigned int V_3 ;
T_8 V_334 ;
if ( F_124 ( V_239 ) && V_7 -> V_237 ) {
return - V_202 ;
}
for ( V_3 = 0 ; V_3 < V_335 ; V_3 ++ )
if ( V_22 == V_336 [ V_3 ] . V_22 )
break;
if ( V_3 == V_335 )
for ( V_3 = 0 ; V_3 < V_335 ; V_3 ++ )
if ( V_22 & V_336 [ V_3 ] . V_22 )
...
if ( V_3 == V_335 )
return - V_126 ;
if ( ( V_22 & V_337 ) && ( V_338 [ 0 ] != '-' ) ) {
if ( V_338 [ 0 ] == 'L' || V_338 [ 0 ] == 'l' ) {
if ( V_338 [ 1 ] == 'C' || V_338 [ 1 ] == 'c' )
V_334 = V_339 ;
else
V_334 = V_340 ;
} else {
if ( V_338 [ 0 ] == 'D' || V_338 [ 0 ] == 'd' )
V_334 = V_341 ;
else
V_334 = V_337 ;
}
for ( V_3 = 0 ; V_3 < V_335 ; V_3 ++ ) {
if ( V_334 == V_336 [ V_3 ] . V_22 )
break;
}
if ( V_3 == V_335 )
return - V_126 ;
...
V_22 = V_336 [ V_3 ] . V_22 ;
if ( ! F_124 ( V_239 ) && V_249 == V_7 -> V_237 ) {
F_91 ( & V_7 -> V_238 , V_213 ) ;
F_60 ( V_7 ) ;
F_92 ( & V_7 -> V_238 , V_213 ) ;
F_2 ( V_7 , & V_336 [ V_3 ] ) ;
...
static T_8 F_128 ( struct V_6 * V_7 )
{
static T_8 V_342 [] = {
V_343 ,
V_344 ,
...
V_337 } ;
T_8 V_267 = 0 ;
T_9 V_346 = F_118 ( V_299 ) ;
T_9 V_347 = F_118 ( V_301 ) ;
if ( ! ( V_347 & 0x1 ) )
V_267 = V_343 ;
else
V_267 = V_342 [ V_346 & 0x03 ] ;
return V_267 ;
}
int F_129 ( struct V_239 * V_239 , void * V_232 , T_8 * V_306 )
{
struct V_6 * V_7 = F_95 ( V_239 ) ;
* V_306 &= F_128 ( V_7 ) ;
return 0 ;
}
static int F_130 ( struct V_239 * V_239 , void * V_232 ,
struct V_348 * V_309 )
{
struct V_6 * V_7 = F_95 ( V_239 ) ;
if ( V_309 -> type != V_349 &&
V_309 -> type != V_350 )
return - V_126 ;
V_309 -> V_351 = V_7 -> V_12 ;
V_309 -> V_352 = V_7 -> V_15 ;
V_309 -> V_353 . V_354 = 1 ;
V_309 -> V_353 . V_355 = 1 ;
if ( V_7 -> V_11 -> V_22 & V_23 ) {
V_309 -> V_353 . V_354 = 11 ;
V_309 -> V_353 . V_355 = 10 ;
}
if ( V_7 -> V_11 -> V_22 & V_356 ) {
V_309 -> V_353 . V_354 = 54 ;
V_309 -> V_353 . V_355 = 59 ;
}
return 0 ;
}
static int F_131 ( struct V_239 * V_239 , void * V_274 , struct V_357 * V_358 )
{
struct V_6 * V_7 = F_95 ( V_239 ) ;
if ( V_358 -> type != V_349 &&
V_358 -> type != V_350 )
return - V_126 ;
V_358 -> V_115 = V_7 -> V_25 ;
return 0 ;
}
static int F_132 ( struct V_239 * V_239 , void * V_274 , const struct V_357 * V_358 )
{
struct V_6 * V_7 = F_95 ( V_239 ) ;
struct V_290 * V_105 = & V_7 -> V_12 ;
struct V_290 * V_115 = & V_7 -> V_25 ;
if ( V_358 -> type != V_349 &&
V_358 -> type != V_350 )
return - V_126 ;
if ( V_7 -> V_237 )
...
int F_133 ( struct V_239 * V_239 , void * V_232 ,
struct V_359 * V_360 )
{
struct V_6 * V_7 = F_95 ( V_239 ) ;
int V_293 ;
...
if ( V_293 == V_295 )
return - V_126 ;
if ( NULL != F_6 ( V_7 , V_293 ) . V_10 ) {
strcpy ( V_360 -> V_10 , L_16 ) ;
V_360 -> type = V_361 ;
F_10 ( V_7 , V_230 , V_362 , V_360 ) ;
V_360 -> V_363 = V_364 |
V_365 |
V_366 |
V_367 ;
V_360 -> V_368 = F_134 ( V_7 ) ;
V_360 -> V_369 = F_135 ( V_360 -> V_368 ) ;
}
if ( 0 != ( F_118 ( V_299 ) & 0x03 ) )
V_360 -> signal = 0xffff ;
return 0 ;
}
int F_136 ( struct V_239 * V_239 , void * V_232 ,
...
if ( 0 != V_360 -> V_294 )
return - V_126 ;
V_371 = V_7 -> V_372 . V_371 ;
if ( V_322 == V_371 ) {
V_370 = F_134 ( V_7 ) ;
V_371 = F_135 ( V_370 ) ;
}
if ( V_371 != V_360 -> V_369 )
V_7 -> V_372 . V_371 = V_360 -> V_369 ;
return 0 ;
}
...
if ( 0 != V_274 -> V_230 )
return - V_126 ;
F_10 ( V_7 , V_230 , V_374 , V_274 ) ;
return 0 ;
}
int F_138 ( struct V_239 * V_239 , void * V_232 ,
const struct V_373 * V_274 )
{
struct V_6 * V_7 = F_95 ( V_239 ) ;
if ( 0 != V_274 -> V_230 )
return - V_126 ;
...
static int F_139 ( struct V_239 * V_239 , void * V_232 ,
struct V_376 * V_274 )
{
if ( V_274 -> V_294 >= V_4 )
return - V_126 ;
F_122 ( V_274 -> V_377 , V_5 [ V_274 -> V_294 ] . V_10 ,
sizeof( V_274 -> V_377 ) ) ;
V_274 -> V_285 = V_5 [ V_274 -> V_294 ] . V_2 ;
return 0 ;
}
...
if ( ( V_274 -> V_294 >= V_4 ) || V_5 [ V_274 -> V_294 ] . V_169 )
return - V_126 ;
F_122 ( V_274 -> V_377 , V_5 [ V_274 -> V_294 ] . V_10 ,
sizeof( V_274 -> V_377 ) ) ;
V_274 -> V_285 = V_5 [ V_274 -> V_294 ] . V_2 ;
...
static int F_141 ( struct V_239 * V_239 , void * V_274 ,
struct V_378 * V_379 )
{
struct V_6 * V_7 = F_95 ( V_239 ) ;
* V_379 = V_7 -> V_123 ;
...
static int F_144 ( struct V_239 * V_239 , void * V_232 , unsigned int V_384 )
{
struct V_6 * V_7 = F_95 ( V_239 ) ;
unsigned long V_213 ;
if ( V_384 ) {
...
static int F_145 ( struct V_239 * V_239 , void * V_232 ,
struct V_385 * V_96 )
{
struct V_6 * V_7 = F_95 ( V_239 ) ;
V_96 -> V_85 = F_118 ( V_96 -> V_96 & 0xffffff ) ;
V_96 -> V_183 = 1 ;
return 0 ;
}
static int F_146 ( struct V_239 * V_239 , void * V_232 ,
const struct V_385 * V_96 )
{
struct V_6 * V_7 = F_95 ( V_239 ) ;
...
if ( 0 != V_360 -> V_294 )
return - V_126 ;
strcpy ( V_360 -> V_10 , L_18 ) ;
F_10 ( V_7 , V_230 , V_362 , V_360 ) ;
V_360 -> V_369 &= V_386 | V_387 ;
if ( V_7 -> V_26 -> V_388 == V_389 ) {
V_360 -> signal = 0xf800 - ( ( F_118 ( 0x581 ) & 0x1f ) << 11 ) ;
V_360 -> V_368 = ( F_118 ( 0x529 ) & 0x08 ) ?
V_390 : V_391 ;
}
return 0 ;
}
...
if ( 0 != V_360 -> V_294 )
return - V_126 ;
F_10 ( V_7 , V_230 , V_392 , V_360 ) ;
return 0 ;
}
int F_149 ( struct V_6 * V_7 )
{
struct V_393 * V_394 = & V_7 -> V_212 ;
struct V_159 * V_189 ;
int V_242 ;
if ( V_395 < 2 || V_395 > V_396 )
V_395 = 2 ;
if ( V_397 > V_398 )
V_397 = V_398 ;
V_397 = ( V_397 + V_399 - 1 ) & V_400 ;
F_150 ( V_394 , 11 ) ;
F_151 ( V_394 , & V_401 ,
V_215 , 0 , 255 , 1 , 128 ) ;
F_151 ( V_394 , & V_401 ,
...
F_151 ( V_394 , & V_401 ,
V_221 , - 15 , 15 , 1 , 0 ) ;
F_152 ( V_394 , & V_402 , NULL ) ;
F_152 ( V_394 , & V_403 , NULL ) ;
F_152 ( V_394 , & V_404 , NULL ) ;
F_152 ( V_394 , & V_405 , NULL ) ;
if ( V_394 -> error )
return V_394 -> error ;
if ( F_153 ( V_7 ) ) {
V_394 = & V_7 -> V_406 ;
F_150 ( V_394 , 2 ) ;
F_154 ( V_394 , & V_7 -> V_212 ,
V_407 ) ;
if ( V_394 -> error )
return V_394 -> error ;
}
V_7 -> V_220 = 1 ;
if ( V_7 -> V_233 && V_405 . V_408 )
V_7 -> V_233 |= V_235 ;
V_7 -> V_409 = 0 ;
F_155 ( & V_7 -> V_199 . V_410 ) ;
F_156 ( & V_7 -> V_199 . V_176 ) ;
V_7 -> V_199 . V_176 . V_411 = V_412 ;
...
if ( V_315 [ V_7 -> V_316 ] . V_414 )
F_157 ( V_7 ) ;
V_189 = & V_7 -> V_205 ;
V_189 -> type = V_349 ;
V_189 -> V_415 = V_416 | V_417 ;
if ( V_418 )
V_189 -> V_415 |= V_419 ;
...
V_189 -> V_422 = V_423 ;
V_189 -> V_424 = & V_425 ;
V_189 -> V_426 = sizeof( struct V_153 ) ;
V_189 -> V_427 = V_428 ;
V_189 -> V_243 = & V_7 -> V_243 ;
V_242 = F_158 ( V_189 ) ;
if ( V_242 )
return V_242 ;
F_159 ( V_7 -> V_187 , & V_7 -> V_199 . V_171 ) ;
V_189 = & V_7 -> V_203 ;
V_189 -> type = V_429 ;
V_189 -> V_415 = V_416 | V_417 ;
if ( V_418 )
...
if ( V_242 )
return V_242 ;
F_159 ( V_7 -> V_187 , & V_7 -> V_204 . V_171 ) ;
return 0 ;
}
void F_160 ( struct V_6 * V_7 )
{
F_161 ( & V_7 -> V_205 ) ;
F_162 ( V_7 -> V_187 , & V_7 -> V_199 . V_171 ) ;
F_161 ( & V_7 -> V_203 ) ;
F_162 ( V_7 -> V_187 , & V_7 -> V_204 . V_171 ) ;
F_163 ( & V_7 -> V_212 ) ;
if ( F_153 ( V_7 ) )
F_163 ( & V_7 -> V_406 ) ;
}
...
{
int V_431 = V_315 [ V_7 -> V_316 ] . V_414 ;
int V_432 ;
unsigned int V_433 = V_315 [ V_7 -> V_316 ] . V_433 ;
F_9 ( V_434 , V_414 [ V_431 ] [ 0 ] ) ;
V_432 = V_414 [ V_431 ] [ 1 ] ;
if ( V_433 & V_435 )
V_432 &= ~ V_436 ;
F_9 ( V_437 , V_432 ) ;
F_9 ( V_438 , V_414 [ V_431 ] [ 2 ] ) ;
F_9 ( V_439 , V_414 [ V_431 ] [ 4 ] ) ;
V_432 = V_414 [ V_431 ] [ 5 ] ;
if ( V_433 & V_440 )
V_432 &= ~ V_441 ;
if ( V_433 & V_442 )
...
F_9 ( V_448 , V_432 ) ;
F_9 ( V_449 , V_414 [ V_431 ] [ 7 ] ) ;
F_9 ( V_450 , V_414 [ V_431 ] [ 8 ] ) ;
F_9 ( V_451 , V_414 [ V_431 ] [ 3 ] ) ;
return 0 ;
}
...
V_347 = F_118 ( V_301 ) ;
F_3 ( L_23 ,
( V_346 & 0x40 ) ? L_24 : L_25 ,
( V_347 & 0x40 ) ? L_26 : L_27 ,
V_452 [ V_346 & 0x03 ] ) ;
V_7 -> V_34 = ( V_346 & 0x40 ) || ( V_347 & 0x40 ) || ! ( V_347 & 0x1 ) ;
if ( V_7 -> V_34 ) {
if ( V_7 -> V_234 )
V_7 -> V_409 = 1 ;
F_89 ( V_7 ) ;
...
if ( ( V_347 & 0x80 ) && ! V_33 && ! V_7 -> V_34 )
F_167 ( V_48 , 0x20 ) ;
else
F_168 ( V_48 , 0x20 ) ;
if ( V_7 -> V_453 && V_7 -> V_453 -> V_454 )
V_7 -> V_453 -> V_454 ( V_7 ) ;
}
void F_169 ( struct V_6 * V_7 , unsigned long V_302 )
{
enum V_119 V_120 ;
F_170 ( & V_7 -> V_238 ) ;
if ( V_7 -> V_199 . V_180 ) {
