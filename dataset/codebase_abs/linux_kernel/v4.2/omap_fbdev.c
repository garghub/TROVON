...
V_35 = F_24 ( & V_6 -> V_63 , 256 , 0 ) ;
if ( V_35 ) {
V_35 = - V_52 ;
goto V_55;
}
F_25 ( V_6 , V_29 -> V_45 [ 0 ] , V_29 -> V_64 ) ;
F_26 ( V_6 , V_17 , V_26 -> V_40 , V_26 -> V_41 ) ;
V_22 -> V_65 . V_66 = V_34 ;
V_6 -> V_67 = F_27 ( V_4 -> V_12 ) ;
...
struct V_16 * F_33 ( struct V_27 * V_22 )
{
struct V_20 * V_21 = V_22 -> V_23 ;
struct V_3 * V_4 = NULL ;
struct V_16 * V_17 ;
int V_35 = 0 ;
V_4 = F_34 ( sizeof( * V_4 ) , V_77 ) ;
if ( ! V_4 )
goto V_53;
F_35 ( & V_4 -> V_2 , F_1 ) ;
V_17 = & V_4 -> V_7 ;
