...
V_104 = V_36 -> V_56 ;
if ( memcmp ( V_76 , V_4 -> V_54 . V_102 . V_105 [ V_104 ] , V_91 ) <= 0 ) {
V_4 -> V_54 . V_102 . V_106 ++ ;
return V_51 ;
}
if ( ! ( V_38 -> V_40 & V_46 ) ) {
T_2 V_78 [ 2 * V_98 ] ;
...
memcpy ( V_4 -> V_54 . V_102 . V_105 [ V_104 ] , V_76 , V_91 ) ;
...
struct V_12 * V_13 = F_2 ( V_11 ) ;
int V_7 ;
T_2 * V_64 , V_112 = V_4 -> V_15 . V_112 ;
if ( V_13 -> V_24 . V_25 &&
! ( V_13 -> V_24 . V_25 -> V_22 & V_66 ) ) {
return V_20 ;
}
if ( F_5 ( F_8 ( V_11 ) < V_112 &&
F_60 ( V_11 , V_112 , 0 , V_62 ) ) )
return V_21 ;
V_7 = F_4 ( V_9 -> V_19 ) ;
V_64 = F_18 ( V_11 , V_112 ) ;
memmove ( V_64 , V_64 + V_112 , V_7 ) ;
return V_20 ;
}
static inline int F_61 ( T_2 * V_113 , T_2 * V_114 , int V_18 )
{
int V_115 ;
for ( V_115 = V_18 - 1 ; V_115 >= 0 ; V_115 -- ) {
if ( V_113 [ V_115 ] < V_114 [ V_115 ] )
return - 1 ;
else if ( V_113 [ V_115 ] > V_114 [ V_115 ] )
return 1 ;
}
return 0 ;
}
...
T_2 * V_118 ;
T_2 V_82 ;
if ( ! V_36 -> V_71 || ! V_36 -> V_71 -> V_119 ||
! ( V_38 -> V_40 & V_46 ) )
return V_51 ;
if ( ! F_27 ( V_9 -> V_19 ) )
return V_39 ;
V_117 = V_36 -> V_71 -> V_119 ;
V_6 = V_36 -> V_11 -> V_18 - V_7 - V_117 -> V_120 ;
if ( V_6 < 0 )
return V_51 ;
if ( F_34 ( V_9 -> V_19 ) )
V_82 = * F_35 ( V_9 ) &
...
V_105 = V_4 -> V_54 . V_121 . V_105 [ V_82 ] ;
V_118 = V_36 -> V_11 -> V_3 + V_7 + V_117 -> V_122 ;
if ( F_61 ( V_118 , V_105 , V_117 -> V_123 ) <= 0 )
return V_51 ;
memcpy ( V_105 , V_118 , V_117 -> V_123 ) ;
if ( F_48 ( V_36 -> V_11 , V_36 -> V_11 -> V_18 - V_117 -> V_96 ) )
return V_51 ;
memmove ( V_36 -> V_11 -> V_3 + V_117 -> V_120 , V_36 -> V_11 -> V_3 , V_7 ) ;
F_29 ( V_36 -> V_11 , V_117 -> V_120 ) ;
return V_39 ;
}
...
static inline void F_64 ( T_2 * V_124 , T_7 V_76 )
{
* V_124 ++ = V_76 ;
* V_124 ++ = V_76 >> 8 ;
* V_124 ++ = V_76 >> 16 ;
...
static inline void F_65 ( T_2 * V_124 , const T_2 * V_125 )
{
* V_124 ++ = V_125 [ 5 ] ;
* V_124 ++ = V_125 [ 4 ] ;
* V_124 ++ = V_125 [ 3 ] ;
...
T_2 V_78 [ 20 ] ;
T_7 V_97 ;
if ( F_17 ( F_67 ( & V_2 -> V_128 ) != 1 ) )
return V_21 ;
V_11 = F_68 ( & V_2 -> V_128 ) ;
V_13 = F_2 ( V_11 ) ;
if ( V_13 -> V_24 . V_25 )
return V_20 ;
if ( F_17 ( F_7 ( V_11 ) < sizeof( * V_127 ) ) )
return V_21 ;
V_127 = (struct V_126 * ) F_9 ( V_11 , sizeof( * V_127 ) ) ;
V_127 -> V_129 = V_130 ;
V_127 -> V_131 = sizeof( * V_127 ) - 2 ;
V_127 -> V_95 = F_32 ( V_4 -> V_15 . V_50 ) ;
V_97 = F_41 ( & V_4 -> V_15 . V_101 ) ;
F_64 ( V_127 -> V_132 , V_97 ) ;
F_63 ( V_11 , V_78 ) ;
F_69 ( V_4 -> V_54 . V_133 . V_103 , V_78 ,
V_11 -> V_3 + 24 , V_11 -> V_18 - 24 , V_127 -> V_5 ) ;
return V_20 ;
}
T_1
F_70 ( struct V_1 * V_2 )
...
if ( F_17 ( F_7 ( V_11 ) < sizeof( * V_127 ) ) )
return V_21 ;
V_127 = (struct V_134 * ) F_9 ( V_11 , sizeof( * V_127 ) ) ;
V_127 -> V_129 = V_130 ;
V_127 -> V_131 = sizeof( * V_127 ) - 2 ;
V_127 -> V_95 = F_32 ( V_4 -> V_15 . V_50 ) ;
V_97 = F_41 ( & V_4 -> V_15 . V_101 ) ;
F_64 ( V_127 -> V_132 , V_97 ) ;
F_63 ( V_11 , V_78 ) ;
F_71 ( V_4 -> V_54 . V_133 . V_103 , V_78 ,
V_11 -> V_3 + 24 , V_11 -> V_18 - 24 , V_127 -> V_5 ) ;
return V_20 ;
}
T_4
...
struct V_63 * V_4 = V_36 -> V_4 ;
struct V_126 * V_127 ;
T_2 V_78 [ 20 ] , V_5 [ 8 ] , V_135 [ 6 ] ;
struct V_8 * V_9 = (struct V_8 * ) V_11 -> V_3 ;
if ( ! F_31 ( V_9 -> V_19 ) )
return V_39 ;
if ( V_11 -> V_18 < 24 + sizeof( * V_127 ) )
return V_51 ;
V_127 = (struct V_126 * )
( V_11 -> V_3 + V_11 -> V_18 - sizeof( * V_127 ) ) ;
if ( V_127 -> V_129 != V_130 ||
V_127 -> V_131 != sizeof( * V_127 ) - 2 )
return V_51 ;
F_65 ( V_135 , V_127 -> V_132 ) ;
if ( memcmp ( V_135 , V_4 -> V_54 . V_133 . V_105 , 6 ) <= 0 ) {
V_4 -> V_54 . V_133 . V_106 ++ ;
return V_51 ;
}
if ( ! ( V_38 -> V_40 & V_46 ) ) {
F_63 ( V_11 , V_78 ) ;
...
if ( memcmp ( V_5 , V_127 -> V_5 , sizeof( V_127 -> V_5 ) ) != 0 ) {
V_4 -> V_54 . V_133 . V_136 ++ ;
return V_51 ;
}
}
memcpy ( V_4 -> V_54 . V_133 . V_105 , V_135 , 6 ) ;
F_14 ( V_11 , V_11 -> V_18 - sizeof( * V_127 ) ) ;
return V_39 ;
}
T_4
...
F_63 ( V_11 , V_78 ) ;
V_9 = (struct V_8 * ) V_11 -> V_3 ;
memcpy ( V_137 , V_9 -> V_89 , V_90 ) ;
F_65 ( V_137 + V_90 , V_127 -> V_132 ) ;
if ( F_75 ( V_4 -> V_54 . V_138 . V_103 , V_78 , V_137 ,
V_11 -> V_3 + 24 , V_11 -> V_18 - 24 , V_127 -> V_5 ) < 0 )
return V_21 ;
return V_20 ;
}
T_4
...
struct V_63 * V_4 = V_36 -> V_4 ;
struct V_134 * V_127 ;
T_2 V_78 [ 20 ] , V_5 [ 16 ] , V_135 [ 6 ] , V_137 [ 12 ] ;
struct V_8 * V_9 = (struct V_8 * ) V_11 -> V_3 ;
if ( ! F_31 ( V_9 -> V_19 ) )
return V_39 ;
if ( V_11 -> V_18 < 24 + sizeof( * V_127 ) )
...
return V_51 ;
F_65 ( V_135 , V_127 -> V_132 ) ;
if ( memcmp ( V_135 , V_4 -> V_54 . V_138 . V_105 , 6 ) <= 0 ) {
V_4 -> V_54 . V_138 . V_106 ++ ;
return V_51 ;
}
if ( ! ( V_38 -> V_40 & V_46 ) ) {
F_63 ( V_11 , V_78 ) ;
memcpy ( V_137 , V_9 -> V_89 , V_90 ) ;
memcpy ( V_137 + V_90 , V_135 , 6 ) ;
if ( F_75 ( V_4 -> V_54 . V_138 . V_103 , V_78 , V_137 ,
V_11 -> V_3 + 24 , V_11 -> V_18 - 24 ,
V_5 ) < 0 ||
memcmp ( V_5 , V_127 -> V_5 , sizeof( V_127 -> V_5 ) ) != 0 ) {
V_4 -> V_54 . V_138 . V_136 ++ ;
return V_51 ;
}
}
memcpy ( V_4 -> V_54 . V_138 . V_105 , V_135 , 6 ) ;
F_14 ( V_11 , V_11 -> V_18 - sizeof( * V_127 ) ) ;
return V_39 ;
}
T_1
