...
V_23 -> V_150 = V_160 ;
F_67 ( V_2 ) ;
F_68 ( V_2 , V_144 , V_144 , V_160 ,
V_145 [ V_144 ] , 0 , V_142 ) ;
F_69 ( V_2 , V_144 , V_144 , V_160 ,
...
F_68 ( V_2 , V_182 , V_182 , V_183 , V_178 , 0 , V_141 ) ;
F_69 ( V_2 , V_182 , V_182 , V_183 , V_178 , 0 , V_141 , 0 ) ;
} else if ( V_184 ) {
V_23 -> V_151 = V_183 ;
F_68 ( V_2 , V_182 , V_182 , V_183 , V_176 , 0 , V_141 ) ;
F_69 ( V_2 , V_182 , V_182 , V_183 , V_176 , 0 ,
V_141 , 0 ) ;
} else {
if ( ( V_23 -> V_150 == V_187 ) &&
V_23 -> V_193 -> V_194 )
F_79 ( V_2 , 0x173 , 1 ) ;
F_68 ( V_2 , 4 , V_182 , V_183 , ( T_1 * ) V_23 -> V_195 ,
0 , V_141 ) ;
F_69 ( V_2 , 4 , V_182 , V_183 , ( T_1 * ) V_23 -> V_195 ,
0 , V_141 , 0 ) ;
}
}
V_155:
...
return 0 ;
F_9 ( & V_9 -> V_15 ) ;
V_13 = F_81 ( V_9 -> V_10 , V_11 , & ( V_51 -> V_196 ) , V_12 ) ;
F_11 ( & V_9 -> V_15 ) ;
return V_13 ;
}
...
return 0 ;
F_9 ( & V_9 -> V_15 ) ;
V_13 = F_83 ( V_9 -> V_10 , V_11 , V_6 , V_12 ) ;
F_11 ( & V_9 -> V_15 ) ;
return V_13 ;
}
...
return 0 ;
F_9 ( & V_9 -> V_15 ) ;
V_13 = F_85 ( V_9 -> V_10 , V_12 , V_51 -> V_51 . V_52 ) ;
F_11 ( & V_9 -> V_15 ) ;
return V_13 ;
}
...
T_3 V_201 ;
T_3 V_202 ;
if ( F_88 ( V_199 , V_6 -> V_51 . V_203 , sizeof( V_199 ) ) )
return - V_204 ;
V_200 = V_199 [ 0 ] ;
V_201 = V_199 [ 1 ] ;
V_202 = V_199 [ 2 ] ;
...
static struct V_207 * F_92 ( struct V_1 * V_2 )
{
struct V_8 * V_9 = F_2 ( V_2 ) ;
struct V_22 * V_23 = V_9 -> V_10 ;
