...
V_107 | V_108 ) )
return - V_109 ;
V_16 = F_30 ( & V_6 -> V_110 , sizeof( struct V_1 ) , V_111 ) ;
if ( ! V_16 )
return - V_112 ;
V_3 = & V_16 -> V_3 ;
F_31 ( V_3 , V_6 , & V_113 ) ;
...
V_103 , 0 , 1 , 1 , 0 ) ;
if ( V_16 -> V_96 . error ) {
int V_118 = V_16 -> V_96 . error ;
F_35 ( V_3 , L_9 , V_118 ) ;
F_36 ( & V_16 -> V_96 ) ;
return V_118 ;
}
V_16 -> V_3 . V_119 = & V_16 -> V_96 ;
V_16 -> V_22 = 0x0024 ;
V_16 -> V_20 = 0x01fc ;
V_16 -> V_33 = 640 ;
V_16 -> V_32 = 480 ;
V_16 -> V_46 = 27000000 ;
if ( V_6 -> V_110 . V_120 ) {
struct V_121 * V_122 = V_6 -> V_110 . V_120 ;
V_16 -> V_46 = V_122 -> V_46 ;
F_6 ( 1 , V_10 , V_3 , L_10 ,
V_16 -> V_46 / 1000000 , ( V_16 -> V_46 / 1000 ) % 1000 ) ;
}
F_37 ( V_6 , L_11 ,
V_6 -> V_4 << 1 , V_6 -> V_106 -> V_123 , V_105 ) ;
return 0 ;
}
