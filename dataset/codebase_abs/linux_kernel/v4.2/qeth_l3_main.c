...
{
struct V_27 * V_28 = V_122 -> V_245 ;
T_8 V_524 = V_122 -> V_184 ^ V_184 ;
if ( ! ( V_524 & V_185 ) )
return 0 ;
if ( V_28 -> V_331 == V_337 ||
V_28 -> V_331 == V_525 )
return 0 ;
return F_89 ( V_28 , V_184 & V_185 ? 1 : 0 ) ;
}
static int F_244 ( struct V_431 * V_432 )
{
V_432 -> V_526 = V_527 ;
memcpy ( V_432 -> V_528 , L_125 , 6 ) ;
V_432 -> V_529 = V_432 -> V_530 -> V_531 ;
return 0 ;
}
static int
F_245 ( struct V_215 * V_122 , struct V_532 * V_533 )
{
if ( V_533 -> V_534 -> V_535 == V_536 )
V_533 -> V_537 = F_244 ;
return 0 ;
}
...
if ( ! V_28 -> V_122 )
return - V_409 ;
V_28 -> V_122 -> V_538 = & V_539 ;
F_102 ( V_28 ) ;
if ( ! ( V_28 -> V_97 . V_191 & V_195 ) )
V_28 -> V_122 -> V_540 = V_28 -> V_97 . V_191 &
0xffff ;
if ( ! V_28 -> V_97 . V_339 ) {
V_28 -> V_122 -> V_541 = V_542 |
V_185 | V_523 |
V_188 ;
V_28 -> V_122 -> V_184 = V_185 ;
}
...
V_28 -> V_122 = F_249 ( 0 , L_177 , V_543 ,
V_544 ) ;
if ( ! V_28 -> V_122 )
return - V_409 ;
V_28 -> V_122 -> V_58 |= V_545 ;
V_28 -> V_122 -> V_538 = & V_546 ;
V_4 = F_100 ( V_28 ) ;
if ( V_4 )
return V_4 ;
if ( V_28 -> V_43 . V_547 [ 0 ] )
memcpy ( V_28 -> V_122 -> V_548 , V_28 -> V_43 . V_547 , 9 ) ;
} else
return - V_409 ;
V_28 -> V_122 -> V_245 = V_28 ;
V_28 -> V_122 -> V_549 = V_550 ;
V_28 -> V_122 -> V_551 = V_28 -> V_97 . V_552 ;
V_28 -> V_122 -> V_553 = & V_554 ;
V_28 -> V_122 -> V_184 |= V_555 |
V_556 |
V_557 ;
F_250 ( V_28 -> V_122 ) ;
V_28 -> V_122 -> V_558 = 15 * V_559 ;
F_251 ( V_28 -> V_122 , & V_28 -> V_121 -> V_122 ) ;
F_252 ( V_28 -> V_122 , & V_28 -> V_302 , F_147 , V_560 ) ;
return F_253 ( V_28 -> V_122 ) ;
}
static int F_254 ( struct V_561 * V_121 )
{
...
static void F_257 ( struct V_561 * V_563 )
{
struct V_27 * V_28 = F_255 ( & V_563 -> V_122 ) ;
F_258 ( & V_563 -> V_122 ) ;
F_164 ( V_28 , 0 , 1 ) ;
F_259 ( V_28 -> V_564 , F_174 ( V_28 , 0xffffffff ) == 0 ) ;
if ( V_563 -> V_331 == V_565 )
F_260 ( V_563 ) ;
if ( V_28 -> V_122 ) {
F_261 ( V_28 -> V_122 ) ;
V_28 -> V_122 = NULL ;
...
static int F_262 ( struct V_561 * V_121 , int V_329 )
{
struct V_27 * V_28 = F_255 ( & V_121 -> V_122 ) ;
int V_4 = 0 ;
enum V_566 V_567 ;
...
V_28 -> V_97 . V_562 = 0 ;
V_28 -> V_331 = V_336 ;
memset ( & V_28 -> V_293 , 0 , sizeof( struct V_573 ) ) ;
F_268 ( V_28 ) ;
F_66 ( V_136 , 2 , L_180 ) ;
V_4 = F_269 ( V_28 ) ;
if ( V_4 ) {
...
static int F_282 ( struct V_561 * V_121 )
{
return F_262 ( V_121 , 0 ) ;
}
static int F_283 ( struct V_561 * V_563 ,
int V_329 )
{
struct V_27 * V_28 = F_255 ( & V_563 -> V_122 ) ;
int V_4 = 0 , V_577 = 0 , V_578 = 0 ;
enum V_566 V_567 ;
F_263 ( & V_28 -> V_568 ) ;
F_263 ( & V_28 -> V_569 ) ;
F_66 ( V_136 , 3 , L_187 ) ;
...
F_272 ( V_28 -> V_122 ) ;
V_567 = V_28 -> V_331 ;
if ( ( ! V_329 && V_28 -> V_97 . V_562 ) || V_28 -> V_97 . V_562 == 2 ) {
F_267 ( V_28 , V_579 ) ;
V_28 -> V_97 . V_562 = 1 ;
}
F_163 ( V_28 , V_329 ) ;
...
F_91 () ;
F_285 ( V_580 , V_28 -> V_122 ) ;
F_93 () ;
}
V_4 = F_277 ( F_278 ( V_28 ) ) ;
V_577 = F_277 ( F_279 ( V_28 ) ) ;
V_578 = F_277 ( F_280 ( V_28 ) ) ;
if ( ! V_4 )
V_4 = ( V_577 ) ? V_577 : V_578 ;
if ( V_4 )
F_265 ( V_136 , 2 , L_181 , V_4 ) ;
F_281 ( F_278 ( V_28 ) ) ;
if ( V_567 == V_334 )
V_28 -> V_331 = V_525 ;
F_275 ( & V_563 -> V_122 . V_575 , V_576 ) ;
F_276 ( & V_28 -> V_569 ) ;
F_276 ( & V_28 -> V_568 ) ;
return 0 ;
}
static int F_260 ( struct V_561 * V_563 )
{
return F_283 ( V_563 , 0 ) ;
}
static int F_286 ( void * V_581 )
{
struct V_27 * V_28 ;
int V_4 = 0 ;
...
static void F_293 ( struct V_561 * V_121 )
{
struct V_27 * V_28 = F_255 ( & V_121 -> V_122 ) ;
F_164 ( V_28 , 0 , 1 ) ;
if ( ( V_121 -> V_331 == V_565 ) && V_28 -> V_97 . V_562 )
F_267 ( V_28 , V_579 ) ;
F_168 ( V_28 , 0 ) ;
F_169 ( V_28 ) ;
F_281 ( F_278 ( V_28 ) ) ;
}
static int F_294 ( struct V_561 * V_121 )
{
struct V_27 * V_28 = F_255 ( & V_121 -> V_122 ) ;
if ( V_28 -> V_122 )
F_295 ( V_28 -> V_122 ) ;
...
static int F_296 ( struct V_561 * V_121 )
{
struct V_27 * V_28 = F_255 ( & V_121 -> V_122 ) ;
int V_4 = 0 ;
if ( V_121 -> V_331 == V_582 )
...
static int F_299 ( struct V_583 * V_584 ,
unsigned long V_585 , void * V_581 )
{
struct V_237 * V_238 = (struct V_237 * ) V_581 ;
struct V_215 * V_122 = (struct V_215 * ) V_238 -> V_586 -> V_122 ;
struct V_29 * V_2 ;
struct V_27 * V_28 ;
if ( F_300 ( V_122 ) != & V_587 )
return V_588 ;
V_28 = F_162 ( V_122 ) ;
if ( ! V_28 )
return V_588 ;
...
static int F_301 ( struct V_583 * V_584 ,
unsigned long V_585 , void * V_581 )
{
struct V_243 * V_238 = (struct V_243 * ) V_581 ;
struct V_215 * V_122 = (struct V_215 * ) V_238 -> V_591 -> V_122 ;
struct V_29 * V_2 ;
struct V_27 * V_28 ;
V_28 = F_162 ( V_122 ) ;
if ( ! V_28 )
