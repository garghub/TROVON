...
bool F_58 ( const struct V_1 * V_129 ,
...
static const char * F_61 ( enum V_131 V_140 )
{
int V_94 = V_140 + 3 ;
if ( F_10 ( V_94 < 0 || V_94 >= F_62 ( V_141 ) ) )
return L_6 ;
return V_141 [ V_94 ] ;
}
...
static int F_66 ( void * V_145 , struct V_128 * V_146 , struct V_128 * V_147 )
{
struct V_1 * V_148 = F_67 ( V_146 , struct V_1 , V_25 ) ;
struct V_1 * V_149 = F_67 ( V_147 , struct V_1 , V_25 ) ;
int V_150 ;
...
void F_68 ( struct V_128 * V_142 )
{
F_69 ( NULL , V_142 , F_66 ) ;
}
...
int V_155 ;
F_10 ( ! F_11 ( & V_22 -> V_17 -> V_23 . V_24 ) ) ;
F_64 (pmode, pt, &connector->probed_modes,
head) {
V_155 = 0 ;
F_71 (mode, &connector->modes, head) {
if ( F_56 ( V_153 , V_2 ) ) {
V_155 = 1 ;
V_2 -> V_140 = V_153 -> V_140 ;
if ( V_152 )
V_2 -> type |= V_153 -> type ;
else
V_2 -> type = V_153 -> type ;
...
if ( ! V_155 ) {
F_72 ( & V_153 -> V_25 , & V_22 -> V_156 ) ;
}
}
}
bool F_73 ( const char * V_157 ,
struct V_21 * V_22 ,
struct V_158 * V_2 )
{
const char * V_5 ;
...
! V_168 && V_169 ) {
V_165 = F_75 ( & V_5 [ V_170 + 1 ] , NULL , 10 ) ;
V_161 = true ;
V_169 = false ;
} else
goto V_176;
...
case 'x' :
if ( ! V_166 && V_169 ) {
V_164 = F_75 ( & V_5 [ V_170 + 1 ] , NULL , 10 ) ;
V_166 = true ;
V_169 = false ;
} else
goto V_176;
...
void F_78 ( struct V_187 * V_188 ,
const struct V_1 * V_189 )
{
F_79 ( V_189 -> V_7 > V_190 || V_189 -> V_8 > V_190 ||
