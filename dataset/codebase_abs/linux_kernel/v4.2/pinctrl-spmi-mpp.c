...
V_8 |= V_6 -> V_42 << V_51 ;
V_8 |= V_6 -> V_52 & V_53 ;
V_9 = F_6 ( V_4 , V_6 , V_54 , V_8 ) ;
if ( V_9 < 0 )
return V_9 ;
V_8 = V_6 -> V_55 << V_56 ;
return F_6 ( V_4 , V_6 , V_57 , V_8 ) ;
}
static int F_32 ( struct V_13 * V_14 ,
unsigned int V_17 , unsigned long * V_58 )
{
unsigned V_32 = F_33 ( * V_58 ) ;
struct V_5 * V_6 ;
unsigned V_59 = 0 ;
V_6 = V_14 -> V_15 -> V_18 [ V_17 ] . V_46 ;
switch ( V_32 ) {
...
V_8 = V_6 -> V_69 << V_77 ;
V_9 = F_6 ( V_4 , V_6 , V_78 , V_8 ) ;
if ( V_9 < 0 )
return V_9 ;
V_8 = V_6 -> V_61 << V_79 ;
V_9 = F_6 ( V_4 , V_6 , V_80 , V_8 ) ;
if ( V_9 < 0 )
return V_9 ;
V_8 = V_6 -> V_73 & V_81 ;
V_9 = F_6 ( V_4 , V_6 , V_82 , V_8 ) ;
if ( V_9 < 0 )
return V_9 ;
if ( ! V_6 -> V_47 ) {
V_8 = 0 ;
...
F_37 ( V_84 , L_17 , V_6 -> V_69 ) ;
F_37 ( V_84 , L_18 , V_85 [ V_6 -> V_61 ] ) ;
F_37 ( V_84 , L_11 , V_6 -> V_52 ? L_19 : L_20 ) ;
}
}
...
unsigned long V_58 ;
V_58 = F_15 ( V_70 , 1 ) ;
return F_34 ( V_4 -> V_89 , V_17 , & V_58 , 1 ) ;
}
...
V_6 -> V_42 = V_8 >> V_51 ;
V_6 -> V_42 &= V_110 ;
V_8 = F_3 ( V_4 , V_6 , V_78 ) ;
if ( V_8 < 0 )
return V_8 ;
V_6 -> V_69 = V_8 >> V_77 ;
V_6 -> V_69 &= V_111 ;
V_8 = F_3 ( V_4 , V_6 , V_80 ) ;
if ( V_8 < 0 )
return V_8 ;
V_6 -> V_61 = V_8 >> V_79 ;
V_6 -> V_61 &= V_112 ;
V_8 = F_3 ( V_4 , V_6 , V_82 ) ;
if ( V_8 < 0 )
return V_8 ;
V_6 -> V_73 = V_8 >> V_113 ;
V_6 -> V_73 &= V_81 ;
...
if ( F_61 ( V_4 -> V_89 ) )
return F_62 ( V_4 -> V_89 ) ;
V_9 = F_63 ( & V_4 -> V_3 ) ;
if ( V_9 ) {
F_5 ( V_4 -> V_12 , L_27 ) ;
goto V_139;
}
V_9 = F_64 ( & V_4 -> V_3 , F_58 ( V_12 ) , 0 , 0 , V_16 ) ;
if ( V_9 ) {
F_5 ( V_12 , L_28 ) ;
goto V_140;
}
