...
unsigned int V_14 ;
for ( V_14 = 0 ; V_14 < V_16 ; V_14 ++ ) {
F_24 ( & V_38 , V_29 [ V_14 ] . V_11 . V_37 ) ;
F_24 ( & V_39 , V_29 [ V_14 ] . V_7 ) ;
}
}
...
int F_31 ( int V_41 , const char * * V_42 ,
const char * T_8 V_19 )
{
int V_43 = 0 ;
unsigned int V_14 , V_44 ;
struct V_45 V_46 ;
T_1 V_13 ;
struct V_2 * V_29 ;
V_41 = F_32 ( V_41 , V_42 , V_47 ,
V_48 , 0 ) ;
if ( V_41 ) {
F_33 ( V_48 , V_47 ) ;
exit ( V_18 ) ;
...
F_40 ( & V_22 , NULL ) ;
F_40 ( & V_23 , NULL ) ;
for ( V_44 = 0 ; V_44 < V_56 && ! V_40 ; V_44 ++ ) {
