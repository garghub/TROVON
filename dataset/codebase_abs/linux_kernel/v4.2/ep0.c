...
unsigned V_170 = V_163 -> V_64 . V_143 ;
V_169 += ( V_170 - ( V_169 % V_170 ) ) ;
V_164 = F_54 ( T_3 , V_162 -> V_69 ,
V_169 - V_69 ) ;
memcpy ( V_162 -> V_105 , V_8 -> V_171 , V_164 ) ;
} else {
...
F_24 ( V_163 , V_161 , 0 ) ;
if ( F_55 ( V_162 -> V_69 , V_163 -> V_64 . V_143 ) &&
...
V_169 = F_62 ( V_42 -> V_43 . V_69 , V_143 ) ;
V_8 -> V_168 = true ;
V_18 = F_2 ( V_8 , V_17 -> V_36 ,
V_8 -> V_176 , V_169 ,
V_173 ) ;
