...
unsigned char V_5 ;
unsigned char V_73 ;
F_12 ( & V_2 -> V_13 , L_16 , V_14 ) ;
if ( ! F_28 ( V_2 -> V_12 , V_74 ) )
return - V_75 ;
V_28 = F_29 ( & V_2 -> V_13 , sizeof( struct V_28 ) ,
V_76 ) ;
if ( ! V_28 )
return - V_77 ;
F_18 ( & V_2 -> V_13 , L_17 V_78 L_18 ) ;
F_30 ( V_2 , V_28 ) ;
V_28 -> V_2 = V_2 ;
F_31 ( & V_2 -> V_13 , 1 ) ;
V_5 = V_79 ;
V_17 = F_4 ( V_2 , V_80 , 1 , & V_5 ) ;
if ( V_17 < 0 ) {
F_3 ( & V_2 -> V_13 , L_3 , V_14 ) ;
return V_17 ;
}
V_17 = F_7 ( V_2 , NULL , & V_73 ) ;
if ( V_17 ) {
F_3 ( & V_2 -> V_13 , L_1 , V_14 ) ;
return V_17 ;
}
if ( V_73 )
F_6 ( V_2 , 0 ) ;
V_28 -> V_31 = F_32 ( & V_2 -> V_13 ,
V_81 . V_82 . V_83 ,
& V_84 , V_85 ) ;
if ( F_33 ( V_28 -> V_31 ) )
return F_34 ( V_28 -> V_31 ) ;
if ( V_2 -> V_26 > 0 ) {
V_17 = F_35 ( & V_2 -> V_13 , V_2 -> V_26 ,
NULL , F_8 ,
V_86 | V_87 | V_88 ,
V_28 -> V_31 -> V_83 , V_2 ) ;
if ( V_17 ) {
