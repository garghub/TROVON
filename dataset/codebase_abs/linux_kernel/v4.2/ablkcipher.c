...
goto V_122;
if ( V_107 -> V_123 ) {
V_22 = V_107 -> V_123 ( V_107 , V_100 ) ;
if ( V_22 )
goto V_124;
goto V_125;
}
V_109 = V_107 -> V_126 ( V_100 ) ;
V_22 = F_64 ( V_109 ) ;
if ( F_65 ( V_109 ) )
goto V_124;
V_22 = F_68 ( V_107 , V_109 ) ;
if ( V_22 ) {
V_107 -> free ( V_109 ) ;
goto V_124;
}
...
return V_67 ;
F_71 ( V_67 ) ;
V_67 = F_73 ( V_119 , type | V_127 ,
V_68 & ~ V_127 ) ;
if ( F_65 ( V_67 ) )
return V_67 ;
if ( ( V_67 -> V_93 & V_96 ) ==
V_112 ) {
if ( ~ V_67 -> V_93 & ( type ^ ~ V_68 ) & V_127 ) {
F_71 ( V_67 ) ;
V_67 = F_74 ( - V_121 ) ;
}
return V_67 ;
...
int F_76 ( struct V_128 * V_129 , const char * V_119 ,
T_2 type , T_2 V_68 )
{
struct V_66 * V_67 ;
int V_22 ;
...
if ( F_65 ( V_67 ) )
return F_64 ( V_67 ) ;
V_22 = F_79 ( & V_129 -> V_25 , V_67 , V_129 -> V_25 . V_109 , V_68 ) ;
F_71 ( V_67 ) ;
return V_22 ;
}
struct V_53 * F_80 ( const char * V_130 ,
T_2 type , T_2 V_68 )
{
struct V_23 * V_24 ;
int V_22 ;
