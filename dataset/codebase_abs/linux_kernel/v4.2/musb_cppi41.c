...
static T_4 F_29 ( unsigned V_80 , unsigned V_81 , T_4 V_82 )
{
unsigned V_83 ;
V_83 = ( V_80 - 1 ) * 2 ;
V_82 &= ~ ( 3 << V_83 ) ;
...
V_86 = V_6 -> V_88 ;
V_84 = V_2 -> V_89 ;
V_85 = F_29 ( V_84 , V_81 , V_86 ) ;
if ( V_85 == V_86 )
return;
if ( V_2 -> V_5 ) {
V_6 -> V_87 = V_85 ;
F_31 ( V_6 -> V_7 -> V_90 , V_91 ,
V_85 ) ;
} else {
V_6 -> V_88 = V_85 ;
F_31 ( V_6 -> V_7 -> V_90 , V_92 ,
V_85 ) ;
}
}
...
F_7 ( V_7 -> V_6 ,
L_3 ,
V_2 -> V_89 , F_34 ( V_2 -> V_89 ) ,
V_29 , V_81 , ( unsigned long long ) V_95 ,
V_96 , V_2 -> V_5 ) ;
V_2 -> V_38 = V_95 ;
V_2 -> V_39 = V_96 ;
V_2 -> V_26 = 0 ;
...
F_30 ( V_2 , V_100 ) ;
F_32 ( V_2 , V_101 ) ;
V_96 = F_35 ( T_4 , V_29 , V_96 ) ;
}
V_2 -> V_21 = V_96 ;
V_36 = V_2 -> V_5 ? V_40 : V_41 ;
V_34 = F_12 ( V_32 , V_95 , V_96 , V_36 ,
V_42 | V_43 ) ;
if ( ! V_34 )
return false ;
V_34 -> V_44 = V_45 ;
...
static struct V_66 * F_36 ( struct V_102 * V_103 ,
struct V_13 * V_8 , T_2 V_5 )
{
struct V_53 * V_6 = F_16 ( V_103 ,
struct V_53 , V_6 ) ;
struct V_1 * V_2 = NULL ;
...
V_56 = F_33 ( V_22 , V_29 , V_81 , V_95 , V_96 ) ;
if ( ! V_56 )
V_22 -> V_23 = V_24 ;
return V_56 ;
}
static int F_40 ( struct V_66 * V_22 , T_1 V_114 ,
...
static void F_44 ( struct V_53 * V_127 )
{
struct V_31 * V_32 ;
int V_128 ;
...
static void F_46 ( struct V_53 * V_6 )
{
F_44 ( V_6 ) ;
}
static int F_47 ( struct V_53 * V_6 )
{
struct V_7 * V_7 = V_6 -> V_7 ;
...
unsigned V_5 ;
unsigned int V_84 ;
V_56 = F_49 ( V_132 , L_5 , V_128 , & V_136 ) ;
if ( V_56 )
goto V_137;
if ( F_50 ( V_136 , L_6 ) )
V_5 = 1 ;
else if ( F_50 ( V_136 , L_7 ) )
V_5 = 0 ;
else {
F_51 ( V_130 , L_8 , V_136 ) ;
goto V_137;
}
V_56 = F_52 ( V_136 + 2 , 0 , & V_84 ) ;
if ( V_56 )
goto V_137;
V_56 = - V_138 ;
if ( V_84 > V_105 || ! V_84 )
...
V_135 -> V_23 = V_24 ;
V_135 -> V_139 = V_140 ;
V_32 = F_54 ( V_130 , V_136 ) ;
if ( ! V_32 ) {
F_51 ( V_130 , L_9 , V_136 ) ;
V_56 = - V_141 ;
goto V_137;
}
V_2 -> V_32 = V_32 ;
...
struct V_102 *
F_58 ( struct V_7 * V_7 , void T_3 * V_142 )
{
struct V_53 * V_6 ;
int V_56 = 0 ;
if ( ! V_7 -> V_6 -> V_133 ) {
...
V_6 = F_59 ( sizeof( * V_6 ) , V_143 ) ;
if ( ! V_6 )
goto V_144;
F_60 ( & V_6 -> V_58 , V_145 , V_79 ) ;
V_6 -> V_58 . V_146 = F_15 ;
F_53 ( & V_6 -> V_62 ) ;
V_6 -> V_7 = V_7 ;
V_6 -> V_6 . V_147 = F_36 ;
