...
int V_45 ;
struct V_42 * V_46 ;
F_47 (sglist, sg, nents, i) {
if ( ! F_8 ( V_5 ) )
F_40 ( F_48 ( V_46 ) , V_46 -> V_37 , V_46 -> V_47 ,
V_34 ) ;
#ifdef F_49
V_46 -> V_48 = V_46 -> V_47 ;
#endif
V_46 -> V_49 = F_50 ( V_5 , F_48 ( V_46 ) ) +
V_46 -> V_37 ;
}
return V_44 ;
}
static T_2 F_51 ( struct V_4 * V_5 , struct V_3 * V_3 ,
unsigned long V_37 , T_4 V_20 , enum V_33 V_34 ,
struct V_23 * V_24 )
{
if ( ! F_8 ( V_5 ) )
F_40 ( V_3 , V_37 , V_20 , V_34 ) ;
return F_50 ( V_5 , V_3 ) + V_37 ;
}
static void F_52 ( struct V_4 * V_5 , struct V_42 * V_43 ,
int V_50 , enum V_33 V_34 ,
struct V_23 * V_24 )
{
int V_45 ;
struct V_42 * V_46 ;
F_47 (sglist, sg, nhwentries, i) {
if ( ! F_8 ( V_5 ) &&
V_34 != V_35 )
F_40 ( F_48 ( V_46 ) , V_46 -> V_37 , V_46 -> V_47 ,
V_34 ) ;
F_28 ( V_5 , V_46 -> V_49 , V_46 -> V_47 , V_34 ) ;
}
}
...
struct V_42 * V_43 , int V_51 ,
enum V_33 V_34 )
{
int V_45 ;
struct V_42 * V_46 ;
if ( F_7 ( V_5 ) ) {
F_47 (sglist, sg, nelems, i) {
F_40 ( F_48 ( V_46 ) , V_46 -> V_37 , V_46 -> V_47 ,
V_34 ) ;
}
}
...
int F_57 ( struct V_4 * V_5 , T_2 V_6 )
{
return 0 ;
}
int F_58 ( struct V_4 * V_5 , T_5 V_52 )
{
return F_59 ( V_5 , V_52 ) ;
}
void F_60 ( struct V_4 * V_5 , void * V_29 , T_4 V_20 ,
enum V_33 V_34 )
{
F_61 ( V_34 == V_53 ) ;
if ( ! F_8 ( V_5 ) )
