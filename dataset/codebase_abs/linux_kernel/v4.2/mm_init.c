...
T_4 V_44 ;
T_5 V_45 = F_16 () ;
T_5 V_46 = F_17 ( T_5 , V_45 * 2 , 32 ) ;
V_44 = F_18 ( T_4 , ( V_47 / V_45 ) / 256 , 0x7fffffff ) ;
V_48 = F_17 ( T_5 , V_44 , V_46 ) ;
}
static int T_3 F_19 ( struct V_49 * V_50 ,
