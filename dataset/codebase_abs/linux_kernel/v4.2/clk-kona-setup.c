...
if ( V_2 -> V_79 . V_80 ) {
T_4 V_87 ;
V_87 = V_2 -> V_79 . V_80 * sizeof( * V_2 -> V_79 . V_81 ) ;
V_2 -> V_79 . V_81 = F_57 ( V_87 , V_65 ) ;
if ( ! V_2 -> V_79 . V_81 ) {
F_4 ( L_51 ,
...
V_2 -> V_82 = F_60 ( V_86 . V_90 , V_2 -> V_6 ) ;
if ( ! V_2 -> V_82 ) {
F_4 ( L_55 , V_9 ,
V_83 -> V_10 ) ;
goto V_88;
...
V_2 -> V_83 = F_61 ( V_83 ) ;
for ( V_60 = 0 ; V_60 < V_2 -> V_79 . V_80 ; V_60 ++ ) {
if ( ! V_2 -> V_91 [ V_60 ] . V_2 )
continue;
V_2 -> V_79 . V_81 [ V_60 ] = F_48 ( & V_2 -> V_91 [ V_60 ] ) ;
}
V_68 = F_62 ( V_83 , V_92 , & V_2 -> V_79 ) ;
if ( V_68 ) {
F_4 ( L_56 , V_9 ,
V_83 -> V_10 , V_68 ) ;
goto V_88;
