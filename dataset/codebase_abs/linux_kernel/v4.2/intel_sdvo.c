...
static void F_95 ( struct V_5 * V_6 , int V_55 )
{
struct V_162 * V_163 ;
...
static bool F_99 ( struct V_1 * V_1 , struct V_261 * V_262 )
{
F_34 ( sizeof( * V_262 ) != 8 ) ;
if ( ! F_31 ( V_1 ,
V_263 ,
...
{
return F_104 ( V_1 -> V_262 . V_275 ) > 1 ;
}
static struct V_280 *
F_105 ( struct V_5 * V_6 )
{
struct V_1 * V_281 = F_3 ( V_6 ) ;
return F_106 ( V_6 , & V_281 -> V_282 ) ;
}
static struct V_280 *
...
V_38 = V_290 ;
if ( V_1 -> V_291 ) {
V_1 -> V_203 = F_110 ( V_280 ) ;
V_1 -> V_228 = F_111 ( V_280 ) ;
V_1 -> V_168 =
F_112 ( V_280 ) ;
}
} else
...
if ( V_7 -> V_293 != V_294 )
V_1 -> V_228 = ( V_7 -> V_293 == V_295 ) ;
}
return V_38 ;
}
static bool
F_113 ( struct V_7 * V_281 ,
struct V_280 * V_280 )
{
bool V_296 = ! ! ( V_280 -> V_288 & V_289 ) ;
bool V_297 = ! ! F_114 ( V_281 ) ;
F_14 ( L_37 ,
V_297 , V_296 ) ;
return V_297 == V_296 ;
}
static enum V_285
F_115 ( struct V_5 * V_6 , bool V_298 )
{
T_4 V_44 ;
struct V_1 * V_1 = F_3 ( V_6 ) ;
struct V_7 * V_7 = F_5 ( V_6 ) ;
...
static void F_138 ( struct V_344 * V_3 )
{
...
V_356 = & V_12 -> V_358 [ 1 ] ;
if ( V_356 -> V_359 &&
F_146 ( V_12 , V_356 -> V_362 ) )
V_361 = V_356 -> V_362 ;
else
V_361 = V_363 ;
V_281 -> V_31 = F_108 ( V_12 , V_361 ) ;
F_147 ( V_281 -> V_31 , true ) ;
}
static void
F_148 ( struct V_1 * V_281 )
{
F_147 ( V_281 -> V_31 , false ) ;
}
static bool
F_149 ( struct V_1 * V_1 , int V_364 )
{
return F_52 ( V_1 ) ;
}
static T_2
F_150 ( struct V_9 * V_10 , struct V_1 * V_281 )
{
struct V_11 * V_12 = V_10 -> V_13 ;
...
static void
F_151 ( struct V_233 * V_233 )
{
struct V_5 * V_5 ;
struct V_1 * V_367 ;
V_5 = & V_233 -> V_4 ;
V_367 = F_3 ( & V_233 -> V_4 ) ;
F_152 ( & V_5 -> V_368 -> V_369 ,
...
F_162 ( & V_6 -> V_4 . V_4 ) ;
if ( F_73 ( V_10 ) -> V_220 >= 4 && F_163 ( V_10 ) ) {
F_164 ( & V_6 -> V_4 . V_4 ) ;
V_1 -> V_204 = true ;
}
}
static struct V_7 * F_165 ( void )
{
struct V_7 * V_382 ;
V_382 = F_22 ( sizeof( * V_382 ) , V_39 ) ;
if ( ! V_382 )
return NULL ;
if ( F_166 ( & V_382 -> V_4 ) < 0 ) {
F_24 ( V_382 ) ;
return NULL ;
}
return V_382 ;
...
static bool
F_171 ( struct V_1 * V_1 , int V_364 )
{
struct V_344 * V_3 = & V_1 -> V_4 . V_4 ;
struct V_5 * V_6 ;
struct V_233 * V_233 ;
...
static bool
F_172 ( struct V_1 * V_1 , int V_364 )
{
struct V_344 * V_3 = & V_1 -> V_4 . V_4 ;
struct V_5 * V_6 ;
struct V_233 * V_233 ;
...
V_1 -> V_347 = 0 ;
memcpy ( V_404 , & V_1 -> V_262 . V_275 , 2 ) ;
F_14 ( L_44 ,
F_20 ( V_1 ) ,
V_404 [ 0 ] , V_404 [ 1 ] ) ;
return false ;
...
static bool F_169 ( struct V_1 * V_1 ,
struct V_7 * V_7 ,
int type )
{
struct V_9 * V_10 = V_1 -> V_4 . V_4 . V_10 ;
...
F_177 (
V_7 -> V_327 , V_16 ,
V_16 , V_409 [ V_7 -> V_329 [ V_16 ] ] ) ;
V_1 -> V_179 = V_7 -> V_329 [ 0 ] ;
F_178 ( & V_7 -> V_4 . V_4 . V_4 ,
V_7 -> V_327 , 0 ) ;
return true ;
}
static bool
...
return false ;
V_7 -> V_334 = V_412 [ 0 ] ;
V_7 -> V_332 = V_412 [ 0 ] - V_44 ;
V_7 -> V_333 = V_7 -> V_332 ;
V_7 -> V_330 =
F_180 ( V_10 , 0 , L_46 , 0 , V_412 [ 0 ] ) ;
if ( ! V_7 -> V_330 )
return false ;
F_178 ( & V_6 -> V_4 ,
V_7 -> V_330 ,
...
F_181 ( V_441 , V_442 ) ;
if ( V_411 . V_443 ) {
if ( ! F_31 ( V_1 , V_444 , & V_44 , 2 ) )
return false ;
V_7 -> V_445 = 1 ;
V_7 -> V_446 = V_44 & 0x1 ;
V_7 -> V_443 =
F_180 ( V_10 , 0 , L_53 , 0 , 1 ) ;
if ( ! V_7 -> V_443 )
return false ;
F_178 ( & V_6 -> V_4 ,
V_7 -> V_443 ,
...
if ( F_127 ( V_7 ) )
return F_179 ( V_1 , V_7 , V_411 . V_305 ) ;
else if ( F_128 ( V_7 ) )
return F_182 ( V_1 , V_7 , V_411 . V_305 ) ;
else
return true ;
}
static int F_183 ( struct V_448 * V_449 ,
struct V_23 * V_24 ,
int V_450 )
{
struct V_1 * V_281 = V_449 -> V_451 ;
if ( ! F_29 ( V_281 , V_281 -> V_56 ) )
return - V_343 ;
return V_281 -> V_31 -> V_452 -> V_453 ( V_281 -> V_31 , V_24 , V_450 ) ;
}
static T_1 F_184 ( struct V_448 * V_449 )
{
struct V_1 * V_281 = V_449 -> V_451 ;
return V_281 -> V_31 -> V_452 -> V_454 ( V_281 -> V_31 ) ;
}
static bool
F_185 ( struct V_1 * V_281 ,
struct V_9 * V_10 )
{
V_281 -> V_282 . V_455 = V_456 ;
V_281 -> V_282 . V_457 = V_458 ;
snprintf ( V_281 -> V_282 . V_37 , V_459 , L_56 ) ;
V_281 -> V_282 . V_10 . V_460 = & V_10 -> V_461 -> V_10 ;
V_281 -> V_282 . V_451 = V_281 ;
V_281 -> V_282 . V_452 = & V_462 ;
return F_186 ( & V_281 -> V_282 ) == 0 ;
}
bool F_187 ( struct V_9 * V_10 , T_7 V_17 , bool V_357 )
{
struct V_11 * V_12 = V_10 -> V_13 ;
struct V_2 * V_2 ;
struct V_1 * V_1 ;
...
V_2 = & V_1 -> V_4 ;
V_2 -> type = V_464 ;
F_188 ( V_10 , & V_2 -> V_4 , & V_465 , 0 ) ;
for ( V_16 = 0 ; V_16 < 0x40 ; V_16 ++ ) {
T_2 V_466 ;
if ( ! F_12 ( V_1 , V_16 , & V_466 ) ) {
F_14 ( L_57 ,
F_20 ( V_1 ) ) ;
goto V_393;
}
