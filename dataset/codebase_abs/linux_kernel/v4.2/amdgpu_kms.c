...
( ( V_8 & V_14 ) == 0 ) )
V_8 |= V_15 ;
V_9 = F_9 ( V_4 , V_2 , V_2 -> V_16 , V_8 ) ;
if ( V_9 ) {
F_10 ( & V_2 -> V_16 -> V_2 , L_1 ) ;
goto V_17;
}
if ( ! V_9 ) {
V_10 = F_11 ( V_4 ) ;
...
static int F_20 ( struct V_1 * V_2 , void * V_18 , struct V_19 * V_20 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
...
return F_21 ( V_17 , & V_50 ,
F_22 ( ( V_89 ) V_27 , sizeof( V_50 ) ) ) ? - V_39 : 0 ;
}
case V_90 : {
enum V_51 type ;
T_2 V_91 = 0 ;
...
V_91 < V_57 )
V_91 ++ ;
return F_21 ( V_17 , & V_91 , F_22 ( V_27 , 4u ) ) ? - V_39 : 0 ;
}
case V_92 :
V_32 = F_25 ( V_4 ) ;
return F_21 ( V_17 , & V_32 , F_22 ( V_27 , 8u ) ) ? - V_39 : 0 ;
case V_93 : {
struct V_94 V_95 ;
if ( V_22 -> V_96 . V_56 != 0 )
return - V_35 ;
...
return F_21 ( V_17 , & V_95 ,
F_22 ( ( V_89 ) V_27 , sizeof( V_95 ) ) ) ? - V_39 : 0 ;
}
case V_128 :
V_32 = F_26 ( & V_4 -> V_129 ) ;
return F_21 ( V_17 , & V_32 , F_22 ( V_27 , 8u ) ) ? - V_39 : 0 ;
...
return F_21 ( V_17 , & V_138 ,
F_22 ( ( V_89 ) V_27 , sizeof( V_138 ) ) ) ? - V_39 : 0 ;
}
case V_156 : {
struct V_157 V_158 ;
...
return F_21 ( V_17 , & V_158 ,
F_22 ( ( V_89 ) V_27 , sizeof( V_158 ) ) ) ? - V_39 : 0 ;
}
case V_166 : {
unsigned V_167 , V_168 = V_22 -> V_169 . V_91 * 4 ;
T_2 * V_170 ;
unsigned V_171 = ( V_22 -> V_169 . V_172 >>
V_173 ) &
V_174 ;
unsigned V_175 = ( V_22 -> V_169 . V_172 >>
V_176 ) &
V_177 ;
if ( V_171 == V_174 )
V_171 = 0xffffffff ;
if ( V_175 == V_177 )
V_175 = 0xffffffff ;
V_170 = F_27 ( V_168 , V_11 ) ;
if ( ! V_170 )
return - V_12 ;
for ( V_33 = 0 ; V_33 < V_22 -> V_169 . V_91 ; V_33 ++ )
if ( F_28 ( V_4 , V_171 , V_175 ,
V_22 -> V_169 . V_178 + V_33 ,
& V_170 [ V_33 ] ) ) {
F_24 ( L_4 ,
V_22 -> V_169 . V_178 + V_33 ) ;
F_6 ( V_170 ) ;
...
V_167 = F_21 ( V_17 , V_170 , F_22 ( V_27 , V_168 ) ) ;
F_6 ( V_170 ) ;
return V_167 ? - V_39 : 0 ;
}
case V_179 : {
...
V_181 . V_223 = F_30 ( V_224 , 0x10000UL ) ;
V_181 . V_225 = ( 1 << V_226 ) *
V_64 ;
V_181 . V_227 = V_64 ;
F_31 ( V_4 , & V_183 ) ;
...
return F_21 ( V_17 , & V_181 ,
F_22 ( ( V_89 ) V_27 , sizeof( V_181 ) ) ) ? - V_39 : 0 ;
}
default:
F_24 ( L_5 , V_22 -> V_36 ) ;
return - V_35 ;
...
int F_34 ( struct V_1 * V_2 , struct V_19 * V_240 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
struct V_241 * V_242 ;
int V_9 ;
...
if ( V_9 < 0 )
return V_9 ;
V_242 = F_8 ( sizeof( * V_242 ) , V_11 ) ;
if ( F_35 ( ! V_242 ) )
return - V_12 ;
V_9 = F_36 ( V_4 , & V_242 -> V_244 ) ;
if ( V_9 )
goto V_245;
F_37 ( & V_242 -> V_246 ) ;
F_38 ( & V_242 -> V_247 ) ;
F_37 ( & V_242 -> V_248 . V_249 ) ;
F_38 ( & V_242 -> V_248 . V_250 ) ;
V_242 -> V_248 . V_4 = V_4 ;
V_240 -> V_243 = V_242 ;
F_18 ( V_2 -> V_2 ) ;
F_19 ( V_2 -> V_2 ) ;
...
if ( ! V_242 )
return;
F_40 ( V_4 , & V_242 -> V_244 ) ;
F_41 (&fpriv->bo_list_handles, list, handle)
F_42 ( V_252 ) ;
F_43 ( & V_242 -> V_247 ) ;
F_44 ( & V_242 -> V_246 ) ;
F_45 ( V_242 ) ;
...
T_4 F_49 ( struct V_1 * V_2 , int V_30 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
...
return F_51 ( V_4 , V_30 ) ;
}
int F_52 ( struct V_1 * V_2 , int V_30 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
int V_254 = F_53 ( V_4 , V_30 ) ;
return F_54 ( V_4 , & V_4 -> V_255 , V_254 ) ;
}
void F_55 ( struct V_1 * V_2 , int V_30 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
int V_254 = F_53 ( V_4 , V_30 ) ;
F_56 ( V_4 , & V_4 -> V_255 , V_254 ) ;
}
int F_57 ( struct V_1 * V_2 , int V_30 ,
int * V_256 ,
struct V_257 * V_258 ,
unsigned V_8 )
{
struct V_29 * V_259 ;
struct V_3 * V_4 = V_2 -> V_5 ;
if ( V_30 < 0 || V_30 >= V_2 -> V_260 ) {
F_50 ( L_6 , V_30 ) ;
return - V_35 ;
}
V_259 = & V_4 -> V_25 . V_42 [ V_30 ] -> V_43 ;
return F_58 ( V_2 , V_30 , V_256 ,
V_258 , V_8 ,
V_259 , & V_259 -> V_261 ) ;
}
