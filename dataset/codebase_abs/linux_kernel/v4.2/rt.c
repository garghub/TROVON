...
static int F_90 ( struct V_22 * V_22 )
{
struct V_4 * V_5 = F_87 ( V_22 ) ;
struct V_84 * V_66 = F_27 ( V_22 ) -> V_66 ;
int V_25 , V_85 , V_86 = 0 ;
T_1 V_10 ;
V_85 = F_91 ( V_66 -> V_82 ) ;
F_3 ( & V_5 -> V_9 ) ;
V_10 = F_37 ( V_5 -> V_10 ) ;
F_92 (i, rd->span) {
struct V_22 * V_87 = F_86 ( V_5 , V_25 ) ;
T_2 V_88 ;
if ( V_87 == V_22 )
continue;
F_3 ( & V_87 -> V_9 ) ;
...
static int F_100 ( struct V_22 * V_22 )
{
int V_86 = 0 ;
if ( ! F_101 ( V_92 ) )
return V_86 ;
...
static inline int F_100 ( struct V_22 * V_22 )
{
return 0 ;
}
...
if ( V_33 -> V_98 != & V_99 )
return;
V_97 = F_110 ( V_51 ) - V_33 -> V_100 . V_101 ;
if ( F_95 ( ( T_2 ) V_97 <= 0 ) )
return;
F_111 ( V_33 -> V_100 . V_102 . V_103 ,
F_112 ( V_33 -> V_100 . V_102 . V_103 , V_97 ) ) ;
V_33 -> V_100 . V_104 += V_97 ;
F_113 ( V_33 , V_97 ) ;
V_33 -> V_100 . V_101 = F_110 ( V_51 ) ;
F_114 ( V_33 , V_97 ) ;
F_115 ( V_51 , V_97 ) ;
if ( ! F_12 () )
return;
...
static void
F_119 ( struct V_22 * V_22 , int V_65 , int V_106 )
{
struct V_51 * V_51 = F_27 ( V_22 ) ;
#ifdef F_102
if ( & V_51 -> V_50 != V_22 )
...
F_120 ( & V_51 -> V_66 -> V_107 , V_51 -> V_54 , V_65 ) ;
}
static void
F_121 ( struct V_22 * V_22 , int V_65 , int V_106 )
{
struct V_51 * V_51 = F_27 ( V_22 ) ;
#ifdef F_102
if ( & V_51 -> V_50 != V_22 )
...
F_120 ( & V_51 -> V_66 -> V_107 , V_51 -> V_54 , V_22 -> V_32 . V_33 ) ;
}
static inline
void F_119 ( struct V_22 * V_22 , int V_65 , int V_106 ) {}
static inline
void F_121 ( struct V_22 * V_22 , int V_65 , int V_106 ) {}
static void
...
static inline
void F_129 ( struct V_48 * V_49 , struct V_22 * V_22 )
{
int V_65 = F_105 ( V_49 ) ;
F_124 ( ! F_130 ( V_65 ) ) ;
V_22 -> V_79 += F_128 ( V_49 ) ;
F_122 ( V_22 , V_65 ) ;
F_52 ( V_49 , V_22 ) ;
F_126 ( V_49 , V_22 ) ;
}
...
{
F_124 ( ! F_130 ( F_105 ( V_49 ) ) ) ;
F_124 ( ! V_22 -> V_79 ) ;
V_22 -> V_79 -= F_128 ( V_49 ) ;
F_123 ( V_22 , F_105 ( V_49 ) ) ;
F_53 ( V_49 , V_22 ) ;
F_127 ( V_49 , V_22 ) ;
}
static void F_132 ( struct V_48 * V_49 , bool V_109 )
{
struct V_22 * V_22 = F_28 ( V_49 ) ;
struct V_23 * V_24 = & V_22 -> V_26 ;
struct V_22 * V_108 = F_74 ( V_49 ) ;
struct V_110 * V_28 = V_24 -> V_28 + F_105 ( V_49 ) ;
if ( V_108 && ( F_83 ( V_108 ) || ! V_108 -> V_79 ) )
return;
if ( V_109 )
F_133 ( & V_49 -> V_58 , V_28 ) ;
else
F_134 ( & V_49 -> V_58 , V_28 ) ;
F_17 ( F_105 ( V_49 ) , V_24 -> V_29 ) ;
F_129 ( V_49 , V_22 ) ;
}
static void F_135 ( struct V_48 * V_49 )
{
struct V_22 * V_22 = F_28 ( V_49 ) ;
struct V_23 * V_24 = & V_22 -> V_26 ;
F_136 ( & V_49 -> V_58 ) ;
if ( F_67 ( V_24 -> V_28 + F_105 ( V_49 ) ) )
F_16 ( F_105 ( V_49 ) , V_24 -> V_29 ) ;
F_131 ( V_49 , V_22 ) ;
}
static void F_137 ( struct V_48 * V_49 )
{
struct V_48 * V_111 = NULL ;
F_116 (rt_se) {
V_49 -> V_111 = V_111 ;
V_111 = V_49 ;
}
F_81 ( F_28 ( V_111 ) ) ;
for ( V_49 = V_111 ; V_49 ; V_49 = V_49 -> V_111 ) {
if ( F_66 ( V_49 ) )
F_135 ( V_49 ) ;
}
}
static void F_78 ( struct V_48 * V_49 , bool V_109 )
{
struct V_51 * V_51 = F_29 ( V_49 ) ;
F_137 ( V_49 ) ;
F_116 (rt_se)
...
static void
F_138 ( struct V_51 * V_51 , struct V_47 * V_63 , int V_112 )
{
struct V_48 * V_49 = & V_63 -> V_50 ;
if ( V_112 & V_113 )
V_49 -> V_114 = 0 ;
F_78 ( V_49 , V_112 & V_115 ) ;
if ( ! F_139 ( V_51 , V_63 ) && V_63 -> V_71 > 1 )
F_60 ( V_51 , V_63 ) ;
}
static void F_140 ( struct V_51 * V_51 , struct V_47 * V_63 , int V_112 )
{
struct V_48 * V_49 = & V_63 -> V_50 ;
F_109 ( V_51 ) ;
F_82 ( V_49 ) ;
...
static void
F_141 ( struct V_22 * V_22 , struct V_48 * V_49 , int V_109 )
{
if ( F_66 ( V_49 ) ) {
struct V_23 * V_24 = & V_22 -> V_26 ;
struct V_110 * V_28 = V_24 -> V_28 + F_105 ( V_49 ) ;
...
F_143 ( & V_49 -> V_58 , V_28 ) ;
}
}
static void F_144 ( struct V_51 * V_51 , struct V_47 * V_63 , int V_109 )
{
struct V_48 * V_49 = & V_63 -> V_50 ;
struct V_22 * V_22 ;
F_116 (rt_se) {
V_22 = F_28 ( V_49 ) ;
F_141 ( V_22 , V_49 , V_109 ) ;
}
}
static void F_145 ( struct V_51 * V_51 )
{
F_144 ( V_51 , V_51 -> V_33 , 0 ) ;
}
static int
F_146 ( struct V_47 * V_63 , int V_54 , int V_116 , int V_112 )
{
struct V_47 * V_33 ;
struct V_51 * V_51 ;
...
V_51 = F_34 ( V_54 ) ;
F_147 () ;
V_33 = F_148 ( V_51 -> V_33 ) ;
if ( V_33 && F_95 ( F_149 ( V_33 ) ) &&
( V_33 -> V_71 < 2 ||
V_33 -> V_65 <= V_63 -> V_65 ) ) {
int V_120 = F_150 ( V_63 ) ;
if ( V_120 != - 1 &&
V_63 -> V_65 < F_34 ( V_120 ) -> V_50 . V_32 . V_33 )
V_54 = V_120 ;
}
F_151 () ;
V_119:
...
static void F_152 ( struct V_51 * V_51 , struct V_47 * V_63 )
{
if ( V_51 -> V_33 -> V_71 == 1 ||
! F_153 ( & V_51 -> V_66 -> V_107 , V_51 -> V_33 , NULL ) )
return;
if ( V_63 -> V_71 != 1
&& F_153 ( & V_51 -> V_66 -> V_107 , V_63 , NULL ) )
return;
F_144 ( V_51 , V_63 , 1 ) ;
F_79 ( V_51 ) ;
}
static void F_154 ( struct V_51 * V_51 , struct V_47 * V_63 , int V_112 )
{
...
#ifdef V_31
if ( V_63 -> V_65 == V_51 -> V_33 -> V_65 && ! F_155 ( V_51 -> V_33 ) )
F_152 ( V_51 , V_63 ) ;
#endif
}
static struct V_48 * F_156 ( struct V_51 * V_51 ,
struct V_22 * V_22 )
{
struct V_23 * V_24 = & V_22 -> V_26 ;
...
struct V_110 * V_28 ;
int V_121 ;
V_121 = F_125 ( V_24 -> V_29 ) ;
F_98 ( V_121 >= V_27 ) ;
V_28 = V_24 -> V_28 + V_121 ;
V_34 = F_157 ( V_28 -> V_34 , struct V_48 , V_58 ) ;
return V_34 ;
}
static struct V_47 * F_158 ( struct V_51 * V_51 )
{
struct V_48 * V_49 ;
struct V_47 * V_63 ;
struct V_22 * V_22 = & V_51 -> V_50 ;
do {
V_49 = F_156 ( V_51 , V_22 ) ;
F_98 ( ! V_49 ) ;
V_22 = F_74 ( V_49 ) ;
} while ( V_22 );
V_63 = F_23 ( V_49 ) ;
V_63 -> V_100 . V_101 = F_110 ( V_51 ) ;
return V_63 ;
}
static struct V_47 *
F_159 ( struct V_51 * V_51 , struct V_47 * V_64 )
{
struct V_47 * V_63 ;
struct V_22 * V_22 = & V_51 -> V_50 ;
if ( F_41 ( V_51 , V_64 ) ) {
...
V_75 ( V_51 ) ;
F_161 ( & V_51 -> V_96 ) ;
if ( F_95 ( ( V_51 -> V_122 && F_162 ( V_51 -> V_122 ) ) ||
V_51 -> V_123 . V_124 ) )
return V_125 ;
}
if ( V_64 -> V_98 == & V_99 )
...
static void F_164 ( struct V_51 * V_51 , struct V_47 * V_63 )
{
F_109 ( V_51 ) ;
if ( F_66 ( & V_63 -> V_50 ) && V_63 -> V_71 > 1 )
F_60 ( V_51 , V_63 ) ;
}
static int F_165 ( struct V_51 * V_51 , struct V_47 * V_63 , int V_54 )
{
if ( ! F_166 ( V_51 , V_63 ) &&
F_167 ( V_54 , F_168 ( V_63 ) ) )
return 1 ;
return 0 ;
}
static struct V_47 * F_169 ( struct V_51 * V_51 , int V_54 )
{
struct V_126 * V_109 = & V_51 -> V_50 . V_37 ;
struct V_47 * V_63 ;
if ( ! F_54 ( V_51 ) )
return NULL ;
F_170 (p, head, pushable_tasks) {
if ( F_165 ( V_51 , V_63 , V_54 ) )
return V_63 ;
}
return NULL ;
}
static int F_150 ( struct V_47 * V_127 )
{
struct V_128 * V_129 ;
struct V_81 * V_130 = F_171 ( V_131 ) ;
int V_132 = F_172 () ;
int V_54 = F_173 ( V_127 ) ;
if ( F_95 ( ! V_130 ) )
return - 1 ;
if ( V_127 -> V_71 == 1 )
return - 1 ;
if ( ! F_153 ( & F_40 ( V_127 ) -> V_66 -> V_107 , V_127 , V_130 ) )
return - 1 ;
if ( F_167 ( V_54 , V_130 ) )
return V_54 ;
if ( ! F_167 ( V_132 , V_130 ) )
V_132 = - 1 ;
F_147 () ;
F_174 (cpu, sd) {
if ( V_129 -> V_112 & V_133 ) {
int V_134 ;
if ( V_132 != - 1 &&
F_167 ( V_132 , F_175 ( V_129 ) ) ) {
F_151 () ;
return V_132 ;
}
V_134 = F_176 ( V_130 ,
...
static struct V_51 * F_178 ( struct V_47 * V_127 , struct V_51 * V_51 )
{
struct V_51 * V_135 = NULL ;
int V_136 ;
int V_54 ;
...
break;
V_135 = F_34 ( V_54 ) ;
if ( V_135 -> V_50 . V_32 . V_33 <= V_127 -> V_65 ) {
V_135 = NULL ;
break;
}
if ( F_179 ( V_51 , V_135 ) ) {
if ( F_95 ( F_40 ( V_127 ) != V_51 ||
! F_167 ( V_135 -> V_54 ,
F_168 ( V_127 ) ) ||
F_166 ( V_51 , V_127 ) ||
! F_162 ( V_127 ) ) ) {
...
static struct V_47 * F_181 ( struct V_51 * V_51 )
{
struct V_47 * V_63 ;
if ( ! F_54 ( V_51 ) )
return NULL ;
V_63 = F_65 ( & V_51 -> V_50 . V_37 ,
struct V_47 , V_37 ) ;
F_98 ( V_51 -> V_54 != F_173 ( V_63 ) ) ;
F_98 ( F_139 ( V_51 , V_63 ) ) ;
F_98 ( V_63 -> V_71 <= 1 ) ;
F_98 ( ! F_162 ( V_63 ) ) ;
F_98 ( ! F_149 ( V_63 ) ) ;
return V_63 ;
}
static int F_182 ( struct V_51 * V_51 )
{
struct V_47 * V_138 ;
struct V_51 * V_135 ;
int V_139 = 0 ;
...
return 0 ;
V_140:
if ( F_95 ( V_138 == V_51 -> V_33 ) ) {
F_124 ( 1 ) ;
return 0 ;
}
if ( F_95 ( V_138 -> V_65 < V_51 -> V_33 -> V_65 ) ) {
F_79 ( V_51 ) ;
return 0 ;
}
F_183 ( V_138 ) ;
V_135 = F_178 ( V_138 , V_51 ) ;
if ( ! V_135 ) {
struct V_47 * V_127 ;
V_127 = F_181 ( V_51 ) ;
if ( F_173 ( V_138 ) == V_51 -> V_54 && V_127 == V_138 ) {
goto V_119;
}
if ( ! V_127 )
goto V_119;
...
{
int V_141 = V_51 -> V_50 . V_39 ;
int V_54 ;
V_54 = F_189 ( V_141 , V_51 -> V_66 -> V_69 ) ;
if ( V_141 < V_51 -> V_54 ) {
if ( V_54 >= V_51 -> V_54 )
return V_40 ;
} else if ( V_54 >= V_40 ) {
V_54 = F_190 ( V_51 -> V_66 -> V_69 ) ;
if ( V_54 >= V_51 -> V_54 )
return V_40 ;
}
V_51 -> V_50 . V_39 = V_54 ;
...
break;
V_142 = F_34 ( V_54 ) ;
if ( V_142 -> V_50 . V_32 . V_34 < V_51 -> V_50 . V_32 . V_33 )
break;
}
return V_54 ;
}
static void F_192 ( struct V_51 * V_51 )
{
int V_54 ;
if ( V_51 -> V_50 . V_38 & V_143 ) {
F_3 ( & V_51 -> V_50 . V_41 ) ;
if ( V_51 -> V_50 . V_38 & V_143 ) {
V_51 -> V_50 . V_38 |= V_144 ;
F_5 ( & V_51 -> V_50 . V_41 ) ;
return;
}
F_5 ( & V_51 -> V_50 . V_41 ) ;
...
if ( V_54 >= V_40 )
return;
V_51 -> V_50 . V_38 = V_143 ;
F_193 ( & V_51 -> V_50 . V_42 , V_54 ) ;
}
static void F_194 ( void * V_145 )
{
struct V_22 * V_22 = V_145 ;
...
goto V_147;
F_193 ( & V_22 -> V_42 , V_54 ) ;
}
static void V_43 ( struct V_148 * V_149 )
{
struct V_22 * V_22 = F_2 ( V_149 , struct V_22 , V_42 ) ;
F_194 ( V_22 ) ;
}
static void V_75 ( struct V_51 * V_76 )
{
int V_132 = V_76 -> V_54 , V_54 ;
bool V_150 = false ;
struct V_47 * V_63 ;
struct V_51 * V_146 ;
if ( F_107 ( ! F_42 ( V_76 ) ) )
...
continue;
V_146 = F_34 ( V_54 ) ;
if ( V_146 -> V_50 . V_32 . V_34 >=
V_76 -> V_50 . V_32 . V_33 )
continue;
F_179 ( V_76 , V_146 ) ;
V_63 = F_169 ( V_146 , V_132 ) ;
if ( V_63 && ( V_63 -> V_65 < V_76 -> V_50 . V_32 . V_33 ) ) {
F_124 ( V_63 == V_146 -> V_33 ) ;
F_124 ( ! F_162 ( V_63 ) ) ;
if ( V_63 -> V_65 < V_146 -> V_33 -> V_65 )
goto V_152;
V_150 = true ;
F_185 ( V_146 , V_63 , 0 ) ;
F_186 ( V_63 , V_132 ) ;
...
static void F_196 ( struct V_51 * V_51 , struct V_47 * V_63 )
{
if ( ! F_166 ( V_51 , V_63 ) &&
! F_155 ( V_51 -> V_33 ) &&
F_54 ( V_51 ) &&
V_63 -> V_71 > 1 &&
( F_197 ( V_51 -> V_33 ) || F_149 ( V_51 -> V_33 ) ) &&
( V_51 -> V_33 -> V_71 < 2 ||
V_51 -> V_33 -> V_65 <= V_63 -> V_65 ) )
V_73 ( V_51 ) ;
}
static void F_198 ( struct V_47 * V_63 ,
const struct V_81 * V_153 )
{
struct V_51 * V_51 ;
int V_85 ;
F_98 ( ! F_149 ( V_63 ) ) ;
...
static void F_199 ( struct V_51 * V_51 )
{
if ( V_51 -> V_50 . V_36 )
F_44 ( V_51 ) ;
F_99 ( V_51 ) ;
F_120 ( & V_51 -> V_66 -> V_107 , V_51 -> V_54 , V_51 -> V_50 . V_32 . V_33 ) ;
}
static void F_200 ( struct V_51 * V_51 )
{
if ( V_51 -> V_50 . V_36 )
F_48 ( V_51 ) ;
F_94 ( V_51 ) ;
F_120 ( & V_51 -> V_66 -> V_107 , V_51 -> V_54 , V_154 ) ;
}
static void F_201 ( struct V_51 * V_51 , struct V_47 * V_63 )
{
if ( ! F_162 ( V_63 ) || V_51 -> V_50 . V_79 )
return;
F_59 ( V_51 ) ;
}
void T_4 F_202 ( void )
...
unsigned int V_25 ;
F_31 (i) {
F_203 ( & F_58 ( V_131 , V_25 ) ,
V_59 , F_39 ( V_25 ) ) ;
}
}
static void F_204 ( struct V_51 * V_51 , struct V_47 * V_63 )
{
if ( F_162 ( V_63 ) && V_51 -> V_33 != V_63 ) {
#ifdef V_31
...
static void
F_205 ( struct V_51 * V_51 , struct V_47 * V_63 , int V_155 )
{
if ( ! F_162 ( V_63 ) )
return;
if ( V_51 -> V_33 == V_63 ) {
...
V_156 = F_207 ( V_63 , V_158 ) ;
V_157 = F_208 ( V_63 , V_158 ) ;
if ( V_156 != V_159 ) {
unsigned long V_34 ;
if ( V_63 -> V_50 . V_160 != V_161 ) {
V_63 -> V_50 . V_114 ++ ;
V_63 -> V_50 . V_160 = V_161 ;
}
V_34 = F_209 ( F_103 ( V_156 , V_157 ) , V_162 / V_163 ) ;
if ( V_63 -> V_50 . V_114 > V_34 )
V_63 -> V_164 . V_165 = V_63 -> V_100 . V_104 ;
}
}
static void F_210 ( struct V_51 * V_51 , struct V_47 * V_63 , int V_166 )
{
struct V_48 * V_49 = & V_63 -> V_50 ;
F_109 ( V_51 ) ;
F_206 ( V_51 , V_63 ) ;
...
static void F_211 ( struct V_51 * V_51 )
{
struct V_47 * V_63 = V_51 -> V_33 ;
V_63 -> V_100 . V_101 = F_110 ( V_51 ) ;
F_64 ( V_51 , V_63 ) ;
}
static unsigned int F_212 ( struct V_51 * V_51 , struct V_47 * V_127 )
{
...
void F_213 ( struct V_171 * V_172 , int V_54 )
{
T_3 V_87 ;
struct V_22 * V_22 ;
F_147 () ;
F_96 (rt_rq, iter, cpu_rq(cpu))
F_214 ( V_172 , V_54 , V_22 ) ;
F_151 () ;
}
