...
static int F_59 ( struct V_3 * V_4 , int V_13 )
{
...
if ( V_12 == 0 )
F_11 ( V_77 , L_25 V_34 L_6 ,
V_13 , F_12 ( & V_4 -> V_35 . V_36 ) ) ;
return V_12 ;
}
static int F_61 ( const struct V_1 * V_2 , struct V_3 * V_4 ,
struct V_72 * V_11 , void * V_98 )
{
struct V_10 * V_101 = (struct V_10 * ) V_11 ;
struct V_3 * V_5 ;
