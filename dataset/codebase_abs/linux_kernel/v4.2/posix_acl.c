...
static int
F_65 ( struct V_97 * V_97 , const char * V_98 ,
const void * V_77 , T_2 V_19 , int V_18 , int type )
{
struct V_2 * V_2 = F_63 ( V_97 ) ;
struct V_1 * V_8 = NULL ;
int V_65 ;
if ( ! F_16 ( V_2 ) )
return - V_67 ;
...
static T_2
F_67 ( struct V_97 * V_97 , char * V_103 , T_2 V_104 ,
const char * V_98 , T_2 V_105 , int type )
{
const char * V_106 ;
T_2 V_19 ;
if ( ! F_16 ( F_63 ( V_97 ) ) )
