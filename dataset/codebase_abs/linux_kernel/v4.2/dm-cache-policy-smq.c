...
static void F_107 ( struct V_73 * V_74 )
{
unsigned long V_141 , V_142 ;
F_108 ( & V_74 -> V_143 , V_141 ) ;
V_142 = V_74 -> V_144 ;
if ( V_142 != V_74 -> V_142 ) {
F_71 ( V_74 ) ;
F_88 ( V_74 ) ;
...
F_109 ( & V_74 -> V_143 , V_141 ) ;
}
static bool F_110 ( struct V_73 * V_74 , bool V_145 )
{
if ( V_145 ) {
F_111 ( & V_74 -> V_146 ) ;
return true ;
} else
return F_112 ( & V_74 -> V_146 ) ;
}
static int F_113 ( struct V_138 * V_139 , T_1 V_65 ,
bool V_145 , bool V_135 , bool V_116 ,
...
static int F_115 ( struct V_138 * V_139 , T_1 V_65 , T_2 * V_128 )
{
int V_122 ;
struct V_73 * V_74 = F_102 ( V_139 ) ;
struct V_8 * V_11 ;
...
static void F_116 ( struct V_73 * V_74 , T_1 V_65 , bool V_148 )
{
struct V_8 * V_11 ;
V_11 = F_56 ( & V_74 -> V_86 , V_65 ) ;
F_8 ( ! V_11 ) ;
...
static void F_117 ( struct V_138 * V_139 , T_1 V_65 )
{
struct V_73 * V_74 = F_102 ( V_139 ) ;
F_111 ( & V_74 -> V_146 ) ;
F_116 ( V_74 , V_65 , true ) ;
F_114 ( & V_74 -> V_146 ) ;
}
...
struct V_73 * V_74 = F_102 ( V_139 ) ;
F_111 ( & V_74 -> V_146 ) ;
F_116 ( V_74 , V_65 , false ) ;
F_114 ( & V_74 -> V_146 ) ;
}
static int F_119 ( struct V_138 * V_139 ,
T_1 V_65 , T_2 V_128 ,
T_4 V_149 , bool V_150 )
{
struct V_73 * V_74 = F_102 ( V_139 ) ;
struct V_8 * V_11 ;
...
V_11 -> V_65 = V_65 ;
V_11 -> V_79 = false ;
V_11 -> V_31 = V_150 ? F_28 ( V_149 , V_72 - 1 ) : 1 ;
F_76 ( V_74 , V_11 ) ;
return 0 ;
}
static int F_120 ( struct V_73 * V_74 , struct V_22 * V_23 ,
T_5 V_108 , void * V_151 )
{
int V_122 ;
unsigned V_31 ;
struct V_8 * V_11 ;
...
for ( V_11 = F_12 ( V_23 -> V_4 , V_23 -> V_26 + V_31 ) ; V_11 ; V_11 = F_14 ( V_23 -> V_4 , V_11 ) ) {
if ( ! V_11 -> V_20 ) {
V_122 = V_108 ( V_151 , F_80 ( V_74 , V_11 ) ,
V_11 -> V_65 , V_11 -> V_31 ) ;
if ( V_122 )
return V_122 ;
}
...
static int F_121 ( struct V_138 * V_139 , T_5 V_108 ,
void * V_151 )
{
struct V_73 * V_74 = F_102 ( V_139 ) ;
int V_122 = 0 ;
F_111 ( & V_74 -> V_146 ) ;
V_122 = F_120 ( V_74 , & V_74 -> V_80 , V_108 , V_151 ) ;
if ( ! V_122 )
V_122 = F_120 ( V_74 , & V_74 -> V_79 , V_108 , V_151 ) ;
F_114 ( & V_74 -> V_146 ) ;
return V_122 ;
}
static void F_122 ( struct V_73 * V_74 , T_1 V_65 )
{
struct V_8 * V_11 ;
V_11 = F_56 ( & V_74 -> V_86 , V_65 ) ;
F_8 ( ! V_11 ) ;
...
static void F_123 ( struct V_138 * V_139 , T_1 V_65 )
{
struct V_73 * V_74 = F_102 ( V_139 ) ;
F_111 ( & V_74 -> V_146 ) ;
F_122 ( V_74 , V_65 ) ;
...
static int F_124 ( struct V_73 * V_74 , T_2 V_128 )
{
...
static int F_125 ( struct V_138 * V_139 , T_2 V_128 )
{
int V_122 ;
struct V_73 * V_74 = F_102 ( V_139 ) ;
F_111 ( & V_74 -> V_146 ) ;
V_122 = F_124 ( V_74 , V_128 ) ;
F_114 ( & V_74 -> V_146 ) ;
return V_122 ;
}
static bool F_126 ( struct V_73 * V_74 , bool V_153 )
{
if ( V_153 ) {
unsigned V_154 = F_84 ( V_74 -> V_102 ) - F_23 ( & V_74 -> V_79 ) ;
unsigned V_38 = F_84 ( V_74 -> V_102 ) * V_155 / 100u ;
return V_154 >= V_38 ;
} else
return ! F_23 ( & V_74 -> V_79 ) ;
}
static int F_127 ( struct V_73 * V_74 , T_1 * V_65 ,
T_2 * V_128 , bool V_156 )
{
struct V_8 * V_11 = NULL ;
bool V_157 = F_126 ( V_74 , V_156 ) ;
if ( V_156 )
V_11 = F_79 ( V_74 , & V_74 -> V_79 , V_157 ? 1u : V_74 -> V_79 . V_24 ) ;
else
...
static int F_128 ( struct V_138 * V_139 , T_1 * V_65 ,
T_2 * V_128 , bool V_156 )
{
int V_122 ;
struct V_73 * V_74 = F_102 ( V_139 ) ;
F_111 ( & V_74 -> V_146 ) ;
V_122 = F_127 ( V_74 , V_65 , V_128 , V_156 ) ;
F_114 ( & V_74 -> V_146 ) ;
return V_122 ;
}
...
T_1 V_158 , T_1 V_159 )
{
struct V_8 * V_11 = F_56 ( & V_74 -> V_86 , V_158 ) ;
if ( V_11 ) {
F_78 ( V_74 , V_11 ) ;
V_11 -> V_65 = V_159 ;
V_11 -> V_79 = true ;
...
static void F_130 ( struct V_138 * V_139 ,
T_1 V_158 , T_1 V_159 )
{
struct V_73 * V_74 = F_102 ( V_139 ) ;
F_111 ( & V_74 -> V_146 ) ;
F_129 ( V_74 , V_158 , V_159 ) ;
F_114 ( & V_74 -> V_146 ) ;
}
static T_2 F_131 ( struct V_138 * V_139 )
{
T_2 V_122 ;
struct V_73 * V_74 = F_102 ( V_139 ) ;
F_111 ( & V_74 -> V_146 ) ;
...
static void F_132 ( struct V_138 * V_139 , bool V_145 )
{
struct V_73 * V_74 = F_102 ( V_139 ) ;
unsigned long V_141 ;
F_108 ( & V_74 -> V_143 , V_141 ) ;
...
{
V_74 -> V_140 . V_160 = F_104 ;
V_74 -> V_140 . F_101 = F_113 ;
V_74 -> V_140 . V_161 = F_115 ;
V_74 -> V_140 . V_162 = F_117 ;
V_74 -> V_140 . V_163 = F_118 ;
V_74 -> V_140 . V_164 = F_119 ;
V_74 -> V_140 . V_165 = F_121 ;
V_74 -> V_140 . V_166 = F_123 ;
V_74 -> V_140 . V_167 = F_125 ;
V_74 -> V_140 . V_168 = F_128 ;
V_74 -> V_140 . V_169 = F_130 ;
V_74 -> V_140 . V_170 = F_131 ;
V_74 -> V_140 . V_142 = F_132 ;
}
static bool F_134 ( T_3 V_171 ,
T_3 V_172 ,
unsigned V_97 )
{
return ( V_172 * V_97 ) > V_171 ;
}
static void F_135 ( T_3 V_171 ,
T_3 V_173 ,
unsigned V_174 ,
T_3 * V_172 ,
unsigned * V_97 )
{
* V_172 = V_173 * 16u ;
* V_97 = F_44 ( V_174 / 4u , 1024u ) ;
while ( ( * V_172 > V_173 ) &&
F_134 ( V_171 , * V_172 , * V_97 ) )
* V_172 /= 2u ;
}
...
{
unsigned V_25 ;
unsigned V_175 = 2u * V_72 ;
unsigned V_176 = 2u * V_175 ;
struct V_73 * V_74 = F_137 ( sizeof( * V_74 ) , V_177 ) ;
if ( ! V_74 )
return NULL ;
F_133 ( V_74 ) ;
V_74 -> V_102 = V_102 ;
V_74 -> V_173 = V_173 ;
F_135 ( V_171 , V_173 , F_84 ( V_102 ) ,
& V_74 -> V_172 , & V_74 -> V_97 ) ;
V_74 -> V_130 = F_138 ( V_74 -> V_172 , V_74 -> V_173 ) ;
V_74 -> V_95 = 1u ;
if ( F_3 ( & V_74 -> V_4 , V_176 + V_74 -> V_97 + F_84 ( V_102 ) ) ) {
F_139 ( L_1 ) ;
goto V_178;
}
F_58 ( & V_74 -> V_75 , & V_74 -> V_4 , 0 , V_175 ) ;
for ( V_25 = 0 ; V_25 < V_175 ; V_25 ++ )
F_65 ( & V_74 -> V_75 , V_25 ) -> V_20 = true ;
F_58 ( & V_74 -> V_77 , & V_74 -> V_4 , V_175 , V_176 ) ;
for ( V_25 = 0 ; V_25 < V_175 ; V_25 ++ )
F_65 ( & V_74 -> V_77 , V_25 ) -> V_20 = true ;
F_58 ( & V_74 -> V_134 , & V_74 -> V_4 , V_176 ,
V_176 + V_74 -> V_97 ) ;
F_58 ( & V_74 -> V_87 , & V_74 -> V_4 ,
V_176 + V_74 -> V_97 ,
V_176 + V_74 -> V_97 + F_84 ( V_102 ) ) ;
