...
V_27:
V_18 = F_8 ( V_10 , V_11 , V_12 , V_15 , V_13 , V_14 , NULL , & V_4 ) ;
if ( V_18 ) {
if ( V_18 != - V_28 ) {
if ( V_13 == V_29 ) {
V_13 |= V_30 ;
...
int V_18 ;
F_15 ( & V_35 ) ;
V_106 . V_69 = & V_46 -> V_69 -> V_7 ;
V_106 . V_114 = true ;
F_61 ( & V_106 . V_115 , & V_35 ) ;
V_109 = F_62 ( V_10 , V_46 -> V_44 , & V_35 ) ;
if ( ! V_109 )
return;
V_18 = F_63 ( & V_111 , & V_35 , true , NULL ) ;
if ( V_18 )
goto V_116;
F_64 (entry, &list, head) {
V_113 = F_65 ( V_107 -> V_69 -> V_117 . V_118 ) ;
if ( V_113 == V_76 )
goto V_119;
}
F_11 ( & V_46 -> V_44 -> V_34 ) ;
...
goto V_65;
if ( V_104 == V_120 )
V_18 = F_67 ( V_10 , V_46 , & V_46 -> V_69 -> V_7 . V_117 ) ;
V_65:
F_13 ( & V_46 -> V_44 -> V_34 ) ;
V_119:
F_68 ( & V_111 , & V_35 ) ;
...
return - V_126 ;
if ( args -> V_127 < V_128 ) {
F_24 ( & V_48 -> V_129 -> V_48 ,
L_7 ,
( unsigned long ) args -> V_127 ,
V_128 ) ;
return - V_64 ;
}
V_122 = ~ ( V_130 | V_131 |
...
if ( args -> V_14 & V_133 )
V_123 |= V_137 ;
V_18 = F_71 ( V_10 , V_46 , args -> V_127 ,
args -> V_138 , args -> V_139 ,
V_123 ) ;
break;
case V_134 :
V_18 = F_72 ( V_10 , V_46 , args -> V_127 ) ;
break;
default:
break;
}
if ( ! V_18 && ! ( args -> V_14 & V_130 ) )
...
case V_141 : {
struct V_142 V_143 ;
void T_6 * V_67 = ( void T_6 * ) ( long ) args -> V_144 ;
V_143 . V_57 = V_4 -> V_5 . V_11 ;
V_143 . V_12 = V_4 -> V_7 . V_117 . V_145 << V_146 ;
V_143 . V_60 = V_4 -> V_13 ;
V_143 . V_66 = V_4 -> V_14 ;
if ( F_74 ( V_67 , & V_143 , sizeof( V_143 ) ) )
V_18 = - V_147 ;
break;
}
case V_148 :
...
T_4 V_58 ;
int V_18 ;
args -> V_150 = F_76 ( V_10 , args -> V_151 , args -> V_152 , 0 ) * ( ( args -> V_152 + 1 ) / 8 ) ;
args -> V_11 = args -> V_150 * args -> V_153 ;
...
static int F_78 ( struct V_155 * V_156 , void * V_52 )
{
struct V_157 * V_158 = (struct V_157 * ) V_156 -> V_159 ;
struct V_51 * V_48 = V_158 -> V_160 -> V_48 ;
struct V_9 * V_10 = V_48 -> V_54 ;
struct V_3 * V_39 ;
unsigned V_161 = 0 ;
F_11 ( & V_10 -> V_33 . V_34 ) ;
...
unsigned V_113 ;
const char * V_82 ;
V_113 = F_65 ( V_39 -> V_7 . V_117 . V_118 ) ;
switch ( V_113 ) {
case V_29 :
V_82 = L_10 ;
break;
...
F_79 ( V_156 , L_13 ,
V_161 , F_80 ( V_39 ) >> 10 , F_80 ( V_39 ) >> 20 ,
