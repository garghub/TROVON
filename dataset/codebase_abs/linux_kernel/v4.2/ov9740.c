...
static int F_19 ( struct V_22 * V_23 , struct V_90 * V_91 )
{
V_91 -> V_92 . V_93 = 0 ;
V_91 -> V_92 . V_94 = 0 ;
V_91 -> V_92 . V_33 = V_35 ;
...
static int F_20 ( struct V_22 * V_23 , struct V_100 * V_91 )
{
V_91 -> V_101 . V_93 = 0 ;
V_91 -> V_101 . V_94 = 0 ;
V_91 -> V_101 . V_33 = V_35 ;
V_91 -> V_101 . V_34 = V_36 ;
V_91 -> type = V_96 ;
return 0 ;
}
...
{
struct V_25 * V_26 =
F_22 ( V_103 -> V_104 , struct V_25 , V_105 ) ;
switch ( V_103 -> V_106 ) {
case V_107 :
V_26 -> V_27 = V_103 -> V_4 ;
break;
...
static int F_23 ( struct V_22 * V_23 , int V_109 )
{
struct V_1 * V_2 = F_9 ( V_23 ) ;
struct V_110 * V_111 = F_24 ( V_2 ) ;
struct V_25 * V_26 = F_10 ( V_23 ) ;
int V_5 ;
if ( V_109 ) {
V_5 = F_25 ( & V_2 -> V_14 , V_111 , V_26 -> V_112 ) ;
if ( V_5 < 0 )
return V_5 ;
if ( V_26 -> V_32 ) {
F_15 ( V_23 , & V_26 -> V_76 ) ;
...
F_26 ( & V_2 -> V_14 , V_111 , V_26 -> V_112 ) ;
}
return 0 ;
}
...
T_2 V_116 , V_117 ;
int V_5 ;
V_5 = F_23 ( & V_26 -> V_118 , 1 ) ;
if ( V_5 < 0 )
return V_5 ;
V_5 = F_1 ( V_2 , V_119 , & V_116 ) ;
if ( V_5 < 0 )
goto V_45;
V_5 = F_1 ( V_2 , V_120 , & V_117 ) ;
if ( V_5 < 0 )
goto V_45;
V_26 -> V_121 = ( V_116 << 8 ) | V_117 ;
V_5 = F_1 ( V_2 , V_122 , & V_26 -> V_123 ) ;
if ( V_5 < 0 )
goto V_45;
V_5 = F_1 ( V_2 , V_124 , & V_26 -> V_125 ) ;
if ( V_5 < 0 )
goto V_45;
V_5 = F_1 ( V_2 , V_126 , & V_26 -> V_127 ) ;
if ( V_5 < 0 )
goto V_45;
if ( V_26 -> V_121 != 0x9740 ) {
V_5 = - V_128 ;
goto V_45;
}
F_31 ( & V_2 -> V_14 , L_7
L_8 ,
V_26 -> V_121 , V_26 -> V_123 , V_26 -> V_125 , V_26 -> V_127 ) ;
V_5 = F_32 ( & V_26 -> V_105 ) ;
V_45:
F_23 ( & V_26 -> V_118 , 0 ) ;
return V_5 ;
...
struct V_1 * V_2 = F_9 ( V_23 ) ;
struct V_110 * V_111 = F_24 ( V_2 ) ;
V_78 -> V_9 = V_130 | V_131 |
V_132 | V_133 |
V_134 ;
V_78 -> type = V_135 ;
V_78 -> V_9 = F_34 ( V_111 , V_78 ) ;
return 0 ;
}
...
V_26 = F_36 ( & V_2 -> V_14 , sizeof( struct V_25 ) , V_138 ) ;
if ( ! V_26 ) {
F_4 ( & V_2 -> V_14 , L_10 ) ;
return - V_139 ;
}
F_37 ( & V_26 -> V_118 , V_2 , & V_140 ) ;
F_38 ( & V_26 -> V_105 , 13 ) ;
F_39 ( & V_26 -> V_105 , & V_141 ,
V_107 , 0 , 1 , 1 , 0 ) ;
F_39 ( & V_26 -> V_105 , & V_141 ,
V_108 , 0 , 1 , 1 , 0 ) ;
V_26 -> V_118 . V_142 = & V_26 -> V_105 ;
if ( V_26 -> V_105 . error )
return V_26 -> V_105 . error ;
V_26 -> V_112 = F_40 ( & V_2 -> V_14 , L_11 ) ;
if ( F_41 ( V_26 -> V_112 ) ) {
V_5 = F_42 ( V_26 -> V_112 ) ;
goto V_143;
}
