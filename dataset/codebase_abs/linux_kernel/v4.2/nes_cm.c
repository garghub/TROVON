...
T_1 * * V_19 = & V_18 ;
T_2 V_20 = 0 ;
struct V_142 * V_555 = (struct V_142 * ) & V_7 -> V_524 ;
struct V_142 * V_556 = (struct V_142 * ) & V_7 -> V_168 ;
V_374 = F_162 ( V_7 -> V_502 , V_539 -> V_557 ) ;
if ( ! V_374 )
return - V_43 ;
V_184 = F_163 ( V_374 ) ;
V_156 = F_156 ( V_184 -> V_374 . V_502 ) ;
...
if ( V_2 -> V_48 == V_46 ||
V_2 -> V_64 == V_62 ) {
F_40 ( V_2 , ( T_2 ) V_539 -> V_559 , ( T_2 ) V_539 -> V_560 ) ;
}
memcpy ( V_37 -> V_561 , V_539 -> V_423 ,
V_539 -> V_422 ) ;
F_10 ( V_2 , V_19 , & V_20 , V_184 -> V_532 , V_28 ) ;
V_184 -> V_422 = V_539 -> V_422 ;
V_186 = & V_184 -> V_187 . V_188 [ 0 ] ;
if ( V_556 -> V_146 . V_147 != V_555 -> V_146 . V_147 ) {
V_183 = ( unsigned long ) V_184 ;
V_159 = V_156 -> V_159 ;
V_552 = V_184 -> V_552 ;
V_550 . V_141 = V_184 -> V_536 + V_554 ;
V_550 . V_562 = V_20 ;
V_553 = ( T_7 ) ( unsigned long ) * V_19 ;
V_548 = V_159 -> V_160 . V_563 ( (struct V_564 * ) V_552 ,
& V_550 , 1 ,
V_565 ,
& V_553 ) ;
if ( ! V_548 ) {
...
V_548 -> V_566 = & V_552 -> V_567 ;
V_548 -> V_502 = V_552 -> V_567 . V_502 ;
V_184 -> V_533 = V_548 ;
V_183 |= V_190 >> 1 ;
F_44 ( V_186 -> V_191 ,
V_192 ,
...
V_184 -> V_207 -> V_571 [ 1 ] =
F_165 ( V_2 -> V_120 ) ;
V_184 -> V_207 -> V_572 = F_45 ( V_2 -> V_116 ) ;
V_184 -> V_207 -> V_461 |= F_45 (
( T_3 ) F_84 ( V_324 -> V_325 -> V_326 ) <<
V_573 ) ;
V_184 -> V_207 -> V_574 |=
F_45 ( F_98 ( V_324 ,
F_151 ( V_184 -> V_207 -> V_572 ) , NULL ,
V_357 ) << 16 ) ;
V_184 -> V_207 -> V_575 = F_45 (
V_224 - F_166 ( V_324 , V_576 ) ) ;
V_184 -> V_207 -> V_577 = F_45 ( V_184 -> V_187 . V_247 ) ;
...
V_545 . V_580 = F_23 ( V_2 -> V_116 ) ;
V_545 . V_581 [ 0 ] = F_22 ( V_2 -> V_120 ) ;
V_545 . V_581 [ 1 ] = F_22 ( V_2 -> V_118 ) ;
V_546 = F_167 ( & V_545 ) ;
V_184 -> V_582 = F_138 ( V_546 ^ 0xffffffff ) ;
F_7 ( V_14 , L_136 ,
V_184 -> V_582 , V_184 -> V_582 & V_541 -> V_583 ) ;
V_184 -> V_582 &= V_541 -> V_583 ;
V_184 -> V_207 -> V_582 = F_45 ( V_184 -> V_582 ) ;
V_2 -> V_3 -> V_447 -> V_317 ( V_2 -> V_3 , V_2 ) ;
F_7 ( V_14 , L_137
L_138
L_139 , V_184 -> V_187 . V_247 ,
F_34 ( V_556 -> V_146 . V_147 ) , F_16 ( V_556 -> V_148 ) ,
F_34 ( V_555 -> V_146 . V_147 ) , F_16 ( V_555 -> V_148 ) ,
...
V_490 . V_423 = NULL ;
V_490 . V_422 = 0 ;
V_490 . V_559 = V_2 -> V_55 ;
V_490 . V_560 = V_2 -> V_56 ;
V_169 = V_7 -> V_519 ( V_7 , & V_490 ) ;
V_543 . V_585 = V_507 ;
F_168 ( & V_184 -> V_374 , & V_543 , V_586 , NULL ) ;
if ( V_2 -> V_320 ) {
V_2 -> V_320 -> V_54 =
V_184 -> V_422 ;
...
int F_169 ( struct V_236 * V_7 , const void * V_587 , T_1 V_588 )
{
struct V_1 * V_2 ;
struct V_1 * V_319 ;
struct V_170 * V_3 ;
...
V_3 = V_2 -> V_3 ;
V_2 -> V_7 = V_7 ;
if ( V_588 + sizeof( struct V_36 ) > V_26 )
return - V_43 ;
if ( V_319 ) {
memcpy ( & V_319 -> V_25 . V_561 , V_587 , V_588 ) ;
V_319 -> V_25 . V_41 = V_588 ;
V_319 -> V_54 = V_588 ;
} else {
V_19 = & V_2 -> V_73 [ 0 ] + sizeof( struct V_36 ) ;
V_2 -> V_54 = V_588 ;
memcpy ( V_19 , V_587 , V_588 ) ;
}
return V_3 -> V_447 -> V_590 ( V_3 , V_2 ) ;
}
int F_170 ( struct V_236 * V_7 , struct V_538 * V_539 )
{
struct V_540 * V_374 ;
struct V_181 * V_184 ;
struct V_155 * V_156 ;
...
if ( ! V_324 )
return - V_43 ;
if ( ! V_555 -> V_148 || ! V_556 -> V_148 )
return - V_43 ;
F_7 ( V_14 , L_142
L_143 , V_184 -> V_187 . V_247 ,
F_34 ( V_156 -> V_345 ) , F_34 ( V_556 -> V_146 . V_147 ) ,
F_16 ( V_556 -> V_148 ) , F_34 ( V_555 -> V_146 . V_147 ) ,
F_16 ( V_555 -> V_148 ) ) ;
F_51 ( & V_593 ) ;
V_184 -> V_531 = 1 ;
V_184 -> V_7 = V_7 ;
V_7 -> V_527 = V_184 ;
V_184 -> V_422 = V_539 -> V_422 ;
F_7 ( V_14 , L_144 , ( T_3 ) V_539 -> V_560 ) ;
F_7 ( V_14 , L_145 ,
V_539 -> V_422 ) ;
V_9 . V_11 = F_34 ( V_555 -> V_146 . V_147 ) ;
V_9 . V_13 = F_16 ( V_555 -> V_148 ) ;
V_9 . V_10 = F_34 ( V_556 -> V_146 . V_147 ) ;
V_9 . V_12 = F_16 ( V_556 -> V_148 ) ;
V_9 . V_7 = V_7 ;
V_9 . V_370 = V_594 ;
V_9 . V_114 = V_9 . V_11 ;
V_9 . V_118 = V_9 . V_13 ;
...
if ( V_555 -> V_146 . V_147 != V_556 -> V_146 . V_147 ) {
F_83 ( V_156 , V_9 . V_118 ,
F_84 ( V_324 -> V_325 -> V_326 ) , V_595 ) ;
V_371 = 1 ;
}
if ( F_26 ( & V_9 ) )
return - V_27 ;
V_7 -> V_430 ( V_7 ) ;
V_2 = V_261 -> V_447 -> V_596 ( V_261 , V_156 ,
...
int F_172 ( struct V_236 * V_7 , int V_402 )
{
struct V_155 * V_156 ;
struct V_299 * V_2 ;
struct V_149 V_9 ;
...
struct V_142 * V_555 = (struct V_142 * ) & V_7 -> V_524 ;
F_7 ( V_14 , L_147 ,
V_7 , F_16 ( V_555 -> V_148 ) ) ;
if ( V_7 -> V_524 . V_591 != V_145 )
return - V_592 ;
...
V_9 . V_114 = V_9 . V_11 ;
V_9 . V_118 = V_9 . V_13 ;
V_2 = V_261 -> V_447 -> V_597 ( V_261 , V_156 , & V_9 ) ;
if ( ! V_2 ) {
F_91 ( V_346 L_150 ,
V_67 , __LINE__ ) ;
return - V_27 ;
...
F_91 ( V_346 L_151 ,
V_313 ) ;
V_261 -> V_447 -> V_598 ( V_261 , ( void * ) V_2 ) ;
return V_313 ;
}
F_51 ( & V_599 ) ;
}
...
{
if ( V_7 -> V_527 )
V_261 -> V_447 -> V_598 ( V_261 , V_7 -> V_527 ) ;
else
F_7 ( V_14 , L_152 ) ;
V_7 -> V_242 ( V_7 ) ;
return 0 ;
}
int F_174 ( struct V_15 * V_16 , struct V_340 * V_600 )
{
int V_339 = 0 ;
V_601 ++ ;
if ( ( V_261 ) && ( V_261 -> V_447 ) )
V_339 = V_261 -> V_447 -> V_602 ( V_261 , F_175 ( V_600 ) , V_16 ) ;
else
F_7 ( V_14 , L_153
L_154 ) ;
return V_339 ;
...
V_324 = V_156 -> V_324 ;
V_342 = V_324 -> V_342 ;
V_555 = (struct V_142 * ) & V_7 -> V_524 ;
V_556 = (struct V_142 * ) & V_7 -> V_168 ;
V_604 = (struct V_142 * ) & V_490 . V_524 ;
if ( V_184 -> V_512 )
return;
F_51 ( & V_605 ) ;
F_7 ( V_14 , L_156
L_157 ,
V_184 -> V_187 . V_247 , F_34 ( V_556 -> V_146 . V_147 ) ,
F_16 ( V_556 -> V_148 ) , F_16 ( V_555 -> V_148 ) , V_224 ) ;
F_150 ( V_184 , V_2 ) ;
V_184 -> V_207 -> V_571 [ 0 ] =
F_165 ( V_2 -> V_118 ) ;
V_184 -> V_207 -> V_571 [ 1 ] =
...
( T_3 ) F_84 ( V_324 -> V_325 -> V_326 ) <<
V_573 ) ;
V_184 -> V_207 -> V_574 |= F_45 (
F_98 ( V_324 ,
F_151 ( V_184 -> V_207 -> V_572 ) ,
NULL , V_357 ) << 16 ) ;
V_184 -> V_207 -> V_575 = F_45 (
V_224 - F_166 ( V_324 , V_576 ) ) ;
V_184 -> V_207 -> V_577 = F_45 ( V_184 -> V_187 . V_247 ) ;
...
V_184 -> V_582 = F_138 ( V_546 ^ 0xffffffff ) ;
F_7 ( V_14 , L_158 ,
V_184 -> V_582 , V_184 -> V_582 & V_342 -> V_583 ) ;
V_184 -> V_582 &= V_342 -> V_583 ;
V_184 -> V_207 -> V_582 = F_45 ( V_184 -> V_582 ) ;
...
& V_490 . V_524 ;
struct V_142 * V_609 = (struct V_142 * )
& V_490 . V_168 ;
F_7 ( V_14 , L_162 ,
V_604 -> V_146 . V_147 , V_609 -> V_146 . V_147 ) ;
}
#endif
V_169 = V_7 -> V_519 ( V_7 , & V_490 ) ;
F_7 ( V_14 , L_126 , V_169 ) ;
...
V_604 -> V_144 = V_145 ;
V_604 -> V_148 = F_22 ( V_6 -> V_9 . V_13 ) ;
V_604 -> V_146 . V_147 = F_23 ( V_6 -> V_9 . V_11 ) ;
V_609 -> V_144 = V_145 ;
V_609 -> V_148 = F_22 ( V_6 -> V_9 . V_12 ) ;
V_609 -> V_146 . V_147 = F_23 ( V_6 -> V_9 . V_10 ) ;
...
F_153 ( & V_6 -> V_613 , V_614 ) ;
F_7 ( V_14 , L_169 ,
V_6 -> V_2 , V_6 ) ;
F_154 ( V_6 -> V_2 -> V_3 -> V_449 , & V_6 -> V_613 ) ;
F_7 ( V_14 , L_170 ) ;
return 0 ;
}
static void V_614 ( struct V_487 * V_485 )
{
