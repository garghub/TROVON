...
F_2 ( & V_2 -> V_12 ) ;
V_47 = V_2 -> V_47 ;
V_51 = F_37 ( V_107 , V_6 -> V_55 . V_56 , V_108 ) ;
if ( V_2 -> V_13 == V_38 ) {
V_8 = - 1 ;
goto V_15;
}
...
union V_5 * V_6 , char * V_33 )
{
strcpy ( V_6 -> V_113 , L_6 ) ;
if ( V_2 -> V_114 & V_115 )
strcat ( V_6 -> V_113 , L_7 ) ;
if ( V_2 -> V_114 & V_116 )
strcat ( V_6 -> V_113 , L_8 ) ;
if ( V_2 -> V_71 & ( V_117 | V_118 ) )
strcat ( V_6 -> V_113 , L_9 ) ;
return 0 ;
}
...
F_2 ( & V_2 -> V_12 ) ;
if ( V_6 -> V_123 . V_65 ) {
F_32 ( V_94 , L_11 , V_122 ) ;
V_2 -> V_124 = V_125 ;
goto exit;
}
if ( V_6 -> V_123 . V_34 & V_126 ) {
V_2 -> V_127 = V_6 -> V_123 . V_59 / 1000 ;
F_32 ( V_94 , L_12 , V_122 ,
V_2 -> V_127 ) ;
}
if ( V_6 -> V_123 . V_34 & V_128 )
V_2 -> V_129 = V_6 -> V_123 . V_59 / 1000 ;
switch ( V_6 -> V_123 . V_34 & V_130 ) {
case V_131 :
V_2 -> V_124 = V_132 ;
break;
case V_133 :
...
V_6 -> V_123 . V_65 = 0 ;
if ( ( V_6 -> V_123 . V_34 & V_137 ) == V_126 ) {
V_6 -> V_123 . V_34 = V_126 ;
V_6 -> V_123 . V_59 = V_2 -> V_127 * 1000 ;
} else {
V_6 -> V_123 . V_34 = V_128 ;
V_6 -> V_123 . V_59 = V_2 -> V_129 * 1000 ;
}
if ( ( V_2 -> V_124 & ( V_134 | V_132 ) ) ==
( V_134 | V_132 ) )
V_6 -> V_123 . V_34 |= V_135 ;
else if ( V_2 -> V_124 & V_134 )
V_6 -> V_123 . V_34 |= V_133 ;
else
V_6 -> V_123 . V_34 |= V_131 ;
exit:
F_5 ( & V_2 -> V_12 ) ;
return 0 ;
}
