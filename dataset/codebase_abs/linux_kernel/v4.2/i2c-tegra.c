...
int V_40 = 0 ;
int V_140 = V_141 ;
V_138 = F_51 ( V_136 , V_142 , 0 ) ;
V_5 = F_52 ( & V_136 -> V_19 , V_138 ) ;
if ( F_53 ( V_5 ) )
return F_54 ( V_5 ) ;
V_138 = F_51 ( V_136 , V_143 , 0 ) ;
if ( ! V_138 ) {
F_27 ( & V_136 -> V_19 , L_9 ) ;
return - V_92 ;
}
V_65 = V_138 -> V_144 ;
V_44 = F_55 ( & V_136 -> V_19 , L_10 ) ;
if ( F_53 ( V_44 ) ) {
F_27 ( & V_136 -> V_19 , L_11 ) ;
return F_54 ( V_44 ) ;
}
V_2 = F_56 ( & V_136 -> V_19 , sizeof( * V_2 ) , V_145 ) ;
if ( ! V_2 )
return - V_146 ;
V_2 -> V_5 = V_5 ;
V_2 -> V_44 = V_44 ;
V_2 -> V_147 . V_148 = & V_149 ;
V_2 -> V_147 . V_150 = & V_151 ;
V_2 -> V_65 = V_65 ;
V_2 -> V_98 = V_136 -> V_152 ;
V_2 -> V_19 = & V_136 -> V_19 ;
V_2 -> V_47 = F_57 ( & V_136 -> V_19 , L_12 ) ;
if ( F_53 ( V_2 -> V_47 ) ) {
F_27 ( & V_136 -> V_19 , L_13 ) ;
return F_54 ( V_2 -> V_47 ) ;
}
V_40 = F_58 ( V_2 -> V_19 -> V_153 , L_14 ,
& V_2 -> V_115 ) ;
if ( V_40 )
V_2 -> V_115 = 100000 ;
V_2 -> V_41 = & V_154 ;
...
V_156 = F_59 ( V_157 , & V_136 -> V_19 ) ;
V_2 -> V_41 = V_156 -> V_8 ;
V_2 -> V_6 = F_60 ( V_136 -> V_19 . V_153 ,
L_15 ) ;
} else if ( V_136 -> V_152 == 3 ) {
V_2 -> V_6 = 1 ;
}
F_61 ( & V_2 -> V_84 ) ;
if ( ! V_2 -> V_41 -> V_42 ) {
V_43 = F_55 ( & V_136 -> V_19 , L_16 ) ;
if ( F_53 ( V_43 ) ) {
F_27 ( & V_136 -> V_19 , L_17 ) ;
return F_54 ( V_43 ) ;
}
V_2 -> V_43 = V_43 ;
}
...
V_40 = F_30 ( V_2 ) ;
if ( V_40 ) {
F_27 ( & V_136 -> V_19 , L_20 ) ;
goto V_159;
}
V_40 = F_65 ( & V_136 -> V_19 , V_2 -> V_65 ,
F_35 , 0 , F_66 ( & V_136 -> V_19 ) , V_2 ) ;
if ( V_40 ) {
F_27 ( & V_136 -> V_19 , L_21 , V_2 -> V_65 ) ;
goto V_159;
}
F_67 ( & V_2 -> V_147 , V_2 ) ;
V_2 -> V_147 . V_160 = V_161 ;
V_2 -> V_147 . V_162 = V_163 ;
F_68 ( V_2 -> V_147 . V_164 , L_22 ,
sizeof( V_2 -> V_147 . V_164 ) ) ;
V_2 -> V_147 . V_148 = & V_149 ;
V_2 -> V_147 . V_19 . V_165 = & V_136 -> V_19 ;
V_2 -> V_147 . V_166 = V_136 -> V_152 ;
V_2 -> V_147 . V_19 . V_153 = V_136 -> V_19 . V_153 ;
V_40 = F_69 ( & V_2 -> V_147 ) ;
if ( V_40 ) {
F_27 ( & V_136 -> V_19 , L_23 ) ;
goto V_159;
}
return 0 ;
V_159:
...
static int F_74 ( struct V_167 * V_19 )
{
...
static int F_78 ( struct V_167 * V_19 )
{
struct V_1 * V_2 = F_75 ( V_19 ) ;
int V_40 ;
F_76 ( & V_2 -> V_147 ) ;
