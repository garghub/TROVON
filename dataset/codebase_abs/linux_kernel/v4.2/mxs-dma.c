...
static enum V_106 F_42 ( struct V_2 * V_3 ,
T_2 V_107 , struct V_108 * V_109 )
{
struct V_1 * V_4 = F_1 ( V_3 ) ;
struct V_5 * V_6 = V_4 -> V_6 ;
T_4 V_110 = 0 ;
...
struct V_70 * V_111 ;
T_4 V_112 ;
V_111 = & V_4 -> V_54 [ V_4 -> V_77 - 1 ] ;
V_110 = V_111 -> V_97 + V_111 -> V_95 ;
V_112 = F_8 ( V_6 -> V_13 +
F_43 ( V_6 , V_3 -> V_7 ) ) ;
V_110 -= V_112 ;
}
F_44 ( V_109 , V_3 -> V_113 , V_3 -> V_107 ,
V_110 ) ;
return V_4 -> V_23 ;
}
static int T_7 F_45 ( struct V_5 * V_6 )
{
int V_53 ;
V_53 = F_28 ( V_6 -> V_61 ) ;
if ( V_53 )
...
static bool F_47 ( struct V_2 * V_3 , void * V_117 )
{
struct V_118 * V_119 = V_117 ;
struct V_1 * V_4 = F_1 ( V_3 ) ;
struct V_5 * V_6 = V_4 -> V_6 ;
int V_39 ;
if ( V_6 -> V_48 . V_20 -> V_120 != V_119 -> V_120 )
return false ;
if ( V_3 -> V_7 != V_119 -> V_7 )
return false ;
V_39 = F_48 ( V_6 -> V_19 , V_119 -> V_7 ) ;
if ( V_39 < 0 )
return false ;
V_4 -> V_39 = V_39 ;
return true ;
...
T_8 V_126 = V_6 -> V_48 . V_127 ;
struct V_118 V_119 ;
if ( V_122 -> V_128 != 1 )
return NULL ;
V_119 . V_120 = V_124 -> V_120 ;
V_119 . V_7 = V_122 -> args [ 0 ] ;
if ( V_119 . V_7 >= V_6 -> V_37 )
return NULL ;
return F_50 ( V_126 , F_47 , & V_119 ) ;
}
static int T_7 F_51 ( struct V_129 * V_19 )
{
struct V_130 * V_131 = V_19 -> V_20 . V_120 ;
...
struct V_138 * V_139 ;
int V_53 , V_36 ;
V_6 = F_52 ( & V_19 -> V_20 , sizeof( * V_6 ) , V_56 ) ;
if ( ! V_6 )
return - V_57 ;
V_53 = F_53 ( V_131 , L_7 , & V_6 -> V_37 ) ;
if ( V_53 ) {
F_10 ( & V_19 -> V_20 , L_8 ) ;
return V_53 ;
}
V_135 = F_54 ( V_140 , & V_19 -> V_20 ) ;
if ( V_135 )
V_133 = V_135 -> V_31 ;
else
V_133 = F_55 ( V_19 ) ;
V_137 = (struct V_136 * ) V_133 -> V_141 ;
V_6 -> type = V_137 -> type ;
V_6 -> V_41 = V_137 -> V_142 ;
V_139 = F_56 ( V_19 , V_143 , 0 ) ;
V_6 -> V_13 = F_57 ( & V_19 -> V_20 , V_139 ) ;
if ( F_58 ( V_6 -> V_13 ) )
return F_59 ( V_6 -> V_13 ) ;
V_6 -> V_61 = F_60 ( & V_19 -> V_20 , NULL ) ;
if ( F_58 ( V_6 -> V_61 ) )
return F_59 ( V_6 -> V_61 ) ;
F_61 ( V_144 , V_6 -> V_48 . V_127 ) ;
F_61 ( V_145 , V_6 -> V_48 . V_127 ) ;
F_62 ( & V_6 -> V_48 . V_146 ) ;
for ( V_36 = 0 ; V_36 < V_47 ; V_36 ++ ) {
struct V_1 * V_4 = & V_6 -> V_38 [ V_36 ] ;
V_4 -> V_6 = V_6 ;
V_4 -> V_3 . V_147 = & V_6 -> V_48 ;
F_63 ( & V_4 -> V_3 ) ;
F_64 ( & V_4 -> V_52 , F_19 ,
( unsigned long ) V_4 ) ;
F_65 ( & V_4 -> V_3 . V_130 ,
...
V_6 -> V_48 . V_20 -> V_148 = & V_6 -> V_148 ;
F_66 ( V_6 -> V_48 . V_20 , V_94 ) ;
V_6 -> V_48 . V_149 = F_25 ;
V_6 -> V_48 . V_150 = F_33 ;
V_6 -> V_48 . V_151 = F_42 ;
V_6 -> V_48 . V_152 = F_35 ;
...
V_6 -> V_48 . V_155 = F_16 ;
V_6 -> V_48 . V_156 = F_41 ;
V_6 -> V_48 . V_157 = F_67 ( V_158 ) ;
V_6 -> V_48 . V_159 = F_67 ( V_158 ) ;
V_6 -> V_48 . V_160 = F_67 ( V_98 ) | F_67 ( V_161 ) ;
V_6 -> V_48 . V_162 = V_163 ;
V_6 -> V_48 . V_164 = F_11 ;
V_53 = F_68 ( & V_6 -> V_48 ) ;
if ( V_53 ) {
