...
struct V_12 * V_14 ;
while ( ! F_96 ( & V_173 ) ) {
V_14 = F_115 ( V_173 . V_174 ,
struct V_12 , V_165 ) ;
F_100 ( & V_14 -> V_165 ) ;
F_78 ( V_14 ) ;
}
}
static void F_116 ( int V_13 )
{
struct V_64 * type ;
struct V_9 * V_11 ;
struct V_12 * V_14 ;
...
V_14 = * F_5 ( V_11 -> V_14 , V_13 ) ;
* F_5 ( V_11 -> V_14 , V_13 ) = NULL ;
if ( V_14 && F_117 ( & V_14 -> V_18 ) )
F_118 ( & V_14 -> V_165 , & V_173 ) ;
}
}
}
static int F_119 ( int V_13 )
{
struct V_64 * type ;
struct V_9 * V_11 ;
...
static int F_121 ( int V_13 , int V_17 )
{
struct V_64 * type ;
struct V_9 * V_11 ;
struct V_12 * V_14 ;
...
static void
F_123 ( struct V_64 * * V_178 , int V_179 , int V_180 )
{
struct V_64 * type ;
struct V_9 * V_11 ;
struct V_12 * V_14 ;
...
if ( V_181 >= 0 )
F_127 ( V_181 , & V_128 ) ;
F_123 ( V_175 , V_13 , V_181 ) ;
F_123 ( V_163 , V_13 , V_181 ) ;
}
static void F_128 ( int V_13 )
{
int V_66 , V_17 ;
V_17 = F_8 ( V_13 ) ;
F_129 (i, &uncore_cpu_mask) {
if ( V_17 == F_8 ( V_66 ) )
return;
}
F_127 ( V_13 , & V_128 ) ;
...
static int F_130 ( struct V_182 * V_183 ,
...
static void T_3 F_131 ( void * V_196 )
{
F_119 ( F_12 () ) ;
}
