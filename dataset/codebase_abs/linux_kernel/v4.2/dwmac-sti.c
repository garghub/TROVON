...
return - V_51 ;
V_4 -> V_52 = - V_53 ;
V_49 = F_14 ( V_46 , V_54 , L_2 ) ;
if ( V_49 )
V_4 -> V_52 = V_49 -> V_55 ;
V_25 = F_15 ( V_36 , L_3 ) ;
if ( F_16 ( V_25 ) )
return F_17 ( V_25 ) ;
V_50 = F_18 ( V_36 , L_3 , 1 , & V_4 -> V_8 ) ;
if ( V_50 ) {
F_19 ( V_34 , L_4 , V_50 ) ;
return V_50 ;
}
...
if ( F_21 ( V_4 -> V_10 ) ) {
const char * V_57 ;
V_50 = F_22 ( V_36 , L_6 , & V_57 ) ;
if ( V_50 < 0 ) {
F_23 ( V_34 , L_7 ) ;
V_4 -> V_6 = V_16 ;
} else if ( ! strcasecmp ( V_57 , L_8 ) ) {
V_4 -> V_6 = V_58 ;
} else if ( ! strcasecmp ( V_57 , L_9 ) ) {
V_4 -> V_6 = V_12 ;
}
V_4 -> V_47 = V_18 ;
}
V_4 -> V_24 = F_24 ( V_34 , L_10 ) ;
if ( F_16 ( V_4 -> V_24 ) ) {
F_23 ( V_34 , L_11 ) ;
V_4 -> V_24 = NULL ;
}
...
struct V_3 * V_4 ;
int V_59 ;
V_4 = F_26 ( & V_46 -> V_34 , sizeof( * V_4 ) , V_60 ) ;
if ( ! V_4 )
return F_27 ( - V_61 ) ;
V_59 = F_13 ( V_4 , V_46 ) ;
if ( V_59 ) {
