...
static T_4 F_64 ( const struct V_10 * V_11 )
{
...
static T_1 F_67 ( const struct V_10 * V_11 )
{
return F_47 ( V_11 , 0 ) ;
}
...
static int F_69 ( struct V_10 * V_11 , bool V_99 )
{
struct V_4 * V_5 = F_13 ( V_11 ) ;
T_1 V_100 ;
( void ) F_5 ( V_5 , V_41 ) ;
...
static bool F_71 ( struct V_10 * V_11 , bool V_105 )
{
struct V_4 * V_5 = F_13 ( V_11 ) ;
T_1 V_102 ;
T_1 V_106 ;
...
F_30 ( & V_11 -> V_30 ) ;
F_74 ( & V_117 ) ;
if ( F_75 ( F_56 ( V_11 -> V_11 ) ) )
F_71 ( V_11 , true ) ;
F_45 ( V_11 ) ;
V_5 -> V_8 = F_16 ( V_11 ) ;
V_5 -> V_67 = F_50 ( V_11 ) ;
if ( F_76 ( V_119 , & V_5 -> V_40 ) ) {
F_14 ( V_11 -> V_11 , L_19 ) ;
if ( F_51 ( V_5 -> V_67 ) ) {
F_14 ( V_11 -> V_11 , L_20 ) ;
V_11 -> V_71 = true ;
...
V_90 = F_80 ( V_11 ) ;
if ( F_76 ( V_104 , & V_5 -> V_40 ) ) {
V_118 = F_81 ( V_11 , & V_117 , & V_90 ) ;
...
if ( F_76 ( V_39 , & V_5 -> V_40 ) ) {
V_11 -> V_125 = true ;
V_5 -> V_90 = V_11 -> V_83 ;
}
if ( V_5 -> V_8 && V_11 -> V_125 ) {
V_11 -> V_125 = F_82 ( V_11 ) ;
V_118 = F_83 ( V_11 , & V_117 ) ;
if ( V_118 && V_118 != - V_94 )
F_25 ( V_11 -> V_11 , L_24 ,
V_118 ) ;
V_11 -> V_125 = F_82 ( V_11 ) ;
...
F_84 ( V_11 , & V_117 ) ;
V_123:
F_14 ( V_11 -> V_11 , L_25 , V_118 ) ;
F_28 ( & V_11 -> V_30 ) ;
F_85 ( V_11 ) ;
return V_126 ;
}
struct V_10 * F_86 ( struct V_77 * V_78 )
{
struct V_10 * V_11 ;
struct V_4 * V_5 ;
V_11 = F_87 ( sizeof( struct V_10 ) +
sizeof( struct V_4 ) , V_127 ) ;
if ( ! V_11 )
return NULL ;
F_88 ( V_11 , & V_78 -> V_11 , & V_128 ) ;
V_5 = F_13 ( V_11 ) ;
F_89 ( & V_5 -> V_31 ) ;
return V_11 ;
}
int F_90 ( struct V_10 * V_11 , T_7 V_129 , T_1 V_130 )
{
struct V_4 * V_5 = F_13 ( V_11 ) ;
T_1 V_131 = F_91 ( V_129 ) ;
T_1 V_132 = F_92 ( V_129 ) ;
T_1 V_133 ;
if ( V_132 & ~ 0xF )
return - V_80 ;
if ( V_131 & 0xF )
