...
{
V_5 -> V_10 . V_58 = 0 ;
V_5 -> V_10 . V_33 . V_59 = 1 ;
V_5 -> V_10 . V_33 . V_31 = V_60 - 1 ;
if ( V_56 == V_61 )
F_8 ( V_5 , V_57 ) ;
else
F_9 ( V_5 , V_57 ) ;
if ( V_55 )
V_5 -> V_10 . V_33 . V_62 = 1 ;
}
...
memset ( V_5 , 0 , F_19 ( struct V_4 , V_66 ) ) ;
if ( V_56 == V_61 )
F_20 ( V_5 , V_64 ) ;
else
F_21 ( V_5 , V_64 ) ;
}
static void F_22 ( struct V_4 * V_5 , int V_67 , int V_68 ,
int V_69 , int V_56 )
{
...
static int F_28 ( struct V_4 * V_5 , int V_74 )
{
if ( V_74 == V_75 )
return V_5 -> V_10 . V_33 . V_76 - 2 ;
else
return V_5 -> V_10 . V_33 . V_76 ;
}
...
static T_2 F_31 ( void * V_79 , T_3 V_80 )
{
...
static int F_32 ( void * V_79 , T_3 V_80 )
{
struct V_4 * V_5 = (struct V_4 * ) V_79 ;
