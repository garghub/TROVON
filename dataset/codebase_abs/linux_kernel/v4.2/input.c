...
static const struct V_128 * F_62 ( struct V_23 * V_24 ,
struct V_7 * V_8 )
{
...
continue;
if ( ! F_63 ( V_129 -> V_10 , V_8 -> V_10 , V_87 ) )
continue;
if ( ! F_63 ( V_129 -> V_36 , V_8 -> V_36 , V_37 ) )
continue;
if ( ! F_63 ( V_129 -> V_68 , V_8 -> V_68 , V_69 ) )
continue;
if ( ! F_63 ( V_129 -> V_65 , V_8 -> V_65 , V_66 ) )
continue;
if ( ! F_63 ( V_129 -> V_71 , V_8 -> V_71 , V_72 ) )
continue;
if ( ! F_63 ( V_129 -> V_74 , V_8 -> V_74 , V_75 ) )
continue;
if ( ! F_63 ( V_129 -> V_78 , V_8 -> V_78 , V_79 ) )
continue;
if ( ! F_63 ( V_129 -> V_140 , V_8 -> V_140 , V_141 ) )
continue;
if ( ! F_63 ( V_129 -> V_61 , V_8 -> V_61 , V_62 ) )
continue;
...
F_65 ( L_2 ,
V_24 -> V_144 , F_66 ( & V_8 -> V_8 . V_145 ) , error ) ;
return error ;
}
static int F_67 ( char * V_146 , int V_147 ,
...
static unsigned int F_70 ( struct V_106 * V_106 , T_1 * V_154 )
{
F_71 ( V_106 , & V_153 , V_154 ) ;
...
static void * F_72 ( struct V_158 * V_159 , T_2 * V_160 )
{
union V_161 * V_162 = (union V_161 * ) & V_159 -> V_163 ;
int error ;
F_73 ( sizeof( union V_161 ) != sizeof( V_159 -> V_163 ) ) ;
error = F_36 ( & V_164 ) ;
if ( error ) {
V_162 -> V_165 = false ;
return F_74 ( error ) ;
...
V_162 -> V_165 = true ;
return F_75 ( & V_166 , * V_160 ) ;
}
static void * F_76 ( struct V_158 * V_159 , void * V_26 , T_2 * V_160 )
{
return F_77 ( V_26 , & V_166 , V_160 ) ;
}
static void F_78 ( struct V_158 * V_159 , void * V_26 )
{
union V_161 * V_162 = (union V_161 * ) & V_159 -> V_163 ;
if ( V_162 -> V_165 )
F_38 ( & V_164 ) ;
}
static void F_79 ( struct V_158 * V_159 , const char * V_144 ,
unsigned long * V_167 , int V_3 )
{
int V_123 ;
bool V_149 = true ;
char V_146 [ 18 ] ;
F_80 ( V_159 , L_6 , V_144 ) ;
for ( V_123 = F_81 ( V_3 ) - 1 ; V_123 >= 0 ; V_123 -- ) {
if ( F_67 ( V_146 , sizeof( V_146 ) ,
V_167 [ V_123 ] , V_149 ) ) {
V_149 = false ;
F_80 ( V_159 , L_7 , V_146 , V_123 > 0 ? L_8 : L_9 ) ;
}
}
if ( V_149 )
F_82 ( V_159 , L_10 ) ;
...
const char * V_169 = F_86 ( & V_8 -> V_8 . V_145 , V_90 ) ;
struct V_18 * V_19 ;
F_80 ( V_159 , L_11 ,
V_8 -> V_129 . V_133 , V_8 -> V_129 . V_135 , V_8 -> V_129 . V_137 , V_8 -> V_129 . V_139 ) ;
F_80 ( V_159 , L_12 , V_8 -> V_144 ? V_8 -> V_144 : L_9 ) ;
F_80 ( V_159 , L_13 , V_8 -> V_170 ? V_8 -> V_170 : L_9 ) ;
F_80 ( V_159 , L_14 , V_169 ? V_169 : L_9 ) ;
F_80 ( V_159 , L_15 , V_8 -> V_171 ? V_8 -> V_171 : L_9 ) ;
F_80 ( V_159 , L_16 ) ;
F_43 (handle, &dev->h_list, d_node)
F_80 ( V_159 , L_17 , V_19 -> V_144 ) ;
F_83 ( V_159 , '\n' ) ;
F_79 ( V_159 , L_18 , V_8 -> V_172 , V_173 ) ;
F_79 ( V_159 , L_19 , V_8 -> V_10 , V_87 ) ;
if ( F_2 ( V_32 , V_8 -> V_10 ) )
F_79 ( V_159 , L_20 , V_8 -> V_36 , V_37 ) ;
if ( F_2 ( V_67 , V_8 -> V_10 ) )
F_79 ( V_159 , L_21 , V_8 -> V_68 , V_69 ) ;
if ( F_2 ( V_64 , V_8 -> V_10 ) )
F_79 ( V_159 , L_22 , V_8 -> V_65 , V_66 ) ;
if ( F_2 ( V_70 , V_8 -> V_10 ) )
F_79 ( V_159 , L_23 , V_8 -> V_71 , V_72 ) ;
if ( F_2 ( V_73 , V_8 -> V_10 ) )
F_79 ( V_159 , L_24 , V_8 -> V_74 , V_75 ) ;
if ( F_2 ( V_77 , V_8 -> V_10 ) )
F_79 ( V_159 , L_25 , V_8 -> V_78 , V_79 ) ;
if ( F_2 ( V_82 , V_8 -> V_10 ) )
F_79 ( V_159 , L_26 , V_8 -> V_140 , V_141 ) ;
if ( F_2 ( V_60 , V_8 -> V_10 ) )
F_79 ( V_159 , L_27 , V_8 -> V_61 , V_62 ) ;
F_83 ( V_159 , '\n' ) ;
F_87 ( V_169 ) ;
return 0 ;
}
static int F_88 ( struct V_174 * V_174 , struct V_106 * V_106 )
{
return F_89 ( V_106 , & V_175 ) ;
}
static void * F_90 ( struct V_158 * V_159 , T_2 * V_160 )
{
union V_161 * V_162 = (union V_161 * ) & V_159 -> V_163 ;
int error ;
F_73 ( sizeof( union V_161 ) != sizeof( V_159 -> V_163 ) ) ;
...
V_162 -> V_165 = true ;
V_162 -> V_160 = * V_160 ;
return F_75 ( & V_176 , * V_160 ) ;
}
static void * F_91 ( struct V_158 * V_159 , void * V_26 , T_2 * V_160 )
{
union V_161 * V_162 = (union V_161 * ) & V_159 -> V_163 ;
V_162 -> V_160 = * V_160 + 1 ;
return F_77 ( V_26 , & V_176 , V_160 ) ;
}
static int F_92 ( struct V_158 * V_159 , void * V_26 )
{
struct V_23 * V_24 = F_85 ( V_26 , struct V_23 , V_168 ) ;
union V_161 * V_162 = (union V_161 * ) & V_159 -> V_163 ;
F_80 ( V_159 , L_28 , V_162 -> V_160 , V_24 -> V_144 ) ;
if ( V_24 -> V_27 )
F_82 ( V_159 , L_29 ) ;
if ( V_24 -> V_177 )
F_80 ( V_159 , L_30 , V_24 -> V_178 ) ;
F_83 ( V_159 , '\n' ) ;
return 0 ;
}
static int F_93 ( struct V_174 * V_174 , struct V_106 * V_106 )
{
return F_89 ( V_106 , & V_179 ) ;
}
static int T_3 F_94 ( void )
{
struct V_180 * V_181 ;
V_182 = F_95 ( L_31 , NULL ) ;
if ( ! V_182 )
return - V_183 ;
V_181 = F_96 ( L_32 , 0 , V_182 ,
& V_184 ) ;
if ( ! V_181 )
goto V_185;
V_181 = F_96 ( L_33 , 0 , V_182 ,
& V_186 ) ;
if ( ! V_181 )
goto V_187;
return 0 ;
V_187: F_97 ( L_32 , V_182 ) ;
V_185: F_97 ( L_31 , NULL ) ;
return - V_183 ;
}
...
static int F_99 ( char * V_146 , int V_188 ,
...
if ( V_2 [ F_100 ( V_123 ) ] & F_101 ( V_123 ) )
V_112 += snprintf ( V_146 + V_112 , V_3 ( V_188 - V_112 , 0 ) , L_35 , V_123 ) ;
return V_112 ;
}
static int F_102 ( char * V_146 , int V_188 , struct V_7 * V_129 ,
int V_191 )
{
int V_112 ;
...
V_112 += F_99 ( V_146 + V_112 , V_188 - V_112 ,
'e' , V_129 -> V_10 , 0 , V_87 ) ;
V_112 += F_99 ( V_146 + V_112 , V_188 - V_112 ,
...
static T_4 F_103 ( struct V_193 * V_8 ,
struct V_194 * V_195 ,
char * V_146 )
{
struct V_7 * V_129 = F_104 ( V_8 ) ;
T_4 V_112 ;
V_112 = F_102 ( V_146 , V_196 , V_129 , 1 ) ;
return F_105 ( int , V_112 , V_196 ) ;
}
static T_4 F_106 ( struct V_193 * V_8 ,
struct V_194 * V_195 ,
char * V_146 )
{
struct V_7 * V_7 = F_104 ( V_8 ) ;
int V_112 = F_107 ( V_146 , V_196 , V_7 -> V_172 ,
V_173 , true ) ;
return F_105 ( int , V_112 , V_196 ) ;
}
static int F_107 ( char * V_146 , int V_147 , unsigned long * V_167 ,
int V_3 , int V_191 )
{
int V_123 ;
int V_112 = 0 ;
bool V_149 = true ;
for ( V_123 = F_81 ( V_3 ) - 1 ; V_123 >= 0 ; V_123 -- ) {
V_112 += F_67 ( V_146 + V_112 , V_3 ( V_147 - V_112 , 0 ) ,
V_167 [ V_123 ] , V_149 ) ;
if ( V_112 ) {
V_149 = false ;
if ( V_123 > 0 )
...
static void F_108 ( struct V_193 * V_193 )
{
struct V_7 * V_8 = F_104 ( V_193 ) ;
F_109 ( V_8 ) ;
F_110 ( V_8 ) ;
F_87 ( V_8 -> V_48 ) ;
F_87 ( V_8 -> V_21 ) ;
...
{
int V_112 ;
if ( F_113 ( V_199 , L_39 , V_144 ) )
return - V_183 ;
V_112 = F_107 ( & V_199 -> V_146 [ V_199 -> V_200 - 1 ] ,
...
if ( F_113 ( V_199 , L_40 ) )
return - V_183 ;
V_112 = F_102 ( & V_199 -> V_146 [ V_199 -> V_200 - 1 ] ,
sizeof( V_199 -> V_146 ) - V_199 -> V_200 ,
V_8 , 0 ) ;
if ( V_112 >= ( sizeof( V_199 -> V_146 ) - V_199 -> V_200 ) )
return - V_183 ;
...
static int F_115 ( struct V_193 * V_193 , struct V_198 * V_199 )
{
struct V_7 * V_8 = F_104 ( V_193 ) ;
F_116 ( L_41 ,
...
if ( V_8 -> V_144 )
F_116 ( L_42 , V_8 -> V_144 ) ;
if ( V_8 -> V_170 )
F_116 ( L_43 , V_8 -> V_170 ) ;
if ( V_8 -> V_171 )
F_116 ( L_44 , V_8 -> V_171 ) ;
F_117 ( L_45 , V_8 -> V_172 , V_173 ) ;
...
if ( F_2 ( V_82 , V_8 -> V_10 ) )
F_117 ( L_53 , V_8 -> V_140 , V_141 ) ;
if ( F_2 ( V_60 , V_8 -> V_10 ) )
F_117 ( L_54 , V_8 -> V_61 , V_62 ) ;
F_118 ( V_8 ) ;
return 0 ;
}
static void F_119 ( struct V_7 * V_8 , bool V_201 )
{
if ( ! V_8 -> V_29 )
return;
F_120 ( V_8 , V_202 , V_76 , V_201 ) ;
F_120 ( V_8 , V_203 , V_80 , V_201 ) ;
...
static char * F_126 ( struct V_193 * V_8 , T_5 * V_204 )
{
return F_127 ( V_90 , L_55 , F_128 ( V_8 ) ) ;
}
struct V_7 * F_129 ( void )
{
static T_6 V_205 = F_130 ( - 1 ) ;
struct V_7 * V_8 ;
...
F_136 ( & V_8 -> V_168 ) ;
F_137 ( & V_8 -> V_8 , L_56 ,
( unsigned long ) F_138 ( & V_205 ) ) ;
F_139 ( V_197 ) ;
}
return V_8 ;
}
static int F_140 ( struct V_193 * V_8 , void * V_210 , void * V_15 )
{
struct V_211 * V_212 = V_210 ;
return V_212 -> V_213 == V_15 ;
}
static void F_141 ( struct V_193 * V_8 , void * V_210 )
{
struct V_211 * V_212 = V_210 ;
struct V_7 * V_213 = V_212 -> V_213 ;
F_142 ( V_8 , L_57 ,
V_91 , F_128 ( & V_213 -> V_8 ) ) ;
F_143 ( V_213 ) ;
}
struct V_7 * F_144 ( struct V_193 * V_8 )
{
struct V_7 * V_213 ;
struct V_211 * V_212 ;
V_212 = F_145 ( F_141 ,
...
V_28 += F_155 ( V_123 ) ? V_216 : 1 ;
if ( F_2 ( V_67 , V_8 -> V_10 ) )
V_28 += F_156 ( V_8 -> V_68 , V_219 ) ;
V_28 += 7 ;
return V_28 ;
}
static void F_157 ( struct V_7 * V_8 )
{
F_158 ( V_8 , V_220 , V_35 ) ;
F_158 ( V_8 , V_221 , V_222 ) ;
F_158 ( V_8 , ABS , abs ) ;
F_158 ( V_8 , V_223 , V_224 ) ;
F_158 ( V_8 , V_202 , V_76 ) ;
F_158 ( V_8 , V_203 , V_80 ) ;
F_158 ( V_8 , V_225 , V_226 ) ;
F_158 ( V_8 , V_227 , V_63 ) ;
}
...
static void F_165 ( struct V_193 * V_8 , void * V_210 )
{
struct V_211 * V_212 = V_210 ;
struct V_7 * V_213 = V_212 -> V_213 ;
F_142 ( V_8 , L_59 ,
...
if ( error )
goto V_235;
F_169 ( & V_8 -> V_168 , & V_166 ) ;
F_43 (handler, &input_handler_list, node)
F_64 ( V_8 , V_24 ) ;
F_68 () ;
F_38 ( & V_164 ) ;
if ( V_8 -> V_215 ) {
F_142 ( V_8 -> V_8 . V_214 , L_63 ,
V_91 , F_128 ( & V_8 -> V_8 ) ) ;
F_147 ( V_8 -> V_8 . V_214 , V_212 ) ;
}
return 0 ;
V_235:
F_164 ( & V_8 -> V_8 ) ;
...
return error ;
if ( V_24 -> V_27 )
F_176 ( & V_19 -> V_236 , & V_8 -> V_209 ) ;
else
F_177 ( & V_19 -> V_236 , & V_8 -> V_209 ) ;
F_38 ( & V_8 -> V_98 ) ;
F_177 ( & V_19 -> V_237 , & V_24 -> V_209 ) ;
if ( V_24 -> V_102 )
V_24 -> V_102 ( V_19 ) ;
return 0 ;
}
...
int F_180 ( int V_238 , unsigned int V_239 ,
bool V_240 )
{
if ( V_238 >= 0 ) {
int V_178 = F_181 ( & V_241 ,
V_238 ,
V_238 + V_239 ,
V_90 ) ;
if ( V_178 >= 0 || ! V_240 )
