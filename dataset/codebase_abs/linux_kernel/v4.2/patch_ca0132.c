...
V_323 , 0 ) ;
F_135 ( V_2 , V_23 -> V_317 [ 1 ] ,
V_310 & ~ V_324 ) ;
V_310 = F_2 ( V_2 , V_23 -> V_317 [ 0 ] , 0 ,
V_323 , 0 ) ;
F_135 ( V_2 , V_23 -> V_317 [ 0 ] ,
V_310 | V_325 ) ;
} else {
F_12 ( V_2 , L_94 ) ;
V_313 = V_326 ;
...
static void F_137 ( struct V_327 * V_328 )
{
struct V_22 * V_23 = F_138 (
F_139 ( V_328 ) , struct V_22 , V_329 ) ;
struct V_330 * V_331 ;
F_132 ( V_23 -> V_2 ) ;
V_331 = F_140 ( V_23 -> V_2 , V_23 -> V_332 ) ;
if ( V_331 ) {
V_331 -> V_333 = 0 ;
F_141 ( V_23 -> V_2 ) ;
}
...
int V_367 = 0 ;
if ( V_40 )
V_367 = F_153 ( V_2 , V_23 -> V_343 [ 0 ] , 0 ,
V_288 , 0 , V_372 , 3 ) ;
else
V_367 = F_153 ( V_2 , V_23 -> V_343 [ 0 ] , 0 ,
V_288 , 0 , V_372 , 0 ) ;
...
V_373 = F_147 ( V_2 , V_3 , & V_350 ) ;
if ( V_373 ) {
int V_103 = F_155 ( V_268 ) ;
int V_374 = F_119 ( V_268 ) ;
unsigned long V_375 ;
F_15 ( & V_2 -> V_376 ) ;
V_375 = V_268 -> V_304 ;
V_268 -> V_304 = F_127 ( V_350 , V_374 ,
0 , V_103 ) ;
...
struct V_275 * V_276 )
{
unsigned int V_377 = sizeof( V_378 )
/ sizeof( struct V_379 ) ;
V_276 -> type = V_380 ;
V_276 -> V_29 = 1 ;
V_276 -> V_272 . V_381 . V_377 = V_377 ;
if ( V_276 -> V_272 . V_381 . V_382 >= V_377 )
V_276 -> V_272 . V_381 . V_382 = V_377 - 1 ;
strcpy ( V_276 -> V_272 . V_381 . V_285 ,
V_378 [ V_276 -> V_272 . V_381 . V_382 ] . V_285 ) ;
return 0 ;
}
...
struct V_1 * V_2 = F_116 ( V_268 ) ;
struct V_22 * V_23 = V_2 -> V_23 ;
V_270 -> V_272 . V_381 . V_382 [ 0 ] = V_23 -> V_371 ;
return 0 ;
}
...
struct V_22 * V_23 = V_2 -> V_23 ;
int V_263 , V_35 = 0 ;
int V_383 = V_270 -> V_272 . V_381 . V_382 [ 0 ] ;
unsigned int V_377 = sizeof( V_378 )
/ sizeof( struct V_379 ) ;
if ( V_383 >= V_377 )
return 0 ;
F_12 ( V_2 , L_99 ,
V_383 , V_378 [ V_383 ] . V_285 ) ;
for ( V_263 = 0 ; V_263 < V_384 ; V_263 ++ ) {
V_35 = F_38 ( V_2 , V_356 . V_266 ,
V_356 . V_357 [ V_263 ] ,
V_378 [ V_383 ] . V_385 [ V_263 ] ) ;
if ( V_35 < 0 )
break;
}
if ( V_35 >= 0 ) {
...
( ( V_3 >= V_364 ) && ( V_3 < V_365 ) ) ) {
V_23 -> V_242 [ V_3 - V_244 ] = * V_271 ;
V_389 = F_146 ( V_2 , V_3 , * V_271 ) ;
goto exit;
}
if ( V_3 == V_23 -> V_343 [ 0 ] ) {
V_23 -> V_348 = * V_271 ;
if ( V_23 -> V_338 != V_339 )
V_389 = F_145 ( V_2 , * V_271 ) ;
goto exit;
}
exit:
F_114 ( V_2 ) ;
...
F_15 ( & V_2 -> V_376 ) ;
V_375 = V_268 -> V_304 ;
V_268 -> V_304 = F_127 ( V_3 , V_374 , 0 , V_103 ) ;
...
static int F_167 ( struct V_267 * V_268 , int V_392 ,
...
V_375 = V_268 -> V_304 ;
V_268 -> V_304 = F_127 ( V_3 , V_374 , 0 , V_103 ) ;
V_35 = F_168 ( V_268 , V_392 , V_66 , V_295 ) ;
V_268 -> V_304 = V_375 ;
F_16 ( & V_2 -> V_376 ) ;
break;
case V_353 :
...
const char * V_393 , int V_103 )
{
char V_286 [ V_287 ] ;
int type = V_103 ? V_288 : V_289 ;
struct V_290 V_291 =
F_170 ( V_286 , V_3 , 1 , type ) ;
sprintf ( V_286 , L_101 , V_393 , V_305 [ V_103 ] ) ;
return F_128 ( V_2 , V_3 , F_129 ( & V_291 , V_2 ) ) ;
}
...
V_291 . V_298 = F_158 ;
V_291 . V_299 = F_159 ;
return F_128 ( V_2 , V_394 , F_129 ( & V_291 , V_2 ) ) ;
}
...
int V_263 , V_359 ;
int V_35 = 0 ;
for ( V_263 = 0 ; V_263 < V_23 -> V_395 ; V_263 ++ ) {
V_35 = F_174 ( V_2 , V_23 -> V_396 [ V_263 ] ) ;
if ( V_35 < 0 )
return V_35 ;
}
V_359 = V_360 + V_361 ;
...
V_35 = F_169 ( V_2 , V_243 , L_102 , 0 ) ;
if ( V_35 < 0 )
return V_35 ;
V_35 = F_169 ( V_2 , V_259 , L_103 , 1 ) ;
if ( V_35 < 0 )
return V_35 ;
F_171 ( V_2 ) ;
#ifdef F_175
F_130 ( V_2 ) ;
#endif
V_35 = F_176 ( V_2 , & V_23 -> V_397 ) ;
if ( V_35 < 0 )
return V_35 ;
if ( V_23 -> V_398 ) {
V_35 = F_177 ( V_2 , V_23 -> V_398 ,
V_23 -> V_398 ) ;
if ( V_35 < 0 )
return V_35 ;
...
struct V_22 * V_23 = V_2 -> V_23 ;
struct V_400 * V_245 ;
V_245 = F_181 ( V_2 , L_104 ) ;
if ( ! V_245 )
return - V_226 ;
V_245 -> V_10 [ V_401 ] = V_402 ;
V_245 -> V_10 [ V_401 ] . V_3 = V_23 -> V_239 [ 0 ] ;
V_245 -> V_10 [ V_401 ] . V_403 =
V_23 -> V_257 . V_404 ;
V_245 -> V_10 [ V_405 ] = V_406 ;
V_245 -> V_10 [ V_405 ] . V_407 = 1 ;
V_245 -> V_10 [ V_405 ] . V_3 = V_23 -> V_369 [ 0 ] ;
V_245 = F_181 ( V_2 , L_105 ) ;
if ( ! V_245 )
return - V_226 ;
V_245 -> V_10 [ V_405 ] = V_406 ;
V_245 -> V_10 [ V_405 ] . V_407 = 1 ;
V_245 -> V_10 [ V_405 ] . V_3 = V_23 -> V_369 [ 1 ] ;
V_245 = F_181 ( V_2 , L_106 ) ;
if ( ! V_245 )
return - V_226 ;
V_245 -> V_10 [ V_405 ] = V_406 ;
V_245 -> V_10 [ V_405 ] . V_407 = 1 ;
V_245 -> V_10 [ V_405 ] . V_3 = V_23 -> V_369 [ 2 ] ;
if ( ! V_23 -> V_398 && ! V_23 -> V_399 )
return 0 ;
...
V_245 -> V_10 [ V_401 ] =
V_410 ;
V_245 -> V_10 [ V_401 ] . V_3 = V_23 -> V_398 ;
}
if ( V_23 -> V_399 ) {
V_245 -> V_10 [ V_405 ] =
V_411 ;
V_245 -> V_10 [ V_405 ] . V_3 = V_23 -> V_399 ;
}
return 0 ;
}
static void F_182 ( struct V_1 * V_2 , T_1 V_412 , T_1 V_413 )
{
if ( V_412 ) {
F_135 ( V_2 , V_412 , V_324 ) ;
if ( F_183 ( V_2 , V_412 ) & V_414 )
F_20 ( V_2 , V_412 , 0 ,
V_415 ,
V_416 ) ;
}
if ( V_413 && ( F_183 ( V_2 , V_413 ) & V_414 ) )
F_20 ( V_2 , V_413 , 0 ,
V_415 , V_417 ) ;
}
static void F_184 ( struct V_1 * V_2 , T_1 V_412 , T_1 V_418 )
{
if ( V_412 ) {
F_135 ( V_2 , V_412 , V_419 ) ;
if ( F_183 ( V_2 , V_412 ) & V_420 )
F_20 ( V_2 , V_412 , 0 ,
V_415 ,
F_185 ( 0 ) ) ;
}
if ( V_418 && ( F_183 ( V_2 , V_418 ) & V_420 ) ) {
F_20 ( V_2 , V_418 , 0 , V_415 ,
F_185 ( 0 ) ) ;
F_186 ( V_2 , V_418 , V_288 , 0 ,
V_372 , 0x5a ) ;
F_186 ( V_2 , V_418 , V_288 , 0 ,
V_421 , 0 ) ;
}
...
{
unsigned int V_422 ;
V_422 = F_188 ( V_2 , V_3 , V_103 == V_289 ?
V_423 : V_424 ) ;
F_189 ( V_2 , V_3 , V_103 , V_422 ) ;
}
...
F_12 ( V_2 , L_109 ) ;
F_193 ( V_2 ) ;
for ( V_263 = 0 ; V_263 < V_23 -> V_257 . V_432 ; V_263 ++ )
F_187 ( V_2 , V_23 -> V_239 [ V_263 ] , V_289 ) ;
for ( V_263 = 0 ; V_263 < V_23 -> V_433 ; V_263 ++ )
F_187 ( V_2 , V_23 -> V_317 [ V_263 ] , V_289 ) ;
for ( V_263 = 0 ; V_263 < V_23 -> V_434 ; V_263 ++ ) {
F_187 ( V_2 , V_23 -> V_369 [ V_263 ] , V_288 ) ;
F_187 ( V_2 , V_23 -> V_343 [ V_263 ] , V_288 ) ;
}
}
...
for ( V_263 = 0 ; V_263 <= V_366 [ V_262 ] . V_435 ; V_263 ++ ) {
F_38 ( V_2 , V_366 [ V_262 ] . V_266 ,
V_366 [ V_262 ] . V_357 [ V_263 ] ,
V_366 [ V_262 ] . V_436 [ V_263 ] ) ;
}
}
V_313 = V_326 ;
...
static void F_197 ( struct V_1 * V_2 , bool V_445 )
{
F_19 ( V_2 , V_446 , V_445 ) ;
F_19 ( V_2 , V_447 , V_445 ) ;
F_19 ( V_2 , V_448 , V_445 ) ;
F_19 ( V_2 , V_449 , V_445 ) ;
F_19 ( V_2 , V_450 , V_445 ) ;
F_19 ( V_2 , V_451 , V_445 ) ;
F_22 ( V_2 , V_335 , V_336 ) ;
F_22 ( V_2 , V_337 , V_336 ) ;
F_22 ( V_2 , V_452 , V_453 ) ;
}
static bool F_198 ( struct V_1 * V_2 )
{
bool V_454 = false ;
const struct V_204 * V_455 ;
const struct V_456 * V_457 ;
if ( F_199 ( & V_457 , V_458 , V_2 -> V_459 -> V_460 ) != 0 )
return false ;
V_455 = (struct V_204 * ) ( V_457 -> V_15 ) ;
if ( F_91 ( V_2 , V_455 , 0 , 0 , true , 0 ) ) {
F_95 ( L_110 ) ;
goto V_461;
}
V_454 = F_93 ( V_2 ) ;
...
static void F_204 ( struct V_1 * V_2 , struct V_463 * V_465 )
{
struct V_22 * V_23 = V_2 -> V_23 ;
F_205 ( & V_23 -> V_329 ) ;
F_206 ( & V_23 -> V_329 , F_6 ( 500 ) ) ;
V_465 -> V_466 -> V_333 = 1 ;
}
static void F_207 ( struct V_1 * V_2 , struct V_463 * V_465 )
{
F_143 ( V_2 ) ;
}
...
{
struct V_22 * V_23 = V_2 -> V_23 ;
F_209 ( V_2 , V_23 -> V_332 , F_204 ) ;
F_209 ( V_2 , V_23 -> V_467 ,
F_207 ) ;
F_209 ( V_2 , V_468 ,
F_203 ) ;
}
...
F_190 ( V_2 ) ;
for ( V_263 = 0 ; V_263 < V_23 -> V_433 ; V_263 ++ )
F_182 ( V_2 , V_23 -> V_317 [ V_263 ] , V_23 -> V_239 [ 0 ] ) ;
F_182 ( V_2 , V_471 -> V_474 [ 0 ] , V_23 -> V_398 ) ;
for ( V_263 = 0 ; V_263 < V_23 -> V_434 ; V_263 ++ )
F_184 ( V_2 , V_23 -> V_343 [ V_263 ] , V_23 -> V_369 [ V_263 ] ) ;
F_184 ( V_2 , V_471 -> V_475 , V_23 -> V_399 ) ;
...
V_23 -> V_343 [ 2 ] = 0x13 ;
V_23 -> V_354 = 0x7 ;
V_23 -> V_467 = V_23 -> V_343 [ 0 ] ;
V_23 -> V_398 = 0x05 ;
V_23 -> V_257 . V_482 = V_23 -> V_398 ;
V_471 -> V_474 [ 0 ] = 0x0c ;
V_471 -> V_483 = 1 ;
V_471 -> V_484 [ 0 ] = V_409 ;
V_23 -> V_399 = 0x09 ;
...
struct V_22 * V_23 = V_2 -> V_23 ;
V_23 -> V_476 = V_486 ;
V_23 -> V_477 = F_87 ( sizeof( struct V_487 ) * F_218 , V_225 ) ;
if ( ! V_23 -> V_477 )
return - V_226 ;
V_23 -> V_477 [ 0 ] . V_3 = V_23 -> V_332 ;
V_23 -> V_477 [ 0 ] . V_488 = V_489 ;
V_23 -> V_477 [ 0 ] . V_4 = V_490 | V_23 -> V_332 ;
V_23 -> V_477 [ 1 ] . V_3 = V_23 -> V_467 ;
V_23 -> V_477 [ 1 ] . V_488 = V_489 ;
V_23 -> V_477 [ 1 ] . V_4 = V_490 | V_23 -> V_467 ;
V_23 -> V_477 [ 2 ] . V_3 = 0x0b ;
V_23 -> V_477 [ 2 ] . V_488 = 0x78D ;
...
V_2 -> V_494 = 1 ;
V_2 -> V_495 = 1 ;
V_480 = F_220 ( V_2 -> V_496 -> V_497 , V_498 ) ;
if ( V_480 )
...
V_23 -> V_473 = V_501 ;
V_23 -> V_478 = V_502 ;
F_221 ( & V_23 -> V_329 , F_137 ) ;
F_210 ( V_2 ) ;
F_216 ( V_2 ) ;
V_35 = F_217 ( V_2 ) ;
if ( V_35 < 0 )
return V_35 ;
V_35 = F_222 ( V_2 , & V_23 -> V_397 , NULL ) ;
if ( V_35 < 0 )
return V_35 ;
return 0 ;
}
