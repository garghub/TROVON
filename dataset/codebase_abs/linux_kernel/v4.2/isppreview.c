...
struct V_1 * V_2 = F_78 ( V_410 ) ;
switch ( V_471 -> V_447 | F_103 ( V_472 -> V_272 ) ) {
case V_243 | V_473 :
if ( V_183 & V_474 ) {
if ( V_2 -> V_283 == V_371 )
return - V_463 ;
...
{
int V_479 ;
V_479 = F_108 ( V_478 , & V_2 -> V_271 ) ;
if ( V_479 < 0 )
goto error;
V_479 = F_109 ( & V_2 -> V_390 , V_478 ) ;
if ( V_479 < 0 )
goto error;
V_479 = F_109 ( & V_2 -> V_384 , V_478 ) ;
if ( V_479 < 0 )
goto error;
return 0 ;
error:
...
struct V_469 * V_481 = & V_410 -> V_272 ;
int V_479 ;
V_2 -> V_283 = V_475 ;
F_111 ( V_410 , & V_482 ) ;
V_410 -> V_483 = & V_484 ;
...
V_410 -> V_183 |= V_486 ;
F_114 ( & V_2 -> V_405 , 2 ) ;
F_115 ( & V_2 -> V_405 , & V_487 , V_407 ,
V_488 , V_489 ,
V_490 , V_336 ) ;
F_115 ( & V_2 -> V_405 , & V_487 , V_408 ,
V_491 , V_492 ,
V_493 , V_335 ) ;
F_116 ( & V_2 -> V_405 ) ;
V_410 -> V_494 = & V_2 -> V_405 ;
V_480 [ V_243 ] . V_183 = V_495
| V_496 ;
V_480 [ V_373 ] . V_183 = V_497 ;
V_481 -> V_498 = & V_499 ;
...
V_2 -> V_390 . V_498 = & V_501 ;
V_2 -> V_390 . V_6 = F_2 ( V_2 ) ;
V_2 -> V_390 . V_502 = F_118 ( 4096 * 4096 ) * 2 * 3 ;
V_2 -> V_390 . V_503 = 64 ;
V_2 -> V_384 . type = V_401 ;
V_2 -> V_384 . V_498 = & V_501 ;
V_2 -> V_384 . V_6 = F_2 ( V_2 ) ;
V_2 -> V_384 . V_502 = F_118 ( 4096 * 4096 ) * 2 * 3 ;
V_2 -> V_384 . V_503 = 32 ;
V_479 = F_119 ( & V_2 -> V_390 , L_6 ) ;
if ( V_479 < 0 )
goto V_504;
V_479 = F_119 ( & V_2 -> V_384 , L_6 ) ;
if ( V_479 < 0 )
goto V_505;
V_479 = F_120 ( & V_2 -> V_390 . V_399 . V_272 , 0 ,
& V_2 -> V_271 . V_272 , V_243 , 0 ) ;
if ( V_479 < 0 )
goto V_506;
V_479 = F_120 ( & V_2 -> V_271 . V_272 , V_373 ,
