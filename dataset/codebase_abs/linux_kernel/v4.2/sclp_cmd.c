...
{
unsigned long long V_83 , V_84 , V_85 ;
V_85 = F_36 () ;
V_83 = F_37 ( * V_51 , V_85 ) ;
V_84 = F_38 ( * V_51 + * V_58 , V_85 ) - V_83 ;
F_39 ( L_8 ,
* V_51 , V_84 >> 20 , * V_58 >> 20 ) ;
* V_51 = V_83 ;
* V_58 = V_84 ;
}
static void T_4 F_40 ( T_3 V_48 )
{
static T_3 V_86 , V_87 ;
unsigned long long V_51 , V_58 ;
if ( V_48 && V_86 && ( V_86 + V_87 == V_48 ) ) {
V_87 ++ ;
return;
}
if ( ! V_86 )
goto V_88;
V_51 = F_21 ( V_86 ) ;
V_58 = ( unsigned long long ) V_87 * V_46 . V_47 ;
if ( V_51 >= V_89 )
goto V_88;
if ( V_51 + V_58 > V_89 )
V_58 = V_89 - V_51 ;
...
static void T_4 F_43 ( T_3 V_48 , int V_27 , int V_56 )
{
struct V_60 * V_61 , * V_92 ;
struct V_93 * V_94 ;
T_3 V_95 ;
V_92 = F_5 ( sizeof( * V_92 ) , V_10 ) ;
if ( ! V_92 )
return;
V_92 -> V_48 = V_48 ;
V_92 -> V_27 = V_27 ;
...
if ( V_104 )
return 0 ;
if ( ( V_46 . V_105 & 0xe00000000000ULL ) != 0xe00000000000ULL )
return 0 ;
V_9 = - V_11 ;
V_6 = ( void * ) F_48 ( V_10 | V_35 ) ;
if ( ! V_6 )
goto V_18;
V_56 = 0 ;
...
if ( V_9 || F_49 ( & V_96 ) )
goto V_18;
for ( V_54 = 1 ; V_54 <= V_46 . V_98 - V_56 ; V_54 ++ )
F_43 ( 0 , 1 , 0 ) ;
V_9 = F_50 ( & V_108 ) ;
if ( V_9 )
goto V_18;
...
static int F_55 ( T_1 V_5 , T_5 V_111 )
{
struct V_112 * V_6 ;
int V_9 ;
if ( ! V_113 )
return - V_34 ;
V_6 = (struct V_112 * ) F_13 ( V_10 | V_35 ) ;
if ( ! V_6 )
return - V_11 ;
V_6 -> V_36 . V_37 = V_50 ;
V_6 -> V_114 = V_115 ;
...
int F_57 ( T_5 V_111 )
{
return F_55 ( V_117 , V_111 ) ;
}
int F_58 ( T_5 V_111 )
{
return F_55 ( V_118 , V_111 ) ;
}
...
if ( ! V_120 )
return - V_34 ;
V_6 = (struct V_119 * ) F_13 ( V_10 | V_35 ) ;
if ( ! V_6 )
return - V_11 ;
V_6 -> V_36 . V_37 = sizeof( * V_6 ) ;
V_9 = F_3 ( V_5 , V_6 ) ;
...
int F_60 ( struct V_121 V_122 )
{
return F_59 ( V_123 | V_122 . V_52 << 8 ) ;
}
int F_61 ( struct V_121 V_122 )
{
return F_59 ( V_124 | V_122 . V_52 << 8 ) ;
}
int F_62 ( struct V_125 * V_22 )
{
struct V_126 * V_6 ;
int V_9 ;
if ( ! V_127 )
return - V_34 ;
V_6 = (struct V_126 * ) F_13 ( V_10 | V_35 ) ;
if ( ! V_6 )
return - V_11 ;
V_6 -> V_36 . V_37 = sizeof( * V_6 ) ;
V_9 = F_3 ( V_128 , V_6 ) ;
...
memcpy ( V_22 -> V_129 , V_6 -> V_129 , V_130 ) ;
memcpy ( V_22 -> V_27 , V_6 -> V_27 , V_130 ) ;
memcpy ( V_22 -> V_25 , V_6 -> V_25 , V_130 ) ;
V_18:
F_14 ( ( unsigned long ) V_6 ) ;
return V_9 ;
}
