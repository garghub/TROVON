...
return V_231 ;
V_230 = F_130 ( V_2 , V_232 , V_228 , V_227 , & V_229 ) ;
if ( V_230 != 0 )
return V_231 ;
switch ( V_227 ) {
case 1 :
F_84 ( V_2 , 4 , * ( V_233 * ) & V_229 ) ;
break;
case 2 :
F_84 ( V_2 , 4 , F_131 ( * ( V_234 * ) & V_229 ) ) ;
break;
case 4 :
F_84 ( V_2 , 4 , F_132 ( * ( V_235 * ) & V_229 ) ) ;
break;
case 8 :
...
break;
case 2 :
* ( V_234 * ) & V_229 = F_136 ( V_148 ) ;
break;
case 4 :
* ( V_235 * ) & V_229 = F_137 ( V_148 ) ;
break;
case 8 :
...
V_230 = F_139 ( V_2 , V_232 , V_228 , V_227 , & V_229 ) ;
if ( V_230 != 0 )
return V_231 ;
return V_237 ;
}
...
int F_141 ( struct V_9 * V_9 , unsigned long V_238 )
{
...
{
int V_106 ;
V_106 = F_143 ( NULL , sizeof( struct V_1 ) , 0 , V_240 ) ;
if ( V_106 )
return V_106 ;
#ifdef F_144
V_106 = F_145 () ;
