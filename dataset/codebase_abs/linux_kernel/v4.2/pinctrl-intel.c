...
const struct V_146 * V_118 = & V_3 -> V_28 -> V_33 [ V_6 ] ;
T_2 V_147 ;
if ( ! F_11 ( V_3 , V_118 -> V_148 ) )
continue;
V_147 = F_6 ( F_3 ( V_3 , V_118 -> V_148 , V_41 ) ) ;
V_129 [ V_6 ] . V_53 = V_147 & ~ V_87 ;
V_147 = F_6 ( F_3 ( V_3 , V_118 -> V_148 , V_42 ) ) ;
V_129 [ V_6 ] . V_80 = V_147 ;
}
V_8 = V_3 -> V_133 . V_8 ;
for ( V_6 = 0 ; V_6 < V_3 -> V_7 ; V_6 ++ ) {
struct V_1 * V_5 = & V_3 -> V_8 [ V_6 ] ;
...
if ( ! F_11 ( V_3 , V_118 -> V_148 ) )
continue;
V_149 = F_3 ( V_3 , V_118 -> V_148 , V_41 ) ;
V_147 = F_6 ( V_149 ) & ~ V_87 ;
if ( V_147 != V_129 [ V_6 ] . V_53 ) {
F_25 ( V_129 [ V_6 ] . V_53 , V_149 ) ;
F_56 ( V_11 , L_19 ,
V_118 -> V_148 , F_6 ( V_149 ) ) ;
}
V_149 = F_3 ( V_3 , V_118 -> V_148 , V_42 ) ;
V_147 = F_6 ( V_149 ) ;
if ( V_147 != V_129 [ V_6 ] . V_80 ) {
F_25 ( V_129 [ V_6 ] . V_80 , V_149 ) ;
F_56 ( V_11 , L_20 ,
V_118 -> V_148 , F_6 ( V_149 ) ) ;
}
}
