...
{
struct V_10 * V_11 = F_63 ( V_112 ) ;
struct V_51 * V_43 ;
struct V_1 * V_1 = NULL ;
int V_12 = - V_32 ;
V_43 = F_64 ( sizeof( struct V_1 ) , & V_115 ) ;
if ( ! V_43 )
return - V_32 ;
V_1 = V_43 -> V_52 ;
V_1 -> V_43 = V_43 ;
...
goto V_109;
V_1 -> V_53 . V_117 = V_17 ;
V_1 -> V_53 . V_118 = V_119 ;
V_1 -> V_53 . V_120 = F_44 ( 0 ) ;
V_1 -> V_56 = F_41 ( 0 , V_57 ) ;
if ( ! V_1 -> V_56 )
goto V_109;
V_43 -> V_121 = & V_11 -> V_14 ;
V_43 -> V_122 = V_123 | V_124 |
V_125 ;
V_43 -> V_86 -> V_122 = V_126 ;
V_43 -> V_86 -> V_127 = 0 ;
V_43 -> V_86 -> V_128 = 11 ;
V_43 -> V_86 -> V_87 . V_129 [ 0 ] = 0x7FFF800 ;
V_43 -> V_86 -> V_87 . V_89 = V_130 ;
V_43 -> V_86 -> V_87 . V_88 = F_69 ( V_130 ) ;
V_43 -> V_86 -> V_131 = V_43 -> V_86 -> V_87 . V_89 [ 0 ] ;
F_70 ( & V_43 -> V_86 -> V_132 ) ;
F_4 ( V_1 , V_133 , 0 ) ;
F_61 ( V_1 ) ;
F_58 ( V_1 ) ;
F_60 ( V_1 ) ;
...
{
struct V_1 * V_1 = F_77 ( V_112 ) ;
F_5 ( & V_1 -> V_11 -> V_14 , L_33 ) ;
V_1 -> V_37 = 1 ;
F_78 ( & V_1 -> V_36 ) ;
F_54 ( & V_1 -> V_34 ) ;
F_38 ( V_1 ) ;
