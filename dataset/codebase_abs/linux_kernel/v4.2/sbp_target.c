...
char * V_245 )
{
return sprintf ( V_245 , L_64 , V_246 ) ;
}
static T_7 F_173 (
struct V_35 * V_22 ,
char * V_245 )
...
struct V_54 * V_55 = V_17 -> V_55 ;
if ( V_55 -> V_208 == - 1 )
return sprintf ( V_245 , L_65 ) ;
else
return sprintf ( V_245 , L_66 , V_55 -> V_208 ) ;
}
static T_7 F_174 (
struct V_35 * V_22 ,
const char * V_245 ,
...
if ( strstr ( V_245 , L_68 ) == V_245 ) {
V_55 -> V_208 = - 1 ;
} else {
if ( F_166 ( V_245 , 16 , & V_247 ) < 0 )
return - V_232 ;
if ( V_247 > 0xffffff )
return - V_232 ;
V_55 -> V_208 = V_247 ;
...
struct V_16 * V_17 = F_73 ( V_22 , struct V_16 , V_22 ) ;
struct V_54 * V_55 = V_17 -> V_55 ;
return sprintf ( V_245 , L_69 , V_55 -> V_195 ) ;
}
static T_7 F_176 (
struct V_35 * V_22 ,
const char * V_245 ,
...
struct V_16 * V_17 = F_73 ( V_22 , struct V_16 , V_22 ) ;
struct V_54 * V_55 = V_17 -> V_55 ;
return sprintf ( V_245 , L_69 , V_55 -> V_211 ) ;
}
static T_7 F_178 (
struct V_35 * V_22 ,
const char * V_245 ,
...
struct V_16 * V_17 = F_73 ( V_22 , struct V_16 , V_22 ) ;
struct V_54 * V_55 = V_17 -> V_55 ;
return sprintf ( V_245 , L_69 , V_55 -> V_73 ) ;
}
static T_7 F_180 (
struct V_35 * V_22 ,
const char * V_245 ,
...
struct V_16 * V_17 = F_73 ( V_22 , struct V_16 , V_22 ) ;
struct V_54 * V_55 = V_17 -> V_55 ;
return sprintf ( V_245 , L_69 , V_55 -> V_68 ) ;
}
static T_7 F_182 (
struct V_35 * V_22 ,
const char * V_245 ,
