...
static void F_35 ( struct V_26 * V_29 , unsigned int V_57 )
{
#ifdef F_32
F_33 ( V_57 , 0 ) ;
#endif
...
int F_36 ( struct V_47 * V_48 , int V_63 )
{
...
V_69 [ 1 ] = 0xFF ;
V_69 [ 2 ] = 0xFF ;
V_68 = F_40 ( V_22 , & V_69 [ 0 ] , V_77 , 3 ) ;
V_68 |= F_40 ( V_22 , & V_69 [ 0 ] , V_78 , 3 ) ;
V_68 |= F_40 ( V_22 , & V_69 [ 0 ] , V_23 , 3 ) ;
if ( V_68 < 0 ) {
F_38 ( V_48 , L_13 , V_68 ) ;
return V_68 ;
}
...
F_43 ( V_48 , L_16 , V_63 ) ;
V_68 = F_44 ( V_63 , NULL , F_9 ,
V_85 , L_17 , V_6 ) ;
if ( V_68 < 0 ) {
F_38 ( V_48 , L_18 , V_63 , V_68 ) ;
goto V_86;
}
V_6 -> V_12 = V_63 ;
F_45 ( & V_6 -> V_8 ) ;
