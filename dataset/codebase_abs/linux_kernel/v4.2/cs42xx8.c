...
F_19 ( V_9 -> V_28 , V_55 , V_56 ) ;
return 0 ;
}
int F_20 ( struct V_57 * V_26 , struct V_28 * V_28 )
{
const struct V_68 * V_69 = F_21 ( V_70 , V_26 ) ;
struct V_8 * V_9 ;
int V_71 , V_12 , V_45 ;
V_9 = F_22 ( V_26 , sizeof( * V_9 ) , V_72 ) ;
if ( V_9 == NULL )
return - V_73 ;
F_23 ( V_26 , V_9 ) ;
if ( V_69 )
...
V_9 -> V_75 = F_24 ( V_26 , L_5 ) ;
if ( F_25 ( V_9 -> V_75 ) ) {
F_4 ( V_26 , L_6 ,
F_26 ( V_9 -> V_75 ) ) ;
return - V_27 ;
}
V_9 -> V_10 = F_27 ( V_9 -> V_75 ) ;
...
static int F_37 ( struct V_57 * V_26 )
{
...
static int F_42 ( struct V_57 * V_26 )
{
struct V_8 * V_9 = F_38 ( V_26 ) ;
F_35 ( V_9 -> V_28 , true ) ;
F_36 ( F_8 ( V_9 -> V_76 ) ,
