...
static T_2 F_36 ( int V_75 , void * V_76 )
{
struct V_77 * V_78 = V_76 ;
struct V_49 * V_50 = V_78 -> V_50 ;
struct V_1 * V_2 = F_29 ( V_50 ) ;
int V_79 , V_4 , V_9 = 0 ;
F_22 ( & V_2 -> V_46 ) ;
F_37 (bit, indio_dev->active_scan_mask,
...
static int F_40 ( struct V_85 * V_83 )
{
struct V_49 * V_50 = F_41 ( V_83 ) ;
struct V_1 * V_2 = F_29 ( V_50 ) ;
int V_4 ;
if ( V_2 -> V_37 )
return 0 ;
...
static int F_42 ( struct V_85 * V_83 ,
bool V_73 )
{
struct V_49 * V_50 = F_41 ( V_83 ) ;
struct V_1 * V_2 = F_29 ( V_50 ) ;
...
static T_2 F_43 ( int V_75 , void * V_87 )
{
struct V_49 * V_50 = V_87 ;
struct V_1 * V_2 = F_29 ( V_50 ) ;
int V_4 ;
int V_67 ;
V_4 = F_8 ( V_2 -> V_5 , V_88 ) ;
if ( V_4 < 0 ) {
...
static T_2 F_47 ( int V_75 , void * V_87 )
{
struct V_49 * V_50 = V_87 ;
struct V_1 * V_2 = F_29 ( V_50 ) ;
if ( V_2 -> V_37 )
...
static int F_51 ( struct V_101 * V_5 ,
struct V_1 * V_2 )
{
struct V_102 * V_7 ;
struct V_103 * V_104 ;
...
V_108 = F_58 ( V_7 -> V_109 -> V_110 , V_7 ) ;
if ( ! V_108 )
return NULL ;
return F_59 ( V_7 ) ;
}
static int F_60 ( struct V_101 * V_5 ,
const struct V_111 * V_108 )
{
struct V_1 * V_2 ;
struct V_49 * V_50 ;
int V_4 ;
...
if ( F_64 ( & V_5 -> V_7 ) )
V_112 = F_57 ( & V_5 -> V_7 ) ;
V_50 -> V_7 . V_114 = & V_5 -> V_7 ;
V_50 -> V_115 = V_116 ;
V_50 -> V_117 = F_5 ( V_116 ) ;
V_50 -> V_112 = V_112 ;
V_50 -> V_118 = V_119 ;
V_50 -> V_69 = & V_120 ;
if ( V_5 -> V_75 <= 0 )
V_5 -> V_75 = F_51 ( V_5 , V_2 ) ;
if ( V_5 -> V_75 > 0 ) {
V_4 = F_65 ( & V_5 -> V_7 ,
V_5 -> V_75 ,
F_47 ,
...
if ( V_4 )
return V_4 ;
V_2 -> V_99 = F_66 ( & V_5 -> V_7 ,
L_24 ,
V_50 -> V_112 ,
V_50 -> V_108 ) ;
if ( ! V_2 -> V_99 )
return - V_113 ;
V_2 -> V_86 = F_66 ( & V_5 -> V_7 ,
L_25 ,
V_50 -> V_112 ,
V_50 -> V_108 ) ;
if ( ! V_2 -> V_86 )
return - V_113 ;
V_2 -> V_99 -> V_7 . V_114 = & V_5 -> V_7 ;
V_2 -> V_99 -> V_123 = & V_124 ;
F_67 ( V_2 -> V_99 , V_50 ) ;
V_4 = F_68 ( V_2 -> V_99 ) ;
if ( V_4 )
return V_4 ;
V_2 -> V_86 -> V_7 . V_114 = & V_5 -> V_7 ;
V_2 -> V_86 -> V_123 = & V_124 ;
F_67 ( V_2 -> V_86 , V_50 ) ;
V_4 = F_68 ( V_2 -> V_86 ) ;
if ( V_4 ) {
V_2 -> V_86 = NULL ;
