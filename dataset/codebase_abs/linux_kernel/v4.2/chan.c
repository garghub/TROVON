...
static bool F_26 ( struct V_34 * V_34 ,
enum V_46 V_47 ,
struct V_3 * V_4 )
{
struct V_95 * V_96 ;
struct V_97 * V_98 = F_27 ( V_34 ) ;
F_28 () ;
if ( ! F_29 ( V_99 ) ||
! ( V_34 -> V_100 & V_101 ) )
return false ;
...
if ( ! ( V_4 -> V_39 & V_103 ) )
return false ;
F_31 (wdev, &rdev->wdev_list, list) {
struct V_3 * V_104 = NULL ;
int V_66 , V_67 ;
F_32 ( V_96 ) ;
if ( V_96 -> V_47 == V_53 &&
V_96 -> V_105 )
V_104 = V_96 -> V_105 -> V_106 . V_107 ;
if ( V_47 == V_51 &&
V_96 -> V_47 == V_51 &&
V_96 -> V_108 &&
! ( V_4 -> V_39 & V_102 ) )
...
static bool F_35 ( struct V_34 * V_34 ,
struct V_1 * V_2 ,
enum V_46 V_47 ,
bool V_110 )
{
...
bool F_38 ( struct V_34 * V_34 ,
struct V_1 * V_2 ,
enum V_46 V_47 )
{
return F_35 ( V_34 , V_2 , V_47 , true ) ;
}
bool F_39 ( struct V_34 * V_34 ,
struct V_1 * V_2 ,
enum V_46 V_47 )
{
bool V_110 ;
F_28 () ;
V_110 = ! F_26 ( V_34 , V_47 ,
V_2 -> V_4 ) ;
return F_35 ( V_34 , V_2 , V_47 , V_110 ) ;
}
...
* V_118 = V_120 ;
F_44 ( V_96 ) ;
if ( V_96 -> V_121 && ! F_45 ( V_96 -> V_121 ) )
return;
switch ( V_96 -> V_47 ) {
case V_49 :
if ( V_96 -> V_105 ) {
* V_4 = V_96 -> V_105 -> V_106 . V_107 ;
* V_118 = ( V_96 -> V_122 &&
! V_96 -> V_123 )
? V_124
: V_125 ;
if ( V_96 -> V_123 )
* V_119 |= F_16 ( V_96 -> V_2 . V_9 ) ;
return;
}
break;
case V_53 :
