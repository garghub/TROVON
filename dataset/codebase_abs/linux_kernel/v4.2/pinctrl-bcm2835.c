...
case V_37 :
F_31 ( V_2 , V_38 , V_18 , V_36 ) ;
break;
case V_39 :
F_31 ( V_2 , V_40 , V_18 , V_36 ) ;
break;
case V_41 :
F_31 ( V_2 , V_38 , V_18 , V_36 ) ;
F_31 ( V_2 , V_40 , V_18 , V_36 ) ;
break;
case V_42 :
F_31 ( V_2 , V_43 , V_18 , V_36 ) ;
break;
case V_44 :
F_31 ( V_2 , V_45 , V_18 , V_36 ) ;
break;
}
}
static void F_33 ( struct V_46 * V_47 )
{
struct V_1 * V_2 = F_34 ( V_47 ) ;
unsigned V_30 = F_35 ( V_47 ) ;
unsigned V_18 = F_7 ( V_30 ) ;
unsigned V_28 = F_6 ( V_30 ) ;
unsigned long V_48 ;
F_36 ( & V_2 -> V_49 [ V_28 ] , V_48 ) ;
F_37 ( V_18 , & V_2 -> V_32 [ V_28 ] ) ;
F_32 ( V_2 , V_30 , true ) ;
F_38 ( & V_2 -> V_49 [ V_28 ] , V_48 ) ;
}
...
static int F_43 ( struct V_46 * V_47 , unsigned int type )
{
struct V_1 * V_2 = F_34 ( V_47 ) ;
unsigned V_30 = F_35 ( V_47 ) ;
unsigned V_18 = F_7 ( V_30 ) ;
...
V_52 = F_42 ( V_2 , V_30 , type ) ;
else
V_52 = F_41 ( V_2 , V_30 , type ) ;
if ( type & V_41 )
F_45 ( V_47 -> V_24 , V_53 ) ;
else
F_45 ( V_47 -> V_24 , V_54 ) ;
...
static const char * F_49 ( struct V_55 * V_56 ,
unsigned V_58 )
{
return V_57 [ V_58 ] ;
}
...
V_72 = F_61 ( sizeof( * V_72 ) , V_82 ) ;
if ( ! V_72 )
return - V_83 ;
V_72 [ 0 ] = F_62 ( V_84 , V_81 ) ;
V_76 -> type = V_71 ;
...
int V_70 , V_95 ;
T_1 V_8 , V_96 , V_81 ;
V_59 = F_64 ( V_74 , L_10 , NULL ) ;
if ( ! V_59 ) {
F_58 ( V_2 -> V_11 , L_11 ,
F_59 ( V_74 ) ) ;
return - V_51 ;
}
V_89 = F_64 ( V_74 , L_12 , NULL ) ;
V_90 = F_64 ( V_74 , L_13 , NULL ) ;
if ( ! V_89 && ! V_90 ) {
F_58 ( V_2 -> V_11 ,
L_14 ,
F_59 ( V_74 ) ) ;
...
if ( V_92 )
V_93 ++ ;
V_94 = V_68 = F_61 ( V_60 * V_93 * sizeof( * V_68 ) ,
V_82 ) ;
if ( ! V_68 )
return - V_83 ;
for ( V_70 = 0 ; V_70 < V_60 ; V_70 ++ ) {
V_95 = F_65 ( V_74 , L_10 , V_70 , & V_8 ) ;
if ( V_95 )
goto V_98;
if ( V_8 >= F_48 ( V_61 ) ) {
F_58 ( V_2 -> V_11 , L_17 ,
...
static const char * F_67 ( struct V_55 * V_56 ,
unsigned V_58 )
{
return V_12 [ V_58 ] ;
}
...
V_111 = F_74 ( V_72 [ V_70 ] ) ;
V_112 = F_75 ( V_72 [ V_70 ] ) ;
if ( V_111 != V_84 )
return - V_51 ;
V_113 = F_6 ( V_8 ) ;
V_6 = F_7 ( V_8 ) ;
...
static int F_77 ( struct V_116 * V_117 )
{
...
struct V_120 V_121 ;
int V_95 , V_70 ;
F_78 ( F_48 ( V_61 ) != V_122 ) ;
F_78 ( F_48 ( V_57 ) != V_122 ) ;
V_2 = F_79 ( V_11 , sizeof( * V_2 ) , V_82 ) ;
if ( ! V_2 )
return - V_83 ;
F_80 ( V_117 , V_2 ) ;
V_2 -> V_11 = V_11 ;
V_95 = F_81 ( V_74 , 0 , & V_121 ) ;
if ( V_95 ) {
F_58 ( V_11 , L_18 ) ;
return V_95 ;
}
V_2 -> V_4 = F_82 ( V_11 , & V_121 ) ;
if ( F_83 ( V_2 -> V_4 ) )
return F_84 ( V_2 -> V_4 ) ;
V_2 -> V_16 = V_123 ;
V_2 -> V_16 . V_11 = V_11 ;
V_2 -> V_16 . V_119 = V_74 ;
V_2 -> V_23 = F_85 ( V_74 , V_122 ,
& V_124 , NULL ) ;
if ( ! V_2 -> V_23 ) {
F_58 ( V_11 , L_19 ) ;
return - V_83 ;
...
V_2 -> V_24 [ V_70 ] = F_91 ( V_74 , V_70 ) ;
V_2 -> V_46 [ V_70 ] . V_2 = V_2 ;
V_2 -> V_46 [ V_70 ] . V_28 = V_70 ;
F_92 ( & V_2 -> V_49 [ V_70 ] ) ;
V_129 = strlen ( F_93 ( V_2 -> V_11 ) ) + 16 ;
V_86 = F_79 ( V_2 -> V_11 , V_129 , V_82 ) ;
if ( ! V_86 )
return - V_83 ;
snprintf ( V_86 , V_129 , L_20 , F_93 ( V_2 -> V_11 ) , V_70 ) ;
V_95 = F_94 ( V_11 , V_2 -> V_24 [ V_70 ] ,
F_28 , V_132 ,
V_86 , & V_2 -> V_46 [ V_70 ] ) ;
if ( V_95 ) {
F_58 ( V_11 , L_21 , V_2 -> V_24 [ V_70 ] ) ;
return V_95 ;
}
}
V_95 = F_95 ( & V_2 -> V_16 ) ;
...
V_2 -> V_133 = F_96 ( & V_134 , V_11 , V_2 ) ;
if ( F_83 ( V_2 -> V_133 ) ) {
F_97 ( & V_2 -> V_16 ) ;
return F_84 ( V_2 -> V_133 ) ;
}
V_2 -> V_135 = V_136 ;
V_2 -> V_135 . V_4 = V_2 -> V_16 . V_4 ;
V_2 -> V_135 . V_137 = & V_2 -> V_16 ;
F_98 ( V_2 -> V_133 , & V_2 -> V_135 ) ;
return 0 ;
}
static int F_99 ( struct V_116 * V_117 )
{
struct V_1 * V_2 = F_100 ( V_117 ) ;
F_101 ( V_2 -> V_133 ) ;
F_97 ( & V_2 -> V_16 ) ;
return 0 ;
}
