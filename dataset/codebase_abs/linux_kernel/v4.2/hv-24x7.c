...
V_146 = ( void * ) F_79 ( V_171 ) ;
V_148 = ( void * ) F_79 ( V_172 ) ;
F_68 ( V_146 , V_148 ) ;
...
V_170 = & V_148 -> V_174 [ 0 ] ;
* V_141 = F_57 ( V_170 -> V_175 [ 0 ] . V_176 [ 0 ] ) ;
V_173:
F_80 ( V_171 ) ;
F_80 ( V_172 ) ;
return V_123 ;
...
static void F_89 ( struct V_162 * V_24 , T_6 V_193 )
{
T_15 V_194 ;
V_194 = F_90 ( & V_24 -> V_195 . V_196 , V_193 ) ;
F_91 ( V_193 - V_194 , & V_24 -> V_141 ) ;
}
...
static void F_93 ( struct V_162 * V_24 , int V_197 )
{
if ( V_197 & V_198 )
F_94 ( & V_24 -> V_195 . V_196 , F_88 ( V_24 ) ) ;
}
static void F_95 ( struct V_162 * V_24 , int V_197 )
{
F_92 ( V_24 ) ;
}
static int F_96 ( struct V_162 * V_24 , int V_197 )
{
if ( V_197 & V_199 )
F_93 ( V_24 , V_197 ) ;
return 0 ;
...
V_119 = F_99 ( L_61 , 4096 , 4096 , 0 , NULL ) ;
if ( ! V_119 )
return - V_88 ;
V_202 . V_203 |= V_204 ;
V_74 = F_55 ( & V_205 . V_62 ,
& V_206 . V_62 ,
& V_207 . V_62 ) ;
if ( V_74 )
return V_74 ;
V_74 = F_100 ( & V_202 , V_202 . V_42 , - 1 ) ;
if ( V_74 )
return V_74 ;
return 0 ;
}
