...
V_72 = & V_70 -> V_72 [ V_83 - 1 ] ;
F_36 ( V_1 , V_17 ,
F_37 ( V_17 , V_72 -> V_75 . V_84 ) ,
V_73 , V_44 ,
F_20 , V_3 ,
V_72 -> V_75 . V_85 ) ;
return 0 ;
...
{
F_5 ( 8 , L_10 ) ;
F_11 ( V_3 , V_87 , 0 , NULL , NULL ) ;
}
static void
F_44 ( struct V_1 * V_1 , struct V_64 * V_17 ,
unsigned int V_32 , void * V_73 , int V_103 ,
int V_104 , T_5 V_24 ,
void * V_25 )
{
int V_105 ;
...
V_1 -> V_111 [ V_105 ] . V_112 = V_104 * V_105 ;
V_1 -> V_111 [ V_105 ] . V_113 = V_104 ;
V_1 -> V_111 [ V_105 ] . V_45 = 0 ;
}
}
int
F_45 ( struct V_1 * V_1 [ 2 ] , struct V_64 * V_17 ,
unsigned int V_32 , int V_103 ,
int V_104 , int V_114 ,
T_5 V_24 , void * V_25 )
{
int V_43 , V_115 ;
...
for ( V_43 = 0 ; V_43 < 2 ; V_43 ++ ) {
V_115 = - V_80 ;
V_1 [ V_43 ] = F_30 ( V_103 , V_79 ) ;
if ( ! V_1 [ V_43 ] )
goto V_116;
V_73 = F_35 ( V_114 , V_79 ) ;
if ( ! V_73 )
goto V_116;
...
{
struct V_117 * V_118 = V_1 -> V_25 ;
unsigned char * V_119 ;
struct V_120 * V_121 ;
int V_122 , V_123 , V_37 ;
if ( F_16 ( V_1 -> V_37 < 0 ) ) {
switch ( V_1 -> V_37 ) {
case - V_38 :
case - V_39 :
...
memcpy ( V_118 -> V_126 , V_119 , V_122 ) ;
V_37 = V_122 ;
V_122 = 0 ;
} else {
V_37 = F_50 ( & V_118 -> V_127 , V_119 , V_122 , & V_123 ,
V_118 -> V_126 , V_118 -> V_128 ) ;
V_119 += V_123 ;
V_122 -= V_123 ;
}
if ( V_37 > 0 ) {
F_5 ( 4 , L_14 , V_37 ) ;
F_21 ( 0x400 , V_118 -> V_126 , V_37 ) ;
if ( ! ( V_121 = F_51 ( V_37 ) ) ) {
F_9 ( L_15 ) ;
break;
}
memcpy ( F_52 ( V_121 , V_37 ) , V_118 -> V_126 , V_37 ) ;
V_118 -> V_129 -> V_130 ( V_118 -> V_129 , V_131 | V_132 , V_121 ) ;
} else if ( V_37 == - V_133 ) {
F_53 ( L_16 ) ;
} else if ( V_37 == - V_134 ) {
F_53 ( L_17 ) ;
...
V_1 -> V_17 = V_118 -> V_3 -> V_18 ;
V_1 -> V_45 = 0 ;
F_6 ( V_1 , V_19 ) ;
}
int F_54 ( struct V_117 * V_118 )
{
struct V_64 * V_17 = V_118 -> V_3 -> V_18 ;
int V_115 ;
F_5 ( 4 , L_10 ) ;
V_118 -> V_126 = F_35 ( V_118 -> V_128 , V_79 ) ;
V_115 = - V_80 ;
if ( ! V_118 -> V_126 )
goto V_116;
V_115 = F_45 ( V_118 -> V_1 , V_17 ,
F_55 ( V_17 , V_118 -> V_136 ) ,
...
for ( V_139 = & V_1 -> V_111 [ 0 ] ,
V_140 = & V_1 -> V_111 [ V_1 -> V_107 ] ,
V_142 = V_1 -> V_41 ;
V_139 < V_140 ;
V_139 ++ ) {
if ( V_139 -> V_37 < 0 ) {
...
return ( V_142 - ( unsigned char * ) V_1 -> V_41 ) ;
}
static void F_57 ( void * V_25 )
{
struct V_117 * V_118 = V_25 ;
struct V_2 * V_3 = V_118 -> V_3 ;
F_5 ( 4 , L_10 ) ;
V_118 -> V_1 [ 0 ] -> V_17 = V_3 -> V_18 ;
F_6 ( V_118 -> V_1 [ 0 ] , V_79 ) ;
V_118 -> V_1 [ 1 ] -> V_17 = V_3 -> V_18 ;
F_6 ( V_118 -> V_1 [ 1 ] , V_79 ) ;
}
void F_58 ( struct V_117 * V_118 , int V_124 )
{
if ( V_118 -> V_124 == V_124 )
return;
V_118 -> V_124 = V_124 ;
F_59 ( V_118 -> V_1 [ 0 ] ) ;
F_59 ( V_118 -> V_1 [ 1 ] ) ;
if ( V_118 -> V_124 != V_143 ) {
if ( V_118 -> V_124 != V_125 ) {
T_6 V_144 = V_145 ;
if ( V_118 -> V_124 == V_146 )
V_144 |= V_147 ;
F_60 ( & V_118 -> V_127 , V_144 ) ;
}
F_12 ( V_118 -> V_3 , V_118 -> V_136 , NULL , NULL ) ;
F_11 ( V_118 -> V_3 , V_118 -> V_148 ,
V_118 -> V_104 ,
NULL , NULL ) ;
F_57 ( V_118 ) ;
} else {
