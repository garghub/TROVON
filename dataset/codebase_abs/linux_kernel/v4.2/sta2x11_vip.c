...
{
F_67 ( & V_6 -> V_139 , 0 ) ;
V_6 -> V_42 . V_140 = & V_6 -> V_139 ;
if ( V_6 -> V_139 . error ) {
int V_125 = V_6 -> V_139 . error ;
F_68 ( & V_6 -> V_139 ) ;
return V_125 ;
}
return 0 ;
}
static int F_69 ( struct V_141 * V_126 , int V_142 , int V_143 ,
const char * V_84 )
{
int V_86 ;
if ( V_142 == - 1 )
return 0 ;
V_86 = F_70 ( V_142 , V_84 ) ;
if ( V_86 ) {
F_71 ( V_126 , L_11 , V_142 , V_84 ) ;
return V_86 ;
}
V_86 = F_72 ( V_142 , V_143 ) ;
if ( V_86 ) {
F_71 ( V_126 , L_12 ,
V_142 , V_84 ) ;
F_73 ( V_142 ) ;
...
V_86 = F_74 ( V_142 , false ) ;
if ( V_86 ) {
F_71 ( V_126 , L_13 , V_142 , V_84 ) ;
F_73 ( V_142 ) ;
return V_86 ;
}
return 0 ;
}
static void F_75 ( struct V_141 * V_126 , int V_142 , const char * V_84 )
{
if ( V_142 != - 1 ) {
F_76 ( V_126 , L_14 , V_142 , V_84 ) ;
F_77 ( V_142 ) ;
F_73 ( V_142 ) ;
}
}
static int F_78 ( struct V_144 * V_58 ,
...
if ( V_86 )
return V_86 ;
V_148 = F_81 ( & V_58 -> V_126 ) ;
if ( ! V_148 ) {
F_82 ( & V_58 -> V_126 , L_16 ) ;
V_86 = - V_43 ;
goto V_149;
}
V_86 = F_69 ( & V_58 -> V_126 , V_148 -> V_150 , 0 ,
V_148 -> V_151 ) ;
if ( V_86 )
goto V_149;
if ( V_148 -> V_152 >= 0 ) {
V_86 = F_69 ( & V_58 -> V_126 , V_148 -> V_152 , 0 ,
V_148 -> V_153 ) ;
if ( V_86 ) {
F_75 ( & V_58 -> V_126 , V_148 -> V_150 ,
V_148 -> V_151 ) ;
goto V_149;
}
}
if ( V_148 -> V_150 != - 1 ) {
F_83 ( 5000 , 25000 ) ;
V_86 = F_72 ( V_148 -> V_150 , 1 ) ;
}
if ( V_148 -> V_152 != - 1 ) {
F_83 ( 5000 , 25000 ) ;
V_86 = F_72 ( V_148 -> V_152 , 1 ) ;
}
F_83 ( 5000 , 25000 ) ;
V_6 = F_84 ( sizeof( struct V_5 ) , V_154 ) ;
if ( ! V_6 ) {
V_86 = - V_155 ;
goto V_156;
}
...
V_6 -> V_166 = V_167 ;
V_6 -> V_166 . V_42 = & V_6 -> V_42 ;
V_6 -> V_166 . V_168 = & V_6 -> V_28 ;
F_93 ( & V_6 -> V_166 , V_6 ) ;
V_86 = F_94 ( & V_6 -> V_166 , V_169 , - 1 ) ;
if ( V_86 )
goto V_170;
V_6 -> V_171 = F_95 ( V_6 -> V_148 -> V_172 ) ;
if ( ! V_6 -> V_171 ) {
V_86 = - V_164 ;
F_71 ( & V_58 -> V_126 , L_19 ) ;
goto V_173;
}
V_6 -> V_70 = F_96 ( & V_6 -> V_42 , V_6 -> V_171 ,
L_20 , V_6 -> V_148 -> V_174 ,
NULL ) ;
if ( ! V_6 -> V_70 ) {
V_86 = - V_164 ;
...
F_105 ( V_6 ) ;
V_156:
F_75 ( & V_58 -> V_126 , V_148 -> V_152 , V_148 -> V_153 ) ;
F_75 ( & V_58 -> V_126 , V_148 -> V_150 , V_148 -> V_151 ) ;
V_149:
return V_86 ;
}
static void F_106 ( struct V_144 * V_58 )
{
struct V_177 * V_42 = F_107 ( V_58 ) ;
struct V_5 * V_6 =
...
F_103 ( V_58 ) ;
F_104 ( & V_6 -> V_42 ) ;
F_75 ( & V_58 -> V_126 , V_6 -> V_148 -> V_150 ,
V_6 -> V_148 -> V_151 ) ;
F_75 ( & V_58 -> V_126 , V_6 -> V_148 -> V_152 ,
V_6 -> V_148 -> V_153 ) ;
F_105 ( V_6 ) ;
}
static int F_108 ( struct V_144 * V_58 , T_4 V_178 )
{
struct V_177 * V_42 = F_107 ( V_58 ) ;
struct V_5 * V_6 =
F_2 ( V_42 , struct V_5 , V_42 ) ;
...
F_3 ( V_6 , V_45 , 0 ) ;
for ( V_85 = 1 ; V_85 < V_181 ; V_85 ++ )
V_6 -> V_179 [ V_85 ] = F_5 ( V_6 , 4 * V_85 ) ;
for ( V_85 = 0 ; V_85 < V_182 ; V_85 ++ )
V_6 -> V_179 [ V_181 + V_183 + V_85 ] =
F_5 ( V_6 , V_184 [ V_85 ] ) ;
F_110 ( & V_6 -> V_16 , V_94 ) ;
F_111 ( V_58 ) ;
if ( F_112 ( V_58 , F_113 ( V_58 , V_178 ) ) ) {
V_6 -> V_185 = 1 ;
}
F_52 ( L_23 ) ;
return 0 ;
}
static int F_114 ( struct V_144 * V_58 )
{
struct V_177 * V_42 = F_107 ( V_58 ) ;
struct V_5 * V_6 =
F_2 ( V_42 , struct V_5 , V_42 ) ;
