...
static int F_66 ( struct V_80 * V_102 )
{
...
V_108 = F_67 ( V_111 , V_42 ) ;
if ( ! V_108 )
return - V_82 ;
V_110 = V_108 -> V_112 ;
V_106 = V_110 -> V_113 ;
V_5 = F_68 ( V_42 , sizeof( * V_5 ) , V_92 ) ;
if ( ! V_5 )
return - V_93 ;
V_5 -> V_42 = V_42 ;
F_69 ( V_102 , V_5 ) ;
V_105 = F_70 ( V_102 , V_114 , 0 ) ;
V_5 -> V_12 = F_71 ( V_42 , V_105 ) ;
if ( F_62 ( V_5 -> V_12 ) ) {
F_27 ( V_42 , L_15 ) ;
return F_63 ( V_5 -> V_12 ) ;
}
V_105 = F_70 ( V_102 , V_114 , 1 ) ;
if ( V_105 ) {
V_5 -> V_60 = F_71 ( V_42 , V_105 ) ;
if ( F_62 ( V_5 -> V_60 ) ) {
F_27 ( V_42 , L_15 ) ;
return F_63 ( V_5 -> V_60 ) ;
}
}
F_72 ( & V_5 -> V_32 ) ;
V_3 = & V_5 -> V_3 ;
