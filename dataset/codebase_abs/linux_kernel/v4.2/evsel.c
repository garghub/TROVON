...
static void F_61 ( struct V_1 * T_1 )
{
F_60 ( T_1 -> V_178 ) ;
T_1 -> V_178 = NULL ;
}
...
void F_63 ( struct V_1 * T_1 , int V_173 , int V_174 )
{
int V_175 , V_176 ;
if ( T_1 -> V_177 )
V_174 = 1 ;
for ( V_175 = 0 ; V_175 < V_173 ; V_175 ++ )
for ( V_176 = 0 ; V_176 < V_174 ; ++ V_176 ) {
F_64 ( F_54 ( T_1 , V_175 , V_176 ) ) ;
F_54 ( T_1 , V_175 , V_176 ) = - 1 ;
}
}
void F_65 ( struct V_1 * T_1 )
{
assert ( F_66 ( & T_1 -> V_37 ) ) ;
F_61 ( T_1 ) ;
F_62 ( T_1 ) ;
F_67 ( T_1 -> V_187 ) ;
F_68 ( T_1 -> V_188 ) ;
...
void F_71 ( struct V_1 * T_1 , int V_175 , int V_176 ,
struct V_190 * V_191 )
{
struct V_190 V_192 ;
if ( ! T_1 -> V_193 )
return;
if ( V_175 == - 1 ) {
V_192 = T_1 -> V_193 -> V_194 ;
T_1 -> V_193 -> V_194 = * V_191 ;
} else {
V_192 = * F_72 ( T_1 -> V_193 , V_175 , V_176 ) ;
* F_72 ( T_1 -> V_193 , V_175 , V_176 ) = * V_191 ;
}
V_191 -> V_195 = V_191 -> V_195 - V_192 . V_195 ;
V_191 -> V_196 = V_191 -> V_196 - V_192 . V_196 ;
V_191 -> V_197 = V_191 -> V_197 - V_192 . V_197 ;
}
void F_73 ( struct V_190 * V_191 ,
bool V_36 , T_7 * V_198 )
{
T_7 V_199 = 0 ;
if ( V_36 ) {
...
V_199 = - 1 ;
V_191 -> V_195 = 0 ;
} else if ( V_191 -> V_197 < V_191 -> V_196 ) {
V_199 = 1 ;
V_191 -> V_195 = ( T_3 ) ( ( double ) V_191 -> V_195 * V_191 -> V_196 / V_191 -> V_197 + 0.5 ) ;
}
} else
V_191 -> V_196 = V_191 -> V_197 = 0 ;
if ( V_198 )
* V_198 = V_199 ;
}
...
return - V_7 ;
if ( F_75 ( F_54 ( T_1 , V_175 , V_176 ) , V_191 , sizeof( * V_191 ) ) < 0 )
return - V_200 ;
return 0 ;
}
...
if ( F_54 ( T_1 , V_175 , V_176 ) < 0 )
return - V_7 ;
if ( T_1 -> V_202 == NULL && F_77 ( T_1 , V_175 + 1 , V_176 + 1 ) < 0 )
return - V_179 ;
if ( F_75 ( F_54 ( T_1 , V_175 , V_176 ) , & V_191 , V_201 * sizeof( T_3 ) ) < 0 )
return - V_200 ;
F_71 ( T_1 , V_175 , V_176 , & V_191 ) ;
F_73 ( & V_191 , V_36 , NULL ) ;
* F_72 ( T_1 -> V_202 , V_175 , V_176 ) = V_191 ;
return 0 ;
}
static int F_78 ( struct V_1 * T_1 , int V_175 , int V_176 )
{
struct V_1 * V_34 = T_1 -> V_34 ;
int V_178 ;
if ( F_50 ( T_1 ) )
...
static void F_80 ( char * V_92 , T_2 V_6 , T_3 V_203 , struct V_204 * V_205 )
{
bool V_206 = true ;
int V_11 = 0 ;
do {
if ( V_203 & V_205 [ V_11 ] . V_25 ) {
V_92 += F_27 ( V_92 , V_6 , L_34 , V_206 ? L_1 : L_35 , V_205 [ V_11 ] . V_39 ) ;
V_206 = false ;
}
} while ( V_205 [ ++ V_11 ] . V_39 != NULL );
}
static void F_81 ( char * V_92 , T_2 V_6 , T_3 V_203 )
{
#define F_82 ( T_8 ) { PERF_SAMPLE_##n, #n }
struct V_204 V_205 [] = {
F_82 ( V_123 ) , F_82 ( V_124 ) , F_82 ( TIME ) , F_82 ( V_140 ) ,
F_82 ( V_126 ) , F_82 ( V_97 ) , F_82 ( V_28 ) , F_82 ( V_147 ) ,
F_82 ( V_134 ) , F_82 ( V_207 ) , F_82 ( V_151 ) ,
F_82 ( V_102 ) , F_82 ( V_107 ) , F_82 ( V_108 ) ,
F_82 ( V_29 ) , F_82 ( V_146 ) ,
{ . V_39 = NULL , }
} ;
#undef F_82
F_80 ( V_92 , V_6 , V_203 , V_205 ) ;
}
static void F_83 ( char * V_92 , T_2 V_6 , T_3 V_203 )
{
#define F_82 ( T_8 ) { PERF_FORMAT_##n, #n }
struct V_204 V_205 [] = {
F_82 ( V_208 ) , F_82 ( V_209 ) ,
F_82 ( V_28 ) , F_82 ( V_210 ) ,
{ . V_39 = NULL , }
} ;
#undef F_82
F_80 ( V_92 , V_6 , V_203 , V_205 ) ;
}
int F_84 ( T_9 * V_211 , struct V_32 * V_22 ,
T_10 V_212 , void * V_213 )
{
char V_92 [ V_214 ] ;
int V_85 = 0 ;
F_85 ( type , V_215 ) ;
...
F_85 ( V_223 , V_215 ) ;
F_85 ( V_172 , V_215 ) ;
F_86 ( L_37 , V_155 , V_215 ) ;
F_85 ( V_73 , V_215 ) ;
F_86 ( L_38 , V_72 , V_216 ) ;
F_86 ( L_39 , V_224 , V_216 ) ;
F_85 ( V_109 , V_216 ) ;
F_85 ( V_111 , V_215 ) ;
F_85 ( V_171 , V_225 ) ;
F_85 ( V_145 , V_216 ) ;
...
static int F_87 ( struct V_1 * T_1 , struct V_227 * V_188 ,
struct V_228 * V_189 )
{
...
V_174 = V_189 -> V_236 ;
if ( T_1 -> V_178 == NULL &&
F_52 ( T_1 , V_188 -> V_236 , V_174 ) < 0 )
return - V_179 ;
if ( T_1 -> V_187 ) {
V_229 |= V_237 ;
V_231 = T_1 -> V_187 -> V_178 ;
}
V_238:
if ( V_120 . V_239 )
...
fprintf ( V_244 , L_41 ) ;
F_84 ( V_244 , & T_1 -> V_22 , V_246 , NULL ) ;
fprintf ( V_244 , L_40 , V_245 ) ;
}
for ( V_175 = 0 ; V_175 < V_188 -> V_236 ; V_175 ++ ) {
for ( V_176 = 0 ; V_176 < V_174 ; V_176 ++ ) {
int V_247 ;
if ( ! T_1 -> V_187 && ! T_1 -> V_177 )
V_231 = F_88 ( V_189 , V_176 ) ;
V_247 = F_78 ( T_1 , V_175 , V_176 ) ;
V_248:
F_89 ( L_42 ,
V_231 , V_188 -> V_249 [ V_175 ] , V_247 , V_229 ) ;
F_54 ( T_1 , V_175 , V_176 ) = F_90 ( & T_1 -> V_22 ,
V_231 ,
V_188 -> V_249 [ V_175 ] ,
V_247 , V_229 ) ;
if ( F_54 ( T_1 , V_175 , V_176 ) < 0 ) {
...
void F_93 ( struct V_1 * T_1 , int V_173 , int V_174 )
{
if ( T_1 -> V_178 == NULL )
return;
F_63 ( T_1 , V_173 , V_174 ) ;
F_61 ( T_1 ) ;
}
int F_94 ( struct V_1 * T_1 , struct V_227 * V_188 ,
struct V_228 * V_189 )
{
if ( V_188 == NULL ) {
V_188 = & V_259 . V_249 ;
...
if ( V_189 == NULL )
V_189 = & V_260 . V_249 ;
return F_87 ( T_1 , V_188 , V_189 ) ;
}
int F_95 ( struct V_1 * T_1 ,
struct V_227 * V_188 )
{
return F_87 ( T_1 , V_188 , & V_260 . V_249 ) ;
}
int F_96 ( struct V_1 * T_1 ,
struct V_228 * V_189 )
{
return F_87 ( T_1 , & V_259 . V_249 , V_189 ) ;
}
static int F_97 ( const struct V_1 * T_1 ,
...
V_269 . V_271 = * V_265 ;
if ( V_266 ) {
V_269 . V_271 = F_98 ( V_269 . V_271 ) ;
V_269 . V_272 [ 0 ] = F_99 ( V_269 . V_272 [ 0 ] ) ;
}
...
V_269 . V_271 = F_98 ( V_269 . V_271 ) ;
V_269 . V_272 [ 0 ] = F_99 ( V_269 . V_272 [ 0 ] ) ;
V_269 . V_272 [ 1 ] = F_99 ( V_269 . V_272 [ 1 ] ) ;
}
...
static inline bool F_100 ( const void * V_275 , T_11 V_276 , const void * V_277 ,
T_3 V_6 )
{
return V_6 > V_276 || V_277 + V_6 > V_275 ;
}
int F_101 ( struct V_1 * T_1 , union V_261 * V_262 ,
struct V_263 * V_278 )
{
T_3 type = T_1 -> V_22 . V_8 ;
bool V_266 = T_1 -> V_267 ;
const T_3 * V_265 ;
T_11 V_276 = V_262 -> V_270 . V_6 ;
...
if ( F_104 ( V_278 -> V_309 . V_6 > V_279 ,
L_45 ) )
return - V_282 ;
}
}
...
T_2 F_106 ( const struct V_263 * V_264 , T_3 type ,
T_3 V_30 )
{
...
V_76 += sizeof( T_3 ) ;
V_279 = F_105 ( V_264 -> V_305 . V_9 ) * sizeof( T_3 ) ;
V_76 += V_279 ;
} else {
V_76 += sizeof( T_3 ) ;
}
...
V_76 += sizeof( T_3 ) ;
V_279 = F_105 ( V_264 -> V_316 . V_9 ) * sizeof( T_3 ) ;
V_76 += V_279 ;
} else {
V_76 += sizeof( T_3 ) ;
}
...
int F_107 ( union V_261 * V_262 , T_3 type ,
T_3 V_30 ,
...
struct V_320 * F_108 ( struct V_1 * T_1 , const char * V_39 )
{
return F_109 ( T_1 -> V_44 , V_39 ) ;
}
void * F_110 ( struct V_1 * T_1 , struct V_263 * V_264 ,
const char * V_39 )
{
struct V_320 * V_321 = F_108 ( T_1 , V_39 ) ;
int V_277 ;
if ( ! V_321 )
return NULL ;
V_277 = V_321 -> V_277 ;
...
T_3 F_111 ( struct V_1 * T_1 , struct V_263 * V_264 ,
const char * V_39 )
{
struct V_320 * V_321 = F_108 ( T_1 , V_39 ) ;
void * V_323 ;
...
static int F_113 ( T_9 * V_211 , bool * V_324 , const char * V_325 , ... )
{
T_12 args ;
int V_85 = 0 ;
if ( ! * V_324 ) {
V_85 += fprintf ( V_211 , L_46 ) ;
} else {
V_85 += fprintf ( V_211 , L_9 ) ;
* V_324 = false ;
}
va_start ( args , V_325 ) ;
V_85 += vfprintf ( V_211 , V_325 , args ) ;
va_end ( args ) ;
return V_85 ;
}
static int F_114 ( T_9 * V_211 , const char * V_39 , const char * V_195 , void * V_213 )
{
return F_113 ( V_211 , ( bool * ) V_213 , L_47 , V_39 , V_195 ) ;
}
int F_115 ( struct V_1 * T_1 ,
struct V_326 * V_327 , T_9 * V_211 )
{
bool V_324 = true ;
int V_328 = 0 ;
if ( V_327 -> V_329 ) {
...
return 0 ;
if ( T_1 -> V_127 > 1 )
V_328 += fprintf ( V_211 , L_48 , T_1 -> V_91 ? : L_1 ) ;
V_328 += fprintf ( V_211 , L_6 , F_39 ( T_1 ) ) ;
F_43 (pos, evsel)
V_328 += fprintf ( V_211 , L_49 , F_39 ( V_93 ) ) ;
if ( T_1 -> V_127 > 1 )
V_328 += fprintf ( V_211 , L_50 ) ;
goto V_330;
}
V_328 += fprintf ( V_211 , L_6 , F_39 ( T_1 ) ) ;
if ( V_327 -> V_243 ) {
V_328 += F_84 ( V_211 , & T_1 -> V_22 ,
F_114 , & V_324 ) ;
} else if ( V_327 -> V_133 ) {
V_328 += F_113 ( V_211 , & V_324 , L_51 V_331 ,
( T_3 ) T_1 -> V_22 . V_135 ) ;
}
V_330:
fputc ( '\n' , V_211 ) ;
...
bool F_116 ( struct V_1 * T_1 , int V_80 ,
...
int F_117 ( struct V_1 * T_1 , struct V_116 * V_116 ,
...
case V_7 :
if ( V_120 . V_171 )
return F_27 ( V_332 , V_6 , L_72 ) ;
if ( V_120 . V_239 )
return F_27 ( V_332 , V_6 , L_73 , V_171 ) ;
break;
default:
break;
}
...
L_75
L_76 ,
V_80 , F_120 ( V_80 , V_339 , sizeof( V_339 ) ) ,
F_39 ( T_1 ) ) ;
}
