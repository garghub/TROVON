...
F_2 ( L_4 ,
V_24 , ( unsigned long ) V_26 , ( unsigned long ) ( V_26 * V_24 ) ,
( unsigned long ) V_27 , ( unsigned long ) V_28 ,
( unsigned long ) F_17 ( & V_2 -> V_29 [ V_27 ] , V_24 ) ) ;
...
int F_22 ( const T_2 * V_9 , unsigned int V_13 ,
...
* V_19 = 0 ;
do {
V_7 = F_3 ( & V_2 , & V_41 , V_52 ) ;
if ( V_7 )
return V_7 ;
F_2 ( L_7 , ( unsigned long ) V_41 ) ;
switch ( V_41 ) {
case V_53 :
V_7 = F_3 ( & V_2 , & V_50 , V_54 ) ;
if ( V_7 )
return V_7 ;
if ( V_2 . V_22 == V_22 )
return - V_8 ;
