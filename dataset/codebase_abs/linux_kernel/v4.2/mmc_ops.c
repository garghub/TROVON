...
V_108 = sizeof( V_112 ) ;
V_9 = V_113 ;
} else if ( V_106 -> V_110 == V_114 ) {
V_107 = V_115 ;
V_108 = sizeof( V_115 ) ;
V_9 = V_116 ;
} else
return - V_68 ;
V_109 = F_22 ( V_108 , V_65 ) ;
if ( ! V_109 )
return - V_66 ;
V_48 . V_7 = & V_7 ;
V_48 . V_50 = & V_50 ;
...
V_50 . V_57 = 1 ;
F_19 ( & V_50 , V_2 ) ;
F_18 ( & V_52 , V_109 , V_46 ) ;
F_20 ( V_8 , & V_48 ) ;
V_5 = 0 ;
if ( V_9 == V_123 ) {
for ( V_33 = 0 ; V_33 < V_46 / 4 ; V_33 ++ )
if ( ( V_119 [ V_33 ] ^ V_109 [ V_33 ] ) != 0xff ) {
V_5 = - V_118 ;
break;
}
}
...
int F_44 ( struct V_1 * V_2 , T_2 V_110 )
{
int V_5 , V_125 ;
if ( V_110 == V_111 )
V_125 = 8 ;
