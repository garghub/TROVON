...
static int F_35 ( struct V_51 * V_34 ,
struct V_30 * V_69 ,
struct V_14 * V_15 ,
int V_12 )
{
...
static int F_39 ( struct V_51 * V_34 ,
enum V_45 * type )
{
const char * V_74 ;
int V_75 , V_28 ;
V_75 = F_40 ( V_34 , L_12 , & V_74 ) ;
if ( V_75 < 0 )
return V_75 ;
for ( V_28 = 0 ; V_28 < F_41 ( V_76 ) ; V_28 ++ )
...
static int F_42 ( struct V_51 * V_34 ,
struct V_14 * V_13 )
{
int V_71 ;
int V_35 ;
V_35 = F_36 ( V_34 , L_13 , & V_71 ) ;
if ( V_35 < 0 ) {
F_38 ( L_14 ) ;
return V_35 ;
}
V_13 -> V_47 = V_71 ;
V_35 = F_36 ( V_34 , L_15 , & V_71 ) ;
if ( V_35 < 0 ) {
F_38 ( L_16 ) ;
return V_35 ;
}
...
V_2 = F_44 ( sizeof( * V_2 ) , V_79 ) ;
if ( ! V_2 )
return F_25 ( - V_80 ) ;
V_35 = F_36 ( V_34 , L_19 , & V_71 ) ;
if ( V_35 < 0 ) {
F_38 ( L_20 ) ;
goto V_81;
}
V_2 -> V_82 = V_71 ;
V_35 = F_36 ( V_34 , L_21 , & V_71 ) ;
if ( V_35 < 0 ) {
F_38 ( L_22 ) ;
goto V_81;
}
V_2 -> V_44 = V_71 ;
V_35 = F_45 ( V_34 , L_23 , V_78 , 2 ) ;
if ( V_35 == 0 ) {
V_2 -> V_83 = V_78 [ 0 ] ;
V_2 -> V_84 = V_78 [ 1 ] ;
} else {
...
if ( V_2 -> V_12 == 0 )
goto V_85;
V_2 -> V_15 = F_44 ( V_2 -> V_12 * sizeof( * V_2 -> V_15 ) , V_79 ) ;
if ( ! V_2 -> V_15 ) {
V_35 = - V_80 ;
goto V_81;
}
...
if ( V_2 -> V_29 == 0 )
goto V_85;
V_2 -> V_32 = F_44 ( V_2 -> V_29 * sizeof( * V_2 -> V_32 ) , V_79 ) ;
if ( ! V_2 -> V_32 ) {
V_35 = - V_80 ;
goto V_86;
}
...
if ( ! V_7 )
goto V_94;
V_91 = F_44 ( sizeof( * V_91 ) , V_79 ) ;
if ( ! V_91 ) {
F_48 ( V_7 ) ;
goto V_94;
}
V_91 -> V_95 = true ;
if ( ! F_36 ( V_61 , L_28 , & V_71 ) )
V_91 -> V_96 = V_71 ;
for ( V_28 = 0 ; V_28 < V_2 -> V_12 ; V_28 ++ )
V_92 |= 1 << V_28 ;
V_91 -> V_83 = V_2 -> V_83 ;
