...
V_69 = F_43 ( T_3 , V_79 [ V_49 ] . V_93 , V_83 ) ;
...
long V_24 ;
if ( F_42 ( ! ( V_114 -> V_130 & V_140 ) ) )
return - V_132 ;
if ( F_42 ( V_114 -> V_141 & V_142 ) )
return - V_100 ;
...
const int V_75 = F_43 ( T_3 , V_39 , V_162 - V_156 ) ;
