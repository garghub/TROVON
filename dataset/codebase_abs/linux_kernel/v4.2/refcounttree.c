...
{
struct V_120 * V_190 = V_188 , * V_191 = V_189 ;
F_136 ( * V_190 , * V_191 ) ;
}
static int F_137 ( struct V_176 * V_177 ,
T_2 * V_194 , int * V_195 )
{
...
static int F_138 ( struct V_7 * V_117 ,
struct V_7 * V_78 ,
T_2 * V_200 )
{
...
F_140 ( & V_177 -> V_126 , F_97 ( V_177 -> V_125 ) ,
sizeof( struct V_120 ) ,
F_133 , F_135 ) ;
V_50 = F_137 ( V_177 , & V_118 , & V_195 ) ;
if ( V_50 ) {
F_56 ( V_50 ) ;
return V_50 ;
}
...
sizeof( struct V_120 ) ,
F_134 , F_135 ) ;
F_140 ( & V_202 -> V_126 , F_97 ( V_202 -> V_125 ) ,
sizeof( struct V_120 ) ,
F_134 , F_135 ) ;
* V_200 = V_118 ;
return 0 ;
}
static int F_141 ( T_3 * V_72 ,
struct V_2 * V_3 ,
struct V_7 * V_51 ,
struct V_7 * V_117 ,
struct V_73 * V_74 )
...
V_50 = F_143 ( V_72 , & V_204 , V_203 , V_78 -> V_13 ,
1 , 0 , V_74 ) ;
if ( V_50 )
F_56 ( V_50 ) ;
V_53:
...
V_50 = F_147 ( V_72 , V_3 , F_148 ( V_207 ) ,
V_86 ) ;
if ( V_50 < 0 ) {
F_56 ( V_50 ) ;
goto V_53;
...
F_90 ( V_72 , F_148 ( V_207 ) ) ;
F_90 ( V_72 , V_117 ) ;
V_53:
F_115 ( V_207 ) ;
return V_50 ;
}
static int F_150 ( T_3 * V_72 ,
struct V_2 * V_3 ,
struct V_7 * V_51 ,
struct V_7 * V_117 ,
struct V_120 * V_124 ,
...
F_12 ( V_11 -> V_180 ) ) ;
F_109 ( & V_146 , V_3 , V_51 ) ;
V_50 = F_164 ( V_72 , & V_146 , F_12 ( V_11 -> V_180 ) ,
1 , V_74 , V_210 ) ;
if ( V_50 ) {
F_56 ( V_50 ) ;
goto V_53;
...
struct V_209 * V_210 )
{
return F_156 ( V_72 , V_3 , V_51 ,
V_118 , V_119 , 1 ,
V_74 , V_210 ) ;
}
static int F_169 ( T_3 * V_72 ,
struct V_2 * V_3 ,
struct V_7 * V_51 ,
struct V_7 * V_117 ,
...
if ( ! V_217 )
F_5 ( V_218 > 1 ) ;
V_219 = F_160 ( ( T_1 ) ( V_118 + V_119 ) , F_11 ( V_124 . V_127 ) +
F_12 ( V_124 . V_128 ) ) - V_118 ;
V_50 = F_169 ( V_72 , V_3 , V_51 ,
V_117 , V_122 ,
V_118 , V_219 ,
V_74 , V_210 ) ;
if ( V_50 ) {
...
static int F_176 ( struct V_56 * V_56 ,
struct V_145 * V_146 ,
T_3 * V_72 , T_2 V_118 ,
T_2 V_119 , T_2 V_220 ,
struct V_73 * V_74 ,
...
V_119 = F_160 ( ( T_1 ) V_118 + V_224 , F_11 ( V_124 . V_127 ) +
F_12 ( V_124 . V_128 ) ) - V_118 ;
if ( V_124 . V_129 ) {
V_227 += 2 ;
if ( V_118 == V_223 &&
...
struct V_7 * V_51 = NULL ;
struct V_1 * V_33 ;
T_1 V_223 = F_185 ( V_56 -> V_77 , V_231 ) ;
if ( ! V_1 ( F_13 ( V_56 -> V_77 ) ) ) {
F_10 ( V_56 -> V_77 , L_10
L_11
L_12 , V_56 -> V_221 ) ;
...
{
F_5 ( V_233 > V_118 ) ;
return V_233 + ( ( V_118 - V_233 ) & F_189 ( V_6 ) ) ;
}
...
static int F_192 ( struct V_56 * V_56 ,
struct V_138 * V_139 ,
T_2 V_118 ,
T_2 V_235 ,
T_2 V_236 ,
...
{
int V_50 = 0 , V_225 = 0 ;
int V_249 = F_197 ( F_13 ( V_6 ) , V_146 ) ;
if ( V_249 < 0 ) {
V_50 = V_249 ;
F_56 ( V_50 ) ;
goto V_53;
...
V_225 =
F_181 ( V_146 -> V_229 ) ;
* V_107 += F_182 ( V_6 , V_146 -> V_229 ) ;
V_50 = F_179 ( V_6 , V_247 , V_51 ,
V_245 , V_246 ,
& V_225 , V_107 ) ;
if ( V_50 ) {
F_56 ( V_50 ) ;
...
static int F_200 ( T_3 * V_72 , struct V_7 * V_8 )
{
F_5 ( F_201 ( V_8 ) ) ;
F_202 ( V_8 ) ;
return 0 ;
...
int V_123 , V_272 = F_174 ( V_6 , V_252 ) ;
T_1 V_273 = F_174 ( V_6 , V_250 ) ;
T_1 V_254 = F_174 ( V_6 , V_251 ) ;
...
V_50 = F_223 ( V_72 , V_146 , V_207 , V_122 ,
& V_276 , V_74 , V_210 ) ;
if ( V_50 )
F_56 ( V_50 ) ;
V_53:
...
T_1 V_278 = F_119 ( V_3 ) ;
F_225 ( ( unsigned long long ) V_278 ,
...
unsigned int * V_287 )
{
return F_232 ( V_280 -> V_56 , V_286 , V_245 ,
V_246 , V_287 ) ;
}
...
if ( V_280 -> V_294 == F_231 ) {
V_50 = F_226 ( V_6 , V_280 -> V_56 , V_118 ,
V_289 ) ;
if ( V_50 )
F_56 ( V_50 ) ;
}
...
static int F_236 ( struct V_279 * V_280 )
{
int V_50 = 0 ;
...
if ( F_238 ( & V_280 -> V_210 ) ) {
F_239 ( V_28 , 1 ) ;
F_240 ( V_28 , & V_280 -> V_210 ) ;
}
return V_50 ;
}
static int F_241 ( struct V_56 * V_56 ,
struct V_7 * V_58 ,
...
F_5 ( ! ( V_76 -> V_61 & V_62 ) ) ;
V_50 = F_192 ( V_56 , & V_60 -> V_295 . V_296 ,
V_118 , V_235 , V_236 ,
& V_237 , & V_238 ) ;
if ( V_50 ) {
F_56 ( V_50 ) ;
...
static int F_246 ( struct V_279 * V_280 ,
T_2 V_286 , T_2 * V_245 ,
T_2 * V_246 ,
unsigned int * V_287 )
{
...
static int F_254 ( struct V_56 * V_56 ,
struct V_7 * V_58 )
{
int V_50 , V_313 = 0 ;
struct V_7 * V_51 = NULL ;
...
if ( V_76 -> V_61 & V_315 )
goto V_316;
F_243 ( & V_314 , F_81 ( V_56 ) , V_58 ) ;
V_193 = F_205 ( V_56 ) ;
V_224 = F_188 ( V_56 -> V_77 , V_193 ) ;
V_118 = 0 ;
while ( V_118 < V_224 ) {
V_50 = F_232 ( V_56 , V_118 , & V_245 ,
& V_246 , & V_275 ) ;
...
V_50 = F_143 ( V_72 , V_146 , V_118 ,
F_174 ( V_56 -> V_77 , V_245 ) ,
V_246 , V_275 , V_74 ) ;
if ( V_50 ) {
F_56 ( V_50 ) ;
goto V_87;
}
V_50 = F_168 ( V_72 , V_247 , V_51 ,
V_245 , V_246 ,
V_74 , V_210 ) ;
if ( V_50 )
F_56 ( V_50 ) ;
...
unsigned int V_275 ;
struct V_145 V_146 ;
F_243 ( & V_146 , F_81 ( V_319 ) , V_320 ) ;
V_193 = F_205 ( V_317 ) ;
V_224 = F_188 ( V_317 -> V_77 , V_193 ) ;
V_118 = 0 ;
while ( V_118 < V_224 ) {
V_50 = F_232 ( V_317 , V_118 , & V_245 ,
& V_246 , & V_275 ) ;
if ( V_50 ) {
F_56 ( V_50 ) ;
goto V_53;
...
static int F_259 ( struct V_56 * V_317 ,
struct V_7 * V_318 ,
struct V_56 * V_319 ,
struct V_7 * V_320 ,
bool V_326 )
...
static int F_261 ( struct V_56 * V_317 ,
struct V_7 * V_318 ,
struct V_56 * V_319 ,
struct V_7 * V_320 ,
bool V_326 )
...
static int F_262 ( struct V_339 * V_340 ,
struct V_7 * V_274 ,
struct V_56 * V_341 ,
bool V_326 )
{
int V_50 ;
struct V_56 * V_56 = F_263 ( V_340 ) ;
struct V_7 * V_78 = NULL ;
if ( F_61 ( V_56 ) -> V_342 & V_343 ) {
V_50 = - V_17 ;
F_56 ( V_50 ) ;
goto V_53;
}
V_50 = F_264 ( V_56 -> V_265 ) ;
if ( V_50 ) {
F_56 ( V_50 ) ;
goto V_53;
}
V_50 = F_254 ( V_56 , V_274 ) ;
if ( V_50 ) {
F_56 ( V_50 ) ;
goto V_53;
}
F_265 ( & V_341 -> V_113 , V_344 ) ;
V_50 = F_266 ( V_341 , & V_78 , 1 ,
V_345 ) ;
if ( V_50 ) {
F_56 ( V_50 ) ;
goto V_116;
}
V_50 = F_261 ( V_56 , V_274 ,
V_341 , V_78 , V_326 ) ;
if ( V_50 ) {
F_56 ( V_50 ) ;
goto V_346;
...
V_53:
if ( ! V_50 ) {
V_50 = F_268 ( V_56 -> V_265 ) ;
if ( V_50 )
F_56 ( V_50 ) ;
}
return V_50 ;
}
static int F_269 ( struct V_339 * V_340 , struct V_56 * V_347 ,
struct V_339 * V_348 , bool V_326 )
{
int error ;
struct V_56 * V_56 = F_263 ( V_340 ) ;
struct V_7 * V_274 = NULL ;
struct V_56 * V_349 = NULL ;
struct V_350 * V_351 , * V_352 ;
T_7 V_353 ;
if ( ! V_1 ( F_13 ( V_56 -> V_77 ) ) )
return - V_354 ;
V_353 = V_56 -> V_335 ;
error = F_270 ( V_347 , & V_353 , & V_351 , & V_352 ) ;
if ( error ) {
F_56 ( error ) ;
return error ;
}
error = F_271 ( V_347 , V_353 ,
& V_349 ) ;
if ( error ) {
F_56 ( error ) ;
goto V_53;
...
static inline int F_278 ( struct V_56 * V_347 , struct V_339 * V_356 )
{
if ( F_279 ( V_356 ) )
return - V_357 ;
if ( F_280 ( V_347 ) )
return - V_358 ;
return F_281 ( V_347 , V_359 | V_360 ) ;
}
static int F_282 ( struct V_339 * V_340 , struct V_56 * V_347 ,
struct V_339 * V_348 , bool V_326 )
{
struct V_56 * V_56 = F_263 ( V_340 ) ;
int error ;
if ( ! V_56 )
return - V_358 ;
error = F_278 ( V_347 , V_348 ) ;
if ( error )
return error ;
if ( V_347 -> V_77 != V_56 -> V_77 )
return - V_361 ;
if ( F_283 ( V_56 ) || F_284 ( V_56 ) )
return - V_362 ;
if ( ! F_285 ( V_56 -> V_335 ) )
return - V_362 ;
if ( V_326 ) {
if ( ! F_286 ( F_287 () , V_56 -> V_333 ) && ! F_288 ( V_363 ) )
return - V_362 ;
if ( ! F_289 ( V_56 -> V_334 ) && ! F_288 ( V_363 ) )
return - V_362 ;
}
if ( ! V_326 ) {
error = F_281 ( V_56 , V_364 ) ;
if ( error )
return error ;
}
F_23 ( & V_56 -> V_113 ) ;
F_290 ( V_347 ) ;
error = F_269 ( V_340 , V_347 , V_348 , V_326 ) ;
F_25 ( & V_56 -> V_113 ) ;
if ( ! error )
F_291 ( V_347 , V_348 ) ;
return error ;
}
int F_292 ( struct V_56 * V_56 ,
const char T_8 * V_365 ,
const char T_8 * V_366 ,
bool V_326 )
{
struct V_339 * V_348 ;
struct V_207 V_367 , V_368 ;
int error ;
if ( ! V_1 ( F_13 ( V_56 -> V_77 ) ) )
return - V_354 ;
error = F_293 ( V_369 , V_365 , 0 , & V_367 ) ;
if ( error ) {
F_56 ( error ) ;
return error ;
}
V_348 = F_294 ( V_369 , V_366 , & V_368 , 0 ) ;
error = F_79 ( V_348 ) ;
if ( F_78 ( V_348 ) ) {
F_56 ( error ) ;
goto V_53;
