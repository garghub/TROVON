...
{
struct V_174 * V_33 = V_2 -> V_33 ;
struct V_130 * V_34 = & V_33 -> V_34 ;
const struct V_151 * V_30 = F_86 ( V_34 ) ;
unsigned int V_175 , V_176 ;
const struct V_177 * V_178 ;
struct V_91 * V_80 ;
struct V_130 * V_179 , * V_180 ;
if ( V_34 -> V_81 ) {
V_175 = 0 ;
V_176 = 0 ;
} else if ( V_30 && V_30 -> V_175 && V_30 -> V_176 ) {
V_175 = V_30 -> V_175 ;
V_176 = V_30 -> V_176 ;
} else {
return 0 ;
}
V_178 = F_87 ( V_33 , V_181 , 1 ) ;
if ( ! V_178 )
V_178 = F_87 ( V_33 , V_181 , 0 ) ;
V_80 = V_2 -> V_80 ;
...
if ( ! V_80 -> V_129 )
return - V_183 ;
V_80 -> V_119 = F_79 ( V_34 , V_184 ,
V_176 ,
V_178 -> V_182 + V_75 ) ;
if ( ! V_80 -> V_119 )
goto V_185;
V_2 -> V_149 = ( void * ) F_88 ( V_153 | V_186 ) ;
if ( ! V_2 -> V_149 )
goto V_187;
V_2 -> V_150 = ( void * ) F_88 ( V_153 | V_186 ) ;
if ( ! V_2 -> V_150 )
goto V_188;
V_179 = V_80 -> V_129 -> V_130 -> V_34 ;
V_2 -> V_131 = F_89 ( V_179 , V_2 -> V_149 , V_189 ,
V_132 ) ;
if ( F_90 ( V_179 , V_2 -> V_131 ) )
goto V_190;
V_180 = V_80 -> V_119 -> V_130 -> V_34 ;
V_2 -> V_120 = F_89 ( V_180 , V_2 -> V_150 , V_189 ,
V_121 ) ;
if ( F_90 ( V_180 , V_2 -> V_120 ) )
goto V_191;
F_91 ( V_34 , L_17 ) ;
return 0 ;
V_191:
F_92 ( V_179 , V_2 -> V_131 , V_189 , V_132 ) ;
V_190:
...
static int F_95 ( struct V_174 * V_33 )
{
struct V_177 * V_192 ;
struct V_91 * V_80 ;
...
V_2 -> V_25 = ( const void * ) V_33 -> V_198 -> V_199 ;
...
V_192 = F_87 ( V_33 , V_181 , 0 ) ;
V_2 -> V_6 = F_104 ( & V_33 -> V_34 , V_192 ) ;
if ( F_101 ( V_2 -> V_6 ) ) {
V_94 = F_102 ( V_2 -> V_6 ) ;
goto V_201;
}
V_94 = F_105 ( & V_33 -> V_34 , V_195 , F_9 , 0 ,
F_75 ( & V_33 -> V_34 ) , V_2 ) ;
if ( V_94 ) {
F_54 ( & V_33 -> V_34 , L_22 ) ;
goto V_201;
...
V_80 -> V_203 = V_86 | V_87 | V_90 ;
V_80 -> V_203 |= V_89 | V_88 ;
V_80 -> V_204 = V_2 -> V_25 -> V_26 ;
V_80 -> V_205 = V_33 -> V_160 ;
V_80 -> V_34 . V_81 = V_33 -> V_34 . V_81 ;
V_80 -> V_156 = V_2 -> V_30 -> V_156 ;
V_80 -> V_206 = F_42 ;
V_80 -> V_207 = F_47 ;
V_80 -> V_208 = F_107 ( 8 , 32 ) ;
V_80 -> V_209 = true ;
V_80 -> V_210 = F_69 ;
V_94 = F_85 ( V_2 ) ;
if ( V_94 < 0 )
...
static int F_111 ( struct V_174 * V_33 )
{
