...
V_113 = F_203 ( V_32 -> V_281 -> V_282 ) ;
V_27 = F_204 ( V_113 , V_279 , V_280 , V_4 ) ;
if ( V_27 ) {
F_153 ( L_25 ,
V_192 , V_27 ) ;
goto V_26;
...
V_27 = - V_283 ;
if ( ! ( V_279 -> V_284 . V_285 & V_286 ) ) {
F_153 ( L_26 ,
V_192 ) ;
goto V_26;
}
F_34 ( V_2 ) ;
V_12 = F_205 ( V_32 , V_279 ) ;
if ( V_12 != 0 ) {
F_153 ( L_27 ,
V_192 , V_12 ) ;
goto V_26;
...
F_25 (server, &clp->cl_superblocks, client_link) {
int V_12 ;
if ( V_32 -> V_289 == V_2 -> V_288 )
continue;
V_32 -> V_289 = V_2 -> V_288 ;
if ( ! F_28 ( V_204 ,
& V_32 -> V_200 ) )
continue;
F_26 () ;
...
F_26 () ;
V_113 = F_203 ( V_32 -> V_281 -> V_282 ) ;
V_12 = F_209 ( V_113 , V_4 ) ;
if ( V_12 != - V_290 )
goto V_236;
if ( F_201 ( V_32 , V_4 ) == - V_291 )
goto V_236;
goto V_26;
}
F_26 () ;
...
V_293 = F_212 ( V_293 , V_302 ) ;
if ( F_148 ( V_293 ) ) {
V_12 = F_150 ( V_293 ) ;
break;
}
V_293 = F_213 ( & V_2 -> V_188 , V_293 ) ;
F_214 ( V_293 ) ;
V_293 = V_2 -> V_188 ;
goto V_296;
case - V_272 :
...
void F_217 ( struct V_46 * V_305 , int V_79 )
{
struct V_1 * V_2 = V_305 -> V_2 ;
switch ( V_79 ) {
default:
F_5 ( V_65 , & V_2 -> V_18 ) ;
break;
...
void F_228 ( struct V_1 * V_2 , T_5 V_86 )
{
if ( ! V_86 )
return;
F_153 ( L_41 ,
...
memset ( V_2 -> V_48 -> V_316 . V_317 , 0 , V_318 ) ;
V_12 = F_40 ( V_2 , V_4 ) ;
if ( V_12 ) {
F_153 ( L_42 ,
...
static int F_229 ( struct V_1 * V_2 ) { return 0 ; }
static int F_231 ( struct V_1 * V_2 )
{
return 0 ;
}
...
{
int V_12 = 0 ;
const char * V_319 = L_45 , * V_320 = L_45 ;
do {
