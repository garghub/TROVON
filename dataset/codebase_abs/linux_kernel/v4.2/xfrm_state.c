...
V_19 = F_127 ( & V_236 -> V_121 , struct V_180 , V_121 ) ;
...
void F_131 ( struct V_180 * V_236 , T_4 V_9 ,
struct V_232 * V_233 )
{
F_53 ( & V_236 -> V_121 ) ;
V_236 -> V_9 = V_9 ;
...
void F_132 ( struct V_180 * V_236 , struct V_1 * V_1 )
{
F_35 ( V_236 -> V_233 ) ;
if ( F_126 ( & V_236 -> V_121 ) )
return;
...
void F_134 ( struct V_157 * V_242 , int V_243 , const struct V_168 * V_169 )
{
struct V_244 * V_95 ;
F_135 () ;
...
void F_138 ( struct V_18 * V_19 , const struct V_168 * V_169 )
{
struct V_244 * V_95 ;
F_135 () ;
F_136 (km, &xfrm_km_list, list)
...
void F_140 ( struct V_157 * V_158 , int V_243 , int V_246 , T_2 V_247 )
{
struct V_168 V_169 ;
V_169 . V_237 . V_246 = V_246 ;
V_169 . V_247 = V_247 ;
V_169 . V_248 = V_256 ;
F_134 ( V_158 , V_243 , & V_169 ) ;
}
int F_141 ( const struct V_257 * V_149 , T_4 V_243 , T_4 type ,
...
int F_142 ( struct V_1 * V_1 , T_4 V_9 , struct V_257 * V_149 , T_1 * V_263 )
{
int V_47 = - V_61 ;
int V_261 ;
struct V_244 * V_95 ;
...
int F_148 ( struct V_244 * V_95 )
{
F_15 ( & V_275 ) ;
F_149 ( & V_95 -> V_11 , & V_276 ) ;
F_16 ( & V_275 ) ;
return 0 ;
}
int F_150 ( struct V_244 * V_95 )
{
F_15 ( & V_275 ) ;
F_151 ( & V_95 -> V_11 ) ;
F_16 ( & V_275 ) ;
...
V_288 = V_191 ;
V_74 = F_30 ( V_19 -> V_22 . V_57 , V_288 ) ;
if ( V_74 ) {
if ( V_74 -> V_170 & V_287 )
V_19 -> V_74 = V_74 ;
else
...
void F_176 ( struct V_18 * V_19 , int V_309 , bool V_135 )
{
struct V_294 * V_295 ;
V_295 = F_177 ( L_8 ) ;
if ( V_295 == NULL )
...
void F_47 ( struct V_18 * V_19 , int V_309 , bool V_135 )
{
struct V_294 * V_295 ;
V_295 = F_177 ( L_10 ) ;
if ( V_295 == NULL )
