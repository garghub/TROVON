...
static T_2 F_21 ( struct V_46 * V_47 ,
...
static T_2 F_25 ( struct V_46 * V_47 ,
struct V_48 * V_49 ,
...
static T_2 F_33 ( struct V_46 * V_47 ,
struct V_48 * V_49 , char * V_50 )
{
int V_4 ;
struct V_1 * V_2 = F_22 ( V_47 ) ;
...
int V_3 ;
V_3 = F_57 ( & V_2 -> V_136 ) ;
F_58 ( V_2 -> V_136 . V_145 . V_146 ) ;
F_59 ( V_2 -> V_136 . V_145 . V_146 ) ;
F_60 ( V_2 -> V_136 . V_145 . V_146 ) ;
F_32 ( V_2 -> V_136 . V_142 ) ;
F_32 ( V_2 -> V_136 . V_144 ) ;
return V_3 ;
}
static int F_61 ( struct V_147 * V_47 , const struct V_148 * V_149 )
{
const struct V_150 * V_151 ;
unsigned V_152 = ( unsigned ) V_149 -> V_153 ;
struct V_1 * V_2 ;
struct V_154 * V_146 ;
int V_3 ;
if ( V_152 >= F_62 ( V_155 ) ) {
...
V_2 -> V_136 . V_158 = V_2 ;
V_2 -> V_73 = V_92 ;
V_2 -> V_138 = V_151 -> V_138 ;
F_5 ( L_28 , V_2 -> V_138 , F_6 ( V_47 ) ) ;
F_66 ( V_146 ) = & V_2 -> V_136 ;
V_2 -> V_136 . V_145 . V_146 = V_146 ;
V_146 -> V_159 = V_160 ;
V_146 -> V_161 = ~ 0 ;
V_146 -> V_162 = ~ 0 ;
V_146 -> V_163 = 16 ;
V_3 = F_67 ( V_146 , & V_47 -> V_47 ) ;
if ( V_3 )
goto V_164;
V_3 = V_151 -> V_165 ( V_2 ) ;
if ( V_3 )
...
V_2 -> V_28 . V_54 , V_2 -> V_28 . V_169 ,
V_2 -> V_28 . V_32 ,
V_2 -> V_28 . V_170 . V_171 ? L_32 : L_33 ,
V_2 -> V_28 . V_52 . V_171 ? L_34 : L_33 ,
V_2 -> V_28 . V_52 . V_53 ) ;
V_146 -> V_172 = V_2 -> V_105 . V_172 ;
if ( V_173 )
F_74 ( V_2 -> V_9 ) ;
V_3 = F_75 ( V_2 -> V_9 -> V_174 , V_175 , V_176 ,
V_14 , V_2 ) ;
if ( V_3 ) {
F_5 ( L_35 ,
V_2 -> V_9 -> V_174 , F_6 ( V_2 -> V_9 ) ) ;
goto V_177;
}
F_76 ( V_2 ) ;
V_3 = F_77 ( V_2 ) ;
...
F_86 ( & V_2 -> V_105 . V_185 , V_11 ) ;
V_2 -> V_105 . V_181 = 0 ;
F_87 ( & V_2 -> V_105 . V_186 , & V_181 ) ;
F_88 ( & V_2 -> V_105 . V_185 , V_11 ) ;
if ( ! F_43 ( & V_181 ) )
F_28 ( L_38 ) ;
F_89 (pos, n, &pending) {
struct V_131 * V_187 = F_90 ( V_184 , struct V_131 , V_110 ) ;
F_91 ( & V_187 -> V_188 ) ;
F_92 ( V_187 -> V_102 -> V_59 . V_189 != V_190 ) ;
F_44 ( V_184 ) ;
F_28 ( L_39 ) ;
F_45 ( V_187 ) ;
}
...
static void F_97 ( struct V_147 * V_47 )
{
...
static void F_99 ( struct V_154 * V_146 )
{
struct V_1 * V_2 ;
int V_3 ;
V_2 = F_66 ( V_146 ) -> V_158 ;
V_3 = F_100 ( V_2 , V_2 -> V_28 . V_34 ) ;
if ( V_3 )
F_5 ( L_40 , V_3 ) ;
}
static int F_101 ( struct V_154 * V_146 , unsigned long time )
{
if ( time < V_192 )
return 0 ;
F_102 ( F_66 ( V_146 ) ) ;
...
static T_2 F_103 ( struct V_193 * V_194 , char * V_50 )
{
return snprintf ( V_50 , V_51 , L_10 , V_195 ) ;
}
static int F_104 ( struct V_193 * V_194 )
{
return F_105 ( V_194 , & V_196 ) ;
}
