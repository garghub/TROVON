...
T_2 V_65 ;
int V_5 , V_66 ;
V_16 = F_29 ( & V_58 -> V_61 , sizeof( * V_16 ) , V_67 ) ;
if ( ! V_16 )
return NULL ;
if ( F_30 ( V_60 , L_7 , & V_65 ) )
goto V_68;
if ( V_65 > V_69 )
goto V_68;
V_16 -> V_24 = V_65 ;
for ( V_5 = 0 ; V_5 < V_16 -> V_24 ; V_5 ++ ) {
sprintf ( V_63 , L_8 , V_5 ) ;
if ( F_30 ( V_60 , V_63 , & V_65 ) )
goto V_68;
V_16 -> V_25 [ V_5 ] . V_28 = V_65 ;
sprintf ( V_63 , L_9 , V_5 ) ;
if ( F_31 ( V_60 , V_63 , & V_64 ) )
goto V_68;
if ( ! strcmp ( V_64 , L_10 ) )
...
else if ( ! strcmp ( V_64 , L_13 ) )
V_16 -> V_25 [ V_5 ] . type = V_39 ;
else
goto V_68;
sprintf ( V_63 , L_14 , V_5 ) ;
if ( F_30 ( V_60 , V_63 , & V_65 ) )
goto V_68;
if ( V_65 > V_7 )
goto V_68;
for ( V_66 = 0 ; V_66 < V_65 ; V_66 ++ ) {
sprintf ( V_63 , L_15 , V_5 , V_66 ) ;
if ( F_31 ( V_60 , V_63 , & V_64 ) )
goto V_68;
if ( strlen ( V_64 ) >= V_73 )
goto V_68;
strcpy ( V_16 -> V_25 [ V_5 ] . V_8 [ V_66 ] , V_64 ) ;
}
}
return V_16 ;
V_68:
...
if ( ! V_16 )
return - V_6 ;
V_13 = F_29 ( & V_58 -> V_61 , sizeof( * V_13 ) , V_67 ) ;
if ( ! V_13 )
return - V_78 ;
F_35 ( & V_13 -> V_35 ) ;
F_10 ( & V_13 -> V_35 ) ;
...
V_13 -> V_51 = F_39 ( L_25 ,
V_16 -> V_24 , 0 , V_13 , & V_82 , NULL , 0 , 0 ) ;
if ( F_40 ( V_13 -> V_51 ) ) {
F_32 ( & V_58 -> V_61 , L_26 ) ;
V_21 = F_41 ( V_13 -> V_51 ) ;
goto V_79;
