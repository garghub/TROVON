...
struct V_1 * F_54 ( struct V_86 * V_87 )
{
struct V_1 * V_6 ;
F_43 ( & V_84 ) ;
F_55 (dpaux, &dpaux_list, list)
...
int F_56 ( struct V_1 * V_6 , struct V_89 * V_58 )
{
unsigned long V_17 ;
int V_72 ;
V_58 -> V_59 . V_90 = V_91 ;
...
int F_68 ( struct V_1 * V_6 , T_2 V_102 )
{
int V_72 ;
V_72 = F_69 ( & V_6 -> V_3 , V_103 ,
V_102 ) ;
if ( V_72 < 0 )
return V_72 ;
return 0 ;
}
int F_70 ( struct V_1 * V_6 , struct V_104 * V_105 ,
T_2 V_106 )
{
T_2 V_107 = V_106 & V_108 ;
T_2 V_18 [ V_109 ] , V_110 [ 4 ] ;
unsigned int V_12 ;
int V_72 ;
V_72 = F_69 ( & V_6 -> V_3 , V_111 , V_106 ) ;
if ( V_72 < 0 )
return V_72 ;
if ( V_107 == V_112 )
return 0 ;
...
V_116 |
V_117 ;
V_72 = F_71 ( & V_6 -> V_3 , V_118 , V_110 ,
V_105 -> V_113 ) ;
if ( V_72 < 0 )
return V_72 ;
F_60 ( 500 , 1000 ) ;
V_72 = F_72 ( & V_6 -> V_3 , V_18 ) ;
if ( V_72 < 0 )
return V_72 ;
switch ( V_107 ) {
case V_119 :
...
break;
case V_121 :
if ( ! F_74 ( V_18 , V_105 -> V_113 ) )
return - V_120 ;
break;
default:
F_33 ( V_6 -> V_60 , L_7 , V_107 ) ;
return - V_20 ;
}
V_72 = F_69 ( & V_6 -> V_3 , V_122 , 0 ) ;
if ( V_72 < 0 )
return V_72 ;
return 0 ;
}
