...
static void F_30 ( struct V_6 * V_7 , struct V_26 * V_27 , void * V_86 )
{
struct V_1 * V_2 = V_86 ;
struct V_73 * V_74 ;
if ( F_7 ( F_31 ( V_27 ) ) ) {
...
V_74 = F_27 ( V_90 ) ;
F_2 ( L_10 ,
F_28 ( V_74 -> V_96 ) , F_35 ( V_74 -> V_97 ) , V_91 , V_93 ) ;
V_39 = sizeof( * V_38 ) ;
if ( V_91 == V_98 )
V_39 += sizeof( * V_95 ) ;
V_27 = F_19 ( V_29 , V_39 ) ;
...
V_40 = F_40 ( & V_2 -> V_8 , V_2 -> V_12 -> V_34 ,
& V_2 -> V_118 [ 0 ] , F_41 ( & V_38 -> V_119 ) ,
V_2 , V_105 , V_120 , 0 , 0 ) ;
if ( V_40 < 0 )
F_38 ( V_2 , V_121 ) ;
}
...
struct V_134 * V_34 = V_12 -> V_34 ;
int V_135 ;
V_135 = F_45 ( & V_34 -> V_35 , V_136 ) ;
if ( V_135 < 0 )
goto V_137;
V_2 = & ( (struct V_1 * ) V_34 -> V_138 ) [ V_135 ] ;
memset ( V_2 , 0 , sizeof( struct V_1 ) ) ;
V_2 -> V_8 . V_36 = V_135 ;
V_2 -> V_12 = V_12 ;
V_2 -> V_13 = V_29 -> V_32 . V_139 ( V_29 , V_27 ) ;
if ( ! V_2 -> V_13 ) {
F_12 ( & V_34 -> V_35 , V_135 ) ;
goto V_137;
}
V_2 -> V_31 = V_27 ;
F_46 ( & V_2 -> V_140 , V_141 ) ;
F_47 ( V_12 -> V_103 -> V_142 -> V_143 , & V_2 -> V_140 ) ;
return;
V_137:
F_2 ( L_13 ) ;
F_34 ( V_29 , V_27 , V_144 , 0 ) ;
F_11 ( V_27 ) ;
F_13 ( V_12 ) ;
}
void F_48 ( struct V_30 * V_12 , struct V_26 * V_27 )
{
struct V_73 * V_74 = F_27 ( V_27 ) ;
switch ( V_74 -> V_81 ) {
case V_145 :
F_44 ( V_12 , V_27 ) ;
break;
...
static void V_141 ( struct V_147 * V_140 )
{
struct V_1 * V_2 = F_15 ( V_140 , struct V_1 , V_140 ) ;
struct V_73 * V_74 = F_27 ( V_2 -> V_31 ) ;
struct V_104 * V_38 ;
int V_148 = 0 ;
int V_149 ;
V_38 = F_20 ( V_2 -> V_31 , sizeof( * V_38 ) ) ;
...
F_5 ( V_2 -> V_13 ) -> V_43 -> V_32 . V_168 ( V_2 -> V_13 , F_30 , V_2 ) ;
V_2 -> V_8 . V_135 = F_5 ( V_2 -> V_13 ) -> V_22 ;
if ( F_49 ( & V_2 -> V_8 , V_2 -> V_12 -> V_34 , V_38 -> V_169 ,
& V_2 -> V_118 [ 0 ] , F_41 ( & V_38 -> V_119 ) ,
F_50 ( V_38 -> V_170 ) , V_149 , V_148 , 0 ) )
goto V_150;
F_2 ( L_14 , V_74 -> V_81 ) ;
return;
V_150:
