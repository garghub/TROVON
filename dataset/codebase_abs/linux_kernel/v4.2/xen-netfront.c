...
V_57 -> V_60 = NULL ;
V_130 = - V_191 ;
V_57 -> V_157 = F_143 ( struct V_94 ) ;
if ( V_57 -> V_157 == NULL )
goto exit;
V_57 -> V_95 = F_143 ( struct V_94 ) ;
if ( V_57 -> V_95 == NULL )
goto exit;
V_31 -> V_192 = & V_193 ;
...
static int F_146 ( struct V_189 * V_20 ,
...
static void F_154 ( struct V_56 * V_30 )
{
unsigned int V_14 = 0 ;
...
F_155 ( V_12 -> V_118 , V_12 ) ;
if ( V_12 -> V_118 && ( V_12 -> V_118 != V_12 -> V_55 ) ) {
F_155 ( V_12 -> V_118 , V_12 ) ;
F_155 ( V_12 -> V_55 , V_12 ) ;
}
...
F_157 ( V_12 -> V_75 ) ;
F_157 ( V_12 -> V_46 ) ;
F_153 ( V_12 -> V_206 , V_12 -> V_25 . V_62 ) ;
F_153 ( V_12 -> V_207 , V_12 -> V_41 . V_62 ) ;
V_12 -> V_206 = V_18 ;
V_12 -> V_207 = V_18 ;
V_12 -> V_25 . V_62 = NULL ;
V_12 -> V_41 . V_62 = NULL ;
...
static int F_158 ( struct V_189 * V_20 )
{
struct V_56 * V_30 = F_159 ( & V_20 -> V_20 ) ;
F_160 ( & V_20 -> V_20 , L_20 , V_20 -> V_208 ) ;
F_154 ( V_30 ) ;
return 0 ;
}
static int F_161 ( struct V_189 * V_20 , T_10 V_209 [] )
{
char * V_210 , * V_211 , * V_212 ;
int V_14 ;
V_212 = V_210 = F_162 ( V_181 , V_20 -> V_208 , L_21 , NULL ) ;
if ( F_147 ( V_212 ) )
return F_148 ( V_212 ) ;
for ( V_14 = 0 ; V_14 < V_213 ; V_14 ++ ) {
V_209 [ V_14 ] = F_163 ( V_210 , & V_211 , 16 ) ;
...
{
int V_130 ;
V_130 = F_166 ( V_12 -> V_30 -> V_48 , & V_12 -> V_204 ) ;
if ( V_130 < 0 )
goto V_203;
V_130 = F_167 ( V_12 -> V_204 ,
F_135 ,
...
return 0 ;
V_215:
F_168 ( V_12 -> V_30 -> V_48 , V_12 -> V_204 ) ;
V_12 -> V_204 = 0 ;
V_203:
return V_130 ;
}
...
if ( V_130 < 0 )
goto V_203;
V_130 = F_166 ( V_12 -> V_30 -> V_48 , & V_12 -> V_205 ) ;
if ( V_130 < 0 )
goto V_216;
...
V_12 -> V_118 = 0 ;
V_218:
F_168 ( V_12 -> V_30 -> V_48 , V_12 -> V_205 ) ;
V_12 -> V_205 = 0 ;
V_216:
F_168 ( V_12 -> V_30 -> V_48 , V_12 -> V_204 ) ;
V_12 -> V_204 = 0 ;
...
static int F_170 ( struct V_189 * V_20 ,
...
V_12 -> V_41 . V_62 = NULL ;
V_12 -> V_25 . V_62 = NULL ;
V_223 = (struct V_222 * ) F_171 ( V_226 | V_227 ) ;
if ( ! V_223 ) {
V_130 = - V_191 ;
F_149 ( V_20 , V_130 , L_24 ) ;
goto V_203;
}
F_172 ( V_223 ) ;
F_173 ( & V_12 -> V_25 , V_223 , V_39 ) ;
V_130 = F_174 ( V_20 , V_223 , 1 , & V_50 ) ;
if ( V_130 < 0 )
goto V_228;
V_12 -> V_206 = V_50 ;
V_225 = (struct V_224 * ) F_171 ( V_226 | V_227 ) ;
if ( ! V_225 ) {
V_130 = - V_191 ;
F_149 ( V_20 , V_130 , L_25 ) ;
goto V_229;
}
F_172 ( V_225 ) ;
F_173 ( & V_12 -> V_41 , V_225 , V_39 ) ;
V_130 = F_174 ( V_20 , V_225 , 1 , & V_50 ) ;
if ( V_130 < 0 )
goto V_230;
V_12 -> V_207 = V_50 ;
if ( V_221 )
...
V_130 = F_182 ( * V_234 , V_237 , L_31 , L_32 ,
V_12 -> V_206 ) ;
if ( V_130 ) {
V_236 = L_33 ;
goto error;
}
V_130 = F_182 ( * V_234 , V_237 , L_34 , L_32 ,
V_12 -> V_207 ) ;
if ( V_130 ) {
V_236 = L_35 ;
goto error;
...
if ( V_235 )
F_164 ( V_237 ) ;
F_149 ( V_20 , V_130 , L_42 , V_236 ) ;
return V_130 ;
}
static void F_183 ( struct V_56 * V_30 )
{
unsigned int V_14 ;
F_184 () ;
...
static int F_188 ( struct V_56 * V_30 ,
unsigned int V_58 )
{
unsigned int V_14 ;
int V_140 ;
V_30 -> V_60 = F_189 ( V_58 , sizeof( struct V_11 ) ,
V_239 ) ;
if ( ! V_30 -> V_60 )
return - V_191 ;
F_184 () ;
...
if ( V_130 < 0 )
V_240 = 1 ;
V_58 = F_194 ( V_240 , V_190 ) ;
V_130 = F_130 ( V_181 , V_30 -> V_48 -> V_182 ,
L_46 , L_32 ,
& V_221 ) ;
if ( V_130 < 0 )
V_221 = 0 ;
V_130 = F_161 ( V_20 , V_30 -> V_31 -> V_241 ) ;
if ( V_130 ) {
F_149 ( V_20 , V_130 , L_47 , V_20 -> V_208 ) ;
goto V_242;
}
if ( V_30 -> V_60 )
F_183 ( V_30 ) ;
V_130 = F_188 ( V_30 , V_58 ) ;
if ( V_130 < 0 )
goto V_243;
for ( V_14 = 0 ; V_14 < V_58 ; ++ V_14 ) {
V_12 = & V_30 -> V_60 [ V_14 ] ;
V_130 = F_170 ( V_20 , V_12 , V_221 ) ;
if ( V_130 ) {
if ( V_14 > 0 ) {
F_184 () ;
...
V_130 = F_195 ( & V_234 ) ;
if ( V_130 ) {
F_149 ( V_20 , V_130 , L_48 ) ;
goto V_243;
}
if ( V_58 == 1 ) {
V_130 = F_180 ( & V_30 -> V_60 [ 0 ] , & V_234 , 0 ) ;
if ( V_130 )
goto V_245;
} else {
V_130 = F_182 ( V_234 , V_20 -> V_208 , L_49 ,
L_32 , V_58 ) ;
if ( V_130 ) {
V_236 = L_50 ;
goto V_245;
...
for ( V_14 = 0 ; V_14 < V_58 ; ++ V_14 ) {
V_12 = & V_30 -> V_60 [ V_14 ] ;
V_130 = F_180 ( V_12 , & V_234 , 1 ) ;
if ( V_130 )
goto V_245;
}
}
V_130 = F_182 ( V_234 , V_20 -> V_208 , L_51 , L_32 ,
1 ) ;
if ( V_130 ) {
V_236 = L_52 ;
goto V_246;
}
V_130 = F_182 ( V_234 , V_20 -> V_208 , L_53 , L_13 , 1 ) ;
if ( V_130 ) {
V_236 = L_54 ;
goto V_246;
}
V_130 = F_182 ( V_234 , V_20 -> V_208 , L_12 , L_13 , 1 ) ;
if ( V_130 ) {
V_236 = L_55 ;
goto V_246;
}
V_130 = F_182 ( V_234 , V_20 -> V_208 , L_15 , L_13 , 1 ) ;
if ( V_130 ) {
V_236 = L_56 ;
goto V_246;
}
V_130 = F_196 ( V_234 , V_20 -> V_208 , L_16 , L_57 ) ;
if ( V_130 ) {
V_236 = L_58 ;
goto V_246;
}
V_130 = F_196 ( V_234 , V_20 -> V_208 , L_14 ,
L_57 ) ;
if ( V_130 ) {
V_236 = L_59 ;
goto V_246;
...
enum V_251 V_252 )
{
struct V_56 * V_57 = F_159 ( & V_20 -> V_20 ) ;
struct V_19 * V_31 = V_57 -> V_31 ;
F_160 ( & V_20 -> V_20 , L_20 , F_205 ( V_252 ) ) ;
switch ( V_252 ) {
case V_253 :
case V_254 :
case V_255 :
...
static int F_209 ( struct V_19 * V_20 , int V_263 )
{
switch ( V_263 ) {
case V_264 :
return F_210 ( V_265 ) ;
...
void * V_57 = F_41 ( V_20 ) ;
int V_14 ;
for ( V_14 = 0 ; V_14 < F_210 ( V_265 ) ; V_14 ++ )
V_23 [ V_14 ] = F_212 ( ( V_267 * ) ( V_57 + V_265 [ V_14 ] . V_79 ) ) ;
}
static void F_213 ( struct V_19 * V_20 , T_6 V_268 , T_10 * V_23 )
{
int V_14 ;
switch ( V_268 ) {
case V_264 :
