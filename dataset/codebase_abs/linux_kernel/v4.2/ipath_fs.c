...
F_29 ( V_2 , L_5 ) ;
F_38 ( V_2 ) ;
V_34 = F_39 ( F_9 ( V_59 ) , V_2 ) ;
V_10:
F_13 ( & F_9 ( V_59 ) -> V_23 ) ;
F_40 ( V_59 ) ;
return V_34 ;
}
static int F_41 ( struct V_44 * V_45 , void * V_7 ,
int V_60 )
{
...
V_34 = F_42 ( V_45 , V_65 , V_63 ) ;
if ( V_34 ) {
F_28 ( V_53 L_13 , V_34 ) ;
goto V_10;
}
F_43 ( & V_66 , V_61 ) ;
F_44 (dd, tmp, &ipath_dev_list, ipath_list) {
F_45 ( & V_66 , V_61 ) ;
V_34 = F_27 ( V_45 , V_32 ) ;
if ( V_34 )
goto V_10;
...
static struct V_3 * F_46 ( struct V_67 * V_68 ,
int V_61 , const char * V_69 , void * V_7 )
{
struct V_3 * V_34 ;
V_34 = F_47 ( V_68 , V_61 , V_7 , F_41 ) ;
if ( ! F_11 ( V_34 ) )
V_70 = V_34 -> V_71 ;
return V_34 ;
}
static void F_48 ( struct V_44 * V_72 )
{
F_49 ( V_72 ) ;
V_70 = NULL ;
}
