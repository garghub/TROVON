...
struct V_143 * V_144 = & V_140 . V_140 ;
int V_60 ;
V_136 = F_54 ( V_81 , V_138 -> V_145 ) ;
if ( ! V_136 ) {
F_55 ( V_81 -> V_84 , L_8 ,
V_138 -> V_145 ) ;
return - V_25 ;
...
V_144 -> V_10 = V_138 -> V_10 ;
V_144 -> V_11 = V_138 -> V_11 ;
V_144 -> V_146 = V_138 -> V_146 ;
V_144 -> V_147 = V_138 -> V_147 ;
V_144 -> V_12 = V_136 -> V_12 ;
V_60 = F_56 ( V_134 , V_148 , V_149 , NULL , & V_140 ) ;
if ( V_60 < 0 )
return V_60 ;
if ( V_144 -> V_12 != V_136 -> V_12 )
return - V_25 ;
V_60 = F_6 ( V_6 , V_138 -> V_10 , V_138 -> V_11 , V_136 -> V_12 ) ;
if ( V_60 < 0 )
return V_60 ;
V_138 -> V_10 = V_144 -> V_10 ;
V_138 -> V_11 = V_144 -> V_11 ;
V_138 -> V_146 = V_144 -> V_146 ;
V_138 -> V_147 = V_144 -> V_147 ;
V_81 -> V_150 = V_136 ;
F_25 ( V_81 -> V_84 , L_10 ,
V_138 -> V_10 , V_138 -> V_11 ) ;
return V_60 ;
...
struct V_143 * V_144 = & V_140 . V_140 ;
T_1 V_154 = V_138 -> V_145 ;
int V_60 ;
V_136 = F_54 ( V_81 , V_154 ) ;
if ( V_154 && ! V_136 ) {
F_55 ( V_81 -> V_84 , L_8 , V_154 ) ;
return - V_25 ;
}
if ( V_138 -> V_11 > V_155 )
V_138 -> V_11 = V_155 ;
...
V_144 -> V_147 = V_138 -> V_147 ;
V_144 -> V_12 = V_136 -> V_12 ;
V_60 = F_56 ( V_134 , V_148 , V_149 , & V_152 , & V_140 ) ;
if ( V_60 < 0 )
return V_60 ;
V_138 -> V_10 = V_144 -> V_10 ;
V_138 -> V_11 = V_144 -> V_11 ;
...
static bool F_58 ( const struct V_159 * V_75 )
{
return V_75 -> V_160 == V_161 ||
( V_75 -> V_162 == 8 &&
V_75 -> V_160 == V_163 ) ||
( V_75 -> V_162 > 8 &&
V_75 -> V_160 == V_164 ) ;
...
unsigned long V_169 ;
int V_60 ;
V_60 = F_56 ( V_134 , V_170 , V_171 , & V_167 ) ;
if ( ! V_60 ) {
V_169 = F_60 ( & V_167 ,
V_172 ) ;
if ( ! V_169 ) {
...
const struct V_159 * V_75 ;
V_60 = F_56 ( V_134 , V_148 , V_179 , NULL , & V_12 ) ;
if ( V_60 < 0 )
return 0 ;
V_75 = F_62 ( V_12 . V_12 ) ;
if ( ! V_75 ) {
F_31 ( V_81 -> V_84 ,
L_13 , V_175 , V_12 . V_12 ) ;
return 0 ;
}
V_60 = F_59 ( V_81 , V_75 -> V_162 ) ;
if ( V_60 < 0 ) {
F_31 ( V_81 -> V_84 ,
L_14 ) ;
return 0 ;
...
if ( V_136 ) {
V_136 -> V_180 = & V_181 [ 0 ] ;
V_136 -> V_12 = V_12 . V_12 ;
V_136 ++ ;
F_25 ( V_81 -> V_84 , L_15 ,
V_181 [ 0 ] . V_182 , V_12 . V_12 ) ;
}
break;
default:
if ( ! F_58 ( V_75 ) )
...
static unsigned int F_70 ( struct V_186 * V_186 , T_3 * V_187 )
{
struct V_80 * V_81 = V_186 -> V_188 ;
return F_71 ( & V_81 -> V_189 , V_186 , V_187 ) ;
}
...
V_167 . V_110 = V_169 ;
V_60 = F_56 ( V_134 , V_170 , V_208 , & V_167 ) ;
...
{
struct V_82 * V_104 = F_24 ( & V_218 -> V_219 ) ;
...
struct V_217 * V_218 )
{
struct V_222 * V_223 = V_218 -> V_219 . V_224 ;
struct V_225 V_226 ;
int V_227 ;
V_6 -> V_106 . V_214 = 1 ;
V_6 -> V_106 . V_228 = V_229 ;
V_6 -> V_106 . V_107 = V_230 ;
V_223 = F_79 ( V_223 , NULL ) ;
if ( ! V_223 ) {
F_31 ( & V_218 -> V_219 , L_23 ) ;
return - V_25 ;
}
V_227 = F_80 ( V_223 , & V_226 ) ;
if ( V_227 ) {
F_31 ( & V_218 -> V_219 , L_24 ) ;
goto V_231;
}
switch ( V_226 . V_232 . V_233 . V_234 ) {
case 8 :
V_6 -> V_106 . V_235 = V_236 ;
break;
case 10 :
V_6 -> V_106 . V_235 =
V_236 | V_237 ;
break;
default:
F_31 ( & V_218 -> V_219 , L_25 ,
V_226 . V_232 . V_233 . V_234 ) ;
V_227 = - V_25 ;
goto V_231;
}
V_231:
...
static int F_82 ( struct V_217 * V_218 )
{
unsigned int V_55 ;
struct V_5 * V_6 ;
struct V_238 * V_9 ;
int V_60 , V_239 ;
struct V_240 * V_219 = & V_218 -> V_219 ;
struct V_82 * V_104 ;
struct V_241 * V_106 ;
V_106 = V_219 -> V_242 ;
if ( ( ! V_106 || ! V_106 -> V_235 ) && ! V_218 -> V_219 . V_224 ) {
F_31 ( & V_218 -> V_219 ,
L_26 ) ;
return - V_25 ;
}
V_6 = F_83 ( & V_218 -> V_219 , sizeof( struct V_5 ) , V_243 ) ;
if ( ! V_6 ) {
F_31 ( & V_218 -> V_219 , L_27 ) ;
return - V_244 ;
}
V_6 -> V_184 = F_84 ( & V_218 -> V_219 , L_28 ) ;
if ( F_67 ( V_6 -> V_184 ) )
return F_85 ( V_6 -> V_184 ) ;
if ( V_106 ) {
...
F_28 ( & V_6 -> V_44 ) ;
F_28 ( & V_6 -> V_94 ) ;
V_6 -> V_185 = F_84 ( V_219 , L_29 ) ;
if ( ! F_67 ( V_6 -> V_185 ) ) {
V_60 = F_87 ( V_6 -> V_185 , V_6 -> V_106 . V_228 ) ;
if ( V_60 < 0 )
return V_60 ;
}
V_6 -> V_220 = F_88 ( & V_218 -> V_219 ,
sizeof( struct V_1 ) * V_88 ,
& V_6 -> V_221 ,
V_243 ) ;
if ( ! V_6 -> V_220 ) {
F_31 ( & V_218 -> V_219 , L_30 ) ;
return - V_244 ;
}
for ( V_239 = 0 ; V_239 < V_88 ; V_239 ++ ) {
V_6 -> V_245 [ V_239 ] . V_95 = V_6 -> V_220 + V_239 ;
V_6 -> V_245 [ V_239 ] . V_48 = V_6 -> V_221 +
V_239 * sizeof( struct V_1 ) ;
F_35 ( & V_6 -> V_245 [ V_239 ] . V_39 , & V_6 -> V_94 ) ;
}
V_6 -> V_90 = F_89 ( & V_218 -> V_219 ) ;
if ( F_67 ( V_6 -> V_90 ) ) {
V_60 = F_85 ( V_6 -> V_90 ) ;
goto V_246;
}
V_9 = F_90 ( V_218 , V_247 , 0 ) ;
V_6 -> V_9 = F_91 ( & V_218 -> V_219 , V_9 ) ;
if ( F_67 ( V_6 -> V_9 ) ) {
V_60 = F_85 ( V_6 -> V_9 ) ;
goto V_248;
}
if ( V_6 -> V_106 . V_235 & V_236 )
V_6 -> V_174 = 1 << 7 ;
if ( V_6 -> V_106 . V_235 & V_237 )
V_6 -> V_174 |= 1 << 9 ;
F_2 ( V_6 , V_26 , V_27 ) ;
V_55 = F_92 ( V_218 , 0 ) ;
if ( F_93 ( V_55 ) ) {
...
V_60 = F_94 ( & V_218 -> V_219 , V_55 , F_13 , 0 , L_31 , V_6 ) ;
if ( V_60 ) {
F_31 ( & V_218 -> V_219 , L_32 , V_55 ) ;
goto V_249;
}
V_6 -> V_55 = V_55 ;
V_104 = & V_6 -> V_104 ;
...
V_104 -> V_125 = & V_251 ;
V_104 -> V_85 = V_6 ;
V_104 -> V_252 . V_219 = & V_218 -> V_219 ;
V_104 -> V_253 = V_218 -> V_254 ;
if ( V_6 -> V_106 . V_255 ) {
V_104 -> V_256 = V_6 -> V_106 . V_256 ;
V_104 -> V_255 = V_6 -> V_106 . V_255 ;
}
V_60 = F_95 ( V_104 ) ;
if ( V_60 ) {
F_31 ( & V_218 -> V_219 , L_34 ) ;
goto V_257;
}
return 0 ;
V_257:
