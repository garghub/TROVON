...
V_5 -> V_323 = F_180 ( V_428 , V_5 -> V_366 ) ;
if ( V_5 -> V_323 == NULL ) {
F_38 ( & V_5 -> V_2 -> V_10 ,
L_121 ) ;
V_67 = - V_205 ;
...
do {
if ( ! F_181 ( & V_430 , V_159 ) )
goto V_431;
F_28 ( & V_432 ) ;
V_67 = F_182 ( & V_430 , & V_380 ) ;
F_31 ( & V_432 ) ;
} while ( V_67 == - V_173 );
if ( V_67 )
goto V_431;
...
if ( V_67 )
goto V_434;
V_5 -> V_323 -> V_435 = & V_5 -> V_2 -> V_10 ;
V_5 -> V_323 -> V_436 = V_5 -> V_436 ;
V_5 -> V_323 -> V_437 = V_380 * V_428 ;
V_5 -> V_323 -> V_438 = V_428 ;
V_5 -> V_323 -> V_439 = & V_440 ;
V_5 -> V_323 -> V_305 = V_5 ;
V_5 -> V_380 = V_380 ;
F_125 ( V_5 ) ;
V_426:
memset ( & V_5 -> V_21 , 0 , sizeof( V_5 -> V_21 ) ) ;
V_5 -> V_21 . V_441 = & V_442 ;
V_5 -> V_21 . V_443 = 1 ;
V_5 -> V_21 . V_444 = V_418 ;
V_5 -> V_21 . V_445 = 1 ;
V_5 -> V_21 . V_446 = sizeof( struct V_12 ) ;
...
if ( V_424 == V_342 )
goto V_450;
F_4 ( V_451 , & V_5 -> V_7 -> V_9 ) ;
F_49 ( V_452 , & V_5 -> V_7 -> V_9 ) ;
F_186 ( V_5 -> V_7 , V_423 ) ;
F_187 ( V_5 -> V_7 , 4096 ) ;
F_188 ( V_5 -> V_7 , 0xffff ) ;
F_189 ( V_5 -> V_7 , 0x400000 ) ;
F_190 ( V_5 -> V_7 , 4096 ) ;
F_191 ( V_5 -> V_7 , V_5 -> V_2 -> V_453 ) ;
F_192 ( V_5 -> V_7 , 0 ) ;
if ( V_5 -> V_186 == true ) {
F_4 ( V_454 , & V_5 -> V_7 -> V_9 ) ;
V_5 -> V_7 -> V_455 . V_456 = 4096 ;
F_193 ( V_5 -> V_7 ,
V_216 * V_217 ) ;
V_5 -> V_7 -> V_455 . V_457 = 0 ;
}
if ( ! ( F_89 ( V_5 , & V_400 ) ) ) {
F_5 ( & V_5 -> V_2 -> V_10 ,
L_125 ) ;
...
V_450:
sprintf ( V_425 , L_126 , V_380 ) ;
V_5 -> V_460 = F_200 ( F_137 ,
V_5 , V_5 -> V_366 , L_74 ,
V_425 ) ;
if ( F_185 ( V_5 -> V_460 ) ) {
...
static void F_213 ( int V_463 )
{
V_464 [ V_463 ] -- ;
}
static int F_214 ( int V_465 )
{
...
( ( V_2 -> V_480 -> V_481 -> V_197 & 0xff00 ) == 0x5a00 ) ) {
F_220 ( V_5 , V_2 -> V_480 -> V_481 ) ;
} else {
...
char V_487 [ 256 ] ;
const struct V_468 * V_469 ;
int V_463 , V_49 = 0 , V_488 = 0 ;
int V_489 = V_490 ;
unsigned long V_91 ;
V_489 = F_225 ( V_2 -> V_480 ) ;
if ( V_489 != V_490 ) {
if ( ! F_226 ( V_489 ) )
V_489 = F_218 () ;
} else {
...
F_48 ( & V_2 -> V_10 , L_134 ,
V_489 , F_225 ( V_2 -> V_480 ) , F_227 ( & V_2 -> V_10 ) ,
F_228 ( F_229 () ) , F_229 () ) ;
V_5 = F_147 ( sizeof( struct V_4 ) , V_159 , V_489 ) ;
if ( V_5 == NULL ) {
F_38 ( & V_2 -> V_10 ,
L_135 ) ;
return - V_219 ;
...
snprintf ( V_5 -> V_496 , 31 , L_139 , V_5 -> V_130 ) ;
V_5 -> V_126 = F_237 ( V_5 -> V_496 ) ;
if ( ! V_5 -> V_126 ) {
...
V_469 = F_215 ( V_5 -> V_366 ) ;
if ( ! F_238 ( V_469 ) ) {
F_217 (cpu, node_mask)
{
snprintf ( & V_487 [ V_488 ] , 256 - V_488 , L_141 , V_463 ) ;
V_488 = strlen ( V_487 ) ;
}
F_48 ( & V_2 -> V_10 , L_142 ,
V_5 -> V_366 ,
...
F_241 (cpu) {
memset ( V_487 , 0 , sizeof( V_487 ) ) ;
for ( V_49 = 0 , V_488 = 0 ; V_49 < V_123 ; V_49 ++ ) {
if ( V_5 -> V_124 [ V_49 ] . V_125 == V_463 ) {
snprintf ( & V_487 [ V_488 ] , 256 - V_488 , L_141 , V_49 ) ;
V_488 = strlen ( V_487 ) ;
}
}
if ( V_488 )
F_48 ( & V_2 -> V_10 , L_145 , V_463 , V_487 ) ;
}
F_242 ( & V_5 -> V_124 [ 0 ] . V_124 , V_498 ) ;
F_242 ( & V_5 -> V_124 [ 1 ] . V_124 , V_499 ) ;
F_242 ( & V_5 -> V_124 [ 2 ] . V_124 , V_500 ) ;
F_242 ( & V_5 -> V_124 [ 3 ] . V_124 , V_501 ) ;
F_242 ( & V_5 -> V_124 [ 4 ] . V_124 , V_502 ) ;
F_242 ( & V_5 -> V_124 [ 5 ] . V_124 , V_503 ) ;
F_242 ( & V_5 -> V_124 [ 6 ] . V_124 , V_504 ) ;
F_242 ( & V_5 -> V_124 [ 7 ] . V_124 , V_505 ) ;
F_243 ( V_2 ) ;
V_67 = F_244 ( V_2 ) ;
if ( V_67 ) {
F_5 ( & V_2 -> V_10 ,
...
static int F_253 ( struct V_1 * V_2 , T_15 V_509 )
{
int V_67 = 0 ;
struct V_4 * V_5 = F_2 ( V_2 ) ;
if ( ! V_5 ) {
