...
V_1 = V_55 + V_9 ;
F_38 ( V_1 , V_35 ) ;
V_35 -> V_60 = F_39 ( V_56 , L_12 , V_11 -> V_24 ) ;
V_14 = F_40 ( V_1 , NULL , F_30 ,
V_61 | V_62 ,
V_35 -> V_60 ? : V_11 -> V_24 , NULL ) ;
F_41 ( V_54 , L_13 , V_11 -> V_24 ,
V_1 , V_37 , V_37 + V_13 - 1 ) ;
return V_14 < 0 ? V_14 : V_37 ;
}
int F_42 ( struct V_53 * V_54 , int V_63 )
{
static struct V_64 V_65 ;
int V_14 , V_13 ;
int V_37 , V_66 , V_67 ;
struct V_68 * V_69 = V_54 -> V_70 ;
V_67 = V_71 + V_72 ;
