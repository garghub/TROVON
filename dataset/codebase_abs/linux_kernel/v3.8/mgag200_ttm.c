...
int F_46 ( struct V_80 * V_66 , int V_15 , int V_98 ,
T_1 V_34 , struct V_27 * * V_99 )
{
struct V_1 * V_57 = V_66 -> V_100 ;
struct V_27 * V_49 ;
T_3 V_101 ;
int V_79 ;
...
F_18 ( V_49 , V_93 | V_50 ) ;
V_101 = F_48 ( & V_57 -> V_4 . V_5 , V_15 ,
sizeof( struct V_27 ) ) ;
V_79 = F_49 ( & V_57 -> V_4 . V_5 , & V_49 -> V_28 , V_15 ,
V_104 , & V_49 -> V_51 ,
V_98 >> V_62 , false , NULL , V_101 ,
NULL , F_12 ) ;
if ( V_79 )
return V_79 ;
* V_99 = V_49 ;
...
struct V_114 * V_115 ;
struct V_1 * V_57 ;
if ( F_57 ( V_113 -> V_116 < V_82 ) )
return F_58 ( V_53 , V_113 ) ;
V_115 = V_53 -> V_117 ;
V_57 = V_115 -> V_118 -> V_66 -> V_100 ;
return F_59 ( V_53 , V_113 , & V_57 -> V_4 . V_5 ) ;
}
