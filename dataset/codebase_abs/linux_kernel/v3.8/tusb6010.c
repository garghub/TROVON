...
return - V_181 ;
V_183 = F_71 ( V_1 -> V_21 ) ;
V_185 = F_72 ( V_183 , V_188 , 0 ) ;
V_1 -> V_189 = V_185 -> V_190 ;
V_185 = F_72 ( V_183 , V_188 , 1 ) ;
if ( ! V_185 ) {
F_73 ( L_41 ) ;
V_60 = - V_181 ;
goto V_76;
}
V_1 -> V_186 = V_185 -> V_190 ;
V_186 = F_74 ( V_185 -> V_190 , F_75 ( V_185 ) ) ;
if ( ! V_186 ) {
F_73 ( L_42 ) ;
V_60 = - V_191 ;
goto V_76;
...
struct V_200 * V_201 ;
int V_60 = - V_191 ;
V_201 = F_83 ( sizeof( * V_201 ) , V_202 ) ;
if ( ! V_201 ) {
F_84 ( & V_183 -> V_198 , L_44 ) ;
goto V_203;
}
V_1 = F_85 ( L_45 , V_204 ) ;
if ( ! V_1 ) {
F_84 ( & V_183 -> V_198 , L_46 ) ;
goto V_205;
}
V_1 -> V_198 . V_206 = & V_183 -> V_198 ;
V_1 -> V_198 . V_207 = & V_208 ;
V_1 -> V_198 . V_209 = V_208 ;
V_201 -> V_198 = & V_183 -> V_198 ;
V_201 -> V_1 = V_1 ;
V_197 -> V_210 = & V_211 ;
F_86 ( V_183 , V_201 ) ;
...
V_183 -> V_212 ) ;
if ( V_60 ) {
F_84 ( & V_183 -> V_198 , L_47 ) ;
goto V_213;
}
V_60 = F_88 ( V_1 , V_197 , sizeof( * V_197 ) ) ;
if ( V_60 ) {
F_84 ( & V_183 -> V_198 , L_48 ) ;
goto V_213;
}
V_60 = F_89 ( V_1 ) ;
if ( V_60 ) {
F_84 ( & V_183 -> V_198 , L_49 ) ;
goto V_213;
}
return 0 ;
V_213:
