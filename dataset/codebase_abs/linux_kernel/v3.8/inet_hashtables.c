...
if ( V_18 -> V_62 != V_47 )
continue;
if ( F_45 ( F_46 ( V_18 , V_4 , V_63 ,
V_55 , V_35 , V_57 , V_36 ) ) ) {
if ( F_37 ( ! F_38 ( & V_18 -> V_54 ) ) )
goto V_64;
if ( F_37 ( ! F_46 ( V_18 , V_4 , V_63 ,
V_55 , V_35 , V_57 , V_36 ) ) ) {
F_39 ( V_18 ) ;
goto V_52;
}
...
struct V_17 * V_18 , T_5 V_68 ,
struct V_69 * * V_70 )
{
struct V_19 * V_71 = V_67 -> V_20 ;
struct V_38 * V_39 = F_14 ( V_18 ) ;
T_1 V_35 = V_39 -> V_41 ;
T_1 V_55 = V_39 -> V_72 ;
int V_36 = V_18 -> V_44 ;
F_42 (acookie, saddr, daddr)
const T_4 V_57 = F_43 ( V_39 -> V_73 , V_68 ) ;
struct V_4 * V_4 = F_19 ( V_18 ) ;
unsigned int V_47 = F_44 ( V_4 , V_35 , V_68 ,
V_55 , V_39 -> V_73 ) ;
struct V_60 * V_6 = V_60 ( V_71 , V_47 ) ;
T_6 * V_28 = F_49 ( V_71 , V_47 ) ;
struct V_17 * V_74 ;
const struct V_46 * V_15 ;
struct V_69 * V_75 ;
int V_76 = 0 ;
F_21 ( V_28 ) ;
F_50 (sk2, node, &head->twchain) {
if ( V_74 -> V_62 != V_47 )
continue;
if ( F_45 ( F_47 ( V_74 , V_4 , V_63 ,
V_55 , V_35 , V_57 , V_36 ) ) ) {
V_75 = F_51 ( V_74 ) ;
if ( F_52 ( V_18 , V_74 , V_70 ) )
goto V_77;
else
goto V_78;
}
...
V_75 = NULL ;
F_50 (sk2, node, &head->chain) {
if ( V_74 -> V_62 != V_47 )
continue;
if ( F_45 ( F_46 ( V_74 , V_4 , V_63 ,
V_55 , V_35 , V_57 , V_36 ) ) )
goto V_78;
}
V_77:
...
static inline T_7 F_62 ( const struct V_17 * V_18 )
{
const struct V_38 * V_39 = F_14 ( V_18 ) ;
return F_63 ( V_39 -> V_41 ,
V_39 -> V_72 ,
V_39 -> V_73 ) ;
}
int F_64 ( struct V_17 * V_18 , struct V_69 * V_75 )
{
struct V_19 * V_20 = V_18 -> V_21 -> V_22 . V_20 ;
struct V_82 * V_83 ;
T_6 * V_28 ;
...
F_54 ( ! F_55 ( V_18 ) ) ;
V_18 -> V_62 = F_65 ( V_18 ) ;
V_6 = V_60 ( V_20 , V_18 -> V_62 ) ;
V_83 = & V_6 -> V_16 ;
V_28 = F_49 ( V_20 , V_18 -> V_62 ) ;
F_21 ( V_28 ) ;
F_56 ( V_18 , V_83 ) ;
if ( V_75 ) {
F_54 ( V_18 -> V_62 != V_75 -> V_84 ) ;
V_76 = F_57 ( V_75 ) ;
}
F_23 ( V_28 ) ;
F_60 ( F_19 ( V_18 ) , V_18 -> V_21 , 1 ) ;
...
int F_73 ( struct V_66 * V_67 ,
struct V_17 * V_18 , T_7 V_89 ,
int (* F_74)( struct V_66 * ,
struct V_17 * , T_5 , struct V_69 * * ) ,
int (* V_47)( struct V_17 * V_18 , struct V_69 * V_70 ) )
{
struct V_19 * V_71 = V_67 -> V_20 ;
...
V_6 = & V_71 -> V_26 [ F_18 ( V_4 , V_7 , V_71 -> V_27 ) ] ;
V_8 = F_16 ( V_18 ) -> V_25 ;
F_70 ( & V_6 -> V_28 ) ;
if ( F_78 ( & V_8 -> V_14 ) == V_18 && ! V_18 -> V_99 . V_100 ) {
V_47 ( V_18 , NULL ) ;
F_72 ( & V_6 -> V_28 ) ;
return 0 ;
} else {
F_23 ( & V_6 -> V_28 ) ;
V_90 = F_74 ( V_67 , V_18 , V_7 , NULL ) ;
V_65:
F_26 () ;
return V_90 ;
}
}
int F_79 ( struct V_66 * V_67 ,
struct V_17 * V_18 )
{
return F_73 ( V_67 , V_18 , F_62 ( V_18 ) ,
F_48 , F_64 ) ;
}
void F_80 ( struct V_19 * V_22 )
{
int V_91 ;
F_81 ( & V_22 -> V_23 , 0 ) ;
for ( V_91 = 0 ; V_91 < V_101 ; V_91 ++ ) {
F_82 ( & V_22 -> V_50 [ V_91 ] . V_28 ) ;
F_83 ( & V_22 -> V_50 [ V_91 ] . V_6 ,
V_91 + V_53 ) ;
}
}
