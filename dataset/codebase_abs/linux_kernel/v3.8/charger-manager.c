...
return sprintf ( V_158 , L_33 , V_145 -> V_53 ) ;
}
...
struct V_159 , V_163 ) ;
return sprintf ( V_158 , L_36 , V_145 -> V_51 ) ;
}
...
static int F_93 ( struct V_166 * V_167 )
{
...
case V_208 :
case V_209 :
F_16 ( V_2 , V_203 ? V_203 : V_79 [ type ] ) ;
break;
default:
F_22 ( V_2 -> V_27 , L_80 , V_71 ) ;
break;
}
}
