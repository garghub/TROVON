...
if ( V_9 ) {
if ( V_9 -> V_113 [ 0 ] )
F_45 ( V_9 -> V_113 [ 0 ] , V_9 -> V_136 [ 0 ] ) ;
if ( V_9 -> V_113 [ 1 ] )
F_45 ( V_9 -> V_113 [ 1 ] , V_9 -> V_136 [ 1 ] ) ;
if ( V_9 -> V_78 )
F_46 ( V_9 -> V_78 ) ;
}
if ( V_2 -> V_99 )
...
static int F_50 ( struct V_1 * V_2 , struct V_148 * V_149 )
{
const struct V_42 * V_43 = F_14 ( V_2 ) ;
struct V_8 * V_9 ;
int V_150 , V_151 ;
...
V_15 = V_149 -> V_154 [ 0 ] ;
F_6 ( V_155 L_5 ,
V_2 -> V_22 , V_43 -> V_156 , V_15 ) ;
if ( ! F_51 ( V_15 , V_43 -> V_137 , L_6 ) ) {
F_6 ( L_7 ) ;
return - V_157 ;
}
V_2 -> V_15 = V_15 ;
V_9 = F_52 ( sizeof( * V_9 ) , V_158 ) ;
if ( ! V_9 ) {
F_44 ( V_2 ) ;
return - V_159 ;
}
...
V_9 -> V_136 [ 0 ] = V_152 ;
V_9 -> V_98 [ 0 ] = F_56 ( ( void * ) V_9 -> V_113 [ 0 ] ) ;
V_9 -> V_94 [ 0 ] = V_165 * ( 1 << V_152 ) ;
V_9 -> V_113 [ 1 ] = F_55 ( V_158 , V_152 ) ;
if ( ! V_9 -> V_113 [ 1 ] ) {
F_6 ( V_163 L_15 ) ;
F_44 ( V_2 ) ;
return - V_164 ;
...
V_9 -> V_136 [ 1 ] = V_152 ;
V_9 -> V_98 [ 1 ] = F_56 ( ( void * ) V_9 -> V_113 [ 1 ] ) ;
V_9 -> V_94 [ 1 ] = V_165 * ( 1 << V_152 ) ;
}
V_161:
V_153 = 0 ;
if ( V_43 -> V_166 > 0 )
...
case V_143 :
if ( V_149 -> V_154 [ 2 ] == 1 ) {
V_4 -> V_173 = V_43 -> V_174 ;
V_4 -> V_171 |= V_175 ;
V_9 -> V_128 = 1 ;
} else {
V_4 -> V_173 = V_43 -> V_166 ;
V_4 -> V_171 |= V_176 ;
}
break;
case V_141 :
...
V_4 -> V_177 = V_43 -> V_178 ;
V_4 -> V_179 = V_66 ;
V_4 -> V_180 = V_43 -> V_181 ;
if ( V_43 -> V_138 == V_142 )
V_4 -> V_182 = F_7 ;
else
V_4 -> V_182 = F_1 ;
V_9 -> V_127 = V_43 -> V_183 ;
V_4 -> V_184 = F_31 ;
if ( V_2 -> V_99 ) {
V_2 -> V_185 = V_4 ;
V_4 -> V_171 |= V_186 ;
...
V_4 -> V_173 = V_43 -> V_167 ;
V_4 -> V_177 = 0xfff ;
V_4 -> V_179 = 1 ;
V_4 -> V_180 = V_43 -> V_208 ;
V_4 -> V_182 = F_10 ;
V_4 -> V_209 = F_8 ;
switch ( V_43 -> V_138 ) {
case V_143 :
...
V_4 -> type = V_212 ;
V_4 -> V_171 = V_172 ;
V_4 -> V_173 = V_43 -> V_168 ;
V_4 -> V_177 = 1 ;
V_4 -> V_179 = V_43 -> V_168 ;
V_4 -> V_180 = & V_213 ;
V_4 -> V_214 = F_11 ;
V_151 ++ ;
}
...
V_4 -> type = V_215 ;
V_4 -> V_171 = V_207 ;
V_4 -> V_173 = V_43 -> V_169 ;
V_4 -> V_177 = 1 ;
V_4 -> V_179 = V_43 -> V_169 ;
V_4 -> V_180 = & V_213 ;
V_4 -> V_214 = F_12 ;
V_151 ++ ;
}
