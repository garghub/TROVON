...
static int F_34 ( struct V_9 * V_10 , void * V_54 )
{
struct V_55 * V_56 = F_35 ( V_10 ) ;
struct V_12 * V_13 = F_36 ( V_56 ) ;
struct V_57 * V_58 ;
struct V_59 * V_60 , * V_61 ;
if ( ! V_13 || ! V_13 -> V_10 )
return - V_27 ;
V_58 = F_37 ( sizeof( * V_58 ) , V_15 ) ;
if ( ! V_58 )
return - V_16 ;
V_58 -> V_62 = V_13 ;
V_10 -> V_63 . V_64 = V_58 ;
V_60 = F_38 ( V_13 -> V_65 , V_66 ) ;
if ( ! V_60 )
goto V_67;
V_61 = V_60 ;
...
static int F_42 ( struct V_9 * V_10 , void * V_54 )
{
if ( ! V_10 -> V_63 . V_64 )
return 0 ;
F_10 ( V_10 -> V_63 . V_64 ) ;
