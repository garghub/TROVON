...
static T_2 F_37 ( struct V_40 * V_13 ,
struct V_50 * args )
{
T_2 V_3 ;
...
static void F_40 ( struct V_40 * V_13 )
{
struct V_50 args ;
...
static T_1
F_45 ( struct V_90 * V_91 , struct V_92 * args )
{
struct V_93 * V_94 ;
F_12 ( L_11 ,
...
if ( F_46 ( args -> V_96 == V_94 -> V_100 + 1 ) ) {
V_94 -> V_100 ++ ;
goto V_101;
}
...
static bool F_47 ( struct V_40 * V_13 ,
T_3 V_108 ,
struct V_109 * V_110 )
{
bool V_11 = 0 ;
...
int V_78 ;
T_1 V_11 = F_2 ( V_130 ) ;
V_13 = F_49 ( V_5 -> V_131 , args -> V_132 , & args -> V_133 ) ;
if ( V_13 == NULL )
goto V_14;
...
V_11 = F_45 ( & V_13 -> V_117 -> V_134 , args ) ;
F_22 ( & V_91 -> V_127 ) ;
if ( V_11 )
goto V_14;
V_5 -> V_139 = args -> V_95 ;
if ( F_47 ( V_13 , args -> V_140 , args -> V_141 ) ) {
V_11 = F_2 ( V_58 ) ;
goto V_14;
}
...
static bool
F_50 ( unsigned long V_149 )
{
return ( V_149 & ~ V_150 ) == 0 ;
}
T_1 F_51 ( struct V_151 * args , void * V_34 ,
struct V_4 * V_5 )
{
T_1 V_11 ;
T_4 V_152 = 0 ;
...
T_1 F_53 ( struct V_159 * args , void * V_34 ,
struct V_4 * V_5 )
{
struct V_90 * V_160 ;
T_1 V_11 ;
