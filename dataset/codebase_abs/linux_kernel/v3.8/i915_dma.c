...
F_25 ( L_26 , ( T_1 ) V_170 -> V_16 ) ;
V_22 = F_5 ( V_2 ) ;
V_22 -> V_23 . V_24 = V_170 -> V_16 & ( 0x1ffff << 12 ) ;
V_2 -> V_5 . V_6 =
F_73 ( V_2 -> V_158 . V_171 + V_170 -> V_16 , 4096 ) ;
if ( V_2 -> V_5 . V_6 == NULL ) {
F_18 ( V_4 ) ;
V_22 -> V_23 . V_24 = 0 ;
F_26 ( L_5
...
{
T_2 * V_2 = V_4 -> V_8 ;
int V_3 = F_9 ( V_4 ) -> V_19 >= 4 ? V_174 : V_175 ;
T_1 V_176 , V_177 = 0 ;
T_12 V_178 ;
int V_40 ;
if ( F_9 ( V_4 ) -> V_19 >= 4 )
F_79 ( V_2 -> V_173 , V_3 + 4 , & V_177 ) ;
F_79 ( V_2 -> V_173 , V_3 , & V_176 ) ;
V_178 = ( ( T_12 ) V_177 << 32 ) | V_176 ;
#ifdef F_80
if ( V_178 &&
F_81 ( V_178 , V_178 + V_179 ) )
return 0 ;
#endif
V_2 -> V_180 . V_181 = L_31 ;
V_2 -> V_180 . V_182 = V_183 ;
V_40 = F_82 ( V_2 -> V_173 -> V_184 ,
& V_2 -> V_180 ,
V_179 , V_179 ,
V_185 ,
0 , V_186 ,
...
{
T_2 * V_2 = V_4 -> V_8 ;
int V_187 = F_9 ( V_4 ) -> V_19 >= 4 ? V_174 : V_175 ;
T_1 V_188 ;
bool V_189 ;
V_2 -> V_190 = false ;
if ( F_87 ( V_4 ) || F_88 ( V_4 ) ) {
F_79 ( V_2 -> V_173 , V_191 , & V_188 ) ;
V_189 = ! ! ( V_188 & V_192 ) ;
} else {
F_79 ( V_2 -> V_173 , V_187 , & V_188 ) ;
V_189 = V_188 & 1 ;
}
if ( V_189 )
return;
...
V_2 -> V_190 = true ;
if ( F_87 ( V_4 ) || F_88 ( V_4 ) ) {
F_83 ( V_2 -> V_173 , V_191 ,
V_188 | V_192 ) ;
} else {
F_79 ( V_2 -> V_173 , V_187 , & V_188 ) ;
F_83 ( V_2 -> V_173 , V_187 , V_188 | 1 ) ;
}
}
static void
F_89 ( struct V_7 * V_4 )
...
F_79 ( V_2 -> V_173 , V_191 , & V_188 ) ;
V_188 &= ~ V_192 ;
F_83 ( V_2 -> V_173 , V_191 , V_188 ) ;
} else {
F_79 ( V_2 -> V_173 , V_187 , & V_188 ) ;
V_188 &= ~ 1 ;
F_83 ( V_2 -> V_173 , V_187 , V_188 ) ;
}
}
if ( V_2 -> V_180 . V_93 )
F_90 ( & V_2 -> V_180 ) ;
}
static unsigned int F_91 ( void * V_193 , bool V_194 )
{
struct V_7 * V_4 = V_193 ;
F_92 ( V_4 , V_194 ) ;
if ( V_194 )
return V_195 | V_196 |
V_197 | V_198 ;
...
static void F_93 ( struct V_199 * V_133 , enum V_200 V_194 )
{
struct V_7 * V_4 = F_94 ( V_133 ) ;
T_13 V_201 = { . V_202 = V_203 } ;
if ( V_194 == V_204 ) {
F_95 ( L_33 ) ;
V_4 -> V_205 = V_206 ;
F_96 ( V_4 -> V_133 , V_207 ) ;
F_97 ( V_4 ) ;
V_4 -> V_205 = V_208 ;
} else {
F_98 ( L_34 ) ;
...
static bool F_100 ( struct V_199 * V_133 )
{
struct V_7 * V_4 = F_94 ( V_133 ) ;
bool V_210 ;
F_101 ( & V_4 -> V_211 ) ;
...
int F_121 ( struct V_7 * V_4 , struct V_224 * V_12 )
{
struct V_9 * V_10 ;
V_10 = F_122 ( sizeof( * V_10 ) , V_108 ) ;
if ( ! V_10 )
return - V_58 ;
V_12 -> V_13 = V_10 ;
return 0 ;
}
void F_123 ( struct V_7 * V_4 , struct V_224 * V_12 )
{
...
static void
F_124 ( struct V_1 * V_2 , unsigned long V_225 ,
unsigned long V_32 )
{
V_2 -> V_158 . V_226 = - 1 ;
#if F_125 ( V_227 )
...
return;
#endif
V_2 -> V_158 . V_226 = F_126 ( V_225 , V_32 , V_229 , 1 ) ;
if ( V_2 -> V_158 . V_226 < 0 ) {
F_105 ( L_36
L_37 ) ;
}
}
...
{
struct V_230 * V_231 ;
struct V_199 * V_133 = V_2 -> V_4 -> V_133 ;
bool V_11 ;
V_231 = F_128 ( 1 ) ;
if ( ! V_231 )
return;
V_231 -> V_232 [ 0 ] . V_225 = V_2 -> V_158 . V_233 -> V_234 ;
V_231 -> V_232 [ 0 ] . V_32 =
V_2 -> V_158 . V_233 -> V_235 << V_236 ;
V_11 =
V_133 -> V_237 [ V_238 ] . V_182 & V_239 ;
F_129 ( V_231 , L_38 , V_11 ) ;
F_52 ( V_231 ) ;
}
static void F_130 ( struct V_1 * V_2 )
{
const struct V_240 * V_241 = V_2 -> V_241 ;
#define F_131 ( V_181 ) info->name ? #name "," : ""
#define F_132 ,
F_25 ( L_39
L_40 ,
V_241 -> V_19 ,
...
int F_133 ( struct V_7 * V_4 , unsigned long V_182 )
{
struct V_1 * V_2 ;
struct V_240 * V_241 ;
int V_40 = 0 , V_244 , V_245 ;
T_14 V_246 ;
V_241 = (struct V_240 * ) V_182 ;
...
F_135 ( V_4 -> V_133 ) ;
if ( F_136 ( V_4 ) )
F_137 ( & V_4 -> V_133 -> V_4 , F_138 ( 30 ) ) ;
if ( F_139 ( V_4 ) || F_140 ( V_4 ) )
F_137 ( & V_4 -> V_133 -> V_4 , F_138 ( 32 ) ) ;
V_244 = F_136 ( V_4 ) ? 1 : 0 ;
if ( V_241 -> V_19 < 5 )
V_245 = 512 * 1024 ;
else
V_245 = 2 * 1024 * 1024 ;
V_2 -> V_256 = F_141 ( V_4 -> V_133 , V_244 , V_245 ) ;
if ( ! V_2 -> V_256 ) {
F_26 ( L_41 ) ;
V_40 = - V_253 ;
goto V_257;
}
V_246 = V_2 -> V_158 . V_233 -> V_235 << V_236 ;
V_2 -> V_158 . V_171 = V_2 -> V_158 . V_233 -> V_234 ;
V_2 -> V_158 . V_258 =
F_142 ( V_2 -> V_158 . V_171 ,
V_246 ) ;
if ( V_2 -> V_158 . V_258 == NULL ) {
V_40 = - V_253 ;
goto V_259;
}
F_124 ( V_2 , V_2 -> V_158 . V_171 ,
V_246 ) ;
V_2 -> V_260 = F_143 ( L_42 , 0 ) ;
if ( V_2 -> V_260 == NULL ) {
F_26 ( L_43 ) ;
V_40 = - V_58 ;
goto V_261;
...
F_149 ( V_4 ) ;
F_150 ( V_4 ) ;
if ( ! F_151 ( V_4 ) && ! F_152 ( V_4 ) )
F_153 ( V_4 -> V_133 ) ;
F_154 ( & V_2 -> V_262 ) ;
F_154 ( & V_2 -> V_263 ) ;
F_154 ( & V_2 -> V_264 . V_265 ) ;
F_154 ( & V_2 -> V_266 ) ;
F_155 ( & V_2 -> V_264 . V_267 ) ;
if ( F_156 ( V_4 ) || F_157 ( V_4 ) )
V_2 -> V_268 = 3 ;
else if ( F_158 ( V_4 ) || ! F_136 ( V_4 ) )
V_2 -> V_268 = 2 ;
else
V_2 -> V_268 = 1 ;
V_40 = F_159 ( V_4 , V_2 -> V_268 ) ;
if ( V_40 )
goto V_269;
V_2 -> V_158 . V_223 = 1 ;
if ( F_15 ( V_4 , V_25 ) ) {
...
V_261:
if ( V_2 -> V_158 . V_226 >= 0 ) {
F_169 ( V_2 -> V_158 . V_226 ,
V_2 -> V_158 . V_171 ,
V_246 ) ;
V_2 -> V_158 . V_226 = - 1 ;
}
F_170 ( V_2 -> V_158 . V_258 ) ;
V_259:
F_171 ( V_4 -> V_133 , V_2 -> V_256 ) ;
V_257:
F_172 ( V_4 ) ;
V_255:
F_173 ( V_2 -> V_173 ) ;
...
F_178 ( V_4 ) ;
F_22 ( & V_4 -> V_37 ) ;
F_179 ( & V_2 -> V_158 . V_275 ) ;
F_170 ( V_2 -> V_158 . V_258 ) ;
if ( V_2 -> V_158 . V_226 >= 0 ) {
F_169 ( V_2 -> V_158 . V_226 ,
V_2 -> V_158 . V_171 ,
V_2 -> V_158 . V_233 -> V_235 * V_172 ) ;
V_2 -> V_158 . V_226 = - 1 ;
}
F_180 () ;
if ( F_15 ( V_4 , V_25 ) ) {
...
int F_192 ( struct V_7 * V_4 , struct V_61 * V_280 )
{
struct V_281 * V_62 ;
F_25 ( L_17 ) ;
...
return - V_58 ;
V_280 -> V_13 = V_62 ;
F_154 ( & V_62 -> V_158 . V_265 ) ;
F_193 ( & V_62 -> V_158 . V_282 ) ;
F_194 ( & V_62 -> V_283 ) ;
return 0 ;
}
...
void F_202 ( struct V_7 * V_4 , struct V_61 * V_280 )
{
struct V_281 * V_62 = V_280 -> V_13 ;
F_52 ( V_62 ) ;
}
