...
V_184 [ F_218 ( V_182 -> V_13 [ V_14 ] ) ] ++ ;
F_219 (nr, N_HIGH_MEMORY)
if ( V_184 [ V_14 ] )
F_220 ( V_180 , L_7 , V_14 , V_184 [ V_14 ] ) ;
}
}
static int F_221 ( struct V_179 * V_180 , void * V_33 )
{
struct V_107 * V_182 = V_33 ;
F_220 ( V_180 , L_8 ,
V_182 -> V_2 , V_182 -> V_2 + V_182 -> V_40 , V_182 -> V_40 ) ;
if ( V_182 -> V_114 )
F_220 ( V_180 , L_9 , V_182 -> V_114 ) ;
if ( V_182 -> V_122 )
F_220 ( V_180 , L_10 , V_182 -> V_122 ) ;
if ( V_182 -> V_187 )
F_220 ( V_180 , L_11 , ( unsigned long long ) V_182 -> V_187 ) ;
if ( V_182 -> V_59 & V_117 )
F_220 ( V_180 , L_12 ) ;
if ( V_182 -> V_59 & V_134 )
F_220 ( V_180 , L_13 ) ;
...
static int F_223 ( struct V_189 * V_189 , struct V_190 * V_190 )
{
unsigned int * V_191 = NULL ;
int V_19 ;
if ( F_217 ( V_183 ) ) {
V_191 = F_224 ( V_186 * sizeof( unsigned int ) , V_106 ) ;
if ( V_191 == NULL )
return - V_15 ;
}
V_19 = F_225 ( V_190 , & V_192 ) ;
if ( ! V_19 ) {
