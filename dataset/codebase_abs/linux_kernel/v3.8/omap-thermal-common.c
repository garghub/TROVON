...
static struct V_3
* F_23 ( struct V_16 * V_17 , int V_31 )
{
struct V_3 * V_4 ;
V_4 = F_24 ( V_17 -> V_47 , sizeof( * V_4 ) , V_48 ) ;
if ( ! V_4 ) {
F_25 ( V_17 -> V_47 , L_4 ) ;
return NULL ;
}
...
int F_27 ( struct V_16 * V_17 , int V_31 ,
char * V_49 )
{
struct V_3 * V_4 ;
V_4 = F_28 ( V_17 , V_31 ) ;
...
int F_32 ( struct V_16 * V_17 , int V_31 )
{
struct V_3 * V_4 ;
V_4 = F_28 ( V_17 , V_31 ) ;
F_33 ( V_4 -> V_6 ) ;
