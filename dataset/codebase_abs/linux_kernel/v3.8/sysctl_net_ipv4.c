...
int F_35 ( T_1 * V_28 , int V_5 , void T_2 * V_6 ,
T_3 * V_7 , T_4 * V_8 )
{
...
F_42 ( V_36 ) ;
V_36 -> V_42 . V_63 = F_43 ( V_36 , L_4 , V_4 ) ;
if ( V_36 -> V_42 . V_63 == NULL )
goto V_64;
return 0 ;
V_64:
if ( ! F_40 ( V_36 , & V_53 ) )
...
struct V_66 * V_67 ;
struct T_1 * V_68 ;
for ( V_68 = V_69 ; V_68 -> V_62 ; V_68 ++ ) {
if ( strcmp ( V_68 -> V_62 , L_5 ) == 0 ) {
V_68 -> V_11 = V_70 ;
break;
}
}
