...
V_480 [ V_374 ] . V_183 = V_496 ;
V_481 -> V_497 = & V_498 ;
V_479 = F_117 ( V_481 , V_499 , V_480 , 0 ) ;
if ( V_479 < 0 )
return V_479 ;
F_100 ( V_411 , NULL ) ;
V_2 -> V_391 . type = V_401 ;
V_2 -> V_391 . V_497 = & V_500 ;
V_2 -> V_391 . V_6 = F_2 ( V_2 ) ;
V_2 -> V_391 . V_501 = F_118 ( 4096 * 4096 ) * 2 * 3 ;
V_2 -> V_391 . V_502 = 64 ;
V_2 -> V_385 . type = V_402 ;
V_2 -> V_385 . V_497 = & V_500 ;
V_2 -> V_385 . V_6 = F_2 ( V_2 ) ;
V_2 -> V_385 . V_501 = F_118 ( 4096 * 4096 ) * 2 * 3 ;
V_2 -> V_385 . V_502 = 32 ;
