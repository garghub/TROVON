...
static int F_18 ( struct V_18 * V_45 , void * V_47 )
{
return F_19 ( V_45 ) ;
}
...
static inline bool F_29 ( T_1 * V_1 ,
...
static bool F_31 ( T_1 * V_1 , unsigned char V_2 )
{
int V_69 = 0 ;
while ( F_32 ( V_1 , ( unsigned char ) ( V_2 + V_70 ) ) & V_71 ) {
F_33 ( 1 ) ;
if ( V_69 ++ == 1000 )
return false ;
}
...
static void F_34 ( T_1 * V_1 , unsigned char V_2 , unsigned char V_72 )
{
F_31 ( V_1 , V_2 ) ;
F_35 ( V_1 , ( unsigned char ) ( V_2 + V_73 ) , V_72 ) ;
}
static void F_36 ( struct V_9 * V_10 )
{
T_1 * V_1 = ( T_1 * ) V_10 -> V_74 ;
unsigned long V_12 ;
if ( F_29 ( V_1 , V_10 -> V_65 , L_8 ) )
return;
if ( V_21 >= V_22 )
F_9 ( L_9 , V_1 -> V_75 ) ;
F_37 ( & V_1 -> V_37 , V_12 ) ;
...
static void F_46 ( T_1 * V_1 , struct V_9 * V_10 )
{
if ( V_21 >= V_87 )
F_9 ( L_16 , V_1 -> V_75 ) ;
if ( V_10 )
...
static void F_50 ( T_1 * V_1 , int V_92 )
{
...
if ( V_92 ) {
if ( ! ( V_93 = ( unsigned char ) ( F_32 ( V_1 , V_4 + V_107 ) & 0x1f ) ) )
V_93 = 32 ;
} else
V_93 = 32 ;
do {
if ( V_93 == 1 ) {
V_94 = 1 ;
V_11 [ 0 ] = F_32 ( V_1 , V_4 + V_108 ) ;
} else {
V_94 = 2 ;
* ( ( unsigned short * ) V_11 ) = F_51 ( V_1 , V_4 + V_108 ) ;
}
V_93 -= V_94 ;
if ( ! V_93 && V_92 )
...
static void F_52 ( T_1 * V_1 , int V_111 , struct V_9 * V_10 )
{
...
if ( V_111 ) {
V_93 = ( unsigned char ) ( F_32 ( V_1 , V_4 + V_107 ) & 0x1f ) ;
if ( ! V_93 && ( F_32 ( V_1 , V_4 + V_70 ) & V_114 ) )
V_93 = 32 ;
} else
V_93 = 32 ;
F_53 ( V_10 , V_93 ) ;
while ( V_93 ) {
V_11 = F_32 ( V_1 , V_4 + V_108 ) ;
V_109 = F_32 ( V_1 , V_4 + V_108 ) ;
V_93 -= 2 ;
V_105 -> V_115 ++ ;
V_112 = V_116 ;
...
static void F_56 ( T_1 * V_1 , struct V_9 * V_10 )
{
if ( ! V_1 -> V_127 )
return;
V_1 -> V_127 = false ;
...
static void F_61 ( T_1 * V_1 , struct V_9 * V_10 )
{
...
V_142 = F_62 ( 2 , F_63 ( int , V_93 , F_62 ( V_1 -> V_131 , V_144 - V_1 -> V_133 ) ) ) ;
if ( V_142 == 1 ) {
F_35 ( V_1 , V_4 + V_145 , * ( V_1 -> V_146 + V_1 -> V_133 ) ) ;
} else {
F_2 ( V_1 , V_4 + V_145 ,
...
F_34 ( V_1 , V_4 , V_148 + V_149 ) ;
}
}
static void F_64 ( T_1 * V_1 , struct V_9 * V_10 )
{
F_58 ( V_1 ) ;
if ( ( V_1 -> V_91 ) ++ >= V_150 )
F_1 ( V_1 , V_8 , V_151 ) ;
...
static void F_67 ( T_1 * V_1 , struct V_9 * V_10 )
{
F_58 ( V_1 ) ;
if ( ( V_1 -> V_90 ) ++ >= V_150 )
F_1 ( V_1 , V_8 , V_157 ) ;
...
V_10 = F_44 ( & V_1 -> V_27 ) ;
F_74 ( & V_1 -> V_37 ) ;
while ( ( V_178 = F_32 ( V_1 , V_4 + V_182 ) ) ) {
if ( V_21 >= V_99 )
...
if ( V_1 -> V_39 . V_129 == V_143 )
F_50 ( V_1 , V_177 & V_195 ) ;
else
F_52 ( V_1 , V_177 & V_195 , V_10 ) ;
}
if ( V_177 & V_197 ) {
if ( V_1 -> V_128 )
V_1 -> V_105 . V_198 ++ ;
...
static int F_78 ( T_1 * V_1 , struct V_9 * V_10 )
{
int V_204 = 0 ;
if ( V_21 >= V_22 )
...
return 0 ;
if ( ! V_1 -> V_146 ) {
V_1 -> V_146 = ( unsigned char * ) F_79 ( V_23 ) ;
if ( ! V_1 -> V_146 ) {
F_9 ( V_206 L_34 ,
__FILE__ , __LINE__ , V_1 -> V_75 ) ;
return - V_24 ;
...
F_80 ( & V_1 -> V_134 , V_207 , ( unsigned long ) V_1 ) ;
V_204 = F_81 ( V_1 ) ;
if ( ! V_204 )
V_204 = F_82 ( V_1 ) ;
if ( V_204 ) {
if ( F_83 ( V_208 ) && V_10 )
F_84 ( V_209 , & V_10 -> V_12 ) ;
F_85 ( V_1 ) ;
return V_204 ;
}
F_86 ( V_1 , V_10 ) ;
...
static void F_88 ( T_1 * V_1 , struct V_9 * V_10 )
{
unsigned long V_12 ;
if ( ! ( V_1 -> V_27 . V_12 & V_205 ) )
return;
...
static void F_93 ( T_1 * V_1 , struct V_9 * V_10 )
{
unsigned long V_12 ;
F_37 ( & V_1 -> V_37 , V_12 ) ;
F_91 ( V_1 ) ;
...
F_96 ( V_1 , ( unsigned char ) V_165 | V_170 ) ;
F_58 ( V_1 ) ;
...
static int F_102 ( struct V_9 * V_10 , unsigned char V_237 )
{
T_1 * V_1 = ( T_1 * ) V_10 -> V_74 ;
unsigned long V_12 ;
if ( V_21 >= V_22 ) {
...
static void F_108 ( struct V_9 * V_10 , char V_237 )
{
T_1 * V_1 = ( T_1 * ) V_10 -> V_74 ;
unsigned long V_12 ;
if ( V_21 >= V_22 )
...
F_9 ( L_54 ,
__FILE__ , __LINE__ , V_1 -> V_75 ) ;
if ( F_29 ( V_1 , V_10 -> V_65 , L_55 ) )
return;
if ( F_110 ( V_10 ) )
F_108 ( V_10 , F_111 ( V_10 ) ) ;
...
F_9 ( L_56 ,
__FILE__ , __LINE__ , V_1 -> V_75 ) ;
if ( F_29 ( V_1 , V_10 -> V_65 , L_57 ) )
return;
if ( F_110 ( V_10 ) ) {
if ( V_1 -> V_242 )
V_1 -> V_242 = 0 ;
else
F_108 ( V_10 , F_113 ( V_10 ) ) ;
}
if ( V_10 -> V_210 . V_211 & V_234 ) {
F_37 ( & V_1 -> V_37 , V_12 ) ;
V_1 -> V_136 |= V_137 ;
...
static int F_114 ( T_1 * V_1 , struct V_113 T_5 * V_243 )
{
int V_244 ;
if ( V_21 >= V_22 )
F_9 ( L_58 , V_1 -> V_75 ) ;
...
F_115 ( V_244 , V_243 , & V_1 -> V_105 , sizeof( struct V_113 ) ) ;
if ( V_244 )
return - V_245 ;
}
return 0 ;
}
static int F_116 ( T_1 * V_1 , V_41 T_5 * V_246 )
{
int V_244 ;
if ( V_21 >= V_22 )
F_9 ( L_58 , V_1 -> V_75 ) ;
F_115 ( V_244 , V_246 , & V_1 -> V_39 , sizeof( V_41 ) ) ;
if ( V_244 )
return - V_245 ;
return 0 ;
}
static int F_117 ( T_1 * V_1 , V_41 T_5 * V_247 , struct V_9 * V_10 )
{
unsigned long V_12 ;
V_41 V_248 ;
int V_244 ;
...
V_1 -> V_75 ) ;
F_118 ( V_244 , & V_248 , V_247 , sizeof( V_41 ) ) ;
if ( V_244 ) {
if ( V_21 >= V_22 )
F_9 ( L_60 ,
__FILE__ , __LINE__ , V_1 -> V_75 ) ;
...
static int F_119 ( T_1 * V_1 , int T_5 * V_42 )
{
int V_244 ;
if ( V_21 >= V_22 )
F_9 ( L_61 , V_1 -> V_75 , V_1 -> V_42 ) ;
F_115 ( V_244 , V_42 , & V_1 -> V_42 , sizeof( int ) ) ;
if ( V_244 )
return - V_245 ;
return 0 ;
}
static int F_120 ( T_1 * V_1 , int V_42 )
{
unsigned long V_12 ;
if ( V_21 >= V_22 )
...
static int F_122 ( T_1 * V_1 , int T_5 * V_249 )
{
int V_244 ;
if ( V_21 >= V_22 )
F_9 ( L_63 , V_1 -> V_75 , V_1 -> V_249 ) ;
F_115 ( V_244 , V_249 , & V_1 -> V_249 , sizeof( int ) ) ;
if ( V_244 )
return - V_245 ;
return 0 ;
}
static int F_123 ( T_1 * V_1 , int V_249 )
{
unsigned long V_12 ;
unsigned char V_250 ;
if ( V_21 >= V_22 )
...
F_35 ( V_1 , V_251 , V_250 ) ;
F_39 ( & V_1 -> V_37 , V_12 ) ;
return 0 ;
}
static int F_124 ( T_1 * V_1 , int V_258 , struct V_9 * V_10 )
{
unsigned long V_12 ;
if ( V_21 >= V_22 )
...
static int F_126 ( T_1 * V_1 , int V_258 )
{
unsigned long V_12 ;
if ( V_21 >= V_22 )
...
static int F_127 ( T_1 * V_1 , int T_5 * V_259 )
{
unsigned long V_12 ;
int V_260 ;
int V_77 = 0 ;
...
F_128 ( V_267 , V_268 ) ;
F_118 ( V_77 , & V_3 , V_259 , sizeof( int ) ) ;
if ( V_77 )
return - V_245 ;
if ( V_21 >= V_22 )
...
exit:
if ( V_77 == 0 )
F_135 ( V_77 , V_263 , V_259 ) ;
return V_77 ;
}
static int F_136 ( T_1 * V_1 , int V_63 )
{
unsigned long V_12 ;
int V_77 ;
struct V_113 V_261 , V_262 ;
...
static int F_139 ( struct V_9 * V_10 , int V_293 )
{
T_1 * V_1 = ( T_1 * ) V_10 -> V_74 ;
unsigned long V_12 ;
if ( V_21 >= V_22 )
...
if ( F_29 ( V_1 , V_10 -> V_65 , L_72 ) )
return - V_294 ;
F_37 ( & V_1 -> V_37 , V_12 ) ;
if ( V_293 == - 1 )
F_140 ( V_1 , V_4 + V_295 , V_118 ) ;
else
F_141 ( V_1 , V_4 + V_295 , V_118 ) ;
F_39 ( & V_1 -> V_37 , V_12 ) ;
return 0 ;
}
...
switch ( V_72 ) {
case V_302 :
return F_116 ( V_1 , V_298 ) ;
case V_303 :
return F_117 ( V_1 , V_298 , V_10 ) ;
case V_304 :
return F_119 ( V_1 , V_298 ) ;
case V_305 :
return F_120 ( V_1 , ( int ) V_63 ) ;
case V_306 :
return F_122 ( V_1 , V_298 ) ;
case V_307 :
return F_123 ( V_1 , ( int ) V_63 ) ;
case V_308 :
return F_124 ( V_1 , ( int ) V_63 , V_10 ) ;
case V_309 :
return F_126 ( V_1 , ( int ) V_63 ) ;
case V_310 :
return F_125 ( V_1 ) ;
case V_311 :
return F_114 ( V_1 , V_298 ) ;
case V_312 :
return F_127 ( V_1 , V_298 ) ;
case V_301 :
return F_136 ( V_1 , ( int ) V_63 ) ;
default:
return - V_313 ;
}
return 0 ;
}
static void F_144 ( struct V_9 * V_10 , struct V_314 * V_315 )
{
T_1 * V_1 = ( T_1 * ) V_10 -> V_74 ;
unsigned long V_12 ;
if ( V_21 >= V_22 )
...
static void F_147 ( struct V_9 * V_10 , struct V_319 * V_320 )
{
T_1 * V_1 = ( T_1 * ) V_10 -> V_74 ;
struct V_321 * V_27 = & V_1 -> V_27 ;
if ( F_29 ( V_1 , V_10 -> V_65 , L_76 ) )
return;
if ( V_21 >= V_22 )
F_9 ( L_77 ,
__FILE__ , __LINE__ , V_1 -> V_75 , V_27 -> V_13 ) ;
F_148 ( ! V_27 -> V_13 ) ;
if ( F_149 ( V_27 , V_10 , V_320 ) == 0 )
goto V_238;
if ( V_27 -> V_12 & V_205 )
F_150 ( V_10 , V_1 -> V_233 ) ;
F_107 ( V_10 ) ;
F_151 ( V_10 ) ;
F_88 ( V_1 , V_10 ) ;
F_152 ( V_27 , V_10 ) ;
...
static void F_150 ( struct V_9 * V_10 , int V_233 )
{
T_1 * V_1 = ( T_1 * ) V_10 -> V_74 ;
...
V_323 = 1 ;
if ( V_233 )
V_323 = F_63 (unsigned long, char_time, timeout) ;
if ( V_1 -> V_39 . V_129 == V_143 ) {
while ( V_1 -> V_127 ) {
F_154 ( F_155 ( V_323 ) ) ;
if ( F_132 ( V_268 ) )
break;
if ( V_233 && F_156 ( V_324 , V_322 + V_233 ) )
break;
}
} else {
...
F_9 ( L_82 ,
__FILE__ , __LINE__ , V_1 -> V_75 ) ;
if ( F_29 ( V_1 , V_10 -> V_65 , L_83 ) )
return;
F_107 ( V_10 ) ;
F_88 ( V_1 , V_10 ) ;
F_158 ( & V_1 -> V_27 ) ;
}
static int F_159 ( struct V_321 * V_27 )
{
T_1 * V_1 = F_43 ( V_27 , T_1 , V_27 ) ;
unsigned long V_12 ;
F_37 ( & V_1 -> V_37 , V_12 ) ;
F_58 ( V_1 ) ;
F_39 ( & V_1 -> V_37 , V_12 ) ;
...
static void F_160 ( struct V_321 * V_27 , int V_325 )
{
T_1 * V_1 = F_43 ( V_27 , T_1 , V_27 ) ;
unsigned long V_12 ;
F_37 ( & V_1 -> V_37 , V_12 ) ;
...
static int F_161 ( struct V_9 * V_10 , struct V_319 * V_320 )
{
T_1 * V_1 ;
struct V_321 * V_27 ;
int V_204 , line ;
...
if ( F_162 ( V_320 ) || V_27 -> V_12 & V_330 ) {
if ( V_27 -> V_12 & V_330 )
F_163 ( & V_27 -> V_331 ) ;
...
V_204 = F_164 ( & V_1 -> V_27 , V_10 , V_320 ) ;
if ( V_204 ) {
if ( V_21 >= V_22 )
F_9 ( L_87 ,
...
static inline void F_165 ( struct V_337 * V_338 , T_1 * V_1 )
{
char V_339 [ 30 ] ;
unsigned long V_12 ;
F_166 ( V_338 , L_89 ,
...
if ( V_1 -> V_105 . V_199 )
F_166 ( V_338 , L_97 , V_1 -> V_105 . V_199 ) ;
if ( V_1 -> V_105 . V_198 )
F_166 ( V_338 , L_98 , V_1 -> V_105 . V_198 ) ;
if ( V_1 -> V_105 . V_341 )
F_166 ( V_338 , L_99 , V_1 -> V_105 . V_341 ) ;
if ( V_1 -> V_105 . V_342 )
F_166 ( V_338 , L_100 , V_1 -> V_105 . V_342 ) ;
if ( V_1 -> V_105 . V_343 )
F_166 ( V_338 , L_101 , V_1 -> V_105 . V_343 ) ;
if ( V_1 -> V_105 . V_344 )
F_166 ( V_338 , L_102 , V_1 -> V_105 . V_344 ) ;
} else {
F_166 ( V_338 , L_103 ,
V_1 -> V_105 . V_297 , V_1 -> V_105 . V_115 ) ;
if ( V_1 -> V_105 . V_120 )
F_166 ( V_338 , L_104 , V_1 -> V_105 . V_120 ) ;
if ( V_1 -> V_105 . V_119 )
F_166 ( V_338 , L_105 , V_1 -> V_105 . V_119 ) ;
if ( V_1 -> V_105 . V_125 )
F_166 ( V_338 , L_106 , V_1 -> V_105 . V_125 ) ;
if ( V_1 -> V_105 . V_126 )
F_166 ( V_338 , L_107 , V_1 -> V_105 . V_126 ) ;
}
F_166 ( V_338 , L_108 , V_339 + 1 ) ;
F_166 ( V_338 , L_109 ,
V_1 -> V_127 , V_1 -> V_83 , V_1 -> V_82 ,
V_1 -> V_78 ) ;
}
static int F_167 ( struct V_337 * V_338 , void * V_345 )
{
T_1 * V_1 ;
F_166 ( V_338 , L_110 , V_346 ) ;
V_1 = V_328 ;
while( V_1 ) {
F_165 ( V_338 , V_1 ) ;
V_1 = V_1 -> V_329 ;
...
static int F_168 ( struct V_347 * V_347 , struct V_319 * V_319 )
{
return F_169 ( V_319 , F_167 , NULL ) ;
}
static int F_170 ( T_1 * V_1 )
{
...
F_175 ( V_1 ) ;
#endif
F_176 ( & V_1 -> V_27 , V_352 , V_1 -> line ,
& V_1 -> V_45 -> V_353 ) ;
}
static void F_26 ( T_1 * V_354 )
{
T_1 * V_1 = V_328 ;
T_1 * V_355 = NULL ;
while( V_1 ) {
...
static void F_191 ( T_1 * V_1 , unsigned char V_2 , unsigned int V_374 )
{
...
V_376 >>= 1 ;
V_376 -- ;
F_35 ( V_1 , ( unsigned char ) ( V_2 + V_377 ) ,
( unsigned char ) ( ( V_375 << 6 ) + V_376 ) ) ;
V_250 = F_32 ( V_1 , ( unsigned char ) ( V_2 + V_378 ) ) & 0x3f ;
V_250 |= ( ( V_375 << 4 ) & 0xc0 ) ;
F_35 ( V_1 , ( unsigned char ) ( V_2 + V_378 ) , V_250 ) ;
}
}
...
V_250 |= V_71 ;
F_35 ( V_1 , V_8 + V_380 , V_250 ) ;
F_35 ( V_1 , V_8 + V_381 , 0xc0 ) ;
F_35 ( V_1 , V_8 + V_382 , 0x17 ) ;
if ( V_1 -> V_39 . V_129 == V_143 && V_1 -> V_39 . V_379 )
F_35 ( V_1 , V_8 + V_378 , 0x38 ) ;
else
F_35 ( V_1 , V_8 + V_378 , 0x30 ) ;
F_35 ( V_1 , V_8 + V_383 , 0x50 ) ;
if ( V_1 -> V_39 . V_129 == V_143 && V_1 -> V_39 . V_379 )
F_191 ( V_1 , V_8 , V_1 -> V_39 . V_379 ) ;
else
...
{
unsigned char V_250 ;
V_250 = F_32 ( V_1 , V_4 + V_382 ) | ( V_71 + V_183 + V_184 ) ;
F_35 ( V_1 , V_4 + V_382 , V_250 ) ;
V_250 = F_32 ( V_1 , V_4 + V_378 ) | ( V_384 + V_114 ) ;
F_35 ( V_1 , V_4 + V_378 , V_250 ) ;
if ( V_1 -> V_39 . V_379 )
F_191 ( V_1 , V_4 , V_1 -> V_39 . V_379 ) ;
else
F_191 ( V_1 , V_4 , 1843200 ) ;
V_250 = F_32 ( V_1 , V_4 + V_380 ) | V_184 ;
F_35 ( V_1 , V_4 + V_380 , V_250 ) ;
}
...
F_35 ( V_1 , V_4 + V_412 , V_250 ) ;
V_250 = 0x50 ;
F_35 ( V_1 , V_4 + V_383 , V_250 ) ;
if ( V_1 -> V_39 . V_12 & V_387 )
F_191 ( V_1 , V_4 , V_1 -> V_39 . V_379 * 16 ) ;
else
F_191 ( V_1 , V_4 , V_1 -> V_39 . V_379 ) ;
F_35 ( V_1 , V_4 + V_413 , 0 ) ;
V_250 = 0x00 ;
if ( V_1 -> V_39 . V_12 & V_414 )
V_250 |= V_114 ;
F_35 ( V_1 , V_4 + V_415 , V_250 ) ;
F_192 ( V_1 ) ;
...
F_141 ( V_1 , V_4 + V_251 , V_186 ) ;
F_3 ( V_1 , V_4 ,
V_195 + V_196 + V_200 +
V_197 + V_202 ) ;
F_34 ( V_1 , V_4 , V_418 + V_103 ) ;
F_31 ( V_1 , V_4 ) ;
F_51 ( V_1 , V_4 + V_185 ) ;
if ( ! V_1 -> V_416 )
F_141 ( V_1 , V_4 + V_381 , V_118 ) ;
F_121 ( V_1 ) ;
F_38 ( V_1 ) ;
F_91 ( V_1 ) ;
}
...
static void F_41 ( T_1 * V_1 , struct V_9 * V_10 )
{
if ( V_21 >= V_99 )
F_9 ( L_121 ,
__FILE__ , __LINE__ , V_1 -> V_75 ) ;
...
{
F_35 ( V_1 , V_4 + V_381 , 0x80 ) ;
F_35 ( V_1 , V_8 + V_381 , 0x80 ) ;
F_35 ( V_1 , V_4 + V_380 , 0 ) ;
F_35 ( V_1 , V_8 + V_380 , 0 ) ;
F_1 ( V_1 , V_4 , 0xffff ) ;
F_1 ( V_1 , V_8 , 0xffff ) ;
F_72 ( V_1 , 0xff ) ;
F_35 ( V_1 , V_420 , 0x06 ) ;
...
V_250 |= V_118 ;
F_35 ( V_1 , V_4 + V_380 , V_250 ) ;
F_35 ( V_1 , V_4 + V_381 , 0x83 ) ;
F_35 ( V_1 , V_4 + V_382 , 0x1f ) ;
F_35 ( V_1 , V_4 + V_378 , 0x10 ) ;
F_35 ( V_1 , V_4 + V_407 , 0 ) ;
F_35 ( V_1 , V_4 + V_383 , 0x50 ) ;
F_191 ( V_1 , V_4 , V_1 -> V_39 . V_232 * 16 ) ;
V_250 = 0x00 ;
if ( V_1 -> V_39 . V_220 != 8 )
V_250 |= V_184 ;
if ( V_1 -> V_39 . V_225 != 1 )
...
F_35 ( V_1 , V_4 + V_295 , V_250 ) ;
F_35 ( V_1 , V_4 + V_422 , 0x5c ) ;
F_35 ( V_1 , V_4 + V_413 , 0 ) ;
V_250 = 0x00 ;
if ( V_1 -> V_39 . V_12 & V_414 )
V_250 |= V_114 ;
...
F_141 ( V_1 , V_4 + V_382 , V_186 ) ;
}
static void F_58 ( T_1 * V_1 )
{
unsigned char V_109 = 0 ;
V_1 -> V_136 &= V_213 + V_137 ;
if ( F_32 ( V_1 , V_8 + V_423 ) & V_117 )
V_1 -> V_136 |= V_159 ;
if ( F_32 ( V_1 , V_8 + V_70 ) & V_183 )
V_1 -> V_136 |= V_153 ;
V_109 = F_32 ( V_1 , V_4 + V_251 ) ;
if ( ! ( V_109 & V_170 ) )
V_1 -> V_136 |= V_172 ;
if ( ! ( V_109 & V_165 ) )
V_1 -> V_136 |= V_167 ;
...
static bool F_45 ( T_1 * V_1 , struct V_9 * V_10 )
{
...
static unsigned int V_13 = F_199 ( V_437 ) ;
unsigned int V_69 ;
bool V_77 = true ;
unsigned long V_12 ;
F_37 ( & V_1 -> V_37 , V_12 ) ;
...
F_35 ( V_1 , V_438 , V_437 [ V_69 ] ) ;
F_35 ( V_1 , V_439 , V_437 [ ( V_69 + 1 ) % V_13 ] ) ;
if ( ( F_32 ( V_1 , V_438 ) != V_437 [ V_69 ] ) ||
( F_32 ( V_1 , V_439 ) != V_437 [ ( V_69 + 1 ) % V_13 ] ) ) {
V_77 = false ;
break;
}
}
...
static void F_196 ( T_1 * V_1 , const char * V_11 , int V_13 , int V_446 )
{
int V_69 ;
int V_447 ;
if ( V_446 )
...
#endif
{
struct V_9 * V_10 = F_44 ( & V_1 -> V_27 ) ;
F_46 ( V_1 , V_10 ) ;
F_48 ( V_10 ) ;
}
}
static int F_201 ( struct V_450 * V_353 , unsigned short V_392 ,
...
static T_8 F_203 ( struct V_464 * V_465 ,
struct V_450 * V_353 )
{
T_1 * V_1 = F_202 ( V_353 ) ;
unsigned long V_12 ;
...
F_204 ( V_353 ) ;
F_205 ( V_465 , V_1 -> V_146 , V_465 -> V_466 ) ;
V_1 -> V_133 = 0 ;
...
static int F_207 ( struct V_450 * V_353 )
{
T_1 * V_1 = F_202 ( V_353 ) ;
struct V_9 * V_10 ;
int V_77 ;
...
static int F_210 ( struct V_450 * V_353 )
{
T_1 * V_1 = F_202 ( V_353 ) ;
struct V_9 * V_10 = F_44 ( & V_1 -> V_27 ) ;
unsigned long V_12 ;
...
static int F_212 ( struct V_450 * V_353 , struct V_472 * V_473 , int V_72 )
{
...
if ( F_214 ( line , & V_476 , V_474 ) )
return - V_245 ;
return 0 ;
case V_482 :
if( ! F_83 ( V_495 ) )
return - V_496 ;
if ( F_215 ( & V_476 , line , V_474 ) )
return - V_245 ;
switch ( V_476 . V_488 )
{
...
static void F_216 ( struct V_450 * V_353 )
{
T_1 * V_1 = F_202 ( V_353 ) ;
unsigned long V_12 ;
if ( V_21 >= V_22 )
...
static void F_197 ( T_1 * V_1 , char * V_95 , int V_474 )
{
struct V_464 * V_465 = F_219 ( V_474 ) ;
...
memcpy ( F_220 ( V_465 , V_474 ) , V_95 , V_474 ) ;
V_465 -> V_501 = F_221 ( V_465 , V_353 ) ;
V_353 -> V_430 . V_502 ++ ;
