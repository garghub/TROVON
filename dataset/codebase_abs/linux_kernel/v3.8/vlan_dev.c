...
F_73 ( V_39 -> V_46 ) ;
V_39 -> V_46 = NULL ;
for ( V_158 = 0 ; V_158 < F_74 ( V_39 -> V_17 ) ; V_158 ++ ) {
...
static struct V_170 * F_80 ( struct V_3 * V_4 , struct V_170 * V_47 )
{
if ( F_8 ( V_4 ) -> V_46 ) {
struct V_46 * V_80 ;
T_3 V_171 = 0 , V_51 = 0 ;
...
unsigned int V_177 ;
V_80 = F_82 ( F_8 ( V_4 ) -> V_46 , V_158 ) ;
do {
V_177 = F_83 ( & V_80 -> V_48 ) ;
V_172 = V_80 -> V_178 ;
V_173 = V_80 -> V_179 ;
V_174 = V_80 -> V_180 ;
V_175 = V_80 -> V_49 ;
V_176 = V_80 -> V_50 ;
} while ( F_84 ( & V_80 -> V_48 , V_177 ) );
V_47 -> V_178 += V_172 ;
V_47 -> V_179 += V_173 ;
V_47 -> V_181 += V_174 ;
V_47 -> V_49 += V_175 ;
...
static int F_86 ( struct V_3 * V_4 , struct V_182 * V_183 ,
T_6 V_184 )
{
struct F_8 * V_39 = F_8 ( V_4 ) ;
struct V_3 * V_38 = V_39 -> V_38 ;
struct V_40 * V_40 ;
int V_71 = 0 ;
V_40 = F_87 ( sizeof( * V_40 ) , V_184 ) ;
V_71 = - V_156 ;
if ( ! V_40 )
goto V_74;
V_71 = F_88 ( V_40 , V_38 , V_184 ) ;
if ( V_71 ) {
F_75 ( V_40 ) ;
goto V_74;
}
