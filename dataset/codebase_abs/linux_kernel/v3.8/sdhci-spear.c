...
static struct V_21 * F_8 ( struct V_3 * V_4 )
{
...
V_6 -> V_1 = F_26 ( V_4 , 0 ) ;
V_6 -> V_46 = V_47 ;
V_6 -> V_48 = F_27 ( & V_4 -> V_9 , V_31 -> V_35 ,
F_18 ( V_31 ) ) ;
if ( ! V_6 -> V_48 ) {
V_32 = - V_28 ;
F_16 ( & V_4 -> V_9 , L_13 ) ;
...
if ( V_8 -> V_12 -> V_13 >= 0 ) {
V_32 = F_30 ( & V_4 -> V_9 , V_8 -> V_12 -> V_13 ,
L_12 ) ;
if ( V_32 < 0 ) {
F_16 ( & V_4 -> V_9 , L_15 ,
V_8 -> V_12 -> V_13 ) ;
...
static int F_42 ( struct V_55 * V_9 )
{
struct V_5 * V_6 = F_43 ( V_9 ) ;
