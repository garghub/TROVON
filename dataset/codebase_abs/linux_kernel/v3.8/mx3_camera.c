...
struct V_199 V_200 ;
int V_54 ;
F_82 ( & V_197 -> V_201 , & V_197 -> V_55 , 0 , 2 , 4096 ) ;
F_82 ( & V_197 -> V_202 , & V_197 -> V_58 , 0 , 2 , 4096 ) ;
V_54 = F_65 ( V_149 , V_75 , V_203 , V_194 ) ;
if ( V_54 < 0 )
return V_54 ;
V_54 = F_65 ( V_149 , V_75 , V_204 , & V_200 ) ;
if ( V_54 < 0 )
return V_54 ;
if ( V_200 . V_175 != V_43 -> V_78 -> V_175 )
return - V_48 ;
if ( V_200 . V_55 & 7 ) {
F_79 ( & V_200 . V_55 ) ;
V_54 = F_65 ( V_149 , V_75 , V_205 , & V_200 ) ;
if ( V_54 < 0 )
return V_54 ;
}
if ( V_200 . V_55 != V_43 -> V_91 || V_200 . V_58 != V_43 -> V_89 )
F_73 ( V_17 , V_200 . V_55 , V_200 . V_58 ,
V_43 -> V_78 -> V_56 ) ;
F_10 ( V_43 -> V_46 , L_16 ,
V_200 . V_55 , V_200 . V_58 ) ;
V_43 -> V_91 = V_200 . V_55 ;
V_43 -> V_89 = V_200 . V_58 ;
return V_54 ;
}
...
V_200 . V_175 = V_50 -> V_175 ;
V_54 = F_65 ( V_149 , V_75 , V_205 , & V_200 ) ;
if ( V_54 < 0 )
return V_54 ;
if ( V_200 . V_175 != V_50 -> V_175 )
return - V_48 ;
if ( ! V_17 -> V_15 [ 0 ] ) {
V_54 = F_75 ( V_17 ) ;
if ( V_54 < 0 )
...
V_200 . V_208 = V_51 -> V_208 ;
V_200 . V_175 = V_50 -> V_175 ;
V_54 = F_65 ( V_149 , V_75 , V_210 , & V_200 ) ;
if ( V_54 < 0 )
return V_54 ;
V_51 -> V_55 = V_200 . V_55 ;
V_51 -> V_58 = V_200 . V_58 ;
...
static unsigned int F_86 ( struct V_215 * V_215 , T_7 * V_216 )
{
struct V_42 * V_43 = V_215 -> V_217 ;
return F_87 ( & V_43 -> V_218 , V_215 , V_216 ) ;
}
static int F_88 ( struct V_44 * V_45 ,
struct V_219 * V_220 )
{
F_89 ( V_220 -> V_221 , L_21 , sizeof( V_220 -> V_221 ) ) ;
...
V_151 . V_79 = V_154 ;
V_54 = F_65 ( V_149 , V_75 , V_227 , & V_151 ) ;
...
static int F_91 ( struct V_229 * V_230 )
{
struct V_1 * V_17 ;
struct V_231 * V_232 ;
void T_8 * V_4 ;
...
V_17 -> V_132 = F_94 ( & V_230 -> V_20 , NULL ) ;
if ( F_95 ( V_17 -> V_132 ) ) {
V_233 = F_96 ( V_17 -> V_132 ) ;
goto V_239;
}
V_17 -> V_160 = V_230 -> V_20 . V_163 ;
V_17 -> V_114 = V_17 -> V_160 -> V_79 ;
if ( ! ( V_17 -> V_114 & V_240 ) ) {
F_67 ( & V_230 -> V_20 , L_27
L_28 ) ;
V_17 -> V_114 |= V_118 ;
}
if ( V_17 -> V_114 & V_241 )
...
if ( V_17 -> V_114 & V_115 )
V_17 -> V_137 |= 1 << 14 ;
V_17 -> V_133 = V_17 -> V_160 -> V_242 * 10000 ;
if ( ! V_17 -> V_133 ) {
F_67 ( & V_230 -> V_20 ,
L_29
L_30 ) ;
...
F_45 ( & V_17 -> V_32 ) ;
F_97 ( & V_17 -> V_24 ) ;
V_4 = F_98 ( V_232 -> V_243 , F_99 ( V_232 ) ) ;
if ( ! V_4 ) {
F_100 ( L_31 , F_99 ( V_232 ) , V_232 -> V_243 ) ;
V_233 = - V_237 ;
goto V_244;
}
V_17 -> V_4 = V_4 ;
...
V_161 -> V_103 = & V_247 ;
V_161 -> V_47 = V_17 ;
V_161 -> V_162 . V_20 = & V_230 -> V_20 ;
V_161 -> V_248 = V_230 -> V_164 ;
V_17 -> V_60 = F_101 ( & V_230 -> V_20 ) ;
if ( F_95 ( V_17 -> V_60 ) ) {
V_233 = F_96 ( V_17 -> V_60 ) ;
goto V_249;
}
V_233 = F_102 ( V_161 ) ;
if ( V_233 )
...
static int F_108 ( struct V_229 * V_230 )
{
struct V_44 * V_161 = F_21 ( & V_230 -> V_20 ) ;
