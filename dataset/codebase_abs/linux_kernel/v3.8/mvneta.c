...
static T_1 F_117 ( struct V_1 * V_2 , T_1 V_232 ,
int * V_233 )
{
struct V_6 * V_7 ;
T_1 V_194 = 0 ;
...
static int F_121 ( unsigned char * V_132 )
{
int V_234 = 0 ;
int V_11 ;
...
static int F_124 ( struct V_1 * V_2 , unsigned char * V_241 ,
int V_67 )
{
unsigned char V_242 = 0 ;
if ( memcmp ( V_241 , L_10 , 5 ) == 0 ) {
F_122 ( V_2 , V_241 [ 5 ] , V_67 ) ;
return 0 ;
}
V_242 = F_121 ( V_241 ) ;
if ( V_67 == - 1 ) {
...
static T_5 F_130 ( int V_254 , void * V_255 )
{
...
static int F_132 ( struct V_257 * V_214 , int V_258 )
{
int V_44 = 0 ;
T_1 V_259 ;
unsigned long V_145 ;
...
static void F_137 ( unsigned long V_4 )
{
...
static int F_139 ( struct V_1 * V_2 , struct V_36 * V_37 ,
int V_188 )
{
struct V_16 * V_17 = V_2 -> V_17 ;
int V_11 ;
...
{
V_37 -> V_9 = V_2 -> V_262 ;
V_37 -> V_48 = F_144 ( V_2 -> V_17 -> V_17 . V_190 ,
V_37 -> V_9 * V_263 ,
& V_37 -> V_264 , V_265 ) ;
if ( V_37 -> V_48 == NULL ) {
F_75 ( V_2 -> V_17 ,
...
F_145 ( V_37 -> V_48 !=
F_146 ( V_37 -> V_48 , V_266 ) ) ;
V_37 -> V_58 = V_37 -> V_9 - 1 ;
F_1 ( V_2 , F_147 ( V_37 -> V_40 ) , V_37 -> V_264 ) ;
...
{
V_7 -> V_9 = V_2 -> V_268 ;
V_7 -> V_48 = F_144 ( V_2 -> V_17 -> V_17 . V_190 ,
V_7 -> V_9 * V_263 ,
& V_7 -> V_264 , V_265 ) ;
if ( V_7 -> V_48 == NULL ) {
F_75 ( V_2 -> V_17 ,
...
F_145 ( V_7 -> V_48 !=
F_146 ( V_7 -> V_48 , V_266 ) ) ;
V_7 -> V_58 = V_7 -> V_9 - 1 ;
F_1 ( V_2 , F_46 ( V_7 -> V_40 ) , 0x03ffffff ) ;
F_1 ( V_2 , F_45 ( V_7 -> V_40 ) , 0x3fffffff ) ;
F_1 ( V_2 , F_151 ( V_7 -> V_40 ) , V_7 -> V_264 ) ;
F_1 ( V_2 , F_61 ( V_7 -> V_40 ) , V_7 -> V_9 ) ;
V_7 -> V_189 = F_152 ( V_7 -> V_9 * sizeof( * V_7 -> V_189 ) , V_265 ) ;
if ( V_7 -> V_189 == NULL ) {
F_149 ( V_2 -> V_17 -> V_17 . V_190 ,
V_7 -> V_9 * V_263 ,
V_7 -> V_48 , V_7 -> V_264 ) ;
...
int V_67 ;
for ( V_67 = 0 ; V_67 < V_69 ; V_67 ++ )
F_153 ( V_2 , & V_2 -> V_70 [ V_67 ] ) ;
}
static void F_156 ( struct V_1 * V_2 )
{
int V_67 ;
for ( V_67 = 0 ; V_67 < V_72 ; V_67 ++ )
F_148 ( V_2 , & V_2 -> V_73 [ V_67 ] ) ;
}
static int F_157 ( struct V_1 * V_2 )
{
int V_67 ;
for ( V_67 = 0 ; V_67 < V_72 ; V_67 ++ ) {
int V_211 = F_143 ( V_2 , & V_2 -> V_73 [ V_67 ] ) ;
if ( V_211 ) {
F_75 ( V_2 -> V_17 , L_16 ,
V_261 , V_67 ) ;
F_156 ( V_2 ) ;
...
int V_67 ;
for ( V_67 = 0 ; V_67 < V_69 ; V_67 ++ ) {
int V_211 = F_150 ( V_2 , & V_2 -> V_70 [ V_67 ] ) ;
if ( V_211 ) {
F_75 ( V_2 -> V_17 , L_17 ,
V_261 , V_67 ) ;
F_155 ( V_2 ) ;
...
static int F_169 ( struct V_16 * V_17 , int V_122 )
{
if ( V_122 < 68 ) {
F_75 ( V_17 , L_19 ) ;
return - V_243 ;
...
if ( V_122 > 9676 ) {
F_125 ( V_17 , L_20 , V_122 ) ;
V_122 = 9676 ;
}
if ( ! F_170 ( F_171 ( V_122 ) , 8 ) ) {
F_125 ( V_17 , L_21 ,
V_122 , F_172 ( F_171 ( V_122 ) , 8 ) ) ;
V_122 = F_172 ( F_171 ( V_122 ) , 8 ) ;
}
return V_122 ;
}
static int F_173 ( struct V_16 * V_17 , int V_122 )
{
struct V_1 * V_2 = F_9 ( V_17 ) ;
int V_270 ;
V_122 = F_169 ( V_17 , V_122 ) ;
if ( V_122 < 0 )
return - V_243 ;
V_17 -> V_122 = V_122 ;
if ( ! F_113 ( V_17 ) )
...
F_155 ( V_2 ) ;
F_156 ( V_2 ) ;
V_2 -> V_196 = F_171 ( V_2 -> V_17 -> V_122 ) ;
V_270 = F_157 ( V_2 ) ;
if ( V_270 ) {
F_75 ( V_2 -> V_17 , L_22 ) ;
return V_270 ;
...
static int F_174 ( struct V_16 * V_17 , void * V_132 )
{
struct V_1 * V_2 = F_9 ( V_17 ) ;
T_2 * V_271 = V_132 + 2 ;
int V_11 ;
...
static void F_175 ( struct V_16 * V_273 )
{
...
{
struct V_274 * V_269 ;
V_269 = F_177 ( V_2 -> V_17 , V_2 -> V_287 , F_175 , 0 ,
V_2 -> V_288 ) ;
if ( ! V_269 ) {
F_75 ( V_2 -> V_17 , L_25 ) ;
return - V_289 ;
...
static int F_180 ( struct V_16 * V_17 )
{
struct V_1 * V_2 = F_9 ( V_17 ) ;
int V_270 ;
F_53 ( V_2 , V_17 -> V_252 , V_110 ) ;
...
if ( V_270 )
goto V_293;
V_270 = F_181 ( V_2 -> V_17 -> V_254 , F_130 , 0 ,
V_294 , V_2 ) ;
if ( V_270 ) {
...
int F_185 ( struct V_16 * V_17 , struct V_297 * V_298 )
{
struct V_1 * V_2 = F_9 ( V_17 ) ;
if ( ! V_2 -> V_269 )
return - V_289 ;
return F_186 ( V_2 -> V_269 , V_298 ) ;
}
int F_187 ( struct V_16 * V_17 , struct V_297 * V_298 )
{
struct V_1 * V_2 = F_9 ( V_17 ) ;
if ( ! V_2 -> V_269 )
return - V_289 ;
return F_188 ( V_2 -> V_269 , V_298 ) ;
}
static int F_189 ( struct V_16 * V_17 ,
struct V_299 * V_300 )
{
struct V_1 * V_2 = F_9 ( V_17 ) ;
int V_67 ;
...
struct V_304 * V_305 )
{
F_192 ( V_305 -> V_306 , V_294 ,
sizeof( V_305 -> V_306 ) ) ;
F_192 ( V_305 -> V_307 , V_308 ,
sizeof( V_305 -> V_307 ) ) ;
F_192 ( V_305 -> V_309 , F_193 ( & V_17 -> V_17 ) ,
sizeof( V_305 -> V_309 ) ) ;
}
static void F_194 ( struct V_16 * V_310 ,
struct V_311 * V_312 )
{
...
static int F_196 ( struct V_1 * V_2 , int V_319 )
{
int V_67 ;
F_39 ( V_2 ) ;
F_43 ( V_2 ) ;
V_2 -> V_70 = F_197 ( V_69 * sizeof( struct V_6 ) ,
V_265 ) ;
if ( ! V_2 -> V_70 )
return - V_197 ;
for ( V_67 = 0 ; V_67 < V_69 ; V_67 ++ ) {
...
V_2 -> V_73 = F_197 ( V_72 * sizeof( struct V_36 ) ,
V_265 ) ;
if ( ! V_2 -> V_73 ) {
F_154 ( V_2 -> V_70 ) ;
return - V_197 ;
...
F_1 ( V_2 , F_200 ( V_11 ) , ( V_328 -> V_5 & 0xffff0000 ) |
...
static void F_203 ( struct V_1 * V_2 , int V_332 )
{
T_1 V_42 ;
F_1 ( V_2 , V_333 , 0 ) ;
if ( V_332 == V_334 )
...
static int F_204 ( struct V_336 * V_337 )
{
...
int V_211 ;
if ( V_110 != 0 ) {
F_205 ( & V_337 -> V_17 , L_29 , V_110 ) ;
return - V_243 ;
}
V_17 = F_206 ( sizeof( struct V_1 ) , 8 ) ;
if ( ! V_17 )
return - V_197 ;
V_17 -> V_254 = F_207 ( V_340 , 0 ) ;
if ( V_17 -> V_254 == 0 ) {
V_211 = - V_243 ;
goto V_343;
}
V_287 = F_208 ( V_340 , L_30 , 0 ) ;
if ( ! V_287 ) {
F_205 ( & V_337 -> V_17 , L_31 ) ;
V_211 = - V_289 ;
goto V_296;
}
V_332 = F_209 ( V_340 ) ;
if ( V_332 < 0 ) {
F_205 ( & V_337 -> V_17 , L_32 ) ;
V_211 = - V_243 ;
goto V_296;
}
V_342 = F_210 ( V_340 ) ;
if ( ! V_342 || ! F_211 ( V_342 ) )
F_212 ( V_17 ) ;
else
...
F_213 ( V_17 , & V_349 ) ;
V_2 = F_9 ( V_17 ) ;
V_2 -> V_146 . V_350 = F_137 ;
F_214 ( & V_2 -> V_146 ) ;
F_138 ( V_144 , & V_2 -> V_145 ) ;
V_2 -> V_351 = V_352 ;
V_2 -> V_287 = V_287 ;
V_2 -> V_288 = V_332 ;
V_2 -> V_5 = F_215 ( V_340 , 0 ) ;
if ( V_2 -> V_5 == NULL ) {
V_211 = - V_197 ;
goto V_296;
}
V_2 -> V_140 = F_216 ( & V_337 -> V_17 , NULL ) ;
if ( F_217 ( V_2 -> V_140 ) ) {
V_211 = F_218 ( V_2 -> V_140 ) ;
goto V_353;
}
F_219 ( V_2 -> V_140 ) ;
...
V_2 -> V_262 = V_314 ;
V_2 -> V_17 = V_17 ;
F_220 ( V_17 , & V_337 -> V_17 ) ;
V_211 = F_196 ( V_2 , V_319 ) ;
if ( V_211 < 0 ) {
F_205 ( & V_337 -> V_17 , L_33 ) ;
goto V_354;
}
F_203 ( V_2 , V_332 ) ;
V_338 = F_221 () ;
if ( V_338 )
F_199 ( V_2 , V_338 ) ;
F_222 ( V_17 , & V_2 -> V_214 , F_132 , V_2 -> V_351 ) ;
V_211 = F_223 ( V_17 ) ;
if ( V_211 < 0 ) {
F_205 ( & V_337 -> V_17 , L_34 ) ;
goto V_355;
}
V_17 -> V_356 = V_357 | V_358 ;
V_17 -> V_359 = V_357 | V_358 ;
V_17 -> V_360 |= V_361 ;
F_125 ( V_17 , L_35 , V_17 -> V_252 ) ;
F_224 ( V_337 , V_2 -> V_17 ) ;
return 0 ;
V_355:
F_198 ( V_2 ) ;
V_354:
...
static int F_229 ( struct V_336 * V_337 )
{
struct V_16 * V_17 = F_230 ( V_337 ) ;
struct V_1 * V_2 = F_9 ( V_17 ) ;
F_231 ( V_17 ) ;
F_198 ( V_2 ) ;
F_225 ( V_2 -> V_140 ) ;
