...
static struct V_25 * F_33 ( struct V_64 * V_18 )
{
struct V_25 * V_26 ;
struct V_77 * V_78 = V_18 -> V_79 ;
if ( ! V_78 )
return NULL ;
V_26 = F_34 ( V_18 , sizeof( * V_26 ) , V_80 ) ;
if ( ! V_26 ) {
F_4 ( V_18 , L_8 ) ;
return NULL ;
}
if ( F_35 ( V_78 , L_9 , & V_26 -> V_37 ) ) {
F_4 ( V_18 , L_10 ) ;
return NULL ;
} ;
if ( F_35 ( V_78 , L_11 , & V_26 -> V_38 ) ) {
F_4 ( V_18 , L_12 ) ;
return NULL ;
} ;
F_35 ( V_78 , L_13 ,
...
F_35 ( V_78 , L_14 ,
& V_26 -> V_71 ) ;
if ( F_36 ( V_78 , L_15 , NULL ) )
V_26 -> V_39 = true ;
if ( F_36 ( V_78 , L_16 , NULL ) )
V_26 -> V_40 = true ;
return V_26 ;
}
static inline struct V_25 * F_33 ( struct V_64 * V_18 )
{
return NULL ;
}
...
V_2 = F_40 ( sizeof( struct V_1 ) , V_80 ) ;
V_27 = F_41 () ;
if ( ! V_2 || ! V_27 ) {
F_4 ( & V_7 -> V_18 , L_19 ) ;
error = - V_85 ;
...
V_27 -> V_87 = L_20 ;
V_27 -> V_28 . V_88 = V_89 ;
V_27 -> V_18 . V_90 = & V_7 -> V_18 ;
V_27 -> V_91 = F_30 ;
V_27 -> V_92 = F_32 ;
F_42 ( V_93 , V_27 -> V_94 ) ;
F_42 ( V_95 , V_27 -> V_94 ) ;
F_42 ( V_96 , V_27 -> V_97 ) ;
F_43 ( V_27 , V_98 , 0 , V_2 -> V_26 -> V_37 , 0 , 0 ) ;
F_43 ( V_27 , V_99 , 0 , V_2 -> V_26 -> V_38 , 0 , 0 ) ;
F_44 ( V_27 , V_31 , 0 ) ;
F_43 ( V_27 , V_45 ,
0 , V_100 , 0 , 0 ) ;
F_43 ( V_27 , V_46 ,
...
error = F_50 ( V_7 -> V_49 , NULL , F_14 ,
V_102 | V_103 , L_25 , V_2 ) ;
if ( error ) {
F_4 ( & V_7 -> V_18 , L_26 ) ;
goto V_104;
}
...
static int F_59 ( struct V_64 * V_18 )
{
struct V_6 * V_7 = F_60 ( V_18 ) ;
struct V_1 * V_2 = F_57 ( V_7 ) ;
struct V_27 * V_27 = V_2 -> V_27 ;
int V_28 ;
...
static int F_61 ( struct V_64 * V_18 )
{
struct V_6 * V_7 = F_60 ( V_18 ) ;
struct V_1 * V_2 = F_57 ( V_7 ) ;
struct V_27 * V_27 = V_2 -> V_27 ;
