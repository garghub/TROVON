...
if ( V_46 ) {
F_25 ( V_19 , L_1 ,
V_47 , V_20 << 4 , V_45 , type , V_13 , V_6 ) ;
}
F_26 ( V_42 ) ;
}
static int
F_27 ( struct V_1 * V_2 , struct V_1 * V_3 ,
struct V_4 * V_5 , void * V_6 , T_1 V_7 ,
struct V_1 * * V_8 )
{
struct V_18 * V_19 ;
int V_11 ;
V_11 = F_28 ( V_2 , V_3 , V_5 , & V_19 ) ;
* V_8 = F_3 ( V_19 ) ;
if ( V_11 )
return V_11 ;
F_29 ( V_19 ) -> V_48 = 0x00000002 ;
F_29 ( V_19 ) -> V_49 = F_18 ;
F_19 ( V_19 ) -> V_50 = & V_51 ;
F_19 ( V_19 ) -> V_52 = V_53 ;
F_19 ( V_19 ) -> V_54 = F_16 ;
...
int
F_30 ( struct V_1 * V_12 )
{
struct V_30 * V_3 = F_19 ( V_12 -> V_3 ) ;
struct V_18 * V_19 = ( void * ) V_3 ;
...
F_9 ( V_19 , 0x00b220 , F_32 ( V_19 ) ? 0x00000044 : 0x00000031 ) ;
...
if ( ! F_33 ( V_19 , 0x00b200 , 0x00000001 , 0x00000000 ) ) {
