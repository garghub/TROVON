...
T_2 V_66 ;
int V_67 ;
V_2 -> V_68 = V_2 -> V_69 -> V_70 ;
V_8 = F_21 ( sizeof( * V_8 ) , V_71 ) ;
if ( ! V_8 )
return - V_72 ;
V_2 -> V_9 = V_8 ;
V_67 = F_22 ( V_65 , V_2 -> V_68 ) ;
if ( V_67 )
return V_67 ;
V_66 = F_23 ( V_65 , 2 ) ;
V_2 -> V_66 = V_66 ;
V_8 -> V_20 = F_24 ( V_66 , V_73 ) ;
if ( ! V_8 -> V_20 )
return - V_72 ;
V_67 = F_25 ( V_2 , 5 ) ;
if ( V_67 )
...
static int F_32 ( struct V_64 * V_2 ,
const struct V_99 * V_100 )
{
return F_33 ( V_2 , & V_101 ) ;
}
static void F_34 ( struct V_64 * V_2 )
{
F_35 ( V_2 ) ;
}
