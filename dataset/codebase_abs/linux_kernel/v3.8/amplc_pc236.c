...
if ( V_55 )
return 2 ;
V_55 |= F_22 ( & V_54 -> V_66 , 0 ) ;
V_55 |= F_22 ( & V_54 -> V_67 , 0 ) ;
V_55 |= F_22 ( & V_54 -> V_68 , 0 ) ;
V_55 |= F_22 ( & V_54 -> V_69 , 1 ) ;
V_55 |= F_22 ( & V_54 -> V_70 , 0 ) ;
if ( V_55 )
return 3 ;
if ( V_55 )
return 4 ;
...
static int F_23 ( struct V_13 * V_14 , struct V_47 * V_48 )
{
F_16 ( V_14 ) ;
return 0 ;
}
...
static T_1 F_25 ( int V_71 , void * V_72 )
{
...
static void F_29 ( struct V_13 * V_14 , unsigned int V_71 )
{
const struct V_1 * V_17 = F_6 ( V_14 ) ;
struct V_8 * V_80 = F_30 ( V_14 ) ;
char V_81 [ 60 ] ;
int V_82 ;
if ( F_1 ( V_17 ) )
V_82 = F_31 ( V_81 , sizeof( V_81 ) ,
L_3 , V_14 -> V_83 ) ;
else if ( F_2 ( V_17 ) )
V_82 = F_31 ( V_81 , sizeof( V_81 ) ,
L_4 , F_32 ( V_80 ) ) ;
...
V_82 = 0 ;
if ( V_71 )
V_82 += F_31 ( & V_81 [ V_82 ] , sizeof( V_81 ) - V_82 ,
L_5 , V_71 ,
( V_14 -> V_71 ? L_6 : L_7 ) ) ;
else
V_82 += F_31 ( & V_81 [ V_82 ] , sizeof( V_81 ) - V_82 ,
...
static int F_34 ( struct V_13 * V_14 , unsigned long V_83 ,
...
V_35 -> V_41 = F_41 ( V_8 , 1 ) ;
V_83 = F_41 ( V_8 , 2 ) ;
return F_34 ( V_14 , V_83 , V_8 -> V_71 , V_102 ) ;
}
static int F_42 ( struct V_13 * V_14 , struct V_15 * V_16 )
{
const struct V_1 * V_17 = F_6 ( V_14 ) ;
struct V_34 * V_35 ;
int V_86 ;
F_33 ( V_14 -> V_29 , V_32 L_12 ) ;
V_35 = F_43 ( sizeof( * V_35 ) , V_103 ) ;
if ( ! V_35 )
return - V_104 ;
V_14 -> V_36 = V_35 ;
if ( F_1 ( V_17 ) ) {
...
V_86 = F_10 ( V_14 , V_83 , V_105 ) ;
if ( V_86 < 0 )
return V_86 ;
return F_34 ( V_14 , V_83 , V_71 , 0 ) ;
} else if ( F_2 ( V_17 ) ) {
struct V_8 * V_8 ;
V_8 = F_5 ( V_14 , V_16 ) ;
if ( ! V_8 )
return - V_33 ;
return F_38 ( V_14 , V_8 ) ;
} else {
F_9 ( V_14 -> V_29 , V_32
L_13 ) ;
return - V_106 ;
...
unsigned long V_107 )
{
struct V_8 * V_8 = F_30 ( V_14 ) ;
struct V_34 * V_35 ;
if ( ! V_6 )
return - V_106 ;
F_33 ( V_14 -> V_29 , V_32 L_14 ,
F_32 ( V_8 ) ) ;
V_35 = F_43 ( sizeof( * V_35 ) , V_103 ) ;
if ( ! V_35 )
return - V_104 ;
...
F_47 ( V_14 -> V_71 , V_14 ) ;
if ( V_14 -> V_73 )
F_48 ( V_14 , & V_14 -> V_73 [ 0 ] ) ;
if ( F_1 ( V_17 ) ) {
if ( V_14 -> V_83 )
F_49 ( V_14 -> V_83 , V_105 ) ;
} else if ( F_2 ( V_17 ) ) {
struct V_8 * V_80 = F_30 ( V_14 ) ;
if ( V_80 ) {
if ( V_14 -> V_83 )
...
static int F_52 ( struct V_8 * V_14 ,
const struct V_108 * V_109 )
{
return F_53 ( V_14 , & V_110 ) ;
}
