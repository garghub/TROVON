...
{
return F_45 ( V_8 , F_48 ( V_57 ) ) ;
}
void F_49 ( struct V_58 * V_59 , enum V_44 type ,
struct V_17 * V_17 )
{
struct V_60 * V_61 ;
V_61 = & V_59 -> V_62 [ type ] ;
V_61 -> V_17 = V_17 ;
F_42 ( & V_61 -> V_63 , & V_17 -> V_50 [ type ] ) ;
}
static void F_50 ( struct V_58 * V_59 , enum V_44 type ,
struct V_17 * V_64 )
{
struct V_60 * V_61 ;
struct V_17 * V_17 ;
...
void F_52 ( struct V_58 * V_59 , enum V_44 type )
{
F_50 ( V_59 , type , NULL ) ;
}
void F_53 ( struct V_58 * V_59 , enum V_44 type ,
struct V_17 * V_17 )
{
F_50 ( V_59 , type , V_17 ) ;
F_49 ( V_59 , type , V_17 ) ;
}
void F_54 ( struct V_58 * V_65 , struct V_58 * V_64 ,
enum V_44 type )
{
V_64 -> V_62 [ type ] . V_17 = V_65 -> V_62 [ type ] . V_17 ;
F_55 ( & V_65 -> V_62 [ type ] . V_63 , & V_64 -> V_62 [ type ] . V_63 ) ;
}
struct V_58 * F_56 ( struct V_17 * V_17 , enum V_44 type )
{
struct V_58 * V_66 = NULL ;
if ( V_17 ) {
struct V_54 * V_67 ;
V_67 = F_57 ( F_58 ( & V_17 -> V_50 [ type ] ) ,
F_59 () ) ;
if ( V_67 )
V_66 = F_60 ( V_67 , struct V_58 , V_62 [ ( type ) ] . V_63 ) ;
}
return V_66 ;
}
struct V_58 * F_61 ( T_1 V_8 , struct V_1 * V_9 )
{
F_62 ( F_63 () ,
L_1
L_2 ) ;
return F_56 ( F_45 ( V_8 , V_9 ) , V_68 ) ;
}
struct V_58 * F_64 ( T_1 V_69 )
{
return F_61 ( V_69 , F_48 ( V_57 ) ) ;
}
struct V_17 * F_65 ( struct V_58 * V_59 , enum V_44 type )
{
struct V_17 * V_17 ;
F_66 () ;
if ( type != V_68 )
V_59 = V_59 -> V_70 ;
V_17 = F_67 ( V_59 -> V_62 [ type ] . V_17 ) ;
F_68 () ;
return V_17 ;
}
struct V_58 * F_69 ( struct V_17 * V_17 , enum V_44 type )
{
struct V_58 * V_66 ;
F_66 () ;
V_66 = F_56 ( V_17 , type ) ;
...
{
return F_72 ( V_17 , F_48 ( V_57 ) ) ;
}
T_1 F_74 ( struct V_58 * V_59 , enum V_44 type ,
struct V_1 * V_9 )
{
T_1 V_8 = 0 ;
F_66 () ;
...
if ( type != V_68 )
V_59 = V_59 -> V_70 ;
V_8 = F_72 ( V_59 -> V_62 [ type ] . V_17 , V_9 ) ;
}
F_68 () ;
return V_8 ;
}
T_1 F_76 ( struct V_58 * V_71 , struct V_1 * V_9 )
{
return F_72 ( F_77 ( V_71 ) , V_9 ) ;
}
struct V_1 * F_48 ( struct V_58 * V_71 )
{
return F_78 ( F_79 ( V_71 ) ) ;
}
...
{
F_84 ( V_30 >= V_51 ) ;
V_24 = F_85 ( V_76 , F_86 ( int , V_24 ,
V_77 * F_87 () ) ) ;
V_78 = F_86 ( int , V_78 ,
V_79 * F_87 () ) ;
F_88 ( L_4 , V_24 , V_78 ) ;
V_80 . V_3 [ 0 ] . V_12 = F_11 ( V_26 , V_27 ) ;
F_89 ( 0 , V_80 . V_3 [ 0 ] . V_12 ) ;
F_18 ( & V_80 . V_3 [ 0 ] . V_13 ) ;
V_80 . V_41 = V_51 ;
V_80 . V_35 = F_90 ( V_17 ,
V_81 | V_82 ) ;
}
