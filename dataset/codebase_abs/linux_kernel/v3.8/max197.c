...
int V_36 , V_27 ;
struct V_1 * V_2 ;
struct V_37 * V_28 = V_34 -> V_8 . V_38 ;
enum V_39 V_40 = F_20 ( V_34 ) -> V_41 ;
if ( V_28 == NULL ) {
F_16 ( & V_34 -> V_8 , L_4 ) ;
return - V_25 ;
}
...
V_2 = F_21 ( & V_34 -> V_8 , sizeof( struct V_1 ) , V_42 ) ;
if ( ! V_2 ) {
F_16 ( & V_34 -> V_8 , L_6 ) ;
return - V_43 ;
}
...
V_2 -> V_4 [ V_36 ] = ( V_48 ) V_36 ;
F_23 ( V_34 , V_2 ) ;
V_27 = F_24 ( & V_34 -> V_8 . V_49 , & V_50 ) ;
if ( V_27 ) {
F_16 ( & V_34 -> V_8 , L_7 ) ;
return V_27 ;
}
V_2 -> V_51 = F_25 ( & V_34 -> V_8 ) ;
if ( F_26 ( V_2 -> V_51 ) ) {
V_27 = F_27 ( V_2 -> V_51 ) ;
F_16 ( & V_34 -> V_8 , L_8 ) ;
goto error;
...
return 0 ;
error:
F_28 ( & V_34 -> V_8 . V_49 , & V_50 ) ;
return V_27 ;
}
static int F_29 ( struct V_33 * V_34 )
{
struct V_1 * V_2 = F_30 ( V_34 ) ;
F_31 ( V_2 -> V_51 ) ;
F_28 ( & V_34 -> V_8 . V_49 , & V_50 ) ;
return 0 ;
}
