...
F_21 ( V_2 ) ;
F_40 ( & V_2 -> V_18 ) ;
V_81 = F_41 ( & V_63 -> V_66 , V_38 , F_17 , 0 ,
V_63 -> V_88 , V_2 ) ;
if ( V_81 ) {
F_30 ( & V_63 -> V_66 , L_10 ) ;
return V_81 ;
...
if ( V_78 ) {
for ( V_82 = 0 ; V_82 < V_78 -> V_91 ; V_82 ++ )
F_45 ( & V_2 -> V_42 , V_78 -> V_92 + V_82 ) ;
} else {
F_46 ( & V_2 -> V_42 ) ;
}
return 0 ;
...
static int F_50 ( struct V_93 * V_66 )
{
struct V_1 * V_2 = F_51 ( V_66 ) ;
T_1 V_49 = F_14 ( V_2 , V_50 ) ;
F_13 ( V_2 , V_50 , V_49 & ~ ( V_51 | V_52 ) ) ;
return 0 ;
}
static int F_52 ( struct V_93 * V_66 )
{
struct V_1 * V_2 = F_51 ( V_66 ) ;
F_21 ( V_2 ) ;
return 0 ;
