...
if ( V_17 && ( V_20 == sizeof( T_2 ) ) )
V_2 -> V_31 . clock . V_32 = * V_17 / 2 ;
else
V_2 -> V_31 . clock . V_32 = V_33 ;
...
if ( V_17 && ( V_20 == sizeof( T_2 ) ) )
V_2 -> V_34 |= ( * V_17 << V_37 ) & V_38 ;
else
V_2 -> V_34 |= V_39 ;
V_17 = F_22 ( V_11 , L_8 , & V_20 ) ;
if ( V_17 && ( V_20 == sizeof( T_2 ) ) && * V_17 ) {
T_2 V_40 = V_2 -> V_31 . clock . V_32 * 2 / * V_17 ;
if ( V_40 > 1 )
V_2 -> V_41 |= V_40 / 2 - 1 ;
else
V_2 -> V_41 |= V_42 ;
...
F_23 ( & V_7 -> V_9 ,
L_10 ,
V_2 -> V_4 , V_9 -> V_15 , V_2 -> V_31 . clock . V_32 ,
V_2 -> V_34 , V_2 -> V_41 ) ;
F_8 ( & V_7 -> V_9 , V_9 ) ;
F_24 ( V_9 , & V_7 -> V_9 ) ;
V_18 = F_25 ( V_9 ) ;
