...
static T_3 F_58 ( struct V_90 * V_49 ,
T_3 V_133 )
{
if ( ! ( V_133 & V_134 ) )
V_133 &= ~ V_135 ;
...
static int F_59 ( struct V_90 * V_49 , T_1 V_50 )
{
...
V_71 = F_61 ( V_2 -> V_48 -> V_61 , 0 , 0 , & V_138 ) ;
if ( V_71 == V_62 && ! ( V_138 & V_148 ) &&
! ( V_138 & V_149 ) &&
( V_138 & V_150 ) ) {
V_141 = F_61 ( V_2 -> V_48 -> V_61 , V_137 ,
V_136 , & V_138 ) ;
if ( V_141 != V_62 ) {
F_46 ( V_49 , L_26
L_27 ,
...
static int F_62 ( struct V_90 * V_49 ,
T_3 V_133 )
{
struct V_1 * V_2 = F_43 ( V_49 ) ;
...
if ( V_155 == V_2 -> V_155 )
return 0 ;
V_86 = F_59 ( V_49 , V_155 ) ;
if ( V_86 && ! V_2 -> V_155 )
V_49 -> V_133 = V_133 & ~ ( V_135 | V_134 ) ;
return V_86 ;
}
static void F_63 ( struct V_90 * V_49 , T_1 V_157 , T_4 * V_50 )
{
int V_23 ;
if ( V_157 != V_158 )
return;
for ( V_23 = 0 ; V_23 < F_64 ( V_159 ) ; V_23 ++ , V_50 += V_160 )
memcpy ( V_50 , V_159 [ V_23 ] . V_102 , V_160 ) ;
}
static int F_65 ( struct V_90 * V_49 , int V_161 )
{
switch ( V_161 ) {
case V_158 :
return F_64 ( V_159 ) ;
...
static void F_66 ( struct V_90 * V_49 ,
struct V_163 * V_164 , T_2 * V_50 )
{
int V_23 ;
struct V_1 * V_2 = F_43 ( V_49 ) ;
for ( V_23 = 0 ; V_23 < F_64 ( V_159 ) ; V_23 ++ )
V_50 [ V_23 ] = F_67 ( V_2 , V_159 [ V_23 ] . V_34 ) ;
}
static int F_68 ( struct V_90 * V_49 , struct V_165 * V_166 , int V_106 )
{
return - V_162 ;
}
...
static T_5 F_71 ( struct V_38 * V_39 ,
struct V_90 * V_45 )
{
struct V_1 * V_2 = F_43 ( V_45 ) ;
unsigned int V_170 ;
...
int V_172 = 0 ;
V_28 V_27 ;
if ( F_72 ( V_39 ) -> V_173 > 5 && F_73 ( V_39 ) ) {
V_45 -> V_164 . V_174 ++ ;
goto V_72;
}
if ( V_39 -> V_175 == V_176 &&
( ( V_39 -> V_177 == F_74 ( V_178 ) &&
F_75 ( V_39 ) -> V_177 != V_179 ) ||
( V_39 -> V_177 == F_74 ( V_180 ) &&
F_76 ( V_39 ) -> V_181 != V_179 ) ) &&
F_77 ( V_39 ) ) {
F_46 ( V_45 , L_33 ) ;
V_45 -> V_164 . V_174 ++ ;
goto V_72;
...
if ( F_22 ( & V_2 -> V_48 -> V_49 , V_27 ) )
goto V_192;
V_167 [ 0 ] . V_53 . V_54 = V_170 | F_81 ( V_39 ) ;
V_167 [ 0 ] . V_53 . V_56 = V_27 ;
for ( V_23 = 0 ; V_23 < F_72 ( V_39 ) -> V_173 ; V_23 ++ ) {
const T_6 * V_193 = & F_72 ( V_39 ) -> V_194 [ V_23 ] ;
V_27 = F_82 ( & V_2 -> V_48 -> V_49 , V_193 , 0 ,
F_83 ( V_193 ) , V_191 ) ;
if ( F_22 ( & V_2 -> V_48 -> V_49 , V_27 ) )
goto V_195;
V_167 [ V_23 + 1 ] . V_53 . V_54 = V_170 | F_83 ( V_193 ) ;
...
V_191 ) ;
for ( V_23 = 1 ; V_23 < F_72 ( V_39 ) -> V_173 + 1 ; V_23 ++ )
F_84 ( & V_2 -> V_48 -> V_49 , V_167 [ V_23 ] . V_53 . V_56 ,
...
static int F_88 ( struct V_200 * V_92 , int V_201 )
{
struct V_1 * V_2 =
F_89 ( V_92 , struct V_1 , V_92 ) ;
...
static void F_102 ( struct V_90 * V_45 )
{
struct V_1 * V_2 = F_43 ( V_45 ) ;
unsigned long V_42 ;
if ( ( V_45 -> V_214 & V_215 ) ||
( F_103 ( V_45 ) > V_2 -> V_216 ) ) {
V_42 = F_104 ( V_2 -> V_48 -> V_61 ,
V_217 |
V_218 ,
0 ) ;
if ( V_42 != V_62 ) {
...
static int F_106 ( struct V_90 * V_49 , int V_225 )
{
struct V_1 * V_2 = F_43 ( V_49 ) ;
...
static void F_109 ( struct V_90 * V_49 )
{
F_28 ( F_43 ( V_49 ) ) ;
V_101 ( V_49 -> V_100 , V_49 ) ;
}
static unsigned long F_108 ( struct V_226 * V_48 )
{
struct V_90 * V_45 = F_110 ( & V_48 -> V_49 ) ;
struct V_1 * V_2 ;
unsigned long V_71 ;
int V_23 ;
int V_232 = 1 ;
...
V_71 += F_111 ( V_232 * sizeof( struct V_95 ) ) ;
return V_71 ;
}
static int F_112 ( struct V_226 * V_49 , const struct V_236 * V_237 )
{
int V_86 , V_23 ;
struct V_90 * V_45 ;
struct V_1 * V_2 ;
unsigned char * V_238 ;
unsigned int * V_239 ;
F_113 ( & V_49 -> V_49 , L_43 ,
V_49 -> V_61 ) ;
V_238 = ( unsigned char * ) F_114 ( V_49 , V_240 ,
NULL ) ;
if ( ! V_238 ) {
F_115 ( & V_49 -> V_49 , L_44 ) ;
return - V_231 ;
}
V_239 = ( unsigned int * ) F_114 ( V_49 ,
V_241 , NULL ) ;
if ( ! V_239 ) {
F_115 ( & V_49 -> V_49 , L_45
L_46 ) ;
return - V_231 ;
}
V_45 = F_116 ( sizeof( struct V_1 ) ) ;
if ( ! V_45 )
return - V_93 ;
V_2 = F_43 ( V_45 ) ;
F_117 ( & V_49 -> V_49 , V_45 ) ;
V_2 -> V_48 = V_49 ;
V_2 -> V_45 = V_45 ;
V_2 -> V_216 = * V_239 ;
V_2 -> V_104 = 0 ;
F_118 ( V_45 , & V_2 -> V_92 , F_88 , 16 ) ;
if ( ( * V_238 & 0x3 ) != 0x02 )
V_238 += 2 ;
V_2 -> V_242 = 0 ;
...
static int F_124 ( struct V_226 * V_49 )
{
struct V_90 * V_45 = F_110 ( & V_49 -> V_49 ) ;
struct V_1 * V_2 = F_43 ( V_45 ) ;
int V_23 ;
for ( V_23 = 0 ; V_23 < V_66 ; V_23 ++ )
F_125 ( & V_2 -> V_67 [ V_23 ] . V_250 ) ;
F_126 ( V_45 ) ;
F_123 ( V_45 ) ;
F_117 ( & V_49 -> V_49 , NULL ) ;
return 0 ;
}
static T_8 F_127 ( struct V_249 * V_250 ,
struct V_254 * V_255 , char * V_182 )
{
struct V_14 * V_15 = F_89 ( V_250 ,
struct V_14 ,
V_250 ) ;
if ( V_255 == & V_256 )
...
static T_8 F_128 ( struct V_249 * V_250 , struct V_254 * V_255 ,
const char * V_182 , T_9 V_36 )
{
struct V_14 * V_15 = F_89 ( V_250 ,
struct V_14 ,
V_250 ) ;
struct V_90 * V_45 = F_110 (
F_89 ( V_250 -> V_259 , struct V_74 , V_250 ) ) ;
struct V_1 * V_2 = F_43 ( V_45 ) ;
long V_260 = F_129 ( V_182 , NULL , 10 ) ;
long V_86 ;
if ( V_255 == & V_256 ) {
if ( V_260 && ! V_15 -> V_22 ) {
if ( F_60 ( V_45 ) ) {
...
static int F_130 ( struct V_74 * V_49 )
{
struct V_90 * V_45 = F_110 ( V_49 ) ;
V_101 ( V_45 -> V_100 , V_45 ) ;
return 0 ;
}
static int T_10 F_131 ( void )
{
F_132 ( V_264 L_54 , V_130 ,
V_265 , V_132 ) ;
return F_133 ( & V_266 ) ;
}
