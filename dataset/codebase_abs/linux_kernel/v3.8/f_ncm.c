...
int V_118 ;
int V_119 ;
unsigned V_120 = V_16 -> V_4 . V_26 ;
struct V_121 * V_122 = V_16 -> V_17 ;
unsigned V_123 = V_16 -> V_19 ? sizeof( V_124 ) : 0 ;
div = F_27 ( V_24 . V_125 ) ;
V_116 = F_27 ( V_24 . V_126 ) ;
V_118 = F_27 ( V_24 . V_127 ) ;
V_115 += V_122 -> V_128 ;
V_119 = F_39 ( V_115 , V_118 ) - V_115 ;
V_115 += V_119 ;
V_115 += V_122 -> V_129 ;
V_115 += 2 * 2 * V_122 -> V_130 ;
V_115 += 2 * 2 * V_122 -> V_130 ;
V_117 = F_39 ( V_115 , div ) + V_116 - V_115 ;
V_115 += V_117 ;
if ( V_115 + V_113 -> V_131 + V_123 > V_120 ) {
F_40 ( V_113 ) ;
return NULL ;
}
V_114 = F_41 ( V_113 , V_115 ,
V_120 - V_113 -> V_131 - V_115 - V_123 ,
V_57 ) ;
F_40 ( V_113 ) ;
if ( ! V_114 )
return NULL ;
...
memset ( V_15 , 0 , V_115 ) ;
F_7 ( V_122 -> V_132 , V_15 ) ;
V_15 += 2 ;
F_6 ( V_122 -> V_128 , V_15 ++ ) ;
V_15 ++ ;
F_5 ( & V_15 , V_122 -> V_133 , V_113 -> V_131 ) ;
F_5 ( & V_15 , V_122 -> V_134 , V_122 -> V_128 + V_119 ) ;
V_15 = ( void * ) V_15 + V_119 ;
F_7 ( V_122 -> V_96 , V_15 ) ;
V_15 += 2 ;
F_6 ( V_115 - V_122 -> V_128 - V_117 , V_15 ++ ) ;
V_15 += V_122 -> V_135 ;
V_15 += V_122 -> V_136 ;
V_15 += V_122 -> V_137 ;
if ( V_16 -> V_19 ) {
...
F_5 ( & V_15 , V_122 -> V_130 , V_115 ) ;
F_5 ( & V_15 , V_122 -> V_130 , V_113 -> V_131 - V_115 ) ;
if ( V_113 -> V_131 > V_139 )
memset ( F_44 ( V_113 , V_120 - V_113 -> V_131 ) ,
0 , V_120 - V_113 -> V_131 ) ;
return V_113 ;
}
...
struct V_111 * V_114 ;
int V_147 = - V_110 ;
unsigned V_120 = F_13 ( V_24 . V_25 ) ;
struct V_121 * V_122 = V_16 -> V_17 ;
unsigned V_123 = V_16 -> V_19 ? sizeof( V_124 ) : 0 ;
int V_148 ;
if ( F_11 ( V_15 ) != V_122 -> V_132 ) {
...
V_15 += 2 ;
if ( F_10 ( V_15 ++ ) != V_122 -> V_128 ) {
F_46 ( V_4 -> V_5 . V_35 -> V_34 , L_30 ) ;
goto V_151;
}
V_15 ++ ;
if ( F_9 ( & V_15 , V_122 -> V_133 ) > V_120 ) {
F_46 ( V_4 -> V_5 . V_35 -> V_34 , L_31 ) ;
goto V_151;
}
V_142 = F_9 ( & V_15 , V_122 -> V_134 ) ;
if ( ( ( V_142 % 4 ) != 0 ) && ( V_142 < V_122 -> V_128 ) ) {
F_46 ( V_4 -> V_5 . V_35 -> V_34 , L_32 ,
V_142 ) ;
goto V_151;
}
V_15 = ( ( void * ) V_113 -> V_36 ) + V_142 ;
if ( F_11 ( V_15 ) != V_122 -> V_96 ) {
F_46 ( V_4 -> V_5 . V_35 -> V_34 , L_33 ) ;
goto V_151;
}
V_15 += 2 ;
V_146 = F_10 ( V_15 ++ ) ;
if ( ( V_146 < V_122 -> V_129 + 2 * 2 * ( V_122 -> V_130 * 2 ) )
|| ( V_146 % V_122 -> V_152 != 0 ) ) {
...
V_15 += V_122 -> V_137 ;
V_146 -= V_122 -> V_129 ;
V_143 = F_9 ( & V_15 , V_122 -> V_130 ) ;
V_145 = F_9 ( & V_15 , V_122 -> V_130 ) ;
V_148 = 0 ;
do {
V_142 = V_143 ;
V_144 = V_145 ;
...
F_50 ( V_114 , V_144 - V_123 ) ;
F_51 ( V_141 , V_114 ) ;
V_146 -= 2 * ( V_122 -> V_130 * 2 ) ;
V_148 ++ ;
if ( V_143 == 0 || V_145 == 0 )
break;
} while ( V_146 > 2 * ( V_122 -> V_130 * 2 ) );
...
V_16 -> V_30 -> V_60 = V_16 ;
V_16 -> V_30 -> V_86 = F_22 ;
V_174 . V_175 = V_169 . V_175 ;
V_176 . V_175 = V_170 . V_175 ;
V_177 . V_175 =
V_171 . V_175 ;
V_37 = F_61 ( V_3 , V_178 , V_179 ,
NULL ) ;
V_16 -> V_4 . V_180 = F_54 ;
V_16 -> V_4 . V_181 = F_55 ;
F_16 ( V_34 , L_40 ,
F_4 ( V_158 -> V_34 -> V_51 ) ? L_41 : L_42 ,
V_16 -> V_4 . V_105 -> V_182 , V_16 -> V_4 . V_108 -> V_182 ,
V_16 -> V_56 -> V_182 ) ;
return 0 ;
V_102:
F_62 ( V_3 ) ;
...
ERROR ( V_34 , L_43 , V_3 -> V_182 , V_37 ) ;
return V_37 ;
}
static void
...
int T_4 F_66 ( struct V_157 * V_158 , T_5 V_185 [ V_186 ] )
{
struct V_1 * V_16 ;
int V_37 ;
if ( ! F_67 ( V_158 -> V_34 -> V_51 ) || ! V_185 )
return - V_110 ;
if ( V_183 [ 0 ] . V_184 == 0 ) {
V_37 = F_68 ( V_158 -> V_34 , V_183 ) ;
if ( V_37 < 0 )
return V_37 ;
V_161 . V_187 =
V_183 [ V_188 ] . V_184 ;
V_37 = V_183 [ V_189 ] . V_184 ;
V_165 . V_187 = V_37 ;
V_166 . V_187 = V_37 ;
V_190 . V_191 = V_183 [ V_192 ] . V_184 ;
V_159 . V_193 = V_183 [ V_194 ] . V_184 ;
}
V_16 = F_69 ( sizeof *V_16 , V_173 ) ;
if ( ! V_16 )
return - V_172 ;
snprintf ( V_16 -> V_185 , sizeof V_16 -> V_185 , L_45 , V_185 ) ;
V_183 [ V_192 ] . V_195 = V_16 -> V_185 ;
F_70 ( & V_16 -> V_55 ) ;
F_12 ( V_16 ) ;
V_16 -> V_4 . V_196 = true ;
V_16 -> V_4 . V_5 . V_182 = L_46 ;
V_16 -> V_4 . V_5 . V_197 = V_198 ;
V_16 -> V_4 . V_5 . V_199 = F_56 ;
V_16 -> V_4 . V_5 . V_200 = F_65 ;
V_16 -> V_4 . V_5 . V_201 = F_28 ;
V_16 -> V_4 . V_5 . V_202 = F_37 ;
V_16 -> V_4 . V_5 . V_203 = F_26 ;
V_16 -> V_4 . V_5 . V_204 = F_53 ;
V_16 -> V_4 . V_205 = F_38 ;
V_16 -> V_4 . V_206 = F_45 ;
