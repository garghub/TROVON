...
{
struct V_94 V_75 ;
struct V_91 * V_92 = V_87 -> V_63 . V_95 ;
struct V_1 * V_2 ;
int V_96 = 0 ;
if ( V_92 == NULL ) {
F_34 ( & V_87 -> V_63 , L_5 ) ;
...
V_2 = F_37 ( & V_87 -> V_63 , sizeof( struct V_1 ) , V_98 ) ;
if ( ! V_2 ) {
F_34 ( & V_87 -> V_63 , L_6 ) ;
return - V_99 ;
}
V_2 -> V_19 = V_87 ;
V_2 -> V_89 = F_38 ( L_7 , & V_87 -> V_63 ,
V_2 , & V_100 ) ;
if ( F_39 ( V_2 -> V_89 ) )
return F_40 ( V_2 -> V_89 ) ;
V_2 -> V_65 = V_90 ;
V_2 -> V_20 = ( V_92 ) ? V_92 -> V_101 : V_22 ;
memset ( & V_75 , 0 , sizeof( struct V_94 ) ) ;
V_75 . type = V_102 ;
V_75 . V_103 = V_92 -> V_104 ;
V_2 -> V_85 = F_41 ( L_8 , & V_87 -> V_63 , V_2 ,
& V_105 , & V_75 ) ;
if ( F_39 ( V_2 -> V_85 ) ) {
V_96 = F_40 ( V_2 -> V_85 ) ;
goto V_106;
}
V_2 -> V_85 -> V_75 . V_76 = V_92 -> V_107 ;
