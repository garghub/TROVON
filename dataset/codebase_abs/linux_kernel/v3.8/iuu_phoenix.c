...
if ( V_15 && V_26 -> V_43 && V_91 ) {
F_38 ( V_15 , V_91 , V_26 -> V_43 ) ;
F_39 ( V_15 ) ;
}
F_40 ( V_15 ) ;
F_31 ( V_26 ) ;
...
static int F_43 ( struct V_1 * V_2 , int V_90 )
{
int V_28 ;
F_17 ( V_2 -> V_46 , V_2 -> V_33 -> V_20 ,
F_23 ( V_2 -> V_33 -> V_20 ,
...
static int F_45 ( struct V_14 * V_15 , struct V_1 * V_2 ,
...
static int F_48 ( struct V_1 * V_2 , T_2 V_104 ,
T_2 * V_51 , T_1 V_105 )
{
int V_29 ;
T_2 V_106 ;
...
& V_51 , V_105 ) ;
if ( V_120 )
F_50 ( & V_15 -> V_126 , V_120 ) ;
if ( V_29 != 0 )
return;
F_51 ( V_15 , V_106 , V_106 ) ;
...
static int F_55 ( struct V_14 * V_15 , struct V_1 * V_2 )
{
struct V_50 * V_33 = V_2 -> V_33 ;
struct V_86 * V_20 = & V_2 -> V_20 ;
T_1 * V_8 ;
...
F_56 ( V_33 -> V_20 , V_2 -> V_30 -> V_146 ) ;
F_56 ( V_33 -> V_20 , V_2 -> V_46 -> V_146 ) ;
V_8 = F_29 ( 10 , V_6 ) ;
if ( V_8 == NULL )
return - V_7 ;
V_4 -> V_97 = 0 ;
...
{
struct V_1 * V_2 = F_62 ( V_20 ) ;
struct V_3 * V_4 = F_9 ( V_2 ) ;
return sprintf ( V_8 , L_34 , V_4 -> V_10 ) ;
}
static T_7 F_63 ( struct V_86 * V_20 ,
struct V_157 * V_158 , const char * V_8 , T_8 V_49 )
{
struct V_1 * V_2 = F_62 ( V_20 ) ;
struct V_3 * V_4 = F_9 ( V_2 ) ;
unsigned long V_159 ;
if ( F_64 ( V_8 , 10 , & V_159 ) ) {
F_59 ( V_20 , L_35 ,
V_21 , V_8 ) ;
goto V_160;
}
