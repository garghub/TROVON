...
F_187 ( & V_222 ) ;
if ( V_220 ) {
F_188 ( V_79 , V_68 , 0 , & V_222 ) ;
F_189 ( V_79 , V_68 , 0 , & V_222 ) ;
} else {
F_188 ( V_79 , V_68 ,
F_103 ( V_69 ) -> V_223 ,
& V_222 ) ;
F_189 ( V_79 , V_68 , V_69 -> V_206 , & V_222 ) ;
}
F_190 ( V_79 , V_68 , F_191 ( V_69 ) , & V_222 ) ;
F_192 ( V_79 , V_68 , F_193 ( V_69 ) , & V_222 ) ;
F_194 ( V_79 , V_68 , V_69 -> V_133 , & V_222 ) ;
F_195 ( V_79 , V_68 , V_69 -> V_131 , & V_222 ) ;
F_196 ( V_79 , F_197 ( V_68 ) ,
V_69 -> V_224 . V_225 , & V_222 ) ;
F_198 ( V_79 , F_197 ( V_68 ) ,
V_69 -> V_224 . V_226 , & V_222 ) ;
F_196 ( V_79 , F_199 ( V_68 ) ,
V_69 -> V_227 . V_225 , & V_222 ) ;
F_198 ( V_79 , F_199 ( V_68 ) ,
V_69 -> V_227 . V_226 , & V_222 ) ;
F_196 ( V_79 , F_200 ( V_68 ) ,
V_69 -> V_228 . V_225 , & V_222 ) ;
F_198 ( V_79 , F_200 ( V_68 ) ,
V_69 -> V_228 . V_226 , & V_222 ) ;
F_201 ( V_79 , V_68 , F_46 ( V_69 ) ,
& V_222 ) ;
F_202 ( V_79 , V_68 , V_69 -> V_229 , & V_222 ) ;
F_203 ( V_79 , V_68 , V_2 -> V_60 , & V_222 ) ;
F_204 ( V_79 , V_68 , V_69 -> V_230 , & V_222 ) ;
F_205 ( V_79 , V_68 , F_103 ( V_69 ) -> V_231 , & V_222 ) ;
F_206 ( V_79 , V_68 , 0 , & V_222 ) ;
}
...
struct V_34 V_35 ;
int V_5 ;
memcpy ( & V_35 , & F_103 ( V_69 ) -> V_96 , sizeof( V_35 ) ) ;
V_5 = F_27 ( V_2 , log , V_32 , & V_35 ,
sizeof( * V_163 ) ) ;
if ( V_5 && V_5 != - V_53 )
return V_5 ;
V_163 = F_39 ( V_32 -> V_48 [ 0 ] , V_32 -> V_49 [ 0 ] ,
struct V_56 ) ;
F_186 ( V_2 , V_32 -> V_48 [ 0 ] , V_163 , V_69 , 0 ) ;
F_23 ( V_32 ) ;
return 0 ;
}
static T_2 int F_208 ( struct V_1 * V_2 ,
struct V_69 * V_69 ,
struct V_31 * V_209 ,
struct V_20 * V_214 ,
...
int V_160 ;
struct V_240 V_85 ;
int V_241 = F_103 ( V_69 ) -> V_231 & V_242 ;
F_209 ( & V_85 ) ;
V_239 = F_24 ( V_232 * sizeof( struct V_34 ) +
V_232 * sizeof( T_3 ) , V_51 ) ;
if ( ! V_239 )
return - V_52 ;
V_238 = ( T_3 * ) V_239 ;
V_237 = (struct V_34 * ) ( V_239 + V_232 * sizeof( T_3 ) ) ;
for ( V_160 = 0 ; V_160 < V_232 ; V_160 ++ ) {
V_238 [ V_160 ] = F_20 ( V_214 , V_160 + V_219 ) ;
F_100 ( V_214 , V_237 + V_160 , V_160 + V_219 ) ;
}
V_5 = F_210 ( V_2 , log , V_209 ,
V_237 , V_238 , V_232 ) ;
if ( V_5 ) {
F_25 ( V_239 ) ;
return V_5 ;
}
for ( V_160 = 0 ; V_160 < V_232 ; V_160 ++ , V_209 -> V_49 [ 0 ] ++ ) {
V_235 = F_21 ( V_209 -> V_48 [ 0 ] ,
V_209 -> V_49 [ 0 ] ) ;
V_234 = F_21 ( V_214 , V_219 + V_160 ) ;
if ( V_237 [ V_160 ] . type == V_55 ) {
...
F_34 ( V_209 -> V_48 [ 0 ] , V_214 , V_235 ,
V_234 , V_238 [ V_160 ] ) ;
}
if ( F_211 ( V_237 + V_160 ) == V_167 &&
! V_241 ) {
int V_61 ;
V_236 = F_39 ( V_214 , V_219 + V_160 ,
struct V_67 ) ;
if ( F_212 ( V_214 , V_236 ) < V_2 -> V_60 )
continue;
V_61 = F_40 ( V_214 , V_236 ) ;
if ( V_61 == V_71 ) {
...
static int F_213 ( void * V_248 , struct V_240 * V_249 , struct V_240 * V_250 )
{
struct V_251 * V_252 , * V_253 ;
V_252 = F_59 ( V_249 , struct V_251 , V_89 ) ;
V_253 = F_59 ( V_250 , struct V_251 , V_89 ) ;
...
V_79 = V_32 -> V_48 [ 0 ] ;
V_32 -> V_49 [ 0 ] ++ ;
if ( V_32 -> V_49 [ 0 ] >= F_117 ( V_79 ) ) {
if ( V_260 ) {
V_5 = F_185 ( V_2 , V_4 , V_32 ,
V_259 , V_260 ) ;
if ( V_5 )
return V_5 ;
V_260 = 0 ;
}
V_5 = F_215 ( V_2 , V_4 , V_32 , 1 ) ;
if ( V_5 < 0 )
return V_5 ;
if ( V_5 > 0 )
return 0 ;
...
F_100 ( V_79 , & V_35 , V_32 -> V_49 [ 0 ] ) ;
if ( V_35 . V_43 != F_45 ( V_69 ) ||
V_35 . type != V_167 ||
V_35 . V_65 >= V_254 -> V_27 + V_254 -> V_28 )
break;
V_255 = F_39 ( V_79 , V_32 -> V_49 [ 0 ] ,
struct V_67 ) ;
V_258 = F_216 ( V_79 , V_255 , & V_222 ) ;
if ( V_258 == V_71 ||
V_258 == V_72 ) {
V_257 = F_217 ( V_79 ,
V_255 , & V_222 ) ;
...
if ( V_32 -> V_49 [ 0 ] < F_117 ( V_79 ) - 1 ) {
struct V_34 V_261 ;
F_100 ( V_79 , & V_261 ,
V_32 -> V_49 [ 0 ] + 1 ) ;
if ( V_261 . V_43 == F_45 ( V_69 ) &&
V_261 . type == V_167 &&
V_261 . V_65 <= V_254 -> V_27 + V_254 -> V_28 ) {
if ( ! V_260 )
V_259 = V_32 -> V_49 [ 0 ] ;
V_260 ++ ;
continue;
...
F_48 ( V_258 == V_73 ) ;
memcpy ( & V_256 , & V_35 , sizeof( V_256 ) ) ;
V_256 . V_65 = V_254 -> V_27 + V_254 -> V_28 ;
F_219 ( V_2 , V_4 , V_32 , & V_256 ) ;
V_257 += V_254 -> V_27 + V_254 -> V_28 - V_35 . V_65 ;
F_220 ( V_79 , V_255 , V_257 ,
& V_222 ) ;
F_221 ( V_79 , V_255 , V_64 -
( V_254 -> V_27 + V_254 -> V_28 ) ,
& V_222 ) ;
F_37 ( V_79 ) ;
}
if ( V_260 )
V_5 = F_185 ( V_2 , V_4 , V_32 , V_259 , V_260 ) ;
return V_5 ;
}
...
struct V_221 V_222 ;
struct V_34 V_35 ;
T_1 V_262 = V_254 -> V_263 - V_254 -> V_27 ;
T_1 V_264 = V_254 -> V_265 ;
T_1 V_257 = V_254 -> V_27 - V_254 -> V_266 ;
T_1 V_267 ;
int V_5 ;
bool V_241 = F_103 ( V_69 ) -> V_231 & V_242 ;
F_209 ( & V_85 ) ;
F_187 ( & V_222 ) ;
V_35 . V_43 = F_45 ( V_69 ) ;
V_35 . type = V_167 ;
V_35 . V_65 = V_254 -> V_27 ;
V_32 -> V_268 = 1 ;
V_5 = F_27 ( V_2 , log , V_32 , & V_35 , sizeof( * V_255 ) ) ;
if ( V_5 && V_5 != - V_53 ) {
V_32 -> V_268 = 0 ;
return V_5 ;
}
...
V_255 = F_39 ( V_79 , V_32 -> V_49 [ 0 ] ,
struct V_67 ) ;
F_223 ( V_79 , V_255 , V_254 -> V_223 ,
& V_222 ) ;
if ( F_224 ( V_269 , & V_254 -> V_231 ) ) {
V_241 = true ;
F_225 ( V_79 , V_255 ,
V_72 ,
& V_222 ) ;
...
V_267 = F_181 ( V_254 -> V_267 , V_254 -> V_271 ) ;
if ( V_254 -> V_272 != V_273 ) {
F_226 ( V_79 , V_255 ,
V_254 -> V_270 ,
& V_222 ) ;
F_227 ( V_79 , V_255 , V_267 ,
& V_222 ) ;
} else if ( V_254 -> V_270 < V_274 ) {
F_226 ( V_79 , V_255 ,
V_254 -> V_270 -
V_257 , & V_222 ) ;
F_227 ( V_79 , V_255 , V_267 ,
...
F_226 ( V_79 , V_255 , 0 , & V_222 ) ;
F_227 ( V_79 , V_255 , 0 ,
& V_222 ) ;
}
F_220 ( V_79 , V_255 ,
V_254 -> V_27 - V_254 -> V_266 ,
& V_222 ) ;
F_221 ( V_79 , V_255 , V_254 -> V_28 , & V_222 ) ;
F_228 ( V_79 , V_255 , V_254 -> V_28 , & V_222 ) ;
F_229 ( V_79 , V_255 , V_254 -> V_272 ,
& V_222 ) ;
F_230 ( V_79 , V_255 , 0 , & V_222 ) ;
F_231 ( V_79 , V_255 , 0 , & V_222 ) ;
F_37 ( V_79 ) ;
V_5 = F_214 ( V_2 , log , V_69 , V_254 , V_32 ) ;
F_23 ( V_32 ) ;
V_32 -> V_268 = 0 ;
if ( V_5 ) {
return V_5 ;
...
struct V_31 * V_32 )
{
struct V_251 * V_254 , * V_275 ;
struct V_240 V_276 ;
struct V_277 * V_278 = & F_103 ( V_69 ) -> V_279 ;
T_1 V_280 ;
int V_5 = 0 ;
F_209 ( & V_276 ) ;
F_233 ( & V_278 -> V_281 ) ;
V_280 = V_4 -> V_15 -> V_282 ;
F_234 (em, n, &tree->modified_extents, list) {
F_235 ( & V_254 -> V_89 ) ;
if ( V_254 -> V_223 <= V_280 )
continue;
F_3 ( & V_254 -> V_283 ) ;
F_236 ( V_284 , & V_254 -> V_231 ) ;
F_237 ( & V_254 -> V_89 , & V_276 ) ;
}
F_238 ( NULL , & V_276 , F_213 ) ;
while ( ! F_58 ( & V_276 ) ) {
V_254 = F_59 ( V_276 . V_88 , struct V_251 , V_89 ) ;
F_235 ( & V_254 -> V_89 ) ;
if ( V_5 ) {
F_239 ( V_278 , V_254 ) ;
F_240 ( V_254 ) ;
...
F_241 ( & V_278 -> V_281 ) ;
V_5 = F_222 ( V_2 , V_69 , V_4 , V_254 , V_32 ) ;
F_233 ( & V_278 -> V_281 ) ;
F_239 ( V_278 , V_254 ) ;
F_240 ( V_254 ) ;
}
...
V_213 . V_65 = ( T_1 ) - 1 ;
if ( F_31 ( V_69 -> V_133 ) ||
F_103 ( V_69 ) -> V_223 > V_4 -> V_15 -> V_282 ) {
V_5 = F_243 ( V_2 , V_69 ) ;
if ( V_5 ) {
F_80 ( V_32 ) ;
F_80 ( V_209 ) ;
...
break;
V_214 = V_32 -> V_48 [ 0 ] ;
if ( V_286 && V_285 + V_286 == V_32 -> V_49 [ 0 ] ) {
V_286 ++ ;
goto V_293;
} else if ( ! V_286 ) {
V_285 = V_32 -> V_49 [ 0 ] ;
...
V_5 = F_208 ( V_2 , V_69 , V_209 , V_214 , V_285 ,
V_286 , V_233 ) ;
if ( V_5 ) {
V_6 = V_5 ;
goto V_204;
...
if ( V_286 ) {
V_5 = F_208 ( V_2 , V_69 , V_209 , V_214 ,
V_285 ,
V_286 , V_233 ) ;
if ( V_5 ) {
V_6 = V_5 ;
...
if ( V_233 == V_291 && F_31 ( V_69 -> V_133 ) ) {
F_23 ( V_32 ) ;
F_23 ( V_209 ) ;
...
F_103 ( V_69 ) -> V_198 = F_103 ( V_69 ) -> V_294 ;
V_204:
F_4 ( & F_103 ( V_69 ) -> V_7 ) ;
F_80 ( V_32 ) ;
F_80 ( V_209 ) ;
...
static T_2 int F_247 ( struct V_1 * V_2 ,
struct V_69 * V_69 ,
struct V_295 * V_172 ,
struct V_296 * V_297 ,
T_1 V_298 )
...
int V_5 = 0 ;
struct V_3 * V_4 ;
struct V_295 * V_299 = NULL ;
if ( F_123 ( V_69 -> V_133 ) &&
F_103 ( V_69 ) -> V_223 <= V_298 &&
F_103 ( V_69 ) -> V_300 <= V_298 )
goto V_74;
if ( ! F_31 ( V_69 -> V_133 ) ) {
if ( ! V_172 || ! V_172 -> V_301 || V_297 != V_172 -> V_301 -> V_302 )
goto V_74;
V_69 = V_172 -> V_301 ;
}
while ( 1 ) {
...
struct V_3 * V_4 , struct V_69 * V_69 ,
struct V_295 * V_172 , int V_303 )
{
int V_233 = V_303 ? V_243 : V_291 ;
struct V_296 * V_297 ;
struct V_295 * V_299 = NULL ;
int V_5 = 0 ;
T_1 V_298 = V_4 -> V_15 -> V_282 ;
V_297 = V_69 -> V_302 ;
if ( F_154 ( V_4 , V_304 ) ) {
V_5 = 1 ;
goto V_305;
...
V_5 = F_247 ( V_2 , V_69 , V_172 ,
V_297 , V_298 ) ;
if ( V_5 )
goto V_305;
if ( F_253 ( V_69 , V_2 -> V_60 ) ) {
V_5 = V_306 ;
goto V_305;
}
V_5 = F_1 ( V_2 , V_4 ) ;
...
struct V_3 * V_4 , struct V_295 * V_295 )
{
struct V_295 * V_172 = F_249 ( V_295 ) ;
int V_5 ;
V_5 = F_251 ( V_2 , V_4 , V_295 -> V_301 , V_172 , 0 ) ;
F_250 ( V_172 ) ;
return V_5 ;
}
int F_255 ( struct V_3 * V_17 )
{
int V_5 ;
struct V_31 * V_32 ;
struct V_1 * V_2 ;
...
V_261 . V_43 = V_137 . V_65 ;
V_261 . type = V_309 ;
V_261 . V_65 = ( T_1 ) - 1 ;
V_23 . V_158 = F_259 ( V_15 , & V_261 ) ;
if ( F_73 ( V_23 . V_158 ) ) {
...
return;
V_312:
F_103 ( V_91 ) -> V_300 = V_2 -> V_60 ;
}
int F_263 ( struct V_1 * V_2 ,
struct V_69 * V_69 , struct V_69 * V_313 ,
struct V_295 * V_172 )
{
...
if ( F_103 ( V_69 ) -> V_203 <=
V_4 -> V_15 -> V_282 &&
( ! V_313 || F_103 ( V_313 ) -> V_203 <=
V_4 -> V_15 -> V_282 ) )
return 0 ;
return F_251 ( V_2 , V_4 , V_69 , V_172 , 1 ) ;
}
