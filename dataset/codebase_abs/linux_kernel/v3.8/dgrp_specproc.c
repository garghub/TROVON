...
F_28 ( V_62 -> V_65 , V_63 ) ;
if ( V_62 -> V_67 == V_88 ) {
sprintf ( V_86 , L_15 , ( V_62 -> V_89 >> 8 ) & 0xff ,
V_62 -> V_89 & 0xff ) ;
sprintf ( V_87 , L_15 , ( V_62 -> V_90 >> 8 ) & 0xff ,
V_62 -> V_90 & 0xff ) ;
F_29 ( V_57 , L_16 ,
V_63 ,
F_30 ( V_62 -> V_67 ) ,
...
int V_48 ;
int V_94 ;
V_62 = F_57 ( sizeof( struct V_34 ) , V_95 ) ;
if ( ! V_62 )
return - V_76 ;
V_62 -> V_66 = 0 ;
V_62 -> V_65 = V_20 ;
...
F_59 ( & V_62 -> V_101 [ V_94 ] ) ;
V_48 = F_60 ( V_62 ) ;
if ( V_48 )
goto V_102;
V_62 -> V_66 = V_62 -> V_103 -> V_83 ;
V_48 = F_61 ( V_62 ) ;
if ( V_48 )
goto V_102;
F_62 ( V_62 , V_3 , V_104 ) ;
...
static void F_62 ( struct V_34 * V_109 ,
struct V_12 * V_18 ,
void (* F_66)( struct V_12 * V_13 ) )
{
char V_81 [ 3 ] ;
struct V_12 * V_13 ;
F_28 ( V_109 -> V_65 , V_81 ) ;
V_13 = F_9 ( V_81 , 0600 | V_23 , V_18 ) ;
if ( ! V_13 )
return;
V_13 -> V_26 = ( void * ) V_109 ;
if ( F_66 )
F_66 ( V_13 ) ;
}
