...
goto V_294;
#ifdef F_129
snprintf ( V_287 , sizeof( V_287 ) , L_50 , V_286 -> V_302 ) ;
...
static int F_148 ( struct V_118 * V_120 ,
const struct V_283 * V_284 )
{
int V_10 ;
struct V_5 * V_6 ;
