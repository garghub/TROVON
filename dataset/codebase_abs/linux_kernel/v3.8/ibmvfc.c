...
static int F_157 ( struct V_131 * V_8 )
{
struct V_254 * V_255 = V_8 -> V_231 ;
struct V_3 * V_4 = F_59 ( V_255 -> V_89 ) ;
struct V_143 * V_144 = V_143 ( V_255 ) ;
...
static int F_159 ( struct V_131 * V_8 )
{
int V_47 ;
...
static void F_160 ( struct V_169 * V_170 )
{
struct V_145 * V_146 = F_161 ( V_170 ) ;
struct V_3 * V_4 = F_59 ( V_146 ) ;
struct V_169 * V_370 ;
struct V_254 * V_255 ;
unsigned long V_47 ;
...
static const struct V_371 * F_163 ( T_2 V_372 )
{
int V_44 ;
...
static const char * F_164 ( enum V_375 V_72 )
{
int V_44 ;
...
static void F_165 ( struct V_377 * V_18 ,
struct V_3 * V_4 )
{
const struct V_371 * V_346 = F_163 ( V_18 -> V_378 ) ;
struct V_64 * V_65 ;
...
static void F_166 ( struct V_402 * V_18 , struct V_3 * V_4 )
{
long V_47 ;
...
static int F_167 ( struct V_145 * V_146 , unsigned long time )
{
unsigned long V_39 ;
struct V_3 * V_4 = F_59 ( V_146 ) ;
int V_136 = 0 ;
...
static int F_169 ( struct V_143 * V_144 )
{
struct V_145 * V_146 = F_58 ( V_144 -> V_98 . V_147 ) ;
struct V_3 * V_4 = F_59 ( V_146 ) ;
unsigned long V_39 = 0 ;
...
F_173 ( V_255 , V_255 -> V_416 ) ;
F_39 ( V_146 -> V_122 , V_39 ) ;
return 0 ;
}
static int F_174 ( struct V_254 * V_255 , int V_417 ,
int V_418 )
{
if ( V_418 != V_419 )
return - V_420 ;
...
static int F_176 ( struct V_254 * V_255 , int V_422 )
{
if ( V_255 -> V_415 ) {
F_171 ( V_255 , V_422 ) ;
if ( V_422 )
...
static T_5 F_177 ( struct V_231 * V_98 ,
struct V_423 * V_424 , char * V_425 )
{
struct V_145 * V_146 = F_178 ( V_98 ) ;
struct V_3 * V_4 = F_59 ( V_146 ) ;
...
unsigned long V_39 = 0 ;
F_37 ( V_146 -> V_122 , V_39 ) ;
V_4 -> V_234 = F_186 ( V_425 , NULL , 10 ) ;
F_39 ( V_146 -> V_122 , V_39 ) ;
return strlen ( V_425 ) ;
}
static T_5 F_187 ( struct V_428 * V_429 , struct V_430 * V_431 ,
struct V_432 * V_433 ,
...
static struct V_377 * F_188 ( struct V_3 * V_4 )
{
...
static struct V_402 * F_190 ( struct V_3 * V_4 )
{
...
static T_8 F_191 ( int V_112 , void * V_438 )
{
...
F_37 ( V_4 -> V_89 -> V_122 , V_39 ) ;
while ( ! V_136 ) {
while ( ( V_206 = F_188 ( V_4 ) ) != NULL ) {
F_165 ( V_206 , V_4 ) ;
V_206 -> V_217 = 0 ;
F_195 () ;
}
while ( ( V_18 = F_190 ( V_4 ) ) != NULL ) {
F_166 ( V_18 , V_4 ) ;
V_18 -> V_217 = 0 ;
F_195 () ;
}
F_196 ( V_108 ) ;
if ( ( V_206 = F_188 ( V_4 ) ) != NULL ) {
F_192 ( V_108 ) ;
F_165 ( V_206 , V_4 ) ;
V_206 -> V_217 = 0 ;
F_195 () ;
} else if ( ( V_18 = F_190 ( V_4 ) ) != NULL ) {
F_192 ( V_108 ) ;
F_166 ( V_18 , V_4 ) ;
V_18 -> V_217 = 0 ;
F_195 () ;
...
static int F_198 ( struct V_64 * V_65 ,
void (* V_103) ( struct V_64 * ) )
{
if ( ++ V_65 -> V_96 > V_441 ) {
F_12 ( V_65 , V_68 ) ;
...
V_447 += F_198 ( V_65 , V_459 ) ;
else if ( V_65 -> V_397 )
V_447 += F_198 ( V_65 , V_459 ) ;
else if ( F_8 ( V_38 -> V_36 , V_38 -> error ) )
V_447 += F_198 ( V_65 , V_457 ) ;
else
F_12 ( V_65 , V_68 ) ;
F_202 ( V_65 , V_447 , L_65 ,
...
F_201 ( V_65 , L_67 ) ;
if ( V_65 -> V_173 . V_175 &&
V_65 -> V_173 . V_175 != F_204 ( V_38 -> V_450 . V_175 ) ) {
V_4 -> V_90 = 1 ;
F_201 ( V_65 , L_68 ) ;
break;
}
V_65 -> V_173 . V_174 = F_204 ( V_38 -> V_450 . V_174 ) ;
V_65 -> V_173 . V_175 = F_204 ( V_38 -> V_450 . V_175 ) ;
...
static int F_208 ( struct V_314 * V_10 ,
struct V_64 * V_65 )
{
...
if ( F_215 ( & V_65 -> V_138 ) )
F_216 ( & V_65 -> V_138 , V_16 + ( V_475 * V_178 ) ) ;
else {
V_65 -> V_138 . V_41 = ( unsigned long ) V_65 ;
V_65 -> V_138 . V_249 = V_16 + ( V_475 * V_178 ) ;
V_65 -> V_138 . V_250 = ( void (*) ( unsigned long ) ) F_213 ;
F_112 ( & V_65 -> V_138 ) ;
}
F_12 ( V_65 , V_462 ) ;
...
V_447 += F_198 ( V_65 , V_479 ) ;
else
F_12 ( V_65 , V_68 ) ;
F_202 ( V_65 , V_447 , L_82 ,
F_6 ( V_38 -> V_36 , V_38 -> error ) , V_38 -> V_36 , V_38 -> error ,
F_11 ( V_38 -> V_62 ) , V_38 -> V_62 ,
...
static int F_218 ( struct V_3 * V_4 , T_2 V_24 )
{
struct V_64 * V_65 ;
unsigned long V_39 ;
F_37 ( V_4 -> V_89 -> V_122 , V_39 ) ;
...
static void F_237 ( struct V_3 * V_4 , int V_128 )
{
if ( V_128 & V_390 )
F_238 ( V_4 -> V_89 , F_239 () , V_521 , 0 ) ;
if ( ( V_128 & V_94 ) &&
V_4 -> V_72 >= V_166 )
F_238 ( V_4 -> V_89 , F_239 () , V_522 , 0 ) ;
if ( ( V_128 & V_386 ) &&
V_4 -> V_72 == V_88 )
F_238 ( V_4 -> V_89 , F_239 () , V_523 , 0 ) ;
}
static void F_240 ( struct V_64 * V_65 )
{
struct V_3 * V_4 = V_65 -> V_4 ;
struct V_169 * V_170 ;
unsigned long V_39 ;
F_201 ( V_65 , L_97 ) ;
V_170 = F_241 ( V_4 -> V_89 , 0 , & V_65 -> V_173 ) ;
F_37 ( V_4 -> V_89 -> V_122 , V_39 ) ;
...
struct V_111 * V_18 = & V_4 -> V_18 ;
V_92 ;
V_18 -> V_100 = (struct V_402 * ) F_253 ( V_213 ) ;
if ( ! V_18 -> V_100 )
return - V_214 ;
V_18 -> V_129 = V_101 / sizeof( * V_18 -> V_100 ) ;
V_18 -> V_118 = F_254 ( V_98 , V_18 -> V_100 ,
V_101 , V_119 ) ;
if ( F_255 ( V_98 , V_18 -> V_118 ) )
goto V_531;
...
V_530 = 0 ;
F_256 ( & V_4 -> V_113 , ( void * ) F_194 , ( unsigned long ) V_4 ) ;
if ( ( V_47 = F_257 ( V_108 -> V_112 , F_191 , 0 , V_534 , V_4 ) ) ) {
...
struct V_231 * V_98 = V_4 -> V_98 ;
V_92 ;
V_536 -> V_100 = (struct V_377 * ) F_253 ( V_213 ) ;
if ( ! V_536 -> V_100 ) {
F_21 ( V_98 , L_107 ) ;
goto V_537;
}
V_536 -> V_129 = V_101 / sizeof( struct V_377 ) ;
V_536 -> V_118 = F_254 ( V_98 , V_536 -> V_100 ,
V_536 -> V_129 * sizeof( * V_536 -> V_100 ) ,
V_119 ) ;
if ( F_255 ( V_98 , V_536 -> V_118 ) ) {
F_21 ( V_98 , L_108 ) ;
goto V_538;
}
V_4 -> V_220 = F_262 ( V_534 , V_98 ,
...
static void F_264 ( struct V_548 * V_549 )
{
...
F_39 ( V_4 -> V_89 -> V_122 , V_39 ) ;
F_240 ( V_65 ) ;
} else if ( F_265 ( & V_170 -> V_98 ) ) {
F_39 ( V_4 -> V_89 -> V_122 , V_39 ) ;
F_201 ( V_65 , L_113 ) ;
F_266 ( V_170 , V_65 -> V_173 . V_452 ) ;
F_267 ( & V_170 -> V_98 ) ;
}
F_73 ( & V_65 -> V_150 , F_68 ) ;
F_37 ( V_4 -> V_89 -> V_122 , V_39 ) ;
...
static int F_268 ( struct V_107 * V_108 , const struct V_551 * V_149 )
{
struct V_3 * V_4 ;
struct V_145 * V_146 ;
...
F_271 ( & V_4 -> V_91 ) ;
F_271 ( & V_4 -> V_176 ) ;
F_272 ( & V_4 -> V_528 , F_264 ) ;
F_273 ( & V_4 -> V_333 ) ;
if ( ( V_47 = F_261 ( V_4 ) ) )
goto V_561;
V_4 -> V_562 = F_274 ( F_249 , V_4 , L_116 , V_534 ,
V_146 -> V_560 ) ;
if ( F_275 ( V_4 -> V_562 ) ) {
F_21 ( V_98 , L_117 ,
F_276 ( V_4 -> V_562 ) ) ;
...
if ( ( V_47 = F_277 ( V_146 , V_98 ) ) )
goto V_566;
F_278 ( V_146 ) = V_567 ;
if ( ( V_47 = F_279 ( & V_146 -> V_568 . V_431 ,
& V_569 ) ) ) {
F_21 ( V_98 , L_120 , V_47 ) ;
goto V_570;
}
if ( F_280 ( V_146 ) -> V_527 )
F_244 ( F_280 ( V_146 ) -> V_527 , 1 ) ;
F_281 ( V_98 , V_4 ) ;
F_282 ( & V_571 ) ;
...
static int F_288 ( struct V_107 * V_108 )
{
struct V_3 * V_4 = F_103 ( & V_108 -> V_98 ) ;
unsigned long V_39 ;
V_92 ;
F_289 ( & V_4 -> V_89 -> V_568 . V_431 , & V_569 ) ;
F_37 ( V_4 -> V_89 -> V_122 , V_39 ) ;
F_18 ( V_4 , V_73 ) ;
F_39 ( V_4 -> V_89 -> V_122 , V_39 ) ;
F_77 ( V_4 ) ;
...
static int F_291 ( struct V_231 * V_98 )
{
unsigned long V_39 ;
struct V_3 * V_4 = F_103 ( V_98 ) ;
struct V_107 * V_108 = F_23 ( V_98 ) ;
...
static unsigned long F_292 ( struct V_107 * V_108 )
{
unsigned long V_573 = V_202 * sizeof( union V_307 ) ;
return V_573 + ( ( 512 * 1024 ) * V_552 . V_574 ) ;
}
static int T_9 F_293 ( void )
{
int V_47 ;
if ( ! F_294 ( V_575 ) )
return - V_576 ;
F_295 (KERN_INFO IBMVFC_NAMEL_121 ,
