...
static int F_105 ( struct V_273 * V_274 )
{
struct V_276 * V_277 = V_274 -> V_30 . V_278 ;
struct V_1 * V_8 ;
int V_6 , V_48 ;
int V_28 = 0 ;
V_8 = F_106 ( & V_274 -> V_30 , sizeof( * V_8 ) , V_279 ) ;
if ( ! V_8 ) {
F_16 ( & V_274 -> V_30 , L_66 , V_43 ) ;
return - V_280 ;
}
V_8 -> V_10 = V_274 -> V_281 -> V_282 ;
if ( ! V_8 -> V_10 ) {
if ( V_277 ) {
V_28 = F_107 ( & V_274 -> V_30 , V_277 , & V_8 -> V_10 ) ;
if ( V_28 ) {
F_16 ( & V_274 -> V_30 ,
L_67 ) ;
return V_28 ;
...
F_16 ( & V_274 -> V_30 , L_68 ) ;
return - V_224 ;
}
} else {
F_108 ( & V_274 -> V_30 , L_69 ) ;
}
F_109 ( & V_8 -> V_29 ) ;
V_8 -> V_30 = & V_274 -> V_30 ;
V_8 -> V_283 = F_78 ( V_274 -> V_30 . V_283 ) ;
V_8 -> V_77 = F_110 ( L_70 ) ;
V_8 -> V_127 . V_232 = L_71 ;
V_8 -> V_127 . type = V_238 ;
V_8 -> V_127 . V_235 = V_284 ;
V_8 -> V_127 . V_233 = F_5 ( V_284 ) ;
V_8 -> V_127 . V_236 = F_75 ;
V_8 -> V_127 . V_231 = V_285 ;
V_8 -> V_127 . V_230 = F_5 ( V_285 ) ,
...
V_48 = F_116 ( V_274 , V_288 [ V_6 ] . V_232 ) ;
V_28 = F_117 ( V_48 , NULL , V_288 [ V_6 ] . V_289 ,
V_290 | V_291 ,
V_288 [ V_6 ] . V_232 , V_8 ) ;
if ( V_28 != 0 ) {
F_16 ( V_8 -> V_30 , L_76
