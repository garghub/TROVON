...
int F_20 ( struct V_2 * V_3 , struct V_1 * V_13 ,
unsigned long V_19 , unsigned V_21 )
{
return F_18 ( V_3 , V_13 , V_19 , V_21 , 0 ) ;
}
...
if ( F_3 ( V_13 == NULL ) )
return NULL ;
F_21 ( V_17 , V_13 , V_19 , V_21 , V_22 ,
V_18 , V_33 ) ;
return V_13 ;
}
int F_23 ( struct V_2 * V_3 , struct V_1 * V_13 ,
unsigned long V_19 , unsigned V_21 , unsigned long V_22 ,
unsigned long V_18 , unsigned long V_33 )
{
struct V_1 * V_17 ;
V_17 = F_24 ( V_3 ,
...
unsigned long V_18 , unsigned long V_33 )
{
return F_23 ( V_3 , V_13 , V_19 , V_21 , 0 , V_18 , V_33 ) ;
}
...
static int F_30 ( unsigned long V_18 , unsigned long V_33 ,
unsigned long V_19 , unsigned V_21 )
{
if ( V_33 - V_18 < V_19 )
return 0 ;
...
struct V_1 * F_19 ( const struct V_2 * V_3 ,
unsigned long V_19 ,
unsigned V_21 ,
unsigned long V_22 ,
bool V_39 )
...
V_41 = NULL ;
V_42 = ~ 0UL ;
F_31 (entry, &mm->hole_stack, hole_stack) {
