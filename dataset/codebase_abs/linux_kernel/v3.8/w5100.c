...
{
struct V_113 * V_6 = V_112 -> V_54 . V_114 ;
struct V_26 * V_27 = F_76 ( V_112 ) ;
struct V_1 * V_2 = F_34 ( V_27 ) ;
const char * V_115 = F_77 ( V_27 ) ;
struct V_116 * V_117 ;
int V_118 ;
int V_91 ;
int V_119 ;
if ( V_6 && F_69 ( V_6 -> V_120 ) ) {
memcpy ( V_27 -> V_30 , V_6 -> V_120 , V_28 ) ;
} else {
F_78 ( V_27 ) ;
}
V_117 = F_79 ( V_112 , V_121 , 0 ) ;
if ( ! V_117 )
return - V_122 ;
V_118 = F_80 ( V_117 ) ;
if ( ! F_81 ( & V_112 -> V_54 , V_117 -> V_123 , V_118 , V_115 ) )
return - V_124 ;
V_2 -> V_4 = F_82 ( & V_112 -> V_54 , V_117 -> V_123 , V_118 ) ;
if ( ! V_2 -> V_4 )
return - V_124 ;
F_83 ( & V_2 -> V_18 ) ;
V_2 -> V_33 = V_118 < V_125 ;
if ( V_2 -> V_33 ) {
V_2 -> V_126 = F_10 ;
V_2 -> V_127 = F_14 ;
V_2 -> V_128 = F_15 ;
...
F_26 ( V_2 ) ;
if ( F_45 ( V_2 , V_132 ) != V_133 )
return - V_134 ;
V_91 = F_84 ( V_112 , 0 ) ;
if ( V_91 < 0 )
return V_91 ;
V_119 = F_85 ( V_91 , F_58 ,
V_135 , V_115 , V_27 ) ;
if ( V_119 < 0 )
return V_119 ;
V_2 -> V_91 = V_91 ;
V_2 -> V_56 = V_6 ? V_6 -> V_56 : - V_136 ;
if ( F_35 ( V_2 -> V_56 ) ) {
char * V_137 = F_86 ( & V_112 -> V_54 , 16 , V_138 ) ;
if ( ! V_137 )
return - V_87 ;
snprintf ( V_137 , 16 , L_6 , V_115 ) ;
...
F_89 ( V_27 , L_7 , ( V_142 ) V_117 -> V_123 , V_91 ) ;
return 0 ;
}
...
static int F_99 ( struct V_111 * V_112 )
{
struct V_26 * V_27 = F_76 ( V_112 ) ;
struct V_1 * V_2 = F_34 ( V_27 ) ;
F_26 ( V_2 ) ;
