...
void F_60 ( struct V_4 * V_17 ,
struct V_5 * V_6 , int V_99 )
{
const T_8 * V_100 ;
int V_101 ;
int V_102 = F_61 ( V_6 ) ;
...
static inline void F_85 ( struct V_35 * V_6 , int V_146 )
{
struct V_50 * V_142 , * V_147 = & V_6 -> V_50 [ V_146 ] ;
F_27 ( L_43 ,
F_28 ( V_6 ) , V_146 ,
( unsigned long long ) V_147 -> V_63 ,
( unsigned long long ) V_147 -> V_65 ,
( unsigned int ) V_147 -> V_62 ) ;
V_142 = F_83 ( V_6 , V_147 ) ;
if ( ! V_142 || ( V_142 -> V_62 & V_125 ) ||
F_84 ( V_142 , V_147 ) < 0 ) {
F_57 ( V_145 L_44
L_45 , V_146 , F_28 ( V_6 ) ) ;
...
V_147 -> V_62 |= V_125 ;
V_147 -> V_65 -= V_147 -> V_63 ;
V_147 -> V_63 = 0 ;
}
}
static void T_10 F_86 ( int V_148 )
{
...
F_41 (dev) {
F_69 ( V_6 , V_128 , & V_127 ) ;
for ( V_146 = 0 ; V_146 <= V_60 ; V_146 ++ ) {
V_147 = & V_6 -> V_50 [ V_146 ] ;
if ( V_147 -> V_30 )
continue;
if ( ! V_147 -> V_62 || ( V_147 -> V_62 & V_125 ) )
continue;
if ( V_146 == V_60 )
V_149 = 1 ;
if ( V_147 -> V_62 & V_59 )
...
static void T_10 F_89 ( struct V_26 * V_27 )
{
struct V_4 * V_17 = F_17 ( V_27 ) ;
T_1 V_51 ;
struct V_50 * V_111 , * V_154 ;
int V_55 ;
F_27 ( L_48 ,
F_16 ( V_27 ) ) ;
...
for ( V_55 = 0 ; V_55 < 3 ; V_55 ++ ) {
V_154 = & V_17 -> V_118 [ V_55 ] ;
if ( ! ( V_154 -> V_62 & V_58 ) )
continue;
F_27 ( L_53 , V_154 ) ;
if ( ( V_154 -> V_63 - V_51 ) <= 0xa0000 &&
( V_154 -> V_65 - V_51 ) >= 0xbffff )
break;
}
if ( V_55 >= 3 )
return;
...
void F_94 ( struct V_26 * V_27 )
{
struct V_35 * V_6 ;
struct V_26 * V_156 ;
F_14 (dev, &bus->devices, bus_list) {
int V_55 ;
for ( V_55 = 0 ; V_55 < V_157 ; V_55 ++ ) {
struct V_50 * V_147 = & V_6 -> V_50 [ V_55 ] ;
if ( V_147 -> V_30 || ! V_147 -> V_63 || ! V_147 -> V_62 )
continue;
F_27 ( L_58
L_59 ,
F_28 ( V_6 ) , V_55 ,
...
int F_98 ( struct V_35 * V_6 , int V_158 )
{
return F_99 ( V_6 , V_158 ) ;
}
static void F_100 ( struct V_4 * V_17 ,
struct V_159 * V_160 )
{
unsigned long V_54 ;
struct V_50 * V_111 ;
...
V_111 -> V_65 = V_111 -> V_63 + V_161 ;
V_111 -> V_62 = V_59 ;
}
F_101 ( V_160 , V_111 ,
( V_162 T_1 ) ( V_17 -> V_22 - V_25 ) ) ;
F_27 ( L_63 ,
( unsigned long long ) V_111 -> V_63 ,
( unsigned long long ) V_111 -> V_65 ,
...
static void F_104 ( struct V_4 * V_17 )
{
F_105 ( V_160 ) ;
struct V_26 * V_27 ;
