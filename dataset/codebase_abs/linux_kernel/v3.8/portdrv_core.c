...
static int F_28 ( struct V_11 * V_61 , int V_62 , int V_40 )
{
int V_63 ;
struct V_64 * V_65 ;
struct V_3 * V_3 ;
V_65 = F_8 ( sizeof( * V_65 ) , V_25 ) ;
if ( ! V_65 )
return - V_26 ;
V_65 -> V_66 = V_61 ;
V_65 -> V_40 = V_40 ;
...
int F_35 ( struct V_11 * V_4 )
{
int V_17 , V_71 , V_19 , V_72 ;
int V_39 [ V_16 ] ;
V_17 = F_36 ( V_4 ) ;
if ( V_17 )
return V_17 ;
...
static int F_39 ( struct V_3 * V_4 , void * V_75 )
{
struct V_76 * V_77 ;
if ( ( V_4 -> V_67 == & V_68 ) && V_4 -> V_78 ) {
V_77 = F_40 ( V_4 -> V_78 ) ;
if ( V_77 -> V_79 )
V_77 -> V_79 ( F_4 ( V_4 ) ) ;
}
...
{
return F_42 ( V_4 , NULL , F_39 ) ;
}
static int F_43 ( struct V_3 * V_4 , void * V_75 )
{
struct V_76 * V_77 ;
if ( ( V_4 -> V_67 == & V_68 ) &&
( V_4 -> V_78 ) ) {
...
{
return F_42 ( V_4 , NULL , F_43 ) ;
}
static int F_45 ( struct V_3 * V_4 , void * V_75 )
{
if ( V_4 -> V_67 == & V_68 ) {
F_46 ( V_4 ) ;
F_47 ( V_4 ) ;
...
int F_53 ( struct V_76 * V_85 )
{
if ( V_49 )
return - V_43 ;
V_85 -> V_78 . V_84 = ( char * ) V_85 -> V_84 ;
V_85 -> V_78 . V_67 = & V_68 ;
V_85 -> V_78 . V_82 = F_49 ;
V_85 -> V_78 . remove = F_51 ;
V_85 -> V_78 . V_86 = F_52 ;
return F_54 ( & V_85 -> V_78 ) ;
}
void F_55 ( struct V_76 * V_87 )
{
F_56 ( & V_87 -> V_78 ) ;
}
