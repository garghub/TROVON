...
break;
default:
F_32 ( & V_2 -> V_8 . V_61 , & V_52 , V_49 , NULL ) ;
return;
}
if ( V_2 -> V_54 . V_57 )
V_52 . V_62 = & V_2 -> V_54 ;
F_33 ( & V_2 -> V_8 . V_61 , & V_52 ) ;
return;
}
...
V_4 -> V_14 = V_64 ;
snprintf ( V_4 -> V_57 , sizeof( V_4 -> V_57 ) , L_27 ,
V_2 -> V_8 . type ) ;
snprintf ( V_4 -> V_97 , sizeof( V_4 -> V_97 ) , L_28 ,
F_40 ( V_2 -> V_8 . V_98 ) ) ;
V_64 -> V_99 = V_4 -> V_57 ;
V_64 -> V_100 = V_4 -> V_97 ;
V_64 -> V_101 . V_102 = V_103 ;
V_64 -> V_101 . V_104 = 1 ;
if ( V_2 -> V_8 . V_98 -> V_105 ) {
V_64 -> V_101 . V_106 = V_2 -> V_8 . V_98 -> V_105 ;
V_64 -> V_101 . V_107 = V_2 -> V_8 . V_98 -> V_108 ;
} else {
V_64 -> V_101 . V_106 = V_2 -> V_8 . V_98 -> V_106 ;
V_64 -> V_101 . V_107 = V_2 -> V_8 . V_98 -> V_109 ;
}
V_64 -> V_14 . V_110 = & V_2 -> V_8 . V_98 -> V_14 ;
V_64 -> V_111 = V_59 ;
V_64 -> V_112 = V_113 ;
V_2 -> V_5 = V_4 ;
F_23 ( V_2 , V_4 ) ;
