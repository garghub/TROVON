...
struct V_17 * V_13 ;
int V_133 ;
V_13 = * ( ( void * * ) F_66 ( & V_132 -> V_19 ) ) ;
V_13 -> V_18 . V_63 = V_134 ;
V_13 -> V_18 . V_123 = & V_135 ;
V_13 -> V_18 . V_109 = V_23 ;
F_67 ( & V_13 -> V_18 . V_19 , L_22 ) ;
V_13 -> V_18 . V_19 . V_20 = & V_132 -> V_19 ;
V_13 -> V_18 . V_19 . V_136 = F_62 ;
V_133 = F_68 ( & V_13 -> V_18 . V_19 ) ;
if ( V_133 < 0 ) {
F_69 ( & V_13 -> V_18 . V_19 ) ;
return V_133 ;
}
F_63 ( V_13 ) ;
V_133 = F_70 ( & V_132 -> V_19 , & V_13 -> V_18 ) ;
if ( V_133 < 0 )
goto V_137;
V_133 = F_71 ( & V_13 -> V_18 . V_19 , & V_138 ) ;
if ( V_133 < 0 )
goto V_139;
F_72 ( V_132 , V_13 ) ;
return V_133 ;
...
{
struct V_17 * V_13 = F_76 ( V_132 ) ;
F_73 ( & V_13 -> V_18 ) ;
F_72 ( V_132 , NULL ) ;
F_77 ( & V_13 -> V_18 . V_19 , & V_138 ) ;
F_74 ( & V_13 -> V_18 . V_19 ) ;
return 0 ;
}
static void F_78 ( struct V_17 * V_13 , struct V_9 * V_33 ,
int V_57 )
{
F_79 ( & V_13 -> V_30 ) ;
V_13 -> V_38 = V_57 ;
...
static int F_81 ( struct V_131 * V_132 , T_3 V_140 )
{
struct V_17 * V_13 = F_76 ( V_132 ) ;
struct V_9 * V_33 = F_9 ( & V_13 -> V_18 ) ;
F_28 ( & V_132 -> V_19 , L_19 , V_141 ) ;
F_78 ( V_13 , V_33 , 1 ) ;
F_57 ( F_5 ( V_33 ) ) ;
return 0 ;
}
...
static unsigned int F_83 ( const struct V_59 * V_60 )
{
unsigned int V_142 ;
V_142 = F_84 ( V_60 ) << 1 ;
if ( F_85 ( V_60 ) )
...
static int F_86 ( struct V_9 * V_33 , struct V_143 * V_143 )
{
...
return 0 ;
V_142 = F_83 ( V_60 ) ;
return ( 1 << V_142 ) & V_33 -> V_144 ;
}
static int F_87 ( struct V_9 * V_33 ,
unsigned int V_145 )
{
int V_127 ;
V_127 = V_33 -> V_146 [ F_88 ( V_145 ) ] ;
if ( F_89 ( V_145 ) )
V_127 >>= 4 ;
else
V_127 &= 0xf ;
...
static void F_90 ( struct V_9 * V_33 ,
...
V_127 |= V_147 ;
V_33 -> V_146 [ F_88 ( V_145 ) ] = V_127 ;
}
static int F_91 ( struct V_9 * V_33 , struct V_143 * V_143 )
{
unsigned int V_127 ;
int V_148 ;
V_148 = F_86 ( V_33 , V_143 ) ;
if ( ! V_143 -> V_149 ) {
if ( V_148 )
return - V_67 ;
return 0 ;
...
V_133 = F_91 ( V_33 , V_143 ) ;
if ( V_133 ) {
F_37 ( V_150 ) ;
goto V_69;
}
V_133 = F_95 ( V_11 , V_143 ) ;
if ( V_133 ) {
F_37 ( V_150 ) ;
goto V_69;
}
if ( ! V_33 -> V_153 ) {
V_33 -> V_153 = V_143 -> V_19 ;
F_96 ( V_33 -> V_153 ) ;
} else if ( F_97 ( V_33 -> V_153 != V_143 -> V_19 ) )
F_27 ( F_6 ( V_33 ) , L_24 ) ;
F_40 ( & V_150 -> V_154 , & V_33 -> V_154 ) ;
V_143 -> V_155 = V_150 ;
if ( F_98 ( V_143 -> V_145 ) == V_156 )
V_143 -> V_157 = 1 ;
if ( ! F_99 ( & V_33 -> V_158 ) )
F_51 ( & V_33 -> V_158 , V_104 + 1 ) ;
V_69:
F_31 ( & V_33 -> V_13 -> V_30 , V_79 ) ;
return V_133 ;
}
static int F_100 ( struct V_10 * V_11 , struct V_143 * V_143 , int V_28 )
{
struct V_9 * V_33 ;
unsigned long V_79 ;
int V_133 ;
V_33 = F_4 ( V_11 ) ;
F_30 ( & V_33 -> V_13 -> V_30 , V_79 ) ;
V_133 = F_101 ( V_11 , V_143 , V_28 ) ;
if ( ! V_133 && V_33 -> V_45 != V_159 &&
! F_12 ( & V_33 -> V_154 ) )
F_51 ( & V_33 -> V_158 , V_104 ) ;
F_31 ( & V_33 -> V_13 -> V_30 , V_79 ) ;
return V_133 ;
}
static int F_102 ( struct V_143 * V_143 , struct V_5 * V_8 ,
T_4 V_160 )
{
void * V_161 , * V_162 ;
...
T_4 V_167 ;
bool V_168 ;
V_163 = F_103 ( V_143 -> V_145 ) ;
V_162 = V_8 -> V_8 . V_88 + V_8 -> V_8 . V_82 ;
if ( ! V_143 -> V_169 ) {
...
V_79 |= V_174 ;
F_104 ( V_165 , V_143 -> V_175 , V_143 -> V_169 , V_79 ) ;
V_150 -> V_152 = 1 ;
}
V_168 = F_105 ( V_165 ) ;
if ( V_168 == false ) {
...
do {
V_161 = V_165 -> V_176 ;
V_167 = F_55 ( T_4 , V_160 , V_165 -> V_86 ) ;
V_165 -> V_177 = V_167 ;
V_166 += V_167 ;
if ( V_163 )
...
static int F_108 ( struct V_9 * V_33 , struct V_143 * V_143 ,
...
V_181 = V_8 -> V_8 . V_86 - V_8 -> V_8 . V_82 ;
V_160 = F_109 ( V_180 , V_181 ) ;
V_163 = F_103 ( V_143 -> V_145 ) ;
if ( F_97 ( V_160 == 0 ) )
V_182 = 1 ;
else {
...
break;
V_160 = F_55 ( unsigned , V_160 , V_178 ) ;
if ( V_160 == 0 )
break;
...
static struct V_1 * F_111 ( struct V_17 * V_13 , V_111 V_32 )
{
int V_119 ;
...
static int F_113 ( struct V_9 * V_33 , struct V_143 * V_143 ,
struct V_190 * V_191 ,
int * V_28 )
{
struct V_1 * V_192 ;
...
unsigned V_194 ;
unsigned V_195 ;
V_194 = F_114 ( V_191 -> V_196 ) ;
V_195 = F_114 ( V_191 -> V_197 ) ;
switch ( V_191 -> V_198 ) {
case V_199 :
...
static void F_115 ( unsigned long V_221 )
{
struct V_9 * V_33 = (struct V_9 * ) V_221 ;
struct V_17 * V_13 = V_33 -> V_13 ;
...
if ( V_143 -> V_225 )
goto V_226;
else if ( V_33 -> V_45 != V_159 )
continue;
type = F_98 ( V_143 -> V_145 ) ;
if ( V_222 <= 0 && type == V_227 )
continue;
V_32 = F_88 ( V_143 -> V_145 ) ;
if ( F_103 ( V_143 -> V_145 ) )
V_32 |= V_84 ;
V_4 = F_111 ( V_13 , V_32 ) ;
if ( ! V_4 ) {
F_28 ( F_6 ( V_33 ) ,
...
V_4 -> V_126 = 0 ;
V_4 -> V_77 = 0 ;
V_92 = F_113 ( V_33 , V_143 , & V_191 ,
& V_28 ) ;
if ( V_92 > 0 ) {
F_15 ( & V_13 -> V_30 ) ;
V_92 = V_13 -> V_54 -> V_191 ( & V_13 -> V_18 ,
& V_191 ) ;
F_16 ( & V_13 -> V_30 ) ;
if ( V_92 >= 0 ) {
V_178 = 64 * 1024 ;
...
V_178 = V_222 ;
switch ( F_98 ( V_143 -> V_145 ) ) {
case V_232 :
V_178 = V_61 ( V_178 , F_110 ( V_13 , V_4 ) ) ;
V_28 = - V_233 ;
break;
case V_234 :
V_178 = V_61 ( V_178 , F_110 ( V_13 , V_4 ) ) ;
...
V_231:
V_4 -> V_128 = V_104 ;
V_222 = F_108 ( V_33 , V_143 , V_4 , V_178 , & V_28 ) ;
break;
}
if ( V_28 == - V_81 )
continue;
...
F_118 ( F_5 ( V_33 ) , V_143 ) ;
F_15 ( & V_13 -> V_30 ) ;
F_119 ( F_5 ( V_33 ) , V_143 , V_28 ) ;
F_16 ( & V_13 -> V_30 ) ;
goto V_224;
}
if ( F_12 ( & V_33 -> V_154 ) ) {
...
F_51 ( & V_33 -> V_158 , V_104 + F_50 ( 1 ) ) ;
}
F_31 ( & V_13 -> V_30 , V_79 ) ;
}
static int F_121 ( struct V_10 * V_11 , char * V_88 )
{
struct V_9 * V_33 ;
unsigned long V_79 ;
int V_62 = 0 ;
...
if ( ! F_122 ( V_11 ) )
goto V_69;
if ( V_33 -> V_52 && F_123 ( V_104 , V_33 -> V_103 ) ) {
V_33 -> V_35 |= ( V_235 << 16 ) ;
V_33 -> V_35 &= ~ V_51 ;
F_20 ( V_33 ) ;
}
if ( ( V_33 -> V_35 & V_236 ) != 0 ) {
* V_88 = ( 1 << 1 ) ;
F_28 ( F_6 ( V_33 ) , L_32 ,
V_33 -> V_35 ) ;
V_62 = 1 ;
...
static inline void
F_125 ( struct V_237 * V_60 )
{
memset ( V_60 , 0 , sizeof *V_60 ) ;
V_60 -> V_65 = 0x2a ;
V_60 -> V_238 = 12 ;
V_60 -> V_239 = F_126 ( 0x0001 ) ;
V_60 -> V_240 = 1 ;
V_60 -> V_241 . V_242 . V_243 = 0x04 ;
V_60 -> V_241 . V_242 . V_244 = 0xffff ;
}
static inline void F_127 ( struct V_237 * V_60 )
{
memset ( V_60 , 0 , sizeof *V_60 ) ;
V_60 -> V_65 = 0x29 ;
V_60 -> V_238 = 9 ;
...
if ( V_11 -> V_22 == V_34 )
F_125 ( (struct V_237 * ) V_88 ) ;
else
F_127 ( (struct V_237 * ) V_88 ) ;
break;
case V_256 | V_257 :
if ( V_11 -> V_22 != V_34 )
goto error;
if ( ( V_197 >> 8 ) != V_258 )
goto error;
memcpy ( V_88 , & V_259 , sizeof( V_259 ) ) ;
V_62 = sizeof( V_259 ) ;
break;
case V_260 :
* ( V_261 * ) V_88 = F_129 ( 0 ) ;
...
F_20 ( V_33 ) ;
( ( V_264 * ) V_88 ) [ 0 ] = F_126 ( V_33 -> V_35 ) ;
( ( V_264 * ) V_88 ) [ 1 ] = F_126 ( V_33 -> V_35 >> 16 ) ;
break;
case V_265 :
V_62 = - V_229 ;
break;
...
F_28 ( & V_11 -> V_15 . V_274 -> V_19 , L_19 , V_141 ) ;
F_79 ( & V_33 -> V_13 -> V_30 ) ;
V_33 -> V_45 = V_46 ;
F_20 ( V_33 ) ;
V_11 -> V_140 = V_275 ;
...
static inline T_2 F_132 ( char * V_88 , T_6 V_277 , struct V_143 * V_143 )
{
int V_4 = F_88 ( V_143 -> V_145 ) ;
...
static T_2 F_133 ( struct V_14 * V_19 , struct V_112 * V_113 ,
char * V_88 )
{
...
T_6 V_278 ;
V_278 = F_132 ( V_88 , V_115 - V_277 , V_150 -> V_143 ) ;
V_88 += V_278 ;
V_277 += V_278 ;
}
F_31 ( & V_33 -> V_13 -> V_30 , V_79 ) ;
...
static int F_135 ( struct V_9 * V_33 )
{
F_136 ( & V_33 -> V_158 ) ;
V_33 -> V_158 . V_114 = F_115 ;
V_33 -> V_158 . V_279 = ( unsigned long ) V_33 ;
V_33 -> V_45 = V_159 ;
V_33 -> V_144 = 0 ;
F_34 ( & V_33 -> V_154 ) ;
F_5 ( V_33 ) -> V_280 = V_281 ;
F_5 ( V_33 ) -> V_140 = V_276 ;
F_5 ( V_33 ) -> V_282 = 1 ;
#ifdef F_64
F_5 ( V_33 ) -> V_15 . V_283 = 1 ;
#endif
return 0 ;
return F_71 ( F_6 ( V_33 ) , & V_284 ) ;
}
...
struct V_17 * V_13 ;
V_13 = F_4 ( V_11 ) -> V_13 ;
F_77 ( F_6 ( F_4 ( V_11 ) ) , & V_284 ) ;
F_141 ( V_13 -> V_54 ) ;
F_142 ( F_6 ( F_4 ( V_11 ) ) , L_54 ) ;
}
...
static int F_145 ( struct V_10 * V_11 , struct V_287 * V_153 ,
...
return - V_67 ;
F_30 ( & V_33 -> V_13 -> V_30 , V_79 ) ;
for ( V_119 = 0 ; V_119 < V_290 ; V_119 ++ ) {
V_142 = F_83 ( & V_289 [ V_119 ] -> V_60 ) ;
if ( ( 1 << V_142 ) & V_33 -> V_144 ) {
V_293 = - V_67 ;
goto V_294;
}
V_292 = F_25 ( & V_289 [ V_119 ] -> V_295 ) ;
if ( ! V_292 ) {
V_293 = - V_67 ;
goto V_294;
}
...
V_33 -> V_144 |= 1 << V_142 ;
F_90 ( V_33 ,
F_84 ( & V_289 [ V_119 ] -> V_60 ) , V_293 ) ;
}
V_294:
F_31 ( & V_33 -> V_13 -> V_30 , V_79 ) ;
return V_293 ;
}
static int F_146 ( struct V_10 * V_11 , struct V_287 * V_153 ,
struct V_288 * * V_289 , unsigned int V_290 ,
T_1 V_80 )
{
struct V_9 * V_33 = F_4 ( V_11 ) ;
...
static int F_147 ( struct V_131 * V_132 )
{
struct V_17 * V_13 ;
struct V_10 * V_25 ;
struct V_10 * V_24 ;
int V_62 ;
F_142 ( & V_132 -> V_19 , L_57 V_297 L_58 , V_298 ) ;
V_13 = * ( ( void * * ) F_66 ( & V_132 -> V_19 ) ) ;
if ( ! V_107 . V_108 )
V_9 . V_79 = V_286 ;
V_25 = F_148 ( & V_9 , & V_132 -> V_19 , F_149 ( & V_132 -> V_19 ) ) ;
if ( ! V_25 )
return - V_151 ;
V_25 -> V_299 = 1 ;
V_62 = F_150 ( V_25 , 0 , 0 ) ;
...
static int F_154 ( struct V_131 * V_132 )
{
struct V_17 * V_13 ;
V_13 = F_4 ( F_76 ( V_132 ) ) -> V_13 ;
if ( V_13 -> V_24 ) {
F_153 ( F_5 ( V_13 -> V_24 ) ) ;
F_152 ( F_5 ( V_13 -> V_24 ) ) ;
}
...
static int F_155 ( struct V_131 * V_132 , T_3 V_140 )
{
struct V_10 * V_11 ;
struct V_9 * V_33 ;
int V_133 = 0 ;
...
V_33 = F_4 ( V_11 ) ;
if ( V_33 -> V_45 == V_159 ) {
F_156 ( & V_132 -> V_19 , L_59 ) ;
V_133 = - V_303 ;
} else
F_157 ( V_304 , & V_11 -> V_79 ) ;
return V_133 ;
}
static int F_158 ( struct V_131 * V_132 )
{
struct V_10 * V_11 ;
F_28 ( & V_132 -> V_19 , L_19 , V_141 ) ;
V_11 = F_76 ( V_132 ) ;
F_159 ( V_304 , & V_11 -> V_79 ) ;
F_57 ( V_11 ) ;
return 0 ;
}
...
return - V_67 ;
if ( V_107 . V_307 < 1 || V_107 . V_307 > V_305 ) {
F_162 ( L_60 ,
V_305 ) ;
return - V_67 ;
}
for ( V_119 = 0 ; V_119 < V_107 . V_307 ; V_119 ++ ) {
V_308 [ V_119 ] = F_163 ( V_309 , V_119 ) ;
if ( ! V_308 [ V_119 ] ) {
V_119 -- ;
while ( V_119 >= 0 )
F_164 ( V_308 [ V_119 -- ] ) ;
...
for ( V_119 = 0 ; V_119 < V_107 . V_307 ; V_119 ++ ) {
V_13 [ V_119 ] = F_33 ( sizeof( struct V_17 ) , V_312 ) ;
if ( ! V_13 [ V_119 ] )
goto V_313;
V_62 = F_165 ( V_308 [ V_119 ] , & V_13 [ V_119 ] ,
sizeof( void * ) ) ;
if ( V_62 )
goto V_313;
V_62 = F_165 ( V_310 [ V_119 ] , & V_13 [ V_119 ] ,
sizeof( void * ) ) ;
if ( V_62 )
goto V_313;
}
...
for ( V_119 = 0 ; V_119 < V_107 . V_307 ; V_119 ++ ) {
struct V_17 * V_13 ;
V_13 = * ( ( void * * ) F_66 ( & V_310 [ V_119 ] -> V_19 ) ) ;
F_171 ( V_310 [ V_119 ] ) ;
F_171 ( V_308 [ V_119 ] ) ;
F_37 ( V_13 ) ;
}
