...
return - V_78 ;
do {
V_6 = F_181 ( V_39 , V_161 , V_346 , & V_58 ) ;
} while ( ( V_6 == - V_347 ) && F_182 ( V_39 , V_77 ) );
if ( V_6 )
goto V_234;
if ( V_58 != V_346 ) {
V_6 = - V_54 ;
...
static int F_183 ( struct V_345 * V_39 , struct V_1 * V_2 )
{
...
static int F_189 ( struct V_345 * V_39 , struct V_1 * V_2 )
{
struct V_160 * V_161 ;
unsigned short V_346 ;
int V_6 ;
V_346 = F_190 ( F_75 ( (struct V_124 * ) & V_2 -> V_21 . V_23 . V_24 . V_142 ) ) ;
if ( V_346 < V_358 && ! F_191 ( V_359 ) )
return - V_360 ;
V_161 = F_186 ( V_39 , V_346 ) ;
if ( ! V_161 ) {
V_6 = F_180 ( V_39 , V_2 , V_346 ) ;
} else {
V_6 = F_187 ( V_161 , V_2 , V_2 -> V_342 ) ;
if ( ! V_6 )
F_177 ( V_161 , V_2 ) ;
}
return V_6 ;
...
V_2 -> V_274 = V_271 . V_372 . V_373 . V_374 ;
#endif
}
V_6 = F_193 ( V_2 ) ;
if ( V_6 )
...
V_390 . V_294 = F_119 ( V_2 -> V_21 . V_39 ,
(struct V_124 * ) & V_23 -> V_24 . V_143 ) ;
V_390 . V_289 = 1 << ( V_393 - 8 ) ;
V_390 . V_394 = V_395 ;
...
V_390 . V_226 = F_203 ( T_1 , 7 , V_106 -> V_226 ) ;
V_390 . V_181 = F_203 ( T_1 , 7 , V_106 -> V_181 ) ;
V_390 . V_398 = V_393 ;
V_390 . V_399 = V_393 ;
V_390 . V_394 = V_395 ;
V_390 . V_104 = V_2 -> V_104 ? 1 : 0 ;
V_6 = F_204 ( V_2 -> V_119 . V_35 , & V_390 ) ;
V_69:
if ( V_6 && ! F_55 ( V_21 ) ) {
F_96 ( V_21 ) ;
V_2 -> V_119 . V_35 = NULL ;
...
int F_207 ( struct V_71 * V_21 , struct V_105 * V_106 )
{
struct V_1 * V_2 ;
int V_6 ;
V_2 = F_19 ( V_21 , struct V_1 , V_21 ) ;
...
V_381 . V_181 = F_203 ( T_1 , 7 , V_106 -> V_181 ) ;
V_381 . V_104 = V_2 -> V_104 ? 1 : 0 ;
V_6 = F_209 ( V_2 -> V_119 . V_35 , & V_381 ) ;
V_69:
return V_6 ;
}
...
return F_211 ( V_2 -> V_119 . V_122 , & V_401 ) ;
}
...
V_381 . V_175 = V_175 ;
V_381 . V_178 = V_178 ;
return F_213 ( V_2 -> V_119 . V_35 , & V_381 ) ;
}
int F_214 ( struct V_71 * V_21 , struct V_105 * V_106 )
{
struct V_1 * V_2 ;
int V_6 ;
V_2 = F_19 ( V_21 , struct V_1 , V_21 ) ;
...
int F_216 ( struct V_71 * V_21 , enum V_406 V_172 )
{
struct V_1 * V_2 ;
int V_6 ;
V_2 = F_19 ( V_21 , struct V_1 , V_21 ) ;
...
case V_407 :
V_6 = F_217 ( V_2 -> V_119 . V_35 , V_172 ) ;
break;
default:
V_6 = 0 ;
break;
...
int F_215 ( struct V_71 * V_21 , const void * V_175 ,
T_1 V_178 )
{
struct V_1 * V_2 ;
int V_6 ;
...
if ( V_6 )
goto V_69;
if ( F_220 ( V_2 -> V_119 . V_35 , NULL , 0 ) )
F_221 ( V_2 -> V_119 . V_35 , NULL , 0 ) ;
break;
case V_121 :
V_6 = F_222 ( V_2 -> V_119 . V_122 , 0 ) ;
break;
default:
V_6 = - V_65 ;
break;
...
static int F_223 ( int V_192 , struct V_409 * V_34 )
{
struct V_1 * V_2 ;
...
V_192 = F_224 ( V_2 -> V_21 . V_87 , & V_34 -> V_37 . V_43 ,
...
F_227 ( & V_291 -> V_133 , V_25 -> V_415 , V_413 ) ;
if ( V_2 -> V_21 . V_39 == V_40 )
V_413 [ 7 ] = 0x01 ;
* V_43 = * (union V_46 * ) ( V_413 + 4 ) ;
} else {
F_228 ( sin -> V_130 . V_131 , V_25 -> V_415 , V_413 ) ;
if ( V_2 -> V_21 . V_39 == V_40 )
V_413 [ 7 ] = 0x01 ;
* V_43 = * (union V_46 * ) ( V_413 + 4 ) ;
}
...
if ( V_6 )
return V_6 ;
F_226 ( V_2 , (struct V_124 * ) & V_32 -> V_24 , & V_37 . V_43 ) ;
if ( V_2 -> V_21 . V_39 == V_40 )
V_37 . V_38 = F_230 ( V_41 ) ;
...
V_429 |
V_430 ;
V_32 -> V_34 . V_35 = F_231 ( & V_307 , V_2 -> V_21 . V_22 ,
V_2 -> V_21 . V_44 , & V_37 ,
V_290 , V_77 ,
F_223 , V_32 ) ;
return F_232 ( V_32 -> V_34 . V_35 ) ;
}
static void F_233 ( struct V_308 * V_283 )
{
struct V_431 * V_432 = F_19 ( V_283 , struct V_431 , V_283 ) ;
struct V_31 * V_32 = V_432 -> V_32 ;
struct V_409 * V_433 = V_32 -> V_34 . V_35 ;
V_32 -> V_34 . V_35 -> V_73 = V_32 ;
F_223 ( 0 , V_433 ) ;
F_95 ( & V_32 -> V_33 , F_18 ) ;
F_20 ( V_432 ) ;
}
static void F_234 ( struct V_124 * V_24 , union V_46 * V_43 )
{
struct V_129 * sin = (struct V_129 * ) V_24 ;
struct V_132 * V_291 = (struct V_132 * ) V_24 ;
if ( F_72 ( V_24 ) ) {
...
V_43 -> V_434 [ 10 ] = 0xff ;
V_43 -> V_434 [ 11 ] = 0xff ;
* ( T_6 * ) ( & V_43 -> V_434 [ 12 ] ) = sin -> V_130 . V_131 ;
}
}
...
F_234 ( V_24 , & V_32 -> V_34 . V_35 -> V_37 . V_43 ) ;
V_32 -> V_34 . V_35 -> V_37 . V_112 = F_147 ( 0xffff ) ;
if ( V_2 -> V_21 . V_39 == V_40 )
V_32 -> V_34 . V_35 -> V_37 . V_38 = F_230 ( V_41 ) ;
if ( V_25 -> V_317 )
...
int F_237 ( struct V_71 * V_21 , struct V_124 * V_24 ,
void * V_73 )
{
struct V_1 * V_2 ;
struct V_31 * V_32 ;
...
void F_244 ( struct V_71 * V_21 , struct V_124 * V_24 )
{
struct V_1 * V_2 ;
struct V_31 * V_32 ;
V_2 = F_19 ( V_21 , struct V_1 , V_21 ) ;
...
static int F_246 ( struct V_265 * V_315 , struct V_1 * V_2 )
{
struct V_55 * V_25 ;
struct V_311 * V_283 ;
V_25 = & V_2 -> V_21 . V_23 . V_24 . V_25 ;
if ( ( V_25 -> V_317 == V_315 -> V_437 ) &&
memcmp ( V_25 -> V_66 , V_315 -> V_25 , V_315 -> V_438 ) ) {
F_105 ( V_439 L_4 ,
...
V_283 -> V_21 = V_2 ;
V_283 -> V_172 . V_172 = V_440 ;
F_12 ( & V_2 -> V_20 ) ;
F_143 ( V_288 , & V_283 -> V_283 ) ;
}
return 0 ;
}
static int F_247 ( struct V_441 * V_442 , unsigned long V_172 ,
void * V_443 )
{
struct V_265 * V_315 = (struct V_265 * ) V_443 ;
struct V_18 * V_19 ;
struct V_1 * V_2 ;
int V_6 = V_444 ;
if ( F_248 ( V_315 ) != & V_271 )
return V_444 ;
if ( V_172 != V_445 )
return V_444 ;
if ( ! ( V_315 -> V_5 & V_446 ) || ! ( V_315 -> V_323 & V_447 ) )
return V_444 ;
F_22 ( & V_7 ) ;
F_35 (cma_dev, &dev_list, list)
...
static void F_249 ( struct V_45 * V_22 )
{
struct V_18 * V_19 ;
struct V_1 * V_2 ;
...
static void F_253 ( struct V_45 * V_22 )
{
struct V_18 * V_19 ;
V_19 = F_254 ( V_22 , & V_448 ) ;
if ( ! V_19 )
return;
F_22 ( & V_7 ) ;
F_23 ( & V_19 -> V_28 ) ;
...
static int F_255 ( struct V_450 * V_451 , struct V_452 * V_453 )
{
struct V_454 * V_455 ;
struct V_456 * V_457 ;
struct V_1 * V_2 ;
...
F_22 ( & V_7 ) ;
F_35 (cma_dev, &dev_list, list) {
if ( V_458 < V_453 -> args [ 0 ] ) {
V_458 ++ ;
continue;
}
V_459 = 0 ;
F_35 (id_priv, &cma_dev->id_list, list) {
if ( V_459 < V_453 -> args [ 1 ] ) {
V_459 ++ ;
continue;
}
V_457 = F_256 ( V_451 , & V_455 , V_453 -> V_455 -> V_460 ,
sizeof *V_457 , V_461 ,
V_462 ) ;
if ( ! V_457 )
goto V_69;
...
V_21 = & V_2 -> V_21 ;
V_457 -> V_27 = V_21 -> V_23 . V_24 . V_25 . V_61 ;
V_457 -> V_44 = V_21 -> V_44 ;
V_457 -> V_317 =
V_21 -> V_23 . V_24 . V_25 . V_317 ;
if ( V_21 -> V_23 . V_24 . V_142 . V_301 == V_128 ) {
if ( F_257 ( V_451 , V_455 ,
sizeof( struct V_129 ) ,
...
V_457 -> V_465 = V_2 -> V_79 ;
V_457 -> V_466 = V_21 -> V_39 ;
V_457 -> V_467 = V_2 -> V_8 ;
V_457 -> V_103 = V_2 -> V_103 ;
V_457 -> V_76 = V_21 -> V_76 ;
V_459 ++ ;
}
V_453 -> args [ 1 ] = 0 ;
V_458 ++ ;
