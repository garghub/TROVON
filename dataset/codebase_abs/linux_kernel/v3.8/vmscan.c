...
unsigned long * V_25 )
{
unsigned long V_178 , V_141 , free ;
...
V_181 = V_179 * ( V_149 -> V_159 [ 0 ] + 1 ) ;
V_181 /= V_149 -> V_152 [ 0 ] + 1 ;
V_182 = V_180 * ( V_149 -> V_159 [ 1 ] + 1 ) ;
V_182 /= V_149 -> V_152 [ 1 ] + 1 ;
F_60 ( & V_83 -> V_140 ) ;
V_183 [ 0 ] = V_181 ;
V_183 [ 1 ] = V_182 ;
V_184 = V_181 + V_182 + 1 ;
...
unsigned long V_137 ;
V_137 = F_2 ( V_4 , V_6 ) ;
if ( V_2 -> V_110 || V_185 || ! F_161 ( V_2 ) ) {
V_137 >>= V_2 -> V_110 ;
if ( ! V_137 && V_186 )
V_137 = V_19 ;
V_137 = F_166 ( V_137 * V_183 [ V_141 ] , V_184 ) ;
}
V_25 [ V_6 ] = V_137 ;
}
}
...
{
if ( F_168 ( V_195 ) && V_2 -> V_139 &&
( V_2 -> V_139 > V_196 ||
V_2 -> V_110 < V_111 - 2 ) )
return true ;
return false ;
}
static inline bool F_169 ( struct V_4 * V_4 ,
unsigned long V_93 ,
unsigned long V_98 ,
struct V_1 * V_2 )
{
...
V_198 > V_197 )
return true ;
switch ( F_170 ( F_6 ( V_4 ) , V_2 -> V_139 ) ) {
case V_200 :
case V_201 :
return false ;
default:
...
static void F_171 ( struct V_4 * V_4 , struct V_1 * V_2 )
{
unsigned long V_25 [ V_202 ] ;
unsigned long V_14 ;
enum V_5 V_6 ;
unsigned long V_93 , V_98 ;
unsigned long V_203 = V_2 -> V_203 ;
struct V_204 V_205 ;
V_206:
V_93 = 0 ;
V_98 = V_2 -> V_98 ;
F_163 ( V_4 , V_2 , V_25 ) ;
F_172 ( & V_205 ) ;
while ( V_25 [ V_191 ] || V_25 [ V_192 ] ||
V_25 [ V_193 ] ) {
F_165 (lru) {
if ( V_25 [ V_6 ] ) {
V_14 = F_173 (unsigned long,
...
static void F_176 ( struct V_83 * V_83 , struct V_1 * V_2 )
{
struct V_207 * V_208 = V_2 -> V_3 ;
struct V_209 V_210 = {
. V_83 = V_83 ,
. V_110 = V_2 -> V_110 ,
} ;
struct V_207 * V_211 ;
V_211 = F_177 ( V_208 , NULL , & V_210 ) ;
do {
struct V_4 * V_4 = F_178 ( V_83 , V_211 ) ;
F_171 ( V_4 , V_2 ) ;
if ( ! F_1 ( V_2 ) ) {
F_179 ( V_208 , V_211 ) ;
break;
}
V_211 = F_177 ( V_208 , V_211 , & V_210 ) ;
} while ( V_211 );
}
static inline bool F_180 ( struct V_83 * V_83 , struct V_1 * V_2 )
{
unsigned long V_212 , V_213 ;
bool V_214 ;
if ( V_2 -> V_139 <= V_196 )
return false ;
V_212 = F_21 ( F_181 ( V_83 ) ,
( V_83 -> V_215 + V_216 - 1 ) /
V_216 ) ;
V_213 = F_164 ( V_83 ) + V_212 + ( 2UL << V_2 -> V_139 ) ;
V_214 = F_182 ( V_83 , 0 , V_213 , 0 , 0 ) ;
if ( F_183 ( V_83 , V_2 -> V_139 ) )
return V_214 ;
if ( ! F_170 ( V_83 , V_2 -> V_139 ) )
return false ;
return V_214 ;
}
static bool F_184 ( struct V_217 * V_217 , struct V_1 * V_2 )
{
struct V_218 * V_219 ;
struct V_83 * V_83 ;
unsigned long V_220 ;
...
static bool F_189 ( struct V_83 * V_83 )
{
return V_83 -> V_156 < F_190 ( V_83 ) * 6 ;
}
static bool V_187 ( struct V_217 * V_217 ,
struct V_1 * V_2 )
{
struct V_218 * V_219 ;
struct V_83 * V_83 ;
...
static unsigned long F_191 ( struct V_217 * V_217 ,
struct V_1 * V_2 ,
struct V_13 * V_15 )
{
unsigned long V_224 = 0 ;
struct V_225 * V_225 = V_37 -> V_225 ;
struct V_218 * V_219 ;
struct V_83 * V_83 ;
unsigned long V_226 ;
bool V_222 ;
...
if ( V_225 ) {
V_2 -> V_93 += V_225 -> V_228 ;
V_225 -> V_228 = 0 ;
}
}
V_224 += V_2 -> V_98 ;
if ( V_2 -> V_93 >= V_2 -> V_203 )
goto V_20;
V_226 = V_2 -> V_203 + V_2 -> V_203 / 2 ;
if ( V_224 > V_226 ) {
F_194 ( V_229 ? 0 : V_224 ,
V_230 ) ;
V_2 -> V_113 = 1 ;
}
if ( ! V_2 -> V_231 && V_2 -> V_98 &&
V_2 -> V_110 < V_111 - 2 ) {
struct V_83 * V_232 ;
F_195 ( V_217 , F_196 ( V_2 -> V_102 ) ,
& V_233 ,
& V_232 ) ;
F_146 ( V_232 , V_154 , V_155 / 10 ) ;
}
} while ( -- V_2 -> V_110 >= 0 );
V_20:
F_197 () ;
...
if ( V_222 )
return 1 ;
if ( F_1 ( V_2 ) && ! V_187 ( V_217 , V_2 ) )
return 1 ;
return 0 ;
}
static bool F_198 ( T_6 * V_235 )
{
struct V_83 * V_83 ;
...
int V_237 ;
bool V_238 ;
for ( V_237 = 0 ; V_237 <= V_239 ; V_237 ++ ) {
V_83 = & V_235 -> V_240 [ V_237 ] ;
V_236 += F_199 ( V_83 ) ;
V_89 += F_5 ( V_83 , V_194 ) ;
}
V_238 = V_89 > V_236 / 2 ;
if ( ! V_238 && F_200 ( & V_235 -> V_241 ) ) {
V_235 -> V_242 = F_21 ( V_235 -> V_242 ,
(enum V_243 ) V_239 ) ;
F_201 ( & V_235 -> V_241 ) ;
}
return V_238 ;
}
static bool F_202 ( T_7 V_102 , struct V_217 * V_217 ,
T_8 * V_244 )
{
struct V_83 * V_83 ;
int V_245 = F_196 ( V_102 ) ;
T_6 * V_235 ;
if ( V_37 -> V_38 & V_246 )
goto V_20;
if ( F_143 ( V_37 ) )
goto V_20;
F_195 ( V_217 , V_245 , NULL , & V_83 ) ;
V_235 = V_83 -> V_162 ;
if ( F_198 ( V_235 ) )
goto V_20;
F_79 ( V_247 ) ;
...
unsigned long F_205 ( struct V_217 * V_217 , int V_139 ,
T_7 V_102 , T_8 * V_244 )
{
unsigned long V_93 ;
struct V_1 V_2 = {
...
if ( F_202 ( V_102 , V_217 , V_244 ) )
return 1 ;
F_206 ( V_139 ,
V_2 . V_113 ,
V_102 ) ;
V_93 = F_191 ( V_217 , & V_2 , & V_15 ) ;
F_207 ( V_93 ) ;
return V_93 ;
}
unsigned long F_208 ( struct V_207 * V_211 ,
T_7 V_102 , bool V_185 ,
struct V_83 * V_83 ,
unsigned long * V_98 )
{
struct V_1 V_2 = {
...
unsigned long F_211 ( struct V_207 * V_211 ,
T_7 V_102 ,
bool V_185 )
{
struct V_217 * V_217 ;
...
static void F_216 ( struct V_83 * V_83 , struct V_1 * V_2 )
{
struct V_207 * V_211 ;
if ( ! V_175 )
return;
V_211 = F_177 ( NULL , NULL , NULL ) ;
do {
struct V_4 * V_4 = F_178 ( V_83 , V_211 ) ;
if ( F_154 ( V_4 ) )
F_152 ( V_19 , V_4 ,
V_2 , V_190 ) ;
V_211 = F_177 ( NULL , V_211 , NULL ) ;
} while ( V_211 );
}
static bool F_217 ( struct V_83 * V_83 , int V_139 ,
unsigned long V_212 , int V_242 )
{
if ( ! F_182 ( V_83 , V_139 , F_164 ( V_83 ) +
V_212 , V_242 , 0 ) )
return false ;
if ( F_168 ( V_195 ) && V_139 &&
! F_170 ( V_83 , V_139 ) )
return false ;
return true ;
}
static bool F_218 ( T_6 * V_235 , int V_139 , int V_242 )
{
unsigned long V_215 = 0 ;
unsigned long V_254 = 0 ;
int V_237 ;
for ( V_237 = 0 ; V_237 <= V_242 ; V_237 ++ ) {
struct V_83 * V_83 = V_235 -> V_240 + V_237 ;
if ( ! F_186 ( V_83 ) )
continue;
V_215 += V_83 -> V_215 ;
if ( V_83 -> V_187 ) {
...
if ( F_217 ( V_83 , V_139 , 0 , V_237 ) )
V_254 += V_83 -> V_215 ;
else if ( ! V_139 )
return false ;
}
if ( V_139 )
return V_254 >= ( V_215 >> 2 ) ;
else
return true ;
}
static bool F_219 ( T_6 * V_235 , int V_139 , long V_255 ,
int V_242 )
{
if ( V_255 )
return false ;
if ( F_200 ( & V_235 -> V_248 ) ) {
F_220 ( & V_235 -> V_248 ) ;
return false ;
}
return F_218 ( V_235 , V_139 , V_242 ) ;
}
static unsigned long F_221 ( T_6 * V_235 , int V_139 ,
int * V_242 )
{
struct V_83 * V_256 ;
int V_237 ;
...
int V_261 = 0 ;
V_256 = NULL ;
for ( V_237 = V_235 -> V_262 - 1 ; V_237 >= 0 ; V_237 -- ) {
struct V_83 * V_83 = V_235 -> V_240 + V_237 ;
if ( ! F_186 ( V_83 ) )
continue;
if ( V_83 -> V_187 &&
...
continue;
F_216 ( V_83 , & V_2 ) ;
if ( V_171 && F_222 ( V_237 ) ) {
V_257 = V_237 ;
break;
}
if ( ! F_217 ( V_83 , V_139 , 0 , 0 ) ) {
V_257 = V_237 ;
break;
} else {
F_223 ( V_83 , V_115 ) ;
...
V_2 . V_93 += V_225 -> V_228 ;
V_224 += V_2 . V_98 ;
if ( V_263 == 0 && ! F_189 ( V_83 ) )
V_83 -> V_187 = 1 ;
}
if ( V_224 > V_19 * 2 &&
V_224 > V_2 . V_93 + V_2 . V_93 / 2 )
V_2 . V_113 = 1 ;
if ( V_83 -> V_187 ) {
if ( V_257 && V_257 == V_237 )
V_257 -- ;
continue;
}
if ( ! F_217 ( V_83 , V_264 , 0 , V_257 ) ) {
V_256 = V_83 ;
if ( ! F_182 ( V_83 , V_139 ,
F_199 ( V_83 ) , V_257 , 0 ) )
V_261 = 1 ;
...
F_198 ( V_235 ) )
F_220 ( & V_235 -> V_248 ) ;
if ( F_218 ( V_235 , V_139 , * V_242 ) )
break;
if ( V_224 && ( V_2 . V_110 < V_111 - 2 ) ) {
if ( V_261 )
F_79 ( V_266 ) ;
else if ( V_256 )
F_146 ( V_256 , V_154 , V_155 / 10 ) ;
}
if ( V_2 . V_93 >= V_19 )
break;
} while ( -- V_2 . V_110 >= 0 );
...
static void F_227 ( T_6 * V_235 , int V_139 , int V_242 )
{
long V_255 = 0 ;
F_228 ( V_268 ) ;
if ( F_229 ( V_37 ) || F_230 () )
return;
F_231 ( & V_235 -> V_241 , & V_268 , V_269 ) ;
if ( F_219 ( V_235 , V_139 , V_255 , V_242 ) ) {
V_255 = F_232 ( V_155 / 10 ) ;
F_233 ( & V_235 -> V_241 , & V_268 ) ;
F_231 ( & V_235 -> V_241 , & V_268 , V_269 ) ;
}
if ( F_219 ( V_235 , V_139 , V_255 , V_242 ) ) {
F_234 ( V_235 -> V_163 ) ;
...
const struct V_281 * V_281 = F_239 ( V_235 -> V_163 ) ;
F_240 ( V_117 ) ;
if ( ! F_241 ( V_281 ) )
F_242 ( V_280 , V_281 ) ;
V_37 -> V_225 = & V_225 ;
...
V_277 = V_235 -> V_242 ;
V_235 -> V_284 = 0 ;
V_235 -> V_242 = V_235 -> V_262 - 1 ;
}
if ( V_139 < V_275 || V_242 > V_277 ) {
V_139 = V_275 ;
V_242 = V_277 ;
} else {
F_227 ( V_235 , V_276 ,
...
break;
if ( ! V_18 ) {
F_244 ( V_235 -> V_163 , V_139 ) ;
V_278 = V_242 ;
V_276 = F_221 ( V_235 , V_139 ,
& V_278 ) ;
}
}
V_37 -> V_225 = NULL ;
...
void F_245 ( struct V_83 * V_83 , int V_139 , enum V_243 V_242 )
{
T_6 * V_235 ;
if ( ! F_186 ( V_83 ) )
return;
...
return;
V_235 = V_83 -> V_162 ;
if ( V_235 -> V_284 < V_139 ) {
V_235 -> V_284 = V_139 ;
V_235 -> V_242 = F_21 ( V_235 -> V_242 , V_242 ) ;
}
if ( ! F_200 ( & V_235 -> V_241 ) )
return;
if ( F_182 ( V_83 , V_139 , F_181 ( V_83 ) , 0 , 0 ) )
return;
F_246 ( V_235 -> V_163 , F_148 ( V_83 ) , V_139 ) ;
F_201 ( & V_235 -> V_241 ) ;
}
...
unsigned long F_190 ( struct V_83 * V_83 )
{
int V_25 ;
V_25 = F_5 ( V_83 , V_176 ) +
F_5 ( V_83 , V_144 ) ;
...
unsigned long F_249 ( unsigned long V_203 )
{
struct V_225 V_225 ;
struct V_1 V_2 = {
. V_102 = V_251 ,
...
struct V_217 * V_217 = F_250 ( F_251 () , V_2 . V_102 ) ;
...
static int F_253 ( struct V_285 * V_286 , unsigned long V_287 ,
void * V_288 )
{
int V_252 ;
if ( V_287 == V_289 || V_287 == V_290 ) {
F_254 (nid, N_MEMORY) {
T_6 * V_235 = F_213 ( V_252 ) ;
const struct V_281 * V_291 ;
V_291 = F_239 ( V_235 -> V_163 ) ;
if ( F_255 ( V_292 , V_291 ) < V_293 )
F_242 ( V_235 -> F_238 , V_291 ) ;
}
}
return V_294 ;
}
...
if ( V_235 -> F_238 )
return 0 ;
V_235 -> F_238 = F_257 ( F_238 , V_235 , L_4 , V_252 ) ;
if ( F_258 ( V_235 -> F_238 ) ) {
F_50 ( V_295 == V_296 ) ;
V_235 -> F_238 = NULL ;
F_259 ( L_5 , V_252 ) ;
V_18 = F_260 ( V_235 -> F_238 ) ;
}
return V_18 ;
}
void F_261 ( int V_252 )
{
struct V_279 * F_238 = F_213 ( V_252 ) -> F_238 ;
if ( F_238 ) {
F_262 ( F_238 ) ;
F_213 ( V_252 ) -> F_238 = NULL ;
}
}
...
static inline unsigned long F_266 ( struct V_83 * V_83 )
{
...
static long F_267 ( struct V_83 * V_83 )
{
long V_300 ;
long V_21 = 0 ;
if ( V_301 & V_302 )
...
static int F_268 ( struct V_83 * V_83 , T_7 V_102 , unsigned int V_139 )
{
...
. V_100 = ! ! ( V_301 & V_302 ) ,
. V_188 = 1 ,
. V_203 = F_269 (unsigned long, nr_pages,
SWAP_CLUSTER_MAX) ,
. V_102 = V_102 ,
. V_139 = V_139 ,
. V_110 = V_306 ,
...
int F_270 ( struct V_83 * V_83 , T_7 V_102 , unsigned int V_139 )
{
int V_163 ;
int V_18 ;
if ( F_267 ( V_83 ) <= V_83 -> V_309 &&
...
return V_314 ;
V_163 = F_271 ( V_83 ) ;
if ( F_272 ( V_163 , V_315 ) && V_163 != F_251 () )
return V_314 ;
if ( F_273 ( V_83 , V_316 ) )
return V_314 ;
V_18 = F_268 ( V_83 , V_102 , V_139 ) ;
F_223 ( V_83 , V_316 ) ;
if ( ! V_18 )
F_79 ( V_317 ) ;
return V_18 ;
...
{
return ! F_274 ( F_36 ( V_34 ) ) && ! F_275 ( V_34 ) ;
}
void F_276 ( struct V_34 * * V_318 , int V_138 )
{
struct V_4 * V_4 ;
...
int V_320 = 0 ;
int V_237 ;
for ( V_237 = 0 ; V_237 < V_138 ; V_237 ++ ) {
struct V_34 * V_34 = V_318 [ V_237 ] ;
struct V_83 * V_321 ;
V_319 ++ ;
V_321 = F_92 ( V_34 ) ;
if ( V_321 != V_83 ) {
...
int F_279 ( struct V_325 * V_326 , int V_327 ,
void T_10 * V_328 ,
T_11 * V_329 , T_12 * V_330 )
{
F_277 () ;
F_280 ( V_326 , V_327 , V_328 , V_329 , V_330 ) ;
V_331 = 0 ;
return 0 ;
}
static T_13 F_281 ( struct V_332 * V_333 ,
struct V_334 * V_335 ,
char * V_336 )
{
F_277 () ;
...
static T_13 F_282 ( struct V_332 * V_333 ,
struct V_334 * V_335 ,
const char * V_336 , T_11 V_337 )
{
F_277 () ;
return 1 ;
}
int F_283 ( struct V_338 * V_338 )
{
return F_284 ( & V_338 -> V_333 , & V_339 ) ;
}
void F_285 ( struct V_338 * V_338 )
{
F_286 ( & V_338 -> V_333 , & V_339 ) ;
}
