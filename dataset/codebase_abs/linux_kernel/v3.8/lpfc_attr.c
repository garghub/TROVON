...
if ( sscanf ( V_9 , L_53 , & V_213 ) != 1 )
return - V_87 ;
if ( V_213 < V_320 || V_213 > V_321 )
return - V_87 ;
V_18 -> V_322 = ( T_2 ) V_213 ;
for ( V_3 = 0 ; V_3 < V_18 -> V_323 ; V_3 += V_324 )
F_123 ( V_18 , V_3 ) ;
return strlen ( V_9 ) ;
}
static int
F_124 ( struct V_17 * V_18 , int V_213 )
{
if ( V_18 -> V_44 != V_45 ) {
V_18 -> V_322 = 0 ;
return 0 ;
...
static int
F_125 ( struct V_14 * V_15 , int V_213 )
{
struct V_12 * V_13 = F_87 ( V_15 ) ;
struct V_248 * V_249 , * V_326 ;
if ( V_213 == V_15 -> V_327 )
return 0 ;
...
V_15 -> V_327 = V_213 ;
F_62 ( V_13 -> V_250 ) ;
F_126 (ndlp, next_ndlp, &vport->fc_nodes, nlp_listp) {
if ( ! F_89 ( V_249 ) )
continue;
if ( V_249 -> V_328 == V_329 )
continue;
V_249 -> V_330 = V_15 -> V_331 ;
}
F_63 ( V_13 -> V_250 ) ;
return 0 ;
}
...
return - V_87 ;
if ( memcmp ( V_9 , V_336 , V_335 ) )
return - V_87 ;
if ( ! ( V_15 -> V_76 & V_96 ) )
return - V_98 ;
F_62 ( & V_18 -> V_214 ) ;
for ( V_332 = 0 ; V_332 < V_85 - V_335 ;
V_332 += sizeof( T_2 ) )
F_46 ( * ( ( T_2 * ) ( V_9 + V_332 + V_335 ) ) ,
V_18 -> V_337 + V_291 + V_332 ) ;
F_63 ( & V_18 -> V_214 ) ;
return V_85 ;
}
static T_1
F_128 ( struct V_285 * V_286 , struct V_287 * V_288 ,
struct V_289 * V_290 ,
char * V_9 , T_10 V_291 , T_5 V_85 )
{
T_5 V_332 ;
...
return - V_87 ;
F_62 ( & V_18 -> V_214 ) ;
for ( V_332 = 0 ; V_332 < V_85 ; V_332 += sizeof( T_2 ) ) {
V_338 = ( T_2 * ) ( V_9 + V_332 ) ;
* V_338 = F_45 ( V_18 -> V_337 + V_291 + V_332 ) ;
}
F_63 ( & V_18 -> V_214 ) ;
return V_85 ;
}
static T_1
F_129 ( struct V_285 * V_286 , struct V_287 * V_288 ,
struct V_289 * V_290 ,
char * V_9 , T_10 V_291 , T_5 V_85 )
{
return - V_98 ;
...
static T_1
F_130 ( struct V_285 * V_286 , struct V_287 * V_288 ,
struct V_289 * V_290 ,
char * V_9 , T_10 V_291 , T_5 V_85 )
{
return - V_98 ;
...
struct V_12 * V_13 = F_87 ( V_15 ) ;
int error ;
error = F_132 ( & V_13 -> V_339 . V_288 ,
& V_340 ) ;
if ( error || V_15 -> V_207 == V_341 )
goto V_170;
error = F_132 ( & V_13 -> V_339 . V_288 ,
& V_342 ) ;
if ( error )
...
return 0 ;
V_345:
F_133 ( & V_13 -> V_339 . V_288 , & V_342 ) ;
V_343:
F_133 ( & V_13 -> V_339 . V_288 ,
& V_340 ) ;
V_170:
return error ;
}
...
if ( V_15 -> V_207 == V_341 )
return;
F_133 ( & V_13 -> V_339 . V_288 , & V_344 ) ;
F_133 ( & V_13 -> V_339 . V_288 , & V_342 ) ;
}
static void
F_135 ( struct V_12 * V_13 )
{
struct V_14 * V_15 = (struct V_14 * ) V_13 -> V_16 ;
F_136 ( V_13 ) = V_15 -> V_346 ;
}
static void
...
( ( V_18 -> V_74 == V_75 ) &&
( V_15 -> V_76 & V_77 ) ) ) )
V_373 = F_75 ( V_18 -> V_374 . V_375 . V_102 . V_296 ) ;
else
V_373 = 0 ;
F_63 ( V_13 -> V_250 ) ;
F_145 ( V_13 ) = V_373 ;
...
struct V_376 * V_377 = & V_18 -> V_378 ;
struct V_379 * V_380 = & V_126 -> V_381 ;
T_6 * V_93 ;
T_7 * V_185 ;
unsigned long V_382 ;
int V_128 = 0 ;
...
V_377 -> V_385 = V_185 -> V_192 . V_386 . V_387 ;
V_377 -> V_388 = ( V_389 )
( ( V_389 ) V_185 -> V_192 . V_386 . V_390
* ( V_389 ) 256 ) ;
V_377 -> V_391 = V_185 -> V_192 . V_386 . V_392 ;
V_377 -> V_393 = ( V_389 )
( ( V_389 ) V_185 -> V_192 . V_386 . V_394
* ( V_389 ) 256 ) ;
memset ( V_93 , 0 , sizeof ( T_6 ) ) ;
V_185 -> V_104 = V_395 ;
V_185 -> V_106 = V_107 ;
...
V_377 -> V_396 = V_185 -> V_192 . V_397 . V_398 ;
V_377 -> V_399 = V_185 -> V_192 . V_397 . V_400 ;
V_377 -> V_401 = V_185 -> V_192 . V_397 . V_402 ;
V_377 -> V_403 = V_185 -> V_192 . V_397 . V_404 ;
V_377 -> V_405 = V_185 -> V_192 . V_397 . V_406 ;
V_377 -> V_407 = V_185 -> V_192 . V_397 . V_408 ;
V_377 -> V_409 = V_185 -> V_192 . V_397 . V_408 ;
V_377 -> V_396 -= V_380 -> V_396 ;
V_377 -> V_399 -= V_380 -> V_399 ;
V_377 -> V_401 -= V_380 -> V_401 ;
V_377 -> V_403 -= V_380 -> V_403 ;
V_377 -> V_405 -= V_380 -> V_405 ;
V_377 -> V_407 -= V_380 -> V_407 ;
V_377 -> V_409 -= V_380 -> V_409 ;
if ( V_18 -> V_19 & V_410 ) {
V_377 -> V_411 = - 1 ;
V_377 -> V_412 = ( V_18 -> V_413 >> 1 ) ;
V_377 -> V_412 -= V_380 -> V_413 ;
} else if ( V_18 -> V_74 == V_75 ) {
V_377 -> V_411 = ( V_18 -> V_414 >> 1 ) ;
V_377 -> V_411 -= V_380 -> V_413 ;
V_377 -> V_412 = - 1 ;
} else {
V_377 -> V_411 = - 1 ;
V_377 -> V_412 = ( V_18 -> V_414 >> 1 ) ;
V_377 -> V_412 -= V_380 -> V_413 ;
}
V_377 -> V_415 = - 1 ;
V_382 = F_148 () ;
if ( V_382 < V_126 -> V_416 )
V_377 -> V_417 = V_382 +
( ( unsigned long ) - 1 - V_126 -> V_416 ) ;
else
V_377 -> V_417 = V_382 - V_126 -> V_416 ;
F_32 ( V_93 , V_18 -> V_99 ) ;
return V_377 ;
}
static void
...
V_380 -> V_396 = V_185 -> V_192 . V_397 . V_398 ;
V_380 -> V_399 = V_185 -> V_192 . V_397 . V_400 ;
V_380 -> V_401 = V_185 -> V_192 . V_397 . V_402 ;
V_380 -> V_403 = V_185 -> V_192 . V_397 . V_404 ;
V_380 -> V_405 = V_185 -> V_192 . V_397 . V_406 ;
V_380 -> V_407 = V_185 -> V_192 . V_397 . V_408 ;
V_380 -> V_409 = V_185 -> V_192 . V_397 . V_408 ;
if ( V_18 -> V_19 & V_410 )
V_380 -> V_413 = ( V_18 -> V_413 >> 1 ) ;
else
V_380 -> V_413 = ( V_18 -> V_414 >> 1 ) ;
V_126 -> V_416 = F_148 () ;
F_32 ( V_93 , V_18 -> V_99 ) ;
return;
}
static struct V_248 *
F_150 ( struct V_419 * V_420 )
{
struct V_12 * V_13 = F_151 ( V_420 -> V_6 . V_421 ) ;
struct V_14 * V_15 = (struct V_14 * ) V_13 -> V_16 ;
struct V_248 * V_249 ;
F_62 ( V_13 -> V_250 ) ;
F_88 (ndlp, &vport->fc_nodes, nlp_listp) {
...
static void
F_152 ( struct V_419 * V_420 )
{
struct V_248 * V_249 = F_150 ( V_420 ) ;
F_153 ( V_420 ) = V_249 ? V_249 -> V_425 : - 1 ;
}
static void
F_154 ( struct V_419 * V_420 )
{
struct V_248 * V_249 = F_150 ( V_420 ) ;
F_155 ( V_420 ) =
V_249 ? F_75 ( V_249 -> V_426 . V_102 . V_296 ) : 0 ;
}
static void
F_156 ( struct V_419 * V_420 )
{
struct V_248 * V_249 = F_150 ( V_420 ) ;
F_157 ( V_420 ) =
...
static void
F_158 ( struct V_427 * V_251 , T_2 V_428 )
{
if ( V_428 )
V_251 -> V_252 = V_428 ;
else
...
static void
F_159 ( struct V_429 * V_429 )
{
struct V_14 * V_15 = * (struct V_14 * * ) V_429 -> V_430 ;
if ( V_15 -> V_62 == V_71 )
F_160 ( V_15 , V_431 , 0 , 0 ) ;
}
static void
F_161 ( struct V_17 * V_18 , T_2 V_432 )
{
V_18 -> V_433 = V_432 ;
}
void
F_162 ( struct V_17 * V_18 )
{
F_163 ( V_18 , V_434 ) ;
F_164 ( V_18 , V_435 ) ;
F_165 ( V_18 , V_436 ) ;
