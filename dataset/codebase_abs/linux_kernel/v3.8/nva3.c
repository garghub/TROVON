...
F_6 ( V_20 , V_14 ) ;
F_7 ( L_2 ,
V_19 , V_13 << 12 , V_17 , V_16 , V_18 ) ;
F_8 ( V_8 , 0x004 , 0x00000040 ) ;
V_12 &= ~ 0x00000040 ;
}
if ( V_12 ) {
F_5 ( V_8 , L_3 , V_12 ) ;
...
static int
F_12 ( struct V_9 * V_22 , struct V_9 * V_6 ,
struct V_23 * V_24 , void * V_18 , T_1 V_25 ,
struct V_9 * * V_26 )
{
bool V_27 = ( F_13 ( V_22 ) -> V_28 != 0xaf ) ;
struct V_29 * V_30 ;
int V_31 ;
V_31 = F_14 ( V_22 , V_6 , V_24 , 0x104000 , V_27 ,
L_4 , L_5 , & V_30 ) ;
* V_26 = F_15 ( V_30 ) ;
if ( V_31 )
return V_31 ;
F_16 ( V_30 ) -> V_32 = 0x00802000 ;
F_16 ( V_30 ) -> V_33 = F_1 ;
F_2 ( V_30 ) -> V_34 = & V_35 ;
F_2 ( V_30 ) -> V_36 = V_37 ;
F_2 ( V_30 ) -> V_38 = F_10 ;
F_17 ( V_30 ) -> V_39 . V_18 = V_40 ;
F_17 ( V_30 ) -> V_39 . V_25 = sizeof( V_40 ) ;
F_17 ( V_30 ) -> V_18 . V_18 = V_41 ;
F_17 ( V_30 ) -> V_18 . V_25 = sizeof( V_41 ) ;
return 0 ;
}
