...
F_93 (avc, &anon_vma->rb_root, pgoff, pgoff) {
struct V_10 * V_11 = V_12 -> V_11 ;
unsigned long V_51 = F_61 ( V_38 , V_11 ) ;
if ( V_72 && ! F_94 ( V_11 -> V_17 , V_72 ) )
continue;
...
static int F_95 ( struct V_38 * V_38 ,
struct V_71 * V_72 ,
unsigned long * V_55 )
{
unsigned int V_67 ;
...
int V_76 = 0 ;
* V_55 = 0 ;
if ( F_46 ( V_38 ) && F_102 ( V_38 ) ) {
if ( ! V_75 && ( ! F_63 ( V_38 ) || F_103 ( V_38 ) ) ) {
V_76 = F_104 ( V_38 ) ;
if ( ! V_76 ) {
V_68 ++ ;
goto V_43;
...
static int F_108 ( struct V_38 * V_38 , struct V_10 * V_11 ,
unsigned long V_51 )
{
struct V_15 * V_16 = V_11 -> V_17 ;
T_7 * V_64 ;
...
if ( ! V_64 )
goto V_43;
if ( F_109 ( * V_64 ) || F_110 ( * V_64 ) ) {
T_7 V_78 ;
F_111 ( V_11 , V_51 , F_81 ( * V_64 ) ) ;
V_78 = F_112 ( V_11 , V_51 , V_64 ) ;
V_78 = F_113 ( V_78 ) ;
V_78 = F_114 ( V_78 ) ;
F_115 ( V_16 , V_51 , V_64 , V_78 ) ;
V_77 = 1 ;
}
F_82 ( V_64 , V_65 ) ;
if ( V_77 )
...
static int F_117 ( struct V_73 * V_40 , struct V_38 * V_38 )
{
T_3 V_45 = V_38 -> V_46 << ( V_47 - V_48 ) ;
struct V_10 * V_11 ;
int V_77 = 0 ;
...
if ( V_11 -> V_55 & V_79 ) {
unsigned long V_51 = F_61 ( V_38 , V_11 ) ;
V_77 += F_108 ( V_38 , V_11 , V_51 ) ;
}
}
F_100 ( & V_40 -> V_74 ) ;
return V_77 ;
}
int F_118 ( struct V_38 * V_38 )
{
int V_77 = 0 ;
F_96 ( ! F_97 ( V_38 ) ) ;
if ( F_46 ( V_38 ) ) {
struct V_73 * V_40 = F_119 ( V_38 ) ;
if ( V_40 )
V_77 = F_117 ( V_40 , V_38 ) ;
}
return V_77 ;
}
...
V_1 = ( void * ) V_1 + V_42 ;
V_38 -> V_40 = (struct V_73 * ) V_1 ;
V_38 -> V_46 = F_121 ( V_11 , V_51 ) ;
}
static void F_123 ( struct V_38 * V_38 ,
struct V_10 * V_11 , unsigned long V_51 )
{
#ifdef F_124
F_96 ( F_64 ( V_38 ) -> V_5 != V_11 -> V_1 -> V_5 ) ;
F_96 ( V_38 -> V_46 != F_121 ( V_11 , V_51 ) ) ;
#endif
}
void F_125 ( struct V_38 * V_38 ,
struct V_10 * V_11 , unsigned long V_51 )
{
F_126 ( V_38 , V_11 , V_51 , 0 ) ;
}
void F_126 ( struct V_38 * V_38 ,
struct V_10 * V_11 , unsigned long V_51 , int V_80 )
{
int V_81 = F_127 ( & V_38 -> V_82 ) ;
if ( V_81 ) {
if ( ! F_86 ( V_38 ) )
F_128 ( V_38 , V_83 ) ;
else
...
F_5 ( ! F_97 ( V_38 ) ) ;
if ( V_81 )
F_122 ( V_38 , V_11 , V_51 , V_80 ) ;
else
F_123 ( V_38 , V_11 , V_51 ) ;
}
...
int F_148 ( struct V_38 * V_38 , struct V_10 * V_11 ,
...
F_111 ( V_11 , V_51 , F_80 ( V_38 ) ) ;
V_92 = F_112 ( V_11 , V_51 , V_64 ) ;
if ( F_109 ( V_92 ) )
F_142 ( V_38 ) ;
F_150 ( V_16 ) ;
...
F_115 ( V_16 , V_51 , V_64 ,
F_153 ( F_154 ( V_38 ) ) ) ;
} else if ( F_63 ( V_38 ) ) {
T_9 V_78 = { . V_103 = F_155 (page) } ;
if ( F_156 ( V_38 ) ) {
if ( F_157 ( V_78 ) < 0 ) {
F_115 ( V_16 , V_51 , V_64 , V_92 ) ;
V_77 = V_99 ;
goto V_97;
}
if ( F_158 ( & V_16 -> V_104 ) ) {
...
F_96 ( F_149 ( V_87 ) != V_109 ) ;
V_78 = F_161 ( V_38 , F_110 ( V_92 ) ) ;
}
F_115 ( V_16 , V_51 , V_64 , F_153 ( V_78 ) ) ;
F_96 ( F_162 ( * V_64 ) ) ;
} else if ( F_160 ( V_108 ) &&
( F_149 ( V_87 ) == V_109 ) ) {
T_9 V_78 ;
...
V_95:
F_82 ( V_64 , V_65 ) ;
if ( F_50 ( & V_11 -> V_17 -> V_110 ) ) {
if ( V_11 -> V_55 & V_70 ) {
F_164 ( V_38 ) ;
V_77 = V_111 ;
}
F_51 ( & V_11 -> V_17 -> V_110 ) ;
}
return V_77 ;
}
static int F_165 ( unsigned long V_112 , unsigned int * V_67 ,
...
F_111 ( V_11 , V_51 , F_81 ( * V_64 ) ) ;
V_92 = F_112 ( V_11 , V_51 , V_64 ) ;
if ( V_38 -> V_46 != F_121 ( V_11 , V_51 ) )
F_115 ( V_16 , V_51 , V_64 , F_169 ( V_38 -> V_46 ) ) ;
if ( F_109 ( V_92 ) )
F_142 ( V_38 ) ;
F_138 ( V_38 ) ;
F_163 ( V_38 ) ;
...
static int F_172 ( struct V_38 * V_38 , enum V_91 V_87 )
{
struct V_1 * V_1 ;
T_3 V_45 ;
struct V_7 * V_12 ;
...
struct V_10 * V_11 = V_12 -> V_11 ;
unsigned long V_51 ;
if ( F_160 ( V_108 ) && ( V_87 & V_109 ) &&
F_171 ( V_11 ) )
continue;
V_51 = F_61 ( V_38 , V_11 ) ;
V_77 = F_148 ( V_38 , V_11 , V_51 , V_87 ) ;
...
if ( F_149 ( V_87 ) == V_96 )
goto V_43;
F_174 (vma, &mapping->i_mmap_nonlinear,
shared.nonlinear) {
...
F_174 (vma, &mapping->i_mmap_nonlinear, shared.nonlinear)
V_11 -> V_128 = NULL ;
V_43:
F_100 ( & V_40 -> V_74 ) ;
return V_77 ;
}
int F_176 ( struct V_38 * V_38 , enum V_91 V_87 )
{
int V_77 ;
F_96 ( ! F_97 ( V_38 ) ) ;
F_5 ( ! F_73 ( V_38 ) && F_86 ( V_38 ) ) ;
if ( F_18 ( F_103 ( V_38 ) ) )
V_77 = F_177 ( V_38 , V_87 ) ;
else if ( F_63 ( V_38 ) )
V_77 = F_172 ( V_38 , V_87 ) ;
else
...
{
F_5 ( ! F_97 ( V_38 ) || F_179 ( V_38 ) ) ;
if ( F_18 ( F_103 ( V_38 ) ) )
return F_177 ( V_38 , V_96 ) ;
else if ( F_63 ( V_38 ) )
return F_172 ( V_38 , V_96 ) ;
else
...
static int F_180 ( struct V_38 * V_38 , int (* F_181)( struct V_38 * ,
...
struct V_10 * V_11 = V_12 -> V_11 ;
unsigned long V_51 = F_61 ( V_38 , V_11 ) ;
V_77 = F_181 ( V_38 , V_11 , V_51 , V_130 ) ;
if ( V_77 != V_93 )
break;
}
F_54 ( V_1 ) ;
...
static int F_182 ( struct V_38 * V_38 , int (* F_181)( struct V_38 * ,
struct V_10 * , unsigned long , void * ) , void * V_130 )
{
struct V_73 * V_40 = V_38 -> V_40 ;
T_3 V_45 = V_38 -> V_46 << ( V_47 - V_48 ) ;
...
int F_183 ( struct V_38 * V_38 , int (* F_181)( struct V_38 * ,
struct V_10 * , unsigned long , void * ) , void * V_130 )
{
F_5 ( ! F_97 ( V_38 ) ) ;
if ( F_18 ( F_103 ( V_38 ) ) )
return F_184 ( V_38 , F_181 , V_130 ) ;
else if ( F_63 ( V_38 ) )
return F_180 ( V_38 , F_181 , V_130 ) ;
else
return F_182 ( V_38 , F_181 , V_130 ) ;
}
...
F_96 ( ! F_97 ( V_38 ) ) ;
F_96 ( ! V_1 ) ;
V_81 = F_127 ( & V_38 -> V_82 ) ;
if ( V_81 )
F_185 ( V_38 , V_11 , V_51 , 0 ) ;
}
void F_187 ( struct V_38 * V_38 ,
struct V_10 * V_11 , unsigned long V_51 )
{
F_96 ( V_51 < V_11 -> V_49 || V_51 >= V_11 -> V_52 ) ;
F_3 ( & V_38 -> V_82 , 0 ) ;
F_185 ( V_38 , V_11 , V_51 , 1 ) ;
}
