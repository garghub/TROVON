...
V_119 -> V_123 |= V_130 ;
V_119 -> V_115 = V_116 ;
V_119 -> V_131 . V_132 = V_119 -> V_76 * F_76 ( V_11 -> V_133 ) ;
V_119 -> V_115 = V_116 ;
V_119 -> V_134 = V_135 ;
...
F_79 ( & V_11 -> V_121 [ V_119 -> V_76 ] . V_121 , & V_11 -> V_148 ) ;
...
F_37 ( V_11 ) ;
V_11 -> V_117 = NULL ;
F_60 ( V_11 , V_168 -> V_169 . V_170 . V_171 , V_168 -> V_169 . V_170 . V_172 ) ;
return 0 ;
}
...
if ( F_94 ( V_9 , V_121 -> V_189 + V_121 -> V_188 , V_113 ) )
return - V_186 ;
V_121 -> V_188 += V_113 ;
F_22 ( V_44 , L_22 ,
V_41 ,
...
if ( F_23 ( & V_11 -> V_45 ) )
return - V_46 ;
V_31 = F_92 ( V_42 , V_9 , V_113 , V_182 ) ;
F_38 ( & V_11 -> V_45 ) ;
return V_31 ;
}
static int F_96 ( struct V_42 * V_42 , struct V_190 * V_191 )
{
unsigned long V_60 = V_191 -> V_192 - V_191 -> V_193 ,
V_194 = V_191 -> V_193 ;
void * V_195 ;
T_6 V_156 ;
struct V_1 * V_11 = F_21 ( V_42 ) ;
...
struct V_226 * V_242 ;
T_7 V_243 = V_227 -> V_244 -> V_165 . V_245 ;
...
V_11 -> V_266 = F_131 ( 32 * V_11 -> V_264 , V_228 ) ;
if ( V_11 -> V_266 == NULL ) {
F_17 ( & V_227 -> V_6 , L_46 ) ;
return - V_258 ;
}
for ( V_156 = 0 ; V_156 < V_11 -> V_264 ; V_156 ++ ) {
T_8 V_267 = F_132 ( V_242 -> V_244 [ V_156 ] . V_249 [ 1 ] . V_165 .
V_268 ) ;
V_11 -> V_266 [ V_156 ] =
