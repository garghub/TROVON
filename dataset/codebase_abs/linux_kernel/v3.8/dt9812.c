...
for ( V_130 = 0 ; V_130 < V_128 -> V_130 ; V_130 ++ )
V_129 [ V_130 ] = ( ( 1 << V_128 -> V_131 ) & V_37 ) != 0 ;
return V_130 ;
}
...
for ( V_130 = 0 ; V_130 < V_128 -> V_130 ; V_130 ++ ) {
T_3 V_24 = 0 ;
F_23 ( V_115 -> V_36 , V_128 -> V_131 , & V_24 ,
V_60 ) ;
V_129 [ V_130 ] = V_24 ;
}
return V_130 ;
...
for ( V_130 = 0 ; V_130 < V_128 -> V_130 ; V_130 ++ ) {
V_24 = 0 ;
F_24 ( V_115 -> V_36 , V_128 -> V_131 , & V_24 ) ;
V_129 [ V_130 ] = V_24 ;
}
return V_130 ;
}
...
int V_130 ;
for ( V_130 = 0 ; V_130 < V_128 -> V_130 ; V_130 ++ )
F_25 ( V_115 -> V_36 , V_128 -> V_131 , V_129 [ V_130 ] ) ;
return V_130 ;
}
static int F_45 ( struct V_113 * V_4 , struct V_133 * V_134 )
{
struct V_114 * V_115 ;
int V_25 ;
struct V_117 * V_118 ;
...
static void F_47 ( struct V_113 * V_4 )
{
}
