...
struct V_101 * V_89 )
{
return F_27 ( V_2 , V_4 , V_89 ) ;
}
static int F_28 ( struct V_1 * V_2 , struct V_112 * V_113 )
{
const struct V_33 * V_34 = F_10 ( V_2 ) ;
struct V_35 * V_36 ;
struct V_3 * V_4 ;
int V_114 , V_115 , V_116 , V_47 , V_31 , V_117 = 0 ;
unsigned long V_44 ;
unsigned int V_66 [ V_70 ] ;
int V_118 ;
V_44 = V_113 -> V_119 [ 0 ] ;
V_66 [ 0 ] = V_113 -> V_119 [ 1 ] ;
V_66 [ 1 ] = V_113 -> V_119 [ 2 ] ;
F_3 ( V_2 -> V_9 , L_6 ,
V_2 -> V_120 -> V_121 , V_44 ) ;
V_2 -> V_44 = V_44 ;
if ( ! V_44 || ! F_29 ( V_44 ,
V_34 -> V_38 * V_45 ,
V_2 -> V_120 -> V_121 ) ) {
...
V_2 -> V_123 = V_34 -> V_124 ;
V_36 = F_31 ( sizeof( * V_36 ) , V_125 ) ;
if ( ! V_36 )
return - V_126 ;
V_2 -> V_37 = V_36 ;
for ( V_31 = 0 ; V_31 < V_70 ; ++ V_31 ) {
V_36 -> V_40 [ V_31 ] . V_127 = V_31 ;
V_36 -> V_40 [ V_31 ] . V_44 = V_2 -> V_44 + V_31 * V_45 ;
V_36 -> V_40 [ V_31 ] . V_66 = 0 ;
F_32 ( & V_36 -> V_40 [ V_31 ] . V_74 ) ;
}
V_115 = V_128 * V_34 -> V_38 ;
V_116 = F_33 ( V_115 ) ;
V_36 -> V_129 =
F_34 ( V_116 , sizeof( struct V_130 ) ,
V_125 ) ;
if ( ! V_36 -> V_129 ) {
F_35 ( V_2 -> V_9 ,
L_8 ) ;
...
V_118 = F_36 ( V_2 , V_116 ) ;
if ( V_118 )
return V_118 ;
V_47 = 0 ;
V_31 = 0 ;
for ( V_114 = 0 ; V_114 < ( int ) V_2 -> V_80 ; ++ V_114 ) {
int V_8 ;
V_4 = & V_2 -> V_81 [ V_114 ] ;
V_4 -> V_37 = & V_36 -> V_129 [ V_114 ] ;
V_4 -> V_131 = 1 ;
V_4 -> V_132 = & V_133 ;
