...
struct V_79 V_80 ;
struct V_1 * V_86 ;
while ( F_52 ( & V_82 , & V_80 ) ) {
V_86 = F_53 ( V_80 . V_77 , V_80 . V_19 ,
V_80 . V_21 ) ;
if ( ! V_86 ) {
F_47 ( L_16 ,
V_80 . V_77 , V_80 . V_19 ,
F_48 ( V_80 . V_21 ) , F_49 ( V_80 . V_21 ) ) ;
continue;
}
F_40 ( V_86 , V_80 . V_24 ) ;
F_54 ( V_86 ) ;
...
static int F_55 ( struct V_1 * V_2 , struct V_10 * V_76 )
{
int V_7 , V_87 ;
V_76 -> V_8 = 0 ;
V_76 -> V_88 = 0 ;
...
V_76 -> V_88 = 1 ;
F_8 ( V_2 ,
V_7 + V_93 , & V_76 -> V_94 . V_95 ) ;
F_8 ( V_2 ,
V_7 + V_93 + 4 , & V_76 -> V_94 . V_96 ) ;
F_8 ( V_2 ,
V_7 + V_93 + 8 , & V_76 -> V_94 . V_97 ) ;
F_8 ( V_2 ,
V_7 + V_93 + 12 , & V_76 -> V_94 . V_98 ) ;
}
}
return 1 ;
}
static inline void F_57 ( struct V_74 * V_99 ,
struct V_10 * V_11 )
{
int V_100 ;
for ( V_100 = 0 ; V_100 < V_11 -> V_12 && V_11 -> V_2 [ V_100 ] ; V_100 ++ ) {
if ( F_55 ( V_11 -> V_2 [ V_100 ] , V_11 ) )
F_58 ( V_11 -> V_2 [ V_100 ] , V_11 ) ;
}
for ( V_100 = 0 ; V_100 < V_11 -> V_12 && V_11 -> V_2 [ V_100 ] ; V_100 ++ ) {
if ( F_55 ( V_11 -> V_2 [ V_100 ] , V_11 ) )
F_42 ( V_99 , V_11 -> V_2 [ V_100 ] , V_11 ) ;
}
}
static void F_59 ( struct V_74 * V_99 ,
struct V_101 * V_102 )
{
struct V_10 * V_11 ;
V_11 = F_60 ( sizeof( struct V_10 ) , V_103 ) ;
if ( ! V_11 ) {
...
if ( V_102 -> V_8 & V_105 ) {
V_11 -> V_18 = F_61 ( V_102 -> V_18 ) ;
V_11 -> V_24 = V_25 ;
if ( V_102 -> V_8 & V_106 )
V_11 -> V_22 = 1 ;
else
V_11 -> V_22 = 0 ;
F_62 ( V_99 -> V_104 , V_11 ) ;
if ( F_16 ( V_99 -> V_104 , V_11 ) )
F_57 ( V_99 , V_11 ) ;
}
if ( V_102 -> V_8 & V_107 ) {
V_11 -> V_18 = F_63 ( V_102 -> V_18 ) ;
if ( V_102 -> V_8 & V_108 )
V_11 -> V_24 = V_71 ;
else
V_11 -> V_24 = V_89 ;
...
static int F_65 ( struct V_110 * V_111 , struct V_101 * V_102 )
{
unsigned long V_78 ;
F_44 ( & V_111 -> V_112 , V_78 ) ;
if ( V_111 -> V_113 == V_111 -> V_114 ) {
F_50 ( & V_111 -> V_112 , V_78 ) ;
return 0 ;
}
...
{
struct V_110 * V_111 = F_67 ( V_85 , struct V_110 , V_117 ) ;
struct V_74 * V_99 = V_111 -> V_118 ;
struct V_101 V_119 ( V_102 ) ;
F_68 ( & V_111 -> V_120 ) ;
while ( F_65 ( V_111 , & V_102 ) )
F_59 ( V_99 , & V_102 ) ;
F_69 ( & V_111 -> V_120 ) ;
F_70 ( & V_111 -> V_121 ) ;
}
int F_71 ( struct V_74 * V_2 )
{
if ( V_122 ) {
F_18 ( V_33 , & V_2 -> V_60 ,
L_18 ) ;
