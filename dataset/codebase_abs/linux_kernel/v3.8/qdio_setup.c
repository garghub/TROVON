...
unsigned char V_73 ;
int V_32 ;
V_32 = F_24 ( V_8 , & V_8 -> V_92 , NULL ) ;
if ( V_32 ) {
F_29 ( L_7 , V_8 -> V_92 . V_97 ) ;
F_29 ( L_8 , V_32 ) ;
V_73 = V_74 | V_77 |
V_78 ;
} else
V_73 = V_8 -> V_114 . V_115 ;
F_23 ( V_8 , V_73 , V_8 -> V_114 . V_90 ) ;
F_22 ( V_8 , V_73 ) ;
F_18 ( L_9 , V_73 , V_8 -> V_114 . V_116 ) ;
F_18 ( L_10 , V_8 -> V_114 . V_117 , V_8 -> V_17 . V_118 ) ;
}
...
F_27 ( ( unsigned long ) V_8 -> V_123 ) ;
F_27 ( V_8 -> V_98 ) ;
F_27 ( ( unsigned long ) V_8 ) ;
}
...
F_32 ( V_8 , V_8 -> V_33 , V_15 , 0 ) ;
for ( V_15 = 0 ; V_15 < V_51 -> V_137 ; V_15 ++ )
F_32 ( V_8 , V_8 -> V_34 , V_15 ,
V_51 -> V_135 ) ;
}
...
V_143 -> V_12 ) ;
F_33 ( V_8 , V_143 ) ;
V_149 = F_38 ( V_143 -> V_150 , V_160 ) ;
if ( ! V_149 ) {
F_29 ( L_11 , V_8 -> V_92 . V_97 ) ;
V_32 = - V_113 ;
goto V_161;
}
V_8 -> V_162 = * V_149 ;
V_149 = F_38 ( V_143 -> V_150 , V_163 ) ;
if ( ! V_149 ) {
F_29 ( L_12 , V_8 -> V_92 . V_97 ) ;
V_32 = - V_113 ;
goto V_161;
}
V_8 -> V_164 = * V_149 ;
...
F_41 ( V_174 L_24 , V_168 ) ;
}
int F_42 ( struct V_175 * V_176 )
{
V_176 -> V_122 = F_43 ( sizeof( struct V_1 * ) * V_20 ,
V_3 ) ;
if ( ! V_176 -> V_122 ) {
V_176 -> V_120 = 0 ;
return - V_29 ;
...
{
int V_32 ;
V_27 = F_46 ( L_25 , sizeof( struct V_13 ) ,
256 , 0 , NULL ) ;
if ( ! V_27 )
return - V_29 ;
V_2 = F_46 ( L_26 ,
