...
static struct V_34 * T_5 F_66 ( struct V_159 * V_7 )
{
...
static void T_5 F_68 ( struct V_159 * V_169 )
{
struct V_34 * V_170 ;
struct V_34 * V_35 ;
int V_6 ;
...
static void T_5 F_75 ( struct V_159 * V_7 )
{
...
static void T_6 F_77 ( struct V_159 * V_7 )
{
struct V_154 * V_155 = & V_4 . V_40 ;
F_78 ( V_155 ) ;
}
static int T_5 F_79 ( struct V_159 * V_7 )
{
T_1 V_173 ;
struct V_174 * V_175 ;
struct V_176 * V_176 ;
...
V_4 . V_7 = V_7 ;
F_80 ( & V_4 . V_10 , 1 ) ;
V_175 = F_81 ( V_4 . V_7 , V_177 , 0 ) ;
if ( ! V_175 ) {
F_38 ( L_24 ) ;
return - V_98 ;
}
V_4 . V_5 = F_82 ( & V_7 -> V_8 , V_175 -> V_178 ,
F_83 ( V_175 ) ) ;
if ( ! V_4 . V_5 ) {
F_38 ( L_25 ) ;
return - V_179 ;
}
V_176 = F_84 ( & V_7 -> V_8 , L_26 ) ;
if ( F_85 ( V_176 ) ) {
F_38 ( L_27 ) ;
return F_86 ( V_176 ) ;
}
V_4 . V_52 = F_87 ( V_176 ) / 1000 ;
F_88 ( V_176 ) ;
F_89 ( & V_7 -> V_8 ) ;
V_6 = F_5 () ;
if ( V_6 )
...
static int T_6 F_95 ( struct V_159 * V_7 )
{
F_96 ( & V_7 -> V_8 ) ;
F_77 ( V_7 ) ;
F_94 ( & V_7 -> V_8 ) ;
...
static int F_97 ( struct V_181 * V_8 )
{
F_98 () ;
return 0 ;
}
static int F_99 ( struct V_181 * V_8 )
{
int V_6 ;
V_6 = F_100 () ;
if ( V_6 < 0 )
