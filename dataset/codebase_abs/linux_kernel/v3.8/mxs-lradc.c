...
V_8 -> V_47 [ V_46 ] = F_9 ( V_8 -> V_18 + F_6 ( V_46 ) ) ;
F_5 ( V_41 , V_8 -> V_18 + F_6 ( V_46 ) ) ;
V_8 -> V_47 [ V_46 ] &= V_27 ;
V_8 -> V_47 [ V_46 ] /= V_43 ;
V_46 ++ ;
}
if ( V_31 -> V_48 ) {
T_3 * V_49 = ( T_3 * ) ( ( V_50 * ) V_8 -> V_47 +
F_19 ( V_46 , sizeof( T_3 ) ) ) ;
* V_49 = V_39 -> V_49 ;
}
F_20 ( V_31 , ( V_50 * ) V_8 -> V_47 ) ;
F_21 ( V_31 -> V_35 ) ;
return V_36 ;
}
static int F_22 ( struct V_51 * V_35 , bool V_52 )
{
struct V_1 * V_31 = V_35 -> V_53 ;
struct V_7 * V_8 = F_2 ( V_31 ) ;
const T_2 V_54 = V_52 ? V_23 : V_20 ;
F_5 ( V_55 , V_8 -> V_18 + F_23 ( 0 ) + V_54 ) ;
return 0 ;
}
...
int V_9 ;
struct V_51 * V_35 ;
V_35 = F_25 ( L_1 , V_31 -> V_56 , V_31 -> V_57 ) ;
if ( V_35 == NULL )
return - V_58 ;
V_35 -> V_59 . V_60 = V_31 -> V_59 . V_60 ;
V_35 -> V_53 = V_31 ;
V_35 -> V_61 = & V_62 ;
V_9 = F_26 ( V_35 ) ;
if ( V_9 ) {
...
{
struct V_7 * V_8 = F_2 ( V_31 ) ;
struct V_63 * V_47 = V_31 -> V_47 ;
int V_9 = 0 , V_3 , V_64 = 0 , V_65 = 0 ;
T_2 V_66 = 0 ;
T_2 V_67 = 0 ;
const T_2 V_41 = V_42 |
( ( V_43 - 1 ) << V_44 ) ;
const int V_68 = F_31 ( V_47 -> V_69 , V_13 ) ;
if ( ! V_68 )
return - V_11 ;
V_9 = F_3 ( & V_8 -> V_14 ) ;
if ( ! V_9 )
return - V_15 ;
V_8 -> V_47 = F_32 ( V_68 * sizeof( * V_8 -> V_47 ) , V_70 ) ;
if ( ! V_8 -> V_47 ) {
V_9 = - V_58 ;
goto V_71;
}
...
V_8 -> V_18 + V_19 + V_20 ) ;
for ( V_45 = 0 ; V_45 < V_82 ; V_45 ++ )
F_5 ( 0 , V_8 -> V_18 + F_23 ( V_45 ) ) ;
}
static int F_41 ( struct V_85 * V_86 )
{
struct V_87 * V_59 = & V_86 -> V_59 ;
struct V_7 * V_8 ;
struct V_1 * V_31 ;
struct V_88 * V_89 ;
int V_9 = 0 ;
...
V_8 -> V_59 = & V_86 -> V_59 ;
V_8 -> V_18 = F_45 ( V_59 , V_89 ) ;
if ( ! V_8 -> V_18 ) {
V_9 = - V_91 ;
goto V_92;
}
for ( V_45 = 0 ; V_45 < 13 ; V_45 ++ ) {
V_8 -> V_29 [ V_45 ] = F_46 ( V_86 , V_45 ) ;
if ( V_8 -> V_29 [ V_45 ] < 0 ) {
V_9 = - V_11 ;
goto V_92;
}
V_9 = F_47 ( V_59 , V_8 -> V_29 [ V_45 ] ,
F_11 , 0 ,
V_93 [ V_45 ] , V_31 ) ;
if ( V_9 )
goto V_92;
