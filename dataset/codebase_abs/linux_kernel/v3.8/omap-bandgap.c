...
V_2 -> V_107 = F_60 ( NULL , V_2 -> V_12 -> V_108 ) ;
V_52 = F_58 ( V_2 -> V_107 ) ;
if ( V_52 ) {
F_17 ( & V_85 -> V_29 , L_22 ) ;
goto V_109;
}
V_2 -> V_110 = F_60 ( NULL , V_2 -> V_12 -> V_111 ) ;
V_52 = F_58 ( V_2 -> V_110 ) ;
if ( V_52 ) {
F_17 ( & V_85 -> V_29 ,
L_23 ) ;
...
T_1 V_5 ;
V_8 = V_2 -> V_12 -> V_14 [ V_9 ] . V_15 ;
V_5 = F_1 ( V_2 , V_8 -> V_112 ) ;
if ( V_52 || ! V_5 )
F_61 ( & V_85 -> V_29 ,
L_24 ) ;
}
V_78 = F_62 ( V_2 -> V_110 ,
V_2 -> V_12 -> V_14 [ 0 ] . V_39 -> V_113 ) ;
if ( V_78 < V_2 -> V_12 -> V_14 [ 0 ] . V_39 -> V_114 ||
V_78 == 0xffffffff ) {
V_52 = - V_115 ;
F_17 ( & V_85 -> V_29 , L_25 , V_78 ) ;
goto V_116;
}
V_52 = F_63 ( V_2 -> V_110 , V_78 ) ;
if ( V_52 )
F_17 ( & V_85 -> V_29 , L_26 ) ;
V_2 -> V_78 = V_78 ;
F_64 ( V_2 -> V_107 ) ;
...
{
struct V_1 * V_2 = F_71 ( V_85 ) ;
int V_9 ;
for ( V_9 = 0 ; V_9 < V_2 -> V_12 -> V_13 ; V_9 ++ ) {
if ( V_2 -> V_12 -> V_14 [ V_9 ] . V_118 )
V_2 -> V_12 -> V_14 [ V_9 ] . F_72 ( V_2 , V_9 ) ;
if ( V_2 -> V_12 -> V_121 )
...
static int F_75 ( struct V_129 * V_29 )
{
struct V_1 * V_2 = F_76 ( V_29 ) ;
int V_55 ;
V_55 = F_73 ( V_2 ) ;
F_5 ( V_2 , false ) ;
F_67 ( V_2 -> V_107 ) ;
...
static int F_77 ( struct V_129 * V_29 )
{
struct V_1 * V_2 = F_76 ( V_29 ) ;
F_64 ( V_2 -> V_107 ) ;
F_5 ( V_2 , true ) ;
