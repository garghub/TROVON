...
error = F_72 ( args -> V_51 , args -> V_22 , args -> V_101 ,
- 1 , & V_114 ) ;
if ( error )
return error ;
F_81 ( V_114 , args ) ;
...
F_89 ( V_76 ) ;
V_76 -> V_97 -> V_101 = 0 ;
error = F_72 ( NULL , V_76 -> V_22 , 0 , - 1 , & V_114 ) ;
if ( error )
return F_47 ( error ) ;
error = F_90 ( V_114 , V_76 ) ;
F_74 ( NULL , V_114 ) ;
return F_47 ( error ) ;
}
STATIC int
...
V_109 = F_76 ( V_124 -> V_114 , V_123 -> args ) ;
if ( V_109 == V_61 ) {
...
F_74 ( args -> V_51 , V_123 -> V_129 . V_124 [ V_139 ] . V_114 ) ;
...
V_114 = NULL ;
if ( V_97 -> V_101 > 0 ) {
error = F_106 ( NULL , V_76 -> V_22 , V_97 -> V_101 , - 1 ,
& V_114 , V_24 ) ;
if ( ( error != 0 ) && ( error != V_143 ) )
return ( error ) ;
if ( V_114 ) {
V_141 = V_114 -> V_144 ;
switch ( F_109 ( V_141 -> V_145 . V_146 . V_131 ) ) {
case V_147 :
F_110 ( V_76 ) ;
F_74 ( NULL , V_114 ) ;
V_114 = NULL ;
...
case V_132 :
V_140 = V_114 -> V_144 ;
if ( V_97 -> V_21 > F_111 ( V_140 -> V_148 [
F_109 ( V_140 -> V_145 . V_83 ) - 1 ] . V_21 ) ) {
F_110 ( V_76 ) ;
F_74 ( NULL , V_114 ) ;
V_114 = NULL ;
} else if ( V_97 -> V_21 <=
F_111 ( V_140 -> V_148 [ 0 ] . V_21 ) ) {
F_110 ( V_76 ) ;
F_74 ( NULL , V_114 ) ;
V_114 = NULL ;
}
...
V_97 -> V_101 = 0 ;
for (; ; ) {
error = F_106 ( NULL , V_76 -> V_22 ,
V_97 -> V_101 , - 1 , & V_114 ,
V_24 ) ;
if ( error )
return ( error ) ;
V_141 = V_114 -> V_144 ;
if ( V_141 -> V_145 . V_146 . V_131 ==
F_112 ( V_132 ) )
break;
if ( F_113 ( V_141 -> V_145 . V_146 . V_131 !=
F_112 ( V_147 ) ) ) {
F_114 ( L_1 ,
V_149 ,
V_76 -> V_22 -> V_28 ,
...
V_142 = V_141 -> V_142 ;
for ( V_139 = 0 ; V_139 < F_109 ( V_141 -> V_145 . V_83 ) ;
V_142 ++ , V_139 ++ ) {
if ( V_97 -> V_21
<= F_111 ( V_142 -> V_21 ) ) {
V_97 -> V_101 = F_111 ( V_142 -> V_150 ) ;
F_115 ( V_76 ,
V_142 ) ;
break;
}
}
if ( V_139 == F_109 ( V_141 -> V_145 . V_83 ) ) {
F_74 ( NULL , V_114 ) ;
return ( 0 ) ;
}
F_74 ( NULL , V_114 ) ;
...
if ( V_76 -> V_92 || V_140 -> V_145 . V_146 . V_151 == 0 )
break;
V_97 -> V_101 = F_111 ( V_140 -> V_145 . V_146 . V_151 ) ;
F_74 ( NULL , V_114 ) ;
...
void * V_155 ;
T_19 * V_114 ;
int V_156 , error , V_157 , V_20 , V_158 , V_139 ;
T_20 V_159 ;
F_116 ( args ) ;
...
while ( V_20 > 0 ) {
V_156 = V_153 ;
error = F_117 ( args -> V_22 , ( V_160 ) V_159 ,
args -> V_122 , V_152 , & V_156 ,
V_161 ) ;
if ( error )
return ( error ) ;
ASSERT ( V_156 >= 1 ) ;
for ( V_139 = 0 ; ( V_139 < V_156 ) && ( V_20 > 0 ) ; V_139 ++ ) {
ASSERT ( ( V_152 [ V_139 ] . V_162 != V_163 ) &&
( V_152 [ V_139 ] . V_162 != V_164 ) ) ;
V_154 = F_118 ( V_33 , V_152 [ V_139 ] . V_162 ) ;
V_158 = F_119 ( V_33 , V_152 [ V_139 ] . V_165 ) ;
error = F_120 ( V_33 , NULL , V_33 -> V_166 ,
V_154 , V_158 , 0 , & V_114 , NULL ) ;
if ( error )
return ( error ) ;
V_157 = F_121 ( int , V_20 , F_122 ( V_114 -> V_167 ) ) ;
F_123 ( V_114 , 0 , V_157 , V_155 , V_168 ) ;
F_124 ( V_114 ) ;
V_155 += V_157 ;
V_20 -= V_157 ;
V_159 += V_152 [ V_139 ] . V_165 ;
}
}
ASSERT ( V_20 == 0 ) ;
return ( 0 ) ;
...
V_169 = 0 ;
error = F_126 ( args -> V_51 , args -> V_22 , V_158 , & V_169 ,
V_24 ) ;
if ( error ) {
return ( error ) ;
}
...
F_35 ( args -> V_40 , args -> V_39 ) ;
V_156 = 1 ;
error = F_127 ( args -> V_51 , V_22 , ( V_160 ) V_159 ,
V_158 ,
V_161 | V_171 ,
...
ASSERT ( ( V_152 . V_162 != V_163 ) &&
( V_152 . V_162 != V_164 ) ) ;
V_154 = F_118 ( V_33 , V_152 . V_162 ) ,
V_158 = F_119 ( V_33 , V_152 . V_165 ) ;
V_114 = F_128 ( V_33 -> V_166 , V_154 , V_158 , 0 ) ;
if ( ! V_114 )
return V_173 ;
V_172 = F_122 ( V_114 -> V_167 ) ;
V_157 = F_121 ( int , V_20 , V_172 ) ;
F_123 ( V_114 , 0 , V_157 , V_170 , V_174 ) ;
if ( V_157 < V_172 )
F_129 ( V_114 , V_157 , V_172 - V_157 ) ;
error = F_130 ( V_114 ) ;
F_124 ( V_114 ) ;
if ( error )
return error ;
...
V_154 = F_118 ( V_33 , V_152 . V_162 ) ,
V_158 = F_119 ( V_33 , V_152 . V_165 ) ;
V_114 = F_132 ( V_33 -> V_166 , V_154 , V_158 , V_176 ) ;
if ( V_114 ) {
F_133 ( V_114 ) ;
F_124 ( V_114 ) ;
V_114 = NULL ;
...
while ( ! V_175 ) {
F_35 ( args -> V_40 , args -> V_39 ) ;
error = F_134 ( args -> V_51 , args -> V_22 , V_159 , V_158 ,
V_161 | V_171 ,
