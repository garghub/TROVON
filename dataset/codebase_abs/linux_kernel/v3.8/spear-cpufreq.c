...
V_2 -> V_28 = F_3 ( 0 ) ;
F_23 ( V_2 -> V_29 , F_24 ( V_2 -> V_5 ) ) ;
F_23 ( V_2 -> V_30 , V_2 -> V_29 ) ;
return 0 ;
}
...
& V_3 . V_27 ) )
V_3 . V_27 = V_40 ;
V_34 = F_30 ( V_32 , L_17 , NULL ) ;
if ( ! V_34 || ! V_34 -> V_41 ) {
F_9 ( L_18 ) ;
V_13 = - V_39 ;
goto V_42;
}
V_37 = V_34 -> V_43 / sizeof( V_44 ) ;
V_36 = V_34 -> V_41 ;
V_4 = F_31 ( sizeof( * V_4 ) * ( V_37 + 1 ) , V_45 ) ;
if ( ! V_4 ) {
V_13 = - V_46 ;
goto V_42;
}
