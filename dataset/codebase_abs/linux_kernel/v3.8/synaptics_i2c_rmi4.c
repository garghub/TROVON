...
if ( ! V_146 ) {
F_3 ( & V_41 -> V_12 , L_17 , V_13 ) ;
return - V_150 ;
}
V_144 = F_32 ( sizeof( struct V_1 ) * 2 ,
V_128 ) ;
if ( ! V_144 ) {
F_3 ( & V_41 -> V_12 , L_18 , V_13 ) ;
return - V_129 ;
}
V_144 -> V_42 = F_33 () ;
if ( V_144 -> V_42 == NULL ) {
...
V_144 -> V_152 = F_34 ( & V_41 -> V_12 , L_20 ) ;
if ( F_35 ( V_144 -> V_152 ) ) {
F_3 ( & V_41 -> V_12 , L_21 ,
V_13 ) ;
