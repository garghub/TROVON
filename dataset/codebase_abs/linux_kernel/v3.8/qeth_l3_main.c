...
return ( F_198 ( V_251 ) [ 24 ] == 0xff ) ?
V_129 : 0 ;
else if ( V_251 -> V_278 == V_260 )
return ( ( F_198 ( V_251 ) [ 16 ] & 0xf0 ) == 0xe0 ) ?
V_129 : 0 ;
...
static void F_201 ( struct V_27 * V_28 , struct V_252 * V_144 ,
...
V_144 -> V_144 . V_258 . V_253 = F_203 ( V_251 ) ;
}
...
struct V_51 * V_447 = & F_204 ( V_251 ) -> V_262 ;
if ( ! F_205 ( & V_446 -> V_450 ) )
V_447 = & V_446 -> V_450 ;
...
struct V_458 * V_459 = F_208 ( V_251 ) ;
struct V_254 * V_451 = V_255 ( V_251 ) ;
struct V_460 * V_461 = F_204 ( V_251 ) ;
...
V_144 -> V_463 . V_470 = F_209 ( V_251 ) -> V_471 ;
...
if ( V_251 -> V_278 == V_259 ) {
V_461 -> V_475 = 0 ;
V_459 -> V_454 = ~ F_210 ( & V_461 -> V_476 , & V_461 -> V_262 ,
0 , V_477 , 0 ) ;
} else {
V_459 -> V_454 = ~ F_211 ( V_451 -> V_476 , V_451 -> V_262 ,
0 , V_477 , 0 ) ;
V_451 -> V_478 = 0 ;
V_451 -> V_454 = 0 ;
}
}
static inline int F_212 ( struct V_250 * V_251 )
{
unsigned long V_479 = ( unsigned long ) F_208 ( V_251 ) +
F_208 ( V_251 ) -> V_474 * 4 ;
int V_480 = V_251 -> V_23 - ( V_479 - ( unsigned long ) V_251 -> V_85 ) ;
int V_481 = F_213 ( V_479 + V_480 - 1 ) - F_214 ( V_479 ) ;
V_481 += F_209 ( V_251 ) -> V_482 ;
return V_481 ;
}
static int F_215 ( struct V_250 * V_251 , struct V_218 * V_125 )
{
int V_4 ;
T_4 * V_483 ;
...
V_492 = V_500 ;
V_144 = F_219 ( V_501 , V_61 ) ;
if ( ! V_144 )
goto V_495;
V_484 ++ ;
} else {
V_486 = F_220 ( V_251 , sizeof( struct V_457 )
+ V_502 ) ;
if ( ! V_486 )
goto V_495;
}
...
if ( V_444 != 4 && F_202 ( V_486 ) ) {
F_221 ( V_486 , V_502 ) ;
F_222 ( V_486 , V_486 -> V_85 + 4 , 4 ) ;
F_223 ( V_486 , 4 ,
V_486 -> V_85 + 8 , 4 ) ;
F_223 ( V_486 , 8 ,
V_486 -> V_85 + 12 , 4 ) ;
...
V_144 = (struct V_252 * ) F_221 ( V_486 ,
sizeof( struct V_457 ) ) ;
memset ( V_144 , 0 , sizeof( struct V_457 ) ) ;
F_201 ( V_28 , V_144 , V_486 , V_444 , V_128 ) ;
...
V_144 = (struct V_252 * ) F_221 ( V_486 ,
sizeof( struct V_252 ) ) ;
F_201 ( V_28 , V_144 , V_486 , V_444 ,
V_128 ) ;
} else {
if ( V_486 -> V_278 == V_300 )
F_199 ( V_28 , V_144 , V_486 ) ;
else {
F_201 ( V_28 , V_144 , V_486 , V_444 ,
V_128 ) ;
...
V_485 = F_226 ( V_28 , ( void * ) V_144 , V_486 ,
V_484 ) ;
if ( ! V_485 ) {
if ( V_492 >= 0 )
F_227 ( V_501 , V_144 ) ;
...
V_484 += V_485 ;
V_482 = F_209 ( V_486 ) -> V_482 ;
if ( V_28 -> V_99 . type != V_100 ) {
int V_23 ;
if ( V_491 )
V_23 = ( ( unsigned long ) F_208 ( V_486 ) +
F_208 ( V_486 ) -> V_474 * 4 ) -
...
V_4 = F_230 ( V_28 , V_488 , V_486 , V_144 ,
V_484 , V_492 , 0 ) ;
if ( ! V_4 ) {
V_28 -> V_265 . V_507 ++ ;
...
static int F_232 ( struct V_218 * V_125 )
{
struct V_27 * V_28 = V_125 -> V_246 ;
int V_4 = 0 ;
F_17 ( V_28 , 4 , L_172 ) ;
...
static int F_236 ( struct V_218 * V_125 )
{
struct V_27 * V_28 = V_125 -> V_246 ;
F_17 ( V_28 , 5 , L_173 ) ;
if ( F_130 ( V_28 , V_248 ) ) {
...
static T_8 F_239 ( struct V_218 * V_125 ,
T_8 V_187 )
{
struct V_27 * V_28 = V_125 -> V_246 ;
if ( ! F_53 ( V_28 , V_158 ) )
...
static int F_240 ( struct V_218 * V_125 ,
T_8 V_187 )
{
struct V_27 * V_28 = V_125 -> V_246 ;
...
static int F_241 ( struct V_429 * V_430 )
{
V_430 -> V_523 = V_524 ;
...
static int
F_242 ( struct V_218 * V_125 , struct V_529 * V_530 )
{
if ( V_530 -> V_531 -> V_532 == V_533 )
V_530 -> V_534 = F_241 ;
return 0 ;
}
static int F_243 ( struct V_27 * V_28 )
{
if ( V_28 -> V_99 . type == V_420 ||
V_28 -> V_99 . type == V_421 ) {
...
V_28 -> V_125 = F_246 ( 0 , L_177 , V_540 ) ;
if ( ! V_28 -> V_125 )
return - V_407 ;
...
F_247 ( V_28 -> V_125 , & V_549 ) ;
V_28 -> V_125 -> V_187 |= V_550 |
V_551 |
V_552 ;
V_28 -> V_125 -> V_553 &= ~ V_554 ;
V_28 -> V_125 -> V_555 = 15 * V_556 ;
F_248 ( V_28 -> V_125 , & V_28 -> V_124 -> V_125 ) ;
F_249 ( V_28 -> V_125 , & V_28 -> V_303 , F_145 , V_557 ) ;
return F_250 ( V_28 -> V_125 ) ;
}
static int F_251 ( struct V_558 * V_124 )
{
struct V_27 * V_28 = F_252 ( & V_124 -> V_125 ) ;
F_253 ( & V_124 -> V_125 ) ;
V_28 -> V_43 . V_329 = 0 ;
V_28 -> V_99 . V_559 = 0 ;
return 0 ;
}
static void F_254 ( struct V_558 * V_560 )
{
struct V_27 * V_28 = F_252 ( & V_560 -> V_125 ) ;
F_255 ( & V_560 -> V_125 ) ;
F_162 ( V_28 , 0 , 1 ) ;
F_256 ( V_28 -> V_561 , F_172 ( V_28 , 0xffffffff ) == 0 ) ;
if ( V_560 -> V_71 == V_562 )
F_257 ( V_560 ) ;
if ( V_28 -> V_125 ) {
F_258 ( V_28 -> V_125 ) ;
...
static int F_259 ( struct V_558 * V_124 , int V_330 )
{
struct V_27 * V_28 = F_252 ( & V_124 -> V_125 ) ;
int V_4 = 0 ;
enum V_563 V_564 ;
...
V_4 = F_261 ( V_28 ) ;
if ( V_4 ) {
F_262 ( V_139 , 2 , L_179 , V_4 ) ;
V_4 = - V_407 ;
goto V_567;
}
F_263 ( V_28 ) ;
if ( ! V_28 -> V_125 && F_243 ( V_28 ) ) {
V_4 = - V_407 ;
goto V_567;
}
if ( F_264 ( V_28 , V_568 ) ) {
...
V_4 = F_95 ( V_28 ) ;
if ( V_4 )
F_262 ( V_139 , 2 , L_183 , V_4 ) ;
V_4 = F_48 ( V_28 ) ;
if ( V_4 )
F_262 ( V_139 , 2 , L_184 , V_4 ) ;
V_4 = F_51 ( V_28 ) ;
if ( V_4 )
F_262 ( V_139 , 2 , L_185 , V_4 ) ;
}
F_237 ( V_28 -> V_125 ) ;
V_4 = F_268 ( V_28 ) ;
if ( V_4 ) {
F_262 ( V_139 , 2 , L_186 , V_4 ) ;
V_4 = - V_407 ;
goto V_567;
}
V_28 -> V_71 = V_73 ;
...
static int F_278 ( struct V_558 * V_124 )
{
return F_259 ( V_124 , 0 ) ;
}
static int F_279 ( struct V_558 * V_560 ,
int V_330 )
{
struct V_27 * V_28 = F_252 ( & V_560 -> V_125 ) ;
...
if ( V_28 -> V_125 && F_280 ( V_28 -> V_125 ) )
F_270 ( V_28 -> V_125 ) ;
V_564 = V_28 -> V_71 ;
...
F_90 () ;
F_281 ( V_577 , V_28 -> V_125 ) ;
F_92 () ;
}
V_4 = F_274 ( F_275 ( V_28 ) ) ;
V_574 = F_274 ( F_276 ( V_28 ) ) ;
V_575 = F_274 ( F_277 ( V_28 ) ) ;
if ( ! V_4 )
...
if ( V_564 == V_72 )
V_28 -> V_71 = V_522 ;
F_272 ( & V_560 -> V_125 . V_572 , V_573 ) ;
F_273 ( & V_28 -> V_566 ) ;
F_273 ( & V_28 -> V_565 ) ;
return 0 ;
}
static int F_257 ( struct V_558 * V_560 )
{
return F_279 ( V_560 , 0 ) ;
}
static int F_282 ( void * V_578 )
{
struct V_27 * V_28 ;
int V_4 = 0 ;
...
static void F_287 ( struct V_558 * V_124 )
{
struct V_27 * V_28 = F_252 ( & V_124 -> V_125 ) ;
F_162 ( V_28 , 0 , 1 ) ;
...
static int F_288 ( struct V_558 * V_124 )
{
struct V_27 * V_28 = F_252 ( & V_124 -> V_125 ) ;
if ( V_28 -> V_125 )
F_289 ( V_28 -> V_125 ) ;
...
static int F_290 ( struct V_558 * V_124 )
{
struct V_27 * V_28 = F_252 ( & V_124 -> V_125 ) ;
int V_4 = 0 ;
if ( V_124 -> V_71 == V_579 )
...
static int F_292 ( struct V_580 * V_581 ,
...
static int F_294 ( struct V_580 * V_581 ,
unsigned long V_582 , void * V_578 )
{
