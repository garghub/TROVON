...
V_3 -> V_24 |= V_64 ;
if ( V_70 -> V_88 == V_91 )
V_3 -> V_49 -> V_127 = V_128 ;
switch ( V_70 -> V_81 ) {
case 8 :
V_3 -> V_49 -> V_127 |= V_129 ;
case 4 :
V_3 -> V_49 -> V_127 |= V_130 ;
break;
}
if ( V_70 -> V_131 )
V_3 -> V_49 -> V_131 |= V_70 -> V_131 ;
V_3 -> V_24 |= ( V_132 |
V_133 ) ;
V_3 -> V_24 |= V_134 ;
if ( V_3 -> V_24 & V_25 ) {
...
if ( V_70 -> V_138 )
V_3 -> V_49 -> V_127 |= V_70 -> V_138 ;
if ( V_70 -> V_139 )
V_3 -> V_49 -> V_140 |= V_70 -> V_139 ;
F_67 ( & V_12 -> V_13 ) ;
F_68 ( & V_12 -> V_13 , 50 ) ;
F_69 ( & V_12 -> V_13 ) ;
F_70 ( & V_12 -> V_13 , 1 ) ;
