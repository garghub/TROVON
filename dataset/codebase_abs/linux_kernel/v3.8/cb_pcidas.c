...
break;
default:
V_90 |= F_46 ( & V_89 -> V_105 , 0 ) ;
break;
}
if ( V_89 -> V_97 == V_99 )
V_90 |= F_47 ( & V_89 -> V_110 ,
V_83 -> V_111 * V_89 -> V_112 ) ;
if ( V_89 -> V_100 == V_99 )
V_90 |= F_47 ( & V_89 -> V_113 ,
V_83 -> V_111 ) ;
V_90 |= F_46 ( & V_89 -> V_114 , V_89 -> V_112 ) ;
if ( V_89 -> V_103 == V_104 )
V_90 |= F_46 ( & V_89 -> V_115 , 0 ) ;
if ( V_90 )
return 3 ;
if ( V_89 -> V_97 == V_99 ) {
V_91 = V_89 -> V_110 ;
...
static void F_49 ( struct V_3 * V_4 , unsigned int * V_122 ,
int V_123 )
{
struct V_5 * V_6 = V_4 -> V_7 ;
F_48 ( V_116 , & ( V_6 -> V_117 ) ,
& ( V_6 -> V_118 ) , V_122 ,
V_123 & V_119 ) ;
F_50 ( V_6 -> V_124 + V_125 , 0 , 1 ,
V_6 -> V_117 , 2 ) ;
F_50 ( V_6 -> V_124 + V_125 , 0 , 2 ,
V_6 -> V_118 , 2 ) ;
}
...
V_156 = V_6 -> V_158 ;
V_155 = F_55 ( V_11 , V_6 -> V_159 ,
V_156 * sizeof( short ) ) ;
V_156 = V_155 / sizeof( short ) ;
if ( V_89 -> V_103 == V_102 )
V_6 -> V_158 -= V_156 ;
F_56 ( V_6 -> V_46 + V_50 , V_6 -> V_159 , V_155 ) ;
F_19 ( & V_4 -> V_40 , V_39 ) ;
...
& ( V_89 -> V_110 ) ,
V_89 -> V_39 ) ;
F_50 ( V_6 -> V_124 + V_166 , 0 , 1 ,
V_6 -> V_151 , 2 ) ;
F_50 ( V_6 -> V_124 + V_166 , 0 , 2 ,
V_6 -> V_152 , 2 ) ;
}
if ( V_89 -> V_103 == V_102 )
...
static void F_59 ( struct V_3 * V_4 , unsigned int V_169 )
{
const struct V_82 * V_83 = F_40 ( V_4 ) ;
struct V_5 * V_6 = V_4 -> V_7 ;
...
static T_2 F_61 ( int V_175 , void * V_176 )
{
...
V_127 = V_11 -> V_127 ;
V_127 -> V_172 = 0 ;
V_178 = F_62 ( V_6 -> V_57 + V_182 ) ;
if ( ( V_183 & V_178 ) == 0 )
return V_181 ;
F_63 ( V_6 -> V_57 + V_184 ) ;
F_64 ( V_6 -> V_185 | V_186 ,
V_6 -> V_57 + V_182 ) ;
...
static const void * F_68 ( struct V_3 * V_4 ,
struct V_193 * V_194 )
{
const struct V_82 * V_83 ;
int V_20 ;
for ( V_20 = 0 ; V_20 < F_69 ( V_195 ) ; V_20 ++ ) {
V_83 = & V_195 [ V_20 ] ;
...
return - V_200 ;
V_4 -> V_201 = V_83 ;
V_4 -> V_202 = V_83 -> V_203 ;
V_6 = F_72 ( sizeof( * V_6 ) , V_204 ) ;
if ( ! V_6 )
return - V_205 ;
V_4 -> V_7 = V_6 ;
V_199 = F_73 ( V_194 , V_4 -> V_202 ) ;
if ( V_199 )
return V_199 ;
V_6 -> V_57 = F_74 ( V_194 , 0 ) ;
V_6 -> V_22 = F_74 ( V_194 , 1 ) ;
V_6 -> V_29 = F_74 ( V_194 , 2 ) ;
V_6 -> V_124 = F_74 ( V_194 , 3 ) ;
if ( V_83 -> V_206 )
V_6 -> V_46 = F_74 ( V_194 , 4 ) ;
F_64 ( V_186 ,
V_6 -> V_57 + V_182 ) ;
if ( F_75 ( V_194 -> V_175 , F_61 ,
V_207 , V_4 -> V_208 -> V_209 , V_4 ) ) {
F_76 ( V_4 -> V_37 , L_12 ,
V_194 -> V_175 ) ;
return - V_38 ;
}
...
V_4 -> V_177 = V_11 ;
V_11 -> type = V_211 ;
V_11 -> V_212 = V_213 | V_214 | V_215 | V_216 ;
V_11 -> V_121 = V_83 -> V_217 ;
V_11 -> V_218 = V_83 -> V_217 ;
V_11 -> V_219 = ( 1 << V_83 -> V_220 ) - 1 ;
V_11 -> V_221 = V_83 -> V_222 ;
V_11 -> V_223 = F_7 ;
V_11 -> V_224 = F_16 ;
V_11 -> V_225 = F_51 ;
V_11 -> V_226 = F_43 ;
...
if ( V_83 -> V_206 ) {
V_11 -> type = V_228 ;
V_11 -> V_212 = V_213 | V_229 | V_214 ;
V_11 -> V_121 = V_83 -> V_206 ;
V_11 -> V_219 = ( 1 << V_83 -> V_220 ) - 1 ;
V_11 -> V_221 = & V_230 ;
V_11 -> V_223 = F_22 ;
if ( V_83 -> V_231 ) {
...
V_11 = & V_4 -> V_210 [ 2 ] ;
V_199 = F_78 ( V_4 , V_11 , NULL ,
V_6 -> V_124 + V_235 ) ;
if ( V_199 )
return V_199 ;
V_11 = & V_4 -> V_210 [ 3 ] ;
V_11 -> type = V_236 ;
V_11 -> V_212 = V_213 | V_237 ;
V_11 -> V_121 = 256 ;
V_11 -> V_219 = 0xff ;
V_11 -> V_223 = F_28 ;
V_11 = & V_4 -> V_210 [ 4 ] ;
V_11 -> type = V_238 ;
V_11 -> V_212 = V_213 | V_229 | V_237 ;
V_11 -> V_121 = V_239 ;
V_11 -> V_219 = 0xff ;
V_11 -> V_223 = F_33 ;
V_11 -> V_233 = F_32 ;
for ( V_20 = 0 ; V_20 < V_11 -> V_121 ; V_20 ++ )
F_30 ( V_4 , V_20 , V_11 -> V_219 / 2 ) ;
V_11 = & V_4 -> V_210 [ 5 ] ;
V_11 -> type = V_238 ;
V_11 -> V_212 = V_213 | V_229 | V_237 ;
if ( V_83 -> V_85 == V_86 ) {
...
F_83 ( V_4 -> V_175 , V_4 ) ;
if ( V_4 -> V_210 )
F_84 ( V_4 , & V_4 -> V_210 [ 2 ] ) ;
if ( V_194 ) {
if ( V_6 -> V_57 )
F_85 ( V_194 ) ;
}
}
static int F_86 ( struct V_193 * V_4 ,
const struct V_245 * V_246 )
{
return F_87 ( V_4 , & V_247 ) ;
}
static void F_88 ( struct V_193 * V_4 )
{
F_89 ( V_4 ) ;
}
