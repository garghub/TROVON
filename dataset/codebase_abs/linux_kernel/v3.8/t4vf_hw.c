...
int V_240 , const T_3 * V_36 , bool V_258 )
{
int V_102 ;
struct V_245 V_14 , V_9 ;
...
bool V_260 , T_7 V_261 , bool V_15 )
{
struct V_245 V_14 ;
T_4 V_105 = F_39 ( F_40 ( struct V_245 ,
V_84 . V_248 [ 0 ] ) , 16 ) ;
...
T_4 V_273 = ( F_40 ( struct V_272 , V_84 ) +
sizeof( struct V_274 ) ) ;
T_4 V_105 = F_39 ( V_273 , 16 ) ;
int V_102 ;
memset ( & V_14 , 0 , sizeof( V_14 ) ) ;
...
if ( V_102 )
return V_102 ;
memcpy ( V_269 , & V_9 . V_84 . V_276 . V_278 , sizeof( T_2 ) * V_271 ) ;
V_244 -= V_271 ;
V_269 += V_271 ;
}
...
int F_107 ( struct V_1 * V_1 , const T_2 * V_9 )
{
const struct V_308 * V_309 = ( const struct V_308 * ) V_9 ;
T_3 V_310 = F_108 ( F_19 ( V_309 -> V_311 ) ) ;
switch ( V_310 ) {
case V_81 : {
