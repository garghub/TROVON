...
static int F_21 ( struct V_16 * V_16 , T_2 V_47 , T_2 V_48 , int V_49 )
{
struct V_50 * V_50 = V_16 -> V_51 . V_52 -> V_53 ;
int V_54 ;
F_8 ( & V_50 -> V_22 ) ;
V_54 = F_5 ( V_19 ) ;
F_9 ( & V_50 -> V_22 ) ;
...
static T_7 F_22 ( int V_55 , void * V_56 )
{
struct V_1 * V_2 = V_56 ;
int V_8 ;
T_1 V_15 , V_57 ;
V_8 = F_23 ( V_2 -> V_7 . V_58 , & V_15 , & V_57 ) ;
if ( V_15 != V_2 -> V_15 )
F_4 ( & V_2 -> V_7 . V_11 ,
L_9 ,
...
{
struct V_1 * V_2 = F_26 ( & V_63 -> V_11 ) ;
struct V_5 * V_6 ;
int error ;
unsigned long V_64 ;
V_64 = V_2 -> V_24 [ V_2 -> V_25 ] . V_47 * V_2 -> V_27 ;
if ( V_64 % V_65 ) {
F_4 ( & V_2 -> V_7 . V_11 ,
L_11 , V_12 ,
__LINE__ , V_64 ) ;
...
V_64 = V_2 -> V_24 [ V_2 -> V_25 ] . V_26 * V_2 -> V_27 ;
if ( V_64 % V_65 ) {
F_4 ( & V_2 -> V_7 . V_11 ,
L_12 , V_12 ,
__LINE__ , V_64 ) ;
