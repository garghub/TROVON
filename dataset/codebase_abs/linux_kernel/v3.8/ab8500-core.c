...
static int F_55 ( struct V_80 * V_81 )
{
static char * V_82 [] = {
L_14 ,
L_15 ,
...
L_20 ,
L_21 } ;
struct V_83 * V_84 = F_56 ( & V_81 -> V_5 ) ;
const struct V_85 * V_86 = F_57 ( V_81 ) ;
enum V_87 V_88 = V_89 ;
...
int V_24 ;
T_2 V_15 ;
V_1 = F_58 ( & V_81 -> V_5 , sizeof *V_1 , V_92 ) ;
if ( ! V_1 )
return - V_93 ;
if ( V_84 )
V_1 -> V_39 = V_84 -> V_39 ;
V_1 -> V_5 = & V_81 -> V_5 ;
V_91 = F_59 ( V_81 , V_94 , 0 ) ;
if ( ! V_91 )
return - V_95 ;
V_1 -> V_46 = V_91 -> V_96 ;
V_1 -> V_17 = F_6 ;
...
V_1 -> V_6 = F_58 ( & V_81 -> V_5 , V_1 -> V_25 , V_92 ) ;
if ( ! V_1 -> V_6 )
return - V_93 ;
V_1 -> V_27 = F_58 ( & V_81 -> V_5 , V_1 -> V_25 , V_92 ) ;
if ( ! V_1 -> V_27 )
return - V_93 ;
V_4 = F_17 ( V_1 , V_71 ,
V_72 , & V_15 ) ;
if ( V_4 < 0 )
return V_4 ;
F_54 ( V_1 -> V_5 , L_23 , V_15 ) ;
if ( V_15 ) {
for ( V_24 = 0 ; V_24 < F_63 ( V_82 ) ; V_24 ++ ) {
if ( V_15 & 1 )
F_64 ( V_106 L_24 ,
V_82 [ V_24 ] ) ;
V_15 = V_15 >> 1 ;
...
return V_4 ;
if ( F_44 ( V_1 ) ) {
V_4 = F_66 ( & V_81 -> V_5 , V_1 -> V_46 , NULL ,
F_32 ,
V_109 | V_110 ,
L_27 , V_1 ) ;
}
...
V_4 = F_67 ( V_1 -> V_5 , 0 , V_111 ,
F_63 ( V_111 ) , NULL ,
V_1 -> V_39 , V_1 -> V_50 ) ;
if ( V_4 )
return V_4 ;
if ( F_44 ( V_1 ) )
V_4 = F_67 ( V_1 -> V_5 , 0 , V_112 ,
F_63 ( V_112 ) , NULL ,
V_1 -> V_39 , V_1 -> V_50 ) ;
else
V_4 = F_67 ( V_1 -> V_5 , 0 , V_113 ,
F_63 ( V_113 ) , NULL ,
V_1 -> V_39 , V_1 -> V_50 ) ;
if ( V_4 )
return V_4 ;
if ( F_44 ( V_1 ) || F_45 ( V_1 ) )
V_4 = F_67 ( V_1 -> V_5 , 0 , V_114 ,
F_63 ( V_114 ) , NULL ,
V_1 -> V_39 , V_1 -> V_50 ) ;
if ( V_4 )
return V_4 ;
if ( ! V_115 ) {
V_4 = F_67 ( V_1 -> V_5 , 0 , V_116 ,
F_63 ( V_116 ) , NULL ,
V_1 -> V_39 , V_1 -> V_50 ) ;
if ( V_4 )
F_3 ( V_1 -> V_5 , L_28 ) ;
...
{
struct V_1 * V_1 = F_70 ( V_81 ) ;
if ( F_44 ( V_1 ) )
F_71 ( & V_1 -> V_5 -> V_117 , & V_118 ) ;
else
F_71 ( & V_1 -> V_5 -> V_117 , & V_119 ) ;
F_72 ( V_1 -> V_5 ) ;
return 0 ;
}
