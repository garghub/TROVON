...
{
struct V_19 * V_20 = F_23 ( V_40 ) ;
F_24 ( V_20 ) ;
F_11 ( V_20 ) ;
F_21 ( V_20 ) ;
return 0 ;
}
static int F_25 ( struct V_60 * V_43 )
{
struct V_19 * V_20 = F_26 ( V_43 ) ;
struct V_1 * V_7 = F_14 ( V_20 ) ;
...
static int F_28 ( struct V_60 * V_43 )
{
struct V_19 * V_20 = F_26 ( V_43 ) ;
struct V_1 * V_7 = F_14 ( V_20 ) ;
unsigned int V_65 ;
