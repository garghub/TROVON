...
static T_1
F_53 ( struct V_61 * V_81 , char T_2 * V_62 , T_3 V_63 ,
T_4 * V_64 )
{
struct V_2 * V_20 = V_81 -> V_82 ;
char * V_60 ;
if ( V_20 -> V_44 & V_45 )
V_60 = L_6 ;
else
V_60 = L_7 ;
return F_54 ( V_62 , V_63 , V_64 , V_60 , 2 ) ;
}
static T_1
F_55 ( struct V_61 * V_81 , const char T_2 * V_62 , T_3 V_63 ,
T_4 * V_64 )
{
struct V_2 * V_20 = V_81 -> V_82 ;
unsigned long V_83 ;
int V_21 ;
V_21 = F_56 ( V_62 , V_63 , 10 , & V_83 ) ;
if ( V_21 )
return V_21 ;
V_21 = F_39 () ;
if ( V_21 < 0 )
...
static T_1
F_57 ( struct V_61 * V_81 , char T_2 * V_62 , T_3 V_63 ,
T_4 * V_64 )
{
const char V_84 [ 4 ] = { '?' , '0' , '1' , 'X' } ;
struct V_50 * system = V_81 -> V_82 ;
struct V_2 * V_20 ;
char V_60 [ 2 ] ;
int V_57 = 0 ;
int V_21 ;
...
V_60 [ 0 ] = V_84 [ V_57 ] ;
V_60 [ 1 ] = '\n' ;
V_21 = F_54 ( V_62 , V_63 , V_64 , V_60 , 2 ) ;
return V_21 ;
}
static T_1
F_58 ( struct V_61 * V_81 , const char T_2 * V_62 , T_3 V_63 ,
T_4 * V_64 )
{
struct V_50 * system = V_81 -> V_82 ;
const char * V_8 = NULL ;
...
static void * F_59 ( struct V_72 * V_73 , void * V_74 , T_4 * V_75 )
{
struct V_2 * V_20 = V_73 -> V_86 ;
struct V_13 * V_14 ;
...
if ( F_60 ( F_61 ( V_7 ) ) )
return NULL ;
V_14 = F_47 ( V_7 -> V_90 , struct V_13 , V_18 ) ;
return V_14 ;
case V_92 :
return NULL ;
}
V_14 = V_74 ;
if ( V_14 -> V_18 . V_90 == V_87 )
return ( void * ) V_91 ;
else if ( V_14 -> V_18 . V_90 == V_7 )
return ( void * ) V_92 ;
V_14 = F_47 ( V_14 -> V_18 . V_90 , struct V_13 , V_18 ) ;
return V_14 ;
}
static void * F_62 ( struct V_72 * V_73 , T_4 * V_75 )
{
T_4 V_76 = 0 ;
void * V_80 ;
if ( ! * V_75 )
...
V_80 = ( void * ) V_89 ;
do {
V_80 = F_59 ( V_73 , V_80 , & V_76 ) ;
} while ( V_80 && V_76 < * V_75 );
return V_80 ;
}
static int F_63 ( struct V_72 * V_73 , void * V_74 )
{
struct V_2 * V_20 = V_73 -> V_86 ;
struct V_13 * V_14 ;
const char * V_93 ;
...
static void F_65 ( struct V_72 * V_73 , void * V_80 )
{
}
static int F_66 ( struct V_95 * V_95 , struct V_61 * V_61 )
{
struct V_2 * V_20 = V_95 -> V_96 ;
struct V_72 * V_73 ;
int V_21 ;
V_21 = F_67 ( V_61 , & V_97 ) ;
if ( V_21 < 0 )
...
static T_1
F_68 ( struct V_61 * V_81 , char T_2 * V_62 , T_3 V_63 , T_4 * V_64 )
{
struct V_2 * V_20 = V_81 -> V_82 ;
struct V_98 * V_99 ;
int V_100 ;
if ( * V_64 )
return 0 ;
V_99 = F_69 ( sizeof( * V_99 ) , V_15 ) ;
if ( ! V_99 )
return - V_19 ;
F_70 ( V_99 ) ;
F_71 ( V_99 , L_15 , V_20 -> V_28 . type ) ;
V_100 = F_54 ( V_62 , V_63 , V_64 ,
V_99 -> V_69 , V_99 -> V_101 ) ;
F_7 ( V_99 ) ;
return V_100 ;
}
static T_1
F_72 ( struct V_61 * V_81 , char T_2 * V_62 , T_3 V_63 ,
T_4 * V_64 )
{
struct V_2 * V_20 = V_81 -> V_82 ;
struct V_98 * V_99 ;
...
F_70 ( V_99 ) ;
F_73 ( V_20 , V_99 ) ;
V_100 = F_54 ( V_62 , V_63 , V_64 , V_99 -> V_69 , V_99 -> V_101 ) ;
F_7 ( V_99 ) ;
return V_100 ;
}
static T_1
F_74 ( struct V_61 * V_81 , const char T_2 * V_62 , T_3 V_63 ,
T_4 * V_64 )
{
struct V_2 * V_20 = V_81 -> V_82 ;
char * V_60 ;
...
if ( V_63 >= V_102 )
return - V_58 ;
V_60 = ( char * ) F_75 ( V_103 ) ;
if ( ! V_60 )
return - V_19 ;
if ( F_76 ( V_60 , V_62 , V_63 ) ) {
F_77 ( ( unsigned long ) V_60 ) ;
return - V_104 ;
}
V_60 [ V_63 ] = '\0' ;
V_16 = F_78 ( V_20 , V_60 ) ;
...
static int F_79 ( struct V_95 * V_95 , struct V_61 * V_81 )
{
...
static int F_81 ( struct V_95 * V_95 , struct V_61 * V_61 )
{
struct V_50 * system = V_95 -> V_96 ;
if ( system )
F_33 ( system ) ;
return 0 ;
}
static T_1
F_82 ( struct V_61 * V_81 , char T_2 * V_62 , T_3 V_63 ,
T_4 * V_64 )
{
struct V_50 * system = V_81 -> V_82 ;
struct V_98 * V_99 ;
...
static T_1
F_84 ( struct V_61 * V_81 , const char T_2 * V_62 , T_3 V_63 ,
T_4 * V_64 )
{
struct V_50 * system = V_81 -> V_82 ;
char * V_60 ;
...
static T_1
F_86 ( struct V_61 * V_81 , char T_2 * V_62 , T_3 V_63 , T_4 * V_64 )
{
int (* F_87)( struct V_98 * V_99 ) = V_81 -> V_82 ;
struct V_98 * V_99 ;
int V_100 ;
if ( * V_64 )
return 0 ;
...
static int
F_92 ( struct V_95 * V_95 , struct V_61 * V_61 )
{
const struct V_110 * V_111 = & V_112 ;
return F_67 ( V_61 , V_111 ) ;
}
static int
F_93 ( struct V_95 * V_95 , struct V_61 * V_61 )
{
const struct V_110 * V_111 = & V_113 ;
if ( ( V_61 -> V_114 & V_115 ) &&
( V_61 -> V_116 & V_117 ) )
F_29 () ;
return F_67 ( V_61 , V_111 ) ;
...
static struct V_107 *
F_94 ( const char * V_8 , struct V_107 * V_109 )
{
struct V_50 * system ;
struct V_107 * V_118 ;
F_23 (system, &event_subsystems, list) {
...
V_118 = F_96 ( L_23 , 0644 , system -> V_118 , system ,
& V_120 ) ;
if ( ! V_118 ) {
F_7 ( system -> V_52 ) ;
system -> V_52 = NULL ;
...
F_97 ( L_25 , 0644 , system -> V_118 , system ,
& V_121 ) ;
return system -> V_118 ;
}
static int
F_98 ( struct V_2 * V_20 , struct V_107 * V_109 ,
const struct V_122 * V_27 ,
const struct V_122 * V_42 ,
const struct V_122 * V_52 ,
const struct V_122 * V_123 )
{
struct V_1 * V_7 ;
int V_21 ;
if ( strcmp ( V_20 -> V_4 -> system , V_79 ) != 0 )
V_109 = F_94 ( V_20 -> V_4 -> system , V_109 ) ;
V_20 -> V_124 = F_90 ( V_20 -> V_8 , V_109 ) ;
if ( ! V_20 -> V_124 ) {
F_91 ( L_17
L_26 , V_20 -> V_8 ) ;
return - 1 ;
...
F_97 ( L_25 , 0644 , V_20 -> V_124 , V_20 ,
V_42 ) ;
#ifdef F_20
if ( V_20 -> V_28 . type && V_20 -> V_4 -> V_47 )
F_97 ( L_27 , 0444 , V_20 -> V_124 , V_20 ,
V_27 ) ;
#endif
V_7 = F_1 ( V_20 ) ;
if ( F_61 ( V_7 ) ) {
...
F_97 ( L_23 , 0644 , V_20 -> V_124 , V_20 ,
V_52 ) ;
F_97 ( L_30 , 0444 , V_20 -> V_124 , V_20 ,
V_123 ) ;
return 0 ;
}
...
return - V_58 ;
if ( V_20 -> V_4 -> V_127 ) {
V_21 = V_20 -> V_4 -> V_127 ( V_20 ) ;
if ( V_21 < 0 && V_21 != - V_128 )
F_102 ( L_31 ,
V_20 -> V_8 ) ;
}
return V_21 ;
...
static int
F_103 ( struct V_2 * V_20 , struct V_129 * V_130 ,
const struct V_122 * V_27 ,
const struct V_122 * V_42 ,
const struct V_122 * V_52 ,
const struct V_122 * V_123 )
...
if ( ! V_109 )
return - V_131 ;
V_21 = F_98 ( V_20 , V_109 , V_27 , V_42 , V_52 , V_123 ) ;
if ( ! V_21 )
F_6 ( & V_20 -> V_78 , & V_77 ) ;
V_20 -> V_130 = V_130 ;
return V_21 ;
...
{
struct V_137 * V_138 ;
V_138 = F_69 ( sizeof( * V_138 ) , V_15 ) ;
if ( ! V_138 )
return NULL ;
V_138 -> V_130 = V_130 ;
V_138 -> V_27 = V_132 ;
V_138 -> V_27 . V_139 = V_130 ;
V_138 -> V_42 = V_133 ;
V_138 -> V_42 . V_139 = V_130 ;
V_138 -> V_52 = V_134 ;
V_138 -> V_52 . V_139 = V_130 ;
V_138 -> V_123 = V_135 ;
V_138 -> V_123 . V_139 = V_130 ;
F_6 ( & V_138 -> V_78 , & V_140 ) ;
return V_138 ;
}
static void F_113 ( struct V_129 * V_130 )
{
struct V_137 * V_138 = NULL ;
struct V_2 * * V_20 , * * V_141 , * * V_142 ;
V_141 = V_130 -> V_143 ;
V_142 = V_130 -> V_143 + V_130 -> V_144 ;
if ( V_141 == V_142 )
return;
V_138 = F_112 ( V_130 ) ;
if ( ! V_138 )
...
F_103 ( * V_20 , V_130 ,
& V_138 -> V_27 , & V_138 -> V_42 ,
& V_138 -> V_52 , & V_138 -> V_123 ) ;
}
}
...
static int F_117 ( struct V_146 * V_147 ,
unsigned long V_83 , void * V_31 )
{
...
static T_5 int F_118 ( char * V_150 )
{
F_119 ( V_151 , V_150 , V_152 ) ;
V_153 = 1 ;
V_154 = 1 ;
return 1 ;
}
...
if ( ! V_108 )
return 0 ;
V_118 = F_96 ( L_34 , 0444 , V_108 ,
NULL , & V_157 ) ;
if ( ! V_118 )
F_91 ( L_17
L_35 ) ;
V_118 = F_96 ( L_36 , 0644 , V_108 ,
NULL , & V_158 ) ;
if ( ! V_118 )
F_91 ( L_17
L_37 ) ;
...
if ( ! V_109 )
return 0 ;
F_97 ( L_38 , 0444 , V_109 ,
V_159 ,
& V_160 ) ;
F_97 ( L_39 , 0444 , V_109 ,
V_161 ,
& V_160 ) ;
F_97 ( L_25 , 0644 , V_109 ,
NULL , & V_121 ) ;
if ( F_10 () )
F_91 ( L_40 ) ;
F_23 (call, &ftrace_events, list) {
V_21 = F_98 ( V_20 , V_109 ,
& V_132 ,
& V_133 ,
& V_134 ,
& V_135 ) ;
...
static T_5 void F_124 ( struct V_163 * V_164 )
{
F_125 ( & V_165 ) ;
F_126 ( & V_166 ) ;
F_127 ( 1 ) ;
...
static T_5 int F_131 ( void * V_168 )
{
void * V_169 ;
V_169 = F_69 ( 1234 , V_15 ) ;
if ( ! V_169 )
F_28 ( L_42 ) ;
F_132 ( F_124 ) ;
F_7 ( V_169 ) ;
...
static void
F_142 ( unsigned long V_173 , unsigned long V_174 ,
...
V_118 -> V_173 = V_173 ;
V_118 -> V_174 = V_174 ;
F_151 ( V_69 , V_28 , V_44 , V_183 ) ;
V_85:
F_152 ( & F_147 ( V_184 , V_182 ) ) ;
F_153 () ;
}
