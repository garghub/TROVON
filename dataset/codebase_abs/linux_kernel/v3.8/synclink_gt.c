...
F_243 ( & V_2 -> V_38 , V_486 , V_2 -> line ,
& V_2 -> V_449 -> V_179 ) ;
}
}
static int F_244 ( struct V_473 * V_179 ,
...
static void F_247 ( struct V_473 * V_179 )
{
}
...
F_249 ( V_486 , V_2 -> line ) ;
if ( ( V_148 = F_250 ( V_486 ) ) )
F_12 ( ( L_157 , V_148 ) ) ;
F_251 ( V_486 ) ;
}
V_2 = V_34 ;
...
static T_1 F_260 ( struct V_1 * V_2 , unsigned int V_507 )
{
F_261 () ;
return F_262 ( ( void V_508 * ) V_458 ) ;
}
static void F_263 ( struct V_1 * V_2 , unsigned int V_507 , T_1 V_174 )
{
F_261 () ;
F_264 ( V_174 , ( void V_508 * ) V_458 ) ;
}
static T_12 F_99 ( struct V_1 * V_2 , unsigned int V_507 )
{
F_261 () ;
return F_265 ( ( void V_508 * ) V_458 ) ;
}
static void F_100 ( struct V_1 * V_2 , unsigned int V_507 , T_12 V_174 )
{
F_261 () ;
...
static void F_271 ( struct V_1 * V_2 , T_9 V_510 )
{
unsigned int div ;
...
F_263 ( V_2 , V_538 , ( unsigned char ) V_338 ) ;
V_338 = 0 ;
switch( V_2 -> V_68 . V_69 ) {
case V_282 :
V_338 |= V_316 + V_521 ;
...
if ( V_2 -> V_68 . V_137 )
V_338 |= V_266 + V_267 ;
F_263 ( V_2 , V_509 , ( unsigned char ) V_338 ) ;
...
F_263 ( V_2 , V_538 , ( unsigned char ) ( ( V_2 -> V_385 >> 8 ) & 0xff ) ) ;
} else if ( ! ( V_539 & V_177 ) ) {
V_539 &= ~ ( V_333 + V_334 ) ;
}
...
if ( V_2 -> V_412 & V_553 )
V_338 |= V_267 ;
F_263 ( V_2 , V_554 , V_338 ) ;
}
static void F_33 ( struct V_1 * V_2 )
{
unsigned char V_338 = F_260 ( V_2 , V_554 ) ;
if ( V_2 -> V_62 & V_64 )
V_338 |= V_288 ;
else
V_338 &= ~ V_288 ;
