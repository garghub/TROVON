...
0 , F_142 ( V_223 ) ,
F_143 ( & V_223 -> V_228 ) , V_223 , F_143 ( & V_223 -> V_77 ) ) ;
}
...
int V_49 ;
struct V_216 * V_119 ;
V_49 = F_146 ( V_230 , V_231 , V_233 , sizeof( struct V_216 ) ) ;
if ( V_49 < 0 )
return V_49 ;
...
{
return F_145 ( V_229 , V_231 , & V_37 , & V_235 ) ;
}
static T_9 int F_148 ( struct V_13 * V_13 )
{
if ( ! F_149 ( V_13 , L_7 , V_236 , & V_237 ) )
return - V_238 ;
return 0 ;
}
