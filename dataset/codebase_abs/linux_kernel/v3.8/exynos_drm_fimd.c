...
static T_2 F_75 ( int V_129 , void * V_130 )
{
struct V_11 * V_12 = (struct V_11 * ) V_130 ;
struct V_131 * V_25 = & V_12 -> V_25 ;
struct V_132 * V_133 = V_25 -> V_133 ;
struct V_23 * V_26 = V_25 -> V_26 ;
T_1 V_41 ;
V_41 = F_33 ( V_12 -> V_43 + V_134 ) ;
if ( V_41 & V_135 )
F_19 ( V_135 , V_12 -> V_43 + V_134 ) ;
if ( V_26 -> V_136 < 0 )
goto V_137;
F_76 ( V_133 , V_26 -> V_136 ) ;
F_77 ( V_133 , V_26 -> V_136 ) ;
if ( F_39 ( & V_12 -> V_73 ) ) {
F_37 ( & V_12 -> V_73 , 0 ) ;
F_78 ( & V_12 -> V_74 ) ;
}
...
static int F_79 ( struct V_132 * V_133 , struct V_10 * V_7 )
{
F_6 ( L_1 , __FILE__ ) ;
V_133 -> V_139 = 1 ;
V_133 -> V_140 = 1 ;
...
static void F_82 ( struct V_132 * V_133 , struct V_10 * V_7 )
{
F_6 ( L_1 , __FILE__ ) ;
if ( F_80 ( V_133 ) )
F_83 ( V_133 , V_7 ) ;
...
struct V_40 * V_14 )
{
unsigned long V_141 = F_85 ( V_12 -> V_142 ) ;
T_1 V_143 ;
T_1 V_60 ;
T_1 V_144 = 0 ;
T_1 V_145 ;
F_6 ( L_1 , __FILE__ ) ;
V_143 = V_14 -> V_50 + V_14 -> V_52 +
V_14 -> V_51 + V_14 -> V_55 ;
V_143 *= V_14 -> V_46 + V_14 -> V_48 +
V_14 -> V_47 + V_14 -> V_54 ;
if ( ! V_14 -> V_146 )
V_14 -> V_146 = 60 ;
V_141 /= V_143 ;
...
static int F_87 ( struct V_11 * V_12 , bool V_148 )
{
F_6 ( L_1 , __FILE__ ) ;
if ( V_148 ) {
int V_149 ;
V_149 = F_88 ( V_12 -> V_150 ) ;
if ( V_149 < 0 )
return V_149 ;
V_149 = F_88 ( V_12 -> V_142 ) ;
if ( V_149 < 0 ) {
F_89 ( V_12 -> V_150 ) ;
return V_149 ;
}
...
for ( V_35 = 0 ; V_35 < V_36 ; V_35 ++ ) {
V_34 = & V_12 -> V_34 [ V_35 ] ;
V_34 -> V_37 = V_34 -> V_128 ;
V_34 -> V_128 = false ;
}
}
static int F_92 ( struct V_11 * V_12 , bool V_148 )
{
struct V_10 * V_7 = V_12 -> V_25 . V_7 ;
if ( V_148 ) {
int V_149 ;
V_149 = F_87 ( V_12 , true ) ;
if ( V_149 < 0 )
return V_149 ;
V_12 -> V_19 = false ;
if ( F_35 ( 0 , & V_12 -> V_65 ) )
...
V_12 = F_94 ( & V_3 -> V_7 , sizeof( * V_12 ) , V_157 ) ;
if ( ! V_12 )
return - V_158 ;
V_12 -> V_150 = F_95 ( V_7 , L_18 ) ;
if ( F_96 ( V_12 -> V_150 ) ) {
F_41 ( V_7 , L_19 ) ;
return F_97 ( V_12 -> V_150 ) ;
}
V_12 -> V_142 = F_95 ( V_7 , L_20 ) ;
if ( F_96 ( V_12 -> V_142 ) ) {
F_41 ( V_7 , L_21 ) ;
return F_97 ( V_12 -> V_142 ) ;
}
V_154 = F_98 ( V_3 , V_159 , 0 ) ;
V_12 -> V_43 = F_99 ( & V_3 -> V_7 , V_154 ) ;
if ( ! V_12 -> V_43 ) {
F_41 ( V_7 , L_22 ) ;
return - V_160 ;
}
V_154 = F_98 ( V_3 , V_161 , 0 ) ;
if ( ! V_154 ) {
F_41 ( V_7 , L_23 ) ;
return - V_160 ;
}
V_12 -> V_129 = V_154 -> V_162 ;
V_149 = F_100 ( & V_3 -> V_7 , V_12 -> V_129 , F_75 ,
0 , L_24 , V_12 ) ;
if ( V_149 ) {
F_41 ( V_7 , L_23 ) ;
return V_149 ;
}
V_12 -> V_57 = V_152 -> V_57 ;
V_12 -> V_42 = V_152 -> V_42 ;
V_12 -> V_82 = V_152 -> V_82 ;
V_12 -> V_13 = V_13 ;
F_101 ( & V_12 -> V_74 ) ;
F_37 ( & V_12 -> V_73 , 0 ) ;
V_25 = & V_12 -> V_25 ;
...
V_13 -> V_14 . V_165 = F_85 ( V_12 -> V_142 ) / V_12 -> V_60 ;
F_6 ( L_25 ,
V_13 -> V_14 . V_165 , V_12 -> V_60 ) ;
