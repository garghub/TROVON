...
static int F_17 ( struct V_4 * V_4 , struct V_46 * V_47 , int V_13 )
{
int V_48 , V_20 ;
...
static int F_26 ( struct V_46 * V_47 , unsigned int V_64 )
{
...
static int F_29 ( struct V_67 * V_47 , const struct V_68 * V_34 )
{
int V_69 ;
struct V_4 * V_4 = F_27 ( sizeof( * V_4 ) , V_65 ) ;
if ( ! V_4 )
...
static int F_35 ( struct V_46 * V_47 , unsigned int V_64 )
{
F_32 ( F_36 ( V_47 ) ) ;
F_20 ( V_47 , NULL ) ;
return 0 ;
}
static void F_37 ( struct V_67 * V_47 )
{
F_32 ( F_38 ( V_47 ) ) ;
F_31 ( V_47 , NULL ) ;
}
