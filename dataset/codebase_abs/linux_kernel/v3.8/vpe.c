...
V_138 V_38 = V_181 ;
struct V_1 * V_4 ;
if ( F_82 ( V_162 -> V_183 . V_184 -> V_185 ) != V_2 )
return - V_167 ;
V_4 = F_1 ( V_168 ) ;
if ( V_4 == NULL )
return - V_167 ;
...
V_181 -= F_89 ( V_4 -> V_123 + V_4 -> V_32 , V_180 , V_181 ) ;
if ( ! V_181 )
return - V_186 ;
V_4 -> V_32 += V_181 ;
return V_38 ;
...
int F_91 ( T_15 V_1 , unsigned long V_118 )
{
struct V_1 * V_4 = V_1 ;
V_4 -> V_108 = V_118 ;
return F_41 ( V_4 ) ;
...
int F_97 ( int V_9 , struct V_103 * V_15 )
{
struct V_1 * V_4 ;
if ( ( V_4 = F_1 ( V_9 ) ) == NULL )
return - 1 ;
F_98 ( & V_15 -> V_13 , & V_4 -> V_15 ) ;
return 0 ;
}
char * F_99 ( int V_9 )
{
...
static T_12 F_100 ( struct V_189 * V_190 , struct V_191 * V_192 ,
const char * V_193 , V_138 V_32 )
{
...
static T_12 F_101 ( struct V_189 * V_194 , struct V_191 * V_192 ,
char * V_193 )
{
struct V_1 * V_1 = F_1 ( V_168 ) ;
return sprintf ( V_193 , L_47 , V_1 -> V_111 ) ;
}
static T_12 F_102 ( struct V_189 * V_190 , struct V_191 * V_192 ,
const char * V_193 , V_138 V_32 )
{
struct V_1 * V_1 = F_1 ( V_168 ) ;
unsigned long V_195 ;
char * V_196 ;
V_195 = F_103 ( V_193 , & V_196 , 0 ) ;
if ( V_196 == V_193 )
goto V_197;
if ( V_195 == 0 || V_195 > ( V_198 - V_168 ) )
goto V_197;
V_1 -> V_111 = V_195 ;
return V_32 ;
V_197:
...
static void F_104 ( struct V_189 * V_194 )
{
F_14 ( V_194 ) ;
}
static int T_16 F_105 ( void )
{
unsigned int V_155 , V_156 ;
...
V_19 = F_19 () ;
V_198 = ( V_19 & V_29 ) + 1 ;
V_211 = ( ( V_19 & V_27 ) >> V_28 ) + 1 ;
for ( V_8 = V_168 ; V_8 < V_198 ; V_8 ++ ) {
F_67 ( V_24 ) ;
F_49 ( V_156 ) ;
F_50 ( V_155 ) ;
F_44 ( V_101 ) ;
...
V_4 -> V_111 = V_198 - V_168 ;
F_98 ( & V_10 -> V_8 , & V_4 -> V_8 ) ;
if ( V_8 >= V_168 ) {
...
static void T_17 F_118 ( void )
{
struct V_1 * V_4 , * V_67 ;
F_119 ( & V_206 ) ;
F_117 ( V_201 , V_202 ) ;
F_120 (v, n, &vpecontrol.vpe_list, list) {
if ( V_4 -> V_165 != V_170 )
F_11 ( V_4 ) ;
}
}
