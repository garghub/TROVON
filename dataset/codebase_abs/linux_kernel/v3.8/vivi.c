...
V_153 = & V_11 -> V_154 ;
V_153 -> type = V_203 ;
V_153 -> V_204 = V_205 | V_206 | V_207 | V_208 ;
V_153 -> V_209 = V_11 ;
V_153 -> V_210 = sizeof( struct V_57 ) ;
V_153 -> V_211 = & V_212 ;
V_153 -> V_213 = & V_214 ;
V_155 = F_87 ( V_153 ) ;
if ( V_155 )
...
V_179 -> V_217 = V_153 ;
F_91 ( V_218 , & V_179 -> V_98 ) ;
V_179 -> V_71 = & V_11 -> V_132 ;
F_92 ( V_179 , V_11 ) ;
V_155 = F_93 ( V_179 , V_219 , V_220 ) ;
if ( V_155 < 0 )
goto V_202;
...
{
const struct V_221 * V_222 = F_95 ( L_30 ) ;
int V_155 = 0 , V_54 ;
if ( V_222 == NULL ) {
F_96 ( V_223 L_31 ) ;
return - V_224 ;
