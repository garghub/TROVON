...
static int T_1
F_43 ( struct V_8 * V_9 , unsigned long V_98 )
{
struct V_92 * V_93 ;
struct V_16 * V_17 ;
unsigned long V_26 ;
...
return - V_64 ;
V_93 = F_44 ( V_9 ) ;
V_17 = F_45 ( sizeof( * V_17 ) , V_99 ) ;
if ( ! V_17 )
return - V_100 ;
V_9 -> V_18 = V_17 ;
F_12 ( V_9 -> V_38 , L_4 , F_46 ( V_93 ) ) ;
V_9 -> V_101 = F_41 ( V_93 ) ;
if ( V_9 -> V_101 == NULL ) {
F_14 ( V_9 -> V_38 , L_5 ) ;
return - V_64 ;
}
if ( F_47 ( V_93 , V_9 -> V_102 -> V_103 ) ) {
F_14 ( V_9 -> V_38 ,
L_6 ) ;
return - V_104 ;
}
...
static int T_1
F_49 ( struct V_8 * V_9 , struct V_105 * V_106 )
{
const struct V_1 * V_15 = F_4 ( V_9 ) ;
struct V_16 * V_17 ;
unsigned long V_26 ;
...
static void T_1 F_53 ( struct V_8 * V_9 )
{
const struct V_1 * V_15 = F_4 ( V_9 ) ;
if ( ! V_15 )
return;
...
if ( F_1 ( V_15 ) ) {
if ( V_9 -> V_26 )
F_54 ( V_9 -> V_26 , V_15 -> V_108 ) ;
} else if ( F_2 ( V_15 ) ) {
struct V_92 * V_93 = F_44 ( V_9 ) ;
if ( V_93 ) {
if ( V_9 -> V_26 )
F_55 ( V_93 ) ;
}
...
static int F_56 ( struct V_92 * V_9 ,
const struct V_110 * V_111 )
{
return F_57 ( V_9 , & V_112 ) ;
}
static void F_58 ( struct V_92 * V_9 )
{
F_59 ( V_9 ) ;
}
