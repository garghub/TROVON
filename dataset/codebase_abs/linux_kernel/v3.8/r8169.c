...
{
F_215 ( V_2 , V_2 -> V_404 . V_405 ) ;
}
static void F_218 ( struct V_1 * V_2 )
{
F_215 ( V_2 , V_2 -> V_404 . V_406 ) ;
}
...
if ( ! V_426 )
goto V_428;
V_147 = F_237 ( sizeof( * V_147 ) , V_253 ) ;
if ( ! V_147 )
goto V_429;
V_171 = F_238 ( & V_147 -> V_314 , V_426 , & V_2 -> V_5 -> V_18 ) ;
if ( V_171 < 0 )
goto V_430;
...
static void F_244 ( struct V_63 * V_18 )
{
struct V_1 * V_2 = F_49 ( V_18 ) ;
V_2 -> V_440 ( V_18 ) ;
F_66 ( V_2 ) ;
...
static T_1 F_246 ( void T_4 * V_23 )
{
T_1 V_30 ;
V_30 = F_60 ( V_220 ) ;
F_62 ( V_220 , V_30 ) ;
...
static void F_247 ( void T_4 * V_23 , unsigned int V_447 )
{
F_62 ( V_448 , V_447 + 1 ) ;
}
static void F_248 ( void T_4 * V_23 , unsigned V_34 )
{
...
V_454 [ 1 ] = V_454 [ 0 ] = 0 ;
F_251 (ha, dev) {
int V_462 = F_252 ( V_463 , V_461 -> V_71 ) >> 26 ;
...
static void F_255 ( struct V_1 * V_2 , int V_71 , int V_44 )
{
if ( V_2 -> V_472 . V_60 )
V_2 -> V_472 . V_60 ( V_2 , V_71 , V_44 ) ;
}
static T_2 F_256 ( struct V_1 * V_2 , int V_71 )
{
return V_2 -> V_472 . V_61 ? V_2 -> V_472 . V_61 ( V_2 , V_71 ) : ~ 0 ;
}
static void F_257 ( struct V_1 * V_2 , T_2 V_85 )
{
T_2 V_473 ;
V_473 = F_256 ( V_2 , 0x070c ) & 0x00ffffff ;
F_255 ( V_2 , 0x070c , V_473 | V_85 ) ;
}
static void F_258 ( struct V_1 * V_2 )
{
F_257 ( V_2 , 0x17000000 ) ;
}
static void F_259 ( struct V_1 * V_2 )
{
F_257 ( V_2 , 0x27000000 ) ;
}
static void F_260 ( struct V_1 * V_2 , int V_71 , int V_44 )
{
void T_4 * V_23 = V_2 -> V_24 ;
F_17 ( V_474 , V_44 ) ;
...
static void F_262 ( struct V_1 * V_2 , int V_71 , int V_44 )
{
void T_4 * V_23 = V_2 -> V_24 ;
F_17 ( V_474 , V_44 ) ;
F_17 ( V_475 , V_476 | ( V_71 & V_477 ) |
...
static T_2 F_263 ( struct V_1 * V_2 , int V_71 )
{
void T_4 * V_23 = V_2 -> V_24 ;
...
static void F_265 ( struct V_1 * V_2 , const struct V_482 * V_360 ,
int V_77 )
{
T_1 V_359 ;
while ( V_77 -- > 0 ) {
V_359 = ( F_52 ( V_2 , V_360 -> V_483 ) & ~ V_360 -> V_21 ) | V_360 -> V_85 ;
F_51 ( V_2 , V_360 -> V_483 , V_359 ) ;
V_360 ++ ;
}
}
...
void T_4 * V_23 = V_2 -> V_24 ;
struct V_5 * V_6 = V_2 -> V_5 ;
F_21 ( V_115 , F_68 ( V_115 ) & ~ V_486 ) ;
F_62 ( V_220 , F_60 ( V_220 ) & ~ V_487 ) ;
F_5 ( V_6 ,
( 0x5 << V_421 ) | V_423 ) ;
}
...
{
static const struct V_482 V_490 [] = {
{ 0x01 , 0 , 0x0001 } ,
{ 0x02 , 0x0800 , 0x1000 } ,
{ 0x03 , 0 , 0x0042 } ,
{ 0x06 , 0x0080 , 0x0000 } ,
...
{
void T_4 * V_23 = V_2 -> V_24 ;
static const struct V_482 V_492 [] = {
{ 0x02 , 0x0800 , 0x1000 } ,
{ 0x03 , 0 , 0x0002 } ,
{ 0x06 , 0x0080 , 0x0000 }
} ;
F_259 ( V_2 ) ;
F_21 ( V_491 , 0x06 | V_493 | V_494 ) ;
F_265 ( V_2 , V_492 , F_88 ( V_492 ) ) ;
F_272 ( V_2 ) ;
}
static void F_277 ( struct V_1 * V_2 )
{
static const struct V_482 V_495 [] = {
{ 0x01 , 0 , 0x0001 } ,
{ 0x03 , 0x0400 , 0x0220 }
} ;
F_259 ( V_2 ) ;
F_265 ( V_2 , V_495 , F_88 ( V_495 ) ) ;
F_272 ( V_2 ) ;
}
...
F_5 ( V_6 , 0x5 << V_421 ) ;
F_21 ( V_422 , V_488 ) ;
for ( V_15 = 0 ; V_15 < F_88 ( V_496 ) ; V_15 ++ ) {
const struct V_482 * V_360 = V_496 + V_15 ;
T_1 V_359 ;
V_359 = F_52 ( V_2 , V_360 -> V_483 ) ;
...
F_259 ( V_2 ) ;
F_265 ( V_2 , V_497 , F_88 ( V_497 ) ) ;
F_5 ( V_6 , 0x5 << V_421 ) ;
F_21 ( V_422 , V_488 ) ;
F_266 ( V_6 ) ;
F_17 ( V_498 , F_18 ( V_498 ) | V_499 ) ;
F_17 ( V_498 , F_18 ( V_498 ) & ~ V_499 ) ;
F_21 ( V_120 , F_68 ( V_120 ) & ~ V_500 ) ;
}
static void F_284 ( struct V_1 * V_2 )
{
void T_4 * V_23 = V_2 -> V_24 ;
struct V_5 * V_6 = V_2 -> V_5 ;
static const struct V_482 V_501 [] = {
{ 0x09 , 0x0000 , 0x0080 } ,
{ 0x19 , 0x0000 , 0x0224 }
} ;
F_258 ( V_2 ) ;
F_265 ( V_2 , V_501 , F_88 ( V_501 ) ) ;
F_5 ( V_6 , 0x5 << V_421 ) ;
...
F_21 ( V_422 , V_502 ) ;
F_266 ( V_6 ) ;
F_17 ( V_310 , F_18 ( V_310 ) | V_503 ) ;
F_21 ( V_504 , F_68 ( V_504 ) & ~ V_505 ) ;
F_21 ( V_506 , F_68 ( V_506 ) & ~ 0x07 ) ;
F_21 ( V_507 , F_68 ( V_507 ) | V_508 ) ;
F_17 ( V_498 , F_18 ( V_498 ) | V_509 ) ;
F_21 ( V_120 , F_68 ( V_120 ) & ~ V_500 ) ;
}
...
{
void T_4 * V_23 = V_2 -> V_24 ;
static const struct V_482 V_510 [] = {
{ 0x06 , 0x00c0 , 0x0020 } ,
{ 0x08 , 0x0001 , 0x0002 } ,
{ 0x09 , 0x0000 , 0x0080 } ,
{ 0x19 , 0x0000 , 0x0224 }
...
void T_4 * V_23 = V_2 -> V_24 ;
struct V_5 * V_6 = V_2 -> V_5 ;
F_53 ( V_2 , 0xc8 , V_511 , 0x080002 , V_78 ) ;
...
static void F_289 ( struct V_63 * V_18 )
{
struct V_1 * V_2 = F_49 ( V_18 ) ;
void T_4 * V_23 = V_2 -> V_24 ;
F_21 ( V_134 , V_135 ) ;
F_21 ( V_422 , V_488 ) ;
F_247 ( V_23 , V_447 ) ;
V_2 -> V_217 |= F_60 ( V_220 ) | V_513 | V_514 ;
F_62 ( V_220 , V_2 -> V_217 ) ;
F_62 ( V_469 , 0x5151 ) ;
if ( V_2 -> V_34 == V_294 ) {
V_2 -> V_88 |= V_515 | V_516 ;
V_2 -> V_88 &= ~ V_517 ;
}
F_245 ( V_2 , V_23 ) ;
F_249 ( V_18 ) ;
...
void T_4 * V_23 = V_2 -> V_24 ;
struct V_5 * V_6 = V_2 -> V_5 ;
static const struct V_482 V_518 [] = {
{ 0x01 , 0 , 0x6e65 } ,
{ 0x02 , 0 , 0x091f } ,
{ 0x03 , 0 , 0xc2f9 } ,
{ 0x06 , 0 , 0xafb5 } ,
...
F_5 ( V_6 , 0x5 << V_421 ) ;
F_21 ( V_113 ,
V_520 | V_521 | V_489 | V_522 | V_523 | V_524 | V_114 ) ;
F_21 ( V_115 , F_68 ( V_115 ) & ~ V_486 ) ;
V_519 = F_68 ( V_113 ) ;
if ( ( V_519 & V_521 ) && ( V_519 & V_520 ) )
F_21 ( V_113 , V_519 & ~ V_521 ) ;
F_265 ( V_2 , V_518 , F_88 ( V_518 ) ) ;
}
...
F_259 ( V_2 ) ;
F_5 ( V_6 , 0x5 << V_421 ) ;
F_21 ( V_113 , V_522 | V_523 | V_524 | V_114 ) ;
F_21 ( V_115 , F_68 ( V_115 ) & ~ V_486 ) ;
}
...
{
void T_4 * V_23 = V_2 -> V_24 ;
static const struct V_482 V_525 [] = {
{ 0x07 , 0 , 0x4000 } ,
{ 0x19 , 0 , 0x0200 } ,
{ 0x19 , 0 , 0x0020 } ,
{ 0x1e , 0 , 0x2000 } ,
...
F_17 ( V_526 , F_18 ( V_526 ) | 0x002800 ) ;
F_17 ( V_526 , F_18 ( V_526 ) & ~ 0x010000 ) ;
F_21 ( V_504 , F_68 ( V_504 ) | V_527 | V_528 ) ;
F_21 ( V_507 , F_68 ( V_507 ) | V_508 ) ;
F_265 ( V_2 , V_525 , F_88 ( V_525 ) ) ;
}
...
{
void T_4 * V_23 = V_2 -> V_24 ;
static const struct V_482 V_529 [] = {
{ 0x19 , 0xffff , 0xff64 } ,
{ 0x1e , 0 , 0x4000 }
} ;
F_259 ( V_2 ) ;
...
void T_4 * V_23 = V_2 -> V_24 ;
F_17 ( V_526 , F_18 ( V_526 ) | 0x002800 ) ;
F_17 ( V_498 , ( F_18 ( V_498 ) | V_530 ) & ~ V_531 ) ;
F_21 ( V_504 , F_68 ( V_504 ) | V_527 | V_528 ) ;
F_21 ( V_507 , F_68 ( V_507 ) & ~ V_508 ) ;
}
...
static int F_299 ( struct V_63 * V_18 , int V_533 )
{
struct V_1 * V_2 = F_49 ( V_18 ) ;
if ( V_533 < V_534 ||
V_533 > V_143 [ V_2 -> V_34 ] . V_535 )
return - V_172 ;
if ( V_533 > V_536 )
F_222 ( V_2 ) ;
else
...
static inline void F_301 ( struct V_228 * V_229 )
{
V_229 -> V_71 = F_302 ( 0x0badbadbadbadbadull ) ;
V_229 -> V_537 &= ~ F_303 ( V_538 | V_539 ) ;
}
static void F_304 ( struct V_1 * V_2 ,
void * * V_540 , struct V_228 * V_229 )
{
F_305 ( & V_2 -> V_5 -> V_18 , F_132 ( V_229 -> V_71 ) , V_447 ,
V_541 ) ;
F_147 ( * V_540 ) ;
* V_540 = NULL ;
F_301 ( V_229 ) ;
}
static inline void F_306 ( struct V_228 * V_229 , T_2 V_447 )
{
T_2 V_542 = F_114 ( V_229 -> V_537 ) & V_543 ;
V_229 -> V_537 = F_303 ( V_538 | V_542 | V_447 ) ;
}
static inline void F_307 ( struct V_228 * V_229 , T_6 V_544 ,
T_2 V_447 )
{
V_229 -> V_71 = F_302 ( V_544 ) ;
F_308 () ;
F_306 ( V_229 , V_447 ) ;
}
static inline void * F_309 ( void * V_28 )
{
return ( void * ) F_310 ( ( long ) V_28 , 16 ) ;
}
static struct V_225 * F_311 ( struct V_1 * V_2 ,
struct V_228 * V_229 )
{
void * V_28 ;
T_6 V_544 ;
struct V_248 * V_10 = & V_2 -> V_5 -> V_18 ;
struct V_63 * V_18 = V_2 -> V_18 ;
int V_545 = V_18 -> V_18 . V_546 ? F_312 ( V_18 -> V_18 . V_546 ) : - 1 ;
V_28 = F_313 ( V_447 , V_253 , V_545 ) ;
if ( ! V_28 )
return NULL ;
if ( F_309 ( V_28 ) != V_28 ) {
F_147 ( V_28 ) ;
V_28 = F_313 ( V_447 + 15 , V_253 , V_545 ) ;
if ( ! V_28 )
return NULL ;
}
V_544 = F_314 ( V_10 , F_309 ( V_28 ) , V_447 ,
V_541 ) ;
if ( F_315 ( F_316 ( V_10 , V_544 ) ) ) {
if ( F_80 () )
F_11 ( V_2 , V_17 , V_2 -> V_18 , L_22 ) ;
goto V_547;
}
F_307 ( V_229 , V_544 , V_447 ) ;
return V_28 ;
V_547:
F_147 ( V_28 ) ;
return NULL ;
...
{
unsigned int V_15 ;
for ( V_15 = 0 ; V_15 < V_548 ; V_15 ++ ) {
if ( V_2 -> V_549 [ V_15 ] ) {
F_304 ( V_2 , V_2 -> V_549 + V_15 ,
V_2 -> V_550 + V_15 ) ;
}
}
}
static inline void F_318 ( struct V_228 * V_229 )
{
V_229 -> V_537 |= F_303 ( V_543 ) ;
}
...
if ( V_2 -> V_549 [ V_15 ] )
continue;
V_28 = F_311 ( V_2 , V_2 -> V_550 + V_15 ) ;
if ( ! V_28 ) {
F_301 ( V_2 -> V_550 + V_15 ) ;
goto V_547;
}
V_2 -> V_549 [ V_15 ] = V_28 ;
}
F_318 ( V_2 -> V_550 + V_548 - 1 ) ;
return 0 ;
V_547:
F_317 ( V_2 ) ;
return - V_427 ;
}
static int F_320 ( struct V_63 * V_18 )
{
struct V_1 * V_2 = F_49 ( V_18 ) ;
F_221 ( V_2 ) ;
memset ( V_2 -> V_551 , 0x0 , V_552 * sizeof( struct V_553 ) ) ;
memset ( V_2 -> V_549 , 0x0 , V_548 * sizeof( void * ) ) ;
return F_319 ( V_2 ) ;
}
static void F_321 ( struct V_248 * V_10 , struct V_553 * V_551 ,
struct V_554 * V_229 )
{
unsigned int V_77 = V_551 -> V_77 ;
F_305 ( V_10 , F_132 ( V_229 -> V_71 ) , V_77 , V_555 ) ;
V_229 -> V_537 = 0x00 ;
V_229 -> V_230 = 0x00 ;
V_229 -> V_71 = 0x00 ;
V_551 -> V_77 = 0 ;
}
static void F_322 ( struct V_1 * V_2 , T_2 V_322 ,
unsigned int V_13 )
{
unsigned int V_15 ;
for ( V_15 = 0 ; V_15 < V_13 ; V_15 ++ ) {
unsigned int V_556 = ( V_322 + V_15 ) % V_552 ;
struct V_553 * V_551 = V_2 -> V_551 + V_556 ;
unsigned int V_77 = V_551 -> V_77 ;
if ( V_77 ) {
struct V_225 * V_226 = V_551 -> V_226 ;
F_321 ( & V_2 -> V_5 -> V_18 , V_551 ,
V_2 -> V_557 + V_556 ) ;
if ( V_226 ) {
V_2 -> V_18 -> V_260 . V_558 ++ ;
F_323 ( V_226 ) ;
V_551 -> V_226 = NULL ;
}
}
...
static void F_331 ( struct V_63 * V_18 )
{
struct V_1 * V_2 = F_49 ( V_18 ) ;
F_181 ( V_2 , V_560 ) ;
}
static int F_332 ( struct V_1 * V_2 , struct V_225 * V_226 ,
T_2 * V_561 )
{
struct V_562 * V_146 = F_333 ( V_226 ) ;
unsigned int V_563 , V_556 ;
struct V_554 * V_564 ( V_565 ) ;
struct V_248 * V_10 = & V_2 -> V_5 -> V_18 ;
V_556 = V_2 -> V_413 ;
for ( V_563 = 0 ; V_563 < V_146 -> V_566 ; V_563 ++ ) {
const T_8 * V_567 = V_146 -> V_568 + V_563 ;
T_6 V_544 ;
T_2 V_232 , V_77 ;
void * V_71 ;
V_556 = ( V_556 + 1 ) % V_552 ;
V_565 = V_2 -> V_557 + V_556 ;
V_77 = F_334 ( V_567 ) ;
V_71 = F_335 ( V_567 ) ;
V_544 = F_314 ( V_10 , V_71 , V_77 , V_555 ) ;
if ( F_315 ( F_316 ( V_10 , V_544 ) ) ) {
if ( F_80 () )
...
V_232 = V_561 [ 0 ] | V_77 |
( V_543 * ! ( ( V_556 + 1 ) % V_552 ) ) ;
V_565 -> V_537 = F_303 ( V_232 ) ;
V_565 -> V_230 = F_303 ( V_561 [ 1 ] ) ;
V_565 -> V_71 = F_302 ( V_544 ) ;
V_2 -> V_551 [ V_556 ] . V_77 = V_77 ;
}
if ( V_563 ) {
V_2 -> V_551 [ V_556 ] . V_226 = V_226 ;
V_565 -> V_537 |= F_303 ( V_569 ) ;
}
return V_563 ;
V_547:
F_322 ( V_2 , V_2 -> V_413 + 1 , V_563 ) ;
return - V_570 ;
}
static inline void F_336 ( struct V_1 * V_2 ,
struct V_225 * V_226 , T_2 * V_561 )
{
const struct V_571 * V_146 = V_572 + V_2 -> V_573 ;
T_2 V_574 = F_333 ( V_226 ) -> V_575 ;
int V_483 = V_146 -> V_576 ;
if ( V_574 ) {
V_561 [ 0 ] |= V_577 ;
V_561 [ V_483 ] |= F_337 ( V_574 , V_208 ) << V_146 -> V_578 ;
} else if ( V_226 -> V_579 == V_580 ) {
const struct V_581 * V_582 = F_338 ( V_226 ) ;
if ( V_582 -> V_583 == V_584 )
V_561 [ V_483 ] |= V_146 -> V_323 . V_585 ;
else if ( V_582 -> V_583 == V_586 )
V_561 [ V_483 ] |= V_146 -> V_323 . V_587 ;
else
F_339 ( 1 ) ;
}
}
static T_9 F_340 ( struct V_225 * V_226 ,
struct V_63 * V_18 )
{
struct V_1 * V_2 = F_49 ( V_18 ) ;
unsigned int V_556 = V_2 -> V_413 % V_552 ;
struct V_554 * V_565 = V_2 -> V_557 + V_556 ;
void T_4 * V_23 = V_2 -> V_24 ;
struct V_248 * V_10 = & V_2 -> V_5 -> V_18 ;
T_6 V_544 ;
T_2 V_232 , V_77 ;
T_2 V_561 [ 2 ] ;
int V_568 ;
if ( F_315 ( ! F_341 ( V_2 , F_333 ( V_226 ) -> V_566 ) ) ) {
F_11 ( V_2 , V_17 , V_18 , L_24 ) ;
goto V_588;
}
if ( F_315 ( F_114 ( V_565 -> V_537 ) & V_538 ) )
goto V_588;
V_77 = F_342 ( V_226 ) ;
V_544 = F_314 ( V_10 , V_226 -> V_28 , V_77 , V_555 ) ;
if ( F_315 ( F_316 ( V_10 , V_544 ) ) ) {
if ( F_80 () )
...
V_2 -> V_551 [ V_556 ] . V_77 = V_77 ;
V_565 -> V_71 = F_302 ( V_544 ) ;
V_561 [ 1 ] = F_303 ( F_109 ( V_226 ) ) ;
V_561 [ 0 ] = V_538 ;
F_336 ( V_2 , V_226 , V_561 ) ;
V_568 = F_332 ( V_2 , V_226 , V_561 ) ;
if ( V_568 < 0 )
goto V_590;
else if ( V_568 )
V_561 [ 0 ] |= V_591 ;
...
F_343 ( V_226 ) ;
F_308 () ;
V_232 = V_561 [ 0 ] | V_77 | ( V_543 * ! ( ( V_556 + 1 ) % V_552 ) ) ;
V_565 -> V_537 = F_303 ( V_232 ) ;
V_2 -> V_413 += V_568 + 1 ;
F_308 () ;
F_21 ( V_592 , V_593 ) ;
...
return V_595 ;
V_590:
F_321 ( V_10 , V_2 -> V_551 + V_556 , V_565 ) ;
V_589:
F_323 ( V_226 ) ;
V_18 -> V_260 . V_558 ++ ;
return V_595 ;
...
static void F_346 ( struct V_63 * V_18 )
{
struct V_1 * V_2 = F_49 ( V_18 ) ;
struct V_5 * V_6 = V_2 -> V_5 ;
T_1 V_597 , V_598 ;
F_347 ( V_6 , V_599 , & V_598 ) ;
F_347 ( V_6 , V_600 , & V_597 ) ;
F_11 ( V_2 , V_601 , V_18 , L_26 ,
V_598 , V_597 ) ;
if ( V_6 -> V_602 )
V_598 &= ~ V_603 ;
else
V_598 |= V_604 | V_603 ;
F_348 ( V_6 , V_599 , V_598 ) ;
F_348 ( V_6 , V_600 ,
V_597 & ( V_605 |
V_606 | V_607 |
V_608 | V_609 ) ) ;
if ( ( V_2 -> V_217 & V_610 ) && ! V_2 -> V_412 && ! V_2 -> V_414 ) {
void T_4 * V_23 = V_2 -> V_24 ;
F_81 ( V_2 , V_601 , V_18 , L_27 ) ;
V_2 -> V_217 &= ~ V_610 ;
F_62 ( V_220 , V_2 -> V_217 ) ;
V_18 -> V_141 &= ~ V_611 ;
}
...
static void F_349 ( struct V_63 * V_18 , struct V_1 * V_2 )
{
unsigned int V_411 , V_612 ;
V_411 = V_2 -> V_411 ;
F_350 () ;
V_612 = V_2 -> V_413 - V_411 ;
while ( V_612 > 0 ) {
unsigned int V_556 = V_411 % V_552 ;
struct V_553 * V_551 = V_2 -> V_551 + V_556 ;
T_2 V_232 ;
F_351 () ;
V_232 = F_114 ( V_2 -> V_557 [ V_556 ] . V_537 ) ;
if ( V_232 & V_538 )
break;
F_321 ( & V_2 -> V_5 -> V_18 , V_551 ,
V_2 -> V_557 + V_556 ) ;
if ( V_232 & V_569 ) {
F_352 ( & V_2 -> V_613 . V_614 ) ;
V_2 -> V_613 . V_615 ++ ;
V_2 -> V_613 . V_616 += V_551 -> V_226 -> V_77 ;
F_353 ( & V_2 -> V_613 . V_614 ) ;
F_323 ( V_551 -> V_226 ) ;
V_551 -> V_226 = NULL ;
}
V_411 ++ ;
...
static inline int F_355 ( T_2 V_232 )
{
return ( V_232 & ( V_591 | V_569 ) ) != ( V_591 | V_569 ) ;
}
static inline void F_356 ( struct V_225 * V_226 , T_2 V_537 )
{
T_2 V_232 = V_537 & V_617 ;
if ( ( ( V_232 == V_618 ) && ! ( V_537 & V_619 ) ) ||
( ( V_232 == V_620 ) && ! ( V_537 & V_621 ) ) )
V_226 -> V_579 = V_622 ;
else
F_357 ( V_226 ) ;
}
static struct V_225 * F_358 ( void * V_28 ,
struct V_1 * V_2 ,
int V_623 ,
T_6 V_71 )
{
...
struct V_248 * V_10 = & V_2 -> V_5 -> V_18 ;
V_28 = F_309 ( V_28 ) ;
F_359 ( V_10 , V_71 , V_623 , V_541 ) ;
F_360 ( V_28 ) ;
V_226 = F_361 ( V_2 -> V_18 , V_623 ) ;
if ( V_226 )
memcpy ( V_226 -> V_28 , V_28 , V_623 ) ;
F_362 ( V_10 , V_71 , V_623 , V_541 ) ;
return V_226 ;
}
static int F_363 ( struct V_63 * V_18 , struct V_1 * V_2 , T_2 V_624 )
{
unsigned int V_414 , V_625 ;
unsigned int V_349 ;
V_414 = V_2 -> V_414 ;
V_625 = V_548 + V_2 -> V_412 - V_414 ;
V_625 = F_337 ( V_625 , V_624 ) ;
for (; V_625 > 0 ; V_625 -- , V_414 ++ ) {
unsigned int V_556 = V_414 % V_548 ;
struct V_228 * V_229 = V_2 -> V_550 + V_556 ;
T_2 V_232 ;
F_351 () ;
V_232 = F_114 ( V_229 -> V_537 ) & V_2 -> V_626 ;
if ( V_232 & V_538 )
break;
if ( F_315 ( V_232 & V_627 ) ) {
F_81 ( V_2 , V_628 , V_18 , L_28 ,
V_232 ) ;
V_18 -> V_260 . V_264 ++ ;
if ( V_232 & ( V_629 | V_630 ) )
V_18 -> V_260 . V_631 ++ ;
if ( V_232 & V_632 )
V_18 -> V_260 . V_633 ++ ;
if ( V_232 & V_634 ) {
...
if ( F_364 ( ! ( V_18 -> V_141 & V_637 ) ) )
V_623 = ( V_232 & 0x00003fff ) - 4 ;
else
V_623 = V_232 & 0x00003fff ;
if ( F_315 ( F_355 ( V_232 ) ) ) {
V_18 -> V_260 . V_638 ++ ;
V_18 -> V_260 . V_631 ++ ;
goto V_639;
}
V_226 = F_358 ( V_2 -> V_549 [ V_556 ] ,
V_2 , V_623 , V_71 ) ;
if ( ! V_226 ) {
V_18 -> V_260 . V_638 ++ ;
goto V_639;
...
F_356 ( V_226 , V_232 ) ;
F_365 ( V_226 , V_623 ) ;
V_226 -> V_583 = F_366 ( V_226 , V_18 ) ;
F_113 ( V_229 , V_226 ) ;
F_367 ( & V_2 -> V_559 , V_226 ) ;
F_352 ( & V_2 -> V_640 . V_614 ) ;
V_2 -> V_640 . V_615 ++ ;
V_2 -> V_640 . V_616 += V_623 ;
F_353 ( & V_2 -> V_640 . V_614 ) ;
}
V_639:
V_229 -> V_230 = 0 ;
F_308 () ;
...
static T_10 F_368 ( int V_641 , void * V_642 )
{
...
F_61 ( V_2 , V_232 ) ;
if ( F_315 ( V_232 & V_515 ) ) {
switch ( V_2 -> V_34 ) {
case V_294 :
F_327 ( V_18 ) ;
F_372 ( V_560 , V_2 -> V_3 . V_371 ) ;
default:
break;
}
}
if ( F_315 ( V_232 & V_644 ) )
F_346 ( V_18 ) ;
if ( V_232 & V_645 )
F_77 ( V_18 , V_2 , V_2 -> V_24 , true ) ;
F_66 ( V_2 ) ;
}
static void F_373 ( struct V_646 * V_372 )
{
static const struct {
int V_647 ;
...
struct V_1 * V_2 =
F_374 ( V_372 , struct V_1 , V_3 . V_372 ) ;
struct V_63 * V_18 = V_2 -> V_18 ;
int V_15 ;
F_1 ( V_2 ) ;
if ( ! F_76 ( V_18 ) ||
! F_375 ( V_650 , V_2 -> V_3 . V_371 ) )
goto V_651;
for ( V_15 = 0 ; V_15 < F_88 ( V_648 ) ; V_15 ++ ) {
bool V_652 ;
V_652 = F_376 ( V_648 [ V_15 ] . V_647 , V_2 -> V_3 . V_371 ) ;
if ( V_652 )
...
static int F_377 ( struct V_653 * V_559 , int V_624 )
{
struct V_1 * V_2 = F_374 ( V_559 , struct V_1 , V_559 ) ;
struct V_63 * V_18 = V_2 -> V_18 ;
...
if ( V_232 & V_656 )
V_655 = F_363 ( V_18 , V_2 , ( T_2 ) V_624 ) ;
if ( V_232 & V_657 )
F_349 ( V_18 , V_2 ) ;
if ( V_232 & V_2 -> V_88 ) {
V_654 &= ~ V_2 -> V_88 ;
...
static void F_379 ( struct V_63 * V_18 , void T_4 * V_23 )
{
struct V_1 * V_2 = F_49 ( V_18 ) ;
if ( V_2 -> V_34 > V_306 )
return;
...
static void F_380 ( struct V_63 * V_18 )
{
struct V_1 * V_2 = F_49 ( V_18 ) ;
void T_4 * V_23 = V_2 -> V_24 ;
F_104 ( & V_2 -> V_203 ) ;
...
static int F_381 ( struct V_63 * V_18 )
{
struct V_1 * V_2 = F_49 ( V_18 ) ;
struct V_5 * V_6 = V_2 -> V_5 ;
F_382 ( & V_6 -> V_18 ) ;
F_126 ( V_18 ) ;
F_1 ( V_2 ) ;
F_383 ( V_650 , V_2 -> V_3 . V_371 ) ;
F_380 ( V_18 ) ;
F_3 ( V_2 ) ;
F_384 ( V_6 -> V_641 , V_18 ) ;
F_129 ( & V_6 -> V_18 , V_659 , V_2 -> V_550 ,
V_2 -> V_445 ) ;
F_129 ( & V_6 -> V_18 , V_660 , V_2 -> V_557 ,
V_2 -> V_442 ) ;
V_2 -> V_557 = NULL ;
V_2 -> V_550 = NULL ;
F_385 ( & V_6 -> V_18 ) ;
...
static void F_386 ( struct V_63 * V_18 )
{
struct V_1 * V_2 = F_49 ( V_18 ) ;
F_368 ( V_2 -> V_5 -> V_641 , V_18 ) ;
}
static int F_387 ( struct V_63 * V_18 )
{
struct V_1 * V_2 = F_49 ( V_18 ) ;
void T_4 * V_23 = V_2 -> V_24 ;
struct V_5 * V_6 = V_2 -> V_5 ;
int V_661 = - V_427 ;
F_382 ( & V_6 -> V_18 ) ;
V_2 -> V_557 = F_127 ( & V_6 -> V_18 , V_660 ,
& V_2 -> V_442 , V_253 ) ;
if ( ! V_2 -> V_557 )
goto V_662;
V_2 -> V_550 = F_127 ( & V_6 -> V_18 , V_659 ,
& V_2 -> V_445 , V_253 ) ;
if ( ! V_2 -> V_550 )
goto V_663;
V_661 = F_320 ( V_18 ) ;
if ( V_661 < 0 )
goto V_664;
F_388 ( & V_2 -> V_3 . V_372 , F_373 ) ;
F_345 () ;
F_239 ( V_2 ) ;
V_661 = F_389 ( V_6 -> V_641 , F_368 ,
( V_2 -> V_141 & V_396 ) ? 0 : V_665 ,
V_18 -> V_426 , V_18 ) ;
if ( V_661 < 0 )
goto V_666;
F_1 ( V_2 ) ;
F_372 ( V_650 , V_2 -> V_3 . V_371 ) ;
F_329 ( & V_2 -> V_559 ) ;
F_193 ( V_18 , V_2 ) ;
...
static struct V_668 *
F_392 ( struct V_63 * V_18 , struct V_668 * V_260 )
{
struct V_1 * V_2 = F_49 ( V_18 ) ;
void T_4 * V_23 = V_2 -> V_24 ;
unsigned int V_322 ;
...
F_379 ( V_18 , V_23 ) ;
do {
V_322 = F_393 ( & V_2 -> V_640 . V_614 ) ;
V_260 -> V_262 = V_2 -> V_640 . V_615 ;
V_260 -> V_669 = V_2 -> V_640 . V_616 ;
} while ( F_394 ( & V_2 -> V_640 . V_614 , V_322 ) );
do {
V_322 = F_393 ( & V_2 -> V_613 . V_614 ) ;
V_260 -> V_261 = V_2 -> V_613 . V_615 ;
V_260 -> V_670 = V_2 -> V_613 . V_616 ;
} while ( F_394 ( & V_2 -> V_613 . V_614 , V_322 ) );
V_260 -> V_638 = V_18 -> V_260 . V_638 ;
V_260 -> V_558 = V_18 -> V_260 . V_558 ;
V_260 -> V_631 = V_18 -> V_260 . V_631 ;
V_260 -> V_264 = V_18 -> V_260 . V_264 ;
V_260 -> V_633 = V_18 -> V_260 . V_633 ;
V_260 -> V_635 = V_18 -> V_260 . V_635 ;
...
static int F_397 ( struct V_248 * V_248 )
{
struct V_5 * V_6 = F_398 ( V_248 ) ;
struct V_63 * V_18 = F_399 ( V_6 ) ;
F_395 ( V_18 ) ;
return 0 ;
}
...
static unsigned F_418 ( struct V_1 * V_2 ,
...
static int
F_422 ( struct V_5 * V_6 , const struct V_682 * V_683 )
{
...
V_2 -> V_18 = V_18 ;
V_2 -> V_5 = V_6 ;
V_2 -> V_244 = F_426 ( V_689 . V_244 , V_693 ) ;
V_188 = & V_2 -> V_188 ;
V_188 -> V_18 = V_18 ;
V_188 -> V_694 = F_50 ;
V_188 -> V_695 = F_48 ;
...
if ( F_431 ( V_6 , V_686 ) < V_154 ) {
F_11 ( V_2 , V_311 , V_18 ,
L_34 ) ;
V_171 = - V_389 ;
goto V_704;
}
V_171 = F_432 ( V_6 , V_149 ) ;
if ( V_171 < 0 ) {
...
V_2 -> V_217 = V_218 ;
if ( ( sizeof( T_6 ) > 4 ) &&
! F_433 ( V_6 , F_128 ( 64 ) ) && V_705 ) {
V_2 -> V_217 |= V_610 ;
V_18 -> V_141 |= V_611 ;
} else {
V_171 = F_433 ( V_6 , F_128 ( 32 ) ) ;
if ( V_171 < 0 ) {
F_11 ( V_2 , V_311 , V_18 , L_36 ) ;
goto V_706;
}
}
V_23 = F_434 ( F_435 ( V_6 , V_686 ) , V_154 ) ;
if ( ! V_23 ) {
...
memcpy ( V_18 -> V_672 , V_18 -> V_361 , V_18 -> V_384 ) ;
F_439 ( V_18 , & V_709 ) ;
V_18 -> V_710 = V_711 ;
F_440 ( V_18 , & V_2 -> V_559 , F_377 , V_712 ) ;
V_18 -> V_141 |= V_215 |
V_713 | V_216 ;
...
V_2 -> V_88 = V_132 -> V_88 ;
V_2 -> V_626 = ( V_2 -> V_34 != V_136 ) ?
~ ( V_718 | V_634 ) : ~ 0 ;
F_441 ( & V_2 -> V_203 ) ;
V_2 -> V_203 . V_28 = ( unsigned long ) V_18 ;
V_2 -> V_203 . V_719 = F_184 ;
V_2 -> V_147 = V_350 ;
V_171 = F_442 ( V_18 ) ;
if ( V_171 < 0 )
goto V_720;
...
V_143 [ V_688 ] . V_426 , V_23 , V_18 -> V_361 ,
( T_2 ) ( F_18 ( V_310 ) & 0x9cf0f8ff ) , V_6 -> V_641 ) ;
if ( V_143 [ V_688 ] . V_535 != V_210 ) {
