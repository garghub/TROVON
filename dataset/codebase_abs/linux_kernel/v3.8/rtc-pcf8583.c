...
struct V_24 V_25 = { V_34 , sizeof( V_33 ) , V_33 } ;
int V_35 , V_36 , V_37 ;
F_8 ( V_2 , & V_23 ) ;
if ( V_23 & ( V_38 | V_39 ) ) {
...
{
struct V_1 * V_2 = F_14 ( V_31 ) ;
unsigned char V_33 [ 2 ] , V_42 ;
struct V_24 V_43 = { V_34 , sizeof( V_33 ) , V_33 } ;
struct V_24 V_44 = { V_45 , 1 , & V_42 } ;
unsigned int V_46 = V_32 -> V_14 + 1900 ;
int V_12 ;
V_12 = F_4 ( V_2 , V_32 , 1 ) ;
if ( V_12 )
return V_12 ;
...
struct V_49 * V_49 ;
int V_37 ;
if ( ! F_18 ( V_2 -> V_13 , V_50 ) )
return - V_51 ;
V_49 = F_19 ( sizeof( struct V_49 ) , V_52 ) ;
if ( ! V_49 )
return - V_53 ;
F_20 ( V_2 , V_49 ) ;
V_49 -> V_54 = F_21 ( V_55 . V_56 . V_57 ,
& V_2 -> V_31 , & V_58 , V_59 ) ;
if ( F_22 ( V_49 -> V_54 ) ) {
V_37 = F_23 ( V_49 -> V_54 ) ;
goto V_60;
