...
if ( V_52 < V_55 || V_52 > V_54 || V_52 < V_5 -> V_47 . V_57 ) {
F_15 ( & V_5 -> V_47 . V_48 ) ;
return - V_24 ;
}
...
static T_3 F_29 ( struct V_8 * V_9 , struct V_10 * V_11 , char * V_12 )
{
struct V_13 * V_46 = F_6 ( V_9 , struct V_13 , V_9 ) ;
struct V_1 * V_2 = V_46 -> V_2 ;
struct V_4 * V_5 = V_2 -> V_6 ;
...
#endif
if ( F_11 ( V_2 ) ) {
V_36 = F_37 ( & V_2 -> V_62 -> V_9 , & V_64 ) ;
if ( V_36 )
F_36 ( L_5 ) ;
}
if ( F_34 ( V_2 ) -> V_61 >= 6 ) {
V_36 = F_38 ( & V_2 -> V_62 -> V_9 . V_30 , V_65 ) ;
if ( V_36 )
F_36 ( L_6 ) ;
}
}
...
{
F_40 ( & V_2 -> V_62 -> V_9 . V_30 , V_65 ) ;
F_41 ( & V_2 -> V_62 -> V_9 , & V_64 ) ;
#ifdef F_33
F_42 ( & V_2 -> V_62 -> V_9 . V_30 , & V_63 ) ;
#endif
}
