...
int F_48 ( struct V_18 * V_19 , struct V_106 * V_106 )
{
struct V_7 * V_8 = V_19 -> V_8 ;
int V_97 ;
V_97 = F_37 ( & V_8 -> V_98 ) ;
...
int F_55 ( const struct V_109 * V_110 ,
unsigned int * V_111 )
{
switch ( V_110 -> V_112 ) {
case 1 :
...
error = F_55 ( V_110 , & V_117 ) ;
if ( error )
return error ;
}
if ( V_117 >= V_8 -> V_121 )
return - V_116 ;
V_110 -> V_119 = F_56 ( V_8 , V_117 ) ;
V_110 -> V_117 = V_117 ;
...
F_59 ( * V_122 , V_8 -> V_36 ) ;
F_60 ( V_110 -> V_119 , V_8 -> V_36 ) ;
for ( V_123 = 0 ; V_123 < V_8 -> V_121 ; V_123 ++ ) {
if ( F_56 ( V_8 , V_123 ) == * V_122 ) {
F_60 ( * V_122 , V_8 -> V_36 ) ;
break;
}
}
...
int F_61 ( struct V_7 * V_8 , struct V_109 * V_110 )
{
unsigned long V_33 ;
int V_97 ;
F_19 ( & V_8 -> V_34 , V_33 ) ;
...
static const struct V_128 * F_63 ( struct V_23 * V_24 ,
struct V_7 * V_8 )
{
...
continue;
if ( ! F_64 ( V_129 -> V_10 , V_8 -> V_10 , V_87 ) )
continue;
if ( ! F_64 ( V_129 -> V_36 , V_8 -> V_36 , V_37 ) )
continue;
if ( ! F_64 ( V_129 -> V_68 , V_8 -> V_68 , V_69 ) )
continue;
if ( ! F_64 ( V_129 -> V_65 , V_8 -> V_65 , V_66 ) )
continue;
if ( ! F_64 ( V_129 -> V_71 , V_8 -> V_71 , V_72 ) )
continue;
if ( ! F_64 ( V_129 -> V_74 , V_8 -> V_74 , V_75 ) )
continue;
if ( ! F_64 ( V_129 -> V_78 , V_8 -> V_78 , V_79 ) )
continue;
if ( ! F_64 ( V_129 -> V_140 , V_8 -> V_140 , V_141 ) )
continue;
if ( ! F_64 ( V_129 -> V_61 , V_8 -> V_61 , V_62 ) )
continue;
...
F_66 ( L_2 ,
V_24 -> V_144 , F_67 ( & V_8 -> V_8 . V_145 ) , error ) ;
return error ;
}
static int F_68 ( char * V_146 , int V_147 ,
...
static void F_80 ( struct V_158 * V_159 , const char * V_144 ,
unsigned long * V_167 , int V_3 )
{
int V_123 ;
bool V_149 = true ;
char V_146 [ 18 ] ;
F_81 ( V_159 , L_6 , V_144 ) ;
for ( V_123 = F_82 ( V_3 ) - 1 ; V_123 >= 0 ; V_123 -- ) {
if ( F_68 ( V_146 , sizeof( V_146 ) ,
V_167 [ V_123 ] , V_149 ) ) {
V_149 = false ;
F_81 ( V_159 , L_7 , V_146 , V_123 > 0 ? L_8 : L_9 ) ;
}
}
if ( V_149 )
F_83 ( V_159 , L_10 ) ;
...
F_80 ( V_159 , L_26 , V_8 -> V_140 , V_141 ) ;
...
union V_161 * V_162 = (union V_161 * ) & V_159 -> V_163 ;
F_81 ( V_159 , L_28 , V_162 -> V_160 , V_24 -> V_144 ) ;
if ( V_24 -> V_27 )
F_83 ( V_159 , L_29 ) ;
if ( V_24 -> V_177 )
...
static int F_100 ( char * V_146 , int V_188 ,
...
V_112 += F_100 ( V_146 + V_112 , V_188 - V_112 ,
'e' , V_129 -> V_10 , 0 , V_87 ) ;
V_112 += F_100 ( V_146 + V_112 , V_188 - V_112 ,
...
bool V_149 = true ;
for ( V_123 = F_82 ( V_3 ) - 1 ; V_123 >= 0 ; V_123 -- ) {
V_112 += F_68 ( V_146 + V_112 , V_3 ( V_147 - V_112 , 0 ) ,
V_167 [ V_123 ] , V_149 ) ;
if ( V_112 ) {
V_149 = false ;
if ( V_123 > 0 )
...
static char * F_123 ( struct V_193 * V_8 , T_5 * V_204 )
{
return F_124 ( V_90 , L_55 , F_125 ( V_8 ) ) ;
}
struct V_7 * F_126 ( void )
{
struct V_7 * V_8 ;
V_8 = F_127 ( sizeof( struct V_7 ) , V_90 ) ;
if ( V_8 ) {
V_8 -> V_8 . type = & V_205 ;
V_8 -> V_8 . V_206 = & V_207 ;
F_128 ( & V_8 -> V_8 ) ;
...
static int F_133 ( struct V_193 * V_8 , void * V_209 , void * V_15 )
{
struct V_210 * V_211 = V_209 ;
return V_211 -> V_212 == V_15 ;
}
static void F_134 ( struct V_193 * V_8 , void * V_209 )
{
struct V_210 * V_211 = V_209 ;
struct V_7 * V_212 = V_211 -> V_212 ;
F_135 ( V_8 , L_56 ,
V_91 , F_125 ( & V_212 -> V_8 ) ) ;
F_136 ( V_212 ) ;
}
struct V_7 * F_137 ( struct V_193 * V_8 )
{
struct V_7 * V_212 ;
struct V_210 * V_211 ;
V_211 = F_138 ( F_134 ,
sizeof( struct V_210 ) , V_90 ) ;
if ( ! V_211 )
return NULL ;
V_212 = F_126 () ;
if ( ! V_212 ) {
...
void F_144 ( struct V_7 * V_8 , unsigned int type , unsigned int V_1 )
{
switch ( type ) {
case V_32 :
F_60 ( V_1 , V_8 -> V_36 ) ;
...
static unsigned int F_146 ( struct V_7 * V_8 )
{
int V_215 ;
int V_123 ;
unsigned int V_28 ;
if ( V_8 -> V_41 ) {
V_215 = V_8 -> V_41 -> V_45 ;
} else if ( F_2 ( V_216 , V_8 -> V_65 ) ) {
V_215 = V_8 -> V_48 [ V_216 ] . V_96 -
V_8 -> V_48 [ V_216 ] . V_95 + 1 ,
V_215 = F_147 ( V_215 , 2 , 32 ) ;
...
{
F_150 ( V_8 , V_219 , V_35 ) ;
F_150 ( V_8 , V_220 , V_221 ) ;
F_150 ( V_8 , ABS , abs ) ;
F_150 ( V_8 , V_222 , V_223 ) ;
F_150 ( V_8 , V_202 , V_76 ) ;
F_150 ( V_8 , V_203 , V_80 ) ;
F_150 ( V_8 , V_224 , V_225 ) ;
F_150 ( V_8 , V_226 , V_63 ) ;
}
static void F_151 ( struct V_7 * V_8 )
{
struct V_18 * V_19 , * V_227 ;
F_52 ( V_8 ) ;
F_46 ( & V_164 ) ;
F_152 (handle, next, &dev->h_list, d_node)
V_19 -> V_24 -> V_228 ( V_19 ) ;
F_142 ( ! F_153 ( & V_8 -> V_208 ) ) ;
F_154 ( & V_8 -> V_14 ) ;
F_155 ( & V_8 -> V_168 ) ;
F_69 () ;
F_39 ( & V_164 ) ;
...
static void F_157 ( struct V_193 * V_8 , void * V_209 )
{
struct V_210 * V_211 = V_209 ;
struct V_7 * V_212 = V_211 -> V_212 ;
F_135 ( V_8 , L_58 ,
...
if ( V_8 -> V_231 < V_230 )
V_8 -> V_231 = V_230 ;
V_8 -> V_86 = V_3 ( V_8 -> V_231 , V_230 ) + 2 ;
...
V_8 -> V_126 = F_58 ;
F_161 ( & V_8 -> V_8 , L_59 ,
( unsigned long ) F_162 ( & V_229 ) - 1 ) ;
error = F_163 ( & V_8 -> V_8 ) ;
if ( error )
goto V_234;
V_169 = F_87 ( & V_8 -> V_8 . V_145 , V_90 ) ;
F_164 ( L_60 ,
...
if ( error )
goto V_235;
F_165 ( & V_8 -> V_168 , & V_166 ) ;
F_44 (handler, &input_handler_list, node)
F_65 ( V_8 , V_24 ) ;
F_69 () ;
F_39 ( & V_164 ) ;
if ( V_8 -> V_214 ) {
F_135 ( V_8 -> V_8 . V_213 , L_63 ,
V_91 , F_125 ( & V_8 -> V_8 ) ) ;
F_140 ( V_8 -> V_8 . V_213 , V_211 ) ;
}
return 0 ;
V_235:
F_156 ( & V_8 -> V_8 ) ;
...
return error ;
F_131 ( & V_24 -> V_208 ) ;
F_165 ( & V_24 -> V_168 , & V_176 ) ;
F_44 (dev, &input_dev_list, node)
F_65 ( V_8 , V_24 ) ;
F_69 () ;
F_39 ( & V_164 ) ;
return 0 ;
...
struct V_18 * V_19 , * V_227 ;
F_46 ( & V_164 ) ;
F_152 (handle, next, &handler->h_list, h_node)
V_24 -> V_228 ( V_19 ) ;
F_142 ( ! F_153 ( & V_24 -> V_208 ) ) ;
F_155 ( & V_24 -> V_168 ) ;
F_69 () ;
F_39 ( & V_164 ) ;
}
int F_169 ( struct V_23 * V_24 , void * V_15 ,
int (* F_170)( struct V_18 * , void * ) )
{
struct V_18 * V_19 ;
int V_97 = 0 ;
F_11 () ;
F_13 (handle, &handler->h_list, h_node) {
V_97 = F_170 ( V_19 , V_15 ) ;
if ( V_97 )
break;
}
F_14 () ;
...
return error ;
if ( V_24 -> V_27 )
F_172 ( & V_19 -> V_236 , & V_8 -> V_208 ) ;
else
F_173 ( & V_19 -> V_236 , & V_8 -> V_208 ) ;
F_39 ( & V_8 -> V_98 ) ;
F_173 ( & V_19 -> V_237 , & V_24 -> V_208 ) ;
if ( V_24 -> V_102 )
V_24 -> V_102 ( V_19 ) ;
return 0 ;
}
void F_174 ( struct V_18 * V_19 )
{
struct V_7 * V_8 = V_19 -> V_8 ;
F_175 ( & V_19 -> V_237 ) ;
F_46 ( & V_8 -> V_98 ) ;
...
int F_176 ( int V_238 , unsigned int V_239 ,
bool V_240 )
{
if ( V_238 >= 0 ) {
int V_178 = F_177 ( & V_241 ,
V_238 ,
V_238 + V_239 ,
V_90 ) ;
if ( V_178 >= 0 || ! V_240 )
