...
static int F_12 ( T_1 V_21 , int V_6 , int V_7 ,
struct V_13 * V_14 )
{
struct V_2 * V_5 ;
V_5 = F_13 ( sizeof( struct V_2 ) , V_22 ) ;
if ( ! V_5 )
return - V_23 ;
V_5 -> V_12 . V_6 = V_6 ;
V_5 -> V_12 . V_7 = V_7 ;
V_5 -> V_12 . V_9 = ( V_14 -> V_24 >> 16 ) & 0xFFFF ;
V_5 -> V_1 = V_14 -> V_1 + 1 ;
F_8 ( V_5 , V_14 ) ;
V_5 -> V_25 = V_14 -> V_26 ;
if ( V_14 -> V_19 [ 0 ] )
F_14 ( V_21 , V_14 -> V_19 , & V_5 -> V_27 ) ;
F_15 ( ( V_28 ,
L_4 ,
...
int F_17 ( T_1 V_21 , int V_6 , int V_7 )
{
T_2 V_31 ;
struct V_32 V_33 = { V_34 , NULL } ;
struct V_13 * V_5 ;
V_31 = F_18 ( V_21 , V_35 , & V_33 ) ;
if ( F_19 ( V_31 ) )
return - V_36 ;
F_11 ( V_37 L_5 ,
( char * ) V_33 . V_38 ) ;
...
V_5 = V_33 . V_38 ;
while ( V_5 && ( V_5 -> V_39 > 0 ) ) {
F_12 ( V_21 , V_6 , V_7 , V_5 ) ;
V_5 = (struct V_13 * )
( ( unsigned long ) V_5 + V_5 -> V_39 ) ;
}
F_20 ( V_33 . V_38 ) ;
return 0 ;
}
void F_24 ( int V_6 , int V_7 )
{
struct V_2 * V_5 , * V_41 ;
F_11 ( V_37
L_7 ,
...
if ( V_6 == V_5 -> V_12 . V_6 && V_7 == V_5 -> V_12 . V_7 ) {
F_26 ( & V_5 -> V_29 ) ;
F_20 ( V_5 ) ;
}
}
...
static int F_27 ( struct V_42 * V_7 )
{
struct V_42 * V_43 ;
...
V_4 -> V_64 = V_61 ;
if ( V_27 )
snprintf ( V_60 , sizeof( V_60 ) , L_19 , V_27 ) ;
else
V_60 [ 0 ] = '\0' ;
F_40 ( & V_4 -> V_4 , L_20 ,
F_1 ( V_1 ) , V_60 , V_55 ,
( V_56 == V_57 ) ? L_21 : L_22 ,
( V_58 == V_59 ) ? L_23 : L_24 , V_4 -> V_64 ) ;
return 0 ;
}
