...
#define F_35 3
#define F_36 1
V_182 -> V_94 . V_93 . V_153 = F_35 ;
V_182 -> V_94 . V_93 . V_12 = F_36 ;
if ( ! F_37 ( V_2 , V_8 -> V_193 ,
( V_54 ) V_2 -> V_194 , 0 ) ) {
struct V_195 * V_196 ;
V_196 = F_37 ( V_2 , V_8 -> V_193 ,
V_197 , 0 ) ;
if ( V_196 )
...
#define F_38 6
#define F_39 2
V_182 -> V_199 . V_200 . V_153 = F_38 ;
V_182 -> V_199 . V_200 . V_12 = F_39 ;
...
V_2 -> V_99 . V_151 ) ;
return F_47 ( V_2 , V_233 ,
V_213 , 0 , V_15 ) ;
}
static int F_51 ( struct V_1 * V_2 , T_1 * V_246 )
{
T_1 V_83 [ V_235 ] ;
int V_27 ;
if ( ! V_246 || F_52 ( V_246 ) )
...
memcpy ( V_83 , V_246 , V_235 ) ;
V_27 = F_47 ( V_2 , V_247 ,
V_213 , 0 , V_83 ) ;
return V_27 ;
}
int F_53 ( struct V_1 * V_2 , T_1 * V_246 )
{
if ( ! V_2 -> V_144 )
return 0 ;
switch ( V_2 -> V_190 ) {
case V_244 :
return F_51 ( V_2 , V_246 ) ;
case V_192 :
return F_47 ( V_2 ,
V_248 ,
V_213 , 0 , NULL ) ;
case V_249 :
return F_47 ( V_2 , V_250 ,
V_213 , 0 , NULL ) ;
default:
break;
}
