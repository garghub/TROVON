...
V_75 -> V_102 |= V_187 ;
F_30 ( & V_75 -> V_85 , V_55 ) ;
F_11 ( & V_75 -> V_91 -> V_188 ) ;
if ( V_75 -> V_91 -> V_189 )
V_75 -> V_91 -> V_189 -> V_190 . V_191 ++ ;
F_12 ( & V_75 -> V_91 -> V_188 ) ;
return 0 ;
}
int F_93 (
struct V_74 * V_75 )
...
static T_4
F_97 ( struct V_74 * V_75 , struct V_193 * V_194 ,
T_1 V_195 , struct V_193 * V_196 , T_1 V_197 )
{
if ( ! V_194 || ! V_195 )
return 0 ;
if ( V_75 -> V_102 & V_167 ) {
...
unsigned char * V_182 , unsigned char * V_202 , T_1 V_203 ,
T_1 V_164 , int V_171 , int V_204 , int V_55 ,
struct V_193 * V_194 , T_1 V_195 ,
struct V_193 * V_196 , T_1 V_197 )
{
struct V_39 * V_40 ;
T_4 V_205 ;
int V_30 ;
...
V_164 , V_204 , V_171 , V_202 ) ;
if ( V_55 & V_206 )
V_74 -> V_163 = 1 ;
V_30 = F_99 ( V_32 , V_74 , ( V_55 & V_207 ) ) ;
if ( V_30 )
return V_30 ;
if ( V_55 & V_208 )
V_74 -> V_102 |= V_209 ;
V_205 = F_100 ( V_74 , V_203 ) ;
if ( V_205 ) {
F_101 ( V_74 , V_205 , 0 ) ;
F_102 ( V_32 , V_74 ) ;
return 0 ;
}
V_205 = F_87 ( V_74 , V_182 ) ;
if ( V_205 != 0 ) {
F_55 ( V_74 , V_205 ) ;
return 0 ;
}
...
if ( V_194 )
V_44 = F_103 ( F_104 ( V_194 ) ) + V_194 -> V_211 ;
if ( V_44 ) {
memset ( V_44 , 0 , V_194 -> V_212 ) ;
F_105 ( F_104 ( V_194 ) ) ;
}
}
V_205 = F_97 ( V_74 , V_194 , V_195 ,
V_196 , V_197 ) ;
if ( V_205 != 0 ) {
F_55 ( V_74 , V_205 ) ;
return 0 ;
...
T_1 V_164 , int V_171 , int V_204 , int V_55 )
{
return F_98 ( V_74 , V_32 , V_182 , V_202 ,
V_203 , V_164 , V_171 , V_204 ,
V_55 , NULL , 0 , NULL , 0 ) ;
}
static void F_108 ( struct V_99 * V_100 )
{
struct V_74 * V_74 = F_32 ( V_100 , struct V_74 , V_100 ) ;
V_74 -> V_213 -> V_214 = V_215 ;
V_74 -> V_66 -> V_216 ( V_74 ) ;
F_49 ( V_74 ) ;
}
int F_109 ( struct V_74 * V_74 , struct V_2 * V_32 ,
unsigned char * V_202 , T_1 V_203 ,
void * V_217 , unsigned char V_218 ,
T_5 V_219 , unsigned int V_220 , int V_55 )
{
struct V_39 * V_40 ;
int V_30 ;
V_40 = V_32 -> V_40 ;
...
F_82 ( V_74 , V_40 -> V_46 , V_32 ,
0 , V_134 , V_221 , V_202 ) ;
V_30 = F_110 ( V_74 , V_217 , V_218 , V_219 ) ;
if ( V_30 < 0 )
return - V_25 ;
if ( V_218 == V_222 )
V_74 -> V_213 -> V_223 = V_220 ;
V_30 = F_99 ( V_32 , V_74 , ( V_55 & V_207 ) ) ;
if ( V_30 ) {
F_111 ( V_74 -> V_213 ) ;
return V_30 ;
}
V_30 = F_112 ( V_74 , V_203 ) ;
if ( V_30 ) {
...
V_75 -> V_110 = V_238 ;
if ( V_75 -> V_32 &&
V_75 -> V_78 -> V_142 . V_239 == 2 )
F_118 ( V_75 -> V_32 -> V_41 ,
V_75 -> V_240 , 0x2C ,
V_241 ) ;
V_30 = V_75 -> V_66 -> V_242 ( V_75 ) ;
if ( V_30 == - V_243 || V_30 == - V_25 )
goto V_244;
goto V_245;
default:
F_4 ( L_103 ,
...
T_4 V_30 ;
F_24 ( & V_75 -> V_85 ) ;
V_75 -> V_79 |= ( V_80 | V_227 ) ;
F_26 ( & V_75 -> V_85 ) ;
if ( V_75 -> V_246 ) {
V_30 = V_75 -> V_246 ( V_75 ) ;
if ( V_30 ) {
F_24 ( & V_75 -> V_85 ) ;
V_75 -> V_79 &= ~ ( V_80 | V_227 ) ;
F_26 ( & V_75 -> V_85 ) ;
...
if ( F_123 ( & V_77 -> V_249 ) == 0 )
return false ;
F_11 ( & V_77 -> V_251 ) ;
F_25 ( & V_75 -> V_172 , & V_77 -> V_252 ) ;
F_12 ( & V_77 -> V_251 ) ;
F_27 ( L_108
L_109 ,
...
static inline void F_128 ( struct V_193 * V_194 , int V_260 )
{
struct V_193 * V_261 ;
int V_262 ;
...
if ( V_75 -> V_102 & V_201 )
return;
F_128 ( V_75 -> V_115 , V_75 -> V_198 ) ;
V_75 -> V_115 = NULL ;
V_75 -> V_198 = 0 ;
F_128 ( V_75 -> V_199 , V_75 -> V_200 ) ;
V_75 -> V_199 = NULL ;
V_75 -> V_200 = 0 ;
}
...
F_10 ( ! V_261 ) ;
if ( V_75 -> V_198 == 1 )
return F_103 ( F_104 ( V_261 ) ) + V_261 -> V_211 ;
V_268 = F_136 ( sizeof( * V_268 ) * V_75 -> V_198 , V_33 ) ;
if ( ! V_268 )
return NULL ;
F_129 (cmd->t_data_sg, sg, cmd->t_data_nents, i) {
V_268 [ V_161 ] = F_104 ( V_261 ) ;
}
V_75 -> V_269 = F_137 ( V_268 , V_75 -> V_198 , V_270 , V_271 ) ;
F_131 ( V_268 ) ;
if ( ! V_75 -> V_269 )
return NULL ;
return V_75 -> V_269 + V_75 -> V_115 [ 0 ] . V_211 ;
}
void F_138 ( struct V_74 * V_75 )
{
if ( ! V_75 -> V_198 ) {
return;
} else if ( V_75 -> V_198 == 1 ) {
...
{
T_1 V_212 = V_75 -> V_164 ;
unsigned int V_260 ;
struct V_267 * V_267 ;
T_5 V_272 ;
int V_161 = 0 ;
V_260 = F_141 ( V_212 , V_273 ) ;
V_75 -> V_115 = F_136 ( sizeof( struct V_193 ) * V_260 , V_33 ) ;
if ( ! V_75 -> V_115 )
return - V_25 ;
V_75 -> V_198 = V_260 ;
F_142 ( V_75 -> V_115 , V_260 ) ;
V_272 = V_75 -> V_102 & V_210 ? 0 : V_274 ;
while ( V_212 ) {
T_1 V_275 = F_143 ( T_1 , V_212 , V_273 ) ;
V_267 = F_144 ( V_33 | V_272 ) ;
if ( ! V_267 )
goto V_3;
F_145 ( & V_75 -> V_115 [ V_161 ] , V_267 , V_275 , 0 ) ;
V_212 -= V_275 ;
V_161 ++ ;
}
return 0 ;
...
void F_146 ( struct V_74 * V_75 , int V_278 )
{
if ( ! ( V_75 -> V_102 & V_279 ) ) {
if ( V_278 && ( V_75 -> V_102 & V_263 ) )
F_147 ( V_75 ) ;
F_133 ( V_75 ) ;
} else {
if ( V_278 )
...
{
struct V_74 * V_74 = F_32 ( V_57 , struct V_74 , V_281 ) ;
struct V_2 * V_32 = V_74 -> V_32 ;
unsigned long V_55 ;
F_29 ( & V_32 -> V_37 , V_55 ) ;
if ( F_41 ( & V_74 -> V_173 ) ) {
F_30 ( & V_32 -> V_37 , V_55 ) ;
V_74 -> V_66 -> V_265 ( V_74 ) ;
return;
}
if ( V_32 -> V_283 && V_74 -> V_285 ) {
F_30 ( & V_32 -> V_37 , V_55 ) ;
F_37 ( & V_74 -> V_175 ) ;
return;
}
...
F_29 ( & V_95 -> V_97 , V_289 ) ;
while ( ! F_41 ( & V_95 -> V_291 ) ) {
V_75 = F_155 ( & V_95 -> V_291 ,
struct V_74 , V_98 ) ;
F_51 ( & V_75 -> V_98 ) ;
F_11 ( & V_75 -> V_85 ) ;
F_27 ( L_129
...
V_75 -> V_79 |= V_86 ;
F_12 ( & V_75 -> V_85 ) ;
F_30 ( & V_95 -> V_97 , V_289 ) ;
if ( ! V_75 -> V_91 ) {
F_4 ( L_131 ,
V_75 -> V_66 -> V_88 ( V_75 ) ,
V_75 -> V_66 -> V_226 ( V_75 ) , V_75 -> V_122 ) ;
F_156 () ;
}
F_27 ( L_132
L_133 , V_75 -> V_91 -> V_203 ,
V_75 -> V_66 -> V_88 ( V_75 ) ) ;
...
V_75 -> V_91 -> V_203 ,
V_75 -> V_66 -> V_88 ( V_75 ) ) ;
F_29 ( & V_75 -> V_85 , V_290 ) ;
if ( ! ( V_75 -> V_79 & V_96 ) ) {
F_30 ( & V_75 -> V_85 , V_290 ) ;
goto V_292;
}
V_75 -> V_79 &= ~ V_96 ;
F_47 ( V_75 ) ;
...
F_27 ( L_138 ,
V_95 -> V_203 , V_75 -> V_66 -> V_88 ( V_75 ) ) ;
F_30 ( & V_75 -> V_85 , V_290 ) ;
F_29 ( & V_95 -> V_97 , V_289 ) ;
}
F_30 ( & V_95 -> V_97 , V_289 ) ;
}
static int F_157 ( void * V_293 )
{
struct V_91 * V_95 = V_293 ;
F_154 ( V_95 ) ;
F_37 ( & V_95 -> V_294 ) ;
return 0 ;
}
...
T_4 V_301 , int V_302 )
{
unsigned char * V_303 = V_75 -> V_111 ;
unsigned long V_55 ;
T_3 V_297 = 0 , V_298 = 0 ;
F_29 ( & V_75 -> V_85 , V_55 ) ;
if ( V_75 -> V_102 & V_103 ) {
...
V_75 -> V_104 = V_105 ;
V_304:
return V_75 -> V_66 -> V_242 ( V_75 ) ;
}
int F_125 ( struct V_74 * V_75 , int V_322 )
{
if ( ! ( V_75 -> V_79 & V_120 ) )
return 0 ;
if ( ! V_322 || ( V_75 -> V_102 & V_323 ) )
return 1 ;
F_27 ( L_151 ,
V_75 -> V_165 [ 0 ] , V_75 -> V_66 -> V_88 ( V_75 ) ) ;
V_75 -> V_102 |= V_323 ;
V_75 -> V_66 -> V_242 ( V_75 ) ;
return 1 ;
}
...
unsigned long V_55 ;
F_29 ( & V_75 -> V_85 , V_55 ) ;
if ( V_75 -> V_102 & ( V_103 | V_323 ) ) {
F_30 ( & V_75 -> V_85 , V_55 ) ;
return;
}
F_30 ( & V_75 -> V_85 , V_55 ) ;
if ( V_75 -> V_133 == V_136 ) {
if ( V_75 -> V_66 -> V_324 ( V_75 ) != 0 ) {
V_75 -> V_79 |= V_120 ;
F_86 () ;
}
}
...
struct V_74 * V_75 = F_32 ( V_100 , struct V_74 , V_100 ) ;
struct V_76 * V_77 = V_75 -> V_78 ;
struct V_213 * V_326 = V_75 -> V_213 ;
int V_30 ;
switch ( V_326 -> V_327 ) {
case V_222 :
F_166 ( V_77 , V_326 , V_75 -> V_32 ) ;
break;
case V_328 :
case V_329 :
case V_330 :
...
break;
case V_332 :
V_30 = F_167 ( V_77 , V_326 , NULL , NULL ) ;
V_326 -> V_214 = ( ! V_30 ) ? V_333 :
V_334 ;
break;
case V_335 :
V_326 -> V_214 = V_334 ;
...
F_60 ( V_75 -> V_78 -> V_338 , & V_75 -> V_100 ) ;
return 0 ;
}
