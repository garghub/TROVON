...
static int F_117 ( struct V_1 * V_18 , struct V_178 * V_202 )
{
F_24 ( V_233 L_10 , V_18 -> V_55 ,
* V_202 -> V_24 ) ;
return V_234 | V_240 ;
}
void F_118 ( unsigned int V_242 , T_5 V_278 )
{
if ( V_242 < V_279 )
V_280 [ V_242 ] = V_278 ? V_278 : F_117 ;
else
F_24 ( V_233 L_11
L_12 , V_242 ) ;
}
static int F_119 ( struct V_1 * V_18 , struct V_178 * * V_179 , int V_180 )
{
while ( V_180 -- ) {
struct V_178 * V_202 = * V_179 ++ ;
unsigned int V_242 = F_111 ( V_202 ) ;
int V_25 = V_280 [ V_242 ] ( V_18, V_202 ) ;
#if V_281
if ( V_25 & V_282 ) {
union V_241 * V_169 = F_82 ( V_202 ) ;
F_24 ( V_233 L_13
...
int V_283 ;
F_121 () ;
V_283 = V_18 -> V_284 ( V_18 , V_202 ) ;
F_122 () ;
return V_283 ;
}
static int F_123 ( struct V_14 * V_18 )
{
struct V_3 * V_3 ;
int V_17 ;
F_124 ( & V_285 ) ;
...
static void F_127 ( struct V_1 * V_2 , T_1 V_123 , struct V_286 * V_175 )
{
struct V_178 * V_202 ;
struct V_287 * V_23 ;
V_202 = F_68 ( sizeof( * V_23 ) , V_223 ) ;
if ( ! V_202 ) {
F_24 ( V_233 L_15 , V_288 ) ;
return;
}
V_202 -> V_204 = V_289 ;
V_23 = (struct V_287 * ) F_128 ( V_202 , sizeof( * V_23 ) ) ;
V_23 -> V_206 . V_207 = F_62 ( F_63 ( V_208 ) ) ;
F_64 ( V_23 ) = F_62 ( F_65 ( V_290 , V_123 ) ) ;
V_23 -> V_291 = 0 ;
V_23 -> V_292 = 0 ;
V_23 -> V_293 = F_106 ( V_294 ) ;
V_23 -> V_295 = F_129 ( F_130 ( V_296 ) ) ;
V_23 -> V_26 = F_129 ( F_130 ( V_175 -> V_297 ) ) ;
V_2 -> V_284 ( V_2 , V_202 ) ;
}
static void F_116 ( struct V_298 * V_273 , struct V_181 * V_274 ,
struct V_298 * V_275 , struct V_181 * V_276 ,
const void * V_277 )
{
...
V_175 = F_131 ( V_2 , V_275 , V_300 , V_277 ) ;
if ( ! V_175 ) {
F_24 ( V_233 L_20 ,
V_288 ) ;
return;
}
V_301 = & ( F_52 ( V_2 ) ) -> V_187 ;
for ( V_123 = 0 ; V_123 < V_301 -> V_221 ; V_123 ++ ) {
V_303 = F_93 ( V_301 , V_123 ) ;
F_73 ( ! V_303 ) ;
if ( V_303 && V_303 -> V_189 && V_303 -> V_7 && V_303 -> V_7 -> V_305 ) {
V_302 = V_303 -> V_7 -> V_305 ( V_303 -> V_189 , V_273 , V_275 , V_175 ) ;
if ( V_302 ) {
F_16 () ;
F_132 ( F_133 ( V_2 ) , V_175 ) ;
F_18 () ;
F_127 ( V_2 , V_123 , V_175 ) ;
}
}
}
F_134 ( V_2 , V_175 ) ;
}
void * F_135 ( unsigned long V_109 )
{
void * V_169 = F_136 ( V_109 , V_218 ) ;
if ( ! V_169 )
V_169 = F_137 ( V_109 ) ;
return V_169 ;
}
void F_138 ( void * V_94 )
{
if ( F_139 ( V_94 ) )
F_140 ( V_94 ) ;
else
...
static int F_142 ( struct V_186 * V_91 , unsigned int V_221 ,
unsigned int V_306 , unsigned int V_307 ,
unsigned int V_226 , unsigned int V_228 )
{
unsigned long V_109 = V_221 * sizeof( * V_91 -> V_200 ) +
V_306 * sizeof( * V_91 -> V_225 ) + V_307 * sizeof( * V_91 -> V_227 ) ;
V_91 -> V_200 = F_135 ( V_109 ) ;
if ( ! V_91 -> V_200 )
return - V_308 ;
V_91 -> V_227 = (union V_196 * ) & V_91 -> V_200 [ V_221 ] ;
V_91 -> V_225 = (union V_188 * ) & V_91 -> V_227 [ V_307 ] ;
V_91 -> V_221 = V_221 ;
V_91 -> V_307 = V_307 ;
V_91 -> V_228 = V_228 ;
V_91 -> V_198 = NULL ;
...
if ( V_307 ) {
while ( -- V_307 )
V_91 -> V_227 [ V_307 - 1 ] . V_192 = & V_91 -> V_227 [ V_307 ] ;
V_91 -> V_198 = V_91 -> V_227 ;
}
if ( V_306 ) {
while ( -- V_306 )
V_91 -> V_225 [ V_306 - 1 ] . V_192 = & V_91 -> V_225 [ V_306 ] ;
V_91 -> V_193 = V_91 -> V_225 ;
}
return 0 ;
}
static void F_145 ( struct V_186 * V_91 )
{
F_138 ( V_91 -> V_200 ) ;
}
static inline void F_146 ( struct V_3 * V_309 )
{
F_147 ( & V_285 ) ;
F_6 ( & V_309 -> V_310 , & V_310 ) ;
F_148 ( & V_285 ) ;
}
static inline void F_149 ( struct V_3 * V_309 )
{
F_147 ( & V_285 ) ;
F_10 ( & V_309 -> V_310 ) ;
F_148 ( & V_285 ) ;
}
int F_150 ( struct V_3 * V_3 )
{
struct V_1 * V_18 = & V_3 -> V_2 ;
int V_306 , V_311 ;
struct V_212 * V_91 ;
struct V_122 V_312 , V_122 ;
struct V_124 V_124 ;
unsigned int V_313 ;
V_91 = F_136 ( sizeof( * V_91 ) , V_218 ) ;
if ( ! V_91 )
return - V_308 ;
V_311 = - V_59 ;
if ( V_18 -> V_314 ( V_18 , V_139 , & V_91 -> V_315 ) < 0 ||
V_18 -> V_314 ( V_18 , V_135 , & V_91 -> V_316 ) < 0 ||
V_18 -> V_314 ( V_18 , V_148 , & V_313 ) < 0 ||
V_18 -> V_314 ( V_18 , V_149 , & V_124 ) < 0 ||
V_18 -> V_314 ( V_18 , V_140 , & V_122 ) < 0 ||
V_18 -> V_314 ( V_18 , V_147 , & V_312 ) < 0 )
goto V_317;
V_311 = - V_308 ;
F_151 ( V_18 -> V_318 , F_152 ( V_313 ) ) ;
if ( ! F_133 ( V_18 ) )
goto V_317;
V_306 = F_22 ( V_122 . V_141 / 2 , V_319 ) ;
V_311 = F_142 ( & V_91 -> V_187 , V_122 . V_141 , V_306 ,
V_312 . V_141 , V_320 , V_312 . V_146 ) ;
if ( V_311 )
goto V_321;
V_91 -> V_151 = V_124 . V_151 ;
V_91 -> V_322 = V_124 . V_109 ;
F_153 ( & V_91 -> V_214 , F_66 ) ;
F_144 ( & V_91 -> V_215 ) ;
F_154 ( & V_91 -> V_323 ) ;
V_91 -> V_18 = V_18 ;
F_52 ( V_18 ) = V_91 ;
...
V_321:
F_157 ( F_133 ( V_18 ) ) ;
F_151 ( V_18 -> V_318 , NULL ) ;
V_317:
F_141 ( V_91 ) ;
return V_311 ;
}
static void F_158 ( struct V_325 * V_326 )
{
struct V_327 * V_328 = F_67 ( V_326 , struct V_327 , V_325 ) ;
F_157 ( V_328 ) ;
}
...
V_328 = F_133 ( V_2 ) ;
F_18 () ;
F_151 ( V_2 -> V_318 , NULL ) ;
F_161 ( & V_328 -> V_325 , F_158 ) ;
if ( V_91 -> V_219 )
F_120 ( V_91 -> V_219 ) ;
F_141 ( V_91 ) ;
}
...
static int V_329 ;
F_5 ( & V_8 ) ;
snprintf ( V_2 -> V_55 , sizeof( V_2 -> V_55 ) , L_21 , V_329 ++ ) ;
F_6 ( & V_2 -> V_330 , & V_330 ) ;
F_8 ( & V_8 ) ;
}
