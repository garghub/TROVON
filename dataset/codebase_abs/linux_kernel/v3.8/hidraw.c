...
static int F_29 ( int V_61 , struct V_1 * V_1 , int V_62 )
{
struct V_5 * V_6 = V_1 -> V_7 ;
return F_30 ( V_61 , V_1 , V_62 , & V_6 -> V_63 ) ;
}
static int F_31 ( struct V_54 * V_54 , struct V_1 * V_1 )
{
unsigned int V_29 = F_13 ( V_54 ) ;
struct V_15 * V_34 ;
struct V_5 * V_6 = V_1 -> V_7 ;
...
static long F_34 ( struct V_1 * V_1 , unsigned int V_66 ,
unsigned long V_67 )
{
...
switch ( V_66 ) {
case V_69 :
if ( F_35 ( V_34 -> V_38 -> V_70 , ( int T_2 * ) V_67 ) )
V_8 = - V_26 ;
break;
case V_71 :
{
T_7 V_9 ;
if ( F_36 ( V_9 , ( int T_2 * ) V_67 ) )
V_8 = - V_26 ;
else if ( V_9 > V_72 - 1 )
V_8 = - V_41 ;
else if ( F_10 ( V_68 + F_37 (
struct V_73 ,
V_25 [ 0 ] ) ,
V_34 -> V_38 -> V_74 ,
F_38 ( V_34 -> V_38 -> V_70 , V_9 ) ) )
V_8 = - V_26 ;
break;
}
case V_75 :
{
struct V_76 V_77 ;
V_77 . V_78 = V_34 -> V_38 -> V_79 ;
V_77 . V_80 = V_34 -> V_38 -> V_80 ;
V_77 . V_81 = V_34 -> V_38 -> V_81 ;
...
if ( F_40 ( V_66 ) == F_40 ( F_41 ( 0 ) ) ) {
int V_9 = F_42 ( V_66 ) ;
V_8 = F_12 ( V_1 , V_68 , V_9 , V_82 ) ;
break;
}
if ( F_40 ( V_66 ) == F_40 ( F_43 ( 0 ) ) ) {
int V_9 = F_42 ( V_66 ) ;
V_8 = F_19 ( V_1 , V_68 , V_9 , V_82 ) ;
break;
}
if ( F_44 ( V_66 ) != V_83 ) {
V_8 = - V_41 ;
...
if ( F_40 ( V_66 ) == F_40 ( F_45 ( 0 ) ) ) {
int V_9 = strlen ( V_38 -> V_84 ) + 1 ;
if ( V_9 > F_42 ( V_66 ) )
V_9 = F_42 ( V_66 ) ;
V_8 = F_10 ( V_68 , V_38 -> V_84 , V_9 ) ?
- V_26 : V_9 ;
break;
}
if ( F_40 ( V_66 ) == F_40 ( F_46 ( 0 ) ) ) {
int V_9 = strlen ( V_38 -> V_85 ) + 1 ;
if ( V_9 > F_42 ( V_66 ) )
V_9 = F_42 ( V_66 ) ;
V_8 = F_10 ( V_68 , V_38 -> V_85 , V_9 ) ?
- V_26 : V_9 ;
break;
}
}
...
int F_47 ( struct V_33 * V_38 , T_8 * V_87 , int V_9 )
{
struct V_15 * V_34 = V_38 -> V_15 ;
struct V_5 * V_6 ;
int V_8 = 0 ;
F_48 (list, &dev->list, node) {
int V_88 = ( V_6 -> V_13 + 1 ) & ( V_27 - 1 ) ;
if ( V_88 == V_6 -> V_14 )
continue;
if ( ! ( V_6 -> V_2 [ V_6 -> V_13 ] . V_25 = F_49 ( V_87 , V_9 , V_89 ) ) ) {
V_8 = - V_43 ;
break;
}
V_6 -> V_2 [ V_6 -> V_13 ] . V_9 = V_9 ;
V_6 -> V_13 = V_88 ;
F_50 ( & V_6 -> V_63 , V_90 , V_91 ) ;
}
F_51 ( & V_34 -> V_10 ) ;
return V_8 ;
}
int F_52 ( struct V_33 * V_38 )
{
int V_29 , V_92 ;
struct V_15 * V_34 ;
...
V_34 -> V_34 = F_53 ( V_94 , & V_38 -> V_34 , F_54 ( V_95 , V_29 ) ,
NULL , L_5 , L_6 , V_29 ) ;
if ( F_55 ( V_34 -> V_34 ) ) {
V_36 [ V_29 ] = NULL ;
F_7 ( & V_45 ) ;
...
void F_59 ( struct V_33 * V_38 )
{
struct V_15 * V_15 = V_38 -> V_15 ;
F_3 ( & V_45 ) ;
V_15 -> V_18 = 0 ;
F_60 ( V_94 , F_54 ( V_95 , V_15 -> V_29 ) ) ;
V_36 [ V_15 -> V_29 ] = NULL ;
if ( V_15 -> V_58 ) {
F_33 ( V_38 ) ;
F_51 ( & V_15 -> V_10 ) ;
