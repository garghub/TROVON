...
struct V_1 * V_18 = F_41 ( V_90 -> V_92 ) ;
int V_93 = V_18 -> V_56 [ V_90 -> V_94 ] ;
F_53 ( & V_90 -> V_123 , L_3 , V_15 ,
V_90 -> V_41 , V_90 -> V_111 , V_90 -> V_112 ) ;
if ( F_42 ( V_93 ) )
F_54 ( V_93 , V_90 -> V_41 & V_44 ? 0 : 1 ) ;
F_40 ( V_90 , V_96 ) ;
return 0 ;
}
...
if ( ! V_127 && ! V_133 ) {
F_59 ( & V_125 -> V_123 , L_4 ) ;
return - V_140 ;
}
V_138 = F_60 ( V_127 , L_5 , & V_139 ) ;
if ( V_138 < 0 ) {
if ( V_133 )
V_139 = V_133 -> V_141 ;
else
...
if ( ! F_42 ( V_146 ) )
continue;
V_138 = F_65 ( V_18 -> V_56 [ V_11 ] , V_147 ) ;
if ( V_138 ) {
F_59 ( & V_125 -> V_123 , L_7 ) ;
goto V_148;
}
}
V_18 -> V_145 . V_56 = F_40 ;
V_18 -> V_145 . V_149 = F_47 ;
V_18 -> V_145 . V_150 = F_49 ;
V_18 -> V_145 . V_92 -> V_151 = F_52 ;
V_18 -> V_145 . V_92 -> V_152 = F_55 ;
...
V_138 = F_71 ( V_18 -> V_102 , F_45 , 0 , V_147 , V_18 ) ;
if ( V_138 ) {
F_59 ( & V_125 -> V_123 , L_10 , V_18 -> V_102 , V_138 ) ;
goto V_163;
}
V_137 = F_72 ( & V_125 -> V_123 ) ;
if ( F_73 ( V_137 ) ) {
V_138 = F_74 ( V_137 ) ;
goto V_164;
}
V_18 -> V_165 = F_75 ( & V_125 -> V_123 , L_11 ) ;
if ( F_73 ( V_18 -> V_165 ) ) {
V_138 = F_74 ( V_18 -> V_165 ) ;
goto V_164;
}
V_18 -> V_166 = F_75 ( & V_125 -> V_123 , L_12 ) ;
if ( F_73 ( V_18 -> V_166 ) ) {
V_138 = F_74 ( V_18 -> V_166 ) ;
goto V_164;
}
F_76 ( V_18 -> V_166 ) ;
F_76 ( V_18 -> V_165 ) ;
V_18 -> V_36 = F_77 ( V_18 -> V_166 ) ;
V_18 -> V_3 -> V_167 ( V_18 ) ;
V_18 -> V_3 -> V_107 ( V_18 , 0 ) ;
V_92 -> V_123 . V_128 = V_125 -> V_123 . V_128 ;
V_138 = F_78 ( & V_18 -> V_145 ) ;
if ( V_138 ) {
F_59 ( & V_125 -> V_123 , L_13 , V_138 ) ;
goto V_168;
}
F_79 ( & V_125 -> V_123 , L_14 ) ;
return V_138 ;
V_168:
F_80 ( V_18 -> V_166 ) ;
F_80 ( V_18 -> V_165 ) ;
V_164:
F_81 ( V_18 -> V_102 , V_18 ) ;
V_163:
F_82 ( V_18 -> V_25 ) ;
V_162:
F_83 ( V_136 -> V_159 , F_68 ( V_136 ) ) ;
V_148:
while ( -- V_11 >= 0 ) {
