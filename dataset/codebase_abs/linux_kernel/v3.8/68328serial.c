...
V_172 = V_21 & ~ V_22 ;
V_173:
for ( V_70 = 0 ; V_70 < F_87 ( V_174 ) ; V_70 ++ )
if ( V_174 [ V_70 ] == V_175 )
break;
if ( V_70 >= F_87 ( V_174 ) ) {
V_175 = 9600 ;
...
int F_88 ( struct V_178 * V_179 , char * V_126 )
{
int V_70 , V_180 = V_181 ;
if ( ! V_179 )
return ( - 1 ) ;
if ( V_126 )
V_180 = F_89 ( V_126 , NULL , 0 ) ;
for ( V_70 = 0 ; V_70 < F_87 ( V_174 ) ; V_70 ++ )
if ( V_174 [ V_70 ] == V_180 )
break;
if ( V_70 < F_87 ( V_174 ) ) {
...
static struct V_182 * F_90 ( struct V_178 * V_92 , int * V_150 )
{
* V_150 = V_92 -> V_150 ;
return V_151 ;
}
void F_91 ( struct V_178 * V_183 , const char * V_184 ,
unsigned int V_97 )
{
if ( ! V_177 )
F_86 () ;
