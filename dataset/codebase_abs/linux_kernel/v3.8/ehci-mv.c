...
V_2 -> V_9 = F_20 ( & V_20 -> V_14 , V_26 -> V_37 ,
F_21 ( V_26 ) ) ;
if ( V_2 -> V_9 == 0 ) {
F_9 ( & V_20 -> V_14 , L_9 ) ;
V_6 = - V_38 ;
...
V_2 -> V_39 = F_20 ( & V_20 -> V_14 , V_26 -> V_37 ,
F_21 ( V_26 ) ) ;
if ( V_2 -> V_39 == NULL ) {
F_9 ( & V_20 -> V_14 , L_12 ) ;
V_6 = - V_38 ;
...
V_28 = F_22 ( V_2 -> V_39 ) & V_40 ;
V_2 -> V_41 =
( void V_42 * ) ( ( unsigned long ) V_2 -> V_39 + V_28 ) ;
V_12 -> V_43 = V_26 -> V_37 ;
V_12 -> V_44 = V_26 -> V_45 - V_26 -> V_37 + 1 ;
V_12 -> V_46 = V_2 -> V_41 ;
V_12 -> V_47 = F_23 ( V_20 , 0 ) ;
if ( ! V_12 -> V_47 ) {
F_9 ( & V_20 -> V_14 , L_14 ) ;
V_6 = - V_17 ;
goto V_48;
...
V_24 = F_24 ( V_12 ) ;
V_24 -> V_49 = (struct V_50 * ) V_2 -> V_39 ;
V_2 -> V_51 = V_7 -> V_51 ;
if ( V_2 -> V_51 == V_52 ) {
#ifdef F_25
V_2 -> V_53 = F_26 ( & V_20 -> V_14 , V_54 ) ;
if ( F_27 ( V_2 -> V_53 ) ) {
F_9 ( & V_20 -> V_14 ,
L_15 ) ;
V_6 = - V_17 ;
...
V_6 = F_28 ( V_2 -> V_53 -> V_53 , & V_12 -> V_15 ) ;
if ( V_6 < 0 ) {
F_9 ( & V_20 -> V_14 ,
L_16 ) ;
V_6 = - V_17 ;
...
if ( V_7 -> V_58 )
V_7 -> V_58 ( V_2 -> V_41 , V_2 -> V_9 ) ;
F_29 ( & V_20 -> V_14 ,
L_20
L_21 , V_12 -> V_46 , V_12 -> V_47 ,
...
{
struct V_1 * V_2 = F_33 ( V_20 ) ;
struct V_11 * V_12 = V_2 -> V_12 ;
int V_27 ;
if ( V_12 -> V_59 )
F_34 ( V_12 ) ;
if ( ! F_27 ( V_2 -> V_53 ) )
F_28 ( V_2 -> V_53 -> V_53 , NULL ) ;
if ( V_2 -> V_51 == V_60 ) {
if ( V_2 -> V_7 -> V_55 )
V_2 -> V_7 -> V_55 ( 0 ) ;
F_6 ( V_2 ) ;
