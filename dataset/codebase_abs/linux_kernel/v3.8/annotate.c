...
V_44 . V_114 ? L_33 : L_42 ,
V_44 . V_115 ? L_43 : L_33 ,
V_98 , V_93 ) ;
F_60 ( L_44 , V_95 ) ;
V_86 = F_61 ( V_95 , L_45 ) ;
if ( ! V_86 )
...
static void F_63 ( struct V_116 * V_117 , struct V_80 * V_81 )
{
struct V_80 * V_118 ;
struct V_119 * * V_120 = & V_117 -> V_119 ;
struct V_119 * V_121 = NULL ;
int V_122 ;
while ( * V_120 != NULL ) {
V_121 = * V_120 ;
V_118 = F_64 ( V_121 , struct V_80 , V_68 ) ;
V_122 = strcmp ( V_118 -> V_76 , V_81 -> V_76 ) ;
if ( V_122 == 0 ) {
V_118 -> V_123 += V_81 -> V_78 ;
return;
}
if ( V_122 < 0 )
V_120 = & ( * V_120 ) -> V_124 ;
...
V_81 -> V_123 = V_81 -> V_78 ;
F_65 ( & V_81 -> V_68 , V_121 , V_120 ) ;
F_66 ( & V_81 -> V_68 , V_117 ) ;
}
static void F_67 ( struct V_116 * V_117 , struct V_80 * V_81 )
{
struct V_80 * V_118 ;
struct V_119 * * V_120 = & V_117 -> V_119 ;
struct V_119 * V_121 = NULL ;
...
static void F_68 ( struct V_116 * V_126 , struct V_116 * V_127 )
{
struct V_80 * V_81 ;
struct V_119 * V_68 ;
V_68 = F_69 ( V_127 ) ;
...
static void F_72 ( struct V_35 * V_36 , int V_70 )
{
struct V_37 * V_38 = F_28 ( V_36 ) ;
struct V_80 * V_81 = V_38 -> V_43 -> V_82 ;
int V_128 ;
for ( V_128 = 0 ; V_128 < V_70 ; V_128 ++ )
free ( V_81 [ V_128 ] . V_76 ) ;
free ( V_81 ) ;
V_38 -> V_43 -> V_82 = NULL ;
}
static int F_73 ( struct V_35 * V_36 , struct V_34 * V_34 ,
int V_48 , struct V_116 * V_117 , int V_70 ,
const char * V_93 )
{
T_2 V_53 ;
int V_128 ;
...
T_2 V_17 ;
T_4 * V_132 ;
V_81 [ V_128 ] . V_78 = 100.0 * V_49 -> V_12 [ V_128 ] / V_49 -> V_56 ;
if ( V_81 [ V_128 ] . V_78 <= 0.5 )
continue;
V_17 = V_53 + V_128 ;
sprintf ( V_129 , L_46 V_14 , V_93 , V_17 ) ;
V_132 = F_61 ( V_129 , L_45 ) ;
if ( ! V_132 )
continue;
if ( F_52 ( & V_76 , & V_90 , V_132 ) < 0 || ! V_90 )
goto V_83;
V_81 [ V_128 ] . V_76 = malloc ( sizeof( char ) * V_90 + 1 ) ;
if ( ! V_81 [ V_128 ] . V_76 )
goto V_83;
strcpy ( V_81 [ V_128 ] . V_76 , V_76 ) ;
F_63 ( & V_130 , & V_81 [ V_128 ] ) ;
V_83:
F_62 ( V_132 ) ;
}
F_68 ( V_117 , & V_130 ) ;
...
static void F_74 ( struct V_116 * V_117 , const char * V_93 )
{
struct V_80 * V_81 ;
struct V_119 * V_68 ;
printf ( L_47 , V_93 ) ;
...
V_79 = F_49 ( V_78 ) ;
V_76 = V_81 -> V_76 ;
F_50 ( stdout , V_79 , L_50 , V_78 , V_76 ) ;
V_68 = F_70 ( V_68 ) ;
}
}
static void F_76 ( struct V_35 * V_36 , int V_48 )
{
struct V_37 * V_38 = F_28 ( V_36 ) ;
struct V_42 * V_49 = F_38 ( V_38 , V_48 ) ;
...
if ( V_49 -> V_12 [ V_17 ] != 0 )
printf ( L_51 V_14 L_52 V_57 L_10 , V_134 / 2 ,
V_36 -> V_53 + V_17 , V_49 -> V_12 [ V_17 ] ) ;
printf ( L_53 V_57 L_10 , V_134 / 2 , L_54 , V_49 -> V_56 ) ;
}
int F_77 ( struct V_35 * V_36 , struct V_34 * V_34 , int V_48 ,
bool V_135 , int V_71 , int V_72 ,
int V_136 )
{
struct V_92 * V_92 = V_34 -> V_92 ;
char * V_93 ;
...
if ( V_140 )
F_76 ( V_36 , V_48 ) ;
F_79 (pos, &notes->src->source, node) {
if ( V_136 && V_73 == NULL ) {
V_73 = V_69 ;
V_138 = 0 ;
}
...
break;
if ( V_138 == V_136 )
V_73 = F_80 ( V_73 -> V_68 . V_83 , F_81 ( * V_73 ) , V_68 ) ;
else
++ V_138 ;
break;
}
...
void F_82 ( struct V_35 * V_36 , int V_48 )
{
struct V_37 * V_38 = F_28 ( V_36 ) ;
struct V_42 * V_49 = F_38 ( V_38 , V_48 ) ;
memset ( V_49 , 0 , V_38 -> V_43 -> V_40 ) ;
}
void F_83 ( struct V_35 * V_36 , int V_48 )
{
struct V_37 * V_38 = F_28 ( V_36 ) ;
struct V_42 * V_49 = F_38 ( V_38 , V_48 ) ;
...
{
struct V_58 * V_69 , * V_141 ;
F_85 (pos, n, head, node) {
F_86 ( & V_69 -> V_68 ) ;
F_41 ( V_69 ) ;
}
}
static T_1 F_87 ( struct V_58 * V_59 , T_4 * V_132 )
{
T_1 V_27 ;
if ( V_59 -> V_17 == - 1 )
return fprintf ( V_132 , L_20 , V_59 -> line ) ;
V_27 = fprintf ( V_132 , L_11 V_14 L_15 , V_59 -> V_17 , V_59 -> V_5 ) ;
if ( V_59 -> V_2 . V_4 [ 0 ] != '\0' ) {
V_27 += fprintf ( V_132 , L_57 , 6 - ( int ) V_27 , L_58 ,
V_59 -> V_2 . V_4 ) ;
}
return V_27 + fprintf ( V_132 , L_10 ) ;
}
T_1 F_88 ( struct V_66 * V_67 , T_4 * V_132 )
{
struct V_58 * V_69 ;
T_1 V_27 = 0 ;
F_79 (pos, head, node)
V_27 += F_87 ( V_69 , V_132 ) ;
return V_27 ;
}
int F_89 ( struct V_35 * V_36 , struct V_34 * V_34 , int V_48 ,
bool V_142 , bool V_135 , int V_71 ,
int V_72 )
{
struct V_92 * V_92 = V_34 -> V_92 ;
const char * V_93 = V_92 -> V_103 ;
struct V_116 V_80 = V_131 ;
T_2 V_70 ;
if ( F_54 ( V_36 , V_34 , 0 ) < 0 )
return - 1 ;
V_70 = F_31 ( V_36 ) ;
if ( V_142 ) {
F_73 ( V_36 , V_34 , V_48 , & V_80 ,
V_70 , V_93 ) ;
F_74 ( & V_80 , V_93 ) ;
}
F_77 ( V_36 , V_34 , V_48 , V_135 ,
V_71 , V_72 , 0 ) ;
if ( V_142 )
F_72 ( V_36 , V_70 ) ;
F_84 ( & F_28 ( V_36 ) -> V_43 -> V_3 ) ;
return 0 ;
}
