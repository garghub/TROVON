...
static int F_47 ( struct V_135 * V_132 ,
enum V_136 V_131 )
{
struct V_6 * V_6 ;
int V_130 ;
V_6 = F_48 ( sizeof( * V_6 ) , V_137 ) ;
if ( ! V_6 )
return - V_138 ;
F_49 ( V_132 , V_6 ) ;
V_6 -> V_131 = V_131 ;
V_130 = F_50 ( V_132 , & V_139 ,
V_140 , F_51 ( V_140 ) ) ;
if ( V_130 )
F_52 ( V_6 ) ;
return V_130 ;
}
static int F_53 ( struct V_135 * V_132 )
{
F_54 ( V_132 ) ;
F_52 ( F_55 ( V_132 ) ) ;
return 0 ;
...
{
return F_47 ( & V_142 -> V_132 , V_143 ) ;
}
static int F_57 ( struct V_141 * V_142 )
{
return F_53 ( & V_142 -> V_132 ) ;
}
static int F_58 ( struct V_144 * V_145 ,
const struct V_146 * V_55 )
{
return F_47 ( & V_145 -> V_132 , V_147 ) ;
}
static int F_59 ( struct V_144 * V_145 )
{
return F_53 ( & V_145 -> V_132 ) ;
}
static int T_2 F_60 ( void )
{
int V_130 = 0 ;
#if F_61 ( V_148 ) || F_61 ( V_149 )
V_130 = F_62 ( & V_150 ) ;
if ( V_130 )
return V_130 ;
#endif
