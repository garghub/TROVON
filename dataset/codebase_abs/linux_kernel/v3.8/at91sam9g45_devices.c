...
static void T_1 F_39 ( void ) {}
void T_1 F_40 ( struct V_185 * V_3 )
{
if ( ! V_3 )
return;
F_6 ( V_186 , 0 ) ;
...
void T_1 F_40 ( struct V_185 * V_3 ) {}
void T_1 F_41 ( struct V_192 * V_3 )
{
if ( ! V_3 )
return;
if ( F_42 ( 0 , & V_3 -> V_193 ) )
...
void T_1 F_47 ( T_2 V_221 ) {}
static inline void F_48 ( unsigned V_230 )
{
if ( V_230 & V_231 )
F_12 ( V_232 , 1 ) ;
if ( V_230 & V_233 )
...
void T_1 F_50 ( unsigned V_248 , unsigned V_230 )
{
struct V_249 * V_250 ;
switch ( V_248 ) {
case V_251 :
...
static inline void F_52 ( unsigned V_230 )
{
F_12 ( V_257 , 1 ) ;
F_12 ( V_258 , 0 ) ;
if ( V_230 & V_259 )
...
void T_1 F_56 ( unsigned V_248 , unsigned V_270 , unsigned V_230 )
{
struct V_249 * V_250 ;
struct V_271 * V_15 ;
switch ( V_248 ) {
...
struct V_50 * V_51 ;
struct V_287 * V_53 ;
V_53 = F_16 ( sizeof( struct V_287 ) , V_54 ) ;
V_51 = & V_53 -> V_288 ;
V_51 -> V_56 = & V_1 . V_57 ;
V_51 -> V_58 = V_289 | V_60 |
F_17 ( V_290 ) ;
V_51 = & V_53 -> V_291 ;
V_51 -> V_56 = & V_1 . V_57 ;
V_51 -> V_58 = V_289 | V_61 |
F_18 ( V_292 ) ;
V_293 . V_64 = V_53 ;
F_2 ( & V_294 ) ;
}
