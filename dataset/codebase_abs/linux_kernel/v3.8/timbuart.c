...
{
struct V_19 * V_20 = V_2 -> V_21 -> V_2 . V_20 ;
...
void F_24 ( struct V_1 * V_2 , T_1 V_11 , T_1 * V_3 )
{
if ( V_11 & V_6 ) {
if ( V_11 & V_45 ) {
T_2 V_15 = F_10 ( V_2 -> V_4 + V_16 ) |
...
V_2 -> V_4 + V_5 ) ;
return F_34 ( V_2 -> V_60 , V_61 , V_62 ,
L_9 , V_9 ) ;
}
...
static int F_37 ( int V_63 )
{
int V_64 ;
for ( V_64 = 0 ; V_64 < F_38 ( V_65 ) ; V_64 ++ )
if ( V_63 <= V_65 [ V_64 ] )
return V_64 ;
return - 1 ;
}
...
short V_69 ;
unsigned long V_70 ;
V_63 = F_40 ( V_2 , V_67 , V_68 , 0 , V_2 -> V_71 / 16 ) ;
V_69 = F_37 ( V_63 ) ;
...
{
struct V_74 * V_75 = F_48 ( V_2 -> V_29 ) ;
int V_76 =
F_49 ( F_50 ( V_75 , V_77 , 0 ) ) ;
if ( V_2 -> V_70 & V_78 ) {
F_51 ( V_2 -> V_4 ) ;
V_2 -> V_4 = NULL ;
}
...
int V_76 =
F_49 ( F_50 ( V_75 , V_77 , 0 ) ) ;
if ( ! F_54 ( V_2 -> V_79 , V_76 , L_9 ) )
return - V_80 ;
if ( V_2 -> V_70 & V_78 ) {
V_2 -> V_4 = F_55 ( V_2 -> V_79 , V_76 ) ;
if ( V_2 -> V_4 == NULL ) {
F_52 ( V_2 -> V_79 , V_76 ) ;
return - V_81 ;
}
...
static void F_56 ( struct V_1 * V_2 , int V_70 )
{
if ( V_70 & V_86 ) {
V_2 -> type = V_87 ;
F_53 ( V_2 ) ;
...
static int F_58 ( struct V_74 * V_29 )
{
int V_91 , V_60 ;
struct V_8 * V_9 ;
struct V_92 * V_93 ;
F_17 ( & V_29 -> V_29 , L_8 , V_30 ) ;
V_9 = F_59 ( sizeof( * V_9 ) , V_94 ) ;
if ( ! V_9 ) {
V_91 = - V_90 ;
goto V_95;
}
...
V_9 -> V_2 . V_60 = V_60 ;
F_61 ( & V_9 -> V_10 , F_25 , ( unsigned long ) V_9 ) ;
V_91 = F_62 ( & V_106 ) ;
if ( V_91 )
goto V_104;
V_91 = F_63 ( & V_106 , & V_9 -> V_2 ) ;
if ( V_91 )
goto V_107;
F_64 ( V_29 , V_9 ) ;
return 0 ;
...
static int F_68 ( struct V_74 * V_29 )
{
struct V_8 * V_9 = F_69 ( V_29 ) ;
F_70 ( & V_9 -> V_10 ) ;
F_71 ( & V_106 , & V_9 -> V_2 ) ;
F_65 ( & V_106 ) ;
F_66 ( V_9 ) ;
