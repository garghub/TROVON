...
F_33 ( & V_1 -> V_12 ) ;
F_34 ( & V_1 -> V_45 , F_22 ) ;
V_24 = F_35 ( V_1 -> V_5 , F_3 , 0 , V_15 -> V_67 ,
V_1 ) ;
if ( V_24 ) {
...
F_11 ( V_1 -> V_5 ) ;
if ( F_19 ( V_18 -> V_49 ) ) {
V_24 = F_36 ( V_18 -> V_49 , F_37 ( & V_15 -> V_57 ) ) ;
if ( V_24 ) {
F_25 ( & V_15 -> V_57 , L_5 ) ;
goto V_76;
}
...
F_40 ( V_15 -> V_57 . V_58 , V_81 ,
V_81 ) ;
else
F_40 ( V_15 -> V_57 . V_58 , V_81 , 0 ) ;
V_24 = F_41 ( & V_15 -> V_57 , & V_1 -> V_4 ) ;
if ( V_24 ) {
F_25 ( & V_15 -> V_57 , L_8 ) ;
goto V_82;
}
...
static int F_45 ( struct V_55 * V_15 )
{
struct V_1 * V_1 = F_46 ( V_15 ) ;
F_47 ( & V_1 -> V_45 ) ;
if ( F_19 ( V_1 -> V_18 -> V_49 ) ) {
if ( V_1 -> V_78 >= 0 )
F_43 ( V_1 -> V_78 , V_1 ) ;
...
static int F_49 ( struct V_83 * V_57 )
{
...
static int F_51 ( struct V_83 * V_57 )
{
struct V_1 * V_1 = F_50 ( V_57 ) ;
F_23 ( & V_1 -> V_45 , 0 ) ;
return 0 ;
