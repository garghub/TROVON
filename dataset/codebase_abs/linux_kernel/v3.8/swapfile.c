...
static void F_131 ( struct V_3 * V_66 , int V_64 ,
unsigned char * V_52 ,
unsigned long * V_161 )
{
F_20 ( & V_48 ) ;
F_129 ( V_66 , V_64 , V_52 , V_161 ) ;
F_132 ( V_66 -> type ) ;
F_19 ( & V_48 ) ;
}
static void F_133 ( struct V_3 * V_66 )
{
F_20 ( & V_48 ) ;
F_129 ( V_66 , V_66 -> V_64 , V_66 -> V_52 , F_134 ( V_66 ) ) ;
F_19 ( & V_48 ) ;
}
static unsigned F_135 ( struct V_148 * V_148 , T_10 * V_164 )
{
struct V_165 * V_166 = V_148 -> V_167 ;
F_136 ( V_148 , & V_168 , V_164 ) ;
...
static void * F_137 ( struct V_165 * V_175 , T_11 * V_176 )
{
struct V_3 * V_4 ;
int type ;
T_11 V_177 = * V_176 ;
...
static void * F_140 ( struct V_165 * V_175 , void * V_180 , T_11 * V_176 )
{
...
static void F_141 ( struct V_165 * V_175 , void * V_180 )
{
F_142 ( & V_178 ) ;
}
static int F_143 ( struct V_165 * V_175 , void * V_180 )
{
struct V_3 * V_4 = V_180 ;
struct V_148 * V_148 ;
int V_181 ;
...
V_148 = V_4 -> V_149 ;
V_181 = F_145 ( V_175 , & V_148 -> V_182 , L_3 ) ;
F_146 ( V_175 , L_4 ,
...
static int F_147 ( struct V_157 * V_157 , struct V_148 * V_148 )
{
struct V_165 * V_166 ;
int V_8 ;
V_8 = F_148 ( V_148 , & V_185 ) ;
if ( V_8 )
return V_8 ;
V_166 = V_148 -> V_167 ;
V_166 -> V_169 = F_105 ( & V_170 ) ;
...
static struct V_3 * F_153 ( void )
{
struct V_3 * V_66 ;
unsigned int type ;
V_66 = F_154 ( sizeof( * V_66 ) , V_20 ) ;
if ( ! V_66 )
return F_155 ( - V_105 ) ;
F_20 ( & V_48 ) ;
for ( type = 0 ; type < V_68 ; type ++ ) {
...
F_157 ( & V_66 -> V_16 . V_27 ) ;
V_66 -> V_36 = V_70 ;
V_66 -> V_28 = - 1 ;
F_19 ( & V_48 ) ;
return V_66 ;
}
static int F_158 ( struct V_3 * V_66 , struct V_157 * V_157 )
{
int error ;
if ( F_127 ( V_157 -> V_159 ) ) {
V_66 -> V_19 = F_56 ( F_159 ( V_157 ) ) ;
error = F_160 ( V_66 -> V_19 ,
V_189 | V_190 | V_191 ,
V_192 ) ;
if ( error < 0 ) {
V_66 -> V_19 = NULL ;
...
V_66 -> V_194 = F_161 ( V_66 -> V_19 ) ;
error = F_162 ( V_66 -> V_19 , V_112 ) ;
if ( error < 0 )
return error ;
V_66 -> V_36 |= V_84 ;
} else if ( F_163 ( V_157 -> V_159 ) ) {
...
static unsigned long F_165 ( struct V_3 * V_66 ,
union V_199 * V_199 ,
struct V_157 * V_157 )
{
int V_126 ;
...
if ( F_166 ( V_199 -> V_203 . V_204 ) == 1 ) {
F_167 ( & V_199 -> V_203 . V_204 ) ;
F_167 ( & V_199 -> V_203 . V_205 ) ;
F_167 ( & V_199 -> V_203 . V_206 ) ;
for ( V_126 = 0 ; V_126 < V_199 -> V_203 . V_206 ; V_126 ++ )
F_167 ( & V_199 -> V_203 . V_207 [ V_126 ] ) ;
}
...
if ( ! V_200 )
return 0 ;
V_201 = F_169 ( V_157 ) >> V_17 ;
if ( V_201 && V_200 > V_201 ) {
F_31 ( V_208
L_12 ) ;
return 0 ;
}
if ( V_199 -> V_203 . V_206 && F_163 ( V_157 -> V_159 ) )
return 0 ;
if ( V_199 -> V_203 . V_206 > V_210 )
return 0 ;
return V_200 ;
}
static int F_170 ( struct V_3 * V_66 ,
union V_199 * V_199 ,
unsigned char * V_52 ,
unsigned long V_200 ,
T_2 * V_156 )
...
static int F_172 ( T_1 V_6 , unsigned char V_30 )
{
struct V_3 * V_66 ;
unsigned long V_5 , type ;
unsigned char V_79 ;
...
{
int V_15 = 0 ;
while ( ! V_15 && F_172 ( V_6 , 1 ) == - V_105 )
V_15 = F_175 ( V_6 , V_222 ) ;
return V_15 ;
}
int F_176 ( T_1 V_6 )
{
return F_172 ( V_6 , V_2 ) ;
}
struct V_3 * F_177 ( struct V_7 * V_7 )
{
T_1 V_175 = { . V_10 = F_41 (page) } ;
F_117 ( ! F_46 ( V_7 ) ) ;
return V_63 [ F_29 ( V_175 ) ] ;
}
struct V_150 * F_178 ( struct V_7 * V_7 )
{
F_33 ( ! F_46 ( V_7 ) ) ;
return F_177 ( V_7 ) -> V_149 -> V_152 ;
}
T_3 F_179 ( struct V_7 * V_7 )
{
T_1 V_175 = { . V_10 = F_41 (page) } ;
F_33 ( ! F_46 ( V_7 ) ) ;
return F_30 ( V_175 ) ;
}
int F_175 ( T_1 V_6 , T_13 V_223 )
{
struct V_3 * V_4 ;
struct V_7 * V_65 ;
struct V_7 * V_7 ;
