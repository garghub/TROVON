...
V_56 = F_32 ( V_46 ) -> V_63 ;
V_1 = F_33 ( V_56 -> V_64 , V_56 , V_57 , V_58 ) ;
V_7 = F_31 ( V_1 ) ;
if ( F_27 ( V_1 ) )
goto V_62;
...
T_7 V_70 = V_71 ;
for ( V_23 = 0 ; V_23 < V_38 ; V_23 ++ )
V_70 = ( V_70 ^ V_37 [ V_23 ] ) * V_72 ;
V_70 %= V_73 ;
if ( F_39 ( V_70 , V_74 ) )
return;
F_35 ( V_37 , V_38 ) ;
}
static T_1 F_40 ( int T_2 * V_75 , int V_38 ,
void T_2 * V_2 , T_3 V_3 , void T_2 * V_4 , T_3 V_5 )
{
int V_37 [ V_76 ] ;
int V_23 ;
...
return - V_6 ;
for ( V_23 = 0 ; V_23 < V_38 ; V_23 ++ )
if ( F_4 ( V_37 [ V_23 ] , V_75 + V_23 ) )
return - V_13 ;
F_38 ( V_37 , V_38 ) ;
return F_30 ( V_37 , V_38 , V_2 , V_3 , V_4 , V_5 ) ;
}
T_8 long F_41 ( struct V_77 T_2 * args )
{
struct V_77 V_54 ;
T_9 T_2 * V_78 ;
T_3 V_3 = 0 ;
...
return - V_13 ;
if ( V_54 . V_2 && ! V_54 . V_79 )
return - V_13 ;
V_78 = F_43 ( V_54 . V_79 ) ;
if ( V_78 && F_4 ( V_3 , V_78 ) )
return - V_13 ;
