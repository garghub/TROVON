...
{
int V_27 , V_28 ;
unsigned char * V_7 = V_20 -> V_29 ;
unsigned int V_30 = V_20 -> V_22 ;
...
case 0xff :
F_15 ( & V_2 -> V_25 , L_7 ) ;
F_12 ( V_19 , V_2 , V_7 [ V_28 ] ) ;
F_12 ( V_19 , V_2 , V_7 [ V_28 + 1 ] ) ;
V_28 += 2 ;
break;
}
if ( V_27 == 1 )
...
if ( V_20 -> V_22 )
F_20 ( V_19 , V_20 , V_8 , V_2 ) ;
F_23 ( V_2 -> V_21 , V_4 -> V_25 ,
F_24 ( V_4 -> V_25 ,
V_2 -> V_36 ) ,
V_2 -> V_21 -> V_29 ,
V_2 -> V_21 -> V_37 ,
F_22 , V_2 ) ;
V_32 = F_25 ( V_2 -> V_21 , V_38 ) ;
if ( V_32 )
F_15 ( & V_2 -> V_25 ,
L_12 ,
V_31 , V_32 ) ;
...
static int F_63 ( struct V_18 * V_19 , struct V_1 * V_2 ,
...
if ( F_73 ( V_19 ) || F_74 ( V_19 ) ) {
unsigned char V_78 = F_75 ( V_19 ) ;
unsigned char V_79 = F_76 ( V_19 ) ;
V_24 =
...
static void F_77 ( struct V_18 * V_19 , int V_192 )
{
struct V_1 * V_2 = V_19 -> V_140 ;
struct V_5 * V_4 = F_8 ( V_2 , V_31 ) ;
struct V_6 * V_8 ;
