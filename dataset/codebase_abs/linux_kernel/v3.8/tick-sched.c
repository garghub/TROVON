...
static int F_83 ( struct V_1 * V_16 , T_1 V_4 )
{
F_74 ( & V_16 -> V_54 , V_4 , V_9 ) ;
...
static void F_89 ( int V_2 , T_1 V_4 )
{
#if 0
...
static inline void F_90 ( int V_2 )
{
struct V_1 * V_16 = & F_2 ( V_3 , V_2 ) ;
T_1 V_4 ;
if ( ! V_16 -> V_28 && ! V_16 -> V_19 )
...
static enum V_75 F_93 ( struct V_76 * V_77 )
{
struct V_1 * V_16 =
F_94 ( V_77 , struct V_1 , V_54 ) ;
struct V_17 * V_18 = F_85 () ;
T_1 V_4 = F_33 () ;
F_14 ( V_4 ) ;
if ( V_18 )
