...
} else if ( V_22 -> type >= V_94 && V_22 -> type <= V_95 ) {
int V_96 ;
F_2 ( V_5 , V_75 , ( V_3 [ 3 ] & 0x01 ) ) ;
for ( V_96 = 0 ; V_96 < 8 ; V_96 ++ )
F_2 ( V_5 , V_76 + V_96 , V_3 [ 4 ] & ( 1 << V_96 ) ) ;
if ( V_3 [ 2 ] & 0x80 ) {
...
F_24 ( V_5 , V_123 , V_121 ) ;
if ( V_121 ) {
int V_114 = F_9 ( ( V_28 * ) & V_3 [ V_119 + V_136 + 7 ] ) ;
int V_115 = F_9 ( ( V_28 * ) & V_3 [ V_119 + V_136 + 9 ] ) ;
F_3 ( V_5 , V_130 , V_114 ) ;
F_3 ( V_5 , V_131 , V_115 ) ;
}
V_2 -> V_110 [ V_122 ] = V_121 ? V_9 : - 1 ;
...
int V_140 = V_3 [ 1 ] & ( 1 << V_96 ) ;
bool V_121 = V_140 && ! V_2 -> V_50 -> V_51 ;
F_23 ( V_5 , V_96 ) ;
F_24 ( V_5 , V_123 , V_121 ) ;
if ( V_121 ) {
...
V_2 -> V_50 -> V_141 = ( V_139 > 0 ) ;
F_25 ( V_5 , true ) ;
return 1 ;
}
static int F_28 ( struct V_1 * V_2 , T_1 V_142 )
{
char * V_3 = V_2 -> V_3 ;
struct V_4 * V_5 = V_2 -> V_5 ;
bool V_23 ;
int V_114 = 0 , V_115 = 0 ;
if ( V_2 -> V_22 . V_109 > 1 || V_142 > V_143 )
return 0 ;
if ( ! V_2 -> V_50 -> V_51 ) {
if ( V_142 == V_144 ) {
V_23 = V_3 [ 0 ] & 0x01 ;
...
static int F_30 ( struct V_1 * V_2 , T_1 V_142 )
{
char * V_3 = V_2 -> V_3 ;
...
int V_152 = V_3 [ 5 ] ;
int V_153 = F_34 ( V_5 , V_13 ) ;
int V_154 = F_34 ( V_5 , V_14 ) ;
int V_155 = 2 * F_20 ( V_152 * V_156 ) ;
int V_157 = V_155 * V_154 / V_153 ;
F_3 ( V_5 , V_130 , V_114 ) ;
F_3 ( V_5 , V_131 , V_115 ) ;
F_3 ( V_5 , V_132 , V_155 ) ;
F_3 ( V_5 , V_158 , V_157 ) ;
...
struct V_4 * V_5 = V_2 -> V_5 ;
unsigned char * V_3 = V_2 -> V_3 ;
int V_159 = V_3 [ 1 ] & 0x07 ;
int V_96 ;
if ( V_3 [ 0 ] != 0x02 )
return 0 ;
for ( V_96 = 0 ; V_96 < V_159 ; V_96 ++ ) {
int V_119 = ( 8 * V_96 ) + 2 ;
int V_160 = V_3 [ V_119 ] ;
if ( V_160 >= 2 && V_160 <= 17 )
F_33 ( V_2 , V_3 + V_119 ) ;
...
struct V_4 * V_5 = V_2 -> V_5 ;
unsigned char * V_3 = V_2 -> V_3 ;
int V_23 = 0 , V_114 = 0 , V_115 = 0 , V_140 = 0 , V_161 = 0 , V_162 = 0 , V_163 = 0 , V_164 = 0 ;
if ( V_3 [ 0 ] != 0x02 )
return 0 ;
...
V_114 = F_9 ( ( V_28 * ) & V_3 [ 2 ] ) ;
V_115 = F_9 ( ( V_28 * ) & V_3 [ 4 ] ) ;
V_140 = F_9 ( ( V_28 * ) & V_3 [ 6 ] ) ;
if ( V_3 [ 8 ] <= V_2 -> V_22 . V_165 )
V_161 = V_2 -> V_22 . V_165 - V_3 [ 8 ] ;
V_162 = V_3 [ 1 ] & 0x01 ;
V_163 = V_3 [ 1 ] & 0x02 ;
V_164 = V_3 [ 1 ] & 0x04 ;
}
...
static int F_38 ( struct V_1 * V_2 , T_1 V_142 )
{
if ( V_142 == V_166 )
return F_31 ( V_2 ) ;
else if ( V_142 == V_167 )
return F_36 ( V_2 ) ;
else if ( V_142 == V_168 || V_142 == V_169 )
return F_37 ( V_2 ) ;
return 0 ;
}
static int F_39 ( struct V_1 * V_2 , T_1 V_142 )
{
unsigned char * V_3 = V_2 -> V_3 ;
int V_170 ;
if ( V_142 != V_171 || V_3 [ 0 ] != 0x80 )
return 0 ;
V_170 = V_3 [ 1 ] & 0x01 ;
if ( V_170 ) {
int V_172 , V_173 ;
...
void F_41 ( struct V_1 * V_1 , T_1 V_142 )
{
bool V_175 ;
...
case V_186 :
case V_137 :
V_175 = F_30 ( V_1 , V_142 ) ;
break;
case V_187 :
V_175 = F_38 ( V_1 , V_142 ) ;
break;
case V_188 :
V_175 = F_39 ( V_1 , V_142 ) ;
break;
default:
V_175 = false ;
break;
...
{
if ( V_22 -> V_191 == V_192 && ! V_22 -> V_193 ) {
V_22 -> V_193 = 1023 ;
V_22 -> V_194 = 1023 ;
}
if ( V_22 -> type >= V_188 ||
( V_22 -> type >= V_94 && V_22 -> type <= V_95 ) ||
( V_22 -> V_195 && V_22 -> V_196 ) )
V_22 -> V_48 |= V_49 ;
if ( V_22 -> type == V_187 &&
V_22 -> V_197 == V_166 ) {
V_22 -> V_193 <<= 5 ;
...
static unsigned int F_48 ( unsigned int V_202 ,
unsigned int V_203 )
{
return ( V_202 * 100 ) / V_203 ;
}
...
int V_96 ;
V_4 -> V_204 [ 0 ] |= F_50 ( V_205 ) | F_50 ( V_206 ) ;
F_44 ( V_16 , V_4 -> V_189 ) ;
F_45 ( V_4 , V_13 , 0 , V_22 -> V_193 ,
V_22 -> V_198 , 0 ) ;
F_45 ( V_4 , V_14 , 0 , V_22 -> V_194 ,
V_22 -> V_199 , 0 ) ;
if ( V_22 -> V_191 == V_8 ) {
F_45 ( V_4 , V_15 , 0 , V_22 -> V_26 ,
V_22 -> V_207 , 0 ) ;
F_51 ( V_4 , V_13 , V_22 -> V_208 ) ;
F_51 ( V_4 , V_14 , V_22 -> V_209 ) ;
} else {
F_51 ( V_4 , V_13 ,
F_48 ( V_22 -> V_193 ,
V_22 -> V_210 ) ) ;
...
F_45 ( V_4 , V_65 , - 900 , 899 , 0 , 0 ) ;
F_46 ( V_1 ) ;
} else if ( V_22 -> V_191 == V_192 ) {
F_52 ( V_12 , V_4 -> V_212 ) ;
F_44 ( V_192 , V_4 -> V_189 ) ;
F_44 ( V_216 , V_4 -> V_189 ) ;
F_44 ( V_217 , V_4 -> V_189 ) ;
F_44 ( V_218 , V_4 -> V_189 ) ;
...
case V_182 :
if ( V_22 -> V_191 == V_192 ) {
F_45 ( V_4 , V_132 , 0 , V_22 -> V_193 , 0 , 0 ) ;
F_45 ( V_4 , V_133 , 0 , V_22 -> V_193 , 0 , 0 ) ;
F_45 ( V_4 , V_134 , 0 , V_22 -> V_194 , 0 , 0 ) ;
