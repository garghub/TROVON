...
static T_1 F_23 ( int V_109 , void * V_110 )
{
...
static inline int F_32 ( struct V_15 * V_16 )
{
struct V_1 * V_2 = F_4 ( V_16 ) ;
volatile struct V_3 * V_4 = V_2 -> V_4 ;
int V_86 ;
...
if ( F_35 ( V_77 , V_131 ) )
return V_129 ;
V_128 = F_36 ( unsigned , V_77 -> V_75 , V_131 ) ;
F_37 ( V_130 ) ;
if ( ! F_22 ( V_2 ) ) {
F_38 ( V_130 ) ;
return V_132 ;
...
int V_159 ;
V_157 = F_50 ( V_153 , sizeof( struct V_3 ) ,
L_17 ) ;
if ( ! V_157 )
return - V_160 ;
V_158 = F_50 ( V_155 , V_161 , L_18 ) ;
if ( ! V_158 ) {
F_51 ( V_153 , sizeof( struct V_3 ) ) ;
return - V_160 ;
}
...
V_16 -> V_26 [ 3 ] = ( V_146 -> V_165 . V_166 >> 16 ) & 0xff ;
V_16 -> V_26 [ 4 ] = ( V_146 -> V_165 . V_166 >> 8 ) & 0xff ;
V_16 -> V_26 [ 5 ] = V_146 -> V_165 . V_166 & 0xff ;
V_16 -> V_153 = F_53 ( V_153 ) ;
V_16 -> V_155 = F_53 ( V_155 ) ;
V_16 -> V_167 = V_16 -> V_155 + V_161 ;
...
F_61 ( V_16 ) ;
F_51 ( F_62 ( V_16 -> V_153 ) ,
sizeof( struct V_3 ) ) ;
F_51 ( F_62 ( V_16 -> V_155 ) , V_161 ) ;
F_56 ( V_16 ) ;
}
