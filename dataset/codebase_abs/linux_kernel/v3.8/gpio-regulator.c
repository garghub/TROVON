...
V_26 -> V_7 [ V_31 ] . V_10 =
F_16 ( ( int * ) V_28 -> V_10 + ( V_31 * 2 ) ) ;
V_26 -> V_7 [ V_31 ] . V_8 =
F_16 ( ( int * ) V_28 -> V_10 + ( V_31 * 2 + 1 ) ) ;
}
V_26 -> V_6 = V_31 ;
F_17 ( V_25 , L_8 , & V_29 ) ;
...
V_50 -> V_54 . V_37 = F_21 ( V_26 -> V_35 , V_32 ) ;
if ( V_50 -> V_54 . V_37 == NULL ) {
F_15 ( & V_47 -> V_2 , L_12 ) ;
V_53 = - V_33 ;
goto V_55;
}
V_50 -> V_8 = F_22 ( V_26 -> V_8 ,
...
V_50 -> V_2 = F_24 ( & V_50 -> V_54 , & V_52 ) ;
if ( F_19 ( V_50 -> V_2 ) ) {
V_53 = F_20 ( V_50 -> V_2 ) ;
F_15 ( & V_47 -> V_2 , L_17 , V_53 ) ;
goto V_73;
}
F_25 ( V_47 , V_50 ) ;
return 0 ;
V_73:
F_26 ( V_50 -> V_8 , V_50 -> V_18 ) ;
V_65:
F_27 ( V_50 -> V_7 ) ;
V_57:
F_27 ( V_50 -> V_8 ) ;
