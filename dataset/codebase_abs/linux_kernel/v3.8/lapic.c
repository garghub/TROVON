...
static void F_131 ( struct V_1 * V_2 , T_1 V_195 )
{
...
static int F_132 ( struct V_1 * V_2 , T_1 V_62 , T_1 V_4 )
{
int V_112 = 0 ;
F_133 ( V_62 , V_4 ) ;
switch ( V_62 ) {
...
case V_209 :
if ( F_25 ( V_2 ) ) {
F_132 ( V_2 , V_137 , 0x40000 | ( V_4 & 0xff ) ) ;
} else
V_112 = 1 ;
break;
default:
...
static int F_135 ( struct V_164 * V_171 ,
...
F_132 ( V_2 , V_160 & 0xff0 , V_4 ) ;
return 0 ;
}
void F_136 ( struct V_29 * V_12 )
{
if ( F_51 ( V_12 ) )
F_132 ( V_12 -> V_13 . V_2 , V_199 , 0 ) ;
}
void F_137 ( struct V_29 * V_12 )
{
struct V_1 * V_2 = V_12 -> V_13 . V_2 ;
if ( ! V_12 -> V_13 . V_2 )
return;
...
F_20 ( & V_10 ) ;
if ( V_2 -> V_5 )
F_138 ( ( unsigned long ) V_2 -> V_5 ) ;
F_139 ( V_2 ) ;
}
T_6 F_140 ( struct V_29 * V_12 )
{
struct V_1 * V_2 = V_12 -> V_13 . V_2 ;
...
void F_141 ( struct V_29 * V_12 , T_6 V_80 )
{
struct V_1 * V_2 = V_12 -> V_13 . V_2 ;
if ( ! F_51 ( V_12 ) || F_46 ( V_2 ) ||
F_47 ( V_2 ) )
...
void F_142 ( struct V_29 * V_12 , unsigned long V_212 )
{
struct V_1 * V_2 = V_12 -> V_13 . V_2 ;
if ( ! F_51 ( V_12 ) )
return;
...
void F_144 ( struct V_29 * V_12 , T_6 V_213 )
{
struct V_1 * V_2 = V_12 -> V_13 . V_2 ;
if ( ! V_2 ) {
V_213 |= V_214 ;
...
int F_149 ( struct V_29 * V_12 )
{
struct V_1 * V_2 = V_12 -> V_13 . V_2 ;
if ( F_51 ( V_12 ) && F_22 ( V_2 ) &&
F_44 ( V_2 , V_45 ) )
return F_150 ( & V_2 -> V_46 . V_179 ) ;
return 0 ;
}
int F_151 ( struct V_1 * V_2 , int V_42 )
{
...
F_156 ( V_224 ) ;
if ( F_148 ( V_2 ) ) {
F_157 ( & V_223 -> V_148 , V_223 -> V_149 ) ;
return V_227 ;
} else
return V_228 ;
}
int F_158 ( struct V_29 * V_12 )
{
struct V_1 * V_2 ;
ASSERT ( V_12 != NULL ) ;
...
V_2 -> V_12 = V_12 ;
F_160 ( & V_2 -> V_46 . V_148 , V_231 ,
V_184 ) ;
V_2 -> V_46 . V_148 . V_232 = F_153 ;
V_12 -> V_13 . V_14 = V_210 ;
F_144 ( V_12 ,
V_233 | V_210 ) ;
F_21 ( & V_10 . V_11 ) ;
F_146 ( V_12 ) ;
F_161 ( & V_2 -> V_165 , & V_234 ) ;
return 0 ;
V_230:
F_139 ( V_2 ) ;
V_229:
...
void F_165 ( struct V_29 * V_12 )
{
struct V_1 * V_2 = V_12 -> V_13 . V_2 ;
if ( ! F_51 ( V_12 ) )
return;
if ( F_150 ( & V_2 -> V_46 . V_179 ) > 0 ) {
if ( F_151 ( V_2 , V_45 ) )
F_166 ( & V_2 -> V_46 . V_179 ) ;
}
}
int F_167 ( struct V_29 * V_12 )
{
int V_76 = F_162 ( V_12 ) ;
struct V_1 * V_2 = V_12 -> V_13 . V_2 ;
if ( V_76 == - 1 )
...
static void F_171 ( struct V_29 * V_12 ,
struct V_1 * V_2 )
{
bool V_179 ;
int V_76 ;
...
void F_173 ( struct V_29 * V_12 )
{
T_1 V_80 ;
void * V_239 ;
if ( F_9 ( V_85 , & V_12 -> V_13 . V_86 ) )
F_171 ( V_12 , V_12 -> V_13 . V_2 ) ;
if ( ! F_9 ( V_240 , & V_12 -> V_13 . V_86 ) )
return;
V_239 = F_174 ( V_12 -> V_13 . V_2 -> V_241 ) ;
V_80 = * ( T_1 * ) ( V_239 + F_175 ( V_12 -> V_13 . V_2 -> V_242 ) ) ;
F_176 ( V_239 ) ;
F_81 ( V_12 -> V_13 . V_2 , V_80 & 0xff ) ;
}
static void F_177 ( struct V_29 * V_12 ,
struct V_1 * V_2 )
{
if ( ! F_70 ( V_12 ) ||
V_2 -> V_66 ||
...
V_239 = F_174 ( V_12 -> V_13 . V_2 -> V_241 ) ;
* ( T_1 * ) ( V_239 + F_175 ( V_12 -> V_13 . V_2 -> V_242 ) ) = V_80 ;
F_176 ( V_239 ) ;
}
void F_179 ( struct V_29 * V_12 , T_7 V_242 )
{
...
int F_180 ( struct V_29 * V_12 , T_1 V_245 , T_6 V_80 )
{
struct V_1 * V_2 = V_12 -> V_13 . V_2 ;
T_1 V_62 = ( V_245 - V_246 ) << 4 ;
if ( ! F_181 ( V_12 -> V_26 ) || ! F_25 ( V_2 ) )
return 1 ;
if ( V_245 == 0x830 )
F_132 ( V_2 , V_139 , ( T_1 ) ( V_80 >> 32 ) ) ;
return F_132 ( V_2 , V_62 , ( T_1 ) V_80 ) ;
}
int F_182 ( struct V_29 * V_12 , T_1 V_245 , T_6 * V_80 )
{
struct V_1 * V_2 = V_12 -> V_13 . V_2 ;
...
int F_184 ( struct V_29 * V_12 , T_1 V_62 , T_6 * V_80 )
{
struct V_1 * V_2 = V_12 -> V_13 . V_2 ;
T_1 V_247 , V_248 = 0 ;
if ( ! F_51 ( V_12 ) )
...
int F_185 ( struct V_29 * V_12 , T_6 V_80 )
{
T_6 V_169 = V_80 & ~ V_82 ;
if ( ! F_186 ( V_169 , 4 ) )
return 1 ;
...
if ( ! F_70 ( V_12 ) )
return 0 ;
return F_187 ( V_12 -> V_26 , & V_12 -> V_13 . V_79 . V_80 ,
V_169 ) ;
}
void F_188 ( void )
{
