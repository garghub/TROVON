...
V_250 = V_73 ;
F_62 ( V_68 , V_250 ) ;
if ( ( V_44 & V_251 ) && F_138 ( V_68 ) )
V_244 = V_68 -> V_85 . V_89 ;
if ( F_56 ( V_2 , V_68 ) ) {
...
ASSERT ( V_68 -> V_88 ) ;
V_248 = F_49 ( V_68 -> V_88 ) ;
}
}
if ( ( V_44 & V_47 ) && F_37 ( V_2 ) ) {
if ( V_68 -> V_85 . V_89 != V_244 ) {
F_63 ( V_68 , V_250 ) ;
...
ASSERT ( V_68 -> V_90 ) ;
V_249 = F_49 ( V_68 -> V_90 ) ;
}
} else if ( ( V_44 & V_49 ) && F_38 ( V_2 ) ) {
if ( F_59 ( V_68 ) != V_245 ) {
F_63 ( V_68 , V_250 ) ;
if ( ( error = F_50 ( V_2 , NULL , ( T_5 ) V_245 ,
V_50 ,
V_87 |
V_75 ,
& V_249 ) ) ) {
...
ASSERT ( V_254 ) ;
ASSERT ( V_254 != V_253 ) ;
F_141 ( V_140 , V_254 , V_255 , - ( V_68 -> V_85 . V_176 ) ) ;
F_141 ( V_140 , V_254 , V_258 , - 1 ) ;
F_141 ( V_140 , V_253 , V_255 , V_68 -> V_85 . V_176 ) ;
F_141 ( V_140 , V_253 , V_258 , 1 ) ;
* V_252 = F_49 ( V_253 ) ;
return V_254 ;
}
int
...
{
T_3 * V_2 = V_68 -> V_74 ;
T_2 V_260 , V_261 , V_262 = 0 ;
T_6 * V_263 , * V_264 , * V_265 , * V_266 ;
int error ;
ASSERT ( F_47 ( V_68 , V_73 | V_180 ) ) ;
ASSERT ( F_32 ( V_2 ) ) ;
V_260 = V_68 -> V_211 ;
V_265 = V_266 = V_263 = V_264 = NULL ;
V_261 = F_112 ( V_68 ) ?
V_267 : V_268 ;
if ( F_36 ( V_2 ) && V_259 &&
V_68 -> V_85 . V_86 != ( T_21 ) F_7 ( V_259 -> V_20 . V_21 ) ) {
V_265 = V_259 ;
if ( V_260 ) {
ASSERT ( V_68 -> V_88 ) ;
V_263 = V_68 -> V_88 ;
...
V_265 , V_266 , ( T_15 ) V_260 , 0 ,
V_44 | V_261 | V_262 ) ) )
return ( error ) ;
F_143 ( NULL , V_68 -> V_74 ,
V_263 , V_264 , - ( ( T_15 ) V_260 ) , 0 ,
V_261 ) ;
}
return ( 0 ) ;
}
...
struct V_80 * * V_270 )
{
struct V_1 * V_2 = V_270 [ 0 ] -> V_74 ;
int V_18 ;
if ( ! F_32 ( V_2 ) || ! F_55 ( V_2 ) )
return 0 ;
for ( V_18 = 0 ; ( V_18 < 4 && V_270 [ V_18 ] ) ; V_18 ++ ) {
struct V_80 * V_68 = V_270 [ V_18 ] ;
int error ;
if ( V_18 == 0 || V_68 != V_270 [ V_18 - 1 ] ) {
if ( F_56 ( V_2 , V_68 ) ) {
error = F_61 ( V_68 , 0 ) ;
if ( error )
return error ;
...
ASSERT ( F_36 ( V_2 ) ) ;
ASSERT ( V_68 -> V_85 . V_86 == F_7 ( V_259 -> V_20 . V_21 ) ) ;
V_68 -> V_88 = F_49 ( V_259 ) ;
F_141 ( V_140 , V_259 , V_258 , 1 ) ;
}
if ( V_25 ) {
