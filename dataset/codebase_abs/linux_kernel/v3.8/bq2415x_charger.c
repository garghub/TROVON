...
F_29 ( V_2 , V_118 ) ;
V_2 -> V_122 = V_122 ;
F_32 ( & V_2 -> V_123 . V_6 -> V_129 , NULL , L_5 ) ;
return 0 ;
}
...
if ( V_2 -> V_131 < 1 )
return;
F_32 ( & V_2 -> V_123 . V_6 -> V_129 , NULL , L_7 ) ;
F_30 ( V_2 , V_2 -> V_130 ) ;
}
static void F_34 ( struct V_1 * V_2 , int V_132 )
{
F_3 ( & V_133 ) ;
if ( V_2 -> V_134 == V_132 ) {
F_6 ( & V_133 ) ;
...
{
V_2 -> V_99 = V_8 ;
F_32 ( & V_2 -> V_123 . V_6 -> V_129 , NULL , L_8 ) ;
F_38 ( V_2 -> V_6 , L_9 , V_8 ) ;
if ( V_2 -> V_131 > 0 )
V_2 -> V_131 = 0 ;
F_30 ( V_2 , V_128 ) ;
F_34 ( V_2 , 0 ) ;
}
static void F_39 ( struct V_138 * V_135 )
{
struct V_1 * V_2 = F_40 ( V_135 , struct V_1 ,
V_135 . V_135 ) ;
int V_10 ;
int error ;
int V_124 ;
...
union V_143 * V_9 )
{
struct V_1 * V_2 = F_40 ( V_140 , struct V_1 ,
V_123 ) ;
int V_10 ;
switch ( V_142 ) {
case V_144 :
...
int V_81 ;
char V_153 [ 8 ] ;
V_2 -> V_123 . V_154 = V_2 -> V_154 ;
V_2 -> V_123 . type = V_155 ;
V_2 -> V_123 . V_156 = V_157 ;
V_2 -> V_123 . V_158 = F_5 ( V_157 ) ;
V_2 -> V_123 . V_159 = F_41 ;
V_10 = F_14 ( V_2 ) ;
if ( V_10 < 0 )
V_81 = V_90 ;
else
...
sprintf ( V_153 , L_22 , V_10 ) ;
V_2 -> V_152 = F_43 ( V_160 ,
L_23 ,
V_161 [ V_81 ] , V_153 ,
F_16 ( V_2 ) ) ;
if ( ! V_2 -> V_152 ) {
...
static T_2 F_48 ( struct V_163 * V_6 ,
struct V_164 * V_165 ,
char * V_15 )
{
struct V_139 * V_140 = F_49 ( V_6 ) ;
struct V_1 * V_2 = F_40 ( V_140 , struct V_1 ,
V_123 ) ;
enum V_25 V_26 ;
int V_10 ;
if ( strcmp ( V_165 -> V_165 . V_154 , L_25 ) == 0 )
V_26 = V_30 ;
else if ( strcmp ( V_165 -> V_165 . V_154 , L_26 ) == 0 )
V_26 = V_36 ;
else if ( strcmp ( V_165 -> V_165 . V_154 , L_27 ) == 0 )
V_26 = V_39 ;
else if ( strcmp ( V_165 -> V_165 . V_154 , L_28 ) == 0 )
V_26 = V_41 ;
else
return - V_21 ;
V_10 = F_13 ( V_2 , V_26 ) ;
if ( V_10 < 0 )
return V_10 ;
return sprintf ( V_15 , L_29 , V_10 ) ;
}
static T_2 F_50 ( struct V_163 * V_6 ,
struct V_164 * V_165 ,
const char * V_15 ,
T_3 V_166 )
{
...
V_123 ) ;
int V_10 = 0 ;
if ( strncmp ( V_15 , L_30 , 4 ) == 0 )
F_34 ( V_2 , 1 ) ;
else if ( strncmp ( V_15 , L_31 , 3 ) == 0 )
F_34 ( V_2 , 0 ) ;
else
V_10 = F_13 ( V_2 , V_27 ) ;
if ( V_10 < 0 )
...
static T_2 F_51 ( struct V_163 * V_6 ,
struct V_164 * V_165 ,
char * V_15 )
{
struct V_139 * V_140 = F_49 ( V_6 ) ;
...
if ( V_2 -> V_134 )
return sprintf ( V_15 , L_32 ) ;
return sprintf ( V_15 , L_33 ) ;
}
static T_2 F_52 ( struct V_163 * V_6 ,
struct V_164 * V_165 ,
const char * V_15 ,
T_3 V_166 )
{
...
V_2 -> V_131 = 0 ;
V_122 = V_125 ;
} else if ( strncmp ( V_15 , L_36 , 9 ) == 0 ) {
if ( V_2 -> V_131 > 0 )
V_2 -> V_131 = 0 ;
V_122 = V_126 ;
} else if ( strncmp ( V_15 , L_37 , 5 ) == 0 ) {
if ( V_2 -> V_131 > 0 )
V_2 -> V_131 = 0 ;
V_122 = V_127 ;
...
static T_2 F_53 ( struct V_163 * V_6 ,
struct V_164 * V_165 ,
char * V_15 )
{
struct V_139 * V_140 = F_49 ( V_6 ) ;
...
T_2 V_10 = 0 ;
if ( V_2 -> V_131 > 0 )
V_10 += sprintf ( V_15 + V_10 , L_39 ) ;
switch ( V_2 -> V_122 ) {
case V_128 :
V_10 += sprintf ( V_15 + V_10 , L_34 ) ;
break;
case V_125 :
...
static T_2 F_54 ( struct V_163 * V_6 ,
struct V_164 * V_165 ,
char * V_15 )
{
struct V_139 * V_140 = F_49 ( V_6 ) ;
...
static T_2 F_55 ( struct V_163 * V_6 ,
struct V_164 * V_165 ,
const char * V_15 ,
T_3 V_166 )
{
...
if ( V_10 < 0 )
return sprintf ( V_15 , L_47 , V_3 , V_10 ) ;
return sprintf ( V_15 , L_48 , V_3 , V_10 ) ;
}
static T_2 F_57 ( struct V_163 * V_6 ,
struct V_164 * V_165 ,
char * V_15 )
{
struct V_139 * V_140 = F_49 ( V_6 ) ;
...
static T_2 F_58 ( struct V_163 * V_6 ,
struct V_164 * V_165 ,
const char * V_15 ,
T_3 V_166 )
{
...
return - V_21 ;
if ( strcmp ( V_165 -> V_165 . V_154 , L_49 ) == 0 )
V_10 = F_18 ( V_2 , V_9 ) ;
else if ( strcmp ( V_165 -> V_165 . V_154 , L_50 ) == 0 )
V_10 = F_20 ( V_2 , V_9 ) ;
else if ( strcmp ( V_165 -> V_165 . V_154 , L_51 ) == 0 )
V_10 = F_22 ( V_2 , V_9 ) ;
else if ( strcmp ( V_165 -> V_165 . V_154 , L_52 ) == 0 )
V_10 = F_24 ( V_2 , V_9 ) ;
else if ( strcmp ( V_165 -> V_165 . V_154 , L_53 ) == 0 )
V_10 = F_26 ( V_2 , V_9 ) ;
else
return - V_21 ;
if ( V_10 < 0 )
...
static T_2 F_60 ( struct V_163 * V_6 ,
struct V_164 * V_165 ,
char * V_15 )
{
struct V_139 * V_140 = F_49 ( V_6 ) ;
...
static T_2 F_61 ( struct V_163 * V_6 ,
struct V_164 * V_165 ,
const char * V_15 ,
T_3 V_166 )
{
...
if ( F_59 ( V_15 , 10 , & V_9 ) < 0 )
return - V_21 ;
if ( strcmp ( V_165 -> V_165 . V_154 , L_54 ) == 0 )
V_26 = V_9 ? V_47 :
V_48 ;
else if ( strcmp ( V_165 -> V_165 . V_154 , L_55 ) == 0 )
V_26 = V_9 ? V_55 :
V_56 ;
else if ( strcmp ( V_165 -> V_165 . V_154 , L_56 ) == 0 )
V_26 = V_9 ? V_68 :
V_69 ;
else if ( strcmp ( V_165 -> V_165 . V_154 , L_57 ) == 0 )
V_26 = V_9 ? V_34 :
V_35 ;
else
return - V_21 ;
...
static T_2 F_62 ( struct V_163 * V_6 ,
struct V_164 * V_165 ,
char * V_15 )
{
struct V_139 * V_140 = F_49 ( V_6 ) ;
...
{
return F_64 ( & V_2 -> V_123 . V_6 -> V_129 ,
& V_167 ) ;
}
static void F_65 ( struct V_1 * V_2 )
{
F_66 ( & V_2 -> V_123 . V_6 -> V_129 , & V_167 ) ;
}
...
V_10 = F_68 ( & V_172 , V_160 ) ;
if ( V_10 == 0 )
return - V_162 ;
F_3 ( & V_173 ) ;
V_10 = F_69 ( & V_172 , V_5 , & V_170 ) ;
F_6 ( & V_173 ) ;
if ( V_10 < 0 )
return V_10 ;
V_154 = F_43 ( V_160 , L_59 , V_169 -> V_154 , V_170 ) ;
if ( ! V_154 ) {
F_38 ( & V_5 -> V_6 , L_60 ) ;
V_10 = - V_162 ;
goto V_174;
}
V_2 = F_70 ( sizeof( * V_2 ) , V_160 ) ;
if ( ! V_2 ) {
F_38 ( & V_5 -> V_6 , L_61 ) ;
V_10 = - V_162 ;
goto V_175;
...
V_2 -> V_169 = V_170 ;
V_2 -> V_6 = & V_5 -> V_6 ;
V_2 -> V_81 = V_169 -> V_176 ;
V_2 -> V_154 = V_154 ;
V_2 -> V_122 = V_128 ;
V_2 -> V_130 = V_128 ;
V_2 -> V_134 = 0 ;
V_2 -> V_131 = 0 ;
memcpy ( & V_2 -> V_108 , V_5 -> V_6 . V_171 ,
sizeof( V_2 -> V_108 ) ) ;
F_17 ( V_2 ) ;
V_10 = F_42 ( V_2 ) ;
if ( V_10 ) {
F_38 ( V_2 -> V_6 , L_62 , V_10 ) ;
goto V_177;
}
V_10 = F_63 ( V_2 ) ;
if ( V_10 ) {
