...
{
int V_12 ;
if ( ! F_115 ( F_116 ( V_225 ) -> V_227 , V_228 ) )
return - V_229 ;
switch ( V_226 ) {
case V_230 :
...
static int
F_118 ( struct V_136 * V_136 , struct V_232 T_4 * V_189 ,
int * V_110 )
{
int V_12 ;
struct V_232 V_190 ;
...
if ( V_12 != 0 )
goto V_241;
V_240 = F_124 ( V_136 , V_84 , & V_239 , V_121 ) ;
if ( F_48 ( V_240 ) ) {
V_12 = F_49 ( V_240 ) ;
goto V_241;
}
...
static inline bool
F_127 ( T_7 V_244 , T_7 V_245 , T_7 V_246 ,
T_7 type , T_7 V_247 ,
bool V_248 )
{
return ( ( V_244 == 0xFF ) ||
...
if ( V_40 -> V_94 != 0 )
return false ;
V_250 = F_129 ( V_38 , V_40 -> V_97 , sizeof( V_251 ) , & V_251 ) ;
if ( V_250 == NULL ) {
F_8 ( L_65 ) ;
V_40 -> V_98 = true ;
return false ;
}
return F_127 ( V_253 -> type ,
V_253 -> V_247 [ 0 ] ,
V_253 -> V_247 [ 1 ] ,
...
if ( V_12 < 0 )
goto V_256;
V_12 = F_137 ( V_257 , F_138 ( V_257 ) ) ;
if ( V_12 < 0 )
goto V_258;
V_12 = F_139 ( V_259 , F_138 ( V_259 ) ) ;
if ( V_12 < 0 )
goto V_260;
V_12 = F_140 ( & V_261 ) ;
if ( V_12 < 0 )
...
return 0 ;
V_262:
F_142 ( V_259 , F_138 ( V_259 ) ) ;
V_260:
F_143 ( V_257 , F_138 ( V_257 ) ) ;
V_258:
F_144 ( & V_255 ) ;
V_256:
return V_12 ;
