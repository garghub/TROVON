...
* F_145 ( struct V_126 * V_127 )
{
unsigned int V_128 ;
for ( V_128 = 0 ; V_128 < F_146 ( V_460 ) ; V_128 ++ )
if ( V_127 -> V_461 == V_460 [ V_128 ] . V_462 )
return & V_460 [ V_128 ] ;
return NULL ;
}
...
V_17 = F_19 ( V_15 ) ;
V_32 = F_149 ( sizeof( * V_32 ) , V_467 ) ;
if ( ! V_32 )
return - V_132 ;
V_15 -> V_33 = V_32 ;
if ( F_150 ( V_127 , V_15 -> V_468 -> V_469 ) ) {
F_151 ( V_15 -> V_199 ,
L_75 ) ;
return - V_470 ;
}
F_152 ( V_127 ) ;
V_15 -> V_471 = V_17 -> V_472 ;
V_15 -> V_380 = F_153 ( V_127 , V_473 ) ;
V_32 -> V_474 =
F_153 ( V_127 , V_475 ) ;
V_32 -> V_476 = V_15 -> V_380 ;
V_32 -> V_477 =
F_153 ( V_127 , V_478 ) ;
V_32 -> V_36 =
F_154 ( V_32 -> V_474 ,
...
F_33 ( L_79 ,
V_32 -> V_201 ) ;
V_464 = F_36 ( V_32 -> V_36 + V_479 ) &
V_480 ;
V_465 = F_36 ( V_32 -> V_36 + V_481 ) &
V_464 & V_482 ;
V_32 -> V_145 = ( ( T_3 ) V_32 -> V_476 &
~ V_464 ) | V_465 ;
V_464 = F_36 ( V_32 -> V_36 + V_483 ) &
V_480 ;
V_465 = F_36 ( V_32 -> V_36 + V_484 ) &
V_464 & V_482 ;
V_32 -> V_143 = ( ( T_3 ) V_32 -> V_477 &
~ V_464 ) | V_465 ;
F_33 ( L_80 , V_32 -> V_145 ) ;
F_33 ( L_81 , V_32 -> V_143 ) ;
V_109 = F_44 ( V_15 ) ;
if ( V_109 < 0 )
return V_109 ;
V_32 -> F_22 =
...
F_35 ( V_15 ) ;
F_43 ( V_15 ) ;
if ( F_156 ( V_127 -> V_344 , F_111 , V_485 ,
L_83 , V_15 ) ) {
F_64 ( V_15 -> V_199 , L_84 ,
V_127 -> V_344 ) ;
return - V_204 ;
}
V_15 -> V_344 = V_127 -> V_344 ;
F_64 ( V_15 -> V_199 , L_85 , V_15 -> V_344 ) ;
V_109 = F_142 ( V_15 ) ;
if ( V_109 < 0 )
return V_109 ;
return 0 ;
...
if ( V_15 -> V_421 )
F_161 ( V_15 , & V_15 -> V_421 [ 4 ] ) ;
if ( V_127 ) {
if ( V_15 -> V_380 )
F_162 ( V_127 ) ;
}
}
static int F_163 ( struct V_126 * V_15 ,
const struct V_486 * V_487 )
{
return F_164 ( V_15 , & V_488 ) ;
}
static void F_165 ( struct V_126 * V_15 )
{
F_166 ( V_15 ) ;
}
