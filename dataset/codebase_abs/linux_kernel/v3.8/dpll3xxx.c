...
V_9 <<= F_3 ( V_5 -> V_15 ) ;
while ( ( ( F_2 ( V_5 -> V_16 ) & V_5 -> V_15 ) != V_9 ) &&
V_10 < V_17 ) {
V_10 ++ ;
F_7 ( 1 ) ;
}
...
unsigned long F_25 ( struct V_50 * V_14 , unsigned long V_51 )
{
struct V_1 * V_2 = F_26 ( V_14 ) ;
return F_27 ( V_2 ) ;
}
int F_28 ( struct V_50 * V_14 )
{
struct V_1 * V_2 = F_26 ( V_14 ) ;
int V_24 ;
struct V_4 * V_5 ;
...
void F_32 ( struct V_50 * V_14 )
{
struct V_1 * V_2 = F_26 ( V_14 ) ;
F_17 ( V_2 ) ;
if ( V_2 -> V_53 )
F_33 ( V_2 -> V_53 , V_14 -> V_2 ) ;
}
int F_34 ( struct V_50 * V_14 , unsigned long V_57 ,
unsigned long V_51 )
{
struct V_1 * V_2 = F_26 ( V_14 ) ;
...
unsigned long F_41 ( struct V_50 * V_14 ,
unsigned long V_51 )
{
const struct V_4 * V_5 ;
unsigned long V_57 ;
