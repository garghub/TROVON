...
static inline void F_69 ( struct V_81 * V_82 , unsigned V_114 )
{
T_1 V_89 ;
V_89 = F_18 ( V_82 -> V_70 . V_91 + V_114 ) ;
V_89 &= ~ V_115 ;
F_20 ( V_89 , V_82 -> V_70 . V_91 + V_114 ) ;
}
static int F_70 ( struct V_61 * V_70 , unsigned V_10 )
{
struct V_81 * V_82 = F_49 ( V_70 ) ;
unsigned long V_65 ;
if ( F_71 ( V_70 -> V_116 + V_10 ) )
return - V_28 ;
F_53 ( & V_82 -> V_117 , V_65 ) ;
F_69 ( V_82 , F_52 ( V_82 -> V_56 , V_10 ) ) ;
F_55 ( V_82 , V_10 ) ;
F_54 ( & V_82 -> V_117 , V_65 ) ;
return 0 ;
}
static void F_72 ( struct V_61 * V_70 , unsigned V_10 )
{
struct V_81 * V_82 = F_49 ( V_70 ) ;
unsigned long V_65 ;
F_53 ( & V_82 -> V_117 , V_65 ) ;
...
F_69 ( V_82 , F_52 ( V_82 -> V_56 , V_10 ) ) ;
F_54 ( & V_82 -> V_117 , V_65 ) ;
F_73 ( V_70 -> V_116 + V_10 ) ;
}
static int F_74 ( struct V_61 * V_70 , unsigned V_84 )
{
struct V_81 * V_82 = F_49 ( V_70 ) ;
int V_87 = F_47 ( V_84 ) ;
unsigned long V_65 ;
...
static inline void F_75 ( struct V_81 * V_82 , unsigned V_10 ,
int V_118 )
{
T_1 V_119 ;
unsigned long V_65 ;
F_53 ( & V_82 -> V_117 , V_65 ) ;
V_119 = F_18 ( V_82 -> V_70 . V_91 + V_10 ) ;
if ( V_118 )
V_119 |= V_120 ;
else
V_119 &= ~ V_120 ;
V_119 &= ~ V_92 ;
V_119 |= V_115 ;
F_20 ( V_119 , V_82 -> V_70 . V_91 + V_10 ) ;
F_54 ( & V_82 -> V_117 , V_65 ) ;
}
static int F_76 ( struct V_61 * V_70 , unsigned V_84 , int V_118 )
{
struct V_81 * V_82 = F_49 ( V_70 ) ;
int V_87 = F_47 ( V_84 ) ;
T_1 V_10 ;
...
V_10 = F_52 ( V_82 -> V_56 , V_87 ) ;
F_53 ( & V_90 , V_65 ) ;
F_75 ( V_82 , V_10 , V_118 ) ;
F_54 ( & V_90 , V_65 ) ;
return 0 ;
}
static int F_77 ( struct V_61 * V_70 , unsigned V_10 )
{
struct V_81 * V_82 = F_49 ( V_70 ) ;
T_1 V_89 ;
unsigned long V_65 ;
...
static void F_78 ( struct V_61 * V_70 , unsigned V_10 ,
int V_118 )
{
struct V_81 * V_82 = F_49 ( V_70 ) ;
T_1 V_107 ;
...
static int F_79 ( struct V_122 * V_86 , unsigned int V_103 ,
T_4 V_88 )
{
struct V_81 * V_82 = V_86 -> V_123 ;
if ( ! V_82 )
return - V_68 ;
F_80 ( V_103 , & V_124 ) ;
F_81 ( V_103 , V_125 ) ;
...
static void F_84 ( const T_1 * V_127 )
{
int V_35 , V_128 ;
const unsigned long * V_129 = ( const unsigned long * ) V_127 ;
for ( V_35 = 0 ; V_35 < V_66 ; V_35 ++ ) {
V_128 = F_85 ( V_129 + V_35 , V_130 ) ;
while ( V_128 < V_130 ) {
T_1 V_10 = F_52 ( V_35 , V_128 ) ;
T_1 V_89 = F_18 ( V_69 [ V_35 ] . V_70 . V_91 + V_10 ) ;
V_89 |= V_131 ;
V_89 |= V_132 ;
F_20 ( V_89 , V_69 [ V_35 ] . V_70 . V_91 + V_10 ) ;
V_128 = F_86 ( V_129 + V_35 , V_130 , V_128 + 1 ) ;
}
}
}
static void F_87 ( const T_1 * V_133 )
{
int V_35 , V_128 ;
const unsigned long * V_129 = ( const unsigned long * ) V_133 ;
for ( V_35 = 0 ; V_35 < V_66 ; V_35 ++ ) {
V_128 = F_85 ( V_129 + V_35 , V_130 ) ;
while ( V_128 < V_130 ) {
T_1 V_10 = F_52 ( V_35 , V_128 ) ;
...
V_82 = & V_69 [ V_35 ] ;
F_90 ( & V_82 -> V_117 ) ;
V_82 -> V_70 . V_62 . V_135 = F_70 ;
V_82 -> V_70 . V_62 . free = F_72 ;
V_82 -> V_70 . V_62 . V_136 = F_74 ;
V_82 -> V_70 . V_62 . V_137 = F_77 ;
V_82 -> V_70 . V_62 . V_138 = F_76 ;
V_82 -> V_70 . V_62 . V_139 = F_78 ;
V_82 -> V_70 . V_62 . V_140 = F_43 ;
V_82 -> V_70 . V_62 . V_116 = V_35 * V_67 ;
V_82 -> V_70 . V_62 . V_141 = V_67 ;
V_82 -> V_70 . V_62 . V_142 = F_91 ( V_19 -> V_143 , V_29 ) ;
V_82 -> V_70 . V_62 . V_73 = V_19 ;
V_82 -> V_70 . V_62 . V_144 = F_32 ;
V_82 -> V_70 . V_62 . V_145 = 2 ;
V_82 -> V_70 . V_91 = V_91 ;
V_82 -> V_56 = V_35 ;
V_82 -> V_44 = V_44 ;
V_82 -> V_146 = F_92 ( V_72 , V_35 ) ;
if ( V_82 -> V_146 < 0 ) {
V_134 = V_82 -> V_146 ;
goto V_147;
}
V_134 = F_93 ( & V_82 -> V_70 . V_62 ) ;
if ( V_134 ) {
F_94 ( L_15 ,
V_19 -> V_143 , V_134 ) ;
goto V_147;
...
& V_149 , V_82 ) ;
if ( ! V_82 -> V_83 ) {
F_94 ( L_16 , V_19 -> V_143 ) ;
V_134 = - V_150 ;
goto V_147;
}
F_96 ( V_82 -> V_146 , F_59 ) ;
F_97 ( V_82 -> V_146 , V_82 ) ;
}
if ( ! F_98 ( V_19 , L_17 , V_127 ,
V_66 ) )
F_84 ( V_127 ) ;
if ( ! F_98 ( V_19 , L_18 , V_133 ,
V_66 ) )
F_87 ( V_133 ) ;
return 0 ;
V_147:
