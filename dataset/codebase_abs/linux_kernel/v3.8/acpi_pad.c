...
{
return F_54 ( V_68 , V_72 , L_3 , V_48 ) ;
}
...
struct V_66 * V_67 , char * V_68 )
{
return F_54 ( V_68 , V_72 , L_3 , V_51 ) ;
}
...
{
int V_73 = 0 ;
V_73 = F_59 ( V_68 , V_72 - 2 , F_6 ( V_28 ) ) ;
V_68 [ V_73 ++ ] = '\n' ;
V_68 [ V_73 ] = '\0' ;
return V_73 ;
}
static int F_60 ( struct V_74 * V_64 )
{
int V_75 ;
V_75 = F_61 ( & V_64 -> V_65 , & V_76 ) ;
if ( V_75 )
return - V_77 ;
V_75 = F_61 ( & V_64 -> V_65 , & V_78 ) ;
if ( V_75 ) {
F_62 ( & V_64 -> V_65 , & V_76 ) ;
return - V_77 ;
}
V_75 = F_61 ( & V_64 -> V_65 , & V_79 ) ;
if ( V_75 ) {
F_62 ( & V_64 -> V_65 , & V_76 ) ;
F_62 ( & V_64 -> V_65 , & V_78 ) ;
return - V_77 ;
...
static void F_63 ( struct V_74 * V_64 )
{
F_62 ( & V_64 -> V_65 , & V_76 ) ;
F_62 ( & V_64 -> V_65 , & V_78 ) ;
F_62 ( & V_64 -> V_65 , & V_79 ) ;
}
static int F_64 ( T_6 V_80 )
{
struct V_81 V_82 = { V_83 , NULL } ;
union V_84 * V_85 ;
int V_62 = - 1 ;
if ( F_65 ( F_66 ( V_80 , L_4 , NULL , & V_82 ) ) )
return V_62 ;
...
static void F_68 ( T_6 V_80 , int V_91 ,
T_3 V_92 )
{
union V_84 V_93 [ 3 ] = {
{ . type = V_94 ,} ,
...
F_66 ( V_80 , L_5 , & V_97 , NULL ) ;
}
static void F_69 ( T_6 V_80 )
{
int V_63 ;
T_3 V_92 ;
F_8 ( & V_71 ) ;
...
static void F_70 ( T_6 V_80 , T_7 V_99 ,
void * V_40 )
{
...
F_69 ( V_80 ) ;
F_71 ( V_64 , V_99 , 0 ) ;
F_72 ( V_64 -> V_100 . V_101 ,
F_73 ( & V_64 -> V_65 ) , V_99 , 0 ) ;
break;
default:
F_74 ( L_6 , V_99 ) ;
break;
...
static int F_75 ( struct V_74 * V_64 )
{
T_8 V_102 ;
...
static int F_79 ( struct V_74 * V_64 ,
int type )
{
F_8 ( & V_71 ) ;
F_46 ( 0 ) ;
