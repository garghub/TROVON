...
V_43 -> V_53 = & V_54 ;
V_43 -> V_55 = V_56 ;
strncpy ( V_43 -> V_57 , V_26 -> V_41 -> V_57 , sizeof( V_43 -> V_57 ) ) ;
V_6 -> V_17 = V_43 ;
F_19 ( V_43 , V_6 ) ;
return F_20 ( V_43 , V_58 , - 1 ) ;
}
static struct V_59 * * T_1
F_21 ( struct V_5 * V_6 , enum V_60 V_40 )
{
struct V_61 * V_62 ;
struct V_63 * V_64 ;
...
V_78 = F_22 ( ( V_76 + 1 ) * sizeof( * V_69 ) + V_77 , V_99 ) ;
if ( V_78 == NULL )
return NULL ;
V_73 = V_78 ;
V_72 = V_78 ;
...
static void
F_26 ( struct V_105 * V_106 , struct V_18 * V_19 )
{
...
V_109 [ V_110 ] . V_111 = 0 ;
F_28 ( V_26 -> V_41 -> V_112 , V_6 -> V_113 ) ;
F_29 ( V_6 -> V_114 ) ;
F_30 ( V_19 ) ;
F_29 ( V_6 ) ;
}
static int T_1
F_31 ( struct V_105 * V_106 , struct V_18 * V_19 )
{
struct V_48 * V_26 = V_106 -> V_26 ;
struct V_5 * V_6 = F_4 ( V_19 ) ;
struct V_1 * V_2 ;
...
V_125 . V_103 =
V_104 . V_103 ;
V_19 -> V_130 = F_21 ( V_6 , V_90 ) ;
if ( F_34 ( V_26 -> V_41 ) )
V_19 -> V_131 = F_21 ( V_6 , V_85 ) ;
if ( F_35 ( V_106 -> V_26 -> V_41 ) )
V_19 -> V_132 = F_21 ( V_6 , V_79 ) ;
V_6 -> V_113 = F_36 ( V_26 -> V_41 -> V_112 , V_99 ) ;
V_6 -> V_114 = F_22 ( V_29 , V_99 ) ;
...
struct V_5 * V_6 ;
int V_37 = 0 ;
if ( ! F_34 ( V_106 -> V_26 -> V_41 ) )
return - V_27 ;
V_6 = F_40 ( sizeof( * V_6 ) , V_99 ) ;
if ( V_6 == NULL )
return - V_50 ;
V_6 -> V_34 = V_38 ;
