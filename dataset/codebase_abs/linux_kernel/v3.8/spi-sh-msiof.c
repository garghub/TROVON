...
V_2 = F_40 ( V_58 ) ;
F_60 ( V_63 , V_2 ) ;
V_2 -> V_95 = V_63 -> V_64 . V_96 ;
F_61 ( & V_2 -> V_17 ) ;
V_2 -> V_65 = F_62 ( & V_63 -> V_64 , NULL ) ;
if ( F_63 ( V_2 -> V_65 ) ) {
F_52 ( & V_63 -> V_64 , L_4 ) ;
V_73 = F_64 ( V_2 -> V_65 ) ;
goto V_97;
}
V_90 = F_65 ( V_63 , V_98 , 0 ) ;
V_92 = F_66 ( V_63 , 0 ) ;
if ( ! V_90 || V_92 < 0 ) {
F_52 ( & V_63 -> V_64 , L_5 ) ;
V_73 = - V_99 ;
...
V_2 -> V_6 = F_67 ( V_90 -> V_101 , F_68 ( V_90 ) ) ;
if ( ! V_2 -> V_6 ) {
F_52 ( & V_63 -> V_64 , L_6 ) ;
V_73 = - V_102 ;
goto V_100;
}
V_73 = F_69 ( V_92 , F_9 , 0 ,
F_70 ( & V_63 -> V_64 ) , V_2 ) ;
if ( V_73 ) {
F_52 ( & V_63 -> V_64 , L_7 ) ;
goto V_103;
...
V_2 -> V_75 = 64 ;
if ( V_2 -> V_95 -> V_104 )
V_2 -> V_74 = V_2 -> V_95 -> V_104 ;
if ( V_2 -> V_95 -> V_105 )
V_2 -> V_75 = V_2 -> V_95 -> V_105 ;
V_58 -> V_106 = V_66 | V_67 | V_60 ;
V_58 -> V_106 |= V_69 | V_68 ;
V_58 -> V_62 = 0 ;
V_58 -> V_107 = V_63 -> V_108 ;
V_58 -> V_109 = V_2 -> V_95 -> V_109 ;
V_58 -> V_110 = V_111 ;
V_58 -> V_112 = V_113 ;
V_2 -> V_114 . V_58 = V_58 ;
V_2 -> V_114 . V_115 = F_39 ;
V_2 -> V_114 . V_116 = F_37 ;
V_2 -> V_114 . V_117 = F_54 ;
V_2 -> V_114 . V_118 [ V_119 ] = F_56 ;
V_2 -> V_114 . V_118 [ V_120 ] = F_56 ;
V_2 -> V_114 . V_118 [ V_121 ] = F_56 ;
V_2 -> V_114 . V_118 [ V_122 ] = F_56 ;
V_73 = F_72 ( & V_2 -> V_114 ) ;
if ( V_73 == 0 )
return 0 ;
F_73 ( & V_63 -> V_64 ) ;
...
static int F_81 ( struct V_123 * V_64 )
{
return 0 ;
}
