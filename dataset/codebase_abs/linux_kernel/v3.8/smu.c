...
F_40 ( V_5 -> V_80 ) ;
V_82:
F_43 ( F_44 ( V_5 ) , sizeof( struct V_76 ) ) ;
V_5 = NULL ;
V_75:
F_40 ( V_69 ) ;
return V_70 ;
...
if ( V_5 -> V_80 ) {
V_5 -> V_43 = F_47 ( V_5 -> V_80 , 0 ) ;
if ( V_5 -> V_43 == V_44 )
F_13 ( V_74 L_18 ,
V_5 -> V_80 -> V_92 ) ;
}
if ( V_5 -> V_84 ) {
V_5 -> V_79 = F_47 ( V_5 -> V_84 , 0 ) ;
if ( V_5 -> V_79 == V_44 )
F_13 ( V_74 L_18 ,
V_5 -> V_84 -> V_92 ) ;
}
if ( V_5 -> V_43 != V_44 ) {
if ( F_48 ( V_5 -> V_43 , F_9 ,
V_93 , L_19 , V_5 ) < 0 ) {
F_13 ( V_35 L_20
L_21 ,
V_5 -> V_43 ) ;
...
{
struct V_68 * V_69 ;
for ( V_69 = NULL ; ( V_69 = F_50 ( V_5 -> V_78 , V_69 ) ) != NULL ; )
if ( F_51 ( V_69 , L_23 ) )
F_52 ( V_69 , L_23 ,
& V_5 -> V_96 -> V_97 ) ;
}
static int F_53 ( struct V_98 * V_97 )
{
if ( ! V_5 )
return - V_39 ;
V_5 -> V_96 = V_97 ;
...
struct V_98 * F_57 ( void )
{
if ( ! V_5 )
return NULL ;
return V_5 -> V_96 ;
}
static void F_58 ( struct V_101 * V_4 , int V_102 )
{
...
static void F_60 ( struct V_3 * V_46 , void * V_25 )
{
...
static int F_66 ( V_11 * V_123 , unsigned int V_124 , unsigned int V_125 )
{
F_67 ( V_52 ) ;
unsigned int V_126 ;
struct V_3 V_4 ;
...
V_126 = 0xe ;
while ( V_125 ) {
unsigned int V_128 = F_68 ( V_125 , V_126 ) ;
V_4 . V_4 = V_129 ;
V_4 . V_10 = 7 ;
V_4 . V_12 = V_127 ;
V_4 . V_32 = V_126 ;
...
static struct V_132 * F_70 ( int V_133 )
{
F_67 ( V_52 ) ;
struct V_45 V_4 ;
...
V_137 -> V_143 = V_135 ;
V_137 -> V_7 = NULL ;
if ( F_66 ( ( V_11 * ) V_135 , V_124 , V_125 ) ) {
F_13 ( V_131 L_38
L_39 , V_133 ) ;
goto V_144;
}
...
const struct V_132 * F_74 ( int V_133 ,
...
const struct V_132 * F_79 ( int V_133 , unsigned int * V_145 )
{
return F_74 ( V_133 , V_145 , 0 ) ;
}
static int F_80 ( struct V_150 * V_150 , struct V_151 * V_151 )
{
struct V_152 * V_153 ;
unsigned long V_24 ;
V_153 = F_71 ( sizeof( struct V_152 ) , V_141 ) ;
if ( V_153 == 0 )
return - V_154 ;
F_35 ( & V_153 -> V_28 ) ;
V_153 -> V_155 = V_156 ;
...
F_77 ( & V_158 ) ;
F_11 ( & V_159 , V_24 ) ;
F_82 ( & V_153 -> V_48 , & V_160 ) ;
F_12 ( & V_159 , V_24 ) ;
V_151 -> V_161 = V_153 ;
F_78 ( & V_158 ) ;
return 0 ;
}
static void F_83 ( struct V_3 * V_4 , void * V_25 )
{
struct V_152 * V_153 = V_25 ;
F_84 ( & V_153 -> V_157 ) ;
}
static T_5 F_85 ( struct V_151 * V_151 , const char T_6 * V_162 ,
T_7 V_163 , T_8 * V_164 )
{
...
if ( V_153 -> V_166 )
return - V_167 ;
else if ( F_86 ( & V_135 , V_162 , sizeof( V_135 ) ) )
return - V_168 ;
...
V_153 -> V_4 . V_37 = 1 ;
F_12 ( & V_153 -> V_28 , V_24 ) ;
if ( F_86 ( V_153 -> V_50 , V_162 + sizeof( V_135 ) , V_135 . V_10 ) ) {
V_153 -> V_166 = 0 ;
return - V_168 ;
}
...
static T_5 F_89 ( struct V_151 * V_151 , struct V_152 * V_153 ,
...
if ( F_96 ( V_162 , & V_135 , sizeof( V_135 ) ) )
return - V_168 ;
V_145 -= sizeof( V_135 ) ;
if ( V_145 && F_96 ( V_162 + sizeof( V_135 ) , V_153 -> V_50 , V_145 ) )
return - V_168 ;
V_153 -> V_166 = 0 ;
return V_27 ;
}
static T_5 F_97 ( struct V_151 * V_151 , struct V_152 * V_153 ,
char T_6 * V_162 , T_7 V_163 )
{
F_98 ( 1000 ) ;
return 0 ;
}
static T_5 F_99 ( struct V_151 * V_151 , char T_6 * V_162 ,
T_7 V_163 , T_8 * V_164 )
{
struct V_152 * V_153 = V_151 -> V_161 ;
if ( V_153 -> V_155 == V_156 )
return F_89 ( V_151 , V_153 , V_162 , V_163 ) ;
if ( V_153 -> V_155 == V_171 )
return F_97 ( V_151 , V_153 , V_162 , V_163 ) ;
return - V_174 ;
}
static unsigned int F_100 ( struct V_151 * V_151 , T_9 * V_157 )
{
struct V_152 * V_153 = V_151 -> V_161 ;
...
static int F_102 ( struct V_150 * V_150 , struct V_151 * V_151 )
{
struct V_152 * V_153 = V_151 -> V_161 ;
unsigned long V_24 ;
unsigned int V_166 ;
