...
{
return vsnprintf ( V_9 , V_138 , V_53 , args ) ;
}
...
int V_8 ;
va_start ( args , V_53 ) ;
V_8 = vsnprintf ( V_9 , V_138 , V_53 , args ) ;
va_end ( args ) ;
return V_8 ;
}
int F_61 ( T_7 * V_139 , T_6 V_19 , const char * V_53 , T_5 args )
{
struct V_25 V_26 = { 0 } ;
char * V_131 , * V_24 ;
V_131 = ( char * ) V_139 ;
...
return ( T_7 * ) ( F_63 ( V_131 , sizeof( T_7 ) ) ) - V_139 ;
#undef F_62
}
int F_64 ( char * V_9 , T_6 V_19 , const char * V_53 , const T_7 * V_139 )
{
struct V_25 V_26 = { 0 } ;
char * V_131 , * V_24 ;
...
int F_66 ( T_7 * V_139 , T_6 V_19 , const char * V_53 , ... )
{
T_5 args ;
int V_143 ;
va_start ( args , V_53 ) ;
V_143 = F_61 ( V_139 , V_19 , V_53 , args ) ;
va_end ( args ) ;
return V_143 ;
}
...
if ( V_148 )
V_147 . V_7 = F_68 ( V_147 . V_7 , V_3 ) ;
else
V_147 . V_146 = F_69 ( V_147 . V_146 , V_3 ) ;
-- V_144 ;
}
}
switch ( V_112 ) {
