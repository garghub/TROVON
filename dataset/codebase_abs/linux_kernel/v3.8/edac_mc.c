...
if ( V_123 && * V_123 )
F_73 ( L_57 ,
V_121 , V_127 , V_22 , V_14 , V_122 , V_123 ) ;
else
F_73 ( L_58 ,
V_121 , V_127 , V_22 , V_14 , V_122 ) ;
}
F_67 ( V_6 , V_115 , V_62 , V_120 ) ;
}
void F_74 ( const enum V_131 type ,
struct V_5 * V_6 ,
const T_2 V_120 ,
const unsigned long V_124 ,
const unsigned long V_125 ,
...
char V_22 [ ( V_136 + 1 + sizeof( V_137 ) ) * V_6 -> V_38 ] ;
char * V_10 ;
int V_50 = - 1 , V_16 = - 1 ;
int V_62 [ V_60 ] = { V_133 , V_134 , V_135 } ;
int V_7 ;
long V_24 ;
bool V_115 = false ;
T_3 V_138 ;
...
if ( V_133 >= 0 && V_133 != V_2 -> V_14 [ 0 ] )
continue;
if ( V_134 >= 0 && V_134 != V_2 -> V_14 [ 1 ] )
continue;
if ( V_135 >= 0 && V_135 != V_2 -> V_14 [ 2 ] )
continue;
if ( V_2 -> V_24 > V_24 )
V_24 = V_2 -> V_24 ;
if ( V_115 && V_2 -> V_23 ) {
...
if ( V_16 >= 0 )
V_6 -> V_37 [ V_50 ] -> V_31 [ V_16 ] -> V_140 += V_120 ;
}
} else
if ( V_50 >= 0 )
V_6 -> V_37 [ V_50 ] -> V_141 += V_120 ;
}
V_10 = V_14 ;
for ( V_7 = 0 ; V_7 < V_6 -> V_11 ; V_7 ++ ) {
if ( V_62 [ V_7 ] < 0 )
