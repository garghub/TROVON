...
return - V_62 ;
F_4 ( L_5 , V_67 -> V_69 ) ;
V_67 -> V_64 [ V_3 ] . V_71 = ( ( T_2 ) V_6 [ 0 ] << 8 ) | V_6 [ 1 ] ;
V_67 -> V_64 [ V_3 ] . V_72 = ( ( T_2 ) V_6 [ 2 ] << 8 ) | V_6 [ 3 ] ;
V_67 -> V_64 [ V_3 ] . V_73 = V_6 [ 4 ] ;
V_67 -> V_64 [ V_3 ] . V_74 = V_6 [ 5 ] ;
V_67 -> V_64 [ V_3 ] . V_75 = V_6 [ 6 ] ;
V_67 -> V_64 [ V_3 ] . V_76 = ( ( T_2 ) V_6 [ 7 ] << 8 ) | V_6 [ 8 ] ;
V_67 -> V_64 [ V_3 ] . V_77 = V_6 [ 9 ] ;
V_67 -> V_64 [ V_3 ] . V_78 = V_6 [ 10 ] ;
V_67 -> V_64 [ V_3 ] . V_79 = V_6 [ 11 ] ;
V_67 -> V_64 [ V_3 ] . V_80 = V_6 [ 12 ] ;
if ( V_67 -> V_69 == 16 ) {
V_67 -> V_64 [ V_3 ] . V_81 . V_82 = V_6 [ 13 ] ;
V_67 -> V_64 [ V_3 ] . V_83 [ 0 ] = V_6 [ 14 ] ;
V_67 -> V_64 [ V_3 ] . V_83 [ 1 ] = V_6 [ 15 ] ;
}
return 0 ;
}
...
int V_58 ;
T_1 V_84 ;
V_58 = F_10 ( V_2 , 0xFE77 , & V_84 , 1 ) ;
if ( V_58 < 0 )
return - V_62 ;
V_84 |= 0x04 ;
V_58 = F_13 ( V_2 , 0xFE77 , & V_84 , 1 ) ;
if ( V_58 < 0 )
return - V_62 ;
V_58 = F_10 ( V_2 , 0xFE77 , & V_84 , 1 ) ;
if ( V_58 < 0 )
...
static int F_19 ( struct V_1 * V_2 , int V_86 , int V_87 )
{
int V_58 ;
T_1 V_84 ;
V_58 = F_10 ( V_2 , 0xFE47 , & V_84 , 1 ) ;
if ( V_58 < 0 )
return - V_62 ;
if ( V_86 ) {
if ( V_87 )
...
V_84 = 0xFF ;
V_58 = F_13 ( V_2 , 0xFE79 , & V_84 , 1 ) ;
if ( V_58 < 0 )
return - V_62 ;
V_84 = 0x01 ;
V_58 = F_13 ( V_2 , 0x48 , & V_84 , 1 ) ;
if ( V_58 < 0 )
return - V_62 ;
}
}
...
V_58 = F_10 ( V_2 , 0xFD6F , & V_89 , 1 ) ;
if ( V_58 == V_70 && ( V_89 & 0x1F ) == 0 ) {
V_89 = 0x1F ;
V_58 = F_13 ( V_2 , 0xFD70 , & V_89 , 1 ) ;
if ( V_58 != V_70 )
F_4 ( L_11 ) ;
} else {
F_4 ( L_12 ) ;
...
V_64 = V_67 -> V_64 ;
V_64 -> V_71 = ( ( T_2 ) V_6 [ 0 ] << 8 ) | V_6 [ 1 ] ;
V_64 -> V_72 = ( ( T_2 ) V_6 [ 2 ] << 8 ) | V_6 [ 3 ] ;
V_64 -> V_73 = V_6 [ 4 ] ;
V_64 -> V_74 = V_6 [ 5 ] ;
V_64 -> V_75 = V_6 [ 6 ] ;
V_64 -> V_76 = ( ( T_2 ) V_6 [ 7 ] << 8 ) | V_6 [ 8 ] ;
V_64 -> V_77 = V_6 [ 9 ] ;
V_64 -> V_78 = V_6 [ 10 ] ;
V_64 -> V_79 = V_6 [ 11 ] ;
V_64 -> V_80 = V_6 [ 12 ] ;
if ( V_67 -> V_69 == 16 ) {
V_64 -> V_81 . V_82 = V_6 [ 13 ] ;
V_64 -> V_83 [ 0 ] = V_6 [ 14 ] ;
V_64 -> V_83 [ 1 ] = V_6 [ 15 ] ;
}
V_67 = (struct V_66 * ) ( V_2 -> V_68 ) ;
