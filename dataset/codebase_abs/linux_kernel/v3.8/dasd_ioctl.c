...
int V_27 ;
V_7 = V_15 -> V_7 ;
if ( ! V_7 -> V_28 || ! V_7 -> V_28 -> V_75 )
return - V_41 ;
V_69 = F_47 ( sizeof( struct V_68 ) , V_51 ) ;
if ( V_69 == NULL )
return - V_52 ;
V_27 = V_7 -> V_28 -> V_75 ( V_7 , V_69 ) ;
if ( V_27 ) {
F_45 ( V_69 ) ;
return V_27 ;
}
...
V_69 -> V_76 = V_73 . V_76 ;
V_69 -> V_77 = V_71 . V_78 ;
V_69 -> V_79 = V_20 -> V_80 . V_79 ;
V_69 -> V_81 = V_20 -> V_80 . V_81 ;
V_69 -> V_82 = V_20 -> V_80 . V_82 ;
V_69 -> V_83 = V_20 -> V_80 . V_83 ;
V_69 -> V_84 = V_7 -> V_31 ;
V_69 -> V_85 = F_50 ( & V_15 -> V_85 ) ;
if ( ! V_15 -> V_5 )
V_69 -> V_85 ++ ;
if ( ( V_7 -> V_31 < V_86 ) ||
( F_51 ( V_15 -> V_87 ) ) )
...
V_69 -> V_42 |=
( ( V_7 -> V_42 & V_43 ) != 0 ) ;
memcpy ( V_69 -> type , V_7 -> V_28 -> V_90 , 4 ) ;
if ( V_15 -> V_91 -> V_92 ) {
struct V_93 * V_94 ;
#ifdef F_52
{
...
if ( V_5 != V_5 -> V_47 )
return - V_41 ;
if ( F_55 ( V_99 , ( int T_1 * ) V_1 ) )
return - V_46 ;
V_7 = F_5 ( V_5 -> V_10 ) ;
if ( ! V_7 )
return - V_11 ;
if ( ! V_99 && F_36 ( V_44 , & V_7 -> V_19 ) ) {
F_11 ( V_7 ) ;
return - V_45 ;
}
F_56 ( V_5 -> V_10 , V_99 ) ;
V_27 = F_57 ( V_7 -> V_20 , V_43 , V_99 ) ;
F_11 ( V_7 ) ;
return V_27 ;
}
static int F_58 ( struct V_18 * V_15 , unsigned int V_67 ,
struct V_100 T_1 * V_1 )
{
T_2 V_101 = F_59 ( V_67 ) ;
struct V_100 V_50 ;
int V_102 ;
V_102 = F_60 ( V_15 -> V_7 -> V_20 , & V_50 ) ;
if ( ! V_102 && F_44 ( V_1 , & V_50 , F_61 ( V_101 , sizeof( * V_1 ) ) ) )
return - V_46 ;
return V_102 ;
}
int F_62 ( struct V_4 * V_5 , T_3 V_103 ,
unsigned int V_67 , unsigned long V_104 )
{
struct V_18 * V_15 ;
struct V_6 * V_7 ;
void T_1 * V_1 ;
...
V_27 = - V_66 ;
if ( V_7 -> V_28 -> V_119 )
V_27 = V_7 -> V_28 -> V_119 ( V_15 , V_67 , V_1 ) ;
}
F_11 ( V_7 ) ;
return V_27 ;
}
