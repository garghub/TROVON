...
static int F_99 ( struct V_87 * V_8 )
{
struct V_109 * V_110 ;
T_2 V_65 ;
...
static int F_217 ( struct V_87 * V_8 )
{
if ( F_202 ( F_218 ( V_8 ) ) )
return - V_370 ;
return 0 ;
}
static int F_219 ( struct V_87 * V_8 )
{
F_203 ( F_218 ( V_8 ) ,
V_227 . V_228 , V_227 . V_386 ) ;
return 0 ;
}
static int T_13 F_220 ( void )
{
int V_68 ;
if ( ! V_398 && F_221 ( V_399 ) ) {
V_68 = F_222 ( & V_400 ) ;
if ( V_68 ) {
F_20 ( L_125 ) ;
goto V_60;
