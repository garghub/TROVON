...
V_139 = V_141 ;
F_5 ( 1 , L_53 , V_139 ) ;
V_130 = F_32 ( & V_134 , V_139 , V_2 -> V_8 . V_10 -> V_142 . V_143 ) ;
if ( V_130 < 0 ) {
if ( V_130 == - V_127 )
F_3 ( V_12 L_54 , V_139 ) ;
else
...
V_131 = V_134 -> V_64 ;
V_135 = V_131 + V_134 -> V_144 ;
if ( V_134 -> V_144 < sizeof( V_138 ) - 1 + 2 + 2 ) {
F_3 ( V_12 L_56 ,
V_139 ) ;
goto V_145;
}
...
V_2 -> V_146 = F_33 ( V_131 ) ;
V_131 += 2 ;
V_137 = F_33 ( V_131 ) ;
V_131 += 2 ;
F_5 ( 1 , L_57 ,
V_137 , V_139 , V_138 ,
V_2 -> V_146 >> 8 , V_2 -> V_146 & 0xff ) ;
V_2 -> V_119 = F_34 ( V_137 , sizeof( * V_2 -> V_119 ) , V_147 ) ;
if ( V_2 -> V_119 == NULL ) {
F_3 ( V_12 L_58 ) ;
V_130 = - V_148 ;
goto V_149;
...
if ( V_135 - V_131 < sizeof( type ) + sizeof( V_116 ) + sizeof( V_144 ) )
goto V_150;
type = F_35 ( V_131 ) ;
V_131 += sizeof( type ) ;
V_116 = F_36 ( V_131 ) ;
...
V_89 = F_33 ( V_131 ) ;
V_131 += sizeof( V_89 ) ;
if ( V_135 - V_131 < sizeof( V_144 ) )
goto V_150;
}
V_144 = F_35 ( V_131 ) ;
V_131 += sizeof( V_144 ) ;
if ( ! V_144 || V_144 > V_135 - V_131 ) {
F_3 ( V_12 L_61 ,
type , ( unsigned long long ) V_116 ,
( unsigned ) ( V_135 - V_131 ) , V_144 ) ;
goto V_145;
}
V_2 -> V_119 [ V_136 ] . V_132 = F_37 ( V_144 , V_147 ) ;
...
F_25 ( type , V_89 ) ;
F_3 ( V_129 L_63 ,
type , ( unsigned long long ) V_116 , V_144 ) ;
}
memcpy ( V_2 -> V_119 [ V_136 ] . V_132 , V_131 , V_144 ) ;
V_2 -> V_119 [ V_136 ] . type = type ;
V_2 -> V_119 [ V_136 ] . V_116 = V_116 ;
V_2 -> V_119 [ V_136 ] . V_144 = V_144 ;
...
V_131 = V_2 -> V_119 [ V_31 ] . V_132 ;
if ( V_2 -> V_119 [ V_31 ] . V_144 != 12 * 16 || V_151 >= 16 )
return - V_24 ;
V_131 += 12 * V_151 ;
if ( V_84 ) {
F_40 ( L_69 ) ;
...
V_152 [ 0 ] = 0x00 ;
memcpy ( & V_152 [ 1 ] , V_131 , 12 ) ;
V_130 = F_6 ( V_2 , V_154 , 0 ) ;
if ( V_130 < 0 ) {
F_3 ( V_12 L_70 ) ;
return - V_155 ;
}
V_130 = F_1 ( V_2 , V_152 , 13 ) ;
if ( V_130 != 0 ) {
F_3 ( V_12 L_71 , V_130 ) ;
}
memset ( V_153 , 0 , sizeof( V_153 ) ) ;
V_153 [ 4 ] = 0x88 ;
F_1 ( V_2 , V_153 , sizeof( V_153 ) ) ;
F_8 ( 10 ) ;
return 0 ;
}
...
T_2 V_160 ;
T_4 V_161 ;
T_1 V_162 = 0 , V_163 = 0 , V_164 = 0 , V_165 = 0 ;
F_5 ( 1 , L_72 , V_18 ) ;
if ( ! V_2 -> V_119 ) {
V_130 = F_31 ( V_15 ) ;
if ( V_130 < 0 )
...
if ( V_84 ) {
F_29 ( V_158 . type ) ;
F_3 ( V_91 L_74 , V_158 . type ,
( unsigned long long ) V_158 . V_167 ) ;
if ( ! V_89 )
F_3 ( V_91 L_75 ) ;
else
F_3 ( V_91 L_76 , V_158 . V_89 ) ;
F_3 ( V_91 L_77 , V_158 . V_169 ) ;
}
...
goto V_171;
V_161 = 0 ;
V_130 = F_30 ( V_15 , V_90 , & V_161 ) ;
if ( V_130 < 0 ) {
F_3 ( V_12 L_79 , V_130 ) ;
goto V_171;
}
F_5 ( 1 , L_80 ) ;
V_130 = F_30 ( V_15 , V_90 | V_92 , & V_161 ) ;
if ( V_130 == - V_127 )
V_130 = F_30 ( V_15 , V_90 | V_92 , & V_161 ) ;
...
V_170:
if ( V_2 -> V_78 . type == ( V_90 | V_158 . type ) &&
V_2 -> V_78 . V_167 == V_156 ) {
F_5 ( 1 , L_82 ) ;
goto V_172;
}
V_2 -> V_78 . V_168 = 0 ;
V_130 = F_30 ( V_15 , V_158 . type , & V_158 . V_116 ) ;
if ( V_130 < 0 )
goto V_171;
V_172:
if ( V_2 -> V_78 . V_168 == V_158 . V_168 &&
V_2 -> V_78 . V_169 == V_158 . V_169 ) {
F_5 ( 1 , L_83 ) ;
goto V_173;
}
V_130 = F_39 ( V_15 , V_158 . type | V_158 . V_168 , & V_158 . V_116 ,
V_158 . V_89 , V_158 . V_169 ) ;
if ( V_130 != 0 )
F_5 ( 1 , L_84 , V_130 ) ;
V_173:
V_130 = F_13 ( V_2 , V_174 , & V_160 ) ;
if ( F_16 ( V_2 , & V_162 , & V_163 , & V_164 ,
& V_165 ) != 0 ) {
F_3 ( V_12 L_85 ) ;
goto V_171;
}
F_5 ( 1 , L_86
L_87 ,
V_160 , V_162 , V_163 , V_164 , V_165 ) ;
if ( V_2 -> V_146 != ( ( V_164 << 8 ) | V_165 ) ) {
F_3 ( V_128
L_88 ,
V_164 , V_165 ) ;
goto V_171;
...
V_160 == V_176 ) ) {
V_2 -> V_160 = V_160 ;
V_2 -> V_177 = ( V_162 << 8 ) | V_163 ;
} else if ( V_2 -> V_160 == 0 || V_2 -> V_160 != V_160 ||
V_2 -> V_177 != ( ( V_162 << 8 ) | V_163 ) ) {
F_3 ( V_128
L_89
L_90 ) ;
...
memcpy ( & V_2 -> V_78 , & V_158 , sizeof( V_2 -> V_78 ) ) ;
V_2 -> V_78 . type |= V_90 ;
return 0 ;
V_171:
memset ( & V_2 -> V_78 , 0 , sizeof( V_2 -> V_78 ) ) ;
...
F_5 ( 1 , L_98 , V_70 ) ;
F_20 ( V_2 , & signal ) ;
F_5 ( 1 , L_99 , signal >> 8 , signal ) ;
F_21 ( V_2 , & V_73 ) ;
F_5 ( 1 , L_100 , V_73 >> 8 , V_73 ) ;
}
static int F_43 ( struct V_14 * V_15 )
{
struct V_179 * V_180 = & V_15 -> V_181 ;
T_3 V_182 = V_180 -> V_183 ;
T_3 V_184 = V_180 -> V_185 ;
struct V_1 * V_2 = V_15 -> V_16 ;
unsigned int type ;
int V_17 = - V_13 ;
F_5 ( 1 , L_101 , V_18 , V_180 -> V_186 ) ;
F_44 ( & V_2 -> V_187 ) ;
switch ( V_182 ) {
case V_188 :
F_5 ( 1 , L_102 , V_18 ) ;
V_2 -> V_41 = V_42 ;
V_2 -> V_45 = V_180 -> V_186 - 1750000 ;
V_2 -> V_37 = V_178 ;
type = V_80 ;
break;
case V_189 :
...
F_5 ( 1 , L_104 , V_18 ) ;
if ( V_184 == 0 ) {
if ( V_180 -> V_186 < 400000000 ) {
V_2 -> V_45 = V_180 -> V_186 - 2250000 ;
} else {
V_2 -> V_45 = V_180 -> V_186 - 2750000 ;
}
V_2 -> V_37 = V_192 ;
type = V_82 ;
} else if ( V_184 <= 6000000 ) {
V_2 -> V_37 = V_178 ;
V_2 -> V_45 = V_180 -> V_186 - 1750000 ;
type = V_80 ;
} else if ( V_184 <= 7000000 ) {
V_2 -> V_37 = V_193 ;
V_2 -> V_45 = V_180 -> V_186 - 2250000 ;
type = V_81 ;
} else {
...
F_5 ( 1 , L_106 ,
V_18 , V_2 -> V_45 ) ;
if ( F_41 ( V_15 , type , 0 , V_2 -> V_195 ) != 0 )
goto V_171;
V_2 -> V_196 = V_180 -> V_185 ;
...
V_18 , V_203 -> V_186 ) ;
F_44 ( & V_2 -> V_187 ) ;
V_2 -> V_45 = V_203 -> V_186 * 62500 ;
V_203 -> V_156 &= V_211 ;
if ( ! V_203 -> V_156 )
V_203 -> V_156 = V_212 ;
if ( V_206 & V_213 )
type = V_101 ;
if ( V_203 -> V_156 & V_214 ) {
V_203 -> V_156 = V_214 ;
if ( V_206 & V_213 ) {
V_2 -> V_37 = V_215 ;
} else if ( V_206 & V_216 ) {
...
if ( V_203 -> V_156 & V_229 ) {
V_203 -> V_156 = V_229 | V_230 ;
if ( V_206 & V_213 )
V_2 -> V_37 = V_231 ;
else
V_2 -> V_37 = V_232 ;
...
if ( V_203 -> V_156 & V_237 ) {
V_203 -> V_156 = V_237 | V_217 ;
if ( V_206 & V_238 ) {
type = 0 ;
V_2 -> V_37 = V_239 ;
} else if ( V_206 & V_213 ) {
...
if ( V_203 -> V_156 & V_245 ) {
type = 0 ;
V_203 -> V_156 = V_245 | V_230 ;
V_2 -> V_37 = V_246 ;
goto V_210;
}
if ( V_203 -> V_156 & V_247 ) {
type = 0 ;
V_203 -> V_156 = V_247 | V_230 ;
V_2 -> V_37 = V_248 ;
goto V_210;
}
V_210:
V_2 -> V_41 = V_43 ;
if ( F_41 ( V_15 , type , V_203 -> V_156 ,
...
static int F_47 ( struct V_14 * V_15 , T_2 * V_249 )
{
struct V_1 * V_2 = V_15 -> V_16 ;
T_2 V_250 = 0 ;
int V_130 ;
F_44 ( & V_2 -> V_187 ) ;
V_130 = F_13 ( V_2 , V_72 , & V_250 ) ;
F_45 ( & V_2 -> V_187 ) ;
if ( V_130 < 0 )
goto V_17;
F_48 ( L_112 , V_250 >> 8 , V_250 ) ;
if ( ( V_2 -> V_37 == V_178 ) ||
( V_2 -> V_37 == V_193 ) ||
( V_2 -> V_37 == V_192 ) ||
( V_2 -> V_37 == V_194 ) )
goto V_251;
F_44 ( & V_2 -> V_187 ) ;
V_130 = F_13 ( V_2 , V_74 , & V_250 ) ;
F_45 ( & V_2 -> V_187 ) ;
F_48 ( L_113 , V_250 >> 8 , V_250 ) ;
if ( V_250 >= 0x2000 ) {
V_250 = 0 ;
} else {
V_250 = ~ V_250 << 3 ;
...
if ( V_250 <= 0x3200 ) {
V_250 = 0xffff ;
} else if ( V_250 >= 0x713A ) {
V_250 = 0 ;
} else {
V_250 = ~ ( V_250 - 0x3200 ) << 2 ;
}
V_17:
* V_249 = V_250 ;
return V_130 ;
}
static int F_49 ( struct V_14 * V_15 , T_3 * V_252 )
{
struct V_1 * V_2 = V_15 -> V_16 ;
* V_252 = V_2 -> V_45 ;
if ( V_84 ) {
...
static int F_50 ( struct V_14 * V_15 , T_3 * V_184 )
{
struct V_1 * V_2 = V_15 -> V_16 ;
F_5 ( 1 , L_3 , V_18 ) ;
* V_184 = V_2 -> V_196 ;
...
static int F_51 ( struct V_14 * V_15 , T_3 * V_255 )
{
struct V_1 * V_2 = V_15 -> V_16 ;
T_2 V_58 = 0 ;
F_44 ( & V_2 -> V_187 ) ;
...
V_266 ? V_266 -> V_268 : - 1 ) ;
F_44 ( & V_262 ) ;
V_267 = F_58 ( struct V_1 , V_2 ,
V_269 ,
V_264 , V_266 -> V_268 , L_118 ) ;
switch ( V_267 ) {
case 0 :
goto V_171;
break;
...
if ( V_266 -> V_195 != 0 ) {
V_2 -> V_195 = V_266 -> V_195 ;
V_2 -> V_259 = V_266 -> V_259 ;
V_2 -> V_198 = V_266 -> V_198 ;
V_2 -> V_200 = V_266 -> V_200 ;
}
if ( V_267 == 1 ) {
if ( F_13 ( V_2 , V_174 , & V_116 ) != 0 )
goto V_171;
} else {
