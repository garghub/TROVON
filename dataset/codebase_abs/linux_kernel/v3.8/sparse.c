...
static void F_59 ( struct V_1 * V_76 , unsigned long V_32 )
{
}
static struct V_1 * F_60 ( unsigned long V_32 )
{
struct V_1 * V_1 , * V_12 ;
unsigned long V_77 = sizeof( struct V_1 ) * V_32 ;
V_1 = F_61 ( V_10 | V_78 , F_62 ( V_77 ) ) ;
if ( V_1 )
goto V_79;
V_12 = F_63 ( V_77 ) ;
if ( V_12 )
...
F_68 ( ( unsigned long ) V_76 ,
F_62 ( sizeof( struct V_1 ) * V_32 ) ) ;
}
static void F_59 ( struct V_1 * V_76 , unsigned long V_32 )
{
unsigned long V_81 , V_82 , V_83 ;
unsigned long V_84 ;
struct V_1 * V_1 = F_69 ( V_76 ) ;
...
static void F_72 ( struct V_1 * V_76 , unsigned long * V_52 )
{
struct V_1 * V_89 ;
unsigned long V_32 ;
if ( ! V_52 )
...
int T_3 F_75 ( struct V_90 * V_90 , unsigned long V_20 ,
int V_32 )
{
...
static void F_79 ( struct V_1 * V_76 , int V_32 )
{
int V_83 ;
if ( ! V_76 )
return;
...
static inline void F_79 ( struct V_1 * V_76 , int V_32 )
{
}
void F_83 ( struct V_90 * V_90 , struct V_5 * V_15 )
{
struct V_1 * V_76 = NULL ;
unsigned long * V_52 = NULL ;
if ( V_15 -> V_19 ) {
V_52 = V_15 -> V_40 ;
V_76 = F_28 ( V_15 -> V_19 ,
F_13 ( V_15 ) ) ;
