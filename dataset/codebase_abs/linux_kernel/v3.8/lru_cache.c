...
F_21 ( ! V_2 ) ;
F_21 ( ! V_2 -> V_29 ) ;
F_22 (e, n, lc_hash_slot(lc, enr), colision) {
if ( V_18 -> V_36 != V_47 )
continue;
...
static struct V_16 * F_30 ( struct V_1 * V_2 , unsigned V_53 )
{
struct V_54 * V_50 ;
struct V_16 * V_18 ;
if ( ! F_31 ( & V_2 -> free ) )
...
return NULL ;
V_18 = F_32 ( V_50 , struct V_16 , V_37 ) ;
F_27 ( V_2 , V_18 ) ;
V_18 -> V_36 = V_53 ;
if ( ! F_33 ( & V_18 -> V_52 ) )
F_34 ( & V_18 -> V_52 ) ;
F_35 ( & V_18 -> V_52 , F_19 ( V_2 , V_53 ) ) ;
...
static struct V_16 * F_37 ( struct V_1 * V_2 , unsigned int V_47 , bool V_57 )
{
struct V_16 * V_18 ;
F_26 () ;
if ( V_2 -> V_4 & V_58 ) {
...
void F_50 ( struct V_1 * V_2 , unsigned int V_47 , int V_63 )
{
struct V_16 * V_18 ;
struct V_54 * V_64 ;
...
F_35 ( & V_18 -> V_52 , F_19 ( V_2 , V_47 ) ) ;
V_64 = & V_2 -> V_25 ;
}
F_29 ( & V_18 -> V_37 , V_64 ) ;
}
void F_51 ( struct V_45 * V_46 , struct V_1 * V_2 , char * V_65 ,
