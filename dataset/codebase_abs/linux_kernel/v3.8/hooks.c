...
static int F_332 ( struct V_646 * V_647 , void * V_16 )
{
struct V_752 * V_753 = V_16 ;
struct V_648 * V_649 = V_647 -> V_650 ;
...
static int F_334 ( struct V_646 * V_647 , struct V_597 * V_598 )
{
int V_552 = 0 ;
T_2 V_228 ;
struct V_759 * V_760 ;
struct V_648 * V_649 = V_647 -> V_650 ;
if ( V_598 -> V_84 < F_335 ( 0 ) ) {
V_552 = - V_86 ;
goto V_66;
}
V_760 = F_336 ( V_598 ) ;
V_552 = F_337 ( V_649 -> V_28 , V_760 -> V_761 , & V_228 ) ;
if ( V_552 ) {
if ( V_552 == - V_86 ) {
F_338 ( V_8 -> V_497 , V_12 , V_498 ,
L_44
L_45 ,
...
static unsigned int F_340 ( struct V_597 * V_598 , int V_712 ,
T_4 V_170 )
{
int V_552 ;
char * V_635 ;
...
return V_765 ;
if ( V_763 )
if ( F_341 ( V_598 , V_170 , V_708 ) != 0 )
return V_765 ;
return V_764 ;
}
static unsigned int F_342 ( unsigned int V_767 ,
struct V_597 * V_598 ,
const struct V_768 * V_769 ,
const struct V_768 * V_66 ,
int (* F_343)( struct V_597 * ) )
{
return F_340 ( V_598 , V_769 -> V_712 , V_177 ) ;
}
static unsigned int F_344 ( unsigned int V_767 ,
struct V_597 * V_598 ,
const struct V_768 * V_769 ,
const struct V_768 * V_66 ,
int (* F_343)( struct V_597 * ) )
{
return F_340 ( V_598 , V_769 -> V_712 , V_178 ) ;
}
static unsigned int F_345 ( struct V_597 * V_598 ,
T_4 V_170 )
{
T_2 V_14 ;
if ( ! F_303 () )
...
V_14 = V_15 ;
if ( F_341 ( V_598 , V_170 , V_14 ) != 0 )
return V_765 ;
return V_764 ;
}
static unsigned int F_346 ( unsigned int V_767 ,
struct V_597 * V_598 ,
const struct V_768 * V_769 ,
const struct V_768 * V_66 ,
int (* F_343)( struct V_597 * ) )
{
return F_345 ( V_598 , V_177 ) ;
}
static unsigned int F_347 ( struct V_597 * V_598 ,
int V_712 ,
T_4 V_170 )
{
...
V_723 , V_770 , & V_252 ) )
return F_348 ( - V_771 ) ;
if ( F_349 ( V_649 -> V_14 , V_598 , & V_252 , V_599 ) )
return F_348 ( - V_771 ) ;
return V_764 ;
}
static unsigned int F_350 ( struct V_597 * V_598 , int V_712 ,
T_4 V_170 )
{
T_2 V_772 ;
T_2 V_708 ;
...
T_13 V_726 ;
if ( ! V_728 )
return F_347 ( V_598 , V_712 , V_170 ) ;
#ifdef F_351
if ( F_352 ( V_598 ) != NULL && F_352 ( V_598 ) -> V_773 != NULL )
return V_764 ;
#endif
V_725 = F_4 () ;
V_726 = F_303 () || F_304 () ;
...
static unsigned int F_353 ( unsigned int V_767 ,
struct V_597 * V_598 ,
const struct V_768 * V_769 ,
const struct V_768 * V_66 ,
int (* F_343)( struct V_597 * ) )
{
return F_350 ( V_598 , V_66 -> V_712 , V_177 ) ;
}
static unsigned int F_354 ( unsigned int V_767 ,
struct V_597 * V_598 ,
const struct V_768 * V_769 ,
const struct V_768 * V_66 ,
int (* F_343)( struct V_597 * ) )
{
return F_350 ( V_598 , V_66 -> V_712 , V_178 ) ;
}
static int F_355 ( struct V_646 * V_647 , struct V_597 * V_598 )
{
int V_552 ;
V_552 = F_356 ( V_647 , V_598 ) ;
if ( V_552 )
return V_552 ;
return F_334 ( V_647 , V_598 ) ;
}
...
static int F_367 ( struct V_786 * V_787 , int V_507 )
{
int V_552 ;
int V_238 ;
switch ( V_507 ) {
...
static int F_373 ( struct V_809 * V_810 , int V_507 )
{
int V_238 ;
int V_552 ;
switch ( V_507 ) {
...
static int F_378 ( struct V_828 * V_829 , int V_507 )
{
int V_552 ;
T_2 V_238 ;
switch ( V_507 ) {
...
static void F_381 ( struct V_777 * V_853 , T_2 * V_504 )
{
...
static int F_390 ( T_2 V_504 , char * * V_444 , T_2 * V_867 )
{
return F_47 ( V_504 , V_444 , V_867 ) ;
}
static int F_391 ( const char * V_444 , T_2 V_867 , T_2 * V_504 )
{
return F_54 ( V_444 , V_867 , V_504 ) ;
}
static void F_392 ( char * V_444 , T_2 V_867 )
{
F_28 ( V_444 ) ;
}
static int F_393 ( struct V_19 * V_19 , void * V_278 , T_2 V_868 )
{
return F_212 ( V_19 , V_463 , V_278 , V_868 , 0 ) ;
}
static int F_394 ( struct V_52 * V_52 , void * V_278 , T_2 V_868 )
{
return F_395 ( V_52 , V_67 , V_278 , V_868 , 0 ) ;
}
...
goto V_66;
F_38 ( V_74 L_61 ) ;
V_552 = F_411 ( V_879 , F_39 ( V_879 ) ) ;
if ( V_552 )
F_8 ( L_62 , V_552 ) ;
#if F_266 ( V_638 ) || F_266 ( V_639 )
V_552 = F_411 ( V_880 , F_39 ( V_880 ) ) ;
if ( V_552 )
F_8 ( L_63 , V_552 ) ;
#endif
V_66:
