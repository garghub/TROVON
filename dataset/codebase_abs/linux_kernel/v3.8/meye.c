...
static unsigned int F_91 ( struct V_115 * V_115 , T_6 * V_230 )
{
unsigned int V_231 = 0 ;
F_61 ( & V_7 . V_128 ) ;
F_92 ( V_115 , & V_7 . V_113 , V_230 ) ;
if ( F_87 ( & V_7 . V_111 ) )
V_231 = V_232 | V_233 ;
F_63 ( & V_7 . V_128 ) ;
return V_231 ;
}
static void F_93 ( struct V_234 * V_235 )
{
long V_236 = ( long ) V_235 -> V_237 ;
V_7 . V_210 [ V_236 ] ++ ;
}
static void F_94 ( struct V_234 * V_235 )
{
long V_236 = ( long ) V_235 -> V_237 ;
V_7 . V_210 [ V_236 ] -- ;
}
static int F_95 ( struct V_115 * V_115 , struct V_234 * V_235 )
{
unsigned long V_18 = V_235 -> V_238 ;
unsigned long V_1 = V_235 -> V_239 - V_235 -> V_238 ;
unsigned long V_218 = V_235 -> V_240 << V_241 ;
...
V_243 = ( unsigned long ) V_7 . V_105 + V_218 ;
while ( V_1 > 0 ) {
V_242 = F_96 ( ( void * ) V_243 ) ;
if ( F_97 ( V_235 , V_18 , V_242 , V_4 , V_244 ) ) {
F_63 ( & V_7 . V_128 ) ;
return - V_139 ;
}
V_18 += V_4 ;
...
V_235 -> V_245 = & V_246 ;
V_235 -> V_247 &= ~ V_248 ;
V_235 -> V_247 |= V_249 | V_250 ;
V_235 -> V_237 = ( void * ) ( V_218 / V_106 ) ;
F_93 ( V_235 ) ;
F_63 ( & V_7 . V_128 ) ;
return 0 ;
}
static int F_98 ( struct V_251 * V_252 , T_7 V_108 )
{
F_99 ( V_252 ) ;
V_7 . V_253 = V_7 . V_71 ;
F_37 () ;
...
static int F_100 ( struct V_251 * V_252 )
{
F_101 ( V_252 ) ;
F_102 ( V_7 . V_9 , V_254 , 1 ) ;
F_28 ( V_74 , 0 ) ;
F_28 ( V_38 , V_46 ) ;
F_38 ( 1 ) ;
F_25 ( V_255 , 1 ) ;
...
static int F_103 ( struct V_251 * V_258 , const struct V_259 * V_260 )
{
struct V_261 * V_262 = & V_7 . V_262 ;
int V_263 = - V_117 ;
unsigned long V_264 ;
if ( V_7 . V_9 != NULL ) {
F_17 ( V_76 L_25 ) ;
...
memcpy ( V_7 . V_266 , & V_270 , sizeof( V_270 ) ) ;
V_7 . V_266 -> V_262 = & V_7 . V_262 ;
V_263 = - V_271 ;
if ( ( V_263 = F_62 ( V_272 , 1 ) ) ) {
F_105 ( V_262 , L_30 ) ;
F_105 ( V_262 , L_31
L_32 ) ;
goto V_273;
}
if ( ( V_263 = F_110 ( V_7 . V_9 ) ) ) {
F_105 ( V_262 , L_33 ) ;
goto V_274;
}
V_264 = F_111 ( V_7 . V_9 , 0 ) ;
if ( ! V_264 ) {
F_105 ( V_262 , L_34 ) ;
goto V_275;
}
...
V_7 . V_31 = F_114 ( V_264 , V_276 ) ;
if ( ! V_7 . V_31 ) {
F_105 ( V_262 , L_36 ) ;
goto V_277;
}
V_7 . V_278 = V_258 -> V_95 ;
if ( F_115 ( V_7 . V_278 , F_49 ,
V_279 | V_280 , L_8 , F_49 ) ) {
F_105 ( V_262 , L_37 ) ;
goto V_281;
}
F_116 ( V_7 . V_9 , V_282 , 8 ) ;
F_116 ( V_7 . V_9 , V_283 , 64 ) ;
F_117 ( V_7 . V_9 ) ;
F_102 ( V_7 . V_9 , V_254 , 1 ) ;
F_28 ( V_74 , 0 ) ;
F_28 ( V_38 , V_46 ) ;
...
V_287 ) ;
F_121 ( V_262 , L_40 ,
V_7 . V_9 -> V_288 , V_264 , V_7 . V_278 ) ;
return 0 ;
V_286:
F_122 ( V_7 . V_278 , F_49 ) ;
V_281:
F_123 ( V_7 . V_31 ) ;
V_277:
...
static void F_128 ( struct V_251 * V_258 )
{
F_129 ( V_7 . V_266 ) ;
F_37 () ;
F_36 () ;
