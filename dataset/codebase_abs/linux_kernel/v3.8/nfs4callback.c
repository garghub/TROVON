...
struct V_44 * V_45 = F_46 ( V_51 , struct V_44 , V_167 ) ;
struct V_81 * V_82 = V_45 -> V_47 . V_168 ;
T_2 V_39 = V_82 -> V_86 ;
V_51 -> V_62 = V_39 ;
if ( V_39 ) {
if ( ! F_57 ( V_82 , V_146 ) )
...
struct V_44 * V_45 = F_46 ( V_51 , struct V_44 , V_167 ) ;
struct V_81 * V_82 = V_45 -> V_47 . V_168 ;
struct V_83 * V_173 = V_82 -> V_137 ;
F_64 ( V_146 , V_147 ) ;
if ( V_173 != V_146 -> V_174 ) {
return;
}
if ( V_51 -> V_170 )
return;
...
{
if ( V_51 -> V_159 -> V_179 )
V_51 -> V_159 -> V_179 ( V_51 ) ;
}
static struct V_180 * F_79 ( struct V_81 * V_82 )
{
struct V_20 * V_181 ;
struct V_180 * V_182 ;
...
if ( F_84 ( V_178 , & V_82 -> V_163 ) )
return;
F_55 ( & V_82 -> V_164 ) ;
F_8 ( ! ( V_82 -> V_163 & V_186 ) ) ;
F_65 ( V_162 , & V_82 -> V_163 ) ;
memcpy ( & V_98 , & V_51 -> V_52 -> V_132 , sizeof( struct V_97 ) ) ;
V_182 = F_79 ( V_82 ) ;
if ( V_182 ) {
F_85 ( V_182 -> V_187 ) ;
V_98 . V_131 = V_182 -> V_187 ;
V_85 = V_182 -> V_188 ;
}
F_56 ( & V_82 -> V_164 ) ;
V_185 = F_38 ( V_82 , & V_98 , V_85 ) ;
if ( V_185 ) {
F_44 ( V_82 , V_185 ) ;
return;
}
...
{
struct V_50 * V_51 = F_46 ( V_190 , struct V_50 , V_152 ) ;
struct V_81 * V_82 = V_51 -> V_52 ;
struct V_83 * V_191 ;
if ( V_82 -> V_163 & V_186 )
F_81 ( V_51 ) ;
...
F_87 ( V_191 , & V_51 -> V_153 , V_192 | V_193 ,
V_51 -> V_159 , V_51 ) ;
}
