...
struct V_70 * V_71 = V_79 -> V_71 ;
F_13 ( V_298 , L_148 ,
V_37 , V_79 -> V_365 . V_210 -> V_345 ) ;
F_39 ( V_298 , V_71 -> V_209 , V_75 , L_149 ) ;
F_82 ( & V_71 -> V_278 ) ;
V_71 -> V_210 = V_79 -> V_365 . V_210 -> V_345 ;
if ( F_94 ( V_71 -> V_209 ) )
F_92 ( V_71 ) ;
else
F_63 ( V_71 ) ;
...
static int F_120 ( struct V_330 * V_79 , enum V_372 V_85 ,
struct V_353 * V_354 , struct V_373 * V_374 ,
struct V_375 * V_376 )
{
struct V_70 * V_71 = V_79 -> V_71 ;
int V_73 ;
F_13 ( V_298 , L_152
L_153 ,
V_37 , V_85 , V_376 -> V_377 , V_376 -> V_378 , V_376 -> V_379 ) ;
if ( ( V_376 -> V_377 != V_380 ) &&
( V_376 -> V_377 != V_381 ) )
return - V_357 ;
V_376 -> V_382 = V_376 -> V_378 ;
F_82 ( & V_71 -> V_278 ) ;
switch ( V_85 ) {
case V_383 :
memcpy ( V_71 -> V_271 [ V_376 -> V_378 ] , V_376 -> V_376 , V_376 -> V_379 ) ;
V_71 -> V_249 [ V_376 -> V_378 ] = V_376 -> V_379 ;
V_71 -> V_248 = V_376 -> V_378 ;
break;
case V_384 :
default:
V_71 -> V_249 [ V_376 -> V_378 ] = 0 ;
break;
}
V_71 -> V_247 = 0 ;
for ( V_73 = 0 ; V_73 < V_152 ; V_73 ++ ) {
...
struct V_330 * V_79 ;
struct V_70 * V_71 ;
V_79 = F_122 ( sizeof( struct V_70 ) , & V_385 ) ;
if ( ! V_79 ) {
...
V_71 -> V_122 = V_386 ;
V_71 -> V_259 = 0 ;
V_71 -> V_79 -> V_387 = 100000 ;
return V_71 ;
}
static int F_128 ( struct V_70 * V_71 ,
struct V_388 * V_389 )
{
struct V_390 * V_391 , * V_392 , * V_393 ;
int V_73 ;
int V_394 ;
struct V_395 * V_396 ;
F_13 ( V_397 , L_156 , V_37 ) ;
F_13 ( V_285 , L_157 , V_37 ,
V_389 -> V_398 [ 0 ] . V_399 . V_400 ) ;
V_392 = NULL ;
V_393 = NULL ;
V_396 = V_389 -> V_401 ;
for ( V_73 = 0 ; V_73 < V_396 -> V_399 . V_400 ; V_73 ++ ) {
V_391 = & V_396 -> V_391 [ V_73 ] . V_399 ;
F_13 ( V_285 , L_158 ,
V_37 , V_73 , V_391 -> V_402 ,
V_391 -> V_403 ) ;
if ( ! V_392 && F_129 ( V_391 ) )
V_392 = V_391 ;
if ( ! V_393 && F_130 ( V_391 ) )
V_393 = V_391 ;
}
if ( ! V_392 || ! V_393 ) {
F_14 ( & V_389 -> V_38 , L_159 ) ;
return - V_404 ;
}
V_71 -> V_226 = F_131 ( V_71 -> V_10 , V_392 -> V_402 ) ;
V_71 -> V_349 = F_132 ( V_71 -> V_10 , V_393 -> V_402 ) ;
V_71 -> V_223 = F_133 ( 0 , V_41 ) ;
V_71 -> V_340 = F_133 ( 0 , V_41 ) ;
if ( ! V_71 -> V_223 || ! V_71 -> V_340 ) {
F_14 ( & V_389 -> V_38 , L_160 ) ;
return - V_42 ;
}
V_394 = sizeof( struct V_333 ) + V_405 ;
V_71 -> V_335 = F_15 ( V_394 , V_41 ) ;
if ( ! V_71 -> V_335 ) {
F_14 ( & V_389 -> V_38 , L_161 ) ;
return - V_42 ;
}
F_13 ( V_397 , L_162 , V_37 ) ;
return 0 ;
}
...
int V_21 ;
F_13 ( V_229 , L_163 ,
V_389 -> V_401 -> V_399 . V_400 ) ;
V_21 = F_128 ( V_71 , V_389 ) ;
if ( V_21 < 0 )
goto exit;
V_21 = F_29 ( V_71 ) ;
if ( V_21 < 0 ) {
F_14 ( & V_389 -> V_38 , L_164 ) ;
goto exit;
}
V_71 -> V_406 = F_31 ( V_71 -> V_76 ) ;
V_71 -> V_210 = V_407 ;
V_71 -> V_245 = V_356 ;
V_71 -> V_130 = V_408 ;
V_71 -> V_128 = V_409 ;
...
V_71 -> V_277 = 0 ;
V_80 = V_71 -> V_79 -> V_80 ;
V_71 -> V_79 -> V_80 -> V_414 = 1 ;
V_71 -> V_79 -> V_80 -> V_415 = 0 ;
V_71 -> V_79 -> V_80 -> V_416 = F_135 ( V_355 ) ;
V_71 -> V_79 -> V_80 -> V_417 [ V_418 ] = & V_419 ;
V_71 -> V_79 -> V_328 = V_420 |
V_421 ;
V_71 -> V_79 -> V_422 = 100 ;
F_136 ( V_71 -> V_79 , & V_389 -> V_38 ) ;
F_137 ( V_71 -> V_79 , V_71 -> V_74 ) ;
V_294 = sizeof( V_80 -> V_309 ) ;
snprintf ( V_80 -> V_309 , V_294 , L_165 ,
...
F_139 ( & V_389 -> V_38 ) , V_71 -> V_74 ,
V_71 -> V_309 . V_310 , V_71 -> V_309 . V_311 ,
V_71 -> V_309 . V_312 , V_71 -> V_309 . V_313 ) ;
F_47 ( V_71 -> V_79 -> V_80 , L_168 ,
V_71 -> V_76 , V_71 -> V_406 -> V_426 ) ;
exit:
return V_21 ;
}
...
static int F_148 ( struct V_388 * V_389 ,
...
if ( V_21 < 0 || ( V_431 . V_310 | V_431 . V_311 ) == 0 )
V_429 = 1 ;
} else
V_429 = 1 ;
if ( V_429 ) {
...
F_151 ( V_389 , V_71 ) ;
memcpy ( & V_71 -> V_309 , & V_431 , sizeof( struct V_430 ) ) ;
V_71 -> V_1 = V_1 ;
V_21 = F_134 ( V_71 , V_389 ) ;
if ( V_21 < 0 )
F_140 ( V_71 ) ;
return V_21 ;
error:
...
static void F_152 ( struct V_388 * V_389 )
{
struct V_70 * V_71 ;
V_71 = F_153 ( V_389 ) ;
F_151 ( V_389 , NULL ) ;
...
F_140 ( V_71 ) ;
F_154 ( & V_389 -> V_38 , L_177 ) ;
}
static int T_6 F_155 ( void )
{
int V_437 ;
F_123 (KERN_INFO DRIVER_DESC L_178 DRIVER_VERSION L_179 ) ;
F_124 ( & V_304 ) ;
V_437 = F_156 ( & V_438 ) ;
if ( V_437 < 0 )
...
{
int V_73 ;
F_123 (KERN_INFO DRIVER_DESC L_178 DRIVER_VERSION L_182 ) ;
F_159 ( & V_438 ) ;
