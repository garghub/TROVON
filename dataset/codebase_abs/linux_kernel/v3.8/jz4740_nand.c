...
struct V_6 * V_7 ;
struct V_2 * V_3 ;
struct V_96 * V_28 = V_63 -> V_69 . V_97 ;
T_5 V_4 , V_98 ;
T_3 V_76 = 0 , V_77 = 0 ;
V_5 = F_36 ( sizeof( * V_5 ) , V_99 ) ;
if ( ! V_5 ) {
F_20 ( & V_63 -> V_69 , L_9 ) ;
return - V_100 ;
}
V_67 = F_18 ( V_63 , L_10 , & V_5 -> V_101 , & V_5 -> V_11 ) ;
if ( V_67 )
goto V_102;
if ( V_28 && F_37 ( V_28 -> V_29 ) ) {
V_67 = F_28 ( V_28 -> V_29 , L_11 ) ;
if ( V_67 ) {
F_20 ( & V_63 -> V_69 ,
L_12 ,
V_28 -> V_29 , V_67 ) ;
...
unsigned char V_75 ;
V_75 = V_28 ? V_28 -> V_14 [ V_98 ] : V_98 ^ 1 ;
if ( V_75 == 0 )
break;
if ( V_75 > V_117 ) {
F_29 ( & V_63 -> V_69 ,
...
if ( V_28 && V_28 -> V_119 ) {
V_28 -> V_119 ( V_63 , V_7 , & V_28 -> V_120 ,
& V_28 -> V_121 ) ;
}
V_67 = F_39 ( V_3 ) ;
if ( V_67 ) {
...
V_67 = F_40 ( V_3 , NULL , NULL ,
V_28 ? V_28 -> V_120 : NULL ,
V_28 ? V_28 -> V_121 : 0 ) ;
if ( V_67 ) {
F_20 ( & V_63 -> V_69 , L_17 ) ;
goto V_123;
...
{
struct V_1 * V_5 = F_44 ( V_63 ) ;
struct V_96 * V_28 = V_63 -> V_69 . V_97 ;
T_5 V_42 ;
F_41 ( & V_5 -> V_3 ) ;
F_5 ( 0 , V_5 -> V_11 + V_12 ) ;
for ( V_42 = 0 ; V_42 < V_117 ; ++ V_42 ) {
