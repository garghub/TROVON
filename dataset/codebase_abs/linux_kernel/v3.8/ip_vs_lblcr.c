...
{
unsigned int V_40 = F_22 ( V_31 -> V_24 , & V_31 -> V_25 ) ;
...
{
unsigned int V_40 = F_22 ( V_24 , V_25 ) ;
struct V_30 * V_31 ;
...
static struct V_4 *
F_50 ( struct V_48 * V_49 , const struct V_71 * V_72 )
{
struct V_38 * V_39 = V_49 -> V_54 ;
struct V_73 V_74 ;
struct V_4 * V_5 = NULL ;
struct V_30 * V_31 ;
F_51 ( V_49 -> V_24 , V_72 , & V_74 ) ;
F_43 ( 6 , L_7 , V_23 ) ;
F_52 ( & V_49 -> V_58 ) ;
V_31 = F_26 ( V_49 -> V_24 , V_39 , & V_74 . V_43 ) ;
if ( V_31 ) {
V_31 -> V_44 = V_12 ;
F_52 ( & V_31 -> V_3 . V_14 ) ;
V_5 = F_14 ( & V_31 -> V_3 ) ;
...
F_11 ( & V_49 -> V_58 ) ;
F_28 ( V_39 , & V_74 . V_43 , V_5 ) ;
F_13 ( & V_49 -> V_58 ) ;
V_63:
F_17 ( 6 , L_10 ,
F_18 ( V_49 -> V_24 , & V_74 . V_43 ) ,
F_18 ( V_49 -> V_24 , & V_5 -> V_25 ) , F_19 ( V_5 -> V_26 ) ) ;
return V_5 ;
}
static int T_2 F_55 ( struct V_52 * V_52 )
{
...
return - V_69 ;
if ( V_52 -> V_80 != & V_81 )
V_51 -> V_78 [ 0 ] . V_82 = NULL ;
} else
V_51 -> V_78 = V_79 ;
V_51 -> F_34 = V_53 ;
V_51 -> V_78 [ 0 ] . V_59 = & V_51 -> F_34 ;
V_51 -> V_83 =
F_58 ( V_52 , L_11 , V_51 -> V_78 ) ;
if ( ! V_51 -> V_83 ) {
if ( ! F_56 ( V_52 , & V_77 ) )
F_9 ( V_51 -> V_78 ) ;
return - V_69 ;
...
static void T_3 F_59 ( struct V_52 * V_52 )
{
struct V_50 * V_51 = F_36 ( V_52 ) ;
F_60 ( V_51 -> V_83 ) ;
if ( ! F_56 ( V_52 , & V_77 ) )
...
static int T_2 F_55 ( struct V_52 * V_52 ) { return 0 ; }
static void T_3 F_59 ( struct V_52 * V_52 ) { }
