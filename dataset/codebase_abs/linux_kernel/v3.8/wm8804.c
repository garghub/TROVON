...
V_96 = F_21 ( V_6 ) ;
V_6 -> V_109 = V_96 -> V_104 ;
V_77 = F_31 ( V_6 , 8 , 8 , V_110 ) ;
if ( V_77 < 0 ) {
F_10 ( V_6 -> V_14 , L_12 , V_77 ) ;
return V_77 ;
}
for ( V_65 = 0 ; V_65 < F_14 ( V_96 -> V_103 ) ; V_65 ++ )
V_96 -> V_103 [ V_65 ] . V_111 = V_112 [ V_65 ] ;
V_77 = F_32 ( V_6 -> V_14 , F_14 ( V_96 -> V_103 ) ,
V_96 -> V_103 ) ;
if ( V_77 ) {
F_10 ( V_6 -> V_14 , L_13 , V_77 ) ;
return V_77 ;
}
V_96 -> V_106 [ 0 ] . V_113 = V_114 ;
V_96 -> V_106 [ 1 ] . V_113 = V_115 ;
for ( V_65 = 0 ; V_65 < F_14 ( V_96 -> V_103 ) ; V_65 ++ ) {
V_77 = F_33 ( V_96 -> V_103 [ V_65 ] . V_105 ,
& V_96 -> V_106 [ V_65 ] ) ;
if ( V_77 != 0 ) {
F_10 ( V_6 -> V_14 ,
L_14 ,
...
F_34 ( V_6 -> V_14 , L_18 , V_77 + 'A' ) ;
V_77 = F_7 ( V_6 ) ;
if ( V_77 < 0 ) {
F_10 ( V_6 -> V_14 , L_19 , V_77 ) ;
goto V_117;
}
F_20 ( V_6 , V_99 ) ;
return 0 ;
...
struct V_95 * V_96 ;
int V_77 ;
V_96 = F_36 ( & V_119 -> V_14 , sizeof *V_96 , V_120 ) ;
if ( ! V_96 )
return - V_121 ;
V_96 -> V_104 = F_37 ( V_119 , & V_122 ) ;
if ( F_38 ( V_96 -> V_104 ) ) {
V_77 = F_39 ( V_96 -> V_104 ) ;
return V_77 ;
}
F_40 ( V_119 , V_96 ) ;
V_77 = F_41 ( & V_119 -> V_14 ,
& V_123 , & V_124 , 1 ) ;
return V_77 ;
}
...
struct V_95 * V_96 ;
int V_77 ;
V_96 = F_36 ( & V_126 -> V_14 , sizeof *V_96 , V_120 ) ;
if ( ! V_96 )
return - V_121 ;
V_96 -> V_104 = F_45 ( V_126 , & V_122 ) ;
if ( F_38 ( V_96 -> V_104 ) ) {
V_77 = F_39 ( V_96 -> V_104 ) ;
return V_77 ;
}
F_46 ( V_126 , V_96 ) ;
V_77 = F_41 ( & V_126 -> V_14 ,
& V_123 , & V_124 , 1 ) ;
return V_77 ;
}
static int F_47 ( struct V_125 * V_126 )
{
F_43 ( & V_126 -> V_14 ) ;
return 0 ;
}
