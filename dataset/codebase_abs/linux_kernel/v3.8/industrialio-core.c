...
if ( V_52 -> V_95 < 0 )
return 0 ;
F_53 (i, &chan->info_mask, sizeof(long)*8 ) {
V_14 = F_48 ( V_114 [ V_5 / 2 ] ,
V_52 ,
& F_34 ,
& F_38 ,
V_5 / 2 ,
...
{
int V_14 ;
V_3 -> V_10 . V_151 = F_85 ( F_86 ( V_18 ) , V_3 -> V_132 ) ;
V_14 = F_21 ( V_3 ) ;
if ( V_14 ) {
F_14 ( V_3 -> V_10 . V_32 ,
L_28 ) ;
...
if ( V_14 < 0 )
goto V_157;
F_90 ( & V_3 -> V_128 , & V_158 ) ;
V_3 -> V_128 . V_159 = V_3 -> V_29 -> V_160 ;
V_14 = F_91 ( & V_3 -> V_128 , V_3 -> V_10 . V_151 , 1 ) ;
if ( V_14 < 0 )
goto V_161;
return 0 ;
V_161:
