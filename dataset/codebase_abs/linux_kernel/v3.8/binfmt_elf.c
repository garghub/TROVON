...
F_70 ( V_208 ) : F_70 ( V_209 ) )
goto V_195;
return 0 ;
}
if ( V_38 -> V_210 && F_70 ( V_211 ) )
goto V_195;
if ( V_38 -> V_203 == NULL )
return 0 ;
if ( F_70 ( V_212 ) )
...
static int F_75 ( struct V_233 * V_234 )
{
int V_235 ;
V_235 = sizeof( struct V_236 ) ;
V_235 += F_76 ( strlen ( V_234 -> V_237 ) + 1 , 4 ) ;
V_235 += F_76 ( V_234 -> V_238 , 4 ) ;
return V_235 ;
}
static int F_77 ( struct V_81 * V_81 , T_8 * V_239 )
{
static const char V_160 [ 4 ] = { 0 , } ;
F_78 ( V_160 , F_76 ( * V_239 , 4 ) - * V_239 , V_239 ) ;
return 1 ;
}
static int F_79 ( struct V_233 * V_240 , struct V_81 * V_81 ,
T_8 * V_239 )
{
struct V_236 V_234 ;
...
F_78 ( & V_234 , sizeof( V_234 ) , V_239 ) ;
F_78 ( V_240 -> V_237 , V_234 . V_241 , V_239 ) ;
if ( ! F_77 ( V_81 , V_239 ) )
return 0 ;
F_78 ( V_240 -> V_244 , V_240 -> V_238 , V_239 ) ;
if ( ! F_77 ( V_81 , V_239 ) )
return 0 ;
return 1 ;
}
static void F_80 ( struct V_15 * V_245 , int V_246 ,
...
static void F_81 ( struct V_50 * V_262 , int V_235 , T_8 V_263 )
{
V_262 -> V_97 = V_264 ;
V_262 -> V_91 = V_263 ;
V_262 -> V_89 = 0 ;
...
static void F_82 ( struct V_233 * V_267 , const char * V_237 , int type ,
...
static void F_83 ( struct V_268 * V_269 ,
...
F_84 () ;
V_269 -> V_280 = F_85 ( F_86 ( V_19 -> V_281 ) ) ;
F_87 () ;
V_269 -> V_282 = F_85 ( V_19 ) ;
V_269 -> V_283 = F_88 ( V_19 ) ;
V_269 -> V_284 = F_89 ( V_19 ) ;
if ( F_90 ( V_19 ) ) {
struct V_285 V_286 ;
F_91 ( V_19 , & V_286 ) ;
F_92 ( V_286 . V_287 , & V_269 -> V_288 ) ;
F_92 ( V_286 . V_289 , & V_269 -> V_290 ) ;
} else {
F_92 ( V_19 -> V_287 , & V_269 -> V_288 ) ;
F_92 ( V_19 -> V_289 , & V_269 -> V_290 ) ;
}
F_92 ( V_19 -> signal -> V_291 , & V_269 -> V_292 ) ;
F_92 ( V_19 -> signal -> V_293 , & V_269 -> V_294 ) ;
}
static int F_93 ( struct V_295 * V_296 , struct V_270 * V_19 ,
struct V_297 * V_5 )
{
...
V_296 -> V_299 [ V_39 ] = 0 ;
F_84 () ;
V_296 -> V_280 = F_85 ( F_86 ( V_19 -> V_281 ) ) ;
F_87 () ;
V_296 -> V_282 = F_85 ( V_19 ) ;
V_296 -> V_283 = F_88 ( V_19 ) ;
V_296 -> V_284 = F_89 ( V_19 ) ;
V_94 = V_19 -> V_300 ? F_95 ( ~ V_19 -> V_300 ) + 1 : 0 ;
V_296 -> V_301 = V_94 ;
V_296 -> V_302 = ( V_94 > 5 ) ? '.' : L_1 [ V_94 ] ;
V_296 -> V_303 = V_296 -> V_302 == 'Z' ;
V_296 -> V_304 = F_96 ( V_19 ) ;
V_296 -> V_305 = V_19 -> V_136 ;
F_84 () ;
V_36 = F_97 ( V_19 ) ;
F_98 ( V_296 -> V_306 , F_16 ( V_36 -> V_58 , V_36 -> V_59 ) ) ;
F_99 ( V_296 -> V_307 , F_17 ( V_36 -> V_58 , V_36 -> V_63 ) ) ;
F_87 () ;
strncpy ( V_296 -> V_308 , V_19 -> V_309 , sizeof( V_296 -> V_308 ) ) ;
return 0 ;
}
static void F_100 ( struct V_233 * V_267 , struct V_297 * V_5 )
{
...
F_82 ( V_267 , L_2 , V_312 , V_94 * sizeof( T_1 ) , V_310 ) ;
}
static void F_101 ( struct V_233 * V_267 , T_11 * V_313 ,
T_12 * V_314 )
{
T_7 V_315 = F_71 () ;
F_73 ( V_316 ) ;
F_102 ( ( T_11 V_11 * ) V_313 , V_314 ) ;
F_73 ( V_315 ) ;
F_82 ( V_267 , L_2 , V_317 , sizeof( * V_313 ) , V_313 ) ;
}
static void F_103 ( struct V_233 * V_267 )
{
struct V_37 * V_38 ;
...
if ( ! V_81 )
continue;
V_330 = F_106 ( & V_81 -> V_204 , V_324 , V_320 ) ;
if ( F_43 ( V_330 ) ) {
if ( F_42 ( V_330 ) == - V_331 ) {
F_107 ( V_244 ) ;
V_87 = V_87 * 5 / 4 ;
...
F_82 ( V_267 , L_2 , V_333 , V_87 , V_244 ) ;
V_328: ;
}
static void F_108 ( struct V_270 * V_334 ,
const struct V_335 * V_336 )
{
if ( V_336 -> V_337 )
V_336 -> V_337 ( V_334 , V_336 , 1 ) ;
}
static int F_109 ( struct V_338 * V_339 ,
const struct V_340 * V_341 ,
long V_271 , T_2 * V_342 )
{
unsigned int V_94 ;
F_83 ( & V_339 -> V_269 , V_339 -> V_334 , V_271 ) ;
( void ) V_341 -> V_343 [ 0 ] . F_110 ( V_339 -> V_334 , & V_341 -> V_343 [ 0 ] ,
0 , F_111 ( V_339 -> V_269 . V_344 ) ,
F_112 ( & V_339 -> V_269 ) , NULL ) ;
F_82 ( & V_339 -> V_345 [ 0 ] , L_2 , V_346 ,
F_113 ( V_339 -> V_269 ) , & V_339 -> V_269 ) ;
* V_342 += F_75 ( & V_339 -> V_345 [ 0 ] ) ;
F_108 ( V_339 -> V_334 , & V_341 -> V_343 [ 0 ] ) ;
for ( V_94 = 1 ; V_94 < V_341 -> V_321 ; ++ V_94 ) {
const struct V_335 * V_336 = & V_341 -> V_343 [ V_94 ] ;
F_108 ( V_339 -> V_334 , V_336 ) ;
if ( V_336 -> V_347 && V_336 -> F_110 &&
...
if ( F_51 ( ! V_244 ) )
return 0 ;
V_349 = V_336 -> F_110 ( V_339 -> V_334 , V_336 ,
0 , V_87 , V_244 , NULL ) ;
if ( F_51 ( V_349 ) )
F_35 ( V_244 ) ;
else {
if ( V_336 -> V_347 != V_350 )
F_82 ( & V_339 -> V_345 [ V_94 ] , L_3 ,
V_336 -> V_347 ,
V_87 , V_244 ) ;
else {
F_114 ( & V_339 -> V_269 , 1 ) ;
F_82 ( & V_339 -> V_345 [ V_94 ] , L_2 ,
V_350 , V_87 , V_244 ) ;
}
* V_342 += F_75 ( & V_339 -> V_345 [ V_94 ] ) ;
}
}
}
return 1 ;
}
static int F_115 ( struct V_15 * V_245 , int V_351 ,
struct V_352 * V_353 ,
T_12 * V_314 , struct V_155 * V_156 )
{
struct V_270 * V_354 = V_4 ;
const struct V_340 * V_341 = F_116 ( V_354 ) ;
struct V_338 * V_339 ;
struct V_295 * V_296 ;
struct V_355 * V_356 ;
unsigned int V_94 ;
...
if ( V_296 == NULL ) {
V_353 -> V_296 . V_244 = NULL ;
return 0 ;
}
F_82 ( & V_353 -> V_296 , L_2 , V_358 , sizeof( * V_296 ) , V_296 ) ;
V_353 -> V_359 = 0 ;
for ( V_94 = 0 ; V_94 < V_341 -> V_321 ; ++ V_94 )
if ( V_341 -> V_343 [ V_94 ] . V_347 != 0 )
++ V_353 -> V_359 ;
if ( F_51 ( V_353 -> V_359 == 0 ) ||
F_51 ( V_341 -> V_343 [ 0 ] . V_347 != V_346 ) ) {
F_117 ( 1 ) ;
return 0 ;
}
F_80 ( V_245 , V_351 ,
...
V_339 = F_118 ( F_119 ( struct V_338 ,
V_345 [ V_353 -> V_359 ] ) ,
V_115 ) ;
if ( F_51 ( ! V_339 ) )
return 0 ;
...
if ( ! F_109 ( V_339 , V_341 , V_314 -> V_273 , & V_353 -> V_87 ) )
return 0 ;
F_93 ( V_296 , V_354 -> V_364 , V_354 -> V_5 ) ;
V_353 -> V_87 += F_75 ( & V_353 -> V_296 ) ;
F_101 ( & V_353 -> V_365 , & V_353 -> V_313 , V_314 ) ;
V_353 -> V_87 += F_75 ( & V_353 -> V_365 ) ;
F_100 ( & V_353 -> V_310 , V_4 -> V_5 ) ;
V_353 -> V_87 += F_75 ( & V_353 -> V_310 ) ;
F_103 ( & V_353 -> V_366 ) ;
V_353 -> V_87 += F_75 ( & V_353 -> V_366 ) ;
return 1 ;
}
static T_2 F_120 ( struct V_352 * V_353 )
{
return V_353 -> V_87 ;
}
static int F_121 ( struct V_352 * V_353 ,
...
do {
int V_94 ;
if ( ! F_79 ( & V_339 -> V_345 [ 0 ] , V_81 , V_239 ) )
return 0 ;
if ( V_367 && ! F_79 ( & V_353 -> V_296 , V_81 , V_239 ) )
return 0 ;
if ( V_367 && ! F_79 ( & V_353 -> V_365 , V_81 , V_239 ) )
return 0 ;
if ( V_367 && ! F_79 ( & V_353 -> V_310 , V_81 , V_239 ) )
return 0 ;
if ( V_367 && ! F_79 ( & V_353 -> V_366 , V_81 , V_239 ) )
return 0 ;
for ( V_94 = 1 ; V_94 < V_353 -> V_359 ; ++ V_94 )
if ( V_339 -> V_345 [ V_94 ] . V_244 &&
! F_79 ( & V_339 -> V_345 [ V_94 ] , V_81 , V_239 ) )
return 0 ;
V_367 = 0 ;
V_339 = V_339 -> V_363 ;
} while ( V_339 );
...
static void F_122 ( struct V_352 * V_353 )
{
...
V_368 = V_339 -> V_363 ;
F_117 ( V_339 -> V_345 [ 0 ] . V_244 && V_339 -> V_345 [ 0 ] . V_244 != & V_339 -> V_269 ) ;
for ( V_94 = 1 ; V_94 < V_353 -> V_359 ; ++ V_94 )
F_35 ( V_339 -> V_345 [ V_94 ] . V_244 ) ;
F_35 ( V_339 ) ;
}
F_35 ( V_353 -> V_296 . V_244 ) ;
F_107 ( V_353 -> V_366 . V_244 ) ;
}
static int F_123 ( long V_271 , struct V_369 * V_339 )
{
int V_235 = 0 ;
struct V_270 * V_19 = V_339 -> V_357 ;
V_339 -> V_370 = 0 ;
F_83 ( & V_339 -> V_269 , V_19 , V_271 ) ;
F_124 ( V_19 , & V_339 -> V_269 . V_344 ) ;
F_82 ( & V_339 -> V_345 [ 0 ] , L_2 , V_346 , sizeof( V_339 -> V_269 ) ,
& ( V_339 -> V_269 ) ) ;
V_339 -> V_370 ++ ;
V_235 += F_75 ( & V_339 -> V_345 [ 0 ] ) ;
if ( ( V_339 -> V_269 . V_371 = F_125 ( V_19 , NULL ,
& V_339 -> V_372 ) ) ) {
F_82 ( & V_339 -> V_345 [ 1 ] , L_2 , V_350 , sizeof( V_339 -> V_372 ) ,
& ( V_339 -> V_372 ) ) ;
V_339 -> V_370 ++ ;
V_235 += F_75 ( & V_339 -> V_345 [ 1 ] ) ;
}
#ifdef F_126
if ( F_127 ( V_19 , & V_339 -> V_373 ) ) {
F_82 ( & V_339 -> V_345 [ 2 ] , L_3 , V_374 ,
sizeof( V_339 -> V_373 ) , & V_339 -> V_373 ) ;
V_339 -> V_370 ++ ;
V_235 += F_75 ( & V_339 -> V_345 [ 2 ] ) ;
}
#endif
return V_235 ;
}
static int F_128 ( struct V_352 * V_353 )
{
...
V_377 = F_118 ( sizeof( * V_377 ) , V_115 ) ;
if ( ! V_377 )
return 0 ;
V_377 -> V_357 = V_356 -> V_334 ;
F_130 ( & V_377 -> V_378 , & V_353 -> V_375 ) ;
}
F_131 (t, &info->thread_list) {
int V_235 ;
V_377 = F_132 ( V_339 , struct V_369 , V_378 ) ;
V_235 = F_123 ( V_314 -> V_273 , V_377 ) ;
V_353 -> V_379 += V_235 ;
}
}
memset ( V_353 -> V_269 , 0 , sizeof( * V_353 -> V_269 ) ) ;
F_83 ( V_353 -> V_269 , V_4 , V_314 -> V_273 ) ;
F_133 ( & V_353 -> V_269 -> V_344 , V_156 ) ;
F_80 ( V_245 , V_351 , V_380 , V_381 , V_256 ) ;
F_82 ( V_353 -> V_345 + 0 , L_2 , V_346 ,
sizeof( * V_353 -> V_269 ) , V_353 -> V_269 ) ;
F_93 ( V_353 -> V_296 , V_4 -> V_364 , V_4 -> V_5 ) ;
F_82 ( V_353 -> V_345 + 1 , L_2 , V_358 ,
sizeof( * V_353 -> V_296 ) , V_353 -> V_296 ) ;
F_101 ( V_353 -> V_345 + 2 , & V_353 -> V_313 , V_314 ) ;
F_100 ( V_353 -> V_345 + 3 , V_4 -> V_5 ) ;
F_103 ( V_353 -> V_345 + 4 ) ;
V_353 -> V_382 = 5 ;
V_353 -> V_269 -> V_371 = F_125 ( V_4 , V_156 ,
V_353 -> V_372 ) ;
if ( V_353 -> V_269 -> V_371 )
F_82 ( V_353 -> V_345 + V_353 -> V_382 ++ ,
L_2 , V_350 , sizeof( * V_353 -> V_372 ) , V_353 -> V_372 ) ;
#ifdef F_126
if ( F_127 ( V_4 , V_353 -> V_373 ) )
F_82 ( V_353 -> V_345 + V_353 -> V_382 ++ ,
L_3 , V_374 ,
...
struct V_376 * V_339 ;
for ( V_94 = 0 ; V_94 < V_353 -> V_382 ; V_94 ++ )
if ( ! F_79 ( V_353 -> V_345 + V_94 , V_81 , V_239 ) )
return 0 ;
F_131 (t, &info->thread_list) {
struct V_369 * V_383 =
F_132 ( V_339 , struct V_369 , V_378 ) ;
for ( V_94 = 0 ; V_94 < V_383 -> V_370 ; V_94 ++ )
if ( ! F_79 ( & V_383 -> V_345 [ V_94 ] , V_81 , V_239 ) )
return 0 ;
}
return 1 ;
}
static void F_122 ( struct V_352 * V_353 )
{
while ( ! F_134 ( & V_353 -> V_375 ) ) {
struct V_376 * V_383 = V_353 -> V_375 . V_363 ;
F_135 ( V_383 ) ;
F_35 ( F_132 ( V_383 , struct V_369 , V_378 ) ) ;
}
F_107 ( V_353 -> V_345 [ 4 ] . V_244 ) ;
F_35 ( V_353 -> V_269 ) ;
F_35 ( V_353 -> V_296 ) ;
F_35 ( V_353 -> V_345 ) ;
F_35 ( V_353 -> V_372 ) ;
...
static struct V_37 * F_136 ( struct V_270 * V_384 ,
struct V_37 * V_385 )
{
...
static struct V_37 * F_137 ( struct V_37 * V_386 ,
struct V_37 * V_385 )
{
struct V_37 * V_349 ;
V_349 = V_386 -> V_329 ;
...
static void F_138 ( struct V_15 * V_245 , struct V_387 * V_388 ,
T_1 V_389 , int V_246 )
{
V_245 -> V_389 = V_389 ;
...
static T_2 F_139 ( struct V_37 * V_385 ,
unsigned long V_194 )
{
struct V_37 * V_38 ;
T_2 V_87 = 0 ;
for ( V_38 = F_136 ( V_4 , V_385 ) ; V_38 != NULL ;
V_38 = F_137 ( V_38 , V_385 ) )
V_87 += F_69 ( V_38 , V_194 ) ;
return V_87 ;
}
static int F_140 ( struct V_399 * V_400 )
{
int V_401 = 0 ;
T_7 V_219 ;
int V_246 ;
...
if ( ! F_115 ( V_245 , V_52 , & V_353 , V_400 -> V_314 , V_400 -> V_156 ) )
goto V_405;
V_401 = 1 ;
V_4 -> V_136 |= V_406 ;
V_219 = F_71 () ;
...
V_239 = V_263 ;
{
T_2 V_235 = F_120 ( & V_353 ) ;
V_235 += F_142 () ;
V_403 = F_33 ( sizeof( * V_403 ) , V_115 ) ;
if ( ! V_403 )
goto V_407;
F_81 ( V_403 , V_235 , V_263 ) ;
V_263 += V_235 ;
}
V_402 = V_263 = F_76 ( V_263 , V_44 ) ;
V_263 += F_139 ( V_385 , V_400 -> V_194 ) ;
V_263 += F_143 () ;
V_389 = V_263 ;
if ( V_52 == V_404 ) {
...
if ( ! V_388 )
goto V_407;
F_138 ( V_245 , V_388 , V_389 , V_246 ) ;
}
V_263 = V_402 ;
V_87 += sizeof( * V_245 ) ;
if ( V_87 > V_400 -> V_408 || ! F_144 ( V_400 -> V_81 , V_245 , sizeof( * V_245 ) ) )
goto V_407;
V_87 += sizeof( * V_403 ) ;
if ( V_87 > V_400 -> V_408
|| ! F_144 ( V_400 -> V_81 , V_403 , sizeof( * V_403 ) ) )
goto V_407;
for ( V_38 = F_136 ( V_4 , V_385 ) ; V_38 != NULL ;
V_38 = F_137 ( V_38 , V_385 ) ) {
struct V_50 V_262 ;
...
V_262 . V_265 = 0 ;
V_262 . V_88 = F_69 ( V_38 , V_400 -> V_194 ) ;
...
V_87 += sizeof( V_262 ) ;
if ( V_87 > V_400 -> V_408
|| ! F_144 ( V_400 -> V_81 , & V_262 , sizeof( V_262 ) ) )
goto V_407;
}
if ( ! F_145 ( V_400 -> V_81 , V_263 , & V_87 , V_400 -> V_408 ) )
goto V_407;
if ( ! F_121 ( & V_353 , V_400 -> V_81 , & V_239 ) )
goto V_407;
if ( F_146 ( V_400 -> V_81 , & V_239 ) )
goto V_407;
if ( ! F_147 ( V_400 -> V_81 , V_402 - V_239 ) )
goto V_407;
for ( V_38 = F_136 ( V_4 , V_385 ) ; V_38 != NULL ;
V_38 = F_137 ( V_38 , V_385 ) ) {
unsigned long V_3 ;
unsigned long V_2 ;
V_2 = V_38 -> V_217 + F_69 ( V_38 , V_400 -> V_194 ) ;
for ( V_3 = V_38 -> V_217 ; V_3 < V_2 ; V_3 += V_190 ) {
struct V_411 * V_411 ;
int V_412 ;
V_411 = F_148 ( V_3 ) ;
if ( V_411 ) {
void * V_413 = F_149 ( V_411 ) ;
V_412 = ( ( V_87 += V_190 ) > V_400 -> V_408 ) ||
! F_144 ( V_400 -> V_81 , V_413 ,
V_190 ) ;
F_150 ( V_411 ) ;
F_151 ( V_411 ) ;
} else
V_412 = ! F_147 ( V_400 -> V_81 , V_190 ) ;
if ( V_412 )
goto V_407;
}
}
if ( ! F_152 ( V_400 -> V_81 , & V_87 , V_400 -> V_408 ) )
goto V_407;
if ( V_52 == V_404 ) {
V_87 += sizeof( * V_388 ) ;
if ( V_87 > V_400 -> V_408
|| ! F_144 ( V_400 -> V_81 , V_388 ,
sizeof( * V_388 ) ) )
goto V_407;
}
V_407:
...
static int T_15 F_153 ( void )
{
F_154 ( & V_187 ) ;
return 0 ;
}
static void T_16 F_155 ( void )
{
F_156 ( & V_187 ) ;
}
