...
static void F_56 ( struct V_67 * V_3 )
{
struct V_2 * V_174 = V_3 -> V_74 ;
if ( V_174 ) {
F_32 ( & V_174 -> V_78 ) ;
V_3 -> V_74 = NULL ;
V_174 -> V_63 = 0 ;
...
static int F_57 ( struct V_173 * V_16 ,
...
V_3 -> V_165 = V_168 ;
V_178 = V_16 -> V_182 ;
if ( V_178 -> V_183 . V_184 != 2 )
goto error;
for ( V_168 = 0 ; V_168 < V_178 -> V_183 . V_184 ; V_168 ++ ) {
V_180 = & V_178 -> V_185 [ V_168 ] . V_183 ;
if ( F_58 ( V_180 ) ) {
V_3 -> V_49 = V_180 ;
continue;
}
...
goto error;
V_38 = F_19 ( V_3 -> V_49 -> V_40 ) ;
V_3 -> V_51 = F_62 ( V_38 , V_18 ) ;
if ( ! V_3 -> V_51 ) {
F_53 ( & V_169 ) ;
return - V_39 ;
}
V_38 = F_19 ( V_3 -> V_27 -> V_40 ) ;
V_3 -> V_41 = F_62 ( V_38 , V_18 ) ;
if ( ! V_3 -> V_41 ) {
F_63 ( V_3 -> V_51 ) ;
F_53 ( & V_169 ) ;
return - V_39 ;
...
if ( V_3 -> V_55 . V_56 == V_57 ) {
F_15 ( V_3 , V_33 ) ;
F_50 ( & V_16 -> V_3 , L_6 , V_3 -> V_34 . V_35 ) ;
if ( F_11 ( V_3 ) ) {
F_15 ( V_3 , V_193 ) ;
F_50 ( & V_16 -> V_3 , L_6 , V_3 -> V_34 . V_36 ) ;
} else {
F_2 ( L_7 ) ;
}
}
...
static void F_70 ( struct V_173 * V_16 )
{
