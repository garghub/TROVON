...
switch ( V_4 & V_40 ) {
case V_41 :
V_26 = V_2 -> V_30 . V_42 ( V_2 , V_3 , V_18 , type , V_21 , V_4 , & V_23 ) ;
break;
case V_43 :
V_26 = V_2 -> V_30 . V_44 ( V_2 , V_3 , V_18 , V_16 , type , V_21 , V_4 , & V_23 ) ;
break;
case V_45 :
V_26 = V_2 -> V_30 . V_46 ( V_2 , V_3 , V_18 , V_16 , type , V_21 , V_4 , & V_23 ) ;
break;
default:
break;
}
break;
case V_47 :
V_26 = V_2 -> V_30 . V_48 ( V_2 , V_3 , V_18 , V_16 , type , V_21 , V_4 , & V_23 ) ;
break;
case F_6 ( 0 ) :
case F_6 ( 1 ) :
case F_6 ( 2 ) :
case F_6 ( 3 ) :
V_26 = V_2 -> V_30 . V_49 ( V_2 , V_3 , V_18 , ( V_10 & 0xc0 ) >> 6 ,
type , V_21 , V_4 , & V_23 ) ;
break;
default:
F_7 ( 1 ) ;
