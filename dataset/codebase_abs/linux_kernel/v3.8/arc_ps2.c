...
V_2 = F_20 ( & V_36 -> V_20 , sizeof( struct V_1 ) ,
V_37 ) ;
if ( ! V_2 ) {
F_4 ( & V_36 -> V_20 , L_9 ) ;
return - V_38 ;
...
for ( V_22 = 0 ; V_22 < V_23 ; V_22 ++ )
F_24 ( V_2 -> V_4 [ V_22 ] . V_19 ) ;
F_15 ( & V_36 -> V_20 , L_14 , V_2 -> V_12 ) ;
F_15 ( & V_36 -> V_20 , L_15 , V_2 -> V_14 ) ;
F_15 ( & V_36 -> V_20 , L_16 ,
V_2 -> V_17 ) ;
return 0 ;
}
