...
struct V_20 * V_73 ,
int V_252 , int V_253 , struct V_74 * V_254 )
{
struct V_10 * V_6 = V_2 -> V_6 ;
struct F_3 * V_9 = F_3 ( V_2 ) ;
struct V_23 * V_24 = V_23 ( V_6 ) ;
...
F_22 ( V_2 , V_73 ) ;
if ( F_11 ( V_24 -> V_27 ) -> V_49 == V_50 )
F_8 ( V_6 , 0 , V_255 , F_5 ( V_6 ) -> V_12 . V_256 ) ;
F_26 ( V_2 , V_73 ) ;
...
struct V_10 * V_6 = V_2 -> V_6 ;
struct V_30 * V_31 = & F_5 ( V_6 ) -> V_12 ;
struct V_3 * V_257 = & V_31 -> V_13 [ V_9 -> V_5 ] ;
struct V_30 * V_258 = & F_5 ( V_6 ) -> V_199 ;
struct V_3 * V_259 = & V_258 -> V_13 [ V_9 -> V_5 ] ;
if ( F_14 ( V_2 -> V_6 ) )
F_15 ( V_2 -> V_6 , V_9 -> V_5 ) ;
F_32 ( V_2 -> V_6 , V_9 -> V_5 , V_258 ) ;
V_31 -> V_256 = V_258 -> V_256 & ~ ( 0x5 << 16 ) ;
V_257 -> V_7 [ V_260 ] = V_259 -> V_7 [ V_260 ] ;
V_31 -> V_45 = V_258 -> V_45 & ~ ( V_46 | V_47 | V_48 ) ;
V_257 -> V_229 = V_259 -> V_229 ;
}
...
struct V_10 * V_6 = V_2 -> V_6 ;
int V_261 = V_9 -> V_5 ;
T_1 V_262 = F_5 ( V_6 ) -> V_199 . V_13 [ V_261 ] . V_7 [ V_263 ] ;
if ( F_14 ( V_2 -> V_6 ) )
F_15 ( V_2 -> V_6 , V_261 ) ;
F_34 ( V_2 -> V_6 , V_261 , & F_5 ( V_6 ) -> V_199 ) ;
F_30 ( V_2 -> V_6 , V_261 , V_262 ) ;
V_9 -> V_65 = V_264 ;
}
...
F_15 ( V_6 , V_9 -> V_5 ) ;
F_36 ( V_6 , V_9 -> V_5 ) ;
V_266 -> V_268 ( V_2 , V_69 ) ;
F_37 ( V_6 , V_9 -> V_5 , true ) ;
F_38 ( V_6 , V_9 -> V_5 , V_269 , V_270 ) ;
if ( F_11 ( V_24 -> V_27 ) -> V_49 == V_50 ) {
T_2 V_271 = F_39 ( V_6 , V_9 -> V_5 , V_272 ) ;
F_8 ( V_6 , V_9 -> V_5 , V_272 , V_271 & ~ 0x10000 ) ;
}
}
...
struct V_265 * V_266 = V_2 -> V_267 ;
struct F_3 * V_9 = F_3 ( V_2 ) ;
F_34 ( V_6 , V_9 -> V_5 , & F_5 ( V_6 ) -> V_12 ) ;
F_41 ( V_2 , V_2 -> V_252 , V_2 -> V_253 , NULL ) ;
#ifdef F_42
{
T_1 V_273 = F_16 ( V_6 , V_9 -> V_5 , V_274 ) ;
V_273 |= F_25 ( V_275 ) ;
F_2 ( V_6 , V_9 -> V_5 , V_274 , V_273 ) ;
}
#endif
V_266 -> V_268 ( V_2 , V_70 ) ;
F_43 ( V_6 , V_9 -> V_5 ) ;
}
...
{
struct F_3 * V_9 = F_3 ( V_2 ) ;
struct V_10 * V_6 = V_9 -> V_277 . V_6 ;
struct V_278 { T_1 V_279 , V_280 , V_281 ; } V_282 ( ( V_283 ) ) * V_284 ;
int V_285 ;
V_284 = (struct V_278 * ) F_5 ( V_6 ) -> V_12 . V_13 [ V_9 -> V_5 ] . V_286 ;
for ( V_285 = 0 ; V_285 < 256 ; V_285 ++ ) {
V_284 [ V_285 ] . V_279 = V_9 -> V_287 . V_279 [ V_285 ] >> 8 ;
V_284 [ V_285 ] . V_280 = V_9 -> V_287 . V_280 [ V_285 ] >> 8 ;
V_284 [ V_285 ] . V_281 = V_9 -> V_287 . V_281 [ V_285 ] >> 8 ;
}
F_51 ( V_6 , V_9 -> V_5 , & F_5 ( V_6 ) -> V_12 ) ;
}
static void
F_52 ( struct V_1 * V_2 , T_3 * V_279 , T_3 * V_280 , T_3 * V_281 , T_2 V_288 ,
T_2 V_289 )
{
int V_290 = ( V_288 + V_289 > 256 ) ? 256 : V_288 + V_289 , V_285 ;
struct F_3 * V_9 = F_3 ( V_2 ) ;
for ( V_285 = V_288 ; V_285 < V_290 ; V_285 ++ ) {
V_9 -> V_287 . V_279 [ V_285 ] = V_279 [ V_285 ] ;
V_9 -> V_287 . V_280 [ V_285 ] = V_280 [ V_285 ] ;
V_9 -> V_287 . V_281 [ V_285 ] = V_281 [ V_285 ] ;
}
if ( ! V_9 -> V_277 . V_75 ) {
V_9 -> V_287 . V_238 = 0 ;
return;
...
F_53 ( struct V_1 * V_2 ,
struct V_74 * V_291 ,
int V_252 , int V_253 , bool V_292 )
{
struct F_3 * V_9 = F_3 ( V_2 ) ;
struct V_10 * V_6 = V_2 -> V_6 ;
struct V_23 * V_24 = V_23 ( V_6 ) ;
...
V_293 = V_2 -> V_75 ;
V_75 = V_294 ( V_2 -> V_75 ) ;
V_297 = F_54 ( V_75 -> V_276 , V_298 ) ;
if ( V_297 )
return V_297 ;
if ( V_291 ) {
struct V_294 * V_299 = V_294 ( V_291 ) ;
F_47 ( V_299 -> V_276 ) ;
}
}
V_9 -> V_75 . V_61 = V_75 -> V_276 -> V_300 . V_61 ;
if ( V_9 -> V_287 . V_238 != V_293 -> V_238 ) {
V_9 -> V_287 . V_238 = V_293 -> V_238 ;
F_50 ( V_2 ) ;
}
V_11 -> V_7 [ V_237 ] &= ~ 3 ;
V_11 -> V_7 [ V_237 ] |= ( V_2 -> V_75 -> V_238 + 1 ) / 8 ;
...
V_11 -> V_240 |= V_244 ;
F_1 ( V_2 , V_11 , V_237 ) ;
F_8 ( V_6 , V_9 -> V_5 , V_301 ,
V_11 -> V_240 ) ;
V_11 -> V_7 [ V_153 ] = V_293 -> V_154 [ 0 ] >> 3 ;
V_11 -> V_7 [ V_159 ] =
F_24 ( V_293 -> V_154 [ 0 ] >> 3 , 8 , V_160 ) ;
V_11 -> V_7 [ V_161 ] =
F_24 ( V_293 -> V_154 [ 0 ] / 8 , 11 , V_162 ) ;
F_1 ( V_2 , V_11 , V_159 ) ;
F_1 ( V_2 , V_11 , V_153 ) ;
F_1 ( V_2 , V_11 , V_161 ) ;
V_11 -> V_302 = V_9 -> V_75 . V_61 & ~ 3 ;
V_11 -> V_302 += ( V_253 * V_293 -> V_154 [ 0 ] ) + ( V_252 * V_293 -> V_303 / 8 ) ;
F_55 ( V_6 , V_9 -> V_5 , V_11 -> V_302 ) ;
F_56 ( V_6 , V_2 -> V_21 . clock , V_293 -> V_303 ,
& V_295 , & V_296 ) ;
V_11 -> V_7 [ V_304 ] = V_295 ;
V_11 -> V_7 [ V_305 ] = V_296 & 0xff ;
F_1 ( V_2 , V_11 , V_304 ) ;
F_1 ( V_2 , V_11 , V_305 ) ;
if ( F_11 ( V_24 -> V_27 ) -> V_49 >= V_306 ) {
V_11 -> V_7 [ V_307 ] = V_296 >> 8 ;
F_1 ( V_2 , V_11 , V_307 ) ;
}
return 0 ;
}
static int
F_41 ( struct V_1 * V_2 , int V_252 , int V_253 ,
struct V_74 * V_254 )
{
return F_53 ( V_2 , V_254 , V_252 , V_253 , false ) ;
}
static int
F_57 ( struct V_1 * V_2 ,
struct V_74 * V_75 ,
int V_252 , int V_253 , enum V_308 V_31 )
{
...
F_59 ( V_6 ) ;
return F_53 ( V_2 , V_75 , V_252 , V_253 , true ) ;
}
static void F_60 ( struct V_10 * V_6 , struct V_310 * V_311 ,
struct V_310 * V_312 )
{
int V_313 = F_61 ( V_6 ) ;
T_2 V_314 ;
int V_285 , V_315 ;
for ( V_285 = 0 ; V_285 < V_313 ; V_285 ++ ) {
for ( V_315 = 0 ; V_315 < V_313 ; V_315 ++ ) {
V_314 = F_62 ( V_311 , V_285 * 64 + V_315 ) ;
F_63 ( V_312 , V_285 * V_313 + V_315 , ( V_314 & 0x80000000 ) >> 16
| ( V_314 & 0xf80000 ) >> 9
| ( V_314 & 0xf800 ) >> 6
| ( V_314 & 0xf8 ) >> 3 ) ;
}
...
static void F_64 ( struct V_10 * V_6 , struct V_310 * V_311 ,
struct V_310 * V_312 )
{
T_2 V_314 ;
int V_316 , V_285 ;
for ( V_285 = 0 ; V_285 < 64 * 64 ; V_285 ++ ) {
V_314 = F_62 ( V_311 , V_285 ) ;
V_316 = V_314 >> 24 ;
if ( V_316 > 0 && V_316 < 255 )
V_314 = ( V_314 & 0x00ffffff ) | ( ( V_316 + 1 ) << 24 ) ;
#ifdef F_42
{
struct V_23 * V_24 = V_23 ( V_6 ) ;
if ( F_11 ( V_24 -> V_27 ) -> V_40 == 0x11 ) {
V_314 = ( ( V_314 & 0x000000ff ) << 24 ) |
( ( V_314 & 0x0000ff00 ) << 8 ) |
( ( V_314 & 0x00ff0000 ) >> 8 ) |
( ( V_314 & 0xff000000 ) >> 24 ) ;
}
...
#endif
F_65 ( V_312 , V_285 , V_314 ) ;
}
}
static int
F_66 ( struct V_1 * V_2 , struct V_317 * V_318 ,
T_2 V_319 , T_2 V_313 , T_2 V_320 )
{
struct V_23 * V_24 = V_23 ( V_2 -> V_6 ) ;
struct V_10 * V_6 = V_24 -> V_6 ;
struct F_3 * V_9 = F_3 ( V_2 ) ;
struct V_310 * V_59 = NULL ;
struct V_321 * V_322 ;
int V_297 = 0 ;
if ( ! V_319 ) {
V_9 -> V_59 . V_323 ( V_9 , true ) ;
return 0 ;
}
if ( V_313 != 64 || V_320 != 64 )
return - V_324 ;
V_322 = F_67 ( V_6 , V_318 , V_319 ) ;
if ( ! V_322 )
return - V_325 ;
V_59 = F_68 ( V_322 ) ;
V_297 = F_69 ( V_59 ) ;
...
goto V_326;
if ( F_11 ( V_24 -> V_27 ) -> V_40 >= 0x11 )
F_64 ( V_6 , V_59 , V_9 -> V_59 . V_276 ) ;
else
F_60 ( V_6 , V_59 , V_9 -> V_59 . V_276 ) ;
F_46 ( V_59 ) ;
V_9 -> V_59 . V_61 = V_9 -> V_59 . V_276 -> V_300 . V_61 ;
V_9 -> V_59 . V_60 ( V_9 , V_9 -> V_59 . V_61 ) ;
V_9 -> V_59 . V_327 ( V_9 , true ) ;
V_326:
F_70 ( V_322 ) ;
return V_297 ;
}
static int
F_71 ( struct V_1 * V_2 , int V_252 , int V_253 )
{
struct F_3 * V_9 = F_3 ( V_2 ) ;
V_9 -> V_59 . V_328 ( V_9 , V_252 , V_253 ) ;
return 0 ;
}
int
F_72 ( struct V_10 * V_6 , int V_329 )
{
struct F_3 * V_9 ;
int V_297 , V_285 ;
V_9 = F_73 ( sizeof( * V_9 ) , V_330 ) ;
if ( ! V_9 )
return - V_331 ;
for ( V_285 = 0 ; V_285 < 256 ; V_285 ++ ) {
V_9 -> V_287 . V_279 [ V_285 ] = V_285 << 8 ;
V_9 -> V_287 . V_280 [ V_285 ] = V_285 << 8 ;
V_9 -> V_287 . V_281 [ V_285 ] = V_285 << 8 ;
}
V_9 -> V_287 . V_238 = 0 ;
V_9 -> V_5 = V_329 ;
V_9 -> V_65 = V_264 ;
F_74 ( V_6 , & V_9 -> V_277 , & V_332 ) ;
F_75 ( & V_9 -> V_277 , & V_333 ) ;
F_76 ( & V_9 -> V_277 , 256 ) ;
V_297 = F_77 ( V_6 , 64 * 64 * 4 , 0x100 , V_298 ,
0 , 0x0000 , NULL , & V_9 -> V_59 . V_276 ) ;
if ( ! V_297 ) {
V_297 = F_54 ( V_9 -> V_59 . V_276 , V_298 ) ;
if ( ! V_297 ) {
V_297 = F_69 ( V_9 -> V_59 . V_276 ) ;
if ( V_297 )
F_47 ( V_9 -> V_59 . V_276 ) ;
}
if ( V_297 )
