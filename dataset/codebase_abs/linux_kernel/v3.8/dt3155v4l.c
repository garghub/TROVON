...
static T_6
F_51 ( struct V_83 * V_84 , char T_7 * V_103 , T_8 V_104 , T_9 * V_105 )
{
struct V_12 * V_13 = F_38 ( V_84 ) ;
T_6 V_106 ;
if ( F_39 ( & V_13 -> V_85 ) )
return - V_86 ;
V_106 = F_52 ( V_13 -> V_50 , V_103 , V_104 , V_105 , V_84 -> V_107 & V_108 ) ;
F_17 ( & V_13 -> V_85 ) ;
return V_106 ;
}
static unsigned int
F_53 ( struct V_83 * V_84 , struct V_109 * V_110 )
{
struct V_12 * V_13 = F_38 ( V_84 ) ;
unsigned int V_106 ;
F_19 ( & V_13 -> V_85 ) ;
V_106 = F_54 ( V_13 -> V_50 , V_84 , V_110 ) ;
F_17 ( & V_13 -> V_85 ) ;
return V_106 ;
}
static int
F_55 ( struct V_83 * V_84 , struct V_111 * V_112 )
{
struct V_12 * V_13 = F_38 ( V_84 ) ;
int V_106 ;
if ( F_39 ( & V_13 -> V_85 ) )
return - V_86 ;
V_106 = F_56 ( V_13 -> V_50 , V_112 ) ;
F_17 ( & V_13 -> V_85 ) ;
return V_106 ;
}
static int
F_57 ( struct V_83 * V_84 , void * V_113 , enum V_114 type )
{
struct V_12 * V_13 = F_38 ( V_84 ) ;
return F_58 ( V_13 -> V_50 , type ) ;
}
static int
F_59 ( struct V_83 * V_84 , void * V_113 , enum V_114 type )
{
struct V_12 * V_13 = F_38 ( V_84 ) ;
return F_60 ( V_13 -> V_50 , type ) ;
}
static int
F_61 ( struct V_83 * V_84 , void * V_113 , struct V_115 * V_116 )
{
struct V_12 * V_13 = F_38 ( V_84 ) ;
strcpy ( V_116 -> V_117 , V_101 ) ;
strcpy ( V_116 -> V_118 , V_101 L_1 ) ;
sprintf ( V_116 -> V_119 , L_2 , F_62 ( V_13 -> V_60 ) ) ;
V_116 -> V_120 =
F_63 ( V_121 , V_122 , V_123 ) ;
V_116 -> V_124 = V_125 |
V_126 ;
return 0 ;
}
static int
F_64 ( struct V_83 * V_84 , void * V_113 , struct V_127 * V_128 )
{
if ( V_128 -> V_2 >= V_129 )
return - V_130 ;
...
static int
F_65 ( struct V_83 * V_84 , void * V_113 , struct V_51 * V_128 )
{
if ( V_128 -> type != V_91 )
return - V_130 ;
...
static int
F_66 ( struct V_83 * V_84 , void * V_113 , struct V_51 * V_128 )
{
if ( V_128 -> type != V_91 )
return - V_130 ;
...
static int
F_67 ( struct V_83 * V_84 , void * V_113 , struct V_51 * V_128 )
{
return F_65 ( V_84 , V_113 , V_128 ) ;
}
static int
F_68 ( struct V_83 * V_84 , void * V_113 , struct V_143 * V_144 )
{
struct V_12 * V_13 = F_38 ( V_84 ) ;
return F_69 ( V_13 -> V_50 , V_144 ) ;
}
static int
F_70 ( struct V_83 * V_84 , void * V_113 , struct V_145 * V_144 )
{
struct V_12 * V_13 = F_38 ( V_84 ) ;
return F_71 ( V_13 -> V_50 , V_144 ) ;
}
static int
F_72 ( struct V_83 * V_84 , void * V_113 , struct V_145 * V_144 )
{
struct V_12 * V_13 = F_38 ( V_84 ) ;
return F_73 ( V_13 -> V_50 , V_144 ) ;
}
static int
F_74 ( struct V_83 * V_84 , void * V_113 , struct V_145 * V_144 )
{
struct V_12 * V_13 = F_38 ( V_84 ) ;
return F_75 ( V_13 -> V_50 , V_144 , V_84 -> V_107 & V_108 ) ;
}
static int
F_76 ( struct V_83 * V_84 , void * V_113 , T_10 * V_146 )
{
* V_146 = V_147 ;
return 0 ;
}
static int
F_77 ( struct V_83 * V_84 , void * V_113 , T_10 * V_146 )
{
* V_146 = V_147 ;
return 0 ;
}
static int
F_78 ( struct V_83 * V_84 , void * V_113 , T_10 * V_146 )
{
if ( * V_146 & V_147 )
return 0 ;
return - V_130 ;
...
static int
F_79 ( struct V_83 * V_84 , void * V_113 , struct V_148 * V_149 )
{
if ( V_149 -> V_2 )
return - V_130 ;
...
static int
F_80 ( struct V_83 * V_84 , void * V_113 , unsigned int * V_154 )
{
* V_154 = 0 ;
return 0 ;
}
static int
F_81 ( struct V_83 * V_84 , void * V_113 , unsigned int V_154 )
{
if ( V_154 )
return - V_130 ;
return 0 ;
...
static int
F_82 ( struct V_83 * V_84 , void * V_113 , struct V_155 * V_156 )
{
if ( V_156 -> type != V_91 )
return - V_130 ;
...
static int
F_83 ( struct V_83 * V_84 , void * V_113 , struct V_155 * V_156 )
{
if ( V_156 -> type != V_91 )
return - V_130 ;
V_156 -> V_157 . V_158 . V_159 = V_160 ;
...
F_6 ( V_13 -> V_18 , V_184 , V_186 ) ;
F_6 ( V_13 -> V_18 , V_187 , V_188 | V_189 | V_190 ) ;
V_169 = F_87 ( & V_60 -> V_61 , V_197 , & V_170 ,
V_88 ) ;
if ( ! V_169 )
return - V_89 ;
...
F_88 ( & V_60 -> V_61 , V_197 , V_169 , V_170 ) ;
if ( V_4 & V_47 )
return - V_8 ;
return 0 ;
}
static int
F_89 ( struct V_200 * V_61 , T_8 V_104 , int V_201 )
{
struct V_202 * V_203 ;
T_4 V_204 ;
int V_205 = V_104 >> V_206 ;
int V_207 = F_90 ( V_205 ) * sizeof( long ) ;
if ( ( V_201 & V_208 ) == 0 )
goto V_209;
if ( ! V_104 )
goto V_209;
...
if ( ! V_203 )
goto V_209;
V_203 -> V_211 = F_87 ( V_61 , V_104 , & V_204 ,
V_212 ) ;
if ( ! V_203 -> V_211 )
goto V_213;
...
return V_208 ;
V_215:
F_88 ( V_61 , V_104 , V_203 -> V_211 , V_204 ) ;
V_213:
F_45 ( V_203 ) ;
V_209:
return 0 ;
...
static void
F_91 ( struct V_200 * V_61 )
{
struct V_202 * V_203 = V_61 -> V_210 ;
if ( ! V_203 )
return;
V_61 -> V_210 = NULL ;
F_88 ( V_61 , V_203 -> V_104 << V_206 ,
V_203 -> V_211 , V_203 -> V_216 ) ;
F_45 ( V_203 -> V_214 ) ;
F_45 ( V_203 ) ;
}
static int
F_92 ( struct V_168 * V_60 , const struct V_217 * V_218 )
{
int V_219 ;
struct V_12 * V_13 ;
V_219 = F_93 ( & V_60 -> V_61 , F_94 ( 32 ) ) ;
if ( V_219 )
return - V_183 ;
V_219 = F_95 ( & V_60 -> V_61 , F_94 ( 32 ) ) ;
if ( V_219 )
return - V_183 ;
...
if ( V_219 )
goto V_227;
V_219 = F_104 ( V_13 -> V_62 , V_228 , - 1 ) ;
if ( V_219 )
goto V_227;
if ( F_89 ( & V_60 -> V_61 , V_229 ,
V_208 ) )
F_105 ( & V_60 -> V_61 , L_4 ) ;
F_105 ( & V_60 -> V_61 , L_5 , V_13 -> V_62 -> V_230 ) ;
return 0 ;
V_227:
