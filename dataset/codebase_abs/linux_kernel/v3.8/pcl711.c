...
struct V_13 * V_14 ;
V_18 = V_88 -> V_90 [ 0 ] ;
F_12 ( V_91 L_3 , V_7 -> V_42 , V_18 ) ;
if ( ! F_28 ( V_18 , V_92 , L_4 ) ) {
F_12 ( L_5 ) ;
return - V_93 ;
}
V_7 -> V_18 = V_18 ;
...
if ( V_89 )
return V_89 ;
V_11 = F_31 ( sizeof( * V_11 ) , V_98 ) ;
if ( ! V_11 )
return - V_99 ;
V_7 -> V_12 = V_11 ;
V_14 = & V_7 -> V_15 [ 0 ] ;
V_14 -> type = V_100 ;
V_14 -> V_101 = V_102 | V_103 ;
V_14 -> V_104 = V_9 -> V_105 ;
V_14 -> V_106 = 0xfff ;
V_14 -> V_107 = 1 ;
V_14 -> V_108 = V_9 -> V_109 ;
V_14 -> V_110 = F_10 ;
if ( V_1 ) {
V_7 -> V_111 = V_14 ;
V_14 -> V_101 |= V_112 ;
