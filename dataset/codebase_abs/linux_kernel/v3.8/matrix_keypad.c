...
V_2 = F_55 ( V_39 , sizeof( * V_2 ) , V_58 ) ;
if ( ! V_2 ) {
F_48 ( V_39 , L_9 ) ;
return F_54 ( - V_59 ) ;
}
V_2 -> V_16 = F_56 ( V_54 , L_10 ) ;
V_2 -> V_9 = F_56 ( V_54 , L_11 ) ;
if ( ! V_2 -> V_16 || ! V_2 -> V_9 ) {
F_48 ( V_39 , L_12 ) ;
return F_54 ( - V_60 ) ;
}
...
V_13 = F_64 ( sizeof( struct V_12 ) , V_58 ) ;
V_19 = F_65 () ;
if ( ! V_13 || ! V_19 ) {
V_46 = - V_59 ;
goto V_64;
...
V_19 -> V_65 = V_45 -> V_65 ;
V_19 -> V_33 . V_66 = V_67 ;
V_19 -> V_39 . V_68 = & V_45 -> V_39 ;
V_19 -> V_69 = F_29 ;
V_19 -> V_70 = F_32 ;
V_46 = F_69 ( V_2 -> V_63 , NULL ,
V_2 -> V_16 ,
V_2 -> V_9 ,
NULL , V_19 ) ;
if ( V_46 ) {
