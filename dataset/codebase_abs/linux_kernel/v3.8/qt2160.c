...
static int F_21 ( struct V_1 * V_2 , T_1 V_35 )
{
int V_18 ;
V_18 = F_3 ( V_2 , V_35 ) ;
if ( V_18 ) {
...
static int F_22 ( struct V_1 * V_2 , T_1 V_35 , T_1 V_10 )
{
int V_18 ;
V_18 = F_23 ( V_2 , V_35 , V_10 ) ;
if ( V_18 < 0 )
F_4 ( & V_2 -> V_9 ,
L_10 , V_18 ) ;
return V_18 ;
...
if ( ! F_24 ( V_2 ) )
return - V_45 ;
V_12 = F_28 ( sizeof( struct V_11 ) , V_46 ) ;
V_14 = F_29 () ;
if ( ! V_12 || ! V_14 ) {
F_4 ( & V_2 -> V_9 , L_16 ) ;
error = - V_47 ;
...
F_33 ( V_56 , V_14 -> V_57 ) ;
F_34 ( V_58 , V_14 -> V_57 ) ;
for ( V_19 = 0 ; V_19 < F_32 ( V_55 ) ; V_19 ++ ) {
V_12 -> V_24 [ V_19 ] = V_55 [ V_19 ] ;
F_33 ( V_55 [ V_19 ] , V_14 -> V_59 ) ;
}
F_34 ( V_60 , V_14 -> V_59 ) ;
