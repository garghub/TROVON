...
return 0 ;
case V_88 :
V_97 = F_26 ( V_131 , V_35 -> V_97 [ 0 ] , & V_2 -> V_99 ,
& V_132 ) ;
break;
case V_83 :
V_97 = F_26 ( V_133 , V_35 -> V_97 [ 0 ] , & V_2 -> V_99 ,
& V_134 ) ;
break;
case V_86 :
...
if ( V_5 )
goto V_12;
V_97 = F_26 ( V_135 , V_35 -> V_97 [ 0 ] , & V_2 -> V_99 ,
& V_136 ) ;
break;
default:
V_97 = NULL ;
...
T_1 V_24 ;
F_8 ( & V_2 -> V_18 -> V_21 , L_3 , V_22 ) ;
V_5 = F_12 ( V_2 , V_137 , & V_24 ) ;
if ( V_5 )
goto V_12;
V_24 |= 0x09 ;
V_5 = F_11 ( V_2 , V_137 , V_24 ) ;
if ( V_5 )
goto V_12;
V_5 = F_9 ( V_2 , V_138 , L_25 , 4 ) ;
if ( V_5 )
goto V_12;
V_5 = F_9 ( V_2 , V_139 , L_26 , 4 ) ;
if ( V_5 )
goto V_12;
return V_5 ;
V_12:
...
static int F_36 ( struct V_1 * V_2 , int V_140 )
{
int V_5 ;
T_1 V_141 , V_142 , V_143 [ 2 ] ;
F_8 ( & V_2 -> V_18 -> V_21 , L_27 , V_22 , V_140 ) ;
V_5 = F_12 ( V_2 , V_144 , & V_142 ) ;
if ( V_5 )
goto V_12;
V_5 = F_12 ( V_2 , V_103 , & V_141 ) ;
if ( V_5 )
goto V_12;
...
V_142 , V_141 ) ;
V_5 = F_11 ( V_2 , V_144 , V_142 ) ;
if ( V_5 )
goto V_12;
V_5 = F_11 ( V_2 , V_103 , V_141 ) ;
if ( V_5 )
goto V_12;
V_5 = F_9 ( V_2 , V_145 , V_143 , 2 ) ;
if ( V_5 )
goto V_12;
if ( V_140 )
...
static int F_39 ( struct V_1 * V_2 , int V_140 )
{
int V_5 ;
T_1 V_24 ;
F_8 ( & V_2 -> V_18 -> V_21 , L_27 , V_22 , V_140 ) ;
...
if ( ! V_40 -> V_152 ) {
for ( V_148 = 0 ; V_148 < F_42 ( V_151 ) ; V_148 ++ ) {
V_5 = F_11 ( V_2 , V_151 [ V_148 ] . V_23 ,
V_151 [ V_148 ] . V_24 ) ;
if ( V_5 )
goto V_12;
}
...
V_149 = V_8 [ 0 ] << 24 | V_8 [ 1 ] << 16 |
V_8 [ 2 ] << 8 | V_8 [ 3 ] ;
}
F_43 ( V_2 -> V_154 , V_149 , 0 ) ;
V_5 = F_11 ( V_2 , V_155 , 1 ) ;
if ( V_5 )
goto V_12;
V_5 = F_11 ( V_2 , V_155 , 1 ) ;
if ( V_5 )
...
goto V_12;
V_25 = V_8 [ 0 ] ;
V_5 = F_10 ( V_2 , V_178 , V_8 , V_25 ) ;
V_5 = F_11 ( V_2 , V_166 , 0x03 ) ;
V_5 = F_11 ( V_2 , V_165 , 0x80 ) ;
V_5 = F_11 ( V_2 , V_164 , 0x80 ) ;
exit:
return V_5 ;
V_12:
F_8 ( & V_2 -> V_18 -> V_21 , L_1 , V_22 , V_5 ) ;
