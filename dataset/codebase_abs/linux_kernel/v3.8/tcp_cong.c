...
if ( V_55 && V_46 -> V_56 < V_46 -> V_50 )
return;
if ( V_57 > 0 && V_46 -> V_48 > V_57 )
V_53 = V_57 >> 1 ;
else
V_53 = V_48 ;
if ( V_55 > 1 && V_46 -> V_56 >= 2 * V_46 -> V_50 )
V_53 <<= 1 ;
V_46 -> V_56 = 0 ;
V_46 -> V_58 += V_53 ;
while ( V_46 -> V_58 >= V_48 ) {
V_46 -> V_58 -= V_48 ;
V_54 ++ ;
}
V_46 -> V_48 = F_46 ( V_48 + V_54 , V_46 -> V_59 ) ;
}
void F_47 ( struct V_45 * V_46 , T_3 V_60 )
{
if ( V_46 -> V_58 >= V_60 ) {
if ( V_46 -> V_48 < V_46 -> V_59 )
V_46 -> V_48 ++ ;
V_46 -> V_58 = 0 ;
} else {
V_46 -> V_58 ++ ;
...
void F_48 ( struct V_13 * V_14 , T_3 V_61 , T_3 V_44 )
{
struct V_45 * V_46 = F_40 ( V_14 ) ;
if ( ! F_39 ( V_14 , V_44 ) )
return;
if ( V_46 -> V_48 <= V_46 -> V_62 )
F_43 ( V_46 ) ;
else if ( V_55 ) {
if ( V_46 -> V_56 >= V_46 -> V_48 * V_46 -> V_50 ) {
V_46 -> V_56 -= V_46 -> V_48 * V_46 -> V_50 ;
if ( V_46 -> V_48 < V_46 -> V_59 )
V_46 -> V_48 ++ ;
}
} else {
