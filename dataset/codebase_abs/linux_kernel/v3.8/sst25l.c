...
if ( ! V_61 )
return - V_69 ;
V_2 = F_23 ( sizeof( struct V_1 ) , V_70 ) ;
if ( ! V_2 )
return - V_71 ;
V_2 -> V_14 = V_14 ;
F_24 ( & V_2 -> V_40 ) ;
...
V_68 = V_14 -> V_43 . V_72 ;
if ( V_68 && V_68 -> V_73 )
V_2 -> V_33 . V_73 = V_68 -> V_73 ;
else
V_2 -> V_33 . V_73 = F_26 ( & V_14 -> V_43 ) ;
V_2 -> V_33 . type = V_74 ;
V_2 -> V_33 . V_75 = V_76 ;
...
static int F_31 ( struct V_62 * V_14 )
{
struct V_1 * V_2 = F_32 ( & V_14 -> V_43 ) ;
int V_50 ;
V_50 = F_33 ( & V_2 -> V_33 ) ;
if ( V_50 == 0 )
F_30 ( V_2 ) ;
