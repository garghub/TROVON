...
V_4 = F_62 ( V_10 , sizeof( * V_4 ) , V_126 ) ;
if ( ! V_4 )
return - V_127 ;
V_4 -> V_11 |= ( unsigned long ) V_102 . V_16 ;
if ( V_100 == V_128 &&
( V_2 -> V_129 == 0xa1 || V_2 -> V_129 == 0xa2 ) )
V_4 -> V_11 |= V_130 ;
if ( V_100 == V_131 && V_2 -> V_129 >= 0x40 )
V_4 -> V_11 &= ~ V_132 ;
if ( F_43 ( V_2 ) )
V_4 -> V_11 &= ~ V_133 ;
if ( ( V_4 -> V_11 & V_130 ) || F_63 ( V_2 ) )
F_64 ( V_2 , 1 ) ;
...
V_95 = F_67 ( F_68 ( V_4 -> V_134 ) , F_69 ( V_4 -> V_18 ) ) ;
V_14 = F_70 ( & V_2 -> V_10 , V_104 , V_95 ) ;
if ( ! V_14 )
return - V_127 ;
V_14 -> V_16 = V_4 ;
if ( ! ( V_4 -> V_134 & V_143 ) || V_144 )
V_14 -> V_11 |= V_145 ;
else
F_71 ( V_146 L_60 ) ;
if ( V_102 . V_11 & V_147 )
...
F_73 ( V_29 , V_105 ,
0x100 + V_29 -> V_148 * 0x80 , L_62 ) ;
if ( V_29 -> V_11 & V_147 )
V_29 -> V_149 = V_4 -> V_150 ;
if ( ! ( V_4 -> V_18 & ( 1 << V_94 ) ) )
V_29 -> V_74 = & V_151 ;
}
F_39 ( V_14 ) ;
F_52 ( V_14 ) ;
V_31 = F_33 ( V_2 , V_4 -> V_134 & V_152 ) ;
if ( V_31 )
return V_31 ;
V_31 = F_4 ( V_14 ) ;
if ( V_31 )
...
F_37 ( V_14 ) ;
F_74 ( V_2 ) ;
return F_75 ( V_14 , V_2 -> V_153 , V_154 , V_155 ,
& V_156 ) ;
}
