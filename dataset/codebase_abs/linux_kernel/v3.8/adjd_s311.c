...
if ( V_6 < 0 )
goto V_31;
V_4 -> V_32 [ V_30 ++ ] = V_6 & V_14 ;
V_21 += 2 ;
}
if ( V_2 -> V_33 )
* ( T_7 * ) ( ( T_1 * ) V_4 -> V_32 + F_18 ( V_21 , sizeof( T_7 ) ) )
= V_28 ;
F_19 ( V_2 , ( T_1 * ) V_4 -> V_32 ) ;
V_31:
F_20 ( V_2 -> V_34 ) ;
return V_35 ;
}
...
const unsigned long * V_42 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
F_25 ( V_4 -> V_32 ) ;
V_4 -> V_32 = F_26 ( V_2 -> V_43 , V_44 ) ;
if ( V_4 -> V_32 == NULL )
return - V_45 ;
return 0 ;
}
static int F_27 ( struct V_46 * V_7 ,
...
static int F_36 ( struct V_46 * V_7 )
{
