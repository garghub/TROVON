...
struct V_30 V_31 ;
int V_32 ;
for ( V_32 = 0 ; V_32 < F_42 ( V_28 ) ; V_32 ++ ) {
V_29 = F_20 ( NULL , NULL , V_28 [ V_32 ] ) ;
F_43 ( V_29 , 0 , & V_31 ) ;
...
{
struct V_34 * V_34 = F_49 ( NULL , 0 , V_35 |
V_36 ,
0 , 256 , L_21 ) ;
F_50 ( V_34 == NULL ) ;
F_51 ( V_34 ) ;
...
{
unsigned long V_37 = F_53 () ;
return F_54 ( V_37 , L_22 ) ;
}
static int T_1 F_55 ( void )
{
unsigned long V_37 = F_53 () ;
return F_54 ( V_37 , L_23 ) ;
}
static int T_1 F_56 ( void )
{
unsigned long V_37 = F_53 () ;
return F_54 ( V_37 , L_24 ) ;
}
