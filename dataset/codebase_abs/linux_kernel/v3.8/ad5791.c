...
V_27 -> V_32 = true ;
V_27 -> V_2 = V_2 ;
if ( ! F_25 ( V_27 -> V_74 ) && ! F_25 ( V_27 -> V_71 ) ) {
V_27 -> V_56 = ( V_67 + V_68 ) / 1000 ;
V_27 -> V_60 = V_68 / 1000 ;
} else if ( V_64 ) {
V_27 -> V_56 = V_64 -> V_77 + V_64 -> V_60 ;
V_27 -> V_60 = V_64 -> V_60 ;
} else {
F_28 ( & V_2 -> V_65 , L_4 ) ;
}
...
if ( V_10 )
goto V_76;
V_27 -> V_80 = & V_81 [ F_29 ( V_2 )
-> V_82 ] ;
V_27 -> V_33 = F_30 ( V_27 -> V_80 -> V_83 ( V_27 -> V_56 ) )
| ( ( V_64 && V_64 -> V_84 ) ? 0 : V_85 ) |
V_86 ;
...
goto V_76;
F_31 ( V_2 , V_23 ) ;
V_23 -> V_65 . V_87 = & V_2 -> V_65 ;
V_23 -> V_88 = & V_89 ;
V_23 -> V_90 = V_91 ;
V_23 -> V_92
= & V_93 [ F_29 ( V_2 ) -> V_82 ] ;
V_23 -> V_94 = 1 ;
V_23 -> V_95 = F_29 ( V_27 -> V_2 ) -> V_95 ;
V_10 = F_32 ( V_23 ) ;
if ( V_10 )
goto V_76;
return 0 ;
