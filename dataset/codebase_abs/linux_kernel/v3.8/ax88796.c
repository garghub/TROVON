...
strcpy ( V_85 -> V_89 , V_90 ) ;
strcpy ( V_85 -> V_91 , V_92 ) ;
strcpy ( V_85 -> V_93 , V_87 -> V_67 ) ;
}
static int F_42 ( struct V_2 * V_3 , struct V_94 * V_82 )
{
struct V_1 * V_53 = F_1 ( V_3 ) ;
struct V_54 * V_55 = V_53 -> V_55 ;
if ( ! V_55 )
return - V_10 ;
return F_43 ( V_55 , V_82 ) ;
}
...
static void F_49 ( struct V_107 * V_108 , int V_109 )
{
struct V_1 * V_53 = F_50 ( V_108 , struct V_1 , V_110 ) ;
if ( V_109 )
V_53 -> V_111 |= V_112 ;
else
V_53 -> V_111 &= ~ V_112 ;
...
static void F_51 ( struct V_107 * V_108 , int V_114 )
{
struct V_1 * V_53 = F_50 ( V_108 , struct V_1 , V_110 ) ;
if ( V_114 )
V_53 -> V_111 &= ~ V_115 ;
...
static void F_52 ( struct V_107 * V_108 , int V_116 )
{
struct V_1 * V_53 = F_50 ( V_108 , struct V_1 , V_110 ) ;
if ( V_116 )
V_53 -> V_111 |= V_117 ;
...
V_53 -> V_61 -> V_68 = F_56 ( sizeof( int ) * V_127 , V_128 ) ;
if ( ! V_53 -> V_61 -> V_68 ) {
V_119 = - V_123 ;
goto V_129;
}
...
static void F_60 ( struct V_2 * V_3 , struct V_4 * V_5 )
{
void T_1 * V_6 = V_5 -> V_7 ;
struct V_1 * V_53 = F_1 ( V_3 ) ;
...
F_33 ( V_3 -> V_68 , V_3 ) ;
F_70 ( V_5 -> V_7 ) ;
V_7 = F_71 ( V_87 , V_170 , 0 ) ;
F_72 ( V_7 -> V_171 , F_73 ( V_7 ) ) ;
if ( V_53 -> V_172 ) {
F_70 ( V_53 -> V_172 ) ;
V_7 = F_71 ( V_87 , V_170 , 1 ) ;
F_72 ( V_7 -> V_171 , F_73 ( V_7 ) ) ;
}
F_74 ( V_3 ) ;
return 0 ;
...
if ( ! F_80 ( V_7 -> V_171 , V_174 , V_87 -> V_67 ) ) {
F_79 ( & V_87 -> V_3 , L_19 ) ;
V_60 = - V_180 ;
goto V_181;
}
V_5 -> V_7 = F_81 ( V_7 -> V_171 , V_174 ) ;
V_3 -> V_20 = ( unsigned long ) V_5 -> V_7 ;
if ( V_5 -> V_7 == NULL ) {
F_79 ( & V_87 -> V_3 , L_20 , V_7 ) ;
V_60 = - V_180 ;
goto V_185;
}
V_173 = F_71 ( V_87 , V_170 , 1 ) ;
if ( ! V_173 ) {
if ( ! V_53 -> V_71 -> V_183 ) {
...
V_175 = F_73 ( V_173 ) ;
if ( ! F_80 ( V_173 -> V_171 , V_175 , V_87 -> V_67 ) ) {
F_79 ( & V_87 -> V_3 , L_19 ) ;
V_60 = - V_180 ;
goto V_186;
}
V_53 -> V_172 = F_81 ( V_173 -> V_171 , V_175 ) ;
if ( ! V_53 -> V_172 ) {
F_79 ( & V_87 -> V_3 , L_21 ) ;
V_60 = - V_180 ;
goto V_187;
...
F_70 ( V_53 -> V_172 ) ;
V_187:
F_72 ( V_173 -> V_171 , V_175 ) ;
V_186:
F_70 ( V_5 -> V_7 ) ;
V_185:
F_72 ( V_7 -> V_171 , V_174 ) ;
V_181:
F_74 ( V_3 ) ;
return V_60 ;
}
static int F_82 ( struct V_86 * V_3 , T_4 V_188 )
{
struct V_2 * V_189 = F_68 ( V_3 ) ;
...
{
struct V_2 * V_189 = F_68 ( V_87 ) ;
struct V_1 * V_53 = F_1 ( V_189 ) ;
F_60 ( V_189 , F_2 ( V_189 ) ) ;
