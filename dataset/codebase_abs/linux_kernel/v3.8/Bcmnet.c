...
strcpy ( V_53 -> V_60 , V_61 ) ;
strcpy ( V_53 -> V_62 , V_63 ) ;
snprintf ( V_53 -> V_64 , sizeof( V_53 -> V_64 ) , L_6 ,
V_4 -> V_65 ,
V_4 -> V_66 ) ;
F_30 ( V_58 , V_53 -> V_67 , sizeof( V_53 -> V_67 ) ) ;
}
...
static void F_33 ( struct V_1 * V_2 , T_3 V_69 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
V_4 -> V_68 = V_69 ;
}
