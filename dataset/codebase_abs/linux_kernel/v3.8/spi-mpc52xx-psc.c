...
{
struct V_90 * V_91 = V_42 -> V_92 ;
struct V_11 * V_12 ;
struct V_93 * V_13 ;
int V_74 ;
V_13 = F_35 ( V_42 , sizeof *V_12 ) ;
if ( V_13 == NULL )
return - V_69 ;
F_36 ( V_42 , V_13 ) ;
V_12 = F_3 ( V_13 ) ;
V_13 -> V_94 = V_20 | V_19 | V_24 | V_21 ;
V_12 -> V_81 = V_81 ;
if ( V_91 == NULL ) {
F_37 ( V_42 , L_3
L_4 ) ;
...
V_13 -> V_98 = F_26 ;
V_13 -> V_99 = F_29 ;
V_13 -> V_42 . V_100 = V_42 -> V_100 ;
V_12 -> V_15 = F_38 ( V_87 , V_88 ) ;
if ( ! V_12 -> V_15 ) {
F_39 ( V_42 , L_5 ) ;
V_74 = - V_101 ;
goto V_102;
...
V_74 = F_40 ( V_12 -> V_81 , F_33 , 0 , L_6 ,
V_12 ) ;
if ( V_74 )
goto V_102;
...
T_6 V_110 , V_111 ;
T_5 V_112 = - 1 ;
V_109 = F_52 ( V_108 -> V_42 . V_100 , 0 , & V_111 , NULL ) ;
if ( ! V_109 ) {
F_39 ( & V_108 -> V_42 , L_8 ) ;
return - V_37 ;
}
V_110 = F_53 ( V_108 -> V_42 . V_100 , V_109 ) ;
if ( V_108 -> V_42 . V_92 == NULL ) {
const T_2 * V_113 ;
V_113 = F_54 ( V_108 -> V_42 . V_100 , L_9 , NULL ) ;
if ( ! V_113 || * V_113 > 5 ) {
F_39 ( & V_108 -> V_42 , L_10 ) ;
return - V_37 ;
}
V_112 = * V_113 + 1 ;
}
return F_34 ( & V_108 -> V_42 , ( T_2 ) V_110 , ( T_2 ) V_111 ,
F_55 ( V_108 -> V_42 . V_100 , 0 ) , V_112 ) ;
}
static int F_56 ( struct V_107 * V_108 )
{
struct V_93 * V_13 = F_57 ( F_58 ( & V_108 -> V_42 ) ) ;
