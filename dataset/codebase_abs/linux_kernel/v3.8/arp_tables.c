...
{
int V_10 ;
if ( ! F_95 ( F_96 ( V_217 ) -> V_219 , V_220 ) )
return - V_221 ;
switch ( V_218 ) {
case V_222 :
...
if ( F_99 ( V_122 , & V_224 -> V_122 ) != 0 ||
F_99 ( V_128 , & V_224 -> V_128 ) != 0 )
return - V_167 ;
return 0 ;
}
...
if ( V_10 != 0 )
goto V_233;
V_232 = F_107 ( V_175 , V_84 , & V_231 , V_115 ) ;
if ( F_37 ( V_232 ) ) {
V_10 = F_38 ( V_232 ) ;
goto V_233;
}
