...
int F_33 ( struct V_1 * V_1 , struct V_30 * V_10 )
{
struct V_11 * V_5 ;
F_7 ( & V_1 -> V_22 ) ;
F_34 (client, &host1x->clients, list) {
if ( V_5 -> V_31 && V_5 -> V_31 -> V_32 ) {
int V_16 = V_5 -> V_31 -> V_32 ( V_5 , V_10 ) ;
if ( V_16 < 0 ) {
F_21 ( V_1 -> V_21 ,
L_6 ,
F_35 ( V_5 -> V_21 ) , V_16 ) ;
...
if ( V_5 -> V_31 && V_5 -> V_31 -> V_33 ) {
int V_16 = V_5 -> V_31 -> V_33 ( V_5 ) ;
if ( V_16 < 0 ) {
F_21 ( V_1 -> V_21 ,
L_7 ,
F_35 ( V_5 -> V_21 ) , V_16 ) ;
