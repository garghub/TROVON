...
V_185 = F_91 () ;
F_92 ( V_192 ) ;
V_28 = F_93 ( V_132 , (struct V_193 V_194 * ) V_182 , V_183 , & V_180 ) ;
F_92 ( V_185 ) ;
}
if ( V_28 >= 0 ) {
V_161 . V_195 += V_28 ;
...
if ( ! F_37 ( exp ) )
V_209 = 0 ;
V_185 = F_91 () ; F_92 ( V_192 ) ;
V_28 = F_105 ( V_132 , (struct V_193 V_194 * ) V_182 , V_183 , & V_180 ) ;
F_92 ( V_185 ) ;
if ( V_28 < 0 )
goto V_31;
* V_207 = V_28 ;
...
V_28 = F_107 ( V_132 , V_180 , V_180 + * V_207 , 0 ) ;
}
V_31:
F_22 ( L_5 , V_28 ) ;
if ( V_28 >= 0 )
...
T_1 F_108 ( struct V_1 * V_2 , struct V_22 * V_23 ,
T_9 V_180 , struct V_181 * V_182 , int V_183 , unsigned long * V_184 )
{
struct V_132 * V_132 ;
struct V_36 * V_36 ;
...
V_11 = F_89 ( V_2 , V_23 , V_132 , V_180 , V_182 , V_183 , V_184 ) ;
if ( V_145 ) {
...
V_11 = F_108 ( V_2 , V_23 , V_180 , V_182 , V_183 , V_184 ) ;
V_12:
return V_11 ;
}
T_1
F_110 ( struct V_1 * V_2 , struct V_22 * V_23 , struct V_132 * V_132 ,
T_9 V_180 , struct V_181 * V_182 , int V_183 , unsigned long * V_207 ,
int * V_208 )
{
T_1 V_11 = 0 ;
if ( V_132 ) {
...
if ( V_11 )
goto V_12;
V_11 = F_103 ( V_2 , V_23 , V_132 , V_180 , V_182 , V_183 , V_207 ,
V_208 ) ;
} else {
...
goto V_12;
if ( V_207 )
V_11 = F_103 ( V_2 , V_23 , V_132 , V_180 , V_182 , V_183 ,
V_207 , V_208 ) ;
F_78 ( V_132 ) ;
}
V_12:
...
goto V_12;
if ( F_37 ( V_23 -> V_30 ) ) {
int V_122 = F_107 ( V_132 , V_180 , V_215 , 0 ) ;
if ( V_122 != - V_100 )
V_11 = F_28 ( V_122 ) ;
else
V_11 = V_218 ;
...
static T_1
F_112 ( struct V_1 * V_2 , struct V_22 * V_219 ,
struct V_44 * V_45 )
{
V_45 -> V_52 &= ~ V_59 ;
if ( F_113 () != 0 )
...
char * V_220 , int V_221 , struct V_44 * V_45 ,
int type , T_7 V_222 , struct V_22 * V_219 )
{
struct V_3 * V_3 , * V_223 = NULL ;
struct V_36 * V_224 ;
T_1 V_11 ;
T_1 V_122 ;
int V_28 ;
...
goto V_31;
F_117 ( V_23 , V_230 ) ;
V_223 = F_27 ( V_220 , V_3 , V_221 ) ;
V_28 = F_7 ( V_223 ) ;
if ( F_6 ( V_223 ) )
goto V_31;
V_11 = F_32 ( V_219 , V_23 -> V_30 , V_223 , V_23 ) ;
if ( V_11 )
goto V_12;
} else {
V_223 = F_3 ( V_219 -> V_29 ) ;
if ( ! V_23 -> V_231 ) {
F_118 ( V_232
L_6 ,
V_3 -> V_233 -> V_234 . V_24 ,
V_3 -> V_234 . V_24 ) ;
V_11 = V_235 ;
goto V_12;
}
...
if ( V_223 -> V_21 ) {
F_22 ( L_7 ,
V_3 -> V_234 . V_24 , V_223 -> V_234 . V_24 ) ;
goto V_12;
}
if ( ! ( V_45 -> V_52 & V_59 ) )
V_45 -> V_67 = 0 ;
...
switch ( type ) {
case V_58 :
V_28 = F_120 ( V_224 , V_223 , V_45 -> V_67 , true ) ;
if ( ! V_28 )
F_114 ( V_45 ) ;
break;
case V_33 :
V_28 = F_121 ( V_224 , V_223 , V_45 -> V_67 ) ;
break;
case V_237 :
case V_238 :
case V_239 :
case V_240 :
V_28 = F_122 ( V_224 , V_223 , V_45 -> V_67 , V_222 ) ;
break;
}
if ( V_28 < 0 )
goto V_31;
V_11 = F_112 ( V_2 , V_219 , V_45 ) ;
...
static inline int F_124 ( int V_241 )
{
return V_241 == V_242
|| V_241 == V_243 ;
}
...
char * V_220 , int V_221 , struct V_44 * V_45 ,
struct V_22 * V_219 , int V_241 , T_6 * V_244 ,
bool * V_245 , bool * V_246 )
{
struct V_3 * V_3 , * V_223 = NULL ;
struct V_36 * V_224 ;
T_1 V_11 ;
int V_28 ;
T_11 V_247 = 0 , V_248 = 0 ;
V_11 = V_127 ;
if ( ! V_221 )
goto V_12;
V_11 = V_225 ;
...
goto V_12;
if ( F_124 ( V_241 ) ) {
V_247 = V_244 [ 0 ] & 0x7fffffff ;
V_248 = V_244 [ 1 ] & 0x7fffffff ;
}
if ( V_223 -> V_21 ) {
V_11 = 0 ;
switch ( V_241 ) {
case V_249 :
if ( ! F_34 ( V_223 -> V_21 -> V_37 ) )
goto V_12;
else if ( V_245 ) {
* V_245 = ( V_45 -> V_52 & V_55 ) && ! V_45 -> V_64 ;
}
else {
V_45 -> V_52 &= V_55 ;
goto V_250;
...
break;
case V_242 :
if ( V_223 -> V_21 -> V_251 . V_61 == V_247
&& V_223 -> V_21 -> V_252 . V_61 == V_248
&& V_223 -> V_21 -> V_65 == 0 ) {
if ( V_246 )
* V_246 = 1 ;
break;
...
V_45 -> V_52 = V_54 | V_53
| V_254 | V_255 ;
V_45 -> V_60 . V_61 = V_247 ;
V_45 -> V_62 . V_61 = V_248 ;
V_45 -> V_60 . V_256 = 0 ;
V_45 -> V_62 . V_256 = 0 ;
}
V_250:
...
T_1
F_127 ( struct V_1 * V_2 , struct V_22 * V_23 , char * V_85 , int * V_257 )
{
struct V_36 * V_36 ;
T_10 V_185 ;
T_1 V_11 ;
int V_28 ;
struct V_8 V_8 ;
V_11 = F_30 ( V_2 , V_23 , V_258 , V_118 ) ;
if ( V_11 )
goto V_12;
V_8 . V_9 = V_23 -> V_30 -> V_10 . V_9 ;
V_8 . V_3 = V_23 -> V_29 ;
...
F_128 ( & V_8 ) ;
V_185 = F_91 () ; F_92 ( V_192 ) ;
V_28 = V_36 -> V_228 -> V_259 ( V_8 . V_3 , ( char V_194 * ) V_85 , * V_257 ) ;
F_92 ( V_185 ) ;
if ( V_28 < 0 )
goto V_31;
* V_257 = V_28 ;
...
F_26 ( V_23 ) ;
V_3 = V_23 -> V_29 ;
V_261 = F_27 ( V_220 , V_3 , V_221 ) ;
V_28 = F_7 ( V_261 ) ;
if ( F_6 ( V_261 ) )
goto V_31;
if ( F_130 ( V_8 [ V_260 ] != 0 ) ) {
char * V_263 = F_54 ( V_260 + 1 , V_88 ) ;
if ( V_263 == NULL )
V_28 = - V_89 ;
else {
strncpy ( V_263 , V_8 , V_260 ) ;
V_263 [ V_260 ] = 0 ;
V_28 = F_131 ( V_3 -> V_21 , V_261 , V_263 ) ;
F_55 ( V_263 ) ;
}
} else
V_28 = F_131 ( V_3 -> V_21 , V_261 , V_8 ) ;
V_11 = F_28 ( V_28 ) ;
if ( ! V_11 )
V_11 = F_28 ( F_36 ( V_23 ) ) ;
F_51 ( V_23 ) ;
F_126 ( V_23 ) ;
V_262 = F_32 ( V_219 , V_23 -> V_30 , V_261 , V_23 ) ;
F_15 ( V_261 ) ;
if ( V_11 == 0 ) V_11 = V_262 ;
V_12:
return V_11 ;
V_31:
V_11 = F_28 ( V_28 ) ;
...
T_1
F_132 ( struct V_1 * V_2 , struct V_22 * V_264 ,
char * V_24 , int V_25 , struct V_22 * V_265 )
{
struct V_3 * V_266 , * V_261 , * V_267 ;
struct V_36 * V_224 ;
T_1 V_11 ;
int V_28 ;
V_11 = F_30 ( V_2 , V_264 , V_33 , V_226 ) ;
if ( V_11 )
goto V_12;
V_11 = F_30 ( V_2 , V_265 , 0 , V_118 ) ;
if ( V_11 )
goto V_12;
V_11 = V_268 ;
if ( F_49 ( V_265 -> V_29 -> V_21 -> V_37 ) )
goto V_12;
V_11 = V_127 ;
if ( ! V_25 )
goto V_12;
...
if ( ! V_267 -> V_21 )
goto V_269;
V_28 = F_33 ( V_267 -> V_21 ) ;
if ( V_28 ) {
V_11 = F_28 ( V_28 ) ;
goto V_269;
}
V_28 = F_133 ( V_267 , V_224 , V_261 ) ;
if ( ! V_28 ) {
V_11 = F_28 ( F_36 ( V_264 ) ) ;
if ( ! V_11 )
V_11 = F_28 ( F_36 ( V_265 ) ) ;
} else {
if ( V_28 == - V_270 && V_2 -> V_211 == 2 )
V_11 = V_126 ;
else
V_11 = F_28 ( V_28 ) ;
}
...
T_1
F_134 ( struct V_1 * V_2 , struct V_22 * V_264 , char * V_220 , int V_221 ,
struct V_22 * V_265 , char * V_272 , int V_273 )
{
struct V_3 * V_274 , * V_275 , * V_276 , * V_277 , * V_278 ;
struct V_36 * V_279 , * V_280 ;
T_1 V_11 ;
int V_28 ;
V_11 = F_30 ( V_2 , V_264 , V_33 , V_281 ) ;
if ( V_11 )
goto V_12;
V_11 = F_30 ( V_2 , V_265 , V_33 , V_226 ) ;
if ( V_11 )
goto V_12;
V_274 = V_264 -> V_29 ;
V_279 = V_274 -> V_21 ;
V_275 = V_265 -> V_29 ;
V_280 = V_275 -> V_21 ;
V_11 = ( V_2 -> V_211 == 2 ) ? V_126 : V_282 ;
if ( V_264 -> V_30 != V_265 -> V_30 )
goto V_12;
V_11 = V_127 ;
if ( ! V_221 || F_25 ( V_220 , V_221 ) || ! V_273 || F_25 ( V_272 , V_273 ) )
goto V_12;
V_28 = F_116 ( V_264 ) ;
if ( V_28 ) {
V_11 = F_28 ( V_28 ) ;
...
V_278 = F_135 ( V_275 , V_274 ) ;
V_264 -> V_231 = V_265 -> V_231 = 1 ;
F_136 ( V_264 ) ;
F_136 ( V_265 ) ;
V_276 = F_27 ( V_220 , V_274 , V_221 ) ;
V_28 = F_7 ( V_276 ) ;
if ( F_6 ( V_276 ) )
goto V_31;
V_28 = - V_13 ;
...
goto V_285;
V_28 = - V_270 ;
if ( V_264 -> V_30 -> V_10 . V_9 != V_265 -> V_30 -> V_10 . V_9 )
goto V_285;
...
V_28 = F_137 ( V_279 , V_276 , V_280 , V_277 ) ;
if ( ! V_28 ) {
V_28 = F_36 ( V_265 ) ;
if ( ! V_28 )
V_28 = F_36 ( V_264 ) ;
...
int V_28 ;
V_11 = V_126 ;
if ( ! V_221 || F_25 ( V_220 , V_221 ) )
goto V_12;
V_11 = F_30 ( V_2 , V_23 , V_33 , V_281 ) ;
if ( V_11 )
goto V_12;
V_28 = F_116 ( V_23 ) ;
if ( V_28 )
...
goto V_288;
if ( type != V_33 )
V_28 = F_141 ( V_224 , V_286 ) ;
else
V_28 = F_142 ( V_224 , V_286 ) ;
if ( ! V_28 )
V_28 = F_36 ( V_23 ) ;
V_288:
F_15 ( V_286 ) ;
...
static T_1 F_145 ( struct V_132 * V_132 , T_13 V_300 ,
...
int V_176 ;
T_9 V_180 ;
V_85 . V_295 = ( void * ) F_146 ( V_88 ) ;
if ( ! V_85 . V_295 )
return F_28 ( - V_89 ) ;
V_180 = * V_303 ;
while ( 1 ) {
struct V_36 * V_304 = V_132 -> V_198 . V_3 -> V_21 ;
unsigned int V_297 ;
V_302 -> V_11 = V_305 ;
V_85 . V_296 = 0 ;
V_85 . V_299 = 0 ;
...
if ( V_302 -> V_11 != V_124 )
break;
V_297 = F_144 ( sizeof( * V_294 ) + V_294 -> V_290 ,
sizeof( T_12 ) ) ;
V_176 -= V_297 ;
...
if ( V_176 > 0 )
break;
V_180 = F_149 ( V_132 , 0 , V_306 ) ;
}
F_150 ( ( unsigned long ) ( V_85 . V_295 ) ) ;
if ( V_28 )
return F_28 ( V_28 ) ;
* V_303 = V_180 ;
return V_302 -> V_11 ;
...
T_1
F_151 ( struct V_1 * V_2 , struct V_22 * V_23 , T_9 * V_303 ,
...
if ( V_11 )
goto V_12;
V_180 = F_149 ( V_132 , V_180 , V_307 ) ;
if ( V_180 < 0 ) {
V_11 = F_28 ( ( int ) V_180 ) ;
goto V_308;
}
V_11 = F_145 ( V_132 , V_300 , V_302 , V_303 ) ;
...
T_1
F_152 ( struct V_1 * V_2 , struct V_22 * V_23 , struct V_310 * V_311 , int V_110 )
{
T_1 V_11 ;
...
V_36 -> V_71 == F_113 () )
return 0 ;
V_11 = F_158 ( V_36 , V_313 & ( V_318 | V_319 | V_320 ) ) ;
if ( V_11 == - V_321 && F_34 ( V_36 -> V_37 ) &&
( V_313 == ( V_136 | V_57 ) ||
V_313 == ( V_136 | V_322 ) ) )
V_11 = F_158 ( V_36 , V_320 ) ;
...
if ( V_153 [ 0 ] . V_155 )
return 0 ;
V_329 = F_161 ( V_327 , V_326 ) ;
if ( V_329 < 2 )
V_329 = 2 ;
V_327 = V_329 * V_326 ;
F_22 ( L_10 , V_327 ) ;
for ( V_325 = 0 ; V_325 < V_326 ; V_325 ++ ) {
F_162 ( & V_153 [ V_325 ] . V_154 ) ;
V_323 = & V_153 [ V_325 ] . V_155 ;
for ( V_328 = 0 ; V_328 < V_329 ; V_328 ++ ) {
* V_323 = F_163 ( sizeof( struct V_142 ) , V_88 ) ;
if ( ! * V_323 )
goto V_330;
V_323 = & ( * V_323 ) -> V_156 ;
}
...
V_176 = F_52 ( V_23 -> V_29 , V_24 , & V_331 ) ;
if ( V_176 < 0 )
return F_64 ( V_176 ) ;
V_95 = F_65 ( & V_93 , V_331 , V_176 ) ;
F_55 ( V_331 ) ;
return V_95 ;
}
int
...
int error ;
if ( ! F_165 ( V_36 ) ||
! V_36 -> V_228 -> V_334 || ! V_36 -> V_228 -> V_335 )
return - V_105 ;
switch( type ) {
case V_332 :
V_24 = V_102 ;
...
if ( V_95 && V_95 -> V_92 ) {
V_176 = F_57 ( V_95 -> V_92 ) ;
V_331 = F_54 ( V_176 , V_88 ) ;
if ( ! V_331 )
return - V_89 ;
error = F_58 ( & V_93 , V_95 , V_331 , V_176 ) ;
if ( error < 0 )
goto V_336;
V_176 = error ;
} else
...
goto V_336;
if ( V_176 )
error = F_59 ( V_23 -> V_29 , V_24 , V_331 , V_176 , 0 ) ;
else {
