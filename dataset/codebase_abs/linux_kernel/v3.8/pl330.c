...
F_144 ( V_370 , V_291 ) ;
V_366 = V_370 -> V_366 [ 0 ] ;
V_207 = F_145 ( V_366 , F_139 , 0 ,
F_146 ( & V_370 -> V_98 ) , V_20 ) ;
if ( V_207 )
goto V_382;
V_207 = F_83 ( V_20 ) ;
if ( V_207 )
...
F_85 ( & V_291 -> V_299 ) ;
F_84 ( & V_291 -> V_298 ) ;
if ( ! F_122 ( V_291 , V_274 , V_384 ) )
F_147 ( & V_370 -> V_98 , L_47 ) ;
V_375 = & V_291 -> V_385 ;
F_85 ( & V_375 -> V_223 ) ;
if ( V_373 )
V_16 = F_148 ( int , V_373 -> V_386 , V_20 -> V_15 . V_16 ) ;
else
V_16 = F_148 ( int , V_20 -> V_15 . V_213 , V_20 -> V_15 . V_16 ) ;
V_291 -> V_387 = F_79 ( V_16 * sizeof( * V_293 ) , V_274 ) ;
if ( ! V_291 -> V_387 ) {
V_207 = - V_217 ;
...
if ( V_373 ) {
V_375 -> V_389 = V_373 -> V_389 ;
} else {
F_149 ( V_390 , V_375 -> V_389 ) ;
if ( V_20 -> V_15 . V_213 ) {
F_149 ( V_391 , V_375 -> V_389 ) ;
F_149 ( V_392 , V_375 -> V_389 ) ;
F_149 ( V_393 , V_375 -> V_389 ) ;
}
}
V_375 -> V_394 = F_109 ;
V_375 -> V_395 = F_113 ;
...
F_152 ( V_20 -> V_23 ) ;
V_381:
F_153 ( V_377 -> V_380 , F_142 ( V_377 ) ) ;
F_86 ( V_291 ) ;
return V_207 ;
}
static int F_154 ( struct V_369 * V_370 )
{
struct V_290 * V_291 = F_155 ( V_370 ) ;
struct V_281 * V_293 , * V_403 ;
struct V_19 * V_20 ;
struct V_376 * V_377 ;
int V_366 ;
if ( ! V_291 )
