...
if ( V_138 -> V_155 >= V_197 )
break;
V_7 = F_17 ( NULL , V_194 -> V_198 [ V_58 ] ,
V_194 -> V_199 , V_194 -> V_200 ) ;
if ( V_7 < 0 )
return V_201 ;
...
static int F_67 ( struct V_203 * V_204 )
{
T_10 V_205 ;
struct V_137 V_8 ;
memset ( & V_8 , 0 , sizeof( V_8 ) ) ;
V_205 =
F_68 ( V_204 -> V_206 , V_207 ,
F_62 , & V_8 ) ;
if ( F_69 ( V_205 ) )
return - V_164 ;
...
static int F_70 ( struct V_203 * V_204 , int type )
{
return - V_61 ;
}
