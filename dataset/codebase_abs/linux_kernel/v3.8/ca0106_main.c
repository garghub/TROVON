...
static int V_62 ( struct V_1 * V_2 , int V_155 )
{
struct V_172 * V_173 ;
struct V_57 * V_58 ;
...
switch ( V_155 ) {
case 0 :
F_69 ( V_173 , V_128 , & V_176 ) ;
F_69 ( V_173 , V_177 , & V_178 ) ;
V_175 = V_179 ;
break;
case 1 :
F_69 ( V_173 , V_128 , & V_180 ) ;
F_69 ( V_173 , V_177 , & V_181 ) ;
V_175 = V_182 ;
break;
case 2 :
F_69 ( V_173 , V_128 , & V_183 ) ;
F_69 ( V_173 , V_177 , & V_184 ) ;
V_175 = V_185 ;
break;
case 3 :
F_69 ( V_173 , V_128 , & V_186 ) ;
F_69 ( V_173 , V_177 , & V_187 ) ;
V_175 = V_188 ;
break;
}
V_173 -> V_189 = 0 ;
strcpy ( V_173 -> V_190 , L_7 ) ;
for( V_58 = V_173 -> V_191 [ V_128 ] . V_58 ;
V_58 ;
V_58 = V_58 -> V_192 ) {
if ( ( V_64 = F_70 ( V_58 ,
V_193 ,
...
for ( V_58 = V_173 -> V_191 [ V_177 ] . V_58 ;
V_58 ;
V_58 = V_58 -> V_192 ) {
if ( ( V_64 = F_70 ( V_58 ,
V_193 ,
...
static void F_73 ( struct V_1 * V_37 , int V_194 )
{
int V_195 ;
unsigned int V_196 ;
F_3 ( 0 , V_37 -> V_9 + V_33 ) ;
...
V_199 | V_200 |
V_201 | 0x00001200 |
0x00000000 | V_202 | V_203 ;
if ( ! V_194 ) {
V_37 -> V_39 [ 0 ] = V_37 -> V_40 [ 0 ] = V_196 ;
V_37 -> V_39 [ 1 ] = V_37 -> V_40 [ 1 ] = V_196 ;
V_37 -> V_39 [ 2 ] = V_37 -> V_40 [ 2 ] = V_196 ;
V_37 -> V_39 [ 3 ] = V_37 -> V_40 [ 3 ] = V_196 ;
}
F_6 ( V_37 , V_204 , 0 , V_37 -> V_39 [ 1 ] ) ;
F_6 ( V_37 , V_41 , 0 , V_37 -> V_39 [ 0 ] ) ;
F_6 ( V_37 , V_205 , 0 , V_37 -> V_39 [ 2 ] ) ;
F_6 ( V_37 , V_206 , 0 , V_37 -> V_39 [ 3 ] ) ;
F_6 ( V_37 , V_108 , 0 , 0x00fc0000 ) ;
F_6 ( V_37 , V_207 , 0 , 0x00fc0000 ) ;
F_53 ( V_208 , V_37 -> V_9 + V_138 ) ;
...
#endif
F_6 ( V_37 , V_209 , 0 , 0xf ) ;
F_6 ( V_37 , V_210 , 0 , 0x000f0000 ) ;
V_37 -> V_211 = 0 ;
F_6 ( V_37 , V_212 , 0 , 0x40c81000 ) ;
F_6 ( V_37 , V_212 , 1 , 0xffffffff ) ;
F_6 ( V_37 , V_212 , 2 , 0x30300000 ) ;
F_6 ( V_37 , V_212 , 3 , 0x00700000 ) ;
F_6 ( V_37 , V_213 , 0 , 0x32765410 ) ;
F_6 ( V_37 , V_214 , 0 , 0x76767676 ) ;
F_6 ( V_37 , V_215 , 0 , 0x32765410 ) ;
F_6 ( V_37 , V_216 , 0 , 0x76767676 ) ;
for ( V_195 = 0 ; V_195 < 4 ; V_195 ++ ) {
F_6 ( V_37 , V_217 , V_195 , 0x30303030 ) ;
F_6 ( V_37 , V_218 , V_195 , 0x30303030 ) ;
#if 0
...
F_6 ( V_37 , V_219 , 0x0 , 0x333300e4 ) ;
if ( ! V_194 )
V_37 -> V_220 = 3 ;
} else if ( V_37 -> V_43 -> V_137 == 1 ) {
F_6 ( V_37 , V_219 , 0x0 , 0x444400e4 ) ;
if ( ! V_194 )
V_37 -> V_220 = 4 ;
} else {
F_6 ( V_37 , V_219 , 0x0 , 0x333300e4 ) ;
...
if ( V_37 -> V_43 -> V_221 == 2 ) {
F_3 ( 0x0 , V_37 -> V_9 + V_222 ) ;
F_3 ( 0x005f5301 , V_37 -> V_9 + V_222 ) ;
} else if ( V_37 -> V_43 -> V_221 == 1 ) {
F_3 ( 0x0 , V_37 -> V_9 + V_222 ) ;
F_3 ( 0x005f5301 , V_37 -> V_9 + V_222 ) ;
} else {
F_3 ( 0x0 , V_37 -> V_9 + V_222 ) ;
F_3 ( 0x005f03a3 , V_37 -> V_9 + V_222 ) ;
}
F_11 ( V_37 , 0x105 ) ;
F_3 ( V_223 | V_224 , V_37 -> V_9 + V_98 ) ;
if ( V_37 -> V_43 -> V_111 == 1 ) {
int V_225 , V_16 ;
V_225 = F_74 ( V_226 ) ;
for ( V_16 = 0 ; V_16 < V_225 ; V_16 ++ )
F_9 ( V_37 , V_226 [ V_16 ] [ 0 ] ,
V_226 [ V_16 ] [ 1 ] ) ;
for ( V_16 = 0 ; V_16 < 4 ; V_16 ++ ) {
V_37 -> V_227 [ V_16 ] [ 0 ] = 0xcf ;
V_37 -> V_227 [ V_16 ] [ 1 ] = 0xcf ;
}
V_37 -> V_228 = 2 ;
}
if ( V_37 -> V_43 -> V_46 ) {
...
V_225 = F_74 ( V_229 ) ;
for ( V_16 = 0 ; V_16 < V_225 ; V_16 ++ ) {
int V_3 = V_229 [ V_16 ] >> V_230 ;
F_7 ( V_37 , V_229 [ V_16 ] ) ;
if ( V_3 < F_74 ( V_37 -> V_56 ) )
V_37 -> V_56 [ V_3 ] = V_229 [ V_16 ] ;
}
F_17 ( V_37 , V_45 , 1 ) ;
}
}
...
static int F_75 ( int V_231 , struct V_232 * V_147 ,
struct V_233 * V_153 ,
struct V_1 * * V_234 )
{
struct V_1 * V_37 ;
...
if ( V_64 < 0 )
return V_64 ;
if ( F_77 ( V_153 , F_78 ( 32 ) ) < 0 ||
F_79 ( V_153 , F_78 ( 32 ) ) < 0 ) {
F_80 ( V_23 L_8 ) ;
F_64 ( V_153 ) ;
return - V_238 ;
}
...
V_37 -> V_152 = - 1 ;
F_81 ( & V_37 -> V_8 ) ;
V_37 -> V_9 = F_82 ( V_153 , 0 ) ;
V_37 -> V_151 = F_83 ( V_37 -> V_9 , 0x20 , L_9 ) ;
if ( ! V_37 -> V_151 ) {
F_59 ( V_37 ) ;
F_80 ( V_23 L_10 ) ;
return - V_239 ;
}
if ( F_84 ( V_153 -> V_152 , F_66 ,
V_240 , V_241 , V_37 ) ) {
F_59 ( V_37 ) ;
F_80 ( V_23 L_11 ) ;
return - V_239 ;
...
if ( F_85 ( V_193 , F_71 ( V_153 ) ,
1024 , & V_37 -> V_79 ) < 0 ) {
F_59 ( V_37 ) ;
return - V_66 ;
}
F_86 ( V_153 ) ;
F_87 ( V_153 , V_242 , & V_37 -> V_243 ) ;
F_88 ( V_153 , V_244 , & V_37 -> V_245 ) ;
F_80 ( V_246 L_12 ,
V_37 -> V_245 , V_153 -> V_247 , V_37 -> V_243 ) ;
strcpy ( V_147 -> V_248 , L_7 ) ;
strcpy ( V_147 -> V_249 , L_7 ) ;
for ( V_235 = V_250 ; V_235 -> V_243 ; V_235 ++ ) {
if ( V_251 [ V_231 ] ) {
if ( V_235 -> V_243 == V_251 [ V_231 ] )
break;
} else if ( V_235 -> V_243 == V_37 -> V_243 )
break;
}
V_37 -> V_43 = V_235 ;
if ( V_251 [ V_231 ] ) {
F_80 ( V_246 L_13
L_14 ,
V_235 -> V_190 , V_37 -> V_243 , V_251 [ V_231 ] ) ;
}
sprintf ( V_147 -> V_252 , L_15 ,
V_235 -> V_190 , V_37 -> V_9 , V_37 -> V_152 ) ;
F_73 ( V_37 , 0 ) ;
V_64 = F_89 ( V_147 , V_253 , V_37 , & V_144 ) ;
if ( V_64 < 0 ) {
F_59 ( V_37 ) ;
return V_64 ;
}
...
static void F_90 ( struct V_254 * V_164 , int V_255 )
{
F_11 ( (struct V_1 * ) ( V_164 -> V_157 ) , V_255 ) ;
}
static void F_91 ( struct V_254 * V_164 , int V_255 )
{
F_12 ( (struct V_1 * ) ( V_164 -> V_157 ) , V_255 ) ;
}
static unsigned char F_92 ( struct V_254 * V_164 , int V_38 )
{
return ( unsigned char ) F_1 ( (struct V_1 * ) ( V_164 -> V_157 ) ,
V_164 -> V_9 + V_38 , 0 ) ;
}
static void F_93 ( struct V_254 * V_164 , int V_12 , int V_38 )
{
F_6 ( (struct V_1 * ) ( V_164 -> V_157 ) , V_164 -> V_9 + V_38 , 0 , V_12 ) ;
}
static struct V_232 * F_94 ( void * V_157 )
{
return ( (struct V_1 * ) V_157 ) -> V_147 ;
}
static int F_95 ( void * V_157 )
{
return ( (struct V_1 * ) V_157 ) -> V_9 ;
}
static int F_96 ( struct V_1 * V_37 , unsigned int V_60 )
{
struct V_254 * V_164 ;
char * V_190 ;
int V_64 ;
...
V_164 -> V_278 = F_95 ;
V_164 -> V_157 = V_37 ;
if ( ( V_64 = F_97 ( V_37 , V_164 , 0 , V_190 ) ) < 0 )
return V_64 ;
return 0 ;
}
static int F_98 ( struct V_233 * V_153 ,
...
V_64 = F_99 ( V_285 [ V_231 ] , V_286 [ V_231 ] , V_287 , 0 , & V_147 ) ;
if ( V_64 < 0 )
return V_64 ;
V_64 = F_75 ( V_231 , V_147 , V_153 , & V_37 ) ;
if ( V_64 < 0 )
goto error;
V_147 -> V_36 = V_37 ;
for ( V_93 = 0 ; V_93 < 4 ; V_93 ++ ) {
...
static void F_108 ( struct V_233 * V_153 )
{
F_107 ( F_109 ( V_153 ) ) ;
F_106 ( V_153 , NULL ) ;
}
static int F_110 ( struct V_155 * V_231 )
{
struct V_233 * V_153 = F_111 ( V_231 ) ;
struct V_232 * V_147 = F_112 ( V_231 ) ;
struct V_1 * V_37 = V_147 -> V_36 ;
int V_93 ;
F_113 ( V_147 , V_289 ) ;
for ( V_93 = 0 ; V_93 < 4 ; V_93 ++ )
F_114 ( V_37 -> V_173 [ V_93 ] ) ;
if ( V_37 -> V_43 -> V_137 )
F_115 ( V_37 -> V_137 ) ;
F_116 ( V_37 ) ;
F_60 ( V_37 ) ;
...
static int F_119 ( struct V_155 * V_231 )
{
struct V_233 * V_153 = F_111 ( V_231 ) ;
struct V_232 * V_147 = F_112 ( V_231 ) ;
struct V_1 * V_37 = V_147 -> V_36 ;
...
F_123 ( V_37 ) ;
if ( V_37 -> V_43 -> V_46 ) {
for ( V_93 = 0 ; V_93 < F_74 ( V_37 -> V_56 ) ; V_93 ++ )
