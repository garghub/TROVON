...
static int F_22 ( struct V_3 * V_51 ,
...
if ( F_23 ( V_51 , 0x50 , V_89 , V_93 , sizeof( V_93 ) ) )
return - 1 ;
...
if ( V_91 > 0 ) {
V_89 += sizeof( T_2 ) + 1 ;
V_34 = F_23 ( V_51 , 0x50 , V_89 , V_83 , V_91 ) ;
if ( ! V_34 ) {
* V_88 = V_93 [ 2 ] ;
#if 0
if (Length < EETag[2])
...
V_34 = F_22 ( V_51 , 0x50 , V_89 , V_83 [ V_98 ] ) ;
if ( V_34 )
break;
V_97 = 10 ;
while ( V_97 ) {
T_1 V_99 ;
F_26 ( 50 ) ;
V_34 = F_23 ( V_51 , 0x50 , V_89 , & V_99 , 1 ) ;
if ( V_34 )
break;
if ( V_99 != V_83 [ V_98 ] )
F_21 ( V_85
...
static int F_27 ( struct V_3 * V_51 , T_2 V_92 , T_2 * V_83 )
{
int V_100 ;
T_1 V_59 [ 2 ] ;
T_3 V_60 = 0 ;
V_100 = F_24 ( V_51 , V_92 , 2 , V_59 , & V_60 ) ;
if ( V_100 )
return V_100 ;
if ( V_60 != 2 )
return - V_42 ;
...
V_59 [ 0 ] = V_83 >> 8 ;
V_59 [ 1 ] = V_83 & 0xff ;
V_100 = F_25 ( V_51 , V_92 , 2 , V_59 ) ;
if ( V_100 )
return V_100 ;
return 0 ;
}
static T_4 F_29 ( void * V_101 , T_4 V_102 , int V_103 )
{
...
F_30 ( V_85 L_17 ,
V_102 ) ;
F_28 ( V_104 , 0x1000 + V_2 -> V_10 , V_83 ) ;
} else {
if ( F_27 ( V_104 , 0x1000 + V_2 -> V_10 , & V_83 ) )
V_83 = 0 ;
F_30 ( V_85 L_18 ,
( T_4 ) V_83 ) ;
}
...
static T_5 F_31 ( struct V_79 * V_7 ,
enum V_105 V_106 )
{
...
static void F_34 ( struct V_79 * V_7 )
{
