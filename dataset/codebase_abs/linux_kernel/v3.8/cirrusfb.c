...
static unsigned int F_59 ( struct V_6 * V_7 ,
T_1 T_2 * V_13 )
{
unsigned long V_244 ;
struct V_1 * V_2 = V_7 -> V_10 ;
...
static int F_81 ( struct V_248 * V_249 ,
...
static int F_93 ( struct V_252 * V_300 ,
...
void F_100 ( struct V_252 * V_300 )
{
struct V_6 * V_7 = F_101 ( V_300 ) ;
F_78 ( V_7 ) ;
F_99 ( V_300 , NULL ) ;
}
static int T_4 F_102 ( char * V_319 )
{
char * V_320 ;
if ( ! V_319 || ! * V_319 )
return 0 ;
...
T_6 V_359 , T_6 V_360 , T_6 V_221 , T_6 V_222 ,
T_3 V_236 , T_3 V_237 , T_6 V_74 ,
V_347 V_361 )
{
T_7 V_336 = ( V_360 * V_74 ) + V_359 ;
V_347 V_231 ;
F_40 ( V_13 ) ;
