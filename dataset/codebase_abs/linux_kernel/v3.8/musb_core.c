...
int V_270 = F_145 ( V_127 , L_80 ) ;
int V_174 ;
struct V_271 * V_272 ;
void T_2 * V_273 ;
V_272 = F_146 ( V_127 , V_274 , 0 ) ;
if ( ! V_272 || V_270 <= 0 )
return - V_233 ;
V_273 = F_147 ( V_272 -> V_258 , F_148 ( V_272 ) ) ;
if ( ! V_273 ) {
F_99 ( V_3 , L_81 ) ;
return - V_245 ;
}
...
static int F_150 ( struct V_126 * V_127 )
{
struct V_2 * V_3 = & V_127 -> V_3 ;
struct V_1 * V_1 = F_1 ( V_3 ) ;
