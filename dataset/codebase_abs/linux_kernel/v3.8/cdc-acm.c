...
V_127 . V_133 = V_1 -> V_7 . V_133 / 10 ;
V_127 . V_134 = V_1 -> V_7 . V_134 == V_135 ?
V_135 :
V_1 -> V_7 . V_134 / 10 ;
...
struct V_125 T_3 * V_137 )
{
struct V_125 V_138 ;
unsigned int V_134 , V_133 ;
int V_14 = 0 ;
if ( F_82 ( & V_138 , V_137 , sizeof( V_138 ) ) )
return - V_136 ;
V_133 = V_138 . V_133 * 10 ;
V_134 = V_138 . V_134 == V_135 ?
V_135 : V_138 . V_134 * 10 ;
F_2 ( & V_1 -> V_7 . V_5 ) ;
if ( ! F_83 ( V_139 ) ) {
if ( ( V_133 != V_1 -> V_7 . V_133 ) ||
( V_134 != V_1 -> V_7 . V_134 ) )
V_14 = - V_81 ;
else
V_14 = - V_140 ;
...
static int F_84 ( struct V_55 * V_56 ,
...
switch ( V_141 ) {
case V_145 :
V_143 = F_78 ( V_1 , (struct V_125 T_3 * ) V_142 ) ;
break;
case V_146 :
V_143 = F_81 ( V_1 , (struct V_125 T_3 * ) V_142 ) ;
break;
}
return V_143 ;
}
static void F_85 ( struct V_55 * V_56 ,
struct V_147 * V_148 )
{
struct V_1 * V_1 = V_56 -> V_95 ;
struct V_147 * V_149 = & V_56 -> V_149 ;
struct V_150 V_151 ;
int V_57 = V_1 -> V_105 ;
V_151 . V_132 = F_86 ( F_87 ( V_56 ) ) ;
V_151 . V_152 = V_149 -> V_153 & V_154 ? 2 : 0 ;
V_151 . V_155 = V_149 -> V_153 & V_156 ?
( V_149 -> V_153 & V_157 ? 1 : 2 ) +
( V_149 -> V_153 & V_158 ? 2 : 0 ) : 0 ;
switch ( V_149 -> V_153 & V_159 ) {
case V_160 :
V_151 . V_161 = 5 ;
break;
case V_162 :
...
V_1 -> V_66 = ( ( V_149 -> V_153 & V_165 ) != 0 ) ;
if ( ! V_151 . V_132 ) {
V_151 . V_132 = V_1 -> line . V_132 ;
V_57 &= ~ V_106 ;
} else
V_57 |= V_106 ;
if ( V_57 != V_1 -> V_105 )
F_54 ( V_1 , V_1 -> V_105 = V_57 ) ;
if ( memcmp ( & V_1 -> line , & V_151 , sizeof V_151 ) ) {
memcpy ( & V_1 -> line , & V_151 , sizeof V_151 ) ;
F_10 ( & V_1 -> V_17 -> V_15 , L_24 ,
V_21 ,
F_79 ( V_151 . V_132 ) ,
V_151 . V_152 , V_151 . V_155 ,
V_151 . V_161 ) ;
F_88 ( V_1 , & V_1 -> line ) ;
}
}
...
int V_22 ;
struct V_24 * V_25 ;
struct V_166 * V_167 = F_90 ( V_1 -> V_17 ) ;
for ( V_25 = & V_1 -> V_25 [ 0 ] , V_22 = 0 ; V_22 < V_27 ; V_22 ++ , V_25 ++ )
F_91 ( V_167 , V_1 -> V_114 , V_25 -> V_12 , V_25 -> V_36 ) ;
}
...
int V_22 ;
for ( V_22 = 0 ; V_22 < V_1 -> V_82 ; V_22 ++ )
F_91 ( V_167 , V_1 -> V_168 ,
V_1 -> V_169 [ V_22 ] . V_170 , V_1 -> V_169 [ V_22 ] . V_171 ) ;
}
...
struct V_24 * V_25 ;
for ( V_25 = & V_1 -> V_25 [ 0 ] , V_22 = 0 ; V_22 < V_27 ; V_22 ++ , V_25 ++ ) {
V_25 -> V_12 = F_94 ( V_1 -> V_15 , V_1 -> V_114 , V_103 ,
& V_25 -> V_36 ) ;
if ( ! V_25 -> V_12 ) {
while ( V_22 != 0 ) {
-- V_22 ;
-- V_25 ;
F_91 ( V_1 -> V_15 , V_1 -> V_114 ,
V_25 -> V_12 , V_25 -> V_36 ) ;
}
return - V_172 ;
}
...
unsigned char * V_179 = V_47 -> V_18 -> V_180 ;
int V_181 = V_47 -> V_18 -> V_182 ;
struct V_46 * V_183 ;
struct V_46 * V_184 ;
struct V_185 * V_186 = NULL ;
struct V_185 * V_187 = NULL ;
struct V_185 * V_188 = NULL ;
struct V_166 * V_167 = F_90 ( V_47 ) ;
struct V_1 * V_1 ;
int V_8 ;
int V_189 , V_168 ;
T_4 * V_12 ;
...
int V_22 ;
int V_196 = 0 ;
V_194 = ( unsigned long ) V_174 -> V_197 ;
V_195 = ( V_194 == V_198 ) ? 1 : V_199 ;
if ( V_194 == V_200 ) {
V_184 = F_96 ( V_167 , 1 ) ;
V_183 = F_96 ( V_167 , 0 ) ;
goto V_201;
...
if ( ! V_181 ) {
if ( V_47 -> V_202 -> V_203 &&
V_47 -> V_202 -> V_203 -> V_182 &&
V_47 -> V_202 -> V_203 -> V_180 ) {
F_10 ( & V_47 -> V_15 ,
L_26 ) ;
V_181 = V_47 -> V_202 -> V_203 -> V_182 ;
V_179 = V_47 -> V_202 -> V_203 -> V_180 ;
} else {
F_19 ( & V_47 -> V_15 ,
L_27 ) ;
return - V_128 ;
...
V_176 = (struct V_175 * ) V_179 ;
break;
case V_207 :
V_178 = (struct V_177 * ) V_179 ;
break;
case V_208 :
break;
case V_209 :
...
V_183 = F_96 ( V_167 , V_176 -> V_215 ) ;
V_184 = F_96 ( V_167 , ( V_193 = V_176 -> V_216 ) ) ;
if ( ! V_183 || ! V_184 ) {
F_10 ( & V_47 -> V_15 , L_37 ) ;
return - V_40 ;
}
...
struct V_185 * V_218 ;
V_218 = & V_184 -> V_202 -> V_203 [ V_22 ] . V_19 ;
if ( F_98 ( V_218 ) )
V_186 = V_218 ;
else if ( F_99 ( V_218 ) )
V_188 = V_218 ;
...
if ( ! V_196 && V_47 != V_183 )
return - V_40 ;
if ( ! V_196 && F_101 ( V_184 ) ) {
F_10 ( & V_47 -> V_15 , L_42 ) ;
return - V_223 ;
}
if ( V_184 -> V_202 -> V_19 . V_213 < 2 ||
V_183 -> V_202 -> V_19 . V_213 == 0 )
return - V_128 ;
V_186 = & V_183 -> V_202 -> V_203 [ 0 ] . V_19 ;
V_187 = & V_184 -> V_202 -> V_203 [ 0 ] . V_19 ;
V_188 = & V_184 -> V_202 -> V_203 [ 1 ] . V_19 ;
if ( ! F_102 ( V_187 ) ) {
struct V_185 * V_222 ;
F_10 ( & V_47 -> V_15 ,
L_43 ) ;
...
V_219:
F_10 ( & V_47 -> V_15 , L_44 ) ;
V_1 = F_103 ( sizeof( struct V_1 ) , V_103 ) ;
if ( V_1 == NULL ) {
F_19 ( & V_47 -> V_15 , L_45 ) ;
goto V_224;
}
...
F_106 ( & V_1 -> V_87 ) ;
F_107 ( & V_1 -> V_5 ) ;
V_1 -> V_225 = F_108 ( V_167 , V_187 -> V_226 ) ;
V_1 -> V_227 = F_109 ( V_187 ) ;
if ( V_1 -> V_227 )
V_1 -> V_228 = V_187 -> V_228 ;
F_110 ( & V_1 -> V_7 ) ;
V_1 -> V_7 . V_229 = & V_230 ;
V_12 = F_94 ( V_167 , V_189 , V_103 , & V_1 -> V_231 ) ;
if ( ! V_12 ) {
F_19 ( & V_47 -> V_15 , L_47 ) ;
goto V_232;
}
...
V_1 -> V_102 = F_111 ( 0 , V_103 ) ;
if ( ! V_1 -> V_102 ) {
F_19 ( & V_47 -> V_15 , L_49 ) ;
goto V_235;
}
for ( V_22 = 0 ; V_22 < V_195 ; V_22 ++ ) {
struct V_84 * V_85 = & ( V_1 -> V_169 [ V_22 ] ) ;
struct V_33 * V_33 ;
V_85 -> V_170 = F_94 ( V_1 -> V_15 , V_168 , V_103 ,
& V_85 -> V_171 ) ;
if ( ! V_85 -> V_170 ) {
F_19 ( & V_47 -> V_15 , L_50
L_51 ) ;
...
if ( F_109 ( V_188 ) )
F_112 ( V_239 -> V_33 , V_167 ,
F_115 ( V_167 , V_188 -> V_226 ) ,
NULL , V_1 -> V_114 , F_42 , V_239 , V_188 -> V_228 ) ;
else
F_113 ( V_239 -> V_33 , V_167 ,
F_116 ( V_167 , V_188 -> V_226 ) ,
NULL , V_1 -> V_114 , F_42 , V_239 ) ;
V_239 -> V_33 -> V_237 |= V_238 ;
V_239 -> V_86 = V_1 ;
}
F_117 ( V_47 , V_1 ) ;
V_22 = F_118 ( & V_47 -> V_15 , & V_241 ) ;
if ( V_22 < 0 )
goto V_240;
if ( V_178 ) {
V_1 -> V_49 = F_119 ( V_178 -> V_242 - 4 , V_103 ) ;
if ( ! V_1 -> V_49 )
goto V_243;
V_1 -> V_50 = V_178 -> V_242 - 4 ;
memcpy ( V_1 -> V_49 , ( T_4 * ) & V_178 -> V_244 ,
V_178 -> V_242 - 4 ) ;
V_1 -> V_51 = V_178 -> V_245 ;
V_22 = F_118 ( & V_47 -> V_15 , & V_246 ) ;
if ( V_22 < 0 ) {
F_62 ( V_1 -> V_49 ) ;
V_1 -> V_49 = NULL ;
V_1 -> V_50 = 0 ;
...
V_22 = F_118 ( & V_47 -> V_15 ,
& V_247 ) ;
if ( V_22 < 0 ) {
F_120 ( & V_47 -> V_15 , & V_246 ) ;
F_62 ( V_1 -> V_49 ) ;
V_1 -> V_49 = NULL ;
V_1 -> V_50 = 0 ;
goto V_243;
...
V_243:
F_112 ( V_1 -> V_102 , V_167 ,
F_121 ( V_167 , V_186 -> V_226 ) ,
V_1 -> V_233 , V_189 , F_29 , V_1 ,
V_186 -> V_228 ? V_186 -> V_228 : 0xff ) ;
V_1 -> V_102 -> V_237 |= V_238 ;
V_1 -> V_102 -> V_35 = V_1 -> V_231 ;
F_122 ( & V_47 -> V_15 , L_54 , V_8 ) ;
F_54 ( V_1 , V_1 -> V_105 ) ;
V_1 -> line . V_132 = F_86 ( 9600 ) ;
V_1 -> line . V_161 = 8 ;
F_88 ( V_1 , & V_1 -> line ) ;
F_123 ( & V_248 , V_184 , V_1 ) ;
F_117 ( V_184 , V_1 ) ;
F_124 ( V_183 ) ;
F_125 ( & V_1 -> V_7 , V_111 , V_8 ,
& V_183 -> V_15 ) ;
return 0 ;
V_240:
for ( V_22 = 0 ; V_22 < V_27 ; V_22 ++ )
F_126 ( V_1 -> V_25 [ V_22 ] . V_33 ) ;
V_236:
for ( V_22 = 0 ; V_22 < V_195 ; V_22 ++ )
F_126 ( V_1 -> V_80 [ V_22 ] ) ;
F_92 ( V_1 ) ;
...
F_89 ( V_1 ) ;
V_234:
F_91 ( V_167 , V_189 , V_1 -> V_233 , V_1 -> V_231 ) ;
V_232:
F_6 ( V_1 ) ;
F_62 ( V_1 ) ;
V_224:
...
static void F_129 ( struct V_46 * V_47 )
{
struct V_1 * V_1 = F_26 ( V_47 ) ;
struct V_166 * V_167 = F_90 ( V_47 ) ;
struct V_55 * V_56 ;
...
F_126 ( V_1 -> V_80 [ V_22 ] ) ;
F_89 ( V_1 ) ;
F_91 ( V_167 , V_1 -> V_189 , V_1 -> V_233 , V_1 -> V_231 ) ;
F_92 ( V_1 ) ;
if ( ! V_1 -> V_196 )
F_131 ( & V_248 , V_47 == V_1 -> V_17 ?
V_1 -> V_39 : V_1 -> V_17 ) ;
F_49 ( & V_1 -> V_7 ) ;
}
static int F_132 ( struct V_46 * V_47 , T_5 V_249 )
{
struct V_1 * V_1 = F_26 ( V_47 ) ;
int V_250 ;
if ( F_133 ( V_249 ) ) {
...
if ( V_250 )
return 0 ;
if ( F_136 ( V_252 , & V_1 -> V_7 . V_29 ) )
F_127 ( V_1 ) ;
return 0 ;
}
static int F_137 ( struct V_46 * V_47 )
{
struct V_1 * V_1 = F_26 ( V_47 ) ;
struct V_24 * V_25 ;
int V_143 = 0 ;
...
if ( V_143 < 0 )
goto V_254;
V_143 = F_37 ( V_1 , V_253 ) ;
}
V_254:
return V_143 ;
}
static int F_138 ( struct V_46 * V_47 )
{
struct V_1 * V_1 = F_26 ( V_47 ) ;
struct V_55 * V_56 ;
if ( F_136 ( V_252 , & V_1 -> V_7 . V_29 ) ) {
...
V_111 -> type = V_260 ,
V_111 -> V_261 = V_262 ,
V_111 -> V_29 = V_263 | V_264 ;
V_111 -> V_265 = V_266 ;
V_111 -> V_265 . V_153 = V_267 | V_164 | V_268 |
V_269 | V_165 ;
F_141 ( V_111 , & V_270 ) ;
V_14 = F_142 ( V_111 ) ;
if ( V_14 ) {
...
F_146 (KERN_INFO KBUILD_MODNAME L_57 DRIVER_DESC L_58 ) ;
return 0 ;
}
