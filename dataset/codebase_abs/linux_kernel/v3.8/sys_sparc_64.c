...
T_1 unsigned long F_20 ( struct V_60 * V_61 )
{
static int V_62 ;
if ( V_62 ++ > 5 )
return - V_63 ;
F_21 ( L_1 , V_61 -> V_64 [ 1 ] ) ;
#ifdef F_22
F_23 ( V_61 ) ;
#endif
return - V_63 ;
}
T_1 void F_24 ( struct V_60 * V_61 )
{
T_2 V_25 ;
if ( F_6 ( V_29 ) ) {
V_61 -> V_65 &= 0xffffffff ;
V_61 -> V_66 &= 0xffffffff ;
}
#ifdef F_25
F_21 ( L_2 , V_61 -> V_65 , V_61 -> V_66 ) ;
#endif
V_25 . V_67 = V_68 ;
V_25 . V_69 = 0 ;
V_25 . V_70 = V_71 ;
V_25 . V_72 = ( void V_73 * ) V_61 -> V_65 ;
V_25 . V_74 = 0 ;
F_26 ( V_68 , & V_25 , V_18 ) ;
#ifdef F_25
F_21 ( L_3 , V_61 -> V_65 , V_61 -> V_66 ) ;
#endif
}
T_1 long F_27 ( unsigned long V_75 ,
struct V_60 * V_61 )
{
if ( V_75 >= 3 )
return - V_28 ;
V_61 -> V_76 = ( V_61 -> V_76 & ~ V_77 ) | ( V_75 << 14 ) ;
return 0 ;
}
T_1 long F_28 ( void )
{
