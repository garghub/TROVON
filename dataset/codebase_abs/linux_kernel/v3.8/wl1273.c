...
struct V_67 * V_68 )
{
struct V_54 * V_55 = F_9 ( V_68 -> V_53 ) ;
...
return V_8 ;
V_55 -> V_83 = F_23 ( V_79 ) ;
V_8 = F_6 ( V_2 , V_55 -> V_83 ) ;
if ( V_8 )
return V_8 ;
return 0 ;
}
int F_24 ( struct V_52 * V_53 , unsigned int * V_84 )
{
struct V_54 * V_55 ;
if ( V_53 == NULL || V_84 == NULL )
return - V_22 ;
V_55 = F_9 ( V_53 ) ;
switch ( V_55 -> V_9 ) {
case V_73 :
...
V_55 = F_26 ( sizeof( struct V_54 ) , V_91 ) ;
if ( V_55 == NULL ) {
F_4 ( V_53 -> V_6 , L_20 ) ;
return - V_92 ;
}
