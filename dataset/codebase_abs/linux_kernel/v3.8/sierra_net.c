...
{
F_44 ( V_10 , V_102 ) ;
strncpy ( V_102 -> V_103 , V_104 , sizeof V_102 -> V_103 ) ;
strncpy ( V_102 -> V_105 , V_106 , sizeof V_102 -> V_105 ) ;
}
...
F_59 ( & V_5 -> V_69 ) ;
V_40 = F_50 ( V_3 , & V_118 ) ;
F_20 ( & V_3 -> V_47 -> V_3 , L_37 , V_118 ) ;
if ( ! ( V_40 == sizeof( V_118 ) && ( V_118 & V_150 ) ) ) {
F_54 ( & V_3 -> V_47 -> V_3 , L_38
L_39 ) ;
F_37 ( V_5 ) ;
return - V_46 ;
}
