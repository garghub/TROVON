...
V_11 = 1 ;
V_7 -> V_45 = F_23 ( F_26 ( V_6 . V_44 ) + V_6 . V_46 + V_6 . V_47
+ V_8 - ( V_6 . V_42 << 2 ) ) ;
V_7 -> V_44 = 0 ;
}
( ( V_48 * ) V_7 ) [ 13 ] = 0 ;
...
static inline void
F_30 ( struct V_1 * V_1 , struct V_2 * V_52 , unsigned char V_53 ,
unsigned int V_54 )
{
if ( V_54 == V_55 && V_52 -> V_35 == NULL )
V_52 -> V_35 = V_1 -> V_56 ;
F_31 ( V_52 , V_57 , V_53 , 0 ) ;
}
static unsigned int
F_32 ( struct V_2 * V_58 , const struct V_59 * V_60 )
{
const struct V_61 * V_62 = V_60 -> V_63 ;
struct V_1 * V_1 = F_33 ( ( V_60 -> V_64 != NULL ) ? V_60 -> V_64 : V_60 -> V_65 ) ;
F_5 ( L_8 , V_66 ) ;
switch ( V_62 -> V_67 ) {
case V_68 :
F_30 ( V_1 , V_58 , V_69 , V_60 -> V_54 ) ;
break;
case V_70 :
F_30 ( V_1 , V_58 , V_71 , V_60 -> V_54 ) ;
break;
case V_72 :
F_30 ( V_1 , V_58 , V_73 , V_60 -> V_54 ) ;
break;
case V_74 :
F_30 ( V_1 , V_58 , V_75 , V_60 -> V_54 ) ;
break;
case V_76 :
F_30 ( V_1 , V_58 , V_77 , V_60 -> V_54 ) ;
break;
case V_78 :
break;
case V_79 :
...
static int F_35 ( const struct V_81 * V_60 )
{
