...
static int F_138 ( struct V_87 * V_45 , T_4 V_329 )
{
return 0 ;
}
...
V_333 . V_121 = V_132 -> V_102 ;
V_333 . V_156 = V_334 ;
V_333 . V_51 = F_53 ( V_51 -> V_221 [ V_334 ] . V_335 ) ;
F_36 ( V_336 , & V_333 ) ;
if ( V_20 ) {
F_32 ( V_54 ,
L_53
...
V_333 . V_156 = V_337 ;
V_333 . V_51 = F_53 ( V_51 -> V_221 [ V_337 ] . V_335 ) ;
F_36 ( V_336 , & V_333 ) ;
if ( V_20 ) {
F_32 ( V_54 ,
L_55
...
F_43 ( V_54 , V_96 , L_56 ,
V_51 -> V_221 [ V_334 ] . V_335 ,
V_51 -> V_221 [ V_337 ] . V_335 ) ;
V_248:
return V_20 ;
}
