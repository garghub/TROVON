...
if ( F_24 ( & V_34 -> V_78 ) )
return 0 ;
F_61 (lseg, next, &lo->plh_segs, pls_list)
if ( ! V_89 ||
F_59 ( & V_71 -> V_97 , V_89 ) ) {
F_3 ( L_23
L_24 , V_5 ,
...
if ( F_24 ( V_98 ) )
return;
F_61 (lseg, tmp, free_me, pls_list) {
F_19 ( & V_71 -> V_72 ) ;
F_49 ( V_71 ) ;
}
}
...
F_5 ( & V_43 -> V_44 ) ;
F_65 () ;
F_66 (server, &clp->cl_superblocks, client_link) {
if ( ! F_24 ( & V_14 -> V_101 ) )
F_67 ( & V_14 -> V_101 , & V_92 ) ;
}
F_68 () ;
F_7 ( & V_43 -> V_44 ) ;
while ( ! F_24 ( & V_92 ) ) {
V_34 = F_69 ( V_92 . V_94 , struct V_33 ,
V_42 ) ;
F_3 ( L_26 , V_5 ,
V_34 -> V_41 -> V_102 ) ;
F_25 ( & V_34 -> V_42 ) ;
...
static bool F_70 ( T_1 V_103 , T_1 V_104 )
{
return ( V_105 ) V_103 - ( V_105 ) V_104 > 0 ;
}
void
F_71 ( struct V_33 * V_34 , const T_4 * V_106 ,
bool V_107 )
{
T_1 V_108 , V_109 , V_110 ;
int V_111 = F_24 ( & V_34 -> V_78 ) ;
V_108 = F_72 ( V_34 -> V_112 . V_113 ) ;
V_109 = F_72 ( V_106 -> V_113 ) ;
if ( V_111 || F_70 ( V_109 , V_108 ) ) {
F_73 ( & V_34 -> V_112 , V_106 ) ;
if ( V_107 ) {
V_110 = F_72 ( V_106 -> V_113 ) ;
} else {
V_110 = V_109 - F_55 ( & V_34 -> V_114 ) ;
}
if ( V_111 || F_70 ( V_110 , V_34 -> V_115 ) )
V_34 -> V_115 = V_110 ;
}
}
static bool
F_74 ( const struct V_33 * V_34 ,
const T_4 * V_116 )
{
T_1 V_113 = F_72 ( V_116 -> V_113 ) ;
return ! F_70 ( V_113 , V_34 -> V_115 ) ;
}
static bool
F_75 ( const struct V_33 * V_34 , int V_117 )
{
return V_34 -> V_100 ||
F_42 ( V_79 , & V_34 -> V_60 ) ||
( F_24 ( & V_34 -> V_78 ) &&
...
int
F_76 ( T_4 * V_118 , struct V_33 * V_34 ,
struct V_119 * V_120 )
{
int V_25 = 0 ;
F_3 ( L_27 , V_5 ) ;
...
int V_122 ;
do {
V_122 = F_77 ( & V_120 -> V_123 ) ;
F_73 ( V_118 , & V_120 -> V_116 ) ;
} while ( F_78 ( & V_120 -> V_123 , V_122 ) );
} else
F_73 ( V_118 , & V_34 -> V_112 ) ;
F_7 ( & V_34 -> V_41 -> V_52 ) ;
F_3 ( L_28 , V_5 ) ;
return V_25 ;
}
...
V_127 -> args . V_125 = F_81 ( V_125 ) ;
V_127 -> V_38 = V_38 ;
V_71 = F_82 ( V_127 , V_38 ) ;
if ( F_83 ( V_71 ) ) {
switch ( F_84 ( V_71 ) ) {
case - V_132 :
case - V_133 :
...
F_42 ( V_79 , & V_34 -> V_60 ) )
goto V_142;
F_61 (lseg, tmp, &lo->plh_segs, pls_list)
...
void F_90 ( struct V_36 * V_37 , T_1 V_144 )
{
struct V_33 * V_34 ;
F_5 ( & V_37 -> V_52 ) ;
V_34 = F_28 ( V_37 ) -> V_49 ;
if ( F_70 ( V_144 , V_34 -> V_115 ) )
V_34 -> V_115 = V_144 ;
F_7 ( & V_37 -> V_52 ) ;
}
bool F_91 ( struct V_36 * V_37 , T_1 * V_144 , struct V_145 * V_146 )
{
struct V_47 * V_48 = F_28 ( V_37 ) ;
struct V_33 * V_34 ;
struct V_70 * V_71 ;
...
if ( F_42 ( V_143 , & V_71 -> V_76 ) ) {
F_92 ( & F_22 ( V_37 ) -> V_80 , V_146 , NULL ) ;
V_140 = true ;
goto V_4;
}
V_34 = V_48 -> V_49 ;
V_147 = F_72 ( V_34 -> V_112 . V_113 ) ;
...
if ( F_93 ( & V_71 -> V_97 , & V_150 -> V_97 ) > 0 )
continue;
F_95 ( & V_71 -> V_72 , & V_150 -> V_72 ) ;
F_3 ( L_34
L_35
L_36 ,
...
F_45 ( & V_34 -> V_151 ) ;
V_34 -> V_41 = V_37 ;
V_34 -> V_45 = F_97 ( V_125 -> V_152 -> V_7 -> V_153 ) ;
return V_34 ;
}
static struct V_33 *
...
goto V_154;
F_7 ( & V_37 -> V_52 ) ;
V_106 = F_96 ( V_37 , V_125 , V_38 ) ;
F_5 ( & V_37 -> V_52 ) ;
if ( F_99 ( V_48 -> V_49 == NULL ) ) {
V_48 -> V_49 = V_106 ;
return V_106 ;
} else if ( V_106 != NULL )
F_23 ( V_106 ) ;
...
V_156 = * V_62 ;
V_156 . V_64 = 1 ;
return F_57 ( V_155 , & V_156 ) ;
}
static struct V_70 *
F_101 ( struct V_33 * V_34 ,
struct V_61 * V_62 )
{
...
static bool F_103 ( struct V_124 * V_125 ,
struct V_36 * V_37 , int V_53 )
{
struct V_158 * V_159 = V_125 -> V_160 ;
struct V_47 * V_48 = F_28 ( V_37 ) ;
T_6 V_161 = F_104 ( V_37 ) ;
...
if ( ! F_106 ( F_22 ( V_37 ) ) )
goto V_4;
if ( F_103 ( V_125 , V_37 , V_53 ) )
goto V_4;
F_5 ( & V_37 -> V_52 ) ;
V_34 = F_98 ( V_37 , V_125 , V_38 ) ;
if ( V_34 == NULL ) {
F_7 ( & V_37 -> V_52 ) ;
goto V_4;
}
...
if ( V_178 . V_64 != V_65 )
V_178 . V_64 = F_107 ( V_178 . V_64 ) ;
V_71 = F_79 ( V_34 , V_125 , & V_178 , V_38 ) ;
F_36 ( & V_34 -> V_114 ) ;
V_183:
F_29 ( V_34 ) ;
V_4:
...
if ( F_75 ( V_34 , 1 ) ||
F_74 ( V_34 , & V_187 -> V_116 ) ) {
F_3 ( L_55 , V_5 ) ;
goto V_188;
}
F_71 ( V_34 , & V_187 -> V_116 , false ) ;
F_44 ( V_34 , V_71 ) ;
...
void
F_111 ( struct V_190 * V_191 , struct V_192 * V_193 )
{
T_3 V_194 = V_193 -> V_195 ;
F_112 ( V_191 -> V_196 != NULL ) ;
if ( V_193 -> V_197 != V_193 -> V_198 ) {
F_113 ( V_191 ) ;
return;
}
if ( V_191 -> V_199 == NULL )
V_194 = F_104 ( V_191 -> V_200 ) - F_114 ( V_193 ) ;
else
V_194 = F_115 ( V_191 -> V_199 ) ;
V_191 -> V_196 = F_105 ( V_191 -> V_200 ,
V_193 -> V_201 ,
F_114 ( V_193 ) ,
V_194 ,
V_149 ,
...
void
F_118 ( struct V_190 * V_191 , struct V_36 * V_36 ,
const struct V_204 * V_205 )
{
struct V_8 * V_14 = F_22 ( V_36 ) ;
struct V_1 * V_39 = V_14 -> V_10 ;
if ( V_39 == NULL )
F_119 ( V_191 , V_36 , V_205 ) ;
else
F_120 ( V_191 , V_36 , V_39 -> V_206 , V_205 , V_14 -> V_207 , 0 ) ;
}
void
F_121 ( struct V_190 * V_191 , struct V_36 * V_36 ,
int V_208 ,
const struct V_204 * V_205 )
{
struct V_8 * V_14 = F_22 ( V_36 ) ;
struct V_1 * V_39 = V_14 -> V_10 ;
if ( V_39 == NULL )
F_122 ( V_191 , V_36 , V_208 , V_205 ) ;
else
F_120 ( V_191 , V_36 , V_39 -> V_209 , V_205 , V_14 -> V_210 , V_208 ) ;
}
bool
F_123 ( struct V_190 * V_191 , struct V_192 * V_211 ,
struct V_192 * V_193 )
{
if ( V_191 -> V_196 == NULL )
return F_124 ( V_191 , V_211 , V_193 ) ;
return F_114 ( V_193 ) < F_56 ( V_191 -> V_196 -> V_97 . V_63 ,
V_191 -> V_196 -> V_97 . V_64 ) ;
}
int F_125 ( struct V_36 * V_36 ,
struct V_91 * V_66 ,
const struct V_204 * V_205 )
{
struct V_190 V_191 ;
F_38 ( V_212 ) ;
F_122 ( & V_191 , V_36 , V_213 , V_205 ) ;
while ( ! F_24 ( V_66 ) ) {
struct V_192 * V_193 = F_126 ( V_66 -> V_94 ) ;
F_127 ( V_193 ) ;
if ( ! F_128 ( & V_191 , V_193 ) )
F_129 ( V_193 , & V_212 ) ;
}
F_130 ( & V_191 ) ;
if ( ! F_24 ( & V_212 ) ) {
...
static void F_132 ( struct V_215 * V_216 )
{
...
V_216 -> V_146 . V_223 = F_125 ( V_218 -> V_36 ,
& V_218 -> V_224 ,
V_218 -> V_225 ) ;
}
void F_134 ( struct V_215 * V_216 )
{
struct V_217 * V_218 = V_216 -> V_219 ;
if ( ! V_218 -> V_220 ) {
F_135 ( V_216 ) ;
...
static void
F_136 ( struct V_190 * V_229 ,
struct V_215 * V_216 )
{
struct V_217 * V_218 = V_216 -> V_219 ;
if ( ! F_33 ( V_222 , & V_218 -> V_137 ) ) {
F_137 ( & V_218 -> V_224 , & V_229 -> V_230 ) ;
F_117 ( V_229 ) ;
V_229 -> V_231 = 1 ;
}
F_138 ( V_216 ) ;
...
static void
F_141 ( struct V_190 * V_229 , struct V_91 * V_66 , int V_236 )
{
struct V_215 * V_216 ;
...
while ( ! F_24 ( V_66 ) ) {
enum V_232 V_237 ;
V_216 = F_142 ( V_66 , struct V_215 , V_242 ) ;
F_25 ( & V_216 -> V_242 ) ;
V_237 = F_139 ( V_216 , V_235 , V_71 , V_236 ) ;
if ( V_237 == V_239 )
F_136 ( V_229 , V_216 ) ;
}
F_54 ( V_71 ) ;
}
static void F_143 ( struct V_217 * V_218 )
{
F_54 ( V_218 -> V_71 ) ;
F_144 ( V_218 ) ;
}
int
F_145 ( struct V_190 * V_229 )
{
struct V_243 * V_244 ;
struct V_217 * V_218 ;
int V_157 ;
...
V_218 = & V_244 -> V_219 ;
F_147 ( V_229 , V_218 , F_143 ) ;
V_218 -> V_71 = F_102 ( V_229 -> V_196 ) ;
F_15 ( & V_218 -> V_247 ) ;
V_157 = F_148 ( V_229 , V_218 ) ;
if ( V_157 != 0 ) {
F_54 ( V_229 -> V_196 ) ;
V_229 -> V_196 = NULL ;
} else
F_141 ( V_229 , & V_218 -> V_248 , V_229 -> V_249 ) ;
if ( F_9 ( & V_218 -> V_247 ) )
V_218 -> V_225 -> V_250 ( V_218 ) ;
return V_157 ;
}
int F_149 ( struct V_36 * V_36 ,
struct V_91 * V_66 ,
const struct V_204 * V_205 )
{
struct V_190 V_191 ;
...
static void F_150 ( struct V_251 * V_216 )
{
struct V_217 * V_218 = V_216 -> V_219 ;
...
if ( ! F_33 ( V_222 , & V_218 -> V_137 ) )
V_216 -> V_146 . V_223 = F_149 ( V_218 -> V_36 ,
& V_218 -> V_224 ,
V_218 -> V_225 ) ;
}
void F_151 ( struct V_251 * V_216 )
{
struct V_217 * V_218 = V_216 -> V_219 ;
if ( F_99 ( ! V_218 -> V_220 ) ) {
F_152 ( V_216 ) ;
...
static void
F_156 ( struct V_190 * V_229 , struct V_91 * V_66 )
{
struct V_251 * V_216 ;
const struct V_234 * V_235 = V_229 -> V_241 ;
struct V_70 * V_71 = V_229 -> V_196 ;
...
while ( ! F_24 ( V_66 ) ) {
enum V_232 V_237 ;
V_216 = F_142 ( V_66 , struct V_251 , V_242 ) ;
F_25 ( & V_216 -> V_242 ) ;
V_237 = F_155 ( V_216 , V_235 , V_71 ) ;
if ( V_237 == V_239 )
F_153 ( V_229 , V_216 ) ;
}
F_54 ( V_71 ) ;
}
static void F_157 ( struct V_217 * V_218 )
{
F_54 ( V_218 -> V_71 ) ;
F_158 ( V_218 ) ;
}
int
F_159 ( struct V_190 * V_229 )
{
struct V_255 * V_256 ;
struct V_217 * V_218 ;
int V_157 ;
...
V_218 = & V_256 -> V_219 ;
F_147 ( V_229 , V_218 , F_157 ) ;
V_218 -> V_71 = F_102 ( V_229 -> V_196 ) ;
F_15 ( & V_218 -> V_247 ) ;
V_157 = F_161 ( V_229 , V_218 ) ;
if ( V_157 != 0 ) {
F_54 ( V_229 -> V_196 ) ;
V_229 -> V_196 = NULL ;
} else
F_156 ( V_229 , & V_218 -> V_248 ) ;
if ( F_9 ( & V_218 -> V_247 ) )
V_218 -> V_225 -> V_250 ( V_218 ) ;
return V_157 ;
}
static void F_162 ( struct V_36 * V_36 , struct V_91 * V_257 )
{
struct V_70 * V_71 ;
...
void F_163 ( struct V_70 * V_71 )
{
F_37 ( V_71 -> V_77 , V_71 -> V_97 . V_53 ) ;
}
void
F_135 ( struct V_215 * V_233 )
{
struct V_217 * V_218 = V_233 -> V_219 ;
struct V_36 * V_36 = V_218 -> V_36 ;
...
int
F_166 ( struct V_36 * V_36 , bool V_265 )
{
struct V_263 * V_216 ;
struct V_47 * V_48 = F_28 ( V_36 ) ;
T_6 V_259 ;
...
struct V_158 * F_172 ( void )
{
struct V_158 * V_276 ;
V_276 = F_80 ( sizeof( * V_276 ) , V_203 ) ;
if ( ! V_276 ) {
F_3 ( L_65 , V_5 ) ;
return NULL ;
}
