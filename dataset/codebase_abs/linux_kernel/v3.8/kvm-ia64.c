...
int F_119 ( struct V_5 * V_5 , struct V_252 * V_253 )
{
if ( ! F_61 ( V_5 ) )
return - V_254 ;
V_253 -> V_30 = F_120 ( V_5 , V_211 ,
V_253 -> V_255 , V_253 -> V_256 ) ;
return 0 ;
}
long F_121 ( struct V_257 * V_258 ,
unsigned int V_259 , unsigned long V_260 )
{
struct V_5 * V_5 = V_258 -> V_261 ;
void T_7 * V_262 = ( void T_7 * ) V_260 ;
int V_53 = - V_263 ;
switch ( V_259 ) {
case V_264 : {
struct V_265 V_266 ;
struct V_267 V_268 ;
V_53 = - V_269 ;
if ( F_122 ( & V_266 , V_262 , sizeof V_266 ) )
goto V_163;
V_268 . V_35 = V_266 . V_35 ;
V_268 . V_19 = V_266 . V_19 ;
V_268 . V_270 =
V_266 . V_270 ;
V_268 . V_271 = V_266 . V_271 ;
V_53 = F_123 ( V_5 ,
& V_268 , 0 ) ;
if ( V_53 )
goto V_163;
...
struct V_213 V_214 ;
V_53 = - V_269 ;
if ( F_122 ( & V_214 , V_262 , sizeof V_214 ) )
goto V_163;
V_53 = - V_254 ;
if ( ! F_61 ( V_5 ) )
goto V_163;
...
goto V_163;
V_53 = - V_269 ;
if ( F_129 ( V_262 , & V_214 , sizeof V_214 ) )
goto V_163;
V_53 = 0 ;
break;
}
...
V_24 -> V_287 [ V_12 ] = F_139 ( V_12 ) ;
V_286 . V_288 = V_24 -> V_287 [ 3 ] ;
V_286 . V_289 = 4 ;
V_24 -> V_287 [ 3 ] = V_286 . V_288 ;
V_24 -> V_290 . V_291 = 1 ;
V_24 -> V_290 . V_292 = 1 ;
V_24 -> V_290 . V_293 = 1 ;
V_24 -> V_290 . V_294 = 1 ;
...
unsigned long V_302 ;
V_302 = V_186 -> V_302 ;
F_23 ( V_50 L_13 , V_2 , V_302 ) ;
V_301 = F_13 ( ( T_1 * ) V_24 , ( T_1 * ) V_302 , 0 ) ;
if ( V_301 ) {
F_23 ( V_85 L_14 ) ;
return - V_40 ;
}
...
T_8 V_303 = { 0 } ;
F_142 ( & V_303 ) ;
V_2 -> V_6 . V_21 = V_303 . V_304 ;
V_2 -> V_6 . V_22 [ 0 ] = V_303 . V_305 [ 0 ] ;
V_2 -> V_6 . V_22 [ 1 ] = V_303 . V_305 [ 1 ] ;
V_2 -> V_6 . V_23 [ 0 ] = V_303 . V_306 [ 0 ] ;
V_2 -> V_6 . V_23 [ 1 ] = V_303 . V_306 [ 1 ] ;
}
...
static enum V_307 F_145 ( struct V_143 * V_82 )
{
struct V_1 * V_2 ;
T_9 * V_308 ;
...
{
return F_61 ( V_2 -> V_5 ) == ( V_2 -> V_6 . V_311 != NULL ) ;
}
...
union V_174 * V_313 = & V_2 -> V_6 . V_227 ;
struct V_1 * V_314 = F_149 ( V_2 -> V_5 , V_2 ) ;
if ( F_137 ( V_314 ) )
return F_138 ( V_314 ) ;
if ( F_150 ( V_2 ) ) {
V_2 -> V_6 . V_118 = V_119 ;
...
V_312 -> V_6 . V_147 = V_147 ;
V_312 -> V_6 . V_240 = 0 ;
}
} else
V_2 -> V_6 . V_118 = V_130 ;
V_53 = - V_283 ;
V_2 -> V_6 . V_311 = F_151 ( sizeof( struct V_318 ) , V_197 ) ;
if ( ! V_2 -> V_6 . V_311 )
goto V_163;
V_2 -> V_6 . V_311 -> V_2 = V_2 ;
V_313 -> V_319 [ 1 ] = 0 ;
V_313 -> V_319 [ 12 ] = ( unsigned long ) ( ( char * ) V_314 + V_320 ) ;
V_313 -> V_319 [ 13 ] = ( unsigned long ) V_314 ;
V_313 -> V_169 = 0x1008522000UL ;
V_313 -> V_321 [ 40 ] = V_322 ;
V_313 -> V_323 = 0 ;
V_313 -> V_324 = 0x0 ;
V_313 -> V_321 [ 36 ] = 0x0 ;
V_313 -> V_321 [ 19 ] = 0x0 ;
V_313 -> V_321 [ 18 ] = ( unsigned long ) V_314 +
( ( sizeof( struct V_1 ) + 15 ) & ~ 15 ) ;
V_313 -> V_321 [ 64 ] = 0x0 ;
V_313 -> V_325 [ 0 ] = 0x7e04UL ;
V_313 -> V_325 [ 2 ] = ( unsigned long ) V_186 -> V_302 ;
V_313 -> V_325 [ 8 ] = 0x3c ;
V_313 -> V_326 [ 0 ] = 0x30 ;
V_313 -> V_326 [ 1 ] = 0x30 ;
V_313 -> V_326 [ 2 ] = 0x30 ;
...
V_313 -> V_326 [ 5 ] = 0x30 ;
V_313 -> V_326 [ 7 ] = 0x30 ;
V_313 -> V_327 [ 0 ] = * ( unsigned long * ) V_186 -> V_328 ;
V_2 -> V_6 . V_173 = V_5 -> V_6 . V_208 ;
V_2 -> V_6 . V_204 = V_5 -> V_6 . V_204 ;
V_2 -> V_6 . V_206 = V_5 -> V_6 . V_206 ;
F_152 ( & V_2 -> V_6 . V_145 , V_329 , V_151 ) ;
V_2 -> V_6 . V_145 . V_330 = F_145 ;
V_2 -> V_6 . V_170 = - 1 ;
V_2 -> V_6 . V_24 = (struct V_24 * ) F_153 ( V_2 -> V_331 ) ;
V_2 -> V_6 . V_332 = V_42 ;
V_2 -> V_6 . V_333 = V_334 ;
V_2 -> V_6 . V_335 = F_18 ( & V_5 -> V_6 . V_336 ) ;
V_2 -> V_6 . V_337 . V_338 = (struct V_230 * ) F_154 ( V_2 -> V_331 ) ;
V_2 -> V_6 . V_339 . V_338 = (struct V_230 * ) F_155 ( V_2 -> V_331 ) ;
F_141 ( V_2 ) ;
V_53 = 0 ;
V_163:
return V_53 ;
...
int V_53 ;
int V_131 ;
F_104 ( sizeof( struct V_1 ) > V_342 / 2 ) ;
V_53 = - V_40 ;
if ( V_100 >= V_316 ) {
F_23 ( V_85 L_16 ,
V_316 ) ;
...
int F_165 ( struct V_1 * V_2 , struct V_345 * V_346 )
{
return - V_40 ;
}
int F_166 ( struct V_1 * V_2 , struct V_345 * V_346 )
{
return - V_40 ;
}
...
V_350 = V_349 ( V_5 ) ;
F_170 (memslot, slots) {
for ( V_13 = 0 ; V_13 < V_352 -> V_353 ; V_13 ++ ) {
if ( V_352 -> V_354 [ V_13 ] )
F_171 ( (struct V_355 * ) V_352 -> V_354 [ V_13 ] ) ;
}
}
}
...
void F_179 ( struct V_1 * V_2 , int V_131 )
{
if ( V_131 != V_2 -> V_131 ) {
V_2 -> V_131 = V_131 ;
if ( V_2 -> V_6 . V_150 )
...
int F_180 ( struct V_1 * V_2 , struct V_218 * V_107 )
{
struct V_24 * V_24 = F_41 ( V_2 -> V_5 , V_2 -> V_6 . V_24 ) ;
int V_12 ;
F_181 ( V_2 ) ;
...
struct V_357 * V_358 )
{
memcpy ( V_358 , V_2 , sizeof( struct V_357 ) ) ;
return 0 ;
}
int F_185 ( struct V_1 * V_2 ,
struct V_357 * V_358 )
{
memcpy ( V_2 + 1 , & V_358 -> V_358 [ 0 ] + sizeof( struct V_1 ) ,
sizeof( struct V_357 ) - sizeof( struct V_1 ) ) ;
V_2 -> V_6 . V_359 = ( (struct V_1 * ) V_358 ) -> V_6 . V_359 ;
return 0 ;
}
...
switch ( V_259 ) {
case V_360 : {
struct V_357 T_7 * V_361 ;
void T_7 * V_362 = V_262 ;
V_53 = - V_269 ;
if ( F_122 ( & V_361 , V_362 , sizeof( void * ) ) )
goto V_163;
if ( ! F_188 ( V_363 , V_361 ,
sizeof( struct V_357 ) ) ) {
F_23 ( V_48 L_19
L_20 ) ;
goto V_163;
}
V_358 = F_151 ( sizeof( struct V_357 ) , V_197 ) ;
if ( ! V_358 ) {
V_53 = - V_283 ;
goto V_163;
}
V_53 = F_184 ( V_2 , V_358 ) ;
if ( V_53 )
goto V_163;
if ( F_129 ( V_361 , V_358 ,
sizeof( struct V_357 ) ) ) {
V_53 = - V_269 ;
goto V_163;
}
...
if ( F_122 ( & V_361 , V_362 , sizeof( void * ) ) )
goto V_163;
if ( ! F_188 ( V_365 , V_361 ,
sizeof( struct V_357 ) ) ) {
F_23 ( V_48 L_21
L_22 ) ;
goto V_163;
}
V_358 = F_189 ( sizeof( struct V_357 ) , V_197 ) ;
if ( ! V_358 ) {
V_53 = - V_283 ;
goto V_163;
}
if ( F_122 ( V_358 , V_361 ,
sizeof( struct V_357 ) ) )
goto V_163;
V_53 = F_185 ( V_2 , V_358 ) ;
break;
}
default:
V_53 = - V_40 ;
...
int F_190 ( struct V_1 * V_2 , struct V_366 * V_367 )
{
return V_368 ;
}
void F_191 ( struct V_351 * free ,
struct V_351 * V_369 )
{
}
int F_192 ( struct V_351 * V_35 , unsigned long V_353 )
{
return 0 ;
}
...
unsigned long V_374 = V_352 -> V_374 ;
if ( V_374 + V_353 > ( V_375 >> V_137 ) )
return - V_283 ;
for ( V_12 = 0 ; V_12 < V_353 ; V_12 ++ ) {
V_373 = F_194 ( V_5 , V_374 + V_12 ) ;
if ( ! F_195 ( V_373 ) ) {
F_109 ( V_5 , V_374 + V_12 ,
V_373 << V_137 ,
V_376 | V_377 ) ;
V_352 -> V_354 [ V_12 ] = ( unsigned long ) F_196 ( V_373 ) ;
} else {
F_109 ( V_5 , V_374 + V_12 ,
V_378 | ( V_373 << V_137 ) ,
V_379 ) ;
...
long V_301 ;
V_301 = F_204 ( & V_380 , & V_30 , & V_381 , 0 ) ;
if ( V_301 )
goto V_163;
if ( ! ( V_380 & V_382 ) )
goto V_163;
F_23 ( V_50 L_23 ) ;
V_301 = F_205 ( & V_280 , & V_383 ) ;
if ( V_301 )
goto V_163;
F_23 ( V_50 L_24 , V_280 ) ;
if ( ! ( V_383 & V_384 ) ) {
F_23 ( V_47 L_25
L_26 , V_383 ) ;
}
...
static void F_206 ( struct V_186 * V_385 ,
struct V_386 * V_386 )
{
...
static int F_207 ( struct V_186 * V_385 ,
struct V_386 * V_386 )
{
unsigned long V_389 ;
unsigned long V_393 ;
...
V_389 = ( unsigned long ) V_386 -> V_390 ;
V_393 = V_386 -> V_399 ;
if ( F_102 ( V_393 > V_282 ) )
return - V_269 ;
memcpy ( ( void * ) V_36 , ( void * ) V_389 , V_393 ) ;
F_206 ( V_385 , V_386 ) ;
F_5 ( V_36 , V_393 ) ;
V_394 = V_385 -> V_302 - V_389 ;
V_186 -> V_302 = V_38 + V_394 ;
F_23 ( V_50 L_30 ,
V_186 -> V_302 ) ;
V_396 = ( unsigned long ) V_385 -> V_328 - V_389 ;
V_186 -> V_328 = ( V_400 * ) ( V_38 +
V_396 ) ;
V_395 = * ( unsigned long * ) V_385 -> V_328 - V_389 ;
...
V_409 = F_211 ( V_352 ) ;
V_304 = V_352 -> V_374 / V_412 ;
F_20 ( & V_5 -> V_6 . V_336 ) ;
for ( V_12 = 0 ; V_12 < V_409 / sizeof( long ) ; ++ V_12 ) {
V_352 -> V_410 [ V_12 ] = V_410 [ V_304 + V_12 ] ;
V_410 [ V_304 + V_12 ] = 0 ;
}
F_22 ( & V_5 -> V_6 . V_336 ) ;
}
...
if ( log -> V_35 >= V_415 )
goto V_163;
V_352 = F_213 ( V_5 -> V_416 , log -> V_35 ) ;
V_53 = - V_417 ;
if ( ! V_352 -> V_410 )
goto V_163;
F_210 ( V_5 , V_352 ) ;
V_53 = F_214 ( V_5 , log , & V_414 ) ;
if ( V_53 )
goto V_163;
if ( V_414 ) {
F_199 ( V_5 ) ;
V_409 = F_211 ( V_352 ) ;
memset ( V_352 -> V_410 , 0 , V_409 ) ;
}
V_53 = 0 ;
V_163:
F_128 ( & V_5 -> V_273 ) ;
...
int F_217 ( struct V_1 * V_2 , struct V_418 * V_255 )
{
return F_40 ( V_2 , V_255 -> V_91 ) ;
}
int F_218 ( struct V_318 * V_311 , T_10 V_419 )
{
return V_311 -> V_2 -> V_331 == V_419 ;
}
int F_219 ( struct V_318 * V_311 , T_11 V_420 )
{
return 0 ;
}
int F_220 ( struct V_1 * V_421 , struct V_1 * V_422 )
{
return V_421 -> V_6 . V_245 - V_422 -> V_6 . V_245 ;
}
int F_221 ( struct V_1 * V_2 , struct V_318 * V_423 ,
int V_424 , int V_419 , int V_425 )
{
struct V_318 * V_426 = V_2 -> V_6 . V_311 ;
return ( V_425 == 0 ) ?
F_218 ( V_426 , V_419 ) :
F_219 ( V_426 , V_419 ) ;
}
static int F_222 ( int * V_427 )
{
T_5 V_428 , V_429 ;
int V_12 ;
