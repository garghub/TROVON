...
if ( F_17 ( V_42 ) )
V_42 -> V_41 = F_14 ( V_6 , V_42 -> V_41 ) ;
}
static void F_18 ( struct V_42 * V_42 , struct V_3 * V_4 )
{
unsigned V_45 = F_19 ( V_42 ) ;
char * V_46 = F_20 ( V_42 ) ;
if ( V_46 && V_45 >= V_4 -> V_16 ) {
V_46 [ V_4 -> V_16 - 1 ] = V_4 -> V_20 ;
F_21 ( L_23
L_24 ,
V_42 , V_4 -> V_20 , V_4 -> V_16 ,
( F_22 ( V_42 ) == V_18 ) ? 'w' : 'r' ,
V_42 -> V_47 , ( unsigned long long ) V_42 -> V_41 , V_45 ) ;
}
}
...
struct V_3 * V_4 = V_6 -> V_40 ;
unsigned V_48 ;
struct V_39 * V_49 = F_24 ( V_42 , sizeof( struct V_39 ) ) ;
V_49 -> V_50 = false ;
V_48 = ( V_29 - V_4 -> V_28 ) / V_51 ;
...
struct V_3 * V_4 = V_6 -> V_40 ;
struct V_39 * V_49 = F_24 ( V_42 , sizeof( struct V_39 ) ) ;
if ( V_4 -> V_16 && ! error && V_49 -> V_50 &&
( F_22 ( V_42 ) == V_19 ) && ( V_4 -> V_17 == V_19 ) &&
F_26 ( V_42 , V_4 ) )
F_18 ( V_42 , V_4 ) ;
return error ;
}
static int F_28 ( struct V_5 * V_6 , T_2 type ,
...
static int F_30 ( struct V_5 * V_6 , unsigned int V_64 , unsigned long V_65 )
{
struct V_3 * V_4 = V_6 -> V_40 ;
struct V_66 * V_35 = V_4 -> V_35 ;
int V_7 = 0 ;
if ( V_4 -> V_31 ||
V_6 -> V_67 != F_31 ( V_35 -> V_44 -> V_68 ) >> V_69 )
V_7 = F_32 ( NULL , V_64 ) ;
return V_7 ? : F_33 ( V_35 -> V_44 , V_35 -> V_70 , V_64 , V_65 ) ;
}
static int F_34 ( struct V_5 * V_6 , struct V_71 * V_72 ,
struct V_73 * V_74 , int V_75 )
{
struct V_3 * V_4 = V_6 -> V_40 ;
struct V_76 * V_77 = F_35 ( V_4 -> V_35 -> V_44 ) ;
if ( ! V_77 -> V_78 )
return V_75 ;
V_72 -> V_43 = V_4 -> V_35 -> V_44 ;
V_72 -> V_41 = F_14 ( V_6 , V_72 -> V_41 ) ;
return F_36 ( V_75 , V_77 -> V_78 ( V_77 , V_72 , V_74 ) ) ;
}
static int F_37 ( struct V_5 * V_6 , T_3 V_79 , void * V_46 )
{
struct V_3 * V_4 = V_6 -> V_40 ;
return V_79 ( V_6 , V_4 -> V_35 , V_4 -> V_31 , V_6 -> V_67 , V_46 ) ;
}
