...
#define F_53 (PAGE_SIZE * MAX_ARG_PAGES - sizeof(void *))
V_98 = F_53 - V_10 -> V_14 ;
...
F_8 ( L_47 , ( int ) V_14 ) ;
for ( V_106 = F_53 - 1 ; V_106 >= V_10 -> V_14 ; V_106 -- )
* ( char * ) -- V_14 =
( ( char * ) F_56 ( V_10 -> V_155 [ V_106 / V_156 ] ) ) [ V_106 % V_156 ] ;
...
F_58 ( V_150 , V_151 , V_3 -> V_20 -> V_157 ) ;
return 0 ;
}
