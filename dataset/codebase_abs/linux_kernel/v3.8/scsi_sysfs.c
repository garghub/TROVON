...
static T_1
F_60 ( struct V_27 * V_28 , struct V_29 * V_30 , char * V_31 )
{
struct V_50 * V_51 ;
V_51 = F_35 ( V_28 ) ;
...
struct V_50 * V_51 = F_35 ( V_28 ) ;
unsigned long V_102 ;
if ( F_65 ( V_31 , 10 , & V_102 ) )
return - V_24 ;
V_51 -> V_101 = F_66 ( V_102 ) ;
return V_102 ;
}
static T_1
...
if ( V_57 -> V_2 != V_109 )
return 0 ;
error = F_70 ( & V_57 -> V_28 ) ;
if ( error ) {
F_71 ( & V_57 -> V_28 , L_20 , error ) ;
return error ;
}
F_72 ( & V_57 -> V_28 ) ;
V_57 -> V_2 = V_110 ;
...
error = F_84 ( & V_51 -> V_52 ,
& V_117 ) ;
error = F_84 ( & V_51 -> V_52 ,
& V_118 ) ;
}
else
error = F_84 ( & V_51 -> V_52 , & V_119 ) ;
if ( error )
return error ;
if ( V_51 -> V_63 -> V_39 -> V_106 )
error = F_84 ( & V_51 -> V_52 , & V_120 ) ;
else
error = F_84 ( & V_51 -> V_52 , & V_121 ) ;
if ( error )
return error ;
error = F_85 ( V_111 , & V_51 -> V_52 , NULL , NULL ) ;
if ( error )
F_82 ( V_114 , V_51 ,
L_23 , error ) ;
...
{
struct V_13 * V_14 = F_95 ( V_57 -> V_28 . V_55 ) ;
unsigned long V_61 ;
struct V_50 * V_51 ;
F_25 ( V_14 -> V_64 , V_61 ) ;
V_128:
F_96 (sdev, &shost->__devices, siblings) {
...
void F_99 ( struct V_27 * V_28 )
{
struct V_13 * V_14 = F_95 ( V_28 -> V_55 ) ;
struct V_56 * V_57 , * V_11 = NULL ;
unsigned long V_61 ;
F_25 ( V_14 -> V_64 , V_61 ) ;
F_96 (starget, &shost->__targets, siblings) {
if ( V_57 -> V_2 == V_129 )
continue;
...
int F_100 ( struct V_76 * V_130 )
{
V_130 -> V_131 = & V_85 ;
return F_101 ( V_130 ) ;
}
int F_102 ( struct V_132 * V_133 )
{
V_133 -> V_134 = & V_86 ;
return F_103 ( V_133 ) ;
}
...
int error , V_3 ;
if ( V_14 -> V_39 -> V_135 ) {
for ( V_3 = 0 ; V_14 -> V_39 -> V_135 [ V_3 ] ; V_3 ++ ) {
error = F_84 ( & V_14 -> V_136 ,
V_14 -> V_39 -> V_135 [ V_3 ] ) ;
if ( error )
return error ;
}
...
struct V_56 * V_57 = V_51 -> V_112 ;
F_107 ( & V_51 -> V_52 ) ;
V_51 -> V_52 . V_131 = & V_85 ;
V_51 -> V_52 . type = & V_78 ;
F_108 ( & V_51 -> V_52 , L_24 ,
V_51 -> V_63 -> V_138 , V_51 -> V_20 , V_51 -> V_21 , V_51 -> V_22 ) ;
F_107 ( & V_51 -> V_115 ) ;
V_51 -> V_115 . V_55 = F_109 ( & V_51 -> V_52 ) ;
V_51 -> V_115 . V_134 = & V_86 ;
F_108 ( & V_51 -> V_115 , L_24 ,
V_51 -> V_63 -> V_138 , V_51 -> V_20 , V_51 -> V_21 , V_51 -> V_22 ) ;
V_51 -> V_139 = V_57 -> V_139 ;
F_110 ( & V_51 -> V_52 ) ;
F_25 ( V_14 -> V_64 , V_61 ) ;
F_111 ( & V_51 -> V_67 , & V_57 -> V_140 ) ;
F_111 ( & V_51 -> V_66 , & V_14 -> V_141 ) ;
F_27 ( V_14 -> V_64 , V_61 ) ;
}
