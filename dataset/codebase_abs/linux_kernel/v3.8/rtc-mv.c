...
T_4 V_53 ;
T_2 V_3 ;
V_52 = F_19 ( V_42 , V_54 , 0 ) ;
if ( ! V_52 )
return - V_55 ;
V_6 = F_20 ( & V_42 -> V_2 , sizeof( * V_6 ) , V_56 ) ;
if ( ! V_6 )
return - V_57 ;
V_53 = F_21 ( V_52 ) ;
if ( ! F_22 ( & V_42 -> V_2 , V_52 -> V_58 , V_53 ,
V_42 -> V_59 ) )
return - V_60 ;
V_6 -> V_7 = F_23 ( & V_42 -> V_2 , V_52 -> V_58 , V_53 ) ;
if ( ! V_6 -> V_7 )
return - V_57 ;
...
V_6 -> V_43 = F_25 ( V_42 , 0 ) ;
F_26 ( V_42 , V_6 ) ;
if ( V_6 -> V_43 >= 0 ) {
F_27 ( & V_42 -> V_2 , 1 ) ;
V_6 -> V_47 = F_28 ( V_42 -> V_59 , & V_42 -> V_2 ,
& V_62 ,
V_63 ) ;
} else
V_6 -> V_47 = F_28 ( V_42 -> V_59 , & V_42 -> V_2 ,
& V_64 , V_63 ) ;
if ( F_29 ( V_6 -> V_47 ) )
return F_30 ( V_6 -> V_47 ) ;
if ( V_6 -> V_43 >= 0 ) {
F_4 ( 0 , V_6 -> V_7 + V_38 ) ;
if ( F_31 ( & V_42 -> V_2 , V_6 -> V_43 , F_16 ,
V_65 ,
V_42 -> V_59 , V_6 ) < 0 ) {
F_32 ( & V_42 -> V_2 , L_4 ) ;
V_6 -> V_43 = - 1 ;
...
static int T_5 F_33 ( struct V_41 * V_42 )
{
struct V_5 * V_6 = F_15 ( V_42 ) ;
if ( V_6 -> V_43 >= 0 )
F_27 ( & V_42 -> V_2 , 0 ) ;
