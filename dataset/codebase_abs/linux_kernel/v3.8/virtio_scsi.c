...
V_59 = F_30 ( V_51 -> V_64 . V_47 , & V_61 , 0 , 1 , V_58 ,
V_65 ) ;
if ( ! V_59 )
F_31 ( V_51 -> V_64 . V_47 ) ;
...
{
struct V_50 * V_51 = F_22 ( V_49 ) ;
struct V_93 * V_94 = V_51 -> V_94 [ V_6 -> V_14 -> V_107 ] ;
struct V_10 * V_11 ;
int V_108 ;
struct V_1 * V_72 = F_1 ( V_51 -> V_3 ) ;
F_61 ( F_62 ( V_6 ) > V_72 -> V_109 ) ;
F_61 ( V_6 -> V_100 == V_110 ) ;
F_9 ( & V_6 -> V_14 -> V_15 ,
L_6 , V_6 , V_6 -> V_111 [ 0 ] ) ;
V_108 = V_112 ;
V_11 = F_63 ( V_44 , V_65 ) ;
...
V_11 -> V_6 = V_6 ;
V_11 -> V_99 . V_11 = (struct V_114 ) {
. V_74 [ 0 ] = 1 ,
. V_74 [ 1 ] = V_6 -> V_14 -> V_107 ,
...
F_61 ( V_6 -> V_120 > V_121 ) ;
memcpy ( V_11 -> V_99 . V_11 . V_122 , V_6 -> V_111 , V_6 -> V_120 ) ;
...
{
F_65 ( V_55 ) ;
struct V_93 * V_94 = V_51 -> V_94 [ V_11 -> V_6 -> V_14 -> V_107 ] ;
int V_108 = V_123 ;
V_11 -> V_55 = & V_55 ;
if ( F_55 ( V_94 , & V_51 -> V_56 , V_11 ,
sizeof V_11 -> V_99 . V_124 , sizeof V_11 -> V_13 . V_124 ,
V_125 ) < 0 )
goto V_113;
F_66 ( & V_55 ) ;
if ( V_11 -> V_13 . V_124 . V_16 == V_20 ||
V_11 -> V_13 . V_124 . V_16 == V_126 )
V_108 = V_127 ;
V_113:
F_15 ( V_11 , V_44 ) ;
return V_108 ;
...
{
struct V_50 * V_51 = F_22 ( V_6 -> V_14 -> V_128 ) ;
struct V_10 * V_11 ;
F_68 ( V_129 , V_6 -> V_14 , L_7 ) ;
V_11 = F_63 ( V_44 , V_125 ) ;
if ( ! V_11 )
return V_123 ;
memset ( V_11 , 0 , sizeof( * V_11 ) ) ;
V_11 -> V_6 = V_6 ;
V_11 -> V_99 . V_124 = (struct V_130 ) {
. type = V_131 ,
. V_132 = V_133 ,
. V_74 [ 0 ] = 1 ,
. V_74 [ 1 ] = V_6 -> V_14 -> V_107 ,
...
static void F_70 ( struct V_103 * V_135 ,
struct V_46 * V_47 )
{
F_71 ( & V_135 -> V_54 ) ;
V_135 -> V_47 = V_47 ;
...
struct V_93 * V_94 ;
T_4 V_137 = V_138 ;
V_94 = F_73 ( sizeof( * V_94 ) + sizeof( V_94 -> V_61 [ 0 ] ) * ( V_136 + 2 ) ,
V_137 ) ;
if ( ! V_94 )
return NULL ;
F_71 ( & V_94 -> V_106 ) ;
F_74 ( V_94 -> V_61 , V_136 + 2 ) ;
return V_94 ;
}
...
V_59 = V_3 -> V_140 -> V_147 ( V_3 , 3 , V_144 , V_145 , V_146 ) ;
if ( V_59 )
return V_59 ;
F_70 ( & V_51 -> V_56 , V_144 [ 0 ] ) ;
F_70 ( & V_51 -> V_64 , V_144 [ 1 ] ) ;
F_70 ( & V_51 -> V_53 , V_144 [ 2 ] ) ;
F_79 ( V_3 , V_148 , V_121 ) ;
F_79 ( V_3 , V_149 , V_40 ) ;
if ( F_80 ( V_3 , V_150 ) )
F_32 ( V_51 ) ;
V_136 = F_81 ( V_3 , V_151 ) ? : 1 ;
for ( V_66 = 0 ; V_66 < V_139 ; V_66 ++ ) {
V_51 -> V_94 [ V_66 ] = F_72 ( V_3 , V_136 ) ;
if ( ! V_51 -> V_94 [ V_66 ] ) {
V_59 = - V_152 ;
goto V_113;
}
...
T_1 V_136 , V_139 ;
T_1 V_153 ;
V_139 = F_81 ( V_3 , V_154 ) + 1 ;
V_72 = F_83 ( & V_155 ,
sizeof( * V_51 )
+ V_139 * sizeof( struct V_93 ) ) ;
if ( ! V_72 )
return - V_152 ;
V_136 = F_81 ( V_3 , V_151 ) ? : 1 ;
V_72 -> V_109 = V_136 ;
...
V_51 -> V_3 = V_3 ;
V_3 -> V_4 = V_72 ;
V_59 = F_78 ( V_3 , V_51 , V_139 ) ;
if ( V_59 )
goto V_156;
V_153 = F_81 ( V_3 , V_153 ) ? : 1 ;
V_72 -> V_153 = F_13 ( T_1 , V_153 , V_72 -> V_157 ) ;
V_72 -> V_158 = F_81 ( V_3 , V_158 ) ? : 0xFFFF ;
V_72 -> V_159 = F_81 ( V_3 , V_159 ) + 1 + 0x4000 ;
V_72 -> V_142 = V_139 ;
V_72 -> V_160 = 0 ;
V_72 -> V_161 = V_121 ;
V_59 = F_84 ( V_72 , & V_3 -> V_162 ) ;
if ( V_59 )
goto V_163;
return 0 ;
V_163:
...
struct V_1 * V_49 = F_1 ( V_3 ) ;
struct V_50 * V_51 = F_22 ( V_49 ) ;
return F_78 ( V_3 , V_51 , V_49 -> V_142 ) ;
}
