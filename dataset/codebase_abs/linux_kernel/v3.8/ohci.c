...
int V_58 = 0 ;
F_26 ( & V_4 -> V_62 ) ;
V_168 = F_21 ( V_4 , 7 , 0xe0 ) ;
if ( V_168 >= 0 ) {
V_168 = F_16 ( V_4 , 8 ) ;
V_168 |= 0x40 ;
V_168 = F_21 ( V_4 , 8 , V_168 ) ;
if ( V_168 >= 0 ) {
V_168 = F_16 ( V_4 , 12 ) ;
if ( V_168 >= 0 ) {
if ( ( V_168 & 0x08 ) == 0x08 ) {
...
static int F_122 ( struct V_1 * V_4 , int V_28 )
{
...
V_258 , V_259 ) ;
F_6 ( V_4 , V_27 , V_28 ) ;
F_127 ( & V_4 -> V_3 , V_4 -> V_30 , V_27 ,
V_28 , V_4 -> V_31 ,
V_4 -> V_280 ) ;
V_4 -> V_280 = false ;
}
static T_8 F_128 ( int V_281 , void * V_45 )
{
struct V_1 * V_4 = V_45 ;
T_1 V_282 , V_283 ;
int V_50 ;
...
F_2 ( V_4 , V_282 ) ;
if ( V_282 & V_11 )
F_129 ( V_285 , & V_4 -> F_123 ) ;
if ( V_282 & V_12 )
F_130 ( & V_4 -> V_118 . V_126 ) ;
if ( V_282 & V_13 )
F_130 ( & V_4 -> V_286 . V_126 ) ;
if ( V_282 & V_14 )
F_130 ( & V_4 -> V_216 . V_126 ) ;
if ( V_282 & V_15 )
F_130 ( & V_4 -> V_222 . V_126 ) ;
if ( V_282 & V_16 ) {
...
static void F_136 ( V_42 * V_296 , const V_42 * V_297 , T_9 V_94 )
{
T_9 V_298 = V_94 * 4 ;
...
{
struct V_1 * V_4 = V_1 ( V_3 ) ;
struct V_310 * V_311 = F_140 ( V_3 -> V_10 ) ;
...
static void F_149 ( struct V_2 * V_3 , struct V_91 * V_170 )
{
struct V_1 * V_4 = V_1 ( V_3 ) ;
F_108 ( & V_4 -> V_222 , V_170 ) ;
}
static int F_150 ( struct V_2 * V_3 , struct V_91 * V_170 )
{
struct V_1 * V_4 = V_1 ( V_3 ) ;
...
static T_1 F_152 ( struct V_2 * V_3 , int V_351 )
{
struct V_1 * V_4 = V_1 ( V_3 ) ;
unsigned long V_154 ;
T_1 V_352 ;
...
static void F_154 ( struct V_2 * V_3 , int V_351 , T_1 V_352 )
{
struct V_1 * V_4 = V_1 ( V_3 ) ;
unsigned long V_154 ;
switch ( V_351 ) {
...
static void F_155 ( struct V_364 * V_64 )
{
...
static void F_156 ( struct V_364 * V_64 , const T_1 * V_369 )
{
T_1 * V_370 ;
...
V_370 [ 0 ] = F_157 ( V_369 [ 1 ] ) ;
if ( V_64 -> V_365 . V_371 > 4 )
V_370 [ 1 ] = F_157 ( V_369 [ 0 ] ) ;
...
F_159 ( V_143 -> V_4 -> V_3 . V_10 ,
V_374 & V_375 ,
V_374 & ~ V_375 ,
F_48 ( V_68 -> V_134 ) ,
V_80 ) ;
}
F_156 ( V_64 , ( T_1 * ) ( V_85 + 1 ) ) ;
if ( V_85 -> V_135 & F_33 ( V_181 ) )
F_155 ( V_64 ) ;
return 1 ;
}
static int F_160 ( struct V_143 * V_143 ,
struct V_67 * V_68 ,
struct V_67 * V_85 )
{
struct V_364 * V_64 =
...
static void F_161 ( struct V_364 * V_64 )
{
F_159 ( V_64 -> V_143 . V_4 -> V_3 . V_10 ,
V_64 -> V_377 & V_375 ,
V_64 -> V_377 & ~ V_375 ,
V_64 -> V_378 , V_80 ) ;
V_64 -> V_365 . V_153 . V_379 ( & V_64 -> V_365 ,
...
static inline void F_162 ( struct V_143 * V_143 ,
struct V_67 * V_373 )
{
T_3 V_135 ;
T_1 V_374 ;
...
static int F_163 ( struct V_143 * V_143 ,
struct V_67 * V_68 ,
struct V_67 * V_85 )
{
struct V_364 * V_64 =
...
static void F_164 ( struct V_1 * V_4 , T_6 V_380 )
{
...
static struct V_388 * F_166 ( struct V_2 * V_3 ,
...
V_390 = & V_4 -> V_395 ;
V_153 = F_158 ;
V_66 = * V_380 & 1ULL << V_389 ? F_131 ( * V_390 ) - 1 : - 1 ;
if ( V_66 >= 0 ) {
* V_380 &= ~ ( 1ULL << V_389 ) ;
* V_390 &= ~ ( 1 << V_66 ) ;
V_75 = F_113 ( V_66 ) ;
...
V_390 = & V_4 -> V_395 ;
V_153 = F_160 ;
V_66 = ! V_4 -> V_397 ? F_131 ( * V_390 ) - 1 : - 1 ;
if ( V_66 >= 0 ) {
V_4 -> V_397 = true ;
* V_390 &= ~ ( 1 << V_66 ) ;
V_75 = F_113 ( V_66 ) ;
...
static int F_170 ( struct V_388 * V_365 ,
...
F_11 ( V_4 , F_171 ( V_64 -> V_143 . V_75 ) , V_404 ) ;
...
static int F_172 ( struct V_388 * V_365 )
{
...
F_15 ( V_4 ) ;
F_86 ( & V_64 -> V_143 ) ;
F_173 ( & V_64 -> V_143 . V_126 ) ;
return 0 ;
}
static void F_174 ( struct V_388 * V_365 )
{
struct V_1 * V_4 = V_1 ( V_365 -> V_3 ) ;
struct V_364 * V_64 = F_1 ( V_365 , struct V_364 , V_365 ) ;
unsigned long V_154 ;
...
static int F_175 ( struct V_388 * V_365 , T_6 * V_380 )
{
struct V_1 * V_4 = V_1 ( V_365 -> V_3 ) ;
unsigned long V_154 ;
int V_58 ;
...
static void F_176 ( struct V_1 * V_4 )
{
int V_50 ;
struct V_364 * V_64 ;
...
V_64 = & V_4 -> V_288 [ V_50 ] ;
if ( V_64 -> V_143 . V_167 )
F_170 ( & V_64 -> V_365 , 0 , V_64 -> V_401 , V_64 -> V_402 ) ;
}
...
static int F_177 ( struct V_364 * V_64 ,
struct V_416 * V_170 ,
struct V_417 * V_77 ,
unsigned long V_109 )
{
...
if ( V_92 -> V_98 > 0 )
V_141 ++ ;
V_424 = F_178 ( V_421 + V_92 -> V_99 ) >> V_426 ;
if ( V_92 -> V_99 > 0 )
V_420 = V_424 - ( V_421 >> V_426 ) ;
else
V_420 = 0 ;
V_141 += V_420 ;
V_419 = F_179 ( V_92 -> V_98 , sizeof( * V_68 ) ) ;
...
V_35 = ( T_4 * ) & V_68 [ 1 ] ;
V_35 [ 0 ] = F_32 ( F_180 ( V_92 -> V_427 ) |
F_181 ( V_92 -> V_428 ) |
F_182 ( V_177 ) |
F_183 ( V_64 -> V_365 . V_389 ) |
F_184 ( V_64 -> V_365 . V_32 ) ) ;
V_35 [ 1 ] =
F_32 ( F_185 ( V_92 -> V_98 +
V_92 -> V_99 ) ) ;
}
if ( V_92 -> V_98 > 0 ) {
...
static int F_188 ( struct V_364 * V_64 ,
struct V_416 * V_170 ,
struct V_417 * V_77 ,
unsigned long V_109 )
{
...
V_371 = F_189 ( V_64 -> V_365 . V_371 , ( T_9 ) 8 ) ;
V_419 = F_179 ( V_371 , sizeof( * V_68 ) ) ;
V_60 = V_109 >> V_426 ;
V_44 = V_109 & ~ V_375 ;
V_433 = V_170 -> V_99 / V_432 ;
for ( V_50 = 0 ; V_50 < V_432 ; V_50 ++ ) {
V_141 = F_179 ( V_433 + V_44 , V_72 ) + 1 ;
...
static int F_190 ( struct V_364 * V_64 ,
struct V_416 * V_170 ,
struct V_417 * V_77 ,
unsigned long V_109 )
{
...
V_44 = V_109 & ~ V_375 ;
V_431 = V_170 -> V_99 ;
V_141 = F_179 ( V_44 + V_431 , V_72 ) ;
if ( F_153 ( V_44 & 3 || V_431 & 3 || V_60 + V_141 > V_77 -> V_436 ) )
return - V_437 ;
...
static int F_191 ( struct V_388 * V_365 ,
struct V_416 * V_170 ,
struct V_417 * V_77 ,
unsigned long V_109 )
{
...
switch ( V_365 -> type ) {
case V_391 :
V_58 = F_177 ( V_64 , V_170 , V_77 , V_109 ) ;
break;
case V_393 :
V_58 = F_188 ( V_64 , V_170 , V_77 , V_109 ) ;
break;
case V_396 :
V_58 = F_190 ( V_64 , V_170 , V_77 , V_109 ) ;
break;
}
F_74 ( & V_64 -> V_143 . V_4 -> V_155 , V_154 ) ;
return V_58 ;
}
static void F_192 ( struct V_388 * V_365 )
{
struct V_143 * V_64 =
& F_1 ( V_365 , struct V_364 , V_365 ) -> V_143 ;
F_11 ( V_64 -> V_4 , F_35 ( V_64 -> V_75 ) , V_76 ) ;
}
static int F_193 ( struct V_388 * V_365 )
{
struct V_364 * V_64 = F_1 ( V_365 , struct V_364 , V_365 ) ;
int V_58 = 0 ;
F_95 ( & V_64 -> V_143 . V_126 ) ;
if ( ! F_194 ( 0 , & V_64 -> V_438 ) ) {
...
static void F_197 ( struct V_310 * V_311 )
{
if ( F_198 ( V_439 ) ) {
struct V_440 * V_441 = F_199 ( V_311 ) ;
if ( V_441 ) {
F_200 ( V_442 , V_441 , 0 , 1 ) ;
F_200 ( V_443 , V_441 , 0 , 1 ) ;
}
}
}
static void F_201 ( struct V_310 * V_311 )
{
if ( F_198 ( V_439 ) ) {
struct V_440 * V_441 = F_199 ( V_311 ) ;
if ( V_441 ) {
F_200 ( V_443 , V_441 , 0 , 0 ) ;
F_200 ( V_442 , V_441 , 0 , 0 ) ;
}
}
}
static inline void F_197 ( struct V_310 * V_311 ) {}
static inline void F_201 ( struct V_310 * V_311 ) {}
static int F_202 ( struct V_310 * V_311 ,
...
V_4 = F_203 ( sizeof( * V_4 ) , V_127 ) ;
if ( V_4 == NULL ) {
V_450 = - V_140 ;
goto V_453;
}
F_204 ( & V_4 -> V_3 , & V_454 , & V_311 -> V_311 ) ;
F_197 ( V_311 ) ;
V_450 = F_205 ( V_311 ) ;
if ( V_450 ) {
...
F_209 ( & V_4 -> V_155 ) ;
F_210 ( & V_4 -> V_62 ) ;
F_211 ( & V_4 -> F_123 , F_123 ) ;
if ( ! ( F_212 ( V_311 , 0 ) & V_457 ) ||
F_213 ( V_311 , 0 ) < V_458 ) {
F_20 ( & V_311 -> V_311 , L_66 ) ;
V_450 = - V_459 ;
goto V_460;
}
V_450 = F_214 ( V_311 , 0 , V_341 ) ;
if ( V_450 ) {
F_20 ( & V_311 -> V_311 , L_67 ) ;
goto V_460;
}
V_4 -> V_46 = F_215 ( V_311 , 0 , V_458 ) ;
if ( V_4 -> V_46 == NULL ) {
...
F_11 ( V_4 , V_412 , ~ 0 ) ;
V_4 -> V_395 = V_4 -> V_231 ;
V_4 -> V_414 = F_216 ( V_4 -> V_395 ) ;
V_298 = sizeof( struct V_364 ) * V_4 -> V_414 ;
V_4 -> V_288 = F_203 ( V_298 , V_127 ) ;
F_11 ( V_4 , V_407 , ~ 0 ) ;
V_4 -> V_230 = F_13 ( V_4 , V_407 ) ;
F_11 ( V_4 , V_411 , ~ 0 ) ;
V_4 -> V_392 = V_4 -> V_230 ;
V_4 -> V_415 = F_216 ( V_4 -> V_392 ) ;
V_298 = sizeof( struct V_364 ) * V_4 -> V_415 ;
V_4 -> V_290 = F_203 ( V_298 , V_127 ) ;
...
F_13 ( V_4 , V_478 ) ;
V_450 = F_217 ( & V_4 -> V_3 , V_447 , V_448 , V_449 ) ;
if ( V_450 )
goto V_476;
V_313 = F_13 ( V_4 , V_47 ) & 0x00ff00ff ;
F_4 ( & V_311 -> V_311 ,
...
static void F_222 ( struct V_310 * V_311 )
{
struct V_1 * V_4 ;
V_4 = F_223 ( V_311 ) ;
F_11 ( V_4 , V_334 , ~ 0 ) ;
...
static int F_227 ( struct V_310 * V_311 , T_11 V_479 )
{
struct V_1 * V_4 = F_223 ( V_311 ) ;
int V_450 ;
F_135 ( V_4 ) ;
F_226 ( V_311 -> V_281 , V_4 ) ;
F_145 ( V_311 ) ;
...
V_450 = F_229 ( V_311 , F_230 ( V_311 , V_479 ) ) ;
if ( V_450 )
F_20 ( & V_311 -> V_311 , L_74 , V_450 ) ;
F_201 ( V_311 ) ;
return 0 ;
}
static int F_231 ( struct V_310 * V_311 )
{
struct V_1 * V_4 = F_223 ( V_311 ) ;
int V_450 ;
F_197 ( V_311 ) ;
