...
T_3 V_97 = F_69 ( T_3 , V_29 , V_26 -> V_43 ) ;
unsigned int V_98 ;
...
return ( ( V_96 - V_20 -> V_44 . V_100 - F_23 ( V_26 -> V_2 ) -
V_98 ) & ~ ( V_97 - 1 ) ) + ( V_98 - 2 ) ;
}
...
V_2 = V_26 -> V_2 ;
V_26 -> V_43 = 0 ;
V_20 -> V_44 . V_100 = sizeof( struct V_21 ) +
F_2 ( V_2 ) ;
if ( V_20 -> V_44 . V_88 == V_92 )
V_20 -> V_44 . V_100 += sizeof( struct V_77 ) ;
else if ( V_20 -> V_44 . V_88 == V_99 && V_20 -> V_141 . V_142 != V_143 )
V_20 -> V_44 . V_100 += V_144 ;
if ( V_20 -> V_49 ) {
struct V_50 * V_49 = V_20 -> V_49 ;
switch ( V_49 -> V_56 ) {
default:
goto error;
case V_63 :
V_20 -> V_44 . V_100 += sizeof( struct V_51 ) ;
break;
case V_64 :
V_20 -> V_44 . V_100 += sizeof( struct V_51 ) + 2 * sizeof( T_3 ) ;
break;
}
}
V_97 = F_5 ( F_27 ( V_2 ) , 4 ) ;
if ( V_26 -> V_43 )
V_97 = F_69 ( T_3 , V_97 , V_26 -> V_43 ) ;
V_20 -> V_44 . V_145 = V_97 + 1 + F_23 ( V_26 -> V_2 ) ;
error:
return V_15 ;
}
