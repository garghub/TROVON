...
static void F_100 ( struct V_28 * V_62 )
{
struct V_70 * V_7 ;
int V_85 ;
for ( V_85 = V_16 ; V_85 < V_172 ; V_85 ++ ) {
...
static int F_101 ( struct V_28 * V_62 ,
enum V_98 V_7 )
{
int V_316 ;
F_22 ( & V_62 -> V_203 ) ;
...
static int F_104 ( struct V_28 * V_62 )
{
struct V_50 * V_51 = NULL ;
struct V_322 * V_323 ;
struct V_292 V_324 ;
...
if ( ( F_75 ( V_323 -> V_326 . V_161 ) != V_327 ) ||
...
V_62 -> V_331 = F_75 ( V_323 -> V_326 . V_330 ) ;
V_62 -> V_100 = F_75 ( V_323 -> V_326 . V_109 ) ;
F_2 ( V_318 ,
L_72 ,
...
V_324 . V_148 . V_189 = F_78 ;
V_324 . V_148 . V_204 = NULL ;
V_324 . V_148 . V_151 = NULL ;
V_324 . V_150 = V_335 ;
V_324 . V_19 = V_128 ;
V_72 = F_98 ( ( void * ) V_62 , & V_324 , & V_325 ) ;
if ( V_72 )
F_105 ( V_62 -> V_88 -> V_89 ) ;
V_329:
if ( V_51 ) {
F_69 ( V_51 ) ;
F_70 ( V_62 , V_51 ) ;
...
if ( V_72 )
return V_72 ;
V_72 = F_108 ( V_62 -> V_88 ) ;
if ( V_72 )
F_109 ( V_62 ) ;
return V_72 ;
}
static int F_110 ( struct V_28 * V_62 )
{
T_3 V_337 , V_338 ;
struct V_50 * V_51 ;
int V_85 ;
...
V_51 = F_111 ( sizeof( * V_51 ) , V_339 ) ;
if ( ! V_51 )
return - V_156 ;
V_51 -> V_69 = F_111 ( V_338 , V_339 ) ;
if ( ! V_51 -> V_69 ) {
F_96 ( V_51 ) ;
return - V_156 ;
}
...
static void F_109 ( struct V_28 * V_62 )
{
F_22 ( & V_62 -> V_64 ) ;
V_62 -> V_173 |= V_174 ;
F_24 ( & V_62 -> V_64 ) ;
...
static void * F_113 ( struct V_341 * V_89 )
{
struct V_28 * V_62 = NULL ;
int V_72 = 0 ;
V_62 = F_111 ( sizeof( * V_62 ) , V_339 ) ;
if ( ! V_62 ) {
F_30 ( L_76 ) ;
return NULL ;
}
V_62 -> V_88 = F_111 ( sizeof( * V_62 -> V_88 ) , V_339 ) ;
if ( ! V_62 -> V_88 ) {
F_30 ( L_76 ) ;
V_72 = - V_156 ;
goto V_342;
...
static void F_116 ( struct V_28 * V_62 )
{
