...
struct V_115 * V_129 ;
T_2 V_130 ;
V_129 = F_103 ( V_2 -> V_5 -> V_117 , L_47 ) ;
if ( ! V_129 ) {
F_13 ( V_2 -> V_5 , L_48 ) ;
return - V_131 ;
}
...
{
T_2 V_65 ;
V_65 = F_106 ( V_2 -> V_133 ) ;
V_65 |= V_2 -> V_132 ;
F_107 ( V_65 , V_2 -> V_133 ) ;
}
...
struct V_113 * V_139 ;
int V_111 = 0 ;
V_2 = F_98 ( & V_136 -> V_5 , sizeof( struct V_1 ) ,
V_120 ) ;
if ( ! V_2 ) {
F_13 ( & V_136 -> V_5 , L_54 ) ;
return - V_121 ;
...
V_139 = V_136 -> V_5 . V_140 ;
if ( ! V_139 ) {
F_13 ( & V_136 -> V_5 , L_55 ) ;
return - V_59 ;
}
}
V_2 -> clock = F_112 ( & V_136 -> V_5 , L_56 ) ;
if ( F_110 ( V_2 -> clock ) ) {
F_13 ( & V_136 -> V_5 , L_57 ) ;
return F_111 ( V_2 -> clock ) ;
}
F_113 ( V_2 -> clock ) ;
V_138 = F_114 ( V_136 , V_141 , 0 ) ;
V_2 -> V_142 = F_115 ( & V_136 -> V_5 , V_138 ) ;
if ( ! V_2 -> V_142 ) {
F_13 ( & V_136 -> V_5 , L_58 ) ;
return - V_121 ;
}
V_2 -> V_100 = F_116 ( V_136 , 0 ) ;
if ( V_2 -> V_100 == - V_143 ) {
F_13 ( & V_136 -> V_5 , L_59 ) ;
return - V_131 ;
}
F_117 ( & V_2 -> V_105 , F_94 ) ;
V_2 -> V_112 = V_139 -> V_112 ;
if ( V_136 -> V_5 . V_117 ) {
if ( V_2 -> V_133 )
F_105 ( V_2 ) ;
} else {
...
F_1 ( V_2 ) ;
V_111 = F_118 ( & V_136 -> V_5 , V_2 -> V_100 , F_90 , 0 ,
L_60 , V_2 ) ;
if ( V_111 ) {
F_13 ( & V_136 -> V_5 , L_61 ) ;
return V_111 ;
...
static int F_120 ( struct V_135 * V_136 )
{
struct V_113 * V_139 = V_136 -> V_5 . V_140 ;
struct V_1 * V_2 = F_121 ( V_136 ) ;
F_122 ( V_2 -> V_100 ) ;
if ( F_123 ( & V_2 -> V_105 ) )
F_124 ( & V_2 -> V_105 ) ;
if ( V_136 -> V_5 . V_117 ) {
...
static int F_128 ( struct V_114 * V_5 )
{
struct V_113 * V_139 = V_5 -> V_140 ;
struct V_1 * V_2 = F_127 ( V_5 ) ;
if ( V_5 -> V_117 ) {
