...
{
struct V_183 * V_184 ;
V_184 = F_35 ( sizeof( * V_184 ) , V_67 ) ;
if ( F_8 ( V_184 == NULL ) )
return - V_68 ;
F_45 ( V_184 ) ;
F_46 ( & V_184 -> V_109 , true , V_110 ) ;
V_188 -> V_152 = V_184 ;
return 0 ;
}
...
struct V_18 * V_19 = F_78 ( V_62 ) ;
struct V_146 * V_147 = V_146 ( V_145 ) ;
struct V_183 * V_190 = V_19 -> V_111 ;
struct V_183 * V_184 = V_183 ( V_145 -> V_188 ) ;
int V_24 = 0 ;
if ( ! V_19 -> V_87 ) {
V_24 = F_26 ( V_19 , true ) ;
if ( F_8 ( V_24 != 0 ) )
...
if ( V_190 ) {
F_24 ( V_190 != & V_19 -> V_108 ) ;
V_24 = F_101 ( & V_190 -> V_109 , false , V_147 -> V_149 ) ;
if ( F_8 ( V_24 != 0 ) )
goto V_192;
F_46 ( & V_190 -> V_109 , true , V_110 ) ;
V_24 = F_102 ( & V_19 -> V_26 , V_118 ) ;
if ( F_8 ( V_24 != 0 ) ) {
F_14 ( L_42
L_43 ) ;
}
...
F_46 ( & V_184 -> V_109 , false , V_110 ) ;
if ( ! V_189 ) {
F_103 ( & V_184 -> V_109 ) ;
F_24 ( V_147 -> V_150 != V_145 -> V_188 ) ;
F_87 ( & V_147 -> V_150 ) ;
}
V_19 -> V_111 = V_184 ;
return 0 ;
...
struct V_183 * V_184 = V_183 ( V_145 -> V_188 ) ;
int V_24 ;
V_147 -> V_150 = F_105 ( V_145 -> V_188 ) ;
V_24 = F_101 ( & V_184 -> V_109 , false , V_147 -> V_149 ) ;
F_106 ( V_19 ) ;
if ( F_8 ( ( V_24 != 0 ) ) ) {
F_14 ( L_44 ) ;
F_87 ( & V_147 -> V_150 ) ;
...
V_19 -> V_111 = & V_19 -> V_108 ;
F_46 ( & V_19 -> V_108 . V_109 , false , V_110 ) ;
F_103 ( & V_19 -> V_108 . V_109 ) ;
if ( V_19 -> V_87 )
F_107 ( V_19 ) ;
}
static void F_108 ( struct V_194 * V_69 )
{
struct V_61 * V_62 = F_109 ( V_69 ) ;
F_110 ( V_62 ) ;
}
static int V_139 ( struct V_195 * V_196 , unsigned long V_197 ,
void * V_198 )
{
struct V_18 * V_19 =
F_111 ( V_196 , struct V_18 , V_137 ) ;
struct V_183 * V_184 = V_19 -> V_111 ;
switch ( V_197 ) {
case V_199 :
case V_200 :
F_112 ( & V_184 -> V_109 ) ;
...
static int F_116 ( struct V_194 * V_69 , T_4 V_33 )
{
struct V_61 * V_62 = F_109 ( V_69 ) ;
struct V_18 * V_19 = F_78 ( V_62 ) ;
if ( V_19 -> V_45 != 0 ) {
...
static int F_120 ( struct V_194 * V_69 )
{
F_119 ( V_69 , V_207 ) ;
F_121 ( V_69 ) ;
return F_122 ( V_69 ) ;
...
static void F_127 ( struct V_208 * V_209 )
{
struct V_194 * V_69 = F_124 ( V_209 ) ;
struct V_61 * V_62 = F_109 ( V_69 ) ;
struct V_18 * V_19 = F_78 ( V_62 ) ;
...
static int F_128 ( struct V_194 * V_69 , const struct V_213 * V_214 )
{
return F_129 ( V_69 , V_214 , & V_163 ) ;
}
static int T_5 F_130 ( void )
{
int V_24 ;
V_24 = F_131 ( & V_163 , & V_215 ) ;
if ( V_24 )
F_14 ( L_48 ) ;
return V_24 ;
}
