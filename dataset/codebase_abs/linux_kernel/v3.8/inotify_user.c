...
int V_18 ;
do {
if ( F_42 ( ! F_43 ( V_71 , V_76 ) ) )
return - V_77 ;
F_15 ( V_72 ) ;
V_18 = F_44 ( V_71 , V_75 , * V_73 + 1 ,
& V_75 -> V_37 ) ;
if ( ! V_18 ) {
* V_73 = V_75 -> V_37 ;
F_45 ( & V_75 -> V_78 ) ;
...
F_27 ( V_86 ) ;
F_55 ( V_16 , V_75 ) ;
F_64 ( & V_16 -> V_79 . V_94 -> V_95 ) ;
}
static void F_65 ( struct V_80 * V_78 )
{
struct V_74 * V_75 ;
V_75 = F_18 ( V_78 , struct V_74 , V_78 ) ;
F_66 ( V_96 , V_75 ) ;
...
if ( F_42 ( ! ( V_2 & V_6 ) ) )
return - V_30 ;
V_105 = F_61 ( V_96 , V_76 ) ;
if ( F_42 ( ! V_105 ) )
return - V_77 ;
F_72 ( & V_105 -> V_78 , F_65 ) ;
V_105 -> V_78 . V_2 = V_2 ;
V_105 -> V_37 = - 1 ;
V_18 = - V_106 ;
if ( F_50 ( & V_16 -> V_79 . V_94 -> V_95 ) >= V_107 )
goto V_108;
V_18 = F_41 ( V_71 , V_72 , & V_16 -> V_79 . V_73 ,
V_105 ) ;
if ( V_18 )
goto V_108;
V_18 = F_73 ( & V_105 -> V_78 , V_16 , V_54 , NULL , 0 ) ;
if ( V_18 ) {
F_55 ( V_16 , V_105 ) ;
goto V_108;
}
F_74 ( & V_16 -> V_79 . V_94 -> V_95 ) ;
V_18 = V_105 -> V_37 ;
V_108:
F_54 ( & V_105 -> V_78 ) ;
return V_18 ;
...
static struct V_15 * F_76 ( unsigned int V_111 )
{
struct V_15 * V_16 ;
V_16 = F_77 ( & V_112 ) ;
if ( F_26 ( V_16 ) )
...
F_83 ( V_7 != V_143 ) ;
F_49 ( F_84 ( V_144 ) != 21 ) ;
V_96 = F_85 ( V_74 , V_145 ) ;
V_93 = F_85 ( V_34 , V_145 ) ;
V_146 = 16384 ;
V_114 = 128 ;
V_107 = 8192 ;
return 0 ;
