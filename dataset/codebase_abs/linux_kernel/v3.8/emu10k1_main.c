...
unsigned int V_140 ;
unsigned long V_141 ;
const struct V_142 * V_143 = V_2 -> V_142 ;
if ( ! V_143 )
return - V_144 ;
F_25 ( & V_2 -> V_145 , V_141 ) ;
F_4 ( 0x00 , V_2 -> V_41 + V_74 ) ;
V_140 = F_8 ( V_2 -> V_41 + V_74 ) ;
F_12 ( 100 ) ;
F_4 ( 0x80 , V_2 -> V_41 + V_74 ) ;
V_140 = F_8 ( V_2 -> V_41 + V_74 ) ;
F_12 ( 100 ) ;
for ( V_77 = 0 ; V_77 < V_143 -> V_76 ; V_77 ++ ) {
V_114 = V_143 -> V_116 [ V_77 ] ;
...
V_147 = F_35 ( & V_2 -> V_142 , V_161 , & V_2 -> V_170 -> V_171 ) ;
if ( V_147 != 0 ) {
F_7 ( V_172 L_14 , V_161 , V_147 ) ;
return V_147 ;
}
F_7 ( V_73 L_15 ,
V_161 , V_2 -> V_142 -> V_76 ) ;
}
F_31 ( V_2 , V_154 , & V_101 ) ;
if ( ( V_101 & 0x3f ) != 0x15 ) {
F_7 ( V_73 L_16 , V_101 ) ;
...
F_7 ( V_73 L_17 ) ;
F_31 ( V_2 , V_173 , & V_37 ) ;
F_31 ( V_2 , V_174 , & V_146 ) ;
F_7 ( V_73 L_18 , V_37 , V_146 ) ;
F_32 ( V_2 , V_159 , V_175 ) ;
F_31 ( V_2 , V_150 , & V_101 ) ;
F_7 ( V_73 L_19 , V_101 ) ;
F_31 ( V_2 , V_150 , & V_101 ) ;
F_7 ( V_73 L_19 , V_101 ) ;
...
#endif
for ( V_139 = 0 ; V_139 < 0x20 ; V_139 ++ ) {
F_36 ( V_2 , 0x0100 + V_139 , V_218 ) ;
}
for ( V_139 = 0 ; V_139 < 4 ; V_139 ++ ) {
F_36 ( V_2 , 0x0200 + V_139 , V_218 ) ;
}
for ( V_139 = 0 ; V_139 < 7 ; V_139 ++ ) {
F_36 ( V_2 , 0x0300 + V_139 , V_218 ) ;
}
for ( V_139 = 0 ; V_139 < 7 ; V_139 ++ ) {
F_36 ( V_2 , V_219 + V_139 , V_218 ) ;
}
F_36 ( V_2 ,
V_220 , V_203 ) ;
F_36 ( V_2 ,
...
V_2 -> V_288 = NULL ;
V_2 -> V_95 = V_170 -> V_95 ;
F_61 ( V_170 , V_289 , & V_2 -> V_290 ) ;
F_62 ( V_170 , V_291 , & V_2 -> V_100 ) ;
F_34 ( L_22 , V_170 -> V_292 , V_170 -> V_258 , V_2 -> V_290 , V_2 -> V_100 ) ;
for ( V_271 = V_293 ; V_271 -> V_292 ; V_271 ++ ) {
if ( V_271 -> V_292 == V_170 -> V_292 && V_271 -> V_258 == V_170 -> V_258 ) {
if ( V_266 ) {
...
F_34 ( L_24 , V_271 -> V_295 ) ;
else if ( V_266 )
F_34 ( L_25
L_26
L_27 , V_271 -> V_295 ,
V_170 -> V_292 , V_170 -> V_258 , V_2 -> V_290 , V_271 -> V_266 ) ;
else
F_34 ( L_25
L_28 ,
V_271 -> V_295 , V_170 -> V_292 , V_170 -> V_258 ,
V_2 -> V_290 ) ;
if ( ! * V_261 -> V_296 && V_271 -> V_296 ) {
int V_139 , V_77 = 0 ;
F_63 ( V_261 -> V_296 , V_271 -> V_296 , sizeof( V_261 -> V_296 ) ) ;
for (; ; ) {
for ( V_139 = 0 ; V_139 < V_297 ; V_139 ++ ) {
if ( V_298 [ V_139 ] && ! strcmp ( V_298 [ V_139 ] -> V_296 , V_261 -> V_296 ) )
break;
}
if ( V_139 >= V_297 )
break;
...
if ( V_77 >= V_299 )
break;
snprintf ( V_261 -> V_296 , sizeof( V_261 -> V_296 ) , L_29 , V_271 -> V_296 , V_77 ) ;
}
}
V_269 = V_2 -> V_30 = V_271 -> V_300 ;
V_2 -> V_301 = V_269 ? V_302 : V_303 ;
if ( F_64 ( V_170 , V_2 -> V_301 ) < 0 ||
F_65 ( V_170 , V_2 -> V_301 ) < 0 ) {
F_7 ( V_172 L_30 , V_2 -> V_301 ) ;
F_53 ( V_2 ) ;
F_52 ( V_170 ) ;
return - V_304 ;
}
...
V_2 -> V_305 = V_307 ;
V_147 = F_66 ( V_170 , L_31 ) ;
if ( V_147 < 0 ) {
F_53 ( V_2 ) ;
F_52 ( V_170 ) ;
return V_147 ;
}
V_2 -> V_41 = F_67 ( V_170 , 0 ) ;
V_2 -> V_308 = V_265 >> V_309 ;
if ( F_68 ( V_310 , F_69 ( V_170 ) ,
32 * 1024 , & V_2 -> V_84 ) < 0 ) {
V_147 = - V_276 ;
goto error;
}
...
if ( F_73 ( V_170 -> V_250 , V_323 , V_324 ,
V_325 , V_2 ) ) {
V_147 = - V_326 ;
goto error;
}
V_2 -> V_250 = V_170 -> V_250 ;
...
goto error;
F_13 ( V_2 ) ;
V_147 = F_78 ( V_261 , V_338 , V_2 , & V_273 ) ;
if ( V_147 < 0 )
goto error;
#ifdef F_79
F_80 ( V_2 ) ;
#endif
F_81 ( V_261 , & V_170 -> V_171 ) ;
* V_267 = V_2 ;
return 0 ;
error:
F_39 ( V_2 ) ;
...
for ( V_139 = 0 ; V_139 < V_60 ; V_139 ++ , V_342 ++ )
* V_342 = F_5 ( V_2 , * V_101 , V_139 ) ;
if ( V_2 -> V_30 ) {
