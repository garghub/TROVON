...
case V_20 :
V_11 = V_69 -> V_73 -> V_11 ;
V_58 = F_22 ( V_2 -> V_27 -> V_74 , V_11 , V_9 ,
V_70 ) ;
if ( V_58 )
return V_58 ;
V_2 -> V_4 = V_69 -> V_73 ;
...
static int F_23 ( struct V_1 * V_2 , enum V_18 V_19 )
{
struct V_68 * V_69 = V_2 -> V_27 -> V_69 ;
T_1 V_24 [] = { V_25 , V_26 } ;
T_1 V_23 [] = { V_77 , V_78 } ;
T_1 V_79 [] = { V_80 , V_81 } ;
if ( V_19 == V_82 || V_19 == V_83 )
return 0 ;
if ( ! V_69 )
goto V_84;
...
{
struct V_87 * V_27 = F_25 ( V_86 -> V_74 . V_88 ) ;
int V_19 = V_86 -> V_19 ;
struct V_1 * V_2 ;
struct V_89 V_90 = { } ;
struct V_53 * V_54 ;
int V_58 ;
V_2 = F_26 ( V_27 -> V_74 , sizeof( struct V_1 ) , V_91 ) ;
if ( ! V_2 )
return - V_92 ;
V_2 -> V_27 = V_27 ;
V_58 = F_23 ( V_2 , V_19 ) ;
...
return V_58 ;
V_90 . V_74 = V_27 -> V_74 ;
V_90 . V_93 = V_27 -> V_69 ? V_27 -> V_69 -> V_94 [ V_19 ] : NULL ;
V_90 . V_95 = V_2 ;
V_90 . V_96 = V_27 -> V_96 ;
V_54 = F_27 ( & V_97 [ V_19 ] , & V_90 ) ;
if ( F_28 ( V_54 ) ) {
V_58 = F_29 ( V_54 ) ;
F_30 ( V_27 -> V_74 , L_4 ,
V_19 + 1 , V_58 ) ;
