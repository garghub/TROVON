...
V_89 = F_58 ( V_100 ) ;
if ( V_89 ) {
F_8 ( L_19 , V_100 -> V_140 , V_89 ) ;
F_59 ( & V_3 . V_103 ) ;
F_56 ( V_100 ) ;
return;
}
}
static void T_2 F_60 ( struct V_127 * V_90 )
{
...
static void T_3 F_62 ( struct V_127 * V_90 )
{
struct V_112 * V_113 = & V_3 . V_103 ;
F_63 ( V_113 ) ;
}
static int T_2 F_64 ( struct V_127 * V_90 )
{
T_4 V_147 ;
struct V_148 * V_149 ;
int V_89 ;
...
F_65 ( & V_3 . V_114 ) ;
V_3 . V_30 = 0 ;
V_149 = F_66 ( V_3 . V_90 , V_150 , 0 ) ;
if ( ! V_149 ) {
F_8 ( L_20 ) ;
return - V_118 ;
}
V_3 . V_4 = F_67 ( & V_90 -> V_91 , V_149 -> V_151 ,
F_68 ( V_149 ) ) ;
if ( ! V_3 . V_4 ) {
F_8 ( L_21 ) ;
return - V_152 ;
...
static int T_3 F_74 ( struct V_127 * V_90 )
{
F_75 ( & V_90 -> V_91 ) ;
if ( V_3 . V_109 != NULL ) {
F_76 ( V_3 . V_109 ) ;
...
static int F_78 ( struct V_156 * V_91 )
{
if ( V_3 . V_130 )
F_79 ( V_3 . V_130 ) ;
F_80 () ;
...
static int F_81 ( struct V_156 * V_91 )
{
int V_89 ;
V_89 = F_82 () ;
if ( V_89 < 0 )
