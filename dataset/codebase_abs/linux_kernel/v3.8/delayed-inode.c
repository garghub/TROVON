...
F_92 ( V_95 , NULL , 0 ) ;
F_93 ( V_77 , V_8 , V_95 , V_103 , V_104 ,
V_98 , V_99 , V_107 ) ;
V_106 = V_95 -> V_111 [ 0 ] ;
F_94 (curr, next, &head, tree_list) {
V_102 = F_95 ( V_101 , V_106 , char ) ;
F_96 ( V_101 , & V_96 -> V_112 ,
( unsigned long ) V_102 ,
V_96 -> V_53 ) ;
V_106 ++ ;
F_81 ( V_8 , V_96 ) ;
...
char * V_113 ;
int V_39 ;
V_39 = F_99 ( V_77 , V_8 , V_95 , & V_61 -> V_26 ,
V_61 -> V_53 ) ;
if ( V_39 < 0 && V_39 != - V_43 )
return V_39 ;
V_101 = V_95 -> V_48 [ 0 ] ;
V_54 = F_100 ( V_101 , V_95 -> V_111 [ 0 ] ) ;
V_113 = F_95 ( V_101 , V_95 -> V_111 [ 0 ] , char ) ;
F_96 ( V_101 , V_61 -> V_112 , ( unsigned long ) V_113 ,
V_61 -> V_53 ) ;
F_101 ( V_101 ) ;
F_81 ( V_8 , V_61 ) ;
return 0 ;
...
if ( ! V_107 )
return 0 ;
V_39 = F_107 ( V_77 , V_8 , V_95 , V_95 -> V_111 [ 0 ] , V_107 ) ;
if ( V_39 )
goto V_51;
F_94 (curr, next, &head, tree_list) {
F_81 ( V_8 , V_96 ) ;
...
if ( ! V_96 )
goto V_118;
V_39 = F_109 ( V_77 , V_8 , & V_96 -> V_26 , V_95 , - 1 , 1 ) ;
if ( V_39 < 0 )
goto V_118;
else if ( V_39 > 0 ) {
V_58 = V_96 ;
...
F_112 ( & V_26 , V_120 ) ;
V_26 . V_29 = 0 ;
V_39 = F_113 ( V_77 , V_8 , V_95 , & V_26 , 1 ) ;
if ( V_39 > 0 ) {
F_103 ( V_95 ) ;
F_40 ( & V_36 -> V_17 ) ;
return - V_117 ;
...
F_114 ( V_95 , 1 ) ;
V_101 = V_95 -> V_48 [ 0 ] ;
V_22 = F_95 ( V_101 , V_95 -> V_111 [ 0 ] ,
struct V_119 ) ;
F_96 ( V_101 , & V_36 -> V_22 , ( unsigned long ) V_22 ,
sizeof( struct V_119 ) ) ;
F_101 ( V_101 ) ;
F_103 ( V_95 ) ;
F_87 ( V_8 , V_36 ) ;
...
{
struct V_7 * V_122 = V_8 ;
struct V_30 * V_32 ;
struct V_2 * V_123 , * V_60 ;
struct V_94 * V_95 ;
struct V_78 * V_82 ;
int V_39 = 0 ;
bool V_11 = ( V_121 > 0 ) ;
...
V_32 = F_10 ( V_8 ) ;
V_123 = F_34 ( V_32 ) ;
while ( V_123 && ( ! V_11 || ( V_11 && V_121 -- ) ) ) {
V_122 = V_123 -> V_8 ;
V_39 = F_102 ( V_77 , V_95 , V_122 ,
V_123 ) ;
if ( ! V_39 )
V_39 = F_108 ( V_77 , V_95 ,
V_122 , V_123 ) ;
if ( ! V_39 )
V_39 = F_111 ( V_77 , V_122 ,
V_95 , V_123 ) ;
if ( V_39 ) {
F_44 ( V_123 ) ;
V_123 = NULL ;
...
V_39 = F_102 ( V_77 , V_95 , V_36 -> V_8 , V_36 ) ;
if ( ! V_39 )
V_39 = F_108 ( V_77 , V_95 , V_36 -> V_8 , V_36 ) ;
if ( ! V_39 )
...
int V_131 = 0 ;
int V_39 ;
V_130 = F_125 ( V_128 , struct V_129 , V_128 ) ;
V_95 = F_116 () ;
if ( ! V_95 )
goto V_51;
V_95 -> V_126 = 1 ;
...
V_82 = V_77 -> V_82 ;
V_77 -> V_82 = & V_8 -> V_31 -> V_83 ;
V_39 = F_102 ( V_77 , V_95 , V_8 , V_6 ) ;
if ( ! V_39 )
V_39 = F_108 ( V_77 , V_95 , V_8 ,
V_6 ) ;
if ( ! V_39 )
F_111 ( V_77 , V_8 , V_95 , V_6 ) ;
F_39 ( & V_6 -> V_17 ) ;
if ( V_6 -> V_11 )
V_131 = 1 ;
else
...
return 0 ;
F_94 (curr, next, del_list, readdir_list) {
if ( V_96 -> V_26 . V_29 > V_144 )
break;
F_97 ( & V_96 -> V_156 ) ;
V_39 = ( V_96 -> V_26 . V_29 == V_144 ) ;
if ( F_41 ( & V_96 -> V_10 ) )
F_70 ( V_96 ) ;
if ( V_39 )
return 1 ;
...
F_94 (curr, next, ins_list, readdir_list) {
F_97 ( & V_96 -> V_156 ) ;
if ( V_96 -> V_26 . V_29 < V_158 -> V_164 ) {
if ( F_41 ( & V_96 -> V_10 ) )
F_70 ( V_96 ) ;
continue;
}
V_158 -> V_164 = V_96 -> V_26 . V_29 ;
V_161 = (struct V_145 * ) V_96 -> V_112 ;
V_139 = ( char * ) ( V_161 + 1 ) ;
V_140 = F_149 ( V_161 -> V_140 ) ;
V_163 = V_165 [ V_161 -> type ] ;
F_150 ( & V_148 , & V_161 -> V_148 ) ;
V_162 = V_160 ( V_159 , V_139 , V_140 , V_96 -> V_26 . V_29 ,
V_148 . V_28 , V_163 ) ;
if ( F_41 ( & V_96 -> V_10 ) )
F_70 ( V_96 ) ;
if ( V_162 )
...
for ( V_108 = 0 ; V_108 < V_184 ; V_108 ++ )
F_15 ( & V_183 [ V_108 ] -> V_10 ) ;
F_19 ( & V_8 -> V_37 ) ;
for ( V_108 = 0 ; V_108 < V_184 ; V_108 ++ ) {
F_191 ( V_183 [ V_108 ] ) ;
F_44 ( V_183 [ V_108 ] ) ;
