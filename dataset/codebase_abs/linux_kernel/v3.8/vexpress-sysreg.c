...
void T_3 F_36 ( struct V_19 * V_20 )
{
if ( F_13 ( ! V_2 ) )
return;
...
void T_3 F_39 ( void )
{
struct V_19 * V_20 = F_40 ( NULL , NULL ,
L_10 ) ;
if ( V_20 ) {
V_2 = F_41 ( V_20 , 0 ) ;
F_36 ( V_20 ) ;
...
unsigned V_47 )
{
struct V_77 * V_78 = & V_79 [ V_47 ] ;
T_1 V_80 = F_4 ( V_2 + V_78 -> V_81 ) ;
return ! ! ( V_80 & V_78 -> V_76 ) ;
}
...
V_80 &= ~ V_78 -> V_76 ;
F_2 ( V_80 , V_2 + V_78 -> V_81 ) ;
}
static T_4 F_47 ( struct V_23 * V_24 ,
struct V_82 * V_83 , char * V_84 )
{
return sprintf ( V_84 , L_12 , F_4 ( V_2 + V_13 ) ) ;
}
static int F_48 ( struct V_28 * V_29 )
{
int V_40 ;
struct V_31 * V_85 = F_49 ( V_29 ,
V_86 , 0 ) ;
if ( ! F_50 ( & V_29 -> V_24 , V_85 -> V_34 ,
F_51 ( V_85 ) , V_29 -> V_21 ) ) {
F_34 ( & V_29 -> V_24 , L_13 ) ;
return - V_54 ;
}
if ( ! V_2 ) {
V_2 = F_52 ( & V_29 -> V_24 , V_85 -> V_34 ,
F_51 ( V_85 ) ) ;
F_36 ( V_29 -> V_24 . V_25 ) ;
}
if ( ! V_2 ) {
