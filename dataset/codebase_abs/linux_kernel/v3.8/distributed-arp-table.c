...
if ( ! V_2 -> V_3 . V_20 )
return;
for ( V_19 = 0 ; V_19 < V_2 -> V_3 . V_20 -> V_21 ; V_19 ++ ) {
V_18 = & V_2 -> V_3 . V_20 -> V_22 [ V_19 ] ;
V_13 = & V_2 -> V_3 . V_20 -> V_23 [ V_19 ] ;
F_12 ( V_13 ) ;
F_13 (dat_entry, node, node_tmp, head,
hash_entry) {
if ( F_11 && ! F_11 ( V_8 ) )
continue;
F_14 ( V_15 ) ;
...
static int F_17 ( const struct V_14 * V_15 , const void * V_28 )
{
const void * V_29 = F_16 ( V_15 , struct V_7 ,
V_30 ) ;
return ( memcmp ( V_29 , V_28 , sizeof( V_31 ) ) == 0 ? 1 : 0 ) ;
}
...
static T_2 F_22 ( const void * V_36 , T_2 V_21 )
{
...
struct V_43 * V_20 = V_2 -> V_3 . V_20 ;
T_2 V_44 ;
if ( ! V_20 )
return NULL ;
V_44 = F_22 ( & V_41 , V_20 -> V_21 ) ;
V_18 = & V_20 -> V_22 [ V_44 ] ;
F_24 () ;
F_25 (dat_entry, node, head, hash_entry) {
if ( V_8 -> V_41 != V_41 )
continue;
if ( ! F_26 ( & V_8 -> V_9 ) )
continue;
...
V_18 = & V_20 -> V_22 [ V_19 ] ;
F_24 () ;
F_25 (orig_node, node, head, hash_entry) {
V_75 = V_88 - V_83 -> V_89 +
V_85 ;
if ( ! F_36 ( V_84 , V_74 ,
V_75 , V_76 ,
...
if ( V_97 [ V_19 ] . type == V_87 )
continue;
V_95 = F_41 ( V_97 [ V_19 ] . V_83 ) ;
if ( ! V_95 )
goto V_98;
V_96 = F_42 ( V_33 , V_50 ) ;
if ( ! F_43 ( V_2 , V_96 ,
