...
V_149 -> type , V_149 -> V_196 , F_113 ( V_193 ) ) ;
...
V_108 += 2 * sizeof( V_144 ) ;
V_142 = F_115 ( V_15 , V_13 , V_41 , V_108 , V_110 , & V_127 ) ;
V_143:
F_33 ( V_13 ) ;
return V_142 ;
}
static int F_116 ( struct V_14 * V_15 , int * V_147 ,
...
V_142 = F_117 ( V_15 , V_13 , V_41 , V_162 , V_110 , & V_127 ) ;
F_33 ( V_13 ) ;
return V_142 ;
}
static unsigned int
F_118 ( unsigned int V_110 , struct V_14 * V_15 , int V_51 )
{
struct V_36 * V_36 ;
struct V_57 V_58 ;
struct V_81 * V_41 ;
...
if ( F_80 ( V_58 . V_43 == V_8 ) ) {
int V_147 ;
int V_142 = F_116 ( V_15 , & V_147 , V_110 ,
& V_58 ) ;
if ( V_147 )
return V_142 ;
}
...
V_206 = F_122 ( 1 , & V_13 -> V_101 ) ;
if ( V_19 -> V_211 & V_212 )
F_123 ( V_36 , V_13 , V_206 ) ;
F_28 ( V_13 ) ;
return V_95 ;
}
static unsigned int
...
static unsigned int
F_130 ( unsigned int V_110 , struct V_14 * V_15 ,
const struct V_188 * V_189 , const struct V_188 * V_143 ,
int (* F_98)( struct V_14 * ) )
{
int V_213 ;
...
if ( ! F_6 ( V_36 ) -> V_186 )
return V_102 ;
return F_116 ( V_15 , & V_213 , V_110 , & V_122 ) ;
}
static int T_8 F_131 ( struct V_36 * V_36 )
{
struct V_18 * V_19 ;
V_19 = F_132 ( V_36 , V_214 ) ;
if ( V_19 == NULL )
return - V_215 ;
V_19 -> V_186 = 0 ;
V_19 -> V_36 = V_36 ;
