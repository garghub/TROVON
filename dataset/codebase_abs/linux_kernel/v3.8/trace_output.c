...
goto V_128;
F_62 ( & V_115 -> V_121 , V_121 ) ;
} else if ( V_115 -> type > V_124 ) {
F_63 ( V_131 L_27 ) ;
F_60 ( 1 ) ;
goto V_128;
} else {
...
if ( V_115 -> V_129 -> V_132 == NULL )
V_115 -> V_129 -> V_132 = V_133 ;
if ( V_115 -> V_129 -> V_134 == NULL )
V_115 -> V_129 -> V_134 = V_133 ;
if ( V_115 -> V_129 -> V_135 == NULL )
V_115 -> V_129 -> V_135 = V_133 ;
if ( V_115 -> V_129 -> V_25 == NULL )
V_115 -> V_129 -> V_25 = V_133 ;
V_118 = V_115 -> type & ( V_119 - 1 ) ;
F_64 ( & V_115 -> V_136 , & V_137 [ V_118 ] ) ;
V_7 = V_115 -> type ;
V_128:
F_65 ( & V_127 ) ;
return V_7 ;
...
enum V_9 V_133 ( struct V_10 * V_11 , int V_32 ,
struct V_114 * V_115 )
{
...
int V_143 , V_144 ;
F_5 ( V_17 , V_11 -> V_15 ) ;
V_144 = F_49 ( V_17 -> V_145 ) ;
V_143 = F_49 ( V_17 -> V_146 ) ;
F_42 ( V_17 -> V_147 , V_83 ) ;
if ( ! F_8 ( & V_11 -> V_12 ,
L_31 ,
V_17 -> V_148 ,
V_17 -> V_149 ,
...
static int F_79 ( struct V_10 * V_11 , char V_143 )
{
struct V_142 * V_17 ;
int V_144 ;
F_5 ( V_17 , V_11 -> V_15 ) ;
...
static int F_82 ( struct V_10 * V_11 , char V_143 )
{
struct V_142 * V_17 ;
struct V_3 * V_4 = & V_11 -> V_12 ;
int V_144 ;
...
unsigned long * V_153 ;
F_5 ( V_17 , V_11 -> V_15 ) ;
V_153 = ( unsigned long * ) ( ( long ) V_11 -> V_15 + V_11 -> V_108 ) ;
if ( ! F_11 ( V_4 , L_35 ) )
goto V_139;
for ( V_30 = V_17 -> V_68 ; V_30 && * V_30 != V_69 && V_30 < V_153 ; V_30 ++ ) {
if ( ! F_11 ( V_4 , L_13 ) )
goto V_139;
