...
struct V_4 * V_5 ;
F_7 (lkb, head, lkb_statequeue) {
if ( V_5 -> V_7 == V_186 && V_5 -> V_9 == V_389 )
return V_5 ;
}
return NULL ;
}
...
{
struct V_4 * V_5 ;
V_5 = F_282 ( & V_19 -> V_79 , V_186 , V_389 ) ;
if ( V_5 )
return V_5 ;
V_5 = F_282 ( & V_19 -> V_80 , V_186 , V_389 ) ;
if ( V_5 )
return V_5 ;
V_5 = F_282 ( & V_19 -> V_81 , V_186 , V_389 ) ;
if ( V_5 )
return V_5 ;
return NULL ;
}
static int F_284 ( struct V_29 * V_30 , struct V_4 * V_5 ,
struct V_18 * V_19 , struct V_390 * V_88 )
{
struct V_391 * V_392 = (struct V_391 * ) V_88 -> V_393 ;
V_5 -> V_7 = V_88 -> V_394 . V_209 ;
V_5 -> V_305 = F_285 ( V_392 -> V_395 ) ;
V_5 -> V_9 = F_285 ( V_392 -> V_396 ) ;
V_5 -> V_10 = F_285 ( V_392 -> V_397 ) ;
V_5 -> V_11 = F_285 ( V_392 -> V_398 ) & 0x0000FFFF ;
V_5 -> V_11 |= V_38 ;
V_5 -> V_243 = F_285 ( V_392 -> V_399 ) ;
V_5 -> V_13 = V_392 -> V_400 ;
V_5 -> V_14 = V_392 -> V_401 ;
V_5 -> V_282 = ( V_392 -> V_402 & V_52 ) ? & F_229 : NULL ;
V_5 -> V_302 = ( V_392 -> V_402 & V_49 ) ? & F_230 : NULL ;
if ( V_5 -> V_10 & V_242 ) {
int V_403 = V_88 -> V_394 . V_326 - sizeof( struct V_390 ) -
sizeof( struct V_391 ) ;
if ( V_403 > V_30 -> V_240 )
return - V_123 ;
V_5 -> V_162 = F_143 ( V_30 ) ;
if ( ! V_5 -> V_162 )
return - V_69 ;
memcpy ( V_5 -> V_162 , V_392 -> V_404 , V_403 ) ;
}
if ( V_392 -> V_405 == F_286 ( V_178 ) &&
F_23 ( V_5 ) ) {
V_392 -> V_406 = V_173 ;
V_5 -> V_14 = V_148 ;
F_62 ( V_19 , V_372 ) ;
...
int F_287 ( struct V_29 * V_30 , struct V_390 * V_88 )
{
struct V_391 * V_392 = (struct V_391 * ) V_88 -> V_393 ;
struct V_18 * V_19 ;
struct V_4 * V_5 ;
T_1 V_389 = 0 ;
int V_101 = V_88 -> V_394 . V_209 ;
int error ;
if ( V_392 -> V_407 ) {
error = - V_408 ;
goto V_111;
}
V_389 = F_285 ( V_392 -> V_396 ) ;
error = F_67 ( V_30 , V_392 -> V_409 , F_288 ( V_392 -> V_410 ) ,
V_101 , V_122 , & V_19 ) ;
if ( error )
goto V_111;
F_73 ( V_19 ) ;
...
F_86 ( V_19 , V_5 ) ;
F_104 ( V_19 , V_5 , V_392 -> V_406 ) ;
error = 0 ;
V_30 -> V_412 ++ ;
if ( ! F_6 ( & V_19 -> V_81 ) || ! F_6 ( & V_19 -> V_80 ) )
F_62 ( V_19 , V_273 ) ;
V_411:
V_392 -> V_413 = F_289 ( V_5 -> V_8 ) ;
V_5 -> V_17 = V_30 -> V_380 ;
V_114:
F_77 ( V_19 ) ;
F_37 ( V_19 ) ;
...
F_46 ( V_30 , L_126 ,
V_101 , V_389 , error ) ;
V_392 -> V_414 = F_289 ( error ) ;
return error ;
}
int F_290 ( struct V_29 * V_30 , struct V_390 * V_88 )
{
struct V_391 * V_392 = (struct V_391 * ) V_88 -> V_393 ;
struct V_18 * V_19 ;
struct V_4 * V_5 ;
T_1 V_160 , V_389 ;
int error , V_126 ;
V_160 = F_285 ( V_392 -> V_396 ) ;
V_389 = F_285 ( V_392 -> V_413 ) ;
V_126 = F_285 ( V_392 -> V_414 ) ;
error = F_93 ( V_30 , V_160 , & V_5 ) ;
if ( error ) {
F_60 ( V_30 , L_127 ,
V_160 , V_88 -> V_394 . V_209 , V_389 , V_126 ) ;
return error ;
}
V_19 = V_5 -> V_145 ;
F_34 ( V_19 ) ;
...
int F_293 ( struct V_29 * V_30 , struct V_415 * V_416 ,
...
if ( V_102 & V_242 ) {
V_416 -> V_287 . V_294 = F_117 ( V_417 , V_158 ) ;
if ( ! V_416 -> V_287 . V_294 ) {
F_119 ( V_416 ) ;
F_96 ( V_30 , V_5 ) ;
error = - V_69 ;
goto V_111;
...
error = F_184 ( V_166 , & V_416 -> V_287 , V_102 , V_288 , V_289 ,
F_230 , V_416 , F_229 , & args ) ;
V_5 -> V_11 |= V_418 ;
if ( error ) {
F_96 ( V_30 , V_5 ) ;
goto V_111;
...
F_38 ( & V_416 -> V_419 -> V_420 ) ;
F_100 ( V_5 ) ;
F_106 ( & V_5 -> V_150 , & V_416 -> V_419 -> V_421 ) ;
F_40 ( & V_416 -> V_419 -> V_420 ) ;
V_111:
F_10 ( V_30 ) ;
return error ;
}
int F_294 ( struct V_29 * V_30 , struct V_415 * V_422 ,
int V_166 , T_1 V_102 , T_1 V_160 , char * V_423 ,
unsigned long V_289 )
{
struct V_4 * V_5 ;
struct V_291 args ;
...
goto V_111;
V_416 = V_5 -> V_424 ;
if ( V_102 & V_242 && ! V_416 -> V_287 . V_294 ) {
V_416 -> V_287 . V_294 = F_117 ( V_417 , V_158 ) ;
if ( ! V_416 -> V_287 . V_294 ) {
error = - V_69 ;
goto V_313;
...
if ( V_423 && V_416 -> V_287 . V_294 )
memcpy ( V_416 -> V_287 . V_294 , V_423 , V_417 ) ;
V_416 -> V_425 = V_422 -> V_425 ;
V_416 -> V_426 = V_422 -> V_426 ;
V_416 -> V_427 = V_422 -> V_427 ;
V_416 -> V_428 = V_422 -> V_428 ;
V_416 -> V_429 = V_422 -> V_429 ;
V_416 -> V_430 = V_422 -> V_430 ;
error = F_184 ( V_166 , & V_416 -> V_287 , V_102 , 0 , V_289 ,
F_230 , V_416 , F_229 , & args ) ;
if ( error )
goto V_313;
error = F_204 ( V_30 , V_5 , & args ) ;
...
int F_295 ( struct V_29 * V_30 , struct V_415 * V_422 ,
T_1 V_102 , T_1 V_160 , char * V_423 )
{
struct V_4 * V_5 ;
struct V_291 args ;
struct V_415 * V_416 ;
...
F_38 ( & V_416 -> V_419 -> V_420 ) ;
if ( ! F_6 ( & V_5 -> V_150 ) )
F_296 ( & V_5 -> V_150 , & V_416 -> V_419 -> V_431 ) ;
F_40 ( & V_416 -> V_419 -> V_420 ) ;
V_313:
F_99 ( V_5 ) ;
V_111:
...
int F_297 ( struct V_29 * V_30 , struct V_415 * V_422 ,
T_1 V_102 , T_1 V_160 )
{
struct V_4 * V_5 ;
struct V_291 args ;
...
F_100 ( V_5 ) ;
F_113 ( & V_30 -> V_433 ) ;
F_106 ( & V_5 -> V_150 , & V_30 -> V_434 ) ;
F_118 ( & V_30 -> V_433 ) ;
F_187 ( 0 , V_5 -> V_424 , & args ) ;
error = F_206 ( V_30 , V_5 , & args ) ;
if ( error == - V_44 )
error = 0 ;
return error ;
...
if ( F_6 ( & V_419 -> V_421 ) )
goto V_111;
V_5 = F_161 ( V_419 -> V_421 . V_218 , struct V_4 , V_150 ) ;
F_122 ( & V_5 -> V_150 ) ;
if ( V_5 -> V_10 & V_437 )
V_5 -> V_11 |= V_438 ;
else
...
void F_302 ( struct V_29 * V_30 , struct V_435 * V_419 )
{
struct V_4 * V_5 , * V_284 ;
F_8 ( V_30 ) ;
while ( 1 ) {
V_5 = F_301 ( V_30 , V_419 ) ;
if ( ! V_5 )
break;
F_29 ( V_5 ) ;
if ( V_5 -> V_10 & V_437 )
...
static void F_303 ( struct V_29 * V_30 , struct V_435 * V_419 )
{
struct V_4 * V_5 , * V_284 ;
while ( 1 ) {
V_5 = NULL ;
F_38 ( & V_419 -> V_420 ) ;
if ( ! F_6 ( & V_419 -> V_421 ) ) {
V_5 = F_161 ( V_419 -> V_421 . V_218 , struct V_4 ,
V_150 ) ;
F_122 ( & V_5 -> V_150 ) ;
}
F_40 ( & V_419 -> V_420 ) ;
...
int F_305 ( struct V_29 * V_30 , struct V_435 * V_419 ,
int V_186 , int V_307 )
{
int error = 0 ;
if ( V_186 != F_59 () ) {
