...
return - V_29 ;
V_102 = V_2 -> V_40 -> V_203 ( V_2 , V_205 ) ;
if ( V_102 < 0 )
return V_102 ;
V_202 = true ;
F_67 ( V_2 ) ;
...
if ( V_34 )
return V_34 ;
V_150 = ( V_230 . V_150 > V_227 . V_150 ) ? V_227 . V_150 : V_230 . V_150 ;
if ( ! V_150 )
return - V_29 ;
...
} else if ( V_2 -> V_40 && V_2 -> V_40 -> V_238 ) {
