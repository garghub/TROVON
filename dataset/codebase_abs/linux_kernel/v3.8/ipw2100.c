...
F_165 ( L_160 , V_412 -> V_429 [ 0 ] -> V_14 ) ;
...
return sprintf ( V_15 , L_166 , ( int ) V_470 -> V_187 ) ;
}
static T_9 F_191 ( struct V_473 * V_319 , struct V_474 * V_475 ,
char * V_15 )
{
struct V_5 * V_470 = F_190 ( V_319 ) ;
return sprintf ( V_15 , L_166 , ( int ) V_470 -> V_49 ) ;
}
static T_9 F_192 ( struct V_473 * V_319 , struct V_474 * V_475 ,
char * V_15 )
{
struct V_5 * V_470 = F_190 ( V_319 ) ;
return sprintf ( V_15 , L_166 , ( int ) V_470 -> V_476 ) ;
}
...
V_39 += sprintf ( V_39 , L_183 , V_6 -> V_491 ) ;
#ifdef F_128
V_39 += sprintf ( V_39 , L_184 ,
V_6 -> V_313 [ 0 ] ? L_185 : L_186 ) ;
#endif
return V_39 - V_15 ;
}
...
F_201 ( V_150 -> V_494 . V_495 [ V_6 -> V_150 -> V_494 . V_496 ] , L_191 ) ;
F_201 ( V_49 , L_192 ) ;
F_201 ( V_187 , L_192 ) ;
F_201 ( V_476 , L_192 ) ;
V_14 +=
...
F_201 ( V_215 , L_194 ) ;
F_201 ( V_76 , L_194 ) ;
F_201 ( V_428 . V_147 , L_194 ) ;
F_201 ( V_428 . V_498 , L_194 ) ;
F_201 ( V_414 . V_147 , L_194 ) ;
F_201 ( V_414 . V_499 , L_194 ) ;
F_201 ( V_90 . V_147 , L_194 ) ;
F_201 ( V_90 . V_499 , L_194 ) ;
F_201 ( V_92 . V_147 , L_194 ) ;
F_201 ( V_92 . V_498 , L_194 ) ;
F_201 ( V_405 . V_147 , L_194 ) ;
F_201 ( V_405 . V_498 , L_194 ) ;
F_201 ( V_418 . V_147 , L_194 ) ;
F_201 ( V_418 . V_499 , L_194 ) ;
F_201 ( V_150 -> V_300 , L_194 ) ;
F_201 ( V_47 , L_194 ) ;
return V_14 ;
}
...
{
struct V_5 * V_6 = F_190 ( V_319 ) ;
return sprintf ( V_15 , L_202 , V_6 -> V_150 -> V_501 ) ;
}
...
snprintf ( V_81 -> V_656 , sizeof( V_81 -> V_656 ) , L_242 ,
...
V_693 = 2 ;
F_84 ( & V_6 -> V_266 ) ;
F_31 ( L_263 , V_2 -> V_51 , F_274 ( V_261 ) ) ;
...
static void F_310 ( struct V_261 * V_261 )
{
...
static int F_312 ( struct V_261 * V_261 , T_13 V_102 )
{
struct V_5 * V_6 = F_311 ( V_261 ) ;
struct V_1 * V_2 = V_6 -> V_33 ;
F_31 ( L_265 , V_2 -> V_51 ) ;
...
{
int V_267 ;
F_27 (KERN_INFO DRV_NAME L_268 , DRV_DESCRIPTION, DRV_VERSION) ;
F_27 (KERN_INFO DRV_NAME L_269 , DRV_COPYRIGHT) ;
F_320 ( & V_207 , V_704 ,
V_223 ) ;
V_267 = F_321 ( & V_705 ) ;
if ( V_267 )
...
struct V_5 * V_6 = F_2 ( V_2 ) ;
if ( ! ( V_6 -> V_49 & V_166 ) )
strcpy ( V_218 -> V_51 , L_270 ) ;
else
snprintf ( V_218 -> V_51 , V_710 , L_271 ) ;
F_328 ( L_272 , V_218 -> V_51 ) ;
return 0 ;
}
...
struct V_5 * V_6 = F_2 ( V_2 ) ;
if ( V_6 -> V_187 & V_532 )
snprintf ( V_218 -> V_51 , V_710 , L_314 ) ;
else
...
F_27 (KERN_WARNING DRV_NAME L_323
L_324
L_325 ,
h->version) ;
return 1 ;
