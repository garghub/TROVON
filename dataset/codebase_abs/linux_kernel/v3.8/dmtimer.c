...
if ( V_28 -> V_87 ) {
if ( F_69 ( V_28 -> V_87 , L_19 , NULL ) )
V_2 -> V_32 |= V_53 ;
if ( F_69 ( V_28 -> V_87 , L_20 , NULL ) )
V_2 -> V_32 |= V_93 ;
if ( F_69 ( V_28 -> V_87 , L_21 , NULL ) )
V_2 -> V_32 |= V_94 ;
if ( F_69 ( V_28 -> V_87 , L_22 , NULL ) )
V_2 -> V_32 |= V_95 ;
} else {
V_2 -> V_36 = V_27 -> V_36 ;
V_2 -> V_96 = V_61 -> V_97 ;
...
static int F_76 ( struct V_83 * V_27 )
{
struct V_1 * V_2 ;
unsigned long V_40 ;
int V_41 = - V_25 ;
