...
V_30 = 0 ;
if ( V_72 -> signal -> V_62 == V_62 || F_26 ( V_73 ) )
V_30 = 1 ;
switch ( V_27 ) {
case V_74 :
V_69 = F_27 ( V_62 , V_63 ) ;
...
V_69 = F_31 ( V_63 , 1 , ( V_27 == V_83 ) ) ? - V_87 : 0 ;
break;
case V_88 :
case V_89 :
V_69 = F_31 ( V_85 , V_90 ,
...
if ( ! F_26 ( V_73 ) )
return - V_36 ;
if ( F_15 ( & V_93 , V_68 , sizeof( struct V_92 ) ) ) {
V_69 = - V_20 ;
break;
}
V_69 = F_32 ( & V_93 ) ;
if ( V_69 )
break;
if ( F_16 ( V_68 , & V_93 , sizeof( struct V_92 ) ) )
V_69 = - V_20 ;
break;
}
case V_94 :
...
case V_110 :
case V_111 :
V_69 = F_43 ( V_27 , V_68 , V_30 , V_65 ) ;
break;
case V_112 :
case V_113 :
V_69 = F_44 ( V_27 , V_68 , V_30 ) ;
break;
case V_114 :
case V_115 :
case V_116 :
case V_117 :
V_69 = F_45 ( V_27 , V_68 , V_30 ) ;
break;
case V_118 :
case V_119 :
case V_120 :
case V_121 :
V_69 = F_46 ( V_65 , V_27 , V_63 , V_30 ) ;
break;
case V_122 :
{
if ( ! V_30 || ! F_26 ( V_123 ) )
return - V_36 ;
if ( ! F_47 ( V_63 ) || V_63 < 1 || V_63 == V_124 )
V_69 = - V_22 ;
else {
F_48 ( & V_125 . V_126 ) ;
F_49 ( V_125 . V_127 ) ;
V_125 . V_127 = F_50 ( F_51 ( V_72 ) ) ;
V_125 . V_128 = V_63 ;
F_52 ( & V_125 . V_126 ) ;
}
break;
...
if ( ! V_30 )
return - V_36 ;
if ( F_15 ( & V_53 , V_68 , sizeof( struct V_130 ) ) ) {
V_69 = - V_20 ;
goto V_71;
}
...
F_36 () ;
V_138 = F_16 ( V_68 , & V_53 , sizeof( struct V_130 ) ) ;
if ( V_138 )
V_69 = - V_20 ;
break;
}
...
if ( ! V_30 )
return - V_36 ;
if ( F_15 ( & V_151 , (struct V_150 T_1 * ) V_63 ,
sizeof( struct V_150 ) ) ) {
V_69 = - V_20 ;
goto V_71;
}
...
if ( ! V_30 )
return - V_36 ;
if ( F_59 ( V_162 , & V_161 -> V_164 ) ||
F_59 ( V_163 , & V_161 -> V_165 ) )
V_69 = - V_20 ;
else {
F_33 () ;
for ( V_34 = 0 ; V_34 < V_145 ; V_34 ++ ) {
...
if ( V_52 ) {
V_52 -> V_166 = 1 ;
F_60 ( V_45 [ V_34 ] . V_46 , V_163 , V_162 ) ;
}
}
F_36 () ;
}
...
F_61 ( V_162 , & V_169 -> V_164 ) ;
F_61 ( V_163 , & V_169 -> V_165 ) ;
F_61 ( V_170 , & V_169 -> V_175 ) ;
F_61 ( V_171 , & V_169 -> V_176 ) ;
F_61 ( V_172 , & V_169 -> V_177 ) ;
F_61 ( V_173 , & V_169 -> V_178 ) ;
...
if ( ! V_30 )
return - V_36 ;
V_69 = F_15 ( & V_196 , V_68 , sizeof( struct V_195 ) ) ;
if ( V_69 )
V_69 = - V_20 ;
else
F_70 ( V_52 , & V_196 ) ;
...
break;
case V_200 :
V_69 = F_29 ( V_52 -> V_201 ,
( unsigned short T_1 * ) V_63 ) ;
break;
case V_202 :
V_69 = F_14 ( (struct V_19 T_1 * ) V_63 ) ;
break;
default:
V_69 = - V_70 ;
}
...
void F_75 ( struct V_206 * V_207 )
{
struct V_52 * V_208 =
F_76 ( V_207 , struct V_52 , V_209 ) ;
struct V_51 * V_52 ;
struct V_61 * V_62 ;
F_33 () ;
V_52 = V_208 -> V_46 ;
...
static inline int
F_78 ( int V_27 , struct V_211 T_1 * V_29 ,
...
if ( ! V_30 && V_32 -> V_32 != V_48 )
return - V_36 ;
V_32 -> V_43 = F_79 ( ( (struct V_212 * ) V_32 ) -> V_43 ) ;
V_34 = F_19 ( V_52 , V_32 ) ;
if ( V_34 )
return V_34 ;
...
static inline int
F_81 ( unsigned int V_27 , struct V_214 T_1 * V_50 ,
...
case V_35 :
case V_47 :
V_69 = F_78 ( V_27 , V_68 , V_30 , & V_32 ) ;
break;
case V_189 :
V_69 = F_80 ( V_68 , V_30 , & V_32 , V_52 ) ;
break;
case V_58 :
case V_59 :
V_69 = F_81 ( V_27 , V_68 , V_30 , V_52 ) ;
break;
case V_75 :
case V_77 :
#ifdef F_30
...
goto V_216;
default:
V_63 = ( unsigned long ) F_79 ( V_63 ) ;
goto V_216;
}
V_71:
return V_69 ;
V_216:
return F_24 ( V_62 , V_27 , V_63 ) ;
}
...
if ( V_52 -> V_130 . V_131 == V_133 ) {
if ( F_84 ( V_52 -> V_135 , V_52 -> V_130 . V_205 , 1 ) != 0 ) {
F_71 ( V_52 ) ;
if ( V_217 != V_52 -> V_99 ) {
if ( V_52 -> V_99 == V_98 )
F_34 ( 1 ) ;
...
void F_85 ( struct V_51 * V_219 )
{
struct V_51 * V_52 ;
if ( ! V_219 || V_219 -> V_60 == V_26 || V_198 )
return;
V_52 = V_45 [ V_26 ] . V_46 ;
if ( V_52 -> V_130 . V_131 == V_133 ) {
V_52 -> V_136 = V_219 -> V_60 ;
if ( F_84 ( V_52 -> V_135 , V_52 -> V_130 . V_204 , 1 ) == 0 ) {
return;
}
F_71 ( V_52 ) ;
}
...
int F_86 ( unsigned int V_220 , int V_221 )
{
int V_222 ;
F_33 () ;
if ( V_223 ) {
