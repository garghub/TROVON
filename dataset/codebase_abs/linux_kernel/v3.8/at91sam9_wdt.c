...
static long F_16 ( struct V_13 * V_13 ,
...
V_15 = V_32 ;
V_6 . V_7 = V_5 + V_15 * V_16 ;
return F_18 ( V_32 , V_31 ) ;
case V_40 :
return F_18 ( V_15 , V_31 ) ;
}
return - V_41 ;
}
static T_2 F_20 ( struct V_13 * V_13 , const char * V_4 , T_3 V_42 ,
T_4 * V_43 )
{
if ( ! V_42 )
return 0 ;
...
static int T_5 F_21 ( struct V_46 * V_47 )
{
struct V_48 * V_49 ;
int V_50 ;
if ( V_51 . V_52 )
return - V_14 ;
V_51 . V_52 = & V_47 -> V_53 ;
V_49 = F_22 ( V_47 , V_54 , 0 ) ;
if ( ! V_49 )
return - V_55 ;
V_6 . V_56 = F_23 ( V_49 -> V_57 , F_24 ( V_49 ) ) ;
if ( ! V_6 . V_56 ) {
F_25 ( & V_47 -> V_53 , L_3 ) ;
return - V_58 ;
}
V_50 = F_13 ( F_26 ( V_59 * 1000 ) ) ;
if ( V_50 )
return V_50 ;
V_50 = F_27 ( & V_51 ) ;
if ( V_50 )
...
static int T_6 F_30 ( struct V_46 * V_47 )
{
int V_50 ;
V_50 = F_31 ( & V_51 ) ;
if ( ! V_50 )
