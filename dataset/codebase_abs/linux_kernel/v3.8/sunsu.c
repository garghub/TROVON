...
static T_2 void F_80 ( struct V_1 * V_2 )
{
...
static int T_3 F_90 ( struct V_241 * V_242 , char * V_248 )
{
...
static enum V_105 F_94 ( struct V_256 * V_257 )
{
...
static int F_97 ( struct V_261 * V_262 )
{
static int V_263 ;
...
V_2 -> V_271 = F_99 ( V_265 ) ;
V_2 -> V_4 . V_11 = F_100 ( V_265 , 0 , V_2 -> V_271 , L_14 ) ;
if ( ! V_2 -> V_4 . V_11 ) {
if ( type != V_145 )
F_101 ( V_2 ) ;
return - V_269 ;
}
V_2 -> V_4 . V_93 = V_262 -> V_272 . V_273 [ 0 ] ;
V_2 -> V_4 . V_223 = & V_262 -> V_223 ;
V_2 -> V_4 . type = V_210 ;
V_2 -> V_4 . V_21 = ( V_274 * 16 ) ;
V_267 = 0 ;
...
return 0 ;
V_276:
F_102 ( & V_262 -> V_264 [ 0 ] , V_2 -> V_4 . V_11 , V_2 -> V_271 ) ;
return V_267 ;
}
static int F_106 ( struct V_261 * V_262 )
{
struct V_1 * V_2 = F_107 ( & V_262 -> V_223 ) ;
bool V_278 = false ;
if ( V_2 -> V_105 == V_108 ||
V_2 -> V_105 == V_106 )
V_278 = true ;
...
static void T_4 F_117 ( void )
{
if ( V_250 . V_281 )
F_116 ( & V_250 , V_250 . V_281 ) ;
}
