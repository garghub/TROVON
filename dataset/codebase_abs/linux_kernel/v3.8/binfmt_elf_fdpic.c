...
V_111 += sizeof( struct V_124 ) * V_39 -> V_101 -> V_125 ;
...
F_47 ( V_149 , ( V_133 ) F_48 ( V_104 -> V_150 , V_104 -> V_151 ) ) ;
F_47 ( V_152 , ( V_133 ) F_48 ( V_104 -> V_150 , V_104 -> V_153 ) ) ;
F_47 ( V_154 , ( V_133 ) F_49 ( V_104 -> V_150 , V_104 -> V_155 ) ) ;
F_47 ( V_156 , ( V_133 ) F_49 ( V_104 -> V_150 , V_104 -> V_157 ) ) ;
F_47 ( V_158 , F_50 ( V_38 ) ) ;
...
F_52 ( V_38 -> V_130 , ( unsigned long T_4 * ) V_106 ) ;
F_53 ( V_106 != V_105 ) ;
#ifdef F_15
...
F_52 ( ( T_3 ) V_116 , V_108 ++ ) ;
V_111 = F_54 ( V_116 , V_163 ) ;
...
F_52 ( ( T_3 ) ( unsigned long ) V_116 , V_109 ++ ) ;
V_111 = F_54 ( V_116 , V_163 ) ;
if ( ! V_111 || V_111 > V_163 )
return - V_164 ;
V_116 += V_111 ;
...
V_171 = F_55 ( V_38 -> V_174 [ V_169 ] ) ;
V_105 -= V_86 ;
if ( F_45 ( ( void * ) V_105 , V_171 , V_86 ) != 0 )
V_172 = - V_119 ;
F_56 ( V_38 -> V_174 [ V_169 ] ) ;
if ( V_172 < 0 )
goto V_175;
}
...
if ( V_14 -> V_32 & V_54 )
V_200 |= V_202 ;
V_199 = F_35 ( NULL , V_62 , V_198 - V_196 ,
V_88 | V_89 | V_92 , V_200 , 0 ) ;
if ( F_36 ( V_199 ) )
return ( int ) V_199 ;
if ( V_62 != 0 )
V_62 += F_34 ( V_198 - V_196 ) ;
V_16 = V_14 -> V_24 ;
for ( V_19 = 0 ; V_19 < V_14 -> V_3 . V_23 ; V_19 ++ , V_16 ++ ) {
if ( V_14 -> V_24 [ V_19 ] . V_28 != V_61 )
continue;
...
if ( F_60 ( ( void * ) ( V_178 -> V_187 + V_16 -> V_56 ) ,
V_16 -> V_36 - V_16 -> V_56 ) )
return - V_119 ;
}
if ( V_72 ) {
...
V_199 = F_35 ( V_4 , V_199 , V_16 -> V_36 + V_206 , V_209 , V_32 ,
V_16 -> V_59 - V_206 ) ;
F_16 ( L_21 ,
...
F_16 ( L_22 , V_19 , V_199 , V_206 ) ;
if ( F_60 ( ( void T_4 * ) V_199 , V_206 ) )
return - V_119 ;
V_199 += V_206 ;
}
...
unsigned long V_217 ;
V_32 |= V_215 | V_94 ;
V_217 = F_35 ( NULL , V_216 , V_207 - V_208 ,
V_209 , V_32 , 0 ) ;
F_16 ( L_23
L_24 ,
...
if ( F_60 ( ( void T_4 * ) V_199 + V_16 -> V_56 ,
V_208 ) )
return - V_119 ;
}
#else
...
if ( F_60 ( ( void * ) V_199 + V_16 -> V_56 , V_207 ) )
return - V_119 ;
}
#endif
if ( V_72 ) {
...
static int F_62 ( struct V_218 * V_219 , unsigned long V_220 )
{
int V_221 ;
if ( V_219 -> V_222 & V_223 ) {
F_63 ( L_25 , V_219 -> V_224 , V_219 -> V_222 ) ;
return 0 ;
}
if ( ! ( V_219 -> V_222 & V_225 ) ) {
F_63 ( L_26 , V_219 -> V_224 , V_219 -> V_222 ) ;
return 0 ;
}
if ( V_219 -> V_222 & V_226 ) {
if ( V_219 -> V_227 -> V_192 . V_193 -> V_194 -> V_228 == 0 ) {
V_221 = F_64 ( V_229 , & V_220 ) ;
F_63 ( L_27 , V_219 -> V_224 ,
V_219 -> V_222 , V_221 ? L_28 : L_29 ) ;
return V_221 ;
}
V_221 = F_64 ( V_230 , & V_220 ) ;
F_63 ( L_27 , V_219 -> V_224 ,
V_219 -> V_222 , V_221 ? L_28 : L_29 ) ;
return V_221 ;
}
#ifdef F_15
if ( ! V_219 -> V_231 ) {
V_221 = F_64 ( V_232 , & V_220 ) ;
F_63 ( L_30 , V_219 -> V_224 ,
V_219 -> V_222 , V_221 ? L_28 : L_29 ) ;
return V_221 ;
}
#endif
V_221 = F_64 ( V_233 , & V_220 ) ;
F_63 ( L_31 , V_219 -> V_224 , V_219 -> V_222 ,
V_221 ? L_28 : L_29 ) ;
return V_221 ;
}
static int F_65 ( struct V_234 * V_235 )
{
int V_236 ;
V_236 = sizeof( struct V_237 ) ;
V_236 += F_66 ( strlen ( V_235 -> V_238 ) + 1 , 4 ) ;
V_236 += F_66 ( V_235 -> V_239 , 4 ) ;
return V_236 ;
}
static int F_67 ( struct V_4 * V_4 , T_8 * V_240 )
{
static const char V_52 [ 4 ] = { 0 , } ;
F_68 ( V_52 , F_66 ( * V_240 , 4 ) - * V_240 , V_240 ) ;
return 1 ;
}
static int F_69 ( struct V_234 * V_241 , struct V_4 * V_4 ,
T_8 * V_240 )
{
struct V_237 V_235 ;
...
F_68 ( & V_235 , sizeof( V_235 ) , V_240 ) ;
F_68 ( V_241 -> V_238 , V_235 . V_242 , V_240 ) ;
if ( ! F_67 ( V_4 , V_240 ) )
return 0 ;
F_68 ( V_241 -> V_245 , V_241 -> V_239 , V_240 ) ;
if ( ! F_67 ( V_4 , V_240 ) )
return 0 ;
return 1 ;
}
static inline void F_70 ( struct V_2 * V_246 , int V_183 )
{
...
static inline void F_71 ( struct V_21 * V_16 , int V_236 , T_8 V_268 )
{
V_16 -> V_28 = V_269 ;
V_16 -> V_59 = V_268 ;
V_16 -> V_63 = 0 ;
...
static inline void F_72 ( struct V_234 * V_272 , const char * V_238 , int type ,
...
static void F_73 ( struct V_273 * V_274 ,
...
F_74 () ;
V_274 -> V_285 = F_75 ( F_76 ( V_116 -> V_286 ) ) ;
F_77 () ;
V_274 -> V_287 = F_75 ( V_116 ) ;
V_274 -> V_288 = F_78 ( V_116 ) ;
V_274 -> V_289 = F_79 ( V_116 ) ;
if ( F_80 ( V_116 ) ) {
struct V_290 V_291 ;
F_81 ( V_116 , & V_291 ) ;
F_82 ( V_291 . V_292 , & V_274 -> V_293 ) ;
F_82 ( V_291 . V_294 , & V_274 -> V_295 ) ;
} else {
F_82 ( V_116 -> V_292 , & V_274 -> V_293 ) ;
F_82 ( V_116 -> V_294 , & V_274 -> V_295 ) ;
}
F_82 ( V_116 -> signal -> V_296 , & V_274 -> V_297 ) ;
F_82 ( V_116 -> signal -> V_298 , & V_274 -> V_299 ) ;
V_274 -> V_300 = V_116 -> V_72 -> V_78 . V_79 ;
V_274 -> V_301 = V_116 -> V_72 -> V_78 . V_80 ;
}
static int F_83 ( struct V_302 * V_303 , struct V_275 * V_116 ,
struct V_103 * V_72 )
{
...
V_303 -> V_305 [ V_111 ] = 0 ;
F_74 () ;
V_303 -> V_285 = F_75 ( F_76 ( V_116 -> V_286 ) ) ;
F_77 () ;
V_303 -> V_287 = F_75 ( V_116 ) ;
V_303 -> V_288 = F_78 ( V_116 ) ;
V_303 -> V_289 = F_79 ( V_116 ) ;
V_49 = V_116 -> V_306 ? F_85 ( ~ V_116 -> V_306 ) + 1 : 0 ;
V_303 -> V_307 = V_49 ;
V_303 -> V_308 = ( V_49 > 5 ) ? '.' : L_32 [ V_49 ] ;
V_303 -> V_309 = V_303 -> V_308 == 'Z' ;
V_303 -> V_310 = F_86 ( V_116 ) ;
V_303 -> V_311 = V_116 -> V_32 ;
F_74 () ;
V_104 = F_87 ( V_116 ) ;
F_88 ( V_303 -> V_312 , F_48 ( V_104 -> V_150 , V_104 -> V_151 ) ) ;
F_89 ( V_303 -> V_313 , F_49 ( V_104 -> V_150 , V_104 -> V_155 ) ) ;
F_77 () ;
strncpy ( V_303 -> V_314 , V_116 -> V_315 , sizeof( V_303 -> V_314 ) ) ;
return 0 ;
}
static int F_90 ( long V_276 , struct V_316 * V_317 )
{
struct V_275 * V_116 = V_317 -> V_318 ;
int V_236 = 0 ;
V_317 -> V_319 = 0 ;
F_73 ( & V_317 -> V_274 , V_116 , V_276 ) ;
F_91 ( V_116 , & V_317 -> V_274 . V_320 ) ;
F_72 ( & V_317 -> V_321 [ 0 ] , L_33 , V_322 , sizeof( V_317 -> V_274 ) ,
& V_317 -> V_274 ) ;
V_317 -> V_319 ++ ;
V_236 += F_65 ( & V_317 -> V_321 [ 0 ] ) ;
V_317 -> V_274 . V_323 = F_92 ( V_116 , NULL , & V_317 -> V_324 ) ;
if ( V_317 -> V_274 . V_323 ) {
F_72 ( & V_317 -> V_321 [ 1 ] , L_33 , V_325 , sizeof( V_317 -> V_324 ) ,
& V_317 -> V_324 ) ;
V_317 -> V_319 ++ ;
V_236 += F_65 ( & V_317 -> V_321 [ 1 ] ) ;
}
#ifdef F_93
if ( F_94 ( V_116 , & V_317 -> V_326 ) ) {
F_72 ( & V_317 -> V_321 [ 2 ] , L_34 , V_327 ,
sizeof( V_317 -> V_326 ) , & V_317 -> V_326 ) ;
V_317 -> V_319 ++ ;
V_236 += F_65 ( & V_317 -> V_321 [ 2 ] ) ;
}
#endif
return V_236 ;
}
static void F_95 ( struct V_2 * V_246 , struct V_328 * V_329 ,
...
static int F_96 ( struct V_4 * V_4 , T_5 * V_17 ,
...
V_187 += V_86 ) {
struct V_174 * V_174 = F_97 ( V_187 ) ;
if ( V_174 ) {
void * V_340 = F_55 ( V_174 ) ;
* V_17 += V_86 ;
if ( * V_17 > * V_336 )
V_337 = - V_341 ;
else if ( ! F_98 ( V_4 , V_340 , V_86 ) )
V_337 = - V_342 ;
F_56 ( V_174 ) ;
F_99 ( V_174 ) ;
} else if ( ! F_100 ( V_4 , V_86 ) )
V_337 = - V_341 ;
if ( V_337 )
goto V_175;
}
...
if ( ( * V_17 += V_86 ) > * V_336 )
return - V_341 ;
if ( ! F_98 ( V_4 , ( void * ) V_219 -> V_224 ,
V_219 -> V_339 - V_219 -> V_224 ) )
return - V_342 ;
}
return 0 ;
}
static T_5 F_101 ( unsigned long V_220 )
{
struct V_218 * V_219 ;
T_5 V_17 = 0 ;
for ( V_219 = V_50 -> V_72 -> V_12 ; V_219 ; V_219 = V_219 -> V_338 )
...
static int F_102 ( struct V_343 * V_344 )
{
#define F_103 6
int V_345 = 0 ;
T_9 V_346 ;
...
if ( ! V_246 )
goto V_354;
V_274 = F_57 ( sizeof( * V_274 ) , V_25 ) ;
if ( ! V_274 )
goto V_354;
V_303 = F_9 ( sizeof( * V_303 ) , V_25 ) ;
if ( ! V_303 )
goto V_354;
V_321 = F_9 ( F_103 * sizeof( struct V_234 ) , V_25 ) ;
if ( ! V_321 )
goto V_354;
...
V_180 = F_57 ( sizeof( * V_180 ) , V_25 ) ;
if ( ! V_180 )
goto V_354;
V_180 -> V_318 = V_357 -> V_361 ;
F_105 ( & V_180 -> V_362 , & V_349 ) ;
}
F_106 (t, &thread_list) {
struct V_316 * V_180 ;
int V_236 ;
V_180 = F_107 ( V_317 , struct V_316 , V_362 ) ;
V_236 = F_90 ( V_344 -> V_355 -> V_278 , V_180 ) ;
V_351 += V_236 ;
}
}
F_73 ( V_274 , V_50 , V_344 -> V_355 -> V_278 ) ;
F_108 ( & V_274 -> V_320 , V_344 -> V_42 ) ;
...
V_345 = 1 ;
V_50 -> V_32 |= V_365 ;
F_72 ( V_321 + 0 , L_33 , V_322 , sizeof( * V_274 ) , V_274 ) ;
F_83 ( V_303 , V_50 -> V_366 , V_50 -> V_72 ) ;
F_72 ( V_321 + 1 , L_33 , V_367 , sizeof( * V_303 ) , V_303 ) ;
V_348 = 2 ;
...
F_72 ( & V_321 [ V_348 ++ ] , L_33 , V_369 ,
V_49 * sizeof( V_133 ) , V_352 ) ;
if ( ( V_274 -> V_323 =
F_92 ( V_50 , V_344 -> V_42 , V_324 ) ) )
F_72 ( V_321 + V_348 ++ ,
...
V_236 += F_65 ( V_321 + V_49 ) ;
V_236 += V_351 ;
V_353 = F_9 ( sizeof( * V_353 ) , V_25 ) ;
if ( ! V_353 )
goto V_371;
F_71 ( V_353 , V_236 , V_268 ) ;
V_268 += V_236 ;
}
V_347 = V_268 = F_66 ( V_268 , V_372 ) ;
V_268 += F_101 ( V_344 -> V_220 ) ;
V_268 += F_112 () ;
V_261 = V_268 ;
if ( V_23 == V_364 ) {
...
if ( ! V_329 )
goto V_371;
F_95 ( V_246 , V_329 , V_261 , V_183 ) ;
}
V_268 = V_347 ;
V_17 += sizeof( * V_246 ) ;
if ( V_17 > V_344 -> V_336 || ! F_98 ( V_344 -> V_4 , V_246 , sizeof( * V_246 ) ) )
goto V_371;
V_17 += sizeof( * V_353 ) ;
if ( V_17 > V_344 -> V_336
|| ! F_98 ( V_344 -> V_4 , V_353 , sizeof( * V_353 ) ) )
goto V_371;
for ( V_219 = V_50 -> V_72 -> V_12 ; V_219 ; V_219 = V_219 -> V_338 ) {
struct V_21 V_16 ;
T_5 V_236 ;
...
V_16 . V_270 = 0 ;
V_16 . V_56 = F_62 ( V_219 , V_344 -> V_220 ) ? V_236 : 0 ;
V_16 . V_36 = V_236 ;
V_268 += V_16 . V_56 ;
...
V_17 += sizeof( V_16 ) ;
if ( V_17 > V_344 -> V_336
|| ! F_98 ( V_344 -> V_4 , & V_16 , sizeof( V_16 ) ) )
goto V_371;
}
if ( ! F_113 ( V_344 -> V_4 , V_268 , & V_17 , V_344 -> V_336 ) )
goto V_371;
for ( V_49 = 0 ; V_49 < V_348 ; V_49 ++ )
if ( ! F_69 ( V_321 + V_49 , V_344 -> V_4 , & V_240 ) )
goto V_371;
F_106 (t, &thread_list) {
struct V_316 * V_180 =
F_107 ( V_317 , struct V_316 , V_362 ) ;
for ( V_49 = 0 ; V_49 < V_180 -> V_319 ; V_49 ++ )
if ( ! F_69 ( & V_180 -> V_321 [ V_49 ] , V_344 -> V_4 , & V_240 ) )
goto V_371;
}
if ( ! F_100 ( V_344 -> V_4 , V_347 - V_240 ) )
goto V_371;
if ( F_96 ( V_344 -> V_4 , & V_17 , & V_344 -> V_336 ,
V_344 -> V_220 ) < 0 )
goto V_371;
if ( ! F_114 ( V_344 -> V_4 , & V_17 , V_344 -> V_336 ) )
goto V_371;
if ( V_23 == V_364 ) {
V_17 += sizeof( * V_329 ) ;
if ( V_17 > V_344 -> V_336
|| ! F_98 ( V_344 -> V_4 , V_329 ,
sizeof( * V_329 ) ) )
goto V_371;
}
...
F_116 ( V_180 ) ;
F_40 ( F_107 ( V_180 , struct V_316 , V_362 ) ) ;
}
F_40 ( V_353 ) ;
F_40 ( V_246 ) ;
F_40 ( V_274 ) ;
