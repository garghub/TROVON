...
struct V_7 * V_8 = V_6 -> V_8 ;
if ( V_8 -> V_100 . V_101 ) {
struct V_31 * V_22 = V_8 -> V_100 . V_101 ;
int V_19 ;
for ( V_19 = 0 ; V_19 < V_8 -> V_100 . V_102 ; V_19 ++ )
F_55 ( V_22 [ V_19 ] . V_36 ) ;
}
F_56 ( & V_8 -> V_100 ) ;
}
static void F_57 ( struct V_5 * V_6 , T_1 V_103 ,
T_1 V_104 )
{
struct V_7 * V_8 = V_6 -> V_8 ;
if ( F_58 ( V_6 , V_103 ) & V_105 )
F_59 ( V_6 , V_103 , 0 , V_106 ,
! V_8 -> V_107 ? 0x00 : 0x02 ) ;
if ( F_58 ( V_6 , V_104 ) & V_105 )
F_59 ( V_6 , V_104 , 0 , V_106 ,
! V_8 -> V_107 ? 0x00 : 0x02 ) ;
}
...
return - V_37 ;
V_6 -> V_8 = V_8 ;
F_88 ( & V_8 -> V_100 , sizeof( struct V_31 ) , 32 ) ;
return 0 ;
}
...
F_91 ( V_8 , 0x18 , 0 , V_41 ) ;
V_8 -> V_26 . V_87 = 6 ;
V_8 -> V_26 . V_126 = F_92 ( V_127 ) ;
V_8 -> V_26 . V_88 = V_127 ;
V_8 -> V_26 . V_27 = V_128 ;
V_8 -> V_92 = 1 ;
V_8 -> V_76 = V_129 ;
...
static int F_95 ( struct V_1 * V_2 , struct V_3 * V_4 )
{
...
static int F_96 ( struct V_1 * V_2 , struct V_10 * V_11 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
struct V_7 * V_8 = V_6 -> V_8 ;
...
F_91 ( V_8 , 0x10 , 0 , V_41 ) ;
V_8 -> V_26 . V_87 = 2 ;
V_8 -> V_26 . V_126 = F_92 ( V_173 ) ;
V_8 -> V_26 . V_88 = V_173 ;
V_8 -> V_26 . V_27 = V_174 ;
V_8 -> V_92 = 1 ;
V_8 -> V_76 = V_175 ;
...
if ( ! F_67 ( V_2 , V_11 ) )
return 0 ;
F_100 ( V_6 , 0x05 , V_8 -> V_109 ? V_181 : 0 ) ;
...
F_91 ( V_8 , 0x0d , 0 , V_41 ) ;
V_8 -> V_26 . V_87 = 2 ;
V_8 -> V_26 . V_126 = F_92 ( V_188 ) ;
V_8 -> V_26 . V_88 = V_188 ;
V_8 -> V_26 . V_27 = V_189 ;
V_8 -> V_92 = 1 ;
V_8 -> V_76 = V_190 ;
...
V_8 -> V_26 . V_27 = 0 ;
V_8 -> V_9 = & V_202 ;
V_6 -> V_136 . V_161 = F_104 ;
V_6 -> V_136 . V_160 = F_103 ;
F_106 ( V_6 , 0x11 , V_203 ,
( 0x17 << V_204 ) |
( 0x17 << V_205 ) |
( 0x05 << V_206 ) |
( 1 << V_207 ) ) ;
...
struct V_5 * V_6 = F_2 ( V_2 ) ;
struct V_7 * V_8 = V_6 -> V_8 ;
return F_108 ( V_6 , V_4 , V_8 -> V_144 ,
V_8 -> V_146 ) ;
}
...
struct V_5 * V_6 = F_2 ( V_2 ) ;
struct V_7 * V_8 = V_6 -> V_8 ;
return F_110 ( V_6 , V_11 , V_8 -> V_144 ,
...
struct V_5 * V_6 = F_2 ( V_2 ) ;
struct V_7 * V_8 = V_6 -> V_8 ;
int V_23 = F_112 ( V_6 , V_11 , V_8 -> V_144 ,
V_8 -> V_146 ,
& V_8 -> V_26 . V_87 ) ;
if ( V_23 >= 0 && V_8 -> V_147 )
...
struct V_5 * V_6 = F_2 ( V_2 ) ;
unsigned int V_214 ;
V_214 = F_115 ( V_6 , 0x1d , 0 , V_215 ,
V_216 ) ;
if ( ! ( V_214 & 0x80 ) )
V_11 -> V_14 . V_15 . V_16 [ 0 ] = 0 ;
else {
V_214 = F_115 ( V_6 , 0x0b , 0 ,
V_217 , 0 ) ;
if ( V_214 < 3 )
V_214 ++ ;
else
...
static void F_119 ( struct V_5 * V_6 , unsigned int V_113 )
{
if ( ( V_113 >> 26 ) != V_219 )
return;
if ( F_70 ( V_6 , 0x11 ) )
...
static int F_120 ( struct V_7 * V_8 , int type , const char * V_36 ,
unsigned long V_218 )
{
struct V_31 * V_32 ;
V_32 = F_121 ( & V_8 -> V_100 ) ;
if ( ! V_32 )
return - V_37 ;
* V_32 = V_222 [ type ] ;
V_32 -> V_36 = F_122 ( V_36 , V_124 ) ;
if ( ! V_32 -> V_36 )
return - V_37 ;
if ( F_123 ( V_218 ) )
V_32 -> V_223 = V_224 ;
...
static inline T_1 F_124 ( struct V_5 * V_6 , int V_225 )
{
...
int V_19 ;
for ( V_19 = 0 ; V_19 < F_92 ( V_228 ) ; V_19 ++ )
if ( V_228 [ V_19 ] == V_49 )
return V_19 ;
return 0 ;
}
...
return 6 ;
default:
return V_229 [ F_126 ( V_49 ) ] ;
}
}
static int F_128 ( T_1 V_49 )
{
...
V_225 = F_126 ( V_232 -> V_235 [ V_19 ] ) ;
V_8 -> V_233 [ V_19 ] = F_124 ( V_6 , V_225 ) ;
}
...
if ( ! V_237 )
continue;
V_49 = V_238 [ F_126 ( V_232 -> V_235 [ V_19 ] ) ] ;
if ( V_19 == 2 ) {
V_23 = F_120 ( V_8 , V_239 ,
L_23 ,
F_131 ( V_237 , 1 , 0 , V_41 ) ) ;
if ( V_23 < 0 )
return V_23 ;
V_23 = F_120 ( V_8 , V_239 ,
L_24 ,
F_131 ( V_237 , 2 , 0 , V_41 ) ) ;
if ( V_23 < 0 )
return V_23 ;
V_23 = F_120 ( V_8 , V_240 ,
L_25 ,
F_131 ( V_49 , 1 , 2 , V_203 ) ) ;
if ( V_23 < 0 )
return V_23 ;
V_23 = F_120 ( V_8 , V_240 ,
L_26 ,
F_131 ( V_49 , 2 , 2 , V_203 ) ) ;
if ( V_23 < 0 )
return V_23 ;
} else {
sprintf ( V_36 , L_27 , V_236 [ V_19 ] ) ;
V_23 = F_120 ( V_8 , V_239 , V_36 ,
F_131 ( V_237 , 3 , 0 , V_41 ) ) ;
if ( V_23 < 0 )
return V_23 ;
sprintf ( V_36 , L_28 , V_236 [ V_19 ] ) ;
V_23 = F_120 ( V_8 , V_240 , V_36 ,
F_131 ( V_49 , 3 , 2 , V_203 ) ) ;
if ( V_23 < 0 )
return V_23 ;
}
}
...
static int F_132 ( struct V_5 * V_6 , T_1 V_241 ,
const char * V_242 )
{
struct V_7 * V_8 = V_6 -> V_8 ;
T_1 V_49 ;
...
if ( ( V_23 = F_120 ( V_8 , V_240 , V_36 ,
F_131 ( V_49 , 3 , 2 , V_203 ) ) ) < 0 )
return V_23 ;
return 0 ;
}
static int F_133 ( struct V_7 * V_8 , T_1 V_241 ,
...
V_225 = F_127 ( V_241 ) ;
if ( ( V_23 = F_120 ( V_8 , V_239 , V_36 ,
F_131 ( 0x20 , 3 , V_225 , V_203 ) ) ) < 0 )
return V_23 ;
sprintf ( V_36 , L_28 , V_245 ) ;
if ( ( V_23 = F_120 ( V_8 , V_248 , V_36 ,
F_131 ( 0x20 , 3 , V_225 , V_203 ) ) ) < 0 )
return V_23 ;
if ( V_247 ) {
T_1 V_249 ;
...
return F_120 ( V_8 , V_239 , V_36 ,
F_131 ( V_249 , 3 , V_225 , V_41 ) ) ;
}
}
return 0 ;
}
...
V_256 = F_135 ( V_6 , V_232 , V_19 ) ;
F_136 ( V_252 , V_256 ,
F_128 ( V_232 -> V_257 [ V_19 ] . V_241 ) ,
& V_254 ) ;
V_23 = F_133 ( V_8 , V_232 -> V_257 [ V_19 ] . V_241 ,
V_256 , V_254 ,
type == V_258 ) ;
if ( V_23 < 0 )
return V_23 ;
}
F_136 ( V_252 , L_30 , 9 , NULL ) ;
if ( ( V_23 = F_120 ( V_8 , V_239 ,
L_31 ,
F_131 ( 0x21 , 3 , 0x0 , V_41 ) ) ) < 0 )
return V_23 ;
if ( ( V_23 = F_120 ( V_8 , V_248 ,
L_32 ,
F_131 ( 0x21 , 3 , 0x0 , V_41 ) ) ) < 0 )
return V_23 ;
return 0 ;
...
if ( V_241 )
F_137 ( V_6 , V_241 , V_181 , 0 ) ;
V_241 = V_8 -> V_243 . V_263 [ 0 ] ;
if ( V_241 )
F_137 ( V_6 , V_241 , V_264 , 0 ) ;
}
...
V_218 = V_265 ;
if ( type == V_258 )
V_218 |= F_141 ( V_6 , V_49 ) ;
F_100 ( V_6 , V_49 , V_218 ) ;
if ( V_49 != V_230 )
...
struct V_7 * V_8 = V_6 -> V_8 ;
int V_23 ;
if ( ( V_23 = F_143 ( V_6 , & V_8 -> V_243 , NULL ) ) < 0 )
return V_23 ;
if ( ( V_23 = F_129 ( V_6 , & V_8 -> V_243 ) ) < 0 )
return V_23 ;
if ( ! V_8 -> V_243 . V_234 )
return 0 ;
if ( ( V_23 = F_130 ( V_8 , & V_8 -> V_243 ) ) < 0 ||
( V_23 = F_132 ( V_6 ,
V_8 -> V_243 . V_262 [ 0 ] ,
L_33 ) ) < 0 ||
( V_23 = F_132 ( V_6 , V_8 -> V_243 . V_263 [ 0 ] ,
L_34 ) ) < 0 ||
( V_23 = F_134 ( V_6 , & V_8 -> V_243 ) ) < 0 )
return V_23 ;
...
V_8 -> V_29 = V_271 ;
if ( V_8 -> V_100 . V_101 )
V_8 -> V_25 [ V_8 -> V_24 ++ ] = V_8 -> V_100 . V_101 ;
...
if ( V_8 -> V_29 && V_6 -> V_108 < 0x11d4989a ) {
...
switch ( V_125 ) {
case V_278 :
V_6 -> V_136 . V_161 = F_144 ;
break;
case V_297 :
case V_298 :
V_6 -> V_136 . V_160 = F_119 ;
break;
}
#ifdef F_93
...
static int F_150 ( struct V_69 * V_70 ,
struct V_5 * V_6 ,
struct V_71 * V_72 )
{
...
return V_23 ;
V_8 = V_6 -> V_8 ;
V_125 = F_94 ( V_6 , V_328 ,
V_329 , V_330 ) ;
switch ( V_125 ) {
case V_331 :
V_8 -> V_25 [ V_8 -> V_24 ++ ] = V_332 ;
V_6 -> V_136 . V_333 = F_151 ;
break;
case V_334 :
...
static void F_157 ( struct V_5 * V_6 , unsigned int V_113 )
{
switch ( V_113 >> 26 ) {
case V_344 :
F_155 ( V_6 ) ;
...
V_8 -> V_21 [ 0 ] = V_372 ;
V_8 -> V_26 . V_27 = 0 ;
V_6 -> V_136 . V_160 = F_170 ;
V_6 -> V_136 . V_161 = F_171 ;
F_106 ( V_6 , 0x20 , V_203 ,
( 0x17 << V_204 ) |
( 0x17 << V_205 ) |
( 0x05 << V_206 ) |
...
{
bool V_115 = F_70 ( V_6 , 0x11 ) ;
F_59 ( V_6 , 0x12 , 0 , V_373 ,
V_115 ? 0 : V_181 ) ;
}
...
static void F_175 ( struct V_5 * V_6 , unsigned int V_113 )
{
switch ( V_113 >> 26 ) {
case V_374 :
F_173 ( V_6 ) ;
...
V_8 -> V_21 [ V_8 -> V_20 ++ ] =
V_392 ;
V_6 -> V_136 . V_160 = F_175 ;
V_6 -> V_136 . V_161 = F_174 ;
}
break;
case V_393 :
V_8 -> V_24 = 3 ;
