...
static void T_5
F_119 ( struct V_3 * V_4 , int * V_135 ,
int * V_60 , int * V_178 )
{
unsigned int V_14 ;
...
V_179 = F_120 ( V_4 ) ;
F_106 ( V_4 ) ;
* V_135 = F_121 () / ( 16 * V_179 ) ;
}
F_122 ( L_18 , V_146 , * V_135 , * V_60 , * V_178 ) ;
}
static void F_123 ( struct V_1 * V_2 , int V_38 )
{
struct V_3 * V_4 = (struct V_3 * ) V_2 ;
while ( ! ( F_13 ( V_4 ) & V_70 ) )
F_124 () ;
...
static void
F_125 ( struct V_182 * V_183 , const char * V_184 , unsigned int V_185 )
{
struct V_3 * V_4 = V_186 [ V_183 -> V_187 ] ;
unsigned long V_87 ;
F_56 ( & V_4 -> V_2 . V_75 , V_87 ) ;
F_126 ( & V_4 -> V_2 , V_184 , V_185 , F_123 ) ;
F_59 ( & V_4 -> V_2 . V_75 , V_87 ) ;
}
static int T_5
F_127 ( struct V_182 * V_183 , char * V_188 )
{
struct V_3 * V_4 ;
int V_135 = 57600 ;
int V_178 = 8 ;
...
return - V_191 ;
if ( V_188 )
F_128 ( V_188 , & V_135 , & V_60 , & V_178 , & V_189 ) ;
else
F_119 ( V_4 , & V_135 , & V_60 , & V_178 ) ;
return F_129 ( & V_4 -> V_2 , V_183 , V_135 , V_60 , V_178 , V_189 ) ;
}
static void
F_130 ( struct V_182 * V_183 , const char * V_184 , unsigned int V_185 )
{
unsigned long V_87 ;
if ( V_192 . V_2 . line != V_183 -> V_187 )
return;
F_56 ( & V_192 . V_2 . V_75 , V_87 ) ;
F_126 ( & V_192 . V_2 , V_184 , V_185 ,
F_123 ) ;
F_59 ( & V_192 . V_2 . V_75 , V_87 ) ;
}
static int F_131 ( struct V_193 * V_194 , T_6 V_17 )
{
struct V_3 * V_4 = F_132 ( V_194 ) ;
return F_133 ( & V_195 , & V_4 -> V_2 ) ;
}
static int F_134 ( struct V_193 * V_194 )
{
struct V_3 * V_4 = F_132 ( V_194 ) ;
return F_135 ( & V_195 , & V_4 -> V_2 ) ;
}
static int F_136 ( struct V_193 * V_194 )
{
struct V_196 * V_197 ;
struct V_3 * V_4 = NULL ;
int V_198 = 0 ;
if ( V_194 -> V_199 < 0 || V_194 -> V_199 >= V_190 ) {
F_137 ( & V_194 -> V_130 , L_19 ) ;
return - V_200 ;
}
if ( V_186 [ V_194 -> V_199 ] == NULL ) {
V_4 = F_138 ( sizeof( * V_4 ) , V_201 ) ;
if ( ! V_4 ) {
F_137 ( & V_194 -> V_130 ,
L_20 ) ;
return - V_202 ;
...
V_4 -> V_2 . V_210 = V_211 ;
V_4 -> V_2 . V_87 = V_212 ;
V_197 = F_142 ( V_194 , V_213 , 0 ) ;
if ( V_197 == NULL ) {
F_137 ( & V_194 -> V_130 , L_22 ) ;
V_198 = - V_200 ;
goto V_214;
}
V_4 -> V_2 . V_203 = F_143 ( V_197 -> V_215 , F_144 ( V_197 ) ) ;
if ( ! V_4 -> V_2 . V_203 ) {
F_137 ( & V_194 -> V_130 , L_23 ) ;
V_198 = - V_216 ;
goto V_214;
}
V_4 -> V_2 . V_217 = V_197 -> V_215 ;
V_4 -> V_116 = F_145 ( V_194 , 0 ) ;
if ( V_4 -> V_116 < 0 ) {
F_137 ( & V_194 -> V_130 , L_24 ) ;
V_198 = - V_200 ;
goto V_218;
}
V_4 -> V_115 = F_145 ( V_194 , 1 ) ;
if ( V_4 -> V_115 < 0 ) {
F_137 ( & V_194 -> V_130 , L_25 ) ;
V_198 = - V_200 ;
goto V_218;
}
V_4 -> V_2 . V_12 = V_4 -> V_115 ;
V_4 -> V_128 = F_145 ( V_194 , 2 ) ;
if ( V_4 -> V_128 < 0 ) {
F_137 ( & V_194 -> V_130 , L_26 ) ;
V_198 = - V_200 ;
goto V_218;
}
#ifdef F_12
...
V_4 -> V_29 = 1 ;
V_4 -> V_25 = 0 ;
V_197 = F_142 ( V_194 , V_219 , 0 ) ;
if ( V_197 == NULL ) {
F_137 ( & V_194 -> V_130 , L_27 ) ;
V_198 = - V_200 ;
goto V_218;
}
V_4 -> V_23 = V_197 -> V_215 ;
V_197 = F_142 ( V_194 , V_219 , 1 ) ;
if ( V_197 == NULL ) {
F_137 ( & V_194 -> V_130 , L_28 ) ;
V_198 = - V_200 ;
goto V_218;
}
...
F_149 ( & V_194 -> V_130 , V_4 ) ;
V_198 = F_150 ( & V_195 , & V_4 -> V_2 ) ;
#ifdef F_147
}
#endif
if ( ! V_198 )
...
static int F_160 ( struct V_193 * V_194 )
{
struct V_196 * V_197 ;
int V_198 ;
if ( V_194 -> V_199 < 0 || V_194 -> V_199 >= V_190 ) {
F_137 ( & V_194 -> V_130 , L_29 ) ;
return - V_200 ;
}
V_198 = F_140 (
( unsigned short * ) V_194 -> V_130 . V_204 , V_127 ) ;
...
V_192 . V_2 . V_203 = F_143 ( V_197 -> V_215 ,
F_144 ( V_197 ) ) ;
if ( ! V_192 . V_2 . V_203 ) {
F_137 ( & V_194 -> V_130 , L_23 ) ;
V_198 = - V_216 ;
...
V_192 . V_2 . line = V_194 -> V_199 ;
V_192 . V_2 . V_164 = F_121 () ;
V_192 . V_2 . V_206 = V_207 ;
F_141 ( & V_192 . V_2 . V_75 ) ;
return 0 ;
V_214:
F_152 (
( unsigned short * ) V_194 -> V_130 . V_204 ) ;
...
struct V_182 T_5 * F_161 ( unsigned int V_2 ,
unsigned int V_225 )
{
struct V_133 V_226 ;
char V_227 [ 20 ] ;
