...
V_117 = F_7 ( V_107 ) ;
if ( V_112 != ( V_117 & 0x3f ) ) {
F_58 ( V_121 , V_107 , ( V_117 & ~ 0x3f ) | V_112 ) ;
V_116 = 1 ;
}
...
T_1 * V_1 = F_53 ( V_98 ) ;
struct V_4 * V_5 = V_1 -> V_5 ;
T_2 V_122 = V_98 -> V_123 ;
V_102 -> V_102 . integer . V_102 [ 0 ] = ! ( F_7 ( V_107 ) & V_122 ) ;
return 0 ;
}
...
F_57 ( & V_1 -> V_82 ) ;
V_106 = F_7 ( V_107 ) ;
if ( V_102 -> V_102 . integer . V_102 [ 0 ] != ! ( V_106 & V_122 ) ) {
V_106 ^= V_122 ;
F_58 ( V_121 , V_107 , V_106 ) ;
if ( ( V_5 -> V_118 . V_119 == V_120 ) &&
( ( 1 << 6 ) == V_122 ) )
F_55 ( V_5 , V_124 , 0 != ( V_106 & V_122 ) ) ;
V_66 = 1 ;
}
F_59 ( & V_1 -> V_82 ) ;
return V_66 ;
...
struct V_4 * V_5 = V_1 -> V_5 ;
T_6 V_125 ;
V_125 = F_63 ( V_5 , V_126 ) ;
V_102 -> V_102 . integer . V_102 [ 0 ] = V_125 ? 1 : 0 ;
return 0 ;
}
...
V_128 . V_102 = 0 != V_102 -> V_102 . integer . V_102 [ 0 ] ;
V_128 . V_129 = V_126 ;
F_65 ( V_5 , V_130 , V_5 , V_131 , & V_128 ) ;
return 0 ;
}
...
static void F_70 ( struct V_132 * V_93 )
{
T_1 * V_1 = V_93 -> V_94 ;
F_66 ( V_1 ) ;
}
static int F_71 ( struct V_132 * V_93 , struct V_133 * V_47 ,
T_1 * * V_134 ,
struct V_4 * * V_135 )
{
T_1 * V_1 ;
...
F_79 ( V_47 , V_140 , & V_136 ) ;
F_6 ( 1 , L_15
L_16 , V_5 -> V_33 , V_141 ,
F_80 ( V_47 ) , V_47 -> V_142 , V_47 -> V_38 ,
V_136 , ( unsigned long long ) F_81 ( V_47 , 0 ) ) ;
V_1 -> V_38 = V_47 -> V_38 ;
F_82 ( V_1 -> V_38 ) ;
F_83 ( V_93 , & V_47 -> V_48 ) ;
* V_134 = V_1 ;
...
static int F_84 ( struct V_133 * V_47 ,
...
V_53 = F_85 ( V_148 [ V_141 ] , V_129 [ V_141 ] , V_149 ,
sizeof( T_1 ) , & V_93 ) ;
if ( V_53 < 0 )
return V_53 ;
V_93 -> V_150 = F_70 ;
...
if ( V_53 < 0 )
goto error;
V_53 = F_86 ( V_93 , F_87 ( & V_152 , V_1 ) ) ;
if ( V_53 < 0 )
goto error;
V_53 = F_86 ( V_93 , F_87 ( & V_153 , V_1 ) ) ;
if ( V_53 < 0 )
goto error;
if ( V_5 -> V_118 . V_119 == V_120 )
F_86 ( V_93 , F_87 ( & V_154 , V_1 ) ) ;
strcpy ( V_93 -> V_155 , L_18 ) ;
sprintf ( V_93 -> V_156 , L_19 , V_47 -> V_90 ) ;
sprintf ( V_93 -> V_157 , L_20 ,
V_93 -> V_156 , ( unsigned long long ) F_81 ( V_47 , 0 ) ) ;
...
static void F_91 ( struct V_133 * V_47 )
{
struct V_159 * V_93 = F_92 ( V_47 ) ;
F_90 ( ( void * ) V_93 ) ;
F_89 ( V_47 , NULL ) ;
V_141 -- ;
}
