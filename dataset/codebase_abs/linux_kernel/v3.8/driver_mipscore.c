...
{
struct V_12 * V_13 = V_2 -> V_4 -> V_13 ;
T_1 V_50 , V_51 , V_52 , V_53 = 0 ;
if ( V_13 -> V_33 . V_41 & V_54 )
return F_23 ( & V_13 -> V_33 ) ;
if ( F_15 ( & V_13 -> V_30 ) ) {
F_24 ( & V_13 -> V_30 , & V_50 , & V_51 , & V_52 ) ;
} else if ( F_17 ( & V_13 -> V_33 ) ) {
F_25 ( & V_13 -> V_33 , & V_50 , & V_51 , & V_52 ) ;
} else
return 0 ;
if ( ( V_50 == V_55 ) || ( V_13 -> V_56 == 0x5365 ) ) {
V_53 = 200000000 ;
} else {
V_53 = F_26 ( V_50 , V_51 , V_52 ) ;
}
if ( V_50 == V_57 ) {
V_53 *= 2 ;
}
...
if ( V_4 -> V_21 > 5 )
continue;
switch ( V_4 -> V_61 . V_62 ) {
case V_63 :
if ( ( V_13 -> V_56 == 0x4710 ) && ( V_21 <= 4 ) ) {
F_9 ( V_4 , V_21 ++ ) ;
}
break;
case V_64 :
