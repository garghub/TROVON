...
int F_29 ( struct V_2 * V_3 , void * V_94 ,
struct V_95 * V_96 )
{
struct V_97 * V_98 = F_30 ( V_96 ) -> V_98 ;
struct V_4 * V_5 = F_1 ( V_3 ) ;
struct V_1 * V_82 = V_5 -> V_6 ;
struct V_24 * V_25 =
(struct V_24 * ) V_94 ;
...
if ( ! F_28 ( V_5 ) )
return - V_101 ;
V_76 = F_31 ( V_5 , V_98 , & V_25 -> V_16 , & V_100 ) ;
if ( V_76 )
return V_76 ;
F_22 ( & V_82 -> V_89 ) ;
if ( ! V_25 -> V_102 ) {
...
V_76 = F_32 ( V_98 , V_25 -> V_104 , & V_23 ) ;
if ( V_76 )
goto V_103;
...
return 0 ;
F_22 ( & V_82 -> V_89 ) ;
for ( V_30 = 0 , V_105 = 0 ; V_30 < V_90 ; V_30 ++ )
if ( ! V_82 -> V_84 [ V_30 ] . V_106 )
V_105 ++ ;
F_24 ( & V_82 -> V_89 ) ;
return V_105 ;
}
int F_36 ( struct V_4 * V_5 , T_1 * V_107 )
{
struct V_1 * V_82 = V_5 -> V_6 ;
int V_30 ;
if ( ! V_82 )
...
return - V_101 ;
F_22 ( & V_82 -> V_89 ) ;
F_23 ( ! V_82 -> V_84 [ V_16 ] . V_106 ) ;
F_16 ( V_5 , V_16 , false , false ) ;
V_82 -> V_84 [ V_16 ] . V_106 = false ;
F_24 ( & V_82 -> V_89 ) ;
return 0 ;
}
