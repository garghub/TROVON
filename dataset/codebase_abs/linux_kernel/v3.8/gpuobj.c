...
V_2 -> V_6 = V_6 ;
if ( V_9 ) {
V_26 = F_15 ( V_9 , 1 , V_6 , V_6 ,
F_16 ( V_18 , ( T_1 ) 1 ) , & V_2 -> V_7 ) ;
if ( V_26 )
return V_26 ;
...
void
F_21 ( struct V_12 * V_41 )
{
F_1 ( F_4 ( V_41 ) ) ;
}
int
F_22 ( struct V_12 * V_41 )
{
return F_23 ( F_4 ( V_41 ) ) ;
}
int
F_24 ( struct V_12 * V_41 , bool V_42 )
{
return F_25 ( F_4 ( V_41 ) , V_42 ) ;
}
T_1
F_26 ( struct V_12 * V_41 , T_2 V_27 )
{
struct V_1 * V_2 = F_4 ( V_41 ) ;
struct V_43 * V_44 = F_27 ( V_2 -> V_8 ) ;
if ( V_2 -> V_7 )
V_27 += V_2 -> V_7 -> V_36 ;
return V_44 -> V_45 ( V_2 -> V_8 , V_27 ) ;
}
void
F_28 ( struct V_12 * V_41 , T_2 V_27 , T_1 V_39 )
{
struct V_1 * V_2 = F_4 ( V_41 ) ;
struct V_43 * V_44 = F_27 ( V_2 -> V_8 ) ;
if ( V_2 -> V_7 )
V_27 += V_2 -> V_7 -> V_36 ;
V_44 -> V_46 ( V_2 -> V_8 , V_27 , V_39 ) ;
}
int
...
static void
F_40 ( struct V_12 * V_41 )
{
struct V_1 * V_2 = ( void * ) V_41 ;
F_13 ( NULL , & V_2 -> V_8 ) ;
F_6 ( & V_2 -> V_11 ) ;
}
int
F_41 ( struct V_12 * V_8 , struct V_1 * V_11 ,
struct V_1 * * V_47 )
{
struct V_1 * V_2 ;
int V_26 ;
V_26 = F_42 ( V_8 , V_8 -> V_13 ,
& V_57 , 0 , & V_2 ) ;
* V_47 = V_2 ;
if ( V_26 )
return V_26 ;
F_13 ( F_20 ( V_11 ) , & V_2 -> V_8 ) ;
V_2 -> V_27 = V_11 -> V_27 ;
V_2 -> V_6 = V_11 -> V_6 ;
return 0 ;
}
