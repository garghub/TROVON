...
int F_26 ( struct V_1 * V_21 , T_3 V_52 , struct V_53 T_2 * V_54 )
{
int V_55 = 0 , V_56 , V_5 ;
struct V_3 * V_4 , * V_10 ;
F_11 () ;
...
return 0 ;
F_20 ( V_60 ) ;
V_10 = (struct V_3 * ) * V_61 -> V_25 ;
V_10 -> V_40 ++ ;
* V_60 -> V_25 = ( long ) V_10 ;
return 0 ;
}
int F_29 ( struct V_1 * V_21 , T_3 V_52 , T_3 T_2 * V_63 , struct V_53 T_2 * V_54 )
{
int V_5 , V_6 , V_15 , V_64 ;
T_1 * * V_16 , * V_17 ;
struct V_3 * V_4 ;
F_11 () ;
V_64 = 0 ;
...
F_15 ( V_64 , V_63 ) ;
F_13 () ;
return ( ( V_64 <= V_52 ) ? 0 : - V_46 ) ;
}
T_5 F_30 ( unsigned char V_65 )
{
