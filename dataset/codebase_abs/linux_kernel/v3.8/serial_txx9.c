...
static int F_82 ( struct V_181 * V_159 )
{
...
static int F_84 ( struct V_181 * V_159 )
{
int V_160 ;
for ( V_160 = 0 ; V_160 < V_161 ; V_160 ++ ) {
struct V_1 * V_2 = & V_162 [ V_160 ] ;
...
static int F_85 ( struct V_181 * V_159 , T_3 V_38 )
{
int V_160 ;
for ( V_160 = 0 ; V_160 < V_161 ; V_160 ++ ) {
struct V_1 * V_2 = & V_162 [ V_160 ] ;
...
static void F_96 ( struct V_184 * V_159 )
{
...
static int F_98 ( struct V_184 * V_159 , T_3 V_38 )
{
struct V_1 * V_2 = F_97 ( V_159 ) ;
if ( V_2 )
F_86 ( & V_179 , & V_2 -> V_4 ) ;
