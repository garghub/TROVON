...
V_10 = V_114 ;
if ( V_33 . V_13 > V_115 && V_32 . V_13 == V_14 )
V_10 = V_116 ;
if ( V_33 . V_15 == V_117 && V_32 . V_15 < V_118 )
V_10 = V_119 ;
if ( V_33 . V_13 == V_106 && V_32 . V_13 < V_106 && V_32 . V_13 != V_115 )
V_10 = V_120 ;
if ( V_33 . V_15 == V_38 && V_32 . V_15 == V_118 )
V_10 = V_66 ;
if ( F_55 ( V_121 , & V_7 -> V_46 ) &&
! ( V_32 . V_15 == V_31 ||
( V_33 . V_15 == V_31 && V_32 . V_15 == V_117 ) ) )
V_10 = V_66 ;
...
static enum V_43
F_56 ( enum V_29 V_124 , enum V_29 V_85 )
{
if ( V_124 == V_85 )
return V_125 ;
if ( V_124 == V_16 && V_85 == V_38 )
return V_114 ;
if ( V_124 == V_16 && V_85 != V_118 )
return V_122 ;
if ( V_124 < V_31 && V_85 >= V_34 )
return V_122 ;
if ( V_124 >= V_126 && V_124 <= V_127 && V_85 != V_118 && V_85 != V_38 )
return V_66 ;
if ( V_124 == V_38 && V_85 != V_16 )
return V_66 ;
return V_53 ;
}
static enum V_43
...
static void F_57 ( struct V_8 * V_9 , enum V_128 V_129 )
{
...
if ( V_129 != V_131 )
F_58 ( V_68 , L_13 , V_130 [ V_129 ] ) ;
}
static union V_1 F_27 ( struct V_8 * V_9 , union V_1 V_33 ,
enum V_128 * V_129 )
{
enum V_82 V_83 ;
enum V_25 V_137 , V_138 , V_139 , V_140 ;
if ( V_129 )
* V_129 = V_131 ;
V_83 = V_86 ;
if ( F_52 ( V_9 ) ) {
...
if ( V_129 )
* V_129 = V_33 . V_15 == V_39 || V_33 . V_15 == V_108 ?
V_132 : V_133 ;
V_33 . V_15 = V_34 ;
}
if ( V_33 . V_15 < V_34 && V_33 . V_13 == V_141 &&
F_59 ( V_9 , V_141 ) ) {
if ( V_9 -> V_142 == V_9 -> V_87 -> V_143 . V_144 [ V_145 ] ) {
V_33 . V_13 = V_9 -> V_146 . V_13 ;
V_33 . V_28 = V_9 -> V_146 . V_28 ;
} else {
if ( V_129 )
* V_129 = V_134 ;
V_33 . V_13 = V_14 ;
...
if ( V_33 . V_15 >= V_34 && V_33 . V_15 < V_147 ) {
if ( V_33 . V_13 == V_148 || V_33 . V_13 == V_106 )
V_33 . V_13 = V_95 ;
if ( V_33 . V_28 == V_148 || V_33 . V_28 == V_106 )
V_33 . V_28 = V_95 ;
}
V_137 = V_14 ;
V_138 = V_95 ;
...
{
if ( F_26 ( V_160 , & V_9 -> V_46 ) )
F_49 ( V_68 , L_21 ) ;
}
static void F_61 ( struct V_8 * V_9 , enum V_29 V_161 )
{
if ( V_9 -> V_7 -> V_111 < 90 )
V_9 -> V_162 = 0 ;
V_9 -> V_163 = F_62 ( V_9 ) ;
...
unsigned long V_166 = F_63 ( V_9 -> V_162 ) ;
if ( V_166 >= V_9 -> V_163 ) {
V_9 -> V_162 =
F_64 ( V_9 -> V_163 - 1 ) ;
V_9 -> V_163 = 1 ;
...
if ( V_171 != V_172 )
F_68 ( V_9 -> V_7 ) ;
if ( V_32 . V_13 == V_115 && V_33 . V_13 >= V_141 )
F_69 ( V_9 , L_22 ) ;
if ( V_32 . V_15 == V_31 && V_33 . V_15 != V_31 &&
F_16 ( V_9 -> V_7 ) )
F_70 ( V_121 , & V_9 -> V_7 -> V_46 ) ;
F_71 ( & V_9 -> V_174 ) ;
F_71 ( & V_9 -> V_61 ) ;
F_71 ( & V_9 -> V_7 -> V_175 ) ;
...
V_33 . V_15 <= V_34 ) {
V_9 -> V_162 =
F_64 ( F_62 ( V_9 ) - V_9 -> V_167 ) ;
if ( V_9 -> V_167 )
F_49 ( V_68 , L_23 ,
( unsigned long long ) V_9 -> V_162 ) ;
}
if ( ( V_32 . V_15 == V_150 || V_32 . V_15 == V_105 ) &&
( V_33 . V_15 == V_123 || V_33 . V_15 == V_104 ) ) {
F_49 ( V_68 , L_24 ) ;
V_9 -> V_176 += ( long ) V_177
- ( long ) V_9 -> V_178 [ V_9 -> V_179 ] ;
if ( V_33 . V_15 == V_123 )
F_72 ( & V_9 -> V_180 , V_177 ) ;
}
if ( ( V_32 . V_15 == V_123 || V_32 . V_15 == V_104 ) &&
( V_33 . V_15 == V_150 || V_33 . V_15 == V_105 ) ) {
F_49 ( V_68 , L_25 ) ;
V_9 -> V_178 [ V_9 -> V_179 ] = V_177 ;
}
if ( V_32 . V_15 == V_34 &&
( V_33 . V_15 == V_39 || V_33 . V_15 == V_108 ) ) {
unsigned long V_181 = V_177 ;
int V_42 ;
F_61 ( V_9 , V_33 . V_15 ) ;
V_9 -> V_182 = V_181 ;
V_9 -> V_183 = 0 ;
...
V_9 -> V_188 [ V_42 ] = V_9 -> V_167 ;
V_9 -> V_178 [ V_42 ] = V_181 ;
}
F_73 ( V_9 ) ;
if ( V_33 . V_15 == V_39 ) {
F_49 ( V_68 , L_26 ,
( unsigned long long ) V_9 -> V_164 ) ;
F_72 ( & V_9 -> V_180 , V_177 ) ;
}
}
if ( F_52 ( V_9 ) ) {
T_1 V_189 = V_9 -> V_87 -> V_143 . V_46 & ~ ( V_190 | V_191 |
V_192 | V_193 |
V_194 | V_195 ) ;
V_189 &= ~ V_196 ;
if ( F_55 ( V_197 , & V_9 -> V_46 ) )
V_189 |= V_195 ;
...
V_189 |= V_194 ;
if ( V_189 != V_9 -> V_87 -> V_143 . V_46 ) {
V_9 -> V_87 -> V_143 . V_46 = V_189 ;
F_74 ( V_9 ) ;
}
if ( V_32 . V_13 < V_148 && V_33 . V_13 >= V_148 )
F_75 ( V_9 , V_9 -> V_87 -> V_143 . V_144 [ V_145 ] ) ;
F_54 ( V_9 ) ;
}
...
F_77 ( & V_9 -> V_7 -> V_199 ) ;
if ( V_32 . V_15 > V_117 &&
V_33 . V_15 <= V_127 && V_33 . V_15 >= V_126 )
F_78 ( & V_9 -> V_7 -> V_199 ) ;
if ( V_32 . V_15 < V_34 && V_33 . V_15 >= V_34 )
F_60 ( V_9 ) ;
if ( ( V_32 . V_13 == V_115 || V_32 . V_13 == V_141 ) &&
V_33 . V_13 > V_141 )
V_9 -> V_200 = V_177 ;
V_170 = F_79 ( sizeof( * V_170 ) , V_201 ) ;
if ( V_170 ) {
V_170 -> V_32 = V_32 ;
V_170 -> V_33 = V_33 ;
V_170 -> V_46 = V_46 ;
V_170 -> V_202 . V_203 = V_204 ;
V_170 -> V_202 . V_9 = V_9 ;
V_170 -> V_57 = V_57 ;
F_80 ( & V_9 -> V_7 -> V_205 , & V_170 -> V_202 ) ;
} else {
F_42 ( V_68 , L_27 ) ;
}
return V_10 ;
}
static int V_204 ( struct V_206 * V_202 , int V_207 )
{
struct V_169 * V_170 =
F_81 ( V_202 , struct V_169 , V_202 ) ;
struct V_8 * V_9 = V_202 -> V_9 ;
F_82 ( V_9 , V_170 -> V_32 , V_170 -> V_33 , V_170 -> V_46 ) ;
if ( V_170 -> V_46 & V_62 ) {
F_37 ( V_170 -> V_57 != NULL ) ;
F_83 ( V_170 -> V_57 ) ;
}
F_84 ( V_170 ) ;
return 0 ;
...
V_9 -> V_87 -> V_143 . V_144 [ V_229 ] == 0 && V_33 . V_13 >= V_95 ) {
if ( F_105 ( V_9 ) ) {
F_76 ( V_224 , & V_9 -> V_46 ) ;
} else {
F_106 ( V_9 ) ;
...
if ( V_33 . V_15 >= V_34 &&
V_32 . V_13 == V_115 && V_33 . V_13 == V_141 ) {
F_107 ( V_9 , 0 , 0 ) ;
F_102 ( V_9 ) ;
F_103 ( V_9 , V_33 ) ;
}
...
F_103 ( V_9 , V_33 ) ;
if ( V_32 . V_15 != V_147 && V_33 . V_15 == V_147 )
F_103 ( V_9 , V_33 ) ;
...
L_33 , V_228 ) ;
if ( V_32 . V_15 < V_34 && V_33 . V_15 < V_34 &&
V_32 . V_13 > V_100 && V_33 . V_13 == V_100 )
F_104 ( V_9 , & V_232 , NULL ,
L_34 , V_233 ) ;
if ( V_32 . V_13 != V_37 && V_33 . V_13 == V_37 ) {
...
F_103 ( V_9 , V_33 ) ;
if ( V_33 . V_13 > V_141 && V_33 . V_28 > V_141 &&
F_26 ( V_242 , & V_9 -> V_46 ) ) {
if ( V_33 . V_15 == V_34 )
F_111 ( V_9 ) ;
}
...
static int F_114 ( struct V_206 * V_202 , int V_207 )
{
struct V_245 * V_246 =
F_81 ( V_202 , struct V_245 , V_202 ) ;
struct V_6 * V_7 = V_202 -> V_7 ;
enum V_29 V_124 = V_246 -> V_124 ;
union V_1 V_247 = V_246 -> V_247 ;
struct V_8 * V_9 ;
int V_11 ;
F_84 ( V_246 ) ;
if ( V_124 == V_16 && V_247 . V_15 == V_118 )
F_115 ( & V_7 -> V_199 ) ;
if ( V_124 == V_38 && V_247 . V_15 == V_16 ) {
struct V_84 * V_248 ;
F_33 ( & V_7 -> V_249 ) ;
V_248 = V_7 -> V_84 ;
V_7 -> V_250 = 0 ;
...
if ( V_161 . V_17 != V_32 . V_17 )
V_46 &= ~ V_75 ;
if ( V_161 . V_24 != V_32 . V_24 )
V_46 &= ~ V_76 ;
if ( V_161 . V_15 != V_32 . V_15 )
V_46 &= ~ V_77 ;
if ( V_161 . V_13 != V_32 . V_13 )
V_46 &= ~ V_78 ;
if ( V_161 . V_28 != V_32 . V_28 )
V_46 &= ~ V_79 ;
}
F_5 () ;
* V_256 |= V_80 ;
* V_256 &= V_46 ;
( * V_255 ) . V_42 = V_161 . V_42 ;
}
static enum V_43
...
enum V_43 V_10 = V_53 ;
struct V_245 * V_246 ;
enum V_29 V_124 = V_7 -> V_259 ;
union V_1 V_247 , V_263 , V_32 ;
bool V_269 = false ;
if ( V_40 . V_15 ) {
V_10 = F_56 ( V_124 , V_41 . V_15 ) ;
if ( V_10 < V_53 )
goto abort;
}
...
V_246 = F_79 ( sizeof( * V_246 ) , V_201 ) ;
if ( V_246 ) {
V_246 -> V_124 = V_32 . V_15 ;
V_246 -> V_263 = V_263 ;
V_246 -> V_247 = V_247 ;
V_246 -> V_46 = V_46 ;
V_246 -> V_202 . V_203 = F_114 ;
F_128 ( & V_7 -> V_253 ) ;
V_246 -> V_202 . V_7 = V_7 ;
F_80 ( & V_7 -> V_205 , & V_246 -> V_202 ) ;
} else {
F_129 ( V_7 , L_39 ) ;
}
abort:
...
F_129 ( V_7 , L_40 , V_40 . V_42 , V_41 . V_42 ) ;
F_129 ( V_7 , L_41 , F_43 ( V_124 ) , F_43 ( V_41 . V_15 ) ) ;
}
return V_10 ;
}
enum V_43
