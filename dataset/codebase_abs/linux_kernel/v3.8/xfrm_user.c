...
V_39 = F_170 ( V_142 , V_359 [ type ] , V_5 , V_345 ,
V_360 ) ;
if ( V_39 < 0 )
return V_39 ;
if ( V_347 -> V_361 == NULL )
return - V_10 ;
return V_347 -> V_361 ( V_140 , V_142 , V_5 ) ;
}
...
struct V_141 * V_142 ;
int V_39 ;
V_142 = F_69 ( V_140 , V_145 -> V_153 , 0 , V_363 , sizeof( * V_305 ) , 0 ) ;
if ( V_142 == NULL )
return - V_169 ;
V_305 = F_40 ( V_142 ) ;
...
F_88 () ;
return F_166 ( V_114 -> V_132 . V_214 , V_140 , 0 , V_365 , V_193 ) ;
}
...
if ( V_140 == NULL )
return - V_68 ;
V_142 = F_69 ( V_140 , V_145 -> V_153 , V_145 -> V_131 , V_366 , sizeof( * V_26 ) , 0 ) ;
if ( V_142 == NULL ) {
F_81 ( V_140 ) ;
return - V_169 ;
}
...
F_72 ( V_140 , V_142 ) ;
return F_166 ( V_114 -> V_132 . V_214 , V_140 , 0 , V_367 , V_193 ) ;
}
static inline T_5 F_181 ( struct V_87 * V_88 )
{
T_5 V_368 = 0 ;
if ( V_88 -> V_117 )
V_368 += F_84 ( F_1 ( V_88 -> V_117 ) ) ;
if ( V_88 -> V_119 ) {
V_368 += F_84 ( sizeof( struct V_8 ) +
( V_88 -> V_119 -> V_3 + 7 ) / 8 ) ;
V_368 += F_84 ( F_7 ( V_88 -> V_119 ) ) ;
}
if ( V_88 -> V_121 )
V_368 += F_84 ( F_5 ( V_88 -> V_121 ) ) ;
if ( V_88 -> V_123 )
V_368 += F_84 ( sizeof( * V_88 -> V_123 ) ) ;
if ( V_88 -> V_126 )
V_368 += F_84 ( sizeof( * V_88 -> V_126 ) ) ;
if ( V_88 -> V_127 )
V_368 += F_84 ( sizeof( V_88 -> V_127 ) ) ;
if ( V_88 -> V_78 )
V_368 += F_84 ( F_12 ( V_88 -> V_78 ) ) ;
if ( V_88 -> V_178 )
V_368 += F_84 ( sizeof( struct V_21 ) +
V_88 -> V_178 -> V_24 ) ;
if ( V_88 -> V_128 )
V_368 += F_84 ( sizeof( * V_88 -> V_128 ) ) ;
V_368 += F_84 ( sizeof( V_369 ) ) ;
return V_368 ;
}
...
if ( V_140 == NULL )
return - V_68 ;
V_142 = F_69 ( V_140 , V_145 -> V_153 , V_145 -> V_131 , V_145 -> V_155 , V_370 , 0 ) ;
V_39 = - V_169 ;
if ( V_142 == NULL )
goto V_372;
V_26 = F_40 ( V_142 ) ;
...
V_167 = F_61 ( V_140 , V_373 , sizeof( * V_26 ) ) ;
V_39 = - V_169 ;
if ( V_167 == NULL )
goto V_372;
V_26 = F_3 ( V_167 ) ;
...
struct V_253 * V_376 , struct V_245 * V_247 )
{
T_7 V_131 = F_187 () ;
struct V_306 * V_307 ;
struct V_141 * V_142 ;
int V_39 ;
V_142 = F_69 ( V_140 , 0 , 0 , V_377 , sizeof( * V_307 ) , 0 ) ;
if ( V_142 == NULL )
return - V_169 ;
V_307 = F_40 ( V_142 ) ;
...
V_307 -> V_258 = V_376 -> V_258 ;
V_307 -> V_259 = V_376 -> V_259 ;
V_307 -> V_260 = V_376 -> V_260 ;
...
static int F_188 ( struct V_87 * V_88 , struct V_253 * V_376 ,
struct V_245 * V_247 )
{
struct V_114 * V_114 = F_178 ( V_88 ) ;
struct V_139 * V_140 ;
...
if ( V_140 == NULL )
return - V_68 ;
if ( F_186 ( V_140 , V_88 , V_376 , V_247 ) < 0 )
F_88 () ;
return F_166 ( V_114 -> V_132 . V_214 , V_140 , 0 , V_378 , V_193 ) ;
}
static struct V_245 * F_189 ( struct V_379 * V_143 , int V_380 ,
...
struct V_141 * V_142 ;
int V_39 ;
V_142 = F_69 ( V_140 , V_145 -> V_153 , 0 , V_387 , sizeof( * V_386 ) , 0 ) ;
if ( V_142 == NULL )
return - V_169 ;
V_386 = F_40 ( V_142 ) ;
F_114 ( V_247 , & V_386 -> V_246 , V_230 ) ;
V_39 = F_124 ( V_247 , V_140 ) ;
if ( ! V_39 )
V_39 = F_126 ( V_247 , V_140 ) ;
if ( ! V_39 )
...
V_167 = F_61 ( V_140 , V_388 , sizeof( * V_26 ) ) ;
V_39 = - V_169 ;
if ( V_167 == NULL )
goto V_372;
V_26 = F_3 ( V_167 ) ;
...
goto V_372;
F_72 ( V_140 , V_142 ) ;
return F_166 ( V_114 -> V_132 . V_214 , V_140 , 0 , V_389 , V_193 ) ;
V_372:
F_81 ( V_140 ) ;
return V_39 ;
}
...
if ( V_140 == NULL )
return - V_68 ;
V_142 = F_69 ( V_140 , V_145 -> V_153 , V_145 -> V_131 , V_390 , 0 , 0 ) ;
V_39 = - V_169 ;
if ( V_142 == NULL )
goto V_372;
...
{
return F_83 ( sizeof( struct V_392 ) ) ;
}
static int F_198 ( struct V_139 * V_140 , T_2 V_36 ,
struct V_339 * V_89 , T_1 * V_393 )
{
struct V_392 * V_394 ;
struct V_141 * V_142 ;
V_142 = F_69 ( V_140 , 0 , 0 , V_395 , sizeof( * V_394 ) , 0 ) ;
if ( V_142 == NULL )
return - V_169 ;
V_394 = F_40 ( V_142 ) ;
V_394 -> V_36 = V_36 ;
...
if ( V_393 ) {
int V_39 = F_64 ( V_140 , V_54 , sizeof( * V_393 ) , V_393 ) ;
if ( V_39 ) {
F_71 ( V_140 , V_142 ) ;
return V_39 ;
}
...
if ( V_140 == NULL )
return - V_68 ;
if ( F_198 ( V_140 , V_36 , V_89 , V_393 ) < 0 )
F_88 () ;
return F_166 ( V_114 -> V_132 . V_214 , V_140 , 0 , V_396 , V_193 ) ;
}
static inline T_5 F_200 ( void )
{
return F_83 ( sizeof( struct V_397 ) ) ;
}
...
struct V_397 * V_320 ;
struct V_141 * V_142 ;
V_142 = F_69 ( V_140 , 0 , 0 , V_399 , sizeof( * V_320 ) , 0 ) ;
if ( V_142 == NULL )
return - V_169 ;
V_320 = F_40 ( V_142 ) ;
...
V_320 -> V_398 = V_398 ;
V_320 -> V_400 = V_88 -> V_126 -> V_401 ;
V_320 -> V_91 = V_88 -> V_59 . V_91 ;
return F_72 ( V_140 , V_142 ) ;
}
static int F_202 ( struct V_87 * V_88 , T_1 * V_402 ,
T_8 V_403 )
{
struct V_114 * V_114 = F_178 ( V_88 ) ;
struct V_139 * V_140 ;
...
if ( V_140 == NULL )
return - V_68 ;
if ( F_201 ( V_140 , V_88 , V_402 , V_403 ) < 0 )
F_88 () ;
return F_166 ( V_114 -> V_132 . V_214 , V_140 , 0 , V_404 , V_193 ) ;
}
...
V_214 = F_204 ( V_114 , V_410 , & V_406 ) ;
if ( V_214 == NULL )
return - V_68 ;
V_114 -> V_132 . V_411 = V_214 ;
F_205 ( V_114 -> V_132 . V_214 , V_214 ) ;
return 0 ;
}
static void T_10 F_206 ( struct V_412 * V_413 )
{
struct V_114 * V_114 ;
