...
static int F_144 ( struct V_4 * V_5 , T_7 V_172 , int V_173 )
{
struct V_136 * V_137 ;
struct V_174 * V_141 ;
int V_64 ;
...
F_146 ( V_137 ) ;
F_147 ( & V_5 -> V_85 , V_173 ) ;
if ( ! V_5 -> V_181 ) {
V_5 -> V_159 = V_137 ;
V_5 -> V_182 = V_137 -> V_183 ;
V_5 -> V_115 = V_5 ;
if ( ! V_138 ) {
struct V_6 * V_83 ;
V_64 = - V_139 ;
...
goto V_184;
V_64 = 0 ;
if ( V_137 -> V_140 -> V_185 ) {
V_64 = V_137 -> V_140 -> V_185 ( V_5 , V_172 ) ;
if ( V_64 == - V_186 ) {
F_149 ( V_5 -> V_148 ) ;
V_5 -> V_148 = NULL ;
V_5 -> V_159 = NULL ;
...
V_5 -> V_148 = F_148 ( V_137 , V_138 ) ;
if ( ! ( V_137 -> V_60 & V_188 ) ||
! V_5 -> V_148 || ! V_5 -> V_148 -> V_189 ) {
V_64 = - V_139 ;
goto V_184;
}
F_143 ( V_5 , ( T_3 ) V_5 -> V_148 -> V_189 << 9 ) ;
}
} else {
if ( V_5 -> V_115 == V_5 ) {
V_64 = 0 ;
if ( V_5 -> V_159 -> V_140 -> V_185 )
V_64 = V_5 -> V_159 -> V_140 -> V_185 ( V_5 , V_172 ) ;
if ( V_5 -> V_118 ) {
if ( ! V_64 )
F_152 ( V_5 -> V_159 , V_5 ) ;
else if ( V_64 == - V_187 )
...
int F_156 ( struct V_4 * V_5 , T_7 V_172 , void * V_129 )
{
struct V_4 * V_128 = NULL ;
int V_51 ;
F_123 ( ( V_172 & V_191 ) && ! V_129 ) ;
if ( ( V_172 & V_191 ) && V_129 ) {
...
struct V_4 * F_159 ( const char * V_195 , T_7 V_172 ,
void * V_129 )
{
struct V_4 * V_5 ;
int V_102 ;
...
if ( F_83 ( V_5 ) )
return V_5 ;
V_102 = F_156 ( V_5 , V_172 , V_129 ) ;
if ( V_102 )
return F_41 ( V_102 ) ;
if ( ( V_172 & V_178 ) && F_161 ( V_5 ) ) {
F_162 ( V_5 , V_172 ) ;
return F_41 ( - V_196 ) ;
}
return V_5 ;
}
struct V_4 * F_163 ( T_5 V_112 , T_7 V_172 , void * V_129 )
{
struct V_4 * V_5 ;
int V_102 ;
V_5 = F_89 ( V_112 ) ;
...
if ( V_72 -> V_197 & V_202 )
V_72 -> V_200 |= V_191 ;
if ( ( V_72 -> V_197 & V_203 ) == 3 )
V_72 -> V_200 |= V_204 ;
V_5 = F_100 ( V_2 ) ;
if ( V_5 == NULL )
return - V_142 ;
V_72 -> V_48 = V_5 -> V_19 -> V_20 ;
return F_156 ( V_5 , V_72 -> V_200 , V_72 ) ;
}
static int F_155 ( struct V_4 * V_5 , T_7 V_172 , int V_173 )
{
int V_64 = 0 ;
struct V_136 * V_137 = V_5 -> V_159 ;
struct V_4 * V_205 = NULL ;
F_147 ( & V_5 -> V_85 , V_173 ) ;
if ( V_173 )
V_5 -> V_117 -- ;
if ( ! -- V_5 -> V_181 ) {
...
if ( V_5 -> V_115 == V_5 ) {
if ( V_137 -> V_140 -> V_206 )
V_64 = V_137 -> V_140 -> V_206 ( V_137 , V_172 ) ;
}
if ( ! V_5 -> V_181 ) {
struct V_174 * V_141 = V_137 -> V_140 -> V_141 ;
F_149 ( V_5 -> V_148 ) ;
V_5 -> V_148 = NULL ;
V_5 -> V_159 = NULL ;
if ( V_5 != V_5 -> V_115 )
...
int F_162 ( struct V_4 * V_5 , T_7 V_172 )
{
F_36 ( & V_5 -> V_85 ) ;
if ( V_172 & V_191 ) {
bool V_207 ;
...
F_37 ( & V_5 -> V_85 ) ;
return F_155 ( V_5 , V_172 , 0 ) ;
}
static int F_166 ( struct V_2 * V_2 , struct V_46 * V_72 )
{
struct V_4 * V_5 = F_3 ( V_72 -> V_48 -> V_49 ) ;
return F_162 ( V_5 , V_72 -> V_200 ) ;
}
static long F_167 ( struct V_46 * V_46 , unsigned V_208 , unsigned long V_209 )
{
struct V_4 * V_5 = F_3 ( V_46 -> V_48 -> V_49 ) ;
T_7 V_172 = V_46 -> V_200 ;
if ( V_46 -> V_197 & V_199 )
V_172 |= V_201 ;
else
V_172 &= ~ V_201 ;
return F_168 ( V_5 , V_172 , V_208 , V_209 ) ;
}
...
struct V_210 V_211 ;
T_2 V_64 ;
F_154 ( V_41 -> V_212 != V_58 ) ;
F_170 ( & V_211 ) ;
V_64 = F_171 ( V_41 , V_43 , V_45 , & V_41 -> V_212 ) ;
if ( V_64 > 0 || V_64 == - V_213 ) {
T_2 V_102 ;
...
{
struct V_27 * V_215 = F_1 ( V_55 -> V_18 -> V_49 ) -> V_5 . V_116 ;
if ( V_215 && V_215 -> V_216 -> V_217 )
return V_215 -> V_216 -> V_217 ( V_215 , V_55 , V_50 ) ;
return F_178 ( V_55 ) ;
}
int F_179 ( struct V_4 * V_5 , unsigned V_208 , unsigned long V_209 )
{
int V_51 ;
T_9 V_218 = F_180 () ;
F_181 ( V_219 ) ;
V_51 = F_168 ( V_5 , 0 , V_208 , V_209 ) ;
F_181 ( V_218 ) ;
return V_51 ;
}
struct V_4 * F_160 ( const char * V_220 )
{
struct V_4 * V_5 ;
struct V_2 * V_2 ;
struct V_195 V_195 ;
...
if ( ! V_220 || ! * V_220 )
return F_41 ( - V_24 ) ;
error = F_182 ( V_220 , V_221 , & V_195 ) ;
if ( error )
return F_41 ( error ) ;
V_2 = V_195 . V_95 -> V_222 ;
error = - V_223 ;
if ( ! F_183 ( V_2 -> V_119 ) )
goto V_224;
error = - V_196 ;
if ( V_195 . V_225 -> V_226 & V_227 )
goto V_224;
error = - V_142 ;
V_5 = F_100 ( V_2 ) ;
if ( ! V_5 )
...
void F_187 ( void (* F_188)( struct V_4 * , void * ) , void * V_209 )
{
struct V_2 * V_2 , * V_228 = NULL ;
F_7 ( & V_229 ) ;
F_97 (inode, &blockdev_superblock->s_inodes, i_sb_list) {
struct V_17 * V_18 = V_2 -> V_20 ;
F_7 ( & V_2 -> V_11 ) ;
if ( V_2 -> V_12 & ( V_230 | V_231 | V_114 ) ||
V_18 -> V_21 == 0 ) {
F_9 ( & V_2 -> V_11 ) ;
continue;
}
