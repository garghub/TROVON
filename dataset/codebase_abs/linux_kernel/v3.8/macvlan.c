...
static int F_70 ( struct V_119 * V_120 , struct V_121 * V_122 [] ,
struct V_19 * V_8 ,
const unsigned char * V_4 ,
T_6 V_55 )
{
...
struct V_124 * V_125 )
{
snprintf ( V_125 -> V_126 , 32 , L_1 ) ;
snprintf ( V_125 -> V_127 , 32 , L_2 ) ;
}
static int F_77 ( struct V_19 * V_8 ,
struct V_128 * V_129 )
{
const struct V_1 * V_5 = F_26 ( V_8 ) ;
return F_78 ( V_5 -> V_63 , V_129 ) ;
}
...
unsigned int V_32 ;
int V_33 ;
if ( V_8 -> type != V_142 || V_8 -> V_55 & V_143 )
return - V_90 ;
V_3 = F_83 ( sizeof( * V_3 ) , V_144 ) ;
if ( V_3 == NULL )
return - V_107 ;
V_3 -> V_52 = false ;
V_3 -> V_8 = V_8 ;
...
static int F_91 ( struct V_121 * V_122 [] , struct V_121 * V_60 [] )
{
if ( V_122 [ V_147 ] ) {
if ( F_92 ( V_122 [ V_147 ] ) != V_13 )
return - V_90 ;
if ( ! F_46 ( F_93 ( V_122 [ V_147 ] ) ) )
return - V_84 ;
}
if ( V_60 && V_60 [ V_148 ] ) {
...
struct V_121 * V_122 [] , struct V_121 * V_60 [] ,
...
if ( ! V_122 [ V_151 ] )
return - V_90 ;
V_63 = F_96 ( V_150 , F_94 ( V_122 [ V_151 ] ) ) ;
if ( V_63 == NULL )
return - V_152 ;
...
struct V_121 * V_122 [] , struct V_121 * V_60 [] )
{
return F_95 ( V_150 , V_8 , V_122 , V_60 ,
V_158 ,
F_27 ) ;
}
