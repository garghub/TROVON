...
static struct V_1 * F_23 ( const char * V_74 ,
struct V_75 * V_6 , int V_76 )
{
struct V_1 * V_2 ;
struct V_45 * V_5 ;
V_2 = F_24 ( sizeof( * V_2 ) , V_77 ) ;
if ( ! V_2 ) {
F_25 ( L_17 ) ;
return NULL ;
}
V_5 = & V_2 -> V_5 ;
F_26 ( V_5 , V_2 ) ;
snprintf ( V_5 -> V_78 , sizeof( V_5 -> V_78 ) , L_18 , V_74 , V_76 ) ;
V_5 -> V_79 = V_80 ;
V_5 -> V_81 = & V_82 ;
V_5 -> V_83 = V_84 | V_85 ;
V_5 -> V_6 . V_86 = V_6 ;
...
static struct V_1 * F_31 ( const char * V_74 ,
unsigned long V_91 , int V_76 , struct V_75 * V_6 )
{
struct V_1 * V_2 ;
int V_54 ;
V_2 = F_23 ( V_74 , V_6 , V_76 ) ;
if ( V_2 == NULL )
return NULL ;
if ( ! F_32 ( V_91 , 8 , V_2 -> V_5 . V_78 ) ) {
F_25 ( L_21 , V_91 , V_91 + 8 - 1 ) ;
goto V_92;
}
V_2 -> V_91 = V_91 ;
V_54 = F_28 ( V_2 ) ;
...
struct V_1 * V_2 ;
struct V_95 * V_96 ;
V_96 = F_36 ( V_94 , V_97 , 0 ) ;
if ( ! V_96 ) {
F_6 ( & V_94 -> V_6 , L_22 ) ;
return - V_87 ;
}
V_2 = F_31 ( L_23 , V_96 -> V_98 , 0 , & V_94 -> V_6 ) ;
if ( ! V_2 )
return - V_32 ;
F_37 ( & V_94 -> V_6 , L_24 ,
V_2 -> V_5 . V_78 ) ;
