...
V_23 -> V_83 = V_28 ;
V_34 = - V_5 ;
V_34 = F_39 ( V_10 , V_103 , V_103 , NULL ) ;
if ( V_34 )
goto V_95;
return 0 ;
V_95:
...
static void
F_40 ( struct V_93 * V_94 , struct V_9 * V_10 )
{
struct V_8 * V_15 = F_6 ( V_10 ) ;
F_41 ( V_10 ) ;
F_4 ( V_15 ) ;
}
static int F_42 ( struct V_53 * V_54 , T_2 V_49 , int V_56 )
{
V_54 -> V_14 [ V_49 ] = V_56 ;
return 0 ;
}
static int F_43 ( struct V_53 * V_54 , T_2 V_49 )
{
return V_54 -> V_14 [ V_49 ] ;
}
int T_4 F_44 ( struct V_8 * V_15 )
{
F_45 ( & V_15 -> V_52 ) ;
F_46 ( & V_104 . V_20 , & V_15 -> V_52 ) ;
F_45 ( & V_104 . V_105 ) ;
F_46 ( & V_106 . V_20 , & V_104 . V_105 ) ;
F_46 ( & V_107 . V_20 , & V_104 . V_105 ) ;
V_107 . V_14 [ V_108 ] = 0xffc0 ;
V_107 . V_14 [ V_109 ] = 0xe3a0 ;
V_107 . V_14 [ V_110 ] = 0xfff0 ;
V_107 . V_14 [ V_111 ] = 0x0030 ;
return 0 ;
}
int T_4 F_47 ( struct V_93 * V_94 )
{
struct V_8 * V_15 ;
int V_34 ;
V_15 = F_2 ( sizeof *V_15 , V_112 ) ;
if ( ! V_15 )
return - V_5 ;
...
if ( V_34 < 0 )
goto V_113;
V_15 -> V_11 . V_12 . V_114 = V_115 ;
V_15 -> V_11 . V_12 . V_116 = F_36 ;
V_15 -> V_11 . V_12 . V_117 = F_40 ;
V_15 -> V_11 . V_12 . V_118 = F_29 ;
V_15 -> V_11 . V_12 . V_119 = F_28 ;
V_15 -> V_11 . V_12 . V_120 = F_32 ;
F_44 ( V_15 ) ;
F_50 ( & V_15 -> V_16 , F_8 ) ;
V_34 = F_51 ( V_94 , & V_15 -> V_11 . V_12 ) ;
if ( V_34 )
goto V_121;
F_52 ( V_94 -> V_28 , L_9 ,
V_32 , V_85 , V_84 ) ;
