...
static int T_1 F_33 ( struct V_82 * V_83 )
{
...
void T_1 F_34 ( struct V_82 * V_83 )
{
if ( V_78 ) {
V_86 = F_33 ( V_83 ) ;
...
static int T_1 F_41 ( unsigned int V_64 , int V_55 )
{
struct V_59 * V_54 ;
int V_66 , V_119 ;
if ( V_78 ) {
...
static void T_1 F_50 ( unsigned int V_64 , int V_55 )
{
struct V_59 * V_54 , * V_124 ;
int V_119 ;
V_54 = F_42 ( V_64 , V_55 ) ;
...
static void T_1 F_52 ( unsigned int V_64 )
{
int V_66 ;
for ( V_66 = 0 ; V_66 < V_86 ; V_66 ++ )
F_50 ( V_64 , V_66 ) ;
...
static void T_1 F_54 ( void * V_125 )
{
...
static int T_1 F_56 ( unsigned int V_64 )
{
int V_99 ;
if ( V_86 == 0 )
return - V_126 ;
...
static T_3 F_59 ( struct V_59 * V_54 , char * V_60 ,
unsigned int V_64 )
{
return sprintf ( V_60 , L_5 , V_54 -> V_61 . V_81 / 1024 ) ;
}
static T_3 F_60 ( struct V_59 * V_54 ,
int type , char * V_60 )
{
T_5 V_129 = F_61 ( V_60 + V_130 - 1 , V_130 ) - V_60 ;
int V_104 = 0 ;
if ( V_129 > 1 ) {
...
static inline T_3 F_64 ( struct V_59 * V_1 , char * V_60 ,
unsigned int V_64 )
{
return F_60 ( V_1 , 0 , V_60 ) ;
}
static inline T_3 F_65 ( struct V_59 * V_1 , char * V_60 ,
unsigned int V_64 )
{
return F_60 ( V_1 , 1 , V_60 ) ;
}
static T_3 F_66 ( struct V_59 * V_54 , char * V_60 ,
unsigned int V_64 )
{
...
static struct V_134 * * T_1 F_67 ( void )
{
...
static T_3 F_69 ( struct V_140 * V_141 , struct V_134 * V_138 , char * V_60 )
{
...
static T_3 F_72 ( struct V_140 * V_141 , struct V_134 * V_138 ,
const char * V_60 , T_4 V_69 )
{
struct V_142 * V_143 = F_70 ( V_138 ) ;
struct V_144 * V_54 = F_71 ( V_141 ) ;
...
static void T_1 F_73 ( unsigned int V_64 )
{
...
static int T_1 F_74 ( unsigned int V_64 )
{
int V_70 ;
if ( V_86 == 0 )
return - V_126 ;
...
static int T_1 F_75 ( struct V_148 * V_149 )
{
...
static void T_1 F_81 ( struct V_148 * V_149 )
{
unsigned int V_64 = V_149 -> V_150 ;
unsigned long V_66 ;
if ( F_40 ( V_123 , V_64 ) == NULL )
...
static int T_1 F_83 ( struct V_156 * V_157 ,
