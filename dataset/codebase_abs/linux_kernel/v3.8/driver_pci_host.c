...
static int F_16 ( struct V_1 * V_2 , unsigned int V_15 ,
unsigned int V_16 , unsigned int V_17 ,
...
F_26 ( V_2 ) ;
V_7 = V_116 | V_117 ;
F_16 ( V_2 , 0 , 0 , V_118 , & V_7 , sizeof( V_7 ) ) ;
F_5 ( V_2 , V_119 , V_120 ) ;
...
static void F_37 ( struct V_121 * V_15 )
{
...
static void F_44 ( struct V_121 * V_15 )
{
struct V_123 * V_124 ;
int V_125 , V_30 ;
if ( V_15 -> V_4 -> V_50 -> V_90 != F_18 ) {
...
V_124 = & V_15 -> V_123 [ V_125 ] ;
if ( V_124 -> V_47 & ( V_98 | V_96 ) ) {
V_30 = F_45 ( V_15 , V_125 ) ;
if ( V_30 )
F_42 ( L_10 ,
F_39 ( V_15 ) ) ;
}
...
V_51 ) ;
F_38 ( L_11 , F_39 ( V_15 ) ) ;
V_15 -> V_127 = F_47 ( V_49 -> V_52 -> V_5 ) + 2 ;
F_48 ( V_15 , V_128 , V_15 -> V_127 ) ;
return 0 ;
}
int F_49 ( const struct V_121 * V_15 )
{
struct V_48 * V_49 ;
if ( V_15 -> V_4 -> V_50 -> V_90 != F_18 ) {
return - V_126 ;
