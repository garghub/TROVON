...
const struct V_33 * V_41 ;
struct V_8 * V_9 ;
struct V_3 * V_4 ;
int V_42 ;
int V_11 ;
V_9 = F_12 ( sizeof( * V_9 ) , V_43 ) ;
if ( ! V_9 )
return - V_44 ;
V_2 -> V_10 = V_9 ;
V_2 -> V_45 = F_8 ( V_35 ) ;
...
V_58 = F_18 ( sizeof( struct V_57 * ) * 32 ,
V_43 ) ;
if ( ! V_58 )
return - V_44 ;
V_4 -> V_58 = V_58 ;
...
V_4 -> V_67 = F_5 ;
V_4 -> V_68 = F_7 ;
F_3 ( 0x10 , V_9 -> V_15 -> V_16 + V_69 ) ;
F_3 ( 0x00 , V_9 -> V_15 -> V_16 + V_70 ) ;
F_19 ( V_2 -> V_47 , L_2 ,
V_2 -> V_71 -> V_72 , V_2 -> V_48 ) ;
return 0 ;
}
...
{
return F_25 ( V_2 , & V_76 ) ;
}
static void F_26 ( struct V_34 * V_2 )
{
F_27 ( V_2 ) ;
}
