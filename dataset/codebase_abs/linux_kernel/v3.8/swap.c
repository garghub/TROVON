...
if ( ! V_42 )
F_24 ( V_57 L_10 ) ;
F_48 ( & V_9 , & V_65 , V_60 , L_11 ) ;
return V_42 ;
}
static int F_49 ( void * V_66 )
{
struct V_67 * V_68 = V_66 ;
unsigned V_69 ;
while ( 1 ) {
F_50 ( V_68 -> V_70 , F_51 ( & V_68 -> V_71 ) ||
F_52 () ) ;
if ( F_52 () ) {
V_68 -> V_72 = NULL ;
F_53 ( & V_68 -> V_65 , 1 ) ;
...
F_53 ( & V_68 -> V_71 , 0 ) ;
V_68 -> V_42 = F_57 ( V_68 -> V_75 , V_68 -> V_76 ,
...
V_83 = F_59 () - 1 ;
V_83 = F_60 ( V_83 , 1 , V_86 ) ;
V_84 = ( void * ) F_31 ( V_44 | V_87 ) ;
if ( ! V_84 ) {
F_24 ( V_30 L_12 ) ;
V_42 = - V_15 ;
goto V_88;
}
V_66 = F_61 ( sizeof( * V_66 ) * V_83 ) ;
if ( ! V_66 ) {
F_24 ( V_30 L_13 ) ;
V_42 = - V_15 ;
goto V_88;
...
memset ( & V_66 [ V_72 ] , 0 , F_62 ( struct V_77 , V_70 ) ) ;
V_85 = F_63 ( sizeof( * V_85 ) , V_14 ) ;
if ( ! V_85 ) {
F_24 ( V_30 L_14 ) ;
V_42 = - V_15 ;
goto V_88;
}
memset ( V_85 , 0 , F_62 ( struct V_67 , V_70 ) ) ;
for ( V_72 = 0 ; V_72 < V_83 ; V_72 ++ ) {
F_64 ( & V_66 [ V_72 ] . V_70 ) ;
F_64 ( & V_66 [ V_72 ] . V_73 ) ;
V_66 [ V_72 ] . V_72 = F_65 ( F_56 ,
& V_66 [ V_72 ] ,
L_15 , V_72 ) ;
if ( F_66 ( V_66 [ V_72 ] . V_72 ) ) {
V_66 [ V_72 ] . V_72 = NULL ;
F_24 ( V_30
L_16 ) ;
V_42 = - V_15 ;
...
F_50 ( V_66 [ V_72 ] . V_73 ,
F_51 ( & V_66 [ V_72 ] . V_65 ) ) ;
F_53 ( & V_66 [ V_72 ] . V_65 , 0 ) ;
V_42 = V_66 [ V_72 ] . V_42 ;
if ( V_42 < 0 ) {
F_24 ( V_30 L_23 ) ;
goto V_90;
}
if ( F_67 ( ! V_66 [ V_72 ] . V_80 ||
V_66 [ V_72 ] . V_80 >
F_68 ( V_66 [ V_72 ] . V_76 ) ) ) {
F_24 ( V_30
L_24 ) ;
...
V_42 = F_40 ( V_19 , V_84 , & V_39 ) ;
if ( V_42 )
goto V_90;
}
}
F_50 ( V_85 -> V_73 , F_51 ( & V_85 -> V_65 ) ) ;
F_53 ( & V_85 -> V_65 , 0 ) ;
}
V_90:
V_63 = F_33 ( & V_39 ) ;
...
if ( V_84 ) F_36 ( ( unsigned long ) V_84 ) ;
return V_42 ;
}
static int F_71 ( unsigned int V_62 , unsigned int V_20 )
{
unsigned int V_91 = F_72 ( V_35 , 1 ) ;
unsigned int V_92 ;
F_73 ( L_25 , V_91 ) ;
V_92 = V_93 + V_62 ;
return V_91 > V_92 ;
...
V_95 = (struct V_94 * ) F_47 ( V_59 ) ;
error = F_40 ( & V_19 , V_95 , NULL ) ;
if ( ! error ) {
error = ( V_20 & V_97 ) ?
F_44 ( & V_19 , & V_59 , V_96 - 1 ) :
F_58 ( & V_19 , & V_59 , V_96 - 1 ) ;
}
V_90:
...
while ( V_19 -> V_101 ) {
if ( V_19 -> V_101 -> V_102 )
F_36 ( ( unsigned long ) V_19 -> V_101 -> V_102 ) ;
V_100 = V_19 -> V_101 ;
...
V_17 = V_22 -> V_26 ;
while ( V_17 ) {
V_100 = F_63 ( sizeof( * V_19 -> V_101 ) , V_14 ) ;
if ( ! V_100 ) {
F_76 ( V_19 ) ;
return - V_15 ;
}
...
error = F_22 ( V_17 , V_100 -> V_102 , NULL ) ;
if ( error ) {
F_76 ( V_19 ) ;
return error ;
}
...
F_48 ( & V_9 , & V_65 , V_106 , L_31 ) ;
return V_42 ;
}
static int F_84 ( void * V_66 )
{
...
F_53 ( & V_68 -> V_71 , 0 ) ;
V_68 -> V_76 = V_89 ;
V_68 -> V_42 = F_85 ( V_68 -> V_78 + V_79 , V_68 -> V_80 ,
V_68 -> V_75 , & V_68 -> V_76 ) ;
F_53 ( & V_68 -> V_65 , 1 ) ;
F_54 ( & V_68 -> V_73 ) ;
}
...
for ( V_72 = 0 ; V_72 < V_83 ; V_72 ++ )
memset ( & V_66 [ V_72 ] , 0 , F_62 ( struct V_109 , V_70 ) ) ;
V_85 = F_63 ( sizeof( * V_85 ) , V_14 ) ;
if ( ! V_85 ) {
F_24 ( V_30 L_14 ) ;
V_42 = - V_15 ;
...
if ( F_1 () > F_75 () )
V_118 = ( F_1 () - F_75 () ) / 2 ;
V_118 = F_60 ( V_118 , V_120 , V_119 ) ;
for ( V_69 = 0 ; V_69 < V_118 ; V_69 ++ ) {
V_84 [ V_69 ] = ( void * ) F_31 ( V_69 < V_121 ?
V_44 | V_87 :
V_44 | V_45 |
V_46 ) ;
if ( ! V_84 [ V_69 ] ) {
...
V_42 = F_78 ( V_19 , V_84 [ V_111 ] , & V_39 ) ;
if ( V_42 ) {
if ( V_19 -> V_47 &&
...
V_116 = F_87 ( V_66 [ V_72 ] . V_80 + V_79 ,
V_37 ) ;
if ( V_116 > V_114 ) {
if ( V_110 > 1 ) {
V_42 = - 1 ;
...
V_95 = (struct V_94 * ) F_47 ( V_59 ) ;
error = F_77 ( & V_19 , V_104 ) ;
if ( error )
goto V_11;
if ( ! error )
error = F_78 ( & V_19 , V_95 , NULL ) ;
if ( ! error ) {
error = ( * V_104 & V_97 ) ?
F_80 ( & V_19 , & V_59 , V_95 -> V_96 - 1 ) :
F_86 ( & V_19 , & V_59 , V_95 -> V_96 - 1 ) ;
}
F_79 ( & V_19 ) ;
V_11:
if ( ! error )
