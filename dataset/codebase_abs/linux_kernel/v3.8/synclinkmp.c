...
V_1 -> V_27 . V_9 -> V_39 = ( V_1 -> V_27 . V_11 & V_40 ) ? 1 : 0 ;
F_13 ( & V_1 -> V_41 , V_11 ) ;
if ( V_1 -> V_42 ) {
V_30 = - V_43 ;
F_14 ( & V_1 -> V_41 , V_11 ) ;
...
static int F_184 ( T_1 * V_1 )
{
if ( F_185 ( V_1 -> V_124 , V_428 , L_132 ) == NULL ) {
F_4 ( L_133 ,
...
V_1 -> V_454 = true ;
if ( F_185 ( V_1 -> V_126 + V_1 -> V_455 , 128 , L_132 ) == NULL ) {
F_4 ( L_134 ,
...
V_1 -> V_456 = true ;
if ( F_185 ( V_1 -> V_123 + V_1 -> V_457 , V_229 , L_132 ) == NULL ) {
F_4 ( L_135 ,
...
V_1 -> V_458 = true ;
if ( F_185 ( V_1 -> V_125 + V_1 -> V_459 , V_460 , L_132 ) == NULL ) {
F_4 ( L_136 ,
...
V_1 -> V_463 = F_186 ( V_1 -> V_126 , V_464 ) ;
if ( ! V_1 -> V_463 ) {
F_4 ( L_138 ,
__FILE__ , __LINE__ , V_1 -> V_25 , V_1 -> V_126 ) ;
V_1 -> V_24 = V_462 ;
...
V_1 -> V_463 += V_1 -> V_455 ;
V_1 -> V_465 = F_186 ( V_1 -> V_123 , V_464 ) ;
if ( ! V_1 -> V_465 ) {
F_4 ( L_139 ,
__FILE__ , __LINE__ , V_1 -> V_25 , V_1 -> V_123 ) ;
V_1 -> V_24 = V_462 ;
...
if ( V_1 -> V_454 ) {
F_190 ( V_1 -> V_124 , V_428 ) ;
V_1 -> V_454 = false ;
}
if ( V_1 -> V_456 ) {
F_190 ( V_1 -> V_126 + V_1 -> V_455 , 128 ) ;
V_1 -> V_456 = false ;
}
if ( V_1 -> V_458 ) {
F_190 ( V_1 -> V_123 + V_1 -> V_457 , V_229 ) ;
V_1 -> V_458 = false ;
}
if ( V_1 -> V_461 ) {
F_190 ( V_1 -> V_125 + V_1 -> V_459 , V_460 ) ;
V_1 -> V_461 = false ;
}
if ( V_1 -> V_440 ) {
F_191 ( V_1 -> V_440 ) ;
...
if ( V_1 -> V_465 ) {
F_191 ( V_1 -> V_465 - V_1 -> V_457 ) ;
V_1 -> V_465 = NULL ;
}
if ( V_1 -> V_466 ) {
F_191 ( V_1 -> V_466 - V_1 -> V_459 ) ;
V_1 -> V_466 = NULL ;
}
if ( V_1 -> V_463 ) {
F_191 ( V_1 -> V_463 - V_1 -> V_455 ) ;
V_1 -> V_463 = NULL ;
}
if ( V_31 >= V_32 )
F_4 ( L_143 ,
...
static T_1 * F_193 ( int V_469 , int V_251 , struct V_473 * V_474 )
{
T_1 * V_1 ;
V_1 = F_194 ( sizeof( T_1 ) ,
V_353 ) ;
if ( ! V_1 ) {
F_4 ( L_147 ,
...
V_1 -> V_126 = F_199 ( V_474 , 0 ) ;
V_1 -> V_123 = F_199 ( V_474 , 2 ) ;
V_1 -> V_124 = F_199 ( V_474 , 3 ) ;
V_1 -> V_125 = F_199 ( V_474 , 4 ) ;
...
V_1 -> V_480 = V_481 ;
V_1 -> V_482 = V_483 ;
F_200 ( & V_1 -> V_86 , V_484 , ( unsigned long ) V_1 ) ;
F_200 ( & V_1 -> V_354 , V_485 ,
( unsigned long ) V_1 ) ;
...
static void F_201 ( int V_469 , struct V_473 * V_474 )
{
T_1 * V_345 [ V_487 ] ;
int V_27 ;
for ( V_27 = 0 ; V_27 < V_487 ; ++ V_27 ) {
V_345 [ V_27 ] = F_193 ( V_469 , V_27 , V_474 ) ;
if( V_345 [ V_27 ] == NULL ) {
...
{
if ( V_381 ) {
F_76 ( V_1 , V_505 , ( unsigned char ) ( F_75 ( V_1 , V_505 ) | ( V_346 + V_280 ) ) ) ;
...
V_1 -> V_515 = 0 ;
F_126 ( V_1 , V_310 + V_516 ,
V_1 -> V_436 [ 0 ] . V_442 ) ;
F_126 ( V_1 , V_310 + V_517 ,
V_1 -> V_436 [ V_1 -> V_434 - 1 ] . V_442 ) ;
F_126 ( V_1 , V_310 + V_518 , V_429 ) ;
...
F_76 ( V_1 , V_291 + V_293 , 0 ) ;
F_76 ( V_1 , V_291 + V_294 , V_295 ) ;
F_126 ( V_1 , V_291 + V_516 ,
V_1 -> V_438 [ 0 ] . V_442 ) ;
F_126 ( V_1 , V_291 + V_517 ,
V_1 -> V_438 [ V_1 -> V_523 ] . V_442 ) ;
V_1 -> V_260 &= ~ V_303 ;
V_1 -> V_260 |= V_296 ;
F_76 ( V_1 , V_322 , V_1 -> V_260 ) ;
F_76 ( V_1 , V_259 , ( unsigned char ) ( V_303 + V_296 ) ) ;
...
return;
while( V_1 -> V_71 && ( F_75 ( V_1 , V_525 ) & V_346 ) ) {
...
F_76 ( V_1 , V_304 , V_1 -> V_301 ) ;
F_76 ( V_1 , V_322 , V_1 -> V_260 ) ;
F_76 ( V_1 , V_526 , V_1 -> V_267 ) ;
F_76 ( V_1 , V_297 , V_527 ) ;
}
}
...
if ( V_1 -> V_65 . V_212 )
V_147 |= ( V_346 + V_280 ) ;
F_76 ( V_1 , V_505 , V_147 ) ;
V_147 = V_351 ;
F_76 ( V_1 , V_507 , V_147 ) ;
V_147 = V_351 ;
...
F_76 ( V_1 , V_508 , V_147 ) ;
if ( V_1 -> V_65 . V_11 & V_197 )
F_218 ( V_1 , V_1 -> V_65 . V_211 * V_534 ) ;
else
F_218 ( V_1 , V_1 -> V_65 . V_211 ) ;
if ( V_1 -> V_65 . V_11 & V_202 )
V_1 -> V_345 [ 0 ] -> V_506 |= ( V_280 << ( V_1 -> V_251 * 2 ) ) ;
...
F_76 ( V_1 , V_313 , V_522 ) ;
F_76 ( V_1 , V_531 , ( unsigned char ) ( V_521 - 1 ) ) ;
F_76 ( V_1 , V_291 + V_541 , 0x14 ) ;
F_76 ( V_1 , V_310 + V_541 , 0x14 ) ;
F_76 ( V_1 , V_310 + V_542 ,
( unsigned char ) ( V_1 -> V_441 >> 16 ) ) ;
F_76 ( V_1 , V_291 + V_542 ,
( unsigned char ) ( V_1 -> V_441 >> 16 ) ) ;
V_1 -> V_301 |= V_532 + V_533 ;
F_76 ( V_1 , V_304 , V_1 -> V_301 ) ;
V_147 = 0x10 ;
...
F_76 ( V_1 , V_549 , V_147 ) ;
}
static void F_64 ( T_1 * V_1 )
{
T_7 V_258 = F_75 ( V_1 , V_550 ) ;
T_7 V_551 = F_219 ( V_1 ) ;
T_7 V_552 ;
V_1 -> V_55 &= V_57 + V_56 ;
if ( ! ( V_258 & V_150 ) )
...
static void F_221 ( T_1 * V_1 , unsigned int V_554 , unsigned int V_555 )
{
bool V_556 = false ;
while( ! V_556 ) {
V_1 -> V_435 [ V_554 ] . V_258 = 0xff ;
if ( V_554 == V_555 ) {
V_556 = true ;
F_126 ( V_1 , V_310 + V_517 , V_1 -> V_436 [ V_554 ] . V_442 ) ;
}
V_554 ++ ;
if ( V_554 == V_1 -> V_434 )
V_554 = 0 ;
...
for ( ; ; ) {
V_562 = & V_1 -> V_435 [ V_558 ] ;
V_563 = & V_1 -> V_436 [ V_558 ] ;
if ( V_562 -> V_258 == 0xff )
goto V_565;
...
if ( V_31 >= V_570 )
F_222 ( V_1 , V_1 -> V_436 [ V_557 ] . V_448 ,
...
int V_571 = V_559 ;
int V_19 = V_557 ;
unsigned char * V_572 = V_1 -> V_451 ;
V_1 -> V_573 = V_559 ;
V_1 -> V_106 . V_133 ++ ;
while( V_571 ) {
int V_574 = F_36 ( V_571 , V_429 ) ;
memcpy ( V_572 ,
...
V_563 = & V_1 -> V_438 [ V_339 ] ;
F_223 ( V_1 , V_563 -> V_448 , V_61 , V_571 ) ;
V_562 -> V_444 = V_571 ;
V_562 -> V_258 = 0 ;
V_61 += V_571 ;
V_12 -= V_571 ;
...
V_1 -> V_24 = V_577 ;
for ( V_339 = 0 ; V_339 < V_12 ; V_339 ++ ) {
F_76 ( V_1 , V_512 , V_576 [ V_339 ] ) ;
F_76 ( V_1 , V_549 , V_576 [ ( V_339 + 1 ) % V_12 ] ) ;
F_76 ( V_1 , V_578 , V_576 [ ( V_339 + 2 ) % V_12 ] ) ;
F_76 ( V_1 , V_579 , V_576 [ ( V_339 + 3 ) % V_12 ] ) ;
if ( ( F_75 ( V_1 , V_512 ) != V_576 [ V_339 ] ) ||
( F_75 ( V_1 , V_549 ) != V_576 [ ( V_339 + 1 ) % V_12 ] ) ||
...
{
int V_339 ;
volatile T_13 * V_594 = ( T_13 * ) ( V_1 -> V_463 + 0x50 ) ;
T_13 V_595 ;
V_1 -> V_486 |= V_596 ;
* V_594 = V_1 -> V_486 ;
...
F_217 ( V_1 ) ;
{
volatile T_13 * V_597 = ( T_13 * ) ( V_1 -> V_463 + 0x2c ) ;
...
static void V_484 ( unsigned long V_610 )
{
T_1 * V_1 = ( T_1 * ) V_610 ;
unsigned long V_11 ;
if ( V_31 >= V_32 )
...
{
unsigned char * V_615 = ( unsigned char * ) V_1 -> V_466 ;
return * V_615 ;
}
static void F_217 ( T_1 * V_1 )
{
unsigned char * V_615 = ( unsigned char * ) V_1 -> V_466 ;
* V_615 = V_1 -> V_345 [ 0 ] -> V_506 ;
}
static int F_232 ( struct V_473 * V_152 ,
...
static void F_234 ( struct V_473 * V_152 )
{
}
