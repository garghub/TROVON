...
continue;
if ( V_7 -> V_6 [ V_26 ] . V_106 == V_132 )
F_8 ( V_7 -> V_8 , L_47 ,
V_26 ? L_32 : L_33 ,
V_7 -> V_6 [ V_26 ] . V_96 ) ;
if ( V_7 -> V_6 [ V_26 ] . V_106 ++ != 0 )
continue;
if ( ( V_7 -> V_6 [ V_26 ] . V_96 != V_133 ) &&
( V_7 -> V_6 [ V_26 ] . V_96 != V_130 ) )
continue;
...
if ( V_17 )
return V_17 ;
V_7 -> V_6 [ V_26 ] . V_96 = V_146 ;
break;
case V_147 :
if ( ( V_7 -> V_6 [ V_26 ] . V_96 != V_148 ) )
continue;
V_17 = F_76 ( V_6 , V_105 , V_88 ) ;
if ( V_17 )
return V_17 ;
...
enum V_153 V_89 = V_2 -> V_9 -> V_89 [ V_26 ] ;
V_2 -> V_6 [ V_26 ] . V_122 = V_135 ;
switch ( V_89 ) {
case V_154 :
F_3 ( V_2 -> V_8 , L_67 ,
...
case V_147 :
case V_149 :
V_2 -> V_6 [ V_26 ] . V_96 = V_146 ;
break;
case V_150 :
case V_151 :
case V_152 :
V_2 -> V_6 [ V_26 ] . V_96 = V_141 ;
break;
}
V_44:
V_2 -> V_6 [ V_26 ] . V_122 = V_128 ;
...
unsigned int V_88 , void * V_157 )
{
struct V_1 * V_15 = V_12 -> V_16 ;
struct V_33 * V_34 = V_15 -> V_34 ;
if ( V_34 -> V_18 -> V_42 -> V_158 )
return V_34 -> V_18 -> V_42 -> V_158 ( V_12 , V_88 , V_157 ) ;
return F_83 ( V_12 , V_88 , V_157 ) ;
}
...
return - V_60 ;
F_14 ( & V_80 -> V_142 , V_143 ) ;
for ( V_24 = 0 ; V_24 < V_80 -> V_162 ; V_24 ++ ) {
struct V_115 * V_116 ;
...
if ( V_15 -> V_9 -> V_50 ) {
snprintf ( V_172 , sizeof( V_172 ) , L_92 ,
V_15 -> V_9 -> V_72 ) ;
V_17 = F_93 ( V_15 -> V_80 -> V_173 , V_172 , V_169 ,
V_28 , V_30 , & V_171 ) ;
} else {
if ( V_15 -> V_9 -> V_49 )
snprintf ( V_172 , sizeof( V_172 ) , L_93 ,
V_15 -> V_9 -> V_72 ) ;
else
snprintf ( V_172 , sizeof( V_172 ) , L_94 ,
V_15 -> V_9 -> V_72 , V_36 -> V_10 , V_169 ) ;
V_17 = F_94 ( V_15 -> V_80 -> V_173 , V_172 , V_169 , V_28 ,
V_30 , & V_171 ) ;
}
if ( V_17 < 0 ) {
...
F_3 ( V_15 -> V_80 -> V_8 , L_96 , V_169 , V_172 ) ;
F_95 ( & V_15 -> V_71 , F_23 ) ;
V_15 -> V_171 = V_171 ;
V_171 -> V_16 = V_15 ;
if ( V_15 -> V_9 -> V_50 ) {
...
static char * F_102 ( enum V_183 V_96 )
{
switch ( V_96 ) {
case V_133 :
return L_99 ;
...
struct V_5 * V_6 ;
T_3 V_91 = 0 ;
V_91 += snprintf ( V_184 + V_91 , V_185 - V_91 ,
L_110 , V_2 -> V_9 -> V_10 ,
V_26 ? L_111 : L_112 ) ;
V_91 += snprintf ( V_184 + V_91 , V_185 - V_91 , L_113 ,
...
F_74 ( V_83 ) ,
F_32 ( V_83 ) ) ;
V_91 += snprintf ( V_184 + V_91 , V_185 - V_91 , L_116 ) ;
if ( F_81 ( & V_2 -> V_6 [ V_26 ] . V_99 ) ) {
V_91 += snprintf ( V_184 + V_91 , V_185 - V_91 ,
L_117 ) ;
goto V_44;
...
T_3 V_189 = V_190 , V_91 = 0 , V_17 = 0 ;
char * V_184 ;
V_184 = F_106 ( V_189 , V_94 ) ;
if ( ! V_184 )
return - V_95 ;
if ( V_2 -> V_35 -> V_18 -> V_28 . V_54 )
V_91 += F_103 ( V_2 , V_27 ,
V_184 + V_91 , V_189 - V_91 ) ;
if ( V_2 -> V_35 -> V_18 -> V_30 . V_54 )
V_91 += F_103 ( V_2 , V_78 ,
V_184 + V_91 , V_189 - V_91 ) ;
V_17 = F_107 ( V_187 , V_131 , V_188 , V_184 , V_91 ) ;
F_48 ( V_184 ) ;
return V_17 ;
}
