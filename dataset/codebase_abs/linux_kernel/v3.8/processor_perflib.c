...
V_8 -> V_16 -> V_20 =
F_32 ( sizeof( struct V_65 ) * V_83 -> V_55 . V_56 ,
V_86 ) ;
if ( ! V_8 -> V_16 -> V_20 ) {
V_51 = - V_87 ;
goto V_58;
...
V_91:
#ifdef F_35
if ( F_36 ( F_12 ( V_8 -> V_24 , L_1 , & V_24 ) ) ) {
if( F_37 ( V_92 ) )
...
if ( ! V_8 )
continue;
V_8 -> V_16 = F_46 ( V_16 , V_67 ) ;
F_47 ( V_67 , V_8 -> V_16 -> V_121 ) ;
if ( F_42 ( V_8 ) ) {
V_115 = - V_23 ;
continue;
}
