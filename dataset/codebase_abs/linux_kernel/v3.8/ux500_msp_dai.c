...
{
struct V_5 * V_6 = F_2 ( V_2 -> V_7 ) ;
V_6 -> V_164 . V_165 = V_6 -> V_142 -> V_166 ;
V_6 -> V_167 . V_165 = V_6 -> V_142 -> V_168 ;
V_2 -> V_164 = & V_6 -> V_164 ;
V_2 -> V_167 = & V_6 -> V_167 ;
V_6 -> V_164 . V_129 = V_6 -> V_157 ;
V_6 -> V_167 . V_129 = V_6 -> V_157 ;
return 0 ;
}
static int F_32 ( struct V_169 * V_170 )
{
struct V_5 * V_6 ;
int V_116 = 0 ;
F_3 ( & V_170 -> V_7 , L_37 , V_27 ,
V_170 -> V_171 ) ;
V_6 = F_33 ( & V_170 -> V_7 ,
sizeof( struct V_5 ) ,
V_172 ) ;
...
F_37 ( V_149 , ( char * ) V_170 -> V_171 , 50 ) ;
V_6 -> V_143 = F_38 ( & V_170 -> V_7 , L_40 ) ;
if ( F_35 ( V_6 -> V_143 ) ) {
...
V_6 -> V_145 = F_38 ( & V_170 -> V_7 , NULL ) ;
if ( F_35 ( V_6 -> V_145 ) ) {
V_116 = ( int ) F_36 ( V_6 -> V_145 ) ;
F_5 ( & V_170 -> V_7 , L_42 ,
V_27 , V_116 ) ;
goto V_146;
}
V_116 = F_39 ( V_170 , & V_6 -> V_142 ,
V_170 -> V_7 . V_175 ) ;
if ( ! V_6 -> V_142 ) {
F_5 ( & V_170 -> V_7 ,
L_43 ,
...
F_40 ( & V_170 -> V_7 , V_6 ) ;
V_116 = F_41 ( & V_170 -> V_7 ,
& V_177 [ V_6 -> V_142 -> V_140 ] ) ;
if ( V_116 < 0 ) {
F_5 ( & V_170 -> V_7 , L_44 ,
...
static int F_47 ( struct V_169 * V_170 )
{
struct V_5 * V_6 = F_2 ( & V_170 -> V_7 ) ;
F_48 ( V_170 ) ;
F_43 ( & V_170 -> V_7 , F_44 ( V_177 ) ) ;
F_46 ( V_6 -> V_141 ) ;
F_49 ( V_149 , L_21 ) ;
