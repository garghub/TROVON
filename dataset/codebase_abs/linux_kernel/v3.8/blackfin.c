...
struct V_110 * V_111 ;
int V_112 = - V_113 ;
V_111 = F_63 ( sizeof( * V_111 ) , V_114 ) ;
if ( ! V_111 ) {
F_64 ( & V_105 -> V_108 , L_9 ) ;
goto V_115;
}
V_5 = F_65 ( L_10 , V_116 ) ;
if ( ! V_5 ) {
F_64 ( & V_105 -> V_108 , L_11 ) ;
goto V_117;
}
V_5 -> V_108 . V_118 = & V_105 -> V_108 ;
V_5 -> V_108 . V_119 = & V_120 ;
V_5 -> V_108 . V_121 = V_120 ;
V_111 -> V_108 = & V_105 -> V_108 ;
V_111 -> V_5 = V_5 ;
V_107 -> V_122 = & V_123 ;
F_66 ( V_105 , V_111 ) ;
V_112 = F_67 ( V_5 , V_105 -> V_124 ,
V_105 -> V_125 ) ;
if ( V_112 ) {
F_64 ( & V_105 -> V_108 , L_12 ) ;
goto V_126;
}
V_112 = F_68 ( V_5 , V_107 , sizeof( * V_107 ) ) ;
if ( V_112 ) {
F_64 ( & V_105 -> V_108 , L_13 ) ;
goto V_126;
}
V_112 = F_69 ( V_5 ) ;
if ( V_112 ) {
F_64 ( & V_105 -> V_108 , L_14 ) ;
goto V_126;
}
return 0 ;
V_126:
...
{
struct V_110 * V_111 = F_73 ( V_105 ) ;
F_74 ( V_111 -> V_5 ) ;
F_71 ( V_111 ) ;
return 0 ;
}
static int F_75 ( struct V_127 * V_108 )
{
struct V_110 * V_111 = F_76 ( V_108 ) ;
struct V_5 * V_5 = F_77 ( V_111 ) ;
if ( F_27 ( V_5 ) )
F_31 ( V_5 -> V_54 -> V_55 , 0 ) ;
return 0 ;
}
static int F_78 ( struct V_127 * V_108 )
{
struct V_110 * V_111 = F_76 ( V_108 ) ;
struct V_5 * V_5 = F_77 ( V_111 ) ;
F_40 ( V_5 ) ;
