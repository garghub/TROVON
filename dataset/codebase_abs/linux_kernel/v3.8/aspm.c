...
static void F_53 ( struct V_11 * V_15 , int V_89 , bool V_110 ,
bool V_111 )
{
struct V_11 * V_32 = V_15 -> V_63 -> V_64 ;
struct V_1 * V_2 ;
...
static int F_57 ( const char * V_88 , struct V_113 * V_114 )
{
int V_115 ;
struct V_1 * V_2 ;
if ( V_95 )
return - V_116 ;
for ( V_115 = 0 ; V_115 < F_58 ( V_117 ) ; V_115 ++ )
if ( ! strncmp ( V_88 , V_117 [ V_115 ] , strlen ( V_117 [ V_115 ] ) ) )
break;
if ( V_115 >= F_58 ( V_117 ) )
return - V_94 ;
if ( V_115 == V_3 )
...
static int F_59 ( char * V_118 , struct V_113 * V_114 )
{
int V_115 , V_119 = 0 ;
for ( V_115 = 0 ; V_115 < F_58 ( V_117 ) ; V_115 ++ )
if ( V_115 == V_3 )
V_119 += sprintf ( V_118 + V_119 , L_3 , V_117 [ V_115 ] ) ;
else
V_119 += sprintf ( V_118 + V_119 , L_4 , V_117 [ V_115 ] ) ;
return V_119 ;
}
static T_3 F_60 ( struct V_120 * V_44 ,
struct V_121 * V_122 ,
char * V_123 )
{
struct V_11 * V_124 = F_61 ( V_44 ) ;
struct V_1 * V_65 = V_124 -> V_65 ;
return sprintf ( V_123 , L_5 , V_65 -> V_76 ) ;
}
static T_3 F_62 ( struct V_120 * V_44 ,
struct V_121 * V_122 ,
const char * V_123 ,
T_4 V_125 )
{
...
static T_3 F_63 ( struct V_120 * V_44 ,
struct V_121 * V_122 ,
char * V_123 )
{
struct V_11 * V_124 = F_61 ( V_44 ) ;
struct V_1 * V_65 = V_124 -> V_65 ;
return sprintf ( V_123 , L_5 , V_65 -> V_19 ) ;
}
static T_3 F_64 ( struct V_120 * V_44 ,
struct V_121 * V_122 ,
const char * V_123 ,
T_4 V_125 )
{
