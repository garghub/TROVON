...
struct V_76 * V_77 ;
V_77 = F_32 ( & V_72 -> V_73 -> V_5 -> V_78 ) ;
V_77 -> V_70 = ( unsigned long ) V_72 ;
F_45 ( V_77 ) ;
}
void F_46 ( void )
{
...
static int T_5 F_59 ( struct V_2 * V_3 , int V_81 )
{
struct V_28 * V_29 = F_3 ( V_3 -> V_5 , V_81 ) ;
T_1 V_82 = sizeof( struct V_83 ) * F_20 ( V_3 ) ;
if ( ! V_29 -> V_65 ) {
V_29 -> V_65 = F_60 ( V_82 , V_84 , F_61 ( V_81 ) ) ;
if ( ! V_29 -> V_65 ) {
F_62 ( L_1 , V_82 ) ;
return - V_85 ;
}
...
void * V_89 )
{
struct V_2 * V_3 = F_65 ( V_87 , struct V_2 , V_90 ) ;
int V_91 , V_81 = ( unsigned long ) V_89 ;
struct V_28 * V_29 = F_3 ( V_3 -> V_5 , V_81 ) ;
switch ( V_88 ) {
case V_92 :
case V_93 :
...
static int T_6 F_67 ( struct V_2 * V_3 )
{
int V_4 ;
V_3 -> V_97 = 10 ;
V_3 -> V_40 = 2 * F_20 ( V_3 ) ;
V_3 -> V_66 = 4 * F_20 ( V_3 ) ;
V_3 -> V_5 = F_68 ( struct V_28 ) ;
if ( ! V_3 -> V_5 )
return - V_85 ;
F_69 (i) {
if ( F_59 ( V_3 , V_4 ) )
