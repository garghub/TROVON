...
int V_142 ;
int V_143 = 0 ;
V_143 = F_49 ( & V_144 , V_145 ) ;
if ( V_143 == 0 )
return - V_146 ;
F_31 ( & V_147 ) ;
V_143 = F_50 ( & V_144 , V_130 , & V_142 ) ;
F_34 ( & V_147 ) ;
if ( V_143 < 0 )
return V_143 ;
V_141 = F_51 ( V_145 , L_16 , V_140 -> V_141 , V_142 ) ;
if ( ! V_141 ) {
F_11 ( & V_130 -> V_15 , L_17 ) ;
V_143 = - V_146 ;
goto V_148;
}
V_2 = F_52 ( sizeof( * V_2 ) , V_145 ) ;
if ( ! V_2 ) {
...
{
struct V_1 * V_2 = F_57 ( V_130 ) ;
F_41 ( V_2 ) ;
F_54 ( V_2 -> V_61 . V_141 ) ;
F_31 ( & V_147 ) ;
F_55 ( & V_144 , V_2 -> V_140 ) ;
F_34 ( & V_147 ) ;
F_54 ( V_2 ) ;
return 0 ;
}
...
static int F_64 ( struct V_162 * V_163 )
{
struct V_1 * V_2 ;
...
V_2 -> V_15 = & V_163 -> V_15 ;
V_2 -> V_5 = V_164 ;
V_2 -> V_61 . V_141 = V_156 -> V_141 ? : F_66 ( & V_163 -> V_15 ) ;
V_2 -> V_7 . V_8 = & F_63 ;
V_98 = F_36 ( V_2 ) ;
if ( V_98 )
goto V_165;
...
static int F_67 ( struct V_162 * V_163 )
{
struct V_1 * V_2 = F_68 ( V_163 ) ;
F_41 ( V_2 ) ;
F_65 ( V_163 , NULL ) ;
F_54 ( V_2 ) ;
return 0 ;
