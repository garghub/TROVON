...
struct V_120 * F_79 ( struct V_121 * log ,
T_5 V_122 )
{
struct V_123 * V_124 =
(struct V_123 * ) log -> V_125 ;
struct V_120 * V_126 ;
unsigned char * V_24 , * V_127 ;
if ( log -> V_128 < sizeof( struct V_123 ) ||
V_124 -> V_129 != V_130 ||
V_124 -> V_131 != V_132 )
return NULL ;
V_127 = log -> V_125 + log -> V_128 ;
V_24 = V_124 -> V_133 ;
while ( V_24 < V_127 ) {
V_126 = (struct V_120 * ) V_24 ;
if ( V_126 -> V_134 == V_122 )
return V_126 ;
V_24 += V_126 -> V_135 ;
}
return NULL ;
}
T_6 int F_80 ( struct V_5 T_7 * V_136 )
{
struct V_5 args ;
unsigned long V_1 ;
char * V_53 , * V_137 = NULL ;
int V_9 ;
int V_62 ;
if ( ! F_81 ( V_138 ) )
return - V_139 ;
if ( F_82 ( & args , V_136 , 3 * sizeof( T_2 ) ) != 0 )
return - V_65 ;
V_9 = args . V_9 ;
if ( V_9 > F_83 ( args . args )
|| args . V_10 > F_83 ( args . args )
|| V_9 + args . V_10 > F_83 ( args . args ) )
return - V_64 ;
if ( F_82 ( args . args , V_136 -> args ,
V_9 * sizeof( V_12 ) ) != 0 )
return - V_65 ;
if ( args . V_8 == V_34 )
return - V_64 ;
...
V_2 . V_37 = F_87 ( NULL , L_30 ) ;
if ( V_2 . V_37 ) {
const T_2 * V_144 , * V_145 , * V_146 ;
V_144 = F_24 ( V_2 . V_37 , L_31 , NULL ) ;
V_146 = F_24 ( V_2 . V_37 , L_32 , NULL ) ;
if ( V_144 != NULL && V_146 != NULL ) {
V_2 . V_7 = * V_144 ;
V_2 . V_147 = * V_146 ;
V_145 = F_24 ( V_2 . V_37 ,
L_33 , NULL ) ;
...
return;
#ifdef F_88
if ( F_89 ( V_148 ) && F_90 ( V_149 ) ) {
V_142 = F_91 ( V_150 , V_143 ) ;
V_140 = F_26 ( L_26 ) ;
}
#endif
V_151 = F_92 ( V_152 , V_153 , V_142 ) ;
#ifdef F_93
V_46 = F_26 ( L_34 ) ;
#endif
}
int T_1 F_94 ( unsigned long V_154 ,
const char * V_155 , int V_156 , void * V_94 )
{
T_2 * V_144 , * V_145 , * V_146 ;
if ( V_156 != 1 || strcmp ( V_155 , L_30 ) != 0 )
return 0 ;
V_144 = F_95 ( V_154 , L_31 , NULL ) ;
V_145 = F_95 ( V_154 , L_33 , NULL ) ;
V_146 = F_95 ( V_154 , L_32 , NULL ) ;
...
#ifdef F_96
V_144 = F_95 ( V_154 , L_35 , NULL ) ;
if ( V_144 )
V_17 = * V_144 ;
V_144 = F_95 ( V_154 , L_36 , NULL ) ;
if ( V_144 )
V_18 = * V_144 ;
if ( V_17 != V_34 &&
V_18 != V_34 )
...
F_101 () ;
F_99 ( & V_157 ) ;
F_103 ( V_158 >> 32 , V_158 & 0xffffffff ) ;
V_158 = 0 ;
F_6 ( & V_157 ) ;
}
