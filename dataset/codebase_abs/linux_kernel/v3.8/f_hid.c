...
if ( V_36 )
goto V_91;
F_55 ( V_117 , NULL , V_96 , NULL , L_19 , L_20 , V_9 -> V_116 ) ;
return 0 ;
V_91:
...
static void F_57 ( struct V_94 * V_95 , struct V_2 * V_3 )
{
struct V_1 * V_9 = F_1 ( V_3 ) ;
F_58 ( V_117 , F_53 ( V_115 , V_9 -> V_116 ) ) ;
F_59 ( & V_9 -> V_38 ) ;
F_38 ( V_9 -> V_49 ) ;
...
if ( V_120 >= V_121 )
return - V_122 ;
if ( V_123 [ V_124 ] . V_125 == 0 ) {
V_36 = F_62 ( V_95 -> V_38 ) ;
if ( V_36 < 0 )
return V_36 ;
V_123 [ V_124 ] . V_125 = V_36 ;
V_97 . V_126 = V_36 ;
}
...
return - V_42 ;
V_9 -> V_116 = V_120 ;
V_9 -> V_102 = V_119 -> V_127 ;
V_9 -> V_103 = V_119 -> V_128 ;
V_9 -> V_30 = V_119 -> V_30 ;
V_9 -> V_110 = V_119 -> V_110 ;
V_9 -> V_83 = F_63 ( V_119 -> V_83 ,
V_119 -> V_110 ,
V_32 ) ;
if ( ! V_9 -> V_83 ) {
F_13 ( V_9 ) ;
...
V_9 -> V_4 . V_135 = F_34 ;
V_9 -> V_92 = 4 ;
V_36 = F_64 ( V_95 , & V_9 -> V_4 ) ;
if ( V_36 )
F_13 ( V_9 ) ;
return V_36 ;
}
int T_7 F_65 ( struct V_136 * V_137 , int V_7 )
{
int V_36 ;
T_8 V_96 ;
V_117 = F_66 ( V_138 , L_20 ) ;
V_36 = F_67 ( & V_96 , 0 , V_7 , L_20 ) ;
if ( ! V_36 ) {
V_115 = F_68 ( V_96 ) ;
V_121 = V_7 ;
}
