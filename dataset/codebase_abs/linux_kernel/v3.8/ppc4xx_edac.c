...
static enum V_78 F_24 ( T_1 V_79 )
{
switch ( V_79 & V_33 ) {
case V_34 :
return V_80 ;
...
static enum V_83 F_25 ( T_1 V_79 )
{
...
static int F_26 ( struct V_13 * V_14 , T_1 V_79 )
{
const struct V_24 * V_25 = V_14 -> V_26 ;
int V_8 = 0 ;
enum V_83 V_95 ;
...
return - V_127 ;
V_14 -> V_143 = & V_135 -> V_140 ;
F_32 ( V_14 -> V_143 , V_14 ) ;
V_25 = V_14 -> V_26 ;
V_25 -> V_1 = * V_1 ;
V_25 -> V_144 . V_145 = V_146 ;
V_25 -> V_144 . V_147 = V_146 ;
V_14 -> V_148 = ( V_149 | V_150 |
V_151 | V_152 ) ;
V_14 -> V_153 = ( V_154 |
V_105 |
V_103 ) ;
...
V_14 -> V_161 = V_162 ;
V_14 -> V_163 = V_164 ;
V_14 -> V_165 = V_142 -> V_166 ,
V_14 -> V_21 = V_139 -> V_167 ;
V_14 -> V_168 = F_21 ;
V_14 -> V_169 = NULL ;
V_8 = F_26 ( V_14 , V_79 ) ;
if ( V_8 )
...
static int F_33 ( struct V_134 * V_135 ,
struct V_13 * V_14 )
{
int V_8 = 0 ;
int V_170 , V_171 ;
...
V_171 = F_34 ( V_139 , V_173 ) ;
if ( V_170 == V_146 || V_171 == V_146 ) {
F_15 ( V_126 , V_14 ,
L_26 ) ;
V_8 = - V_174 ;
goto V_22;
...
F_15 ( V_54 , V_14 , L_31 , V_170 ) ;
F_15 ( V_54 , V_14 , L_32 , V_171 ) ;
V_25 -> V_144 . V_147 = V_170 ;
V_25 -> V_144 . V_145 = V_171 ;
return 0 ;
V_177:
F_36 ( V_171 , V_14 ) ;
V_176:
...
static int F_37 ( const struct V_138 * V_139 ,
T_2 * V_1 )
{
...
V_182 [ 1 ] . V_16 = V_190 ;
V_182 [ 1 ] . V_188 = false ;
V_14 = F_45 ( V_183 , F_46 ( V_182 ) , V_182 ,
sizeof( struct V_24 ) ) ;
if ( V_14 == NULL ) {
F_40 ( V_126 , L_41
L_42 ,
...
struct V_24 * V_25 = V_14 -> V_26 ;
if ( V_192 == V_193 ) {
F_36 ( V_25 -> V_144 . V_145 , V_14 ) ;
F_36 ( V_25 -> V_144 . V_147 , V_14 ) ;
}
F_52 ( V_25 -> V_1 , V_180 ) ;
F_48 ( V_14 -> V_143 ) ;
F_49 ( V_14 ) ;
