...
F_53 ( V_17 . V_24 ) ;
F_54 ( & V_21 -> V_74 ) ;
V_7 -> V_71 . V_72 = F_55 ( F_56 () , V_45 -> V_72 ) ;
V_7 -> V_71 . V_73 = F_57 ( F_56 () , V_45 -> V_73 ) ;
F_58 ( & V_21 -> V_74 ) ;
}
F_20 ( & V_17 ) ;
V_16:
...
V_76 = V_7 -> V_77 . V_76 ;
V_36 = V_27 -> V_23 . V_36 ;
return F_60 ( V_21 -> V_70 , V_36 , V_21 , V_76 ) ;
}
...
unsigned int V_100 = F_68 ( V_5 ) ;
return ( V_100 >= F_69 ( V_85 ) ) ? NULL : V_85 [ V_100 ] . V_84 ;
}
static int F_70 ( unsigned int V_101 , struct V_6 T_2 * V_102 )
{
struct V_6 * V_7 ;
struct V_19 * V_27 ;
struct V_18 * V_21 ;
...
{
int V_8 ;
V_8 = F_70 ( V_101 , (struct V_6 T_2 * ) V_115 ) ;
return ( long ) V_8 ;
}
static long F_76 ( struct V_19 * V_19 , T_5 V_101 , T_6 V_115 )
{
return ( long ) V_6 ( V_19 , V_101 , ( T_6 ) F_77 ( V_115 ) ) ;
}
int F_78 ( void )
{
int V_116 ;
