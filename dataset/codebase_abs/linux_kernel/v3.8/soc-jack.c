...
static T_1 F_29 ( int V_38 , void * V_39 )
{
struct V_34 * V_35 = V_39 ;
struct V_40 * V_30 = V_35 -> V_5 -> V_2 -> V_10 -> V_30 ;
F_30 ( V_35 -> V_41 ) ;
if ( F_31 ( V_30 ) )
F_32 ( V_30 , V_35 -> V_42 + 50 ) ;
F_33 ( & V_35 -> V_43 ,
F_34 ( V_35 -> V_42 ) ) ;
return V_44 ;
}
static void F_35 ( struct V_45 * V_43 )
{
struct V_34 * V_35 ;
V_35 = F_36 ( V_43 , struct V_34 , V_43 . V_43 ) ;
F_27 ( V_35 ) ;
}
int F_37 ( struct V_4 * V_5 , int V_20 ,
struct V_34 * V_46 )
{
int V_23 , V_47 ;
for ( V_23 = 0 ; V_23 < V_20 ; V_23 ++ ) {
if ( ! F_38 ( V_46 [ V_23 ] . V_35 ) ) {
...
V_47 = F_39 ( V_46 [ V_23 ] . V_35 , V_46 [ V_23 ] . V_41 ) ;
if ( V_47 )
goto V_48;
V_47 = F_40 ( V_46 [ V_23 ] . V_35 ) ;
if ( V_47 )
goto V_49;
F_41 ( & V_46 [ V_23 ] . V_43 , F_35 ) ;
V_46 [ V_23 ] . V_5 = V_5 ;
V_47 = F_42 ( F_43 ( V_46 [ V_23 ] . V_35 ) ,
F_29 ,
V_50 |
V_51 ,
V_46 [ V_23 ] . V_41 ,
...
goto V_49;
if ( V_46 [ V_23 ] . V_52 ) {
V_47 = F_44 ( F_43 ( V_46 [ V_23 ] . V_35 ) , 1 ) ;
if ( V_47 != 0 )
F_21 ( V_5 -> V_2 -> V_30 , L_6
L_7 ,
V_46 [ V_23 ] . V_35 , V_47 ) ;
}
F_45 ( V_46 [ V_23 ] . V_35 , false ) ;
F_27 ( & V_46 [ V_23 ] ) ;
}
return 0 ;
V_49:
...
void F_47 ( struct V_4 * V_5 , int V_20 ,
struct V_34 * V_46 )
{
int V_23 ;
for ( V_23 = 0 ; V_23 < V_20 ; V_23 ++ ) {
F_48 ( V_46 [ V_23 ] . V_35 ) ;
F_49 ( F_43 ( V_46 [ V_23 ] . V_35 ) , & V_46 [ V_23 ] ) ;
F_50 ( & V_46 [ V_23 ] . V_43 ) ;
F_46 ( V_46 [ V_23 ] . V_35 ) ;
V_46 [ V_23 ] . V_5 = NULL ;
}
