...
V_270 += F_130 ( F_3 ( V_110 -> V_30 . V_31 [ 2 ] ) ) ;
}
V_270 += F_130 ( F_3 ( V_110 -> V_30 . V_31 [ 2 ] ) ) -
F_130 ( F_3 ( V_131 -> V_257 ) ) ;
if ( V_248 != V_259 ) {
...
static int F_133 ( struct V_9 * V_10 , struct V_95 * V_245 ,
struct V_253 * V_131 ,
struct V_74 * V_75 , int * V_116 )
{
struct V_11 * V_100 ;
...
T_7 F_140 ( int V_295 , struct V_118 * V_119 )
{
return F_138 ( V_119 ) ;
}
...
unsigned int V_270 = F_148 ( V_319 ) ;
V_317 = V_321 -
( F_149 ( V_319 ) & ( V_321 - 1 ) ) ;
V_317 &= V_321 - 1 ;
if ( V_317 != 0 )
V_39 ++ ;
while ( V_317 < F_148 ( V_319 ) && V_317 < V_212 ) {
V_39 ++ ;
V_317 += V_321 ;
}
V_270 = F_150 ( int , V_270 , V_212 ) ;
V_212 -= V_270 ;
if ( V_212 == 0 )
break;
}
...
static void F_151 ( struct V_92 * V_92 , int V_39 , int V_317 )
{
if ( V_39 != 0 )
F_152 ( & V_92 -> V_93 -> V_93 , L_127
L_128 , V_237 ,
V_92 -> V_75 -> V_94 . V_283 , V_39 ) ;
if ( V_317 != V_92 -> V_263 )
F_152 ( & V_92 -> V_93 -> V_93 , L_129
L_130 ,
V_237 ,
...
int F_154 ( struct V_9 * V_10 , T_8 V_307 ,
...
return F_158 ( V_10 , V_307 , V_92 , V_70 , V_71 ) ;
}
static T_2 F_159 ( unsigned int V_328 )
{
...
static T_2 F_160 ( int V_317 , int V_330 ,
...
return 0 ;
V_333 = ( V_317 + V_330 ) /
F_161 ( F_162 ( & V_92 -> V_75 -> V_94 ) ) ;
if ( ( V_331 - V_333 ) > 31 )
return 31 << 17 ;
return ( V_331 - V_333 ) << 17 ;
}
static int F_163 ( struct V_9 * V_10 , T_8 V_307 ,
struct V_92 * V_92 , int V_70 , unsigned int V_71 )
{
struct V_11 * V_100 ;
unsigned int V_39 ;
...
V_316 = V_92 -> V_320 ;
V_331 = F_164 ( V_92 -> V_263 ,
F_162 ( & V_92 -> V_75 -> V_94 ) ) ;
V_330 = F_144 ( V_10 , V_10 -> V_76 [ V_70 ] ,
V_71 , V_92 -> V_72 ,
V_39 , V_92 , 0 , V_307 ) ;
if ( V_330 < 0 )
return V_330 ;
...
V_317 = 0 ;
V_319 = V_92 -> V_319 ;
V_21 = ( T_3 ) F_149 ( V_319 ) ;
V_334 = F_148 ( V_319 ) ;
V_330 = V_321 - ( V_21 & ( V_321 - 1 ) ) ;
V_330 = F_150 ( int , V_330 , V_334 ) ;
if ( V_330 > V_92 -> V_263 )
V_330 = V_92 -> V_263 ;
V_111 = true ;
do {
...
F_151 ( V_92 , V_39 , V_317 ) ;
F_153 ( V_10 , V_70 , V_71 , V_92 -> V_72 ,
V_322 , V_239 ) ;
return 0 ;
}
int F_158 ( struct V_9 * V_10 , T_8 V_307 ,
struct V_92 * V_92 , int V_70 , unsigned int V_71 )
{
struct V_11 * V_100 ;
struct V_120 * V_120 ;
...
T_3 V_21 ;
if ( V_92 -> V_316 )
return F_163 ( V_10 , V_307 , V_92 , V_70 , V_71 ) ;
V_100 = F_42 ( V_10 , V_92 ) ;
if ( ! V_100 )
return - V_312 ;
V_39 = 0 ;
...
int F_170 ( struct V_9 * V_10 , T_8 V_307 ,
struct V_92 * V_92 , int V_70 , unsigned int V_71 )
{
struct V_11 * V_100 ;
int V_39 ;
...
V_342 -> V_346 | V_342 -> V_350 << 8 | F_172 ( V_342 -> V_351 ) << 16 ,
F_172 ( V_342 -> V_352 ) | F_172 ( V_342 -> V_353 ) << 16 ,
F_130 ( 8 ) | F_166 ( 0 ) ,
V_31 ) ;
if ( F_165 ( V_92 ) )
...
static int F_177 ( struct V_9 * V_10 , T_8 V_307 ,
struct V_92 * V_92 , int V_70 , unsigned int V_71 )
{
struct V_11 * V_100 ;
struct V_120 * V_120 ;
...
if ( V_331 == 0 )
V_331 ++ ;
V_369 = F_174 ( V_10 , V_92 -> V_93 , V_92 ,
V_331 ) ;
V_363 = F_176 ( V_10 ,
V_92 -> V_93 , V_92 , V_331 ) ;
V_365 = F_173 ( V_10 , V_92 , V_141 ) ;
...
int F_181 ( struct V_9 * V_10 , T_8 V_307 ,
struct V_92 * V_92 , int V_70 , unsigned int V_71 )
{
struct V_99 * V_255 ;
struct V_11 * V_100 ;
...
return F_177 ( V_10 , V_307 , V_92 , V_70 , V_71 ) ;
}
static int F_182 ( struct V_9 * V_10 , T_2 V_303 , T_2 V_304 ,
...
if ( ! V_378 )
V_379 ++ ;
V_48 = F_142 ( V_10 , V_10 -> V_50 , V_314 ,
V_379 , V_62 ) ;
if ( V_48 < 0 ) {
F_22 ( V_10 , L_140 ) ;
if ( V_378 )
...
F_141 ( V_10 , V_10 -> V_50 , false , V_303 , V_304 , V_305 ,
V_306 | V_10 -> V_50 -> V_27 ) ;
return 0 ;
}
int F_183 ( struct V_9 * V_10 , T_2 V_198 , T_2 V_70 )
{
return F_182 ( V_10 , 0 , 0 , 0 ,
F_49 ( V_198 ) | F_184 ( V_70 ) , false ) ;
}
int F_185 ( struct V_9 * V_10 , T_1 V_381 ,
T_2 V_70 )
{
return F_182 ( V_10 , F_167 ( V_381 ) ,
F_168 ( V_381 ) , 0 ,
F_49 ( V_191 ) | F_184 ( V_70 ) ,
false ) ;
}
int F_186 ( struct V_9 * V_10 ,
T_2 V_303 , T_2 V_304 , T_2 V_305 , T_2 V_306 )
{
return F_182 ( V_10 , V_303 , V_304 , V_305 , V_306 , false ) ;
}
int F_187 ( struct V_9 * V_10 , T_2 V_70 )
{
return F_182 ( V_10 , 0 , 0 , 0 ,
F_49 ( V_195 ) | F_184 ( V_70 ) ,
false ) ;
}
...
return F_182 ( V_10 , F_167 ( V_381 ) ,
F_168 ( V_381 ) , 0 ,
F_49 ( V_183 ) | F_184 ( V_70 ) ,
V_378 ) ;
}
int F_188 ( struct V_9 * V_10 , T_1 V_381 ,
T_2 V_70 , bool V_378 )
{
return F_182 ( V_10 , F_167 ( V_381 ) ,
F_168 ( V_381 ) , 0 ,
F_49 ( V_190 ) | F_184 ( V_70 ) ,
V_378 ) ;
}
int F_189 ( struct V_9 * V_10 , int V_70 ,
unsigned int V_71 , int V_382 )
{
T_2 V_383 = F_184 ( V_70 ) ;
T_2 V_384 = F_190 ( V_71 ) ;
T_2 type = F_49 ( V_192 ) ;
T_2 V_385 = F_191 ( V_382 ) ;
return F_182 ( V_10 , 0 , 0 , 0 ,
...
V_75 -> V_158 = V_24 ;
V_75 -> V_147 = V_386 ;
return F_182 ( V_10 , F_167 ( V_21 ) | V_27 ,
F_168 ( V_21 ) , V_387 ,
...
T_2 V_384 = F_190 ( V_71 ) ;
T_2 type = F_49 ( V_194 ) ;
return F_182 ( V_10 , 0 , 0 , 0 , V_383 | V_384 | type ,
false ) ;
}
