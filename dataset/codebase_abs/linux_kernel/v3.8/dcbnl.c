...
V_239 = F_1 ( V_242 -> type , V_10 -> V_2 , V_212 , V_11 -> V_252 ,
V_11 -> V_253 , & V_240 ) ;
if ( ! V_239 ) {
V_29 = - V_215 ;
goto V_251;
}
V_29 = V_242 -> V_249 ( V_18 , V_11 , V_11 -> V_252 , V_20 , V_239 ) ;
if ( V_29 < 0 ) {
F_53 ( V_239 ) ;
goto V_251;
}
F_55 ( V_239 , V_240 ) ;
V_29 = F_76 ( V_239 , V_214 , V_212 ) ;
V_251:
F_77 ( V_18 ) ;
return V_29 ;
}
...
{
struct V_156 * V_254 ;
V_254 = F_42 ( sizeof( * V_254 ) , V_255 ) ;
if ( ! V_254 )
return - V_152 ;
memcpy ( & V_254 -> V_72 , V_72 , sizeof( * V_72 ) ) ;
V_254 -> V_176 = V_176 ;
F_80 ( & V_254 -> V_256 , & V_257 ) ;
return 0 ;
}
...
int F_26 ( struct V_17 * V_186 , struct V_71 * V_258 )
{
struct V_156 * V_157 ;
struct V_156 V_211 ;
int V_150 = 0 ;
V_211 . V_176 = V_186 -> V_176 ;
memcpy ( & V_211 . V_72 , V_258 , sizeof( V_211 . V_72 ) ) ;
if ( V_186 -> V_21 -> V_178 )
V_211 . V_158 = V_186 -> V_21 -> V_178 ( V_186 ) ;
F_46 ( & V_175 ) ;
if ( ( V_157 = F_78 ( V_258 , V_186 -> V_176 , 0 ) ) ) {
if ( V_258 -> V_78 )
V_157 -> V_72 . V_78 = V_258 -> V_78 ;
else {
F_81 ( & V_157 -> V_256 ) ;
F_43 ( V_157 ) ;
}
...
int F_61 ( struct V_17 * V_186 , struct V_71 * V_258 )
{
struct V_156 V_211 ;
int V_150 = 0 ;
V_211 . V_176 = V_186 -> V_176 ;
...
V_211 . V_158 = V_186 -> V_21 -> V_178 ( V_186 ) ;
F_46 ( & V_175 ) ;
if ( F_78 ( V_258 , V_186 -> V_176 , V_258 -> V_78 ) ) {
V_150 = - V_260 ;
goto V_251;
}
V_150 = F_79 ( V_258 , V_186 -> V_176 ) ;
...
int F_64 ( struct V_17 * V_186 , struct V_71 * V_261 )
{
struct V_156 * V_157 ;
struct V_156 V_211 ;
int V_150 = - V_262 ;
V_211 . V_176 = V_186 -> V_176 ;
memcpy ( & V_211 . V_72 , V_261 , sizeof( V_211 . V_72 ) ) ;
if ( V_186 -> V_21 -> V_178 )
V_211 . V_158 = V_186 -> V_21 -> V_178 ( V_186 ) ;
F_46 ( & V_175 ) ;
if ( ( V_157 = F_78 ( V_261 , V_186 -> V_176 , V_261 -> V_78 ) ) ) {
F_81 ( & V_157 -> V_256 ) ;
F_43 ( V_157 ) ;
V_150 = 0 ;
}
...
{
F_87 ( & V_257 ) ;
F_88 ( V_264 , V_265 , F_70 , NULL , NULL ) ;
F_88 ( V_264 , V_79 , F_70 , NULL , NULL ) ;
return 0 ;
}
