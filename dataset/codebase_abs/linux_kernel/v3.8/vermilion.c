...
static int F_39 ( struct V_55 * V_56 , const struct V_69 * V_70 )
{
struct V_17 * V_18 ;
struct V_57 * V_58 ;
struct V_33 * V_34 ;
...
static int F_75 ( struct V_57 * V_58 , struct V_198 * V_199 )
{
return - V_42 ;
}
...
while ( V_207 != & V_180 ) {
F_84 ( V_207 ) ;
V_205 = F_85 ( V_207 , struct V_17 , V_97 ) ;
if ( ! F_49 ( & V_205 -> V_58 . V_61 , V_205 ) ) {
F_60 ( V_205 ) ;
F_86 ( V_207 , & V_179 ) ;
} else {
F_17 ( & V_35 ) ;
V_208 = V_205 -> V_58 . V_61 . V_212 ;
V_205 -> V_58 . V_61 . V_62 = 16 ;
F_38 ( & V_205 -> V_58 . V_61 ) ;
if ( F_43 ( & V_205 -> V_58 . V_61 ,
& V_205 -> V_58 ,
V_102 , NULL , 0 , NULL , 16 ) ) {
V_205 -> V_58 . V_61 . V_212 |=
V_213 | V_214 ;
F_87 ( & V_205 -> V_58 , & V_205 -> V_58 . V_61 ) ;
} else {
F_7 (KERN_ERR MODULE_NAME
L_38 ) ;
}
V_205 -> V_58 . V_61 . V_212 = V_208 ;
F_15 ( & V_35 ) ;
}
F_66 ( V_205 ) ;
V_207 = V_180 . V_211 ;
...
void F_88 ( struct V_203 * V_204 )
{
struct V_17 * V_205 , * V_211 ;
F_15 ( & V_35 ) ;
if ( V_118 != V_204 ) {
F_17 ( & V_35 ) ;
return;
