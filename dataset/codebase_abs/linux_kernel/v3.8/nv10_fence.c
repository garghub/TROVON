...
void F_25 ( struct V_35 * V_13 )
{
struct V_11 * V_12 = V_13 -> V_2 ;
F_26 ( V_12 -> V_27 , 0 , V_12 -> V_8 ) ;
}
int
F_27 ( struct V_35 * V_13 )
{
struct V_11 * V_12 ;
int V_6 = 0 ;
...
V_12 -> V_24 . V_41 = F_6 ;
F_28 ( & V_12 -> V_18 ) ;
if ( F_29 ( V_13 -> V_42 ) -> V_43 >= 0x17 ) {
V_6 = F_30 ( V_13 -> V_44 , 4096 , 0x1000 , V_45 ,
0 , 0x0000 , NULL , & V_12 -> V_27 ) ;
if ( ! V_6 ) {
V_6 = F_31 ( V_12 -> V_27 , V_45 ) ;
if ( ! V_6 ) {
V_6 = F_32 ( V_12 -> V_27 ) ;
if ( V_6 )
F_23 ( V_12 -> V_27 ) ;
...
if ( V_6 == 0 ) {
F_26 ( V_12 -> V_27 , 0x000 , 0x00000000 ) ;
V_12 -> V_24 . V_41 = F_7 ;
V_12 -> V_24 . V_46 = F_25 ;
}
}
