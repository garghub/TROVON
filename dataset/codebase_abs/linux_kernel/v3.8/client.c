...
{
struct V_13 * V_16 = V_49 -> V_13 ;
V_49 -> V_139 = F_76 ( V_16 -> V_36 ,
V_138 ) ;
if ( F_7 ( V_49 -> V_139 ) ) {
F_35 ( L_12 , V_79 ) ;
return F_62 ( V_49 -> V_139 ) ;
}
...
if ( V_49 -> V_146 & V_147 )
F_79 ( V_148 , & V_15 . V_88 ) ;
V_16 = F_60 ( & V_15 , & V_81 , NULL , V_144 ) ;
if ( F_7 ( V_16 ) ) {
F_35 ( L_16 , F_62 ( V_16 ) ) ;
return F_62 ( V_16 ) ;
}
...
V_181 = F_80 ( F_82 ( V_49 -> V_139 ) , NULL ) ;
if ( V_49 -> V_161 > V_181 )
V_49 -> V_161 = V_181 ;
if ( V_49 -> V_161 > V_186 )
V_49 -> V_161 = V_186 ;
...
F_84 ( V_49 -> V_139 , V_49 -> V_162 + 100 , V_49 -> V_161 + 100 ) ;
}
...
if ( ! V_49 )
return NULL ;
V_49 -> V_139 = V_49 -> V_218 = F_5 ( - V_37 ) ;
F_22 ( & V_49 -> V_213 ) ;
F_22 ( & V_49 -> V_214 ) ;
F_22 ( & V_49 -> V_219 ) ;
F_22 ( & V_49 -> V_220 ) ;
...
error = V_24 -> V_5 -> V_235 ( V_49 , V_227 -> V_178 , V_203 ) ;
if ( error < 0 ) {
F_35 ( L_25 , - error ) ;
goto error;
}
