...
static int F_262 ( struct V_204 * V_1 , unsigned int V_479 ,
unsigned long V_480 )
{
struct V_1 * V_2 = V_1 -> V_2 ;
switch ( V_479 ) {
...
{
int V_482 = F_263 ( V_2 ) ;
return F_258 ( V_482 , ( int T_7 * ) V_480 ) ;
}
case V_483 :
{
struct V_140 * V_133 ;
...
case V_484 :
return F_264 ( V_2 , (struct V_282 T_7 * ) V_480 ) ;
case V_485 :
return F_265 ( V_2 , (struct V_121 T_7 * ) V_480 ) ;
#ifdef F_266
case V_486 :
case V_487 :
case V_488 :
...
case V_498 :
case V_499 :
return V_500 . V_501 ( V_1 , V_479 , V_480 ) ;
#endif
default:
return - V_502 ;
}
...
static unsigned int F_267 ( struct V_503 * V_503 , struct V_204 * V_1 ,
T_8 * V_504 )
{
struct V_1 * V_2 = V_1 -> V_2 ;
struct V_3 * V_4 = F_2 ( V_2 ) ;
unsigned int V_505 = F_268 ( V_503 , V_1 , V_504 ) ;
F_228 ( & V_2 -> V_92 . V_41 ) ;
if ( V_4 -> V_40 . V_29 ) {
...
F_230 ( & V_2 -> V_92 . V_41 ) ;
F_228 ( & V_2 -> V_508 . V_41 ) ;
if ( V_4 -> V_36 . V_29 ) {
if ( F_23 ( V_4 , & V_4 -> V_36 , V_136 ) )
V_505 |= V_509 | V_510 ;
}
F_230 ( & V_2 -> V_508 . V_41 ) ;
return V_505 ;
}
static void F_269 ( struct V_511 * V_512 )
{
struct V_503 * V_503 = V_512 -> V_513 ;
struct V_204 * V_1 = V_503 -> V_514 ;
struct V_1 * V_2 = V_1 -> V_2 ;
if ( V_2 )
F_80 ( & F_2 ( V_2 ) -> V_515 ) ;
}
static void F_270 ( struct V_511 * V_512 )
{
struct V_503 * V_503 = V_512 -> V_513 ;
struct V_204 * V_1 = V_503 -> V_514 ;
struct V_1 * V_2 = V_1 -> V_2 ;
...
static void F_271 ( struct V_68 * V_29 , unsigned int V_516 ,
unsigned int V_139 )
{
int V_172 ;
...
static char * F_275 ( unsigned long V_516 )
{
char * V_30 = NULL ;
T_9 V_517 = V_182 | V_518 |
V_519 | V_520 | V_521 ;
V_30 = ( char * ) F_276 ( V_517 , V_516 ) ;
if ( V_30 )
return V_30 ;
V_30 = F_277 ( ( 1 << V_516 ) * V_102 ) ;
if ( V_30 )
return V_30 ;
V_517 &= ~ V_521 ;
V_30 = ( char * ) F_276 ( V_517 , V_516 ) ;
...
static struct V_68 * F_278 ( struct V_522 * V_451 , int V_516 )
{
unsigned int V_523 = V_451 -> V_77 ;
struct V_68 * V_29 ;
int V_172 ;
V_29 = F_279 ( V_523 , sizeof( struct V_68 ) , V_182 ) ;
if ( F_35 ( ! V_29 ) )
goto V_93;
for ( V_172 = 0 ; V_172 < V_523 ; V_172 ++ ) {
V_29 [ V_172 ] . V_30 = F_275 ( V_516 ) ;
...
T_6 V_150 ;
int V_56 = - V_178 ;
struct V_522 * V_451 = & V_64 -> V_451 ;
if ( ! V_525 && V_36 && ( V_4 -> V_18 > V_21 ) ) {
F_17 ( 1 , L_9 ) ;
goto V_93;
}
V_24 = V_36 ? & V_4 -> V_36 : & V_4 -> V_40 ;
V_38 = V_36 ? & V_2 -> V_508 : & V_2 -> V_92 ;
V_56 = - V_455 ;
if ( ! V_525 ) {
if ( F_48 ( & V_4 -> V_515 ) )
goto V_93;
...
goto V_93;
if ( F_35 ( V_451 -> V_530 < V_4 -> V_79 +
V_4 -> V_289 ) )
goto V_93;
if ( F_35 ( V_451 -> V_530 & ( V_531 - 1 ) ) )
goto V_93;
V_24 -> V_28 = V_451 -> V_75 / V_451 -> V_530 ;
if ( F_35 ( V_24 -> V_28 <= 0 ) )
goto V_93;
...
goto V_93;
V_56 = - V_181 ;
V_516 = F_280 ( V_451 -> V_75 ) ;
V_29 = F_278 ( V_451 , V_516 ) ;
if ( F_35 ( ! V_29 ) )
goto V_93;
switch ( V_4 -> V_18 ) {
case V_22 :
...
V_56 = - V_455 ;
F_113 ( & V_4 -> V_331 ) ;
if ( V_525 || F_48 ( & V_4 -> V_515 ) == 0 ) {
V_56 = 0 ;
F_228 ( & V_38 -> V_41 ) ;
F_281 ( V_24 -> V_29 , V_29 ) ;
V_24 -> V_142 = ( V_451 -> V_532 - 1 ) ;
V_24 -> V_32 = 0 ;
V_24 -> V_31 = V_451 -> V_530 ;
F_230 ( & V_38 -> V_41 ) ;
F_281 ( V_24 -> V_533 , V_516 ) ;
F_281 ( V_24 -> V_534 , V_451 -> V_77 ) ;
V_24 -> V_535 = V_451 -> V_75 / V_102 ;
...
F_10 ( & V_4 -> V_9 ) ;
if ( V_525 && ( V_4 -> V_18 > V_21 ) ) {
if ( ! V_36 )
F_26 ( V_4 , V_36 , V_38 ) ;
}
F_211 ( V_2 ) ;
if ( V_29 )
F_271 ( V_29 , V_516 , V_451 -> V_77 ) ;
V_93:
return V_56 ;
}
static int F_282 ( struct V_503 * V_503 , struct V_204 * V_1 ,
struct V_511 * V_512 )
{
struct V_1 * V_2 = V_1 -> V_2 ;
struct V_3 * V_4 = F_2 ( V_2 ) ;
...
if ( V_24 -> V_29 == NULL )
continue;
for ( V_172 = 0 ; V_172 < V_24 -> V_534 ; V_172 ++ ) {
struct V_319 * V_319 ;
void * V_541 = V_24 -> V_29 [ V_172 ] . V_30 ;
int V_542 ;
for ( V_542 = 0 ; V_542 < V_24 -> V_535 ; V_542 ++ ) {
V_319 = F_16 ( V_541 ) ;
V_56 = F_283 ( V_512 , V_100 , V_319 ) ;
if ( F_35 ( V_56 ) )
goto V_93;
V_100 += V_102 ;
V_541 += V_102 ;
...
static void * F_284 ( struct V_545 * V_546 , T_10 * V_547 )
__acquires( T_11 )
{
struct V_166 * V_166 = F_285 ( V_546 ) ;
F_137 () ;
return F_286 ( & V_166 -> V_367 . V_391 , * V_547 ) ;
}
static void * F_287 ( struct V_545 * V_546 , void * V_548 , T_10 * V_547 )
{
struct V_166 * V_166 = F_285 ( V_546 ) ;
return F_288 ( V_548 , & V_166 -> V_367 . V_391 , V_547 ) ;
}
static void F_289 ( struct V_545 * V_546 , void * V_548 )
__releases( T_11 )
{
F_141 () ;
}
static int F_290 ( struct V_545 * V_546 , void * V_548 )
{
if ( V_548 == V_549 )
F_291 ( V_546 , L_11 ) ;
else {
struct V_1 * V_550 = F_292 ( V_548 ) ;
const struct V_3 * V_4 = F_2 ( V_550 ) ;
F_293 ( V_546 ,
L_12 ,
V_550 ,
F_48 ( & V_550 -> V_551 ) ,
...
V_4 -> V_5 ,
F_48 ( & V_550 -> V_145 ) ,
F_294 ( F_295 ( V_546 ) , F_296 ( V_550 ) ) ,
F_297 ( V_550 ) ) ;
}
return 0 ;
}
static int F_298 ( struct V_552 * V_552 , struct V_503 * V_503 )
{
return F_299 ( V_552 , V_503 , & V_553 ,
sizeof( struct V_554 ) ) ;
}
