...
void F_208 ( int V_234 , struct V_89 * V_90 )
{
...
T_8 int F_211 ( int V_234 , struct V_89 * V_96 )
{
struct V_254 * V_255 = F_212 () ;
...
F_213 ( 1 ) ;
#endif
F_214 ( V_262 ) . V_263 = V_96 -> V_263 ;
F_214 ( V_262 ) . V_264 = V_96 -> V_264 ;
if ( V_257 != V_265 )
F_214 ( V_262 ) . V_263 &= ~ 0x10 ;
else
F_214 ( V_262 ) . V_263 |= 0x10 ;
}
if ( V_257 == V_265 ) {
