...
V_110 = V_80 -> V_126 . V_118 [ 0 ] . V_119
+ V_80 -> V_126 . V_118 [ 0 ] . V_127 ;
V_80 -> V_126 . V_118 [ 0 ] . V_127 += sizeof( T_2 ) ;
V_101 = V_108 -> V_128 ( V_80 , V_80 -> V_120 , V_80 -> V_129 ) ;
V_101 = F_61 ( V_80 -> V_111 , V_101 ) ;
if ( V_101 == V_103 || V_80 -> V_130 ) {
F_32 ( L_10 ) ;
F_64 ( V_80 , V_131 , NULL ) ;
return 0 ;
}
if ( V_80 -> V_112 != 0 )
* V_110 ++ = V_101 ;
...
int F_65 ( struct V_134 * V_134 , struct V_135 * V_135 )
{
int V_33 ;
struct V_20 * V_20 = & V_136 ;
struct V_22 * V_23 = F_5 ( V_20 , V_24 ) ;
F_6 ( & V_25 ) ;
if ( V_23 -> V_26 == NULL ) {
F_7 ( & V_25 ) ;
...
F_38 ( V_23 -> V_26 ) ;
V_33 = F_66 ( V_23 -> V_26 , V_135 ) ;
F_7 ( & V_25 ) ;
return V_33 ;
}
int F_67 ( struct V_134 * V_134 , struct V_135 * V_135 )
{
int V_33 = F_68 ( V_134 , V_135 ) ;
struct V_20 * V_20 = & V_136 ;
F_6 ( & V_25 ) ;
F_45 ( V_20 ) ;
F_7 ( & V_25 ) ;
