...
{
V_6 -> V_73 . V_87 = F_49 ( V_6 -> V_73 . V_88 , V_6 -> V_73 . V_89 ,
V_90 , 1 ) ;
F_50 ( L_6 ,
V_6 -> V_73 . V_91 >> 20 ,
( unsigned long long ) V_6 -> V_73 . V_89 >> 20 ) ;
F_50 ( L_7 ,
...
V_2 = V_95 -> V_2 ;
if ( ! V_2 -> V_71 ) {
V_15 = V_95 -> V_98 ? V_95 -> V_98 : V_95 -> V_100 ;
V_101:
F_13 ( V_2 , V_15 ) ;
V_48 = F_37 ( & V_2 -> V_8 , & V_2 -> V_17 ,
true , false ) ;
if ( F_20 ( V_48 ) ) {
if ( V_48 != - V_102 && V_15 == V_22 ) {
V_15 |= V_26 ;
goto V_101;
}
return V_48 ;
...
return 0 ;
if ( V_2 -> V_59 >= 0 ) {
V_108 = & V_6 -> V_111 [ V_2 -> V_59 ] ;
V_70 = V_2 -> V_59 ;
goto V_112;
}
V_110 = - 1 ;
for ( V_70 = 0 ; V_70 < V_113 ; V_70 ++ ) {
V_108 = & V_6 -> V_111 [ V_70 ] ;
if ( ! V_108 -> V_2 )
break;
V_109 = V_108 -> V_2 ;
if ( V_109 -> V_71 == 0 )
...
if ( V_110 == - 1 )
return - V_57 ;
V_108 = & V_6 -> V_111 [ V_110 ] ;
V_109 = V_108 -> V_2 ;
F_65 ( L_8 , V_110 , V_109 ) ;
F_66 ( & V_109 -> V_8 ) ;
V_109 -> V_59 = - 1 ;
V_70 = V_110 ;
}
...
V_108 -> V_2 = V_2 ;
V_112:
F_67 ( V_6 , V_70 , V_2 -> V_104 , V_2 -> V_114 ,
V_2 -> V_8 . V_115 . V_116 << V_46 ,
V_2 -> V_8 . V_66 << V_46 ) ;
return 0 ;
}
...
int V_48 ;
if ( V_6 -> V_117 >= V_118 ) {
unsigned V_119 , V_120 , V_121 , V_122 , V_123 ;
V_119 = ( V_104 >> V_124 ) & V_125 ;
V_120 = ( V_104 >> V_126 ) & V_127 ;
V_121 = ( V_104 >> V_128 ) & V_129 ;
V_122 = ( V_104 >> V_130 ) & V_131 ;
V_123 = ( V_104 >> V_132 ) & V_133 ;
switch ( V_119 ) {
case 0 :
case 1 :
case 2 :
...
int F_29 ( struct V_1 * V_2 , bool V_135 ,
bool V_136 )
{
F_63 ( ! F_64 ( V_2 ) && ! V_136 ) ;
if ( ! ( V_2 -> V_104 & V_137 ) )
...
F_29 ( V_14 , 0 , 0 ) ;
V_6 = V_14 -> V_6 ;
if ( V_2 -> V_115 . V_138 == V_82 ) {
V_37 = V_2 -> V_115 . V_66 << V_46 ;
V_140 = V_2 -> V_115 . V_116 << V_46 ;
if ( ( V_140 + V_37 ) > V_6 -> V_73 . V_76 ) {
F_13 ( V_14 , V_22 ) ;
...
int F_76 ( struct V_1 * V_2 , T_1 * V_138 , bool V_141 )
{
int V_48 ;
V_48 = F_77 ( & V_2 -> V_8 , true , V_141 , false , 0 ) ;
if ( F_20 ( V_48 != 0 ) )
return V_48 ;
F_78 ( & V_2 -> V_8 . V_50 -> V_142 ) ;
if ( V_138 )
* V_138 = V_2 -> V_8 . V_115 . V_138 ;
if ( V_2 -> V_8 . V_143 )
V_48 = F_79 ( & V_2 -> V_8 , true , true , V_141 ) ;
F_80 ( & V_2 -> V_8 . V_50 -> V_142 ) ;
F_81 ( & V_2 -> V_8 ) ;
return V_48 ;
}
int F_70 ( struct V_1 * V_2 , bool V_144 )
{
int V_48 ;
V_48 = F_77 ( & V_2 -> V_8 , ! V_144 , false , false , 0 ) ;
if ( F_20 ( V_48 != 0 ) ) {
if ( V_48 != - V_102 )
