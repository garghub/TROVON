...
V_176 -> V_48 = V_46 -> V_48 ;
V_176 -> V_191 = V_8 -> V_192 ;
V_176 -> V_193 = V_194 |
V_195 |
V_196 |
V_197 |
...
static int
F_72 ( struct V_1 * V_2 , T_2 V_200 , T_2 V_201 )
{
struct V_7 * V_8 = V_2 -> V_9 ;
if ( V_200 == 1 && V_201 == 1 )
F_24 ( V_8 , V_202 ) ;
...
static int
F_73 ( struct V_1 * V_2 , T_2 * V_200 , T_2 * V_201 )
{
struct V_7 * V_8 = V_2 -> V_9 ;
switch ( V_8 -> V_59 ) {
case V_202 :
...
static int F_75 ( struct V_1 * V_2 , T_2 V_205 , T_2 V_207 )
{
struct V_7 * V_8 = V_2 -> V_9 ;
T_1 V_10 ;
if ( V_207 != V_212 )
