...
static int T_2 F_47 ( struct V_31 * V_31 )
{
...
return - V_48 ;
if ( V_31 -> V_69 != & V_70 )
V_30 -> V_67 [ 0 ] . V_71 = NULL ;
} else
V_30 -> V_67 = V_68 ;
V_30 -> F_19 = V_32 ;
V_30 -> V_67 [ 0 ] . V_38 = & V_30 -> F_19 ;
V_30 -> V_72 =
F_50 ( V_31 , L_9 , V_30 -> V_67 ) ;
if ( ! V_30 -> V_72 ) {
if ( ! F_48 ( V_31 , & V_66 ) )
F_4 ( V_30 -> V_67 ) ;
return - V_48 ;
...
static void T_3 F_51 ( struct V_31 * V_31 )
{
struct V_29 * V_30 = F_21 ( V_31 ) ;
F_52 ( V_30 -> V_72 ) ;
if ( ! F_48 ( V_31 , & V_66 ) )
...
static int T_2 F_47 ( struct V_31 * V_31 ) { return 0 ; }
static void T_3 F_51 ( struct V_31 * V_31 ) { }
