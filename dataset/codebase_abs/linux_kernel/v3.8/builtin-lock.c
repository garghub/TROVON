...
struct V_97 * V_97 )
{
struct V_85 * V_85 = F_45 ( V_97 , V_44 -> V_2 ) ;
if ( V_85 == NULL ) {
F_46 ( L_35 ,
V_96 -> V_98 . type ) ;
return - 1 ;
}
if ( V_42 -> V_99 . V_100 != NULL ) {
T_4 V_101 = V_42 -> V_99 . V_100 ;
return V_101 ( V_42 , V_44 ) ;
}
return 0 ;
}
...
V_87 = F_48 ( V_105 , V_106 , 0 , false , & V_102 ) ;
if ( ! V_87 ) {
F_9 ( L_36 ) ;
return - 1 ;
}
...
static int F_54 ( int V_108 , const char * * V_109 )
{
const char * V_110 [] = {
L_38 , L_39 , L_40 , L_41 , L_42 , L_43 , L_44 ,
} ;
unsigned int V_111 , V_22 , V_112 ;
const char * * V_113 ;
for ( V_22 = 0 ; V_22 < F_55 ( V_107 ) ; V_22 ++ ) {
if ( ! F_56 ( V_107 [ V_22 ] . V_24 ) ) {
F_9 ( L_45
L_46 ,
V_107 [ V_22 ] . V_24 ) ;
return 1 ;
...
V_111 = F_55 ( V_110 ) + V_108 - 1 ;
V_111 += 2 * F_55 ( V_107 ) ;
V_113 = calloc ( V_111 + 1 , sizeof( char * ) ) ;
if ( V_113 == NULL )
return - V_114 ;
for ( V_22 = 0 ; V_22 < F_55 ( V_110 ) ; V_22 ++ )
V_113 [ V_22 ] = F_57 ( V_110 [ V_22 ] ) ;
for ( V_112 = 0 ; V_112 < F_55 ( V_107 ) ; V_112 ++ ) {
V_113 [ V_22 ++ ] = L_47 ;
V_113 [ V_22 ++ ] = F_57 ( V_107 [ V_112 ] . V_24 ) ;
}
for ( V_112 = 1 ; V_112 < ( unsigned int ) V_108 ; V_112 ++ , V_22 ++ )
V_113 [ V_22 ] = V_109 [ V_112 ] ;
F_4 ( V_22 != V_111 ) ;
return F_58 ( V_22 , V_113 , NULL ) ;
}
int F_59 ( int V_108 , const char * * V_109 , const char * T_5 V_94 )
{
...
const struct V_115 V_117 [] = {
F_62 ( 'i' , L_52 , & V_105 , L_53 , L_54 ) ,
F_63 ( 'v' , L_55 , & V_118 , L_56 ) ,
F_60 ( 'D' , L_57 , & V_119 , L_58 ) ,
F_61 ()
} ;
const struct V_115 V_120 [] = {
F_62 ( 'k' , L_59 , & V_25 , L_9 ,
L_60 ) ,
F_61 ()
} ;
...
for ( V_22 = 0 ; V_22 < V_89 ; V_22 ++ )
F_10 ( V_124 + V_22 ) ;
V_108 = F_65 ( V_108 , V_109 , V_117 , V_122 ,
V_125 ) ;
if ( ! V_108 )
F_66 ( V_122 , V_117 ) ;
if ( ! strncmp ( V_109 [ 0 ] , L_64 , 3 ) ) {
return F_54 ( V_108 , V_109 ) ;
} else if ( ! strncmp ( V_109 [ 0 ] , L_65 , 6 ) ) {
V_75 = & V_126 ;
if ( V_108 ) {
V_108 = F_65 ( V_108 , V_109 ,
V_120 , V_123 , 0 ) ;
if ( V_108 )
F_66 ( V_123 , V_120 ) ;
}
F_52 () ;
} else if ( ! strcmp ( V_109 [ 0 ] , L_66 ) ) {
return F_67 ( V_108 , V_109 , T_5 ) ;
} else if ( ! strcmp ( V_109 [ 0 ] , L_67 ) ) {
if ( V_108 ) {
V_108 = F_65 ( V_108 , V_109 ,
V_116 , V_121 , 0 ) ;
if ( V_108 )
