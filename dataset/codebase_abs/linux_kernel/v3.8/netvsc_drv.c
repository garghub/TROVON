...
struct V_73 * V_74 )
{
strcpy ( V_74 -> V_75 , V_76 ) ;
strcpy ( V_74 -> V_77 , V_78 ) ;
strcpy ( V_74 -> V_79 , L_8 ) ;
}
...
static int F_47 ( struct V_19 * V_11 , void * V_94 )
{
struct V_3 * V_4 = F_6 ( V_11 ) ;
struct V_22 * V_81 = V_4 -> V_10 ;
...
V_99 = V_11 -> V_102 ;
V_100 = F_48 ( V_11 , V_94 ) ;
if ( V_100 != 0 )
return V_100 ;
V_100 = F_49 ( V_81 , V_96 -> V_103 ) ;
if ( V_100 != 0 ) {
...
static int F_52 ( struct V_22 * V_104 ,
...
static int F_62 ( struct V_22 * V_104 )
{
struct V_19 * V_20 ;
struct V_3 * V_64 ;
struct V_6 * V_19 ;
