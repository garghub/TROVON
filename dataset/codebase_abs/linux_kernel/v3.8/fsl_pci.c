...
int T_2 F_41 ( struct V_113 * V_2 , int V_114 )
{
int V_65 ;
struct V_10 * V_11 ;
struct V_26 V_41 ;
...
T_3 V_141 = V_18 -> V_134 << 24 | V_132 << 16 ;
int V_142 ;
...
return ( T_4 ) F_57 ( & V_160 [ V_34 ] . V_165 ) << 32 |
