...
{
int V_78 ;
V_78 = F_43 ( & V_28 -> V_28 , true , V_96 , false , 0 ) ;
if ( V_78 ) {
if ( V_78 != - V_97 )
F_9 ( L_7 , V_28 ) ;
return V_78 ;
...
int F_46 ( struct V_79 * V_65 , int V_15 , int V_98 ,
T_1 V_34 , struct V_27 * * V_99 )
{
struct V_1 * V_9 = V_65 -> V_100 ;
struct V_27 * V_49 ;
T_3 V_101 ;
int V_78 ;
...
V_49 -> V_29 . V_103 = NULL ;
V_49 -> V_28 . V_5 = & V_9 -> V_4 . V_5 ;
F_18 ( V_49 , V_93 | V_50 ) ;
V_101 = F_48 ( & V_9 -> V_4 . V_5 , V_15 ,
sizeof( struct V_27 ) ) ;
V_78 = F_49 ( & V_9 -> V_4 . V_5 , & V_49 -> V_28 , V_15 ,
V_104 , & V_49 -> V_51 ,
V_98 >> V_61 , false , NULL , V_101 ,
NULL , F_12 ) ;
if ( V_78 )
return V_78 ;
* V_99 = V_49 ;
...
int F_51 ( struct V_27 * V_28 , T_2 V_105 , T_4 * V_106 )
{
int V_107 , V_78 ;
if ( V_28 -> V_108 ) {
V_28 -> V_108 ++ ;
...
F_18 ( V_28 , V_105 ) ;
for ( V_107 = 0 ; V_107 < V_28 -> V_51 . V_94 ; V_107 ++ )
V_28 -> V_91 [ V_107 ] |= V_109 ;
...
int F_56 ( struct V_52 * V_53 , struct V_112 * V_113 )
{
struct V_114 * V_115 ;
struct V_1 * V_9 ;
if ( F_57 ( V_113 -> V_116 < V_81 ) )
return F_58 ( V_53 , V_113 ) ;
V_115 = V_53 -> V_117 ;
V_9 = V_115 -> V_118 -> V_65 -> V_100 ;
return F_59 ( V_53 , V_113 , & V_9 -> V_4 . V_5 ) ;
}
