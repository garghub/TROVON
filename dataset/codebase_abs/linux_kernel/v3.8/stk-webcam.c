...
V_2 -> V_76 = F_35 ( V_85 * sizeof( struct V_31 ) ,
V_20 ) ;
if ( V_2 -> V_76 == NULL )
return - V_60 ;
...
static int F_51 ( struct V_1 * V_2 , unsigned V_85 )
{
int V_87 ;
V_87 = F_33 ( V_2 ) ;
if ( V_87 ) {
...
static T_3 F_60 ( struct V_88 * V_89 , char T_4 * V_75 ,
T_5 V_96 , T_6 * V_97 )
{
int V_12 ;
int V_7 ;
...
F_32 ( & V_2 -> V_38 , V_28 ) ;
if ( F_64 ( V_75 , V_98 -> V_43 + * V_97 , V_96 ) )
return - V_16 ;
* V_97 += V_96 ;
if ( * V_97 >= V_2 -> V_52 ) {
* V_97 = 0 ;
...
static unsigned int F_65 ( struct V_88 * V_89 , T_7 * V_104 )
{
struct V_1 * V_2 = V_89 -> V_93 ;
F_66 ( V_89 , & V_2 -> V_55 , V_104 ) ;
if ( ! F_7 ( V_2 ) )
return V_105 ;
if ( ! F_26 ( & V_2 -> V_54 ) )
return V_106 | V_107 ;
...
static int F_69 ( struct V_88 * V_89 , struct V_108 * V_109 )
{
unsigned int V_12 ;
int V_7 ;
...
static int F_72 ( struct V_88 * V_121 ,
...
static int F_74 ( struct V_88 * V_121 , void * V_122 , unsigned int V_12 )
{
if ( V_12 != 0 )
return - V_117 ;
else
...
static int F_75 ( struct V_88 * V_121 , void * V_122 , T_8 * V_137 )
{
return 0 ;
}
static int F_76 ( struct V_88 * V_121 ,
...
static int F_79 ( struct V_88 * V_121 ,
void * V_122 , struct V_143 * V_139 )
{
struct V_1 * V_2 = V_122 ;
switch ( V_139 -> V_142 ) {
...
static int F_83 ( struct V_88 * V_121 ,
...
for ( V_12 = 1 ; V_12 < F_77 ( V_166 ) ; V_12 ++ ) {
...
F_25 ( & V_2 -> V_38 , V_28 ) ;
F_62 ( & V_98 -> V_42 , & V_2 -> V_41 ) ;
* V_75 = V_98 -> V_44 ;
F_32 ( & V_2 -> V_38 , V_28 ) ;
return 0 ;
}
static int F_90 ( struct V_88 * V_121 ,
void * V_122 , struct V_182 * V_75 )
{
struct V_1 * V_2 = V_122 ;
struct V_31 * V_98 ;
...
static int F_96 ( struct V_88 * V_121 ,
void * V_122 , struct V_195 * V_196 )
{
if ( V_196 -> V_3 >= F_77 ( V_166 ) )
return - V_117 ;
switch ( V_196 -> V_197 ) {
case V_154 :
case V_156 :
...
static void F_97 ( struct V_91 * V_200 )
{
struct V_1 * V_2 = F_55 ( V_200 ) ;
...
int V_87 ;
V_2 -> V_92 = V_201 ;
V_2 -> V_92 . V_202 = V_202 ;
V_2 -> V_92 . V_203 = & V_2 -> V_94 -> V_2 ;
V_87 = F_100 ( & V_2 -> V_92 , V_204 , - 1 ) ;
if ( V_87 )
F_10 ( L_30 ) ;
else
F_101 ( L_31 ,
...
static int F_103 ( struct V_205 * V_94 ,
const struct V_206 * V_142 )
{
int V_12 ;
int V_87 = 0 ;
struct V_1 * V_2 = NULL ;
struct V_5 * V_6 = F_104 ( V_94 ) ;
struct V_207 * V_208 ;
struct V_209 * V_210 ;
...
static void F_112 ( struct V_205 * V_94 )
{
struct V_1 * V_2 = F_113 ( V_94 ) ;
F_111 ( V_94 , NULL ) ;
F_114 ( V_2 ) ;
F_115 ( & V_2 -> V_55 ) ;
F_101 ( L_34 ,
...
static int F_117 ( struct V_205 * V_215 , T_9 V_216 )
{
struct V_1 * V_2 = F_113 ( V_215 ) ;
if ( F_61 ( V_2 ) ) {
F_16 ( V_2 ) ;
F_15 ( V_2 ) ;
}
...
static int F_118 ( struct V_205 * V_215 )
{
struct V_1 * V_2 = F_113 ( V_215 ) ;
if ( ! F_9 ( V_2 ) )
return 0 ;
