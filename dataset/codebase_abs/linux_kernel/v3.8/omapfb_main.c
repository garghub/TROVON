...
static void F_26 ( struct V_25 * V_26 , int V_50 )
{
struct V_28 * V_29 = V_26 -> V_30 ;
struct V_3 * V_4 = V_29 -> V_4 ;
F_2 ( V_4 ) ;
if ( V_50 != V_26 -> V_32 . V_50 ) {
struct V_31 * V_142 = & V_4 -> V_142 ;
memcpy ( V_142 , & V_26 -> V_32 , sizeof( * V_142 ) ) ;
V_142 -> V_50 = V_50 ;
if ( F_24 ( V_26 , V_142 ) == 0 &&
memcmp ( V_142 , & V_26 -> V_32 , sizeof( * V_142 ) ) ) {
...
static int F_28 ( struct V_25 * V_26 , int V_143 )
{
struct V_28 * V_29 = V_26 -> V_30 ;
struct V_3 * V_4 = V_29 -> V_4 ;
int V_6 = 0 ;
...
static int F_29 ( struct V_31 * V_32 , struct V_25 * V_26 )
{
struct V_28 * V_29 = V_26 -> V_30 ;
struct V_3 * V_4 = V_29 -> V_4 ;
int V_6 ;
...
return 0 ;
return V_4 -> V_20 -> V_151 ( V_26 , V_145 , F_32 , V_146 ) ;
}
...
int V_153 ;
F_2 ( V_29 -> V_4 ) ;
V_153 = F_31 ( V_26 , V_145 , NULL , NULL ) ;
F_4 ( V_29 -> V_4 ) ;
return V_153 ;
}
...
static int F_35 ( struct V_25 * V_26 , struct V_155 * V_156 )
{
struct V_28 * V_29 = V_26 -> V_30 ;
* V_156 = V_29 -> V_41 ;
return 0 ;
...
static int F_37 ( struct V_25 * V_26 , struct V_161 * V_162 )
{
struct V_28 * V_29 = V_26 -> V_30 ;
struct V_3 * V_4 = V_29 -> V_4 ;
struct V_98 * V_99 ;
...
int F_44 ( struct V_174 * V_175 )
{
return F_45 (
& V_173 [ V_175 -> V_176 ] , & V_175 -> V_178 ) ;
}
void F_46 ( struct V_3 * V_4 , unsigned long V_184 )
{
int V_7 ;
if ( ! V_177 )
return;
for ( V_7 = 0 ; V_7 < V_172 ; V_7 ++ )
F_47 ( & V_173 [ V_7 ] , V_184 ,
V_4 -> V_25 [ V_7 ] ) ;
}
...
static enum V_185 F_49 ( struct V_3 * V_4 )
{
int V_6 ;
F_2 ( V_4 ) ;
V_6 = V_4 -> V_20 -> V_91 () ;
...
static void F_50 ( struct V_3 * V_4 , int V_29 ,
struct V_188 * V_189 )
{
...
void F_51 ( struct V_3 * V_4 , T_2 V_191 )
{
F_2 ( V_4 ) ;
...
static int F_52 ( struct V_25 * V_26 , unsigned int V_192 ,
unsigned long V_193 )
{
struct V_28 * V_29 = V_26 -> V_30 ;
struct V_3 * V_4 = V_29 -> V_4 ;
...
switch ( V_192 ) {
case V_203 :
if ( F_54 ( V_202 . V_143 , ( int V_204 * ) V_193 ) )
V_6 = - V_205 ;
else
F_28 ( V_26 , V_202 . V_143 ) ;
break;
case V_206 :
F_15 ( V_26 ) ;
break;
...
break;
case V_208 :
if ( F_54 ( V_202 . V_200 , ( int V_204 * ) V_193 ) )
V_6 = - V_205 ;
else
V_6 = F_48 ( V_4 , V_202 . V_200 ) ;
break;
case V_209 :
V_202 . V_200 = F_49 ( V_4 ) ;
if ( F_55 ( V_202 . V_200 ,
(enum V_185 V_204 * ) V_193 ) )
V_6 = - V_205 ;
break;
case V_210 :
if ( F_56 ( & V_202 . V_151 , ( void V_204 * ) V_193 ,
sizeof( struct V_211 ) ) )
V_6 = - V_205 ;
else {
...
V_6 = F_33 ( V_26 , & V_202 . V_151 ) ;
break;
case V_215 :
if ( F_56 ( & V_202 . V_197 , ( void V_204 * ) V_193 ,
sizeof( V_202 . V_197 ) ) )
V_6 = - V_205 ;
else
V_6 = F_34 ( V_26 , & V_202 . V_197 ) ;
break;
case V_216 :
if ( ( V_6 = F_35 ( V_26 , & V_202 . V_197 ) ) < 0 )
break;
if ( F_57 ( ( void V_204 * ) V_193 , & V_202 . V_197 ,
sizeof( V_202 . V_197 ) ) )
V_6 = - V_205 ;
break;
case V_217 :
if ( F_56 ( & V_202 . V_198 , ( void V_204 * ) V_193 ,
sizeof( V_202 . V_198 ) ) )
V_6 = - V_205 ;
else
V_6 = F_36 ( V_26 , & V_202 . V_198 ) ;
break;
case V_218 :
if ( ( V_6 = F_37 ( V_26 , & V_202 . V_198 ) ) < 0 )
break;
if ( F_57 ( ( void V_204 * ) V_193 , & V_202 . V_198 ,
sizeof( V_202 . V_198 ) ) )
V_6 = - V_205 ;
break;
case V_219 :
if ( F_56 ( & V_202 . V_199 , ( void V_204 * ) V_193 ,
sizeof( V_202 . V_199 ) ) )
V_6 = - V_205 ;
else
V_6 = F_38 ( V_4 , & V_202 . V_199 ) ;
break;
case V_220 :
if ( ( V_6 = F_39 ( V_4 , & V_202 . V_199 ) ) < 0 )
break;
if ( F_57 ( ( void V_204 * ) V_193 , & V_202 . V_199 ,
sizeof( V_202 . V_199 ) ) )
V_6 = - V_205 ;
break;
case V_221 :
F_50 ( V_4 , V_29 -> V_40 , & V_202 . V_189 ) ;
if ( F_57 ( ( void V_204 * ) V_193 , & V_202 . V_189 , sizeof( V_202 . V_189 ) ) )
V_6 = - V_205 ;
break;
case V_222 :
{
int V_223 ;
if ( F_54 ( V_223 , ( int V_204 * ) V_193 ) ) {
V_6 = - V_205 ;
break;
}
if ( ! V_4 -> V_15 -> V_224 ) {
...
static int F_58 ( struct V_25 * V_41 , struct V_226 * V_227 )
{
struct V_28 * V_29 = V_41 -> V_30 ;
struct V_3 * V_4 = V_29 -> V_4 ;
int V_6 ;
...
{
int V_6 ;
if ( ( V_6 = F_69 ( V_4 -> V_2 , & V_243 ) ) )
goto V_244;
if ( ( V_6 = F_69 ( V_4 -> V_2 , & V_245 ) ) )
goto V_246;
if ( ( V_6 = F_70 ( & V_4 -> V_2 -> V_247 , & V_248 ) ) )
goto V_249;
if ( ( V_6 = F_70 ( & V_4 -> V_2 -> V_247 , & V_250 ) ) )
goto V_251;
return 0 ;
V_251:
F_71 ( & V_4 -> V_2 -> V_247 , & V_248 ) ;
V_249:
F_72 ( V_4 -> V_2 , & V_245 ) ;
V_246:
F_72 ( V_4 -> V_2 , & V_243 ) ;
...
{
F_71 ( & V_4 -> V_2 -> V_247 , & V_250 ) ;
F_71 ( & V_4 -> V_2 -> V_247 , & V_248 ) ;
F_72 ( V_4 -> V_2 , & V_243 ) ;
F_72 ( V_4 -> V_2 , & V_245 ) ;
}
static int F_74 ( struct V_3 * V_4 , struct V_25 * V_41 )
{
struct V_31 * V_32 = & V_41 -> V_32 ;
...
F_24 ( V_41 , V_32 ) ;
F_22 ( V_41 , 1 ) ;
V_6 = F_75 ( & V_41 -> V_77 , 16 , 0 ) ;
if ( V_6 != 0 )
F_8 ( V_4 -> V_2 , L_13 ) ;
return V_6 ;
}
static void F_76 ( struct V_3 * V_4 , struct V_25 * V_26 )
{
F_77 ( & V_26 -> V_77 ) ;
}
...
static void F_82 ( struct V_3 * V_4 , int V_86 )
{
int V_7 ;
switch ( V_86 ) {
case V_90 :
...
V_265 = V_4 -> V_2 -> V_266 ;
V_4 -> V_20 = NULL ;
strncpy ( V_237 , V_265 -> V_267 . V_268 , sizeof( V_237 ) - 1 ) ;
...
F_10 ( V_4 -> V_2 , L_16 , V_270 [ V_7 ] -> V_237 ) ;
if ( strcmp ( V_270 [ V_7 ] -> V_237 , V_237 ) == 0 ) {
V_4 -> V_20 = V_270 [ V_7 ] ;
break;
}
}
...
F_53 ( V_4 -> V_20 == NULL || V_4 -> V_15 == NULL ) ;
F_53 ( ! ( F_88 ( V_21 ) && F_88 ( V_24 ) && F_88 ( V_190 ) &&
...
V_4 -> V_86 = V_90 ;
V_15 = V_4 -> V_15 ;
V_274 = V_15 -> V_127 * 1000 ;
V_275 = V_274 * 10 / ( V_15 -> V_129 + V_15 -> V_118 + V_15 -> V_131 + V_15 -> V_137 ) ;
V_276 = V_275 / ( V_15 -> V_133 + V_15 -> V_120 + V_15 -> V_135 + V_15 -> V_139 ) ;
V_182 = V_4 ;
F_95 ( L_25 ,
V_277 , V_4 -> V_9 . V_13 ) ;
F_95 ( L_26
...
static int F_99 ( struct V_271 * V_272 )
{
int V_6 ;
F_53 ( V_291 != NULL ) ;
V_6 = F_100 ( & V_282 ) ;
...
static int F_102 ( struct V_271 * V_272 )
{
struct V_3 * V_4 = F_103 ( V_272 ) ;
enum V_293 V_294 = V_4 -> V_86 ;
V_4 -> V_86 = V_295 ;
F_82 ( V_4 , V_294 ) ;
F_104 ( & V_282 ) ;
V_4 -> V_281 = NULL ;
...
static int F_105 ( struct V_271 * V_272 , T_7 V_296 )
{
struct V_3 * V_4 = F_103 ( V_272 ) ;
if ( V_4 != NULL )
...
static int F_106 ( struct V_271 * V_272 )
{
struct V_3 * V_4 = F_103 ( V_272 ) ;
if ( V_4 != NULL )
...
static int T_8 F_107 ( char * V_297 )
{
char * V_298 = NULL ;
int V_6 = 0 ;
F_108 ( L_29 , V_297 ) ;
if ( ! V_297 || ! * V_297 )
return 0 ;
while ( ! V_6 && ( V_298 = F_109 ( & V_297 , L_30 ) ) != NULL ) {
if ( ! strncmp ( V_298 , L_31 , 5 ) )
V_258 = 1 ;
else if ( ! strncmp ( V_298 , L_32 , 5 ) ) {
char * V_299 ;
unsigned long V_277 ;
V_277 = ( F_110 ( V_298 + 5 , & V_299 , 0 ) ) ;
switch ( V_299 [ 0 ] ) {
case '\0' :
break;
case 'm' :
...
else if ( ! strncmp ( V_298 , L_34 , 6 ) )
V_18 = F_110 ( V_298 + 6 , NULL , 0 ) ;
else if ( ! strncmp ( V_298 , L_35 , 6 ) )
V_19 = F_110 ( V_298 + 6 , NULL , 0 ) ;
else if ( ! strncmp ( V_298 , L_36 , 7 ) )
V_260 = ( F_110 ( V_298 + 7 , NULL , 0 ) ) ;
else if ( ! strncmp ( V_298 , L_37 , 7 ) )
V_262 = ( F_110 ( V_298 + 7 , NULL , 0 ) ) ;
else if ( ! strncmp ( V_298 , L_38 , 13 ) )
V_289 = 1 ;
else {
F_108 ( L_39 ) ;
V_6 = - 1 ;
