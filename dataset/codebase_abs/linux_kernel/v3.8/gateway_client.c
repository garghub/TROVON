...
static bool F_47 ( struct V_76 * V_77 , int V_78 )
{
int V_62 = false ;
unsigned char * V_79 ;
int V_80 ;
...
bool F_50 ( struct V_76 * V_77 , unsigned int * V_78 )
{
struct V_84 * V_84 ;
struct V_85 * V_85 ;
struct V_86 * V_86 ;
struct V_87 * V_87 ;
if ( ! F_51 ( V_77 , * V_78 + V_88 ) )
return false ;
V_84 = (struct V_84 * ) V_77 -> V_82 ;
* V_78 += V_88 ;
if ( F_52 ( V_84 -> V_89 ) == V_90 ) {
if ( ! F_51 ( V_77 , * V_78 + V_91 ) )
return false ;
V_84 = (struct V_84 * ) ( V_77 -> V_82 + V_91 ) ;
* V_78 += V_91 ;
}
switch ( F_52 ( V_84 -> V_89 ) ) {
case V_92 :
if ( ! F_51 ( V_77 , * V_78 + sizeof( * V_85 ) ) )
return false ;
...
if ( ! F_51 ( V_77 , * V_78 + sizeof( * V_87 ) ) )
return false ;
V_87 = (struct V_87 * ) ( V_77 -> V_82 + * V_78 ) ;
* V_78 += sizeof( * V_87 ) ;
if ( ( F_52 ( V_84 -> V_89 ) == V_92 ) &&
( F_52 ( V_87 -> V_98 ) != 67 ) )
return false ;
if ( ( F_52 ( V_84 -> V_89 ) == V_96 ) &&
( F_52 ( V_87 -> V_98 ) != 547 ) )
return false ;
return true ;
}
bool F_53 ( struct V_5 * V_6 ,
struct V_76 * V_77 , struct V_84 * V_84 )
{
struct V_17 * V_99 = NULL , * V_100 = NULL ;
struct V_10 * V_101 = NULL ;
struct V_1 * V_8 = NULL ;
bool V_62 , V_102 = false ;
unsigned int V_78 = 0 ;
T_2 V_103 ;
V_62 = F_50 ( V_77 , & V_78 ) ;
if ( ! V_62 )
goto V_9;
V_101 = F_54 ( V_6 , V_84 -> V_104 ,
V_84 -> V_105 ) ;
if ( ! V_101 )
goto V_9;
if ( ! V_101 -> V_32 )
...
V_100 = F_55 ( V_6 , V_101 , NULL ) ;
if ( ! V_100 )
goto V_9;
if ( V_103 - V_100 -> V_27 > V_108 )
V_102 = true ;
V_9:
if ( V_101 )
F_29 ( V_101 ) ;
