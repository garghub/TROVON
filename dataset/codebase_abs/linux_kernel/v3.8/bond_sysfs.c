...
struct V_10 * V_11 = F_19 ( V_34 ) ;
if ( V_11 -> V_81 )
V_19 = sprintf ( V_5 , L_72 , V_11 -> V_81 -> V_14 -> V_15 ) ;
return V_19 ;
}
...
V_19 = sprintf ( V_5 , L_72 , V_87 -> V_14 -> V_15 ) ;
return V_19 ;
}
...
V_87 = V_11 -> V_88 ;
F_22 ( & V_11 -> V_82 ) ;
return sprintf ( V_5 , L_72 , V_87 ? L_94 : L_95 ) ;
}
...
struct V_93 V_93 ;
if ( ! F_84 ( V_11 , & V_93 ) )
V_19 = sprintf ( V_5 , L_96 , V_93 . V_98 ) ;
}
return V_19 ;
}
