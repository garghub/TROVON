...
int V_20 ;
do {
V_61 = F_39 ( & V_6 -> V_46 . V_63 ) ;
V_20 = F_40 ( V_6 -> V_46 . V_15 , & V_62 ) ;
if ( V_20 ) {
if ( V_20 != 3 )
break;
V_62 = 0 ;
}
} while ( F_41 ( & V_6 -> V_46 . V_63 , V_61 , V_62 ) != V_61 );
return V_20 ;
}
static int F_42 ( struct V_41 * V_6 )
{
T_1 V_61 , V_62 , V_64 ;
int V_20 ;
do {
...
static void F_44 ( struct V_41 * V_6 )
{
if ( V_6 -> V_46 . V_1 & V_67 )
return;
F_42 ( V_6 ) ;
}
static void F_45 ( struct V_41 * V_6 , int V_28 )
{
struct V_18 * V_19 = & F_12 ( V_18 ) ;
struct V_12 * V_13 = & V_6 -> V_46 ;
...
static void F_47 ( struct V_41 * V_6 , int V_28 )
{
struct V_18 * V_19 = & F_12 ( V_18 ) ;
struct V_12 * V_13 = & V_6 -> V_46 ;
if ( ! ( V_13 -> V_1 & V_67 ) ) {
...
static int F_48 ( struct V_41 * V_6 , int V_28 )
{
struct V_18 * V_19 = & F_12 ( V_18 ) ;
if ( ! ( V_19 -> V_28 & V_71 ) )
if ( F_10 ( & V_6 -> V_46 ) )
...
V_6 -> V_46 . V_1 = V_69 | V_67 ;
if ( V_28 & V_72 )
F_45 ( V_6 , V_68 ) ;
F_49 ( V_6 ) ;
return 0 ;
}
static void F_50 ( struct V_41 * V_6 , int V_28 )
{
struct V_18 * V_19 = & F_12 ( V_18 ) ;
F_47 ( V_6 , V_70 ) ;
...
static int T_2 F_57 ( struct V_74 * V_75 ,
...
return - V_84 ;
F_61 ( 0 , 48 ) ;
V_83 = F_62 ( 0x1407 , F_16 ) ;
if ( V_83 ) {
F_14 ( L_5
L_6 , V_83 ) ;
goto V_65;
}
V_83 = F_63 ( & V_85 , L_7 , V_48 ) ;
if ( V_83 ) {
F_14 ( L_8 , V_83 ) ;
F_64 ( 0x1407 , F_16 ) ;
goto V_65;
