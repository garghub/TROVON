...
static int F_506 ( struct V_3 * V_4 , T_3 V_335 , char * V_1401 ,
int V_1402 )
{
int V_26 ;
...
static int F_508 ( struct V_3 * V_4 , T_3 V_1182 , T_3 V_1407 )
{
...
static void F_516 ( struct V_3 * V_4 , T_3 V_1182 )
{
T_3 V_486 ;
int V_10 ;
...
static int F_518 ( struct V_3 * V_4 , const char * V_1423 )
{
...
static int F_599 ( struct V_1516 * V_1233 ,
...
if ( ! ( F_601 ( V_1233 , 0 ) & V_1587 ) ||
! ( F_601 ( V_1233 , 2 ) & V_1587 ) ) {
...
V_1585 . V_1592 . V_1593 = F_605 ( V_1233 -> V_1594 ) ;
V_1585 . V_1592 . V_1594 = V_1233 -> V_1594 -> V_1595 ;
V_1585 . V_1592 . V_508 = F_606 ( V_1233 -> V_1591 ) ;
...
V_1603 ) ;
V_1586 = F_608 ( 44 ) ;
V_10 = F_609 ( V_1233 , V_1586 ) ;
if ( ! V_10 ) {
V_11 -> V_552 |= V_1604 ;
V_10 = F_610 ( V_1233 , V_1586 ) ;
if ( V_10 ) {
...
static void F_620 ( struct V_1516 * V_1233 )
{
struct V_308 * V_11 = F_621 ( V_1233 ) ;
if ( V_11 ) {
struct V_3 * V_4 = F_400 ( V_11 ) ;
F_622 ( V_11 ) ;
if ( V_4 -> V_1504 ) {
...
static int F_623 ( struct V_1516 * V_1233 , T_15 V_1377 )
{
struct V_308 * V_11 = F_621 ( V_1233 ) ;
struct V_3 * V_4 = F_400 ( V_11 ) ;
unsigned long V_87 ;
...
static int F_626 ( struct V_1516 * V_1233 )
{
struct V_308 * V_11 = F_621 ( V_1233 ) ;
struct V_3 * V_4 = F_400 ( V_11 ) ;
unsigned long V_87 ;
...
static int F_640 ( struct V_1522 * V_1523 )
{
union V_1549 V_1585 ;
struct V_308 * V_11 ;
struct V_3 * V_4 ;
...
V_4 = F_400 ( V_11 ) ;
memset ( & V_1585 , 0 , sizeof( V_1585 ) ) ;
V_1585 . V_1613 = F_641 ( V_1523 -> V_11 . V_1525 ) ;
V_4 -> V_25 = F_569 ( V_4 , & V_1585 ,
V_343 ) ;
if ( ! V_4 -> V_25 ) {
V_10 = - V_506 ;
...
F_598 ( V_11 ) ;
V_4 -> V_1504 = F_642 ( & V_1523 -> V_1614 [ 1 ] , 0 ,
F_643 ( & V_1523 -> V_1614 [ 1 ] ) ,
L_228 ) ;
if ( ! V_4 -> V_1504 ) {
...
V_4 -> V_1615 = F_642 ( & V_1523 -> V_1614 [ 2 ] , 0 ,
F_643 ( & V_1523 -> V_1614 [ 2 ] ) ,
L_229 ) ;
if ( ! V_4 -> V_1615 ) {
...
V_4 -> V_1616 = F_642 ( & V_1523 -> V_1614 [ 3 ] , 0 ,
F_643 ( & V_1523 -> V_1614 [ 3 ] ) ,
L_231 ) ;
if ( ! V_4 -> V_1616 ) {
...
F_644 ( & V_1523 -> V_11 , V_11 ) ;
F_597 ( V_4 ) ;
return 0 ;
V_1608:
if ( V_4 -> V_1615 ) {
F_645 ( & V_1523 -> V_1614 [ 2 ] , V_4 -> V_1615 ,
F_643 ( & V_1523 -> V_1614 [ 2 ] ) ) ;
V_4 -> V_1615 = NULL ;
}
if ( V_4 -> V_1616 ) {
F_645 ( & V_1523 -> V_1614 [ 3 ] , V_4 -> V_1616 ,
F_643 ( & V_1523 -> V_1614 [ 3 ] ) ) ;
V_4 -> V_1616 = NULL ;
}
if ( V_4 -> V_1504 ) {
F_645 ( & V_1523 -> V_1614 [ 1 ] , V_4 -> V_1504 ,
F_643 ( & V_1523 -> V_1614 [ 1 ] ) ) ;
V_4 -> V_1504 = NULL ;
}
V_1605:
...
static int F_646 ( struct V_1522 * V_1523 )
{
struct V_308 * V_11 = F_647 ( & V_1523 -> V_11 ) ;
if ( V_11 ) {
struct V_3 * V_4 = F_400 ( V_11 ) ;
F_622 ( V_11 ) ;
if ( V_4 -> V_1615 ) {
