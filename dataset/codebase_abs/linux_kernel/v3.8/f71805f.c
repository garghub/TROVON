...
V_9 = F_89 ( & V_66 -> V_14 , sizeof( struct V_8 ) ,
V_73 ) ;
if ( ! V_9 ) {
F_90 ( L_12 ) ;
return - V_74 ;
...
if ( ! F_92 ( & V_66 -> V_14 , V_71 -> V_76 + V_11 , 2 ,
V_77 ) ) {
F_93 ( & V_66 -> V_14 , L_13 ,
...
return 0 ;
V_85:
F_101 ( & V_66 -> V_14 . V_53 , & V_83 ) ;
for ( V_62 = 0 ; V_62 < 4 ; V_62 ++ )
F_101 ( & V_66 -> V_14 . V_53 , & V_84 [ V_62 ] ) ;
F_101 ( & V_66 -> V_14 . V_53 , & V_88 ) ;
return V_47 ;
}
static int F_102 ( struct V_65 * V_66 )
{
struct V_8 * V_9 = F_103 ( V_66 ) ;
int V_62 ;
F_104 ( V_9 -> V_87 ) ;
F_101 ( & V_66 -> V_14 . V_53 , & V_83 ) ;
for ( V_62 = 0 ; V_62 < 4 ; V_62 ++ )
...
static int T_5 F_105 ( unsigned short V_89 ,
...
if ( V_47 )
goto V_93;
V_47 = F_108 ( V_66 , & V_71 , 1 ) ;
if ( V_47 ) {
F_90 ( L_16 , V_47 ) ;
goto V_93;
}
V_47 = F_109 ( V_66 , V_68 ,
sizeof( struct V_67 ) ) ;
if ( V_47 ) {
F_90 ( L_17 ) ;
goto V_93;
...
static int T_5 F_112 ( int V_94 , unsigned short * V_89 ,
struct V_67 * V_68 )
{
int V_47 = - V_95 ;
T_2 V_96 ;
...
unsigned short V_89 ;
struct V_67 V_68 ;
if ( F_112 ( 0x2e , & V_89 , & V_68 )
&& F_112 ( 0x4e , & V_89 , & V_68 ) )
return - V_95 ;
V_47 = F_116 ( & V_108 ) ;
if ( V_47 )
goto exit;
V_47 = F_105 ( V_89 , & V_68 ) ;
if ( V_47 )
goto V_109;
return 0 ;
V_109:
