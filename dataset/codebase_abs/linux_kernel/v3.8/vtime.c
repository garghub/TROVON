...
T_3 F_27 ( int V_40 )
{
struct V_24 * V_25 = & F_28 ( V_26 , V_40 ) ;
...
static void F_31 ( struct V_44 * V_1 , struct V_45 * V_46 )
{
struct V_44 * V_47 ;
F_32 (tmp, head, entry) {
if ( V_47 -> V_2 > V_1 -> V_2 ) {
F_33 ( & V_1 -> V_48 , & V_47 -> V_48 ) ;
return;
}
}
F_33 ( & V_1 -> V_48 , V_46 ) ;
...
F_35 ( & V_50 ) ;
V_6 = F_8 ( & V_8 ) ;
F_36 (timer, tmp, &virt_timer_list, entry) {
if ( V_1 -> V_2 < V_6 )
F_37 ( & V_1 -> V_48 , & V_49 ) ;
else
V_1 -> V_2 -= V_6 ;
...
void F_43 ( struct V_44 * V_1 )
{
V_1 -> V_51 = NULL ;
F_44 ( & V_1 -> V_48 ) ;
}
static inline int F_45 ( struct V_44 * V_1 )
{
return ! F_6 ( & V_1 -> V_48 ) ;
}
static void F_46 ( struct V_44 * V_1 )
{
if ( F_6 ( & V_7 ) ) {
F_39 ( & V_9 , V_1 -> V_2 ) ;
F_39 ( & V_8 , 0 ) ;
...
V_1 -> V_2 += F_8 ( & V_8 ) ;
if ( F_48 ( ( V_20 ) V_1 -> V_2 <
( V_20 ) F_8 ( & V_9 ) ) )
F_39 ( & V_9 , V_1 -> V_2 ) ;
F_31 ( V_1 , & V_7 ) ;
}
}
static void F_49 ( struct V_44 * V_1 , int V_54 )
{
unsigned long V_55 ;
...
void F_52 ( struct V_44 * V_1 )
{
F_49 ( V_1 , 0 ) ;
}
void F_53 ( struct V_44 * V_1 )
{
F_49 ( V_1 , 1 ) ;
}
static int F_54 ( struct V_44 * V_1 , T_1 V_2 , int V_54 )
{
unsigned long V_55 ;
int V_56 ;
F_4 ( ! V_1 -> V_51 ) ;
if ( V_1 -> V_2 == V_2 && F_45 ( V_1 ) )
return 1 ;
F_50 ( & V_50 , V_55 ) ;
V_56 = F_45 ( V_1 ) ;
if ( V_56 )
...
int F_55 ( struct V_44 * V_1 , T_1 V_2 )
{
return F_54 ( V_1 , V_2 , 0 ) ;
}
int F_56 ( struct V_44 * V_1 , T_1 V_2 )
{
return F_54 ( V_1 , V_2 , 1 ) ;
}
int F_57 ( struct V_44 * V_1 )
{
unsigned long V_55 ;
if ( ! F_45 ( V_1 ) )
return 0 ;
...
static int T_4 F_59 ( struct V_58 * V_59 ,
