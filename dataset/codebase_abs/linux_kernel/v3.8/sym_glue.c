...
static void F_107 ( struct V_254 * V_64 )
{
if ( V_64 -> V_28 . V_255 )
...
static struct V_123 * F_113 ( struct V_258 * V_259 , int V_260 ,
struct V_254 * V_160 )
{
struct V_125 * V_125 ;
...
static void F_130 ( struct V_254 * V_302 , struct V_303 * V_304 )
{
V_302 -> V_283 = V_304 ;
V_304 -> type = 0 ;
F_131 ( V_302 , V_304 ) ;
...
static int F_132 ( struct V_254 * V_64 )
{
struct V_305 * V_263 ;
...
static int F_134 ( struct V_254 * V_64 )
{
...
static int F_136 ( struct V_254 * V_64 )
{
...
static int F_138 ( struct V_254 * V_64 )
{
struct V_126 * V_127 = V_64 -> V_127 ;
struct V_317 V_318 ;
int V_307 = 2 ;
...
static int F_153 ( struct V_126 * V_127 , const struct V_330 * V_331 )
{
struct V_254 V_322 ;
struct V_303 V_283 ;
struct V_123 * V_124 ;
...
static T_10 F_164 ( struct V_126 * V_127 ,
enum V_340 V_341 )
{
if ( V_341 == V_342 ) {
F_162 ( V_127 ) ;
...
static T_10 F_166 ( struct V_126 * V_127 )
{
struct V_123 * V_124 = F_159 ( V_127 ) ;
F_167 ( V_124 ) ;
return V_345 ;
...
static T_10 F_169 ( struct V_126 * V_127 )
{
struct V_123 * V_124 = F_159 ( V_127 ) ;
struct V_19 * V_20 = F_78 ( V_124 ) ;
F_3 ( V_109 L_73 ,
