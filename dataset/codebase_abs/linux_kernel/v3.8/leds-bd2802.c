...
{
struct V_1 * V_2 = F_34 ( V_60 , struct V_1 , V_60 ) ;
if ( V_2 -> V_61 )
F_18 ( V_2 , V_2 -> V_62 , V_2 -> V_6 , V_2 -> V_61 ) ;
else
F_19 ( V_2 , V_2 -> V_62 , V_2 -> V_6 ) ;
}
...
V_2 -> V_63 . V_66 = V_67 ;
V_2 -> V_63 . V_68 = V_69 ;
V_25 = F_37 ( & V_2 -> V_13 -> V_14 , & V_2 -> V_63 ) ;
if ( V_25 < 0 ) {
...
V_2 -> V_71 . V_66 = V_72 ;
V_2 -> V_71 . V_68 = V_73 ;
V_25 = F_37 ( & V_2 -> V_13 -> V_14 , & V_2 -> V_71 ) ;
if ( V_25 < 0 ) {
F_2 ( & V_2 -> V_13 -> V_14 , L_10 ,
V_2 -> V_71 . V_52 ) ;
goto V_74;
...
V_2 -> V_75 . V_66 = V_76 ;
V_2 -> V_75 . V_68 = V_77 ;
V_25 = F_37 ( & V_2 -> V_13 -> V_14 , & V_2 -> V_75 ) ;
if ( V_25 < 0 ) {
F_2 ( & V_2 -> V_13 -> V_14 , L_10 ,
V_2 -> V_75 . V_52 ) ;
goto V_78;
...
V_2 -> V_79 . V_66 = V_80 ;
V_2 -> V_79 . V_68 = V_81 ;
V_25 = F_37 ( & V_2 -> V_13 -> V_14 , & V_2 -> V_79 ) ;
if ( V_25 < 0 ) {
F_2 ( & V_2 -> V_13 -> V_14 , L_10 ,
V_2 -> V_79 . V_52 ) ;
goto V_82;
...
V_2 -> V_83 . V_66 = V_84 ;
V_2 -> V_83 . V_68 = V_85 ;
V_25 = F_37 ( & V_2 -> V_13 -> V_14 , & V_2 -> V_83 ) ;
if ( V_25 < 0 ) {
F_2 ( & V_2 -> V_13 -> V_14 , L_10 ,
V_2 -> V_83 . V_52 ) ;
goto V_86;
...
V_2 -> V_87 . V_68 = V_89 ;
V_2 -> V_87 . V_90 |= V_91 ;
V_25 = F_37 ( & V_2 -> V_13 -> V_14 , & V_2 -> V_87 ) ;
if ( V_25 < 0 ) {
F_2 ( & V_2 -> V_13 -> V_14 , L_10 ,
V_2 -> V_87 . V_52 ) ;
goto V_92;
...
static int F_41 ( struct V_22 * V_13 ,
const struct V_93 * V_4 )
{
struct V_1 * V_2 ;
struct V_36 * V_32 ;
int V_25 , V_17 ;
V_2 = F_42 ( & V_13 -> V_14 , sizeof( struct V_1 ) , V_94 ) ;
if ( ! V_2 ) {
F_2 ( & V_13 -> V_14 , L_16 ) ;
return - V_95 ;
}
V_2 -> V_13 = V_13 ;
V_32 = V_2 -> V_32 = V_13 -> V_14 . V_96 ;
F_43 ( V_13 , V_2 ) ;
F_44 ( V_32 -> V_33 , V_97 , L_17 ) ;
F_14 ( 100 ) ;
V_25 = F_7 ( V_13 , V_98 , 0x00 ) ;
if ( V_25 < 0 ) {
F_2 ( & V_13 -> V_14 , L_18 ) ;
return V_25 ;
} else
F_45 ( & V_13 -> V_14 , L_19 , V_25 ) ;
F_10 ( V_2 -> V_32 -> V_33 , 0 ) ;
V_2 -> V_48 = V_99 ;
V_2 -> V_43 = V_100 ;
F_46 ( & V_2 -> V_57 ) ;
for ( V_17 = 0 ; V_17 < F_21 ( V_101 ) ; V_17 ++ ) {
V_25 = F_22 ( & V_2 -> V_13 -> V_14 ,
V_101 [ V_17 ] ) ;
if ( V_25 ) {
F_2 ( & V_2 -> V_13 -> V_14 , L_4 ,
V_101 [ V_17 ] -> V_51 . V_52 ) ;
goto V_102;
}
}
V_25 = F_35 ( V_2 ) ;
...
V_102:
for ( V_17 -- ; V_17 >= 0 ; V_17 -- )
F_23 ( & V_2 -> V_13 -> V_14 , V_101 [ V_17 ] ) ;
return V_25 ;
}
static int T_4 F_47 ( struct V_22 * V_13 )
{
...
static int F_49 ( struct V_54 * V_14 )
{
...
static int F_50 ( struct V_54 * V_14 )
{
struct V_22 * V_13 = F_27 ( V_14 ) ;
struct V_1 * V_2 = F_26 ( V_13 ) ;
if ( ! F_4 ( V_2 ) || V_2 -> V_31 ) {
