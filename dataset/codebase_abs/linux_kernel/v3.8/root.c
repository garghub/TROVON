...
V_2 = F_15 ( V_24 , F_1 , F_2 , V_21 , V_7 ) ;
if ( F_16 ( V_2 ) )
return F_17 ( V_2 ) ;
if ( ! F_5 ( V_8 , V_7 ) ) {
F_18 ( V_2 ) ;
...
static int F_38 ( struct V_35 * V_36 , struct V_22 * V_22 , struct V_37 * V_38
)
{
F_39 ( V_22 -> V_39 , V_38 ) ;
V_38 -> V_40 = V_41 . V_40 + F_40 () ;
return 0 ;
}
static struct V_22 * F_41 ( struct V_42 * V_43 , struct V_22 * V_22 , unsigned int V_21 )
{
if ( ! F_42 ( V_43 , V_22 , V_21 ) )
return NULL ;
return F_43 ( V_43 , V_22 , V_21 ) ;
}
...
int V_50 ;
if ( V_48 < V_51 ) {
int error = F_45 ( V_45 , V_46 , V_47 ) ;
if ( error <= 0 )
return error ;
V_45 -> V_49 = V_51 ;
}
V_50 = F_46 ( V_45 , V_46 , V_47 ) ;
return V_50 ;
}
