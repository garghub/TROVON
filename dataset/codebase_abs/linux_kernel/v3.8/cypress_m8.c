...
V_5 -> V_62 = V_2 -> V_64 -> V_61 ;
V_5 -> V_63 = V_2 -> V_65 -> V_61 ;
F_3 ( & V_2 -> V_8 , L_14 ,
V_11 , V_5 -> V_63 ,
V_5 -> V_62 ) ;
}
...
F_32 ( V_2 ) ;
if ( V_15 )
F_33 ( V_15 , V_2 , & V_5 -> V_76 ) ;
if ( ! V_2 -> V_65 ) {
F_9 ( & V_2 -> V_8 , L_17 ,
V_11 ) ;
return - 1 ;
}
F_34 ( V_2 -> V_65 , V_7 -> V_8 ,
F_35 ( V_7 -> V_8 , V_2 -> V_77 ) ,
V_2 -> V_65 -> V_78 ,
V_2 -> V_65 -> V_79 ,
V_80 , V_2 , V_5 -> V_63 ) ;
V_72 = F_36 ( V_2 -> V_65 , V_32 ) ;
if ( V_72 ) {
F_9 ( & V_2 -> V_8 ,
L_18 ,
V_11 , V_72 ) ;
...
{
struct V_4 * V_5 = F_2 ( V_2 ) ;
F_3 ( & V_2 -> V_8 , L_21 , V_11 , V_2 -> V_48 , V_89 ) ;
if ( V_5 -> V_53 ) {
V_89 = 0 ;
goto V_90;
}
if ( ! V_89 )
return V_89 ;
V_89 = F_47 ( & V_5 -> V_50 , V_88 , V_89 , & V_5 -> V_39 ) ;
V_90:
F_32 ( V_2 ) ;
return V_89 ;
}
...
V_92 = V_89 +
( V_5 -> V_58 == V_59 ? 2 : 1 ) ;
F_49 ( V_8 , V_11 , V_2 -> V_57 ,
V_2 -> V_64 -> V_78 ) ;
F_34 ( V_2 -> V_64 , V_2 -> V_7 -> V_8 ,
F_50 ( V_2 -> V_7 -> V_8 , V_2 -> V_97 ) ,
V_2 -> V_94 , V_2 -> V_57 ,
V_98 , V_2 , V_5 -> V_62 ) ;
V_72 = F_36 ( V_2 -> V_64 , V_99 ) ;
if ( V_72 ) {
F_51 ( V_2 ,
L_26 ,
V_11 , V_72 ) ;
...
V_102 = V_5 -> V_104 ;
F_12 ( & V_5 -> V_39 , V_29 ) ;
V_72 = ( ( V_103 & V_83 ) ? V_105 : 0 )
| ( ( V_103 & V_84 ) ? V_106 : 0 )
| ( ( V_102 & V_107 ) ? V_108 : 0 )
| ( ( V_102 & V_109 ) ? V_110 : 0 )
| ( ( V_102 & V_111 ) ? V_112 : 0 )
| ( ( V_102 & V_113 ) ? V_114 : 0 ) ;
F_3 ( & V_2 -> V_8 , L_28 , V_11 , V_72 ) ;
return V_72 ;
}
...
struct V_1 * V_2 = V_15 -> V_100 ;
struct V_4 * V_5 = F_2 ( V_2 ) ;
F_3 ( & V_2 -> V_8 , L_29 , V_11 , V_2 -> V_48 , V_117 ) ;
switch ( V_117 ) {
case V_119 :
while ( V_5 != NULL ) {
F_58 ( & V_5 -> V_52 ) ;
...
return - V_73 ;
V_5 -> V_123 = 0 ;
if ( ( ( V_118 & V_124 ) && ( V_122 & V_111 ) ) ||
( ( V_118 & V_110 ) && ( V_122 & V_109 ) ) ||
( ( V_118 & V_114 ) && ( V_122 & V_113 ) ) ||
( ( V_118 & V_108 ) && ( V_122 & V_107 ) ) )
return 0 ;
}
}
return 0 ;
...
static void V_80 ( struct V_175 * V_175 )
{
struct V_1 * V_2 = V_175 -> V_176 ;
struct V_4 * V_5 = F_2 ( V_2 ) ;
struct V_26 * V_8 = & V_175 -> V_8 -> V_8 ;
struct V_14 * V_15 ;
unsigned char * V_177 = V_175 -> V_78 ;
unsigned long V_29 ;
char V_178 = V_179 ;
int V_180 = 0 ;
int V_181 = 0 ;
...
F_49 ( & V_2 -> V_8 , V_11 , V_175 -> V_187 , V_177 ) ;
F_11 ( & V_5 -> V_39 , V_29 ) ;
if ( V_5 -> V_104 != V_5 -> V_189 ) {
V_5 -> V_123 |= V_5 -> V_104 ^
V_5 -> V_189 ;
F_66 ( & V_5 -> V_52 ) ;
V_5 -> V_189 = V_5 -> V_104 ;
...
static void V_98 ( struct V_175 * V_175 )
{
struct V_1 * V_2 = V_175 -> V_176 ;
struct V_4 * V_5 = F_2 ( V_2 ) ;
struct V_26 * V_8 = & V_175 -> V_8 -> V_8 ;
