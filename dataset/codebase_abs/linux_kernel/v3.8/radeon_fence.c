...
struct V_12 * F_43 ( struct V_12 * V_13 )
{
F_44 ( & V_13 -> V_16 ) ;
return V_13 ;
}
...
bool F_48 ( struct V_12 * V_13 , int V_46 )
{
struct V_5 * V_47 ;
if ( ! V_13 ) {
return false ;
...
void F_49 ( struct V_12 * V_13 , int V_46 )
{
...
V_48 -> V_17 [ V_31 ] = F_50 ( V_48 -> V_17 [ V_31 ] , V_49 -> V_17 [ V_31 ] ) ;
}
}
...
if ( V_2 -> V_8 . V_51 || ! F_53 ( V_2 , & V_2 -> V_4 [ V_4 ] ) ) {
V_2 -> V_7 [ V_4 ] . V_10 = 0 ;
V_50 = V_52 + V_4 * 4 ;
} else {
...
if ( ! V_2 -> V_7 [ V_4 ] . V_57 )
continue;
F_1 ( V_2 , V_2 -> V_7 [ V_4 ] . V_17 [ V_4 ] , V_4 ) ;
}
}
