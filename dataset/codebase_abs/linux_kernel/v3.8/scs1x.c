...
static int F_40 ( struct V_68 * V_70 )
{
struct V_71 * V_34 = V_71 ( V_70 ) ;
struct V_24 * V_72 = F_16 ( V_34 ) ;
struct V_69 * V_14 ;
struct V_3 * V_3 ;
int V_45 ;
V_45 = F_41 ( - 16 , NULL , V_73 , sizeof( * V_3 ) , & V_14 ) ;
if ( V_45 < 0 )
return V_45 ;
F_42 ( V_14 , V_70 ) ;
V_3 = V_14 -> V_5 ;
...
goto V_78;
V_14 -> V_79 = F_37 ;
strcpy ( V_14 -> V_80 , L_1 ) ;
strcpy ( V_14 -> V_47 , L_1 ) ;
F_47 ( V_34 -> V_81 , V_82 ,
V_14 -> V_47 , sizeof( V_14 -> V_47 ) ) ;
snprintf ( V_14 -> V_83 , sizeof( V_14 -> V_83 ) ,
L_4 ,
V_14 -> V_47 , V_72 -> V_84 [ 3 ] , V_72 -> V_84 [ 4 ] ,
F_48 ( & V_34 -> V_68 ) , 100 << V_72 -> V_38 ) ;
strcpy ( V_14 -> V_85 , V_14 -> V_47 ) ;
V_45 = F_33 ( V_3 ) ;
if ( V_45 < 0 )
goto V_75;
V_45 = F_28 ( V_3 ) ;
...
static int F_52 ( struct V_68 * V_25 )
{
struct V_3 * V_3 = F_53 ( V_25 ) ;
F_54 ( V_3 -> V_14 ) ;
F_4 ( V_3 -> V_10 ) = NULL ;
F_4 ( V_3 -> V_41 ) = NULL ;
F_20 ( V_3 -> V_27 , V_3 -> V_11 ) ;
...
static void F_57 ( struct V_71 * V_34 )
{
