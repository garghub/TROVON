...
{
struct V_15 V_15 ;
struct V_16 * V_17 = V_11 -> V_18 . V_19 ;
T_1 V_20 , V_21 , V_22 ;
int V_23 ;
memset ( V_12 , 0 , sizeof *V_12 ) ;
if ( F_4 ( V_17 , L_1 , & V_20 ) ) {
V_14 -> V_20 = F_5 ( & V_11 -> V_18 , NULL ) ;
if ( F_6 ( V_14 -> V_20 ) ) {
F_7 ( & V_11 -> V_18 ,
L_2 ) ;
...
int V_47 ;
int V_23 ;
V_46 = F_17 ( V_48 , & V_11 -> V_18 ) ;
if ( ! V_46 )
return - V_34 ;
if ( F_14 ( V_11 -> V_18 . V_19 , L_10 , NULL ) )
return - V_49 ;
V_14 = F_18 ( sizeof( * V_14 ) , V_50 ) ;
if ( V_14 == NULL )
return - V_51 ;
V_47 = ( unsigned long ) V_46 -> V_52 ;
V_23 = F_3 ( V_11 , V_47 , & V_12 , V_14 ) ;
if ( V_23 )
goto V_25;
switch ( V_47 ) {
#ifdef F_19
...
{
struct V_13 * V_14 = F_28 ( & V_11 -> V_18 ) ;
switch ( V_14 -> type ) {
#ifdef F_19
case V_53 ... V_54 :
F_29 ( V_14 -> line ) ;
