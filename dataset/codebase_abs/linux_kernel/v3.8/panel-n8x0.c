...
T_2 * V_98 , T_2 * V_99 )
{
* V_98 = V_3 -> V_60 . V_61 . V_62 ;
* V_99 = V_3 -> V_60 . V_61 . V_63 ;
}
static void F_57 ( void * V_4 )
{
F_54 () ;
}
...
T_2 V_100 , V_101 ;
F_18 ( & V_3 -> V_40 , L_17 ) ;
V_100 = V_3 -> V_60 . V_61 . V_62 ;
V_101 = V_3 -> V_60 . V_61 . V_63 ;
if ( V_10 != 0 || V_11 != 0 || V_12 != V_100 || V_13 != V_101 ) {
F_35 ( & V_3 -> V_40 , L_18 ,
V_10 , V_11 , V_12 , V_13 ) ;
return - V_87 ;
}
