...
static int F_88 ( struct V_162 * V_163 , unsigned int V_164 ,
unsigned long V_33 )
{
struct V_14 * V_15 = F_89 ( V_163 ) ;
void T_2 * V_165 = ( void T_2 * ) V_33 ;
T_4 V_166 ;
int V_85 ;
switch ( V_164 ) {
case V_167 :
case V_168 :
V_85 = F_90 ( V_166 , ( T_4 T_2 * ) V_165 ) ;
if ( V_85 )
return - V_89 ;
if ( V_166 != V_169 )
return - V_170 ;
...
if ( ! F_91 ( V_171 ) )
return - V_172 ;
V_85 = F_51 ( V_15 , V_165 ) ;
return V_85 ;
#endif
}
return - V_170 ;
}
static void * F_92 ( struct V_176 * V_177 , T_5 * V_178 )
__acquires( V_37 )
{
F_43 ( & V_37 ) ;
return F_93 ( & V_12 , * V_178 ) ;
}
static void * F_94 ( struct V_176 * V_177 , void * V_179 , T_5 * V_178 )
{
return F_95 ( V_179 , & V_12 , V_178 ) ;
}
static void F_96 ( struct V_176 * V_177 , void * V_179 )
__releases( V_37 )
{
F_48 ( & V_37 ) ;
}
static int F_97 ( struct V_176 * V_177 , void * V_179 )
{
const struct V_7 * V_45 = F_9 ( V_179 , struct V_7 ,
V_12 ) ;
...
V_35 -> V_15 -> V_180 , V_35 -> V_15 -> V_181 ,
...
static int F_101 ( struct V_182 * V_182 , struct V_183 * V_183 )
{
return F_102 ( V_183 , & V_184 ) ;
}
static int T_8 F_103 ( void )
{
#ifdef F_104
struct V_185 * V_84 ;
V_84 = F_105 ( L_27 , 0 , V_186 , & V_187 ) ;
if ( V_84 == NULL )
return - V_122 ;
#endif
F_106 ( & V_188 ) ;
