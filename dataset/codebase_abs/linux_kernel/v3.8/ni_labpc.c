...
F_71 ( V_16 -> V_14 ,
F_72 ( V_16 -> V_54 ) ) ;
V_16 -> V_198 = F_73 ( V_130 ) ;
if ( V_130 -> V_157 == V_155 &&
V_16 -> V_8 * V_199 < V_16 -> V_198 ) {
V_16 -> V_198 =
V_16 -> V_8 * V_199 ;
}
F_74 ( V_16 -> V_14 , V_16 -> V_198 ) ;
F_75 ( V_16 -> V_14 ) ;
F_23 ( V_162 ) ;
V_16 -> V_40 |= V_200 | V_201 ;
} else
V_16 -> V_40 &= ~ V_200 & ~ V_201 ;
#endif
V_16 -> V_40 |= V_202 ;
...
F_21 ( V_16 -> V_14 ) ;
F_70 ( V_16 -> V_14 ) ;
V_227 = V_16 -> V_198 / V_199 ;
V_229 = F_82 ( V_16 -> V_14 ) / V_199 ;
V_228 = V_227 - V_229 ;
if ( V_16 -> V_8 < V_228 && V_164 -> V_130 . V_157 == V_155 )
V_228 = V_16 -> V_8 ;
V_230 = 0 ;
if ( V_164 -> V_130 . V_157 != V_155 ) {
V_230 = V_16 -> V_198 / V_199 ;
...
V_16 -> V_42 |= V_189 ;
V_16 -> V_35 ( V_16 -> V_42 , V_5 -> V_12 + V_43 ) ;
V_16 -> V_35 ( V_196 , V_5 -> V_12 + V_169 ) ;
F_48 ( V_5 ) ;
...
break;
case V_252 :
V_16 -> V_195 = V_247 / V_245 ;
V_16 -> V_197 = V_246 / V_245 ;
break;
}
if ( V_16 -> V_195 < V_244 )
V_16 -> V_195 = V_244 ;
...
static void F_93 ( struct V_105 * V_5 )
{
F_94 ( V_5 ) ;
}
