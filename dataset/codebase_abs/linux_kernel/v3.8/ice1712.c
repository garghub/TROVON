...
static T_3 F_45 ( int V_60 , void * V_61 )
{
struct V_1 * V_2 = V_61 ;
unsigned char V_62 ;
int V_63 = 0 ;
...
static int F_77 ( struct V_1 * V_2 , int V_144 , struct V_145 * * V_146 )
{
struct V_145 * V_147 ;
int V_46 ;
if ( V_146 )
...
static int F_83 ( struct V_1 * V_2 , int V_144 , struct V_145 * * V_146 )
{
struct V_145 * V_147 ;
int V_46 ;
if ( V_146 )
...
static int F_105 ( struct V_1 * V_2 , int V_144 , struct V_145 * * V_146 )
{
struct V_145 * V_147 ;
int V_46 ;
if ( V_146 )
...
static int F_181 ( struct V_207 * V_148 ,
struct V_350 * V_156 ,
const char * V_297 ,
int V_351 ,
int V_47 ,
...
static int F_197 ( struct V_350 * V_156 ,
...
L_73 , V_300 -> V_395 , V_148 -> V_97 ) ;
if ( V_2 -> V_226 . V_8 [ V_238 ] & V_372 ) {
V_46 = F_200 ( V_148 , 1 , V_390 ,
F_12 ( V_2 , V_396 ) ,
V_300 -> V_397 |
V_393 | V_394 ,
- 1 , & V_2 -> V_66 [ 1 ] ) ;
...
static void F_203 ( struct V_350 * V_156 )
{
struct V_207 * V_148 = F_204 ( V_156 ) ;
struct V_1 * V_2 = V_148 -> V_15 ;
