...
T_1
F_9 ( struct V_1 * V_2 , T_1 V_14 , T_2 V_25 , T_2 V_26 , T_2 V_27 ,
T_2 * V_3 , T_2 * V_4 , T_2 * V_5 , T_2 * V_6 ,
struct V_21 * V_16 )
{
T_2 V_13 = 0xff ;
T_1 V_11 ;
if ( * V_3 >= 0x30 ) {
const T_2 V_28 [] = { 0 , 4 , 7 , 9 } ;
V_13 = ( V_25 * 10 ) + V_28 [ V_26 ] + V_27 ;
} else {
while ( ( V_11 = F_7 ( V_2 , V_14 , V_13 ,
V_3 , V_4 , V_5 , V_6 ) ) ) {
if ( F_3 ( V_2 , V_11 + 0x00 ) == V_26 &&
F_3 ( V_2 , V_11 + 0x01 ) == V_27 )
break;
V_13 ++ ;
}
}
return F_8 ( V_2 , V_14 , V_27 , V_3 , V_4 , V_5 , V_6 , V_16 ) ;
}
