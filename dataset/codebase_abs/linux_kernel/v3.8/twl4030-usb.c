...
int V_14 , V_97 ;
struct V_83 * V_84 ;
struct V_98 * V_99 = V_93 -> V_7 . V_100 ;
V_2 = F_47 ( & V_93 -> V_7 , sizeof *V_2 , V_101 ) ;
if ( ! V_2 )
return - V_102 ;
if ( V_99 )
F_48 ( V_99 , L_16 ,
...
V_84 = F_47 ( & V_93 -> V_7 , sizeof *V_84 , V_101 ) ;
if ( ! V_84 )
return - V_102 ;
V_2 -> V_7 = & V_93 -> V_7 ;
V_2 -> V_75 = F_49 ( V_93 , 0 ) ;
V_2 -> V_17 = false ;
V_2 -> V_54 = 1 ;
V_2 -> V_15 = V_16 ;
...
F_51 ( & V_2 -> V_87 , V_108 ) ;
F_52 ( V_93 , V_2 ) ;
if ( F_53 ( & V_93 -> V_7 , & V_109 ) )
F_54 ( & V_93 -> V_7 , L_20 ) ;
V_2 -> V_110 = true ;
V_14 = F_55 ( V_2 -> V_75 , NULL , F_38 ,
V_111 | V_112 |
V_113 , L_21 , V_2 ) ;
if ( V_14 < 0 ) {
F_4 ( & V_93 -> V_7 , L_22 ,
...
static int T_4 F_57 ( struct V_92 * V_93 )
{
