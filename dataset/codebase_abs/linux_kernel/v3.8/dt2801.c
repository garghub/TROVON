...
if ( ! V_20 )
V_20 = F_10 ( V_2 ) ;
for ( type = 0 ; type < F_27 ( V_67 ) ; type ++ ) {
if ( V_67 [ type ] . V_68 == V_20 )
goto V_69;
}
F_9 ( L_16 ,
V_20 ) ;
...
V_36 -> V_81 = V_71 . V_82 / 2 ;
#endif
V_36 -> V_83 = ( 1 << V_71 . V_84 ) - 1 ;
V_36 -> V_85 = F_15 ( V_71 . V_86 , V_63 -> V_65 [ 3 ] ) ;
V_36 -> V_87 = F_17 ;
V_36 = & V_2 -> V_49 [ 1 ] ;
V_36 -> type = V_88 ;
V_36 -> V_78 = V_89 ;
V_36 -> V_81 = 2 ;
V_36 -> V_83 = ( 1 << V_71 . V_90 ) - 1 ;
V_36 -> V_91 = V_44 -> V_92 ;
V_44 -> V_92 [ 0 ] = F_14 ( V_63 -> V_65 [ 4 ] ) ;
V_44 -> V_92 [ 1 ] = F_14 ( V_63 -> V_65 [ 5 ] ) ;
V_36 -> V_87 = F_20 ;
V_36 -> V_93 = F_21 ;
V_36 = & V_2 -> V_49 [ 2 ] ;
V_36 -> type = V_94 ;
