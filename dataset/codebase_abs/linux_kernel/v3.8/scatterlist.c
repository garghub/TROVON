...
void F_34 ( struct V_40 * V_41 , struct V_1 * V_6 ,
...
bool F_36 ( struct V_40 * V_41 )
{
unsigned int V_49 , V_50 ;
if ( ! V_41 -> V_44 )
return false ;
F_37 ( V_41 ) ;
while ( V_41 -> V_45 == V_41 -> V_43 -> V_51 ) {
if ( -- V_41 -> V_44 ) {
V_41 -> V_43 = F_1 ( V_41 -> V_43 ) ;
V_41 -> V_45 = 0 ;
} else
return false ;
}
V_49 = V_41 -> V_43 -> V_32 + V_41 -> V_45 ;
V_50 = V_41 -> V_43 -> V_51 - V_41 -> V_45 ;
V_41 -> V_29 = F_38 ( F_39 ( V_41 -> V_43 ) , V_49 >> V_39 ) ;
V_49 &= ~ V_52 ;
V_41 -> V_51 = F_40 (unsigned int, len, PAGE_SIZE - off) ;
V_41 -> V_53 = V_41 -> V_51 ;
if ( V_41 -> V_48 & V_54 )
V_41 -> V_55 = F_41 ( V_41 -> V_29 ) + V_49 ;
else
V_41 -> V_55 = F_42 ( V_41 -> V_29 ) + V_49 ;
return true ;
}
void F_37 ( struct V_40 * V_41 )
{
F_35 ( V_41 -> V_53 > V_41 -> V_51 ) ;
if ( V_41 -> V_55 ) {
V_41 -> V_45 += V_41 -> V_53 ;
if ( V_41 -> V_48 & V_46 )
F_43 ( V_41 -> V_29 ) ;
...
V_57 |= V_46 ;
F_34 ( & V_41 , V_6 , V_5 , V_57 ) ;
F_48 ( V_42 ) ;
while ( F_36 ( & V_41 ) && V_32 < V_10 ) {
unsigned int V_50 ;
V_50 = F_33 ( V_41 . V_51 , V_10 - V_32 ) ;
if ( V_56 )
memcpy ( V_9 + V_32 , V_41 . V_55 , V_50 ) ;
else
memcpy ( V_41 . V_55 , V_9 + V_32 , V_50 ) ;
V_32 += V_50 ;
}
F_37 ( & V_41 ) ;
F_49 ( V_42 ) ;
