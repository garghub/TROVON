...
struct V_4 * V_5 =
F_2 ( V_2 , struct V_4 , V_6 ) ;
return snprintf ( V_3 , V_9 , L_1 , V_5 -> V_16 ) ;
}
static T_1 F_12 (
struct V_1 * V_2 , char * V_3 )
{
...
struct V_1 * V_2 , char * V_3 )
{
return snprintf ( V_3 , V_9 , L_5 , ( unsigned long long ) 0 ) ;
}
static T_1 F_16 (
struct V_1 * V_2 , char * V_3 )
{
...
V_5 -> V_18 . V_22 [ V_20 ] : ' ' ;
V_21 [ V_20 ] = '\0' ;
return snprintf ( V_3 , V_9 , L_6 , V_21 ) ;
}
static T_1 F_18 (
struct V_1 * V_2 , char * V_3 )
{
...
struct V_4 * V_5 =
F_2 ( V_2 , struct V_4 , V_6 ) ;
return snprintf ( V_3 , V_9 , L_1 , ( V_28 ) ( V_5 -> V_29 >> 20 ) ) ;
}
static T_1 F_25 (
struct V_1 * V_2 , char * V_3 )
{
struct V_4 * V_5 =
F_2 ( V_2 , struct V_4 , V_6 ) ;
return snprintf ( V_3 , V_9 , L_1 , ( V_28 ) ( V_5 -> V_30 >> 20 ) ) ;
}
static T_1 F_26 (
struct V_1 * V_2 , char * V_3 )
{
...
struct V_4 * V_5 =
F_2 ( V_2 , struct V_4 , V_6 ) ;
return snprintf ( V_3 , V_9 , L_1 , ( V_28 ) ( ( ( V_28 ) V_5 -> V_31 -
V_32 ) * 100 / V_33 ) ) ;
}
...
V_52 = snprintf ( V_3 , V_9 , L_14 , L_15 , V_5 -> V_11 ) ;
F_34 ( & V_47 -> V_53 ) ;
return V_52 ;
}
static T_1 F_38 (
...
V_52 = snprintf ( V_3 , V_9 , L_5 , V_50 -> V_64 . V_65 ) ;
F_34 ( & V_47 -> V_53 ) ;
return V_52 ;
}
static T_1 F_45 (
...
V_52 = snprintf ( V_3 , V_9 , L_6 , V_83 -> V_92 ) ;
F_55 ( & V_83 -> V_87 ) ;
return V_52 ;
}
static T_1 F_61 (
...
V_52 = snprintf ( V_3 , V_9 , L_1 , ( V_28 ) ( V_86 -> V_29 >> 20 ) ) ;
F_55 ( & V_83 -> V_87 ) ;
return V_52 ;
}
static T_1 F_65 (
...
V_52 = snprintf ( V_3 , V_9 , L_1 , ( V_28 ) ( V_86 -> V_30 >> 20 ) ) ;
F_55 ( & V_83 -> V_87 ) ;
return V_52 ;
}
static T_1 F_66 (
...
V_52 = snprintf ( V_3 , V_9 , L_1 , ( V_28 ) ( ( ( V_28 ) V_86 -> V_31 -
V_32 ) * 100 / V_33 ) ) ;
F_55 ( & V_83 -> V_87 ) ;
return V_52 ;
}
...
V_52 = snprintf ( V_3 , V_9 , L_25 , V_83 -> V_92 , V_100 ) ;
F_55 ( & V_83 -> V_97 ) ;
return V_52 ;
}
...
F_31 ( & V_80 -> V_81 . V_103 ,
L_26 , & V_104 ) ;
F_31 ( & V_80 -> V_81 . V_105 ,
L_27 , & V_106 ) ;
