...
if ( F_106 ( V_40 >= V_187 ) )
return - V_15 ;
F_107 ( V_155 -> V_188 , V_185 ) ;
return 0 ;
}
static void F_108 ( unsigned V_183 , struct V_189 * V_190 )
{
struct V_191 * V_107 = F_109 ( V_190 ) ;
struct V_168 * V_192 = F_110 ( V_190 ) ;
struct V_104 * V_155 = F_99 ( V_192 ) ;
void T_1 * V_45 = V_155 -> V_42 ;
unsigned long V_193 ;
int V_194 ;
F_111 ( V_107 , V_190 ) ;
for (; ; ) {
V_193 = F_24 ( V_45 + V_195 ) & F_24 ( V_45 + V_196 ) ;
if ( ! V_193 ) {
if ( ! V_155 -> V_197 )
break;
V_155 = V_155 -> V_197 ;
...
F_112 (n, &isr, BITS_PER_LONG) {
F_113 ( F_114 ( V_155 -> V_162 , V_194 ) ) ;
}
}
F_115 ( V_107 , V_190 ) ;
}
static int F_116 ( struct V_198 * V_199 , unsigned int V_161 ,
T_5 V_200 )
{
struct V_104 * V_155 = V_199 -> V_201 ;
F_117 ( V_161 , & V_202 ) ;
F_118 ( V_161 , & V_203 ,
V_204 ) ;
F_119 ( V_161 , V_205 ) ;
...
static int F_121 ( struct V_198 * V_169 ,
struct V_19 * V_206 ,
const T_2 * V_207 , unsigned int V_208 ,
T_5 * V_209 ,
unsigned int * V_210 )
{
struct V_104 * V_155 = V_169 -> V_201 ;
int V_88 ;
int V_43 = V_155 -> V_107 . V_109 + V_207 [ 0 ] ;
if ( F_122 ( V_208 < 2 ) )
return - V_15 ;
* V_209 = V_207 [ 0 ] ;
* V_210 = V_207 [ 1 ] & V_211 ;
V_88 = F_123 ( V_43 , V_206 -> V_212 ) ;
if ( V_88 )
return V_88 ;
V_88 = F_124 ( V_43 ) ;
if ( V_88 )
...
static int F_125 ( struct V_19 * V_213 ,
struct V_104 * V_155 )
{
struct V_104 * V_214 = NULL ;
struct V_168 * V_169 = F_126 ( V_155 -> V_188 ) ;
V_155 -> V_215 = F_127 ( V_169 ) ;
V_203 . V_216 = V_155 -> V_91 -> V_217 ;
F_22 ( ~ 0 , V_155 -> V_42 + V_47 ) ;
V_155 -> V_162 = F_128 ( V_213 , V_155 -> V_107 . V_154 ,
& V_218 , V_155 ) ;
if ( ! V_155 -> V_162 )
F_129 ( L_47 ,
V_155 -> V_186 ) ;
if ( V_155 -> V_186 )
V_214 = V_41 [ V_155 -> V_186 - 1 ] ;
if ( V_214 && V_214 -> V_197 == V_155 )
return 0 ;
F_120 ( V_155 -> V_188 , V_155 ) ;
F_130 ( V_155 -> V_188 , F_108 ) ;
return 0 ;
}
static void F_131 ( void )
{
unsigned V_6 ;
struct V_104 * V_155 , * V_219 = NULL ;
for ( V_6 = 0 ; V_6 < V_220 ; V_6 ++ ) {
V_155 = V_41 [ V_6 ] ;
if ( V_219 && V_219 -> V_188 == V_155 -> V_188 )
V_219 -> V_197 = V_155 ;
V_219 = V_155 ;
}
}
...
int V_88 = 0 ;
int V_183 , V_6 ;
int V_223 = F_133 ( V_20 , L_48 ) ;
T_3 V_154 ;
char * * V_224 ;
F_134 ( V_223 >= F_135 ( V_41 ) ) ;
if ( V_41 [ V_223 ] ) {
V_88 = - V_225 ;
goto V_152;
}
V_222 = F_136 ( V_139 , V_226 , 0 ) ;
if ( ! V_222 ) {
V_88 = - V_227 ;
goto V_152;
}
...
V_105 -> V_42 = F_138 ( & V_139 -> V_9 , V_222 ) ;
if ( ! V_105 -> V_42 ) {
F_11 ( & V_139 -> V_9 , L_49 ) ;
V_88 = - V_225 ;
goto V_152;
...
F_74 ( V_228 , & V_139 -> V_9 ) -> V_30 ;
V_105 -> V_188 = V_183 ;
V_105 -> V_186 = V_223 ;
V_105 -> clock = F_139 ( & V_139 -> V_9 , NULL ) ;
if ( F_140 ( V_105 -> clock ) ) {
F_11 ( & V_139 -> V_9 , L_50 ) ;
goto V_152;
}
if ( F_141 ( V_105 -> clock ) )
goto V_229;
if ( F_142 ( V_105 -> clock ) ) {
F_11 ( & V_139 -> V_9 , L_51 ) ;
goto V_230;
}
V_105 -> V_107 = V_231 ;
...
V_107 -> V_9 = & V_139 -> V_9 ;
V_107 -> V_232 = V_233 ;
V_107 -> V_109 = V_223 * V_44 ;
if ( ! F_143 ( V_20 , L_52 , & V_154 ) ) {
if ( V_154 >= V_44 )
F_144 ( L_53 ,
V_223 , V_44 , V_44 ) ;
else
...
V_224 = F_12 ( & V_139 -> V_9 , sizeof( char * ) * V_107 -> V_154 , V_27 ) ;
if ( ! V_224 ) {
V_88 = - V_28 ;
goto V_230;
}
for ( V_6 = 0 ; V_6 < V_107 -> V_154 ; V_6 ++ )
V_224 [ V_6 ] = F_77 ( V_27 , L_36 , V_223 + 'A' , V_6 ) ;
V_107 -> V_224 = ( const char * const * ) V_224 ;
V_102 = & V_105 -> V_102 ;
V_102 -> V_4 = V_107 -> V_164 ;
V_102 -> V_110 = V_223 ;
V_102 -> V_234 = V_102 -> V_109 = V_102 -> V_110 * V_44 ;
...
F_148 ( V_105 -> clock ) ;
V_152:
F_11 ( & V_139 -> V_9 , L_55 , V_88 , V_223 ) ;
return V_88 ;
}
