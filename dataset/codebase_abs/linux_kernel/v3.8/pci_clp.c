...
{
struct V_4 * V_4 = F_3 ( V_5 , F_4 ( V_6 ) ) ;
return ( V_4 ) ? F_5 ( V_4 ) : NULL ;
}
static void F_6 ( void * V_7 )
{
F_7 ( ( unsigned long ) V_7 , F_4 ( V_6 ) ) ;
}
...
static int F_10 ( struct V_8 * V_9 , T_1 V_25 )
{
struct V_26 * V_27 ;
int V_28 ;
V_27 = F_2 () ;
...
V_9 -> V_41 [ V_39 ] . V_42 = F_13 ( V_11 -> V_43 [ V_39 ] ) ;
...
static int F_14 ( struct V_8 * V_9 , T_3 V_51 )
{
struct V_52 * V_27 ;
int V_28 ;
V_27 = F_2 () ;
...
V_28 = F_1 ( V_27 ) ;
if ( ! V_28 && V_27 -> V_11 . V_31 . V_35 == V_36 ) {
V_28 = F_12 ( V_9 , & V_27 -> V_11 ) ;
if ( V_28 )
goto V_54;
if ( V_27 -> V_11 . V_25 )
V_28 = F_10 ( V_9 , V_27 -> V_11 . V_25 ) ;
} else {
F_11 ( L_3 ,
V_27 -> V_11 . V_31 . V_35 , V_28 ) ;
V_28 = - V_37 ;
...
int F_15 ( T_3 V_55 , T_3 V_51 , int V_56 )
{
struct V_8 * V_9 ;
int V_28 ;
V_9 = F_16 () ;
...
if ( ! F_25 ( V_9 ) )
return 0 ;
F_26 ( & V_9 -> V_69 -> V_70 , L_5 , V_51 ) ;
V_28 = F_21 ( & V_51 , 0 , V_71 ) ;
if ( ! V_28 )
V_9 -> V_51 = V_51 ;
else
F_27 ( & V_9 -> V_69 -> V_70 ,
...
V_28 = F_15 ( V_73 -> V_55 , V_73 -> V_51 , V_73 -> V_77 ) ;
if ( V_28 )
F_11 ( L_8 , V_73 -> V_55 ) ;
}
int F_32 ( void )
