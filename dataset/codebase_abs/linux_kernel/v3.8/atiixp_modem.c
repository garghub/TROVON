...
static T_4 F_75 ( int V_139 , void * V_140 )
{
...
{
struct V_166 * V_24 = F_79 ( V_165 ) ;
struct V_167 * V_129 = F_80 ( V_165 ) ;
...
static void F_94 ( struct V_174 * V_175 ,
struct V_176 * V_177 )
{
struct V_1 * V_2 = V_175 -> V_53 ;
int V_16 ;
for ( V_16 = 0 ; V_16 < 256 ; V_16 += 4 )
F_95 ( V_177 , L_12 , V_16 , F_2 ( V_2 -> V_7 + V_16 ) ) ;
}
static void F_96 ( struct V_1 * V_2 )
{
struct V_174 * V_175 ;
if ( ! F_97 ( V_2 -> V_129 , L_13 , & V_175 ) )
F_98 ( V_175 , V_2 , F_94 ) ;
}
...
static int F_104 ( struct V_179 * V_164 )
{
struct V_1 * V_2 = V_164 -> V_180 ;
return F_99 ( V_2 ) ;
}
static int F_105 ( struct V_167 * V_129 ,
struct V_166 * V_24 ,
struct V_1 * * V_181 )
{
...
if ( F_112 ( V_24 -> V_139 , F_75 , V_185 ,
V_186 , V_2 ) ) {
...
F_92 ( V_24 ) ;
F_113 ( V_2 -> V_139 ) ;
if ( ( V_89 = F_114 ( V_129 , V_187 , V_2 , & V_27 ) ) < 0 ) {
F_99 ( V_2 ) ;
return V_89 ;
}
F_115 ( V_129 , & V_24 -> V_165 ) ;
* V_181 = V_2 ;
return 0 ;
}
static int F_116 ( struct V_166 * V_24 ,
...
static void F_121 ( struct V_166 * V_24 )
{
F_120 ( F_122 ( V_24 ) ) ;
F_119 ( V_24 , NULL ) ;
}
