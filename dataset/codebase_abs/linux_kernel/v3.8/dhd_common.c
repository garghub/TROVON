...
T_1 V_31 ;
struct V_55 * V_56 ;
struct V_57 * V_58 , * V_4 ;
V_31 = F_25 ( V_24 , L_18 , V_24 -> V_59 ,
sizeof( V_24 -> V_59 ) ) ;
if ( V_31 < 0 ) {
F_10 ( L_19 ,
V_31 ) ;
...
memcpy ( V_24 -> V_14 -> V_61 , V_24 -> V_59 , sizeof( V_24 -> V_14 -> V_61 ) ) ;
...
V_31 = F_19 ( V_24 , L_33 , V_68 ) ;
if ( V_31 ) {
F_28 ( V_69 , L_34 ,
V_68 , V_31 ) ;
V_31 = 0 ;
} else {
V_31 = F_19 ( V_24 , L_35 , 1 ) ;
if ( V_31 ) {
F_28 ( V_69 , L_36 ,
V_31 ) ;
V_31 = 0 ;
...
F_14 ( V_24 , V_70 ,
0 , true ) ;
F_29 (cur, q, &ifp->drvr->bus_if->dcmd_list) {
V_56 = F_30 ( V_58 , struct V_55 , V_71 ) ;
if ( V_56 -> V_72 && V_56 -> V_73 && V_56 -> V_74 ) {
F_18 ( V_24 , V_56 -> V_72 ,
V_56 -> V_73 ,
V_56 -> V_74 ) ;
}
