...
struct V_6 * V_7 ,
enum V_11 V_12 , bool * V_26 )
{
struct V_27 * V_28 = & V_2 -> V_29 [ V_12 ] ;
struct V_30 * V_31 ;
struct V_24 * V_18 ;
...
while ( V_15 == - V_25 ) {
F_28 ( & V_2 -> V_34 ) ;
V_15 = F_29 ( V_28 , V_7 -> V_18 . V_23 , & V_18 ) ;
if ( V_15 == 0 ) {
V_31 = F_24 ( V_18 , struct V_30 , V_18 ) ;
F_2 ( & V_31 -> V_4 ) ;
F_30 ( & V_2 -> V_34 ) ;
break;
}
F_30 ( & V_2 -> V_34 ) ;
V_15 = F_31 ( V_33 , sizeof( * V_31 ) ,
false , false ) ;
if ( F_15 ( V_15 != 0 ) )
return V_15 ;
V_31 = F_32 ( sizeof( * V_31 ) , V_35 ) ;
if ( F_15 ( V_31 == NULL ) ) {
F_33 ( V_33 , sizeof( * V_31 ) ) ;
return - V_36 ;
}
...
F_11 ( & V_31 -> V_4 ) ;
F_34 ( & V_2 -> V_34 ) ;
V_15 = F_35 ( V_28 , & V_31 -> V_18 ) ;
if ( F_23 ( V_15 == 0 ) ) {
F_36 ( & V_31 -> V_38 , & V_2 -> V_39 ) ;
F_2 ( & V_7 -> V_3 ) ;
F_37 ( & V_2 -> V_34 ) ;
if ( V_26 != NULL )
* V_26 = false ;
...
{
struct V_30 * V_31 =
F_4 ( V_4 , struct V_30 , V_4 ) ;
struct V_6 * V_7 = V_31 -> V_37 ;
struct V_1 * V_2 = V_31 -> V_2 ;
struct V_27 * V_28 ;
struct V_32 * V_33 = V_2 -> V_14 -> V_33 ;
V_28 = & V_2 -> V_29 [ V_31 -> V_12 ] ;
( void ) F_40 ( V_28 , & V_31 -> V_18 ) ;
F_41 ( & V_31 -> V_38 ) ;
F_37 ( & V_2 -> V_34 ) ;
...
while ( ! F_44 ( & V_2 -> V_39 ) ) {
V_41 = V_2 -> V_39 . V_43 ;
V_31 = F_45 ( V_41 , struct V_30 , V_38 ) ;
F_39 ( & V_31 -> V_4 ) ;
}
...
unsigned int V_45 )
{
struct V_1 * V_2 = F_32 ( sizeof( * V_2 ) , V_35 ) ;
unsigned int V_42 ;
unsigned int V_46 = 0 ;
int V_15 ;
if ( F_15 ( V_2 == NULL ) )
...
struct V_13 * F_51 ( struct V_32
* V_33 ,
unsigned int V_45 )
{
struct V_13 * V_14 = F_32 ( sizeof( * V_14 ) , V_35 ) ;
int V_15 ;
if ( F_15 ( V_14 == NULL ) )
return NULL ;
V_14 -> V_33 = V_33 ;
F_52 ( & V_14 -> V_16 ) ;
F_53 ( & V_14 -> V_48 , 0 ) ;
V_15 = F_50 ( & V_14 -> V_17 , V_45 ) ;
if ( F_23 ( V_15 == 0 ) )
return V_14 ;
F_5 ( V_14 ) ;
return NULL ;
}
void F_54 ( struct V_13 * * V_49 )
{
