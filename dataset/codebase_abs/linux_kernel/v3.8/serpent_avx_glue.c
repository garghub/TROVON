...
int V_28 ;
V_28 = F_27 ( & V_1 -> V_29 , V_25 , V_26 -
V_16 ) ;
if ( V_28 )
return V_28 ;
return F_28 ( & V_1 -> V_30 , V_25 + V_26 -
V_16 ) ;
}
...
int V_39 ;
V_8 -> V_40 &= ~ V_41 ;
V_39 = F_31 ( V_8 , V_2 , V_3 , V_10 , & V_34 ) ;
F_18 ( V_32 . V_15 ) ;
return V_39 ;
}
...
V_28 = F_27 ( & V_1 -> V_32 , V_25 , V_26 / 2 ) ;
if ( V_28 )
return V_28 ;
...
int V_39 ;
V_8 -> V_40 &= ~ V_41 ;
V_39 = F_38 ( V_8 , V_2 , V_3 , V_10 , & V_34 ) ;
F_18 ( V_32 . V_15 ) ;
return V_39 ;
}
...
V_49 = F_42 ( V_54 ) ;
if ( ( V_49 & ( V_55 | V_56 ) ) != ( V_55 | V_56 ) ) {
F_41 ( V_52 L_2 ) ;
return - V_53 ;
}
return F_43 ( V_57 , F_44 ( V_57 ) ) ;
}
