...
int V_16 ;
V_95:
V_175 = V_171 -> V_6 + ( T_1 ) ( V_151 * V_91 -> V_149 ) - 1 ;
V_176 = * V_6 ;
V_177 = V_91 -> V_149 ;
V_177 = F_115 ( V_177 , V_175 - V_176 + 1 ) ;
V_16 = F_148 ( V_91 , V_171 , & V_176 , & V_177 ) ;
F_59 ( V_16 < 0 || V_176 != * V_6 ) ;
V_177 = F_115 ( V_177 , * V_82 ) ;
V_177 = F_115 ( V_177 , V_175 - V_176 + 1 ) ;
F_145 ( V_91 , V_171 , V_176 , V_177 ) ;
* V_6 += V_177 ;
* V_82 -= V_177 ;
if ( * V_82 ) {
...
T_1 V_180 = 0 ;
T_1 V_175 ;
V_175 = V_155 -> V_6 + ( T_1 ) ( V_151 * V_91 -> V_149 ) ;
V_180 = F_115 ( V_175 - V_6 , V_82 ) ;
F_146 ( V_91 , V_155 , V_6 , V_180 ) ;
return V_180 ;
}
...
if ( V_151 * V_91 -> V_149 > V_27 -> V_8 . V_6 )
return false ;
return true ;
}
...
V_183 = F_156 ( V_91 , V_171 , V_6 , V_82 ) ;
V_82 -= V_183 ;
V_6 += V_183 ;
V_182 = 0 ;
if ( ! V_82 ) {
...
F_91 ( V_91 , V_155 ) ;
if ( V_6 == V_155 -> V_6 ) {
T_1 V_195 = F_115 ( V_82 , V_155 -> V_82 ) ;
V_155 -> V_82 -= V_195 ;
V_155 -> V_6 += V_195 ;
if ( V_155 -> V_82 ) {
V_16 = F_93 ( V_91 , V_155 ) ;
...
T_1 V_196 = V_155 -> V_82 + V_155 -> V_6 ;
...
struct V_101 * V_200 ;
F_15 ( & V_91 -> V_96 ) ;
while ( ( V_200 = V_27 -> V_137 . V_99 ) !=
& V_27 -> V_137 ) {
V_127 = F_110 ( V_200 , struct V_126 ,
V_138 ) ;
...
T_1 V_6 , T_1 V_82 , T_1 V_201 )
{
struct V_90 * V_91 = V_27 -> V_112 ;
struct V_88 * V_85 = NULL ;
T_1 V_202 = V_82 + V_201 ;
T_1 V_16 = 0 ;
F_15 ( & V_91 -> V_96 ) ;
V_85 = F_152 ( V_91 , & V_6 , & V_202 ) ;
if ( ! V_85 )
goto V_105;
V_16 = V_6 ;
if ( V_85 -> V_83 ) {
...
struct V_90 * V_91 = V_27 -> V_112 ;
int V_136 ;
T_1 V_176 = V_127 -> V_198 ;
T_1 V_177 = V_82 ;
T_1 V_16 = 0 ;
V_176 = V_203 ;
V_177 = V_82 ;
V_136 = F_148 ( V_91 , V_85 , & V_176 , & V_177 ) ;
if ( V_136 )
return 0 ;
V_16 = V_176 ;
...
V_207 = F_130 ( V_82 , V_91 -> V_149 ) ;
V_208 = F_130 ( V_206 , V_91 -> V_149 ) ;
V_95:
V_172 = 0 ;
...
V_209 += V_172 ;
if ( V_127 -> V_204 < V_172 * V_91 -> V_149 )
V_127 -> V_204 = V_172 * V_91 -> V_149 ;
if ( V_209 < V_207 || V_127 -> V_204 < V_205 ) {
V_72 = V_174 + 1 ;
goto V_95;
}
V_127 -> V_198 = V_131 * V_91 -> V_149 + V_85 -> V_6 ;
...
if ( ! V_85 )
return - V_53 ;
while ( V_85 -> V_83 || V_85 -> V_82 < V_206 ) {
...
if ( V_212 < V_82 || V_213 < V_205 )
return - V_53 ;
V_127 -> V_198 = V_210 -> V_6 ;
V_122 = & V_210 -> V_98 ;
do {
int V_16 ;
V_85 = F_90 ( V_122 , struct V_88 , V_98 ) ;
V_122 = F_89 ( & V_85 -> V_98 ) ;
if ( V_85 -> V_83 || V_85 -> V_82 < V_206 )
continue;
F_140 ( & V_85 -> V_98 , & V_91 -> V_97 ) ;
V_16 = F_133 ( & V_127 -> V_3 , V_85 -> V_6 ,
& V_85 -> V_98 , 0 ) ;
V_214 += V_85 -> V_82 ;
F_59 ( V_16 ) ;
} while ( V_122 && V_85 != V_211 );
V_127 -> V_204 = V_213 ;
F_179 ( V_27 , V_127 , V_214 , 0 ) ;
return 0 ;
}
static T_7 int
...
struct V_88 * V_85 ;
int V_16 = - V_53 ;
T_1 V_215 = F_131 ( V_91 , V_6 ) ;
if ( V_91 -> V_107 == 0 )
return - V_53 ;
V_85 = F_182 ( V_102 , struct V_88 , V_110 ) ;
if ( V_85 -> V_6 != V_215 ) {
V_85 = F_137 ( V_91 , V_215 , 1 , 0 ) ;
...
int V_16 ;
if ( F_187 ( V_3 , V_216 ) ) {
V_205 = V_206 = V_82 + V_201 ;
} else if ( V_27 -> V_28 & V_217 ) {
V_205 = V_82 ;
V_206 = V_27 -> V_181 ;
} else {
V_205 = F_114 ( V_82 , ( V_82 + V_201 ) >> 2 ) ;
V_206 = V_27 -> V_181 ;
}
F_15 ( & V_91 -> V_96 ) ;
if ( V_91 -> V_120 < V_82 ) {
...
T_1 * V_219 , T_1 V_131 , T_1 V_82 ,
T_1 V_220 , T_1 V_221 )
{
struct V_222 * V_223 = V_27 -> V_223 ;
...
F_17 ( & V_27 -> V_31 ) ;
F_17 ( & V_223 -> V_31 ) ;
V_16 = F_192 ( V_22 -> V_227 ,
V_131 , V_82 , & V_225 ) ;
if ( ! V_16 )
* V_219 += V_225 ;
F_162 ( V_27 , V_220 , V_221 ) ;
if ( V_224 ) {
F_15 ( & V_223 -> V_31 ) ;
F_15 ( & V_27 -> V_31 ) ;
if ( V_27 -> V_197 )
...
T_1 * V_219 , T_1 V_131 , T_1 V_175 , T_1 V_229 )
{
struct V_90 * V_91 = V_27 -> V_112 ;
struct V_88 * V_85 ;
struct V_93 * V_122 ;
...
V_82 = F_115 ( V_132 + V_165 , V_175 ) - V_131 ;
if ( V_82 < V_229 ) {
F_17 ( & V_91 -> V_96 ) ;
goto V_99;
}
...
F_92 ( V_100 , V_85 ) ;
F_17 ( & V_91 -> V_96 ) ;
V_16 = F_191 ( V_27 , V_219 , V_131 , V_82 ,
V_132 , V_165 ) ;
if ( V_16 )
break;
V_99:
...
V_82 = V_229 ;
V_232 = F_148 ( V_91 , V_85 , & V_131 , & V_82 ) ;
if ( V_232 || V_131 >= V_175 ) {
F_17 ( & V_91 -> V_96 ) ;
V_233 = true ;
goto V_99;
}
V_82 = F_115 ( V_82 , V_175 - V_131 ) ;
if ( V_82 < V_229 ) {
F_17 ( & V_91 -> V_96 ) ;
goto V_99;
}
...
T_1 * V_225 , T_1 V_131 , T_1 V_175 , T_1 V_229 )
{
int V_16 ;
* V_225 = 0 ;
V_16 = F_193 ( V_27 , V_225 , V_131 , V_175 , V_229 ) ;
if ( V_16 )
return V_16 ;
V_16 = F_195 ( V_27 , V_225 , V_131 , V_175 , V_229 ) ;
return V_16 ;
}
T_1 F_197 ( struct V_2 * V_234 )
{
