...
V_1 -> V_84 = V_46 -> V_84 ;
V_1 -> V_85 = V_46 -> V_85 ;
for ( V_57 = 0 ; V_57 < F_27 ( V_46 -> V_86 ) ; V_57 ++ ) {
if ( V_46 -> V_86 [ V_57 ] ) {
F_9 ( V_1 , V_38 + V_57 ,
0xffff , V_46 -> V_86 [ V_57 ] ) ;
}
}
V_1 -> V_33 = V_46 -> V_33 ;
if ( V_46 -> V_87 )
...
struct V_1 * V_1 ;
int V_4 ;
V_1 = F_29 ( & V_96 -> V_10 , sizeof( struct V_1 ) , V_67 ) ;
if ( V_1 == NULL )
return - V_68 ;
F_44 ( V_96 , V_1 ) ;
V_1 -> V_10 = & V_96 -> V_10 ;
...
return F_23 ( V_1 , V_96 -> V_52 ) ;
}
static int F_48 ( struct V_95 * V_96 )
{
struct V_1 * V_1 = F_49 ( V_96 ) ;
F_41 ( V_1 ) ;
return 0 ;
}
