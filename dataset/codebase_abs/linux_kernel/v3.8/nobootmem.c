...
unsigned long T_1 F_22 ( T_4 * V_23 )
{
F_23 ( V_23 ) ;
F_20 ( V_23 ) ;
return 0 ;
...
void T_1 F_26 ( T_4 * V_23 , unsigned long V_31 ,
unsigned long V_2 )
{
F_7 ( F_8 ( V_31 ) , V_2 ) ;
F_27 ( V_31 , V_2 ) ;
}
void T_1 F_28 ( unsigned long V_7 , unsigned long V_2 )
{
F_7 ( F_8 ( V_7 ) , V_2 ) ;
F_27 ( V_7 , V_2 ) ;
}
static void * T_1 F_29 ( unsigned long V_2 ,
unsigned long V_3 ,
unsigned long V_4 ,
unsigned long V_5 )
{
...
void * T_1 F_33 ( unsigned long V_2 , unsigned long V_3 ,
unsigned long V_4 )
{
unsigned long V_5 = - 1UL ;
return F_29 ( V_2 , V_3 , V_4 , V_5 ) ;
}
static void * T_1 F_34 ( unsigned long V_2 , unsigned long V_3 ,
unsigned long V_4 , unsigned long V_5 )
{
void * V_34 = F_29 ( V_2 , V_3 , V_4 , V_5 ) ;
if ( V_34 )
return V_34 ;
F_35 ( V_35 L_1 , V_2 ) ;
F_36 ( L_2 ) ;
...
void * T_1 F_37 ( unsigned long V_2 , unsigned long V_3 ,
unsigned long V_4 )
{
unsigned long V_5 = - 1UL ;
return F_34 ( V_2 , V_3 , V_4 , V_5 ) ;
}
void * T_1 F_38 ( T_4 * V_23 ,
unsigned long V_2 ,
unsigned long V_3 ,
unsigned long V_4 ,
unsigned long V_5 )
...
{
if ( F_30 ( F_31 () ) )
return F_40 ( V_2 , V_32 , V_23 -> V_37 ) ;
...
if ( F_30 ( F_31 () ) )
return F_40 ( V_2 , V_32 , V_23 -> V_37 ) ;
return F_41 ( V_23 , V_2 , V_3 , V_4 , 0 ) ;
}
void * T_1 F_43 ( T_4 * V_23 , unsigned long V_2 ,
unsigned long V_3 , unsigned long V_4 )
{
return F_42 ( V_23 , V_2 , V_3 , V_4 ) ;
}
void * T_1 F_44 ( unsigned long V_2 , unsigned long V_3 ,
unsigned long V_4 )
{
return F_34 ( V_2 , V_3 , V_4 , V_38 ) ;
}
void * T_1 F_45 ( T_4 * V_23 , unsigned long V_2 ,
unsigned long V_3 , unsigned long V_4 )
{
if ( F_30 ( F_31 () ) )
return F_40 ( V_2 , V_32 , V_23 -> V_37 ) ;
return F_41 ( V_23 , V_2 , V_3 , V_4 ,
V_38 ) ;
}
