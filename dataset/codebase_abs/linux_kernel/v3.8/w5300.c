...
{
struct V_108 * V_6 = V_107 -> V_56 . V_109 ;
struct V_23 * V_24 = F_69 ( V_107 ) ;
struct V_1 * V_2 = F_30 ( V_24 ) ;
const char * V_110 = F_70 ( V_24 ) ;
struct V_111 * V_112 ;
int V_113 ;
int V_87 ;
int V_114 ;
if ( V_6 && F_62 ( V_6 -> V_115 ) ) {
memcpy ( V_24 -> V_26 , V_6 -> V_115 , V_101 ) ;
} else {
F_71 ( V_24 ) ;
}
V_112 = F_72 ( V_107 , V_116 , 0 ) ;
if ( ! V_112 )
return - V_117 ;
V_113 = F_73 ( V_112 ) ;
if ( ! F_74 ( & V_107 -> V_56 , V_112 -> V_118 , V_113 , V_110 ) )
return - V_119 ;
V_2 -> V_4 = F_75 ( & V_107 -> V_56 , V_112 -> V_118 , V_113 ) ;
if ( ! V_2 -> V_4 )
return - V_119 ;
F_76 ( & V_2 -> V_8 ) ;
V_2 -> V_30 = V_113 < V_120 ;
if ( V_2 -> V_30 ) {
V_2 -> V_121 = F_5 ;
V_2 -> V_122 = F_9 ;
} else {
...
F_21 ( V_2 ) ;
if ( F_11 ( V_2 , V_123 ) != V_124 )
return - V_125 ;
V_87 = F_77 ( V_107 , 0 ) ;
if ( V_87 < 0 )
return V_87 ;
V_114 = F_78 ( V_87 , F_52 ,
V_126 , V_110 , V_24 ) ;
if ( V_114 < 0 )
return V_114 ;
V_2 -> V_87 = V_87 ;
V_2 -> V_58 = V_6 ? V_6 -> V_58 : - V_127 ;
if ( F_31 ( V_2 -> V_58 ) ) {
char * V_128 = F_79 ( & V_107 -> V_56 , 16 , V_129 ) ;
if ( ! V_128 )
return - V_83 ;
snprintf ( V_128 , 16 , L_7 , V_110 ) ;
...
F_82 ( V_24 , L_8 , ( V_133 ) V_112 -> V_118 , V_87 ) ;
return 0 ;
}
static int F_83 ( struct V_106 * V_107 )
{
struct V_1 * V_2 ;
struct V_23 * V_24 ;
int V_134 ;
