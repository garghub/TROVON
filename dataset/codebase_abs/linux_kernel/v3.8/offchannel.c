...
return;
F_13 ( & V_4 -> V_24 ) ;
F_14 (sdata, &local->interfaces, list) {
if ( ! F_15 ( V_2 ) )
continue;
...
if ( V_38 -> V_40 ) {
if ( ! F_12 ( ! V_38 -> V_41 ) ) {
F_24 ( V_38 -> V_2 , V_38 -> V_41 , 7 ,
V_38 -> V_42 -> V_43 ) ;
V_38 -> V_41 = NULL ;
}
} else {
F_25 ( & V_38 -> V_2 -> V_44 , V_38 -> V_45 ,
V_38 -> V_42 , V_38 -> V_46 ,
V_47 ) ;
}
V_38 -> V_39 = true ;
...
if ( F_28 ( & V_4 -> V_54 ) )
goto V_55;
V_38 = F_29 ( & V_4 -> V_54 , struct V_37 ,
V_56 ) ;
if ( ! V_38 -> V_57 )
goto V_55;
V_38 -> V_58 = true ;
...
if ( ! V_61 )
V_61 = 10 ;
V_66 = F_40 ( V_4 , V_38 -> V_2 , V_38 -> V_42 ,
V_61 ) ;
V_38 -> V_57 = true ;
if ( V_66 ) {
F_41 ( V_4 -> V_14 . V_67 ,
...
{
struct V_37 * V_38 =
F_27 ( V_49 , struct V_37 , V_49 . V_49 ) ;
...
if ( V_38 -> abort )
goto V_71;
if ( F_12 ( F_28 ( & V_4 -> V_54 ) ) )
goto V_55;
if ( F_12 ( V_38 != F_29 ( & V_4 -> V_54 ,
struct V_37 ,
V_56 ) ) )
goto V_55;
if ( ! V_38 -> V_57 ) {
