...
void F_26 ( const struct V_97 * V_98 , T_2 V_99 ,
T_2 V_100 , struct V_87 * V_88 ,
struct V_89 * V_90 )
{
int V_101 = V_88 -> V_71 ;
...
F_12 ( V_125 , V_34 , ( T_1 ) V_37 , ( T_1 ) V_138 ) ;
F_48 ( V_139 [ 2 ] [ V_137 ] ) ;
}
...
{
unsigned char T_4 * V_149 , * V_150 , * V_151 ;
T_1 V_152 ;
const T_3 V_153 = 0x000C0000 ;
T_2 V_154 ;
