...
static int F_57 ( struct V_47 * V_44 , unsigned char V_89 )
{
struct V_19 * V_20 = V_44 -> V_62 ;
unsigned long V_56 ;
int V_28 ;
F_20 ( L_16 ,
V_20 -> V_38 , V_44 , V_89 , F_58 ( 0 ) ) ;
F_55 ( & V_20 -> V_40 , V_56 ) ;
...
static int F_63 ( struct V_47 * V_44 , int V_92 )
{
struct V_19 * V_20 = V_44 -> V_62 ;
int V_28 = 0 ;
struct V_81 * V_82 ;
...
static int
F_64 ( unsigned V_38 , struct V_94 * V_95 )
{
struct V_19 * V_20 ;
...
F_67 ( & V_20 -> V_40 ) ;
F_68 ( & V_20 -> V_35 ) ;
F_69 ( & V_20 -> V_61 , F_28 , ( unsigned long ) V_20 ) ;
F_70 ( & V_20 -> V_45 ) ;
F_70 ( & V_20 -> V_51 ) ;
F_70 ( & V_20 -> V_25 ) ;
V_20 -> V_38 = V_38 ;
...
int F_71 ( struct V_97 * V_98 , unsigned V_11 )
{
unsigned V_65 ;
struct V_94 V_95 ;
int V_28 ;
...
for ( V_65 = 0 ; V_65 < V_11 ; V_65 ++ ) {
struct V_127 * V_128 ;
V_128 = F_78 ( & V_73 [ V_65 ] . V_20 -> V_20 ,
V_101 , V_65 , & V_98 -> V_129 ) ;
if ( F_79 ( V_128 ) )
F_32 ( L_24 ,
V_42 , V_65 , F_80 ( V_128 ) ) ;
}
F_24 ( L_25 , V_42 ,
...
int F_89 ( struct V_81 * V_82 , V_39 V_38 )
{
struct V_19 * V_20 ;
unsigned long V_56 ;
int V_28 ;
