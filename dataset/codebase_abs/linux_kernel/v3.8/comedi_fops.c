...
V_39 = V_4 -> V_6 -> V_177 ( V_2 , V_4 , V_131 [ 0 ] ) ;
if ( V_39 >= 0 )
V_39 = 1 ;
break;
default:
...
struct V_5 * V_6 ;
int V_39 = 0 ;
unsigned int T_3 * V_198 ;
if ( F_23 ( & V_197 , V_37 , sizeof( struct V_196 ) ) ) {
F_2 ( L_21 ) ;
return - V_47 ;
}
V_198 = ( unsigned int T_3 * ) V_197 . V_199 ;
if ( V_197 . V_113 >= V_2 -> V_60 ) {
F_2 ( L_22 , V_197 . V_113 ) ;
return - V_200 ;
}
V_4 = & V_2 -> V_20 [ V_197 . V_113 ] ;
V_6 = V_4 -> V_6 ;
if ( V_4 -> type == V_180 ) {
F_2 ( L_23 , V_197 . V_113 ) ;
return - V_181 ;
}
if ( ! V_4 -> V_104 || ! V_4 -> V_201 || ! V_4 -> V_6 ) {
F_2 ( L_24 ,
V_197 . V_113 ) ;
return - V_181 ;
}
...
V_4 -> V_11 = V_64 ;
if ( V_197 . V_202 > V_4 -> V_87 ) {
F_2 ( L_27 ,
V_197 . V_202 , V_4 -> V_87 ) ;
V_39 = - V_15 ;
goto V_203;
}
if ( V_197 . V_202 < 1 ) {
...
V_6 -> V_197 . V_199 =
F_49 ( V_6 -> V_197 . V_202 * sizeof( int ) , V_81 ) ;
if ( ! V_6 -> V_197 . V_199 ) {
F_2 ( L_29 ) ;
V_39 = - V_53 ;
goto V_203;
}
if ( F_23 ( V_6 -> V_197 . V_199 , V_198 ,
V_6 -> V_197 . V_202 * sizeof( int ) ) ) {
F_2 ( L_30 ) ;
V_39 = - V_47 ;
goto V_203;
}
...
V_39 = V_4 -> V_201 ( V_2 , V_4 , & V_6 -> V_197 ) ;
if ( V_6 -> V_197 . V_92 & V_204 || V_39 ) {
F_2 ( L_32 , V_39 ) ;
V_197 = V_6 -> V_197 ;
V_197 . V_199 = ( unsigned int V_205 * ) V_198 ;
V_197 . V_131 = NULL ;
if ( F_30 ( V_37 , & V_197 , sizeof( struct V_196 ) ) ) {
F_2 ( L_33 ) ;
V_39 = - V_47 ;
goto V_203;
}
...
if ( V_197 . V_199 ) {
V_199 =
F_49 ( V_197 . V_202 * sizeof( int ) , V_81 ) ;
if ( ! V_199 ) {
F_2 ( L_29 ) ;
V_39 = - V_53 ;
goto V_203;
...
if ( F_23 ( V_199 , V_198 ,
V_197 . V_202 * sizeof( int ) ) ) {
F_2 ( L_30 ) ;
V_39 = - V_47 ;
goto V_203;
}
V_39 = F_57 ( V_4 , V_197 . V_202 , V_199 ) ;
if ( V_39 < 0 ) {
F_2 ( L_31 ) ;
goto V_203;
}
...
{
int V_39 = 0 ;
if ( ( F_37 ( V_4 ) & V_84 ) && V_4 -> V_234 )
V_39 = V_4 -> V_234 ( V_2 , V_4 ) ;
F_45 ( V_2 , V_4 ) ;
return V_39 ;
}
static void F_73 ( struct V_235 * V_236 )
{
struct V_5 * V_6 ;
struct V_1 * V_2 ;
V_6 = V_236 -> V_237 ;
...
static int F_75 ( struct V_64 * V_64 , struct V_235 * V_238 )
{
const unsigned V_19 = F_32 ( V_64 -> V_66 -> V_67 ) ;
struct V_5 * V_6 = NULL ;
unsigned long V_239 = V_238 -> V_240 ;
unsigned long V_28 ;
int V_241 ;
int V_78 ;
int V_8 ;
...
static unsigned int F_79 ( struct V_64 * V_64 , T_4 * V_252 )
{
...
V_69 = F_6 ( V_68 ) ;
if ( V_69 ) {
F_80 ( V_64 , & V_69 -> V_6 -> V_253 , V_252 ) ;
if ( ! V_69 -> V_11
|| F_81 ( V_69 -> V_6 ) > 0
|| ! ( F_37 ( V_69 ) &
V_84 ) ) {
...
V_70 = F_14 ( V_68 ) ;
if ( V_70 ) {
F_80 ( V_64 , & V_70 -> V_6 -> V_253 , V_252 ) ;
F_46 ( V_70 -> V_6 ,
V_70 -> V_6 -> V_21 ) ;
if ( ! V_70 -> V_11
|| ! ( F_37 ( V_70 ) &
...
V_134 = V_258 ;
V_260 = V_134 ;
if ( V_6 -> V_119 + V_260 > V_6 -> V_21 )
V_260 = V_6 -> V_21 - V_6 -> V_119 ;
F_46 ( V_6 , V_6 -> V_21 ) ;
if ( V_260 > F_82 ( V_6 ) )
V_260 = F_82 ( V_6 ) ;
if ( V_260 < V_134 )
...
F_87 ( V_267 ) ;
F_89 ( & V_6 -> V_253 , & V_252 ) ;
V_218:
return V_32 ? V_32 : V_8 ;
}
static T_1 F_90 ( struct V_64 * V_64 , char T_3 * V_25 , T_2 V_258 ,
T_5 * V_259 )
{
struct V_3 * V_4 ;
struct V_5 * V_6 ;
...
V_134 = V_258 ;
V_260 = F_81 ( V_6 ) ;
if ( V_6 -> V_120 + V_260 > V_6 -> V_21 )
V_260 = V_6 -> V_21 - V_6 -> V_120 ;
if ( V_260 < V_134 )
V_134 = V_260 ;
if ( V_134 == 0 ) {
if ( ! ( F_37 ( V_4 ) & V_84 ) ) {
...
F_64 ( V_6 ) ;
V_6 -> V_177 = NULL ;
F_39 ( V_6 -> V_197 . V_199 ) ;
V_6 -> V_197 . V_199 = NULL ;
} else {
F_91 ( V_2 -> V_268 ,
L_39 ) ;
}
...
static int F_92 ( struct V_269 * V_269 , struct V_64 * V_64 )
{
const unsigned V_19 = F_32 ( V_269 ) ;
struct V_26 * V_68 =
F_33 ( V_19 ) ;
struct V_1 * V_2 =
V_68 ? V_68 -> V_22 : NULL ;
...
#ifdef F_93
F_8 ( & V_2 -> V_29 ) ;
F_94 ( L_42 , V_273 , V_2 -> V_19 ) ;
F_7 ( & V_2 -> V_29 ) ;
#endif
V_2 -> V_272 = 0 ;
if ( ! V_2 -> V_43 && ! F_19 ( V_271 ) ) {
F_2 ( L_43 ) ;
F_8 ( & V_2 -> V_29 ) ;
return - V_200 ;
}
...
if ( V_2 -> V_43 && V_2 -> V_275 == 0 && V_2 -> V_276 ) {
int V_215 = V_2 -> V_276 ( V_2 ) ;
if ( V_215 < 0 ) {
F_22 ( V_2 -> V_46 -> V_44 ) ;
F_22 ( V_274 ) ;
F_8 ( & V_2 -> V_29 ) ;
...
static int F_96 ( struct V_269 * V_269 , struct V_64 * V_64 )
{
const unsigned V_19 = F_32 ( V_269 ) ;
struct V_3 * V_4 = NULL ;
int V_78 ;
...
if ( V_2 -> V_43 && V_2 -> V_275 == 1 && V_2 -> V_277 )
V_2 -> V_277 ( V_2 ) ;
F_22 ( V_274 ) ;
if ( V_2 -> V_43 )
F_22 ( V_2 -> V_46 -> V_44 ) ;
...
static int F_97 ( int V_279 , struct V_64 * V_64 , int V_280 )
{
const unsigned V_19 = F_32 ( V_64 -> V_66 -> V_67 ) ;
struct V_26 * V_68 ;
struct V_1 * V_2 ;
...
if ( V_2 == NULL )
return - V_200 ;
return F_98 ( V_279 , V_64 , V_280 , & V_2 -> V_281 ) ;
}
...
V_8 = F_104 ( F_105 ( V_273 , 0 ) ,
V_287 , L_47 ) ;
if ( V_8 )
return - V_181 ;
F_106 ( & V_288 , & V_289 ) ;
V_288 . V_290 = V_274 ;
F_107 ( & V_288 . V_291 , L_47 ) ;
if ( F_108 ( & V_288 , F_105 ( V_273 , 0 ) , V_287 ) ) {
F_109 ( F_105 ( V_273 , 0 ) ,
V_287 ) ;
return - V_181 ;
}
V_292 = F_110 ( V_274 , L_47 ) ;
if ( F_111 ( V_292 ) ) {
F_103 ( L_48 ) ;
F_112 ( & V_288 ) ;
F_109 ( F_105 ( V_273 , 0 ) ,
...
F_118 ( V_292 ) ;
F_112 ( & V_288 ) ;
F_109 ( F_105 ( V_273 , 0 ) , V_287 ) ;
F_119 () ;
}
void F_120 ( const struct V_1 * V_2 , const char * V_4 )
{
F_91 ( V_2 -> V_268 , L_49 , V_2 -> V_46 -> V_74 , V_4 ) ;
}
...
F_122 ( & V_6 -> V_253 ) ;
if ( V_4 -> V_30 & V_31 )
F_123 ( & V_2 -> V_281 , V_297 , V_298 ) ;
if ( V_4 -> V_30 & V_35 )
F_123 ( & V_2 -> V_281 , V_297 , V_299 ) ;
} else {
if ( V_6 -> V_300 )
...
V_27 -> V_22 -> V_19 = V_78 ;
V_303 = F_131 ( V_292 , V_217 ,
F_105 ( V_273 , V_78 ) , NULL , L_51 , V_78 ) ;
if ( ! F_111 ( V_303 ) )
V_27 -> V_22 -> V_268 = V_303 ;
F_132 ( V_303 , V_27 ) ;
return V_78 ;
}
...
V_27 -> V_76 = V_4 ;
V_194 ( & V_304 ) ;
for ( V_78 = V_305 ; V_78 < V_287 ; ++ V_78 ) {
if ( V_286 [ V_78 ] == NULL ) {
V_286 [ V_78 ] = V_27 ;
break;
}
...
V_4 -> V_19 = V_78 ;
V_303 = F_131 ( V_292 , V_2 -> V_268 ,
F_105 ( V_273 , V_78 ) , NULL , L_52 ,
...
if ( V_4 -> V_19 < 0 )
return;
F_117 ( V_4 -> V_19 >= V_287 ) ;
F_117 ( V_4 -> V_19 < V_305 ) ;
V_194 ( & V_304 ) ;
V_27 = V_286 [ V_4 -> V_19 ] ;
V_286 [ V_4 -> V_19 ] = NULL ;
F_130 ( & V_304 ) ;
if ( V_4 -> V_268 ) {
F_133 ( V_292 , F_105 ( V_273 , V_4 -> V_19 ) ) ;
V_4 -> V_268 = NULL ;
}
F_39 ( V_27 ) ;
}
