...
F_28 ( V_53 ) ;
F_39 ( & V_22 -> V_46 ) ;
for ( V_60 = 0 ; V_60 < F_40 ( & V_22 -> V_61 ) ; V_60 ++ )
V_22 -> V_62 [ V_60 ] = NULL ;
F_41 ( & V_22 -> V_61 , 0 ) ;
F_42 ( & V_22 -> V_46 ) ;
}
...
void F_47 ( struct V_52 * V_53 , int V_56 )
{
F_48 ( & V_53 -> V_37 . V_69 ) ;
F_49 ( V_53 -> V_37 . V_70 ) ;
V_53 -> V_37 . V_71 . V_72 &= V_73 ;
F_50 ( & V_53 -> V_37 . V_71 ) ;
F_51 ( V_53 -> V_63 -> V_74 . V_75 . V_76 ) ;
F_52 ( V_53 -> V_37 . V_49 ) ;
F_53 ( V_77 , & V_53 -> V_37 . V_59 -> V_78 ) ;
}
void F_54 ( struct V_52 * V_53 )
{
F_55 ( V_77 , & V_53 -> V_37 . V_59 -> V_78 ) ;
F_56 ( V_53 -> V_37 . V_49 ) ;
F_48 ( & V_53 -> V_37 . V_71 ) ;
F_49 ( V_53 -> V_63 -> V_74 . V_75 . V_76 ) ;
F_50 ( & V_53 -> V_37 . V_69 ) ;
F_51 ( V_53 -> V_37 . V_70 ) ;
}
static void F_57 ( struct V_52 * V_53 )
{
...
F_53 ( V_87 , & V_53 -> V_37 . V_59 -> V_78 ) ;
}
int F_59 ( struct V_52 * V_53 )
{
return 0 ;
}
int F_60 ( struct V_52 * V_53 )
{
F_41 ( & V_53 -> V_37 . V_59 -> V_78 , V_88 |
V_89 |
V_87 ) ;
V_53 -> V_37 . V_59 -> V_90 = 6 ;
V_53 -> V_37 . V_59 -> V_91 = 0xC1002001U ;
V_53 -> V_37 . V_59 -> V_92 = ( int ) ( long ) V_93 ;
F_61 ( & V_53 -> V_37 . V_94 , V_95 , V_96 ) ;
F_62 ( & V_53 -> V_37 . V_97 , V_98 ,
( unsigned long ) V_53 ) ;
V_53 -> V_37 . V_94 . V_99 = V_100 ;
F_63 ( & V_53 -> V_37 . V_101 ) ;
V_53 -> V_37 . V_101 . V_102 = 0xff ;
return 0 ;
}
struct V_52 * F_64 ( struct V_22 * V_22 ,
unsigned int V_103 )
{
struct V_52 * V_53 ;
int V_31 = - V_9 ;
...
goto V_104;
V_31 = - V_36 ;
V_53 = F_65 ( sizeof( struct V_52 ) , V_40 ) ;
if ( ! V_53 )
goto V_104;
...
F_67 ( 63 - V_103 , ( unsigned long * ) & V_22 -> V_37 . V_38 -> V_55 ) ;
}
...
F_69 ( & V_53 -> V_37 . V_111 . V_112 ) ;
V_53 -> V_37 . V_111 . V_78 = & V_53 -> V_37 . V_59 -> V_78 ;
F_70 ( & V_22 -> V_37 . V_45 . V_46 ) ;
V_31 = F_71 ( V_53 , V_22 , V_103 ) ;
if ( V_31 )
goto V_113;
F_24 ( V_22 , 3 , L_5 , V_103 , V_53 ,
V_53 -> V_37 . V_59 ) ;
F_72 ( V_103 , V_53 , V_53 -> V_37 . V_59 ) ;
return V_53 ;
V_113:
F_27 ( ( unsigned long ) ( V_53 -> V_37 . V_59 ) ) ;
V_106:
...
switch ( V_115 -> V_103 ) {
case V_116 :
V_11 = F_78 ( V_53 -> V_37 . V_59 -> V_84 ,
( V_117 T_1 * ) V_115 -> V_81 ) ;
break;
case V_118 :
V_11 = F_78 ( V_53 -> V_37 . V_59 -> V_119 ,
( V_120 T_1 * ) V_115 -> V_81 ) ;
break;
case V_121 :
V_11 = F_78 ( V_53 -> V_37 . V_59 -> V_82 ,
( V_120 T_1 * ) V_115 -> V_81 ) ;
break;
case V_122 :
V_11 = F_78 ( V_53 -> V_37 . V_59 -> V_83 ,
( V_120 T_1 * ) V_115 -> V_81 ) ;
break;
default:
break;
...
switch ( V_115 -> V_103 ) {
case V_116 :
V_11 = F_80 ( V_53 -> V_37 . V_59 -> V_84 ,
( V_117 T_1 * ) V_115 -> V_81 ) ;
break;
case V_118 :
V_11 = F_80 ( V_53 -> V_37 . V_59 -> V_119 ,
( V_120 T_1 * ) V_115 -> V_81 ) ;
break;
case V_121 :
V_11 = F_80 ( V_53 -> V_37 . V_59 -> V_82 ,
( V_120 T_1 * ) V_115 -> V_81 ) ;
break;
case V_122 :
V_11 = F_80 ( V_53 -> V_37 . V_59 -> V_83 ,
( V_120 T_1 * ) V_115 -> V_81 ) ;
break;
default:
break;
...
int F_86 ( struct V_52 * V_53 , struct V_128 * V_129 )
{
...
int F_87 ( struct V_52 * V_53 , struct V_128 * V_129 )
{
memcpy ( & V_129 -> V_130 , & V_53 -> V_37 . V_71 . V_130 , sizeof( V_129 -> V_130 ) ) ;
V_129 -> V_72 = V_53 -> V_37 . V_71 . V_72 ;
return 0 ;
}
static int F_88 ( struct V_52 * V_53 , T_2 V_131 )
{
int V_31 = 0 ;
if ( ! ( F_40 ( & V_53 -> V_37 . V_59 -> V_78 ) & V_87 ) )
V_31 = - V_132 ;
else {
...
int F_90 ( struct V_52 * V_53 ,
struct V_137 * V_138 )
{
return - V_9 ;
}
int F_91 ( struct V_52 * V_53 ,
struct V_139 * V_140 )
{
return - V_9 ;
}
...
F_101 () ;
F_29 ( V_53 , 6 , L_6 ,
F_40 ( & V_53 -> V_37 . V_59 -> V_78 ) ) ;
F_102 ( V_53 ,
F_40 ( & V_53 -> V_37 . V_59 -> V_78 ) ) ;
V_31 = F_103 ( V_53 -> V_37 . V_59 , V_53 -> V_63 -> V_74 . V_75 . V_124 ) ;
if ( V_31 ) {
if ( F_31 ( V_53 -> V_22 ) ) {
V_31 = V_144 ;
} else {
...
F_106 ( V_53 , V_53 -> V_37 . V_59 -> V_143 ) ;
F_107 () ;
memcpy ( & V_53 -> V_63 -> V_74 . V_75 . V_124 [ 14 ] , & V_53 -> V_37 . V_59 -> V_141 , 16 ) ;
return V_31 ;
}
int F_108 ( struct V_52 * V_53 , struct V_146 * V_146 )
{
int V_31 ;
T_3 V_147 ;
V_148:
if ( V_53 -> V_149 )
F_109 ( V_150 , & V_53 -> V_151 , & V_147 ) ;
F_55 ( V_87 , & V_53 -> V_37 . V_59 -> V_78 ) ;
F_110 ( V_53 -> V_22 -> V_37 . V_45 . V_111 [ V_53 -> V_54 ] == NULL ) ;
switch ( V_146 -> V_152 ) {
case V_153 :
case V_154 :
case V_155 :
...
if ( V_146 -> V_158 & V_65 ) {
V_146 -> V_158 &= ~ V_65 ;
F_58 ( V_53 , V_146 -> V_74 . V_75 . V_159 ) ;
}
if ( V_146 -> V_158 & V_68 ) {
V_146 -> V_158 &= ~ V_68 ;
...
if ( V_53 -> V_149 )
F_109 ( V_150 , & V_147 , NULL ) ;
V_53 -> V_172 . V_173 ++ ;
return V_31 ;
}
static int F_114 ( struct V_52 * V_53 , V_120 V_174 , void * V_175 ,
unsigned long V_176 , int V_159 )
{
if ( V_159 )
return F_115 ( V_53 , V_174 , V_175 , V_176 ) ;
else
return F_116 ( V_53 , V_174 , V_175 , V_176 ) ;
}
int F_117 ( struct V_52 * V_53 , unsigned long V_81 )
{
unsigned char V_177 = 1 ;
int V_159 ;
if ( V_81 == V_178 ) {
if ( F_116 ( V_53 , 163ul , & V_177 , 1 ) )
return - V_29 ;
V_81 = V_179 ;
V_159 = 0 ;
} else if ( V_81 == V_180 ) {
if ( F_115 ( V_53 , 163ul , & V_177 , 1 ) )
return - V_29 ;
V_81 = V_179 ;
V_159 = 1 ;
} else
V_159 = 0 ;
if ( F_114 ( V_53 , V_81 + F_118 ( struct V_181 , V_182 ) ,
V_53 -> V_37 . V_71 . V_130 , 128 , V_159 ) )
return - V_29 ;
if ( F_114 ( V_53 , V_81 + F_118 ( struct V_181 , V_183 ) ,
V_53 -> V_63 -> V_74 . V_75 . V_124 , 128 , V_159 ) )
return - V_29 ;
if ( F_114 ( V_53 , V_81 + F_118 ( struct V_181 , V_131 ) ,
& V_53 -> V_37 . V_59 -> V_79 , 16 , V_159 ) )
return - V_29 ;
if ( F_114 ( V_53 , V_81 + F_118 ( struct V_181 , V_184 ) ,
& V_53 -> V_37 . V_59 -> V_159 , 4 , V_159 ) )
return - V_29 ;
if ( F_114 ( V_53 ,
V_81 + F_118 ( struct V_181 , V_185 ) ,
& V_53 -> V_37 . V_71 . V_72 , 4 , V_159 ) )
return - V_29 ;
if ( F_114 ( V_53 , V_81 + F_118 ( struct V_181 , V_186 ) ,
& V_53 -> V_37 . V_59 -> V_84 , 4 , V_159 ) )
return - V_29 ;
if ( F_114 ( V_53 , V_81 + F_118 ( struct V_181 , V_187 ) ,
& V_53 -> V_37 . V_59 -> V_82 , 8 , V_159 ) )
return - V_29 ;
if ( F_114 ( V_53 , V_81 + F_118 ( struct V_181 , V_188 ) ,
& V_53 -> V_37 . V_59 -> V_83 , 8 , V_159 ) )
return - V_29 ;
if ( F_114 ( V_53 , V_81 + F_118 ( struct V_181 , V_189 ) ,
& V_53 -> V_63 -> V_74 . V_75 . V_76 , 64 , V_159 ) )
return - V_29 ;
if ( F_114 ( V_53 ,
V_81 + F_118 ( struct V_181 , V_190 ) ,
& V_53 -> V_37 . V_59 -> V_85 , 128 , V_159 ) )
return - V_29 ;
return 0 ;
}
long F_119 ( struct V_4 * V_5 ,
unsigned int V_6 , unsigned long V_7 )
{
...
break;
if ( V_6 == V_194 )
V_11 = F_79 ( V_53 , & V_115 ) ;
else
V_11 = F_77 ( V_53 , & V_115 ) ;
break;
}
#ifdef F_11
case V_196 : {
...
V_11 = F_121 ( V_53 -> V_37 . V_49 , V_198 . V_199 ,
...
V_11 = F_122 ( V_53 -> V_37 . V_49 , V_198 . V_200 ,
V_198 . V_201 ) ;
break;
}
#endif
case V_203 : {
V_11 = F_123 ( V_7 , V_53 -> V_37 . V_49 ) ;
if ( ! F_124 ( V_11 ) )
V_11 = 0 ;
break;
}
...
int F_125 ( struct V_52 * V_53 , struct V_204 * V_205 )
{
#ifdef F_11
if ( ( V_205 -> V_206 == V_207 )
&& ( F_31 ( V_53 -> V_22 ) ) ) {
V_205 -> V_208 = F_126 ( V_53 -> V_37 . V_59 ) ;
F_127 ( V_205 -> V_208 ) ;
return 0 ;
}
#endif
...
void F_128 ( struct V_210 * free ,
struct V_210 * V_211 )
{
}
int F_129 ( struct V_210 * V_212 , unsigned long V_213 )
{
return 0 ;
}
int F_130 ( struct V_22 * V_22 ,
struct V_210 * V_214 ,
struct V_210 V_215 ,
struct V_216 * V_217 ,
int V_218 )
...
void F_131 ( struct V_22 * V_22 ,
struct V_216 * V_217 ,
struct V_210 V_215 ,
int V_218 )
{
int V_31 ;
V_31 = F_121 ( V_22 -> V_37 . V_49 , V_217 -> V_220 ,
...
{
int V_223 ;
V_223 = F_136 ( NULL , sizeof( struct V_52 ) , 0 , V_224 ) ;
if ( V_223 )
return V_223 ;
