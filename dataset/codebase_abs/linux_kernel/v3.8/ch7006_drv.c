...
V_118 -> V_130 -> V_131 ( & V_129 ) ;
}
}
return 0 ;
}
static int F_41 ( struct V_11 * V_12 , const struct V_132 * V_133 )
{
T_1 V_134 = V_135 ;
T_1 V_116 ;
int V_136 ;
F_10 ( V_12 , L_1 ) ;
V_136 = F_42 ( V_12 , & V_134 , sizeof( V_134 ) ) ;
if ( V_136 < 0 )
goto V_137;
V_136 = F_43 ( V_12 , & V_116 , sizeof( V_116 ) ) ;
if ( V_136 < 0 )
goto V_137;
F_44 ( V_12 , L_3 , V_116 ) ;
F_28 ( V_12 , 0x3d , 0x0 ) ;
...
static int F_47 ( struct V_139 * V_7 )
{
...
V_5 -> V_106 = 50 ;
V_5 -> V_15 = - 1 ;
V_5 -> V_148 = F_30 ( V_12 , V_135 ) ;
if ( V_149 ) {
for ( V_141 = 0 ; V_141 < V_99 ; V_141 ++ ) {
if ( ! strcmp ( V_100 [ V_141 ] , V_149 ) ) {
V_5 -> V_26 = V_141 ;
break;
}
}
