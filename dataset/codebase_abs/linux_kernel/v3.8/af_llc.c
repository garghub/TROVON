...
V_137 = F_74 ( V_9 , V_83 & V_140 , V_128 ) ;
V_133 = 0 ;
do {
T_5 V_141 ;
if ( F_55 ( V_92 ) ) {
...
if ( V_133 >= V_137 && ! V_9 -> V_143 . V_144 )
break;
if ( V_133 ) {
if ( V_9 -> V_145 ||
V_9 -> V_80 == V_89 ||
...
F_63 ( V_9 , & V_90 ) ;
if ( ( V_83 & V_139 ) && V_134 != V_21 -> V_138 ) {
F_76 ( L_7 ,
V_92 -> V_147 ,
F_77 ( V_92 ) ) ;
V_134 = V_21 -> V_138 ;
...
continue;
V_142:
V_136 = V_18 -> V_128 - V_141 ;
if ( V_128 < V_136 )
V_136 = V_128 ;
if ( ! ( V_83 & V_148 ) ) {
int V_10 = F_78 ( V_18 , V_141 ,
V_110 -> V_149 , V_136 ) ;
if ( V_10 ) {
if ( ! V_133 )
V_133 = - V_150 ;
...
goto V_151;
if ( ! ( V_83 & V_139 ) ) {
F_79 ( & V_9 -> V_124 . V_152 , V_132 ) ;
F_80 ( V_9 , V_18 , false ) ;
F_81 ( & V_9 -> V_124 . V_152 , V_132 ) ;
* V_135 = 0 ;
}
if ( V_136 + V_141 < V_18 -> V_128 )
continue;
} while ( V_128 > 0 );
V_43:
F_28 ( V_9 ) ;
...
F_85 ( V_18 , V_156 ) ;
V_10 = F_86 ( F_87 ( V_18 , V_133 ) , V_110 -> V_149 , V_133 ) ;
if ( V_10 )
goto V_43;
