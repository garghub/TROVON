...
static inline void F_79 ( struct V_12 * V_13 )
{
F_80 ( V_118 , F_75 , V_13 ) ;
F_77 ( V_118 ) ;
F_78 ( V_118 , 0 ) ;
}
...
static int F_87 ( struct V_126 * V_127 , const struct V_128 * V_129 )
{
F_84 ( & V_127 -> V_13 ) ;
if ( F_88 ( V_127 , 0 ) == 0x70 && ! F_89 ( V_127 , 0 ) )
return F_46 ( & V_127 -> V_13 ,
F_90 ( V_127 , V_130 , 0 ) , 8 ) ;
else
return F_46 ( & V_127 -> V_13 ,
F_90 ( V_127 , V_130 , 0 ) ,
F_91 ( V_127 , 0 ) ) ;
}
static void T_8 F_92 ( struct V_126 * V_127 )
{
F_66 ( & V_127 -> V_13 ) ;
}
static int F_93 ( struct V_126 * V_127 , T_10 V_131 )
{
return F_68 ( & V_127 -> V_13 ) ;
}
static int F_94 ( struct V_126 * V_127 )
{
...
static T_11 void F_96 ( struct V_134 * V_135 )
{
...
if ( ! V_137 )
return;
V_11 = F_97 ( V_137 , L_31 , NULL ) ;
if ( V_11 )
F_30 ( F_98 ( V_11 ) , V_33 ) ;
V_11 = F_97 ( V_137 , L_32 , NULL ) ;
if ( V_11 )
F_30 ( F_98 ( V_11 ) , V_103 ) ;
F_17 ( & time ) ;
V_139 = F_99 ( & time ) ;
if ( V_139 ) {
struct V_14 V_140 = {
...
static inline void F_96 ( struct V_134 * V_135 ) {}
static int T_11 F_100 ( struct V_134 * V_135 )
{
F_96 ( V_135 ) ;
F_84 ( & V_135 -> V_13 ) ;
...
static int T_8 F_103 ( struct V_134 * V_135 )
{
F_66 ( & V_135 -> V_13 ) ;
return 0 ;
}
static void F_104 ( struct V_134 * V_135 )
{
