...
continue;
#ifdef F_15
V_14 = F_10 ( V_51 -> V_64 , V_51 ,
V_68 , 0 ,
& V_64 ) ;
#else
V_14 = F_5 ( V_51 -> V_64 , V_51 ,
V_68 , 0 , 0 ,
& V_64 ) ;
#endif
if ( V_14 != V_21 )
...
continue;
V_77:
F_6 ( V_6 -> V_18 -> V_25 , V_66 ) ;
}
V_62:
F_6 ( V_6 -> V_18 -> V_25 , V_52 ) ;
return V_14 ;
}
static T_2 F_16 ( struct V_86 * V_87 , T_8 * V_88 ,
unsigned long V_26 )
{
...
F_13 ( V_93 . V_134 , & V_87 -> V_125 , & V_87 -> V_124 ) ;
F_13 ( V_93 . V_135 , & V_87 -> V_127 ,
& V_87 -> V_126 ) ;
F_13 ( V_93 . V_136 , & V_87 -> V_129 , & V_87 -> V_128 ) ;
F_13 ( V_93 . V_137 , & V_87 -> V_131 ,
& V_87 -> V_130 ) ;
...
V_87 -> V_139 |= V_140 ;
V_62:
F_6 ( V_6 -> V_18 -> V_25 , V_95 ) ;
return V_14 ;
}
static T_2 F_17 ( struct V_86 * V_87 , T_8 * V_141 ,
unsigned long V_26 )
{
...
F_4 ( V_6 -> V_18 -> V_67 ,
V_148 , & V_147 , & V_152 ) ;
V_14 = F_5 ( V_143 -> V_153 , V_143 , & V_149 , & V_63 ,
& V_150 , & V_151 ) ;
...
V_87 -> V_131 = 24 ;
V_62:
F_6 ( V_6 -> V_18 -> V_25 , V_146 ) ;
return V_14 ;
}
void F_18 ( struct V_49 * V_49 )
{
T_8 V_154 = V_155 ;
struct V_86 * V_87 ;
T_8 V_141 = V_156 ;
...
NULL , & V_26 , V_146 ) ;
if ( V_14 == V_24 )
F_17 ( V_87 , & V_141 , V_26 ) ;
}
}
static T_2 F_19 ( T_11 * V_157 ,
struct V_158 * V_58 )
{
struct V_159 * V_160 ;
unsigned long V_161 ;
...
V_14 = F_5 ( V_166 -> V_180 , V_166 , & V_63 , V_171 ,
V_181 , ( T_5 ) 0 ) ;
if ( V_14 != V_21 ) {
F_1 ( L_5 ) ;
goto V_182;
...
V_159 -> V_148 = V_63 ;
V_172 = 0 ;
V_14 = F_10 ( V_63 -> V_183 , V_63 , & V_173 ,
& V_172 , NULL ) ;
if ( V_14 != V_24 ) {
F_1 ( L_6 ) ;
goto V_182;
...
F_6 ( V_166 -> V_191 , V_160 [ V_168 ] . V_148 ) ;
}
}
F_6 ( V_6 -> V_18 -> V_25 , V_160 ) ;
V_58 -> V_192 = V_161 ;
V_58 -> V_193 = V_164 ;
return V_14 ;
V_188:
...
F_6 ( V_166 -> V_191 , V_160 [ V_169 ] . V_148 ) ;
V_178:
F_6 ( V_6 -> V_18 -> V_25 , V_160 ) ;
V_22:
V_58 -> V_192 = 0 ;
...
struct V_49 * F_20 ( void * V_148 , T_16 * V_194 )
{
struct V_49 * V_49 ;
struct V_195 * V_196 ;
struct V_197 * V_198 ;
...
V_14 = F_11 ( 0x4000 , 1 , ( unsigned long * ) & V_49 ) ;
if ( V_14 != V_21 ) {
F_1 ( L_13 ) ;
return NULL ;
}
...
V_14 = F_19 ( V_157 , V_58 ) ;
if ( V_14 != V_21 )
goto V_220;
return V_49 ;
V_220:
if ( V_204 )
F_12 ( V_204 , V_58 -> V_170 ) ;
V_22:
F_12 ( 0x4000 , ( unsigned long ) V_49 ) ;
return NULL ;
}
static T_2 F_21 ( struct V_49 * V_49 ,
void * V_148 )
{
...
V_26 += sizeof( * V_225 ) ;
V_224 = V_26 ;
V_14 = F_11 ( V_26 , 1 , ( unsigned long * ) & V_225 ) ;
if ( V_14 != V_21 )
return V_14 ;
V_14 = F_5 ( V_6 -> V_18 -> V_23 , & V_26 ,
V_225 , & V_15 , & V_12 , & V_16 ) ;
if ( V_14 == V_24 ) {
F_12 ( V_224 , ( unsigned long ) V_225 ) ;
goto V_17;
}
if ( V_14 != V_21 )
goto V_227;
memcpy ( & V_200 -> V_228 , V_229 , sizeof( T_17 ) ) ;
V_200 -> V_230 = ( unsigned long ) V_6 ;
V_200 -> V_231 = V_12 ;
V_200 -> V_232 = V_16 ;
V_200 -> V_233 = ( unsigned long ) V_225 ;
V_200 -> V_234 = V_26 ;
#ifdef F_15
V_200 -> V_235 = ( unsigned long ) V_6 >> 32 ;
V_200 -> V_236 = ( unsigned long ) V_225 >> 32 ;
#endif
V_14 = F_2 ( V_6 -> V_18 -> V_237 ,
V_148 , V_15 ) ;
if ( V_14 != V_21 )
goto V_227;
V_49 -> V_238 = 32 * 1024 ;
...
if ( V_223 && V_223 -> type == V_240 &&
( V_223 -> V_28 + V_223 -> V_26 ) == V_239 -> V_39 )
V_223 -> V_26 += V_239 -> V_38 << 12 ;
else {
V_222 -> V_28 = V_239 -> V_39 ;
V_222 -> V_26 = V_239 -> V_38 << 12 ;
V_222 -> type = V_240 ;
V_223 = V_222 ++ ;
V_226 ++ ;
}
...
static T_2 F_22 ( struct V_158 * V_58 )
{
unsigned long V_35 , V_30 ;
T_2 V_14 ;
V_35 = V_58 -> V_259 ;
V_30 = F_8 ( V_58 -> V_260 , V_33 ) / V_33 ;
V_14 = F_10 ( V_6 -> V_18 -> V_42 ,
V_43 , V_20 ,
V_30 , & V_35 ) ;
if ( V_14 != V_21 ) {
V_14 = F_11 ( V_58 -> V_260 , V_58 -> V_261 ,
& V_35 ) ;
if ( V_14 != V_21 )
F_1 ( L_15 ) ;
}
...
V_58 -> V_260 ) ;
V_58 -> V_259 = V_58 -> V_215 ;
V_58 -> V_215 = ( T_17 ) V_35 ;
return V_14 ;
}
struct V_49 * F_23 ( void * V_148 , T_16 * V_194 ,
struct V_49 * V_49 )
{
...
V_263 -> V_26 = 0x800 ;
V_14 = F_11 ( V_263 -> V_26 , 8 , ( unsigned long * ) & V_263 -> V_266 ) ;
if ( V_14 != V_21 ) {
F_1 ( L_17 ) ;
goto V_22;
}
...
V_264 -> V_26 = 0 ;
V_264 -> V_266 = 0 ;
if ( V_58 -> V_259 != V_58 -> V_215 ) {
V_14 = F_22 ( V_58 ) ;
if ( V_14 != V_21 )
goto V_22;
}
V_14 = F_21 ( V_49 , V_148 ) ;
if ( V_14 != V_21 )
goto V_22;
memset ( ( char * ) V_263 -> V_266 , 0x0 , V_263 -> V_26 ) ;
V_34 = (struct V_265 * ) V_263 -> V_266 ;
V_34 += 2 ;
V_34 -> V_267 = 0xffff ;
V_34 -> V_268 = 0x0000 ;
V_34 -> V_269 = 0x0000 ;
V_34 -> type = V_270 | V_271 ;
V_34 -> V_272 = V_273 ;
V_34 -> V_274 = 0 ;
V_34 -> V_175 = 1 ;
V_34 -> V_275 = 0xf ;
