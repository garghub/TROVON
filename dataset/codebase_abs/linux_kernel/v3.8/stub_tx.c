...
if ( F_26 ( V_3 -> V_25 ) == V_56 )
V_55 = 2 + V_3 -> V_57 ;
else
V_55 = 2 ;
V_54 = F_7 ( V_55 * sizeof( struct V_53 ) , V_58 ) ;
if ( ! V_54 ) {
F_9 ( & V_9 -> V_17 , V_59 ) ;
return - 1 ;
}
...
V_47 += sizeof( V_50 ) ;
V_49 = F_30 ( V_9 -> V_17 . V_68 , & V_46 , V_54 ,
1 , V_47 ) ;
if ( V_49 != V_47 ) {
F_8 ( & V_9 -> V_15 -> V_16 ,
L_14 ,
