...
{
const struct V_19 * V_20 = V_6 -> V_8 -> V_20 ;
V_20 -> V_55 ( V_6 , true , V_6 -> V_57 ? V_6 -> V_57 -> V_93 . V_56 : 0 ) ;
F_35 ( & V_6 -> V_82 ) ;
F_32 ( & V_6 -> V_52 ) ;
F_36 ( & V_6 -> V_12 ) ;
F_33 ( V_6 -> V_58 , V_72 ) ;
...
int F_37 ( struct V_59 * V_60 , unsigned int V_61 )
{
struct V_62 * V_8 = V_60 -> V_63 ;
const struct V_19 * V_20 = V_8 -> V_20 ;
struct V_69 * V_12 ;
...
F_38 ( V_97 L_12 , V_8 -> V_68 [ V_66 ] ) ;
F_38 ( V_97 L_13 ) ;
F_22 ( V_6 ) ;
return - V_22 ;
}
return F_19 ( V_6 , V_60 , V_8 -> V_98 [ V_61 ] ,
V_8 -> V_72 ) ;
}
int F_39 ( struct V_59 * V_60 , unsigned int V_61 )
{
struct V_5 * V_6 = F_40 ( V_60 ) ;
return F_34 ( V_6 , V_6 -> V_8 -> V_72 ) ;
}
int F_41 ( struct V_99 * V_61 , const struct V_100 * V_101 )
{
struct V_102 * V_103 = F_42 ( V_61 -> V_61 . V_7 ) ;
struct V_62 * V_8 = F_10 ( V_103 ,
struct V_62 , V_102 ) ;
struct V_5 * V_6 ;
if ( ! F_43 ( V_61 , 0 ) )
return - V_96 ;
...
if ( ! V_6 )
return - V_94 ;
V_6 -> V_58 = F_44 ( V_61 , 0 ) ;
return F_19 ( V_6 , & V_61 -> V_61 , V_8 -> V_98 [ 0 ] ,
F_45 ( V_61 , 0 ) ) ;
}
void F_46 ( struct V_99 * V_61 )
{
struct V_5 * V_6 = F_40 ( & V_61 -> V_61 ) ;
F_34 ( V_6 , F_45 ( V_61 , 0 ) ) ;
}
