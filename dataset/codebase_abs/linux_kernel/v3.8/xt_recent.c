...
static int F_51 ( const struct V_72 * V_39 )
{
...
static void F_53 ( const struct V_100 * V_39 )
{
struct V_1 * V_1 = F_1 ( V_39 -> V_2 ) ;
const struct V_42 * V_43 = V_39 -> V_44 ;
struct V_13 * V_21 ;
...
static void * F_55 ( struct V_101 * V_102 , T_6 * V_103 )
__acquires( V_58 )
{
...
static void * F_56 ( struct V_101 * V_102 , void * V_109 , T_6 * V_103 )
{
struct V_104 * V_105 = V_102 -> V_106 ;
const struct V_13 * V_21 = V_105 -> V_14 ;
...
static void F_57 ( struct V_101 * V_112 , void * V_109 )
__releases( V_58 )
{
F_30 ( & V_58 ) ;
}
static int F_58 ( struct V_101 * V_102 , void * V_109 )
{
const struct V_12 * V_18 = V_109 ;
unsigned int V_35 ;
...
for ( V_35 = 0 ; V_35 < V_18 -> V_32 ; V_35 ++ )
F_59 ( V_102 , L_6 , V_35 ? L_7 : L_8 , V_18 -> V_26 [ V_35 ] ) ;
F_59 ( V_102 , L_9 ) ;
return 0 ;
}
static int F_60 ( struct V_113 * V_113 , struct V_114 * V_114 )
{
struct V_73 * V_74 = F_61 ( V_113 ) ;
struct V_104 * V_105 ;
V_105 = F_62 ( V_114 , & V_115 , sizeof( * V_105 ) ) ;
if ( V_105 == NULL )
return - V_87 ;
V_105 -> V_14 = V_74 -> V_116 ;
return 0 ;
}
static T_7
F_63 ( struct V_114 * V_114 , const char T_8 * V_117 ,
T_5 V_118 , T_6 * V_119 )
{
const struct V_73 * V_74 = F_61 ( V_114 -> V_120 . V_121 -> V_122 ) ;
struct V_13 * V_21 = V_74 -> V_116 ;
struct V_12 * V_18 ;
char V_123 [ sizeof( L_10 ) ] ;
...
if ( V_118 == 0 )
return 0 ;
if ( V_118 > sizeof( V_123 ) )
V_118 = sizeof( V_123 ) ;
if ( F_64 ( V_123 , V_117 , V_118 ) != 0 )
return - V_127 ;
if ( * V_119 != 0 )
return - V_128 ;
switch ( * V_124 ) {
...
++ V_124 ;
-- V_118 ;
if ( F_65 ( V_124 , V_118 , ':' ) != NULL ) {
V_16 = V_129 ;
V_126 = F_66 ( V_124 , V_118 , ( void * ) & V_5 , '\n' , NULL ) ;
} else {
V_16 = V_20 ;
V_126 = F_67 ( V_124 , V_118 , ( void * ) & V_5 , '\n' , NULL ) ;
}
if ( ! V_126 ) {
F_38 ( L_12 ) ;
return - V_77 ;
