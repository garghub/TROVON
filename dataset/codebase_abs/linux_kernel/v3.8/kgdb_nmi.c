...
static int F_36 ( struct V_31 * V_32 , struct V_43 * V_43 )
{
struct V_14 * V_18 = V_32 -> V_35 ;
return F_37 ( & V_18 -> V_16 , V_32 , V_43 ) ;
}
static void F_38 ( struct V_31 * V_32 , struct V_43 * V_43 )
{
struct V_14 * V_18 = V_32 -> V_35 ;
F_39 ( & V_18 -> V_16 , V_32 , V_43 ) ;
}
...
static int F_43 ( struct V_31 * V_32 , const T_3 * V_44 , int V_4 )
{
int V_5 ;
for ( V_5 = 0 ; V_5 < V_4 ; V_5 ++ )
V_8 -> V_9 ( V_44 [ V_5 ] ) ;
...
static int F_44 ( int V_45 , const char * V_46 [] )
{
