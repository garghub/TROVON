...
F_69 ( V_206 -> V_223 , V_83 -> V_80 , V_83 -> V_222 , V_83 -> V_224 ,
& V_83 -> V_225 ) ;
V_83 -> V_222 = NULL ;
V_83 -> V_42 = NULL ;
V_83 -> V_41 = 0 ;
...
F_71 ( V_2 -> V_9 . V_103 , V_227 , sizeof( V_2 -> V_9 . V_103 ) ) ;
}
static int F_72 ( struct V_205 * V_206 )
{
int V_57 ;
F_6 ( L_27 ) ;
for ( V_57 = 0 ; V_57 < V_206 -> V_228 ; V_57 ++ ) {
struct V_1 * V_2 = V_206 -> V_229 [ V_57 ] ;
F_67 ( V_2 ) ;
F_70 ( V_2 ) ;
}
return 0 ;
...
V_222 = F_77 ( V_206 -> V_223 , V_80 , & V_224 ,
V_233 , & V_225 ) ;
if ( V_222 == NULL ) {
F_78 ( V_206 -> V_223 , L_29 ) ;
return - V_234 ;
}
F_6 ( L_30 ,
...
V_16 = F_79 ( & V_83 -> V_29 ) ;
if ( V_16 ) {
F_69 ( V_206 -> V_223 , V_80 , V_222 , V_224 ,
& V_225 ) ;
F_78 ( V_206 -> V_223 , L_31 ) ;
return V_16 ;
}
}
V_83 -> V_225 = V_225 ;
V_83 -> V_222 = V_222 ;
V_83 -> V_224 = V_224 ;
V_83 -> V_41 = ( unsigned long ) V_224 ;
V_83 -> V_42 = ( void T_1 * ) V_222 ;
V_83 -> V_80 = V_80 ;
V_83 -> V_226 = 1 ;
return 0 ;
}
...
if ( ! V_80 ) {
T_2 V_20 , V_22 ;
V_102 -> V_109 -> V_235 ( V_102 , & V_20 , & V_22 ) ;
if ( V_27 -> V_39 == V_40 ) {
...
static int F_83 ( const char * V_236 , int V_237 ,
...
static int F_87 ( struct V_205 * V_206 )
{
int V_57 , V_16 ;
unsigned long V_241 [ 10 ] ;
unsigned long V_242 [ 10 ] ;
memset ( & V_241 , 0 , sizeof( V_241 ) ) ;
memset ( & V_242 , 0 , sizeof( V_242 ) ) ;
if ( V_243 && F_83 ( V_243 , 10 ,
V_241 , V_242 ) ) {
F_78 ( V_206 -> V_223 , L_34 ) ;
memset ( & V_241 , 0 , sizeof( V_241 ) ) ;
memset ( & V_242 , 0 , sizeof( V_242 ) ) ;
}
for ( V_57 = 0 ; V_57 < V_206 -> V_228 ; V_57 ++ ) {
if ( V_57 == 0 || V_241 [ V_57 ] != 0 ) {
V_16 = F_80 ( V_206 -> V_229 [ V_57 ] ,
V_241 [ V_57 ] , V_242 [ V_57 ] ) ;
if ( V_16 )
return V_16 ;
}
}
for ( V_57 = 0 ; V_57 < V_206 -> V_228 ; V_57 ++ ) {
struct V_26 * V_27 = F_25 ( V_206 -> V_229 [ V_57 ] ) ;
struct V_82 * V_83 ;
V_83 = V_27 -> V_30 ;
F_6 ( L_35 ,
V_57 ,
...
if ( V_258 -> V_131 )
V_258 -> V_131 ( V_256 ) ;
V_258 -> V_235 ( V_256 , & V_20 , & V_22 ) ;
V_258 -> V_261 ( V_256 , 0 , 0 , V_20 , V_22 ) ;
V_259 = V_262 ;
if ( V_259 == 0 )
V_259 = 20 ;
F_94 ( V_206 -> V_263 ,
& V_208 -> V_260 , V_264 / V_259 ) ;
}
...
V_208 = F_63 ( V_206 , V_102 ) ;
F_96 ( & V_208 -> V_260 , F_92 ) ;
V_208 -> V_216 = true ;
F_92 ( & V_208 -> V_260 . V_255 ) ;
}
...
static int F_91 ( struct V_205 * V_206 , struct V_1 * V_2 )
{
struct V_6 * V_7 = & V_2 -> V_7 ;
struct V_101 * V_102 = F_32 ( V_2 ) ;
struct V_26 * V_27 = F_25 ( V_2 ) ;
...
if ( V_16 )
goto V_154;
V_16 = F_98 ( & V_2 -> V_200 , 256 , 0 ) ;
if ( V_16 )
F_78 ( V_206 -> V_223 , L_44 ) ;
V_154:
return V_16 ;
}
static void F_99 ( struct V_205 * V_206 , struct V_1 * V_2 )
{
F_100 ( & V_2 -> V_200 ) ;
}
static void F_101 ( struct V_205 * V_206 )
{
int V_57 ;
F_6 ( L_45 ) ;
if ( V_206 == NULL )
return;
for ( V_57 = 0 ; V_57 < V_206 -> V_228 ; V_57 ++ )
F_102 ( V_206 -> V_229 [ V_57 ] ) ;
F_72 ( V_206 ) ;
for ( V_57 = 0 ; V_57 < V_206 -> V_228 ; V_57 ++ ) {
F_99 ( V_206 , V_206 -> V_229 [ V_57 ] ) ;
F_103 ( V_206 -> V_229 [ V_57 ] ) ;
}
for ( V_57 = 0 ; V_57 < V_206 -> V_272 ; V_57 ++ ) {
struct V_101 * V_256 = V_206 -> V_273 [ V_57 ] . V_256 ;
if ( V_206 -> V_273 [ V_57 ] . V_216 )
F_65 ( V_206 , V_256 ) ;
if ( V_256 -> V_210 != V_274 )
V_256 -> V_109 -> V_221 ( V_256 ) ;
F_104 ( V_256 ) ;
}
if ( V_206 -> V_263 != NULL ) {
F_105 ( V_206 -> V_263 ) ;
...
F_70 ( V_2 ) ;
V_206 -> V_229 [ V_57 ] = V_2 ;
V_27 = F_25 ( V_2 ) ;
V_27 -> V_206 = V_206 ;
V_27 -> V_103 = V_57 ;
V_27 -> V_30 = & V_206 -> V_276 [ V_57 ] ;
V_27 -> V_30 -> V_103 = V_57 ;
F_110 ( & V_27 -> V_30 -> V_277 ) ;
V_27 -> V_39 = V_278 ? V_40 :
V_279 ;
V_27 -> V_153 = V_280 ;
V_206 -> V_228 ++ ;
}
F_6 ( L_48 ) ;
for ( V_57 = 0 ; V_57 < F_111 ( V_206 -> V_228 , V_206 -> V_105 ) ; V_57 ++ ) {
struct V_26 * V_27 = F_25 ( V_206 -> V_229 [ V_57 ] ) ;
...
F_48 ( V_27 -> V_30 ) ;
if ( V_16 ) {
F_78 ( V_206 -> V_223 , L_55 ) ;
return V_16 ;
}
}
if ( V_206 -> V_228 > 0 ) {
struct V_26 * V_27 = F_25 ( V_206 -> V_229 [ 0 ] ) ;
if ( V_27 -> V_105 > 0 ) {
...
static int F_113 ( const char * V_281 ,
struct V_101 * V_102 ,
struct V_115 * V_116 , T_3 * V_282 )
{
struct V_1 * V_2 ;
struct V_6 * V_7 ;
struct V_283 * V_267 ;
int V_16 ;
#ifdef F_114
if ( strcmp ( V_281 , L_58 ) == 0 ) {
* V_116 = V_284 ;
* V_282 = 24 ;
return 0 ;
} else if ( strcmp ( V_281 , L_59 ) == 0 ) {
* V_116 = V_285 ;
* V_282 = 24 ;
return 0 ;
}
...
V_7 = NULL ;
V_267 = NULL ;
V_2 = F_115 ( sizeof( * V_2 ) , V_233 ) ;
if ( V_2 == NULL ) {
V_16 = - V_234 ;
goto V_154;
}
V_7 = F_115 ( sizeof( * V_7 ) , V_233 ) ;
if ( V_7 == NULL ) {
V_16 = - V_234 ;
goto V_154;
}
V_267 = F_115 ( sizeof( * V_267 ) , V_233 ) ;
if ( V_267 == NULL ) {
V_16 = - V_234 ;
goto V_154;
}
V_2 -> V_267 = V_267 ;
V_16 = F_116 ( V_7 , V_2 , V_281 , NULL , 0 , NULL , 24 ) ;
if ( V_16 == 0 ) {
V_16 = - V_60 ;
goto V_154;
}
...
struct V_101 * V_102 , char * V_281 )
{
int V_16 ;
T_3 V_282 ;
struct V_115 V_116 , V_294 ;
struct V_207 * V_208 ;
V_16 = F_113 ( V_281 , V_102 , & V_116 , & V_282 ) ;
if ( V_16 )
return V_16 ;
V_208 = F_63 ( V_206 , V_102 ) ;
V_208 -> V_295 = V_282 ;
if ( V_102 -> V_109 -> V_296 ) {
V_16 = V_102 -> V_109 -> V_296 ( V_102 , & V_116 ) ;
if ( V_16 )
return V_16 ;
} else {
if ( V_102 -> V_109 -> V_114 ) {
V_102 -> V_109 -> V_114 ( V_102 , & V_294 ) ;
if ( V_294 . V_291 != V_116 . V_291 ||
V_294 . V_292 != V_116 . V_292 )
return - V_60 ;
}
}
if ( V_102 -> V_109 -> V_297 )
V_102 -> V_109 -> V_297 ( V_102 , & V_116 ) ;
return 0 ;
}
...
{
struct V_207 * V_208 ;
F_120 ( V_256 -> V_109 -> V_298 == NULL ) ;
V_208 = F_63 ( V_206 , V_256 ) ;
if ( V_208 -> V_295 != 0 )
return V_208 -> V_295 ;
return V_256 -> V_109 -> V_298 ( V_256 ) ;
}
static int F_121 ( struct V_205 * V_206 )
{
char * V_299 , * V_300 , * V_301 ;
int V_16 = 0 ;
V_299 = F_122 ( V_302 , V_233 ) ;
if ( ! V_299 )
return - V_234 ;
V_300 = V_299 ;
while ( ! V_16 && ( V_301 = F_123 ( & V_300 , L_60 ) ) != NULL ) {
char * V_19 , * V_303 , * V_281 ;
struct V_101 * V_102 ;
int V_57 ;
V_19 = strchr ( V_301 , ':' ) ;
if ( ! V_19 ) {
...
V_102 = NULL ;
for ( V_57 = 0 ; V_57 < V_206 -> V_272 ; ++ V_57 ) {
if ( strcmp ( V_206 -> V_273 [ V_57 ] . V_256 -> V_304 ,
V_303 ) == 0 ) {
V_102 = V_206 -> V_273 [ V_57 ] . V_256 ;
break;
}
}
if ( ! V_102 ) {
...
static void F_124 ( struct V_305 * V_59 ,
struct V_101 * V_102 ,
struct V_115 * V_24 )
{
if ( V_102 -> V_109 -> V_114 ) {
...
V_24 -> V_291 = V_59 -> V_75 ;
V_24 -> V_292 = V_59 -> V_76 ;
...
struct V_306 * V_307 ;
T_3 * V_308 ;
int V_16 , V_57 , V_309 , V_176 ;
if ( ! V_102 -> V_109 -> V_310 )
return - V_311 ;
V_176 = 0x80 * 2 ;
V_308 = F_126 ( V_176 , V_233 ) ;
if ( V_308 == NULL )
return - V_234 ;
V_16 = V_102 -> V_109 -> V_310 ( V_102 , V_308 , V_176 ) ;
if ( V_16 < 0 )
goto V_312;
V_307 = F_115 ( sizeof( * V_307 ) , V_233 ) ;
if ( V_307 == NULL ) {
V_16 = - V_234 ;
goto V_312;
}
F_127 ( V_308 , V_307 ) ;
V_309 = - 1 ;
for ( V_57 = 0 ; V_57 < V_307 -> V_313 ; ++ V_57 ) {
struct V_305 * V_59 ;
struct V_115 V_24 ;
V_59 = & V_307 -> V_314 [ V_57 ] ;
if ( V_59 -> V_117 == 0 )
continue;
...
V_16 = V_102 -> V_109 -> V_296 ( V_102 , & V_24 ) ;
if ( V_16 == 0 ) {
V_309 = V_57 ;
break;
}
...
struct V_207 * V_208 ;
int V_16 ;
V_16 = V_258 -> V_212 ( V_256 ) ;
if ( V_16 ) {
F_130 ( V_206 -> V_223 , L_61 ,
V_256 -> V_304 ) ;
return V_16 ;
}
V_208 = F_63 ( V_206 , V_256 ) ;
V_208 -> V_206 = V_206 ;
if ( V_256 -> V_166 & V_213 ) {
T_2 V_20 , V_22 ;
if ( V_317 ) {
F_64 ( V_206 , V_256 ) ;
V_208 -> V_214 = V_215 ;
...
if ( V_258 -> V_319 ) {
V_16 = V_258 -> V_319 ( V_256 , 1 ) ;
if ( V_16 ) {
F_78 ( V_206 -> V_223 , L_62 ) ;
return V_16 ;
}
}
V_258 -> V_235 ( V_256 , & V_20 , & V_22 ) ;
...
struct V_321 * V_322 ;
if ( ! V_320 -> V_323 ) {
F_78 ( V_206 -> V_223 , L_64 ) ;
return - V_60 ;
}
for ( V_57 = 0 ; V_57 < V_206 -> V_272 ; ++ V_57 ) {
struct V_101 * V_256 = V_206 -> V_273 [ V_57 ] . V_256 ;
struct V_324 * V_168 = V_256 -> V_323 ;
V_322 = F_132 ( V_256 -> V_325 ) ;
if ( ! V_322 || ! V_168 )
continue;
if ( V_322 -> V_323 )
V_322 -> V_326 ( V_322 ) ;
V_322 -> V_327 ( V_322 , V_168 ) ;
}
V_322 = V_320 -> V_323 -> V_164 ;
if ( ! V_322 ) {
F_78 ( V_206 -> V_223 , L_65 ) ;
return - V_60 ;
}
for ( V_57 = 0 ; V_57 < V_206 -> V_105 ; V_57 ++ ) {
struct V_144 * V_145 = V_206 -> V_106 [ V_57 ] ;
if ( V_145 -> V_164 )
V_145 -> V_328 ( V_145 ) ;
V_16 = V_145 -> V_329 ( V_145 , V_322 ) ;
if ( V_16 )
F_130 ( V_206 -> V_223 ,
L_66 ,
V_145 -> V_304 , V_322 -> V_304 ) ;
}
return 0 ;
}
static int T_7 F_133 ( struct V_330 * V_331 )
{
...
F_6 ( L_67 ) ;
if ( V_331 -> V_333 != 0 ) {
F_78 ( & V_331 -> V_223 , L_68 ) ;
V_16 = - V_311 ;
goto V_334;
}
V_206 = F_134 ( & V_331 -> V_223 , sizeof( struct V_205 ) ,
V_233 ) ;
if ( V_206 == NULL ) {
V_16 = - V_234 ;
goto V_334;
...
F_140 ( V_256 ) ;
if ( ! V_256 -> V_109 ) {
F_130 ( & V_331 -> V_223 , L_71 ,
V_256 -> V_304 ) ;
F_104 ( V_256 ) ;
continue;
}
V_208 = & V_206 -> V_273 [ V_206 -> V_272 ++ ] ;
V_208 -> V_256 = V_256 ;
if ( V_256 -> V_166 & V_213 )
V_208 -> V_214 = V_318 ;
else
...
if ( V_206 -> V_272 == 0 ) {
F_78 ( & V_331 -> V_223 , L_72 ) ;
V_16 = - V_60 ;
goto V_336;
}
V_206 -> V_105 = F_141 () ;
for ( V_57 = 0 ; V_57 < V_206 -> V_105 ; V_57 ++ )
V_206 -> V_106 [ V_57 ] = F_142 ( V_57 ) ;
V_206 -> V_337 = F_143 () ;
for ( V_57 = 0 ; V_57 < V_206 -> V_337 ; V_57 ++ )
V_206 -> V_338 [ V_57 ] = F_132 ( V_57 ) ;
V_332 = NULL ;
for ( V_57 = 0 ; V_57 < V_206 -> V_272 ; ++ V_57 ) {
struct V_101 * V_256 ;
const char * V_339 ;
V_339 = F_144 () ;
V_256 = V_206 -> V_273 [ V_57 ] . V_256 ;
if ( V_339 == NULL ||
( V_256 -> V_304 && strcmp ( V_339 , V_256 -> V_304 ) == 0 ) ) {
V_332 = V_256 ;
break;
}
}
if ( V_332 == NULL ) {
F_78 ( V_206 -> V_223 , L_73 ) ;
V_16 = - V_60 ;
goto V_336;
}
V_16 = F_131 ( V_206 , V_332 ) ;
if ( V_16 ) {
F_78 ( V_206 -> V_223 , L_74 ) ;
goto V_336;
}
if ( V_302 && strlen ( V_302 ) > 0 ) {
if ( F_121 ( V_206 ) )
F_130 ( & V_331 -> V_223 , L_75 ) ;
} else if ( V_332 && V_332 -> V_109 -> V_297 &&
V_332 -> V_109 -> V_296 ) {
struct V_115 V_24 ;
V_16 = F_125 ( V_332 , & V_24 ) ;
if ( V_16 == 0 )
V_332 -> V_109 -> V_297 ( V_332 , & V_24 ) ;
}
V_16 = F_108 ( V_206 ) ;
if ( V_16 )
goto V_336;
for ( V_57 = 0 ; V_57 < V_206 -> V_337 ; V_57 ++ ) {
struct V_321 * V_322 ;
V_322 = V_206 -> V_338 [ V_57 ] ;
V_16 = V_322 -> V_165 ( V_322 ) ;
if ( V_16 )
F_130 ( V_206 -> V_223 , L_76 ) ;
}
F_6 ( L_77 ) ;
if ( V_332 ) {
V_16 = F_129 ( V_206 , V_332 ) ;
if ( V_16 ) {
F_78 ( V_206 -> V_223 ,
L_78
L_79 ) ;
...
F_146 () ;
V_334:
F_78 ( & V_331 -> V_223 , L_82 ) ;
return V_16 ;
}
static int T_8 F_147 ( struct V_330 * V_331 )
{
struct V_205 * V_206 = F_148 ( V_331 ) ;
F_149 ( V_206 ) ;
F_101 ( V_206 ) ;
F_146 () ;
return 0 ;
