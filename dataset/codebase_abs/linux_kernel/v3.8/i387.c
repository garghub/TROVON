...
int F_37 ( struct V_5 * V_41 , const struct V_42 * V_43 )
{
return F_34 ( V_41 ) ? V_43 -> V_44 : 0 ;
}
int F_38 ( struct V_5 * V_41 , const struct V_42 * V_43 )
{
return ( V_11 && F_34 ( V_41 ) ) ? V_43 -> V_44 : 0 ;
}
int F_39 ( struct V_5 * V_41 , const struct V_42 * V_43 ,
unsigned int V_45 , unsigned int V_46 ,
void * V_47 , void T_2 * V_48 )
{
int V_38 ;
if ( ! V_11 )
return - V_49 ;
...
static inline unsigned short F_46 ( unsigned short V_36 )
{
unsigned int V_61 ;
V_61 = ~ V_36 ;
...
static inline T_3 F_47 ( struct V_13 * V_31 )
{
struct V_62 * V_63 ;
T_3 V_64 = ( V_31 -> V_35 >> 11 ) & 7 ;
T_3 V_36 = ( unsigned long ) V_31 -> V_36 ;
T_3 V_65 ;
T_3 V_38 = 0xffff0000u ;
int V_66 ;
for ( V_66 = 0 ; V_66 < 8 ; V_66 ++ , V_36 >>= 1 ) {
if ( V_36 & 0x1 ) {
V_63 = F_48 ( V_31 , ( V_66 - V_64 ) & 7 ) ;
...
void
F_49 ( struct V_73 * V_74 , struct V_5 * V_8 )
{
...
#else
V_74 -> V_79 = V_31 -> V_79 ;
V_74 -> V_83 = ( V_86 ) V_31 -> V_83 | ( ( T_3 ) V_31 -> V_87 << 16 ) ;
V_74 -> V_81 = V_31 -> V_81 ;
V_74 -> V_37 = V_31 -> V_37 ;
#endif
...
V_31 -> V_34 = V_74 -> V_34 ;
V_31 -> V_35 = V_74 -> V_35 ;
V_31 -> V_36 = F_46 ( V_74 -> V_36 ) ;
V_31 -> V_87 = ( V_86 ) ( ( T_3 ) V_74 -> V_83 >> 16 ) ;
#ifdef F_50
V_31 -> V_80 = V_74 -> V_79 ;
V_31 -> V_82 = V_74 -> V_81 ;
#else
...
int F_54 ( struct V_5 * V_41 , const struct V_42 * V_43 ,
unsigned int V_45 , unsigned int V_46 ,
void * V_47 , void T_2 * V_48 )
{
struct V_73 V_74 ;
...
return V_38 ;
if ( ! V_16 )
return F_55 ( V_41 , V_43 , V_45 , V_46 , V_47 , V_48 ) ;
if ( ! V_11 ) {
return F_41 ( & V_45 , & V_46 , & V_47 , & V_48 ,
...
F_49 ( & V_74 , V_41 ) ;
return F_41 ( & V_45 , & V_46 , & V_47 , & V_48 , & V_74 , 0 , - 1 ) ;
}
...
F_40 ( V_41 ) ;
if ( ! V_16 )
return F_57 ( V_41 , V_43 , V_45 , V_46 , V_47 , V_48 ) ;
if ( ! V_11 ) {
return F_43 ( & V_45 , & V_46 , & V_47 , & V_48 ,
& V_41 -> V_39 . V_28 . V_29 -> V_33 , 0 , - 1 ) ;
}
if ( V_45 > 0 || V_46 < sizeof( V_74 ) )
F_49 ( & V_74 , V_41 ) ;
V_38 = F_43 ( & V_45 , & V_46 , & V_47 , & V_48 , & V_74 , 0 , - 1 ) ;
if ( ! V_38 )
F_53 ( V_41 , & V_74 ) ;
if ( V_51 )
V_41 -> V_39 . V_28 . V_29 -> V_52 . V_53 . V_54 |= V_88 ;
return V_38 ;
}
int F_58 ( struct V_3 * V_4 , struct V_89 * V_28 )
{
struct V_5 * V_8 = V_1 ;
int V_90 ;
V_90 = ! ! F_59 () ;
