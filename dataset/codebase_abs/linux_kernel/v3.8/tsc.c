...
V_12 = F_30 () ;
F_66 ( & V_123 , V_5 ) ;
V_118 = F_14 ( & V_119 , V_12 ) ;
return;
}
V_120 = F_14 ( & V_121 , V_12 ) ;
if ( V_119 == V_121 )
goto V_122;
...
unsigned long T_5 F_72 ( void )
{
int V_15 , V_71 = F_73 () ;
if ( ! V_2 && ! F_49 ( & F_37 ( V_71 ) , V_88 ) )
return 0 ;
F_74 (i)
if ( F_37 ( V_15 ) . V_130 == F_37 ( V_71 ) . V_130 )
