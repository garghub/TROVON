...
struct V_1 * V_2 , T_6 V_205 , T_6 V_206 )
{
struct V_207 * V_208 ;
...
static inline void F_53 ( struct V_60 * V_61 , T_6 V_205 , T_6 V_206 )
{
...
static T_7 V_151 ( int V_148 , void * V_263 )
{
...
static int F_66 ( struct V_146 * V_114 )
{
...
return - V_274 ;
V_61 = F_67 ( & V_275 , sizeof( struct V_1 ) ) ;
if ( ! V_61 )
return - V_276 ;
V_2 = F_57 ( V_61 ) ;
V_61 -> V_277 = V_52 ;
...
V_2 -> V_114 = V_114 ;
V_2 -> V_28 = V_272 ;
strcpy ( V_2 -> V_278 , V_114 -> V_115 . V_156 -> V_279 ) ;
...
F_9 ( L_47 , V_2 -> V_131 ,
V_2 -> V_132 , V_2 -> V_133 ) ;
V_273 = F_68 ( V_155 , L_48 , NULL ) ;
if ( V_273 && V_273 [ 0 ] )
F_9 ( L_49 , V_273 ) ;
if ( F_69 ( V_155 , L_50 , NULL ) != NULL )
V_2 -> V_126 = 1 ;
F_9 ( L_51 ,
V_2 -> V_28 ,
( V_2 -> V_56 ? L_52 : L_53 ) ,
( V_2 -> V_126 ? L_50 : L_54 ) ) ;
if ( F_70 ( V_61 , & V_114 -> V_115 ) ) {
F_9 ( L_55 , V_2 -> V_28 ) ;
goto V_283;
}
F_71 ( & V_114 -> V_115 , V_2 ) ;
F_22 ( V_2 ) ;
F_72 ( V_61 ) ;
V_272 ++ ;
return 0 ;
...
#undef F_37
V_281:
F_73 ( & V_114 -> V_147 [ 0 ] , V_2 -> V_5 ,
F_28 ( & V_114 -> V_147 [ 0 ] ) ) ;
if ( V_2 -> V_135 )
F_73 ( & V_114 -> V_147 [ 0 ] , V_2 -> V_137 ,
sizeof( unsigned char ) ) ;
V_282:
F_74 ( V_2 -> V_148 , V_2 ) ;
V_280:
...
static int F_76 ( struct V_146 * V_114 )
{
struct V_1 * V_2 = F_77 ( & V_114 -> V_115 ) ;
F_25 ( V_2 ) ;
F_78 ( V_2 -> V_109 ) ;
F_2 ( 0 , V_2 -> V_5 + V_6 ) ;
F_74 ( V_2 -> V_148 , V_2 ) ;
...
F_28 ( & V_114 -> V_147 [ 0 ] ) ) ;
if ( V_2 -> V_135 )
F_73 ( & V_114 -> V_147 [ 0 ] , V_2 -> V_137 , sizeof( unsigned char ) ) ;
F_75 ( V_2 -> V_109 ) ;
return 0 ;
}
