...
V_11 -> V_124 = V_13 -> V_121 ;
V_102 = F_44 ( V_11 , 7 , 9 , V_125 ) ;
if ( V_102 < 0 ) {
...
F_40 ( & V_11 -> V_114 . V_119 ,
F_41 ( V_123 ) ) ;
F_47 ( V_11 , V_126 , 0x0100 , 0x0100 ) ;
F_47 ( V_11 , V_127 , 0x0100 , 0x0100 ) ;
F_47 ( V_11 , V_128 , 0x0100 , 0x0100 ) ;
...
struct V_12 * V_13 ;
int V_102 ;
V_13 = F_51 ( & V_137 -> V_2 , sizeof( struct V_12 ) ,
V_138 ) ;
if ( V_13 == NULL )
return - V_139 ;
F_52 ( V_137 , V_13 ) ;
V_13 -> V_121 = F_53 ( V_137 , & V_140 ) ;
if ( F_54 ( V_13 -> V_121 ) ) {
V_102 = F_55 ( V_13 -> V_121 ) ;
F_45 ( & V_137 -> V_2 , L_5 ,
V_102 ) ;
return V_102 ;
}
V_102 = F_56 ( & V_137 -> V_2 , & V_141 ,
V_142 , F_16 ( V_142 ) ) ;
if ( V_102 != 0 )
F_45 ( & V_137 -> V_2 , L_6 , V_102 ) ;
return V_102 ;
}
...
struct V_12 * V_13 ;
int V_102 ;
V_13 = F_51 ( & V_144 -> V_2 , sizeof( struct V_12 ) ,
V_138 ) ;
if ( V_13 == NULL )
return - V_139 ;
F_60 ( V_144 , V_13 ) ;
V_13 -> V_121 = F_61 ( V_144 , & V_140 ) ;
if ( F_54 ( V_13 -> V_121 ) ) {
V_102 = F_55 ( V_13 -> V_121 ) ;
F_45 ( & V_144 -> V_2 , L_5 ,
V_102 ) ;
...
V_102 = F_56 ( & V_144 -> V_2 , & V_141 ,
V_142 , F_16 ( V_142 ) ) ;
if ( V_102 != 0 )
F_45 ( & V_144 -> V_2 , L_6 , V_102 ) ;
return V_102 ;
}
static int F_62 ( struct V_143 * V_147 )
{
F_58 ( & V_147 -> V_2 ) ;
return 0 ;
}
