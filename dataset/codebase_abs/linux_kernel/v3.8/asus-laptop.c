...
F_138 ( L_77 ,
V_124 ) ;
V_20 = F_146 ( sizeof( struct V_19 ) , V_236 ) ;
if ( ! V_20 )
return - V_51 ;
V_20 -> V_1 = V_35 -> V_1 ;
strcpy ( F_147 ( V_35 ) , V_244 ) ;
strcpy ( F_148 ( V_35 ) , V_245 ) ;
V_35 -> V_246 = V_20 ;
V_20 -> V_35 = V_35 ;
F_143 () ;
V_157 = F_141 ( V_20 ) ;
