...
static int F_97 ( const char * V_254 )
{
int V_255 = 0 ;
for (; ; V_254 ++ ) {
switch ( * V_254 ) {
...
static int F_98 ( struct V_4 * V_5 , char * V_256 ,
int V_217 )
{
char * V_257 ;
char * V_258 ;
...
static T_7 F_99 ( struct V_230 * V_230 , const char T_8 * V_245 ,
T_9 V_217 , T_6 * V_231 )
{
int V_3 ;
int V_240 ;
...
static int F_102 ( struct V_267 * V_267 , struct V_230 * V_230 )
{
return F_103 ( V_230 , & V_268 ) ;
}
static int F_104 ( struct V_267 * V_267 , struct V_230 * V_230 )
{
return 0 ;
}
...
V_274 = F_108 ( V_275 , NULL ) ;
if ( ! V_274 ) {
F_96 ( V_273 L_29 ,
V_275 ) ;
return - V_249 ;
}
V_276 = F_109 ( V_277 , 0600 ,
V_274 , NULL , & V_278 ) ;
if ( ! V_276 ) {
F_96 ( V_273 L_30 ,
V_277 ) ;
...
static void F_110 ( int V_8 , int V_57 , int V_279 )
{
int V_21 ;
int V_3 ;
int V_166 = 0 ;
...
V_297 = F_114 ( F_113 ( V_301 ) ) ;
V_298 = F_120 ( V_301 ) ;
V_299 = ( ( unsigned long ) V_297 << V_302 ) | V_298 ;
V_300 = F_120 ( V_301 + ( V_30 - 1 ) ) ;
F_121 ( V_57 , V_299 ) ;
F_122 ( V_57 , V_298 ) ;
F_123 ( V_57 , V_300 ) ;
F_124 ( V_57 , 0xffffUL ) ;
...
static void T_1 F_125 ( int V_7 , int V_303 , int V_279 )
{
int V_8 ;
int V_57 ;
unsigned long V_304 ;
V_8 = F_7 ( V_7 ) ;
V_57 = F_75 ( V_7 ) ;
F_110 ( V_8 , V_57 , V_279 ) ;
F_119 ( V_8 , V_57 ) ;
V_304 = F_10 ( V_7 ) | V_305 ;
F_126 ( V_57 , ( ( V_304 << 32 ) | V_303 ) ) ;
}
...
static int T_1 F_130 ( int V_279 ,
struct V_323 * V_324 ,
unsigned char * V_325 )
{
int V_3 ;
...
V_42 -> V_60 = F_111 ( V_337 , V_241 , V_42 -> V_331 ) ;
memset ( V_42 -> V_60 , 0 , V_337 ) ;
F_4 (cpu) {
V_42 -> V_60 [ V_3 ] . V_57 = F_131 ( V_3 ) -> V_57 ;
V_42 -> V_60 [ V_3 ] . V_7 = F_131 ( V_3 ) -> V_332 ;
}
}
static void F_134 ( struct V_4 * V_80 )
{
int V_338 = sizeof( T_2 ) ;
V_80 -> V_72 = F_135 ( V_338 , V_241 , V_80 -> V_331 ) ;
}
static int F_136 ( struct V_328 * V_329 , struct V_323 * V_327 ,
struct V_4 * * V_339 ,
struct V_4 * * V_340 )
{
int V_21 ;
...
static int T_1 F_137 ( int V_224 ,
struct V_323 * V_324 ,
unsigned char * V_325 )
{
int V_326 ;
...
if ( ( V_334 & 1 ) ) {
V_329 = & V_327 -> V_326 [ V_326 ] ;
if ( F_136 ( V_329 , V_327 , & V_42 , & V_80 ) )
return 1 ;
F_133 ( V_42 ) ;
}
V_326 ++ ;
...
static int T_1 F_138 ( int V_224 , int V_343 )
{
unsigned char * V_325 ;
void * V_296 ;
struct V_323 * V_324 ;
V_96 = F_127 () ;
V_296 = F_139 ( V_224 * sizeof( struct V_323 ) , V_241 ) ;
V_324 = (struct V_323 * ) V_296 ;
memset ( V_324 , 0 , V_224 * sizeof( struct V_323 ) ) ;
V_325 = F_140 ( ( V_224 + 7 ) / 8 , V_241 ) ;
if ( F_130 ( V_343 , V_324 , V_325 ) )
goto V_344;
if ( F_137 ( V_224 , V_324 , V_325 ) )
goto V_344;
F_92 ( V_324 ) ;
F_92 ( V_325 ) ;
F_128 () ;
