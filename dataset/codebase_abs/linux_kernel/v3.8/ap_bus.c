...
static T_14 F_78 ( struct V_107 * V_105 , char * V_56 )
{
return snprintf ( V_56 , V_57 , L_11 ,
F_1 () ? 1 : 0 ) ;
}
static T_14 F_79 ( struct V_107 * V_105 ,
...
static T_14 F_81 ( struct V_107 * V_105 , char * V_56 )
{
return snprintf ( V_56 , V_57 , L_11 , V_109 ? 1 : 0 ) ;
}
static T_14 F_82 ( struct V_107 * V_105 ,
const char * V_56 , T_7 V_108 )
{
int V_110 , V_30 ;
...
static T_14 F_84 ( struct V_107 * V_105 , char * V_56 )
{
return snprintf ( V_56 , V_57 , L_17 , V_111 ) ;
}
static T_14 F_85 ( struct V_107 * V_105 , const char * V_56 ,
T_7 V_108 )
{
...
V_112 = F_86 ( 0 , V_111 ) ;
if ( ! F_87 ( & V_113 ) ||
! F_88 ( & V_113 , F_89 ( & V_113 ) , V_112 ) ) {
F_90 ( & V_113 , V_112 ) ;
F_91 ( & V_113 , V_114 ) ;
}
return V_108 ;
}
static inline int F_92 ( unsigned int * V_115 , unsigned int V_116 )
{
if ( V_116 > 0xFFu )
return 0 ;
return F_93 ( ( V_115 + ( V_116 >> 5 ) ) , ( V_116 & 0x1f ) ) ;
}
static inline int F_94 ( unsigned int V_66 )
{
if ( ! V_117 )
return 1 ;
return F_92 ( V_117 -> V_118 , V_66 ) ;
}
static inline int F_95 ( unsigned int V_119 )
{
if ( ! V_117 )
return 1 ;
return F_92 ( V_117 -> V_120 , V_119 ) ;
}
...
static int F_97 ( struct V_42 * V_43 )
{
...
V_30 = - V_3 ;
V_129:
F_100 ( ( unsigned long ) V_127 ) ;
V_128:
return V_30 ;
}
static void F_101 ( void * V_132 , void * V_133 )
{
F_102 ( V_134 ) ;
F_56 ( & V_79 ) ;
}
static int F_103 ( struct V_52 * V_53 , void * V_85 )
{
return F_30 ( V_53 ) -> V_5 == ( T_4 ) ( unsigned long ) V_85 ;
}
static void F_104 ( struct V_52 * V_53 )
{
struct V_42 * V_43 = F_30 ( V_53 ) ;
F_105 ( V_43 ) ;
}
static void F_75 ( struct V_135 * V_136 )
{
struct V_42 * V_43 ;
struct V_52 * V_53 ;
T_4 V_5 ;
