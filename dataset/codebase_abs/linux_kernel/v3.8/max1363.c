...
unsigned long * V_96 ;
int V_5 ;
V_96 = F_39 ( F_40 ( V_10 ) * sizeof( long ) *
( V_17 -> V_39 -> V_6 + 1 ) , V_82 ) ;
if ( ! V_96 )
return - V_83 ;
for ( V_5 = 0 ; V_5 < V_17 -> V_39 -> V_6 ; V_5 ++ )
F_41 ( V_96 + F_40 ( V_10 ) * V_5 ,
V_7 [ V_17 -> V_39 -> V_8 [ V_5 ] ]
. V_9 , V_10 ) ;
V_26 -> V_97 = V_96 ;
return 0 ;
}
static T_6 F_42 ( int V_62 , void * V_98 )
{
struct V_99 * V_100 = V_98 ;
struct V_25 * V_26 = V_100 -> V_26 ;
struct V_16 * V_17 = F_7 ( V_26 ) ;
T_7 V_101 ;
T_9 * V_33 ;
int V_102 ;
T_4 V_103 ;
unsigned long V_104 = F_28 ( V_17 -> V_22 -> V_9 ,
V_10 ) ;
if ( V_17 -> V_39 -> V_40 != 8 )
V_103 = V_104 * 2 ;
else
...
V_103 += sizeof( T_7 ) ;
if ( V_103 % sizeof( T_7 ) )
V_103 += sizeof( T_7 ) - ( V_103 % sizeof( T_7 ) ) ;
}
if ( V_104 == 0 )
goto V_106;
V_33 = F_29 ( V_103 , V_82 ) ;
if ( V_33 == NULL )
goto V_106;
if ( V_17 -> V_39 -> V_40 != 8 )
V_102 = F_10 ( V_17 -> V_12 , V_33 , V_104 * 2 ) ;
else
V_102 = F_10 ( V_17 -> V_12 , V_33 , V_104 ) ;
if ( V_102 < 0 )
goto V_107;
V_101 = F_23 () ;
if ( V_26 -> V_105 )
memcpy ( V_33 + V_103 - sizeof( T_7 ) , & V_101 , sizeof( V_101 ) ) ;
F_43 ( V_26 , V_33 ) ;
V_107:
F_31 ( V_33 ) ;
V_106:
...
struct V_16 * V_17 = F_7 ( V_26 ) ;
int V_31 = 0 ;
V_26 -> V_109 = F_46 ( V_26 ) ;
if ( ! V_26 -> V_109 ) {
V_31 = - V_83 ;
goto V_37;
}
V_26 -> V_110 = F_47 ( NULL ,
& F_42 ,
V_111 ,
V_26 ,
L_2 ,
...
const struct V_119 * V_113 )
{
int V_31 ;
struct V_16 * V_17 ;
struct V_25 * V_26 ;
V_26 = F_52 ( sizeof( struct V_16 ) ) ;
if ( V_26 == NULL ) {
V_31 = - V_83 ;
goto V_120;
}
V_31 = F_53 ( V_26 , V_12 -> V_49 . V_121 ) ;
if ( V_31 < 0 )
goto V_122;
V_17 = F_7 ( V_26 ) ;
V_17 -> V_123 = F_54 ( & V_12 -> V_49 , L_3 ) ;
if ( F_55 ( V_17 -> V_123 ) ) {
V_31 = F_56 ( V_17 -> V_123 ) ;
goto V_124;
}
V_31 = F_57 ( V_17 -> V_123 ) ;
if ( V_31 )
goto V_125;
F_58 ( V_12 , V_26 ) ;
V_17 -> V_39 = & V_126 [ V_113 -> V_127 ] ;
V_17 -> V_12 = V_12 ;
V_31 = F_38 ( V_26 ) ;
if ( V_31 )
goto V_128;
V_26 -> V_49 . V_129 = & V_12 -> V_49 ;
V_26 -> V_112 = V_113 -> V_112 ;
V_26 -> V_130 = V_17 -> V_39 -> V_130 ;
V_26 -> V_131 = V_17 -> V_39 -> V_131 ;
V_26 -> V_132 = V_17 -> V_39 -> V_132 ;
V_26 -> V_117 = V_133 ;
V_26 -> V_130 = V_17 -> V_39 -> V_130 ;
V_26 -> V_131 = V_17 -> V_39 -> V_131 ;
V_31 = F_35 ( V_17 ) ;
