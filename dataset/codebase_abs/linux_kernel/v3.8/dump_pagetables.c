...
static void F_3 ( struct V_1 * V_2 , struct V_8 * V_9 ,
...
for ( V_26 = 0 ; V_26 < V_37 && V_24 < V_28 ; V_26 ++ ) {
V_9 . V_21 = V_24 ;
V_34 = F_18 ( V_24 ) ;
if ( ! F_19 ( * V_34 ) )
F_12 ( V_2 , & V_9 , V_34 , V_24 ) ;
else
F_3 ( V_2 , & V_9 , V_6 , 1 ) ;
V_24 += V_38 ;
}
...
static int F_20 ( struct V_1 * V_2 , void * V_39 )
{
F_17 ( V_2 ) ;
return 0 ;
}
static int F_21 ( struct V_40 * V_40 , struct V_41 * V_42 )
{
return F_22 ( V_42 , F_20 , NULL ) ;
}
...
V_28 = 1UL << 31 ;
#else
V_28 = ( V_43 . V_44 & V_45 ) >> 2 ;
V_28 = 1UL << ( V_28 * 11 + 31 ) ;
V_19 [ V_46 ] . V_22 = V_47 ;
#endif
V_19 [ V_48 ] . V_22 = ( unsigned long ) V_49 ;
V_19 [ V_50 ] . V_22 = V_51 ;
F_25 ( L_15 , 0400 , NULL , NULL , & V_52 ) ;
return 0 ;
}
