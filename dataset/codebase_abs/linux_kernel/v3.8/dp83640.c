...
V_232 |
V_233 ) ;
return F_6 ( V_7 , V_225 , V_227 ) ;
}
}
static int F_87 ( struct V_6 * V_7 , struct V_237 * V_238 )
{
struct V_9 * V_10 = V_7 -> V_11 ;
struct V_239 V_240 ;
T_2 V_241 , V_242 ;
if ( F_88 ( & V_240 , V_238 -> V_243 , sizeof( V_240 ) ) )
return - V_244 ;
if ( V_240 . V_170 )
return - V_96 ;
if ( V_240 . V_245 < 0 || V_240 . V_245 > V_246 )
return - V_247 ;
V_10 -> V_248 = V_240 . V_245 ;
switch ( V_240 . V_249 ) {
case V_250 :
V_10 -> V_251 = 0 ;
V_10 -> V_252 = 0 ;
...
case V_267 :
V_10 -> V_251 = 1 ;
V_10 -> V_252 = V_257 | V_264 ;
V_10 -> V_253 = 2 ;
break;
default:
return - V_247 ;
}
V_241 = ( V_10 -> V_253 & V_268 ) << V_269 ;
V_242 = ( V_10 -> V_253 & V_268 ) << V_269 ;
if ( V_10 -> V_252 & V_264 ) {
V_241 |= V_270 ;
V_242 |= V_271 ;
}
...
if ( V_10 -> V_248 || V_10 -> V_251 ) {
F_21 ( V_7 , true ) ;
F_5 ( 0 , V_7 , V_19 , V_23 , V_145 ) ;
}
F_5 ( 0 , V_7 , V_64 , V_280 , V_241 ) ;
F_5 ( 0 , V_7 , V_64 , V_281 , V_242 ) ;
F_12 ( & V_10 -> clock -> V_63 ) ;
return F_89 ( V_238 -> V_243 , & V_240 , sizeof( V_240 ) ) ? - V_244 : 0 ;
}
static void V_220 ( struct V_282 * V_283 )
{
struct V_9 * V_10 =
F_14 ( V_283 , struct V_9 , V_219 ) ;
struct V_129 * V_130 , * V_131 ;
struct V_26 * V_26 ;
struct V_173 * V_174 ;
struct V_122 * V_123 ;
...
static int F_97 ( struct V_6 * V_15 , struct V_286 * V_287 )
{
...
V_290 |
V_291 ;
V_287 -> V_292 = F_98 ( V_10 -> clock -> V_169 ) ;
V_287 -> V_293 =
( 1 << V_285 ) |
( 1 << V_284 ) |
( 1 << V_246 ) ;
