...
V_153 = F_59 ( V_147 -> V_116 . V_154 , L_3 , NULL ) ;
if ( V_153 )
V_152 = F_60 ( V_153 ) ;
if ( ! V_152 ) {
...
V_150 = F_61 ( V_147 , V_155 , 0 ) ;
if ( ! V_150 )
return - V_144 ;
V_151 = F_61 ( V_147 , V_156 , 0 ) ;
if ( ! V_151 )
return - V_144 ;
V_4 = F_44 () ;
if ( ! V_4 ) {
...
V_4 -> V_112 = V_150 -> V_157 ;
V_4 -> V_1 = V_151 -> V_157 ;
V_4 -> V_116 = & V_147 -> V_116 ;
V_4 -> V_49 = V_152 ;
F_62 ( & V_147 -> V_116 , V_4 ) ;
V_148 = F_63 ( & V_158 , V_4 ) ;
if ( V_148 ) {
F_36 ( & V_147 -> V_116 ,
L_6 , V_148 ) ;
F_62 ( & V_147 -> V_116 , NULL ) ;
return V_148 ;
}
return 0 ;
}
...
{
struct V_3 * V_4 = F_65 ( & V_147 -> V_116 ) ;
int V_148 = 0 ;
if ( V_4 ) {
V_148 = F_66 ( & V_158 , V_4 ) ;
F_62 ( & V_147 -> V_116 , NULL ) ;
V_4 -> V_112 = 0 ;
}
return V_148 ;
}
static int F_67 ( struct V_146 * V_147 , T_3 V_13 )
{
F_68 ( & V_158 , & V_124 [ V_147 -> V_122 ] ) ;
return 0 ;
}
static int F_69 ( struct V_146 * V_147 )
{
F_70 ( & V_158 , & V_124 [ V_147 -> V_122 ] ) ;
return 0 ;
}
