...
static int F_18 ( struct V_1 * V_2 , struct V_1 * V_50 ,
int V_33 )
{
F_19 ( V_51 , V_52 ) ;
...
static int F_38 ( struct V_1 * V_2 , int V_103 , int V_65 ,
char T_2 * V_66 , int T_2 * V_67 )
{
struct V_2 * V_6 = V_2 -> V_6 ;
struct V_7 * V_8 = F_2 ( V_6 ) -> V_8 ;
...
char T_2 * V_66 , unsigned int V_67 )
{
struct V_2 * V_6 = V_2 -> V_6 ;
struct V_7 * V_8 = F_2 ( V_6 ) -> V_8 ;
struct V_68 V_69 ;
...
static int F_44 ( struct V_1 * V_2 , int V_103 , int V_65 ,
char T_2 * V_66 , unsigned int V_67 )
{
struct V_2 * V_6 = V_2 -> V_6 ;
struct V_7 * V_8 = F_2 ( V_6 ) -> V_8 ;
...
static int F_49 ( struct V_147 * V_148 , struct V_1 * V_2 ,
struct V_149 * V_150 , T_5 V_11 )
{
struct V_2 * V_6 = V_2 -> V_6 ;
struct V_7 * V_8 = F_2 ( V_6 ) -> V_8 ;
int V_12 ;
...
return - V_96 ;
F_51 ( V_8 ) ;
V_12 = F_52 ( V_8 , V_150 , V_11 , V_6 -> V_153 ) ;
F_53 ( V_8 ) ;
return V_12 ;
}
static int F_54 ( struct V_147 * V_148 , struct V_1 * V_2 ,
struct V_149 * V_150 , T_5 V_11 , int V_33 )
{
struct V_2 * V_6 = V_2 -> V_6 ;
struct V_154 * V_155 = F_2 ( V_6 ) ;
int V_12 ;
F_5 ( V_6 ) ;
if ( V_6 -> V_18 == V_94 && F_36 ( V_95 ,
& F_11 ( V_6 ) -> V_33 ) ) {
V_6 -> V_18 = V_135 ;
V_155 -> V_8 -> V_31 = V_135 ;
F_55 ( V_155 -> V_8 ) ;
F_12 ( V_6 ) ;
return 0 ;
}
F_12 ( V_6 ) ;
if ( V_2 -> type == V_40 )
V_12 = F_56 ( V_148 , V_2 , V_150 , V_11 , V_33 ) ;
else
V_12 = F_57 ( V_148 , V_2 , V_150 , V_11 , V_33 ) ;
if ( V_155 -> V_8 -> V_41 != V_43 )
return V_12 ;
F_5 ( V_6 ) ;
if ( ! F_36 ( V_156 , & V_155 -> V_8 -> V_157 ) )
goto V_21;
if ( V_155 -> V_158 ) {
if ( ! F_58 ( V_6 , V_155 -> V_158 ) )
V_155 -> V_158 = NULL ;
else
goto V_21;
}
if ( F_59 ( & V_6 -> V_159 ) <= V_6 -> V_160 >> 1 )
F_60 ( V_155 -> V_8 , 0 ) ;
V_21:
F_12 ( V_6 ) ;
return V_12 ;
}
static void F_61 ( struct V_2 * V_6 )
{
if ( ! F_62 ( V_6 , V_161 ) || V_6 -> V_162 )
return;
F_3 ( L_6 , V_6 , F_63 ( V_6 -> V_18 ) ) ;
F_64 ( F_2 ( V_6 ) -> V_8 ) ;
F_65 ( V_6 , V_163 ) ;
F_66 ( V_6 ) ;
}
static int F_67 ( struct V_1 * V_2 , int V_164 )
{
struct V_2 * V_6 = V_2 -> V_6 ;
struct V_7 * V_8 ;
struct V_133 * V_98 ;
...
static void F_75 ( struct V_2 * V_173 )
{
struct V_2 * V_6 ;
F_3 ( L_7 , V_173 ) ;
while ( ( V_6 = F_25 ( V_173 , NULL ) ) ) {
struct V_7 * V_8 = F_2 ( V_6 ) -> V_8 ;
F_51 ( V_8 ) ;
F_76 ( V_8 ) ;
F_70 ( V_8 , V_174 ) ;
...
static struct V_7 * F_77 ( struct V_7 * V_8 )
{
struct V_2 * V_6 , * V_173 = V_8 -> V_175 ;
if ( F_78 ( V_173 ) ) {
F_3 ( L_8 , V_173 -> V_48 ) ;
return NULL ;
}
V_6 = F_79 ( F_80 ( V_173 ) , NULL , V_176 ,
V_177 ) ;
if ( ! V_6 )
return NULL ;
F_81 ( V_6 , V_176 ) ;
...
static void F_86 ( struct V_7 * V_8 , int V_12 )
{
struct V_2 * V_6 = V_8 -> V_175 ;
struct V_2 * V_173 ;
F_5 ( V_6 ) ;
V_173 = F_11 ( V_6 ) -> V_173 ;
F_65 ( V_6 , V_161 ) ;
switch ( V_8 -> V_31 ) {
case V_19 :
case V_32 :
...
static void F_88 ( struct V_7 * V_8 , int V_31 )
{
struct V_2 * V_6 = V_8 -> V_175 ;
V_6 -> V_18 = V_31 ;
}
static struct V_178 * F_89 ( struct V_7 * V_8 ,
unsigned long V_11 , int V_182 )
{
struct V_178 * V_179 ;
int V_12 ;
F_53 ( V_8 ) ;
V_179 = F_90 ( V_8 -> V_6 , V_11 , V_182 , & V_12 ) ;
F_51 ( V_8 ) ;
if ( ! V_179 )
return F_91 ( V_12 ) ;
return V_179 ;
...
{
struct V_2 * V_6 = V_8 -> V_175 ;
struct V_2 * V_173 = F_11 ( V_6 ) -> V_173 ;
if ( V_173 )
V_173 -> V_181 ( V_173 , 0 ) ;
}
static void F_94 ( struct V_2 * V_6 )
{
F_3 ( L_1 , V_6 ) ;
if ( F_2 ( V_6 ) -> V_8 )
F_64 ( F_2 ( V_6 ) -> V_8 ) ;
...
static void F_82 ( struct V_2 * V_6 , struct V_2 * V_173 )
{
struct V_154 * V_155 = F_2 ( V_6 ) ;
struct V_7 * V_8 = V_155 -> V_8 ;
F_3 ( L_1 , V_6 ) ;
if ( V_173 ) {
struct V_7 * V_185 = F_2 ( V_173 ) -> V_8 ;
V_6 -> V_38 = V_173 -> V_38 ;
F_11 ( V_6 ) -> V_33 = F_11 ( V_173 ) -> V_33 ;
V_8 -> V_111 = V_185 -> V_111 ;
V_8 -> V_75 = V_185 -> V_75 ;
V_8 -> V_76 = V_185 -> V_76 ;
V_8 -> V_132 = V_185 -> V_132 ;
V_8 -> V_41 = V_185 -> V_41 ;
V_8 -> V_78 = V_185 -> V_78 ;
V_8 -> V_79 = V_185 -> V_79 ;
V_8 -> V_81 = V_185 -> V_81 ;
V_8 -> V_186 = V_185 -> V_186 ;
V_8 -> V_28 = V_185 -> V_28 ;
V_8 -> V_33 = V_185 -> V_33 ;
F_97 ( V_173 , V_6 ) ;
} else {
...
static struct V_2 * F_79 ( struct V_193 * V_193 , struct V_1 * V_2 ,
int V_194 , T_6 V_195 )
{
struct V_2 * V_6 ;
struct V_7 * V_8 ;
V_6 = F_99 ( V_193 , V_196 , V_195 , & V_197 ) ;
if ( ! V_6 )
return NULL ;
F_100 ( V_2 , V_6 ) ;
F_101 ( & F_11 ( V_6 ) -> V_198 ) ;
V_6 -> V_199 = F_94 ;
V_6 -> V_200 = V_201 ;
F_102 ( V_6 , V_161 ) ;
V_6 -> V_202 = V_194 ;
...
static int F_106 ( struct V_193 * V_193 , struct V_1 * V_2 , int V_203 ,
int V_204 )
{
struct V_2 * V_6 ;
F_3 ( L_10 , V_2 ) ;
...
V_2 -> type != V_187 && V_2 -> type != V_120 )
return - V_206 ;
if ( V_2 -> type == V_120 && ! V_204 && ! F_7 ( V_207 ) )
return - V_208 ;
V_2 -> V_191 = & V_209 ;
V_6 = F_79 ( V_193 , V_2 , V_203 , V_177 ) ;
if ( ! V_6 )
return - V_180 ;
F_82 ( V_6 , NULL ) ;
F_107 ( & V_172 , V_6 ) ;
...
if ( V_12 < 0 )
return V_12 ;
V_12 = F_110 ( V_176 , & V_210 ) ;
if ( V_12 < 0 ) {
F_111 ( L_11 ) ;
goto error;
}
V_12 = F_112 ( V_211 , & V_212 , L_12 , & V_172 ,
NULL ) ;
if ( V_12 < 0 ) {
F_111 ( L_13 ) ;
F_113 ( V_176 ) ;
