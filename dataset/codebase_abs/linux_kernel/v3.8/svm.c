...
static bool F_311 ( struct V_8 * V_9 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
return ! ! ( V_10 -> V_9 . V_23 . V_24 & V_560 ) ;
}
static void F_312 ( struct V_8 * V_9 , bool V_569 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
if ( V_569 ) {
V_10 -> V_9 . V_23 . V_24 |= V_560 ;
...
static int F_316 ( struct V_279 * V_279 , unsigned int V_34 )
{
return 0 ;
}
...
return;
if ( ! F_11 ( V_10 , V_198 ) ) {
int V_572 = V_10 -> V_1 -> V_2 . V_245 & V_573 ;
F_269 ( V_9 , V_572 ) ;
}
}
...
return;
V_572 = F_271 ( V_9 ) ;
V_10 -> V_1 -> V_2 . V_245 &= ~ V_573 ;
V_10 -> V_1 -> V_2 . V_245 |= V_572 & V_573 ;
}
static void F_300 ( struct V_7 * V_10 )
{
T_4 V_574 ;
int type ;
T_1 V_575 = V_10 -> V_1 -> V_2 . V_447 ;
...
F_322 ( & V_10 -> V_9 , V_574 , V_80 ) ;
} else
F_323 ( & V_10 -> V_9 , V_574 ) ;
break;
case V_493 :
F_324 ( & V_10 -> V_9 , V_574 , false ) ;
break;
default:
break;
}
...
F_327 ( V_10 -> V_1 -> V_2 . V_407 , V_9 , V_450 ) ;
...
F_318 ( V_9 ) ;
V_10 -> V_55 = 0 ;
V_10 -> V_1 -> V_2 . V_362 = V_578 ;
if ( V_10 -> V_1 -> V_2 . V_407 == V_418 + V_215 )
V_10 -> V_370 = F_330 () ;
if ( V_39 ) {
V_9 -> V_23 . V_579 &= ~ ( 1 << V_312 ) ;
V_9 -> V_23 . V_580 &= ~ ( 1 << V_312 ) ;
}
...
static void F_332 ( struct V_8 * V_9 , unsigned long V_403 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
V_10 -> V_1 -> V_2 . V_401 = V_403 ;
F_3 ( V_10 -> V_1 , V_404 ) ;
...
static void
F_334 ( struct V_8 * V_9 , unsigned char * V_583 )
{
V_583 [ 0 ] = 0x0f ;
V_583 [ 1 ] = 0x01 ;
V_583 [ 2 ] = 0xd9 ;
}
static void F_335 ( void * V_584 )
{
* ( int * ) V_584 = 0 ;
}
static bool F_336 ( void )
{
return false ;
}
static T_2 F_337 ( struct V_8 * V_9 , T_11 V_585 , bool V_586 )
{
return 0 ;
}
...
static void F_339 ( T_1 V_587 , struct V_588 * V_589 )
{
switch ( V_587 ) {
case 0x80000001 :
if ( V_17 )
...
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
int V_417 , V_50 = V_598 ;
struct V_599 V_600 ;
struct V_1 * V_1 = V_10 -> V_1 ;
if ( V_45 -> V_22 >= F_301 ( V_601 ) )
goto V_285;
...
if ( V_45 -> V_22 == V_605 )
V_600 . V_407 += V_45 -> V_603 ;
if ( V_600 . V_407 != V_604 )
break;
V_22 = V_10 -> V_17 . V_22 ;
if ( ! ( V_22 & ( 1ULL << V_221 ) ) )
break;
V_263 = V_9 -> V_23 . V_263 & ~ V_345 ;
V_81 = V_45 -> V_606 & ~ V_345 ;
if ( V_45 -> V_22 == V_607 ) {
V_263 &= 0xfUL ;
V_81 &= 0xfUL ;
if ( V_263 & V_454 )
...
T_2 V_613 ;
T_1 V_614 ;
V_613 = ( V_9 -> V_23 . V_261 [ V_278 ] & 0xffff ) << 16 ;
if ( V_45 -> V_22 == V_615 ||
V_45 -> V_22 == V_616 ) {
V_613 |= V_397 ;
V_614 = V_45 -> V_617 ;
...
V_1 -> V_2 . V_407 = V_600 . V_407 ;
V_417 = F_222 ( V_10 ) ;
V_50 = ( V_417 == V_420 ) ? V_623
: V_598 ;
V_285:
return V_50 ;
}
