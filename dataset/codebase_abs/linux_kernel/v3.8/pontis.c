...
V_12 -> type = V_50 ;
V_12 -> V_14 = 1 ;
V_12 -> V_15 . V_51 . V_52 = 3 ;
if ( V_12 -> V_15 . V_51 . V_53 >= V_12 -> V_15 . V_51 . V_52 )
V_12 -> V_15 . V_51 . V_53 = V_12 -> V_15 . V_51 . V_52 - 1 ;
strcpy ( V_12 -> V_15 . V_51 . V_54 , V_49 [ V_12 -> V_15 . V_51 . V_53 ] ) ;
return 0 ;
}
static int F_31 ( struct V_9 * V_10 , struct V_19 * V_20 )
{
struct V_1 * V_2 = F_7 ( V_10 ) ;
F_8 ( & V_2 -> V_22 ) ;
V_20 -> V_15 . V_51 . V_53 [ 0 ] = V_2 -> V_46 . V_55 [ 0 ] ;
F_9 ( & V_2 -> V_22 ) ;
return 0 ;
}
...
int V_28 = 0 ;
F_8 ( & V_2 -> V_22 ) ;
if ( V_20 -> V_15 . V_51 . V_53 [ 0 ] != V_2 -> V_46 . V_55 [ 0 ] ) {
V_2 -> V_46 . V_55 [ 0 ] = V_20 -> V_15 . V_51 . V_53 [ 0 ] & 3 ;
V_6 = 0x80 | ( V_2 -> V_46 . V_55 [ 0 ] << 3 ) ;
F_26 ( V_2 , V_56 , 0x04 , V_6 ) ;
V_28 = 1 ;
}
F_9 ( & V_2 -> V_22 ) ;
return V_28 ;
}
static int F_33 ( struct V_9 * V_10 , struct V_11 * V_12 )
{
V_12 -> type = V_13 ;
V_12 -> V_14 = 1 ;
V_12 -> V_15 . integer . V_16 = 0 ;
...
static int F_34 ( struct V_9 * V_10 , struct V_19 * V_20 )
{
struct V_1 * V_2 = F_7 ( V_10 ) ;
F_8 ( & V_2 -> V_22 ) ;
...
static void F_40 ( struct V_58 * V_59 , struct V_60 * V_61 )
{
struct V_1 * V_2 = V_59 -> V_62 ;
char line [ 64 ] ;
unsigned int V_3 , V_6 ;
F_8 ( & V_2 -> V_22 ) ;
while ( ! F_41 ( V_61 , line , sizeof( line ) ) ) {
...
{
struct V_58 * V_59 ;
if ( ! F_45 ( V_2 -> V_63 , L_6 , & V_59 ) ) {
F_46 ( V_59 , V_2 , F_42 ) ;
V_59 -> V_64 |= V_65 ;
V_59 -> V_66 . V_67 . V_68 = F_40 ;
}
}
static void F_47 ( struct V_58 * V_59 , struct V_60 * V_61 )
{
struct V_1 * V_2 = V_59 -> V_62 ;
int V_3 , V_6 ;
F_8 ( & V_2 -> V_22 ) ;
for ( V_3 = 0 ; V_3 <= 0x26 ; V_3 ++ ) {
V_6 = F_29 ( V_2 , V_56 , V_3 ) ;
F_43 ( V_61 , L_7 , V_3 , V_6 ) ;
}
V_6 = F_29 ( V_2 , V_56 , 0x7f ) ;
F_43 ( V_61 , L_7 , 0x7f , V_6 ) ;
F_9 ( & V_2 -> V_22 ) ;
}
static void F_48 ( struct V_1 * V_2 )
{
struct V_58 * V_59 ;
if ( ! F_45 ( V_2 -> V_63 , L_8 , & V_59 ) )
F_46 ( V_59 , V_2 , F_47 ) ;
}
...
unsigned int V_21 ;
int V_69 ;
for ( V_21 = 0 ; V_21 < F_50 ( V_70 ) ; V_21 ++ ) {
V_69 = F_51 ( V_2 -> V_63 , F_52 ( & V_70 [ V_21 ] , V_2 ) ) ;
if ( V_69 < 0 )
return V_69 ;
}
F_44 ( V_2 ) ;
...
{
static const unsigned short V_71 [] = {
V_36 , 0x00c0 ,
V_72 , 0x0001 ,
V_38 , 0x0000 ,
V_73 , 0x0008 ,
...
static const unsigned char V_85 [] = {
0x04 , 0x80 ,
0x05 , 0x05 ,
0x01 , 0x00 ,
0x02 , 0x00 ,
...
V_2 -> V_87 = 2 ;
V_2 -> V_88 = 2 ;
V_2 -> V_4 = F_54 ( sizeof( struct V_89 ) , V_90 ) ;
if ( ! V_2 -> V_4 )
return - V_91 ;
V_2 -> V_92 = 1 ;
V_2 -> V_46 . V_55 [ 0 ] = 0 ;
for ( V_21 = 0 ; V_21 < F_50 ( V_71 ) ; V_21 += 2 )
F_4 ( V_2 , V_71 [ V_21 ] , V_71 [ V_21 + 1 ] ) ;
F_55 ( 1 ) ;
for ( V_21 = 0 ; V_21 < F_50 ( V_75 ) ; V_21 += 2 )
F_4 ( V_2 , V_75 [ V_21 ] , V_75 [ V_21 + 1 ] ) ;
F_56 ( F_57 ( F_58 ( V_2 , V_93 ) ) | 0x80 , F_58 ( V_2 , V_93 ) ) ;
F_59 ( 5 ) ;
F_56 ( F_57 ( F_58 ( V_2 , V_93 ) ) & ~ 0x80 , F_58 ( V_2 , V_93 ) ) ;
for ( V_21 = 0 ; V_21 < F_50 ( V_85 ) ; V_21 += 2 )
F_26 ( V_2 , V_56 , V_85 [ V_21 ] , V_85 [ V_21 + 1 ] ) ;
return 0 ;
}
