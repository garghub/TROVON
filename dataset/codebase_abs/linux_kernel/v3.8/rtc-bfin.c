...
F_6 ( V_14 ) ;
V_20 = F_34 ( sizeof( * V_20 ) , V_54 ) ;
if ( F_35 ( ! V_20 ) )
return - V_55 ;
F_36 ( V_51 , V_20 ) ;
F_37 ( V_14 , 1 ) ;
V_20 -> V_36 = F_38 ( V_51 -> V_56 , V_14 , & V_57 ,
V_58 ) ;
if ( F_35 ( F_39 ( V_20 -> V_36 ) ) ) {
V_43 = F_40 ( V_20 -> V_36 ) ;
goto V_59;
}
V_43 = F_41 ( V_60 , F_15 , 0 , V_51 -> V_56 , V_14 ) ;
if ( F_35 ( V_43 ) )
goto V_61;
while ( F_7 () & V_15 )
if ( F_42 ( V_53 , V_52 ) )
...
static int F_49 ( struct V_50 * V_51 , T_5 V_62 )
{
struct V_13 * V_14 = & V_51 -> V_14 ;
F_6 ( V_14 ) ;
if ( F_50 ( V_14 ) ) {
