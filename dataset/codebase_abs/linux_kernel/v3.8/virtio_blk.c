...
static int F_93 ( struct V_114 * V_54 )
{
struct V_8 * V_9 ;
struct V_59 * V_60 ;
int V_83 , V_104 ;
...
static void F_121 ( struct V_114 * V_54 )
{
struct V_8 * V_9 = V_54 -> V_55 ;
int V_104 = V_9 -> V_104 ;
int V_179 ;
...
F_115 ( V_9 -> V_20 ) ;
F_116 ( V_9 -> V_20 -> V_21 ) ;
V_54 -> V_122 -> V_180 ( V_54 ) ;
F_122 ( & V_9 -> V_113 ) ;
V_179 = F_123 ( & F_114 ( V_9 -> V_20 ) -> V_181 . V_182 . V_183 ) ;
F_117 ( V_9 -> V_20 ) ;
F_118 ( V_9 -> V_11 ) ;
V_54 -> V_122 -> V_178 ( V_54 ) ;
F_119 ( V_9 ) ;
...
static int F_124 ( struct V_114 * V_54 )
{
struct V_8 * V_9 = V_54 -> V_55 ;
V_54 -> V_122 -> V_180 ( V_54 ) ;
F_74 ( & V_9 -> V_119 ) ;
...
static int F_126 ( struct V_114 * V_54 )
{
struct V_8 * V_9 = V_54 -> V_55 ;
int V_184 ;
V_9 -> V_120 = true ;
V_184 = F_83 ( V_54 -> V_55 ) ;
if ( ! V_184 ) {
F_8 ( V_9 -> V_20 -> V_21 -> V_22 ) ;
F_38 ( V_9 -> V_20 -> V_21 ) ;
F_10 ( V_9 -> V_20 -> V_21 -> V_22 ) ;
