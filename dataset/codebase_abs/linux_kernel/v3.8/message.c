...
void F_90 ( struct V_22 * V_16 , struct V_44 * V_19 ,
bool V_158 )
{
int V_141 = F_11 ( & V_19 -> V_20 ) ;
int V_159 = F_91 ( & V_19 -> V_20 ) ;
int V_160 = F_92 ( & V_19 -> V_20 ) ;
if ( V_158 )
F_76 ( V_16 , V_19 ) ;
if ( V_159 || V_160 )
...
void F_93 ( struct V_22 * V_16 ,
struct V_130 * V_131 , bool V_161 )
{
struct V_132 * V_133 = V_131 -> V_134 ;
int V_61 ;
for ( V_61 = 0 ; V_61 < V_133 -> V_20 . V_137 ; ++ V_61 )
F_90 ( V_16 , & V_133 -> V_138 [ V_61 ] , V_161 ) ;
}
int F_94 ( struct V_22 * V_16 , int V_152 , int V_162 )
{
struct V_130 * V_163 ;
struct V_132 * V_133 ;
struct V_148 * V_149 = F_79 ( V_16 -> V_58 ) ;
...
F_87 ( V_149 -> V_157 ) ;
if ( F_97 ( V_16 ) ) {
F_29 ( & V_163 -> V_16 , L_18 , V_67 ) ;
F_89 ( V_149 -> V_157 ) ;
return - V_31 ;
}
V_38 = F_88 ( V_16 , NULL , V_163 -> V_134 , V_133 ) ;
if ( V_38 < 0 ) {
F_98 ( & V_16 -> V_16 , L_19 ,
V_162 ) ;
F_99 ( V_16 ) ;
...
F_88 ( V_16 , NULL , V_133 , V_163 -> V_134 ) ;
F_99 ( V_16 ) ;
F_89 ( V_149 -> V_157 ) ;
return V_38 ;
}
...
static void F_105 ( struct V_176 * V_16 )
{
struct V_130 * V_131 = F_106 ( V_16 ) ;
struct V_177 * V_178 =
F_107 ( V_131 -> V_172 ) ;
F_108 ( & V_178 -> V_179 , V_180 ) ;
F_20 ( V_131 ) ;
}
static int F_109 ( struct V_176 * V_16 , struct V_181 * V_182 )
{
struct V_22 * V_23 ;
struct V_130 * V_131 ;
struct V_132 * V_133 ;
...
L_22
L_23 ,
F_111 ( V_23 -> V_122 . V_186 ) ,
F_111 ( V_23 -> V_122 . V_187 ) ,
F_111 ( V_23 -> V_122 . V_188 ) ,
V_23 -> V_122 . V_189 ,
V_23 -> V_122 . V_190 ,
V_23 -> V_122 . V_191 ,
V_133 -> V_20 . V_183 ,
...
static struct V_193 * F_112 ( struct V_22 * V_16 ,
struct V_170 * V_171 ,
V_96 V_194 )
{
...
int V_197 ;
int V_61 ;
for ( V_61 = 0 ; ( V_61 < V_198 && V_171 -> V_195 [ V_61 ] ) ; V_61 ++ ) {
V_195 = V_171 -> V_195 [ V_61 ] ;
if ( V_195 -> V_199 == 0 )
continue;
V_196 = V_195 -> V_200 ;
V_197 = V_196 + ( V_195 -> V_199 - 1 ) ;
...
static void F_113 ( struct V_201 * V_202 )
{
int V_103 ;
struct V_130 * V_163 =
F_114 ( V_202 , struct V_130 , V_203 ) ;
struct V_22 * V_117 = F_68 ( V_163 ) ;
V_103 = F_115 ( V_117 , V_163 ) ;
if ( V_103 >= 0 ) {
V_163 -> V_204 = 1 ;
F_116 ( V_117 ) ;
V_163 -> V_204 = 0 ;
...
int F_118 ( struct V_22 * V_16 , int V_205 )
{
int V_61 , V_38 ;
struct V_170 * V_206 = NULL ;
struct V_130 * * V_207 = NULL ;
struct V_148 * V_149 = F_79 ( V_16 -> V_58 ) ;
int V_208 , V_209 ;
if ( V_16 -> V_210 == 0 || V_205 == - 1 )
V_205 = 0 ;
else {
for ( V_61 = 0 ; V_61 < V_16 -> V_122 . V_211 ; V_61 ++ ) {
if ( V_16 -> V_171 [ V_61 ] . V_20 . V_175 ==
V_205 ) {
V_206 = & V_16 -> V_171 [ V_61 ] ;
break;
}
}
}
...
V_208 = V_209 = 0 ;
if ( V_206 ) {
V_209 = V_206 -> V_20 . V_151 ;
V_207 = F_18 ( V_209 * sizeof( * V_207 ) ,
V_11 ) ;
if ( ! V_207 ) {
F_29 ( & V_16 -> V_16 , L_27 ) ;
return - V_31 ;
}
for (; V_208 < V_209 ; ++ V_208 ) {
V_207 [ V_208 ] = F_119 (
sizeof( struct V_130 ) ,
V_11 ) ;
if ( ! V_207 [ V_208 ] ) {
...
V_61 = V_16 -> V_213 - V_206 -> V_20 . V_214 * 2 ;
if ( V_61 < 0 )
F_50 ( & V_16 -> V_16 , L_28
L_29 ,
V_205 , - V_61 ) ;
...
F_121 ( V_16 ) ;
F_87 ( V_149 -> V_157 ) ;
if ( V_16 -> V_150 && F_97 ( V_16 ) ) {
F_29 ( & V_16 -> V_16 , L_18 , V_67 ) ;
F_89 ( V_149 -> V_157 ) ;
V_38 = - V_31 ;
goto V_212;
}
V_38 = F_88 ( V_16 , V_206 , NULL , NULL ) ;
if ( V_38 < 0 ) {
if ( V_16 -> V_150 )
F_99 ( V_16 ) ;
F_89 ( V_149 -> V_157 ) ;
...
for ( V_61 = 0 ; V_61 < V_209 ; ++ V_61 ) {
struct V_177 * V_178 ;
struct V_130 * V_131 ;
struct V_132 * V_133 ;
V_206 -> V_152 [ V_61 ] = V_131 = V_207 [ V_61 ] ;
V_178 = V_206 -> V_215 [ V_61 ] ;
...
V_133 = & V_131 -> V_172 [ 0 ] ;
V_131 -> V_195 =
F_112 ( V_16 , V_206 , V_133 -> V_20 . V_192 ) ;
V_131 -> V_134 = V_133 ;
F_93 ( V_16 , V_131 , true ) ;
V_131 -> V_16 . V_216 = & V_16 -> V_16 ;
V_131 -> V_16 . V_155 = NULL ;
V_131 -> V_16 . V_58 = & V_217 ;
V_131 -> V_16 . type = & V_218 ;
V_131 -> V_16 . V_219 = V_220 ;
V_131 -> V_16 . V_221 = V_16 -> V_16 . V_221 ;
F_124 ( & V_131 -> V_203 , F_113 ) ;
V_131 -> V_222 = - 1 ;
F_125 ( & V_131 -> V_16 ) ;
F_126 ( & V_131 -> V_16 ) ;
F_127 ( & V_131 -> V_16 , L_30 ,
V_16 -> V_58 -> V_223 , V_16 -> V_60 ,
V_205 , V_133 -> V_20 . V_192 ) ;
}
F_20 ( V_207 ) ;
V_38 = F_17 ( V_16 , F_65 ( V_16 , 0 ) ,
V_174 , 0 , V_205 , 0 ,
...
F_88 ( V_16 , NULL , NULL , NULL ) ;
for ( V_61 = 0 ; V_61 < V_209 ; ++ V_61 ) {
F_77 ( V_16 , V_206 -> V_152 [ V_61 ] , true ) ;
F_83 ( & V_206 -> V_152 [ V_61 ] -> V_16 ) ;
V_206 -> V_152 [ V_61 ] = NULL ;
}
V_206 = NULL ;
}
V_16 -> V_150 = V_206 ;
...
F_86 ( V_16 , V_153 ) ;
if ( V_206 -> string == NULL &&
! ( V_16 -> V_104 & V_224 ) )
V_206 -> string = F_60 ( V_16 , V_206 -> V_20 . V_225 ) ;
F_101 ( V_16 ) ;
F_128 ( V_16 ) ;
for ( V_61 = 0 ; V_61 < V_209 ; ++ V_61 ) {
struct V_130 * V_131 = V_206 -> V_152 [ V_61 ] ;
F_10 ( & V_16 -> V_16 ,
L_31 ,
F_81 ( & V_131 -> V_16 ) , V_205 ,
V_131 -> V_134 -> V_20 . V_192 ) ;
F_129 ( & V_131 -> V_16 ) ;
V_38 = F_130 ( & V_131 -> V_16 ) ;
if ( V_38 != 0 ) {
F_29 ( & V_16 -> V_16 , L_32 ,
...
static void F_131 ( struct V_201 * V_226 )
{
struct V_227 * V_228 =
F_114 ( V_226 , struct V_227 , V_226 ) ;
...
F_30 ( & V_229 ) ;
if ( V_228 -> V_171 >= - 1 )
F_118 ( V_117 , V_228 -> V_171 ) ;
F_117 ( V_117 ) ;
F_134 ( V_117 ) ;
F_20 ( V_228 ) ;
}
static void F_121 ( struct V_22 * V_117 )
{
struct V_227 * V_228 ;
F_28 ( & V_229 ) ;
F_135 (req, &set_config_list, node) {
if ( V_228 -> V_117 == V_117 )
V_228 -> V_171 = - 999 ;
}
F_30 ( & V_229 ) ;
}
int F_136 ( struct V_22 * V_117 , int V_171 )
{
struct V_227 * V_228 ;
...
V_228 -> V_117 = V_117 ;
V_228 -> V_171 = V_171 ;
F_124 ( & V_228 -> V_226 , F_131 ) ;
F_28 ( & V_229 ) ;
F_137 ( & V_228 -> V_230 , & V_231 ) ;
F_30 ( & V_229 ) ;
F_138 ( V_117 ) ;
F_139 ( & V_228 -> V_226 ) ;
return 0 ;
