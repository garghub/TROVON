...
V_2 -> V_128 =
F_105 ( V_2 -> V_44 , V_132 ) ;
F_106 ( V_2 -> V_43 , V_2 -> V_43 , V_127 ) ;
break;
}
V_45 = V_122 ;
V_135 = V_125 ;
...
if ( F_76 ( V_45 , V_138 ) )
goto V_74;
F_109 (new_cpu, tmp_mask, cpu_online_mask)
if ( F_110 ( V_139 , V_134 ) [ V_45 ] != - 1 )
goto V_74;
V_122 = V_45 ;
V_125 = V_135 ;
if ( V_2 -> V_45 ) {
F_111 ( V_2 -> V_44 , V_2 -> V_43 ) ;
V_2 -> V_128 =
F_105 ( V_2 -> V_44 , V_132 ) ;
}
F_109 (new_cpu, tmp_mask, cpu_online_mask)
F_110 ( V_139 , V_134 ) [ V_45 ] = V_47 ;
V_2 -> V_45 = V_45 ;
F_111 ( V_2 -> V_43 , V_127 ) ;
V_98 = 0 ;
break;
}
F_25 ( V_127 ) ;
...
int F_112 ( int V_47 , struct V_1 * V_2 , const struct V_121 * V_71 )
{
int V_98 ;
unsigned long V_68 ;
F_44 ( & V_120 , V_68 ) ;
...
static void F_113 ( int V_47 , struct V_1 * V_2 )
{
int V_126 , V_45 ;
F_114 ( ! V_2 -> V_45 ) ;
V_45 = V_2 -> V_45 ;
F_109 (cpu, cfg->domain, cpu_online_mask)
F_110 ( V_139 , V_126 ) [ V_45 ] = - 1 ;
V_2 -> V_45 = 0 ;
F_100 ( V_2 -> V_43 ) ;
if ( F_115 ( ! V_2 -> V_128 ) )
return;
F_109 (cpu, cfg->old_domain, cpu_online_mask) {
for ( V_45 = V_123 ; V_45 < V_140 ;
V_45 ++ ) {
if ( F_110 ( V_139 , V_126 ) [ V_45 ] != V_47 )
continue;
F_110 ( V_139 , V_126 ) [ V_45 ] = - 1 ;
break;
}
...
if ( ! V_2 )
continue;
if ( ! F_118 ( V_126 , V_2 -> V_43 ) )
continue;
V_45 = V_2 -> V_45 ;
F_110 ( V_139 , V_126 ) [ V_45 ] = V_47 ;
}
for ( V_45 = 0 ; V_45 < V_140 ; ++ V_45 ) {
V_47 = F_110 ( V_139 , V_126 ) [ V_45 ] ;
if ( V_47 < 0 )
continue;
V_2 = V_1 ( V_47 ) ;
if ( ! F_118 ( V_126 , V_2 -> V_43 ) )
...
static inline int F_119 ( int V_47 )
{
int V_54 , V_103 , V_62 ;
for ( V_54 = 0 ; V_54 < V_38 ; V_54 ++ ) {
for ( V_62 = 0 ; V_62 < V_8 [ V_54 ] . V_41 ; V_62 ++ ) {
...
static void F_120 ( unsigned int V_47 , struct V_1 * V_2 ,
unsigned long V_86 )
{
struct V_5 * V_6 = & V_142 ;
T_5 V_143 ;
bool V_144 ;
if ( ( V_86 == V_145 && F_119 ( V_47 ) ) ||
V_86 == V_91 ) {
F_121 ( V_47 , V_146 ) ;
V_144 = true ;
} else {
...
F_123 ( V_47 , V_6 , V_143 ,
V_144 ? L_17 : L_18 ) ;
}
static int F_124 ( int V_47 , struct V_40 * V_67 ,
unsigned int V_150 , int V_45 ,
struct V_116 * V_151 )
{
if ( V_152 )
return F_125 ( V_47 , V_67 , V_150 ,
V_45 , V_151 ) ;
...
static void F_126 ( unsigned int V_47 , struct V_1 * V_2 ,
struct V_116 * V_151 )
{
struct V_40 V_67 ;
unsigned int V_156 ;
...
if ( F_124 ( V_47 , & V_67 , V_156 , V_2 -> V_45 , V_151 ) ) {
F_83 ( L_22 ,
F_3 ( V_151 -> V_159 ) , V_151 -> V_160 ) ;
F_113 ( V_47 , V_2 ) ;
return;
}
F_120 ( V_47 , V_2 , V_151 -> V_86 ) ;
if ( V_47 < V_35 -> V_36 )
V_35 -> V_71 ( V_47 ) ;
...
return;
memset ( & V_67 , 0 , sizeof( V_67 ) ) ;
if ( F_107 ( V_54 -> V_158 ( V_54 -> V_157 () ,
V_54 -> V_157 () , & V_156 ) ) )
V_156 = V_162 ;
V_67 . V_154 = V_54 -> V_155 ;
V_67 . V_71 = 0 ;
...
int V_126 ;
F_44 ( & V_120 , V_68 ) ;
V_126 = F_101 ( V_2 -> V_43 , V_132 ) ;
V_54 -> V_202 ( F_161 ( V_126 ) , V_2 -> V_45 ) ;
F_45 ( & V_120 , V_68 ) ;
return 1 ;
}
...
{
T_4 V_203 ;
if ( F_107 ( ! F_99 ( & V_203 , V_130 ) ) ) {
unsigned int V_20 ;
F_109 (i, cfg->old_domain, cpu_online_mask)
V_54 -> V_202 ( F_161 ( V_20 ) , V_204 ) ;
} else {
F_106 ( V_203 , V_2 -> V_44 , V_132 ) ;
...
if ( V_2 -> V_128 )
goto V_209;
if ( V_45 == V_2 -> V_45 && F_118 ( V_205 , V_2 -> V_43 ) )
goto V_209;
...
if ( ! F_105 ( V_71 , V_132 ) )
return - V_216 ;
V_98 = F_112 ( V_47 , V_2 , V_71 ) ;
if ( V_98 )
return V_98 ;
V_98 = V_54 -> V_158 ( V_71 , V_2 -> V_43 , V_214 ) ;
if ( V_98 ) {
if ( F_112 ( V_47 , V_2 , V_59 -> V_217 ) )
F_16 ( L_37 , V_47 ) ;
return V_98 ;
}
F_111 ( V_59 -> V_217 , V_71 ) ;
return 0 ;
}
static int
F_180 ( struct V_83 * V_59 , const struct V_121 * V_71 ,
bool V_218 )
{
...
static void F_182 ( struct V_83 * V_59 )
{
F_174 ( V_59 -> V_84 ) ;
F_183 ( V_59 ) ;
F_164 () ;
...
static inline bool F_185 ( struct V_83 * V_59 , struct V_1 * V_2 )
{
if ( F_107 ( F_186 ( V_59 ) ) ) {
F_59 ( V_2 ) ;
return true ;
...
static inline void F_187 ( struct V_83 * V_59 ,
...
static void F_189 ( struct V_83 * V_59 )
{
struct V_1 * V_2 = V_59 -> V_84 ;
...
F_187 ( V_59 , V_2 , V_222 ) ;
}
static void F_191 ( struct V_83 * V_59 )
{
F_164 () ;
}
...
static void F_193 ( struct V_83 * V_59 , struct V_226 * V_227 )
{
F_194 ( V_227 , L_38 , V_59 -> V_6 -> V_228 ) ;
}
...
static void F_197 ( struct V_83 * V_59 )
{
unsigned long V_223 ;
V_223 = F_170 ( V_236 ) ;
F_198 ( V_236 , V_223 | V_237 ) ;
}
static void F_199 ( struct V_83 * V_59 )
{
unsigned long V_223 ;
V_223 = F_170 ( V_236 ) ;
F_198 ( V_236 , V_223 & ~ V_237 ) ;
...
static void F_201 ( int V_47 )
{
F_122 ( V_47 , V_146 ) ;
F_123 ( V_47 , & V_238 , V_149 ,
L_18 ) ;
}
...
V_240 = F_205 ( V_242 ) ;
V_241 = F_205 ( V_243 ) ;
F_206 ( ( V_241 & ~ V_244 ) | 0x6 ,
V_243 ) ;
F_206 ( V_240 | V_245 , V_242 ) ;
V_20 = 100 ;
while ( V_20 -- > 0 ) {
F_156 ( 10 ) ;
if ( ( F_205 ( V_246 ) & V_247 ) == V_247 )
V_20 -= 10 ;
}
F_206 ( V_240 , V_242 ) ;
F_206 ( V_241 , V_243 ) ;
...
static int T_1 F_207 ( char * V_163 )
{
V_248 = 1 ;
return 0 ;
}
...
F_209 ( V_68 ) ;
V_35 -> V_71 ( 0 ) ;
F_112 ( 0 , V_2 , V_54 -> V_157 () ) ;
F_198 ( V_236 , V_237 | V_254 ) ;
V_35 -> V_255 ( 1 ) ;
V_250 = F_75 ( 0 , V_141 ) ;
V_249 = F_77 ( 0 , V_141 ) ;
V_252 = V_170 . V_62 ;
...
F_210 () ;
V_35 -> V_71 ( 0 ) ;
F_198 ( V_236 , V_237 | V_260 | V_2 -> V_45 ) ;
...
static int T_1 F_216 ( void )
{
F_217 ( & V_266 ) ;
return 0 ;
}
unsigned int F_218 ( unsigned int V_53 , int V_32 )
{
struct V_1 * V_2 ;
unsigned long V_68 ;
...
int V_47 ;
V_269 = V_267 ;
V_47 = F_218 ( V_269 , V_32 ) ;
if ( V_47 == 0 )
V_47 = - 1 ;
return V_47 ;
}
void F_220 ( unsigned int V_47 )
{
struct V_1 * V_2 = F_23 ( V_47 ) ;
unsigned long V_68 ;
F_121 ( V_47 , V_268 | V_270 ) ;
if ( F_1 ( V_2 ) )
F_221 ( V_47 ) ;
F_44 ( & V_120 , V_68 ) ;
F_113 ( V_47 , V_2 ) ;
...
static int F_222 ( struct V_271 * V_272 , unsigned int V_47 ,
...
return - V_277 ;
V_2 = V_1 ( V_47 ) ;
V_98 = F_112 ( V_47 , V_2 , V_54 -> V_157 () ) ;
if ( V_98 )
return V_98 ;
...
return V_98 ;
if ( F_1 ( V_2 ) ) {
F_223 ( V_272 , V_47 , V_156 , V_274 , V_275 ) ;
return V_98 ;
}
if ( F_224 () )
V_274 -> V_278 = V_279 |
...
static int
F_228 ( struct V_83 * V_59 , const struct V_121 * V_71 , bool V_218 )
{
struct V_1 * V_2 = V_59 -> V_84 ;
struct V_273 V_274 ;
unsigned int V_156 ;
...
return - 1 ;
F_229 ( V_59 -> V_291 , & V_274 ) ;
V_274 . V_59 &= ~ V_292 ;
V_274 . V_59 |= F_227 ( V_2 -> V_45 ) ;
V_274 . V_280 &= ~ V_293 ;
V_274 . V_280 |= F_226 ( V_156 ) ;
F_230 ( V_59 -> V_291 , & V_274 ) ;
return V_220 ;
}
static int F_231 ( struct V_271 * V_294 , struct V_291 * V_295 , int V_47 )
{
struct V_5 * V_6 = & V_296 ;
struct V_273 V_274 ;
int V_219 ;
V_219 = F_222 ( V_294 , V_47 , & V_274 , - 1 ) ;
if ( V_219 < 0 )
return V_219 ;
F_232 ( V_47 , V_295 ) ;
F_233 ( V_47 , & V_274 ) ;
...
F_123 ( V_47 , V_6 , V_149 , L_18 ) ;
F_234 ( V_96 , & V_294 -> V_294 , L_60 , V_47 ) ;
return 0 ;
}
int F_235 ( struct V_271 * V_294 , int V_297 , int type )
{
...
return 1 ;
V_32 = F_236 ( & V_294 -> V_294 ) ;
V_269 = V_267 ;
V_298 = 0 ;
F_237 (msidesc, &dev->msi_list, list) {
V_47 = F_218 ( V_269 , V_32 ) ;
if ( V_47 == 0 )
return - 1 ;
V_269 = V_47 + 1 ;
...
goto V_300;
if ( ! V_298 ) {
V_58 = F_238 ( V_294 , V_47 , V_297 ) ;
if ( V_58 < 0 ) {
V_219 = V_58 ;
goto error;
}
} else {
V_219 = F_239 ( V_294 , V_47 , V_58 ,
V_298 ) ;
if ( V_219 < 0 )
goto error;
}
V_300:
V_219 = F_231 ( V_294 , V_295 , V_47 ) ;
if ( V_219 < 0 )
goto error;
V_298 ++ ;
}
...
void F_240 ( unsigned int V_47 )
{
F_220 ( V_47 ) ;
}
static int
F_241 ( struct V_83 * V_59 , const struct V_121 * V_71 ,
bool V_218 )
{
struct V_1 * V_2 = V_59 -> V_84 ;
unsigned int V_156 , V_47 = V_59 -> V_47 ;
...
V_274 . V_280 &= ~ V_293 ;
V_274 . V_280 |= F_226 ( V_156 ) ;
V_274 . V_278 = V_279 | F_225 ( V_156 ) ;
F_243 ( V_47 , & V_274 ) ;
return V_220 ;
}
int F_244 ( unsigned int V_47 )
{
int V_219 ;
struct V_273 V_274 ;
V_219 = F_222 ( NULL , V_47 , & V_274 , - 1 ) ;
if ( V_219 < 0 )
return V_219 ;
F_243 ( V_47 , & V_274 ) ;
F_123 ( V_47 , & V_301 , V_149 ,
L_18 ) ;
return 0 ;
}
static int F_245 ( struct V_83 * V_59 ,
...
int F_248 ( unsigned int V_47 , unsigned int V_303 )
{
struct V_5 * V_6 = & V_304 ;
struct V_273 V_274 ;
int V_219 ;
if ( V_152 ) {
V_219 = F_249 ( V_47 , V_303 ) ;
if ( V_219 )
return V_219 ;
}
V_219 = F_222 ( NULL , V_47 , & V_274 , V_303 ) ;
if ( V_219 < 0 )
return V_219 ;
F_247 ( F_250 ( V_47 ) , & V_274 ) ;
F_121 ( V_47 , V_147 ) ;
if ( F_1 ( F_23 ( V_47 ) ) )
F_2 ( V_6 ) ;
F_123 ( V_47 , V_6 , V_149 , L_18 ) ;
...
static void F_251 ( unsigned int V_47 , unsigned int V_156 , T_8 V_45 )
{
struct V_305 V_274 ;
F_252 ( V_47 , & V_274 ) ;
V_274 . V_280 &= ~ ( V_306 | V_307 ) ;
V_274 . V_278 &= ~ ( V_308 ) ;
V_274 . V_280 |= F_253 ( V_45 ) | F_254 ( V_156 ) ;
V_274 . V_278 |= F_255 ( V_156 ) ;
F_256 ( V_47 , & V_274 ) ;
}
static int
F_257 ( struct V_83 * V_59 , const struct V_121 * V_71 , bool V_218 )
{
struct V_1 * V_2 = V_59 -> V_84 ;
unsigned int V_156 ;
if ( F_178 ( V_59 , V_71 , & V_156 ) )
return - 1 ;
F_251 ( V_59 -> V_47 , V_156 , V_2 -> V_45 ) ;
return V_220 ;
}
int F_258 ( unsigned int V_47 , struct V_271 * V_294 )
{
struct V_1 * V_2 ;
struct V_305 V_274 ;
unsigned V_156 ;
...
F_123 ( V_47 , & V_316 ,
V_149 , L_18 ) ;
F_234 ( V_96 , & V_294 -> V_294 , L_61 , V_47 ) ;
return 0 ;
}
static int
...
if ( ! V_219 )
F_260 ( V_62 , V_8 [ V_7 ] . V_317 ) ;
return V_219 ;
}
static int T_1 F_261 ( int V_159 )
{
union V_318 V_319 ;
unsigned long V_68 ;
F_44 ( & V_69 , V_68 ) ;
...
int F_266 ( struct V_325 * V_294 , int V_47 ,
struct V_116 * V_117 )
{
int V_32 ;
if ( ! F_92 ( V_47 ) ) {
...
V_32 = V_294 ? F_236 ( V_294 ) : F_18 ( 0 ) ;
return F_134 ( V_47 , V_32 , V_117 ) ;
}
static int T_1 F_267 ( int V_159 , int V_326 )
{
union V_176 V_177 ;
...
static T_8 T_1 F_269 ( T_8 V_303 )
{
if ( ( V_190 . V_191 == V_192 ) &&
! F_151 ( V_193 [ V_194 ] ) )
return F_267 ( V_38 , V_303 ) ;
else
return V_303 ;
}
static T_8 T_1 F_269 ( T_8 V_303 )
...
F_271 ( V_329 , 256 ) ;
for ( V_20 = 0 ; V_20 < V_38 ; V_20 ++ ) {
F_272 ( F_3 ( V_20 ) , V_329 ) ;
}
if ( ! F_76 ( V_303 , V_329 ) )
return V_303 ;
return F_273 ( V_329 , 256 ) ;
}
static int T_1 F_274 ( int V_159 )
{
union V_318 V_319 ;
unsigned long V_68 ;
F_44 ( & V_69 , V_68 ) ;
...
int F_275 ( T_3 V_111 , int * V_86 , int * V_105 )
{
...
F_180 ( V_332 , V_71 , false ) ;
}
}
static struct V_333 * T_1 F_280 ( int V_38 )
{
unsigned long V_334 ;
struct V_333 * V_51 ;
char * V_335 ;
...
V_344:
#endif
V_340 = ( unsigned long ) F_283 ( V_345 ) ;
V_340 = F_284 ( V_340 ) ;
}
F_285 ( V_103 , V_340 ) ;
F_10 ( V_21 , L_76 ,
F_286 ( V_103 ) + ( V_340 & ~ V_346 ) ,
V_340 ) ;
V_103 ++ ;
V_342 -> V_347 = V_340 ;
...
return - 1 ;
V_110 = F_5 ( V_159 ) ;
if ( F_289 ( V_111 > V_110 -> V_352 ) )
return - 1 ;
return V_111 - V_110 -> V_112 ;
}
static T_1 int F_290 ( unsigned long V_353 )
{
if ( V_38 >= V_354 ) {
F_83 ( L_79 ,
V_354 , V_38 ) ;
...
static T_1 int F_291 ( int V_103 )
{
union V_176 V_177 ;
union V_318 V_319 ;
union V_355 V_356 ;
...
void T_1 F_292 ( int V_303 , T_3 V_353 , T_3 V_112 )
{
int V_103 = 0 ;
int V_320 ;
struct V_12 * V_110 ;
...
F_285 ( V_341 + V_103 , V_353 ) ;
if ( F_291 ( V_103 ) ) {
F_293 ( V_341 + V_103 ) ;
return;
}
V_8 [ V_103 ] . V_9 . V_10 = F_269 ( V_303 ) ;
V_8 [ V_103 ] . V_9 . V_359 = F_274 ( V_103 ) ;
V_320 = F_261 ( V_103 ) ;
V_110 = F_5 ( V_103 ) ;
V_110 -> V_112 = V_112 ;
