...
static int F_74 ( struct V_190 * V_190 , T_1 V_260 )
{
struct V_1 * V_5 = F_73 ( V_190 ) ;
struct V_2 * V_115 = V_5 -> V_115 ;
int V_249 ;
...
static int F_77 ( struct V_190 * V_190 ,
struct V_263 * V_189 ,
int * V_267 )
{
struct V_1 * V_5 = F_73 ( V_190 ) ;
struct V_2 * V_115 = V_5 -> V_115 ;
* V_267 = F_2 ( V_5 ) ;
F_15 ( V_115 -> V_104 , L_58 , V_105 , * V_267 ) ;
return 0 ;
}
...
if ( V_5 -> V_274 == V_275 )
V_271 = V_276 ;
F_81 ( V_5 -> V_277 , & V_5 -> V_278 , V_271 ) ;
}
return V_70 ;
}
...
V_287 = F_83 ( V_288 - ( int ) sizeof( * V_141 ) ,
( int ) F_9 ( V_141 -> V_292 ) ) ;
...
V_282 = F_84 ( * ( V_294 * ) V_286 -> V_282 ) ;
V_283 = F_85 ( V_286 -> V_295 ) ;
V_284 = F_85 ( V_286 -> V_284 ) ;
V_281 = F_86 ( V_5 -> V_189 . V_190 , V_182 , V_141 -> V_290 ,
V_282 , V_283 , V_284 , V_289 , V_287 , signal ,
V_96 ) ;
F_87 ( V_281 ) ;
return ( V_281 != NULL ) ;
}
static struct V_279 * F_88 (
struct V_279 * V_141 ,
...
static bool F_89 ( struct V_279 * V_141 ,
int V_288 , void * V_82 , int V_81 )
{
void * V_296 , * V_297 ;
...
static int F_80 ( struct V_2 * V_115 , T_2 * V_298 ,
bool * V_299 )
{
void * V_82 = NULL ;
struct V_300 * V_301 ;
...
V_288 = 0 ;
V_141 = F_88 ( V_301 -> V_141 , & V_288 , V_82 , V_81 ) ;
while ( F_89 ( V_141 , V_288 , V_82 , V_81 ) ) {
if ( F_82 ( V_115 , V_141 ) && V_298 &&
V_299 ) {
if ( F_69 ( V_141 -> V_290 , V_298 ) )
* V_299 = true ;
}
V_302 ++ ;
V_141 = F_88 ( V_141 , & V_288 , V_82 , V_81 ) ;
}
F_15 ( V_115 -> V_104 , L_63
L_64 , V_105 , V_238 , V_302 ) ;
V_305:
F_17 ( V_82 ) ;
return V_70 ;
}
static void F_90 ( struct V_307 * V_308 )
{
struct V_1 * V_5 =
F_91 ( V_308 , struct V_1 , V_278 . V_308 ) ;
struct V_2 * V_115 = V_5 -> V_115 ;
int V_70 ;
...
F_92 ( V_5 -> V_273 , V_70 < 0 ) ;
V_5 -> V_273 = NULL ;
}
static int F_93 ( struct V_190 * V_190 , struct V_253 * V_3 ,
struct V_309 * V_310 )
{
struct V_1 * V_5 = F_73 ( V_190 ) ;
struct V_2 * V_115 = V_5 -> V_115 ;
...
static int F_98 ( struct V_190 * V_190 , struct V_253 * V_3 ,
T_7 V_324 )
{
struct V_1 * V_5 = F_73 ( V_190 ) ;
struct V_2 * V_115 = V_5 -> V_115 ;
F_15 ( V_115 -> V_104 , L_76 , V_324 ) ;
V_5 -> V_325 = false ;
...
static int F_101 ( struct V_190 * V_190 , struct V_253 * V_3 )
{
struct V_1 * V_5 = F_73 ( V_190 ) ;
struct V_2 * V_115 = V_5 -> V_115 ;
...
static int F_102 ( struct V_190 * V_190 , struct V_253 * V_270 ,
...
struct V_1 * V_5 = F_73 ( V_190 ) ;
struct V_2 * V_115 = V_5 -> V_115 ;
F_15 ( V_115 -> V_104 , L_87 , V_105 , V_329 , V_330 ) ;
...
struct V_2 * V_115 = V_5 -> V_115 ;
struct V_213 V_191 ;
F_15 ( V_115 -> V_104 , L_88 , V_105 , V_329 ) ;
if ( V_329 >= V_196 )
return - V_217 ;
V_5 -> V_199 = V_329 ;
if ( F_3 ( V_5 , V_329 ) )
...
static int F_106 ( struct V_190 * V_190 , struct V_253 * V_3 ,
T_2 * V_290 , struct V_335 * V_336 )
{
struct V_1 * V_5 = F_73 ( V_190 ) ;
struct V_2 * V_115 = V_5 -> V_115 ;
if ( ! F_69 ( V_5 -> V_141 , V_290 ) )
return - V_217 ;
F_105 ( V_115 , V_336 ) ;
return 0 ;
}
...
static int F_108 ( struct V_190 * V_190 , struct V_253 * V_270 ,
struct V_246 * V_247 )
{
struct V_1 * V_5 = F_73 ( V_190 ) ;
struct V_2 * V_115 = V_5 -> V_115 ;
...
static int F_111 ( struct V_190 * V_190 , struct V_253 * V_270 ,
struct V_246 * V_247 )
{
struct V_1 * V_5 = F_73 ( V_190 ) ;
struct V_2 * V_115 = V_5 -> V_115 ;
...
static int F_113 ( struct V_190 * V_190 , struct V_253 * V_3 ,
...
L_95 , V_105 , V_70 , F_9 ( V_293 ) ,
F_25 ( F_9 ( V_293 ) ) ) ;
if ( V_145 ) {
V_283 = F_85 ( V_145 -> V_355 . V_356 ) ;
} else {
...
L_100
L_101 , V_105 , ( V_182 ? V_182 -> V_312 : - 1 ) ,
V_141 , ( T_1 ) V_282 , V_283 , V_188 , V_287 ,
V_139 . V_149 , signal ) ;
V_281 = F_86 ( V_5 -> V_189 . V_190 , V_182 , V_141 ,
...
if ( ! V_145 ) {
F_117 ( V_365 , & V_5 -> V_366 ) ;
F_118 ( V_5 -> V_277 , & V_5 -> V_308 ) ;
return;
}
...
V_141 , V_363 ? L_103 : L_104 ) ;
V_364 = false ;
F_80 ( V_115 , V_141 , & V_364 ) ;
if ( ! F_34 ( V_141 ) && ! V_364 ) {
F_115 ( V_115 , V_141 , V_145 ) ;
}
if ( V_5 -> V_179 == V_147 ) {
if ( ! V_363 )
F_120 ( V_115 -> V_104 , V_141 , V_362 ,
V_361 , V_355 ,
V_360 , 0 , V_96 ) ;
else
F_121 ( V_115 -> V_104 ,
...
static void F_127 ( struct V_307 * V_308 )
{
struct V_1 * V_5 =
F_91 ( V_308 , struct V_1 , V_308 ) ;
struct V_2 * V_115 = V_5 -> V_115 ;
if ( F_128 ( V_365 , & V_5 -> V_366 ) )
F_116 ( V_115 ) ;
if ( F_128 ( V_371 , & V_5 -> V_366 ) )
F_124 ( V_115 ) ;
if ( F_128 ( V_372 , & V_5 -> V_366 ) )
F_58 ( V_115 ) ;
}
static void F_129 ( struct V_253 * V_3 )
{
struct V_2 * V_115 = F_79 ( V_3 ) ;
struct V_1 * V_5 = F_1 ( V_115 ) ;
if ( F_130 ( V_372 , & V_5 -> V_366 ) )
return;
F_117 ( V_372 , & V_5 -> V_366 ) ;
F_118 ( V_5 -> V_277 , & V_5 -> V_308 ) ;
}
...
struct V_378 * V_379 ;
enum V_380 V_381 ;
if ( V_81 < F_132 ( struct V_373 , V_89 ) +
sizeof( struct V_378 ) ) {
...
V_90 = V_81 - F_132 ( struct V_373 , V_89 ) ;
...
F_136 ( V_115 -> V_104 , V_126 , V_392 -> V_141 ,
V_394 , V_233 ) ;
}
}
...
V_107 = F_132 ( struct V_396 , V_106 ) +
F_9 ( V_397 -> V_107 ) ;
...
return;
case V_403 :
F_131 ( V_115 , V_374 , V_81 ) ;
return;
case V_404 :
F_135 ( V_115 , V_374 , V_81 ) ;
return;
default:
...
static void F_138 ( struct V_2 * V_115 , void * V_405 , int V_90 )
{
struct V_1 * V_5 = F_1 ( V_115 ) ;
...
F_117 ( V_371 , & V_5 -> V_366 ) ;
F_118 ( V_5 -> V_277 , & V_5 -> V_308 ) ;
break;
case V_408 :
F_137 ( V_115 , V_397 , V_90 ) ;
break;
default:
...
static void F_140 ( struct V_2 * V_115 , T_5 V_293 )
{
struct V_1 * V_5 = F_1 ( V_115 ) ;
enum V_425 V_426 ;
...
return;
V_5 -> V_353 = V_293 ;
F_141 ( V_115 -> V_104 , V_426 , V_96 ) ;
}
static void F_142 ( struct V_307 * V_308 )
{
struct V_1 * V_5 =
F_91 ( V_308 , struct V_1 ,
V_432 . V_308 ) ;
struct V_2 * V_115 = V_5 -> V_115 ;
T_3 V_293 , V_133 ;
int V_81 , V_70 , V_433 ;
...
F_81 ( V_5 -> V_277 , & V_5 -> V_432 ,
V_434 ) ;
}
static void F_145 ( struct V_2 * V_115 , int V_274 )
{
struct V_1 * V_5 = F_1 ( V_115 ) ;
V_5 -> V_274 = V_274 ;
V_5 -> V_439 [ 0 ] = V_440 [ 0 ] ;
...
static int F_149 ( struct V_2 * V_115 , struct V_454 * V_455 )
{
struct V_190 * V_190 ;
struct V_1 * V_5 ;
int V_415 , V_81 ;
T_3 V_133 ;
V_190 = F_150 ( & V_456 , sizeof( struct V_1 ) ) ;
if ( ! V_190 )
return - V_97 ;
V_5 = F_73 ( V_190 ) ;
...
V_5 -> V_115 = V_115 ;
F_151 ( & V_5 -> V_99 ) ;
V_5 -> V_277 = F_152 ( L_140 ) ;
F_153 ( & V_5 -> V_308 , F_127 ) ;
F_154 ( & V_5 -> V_432 , F_142 ) ;
F_154 ( & V_5 -> V_278 , F_90 ) ;
V_415 = F_155 ( V_115 , V_455 , V_458 ) ;
if ( V_415 < 0 )
goto V_459;
...
V_5 -> V_473 . V_474 = F_157 ( V_470 ) ;
V_5 -> V_473 . V_475 = V_5 -> V_471 ;
V_5 -> V_473 . V_476 = F_157 ( V_472 ) ;
V_190 -> V_477 [ V_478 ] = & V_5 -> V_473 ;
V_190 -> V_479 = V_480 ;
memcpy ( V_5 -> V_481 , V_482 ,
sizeof( V_482 ) ) ;
V_190 -> V_481 = V_5 -> V_481 ;
V_190 -> V_483 = F_157 ( V_482 ) ;
F_158 ( V_190 , & V_115 -> V_484 -> V_3 ) ;
if ( F_159 ( V_190 ) ) {
V_415 = - V_485 ;
goto V_459;
}
...
static void F_165 ( struct V_2 * V_115 , struct V_454 * V_455 )
{
struct V_1 * V_5 = F_1 ( V_115 ) ;
F_35 ( V_115 , false ) ;
F_160 ( & V_5 -> V_432 ) ;
