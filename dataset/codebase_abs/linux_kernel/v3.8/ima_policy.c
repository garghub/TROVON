...
V_39 -> V_8 = V_87 ;
else if ( strcmp ( args [ 0 ] . V_84 , L_18 ) == 0 )
V_39 -> V_8 = V_88 ;
else
V_53 = - V_59 ;
if ( ! V_53 )
...
break;
case V_89 :
F_18 ( V_61 , L_19 , args [ 0 ] . V_84 ) ;
if ( V_39 -> V_9 )
V_53 = - V_59 ;
if ( ( strcmp ( args [ 0 ] . V_84 , L_20 ) ) == 0 )
V_39 -> V_9 = V_90 ;
else if ( strcmp ( args [ 0 ] . V_84 , L_21 ) == 0 )
V_39 -> V_9 = V_91 ;
else if ( strcmp ( args [ 0 ] . V_84 , L_22 ) == 0 )
V_39 -> V_9 = V_92 ;
else if ( strcmp ( args [ 0 ] . V_84 , L_23 ) == 0 )
V_39 -> V_9 = V_93 ;
else
V_53 = - V_59 ;
if ( ! V_53 )
...
if ( ! V_53 ) {
V_39 -> V_23 = F_27 ( F_28 () , ( V_96 ) V_71 ) ;
if ( ! F_26 ( V_39 -> V_23 ) || ( ( ( V_96 ) V_71 ) != V_71 ) )
V_53 = - V_59 ;
else
V_39 -> V_15 |= V_22 ;
}
...
V_53 = F_25 ( args [ 0 ] . V_84 , 10 , & V_71 ) ;
if ( ! V_53 ) {
V_39 -> V_25 = F_27 ( F_28 () , ( V_96 ) V_71 ) ;
if ( ! F_26 ( V_39 -> V_25 ) || ( ( ( V_96 ) V_71 ) != V_71 ) )
V_53 = - V_59 ;
else
V_39 -> V_15 |= V_24 ;
}
