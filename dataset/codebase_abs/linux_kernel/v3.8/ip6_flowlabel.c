...
V_62 = F_42 ( V_2 , V_34 , & V_68 , & V_69 , V_4 -> V_14 ,
& V_70 , & V_70 , & V_70 ) ;
if ( V_62 )
goto V_64;
V_62 = - V_63 ;
...
( ( V_101 -> V_10 == V_85 ) &&
F_55 ( V_101 -> V_12 . V_86 , V_4 -> V_12 . V_86 ) ) )
goto V_115;
V_62 = - V_63 ;
if ( ! F_56 ( & V_101 -> V_81 , & V_4 -> V_81 ) ||
...
goto V_114;
if ( ! V_56 . V_104 ) {
if ( F_57 ( & ( (struct V_55 T_3 * ) V_57 ) -> V_104 ,
...
static struct V_1 * F_58 ( struct V_118 * V_119 )
{
struct V_1 * V_4 = NULL ;
struct V_120 * V_121 = F_59 ( V_119 ) ;
struct V_2 * V_2 = F_60 ( V_119 ) ;
for ( V_121 -> V_122 = 0 ; V_121 -> V_122 <= V_27 ; ++ V_121 -> V_122 ) {
V_4 = V_5 [ V_121 -> V_122 ] ;
...
static struct V_1 * F_61 ( struct V_118 * V_119 , struct V_1 * V_4 )
{
struct V_120 * V_121 = F_59 ( V_119 ) ;
struct V_2 * V_2 = F_60 ( V_119 ) ;
V_4 = V_4 -> V_6 ;
...
static struct V_1 * F_62 ( struct V_118 * V_119 , T_4 V_124 )
{
struct V_1 * V_4 = F_58 ( V_119 ) ;
if ( V_4 )
while ( V_124 && ( V_4 = F_61 ( V_119 , V_4 ) ) != NULL )
-- V_124 ;
return V_124 ? NULL : V_4 ;
}
static void * F_63 ( struct V_118 * V_119 , T_4 * V_124 )
__acquires( V_8 )
{
F_5 ( & V_8 ) ;
return * V_124 ? F_62 ( V_119 , * V_124 - 1 ) : V_125 ;
}
static void * F_64 ( struct V_118 * V_119 , void * V_126 , T_4 * V_124 )
{
struct V_1 * V_4 ;
if ( V_126 == V_125 )
V_4 = F_58 ( V_119 ) ;
else
V_4 = F_61 ( V_119 , V_126 ) ;
++ * V_124 ;
return V_4 ;
}
static void F_65 ( struct V_118 * V_119 , void * V_126 )
__releases( V_8 )
{
F_7 ( & V_8 ) ;
}
static int F_66 ( struct V_118 * V_119 , void * V_126 )
{
struct V_120 * V_121 = F_59 ( V_119 ) ;
if ( V_126 == V_125 )
F_67 ( V_119 , L_1 ,
...
struct V_1 * V_4 = V_126 ;
F_67 ( V_119 ,
L_10 ,
( unsigned int ) F_68 ( V_4 -> V_3 ) ,
V_4 -> V_10 ,
( ( V_4 -> V_10 == V_11 ) ?
F_69 ( V_4 -> V_12 . V_13 , V_121 -> V_127 ) :
( ( V_4 -> V_10 == V_85 ) ?
F_70 ( F_71 ( V_119 ) , V_4 -> V_12 . V_86 ) :
0 ) ) ,
F_21 ( & V_4 -> V_9 ) ,
V_4 -> V_18 / V_52 ,
...
struct V_120 * V_121 ;
int V_62 ;
V_62 = F_73 ( V_128 , V_129 , & V_130 ,
sizeof( struct V_120 ) ) ;
if ( ! V_62 ) {
V_119 = V_129 -> V_131 ;
V_121 = F_59 ( V_119 ) ;
F_74 () ;
V_121 -> V_127 = F_75 ( F_76 ( V_83 ) ) ;
F_77 () ;
}
return V_62 ;
}
static int F_78 ( struct V_128 * V_128 , struct V_129 * V_129 )
{
struct V_118 * V_119 = V_129 -> V_131 ;
struct V_120 * V_121 = F_59 ( V_119 ) ;
F_79 ( V_121 -> V_127 ) ;
return F_80 ( V_128 , V_129 ) ;
}
...
static void T_2 F_83 ( struct V_2 * V_2 )
{
F_84 ( V_2 , L_11 ) ;
}
static inline int F_81 ( struct V_2 * V_2 )
{
return 0 ;
}
...
static void T_2 F_85 ( struct V_2 * V_2 )
{
F_26 ( V_2 ) ;
F_83 ( V_2 ) ;
}
