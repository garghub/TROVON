...
{
int V_8 ;
for ( V_8 = 0 ; V_8 < F_222 ( V_1354 ) ; V_8 ++ ) {
...
F_502 ( V_23 -> V_163 , & V_1354 [ V_8 ] ) ;
}
static int F_163 ( struct V_17 * V_23 )
{
int V_155 , V_7 ;
if ( V_23 -> V_1356 ) {
F_503 ( V_23 -> V_163 , V_23 -> V_1356 ) ;
V_23 -> V_1356 = 0 ;
}
if ( V_23 -> V_37 & V_700 )
return - V_306 ;
...
V_1362 -> V_869 = F_504 ( V_202 -> V_203 ,
...
V_1376 -> V_869 = F_504 ( V_202 -> V_209 ,
sizeof( struct V_1365 ) ,
V_148 ) ;
if ( ! V_1376 -> V_869 ) {
V_155 = - V_476 ;
...
static T_12 F_511 ( struct V_1005 * V_501 ,
struct V_165 * V_166 )
{
F_74 ( L_525 ) ;
F_239 ( V_501 ) ;
...
if ( V_23 -> V_157 )
return - V_160 ;
V_23 -> V_157 = F_512 ( sizeof( struct V_1383 ) , 1 ) ;
if ( V_23 -> V_157 == NULL )
return - V_476 ;
...
static int F_518 ( struct V_477 * V_1386 ,
...
F_521 ( V_1386 ) ;
V_557 = F_522 ( V_1386 , F_523 ( 32 ) ) ;
if ( ! V_557 )
V_557 = F_524 ( V_1386 , F_523 ( 32 ) ) ;
if ( V_557 ) {
F_4 (KERN_WARNING DRV_NAME L_527 ) ;
goto V_1392;
}
F_525 ( V_1386 , V_23 ) ;
V_557 = F_526 ( V_1386 , V_1325 ) ;
if ( V_557 )
goto V_1392;
F_527 ( V_1386 , 0x40 , & V_21 ) ;
if ( ( V_21 & 0x0000ff00 ) != 0 )
F_528 ( V_1386 , 0x40 , V_21 & 0xffff00ff ) ;
V_415 = F_529 ( V_1386 , 0 ) ;
V_23 -> V_1393 = V_415 ;
V_137 = F_530 ( V_1386 , 0 ) ;
if ( ! V_137 ) {
V_557 = - V_1390 ;
goto V_1394;
}
...
F_410 ( V_23 , 1 ) ;
V_557 = F_531 ( V_1386 -> V_1334 , F_483 , V_1396 , V_1325 , V_23 ) ;
if ( V_557 ) {
F_46 ( L_531 , V_1386 -> V_1334 ) ;
goto V_1395;
}
F_514 ( V_167 , & V_1386 -> V_166 ) ;
F_59 ( & V_23 -> V_109 ) ;
...
V_167 -> V_1406 = & V_1407 ;
V_167 -> V_1408 = & V_1409 ;
V_557 = F_532 ( & V_1386 -> V_166 . V_1410 , & V_1411 ) ;
if ( V_557 ) {
F_46 ( L_532 ) ;
F_60 ( & V_23 -> V_109 ) ;
goto V_1412;
...
V_1413:
F_534 ( & V_1386 -> V_166 . V_1410 , & V_1411 ) ;
V_1412:
F_535 ( V_1386 -> V_1334 , V_23 ) ;
V_1395:
F_536 ( V_23 -> V_22 ) ;
V_1394:
F_537 ( V_1386 ) ;
...
static void F_539 ( struct V_477 * V_1386 )
{
struct V_17 * V_23 = F_540 ( V_1386 ) ;
...
static int F_543 ( struct V_477 * V_1386 , T_15 V_664 )
{
struct V_17 * V_23 = F_540 ( V_1386 ) ;
struct V_165 * V_166 = V_23 -> V_167 ;
F_4 ( V_1312 L_537 , V_166 -> V_158 ) ;
F_161 ( V_23 ) ;
F_544 ( V_166 ) ;
F_545 ( V_1386 ) ;
F_538 ( V_1386 ) ;
F_546 ( V_1386 , F_547 ( V_1386 , V_664 ) ) ;
V_23 -> V_1415 = F_548 () ;
return 0 ;
}
static int F_549 ( struct V_477 * V_1386 )
{
struct V_17 * V_23 = F_540 ( V_1386 ) ;
struct V_165 * V_166 = V_23 -> V_167 ;
int V_557 ;
...
F_528 ( V_1386 , 0x40 , V_21 & 0xffff00ff ) ;
F_551 ( V_166 ) ;
V_23 -> V_1356 = F_548 () - V_23 -> V_1415 ;
F_128 ( & V_23 -> V_193 ) ;
return 0 ;
}
static void F_552 ( struct V_477 * V_1386 )
{
struct V_17 * V_23 = F_540 ( V_1386 ) ;
F_161 ( V_23 ) ;
F_538 ( V_1386 ) ;
...
V_432 = F_555 ( & V_1417 . V_1324 , & V_1418 ) ;
if ( V_432 ) {
F_46 ( L_543 ) ;
F_556 ( & V_1417 ) ;
return V_432 ;
