...
if ( ! ( V_86 -> V_92 & V_93 ) ) {
V_86 -> V_92 |= V_93 ;
if ( F_52 ( & V_86 -> V_94 , V_89 , V_7 , 0 ) == 0 )
F_53 ( V_7 , V_89 ) ;
}
F_54 ( & V_86 -> V_91 ) ;
...
static void F_58 ( struct V_87 * V_86 )
{
struct V_6 * V_7 = V_86 -> V_31 -> V_7 ;
char V_89 [ V_90 ] ;
F_51 ( & V_86 -> V_91 ) ;
...
static void F_64 ( struct V_30 * V_31 , struct V_87 * V_101 )
{
struct V_87 * V_43 ;
V_43 = F_65 ( sizeof( * V_43 ) , V_67 ) ;
if ( ! V_43 )
return;
F_51 ( & V_101 -> V_91 ) ;
F_66 ( & V_43 -> V_91 ) ;
...
static void F_68 ( struct V_30 * V_31 , const struct V_4 * V_111 )
{
...
V_86 -> V_116 ++ ;
F_72 ( & V_31 -> V_36 ) ;
F_33 ( V_31 , & V_86 -> V_94 , V_24 , 0 ,
NULL , 0 ) ;
F_48 ( V_31 ) ;
return 0 ;
}
}
V_86 = F_65 ( sizeof( struct V_87 ) , V_67 ) ;
if ( V_86 == NULL ) {
F_72 ( & V_31 -> V_36 ) ;
F_48 ( V_31 ) ;
return - V_17 ;
}
F_73 ( & V_86 -> V_100 , V_117 , ( unsigned long ) V_86 ) ;
V_86 -> V_94 = * V_5 ;
V_86 -> V_31 = V_31 ;
V_86 -> V_116 = 1 ;
...
bool F_78 ( struct V_126 * V_127 , int V_128 )
{
struct V_129 * V_130 ;
if ( V_128 != V_131 )
return false ;
if ( ! F_79 ( V_127 , sizeof( struct V_129 ) ) )
return false ;
V_130 = F_80 ( V_127 ) ;
switch ( V_130 -> V_132 ) {
case V_133 :
...
bool F_81 ( struct V_6 * V_7 , const struct V_4 * V_35 ,
const struct V_4 * V_85 )
{
struct V_30 * V_31 ;
struct V_87 * V_86 ;
...
{
int V_139 = F_84 () % V_31 -> V_140 ;
V_31 -> V_141 = 1 ;
if ( ! F_85 ( & V_31 -> V_142 , V_120 + V_139 + 2 ) )
F_67 ( V_31 ) ;
}
static void F_86 ( struct V_30 * V_31 , int V_143 )
{
int V_139 = F_84 () % V_143 ;
if ( ! F_85 ( & V_31 -> V_144 , V_120 + V_139 + 2 ) )
F_67 ( V_31 ) ;
}
static void F_87 ( struct V_87 * V_123 , unsigned long V_145 )
{
unsigned long V_143 = V_145 ;
if ( F_75 ( & V_123 -> V_94 ) ||
F_76 ( & V_123 -> V_94 ) < V_122 )
return;
if ( F_61 ( & V_123 -> V_100 ) ) {
F_62 ( & V_123 -> V_88 ) ;
...
if ( ! F_85 ( & V_123 -> V_100 , V_120 + V_143 ) )
F_88 ( & V_123 -> V_88 ) ;
V_123 -> V_92 |= V_147 ;
}
static bool F_89 ( struct V_87 * V_43 , int V_148 ,
...
static bool F_90 ( struct V_87 * V_43 , int V_148 ,
const struct V_4 * V_149 )
{
struct V_103 * V_104 ;
int V_47 , V_150 ;
if ( V_43 -> V_102 == V_24 )
return F_89 ( V_43 , V_148 , V_149 ) ;
V_150 = 0 ;
for ( V_104 = V_43 -> V_106 ; V_104 ; V_104 = V_104 -> V_107 ) {
if ( V_150 == V_148 )
break;
...
int V_159 = 0 ;
int V_160 ;
if ( ! F_79 ( V_127 , sizeof( struct V_4 ) ) )
return - V_14 ;
V_160 = F_92 ( F_93 ( V_127 ) -> V_161 ) + sizeof( struct V_162 ) ;
V_160 -= F_94 ( V_127 ) ;
if ( ! ( F_95 ( & F_93 ( V_127 ) -> V_163 ) & V_164 ) )
return - V_14 ;
V_31 = F_22 ( V_127 -> V_7 ) ;
if ( V_31 == NULL )
return 0 ;
V_157 = (struct V_156 * ) F_80 ( V_127 ) ;
V_35 = & V_157 -> V_165 ;
V_158 = F_95 ( V_35 ) ;
if ( V_158 != V_166 &&
! ( V_158 & V_167 ) )
...
if ( V_160 == 24 ) {
int V_168 ;
V_155 = ( F_92 ( V_157 -> V_169 ) * V_170 ) / 1000 ;
...
if ( ! F_79 ( V_127 , V_173 ) )
return - V_14 ;
V_154 = (struct V_153 * ) F_97 ( V_127 ) ;
V_155 = ( F_98 ( F_92 ( V_154 -> V_174 ) ) * V_170 ) / 1000 ;
if ( ! V_155 )
V_155 = 1 ;
V_31 -> V_140 = V_155 ;
if ( V_154 -> V_175 )
...
if ( V_154 -> V_176 != 0 ) {
if ( ! F_79 ( V_127 , V_173 +
F_92 ( V_154 -> V_176 ) * sizeof( struct V_4 ) ) )
return - V_14 ;
V_154 = (struct V_153 * ) F_97 ( V_127 ) ;
V_159 = 1 ;
}
...
if ( ! ( V_123 -> V_92 & V_151 ) ||
F_90 ( V_123 , F_92 ( V_154 -> V_176 ) , V_154 -> V_177 ) )
F_87 ( V_123 , V_155 ) ;
F_54 ( & V_123 -> V_91 ) ;
break;
}
...
V_127 -> V_179 != V_182 )
return 0 ;
if ( ! F_79 ( V_127 , sizeof( * V_157 ) - sizeof( struct V_129 ) ) )
return - V_14 ;
V_157 = (struct V_156 * ) F_80 ( V_127 ) ;
V_178 = F_95 ( & F_93 ( V_127 ) -> V_163 ) ;
if ( V_178 != V_166 &&
! ( V_178 & V_164 ) )
return - V_14 ;
V_31 = F_22 ( V_127 -> V_7 ) ;
...
static bool F_100 ( struct V_87 * V_43 , struct V_103 * V_104 , int type ,
int V_184 , int V_185 )
{
switch ( type ) {
case V_186 :
...
static int
F_101 ( struct V_87 * V_43 , int type , int V_184 , int V_185 )
{
struct V_103 * V_104 ;
int V_150 = 0 ;
for ( V_104 = V_43 -> V_106 ; V_104 ; V_104 = V_104 -> V_107 ) {
if ( ! F_100 ( V_43 , V_104 , type , V_184 , V_185 ) )
continue;
V_150 ++ ;
}
return V_150 ;
}
static struct V_126 * F_102 ( struct V_6 * V_7 , int V_192 )
{
struct V_12 * V_12 = F_103 ( V_7 ) ;
...
V_203 , 0 } ;
V_192 += V_198 + V_199 ;
V_192 = F_105 ( int , V_192 , F_106 ( 0 , 0 ) ) ;
V_127 = F_107 ( V_2 , V_192 , 1 , & V_13 ) ;
if ( ! V_127 )
return NULL ;
F_108 ( V_127 , V_198 ) ;
if ( F_109 ( V_7 , & V_197 , V_204 ) ) {
V_163 = & V_205 ;
} else
V_163 = & V_197 ;
F_110 ( V_2 , V_127 , V_7 , V_163 , & V_206 , V_207 , 0 ) ;
memcpy ( F_111 ( V_127 , sizeof( V_201 ) ) , V_201 , sizeof( V_201 ) ) ;
F_112 ( V_127 , F_113 ( V_127 ) - V_127 -> V_208 ) ;
F_111 ( V_127 , sizeof( * V_196 ) ) ;
V_196 = (struct V_195 * ) F_97 ( V_127 ) ;
V_196 -> V_209 = V_136 ;
V_196 -> V_210 = 0 ;
V_196 -> V_211 = 0 ;
V_196 -> V_212 = 0 ;
...
static void F_114 ( struct V_126 * V_127 )
{
struct V_162 * V_214 = F_93 ( V_127 ) ;
struct V_195 * V_196 =
(struct V_195 * ) F_97 ( V_127 ) ;
int V_161 , V_215 ;
struct V_30 * V_31 ;
struct V_12 * V_12 = F_103 ( V_127 -> V_7 ) ;
int V_13 ;
struct V_216 V_217 ;
struct V_218 * V_21 ;
F_5 () ;
V_31 = F_22 ( V_127 -> V_7 ) ;
F_115 ( V_12 , V_31 , V_219 , V_127 -> V_160 ) ;
V_161 = ( V_127 -> V_220 - V_127 -> V_221 ) - sizeof( * V_214 ) ;
V_215 = V_127 -> V_220 - V_127 -> V_222 ;
V_214 -> V_161 = F_116 ( V_161 ) ;
V_196 -> V_211 = F_117 ( & V_214 -> V_163 , & V_214 -> V_223 , V_215 ,
V_131 ,
F_118 ( F_97 ( V_127 ) ,
V_215 , 0 ) ) ;
F_119 ( V_12 -> V_193 . V_194 , & V_217 , V_136 ,
& F_93 ( V_127 ) -> V_163 , & F_93 ( V_127 ) -> V_223 ,
V_127 -> V_7 -> V_3 ) ;
V_21 = F_120 ( V_127 -> V_7 , NULL , & V_217 ) ;
V_13 = 0 ;
if ( F_121 ( V_21 ) ) {
V_13 = F_122 ( V_21 ) ;
V_21 = NULL ;
...
goto V_224;
V_161 = V_127 -> V_160 ;
V_13 = F_124 ( V_225 , V_226 , V_127 , NULL , V_127 -> V_7 ,
V_227 ) ;
V_228:
if ( ! V_13 ) {
F_125 ( V_12 , V_31 , V_136 ) ;
F_126 ( V_12 , V_31 , V_229 ) ;
F_127 ( V_12 , V_31 , V_230 , V_161 ) ;
} else
F_128 ( V_12 , V_31 , V_231 ) ;
F_8 () ;
return;
V_224:
F_129 ( V_127 ) ;
...
static int F_130 ( struct V_87 * V_43 , int type , int V_232 , int V_233 )
{
return sizeof( struct V_234 ) + 16 * F_101 ( V_43 , type , V_232 , V_233 ) ;
}
...
struct V_234 * V_236 ;
if ( ! V_127 )
V_127 = F_102 ( V_7 , V_7 -> V_237 ) ;
if ( ! V_127 )
return NULL ;
V_236 = (struct V_234 * ) F_111 ( V_127 , sizeof( struct V_234 ) ) ;
V_236 -> V_238 = type ;
V_236 -> V_239 = 0 ;
V_236 -> V_240 = 0 ;
V_236 -> V_241 = V_43 -> V_94 ;
V_196 = (struct V_195 * ) F_97 ( V_127 ) ;
V_196 -> V_213 = F_116 ( F_92 ( V_196 -> V_213 ) + 1 ) ;
* V_235 = V_236 ;
return V_127 ;
}
static struct V_126 * F_132 ( struct V_126 * V_127 , struct V_87 * V_43 ,
...
if ( ! * V_243 )
goto V_248;
V_196 = V_127 ? (struct V_195 * ) F_97 ( V_127 ) : NULL ;
if ( V_247 ) {
if ( V_196 && V_196 -> V_213 &&
F_133 ( V_127 ) < F_130 ( V_43 , type , V_184 , V_185 ) ) {
if ( V_127 )
F_114 ( V_127 ) ;
V_127 = F_102 ( V_7 , V_7 -> V_237 ) ;
}
...
if ( V_246 )
V_104 -> V_152 = 0 ;
if ( F_133 ( V_127 ) < sizeof( * V_249 ) +
V_245 * sizeof( struct V_234 ) ) {
if ( V_247 && ! V_245 )
break;
if ( V_236 )
V_236 -> V_240 = F_116 ( V_150 ) ;
if ( V_127 )
F_114 ( V_127 ) ;
V_127 = F_102 ( V_7 , V_7 -> V_237 ) ;
V_245 = 1 ;
...
if ( V_245 ) {
V_127 = F_131 ( V_127 , V_43 , type , & V_236 ) ;
V_245 = 0 ;
}
if ( ! V_127 )
return NULL ;
V_249 = (struct V_4 * ) F_111 ( V_127 , sizeof( * V_249 ) ) ;
* V_249 = V_104 -> V_137 ;
V_150 ++ ; V_244 ++ ;
if ( ( type == V_190 ||
...
return V_127 ;
if ( V_43 -> V_98 || V_246 ) {
if ( V_127 && F_133 ( V_127 ) < sizeof( struct V_234 ) ) {
F_114 ( V_127 ) ;
V_127 = NULL ;
}
V_127 = F_131 ( V_127 , V_43 , type , & V_236 ) ;
...
static void F_134 ( struct V_30 * V_31 , struct V_87 * V_43 )
{
...
type = V_186 ;
V_127 = F_132 ( V_127 , V_43 , type , 0 , 0 ) ;
F_54 ( & V_43 -> V_91 ) ;
}
F_29 ( & V_31 -> V_36 ) ;
} else {
...
static void F_135 ( struct V_103 * * V_250 )
{
...
static void F_136 ( struct V_30 * V_31 )
{
...
type = V_191 ;
V_252 = V_191 ;
V_127 = F_132 ( V_127 , V_43 , type , 1 , 0 ) ;
V_127 = F_132 ( V_127 , V_43 , V_252 , 1 , 1 ) ;
}
if ( V_43 -> V_98 ) {
if ( V_43 -> V_102 == V_24 ) {
type = V_188 ;
...
V_127 = F_132 ( V_127 , V_43 , type , 0 , 0 ) ;
V_127 = F_132 ( V_127 , V_43 , V_252 , 0 , 1 ) ;
if ( V_43 -> V_98 ) {
if ( V_43 -> V_102 == V_24 )
type = V_189 ;
else
...
static void F_137 ( struct V_4 * V_5 , struct V_6 * V_7 , int type )
{
struct V_12 * V_12 = F_103 ( V_7 ) ;
struct V_1 * V_2 = V_12 -> V_193 . V_194 ;
struct V_30 * V_31 ;
...
V_219 , V_255 ) ;
F_8 () ;
V_127 = F_107 ( V_2 , V_198 + V_199 + V_255 , 1 , & V_13 ) ;
if ( V_127 == NULL ) {
F_5 () ;
F_138 ( V_12 , F_22 ( V_7 ) ,
V_231 ) ;
...
V_163 = & V_197 ;
F_110 ( V_2 , V_127 , V_7 , V_163 , V_254 , V_207 , V_161 ) ;
memcpy ( F_111 ( V_127 , sizeof( V_201 ) ) , V_201 , sizeof( V_201 ) ) ;
V_253 = (struct V_156 * ) F_111 ( V_127 , sizeof( struct V_156 ) ) ;
memset ( V_253 , 0 , sizeof( struct V_156 ) ) ;
V_253 -> V_257 = type ;
V_253 -> V_165 = * V_5 ;
V_253 -> V_258 = F_117 ( V_163 , V_254 , V_160 ,
V_131 ,
F_118 ( V_253 , V_160 , 0 ) ) ;
F_5 () ;
V_31 = F_22 ( V_127 -> V_7 ) ;
F_119 ( V_2 , & V_217 , type ,
& F_93 ( V_127 ) -> V_163 , & F_93 ( V_127 ) -> V_223 ,
V_127 -> V_7 -> V_3 ) ;
V_21 = F_120 ( V_127 -> V_7 , NULL , & V_217 ) ;
if ( F_121 ( V_21 ) ) {
...
V_228:
if ( ! V_13 ) {
F_139 ( V_12 , V_31 , type ) ;
F_140 ( V_12 , V_31 , V_229 ) ;
F_115 ( V_12 , V_31 , V_230 , V_255 ) ;
} else
F_138 ( V_12 , V_31 , V_231 ) ;
F_8 () ;
return;
V_224:
F_129 ( V_127 ) ;
...
static int F_141 ( struct V_87 * V_43 , int V_23 ,
...
static int F_34 ( struct V_30 * V_31 , const struct V_4 * V_111 ,
...
int V_49 = F_141 ( V_43 , V_23 , & V_259 [ V_47 ] ) ;
V_264 |= V_49 > 0 ;
if ( ! V_13 && V_49 < 0 )
V_13 = V_49 ;
}
...
V_104 -> V_108 = 0 ;
F_57 ( V_43 -> V_31 ) ;
} else if ( F_143 ( V_43 ) || V_264 )
F_57 ( V_43 -> V_31 ) ;
F_54 ( & V_43 -> V_91 ) ;
F_29 ( & V_31 -> V_36 ) ;
return V_13 ;
}
static int F_144 ( struct V_87 * V_43 , int V_23 ,
const struct V_4 * V_259 )
{
struct V_103 * V_104 , * V_242 ;
V_242 = NULL ;
...
static void F_142 ( struct V_87 * V_43 )
{
struct V_103 * V_104 ;
...
static int F_143 ( struct V_87 * V_43 )
{
...
V_13 = 0 ;
for ( V_47 = 0 ; V_47 < V_262 ; V_47 ++ ) {
V_13 = F_144 ( V_43 , V_23 , & V_259 [ V_47 ] ) ;
if ( V_13 )
break;
}
if ( V_13 ) {
...
static void F_63 ( struct V_87 * V_43 )
{
...
static void F_56 ( struct V_87 * V_123 )
{
unsigned long V_143 ;
if ( V_123 -> V_92 & V_97 )
return;
F_137 ( & V_123 -> V_94 , V_123 -> V_31 -> V_7 , V_134 ) ;
V_143 = F_84 () % V_272 ;
F_51 ( & V_123 -> V_91 ) ;
if ( F_61 ( & V_123 -> V_100 ) ) {
F_62 ( & V_123 -> V_88 ) ;
...
int V_13 ;
if ( ! V_273 -> V_26 ) {
return F_34 ( V_31 , & V_273 -> V_5 , V_273 -> V_23 , 0 , NULL , 0 ) ;
}
V_13 = F_34 ( V_31 , & V_273 -> V_5 , V_273 -> V_23 ,
V_273 -> V_26 -> V_58 , V_273 -> V_26 -> V_59 , 0 ) ;
F_13 ( V_2 , V_273 -> V_26 , F_36 ( V_273 -> V_26 -> V_63 ) ) ;
V_273 -> V_26 = NULL ;
return V_13 ;
}
static void F_60 ( struct V_87 * V_123 )
{
if ( F_55 ( V_123 -> V_31 ) ) {
if ( V_123 -> V_92 & V_183 )
F_137 ( & V_123 -> V_94 , V_123 -> V_31 -> V_7 ,
V_135 ) ;
} else {
F_64 ( V_123 -> V_31 , V_123 ) ;
F_57 ( V_123 -> V_31 ) ;
}
}
...
F_66 ( & V_31 -> V_109 ) ;
V_31 -> V_141 = 0 ;
F_73 ( & V_31 -> V_142 , F_146 ,
( unsigned long ) V_31 ) ;
V_31 -> V_110 = NULL ;
V_31 -> V_172 = 0 ;
F_73 ( & V_31 -> V_144 , F_147 ,
( unsigned long ) V_31 ) ;
V_31 -> V_99 = V_274 ;
V_31 -> V_140 = V_272 ;
V_31 -> V_171 = 0 ;
...
static inline struct V_87 * F_154 ( struct V_278 * V_279 )
{
struct V_87 * V_101 = NULL ;
struct V_280 * V_281 = F_155 ( V_279 ) ;
struct V_12 * V_12 = F_156 ( V_279 ) ;
V_281 -> V_31 = NULL ;
F_157 (net, state->dev) {
struct V_30 * V_31 ;
V_31 = F_22 ( V_281 -> V_7 ) ;
...
static struct V_87 * F_158 ( struct V_278 * V_279 , struct V_87 * V_101 )
{
struct V_280 * V_281 = F_155 ( V_279 ) ;
V_101 = V_101 -> V_18 ;
while ( ! V_101 ) {
if ( F_159 ( V_281 -> V_31 != NULL ) )
F_29 ( & V_281 -> V_31 -> V_36 ) ;
V_281 -> V_7 = F_160 ( V_281 -> V_7 ) ;
if ( ! V_281 -> V_7 ) {
V_281 -> V_31 = NULL ;
break;
}
...
static struct V_87 * F_161 ( struct V_278 * V_279 , T_4 V_282 )
{
struct V_87 * V_101 = F_154 ( V_279 ) ;
if ( V_101 )
while ( V_282 && ( V_101 = F_158 ( V_279 , V_101 ) ) != NULL )
-- V_282 ;
return V_282 ? NULL : V_101 ;
}
static void * F_162 ( struct V_278 * V_279 , T_4 * V_282 )
__acquires( T_5 )
{
F_5 () ;
return F_161 ( V_279 , * V_282 ) ;
}
static void * F_163 ( struct V_278 * V_279 , void * V_283 , T_4 * V_282 )
{
struct V_87 * V_101 = F_158 ( V_279 , V_283 ) ;
++ * V_282 ;
return V_101 ;
}
static void F_164 ( struct V_278 * V_279 , void * V_283 )
__releases( T_5 )
{
struct V_280 * V_281 = F_155 ( V_279 ) ;
if ( F_159 ( V_281 -> V_31 != NULL ) ) {
...
static int F_165 ( struct V_278 * V_279 , void * V_283 )
{
...
( V_101 -> V_92 & V_147 ) ?
F_167 ( V_101 -> V_100 . V_146 - V_120 ) : 0 ) ;
return 0 ;
}
static int F_168 ( struct V_285 * V_285 , struct V_286 * V_286 )
{
return F_169 ( V_285 , V_286 , & V_287 ,
sizeof( struct V_280 ) ) ;
}
static inline struct V_103 * F_170 ( struct V_278 * V_279 )
{
struct V_103 * V_104 = NULL ;
struct V_87 * V_101 = NULL ;
struct V_288 * V_281 = F_171 ( V_279 ) ;
struct V_12 * V_12 = F_156 ( V_279 ) ;
V_281 -> V_31 = NULL ;
V_281 -> V_101 = NULL ;
F_157 (net, state->dev) {
...
static struct V_103 * F_173 ( struct V_278 * V_279 , struct V_103 * V_104 )
{
struct V_288 * V_281 = F_171 ( V_279 ) ;
V_104 = V_104 -> V_107 ;
while ( ! V_104 ) {
F_54 ( & V_281 -> V_101 -> V_91 ) ;
...
if ( ! V_281 -> V_101 )
break;
F_51 ( & V_281 -> V_101 -> V_91 ) ;
V_104 = V_281 -> V_101 -> V_106 ;
}
V_228:
return V_104 ;
}
static struct V_103 * F_174 ( struct V_278 * V_279 , T_4 V_282 )
{
struct V_103 * V_104 = F_170 ( V_279 ) ;
if ( V_104 )
while ( V_282 && ( V_104 = F_173 ( V_279 , V_104 ) ) != NULL )
-- V_282 ;
return V_282 ? NULL : V_104 ;
}
static void * F_175 ( struct V_278 * V_279 , T_4 * V_282 )
__acquires( T_5 )
{
F_5 () ;
return * V_282 ? F_174 ( V_279 , * V_282 - 1 ) : V_289 ;
}
static void * F_176 ( struct V_278 * V_279 , void * V_283 , T_4 * V_282 )
{
struct V_103 * V_104 ;
if ( V_283 == V_289 )
V_104 = F_170 ( V_279 ) ;
else
V_104 = F_173 ( V_279 , V_283 ) ;
++ * V_282 ;
return V_104 ;
}
static void F_177 ( struct V_278 * V_279 , void * V_283 )
__releases( T_5 )
{
struct V_288 * V_281 = F_171 ( V_279 ) ;
if ( F_159 ( V_281 -> V_101 != NULL ) ) {
F_54 ( & V_281 -> V_101 -> V_91 ) ;
V_281 -> V_101 = NULL ;
}
if ( F_159 ( V_281 -> V_31 != NULL ) ) {
...
static int F_178 ( struct V_278 * V_279 , void * V_283 )
{
...
static int F_179 ( struct V_285 * V_285 , struct V_286 * V_286 )
{
return F_169 ( V_285 , V_286 , & V_290 ,
sizeof( struct V_288 ) ) ;
}
static int T_6 F_180 ( struct V_12 * V_12 )
{
int V_13 ;
V_13 = - V_17 ;
if ( ! F_181 ( V_12 , L_11 , V_291 , & V_292 ) )
goto V_228;
if ( ! F_181 ( V_12 , L_12 , V_291 ,
& V_293 ) )
goto V_294;
V_13 = 0 ;
V_228:
...
static void T_7 F_183 ( struct V_12 * V_12 )
{
F_182 ( V_12 , L_12 ) ;
F_182 ( V_12 , L_11 ) ;
}
static inline int F_180 ( struct V_12 * V_12 )
{
return 0 ;
}
static inline void F_183 ( struct V_12 * V_12 )
{
}
static int T_6 F_184 ( struct V_12 * V_12 )
{
int V_13 ;
V_13 = F_185 ( & V_12 -> V_193 . V_194 , V_295 ,
V_296 , V_131 , V_12 ) ;
if ( V_13 < 0 ) {
F_186 ( L_13 ,
V_13 ) ;
...
return V_13 ;
V_298:
F_187 ( V_12 -> V_193 . V_194 ) ;
goto V_228;
}
static void T_7 F_188 ( struct V_12 * V_12 )
{
F_187 ( V_12 -> V_193 . V_194 ) ;
F_183 ( V_12 ) ;
}
