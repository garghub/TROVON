...
static void F_56 ( struct V_21 * V_144 ,
struct V_1 * V_2 )
{
F_5 ( V_15 , L_25 , V_16 ) ;
}
static void F_57 ( struct V_21 * V_18 )
{
struct V_9 * V_10 ;
int V_69 ;
...
static int F_58 ( struct V_21 * V_18 )
{
return 0 ;
}
static T_1 F_59 ( struct V_21 * V_18 , T_2 V_89 )
{
T_1 V_147 = 0 ;
int V_69 ;
for ( V_69 = 0 ; V_69 < V_96 ; V_69 ++ ) {
...
static int F_60 ( struct V_21 * V_18 ,
struct V_148 * V_149 ,
struct V_150 * V_151 )
{
struct V_63 * V_57 = V_18 -> V_56 -> V_57 ;
...
memset ( V_155 , 0 ,
sizeof( struct V_154 ) ) ;
V_155 -> V_163 = F_62 ( V_164 ) ;
V_155 -> V_145 = F_62 ( V_149 -> V_145 ) ;
V_155 -> V_165 = F_62 ( V_149 -> V_165 &
~ V_166 ) ;
V_5 = V_160 << V_167 ;
V_155 -> V_165 |= F_62 ( V_5 ) ;
if ( V_149 -> V_165 &
V_168 ) {
V_157 = true ;
}
F_63 ( V_2 , NULL , ( T_1 * ) V_155 ,
V_159 ,
V_35 , V_169 ) ;
V_45 = F_64 ( V_18 , V_2 ) ;
V_2 = NULL ;
...
static void * F_66 ( struct V_63 * V_57 )
{
int V_45 = 0 ;
...
static void F_69 ( struct V_21 * V_18 )
{
struct V_1 * V_2 ;
while ( true ) {
V_2 = F_43 ( V_18 ) ;
...
static int F_70 ( struct V_21 * V_18 )
{
struct V_47 * V_7 ;
struct V_183 * V_184 ;
struct V_1 * V_2 ;
...
V_7 = V_2 -> V_7 ;
V_184 = (struct V_183 * ) F_61 ( V_7 ,
sizeof( * V_184 ) ) ;
memset ( V_184 , 0 , sizeof( struct V_183 ) ) ;
V_184 -> V_163 = F_62 ( V_185 ) ;
F_5 ( V_15 , L_33 ) ;
F_63 ( V_2 , NULL , ( T_1 * ) V_184 ,
sizeof( struct V_183 ) ,
V_35 , V_169 ) ;
V_18 -> V_129 |= V_130 ;
return F_64 ( V_18 , V_2 ) ;
}
static void F_71 ( struct V_21 * V_18 )
{
int V_69 ;
struct V_9 * V_10 ;
for ( V_69 = 0 ; V_69 < V_96 ; V_69 ++ ) {
...
static int F_64 ( struct V_21 * V_18 ,
struct V_1 * V_2 )
{
struct V_11 V_24 ;
F_5 ( V_15 ,
...
if ( V_189 -> V_192 . V_163 != F_62 ( V_193 ) ) {
F_5 ( V_15 , L_36 ,
V_189 -> V_192 . V_163 ) ;
return - V_143 ;
}
...
V_189 -> V_192 . V_194 ,
V_189 -> V_192 . V_175 ) ;
V_18 -> V_87 = F_49 ( V_189 -> V_192 . V_194 ) ;
V_18 -> V_32 = F_49 ( V_189 -> V_192 . V_175 ) ;
...
V_190 . V_13 . V_123 = F_56 ;
V_190 . V_73 = V_195 ;
V_190 . V_145 = V_162 ;
V_45 = F_60 ( V_18 , & V_190 , & V_191 ) ;
return V_45 ;
}
static void F_74 ( struct V_21 * V_18 ,
...
static int F_75 ( struct V_21 * V_18 ,
struct V_11 * V_44 )
{
...
static int F_78 ( struct V_21 * V_18 ,
struct V_198 * V_3 )
{
return 0 ;
}
void F_79 ( struct V_63 * V_57 )
{
V_57 -> V_199 = & V_200 ;
}
