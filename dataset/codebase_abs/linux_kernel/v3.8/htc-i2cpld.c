...
{
struct V_15 * V_16 ;
struct V_51 * V_14 = & V_49 -> V_14 ;
struct V_52 * V_53 ;
struct V_3 * V_4 ;
struct V_54 * V_55 ;
unsigned int V_6 , V_56 ;
int V_57 = 0 ;
V_53 = V_14 -> V_58 ;
V_16 = F_24 ( V_49 ) ;
V_4 = & V_16 -> V_4 [ V_50 ] ;
V_55 = & V_53 -> V_4 [ V_50 ] ;
V_56 = V_4 -> V_7 + V_4 -> V_26 ;
for ( V_6 = V_4 -> V_7 ; V_6 < V_56 ; V_6 ++ ) {
F_25 ( V_6 , & V_59 ,
V_60 ) ;
F_26 ( V_6 , V_4 ) ;
#ifdef F_27
...
F_35 ( V_22 , V_4 ) ;
snprintf ( V_22 -> V_72 , V_71 , L_12 , V_22 -> V_68 ) ;
V_4 -> V_22 = V_22 ;
F_21 ( V_22 ) ;
...
V_16 = F_24 ( V_49 ) ;
V_16 -> V_20 = V_53 -> V_85 ;
V_16 -> V_4 = F_42 ( sizeof( struct V_3 ) * V_16 -> V_20 ,
V_86 ) ;
if ( ! V_16 -> V_4 ) {
F_8 ( V_14 , L_18 ) ;
return - V_87 ;
...
for ( V_17 = 0 ; V_17 < V_16 -> V_20 ; V_17 ++ ) {
int V_57 ;
V_16 -> V_4 [ V_17 ] . V_47 = V_53 -> V_4 [ V_17 ] . V_47 ;
V_16 -> V_4 [ V_17 ] . V_27 = V_53 -> V_4 [ V_17 ] . V_47 ;
V_16 -> V_4 [ V_17 ] . V_29 = 0 ;
V_16 -> V_4 [ V_17 ] . V_14 = V_14 ;
V_16 -> V_4 [ V_17 ] . V_7 = V_53 -> V_4 [ V_17 ] . V_88 ;
V_16 -> V_4 [ V_17 ] . V_26 = V_53 -> V_4 [ V_17 ] . V_89 ;
F_43 ( & ( V_16 -> V_4 [ V_17 ] . V_40 ) , & F_16 ) ;
...
F_45 ( V_14 , L_19 , V_53 -> V_4 [ V_17 ] . V_68 ) ;
}
return 0 ;
}
...
V_16 = F_42 ( sizeof( struct V_15 ) , V_86 ) ;
if ( ! V_16 )
return - V_87 ;
V_57 = - V_10 ;
V_92 = F_47 ( V_49 , V_94 , 0 ) ;
if ( V_92 ) {
int V_8 ;
V_16 -> V_90 = V_92 -> V_95 ;
V_8 = V_96 | V_97 ;
