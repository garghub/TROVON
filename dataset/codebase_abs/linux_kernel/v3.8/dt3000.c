...
{
int V_105 ;
V_105 = ( F_25 ( V_98 -> V_99 ) < 4 ) ? 0x0f : 0xf0 ;
switch ( V_26 [ 0 ] ) {
case V_106 :
V_29 -> V_107 |= V_105 ;
break;
...
V_105 = ( V_29 -> V_107 & 0x01 ) | ( ( V_29 -> V_107 & 0x10 ) >> 3 ) ;
F_31 ( V_7 , V_105 ) ;
return V_98 -> V_100 ;
}
...
if ( V_26 [ 0 ] ) {
V_29 -> V_113 &= ~ V_26 [ 0 ] ;
V_29 -> V_113 |= V_26 [ 1 ] & V_26 [ 0 ] ;
F_10 ( V_7 , V_104 , 0 , V_29 -> V_113 ) ;
}
V_26 [ 1 ] = F_8 ( V_7 , V_114 , 0 , 0 ) ;
return V_98 -> V_100 ;
}
...
{
struct V_9 * V_10 = V_7 -> V_11 ;
unsigned int V_115 = F_25 ( V_98 -> V_99 ) ;
int V_2 ;
for ( V_2 = 0 ; V_2 < V_98 -> V_100 ; V_2 ++ ) {
F_4 ( V_116 , V_10 -> V_13 + V_24 ) ;
F_4 ( V_115 , V_10 -> V_13 + F_9 ( 0 ) ) ;
...
static const void * F_35 ( struct V_6 * V_7 ,
struct V_118 * V_119 )
{
const struct V_68 * V_69 ;
int V_2 ;
for ( V_2 = 0 ; V_2 < F_36 ( V_120 ) ; V_2 ++ ) {
V_69 = & V_120 [ V_2 ] ;
if ( V_69 -> V_121 == V_119 -> V_122 )
return V_69 ;
}
return NULL ;
}
...
return - V_126 ;
V_7 -> V_127 = V_69 ;
V_7 -> V_128 = V_69 -> V_129 ;
V_10 = F_39 ( sizeof( * V_10 ) , V_130 ) ;
if ( ! V_10 )
return - V_131 ;
V_7 -> V_11 = V_10 ;
V_125 = F_40 ( V_119 , V_7 -> V_128 ) ;
if ( V_125 < 0 )
return V_125 ;
V_7 -> V_132 = 1 ;
V_124 = F_41 ( V_119 , 0 ) ;
V_10 -> V_13 = F_42 ( V_124 , V_133 ) ;
if ( ! V_10 -> V_13 )
return - V_131 ;
V_125 = F_43 ( V_119 -> V_43 , F_14 , V_134 ,
V_7 -> V_128 , V_7 ) ;
if ( V_125 )
return V_125 ;
V_7 -> V_43 = V_119 -> V_43 ;
...
V_7 -> V_135 = V_29 ;
V_29 -> type = V_136 ;
V_29 -> V_137 = V_138 | V_139 | V_140 | V_141 ;
V_29 -> V_142 = V_69 -> V_143 ;
V_29 -> V_144 = F_28 ;
V_29 -> V_145 = ( 1 << V_69 -> V_146 ) - 1 ;
V_29 -> V_147 = 512 ;
V_29 -> V_148 = & V_149 ;
V_29 -> V_150 = F_24 ;
V_29 -> V_151 = F_18 ;
...
V_29 -> V_144 = F_30 ;
V_29 -> V_155 = F_29 ;
V_29 -> V_145 = ( 1 << V_69 -> V_156 ) - 1 ;
V_29 -> V_147 = 1 ;
V_29 -> V_148 = & V_157 ;
V_29 = & V_7 -> V_47 [ 2 ] ;
V_29 -> type = V_158 ;
V_29 -> V_137 = V_138 | V_154 ;
V_29 -> V_142 = 8 ;
V_29 -> V_159 = F_32 ;
V_29 -> V_160 = F_33 ;
V_29 -> V_145 = 1 ;
...
static int F_50 ( struct V_118 * V_7 ,
const struct V_164 * V_165 )
{
return F_51 ( V_7 , & V_166 ) ;
}
static void F_52 ( struct V_118 * V_7 )
{
F_53 ( V_7 ) ;
}
