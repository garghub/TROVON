...
static void F_69 ( struct V_127 * V_49 )
{
struct V_11 * V_128 =
F_70 ( V_49 , struct V_11 , V_12 ) ;
F_71 ( V_128 ) ;
}
static unsigned int F_72 ( struct V_127 * V_49 , int V_14 )
{
struct V_11 * V_128 =
F_70 ( V_49 , struct V_11 , V_12 ) ;
unsigned int V_129 ;
V_129 = F_56 ( V_49 -> V_25 + V_14 ) ;
if ( V_14 == V_130 ) {
if ( V_129 == 0 )
V_129 = V_128 -> V_131 ;
}
...
struct V_11 * V_12 , int V_31 )
{
V_12 -> V_12 . V_33 |= V_132 ;
V_12 -> V_12 . V_133 = F_72 ;
V_12 -> V_12 . V_134 = F_69 ;
return F_68 ( V_10 , V_30 , V_12 , V_31 ) ;
}
static int F_74 ( struct V_2 * V_3 )
{
#if F_75 ( V_135 ) || F_75 ( V_136 )
return - V_46 ;
#else
return 0 ;
#endif
...
F_26 ( 0x00 , V_49 + V_138 ) ;
F_26 ( V_139 , V_49 + V_140 ) ;
F_26 ( 128 , V_49 + V_141 ) ;
F_26 ( 128 , V_49 + V_142 ) ;
F_19 ( V_49 ) ;
return F_50 ( V_10 , V_30 , V_12 , V_31 ) ;
...
V_12 -> V_12 . type = V_147 ;
return F_50 ( V_10 , V_30 , V_12 , V_31 ) ;
}
static inline int F_80 ( T_4 V_148 , T_4 V_149 )
{
return V_148 == V_150 || V_148 == V_149 ;
}
static struct V_151 * F_81 ( struct V_2 * V_3 )
{
struct V_151 * V_152 ;
for ( V_152 = V_153 ; ; V_152 ++ )
if ( F_80 ( V_152 -> V_5 , V_3 -> V_5 ) &&
F_80 ( V_152 -> V_6 , V_3 -> V_6 ) &&
F_80 ( V_152 -> V_154 , V_3 -> V_7 ) &&
F_80 ( V_152 -> V_155 , V_3 -> V_8 ) )
break;
return V_152 ;
}
static inline int F_82 ( struct V_2 * V_3 ,
const struct V_29 * V_30 )
{
if ( V_30 -> V_33 & V_156 )
return 0 ;
...
static int
F_83 ( struct V_2 * V_3 , struct V_29 * V_30 )
{
const struct V_158 * V_159 ;
int V_160 , V_161 , V_162 = - 1 , V_65 ;
if ( ( ( ( V_3 -> V_83 >> 8 ) != V_163 ) &&
( ( V_3 -> V_83 >> 8 ) != V_164 ) ) ||
( V_3 -> V_83 & 0xff ) > 6 )
return - V_46 ;
for ( V_159 = V_165 ;
V_159 < V_165 + F_40 ( V_165 ) ;
V_159 ++ ) {
if ( V_3 -> V_5 == V_159 -> V_5 &&
V_3 -> V_6 == V_159 -> V_6 )
return - V_46 ;
}
V_160 = V_161 = 0 ;
for ( V_65 = 0 ; V_65 < V_18 ; V_65 ++ ) {
if ( F_6 ( V_3 , V_65 ) & V_166 ) {
V_161 ++ ;
if ( V_162 == - 1 )
V_162 = V_65 ;
}
...
static inline int
F_84 ( const struct V_29 * V_30 ,
const struct V_29 * V_167 )
{
return
V_30 -> V_79 == V_167 -> V_79 &&
V_30 -> V_168 == V_167 -> V_168 &&
V_30 -> V_34 == V_167 -> V_34 &&
V_30 -> V_35 == V_167 -> V_35 &&
V_30 -> V_32 == V_167 -> V_32 ;
}
struct V_9 *
F_85 ( struct V_2 * V_3 , const struct V_29 * V_30 )
{
struct V_11 V_169 ;
struct V_9 * V_10 ;
struct V_151 * V_152 ;
...
V_10 = F_87 ( sizeof( struct V_9 ) +
sizeof( unsigned int ) * V_170 ,
V_173 ) ;
if ( ! V_10 ) {
V_10 = F_86 ( - V_22 ) ;
goto V_174;
...
V_169 . V_12 . V_33 = V_175 | V_176 | V_177 ;
V_169 . V_12 . V_178 = V_30 -> V_168 * 16 ;
V_169 . V_12 . V_157 = F_82 ( V_3 , V_30 ) ;
V_169 . V_12 . V_3 = & V_3 -> V_3 ;
for ( V_65 = 0 ; V_65 < V_170 ; V_65 ++ ) {
if ( V_152 -> V_179 ( V_10 , V_30 , & V_169 , V_65 ) )
break;
#ifdef F_88
F_2 ( V_47 L_20 ,
V_169 . V_12 . V_25 , V_169 . V_12 . V_157 , V_169 . V_12 . V_23 ) ;
#endif
V_10 -> line [ V_65 ] = F_89 ( & V_169 ) ;
if ( V_10 -> line [ V_65 ] < 0 ) {
...
struct V_151 * V_152 ;
int V_65 ;
for ( V_65 = 0 ; V_65 < V_10 -> V_180 ; V_65 ++ )
F_91 ( V_10 -> line [ V_65 ] ) ;
for ( V_65 = 0 ; V_65 < V_18 ; V_65 ++ ) {
if ( V_10 -> V_21 [ V_65 ] )
F_19 ( V_10 -> V_21 [ V_65 ] ) ;
...
F_94 ( V_10 -> line [ V_65 ] ) ;
if ( V_10 -> V_152 -> exit )
V_10 -> V_152 -> exit ( V_10 -> V_3 ) ;
}
void F_95 ( struct V_9 * V_10 )
{
int V_65 ;
if ( V_10 -> V_152 -> V_171 )
V_10 -> V_152 -> V_171 ( V_10 -> V_3 ) ;
for ( V_65 = 0 ; V_65 < V_10 -> V_180 ; V_65 ++ )
if ( V_10 -> line [ V_65 ] >= 0 )
F_96 ( V_10 -> line [ V_65 ] ) ;
}
static int
F_97 ( struct V_2 * V_3 , const struct V_158 * V_181 )
{
struct V_151 * V_152 ;
struct V_9 * V_10 ;
const struct V_29 * V_30 ;
...
V_152 = F_81 ( V_3 ) ;
if ( V_152 -> V_183 ) {
V_36 = V_152 -> V_183 ( V_3 ) ;
if ( V_36 )
return V_36 ;
}
if ( V_181 -> V_184 >= F_40 ( V_185 ) ) {
F_2 ( V_108 L_22 ,
V_181 -> V_184 ) ;
return - V_19 ;
}
V_30 = & V_185 [ V_181 -> V_184 ] ;
V_36 = F_98 ( V_3 ) ;
F_99 ( V_3 ) ;
if ( V_36 )
return V_36 ;
if ( V_181 -> V_184 == V_186 ) {
memcpy ( & V_182 , V_30 , sizeof( struct V_29 ) ) ;
V_30 = & V_182 ;
V_36 = F_83 ( V_3 , & V_182 ) ;
if ( V_36 )
goto V_187;
} else {
memcpy ( & V_182 , & V_185 [ V_186 ] ,
sizeof( struct V_29 ) ) ;
V_36 = F_83 ( V_3 , & V_182 ) ;
if ( V_36 == 0 && F_84 ( V_30 , & V_182 ) )
F_1 ( L_23 ,
V_3 ) ;
}
V_10 = F_85 ( V_3 , V_30 ) ;
...
static int F_106 ( struct V_2 * V_3 , T_5 V_188 )
{
struct V_9 * V_10 = F_105 ( V_3 ) ;
if ( V_10 )
F_93 ( V_10 ) ;
F_99 ( V_3 ) ;
F_107 ( V_3 , F_108 ( V_3 , V_188 ) ) ;
return 0 ;
}
...
static T_6 F_111 ( struct V_2 * V_3 ,
T_7 V_188 )
{
struct V_9 * V_10 = F_105 ( V_3 ) ;
if ( V_188 == V_191 )
...
static T_6 F_112 ( struct V_2 * V_3 )
{
int V_36 ;
V_36 = F_98 ( V_3 ) ;
if ( V_36 )
