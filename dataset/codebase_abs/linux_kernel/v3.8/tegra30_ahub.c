...
if ( V_3 )
return - V_98 ;
for ( V_90 = 0 ; V_90 < F_32 ( V_99 ) ; V_90 ++ ) {
V_89 = F_33 ( NULL , V_99 [ V_90 ] ) ;
if ( F_34 ( V_89 ) ) {
F_11 ( & V_88 -> V_7 , L_3 ,
V_99 [ V_90 ] ) ;
V_10 = F_35 ( V_89 ) ;
...
V_3 = F_38 ( & V_88 -> V_7 , sizeof( struct V_101 ) ,
V_102 ) ;
if ( ! V_3 ) {
F_11 ( & V_88 -> V_7 , L_4 ) ;
V_10 = - V_103 ;
...
F_39 ( & V_88 -> V_7 , V_3 ) ;
V_3 -> V_7 = & V_88 -> V_7 ;
V_3 -> V_9 = F_40 ( & V_88 -> V_7 , L_5 ) ;
if ( F_34 ( V_3 -> V_9 ) ) {
F_11 ( & V_88 -> V_7 , L_6 ) ;
V_10 = F_35 ( V_3 -> V_9 ) ;
goto V_100;
}
V_3 -> V_8 = F_40 ( & V_88 -> V_7 , L_7 ) ;
if ( F_34 ( V_3 -> V_8 ) ) {
F_11 ( & V_88 -> V_7 , L_8 ) ;
V_10 = F_35 ( V_3 -> V_8 ) ;
goto V_104;
}
if ( F_41 ( V_88 -> V_7 . V_105 ,
L_9 ,
V_95 , 2 ) < 0 ) {
F_11 ( & V_88 -> V_7 ,
L_10 ) ;
...
V_3 -> V_23 = V_95 [ 1 ] ;
V_92 = F_42 ( V_88 , V_106 , 0 ) ;
if ( ! V_92 ) {
F_11 ( & V_88 -> V_7 , L_11 ) ;
V_10 = - V_98 ;
goto V_107;
}
V_94 = F_43 ( & V_88 -> V_7 , V_92 -> V_108 ,
F_44 ( V_92 ) , V_109 ) ;
if ( ! V_94 ) {
F_11 ( & V_88 -> V_7 , L_12 ) ;
V_10 = - V_18 ;
...
F_7 ( V_3 -> V_4 , true ) ;
V_93 = F_42 ( V_88 , V_106 , 1 ) ;
if ( ! V_93 ) {
F_11 ( & V_88 -> V_7 , L_15 ) ;
V_10 = - V_98 ;
goto V_107;
}
V_94 = F_43 ( & V_88 -> V_7 , V_93 -> V_108 ,
F_44 ( V_93 ) , V_109 ) ;
if ( ! V_94 ) {
F_11 ( & V_88 -> V_7 , L_16 ) ;
V_10 = - V_18 ;
...
F_49 ( V_88 -> V_7 . V_105 , NULL , V_113 ,
& V_88 -> V_7 ) ;
return 0 ;
V_112:
F_50 ( & V_88 -> V_7 ) ;
