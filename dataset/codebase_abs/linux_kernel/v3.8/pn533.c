...
static int F_67 ( struct V_17 * V_18 , T_1 * V_58 , int V_59 )
{
struct V_115 * V_116 ;
int V_21 ;
F_21 ( & V_18 -> V_35 -> V_18 , L_13 , V_43 ) ;
...
static int F_79 ( struct V_17 * V_18 , T_1 * V_58 , int V_59 )
{
struct V_160 * V_116 ;
...
if ( V_172 -> V_154 == 0 ) {
F_83 ( & V_18 -> V_174 ) ;
return F_79 ( V_18 , V_58 , V_59 ) ;
} else {
V_21 = F_67 ( V_18 , V_58 , V_59 ) ;
if ( ! V_21 )
return V_21 ;
}
F_63 ( V_18 ) ;
...
V_18 -> V_20 = F_115 ( V_282 , V_62 ) ;
V_18 -> V_37 = F_130 ( 0 , V_62 ) ;
V_18 -> V_44 = F_115 ( V_282 , V_62 ) ;
...
L_83 , V_266 -> V_286 , V_266 -> V_287 ) ;
V_18 -> V_214 = V_264 -> V_288 ;
switch ( V_18 -> V_214 ) {
case V_247 :
V_273 = V_289 ;
break;
