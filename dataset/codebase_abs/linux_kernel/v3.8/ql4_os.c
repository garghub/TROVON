...
static int F_320 ( struct V_645 * V_194 ,
...
static void F_354 ( struct V_645 * V_194 )
{
struct V_9 * V_10 ;
if ( ! F_355 ( V_194 ) )
return;
...
static T_10
F_387 ( struct V_645 * V_194 , T_11 V_242 )
{
