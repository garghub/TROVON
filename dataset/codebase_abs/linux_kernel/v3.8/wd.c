...
V_24 -> V_26 = V_2 -> V_9 . V_19 ;
V_24 -> V_27 = V_2 -> V_9 . V_28 ;
V_24 -> V_29 = 1 ;
V_24 -> V_30 = 0 ;
...
{
int V_36 ;
if ( V_2 -> V_9 . V_10 != V_37 ||
V_2 -> V_14 != V_38 )
return 0 ;
memcpy ( V_2 -> V_5 , V_33 , V_34 ) ;
V_2 -> V_14 = V_39 ;
V_36 = F_12 ( V_2 , & V_2 -> V_9 ) ;
if ( V_36 < 0 )
goto V_40;
if ( V_36 && V_2 -> V_41 ) {
V_36 = 0 ;
