...
static int
F_89 ( struct V_131 * V_131 , struct V_183 T_4 * V_184 ,
const int * V_106 )
{
int V_14 ;
struct V_183 V_185 ;
...
static int
F_90 ( struct V_131 * V_131 , const char * V_60 , unsigned int V_98 ,
...
V_190 = F_91 ( V_56 , V_188 , V_116 , & V_14 ) ;
if ( ! V_190 )
goto V_193;
F_11 ( L_42 ,
...
static int
F_93 ( struct V_131 * V_131 , const void T_4 * V_123 , unsigned int V_106 )
{
int V_14 ;
struct V_155 V_181 ;
struct V_74 * V_116 ;
...
goto V_195;
F_11 ( L_43 ) ;
V_14 = F_90 ( V_131 , V_181 . V_60 , V_181 . V_98 , V_116 ,
...
static int
F_95 ( struct V_131 * V_131 , const void T_4 * V_123 , unsigned int V_106 ,
int V_178 )
{
...
static int
F_97 ( struct V_44 * V_49 , void T_4 * * V_204 ,
...
F_30 (ematch, e) {
V_14 = F_98 ( V_100 , V_204 , V_125 ) ;
if ( V_14 != 0 )
return V_14 ;
}
V_63 = V_49 -> V_63 - ( V_206 - * V_125 ) ;
V_56 = F_17 ( V_49 ) ;
V_14 = F_99 ( V_56 , V_204 , V_125 ) ;
if ( V_14 )
return V_14 ;
V_128 = V_49 -> V_128 - ( V_206 - * V_125 ) ;
if ( F_100 ( V_63 , & V_205 -> V_63 ) != 0 ||
F_100 ( V_128 , & V_205 -> V_128 ) != 0 )
return - V_171 ;
return 0 ;
}
static int
F_101 ( struct V_99 * V_130 ,
const char * V_60 ,
...
static void F_102 ( struct V_176 * V_49 )
{
struct V_48 * V_56 ;
struct V_99 * V_100 ;
F_30 (ematch, e)
...
static int
F_105 ( struct V_176 * V_49 , void * * V_204 ,
...
* V_125 += sizeof( struct V_44 ) - sizeof( struct V_176 ) ;
F_30 (ematch, e) {
V_14 = F_106 ( V_100 , V_204 , V_125 ) ;
if ( V_14 != 0 )
return V_14 ;
}
V_210 -> V_63 = V_49 -> V_63 - ( V_206 - * V_125 ) ;
V_56 = F_103 ( V_49 ) ;
F_107 ( V_56 , V_204 , V_125 ) ;
...
static int F_108 ( struct V_44 * V_49 , struct V_131 * V_131 ,
const char * V_60 )
{
unsigned int V_146 ;
int V_14 = 0 ;
...
static int
F_110 ( struct V_131 * V_131 , void T_4 * V_123 , unsigned int V_106 )
{
int V_14 ;
struct V_218 V_181 ;
struct V_74 * V_116 ;
...
V_14 = F_109 ( V_131 , V_181 . V_60 , V_181 . V_98 ,
...
static int
F_113 ( struct V_219 * V_220 , int V_221 , void T_4 * V_123 ,
unsigned int V_106 )
{
int V_14 ;
if ( ! F_114 ( F_115 ( V_220 ) -> V_222 , V_223 ) )
return - V_224 ;
switch ( V_221 ) {
case V_225 :
V_14 = F_110 ( F_115 ( V_220 ) , V_123 , V_106 ) ;
break;
case V_226 :
V_14 = F_95 ( F_115 ( V_220 ) , V_123 , V_106 , 1 ) ;
break;
default:
F_11 ( L_51 , V_221 ) ;
V_14 = - V_135 ;
...
static int
F_116 ( unsigned int V_166 , struct V_1 * V_85 ,
void T_4 * V_167 )
{
struct V_153 * V_105 ;
const struct V_74 * V_75 = V_85 -> V_75 ;
...
static int
F_117 ( struct V_131 * V_131 , struct V_227 T_4 * V_184 ,
int * V_106 )
{
int V_14 ;
struct V_227 V_185 ;
...
static int
F_118 ( struct V_219 * V_220 , int V_221 , void T_4 * V_123 , int * V_106 )
{
int V_14 ;
if ( ! F_114 ( F_115 ( V_220 ) -> V_222 , V_223 ) )
return - V_224 ;
switch ( V_221 ) {
case V_228 :
V_14 = F_80 ( F_115 ( V_220 ) , V_123 , V_106 , 1 ) ;
break;
case V_229 :
V_14 = F_117 ( F_115 ( V_220 ) , V_123 , V_106 ) ;
break;
default:
V_14 = F_119 ( V_220 , V_221 , V_123 , V_106 ) ;
}
return V_14 ;
}
static int
F_120 ( struct V_219 * V_220 , int V_221 , void T_4 * V_123 , unsigned int V_106 )
{
int V_14 ;
if ( ! F_114 ( F_115 ( V_220 ) -> V_222 , V_223 ) )
return - V_224 ;
switch ( V_221 ) {
case V_225 :
V_14 = F_93 ( F_115 ( V_220 ) , V_123 , V_106 ) ;
break;
case V_226 :
V_14 = F_95 ( F_115 ( V_220 ) , V_123 , V_106 , 0 ) ;
break;
default:
F_11 ( L_51 , V_221 ) ;
V_14 = - V_135 ;
...
switch ( V_221 ) {
case V_228 :
V_14 = F_80 ( F_115 ( V_220 ) , V_123 , V_106 , 0 ) ;
break;
case V_229 :
V_14 = F_89 ( F_115 ( V_220 ) , V_123 , V_106 ) ;
break;
case V_230 :
case V_231 : {
struct V_232 V_233 ;
...
struct V_1 * F_122 ( struct V_131 * V_131 ,
const struct V_1 * V_85 ,
const struct V_155 * V_156 )
{
int V_14 ;
...
if ( V_14 != 0 )
goto V_236;
V_235 = F_123 ( V_131 , V_85 , & V_234 , V_116 ) ;
if ( F_47 ( V_235 ) ) {
V_14 = F_48 ( V_235 ) ;
goto V_236;
}
...
void F_124 ( struct V_131 * V_131 , struct V_1 * V_85 )
{
struct V_74 * V_75 ;
void * V_170 ;
...
static inline bool
F_126 ( T_7 V_239 , T_7 V_240 , T_7 V_241 ,
T_7 type , T_7 V_242 ,
bool V_243 )
{
...
static bool
F_127 ( const struct V_5 * V_6 , struct V_40 * V_41 )
{
...
if ( V_41 -> V_12 != 0 )
return false ;
V_245 = F_128 ( V_6 , V_41 -> V_101 , sizeof( V_246 ) , & V_246 ) ;
if ( V_245 == NULL ) {
F_11 ( L_57 ) ;
V_41 -> V_13 = true ;
return false ;
}
return F_126 ( V_248 -> type ,
V_248 -> V_242 [ 0 ] ,
V_248 -> V_242 [ 1 ] ,
V_245 -> V_249 , V_245 -> V_250 ,
! ! ( V_248 -> V_28 & V_251 ) ) ;
}
static int F_129 ( const struct V_137 * V_41 )
{
const struct V_247 * V_248 = V_41 -> V_104 ;
return ( V_248 -> V_28 & ~ V_251 ) ? - V_135 : 0 ;
}
static int T_8 F_130 ( struct V_131 * V_131 )
{
return F_131 ( V_131 , V_96 ) ;
}
static void T_9 F_132 ( struct V_131 * V_131 )
{
F_133 ( V_131 , V_96 ) ;
}
...
if ( V_14 < 0 )
goto V_253;
V_14 = F_136 ( V_254 , F_137 ( V_254 ) ) ;
if ( V_14 < 0 )
goto V_255;
V_14 = F_138 ( V_256 , F_137 ( V_256 ) ) ;
if ( V_14 < 0 )
goto V_257;
V_14 = F_139 ( & V_258 ) ;
if ( V_14 < 0 )
...
return 0 ;
V_259:
F_141 ( V_256 , F_137 ( V_256 ) ) ;
V_257:
F_142 ( V_254 , F_137 ( V_254 ) ) ;
V_255:
F_143 ( & V_252 ) ;
V_253:
return V_14 ;
