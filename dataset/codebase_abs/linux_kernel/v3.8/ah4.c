...
static int F_45 ( struct V_34 * V_35 , struct V_31 * V_32 )
{
int V_71 ;
int V_18 ;
int V_52 ;
...
V_71 = ( V_41 -> V_59 + 2 ) << 2 ;
if ( V_35 -> V_56 . V_57 & V_58 ) {
if ( V_71 != F_29 ( sizeof( * V_41 ) + V_38 -> V_76 ) &&
V_71 != F_29 ( sizeof( * V_41 ) + V_38 -> V_43 ) )
goto V_49;
} else {
if ( V_71 != F_30 ( sizeof( * V_41 ) + V_38 -> V_76 ) &&
...
static void F_49 ( struct V_31 * V_32 , T_3 V_80 )
{
struct V_81 * V_81 = F_50 ( V_32 -> V_82 ) ;
...
V_35 = F_52 ( V_81 , V_32 -> V_87 , ( const V_88 * ) & V_14 -> V_15 ,
V_41 -> V_61 , V_53 , V_89 ) ;
if ( ! V_35 )
return;
if ( F_51 ( V_32 ) -> type == V_83 ) {
F_53 ( & V_90 ) ;
F_54 ( V_81 ) ;
F_55 ( V_32 , V_81 , V_80 , 0 , 0 , V_53 , 0 ) ;
} else
F_56 ( V_32 , V_81 , 0 , 0 , V_53 , 0 ) ;
F_57 ( V_35 ) ;
}
...
if ( V_35 -> V_94 )
goto error;
V_38 = F_59 ( sizeof( * V_38 ) , V_95 ) ;
if ( ! V_38 )
return - V_50 ;
V_2 = F_60 ( V_35 -> V_93 -> V_96 , 0 , 0 ) ;
if ( F_61 ( V_2 ) )
goto error;
V_38 -> V_2 = V_2 ;
if ( F_62 ( V_2 , V_35 -> V_93 -> V_97 ,
( V_35 -> V_93 -> V_98 + 7 ) / 8 ) )
goto error;
V_92 = F_63 ( V_35 -> V_93 -> V_96 , 0 ) ;
F_64 ( ! V_92 ) ;
if ( V_92 -> V_99 . V_100 . V_101 / 8 !=
F_2 ( V_2 ) ) {
F_65 ( L_1 ,
V_102 , V_35 -> V_93 -> V_96 ,
F_2 ( V_2 ) ,
V_92 -> V_99 . V_100 . V_101 / 8 ) ;
goto error;
}
V_38 -> V_76 = V_92 -> V_99 . V_100 . V_101 / 8 ;
V_38 -> V_43 = V_35 -> V_93 -> V_103 / 8 ;
F_64 ( V_38 -> V_43 > V_104 ) ;
if ( V_35 -> V_56 . V_57 & V_58 )
V_35 -> V_56 . V_105 = F_29 ( sizeof( struct V_40 ) +
V_38 -> V_43 ) ;
else
V_35 -> V_56 . V_105 = F_30 ( sizeof( struct V_40 ) +
V_38 -> V_43 ) ;
if ( V_35 -> V_56 . V_74 == V_75 )
V_35 -> V_56 . V_105 += sizeof( struct V_13 ) ;
V_35 -> V_33 = V_38 ;
return 0 ;
error:
if ( V_38 ) {
...
{
if ( F_69 ( & V_106 , V_89 ) < 0 ) {
F_65 ( L_2 , V_102 ) ;
return - V_107 ;
}
if ( F_70 ( & V_108 , V_53 ) < 0 ) {
F_65 ( L_3 , V_102 ) ;
F_71 ( & V_106 , V_89 ) ;
return - V_107 ;
}
...
{
if ( F_73 ( & V_108 , V_53 ) < 0 )
F_65 ( L_4 , V_102 ) ;
if ( F_71 ( & V_106 , V_89 ) < 0 )
F_65 ( L_5 , V_102 ) ;
}
