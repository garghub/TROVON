...
#endif
V_2 -> V_8 = V_8 ;
strcpy ( V_47 -> V_96 , V_2 -> V_5 ) ;
sprintf ( V_47 -> V_97 , L_22 , V_47 -> V_96 ) ;
#if F_16 ( F_15 ) || F_16 ( F_3 )
sprintf ( V_47 -> V_98 , L_23 ,
V_47 -> V_97 , V_53 -> V_5 ,
V_2 -> V_39 + 4 , V_8 , V_29 , V_83 ) ;
#else
sprintf ( V_47 -> V_98 , L_24 ,
V_47 -> V_97 , V_53 -> V_5 , V_2 -> V_39 + 4 , V_8 , V_29 ) ;
#endif
if ( V_31 <= 0 || V_31 == V_91 )
V_88 = NULL ;
else {
error = F_48 ( V_47 , 0 , V_99 ,
V_31 , 0 , V_32 , & V_88 ) ;
if ( error )
F_5 ( V_40 L_25 ,
V_31 ) ;
...
#endif
if ( ! V_101 && F_50 ( V_47 , V_79 , V_79 + 2 ,
V_104 , 0 , & V_101 ) < 0 ) {
F_5 ( V_40 L_26 ,
V_79 , V_79 + 4 - 1 ) ;
}
if ( V_101 ) {
error = F_51 ( V_101 , 0 , 1 , & V_90 ) ;
if ( error < 0 )
return error ;
}
}
...
static int F_53 ( struct V_46 * * V_105 )
{
struct V_46 * V_47 ;
int V_52 ;
V_52 = F_54 ( V_57 , V_78 , V_106 ,
...
struct V_46 * V_47 ;
int error ;
static long V_112 [] = { 0x300 , 0x310 , 0x320 , 0x330 , - 1 } ;
#ifdef F_3
static int V_113 [] = { 5 , 9 , 10 , 11 , 7 , - 1 } ;
#else
static int V_113 [] = { 9 , 10 , 11 , 7 , - 1 } ;
#endif
static int V_114 [] = { 5 , 9 , 10 , 7 , - 1 } ;
static int V_115 [] = { 3 , 1 , 0 , - 1 } ;
#if F_16 ( F_15 ) || F_16 ( F_3 )
static int V_116 [] [ 2 ] = { { 1 , - 1 } , { 0 , - 1 } , { - 1 , - 1 } , { 0 , - 1 } } ;
#endif
if ( V_31 == V_91 ) {
if ( ( V_31 = F_42 ( V_112 , 2 ) ) < 0 ) {
F_5 ( V_22 L_27 ) ;
return - V_43 ;
}
}
...
if ( V_32 == V_117 ) {
if ( ( V_32 = F_57 ( V_114 ) ) < 0 ) {
F_5 ( V_22 L_29 ) ;
return - V_43 ;
}
}
if ( V_29 == V_118 ) {
if ( ( V_29 = F_58 ( V_115 ) ) < 0 ) {
F_5 ( V_22 L_30 ) ;
return - V_43 ;
}
}
...
if ( error )
return error ;
V_2 -> V_60 -> V_121 ( V_2 -> V_60 ) ;
F_66 ( V_47 , V_122 ) ;
return 0 ;
}
static int F_68 ( struct V_108 * V_110 , unsigned int V_123 ,
T_2 V_124 )
{
return F_65 ( F_64 ( V_110 ) ) ;
}
static int F_69 ( struct V_108 * V_110 , unsigned int V_123 )
{
return F_67 ( F_64 ( V_110 ) ) ;
}
static int F_70 ( struct V_70 * V_125 ,
const struct V_71 * V_72 )
{
struct V_46 * V_47 ;
int error , V_126 ;
...
static void F_72 ( struct V_70 * V_125 )
{
F_60 ( F_73 ( V_125 ) ) ;
F_71 ( V_125 , NULL ) ;
V_111 = 0 ;
}
static int F_74 ( struct V_70 * V_125 ,
T_2 V_124 )
{
return F_65 ( F_73 ( V_125 ) ) ;
}
static int F_75 ( struct V_70 * V_125 )
{
return F_67 ( F_73 ( V_125 ) ) ;
}
