...
case V_134 : {
struct V_135 V_136 ;
struct V_135 T_5 * V_137 ;
struct V_138 * V_139 ;
V_62 = - V_128 ;
if ( F_100 ( & V_136 , V_126 , sizeof( V_136 ) ) )
goto V_75;
V_62 = - V_49 ;
...
goto V_75;
V_62 = - V_87 ;
V_139 = F_102 ( V_136 . V_140 * sizeof( * V_139 ) ) ;
if ( ! V_139 )
goto V_75;
V_62 = - V_128 ;
V_137 = V_126 ;
if ( F_100 ( V_139 , V_137 -> V_139 ,
V_136 . V_140 * sizeof( * V_139 ) ) )
goto V_142;
V_62 = F_103 ( V_29 , V_139 , V_136 . V_140 ,
V_136 . V_27 ) ;
V_142:
F_104 ( V_139 ) ;
break;
