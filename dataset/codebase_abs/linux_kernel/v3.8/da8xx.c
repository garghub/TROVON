...
struct V_101 * V_101 ;
int V_59 = - V_102 ;
V_100 = F_48 ( sizeof( * V_100 ) , V_103 ) ;
if ( ! V_100 ) {
F_49 ( & V_94 -> V_97 , L_17 ) ;
goto V_104;
}
V_10 = F_50 ( L_18 , V_105 ) ;
if ( ! V_10 ) {
F_49 ( & V_94 -> V_97 , L_19 ) ;
goto V_106;
}
V_101 = F_51 ( & V_94 -> V_97 , L_20 ) ;
if ( F_52 ( V_101 ) ) {
F_49 ( & V_94 -> V_97 , L_21 ) ;
V_59 = F_53 ( V_101 ) ;
goto V_107;
...
V_10 -> V_97 . V_109 = & V_94 -> V_97 ;
V_10 -> V_97 . V_110 = & V_111 ;
V_10 -> V_97 . V_112 = V_111 ;
V_100 -> V_97 = & V_94 -> V_97 ;
V_100 -> V_10 = V_10 ;
V_100 -> V_101 = V_101 ;
V_96 -> V_113 = & V_114 ;
F_55 ( V_94 , V_100 ) ;
V_59 = F_56 ( V_10 , V_94 -> V_115 ,
V_94 -> V_116 ) ;
if ( V_59 ) {
F_49 ( & V_94 -> V_97 , L_23 ) ;
goto V_117;
}
V_59 = F_57 ( V_10 , V_96 , sizeof( * V_96 ) ) ;
if ( V_59 ) {
F_49 ( & V_94 -> V_97 , L_24 ) ;
goto V_117;
}
...
static int F_63 ( struct V_93 * V_94 )
{
struct V_99 * V_100 = F_64 ( V_94 ) ;
F_65 ( V_100 -> V_10 ) ;
F_59 ( V_100 -> V_101 ) ;
F_60 ( V_100 -> V_101 ) ;
F_62 ( V_100 ) ;
