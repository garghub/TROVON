...
T_1 F_59 ( struct V_87 * V_88 , T_5 * V_93 )
{
struct V_1 * V_91 ;
T_1 V_24 = 0 ;
F_52 (pos, head, node) {
int V_41 ;
for ( V_41 = 0 ; V_41 < V_75 ; ++ V_41 )
V_24 += F_60 ( V_91 , V_41 , V_93 ) ;
}
return V_24 ;
}
T_1 F_58 ( struct V_1 * V_1 , T_5 * V_93 )
{
char V_94 [ V_23 * 2 + 1 ] ;
F_5 ( V_1 -> V_31 , sizeof( V_1 -> V_31 ) , V_94 ) ;
return fprintf ( V_93 , L_11 , V_94 ) ;
}
T_1 F_60 ( struct V_1 * V_1 , enum V_72 type , T_5 * V_93 )
{
struct V_44 * V_95 ;
T_1 V_24 = fprintf ( V_93 , L_12 , V_1 -> V_66 ) ;
if ( V_1 -> V_66 != V_1 -> V_26 )
V_24 += fprintf ( V_93 , L_13 , V_1 -> V_26 ) ;
V_24 += fprintf ( V_93 , L_14 , V_96 [ type ] ,
V_1 -> V_73 ? L_6 : L_15 ) ;
V_24 += F_58 ( V_1 , V_93 ) ;
V_24 += fprintf ( V_93 , L_16 ) ;
for ( V_95 = F_10 ( & V_1 -> V_76 [ type ] ) ; V_95 ; V_95 = F_12 ( V_95 ) ) {
struct V_97 * V_91 = F_11 ( V_95 , struct V_97 , V_44 ) ;
V_24 += F_61 ( V_91 , V_93 ) ;
}
return V_24 ;
}
