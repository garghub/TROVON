...
static int F_26 ( struct V_23 * V_24 , struct V_59 * V_60 )
{
...
T_4 F_48 ( void * V_112 , const struct V_68 * V_113 ,
T_4 V_15 , T_4 V_114 )
{
return V_113 -> V_69 ;
}
int F_49 ( struct V_59 * V_60 , int V_115 )
{
return 0 ;
}
void F_50 ( unsigned int V_116 , struct V_117 * V_21 )
{
V_116 = F_51 ( V_116 ) ;
if ( ! V_10 || ( V_116 & V_118 ) == 0 ) {
F_20 ( L_32 ,
V_116 , ( int ) V_21 -> V_119 , V_10 ) ;
for (; ; ) { }
}
V_10 = 0 ;
V_11 = 1 ;
...
static inline unsigned long F_52 ( int V_121 )
{
return 1 << V_121 ;
}
static void F_53 ( struct V_122 * V_112 )
{
unsigned long V_115 , V_7 ;
V_115 = ( unsigned long ) V_112 -> V_123 ;
F_2 ( V_7 ) ;
F_3 ( V_115 , V_8 . V_33 + V_124 ) ;
F_7 ( V_7 ) ;
}
static void F_54 ( struct V_122 * V_112 )
{
unsigned long V_115 , V_7 ;
V_115 = ( unsigned long ) V_112 -> V_123 ;
F_2 ( V_7 ) ;
F_3 ( V_115 , V_8 . V_33 + V_125 ) ;
F_7 ( V_7 ) ;
}
static unsigned int F_55 ( struct V_122 * V_112 )
{
F_56 ( V_112 -> V_77 ) ;
F_54 ( V_112 ) ;
return 0 ;
}
unsigned int F_34 ( struct V_126 * V_127 ,
unsigned int V_74 )
{
unsigned int V_77 ;
unsigned long V_115 ;
...
F_58 ( V_77 , & V_129 ,
V_130 , L_33 ) ;
F_59 ( V_77 , ( void * ) V_115 ) ;
V_128:
return V_77 ;
}
static void F_60 ( int V_131 , unsigned int V_132 )
{
...
void F_62 ( unsigned long V_136 , const void * V_137 , unsigned long V_95 )
{
while ( V_95 ) {
V_95 -= 1 ;
F_63 ( * ( const char * ) V_137 , V_136 ) ;
V_137 += 1 ;
}
}
void F_64 ( unsigned long V_136 , const void * V_137 , unsigned long V_95 )
{
while ( V_95 ) {
V_95 -= 2 ;
F_65 ( * ( const short * ) V_137 , V_136 ) ;
V_137 += 2 ;
}
}
void F_66 ( unsigned long V_136 , const void * V_137 , unsigned long V_95 )
{
while ( V_95 ) {
V_95 -= 4 ;
F_67 ( * ( const long * ) V_137 , V_136 ) ;
V_137 += 4 ;
}
}
void F_68 ( unsigned long V_136 , void * V_138 , unsigned long V_95 )
{
while ( V_95 ) {
V_95 -= 1 ;
* ( unsigned char * ) V_138 = F_69 ( V_136 ) ;
V_138 += 1 ;
}
}
void F_70 ( unsigned long V_136 , void * V_138 , unsigned long V_95 )
{
while ( V_95 ) {
V_95 -= 2 ;
* ( unsigned short * ) V_138 = F_71 ( V_136 ) ;
V_138 += 2 ;
}
}
void F_72 ( unsigned long V_136 , void * V_138 , unsigned long V_95 )
{
while ( V_95 ) {
V_95 -= 4 ;
* ( unsigned long * ) V_138 = F_73 ( V_136 ) ;
V_138 += 4 ;
}
}
