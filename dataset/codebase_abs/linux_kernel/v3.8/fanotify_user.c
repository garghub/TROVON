...
V_24 = - V_91 ;
if ( ( V_89 & V_92 ) &&
! ( F_57 ( V_55 . V_10 -> V_93 . V_16 -> V_94 -> V_95 ) ) ) {
F_58 ( V_55 ) ;
goto V_56;
}
* V_15 = V_55 . V_10 -> V_93 ;
...
if ( ! V_85 )
return - V_46 ;
V_107 = F_63 ( V_85 , V_29 , V_89 ,
& V_108 ) ;
if ( V_108 )
F_70 ( V_85 , V_3 ) ;
F_71 ( V_85 ) ;
if ( V_107 & F_72 ( V_17 ) -> V_109 )
F_73 ( V_17 ) ;
return 0 ;
}
...
return - V_51 ;
F_79 ( V_85 , F_54 ) ;
V_24 = F_80 ( V_85 , V_3 , NULL , V_17 , 0 ) ;
if ( V_24 )
goto V_120;
}
V_116 = F_77 ( V_85 , V_29 , V_89 ) ;
if ( V_116 & ~ F_72 ( V_17 ) -> V_109 )
F_73 ( V_17 ) ;
V_120:
F_71 ( V_85 ) ;
return V_24 ;
...
return - V_51 ;
F_79 ( V_85 , F_54 ) ;
V_24 = F_80 ( V_85 , V_3 , V_72 , NULL , 0 ) ;
if ( V_24 )
goto V_120;
}
V_116 = F_77 ( V_85 , V_29 , V_89 ) ;
...
T_8 (F_82)( int V_122 , unsigned int V_89 ,
T_9 V_29 , int V_87 ,
const char T_5 * V_123 )
{
struct V_72 * V_72 = NULL ;
struct V_106 * V_17 = NULL ;
struct V_2 * V_3 ;
struct V_34 V_55 ;
struct V_15 V_15 ;
int V_24 ;
F_4 ( L_11 ,
V_6 , V_122 , V_89 , V_87 , V_123 , V_29 ) ;
if ( V_29 & ( ( T_9 ) 0xffffffff << 32 ) )
return - V_8 ;
if ( V_89 & ~ V_124 )
return - V_8 ;
switch ( V_89 & ( V_125 | V_126 | V_127 ) ) {
case V_125 :
case V_126 :
if ( ! V_29 )
return - V_8 ;
...
V_3 -> V_133 == V_134 )
goto V_132;
V_24 = F_55 ( V_87 , V_123 , & V_15 , V_89 ) ;
if ( V_24 )
goto V_132;
if ( ! ( V_89 & V_135 ) )
V_72 = V_15 . V_16 -> V_94 ;
...
case V_125 :
if ( V_89 & V_135 )
V_24 = F_78 ( V_3 , V_17 , V_29 , V_89 ) ;
else
V_24 = F_81 ( V_3 , V_72 , V_29 , V_89 ) ;
break;
case V_126 :
if ( V_89 & V_135 )
V_24 = F_68 ( V_3 , V_17 , V_29 , V_89 ) ;
else
V_24 = F_74 ( V_3 , V_72 , V_29 , V_89 ) ;
break;
case V_127 :
if ( V_89 & V_135 )
F_83 ( V_3 ) ;
...
T_10 long F_85 ( long V_122 , long V_89 , T_9 V_29 ,
long V_87 , long V_123 )
{
return F_86 ( ( int ) V_122 , ( unsigned int ) V_89 ,
V_29 , ( int ) V_87 ,
( const char T_5 * ) V_123 ) ;
}
static int T_11 F_87 ( void )
{
V_86 = F_88 ( V_84 , V_136 ) ;
V_48 = F_88 ( V_36 ,
V_136 ) ;
return 0 ;
}
