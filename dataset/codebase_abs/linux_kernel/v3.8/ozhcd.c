...
void F_34 ( struct V_41 * V_42 , struct V_23 * V_26 ,
struct V_30 * V_30 )
{
T_1 V_50 , V_51 , V_52 ;
...
void F_52 ( void * V_84 , T_1 V_60 , int V_31 , T_1 * V_91 ,
int V_92 , int V_93 , int V_94 )
{
struct V_41 * V_42 = (struct V_41 * ) V_84 ;
struct V_30 * V_30 ;
int V_61 = 0 ;
F_25 ( V_95 , 0 , V_60 , 0 , V_31 ) ;
F_21 ( L_16 ,
V_92 , V_93 , V_94 ) ;
...
void F_61 ( void * V_84 , T_1 V_60 , T_1 V_116 , T_1 * V_129 ,
int V_50 )
{
struct V_41 * V_42 = (struct V_41 * ) V_84 ;
struct V_30 * V_30 ;
...
static int F_62 ( struct V_23 * V_26 , T_1 * V_129 , int V_50 )
{
int V_134 ;
int V_52 ;
if ( ! V_26 -> V_29 )
...
void F_63 ( void * V_84 , T_1 V_136 , T_1 * V_129 , int V_50 )
{
struct V_41 * V_42 = (struct V_41 * ) V_84 ;
struct V_23 * V_26 ;
struct V_1 * V_5 = V_42 -> V_5 ;
...
F_25 ( V_72 , V_26 -> V_47 , 0 , 0 , V_26 -> V_28 ) ;
V_26 -> V_71 = V_143 ;
