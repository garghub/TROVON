...
F_72 ( & V_37 -> V_38 . V_160 . V_203 , V_94 ) ;
if ( ! V_161 [ V_107 ] . V_204 )
V_161 [ V_107 ] . V_193 = V_41 ;
else
V_186 = 1 ;
F_73 ( & V_37 -> V_38 . V_160 . V_203 , V_94 ) ;
if ( V_186 ) {
F_12 ( V_35 , L_37
L_38 ,
V_41 , V_107 ) ;
...
V_209 ) ;
struct V_210 * V_38 =
F_76 ( V_160 , struct V_210 , V_160 ) ;
struct V_36 * V_37 =
F_76 ( V_38 , struct V_36 , V_38 ) ;
...
if ( F_36 ( V_35 ) )
V_37 -> V_38 . V_39 =
F_80 ( F_81 ( V_35 -> V_71 , V_37 -> V_224 . V_225 ) +
V_37 -> V_224 . V_226 , V_227 ) ;
else
V_37 -> V_38 . V_39 =
F_80 ( F_81 ( V_35 -> V_71 , 2 ) +
V_228 , V_227 ) ;
if ( ! V_37 -> V_38 . V_39 ) {
F_24 ( V_35 , L_46 ) ;
goto V_229;
...
F_82 ( & V_223 -> V_236 [ V_113 ] ) ;
}
F_83 ( & V_223 -> V_237 ) ;
}
memset ( & V_37 -> V_38 . V_160 . V_183 , 0 , V_35 -> V_95 . V_238 ) ;
V_37 -> V_38 . V_160 . V_183 . type = V_239 ;
F_84 ( & V_37 -> V_38 . V_160 . V_209 ,
F_75 ) ;
F_84 ( & V_37 -> V_38 . V_160 . V_240 ,
V_241 ) ;
F_84 ( & V_37 -> V_38 . V_160 . V_242 ,
V_243 ) ;
F_83 ( & V_37 -> V_38 . V_160 . V_203 ) ;
F_83 ( & V_37 -> V_38 . V_160 . V_244 . V_245 ) ;
...
F_87 ( V_35 , V_249 ) ;
V_247:
F_88 ( V_37 -> V_38 . V_160 . V_246 ) ;
F_89 ( V_37 -> V_38 . V_160 . V_246 ) ;
V_235:
while ( -- V_123 ) {
for ( V_113 = 1 ; V_113 <= V_232 ; V_113 ++ )
...
F_90 ( V_37 -> V_38 . V_39 ) ;
V_229:
F_91 ( & ( V_35 -> V_71 -> V_35 ) , V_250 ,
V_37 -> V_38 . V_90 ,
V_37 -> V_38 . V_173 ) ;
V_37 -> V_38 . V_90 = NULL ;
return - V_16 ;
}
int F_92 ( struct V_34 * V_35 )
{
struct V_36 * V_37 = V_36 ( V_35 ) ;
F_71 ( & V_37 -> V_41 . V_83 ) ;
F_71 ( & V_37 -> V_41 . V_91 ) ;
F_93 ( & V_37 -> V_41 . V_51 , 1 ) ;
V_37 -> V_41 . V_70 = 0 ;
V_37 -> V_41 . V_75 = 1 ;
V_37 -> V_41 . V_72 = NULL ;
V_37 -> V_38 . V_90 = NULL ;
if ( ! F_94 ( V_35 ) ) {
V_37 -> V_41 . V_72 = F_80 ( F_81 ( V_35 -> V_71 , 0 ) +
V_251 , V_252 ) ;
if ( ! V_37 -> V_41 . V_72 ) {
F_24 ( V_35 , L_50 ) ;
return - V_16 ;
...
if ( F_46 ( V_35 ) ) {
V_37 -> V_38 . V_90 = F_95 ( & ( V_35 -> V_71 -> V_35 ) , V_250 ,
& V_37 -> V_38 . V_173 ,
V_155 ) ;
if ( ! V_37 -> V_38 . V_90 ) {
F_24 ( V_35 , L_51 ) ;
...
V_37 -> V_41 . V_254 = F_96 ( L_52 , V_35 -> V_71 ,
V_179 ,
V_179 , 0 ) ;
if ( ! V_37 -> V_41 . V_254 )
goto V_229;
...
int F_100 ( struct V_34 * V_35 )
{
struct V_36 * V_37 = V_36 ( V_35 ) ;
int V_123 ;
int V_49 = 0 ;
V_37 -> V_41 . V_59 = F_101 ( V_37 -> V_41 . V_255 *
sizeof ( struct V_58 ) ,
V_155 ) ;
if ( ! V_37 -> V_41 . V_59 )
return - V_16 ;
...
V_37 -> V_41 . V_62 = 0 ;
F_93 ( & V_37 -> V_41 . V_60 , V_37 -> V_41 . V_255 ) ;
F_83 ( & V_37 -> V_41 . V_61 ) ;
...
{
struct V_116 * V_256 ;
V_256 = F_101 ( sizeof *V_256 , V_155 ) ;
if ( ! V_256 )
return F_103 ( - V_16 ) ;
V_256 -> V_121 = F_104 ( V_36 ( V_35 ) -> V_41 . V_254 , V_155 ,
& V_256 -> V_125 ) ;
if ( ! V_256 -> V_121 ) {
F_58 ( V_256 ) ;
return F_103 ( - V_16 ) ;
...
if ( ! V_256 )
return;
F_105 ( V_36 ( V_35 ) -> V_41 . V_254 , V_256 -> V_121 , V_256 -> V_125 ) ;
F_58 ( V_256 ) ;
}
T_2 F_70 ( void )
{
