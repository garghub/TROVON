...
{
struct V_13 * V_14 ;
struct V_116 * V_117 = & V_41 -> V_118 [ V_91 ] ;
struct V_15 * V_16 = F_50 ( V_117 ) ;
V_14 = F_51 ( V_119 ) ;
if ( F_52 ( ! V_14 ) )
return - V_47 ;
F_17 ( V_14 , V_16 , 1 ) ;
...
static int F_53 ( struct V_113 * V_41 , int V_91 )
{
struct V_116 * V_117 = & V_41 -> V_118 [ V_91 ] ;
struct V_15 * V_16 = F_50 ( V_117 ) ;
F_54 () ;
...
static int F_55 ( struct V_113 * V_41 ,
struct V_114 * V_115 , int V_91 )
{
struct V_13 * V_14 ;
struct V_116 * V_117 = & V_41 -> V_118 [ V_91 ] ;
...
static int F_58 ( struct V_113 * V_41 ,
struct V_114 * V_115 , int V_91 )
{
struct V_13 * V_14 ;
struct V_116 * V_117 = & V_41 -> V_118 [ V_91 ] ;
...
if ( ! V_16 -> V_120 && F_41 () ) {
if ( V_115 -> V_121 >= 0 ) {
return V_115 -> V_33 [ V_115 -> V_121 ] . F_59 ( V_41 ,
V_115 , V_115 -> V_121 ) ;
} else {
F_4 () ;
return - V_122 ;
...
struct V_15 * V_16 ;
struct V_116 * V_117 ;
struct V_113 * V_41 = F_65 ( V_127 , V_14 -> V_6 ) ;
if ( ! V_14 -> V_51 . V_128 )
return - V_47 ;
if ( V_14 -> V_51 . V_19 == 0 ) {
return - V_47 ;
...
struct V_15 * V_16 ;
struct V_132 * V_12 ;
struct V_114 * V_115 = & V_133 ;
if ( ! V_14 -> V_51 . V_128 )
return - V_47 ;
if ( V_14 -> V_51 . V_19 == 0 )
return - V_47 ;
V_115 -> V_121 = - 1 ;
for ( V_66 = 0 ; V_66 < V_130 ; V_66 ++ ) {
V_115 -> V_33 [ V_66 ] . V_134 [ 0 ] = '\0' ;
...
snprintf ( V_12 -> V_134 , V_135 , L_21 , V_66 ) ;
strncpy ( V_12 -> V_94 , V_16 -> V_94 , V_136 ) ;
V_12 -> V_137 = V_16 -> V_54 ;
V_12 -> V_138 = V_16 -> V_54 * V_139 ;
V_12 -> V_51 = 0 ;
switch ( V_16 -> type ) {
case V_25 :
if ( V_16 -> V_61 == V_93 )
...
if ( ! V_14 -> V_51 . V_128 )
return - V_49 ;
if ( V_14 -> V_6 == 0 && F_74 () == & V_133 ) {
F_69 () ;
F_75 () ;
F_76 (cpu) {
V_143 = F_65 ( V_119 , V_129 ) ;
if ( ! V_143 || ! V_143 -> V_51 . V_128 )
continue;
V_41 = F_65 ( V_127 , V_129 ) ;
F_70 ( V_41 ) ;
}
F_40 ( V_14 ) ;
F_67 ( V_14 ) ;
...
V_41 = F_84 ( sizeof( * V_41 ) , V_154 ) ;
if ( ! V_41 )
return - V_155 ;
F_65 ( V_127 , V_14 -> V_6 ) = V_41 ;
F_64 ( V_14 ) ;
V_144 = F_85 ( V_41 ) ;
if ( V_144 ) {
if ( V_152 == 0 )
