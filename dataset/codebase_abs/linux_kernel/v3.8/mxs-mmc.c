...
if ( V_161 ) {
V_10 -> V_178 = (enum V_179 ) V_157 -> V_35 ;
V_5 = F_58 ( V_161 , L_3 ,
& V_10 -> V_151 ) ;
if ( V_5 ) {
F_59 ( F_21 ( V_4 -> V_2 ) ,
...
V_10 -> V_178 = V_155 -> V_180 -> V_181 ;
V_10 -> V_151 = V_165 -> V_182 ;
}
V_4 -> V_2 = V_2 ;
V_4 -> V_28 = 0 ;
V_171 = F_60 ( & V_155 -> V_159 , L_5 ) ;
if ( ! F_61 ( V_171 ) ) {
V_5 = F_62 ( V_171 ) ;
if ( V_5 ) {
F_59 ( & V_155 -> V_159 ,
...
V_166 = F_63 ( & V_155 -> V_159 ) ;
if ( F_61 ( V_166 ) ) {
V_5 = F_64 ( V_166 ) ;
goto V_177;
}
V_10 -> V_183 = F_65 ( & V_155 -> V_159 , NULL ) ;
if ( F_61 ( V_10 -> V_183 ) ) {
V_5 = F_64 ( V_10 -> V_183 ) ;
goto V_177;
}
...
V_2 -> V_202 = 52 ;
V_2 -> V_203 = 1 << 0xf ;
V_2 -> V_204 = ( F_42 ( V_10 ) ) ? 0xff : 0xffffff ;
V_2 -> V_205 = ( F_42 ( V_10 ) ) ? 0xffff : 0xffffffff ;
V_2 -> V_206 = F_71 ( V_10 -> V_74 -> V_207 -> V_159 ) ;
F_72 ( V_155 , V_2 ) ;
...
static int F_84 ( struct V_207 * V_159 )
{
...
static int F_87 ( struct V_207 * V_159 )
{
struct V_1 * V_2 = F_85 ( V_159 ) ;
struct V_3 * V_4 = F_2 ( V_2 ) ;
struct V_9 * V_10 = & V_4 -> V_10 ;
