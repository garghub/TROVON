...
F_87 ( & V_70 -> V_6 , L_25 , V_75 ) ;
for ( V_55 = 11 ; V_55 < V_13 -> V_79 ; V_55 ++ ) {
V_2 = F_86 ( V_13 , V_30 , V_55 ,
V_105 ) ;
V_75 = V_75 || ( V_2 & V_104 ) ;
F_87 ( & V_70 -> V_6 , L_26 , V_55 - 7 , V_2 ) ;
}
F_87 ( & V_70 -> V_6 , L_27 , V_75 ) ;
V_55 = V_75 ? 2 : 0 ;
for (; V_55 < V_13 -> V_80 ; V_55 ++ ) {
V_2 = F_86 ( V_13 , V_49 , V_55 ,
V_105 ) ;
F_87 ( & V_70 -> V_6 , L_26 , V_55 + 1 , V_2 ) ;
if ( V_93 >= V_101 [ V_55 ] ) {
if ( ! ( V_2 & V_104 ) ) {
F_87 ( & V_70 -> V_6 ,
L_28 , V_55 + 1 ) ;
...
T_1 V_55 ;
F_19 ( & V_13 -> V_20 ) ;
if ( F_104 ( V_107 , V_13 -> V_108 + V_109 * 2 ) || ! V_13 -> V_82 ) {
F_87 ( V_6 , L_37 ) ;
for ( V_55 = 0 ; V_55 < V_13 -> V_78 ; V_55 ++ ) {
if ( F_89 ( V_13 -> V_24 , V_55 ) ) {
V_13 -> V_16 [ V_55 ] =
...
struct V_117 V_97 [ 3 ] ;
int V_19 , V_55 , V_118 ;
V_70 = F_107 ( L_10 , V_85 ) ;
if ( ! V_70 ) {
V_19 = - V_77 ;
F_108 ( L_38 ) ;
goto exit;
}
memset ( V_97 , 0 , 3 * sizeof( struct V_117 ) ) ;
V_118 = 0 ;
for ( V_55 = 0 ; V_55 < 3 ; V_55 ++ ) {
if ( ! V_81 [ V_55 ] )
continue;
V_97 [ V_118 ] . V_119 = V_81 [ V_55 ] ;
V_97 [ V_118 ] . V_120 = V_81 [ V_55 ] + V_86 - 1 ;
V_97 [ V_118 ] . V_52 = L_10 ,
V_97 [ V_118 ] . V_121 = V_122 ,
V_19 = F_109 ( & V_97 [ V_118 ] ) ;
if ( V_19 )
goto V_123;
V_118 ++ ;
}
V_19 = F_110 ( V_70 , V_97 , V_118 ) ;
if ( V_19 ) {
F_108 ( L_39 , V_19 ) ;
goto V_123;
}
