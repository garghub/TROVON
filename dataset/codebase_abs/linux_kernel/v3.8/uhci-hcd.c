...
V_2 -> V_90 = F_62 ( L_21 , F_16 ( V_2 ) ,
sizeof( struct V_112 ) , 16 , 0 ) ;
if ( ! V_2 -> V_90 ) {
F_40 ( F_16 ( V_2 ) , L_22 ) ;
goto V_113;
}
V_2 -> V_89 = F_62 ( L_23 , F_16 ( V_2 ) ,
...
for ( V_84 = 0 ; V_84 < V_87 ; V_84 ++ ) {
V_2 -> V_6 [ V_84 ] = F_64 ( V_2 , NULL , NULL ) ;
if ( ! V_2 -> V_6 [ V_84 ] ) {
F_40 ( F_16 ( V_2 ) , L_26 ) ;
goto V_117;
}
}
for ( V_84 = V_118 + 1 ; V_84 < V_119 ; ++ V_84 )
V_2 -> V_6 [ V_84 ] -> V_120 = F_3 ( V_2 , V_2 -> V_121 ) ;
...
if ( F_82 () )
return - V_140 ;
F_83 ( V_141 L_32 V_142 L_33 ,
V_38 ? L_34 : L_7 ) ;
F_30 ( V_143 , & V_144 ) ;
if ( V_85 ) {
V_80 = F_84 ( V_81 , V_110 ) ;
if ( ! V_80 )
goto V_145;
V_106 = F_85 ( L_35 , V_146 ) ;
if ( ! V_106 )
goto V_147;
}
V_148 = F_86 ( L_36 ,
