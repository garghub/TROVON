...
V_2 -> V_274 =
F_174 ( V_2 -> V_276 * sizeof( struct V_27 ) ,
V_393 ) ;
if ( V_2 -> V_274 == NULL ) {
F_9 ( V_2 -> V_17 , L_48 ) ;
return - V_386 ;
...
F_64 ( V_17 , L_70 ,
( ( V_2 -> V_541 == 64 ) ? L_71 : L_72 ) ,
( ( V_2 -> V_542 ) ? L_73 : L_74 ) ) ;
F_64 ( V_17 , L_75 ,
V_2 -> V_7 ) ;
F_64 ( V_17 , L_76 , V_38 -> V_325 ) ;
F_78 ( V_2 , V_543 , V_17 , L_77 , V_17 -> V_70 ) ;
}
static int F_196 ( struct V_1 * V_2 , int V_544 )
{
struct V_67 * V_17 = V_2 -> V_17 ;
int V_545 = 0 ;
F_148 ( V_17 ) ;
...
V_30 = F_203 ( V_2 -> V_38 -> V_325 , F_146 ,
...
V_2 -> V_542 = 0 ;
V_2 -> V_540 = ( T_5 ) F_218 ( V_2 -> V_38 -> V_568 ) ;
}
...
static int F_220 ( struct V_537 * V_38 ,
