...
int V_180 = 100 ;
T_1 V_301 ;
F_46 ( V_2 , V_133 , L_81 , V_300 ) ;
if ( F_7 ( V_2 , V_221 ) & V_222 ) {
F_36 ( V_2 , V_133 , L_82 ) ;
return - V_273 ;
}
V_301 = V_300 | V_222 ;
F_14 ( V_2 , V_221 , V_301 ) ;
do {
F_52 ( 1 ) ;
V_301 = F_7 ( V_2 , V_221 ) ;
} while ( ( V_301 & V_222 ) && ( -- V_180 ) );
if ( ! V_180 ) {
F_46 ( V_2 , V_133 , L_83 ) ;
return - V_218 ;
}
...
memcpy ( V_9 , & V_310 [ V_309 -> V_34 ] , V_246 ) ;
V_309 -> V_246 = V_246 ;
return 0 ;
}
...
V_259 = V_315 | F_150 ( V_315 ) ;
while ( ! ( F_7 ( V_2 , V_316 ) & V_259 ) && -- V_314 )
F_44 ( 1000 ) ;
if ( V_314 == 0 ) {
F_151 ( L_92 ) ;
return - V_129 ;
...
static int F_165 ( struct V_329 * V_4 ,
struct V_330 * V_331 )
{
const char * V_332 ;
T_1 V_333 = 0 ;
...
F_168 ( V_331 , L_104 , & V_4 -> V_334 ) ;
F_168 ( V_331 , L_105 , & V_333 ) ;
if ( V_333 == 4 )
V_4 -> V_5 |= V_6 ;
else
V_4 -> V_5 |= V_8 ;
if ( F_169 ( V_331 , L_106 , NULL ) )
V_4 -> V_225 = V_335 ;
...
if ( V_342 < 0 )
goto V_350;
if ( V_2 -> V_4 . V_225 == V_335 )
V_217 |= V_226 ;
if ( V_2 -> V_4 . V_227 == V_336 )
V_217 |= V_228 ;
F_14 ( V_2 , V_229 , V_217 ) ;
F_95 ( V_28 ) ;
V_342 = F_177 ( V_28 -> V_135 , F_115 ,
