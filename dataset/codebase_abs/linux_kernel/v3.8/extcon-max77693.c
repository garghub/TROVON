...
static int F_19 ( struct V_119 * V_120 )
{
...
int V_4 , V_90 ;
T_1 V_128 ;
V_2 = F_22 ( & V_120 -> V_14 , sizeof( struct V_1 ) ,
V_129 ) ;
if ( ! V_2 ) {
F_3 ( & V_120 -> V_14 , L_31 ) ;
return - V_130 ;
...
F_29 ( & V_2 -> V_88 , F_10 ) ;
for ( V_90 = 0 ; V_90 < F_13 ( V_92 ) ; V_90 ++ ) {
struct V_133 * V_134 = & V_92 [ V_90 ] ;
unsigned int V_94 = 0 ;
V_94 = F_30 ( V_9 -> V_135 , V_134 -> V_93 ) ;
if ( ! V_94 ) {
V_4 = - V_15 ;
goto V_136;
}
...
V_2 -> V_40 = F_22 ( & V_120 -> V_14 , sizeof( struct V_139 ) ,
V_129 ) ;
if ( ! V_2 -> V_40 ) {
F_3 ( & V_120 -> V_14 , L_36 ) ;
V_4 = - V_130 ;
...
V_2 -> V_40 -> V_138 = V_140 ;
V_2 -> V_40 -> V_141 = V_142 ;
V_4 = F_32 ( V_2 -> V_40 , NULL ) ;
if ( V_4 ) {
F_3 ( & V_120 -> V_14 , L_37 ) ;
goto V_136;
}
for ( V_90 = 0 ; V_90 < V_126 -> V_143 ; V_90 ++ ) {
enum V_144 V_145 = V_146 ;
F_33 ( V_2 -> V_9 -> V_10 ,
V_126 -> V_147 [ V_90 ] . V_148 ,
V_126 -> V_147 [ V_90 ] . V_117 ) ;
switch ( V_126 -> V_147 [ V_90 ] . V_148 ) {
case V_149 :
V_145 = V_150 ;
break;
case V_151 :
...
V_136:
while ( -- V_90 >= 0 )
F_35 ( V_92 [ V_90 ] . V_94 , V_2 ) ;
return V_4 ;
}
static int F_36 ( struct V_119 * V_120 )
{
struct V_1 * V_2 = F_37 ( V_120 ) ;
int V_90 ;
for ( V_90 = 0 ; V_90 < F_13 ( V_92 ) ; V_90 ++ )
F_35 ( V_92 [ V_90 ] . V_94 , V_2 ) ;
F_38 ( & V_2 -> V_88 ) ;
