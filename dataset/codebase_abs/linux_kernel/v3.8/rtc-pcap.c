...
int V_33 , V_34 ;
int V_35 = - V_36 ;
V_3 = F_20 ( sizeof( struct V_3 ) , V_37 ) ;
if ( ! V_3 )
return V_35 ;
V_3 -> V_5 = F_21 ( V_18 -> V_14 . V_38 ) ;
F_22 ( V_18 , V_3 ) ;
V_3 -> V_11 = F_23 ( L_1 , & V_18 -> V_14 ,
& V_39 , V_40 ) ;
if ( F_24 ( V_3 -> V_11 ) ) {
V_35 = F_25 ( V_3 -> V_11 ) ;
goto V_41;
...
V_35 = F_26 ( V_33 , F_1 , 0 , L_2 , V_3 ) ;
if ( V_35 )
goto V_42;
V_35 = F_26 ( V_34 , F_1 , 0 , L_3 , V_3 ) ;
if ( V_35 )
goto V_43;
return 0 ;
V_43:
...
{
struct V_3 * V_3 = F_6 ( V_18 ) ;
F_27 ( F_2 ( V_3 -> V_5 , V_6 ) , V_3 ) ;
F_27 ( F_2 ( V_3 -> V_5 , V_9 ) , V_3 ) ;
F_28 ( V_3 -> V_11 ) ;
F_29 ( V_3 ) ;
return 0 ;
}
