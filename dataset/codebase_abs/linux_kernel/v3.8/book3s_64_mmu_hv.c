...
int F_100 ( struct V_1 * V_1 , unsigned long V_74 , unsigned long V_208 )
{
if ( V_1 -> V_18 . V_109 )
...
static int F_102 ( struct V_1 * V_1 , unsigned long * V_209 ,
unsigned long V_73 )
{
struct V_4 * V_5 = V_1 -> V_18 . V_26 ;
...
if ( ! V_1 -> V_18 . V_109 )
return 0 ;
return F_96 ( V_1 , V_184 , F_105 ) ;
}
void F_107 ( struct V_1 * V_1 , unsigned long V_184 , T_4 V_197 )
{
if ( ! V_1 -> V_18 . V_109 )
return;
F_96 ( V_1 , V_184 , F_97 ) ;
...
long F_109 ( struct V_1 * V_1 , struct V_40 * V_41 ,
unsigned long * V_227 )
{
unsigned long V_43 ;
unsigned long * V_209 ;
...
void * F_111 ( struct V_1 * V_1 , unsigned long V_108 ,
unsigned long * V_228 )
{
struct V_40 * V_41 ;
...
struct V_76 * V_76 , * V_78 [ 1 ] ;
int V_44 ;
unsigned long V_184 , V_49 , V_229 ;
unsigned long V_230 ;
unsigned long * V_80 ;
int V_205 ;
V_205 = F_88 ( & V_1 -> V_206 ) ;
...
if ( V_228 )
* V_228 = V_49 - V_229 ;
return F_113 ( V_76 ) + V_229 ;
V_29:
F_90 ( & V_1 -> V_206 , V_205 ) ;
return NULL ;
}
void F_114 ( struct V_1 * V_1 , void * V_231 )
{
struct V_76 * V_76 = F_115 ( V_231 ) ;
F_45 ( V_76 ) ;
}
static long F_116 ( unsigned long V_103 , unsigned long * V_232 ,
unsigned long * V_181 , struct V_4 * V_233 ,
int V_234 , int V_235 )
{
unsigned long V_132 , V_133 ;
int V_236 = 1 ;
int V_237 , V_238 ;
V_238 = ! ! ( V_233 -> V_153 & V_239 ) ;
if ( ! V_235 && ! V_238 )
return 0 ;
V_237 = 0 ;
if ( V_232 [ 0 ] & ( V_114 | V_113 ) ) {
V_237 = 1 ;
if ( ( V_103 & V_240 ) &&
! ( V_232 [ 0 ] & V_56 ) )
V_237 = 0 ;
...
V_237 = ! ! ( V_132 & V_114 ) ;
if ( ( V_103 & V_240 ) && ! ( V_132 & V_56 ) )
V_237 = 0 ;
V_133 = V_233 -> V_153 | ( V_232 [ 1 ] & ( V_57 | V_58 ) ) ;
V_238 = ! ! ( V_233 -> V_153 & V_239 ) ;
if ( V_237 == V_234 && V_238 ) {
V_133 &= ~ V_239 ;
V_233 -> V_153 = V_133 ;
}
...
static T_6 F_117 ( struct V_241 * V_241 , char T_7 * V_242 ,
T_8 V_243 , T_9 * V_244 )
{
struct V_245 * V_246 = V_241 -> V_247 ;
struct V_1 * V_1 = V_246 -> V_1 ;
struct V_248 V_249 ;
unsigned long * V_232 ;
struct V_4 * V_233 ;
unsigned long V_43 , V_250 , V_251 ;
unsigned long T_7 * V_252 ;
struct V_248 T_7 * V_253 ;
unsigned long V_103 ;
int V_235 ;
unsigned long V_181 [ 2 ] ;
if ( ! F_118 ( V_254 , V_242 , V_243 ) )
return - V_193 ;
V_235 = V_246 -> V_235 ;
V_103 = V_246 -> V_103 ;
V_43 = V_246 -> V_145 ;
V_232 = ( unsigned long * ) ( V_1 -> V_18 . V_21 + ( V_43 * V_255 ) ) ;
V_233 = V_1 -> V_18 . V_26 + V_43 ;
V_252 = ( unsigned long T_7 * ) V_242 ;
V_250 = 0 ;
while ( V_250 + sizeof( V_249 ) + V_255 < V_243 ) {
V_253 = (struct V_248 T_7 * ) V_242 ;
V_249 . V_256 = 0 ;
V_249 . V_257 = 0 ;
V_251 = V_250 ;
V_250 += sizeof( V_249 ) ;
V_252 = ( unsigned long T_7 * ) ( V_242 + sizeof( V_249 ) ) ;
if ( ! V_235 ) {
...
V_249 . V_256 < 0xffff &&
V_250 + V_255 < V_243 &&
F_116 ( V_103 , V_232 , V_181 , V_233 , 1 , V_235 ) ) {
++ V_249 . V_256 ;
if ( F_119 ( V_181 [ 0 ] , V_252 ) ||
F_119 ( V_181 [ 1 ] , V_252 + 1 ) )
return - V_193 ;
V_250 += V_255 ;
V_252 += 2 ;
++ V_43 ;
...
while ( V_43 < V_1 -> V_18 . V_23 &&
V_249 . V_257 < 0xffff &&
F_116 ( V_103 , V_232 , V_181 , V_233 , 0 , V_235 ) ) {
++ V_249 . V_257 ;
++ V_43 ;
V_232 += 2 ;
++ V_233 ;
}
if ( V_249 . V_256 || V_249 . V_257 ) {
if ( F_120 ( V_253 , & V_249 , sizeof( V_249 ) ) )
return - V_193 ;
V_251 = V_250 ;
V_242 = ( char T_7 * ) V_252 ;
} else {
V_250 = V_251 ;
}
...
static T_6 F_121 ( struct V_241 * V_241 , const char T_7 * V_242 ,
T_8 V_243 , T_9 * V_244 )
{
struct V_245 * V_246 = V_241 -> V_247 ;
struct V_1 * V_1 = V_246 -> V_1 ;
...
unsigned long T_7 * V_252 ;
unsigned long * V_232 ;
unsigned long V_258 [ 2 ] ;
T_6 V_250 ;
long int V_29 , V_53 ;
int V_259 ;
if ( ! F_118 ( V_260 , V_242 , V_243 ) )
return - V_193 ;
F_11 ( & V_1 -> V_31 ) ;
V_259 = V_1 -> V_18 . V_32 ;
if ( V_259 ) {
...
V_29 = 0 ;
for ( V_250 = 0 ; V_250 + sizeof( V_249 ) <= V_243 ; ) {
V_29 = - V_193 ;
if ( F_122 ( & V_249 , V_242 , sizeof( V_249 ) ) )
break;
V_29 = 0 ;
if ( V_250 + V_249 . V_256 * V_255 > V_243 )
break;
V_250 += sizeof( V_249 ) ;
V_242 += sizeof( V_249 ) ;
V_29 = - V_66 ;
V_43 = V_249 . V_145 ;
if ( V_43 >= V_1 -> V_18 . V_23 ||
V_43 + V_249 . V_256 + V_249 . V_257 > V_1 -> V_18 . V_23 )
break;
V_232 = ( unsigned long * ) ( V_1 -> V_18 . V_21 + ( V_43 * V_255 ) ) ;
V_252 = ( unsigned long T_7 * ) V_242 ;
for ( V_216 = 0 ; V_216 < V_249 . V_256 ; ++ V_216 ) {
V_29 = - V_193 ;
if ( F_123 ( V_132 , V_252 ) || F_123 ( V_133 , V_252 + 1 ) )
goto V_34;
V_29 = - V_66 ;
if ( ! ( V_132 & V_114 ) )
goto V_34;
...
if ( ! V_259 && F_125 ( V_132 ) ) {
unsigned long V_49 = F_50 ( V_132 , V_133 ) ;
unsigned long V_262 = F_126 ( V_49 ) ;
unsigned long V_263 ;
V_1 -> V_18 . V_151 = V_262 | V_129 |
( V_55 << V_264 ) ;
V_263 = V_1 -> V_18 . V_263 & ~ V_265 ;
V_263 |= V_262 << ( V_266 - 4 ) ;
V_1 -> V_18 . V_263 = V_263 ;
V_259 = 1 ;
}
++ V_43 ;
V_232 += 2 ;
}
for ( V_216 = 0 ; V_216 < V_249 . V_257 ; ++ V_216 ) {
if ( V_232 [ 0 ] & ( V_114 | V_113 ) )
F_124 ( V_1 , 0 , V_43 , 0 , V_258 ) ;
++ V_43 ;
V_232 += 2 ;
...
static int F_128 ( struct V_267 * V_267 , struct V_241 * V_268 )
{
struct V_245 * V_246 = V_268 -> V_247 ;
V_268 -> V_247 = NULL ;
if ( ! ( V_246 -> V_103 & V_269 ) )
F_129 ( & V_246 -> V_1 -> V_18 . V_270 ) ;
F_130 ( V_246 -> V_1 ) ;
F_131 ( V_246 ) ;
return 0 ;
}
int F_132 ( struct V_1 * V_1 , struct V_271 * V_272 )
{
int V_53 ;
struct V_245 * V_246 ;
int V_273 ;
if ( V_272 -> V_103 & ~ ( V_240 | V_269 ) )
return - V_66 ;
V_246 = F_133 ( sizeof( * V_246 ) , V_11 ) ;
if ( ! V_246 )
return - V_20 ;
F_134 ( V_1 ) ;
V_246 -> V_1 = V_1 ;
V_246 -> V_145 = V_272 -> V_274 ;
V_246 -> V_103 = V_272 -> V_103 ;
V_246 -> V_235 = 1 ;
V_273 = ( V_272 -> V_103 & V_269 ) ? V_275 : V_276 ;
V_53 = F_135 ( L_7 , & V_277 , V_246 , V_273 ) ;
if ( V_53 < 0 ) {
F_130 ( V_1 ) ;
return V_53 ;
}
...
{
struct V_279 * V_280 = & V_39 -> V_18 . V_280 ;
if ( F_25 ( V_67 ) )
V_39 -> V_18 . V_124 = 32 ;
else
V_39 -> V_18 . V_124 = 64 ;
