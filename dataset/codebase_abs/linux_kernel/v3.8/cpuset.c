...
V_9 -> V_32 = V_32 ;
V_72 ++ ;
if ( ! F_8 ( V_170 , & V_3 -> V_11 ) )
goto V_171;
F_38 (tmp_cg, &parent_cg->children, sibling) {
struct V_1 * V_172 = F_1 ( V_169 ) ;
if ( F_9 ( V_172 ) || F_7 ( V_172 ) )
goto V_171;
}
F_75 ( & V_98 ) ;
V_9 -> V_33 = V_32 -> V_33 ;
F_22 ( V_9 -> V_30 , V_32 -> V_30 ) ;
F_76 ( & V_98 ) ;
V_171:
return & V_9 -> V_5 ;
}
...
static void F_145 ( struct V_6 * V_36 ,
struct V_85 * V_86 )
{
struct V_2 * V_174 = V_86 -> V_22 ;
F_146 ( V_174 , V_36 ) ;
}
static void F_147 ( struct V_1 * V_101 , struct V_1 * V_102 )
{
struct V_85 V_86 ;
...
static void F_148 ( struct V_1 * V_9 )
{
struct V_1 * V_32 ;
...
static struct V_1 * F_149 ( struct V_177 * V_178 )
{
struct V_1 * V_57 ;
struct V_1 * V_58 ;
struct V_2 * V_3 ;
...
static void
F_150 ( struct V_1 * V_179 , enum V_180 V_181 )
{
F_45 ( V_178 ) ;
struct V_1 * V_57 ;
static T_1 V_182 ;
F_50 ( (struct V_177 * ) & V_179 -> V_56 , & V_178 ) ;
switch ( V_181 ) {
case V_183 :
while ( ( V_57 = F_149 ( & V_178 ) ) != NULL ) {
...
F_93 ( V_57 , & V_182 , NULL ) ;
}
}
}
void F_151 ( bool V_185 )
{
struct V_53 * V_82 ;
T_2 * V_67 ;
int V_68 ;
...
static int F_152 ( struct V_186 * V_187 ,
...
int F_165 ( int V_195 , T_13 V_196 )
{
const struct V_1 * V_9 ;
int V_197 ;
if ( F_166 () || ( V_196 & V_198 ) )
return 1 ;
F_167 ( ! ( V_196 & V_199 ) ) ;
if ( F_168 ( V_195 , V_103 -> V_33 ) )
return 1 ;
if ( F_81 ( F_82 ( V_107 ) ) )
return 1 ;
if ( V_196 & V_199 )
...
V_9 = F_164 ( F_4 ( V_103 ) ) ;
F_88 ( V_103 ) ;
V_197 = F_168 ( V_195 , V_9 -> V_33 ) ;
F_76 ( & V_98 ) ;
return V_197 ;
}
int F_169 ( int V_195 , T_13 V_196 )
{
if ( F_166 () || ( V_196 & V_198 ) )
return 1 ;
if ( F_168 ( V_195 , V_103 -> V_33 ) )
...
static int F_171 ( int * V_200 )
{
int V_195 ;
V_195 = F_172 ( * V_200 , V_103 -> V_33 ) ;
if ( V_195 == V_201 )
V_195 = F_173 ( V_103 -> V_33 ) ;
* V_200 = V_195 ;
return V_195 ;
}
int F_174 ( void )
{
if ( V_103 -> V_202 == V_203 )
V_103 -> V_202 =
F_175 ( & V_103 -> V_33 ) ;
return F_171 ( & V_103 -> V_202 ) ;
}
int F_176 ( void )
{
if ( V_103 -> V_204 == V_203 )
V_103 -> V_204 =
F_175 ( & V_103 -> V_33 ) ;
return F_171 ( & V_103 -> V_204 ) ;
}
int F_177 ( const struct V_6 * V_205 ,
const struct V_6 * V_206 )
{
return F_25 ( V_205 -> V_33 , V_206 -> V_33 ) ;
}
...
F_114 ( & V_207 ) ;
snprintf ( V_208 , V_209 ,
V_18 ? ( const char * ) V_18 -> V_210 . V_211 : L_10 ) ;
F_131 ( V_212 , V_213 ,
V_36 -> V_33 ) ;
F_54 ( V_214 L_11 ,
V_36 -> V_215 , V_208 , V_212 ) ;
F_115 ( & V_207 ) ;
}
void F_179 ( void )
{
...
static int F_180 ( struct V_216 * V_217 , void * V_218 )
{
struct V_219 * V_219 ;
struct V_6 * V_36 ;
char * V_93 ;
...
static int F_186 ( struct V_224 * V_224 , struct V_163 * V_163 )
{
struct V_219 * V_219 = F_187 ( V_224 ) -> V_219 ;
return F_188 ( V_163 , F_180 , V_219 ) ;
}
void F_189 ( struct V_216 * V_217 , struct V_6 * V_7 )
{
F_190 ( V_217 , L_12 ) ;
F_191 ( V_217 , & V_7 -> V_33 ) ;
F_190 ( V_217 , L_13 ) ;
F_190 ( V_217 , L_14 ) ;
F_192 ( V_217 , & V_7 -> V_33 ) ;
F_190 ( V_217 , L_13 ) ;
}
