...
char * T_2 F_45 ( char * V_61 )
{
if ( ! strcmp ( V_61 , L_18 ) ) {
V_59 = 0 ;
return NULL ;
} else if ( ! strncmp ( V_61 , L_19 , 8 ) ) {
V_22 = F_46 ( V_61 + 8 , NULL , 0 ) ;
return NULL ;
}
return V_61 ;
}
int F_47 ( struct V_1 * V_2 , int V_62 )
{
int V_63 ;
if ( ( V_63 = F_48 ( V_2 , V_62 ) ) < 0 )
return V_63 ;
if ( ! V_2 -> V_64 )
F_49 ( V_2 ) ;
return 0 ;
