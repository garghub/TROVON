...
case V_249 :
V_28 = - V_250 ;
if ( ! F_89 ( F_69 ( V_43 ) -> V_251 , V_252 ) )
break;
V_28 = F_90 ( V_43 , V_117 , V_118 , V_17 ) ;
break;
case V_127 :
if ( ! ! V_119 && ! F_89 ( F_69 ( V_43 ) -> V_251 , V_253 ) &&
! F_89 ( F_69 ( V_43 ) -> V_251 , V_252 ) ) {
V_28 = - V_250 ;
break;
}
if ( V_17 < 1 )
...
{
struct V_5 * V_256 = F_2 ( V_4 ) ;
if ( F_93 ( V_4 ) ) {
V_256 -> V_56 = F_94 ( V_4 ) ;
V_256 -> V_58 . V_8 = F_95 ( V_4 ) ;
} else {
V_256 -> V_56 = 0 ;
V_256 -> V_58 . V_8 = 0 ;
}
...
break;
case V_130 :
V_119 = ( V_178 int ) F_81 ( ( V_263 ) V_42 -> V_179 ) ;
break;
case V_182 :
{
struct V_185 V_57 ;
...
if ( V_42 -> V_45 & V_156 ) {
struct V_5 V_6 ;
V_6 . V_7 . V_8 = V_42 -> V_267 ;
V_6 . V_58 . V_8 = V_42 -> V_267 ;
V_6 . V_56 = V_42 -> V_190 ;
F_4 ( & V_2 , V_10 , V_11 , sizeof( V_6 ) , & V_6 ) ;
}
if ( V_42 -> V_45 & V_157 ) {
int V_268 = V_42 -> V_173 ;
F_4 ( & V_2 , V_10 , V_13 , sizeof( V_268 ) , & V_268 ) ;
}
if ( V_42 -> V_45 & V_158 ) {
int V_15 = V_42 -> V_269 ;
