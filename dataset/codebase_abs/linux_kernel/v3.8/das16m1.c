...
unsigned int V_46 ;
unsigned long V_41 ;
V_6 -> V_92 = V_6 -> V_93 -> V_94 ;
V_41 = V_91 -> V_95 [ 0 ] ;
V_12 = F_37 ( sizeof( * V_12 ) , V_96 ) ;
if ( ! V_12 )
return - V_97 ;
V_6 -> V_13 = V_12 ;
if ( ! F_38 ( V_41 , V_98 , V_6 -> V_92 ) ) {
F_10 ( V_6 , L_9 ) ;
return - V_99 ;
}
if ( ! F_38 ( V_41 + V_100 , V_101 ,
V_6 -> V_92 ) ) {
F_39 ( V_41 , V_98 ) ;
F_10 ( V_6 , L_9 ) ;
return - V_99 ;
...
V_8 -> V_121 = F_24 ;
V_8 = & V_6 -> V_103 [ 3 ] ;
F_43 ( V_6 , V_8 , NULL , V_6 -> V_41 + V_100 ) ;
F_14 ( V_124 , V_6 -> V_41 + V_125 ) ;
F_14 ( V_12 -> V_71 , V_6 -> V_41 + V_69 ) ;
if ( V_6 -> V_46 )
...
{
if ( V_6 -> V_103 )
F_45 ( V_6 , & V_6 -> V_103 [ 3 ] ) ;
if ( V_6 -> V_46 )
F_46 ( V_6 -> V_46 , V_6 ) ;
if ( V_6 -> V_41 ) {
F_39 ( V_6 -> V_41 , V_98 ) ;
F_39 ( V_6 -> V_41 + V_100 , V_101 ) ;
}
}
