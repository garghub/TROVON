...
F_6 ( V_18 , V_176 ) ;
error = F_88 ( V_18 -> V_33 , V_5 , args -> V_173 ,
( args -> V_166 & V_167 ) ?
args -> V_177 : NULL , 1 , 0 ) ;
F_89 ( error < 0 ) ;
error = F_88 ( V_18 -> V_33 , V_5 + error , args -> V_173 ,
( args -> V_166 & V_168 ) ?
args -> V_178 : NULL , 1 ,
V_179 ) ;
F_89 ( error < 0 ) ;
...
static int F_99 ( struct V_1 * V_2 , struct V_17 * V_18 ,
struct V_191 * V_180 )
{
enum V_45 V_46 ;
int error ;
...
static int F_104 ( struct V_1 * V_2 , struct V_17 * V_18 ,
struct V_200 * V_180 )
{
enum V_45 V_46 ;
int error ;
...
int F_105 ( struct V_17 * V_18 , struct V_201 * V_202 ,
int V_203 )
{
...
V_202 -> V_208 = F_106 ( V_202 -> V_86 -> V_47 ) ;
V_20 = F_9 ( V_18 , 4 ) ;
if ( F_10 ( V_20 == NULL ) )
goto V_22;
if ( * V_20 != V_76 ) {
...
static inline int F_117 ( struct V_17 * V_18 ,
struct V_234 * V_180 )
{
struct V_235 * * V_236 ;
unsigned int * V_237 ;
...
V_237 = & V_180 -> V_242 ;
error = F_119 ( V_18 -> V_33 , V_238 , V_237 , V_236 ) ;
if ( F_10 ( error <= 0 ) )
goto V_111;
V_236 = NULL ;
...
V_237 = & V_180 -> V_243 ;
error = F_119 ( V_18 -> V_33 , V_238 + error , V_237 , V_236 ) ;
if ( F_10 ( error <= 0 ) )
return error ;
error = 0 ;
V_111:
...
static int F_91 ( enum V_45 V_46 )
{
int V_244 ;
