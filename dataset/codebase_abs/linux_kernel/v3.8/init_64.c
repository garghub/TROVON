...
{
unsigned long V_82 = F_89 ( V_6 + V_32 ) ;
if ( V_82 > V_83 ) {
V_83 = V_82 ;
V_84 = V_82 ;
V_85 = ( void * ) F_42 ( V_83 * V_20 - 1 ) + 1 ;
}
}
int F_90 ( int V_86 , T_10 V_6 , T_10 V_32 )
{
struct V_87 * V_88 = F_91 ( V_86 ) ;
struct V_89 * V_89 = V_88 -> V_90 + V_91 ;
unsigned long V_92 , V_93 = V_6 >> V_43 ;
unsigned long V_94 = V_32 >> V_43 ;
int V_95 ;
V_92 = F_92 ( V_6 , V_6 + V_32 ) ;
if ( V_92 > V_42 )
V_42 = V_92 ;
V_95 = F_93 ( V_86 , V_89 , V_93 , V_94 ) ;
F_94 ( V_95 ) ;
F_88 ( V_6 , V_32 ) ;
return V_95 ;
}
...
#endif
V_100 = F_100 ( 0 , V_83 ) ;
V_97 = V_83 - V_101 - V_100 ;
V_17 = 1 ;
V_96 = ( unsigned long ) & V_102 - ( unsigned long ) & V_46 ;
V_98 = ( unsigned long ) & V_103 - ( unsigned long ) & V_102 ;
V_99 = ( unsigned long ) & V_104 - ( unsigned long ) & V_105 ;
F_101 ( & V_106 , ( void * ) V_107 ,
V_108 - V_107 , V_109 ) ;
F_24 ( V_110 L_14
L_15 ,
F_102 () << ( V_43 - 10 ) ,
...
unsigned long V_6 = F_104 ( V_46 ) ;
unsigned long V_113 =
( ( unsigned long ) V_114 + V_20 - 1 ) & V_21 ;
unsigned long V_7 = ( unsigned long ) & V_115 ;
unsigned long V_116 = F_109 ( ( unsigned long ) & V_111 ) ;
unsigned long V_117 = F_109 ( ( unsigned long ) & V_118 ) ;
unsigned long V_119 = ( unsigned long ) & V_120 ;
F_24 ( V_110 L_18 ,
( V_7 - V_6 ) >> 10 ) ;
F_107 ( V_6 , ( V_7 - V_6 ) >> V_43 ) ;
V_112 = 1 ;
F_110 ( V_113 , ( V_7 - V_113 ) >> V_43 ) ;
F_111 () ;
#ifdef F_112
F_24 ( V_110 L_19 , V_6 , V_7 ) ;
F_105 ( V_6 , ( V_7 - V_6 ) >> V_43 ) ;
F_24 ( V_110 L_20 ) ;
F_107 ( V_6 , ( V_7 - V_6 ) >> V_43 ) ;
#endif
...
F_9 ( F_114 ( V_113 ) ) ) ;
F_113 ( L_21 ,
( unsigned long ) F_9 ( F_114 ( V_117 ) ) ,
( unsigned long ) F_9 ( F_114 ( V_119 ) ) ) ;
}
int F_115 ( unsigned long V_54 )
{
unsigned long V_121 = ( ( long ) V_54 ) >> V_122 ;
T_2 * V_13 ;
T_5 * V_23 ;
T_6 * V_26 ;
T_7 * V_27 ;
if ( V_121 != 0 && V_121 != - 1UL )
return 0 ;
V_13 = F_5 ( V_54 ) ;
if ( F_6 ( * V_13 ) )
return 0 ;
...
return 0 ;
if ( F_77 ( * V_23 ) )
return F_116 ( F_117 ( * V_23 ) ) ;
V_26 = F_28 ( V_23 , V_54 ) ;
if ( F_30 ( * V_26 ) )
return 0 ;
if ( F_69 ( * V_26 ) )
return F_116 ( F_118 ( * V_26 ) ) ;
V_27 = F_32 ( V_26 , V_54 ) ;
if ( F_119 ( * V_27 ) )
return 0 ;
return F_116 ( F_120 ( * V_27 ) ) ;
}
struct V_123 * F_121 ( struct V_124 * V_125 )
{
#ifdef F_122
if ( ! V_125 || V_125 -> V_126 . V_127 )
return NULL ;
#endif
return & V_128 ;
}
int F_123 ( struct V_124 * V_125 , unsigned long V_54 )
{
struct V_123 * V_129 = F_121 ( V_125 ) ;
if ( ! V_129 )
return 0 ;
return ( V_54 >= V_129 -> V_130 ) && ( V_54 < V_129 -> V_131 ) ;
}
int F_124 ( unsigned long V_54 )
{
return ( V_54 >= V_107 ) && ( V_54 < V_108 ) ;
}
const char * F_125 ( struct V_123 * V_129 )
{
if ( V_129 -> V_132 && V_129 -> V_130 == ( long ) V_129 -> V_132 -> V_126 . V_133 )
return L_22 ;
if ( V_129 == & V_128 )
return L_23 ;
return NULL ;
...
int T_9
F_128 ( struct V_11 * V_135 , unsigned long V_32 , int V_136 )
{
unsigned long V_54 = ( unsigned long ) V_135 ;
unsigned long V_7 = ( unsigned long ) ( V_135 + V_32 ) ;
unsigned long V_63 ;
T_2 * V_13 ;
T_5 * V_23 ;
T_6 * V_26 ;
...
void * V_137 = NULL ;
V_13 = F_129 ( V_54 , V_136 ) ;
if ( ! V_13 )
return - V_138 ;
V_23 = F_130 ( V_13 , V_54 , V_136 ) ;
if ( ! V_23 )
return - V_138 ;
if ( ! V_139 ) {
V_63 = ( V_54 + V_20 ) & V_21 ;
V_26 = F_131 ( V_23 , V_54 , V_136 ) ;
if ( ! V_26 )
return - V_138 ;
V_137 = F_132 ( V_26 , V_54 , V_136 ) ;
if ( ! V_137 )
return - V_138 ;
V_140 = V_54 + V_20 ;
V_141 = V_137 + V_20 ;
...
if ( F_30 ( * V_26 ) ) {
T_7 V_142 ;
V_137 = F_134 ( V_35 , V_136 ) ;
if ( ! V_137 )
return - V_138 ;
V_142 = F_64 ( F_44 ( V_137 ) >> V_43 ,
V_38 ) ;
F_47 ( V_26 , F_48 ( F_63 ( V_142 ) ) ) ;
if ( V_141 != V_137 || V_143 != V_136 ) {
if ( V_144 )
F_24 ( V_145 L_25 ,
V_146 , V_140 - 1 , V_144 , V_141 - 1 , V_143 ) ;
V_146 = V_54 ;
V_143 = V_136 ;
V_144 = V_137 ;
}
...
F_135 ( ( T_7 * ) V_26 , V_136 , V_54 , V_63 ) ;
}
}
F_4 ( ( unsigned long ) V_135 , V_7 ) ;
return 0 ;
}
void T_9 F_136 ( void )
{
