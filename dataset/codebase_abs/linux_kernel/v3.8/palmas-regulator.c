...
V_60 -> V_38 [ V_63 ] = F_26 ( V_11 ,
sizeof( struct V_37 ) , V_69 ) ;
V_34 = F_27 ( V_64 [ V_63 ] . V_67 ,
L_4 , & V_62 ) ;
if ( ! V_34 )
...
V_34 = F_27 ( V_58 , L_9 , & V_62 ) ;
if ( ! V_34 )
V_60 -> V_70 = V_62 ;
}
static int F_28 ( struct V_71 * V_72 )
{
struct V_1 * V_1 = F_29 ( V_72 -> V_11 . V_73 ) ;
...
if ( V_58 && ! V_60 ) {
V_60 = F_26 ( & V_72 -> V_11 , sizeof( * V_60 ) , V_69 ) ;
if ( ! V_60 )
return - V_77 ;
F_21 ( & V_72 -> V_11 , V_58 , V_60 ) ;
}
V_13 = F_26 ( & V_72 -> V_11 , sizeof( * V_13 ) , V_69 ) ;
if ( ! V_13 )
return - V_77 ;
V_13 -> V_11 = & V_72 -> V_11 ;
V_13 -> V_1 = V_1 ;
