...
V_43 = V_10 -> V_9 -> V_78 ( V_19 , V_10 , V_41 , V_4 -> V_74 , V_25 , & V_42 ) ;
if ( V_43 == 0 ) {
if ( V_44 ) {
F_30 ( V_27 ) ;
V_10 -> V_7 = * V_36 ;
...
int F_50 ( struct V_15 * V_10 , struct V_2 * * V_119 ,
...
V_124 = F_51 ( V_119 [ V_122 -> V_125 ] , V_120 ,
L_2 , V_126 ,
V_127 ) ;
if ( F_52 ( V_124 ) )
return F_53 ( V_124 ) ;
...
V_124 = F_54 ( V_119 [ V_122 -> V_117 ] , V_120 , NULL ,
V_126 , V_127 ) ;
if ( F_52 ( V_124 ) )
return F_53 ( V_124 ) ;
V_116 -> V_117 = V_124 ;
