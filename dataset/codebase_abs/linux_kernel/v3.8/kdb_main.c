...
V_204 -> V_207 , ( void * ) V_204 ) ;
#ifdef F_80
F_16 ( L_102 , F_81 ( V_204 ) ) ;
#endif
if ( V_204 -> V_205 == V_208 )
F_16 ( L_103 ) ;
else if ( V_204 -> V_205 == V_209 )
F_16 ( L_104 ) ;
else
F_16 ( L_105 ) ;
F_16 ( L_106 , V_204 -> V_210 ) ;
#ifdef F_80
{
struct V_211 * V_212 ;
F_16 ( L_107 ) ;
...
if ( V_25 ) {
char * V_13 ;
V_216 = F_85 ( V_26 [ 1 ] , & V_13 , 0 ) ;
if ( * V_13 )
V_216 = 0 ;
if ( V_25 > 1 ) {
V_217 = F_10 ( V_26 [ 2 ] , & V_13 , 0 ) ;
if ( * V_13 || V_217 < 0 )
V_217 = 0 ;
}
}
V_21 = F_11 ( L_112 , & V_215 ) ;
if ( ! V_21 && V_215 ) {
const char * V_223 [] = { L_113 , L_112 , L_114 } ;
F_15 ( 2 , V_223 ) ;
}
F_86 ( & V_220 ) ;
while ( F_87 ( & V_220 , 1 , NULL , 0 , NULL ) )
V_187 ++ ;
if ( V_216 < 0 ) {
if ( V_217 >= V_187 )
F_16 ( L_115
L_116 , V_187 ) ;
else if ( V_217 - V_216 >= V_187 )
F_16 ( L_117
L_118 , V_187 , V_187 - V_217 ) ;
V_218 = V_217 ;
V_216 = abs ( V_216 ) ;
} else if ( V_216 > 0 ) {
V_218 = V_187 - V_216 - V_217 ;
V_216 = abs ( V_216 ) ;
if ( V_217 >= V_187 ) {
F_16 ( L_119
L_120 , V_187 ) ;
...
if ( V_218 >= V_187 || V_218 < 0 )
return 0 ;
F_86 ( & V_220 ) ;
while ( F_87 ( & V_220 , 1 , V_222 , sizeof( V_222 ) , & V_72 ) ) {
if ( V_218 ) {
V_218 -- ;
continue;
}
...
static int F_91 ( const char * V_20 , const struct V_227 * V_228 )
{
if ( ! F_92 ( & V_224 , - 1 , 0 ) )
return - V_229 ;
V_225 . V_226 ( 1 ) ;
...
{
int V_10 , V_230 , V_231 = 1 ;
char V_205 , V_232 = '?' ;
F_16 ( L_124 , F_50 () ) ;
F_16 ( L_125 ) ;
for ( V_230 = - 1 , V_10 = 0 ; V_10 < V_233 ; V_10 ++ ) {
if ( ! F_94 ( V_10 ) ) {
V_205 = 'F' ;
} else {
V_205 = ' ' ;
...
if ( V_25 != 1 )
return V_29 ;
V_21 = F_12 ( V_26 [ 1 ] , & V_234 ) ;
if ( V_21 )
return V_21 ;
if ( ( V_234 > V_233 ) || ! F_94 ( V_234 ) )
return V_191 ;
V_235 = V_234 ;
return V_145 ;
}
...
{
int V_236 = 0 , V_237 = 0 ;
unsigned long V_238 = F_98 ( L_130 ) ,
V_239 = F_98 ( L_131 ) ;
unsigned long V_2 ;
const struct V_1 * V_3 , * V_240 ;
F_99 (cpu) {
V_3 = F_1 ( V_2 ) ;
if ( F_100 ( V_3 , V_238 ) )
++ V_236 ;
...
int V_2 ;
unsigned long V_241 ;
if ( ! V_3 || F_104 ( & V_241 , ( char * ) V_3 , sizeof( unsigned long ) ) )
return;
V_2 = F_48 ( V_3 ) ;
F_16 ( L_138 ,
( void * ) V_3 , V_3 -> V_122 , V_3 -> V_242 -> V_122 ,
F_46 ( V_3 ) , F_48 ( V_3 ) ,
F_95 ( V_3 ) ,
( void * ) ( & V_3 -> V_243 ) ,
V_3 == F_1 ( F_50 () ) ? '*' : ' ' ,
...
unsigned long V_245 , V_2 ;
if ( V_25 == 0 )
F_97 () ;
F_16 ( L_142 ,
( int ) ( 2 * sizeof( void * ) ) + 2 , L_143 ,
( int ) ( 2 * sizeof( void * ) ) + 2 , L_144 ) ;
V_245 = F_98 ( V_25 ? V_26 [ 1 ] : NULL ) ;
F_99 (cpu) {
if ( F_31 ( V_88 ) )
return 0 ;
V_3 = F_1 ( V_2 ) ;
...
if ( V_21 )
return V_24 ;
V_3 = F_107 ( ( V_246 ) V_20 , & V_247 ) ;
if ( ! V_3 ) {
F_16 ( L_146 , ( V_246 ) V_20 ) ;
return 0 ;
}
}
F_45 ( V_3 ) ;
...
if ( F_31 ( V_88 ) )
goto V_251;
sprintf ( V_222 , L_108 V_125 L_29 , V_61 , V_248 ) ;
V_21 = F_29 ( V_222 ) ;
if ( V_21 )
goto V_251;
V_41 = V_248 + V_249 ;
if ( F_63 ( & V_248 , V_41 , sizeof( V_248 ) ) )
goto V_251;
}
V_251:
F_26 ( V_61 ) ;
...
F_34 (kt, i) {
if ( V_252 -> V_92 )
F_16 ( L_149 , V_252 -> V_92 ,
V_252 -> V_253 , V_252 -> V_254 ) ;
if ( F_31 ( V_88 ) )
return 0 ;
}
return 0 ;
...
static void F_113 ( struct V_265 * V_266 , struct V_267 * V_268 )
{
static int V_269 [] = { 31 , 29 , 31 , 30 , 31 , 30 , 31 ,
31 , 30 , 31 , 30 , 31 } ;
memset ( V_268 , 0 , sizeof( * V_268 ) ) ;
V_268 -> V_270 = V_266 -> V_271 % ( 24 * 60 * 60 ) ;
V_268 -> V_272 = V_266 -> V_271 / ( 24 * 60 * 60 ) +
( 2 * 365 + 1 ) ;
V_268 -> V_273 = V_268 -> V_270 / 60 % 60 ;
V_268 -> V_274 = V_268 -> V_270 / 60 / 60 ;
V_268 -> V_270 = V_268 -> V_270 % 60 ;
V_268 -> V_275 = 68 + 4 * ( V_268 -> V_272 / ( 4 * 365 + 1 ) ) ;
V_268 -> V_272 %= ( 4 * 365 + 1 ) ;
V_269 [ 1 ] = 29 ;
while ( V_268 -> V_272 >= V_269 [ V_268 -> V_276 ] ) {
V_268 -> V_272 -= V_269 [ V_268 -> V_276 ] ;
if ( ++ V_268 -> V_276 == 12 ) {
V_268 -> V_276 = 0 ;
++ V_268 -> V_275 ;
V_269 [ 1 ] = 28 ;
...
static void F_114 ( struct V_277 * V_20 )
{
struct V_265 V_278 ;
F_115 ( & V_278 ) ;
memset ( V_20 , 0 , sizeof( * V_20 ) ) ;
V_20 -> V_278 = V_278 . V_271 ;
V_20 -> V_279 [ 0 ] = V_280 [ 0 ] ;
V_20 -> V_279 [ 1 ] = V_280 [ 1 ] ;
V_20 -> V_279 [ 2 ] = V_280 [ 2 ] ;
V_20 -> V_281 = V_282 - 1 ;
F_116 ( V_20 ) ;
return;
}
...
if ( V_25 )
return V_29 ;
F_16 ( L_158 , V_284 . V_40 . V_285 ) ;
F_16 ( L_159 , V_284 . V_40 . V_286 ) ;
F_16 ( L_160 , V_284 . V_40 . V_287 ) ;
F_16 ( L_161 , V_284 . V_40 . V_288 ) ;
F_16 ( L_162 , V_284 . V_40 . V_289 ) ;
F_16 ( L_163 , V_284 . V_40 . V_290 ) ;
F_16 ( L_164 , F_118 ( V_291 ) ) ;
V_283 = F_119 () ;
F_113 ( & V_283 , & V_268 ) ;
F_16 ( L_165
L_166 ,
1900 + V_268 . V_275 , V_268 . V_276 + 1 , V_268 . V_272 ,
V_268 . V_274 , V_268 . V_273 , V_268 . V_270 ,
V_292 . V_293 ) ;
F_114 ( & V_20 ) ;
F_16 ( L_167 ) ;
if ( V_20 . V_278 > ( 24 * 60 * 60 ) ) {
int V_294 = V_20 . V_278 / ( 24 * 60 * 60 ) ;
V_20 . V_278 %= ( 24 * 60 * 60 ) ;
F_16 ( L_168 , V_294 , V_294 == 1 ? L_1 : L_169 ) ;
}
F_16 ( L_170 , V_20 . V_278 / ( 60 * 60 ) , ( V_20 . V_278 / 60 ) % 60 ) ;
#define F_120 ( T_10 ) ((x) >> FSHIFT)
#define F_121 ( T_10 ) LOAD_INT(((x) & (FIXED_1-1)) * 100)
F_16 ( L_171 ,
F_120 ( V_20 . V_279 [ 0 ] ) , F_121 ( V_20 . V_279 [ 0 ] ) ,
F_120 ( V_20 . V_279 [ 1 ] ) , F_121 ( V_20 . V_279 [ 1 ] ) ,
F_120 ( V_20 . V_279 [ 2 ] ) , F_121 ( V_20 . V_279 [ 2 ] ) ) ;
#undef F_120
#undef F_121
#define F_122 ( T_10 ) ((x) << (PAGE_SHIFT - 10))
F_16 ( L_172
L_173 ,
V_20 . V_295 , V_20 . V_296 , V_20 . V_297 ) ;
return 0 ;
}
...
char V_160 [ 64 ] ;
int V_2 , V_21 , V_38 = 1 ;
unsigned long V_41 , V_298 , V_20 , V_163 = 0 , V_299 = ~ 0UL ;
if ( V_25 < 1 || V_25 > 3 )
return V_29 ;
V_21 = F_18 ( V_25 , V_26 , & V_38 , & V_298 , NULL , NULL ) ;
if ( V_21 )
return V_21 ;
if ( V_25 >= 2 ) {
...
if ( F_31 ( V_88 ) )
return 0 ;
if ( V_299 != ~ 0UL && V_299 != V_2 )
continue;
V_41 = V_298 + F_125 ( V_2 ) ;
V_21 = F_63 ( & V_20 , V_41 , V_163 ) ;
if ( V_21 ) {
F_16 ( L_176 V_300 L_177
L_178 , V_2 , V_41 , V_21 ) ;
continue;
}
F_16 ( L_176 , V_2 ) ;
...
T_4 * V_228 ;
F_34 (kp, i) {
if ( V_228 -> V_92 && ( strcmp ( V_228 -> V_92 , V_103 ) == 0 ) ) {
F_16 ( L_190
L_191 , V_103 , V_301 , V_67 ) ;
return 1 ;
}
}
F_34 (kp, i) {
...
if ( V_10 >= V_94 ) {
T_4 * V_303 = F_28 ( ( V_94 - V_304 +
V_305 ) * sizeof( * V_303 ) , V_68 ) ;
if ( ! V_303 ) {
F_16 ( L_192
L_193 ) ;
return 1 ;
...
if ( V_306 ) {
memcpy ( V_303 , V_306 ,
( V_94 - V_304 ) * sizeof( * V_303 ) ) ;
F_26 ( V_306 ) ;
}
memset ( V_303 + V_94 , 0 ,
V_305 * sizeof( * V_303 ) ) ;
V_306 = V_303 ;
V_228 = V_306 + V_94 - V_304 ;
V_94 += V_305 ;
}
V_228 -> V_92 = V_103 ;
V_228 -> V_96 = V_301 ;
...
short V_302 )
{
return F_127 ( V_103 , V_301 , V_66 , V_67 , V_302 ,
V_99 ) ;
}
...
L_213 , 0 , V_99 ) ;
F_127 ( L_214 , V_308 , L_205 ,
L_215 , 1 , V_99 ) ;
F_127 ( L_216 , V_308 , L_217 ,
L_218 , 0 , V_99 ) ;
F_127 ( L_219 , V_308 , L_220 ,
L_221 , 0 , V_99 ) ;
F_127 ( L_222 , V_308 , L_1 ,
L_223 , 0 , V_99 ) ;
F_127 ( L_224 , V_308 , L_194 ,
L_225 , 0 ,
V_99 ) ;
...
{
int V_10 , V_21 ;
for ( V_10 = 0 ; V_312 [ V_10 ] ; ++ V_10 ) {
V_21 = F_29 ( V_312 [ V_10 ] ) ;
if ( V_21 )
F_16 ( L_271 ,
V_312 [ V_10 ] , V_21 ) ;
}
...
void T_13 F_131 ( int V_313 )
{
static int V_314 = V_315 ;
int V_10 ;
if ( V_314 == V_316 || V_313 <= V_314 )
return;
for ( V_10 = V_314 ; V_10 < V_313 ; V_10 ++ ) {
switch ( V_10 ) {
case V_315 :
F_129 () ;
F_132 () ;
