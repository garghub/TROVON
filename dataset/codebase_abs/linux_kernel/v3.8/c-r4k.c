...
V_174 [ V_113 -> V_22 . V_27 ] , V_113 -> V_22 . V_129 ) ;
F_107 ( L_6 ,
V_100 >> 10 , V_174 [ V_113 -> V_115 . V_27 ] ,
...
{
unsigned long V_17 , V_4 , V_175 , V_20 , V_176 ;
unsigned int V_119 = F_100 () ;
struct V_112 * V_113 = & V_21 ;
if ( V_119 & V_159 )
return 0 ;
V_175 = ( unsigned long ) & V_177 ;
V_175 &= ~ ( ( 4 * 1024 * 1024 ) - 1 ) ;
V_20 = V_175 + ( 4 * 1024 * 1024 ) ;
F_17 ( V_17 ) ;
V_176 = ( 64 * 1024 ) ;
for ( V_4 = V_175 ; V_4 < V_20 ; V_4 = ( V_175 + V_176 ) ) {
unsigned long * V_178 = ( unsigned long * ) V_4 ;
...
F_109 ( V_181 , V_175 ) ;
V_176 = ( 128 * 1024 ) ;
for ( V_4 = V_175 + ( 128 * 1024 ) ; V_4 < V_20 ; V_4 = V_175 + V_176 ) {
F_109 ( V_182 , V_4 ) ;
__asm__ __volatile__("nop; nop; nop; nop;");
if ( ! F_110 () )
break;
...
V_4 -= V_175 ;
V_49 = V_4 ;
V_113 -> V_183 . V_129 = 16 << ( ( V_119 & V_184 ) >> 22 ) ;
V_113 -> V_183 . V_27 = 1 ;
V_113 -> V_115 . V_25 = 0 ;
return 1 ;
}
...
struct V_112 * V_113 = & V_21 ;
V_49 = 512 * 1024 ;
V_113 -> V_183 . V_129 = 32 ;
V_113 -> V_183 . V_27 = 4 ;
V_113 -> V_183 . V_25 = 0 ;
V_113 -> V_183 . V_23 = V_49 / ( V_113 -> V_183 . V_27 ) ;
V_113 -> V_183 . V_157 = V_49 / ( V_113 -> V_183 . V_129 * V_113 -> V_183 . V_27 ) ;
F_112 ( L_10 ,
V_49 >> 10 , V_174 [ V_113 -> V_183 . V_27 ] , V_113 -> V_183 . V_129 ) ;
V_113 -> V_133 |= V_185 ;
}
...
case V_71 :
case V_72 :
V_49 = 0x80000 << ( ( V_119 & V_188 ) >> 16 ) ;
V_113 -> V_183 . V_129 = 64 << ( ( V_119 >> 13 ) & 1 ) ;
V_113 -> V_183 . V_27 = 2 ;
V_113 -> V_183 . V_25 = 0 ;
V_186 = 1 ;
break;
...
return;
default:
if ( V_113 -> V_190 == V_191 ||
V_113 -> V_190 == V_192 ||
V_113 -> V_190 == V_193 ||
V_113 -> V_190 == V_194 ) {
#ifdef F_119
if ( F_120 () ) {
V_49 = V_113 -> V_183 . V_27 * V_113 -> V_183 . V_157 * V_113 -> V_183 . V_129 ;
F_107 ( L_11 ,
V_49 >> 10 ,
V_174 [ V_113 -> V_183 . V_27 ] , V_113 -> V_183 . V_129 ) ;
}
#else
if ( ! ( V_113 -> V_183 . V_17 & V_195 ) )
F_104 ( L_12 ) ;
#endif
return;
}
...
static int T_6 F_125 ( char * V_199 )
{
F_126 ( & V_199 , & V_200 ) ;
return 0 ;
}
...
static int T_6 F_131 ( char * V_199 )
{
V_204 = 1 ;
return 0 ;
}
...
case V_162 :
case V_163 :
F_133 ( 0x100 , & V_206 , 0x80 ) ;
break;
default:
F_133 ( 0x100 , & V_205 , 0x80 ) ;
break;
}
}
void T_1 F_134 ( void )
