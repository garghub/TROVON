...
struct V_42 * V_43 ;
int V_8 ;
if ( ! F_16 ( V_2 -> V_14 , V_44 ) )
return - V_45 ;
V_43 = F_17 ( & V_2 -> V_25 , sizeof( * V_43 ) , V_46 ) ;
if ( ! V_43 )
return - V_47 ;
V_8 = F_5 ( V_2 , true ) ;
if ( V_8 < 0 )
...
if ( V_8 < 0 )
return V_8 ;
V_43 -> V_48 = F_18 ( V_49 , & V_2 -> V_25 ,
& V_50 , V_51 ) ;
if ( F_19 ( V_43 -> V_48 ) )
return F_20 ( V_43 -> V_48 ) ;
F_21 ( V_2 , V_43 ) ;
return 0 ;
}
