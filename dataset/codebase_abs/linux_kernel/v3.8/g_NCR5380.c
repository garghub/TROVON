...
static int F_51 ( char * V_89 , int V_69 , int V_90 )
{
int V_71 = V_69 ;
F_52 ( L_29 ANDP opcode) ;
return V_69 - V_71 ;
}
static int F_53 ( char * V_89 , int V_69 , unsigned char * V_91 )
{
int V_22 , V_92 , V_71 = V_69 ;
V_69 += F_51 ( V_89 , V_69 , V_91 [ 0 ] ) ;
for ( V_22 = 1 , V_92 = F_54 ( V_91 [ 0 ] ) ; V_22 < V_92 ; ++ V_22 )
F_52 ( L_30 ANDP command[i]) ;
F_52 ( L_21 ) ;
return V_69 - V_71 ;
}
static int F_55 ( char * V_89 , int V_69 , T_5 * V_93 )
{
int V_71 = V_69 ;
F_52 ( L_31 ANDP cmd->device->host->host_no ANDP cmd->device->id ANDP cmd->device->lun) ;
F_52 ( L_32 ) ;
V_69 += F_53 ( V_89 , V_69 , V_93 -> V_94 ) ;
return V_69 - V_71 ;
}
static int F_56 ( struct V_27 * V_95 , char * V_89 , char * * V_71 , T_6 V_96 , int V_97 , int V_98 )
{
int V_69 = 0 ;
F_40 () ;
unsigned long V_26 ;
...
#ifdef F_57
if ( V_51 -> V_103 || V_51 -> V_104 || V_51 -> V_105 )
F_52 ( L_45 ) ;
if ( V_51 -> V_106 )
...
F_52 ( L_21 ) ;
F_61 (dev, scsi_ptr) {
unsigned long V_108 = V_51 -> V_109 [ V_40 -> V_110 ] ;
unsigned long V_111 = V_51 -> V_112 [ V_40 -> V_110 ] ;
long V_113 = V_51 -> V_114 [ V_40 -> V_110 ] / V_115 ;
long V_116 = V_51 -> V_117 [ V_40 -> V_110 ] / V_115 ;
F_52 ( L_48 ANDP dev->id ANDP scsi_device_type(dev->type)) ;
for ( V_22 = 0 ; V_22 < 8 ; V_22 ++ )
if ( V_40 -> V_118 [ V_22 ] >= 0x20 )
* ( V_89 + ( V_69 ++ ) ) = V_40 -> V_118 [ V_22 ] ;
* ( V_89 + ( V_69 ++ ) ) = ' ' ;
for ( V_22 = 0 ; V_22 < 16 ; V_22 ++ )
if ( V_40 -> V_119 [ V_22 ] >= 0x20 )
* ( V_89 + ( V_69 ++ ) ) = V_40 -> V_119 [ V_22 ] ;
* ( V_89 + ( V_69 ++ ) ) = ' ' ;
for ( V_22 = 0 ; V_22 < 4 ; V_22 ++ )
if ( V_40 -> V_120 [ V_22 ] >= 0x20 )
* ( V_89 + ( V_69 ++ ) ) = V_40 -> V_120 [ V_22 ] ;
* ( V_89 + ( V_69 ++ ) ) = ' ' ;
...
for ( V_22 = 0 ; ( V_123 [ V_22 ] . V_124 != V_125 ) && ( V_123 [ V_22 ] . V_124 != ( V_99 & V_126 ) ) ; ++ V_22 ) ;
F_52 ( L_53 ANDP phases[i].name) ;
}
if ( ! V_51 -> V_103 ) {
F_52 ( L_54 ) ;
} else {
V_69 += F_55 ( V_89 , V_69 , ( T_5 * ) V_51 -> V_103 ) ;
}
F_52 ( L_55 ) ;
for ( V_100 = ( T_5 * ) V_51 -> V_104 ; V_100 ; V_100 = ( T_5 * ) V_100 -> V_127 )
V_69 += F_55 ( V_89 , V_69 , V_100 ) ;
F_52 ( L_56 ) ;
for ( V_100 = ( T_5 * ) V_51 -> V_105 ; V_100 ; V_100 = ( T_5 * ) V_100 -> V_127 )
V_69 += F_55 ( V_89 , V_69 , V_100 ) ;
* V_71 = V_89 + V_96 ;
V_69 -= V_96 ;
if ( V_69 > V_97 )
V_69 = V_97 ;
F_62 ( V_95 -> V_101 , V_26 ) ;
return V_69 ;
}
