...
static void F_4 ( struct V_1 * V_2 , int V_28 )
{
int V_29 , cos , V_30 = F_2 ( V_2 ) ;
for ( cos = 1 ; cos < V_2 -> V_23 ; cos ++ ) {
for ( V_29 = 0 ; V_29 < V_30 - V_28 ; V_29 ++ ) {
struct V_5 * V_7 = & V_2 -> V_7 [ V_29 ] ;
int V_31 = cos * ( V_30 - V_28 ) + V_29 ;
memcpy ( & V_2 -> V_25 [ V_31 ] , V_7 -> V_27 [ cos ] ,
sizeof( struct V_26 ) ) ;
V_7 -> V_27 [ cos ] = & V_2 -> V_25 [ V_31 ] ;
}
}
}
static T_1 F_5 ( struct V_1 * V_2 , struct V_26 * V_32 ,
T_1 V_33 , unsigned int * V_34 ,
unsigned int * V_35 )
{
struct V_36 * V_37 = & V_32 -> V_38 [ V_33 ] ;
struct V_39 * V_40 ;
struct V_41 * V_42 ;
struct V_43 * V_44 = V_37 -> V_44 ;
T_1 V_45 = F_6 ( V_37 -> V_46 ) , V_47 ;
int V_48 ;
F_7 ( & V_44 -> V_49 ) ;
F_8 ( V_50 , L_1 ,
V_32 -> V_51 , V_33 , V_37 , V_44 ) ;
V_40 = & V_32 -> V_52 [ V_45 ] . V_53 ;
F_9 ( & V_2 -> V_54 -> V_55 , F_10 ( V_40 ) ,
F_11 ( V_40 ) , V_56 ) ;
V_48 = F_12 ( V_40 -> V_48 ) - 1 ;
#ifdef F_13
if ( ( V_48 - 1 ) > ( V_57 + 2 ) ) {
F_14 ( L_2 ) ;
F_15 () ;
...
while ( V_48 > 0 ) {
V_42 = & V_32 -> V_52 [ V_45 ] . V_60 ;
F_17 ( & V_2 -> V_54 -> V_55 , F_10 ( V_42 ) ,
F_11 ( V_42 ) , V_56 ) ;
if ( -- V_48 )
V_45 = F_6 ( F_16 ( V_45 ) ) ;
}
...
int F_21 ( struct V_1 * V_2 , struct V_26 * V_32 )
{
struct V_62 * V_63 ;
T_1 V_64 , V_65 , V_66 = V_32 -> V_67 ;
unsigned int V_34 = 0 , V_35 = 0 ;
#ifdef F_13
if ( F_22 ( V_2 -> V_68 ) )
return - 1 ;
#endif
V_63 = F_23 ( V_2 -> V_55 , V_32 -> V_51 ) ;
V_64 = F_12 ( * V_32 -> V_69 ) ;
V_65 = V_32 -> V_70 ;
while ( V_65 != V_64 ) {
T_1 V_71 ;
...
F_8 ( V_50 ,
L_3 ,
V_32 -> V_51 , V_64 , V_65 , V_71 ) ;
V_66 = F_5 ( V_2 , V_32 , V_71 ,
& V_34 , & V_35 ) ;
V_65 ++ ;
}
F_24 ( V_63 , V_34 , V_35 ) ;
...
static inline void F_32 ( struct V_5 * V_7 ,
T_1 V_33 )
{
T_1 V_75 = V_7 -> V_76 ;
if ( F_33 ( V_33 , V_75 ) > 0 )
...
static inline void F_34 ( struct V_5 * V_7 ,
T_1 V_77 ,
struct V_78 * V_79 )
{
...
F_35 ( V_7 -> V_82 ,
F_36 ( F_12 ( V_79 -> V_83 . V_84 [ V_29 ] ) ) ) ;
F_8 ( V_85 , L_4 ,
V_77 - 1 , F_12 ( V_79 -> V_83 . V_84 [ V_77 - 1 ] ) ) ;
F_7 ( ( void * ) ( V_7 -> V_82 ) ) ;
F_32 ( V_7 ,
F_12 ( V_79 -> V_83 . V_84 [ V_77 - 1 ] ) ) ;
V_75 = F_36 ( V_7 -> V_76 ) ;
V_80 = V_75 >> V_86 ;
V_81 = F_36 ( V_7 -> V_87 ) >> V_86 ;
if ( V_80 + 1 != V_81 )
V_80 ++ ;
for ( V_29 = V_81 ; V_29 != V_80 ; V_29 = F_37 ( V_29 ) ) {
if ( F_19 ( V_7 -> V_82 [ V_29 ] ) )
break;
V_7 -> V_82 [ V_29 ] = V_88 ;
V_28 += V_89 ;
}
...
static T_2 F_39 ( const struct V_1 * V_2 ,
const struct V_90 * V_79 ,
bool * V_91 )
{
if ( ( V_2 -> V_55 -> V_92 & V_93 ) &&
( V_79 -> V_94 & V_95 ) ) {
enum V_96 V_97 ;
V_97 = V_79 -> V_94 & V_98 ;
* V_91 = ( V_97 == V_99 ) ||
( V_97 == V_100 ) ;
return F_40 ( V_79 -> V_101 ) ;
}
* V_91 = false ;
return 0 ;
}
static void F_41 ( struct V_5 * V_7 , T_1 V_102 ,
T_1 V_103 , T_1 V_104 ,
struct V_90 * V_79 )
{
struct V_1 * V_2 = V_7 -> V_2 ;
struct V_105 * V_106 = & V_7 -> V_107 [ V_103 ] ;
struct V_105 * V_108 = & V_7 -> V_107 [ V_104 ] ;
struct V_109 * V_110 = & V_7 -> V_111 [ V_104 ] ;
T_3 V_112 ;
struct V_113 * V_114 = & V_7 -> V_114 [ V_102 ] ;
struct V_105 * V_115 = & V_114 -> V_115 ;
if ( V_114 -> V_116 != V_117 )
F_14 ( L_6 , V_102 ) ;
V_112 = F_42 ( & V_2 -> V_54 -> V_55 ,
V_115 -> V_118 + V_119 ,
V_7 -> V_120 , V_121 ) ;
if ( F_22 ( F_43 ( & V_2 -> V_54 -> V_55 , V_112 ) ) ) {
F_44 ( V_7 , V_103 , V_104 ) ;
V_114 -> V_116 = V_122 ;
return;
}
V_108 -> V_118 = V_115 -> V_118 ;
F_45 ( V_108 , V_112 , V_112 ) ;
V_110 -> V_123 = F_46 ( F_47 ( V_112 ) ) ;
V_110 -> V_124 = F_46 ( F_48 ( V_112 ) ) ;
* V_115 = * V_106 ;
V_114 -> V_125 =
F_12 ( V_79 -> V_126 . V_58 ) ;
V_114 -> V_127 = F_12 ( V_79 -> V_127 ) ;
V_114 -> V_116 = V_128 ;
V_114 -> V_129 = F_12 ( V_79 -> V_129 ) ;
V_114 -> V_130 = V_79 -> V_130 ;
V_114 -> V_131 = F_39 ( V_2 , V_79 , & V_114 -> V_91 ) ;
if ( V_7 -> V_132 == V_133 ) {
T_1 V_134 = F_12 ( V_79 -> V_135 ) ;
V_114 -> V_136 =
V_137 * V_138 / V_134 * V_134 ;
V_114 -> V_134 = V_134 ;
}
#ifdef F_13
V_7 -> V_139 |= ( 1 << V_102 ) ;
#ifdef F_49
F_8 (NETIF_MSG_RX_STATUS, L_7 ,
#else
...
snprintf(fp->name, sizeof(fp->name), L_51,
bp->dev->name, i);
rc = request_irq(bp->msix_table[offset].vector,
...
bp->num_queues = bp->num_ethernet_queues + bp->num_cnic_queues;
BNX2X_DEV_INFO(L_58, bp->num_queues);
}
...
DP(NETIF_MSG_IFUP, L_66, loaded_fw, my_fw);
if (loaded_fw != my_fw) {
if (is_err)
BNX2X_ERR(L_67,
loaded_fw, my_fw);
...
u32 load_code;
int i, rc;
DP(NETIF_MSG_IFUP, L_77);
DP(NETIF_MSG_IFUP,
L_78, CNIC_ENABLED(bp) ? L_79 : L_80);
#ifdef F_13
if (unlikely(bp->panic)) {
BNX2X_ERR(L_81);
return -EPERM;
...
DP(NETIF_MSG_IFUP, L_82, bp->num_queues);
for_each_queue(bp, i)
bnx2x_bz_fp(bp, i);
...
BNX2X_DEV_INFO(L_85, bp->fw_seq);
bp->fw_drv_pulse_wr_seq =
(SHMEM_RD(bp, func_mb[BP_FW_MB_IDX(bp)].drv_pulse_mb) &
DRV_PULSE_SEQ_MASK);
BNX2X_DEV_INFO(L_86, bp->fw_drv_pulse_wr_seq);
...
bp->port.pmf = 0;
DP(NETIF_MSG_IFUP, L_91, bp->port.pmf);
...
break;
default:
dev_err(&bp->pdev->dev, L_105, state);
return -EINVAL;
}
return 0;
}
...
DP(NETIF_MSG_TX_QUEUED,
L_109,
(xmit_type & XMIT_GSO) ? L_110 : L_111,
...
DP(NETIF_MSG_TX_QUEUED, L_123, tx_data_bd);
first_bd->nbd = cpu_to_le16(nbd);
bd_prod = TX_BD(NEXT_TX_IDX(bd_prod));
...
pbd_e2->parsing_data);
DP(NETIF_MSG_TX_QUEUED, L_126, nbd, bd_prod);
...
BNX2X_DEV_INFO(L_138, fp_array_size);
...
BNX2X_DEV_INFO(L_139, txq_array_size);
