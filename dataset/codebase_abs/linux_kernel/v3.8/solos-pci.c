...
struct V_126 * V_127 ;
F_66 ( & V_128 ) ;
V_123 = & V_129 [ V_29 & ( V_130 - 1 ) ] ;
F_67 (s, node, head) {
V_2 = F_68 ( V_127 ) ;
if ( V_2 -> V_7 == V_7 && V_2 -> V_29 == V_29 &&
V_2 -> V_28 == V_28 && V_2 -> V_131 . V_132 . V_133 != V_134 &&
F_69 ( V_135 , & V_2 -> V_57 ) )
goto V_136;
}
V_2 = NULL ;
...
if( V_43 % 8 == 0 )
sprintf ( V_145 , L_44 , V_43 ) ;
sprintf ( V_146 , L_45 , * ( V_10 -> V_40 + V_43 ) ) ;
strcat ( V_145 , V_146 ) ;
if( V_43 % 8 == 7 ) {
sprintf ( V_146 , L_46 ) ;
strcat ( V_145 , V_146 ) ;
F_81 ( V_147 L_47 , V_145 ) ;
}
}
if ( V_43 % 8 != 0 ) {
sprintf ( V_146 , L_46 ) ;
...
unsigned long V_57 ;
F_54 ( V_4 ) -> V_2 = V_2 ;
F_26 ( & V_15 -> V_142 , V_57 ) ;
V_148 = F_62 ( & V_15 -> V_143 [ V_32 ] ) ;
F_63 ( & V_15 -> V_143 [ V_32 ] , V_4 ) ;
if ( ! V_148 )
V_15 -> V_149 |= ( 1 << V_32 ) ;
F_29 ( & V_15 -> V_142 , V_57 ) ;
if ( ! V_148 )
F_52 ( V_15 ) ;
}
...
unsigned char V_32 ;
unsigned long V_57 ;
F_26 ( & V_15 -> V_152 , V_57 ) ;
V_104 = F_38 ( V_15 -> V_71 + V_121 ) ;
V_150 = V_15 -> V_149 & ~ V_104 ;
for ( V_32 = 0 ; V_150 ; V_150 >>= 1 , V_32 ++ ) {
if ( V_150 & 1 ) {
struct V_3 * V_153 = V_15 -> V_154 [ V_32 ] ;
if ( V_153 ) {
F_53 ( V_15 -> V_7 , F_54 ( V_153 ) -> V_110 ,
V_153 -> V_39 , V_155 ) ;
V_15 -> V_154 [ V_32 ] = NULL ;
}
F_31 ( & V_15 -> V_142 ) ;
V_4 = F_32 ( & V_15 -> V_143 [ V_32 ] ) ;
if ( ! V_4 )
V_15 -> V_149 &= ~ ( 1 << V_32 ) ;
F_33 ( & V_15 -> V_142 ) ;
if ( V_4 && ! V_15 -> V_108 ) {
...
if ( ( unsigned long ) V_40 & V_15 -> V_156 ) {
V_40 = V_15 -> V_157 + ( V_62 * V_32 ) ;
...
continue;
if ( V_114 ) {
struct V_19 * V_20 = ( void * ) V_153 -> V_40 ;
int V_27 = F_55 ( V_20 -> V_27 ) ;
F_19 ( V_153 , sizeof( * V_20 ) ) ;
...
if ( V_151 )
F_39 ( V_151 , V_15 -> V_71 + V_121 ) ;
F_29 ( & V_15 -> V_152 , V_57 ) ;
return V_104 ;
}
...
V_160 = sizeof( * V_20 ) - F_88 ( V_4 ) ;
V_42 = F_89 ( V_4 , V_160 , 0 , V_63 ) ;
if ( V_42 ) {
...
static int F_91 ( struct V_65 * V_7 , const struct V_161 * V_162 )
{
int V_64 ;
T_5 V_163 ;
T_6 V_164 , V_165 ;
...
V_15 -> V_71 = F_98 ( V_7 , 0 , V_166 ) ;
if ( ! V_15 -> V_71 ) {
F_6 ( & V_7 -> V_7 , L_55 ) ;
goto V_167;
}
V_15 -> V_168 = F_98 ( V_7 , 1 , V_169 ) ;
if ( ! V_15 -> V_168 ) {
F_6 ( & V_7 -> V_7 , L_56 ) ;
goto V_170;
}
...
V_69 = F_38 ( V_15 -> V_71 + V_172 ) ;
V_163 = ( V_69 & 0x0000FFFF ) ;
V_164 = ( ( V_69 & 0xFF000000 ) >> 24 ) ;
V_165 = ( ( V_69 & 0x00FF0000 ) >> 16 ) ;
V_15 -> V_84 = F_99 ( V_164 , V_165 ) ;
if ( V_15 -> V_84 > V_85 )
V_15 -> V_113 = V_62 ;
else
V_15 -> V_113 = V_173 ;
...
if ( 1 ) {
V_15 -> V_156 = 3 ;
V_15 -> V_157 = F_101 ( V_15 -> V_106 * V_62 , V_23 ) ;
if ( ! V_15 -> V_157 ) {
...
F_104 ( & V_15 -> V_33 ) ;
F_105 ( & V_15 -> V_35 ) ;
V_64 = F_106 ( V_7 -> V_98 , F_48 , V_181 ,
L_60 , V_15 ) ;
if ( V_64 ) {
F_22 ( & V_15 -> V_7 -> V_7 , L_61 , V_7 -> V_98 ) ;
goto V_180;
}
F_39 ( 1 , V_15 -> V_71 + V_182 ) ;
if ( V_174 )
F_42 ( V_15 , 0 ) ;
if ( V_175 )
F_42 ( V_15 , 1 ) ;
...
goto V_183;
if ( V_15 -> V_84 >= V_179 &&
F_108 ( & V_15 -> V_7 -> V_7 . V_184 , & V_185 ) )
F_109 ( & V_15 -> V_7 -> V_7 , L_62 ) ;
return 0 ;
V_183:
F_39 ( 0 , V_15 -> V_71 + V_182 ) ;
F_110 ( V_7 -> V_98 , V_15 ) ;
F_111 ( & V_15 -> V_102 ) ;
V_180:
F_112 ( V_15 -> V_157 ) ;
F_102 ( V_7 , NULL ) ;
F_113 ( V_7 , V_15 -> V_168 ) ;
V_170:
F_113 ( V_7 , V_15 -> V_71 ) ;
V_167:
F_114 ( V_7 ) ;
...
static int F_107 ( struct V_14 * V_15 , struct V_6 * V_186 )
{
int V_43 ;
for ( V_43 = 0 ; V_43 < V_15 -> V_106 ; V_43 ++ ) {
struct V_3 * V_4 ;
struct V_19 * V_20 ;
F_115 ( & V_15 -> V_143 [ V_43 ] ) ;
F_115 ( & V_15 -> V_61 [ V_43 ] ) ;
V_15 -> V_12 [ V_43 ] = F_116 ( L_60 , V_186 , & V_187 , - 1 , NULL ) ;
if ( ! V_15 -> V_12 [ V_43 ] ) {
F_109 ( & V_15 -> V_7 -> V_7 , L_63 , V_43 ) ;
F_117 ( V_15 ) ;
return - V_53 ;
}
if ( F_118 ( & V_15 -> V_12 [ V_43 ] -> V_13 , & V_188 ) )
F_109 ( & V_15 -> V_7 -> V_7 , L_64 , V_43 ) ;
if ( F_108 ( & V_15 -> V_12 [ V_43 ] -> V_13 . V_184 , & V_189 ) )
F_109 ( & V_15 -> V_7 -> V_7 , L_65 , V_43 ) ;
F_24 ( & V_15 -> V_7 -> V_7 , L_66 , V_15 -> V_12 [ V_43 ] -> V_190 ) ;
V_15 -> V_12 [ V_43 ] -> V_191 . V_192 = 8 ;
V_15 -> V_12 [ V_43 ] -> V_191 . V_193 = 16 ;
V_15 -> V_12 [ V_43 ] -> V_16 = V_15 ;
V_15 -> V_12 [ V_43 ] -> V_194 = ( void * ) ( unsigned long ) V_43 ;
...
if ( V_15 -> V_12 [ V_43 ] ) {
struct V_3 * V_4 ;
F_24 ( & V_15 -> V_7 -> V_7 , L_68 , V_15 -> V_12 [ V_43 ] -> V_190 ) ;
F_119 ( & V_15 -> V_12 [ V_43 ] -> V_13 . V_184 , & V_189 ) ;
...
while ( ( V_4 = F_32 ( & V_15 -> V_143 [ V_43 ] ) ) )
F_78 ( V_4 ) ;
}
}
}
...
( void ) F_38 ( V_15 -> V_71 + V_90 ) ;
if ( V_15 -> V_84 >= V_179 )
F_119 ( & V_15 -> V_7 -> V_7 . V_184 , & V_185 ) ;
F_117 ( V_15 ) ;
F_110 ( V_7 -> V_98 , V_15 ) ;
F_111 ( & V_15 -> V_102 ) ;
F_112 ( V_15 -> V_157 ) ;
...
{
F_124 ( sizeof( struct V_195 ) > sizeof( ( (struct V_3 * ) 0 ) -> V_196 ) ) ;
F_81 ( V_197 L_69 , V_198 ) ;
return F_125 ( & V_199 ) ;
}
static void T_8 F_126 ( void )
{
F_127 ( & V_199 ) ;
F_81 ( V_197 L_70 , V_198 ) ;
}
