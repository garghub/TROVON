...
if ( ! V_51 -> V_37 . V_57 )
V_51 -> V_37 . V_57 = & V_58 ;
V_55 = F_20 ( & V_51 -> V_37 , sizeof( * V_55 ) , V_59 ) ;
if ( ! V_55 )
return - V_60 ;
if ( F_21 ( V_53 , L_2 , NULL ) )
V_55 -> V_19 |= V_20 ;
if ( F_21 ( V_53 , L_3 , NULL ) )
V_55 -> V_19 |= V_22 ;
if ( F_21 ( V_53 , L_4 , NULL ) )
V_55 -> V_19 |= V_24 ;
if ( F_21 ( V_53 , L_5 , NULL ) )
V_55 -> V_19 |= V_28 ;
if ( F_21 ( V_53 , L_6 , NULL ) )
V_55 -> V_19 |= V_26 ;
if ( F_21 ( V_53 , L_7 , NULL ) )
V_55 -> V_19 |= V_30 ;
if ( F_21 ( V_53 , L_8 , NULL ) )
V_55 -> V_19 |= V_32 ;
if ( ! F_22 ( V_53 , L_9 , & V_56 ) )
V_55 -> V_34 = V_56 ;
if ( ! F_22 ( V_53 , L_10 , & V_56 ) )
V_55 -> V_61 = V_56 ;
if ( ! F_22 ( V_53 , L_11 , & V_56 ) )
V_55 -> V_62 = V_56 ;
V_51 -> V_37 . V_39 = V_55 ;
return 0 ;
}
...
int F_23 ( const struct V_63 * V_64 , struct V_50 * V_51 )
{
int V_38 , V_65 ;
struct V_66 * V_67 ;
struct V_15 * V_16 ;
...
V_70 = F_26 ( & V_51 -> V_37 , NULL ) ;
if ( F_27 ( V_70 ) )
return F_28 ( V_70 ) ;
V_67 = F_29 ( V_64 , & V_51 -> V_37 , L_13 ) ;
if ( ! V_67 ) {
V_38 = - V_60 ;
goto V_73;
}
V_69 = F_30 ( V_51 , V_74 , 0 ) ;
if ( ! V_69 ) {
F_25 ( L_14 ) ;
V_38 = - V_72 ;
goto V_75;
...
V_67 -> V_76 = V_69 -> V_77 ;
V_67 -> V_78 = F_31 ( V_69 ) ;
if ( ! F_32 ( V_67 -> V_76 , V_67 -> V_78 , V_79 ) ) {
F_33 ( L_15 ) ;
V_38 = - V_80 ;
goto V_75;
}
V_67 -> V_81 = F_34 ( V_67 -> V_76 , V_67 -> V_78 ) ;
if ( ! V_67 -> V_81 ) {
F_33 ( L_16 ) ;
V_38 = - V_60 ;
goto V_82;
}
V_2 = (struct V_1 * ) F_35 ( V_67 ) ;
V_2 -> V_37 = & V_51 -> V_37 ;
V_2 -> V_40 = V_70 ;
...
void F_42 ( struct V_66 * V_67 , struct V_50 * V_51 )
{
...
if ( F_52 () )
return - V_71 ;
return F_23 ( & V_90 , V_51 ) ;
}
static int F_53 ( struct V_50 * V_51 )
{
struct V_66 * V_67 = F_54 ( V_51 ) ;
F_42 ( V_67 , V_51 ) ;
F_55 ( V_51 , NULL ) ;
return 0 ;
}
