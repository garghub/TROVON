...
int V_18 ;
T_1 V_7 ;
V_40 = F_15 ( V_34 , V_41 , 0 ) ;
if ( ! V_40 ) {
F_16 ( & V_34 -> V_37 , L_1 ) ;
return - V_42 ;
}
V_12 = F_17 ( & V_34 -> V_37 , sizeof( * V_12 ) , V_43 ) ;
if ( ! V_12 ) {
F_16 ( & V_34 -> V_37 , L_2 ) ;
return - V_44 ;
}
V_12 -> V_6 = F_18 ( & V_34 -> V_37 , V_40 ) ;
if ( ! V_12 -> V_6 )
return - V_45 ;
V_12 -> V_19 = F_19 ( & V_34 -> V_37 , NULL ) ;
if ( F_20 ( V_12 -> V_19 ) )
return F_21 ( V_12 -> V_19 ) ;
V_12 -> V_37 = & V_34 -> V_37 ;
F_22 ( V_34 , V_12 ) ;
...
V_7 = F_4 ( V_12 -> V_6 + V_51 ) ;
V_7 |= V_52 ;
F_6 ( V_7 , V_12 -> V_6 + V_51 ) ;
F_11 ( V_12 -> V_19 ) ;
}
V_18 = F_26 ( & V_12 -> V_3 ) ;
if ( ! V_18 ) {
F_25 ( V_12 -> V_19 ) ;
F_16 ( & V_34 -> V_37 , L_4 , V_18 ) ;
}
return V_18 ;
}
