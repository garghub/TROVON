...
{
struct V_1 * V_2 = F_80 ( V_125 ) ;
return F_149 ( & V_2 -> V_5 . V_118 , V_254 ) ;
}
static int F_150 ( struct V_125 * V_125 , void * V_186 ,
struct V_252 * V_30 )
{
struct V_1 * V_2 = F_80 ( V_125 ) ;
return F_151 ( & V_2 -> V_5 . V_118 , V_30 , V_125 -> V_255 & V_256 ) ;
}
static int F_152 ( struct V_125 * V_125 , void * V_186 ,
struct V_257 * V_258 )
{
struct V_1 * V_2 = F_80 ( V_125 ) ;
return F_153 ( & V_2 -> V_5 . V_118 , V_258 ) ;
}
static int F_154 ( struct V_125 * V_125 , void * V_186 ,
struct V_252 * V_259 )
{
struct V_1 * V_2 = F_80 ( V_125 ) ;
return F_155 ( & V_2 -> V_5 . V_118 , V_259 ) ;
}
...
V_261 -> V_170 . V_179 = 0 ;
V_261 -> V_170 . V_180 = 0 ;
V_261 -> V_170 . V_105 = V_51 -> V_267 ;
V_261 -> V_170 . V_106 = V_51 -> V_268 ;
return 0 ;
case V_181 :
V_51 = & V_4 -> V_20 ;
case V_269 :
V_261 -> V_170 . V_179 = V_51 -> V_165 ;
V_261 -> V_170 . V_180 = V_51 -> V_166 ;
V_261 -> V_170 . V_105 = V_51 -> V_105 ;
V_261 -> V_170 . V_106 = V_51 -> V_106 ;
return 0 ;
}
return - V_18 ;
}
static int F_157 ( struct V_169 * V_270 , struct V_169 * V_259 )
{
if ( V_270 -> V_179 < V_259 -> V_179 || V_270 -> V_180 < V_259 -> V_180 )
return 0 ;
if ( V_270 -> V_179 + V_270 -> V_105 > V_259 -> V_179 + V_259 -> V_105 )
return 0 ;
if ( V_270 -> V_180 + V_270 -> V_106 > V_259 -> V_180 + V_259 -> V_106 )
return 0 ;
return 1 ;
}
static int F_158 ( struct V_125 * V_125 , void * V_224 ,
struct V_260 * V_261 )
{
struct V_1 * V_2 = F_80 ( V_125 ) ;
struct V_3 * V_4 = V_2 -> V_5 . V_4 ;
struct V_169 V_271 = V_261 -> V_170 ;
struct V_50 * V_51 ;
unsigned long V_11 ;
if ( V_261 -> type != V_262 )
return - V_18 ;
if ( V_261 -> V_171 == V_181 )
V_51 = & V_4 -> V_20 ;
else if ( V_261 -> V_171 == V_269 )
V_51 = & V_4 -> V_16 ;
else
return - V_18 ;
F_102 ( V_4 , & V_271 , V_261 -> V_171 ) ;
if ( V_261 -> V_11 & V_272 &&
! F_157 ( & V_271 , & V_261 -> V_170 ) )
return - V_273 ;
if ( V_261 -> V_11 & V_274 &&
! F_157 ( & V_261 -> V_170 , & V_271 ) )
return - V_273 ;
V_261 -> V_170 = V_271 ;
F_3 ( & V_2 -> V_19 , V_11 ) ;
F_125 ( V_51 , V_261 -> V_170 . V_179 , V_261 -> V_170 . V_180 , V_261 -> V_170 . V_105 ,
V_261 -> V_170 . V_106 ) ;
F_21 ( & V_2 -> V_19 , V_11 ) ;
F_32 ( V_24 , & V_2 -> V_25 ) ;
return 0 ;
}
static int F_159 ( struct V_275 * V_88 ,
const struct V_238 * V_276 ,
const struct V_238 * V_277 , V_114 V_11 )
{
struct V_47 * V_203 = F_133 ( V_88 ) ;
struct V_1 * V_2 = F_160 ( V_203 ) ;
if ( F_134 ( V_277 -> V_88 ) != V_246 )
return - V_18 ;
if ( F_76 ( V_2 == NULL ) )
return 0 ;
F_43 ( L_9 ,
V_276 -> V_88 -> V_189 , V_277 -> V_88 -> V_189 , V_11 ,
V_2 -> V_5 . V_278 ) ;
if ( V_11 & V_279 ) {
if ( V_2 -> V_5 . V_278 != 0 )
return - V_126 ;
V_2 -> V_5 . V_278 = V_203 -> V_280 ;
return 0 ;
}
V_2 -> V_5 . V_278 = 0 ;
return 0 ;
}
void F_161 ( struct V_47 * V_203 , unsigned int V_281 ,
void * V_282 )
{
struct V_9 * V_10 ;
struct V_29 * V_30 ;
...
return;
V_10 = F_2 ( V_203 ) ;
V_284 = F_162 ( & V_203 -> V_88 ) ;
F_3 ( & V_284 -> V_19 , V_11 ) ;
V_2 = V_10 ? V_10 -> V_285 : NULL ;
if ( V_2 && V_282 && V_281 == V_286 &&
F_35 ( V_37 , & V_2 -> V_25 ) ) {
unsigned long V_287 ;
F_3 ( & V_2 -> V_19 , V_287 ) ;
if ( ! F_23 ( & V_2 -> V_5 . V_41 ) ) {
V_30 = F_163 ( V_2 -> V_5 . V_41 . V_288 ,
struct V_29 , V_289 ) ;
F_66 ( & V_30 -> V_39 , 0 , * ( ( V_114 * ) V_282 ) ) ;
}
F_37 ( V_2 , 1 ) ;
F_33 ( V_2 ) ;
F_21 ( & V_2 -> V_19 , V_287 ) ;
}
F_21 ( & V_284 -> V_19 , V_11 ) ;
}
static int F_164 ( struct V_47 * V_203 ,
struct V_290 * V_224 ,
struct V_291 * V_139 )
{
struct V_99 * V_17 ;
...
static int F_167 ( struct V_47 * V_203 ,
struct V_290 * V_224 ,
struct V_204 * V_17 )
{
struct V_1 * V_2 = F_160 ( V_203 ) ;
...
static int F_168 ( struct V_47 * V_203 ,
struct V_290 * V_224 ,
struct V_294 * V_295 )
{
struct V_1 * V_2 = F_160 ( V_203 ) ;
struct V_3 * V_4 = V_2 -> V_5 . V_4 ;
struct V_50 * V_51 = & V_4 -> V_16 ;
struct V_169 * V_170 = & V_295 -> V_170 ;
struct V_169 * V_296 ;
if ( V_295 -> V_141 != V_158 )
return - V_18 ;
F_72 ( & V_2 -> V_119 ) ;
switch ( V_295 -> V_171 ) {
case V_264 :
V_51 = & V_4 -> V_20 ;
case V_265 :
V_170 -> V_105 = V_51 -> V_267 ;
V_170 -> V_106 = V_51 -> V_268 ;
V_170 -> V_179 = 0 ;
V_170 -> V_180 = 0 ;
F_74 ( & V_2 -> V_119 ) ;
return 0 ;
case V_269 :
V_296 = F_169 ( V_224 , V_295 -> V_141 ) ;
break;
case V_181 :
V_296 = F_170 ( V_224 , V_295 -> V_141 ) ;
V_51 = & V_4 -> V_20 ;
break;
default:
F_74 ( & V_2 -> V_119 ) ;
...
F_43 ( L_11 ,
V_295 -> V_141 , V_170 -> V_179 , V_170 -> V_180 , V_170 -> V_105 , V_170 -> V_106 ,
V_51 -> V_107 , V_51 -> V_108 ) ;
F_74 ( & V_2 -> V_119 ) ;
return 0 ;
}
static int F_171 ( struct V_47 * V_203 ,
struct V_290 * V_224 ,
struct V_294 * V_295 )
{
struct V_1 * V_2 = F_160 ( V_203 ) ;
...
F_32 ( V_24 , & V_2 -> V_25 ) ;
F_21 ( & V_2 -> V_19 , V_11 ) ;
if ( V_295 -> V_171 == V_181 )
V_4 -> V_25 |= V_164 ;
}
F_43 ( L_12 , V_295 -> V_171 , V_170 -> V_179 , V_170 -> V_180 ,
...
struct V_300 * V_223 )
{
struct V_301 * V_87 = & V_2 -> V_5 . V_87 ;
struct V_27 * V_5 ;
struct V_3 * V_4 ;
struct V_78 * V_79 ;
int V_12 = - V_302 ;
V_4 = F_173 ( sizeof( * V_4 ) , V_303 ) ;
if ( ! V_4 )
return - V_302 ;
V_4 -> V_1 = V_2 ;
V_4 -> V_304 = V_305 ;
...
snprintf ( V_87 -> V_189 , sizeof( V_87 -> V_189 ) , L_13 , V_2 -> V_309 ) ;
V_87 -> V_310 = & V_311 ;
V_87 -> V_312 = & V_313 ;
V_87 -> V_223 = V_223 ;
V_87 -> V_314 = - 1 ;
...
V_79 -> type = V_262 ;
V_79 -> V_317 = V_318 | V_319 | V_320 ;
V_79 -> V_81 = V_2 -> V_5 . V_4 ;
V_79 -> V_321 = & V_322 ;
V_79 -> V_323 = & V_324 ;
V_79 -> V_325 = sizeof( struct V_29 ) ;
V_12 = F_175 ( V_79 ) ;
if ( V_12 )
goto V_326;
V_5 -> V_239 . V_11 = V_242 ;
V_12 = F_176 ( & V_87 -> V_88 , 1 , & V_5 -> V_239 , 0 ) ;
if ( V_12 )
goto V_326;
V_12 = F_177 ( V_87 , V_327 , - 1 ) ;
if ( V_12 )
goto V_328;
F_178 ( V_223 , L_14 ,
V_87 -> V_189 , F_179 ( V_87 ) ) ;
...
static int F_182 ( struct V_47 * V_203 )
{
struct V_1 * V_2 = F_160 ( V_203 ) ;
int V_12 ;
if ( V_2 == NULL )
return - V_15 ;
V_12 = F_183 ( V_2 , V_203 -> V_223 ) ;
if ( V_12 )
return V_12 ;
V_2 -> V_329 = F_2 ( V_203 ) ;
V_12 = F_172 ( V_2 , V_203 -> V_223 ) ;
if ( V_12 ) {
F_184 ( V_2 ) ;
V_2 -> V_329 = NULL ;
}
...
static void F_185 ( struct V_47 * V_203 )
{
struct V_1 * V_2 = F_160 ( V_203 ) ;
if ( V_2 == NULL )
return;
F_184 ( V_2 ) ;
if ( F_186 ( & V_2 -> V_5 . V_87 ) ) {
F_187 ( & V_2 -> V_5 . V_87 ) ;
F_180 ( & V_2 -> V_5 . V_87 . V_88 ) ;
V_2 -> V_329 = NULL ;
}
F_181 ( V_2 -> V_5 . V_4 ) ;
V_2 -> V_5 . V_4 = NULL ;
...
F_189 ( V_203 , & V_330 ) ;
V_203 -> V_11 = V_331 ;
snprintf ( V_203 -> V_189 , sizeof( V_203 -> V_189 ) , L_15 , V_2 -> V_131 -> V_309 ) ;
V_2 -> V_5 . V_332 [ V_158 ] . V_11 = V_242 ;
V_2 -> V_5 . V_332 [ V_155 ] . V_11 = V_333 ;
V_12 = F_176 ( & V_203 -> V_88 , V_334 ,
V_2 -> V_5 . V_332 , 0 ) ;
if ( V_12 )
return V_12 ;
V_203 -> V_88 . V_321 = & V_335 ;
V_203 -> V_336 = & V_337 ;
F_190 ( V_203 , V_2 ) ;
return 0 ;
}
