...
int F_48 ( struct V_1 * V_3 , struct V_49 * V_49 )
{
unsigned long V_21 ;
if ( ! V_3 || ! V_49 || ! V_26 || ! V_26 -> F_48 )
return - V_7 ;
F_41 ( & V_3 -> V_12 , V_21 ) ;
if ( ( F_49 ( V_49 ) == 0 ) &&
( F_50 ( & V_3 -> V_48 ) == 0 ) )
...
int F_52 ( struct V_1 * V_3 , struct V_52 * V_53 )
{
if ( F_53 () || F_54 () )
return 0 ;
if ( ! V_53 )
...
int F_55 ( struct V_1 * V_3 , struct V_52 * V_53 )
{
unsigned long V_21 ;
if ( F_53 () || F_54 () )
return 0 ;
if ( ! V_3 || ! V_53 || ! V_26 || ! V_26 -> F_48 )
return - V_7 ;
F_41 ( & V_3 -> V_12 , V_21 ) ;
if ( F_50 ( & V_3 -> V_48 ) == 0 ) {
F_42 ( & V_3 -> V_12 , V_21 ) ;
