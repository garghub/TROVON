...
F_57 (cl, n, &q->clhash.hash[h], common.hnode) {
if ( V_12 -> V_24 == V_23 ) {
V_12 -> V_110 = ( V_12 -> V_122 * V_12 -> V_123 * V_3 -> V_124 [ V_23 ] ) /
V_3 -> V_120 [ V_23 ] ;
}
if ( V_12 -> V_110 <= 0 || V_12 -> V_110 > 32 * F_58 ( V_12 -> V_41 ) -> V_125 ) {
F_59 ( L_1 ,
V_12 -> V_8 . V_4 , V_12 -> V_110 ) ;
V_12 -> V_110 = F_58 ( V_12 -> V_41 ) -> V_125 / 2 + 1 ;
}
}
}
}
...
static void F_61 ( struct V_1 * V_12 , T_1 V_129 , T_1 V_130 , T_1 V_131 )
{
...
static int F_72 ( struct V_1 * V_12 , struct V_135 * V_136 )
{
...
static int F_75 ( struct V_1 * V_12 , struct V_148 * V_149 )
{
struct V_2 * V_3 = F_6 ( V_12 -> V_41 ) ;
if ( V_149 -> V_123 )
...
static int F_76 ( struct V_1 * V_12 , struct V_150 * V_151 )
{
switch ( V_151 -> V_152 ) {
case V_153 :
V_12 -> V_107 = F_19 ;
...
static int F_77 ( struct V_1 * V_12 , struct V_159 * V_160 )
{
...
static int F_78 ( struct V_1 * V_12 , struct V_164 * V_165 )
{
F_61 ( V_12 , V_165 -> V_126 , V_165 -> V_22 , V_165 -> V_166 ) ;
return 0 ;
}
static int F_79 ( struct V_17 * V_18 , struct V_167 * V_168 )
{
struct V_2 * V_3 = F_6 ( V_18 ) ;
struct V_167 * V_169 [ V_170 + 1 ] ;
struct V_171 * V_172 ;
int V_173 ;
V_173 = F_80 ( V_169 , V_170 , V_168 , V_174 ) ;
if ( V_173 < 0 )
return V_173 ;
if ( V_169 [ V_175 ] == NULL || V_169 [ V_176 ] == NULL )
return - V_156 ;
V_172 = F_81 ( V_169 [ V_176 ] ) ;
if ( ( V_3 -> V_21 . V_177 = F_82 ( V_172 , V_169 [ V_175 ] ) ) == NULL )
return - V_156 ;
V_173 = F_83 ( & V_3 -> V_7 ) ;
if ( V_173 < 0 )
goto V_178;
...
V_3 -> V_21 . V_41 = V_18 ;
V_3 -> V_21 . V_3 = F_84 ( V_18 -> V_180 , & V_181 ,
V_18 -> V_27 ) ;
if ( ! V_3 -> V_21 . V_3 )
V_3 -> V_21 . V_3 = & V_182 ;
...
F_65 ( & V_3 -> V_21 ) ;
if ( V_169 [ V_188 ] )
F_72 ( & V_3 -> V_21 , F_81 ( V_169 [ V_188 ] ) ) ;
F_74 ( V_3 , & V_3 -> V_21 ) ;
return 0 ;
V_178:
F_88 ( V_3 -> V_21 . V_177 ) ;
...
if ( F_91 ( V_10 , V_176 , sizeof( V_12 -> V_177 -> V_184 ) , & V_12 -> V_177 -> V_184 ) )
goto V_189;
return V_10 -> V_95 ;
V_189:
F_92 ( V_10 , V_71 ) ;
...
V_168 . V_137 = ~ 0 ;
if ( F_91 ( V_10 , V_188 , sizeof( V_168 ) , & V_168 ) )
goto V_189;
return V_10 -> V_95 ;
V_189:
F_92 ( V_10 , V_71 ) ;
...
if ( F_91 ( V_10 , V_190 , sizeof( V_168 ) , & V_168 ) )
goto V_189;
return V_10 -> V_95 ;
V_189:
F_92 ( V_10 , V_71 ) ;
...
if ( F_91 ( V_10 , V_192 , sizeof( V_168 ) , & V_168 ) )
goto V_189;
return V_10 -> V_95 ;
V_189:
F_92 ( V_10 , V_71 ) ;
...
V_168 . V_166 = ~ 0 ;
if ( F_91 ( V_10 , V_193 , sizeof( V_168 ) , & V_168 ) )
goto V_189;
}
return V_10 -> V_95 ;
V_189:
...
V_168 . V_194 = 0 ;
V_168 . V_195 = 0 ;
if ( F_91 ( V_10 , V_196 , sizeof( V_168 ) , & V_168 ) )
goto V_189;
}
return V_10 -> V_95 ;
V_189:
...
static int
F_103 ( struct V_17 * V_18 , struct V_199 * V_200 )
{
struct V_2 * V_3 = F_6 ( V_18 ) ;
V_3 -> V_21 . V_67 . V_64 = V_3 -> V_21 . V_64 ;
return F_104 ( V_200 , & V_3 -> V_21 . V_67 , sizeof( V_3 -> V_21 . V_67 ) ) ;
}
static int
...
static int
F_106 ( struct V_17 * V_18 , unsigned long V_201 ,
struct V_199 * V_200 )
{
struct V_2 * V_3 = F_6 ( V_18 ) ;
struct V_1 * V_12 = (struct V_1 * ) V_201 ;
...
if ( F_107 ( V_200 , & V_12 -> V_99 ) < 0 ||
F_108 ( V_200 , & V_12 -> V_99 , & V_12 -> V_208 ) < 0 ||
F_109 ( V_200 , & V_12 -> V_57 ) < 0 )
return - 1 ;
return F_104 ( V_200 , & V_12 -> V_67 , sizeof( V_12 -> V_67 ) ) ;
}
static int F_110 ( struct V_17 * V_18 , unsigned long V_201 , struct V_17 * V_14 ,
struct V_17 * * V_209 )
{
struct V_1 * V_12 = (struct V_1 * ) V_201 ;
if ( V_14 == NULL ) {
V_14 = F_84 ( V_18 -> V_180 ,
& V_181 , V_12 -> V_8 . V_4 ) ;
if ( V_14 == NULL )
return - V_210 ;
} else {
...
* V_209 = V_12 -> V_3 ;
V_12 -> V_3 = V_14 ;
F_112 ( * V_209 , ( * V_209 ) -> V_3 . V_60 ) ;
F_71 ( * V_209 ) ;
F_113 ( V_18 ) ;
return 0 ;
}
static struct V_17 * F_114 ( struct V_17 * V_18 , unsigned long V_201 )
{
struct V_1 * V_12 = (struct V_1 * ) V_201 ;
return V_12 -> V_3 ;
}
static void F_115 ( struct V_17 * V_18 , unsigned long V_201 )
{
struct V_1 * V_12 = (struct V_1 * ) V_201 ;
...
for ( V_119 = 0 ; V_119 < V_3 -> V_7 . V_121 ; V_119 ++ ) {
F_123 (cl, n, next, &q->clhash.hash[h],
common.hnode)
F_117 ( V_18 , V_12 ) ;
}
F_124 ( & V_3 -> V_7 ) ;
}
static void F_125 ( struct V_17 * V_18 , unsigned long V_201 )
{
struct V_1 * V_12 = (struct V_1 * ) V_201 ;
if ( -- V_12 -> V_179 == 0 ) {
#ifdef F_9
T_5 * V_213 = F_126 ( V_18 ) ;
struct V_2 * V_3 = F_6 ( V_18 ) ;
F_127 ( V_213 ) ;
if ( V_3 -> V_56 == V_12 )
V_3 -> V_56 = NULL ;
...
static int
F_129 ( struct V_17 * V_18 , T_1 V_4 , T_1 V_214 , struct V_167 * * V_215 ,
unsigned long * V_201 )
{
int V_173 ;
struct V_2 * V_3 = F_6 ( V_18 ) ;
...
if ( V_169 [ V_176 ] ) {
V_217 = F_82 ( F_81 ( V_169 [ V_176 ] ) ,
V_169 [ V_175 ] ) ;
if ( V_217 == NULL )
return - V_156 ;
}
if ( V_215 [ V_218 ] ) {
V_173 = F_130 ( & V_12 -> V_99 , & V_12 -> V_208 ,
F_126 ( V_18 ) ,
V_215 [ V_218 ] ) ;
if ( V_173 ) {
if ( V_217 )
...
if ( V_169 [ V_188 ] )
F_72 ( V_12 , F_81 ( V_169 [ V_188 ] ) ) ;
if ( V_169 [ V_190 ] ) {
F_73 ( V_3 , V_12 ) ;
F_75 ( V_12 , F_81 ( V_169 [ V_190 ] ) ) ;
}
if ( V_169 [ V_192 ] )
F_76 ( V_12 , F_81 ( V_169 [ V_192 ] ) ) ;
#ifdef F_9
if ( V_169 [ V_196 ] )
F_77 ( V_12 , F_81 ( V_169 [ V_196 ] ) ) ;
#endif
if ( V_169 [ V_193 ] )
F_78 ( V_12 , F_81 ( V_169 [ V_193 ] ) ) ;
if ( V_12 -> V_3 -> V_3 . V_60 )
F_10 ( V_12 ) ;
F_113 ( V_18 ) ;
return 0 ;
...
V_169 [ V_188 ] == NULL )
return - V_156 ;
V_217 = F_82 ( F_81 ( V_169 [ V_176 ] ) , V_169 [ V_175 ] ) ;
if ( V_217 == NULL )
return - V_156 ;
if ( V_4 ) {
V_173 = - V_156 ;
...
V_173 = - V_210 ;
V_12 = F_132 ( sizeof( * V_12 ) , V_222 ) ;
if ( V_12 == NULL )
goto V_219;
if ( V_215 [ V_218 ] ) {
V_173 = F_133 ( & V_12 -> V_99 , & V_12 -> V_208 ,
F_126 ( V_18 ) ,
V_215 [ V_218 ] ) ;
if ( V_173 ) {
F_121 ( V_12 ) ;
...
V_217 = NULL ;
V_12 -> V_179 = 1 ;
V_12 -> V_3 = F_84 ( V_18 -> V_180 , & V_181 , V_4 ) ;
if ( ! V_12 -> V_3 )
V_12 -> V_3 = & V_182 ;
V_12 -> V_8 . V_4 = V_4 ;
V_12 -> V_13 = V_133 ;
...
static int F_135 ( struct V_17 * V_18 , unsigned long V_201 )
{
struct V_2 * V_3 = F_6 ( V_18 ) ;
struct V_1 * V_12 = (struct V_1 * ) V_201 ;
unsigned int V_60 ;
...
static struct V_224 * * F_137 ( struct V_17 * V_18 , unsigned long V_201 )
{
struct V_2 * V_3 = F_6 ( V_18 ) ;
struct V_1 * V_12 = (struct V_1 * ) V_201 ;
if ( V_12 == NULL )
...
static unsigned long F_138 ( struct V_17 * V_18 , unsigned long V_133 ,
T_1 V_4 )
{
struct V_2 * V_3 = F_6 ( V_18 ) ;
...
static void F_139 ( struct V_17 * V_18 , unsigned long V_201 )
{
struct V_1 * V_12 = (struct V_1 * ) V_201 ;
V_12 -> V_211 -- ;
}
static void F_140 ( struct V_17 * V_18 , struct V_225 * V_201 )
{
struct V_2 * V_3 = F_6 ( V_18 ) ;
struct V_1 * V_12 ;
struct V_117 * V_118 ;
