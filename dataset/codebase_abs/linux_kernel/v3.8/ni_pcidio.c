...
F_76 ( struct V_183 * V_180 )
{
unsigned int V_184 = V_180 -> V_185 ;
unsigned int V_86 ;
for ( V_86 = 0 ; V_86 < F_77 ( V_186 ) ; V_86 ++ ) {
const struct V_182 * V_187 = & V_186 [ V_86 ] ;
if ( V_187 -> V_184 == V_184 )
return V_187 ;
}
return NULL ;
}
...
unsigned long V_188 )
{
struct V_183 * V_180 = F_79 ( V_3 ) ;
struct V_4 * V_5 ;
struct V_17 * V_18 ;
int V_155 ;
unsigned int V_29 ;
V_5 = F_80 ( sizeof( * V_5 ) , V_189 ) ;
if ( ! V_5 )
return - V_190 ;
V_3 -> V_6 = V_5 ;
F_81 ( & V_5 -> V_8 ) ;
V_3 -> V_191 = F_76 ( V_180 ) ;
if ( ! V_3 -> V_191 )
return - V_192 ;
V_5 -> V_10 = F_82 ( V_180 ) ;
if ( ! V_5 -> V_10 )
...
if ( V_155 )
return V_155 ;
F_87 ( V_3 -> V_164 , L_19 , V_3 -> V_193 ,
F_23 ( V_5 -> V_10 -> V_15 + V_197 ) ) ;
V_18 = & V_3 -> V_31 [ 0 ] ;
V_3 -> V_198 = V_18 ;
V_18 -> type = V_199 ;
V_18 -> V_200 =
...
static int F_95 ( struct V_183 * V_3 ,
const struct V_221 * V_222 )
{
return F_96 ( V_3 , & V_223 ) ;
}
static void F_97 ( struct V_183 * V_3 )
{
F_98 ( V_3 ) ;
}
