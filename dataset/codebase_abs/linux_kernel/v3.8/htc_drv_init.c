...
snprintf ( V_12 -> V_13 -> V_231 , V_232 , L_16 ,
V_2 -> V_227 ,
V_2 -> V_229 ) ;
F_22 ( V_2 -> V_8 , L_17 ,
V_2 -> V_227 ,
...
if ( error != 0 )
goto V_238;
error = F_79 ( & V_55 -> V_239 , V_2 -> V_12 -> V_13 ,
F_23 ) ;
if ( error )
goto V_240;
V_57 = & V_55 -> V_239 ;
...
goto V_247;
if ( ! F_85 ( V_57 ) ) {
error = F_86 ( V_12 -> V_13 , V_57 -> V_248 ) ;
if ( error )
goto V_249;
}
error = F_87 ( V_2 -> V_10 ) ;
...
V_2 -> V_45 ,
V_2 -> V_47 ) ;
F_88 ( V_2 -> V_10 , V_236 , sizeof( V_236 ) ) ;
F_89 ( V_12 -> V_13 , L_21 , V_236 ) ;
F_90 ( V_2 ) ;
F_91 ( V_2 ) ;
return 0 ;
V_249:
...
int F_92 ( struct V_250 * V_251 , struct V_252 * V_8 ,
T_1 V_24 , char * V_144 , T_2 V_25 )
{
struct V_11 * V_12 ;
struct V_1 * V_2 ;
int V_26 ;
V_12 = F_93 ( sizeof( struct V_1 ) , & V_253 ) ;
if ( ! V_12 )
return - V_148 ;
V_2 = V_12 -> V_2 ;
V_2 -> V_12 = V_12 ;
...
void F_98 ( struct V_250 * V_251 , bool V_256 )
{
if ( V_251 -> V_254 ) {
if ( V_256 )
V_251 -> V_254 -> V_10 -> V_151 |= V_257 ;
F_9 ( V_251 -> V_254 ) ;
F_96 ( V_251 -> V_254 ) ;
F_97 ( V_251 -> V_254 -> V_12 ) ;
}
}
void F_99 ( struct V_250 * V_251 )
{
F_100 ( V_251 -> V_254 , V_258 ) ;
}
int F_101 ( struct V_250 * V_251 )
{
