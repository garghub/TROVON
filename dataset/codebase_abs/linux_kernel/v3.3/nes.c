...
static int T_4 F_40 ( struct V_122 * V_26 , const struct V_123 * V_124 )
{
...
static void T_7 F_82 ( struct V_122 * V_26 )
{
...
static T_8 F_86 ( struct V_185 * V_186 , char * V_187 )
{
...
static T_8 F_87 ( struct V_185 * V_186 ,
const char * V_187 , T_9 V_194 )
{
char * V_195 = ( char * ) V_187 ;
V_190 = F_88 ( V_195 , & V_195 , 10 ) ;
return F_89 ( V_187 , V_194 ) ;
}
static T_8 F_90 ( struct V_185 * V_186 , char * V_187 )
{
T_2 V_196 = 0xdead ;
T_2 V_189 = 0 ;
struct V_11 * V_12 ;
...
static T_8 F_91 ( struct V_185 * V_186 ,
const char * V_187 , T_9 V_194 )
{
char * V_195 = ( char * ) V_187 ;
T_2 V_198 ;
...
static T_8 F_92 ( struct V_185 * V_186 , char * V_187 )
{
T_2 V_199 = 0xdead ;
T_2 V_189 = 0 ;
struct V_11 * V_12 ;
...
static T_8 F_93 ( struct V_185 * V_186 ,
const char * V_187 , T_9 V_194 )
{
char * V_195 = ( char * ) V_187 ;
T_2 V_198 ;
...
static T_8 F_94 ( struct V_185 * V_186 , char * V_187 )
{
T_2 V_201 = 0xdead ;
T_2 V_189 = 0 ;
struct V_11 * V_12 ;
...
static T_8 F_95 ( struct V_185 * V_186 ,
const char * V_187 , T_9 V_194 )
{
char * V_195 = ( char * ) V_187 ;
T_2 V_198 ;
...
static T_8 F_96 ( struct V_185 * V_186 , char * V_187 )
{
T_2 V_203 = 0xdead ;
T_2 V_189 = 0 ;
struct V_11 * V_12 ;
...
static T_8 F_97 ( struct V_185 * V_186 ,
const char * V_187 , T_9 V_194 )
{
char * V_195 = ( char * ) V_187 ;
T_2 V_198 ;
...
static T_8 F_98 ( struct V_185 * V_186 , char * V_187 )
{
return snprintf ( V_187 , V_193 , L_46 , V_205 ) ;
}
static T_8 F_99 ( struct V_185 * V_186 ,
const char * V_187 , T_9 V_194 )
{
char * V_195 = ( char * ) V_187 ;
if ( V_195 [ 1 ] == 'x' || V_195 [ 1 ] == 'X' || V_195 [ 0 ] == 'x' || V_195 [ 0 ] == 'X' )
...
static T_8 F_100 ( struct V_185 * V_186 , char * V_187 )
{
T_2 V_206 = 0xdead ;
T_2 V_189 = 0 ;
struct V_11 * V_12 ;
...
static T_8 F_101 ( struct V_185 * V_186 ,
const char * V_187 , T_9 V_194 )
{
char * V_195 = ( char * ) V_187 ;
T_2 V_198 ;
...
static T_8 F_102 ( struct V_185 * V_186 , char * V_187 )
{
return snprintf ( V_187 , V_193 , L_46 , V_207 ) ;
}
static T_8 F_103 ( struct V_185 * V_186 ,
const char * V_187 , T_9 V_194 )
{
char * V_195 = ( char * ) V_187 ;
if ( V_195 [ 1 ] == 'x' || V_195 [ 1 ] == 'X' || V_195 [ 0 ] == 'x' || V_195 [ 0 ] == 'X' )
...
static T_8 F_104 ( struct V_185 * V_186 , char * V_187 )
{
T_2 V_208 = 0xdead ;
T_2 V_189 = 0 ;
struct V_11 * V_12 ;
...
static T_8 F_106 ( struct V_185 * V_186 ,
const char * V_187 , T_9 V_194 )
{
char * V_195 = ( char * ) V_187 ;
T_2 V_198 ;
...
static T_8 F_107 ( struct V_185 * V_186 , char * V_187 )
{
T_2 V_209 = 0xdead ;
T_2 V_189 = 0 ;
struct V_11 * V_12 ;
...
static T_8 F_108 ( struct V_185 * V_186 ,
const char * V_187 , T_9 V_194 )
{
unsigned long V_209 ;
T_2 V_210 ;
