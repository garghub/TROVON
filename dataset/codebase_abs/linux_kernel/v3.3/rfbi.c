...
V_4 . V_5 = F_68 ( V_141 -> V_145 , F_69 ( V_141 ) ) ;
if ( ! V_4 . V_5 ) {
F_38 ( L_22 ) ;
V_6 = - V_146 ;
goto V_144;
...
goto V_147;
F_71 ( 10 ) ;
V_142 = F_72 ( & V_7 -> V_8 , L_23 ) ;
if ( F_73 ( V_142 ) ) {
F_38 ( L_24 ) ;
V_6 = F_74 ( V_142 ) ;
goto V_148;
}
V_4 . V_47 = F_75 ( V_142 ) / 1000 ;
F_76 ( V_142 ) ;
V_139 = F_3 ( V_124 ) ;
F_77 ( & V_7 -> V_8 , L_25 ,
...
static int F_81 ( struct V_138 * V_7 )
{
F_79 ( & V_7 -> V_8 ) ;
F_80 ( V_4 . V_5 ) ;
return 0 ;
}
static int F_82 ( struct V_149 * V_8 )
{
F_83 () ;
F_84 () ;
return 0 ;
}
static int F_85 ( struct V_149 * V_8 )
{
int V_6 ;
V_6 = F_86 () ;
if ( V_6 < 0 )
