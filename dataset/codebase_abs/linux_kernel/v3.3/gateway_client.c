...
bool F_49 ( struct V_75 * V_76 , unsigned int * V_77 )
{
struct V_83 * V_83 ;
struct V_84 * V_84 ;
struct V_85 * V_85 ;
struct V_86 * V_86 ;
if ( ! F_50 ( V_76 , * V_77 + V_87 ) )
return false ;
V_83 = (struct V_83 * ) V_76 -> V_81 ;
* V_77 += V_87 ;
if ( F_51 ( V_83 -> V_88 ) == V_89 ) {
if ( ! F_50 ( V_76 , * V_77 + V_90 ) )
return false ;
V_83 = (struct V_83 * ) ( V_76 -> V_81 + V_90 ) ;
* V_77 += V_90 ;
}
switch ( F_51 ( V_83 -> V_88 ) ) {
case V_91 :
if ( ! F_50 ( V_76 , * V_77 + sizeof( * V_84 ) ) )
return false ;
...
* V_77 += sizeof( * V_86 ) ;
if ( ( F_51 ( V_83 -> V_88 ) == V_91 ) &&
( F_51 ( V_86 -> V_97 ) != 67 ) )
return false ;
if ( ( F_51 ( V_83 -> V_88 ) == V_95 ) &&
( F_51 ( V_86 -> V_97 ) != 547 ) )
return false ;
return true ;
}
bool F_52 ( struct V_4 * V_4 ,
struct V_75 * V_76 , struct V_83 * V_83 )
{
struct V_13 * V_98 = NULL , * V_99 = NULL ;
struct V_7 * V_100 = NULL ;
struct V_1 * V_5 = NULL ;
bool V_59 , V_101 = false ;
unsigned int V_77 = 0 ;
T_2 V_102 ;
V_59 = F_49 ( V_76 , & V_77 ) ;
if ( ! V_59 )
goto V_6;
V_100 = F_53 ( V_4 , V_83 -> V_103 ,
V_83 -> V_104 ) ;
if ( ! V_100 )
goto V_6;
if ( ! V_100 -> V_25 )
...
V_99 = F_54 ( V_4 , V_100 , NULL ) ;
if ( ! V_99 )
goto V_6;
if ( V_102 - V_99 -> V_26 > V_107 )
V_101 = true ;
V_6:
if ( V_100 )
F_29 ( V_100 ) ;
