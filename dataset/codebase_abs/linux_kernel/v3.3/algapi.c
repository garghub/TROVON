...
int F_68 ( struct V_28 * V_29 , struct V_3 * V_4 ,
...
int F_69 ( struct V_28 * V_29 , struct V_3 * V_4 ,
struct V_20 * V_21 ,
...
goto V_49;
V_29 -> V_75 = V_75 ;
V_45 = F_68 ( V_29 , V_4 , V_21 , V_75 -> V_76 ) ;
V_49:
return V_45 ;
}
...
static struct V_3 * F_72 ( struct V_28 * V_29 )
{
struct V_3 * V_4 ;
struct V_3 * V_77 ;
F_60 ( & V_55 ) ;
...
struct V_78 * F_74 ( struct V_28 * V_29 , T_1 type ,
T_1 V_2 )
{
struct V_3 * V_4 ;
struct V_78 * V_79 ;
...
{
return F_82 ( & V_83 , V_82 ) ;
}
struct V_84 * F_83 ( struct V_85 * * V_86 )
{
struct V_85 * V_87 = V_86 [ 0 ] ;
struct V_84 * V_88 ;
if ( ! V_87 )
return F_36 ( - V_50 ) ;
if ( F_84 ( V_87 ) < sizeof( * V_88 ) )
return F_36 ( - V_16 ) ;
if ( V_87 -> V_89 != V_90 )
return F_36 ( - V_16 ) ;
V_88 = F_85 ( V_87 ) ;
...
int F_86 ( struct V_85 * * V_86 , T_1 type )
{
struct V_84 * V_88 ;
V_88 = F_83 ( V_86 ) ;
if ( F_32 ( V_88 ) )
...
const char * F_87 ( struct V_85 * V_87 )
{
struct V_91 * V_92 ;
if ( ! V_87 )
return F_36 ( - V_50 ) ;
if ( F_84 ( V_87 ) < sizeof( * V_92 ) )
return F_36 ( - V_16 ) ;
if ( V_87 -> V_89 != V_93 )
return F_36 ( - V_16 ) ;
V_92 = F_85 ( V_87 ) ;
...
struct V_3 * F_88 ( struct V_85 * V_87 ,
const struct V_74 * V_75 ,
T_1 type , T_1 V_2 )
{
const char * V_1 ;
...
if ( F_32 ( V_1 ) )
return F_36 ( V_45 ) ;
return F_89 ( V_1 , V_75 , type , V_2 ) ;
}
int F_90 ( struct V_85 * V_87 , T_1 * V_94 )
{
struct F_90 * V_95 ;
if ( ! V_87 )
return - V_50 ;
if ( F_84 ( V_87 ) < sizeof( * V_95 ) )
return - V_16 ;
if ( V_87 -> V_89 != V_96 )
return - V_16 ;
V_95 = F_85 ( V_87 ) ;
...
void * F_91 ( const char * V_1 , struct V_3 * V_4 ,
unsigned int V_97 )
{
struct V_20 * V_21 ;
char * V_66 ;
int V_45 ;
V_66 = F_92 ( V_97 + sizeof( * V_21 ) + sizeof( struct V_28 ) ,
V_98 ) ;
if ( ! V_66 )
return F_36 ( - V_99 ) ;
V_21 = ( void * ) ( V_66 + V_97 ) ;
...
struct V_20 * F_93 ( const char * V_1 ,
struct V_3 * V_4 )
{
struct V_20 * V_21 ;
struct V_28 * V_29 ;
...
void F_95 ( struct V_103 * V_104 , unsigned int V_105 )
{
F_27 ( & V_104 -> V_31 ) ;
...
V_104 -> V_107 ++ ;
F_97 ( & V_109 -> V_31 , & V_104 -> V_31 ) ;
V_49:
return V_45 ;
}
void * F_98 ( struct V_103 * V_104 , unsigned int V_114 )
{
struct V_24 * V_109 ;
if ( F_52 ( ! V_104 -> V_107 ) )
return NULL ;
...
struct V_108 * F_99 ( struct V_103 * V_104 )
{
return F_98 ( V_104 , 0 ) ;
}
int F_100 ( struct V_103 * V_104 , struct V_78 * V_79 )
{
struct V_108 * V_115 ;
...
static inline void F_101 ( T_2 * V_116 , unsigned int V_117 )
{
...
void F_102 ( T_2 * V_116 , unsigned int V_117 )
{
...
static inline void F_105 ( T_2 * V_116 , const T_2 * V_118 , unsigned int V_117 )
{
for (; V_117 ; V_117 -- )
* V_116 ++ ^= * V_118 ++ ;
}
void F_106 ( T_2 * V_120 , const T_2 * V_121 , unsigned int V_117 )
{
T_1 * V_116 = ( T_1 * ) V_120 ;
T_1 * V_118 = ( T_1 * ) V_121 ;
for (; V_117 >= 4 ; V_117 -= 4 )
* V_116 ++ ^= * V_118 ++ ;
F_105 ( ( T_2 * ) V_116 , ( T_2 * ) V_118 , V_117 ) ;
}
