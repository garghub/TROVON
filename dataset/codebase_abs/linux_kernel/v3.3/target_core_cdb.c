...
snprintf ( & V_3 [ 8 ] , 8 , L_3 ) ;
snprintf ( & V_3 [ 16 ] , 16 , L_4 , V_16 -> V_30 -> V_35 . V_36 ) ;
snprintf ( & V_3 [ 32 ] , 4 , L_4 , V_16 -> V_30 -> V_35 . V_37 ) ;
V_3 [ 4 ] = 31 ;
V_34:
F_7 ( V_12 ) ;
return 0 ;
...
V_40 ) {
T_2 V_41 ;
V_41 = strlen ( V_16 -> V_30 -> V_35 . V_42 ) ;
V_41 ++ ;
...
V_52 += sprintf ( & V_3 [ V_51 + 12 ] , L_5 , V_49 ,
& V_16 -> V_30 -> V_35 . V_42 [ 0 ] ) ;
}
V_3 [ V_51 ] = 0x2 ;
V_3 [ V_51 + 1 ] = 0x1 ;
V_3 [ V_51 + 2 ] = 0x0 ;
memcpy ( & V_3 [ V_51 + 4 ] , L_3 , 8 ) ;
V_52 ++ ;
V_3 [ V_51 + 3 ] = V_52 ;
V_38 += ( V_52 + 4 ) ;
V_51 += ( V_52 + 4 ) ;
...
struct V_15 * V_16 = V_12 -> V_17 ;
unsigned char * V_3 ;
unsigned long long V_98 = V_16 -> V_26 -> V_99 ( V_16 ) ;
T_2 V_100 ;
if ( V_98 >= 0x00000000ffffffff )
V_100 = 0xffffffff ;
else
V_100 = ( T_2 ) V_98 ;
V_3 = F_6 ( V_12 ) ;
...
V_3 [ 2 ] = ( V_100 >> 8 ) & 0xff ;
V_3 [ 3 ] = V_100 & 0xff ;
V_3 [ 4 ] = ( V_16 -> V_30 -> V_73 . V_101 >> 24 ) & 0xff ;
V_3 [ 5 ] = ( V_16 -> V_30 -> V_73 . V_101 >> 16 ) & 0xff ;
V_3 [ 6 ] = ( V_16 -> V_30 -> V_73 . V_101 >> 8 ) & 0xff ;
V_3 [ 7 ] = V_16 -> V_30 -> V_73 . V_101 & 0xff ;
if ( V_16 -> V_30 -> V_73 . V_76 || V_16 -> V_30 -> V_73 . V_77 )
...
struct V_15 * V_16 = V_12 -> V_17 ;
unsigned char * V_3 ;
unsigned long long V_100 = V_16 -> V_26 -> V_99 ( V_16 ) ;
V_3 = F_6 ( V_12 ) ;
V_3 [ 0 ] = ( V_100 >> 56 ) & 0xff ;
V_3 [ 1 ] = ( V_100 >> 48 ) & 0xff ;
V_3 [ 2 ] = ( V_100 >> 40 ) & 0xff ;
...
V_3 [ 6 ] = ( V_100 >> 8 ) & 0xff ;
V_3 [ 7 ] = V_100 & 0xff ;
V_3 [ 8 ] = ( V_16 -> V_30 -> V_73 . V_101 >> 24 ) & 0xff ;
V_3 [ 9 ] = ( V_16 -> V_30 -> V_73 . V_101 >> 16 ) & 0xff ;
V_3 [ 10 ] = ( V_16 -> V_30 -> V_73 . V_101 >> 8 ) & 0xff ;
V_3 [ 11 ] = V_16 -> V_30 -> V_73 . V_101 & 0xff ;
if ( V_16 -> V_30 -> V_73 . V_76 || V_16 -> V_30 -> V_73 . V_77 )
V_3 [ 14 ] = 0x80 ;
F_7 ( V_12 ) ;
V_88 -> V_96 = V_97 ;
...
V_43 [ 1 ] = 0x0a ;
V_43 [ 2 ] = 2 ;
V_43 [ 3 ] = ( V_16 -> V_30 -> V_73 . V_102 == 1 ) ? 0x00 : 0x10 ;
V_43 [ 4 ] = ( V_16 -> V_30 -> V_73 . V_103 == 2 ) ? 0x30 :
( V_16 -> V_30 -> V_73 . V_103 == 1 ) ? 0x20 : 0x00 ;
V_43 [ 5 ] = ( V_16 -> V_30 -> V_73 . V_104 ) ? 0x40 : 0x00 ;
V_43 [ 8 ] = 0xff ;
V_43 [ 9 ] = 0xff ;
V_43 [ 11 ] = 30 ;
return 12 ;
...
switch ( V_90 [ 2 ] & 0x3f ) {
case 0x01 :
V_110 = F_27 ( & V_3 [ V_109 ] ) ;
break;
case 0x08 :
V_110 = F_29 ( V_16 , & V_3 [ V_109 ] ) ;
break;
case 0x0a :
V_110 = F_28 ( V_16 , & V_3 [ V_109 ] ) ;
break;
case 0x3f :
V_110 = F_27 ( & V_3 [ V_109 ] ) ;
V_110 += F_29 ( V_16 , & V_3 [ V_109 + V_110 ] ) ;
V_110 += F_28 ( V_16 , & V_3 [ V_109 + V_110 ] ) ;
break;
default:
F_5 ( L_13 ,
V_90 [ 2 ] & 0x3f , V_90 [ 3 ] ) ;
...
F_30 ( & V_3 [ 3 ] , type ) ;
if ( ( V_16 -> V_30 -> V_73 . V_74 > 0 ) &&
( V_16 -> V_30 -> V_73 . V_117 > 0 ) )
F_31 ( & V_3 [ 3 ] , type ) ;
if ( ( V_109 + 2 ) > V_12 -> V_22 )
V_109 = V_12 -> V_22 ;
} else {
V_109 -= 1 ;
V_3 [ 0 ] = V_109 & 0xff ;
...
( V_16 -> V_30 -> V_73 . V_117 > 0 ) )
F_31 ( & V_3 [ 2 ] , type ) ;
if ( ( V_109 + 1 ) > V_12 -> V_22 )
V_109 = V_12 -> V_22 ;
}
V_106 = F_6 ( V_12 ) ;
memcpy ( V_106 , V_3 , V_109 ) ;
F_7 ( V_12 ) ;
V_88 -> V_96 = V_97 ;
F_24 ( V_88 , 1 ) ;
return 0 ;
...
struct V_11 * V_12 = V_88 -> V_89 ;
struct V_15 * V_16 = V_12 -> V_17 ;
unsigned char * V_3 , * V_128 = NULL ;
unsigned char * V_90 = & V_12 -> V_91 [ 0 ] ;
T_4 V_129 ;
unsigned int V_130 = V_12 -> V_22 , V_131 ;
int V_92 = 0 , V_109 ;
...
V_128 = & V_3 [ V_109 ] ;
F_14 ( L_17
L_18 , V_16 -> V_26 -> V_135 , V_132 , V_133 , V_130 , V_128 ) ;
while ( V_130 ) {
V_129 = F_37 ( & V_128 [ 0 ] ) ;
V_131 = F_38 ( & V_128 [ 8 ] ) ;
F_14 ( L_19 ,
( unsigned long long ) V_129 , V_131 ) ;
V_92 = V_16 -> V_26 -> V_134 ( V_16 , V_129 , V_131 ) ;
if ( V_92 < 0 ) {
F_5 ( L_20 ,
V_92 ) ;
goto V_120;
...
struct V_15 * V_16 = V_12 -> V_17 ;
T_4 V_131 ;
T_4 V_129 = V_12 -> V_137 ;
T_2 V_138 ;
int V_92 ;
if ( ! V_16 -> V_26 -> V_134 ) {
F_5 ( L_21
L_22 , V_16 -> V_26 -> V_135 ) ;
V_12 -> V_93 = V_136 ;
return - V_121 ;
}
...
V_131 = ( V_16 -> V_26 -> V_99 ( V_16 ) - V_129 ) ;
F_14 ( L_23 ,
( unsigned long long ) V_129 , ( unsigned long long ) V_131 ) ;
V_92 = V_16 -> V_26 -> V_134 ( V_16 , V_129 , V_131 ) ;
if ( V_92 < 0 ) {
F_14 ( L_24 ) ;
return V_92 ;
...
if ( V_12 -> V_143 & V_144 ) {
unsigned long long V_129 = V_88 -> V_145 ;
T_2 V_146 = V_88 -> V_147 ;
switch ( V_142 ) {
case 6 :
V_90 [ 1 ] = ( V_129 >> 16 ) & 0x1f ;
V_90 [ 2 ] = ( V_129 >> 8 ) & 0xff ;
V_90 [ 3 ] = V_129 & 0xff ;
V_90 [ 4 ] = V_146 & 0xff ;
break;
