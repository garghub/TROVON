...
int V_33 ;
V_34:
if ( F_28 ( & V_31 -> V_28 , V_7 ) == 0 )
return - V_8 ;
F_22 ( & V_31 -> V_27 ) ;
V_33 = F_29 ( & V_31 -> V_28 , V_15 , 1 , ( int * ) V_32 ) ;
F_24 ( & V_31 -> V_27 ) ;
if ( V_33 == - V_35 )
goto V_34;
if ( V_33 != 0 )
...
struct V_14 *
F_38 ( struct V_1 * V_2 , struct V_25 * V_18 ,
T_2 V_26 )
{
struct V_14 * V_15 ;
F_22 ( & V_18 -> V_27 ) ;
...
return - V_55 ;
V_33 = F_21 ( V_31 , args -> V_26 ) ;
return V_33 ;
}
int
F_41 ( struct V_1 * V_2 , void * V_51 ,
struct V_25 * V_31 )
{
...
if ( ! ( V_2 -> V_22 -> V_53 & V_54 ) )
return - V_55 ;
V_15 = F_38 ( V_2 , V_31 , args -> V_26 ) ;
if ( V_15 == NULL )
return - V_57 ;
V_34:
if ( F_28 ( & V_2 -> V_6 , V_7 ) == 0 ) {
V_33 = - V_8 ;
goto V_58;
}
F_22 ( & V_2 -> V_5 ) ;
if ( ! V_15 -> V_45 ) {
V_33 = F_29 ( & V_2 -> V_6 , V_15 , 1 ,
& V_15 -> V_45 ) ;
...
return - V_55 ;
F_22 ( & V_2 -> V_5 ) ;
V_15 = F_23 ( & V_2 -> V_6 , ( int ) args -> V_45 ) ;
if ( V_15 )
F_39 ( V_15 ) ;
F_24 ( & V_2 -> V_5 ) ;
if ( ! V_15 )
return - V_57 ;
V_33 = F_27 ( V_31 , V_15 , & V_26 ) ;
F_42 ( V_15 ) ;
if ( V_33 )
return V_33 ;
args -> V_26 = V_26 ;
...
static int
F_44 ( int V_62 , void * V_63 , void * V_51 )
{
...
void
F_45 ( struct V_1 * V_2 , struct V_25 * V_61 )
{
F_46 ( & V_61 -> V_28 ,
& F_44 , V_61 ) ;
F_47 ( & V_61 -> V_28 ) ;
...
static void F_52 ( struct V_64 * V_67 )
{
F_53 () ;
}
...
int F_63 ( struct V_71 * V_18 , struct V_68 * V_69 )
{
...
int V_33 = 0 ;
F_57 ( & V_2 -> V_65 ) ;
if ( F_64 ( & V_4 -> V_10 , V_69 -> V_76 , & V_40 ) ) {
F_59 ( & V_2 -> V_65 ) ;
return F_65 ( V_18 , V_69 ) ;
}
V_42 = F_66 ( V_40 , struct V_37 , V_40 ) -> V_42 ;
if ( ! V_42 ||
( ( V_42 -> V_77 & V_78 ) && ! F_67 ( V_79 ) ) ) {
V_33 = - V_80 ;
goto V_81;
}
