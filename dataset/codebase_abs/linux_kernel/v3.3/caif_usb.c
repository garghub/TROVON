...
struct V_1 * F_14 ( int V_28 , T_1 V_31 [ V_32 ] ,
T_1 V_33 [ V_32 ] )
{
...
struct V_48 * V_48 = F_21 ( V_44 ) ;
struct V_49 * V_50 = V_48 -> V_51 ;
struct V_52 V_53 ;
if ( V_44 -> V_54 == NULL || V_44 -> V_54 -> V_55 == NULL )
return 0 ;
V_44 -> V_54 -> V_55 ( V_44 , & V_53 ) ;
if ( strncmp ( V_53 . V_56 , L_5 , 7 ) != 0 )
return 0 ;
F_19 ( L_6 ,
F_22 ( V_50 -> V_57 . V_58 ) ,
F_22 ( V_50 -> V_57 . V_59 ) ) ;
if ( ! ( F_22 ( V_50 -> V_57 . V_58 ) == V_60 &&
F_22 ( V_50 -> V_57 . V_59 ) == V_61 ) )
return 0 ;
if ( V_41 == V_62 )
F_23 ( V_63 ) ;
if ( V_41 != V_64 )
...
V_46 . V_68 = V_69 ;
V_46 . V_70 = NULL ;
V_47 = F_14 ( V_44 -> V_71 , V_44 -> V_72 ,
V_44 -> V_73 ) ;
if ( ! V_47 )
return - V_74 ;
if ( V_44 -> V_75 > 1 )
F_10 ( L_7 ) ;
F_25 ( V_44 , & V_46 , V_47 , V_76 ,
& V_16 , & V_77 . V_78 ) ;
if ( ! V_79 )
F_26 ( & V_77 ) ;
V_79 = true ;
