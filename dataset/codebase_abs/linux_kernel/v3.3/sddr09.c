...
int V_8 , V_11 , V_12 ;
unsigned char V_17 , V_18 , V_19 [ 8 ] ;
V_17 = 0 ;
for ( V_11 = 0 ; V_11 < 8 ; V_11 ++ )
V_19 [ V_11 ] = 0 ;
for ( V_8 = 0 ; V_8 < 256 ; V_8 ++ ) {
...
static unsigned int
F_31 ( struct V_61 * V_62 , unsigned int V_65 ) {
static unsigned int V_85 = 1 ;
int V_86 , V_87 , V_8 ;
V_86 = ( V_65 / 1000 ) << 10 ;
V_87 = V_62 -> V_76 >> ( V_62 -> V_74 + V_62 -> V_51 ) ;
V_87 -= V_86 ;
if ( V_87 > 1024 )
V_87 = 1024 ;
for ( V_8 = V_85 + 1 ; V_8 < V_87 ; V_8 ++ ) {
if ( V_62 -> V_88 [ V_86 + V_8 ] == UNDEF ) {
V_85 = V_8 ;
return V_86 + V_8 ;
}
}
...
static int
F_32 ( struct V_20 * V_21 , unsigned int V_65 ,
unsigned int V_68 , unsigned int V_69 ,
unsigned char * V_89 , unsigned char * V_90 ) {
struct V_61 * V_62 = (struct V_61 * ) V_21 -> V_63 ;
unsigned long V_58 ;
unsigned int V_67 , V_91 ;
unsigned int V_92 ;
unsigned char * V_93 , * V_94 , * V_95 ;
unsigned char V_16 [ 3 ] ;
int V_8 , V_42 , V_96 ;
V_91 = ( ( V_65 % 1000 ) << 1 ) | 0x1000 ;
if ( V_13 [ F_14 ( V_91 ) ^ F_15 ( V_91 ) ] )
V_91 ^= 1 ;
V_67 = V_62 -> V_82 [ V_65 ] ;
V_96 = 0 ;
if ( V_67 == UNDEF ) {
...
F_5 ( V_93 + ( V_62 -> V_78 / 2 ) , V_16 ) ;
if ( ! F_6 ( V_94 + 8 , V_16 ) ) {
F_16 ( L_23 ,
V_8 , V_67 ) ;
F_7 ( V_94 + 8 , V_16 ) ;
}
V_94 [ 6 ] = V_94 [ 11 ] = F_14 ( V_91 ) ;
V_94 [ 7 ] = V_94 [ 12 ] = F_15 ( V_91 ) ;
}
V_95 = V_89 ;
for ( V_8 = V_68 ; V_8 < V_68 + V_69 ; V_8 ++ ) {
V_93 = V_90 + V_8 * V_92 ;
V_94 = V_93 + V_62 -> V_78 ;
memcpy ( V_93 , V_95 , V_62 -> V_78 ) ;
V_95 += V_62 -> V_78 ;
F_5 ( V_93 , V_16 ) ;
F_7 ( V_94 + 13 , V_16 ) ;
F_5 ( V_93 + ( V_62 -> V_78 / 2 ) , V_16 ) ;
...
static struct V_6 *
F_37 ( struct V_20 * V_21 , unsigned char V_103 ) {
struct V_6 * V_105 ;
...
sprintf ( V_106 + strlen ( V_106 ) ,
L_39 ,
F_1 ( V_102 [ 0 ] ) ) ;
V_105 = F_2 ( V_102 [ 1 ] ) ;
if ( V_105 ) {
sprintf ( V_106 + strlen ( V_106 ) ,
L_40 , 1 << ( V_105 -> V_107 - 20 ) ) ;
} else {
sprintf ( V_106 + strlen ( V_106 ) ,
L_41 ) ;
}
...
int V_8 , V_11 , V_42 ;
unsigned char * V_64 , * V_111 , * V_89 ;
unsigned int V_65 , V_112 ;
if ( ! V_62 -> V_76 )
return - 1 ;
V_108 = V_62 -> V_76 >> ( V_62 -> V_74 + V_62 -> V_51 ) ;
#define F_39 65536
V_110 = F_26 ( V_108 , F_39 >> V_54 ) ;
V_109 = ( V_110 << V_54 ) ;
V_64 = F_27 ( V_109 , V_79 ) ;
if ( V_64 == NULL ) {
F_28 ( V_80 L_46 ) ;
V_42 = - 1 ;
goto V_113;
...
F_30 ( V_62 -> V_82 ) ;
F_30 ( V_62 -> V_88 ) ;
V_62 -> V_82 = F_27 ( V_108 * sizeof( int ) , V_79 ) ;
V_62 -> V_88 = F_27 ( V_108 * sizeof( int ) , V_79 ) ;
if ( V_62 -> V_82 == NULL || V_62 -> V_88 == NULL ) {
F_28 ( V_80 L_46 ) ;
V_42 = - 1 ;
goto V_113;
}
for ( V_8 = 0 ; V_8 < V_108 ; V_8 ++ )
V_62 -> V_82 [ V_8 ] = V_62 -> V_88 [ V_8 ] = UNDEF ;
V_89 = V_111 ;
for ( V_8 = 0 ; V_8 < V_108 ; V_8 ++ ) {
V_89 += ( 1 << V_54 ) ;
if ( V_89 >= V_111 ) {
...
L_49
L_50 ,
V_8 , V_89 [ 0 ] , V_89 [ 1 ] , V_89 [ 2 ] , V_89 [ 3 ] ,
V_89 [ 4 ] , V_89 [ 5 ] ) ;
V_62 -> V_88 [ V_8 ] = V_114 ;
continue;
}
...
L_51
L_52 ,
V_8 , V_89 [ 6 ] , V_89 [ 7 ] , V_89 [ 11 ] , V_89 [ 12 ] ) ;
V_62 -> V_88 [ V_8 ] = V_114 ;
continue;
}
if ( V_13 [ V_89 [ 6 ] ^ V_89 [ 7 ] ] ) {
F_28 ( V_80
L_53
L_54 , V_8 , V_89 [ 6 ] , V_89 [ 7 ] ) ;
V_62 -> V_88 [ V_8 ] = V_114 ;
continue;
}
V_65 = F_40 ( V_89 [ 7 ] , V_89 [ 6 ] ) ;
V_65 = ( V_65 & 0x07FF ) >> 1 ;
if ( V_65 >= 1000 ) {
F_28 ( V_80
L_55 ,
...
V_65 += 1000 * ( V_8 / 0x400 ) ;
if ( V_62 -> V_82 [ V_65 ] != UNDEF ) {
F_28 ( V_80
L_56 ,
V_65 , V_62 -> V_82 [ V_65 ] , V_8 ) ;
goto V_117;
}
V_62 -> V_88 [ V_8 ] = V_65 ;
V_62 -> V_82 [ V_65 ] = V_8 ;
...
V_112 = 0 ;
for ( V_8 = 0 ; V_8 < V_108 ; V_8 += 1024 ) {
int V_119 = 0 ;
for ( V_11 = 0 ; V_11 < 1024 && V_8 + V_11 < V_108 ; V_11 ++ ) {
if ( V_62 -> V_88 [ V_8 + V_11 ] != V_114 ) {
if ( V_119 >= 1000 )
V_62 -> V_88 [ V_8 + V_11 ] = V_120 ;
else
V_119 ++ ;
}
}
...
int V_42 ;
if ( V_21 -> V_121 -> V_122 -> V_123 . V_124 != 1 ) {
F_16 ( L_58 , V_21 -> V_121
-> V_122 -> V_123 . V_124 ) ;
return - V_125 ;
}
V_42 = F_43 ( V_21 -> V_121 ) ;
F_16 ( L_59 , V_42 ) ;
if ( V_42 == - V_34 ) {
F_16 ( L_60 ) ;
} else if ( V_42 != 0 ) {
...
static int F_46 ( struct V_127 * V_83 , struct V_20 * V_21 )
{
int V_128 ;
F_16 ( L_66 , V_83 -> V_129 -> V_130 ) ;
switch ( V_83 -> V_129 -> V_130 ) {
case 0 :
V_128 = F_47 ( V_83 , V_21 ) ;
break;
case 1 :
V_83 -> V_129 -> V_130 = 0 ;
V_128 = F_48 ( V_83 , V_21 ) ;
V_83 -> V_129 -> V_130 = 1 ;
break;
default:
F_16 ( L_67 ,
...
static int F_48 ( struct V_127 * V_83 , struct V_20 * V_21 )
{
static unsigned char V_132 = 0 , V_133 = 0 ;
static unsigned char V_134 = 0 ;
int V_42 , V_8 ;
unsigned char * V_89 = V_21 -> V_41 ;
unsigned long V_76 ;
unsigned int V_68 , V_69 ;
struct V_61 * V_62 ;
static unsigned char V_135 [ 8 ] = {
0x00 , 0x80 , 0x00 , 0x02 , 0x1F , 0x00 , 0x00 , 0x00
} ;
static unsigned char V_136 [ 19 ] = {
0x00 , 0x0F , 0x00 , 0x0 , 0x0 , 0x0 , 0x00 ,
0x01 , 0x0A ,
0x00 , 0x00 , 0x00 , 0x00 , 0x00 , 0x00 , 0x00 , 0x00 , 0x00 , 0x00
} ;
V_62 = (struct V_61 * ) V_21 -> V_63 ;
if ( V_83 -> V_137 [ 0 ] == V_138 && V_134 ) {
memset ( V_89 , 0 , 18 ) ;
V_89 [ 0 ] = 0x70 ;
V_89 [ 2 ] = V_132 ;
V_89 [ 7 ] = 11 ;
...
V_134 = 1 ;
if ( V_83 -> V_137 [ 0 ] == V_140 ) {
memcpy ( V_89 , V_135 , 8 ) ;
F_50 ( V_21 , V_89 , 36 ) ;
return V_139 ;
}
if ( V_83 -> V_137 [ 0 ] == V_141 ) {
struct V_6 * V_105 ;
F_36 ( V_21 , V_62 ) ;
V_105 = F_37 ( V_21 , V_62 -> V_103 ) ;
if ( ! V_105 ) {
V_142:
V_132 = 0x02 ;
V_133 = 0x3a ;
...
V_62 -> V_76 = ( 1 << V_105 -> V_107 ) ;
V_62 -> V_51 = V_105 -> V_51 ;
V_62 -> V_78 = ( 1 << V_62 -> V_51 ) ;
V_62 -> V_74 = V_105 -> V_74 ;
V_62 -> V_77 = ( 1 << V_62 -> V_74 ) ;
V_62 -> V_75 = V_62 -> V_77 - 1 ;
if ( F_38 ( V_21 ) ) {
goto V_142;
}
V_76 = ( V_62 -> V_112 << V_62 -> V_74 ) - 1 ;
( ( V_144 * ) V_89 ) [ 0 ] = F_51 ( V_76 ) ;
( ( V_144 * ) V_89 ) [ 1 ] = F_51 ( V_62 -> V_78 ) ;
F_49 ( V_89 , 8 , V_83 ) ;
return V_139 ;
}
if ( V_83 -> V_137 [ 0 ] == V_145 ) {
int V_146 = ( V_83 -> V_137 [ 2 ] & 0x3F ) ;
if ( V_146 == 0x01 || V_146 == 0x3F ) {
F_16 ( L_68
L_69 , V_146 ) ;
memcpy ( V_89 , V_136 , sizeof( V_136 ) ) ;
( ( V_147 * ) V_89 ) [ 0 ] = F_52 ( sizeof( V_136 ) - 2 ) ;
V_89 [ 3 ] = ( V_62 -> V_103 & V_104 ) ? 0x80 : 0 ;
F_49 ( V_89 , sizeof( V_136 ) , V_83 ) ;
return V_139 ;
}
V_132 = 0x05 ;
V_133 = 0x24 ;
...
if ( V_83 -> V_137 [ 0 ] == V_148 )
return V_139 ;
V_134 = 0 ;
if ( V_83 -> V_137 [ 0 ] == V_149 ) {
V_68 = F_40 ( V_83 -> V_137 [ 3 ] , V_83 -> V_137 [ 2 ] ) ;
V_68 <<= 16 ;
V_68 |= F_40 ( V_83 -> V_137 [ 5 ] , V_83 -> V_137 [ 4 ] ) ;
V_69 = F_40 ( V_83 -> V_137 [ 8 ] , V_83 -> V_137 [ 7 ] ) ;
F_16 ( L_70 ,
V_68 , V_69 ) ;
...
for (; V_83 -> V_152 < 12 ; V_83 -> V_152 ++ )
V_83 -> V_137 [ V_83 -> V_152 ] = 0 ;
V_83 -> V_137 [ 1 ] = V_43 ;
V_89 [ 0 ] = 0 ;
for ( V_8 = 0 ; V_8 < 12 ; V_8 ++ )
sprintf ( V_89 + strlen ( V_89 ) , L_72 , V_83 -> V_137 [ V_8 ] ) ;
F_16 ( L_73 , V_89 ) ;
V_42 = F_10 ( V_21 , V_83 -> V_137 , 12 ) ;
if ( V_42 ) {
F_16 ( L_74
L_75 , V_42 ) ;
return V_131 ;
...
if ( V_83 -> V_153 == V_154 ||
V_83 -> V_153 == V_155 ) {
unsigned int V_26 = ( V_83 -> V_153 == V_154 )
? V_21 -> V_57 : V_21 -> V_44 ;
F_16 ( L_76 ,
( V_83 -> V_153 == V_154 ) ?
L_77 : L_78 ,
F_53 ( V_83 ) ) ;
V_42 = F_54 ( V_21 , V_26 , V_83 ) ;
return ( V_42 == V_32 ?
V_139 : V_131 ) ;
}
return V_139 ;
...
static int F_56 ( struct V_156 * V_157 ,
const struct V_158 * V_7 )
{
struct V_20 * V_21 ;
int V_42 ;
V_42 = F_57 ( & V_21 , V_157 , V_7 ,
( V_7 - V_159 ) + V_160 ) ;
if ( V_42 )
return V_42 ;
if ( V_21 -> V_161 == V_162 ) {
