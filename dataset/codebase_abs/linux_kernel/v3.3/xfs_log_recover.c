...
error = F_24 ( log , V_105 , V_112 , V_5 ) ;
if ( error )
break;
V_105 += V_112 ;
V_44 = 0 ;
...
V_135 = F_83 ( V_136 , V_134 + V_137 , V_137 , V_126 ) ;
...
( F_108 ( V_5 ) != F_126 ( log -> V_6 -> V_22 . V_233 ,
( V_234 ) F_127 ( log -> V_6 ) ) ) ) {
F_128 ( V_5 ) ;
error = F_28 ( V_5 ) ;
} else {
...
V_241 = 1 ;
error = F_131 ( & V_131 -> V_141 [ 0 ] , V_145 ) ;
if ( error )
goto error;
}
...
} else if ( F_35 ( F_137 ( V_240 -> V_251 ) ) ) {
if ( ( V_240 -> V_252 != V_253 ) &&
( V_240 -> V_252 != V_254 ) &&
( V_240 -> V_252 != V_255 ) ) {
F_136 ( L_47 ,
...
F_138 ( V_235 , V_131 -> V_141 [ 1 ] . V_143 ) ;
...
case V_270 :
case V_271 :
memcpy ( F_140 ( V_235 ) , V_236 , V_134 ) ;
break;
case V_272 :
F_141 ( V_20 , (struct V_273 * ) V_236 , V_134 ,
( V_274 * ) F_140 ( V_235 ) ,
F_142 ( V_235 , V_20 ) ) ;
break;
default:
...
case V_277 :
V_237 = F_143 ( V_235 ) ;
ASSERT ( V_134 <= F_144 ( V_235 , V_20 ) ) ;
memcpy ( V_237 , V_236 , V_134 ) ;
break;
case V_278 :
V_237 = F_143 ( V_235 ) ;
F_141 ( V_20 , (struct V_273 * ) V_236 ,
V_134 , ( V_274 * ) V_237 ,
F_144 ( V_235 , V_20 ) ) ;
break;
default:
...
error = F_147 ( V_20 , V_20 -> V_230 ,
V_286 -> V_289 ,
F_148 ( V_20 , V_286 -> V_288 ) ,
0 , & V_5 ) ;
if ( error ) {
F_20 ( V_5 , L_60 ) ;
return error ;
...
V_292 = F_150 ( V_20 , V_293 -> V_294 ) ;
if ( ( error = F_151 ( & ( V_131 -> V_141 [ 0 ] ) ,
& ( V_292 -> V_295 ) ) ) ) {
F_152 ( V_292 ) ;
return error ;
}
F_153 ( & V_292 -> V_296 , V_293 -> V_294 ) ;
F_154 ( & log -> V_297 -> V_298 ) ;
F_155 ( log -> V_297 , & V_292 -> V_299 , V_125 ) ;
return 0 ;
}
STATIC int
F_156 (
...
T_12 * V_131 )
{
F_164 ( log , V_121 , V_131 , V_315 ) ;
switch ( F_92 ( V_131 ) ) {
case V_154 :
return F_97 ( log , V_131 ) ;
case V_159 :
return F_145 ( log , V_131 ) ;
case V_157 :
case V_161 :
case V_160 :
case V_158 :
...
T_12 * V_131 )
{
F_164 ( log , V_121 , V_131 , V_316 ) ;
switch ( F_92 ( V_131 ) ) {
case V_154 :
return F_122 ( log , V_131 ) ;
case V_157 :
return F_130 ( log , V_131 ) ;
case V_161 :
return F_149 ( log , V_131 , V_121 -> V_127 ) ;
case V_160 :
return F_156 ( log , V_131 ) ;
case V_158 :
...
if ( V_151 == V_315 )
error = F_163 ( log , V_121 , V_131 ) ;
else
error = F_165 ( log , V_121 , V_131 ) ;
if ( error )
return error ;
}
F_162 ( V_121 ) ;
...
T_29 * V_334 ;
T_30 V_335 ;
ASSERT ( ! F_173 ( V_336 , & V_292 -> V_337 ) ) ;
for ( V_43 = 0 ; V_43 < V_292 -> V_295 . V_294 ; V_43 ++ ) {
V_334 = & ( V_292 -> V_295 . V_338 [ V_43 ] ) ;
V_335 = F_174 ( V_20 ,
F_175 ( V_20 , V_334 -> V_339 ) ) ;
if ( ( V_335 == 0 ) ||
( V_334 -> V_340 == 0 ) ||
( V_335 >= V_20 -> V_22 . V_341 ) ||
( V_334 -> V_340 >= V_20 -> V_22 . V_342 ) ) {
F_176 ( V_292 , V_292 -> V_295 . V_294 ) ;
return F_36 ( V_56 ) ;
}
}
V_333 = F_177 ( V_20 , 0 ) ;
error = F_178 ( V_333 , 0 , F_179 ( V_20 ) , 0 , 0 , 0 ) ;
if ( error )
goto V_343;
V_332 = F_180 ( V_333 , V_292 , V_292 -> V_295 . V_294 ) ;
for ( V_43 = 0 ; V_43 < V_292 -> V_295 . V_294 ; V_43 ++ ) {
V_334 = & ( V_292 -> V_295 . V_338 [ V_43 ] ) ;
error = F_181 ( V_333 , V_334 -> V_339 , V_334 -> V_340 ) ;
if ( error )
goto V_343;
F_182 ( V_333 , V_332 , V_334 -> V_339 ,
V_334 -> V_340 ) ;
}
F_183 ( V_336 , & V_292 -> V_337 ) ;
error = F_184 ( V_333 , 0 ) ;
return error ;
V_343:
F_185 ( V_333 , V_344 ) ;
...
if ( V_301 -> V_313 != V_161 ) {
#ifdef F_187
for (; V_301 ; V_301 = F_159 ( V_306 , & V_304 ) )
ASSERT ( V_301 -> V_313 != V_161 ) ;
#endif
break;
}
V_292 = ( T_22 * ) V_301 ;
if ( F_173 ( V_336 , & V_292 -> V_337 ) ) {
V_301 = F_159 ( V_306 , & V_304 ) ;
continue;
}
F_161 ( & V_306 -> V_298 ) ;
error = F_172 ( log -> V_6 , V_292 ) ;
F_154 ( & V_306 -> V_298 ) ;
if ( error )
goto V_49;
V_301 = F_159 ( V_306 , & V_304 ) ;
...
int V_12 ;
int error ;
V_333 = F_177 ( V_20 , V_348 ) ;
error = F_178 ( V_333 , 0 , F_189 ( V_20 ) ,
0 , 0 , 0 ) ;
if ( error )
goto V_349;
error = F_190 ( V_20 , V_333 , V_345 , & V_347 ) ;
if ( error )
goto V_349;
V_346 = F_191 ( V_347 ) ;
...
T_33 V_358 ;
int error ;
V_358 = F_194 ( V_20 , V_345 , V_353 ) ;
error = F_195 ( V_20 , NULL , V_358 , 0 , 0 , & V_357 ) ;
if ( error )
goto V_359;
error = F_196 ( V_20 , NULL , V_357 , & V_235 , & V_354 , V_227 ) ;
if ( error )
goto V_360;
...
error = F_190 ( V_20 , NULL , V_345 , & V_347 ) ;
if ( error ) {
continue;
}
V_346 = F_191 ( V_347 ) ;
...
V_79 V_378 ;
T_3 V_133 ;
F_199 ( log , V_368 , V_369 ) ;
V_378 = F_201 ( V_368 -> V_373 . V_87 ) ;
V_133 = V_368 -> V_372 ;
...
if ( ! V_388 )
return V_47 ;
error = F_21 ( log , V_70 , 1 , V_388 , & V_12 ) ;
if ( error )
goto V_395;
V_71 = ( T_6 * ) V_12 ;
error = F_203 ( log , V_71 , V_70 ) ;
if ( error )
goto V_395;
V_57 = F_32 ( V_71 -> V_57 ) ;
...
error = F_21 ( log , V_11 , V_77 , V_388 , & V_12 ) ;
if ( error )
goto V_397;
V_71 = ( T_6 * ) V_12 ;
error = F_203 ( log , V_71 , V_11 ) ;
if ( error )
goto V_397;
V_390 = ( int ) F_51 ( F_32 ( V_71 -> V_59 ) ) ;
error = F_21 ( log , V_11 + V_77 , V_390 , V_389 ,
& V_12 ) ;
if ( error )
goto V_397;
F_202 ( V_71 , V_12 , log ) ;
...
error = F_21 ( log , V_11 , V_77 , V_388 ,
& V_12 ) ;
if ( error )
goto V_397;
} else {
...
error = F_21 ( log , V_11 , V_390 , V_389 ,
& V_12 ) ;
if ( error )
goto V_397;
} else {
...
V_411 = 0LL ;
for ( V_345 = 0 ; V_345 < V_20 -> V_22 . V_366 ; V_345 ++ ) {
error = F_224 ( V_20 , NULL , V_345 , 0 , & V_408 ) ;
if ( error ) {
F_112 ( V_20 , L_79 ,
V_7 , V_345 , error ) ;
} else {
...
struct V_414 * V_346 = F_191 ( V_347 ) ;
