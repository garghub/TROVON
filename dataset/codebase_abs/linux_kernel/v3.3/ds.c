...
F_7 ( & V_36 -> V_32 . V_33 ) ;
F_14 (dynid, n, &drv->dynids.list, node) {
F_15 ( & V_19 -> V_34 ) ;
F_16 ( V_19 ) ;
}
F_9 ( & V_36 -> V_32 . V_33 ) ;
...
V_55 -> V_74 = 1 ;
F_9 ( & V_55 -> V_72 ) ;
F_14 (p_dev, tmp, &s->devices_list, socket_device_list) {
if ( V_43 == V_76 )
continue;
F_7 ( & V_55 -> V_72 ) ;
F_15 ( & V_43 -> V_79 ) ;
...
static int T_14 F_103 ( struct V_44 * V_46 ,
struct V_167 * V_168 )
{
