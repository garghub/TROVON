...
F_12 ( V_2 ) ;
for ( V_50 = 0 ; V_50 < V_48 -> V_58 ; V_50 ++ ) {
for ( V_51 = 0 ; V_51 < F_38 ( V_59 ) ; V_51 ++ ) {
if ( ( V_48 -> V_60 [ V_50 ] . V_46 == V_59 [ V_51 ] . V_46 ) &&
! strcmp ( V_48 -> V_60 [ V_50 ] . V_61 ,
V_59 [ V_51 ] . V_61 ) ) {
V_59 [ V_51 ] . V_49 =
V_48 -> V_60 [ V_50 ] . V_49 ;
break;
...
static int F_41 ( struct V_44 * V_13 )
{
...
static int F_44 ( struct V_63 * V_7 )
{
struct V_44 * V_13 = F_45 ( V_7 ) ;
struct V_1 * V_2 = F_42 ( V_13 ) ;
F_14 ( V_2 ) ;
return 0 ;
}
static int F_46 ( struct V_63 * V_7 )
{
struct V_44 * V_13 = F_45 ( V_7 ) ;
struct V_1 * V_2 = F_42 ( V_13 ) ;
