...
static void F_112 ( struct V_101 * V_102 ,
struct V_6 * V_7 )
{
struct V_135 * V_136 = V_102 -> V_137 ;
struct V_144 * V_145 = V_7 -> V_146 . V_147 ;
...
static int F_113 ( struct V_101 * V_102 )
{
struct V_135 * V_136 ;
...
F_13 ( ! F_114 ( ( long ) V_136 -> V_149 , V_150 ) ) ;
...
static T_7 F_116 ( struct V_101 * V_102 ,
unsigned long V_28 )
{
struct V_135 * V_136 = V_102 -> V_137 ;
struct V_8 * V_138 = V_136 -> V_139 ;
...
if ( V_153 ) {
if ( F_117 ( * V_153 ) )
V_141 = F_118 ( * V_153 , V_28 , V_154 ) ;
else if ( F_119 ( * V_153 ) )
V_141 = F_118 ( * V_153 , V_28 , V_83 ) ;
else
F_62 ( V_7 , L_27 , * V_153 , V_28 ) ;
} else {
if ( F_120 ( * V_152 ) )
V_141 = F_118 ( * V_152 , V_28 , V_75 ) ;
else if ( F_121 ( * V_152 ) )
V_141 = F_118 ( * V_152 , V_28 , V_78 ) ;
else
...
T_3 V_158 = 1 << 10 ;
V_58 = F_124 ( L_29 , V_134 , V_158 , V_142 ,
F_105 ) ;
if ( ! V_58 )
return - V_71 ;
V_67 = V_58 ;
