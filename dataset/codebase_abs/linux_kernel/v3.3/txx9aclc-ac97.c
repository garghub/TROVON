...
static int T_4 F_18 ( struct V_34 * V_35 )
{
struct V_1 * V_2 ;
struct V_36 * V_37 ;
int V_38 ;
...
if ( ! V_37 )
return - V_40 ;
if ( ! F_21 ( & V_35 -> V_27 , V_37 -> V_41 , F_22 ( V_37 ) ,
F_23 ( & V_35 -> V_27 ) ) )
return - V_40 ;
V_2 = F_24 ( & V_35 -> V_27 , sizeof( * V_2 ) , V_42 ) ;
if ( ! V_2 )
return - V_43 ;
F_25 ( V_35 , V_2 ) ;
V_2 -> V_44 = V_37 -> V_41 ;
if ( sizeof( V_2 -> V_44 ) > sizeof( V_37 -> V_41 ) &&
V_37 -> V_41 >= V_45 &&
V_37 -> V_41 < V_45 + 0x400000 )
V_2 -> V_44 |= 0xf00000000ull ;
V_2 -> V_3 = F_26 ( & V_35 -> V_27 , V_37 -> V_41 , F_22 ( V_37 ) ) ;
if ( ! V_2 -> V_3 )
return - V_40 ;
V_38 = F_27 ( & V_35 -> V_27 , V_28 , F_13 ,
0 , F_23 ( & V_35 -> V_27 ) , V_2 ) ;
if ( V_38 < 0 )
return V_38 ;
return F_28 ( & V_35 -> V_27 , & V_46 ) ;
}
static int T_5 F_29 ( struct V_34 * V_35 )
{
F_30 ( & V_35 -> V_27 ) ;
return 0 ;
}
