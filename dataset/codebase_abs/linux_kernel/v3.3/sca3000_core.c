...
int V_78 = F_33 ( V_76 ) ;
F_16 ( & V_2 -> V_30 ) ;
V_16 = F_12 ( V_2 , V_57 [ V_78 ] [ 1 ] ) ;
F_18 ( & V_2 -> V_30 ) ;
if ( V_16 < 0 )
return V_16 ;
* V_4 = 0 ;
if ( V_78 == 1 )
F_34 ( V_77 , ( unsigned long * ) & V_16 ,
F_35 ( V_2 -> V_39 -> V_79 ) )
...
F_16 ( & V_2 -> V_30 ) ;
V_16 = F_11 ( V_2 , V_57 [ V_78 ] [ 1 ] , V_81 ) ;
F_18 ( & V_2 -> V_30 ) ;
return V_16 ;
}
static T_6 F_37 ( int V_82 , void * V_83 )
{
...
goto V_104;
V_2 -> V_55 ++ ;
} else if ( ! V_103 && ( V_71 & V_57 [ V_78 ] [ 2 ] ) ) {
V_16 = F_11 ( V_2 ,
V_101 ,
V_71 &
~ ( V_57 [ V_78 ] [ 2 ] ) ) ;
...
static int T_8 F_47 ( struct V_115 * V_116 )
{
int V_16 ;
struct V_1 * V_2 ;
struct V_28 * V_29 ;
...
V_2 -> V_6 = V_116 ;
F_50 ( & V_2 -> V_30 ) ;
V_2 -> V_39 = & V_118 [ F_51 ( V_116 )
-> V_119 ] ;
V_29 -> V_27 . V_120 = & V_116 -> V_27 ;
V_29 -> V_121 = F_51 ( V_116 ) -> V_121 ;
if ( V_2 -> V_39 -> V_122 )
V_29 -> V_39 = & V_123 ;
else {
V_29 -> V_39 = & V_124 ;
V_29 -> V_125 = V_126 ;
V_29 -> V_127 = F_35 ( V_126 ) ;
}
V_29 -> V_128 = V_129 ;
F_52 ( V_29 ) ;
V_16 = F_53 ( V_29 ) ;
...
goto V_131;
if ( V_29 -> V_87 ) {
F_55 ( V_29 , V_29 -> V_87 , 0 ) ;
F_55 ( V_29 , V_29 -> V_87 , 1 ) ;
F_55 ( V_29 , V_29 -> V_87 , 2 ) ;
}
if ( V_116 -> V_82 ) {
V_16 = F_56 ( V_116 -> V_82 ,
NULL ,
& F_37 ,
V_132 ,
L_16 ,
