...
V_73 -> V_80 = 10 ;
V_73 -> V_81 = 20 * V_82 ;
V_71 = (struct V_70 * ) V_73 -> V_32 ;
memset ( V_71 , 0 , sizeof( struct V_70 ) ) ;
V_71 -> V_83 = V_84 ;
V_71 -> V_85 = 0x0e ;
V_74 = V_73 -> V_29 ;
V_74 -> V_86 = V_87 ;
V_74 -> V_88 = sizeof( struct V_70 ) ;
V_74 -> V_35 |= V_89 ;
V_74 -> V_90 = ( V_91 ) ( V_92 ) V_71 ;
memset ( V_11 -> V_24 , 0 , sizeof( * ( V_11 -> V_24 ) ) ) ;
V_74 ++ ;
V_74 -> V_86 = V_93 ;
V_74 -> V_88 = sizeof( * ( V_11 -> V_24 ) ) ;
V_74 -> V_90 = ( V_91 ) ( V_92 ) V_11 -> V_24 ;
V_73 -> V_94 = F_41 () ;
V_73 -> V_95 = V_96 ;
F_20 ( & V_11 -> V_46 , V_35 ) ;
V_11 -> V_35 &= ~ V_36 ;
...
static int F_44 ( struct V_48 * V_97 , struct V_7 * V_11 )
{
unsigned long V_35 ;
struct V_10 * V_68 , * V_98 ;
struct V_48 * V_49 , * V_99 ;
int V_100 , V_75 ;
struct V_50 * V_51 ;
F_20 ( & V_11 -> V_46 , V_35 ) ;
F_45 (pavgroup, tempgroup, &lcu->grouplist, group) {
F_45 (device, tempdev, &pavgroup->baselist,
alias_list) {
F_36 ( & V_49 -> V_58 , & V_11 -> V_39 ) ;
V_51 = (struct V_50 * ) V_49 -> V_51 ;
V_51 -> V_68 = NULL ;
}
F_45 (device, tempdev, &pavgroup->aliaslist,
alias_list) {
F_36 ( & V_49 -> V_58 , & V_11 -> V_39 ) ;
V_51 = (struct V_50 * ) V_49 -> V_51 ;
V_51 -> V_68 = NULL ;
...
if ( V_75 )
return V_75 ;
F_34 ( F_35 ( V_97 -> V_60 ) , V_35 ,
V_101 ) ;
F_25 ( & V_11 -> V_46 ) ;
V_11 -> V_13 = V_34 ;
for ( V_100 = 0 ; V_100 < V_102 ; ++ V_100 ) {
switch ( V_11 -> V_24 -> V_62 [ V_100 ] . V_63 ) {
case V_103 :
V_11 -> V_13 = V_104 ;
break;
case V_105 :
...
F_45 (device, tempdev, &lcu->active_devices,
alias_list) {
F_33 ( V_11 , V_49 , V_97 ) ;
}
F_26 ( & V_11 -> V_46 ) ;
F_21 ( F_35 ( V_97 -> V_60 ) , V_35 ) ;
return 0 ;
}
static void V_45 ( struct V_106 * V_107 )
{
struct V_7 * V_11 ;
struct V_108 * V_43 ;
struct V_48 * V_49 ;
unsigned long V_35 ;
int V_75 ;
V_43 = F_46 ( V_107 , struct V_108 , V_44 . V_107 ) ;
V_11 = F_46 ( V_43 , struct V_7 , V_43 ) ;
V_49 = V_43 -> V_49 ;
V_75 = F_44 ( V_49 , V_11 ) ;
F_20 ( & V_11 -> V_46 , V_35 ) ;
if ( V_75 || ( V_11 -> V_35 & V_36 ) ) {
F_47 ( V_109 , V_49 , L_1
L_2 , V_75 ) ;
F_48 ( & V_11 -> V_43 . V_44 , 30 * V_82 ) ;
} else {
V_11 -> V_43 . V_49 = NULL ;
V_11 -> V_35 &= ~ V_37 ;
}
...
if ( ! V_110 && ! F_5 ( & V_11 -> V_39 ) ) {
V_110 = F_6 ( & V_11 -> V_39 ,
struct V_48 , V_58 ) ;
}
if ( ! V_110 )
return - V_111 ;
V_11 -> V_43 . V_49 = V_110 ;
F_48 ( & V_11 -> V_43 . V_44 , 0 ) ;
return 0 ;
}
...
struct V_48 * F_52 ( struct V_48 * V_112 )
{
struct V_48 * V_113 ;
struct V_10 * V_16 ;
struct V_7 * V_11 ;
...
V_11 -> V_35 & ( V_36 | V_37 ) )
return NULL ;
if ( F_53 ( ! ( V_51 -> V_115 . V_116 [ 8 ] & 0x01 ) ) ) {
F_47 ( V_117 , V_112 , L_3 ,
L_4 ) ;
return NULL ;
}
F_20 ( & V_11 -> V_46 , V_35 ) ;
...
if ( F_54 ( & V_113 -> V_58 , & V_16 -> V_67 ) )
V_16 -> V_69 = F_6 ( & V_16 -> V_67 ,
struct V_48 , V_58 ) ;
else
V_16 -> V_69 = F_6 ( & V_113 -> V_58 ,
struct V_48 , V_58 ) ;
F_21 ( & V_11 -> V_46 , V_35 ) ;
V_114 = (struct V_50 * ) V_113 -> V_51 ;
if ( ( V_114 -> V_88 < V_51 -> V_88 ) && ! V_113 -> V_118 )
return V_113 ;
else
return NULL ;
}
static int F_55 ( struct V_7 * V_11 ,
struct V_48 * V_49 ,
char V_119 )
{
struct V_72 * V_73 ;
...
struct V_30 * V_74 ;
V_73 = V_11 -> V_27 ;
strncpy ( ( char * ) & V_73 -> V_120 , L_5 , 4 ) ;
F_56 ( ( char * ) & V_73 -> V_120 , 4 ) ;
V_74 = V_73 -> V_29 ;
V_74 -> V_86 = V_121 ;
V_74 -> V_35 = 0 ;
V_74 -> V_88 = 16 ;
V_74 -> V_90 = ( V_91 ) ( V_92 ) V_73 -> V_32 ;
( ( char * ) V_73 -> V_32 ) [ 0 ] = V_119 ;
F_40 ( V_79 , & V_73 -> V_35 ) ;
V_73 -> V_80 = 255 ;
V_73 -> V_77 = V_49 ;
V_73 -> V_78 = V_49 ;
...
{
struct V_10 * V_68 ;
struct V_48 * V_49 , * V_123 ;
struct V_50 * V_51 ;
int V_75 ;
unsigned long V_35 ;
F_62 ( V_124 ) ;
F_20 ( & V_11 -> V_46 , V_35 ) ;
F_45 (device, temp, &lcu->active_devices,
alias_list) {
V_51 = (struct V_50 * ) V_49 -> V_51 ;
if ( V_51 -> V_3 . type == V_17 )
continue;
F_36 ( & V_49 -> V_58 , & V_124 ) ;
}
F_2 (pavgroup, &lcu->grouplist, group) {
F_63 ( & V_68 -> V_67 , & V_124 ) ;
}
while ( ! F_5 ( & V_124 ) ) {
V_49 = F_6 ( & V_124 , struct V_48 ,
V_58 ) ;
F_21 ( & V_11 -> V_46 , V_35 ) ;
V_75 = F_64 ( V_49 ) ;
F_20 ( & V_11 -> V_46 , V_35 ) ;
...
static void F_67 ( struct V_7 * V_11 ,
struct V_48 * V_49 )
{
struct V_10 * V_68 ;
struct V_48 * V_4 ;
...
static void F_68 ( struct V_7 * V_11 )
{
struct V_10 * V_68 ;
struct V_48 * V_49 ;
unsigned long V_35 ;
...
static void V_42 ( struct V_106 * V_107 )
{
struct V_7 * V_11 ;
struct V_126 * V_40 ;
unsigned long V_35 ;
struct V_48 * V_49 ;
V_40 = F_46 ( V_107 , struct V_126 ,
V_41 ) ;
V_11 = F_46 ( V_40 , struct V_7 , V_40 ) ;
V_49 = V_40 -> V_49 ;
F_61 ( V_11 ) ;
F_20 ( F_35 ( V_49 -> V_60 ) , V_35 ) ;
F_69 ( V_49 ,
