...
static int F_32 ( struct V_16 * V_17 , struct V_54 * V_55 ,
struct V_62 * * V_63 )
{
int V_4 ;
const char * V_79 ;
...
V_79 = V_3 -> V_15 ;
V_6 = F_33 ( V_79 , V_3 -> V_10 , V_3 -> V_11 ) ;
if ( F_34 ( V_6 ) )
return F_35 ( V_6 ) ;
F_25 ( & V_7 ) ;
if ( V_75 )
...
static int F_37 ( struct V_16 * V_17 , struct V_54 * V_55 )
{
struct V_62 * V_63 [ V_81 + 1 ] ;
struct V_82 * V_83 ;
int type , V_56 ;
type = V_55 -> V_84 ;
if ( type > V_85 )
...
if ( V_83 -> V_91 == NULL )
return - V_64 ;
return F_39 ( V_69 , V_17 , V_55 ,
V_83 -> V_91 , V_83 -> V_92 , 0 ) ;
}
V_56 = F_40 ( V_55 , V_93 [ type ] , V_63 , V_81 ,
V_94 ) ;
if ( V_56 < 0 )
return V_56 ;
if ( V_83 -> V_95 == NULL )
return - V_64 ;
return V_83 -> V_95 ( V_17 , V_55 , V_63 ) ;
}
