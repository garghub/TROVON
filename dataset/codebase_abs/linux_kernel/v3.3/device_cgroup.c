...
struct V_5 * V_11 , struct V_12 * V_13 )
{
struct V_7 * V_8 = F_7 ( V_13 ) ;
if ( V_14 != V_8 && ! F_8 ( V_15 ) )
return - V_16 ;
return 0 ;
}
static int F_9 ( struct V_17 * V_18 , struct V_17 * V_19 )
{
struct V_20 * V_21 , * V_22 , * V_23 ;
F_10 (wh, orig, list) {
V_23 = F_11 ( V_21 , sizeof( * V_21 ) , V_24 ) ;
if ( ! V_23 )
goto V_25;
F_12 ( & V_23 -> V_26 , V_18 ) ;
}
...
struct V_20 * V_21 )
{
struct V_20 * V_28 , * V_29 ;
V_28 = F_11 ( V_21 , sizeof( * V_21 ) , V_24 ) ;
if ( ! V_28 )
return - V_27 ;
F_10 (walk, &dev_cgroup->whitelist, list) {
if ( V_29 -> type != V_21 -> type )
continue;
if ( V_29 -> V_30 != V_21 -> V_30 )
continue;
if ( V_29 -> V_31 != V_21 -> V_31 )
continue;
V_29 -> V_32 |= V_21 -> V_32 ;
F_15 ( V_28 ) ;
V_28 = NULL ;
...
if ( V_28 != NULL )
F_17 ( & V_28 -> V_26 , & V_1 -> V_33 ) ;
return 0 ;
}
static void F_18 ( struct V_1 * V_1 ,
struct V_20 * V_21 )
{
struct V_20 * V_29 , * V_22 ;
F_13 (walk, tmp, &dev_cgroup->whitelist, list) {
if ( V_29 -> type == V_34 )
goto remove;
if ( V_29 -> type != V_21 -> type )
continue;
if ( V_29 -> V_30 != ~ 0 && V_29 -> V_30 != V_21 -> V_30 )
continue;
if ( V_29 -> V_31 != ~ 0 && V_29 -> V_31 != V_21 -> V_31 )
continue;
remove:
V_29 -> V_32 &= ~ V_21 -> V_32 ;
if ( ! V_29 -> V_32 ) {
...
if ( V_37 == NULL ) {
struct V_20 * V_21 ;
V_21 = F_25 ( sizeof( * V_21 ) , V_24 ) ;
if ( ! V_21 ) {
F_15 ( V_1 ) ;
return F_23 ( - V_27 ) ;
}
V_21 -> V_31 = V_21 -> V_30 = ~ 0 ;
V_21 -> type = V_34 ;
V_21 -> V_32 = V_40 ;
F_26 ( & V_21 -> V_26 , & V_1 -> V_33 ) ;
} else {
V_36 = F_3 ( V_37 ) ;
F_27 ( & V_41 ) ;
V_38 = F_9 ( & V_1 -> V_33 ,
...
static void F_30 ( char * V_42 , short V_32 )
{
int V_43 = 0 ;
memset ( V_42 , 0 , V_44 ) ;
if ( V_32 & V_45 )
...
continue;
if ( V_61 -> V_30 != ~ 0 && V_61 -> V_30 != V_60 -> V_30 )
continue;
if ( V_61 -> V_31 != ~ 0 && V_61 -> V_31 != V_60 -> V_31 )
continue;
if ( V_60 -> V_32 & ( ~ V_61 -> V_32 ) )
continue;
return 1 ;
}
return 0 ;
...
if ( V_21 -> type & V_34 )
goto V_79;
if ( ( V_21 -> type & V_49 ) && ! F_47 ( V_77 -> V_80 ) )
continue;
if ( ( V_21 -> type & V_48 ) && ! F_48 ( V_77 -> V_80 ) )
continue;
if ( V_21 -> V_30 != ~ 0 && V_21 -> V_30 != F_49 ( V_77 ) )
continue;
if ( V_21 -> V_31 != ~ 0 && V_21 -> V_31 != F_50 ( V_77 ) )
continue;
if ( ( V_78 & V_81 ) && ! ( V_21 -> V_32 & V_46 ) )
continue;
if ( ( V_78 & V_82 ) && ! ( V_21 -> V_32 & V_45 ) )
continue;
V_79:
F_37 () ;
return 0 ;
...
if ( V_21 -> type & V_34 )
goto V_79;
if ( ( V_21 -> type & V_49 ) && ! F_47 ( V_83 ) )
continue;
if ( ( V_21 -> type & V_48 ) && ! F_48 ( V_83 ) )
continue;
if ( V_21 -> V_30 != ~ 0 && V_21 -> V_30 != F_52 ( V_84 ) )
continue;
if ( V_21 -> V_31 != ~ 0 && V_21 -> V_31 != F_53 ( V_84 ) )
continue;
if ( ! ( V_21 -> V_32 & V_47 ) )
continue;
V_79:
