...
if ( V_11 ) {
if ( F_22 ( V_2 , V_11 ) )
V_2 -> V_23 . V_60 -> V_90 . V_105 ++ ;
else
V_2 -> V_23 . V_60 -> V_90 . V_106 += V_11 -> V_74 ;
F_8 ( V_11 ) ;
}
}
return 0 ;
...
V_2 -> V_3 = F_62 ( sizeof( * V_2 -> V_3 ) , V_121 ) ;
if ( ! V_2 -> V_3 ) {
F_11 ( L_40 ) ;
goto V_123;
}
...
F_63 ( & V_2 -> V_103 ) ;
F_28 ( & V_2 -> V_8 . V_9 ) ;
V_2 -> V_8 . V_119 = F_64 ( F_43 ,
& V_2 -> V_8 , L_42 ) ;
V_2 -> V_23 . V_120 = V_120 ;
V_2 -> V_23 . V_101 = true ;
return V_2 ;
V_123:
F_31 ( V_2 ) ;
