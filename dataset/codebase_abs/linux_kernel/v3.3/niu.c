...
static int F_432 ( struct V_308 * V_11 , struct V_1149 * V_1150 , int V_1151 )
{
return - V_1152 ;
}
...
T_1 V_458 = V_485 -> V_375 ;
V_458 = V_458 >> V_514 ;
V_493 -> V_513 [ V_1154 ++ ] = F_187 ( V_458 ) ;
V_485 = V_562 ;
}
}
...
static void F_438 ( struct V_1155 * V_1156 )
{
struct V_3 * V_4 = F_236 ( V_1156 , struct V_3 , V_1123 ) ;
unsigned long V_87 ;
int V_10 ;
F_63 ( & V_4 -> V_155 , V_87 ) ;
if ( ! F_419 ( V_4 -> V_11 ) ) {
...
static T_1 F_443 ( struct V_483 * V_484 , struct V_1163 * V_1164 ,
...
switch ( V_484 -> V_560 ) {
case F_445 ( V_1176 ) :
V_1171 = F_446 ( V_484 ) -> V_560 ;
V_1170 = F_446 ( V_484 ) -> V_1170 ;
break;
case F_445 ( V_1177 ) :
V_1171 = F_447 ( V_484 ) -> V_1178 ;
V_1170 = ( 40 >> 2 ) ;
V_428 = 1 ;
break;
default:
...
V_341 = (struct V_567 * ) F_459 ( V_484 , V_1198 ) ;
V_490 = V_484 -> V_490 - sizeof( struct V_567 ) ;
V_341 -> V_87 = F_442 ( F_443 ( V_484 , V_1164 , V_1197 , V_490 ) ) ;
V_341 -> V_1206 = 0 ;
V_490 = F_208 ( V_484 ) ;
...
if ( V_1210 > V_579 )
V_1210 = V_579 ;
F_441 ( V_493 , V_798 , V_502 , V_1210 , V_1201 , V_1199 ) ;
V_1201 = V_1199 = 0 ;
...
V_490 = F_211 ( V_1211 ) ;
V_502 = V_4 -> V_304 -> V_507 ( V_4 -> V_508 , F_460 ( V_1211 ) ,
V_1211 -> V_1212 , V_490 ,
V_575 ) ;
...
static int F_462 ( struct V_308 * V_11 , int V_1216 )
{
struct V_3 * V_4 = F_402 ( V_11 ) ;
...
F_464 ( V_1221 -> V_1224 , V_1225 , sizeof( V_1221 -> V_1224 ) ) ;
F_464 ( V_1221 -> V_1226 , V_1227 , sizeof( V_1221 -> V_1226 ) ) ;
snprintf ( V_1221 -> V_1228 , sizeof( V_1221 -> V_1228 ) , L_124 ,
V_1223 -> V_1229 , V_1223 -> V_1230 ) ;
if ( V_4 -> V_25 -> V_339 != V_343 )
F_464 ( V_1221 -> V_1231 , F_465 ( V_4 -> V_1232 ) ,
sizeof( V_1221 -> V_1231 ) ) ;
}
static int F_466 ( struct V_308 * V_11 , struct V_1233 * V_1151 )
{
struct V_3 * V_4 = F_402 ( V_11 ) ;
struct V_38 * V_13 ;
V_13 = & V_4 -> V_39 ;
...
V_1151 -> V_174 = V_13 -> V_215 ;
V_1151 -> V_285 = V_13 -> V_201 ;
F_467 ( V_1151 , V_13 -> V_160 ) ;
...
static int F_468 ( struct V_308 * V_11 , struct V_1233 * V_1151 )
{
struct V_3 * V_4 = F_402 ( V_11 ) ;
struct V_38 * V_13 = & V_4 -> V_39 ;
V_13 -> V_174 = V_1151 -> V_174 ;
V_13 -> V_302 = F_469 ( V_1151 ) ;
V_13 -> V_301 = V_1151 -> V_301 ;
V_13 -> V_285 = V_1151 -> V_285 ;
return F_114 ( V_4 ) ;
}
...
static void F_471 ( struct V_308 * V_11 , T_3 V_1241 )
{
struct V_3 * V_4 = F_402 ( V_11 ) ;
V_4 -> V_1240 = V_1241 ;
}
...
static void F_476 ( int V_1247 , T_5 * V_1248 )
{
switch ( V_1247 ) {
case V_1249 :
case V_1250 :
...
static int F_477 ( T_1 V_421 , int * V_1247 )
{
switch ( V_421 ) {
case V_1262 :
* V_1247 = V_1249 ;
...
static int F_478 ( int V_1247 , T_1 * V_421 )
{
switch ( V_1247 ) {
case V_1249 :
* V_421 = V_1262 ;
...
static int F_480 ( T_1 V_1274 , T_1 * V_928 )
{
T_1 V_403 = 0 ;
if ( V_1274 & V_1276 )
V_403 |= V_1275 ;
...
static int F_481 ( struct V_3 * V_4 , struct V_1290 * V_1291 )
{
T_1 V_421 ;
V_1291 -> V_35 = 0 ;
if ( ! F_478 ( V_1291 -> V_1247 , & V_421 ) )
return - V_21 ;
if ( V_4 -> V_25 -> V_927 [ V_421 - V_425 ] &
V_1292 )
V_1291 -> V_35 = V_1293 ;
else
V_1291 -> V_35 = F_479 ( V_4 -> V_25 -> V_928 [ V_421 -
V_425 ] ) ;
return 0 ;
}
...
V_1295 -> V_1299 . V_1300 . V_1301 = F_483 ( V_584 ) ;
V_584 = ( V_341 -> V_403 [ 3 ] & V_1302 ) >> V_1303 ;
V_1295 -> V_1299 . V_1300 . V_1304 = F_483 ( V_584 ) ;
V_584 = ( V_341 -> V_911 [ 3 ] & V_1297 ) >> V_1298 ;
V_1295 -> V_1305 . V_1300 . V_1301 = F_483 ( V_584 ) ;
V_584 = ( V_341 -> V_911 [ 3 ] & V_1302 ) >> V_1303 ;
V_1295 -> V_1305 . V_1300 . V_1304 = F_483 ( V_584 ) ;
...
V_1310 ) >> 16 ;
V_1295 -> V_1299 . V_1300 . V_1311 = F_445 ( V_1296 ) ;
V_1296 = ( ( V_341 -> V_403 [ 2 ] & V_1309 ) >>
V_1310 ) & 0xffff ;
V_1295 -> V_1299 . V_1300 . V_1312 = F_445 ( V_1296 ) ;
V_1296 = ( ( V_341 -> V_911 [ 2 ] & V_1309 ) >>
V_1310 ) >> 16 ;
V_1295 -> V_1305 . V_1300 . V_1311 = F_445 ( V_1296 ) ;
V_1296 = ( ( V_341 -> V_911 [ 2 ] & V_1309 ) >>
V_1310 ) & 0xffff ;
V_1295 -> V_1305 . V_1300 . V_1312 = F_445 ( V_1296 ) ;
break;
case V_1256 :
case V_1259 :
V_584 = ( V_341 -> V_403 [ 2 ] & V_1309 ) >>
V_1310 ;
V_1295 -> V_1299 . V_1313 . V_1314 = F_483 ( V_584 ) ;
V_584 = ( V_341 -> V_911 [ 2 ] & V_1309 ) >>
V_1310 ;
V_1295 -> V_1305 . V_1313 . V_1314 = F_483 ( V_584 ) ;
break;
case V_1271 :
V_584 = ( V_341 -> V_403 [ 2 ] & V_1309 ) >>
V_1310 ;
V_1295 -> V_1299 . V_1315 . V_1316 = F_483 ( V_584 ) ;
V_584 = ( V_341 -> V_911 [ 2 ] & V_1309 ) >>
V_1310 ;
V_1295 -> V_1305 . V_1315 . V_1316 = F_483 ( V_584 ) ;
...
V_1325 ;
V_860 = F_477 ( V_421 , & V_1295 -> V_1247 ) ;
if ( V_860 < 0 ) {
...
case V_1334 :
V_860 = F_481 ( V_4 , V_1151 ) ;
break;
case V_1335 :
V_1151 -> V_35 = V_4 -> V_624 ;
break;
case V_1336 :
V_1151 -> V_1332 = F_174 ( V_4 ) ;
break;
case V_1337 :
V_860 = F_484 ( V_4 , V_1151 ) ;
break;
case V_1338 :
V_860 = F_486 ( V_4 , V_1151 , V_1330 ) ;
break;
default:
V_860 = - V_21 ;
break;
...
static int F_488 ( struct V_3 * V_4 , struct V_1290 * V_1291 )
{
T_1 V_421 ;
T_1 V_928 = 0 ;
unsigned long V_87 ;
...
static void F_489 ( struct V_1294 * V_1295 ,
struct V_908 * V_341 ,
...
V_1340 = F_490 ( V_1295 -> V_1299 . V_1300 . V_1301 ) ;
V_1342 = F_490 ( V_1295 -> V_1305 . V_1300 . V_1301 ) ;
V_1341 = F_490 ( V_1295 -> V_1299 . V_1300 . V_1304 ) ;
V_1343 = F_490 ( V_1295 -> V_1305 . V_1300 . V_1304 ) ;
...
case V_1251 :
case V_1253 :
V_1345 = F_444 ( V_1295 -> V_1299 . V_1300 . V_1311 ) ;
V_1347 = F_444 ( V_1295 -> V_1305 . V_1300 . V_1311 ) ;
V_1346 = F_444 ( V_1295 -> V_1299 . V_1300 . V_1312 ) ;
V_1348 = F_444 ( V_1295 -> V_1305 . V_1300 . V_1312 ) ;
V_341 -> V_403 [ 2 ] |= ( ( ( T_1 ) V_1345 << 16 ) | V_1346 ) ;
V_341 -> V_911 [ 2 ] |= ( ( ( T_1 ) V_1347 << 16 ) | V_1348 ) ;
F_476 ( V_1295 -> V_1247 , & V_1248 ) ;
break;
case V_1256 :
case V_1259 :
V_1314 = F_490 ( V_1295 -> V_1299 . V_1313 . V_1314 ) ;
V_1344 = F_490 ( V_1295 -> V_1305 . V_1313 . V_1314 ) ;
V_341 -> V_403 [ 2 ] |= V_1314 ;
V_341 -> V_911 [ 2 ] |= V_1344 ;
F_476 ( V_1295 -> V_1247 , & V_1248 ) ;
break;
case V_1271 :
V_1314 = F_490 ( V_1295 -> V_1299 . V_1315 . V_1316 ) ;
V_1344 = F_490 ( V_1295 -> V_1305 . V_1315 . V_1316 ) ;
V_341 -> V_403 [ 2 ] |= V_1314 ;
V_341 -> V_911 [ 2 ] |= V_1344 ;
...
case V_1256 :
case V_1259 :
F_489 ( V_1295 , V_341 , V_1351 , V_421 ) ;
break;
case V_1250 :
case V_1252 :
case V_1254 :
...
static int F_492 ( struct V_3 * V_4 , T_3 V_1360 )
{
struct V_24 * V_25 = V_4 -> V_25 ;
struct V_908 * V_341 ;
T_4 V_386 ;
...
static int F_493 ( struct V_308 * V_11 , struct V_1290 * V_1151 )
{
struct V_3 * V_4 = F_402 ( V_11 ) ;
int V_860 = 0 ;
switch ( V_1151 -> V_1151 ) {
case V_1361 :
V_860 = F_488 ( V_4 , V_1151 ) ;
break;
case V_1362 :
V_860 = F_491 ( V_4 , V_1151 ) ;
break;
case V_1363 :
V_860 = F_492 ( V_4 , V_1151 -> V_1322 . V_1323 ) ;
break;
default:
V_860 = - V_21 ;
break;
...
static void F_494 ( struct V_308 * V_11 , T_3 V_1364 , T_5 * V_35 )
{
struct V_3 * V_4 = F_402 ( V_11 ) ;
int V_26 ;
if ( V_1364 != V_1365 )
...
static int F_495 ( struct V_308 * V_11 , int V_1364 )
{
struct V_3 * V_4 = F_402 ( V_11 ) ;
if ( V_1364 != V_1365 )
return - V_21 ;
...
static int F_503 ( struct V_3 * V_4 , int V_1385 )
{
...
static int F_504 ( struct V_3 * V_4 , int V_29 , int V_1388 , int V_1389 )
{
if ( ( V_29 < V_1383 || V_29 > V_1384 ) ||
( V_1388 < 0 || V_1388 > 3 ) ||
( V_1389 < 0 || V_1389 > 0x1f ) )
return - V_21 ;
F_18 ( F_505 ( V_29 ) , ( V_1388 << V_1390 ) | V_1389 ) ;
return 0 ;
}
...
V_10 = F_506 ( V_4 , V_1181 + 2 ) ;
if ( V_10 < 0 )
return V_10 ;
V_490 = V_10 ;
V_1181 += 3 ;
V_1408 = F_506 ( V_4 , V_1181 + 4 ) ;
V_10 = F_509 ( V_4 , V_1181 + 5 , V_1400 , 64 ) ;
if ( V_10 < 0 )
return V_10 ;
V_1409 = NULL ;
V_1410 = 0 ;
...
F_226 ( V_4 -> V_508 , L_143 , V_1400 , V_1408 ) ;
return - V_21 ;
}
if ( V_1409 ) {
...
* V_1409 ++ = F_506 ( V_4 , V_335 + V_26 ) ;
}
V_1181 += V_490 ;
}
return 0 ;
}
static void T_12 F_519 ( struct V_3 * V_4 , T_3 V_1181 )
{
T_3 V_486 ;
int V_10 ;
V_10 = F_508 ( V_4 , V_1181 + 1 ) ;
if ( V_10 < 0 )
return;
V_486 = V_10 + 3 ;
...
T_3 V_1406 ;
V_10 = F_506 ( V_4 , V_1421 ) ;
if ( V_10 != 0x90 )
return;
V_10 = F_508 ( V_4 , V_1421 + 1 ) ;
if ( V_10 < 0 )
return;
V_1421 = V_1181 + V_486 + 3 ;
V_1406 = V_1181 + V_486 + V_10 ;
V_486 += V_10 ;
V_10 = F_511 ( V_4 , V_1421 , V_1406 ) ;
if ( V_10 < 0 || V_10 == 1 )
return;
}
}
...
while ( V_1181 < V_1406 ) {
V_860 = V_1181 ;
V_10 = F_507 ( V_4 , V_1181 + 0 ) ;
if ( V_10 != 0x55aa )
return 0 ;
V_10 = F_507 ( V_4 , V_1181 + 23 ) ;
if ( V_10 < 0 )
return 0 ;
V_1181 += V_10 ;
V_10 = F_507 ( V_4 , V_1181 + 0 ) ;
if ( V_10 != 0x5043 )
return 0 ;
V_10 = F_507 ( V_4 , V_1181 + 2 ) ;
if ( V_10 != 0x4952 )
return 0 ;
V_10 = F_506 ( V_4 , V_1181 + 20 ) ;
if ( V_10 < 0 )
return 0 ;
if ( V_10 != 0x01 ) {
...
V_4 -> V_87 |= ( V_88 | V_344 |
V_134 ) ;
} else if ( F_521 ( V_4 , V_4 -> V_1223 . V_1418 ) ) {
...
static int T_12 F_529 ( struct V_276 * V_498 , int * V_1471 )
{
int V_30 , V_1331 ;
V_1331 = 0 ;
* V_1471 = 32 ;
...
static int T_12 F_530 ( struct V_276 * V_498 , int * V_1471 )
{
* V_1471 = 32 ;
...
V_1490 -> V_844 [ V_842 ] =
V_1485 + V_1489 ;
F_239 ( L_176 , V_1490 -> V_844 [ V_842 ] ) ;
if ( ++ V_1489 == V_1488 )
V_1489 = 0 ;
}
F_239 ( L_177 ) ;
...
V_1491 , V_1493 ) ;
V_10 = F_526 ( V_25 , V_1221 , V_1461 , V_1462 , V_30 ,
V_1465 ) ;
if ( V_10 )
break;
V_1461 = F_29 ( V_4 , V_30 ,
...
V_10 = F_535 ( V_4 , V_25 , V_1221 ) ;
if ( V_10 )
return V_10 ;
V_1473 = F_529 ( V_1221 , & V_1495 ) ;
V_1474 = F_530 ( V_1221 , & V_1496 ) ;
...
F_532 ( V_25 , V_1473 , V_1474 ) ;
F_534 ( V_25 , V_1473 , V_1474 ) ;
return 0 ;
V_1498:
F_527 ( L_179 , V_1496 ) ;
return - V_21 ;
...
static void T_12 F_541 ( struct V_3 * V_4 , T_5 * V_1511 )
{
struct V_1512 V_1513 [ V_1514 ] ;
struct V_24 * V_25 = V_4 -> V_25 ;
struct V_1515 * V_1232 = V_4 -> V_1232 ;
...
V_1513 [ V_26 ] . V_1389 = 0 ;
V_1513 [ V_26 ] . V_1519 = V_26 ;
}
V_10 = F_542 ( V_1232 , V_1513 , V_1516 ) ;
if ( V_10 < 0 ) {
V_4 -> V_87 &= ~ V_1520 ;
return;
}
...
V_4 -> V_87 |= V_1520 ;
for ( V_26 = 0 ; V_26 < V_1516 ; V_26 ++ )
V_4 -> V_29 [ V_26 ] . V_782 = V_1513 [ V_26 ] . V_1389 ;
V_4 -> V_28 = V_1516 ;
}
static int T_12 F_543 ( struct V_3 * V_4 , T_5 * V_1511 )
{
#ifdef F_544
struct V_1521 * V_1522 = V_4 -> V_1522 ;
const T_3 * V_1523 ;
int V_26 ;
V_1523 = F_545 ( V_1522 -> V_11 . V_1524 , L_181 , NULL ) ;
if ( ! V_1523 )
return - V_8 ;
...
V_1529 = 0 ;
V_10 = F_501 ( V_4 , V_25 , V_1511 [ V_1529 ] ,
F_548 ( V_30 ) ) ;
if ( V_10 )
return V_10 ;
V_1529 ++ ;
...
V_1532 = F_552 ( V_4 -> V_1232 ) ;
V_1418 = F_545 ( V_1532 , L_142 , & V_1408 ) ;
if ( ! V_1418 ) {
F_10 ( V_11 , L_182 ,
V_1532 -> V_1534 ) ;
return - V_21 ;
...
if ( F_521 ( V_4 , V_4 -> V_1223 . V_1418 ) ) {
F_10 ( V_11 , L_184 ,
V_1532 -> V_1534 , V_4 -> V_1223 . V_1418 ) ;
return - V_21 ;
}
V_1533 = F_545 ( V_1532 , L_140 , & V_1408 ) ;
if ( ! V_1533 ) {
F_10 ( V_11 , L_185 ,
V_1532 -> V_1534 ) ;
return - V_21 ;
...
F_10 ( V_11 , L_186 ,
V_1532 -> V_1534 , V_1408 ) ;
}
memcpy ( V_11 -> V_1436 , V_1533 , V_11 -> V_1437 ) ;
if ( ! F_431 ( & V_11 -> V_1436 [ 0 ] ) ) {
F_10 ( V_11 , L_187 ,
V_1532 -> V_1534 ) ;
F_10 ( V_11 , L_188 , V_1532 -> V_1534 , V_11 -> V_1436 ) ;
return - V_21 ;
}
memcpy ( V_11 -> V_1104 , V_11 -> V_1436 , V_11 -> V_1437 ) ;
V_1411 = F_545 ( V_1532 , L_137 , & V_1408 ) ;
if ( V_1411 )
strcpy ( V_4 -> V_1223 . V_1411 , V_1411 ) ;
if ( F_553 ( V_1532 , L_189 , & V_1408 ) ) {
V_4 -> V_87 |= ( V_88 | V_344 |
V_134 ) ;
}
return 0 ;
...
{
struct V_1521 * V_1541 = F_556 ( V_11 ) ;
struct V_24 * V_498 = V_1541 -> V_11 . V_1542 ;
...
return sprintf ( V_1540 , L_201 , V_1544 ) ;
}
...
struct V_1538 * V_1539 , char * V_1540 )
{
return F_558 ( V_11 , V_1539 , V_1540 , 1 ) ;
}
...
T_5 V_543 )
{
struct V_1521 * V_1541 ;
struct V_24 * V_498 ;
int V_26 ;
V_1541 = F_563 ( L_205 , V_1549 ,
NULL , 0 ) ;
if ( F_564 ( V_1541 ) )
return NULL ;
for ( V_26 = 0 ; F_565 ( V_1550 [ V_26 ] ) ; V_26 ++ ) {
int V_10 = F_566 ( & V_1541 -> V_11 ,
& V_1550 [ V_26 ] ) ;
if ( V_10 )
goto V_1551;
}
...
goto V_1551;
V_498 -> V_375 = V_1549 ++ ;
V_1541 -> V_11 . V_1542 = V_498 ;
V_498 -> V_1541 = V_1541 ;
memcpy ( & V_498 -> V_1464 , V_1464 , sizeof( * V_1464 ) ) ;
V_498 -> V_339 = V_543 ;
F_567 ( & V_498 -> V_1552 ) ;
F_568 ( & V_498 -> V_1553 , 0 ) ;
F_569 ( & V_498 -> V_1552 , & V_1554 ) ;
F_570 ( & V_498 -> V_155 ) ;
V_498 -> V_902 = 7500 ;
V_498 -> V_441 = V_1555 ;
...
if ( ! V_498 )
V_498 = F_562 ( V_4 , V_1464 , V_543 ) ;
if ( V_498 ) {
char V_1560 [ 6 ] ;
int V_10 ;
sprintf ( V_1560 , L_206 , V_30 ) ;
V_10 = F_575 ( & V_498 -> V_1541 -> V_11 . V_1561 ,
& V_4 -> V_508 -> V_1561 ,
V_1560 ) ;
if ( ! V_10 ) {
...
sprintf ( V_1560 , L_206 , V_30 ) ;
F_573 ( & V_1559 ) ;
F_579 ( & V_498 -> V_1541 -> V_11 . V_1561 , V_1560 ) ;
V_498 -> V_1425 [ V_30 ] = NULL ;
V_4 -> V_25 = NULL ;
if ( F_580 ( & V_498 -> V_1553 ) ) {
F_581 ( & V_498 -> V_1552 ) ;
F_571 ( V_498 -> V_1541 ) ;
}
F_577 ( & V_1559 ) ;
...
T_16 V_1564 ;
void * V_860 ;
V_860 = F_583 ( V_11 , V_487 , & V_1564 , V_1563 ) ;
if ( V_860 )
* V_1562 = V_1564 ;
return V_860 ;
}
...
{
F_585 ( V_11 , V_487 , V_1565 , V_1562 ) ;
}
static T_1 F_586 ( struct V_508 * V_11 , struct V_485 * V_485 ,
unsigned long V_486 , T_15 V_487 ,
enum V_1566 V_1567 )
{
return F_587 ( V_11 , V_485 , V_486 , V_487 , V_1567 ) ;
}
static void F_588 ( struct V_508 * V_11 , T_1 V_1568 ,
T_15 V_487 , enum V_1566 V_1567 )
{
F_589 ( V_11 , V_1568 , V_487 , V_1567 ) ;
}
static T_1 F_590 ( struct V_508 * V_11 , void * V_1565 ,
T_15 V_487 ,
enum V_1566 V_1567 )
{
return F_591 ( V_11 , V_1565 , V_487 , V_1567 ) ;
}
static void F_592 ( struct V_508 * V_11 , T_1 V_1568 ,
T_15 V_487 ,
enum V_1566 V_1567 )
{
F_593 ( V_11 , V_1568 , V_487 , V_1567 ) ;
}
...
struct V_508 * V_1570 , struct V_1515 * V_1232 ,
struct V_1521 * V_1522 , const struct V_1571 * V_304 ,
T_5 V_30 )
{
struct V_308 * V_11 ;
struct V_3 * V_4 ;
V_11 = F_596 ( sizeof( struct V_3 ) , V_1482 ) ;
if ( ! V_11 ) {
F_226 ( V_1570 , L_208 ) ;
return NULL ;
}
...
static int T_12 F_602 ( struct V_1515 * V_1232 ,
...
V_10 = F_603 ( V_1232 ) ;
if ( V_10 ) {
F_226 ( & V_1232 -> V_11 , L_218 ) ;
return V_10 ;
}
if ( ! ( F_604 ( V_1232 , 0 ) & V_1588 ) ||
! ( F_604 ( V_1232 , 2 ) & V_1588 ) ) {
F_226 ( & V_1232 -> V_11 , L_219 ) ;
V_10 = - V_8 ;
goto V_1589;
}
V_10 = F_605 ( V_1232 , V_1225 ) ;
if ( V_10 ) {
F_226 ( & V_1232 -> V_11 , L_220 ) ;
goto V_1589;
}
V_1585 = F_606 ( V_1232 ) ;
if ( V_1585 <= 0 ) {
F_226 ( & V_1232 -> V_11 , L_221 ) ;
goto V_1590;
}
V_11 = F_595 ( & V_1232 -> V_11 , V_1232 , NULL ,
& V_1591 , F_607 ( V_1232 -> V_1592 ) ) ;
if ( ! V_11 ) {
V_10 = - V_506 ;
goto V_1590;
}
...
V_1584 . V_1593 . V_1594 = F_608 ( V_1232 -> V_1595 ) ;
V_1584 . V_1593 . V_1595 = V_1232 -> V_1595 -> V_1596 ;
V_1584 . V_1593 . V_508 = F_609 ( V_1232 -> V_1592 ) ;
V_4 -> V_25 = F_572 ( V_4 , & V_1584 ,
V_1545 ) ;
if ( ! V_4 -> V_25 ) {
V_10 = - V_506 ;
goto V_1597;
}
F_610 ( V_1232 , V_1585 + V_1598 , & V_1587 ) ;
V_1587 &= ~ V_1599 ;
V_1587 |= ( V_1600 |
V_1601 |
V_1602 |
V_1603 |
V_1604 ) ;
F_611 ( V_1232 , V_1585 + V_1598 , V_1587 ) ;
V_1586 = F_612 ( 44 ) ;
V_10 = F_613 ( V_1232 , V_1586 ) ;
if ( ! V_10 ) {
V_11 -> V_552 |= V_1605 ;
V_10 = F_614 ( V_1232 , V_1586 ) ;
if ( V_10 ) {
F_226 ( & V_1232 -> V_11 , L_222 ) ;
goto V_1606;
}
}
if ( V_10 || V_1586 == F_612 ( 32 ) ) {
V_10 = F_613 ( V_1232 , F_612 ( 32 ) ) ;
if ( V_10 ) {
F_226 ( & V_1232 -> V_11 , L_223 ) ;
goto V_1606;
}
}
F_601 ( V_11 ) ;
V_11 -> V_1607 |= V_1608 ;
V_4 -> V_1503 = F_615 ( V_1232 , 0 ) ;
if ( ! V_4 -> V_1503 ) {
F_226 ( & V_1232 -> V_11 , L_224 ) ;
V_10 = - V_506 ;
goto V_1606;
}
F_616 ( V_1232 ) ;
...
if ( V_10 ) {
if ( V_10 != - V_8 )
F_226 ( & V_1232 -> V_11 , L_225 ) ;
goto V_1609;
}
V_10 = F_618 ( V_11 ) ;
if ( V_10 ) {
F_226 ( & V_1232 -> V_11 , L_226 ) ;
goto V_1609;
}
F_619 ( V_1232 , V_11 ) ;
F_600 ( V_4 ) ;
...
static void T_13 F_624 ( struct V_1515 * V_1232 )
{
struct V_308 * V_11 = F_625 ( V_1232 ) ;
if ( V_11 ) {
struct V_3 * V_4 = F_402 ( V_11 ) ;
F_626 ( V_11 ) ;
if ( V_4 -> V_1503 ) {
...
static int F_627 ( struct V_1515 * V_1232 , T_17 V_1376 )
{
struct V_308 * V_11 = F_625 ( V_1232 ) ;
struct V_3 * V_4 = F_402 ( V_11 ) ;
unsigned long V_87 ;
...
static int F_630 ( struct V_1515 * V_1232 )
{
struct V_308 * V_11 = F_625 ( V_1232 ) ;
struct V_3 * V_4 = F_402 ( V_11 ) ;
unsigned long V_87 ;
...
T_1 * V_1610 , T_6 V_1563 )
{
unsigned long V_1611 = F_634 ( V_487 ) ;
unsigned long V_485 = F_635 ( V_1563 , V_1611 ) ;
if ( V_485 == 0UL )
return NULL ;
...
{
unsigned long V_1611 = F_634 ( V_487 ) ;
F_638 ( ( unsigned long ) V_1565 , V_1611 ) ;
}
...
static void F_641 ( struct V_508 * V_11 , T_1 V_1568 ,
T_15 V_487 , enum V_1566 V_1567 )
{
}
static T_1 F_642 ( struct V_508 * V_11 , void * V_1565 ,
T_15 V_487 ,
enum V_1566 V_1567 )
{
return F_636 ( V_1565 ) ;
}
static void F_643 ( struct V_508 * V_11 , T_1 V_1568 ,
T_15 V_487 ,
enum V_1566 V_1567 )
{
}
static int T_12 F_644 ( struct V_1521 * V_1522 )
{
union V_1548 V_1584 ;
struct V_308 * V_11 ;
struct V_3 * V_4 ;
...
int V_10 ;
F_594 () ;
V_1 = F_545 ( V_1522 -> V_11 . V_1524 , L_227 , NULL ) ;
if ( ! V_1 ) {
F_226 ( & V_1522 -> V_11 , L_228 ,
V_1522 -> V_11 . V_1524 -> V_1534 ) ;
return - V_8 ;
}
V_11 = F_595 ( & V_1522 -> V_11 , NULL , V_1522 ,
& V_1612 , V_1 [ 0 ] & 0x1 ) ;
if ( ! V_11 ) {
V_10 = - V_506 ;
goto V_1613;
...
V_4 = F_402 ( V_11 ) ;
memset ( & V_1584 , 0 , sizeof( V_1584 ) ) ;
V_1584 . V_1614 = F_645 ( V_1522 -> V_11 . V_1524 ) ;
V_4 -> V_25 = F_572 ( V_4 , & V_1584 ,
V_343 ) ;
if ( ! V_4 -> V_25 ) {
V_10 = - V_506 ;
...
F_601 ( V_11 ) ;
V_4 -> V_1503 = F_646 ( & V_1522 -> V_1615 [ 1 ] , 0 ,
F_647 ( & V_1522 -> V_1615 [ 1 ] ) ,
L_229 ) ;
if ( ! V_4 -> V_1503 ) {
...
V_4 -> V_1616 = F_646 ( & V_1522 -> V_1615 [ 2 ] , 0 ,
F_647 ( & V_1522 -> V_1615 [ 2 ] ) ,
L_230 ) ;
if ( ! V_4 -> V_1616 ) {
F_226 ( & V_1522 -> V_11 , L_231 ) ;
V_10 = - V_506 ;
goto V_1609;
}
V_4 -> V_1617 = F_646 ( & V_1522 -> V_1615 [ 3 ] , 0 ,
F_647 ( & V_1522 -> V_1615 [ 3 ] ) ,
L_232 ) ;
if ( ! V_4 -> V_1617 ) {
F_226 ( & V_1522 -> V_11 , L_233 ) ;
V_10 = - V_506 ;
goto V_1609;
}
F_599 ( V_11 ) ;
...
V_10 = F_618 ( V_11 ) ;
if ( V_10 ) {
F_226 ( & V_1522 -> V_11 , L_226 ) ;
goto V_1609;
}
F_648 ( & V_1522 -> V_11 , V_11 ) ;
F_600 ( V_4 ) ;
return 0 ;
V_1609:
if ( V_4 -> V_1616 ) {
F_649 ( & V_1522 -> V_1615 [ 2 ] , V_4 -> V_1616 ,
F_647 ( & V_1522 -> V_1615 [ 2 ] ) ) ;
V_4 -> V_1616 = NULL ;
}
if ( V_4 -> V_1617 ) {
F_649 ( & V_1522 -> V_1615 [ 3 ] , V_4 -> V_1617 ,
F_647 ( & V_1522 -> V_1615 [ 3 ] ) ) ;
V_4 -> V_1617 = NULL ;
}
if ( V_4 -> V_1503 ) {
F_649 ( & V_1522 -> V_1615 [ 1 ] , V_4 -> V_1503 ,
F_647 ( & V_1522 -> V_1615 [ 1 ] ) ) ;
V_4 -> V_1503 = NULL ;
}
V_1606:
...
static int T_13 F_650 ( struct V_1521 * V_1522 )
{
struct V_308 * V_11 = F_651 ( & V_1522 -> V_11 ) ;
if ( V_11 ) {
struct V_3 * V_4 = F_402 ( V_11 ) ;
F_626 ( V_11 ) ;
if ( V_4 -> V_1616 ) {
