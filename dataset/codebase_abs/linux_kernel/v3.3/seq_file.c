...
char * F_19 ( char * V_45 , const char * V_5 , const char * V_46 )
{
while ( V_45 <= V_5 ) {
char V_48 = * V_5 ++ ;
if ( ! V_48 ) {
...
int F_20 ( struct V_4 * V_13 , const struct V_51 * V_51 , const char * V_46 )
{
char * V_20 ;
...
int F_24 ( struct V_4 * V_13 , const struct V_51 * V_51 ,
...
int F_26 ( struct V_4 * V_13 , struct V_56 * V_56 , const char * V_46 )
{
char * V_20 ;
T_4 V_21 = F_21 ( V_13 , & V_20 ) ;
int V_52 = - 1 ;
