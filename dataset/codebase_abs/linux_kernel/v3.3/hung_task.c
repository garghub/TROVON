...
static bool F_11 ( struct V_9 * V_23 , struct V_9 * V_10 )
{
bool V_24 ;
F_12 ( V_23 ) ;
F_12 ( V_10 ) ;
...
F_14 () ;
F_15 () ;
V_24 = F_16 ( V_23 ) && F_16 ( V_10 ) ;
F_17 ( V_10 ) ;
F_17 ( V_23 ) ;
return V_24 ;
}
static void F_18 ( unsigned long V_11 )
{
int V_25 = V_26 ;
int V_27 = V_28 ;
...
static unsigned long F_22 ( unsigned long V_11 )
{
...
static int F_26 ( void * V_44 )
{
F_27 ( V_45 , 0 ) ;
for ( ; ; ) {
unsigned long V_11 = V_46 ;
while ( F_28 ( F_22 ( V_11 ) ) )
V_11 = V_46 ;
F_18 ( V_11 ) ;
}
return 0 ;
