...
struct V_10 * V_11 = F_5 ( V_2 ) ;
int V_69 , V_23 ;
V_11 -> V_17 . V_80 = & V_11 -> V_43 [ 0 ] ;
V_11 -> V_17 . V_42 =
F_10 ( V_11 -> V_43 ) ;
V_69 = F_24 ( V_2 , 8 , 16 , V_11 -> V_81 ) ;
if ( V_69 != 0 ) {
F_6 ( V_2 -> V_13 , L_6 , V_69 ) ;
return V_69 ;
}
for ( V_23 = 0 ; V_23 < F_10 ( V_11 -> V_78 ) ; V_23 ++ )
V_11 -> V_78 [ V_23 ] . V_82 = V_83 [ V_23 ] ;
...
static T_2 int F_29 ( struct V_92 * V_93 ,
const struct V_94 * V_95 )
{
struct V_10 * V_11 ;
int V_69 ;
V_11 = F_30 ( sizeof( struct V_10 ) , V_96 ) ;
if ( V_11 == NULL )
return - V_97 ;
F_31 ( V_93 , V_11 ) ;
V_11 -> V_81 = V_98 ;
...
static T_3 int F_34 ( struct V_92 * V_101 )
{
F_35 ( & V_101 -> V_13 ) ;
F_33 ( F_36 ( V_101 ) ) ;
return 0 ;
