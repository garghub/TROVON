...
unsigned long F_36 ( struct V_11 * V_43 )
{
return V_43 -> V_18 . V_14 . V_37 ;
}
T_4 int F_37 ( struct V_13 * V_14 )
{
int error ;
char * V_44 ;
V_44 = F_38 ( ( const char T_3 * ) V_14 -> V_22 [ 26 ] ) ;
error = F_39 ( V_44 ) ;
if ( F_40 ( V_44 ) )
goto V_45;
error = F_41 ( V_44 ,
...
int F_43 ( const char * V_44 ,
const char * const V_46 [] ,
const char * const V_47 [] )
{
return F_44 ( V_44 , V_46 , V_47 , V_48 ) ;
}
unsigned long
F_45 ( struct V_11 * V_28 )
{
struct V_49 V_50 ;
unsigned long V_51 ;
int V_52 = 0 ;
