...
{
struct V_22 * V_23 ;
if ( ! F_7 ( V_8 , ( F_8 ( V_8 ) ) + 8 ) ||
! F_7 ( V_8 , ( F_8 ( V_8 ) +
( ( F_9 ( V_8 ) [ 1 ] + 1 ) << 3 ) ) ) )
return - 1 ;
V_23 = (struct V_22 * ) F_9 ( V_8 ) ;
if ( V_23 -> V_24 < F_5 ( V_23 -> V_25 ) ) {
F_10 ( V_26 L_1 ,
V_23 -> V_24 , F_5 ( V_23 -> V_25 ) ) ;
F_3 ( V_8 , 0 , ( ( & V_23 -> V_24 ) -
F_11 ( V_8 ) ) ) ;
return - 1 ;
}
...
static int F_27 ( struct V_29 * V_30 , struct V_7 * V_8 ,
const struct V_61 * V_62 )
{
struct V_63 * V_63 = F_28 ( V_30 ) ;
...
struct V_52 V_53 ;
int V_35 = 0 ;
if ( F_29 ( V_68 -> V_74 == V_75 &&
V_68 -> V_76 <= V_77 ) )
goto V_78;
if ( F_30 ( V_65 -> V_79 ) ) {
V_73 = F_31 ( V_8 , V_65 -> V_79 , V_46 ) ;
if ( F_30 ( V_73 >= 0 ) )
V_44 = (struct V_43 * )
( F_11 ( V_8 ) + V_73 ) ;
}
F_32 ( V_8 , & V_53 ) ;
if ( ! F_26 ( & V_53 , & F_13 ( V_8 ) -> V_80 ,
...
V_72 . V_84 = V_85 ;
V_72 . V_86 = V_68 -> V_74 ;
V_72 . V_87 = F_33 ( V_62 , & V_68 -> V_88 ) ;
if ( V_72 . V_87 )
V_72 . V_89 = F_34 ( ~ 0 ) ;
V_72 . V_90 = F_35 ( V_62 , & V_68 -> V_88 ) ;
if ( V_72 . V_90 )
V_72 . V_91 = F_34 ( ~ 0 ) ;
V_72 . V_92 = V_68 -> V_93 ;
V_35 = F_36 ( V_63 , V_45 , & V_72 ,
( V_44 ? ( V_81 * ) & V_44 -> V_48 : NULL ) ) ;
V_78:
return V_35 ;
}
static int F_37 ( struct V_29 * V_30 , struct V_7 * V_8 ,
T_2 * * V_36 )
{
T_3 V_73 = sizeof( struct V_31 ) ;
struct V_94 * V_95 =
(struct V_94 * ) ( F_13 ( V_8 ) + 1 ) ;
const unsigned char * V_96 = F_11 ( V_8 ) ;
unsigned int V_97 = V_8 -> V_98 - V_8 -> V_99 ;
int V_100 = 0 ;
* V_36 = & F_13 ( V_8 ) -> V_36 ;
while ( V_73 + 1 <= V_97 ) {
switch ( * * V_36 ) {
...
{
if ( V_30 -> V_105 . V_106 ) {
F_40 ( V_107 L_4 , V_108 ,
V_30 -> V_105 . V_106 ) ;
return - V_109 ;
}
if ( V_30 -> V_49 . V_110 != V_111 ) {
F_40 ( V_107 L_5 ,
V_108 , V_111 , V_30 -> V_49 . V_110 ) ;
return - V_109 ;
}
V_30 -> V_49 . V_50 = sizeof( struct V_33 ) +
F_1 ( sizeof( struct V_33 ) , 6 ) +
sizeof( struct V_43 ) ;
F_25 ( V_30 -> V_49 . V_50 != 24 ) ;
return 0 ;
}
static void F_41 ( struct V_29 * V_30 )
{
}
static int F_42 ( struct V_29 * V_30 , struct V_7 * V_8 )
{
const struct V_31 * V_32 = F_13 ( V_8 ) ;
struct V_112 * V_113 = (struct V_112 * ) V_8 -> V_3 ;
int V_35 = V_113 -> V_114 . V_36 ;
F_14 ( & V_30 -> V_37 ) ;
...
static int F_43 ( struct V_29 * V_30 , struct V_7 * V_8 )
{
struct V_31 * V_32 ;
struct V_112 * V_113 ;
T_2 V_36 ;
...
V_36 = * F_21 ( V_8 ) ;
* F_21 ( V_8 ) = V_115 ;
V_113 = (struct V_112 * ) F_9 ( V_8 ) ;
V_113 -> V_114 . V_36 = V_36 ;
V_113 -> V_114 . V_51 = ( V_30 -> V_49 . V_50 >> 3 ) - 1 ;
V_113 -> V_114 . type = V_116 ;
V_113 -> V_114 . V_117 = 1 ;
memset ( & V_113 -> V_118 , 0 , sizeof( V_113 -> V_118 ) ) ;
F_25 ( V_113 -> V_114 . V_51 != 2 ) ;
memcpy ( & V_113 -> V_48 , & V_32 -> V_80 , sizeof( V_113 -> V_48 ) ) ;
F_23 ( & V_30 -> V_37 ) ;
memcpy ( & V_32 -> V_80 , V_30 -> V_40 , sizeof( V_32 -> V_80 ) ) ;
F_24 ( & V_30 -> V_37 ) ;
return 0 ;
}
static int F_44 ( struct V_29 * V_30 , struct V_7 * V_8 ,
T_2 * * V_36 )
{
T_3 V_73 = sizeof( struct V_31 ) ;
struct V_94 * V_95 =
...
V_30 -> V_49 . V_50 = sizeof( struct V_112 ) ;
return 0 ;
}
...
{
F_40 ( V_107 L_6 ) ;
if ( F_48 ( & V_121 , V_85 ) < 0 ) {
F_40 ( V_107 L_7 , V_108 ) ;
goto V_122;
}
if ( F_48 ( & V_123 , V_85 ) < 0 ) {
F_40 ( V_107 L_8 , V_108 ) ;
goto V_124;
}
if ( F_49 ( F_6 ) < 0 ) {
F_40 ( V_107 L_9 , V_108 ) ;
goto V_125;
}
return 0 ;
V_125:
...
{
if ( F_52 ( F_6 ) < 0 )
F_40 ( V_107 L_10 , V_108 ) ;
if ( F_50 ( & V_123 , V_85 ) < 0 )
F_40 ( V_107 L_11 , V_108 ) ;
if ( F_50 ( & V_121 , V_85 ) < 0 )
F_40 ( V_107 L_12 , V_108 ) ;
}
