...
static int F_125 ( const struct V_7 * V_7 , struct V_333 * V_334 ,
int V_249 , int V_250 )
{
int V_47 ;
V_47 = F_126 ( V_7 , V_334 , V_249 , V_250 ) ;
if ( V_47 )
return V_47 ;
...
const struct V_7 * V_7 = F_52 () ;
if ( V_69 & V_462 )
return F_113 ( V_7 , V_215 -> V_52 -> V_459 ,
V_463 , NULL ) ;
else
return F_106 ( V_7 , V_215 , V_464 ) ;
}
static int F_182 ( struct V_465 * V_376 , int V_69 )
{
const struct V_7 * V_7 = F_52 () ;
return F_113 ( V_7 , V_376 -> V_466 ,
V_467 , NULL ) ;
}
...
static int F_188 ( struct V_19 * V_270 , struct V_52 * V_52 , T_5 V_151 )
{
...
static int F_192 ( struct V_19 * V_270 , struct V_52 * V_52 , T_5 V_302 )
{
...
static int F_194 ( struct V_19 * V_270 , struct V_52 * V_52 , T_5 V_151 , T_8 V_221 )
{
...
static int F_200 ( struct V_465 * V_376 , struct V_52 * V_52 )
{
const struct V_7 * V_7 = F_52 () ;
struct V_215 V_215 ;
V_215 . V_52 = V_52 ;
...
if ( V_633 == NULL )
goto V_66;
V_252 -> V_257 . V_608 . V_634 . V_610 = V_633 -> V_610 ;
V_252 -> V_257 . V_608 . V_634 . V_611 = V_633 -> V_611 ;
V_577 = 0 ;
V_630 = V_633 -> V_630 ;
V_602 += sizeof( V_632 ) ;
...
V_47 = F_270 ( V_11 , V_645 , & V_272 ) ;
if ( V_47 )
return V_47 ;
return F_35 ( V_11 -> V_14 , V_272 , V_645 , V_655 , NULL ) ;
}
static int F_273 ( struct V_656 * V_648 , int V_170 ,
...
static int F_276 ( struct V_656 * V_648 , struct V_657 * V_658 , int V_659 )
{
struct V_648 * V_649 = V_648 -> V_649 ;
T_4 V_170 ;
int V_555 ;
V_555 = F_271 ( V_8 , V_649 , V_660 ) ;
if ( V_555 )
goto V_66;
V_170 = V_649 -> V_661 ;
...
V_555 = F_278 ( V_649 -> V_678 ,
V_666 , & V_14 ) ;
if ( V_555 )
goto V_66;
F_95 ( & V_252 , V_653 ) ;
V_252 . V_257 . V_608 . V_617 = F_279 ( V_666 ) ;
...
V_252 . V_257 . V_608 . V_634 . V_610 = V_665 -> V_672 ;
V_555 = F_35 ( V_651 -> V_14 , V_14 ,
...
static int F_281 ( struct V_656 * V_648 , struct V_657 * V_658 , int V_659 )
{
struct V_648 * V_649 = V_648 -> V_649 ;
struct V_650 * V_651 = V_649 -> V_652 ;
int V_555 ;
V_555 = F_271 ( V_8 , V_649 , V_684 ) ;
if ( V_555 )
return V_555 ;
if ( V_651 -> V_28 == V_179 ||
V_651 -> V_28 == V_183 ) {
...
V_555 = F_278 ( V_649 -> V_678 , V_666 , & V_14 ) ;
if ( V_555 )
goto V_66;
V_228 = ( V_651 -> V_28 == V_179 ) ?
V_686 : V_687 ;
F_95 ( & V_252 , V_653 ) ;
V_252 . V_257 . V_608 . V_619 = F_279 ( V_666 ) ;
V_252 . V_257 . V_608 . V_170 = V_649 -> V_661 ;
V_555 = F_35 ( V_651 -> V_14 , V_14 , V_651 -> V_28 , V_228 , & V_252 ) ;
if ( V_555 )
goto V_66;
}
V_555 = F_282 ( V_649 , V_658 ) ;
V_66:
return V_555 ;
}
static int F_283 ( struct V_656 * V_648 , int V_688 )
{
return F_271 ( V_8 , V_648 -> V_649 , V_689 ) ;
}
static int F_284 ( struct V_656 * V_648 , struct V_656 * V_690 )
{
int V_555 ;
struct V_20 * V_21 ;
struct V_20 * V_123 ;
V_555 = F_271 ( V_8 , V_648 -> V_649 , V_691 ) ;
if ( V_555 )
return V_555 ;
V_123 = F_274 ( V_690 ) -> V_30 ;
...
static int F_285 ( struct V_656 * V_648 , struct V_692 * V_693 ,
int V_498 )
{
return F_271 ( V_8 , V_648 -> V_649 , V_694 ) ;
}
...
static int F_287 ( struct V_656 * V_648 )
{
...
static int F_289 ( struct V_656 * V_648 , int V_697 , int V_698 )
{
int V_555 ;
V_555 = F_271 ( V_8 , V_648 -> V_649 , V_699 ) ;
if ( V_555 )
return V_555 ;
return F_290 ( V_648 , V_697 , V_698 ) ;
}
static int F_291 ( struct V_656 * V_648 , int V_697 ,
int V_698 )
{
return F_271 ( V_8 , V_648 -> V_649 , V_700 ) ;
}
static int F_292 ( struct V_656 * V_648 , int V_701 )
{
return F_271 ( V_8 , V_648 -> V_649 , V_702 ) ;
}
...
V_555 = F_294 ( V_706 -> V_14 , V_705 -> V_14 ,
& V_707 -> V_14 ) ;
if ( V_555 )
return V_555 ;
...
static int F_295 ( struct V_656 * V_648 ,
struct V_656 * V_703 )
{
...
static int F_296 ( int V_713 , char * V_637 , T_4 V_170 ,
T_2 V_709 ,
struct V_251 * V_252 )
{
int V_555 ;
...
if ( V_170 != V_177 && V_170 != V_178 )
return 0 ;
if ( V_170 == V_178 && V_600 -> V_166 == F_279 ( V_728 ) )
V_170 = V_177 ;
if ( ! V_729 )
...
if ( V_727 ) {
T_2 V_709 ;
V_555 = F_266 ( V_600 , V_170 , & V_709 ) ;
if ( V_555 )
return V_555 ;
V_555 = F_296 ( V_600 -> V_722 , V_637 , V_170 ,
V_709 , & V_252 ) ;
if ( V_555 ) {
F_304 ( V_600 , V_555 , 0 ) ;
return V_555 ;
...
static int F_305 ( struct V_656 * V_648 , char T_13 * V_732 ,
int T_13 * V_733 , unsigned V_84 )
{
int V_555 = 0 ;
char * V_734 ;
T_2 V_735 ;
...
if ( F_306 ( V_732 , V_734 , V_735 ) )
V_555 = - V_738 ;
V_737:
if ( F_307 ( V_735 , V_733 ) )
V_555 = - V_738 ;
F_28 ( V_734 ) ;
return V_555 ;
}
static int F_308 ( struct V_656 * V_648 , struct V_599 * V_600 , T_2 * V_506 )
{
T_2 V_739 = V_647 ;
T_4 V_170 ;
if ( V_600 && V_600 -> V_166 == F_279 ( V_728 ) )
V_170 = V_177 ;
else if ( V_600 && V_600 -> V_166 == F_279 ( V_740 ) )
V_170 = V_178 ;
else if ( V_648 )
...
F_214 ( F_274 ( V_648 ) , & V_739 ) ;
else if ( V_600 )
F_266 ( V_600 , V_170 , & V_739 ) ;
V_66:
* V_506 = V_739 ;
if ( V_739 == V_647 )
return - V_86 ;
...
static int F_309 ( struct V_648 * V_649 , int V_170 , T_9 V_741 )
{
struct V_650 * V_651 ;
...
static void F_313 ( const struct V_648 * V_649 , struct V_648 * V_704 )
{
struct V_650 * V_651 = V_649 -> V_652 ;
...
static void F_315 ( struct V_648 * V_649 , struct V_656 * V_325 )
{
struct V_20 * V_21 = F_274 ( V_325 ) -> V_30 ;
struct V_650 * V_651 = V_649 -> V_652 ;
...
V_555 = F_294 ( V_651 -> V_14 , V_746 , & V_272 ) ;
if ( V_555 )
return V_555 ;
V_745 -> V_506 = V_272 ;
V_745 -> V_739 = V_746 ;
}
return F_317 ( V_745 , V_170 ) ;
}
static void F_318 ( struct V_648 * V_704 ,
const struct V_744 * V_745 )
{
struct V_650 * V_742 = V_704 -> V_652 ;
V_742 -> V_14 = V_745 -> V_506 ;
V_742 -> V_709 = V_745 -> V_739 ;
F_319 ( V_704 , V_745 -> V_747 -> V_170 ) ;
}
...
static void F_326 ( const struct V_744 * V_745 ,
struct V_750 * V_751 )
{
...
V_758 = F_332 ( V_600 ) ;
V_555 = F_333 ( V_651 -> V_28 , V_758 -> V_759 , & V_228 ) ;
if ( V_555 ) {
if ( V_555 == - V_86 ) {
F_334 ( V_8 -> V_760 , V_12 , V_761 ,
L_42
L_43 ,
...
static unsigned int F_336 ( struct V_599 * V_600 , int V_713 ,
T_4 V_170 )
{
int V_555 ;
char * V_637 ;
...
return V_765 ;
if ( V_763 )
if ( F_337 ( V_600 , V_170 , V_709 ) != 0 )
return V_765 ;
return V_764 ;
}
static unsigned int F_338 ( unsigned int V_767 ,
struct V_599 * V_600 ,
const struct V_768 * V_769 ,
const struct V_768 * V_66 ,
int (* F_339)( struct V_599 * ) )
{
return F_336 ( V_600 , V_769 -> V_713 , V_177 ) ;
}
static unsigned int F_340 ( unsigned int V_767 ,
struct V_599 * V_600 ,
const struct V_768 * V_769 ,
const struct V_768 * V_66 ,
int (* F_339)( struct V_599 * ) )
{
return F_336 ( V_600 , V_769 -> V_713 , V_178 ) ;
}
...
static unsigned int F_346 ( struct V_599 * V_600 , int V_713 ,
T_4 V_170 )
{
T_2 V_772 ;
T_2 V_709 ;
...
T_11 V_727 ;
if ( ! V_729 )
return F_343 ( V_600 , V_713 , V_170 ) ;
#ifdef F_347
if ( F_348 ( V_600 ) != NULL && F_348 ( V_600 ) -> V_773 != NULL )
return V_764 ;
#endif
V_726 = F_4 () ;
V_727 = F_302 () || F_303 () ;
...
T_2 V_714 ;
T_2 V_715 ;
if ( F_297 ( V_713 , & V_714 ) )
return V_765 ;
if ( F_35 ( V_709 , V_714 ,
V_716 , V_775 , & V_252 ) )
return F_344 ( - V_771 ) ;
if ( F_280 ( V_637 , V_170 , & V_715 ) )
return V_765 ;
if ( F_35 ( V_709 , V_715 ,
V_718 , V_776 , & V_252 ) )
return F_344 ( - V_771 ) ;
...
int (* F_339)( struct V_599 * ) )
{
return F_346 ( V_600 , V_66 -> V_713 , V_177 ) ;
}
...
int (* F_339)( struct V_599 * ) )
{
return F_346 ( V_600 , V_66 -> V_713 , V_178 ) ;
}
...
static void F_354 ( struct V_777 * V_228 )
{
struct V_778 * V_21 = V_228 -> V_16 ;
V_228 -> V_16 = NULL ;
F_28 ( V_21 ) ;
}
static int F_355 ( struct V_779 * V_693 )
{
struct V_780 * V_781 ;
...
static void F_356 ( struct V_779 * V_693 )
{
struct V_780 * V_781 = V_693 -> V_16 ;
V_693 -> V_16 = NULL ;
F_28 ( V_781 ) ;
}
static int F_357 ( struct V_777 * V_782 ,
T_2 V_238 )
{
struct V_778 * V_21 ;
struct V_251 V_252 ;
...
static int F_358 ( struct V_779 * V_693 )
{
return F_355 ( V_693 ) ;
}
static void F_359 ( struct V_779 * V_693 )
{
F_356 ( V_693 ) ;
}
static int F_360 ( struct V_786 * V_787 )
{
struct V_778 * V_21 ;
struct V_251 V_252 ;
T_2 V_14 = F_14 () ;
int V_47 ;
V_47 = F_353 ( V_8 , & V_787 -> V_788 , V_789 ) ;
if ( V_47 )
return V_47 ;
...
static void F_361 ( struct V_786 * V_787 )
{
F_354 ( & V_787 -> V_788 ) ;
}
static int F_362 ( struct V_786 * V_787 , int V_791 )
{
struct V_778 * V_21 ;
struct V_251 V_252 ;
T_2 V_14 = F_14 () ;
...
static int F_363 ( struct V_786 * V_787 , int V_509 )
{
int V_555 ;
int V_238 ;
switch ( V_509 ) {
...
V_555 = F_357 ( & V_787 -> V_788 , V_238 ) ;
return V_555 ;
}
static int F_364 ( struct V_786 * V_787 , struct V_779 * V_693 , int V_791 )
{
struct V_778 * V_21 ;
struct V_780 * V_781 ;
struct V_251 V_252 ;
...
static int F_365 ( struct V_786 * V_787 , struct V_779 * V_693 ,
struct V_17 * V_237 ,
long type , int V_151 )
{
struct V_778 * V_21 ;
...
static int F_366 ( struct V_809 * V_810 )
{
struct V_778 * V_21 ;
struct V_251 V_252 ;
T_2 V_14 = F_14 () ;
int V_47 ;
V_47 = F_353 ( V_8 , & V_810 -> V_811 , V_812 ) ;
if ( V_47 )
return V_47 ;
...
static void F_367 ( struct V_809 * V_810 )
{
F_354 ( & V_810 -> V_811 ) ;
}
static int F_368 ( struct V_809 * V_810 , int V_814 )
{
struct V_778 * V_21 ;
struct V_251 V_252 ;
T_2 V_14 = F_14 () ;
...
static int F_369 ( struct V_809 * V_810 , int V_509 )
{
int V_238 ;
int V_555 ;
switch ( V_509 ) {
...
V_555 = F_357 ( & V_810 -> V_811 , V_238 ) ;
return V_555 ;
}
static int F_370 ( struct V_809 * V_810 ,
char T_13 * V_824 , int V_814 )
{
T_2 V_238 ;
if ( V_814 & V_825 )
V_238 = V_826 ;
...
V_238 = V_826 | V_827 ;
return F_357 ( & V_810 -> V_811 , V_238 ) ;
}
static int F_371 ( struct V_828 * V_829 )
{
struct V_778 * V_21 ;
struct V_251 V_252 ;
T_2 V_14 = F_14 () ;
int V_47 ;
V_47 = F_353 ( V_8 , & V_829 -> V_830 , V_831 ) ;
if ( V_47 )
return V_47 ;
...
static void F_372 ( struct V_828 * V_829 )
{
F_354 ( & V_829 -> V_830 ) ;
}
static int F_373 ( struct V_828 * V_829 , int V_833 )
{
struct V_778 * V_21 ;
struct V_251 V_252 ;
T_2 V_14 = F_14 () ;
...
static int F_374 ( struct V_828 * V_829 , int V_509 )
{
int V_555 ;
T_2 V_238 ;
switch ( V_509 ) {
...
V_238 = V_842 ;
return F_357 ( & V_829 -> V_830 , V_238 ) ;
}
static int F_376 ( struct V_777 * V_853 , short V_98 )
{
T_2 V_255 = 0 ;
V_255 = 0 ;
if ( V_98 & V_854 )
...
if ( V_255 == 0 )
return 0 ;
return F_357 ( V_853 , V_255 ) ;
}
static void F_377 ( struct V_777 * V_853 , T_2 * V_506 )
{
...
static int F_386 ( T_2 V_506 , char * * V_453 , T_2 * V_867 )
{
return F_47 ( V_506 , V_453 , V_867 ) ;
}
static int F_387 ( const char * V_453 , T_2 V_867 , T_2 * V_506 )
{
return F_54 ( V_453 , V_867 , V_506 ) ;
}
static void F_388 ( char * V_453 , T_2 V_867 )
{
F_28 ( V_453 ) ;
}
static int F_389 ( struct V_19 * V_19 , void * V_279 , T_2 V_868 )
{
return F_212 ( V_19 , V_472 , V_279 , V_868 , 0 ) ;
}
static int F_390 ( struct V_52 * V_52 , void * V_279 , T_2 V_868 )
{
return F_391 ( V_52 , V_67 , V_279 , V_868 , 0 ) ;
}
static int F_392 ( struct V_19 * V_19 , void * * V_279 , T_2 * V_868 )
{
int V_84 = 0 ;
...
static int F_393 ( struct V_785 * V_869 , const struct V_7 * V_7 ,
unsigned long V_69 )
{
const struct V_10 * V_11 ;
struct V_870 * V_871 ;
...
static void F_394 ( struct V_785 * V_869 )
{
struct V_870 * V_871 = V_869 -> V_16 ;
V_869 -> V_16 = NULL ;
F_28 ( V_871 ) ;
}
static int F_395 ( T_14 V_872 ,
const struct V_7 * V_7 ,
T_15 V_228 )
{
struct V_785 * V_785 ;
...
static int F_397 ( struct V_785 * V_785 , char * * V_873 )
{
...
static void F_403 ( struct V_41 * V_42 , void * V_878 )
{
F_62 ( V_42 , NULL ) ;
}
void F_404 ( void )
