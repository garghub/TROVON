...
V_16 -> V_69 -> V_96 = L_11 ;
snprintf ( V_16 -> V_69 -> V_102 , V_103 , L_12 ,
V_16 -> V_104 -> V_96 , V_16 -> V_104 -> V_102 ) ;
V_16 -> V_69 -> V_38 = F_61 ( sizeof( int ) * V_84 , V_105 ) ;
if ( ! V_16 -> V_69 -> V_38 ) {
V_98 = - V_7 ;
goto V_106;
}
for ( V_43 = 0 ; V_43 < V_84 ; ++ V_43 )
V_16 -> V_69 -> V_38 [ V_43 ] = V_107 ;
if ( F_62 ( V_16 -> V_69 ) ) {
V_98 = - V_108 ;
goto V_109;
}
...
struct V_15 * V_16 = F_8 ( V_26 ) ;
struct V_1 * V_2 = & V_16 -> V_2 [ ( V_111 << 1 ) | 1 ] ;
struct V_18 * V_5 = & V_2 -> V_4 . V_8 [ V_2 -> V_4 . V_5 ] ;
int V_20 ;
unsigned long V_23 ;
T_3 V_112 ;
...
{
struct V_15 * V_16 = F_8 ( V_26 ) ;
return F_85 ( V_16 -> V_68 , V_126 , V_67 ) ;
}
static int
...
goto V_139;
F_82 ( V_26 , 1500 ) ;
memcpy ( & V_136 , & V_16 -> V_46 -> V_136 , sizeof( struct V_135 ) ) ;
if ( ! F_92 ( V_136 . V_140 ) ) {
F_93 ( L_14 ) ;
F_94 ( V_136 . V_140 ) ;
}
...
int V_98 ;
int V_43 ;
V_144 = F_100 ( V_104 , V_145 , 0 ) ;
if ( ! V_144 ) {
F_101 ( & V_104 -> V_26 , L_16 ) ;
V_98 = - V_146 ;
goto V_99;
}
V_144 = F_102 ( & V_104 -> V_26 , V_144 -> V_147 ,
F_103 ( V_144 ) , F_55 ( & V_104 -> V_26 ) ) ;
if ( ! V_144 ) {
F_101 ( & V_104 -> V_26 , L_17 ) ;
V_98 = - V_148 ;
goto V_99;
}
V_149 = F_104 ( & V_104 -> V_26 ,
