...
int V_50 ;
T_1 V_20 ;
V_49 = F_20 ( V_47 , V_51 , 0 ) ;
if ( ! V_49 )
return - V_52 ;
V_6 = F_21 ( sizeof *V_6 , V_53 ) ;
if ( ! V_6 )
return - V_54 ;
if ( ! F_22 ( & V_47 -> V_2 ) )
F_23 ( & V_47 -> V_2 , 1 ) ;
F_24 ( V_47 , V_6 ) ;
V_6 -> V_55 = F_25 ( V_49 -> V_56 , F_26 ( V_49 ) ) ;
if ( ! V_6 -> V_55 ) {
F_27 ( & V_47 -> V_2 , L_11 ) ;
V_50 = - V_54 ;
goto V_57;
...
V_20 &= ~ ( V_22 | V_23 ) ;
F_9 ( V_6 , V_21 , V_20 ) ;
V_6 -> V_43 = F_28 ( V_47 -> V_60 , & V_47 -> V_2 ,
& V_61 , V_62 ) ;
if ( F_29 ( V_6 -> V_43 ) ) {
V_50 = F_30 ( V_6 -> V_43 ) ;
goto V_63;
...
V_50 = F_31 ( V_64 , F_16 ,
V_65 | V_66 ,
F_32 ( & V_6 -> V_43 -> V_2 ) , V_6 ) ;
if ( V_50 ) {
F_6 ( & V_47 -> V_2 , L_12 , V_64 ) ;
F_33 ( V_6 -> V_43 ) ;
goto V_57;
}
if ( F_3 ( V_6 ) == 0 )
...
static int T_4 F_37 ( struct V_46 * V_47 )
{
struct V_5 * V_6 = F_38 ( V_47 ) ;
T_1 V_20 = F_4 ( V_6 , V_21 ) ;
F_9 ( V_6 , V_21 , V_20 & ~ ( V_22 | V_23 ) ) ;
F_39 ( V_64 , V_6 ) ;
F_33 ( V_6 -> V_43 ) ;
...
struct V_5 * V_6 = F_38 ( V_47 ) ;
T_1 V_20 = F_4 ( V_6 , V_21 ) ;
V_6 -> V_67 = V_20 & ( V_22 | V_23 ) ;
F_9 ( V_6 , V_21 , V_20 & ~ V_6 -> V_67 ) ;
}
...
static int T_3 F_46 ( struct V_1 * V_2 , void * V_69 )
{
struct V_46 * V_47 = F_47 ( V_2 ) ;
int V_50 ;
if ( strcmp ( L_14 , V_47 -> V_60 ) != 0
|| V_47 -> V_70 != V_71 )
goto V_57;
if ( V_2 -> V_72 ) {
F_6 ( V_2 , L_15 ) ;
