...
{
struct V_3 V_4 ;
if ( F_4 ( V_10 , V_14 , & V_4 , V_12 , NULL ) < 0 ) {
F_5 ( L_1 ,
V_10 -> V_15 . type ) ;
return - 1 ;
}
...
return 0 ;
if ( F_1 ( & T_3 -> V_1 , & V_4 , V_12 -> V_5 ) ) {
F_5 ( L_2 ) ;
return - 1 ;
}
T_3 -> V_1 . V_18 . V_19 += V_12 -> V_5 ;
return 0 ;
}
...
int V_42 , V_43 ;
struct V_44 * V_45 [ 2 ] ;
V_45 [ 0 ] = F_20 ( V_46 , V_47 , V_48 , false , & V_49 ) ;
V_45 [ 1 ] = F_20 ( V_50 , V_47 , V_48 , false , & V_49 ) ;
if ( V_45 [ 0 ] == NULL || V_45 [ 1 ] == NULL )
return - V_6 ;
for ( V_43 = 0 ; V_43 < 2 ; ++ V_43 ) {
V_42 = F_21 ( V_45 [ V_43 ] , & V_49 ) ;
if ( V_42 )
goto V_51;
}
F_16 ( & V_45 [ 1 ] -> V_1 ) ;
if ( V_52 )
F_15 ( & V_45 [ 0 ] -> V_1 ) ;
F_18 ( & V_45 [ 0 ] -> V_1 , & V_45 [ 1 ] -> V_1 ) ;
F_22 ( & V_45 [ 1 ] -> V_1 , & V_45 [ 0 ] -> V_1 ,
V_52 , true , 0 , 0 , stdout ) ;
V_51:
for ( V_43 = 0 ; V_43 < 2 ; ++ V_43 )
F_23 ( V_45 [ V_43 ] ) ;
return V_42 ;
}
int F_24 ( int V_53 , const char * * V_54 , const char * T_5 V_8 )
{
V_55 = V_56 ;
V_53 = F_25 ( V_53 , V_54 , V_57 , V_58 , 0 ) ;
if ( V_53 ) {
if ( V_53 > 2 )
F_26 ( V_58 , V_57 ) ;
if ( V_53 == 2 ) {
...
F_28 ( V_58 , V_57 ) ;
F_29 () ;
F_30 ( & V_63 , V_59 . V_64 , L_5 , NULL ) ;
F_30 ( & V_65 , V_59 . V_66 , L_6 , NULL ) ;
F_30 ( & V_67 , V_59 . V_68 , L_7 , NULL ) ;
return F_19 () ;
}
