...
static int T_1 F_7 ( struct V_9 * V_10 , struct V_11 * V_12 )
{
unsigned int V_3 ;
int V_4 ;
...
static int T_1 F_11 ( int V_18 , struct V_11 * V_12 ,
struct V_19 * V_10 ,
...
static int T_1 F_22 ( struct V_9 * V_10 , struct V_11 * V_2 )
{
struct V_48 * V_49 ;
...
static int T_1 F_37 ( struct V_9 * V_10 , int V_18 )
{
struct V_11 * V_12 ;
int V_64 , V_4 ;
struct V_65 * V_66 ;
...
static int T_1 F_46 ( struct V_84 * V_23 ,
unsigned int V_18 )
{
...
static int T_1 F_48 ( struct V_84 * V_23 ,
unsigned int V_18 )
{
struct V_9 * V_10 ;
int V_4 ;
...
static int T_3 F_52 ( struct V_84 * V_86 ,
unsigned int V_18 )
{
F_50 ( F_53 ( V_86 ) ) ;
F_51 ( V_86 , NULL ) ;
...
static int T_1 F_56 ( struct V_19 * V_89 ,
...
static void T_3 F_58 ( struct V_19 * V_89 )
{
F_50 ( F_59 ( V_89 ) ) ;
F_57 ( V_89 , NULL ) ;
}
static int F_60 ( struct V_19 * V_89 , T_4 V_88 )
{
