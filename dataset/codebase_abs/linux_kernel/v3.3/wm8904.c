...
F_16 ,
F_15 ) ;
int V_133 , V_31 , V_275 ;
const char * * V_276 ;
V_8 -> V_50 = 0 ;
V_8 -> V_56 = NULL ;
for ( V_31 = 0 ; V_31 < V_29 -> V_53 ; V_31 ++ ) {
for ( V_275 = 0 ; V_275 < V_8 -> V_50 ; V_275 ++ ) {
if ( strcmp ( V_29 -> V_54 [ V_31 ] . V_55 ,
V_8 -> V_56 [ V_275 ] ) == 0 )
break;
}
...
F_8 ( V_2 -> V_16 , L_31 ,
V_8 -> V_50 ) ;
V_8 -> V_274 . V_214 = V_8 -> V_50 ;
V_8 -> V_274 . V_278 = V_8 -> V_56 ;
V_133 = F_32 ( V_2 , & V_273 , 1 ) ;
if ( V_133 != 0 )
F_9 ( V_2 -> V_16 ,
L_32 , V_133 ) ;
}
...
V_8 -> V_281 [ V_31 ] = V_29 -> V_34 [ V_31 ] . V_55 ;
V_8 -> V_280 . V_214 = V_29 -> V_44 ;
V_8 -> V_280 . V_278 = V_8 -> V_281 ;
V_133 = F_32 ( V_2 , & V_273 , 1 ) ;
if ( V_133 != 0 )
F_9 ( V_2 -> V_16 ,
L_36 , V_133 ) ;
...
break;
case V_125 :
memset ( & V_283 . V_284 , 0 , sizeof( V_283 . V_284 ) ) ;
break;
default:
F_9 ( V_2 -> V_16 , L_38 ,
V_8 -> V_114 ) ;
...
V_307 , 0 ) ;
if ( V_8 -> V_29 ) {
for ( V_31 = 0 ; V_31 < V_308 ; V_31 ++ ) {
if ( ! V_29 -> V_309 [ V_31 ] )
continue;
V_249 [ V_310 + V_31 ]
= V_29 -> V_309 [ V_31 ] & 0xffff ;
}
...
static T_3 int F_67 ( struct V_317 * V_318 ,
const struct V_319 * V_320 )
{
struct V_7 * V_8 ;
int V_133 ;
V_8 = F_68 ( sizeof( struct V_7 ) , V_277 ) ;
if ( V_8 == NULL )
return - V_321 ;
V_8 -> V_114 = V_320 -> V_322 ;
F_69 ( V_318 , V_8 ) ;
V_8 -> V_29 = V_318 -> V_16 . V_323 ;
V_133 = F_70 ( & V_318 -> V_16 ,
& V_324 , & V_283 , 1 ) ;
if ( V_133 < 0 )
F_66 ( V_8 ) ;
return V_133 ;
}
static T_4 int F_71 ( struct V_317 * V_325 )
{
F_72 ( & V_325 -> V_16 ) ;
F_66 ( F_73 ( V_325 ) ) ;
return 0 ;
