...
{
struct V_1 * V_2 ;
V_2 = F_27 ( & V_38 , V_37 , V_5 ) ;
return V_2 ? V_2 -> V_22 : NULL ;
}
static void F_38 ( struct V_36 * V_39 )
{
F_10 ( V_39 -> V_27 ) ;
}
...
static struct V_44 * F_42 ( int V_45 , struct V_4 * V_5 ,
struct V_1 * * V_2 )
{
...
if ( F_53 ( ( void T_3 * ) ( unsigned long ) V_52 . V_67 ,
& V_54 , sizeof V_54 ) ) {
V_13 = - V_64 ;
goto V_82;
}
V_48 -> V_83 = V_62 -> V_84 ;
F_54 ( & V_48 -> V_85 , V_48 -> V_59 -> V_60 ,
V_86 ) ;
V_13 = F_55 ( & V_48 -> V_85 ) ;
if ( V_13 )
goto V_82;
...
if ( F_45 ( & V_52 , V_49 , sizeof V_52 ) )
return - V_64 ;
V_13 = F_63 ( V_48 -> V_59 -> V_60 , V_52 . V_133 , & V_90 ) ;
if ( V_13 )
return V_13 ;
memset ( & V_54 , 0 , sizeof V_54 ) ;
...
V_54 . V_153 = F_64 ( V_48 -> V_59 -> V_60 ,
V_52 . V_133 ) ;
if ( F_53 ( ( void T_3 * ) ( unsigned long ) V_52 . V_67 ,
& V_54 , sizeof V_54 ) )
return - V_64 ;
...
static int F_72 ( struct V_161 * V_162 ,
struct V_163 * V_163 ,
struct V_44 * V_164 )
{
...
while ( * V_169 ) {
V_171 = * V_169 ;
V_167 = F_73 ( V_171 , struct V_165 , V_172 ) ;
...
F_74 ( & V_166 -> V_172 , V_171 , V_169 ) ;
F_75 ( & V_166 -> V_172 , & V_162 -> V_170 ) ;
F_76 ( V_163 ) ;
return 0 ;
}
static struct V_165 * F_77 ( struct V_161 * V_162 ,
struct V_163 * V_163 )
{
struct V_165 * V_166 ;
struct V_168 * V_169 = V_162 -> V_170 . V_168 ;
while ( V_169 ) {
V_166 = F_73 ( V_169 , struct V_165 , V_172 ) ;
...
static struct V_44 * F_78 ( struct V_161 * V_162 , struct V_163 * V_163 )
{
struct V_165 * V_166 ;
V_166 = F_77 ( V_162 , V_163 ) ;
if ( ! V_166 )
return NULL ;
return V_166 -> V_164 ;
}
static void F_79 ( struct V_161 * V_162 ,
struct V_163 * V_163 )
{
struct V_165 * V_166 ;
V_166 = F_77 ( V_162 , V_163 ) ;
if ( V_166 ) {
F_80 ( V_163 ) ;
F_81 ( & V_166 -> V_172 , & V_162 -> V_170 ) ;
F_6 ( V_166 ) ;
}
}
T_2 F_82 ( struct V_47 * V_48 ,
...
( unsigned long ) V_52 . V_67 + sizeof V_54 ,
V_50 - sizeof V_52 , V_51 - sizeof V_54 ) ;
F_46 ( & V_48 -> V_59 -> V_181 ) ;
if ( V_52 . V_182 != - 1 ) {
V_179 = F_83 ( V_52 . V_182 ) ;
if ( ! V_179 ) {
V_13 = - V_183 ;
goto V_184;
}
...
if ( V_163 ) {
if ( V_180 ) {
V_13 = F_72 ( V_48 -> V_59 , V_163 , V_164 ) ;
if ( V_13 )
goto V_195;
}
F_85 ( & V_164 -> V_157 ) ;
...
F_58 ( V_179 ) ;
F_46 ( & V_48 -> V_9 ) ;
F_68 ( & V_178 -> V_27 . V_160 , & V_48 -> V_61 -> V_76 ) ;
F_57 ( & V_48 -> V_9 ) ;
V_178 -> V_27 . V_10 = 1 ;
F_13 ( & V_178 -> V_27 . V_9 ) ;
F_57 ( & V_48 -> V_59 -> V_181 ) ;
return V_50 ;
V_159:
if ( V_163 ) {
if ( V_180 )
F_79 ( V_48 -> V_59 , V_163 ) ;
F_86 ( & V_164 -> V_157 ) ;
}
V_195:
...
F_46 ( & V_48 -> V_9 ) ;
F_68 ( & V_178 -> V_27 . V_160 , & V_48 -> V_61 -> V_72 ) ;
F_57 ( & V_48 -> V_9 ) ;
V_178 -> V_27 . V_10 = 1 ;
F_13 ( & V_178 -> V_27 . V_9 ) ;
return V_50 ;
...
static int F_101 ( void T_3 * V_238 , struct V_239 * V_240 )
{
struct V_241 V_242 ;
...
V_242 . V_259 = 0 ;
if ( F_53 ( V_238 , & V_242 , sizeof V_242 ) )
return - V_64 ;
return 0 ;
}
...
V_13 = F_103 ( V_31 , 1 , & V_240 ) ;
if ( V_13 < 0 )
goto V_265;
if ( ! V_13 )
break;
V_13 = F_101 ( V_262 , & V_240 ) ;
if ( V_13 )
goto V_265;
V_262 += sizeof( struct V_241 ) ;
++ V_54 . V_263 ;
}
if ( F_53 ( V_261 , & V_54 , sizeof V_54 ) ) {
V_13 = - V_64 ;
goto V_265;
}
V_13 = V_50 ;
...
if ( V_52 . V_279 == V_280 ) {
V_164 = F_42 ( V_52 . V_24 , V_48 -> V_61 , & V_273 ) ;
if ( ! V_164 ) {
V_13 = - V_65 ;
goto V_211;
}
...
V_178 -> V_277 . V_302 = 0 ;
F_50 ( & V_178 -> V_277 . V_303 ) ;
F_50 ( & V_178 -> V_304 ) ;
if ( V_52 . V_279 == V_280 )
V_39 = F_108 ( V_26 , & V_90 ) ;
else
...
F_67 ( & V_39 -> V_157 , 0 ) ;
F_85 ( & V_26 -> V_157 ) ;
F_85 ( & V_90 . V_291 -> V_157 ) ;
if ( V_90 . V_292 )
F_85 ( & V_90 . V_292 -> V_157 ) ;
if ( V_90 . V_43 )
F_85 ( & V_90 . V_43 -> V_157 ) ;
}
...
F_41 ( V_43 ) ;
F_46 ( & V_48 -> V_9 ) ;
F_68 ( & V_178 -> V_277 . V_27 . V_160 , & V_48 -> V_61 -> V_73 ) ;
F_57 ( & V_48 -> V_9 ) ;
...
if ( F_45 ( & V_52 , V_49 , sizeof V_52 ) )
return - V_64 ;
V_90 = F_66 ( sizeof *V_90 , V_15 ) ;
V_313 = F_66 ( sizeof *V_313 , V_15 ) ;
if ( ! V_90 || ! V_313 ) {
V_13 = - V_16 ;
goto V_196;
}
...
V_13 = F_113 ( V_39 , V_90 , V_52 . V_314 , V_313 ) ;
F_38 ( V_39 ) ;
if ( V_13 )
goto V_196;
memset ( & V_54 , 0 , sizeof V_54 ) ;
...
static int F_114 ( enum V_350 V_279 , int V_351 )
{
switch ( V_279 ) {
case V_282 :
...
if ( F_45 ( & V_52 , V_49 , sizeof V_52 ) )
return - V_64 ;
F_47 ( & V_56 , V_49 + sizeof V_52 , NULL , V_50 - sizeof V_52 ,
V_51 ) ;
V_90 = F_66 ( sizeof *V_90 , V_15 ) ;
if ( ! V_90 )
return - V_16 ;
...
F_114 ( V_39 -> V_279 , V_52 . V_314 ) , & V_56 ) ;
} else {
V_13 = F_116 ( V_39 , V_90 , F_114 ( V_39 -> V_279 , V_52 . V_314 ) ) ;
}
F_38 ( V_39 ) ;
if ( V_13 )
goto V_196;
...
V_366 = F_66 ( F_121 ( sizeof *V_366 , sizeof ( struct V_377 ) ) +
...
F_121 ( sizeof *V_366 , sizeof ( struct V_377 ) ) ;
if ( F_45 ( V_366 -> V_396 ,
V_49 + sizeof V_52 +
...
static struct V_398 * F_122 ( const char T_3 * V_49 ,
int V_50 ,
T_5 V_372 ,
T_5 V_373 ,
T_5 V_371 )
...
return F_123 ( - V_65 ) ;
V_362 = F_66 ( V_371 , V_15 ) ;
if ( ! V_362 )
return F_123 ( - V_16 ) ;
V_369 = 0 ;
V_365 = NULL ;
for ( V_368 = 0 ; V_368 < V_372 ; ++ V_368 ) {
if ( F_45 ( V_362 , V_49 + V_368 * V_371 ,
V_371 ) ) {
V_13 = - V_64 ;
goto V_66;
}
...
V_13 = F_132 ( V_39 , & V_408 -> V_410 , V_52 . V_409 ) ;
if ( ! V_13 )
F_68 ( & V_408 -> V_160 , & V_178 -> V_304 ) ;
else
F_6 ( V_408 ) ;
V_265:
F_39 ( V_39 ) ;
...
if ( ! V_39 )
return - V_65 ;
V_13 = F_134 ( V_39 , (union V_411 * ) V_52 . V_410 , V_52 . V_409 ) ;
if ( V_13 )
goto V_265;
V_178 = F_7 ( V_39 -> V_27 , struct V_271 , V_277 . V_27 ) ;
F_131 (mcast, &obj->mcast_list, list)
...
V_90 . V_418 . V_419 . V_164 = F_42 ( V_52 -> V_45 , V_48 -> V_61 , & V_273 ) ;
if ( ! V_90 . V_418 . V_419 . V_164 ) {
V_13 = - V_65 ;
goto V_421;
}
V_178 -> V_422 = F_7 ( V_273 , struct V_177 , V_27 ) ;
F_85 ( & V_178 -> V_422 -> V_194 ) ;
}
V_90 . V_85 = V_423 ;
V_90 . V_424 = V_48 ;
...
F_85 ( & V_90 . V_418 . V_419 . V_31 -> V_157 ) ;
F_85 ( & V_90 . V_418 . V_419 . V_164 -> V_157 ) ;
}
F_85 ( & V_26 -> V_157 ) ;
F_67 ( & V_43 -> V_157 , 0 ) ;
...
F_31 ( V_26 ) ;
F_46 ( & V_48 -> V_9 ) ;
F_68 ( & V_178 -> V_277 . V_27 . V_160 , & V_48 -> V_61 -> V_74 ) ;
F_57 ( & V_48 -> V_9 ) ;
V_178 -> V_277 . V_27 . V_10 = 1 ;
F_13 ( & V_178 -> V_277 . V_27 . V_9 ) ;
return 0 ;
