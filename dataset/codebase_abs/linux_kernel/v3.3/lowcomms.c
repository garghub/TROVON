...
F_38 ( & V_125 . V_134 , 0 , & V_80 ) ;
if ( F_55 ( & V_125 . V_134 , & V_8 ) ) {
...
V_127 -> V_52 = F_57 ( V_128 . V_138 , & V_130 ) ;
if ( ! V_127 -> V_52 ) {
F_50 ( L_9 , V_130 ) ;
return;
}
...
static int F_59 ( struct V_10 * V_14 )
{
int V_98 = 0 ;
struct V_93 V_113 = {} ;
...
int V_145 = 0 ;
int V_146 ;
char V_147 [ F_44 ( sizeof( struct V_92 ) ) ] ;
F_20 ( & V_14 -> V_19 ) ;
if ( V_14 -> V_52 == NULL ) {
V_98 = - V_148 ;
goto V_149;
...
F_50 ( L_13
L_14 ,
F_61 ( V_14 -> V_88 ) , V_14 -> V_2 . V_5 , V_14 -> V_2 . V_4 ,
...
static int F_64 ( struct V_10 * V_14 )
{
int V_159 ;
struct V_37 V_160 ;
struct V_72 * V_161 ;
...
F_21 ( & V_162 -> V_19 ) ;
if ( ! F_27 ( V_55 , & V_163 -> V_56 ) )
F_28 ( V_57 , & V_163 -> V_24 ) ;
F_21 ( & V_14 -> V_19 ) ;
return 0 ;
V_167:
F_21 ( & V_14 -> V_19 ) ;
...
V_175 = F_75 ( & V_14 -> V_20 , struct V_174 , V_17 ) ;
V_4 = V_175 -> V_4 ;
V_179 = V_175 -> V_179 ;
F_74 ( & V_14 -> V_21 ) ;
V_144 [ 0 ] . V_154 = F_61 ( V_175 -> V_176 ) + V_179 ;
V_144 [ 0 ] . V_153 = V_4 ;
V_96 = F_46 ( & V_94 ) ;
V_96 -> V_105 = V_106 ;
V_96 -> V_107 = V_108 ;
...
V_97 = F_48 ( V_96 ) ;
memset ( V_97 , 0x00 , sizeof( struct V_92 ) ) ;
V_97 -> V_183 = F_76 ( F_36 () ) ;
V_94 . V_102 = V_96 -> V_109 ;
V_98 = F_49 ( V_178 -> V_52 , & V_94 , V_144 , 1 , V_4 ) ;
if ( V_98 < 0 ) {
F_50 ( L_22 ,
V_14 -> V_8 , V_98 ) ;
F_30 ( V_65 , & V_14 -> V_56 ) ;
...
F_38 ( & V_78 , V_68 . V_182 , & V_80 ) ;
F_50 ( L_25 , V_14 -> V_8 ) ;
F_79 ( V_52 , V_191 , V_192 , ( char * ) & V_187 ,
sizeof( V_187 ) ) ;
V_159 =
...
if ( V_159 < 0 ) {
F_50 ( L_28 , V_68 . V_182 ) ;
F_41 ( V_52 ) ;
V_52 = NULL ;
V_14 -> V_52 = NULL ;
goto V_199;
}
V_159 = F_79 ( V_52 , V_200 , V_202 ,
( char * ) & V_187 , sizeof( V_187 ) ) ;
if ( V_159 < 0 ) {
F_50 ( L_29 , V_159 ) ;
}
...
static int F_84 ( struct V_10 * V_206 ,
struct V_37 * V_38 ,
int V_80 , int V_207 )
{
int V_159 = 0 ;
if ( V_207 == 1 )
V_159 = F_85 ( V_206 -> V_52 ,
(struct V_35 * ) V_38 ,
V_80 ) ;
else
V_159 = F_79 ( V_206 -> V_52 , V_208 ,
V_209 ,
( char * ) V_38 , V_80 ) ;
if ( V_159 < 0 )
F_50 ( L_31 ,
...
V_212 . V_219 = 1 ;
V_212 . V_220 = 1 ;
V_159 = F_79 ( V_52 , V_200 , V_221 ,
( char * ) & V_213 , sizeof( V_213 ) ) ;
if ( V_159 )
F_50 ( L_34 , V_159 ) ;
V_159 = F_79 ( V_52 , V_208 , V_222 ,
...
F_38 ( & V_210 , V_68 . V_182 , & V_80 ) ;
V_159 = F_84 ( V_14 , & V_210 , V_80 , V_207 ) ;
if ( V_159 )
goto V_223;
++ V_207 ;
}
...
static struct V_174 * F_88 ( struct V_10 * V_14 ,
T_1 V_31 )
{
struct V_174 * V_225 ;
V_225 = F_83 ( sizeof( struct V_174 ) , V_31 ) ;
if ( ! V_225 )
return NULL ;
V_225 -> V_176 = F_60 ( V_31 ) ;
if ( ! V_225 -> V_176 ) {
F_70 ( V_225 ) ;
return NULL ;
}
...
void * F_89 ( int V_8 , int V_4 , T_1 V_31 , char * * V_227 )
{
struct V_10 * V_14 ;
struct V_174 * V_175 ;
int V_179 = 0 ;
...
return NULL ;
F_72 ( & V_14 -> V_21 ) ;
V_175 = F_90 ( V_14 -> V_20 . V_228 , struct V_174 , V_17 ) ;
...
if ( V_175 ) {
V_229:
* V_227 = F_61 ( V_175 -> V_176 ) + V_179 ;
return V_175 ;
}
V_175 = F_88 ( V_14 , V_31 ) ;
if ( V_175 ) {
F_72 ( & V_14 -> V_21 ) ;
V_179 = V_175 -> V_226 ;
V_175 -> V_226 += V_4 ;
V_184 = V_175 -> V_184 ++ ;
F_91 ( & V_175 -> V_17 , & V_14 -> V_20 ) ;
F_74 ( & V_14 -> V_21 ) ;
goto V_229;
}
return NULL ;
}
void F_92 ( void * V_230 )
{
...
F_72 ( & V_14 -> V_21 ) ;
for (; ; ) {
V_175 = F_90 ( V_14 -> V_20 . V_233 , struct V_174 ,
V_17 ) ;
if ( (struct V_234 * ) V_175 == & V_14 -> V_20 )
break;
V_4 = V_175 -> V_4 ;
V_179 = V_175 -> V_179 ;
F_45 ( V_4 == 0 && V_175 -> V_184 == 0 ) ;
F_74 ( & V_14 -> V_21 ) ;
V_98 = 0 ;
if ( V_4 ) {
V_98 = F_94 ( V_14 -> V_52 , V_175 -> V_176 , V_179 , V_4 ,
V_103 ) ;
if ( V_98 == - V_148 || V_98 == 0 ) {
if ( V_98 == - V_148 &&
F_33 ( V_61 , & V_14 -> V_52 -> V_56 ) &&
! F_27 ( V_59 , & V_14 -> V_56 ) ) {
F_67 ( V_58 , & V_14 -> V_52 -> V_56 ) ;
V_14 -> V_52 -> V_53 -> V_60 ++ ;
}
F_95 () ;
goto V_188;
...
{
struct V_10 * V_14 = F_100 ( V_239 , struct V_10 , V_24 ) ;
int V_130 ;
F_30 ( V_55 , & V_14 -> V_56 ) ;
do {
...
{
struct V_10 * V_14 = F_100 ( V_239 , struct V_10 , V_22 ) ;
if ( F_31 ( V_65 , & V_14 -> V_56 ) ) {
V_14 -> V_27 ( V_14 ) ;
F_67 ( V_62 , & V_14 -> V_56 ) ;
}
...
error = - V_71 ;
V_16 = F_114 ( L_48 , sizeof( struct V_10 ) ,
F_115 ( struct V_10 ) , 0 ,
NULL ) ;
if ( ! V_16 )
goto V_188;
