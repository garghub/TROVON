...
default:
F_39 ( L_49 ,
V_17 [ V_152 ] , F_64 ( V_5 -> V_99 . V_100 ) ,
V_5 -> V_99 . V_153 ) ;
return - V_104 ;
}
F_39 ( L_50 , V_151 ,
F_64 ( V_5 -> V_99 . V_100 ) , V_5 -> V_99 . V_153 ) ;
return 0 ;
}
...
{
struct V_4 * V_5 = V_2 -> V_6 ;
V_5 -> V_156 = ( V_155 ) ? V_155 -> V_156 : V_157 ;
V_5 -> V_13 = ( V_155 ) ? V_155 -> V_13 : V_40 ;
V_5 -> V_95 = ( V_155 ) ? V_155 -> V_95 : 0 ;
V_5 -> V_158 = ( V_155 ) ?
V_155 -> V_158 : V_159 ;
V_5 -> V_8 = ( V_155 ) ?
V_155 -> V_8 : V_160 ;
...
static inline int F_66 ( struct V_154 * V_155 )
{
return ( ( V_161 == - 1 ) ?
( ( V_155 ) && ( V_155 -> V_162 ) ) :
( V_161 ) ) ? 1 : 0 ;
}
static int F_67 ( struct V_1 * V_2 , void * V_163 )
{
struct V_154 * V_155 = (struct V_154 * ) V_163 ;
F_65 ( V_2 , V_155 ) ;
if ( F_66 ( V_155 ) )
F_44 ( V_2 ) ;
if ( ( V_155 ) && ( V_155 -> V_114 ) )
F_61 ( V_2 , V_155 -> V_114 ) ;
return 0 ;
}
struct V_1 * F_68 ( struct V_1 * V_2 , T_2 V_153 ,
struct V_164 * V_165 ,
struct V_154 * V_155 )
{
struct V_4 * V_5 = NULL ;
...
V_2 -> V_6 = V_5 ;
if ( V_155 ) {
if ( V_155 -> V_156 != V_168 )
V_5 -> V_156 = V_155 -> V_156 ;
if ( V_155 -> V_13 )
V_5 -> V_13 = V_155 -> V_13 ;
if ( V_155 -> V_95 )
V_5 -> V_95 = V_155 -> V_95 ;
if ( V_155 -> V_158 )
V_5 -> V_158 = V_155 -> V_158 ;
if ( V_155 -> V_8 )
V_5 -> V_8 = V_155 -> V_8 ;
if ( V_155 -> V_114 )
F_61 ( V_2 , V_155 -> V_114 ) ;
