...
static int T_3 F_20 ( struct V_147 * V_148 ,
const struct V_149 * V_150 )
{
struct V_94 * V_95 ;
int V_96 ;
V_95 = F_21 ( & V_148 -> V_10 , sizeof( struct V_94 ) ,
V_151 ) ;
if ( ! V_95 )
return - V_152 ;
F_22 ( V_148 , V_95 ) ;
V_95 -> V_98 = V_153 ;
V_96 = F_23 ( & V_148 -> V_10 ,
& V_154 , & V_155 , 1 ) ;
return V_96 ;
}
static int T_4 F_24 ( struct V_147 * V_156 )
{
F_25 ( & V_156 -> V_10 ) ;
return 0 ;
}
