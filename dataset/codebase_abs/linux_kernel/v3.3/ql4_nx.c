...
V_148 = F_18 ( V_2 , V_165 + 0xe4 ) ;
V_148 |= ( 1 << 1 ) ;
F_11 ( V_2 , V_165 + 0xe4 , V_148 ) ;
F_56 ( 20 ) ;
V_148 = F_18 ( V_2 , V_165 + 0xe4 ) ;
V_148 &= ~ ( 1 << 1 ) ;
F_11 ( V_2 , V_165 + 0xe4 , V_148 ) ;
...
F_9 ( V_62 , V_2 ,
L_18 , V_112 , V_151 ) ;
V_150 = F_58 ( V_151 * sizeof( struct V_149 ) , V_166 ) ;
if ( V_150 == NULL ) {
F_9 ( V_100 , V_2 ,
L_19 , V_112 ) ;
return - 1 ;
...
F_59 ( V_150 ) ;
F_11 ( V_2 , V_172 + 0xec , 0x1e ) ;
F_11 ( V_2 , V_172 + 0x4c , 8 ) ;
F_11 ( V_2 , V_173 + 0x4c , 8 ) ;
...
T_4 V_65 ;
T_3 V_178 , V_179 ;
V_176 = V_177 = V_2 -> V_180 . V_181 ;
V_94 = ( V_174 - V_176 ) / 8 ;
F_8 ( F_32 ( L_22 ,
V_2 -> V_182 , V_63 , V_176 , V_174 ) ) ;
for ( V_69 = 0 ; V_69 < V_94 ; V_69 ++ ) {
if ( ( F_54 ( V_2 , V_176 , ( int * ) & V_179 ) ) ||
( F_54 ( V_2 , V_176 + 4 ,
( int * ) & V_178 ) ) ) {
V_175 = - 1 ;
goto V_183;
}
V_65 = ( ( T_4 ) V_178 << 32 ) | V_179 ;
V_175 = F_62 ( V_2 , V_177 , & V_65 , 8 ) ;
if ( V_175 )
goto V_183;
V_176 += 8 ;
V_177 += 8 ;
...
static int F_65 ( struct V_1 * V_2 , T_5 V_174 )
{
T_3 V_184 ;
F_11 ( V_2 , V_185 , 0 ) ;
if ( F_55 ( V_2 , 0 ) != V_186 ) {
...
F_53 ( 500 ) ;
V_184 = F_18 ( V_2 , V_164 ) ;
V_184 &= ~ ( 1 << 28 ) ;
F_11 ( V_2 , V_164 , V_184 ) ;
if ( F_61 ( V_2 , V_174 ) ) {
F_32 ( L_24 , V_63 ) ;
return V_187 ;
}
...
T_4 V_3 , void * V_65 , int V_94 )
{
int V_69 , V_188 = 0 , V_189 , V_117 , V_190 , V_191 , V_192 [ 2 ] , V_193 [ 2 ] ;
int V_194 ;
T_5 V_195 ;
T_6 V_196 , V_148 , V_197 , V_198 [ 2 ] = { 0 , 0 } ;
...
V_193 [ 0 ] = V_3 & 0xf ;
V_192 [ 0 ] = ( V_94 < ( 16 - V_193 [ 0 ] ) ) ? V_94 : ( 16 - V_193 [ 0 ] ) ;
V_194 = 4 ;
V_191 = ( ( V_193 [ 0 ] + V_94 - 1 ) >> V_194 ) + 1 ;
V_193 [ 1 ] = 0 ;
V_192 [ 1 ] = V_94 - V_192 [ 0 ] ;
for ( V_69 = 0 ; V_69 < V_191 ; V_69 ++ ) {
V_195 = V_196 + ( V_69 << V_194 ) ;
F_11 ( V_2 , V_197 + V_199 , V_195 ) ;
V_195 = 0 ;
F_11 ( V_2 , V_197 + V_200 , V_195 ) ;
V_195 = V_201 ;
F_11 ( V_2 , V_197 + V_202 , V_195 ) ;
V_195 = V_203 | V_201 ;
F_11 ( V_2 , V_197 + V_202 , V_195 ) ;
for ( V_188 = 0 ; V_188 < V_204 ; V_188 ++ ) {
V_195 = F_18 ( V_2 , V_197 + V_202 ) ;
if ( ( V_195 & V_205 ) == 0 )
break;
}
if ( V_188 >= V_204 ) {
...
V_117 = V_193 [ V_69 ] >> 2 ;
V_190 = ( V_193 [ V_69 ] + V_192 [ V_69 ] - 1 ) >> 2 ;
for ( V_189 = V_117 ; V_189 <= V_190 ; V_189 ++ ) {
V_195 = F_18 ( V_2 ,
V_197 + F_68 ( V_189 ) ) ;
V_198 [ V_69 ] |= ( ( T_6 ) V_195 << ( 32 * ( V_189 & 1 ) ) ) ;
}
}
if ( V_188 >= V_204 )
return - 1 ;
...
V_148 = ( ( V_198 [ 0 ] >> ( V_193 [ 0 ] * 8 ) ) & ( ~ ( ~ 0ULL << ( V_192 [ 0 ] * 8 ) ) ) ) |
...
T_4 V_3 , void * V_65 , int V_94 )
{
int V_69 , V_188 , V_116 = 0 , V_191 , V_192 [ 2 ] , V_193 ;
int V_208 , V_194 , V_209 ;
T_5 V_195 ;
T_6 V_196 , V_197 , V_210 , V_198 [ 2 ] = { 0 , 0 } ;
if ( V_3 >= V_106 && V_3 <= V_107 )
V_197 = V_165 ;
else {
V_197 = V_171 ;
...
V_193 = V_3 & 0x7 ;
V_192 [ 0 ] = ( V_94 < ( 8 - V_193 ) ) ? V_94 : ( 8 - V_193 ) ;
V_192 [ 1 ] = V_94 - V_192 [ 0 ] ;
V_196 = V_3 & 0xfffffff0 ;
V_191 = ( ( ( V_3 & 0xf ) + V_94 - 1 ) >> 4 ) + 1 ;
V_194 = 4 ;
V_208 = 2 ;
V_209 = ( V_3 & 0xf ) / 8 ;
for ( V_69 = 0 ; V_69 < V_191 ; V_69 ++ ) {
if ( F_66 ( V_2 , V_196 +
( V_69 << V_194 ) , & V_198 [ V_69 * V_208 ] , 8 ) )
return - 1 ;
}
switch ( V_94 ) {
case 1 :
...
V_198 [ V_209 ] |= V_210 << ( V_193 * 8 ) ;
}
if ( V_192 [ 1 ] != 0 ) {
V_198 [ V_209 + 1 ] &= ~ ( ~ 0ULL << ( V_192 [ 1 ] * 8 ) ) ;
V_198 [ V_209 + 1 ] |= V_210 >> ( V_192 [ 0 ] * 8 ) ;
}
for ( V_69 = 0 ; V_69 < V_191 ; V_69 ++ ) {
V_195 = V_196 + ( V_69 << V_194 ) ;
F_11 ( V_2 , V_197 + V_199 , V_195 ) ;
V_195 = 0 ;
F_11 ( V_2 , V_197 + V_200 , V_195 ) ;
V_195 = V_198 [ V_69 * V_208 ] & 0xffffffff ;
F_11 ( V_2 , V_197 + V_211 , V_195 ) ;
V_195 = ( V_198 [ V_69 * V_208 ] >> 32 ) & 0xffffffff ;
F_11 ( V_2 , V_197 + V_212 , V_195 ) ;
V_195 = V_198 [ V_69 * V_208 + 1 ] & 0xffffffff ;
F_11 ( V_2 , V_197 + V_213 ,
V_195 ) ;
V_195 = ( V_198 [ V_69 * V_208 + 1 ] >> 32 ) & 0xffffffff ;
F_11 ( V_2 , V_197 + V_214 ,
V_195 ) ;
V_195 = V_201 | V_215 ;
F_11 ( V_2 , V_197 + V_202 , V_195 ) ;
V_195 = V_203 | V_201 | V_215 ;
F_11 ( V_2 , V_197 + V_202 , V_195 ) ;
for ( V_188 = 0 ; V_188 < V_204 ; V_188 ++ ) {
V_195 = F_18 ( V_2 , V_197 + V_202 ) ;
if ( ( V_195 & V_205 ) == 0 )
...
F_9 ( V_62 , V_2 ,
L_33 ) ;
V_175 = F_79 ( V_2 , V_2 -> V_180 . V_239 ) ;
if ( V_175 != V_186 ) {
F_9 ( V_121 , V_2 , L_34
L_35 ) ;
return V_175 ;
...
F_9 ( V_62 , V_2 , L_43 , V_254 ,
V_254 < V_262 ? V_263 [ V_254 ] : L_44 ) ;
if ( V_254 != V_250 ) {
F_9 ( V_62 , V_2 , L_45 ) ;
...
F_7 ( & V_2 -> V_273 -> V_274 ) ;
V_272 = F_92 ( V_2 ) ;
if ( V_272 == V_186 && ! F_57 ( V_266 , & V_2 -> V_66 ) )
V_272 = F_95 ( V_2 ) ;
return V_272 ;
}
static inline T_5
F_96 ( struct V_275 * V_180 , T_5 V_276 )
{
return V_180 -> V_277 | V_276 ;
}
static inline T_5
F_97 ( struct V_275 * V_180 , T_5 V_276 )
{
return V_180 -> V_278 | V_276 ;
}
static T_5 *
...
V_282 = V_283 [ 0 ] ;
* V_117 = V_284 ;
F_8 ( F_9 ( V_62 , V_2 , L_53 , V_282 , * V_117 ) ) ;
return V_186 ;
}
static void
...
L_59 , F_106 ( V_292 -> V_300 ) , V_117 ,
F_106 ( V_292 -> V_190 ) >> 2 , F_106 ( V_292 -> V_94 ) ) ) ;
...
L_61 , V_282 , V_180 -> V_293 ,
V_180 -> V_302 , V_180 -> V_304 , V_180 -> V_181 ,
V_180 -> V_239 ) ) ;
}
static void
...
V_180 -> V_328 = V_320 -> V_329 ;
V_180 -> V_330 = F_96 ( V_180 , 0x0300 | V_320 -> V_331 ) ;
V_180 -> V_332 = F_106 ( V_320 -> V_333 ) ;
if ( V_320 -> V_334 ) {
V_180 -> V_335 = F_96 ( V_180 , 0x0300 |
V_320 -> V_334 ) ;
V_180 -> V_336 = V_320 -> V_337 ?
F_96 ( V_180 , 0x0300 | V_320 -> V_337 ) :
F_96 ( V_180 , 0x0336 ) ;
}
goto V_70;
V_296:
...
V_180 -> V_330 , V_180 -> V_336 ,
V_180 -> V_335 , V_180 -> V_328 ,
V_180 -> V_332 ) ) ;
}
static void
