...
static int F_25 ( struct V_56 * V_57 , unsigned int V_4 )
{
int V_58 = F_26 ( V_57 -> V_59 ) ;
T_4 V_60 ;
if ( V_58 >= 0 && V_58 < 128 )
return F_27 ( V_58 , V_4 ) ;
if ( V_57 -> V_59 == V_61 )
return F_28 ( V_4 ) ;
switch ( V_57 -> V_59 ) {
case V_62 :
...
V_71 = V_44 ;
F_40 ( V_72 , F_41 ( V_72 ) ) ;
if ( ( V_70 = F_42 ( V_73 , 32 ) ) )
return V_70 ;
F_24 () ;
F_43 ( & V_74 ) ;
F_43 ( & V_75 ) ;
F_43 ( & V_76 ) ;
V_70 = F_44 ( V_77 , F_41 ( V_77 ) ) ;
}
return V_70 ;
}
