...
F_6 ( V_12 , L_69 ,
V_71 -> V_86 . V_157 ) ;
V_71 -> V_35 = F_83 ( V_71 -> V_86 . V_157 ) ;
if ( ! V_71 -> V_35 ) {
F_17 ( V_12 , L_70
L_71 ,
V_71 -> V_86 . V_157 ) ;
...
static int
F_85 ( struct V_11 * V_12 , int * V_106 , char * V_113 )
{
if ( ! ( * V_106 & V_174 ) )
return - V_146 ;
return 0 ;
...
static int
F_86 ( struct V_25 * V_25 , struct V_185 * V_186 )
{
struct V_11 * V_12 = V_25 -> V_132 ;
T_16 V_187 = F_87 ( V_12 -> V_188 -> V_189 ) ;
F_6 ( V_12 , L_73 ) ;
V_186 -> V_190 = V_180 ;
...
static struct V_25 *
F_88 ( struct V_203 * V_204 , int V_106 , const char * V_205 ,
void * V_113 )
{
return F_89 ( V_204 , V_106 , V_205 , V_113 , F_71 ) ;
}
static int T_17
F_90 ( void )
{
