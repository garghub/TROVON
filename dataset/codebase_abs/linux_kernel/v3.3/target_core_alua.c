...
switch ( V_89 ) {
case V_94 :
return F_20 ( V_4 , V_62 ,
V_63 , V_64 ) ;
case V_95 :
return F_21 ( V_4 , V_62 , V_64 ) ;
case V_96 :
...
V_108 = F_32 ( V_104 , V_111 , 0600 ) ;
if ( F_33 ( V_108 ) || ! V_108 || ! V_108 -> V_116 ) {
F_11 ( L_19 ,
V_104 ) ;
return - V_117 ;
}
...
V_107 = F_34 () ;
F_35 ( F_36 () ) ;
V_115 = F_37 ( V_108 , & V_110 [ 0 ] , 1 , & V_108 -> V_120 ) ;
F_35 ( V_107 ) ;
if ( V_115 < 0 ) {
F_11 ( L_20 , V_104 ) ;
F_38 ( V_108 , NULL ) ;
...
L_24 , & V_125 -> V_128 [ 0 ] ,
F_40 ( & V_13 -> V_129 . V_130 ) ) ;
return F_31 ( V_104 , V_105 , V_44 ) ;
}
static int F_41 (
struct V_12 * V_13 ,
struct V_10 * V_35 ,
...
F_42 ( & V_13 -> V_25 , V_131 ) ;
F_12 ( L_25
L_26 , ( V_132 ) ? L_27 :
L_28 , F_40 ( & V_13 -> V_129 . V_130 ) ,
V_13 -> V_26 , F_26 ( V_138 ) ,
F_26 ( V_131 ) ) ;
return 0 ;
}
int F_16 (
...
struct V_149 *
F_51 ( const char * V_179 , int V_180 )
{
struct V_149 * V_150 ;
V_150 = F_52 ( V_181 , V_154 ) ;
if ( ! V_150 ) {
F_11 ( L_44 ) ;
return F_53 ( - V_155 ) ;
}
...
int F_56 ( struct V_149 * V_150 , T_2 V_159 )
{
struct V_149 * V_187 ;
T_2 V_188 ;
if ( V_150 -> V_185 ) {
...
struct V_149 * F_66 ( const char * V_179 )
{
struct V_149 * V_150 ;
struct V_201 * V_202 ;
F_4 ( & V_189 ) ;
...
F_62 () ;
F_4 ( & V_13 -> V_28 ) ;
F_63 (tg_pt_gp_mem, tg_pt_gp_mem_tmp,
...
T_5 F_79 ( struct V_10 * V_11 , char * V_220 )
{
struct V_6 * V_7 = V_11 -> V_173 -> V_219 -> V_9 ;
struct V_201 * V_221 ;
struct V_21 * V_198 = & V_7 -> V_21 ;
...
T_5 F_91 ( struct V_36 * V_88 , char * V_220 )
{
if ( ! V_88 -> V_37 )
return - V_117 ;
...
int F_97 ( struct V_33 * V_34 , int V_231 )
{
struct V_6 * V_7 = V_34 -> V_9 ;
struct V_21 * V_198 = & V_7 -> V_21 ;
struct V_151 * V_152 ;
