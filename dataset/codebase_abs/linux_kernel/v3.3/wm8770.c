...
V_38 -> V_79 [ 0 ] . V_80 = V_81 ;
V_38 -> V_79 [ 1 ] . V_80 = V_82 ;
V_38 -> V_79 [ 2 ] . V_80 = V_83 ;
for ( V_39 = 0 ; V_39 < F_11 ( V_38 -> V_73 ) ; V_39 ++ ) {
V_66 = F_26 ( V_38 -> V_73 [ V_39 ] . V_84 ,
& V_38 -> V_79 [ V_39 ] ) ;
if ( V_66 ) {
F_13 ( V_7 -> V_51 ,
L_6 ,
...
F_18 ( V_7 , V_72 ) ;
for ( V_39 = 0 ; V_39 < F_11 ( V_38 -> V_73 ) ; ++ V_39 )
F_32 ( V_38 -> V_73 [ V_39 ] . V_84 ,
& V_38 -> V_79 [ V_39 ] ) ;
F_30 ( F_11 ( V_38 -> V_73 ) , V_38 -> V_73 ) ;
return 0 ;
}
static int T_2 F_33 ( struct V_100 * V_101 )
{
struct V_37 * V_38 ;
int V_66 ;
V_38 = F_34 ( & V_101 -> V_51 , sizeof( struct V_37 ) ,
V_102 ) ;
if ( ! V_38 )
return - V_103 ;
V_38 -> V_76 = V_104 ;
F_35 ( V_101 , V_38 ) ;
V_66 = F_36 ( & V_101 -> V_51 ,
& V_105 , & V_106 , 1 ) ;
return V_66 ;
}
static int T_3 F_37 ( struct V_100 * V_101 )
{
F_38 ( & V_101 -> V_51 ) ;
return 0 ;
}
