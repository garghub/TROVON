...
V_2 -> V_14 = ! ! ( V_8 -> V_42 . V_44 . V_45 ) ;
V_2 -> V_18 = ( V_8 -> V_46 % 2 ) == 1 ;
V_2 -> V_19 = ( ( V_8 -> V_46 >> 1 ) % 2 ) == 1 ;
if ( F_11 ( V_8 -> V_15 ) ) {
if ( ! F_24 ( V_8 -> V_15 , L_3 ) )
F_25 ( V_8 -> V_15 , V_2 -> V_14 ) ;
else
V_36 = 1 ;
} else
V_36 = 2 ;
...
if ( F_11 ( V_8 -> V_23 ) &&
F_11 ( V_8 -> V_24 ) ) {
if ( ! F_24 ( V_8 -> V_23 , L_6 ) )
F_25 ( V_8 -> V_23 ,
( V_8 -> V_46 ) % 2 ) ;
else
V_36 = 1 ;
if ( ! F_24 ( V_8 -> V_24 , L_7 ) )
F_25 ( V_8 -> V_24 ,
( V_8 -> V_46 >> 1 ) % 2 ) ;
else {
if ( ! V_36 )
...
static int T_4 F_31 ( struct V_27 * V_5 )
{
