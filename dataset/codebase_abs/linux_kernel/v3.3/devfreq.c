...
V_1 = F_29 ( sizeof( struct V_1 ) , V_49 ) ;
if ( ! V_1 ) {
F_25 ( V_3 , L_8 ,
V_5 ) ;
V_11 = - V_50 ;
...
{
return sprintf ( V_63 , L_9 , F_22 ( V_3 ) -> V_13 -> V_40 ) ;
}
static T_1 F_39 ( struct V_2 * V_3 ,
struct V_61 * V_62 , char * V_63 )
{
return sprintf ( V_63 , L_10 , F_22 ( V_3 ) -> V_17 ) ;
}
static T_1 F_40 ( struct V_2 * V_3 ,
struct V_61 * V_62 , char * V_63 )
{
return sprintf ( V_63 , L_11 , F_22 ( V_3 ) -> V_15 -> V_55 ) ;
}
static T_1 F_41 ( struct V_2 * V_3 ,
struct V_61 * V_62 ,
const char * V_63 , T_2 V_64 )
{
struct V_1 * V_65 = F_22 ( V_3 ) ;
unsigned int V_66 ;
int V_21 ;
V_21 = sscanf ( V_63 , L_12 , & V_66 ) ;
if ( V_21 != 1 )
goto V_27;
F_12 ( & V_65 -> V_12 ) ;
V_65 -> V_15 -> V_55 = V_66 ;
...
struct V_70 * F_51 ( struct V_2 * V_3 , unsigned long * V_10 )
{
struct V_70 * V_70 = F_52 ( V_3 , V_10 ) ;
if ( V_70 == F_5 ( - V_9 ) )
V_70 = F_53 ( V_3 , V_10 ) ;
return V_70 ;
}
...
{
struct V_71 * V_72 = F_55 ( V_3 ) ;
if ( F_26 ( V_72 ) )
return F_48 ( V_72 ) ;
return F_56 ( V_72 , & V_1 -> V_19 ) ;
}
