...
int V_36 ;
F_2 () ;
if ( ( sizeof( V_51 ) / sizeof( struct V_49 ) ) !=
( sizeof( V_52 ) / sizeof( const char * ) ) ) {
F_39 ( L_13 ) ;
return - V_21 ;
}
...
for ( V_36 = 0 ; V_36 < ( sizeof( V_51 ) /
sizeof( struct V_49 ) ) ; V_36 ++ ) {
if ( V_50 == & V_51 [ V_36 ] )
V_31 -> V_53 = V_52 [ V_36 ] ;
}
if ( V_31 -> V_53 == NULL )
V_31 -> V_53 = L_15 ;
V_31 -> V_2 . V_54 = & V_55 ;
V_31 -> V_2 . V_56 = & V_31 -> V_2 . V_57 . V_58 . V_59 ;
V_31 -> V_2 . V_60 = & V_31 -> V_2 . V_57 . V_58 . V_61 ;
F_41 ( & V_31 -> V_44 ) ;
F_34 ( V_46 , ( void * ) V_31 ) ;
V_31 -> V_2 . V_8 = F_42 ( F_43 ( V_46 ) ) ;
V_7 = F_44 ( V_46 , & V_47 ) ;
if ( V_7 < 0 ) {
V_25 ( L_16 ,
V_30 , V_7 ) ;
...
static int F_46 ( struct V_63 * V_63 , struct V_64 * V_64 )
{
int V_7 = 0 , V_65 = 0 ;
