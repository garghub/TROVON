...
V_37 -> V_37 . V_42 = F_19 (
V_15 , V_8 -> V_43 , & V_39 ) ;
V_37 -> V_37 . V_44 = V_39 . V_44 ;
V_37 -> V_37 . V_45 = V_39 . V_45 ;
F_20 ( & V_37 -> V_46 . V_47 ,
& V_37 -> V_46 . V_48 -> V_49 ) ;
F_21 ( & V_37 -> V_46 . V_48 -> V_50 ) ;
F_22 ( & V_15 -> V_41 , V_40 ) ;
}
}
...
struct V_35 * V_15 = V_2 -> V_15 ;
struct V_8 * V_8 = F_3 ( V_2 ) ;
F_13 ( L_2 , V_2 -> V_27 ? V_2 -> V_27 -> V_46 . V_43 : - 1 , V_27 -> V_46 . V_43 ) ;
if ( V_8 -> V_37 ) {
F_24 ( V_15 -> V_15 , L_3 ) ;
return - V_51 ;
}
...
V_8 -> V_37 = V_37 ;
V_2 -> V_27 = V_27 ;
F_25 ( F_26 ( V_27 , 0 ) , V_52 ,
F_17 , V_2 ) ;
return 0 ;
}
struct V_1 * F_27 ( struct V_35 * V_15 ,
struct V_53 * V_54 , int V_43 )
{
struct V_1 * V_2 = NULL ;
struct V_8 * V_8 = F_28 ( sizeof( * V_8 ) , V_55 ) ;
F_13 ( L_1 , V_54 -> V_30 ) ;
if ( ! V_8 ) {
F_24 ( V_15 -> V_15 , L_4 ) ;
goto V_56;
...
V_2 = & V_8 -> V_46 ;
V_8 -> V_9 = F_29 ( V_15 , V_54 , ( 1 << V_43 ) , true ) ;
V_8 -> V_9 -> V_2 = V_2 ;
V_8 -> V_30 = V_54 -> V_30 ;
V_8 -> V_43 = V_43 ;
F_30 ( V_15 , V_2 , & V_57 ) ;
