...
{
struct V_1 * V_2 ;
struct V_147 * V_148 = V_146 -> V_35 . V_149 ;
struct V_5 * V_6 ;
struct V_150 * V_151 ;
int V_123 = 0 , V_152 ;
char V_153 [ 20 ] ;
...
V_2 -> V_154 = V_100 | V_102 | V_97 ;
if ( V_146 -> V_155 != - 1 )
V_2 -> V_30 = V_146 -> V_155 ;
V_2 -> V_156 = F_47 ;
V_2 -> V_157 = F_60 ;
V_2 -> V_158 = F_50 ;
V_2 -> V_113 = V_148 -> V_159 ;
F_71 ( & V_146 -> V_35 , V_2 ) ;
V_6 = F_2 ( V_2 ) ;
V_6 -> V_2 = V_2 ;
sprintf ( V_153 , L_29 , V_2 -> V_30 ) ;
V_6 -> V_141 = F_72 ( V_153 , V_160 , 1 ) ;
if ( V_6 -> V_141 == NULL ) {
V_123 = - V_111 ;
goto V_161;
}
V_151 = F_73 ( V_146 , V_162 , 0 ) ;
if ( V_151 == NULL ) {
V_123 = - V_163 ;
goto V_161;
}
V_151 -> V_164 += V_148 -> V_165 ;
V_151 -> V_166 += V_148 -> V_165 ;
V_6 -> V_59 = V_151 -> V_164 ;
if ( ! F_74 ( V_151 -> V_164 , F_75 ( V_151 ) ,
F_76 ( & V_146 -> V_35 ) ) ) {
V_123 = - V_167 ;
goto V_161;
}
V_6 -> V_7 = F_77 ( V_151 -> V_164 , F_75 ( V_151 ) ) ;
if ( ! V_6 -> V_7 ) {
F_39 ( & V_146 -> V_35 , L_30 ) ;
V_123 = - V_111 ;
goto V_168;
}
V_6 -> V_35 = & V_146 -> V_35 ;
...
F_79 ( & V_6 -> V_116 ) ;
F_80 ( & V_6 -> V_117 ) ;
F_80 ( & V_29 [ V_2 -> V_30 - 1 ] . V_11 ) ;
V_6 -> V_55 = F_81 ( V_2 -> V_113 ,
sizeof( struct V_42 ) ,
V_110 ) ;
if ( V_6 -> V_55 == NULL )
goto V_169;
for ( V_152 = 0 ; V_152 < V_2 -> V_113 ; V_152 ++ ) {
char V_170 [ 14 ] ;
struct V_150 * V_171 ;
sprintf ( V_170 , L_31 , V_152 ) ;
V_171 = F_82 ( V_146 , V_172 ,
V_170 ) ;
if ( ! V_171 ) {
F_39 ( & V_146 -> V_35 , L_32 ) ;
V_123 = - V_163 ;
break;
}
V_6 -> V_55 [ V_152 ] . V_74 = - 1 ;
V_6 -> V_55 [ V_152 ] . V_75 = V_171 -> V_164 ;
sprintf ( V_170 , L_33 , V_152 ) ;
V_171 = F_82 ( V_146 , V_172 ,
V_170 ) ;
if ( ! V_171 ) {
F_39 ( & V_146 -> V_35 , L_34 ) ;
V_123 = - V_163 ;
break;
}
V_6 -> V_55 [ V_152 ] . V_67 = - 1 ;
V_6 -> V_55 [ V_152 ] . V_69 = V_171 -> V_164 ;
}
if ( V_123 < 0 )
goto V_173;
F_83 ( & V_146 -> V_35 ) ;
...
F_87 ( V_6 -> V_7 ) ;
V_168:
F_88 ( V_151 -> V_164 , F_75 ( V_151 ) ) ;
V_161:
F_52 ( V_2 ) ;
F_89 ( V_146 , NULL ) ;
return V_123 ;
}
static int T_5 F_90 ( struct V_145 * V_146 )
{
struct V_1 * V_2 ;
struct V_5 * V_6 ;
struct V_42 * V_55 ;
...
static int F_93 ( struct V_144 * V_35 )
{
