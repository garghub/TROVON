...
V_100 = V_32 -> V_105 ;
V_101 = V_32 -> V_106 ;
if( V_100 <= 0 || ! ( V_101 & V_107 ) || V_101 & V_108 )
F_47 ( - V_14 ) ;
if ( V_101 & V_109 )
F_47 ( - V_110 ) ;
type = V_32 -> V_111 ;
...
static int
F_55 ( struct V_120 * V_121 ,
unsigned long V_122 , void * V_123 )
{
struct V_124 * V_57 = V_123 ;
if ( ! F_56 ( F_57 ( V_57 ) , & V_125 ) )
return V_126 ;
if ( V_122 == V_127 )
F_44 ( V_57 -> V_96 ) ;
return V_126 ;
...
unsigned long V_122 , void * V_123 )
{
struct V_128 * V_129 = V_123 ;
if ( V_122 == V_130 && V_129 -> V_51 == V_131 ) {
F_8 ( & V_18 ) ;
if ( ( F_56 ( V_129 -> V_132 , & V_125 ) ) && ( V_129 -> V_100 == V_15 ) )
F_4 () ;
F_11 ( & V_18 ) ;
}
return V_126 ;
}
static int F_59 ( struct V_133 * V_134 , void * V_78 )
{
F_8 ( & V_18 ) ;
F_60 ( V_134 ,
L_6
...
static int F_61 ( struct V_135 * V_135 , struct V_136 * V_136 )
{
return F_62 ( V_136 , F_59 , NULL ) ;
}
static int T_5 F_63 ( void )
{
int V_8 = - V_83 ;
struct V_137 * T_6 V_138 ;
F_64 ( & V_139 ) ;
V_74 = F_65 ( & V_125 , V_131 , 0 ,
F_52 , NULL , V_140 ) ;
if ( V_74 == NULL ) {
F_27 ( V_65 L_13 ) ;
goto V_141;
...
F_68 ( & V_146 ) ;
#ifdef F_69
V_147 = F_70 ( V_148 , V_149 ) ;
#endif
V_8 = F_71 ( V_150 , & V_151 ) ;
if ( V_8 < 0 ) {
F_27 ( V_65 L_15 ) ;
goto V_152;
}
