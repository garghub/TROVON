...
static void F_13 ( struct V_1 * V_1 , unsigned int V_32 )
{
if ( V_32 > 400 ) {
struct V_22 * V_22 = & V_1 -> V_22 ;
...
{
F_16 ( & V_1 -> V_22 . V_34 -> V_3 , & V_35 . V_36 ) ;
}
static const struct V_37 * F_17 ( unsigned char V_38 )
{
...
int V_50 ;
for ( V_50 = 0 ; V_50 < F_18 ( V_39 ) ; V_50 ++ )
...
int F_21 ( struct V_1 * V_1 , bool V_58 )
{
struct V_22 * V_22 = & V_1 -> V_22 ;
unsigned char V_20 [ 4 ] ;
...
V_20 [ 1 ] = 0 ;
F_8 ( V_22 , V_20 , V_61 ) ;
V_38 = ( ( V_20 [ 0 ] >> 4 ) & 0x07 ) | ( ( V_20 [ 0 ] << 3 ) & 0x78 ) ;
V_59 = V_20 [ 1 ] ;
if ( ! V_38 || ! V_59 )
return - 1 ;
V_51 = F_17 ( V_38 ) ;
