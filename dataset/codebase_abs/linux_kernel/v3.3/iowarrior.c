...
static unsigned F_46 ( struct V_50 * V_50 , T_6 * V_117 )
{
struct V_21 * V_2 = V_50 -> V_54 ;
unsigned int V_118 = 0 ;
if ( ! V_2 -> V_55 )
return V_119 | V_120 ;
F_47 ( V_50 , & V_2 -> V_40 , V_117 ) ;
F_47 ( V_50 , & V_2 -> V_46 , V_117 ) ;
if ( ! V_2 -> V_55 )
return V_119 | V_120 ;
if ( F_22 ( V_2 ) != - 1 )
V_118 |= V_121 | V_122 ;
...
static char * F_48 ( struct V_125 * V_2 , T_7 * V_126 )
{
return F_49 ( V_72 , L_14 , F_50 ( V_2 ) ) ;
}
static int F_51 ( struct V_16 * V_34 ,
const struct V_127 * V_5 )
{
...
V_2 -> V_34 = V_34 ;
V_128 = V_34 -> V_19 ;
V_2 -> V_67 = F_38 ( V_78 -> V_99 . V_132 ) ;
for ( V_131 = 0 ; V_131 < V_128 -> V_12 . V_133 ; ++ V_131 ) {
V_130 = & V_128 -> V_130 [ V_131 ] . V_12 ;
if ( F_55 ( V_130 ) )
V_2 -> V_134 = V_130 ;
if ( F_56 ( V_130 ) )
V_2 -> V_80 = V_130 ;
}
V_2 -> V_35 = F_57 ( V_2 -> V_134 ) ;
...
F_59 ( V_78 , V_78 -> V_99 . V_135 , V_2 -> V_107 ,
sizeof( V_2 -> V_107 ) ) ;
...
V_128 -> V_12 . V_13 , V_2 -> V_47 - V_138 ) ;
return V_28 ;
error:
F_19 ( V_2 ) ;
return V_28 ;
