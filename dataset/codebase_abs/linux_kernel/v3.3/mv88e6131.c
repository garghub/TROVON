...
if ( V_9 -> V_13 -> V_14 -> V_15 > 1 )
F_6 ( V_11 , 0x1c , 0xf000 | ( V_9 -> V_16 & 0x1f ) ) ;
else
F_6 ( V_11 , 0x1c , 0xe000 | ( V_9 -> V_16 & 0x1f ) ) ;
F_6 ( V_17 , 0x03 , 0xffff ) ;
F_6 ( V_17 , 0x05 , 0x00ff ) ;
for ( V_10 = 0 ; V_10 < 32 ; V_10 ++ ) {
int V_18 ;
V_18 = 0x1f ;
if ( V_10 != V_9 -> V_16 && V_10 < V_9 -> V_13 -> V_14 -> V_15 )
V_18 = V_9 -> V_14 -> V_19 [ V_10 ] & 0x1f ;
F_6 ( V_17 , 0x06 , 0x8000 | ( V_10 << 8 ) | V_18 ) ;
}
for ( V_10 = 0 ; V_10 < 8 ; V_10 ++ )
F_6 ( V_17 , 0x07 , 0x8000 | ( V_10 << 12 ) | 0x7ff ) ;
for ( V_10 = 0 ; V_10 < 16 ; V_10 ++ )
F_6 ( V_17 , 0x08 , 0x8000 | ( V_10 << 11 ) ) ;
F_6 ( V_17 , 0x0f , 0x00ff ) ;
return 0 ;
}
