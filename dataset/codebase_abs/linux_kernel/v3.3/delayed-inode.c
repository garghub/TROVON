...
F_90 ( V_92 , NULL , 0 ) ;
V_38 = F_91 ( V_76 , V_8 , V_92 , V_100 , V_101 ,
V_95 , V_96 , V_104 ) ;
if ( V_38 )
goto error;
V_103 = V_92 -> V_108 [ 0 ] ;
...
while ( V_119 ) {
V_8 = V_119 -> V_8 ;
V_38 = F_100 ( V_76 , V_92 , V_8 ,
V_119 ) ;
if ( ! V_38 )
V_38 = F_106 ( V_76 , V_92 , V_8 ,
V_119 ) ;
if ( ! V_38 )
V_38 = F_109 ( V_76 , V_8 , V_92 ,
V_119 ) ;
if ( V_38 ) {
F_44 ( V_119 ) ;
break;
...
static void F_119 ( struct V_121 * V_122 )
{
struct V_123 * V_124 ;
struct V_75 * V_76 ;
struct V_91 * V_92 ;
...
int V_126 = 0 ;
int V_38 ;
V_124 = F_120 ( V_122 , struct V_123 , V_122 ) ;
V_92 = F_114 () ;
if ( ! V_92 )
goto V_50;
V_92 -> V_120 = 1 ;
...
static int F_126 ( struct V_29 * V_31 ,
...
V_124 -> V_8 = V_8 ;
V_124 -> V_6 = V_93 ;
V_124 -> V_122 . V_130 = F_119 ;
V_124 -> V_122 . V_131 = 0 ;
F_127 ( & V_8 -> V_30 -> V_132 , & V_124 -> V_122 ) ;
V_11 ++ ;
if ( V_129 || V_11 < 4 )
goto V_39;
return 0 ;
...
V_142 -> V_144 = * V_139 ;
V_142 -> V_145 = F_133 ( V_76 -> V_145 ) ;
V_142 -> V_52 = 0 ;
V_142 -> V_136 = F_134 ( V_136 ) ;
V_142 -> type = type ;
...
void F_140 ( struct V_32 * V_32 , struct V_48 * V_150 ,
struct V_48 * V_151 )
{
struct V_2 * V_6 ;
struct V_22 * V_53 ;
...
int F_143 ( struct V_153 * V_154 , void * V_155 ,
T_5 V_156 ,
struct V_48 * V_150 )
{
struct V_141 * V_157 ;
...
V_135 = ( char * ) ( V_157 + 1 ) ;
V_136 = F_144 ( V_157 -> V_136 ) ;
V_159 = V_161 [ V_157 -> type ] ;
F_145 ( & V_144 , & V_157 -> V_144 ) ;
...
static void F_146 ( struct V_75 * V_76 ,
struct V_116 * V_117 ,
struct V_32 * V_32 )
{
F_147 ( V_117 , V_32 -> V_162 ) ;
F_148 ( V_117 , V_32 -> V_163 ) ;
F_149 ( V_117 , F_12 ( V_32 ) -> V_164 ) ;
F_150 ( V_117 , V_32 -> V_165 ) ;
F_151 ( V_117 , V_32 -> V_166 ) ;
F_152 ( V_117 , F_153 ( V_32 ) ) ;
F_154 ( V_117 ,
F_12 ( V_32 ) -> V_167 ) ;
F_155 ( V_117 , F_12 ( V_32 ) -> V_168 ) ;
F_156 ( V_117 , V_76 -> V_145 ) ;
F_157 ( V_117 , V_32 -> V_169 ) ;
F_158 ( V_117 , F_12 ( V_32 ) -> V_131 ) ;
F_159 ( V_117 , 0 ) ;
F_160 ( F_161 ( V_117 ) ,
V_32 -> V_170 . V_171 ) ;
F_162 ( F_161 ( V_117 ) ,
...
int F_165 ( struct V_32 * V_32 , T_3 * V_175 )
{
struct V_2 * V_6 ;
struct V_116 * V_117 ;
struct V_176 * V_177 ;
...
V_117 = & V_6 -> V_117 ;
V_32 -> V_162 = F_166 ( V_117 ) ;
V_32 -> V_163 = F_167 ( V_117 ) ;
F_168 ( V_32 , F_169 ( V_117 ) ) ;
V_32 -> V_165 = F_170 ( V_117 ) ;
F_171 ( V_32 , F_172 ( V_117 ) ) ;
F_173 ( V_32 , F_174 ( V_117 ) ) ;
F_12 ( V_32 ) -> V_167 = F_175 ( V_117 ) ;
F_12 ( V_32 ) -> V_168 = F_176 ( V_117 ) ;
V_32 -> V_169 = 0 ;
* V_175 = F_177 ( V_117 ) ;
F_12 ( V_32 ) -> V_131 = F_178 ( V_117 ) ;
V_177 = F_161 ( V_117 ) ;
V_32 -> V_170 . V_171 = F_179 ( V_177 ) ;
V_32 -> V_170 . V_172 = F_180 ( V_177 ) ;
V_177 = F_163 ( V_117 ) ;
V_32 -> V_173 . V_171 = F_179 ( V_177 ) ;
V_32 -> V_173 . V_172 = F_180 ( V_177 ) ;
V_177 = F_164 ( V_117 ) ;
V_32 -> V_174 . V_171 = F_179 ( V_177 ) ;
V_32 -> V_174 . V_172 = F_180 ( V_177 ) ;
...
static void F_182 ( struct V_2 * V_6 )
{
struct V_7 * V_8 = V_6 -> V_8 ;
