...
static void F_56 ( unsigned int V_15 )
{
}
void T_4 F_57 ( void )
{
...
F_59 ( 0 , ~ 0 ) ;
F_32 ( V_47 | V_25 | V_24 ) ;
F_60 ( V_31 | V_30 | V_28 | V_29 | V_32 | V_48 ,
V_28 | V_29 | V_32 | V_48 ) ;
F_61 () ;
...
static void T_5 F_62 ( unsigned long V_49 , char * V_50 , char * V_51 )
{
memcpy ( ( void * ) V_49 , V_50 , V_51 - V_50 ) ;
F_63 ( ( unsigned long ) V_50 , V_51 - V_50 ) ;
F_55 ( V_49 , V_49 + ( V_51 - V_50 ) ) ;
F_64 () ;
}
static inline void T_5 F_65 ( void )
{
F_62 ( V_52 , & V_53 ,
& V_54 ) ;
F_62 ( V_55 , & V_56 ,
