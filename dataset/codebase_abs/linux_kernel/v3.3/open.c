...
static inline int F_80 ( int V_100 , T_5 V_43 , struct V_110 * V_111 )
{
int V_112 = 0 ;
int V_113 ;
if ( ! ( V_100 & V_86 ) )
...
struct V_4 * F_82 ( const char * V_128 , int V_100 , T_5 V_43 )
{
struct V_110 V_111 ;
...
long F_86 ( int V_133 , const char T_2 * V_128 , int V_100 , T_5 V_43 )
{
struct V_110 V_111 ;
int V_129 = F_80 ( V_100 , V_43 , & V_111 ) ;
