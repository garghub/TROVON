...
static int F_22 ( struct V_64 * V_65 , const T_1 V_6 [] , int V_10 )
{
struct V_1 * V_2 = V_65 -> V_66 ;
if ( V_10 != 2 )
return - V_19 ;
...
F_5 ( V_2 , V_100 , 1 , 0 ) ;
V_125 = F_20 ( V_123 -> V_133 ) ;
if ( V_125 < 0 )
return V_125 ;
F_5 ( V_2 , V_102 , 7 , V_125 ) ;
V_125 = F_20 ( V_123 -> V_139 ) ;
if ( V_125 < 0 )
return V_125 ;
...
V_123 -> V_133 =
F_21 ( F_4 ( V_2 , V_162 ) & 7 ) ;
V_123 -> V_139 =
F_21 ( ( F_4 ( V_2 , V_162 ) >> 3 ) & 7 ) ;
...
static int F_27 ( struct V_64 * V_65 , T_3 * V_164 )
{
struct V_1 * V_2 = V_65 -> V_66 ;
int V_165 ;
int V_166 ;
...
static int F_28 ( struct V_64 * V_65 , T_4 * signal )
{
struct V_1 * V_2 = V_65 -> V_66 ;
int V_125 ;
int V_3 = 0 ;
...
static int F_29 ( struct V_64 * V_65 , T_4 * V_181 )
{
struct V_1 * V_2 = V_65 -> V_66 ;
int V_125 ;
F_2 ( L_8 , V_11 ) ;
...
static int F_30 ( struct V_64 * V_65 , T_2 * V_183 )
{
struct V_1 * V_2 = V_65 -> V_66 ;
int V_125 ;
int V_184 ;
...
static int F_31 ( struct V_64 * V_65 , T_2 * V_187 )
{
struct V_1 * V_2 = V_65 -> V_66 ;
int V_125 ;
F_2 ( L_8 , V_11 ) ;
...
static int F_33 ( struct V_64 * V_65 , int V_190 )
{
struct V_1 * V_2 = V_65 -> V_66 ;
if ( V_190 ) {
return F_7 ( V_2 ) ;
...
static int F_34 ( struct V_64 * V_65 , struct V_191 * V_192 )
{
V_192 -> V_193 = 800 ;
V_192 -> V_194 = 0 ;
V_192 -> V_195 = 0 ;
...
struct V_64 * F_37 ( const struct V_196 * V_13 ,
struct V_197 * V_15 )
{
struct V_1 * V_2 ;
int V_198 ;
V_2 = F_38 ( sizeof( struct V_1 ) , V_199 ) ;
if ( ! V_2 ) {
F_13 ( V_50 L_32 ) ;
return NULL ;
}
...
struct V_64 * F_39 ( const struct V_196 * V_13 ,
struct V_197 * V_15 )
{
struct V_1 * V_2 ;
int V_198 ;
