...
static int T_10 F_53 ( unsigned int V_113 , T_1 * V_124 )
{
int V_10 ;
V_5 = F_54 ( sizeof( T_1 ) * V_4 , V_62 ) ;
if ( ! V_5 )
return - V_125 ;
...
V_115 -> V_128 = 0xffff ;
F_14 () ;
V_10 = F_55 ( V_113 , F_43 , 0 , L_10 , ( void * ) V_115 ) ;
if ( V_10 )
F_38 ( V_129 L_11 ) ;
else {
V_24 = 1 ;
...
switch ( F_58 () ) {
case V_131 :
return F_53 ( V_132 , V_133 ) ;
case V_134 :
return F_53 ( V_135 , V_136 ) ;
case V_137 :
return F_53 ( V_138 , V_139 ) ;
}
return 0 ;
}
