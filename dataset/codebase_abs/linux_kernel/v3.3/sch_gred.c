...
static inline int F_41 ( struct V_6 * V_7 , struct V_51 * V_52 )
{
struct V_1 * V_2 = F_11 ( V_7 ) ;
struct V_53 * V_54 ;
int V_8 ;
...
if ( V_86 == NULL )
goto V_89;
F_56 ( V_18 , V_85 , sizeof( V_54 ) , & V_54 ) ;
for ( V_8 = 0 ; V_8 < V_56 ; V_8 ++ ) {
struct V_10 * V_11 = V_2 -> V_12 [ V_8 ] ;
V_87 [ V_8 ] = V_11 ? V_11 -> V_35 . V_62 : 0 ;
}
F_56 ( V_18 , V_79 , sizeof( V_87 ) , V_87 ) ;
V_35 = F_55 ( V_18 , V_77 ) ;
if ( V_35 == NULL )
goto V_89;
for ( V_8 = 0 ; V_8 < V_56 ; V_8 ++ ) {
...
V_71 . V_94 = F_24 ( & V_11 -> V_35 , & V_11 -> V_21 , V_11 -> V_21 . V_22 ) ;
V_90:
