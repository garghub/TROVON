...
struct V_137 * V_138 = F_37 ( V_36 -> V_128 ) ;
T_1 V_139 = V_69 -> V_136 . V_140 ;
int V_141 = 0 ;
int V_142 ;
int V_143 ;
int V_41 ;
...
V_13 -> V_31 = F_39 ( V_138 , 0 , 60 , 1 , 1 ) + V_142 ;
V_13 -> V_116 = V_13 -> V_31 + 2 * V_142 ;
V_13 -> V_32 = F_7 ( 1 , 1 ) ;
if ( V_36 -> V_123 ) {
V_13 -> V_45 = 16 ;
V_13 -> V_99 = 0 ;
...
{
struct V_35 * V_36 = V_78 ;
F_36 ( V_78 , V_80 , V_69 , V_81 , V_36 -> V_128 -> V_163 . V_164 ) ;
}
static void
F_41 ( void * V_78 , struct V_79 * V_80 ,
struct V_61 * V_69 , void * V_81 ,
T_2 V_165 , enum V_132 V_133 )
{
...
struct V_82 * V_83 ;
struct V_35 * V_36 = V_78 ;
struct V_167 * V_128 = V_36 -> V_128 ;
int V_129 = 0 ;
int V_41 ;
for ( V_41 = 0 ; V_41 < V_168 ; V_41 ++ ) {
V_80 = V_128 -> V_169 -> V_170 [ V_41 ] ;
if ( V_80 && V_80 -> V_171 > V_129 )
V_129 = V_80 -> V_171 ;
}
V_83 = F_43 ( sizeof( struct V_12 ) , V_166 ) ;
if ( ! V_83 )
return NULL ;
