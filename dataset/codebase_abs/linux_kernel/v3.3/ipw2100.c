...
goto V_123;
F_83 ( & V_22 -> V_263 ) ;
F_30 ( L_265 , V_2 -> V_51 , F_274 ( V_258 ) ) ;
...
static struct V_824 * F_380 ( struct V_1 * V_2 )
{
enum {
V_825 = 30 ,
V_826 = 60 ,
...
static int F_381 ( struct V_119 * V_849 )
{
struct V_850 * V_851 =
(struct V_850 * ) V_849 -> V_852 -> V_37 ;
if ( F_382 ( V_851 -> V_121 ) != V_853 ) {
...
V_202 = F_384 ( & V_849 -> V_852 , V_857 , & V_22 -> V_258 -> V_2 ) ;
if ( V_202 < 0 ) {
F_26 (KERN_ERR DRV_NAME L_67
L_331 ,
