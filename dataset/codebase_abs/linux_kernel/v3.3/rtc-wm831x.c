...
struct V_5 * V_5 ;
int V_40 = F_27 ( V_37 , L_17 ) ;
int V_9 = 0 ;
V_5 = F_28 ( & V_37 -> V_2 , sizeof( * V_5 ) , V_41 ) ;
if ( V_5 == NULL )
return - V_42 ;
F_29 ( V_37 , V_5 ) ;
V_5 -> V_6 = V_6 ;
...
V_5 -> V_29 = 1 ;
F_30 ( & V_37 -> V_2 , 1 ) ;
V_5 -> V_32 = F_31 ( L_18 , & V_37 -> V_2 ,
& V_44 , V_45 ) ;
if ( F_32 ( V_5 -> V_32 ) ) {
V_9 = F_33 ( V_5 -> V_32 ) ;
goto V_43;
}
V_9 = F_34 ( V_40 , NULL , F_19 ,
V_46 , L_19 ,
V_5 ) ;
if ( V_9 != 0 ) {
F_4 ( & V_37 -> V_2 , L_20 ,
...
static int T_4 F_35 ( struct V_36 * V_37 )
{
struct V_5 * V_5 = F_36 ( V_37 ) ;
int V_40 = F_27 ( V_37 , L_17 ) ;
F_37 ( V_40 , V_5 ) ;
F_38 ( V_5 -> V_32 ) ;
return 0 ;
