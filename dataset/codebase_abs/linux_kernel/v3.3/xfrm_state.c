...
break;
case V_192 :
* (struct V_193 * ) V_20 -> V_154 . V_2 . V_194 = * (struct V_193 * ) V_2 ;
* (struct V_193 * ) V_20 -> V_154 . V_3 . V_194 = * (struct V_193 * ) V_3 ;
V_20 -> V_154 . V_190 = 128 ;
V_20 -> V_154 . V_191 = 128 ;
* (struct V_193 * ) V_20 -> V_23 . V_3 . V_194 = * (struct V_193 * ) V_3 ;
* (struct V_193 * ) V_20 -> V_22 . V_2 . V_194 = * (struct V_193 * ) V_2 ;
break;
}
V_20 -> V_99 . V_100 = V_116 ;
V_20 -> V_22 . V_9 = V_9 ;
...
V_195 = F_105 ( V_1 , V_157 , V_20 -> V_99 . V_197 ) ;
...
static struct V_19 * F_106 ( struct V_19 * V_198 , int * V_199 )
{
...
if ( V_198 -> V_70 ) {
V_20 -> V_70 = F_107 ( V_198 -> V_70 ) ;
if ( ! V_20 -> V_70 )
goto error;
}
V_20 -> V_23 . V_201 = V_198 -> V_23 . V_201 ;
if ( V_198 -> V_71 ) {
V_20 -> V_71 = F_108 ( V_198 -> V_71 ) ;
if ( ! V_20 -> V_71 )
goto error;
}
V_20 -> V_23 . V_202 = V_198 -> V_23 . V_202 ;
if ( V_198 -> V_72 ) {
V_20 -> V_72 = F_108 ( V_198 -> V_72 ) ;
if ( ! V_20 -> V_72 )
goto error;
}
V_20 -> V_23 . V_203 = V_198 -> V_23 . V_203 ;
if ( V_198 -> V_63 ) {
V_20 -> V_63 = F_109 ( V_198 -> V_63 , sizeof( * V_20 -> V_63 ) , V_204 ) ;
if ( ! V_20 -> V_63 )
goto error;
}
if ( V_198 -> V_73 ) {
V_20 -> V_73 = F_109 ( V_198 -> V_73 , sizeof( * V_20 -> V_73 ) ,
V_204 ) ;
if ( ! V_20 -> V_73 )
goto error;
}
if ( V_198 -> V_74 ) {
V_52 = F_110 ( V_20 , V_198 ) ;
if ( V_52 )
goto error;
}
...
struct V_19 * F_112 ( struct V_205 * V_158 )
{
unsigned int V_21 ;
struct V_19 * V_20 ;
struct V_16 * V_17 ;
...
struct V_19 *
F_117 ( struct V_1 * V_1 , T_2 V_157 , const T_1 * V_2 , T_3 V_8 ,
T_4 V_9 , unsigned short V_5 )
{
struct V_19 * V_20 ;
F_16 ( & V_42 ) ;
...
struct V_19 *
F_118 ( struct V_1 * V_1 , T_2 V_157 ,
const T_1 * V_2 , const T_1 * V_3 ,
T_4 V_9 , unsigned short V_5 )
{
struct V_19 * V_20 ;
...
struct V_19 *
F_119 ( struct V_1 * V_1 , struct V_186 * V_157 , T_4 V_61 , T_2 V_4 , T_4 V_9 ,
const T_1 * V_2 , const T_1 * V_3 ,
...
int
F_120 ( struct V_151 * * V_216 , struct V_151 * * V_217 , int V_218 ,
unsigned short V_5 )
{
int V_52 = 0 ;
struct V_46 * V_47 = F_28 ( V_5 ) ;
...
int
F_121 ( struct V_19 * * V_216 , struct V_19 * * V_217 , int V_218 ,
unsigned short V_5 )
{
int V_52 = 0 ;
struct V_46 * V_47 = F_28 ( V_5 ) ;
...
static struct V_19 * F_105 ( struct V_1 * V_1 , T_2 V_157 , T_2 V_197 )
{
int V_39 ;
for ( V_39 = 0 ; V_39 <= V_1 -> V_6 . V_7 ; V_39 ++ ) {
struct V_16 * V_17 ;
...
struct V_19 * F_122 ( struct V_1 * V_1 , T_2 V_157 , T_2 V_197 )
{
struct V_19 * V_20 ;
F_16 ( & V_42 ) ;
V_20 = F_105 ( V_1 , V_157 , V_197 ) ;
F_17 ( & V_42 ) ;
return V_20 ;
}
T_2 F_123 ( void )
...
int F_125 ( struct V_19 * V_20 , T_2 V_223 , T_2 V_224 )
{
struct V_1 * V_1 = F_48 ( V_20 ) ;
unsigned int V_21 ;
struct V_19 * V_170 ;
int V_52 = - V_56 ;
T_3 V_225 = F_126 ( V_223 ) ;
T_3 V_226 = F_126 ( V_224 ) ;
T_2 V_157 = V_20 -> V_157 . V_159 & V_20 -> V_157 . V_158 ;
F_16 ( & V_20 -> V_98 ) ;
if ( V_20 -> V_99 . V_100 == V_101 )
goto V_227;
...
V_52 = - V_56 ;
if ( V_225 == V_226 ) {
V_170 = F_117 ( V_1 , V_157 , & V_20 -> V_22 . V_2 , V_225 , V_20 -> V_22 . V_9 , V_20 -> V_23 . V_5 ) ;
if ( V_170 ) {
F_73 ( V_170 ) ;
goto V_227;
}
...
V_8 = V_223 + F_127 () % ( V_224 - V_223 + 1 ) ;
V_170 = F_117 ( V_1 , V_157 , & V_20 -> V_22 . V_2 , F_126 ( V_8 ) , V_20 -> V_22 . V_9 , V_20 -> V_23 . V_5 ) ;
if ( V_170 == NULL ) {
...
int F_128 ( struct V_1 * V_1 , struct F_128 * V_228 ,
...
struct F_128 * V_20 ;
int V_52 = 0 ;
if ( V_228 -> V_197 != 0 && F_130 ( & V_228 -> V_122 ) )
return 0 ;
F_16 ( & V_42 ) ;
if ( F_130 ( & V_228 -> V_122 ) )
V_20 = F_131 ( & V_1 -> V_6 . V_179 , struct F_128 , V_122 ) ;
else
V_20 = F_132 ( & V_228 -> V_122 , struct F_128 , V_122 ) ;
...
continue;
V_52 = F_129 ( V_100 , V_228 -> V_197 , V_229 ) ;
if ( V_52 ) {
F_134 ( & V_228 -> V_122 , & V_20 -> V_122 ) ;
goto V_67;
}
V_228 -> V_197 ++ ;
}
...
void F_136 ( struct F_128 * V_228 , T_4 V_9 )
{
F_63 ( & V_228 -> V_122 ) ;
V_228 -> V_9 = V_9 ;
V_228 -> V_100 = V_101 ;
...
void F_139 ( struct V_162 * V_235 , int V_236 , const struct V_237 * V_238 )
{
struct V_239 * V_99 ;
F_140 ( & V_240 ) ;
...
void F_143 ( struct V_19 * V_20 , const struct V_237 * V_238 )
{
struct V_239 * V_99 ;
F_140 ( & V_240 ) ;
F_141 (km, &xfrm_km_list, list)
...
int F_144 ( struct V_19 * V_20 , T_1 * V_250 , T_6 V_251 )
{
int V_52 = - V_65 ;
struct V_239 * V_99 ;
F_140 ( & V_240 ) ;
...
void F_145 ( struct V_162 * V_163 , int V_236 , int V_242 , T_2 V_243 )
{
struct V_1 * V_1 = F_93 ( V_163 ) ;
struct V_237 V_238 ;
V_238 . V_229 . V_242 = V_242 ;
V_238 . V_243 = V_243 ;
V_238 . V_244 = V_253 ;
F_139 ( V_163 , V_236 , & V_238 ) ;
if ( V_242 )
F_45 ( & V_1 -> V_6 . V_84 ) ;
}
int F_146 ( const struct V_254 * V_154 , T_4 V_236 , T_4 type ,
...
int F_147 ( struct V_1 * V_1 , T_4 V_9 , struct V_254 * V_154 , T_1 * V_260 )
{
int V_52 = - V_65 ;
int V_258 ;
struct V_239 * V_99 ;
...
int F_148 ( struct V_262 * V_263 , int V_264 , T_4 T_7 * V_265 , int V_266 )
{
int V_52 ;
T_4 * V_229 ;
struct V_239 * V_99 ;
...
return - V_268 ;
V_229 = F_149 ( V_266 , V_204 ) ;
if ( ! V_229 )
return - V_176 ;
V_52 = - V_269 ;
if ( F_150 ( V_229 , V_265 , V_266 ) )
goto V_67;
V_52 = - V_65 ;
F_140 ( & V_240 ) ;
F_141 (km, &xfrm_km_list, list) {
...
int F_153 ( struct V_239 * V_99 )
{
F_21 ( & V_240 ) ;
F_154 ( & V_99 -> V_11 , & V_271 ) ;
F_22 ( & V_240 ) ;
return 0 ;
}
int F_155 ( struct V_239 * V_99 )
{
F_21 ( & V_240 ) ;
F_71 ( & V_99 -> V_11 ) ;
F_22 ( & V_240 ) ;
...
int F_161 ( struct V_19 * V_20 , int V_274 )
{
int V_221 ;
F_16 ( & V_20 -> V_98 ) ;
if ( V_20 -> V_99 . V_100 == V_166 &&
...
int F_162 ( struct V_19 * V_20 , bool V_277 )
{
struct V_46 * V_47 ;
struct V_60 * V_76 ;
...
F_173 ( V_289 , L_6 , V_8 , V_8 ) ;
}
static void F_174 ( struct V_295 * V_296 , T_9 V_5 ,
struct V_288 * V_289 )
{
...
void F_177 ( struct V_19 * V_20 , int V_302 ,
...
if ( V_289 == NULL )
return;
F_179 ( V_303 , V_139 , V_140 , V_289 ) ;
F_171 ( V_20 , V_289 ) ;
F_173 ( V_289 , L_9 , V_302 ) ;
F_180 ( V_289 ) ;
}
...
if ( V_289 == NULL )
return;
F_174 ( V_296 , V_20 -> V_23 . V_5 , V_289 ) ;
...
void F_183 ( struct V_295 * V_296 , T_9 V_5 )
{
struct V_288 * V_289 ;
V_289 = F_178 ( L_14 ) ;
if ( V_289 == NULL )
return;
F_174 ( V_296 , V_5 , V_289 ) ;
F_180 ( V_289 ) ;
}
...
return;
F_174 ( V_296 , V_20 -> V_23 . V_5 , V_289 ) ;
if ( F_186 ( V_296 , V_9 , & V_305 , & V_304 ) == 0 ) {
T_2 V_8 = F_172 ( V_305 ) ;
F_173 ( V_289 , L_13 ,
V_8 , V_8 , F_172 ( V_304 ) ) ;
}
