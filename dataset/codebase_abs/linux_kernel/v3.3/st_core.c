...
void F_10 ( unsigned char V_6 , struct V_1 * V_2 )
{
F_11 ( L_4 , V_5 , V_6 ) ;
if ( F_5
...
void F_14 ( struct V_1 * V_2 , char V_23 )
{
...
struct V_36 * F_31 ( struct V_1 * V_2 )
{
struct V_36 * V_60 ;
F_11 ( L_25 , V_5 ) ;
if ( V_2 -> V_61 != NULL ) {
...
void F_32 ( struct V_1 * V_2 , struct V_36 * V_62 )
{
unsigned long V_38 = 0 ;
F_11 ( L_25 , V_5 ) ;
F_18 ( & V_2 -> V_39 , V_38 ) ;
...
void F_23 ( struct V_1 * V_66 )
{
struct V_36 * V_62 ;
unsigned long V_38 ;
F_11 ( L_25 , V_5 ) ;
if ( F_34 ( V_67 , & V_66 -> V_68 ) ) {
F_11 ( L_29 ) ;
F_35 ( V_69 , & V_66 -> V_68 ) ;
return;
}
do {
F_36 ( V_69 , & V_66 -> V_68 ) ;
while ( ( V_62 = F_31 ( V_66 ) ) ) {
int V_28 ;
F_18 ( & V_66 -> V_39 , V_38 ) ;
F_35 ( V_70 , & V_66 -> V_11 -> V_38 ) ;
V_28 = F_7 ( V_66 , V_62 -> V_14 , V_62 -> V_28 ) ;
F_37 ( V_62 , V_28 ) ;
if ( V_62 -> V_28 ) {
V_66 -> V_61 = V_62 ;
F_22 ( & V_66 -> V_39 , V_38 ) ;
...
} while ( F_38 ( V_69 , & V_66 -> V_68 ) );
F_36 ( V_67 , & V_66 -> V_68 ) ;
}
void F_39 ( struct V_1 * V_2 , void * V_71 )
{
F_40 ( V_71 , L_30 ,
V_2 -> V_27 ,
...
long F_41 ( struct V_3 * V_4 )
{
struct V_1 * V_2 ;
long V_23 = 0 ;
unsigned long V_38 = 0 ;
F_42 ( & V_2 , 0 ) ;
F_2 ( L_31 , V_5 , V_4 -> V_6 ) ;
...
F_11 ( L_40 , V_5 , V_4 -> V_6 ) ;
}
long F_45 ( struct V_3 * V_9 )
{
long V_23 = 0 ;
unsigned long V_38 = 0 ;
struct V_1 * V_2 ;
F_11 ( L_41 , V_5 , V_9 -> V_6 ) ;
F_42 ( & V_2 , 0 ) ;
if ( ! V_2 || V_9 -> V_6 >= V_25 ) {
F_6 ( L_42 , V_9 -> V_6 ) ;
return - V_72 ;
...
static void F_55 ( struct V_10 * V_11 , const unsigned char * V_14 ,
char * V_85 , int V_15 )
{
#ifdef F_8
F_9 ( V_17 , L_50 , V_18 ,
...
F_11 ( L_52 ) ;
V_2 = F_60 ( sizeof( struct V_1 ) , V_90 ) ;
if ( ! V_2 ) {
F_6 ( L_53 ) ;
V_23 = F_61 ( V_88 ) ;
if ( V_23 )
