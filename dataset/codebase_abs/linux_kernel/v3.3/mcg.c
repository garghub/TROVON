...
V_29 = V_7 -> V_42 ;
F_34 ( & V_58 -> V_59 . V_60 ) ;
V_19 = F_37 ( V_2 , V_13 , V_66 , V_34 , V_14 ,
V_7 , & V_16 , & V_69 , & V_5 ) ;
if ( V_19 )
goto V_55;
if ( V_5 != - 1 ) {
...
int F_49 ( struct V_1 * V_2 , struct V_74 * V_46 , T_1 V_66 [ 16 ] ,
enum V_67 V_34 )
{
enum V_23 V_14 ;
V_14 = ( F_48 ( & V_66 [ 10 ] ) ) ? V_88 : V_89 ;
...
return F_44 ( V_2 , V_46 , V_66 , V_34 , V_14 ) ;
}
...
int F_51 ( struct V_1 * V_2 , struct V_74 * V_46 ,
...
int F_52 ( struct V_1 * V_2 , int V_91 ,
struct V_92 * V_93 ,
struct V_6 * V_94 ,
struct V_6 * V_95 ,
struct V_96 * V_97 )
...
static int F_53 ( struct V_1 * V_2 , T_2 V_24 ,
...
return 0 ;
if ( F_46 ( V_2 ) )
return F_53 ( V_2 , V_24 , V_89 , 1 , V_13 ) ;
return F_33 ( V_2 , V_13 , V_89 , V_24 ) ;
}
...
return 0 ;
if ( F_46 ( V_2 ) )
return F_53 ( V_2 , V_24 , V_89 , 0 , V_13 ) ;
return F_36 ( V_2 , V_13 , V_89 , V_24 ) ;
}
int F_56 ( struct V_1 * V_2 , T_2 V_24 , T_1 V_13 )
{
if ( ! ( V_2 -> V_44 . V_71 & V_90 ) )
return 0 ;
if ( F_46 ( V_2 ) )
return F_53 ( V_2 , V_24 , V_88 , 1 , V_13 ) ;
return F_33 ( V_2 , V_13 , V_88 , V_24 ) ;
}
int F_57 ( struct V_1 * V_2 , T_2 V_24 , T_1 V_13 )
{
if ( ! ( V_2 -> V_44 . V_71 & V_90 ) )
return 0 ;
if ( F_46 ( V_2 ) )
return F_53 ( V_2 , V_24 , V_88 , 0 , V_13 ) ;
...
struct F_12 * V_58 = F_12 ( V_2 ) ;
int V_19 ;
V_19 = F_59 ( & V_58 -> V_59 . V_77 , V_2 -> V_44 . V_103 ,
