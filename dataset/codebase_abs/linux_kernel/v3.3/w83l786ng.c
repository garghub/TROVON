...
T_4 V_2 ;
V_2 = F_12 ( V_12 , NULL , 10 ) ;
F_13 ( & V_17 -> V_18 ) ;
V_17 -> V_19 [ V_14 ] = F_1 ( V_2 , F_14 ( V_17 -> V_20 [ V_14 ] ) ) ;
F_6 ( V_5 , F_15 ( V_14 ) ,
V_17 -> V_19 [ V_14 ] ) ;
F_16 ( & V_17 -> V_18 ) ;
return V_13 ;
...
return sprintf ( V_12 , L_1 , F_14 ( V_17 -> V_20 [ V_14 ] ) ) ;
}
static T_2
...
T_1 V_25 = 0 ;
F_13 ( & V_17 -> V_18 ) ;
V_21 = F_20 ( V_17 -> V_19 [ V_14 ] , F_14 ( V_17 -> V_20 [ V_14 ] ) ) ;
V_17 -> V_20 [ V_14 ] = F_3 ( F_12 ( V_12 , NULL , 10 ) ) ;
switch ( V_14 ) {
case 0 :
V_24 = 0xf8 ;
V_25 = 0 ;
...
V_23 = F_4 ( V_5 , V_26 )
& V_24 ;
V_22 = ( V_17 -> V_20 [ V_14 ] << V_25 ) & ~ V_24 ;
F_6 ( V_5 , V_26 ,
V_23 | V_22 ) ;
V_17 -> V_19 [ V_14 ] = F_1 ( V_21 , F_14 ( V_17 -> V_20 [ V_14 ] ) ) ;
F_6 ( V_5 , F_15 ( V_14 ) ,
V_17 -> V_19 [ V_14 ] ) ;
F_16 ( & V_17 -> V_18 ) ;
return V_13 ;
...
int V_15 = V_28 -> V_15 ;
struct V_16 * V_17 = F_18 ( V_9 ) ;
return sprintf ( V_12 , L_2 , F_23 ( V_17 -> V_29 [ V_14 ] [ V_15 ] ) ) ;
}
static T_2
...
struct V_16 * V_17 = F_11 ( V_5 ) ;
T_5 V_2 ;
V_2 = F_25 ( V_12 , NULL , 10 ) ;
F_13 ( & V_17 -> V_18 ) ;
V_17 -> V_29 [ V_14 ] [ V_15 ] = F_26 ( V_2 ) ;
F_6 ( V_5 , V_30 [ V_14 ] [ V_15 ] ,
V_17 -> V_29 [ V_14 ] [ V_15 ] ) ;
F_16 ( & V_17 -> V_18 ) ;
return V_13 ;
}
...
struct V_4 * V_5 = F_10 ( V_9 ) ;
struct V_16 * V_17 = F_11 ( V_5 ) ;
T_4 V_2 = F_2 ( F_12 ( V_12 , NULL , 10 ) , 0 , 255 ) ;
F_13 ( & V_17 -> V_18 ) ;
V_17 -> V_35 [ V_14 ] = V_2 ;
F_6 ( V_5 , V_36 [ V_14 ] , V_2 ) ;
F_16 ( & V_17 -> V_18 ) ;
return V_13 ;
}
static T_2
...
int V_14 = F_9 ( V_11 ) -> V_15 ;
struct V_16 * V_17 = F_18 ( V_9 ) ;
return sprintf ( V_12 , L_3 , ( long ) V_17 -> V_39 [ V_14 ] ) ;
}
static T_2
...
static int
F_32 ( struct V_4 * V_5 , struct V_43 * V_44 )
{
...
F_35 ( V_44 -> type , L_6 , V_56 ) ;
return 0 ;
}
static int
F_36 ( struct V_4 * V_5 , const struct V_57 * V_58 )
{
...
F_40 ( V_5 ) ;
for ( V_3 = 0 ; V_3 < 2 ; V_3 ++ ) {
V_17 -> V_19 [ V_3 ] = F_4 ( V_5 ,
F_15 ( V_3 ) ) ;
}
V_60 = F_4 ( V_5 , V_26 ) ;
V_17 -> V_20 [ 0 ] = V_60 & 0x07 ;
V_17 -> V_20 [ 1 ] = ( V_60 >> 4 ) & 0x07 ;
if ( ( V_59 = F_41 ( & V_5 -> V_9 . V_63 , & V_64 ) ) )
goto V_65;
V_17 -> V_66 = F_42 ( V_9 ) ;
if ( F_43 ( V_17 -> V_66 ) ) {
V_59 = F_44 ( V_17 -> V_66 ) ;
...
V_17 -> V_37 [ V_3 ] =
( ( V_70 >> V_38 [ V_3 ] ) & 2 ) + 1 ;
V_17 -> V_35 [ V_3 ] = F_4 ( V_5 ,
V_36 [ V_3 ] ) ;
}
for ( V_3 = 0 ; V_3 < 2 ; V_3 ++ ) {
for ( V_69 = 0 ; V_69 < 3 ; V_69 ++ ) {
V_17 -> V_29 [ V_3 ] [ V_69 ] = F_4 ( V_5 ,
V_30 [ V_3 ] [ V_69 ] ) ;
}
}
V_60 = F_4 ( V_5 , V_42 ) ;
V_17 -> V_39 [ 0 ] = V_60 & 0x0f ;
V_17 -> V_39 [ 1 ] = ( V_60 >> 4 ) & 0x0f ;
V_17 -> V_72 = V_71 ;
V_17 -> V_74 = 1 ;
}
F_16 ( & V_17 -> V_18 ) ;
