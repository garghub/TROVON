...
V_25 -> V_57 . V_58 = V_59 | V_60 |
V_61 | V_62 ;
V_25 -> V_57 . V_63 = V_64 ;
V_25 -> V_65 . V_66 = 24 ;
V_28 -> V_38 = V_67 ;
memcpy ( V_28 -> gamma , V_68 , sizeof( V_28 -> gamma ) ) ;
V_28 -> V_49 = F_37 ( & V_25 -> V_14 , L_9 ) ;
if ( F_38 ( V_28 -> V_49 ) ) {
F_36 ( & V_25 -> V_14 , L_10 ) ;
V_37 = F_39 ( V_28 -> V_49 ) ;
goto V_69;
...
V_37 = F_49 ( V_2 ) ;
if ( V_37 < 0 ) {
F_36 ( & V_2 -> V_14 , L_17 , V_37 ) ;
return V_37 ;
}
V_28 = F_50 ( sizeof( * V_28 ) , V_76 ) ;
if ( V_28 == NULL )
return - V_77 ;
V_28 -> V_2 = V_2 ;
F_51 ( & V_2 -> V_14 , V_28 ) ;
...
static int T_5 F_53 ( struct V_1 * V_2 )
{
