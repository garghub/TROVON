...
struct V_43 V_44 ;
struct V_1 * V_1 ;
unsigned V_70 , V_3 , V_36 ;
F_31 ( V_62 -> V_64 , * V_55 , 0 , & V_44 ) ;
V_3 = V_44 . V_83 / V_27 ;
V_36 = F_33 ( V_62 -> V_64 -> V_5 * V_62 -> V_64 -> V_68 ,
V_62 -> V_64 -> V_68 , V_44 . V_84 , V_44 . V_53 ) ;
V_1 = V_62 -> V_9 -> V_14 [ V_3 ] . V_17 [ V_36 ] ;
V_70 = V_27 - ( V_44 . V_83 % V_27 ) ;
* V_55 += V_70 ;
F_9 ( L_8 ,
V_3 , V_36 , F_22 ( * V_55 ) , V_70 , V_44 . V_53 , V_44 . V_84 ) ;
F_6 ( ! V_1 ) ;
return F_25 ( V_62 , & V_44 , V_1 , V_70 ) ;
}
...
T_1 V_55 = V_62 -> V_44 . V_91 ;
T_1 V_92 ;
unsigned V_93 = V_62 -> V_44 . V_93 ;
unsigned V_26 , V_36 , V_3 , V_94 = V_9 -> V_4 , V_95 = - 1 ;
int V_65 ;
if ( V_55 == V_62 -> V_55 )
goto V_96;
V_94 = F_14 ( V_9 ) ;
V_95 = F_15 ( V_9 ) ;
for ( V_36 = 0 ; ; V_36 ++ ) {
F_31 ( V_62 -> V_64 , V_55 , 0 , & V_90 ) ;
V_90 . V_79 += V_94 * V_27 ;
V_55 += V_94 * V_27 ;
for ( V_3 = V_94 ; V_3 <= V_95 ; V_3 ++ ) {
struct V_13 * V_34 = & V_9 -> V_14 [ V_3 ] ;
struct V_1 * * V_97 = & V_34 -> V_17 [ V_36 ] ;
bool V_98 ;
if ( * V_97 ) {
if ( V_62 -> V_55 % V_27 )
F_30 ( V_62 , * V_97 ) ;
...
* V_97 = V_62 -> V_31 -> V_99 ( V_62 -> V_100 , V_55 ,
& V_98 ) ;
if ( F_8 ( ! * V_97 ) )
return - V_28 ;
if ( ! V_98 )
F_25 ( V_62 , & V_90 , * V_97 , V_27 ) ;
V_34 -> V_19 [ V_36 ] = true ;
V_90 . V_79 += V_27 ;
V_55 += V_27 ;
}
...
V_3 = V_90 . V_83 / V_27 ;
V_36 = F_33 ( V_62 -> V_64 -> V_5 * V_62 -> V_64 -> V_68 ,
V_62 -> V_64 -> V_68 , V_90 . V_84 , V_90 . V_53 ) ;
F_6 ( V_62 -> V_44 . V_91 + V_93 != V_92 ) ;
if ( V_94 == V_9 -> V_4 ) {
V_94 = F_14 ( V_9 ) ;
V_95 = F_15 ( V_9 ) ;
}
while ( V_55 < V_92 ) {
struct V_13 * V_34 = & V_9 -> V_14 [ V_3 ] ;
if ( ( V_94 <= V_3 ) && ( V_3 <= V_95 ) ) {
struct V_1 * V_1 ;
bool V_98 ;
F_6 ( V_34 -> V_17 [ V_36 ] ) ;
V_1 = V_62 -> V_31 -> V_99 ( V_62 -> V_100 , V_55 ,
& V_98 ) ;
if ( F_8 ( ! V_1 ) )
return - V_28 ;
V_34 -> V_17 [ V_36 ] = V_1 ;
...
return 0 ;
V_89 -> V_17 = V_62 -> V_17 ;
for ( V_26 = 0 ; V_26 < V_89 -> V_77 ; V_26 += V_89 -> V_64 -> V_68 ) {
V_65 = F_41 ( V_89 , V_26 ) ;
if ( F_8 ( V_65 ) )
return V_65 ;
}
...
V_65 = F_44 ( V_62 , & V_106 , 0 , V_17 ,
V_48 , V_105 * V_27 ) ;
if ( F_8 ( V_65 ) )
return V_65 ;
F_16 ( V_9 ) ;
F_11 ( V_9 , V_62 -> V_31 , V_62 -> V_100 ) ;
}
return 0 ;
}
int F_45 ( struct V_61 * V_62 )
{
struct V_63 * V_64 = V_62 -> V_64 ;
if ( V_62 -> V_103 ) {
unsigned V_4 = V_64 -> V_107 / V_27 ;
unsigned V_108 = V_62 -> V_44 . V_93 ;
T_1 V_109 , V_110 ;
if ( F_5 ( V_4 , V_64 -> V_5 ,
V_64 -> V_6 , & V_62 -> V_9 ) ) {
return - V_28 ;
}
V_110 = F_40 ( V_62 -> V_55 , V_108 ) ;
V_109 = F_40 ( V_62 -> V_55 + V_62 -> V_56 , V_108 ) ;
if ( V_109 != V_110 ) {
V_62 -> V_56 = V_109 * V_108 - V_62 -> V_55 ;
F_6 ( ! V_62 -> V_56 ) ;
V_62 -> V_111 = ( V_62 -> V_56 + V_27 - 1 ) /
V_27 ;
...
if ( V_62 -> V_112 )
F_13 ( V_62 -> V_103 ) ;
F_11 ( V_62 -> V_9 , V_62 -> V_31 , V_62 -> V_100 ) ;
F_12 ( V_62 -> V_9 ) ;
} else {
if ( V_62 -> V_112 )
