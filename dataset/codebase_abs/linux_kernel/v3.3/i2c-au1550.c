...
struct V_66 * V_3 ;
int V_67 ;
V_3 = F_28 ( V_65 , V_68 , 0 ) ;
if ( ! V_3 ) {
V_67 = - V_69 ;
goto V_29;
}
V_49 = F_29 ( sizeof( struct V_1 ) , V_70 ) ;
if ( ! V_49 ) {
V_67 = - V_71 ;
goto V_29;
}
V_49 -> V_72 = F_30 ( V_3 -> V_73 , F_31 ( V_3 ) ,
V_65 -> V_74 ) ;
if ( ! V_49 -> V_72 ) {
V_67 = - V_75 ;
goto V_76;
}
V_49 -> V_5 = F_32 ( V_3 -> V_73 , F_31 ( V_3 ) ) ;
if ( ! V_49 -> V_5 ) {
V_67 = - V_28 ;
goto V_77;
}
V_49 -> V_8 = 200 ;
V_49 -> V_6 . V_78 = V_65 -> V_79 ;
V_49 -> V_6 . V_80 = & V_81 ;
V_49 -> V_6 . V_39 = V_49 ;
V_49 -> V_6 . V_82 . V_83 = & V_65 -> V_82 ;
F_33 ( V_49 -> V_6 . V_74 , L_1 , sizeof( V_49 -> V_6 . V_74 ) ) ;
F_17 ( V_49 ) ;
V_67 = F_34 ( & V_49 -> V_6 ) ;
if ( V_67 == 0 ) {
F_35 ( V_65 , V_49 ) ;
...
static int T_3 F_39 ( struct V_64 * V_65 )
{
struct V_1 * V_49 = F_40 ( V_65 ) ;
F_35 ( V_65 , NULL ) ;
F_41 ( & V_49 -> V_6 ) ;
F_26 ( V_49 ) ;
F_36 ( V_49 -> V_5 ) ;
...
static int F_42 ( struct V_84 * V_82 )
{
struct V_1 * V_49 = F_43 ( V_82 ) ;
F_26 ( V_49 ) ;
return 0 ;
}
static int F_44 ( struct V_84 * V_82 )
{
struct V_1 * V_49 = F_43 ( V_82 ) ;
F_17 ( V_49 ) ;
return 0 ;
