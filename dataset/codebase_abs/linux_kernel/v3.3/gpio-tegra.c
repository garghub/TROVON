...
void T_3 F_68 ( struct V_70 * V_71 , int V_72 )
{
int V_55 ;
...
static int F_69 ( struct V_73 * V_74 , void * V_75 )
{
int V_55 ;
int V_56 ;
for ( V_55 = 0 ; V_55 < 7 ; V_55 ++ ) {
...
static int F_71 ( struct V_76 * V_76 , struct V_77 * V_77 )
{
return F_72 ( V_77 , F_69 , & V_76 -> V_78 ) ;
}
