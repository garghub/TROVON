...
static void F_44 ( unsigned long V_92 )
{
struct V_7 * V_8 ;
T_3 V_11 , V_12 , V_13 ;
struct V_1 * V_2 ;
...
case V_96 :
case V_97 :
if ( V_8 -> V_14 < F_46 ( V_2 ) ) {
T_2 rand ;
F_45 ( L_2 ,
V_8 -> V_8 . V_46 , V_8 -> V_14 ,
V_8 -> V_98 ) ;
F_47 ( & rand , sizeof( T_2 ) ) ;
V_8 -> V_98 = V_8 -> V_98 +
rand % V_8 -> V_98 ;
++ V_8 -> V_14 ;
F_48 ( V_8 , V_8 -> V_98 ) ;
...
void F_59 ( struct V_1 * V_2 , struct V_53 * V_54 ,
...
memcpy ( & V_12 , F_63 ( V_18 . V_123 ) , 2 ) ;
if ( V_116 == V_77 ||
( V_116 == V_45 && V_58 == 8 ) )
memcpy ( & V_11 , F_64 ( V_18 . V_123 ) , 2 ) ;
F_37 () ;
...
V_16 = F_67 ( V_20 , & V_18 , V_113 -> V_27 ) ;
