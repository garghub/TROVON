...
static T_6 F_69 ( struct V_55 * V_55 , const char T_7 * V_119 ,
T_8 V_88 , T_1 * V_120 )
{
struct V_87 * V_45 ;
char V_121 [ V_122 ] ;
...
V_88 = sizeof( V_121 ) - 1 ;
if ( F_70 ( V_121 , V_119 , V_88 ) )
return - V_124 ;
V_123 = F_71 ( F_72 ( V_121 ) , 10 , & type ) ;
if ( V_123 < 0 )
return V_123 ;
if ( type < V_125 || type > V_126 )
return - V_127 ;
V_45 = F_73 ( V_55 -> V_70 . V_71 -> V_72 ) ;
if ( ! V_45 )
return - V_48 ;
V_4 = F_74 ( V_45 ) ;
if ( V_4 ) {
...
static int F_76 ( unsigned long V_92 , T_9 V_130 ,
struct V_131 * V_132 )
{
...
static int F_77 ( unsigned long V_67 , unsigned long V_68 ,
struct V_94 * V_95 )
{
...
V_134 = F_76 ( V_92 , V_135 , V_132 ) ;
if ( V_134 )
break;
}
return V_134 ;
}
static T_9 F_78 ( V_25 V_109 )
{
T_10 V_136 = F_79 ( V_109 ) ;
return F_80 ( V_136 ) | ( F_81 ( V_136 ) << V_137 ) ;
}
static T_9 F_82 ( V_25 V_109 )
{
T_9 V_138 = 0 ;
if ( F_40 ( V_109 ) )
V_138 = F_83 ( F_78 ( V_109 ) )
| F_84 ( V_19 ) | V_139 ;
else if ( F_41 ( V_109 ) )
V_138 = F_83 ( F_85 ( V_109 ) )
| F_84 ( V_19 ) | V_140 ;
return V_138 ;
}
static int F_86 ( T_4 * V_108 , unsigned long V_92 , unsigned long V_68 ,
struct V_94 * V_95 )
{
struct V_35 * V_36 ;
struct V_131 * V_132 = V_95 -> V_41 ;
...
! F_59 ( V_36 ) ) {
V_109 = F_87 ( V_108 , V_92 ) ;
V_130 = F_82 ( * V_109 ) ;
F_88 ( V_109 ) ;
}
V_134 = F_76 ( V_92 , V_130 , V_132 ) ;
if ( V_134 )
return V_134 ;
}
F_57 () ;
...
static T_9 F_89 ( V_25 V_109 , int V_141 )
{
T_9 V_138 = 0 ;
if ( F_41 ( V_109 ) )
V_138 = F_83 ( F_85 ( V_109 ) + V_141 )
| F_84 ( V_19 ) | V_140 ;
return V_138 ;
}
static int F_90 ( V_25 * V_109 , unsigned long V_142 ,
...
static T_6 F_91 ( struct V_55 * V_55 , char T_7 * V_119 ,
T_8 V_88 , T_1 * V_120 )
{
struct V_87 * V_45 = F_73 ( V_55 -> V_70 . V_71 -> V_72 ) ;
struct V_3 * V_4 ;
struct V_131 V_132 ;
int V_58 = - V_48 ;
struct V_94 V_143 = {} ;
...
V_132 . V_121 = F_92 ( V_132 . V_32 , V_152 ) ;
V_58 = - V_59 ;
if ( ! V_132 . V_121 )
goto V_150;
V_4 = F_15 ( V_45 ) ;
...
F_10 ( & V_4 -> V_39 ) ;
V_146 = V_68 ;
V_32 = F_96 ( V_88 , V_149 * V_132 . V_40 ) ;
if ( F_97 ( V_119 , V_132 . V_121 , V_32 ) ) {
V_58 = - V_124 ;
goto V_157;
}
V_148 += V_32 ;
...
static void F_98 ( struct V_98 * V_98 , struct V_158 * V_159 , int F_47 ,
unsigned long V_160 )
{
int V_88 = F_46 ( V_98 ) ;
V_159 -> V_161 += V_160 ;
...
if ( V_88 > V_159 -> V_167 )
V_159 -> V_167 = V_88 ;
V_159 -> V_168 [ F_103 ( V_98 ) ] += V_160 ;
}
static struct V_98 * F_104 ( V_25 V_109 , struct V_35 * V_36 ,
unsigned long V_92 )
{
struct V_98 * V_98 ;
int V_169 ;
...
struct V_98 * V_98 ;
V_98 = F_104 ( V_173 , V_159 -> V_36 , V_92 ) ;
if ( V_98 )
F_98 ( V_98 , V_159 , F_47 ( V_173 ) ,
V_113 / V_27 ) ;
F_53 ( & V_95 -> V_4 -> V_111 ) ;
return 0 ;
}
...
do {
struct V_98 * V_98 = F_104 ( * V_109 , V_159 -> V_36 , V_92 ) ;
if ( ! V_98 )
continue;
F_98 ( V_98 , V_159 , F_47 ( * V_109 ) , 1 ) ;
