...
static int T_5 F_49 ( struct V_175 * V_176 ,
...
static void T_8 F_54 ( struct V_175 * V_176 )
{
if ( V_3 -> V_131 ) {
F_40 ( V_3 -> V_131 ) ;
V_3 -> V_131 = NULL ;
...
static int T_5 F_37 ( const struct V_182 * V_183 , const char * V_184 ,
int V_6 , int V_185 )
{
int V_121 ;
...
static int T_6 F_61 ( char * V_187 )
{
char * V_188 ;
char V_189 [ 80 ] ;
char V_190 [ 80 ] ;
