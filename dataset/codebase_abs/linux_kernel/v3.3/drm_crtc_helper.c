...
F_5 ( V_74 -> V_96 [ V_85 ] ) ) ;
V_74 -> V_96 [ V_85 ] -> V_28 -> V_46 ( V_74 -> V_96 [ V_85 ] , V_99 ) ;
}
}
F_21 ( V_15 ) ;
} else if ( V_80 ) {
...
V_51 -> V_105 [ V_85 ] = V_102 -> V_105 [ V_85 ] ;
V_51 -> V_106 [ V_85 ] = V_102 -> V_106 [ V_85 ] ;
}
F_40 ( V_102 -> V_107 , & V_51 -> V_94 ,
& V_51 -> V_95 ) ;
V_51 -> V_107 = V_102 -> V_107 ;
return 0 ;
}
...
{
struct V_110 * V_110 = F_43 ( V_109 ) ;
struct V_14 * V_15 = F_44 ( V_110 , struct V_14 , V_88 . V_111 ) ;
struct V_1 * V_2 ;
enum V_112 V_113 ;
bool V_114 = false , V_115 = false ;
if ( ! V_116 )
return;
F_45 ( & V_15 -> V_88 . V_117 ) ;
F_18 (connector, &dev->mode_config.connector_list, head) {
if ( ! V_2 -> V_118 )
continue;
else if ( V_2 -> V_118 & ( V_119 | V_120 ) )
V_114 = true ;
V_113 = V_2 -> V_9 ;
if ( V_113 == V_26 &&
! ( V_2 -> V_118 & V_120 ) &&
...
F_46 ( & V_15 -> V_88 . V_117 ) ;
if ( V_115 ) {
F_47 ( V_15 ) ;
if ( V_15 -> V_88 . V_28 -> V_122 )
V_15 -> V_88 . V_28 -> V_122 ( V_15 ) ;
}
if ( V_114 )
F_48 ( V_123 , V_110 , V_124 ) ;
}
void F_49 ( struct V_14 * V_15 )
{
if ( ! V_15 -> V_88 . V_125 )
return;
F_50 ( & V_15 -> V_88 . V_111 ) ;
}
void F_6 ( struct V_14 * V_15 )
{
bool V_126 = false ;
struct V_1 * V_2 ;
if ( ! V_15 -> V_88 . V_125 || ! V_116 )
return;
F_18 (connector, &dev->mode_config.connector_list, head) {
if ( V_2 -> V_118 )
V_126 = true ;
...
if ( V_126 )
F_48 ( V_123 , & V_15 -> V_88 . V_111 , V_124 ) ;
}
void F_51 ( struct V_14 * V_15 )
{
F_52 ( & V_15 -> V_88 . V_111 , F_42 ) ;
V_15 -> V_88 . V_125 = true ;
F_6 ( V_15 ) ;
}
...
if ( ! V_15 -> V_88 . V_125 )
return;
F_55 ( & V_15 -> V_88 . V_111 ) ;
if ( V_116 )
F_48 ( V_123 , & V_15 -> V_88 . V_111 , 0 ) ;
}
int F_56 ( T_1 V_127 )
{
switch ( V_127 ) {
