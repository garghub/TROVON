...
V_118 = F_40 ( sizeof *V_118 , V_119 ) ;
if ( ! V_118 ) {
V_69 = - V_19 ;
goto V_120;
}
if ( ! V_68 -> V_77 ) {
V_68 -> V_77 = F_40 ( sizeof( struct V_121 ) + V_63 -> V_73 ,
V_119 ) ;
if ( V_68 -> V_77 ) {
V_68 -> V_77 -> V_108 = ( char * ) V_68 -> V_77 +
sizeof( struct V_121 ) ;
V_68 -> V_77 -> V_122 = V_63 -> V_73 ;
}
}
...
if ( F_42 ( & V_35 -> V_96 ) )
goto error;
return F_43 ( V_35 -> V_101 , & V_104 , & V_105 ) ;
error:
F_8 ( V_32 ) ;
F_8 ( V_118 -> V_77 ) ;
F_8 ( V_118 ) ;
...
F_8 ( V_118 ) ;
V_120:
F_44 ( & V_35 -> V_128 , V_117 ) ;
if ( V_35 -> V_38 < V_129 ) {
V_35 -> V_38 = V_129 ;
F_45 ( & V_35 -> V_128 , V_117 ) ;
F_11 ( V_35 -> V_61 ) ;
} else
F_45 ( & V_35 -> V_128 , V_117 ) ;
return V_69 ;
...
static int
F_54 ( struct V_31 * V_63 , const char * V_109 , char * args )
{
int V_69 ;
struct V_2 V_3 ;
struct V_34 * V_35 ;
...
if ( ! V_35 )
return - V_19 ;
V_35 -> V_61 = F_55 ( F_9 , V_63 , V_136 ,
V_137 ) ;
if ( F_29 ( V_35 -> V_61 ) )
goto error;
V_63 -> V_36 = V_35 ;
V_35 -> V_109 . V_138 = V_139 ;
V_35 -> V_109 . V_140 . V_141 = F_56 ( V_109 ) ;
V_35 -> V_109 . V_142 = F_57 ( V_3 . V_9 ) ;
V_69 = F_58 ( V_35 -> V_61 , NULL ,
(struct V_143 * ) & V_35 -> V_109 ,
V_35 -> V_15 ) ;
if ( V_69 )
goto error;
V_69 = F_59 ( & V_35 -> V_62 ) ;
...
goto error;
V_69 = F_61 ( V_35 -> V_61 -> V_71 , & V_135 ) ;
if ( V_69 )
goto error;
...
goto error;
F_22 ( V_35 -> V_85 , V_90 ) ;
V_35 -> V_102 = F_63 ( V_35 -> V_61 -> V_71 ) ;
if ( F_29 ( V_35 -> V_102 ) )
goto error;
V_35 -> V_100 = NULL ;
if ( V_135 . V_144 & V_145 )
V_35 -> V_111 = V_35 -> V_61 -> V_71 -> V_146 ;
else {
V_35 -> V_100 = F_64 ( V_35 -> V_102 , V_147 ) ;
if ( F_29 ( V_35 -> V_100 ) )
goto error;
...
V_133 . V_148 = F_20 ;
V_133 . V_149 = V_63 ;
V_133 . V_150 . V_151 = V_3 . V_11 ;
V_133 . V_150 . V_152 = V_3 . V_13 ;
V_133 . V_150 . V_153 = V_154 ;
V_133 . V_150 . V_155 = V_156 ;
V_133 . V_157 = V_158 ;
V_133 . V_159 = V_137 ;
V_133 . V_160 = V_35 -> V_85 ;
V_133 . V_161 = V_35 -> V_85 ;
V_69 = F_65 ( V_35 -> V_61 , V_35 -> V_102 , & V_133 ) ;
if ( V_69 )
goto error;
