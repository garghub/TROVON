...
static void
F_37 ( T_2 * V_66 , struct V_10 * V_11 , const char * V_67 , void * V_68 )
{
switch ( V_11 -> type ) {
case V_31 :
case V_27 : {
...
static void
F_38 ( T_2 * V_66 , const char * V_67 , void * V_68 )
{
const char * V_25 = V_67 ;
T_3 V_70 ;
fprintf ( V_66 , L_29 ) ;
...
static void
F_40 ( T_2 * V_66 , struct V_10 * V_11 , const char * V_67 , void * V_68 )
{
if ( V_11 -> type == V_27 && * V_67 != 'n' )
fprintf ( V_66 , L_35 , V_54 , V_11 -> V_8 , ( char ) toupper ( * V_67 ) ) ;
}
static void F_41 ( T_2 * V_66 , struct V_10 * V_11 ,
...
static void
F_43 ( T_2 * V_66 , struct V_73 * V_74 , void * V_75 )
{
char V_17 [ 256 ] ;
...
V_58 = F_25 ( F_26 ( V_11 ) ) ;
V_87 = F_49 ( V_58 ) ;
if ( ! F_50 ( V_58 ) && V_11 == V_87 ) {
if ( ( V_11 -> type == V_31 ) &&
F_31 ( V_11 ) == V_32 )
goto V_86;
}
}
F_41 ( V_84 , V_11 , & V_88 , NULL ) ;
}
V_86:
if ( V_83 -> V_85 != NULL ) {
V_83 = V_83 -> V_85 ;
...
struct V_16 V_95 ;
char * V_96 ;
if ( ! V_16 ( V_8 , & V_95 ) && F_52 ( V_95 . V_97 ) ) {
strcpy ( V_92 , V_8 ) ;
strcat ( V_92 , L_39 ) ;
V_91 = F_6 () ;
...
V_20 = getenv ( L_41 ) ;
if ( ! V_20 || ! * V_20 ) {
sprintf ( V_93 , L_42 , V_92 , ( int ) F_53 () ) ;
...
strcpy ( V_102 , L_48 ) ;
V_106 = F_58 ( V_100 , V_109 | V_110 | V_111 , 0644 ) ;
if ( V_106 == - 1 ) {
if ( V_112 != V_113 ) {
V_105 = 1 ;
break;
...
* V_102 = 0 ;
if ( V_16 ( V_100 , & V_104 ) && F_59 ( V_100 , 0755 ) ) {
V_105 = 1 ;
goto V_84;
}
* V_102 ++ = '/' ;
...
F_43 ( V_84 , & V_88 , NULL ) ;
F_43 ( V_114 , & V_116 , NULL ) ;
F_43 ( V_115 , & V_117 , NULL ) ;
F_21 (i, sym) {
if ( ! V_11 -> V_8 )
continue;
F_10 ( V_11 ) ;
F_41 ( V_115 , V_11 , & V_118 , NULL ) ;
if ( ! ( V_11 -> V_30 & V_63 ) )
continue;
F_41 ( V_84 , V_11 , & V_88 , ( void * ) 1 ) ;
F_41 ( V_114 , V_11 , & V_116 , ( void * ) 1 ) ;
F_41 ( V_115 , V_11 , & V_117 , NULL ) ;
}
fclose ( V_84 ) ;
fclose ( V_114 ) ;
fclose ( V_115 ) ;
...
static void F_65 ( struct V_10 * V_123 )
{
struct V_41 * V_42 ;
struct V_10 * V_11 ;
struct V_47 * V_60 ;
