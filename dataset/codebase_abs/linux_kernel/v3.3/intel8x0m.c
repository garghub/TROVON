...
static int T_7 F_50 ( struct V_1 * V_2 , int V_108 ,
struct V_109 * V_110 )
{
struct V_111 * V_112 ;
int V_102 ;
...
static int T_7 F_58 ( struct V_1 * V_2 , int V_141 )
{
struct V_138 * V_142 ;
struct V_143 V_19 ;
struct V_18 * V_144 ;
...
static int F_73 ( struct V_172 * V_125 , T_8 V_173 )
{
struct V_174 * V_115 = F_74 ( V_125 ) ;
...
F_71 ( V_125 ) ;
F_78 ( V_125 ) ;
F_79 ( V_125 , F_80 ( V_125 , V_173 ) ) ;
return 0 ;
}
static int F_81 ( struct V_172 * V_125 )
{
struct V_174 * V_115 = F_74 ( V_125 ) ;
struct V_1 * V_2 = V_115 -> V_21 ;
F_79 ( V_125 , V_176 ) ;
...
static void T_7 F_91 ( struct V_1 * V_2 )
{
struct V_180 * V_181 ;
if ( ! F_92 ( V_2 -> V_115 , L_23 , & V_181 ) )
F_93 ( V_181 , V_2 , F_89 ) ;
}
static int F_94 ( struct V_184 * V_108 )
{
struct V_1 * V_2 = V_108 -> V_185 ;
return F_66 ( V_2 ) ;
}
static int T_7 F_95 ( struct V_174 * V_115 ,
struct V_172 * V_125 ,
unsigned long V_131 ,
struct V_1 * * V_186 )
{
...
unsigned int V_187 ;
struct V_32 * V_32 ;
static struct V_188 V_147 = {
. V_189 = F_94 ,
} ;
static struct V_190 V_191 [ 2 ] = {
{ V_161 , 0 } ,
{ V_162 , 0x10 } ,
} ;
struct V_190 * V_129 ;
...
if ( V_131 == V_134 )
V_32 -> V_198 = ( V_32 -> V_36 - 0x40 ) / 0x10 ;
}
V_2 -> V_46 = ( V_131 == V_168 ) ? 0 : 1 ;
if ( F_102 ( V_124 , F_54 ( V_125 ) ,
V_2 -> V_68 * sizeof( T_2 ) * V_199 * 2 ,
& V_2 -> V_170 ) < 0 ) {
F_66 ( V_2 ) ;
return - V_193 ;
}
...
for ( V_58 = 0 ; V_58 < V_2 -> V_68 ; V_58 ++ ) {
V_32 = & V_2 -> V_69 [ V_58 ] ;
V_32 -> V_34 = ( ( T_2 * ) V_2 -> V_170 . V_171 ) + ( V_58 * V_199 * 2 ) ;
V_32 -> V_38 = V_2 -> V_170 . V_6 + ( V_58 * sizeof( T_2 ) * V_199 * 2 ) ;
V_187 |= V_32 -> V_67 ;
}
V_2 -> V_65 = V_200 ;
V_2 -> V_67 = V_187 ;
...
if ( ( V_102 = F_103 ( V_115 , V_201 , V_2 , & V_147 ) ) < 0 ) {
F_66 ( V_2 ) ;
return V_102 ;
}
F_104 ( V_115 , & V_125 -> V_202 ) ;
* V_186 = V_2 ;
return 0 ;
}
static int T_7 F_105 ( struct V_172 * V_125 ,
...
static void T_9 F_110 ( struct V_172 * V_125 )
{
F_107 ( F_74 ( V_125 ) ) ;
F_109 ( V_125 , NULL ) ;
}
