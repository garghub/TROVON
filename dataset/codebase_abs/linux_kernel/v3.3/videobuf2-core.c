...
if ( ! F_38 ( V_4 -> type ) && ( V_4 -> V_64 & V_130 ) ) {
V_30 = F_70 ( V_4 , 1 ) ;
if ( V_30 )
return V_131 ;
}
if ( F_38 ( V_4 -> type ) && ( V_4 -> V_64 & V_132 ) ) {
V_30 = F_70 ( V_4 , 0 ) ;
if ( V_30 )
return V_131 ;
return V_133 | V_134 ;
...
|| V_2 -> V_33 == V_57 ) ) {
return ( F_38 ( V_4 -> type ) ) ? V_133 | V_134 :
V_135 | V_136 ;
}
return 0 ;
}
...
static int F_70 ( struct V_3 * V_4 , int V_137 )
{
struct V_138 * V_73 ;
int V_111 , V_30 ;
unsigned int V_76 = 0 ;
if ( ( V_137 && ! ( V_4 -> V_64 & V_130 ) ) ||
( ! V_137 && ! ( V_4 -> V_64 & V_132 ) ) )
F_78 () ;
if ( ! V_4 -> V_66 -> V_85 )
return - V_74 ;
...
V_76 = 1 ;
F_5 ( 3 , L_76 ,
( V_137 ) ? L_77 : L_78 , V_76 , V_4 -> V_139 ) ;
V_73 = F_10 ( sizeof( struct V_138 ) , V_32 ) ;
if ( V_73 == NULL )
return - V_15 ;
V_73 -> V_52 = V_4 -> V_139 ;
V_73 -> V_71 . V_76 = V_76 ;
...
goto V_141;
V_73 -> V_25 [ V_111 ] . V_142 = F_79 ( V_4 -> V_25 [ V_111 ] , 0 ) ;
}
if ( V_137 ) {
for ( V_111 = 0 ; V_111 < V_4 -> V_22 ; V_111 ++ ) {
...
static T_2 F_80 ( struct V_3 * V_4 , char T_3 * V_144 , T_2 V_76 ,
T_4 * V_145 , int V_146 , int V_137 )
{
struct V_138 * V_73 ;
struct V_147 * V_148 ;
int V_30 , V_17 ;
F_5 ( 3 , L_80 ,
V_137 ? L_77 : L_78 , ( long ) * V_145 , V_76 ,
V_146 ? L_81 : L_82 ) ;
if ( ! V_144 )
return - V_43 ;
if ( ! V_4 -> V_73 ) {
...
V_73 -> V_42 . V_17 = V_17 ;
V_30 = F_59 ( V_4 , & V_73 -> V_42 , V_146 ) ;
F_5 ( 5 , L_84 , V_30 ) ;
if ( V_30 )
goto V_149;
V_73 -> V_150 += 1 ;
V_2 = V_4 -> V_25 [ V_17 ] ;
V_148 -> V_142 = F_81 ( V_2 , 0 ) ;
V_148 -> V_143 = 0 ;
}
if ( V_148 -> V_151 + V_76 > V_148 -> V_142 ) {
V_76 = V_148 -> V_142 - V_148 -> V_151 ;
F_5 ( 5 , L_85 , V_76 ) ;
}
F_5 ( 3 , L_86 ,
V_76 , V_17 , V_148 -> V_151 ) ;
if ( V_137 )
V_30 = F_82 ( V_144 , V_148 -> V_85 + V_148 -> V_151 , V_76 ) ;
else
V_30 = F_83 ( V_148 -> V_85 + V_148 -> V_151 , V_144 , V_76 ) ;
if ( V_30 ) {
F_5 ( 3 , L_87 ) ;
V_30 = - V_152 ;
goto V_149;
...
V_148 -> V_151 += V_76 ;
* V_145 += V_76 ;
if ( V_148 -> V_151 == V_148 -> V_142 ||
( ! V_137 && ( V_73 -> V_52 & V_153 ) ) ) {
if ( V_137 && ( V_73 -> V_52 & V_154 ) &&
V_73 -> V_150 == 1 ) {
F_5 ( 3 , L_88 ) ;
V_4 -> V_73 = V_73 ;
return F_77 ( V_4 ) ;
...
V_148 -> V_151 = 0 ;
V_148 -> V_143 = 1 ;
V_148 -> V_142 = V_4 -> V_25 [ 0 ] -> V_12 [ 0 ] . V_13 ;
V_73 -> V_155 += 1 ;
...
T_2 F_84 ( struct V_3 * V_4 , char T_3 * V_144 , T_2 V_76 ,
T_4 * V_145 , int V_108 )
{
return F_80 ( V_4 , V_144 , V_76 , V_145 , V_108 , 1 ) ;
}
T_2 F_85 ( struct V_3 * V_4 , char T_3 * V_144 , T_2 V_76 ,
T_4 * V_145 , int V_108 )
{
return F_80 ( V_4 , V_144 , V_76 , V_145 , V_108 , 0 ) ;
}
