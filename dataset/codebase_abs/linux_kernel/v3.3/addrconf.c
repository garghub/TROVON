...
F_45 ( V_7 -> V_79 , V_45 ) ;
F_46 ( V_7 , & V_80 ) ;
if ( V_45 -> V_49 . V_55 && V_7 && ( V_7 -> V_58 & V_81 ) )
F_46 ( V_7 , & V_82 ) ;
return V_45 ;
}
...
static int F_114 ( struct V_13 * V_14 , struct V_13 * V_146 )
{
struct V_4 * V_5 = V_14 -> V_5 ;
...
static inline int F_119 ( int type )
{
if ( type & ( V_172 | V_173 | V_115 ) )
return 1 ;
return 0 ;
}
static int F_120 ( struct V_86 * V_86 ,
struct V_174 * V_175 ,
struct V_176 * V_99 ,
int V_177 )
{
...
break;
case V_185 :
V_154 = F_122 ( & V_175 -> V_84 -> V_102 , V_99 -> V_102 ) ;
break;
case V_179 :
V_154 = F_123 ( V_175 -> V_112 ) ;
if ( V_154 >= V_99 -> V_109 )
V_154 = - V_154 ;
else
V_154 -= 128 ;
...
#endif
case V_200 :
V_154 = ! ( F_126 ( & V_175 -> V_84 -> V_102 ) ^
F_126 ( V_99 -> V_102 ) ) ;
break;
case V_181 :
V_175 -> V_182 = V_154 = F_127 ( & V_175 -> V_84 -> V_102 ,
V_99 -> V_102 ) ;
break;
default:
V_154 = 0 ;
...
if ( V_154 )
F_128 ( V_177 , V_175 -> V_183 ) ;
V_175 -> V_178 = V_177 ;
V_123:
return V_154 ;
}
int F_129 ( struct V_86 * V_86 , struct V_6 * V_201 ,
...
V_99 . V_109 = F_123 ( V_206 ) ;
V_99 . V_195 = F_125 ( V_86 , V_202 , V_206 , V_99 . V_144 ) ;
V_99 . V_190 = V_190 ;
V_205 -> V_178 = - 1 ;
V_205 -> V_84 = NULL ;
F_56 () ;
...
continue;
V_175 -> V_112 = F_130 ( & V_175 -> V_84 -> V_102 ) ;
if ( F_132 ( V_175 -> V_112 == V_113 ||
V_175 -> V_112 & V_114 ) ) {
F_133 ( V_41
L_16
L_17 ,
...
V_175 -> V_178 = - 1 ;
F_134 ( V_175 -> V_183 , V_208 ) ;
for ( V_177 = 0 ; V_177 < V_208 ; V_177 ++ ) {
int V_209 , V_210 ;
V_209 = F_120 ( V_86 , V_205 , & V_99 , V_177 ) ;
V_210 = F_120 ( V_86 , V_175 , & V_99 , V_177 ) ;
if ( V_209 > V_210 ) {
if ( V_177 == V_179 &&
V_175 -> V_180 > 0 ) {
goto V_211;
...
int F_137 ( struct V_6 * V_7 , struct V_104 * V_102 ,
unsigned char V_212 )
{
struct V_4 * V_5 ;
int V_111 = - V_116 ;
...
int F_138 ( struct V_86 * V_86 , const struct V_104 * V_102 ,
...
F_79 () ;
F_139 (ifp, node, &inet6_addr_lst[hash], addr_lst) {
if ( ! F_140 ( F_32 ( V_14 -> V_5 -> V_7 ) , V_86 ) )
continue;
if ( F_122 ( & V_14 -> V_102 , V_102 ) &&
! ( V_14 -> V_58 & V_85 ) &&
...
int F_142 ( const struct V_104 * V_102 , struct V_6 * V_7 )
{
struct V_4 * V_5 ;
struct V_13 * V_84 ;
int V_136 ;
...
struct V_13 * F_143 ( struct V_86 * V_86 , const struct V_104 * V_102 ,
struct V_6 * V_7 , int V_215 )
{
...
struct V_216 * V_217 ;
F_79 () ;
F_144 (ifp, node, &inet6_addr_lst[hash], addr_lst) {
if ( ! F_140 ( F_32 ( V_14 -> V_5 -> V_7 ) , V_86 ) )
continue;
if ( F_122 ( & V_14 -> V_102 , V_102 ) ) {
if ( V_7 == NULL || V_14 -> V_5 -> V_7 == V_7 ||
...
static void F_145 ( struct V_13 * V_14 , int V_220 )
{
if ( V_14 -> V_58 & V_138 ) {
F_97 ( & V_14 -> V_48 ) ;
F_7 ( V_14 ) ;
...
struct V_104 V_102 ;
V_102 . V_106 [ 0 ] = F_149 ( 0xfe800000 ) ;
V_102 . V_106 [ 1 ] = 0 ;
if ( ! F_150 ( V_102 . V_158 + 8 , V_5 -> V_7 ) &&
F_122 ( & V_14 -> V_102 , & V_102 ) ) {
V_5 -> V_49 . V_119 = 1 ;
F_24 ( V_67 L_19 ,
V_14 -> V_5 -> V_7 -> V_42 ) ;
}
...
void F_151 ( struct V_6 * V_7 , const struct V_104 * V_102 )
{
struct V_104 V_225 ;
...
void F_153 ( struct V_4 * V_5 , const struct V_104 * V_102 )
{
struct V_104 V_225 ;
...
if ( F_155 ( & V_102 ) )
return;
F_157 ( V_14 -> V_5 , & V_102 ) ;
}
static int F_158 ( T_3 * V_226 , struct V_6 * V_7 )
{
if ( V_7 -> V_227 != V_228 )
return - 1 ;
...
static int F_161 ( T_3 * V_226 , T_4 V_102 )
{
if ( V_102 == 0 )
return - 1 ;
V_226 [ 0 ] = ( F_162 ( V_102 ) || F_163 ( V_102 ) ||
F_164 ( V_102 ) || F_165 ( V_102 ) ||
F_166 ( V_102 ) || F_167 ( V_102 ) ||
F_168 ( V_102 ) || F_169 ( V_102 ) ||
F_170 ( V_102 ) || F_171 ( V_102 ) ||
F_172 ( V_102 ) ) ? 0x00 : 0x02 ;
V_226 [ 1 ] = 0 ;
V_226 [ 2 ] = 0x5E ;
V_226 [ 3 ] = 0xFE ;
...
static int F_173 ( T_3 * V_226 , struct V_6 * V_7 )
{
if ( V_7 -> V_65 & V_66 )
return F_161 ( V_226 , * ( T_4 * ) V_7 -> V_229 ) ;
return - 1 ;
}
...
static int F_150 ( T_3 * V_226 , struct V_6 * V_7 )
{
switch ( V_7 -> type ) {
case V_233 :
case V_234 :
case V_235 :
return F_158 ( V_226 , V_7 ) ;
case V_236 :
return F_159 ( V_226 , V_7 ) ;
case V_237 :
return F_160 ( V_226 , V_7 ) ;
case V_64 :
return F_173 ( V_226 , V_7 ) ;
case V_238 :
return F_174 ( V_226 , V_7 ) ;
}
return - 1 ;
}
static int F_175 ( T_3 * V_226 , struct V_4 * V_5 )
{
int V_111 = - 1 ;
struct V_13 * V_14 ;
F_131 ( & V_5 -> V_48 ) ;
...
{
V_239:
F_177 ( V_5 -> V_162 , sizeof( V_5 -> V_162 ) ) ;
V_5 -> V_162 [ 0 ] &= ~ 0x02 ;
if ( V_5 -> V_162 [ 0 ] == 0xfd &&
...
static int F_115 ( struct V_4 * V_5 , struct V_104 * V_147 ) {
int V_154 = 0 ;
...
static void
F_179 ( struct V_104 * V_240 , int V_241 , struct V_6 * V_7 ,
...
static struct V_8 * F_181 ( const struct V_104 * V_240 ,
int V_241 ,
...
struct V_8 * V_9 = NULL ;
struct V_263 * V_90 ;
V_90 = F_182 ( F_32 ( V_7 ) , V_245 ) ;
if ( V_90 == NULL )
return NULL ;
F_100 ( & V_90 -> V_264 ) ;
V_262 = F_183 ( & V_90 -> V_265 , V_240 , V_241 , NULL , 0 ) ;
if ( ! V_262 )
goto V_123;
...
F_186 ( & V_243 . V_257 , F_149 ( 0xFF000000 ) , 0 , 0 , 0 ) ;
F_180 ( & V_243 ) ;
}
...
{
struct V_104 V_102 ;
F_186 ( & V_102 , F_149 ( 0xFE800000 ) , 0 , 0 , 0 ) ;
F_179 ( & V_102 , 64 , V_7 , 0 , 0 ) ;
}
static struct V_4 * F_189 ( struct V_6 * V_7 )
{
struct V_4 * V_5 ;
F_29 () ;
V_5 = F_47 ( V_7 ) ;
...
void F_190 ( struct V_6 * V_7 , T_3 * V_270 , int V_271 , bool V_272 )
{
struct V_273 * V_274 ;
V_163 V_140 ;
V_163 V_165 ;
...
return;
V_140 = F_191 ( V_274 -> V_277 ) ;
V_165 = F_191 ( V_274 -> V_278 ) ;
if ( V_165 > V_140 ) {
if ( F_148 () )
F_24 ( V_56 L_22 ) ;
return;
...
if ( F_150 ( V_102 . V_158 + 8 , V_7 ) &&
F_175 ( V_102 . V_158 + 8 , V_275 ) ) {
F_66 ( V_275 ) ;
return;
}
goto V_286;
...
F_197 ( V_292 , V_275 , V_274 ) ;
F_66 ( V_275 ) ;
}
int F_198 ( struct V_86 * V_86 , void T_6 * V_293 )
{
struct V_294 V_295 ;
struct V_6 * V_7 ;
int V_111 = - V_296 ;
F_199 () ;
V_111 = - V_297 ;
if ( F_200 ( & V_295 , V_293 , sizeof( struct V_294 ) ) )
goto V_298;
V_7 = F_201 ( V_86 , V_295 . V_299 ) ;
V_111 = - V_117 ;
if ( V_7 == NULL )
goto V_298;
#if F_40 ( V_62 ) || F_40 ( V_63 )
...
static int F_206 ( struct V_86 * V_86 , int V_144 , const struct V_104 * V_240 ,
...
int F_210 ( struct V_86 * V_86 , void T_6 * V_293 )
{
struct V_294 V_295 ;
int V_111 ;
if ( ! F_211 ( V_323 ) )
...
return - V_297 ;
F_199 () ;
V_111 = F_206 ( V_86 , V_295 . V_299 , & V_295 . V_306 ,
V_295 . V_325 , V_138 ,
V_326 , V_326 ) ;
F_62 () ;
return V_111 ;
...
static void F_213 ( struct V_4 * V_5 , const struct V_104 * V_102 ,
int V_241 , int V_109 )
{
struct V_13 * V_14 ;
...
if ( V_102 . V_106 [ 3 ] ) {
F_213 ( V_5 , & V_102 , 128 , V_109 ) ;
return;
}
F_215 (net, dev) {
struct V_328 * V_329 = F_216 ( V_7 ) ;
...
F_213 ( V_5 , & V_338 , 128 , V_218 ) ;
}
static void F_218 ( struct V_4 * V_5 , const struct V_104 * V_102 )
{
struct V_13 * V_14 ;
T_1 V_156 = V_138 ;
#ifdef F_195
...
static inline int
F_223 ( struct V_4 * V_5 , struct V_6 * V_339 )
{
struct V_104 V_340 ;
if ( ! F_137 ( V_339 , & V_340 , V_85 ) ) {
F_218 ( V_5 , & V_340 ) ;
return 0 ;
}
return - 1 ;
...
struct V_86 * V_86 = F_32 ( V_5 -> V_7 ) ;
if ( V_5 -> V_7 -> V_341 &&
( V_339 = F_201 ( V_86 , V_5 -> V_7 -> V_341 ) ) ) {
if ( ! F_223 ( V_5 , V_339 ) )
return;
}
F_215 (net, link_dev) {
...
static int F_226 ( struct V_342 * V_343 , unsigned long V_344 ,
void * V_127 )
{
...
static void F_232 ( struct V_6 * V_7 , unsigned long V_344 )
{
struct V_4 * V_5 ;
F_29 () ;
V_5 = F_48 ( V_7 ) ;
...
static int F_209 ( struct V_6 * V_7 , int V_359 )
{
struct V_86 * V_86 = F_32 ( V_7 ) ;
struct V_4 * V_5 ;
struct V_13 * V_84 ;
...
V_369 = F_246 () % ( V_5 -> V_49 . V_367 ? : 1 ) ;
V_14 -> V_366 = V_5 -> V_49 . V_168 ;
F_10 ( V_14 , V_19 , V_369 ) ;
}
static void F_118 ( struct V_13 * V_14 , T_1 V_58 )
{
struct V_4 * V_5 = V_14 -> V_5 ;
struct V_6 * V_7 = V_5 -> V_7 ;
F_151 ( V_7 , & V_14 -> V_102 ) ;
F_247 ( V_14 -> V_102 . V_106 [ 3 ] ) ;
F_131 ( & V_5 -> V_48 ) ;
F_80 ( & V_14 -> V_48 ) ;
if ( V_14 -> V_97 == V_98 )
goto V_123;
...
F_89 ( & V_14 -> V_48 ) ;
F_244 ( & V_5 -> V_48 ) ;
F_152 ( & V_14 -> V_102 , & V_371 ) ;
F_250 ( V_14 -> V_5 -> V_7 , NULL , & V_14 -> V_102 , & V_371 , & V_372 ) ;
V_123:
F_102 ( V_14 ) ;
}
static void F_248 ( struct V_13 * V_14 )
{
...
F_243 ( V_14 -> V_5 -> V_7 , & V_14 -> V_102 , & V_82 ) ;
F_97 ( & V_14 -> V_48 ) ;
V_14 -> V_366 = 1 ;
V_14 -> V_5 -> V_76 |= V_364 ;
...
static struct V_13 * F_251 ( struct V_374 * V_375 , T_9 V_376 )
{
struct V_13 * V_84 = NULL ;
struct V_377 * V_97 = V_375 -> V_378 ;
struct V_86 * V_86 = F_252 ( V_375 ) ;
int V_91 = 0 ;
if ( V_376 == 0 ) {
V_97 -> V_379 = 0 ;
V_97 -> V_380 = 0 ;
...
struct V_216 * V_362 ;
F_144 (ifa, n, &inet6_addr_lst[state->bucket],
addr_lst) {
if ( V_91 < V_97 -> V_380 ) {
V_91 ++ ;
continue;
...
V_97 -> V_380 ++ ;
if ( F_140 ( F_32 ( V_84 -> V_5 -> V_7 ) , V_86 ) )
return V_84 ;
}
V_97 -> V_380 = 0 ;
V_91 = 0 ;
...
static struct V_13 * F_253 ( struct V_374 * V_375 ,
struct V_13 * V_84 )
{
struct V_377 * V_97 = V_375 -> V_378 ;
struct V_86 * V_86 = F_252 ( V_375 ) ;
struct V_216 * V_362 = & V_84 -> V_96 ;
F_254 (ifa, n, addr_lst) {
V_97 -> V_380 ++ ;
if ( F_140 ( F_32 ( V_84 -> V_5 -> V_7 ) , V_86 ) )
return V_84 ;
}
...
static void * F_255 ( struct V_374 * V_375 , T_9 * V_376 )
__acquires( T_10 )
{
F_79 () ;
return F_251 ( V_375 , * V_376 ) ;
}
static void * F_256 ( struct V_374 * V_375 , void * V_381 , T_9 * V_376 )
{
struct V_13 * V_84 ;
V_84 = F_253 ( V_375 , V_381 ) ;
++ * V_376 ;
return V_84 ;
}
static void F_257 ( struct V_374 * V_375 , void * V_381 )
__releases( T_10 )
{
F_93 () ;
}
static int F_258 ( struct V_374 * V_375 , void * V_381 )
{
...
static int F_260 ( struct V_382 * V_382 , struct V_383 * V_383 )
{
return F_261 ( V_382 , V_383 , & V_384 ,
sizeof( struct V_377 ) ) ;
}
static int T_11 F_262 ( struct V_86 * V_86 )
{
if ( ! F_263 ( V_86 , L_37 , V_385 , & V_386 ) )
return - V_38 ;
return 0 ;
}
static void T_12 F_264 ( struct V_86 * V_86 )
{
F_265 ( V_86 , L_37 ) ;
}
int T_13 F_266 ( void )
...
int F_270 ( struct V_86 * V_86 , const struct V_104 * V_102 )
{
int V_154 = 0 ;
...
unsigned int V_110 = F_74 ( V_102 ) ;
F_79 () ;
F_144 (ifp, n, &inet6_addr_lst[hash], addr_lst) {
if ( ! F_140 ( F_32 ( V_14 -> V_5 -> V_7 ) , V_86 ) )
continue;
if ( F_122 ( & V_14 -> V_102 , V_102 ) &&
( V_14 -> V_58 & V_192 ) ) {
...
static void F_196 ( unsigned long V_388 )
{
...
static struct V_104 * F_272 ( struct V_399 * V_102 , struct V_399 * V_400 )
{
struct V_104 * V_240 = NULL ;
if ( V_102 )
V_240 = F_273 ( V_102 ) ;
if ( V_400 ) {
if ( V_240 && F_274 ( V_400 , V_240 , sizeof( * V_240 ) ) )
V_240 = NULL ;
else
V_240 = F_273 ( V_400 ) ;
}
...
static int
F_275 ( struct V_401 * V_402 , struct V_403 * V_404 , void * V_293 )
{
struct V_86 * V_86 = F_276 ( V_402 -> V_405 ) ;
struct V_406 * V_407 ;
struct V_399 * V_408 [ V_409 + 1 ] ;
struct V_104 * V_240 ;
int V_111 ;
V_111 = F_277 ( V_404 , sizeof( * V_407 ) , V_408 , V_409 , V_410 ) ;
if ( V_111 < 0 )
return V_111 ;
V_407 = F_278 ( V_404 ) ;
V_240 = F_272 ( V_408 [ V_411 ] , V_408 [ V_412 ] ) ;
if ( V_240 == NULL )
return - V_296 ;
return F_208 ( V_86 , V_407 -> V_413 , V_240 , V_407 -> V_414 ) ;
}
static int F_279 ( struct V_13 * V_14 , T_3 V_320 ,
T_1 V_165 , T_1 V_140 )
{
T_1 V_58 ;
T_5 V_24 ;
...
V_7 = F_201 ( V_86 , V_407 -> V_413 ) ;
if ( V_7 == NULL )
return - V_117 ;
V_320 = V_407 -> V_320 & ( V_370 | V_192 ) ;
V_84 = F_143 ( V_86 , V_240 , V_7 , 1 ) ;
if ( V_84 == NULL ) {
return F_206 ( V_86 , V_407 -> V_413 , V_240 ,
V_407 -> V_414 , V_320 ,
V_415 , V_140 ) ;
}
...
V_111 = F_279 ( V_84 , V_320 , V_415 , V_140 ) ;
F_102 ( V_84 ) ;
return V_111 ;
}
static void F_281 ( struct V_403 * V_404 , T_3 V_424 , T_3 V_58 ,
T_3 V_109 , int V_144 )
{
struct V_406 * V_407 ;
V_407 = F_278 ( V_404 ) ;
...
static int F_282 ( struct V_401 * V_402 , unsigned long V_1 ,
...
V_418 . V_420 = V_427 ;
V_418 . V_419 = V_277 ;
return F_283 ( V_402 , V_416 , sizeof( V_418 ) , & V_418 ) ;
}
static inline int F_284 ( int V_335 )
{
if ( V_335 & V_218 )
return V_337 ;
else if ( V_335 & V_213 )
...
static inline int F_285 ( void )
{
return F_286 ( sizeof( struct V_406 ) )
+ F_287 ( 16 )
+ F_287 ( sizeof( struct V_417 ) ) ;
}
static int F_288 ( struct V_401 * V_402 , struct V_13 * V_84 ,
T_1 V_431 , T_1 V_375 , int V_344 , unsigned int V_58 )
{
struct V_403 * V_404 ;
T_1 V_427 , V_277 ;
V_404 = F_289 ( V_402 , V_431 , V_375 , V_344 , sizeof( struct V_406 ) , V_58 ) ;
if ( V_404 == NULL )
return - V_432 ;
F_281 ( V_404 , V_84 -> V_128 , V_84 -> V_58 , F_284 ( V_84 -> V_109 ) ,
V_84 -> V_5 -> V_7 -> V_144 ) ;
if ( ! ( V_84 -> V_58 & V_138 ) ) {
V_427 = V_84 -> V_165 ;
V_277 = V_84 -> V_140 ;
...
if ( F_283 ( V_402 , V_411 , 16 , & V_84 -> V_102 ) < 0 ||
F_282 ( V_402 , V_84 -> V_1 , V_84 -> V_78 , V_427 , V_277 ) < 0 ) {
F_290 ( V_402 , V_404 ) ;
return - V_432 ;
}
return F_291 ( V_402 , V_404 ) ;
}
static int F_292 ( struct V_401 * V_402 , struct V_434 * V_435 ,
T_1 V_431 , T_1 V_375 , int V_344 , T_14 V_58 )
{
struct V_403 * V_404 ;
T_3 V_109 = V_430 ;
int V_144 = V_435 -> V_5 -> V_7 -> V_144 ;
if ( F_207 ( & V_435 -> V_436 ) & V_428 )
V_109 = V_429 ;
V_404 = F_289 ( V_402 , V_431 , V_375 , V_344 , sizeof( struct V_406 ) , V_58 ) ;
if ( V_404 == NULL )
return - V_432 ;
F_281 ( V_404 , 128 , V_138 , V_109 , V_144 ) ;
if ( F_283 ( V_402 , V_437 , 16 , & V_435 -> V_436 ) < 0 ||
F_282 ( V_402 , V_435 -> V_438 , V_435 -> V_439 ,
V_326 , V_326 ) < 0 ) {
F_290 ( V_402 , V_404 ) ;
return - V_432 ;
}
...
static int F_293 ( struct V_401 * V_402 , struct V_440 * V_441 ,
T_1 V_431 , T_1 V_375 , int V_344 , unsigned int V_58 )
{
struct V_403 * V_404 ;
T_3 V_109 = V_430 ;
int V_144 = V_441 -> V_442 -> V_7 -> V_144 ;
if ( F_207 ( & V_441 -> V_443 ) & V_428 )
V_109 = V_429 ;
V_404 = F_289 ( V_402 , V_431 , V_375 , V_344 , sizeof( struct V_406 ) , V_58 ) ;
if ( V_404 == NULL )
return - V_432 ;
F_281 ( V_404 , 128 , V_138 , V_109 , V_144 ) ;
if ( F_283 ( V_402 , V_444 , 16 , & V_441 -> V_443 ) < 0 ||
F_282 ( V_402 , V_441 -> V_445 , V_441 -> V_446 ,
V_326 , V_326 ) < 0 ) {
F_290 ( V_402 , V_404 ) ;
return - V_432 ;
}
...
static int F_294 ( struct V_4 * V_5 , struct V_401 * V_402 ,
...
if ( ++ V_452 < V_450 )
continue;
V_111 = F_288 ( V_402 , V_84 ,
F_295 ( V_448 -> V_402 ) . V_431 ,
V_448 -> V_404 -> V_454 ,
V_327 ,
V_455 ) ;
if ( V_111 <= 0 )
...
static int F_296 ( struct V_401 * V_402 , struct V_447 * V_448 ,
enum V_449 type )
{
struct V_86 * V_86 = F_276 ( V_402 -> V_405 ) ;
int V_361 , V_462 ;
...
F_139 (dev, node, head, index_hlist) {
if ( V_463 < V_464 )
goto V_468;
...
static int F_297 ( struct V_401 * V_402 , struct V_447 * V_448 )
{
enum V_449 type = V_453 ;
return F_296 ( V_402 , V_448 , type ) ;
}
...
static int F_300 ( struct V_401 * V_470 , struct V_403 * V_404 ,
void * V_293 )
{
struct V_86 * V_86 = F_276 ( V_470 -> V_405 ) ;
struct V_406 * V_407 ;
struct V_399 * V_408 [ V_409 + 1 ] ;
...
if ( V_111 < 0 )
goto V_471;
V_102 = F_272 ( V_408 [ V_411 ] , V_408 [ V_412 ] ) ;
if ( V_102 == NULL ) {
V_111 = - V_296 ;
goto V_471;
}
...
if ( V_407 -> V_413 )
V_7 = F_201 ( V_86 , V_407 -> V_413 ) ;
V_84 = F_143 ( V_86 , V_102 , V_7 , 1 ) ;
if ( ! V_84 ) {
V_111 = - V_116 ;
goto V_471;
}
V_402 = F_301 ( F_285 () , V_33 ) ;
if ( ! V_402 ) {
V_111 = - V_125 ;
goto V_472;
}
V_111 = F_288 ( V_402 , V_84 , F_295 ( V_470 ) . V_431 ,
V_404 -> V_454 , V_327 , 0 ) ;
if ( V_111 < 0 ) {
F_21 ( V_111 == - V_432 ) ;
F_302 ( V_402 ) ;
...
V_111 = F_303 ( V_402 , V_86 , F_295 ( V_470 ) . V_431 ) ;
V_472:
F_102 ( V_84 ) ;
V_471:
return V_111 ;
}
static void F_304 ( int V_344 , struct V_13 * V_84 )
{
struct V_401 * V_402 ;
struct V_86 * V_86 = F_32 ( V_84 -> V_5 -> V_7 ) ;
int V_111 = - V_125 ;
V_402 = F_301 ( F_285 () , V_124 ) ;
if ( V_402 == NULL )
goto V_471;
V_111 = F_288 ( V_402 , V_84 , 0 , 0 , V_344 , 0 ) ;
if ( V_111 < 0 ) {
F_21 ( V_111 == - V_432 ) ;
F_302 ( V_402 ) ;
goto V_471;
}
F_305 ( V_402 , V_86 , 0 , V_473 , NULL , V_124 ) ;
return;
V_471:
if ( V_111 < 0 )
F_306 ( V_86 , V_473 , V_111 ) ;
}
static inline void F_307 ( struct V_474 * V_49 ,
T_2 * V_475 , int V_476 )
{
F_308 ( V_476 < ( V_477 * 4 ) ) ;
...
static inline T_15 F_313 ( void )
{
return F_287 ( 4 )
+ F_287 ( sizeof( struct V_519 ) )
+ F_287 ( V_477 * 4 )
+ F_287 ( V_520 * 8 )
+ F_287 ( V_521 * 8 ) ;
}
static inline T_15 F_314 ( void )
{
return F_286 ( sizeof( struct V_522 ) )
+ F_287 ( V_523 )
+ F_287 ( V_524 )
+ F_287 ( 4 )
+ F_287 ( 4 )
...
static inline void F_315 ( T_16 * V_27 , T_17 * V_525 ,
int V_526 , int V_476 )
{
int V_177 ;
...
F_316 ( F_317 ( & V_525 [ V_177 ] ) , & V_27 [ V_177 ] ) ;
memset ( & V_27 [ V_526 ] , 0 , V_527 ) ;
}
static inline void F_318 ( T_16 * V_27 , void V_26 * * V_525 ,
...
F_316 ( V_526 , & V_27 [ 0 ] ) ;
for ( V_177 = 1 ; V_177 < V_526 ; V_177 ++ )
F_316 ( F_319 ( V_525 , V_177 , V_528 ) , & V_27 [ V_177 ] ) ;
memset ( & V_27 [ V_526 ] , 0 , V_527 ) ;
}
static void F_320 ( T_16 * V_27 , struct V_4 * V_5 , int V_529 ,
int V_476 )
{
switch ( V_529 ) {
case V_530 :
F_318 ( V_27 , ( void V_26 * * ) V_5 -> V_27 . V_28 ,
V_520 , V_476 , F_321 ( struct V_29 , V_531 ) ) ;
break;
case V_532 :
F_315 ( V_27 , V_5 -> V_27 . V_31 -> V_533 , V_521 , V_476 ) ;
break;
}
}
static int F_322 ( struct V_401 * V_402 , struct V_4 * V_5 )
{
struct V_399 * V_534 ;
struct V_519 V_418 ;
F_323 ( V_402 , V_535 , V_5 -> V_76 ) ;
V_418 . V_536 = V_537 ;
V_418 . V_78 = F_1 ( V_5 -> V_78 ) ;
V_418 . V_538 = F_309 ( V_5 -> V_53 -> V_538 ) ;
V_418 . V_169 = F_309 ( V_5 -> V_53 -> V_169 ) ;
F_324 ( V_402 , V_539 , sizeof( V_418 ) , & V_418 ) ;
V_534 = F_325 ( V_402 , V_540 , V_477 * sizeof( V_541 ) ) ;
if ( V_534 == NULL )
goto V_542;
F_307 ( & V_5 -> V_49 , F_273 ( V_534 ) , F_326 ( V_534 ) ) ;
V_534 = F_325 ( V_402 , V_530 , V_520 * sizeof( T_16 ) ) ;
if ( V_534 == NULL )
goto V_542;
F_320 ( F_273 ( V_534 ) , V_5 , V_530 , F_326 ( V_534 ) ) ;
V_534 = F_325 ( V_402 , V_532 , V_521 * sizeof( T_16 ) ) ;
if ( V_534 == NULL )
goto V_542;
F_320 ( F_273 ( V_534 ) , V_5 , V_532 , F_326 ( V_534 ) ) ;
return 0 ;
V_542:
return - V_432 ;
}
static T_15 F_327 ( const struct V_6 * V_7 )
{
if ( ! F_48 ( V_7 ) )
return 0 ;
return F_313 () ;
}
static int F_328 ( struct V_401 * V_402 , const struct V_6 * V_7 )
{
struct V_4 * V_5 = F_48 ( V_7 ) ;
if ( ! V_5 )
return - V_543 ;
if ( F_322 ( V_402 , V_5 ) < 0 )
return - V_432 ;
return 0 ;
}
static int F_329 ( struct V_401 * V_402 , struct V_4 * V_5 ,
T_1 V_431 , T_1 V_375 , int V_344 , unsigned int V_58 )
{
struct V_6 * V_7 = V_5 -> V_7 ;
struct V_522 * V_544 ;
struct V_403 * V_404 ;
void * V_545 ;
V_404 = F_289 ( V_402 , V_431 , V_375 , V_344 , sizeof( * V_544 ) , V_58 ) ;
if ( V_404 == NULL )
return - V_432 ;
V_544 = F_278 ( V_404 ) ;
V_544 -> V_546 = V_426 ;
...
V_544 -> V_550 = F_330 ( V_7 ) ;
V_544 -> V_551 = 0 ;
F_331 ( V_402 , V_552 , V_7 -> V_42 ) ;
if ( V_7 -> V_227 )
F_324 ( V_402 , V_553 , V_7 -> V_227 , V_7 -> V_229 ) ;
F_323 ( V_402 , V_554 , V_7 -> V_46 ) ;
if ( V_7 -> V_144 != V_7 -> V_341 )
F_323 ( V_402 , V_555 , V_7 -> V_341 ) ;
V_545 = F_332 ( V_402 , V_556 ) ;
if ( V_545 == NULL )
goto V_542;
if ( F_322 ( V_402 , V_5 ) < 0 )
goto V_542;
...
static int F_334 ( struct V_401 * V_402 , struct V_447 * V_448 )
{
struct V_86 * V_86 = F_276 ( V_402 -> V_405 ) ;
int V_361 , V_462 ;
int V_463 = 0 , V_464 ;
...
void F_230 ( int V_344 , struct V_4 * V_5 )
{
struct V_401 * V_402 ;
struct V_86 * V_86 = F_32 ( V_5 -> V_7 ) ;
int V_111 = - V_125 ;
V_402 = F_301 ( F_314 () , V_124 ) ;
if ( V_402 == NULL )
goto V_471;
V_111 = F_329 ( V_402 , V_5 , 0 , 0 , V_344 , 0 ) ;
if ( V_111 < 0 ) {
F_21 ( V_111 == - V_432 ) ;
F_302 ( V_402 ) ;
goto V_471;
}
F_305 ( V_402 , V_86 , 0 , V_557 , NULL , V_124 ) ;
return;
V_471:
if ( V_111 < 0 )
F_306 ( V_86 , V_557 , V_111 ) ;
}
static inline T_15 F_335 ( void )
{
return F_286 ( sizeof( struct V_558 ) )
+ F_287 ( sizeof( struct V_104 ) )
+ F_287 ( sizeof( struct V_559 ) ) ;
}
static int F_336 ( struct V_401 * V_402 , struct V_4 * V_5 ,
...
struct V_403 * V_404 ;
struct V_559 V_418 ;
V_404 = F_289 ( V_402 , V_431 , V_375 , V_344 , sizeof( * V_560 ) , V_58 ) ;
if ( V_404 == NULL )
return - V_432 ;
V_560 = F_278 ( V_404 ) ;
V_560 -> V_561 = V_426 ;
...
if ( V_274 -> V_283 )
V_560 -> V_567 |= V_569 ;
F_324 ( V_402 , V_570 , sizeof( V_274 -> V_143 ) , & V_274 -> V_143 ) ;
V_418 . V_571 = F_191 ( V_274 -> V_278 ) ;
V_418 . V_572 = F_191 ( V_274 -> V_277 ) ;
F_324 ( V_402 , V_573 , sizeof( V_418 ) , & V_418 ) ;
return F_291 ( V_402 , V_404 ) ;
V_542:
F_290 ( V_402 , V_404 ) ;
return - V_432 ;
}
static void F_197 ( int V_344 , struct V_4 * V_5 ,
struct V_273 * V_274 )
{
struct V_401 * V_402 ;
struct V_86 * V_86 = F_32 ( V_5 -> V_7 ) ;
int V_111 = - V_125 ;
V_402 = F_301 ( F_335 () , V_124 ) ;
if ( V_402 == NULL )
goto V_471;
V_111 = F_336 ( V_402 , V_5 , V_274 , 0 , 0 , V_344 , 0 ) ;
if ( V_111 < 0 ) {
F_21 ( V_111 == - V_432 ) ;
F_302 ( V_402 ) ;
goto V_471;
}
F_305 ( V_402 , V_86 , 0 , V_574 , NULL , V_124 ) ;
return;
V_471:
if ( V_111 < 0 )
F_306 ( V_86 , V_574 , V_111 ) ;
}
static void F_239 ( int V_344 , struct V_13 * V_14 )
{
F_304 ( V_344 ? : V_327 , V_14 ) ;
switch ( V_344 ) {
case V_327 :
if ( ! ( V_14 -> V_9 -> V_575 ) )
F_249 ( V_14 -> V_9 ) ;
...
static
int F_338 ( V_89 * V_576 , int V_577 ,
...
V_583 = * V_576 ;
V_583 . V_127 = & V_582 ;
V_154 = F_339 ( & V_583 , V_577 , V_578 , V_579 , V_580 ) ;
if ( V_577 )
...
return;
if ( V_5 -> V_49 . V_119 )
F_226 ( NULL , V_142 , V_5 -> V_7 ) ;
else
F_226 ( NULL , V_133 , V_5 -> V_7 ) ;
}
static void F_341 ( struct V_86 * V_86 , T_2 V_87 )
{
struct V_6 * V_7 ;
struct V_4 * V_5 ;
F_56 () ;
...
static int F_342 ( struct V_89 * V_90 , int * V_91 , int V_87 )
{
struct V_86 * V_86 ;
int V_92 ;
if ( ! F_60 () )
...
F_340 ( (struct V_4 * ) V_90 -> V_95 ) ;
F_62 () ;
return 0 ;
}
static
int F_343 ( V_89 * V_576 , int V_577 ,
void T_6 * V_578 , T_15 * V_579 , T_9 * V_580 )
{
int * V_581 = V_576 -> V_127 ;
int V_582 = * V_581 ;
...
V_154 = F_339 ( & V_583 , V_577 , V_578 , V_579 , V_580 ) ;
if ( V_577 )
V_154 = F_342 ( V_576 , V_581 , V_582 ) ;
if ( V_154 )
* V_580 = V_376 ;
return V_154 ;
}
static int F_344 ( struct V_86 * V_86 , char * V_584 ,
...
V_586 = F_346 ( & V_590 , sizeof( * V_586 ) , V_33 ) ;
if ( V_586 == NULL )
goto V_123;
...
V_586 -> V_584 = F_347 ( V_584 , V_33 ) ;
if ( ! V_586 -> V_584 )
goto free;
V_588 [ F_345 ] . V_589 = V_586 -> V_584 ;
V_586 -> V_592 = F_348 ( V_86 , V_588 ,
V_586 -> V_591 ) ;
if ( V_586 -> V_592 == NULL )
goto V_593;
V_91 -> V_52 = V_586 ;
...
static void F_349 ( struct V_474 * V_91 )
{
struct V_585 * V_586 ;
if ( V_91 -> V_52 == NULL )
return;
...
{
F_351 ( V_5 -> V_7 , V_5 -> V_53 , L_40 ,
& V_594 ) ;
F_344 ( F_32 ( V_5 -> V_7 ) , V_5 -> V_7 -> V_42 ,
V_5 , & V_5 -> V_49 ) ;
}
...
static int T_11 F_353 ( struct V_86 * V_86 )
{
int V_111 ;
...
V_596 = & V_597 ;
if ( ! F_140 ( V_86 , & V_598 ) ) {
V_595 = F_346 ( V_595 , sizeof( V_474 ) , V_33 ) ;
if ( V_595 == NULL )
goto V_599;
V_596 = F_346 ( V_596 , sizeof( V_597 ) , V_33 ) ;
if ( V_596 == NULL )
goto V_600;
} else {
...
#ifdef F_354
V_111 = F_344 ( V_86 , L_42 , NULL , V_595 ) ;
if ( V_111 < 0 )
goto V_602;
V_111 = F_344 ( V_86 , L_43 , NULL , V_596 ) ;
if ( V_111 < 0 )
goto V_603;
#endif
return 0 ;
...
static void T_12 F_355 ( struct V_86 * V_86 )
{
#ifdef F_354
F_349 ( V_86 -> V_28 . V_50 ) ;
F_349 ( V_86 -> V_28 . V_94 ) ;
#endif
if ( ! F_140 ( V_86 , & V_598 ) ) {
F_17 ( V_86 -> V_28 . V_50 ) ;
F_17 ( V_86 -> V_28 . V_94 ) ;
...
int F_356 ( struct V_342 * V_604 )
{
return F_357 ( & V_132 , V_604 ) ;
}
...
if ( V_111 < 0 )
goto V_612;
V_111 = F_365 ( V_613 , V_614 , NULL , F_334 ,
NULL ) ;
if ( V_111 < 0 )
goto V_471;
F_365 ( V_613 , V_327 , F_280 , NULL , NULL ) ;
F_365 ( V_613 , V_141 , F_275 , NULL , NULL ) ;
F_365 ( V_613 , V_615 , F_300 ,
F_297 , NULL ) ;
F_365 ( V_613 , V_457 , NULL ,
F_298 , NULL ) ;
F_365 ( V_613 , V_461 , NULL ,
F_299 , NULL ) ;
F_366 () ;
return 0 ;
V_471:
