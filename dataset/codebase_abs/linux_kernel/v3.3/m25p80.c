...
( long long ) V_36 -> V_37 ) ;
if ( V_36 -> V_29 + V_36 -> V_37 > V_4 -> V_3 . V_27 )
return - V_39 ;
...
V_4 -> V_3 . V_111 ) ;
if ( V_4 -> V_3 . V_111 )
for ( V_61 = 0 ; V_61 < V_4 -> V_3 . V_111 ; V_61 ++ )
F_16 ( L_14
L_15
L_16 ,
V_61 , ( long long ) V_4 -> V_3 . V_112 [ V_61 ] . V_32 ,
V_4 -> V_3 . V_112 [ V_61 ] . V_33 ,
V_4 -> V_3 . V_112 [ V_61 ] . V_33 / 1024 ,
V_4 -> V_3 . V_112 [ V_61 ] . V_113 ) ;
return F_48 ( & V_4 -> V_3 , NULL , & V_84 ,
V_82 ? V_82 -> V_114 : NULL ,
V_82 ? V_82 -> V_115 : 0 ) ;
}
