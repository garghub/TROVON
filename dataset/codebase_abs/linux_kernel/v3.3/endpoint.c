...
if ( V_18 -> V_94 [ V_9 ] . V_104 && F_35 () ) {
F_36 ( L_4 , V_9 , V_18 -> V_94 [ V_9 ] . V_104 ) ;
}
...
V_116 >>= - V_3 -> V_63 ;
if ( F_46 ( V_116 >= V_3 -> V_61 - V_3 -> V_61 / 8 && V_116 <= V_3 -> V_66 ) ) {
F_38 ( & V_3 -> V_109 , V_98 ) ;
V_3 -> V_62 = V_116 ;
F_39 ( & V_3 -> V_109 , V_98 ) ;
} else {
...
if ( V_3 -> V_110 >= V_44 -> V_25 * V_99 )
V_3 -> V_110 -= V_44 -> V_25 * V_99 ;
V_44 -> V_122 = V_3 -> V_123 ;
V_44 -> V_122 += V_100 ;
V_3 -> V_123 = V_44 -> V_122 ;
V_3 -> V_124 = F_50 ( V_3 -> V_26 ) ;
V_3 -> V_124 &= 0xFF ;
F_39 ( & V_3 -> V_109 , V_98 ) ;
V_18 -> V_89 = V_101 ;
if ( V_103 )
...
unsigned long V_98 ;
int V_99 = V_44 -> V_52 >> 3 ;
int V_125 = V_18 -> V_89 / V_99 ;
int V_126 ;
F_38 ( & V_3 -> V_109 , V_98 ) ;
V_126 = F_52 ( V_3 , V_44 -> V_1 ) ;
if ( V_125 > V_3 -> V_123 )
V_3 -> V_123 = 0 ;
else
V_3 -> V_123 -= V_125 ;
V_44 -> V_122 = V_3 -> V_123 ;
if ( abs ( V_126 - V_3 -> V_123 ) * 1000 > V_44 -> V_1 * 2 )
F_16 ( V_127 L_6 ,
V_126 , V_3 -> V_123 ) ;
F_39 ( & V_3 -> V_109 , V_98 ) ;
return 0 ;
}
static const char * F_53 ( int V_41 )
{
switch ( V_41 ) {
case - V_128 :
return L_7 ;
...
static int F_54 ( struct V_2 * V_3 , struct V_92 * V_44 )
{
unsigned int V_9 ;
int V_41 ;
if ( V_3 -> V_8 -> V_7 -> V_12 )
...
void F_57 ( struct V_139 * V_140 ,
int V_8 , struct V_141 * V_142 )
{
struct V_2 * V_3 = & V_140 -> V_39 [ V_8 ] ;
F_58 ( & V_3 -> V_143 ) ;
F_59 ( & V_3 -> V_109 ) ;
V_3 -> V_8 = V_140 ;
V_3 -> V_55 = V_8 ;
V_3 -> V_26 = V_140 -> V_7 -> V_26 ;
V_3 -> V_106 = V_140 -> V_7 -> V_106 ;
V_3 -> V_42 = V_144 [ V_8 ] ;
if ( F_25 ( V_3 -> V_26 ) >= V_145 )
V_3 -> V_42 . V_50 = F_31 ;
F_60 ( V_140 -> V_146 , V_8 ) ;
F_61 ( & V_142 -> V_147 , & V_3 -> V_143 ) ;
V_3 -> V_148 |= V_142 -> V_148 ;
V_3 -> V_149 = V_142 -> V_149 ;
V_3 -> V_150 ++ ;
V_3 -> V_78 = V_142 -> V_78 ;
}
int F_62 ( struct V_38 * V_39 , int V_151 )
{
struct V_2 * V_3 = V_39 -> V_44 -> V_152 ;
switch ( V_151 ) {
case V_153 :
case V_154 :
V_3 -> V_42 . V_45 = F_49 ;
...
int F_63 ( struct V_38 * V_39 , int V_151 )
{
struct V_2 * V_3 = V_39 -> V_44 -> V_152 ;
switch ( V_151 ) {
case V_153 :
V_3 -> V_42 . V_43 = F_34 ;
return F_54 ( V_3 , V_39 -> V_44 ) ;
case V_155 :
return F_3 ( V_3 , 0 , 0 ) ;
case V_156 :
V_3 -> V_42 . V_43 = F_41 ;
