...
static int F_24 ( struct V_149 * V_150 ,
unsigned int V_151 )
{
...
static int F_25 ( struct V_174 * V_175 ,
struct V_176 * V_177 ,
struct V_149 * V_150 )
{
struct V_65 * V_66 = V_150 -> V_66 ;
...
static int F_28 ( struct V_149 * V_217 , int V_218 )
{
...
static int F_29 ( struct V_65 * V_66 , int V_220 ,
...
static T_3 int F_38 ( struct V_237 * V_238 ,
const struct V_239 * V_240 )
{
struct V_96 * V_97 ;
unsigned int V_3 ;
int V_101 ;
V_97 = F_39 ( & V_238 -> V_2 , sizeof( struct V_96 ) ,
V_241 ) ;
if ( V_97 == NULL )
return - V_242 ;
F_40 ( V_238 , V_97 ) ;
V_97 -> V_59 = F_41 ( V_238 , & V_243 ) ;
if ( F_42 ( V_97 -> V_59 ) ) {
V_101 = F_43 ( V_97 -> V_59 ) ;
F_18 ( & V_238 -> V_2 , L_23 , V_101 ) ;
goto V_244;
}
V_101 = F_44 ( V_97 -> V_59 , V_4 , & V_3 ) ;
if ( V_101 != 0 ) {
F_18 ( & V_238 -> V_2 , L_24 , V_101 ) ;
goto V_245;
}
if ( V_3 != 0x9081 ) {
F_18 ( & V_238 -> V_2 , L_25 , V_3 ) ;
V_101 = - V_72 ;
goto V_245;
}
V_101 = F_3 ( V_97 -> V_59 ) ;
...
if ( F_45 ( & V_238 -> V_2 ) )
memcpy ( & V_97 -> V_207 , F_45 ( & V_238 -> V_2 ) ,
sizeof( V_97 -> V_207 ) ) ;
V_101 = F_46 ( & V_238 -> V_2 ,
& V_246 , & V_247 , 1 ) ;
if ( V_101 < 0 )
goto V_245;
return 0 ;
...
static T_4 int F_48 ( struct V_237 * V_248 )
{
