...
F_54 ( V_65 , & V_19 -> V_20 ) ;
if ( V_99 -> V_79 . V_80 ) {
struct V_78 * V_79 = & V_99 -> V_79 ;
T_5 V_93 ;
V_79 -> V_112 = V_97 -> V_110 + V_113 ;
F_55 ( V_93 ) ;
F_56 ( V_114 , V_93 ) ;
V_3 -> V_10 . V_9 = F_57 ( V_93 , F_41 , V_79 ) ;
}
...
strcpy ( V_65 -> V_117 , L_18 ) ;
strcpy ( V_65 -> V_66 , L_18 ) ;
sprintf ( V_65 -> V_118 , L_19 ) ;
V_38 = F_37 ( V_3 ) ;
if ( V_38 ) {
F_4 ( & V_19 -> V_20 , L_20 ) ;
goto V_119;
...
static int F_67 ( struct V_94 * V_19 , T_6 V_120 )
{
struct V_95 * V_65 = F_68 ( V_19 ) ;
...
static int T_7 F_70 ( struct V_94 * V_19 )
{
struct V_95 * V_65 = F_68 ( V_19 ) ;
