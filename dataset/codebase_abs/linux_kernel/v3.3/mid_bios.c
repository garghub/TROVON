...
F_23 ( V_24 ) ;
if ( memcmp ( V_20 -> V_35 , L_9 , 4 ) ) {
V_20 -> V_34 = 0 ;
return;
}
F_16 ( V_2 -> V_2 , L_10 , V_20 -> V_36 ) ;
switch ( V_20 -> V_36 ) {
case 0 :
V_20 -> V_37 = F_22 ( V_22 + sizeof( * V_20 ) - 4 ,
...
case 0x10 :
V_23 = V_20 -> V_47 ;
V_23 |= ( ( 0xff & ( unsigned int ) ( long ) V_20 -> V_37 ) ) << 8 ;
V_20 -> V_47 = V_20 -> V_34 ;
if ( V_23 > 0xff )
V_20 -> V_34 = 0xff ;
else
V_20 -> V_34 = V_23 ;
V_26 = ( ( 0xff00 & ( unsigned int ) ( long ) V_20 -> V_37 ) ) >> 8 ;
V_25 = ( ( 0xff0000 & ( unsigned int ) ( long ) V_20 -> V_37 ) ) >> 16 ;
V_20 -> V_37 = F_22 ( V_22 + V_48 ,
V_49 * V_26 ) ;
V_33 = V_20 -> V_37 ;
