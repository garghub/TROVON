...
if ( V_2 -> V_15 -> V_258 & V_259 ) {
V_97 = F_136 ( & V_260 , V_2 ) ;
V_116 = F_135 ( V_2 -> V_111 , V_97 ) ;
if ( V_116 < 0 )
return V_116 ;
}
if ( F_32 ( ! V_2 -> V_203 ) )
return - V_261 ;
if ( ( V_116 = F_135 ( V_2 -> V_111 , V_97 = F_136 ( & V_262 , V_2 ) ) ) < 0 )
return V_116 ;
V_97 -> V_113 . V_191 = V_2 -> V_203 -> V_191 ;
if ( ( V_116 = F_135 ( V_2 -> V_111 , V_97 = F_136 ( & V_263 , V_2 ) ) ) < 0 )
return V_116 ;
V_97 -> V_113 . V_191 = V_2 -> V_203 -> V_191 ;
if ( ( V_116 = F_135 ( V_2 -> V_111 , V_97 = F_136 ( & V_264 , V_2 ) ) ) < 0 )
return V_116 ;
V_97 -> V_113 . V_191 = V_2 -> V_203 -> V_191 ;
V_2 -> V_187 = V_97 ;
if ( V_2 -> V_22 == V_128 &&
( V_116 = F_135 ( V_2 -> V_111 , V_97 = F_136 ( & V_265 , V_2 ) ) ) < 0 )
return V_116 ;
if ( V_247 ) {
if ( ( V_116 = F_135 ( V_2 -> V_111 , F_136 ( & V_266 , V_2 ) ) ) < 0 )
return V_116 ;
}
V_69 = V_2 -> V_51 -> V_267 [ V_194 ] . V_69 ;
for ( V_46 = 0 ; V_46 < 32 ; ++ V_46 ) {
V_97 = F_136 ( & V_268 , V_2 ) ;
if ( ! V_97 )
return - V_56 ;
...
static int F_137 ( struct V_270 * V_168 )
{
struct V_1 * V_2 ;
unsigned long V_29 ;
unsigned int V_210 ;
...
static int F_139 ( struct V_270 * V_168 )
{
struct V_1 * V_2 ;
unsigned long V_29 ;
V_2 = F_138 ( V_168 ) ;
...
static int F_140 ( struct V_270 * V_168 ,
unsigned long * V_274 , unsigned long * V_275 )
{
* V_274 = 1 ;
* V_275 = 96000 ;
return 0 ;
...
{
struct V_270 * V_168 = NULL ;
struct V_276 V_277 ;
int V_116 ;
V_277 . V_278 = V_279 ;
V_277 . V_280 = V_281 ;
V_277 . V_111 = V_2 -> V_111 -> V_61 ;
V_277 . V_191 = V_191 ;
V_277 . V_243 = 0 ;
if ( ( V_116 = F_142 ( V_2 -> V_111 , L_2 , & V_277 , & V_168 ) ) >= 0 ) {
...
static void F_143 ( struct V_283 * V_284 ,
struct V_285 * V_286 )
{
struct V_1 * V_2 = V_284 -> V_16 ;
int V_25 ;
F_144 ( V_286 , L_13 ) ;
for ( V_25 = 0 ; V_25 <= V_287 ; V_25 += 4 )
F_144 ( V_286 , L_14 , V_25 , F_9 ( V_2 , V_25 ) ) ;
}
static int T_4 F_145 ( struct V_288 * V_111 , struct V_1 * V_2 )
{
struct V_283 * V_284 ;
if ( ! F_146 ( V_111 , L_15 , & V_284 ) )
F_147 ( V_284 , V_2 , F_143 ) ;
return 0 ;
}
static void F_148 ( struct V_289 * V_143 )
{
T_1 V_17 ;
F_149 ( V_143 , V_290 , & V_17 ) ;
#if 0
if (cmd & 0x03) {
#endif
F_150 ( V_143 , V_290 , V_17 & 0xfc ) ;
F_150 ( V_143 , V_290 , V_17 | 0x03 ) ;
F_150 ( V_143 , V_290 , V_17 & 0xfc ) ;
F_151 ( V_143 , V_291 , 0 ) ;
F_151 ( V_143 , V_292 , 0 ) ;
#if 0
...
int V_116 , V_294 ;
const char * V_199 ;
V_116 = F_155 ( & V_2 -> V_295 , L_16 ,
& V_2 -> V_143 -> V_296 ) ;
if ( V_116 >= 0 ) {
if ( V_2 -> V_295 -> V_297 != V_298 ) {
F_17 ( V_12 L_17 ) ;
V_116 = - V_58 ;
}
}
if ( V_116 < 0 )
return V_116 ;
V_294 = V_2 -> V_22 == V_299 ||
V_2 -> V_22 == V_300 ||
V_2 -> V_22 == V_23 ||
V_2 -> V_22 == V_128 ;
V_199 = V_294 ? L_18 : L_19 ;
V_116 = F_155 ( & V_2 -> V_301 , V_199 ,
& V_2 -> V_143 -> V_296 ) ;
if ( V_116 >= 0 ) {
...
V_303 = F_5 ( V_2 , V_219 ) ;
F_7 ( V_2 , V_219 , V_303 & ~ 0x0007 ) ;
V_304 = ( const T_8 * ) V_2 -> V_295 -> V_308 ;
for ( V_25 = 0 ; V_25 < V_298 / 4 ; V_25 ++ )
F_11 ( V_2 , V_309 + ( V_25 << 2 ) ,
F_36 ( V_304 [ V_25 ] ) ) ;
V_304 = ( const T_8 * ) V_2 -> V_301 -> V_308 ;
for ( V_25 = 0 ; V_25 < V_302 / 4 ; V_25 ++ )
F_11 ( V_2 , V_310 + ( V_25 << 2 ) ,
F_36 ( V_304 [ V_25 ] ) ) ;
F_152 ( V_2 ) ;
}
...
V_2 -> V_320 = V_321 ;
V_297 = F_158 ( V_311 , 0x100 ) +
F_158 ( V_2 -> V_314 * 2 * V_47 , 0x100 ) +
F_158 ( V_2 -> V_316 * 2 * V_165 , 0x100 ) +
F_158 ( V_2 -> V_318 * 2 * V_322 , 0x100 ) +
V_2 -> V_320 ;
if ( F_50 ( V_142 , F_51 ( V_2 -> V_143 ) ,
V_297 , & V_2 -> V_323 ) < 0 )
return - V_56 ;
...
V_312 += F_158 ( V_311 , 0x100 ) ;
V_313 += F_158 ( V_311 , 0x100 ) ;
for ( V_44 = 0 ; V_44 < V_47 ; V_44 ++ ) {
V_2 -> V_48 [ V_44 ] . V_61 = V_44 ;
V_2 -> V_48 [ V_44 ] . V_71 = (struct V_80 * ) V_312 ;
V_2 -> V_48 [ V_44 ] . V_103 = V_313 ;
for ( V_71 = 0 ; V_71 < 2 ; V_71 ++ ) {
V_2 -> V_326 [ V_44 ] [ V_71 ] = (struct V_80 * ) V_312 ;
V_312 += V_2 -> V_314 ;
V_313 += V_2 -> V_314 ;
}
}
V_312 = ( char * ) F_158 ( ( unsigned long ) V_312 , 0x100 ) ;
V_313 = F_158 ( V_313 , 0x100 ) ;
V_2 -> V_327 = V_312 ;
V_2 -> V_328 = V_313 ;
for ( V_44 = 0 ; V_44 < V_165 ; V_44 ++ )
for ( V_71 = 0 ; V_71 < 2 ; V_71 ++ ) {
V_2 -> V_93 [ V_44 ] [ V_71 ] = (struct V_152 * ) V_312 ;
V_312 += V_2 -> V_316 ;
V_313 += V_2 -> V_316 ;
}
V_312 = ( char * ) F_158 ( ( unsigned long ) V_312 , 0x100 ) ;
...
V_2 -> V_329 = V_312 ;
V_2 -> V_330 = V_313 ;
for ( V_44 = 0 ; V_44 < V_322 ; V_44 ++ )
for ( V_71 = 0 ; V_71 < 2 ; V_71 ++ ) {
V_2 -> V_145 [ V_44 ] [ V_71 ] = (struct V_331 * ) V_312 ;
V_312 += V_2 -> V_318 ;
V_313 += V_2 -> V_318 ;
}
V_312 = ( char * ) F_158 ( ( unsigned long ) V_312 , 0x100 ) ;
...
F_55 ( & V_2 -> V_323 ) ;
F_163 ( V_2 -> V_343 ) ;
F_151 ( V_2 -> V_143 , 0x40 , V_2 -> V_347 ) ;
F_166 ( V_2 -> V_143 ) ;
F_167 ( V_2 -> V_295 ) ;
F_167 ( V_2 -> V_301 ) ;
F_77 ( V_2 ) ;
...
int F_169 ( struct V_289 * V_143 , T_10 V_350 )
{
struct V_288 * V_111 = F_170 ( V_143 ) ;
...
F_172 ( V_2 -> V_205 ) ;
F_173 ( V_2 -> V_15 ) ;
for ( V_25 = 0 ; V_25 < V_352 ; V_25 ++ )
V_2 -> V_344 [ V_25 ] = F_9 ( V_2 , V_353 [ V_25 ] ) ;
V_2 -> V_354 = F_9 ( V_2 , V_33 ) ;
F_11 ( V_2 , V_234 , 0 ) ;
F_11 ( V_2 , V_236 , 0 ) ;
F_153 ( V_2 ) ;
F_166 ( V_143 ) ;
F_174 ( V_143 ) ;
F_175 ( V_143 , F_176 ( V_143 , V_350 ) ) ;
return 0 ;
}
int F_177 ( struct V_289 * V_143 )
{
struct V_288 * V_111 = F_170 ( V_143 ) ;
struct V_1 * V_2 = V_111 -> V_16 ;
unsigned int V_25 ;
...
F_183 ( 100 ) ;
for ( V_25 = 0 ; V_25 < V_352 ; V_25 ++ )
F_11 ( V_2 , V_353 [ V_25 ] , V_2 -> V_344 [ V_25 ] ) ;
F_184 ( V_2 -> V_15 ) ;
if ( V_2 -> V_31 > 0 ) {
F_52 ( & V_2 -> V_30 ) ;
F_11 ( V_2 , V_33 , V_2 -> V_354 ) ;
...
int T_4 F_185 ( struct V_288 * V_111 ,
struct V_289 * V_143 ,
...
V_2 -> V_24 = V_143 -> V_361 ;
V_2 -> V_362 = F_188 ( V_143 , 0 ) ;
V_2 -> V_4 = F_189 ( V_2 -> V_362 , 0x8000 ) ;
F_182 ( V_143 ) ;
V_2 -> V_62 = - 1 ;
if ( ( V_2 -> V_343 = F_190 ( V_2 -> V_362 , 0x8000 , L_2 ) ) == NULL ) {
F_17 ( V_12 L_24 , V_2 -> V_362 , V_2 -> V_362 + 0x8000 - 1 ) ;
F_159 ( V_2 ) ;
return - V_13 ;
}
if ( F_191 ( V_143 -> V_161 , F_73 , V_363 ,
V_364 , V_2 ) ) {
...
#ifdef F_160
V_2 -> V_344 = F_192 ( V_352 * sizeof( T_2 ) ) ;
if ( V_2 -> V_344 == NULL ) {
F_159 ( V_2 ) ;
return - V_56 ;
}
#endif
if ( ( V_116 = F_193 ( V_111 , V_365 , V_2 , & V_250 ) ) < 0 ) {
F_159 ( V_2 ) ;
return V_116 ;
}
F_145 ( V_111 , V_2 ) ;
F_194 ( V_111 , & V_143 -> V_296 ) ;
* V_358 = V_2 ;
return 0 ;
}
