...
V_128 . V_149 = V_21 -> V_150 ;
V_128 . V_151 = NULL ;
V_128 . V_152 = 0 ;
V_128 . V_153 = V_2 -> V_24 ;
if ( V_112 -> V_154 ) {
...
struct V_155 * V_156 ;
F_63 () ;
V_156 = F_64 ( V_21 -> V_156 ) ;
if ( V_156 ) {
memcpy ( & V_131 , V_156 ,
sizeof( * V_156 ) + V_156 -> V_151 . V_157 ) ;
V_128 . V_151 = & V_131 . V_151 ;
}
F_65 () ;
}
if ( V_128 . V_151 ) {
...
if ( V_21 -> V_68 )
goto V_158;
if ( V_128 . V_151 -> V_151 . V_159 ) {
if ( ! V_40 )
goto V_158;
V_40 = V_128 . V_151 -> V_151 . V_160 ;
}
}
V_129 = F_66 ( V_2 ) ;
if ( V_112 -> V_133 & V_161 )
V_129 |= V_162 ;
if ( F_67 ( V_40 ) ) {
if ( ! V_128 . V_153 )
V_128 . V_153 = V_21 -> V_163 ;
if ( ! V_39 )
V_39 = V_21 -> V_164 ;
}
F_68 ( & V_76 , V_128 . V_153 , V_2 -> V_95 , V_129 ,
V_165 ,
...
{
struct V_20 * V_21 = F_2 ( V_2 ) ;
struct V_136 * V_149 = (struct V_136 * ) V_180 ;
int V_182 = - V_102 ;
int V_183 ;
if ( V_2 -> V_50 != V_184 || V_181 < sizeof( struct V_136 ) )
goto V_36;
V_183 = F_89 ( F_6 ( V_2 ) , V_149 -> V_146 . V_147 ) ;
V_182 = - V_185 ;
if ( V_149 -> V_146 . V_147 && V_183 != V_186 &&
V_183 != V_187 && V_183 != V_188 )
goto V_36;
V_21 -> V_23 = V_21 -> V_150 = V_149 -> V_146 . V_147 ;
...
if ( sin ) {
sin -> V_139 = V_140 ;
sin -> V_146 . V_147 = F_28 ( V_27 ) -> V_39 ;
sin -> V_193 = 0 ;
...
static int F_99 ( struct V_1 * V_2 , char T_7 * V_198 , int V_157 )
{
if ( V_157 > sizeof( struct F_13 ) )
V_157 = sizeof( struct F_13 ) ;
if ( F_100 ( & F_16 ( V_2 ) -> V_30 , V_198 , V_157 ) )
return - V_100 ;
return 0 ;
}
static int F_101 ( struct V_1 * V_2 , char T_7 * V_198 , int T_7 * V_157 )
{
...
char T_7 * V_198 , unsigned int V_157 )
{
if ( V_200 == V_201 ) {
if ( F_2 ( V_2 ) -> V_10 != V_42 )
return - V_132 ;
else
return F_99 ( V_2 , V_198 , V_157 ) ;
}
return - V_202 ;
}
...
{
if ( V_199 != V_203 )
return F_106 ( V_2 , V_199 , V_200 , V_198 , V_157 ) ;
return F_104 ( V_2 , V_199 , V_200 , V_198 , V_157 ) ;
}
static int F_107 ( struct V_1 * V_2 , int V_199 , int V_200 ,
char T_7 * V_198 , unsigned int V_157 )
{
if ( V_199 != V_203 )
return F_108 ( V_2 , V_199 , V_200 , V_198 , V_157 ) ;
return F_104 ( V_2 , V_199 , V_200 , V_198 , V_157 ) ;
}
static int F_109 ( struct V_1 * V_2 , int V_199 , int V_200 ,
char T_7 * V_198 , int T_7 * V_157 )
{
if ( V_200 == V_201 ) {
if ( F_2 ( V_2 ) -> V_10 != V_42 )
return - V_132 ;
else
return F_101 ( V_2 , V_198 , V_157 ) ;
}
return - V_202 ;
}
...
{
if ( V_199 != V_203 )
return F_111 ( V_2 , V_199 , V_200 , V_198 , V_157 ) ;
return F_109 ( V_2 , V_199 , V_200 , V_198 , V_157 ) ;
}
static int F_112 ( struct V_1 * V_2 , int V_199 , int V_200 ,
char T_7 * V_198 , int T_7 * V_157 )
{
if ( V_199 != V_203 )
return F_113 ( V_2 , V_199 , V_200 , V_198 , V_157 ) ;
return F_109 ( V_2 , V_199 , V_200 , V_198 , V_157 ) ;
}
