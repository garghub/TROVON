...
static int F_73 ( struct V_23 * V_1 , unsigned int V_185 , unsigned long V_186 )
{
struct V_1 * V_2 = V_1 -> V_2 ;
int V_26 = - V_210 ;
if ( V_2 -> V_19 -> V_211 )
...
static struct V_247 * F_101 ( struct V_247 * V_248 ,
T_5 V_253 )
{
...
int V_26 = - V_288 ;
T_6 V_289 = F_17 ( V_248 -> V_268 - F_117 ( V_248 ) ) ;
...
unsigned long F_122 ( void T_7 * V_296 [] , int V_297 )
{
...
T_8 F_125 ( void T_7 * V_296 [] , int V_297 , T_3 V_302 )
{
T_8 V_298 = 0 ;
int V_303 ;
F_123 (cpu) {
...
do {
V_308 = F_126 ( V_306 ) ;
V_307 = * ( ( ( T_8 * ) V_304 ) + V_297 ) ;
} while ( F_127 ( V_306 , V_308 ) );
V_298 += V_307 ;
}
return V_298 ;
}
int F_128 ( void T_7 * V_309 [ 2 ] , T_3 V_310 , T_3 V_311 )
{
F_129 ( V_309 == NULL ) ;
...
void F_132 ( void T_7 * V_309 [ V_301 ] )
{
int V_299 ;
F_129 ( V_309 == NULL ) ;
...
{
if ( F_128 ( ( void T_7 * * ) V_37 -> V_296 . V_313 ,
sizeof( struct V_314 ) ,
F_134 ( struct V_314 ) ) < 0 )
goto V_315;
if ( F_128 ( ( void T_7 * * ) V_37 -> V_296 . V_316 ,
sizeof( struct V_317 ) ,
F_134 ( struct V_317 ) ) < 0 )
goto V_318;
if ( F_128 ( ( void T_7 * * ) V_37 -> V_296 . V_319 ,
sizeof( struct V_320 ) ,
F_134 ( struct V_320 ) ) < 0 )
goto V_321;
if ( F_128 ( ( void T_7 * * ) V_37 -> V_296 . V_322 ,
sizeof( struct V_323 ) ,
F_134 ( struct V_323 ) ) < 0 )
goto V_324;
if ( F_128 ( ( void T_7 * * ) V_37 -> V_296 . V_325 ,
sizeof( struct V_323 ) ,
F_134 ( struct V_323 ) ) < 0 )
goto V_326;
if ( F_128 ( ( void T_7 * * ) V_37 -> V_296 . V_327 ,
sizeof( struct V_328 ) ,
F_134 ( struct V_328 ) ) < 0 )
goto V_329;
V_37 -> V_296 . V_330 = F_135 ( sizeof( struct V_331 ) ,
V_71 ) ;
if ( ! V_37 -> V_296 . V_330 )
goto V_332;
F_136 ( V_37 ) ;
return 0 ;
V_332:
F_132 ( ( void T_7 * * ) V_37 -> V_296 . V_327 ) ;
V_329:
F_132 ( ( void T_7 * * ) V_37 -> V_296 . V_325 ) ;
V_326:
F_132 ( ( void T_7 * * ) V_37 -> V_296 . V_322 ) ;
V_324:
F_132 ( ( void T_7 * * ) V_37 -> V_296 . V_319 ) ;
V_321:
F_132 ( ( void T_7 * * ) V_37 -> V_296 . V_316 ) ;
V_318:
F_132 ( ( void T_7 * * ) V_37 -> V_296 . V_313 ) ;
V_315:
return - V_312 ;
}
static T_10 void F_137 ( struct V_37 * V_37 )
{
F_9 ( V_37 -> V_296 . V_330 ) ;
F_132 ( ( void T_7 * * ) V_37 -> V_296 . V_327 ) ;
F_132 ( ( void T_7 * * ) V_37 -> V_296 . V_325 ) ;
F_132 ( ( void T_7 * * ) V_37 -> V_296 . V_322 ) ;
F_132 ( ( void T_7 * * ) V_37 -> V_296 . V_319 ) ;
...
struct V_213 * V_336 ;
int V_292 = - V_27 ;
F_141 ( sizeof( struct V_337 ) > sizeof( V_334 -> V_338 ) ) ;
V_339 = F_135 ( 65536 / 8 , V_71 ) ;
if ( ! V_339 )
goto V_30;
V_292 = F_142 ( & V_340 , 1 ) ;
if ( V_292 )
...
F_145 () ;
#endif
V_340 . V_349 = V_42 . V_350 . V_351 ;
if ( F_146 ( & V_352 , V_353 ) < 0 )
F_80 ( V_354 L_9 ) ;
if ( F_146 ( & V_355 , V_264 ) < 0 )
F_80 ( V_354 L_10 ) ;
if ( F_146 ( & V_356 , V_357 ) < 0 )
F_80 ( V_354 L_11 ) ;
#ifdef F_147
if ( F_146 ( & V_358 , V_359 ) < 0 )
F_80 ( V_354 L_12 ) ;
#endif
for ( V_336 = & V_219 [ 0 ] ; V_336 < & V_219 [ V_217 ] ; ++ V_336 )
F_148 ( V_336 ) ;
for ( V_335 = V_360 ; V_335 < & V_360 [ V_361 ] ; ++ V_335 )
F_74 ( V_335 ) ;
F_149 () ;
F_150 () ;
F_151 () ;
