...
static int F_50 ( struct V_1 * V_2 , int V_64 )
{
if ( ! ( V_64 & V_65 ) )
V_2 -> V_16 . V_66 = V_67 ;
return F_51 ( V_2 ) ;
}
static void F_52 ( struct V_1 * V_2 , int V_64 )
{
F_53 ( V_2 ) ;
}
static void F_54 ( struct V_1 * V_2 , int V_64 )
{
V_2 -> V_16 . V_66 = 0 ;
}
static void F_55 ( struct V_1 * V_2 , int V_64 )
{
V_2 -> V_16 . V_66 = V_67 ;
}
int T_4 F_56 ( void )
