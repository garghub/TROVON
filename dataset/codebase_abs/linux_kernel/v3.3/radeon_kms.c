...
case V_79 :
if ( V_4 -> V_42 >= V_56 )
V_19 = V_4 -> V_57 . V_58 . V_80 ;
else if ( V_4 -> V_42 >= V_43 )
V_19 = V_4 -> V_57 . V_60 . V_80 ;
else if ( V_4 -> V_42 >= V_61 )
V_19 = V_4 -> V_57 . V_62 . V_80 ;
else if ( V_4 -> V_42 >= V_63 )
V_19 = V_4 -> V_57 . V_64 . V_80 ;
else {
return - V_53 ;
}
break;
...
int F_26 ( struct V_1 * V_2 , struct V_16 * V_85 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
V_85 -> V_86 = NULL ;
if ( V_4 -> V_42 >= V_56 ) {
struct V_87 * V_88 ;
int V_7 ;
V_88 = F_6 ( sizeof( * V_88 ) , V_9 ) ;
if ( F_27 ( ! V_88 ) ) {
return - V_10 ;
}
V_7 = F_28 ( V_4 , & V_88 -> V_89 ) ;
if ( V_7 ) {
F_29 ( V_4 , & V_88 -> V_89 ) ;
F_4 ( V_88 ) ;
return V_7 ;
...
V_95 = & V_4 -> V_27 . V_48 [ V_30 ] -> V_49 ;
return F_38 ( V_2 , V_30 , V_92 ,
V_94 , V_6 ,
V_95 ) ;
}
