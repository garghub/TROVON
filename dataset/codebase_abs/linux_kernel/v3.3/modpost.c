...
switch ( V_204 ) {
case V_216 :
V_178 -> V_202 = V_214 & 0xffff ;
break;
case V_217 :
V_178 -> V_202 = ( V_214 & 0x03ffffff ) << 2 ;
break;
case V_218 :
V_178 -> V_202 = V_214 ;
break;
...
unsigned int V_220 ;
const char * V_156 ;
T_9 * V_221 = ( void * ) V_30 -> V_65 + V_148 -> V_103 ;
T_9 * V_222 = ( void * ) V_221 + V_148 -> V_95 ;
V_156 = F_44 ( V_30 , V_148 ) ;
V_156 += strlen ( L_93 ) ;
if ( F_46 ( V_156 , V_154 ) )
return;
for ( V_219 = V_221 ; V_219 < V_222 ; V_219 ++ ) {
V_178 . V_201 = F_31 ( V_219 -> V_201 ) ;
#if V_223 == V_224
if ( V_30 -> V_65 -> V_81 == V_225 ) {
unsigned int V_204 ;
V_220 = F_67 ( V_219 -> V_205 ) ;
V_220 = F_31 ( V_220 ) ;
V_204 = F_68 ( V_219 -> V_205 ) ;
V_178 . V_205 = F_69 ( V_220 , V_204 ) ;
} else {
V_178 . V_205 = F_31 ( V_219 -> V_205 ) ;
V_220 = F_64 ( V_178 . V_205 ) ;
}
#else
V_178 . V_205 = F_31 ( V_219 -> V_205 ) ;
V_220 = F_64 ( V_178 . V_205 ) ;
#endif
V_178 . V_202 = F_31 ( V_219 -> V_202 ) ;
V_67 = V_30 -> V_113 + V_220 ;
if ( F_54 ( V_67 -> V_119 ) )
continue;
...
unsigned int V_220 ;
const char * V_156 ;
T_10 * V_221 = ( void * ) V_30 -> V_65 + V_148 -> V_103 ;
T_10 * V_222 = ( void * ) V_221 + V_148 -> V_95 ;
V_156 = F_44 ( V_30 , V_148 ) ;
V_156 += strlen ( L_94 ) ;
if ( F_46 ( V_156 , V_154 ) )
return;
for ( V_226 = V_221 ; V_226 < V_222 ; V_226 ++ ) {
V_178 . V_201 = F_31 ( V_226 -> V_201 ) ;
#if V_223 == V_224
if ( V_30 -> V_65 -> V_81 == V_225 ) {
unsigned int V_204 ;
V_220 = F_67 ( V_226 -> V_205 ) ;
V_220 = F_31 ( V_220 ) ;
V_204 = F_68 ( V_226 -> V_205 ) ;
V_178 . V_205 = F_69 ( V_220 , V_204 ) ;
} else {
V_178 . V_205 = F_31 ( V_226 -> V_205 ) ;
V_220 = F_64 ( V_178 . V_205 ) ;
}
#else
V_178 . V_205 = F_31 ( V_226 -> V_205 ) ;
...
if ( V_66 [ V_17 ] . V_100 == V_229 )
F_66 ( V_4 , V_30 , & V_30 -> V_66 [ V_17 ] ) ;
else if ( V_66 [ V_17 ] . V_100 == V_230 )
...
V_232 = F_41 ( V_64 . V_109 , V_64 . V_110 , L_95 ) ;
if ( V_64 . V_109 && ! V_232 && ! F_4 ( V_4 ) )
F_2 ( L_96
L_97
L_98 , V_4 ) ;
while ( V_232 ) {
...
V_232 = F_40 ( V_64 . V_109 , V_64 . V_110 ,
L_95 , V_232 ) ;
}
for ( V_67 = V_64 . V_113 ; V_67 < V_64 . V_114 ; V_67 ++ ) {
...
( F_4 ( V_4 ) && V_234 ) )
F_71 ( V_9 , V_4 , & V_64 ) ;
V_231 = F_41 ( V_64 . V_109 , V_64 . V_110 , L_99 ) ;
if ( V_231 )
F_75 ( V_4 , V_231 , V_64 . V_109 ,
V_231 - ( char * ) V_64 . V_65 ) ;
if ( V_231 || ( V_235 && ! F_4 ( V_4 ) ) )
F_76 ( V_4 , V_9 -> V_236 ,
sizeof( V_9 -> V_236 ) - 1 ) ;
F_32 ( & V_64 ) ;
if ( V_237 )
...
void F_77 ( struct V_238 * V_239 , const char * V_14 , int V_63 )
{
if ( V_239 -> V_49 - V_239 -> V_60 < V_63 ) {
V_239 -> V_49 += V_63 + V_240 ;
V_239 -> V_13 = realloc ( V_239 -> V_13 , V_239 -> V_49 ) ;
}
strncpy ( V_239 -> V_13 + V_239 -> V_60 , V_14 , V_63 ) ;
V_239 -> V_60 += V_63 ;
}
static void F_78 ( enum V_20 exp , const char * V_241 , const char * V_14 )
{
const char * V_242 = F_4 ( V_241 ) ? L_15 : L_16 ;
switch ( exp ) {
case V_35 :
F_1 ( L_101
L_102 , V_241 , V_242 , V_14 ) ;
break;
case V_36 :
F_1 ( L_101
L_103 , V_241 , V_242 , V_14 ) ;
break;
case V_37 :
F_2 ( L_101
L_104 , V_241 , V_242 , V_14 ) ;
break;
case V_33 :
case V_34 :
case V_28 :
...
static void F_79 ( enum V_20 exp , const char * V_241 , const char * V_14 )
{
const char * V_242 = F_4 ( V_241 ) ? L_15 : L_16 ;
switch ( exp ) {
case V_34 :
...
if ( ! exp || exp -> V_8 == V_9 )
continue;
V_243 = strrchr ( V_9 -> V_12 , '/' ) ;
if ( V_243 )
V_243 ++ ;
else
V_243 = V_9 -> V_12 ;
if ( ! V_9 -> V_15 )
F_78 ( exp -> V_20 , V_243 , exp -> V_12 ) ;
F_79 ( exp -> V_20 , V_243 , exp -> V_12 ) ;
}
}
static void F_81 ( struct V_238 * V_244 , struct V_8 * V_9 )
{
F_82 ( V_244 , L_107 ) ;
F_82 ( V_244 , L_108 ) ;
F_82 ( V_244 , L_109 ) ;
...
static void F_83 ( struct V_238 * V_244 , int V_245 )
{
if ( V_245 )
F_82 ( V_244 , L_120 ) ;
}
static void F_84 ( struct V_238 * V_244 , const char * V_12 )
{
static const char * V_246 = L_121 ;
if ( strncmp ( V_246 , V_12 , strlen ( V_246 ) ) == 0 )
F_82 ( V_244 , L_122 ) ;
}
static int F_85 ( struct V_238 * V_244 , struct V_8 * V_9 )
{
struct V_18 * V_14 , * exp ;
int V_247 = 0 ;
for ( V_14 = V_9 -> V_137 ; V_14 ; V_14 = V_14 -> V_11 ) {
...
F_82 ( V_244 , L_128 , V_14 -> V_46 , V_14 -> V_12 ) ;
}
F_82 ( V_244 , L_119 ) ;
return V_247 ;
}
static void F_86 ( struct V_238 * V_244 , struct V_8 * V_9 ,
struct V_8 * V_10 )
{
struct V_18 * V_14 ;
struct V_8 * V_241 ;
int V_249 = 1 ;
for ( V_241 = V_10 ; V_241 ; V_241 = V_241 -> V_11 )
V_241 -> V_250 = F_4 ( V_241 -> V_12 ) ;
F_82 ( V_244 , L_57 ) ;
F_82 ( V_244 , L_129 ) ;
F_82 ( V_244 , L_125 ) ;
F_82 ( V_244 , L_130 ) ;
...
V_13 = V_14 -> V_8 -> V_12 ;
F_82 ( V_244 , L_132 , V_249 ? L_15 : L_133 , V_13 ) ;
V_249 = 0 ;
}
F_82 ( V_244 , L_134 ) ;
}
static void F_87 ( struct V_238 * V_244 , struct V_8 * V_9 )
{
if ( V_9 -> V_236 [ 0 ] ) {
F_82 ( V_244 , L_57 ) ;
F_82 ( V_244 , L_135 ,
...
static void F_88 ( struct V_238 * V_244 , const char * V_251 )
{
char * V_252 ;
T_11 * V_61 ;
struct V_50 V_51 ;
V_61 = fopen ( V_251 , L_136 ) ;
if ( ! V_61 )
goto V_253;
if ( F_24 ( fileno ( V_61 ) , & V_51 ) < 0 )
goto V_254;
if ( V_51 . V_55 != V_244 -> V_60 )
goto V_254;
V_252 = F_8 ( malloc ( V_244 -> V_60 ) ) ;
if ( fread ( V_252 , 1 , V_244 -> V_60 , V_61 ) != V_244 -> V_60 )
goto V_255;
if ( memcmp ( V_252 , V_244 -> V_13 , V_244 -> V_60 ) != 0 )
goto V_255;
free ( V_252 ) ;
fclose ( V_61 ) ;
return;
...
fclose ( V_61 ) ;
V_253:
V_61 = fopen ( V_251 , L_137 ) ;
if ( ! V_61 ) {
perror ( V_251 ) ;
exit ( 1 ) ;
}
if ( fwrite ( V_244 -> V_13 , 1 , V_244 -> V_60 , V_61 ) != V_244 -> V_60 ) {
perror ( V_251 ) ;
exit ( 1 ) ;
}
fclose ( V_61 ) ;
}
static void F_89 ( const char * V_251 , unsigned int V_45 )
{
unsigned long V_49 , V_60 = 0 ;
void * V_61 = F_22 ( V_251 , & V_49 ) ;
char * line ;
if ( ! V_61 )
return;
while ( ( line = F_27 ( & V_60 , V_61 , V_49 ) ) ) {
char * V_122 , * V_4 , * V_174 , * V_20 , * V_256 ;
unsigned int V_46 ;
struct V_8 * V_9 ;
struct V_18 * V_14 ;
...
* V_20 ++ = '\0' ;
if ( V_20 && ( ( V_256 = strchr ( V_20 , '\t' ) ) != NULL ) )
* V_256 = '\0' ;
...
static void F_91 ( const char * V_251 )
{
struct V_238 V_239 = { } ;
struct V_18 * V_18 ;
int V_259 ;
for ( V_259 = 0 ; V_259 < V_23 ; V_259 ++ ) {
V_18 = V_24 [ V_259 ] ;
while ( V_18 ) {
if ( F_90 ( V_18 ) )
F_82 ( & V_239 , L_139 ,
...
int main ( int V_260 , char * * V_261 )
{
struct V_8 * V_9 ;
struct V_238 V_239 = { } ;
char * V_262 = NULL , * V_263 = NULL ;
char * V_264 = NULL ;
int V_265 ;
int V_247 ;
struct V_266 * V_267 ;
struct V_266 * V_268 = NULL ;
while ( ( V_265 = F_92 ( V_260 , V_261 , L_140 ) ) != - 1 ) {
switch ( V_265 ) {
case 'i' :
V_262 = V_269 ;
break;
...
F_83 ( & V_239 , ! V_258 ) ;
F_84 ( & V_239 , V_9 -> V_12 ) ;
V_247 |= F_85 ( & V_239 , V_9 ) ;
F_86 ( & V_239 , V_9 , V_10 ) ;
F_93 ( & V_239 , V_9 ) ;
F_87 ( & V_239 , V_9 ) ;
sprintf ( V_251 , L_141 , V_9 -> V_12 ) ;
F_88 ( & V_239 , V_251 ) ;
}
if ( V_264 )
F_91 ( V_264 ) ;
