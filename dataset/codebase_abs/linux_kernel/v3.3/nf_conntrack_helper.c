...
int F_28 ( struct V_12 * V_22 )
{
unsigned int V_18 = F_1 ( & V_22 -> V_2 ) ;
F_29 ( V_22 -> V_41 == NULL ) ;
F_29 ( V_22 -> V_42 >= V_43 ) ;
F_29 ( strlen ( V_22 -> V_20 ) > V_44 - 1 ) ;
F_30 ( & V_45 ) ;
F_31 ( & V_22 -> V_46 , & V_47 [ V_18 ] ) ;
V_19 ++ ;
F_32 ( & V_45 ) ;
return 0 ;
}
static void F_33 ( struct V_12 * V_22 ,
struct V_48 * V_48 )
{
struct V_37 * V_18 ;
struct V_49 * exp ;
...
F_38 (h, nn, &net->ct.unconfirmed, hnnode)
F_19 ( V_18 , V_22 ) ;
for ( V_21 = 0 ; V_21 < V_48 -> V_25 . V_56 ; V_21 ++ ) {
F_38 (h, nn, &net->ct.hash[i], hnnode)
F_19 ( V_18 , V_22 ) ;
}
}
void F_39 ( struct V_12 * V_22 )
{
struct V_48 * V_48 ;
F_30 ( & V_45 ) ;
F_40 ( & V_22 -> V_46 ) ;
