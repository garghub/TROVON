...
V_8 -> V_9 = V_13 -> V_9 ;
if ( ! V_8 -> V_9 ) {
V_8 -> V_9 = F_35 ( V_79 -> V_90 , F_36 ( V_79 ) ) ;
if ( ! V_8 -> V_9 )
goto V_91;
}
V_8 -> V_41 = F_37 ( V_6 , 0 ) ;
...
F_40 ( & V_8 -> V_16 ) ;
F_41 ( V_6 , V_8 ) ;
V_8 -> V_62 = F_42 ( V_82 , & V_6 -> V_2 , V_84 , V_98 ) ;
if ( F_43 ( V_8 -> V_62 ) ) {
V_80 = F_44 ( V_8 -> V_62 ) ;
goto V_91;
}
V_99 . V_75 = V_13 -> V_77 ;
V_80 = F_45 ( & V_6 -> V_2 . V_70 , & V_99 ) ;
if ( V_80 ) {
F_46 ( V_8 -> V_62 ) ;
goto V_91;
}
...
V_91:
if ( V_8 -> V_41 != V_42 )
F_47 ( V_8 -> V_41 , & V_6 -> V_2 ) ;
if ( V_8 -> V_9 )
F_48 ( V_8 -> V_9 ) ;
F_49 ( V_8 ) ;
return V_80 ;
}
static int T_8 F_50 ( struct V_5 * V_6 )
{
struct V_7 * V_8 = F_3 ( V_6 ) ;
struct V_12 * V_13 = V_6 -> V_2 . V_14 ;
F_51 ( & V_6 -> V_2 . V_70 , & V_99 ) ;
if ( ! F_43 ( V_8 -> V_62 ) )
F_46 ( V_8 -> V_62 ) ;
if ( V_8 -> V_9 && ! V_13 -> V_9 )
F_48 ( V_8 -> V_9 ) ;
