...
F_107 ( V_18 , V_110 ) ;
F_108 ( V_18 , V_110 ) ;
V_116 = V_113 ? F_109 ( V_113 ) : NULL ;
F_110 ( V_18 , V_116 ? V_116 -> V_120 : 0 ,
V_116 ? V_116 -> V_121 : 0 ,
V_110 ) ;
F_25 ( & V_48 ) ;
...
F_15 ( L_9 ,
V_18 , exp ) ;
F_112 ( V_122 , & V_18 -> V_58 ) ;
V_18 -> V_50 = exp -> V_50 ;
if ( exp -> V_85 ) {
V_78 = F_113 ( V_18 , V_110 ) ;
if ( V_78 )
F_114 ( V_78 -> V_85 , exp -> V_85 ) ;
}
#ifdef F_115
V_18 -> V_123 = exp -> V_50 -> V_123 ;
#endif
#ifdef F_116
V_18 -> V_124 = exp -> V_50 -> V_124 ;
#endif
F_69 ( & V_18 -> V_50 -> V_71 ) ;
F_29 ( V_17 , V_125 ) ;
} else {
F_117 ( V_18 , V_113 , V_110 ) ;
F_29 ( V_17 , V_119 ) ;
}
F_66 ( & V_18 -> V_40 [ V_31 ] . V_41 ,
& V_17 -> V_18 . V_126 ) ;
...
F_119 ( struct V_17 * V_17 , struct V_39 * V_113 ,
struct V_20 * V_21 ,
unsigned int V_23 ,
T_4 V_24 ,
T_5 V_13 ,
...
if ( F_50 ( V_130 , & V_18 -> V_58 ) ) {
F_15 ( L_11 , V_18 ) ;
* V_80 = V_131 ;
} else if ( F_50 ( V_122 , & V_18 -> V_58 ) ) {
F_15 ( L_12 ,
V_18 ) ;
* V_80 = V_132 ;
} else {
...
unsigned int
F_122 ( struct V_17 * V_17 , T_5 V_135 , unsigned int V_136 ,
struct V_20 * V_21 )
{
...
V_18 = F_119 ( V_17 , V_113 , V_21 , V_23 , V_135 , V_13 ,
V_26 , V_28 , & V_128 , & V_80 ) ;
if ( ! V_18 ) {
F_84 ( V_17 , V_138 ) ;
V_33 = V_35 ;
goto V_73;
...
F_20 ( V_21 -> V_44 ) ;
V_33 = V_28 -> V_140 ( V_18 , V_21 , V_23 , V_80 , V_135 , V_136 ) ;
if ( V_33 <= 0 ) {
F_15 ( L_15 ) ;
F_124 ( V_21 -> V_44 ) ;
V_21 -> V_44 = NULL ;
...
if ( V_128 && ! F_125 ( V_130 , & V_18 -> V_58 ) )
F_76 ( V_141 , V_18 ) ;
V_73:
if ( V_113 ) {
if ( V_33 == V_142 )
...
F_15 ( L_16 , V_18 ) ;
F_128 ( V_143 ) ;
V_18 -> V_40 [ V_42 ] . V_2 = * V_143 ;
if ( V_18 -> V_50 || ( V_78 && ! F_129 ( & V_78 -> V_144 ) ) )
return;
F_9 () ;
F_117 ( V_18 , NULL , V_110 ) ;
F_11 () ;
}
...
int V_146 )
{
F_20 ( V_18 -> V_46 . V_147 == ( unsigned long ) V_18 ) ;
F_20 ( V_21 ) ;
if ( F_50 ( V_148 , & V_18 -> V_58 ) )
goto V_149;
if ( ! F_26 ( V_18 ) ) {
V_18 -> V_46 . V_54 = V_145 ;
} else {
unsigned long V_150 = V_55 + V_145 ;
if ( V_150 - V_18 -> V_46 . V_54 >= V_151 )
F_131 ( & V_18 -> V_46 , V_150 ) ;
}
V_149:
if ( V_146 ) {
struct V_152 * V_149 ;
V_149 = F_132 ( V_18 ) ;
if ( V_149 ) {
F_133 ( & V_149 [ F_72 ( V_80 ) ] . V_153 ) ;
F_134 ( V_21 -> V_154 , & V_149 [ F_72 ( V_80 ) ] . V_155 ) ;
}
}
}
...
if ( V_149 ) {
F_133 ( & V_149 [ F_72 ( V_80 ) ] . V_153 ) ;
F_134 ( V_21 -> V_154 - F_120 ( V_21 ) ,
& V_149 [ F_72 ( V_80 ) ] . V_155 ) ;
}
}
if ( F_83 ( & V_18 -> V_46 ) ) {
V_18 -> V_46 . V_156 ( ( unsigned long ) V_18 ) ;
return true ;
}
return false ;
}
...
const struct V_1 * V_2 )
{
F_137 ( V_21 , V_157 , V_2 -> V_5 . V_11 . V_158 . V_159 ) ;
F_137 ( V_21 , V_160 , V_2 -> V_6 . V_11 . V_158 . V_159 ) ;
return 0 ;
V_161:
return - 1 ;
}
int F_138 ( struct V_162 * V_163 [] ,
struct V_1 * V_164 )
{
if ( ! V_163 [ V_157 ] || ! V_163 [ V_160 ] )
return - V_165 ;
V_164 -> V_5 . V_11 . V_158 . V_159 = F_139 ( V_163 [ V_157 ] ) ;
V_164 -> V_6 . V_11 . V_158 . V_159 = F_139 ( V_163 [ V_160 ] ) ;
return 0 ;
}
int F_140 ( void )
{
return F_141 ( V_166 , V_167 + 1 ) ;
}
static void F_142 ( struct V_20 * V_168 , struct V_20 * V_21 )
{
struct V_39 * V_18 ;
enum V_79 V_80 ;
V_18 = F_71 ( V_21 , & V_80 ) ;
...
V_80 = V_132 ;
V_168 -> V_44 = & V_18 -> V_71 ;
V_168 -> V_134 = V_80 ;
F_69 ( V_168 -> V_44 ) ;
}
static struct V_39 *
F_143 ( struct V_17 * V_17 , int (* F_144)( struct V_39 * V_92 , void * V_147 ) ,
void * V_147 , unsigned int * V_66 )
{
struct V_63 * V_64 ;
struct V_39 * V_18 ;
struct V_65 * V_4 ;
...
int (* F_144)( struct V_39 * V_92 , void * V_147 ) ,
void * V_147 )
{
struct V_39 * V_18 ;
unsigned int V_66 = 0 ;
while ( ( V_18 = F_143 ( V_17 , F_144 , V_147 , & V_66 ) ) != NULL ) {
if ( F_83 ( & V_18 -> V_46 ) )
F_46 ( ( unsigned long ) V_18 ) ;
F_31 ( V_18 ) ;
}
}
static int F_146 ( struct V_39 * V_92 , void * V_147 )
{
struct V_170 * V_171 = (struct V_170 * ) V_147 ;
struct V_60 * V_61 ;
V_61 = F_47 ( V_92 ) ;
if ( V_61 && V_61 -> V_62 == 0 )
V_61 -> V_62 = F_48 ( F_49 () ) ;
if ( F_147 ( V_53 , V_92 ,
V_171 -> V_172 , V_171 -> V_173 ) < 0 )
return 1 ;
F_39 ( V_57 , & V_92 -> V_58 ) ;
return 1 ;
}
static int F_148 ( struct V_39 * V_92 , void * V_147 )
{
return 1 ;
}
...
F_153 ( sizeof( struct V_174 ) * V_15 ) ) ;
}
void F_154 ( struct V_17 * V_17 , T_1 V_172 , int V_173 )
{
struct V_170 V_171 = {
. V_172 = V_172 ,
. V_173 = V_173 ,
} ;
F_145 ( V_17 , F_146 , & V_171 ) ;
}
...
int V_93 = 0 , V_175 ;
F_158 (cpu) {
struct V_39 * V_18 = & F_159 ( V_176 , V_175 ) ;
...
F_168 ( V_17 ) ;
F_169 ( V_17 ) ;
F_170 ( V_17 -> V_18 . V_103 ) ;
F_171 ( V_17 -> V_18 . V_179 ) ;
F_172 ( V_17 -> V_18 . V_180 ) ;
}
...
void * F_177 ( unsigned int * V_184 , int V_185 )
{
struct V_186 * V_14 ;
unsigned int V_187 , V_92 ;
T_8 V_188 ;
F_178 ( sizeof( struct V_186 ) != sizeof( struct V_174 ) ) ;
V_187 = * V_184 = F_179 ( * V_184 , V_189 / sizeof( struct V_186 ) ) ;
V_188 = V_187 * sizeof( struct V_186 ) ;
V_14 = ( void * ) F_180 ( V_190 | V_191 | V_192 ,
F_153 ( V_188 ) ) ;
if ( ! V_14 ) {
F_91 ( V_101 L_17 ) ;
V_14 = F_181 ( V_188 ) ;
...
if ( V_14 && V_185 )
for ( V_92 = 0 ; V_92 < V_187 ; V_92 ++ )
F_182 ( & V_14 [ V_92 ] , V_92 ) ;
return V_14 ;
}
int F_183 ( const char * V_193 , struct V_194 * V_195 )
{
int V_92 , V_66 ;
unsigned int V_196 , V_197 ;
struct V_186 * V_14 , * V_198 ;
struct V_63 * V_64 ;
struct V_39 * V_18 ;
if ( V_199 -> V_200 -> V_201 != & V_181 )
return - V_202 ;
if ( ! V_203 )
return F_184 ( V_193 , V_195 ) ;
V_196 = F_185 ( V_193 , NULL , 0 ) ;
if ( ! V_196 )
return - V_165 ;
V_14 = F_177 ( & V_196 , 1 ) ;
if ( ! V_14 )
return - V_102 ;
F_25 ( & V_48 ) ;
for ( V_92 = 0 ; V_92 < V_181 . V_18 . V_19 ; V_92 ++ ) {
while ( ! F_186 ( & V_181 . V_18 . V_14 [ V_92 ] ) ) {
V_64 = F_187 ( V_181 . V_18 . V_14 [ V_92 ] . V_204 ,
struct V_63 , V_41 ) ;
V_18 = F_57 ( V_64 ) ;
F_16 ( & V_64 -> V_41 ) ;
...
V_197 = V_181 . V_18 . V_19 ;
V_198 = V_181 . V_18 . V_14 ;
V_181 . V_18 . V_19 = V_203 = V_196 ;
V_181 . V_18 . V_14 = V_14 ;
F_30 ( & V_48 ) ;
F_149 ( V_198 , V_197 ) ;
return 0 ;
}
void F_188 ( unsigned long V_205 )
{
int V_175 ;
F_158 (cpu)
F_159 ( V_176 , V_175 ) . V_58 |= V_205 ;
}
...
F_182 ( & V_17 -> V_18 . V_126 , V_215 ) ;
F_182 ( & V_17 -> V_18 . V_59 , V_216 ) ;
V_17 -> V_18 . V_180 = F_194 ( struct V_217 ) ;
if ( ! V_17 -> V_18 . V_180 ) {
V_33 = - V_102 ;
goto V_218;
}
V_17 -> V_18 . V_179 = F_195 ( V_190 , L_19 , V_17 ) ;
if ( ! V_17 -> V_18 . V_179 ) {
V_33 = - V_102 ;
goto V_219;
}
V_17 -> V_18 . V_103 = F_196 ( V_17 -> V_18 . V_179 ,
...
V_17 -> V_18 . V_19 = V_203 ;
V_17 -> V_18 . V_14 = F_177 ( & V_17 -> V_18 . V_19 , 1 ) ;
if ( ! V_17 -> V_18 . V_14 ) {
V_33 = - V_102 ;
F_91 ( V_221 L_21 ) ;
goto V_223;
