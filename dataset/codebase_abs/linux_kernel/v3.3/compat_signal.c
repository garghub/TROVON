...
if ( V_35 == V_100 || V_35 == V_120 || V_35 == V_121 ||
V_35 == V_122 || V_35 == V_123 ) {
V_57 -> V_66 [ 4 ] = V_57 -> V_124 & 127 ;
V_57 -> V_66 [ 5 ] = V_57 -> V_125 ;
}
if ( F_3 ( V_57 -> V_66 [ 2 ] , ( int V_32 T_2 * ) & V_93 -> V_126 ) )
goto V_115;
return 0 ;
V_115:
F_42 ( V_35 , V_58 ) ;
...
static int F_43 ( int V_35 , struct V_39 * V_106 , T_3 * V_127 ,
T_15 * V_94 , struct V_56 * V_57 )
{
int V_3 = 0 ;
...
if ( V_93 == ( void T_2 * ) - 1UL )
goto V_115;
if ( F_1 ( & V_93 -> V_127 , V_127 ) )
goto V_115;
V_3 |= F_3 ( V_128 , & V_93 -> V_102 . V_129 ) ;
V_3 |= F_3 ( 0 , & V_93 -> V_102 . V_130 ) ;
...
V_57 -> V_66 [ 2 ] = F_40 ( V_35 ) ;
V_57 -> V_66 [ 3 ] = ( V_32 V_86 ) & V_93 -> V_127 ;
...
T_3 * V_127 , T_15 * V_132 , struct V_56 * V_57 )
{
T_15 V_133 ;
int V_44 ;
if ( V_106 -> V_46 . V_47 & V_134 )
V_44 = F_43 ( V_35 , V_106 , V_127 , V_132 , V_57 ) ;
else
V_44 = F_41 ( V_35 , V_106 , V_132 , V_57 ) ;
if ( V_44 )
return V_44 ;
F_45 ( & V_133 , & V_58 -> V_133 , & V_106 -> V_46 . V_48 ) ;
if ( ! ( V_106 -> V_46 . V_47 & V_135 ) )
F_46 ( & V_133 , V_35 ) ;
F_31 ( & V_133 ) ;
return 0 ;
}
