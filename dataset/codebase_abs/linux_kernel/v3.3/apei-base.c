...
V_71 = V_69 -> V_73 ;
V_72 = V_69 -> V_72 ;
memcpy ( V_70 , & V_69 -> V_74 , sizeof( * V_70 ) ) ;
if ( ! * V_70 ) {
...
if ( ( V_71 != 8 ) && ( V_71 != 16 ) && ( V_71 != 32 ) && ( V_71 != 64 ) ) {
F_12 (FW_BUG APEI_PFX
L_7 ,
*paddr, width, space_id) ;
return - V_26 ;
...
break;
case V_76 :
V_77 = F_50 ( V_74 , ( T_1 * ) V_10 , V_69 -> V_73 ) ;
if ( F_49 ( V_77 ) )
return - V_79 ;
break;
default:
...
int F_57 ( void )
{
static T_3 V_82 [] = L_10 ;
T_8 V_83 ;
T_1 V_84 [ 3 ] ;
struct V_85 V_86 = {
. V_87 = V_82 ,
. V_88 = 1 ,
. V_89 . V_90 = sizeof( V_84 ) ,
. V_89 . V_91 = V_84 ,
} ;
V_84 [ V_92 ] = V_93 ;
V_84 [ V_94 ] = 1 ;
V_84 [ V_95 ] = 0 ;
if ( F_49 ( F_58 ( NULL , L_11 , & V_83 ) )
|| F_49 ( F_59 ( V_83 , & V_86 ) ) )
return - V_79 ;
else {
F_22 ( V_86 . V_96 . V_91 ) ;
