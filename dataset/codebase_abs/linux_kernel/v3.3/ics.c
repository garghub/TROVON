...
static int F_48 ( struct V_2 * V_2 , unsigned int V_58 )
{
struct V_1 * V_1 = F_49 ( V_2 ) ;
unsigned int V_48 = F_50 ( V_58 ) ;
unsigned long V_4 ;
if ( ! F_47 ( V_1 , V_48 ) )
return - V_59 ;
F_51 ( V_58 , & V_60 , V_61 ) ;
...
int F_59 ( struct V_22 * V_24 , int V_66 )
{
struct V_1 * V_2 ;
int V_67 , V_68 ;
V_2 = F_57 ( V_24 ) ;
...
V_67 = F_60 ( V_66 ) ;
F_61 ( & V_2 -> V_6 ) ;
V_68 = F_62 ( V_2 -> V_62 , V_2 -> V_36 , V_67 ) ;
F_63 ( & V_2 -> V_6 ) ;
if ( V_68 < 0 )
return V_68 ;
return V_68 + V_2 -> V_34 ;
}
...
struct V_22 * V_24 )
{
int V_70 , V_45 , V_71 , V_72 ;
T_3 V_73 , V_36 ;
const T_3 * V_74 ;
V_72 = F_67 ( V_2 -> V_36 ) * sizeof( long ) ;
V_2 -> V_62 = F_68 ( V_72 , V_40 ) ;
if ( ! V_2 -> V_62 ) {
F_55 ( L_11 ) ;
return - V_30 ;
}
F_69 ( & V_2 -> V_6 ) ;
V_74 = F_17 ( V_24 , L_12 , & V_70 ) ;
if ( ! V_74 || ! V_70 ) {
F_55 ( L_13 ,
V_24 -> V_75 ) ;
return 0 ;
}
if ( V_70 % ( 2 * sizeof( T_3 ) ) != 0 ) {
F_55 ( L_14 ,
V_24 -> V_75 ) ;
return 0 ;
}
F_70 ( V_2 -> V_62 , V_2 -> V_36 ) ;
for ( V_45 = 0 ; V_45 < V_70 / sizeof( T_3 ) ; V_45 += 2 ) {
V_73 = F_71 ( V_74 + V_45 , 1 ) ;
V_36 = F_71 ( V_74 + V_45 + 1 , 1 ) ;
F_72 ( L_15 , V_57 , V_73 , V_36 ) ;
if ( ( V_73 + V_36 ) > ( V_2 -> V_34 + V_2 -> V_36 ) ||
V_73 < V_2 -> V_34 ) {
F_55 ( L_16 ,
V_73 , V_73 + V_36 ) ;
break;
}
for ( V_71 = 0 ; V_71 < V_36 ; V_71 ++ )
F_65 ( V_2 -> V_62 ,
( V_73 + V_71 ) - V_2 -> V_34 , 0 ) ;
}
F_53 ( V_2 -> V_62 , V_2 -> V_76 ,
F_60 ( V_2 -> V_77 ) ) ;
return 0 ;
}
static int T_5 F_73 ( struct V_1 * V_2 , struct V_22 * V_24 )
{
T_3 V_78 , V_79 , V_80 , V_81 ;
void T_6 * V_7 ;
const T_3 * V_74 ;
int V_82 , V_70 , V_45 ;
T_1 V_83 , V_84 ;
V_74 = F_17 ( V_24 , L_17 , & V_70 ) ;
if ( ! V_74 || V_70 < ( 2 * sizeof( T_3 ) ) ) {
F_55 ( L_18 ,
V_24 -> V_75 ) ;
return - V_59 ;
}
if ( V_70 > ( 2 * sizeof( T_3 ) ) ) {
F_55 ( L_19 ) ;
return - V_85 ;
}
V_7 = F_74 ( V_24 , 0 ) ;
...
V_2 -> V_34 = F_71 ( V_74 , 1 ) ;
V_2 -> V_36 = F_71 ( V_74 + 1 , 1 ) ;
V_2 -> V_7 = V_7 ;
V_2 -> V_18 = F_20 ( V_24 ) ;
if ( F_31 ( V_2 -> V_18 < 0 ) )
V_2 -> V_18 = 0 ;
V_83 = F_6 ( F_75 ( V_2 -> V_7 ) ) ;
V_84 = F_6 ( F_76 ( V_2 -> V_7 ) ) ;
V_2 -> V_77 = V_83 >> 56 ;
V_81 = ( V_83 >> 44 ) & 0x7ff ;
V_78 = ( V_84 >> 48 ) & 0x1ff ;
V_2 -> V_76 = ( V_2 -> V_18 << V_42 ) | V_78 << 5 ;
V_79 = ( V_84 >> 37 ) & 0x7 ;
V_80 = ( V_2 -> V_18 << V_42 ) | V_79 << 11 ;
F_77 ( L_21 , V_24 -> V_75 ) ;
F_77 ( L_22 ,
...
V_81 , V_80 ,
V_80 + V_81 - 1 ) ;
if ( V_2 -> V_76 < V_2 -> V_34 ||
( V_2 -> V_76 + V_2 -> V_77 ) > ( V_2 -> V_34 + V_2 -> V_36 ) )
F_34 ( L_25 ) ;
if ( V_80 < V_2 -> V_34 ||
( V_80 + V_81 ) > ( V_2 -> V_34 + V_2 -> V_36 ) )
F_34 ( L_26 ) ;
V_82 = F_66 ( V_2 , V_24 ) ;
if ( V_82 ) {
F_78 ( V_7 ) ;
...
V_65 = F_36 ( sizeof( * V_2 ) * V_94 , V_40 ) ;
if ( ! V_65 ) {
F_55 ( L_29 ) ;
return - V_30 ;
}
...
static void F_91 ( struct V_46 * V_98 )
{
V_60 . V_95 ( V_98 ) ;
}
