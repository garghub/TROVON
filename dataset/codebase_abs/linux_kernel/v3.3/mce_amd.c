...
static T_2
F_18 ( struct V_1 * V_2 , const char * V_59 , T_3 V_60 )
{
struct V_14 V_15 ;
unsigned long V_31 ;
if ( F_19 ( V_59 , 0 , & V_31 ) < 0 )
return - V_61 ;
V_2 -> V_25 = ! ! V_31 ;
memset ( & V_15 , 0 , sizeof( V_15 ) ) ;
V_15 . V_2 = V_2 ;
F_20 ( V_2 -> V_9 , F_3 , & V_15 , 1 ) ;
return V_60 ;
}
static T_2
F_21 ( struct V_1 * V_2 , const char * V_59 , T_3 V_60 )
{
struct V_14 V_15 ;
unsigned long V_31 ;
if ( F_19 ( V_59 , 0 , & V_31 ) < 0 )
...
static T_2 F_23 ( struct V_1 * V_2 , char * V_59 )
{
struct V_63 V_64 = { . V_65 = V_2 , } ;
F_20 ( V_2 -> V_9 , F_22 , & V_64 , 1 ) ;
...
static T_2 F_25 ( struct V_68 * V_69 , struct V_70 * V_71 , char * V_59 )
{
struct V_1 * V_2 = F_26 ( V_69 ) ;
struct V_72 * V_73 = F_27 ( V_71 ) ;
T_2 V_74 ;
V_74 = V_73 -> F_25 ? V_73 -> F_25 ( V_2 , V_59 ) : - V_75 ;
return V_74 ;
}
static T_2 F_28 ( struct V_68 * V_69 , struct V_70 * V_71 ,
const char * V_59 , T_3 V_67 )
{
struct V_1 * V_2 = F_26 ( V_69 ) ;
struct V_72 * V_73 = F_27 ( V_71 ) ;
T_2 V_74 ;
V_74 = V_73 -> F_28 ? V_73 -> F_28 ( V_2 , V_59 , V_67 ) : - V_75 ;
return V_74 ;
}
static T_4 int F_29 ( unsigned int V_9 ,
unsigned int V_10 ,
unsigned int V_11 ,
T_1 V_12 )
{
...
( V_37 & V_45 ) )
goto V_77;
V_2 = F_31 ( sizeof( struct V_1 ) , V_78 ) ;
if ( ! V_2 )
return - V_79 ;
V_2 -> V_11 = V_11 ;
V_2 -> V_10 = V_10 ;
...
static T_4 long
F_39 ( int V_9 , unsigned int V_10 )
{
return F_29 ( V_9 , V_10 , 0 ,
V_40 + V_10 * 4 ) ;
}
static T_4 int F_40 ( unsigned int V_9 , unsigned int V_10 )
{
int V_86 , V_76 = 0 ;
struct V_87 * V_2 = NULL ;
struct V_88 * V_89 = V_90 [ V_9 ] ;
char V_91 [ 32 ] ;
sprintf ( V_91 , L_6 , V_10 ) ;
#ifdef F_41
...
if ( ! V_2 )
goto V_92;
V_76 = F_45 ( & V_89 -> V_69 , V_2 -> V_69 , V_91 ) ;
if ( V_76 )
goto V_92;
F_46 ( V_2 -> V_93 , F_44 ( V_9 ) ) ;
F_12 ( V_81 , V_9 ) [ V_10 ] = V_2 ;
goto V_92;
}
#endif
V_2 = F_31 ( sizeof( struct V_87 ) , V_78 ) ;
if ( ! V_2 ) {
V_76 = - V_79 ;
goto V_92;
}
if ( ! F_47 ( & V_2 -> V_93 , V_78 ) ) {
F_38 ( V_2 ) ;
V_76 = - V_79 ;
goto V_92;
}
V_2 -> V_69 = F_48 ( V_91 , & V_89 -> V_69 ) ;
if ( ! V_2 -> V_69 )
goto V_84;
#ifndef F_41
F_49 ( V_2 -> V_93 ) ;
...
struct V_87 * V_96 = F_12 ( V_81 , V_9 ) [ V_10 ] ;
if ( ! V_96 )
return;
...
static void T_4
F_60 ( unsigned long V_98 , unsigned int V_9 )
{
switch ( V_98 ) {
case V_99 :
case V_100 :
