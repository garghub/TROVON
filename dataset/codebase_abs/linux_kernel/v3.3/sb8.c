...
static int T_2 F_6 ( struct V_13 * V_14 , unsigned int V_15 )
{
if ( ! V_16 [ V_15 ] )
return 0 ;
if ( V_1 [ V_15 ] == V_17 ) {
...
static int T_2 F_8 ( struct V_13 * V_14 , unsigned int V_15 )
{
struct V_3 * V_4 ;
struct V_7 * V_8 ;
struct V_9 * V_10 ;
...
static int T_3 F_23 ( struct V_13 * V_14 , unsigned int V_15 )
{
F_22 ( F_24 ( V_14 ) ) ;
F_21 ( V_14 , NULL ) ;
return 0 ;
