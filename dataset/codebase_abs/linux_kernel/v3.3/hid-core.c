...
break;
default:
F_5 ( V_26 -> V_3 , L_19 , V_66 -> V_72 ) ;
V_97 = 0 ;
}
memset ( & V_26 -> V_29 , 0 , sizeof( V_26 -> V_29 ) ) ;
return V_97 ;
}
static int F_20 ( struct V_25 * V_26 , struct V_65 * V_66 )
{
F_18 ( L_20 , V_66 -> V_72 ) ;
return 0 ;
}
...
static void F_22 ( struct V_3 * V_106 )
{
struct V_2 * V_3 = F_23 ( V_106 , struct V_2 , V_106 ) ;
unsigned V_45 , V_57 ;
...
static V_68 * F_24 ( T_3 * V_109 , T_3 * V_110 , struct V_65 * V_66 )
{
V_68 V_111 ;
if ( ( V_110 - V_109 ) <= 0 )
return NULL ;
...
if ( ( V_110 - V_109 ) < 4 )
return NULL ;
V_66 -> V_67 . T_1 = F_26 ( V_109 ) ;
V_109 = ( T_3 * ) ( ( V_118 * ) V_109 + 1 ) ;
return V_109 ;
}
return NULL ;
}
int F_27 ( struct V_2 * V_3 , T_3 * V_109 ,
unsigned V_11 )
{
struct V_25 * V_26 ;
struct V_65 V_66 ;
...
static V_24 F_29 ( T_2 V_23 , unsigned V_38 )
{
switch ( V_38 ) {
...
static T_1 F_30 ( V_121 V_23 , unsigned V_38 )
{
...
static T_2 F_31 ( const struct V_2 * V_58 , T_3 * V_7 ,
...
static void F_34 ( const struct V_2 * V_58 , T_3 * V_7 ,
...
static int F_37 ( V_121 * V_128 , V_121 V_23 , unsigned V_38 )
{
while ( V_38 -- ) {
if ( * V_128 ++ == V_23 )
return 0 ;
...
static int F_38 ( struct V_2 * V_58 , struct V_1 * V_7 )
{
...
static int F_39 ( struct V_2 * V_58 , struct V_20 * V_22 )
{
...
static void F_40 ( struct V_2 * V_58 , struct V_14 * V_17 ,
struct V_20 * V_22 , V_121 V_23 , int V_140 )
{
struct V_141 * V_142 = V_58 -> V_130 ;
int V_97 ;
F_41 ( V_58 , V_22 , V_23 ) ;
if ( V_142 && V_142 -> V_143 && F_39 ( V_58 , V_22 ) ) {
...
if ( V_58 -> V_145 & V_146 )
F_42 ( V_58 , V_17 , V_22 , V_23 ) ;
if ( V_58 -> V_145 & V_147 && V_140 && V_58 -> V_148 )
V_58 -> V_148 ( V_58 , V_17 , V_22 , V_23 ) ;
}
static void F_43 ( struct V_2 * V_58 , struct V_14 * V_17 ,
T_3 * V_67 , int V_140 )
{
unsigned V_38 ;
...
V_23 [ V_38 ] = V_150 < 0 ?
F_29 ( F_31 ( V_58 , V_67 , V_44 + V_38 * V_11 , V_11 ) ,
V_11 ) :
F_31 ( V_58 , V_67 , V_44 + V_38 * V_11 , V_11 ) ;
if ( ! ( V_17 -> V_43 & V_153 ) &&
...
for ( V_38 = 0 ; V_38 < V_149 ; V_38 ++ ) {
if ( V_153 & V_17 -> V_43 ) {
F_40 ( V_58 , V_17 , & V_17 -> V_22 [ V_38 ] , V_23 [ V_38 ] , V_140 ) ;
continue;
}
if ( V_17 -> V_23 [ V_38 ] >= V_150 && V_17 -> V_23 [ V_38 ] <= V_151
&& V_17 -> V_22 [ V_17 -> V_23 [ V_38 ] - V_150 ] . V_58
&& F_37 ( V_23 , V_17 -> V_23 [ V_38 ] , V_149 ) )
F_40 ( V_58 , V_17 , & V_17 -> V_22 [ V_17 -> V_23 [ V_38 ] - V_150 ] , 0 , V_140 ) ;
if ( V_23 [ V_38 ] >= V_150 && V_23 [ V_38 ] <= V_151
&& V_17 -> V_22 [ V_23 [ V_38 ] - V_150 ] . V_58
&& F_37 ( V_17 -> V_23 , V_23 [ V_38 ] , V_149 ) )
F_40 ( V_58 , V_17 , & V_17 -> V_22 [ V_23 [ V_38 ] - V_150 ] , 1 , V_140 ) ;
}
memcpy ( V_17 -> V_23 , V_23 , V_149 * sizeof( V_121 ) ) ;
exit:
F_8 ( V_23 ) ;
}
static void F_44 ( const struct V_2 * V_58 ,
...
for ( V_38 = 0 ; V_38 < V_149 ; V_38 ++ ) {
if ( V_17 -> V_49 < 0 )
F_34 ( V_58 , V_67 , V_44 + V_38 * V_11 , V_11 ,
F_30 ( V_17 -> V_23 [ V_38 ] , V_11 ) ) ;
else
F_34 ( V_58 , V_67 , V_44 + V_38 * V_11 , V_11 ,
V_17 -> V_23 [ V_38 ] ) ;
}
}
void F_45 ( struct V_1 * V_7 , T_3 * V_67 )
{
unsigned V_38 ;
if ( V_7 -> V_4 > 0 )
* V_67 ++ = V_7 -> V_4 ;
...
for ( V_38 = 0 ; V_38 < V_7 -> V_18 ; V_38 ++ )
F_44 ( V_7 -> V_3 , V_7 -> V_17 [ V_38 ] , V_67 ) ;
}
int F_46 ( struct V_14 * V_17 , unsigned V_44 , V_121 V_23 )
{
unsigned V_11 = V_17 -> V_50 ;
F_41 ( V_17 -> V_7 -> V_3 , V_17 -> V_22 + V_44 , V_23 ) ;
if ( V_44 >= V_17 -> V_51 ) {
...
if ( V_17 -> V_49 < 0 ) {
if ( V_23 != F_29 ( F_30 ( V_23 , V_11 ) , V_11 ) ) {
...
static struct V_1 * F_47 ( struct V_5 * V_6 ,
const V_68 * V_67 )
{
struct V_1 * V_7 ;
unsigned int V_38 = 0 ;
...
void F_48 ( struct V_2 * V_58 , int type , V_68 * V_67 , int V_11 ,
int V_140 )
{
...
F_43 ( V_58 , V_7 -> V_17 [ V_122 ] , V_157 , V_140 ) ;
if ( V_58 -> V_145 & V_146 )
F_50 ( V_58 , V_7 ) ;
}
int F_51 ( struct V_2 * V_58 , int type , V_68 * V_67 , int V_11 , int V_140 )
{
struct V_5 * V_6 ;
struct V_141 * V_142 ;
struct V_1 * V_7 ;
...
if ( V_142 && V_142 -> V_168 && F_38 ( V_58 , V_7 ) ) {
...
F_48 ( V_58 , type , V_67 , V_11 , V_140 ) ;
V_165:
F_54 ( & V_58 -> V_163 ) ;
return V_97 ;
}
static bool F_55 ( struct V_2 * V_169 ,
...
const struct V_170 * F_56 ( struct V_2 * V_169 ,
const struct V_170 * V_4 )
{
for (; V_4 -> V_171 ; V_4 ++ )
if ( F_55 ( V_169 , V_4 ) )
...
static bool F_57 ( struct V_2 * V_169 )
{
return ! ! F_56 ( V_169 , V_174 ) ;
}
static T_5
F_58 ( struct V_175 * V_176 , struct V_177 * V_178 ,
struct V_179 * V_180 ,
char * V_161 , T_6 V_181 , T_7 V_149 )
{
struct V_3 * V_106 = F_23 ( V_178 , struct V_3 , V_178 ) ;
struct V_2 * V_169 = F_23 ( V_106 , struct V_2 , V_106 ) ;
...
int F_59 ( struct V_2 * V_169 , unsigned int V_182 )
{
...
T_7 V_149 )
{
struct V_141 * V_142 = F_23 ( V_209 , struct V_141 , V_130 ) ;
struct V_210 * V_211 ;
...
if ( F_55 ( V_169 , & V_211 -> V_4 ) ) {
F_71 ( & V_142 -> V_215 ) ;
return & V_211 -> V_4 ;
}
}
F_71 ( & V_142 -> V_215 ) ;
return F_56 ( V_169 , V_142 -> V_217 ) ;
}
...
return ! F_56 ( V_169 , V_218 ) ;
return 1 ;
}
static int F_81 ( struct V_3 * V_106 )
{
struct V_141 * V_142 = F_23 ( V_106 -> V_130 ,
struct V_141 , V_130 ) ;
struct V_2 * V_169 = F_23 ( V_106 , struct V_2 , V_106 ) ;
const struct V_170 * V_4 ;
int V_97 = 0 ;
...
F_56 ( V_169 , V_241 ) )
return true ;
return ! ! F_56 ( V_169 , V_242 ) ;
}
int F_90 ( struct V_2 * V_169 )
{
static T_8 V_4 = F_91 ( 0 ) ;
int V_97 ;
if ( F_35 ( V_169 -> V_243 & V_244 ) )
return - V_164 ;
