...
int V_9 ;
V_136 = F_24 ( V_6 ) ;
V_9 = F_25 ( V_6 , 8 , 16 , V_136 -> V_137 ) ;
if ( V_9 < 0 ) {
F_26 ( V_6 -> V_138 , L_6 , V_9 ) ;
return V_9 ;
}
V_9 = F_27 ( V_6 ) ;
if ( V_9 < 0 ) {
...
V_144 , V_144 ) ;
F_5 ( V_6 , V_109 , 0 ) ;
F_5 ( V_6 , V_145 , 0x50 | ( 1 << 8 ) ) ;
F_5 ( V_6 , V_146 , 0x50 | ( 1 << 8 ) ) ;
F_29 ( V_6 , V_147 ,
F_30 ( V_147 ) ) ;
F_31 ( & V_6 -> V_118 , V_148 ,
F_30 ( V_148 ) ) ;
F_32 ( & V_6 -> V_118 , V_149 ,
F_30 ( V_149 ) ) ;
return 0 ;
}
static T_4 int F_33 ( struct V_150 * V_151 ,
const struct V_152 * V_153 )
{
struct V_135 * V_136 ;
int V_9 ;
V_136 = F_34 ( sizeof *V_136 , V_154 ) ;
if ( ! V_136 )
return - V_155 ;
V_136 -> V_137 = V_156 ;
F_35 ( V_151 , V_136 ) ;
V_9 = F_36 ( & V_151 -> V_138 ,
& V_157 , & V_158 , 1 ) ;
if ( V_9 < 0 )
F_37 ( V_136 ) ;
return V_9 ;
}
static T_5 int F_38 ( struct V_150 * V_159 )
{
F_39 ( & V_159 -> V_138 ) ;
F_37 ( F_40 ( V_159 ) ) ;
return 0 ;
