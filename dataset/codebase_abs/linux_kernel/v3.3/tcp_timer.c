...
if ( V_2 -> V_86 == V_87 ) {
F_49 ( V_88 L_1 ,
& V_85 -> V_89 , F_50 ( V_85 -> V_90 ) ,
V_85 -> V_91 , V_13 -> V_92 , V_13 -> V_93 ) ;
}
#if F_51 ( V_94 )
else if ( V_2 -> V_86 == V_95 ) {
struct V_96 * V_97 = F_52 ( V_2 ) ;
F_49 ( V_88 L_2 ,
& V_97 -> V_98 , F_50 ( V_85 -> V_90 ) ,
V_85 -> V_91 , V_13 -> V_92 , V_13 -> V_93 ) ;
}
#endif
if ( V_16 - V_13 -> V_99 > V_18 ) {
F_3 ( V_2 ) ;
goto V_70;
}
F_53 ( V_2 , 0 ) ;
...
V_101 = V_105 ;
} else if ( V_28 -> V_102 == V_106 ) {
V_101 = V_107 ;
} else if ( ( V_28 -> V_102 == V_108 ) ||
V_13 -> V_109 ) {
if ( F_56 ( V_13 ) )
V_101 = V_110 ;
else
...
F_28 ( V_2 ) ;
if ( F_29 ( V_2 ) ) {
F_30 ( V_2 , & V_28 -> V_120 , V_64 + ( V_121 / 20 ) ) ;
goto V_66;
}
if ( V_2 -> V_49 == V_67 || ! V_28 -> V_122 )
goto V_70;
if ( F_32 ( V_28 -> V_123 , V_64 ) ) {
F_30 ( V_2 , & V_28 -> V_120 , V_28 -> V_123 ) ;
goto V_70;
}
V_119 = V_28 -> V_122 ;
V_28 -> V_122 = 0 ;
...
void F_64 ( struct V_1 * V_2 , struct V_126 * V_127 )
{
F_5 ( F_6 ( V_2 ) , V_112 ) ;
}
void F_65 ( struct V_1 * V_2 , int V_128 )
{
if ( ( 1 << V_2 -> V_49 ) & ( V_129 | V_130 ) )
return;
if ( V_128 && ! F_27 ( V_2 , V_131 ) )
...
if ( V_2 -> V_49 == V_134 && F_27 ( V_2 , V_56 ) ) {
if ( V_13 -> V_135 >= 0 ) {
const int V_136 = F_69 ( V_2 ) - V_19 ;
if ( V_136 > 0 ) {
F_70 ( V_2 , V_134 , V_136 ) ;
goto V_70;
}
}
F_10 ( V_2 , V_22 ) ;
...
if ( ! F_27 ( V_2 , V_131 ) || V_2 -> V_49 == V_67 )
goto V_70;
V_132 = F_67 ( V_13 ) ;
if ( V_13 -> V_21 || F_43 ( V_2 ) )
goto V_138;
