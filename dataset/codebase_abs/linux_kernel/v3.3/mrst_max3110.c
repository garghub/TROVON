...
V_2 -> V_44 || F_45 () ) ;
F_46 ( & V_2 -> V_81 ) ;
if ( F_47 ( V_82 , & V_2 -> V_44 ) )
F_42 ( V_2 ) ;
if ( F_47 ( V_43 , & V_2 -> V_44 ) )
F_27 ( V_2 , V_34 ) ;
if ( F_47 ( V_68 , & V_2 -> V_44 ) )
F_31 ( V_2 ) ;
F_48 ( & V_2 -> V_81 ) ;
} while ( ! F_45 () );
return V_13 ;
}
static T_4 F_49 ( int V_83 , void * V_84 )
{
struct V_1 * V_2 = V_84 ;
...
| V_92
| V_93 ;
V_31 -> V_66 -> V_31 . V_71 -> V_94 = 1 ;
if ( V_2 -> V_83 ) {
V_2 -> V_95 = NULL ;
V_13 = F_55 ( V_2 -> V_83 , F_49 ,
V_96 , L_9 , V_2 ) ;
if ( V_13 ) {
V_2 -> V_83 = 0 ;
F_20 ( V_26 L_10 ) ;
...
static void F_64 ( struct V_30 * V_31 , int V_100 )
{
V_31 -> type = V_101 ;
}
static int
F_65 ( struct V_30 * V_31 , struct V_102 * V_103 )
{
return - V_104 ;
}
static const char * F_66 ( struct V_30 * V_31 )
{
struct V_1 * V_2 =
F_12 ( V_31 , struct V_1 , V_31 ) ;
return V_2 -> V_105 ;
...
static void
F_67 ( struct V_30 * V_31 , struct V_106 * V_107 ,
struct V_106 * V_108 )
{
struct V_1 * V_2 =
F_12 ( V_31 , struct V_1 , V_31 ) ;
...
V_18 = F_68 ( V_31 , V_107 , V_108 , 0 , 230400 ) ;
switch ( V_18 ) {
case 300 :
V_110 = V_119 ;
break;
...
static unsigned int F_72 ( struct V_30 * V_31 )
{
return V_138 | V_139 | V_138 ;
}
static void F_73 ( struct V_30 * V_31 , unsigned int V_140 )
{
}
static void F_74 ( struct V_30 * V_31 , int V_141 )
{
}
static void F_75 ( struct V_30 * V_31 , unsigned int V_66 ,
unsigned int V_142 )
{
}
...
static int F_77 ( struct V_7 * V_8 , T_5 V_66 )
{
struct V_1 * V_2 = F_78 ( V_8 ) ;
F_79 ( V_2 -> V_83 ) ;
F_80 ( & V_143 , & V_2 -> V_31 ) ;
...
static int T_6 F_84 ( struct V_7 * V_8 )
{
struct V_1 * V_2 ;
void * V_144 ;
T_1 V_145 ;
...
V_2 -> V_31 . type = V_101 ;
V_2 -> V_31 . V_147 = 2 ;
V_2 -> V_31 . V_148 = & V_149 ;
V_2 -> V_31 . line = 0 ;
V_2 -> V_31 . V_150 = & V_8 -> V_150 ;
V_2 -> V_31 . V_151 = 115200 ;
V_2 -> V_8 = V_8 ;
strcpy ( V_2 -> V_105 , V_8 -> V_152 ) ;
...
V_2 -> V_44 = 0 ;
V_145 = V_154 ;
V_13 = F_1 ( V_2 , ( V_60 * ) & V_145 , ( V_60 * ) & V_145 , 2 , 0 ) ;
if ( V_13 < 0 || V_145 == 0 || V_145 == 0xffff ) {
F_87 ( & V_8 -> V_150 , L_13 ,
V_145 ) ;
V_13 = - V_51 ;
goto V_155;
}
V_144 = ( void * ) F_88 ( V_23 ) ;
if ( ! V_144 ) {
V_13 = - V_25 ;
goto V_155;
}
...
F_90 ( V_8 , V_2 ) ;
V_42 = V_2 ;
V_2 -> V_31 . V_158 = ( void * ) 0xff110000 ;
F_91 ( & V_143 , & V_2 -> V_31 ) ;
return 0 ;
V_157:
F_92 ( ( unsigned long ) V_144 ) ;
V_155:
F_9 ( V_2 ) ;
return V_13 ;
}
static int T_7 F_93 ( struct V_7 * V_150 )
{
struct V_1 * V_2 = F_78 ( V_150 ) ;
if ( ! V_2 )
return 0 ;
F_94 ( & V_143 , & V_2 -> V_31 ) ;
F_92 ( ( unsigned long ) V_2 -> V_35 . V_20 ) ;
if ( V_2 -> V_156 )
F_60 ( V_2 -> V_156 ) ;
F_9 ( V_2 ) ;
return 0 ;
