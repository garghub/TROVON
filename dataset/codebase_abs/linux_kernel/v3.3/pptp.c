...
F_18 ( V_7 [ V_4 -> V_8 . V_9 . V_17 . V_2 ] , NULL ) ;
F_15 ( & V_16 ) ;
F_19 () ;
}
...
goto V_44;
V_38 = V_36 -> V_47 . V_48 ;
V_41 = F_25 ( V_38 ) + sizeof( * V_40 ) + sizeof( * V_27 ) + 2 ;
if ( F_26 ( V_22 ) < V_41 || F_27 ( V_22 ) || F_28 ( V_22 ) ) {
struct V_21 * V_49 = F_29 ( V_22 , V_41 ) ;
if ( ! V_49 ) {
F_30 ( V_36 ) ;
goto V_44;
}
...
V_27 -> V_60 = V_61 ;
V_27 -> V_62 = F_35 ( V_63 ) ;
V_27 -> V_2 = F_35 ( V_6 -> V_10 . V_2 ) ;
V_27 -> V_58 |= V_64 ;
V_27 -> V_65 = F_36 ( ++ V_6 -> V_66 ) ;
if ( V_6 -> V_56 != V_34 ) {
V_27 -> V_60 |= V_67 ;
V_27 -> V_57 = F_36 ( V_34 ) ;
V_6 -> V_56 = V_34 ;
...
V_27 -> V_68 = F_35 ( V_32 ) ;
F_37 ( V_22 ) ;
F_34 ( V_22 , sizeof( * V_40 ) ) ;
F_38 ( V_22 ) ;
memset ( & ( F_39 ( V_22 ) -> V_6 ) , 0 , sizeof( F_39 ( V_22 ) -> V_6 ) ) ;
F_39 ( V_22 ) -> V_58 &= ~ ( V_69 | V_70 | V_71 ) ;
V_40 = F_40 ( V_22 ) ;
V_40 -> V_72 = 4 ;
V_40 -> V_73 = sizeof( struct V_39 ) >> 2 ;
if ( F_41 ( V_23 , & V_36 -> V_47 ) )
V_40 -> V_74 = F_35 ( V_75 ) ;
else
V_40 -> V_74 = 0 ;
V_40 -> V_62 = V_46 ;
...
V_40 -> V_77 = V_30 . V_77 ;
V_40 -> V_78 = V_30 . V_78 ;
V_40 -> V_79 = F_42 ( & V_36 -> V_47 ) ;
V_40 -> V_80 = F_35 ( V_22 -> V_32 ) ;
F_43 ( V_22 ) ;
F_44 ( V_22 , & V_36 -> V_47 ) ;
F_45 ( V_22 ) ;
V_22 -> V_81 = V_82 ;
F_46 ( V_40 , & V_36 -> V_47 , NULL ) ;
F_47 ( V_40 ) ;
F_48 ( V_22 ) ;
return 1 ;
V_44:
...
static int F_49 ( struct V_4 * V_23 , struct V_21 * V_22 )
{
struct V_1 * V_25 = F_21 ( V_23 ) ;
struct V_5 * V_6 = & V_25 -> V_8 . V_9 ;
int V_83 , V_68 , V_65 ;
...
goto V_87;
V_85 = (struct V_26 * ) ( V_22 -> V_33 ) ;
V_57 = F_53 ( V_85 -> V_58 ) ? V_85 -> V_57 : V_85 -> V_65 ;
V_57 = F_54 ( V_57 ) ;
if ( V_57 > V_6 -> V_89 )
V_6 -> V_89 = V_57 ;
if ( F_55 ( V_57 , V_6 -> V_89 ) )
V_6 -> V_89 = V_57 ;
} else {
...
V_68 = F_56 ( V_85 -> V_68 ) ;
V_65 = F_54 ( V_85 -> V_65 ) ;
if ( ! F_52 ( V_22 , V_83 + V_68 ) )
goto V_87;
V_84 = V_22 -> V_33 + V_83 ;
if ( V_65 < V_6 -> V_34 + 1 || F_55 ( V_6 -> V_34 , V_65 ) ) {
...
V_40 = F_40 ( V_22 ) ;
V_85 = (struct V_26 * ) V_22 -> V_33 ;
if ( F_56 ( V_85 -> V_62 ) != V_63 ||
F_61 ( V_85 -> V_58 ) ||
F_62 ( V_85 -> V_58 ) ||
! F_63 ( V_85 -> V_58 ) ||
( V_85 -> V_58 & 0xF ) != 0 )
goto V_87;
V_25 = F_1 ( F_35 ( V_85 -> V_2 ) , V_40 -> V_78 ) ;
if ( V_25 ) {
F_43 ( V_22 ) ;
F_45 ( V_22 ) ;
return F_64 ( F_5 ( V_25 ) , V_22 , 0 ) ;
}
V_87:
F_32 ( V_22 ) ;
return V_94 ;
}
static int F_65 ( struct V_97 * V_4 , struct V_98 * V_99 ,
int V_100 )
{
...
static int F_68 ( struct V_97 * V_4 , struct V_98 * V_99 ,
int V_100 , int V_58 )
{
struct V_4 * V_23 = V_4 -> V_23 ;
struct V_101 * V_102 = (struct V_101 * ) V_99 ;
...
static int F_74 ( struct V_97 * V_4 , struct V_98 * V_117 ,
int * V_118 , int V_119 )
{
...
V_102 . V_120 = V_121 ;
V_102 . V_105 = V_106 ;
V_102 . V_103 . V_9 = F_21 ( V_4 -> V_23 ) -> V_8 . V_9 . V_17 ;
memcpy ( V_117 , & V_102 , V_32 ) ;
* V_118 = V_32 ;
return 0 ;
}
static int F_75 ( struct V_97 * V_4 )
{
struct V_4 * V_23 = V_4 -> V_23 ;
struct V_1 * V_25 ;
struct V_5 * V_6 ;
...
static void F_80 ( struct V_4 * V_23 )
{
if ( ! ( V_23 -> V_42 & V_43 ) ) {
F_16 ( F_21 ( V_23 ) ) ;
F_77 ( V_23 ) ;
...
static int F_82 ( struct V_125 * V_125 , struct V_97 * V_4 )
{
int error = - V_126 ;
struct V_4 * V_23 ;
struct V_1 * V_25 ;
struct V_5 * V_6 ;
V_23 = F_83 ( V_125 , V_127 , V_128 , & V_129 ) ;
if ( ! V_23 )
goto V_130;
F_84 ( V_4 , V_23 ) ;
V_4 -> V_131 = V_132 ;
...
V_25 = F_21 ( V_23 ) ;
V_6 = & V_25 -> V_8 . V_9 ;
V_6 -> V_66 = 0 ; V_6 -> V_34 = 0xffffffff ;
V_6 -> V_89 = 0 ; V_6 -> V_56 = 0xffffffff ;
error = 0 ;
V_130:
return error ;
}
static int F_85 ( struct V_19 * V_20 , unsigned int V_141 ,
unsigned long V_142 )
{
struct V_4 * V_23 = (struct V_4 * ) V_20 -> V_24 ;
struct V_1 * V_25 = F_21 ( V_23 ) ;
...
int V_145 = 0 ;
F_89 ( L_2 V_152 L_3 ) ;
V_7 = F_90 ( ( V_15 + 1 ) * sizeof( void * ) ) ;
if ( ! V_7 ) {
F_73 ( L_4 ) ;
return - V_126 ;
}
V_145 = F_91 ( & V_153 , V_154 ) ;
if ( V_145 ) {
F_73 ( L_5 ) ;
goto V_155;
}
