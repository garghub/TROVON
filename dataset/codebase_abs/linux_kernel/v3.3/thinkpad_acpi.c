...
static int F_148 ( struct V_285 * V_157 )
{
switch ( V_66 ) {
case V_286 :
case V_67 :
...
static void F_150 ( struct V_285 * V_157 )
{
if ( V_66 != V_202 &&
! ( V_196 & V_198 ) )
F_146 ( false ) ;
}
static T_8 F_151 ( struct V_71 * V_157 ,
struct V_159 * V_124 ,
char * V_128 )
{
int V_17 , V_30 ;
...
static T_8 F_152 ( struct V_71 * V_157 ,
struct V_159 * V_124 ,
const char * V_128 , T_10 V_35 )
{
unsigned long V_160 ;
...
static T_8 F_153 ( struct V_71 * V_157 ,
struct V_159 * V_124 ,
char * V_128 )
{
...
static T_8 F_158 ( struct V_71 * V_157 ,
struct V_159 * V_124 ,
char * V_128 )
{
...
static T_8 F_169 ( struct V_71 * V_157 ,
struct V_159 * V_124 ,
char * V_128 )
{
return snprintf ( V_128 , V_103 , L_42 ,
...
switch ( V_332 >> 12 ) {
case 1 :
V_376 = F_187 ( V_332 , & V_347 ,
& V_348 ) ;
break;
case 2 :
V_376 = F_188 ( V_332 , & V_347 ,
& V_348 ) ;
break;
case 3 :
switch ( V_332 ) {
...
static void F_201 ( bool V_207 )
{
F_2 ( L_155 ) ;
if ( ! F_202 ( ( V_66 == V_67 || ! V_207 ) ,
F_203 ( L_156
L_157
L_158 ) ) )
F_8 ( L_159
...
static int F_206 ( enum V_384 V_110 )
{
int V_30 ;
F_17 ( V_142 ,
L_167 ,
...
static T_8 F_207 ( struct V_71 * V_157 ,
struct V_159 * V_124 ,
char * V_128 )
{
return F_78 ( V_386 ,
...
static T_8 F_208 ( struct V_71 * V_157 ,
struct V_159 * V_124 ,
const char * V_128 , T_10 V_35 )
{
return F_79 ( V_386 ,
...
static int F_216 ( enum V_384 V_110 )
{
int V_30 ;
F_17 ( V_142 ,
L_177 ,
...
static T_8 F_217 ( struct V_71 * V_157 ,
struct V_159 * V_124 ,
char * V_128 )
{
return F_78 ( V_396 ,
...
static T_8 F_218 ( struct V_71 * V_157 ,
struct V_159 * V_124 ,
const char * V_128 , T_10 V_35 )
{
return F_79 ( V_396 ,
...
static int F_225 ( enum V_384 V_110 )
{
int V_30 ;
F_17 ( V_142 ,
L_187 ,
...
static void F_241 ( struct V_439 * V_440 )
{
struct V_441 * V_63 =
F_242 ( V_440 , struct V_441 , V_440 ) ;
if ( F_137 ( V_66 == V_67 ) )
F_240 ( ( V_63 -> V_442 != V_443 ) ) ;
}
static void F_243 ( struct V_444 * V_445 ,
enum V_446 V_447 )
{
struct V_441 * V_63 =
F_242 ( V_445 ,
...
V_449 : V_443 ;
F_244 ( V_450 , & V_63 -> V_440 ) ;
}
static enum V_446 F_245 ( struct V_444 * V_445 )
{
return ( F_239 () == 1 ) ? V_451 : V_448 ;
}
...
static T_8 F_256 ( struct V_71 * V_157 ,
struct V_159 * V_124 ,
const char * V_128 , T_10 V_35 )
{
unsigned long V_47 ;
...
static inline bool F_263 ( const unsigned int V_459 )
{
#ifdef F_264
return false ;
#else
...
static int F_265 ( const unsigned int V_459 )
{
int V_30 ;
enum V_461 V_462 ;
switch ( V_463 ) {
...
static int F_266 ( const unsigned int V_459 ,
...
static void F_267 ( struct V_439 * V_440 )
{
struct V_441 * V_63 =
F_242 ( V_440 , struct V_441 , V_440 ) ;
if ( F_137 ( V_66 == V_67 ) )
F_266 ( V_63 -> V_459 , V_63 -> V_442 ) ;
}
static void F_268 ( struct V_444 * V_445 ,
enum V_446 V_447 )
{
struct V_441 * V_63 = F_242 ( V_445 ,
struct V_441 , V_444 ) ;
if ( V_447 == V_448 )
V_63 -> V_442 = V_443 ;
...
static int F_269 ( struct V_444 * V_445 ,
...
static enum V_446 F_270 ( struct V_444 * V_445 )
{
int V_70 ;
struct V_441 * V_63 = F_242 ( V_445 ,
struct V_441 , V_444 ) ;
V_70 = F_265 ( V_63 -> V_459 ) ;
...
F_250 ( & V_479 [ V_42 ] . V_444 ) ;
}
F_36 ( V_479 ) ;
}
static int T_1 F_272 ( unsigned int V_459 )
{
int V_70 ;
V_479 [ V_459 ] . V_459 = V_459 ;
if ( ! V_480 [ V_459 ] )
return 0 ;
V_479 [ V_459 ] . V_444 . V_481 = & F_268 ;
V_479 [ V_459 ] . V_444 . V_482 = & F_269 ;
if ( V_463 == V_464 )
V_479 [ V_459 ] . V_444 . V_483 =
& F_270 ;
V_479 [ V_459 ] . V_444 . V_51 = V_480 [ V_459 ] ;
F_247 ( & V_479 [ V_459 ] . V_440 , F_267 ) ;
V_70 = F_248 ( & V_156 -> V_157 ,
& V_479 [ V_459 ] . V_444 ) ;
if ( V_70 < 0 )
...
static enum V_484 T_1 F_273 ( void )
{
T_4 V_30 ;
if ( F_6 () ) {
...
static int F_282 ( int V_494 , T_18 * V_38 )
{
int V_160 ;
T_19 V_495 ;
char V_496 [ 5 ] ;
...
static int F_283 ( struct V_507 * V_120 )
{
int V_17 , V_42 ;
int V_222 ;
V_222 = 8 ;
...
V_17 = F_282 ( V_42 , & V_120 -> V_508 [ V_42 ] ) ;
if ( V_17 )
return V_17 ;
}
return V_222 ;
...
F_284 ( L_270 , ( int ) ( V_160 . V_508 [ V_42 ] / 1000 ) ) ;
else
F_284 ( L_271 ) ;
}
F_284 ( L_272 ) ;
}
static T_8 F_285 ( struct V_71 * V_157 ,
struct V_159 * V_124 ,
char * V_128 )
{
struct V_510 * V_511 =
...
static int F_296 ( struct V_537 * V_538 )
{
unsigned int V_56 =
...
static void F_362 ( struct V_439 * V_666 )
{
int V_70 ;
if ( V_66 != V_67 )
return;
...
static T_8 F_363 ( struct V_71 * V_157 ,
struct V_159 * V_124 ,
char * V_128 )
{
int V_17 , V_667 ;
...
static T_8 F_364 ( struct V_71 * V_157 ,
struct V_159 * V_124 ,
const char * V_128 , T_10 V_35 )
{
unsigned long V_160 ;
...
static T_8 F_365 ( struct V_71 * V_157 ,
struct V_159 * V_124 ,
char * V_128 )
{
int V_17 ;
...
static T_8 F_369 ( struct V_164 * V_165 ,
char * V_128 )
{
return snprintf ( V_128 , V_103 , L_385 , V_665 ) ;
}
static T_8 F_370 ( struct V_164 * V_165 ,
const char * V_128 , T_10 V_35 )
{
unsigned long V_160 ;
...
static int F_376 ( const char * V_162 , int * V_70 )
{
int V_56 ;
...
static int F_377 ( const char * V_162 , int * V_70 )
{
if ( F_84 ( V_162 , L_49 ) != 0 )
return 0 ;
* V_70 = F_355 () ;
...
static int F_378 ( const char * V_162 , int * V_70 )
{
...
static T_8 F_383 ( struct V_71 * V_157 ,
struct V_159 * V_124 ,
char * V_128 )
{
...
| V_712 -> V_716 [ 5 ] ;
while ( ( V_157 = F_399 ( V_717 , NULL , V_157 ) ) ) {
...
V_120 = F_397 ( V_718 ) ;
if ( V_120 && ! F_400 ( V_120 , L_441 , 8 ) ) {
V_712 -> V_719 = F_398 ( V_120 , V_81 ) ;
if ( ! V_712 -> V_719 )
return - V_82 ;
}
V_120 = F_397 ( V_720 ) ;
V_712 -> V_721 = F_398 ( V_120 , V_81 ) ;
