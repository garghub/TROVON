...
if ( F_53 ( & V_1 -> V_150 , & V_31 , 1 ) != 1 ) return - V_151 ;
return 0 ;
}
...
if ( V_60 -> V_148 . V_149 )
V_60 -> V_148 . V_149 ( V_60 , 1 ) ;
if ( F_53 ( & V_1 -> V_150 , & V_154 , 1 ) != 1 ) return - V_151 ;
F_55 ( 1 ) ;
V_154 . V_18 = 0x65 ;
V_154 . V_37 = V_153 ;
...
if ( V_60 -> V_148 . V_149 )
V_60 -> V_148 . V_149 ( V_60 , 1 ) ;
if ( F_53 ( & V_1 -> V_150 , & V_154 , 1 ) != 1 ) {
F_53 ( & V_1 -> V_150 , & V_154 , 1 ) ;
}
return 0 ;
}
...
static int F_58 ( struct V_59 * V_60 , const struct V_38 * * V_39 , char * V_160 )
{
struct V_1 * V_1 = (struct V_1 * ) V_60 -> V_63 -> V_64 ;
return F_12 ( V_39 , V_160 , & V_1 -> V_13 -> V_13 ) ;
}
static int F_59 ( struct V_59 * V_60 , T_5 V_161 , T_5 V_162 )
{
T_1 V_163 = 0 ;
T_1 V_164 = 0 ;
if ( V_161 < 1500000 ) {
...
F_60 ( V_60 , 0x13 , V_163 ) ;
F_60 ( V_60 , 0x14 , V_164 ) ;
F_60 ( V_60 , 0x1f , ( V_162 >> 16 ) & 0xff ) ;
F_60 ( V_60 , 0x20 , ( V_162 >> 8 ) & 0xff ) ;
F_60 ( V_60 , 0x21 , ( V_162 ) & 0xf0 ) ;
return 0 ;
}
...
if ( ( F_53 ( & V_1 -> V_150 , V_31 , 2 ) != 2 ) || ( V_166 == 0xff ) )
V_166 = 0x48 ;
return V_166 ;
}
...
{
switch( F_67 ( V_1 -> V_13 -> V_167 . V_168 ) ) {
case 0x1003 :
V_1 -> V_60 = F_68 ( V_169 , & V_170 , & V_1 -> V_150 ) ;
if ( V_1 -> V_60 != NULL ) {
V_1 -> V_60 -> V_148 . V_171 . V_172 = F_61 ;
if( V_1 -> V_58 == V_165 ) {
V_170 . V_173 = V_174 ;
F_68 ( V_175 , V_1 -> V_60 , & V_1 -> V_150 , 0 , 0 ) ;
} else {
V_1 -> V_60 -> V_148 . V_176 = F_21 ;
}
break;
}
V_1 -> V_60 = F_68 ( V_177 , & V_178 , & V_1 -> V_150 ) ;
if ( V_1 -> V_60 != NULL ) {
...
break;
case 0x1004 :
V_1 -> V_60 = F_68 ( V_179 , & V_180 , & V_1 -> V_150 , F_64 ( V_1 ) ) ;
if ( V_1 -> V_60 != NULL ) {
V_1 -> V_60 -> V_148 . V_171 . V_172 = F_63 ;
break;
}
V_1 -> V_60 = F_68 ( V_181 , & V_182 , & V_1 -> V_150 ) ;
if ( V_1 -> V_60 != NULL ) {
V_1 -> V_60 -> V_148 . V_171 . V_172 = F_65 ;
break;
}
break;
case 0x1005 :
V_1 -> V_60 = F_68 ( V_183 , & V_184 , & V_1 -> V_150 ) ;
if ( V_1 -> V_60 != NULL ) {
V_1 -> V_60 -> V_148 . V_171 . V_172 = F_52 ;
break;
}
V_1 -> V_60 = F_68 ( V_185 , & V_186 , & V_1 -> V_150 ) ;
if ( V_1 -> V_60 != NULL ) {
V_1 -> V_60 -> V_148 . V_171 . V_187 = F_54 ;
V_1 -> V_60 -> V_148 . V_171 . V_172 = F_56 ;
break;
}
break;
}
if ( V_1 -> V_60 == NULL ) {
F_2 ( L_36 ,
F_67 ( V_1 -> V_13 -> V_167 . V_188 ) ,
F_67 ( V_1 -> V_13 -> V_167 . V_168 ) ) ;
} else {
...
static int F_71 ( struct V_189 * V_190 , const struct V_191 * V_24 )
{
struct V_192 * V_193 ;
struct V_1 * V_1 ;
int V_194 ;
...
if ( ! ( V_1 = F_73 ( sizeof( struct V_1 ) , V_199 ) ) )
return - V_114 ;
V_1 -> V_13 = V_193 ;
V_1 -> V_25 = 0 ;
V_1 -> V_85 = 0 ;
...
if ( F_82 ( & V_1 -> V_29 , & V_1 -> V_220 , & V_1 -> V_82 . V_207 ) ) {
F_2 ( L_45 ) ;
V_194 = - V_198 ;
goto V_221;
}
...
static void F_88 ( struct V_189 * V_190 )
{
struct V_1 * V_1 = F_89 ( V_190 ) ;
F_83 ( V_190 , NULL ) ;
V_1 -> V_222 = 1 ;
F_41 ( V_1 ) ;
