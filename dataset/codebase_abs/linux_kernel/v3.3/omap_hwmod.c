...
goto V_138;
F_4 ( V_13 , V_2 ) ;
if ( V_2 -> V_3 -> V_4 -> V_9 & V_139 )
F_73 ( ( F_3 ( V_2 ,
V_2 -> V_3 -> V_4 -> V_140 )
& V_141 ) ,
V_142 , V_66 ) ;
else if ( V_2 -> V_3 -> V_4 -> V_9 & V_143 )
F_73 ( ! ( F_3 ( V_2 ,
V_2 -> V_3 -> V_4 -> V_8 )
& V_144 ) ,
V_142 , V_66 ) ;
...
int F_81 ( struct V_1 * V_2 , T_2 V_31 )
{
T_1 V_13 ;
int V_153 = 0 ;
unsigned long V_45 ;
...
static int F_85 ( struct V_1 * V_2 , void * V_115 )
{
int V_67 , V_147 ;
T_2 V_157 ;
if ( V_2 -> V_49 != V_117 )
...
int F_94 ( struct V_1 * V_2 , T_2 V_20 )
{
T_1 V_13 ;
int V_153 = 0 ;
if ( ! V_2 )
...
struct V_1 * F_95 ( const char * V_5 )
{
struct V_1 * V_2 ;
if ( ! V_5 )
return NULL ;
...
int F_96 ( int (* F_97)( struct V_1 * V_2 , void * V_115 ) ,
void * V_115 )
{
struct V_1 * V_113 ;
int V_63 = 0 ;
...
return - V_6 ;
F_53 (temp_oh, &omap_hwmod_list, node) {
V_63 = (* F_97)( V_113 , V_115 ) ;
if ( V_63 )
break;
}
return V_63 ;
}
int T_4 F_98 ( struct V_1 * * V_170 )
{
int V_147 , V_67 ;
if ( ! V_170 )
return 0 ;
V_67 = 0 ;
do {
V_147 = F_86 ( V_170 [ V_67 ] ) ;
F_2 ( V_147 , L_47 , V_170 [ V_67 ] -> V_5 ,
V_147 ) ;
} while ( V_170 [ ++ V_67 ] );
return 0 ;
}
static int T_4 F_99 ( struct V_1 * V_2 , void * V_115 )
{
if ( V_2 -> V_49 != V_116 )
return 0 ;
if ( V_2 -> V_11 & V_85 )
...
int T_4 F_100 ( const char * V_171 )
{
struct V_1 * V_2 ;
int V_147 ;
...
V_147 = F_96 ( F_99 , NULL ) ;
V_147 = F_96 ( F_56 , NULL ) ;
F_2 ( F_63 ( V_147 ) ,
L_53 , V_87 ) ;
F_96 ( F_85 , NULL ) ;
return 0 ;
...
int F_111 ( struct V_1 * V_2 , struct V_172 * V_173 )
{
...
struct V_182 * F_112 ( struct V_1 * V_2 )
{
struct V_65 * V_66 ;
if ( ! V_2 )
return NULL ;
...
int F_122 ( struct V_1 * V_2 , T_2 V_184 )
{
int V_63 ;
unsigned long V_45 ;
if ( ! V_2 )
...
int F_126 ( struct V_1 * V_2 , int V_186 , int V_187 )
{
int V_188 ;
F_127 () ;
...
return - V_6 ;
if ( ! V_2 -> V_41 -> V_189 ) {
V_2 -> V_41 -> V_189 = F_128 ( sizeof( int ) * V_2 -> V_41 -> V_43 ,
V_190 ) ;
if ( ! V_2 -> V_41 -> V_189 )
return - V_191 ;
}
