...
int V_75 = 0 ;
T_3 V_76 ;
F_17 ( L_8 , V_10 -> V_28 , V_67 , V_72 , V_70 , V_73 ) ;
V_76 = F_31 ( V_17 ) ;
if ( V_76 != F_32 ( V_66 ) ) {
V_74 = - 1 ;
if ( ( V_73 & V_77 ) == V_78 ) {
...
static void F_40 ( struct V_142 * V_142 )
{
...
static void F_46 ( struct V_12 * V_13 , int V_150 )
{
F_24 ( V_13 , V_150 * ( V_50 | V_54 ) , 1 ) ;
}
static int F_47 ( struct V_16 * V_17 , struct V_12 * V_13 )
{
int V_21 ;
unsigned char V_18 [ 32 ] ;
struct V_9 * V_10 = F_16 ( V_13 ) ;
...
F_42 ( & V_10 -> V_161 ) ;
F_53 ( & V_10 -> V_15 ) ;
F_54 ( & V_13 -> V_25 -> V_157 ) ;
F_17 ( L_24 ) ;
}
static int F_48 ( struct V_144 * V_25 )
{
int V_75 , V_21 = 0 ;
...
static int F_55 ( struct V_144 * V_25 )
{
int V_75 ;
struct V_9 * V_10 ;
struct V_24 * V_145 ;
F_17 ( L_25 ) ;
for ( V_75 = 0 ; V_75 < V_25 -> type -> V_164 + 1 ; V_75 ++ ) {
V_10 = F_56 ( sizeof( struct V_9 ) , V_165 ) ;
if ( V_10 == NULL ) {
while ( -- V_75 >= 0 )
F_57 ( F_16 ( V_25 -> V_13 [ V_75 ] ) ) ;
return 1 ;
}
F_58 ( & V_10 -> V_15 ) ;
V_10 -> V_28 = V_75 ;
...
F_59 ( & V_25 -> V_13 [ V_75 ] -> V_30 ) ;
F_61 ( V_25 -> V_13 [ V_75 ] , V_10 ) ;
}
V_145 = F_56 ( sizeof( struct V_24 ) , V_165 ) ;
if ( V_145 == NULL ) {
for ( V_75 = 0 ; V_75 < V_25 -> type -> V_164 + 1 ; V_75 ++ )
F_57 ( F_16 ( V_25 -> V_13 [ V_75 ] ) ) ;
return 1 ;
...
static void F_63 ( struct V_144 * V_25 )
{
int V_75 ;
F_17 ( L_26 , F_39 () ) ;
for ( V_75 = 0 ; V_75 < V_25 -> type -> V_164 + 1 ; V_75 ++ ) {
F_51 ( V_25 -> V_13 [ V_75 ] -> V_64 ) ;
F_51 ( V_25 -> V_13 [ V_75 ] -> V_35 ) ;
}
}
...
static void F_65 ( struct V_142 * V_142 )
{
struct V_12 * V_13 = V_142 -> V_143 ;
struct V_9 * V_10 ;
struct V_24 * V_145 ;
...
F_17 ( L_38 , V_40 , V_167 ) ;
return V_170 ? 1 : 0 ;
}
static int F_66 ( struct V_142 * V_142 )
{
struct V_12 * V_13 = V_142 -> V_143 ;
...
if ( V_192 )
goto V_198;
F_74 (KERN_INFO KBUILD_MODNAME L_41 DRIVER_VERSION L_42
DRIVER_DESC L_43 ) ;
return 0 ;
V_198:
F_75 ( & V_195 ) ;
