...
( ( V_274 * ) V_17 -> V_275 ) [ V_3 ] = F_152 ( V_272 ) ;
}
F_150 ( V_19 , F_12 ( V_1 , V_276 ) ) ;
return 0 ;
}
...
for ( V_3 = 0 ; V_3 < F_154 ( V_277 ) ; V_3 ++ ) {
V_278 = F_155 ( V_279 , V_277 [ V_3 ] , NULL ) ;
if ( V_278 )
break;
}
if ( ! V_278 ) {
...
V_7 = ( V_268 & ~ 0x02 ) ;
F_157 ( V_278 , 0x48 , V_7 ) ;
F_83 ( 50 ) ;
F_156 ( V_278 , 0x48 , & V_7 ) ;
for ( V_3 = 0 ; V_3 < V_136 ; V_3 ++ ) {
F_158 ( 0x9 + V_3 , 0x78 ) ;
V_17 -> V_275 [ V_3 ] = F_159 ( 0x79 ) ;
}
F_158 ( 0x12 , 0x78 ) ;
V_7 = F_159 ( 0x79 ) ;
F_150 ( V_19 , V_7 ) ;
F_157 ( V_278 , 0x48 , V_268 ) ;
F_160 ( V_278 ) ;
return 0 ;
}
...
for ( V_3 = 0 ; V_3 < V_136 ; V_3 ++ )
F_149 ( V_280 + V_3 , V_17 -> V_275 [ V_3 ] ) ;
F_72 ( V_138 , V_2 ) ;
F_14 () ;
}
...
static int F_165 ( struct V_16 * V_17 , struct V_287 * V_288 )
{
struct V_18 * V_19 = F_9 ( V_17 ) ;
return F_166 ( & V_19 -> V_152 , V_288 ) ;
}
static int F_167 ( struct V_16 * V_17 , struct V_287 * V_288 )
{
struct V_18 * V_19 = F_9 ( V_17 ) ;
return F_168 ( & V_19 -> V_152 , V_288 ) ;
}
static void F_169 ( struct V_16 * V_17 ,
struct V_289 * V_290 )
{
struct V_18 * V_19 = F_9 ( V_17 ) ;
F_170 ( V_290 -> V_291 , V_266 , sizeof( V_290 -> V_291 ) ) ;
F_170 ( V_290 -> V_292 , V_293 , sizeof( V_290 -> V_292 ) ) ;
F_170 ( V_290 -> V_294 , F_117 ( V_19 -> V_46 ) ,
sizeof( V_290 -> V_294 ) ) ;
}
...
static void F_172 ( struct V_16 * V_17 , struct V_295 * V_296 ,
void * V_173 )
{
struct V_18 * V_19 = F_9 ( V_17 ) ;
unsigned long V_123 ;
...
V_296 -> V_89 = V_265 ;
F_71 ( & V_19 -> V_137 , V_123 ) ;
F_173 ( V_173 , V_19 -> V_20 , V_296 -> V_89 ) ;
F_73 ( & V_19 -> V_137 , V_123 ) ;
}
static int F_174 ( struct V_16 * V_17 )
{
struct V_18 * V_19 = F_9 ( V_17 ) ;
return F_175 ( & V_19 -> V_152 ) ;
}
static T_2 F_176 ( struct V_16 * V_17 )
{
struct V_18 * V_19 = F_9 ( V_17 ) ;
return V_19 -> V_259 ;
}
static void F_177 ( struct V_16 * V_17 , T_2 V_297 )
{
struct V_18 * V_19 = F_9 ( V_17 ) ;
V_19 -> V_259 = V_297 ;
}
static int F_178 ( struct V_16 * V_17 , struct V_298 * V_299 , int V_288 )
{
struct V_18 * V_19 = F_9 ( V_17 ) ;
return ! F_55 ( V_17 ) ? - V_300 :
F_179 ( & V_19 -> V_152 , F_180 ( V_299 ) , V_288 , NULL ) ;
}
static int F_181 ( struct V_16 * V_17 , void * V_173 )
{
int V_202 ;
V_202 = F_182 ( V_17 , V_173 ) ;
if ( ! V_202 )
F_161 ( V_17 ) ;
return V_202 ;
}
static int T_3 F_183 ( struct V_46 * V_79 ,
