...
static
char * F_40 ( char * V_9 , char * V_17 , const T_2 * V_68 ,
struct V_18 V_19 )
{
V_19 . V_25 |= V_26 | V_27 | V_29 ;
if ( V_19 . V_31 == - 1 )
V_19 . V_31 = 2 + 2 * sizeof( V_95 ) ;
V_19 . V_3 = 16 ;
return F_12 ( V_9 , V_17 , * ( const V_95 * ) V_68 , V_19 ) ;
}
static T_1
char * F_41 ( const char * V_47 , char * V_9 , char * V_17 , void * V_40 ,
struct V_18 V_19 )
{
if ( ! V_40 && * V_47 != 'K' ) {
if ( V_19 . V_31 == - 1 )
...
{
T_4 V_96 ;
F_43 ( V_96 , * ( (struct V_97 * ) V_40 ) -> V_96 ) ;
V_9 += vsnprintf ( V_9 , V_17 > V_9 ? V_17 - V_9 : 0 ,
( (struct V_97 * ) V_40 ) -> V_47 , V_96 ) ;
va_end ( V_96 ) ;
return V_9 ;
}
case 'K' :
...
switch ( V_47 [ 1 ] ) {
case 'F' :
return F_40 ( V_9 , V_17 , V_40 , V_19 ) ;
}
break;
}
V_19 . V_25 |= V_27 ;
...
static T_1
int F_48 ( const char * V_47 , struct V_18 * V_19 )
{
...
V_104:
V_19 -> V_104 = - 1 ;
if ( * V_47 == 'h' || F_49 ( * V_47 ) == 'l' ||
F_49 ( * V_47 ) == 'z' || * V_47 == 't' ) {
V_19 -> V_104 = * V_47 ++ ;
if ( F_50 ( V_19 -> V_104 == * V_47 ) ) {
if ( V_19 -> V_104 == 'l' ) {
V_19 -> V_104 = 'L' ;
++ V_47 ;
} else if ( V_19 -> V_104 == 'h' ) {
V_19 -> V_104 = 'H' ;
++ V_47 ;
}
}
...
if ( V_19 -> V_104 == 'L' )
V_19 -> type = V_112 ;
else if ( V_19 -> V_104 == 'l' ) {
if ( V_19 -> V_25 & V_30 )
V_19 -> type = V_113 ;
else
V_19 -> type = V_114 ;
} else if ( F_49 ( V_19 -> V_104 ) == 'z' ) {
V_19 -> type = V_115 ;
} else if ( V_19 -> V_104 == 't' ) {
V_19 -> type = V_116 ;
} else if ( V_19 -> V_104 == 'H' ) {
if ( V_19 -> V_25 & V_30 )
V_19 -> type = V_117 ;
...
int vsnprintf ( char * V_9 , T_5 V_123 , const char * V_47 , T_4 args )
{
...
while ( * V_47 ) {
const char * V_125 = V_47 ;
int V_126 = F_48 ( V_47 , & V_19 ) ;
V_47 += V_126 ;
switch ( V_19 . type ) {
case V_102 : {
int V_127 = V_126 ;
...
case V_107 :
V_124 = string ( V_124 , V_17 , va_arg ( args , char * ) , V_19 ) ;
break;
case V_108 :
V_124 = F_41 ( V_47 + 1 , V_124 , V_17 , va_arg ( args , void * ) ,
V_19 ) ;
while ( isalnum ( * V_47 ) )
V_47 ++ ;
break;
...
break;
case V_109 : {
T_2 V_104 = V_19 . V_104 ;
if ( V_104 == 'l' ) {
long * V_128 = va_arg ( args , long * ) ;
* V_128 = ( V_124 - V_9 ) ;
} else if ( F_49 ( V_104 ) == 'z' ) {
T_5 * V_128 = va_arg ( args , T_5 * ) ;
* V_128 = ( V_124 - V_9 ) ;
} else {
int * V_128 = va_arg ( args , int * ) ;
* V_128 = ( V_124 - V_9 ) ;
}
break;
}
...
V_124 = F_12 ( V_124 , V_17 , V_15 , V_19 ) ;
}
}
if ( V_123 > 0 ) {
if ( V_124 < V_17 )
...
int F_52 ( char * V_9 , T_5 V_123 , const char * V_47 , T_4 args )
{
int V_8 ;
V_8 = vsnprintf ( V_9 , V_123 , V_47 , args ) ;
if ( F_53 ( V_8 < V_123 ) )
return V_8 ;
if ( V_123 != 0 )
return V_123 - 1 ;
...
int snprintf ( char * V_9 , T_5 V_123 , const char * V_47 , ... )
{
T_4 args ;
int V_8 ;
va_start ( args , V_47 ) ;
...
int F_54 ( char * V_9 , T_5 V_123 , const char * V_47 , ... )
{
T_4 args ;
int V_8 ;
va_start ( args , V_47 ) ;
V_8 = F_52 ( V_9 , V_123 , V_47 , args ) ;
va_end ( args ) ;
return V_8 ;
}
int vsprintf ( char * V_9 , const char * V_47 , T_4 args )
{
return vsnprintf ( V_9 , V_130 , V_47 , args ) ;
}
...
int V_8 ;
va_start ( args , V_47 ) ;
V_8 = vsnprintf ( V_9 , V_130 , V_47 , args ) ;
va_end ( args ) ;
return V_8 ;
}
int F_55 ( T_6 * V_131 , T_5 V_123 , const char * V_47 , T_4 args )
{
struct V_18 V_19 = { 0 } ;
char * V_124 , * V_17 ;
V_124 = ( char * ) V_131 ;
V_17 = ( char * ) ( V_131 + V_123 ) ;
#define F_56 ( type ) \
do { \
if (sizeof(type) == 8) { \
...
break;
case V_107 : {
const char * V_132 = va_arg ( args , char * ) ;
T_5 V_38 ;
if ( ( unsigned long ) V_132 > ( unsigned long ) - V_39
|| ( unsigned long ) V_132 < V_39 )
V_132 = L_2 ;
V_38 = strlen ( V_132 ) + 1 ;
if ( V_124 + V_38 < V_17 )
memcpy ( V_124 , V_132 , V_38 ) ;
V_124 += V_38 ;
break;
}
case V_108 :
...
void * V_133 ;
if ( V_104 == 'l' )
V_133 = va_arg ( args , long * ) ;
else if ( F_49 ( V_104 ) == 'z' )
V_133 = va_arg ( args , T_5 * ) ;
else
V_133 = va_arg ( args , int * ) ;
break;
}
default:
switch ( V_19 . type ) {
...
return ( T_6 * ) ( F_57 ( V_124 , sizeof( T_6 ) ) ) - V_131 ;
#undef F_56
}
int F_58 ( char * V_9 , T_5 V_123 , const char * V_47 , const T_6 * V_131 )
{
struct V_18 V_19 = { 0 } ;
char * V_124 , * V_17 ;
const char * args = ( const char * ) V_131 ;
if ( F_51 ( ( int ) V_123 < 0 ) )
return 0 ;
V_124 = V_9 ;
V_17 = V_9 + V_123 ;
...
case V_107 : {
const char * V_134 = args ;
args += strlen ( V_134 ) + 1 ;
V_124 = string ( V_124 , V_17 , ( char * ) V_134 , V_19 ) ;
break;
}
case V_108 :
V_124 = F_41 ( V_47 + 1 , V_124 , V_17 , F_59 ( void * ) , V_19 ) ;
while ( isalnum ( * V_47 ) )
V_47 ++ ;
break;
case V_110 :
...
break;
case V_118 :
V_15 = F_59 (unsigned char) ;
break;
case V_117 :
V_15 = F_59 (signed char) ;
break;
case V_120 :
V_15 = F_59 (unsigned short) ;
break;
case V_119 :
V_15 = F_59 ( short ) ;
break;
case V_122 :
V_15 = F_59 (unsigned int) ;
break;
default:
V_15 = F_59 ( int ) ;
}
...
int F_60 ( T_6 * V_131 , T_5 V_123 , const char * V_47 , ... )
{
T_4 args ;
int V_135 ;
va_start ( args , V_47 ) ;
V_135 = F_55 ( V_131 , V_123 , V_47 , args ) ;
va_end ( args ) ;
return V_135 ;
}
int vsscanf ( const char * V_9 , const char * V_47 , T_4 args )
{
const char * V_124 = V_9 ;
char * V_136 ;
char V_137 ;
int V_15 = 0 ;
T_2 V_104 ;
...
V_31 = V_139 ;
V_124 = F_61 ( V_124 ) ;
while ( * V_124 && ! isspace ( * V_124 ) && V_31 -- )
* V_7 ++ = * V_124 ++ ;
* V_7 = '\0' ;
V_15 ++ ;
}
...
V_137 = * ( V_124 + 1 ) ;
if ( ! V_137
|| ( V_3 == 16 && ! isxdigit ( V_137 ) )
|| ( V_3 == 10 && ! isdigit ( V_137 ) )
|| ( V_3 == 8 && ( ! isdigit ( V_137 ) || V_137 > '7' ) )
|| ( V_3 == 0 && ! isdigit ( V_137 ) ) )
break;
switch ( V_104 ) {
case 'H' :
...
* V_7 = ( signed char ) F_5 ( V_124 , & V_136 , V_3 ) ;
} else {
unsigned char * V_7 = ( unsigned char * ) va_arg (args, unsigned char *) ;
* V_7 = ( unsigned char ) F_4 ( V_124 , & V_136 , V_3 ) ;
}
break;
case 'h' :
if ( V_138 ) {
short * V_7 = ( short * ) va_arg ( args , short * ) ;
* V_7 = ( short ) F_5 ( V_124 , & V_136 , V_3 ) ;
} else {
unsigned short * V_7 = ( unsigned short * ) va_arg (args, unsigned short *) ;
* V_7 = ( unsigned short ) F_4 ( V_124 , & V_136 , V_3 ) ;
}
break;
case 'l' :
if ( V_138 ) {
long * V_140 = ( long * ) va_arg ( args , long * ) ;
* V_140 = F_5 ( V_124 , & V_136 , V_3 ) ;
} else {
unsigned long * V_140 = ( unsigned long * ) va_arg (args, unsigned long *) ;
* V_140 = F_4 ( V_124 , & V_136 , V_3 ) ;
}
break;
case 'L' :
if ( V_138 ) {
long long * V_140 = ( long long * ) va_arg (args, long long *) ;
* V_140 = F_6 ( V_124 , & V_136 , V_3 ) ;
} else {
unsigned long long * V_140 = ( unsigned long long * ) va_arg (args, unsigned long long *) ;
* V_140 = F_1 ( V_124 , & V_136 , V_3 ) ;
}
break;
case 'Z' :
case 'z' :
...
* V_7 = ( T_5 ) F_4 ( V_124 , & V_136 , V_3 ) ;
}
break;
default:
if ( V_138 ) {
int * V_8 = ( int * ) va_arg ( args , int * ) ;
* V_8 = ( int ) F_5 ( V_124 , & V_136 , V_3 ) ;
} else {
unsigned int * V_8 = ( unsigned int * ) va_arg (args, unsigned int*) ;
* V_8 = ( unsigned int ) F_4 ( V_124 , & V_136 , V_3 ) ;
}
break;
}
V_15 ++ ;
