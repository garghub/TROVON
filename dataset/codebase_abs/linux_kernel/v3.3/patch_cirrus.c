...
unsigned int V_99 = F_82 ( V_2 , V_48 ) ;
V_99 >>= V_164 ;
if ( V_99 & V_165 )
V_162 = V_166 ;
}
...
static void F_92 ( struct V_1 * V_2 , unsigned int V_180 )
{
switch ( F_93 ( V_2 , V_180 >> 26 ) ) {
case V_159 :
F_75 ( V_2 ) ;
break;
case V_167 :
...
static void F_96 ( struct V_1 * V_2 , int V_181 ,
...
static int F_101 ( struct V_88 * V_111 ,
struct V_112 * V_113 )
{
V_113 -> type = V_197 ;
V_113 -> V_115 = 1 ;
...
V_9 &= ~ 0x0010 ;
F_4 ( V_2 , V_204 , V_9 ) ;
if ( ( V_5 -> V_175 || V_5 -> V_151 ) &&
F_35 ( V_2 , V_205 ) ) {
V_203 = F_29 ( V_2 , V_205 ) ;
V_203 &= ~ V_206 ;
V_203 |= ( V_60 << V_207 ) ;
F_97 ( V_2 , V_205 , V_203 ) ;
}
}
...
static int F_107 ( struct V_88 * V_111 ,
struct V_112 * V_113 )
{
struct V_1 * V_2 = F_60 ( V_111 ) ;
struct V_4 * V_5 = V_2 -> V_5 ;
return F_108 ( & V_5 -> V_211 , V_113 ) ;
}
static int F_109 ( struct V_88 * V_111 ,
struct V_120 * V_121 )
{
struct V_1 * V_2 = F_60 ( V_111 ) ;
struct V_4 * V_5 = V_2 -> V_5 ;
...
struct V_1 * V_2 = F_60 ( V_111 ) ;
struct V_4 * V_5 = V_2 -> V_5 ;
return F_111 ( V_2 , & V_5 -> V_211 , V_121 ,
V_5 -> V_22 [ 0 ] , & V_5 -> V_21 ) ;
}
static int F_112 ( struct V_1 * V_2 , int V_119 )
{
struct V_4 * V_5 = V_2 -> V_5 ;
struct V_50 * V_51 = & V_5 -> V_43 ;
...
F_114 ( V_213 , V_132 , V_5 -> V_20 [ V_56 ] , & V_214 ) ;
V_103 = F_112 ( V_2 , V_56 ) ;
if ( V_103 < 0 )
return V_103 ;
}
...
static void F_117 ( struct V_1 * V_2 , unsigned int V_180 )
{
switch ( F_93 ( V_2 , V_180 >> 26 ) ) {
case V_159 :
case V_208 :
...
static int F_120 ( struct V_1 * V_2 , T_3 V_218 )
{
struct V_4 * V_5 = V_2 -> V_5 ;
unsigned int V_9 ;
F_121 ( V_2 ) ;
