...
F_15 ( V_42 ) ;
if ( V_42 -> V_74 . V_75 . V_76 ) {
V_42 -> V_74 . V_75 . V_76 ( V_42 ) ;
if ( V_42 -> V_74 . V_77 ) V_42 -> V_74 . V_77 ( V_42 , 0 ) ;
}
F_1 ( V_2 , 0x82 , 0x0 ) ;
F_11 ( V_2 , 7250 ) ;
...
F_12 ( V_2 , V_63 -> V_31 ) ;
F_8 ( V_2 , V_63 -> V_78 / 1000 ) ;
F_9 ( V_2 , V_69 , V_63 -> V_78 / 1000 ) ;
F_10 ( V_2 , V_70 ) ;
F_13 ( V_2 , V_38 ) ;
if ( V_63 -> V_31 == V_35 ||
V_63 -> V_31 == V_36 )
...
V_83 = F_4 ( V_2 , 0x83 ) ;
V_63 -> V_81 = V_2 -> V_80 ;
V_63 -> V_38 = ( V_83 & 0x08 ) ? V_40 : V_39 ;
if ( V_2 -> V_10 -> V_73 )
V_63 -> V_38 = ( V_63 -> V_38 == V_40 ) ? V_39 : V_40 ;
V_63 -> V_78 = F_7 ( V_2 ) * 1000 ;
V_63 -> V_84 = V_85 ;
switch ( ( V_82 >> 4 ) & 0x7 ) {
case 0 :
V_63 -> V_31 = V_32 ;
...
struct V_41 * F_30 ( const struct V_86 * V_10 ,
struct V_87 * V_14 )
{
struct V_1 * V_2 = NULL ;
V_2 = F_31 ( sizeof( struct V_1 ) , V_88 ) ;
if ( V_2 == NULL )
goto error;
V_2 -> V_10 = V_10 ;
V_2 -> V_14 = V_14 ;
...
goto error;
memcpy ( & V_2 -> V_89 . V_74 , & V_90 , sizeof( struct V_91 ) ) ;
V_2 -> V_89 . V_44 = V_2 ;
return & V_2 -> V_89 ;
error:
F_29 ( V_2 ) ;
