...
static int T_4 F_19 ( struct V_48 * V_49 )
{
struct V_50 * V_7 = V_49 -> V_20 . V_51 ;
struct V_52 * V_20 = & V_49 -> V_20 ;
struct V_1 * V_2 ;
struct V_53 * V_54 ;
struct V_55 * V_56 ;
int V_35 , V_57 ;
V_2 = F_20 ( sizeof( * V_2 ) , V_58 ) ;
if ( ! V_2 ) {
F_13 ( V_20 , L_7 ) ;
return - V_59 ;
}
V_2 -> V_7 = V_7 ? ( * V_7 ) : V_60 ;
V_2 -> V_14 = F_21 () ;
if ( ! V_2 -> V_14 ) {
F_13 ( V_20 , L_8 ) ;
V_35 = - V_59 ;
...
V_2 -> V_14 -> V_62 = F_22 ( V_20 ) ;
V_2 -> V_14 -> V_63 = F_15 ,
V_2 -> V_14 -> V_64 = F_18 ,
V_2 -> V_14 -> V_65 = F_5 ,
V_2 -> V_14 -> V_66 = V_20 ;
V_2 -> V_14 -> V_15 = V_2 ;
snprintf ( V_2 -> V_14 -> V_67 , V_68 , L_9 ,
V_49 -> V_62 , V_49 -> V_67 ) ;
V_2 -> V_6 = F_23 ( V_20 , NULL ) ;
if ( F_24 ( V_2 -> V_6 ) ) {
F_13 ( V_20 , L_10 ) ;
V_35 = F_25 ( V_2 -> V_6 ) ;
V_2 -> V_6 = NULL ;
...
V_2 -> V_20 = V_20 ;
F_28 ( & V_2 -> V_39 ) ;
V_54 = F_29 ( V_49 , V_69 , 0 ) ;
if ( ! V_54 ) {
F_13 ( V_20 , L_11 ) ;
V_35 = - V_70 ;
goto V_61;
}
V_54 = F_30 ( V_20 , V_54 -> V_71 , F_31 ( V_54 ) ,
F_22 ( V_20 ) ) ;
if ( ! V_54 ) {
F_13 ( V_20 , L_12 ) ;
V_35 = - V_72 ;
...
V_2 -> V_11 = F_32 ( V_20 , V_54 -> V_71 , F_31 ( V_54 ) ) ;
if ( ! V_2 -> V_11 ) {
F_13 ( V_20 , L_13 ) ;
V_35 = - V_59 ;
goto V_61;
...
if ( V_35 )
goto V_61;
for ( V_57 = 0 ; V_57 < V_18 ; V_57 ++ ) {
V_56 = V_2 -> V_14 -> V_73 [ V_57 ] ;
if ( V_56 ) {
F_8 ( V_20 , L_14 ,
V_56 -> V_57 , F_22 ( & V_56 -> V_20 ) ,
V_56 -> V_74 ? V_56 -> V_74 -> V_62 : L_15 ) ;
}
}
return 0 ;
V_61:
...
static int F_40 ( struct V_52 * V_20 )
{
struct V_1 * V_2 = F_39 ( V_20 ) ;
T_1 V_75 ;
F_16 ( & V_2 -> V_39 ) ;
V_75 = F_7 ( & V_2 -> V_11 -> V_12 ) ;
V_75 &= ~ V_10 ;
F_3 ( V_75 , & V_2 -> V_11 -> V_12 ) ;
F_14 ( V_2 ) ;
if ( V_2 -> V_6 )
F_35 ( V_2 -> V_6 ) ;
V_2 -> V_40 = true ;
...
static int F_41 ( struct V_52 * V_20 )
{
struct V_1 * V_2 = F_39 ( V_20 ) ;
T_1 V_75 ;
F_16 ( & V_2 -> V_39 ) ;
