...
static int V_76 ( struct V_58 * V_59 , T_2 V_86 , T_3 V_87 ,
T_3 * V_88 , T_4 * V_89 )
{
int V_4 , V_9 ;
volatile char V_3 ;
unsigned char V_90 [ 6 ] , V_91 [ 6 ] ;
struct V_24 * V_41 = V_59 -> V_60 ;
void T_1 * V_1 = V_41 -> V_29 ;
struct V_46 * V_92 = & V_41 -> V_45 [ V_86 >> ( V_41 -> V_39 ) ] ;
if ( V_86 >= V_41 -> V_50 )
return - V_93 ;
if ( V_86 + V_87 > ( ( V_86 | 0x1ff ) + 1 ) )
V_87 = ( ( V_86 | 0x1ff ) + 1 ) - V_86 ;
if ( V_41 -> V_83 != V_92 -> floor ) {
F_10 ( V_1 , V_92 -> floor ) ;
F_9 ( V_1 , V_92 -> V_21 ) ;
} else if ( V_41 -> V_84 != V_92 -> V_21 ) {
F_9 ( V_1 , V_92 -> V_21 ) ;
}
V_41 -> V_83 = V_92 -> floor ;
V_41 -> V_84 = V_92 -> V_21 ;
F_6 ( V_1 , ( V_86 >> 8 ) & 1 , V_31 ) ;
F_8 ( V_1 , 3 , V_86 , V_31 , 0x00 ) ;
F_5 ( V_1 ) ;
F_7 ( V_94 , V_1 , V_95 ) ;
F_7 ( V_96 , V_1 , V_95 ) ;
V_3 = F_2 ( V_1 , V_33 ) ;
...
V_89 [ V_4 ] = F_2 ( V_1 , V_14 + ( V_4 & 0xff ) ) ;
}
#else
F_22 ( V_89 , V_1 + V_97 , V_87 - 1 ) ;
#endif
V_89 [ V_87 - 1 ] = F_2 ( V_1 , V_34 ) ;
* V_88 = V_87 ;
V_9 = 0 ;
V_3 = F_2 ( V_1 , V_33 ) ;
#ifndef F_21
...
#else
F_22 ( V_91 , V_1 + V_97 , 5 ) ;
#endif
V_91 [ 5 ] = F_2 ( V_1 , V_34 ) ;
V_3 = F_2 ( V_1 , V_95 ) ;
V_3 = F_2 ( V_1 , V_95 ) ;
if ( F_2 ( V_1 , V_95 ) & 0x80 ) {
int V_98 ;
#ifdef F_23
F_12 ( L_12 , ( long ) V_86 ) ;
#endif
for ( V_4 = 0 ; V_4 < 6 ; V_4 ++ ) {
V_90 [ V_4 ] = F_2 ( V_1 , V_99 + V_4 ) ;
}
V_98 = F_24 ( V_89 , V_90 ) ;
#ifdef F_23
F_12 ( L_13 , V_98 ) ;
...
#ifdef F_25
F_12 ( L_14 ,
( long ) V_86 , V_91 [ 0 ] , V_91 [ 1 ] , V_91 [ 2 ] , V_91 [ 3 ] ,
V_91 [ 4 ] , V_91 [ 5 ] ) ;
#endif
F_7 ( V_101 , V_1 , V_95 ) ;
return V_9 ;
}
static int V_78 ( struct V_58 * V_59 , T_2 V_102 , T_3 V_87 ,
T_3 * V_88 , const T_4 * V_89 )
{
int V_4 , V_9 = 0 ;
char V_91 [ 6 ] ;
volatile char V_3 ;
struct V_24 * V_41 = V_59 -> V_60 ;
void T_1 * V_1 = V_41 -> V_29 ;
struct V_46 * V_92 = & V_41 -> V_45 [ V_102 >> ( V_41 -> V_39 ) ] ;
if ( V_102 >= V_41 -> V_50 )
return - V_93 ;
#if 0
...
F_6 ( V_1 , V_103 , 0x00 ) ;
F_6 ( V_1 , V_104 , 0x00 ) ;
F_8 ( V_1 , 3 , V_102 , 0x00 , 0x00 ) ;
F_5 ( V_1 ) ;
F_7 ( V_94 , V_1 , V_95 ) ;
F_7 ( V_96 | V_105 , V_1 , V_95 ) ;
#ifndef F_21
for ( V_4 = 0 ; V_4 < V_87 ; V_4 ++ ) {
F_7 ( V_89 [ V_4 ] , V_1 , V_14 + V_4 ) ;
}
#else
F_26 ( V_1 + V_97 , V_89 , V_87 ) ;
#endif
F_7 ( 0x00 , V_1 , V_15 ) ;
F_7 ( 0 , V_1 , V_5 ) ;
F_7 ( 0 , V_1 , V_5 ) ;
...
#ifdef F_25
F_12 ( L_15 ,
( long ) V_102 , V_91 [ 0 ] , V_91 [ 1 ] , V_91 [ 2 ] , V_91 [ 3 ] ,
V_91 [ 4 ] , V_91 [ 5 ] ) ;
#endif
F_6 ( V_1 , V_106 , 0x00 ) ;
F_5 ( V_1 ) ;
...
static int V_80 ( struct V_58 * V_59 , T_2 V_17 ,
struct V_108 * V_109 )
{
#ifndef F_21
int V_4 ;
...
struct V_24 * V_41 = V_59 -> V_60 ;
void T_1 * V_1 = V_41 -> V_29 ;
struct V_46 * V_92 = & V_41 -> V_45 [ V_17 >> V_41 -> V_39 ] ;
T_5 * V_89 = V_109 -> V_110 ;
T_3 V_87 = V_109 -> V_87 ;
F_27 ( V_109 -> V_111 != V_112 ) ;
V_17 += V_109 -> V_113 ;
if ( V_41 -> V_83 != V_92 -> floor ) {
F_10 ( V_1 , V_92 -> floor ) ;
F_9 ( V_1 , V_92 -> V_21 ) ;
...
int V_74 ( struct V_58 * V_59 , struct V_115 * V_116 )
{
volatile char V_3 ;
struct V_24 * V_41 = V_59 -> V_60 ;
T_6 V_17 = V_116 -> V_117 ;
T_6 V_87 = V_116 -> V_87 ;
void T_1 * V_1 = V_41 -> V_29 ;
struct V_46 * V_92 = & V_41 -> V_45 [ V_17 >> V_41 -> V_39 ] ;
if ( V_87 != V_59 -> V_68 )
