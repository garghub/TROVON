...
V_2 -> V_4 = V_4 ;
* V_2 -> V_269 = V_270 ;
V_2 -> V_269 -> V_271 = & V_3 -> V_59 -> V_146 ;
V_55 = F_167 ( V_2 -> V_269 , V_272 ,
V_273 ) ;
if ( V_55 < 0 ) {
F_168 ( V_2 -> V_269 ) ;
F_119 ( V_2 ) ;
...
F_169 ( V_2 -> V_269 , V_2 ) ;
snprintf ( V_2 -> V_269 -> V_178 , sizeof( V_2 -> V_269 -> V_178 ) ,
L_11 , V_37 , V_3 -> V_269 -> V_274 ,
V_2 -> V_269 -> V_274 ) ;
if ( V_273 != - 1 )
V_273 ++ ;
F_170 ( & V_2 -> V_7 ) ;
...
V_3 -> V_39 [ 0 ] -> V_269 -> V_274 ,
V_3 -> V_39 [ V_3 -> V_38 - 1 ] -> V_269 -> V_274 ) ;
return 0 ;
}
