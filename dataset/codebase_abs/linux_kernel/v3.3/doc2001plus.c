...
V_31 -> V_82 = V_81 ;
V_81 = V_29 ;
V_29 -> V_102 = V_31 -> V_72 ;
V_29 -> V_58 = V_31 -> V_58 ;
F_30 ( V_29 , NULL , 0 ) ;
return;
}
}
static int V_93 ( struct V_28 * V_29 , T_2 V_30 , T_4 V_38 ,
T_4 * V_103 , T_3 * V_37 )
{
int V_8 , V_3 ;
volatile char V_44 ;
T_2 V_104 ;
unsigned char V_105 [ 6 ] , V_106 [ 6 ] ;
struct V_17 * V_31 = V_29 -> V_32 ;
void T_1 * V_1 = V_31 -> V_23 ;
struct V_68 * V_107 = & V_31 -> V_67 [ V_30 >> ( V_31 -> V_56 ) ] ;
if ( V_30 >= V_31 -> V_72 )
return - V_108 ;
if ( V_30 + V_38 > ( ( V_30 | 0x1ff ) + 1 ) )
V_38 = ( ( V_30 | 0x1ff ) + 1 ) - V_30 ;
F_7 ( V_1 ) ;
if ( V_31 -> V_100 != V_107 -> floor ) {
F_11 ( V_1 , V_107 -> floor ) ;
F_10 ( V_1 , V_107 -> V_26 ) ;
} else if ( V_31 -> V_101 != V_107 -> V_26 ) {
F_10 ( V_1 , V_107 -> V_26 ) ;
}
V_31 -> V_100 = V_107 -> floor ;
V_31 -> V_101 = V_107 -> V_26 ;
F_2 ( ( V_45 | V_46 ) , V_1 , V_47 ) ;
F_8 ( V_1 , V_48 , 0 ) ;
F_6 ( V_1 ) ;
V_104 = V_30 ;
F_8 ( V_1 , F_12 ( V_29 , & V_104 ) , 0 ) ;
F_9 ( V_31 , 3 , V_104 , 0 , 0x00 ) ;
F_2 ( 0 , V_1 , V_6 ) ;
F_6 ( V_1 ) ;
F_2 ( V_109 , V_1 , V_110 ) ;
F_2 ( V_111 , V_1 , V_110 ) ;
...
F_16 ( V_1 , V_37 , V_38 ) ;
F_16 ( V_1 , V_106 , 4 ) ;
V_106 [ 4 ] = F_5 ( V_1 , V_51 ) ;
V_106 [ 5 ] = F_5 ( V_1 , V_51 ) ;
V_44 = F_5 ( V_1 , V_110 ) ;
V_44 = F_5 ( V_1 , V_110 ) ;
if ( F_5 ( V_1 , V_110 ) & 0x80 ) {
int V_112 ;
#ifdef F_31
F_22 ( L_16 , ( long ) V_30 ) ;
#endif
for ( V_3 = 0 ; V_3 < 6 ; V_3 ++ )
V_105 [ V_3 ] = F_5 ( V_1 , V_113 + V_3 ) ;
V_112 = F_32 ( V_37 , V_105 ) ;
#ifdef F_31
F_22 ( L_17 , V_112 ) ;
#endif
if ( V_112 < 0 ) {
...
F_22 ( L_21
L_20 ,
V_106 [ 0 ] , V_106 [ 1 ] , V_106 [ 2 ] ,
V_106 [ 3 ] , V_106 [ 4 ] , V_106 [ 5 ] ) ;
#endif
V_8 = - V_114 ;
}
}
#ifdef F_33
F_22 ( L_22 ,
( long ) V_30 , V_106 [ 0 ] , V_106 [ 1 ] , V_106 [ 2 ] , V_106 [ 3 ] ,
V_106 [ 4 ] , V_106 [ 5 ] ) ;
#endif
F_2 ( V_115 , V_1 , V_110 ) ;
F_2 ( 0 , V_1 , V_47 ) ;
...
static int V_95 ( struct V_28 * V_29 , T_2 V_116 , T_4 V_38 ,
T_4 * V_103 , const T_3 * V_37 )
{
int V_3 , V_117 , V_8 = 0 ;
T_2 V_118 ;
volatile char V_44 ;
...
struct V_17 * V_31 = V_29 -> V_32 ;
void T_1 * V_1 = V_31 -> V_23 ;
struct V_68 * V_107 = & V_31 -> V_67 [ V_116 >> ( V_31 -> V_56 ) ] ;
if ( V_116 >= V_31 -> V_72 )
return - V_108 ;
if ( ( V_116 & 0x1ff ) || ( V_38 != 0x200 ) )
return - V_108 ;
V_117 = ( V_31 -> V_24 && ( V_116 & 0x200 ) ) ;
F_7 ( V_1 ) ;
if ( V_31 -> V_100 != V_107 -> floor ) {
F_11 ( V_1 , V_107 -> floor ) ;
F_10 ( V_1 , V_107 -> V_26 ) ;
...
F_6 ( V_1 ) ;
V_118 = V_116 ;
F_2 ( F_12 ( V_29 , & V_118 ) , V_1 , V_15 ) ;
if ( V_117 )
V_118 -= 2 ;
F_8 ( V_1 , V_119 , 0x00 ) ;
F_9 ( V_31 , 3 , V_118 , 0x00 , 0x00 ) ;
F_2 ( V_109 , V_1 , V_110 ) ;
if ( V_117 ) {
F_2 ( 0x55 , V_1 , V_39 ) ;
F_2 ( 0x55 , V_1 , V_39 ) ;
}
F_2 ( V_111 | V_120 , V_1 , V_110 ) ;
F_19 ( V_1 , ( unsigned char * ) V_37 , V_38 ) ;
F_1 ( V_1 , 3 ) ;
for ( V_3 = 0 ; V_3 < 6 ; V_3 ++ )
V_106 [ V_3 ] = F_5 ( V_1 , V_113 + V_3 ) ;
F_2 ( V_115 , V_1 , V_110 ) ;
F_19 ( V_1 , V_106 , 6 ) ;
if ( ! V_117 ) {
F_2 ( 0x55 , V_1 , V_39 + 6 ) ;
...
#ifdef F_33
F_22 ( L_23 ,
( long ) V_116 , V_106 [ 0 ] , V_106 [ 1 ] , V_106 [ 2 ] , V_106 [ 3 ] ,
V_106 [ 4 ] , V_106 [ 5 ] ) ;
#endif
F_2 ( 0x00 , V_1 , V_16 ) ;
F_2 ( 0x00 , V_1 , V_16 ) ;
...
static int V_97 ( struct V_28 * V_29 , T_2 V_20 ,
struct V_123 * V_124 )
{
T_2 V_104 , V_125 ;
struct V_17 * V_31 = V_29 -> V_32 ;
void T_1 * V_1 = V_31 -> V_23 ;
struct V_68 * V_107 = & V_31 -> V_67 [ V_20 >> V_31 -> V_56 ] ;
T_4 V_3 , V_102 , V_126 , V_127 ;
T_5 * V_37 = V_124 -> V_128 ;
T_4 V_38 = V_124 -> V_38 ;
F_34 ( V_124 -> V_129 != V_130 ) ;
V_20 += V_124 -> V_131 ;
F_7 ( V_1 ) ;
if ( V_31 -> V_100 != V_107 -> floor ) {
F_11 ( V_1 , V_107 -> floor ) ;
...
F_8 ( V_1 , F_13 ( V_29 , & V_104 ) , 0 ) ;
V_102 = 6 - V_125 ;
} else if ( V_125 < 8 ) {
F_8 ( V_1 , F_14 ( V_29 , & V_104 ) , 0 ) ;
V_102 = 8 - V_125 ;
} else {
F_8 ( V_1 , F_15 ( V_29 , & V_104 ) , 0 ) ;
V_102 = 16 - V_125 ;
}
if ( V_102 > V_127 )
V_102 = V_127 ;
...
F_5 ( V_1 , V_50 ) ;
F_5 ( V_1 , V_50 ) ;
F_16 ( V_1 , & V_37 [ V_126 ] , V_102 - 2 ) ;
V_37 [ V_126 + V_102 - 2 ] = F_5 ( V_1 , V_51 ) ;
V_37 [ V_126 + V_102 - 1 ] = F_5 ( V_1 , V_51 ) ;
V_20 += V_102 ;
V_126 += V_102 ;
V_127 -= V_102 ;
}
...
F_2 ( F_13 ( V_29 , & V_104 ) , V_1 , V_15 ) ;
V_102 = 6 - V_125 ;
} else if ( V_125 < 8 ) {
F_2 ( F_14 ( V_29 , & V_104 ) , V_1 , V_15 ) ;
V_102 = 8 - V_125 ;
} else {
F_2 ( F_15 ( V_29 , & V_104 ) , V_1 , V_15 ) ;
V_102 = 16 - V_125 ;
}
if ( V_102 > V_127 )
V_102 = V_127 ;
...
F_9 ( V_31 , 3 , V_104 , 0 , 0x00 ) ;
F_2 ( V_109 , V_1 , V_110 ) ;
F_19 ( V_1 , ( unsigned char * ) & V_37 [ V_126 ] , V_102 ) ;
F_2 ( 0x00 , V_1 , V_16 ) ;
F_2 ( 0x00 , V_1 , V_16 ) ;
F_8 ( V_1 , V_121 , 0x00 ) ;
F_6 ( V_1 ) ;
...
int V_91 ( struct V_28 * V_29 , struct V_132 * V_133 )
{
volatile char V_44 ;
struct V_17 * V_31 = V_29 -> V_32 ;
T_6 V_20 = V_133 -> V_134 ;
T_6 V_38 = V_133 -> V_38 ;
void T_1 * V_1 = V_31 -> V_23 ;
struct V_68 * V_107 = & V_31 -> V_67 [ V_20 >> V_31 -> V_56 ] ;
F_7 ( V_1 ) ;
