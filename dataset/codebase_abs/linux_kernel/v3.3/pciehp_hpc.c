...
int V_101 ;
T_1 V_102 ;
struct V_5 * V_103 = V_2 -> V_7 -> V_8 ;
if ( ! V_104 )
return;
F_70 ( V_2 , L_31 ) ;
F_70 ( V_2 , L_32 ,
F_71 ( V_103 ) , V_103 -> V_18 ) ;
F_70 ( V_2 , L_33 , V_103 -> V_105 ) ;
F_70 ( V_2 , L_34 , V_103 -> V_106 ) ;
F_70 ( V_2 , L_35 ,
V_103 -> V_107 ) ;
F_70 ( V_2 , L_36 ,
V_103 -> V_108 ) ;
...
continue;
F_70 ( V_2 , L_38 ,
V_101 , & V_103 -> V_110 [ V_101 ] ) ;
}
F_70 ( V_2 , L_39 , V_2 -> V_111 ) ;
...
struct V_1 * F_79 ( struct V_112 * V_6 )
{
struct V_1 * V_2 ;
T_2 V_111 , V_113 ;
struct V_5 * V_103 = V_6 -> V_8 ;
V_2 = F_62 ( sizeof( * V_2 ) , V_95 ) ;
if ( ! V_2 ) {
F_80 ( & V_6 -> V_106 , L_53 , V_36 ) ;
goto abort;
}
V_2 -> V_7 = V_6 ;
if ( ! F_3 ( V_103 ) ) {
...
F_57 ( V_2 ) ;
F_70 ( V_2 , L_57 ,
V_103 -> V_105 , V_103 -> V_106 , V_103 -> V_108 ,
V_103 -> V_107 ) ;
if ( F_61 ( V_2 ) )
goto V_114;
return V_2 ;
