...
return - V_27 ;
if ( F_149 ( & V_227 , V_225 , sizeof( V_227 ) ) )
return - V_239 ;
if ( V_227 . V_80 >= V_164 )
return - V_219 ;
F_42 () ;
...
return - V_27 ;
if ( F_149 ( & V_214 , V_225 , sizeof( V_214 ) ) )
return - V_239 ;
F_42 () ;
if ( V_224 == V_241 )
...
int F_151 ( struct V_196 * V_223 , int V_224 , char V_84 * V_225 , int V_84 * V_226 )
{
int V_248 ;
int V_249 ;
struct V_2 * V_2 = F_138 ( V_223 ) ;
...
V_224 != V_242 )
return - V_235 ;
if ( F_150 ( V_248 , V_226 ) )
return - V_239 ;
V_248 = F_152 (unsigned int, olr, sizeof(int)) ;
if ( V_248 < 0 )
return - V_27 ;
if ( F_153 ( V_248 , V_226 ) )
return - V_239 ;
if ( V_224 == V_250 )
V_249 = 0x0305 ;
#ifdef F_26
...
V_249 = V_4 -> V_243 ;
if ( F_154 ( V_225 , & V_249 , V_248 ) )
return - V_239 ;
return 0 ;
}
int F_155 ( struct V_196 * V_223 , int V_251 , void V_84 * V_10 )
{
struct V_252 V_253 ;
struct V_254 V_255 ;
struct V_127 * V_227 ;
...
switch ( V_251 ) {
case V_256 :
if ( F_149 ( & V_255 , V_10 , sizeof( V_255 ) ) )
return - V_239 ;
...
F_48 ( & V_104 ) ;
if ( F_154 ( V_10 , & V_255 , sizeof( V_255 ) ) )
return - V_239 ;
return 0 ;
}
F_48 ( & V_104 ) ;
return - V_129 ;
case V_261 :
if ( F_149 ( & V_253 , V_10 , sizeof( V_253 ) ) )
return - V_239 ;
F_54 () ;
...
F_56 () ;
if ( F_154 ( V_10 , & V_253 , sizeof( V_253 ) ) )
return - V_239 ;
return 0 ;
}
F_56 () ;
...
int F_156 ( struct V_196 * V_223 , unsigned int V_251 , void V_84 * V_10 )
{
struct V_269 V_253 ;
struct V_270 V_255 ;
struct V_127 * V_227 ;
...
static int F_157 ( struct V_271 * V_272 , unsigned long V_273 , void * V_274 )
{
...
F_160 ( V_69 ) ;
memset ( & ( F_161 ( V_33 ) -> V_281 ) , 0 , sizeof( F_161 ( V_33 ) -> V_281 ) ) ;
F_162 ( V_33 ) ;
}
static inline int F_163 ( struct V_32 * V_33 )
{
struct V_282 * V_281 = & ( F_161 ( V_33 ) -> V_281 ) ;
F_164 ( F_30 ( F_115 ( V_33 ) -> V_60 ) , V_283 ) ;
if ( F_165 ( V_281 -> V_226 ) )
F_166 ( V_33 ) ;
return F_167 ( V_33 ) ;
}
...
if ( V_33 -> V_107 + V_286 > F_171 ( & V_285 -> V_288 ) && ( F_110 ( V_69 -> V_280 ) & V_289 ) ) {
F_164 ( F_30 ( V_60 ) , V_290 ) ;
F_172 ( V_285 ) ;
goto V_287;
}
...
F_176 ( F_74 ( V_33 ) ) ;
if ( V_227 -> V_19 & V_133 ) {
F_158 ( V_33 , V_227 -> V_174 , V_227 -> V_175 ) ;
V_227 -> V_60 -> V_105 . V_108 ++ ;
V_227 -> V_60 -> V_105 . V_106 += V_33 -> V_107 ;
}
F_161 ( V_33 ) -> V_19 |= V_292 ;
...
F_199 ( V_33 , V_335 , 4 , & V_4 -> V_130 [ V_137 -> V_210 ] . V_60 -> V_99 ) ;
...
V_329 -> V_357 = 0 ;
V_329 -> V_358 = V_4 -> V_3 ;
F_208 ( V_33 , V_359 , V_4 -> V_3 ) ;
V_329 -> V_344 = V_345 ;
V_329 -> V_360 = V_361 ;
V_329 -> V_362 = V_363 ;
V_329 -> V_347 = 0 ;
F_209 ( V_33 , V_364 , V_137 -> V_186 ) ;
F_209 ( V_33 , V_365 , V_137 -> V_187 ) ;
...
return F_226 ( V_214 -> V_50 . V_49 , struct V_136 , V_50 ) ;
if ( V_388 -> V_161 == & V_4 -> V_55 )
goto V_389;
F_227 ( V_388 -> V_161 != & V_4 -> V_54 [ V_388 -> V_275 ] ) ;
