...
struct V_6 * F_81 ( void * V_88 ,
int (* F_82)( struct V_6 * V_7 , void * V_88 ) )
{
struct V_6 * V_7 = NULL ;
unsigned long V_11 ;
int V_16 ;
...
int F_88 ( const struct V_8 * V_98 , T_3 V_99 )
{
int V_16 , V_27 ;
for ( V_16 = 0 ; V_16 < V_99 ; V_16 ++ , V_98 ++ ) {
V_27 = F_87 ( V_98 -> V_8 , V_98 -> V_11 , V_98 -> V_3 ) ;
if ( V_27 )
goto V_100;
}
return 0 ;
...
void F_89 ( const struct V_8 * V_98 , T_3 V_99 )
{
while ( V_99 -- )
F_55 ( ( V_98 ++ ) -> V_8 ) ;
}
...
int F_93 ( unsigned V_8 , unsigned V_104 )
{
unsigned long V_11 ;
struct V_6 * V_7 ;
struct V_1 * V_4 = & V_1 [ V_8 ] ;
...
F_17 ( & V_25 , V_11 ) ;
F_86 ( V_7 -> V_95 ) ;
return V_7 -> V_105 ( V_7 , V_8 , V_104 ) ;
V_93:
F_17 ( & V_25 , V_11 ) ;
if ( V_33 )
F_13 ( L_29 ,
...
V_7 = F_9 ( V_8 ) ;
F_85 ( V_7 -> V_95 ) ;
V_38 = V_7 -> V_101 ? V_7 -> V_101 ( V_7 , V_8 - V_7 -> V_9 ) : 0 ;
F_92 ( V_8 , 1 , V_38 ) ;
return V_38 ;
}
void F_95 ( unsigned V_8 , int V_38 )
{
struct V_6 * V_7 ;
V_7 = F_9 ( V_8 ) ;
F_85 ( V_7 -> V_95 ) ;
F_92 ( V_8 , 0 , V_38 ) ;
V_7 -> V_103 ( V_7 , V_8 - V_7 -> V_9 , V_38 ) ;
}
int F_96 ( unsigned V_8 )
{
struct V_6 * V_7 ;
V_7 = F_9 ( V_8 ) ;
return V_7 -> V_95 ;
...
struct V_6 * V_7 ;
V_7 = F_9 ( V_8 ) ;
return V_7 -> V_106 ? V_7 -> V_106 ( V_7 , V_8 - V_7 -> V_9 ) : - V_107 ;
}
...
static void F_98 ( struct V_108 * V_109 , struct V_6 * V_7 )
{
unsigned V_16 ;
unsigned V_8 = V_7 -> V_9 ;
struct V_1 * V_110 = & V_1 [ V_8 ] ;
int V_111 ;
for ( V_16 = 0 ; V_16 < V_7 -> V_15 ; V_16 ++ , V_8 ++ , V_110 ++ ) {
if ( ! F_11 ( V_10 , & V_110 -> V_11 ) )
continue;
V_111 = F_11 ( V_36 , & V_110 -> V_11 ) ;
F_99 ( V_109 , L_30 ,
V_8 , V_110 -> V_3 ,
V_111 ? L_7 : L_31 ,
V_7 -> V_101
? ( V_7 -> V_101 ( V_7 , V_16 ) ? L_32 : L_33 )
: L_34 ) ;
F_99 ( V_109 , L_35 ) ;
}
}
static int F_100 ( struct V_108 * V_109 , void * V_112 )
{
struct V_6 * V_7 = NULL ;
unsigned V_8 ;
int V_113 = 0 ;
...
if ( V_29 )
F_99 ( V_109 , L_37 ,
V_29 -> V_114 ? V_29 -> V_114 -> V_69 : L_38 ,
F_101 ( V_29 ) ) ;
if ( V_7 -> V_3 )
F_99 ( V_109 , L_39 , V_7 -> V_3 ) ;
if ( V_7 -> V_95 )
F_99 ( V_109 , L_40 ) ;
F_99 ( V_109 , L_41 ) ;
V_113 = 1 ;
...
static int F_102 ( struct V_116 * V_116 , struct V_117 * V_117 )
{
return F_103 ( V_117 , F_100 , NULL ) ;
}
static int T_1 F_104 ( void )
{
( void ) F_105 ( L_42 , V_118 | V_119 ,
NULL , NULL , & V_120 ) ;
return 0 ;
}
