...
if ( V_48 == V_42 -> V_27 )
V_1 = F_31 ( V_42 -> V_38 , sizeof( * V_1 ) , V_61 ) ;
else
V_1 = F_32 ( sizeof( * V_1 ) , V_61 ) ;
if ( ! V_1 ) {
V_45 = - V_62 ;
goto V_50;
}
...
int F_38 ( void * V_3 , struct V_43 * * V_67 )
{
int V_45 , V_18 ;
struct V_43 * V_43 ;
* V_67 = NULL ;
V_43 = F_32 ( sizeof( * V_43 ) , V_61 ) ;
if ( ! V_43 )
return - V_62 ;
...
( (struct V_3 * ) V_3 ) -> F_37 ( V_3 , V_43 -> V_44 . V_5 ) ;
* V_67 = V_43 ;
return 0 ;
V_50:
F_33 ( V_43 ) ;
...
int F_42 ( struct V_43 * V_43 )
{
F_43 ( & V_43 -> V_44 ) ;
F_33 ( V_43 ) ;
return 0 ;
}
static int F_44 ( struct V_4 * V_4 )
{
V_4 -> V_70 = 0 ;
return V_4 -> V_40 = F_45 ( V_4 , struct V_71 , V_4 ) -> V_40 [ 0 ] ;
}
static int F_46 ( struct V_4 * V_4 )
{
V_4 -> V_70 ++ ;
return F_45 ( V_4 , struct V_71 , V_4 ) -> V_40 [ V_4 -> V_70 ] ;
}
static int F_47 ( const struct V_4 * V_4 )
{
return F_45 ( V_4 , struct V_71 , V_4 ) -> V_40 [ V_4 -> V_70 ] ;
}
static int F_48 ( struct V_71 * V_71 , struct V_1 * V_1 , struct V_4 * V_72 )
{
struct V_73 * V_74 ;
int V_18 ;
...
if ( V_45 )
return V_45 ;
V_71 -> V_75 = F_32 ( sizeof( struct V_73 ) * V_42 -> V_22 ,
V_61 ) ;
if ( ! V_71 -> V_75 ) {
V_45 = - V_62 ;
goto V_50;
...
F_34 ( & V_44 -> V_44 , 1 , V_71 -> V_40 [ V_18 ] ) ;
F_29 ( & V_44 -> V_59 , V_58 ) ;
F_33 ( V_71 ) ;
return V_45 ;
}
static int F_53 ( struct V_84 * V_44 , struct V_71 * V_71 )
{
unsigned long V_58 ;
int V_18 ;
F_27 ( & V_44 -> V_59 , V_58 ) ;
...
static int F_54 ( void * V_89 , struct V_73 * V_74 )
{
...
static int F_55 ( struct V_84 * V_44 , struct V_73 * V_74 )
{
unsigned long V_58 ;
int V_45 ;
F_27 ( & V_44 -> V_97 , V_58 ) ;
...
V_45 = F_57 ( & V_44 -> V_75 , V_74 , F_54 , V_44 ) ;
F_29 ( & V_44 -> V_97 , V_58 ) ;
return V_45 ;
}
static int F_58 ( struct V_84 * V_44 , struct V_73 * V_74 )
{
unsigned long V_58 ;
int V_45 ;
F_27 ( & V_44 -> V_97 , V_58 ) ;
V_45 = F_56 ( & V_44 -> V_75 , V_74 , F_54 , V_44 ) ;
if ( F_59 ( & V_44 -> V_75 ) ) {
F_57 ( & V_44 -> V_75 , V_44 -> V_99 ,
F_54 , V_44 ) ;
V_44 -> V_98 = 1 ;
}
F_29 ( & V_44 -> V_97 , V_58 ) ;
...
int F_60 ( void * V_3 , struct V_84 * * V_100 )
{
int V_45 ;
struct V_84 * V_84 ;
struct V_73 * V_74 ;
* V_100 = NULL ;
V_84 = F_32 ( sizeof( * V_84 ) , V_61 ) ;
if ( ! V_84 )
return - V_62 ;
V_45 = F_39 ( & V_84 -> V_44 , V_85 , V_101 , V_3 ) ;
if ( V_45 )
goto V_50;
F_40 ( & V_84 -> V_59 ) ;
F_40 ( & V_84 -> V_97 ) ;
F_61 ( & V_84 -> V_75 ) ;
V_74 = F_32 ( sizeof( * V_74 ) , V_61 ) ;
if ( ! V_74 ) {
V_45 = - V_62 ;
goto V_63;
}
V_74 -> V_76 = V_74 -> V_79 = V_74 -> V_94 = V_74 -> V_78 = 0 ;
F_62 ( & V_74 -> V_102 , & V_84 -> V_75 ) ;
V_84 -> V_99 = V_74 ;
V_84 -> V_98 = 1 ;
V_84 -> V_103 = F_52 ;
V_84 -> V_104 = F_53 ;
