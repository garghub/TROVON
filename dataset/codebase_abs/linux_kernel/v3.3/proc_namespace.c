...
{
struct V_3 * V_4 = V_13 -> V_57 ;
struct V_44 * V_45 = F_14 ( V_31 ) ;
struct V_19 * V_20 = V_31 -> V_58 ;
struct V_47 V_48 = { . V_49 = V_31 -> V_50 , . V_31 = V_31 } ;
struct V_47 V_59 = V_4 -> V_59 ;
int V_46 = 0 ;
F_18 ( V_13 , L_15 , V_45 -> V_60 , V_45 -> V_61 -> V_60 ,
F_19 ( V_20 -> V_62 ) , F_20 ( V_20 -> V_62 ) ) ;
if ( V_20 -> V_52 -> V_63 )
V_46 = V_20 -> V_52 -> V_63 ( V_13 , V_31 -> V_50 ) ;
else
F_21 ( V_13 , V_31 -> V_50 , L_10 ) ;
if ( V_46 )
goto V_54;
F_12 ( V_13 , ' ' ) ;
V_46 = F_22 ( V_13 , & V_48 , & V_59 , L_10 ) ;
if ( V_46 )
goto V_54;
F_6 ( V_13 , V_31 -> V_39 & V_64 ? L_12 : L_13 ) ;
F_8 ( V_13 , V_31 ) ;
if ( F_23 ( V_45 ) )
F_18 ( V_13 , L_16 , V_45 -> V_65 ) ;
if ( F_24 ( V_45 ) ) {
int V_66 = V_45 -> V_67 -> V_65 ;
int V_68 = F_25 ( V_45 , & V_4 -> V_59 ) ;
F_18 ( V_13 , L_17 , V_66 ) ;
if ( V_68 && V_68 != V_66 )
F_18 ( V_13 , L_18 , V_68 ) ;
}
...
if ( V_46 )
goto V_54;
F_6 ( V_13 , V_20 -> V_28 & V_69 ? L_12 : L_13 ) ;
V_46 = F_5 ( V_13 , V_20 ) ;
if ( V_46 )
goto V_54;
if ( V_20 -> V_52 -> V_56 )
...
F_12 ( V_13 , ' ' ) ;
if ( ! V_46 )
V_46 = V_20 -> V_52 -> V_70 ( V_13 , V_48 . V_49 ) ;
}
F_12 ( V_13 , '\n' ) ;
return V_46 ;
}
static int F_28 ( struct V_71 * V_71 , struct V_1 * V_1 ,
int (* F_29)( struct V_18 * , struct V_30 * ) )
{
struct V_72 * V_73 = F_30 ( V_71 ) ;
struct V_74 * V_75 ;
struct V_6 * V_7 = NULL ;
struct V_47 V_59 ;
struct V_3 * V_4 ;
...
F_34 ( V_73 ) ;
V_76 = - V_82 ;
V_4 = F_39 ( sizeof( struct V_3 ) , V_83 ) ;
if ( ! V_4 )
goto V_84;
V_1 -> V_5 = & V_4 -> V_13 ;
V_76 = F_40 ( V_1 , & V_85 ) ;
...
static int F_44 ( struct V_71 * V_71 , struct V_1 * V_1 )
{
struct V_3 * V_4 = V_1 -> V_5 ;
F_42 ( & V_4 -> V_59 ) ;
F_43 ( V_4 -> V_7 ) ;
return F_45 ( V_71 , V_1 ) ;
}
static int F_46 ( struct V_71 * V_71 , struct V_1 * V_1 )
{
return F_28 ( V_71 , V_1 , F_13 ) ;
}
static int F_47 ( struct V_71 * V_71 , struct V_1 * V_1 )
{
return F_28 ( V_71 , V_1 , F_17 ) ;
}
static int F_48 ( struct V_71 * V_71 , struct V_1 * V_1 )
{
return F_28 ( V_71 , V_1 , F_27 ) ;
}
