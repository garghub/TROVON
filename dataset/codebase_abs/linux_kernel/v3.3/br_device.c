...
static void F_52 ( struct V_3 * V_4 , struct V_50 * V_51 )
{
...
{
struct V_5 * V_6 = F_2 ( V_4 ) ;
return F_54 ( V_6 , V_57 ) ;
}
static void F_55 ( struct V_3 * V_58 )
{
}
...
static int F_59 ( struct V_3 * V_4 , struct V_61 * V_62 )
{
struct V_5 * V_6 = F_2 ( V_4 ) ;
struct V_59 * V_41 , * V_60 ;
int V_63 = 0 ;
...
int F_60 ( struct V_59 * V_41 )
{
struct V_65 * V_66 ;
int V_63 = 0 ;
V_66 = F_61 ( sizeof( * V_41 -> V_66 ) , V_67 ) ;
V_63 = - V_27 ;
if ( ! V_66 )
goto V_26;
V_66 -> V_4 = V_41 -> V_4 ;
F_62 ( V_66 -> V_68 , V_41 -> V_4 -> V_69 , V_70 ) ;
V_63 = F_63 ( V_66 ) ;
if ( V_63 ) {
F_64 ( V_66 ) ;
goto V_26;
...
static int F_69 ( struct V_3 * V_4 , struct V_3 * V_71 )
{
struct V_5 * V_6 = F_2 ( V_4 ) ;
return F_70 ( V_6 , V_71 ) ;
}
...
V_6 -> V_97 = V_98 ;
V_6 -> V_99 = V_6 -> V_91 ;
V_6 -> V_100 = V_6 -> V_101 = 20 * V_102 ;
V_6 -> V_103 = V_6 -> V_104 = 2 * V_102 ;
V_6 -> V_105 = V_6 -> V_106 = 15 * V_102 ;
V_6 -> V_107 = 300 * V_102 ;
F_81 ( V_6 ) ;
F_82 ( V_6 ) ;
F_83 ( V_6 ) ;
