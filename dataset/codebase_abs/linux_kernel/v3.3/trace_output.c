...
* V_95 = F_48 ( V_11 , NULL ,
& V_94 ) ;
unsigned long V_96 = ( V_61 & V_97 ) ;
unsigned long V_85 = F_45 ( V_11 -> V_89 - V_11 -> V_98 -> V_99 ) ;
unsigned long V_86 ;
if ( ! V_95 )
V_94 = V_11 -> V_89 ;
V_86 = F_45 ( V_94 - V_11 -> V_89 ) ;
if ( V_96 ) {
char V_82 [ V_83 ] ;
F_42 ( V_14 -> V_84 , V_82 ) ;
V_7 = F_8 ( V_4 , L_22
...
static int F_49 ( unsigned long V_102 )
{
int V_103 = V_102 ? F_50 ( V_102 ) + 1 : 0 ;
return V_103 < sizeof( V_104 ) - 1 ? V_104 [ V_103 ] : '?' ;
}
struct V_105 * F_51 ( int type )
{
struct V_105 * V_106 ;
struct V_107 * V_108 ;
unsigned V_109 ;
...
if ( F_60 ( F_51 ( V_106 -> type ) ) )
goto V_119;
F_62 ( & V_106 -> V_112 , V_112 ) ;
} else if ( V_106 -> type > V_115 ) {
F_63 ( V_122 L_24 ) ;
F_60 ( 1 ) ;
goto V_119;
} else {
...
if ( V_106 -> V_120 -> V_123 == NULL )
V_106 -> V_120 -> V_123 = V_124 ;
if ( V_106 -> V_120 -> V_125 == NULL )
V_106 -> V_120 -> V_125 = V_124 ;
if ( V_106 -> V_120 -> V_126 == NULL )
V_106 -> V_120 -> V_126 = V_124 ;
if ( V_106 -> V_120 -> V_25 == NULL )
V_106 -> V_120 -> V_25 = V_124 ;
V_109 = V_106 -> type & ( V_110 - 1 ) ;
F_64 ( & V_106 -> V_127 , & V_128 [ V_109 ] ) ;
V_7 = V_106 -> type ;
V_119:
F_65 ( & V_118 ) ;
return V_7 ;
}
int F_66 ( struct V_105 * V_106 )
{
F_67 ( & V_106 -> V_127 ) ;
F_68 ( & V_106 -> V_112 ) ;
return 0 ;
...
enum V_9 V_124 ( struct V_10 * V_11 , int V_32 ,
struct V_105 * V_106 )
{
if ( ! F_8 ( & V_11 -> V_12 , L_25 , V_11 -> V_15 -> type ) )
return V_20 ;
return V_21 ;
}
...
int V_134 , V_135 ;
F_5 ( V_17 , V_11 -> V_15 ) ;
V_135 = F_49 ( V_17 -> V_136 ) ;
V_134 = F_49 ( V_17 -> V_137 ) ;
F_42 ( V_17 -> V_138 , V_82 ) ;
if ( ! F_8 ( & V_11 -> V_12 ,
L_28 ,
V_17 -> V_139 ,
V_17 -> V_140 ,
...
int V_32 , struct V_105 * V_106 )
{
return F_76 ( V_11 , L_30 ) ;
}
static int F_79 ( struct V_10 * V_11 , char V_134 )
{
struct V_133 * V_17 ;
int V_135 ;
F_5 ( V_17 , V_11 -> V_15 ) ;
...
static int F_82 ( struct V_10 * V_11 , char V_134 )
{
struct V_133 * V_17 ;
struct V_3 * V_4 = & V_11 -> V_12 ;
int V_135 ;
...
unsigned long * V_144 ;
F_5 ( V_17 , V_11 -> V_15 ) ;
V_144 = ( unsigned long * ) ( ( long ) V_11 -> V_15 + V_11 -> V_145 ) ;
if ( ! F_11 ( V_4 , L_32 ) )
goto V_130;
for ( V_30 = V_17 -> V_67 ; V_30 && * V_30 != V_68 && V_30 < V_144 ; V_30 ++ ) {
if ( ! F_11 ( V_4 , L_13 ) )
goto V_130;
...
struct V_22 * V_17 ;
F_5 ( V_17 , V_11 -> V_15 ) ;
if ( ! F_8 ( & V_11 -> V_12 , L_37 , V_17 -> V_48 , V_17 -> V_19 ) )
goto V_130;
return V_21 ;
V_130:
return V_20 ;
