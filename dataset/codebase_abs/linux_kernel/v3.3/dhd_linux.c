...
int
F_67 ( struct V_75 * V_63 , int V_12 , char * V_3 , T_4 * V_148 )
{
struct V_6 * V_7 ;
struct V_15 * V_9 ;
struct V_76 * V_48 = F_30 ( V_63 ) ;
...
V_9 = F_70 ( sizeof( struct V_6 ) , V_3 , V_149 ) ;
if ( ! V_9 ) {
F_2 ( ERROR , L_45 ) ;
return - V_70 ;
}
...
V_7 -> V_65 = V_12 ;
if ( V_148 != NULL )
memcpy ( & V_7 -> V_148 , V_148 , V_31 ) ;
if ( F_71 ( V_2 , V_7 -> V_65 ) ) {
F_2 ( ERROR , L_46 ) ;
F_69 ( V_7 -> V_9 ) ;
V_2 -> V_8 [ V_12 ] = NULL ;
return - V_109 ;
...
F_2 ( V_11 , L_47 ,
V_150 -> V_151 , V_7 -> V_9 -> V_3 ) ;
return 0 ;
}
void F_72 ( struct V_1 * V_2 , int V_12 )
{
struct V_6 * V_7 ;
F_2 ( V_11 , L_43 , V_12 ) ;
V_7 = V_2 -> V_8 [ V_12 ] ;
...
int F_76 ( T_3 V_154 , struct V_75 * V_63 )
{
struct V_1 * V_2 = NULL ;
int V_27 = 0 ;
F_2 ( V_11 , L_17 ) ;
V_2 = F_77 ( sizeof( struct V_1 ) , V_32 ) ;
if ( ! V_2 )
return - V_70 ;
F_78 ( & V_2 -> V_155 ) ;
V_2 -> V_66 = V_154 ;
...
F_12 ( L_53 , V_2 -> V_160 , V_158 ,
V_157 , sizeof( V_157 ) ) ;
F_82 ( V_2 , 0 , V_107 , V_157 ,
sizeof( V_157 ) ) ;
memcpy ( V_2 -> V_160 , V_157 , V_158 ) ;
F_83 ( V_2 -> V_160 , V_161 ) ;
F_83 ( V_2 -> V_160 , V_162 ) ;
F_83 ( V_2 -> V_160 , V_163 ) ;
F_83 ( V_2 -> V_160 , V_164 ) ;
F_83 ( V_2 -> V_160 , V_165 ) ;
F_83 ( V_2 -> V_160 , V_166 ) ;
F_83 ( V_2 -> V_160 , V_167 ) ;
F_83 ( V_2 -> V_160 , V_168 ) ;
F_83 ( V_2 -> V_160 , V_169 ) ;
F_83 ( V_2 -> V_160 , V_170 ) ;
F_83 ( V_2 -> V_160 , V_171 ) ;
F_83 ( V_2 -> V_160 , V_172 ) ;
F_83 ( V_2 -> V_160 , V_173 ) ;
F_83 ( V_2 -> V_160 , V_174 ) ;
F_83 ( V_2 -> V_160 , V_175 ) ;
F_83 ( V_2 -> V_160 , V_176 ) ;
F_83 ( V_2 -> V_160 , V_177 ) ;
F_83 ( V_2 -> V_160 , V_178 ) ;
V_2 -> V_179 = 1 ;
V_2 -> V_180 [ 0 ] = L_54 ;
V_27 = F_84 ( V_2 ) ;
if ( V_27 < 0 )
...
int F_71 ( struct V_1 * V_2 , int V_12 )
{
struct V_15 * V_9 ;
T_4 V_181 [ V_31 ] = {
...
V_9 -> V_152 = & V_153 ;
if ( V_12 != 0 ) {
memcpy ( V_181 , V_2 -> V_147 , V_31 ) ;
}
if ( V_12 == 1 ) {
F_2 ( V_11 , L_55 ) ;
V_181 [ 0 ] |= 0X02 ;
}
V_9 -> V_182 = V_91 + V_2 -> V_66 ;
V_9 -> V_183 = & V_184 ;
V_2 -> V_185 = V_9 -> V_186 + V_9 -> V_182 +
V_2 -> V_66 ;
memcpy ( V_9 -> V_42 , V_181 , V_31 ) ;
if ( ! V_12 ) {
V_2 -> V_146 = F_85 ( V_9 , V_2 -> V_63 , V_2 ) ;
if ( V_2 -> V_146 == NULL ) {
F_2 ( ERROR , L_56 ) ;
goto V_156;
}
...
if ( V_2 ) {
F_88 ( V_2 ) ;
V_2 -> V_48 -> V_188 ( V_2 -> V_63 ) ;
}
}
void F_81 ( struct V_75 * V_63 )
{
int V_4 ;
struct V_76 * V_48 = F_30 ( V_63 ) ;
struct V_1 * V_2 = V_48 -> V_2 ;
...
{
return F_92 ( & V_2 -> V_61 ) ;
}
int F_59 ( struct V_15 * V_9 )
{
struct V_6 * V_7 = F_16 ( V_9 ) ;
struct V_1 * V_2 = V_7 -> V_2 ;
int V_190 = 10 * V_191 / 1000 ;
int V_192 = V_193 ;
int V_194 = F_91 ( V_2 ) ;
while ( V_192 && V_194 ) {
if ( V_194 ) {
...
int F_95 ( struct V_1 * V_2 , const T_4 * V_24 , int V_197 )
{
int V_27 = 0 ;
struct V_198 * V_199 ;
T_8 V_200 ;
...
V_200 = F_96 () ;
F_97 ( V_202 ) ;
V_199 = F_98 ( L_59 , V_203 | V_204 , 0640 ) ;
if ( ! V_199 ) {
F_2 ( ERROR , L_60 ) ;
V_27 = - 1 ;
goto exit;
}
V_199 -> V_205 -> V_206 ( V_199 , ( char T_6 * ) V_24 , V_197 , & V_201 ) ;
exit:
F_11 ( V_24 ) ;
if ( V_199 )
F_99 ( V_199 , V_150 -> V_207 ) ;
F_97 ( V_200 ) ;
return V_27 ;
}
