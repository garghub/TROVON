...
char V_125 [ 30 ] ;
return snprintf ( V_7 , V_114 , L_37 ,
V_11 -> V_15 -> V_32 -> V_126 ( V_11 , V_125 ) ) ;
}
static T_1
...
V_138 = V_140 ;
if ( V_138 != V_140 || V_14 -> V_138 != V_140 ) {
V_14 -> V_138 = V_138 ;
F_18 ( V_29 , & V_11 -> V_30 ) ;
}
return strlen ( V_7 ) ;
...
{
T_7 * V_11 = F_2 ( F_66 ( V_86 ) ) ;
return snprintf ( V_7 , V_114 , L_53 , V_11 -> V_15 -> V_142 * 100 ) ;
}
static T_1
...
return - V_39 ;
if ( V_56 )
V_16 = V_14 -> V_32 -> V_145 ( V_11 ) ;
else
V_16 = V_14 -> V_32 -> V_112 ( V_11 ) ;
if ( V_16 != V_42 )
V_9 = 0 ;
return V_9 ;
}
...
static T_1
F_97 ( struct V_12 * V_86 , struct V_113 * V_109 ,
char * V_7 )
{
T_7 * V_11 = F_2 ( F_66 ( V_86 ) ) ;
struct V_13 * V_14 = V_11 -> V_15 ;
...
static T_1
F_99 ( struct V_12 * V_86 , struct V_113 * V_109 ,
char * V_7 )
{
T_7 * V_11 = F_2 ( F_66 ( V_86 ) ) ;
if ( ! F_37 ( V_11 -> V_15 ) )
...
static T_1
F_101 ( struct V_12 * V_86 , struct V_113 * V_109 ,
char * V_7 )
{
T_7 * V_11 = F_2 ( F_66 ( V_86 ) ) ;
...
V_16 = F_103 ( V_11 , & V_164 , & V_165 ) ;
if ( V_16 != V_42 )
V_164 = V_165 = 0 ;
return snprintf ( V_7 , V_114 , L_56 , V_164 , V_165 ) ;
}
static T_1
F_104 ( struct V_12 * V_86 , struct V_113 * V_109 ,
char * V_7 )
{
T_7 * V_11 = F_2 ( F_66 ( V_86 ) ) ;
int V_16 = V_163 ;
...
static void
F_106 ( struct V_102 * V_170 )
{
T_7 * V_11 = F_2 ( V_170 ) ;
F_107 ( V_170 ) = V_11 -> V_171 . V_172 . V_173 << 16 |
V_11 -> V_171 . V_172 . V_174 << 8 | V_11 -> V_171 . V_172 . V_175 ;
}
static void
F_108 ( struct V_102 * V_170 )
{
...
static void
F_112 ( struct V_197 * V_198 )
{
struct V_102 * V_83 = F_3 ( V_198 -> V_86 . V_199 ) ;
T_7 * V_11 = F_2 ( V_83 ) ;
T_9 * V_200 ;
T_10 V_201 = 0 ;
F_113 (fcport, &vha->vp_fcports, list) {
if ( V_200 -> V_202 &&
V_198 -> V_203 == V_200 -> V_202 -> V_204 ) {
V_201 = F_114 ( V_200 -> V_201 ) ;
break;
}
}
F_115 ( V_198 ) = V_201 ;
...
static void
F_120 ( struct V_207 * V_202 , T_5 V_208 )
{
if ( V_208 )
V_202 -> V_209 = V_208 ;
else
...
static void
F_121 ( struct V_207 * V_202 )
{
struct V_102 * V_83 = F_122 ( V_202 ) ;
...
F_125 ( V_83 -> V_212 , V_166 ) ;
if ( F_86 ( V_143 , & V_200 -> V_11 -> V_30 ) )
return;
if ( F_32 ( F_33 ( V_200 -> V_11 -> V_15 -> V_58 ) ) ) {
F_126 ( V_200 -> V_11 , V_214 << 16 ) ;
return;
}
}
static void
F_127 ( struct V_207 * V_202 )
{
T_9 * V_200 = * ( T_9 * * ) V_202 -> V_210 ;
if ( ! V_200 )
return;
...
! F_86 ( V_217 , & V_200 -> V_11 -> V_30 ) )
V_200 -> V_11 -> V_15 -> V_32 -> V_218 ( V_200 -> V_11 ,
V_200 -> V_215 , V_200 -> V_171 . V_172 . V_173 ,
V_200 -> V_171 . V_172 . V_174 , V_200 -> V_171 . V_172 . V_175 ) ;
}
static int
F_128 ( struct V_102 * V_170 )
{
T_7 * V_11 = F_2 ( V_170 ) ;
F_129 ( V_11 ) ;
return 0 ;
...
V_16 = V_163 ;
if ( F_23 ( V_14 ) ) {
V_16 = F_131 ( V_82 , V_221 , V_222 ) ;
} else if ( F_75 ( & V_82 -> V_127 ) == V_132 &&
! F_76 ( V_11 ) && ! V_14 -> V_226 ) {
V_16 = F_132 ( V_82 , V_82 -> V_215 ,
V_221 , V_222 ) ;
}
if ( V_16 != V_42 )
goto V_227;
...
V_227:
F_133 ( V_14 -> V_77 , V_221 , V_222 ) ;
V_225:
return V_223 ;
}
static void
F_134 ( struct V_102 * V_170 )
{
T_7 * V_11 = F_2 ( V_170 ) ;
F_135 ( V_11 , F_136 ( V_170 ) ) ;
}
static void
...
static void
F_138 ( struct V_102 * V_170 )
{
T_7 * V_11 = F_2 ( V_170 ) ;
T_6 V_201 [ V_252 ] = { 0xFF , 0xFF , 0xFF , 0xFF , \
0xFF , 0xFF , 0xFF , 0xFF } ;
T_10 V_253 = F_114 ( V_201 ) ;
if ( V_11 -> V_130 & V_254 )
V_253 = F_114 ( V_11 -> V_255 ) ;
F_139 ( V_170 ) = V_253 ;
}
static void
F_140 ( struct V_102 * V_170 )
{
T_7 * V_11 = F_2 ( V_170 ) ;
...
static int
F_142 ( struct V_264 * V_264 , bool V_265 )
{
int V_104 = 0 ;
T_6 V_266 = 0 ;
...
if ( V_265 ) {
F_145 ( & V_11 -> V_272 , V_273 ) ;
F_146 ( V_264 , V_274 ) ;
} else
F_145 ( & V_11 -> V_272 , V_275 ) ;
F_9 ( V_25 , V_11 , 0x7080 ,
L_71 , V_11 -> V_191 ) ;
F_145 ( & V_11 -> V_127 , V_128 ) ;
V_11 -> V_276 = V_277 ;
V_11 -> V_278 = V_279 ;
...
| V_291
| V_292 ) ;
F_149 ( V_11 -> V_83 , V_293 ) ;
} else
V_11 -> V_166 . V_285 = 0 ;
}
if ( F_150 ( V_11 -> V_83 , & V_264 -> V_86 ,
& V_14 -> V_58 -> V_86 ) ) {
F_17 ( V_28 , V_11 , 0x7083 ,
L_74 , V_11 -> V_191 ) ;
goto V_294;
}
F_151 ( V_11 -> V_83 ) = V_14 -> V_295 ;
F_152 ( V_11 -> V_83 ) = F_114 ( V_11 -> V_201 ) ;
F_153 ( V_11 -> V_83 ) = F_114 ( V_11 -> V_205 ) ;
F_154 ( V_11 -> V_83 ) =
F_154 ( V_82 -> V_83 ) ;
F_155 ( V_11 -> V_83 ) =
F_155 ( V_82 -> V_83 ) ;
...
goto V_298;
for ( V_37 = 0 ; V_37 < V_14 -> V_301 ; V_37 ++ ) {
if ( memcmp ( V_14 -> V_300 [ V_37 ] . V_205 , V_11 -> V_205 , 8 ) == 0
&& memcmp ( V_14 -> V_300 [ V_37 ] . V_201 , V_11 -> V_201 ,
8 ) == 0 ) {
V_266 = V_14 -> V_300 [ V_37 ] . V_302 ;
break;
}
}
if ( V_266 ) {
V_104 = F_157 ( V_14 , V_267 , V_11 -> V_191 , 0 , 0 ,
V_266 ) ;
if ( ! V_104 )
...
static int
F_161 ( struct V_264 * V_264 )
{
T_7 * V_11 = V_264 -> V_210 ;
struct V_13 * V_14 = V_11 -> V_15 ;
T_4 V_203 = V_11 -> V_191 ;
while ( F_86 ( V_303 , & V_11 -> V_30 ) ||
F_86 ( V_304 , & V_11 -> V_30 ) )
F_162 ( 1000 ) ;
F_158 ( V_11 ) ;
V_11 -> V_166 . V_305 = 1 ;
F_163 ( V_11 -> V_83 ) ;
...
if ( V_307 & V_28 )
F_162 ( F_166 () % 10 ) ;
F_167 ( F_75 ( & V_11 -> V_308 ) ) ;
F_168 ( V_11 ) ;
F_169 ( & V_14 -> V_309 ) ;
V_14 -> V_310 -- ;
F_170 ( V_11 -> V_191 , V_14 -> V_311 ) ;
F_171 ( & V_14 -> V_309 ) ;
if ( V_11 -> V_269 -> V_203 && ! V_14 -> V_166 . V_296 ) {
if ( F_172 ( V_11 , V_11 -> V_269 ) != V_42 )
...
static int
F_156 ( struct V_264 * V_264 , bool V_265 )
{
T_7 * V_11 = V_264 -> V_210 ;
if ( V_265 )
F_158 ( V_11 ) ;
...
F_152 ( V_11 -> V_83 ) = F_114 ( V_11 -> V_201 ) ;
F_153 ( V_11 -> V_83 ) = F_114 ( V_11 -> V_205 ) ;
F_154 ( V_11 -> V_83 ) = V_312 ;
F_175 ( V_11 -> V_83 ) = V_14 -> V_313 ;
F_176 ( V_11 -> V_83 ) = V_14 -> V_310 ;
if ( F_37 ( V_14 ) )
V_176 = V_188 ;
else if ( F_36 ( V_14 ) )
V_176 = V_186 | V_184 |
