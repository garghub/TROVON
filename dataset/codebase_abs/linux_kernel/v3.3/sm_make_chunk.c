...
if ( V_101 == V_348 && V_395 ) {
V_339 = V_19 -> V_397 ;
V_4 = F_2 ( V_339 -> V_272 . V_384 ) ;
V_393 = V_4 -> V_385 ( V_339 , & V_358 ) ;
V_160 . V_68 . type = V_349 ;
V_160 . V_68 . V_14 = F_6 ( V_392 + V_393 ) ;
V_160 . V_398 = V_300 ;
F_7 ( V_28 , V_392 , & V_160 ) ;
F_7 ( V_28 , V_393 , & V_358 ) ;
...
static void F_136 ( struct V_1 * V_2 , T_17 V_398 ,
...
if ( V_400 )
V_403 =
F_17 ( V_400 -> V_68 . V_14 ) ;
}
V_401 . V_68 . type = V_405 ;
V_401 . V_68 . V_14 = F_6 ( sizeof( V_401 ) +
V_404 +
V_403 ) ;
V_401 . V_398 = V_398 ;
...
if ( V_400 -> V_68 . type != V_348 &&
V_400 -> V_68 . type != V_349 &&
V_400 -> V_68 . type != V_324 )
return V_312 ;
...
if ( ! V_80 )
return V_410 ;
if ( ! F_138 ( & V_80 -> V_411 , F_139 ( V_80 ) ) )
F_140 ( V_80 ) ;
V_19 -> V_412 = V_80 ;
break;
case V_349 :
if ( V_19 -> V_80 . V_413 == 1 )
return V_414 ;
if ( F_114 ( & V_381 -> V_210 , & V_339 ) )
return V_415 ;
if ( V_4 -> V_409 ( & V_339 ) ) {
...
case V_349 :
case V_324 :
V_400 = ( V_376 * ) V_160 . V_69 ;
V_416 = F_17 ( V_400 -> V_68 . V_14 ) ;
...
V_417 = ( T_28 * ) V_381 -> V_6 -> V_152 ;
V_386 = F_96 ( V_417 -> V_386 ) ;
V_14 = sizeof( T_28 ) ;
...
V_105 -= V_14 ;
V_418 = F_135 ( V_19 , V_386 , V_105 * 4 ) ;
if ( ! V_418 )
goto V_420;
while ( V_105 > 0 ) {
V_399 = F_137 ( V_19 , V_381 ,
V_400 ) ;
if ( V_406 != V_399 )
V_419 = 0 ;
if ( ! V_419 )
...
static T_1 F_151 ( struct V_1 * V_418 ,
V_376 * V_400 ,
int V_426 )
{
V_376 * V_427 ;
...
V_399 = V_429 ;
V_428 = F_17 ( V_418 -> V_139 -> V_14 ) -
sizeof( T_20 ) ;
V_14 = sizeof( T_28 ) ;
V_427 = ( V_376 * ) ( V_418 -> V_6 -> V_152 +
V_14 ) ;
V_428 -= V_14 ;
while ( V_428 > 0 ) {
if ( V_427 -> V_398 == V_400 -> V_398 ) {
switch( V_427 -> V_68 . type ) {
case V_407 :
return V_406 ;
case V_408 :
V_14 = sizeof( V_376 ) ;
...
T_2 V_138 ;
int V_300 ;
V_138 = ( V_436 + 1 ) * sizeof( T_13 ) ;
V_28 = F_18 ( V_19 , V_304 , 0 , V_138 ) ;
if ( ! V_28 )
return NULL ;
V_440 . V_435 = F_13 ( V_435 ) ;
V_28 -> V_15 . V_442 =
F_7 ( V_28 , sizeof( V_440 ) , & V_440 ) ;
for ( V_300 = 0 ; V_300 < V_436 ; V_300 ++ ) {
V_441 . V_107 = V_438 [ V_300 ] . V_107 ;
V_441 . V_102 = V_438 [ V_300 ] . V_102 ;
F_7 ( V_28 , sizeof( V_441 ) , & V_441 ) ;
}
return V_28 ;
}
