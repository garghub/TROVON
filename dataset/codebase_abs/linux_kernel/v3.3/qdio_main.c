...
static void F_122 ( struct V_50 * V_24 )
{
...
static inline int F_137 ( int V_40 , int V_16 , int V_17 )
{
...
V_12 -> V_64 . T_4 . V_74 = 0 ;
goto V_86;
} else if ( F_137 ( V_12 -> V_64 . T_4 . V_73 , V_40 , V_17 ) ) {
if ( F_16 ( V_12 ) ) {
V_234 = F_42 ( V_40 , V_17 ) ;
V_234 = F_60 ( V_234 , V_12 -> V_64 . T_4 . V_73 ) ;
V_12 -> V_64 . T_4 . V_74 -= V_234 ;
if ( V_12 -> V_64 . T_4 . V_74 <= 0 ) {
V_12 -> V_64 . T_4 . V_71 = 0 ;
V_12 -> V_64 . T_4 . V_74 = 0 ;
goto V_86;
}
V_12 -> V_64 . T_4 . V_73 = F_42 ( V_12 -> V_64 . T_4 . V_73 , V_234 ) ;
}
else
V_12 -> V_64 . T_4 . V_71 = 0 ;
}
...
V_233 = F_139 ( V_17 , & V_12 -> V_91 ) - V_17 ;
F_8 ( V_233 + V_17 > V_45 ) ;
if ( F_140 ( V_12 ) )
return F_32 ( V_12 ) ;
return 0 ;
...
F_18 ( V_12 , F_142 ( V_40 ) , & V_15 , 0 ) ;
if ( V_15 != V_142 )
V_19 = F_69 ( V_12 , 0 ) ;
else
F_9 ( V_12 , V_240 ) ;
}
if ( V_233 >= V_12 -> V_64 . T_3 . V_241 || V_19 )
F_63 ( & V_12 -> V_138 ) ;
else
if ( ! F_74 ( & V_12 -> V_64 . T_3 . V_153 ) )
...
int V_242 , unsigned int V_40 , unsigned int V_17 )
{
struct V_50 * V_24 ;
...
F_146 ( V_24 ) ;
F_38 ( V_12 ) ;
F_147 ( V_165 , & V_12 -> V_64 . T_4 . V_166 ) ;
if ( F_148 ( V_24 ) )
goto V_245;
if ( ! F_52 ( V_12 ) )
goto V_245;
...
int F_149 ( struct V_168 * V_33 , int V_22 , int * V_40 ,
int * error )
{
struct V_11 * V_12 ;
int V_16 , V_131 ;
