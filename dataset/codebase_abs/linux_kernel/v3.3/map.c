...
if ( V_19 == V_93 || V_19 == V_94 )
V_84 = L_21 ;
else {
if ( ! V_95 . V_96 )
goto V_97;
sprintf ( V_92 , L_22 , V_95 . V_96 , V_19 ) ;
if ( F_72 ( V_92 , V_98 ) ) {
F_73 ( L_23 , V_92 ) ;
goto V_97;
}
...
void F_74 ( struct V_26 * V_3 , T_7 V_99 , void * V_100 )
{
struct V_13 * V_28 ;
...
char * F_75 ( struct V_58 * V_3 , char * V_101 , T_4 V_102 )
{
if ( F_76 ( V_3 ) )
snprintf ( V_101 , V_102 , L_24 , L_25 ) ;
else if ( F_77 ( V_3 ) )
snprintf ( V_101 , V_102 , L_24 , L_26 ) ;
else
snprintf ( V_101 , V_102 , L_27 , L_26 , V_3 -> V_19 ) ;
return V_101 ;
}
