...
struct V_22 * V_2 = V_37 -> V_20 ;
if ( F_72 ( F_42 ( V_37 ) ) )
return F_63 ( V_37 , V_76 ) ;
if ( ! V_2 || ! V_2 -> V_61 )
return 0 ;
if ( V_2 -> V_61 -> V_78 ) {
int error ;
error = V_2 -> V_61 -> V_78 ( V_37 ) ;
F_61 ( V_2 -> V_61 -> V_78 , error ) ;
if ( error )
return error ;
}
...
int F_101 ( struct V_1 * V_2 , struct V_85 * V_86 ,
const char * V_87 )
{
int error ;
