...
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
F_18 ( V_32 -> V_33 , V_34 , sizeof( V_32 -> V_33 ) ) ;
F_18 ( V_32 -> V_35 , V_36 , sizeof( V_32 -> V_35 ) ) ;
F_18 ( V_32 -> V_37 , F_19 ( V_6 -> V_38 ) ,
sizeof( V_32 -> V_37 ) ) ;
V_32 -> V_39 = F_16 ( V_2 ) ;
}
...
* V_44 ++ = F_21 ( & V_16 -> V_51 -> V_52 + V_45 ) ;
for ( V_45 = 0 ; V_45 < V_53 ; V_45 ++ ) {
F_22 ( & V_6 -> V_16 , V_45 , & V_46 ) ;
* V_44 ++ = V_46 ;
}
}
...
V_6 -> V_77 = V_76 ;
V_76 -> V_83 =
F_30 ( V_71 -> V_82 , V_97 , V_79 ) ;
V_76 -> V_83 = F_31 ( V_76 -> V_83 , V_98 ) ;
V_73 -> V_83 =
F_30 ( V_71 -> V_84 , V_97 , V_79 ) ;
V_73 -> V_83 = F_31 ( V_73 -> V_83 , V_99 ) ;
if ( ( F_12 ( V_6 -> V_2 ) ) ) {
V_89 = F_32 ( V_6 , V_6 -> V_77 ) ;
if ( V_89 )
goto V_100;
V_89 = F_33 ( V_6 , V_6 -> V_74 ) ;
if ( V_89 )
goto V_101;
#ifdef F_34
V_6 -> V_77 = V_86 ;
...
static void F_41 ( struct V_1 * V_2 , T_1 V_114 ,
T_3 * V_115 )
{
T_3 * V_42 = V_115 ;
int V_45 ;
...
static int F_44 ( struct V_1 * V_2 , int V_127 )
{
switch ( V_127 ) {
case V_116 :
return V_128 ;
