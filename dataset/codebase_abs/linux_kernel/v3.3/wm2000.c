...
unsigned int V_3 , T_1 V_17 , int V_18 )
{
int V_9 ;
V_9 = F_4 ( V_2 , V_3 ) ;
while ( ! ( V_9 & V_17 ) && -- V_18 ) {
...
int V_3 ;
T_3 V_87 ;
V_6 = F_36 ( & V_2 -> V_20 , sizeof( struct V_5 ) ,
V_88 ) ;
if ( V_6 == NULL ) {
F_13 ( & V_2 -> V_20 , L_28 ) ;
return - V_89 ;
...
V_87 |= V_3 & 0xff ;
if ( V_87 != 0x2000 ) {
F_13 ( & V_2 -> V_20 , L_30 , V_87 ) ;
V_10 = - V_93 ;
goto V_94;
}
V_3 = F_4 ( V_2 , V_95 ) ;
F_41 ( & V_2 -> V_20 , L_31 , V_3 + 'A' ) ;
V_84 = L_32 ;
V_83 = F_42 ( & V_2 -> V_20 ) ;
if ( V_83 ) {
V_6 -> V_21 = V_83 -> V_96 ;
...
V_10 = F_43 ( & V_86 , V_84 , & V_2 -> V_20 ) ;
if ( V_10 != 0 ) {
F_13 ( & V_2 -> V_20 , L_33 , V_10 ) ;
goto V_94;
}
V_6 -> V_31 = V_86 -> V_99 + 2 ;
V_6 -> V_32 = F_36 ( & V_2 -> V_20 ,
V_6 -> V_31 ,
V_88 ) ;
if ( V_6 -> V_32 == NULL ) {
F_13 ( & V_2 -> V_20 , L_34 ) ;
...
V_6 -> V_32 [ 0 ] = 0x80 ;
V_6 -> V_32 [ 1 ] = 0x00 ;
memcpy ( V_6 -> V_32 + 2 , V_86 -> V_100 , V_86 -> V_99 ) ;
V_6 -> V_66 = 1 ;
V_6 -> V_68 = 1 ;
V_6 -> V_67 = 1 ;
V_6 -> V_2 = V_2 ;
F_6 ( V_6 ) ;
V_10 = F_44 ( & V_2 -> V_20 , & V_101 , NULL , 0 ) ;
if ( ! V_10 )
goto V_91;
V_94:
F_45 ( V_6 -> V_7 ) ;
