...
static int T_4 F_34 ( struct V_61 * V_62 )
{
...
V_9 = F_36 ( sizeof( * V_9 ) , V_71 ) ;
if ( ! V_9 ) {
F_35 ( & V_62 -> V_65 , L_5 ) ;
V_41 = - V_72 ;
goto V_70;
}
V_31 = F_37 ( V_62 , V_73 , 0 ) ;
if ( ! V_31 ) {
F_35 ( & V_62 -> V_65 , L_6 ) ;
V_41 = - V_69 ;
goto V_74;
}
if ( ! F_38 ( V_31 -> V_75 , F_39 ( V_31 ) , V_62 -> V_76 ) ) {
F_35 ( & V_62 -> V_65 , L_7 ) ;
V_41 = - V_69 ;
goto V_74;
}
V_9 -> V_33 = F_40 ( V_31 -> V_75 , F_39 ( V_31 ) ) ;
if ( ! V_9 -> V_33 ) {
F_35 ( & V_62 -> V_65 , L_8 ) ;
V_41 = - V_69 ;
goto V_77;
}
V_67 = F_41 ( V_78 , 0x00100000 ) ;
if ( ! V_67 ) {
F_35 ( & V_62 -> V_65 , L_9 ) ;
V_41 = - V_69 ;
goto V_79;
}
V_9 -> V_80 . V_81 = ( unsigned long ) V_67 ;
#ifdef F_42
if ( ( F_43 () == V_82 ) &&
( F_44 () < 0x01030202 ) ) {
...
V_9 -> V_10 = 8191 ;
F_10 ( V_9 ) ;
F_47 ( ( unsigned long ) V_9 -> V_80 . V_81 ) ;
V_40 = F_17 ( V_9 -> V_33 + V_50 ) ;
V_40 &= ~ V_64 -> V_93 ;
V_40 |= V_64 -> V_94 ;
V_40 &= ~ V_95 ;
...
int T_6 F_56 ( const struct V_99 * V_65 , T_2 V_100 , T_2 V_101 )
{
struct V_8 * V_9 = V_65 -> V_22 ;
if ( V_9 && V_9 -> V_84 )
return V_9 -> V_84 ( V_65 , V_100 , V_101 ) ;
return - 1 ;
}
int F_57 ( struct V_99 * V_65 )
{
return 0 ;
}
