...
V_139 =
F_37 ( V_138 . V_142 , sizeof( struct V_39 ) , V_89 ) ;
if ( ! V_139 ) {
F_6 ( L_3 ) ;
V_43 = - V_58 ;
goto error;
...
static void F_63 ( struct V_222 * V_223 )
{
struct V_63 * V_64 ;
struct V_9 * V_10 ;
V_64 = V_223 -> V_224 ;
...
static int F_64 ( struct V_1 * V_1 , struct V_222 * V_226 )
{
const unsigned V_4 = F_2 ( V_1 -> V_5 -> V_6 ) ;
...
static unsigned int F_68 ( struct V_1 * V_1 , T_1 * V_242 )
{
...
V_78 = F_34 ( V_8 ) ;
if ( V_78 ) {
F_69 ( V_1 , & V_78 -> V_64 -> V_243 , V_242 ) ;
if ( ! V_78 -> V_102
|| F_70 ( V_78 -> V_64 ) > 0
|| ! ( F_38 ( V_78 ) &
V_93 ) ) {
...
V_79 = F_35 ( V_8 ) ;
if ( V_79 ) {
F_69 ( V_1 , & V_79 -> V_64 -> V_243 , V_242 ) ;
F_45 ( V_79 -> V_64 ,
V_79 -> V_64 -> V_76 ) ;
if ( ! V_79 -> V_102
|| ! ( F_38 ( V_79 ) &
...
static T_2 F_73 ( struct V_1 * V_1 , const char V_17 * V_248 ,
T_3 V_249 , T_4 * V_250 )
{
struct V_65 * V_66 ;
struct V_63 * V_64 ;
...
F_76 ( V_260 ) ;
F_78 ( & V_64 -> V_243 , & V_242 ) ;
V_18:
return V_252 ? V_252 : V_67 ;
}
static T_2 F_79 ( struct V_1 * V_1 , char V_17 * V_248 , T_3 V_249 ,
T_4 * V_250 )
{
struct V_65 * V_66 ;
struct V_63 * V_64 ;
...
static int F_80 ( struct V_262 * V_262 , struct V_1 * V_1 )
{
...
static int F_84 ( struct V_262 * V_262 , struct V_1 * V_1 )
{
const unsigned V_4 = F_2 ( V_262 ) ;
...
static int F_85 ( int V_272 , struct V_1 * V_1 , int V_273 )
{
const unsigned V_4 = F_2 ( V_1 -> V_5 -> V_6 ) ;
struct V_7 * V_8 ;
struct V_9 * V_10 ;
...
if ( V_10 == NULL )
return - V_13 ;
return F_86 ( V_272 , V_1 , V_273 , & V_10 -> V_274 ) ;
}
...
V_67 = F_90 ( F_91 ( V_266 , 0 ) ,
V_281 , L_46 ) ;
if ( V_67 )
return - V_190 ;
F_92 ( & V_282 , & V_283 ) ;
V_282 . V_284 = V_267 ;
F_93 ( & V_282 . V_285 , L_46 ) ;
if ( F_94 ( & V_282 , F_91 ( V_266 , 0 ) , V_281 ) ) {
F_95 ( F_91 ( V_266 , 0 ) ,
V_281 ) ;
return - V_190 ;
}
V_286 = F_96 ( V_267 , L_46 ) ;
if ( F_97 ( V_286 ) ) {
F_52 ( V_261 L_47 ) ;
F_98 ( & V_282 ) ;
F_95 ( F_91 ( V_266 , 0 ) ,
...
F_104 ( V_286 ) ;
F_98 ( & V_282 ) ;
F_95 ( F_91 ( V_266 , 0 ) , V_281 ) ;
F_105 () ;
}
void F_106 ( const struct V_9 * V_10 , const char * V_66 )
{
F_52 ( V_261 L_48 , V_10 -> V_4 ,
V_10 -> V_51 -> V_83 , V_66 ) ;
}
void F_107 ( struct V_9 * V_10 , struct V_65 * V_66 )
{
struct V_63 * V_64 = V_66 -> V_64 ;
unsigned V_204 = 0 ;
unsigned V_287 = 0 ;
...
F_108 ( & V_64 -> V_243 ) ;
if ( V_66 -> V_92 & V_135 )
F_109 ( & V_10 -> V_274 , V_289 , V_290 ) ;
if ( V_66 -> V_92 & V_137 )
F_109 ( & V_10 -> V_274 , V_289 , V_291 ) ;
} else {
if ( V_64 -> V_292 )
...
unsigned V_86 ;
int V_67 ;
V_296 = F_115 ( sizeof( struct V_7 ) , V_89 ) ;
if ( V_296 == NULL )
return - V_58 ;
V_296 -> V_12 = F_115 ( sizeof( struct V_9 ) , V_89 ) ;
if ( V_296 -> V_12 == NULL ) {
F_40 ( V_296 ) ;
return - V_58 ;
}
...
V_296 -> V_12 -> V_4 = V_86 ;
V_297 = F_116 ( V_286 , V_295 ,
F_91 ( V_266 , V_86 ) , NULL , L_51 , V_86 ) ;
if ( ! F_97 ( V_297 ) )
V_296 -> V_12 -> V_299 = V_297 ;
F_117 ( V_297 , V_296 ) ;
V_67 = F_118 ( V_297 , & V_300 ) ;
if ( V_67 ) {
F_52 ( V_261
L_52
L_53 ,
...
V_66 -> V_4 = V_86 ;
V_297 = F_116 ( V_286 , V_10 -> V_299 ,
F_91 ( V_266 , V_86 ) , NULL , L_54 ,
...
if ( V_66 -> V_4 < 0 )
return;
F_103 ( V_66 -> V_4 >= V_281 ) ;
F_103 ( V_66 -> V_4 < V_306 ) ;
F_58 ( & V_298 , V_101 ) ;
V_296 = V_280 [ V_66 -> V_4 ] ;
V_280 [ V_66 -> V_4 ] = NULL ;
F_59 ( & V_298 , V_101 ) ;
if ( V_66 -> V_299 ) {
F_119 ( V_286 , F_91 ( V_266 , V_66 -> V_4 ) ) ;
V_66 -> V_299 = NULL ;
}
F_40 ( V_296 ) ;
}
...
struct V_65 * const V_84 =
F_34 ( V_296 ) ;
V_43 = F_126 ( V_248 , 10 , & V_312 ) ;
if ( V_43 )
return V_43 ;
if ( V_312 > ( V_314 / V_311 ) )
return - V_70 ;
V_313 = V_312 * V_311 ;
F_4 ( & V_296 -> V_12 -> V_14 ) ;
if ( V_84 == NULL ||
...
struct V_65 * const V_84 =
F_34 ( V_296 ) ;
V_43 = F_126 ( V_248 , 10 , & V_316 ) ;
if ( V_43 )
return V_43 ;
if ( V_316 > ( V_314 / V_311 ) )
return - V_70 ;
V_307 = V_316 * V_311 ;
F_4 ( & V_296 -> V_12 -> V_14 ) ;
if ( V_84 == NULL ||
...
static T_2 F_132 ( struct V_12 * V_10 ,
struct V_309 * V_301 ,
const char * V_248 , T_3 V_252 )
{
struct V_7 * V_296 = F_124 ( V_10 ) ;
