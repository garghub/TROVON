...
static int F_36 ( struct V_55 * V_56 , int V_57 ,
void T_1 * V_58 , T_2 * V_59 , T_3 * V_60 )
{
struct V_55 V_61 = * V_56 ;
if ( V_57 && ! F_37 ( V_62 ) )
return - V_63 ;
V_61 . V_64 = & V_65 -> V_66 -> V_43 -> V_67 ;
return F_38 ( & V_61 , V_57 , V_58 , V_59 , V_60 ) ;
}
