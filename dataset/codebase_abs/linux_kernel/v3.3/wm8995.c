...
V_35 = F_10 ( V_2 ) ;
V_35 -> V_2 = V_2 ;
V_2 -> V_424 = V_35 -> V_418 ;
V_32 = F_46 ( V_2 , 16 , 16 , V_425 ) ;
if ( V_32 < 0 ) {
F_14 ( V_2 -> V_9 , L_36 , V_32 ) ;
return V_32 ;
}
for ( V_341 = 0 ; V_341 < F_28 ( V_35 -> V_417 ) ; V_341 ++ )
V_35 -> V_417 [ V_341 ] . V_426 = V_427 [ V_341 ] ;
...
V_35 -> V_422 [ 0 ] . V_428 = V_429 ;
V_35 -> V_422 [ 1 ] . V_428 = V_430 ;
V_35 -> V_422 [ 2 ] . V_428 = V_431 ;
V_35 -> V_422 [ 3 ] . V_428 = V_432 ;
V_35 -> V_422 [ 4 ] . V_428 = V_433 ;
V_35 -> V_422 [ 5 ] . V_428 = V_434 ;
V_35 -> V_422 [ 6 ] . V_428 = V_435 ;
V_35 -> V_422 [ 7 ] . V_428 = V_436 ;
for ( V_341 = 0 ; V_341 < F_28 ( V_35 -> V_417 ) ; V_341 ++ ) {
...
static int T_3 F_52 ( struct V_459 * V_460 )
{
struct V_34 * V_35 ;
int V_32 ;
V_35 = F_53 ( sizeof *V_35 , V_461 ) ;
if ( ! V_35 )
return - V_462 ;
F_54 ( V_460 , V_35 ) ;
V_35 -> V_418 = F_55 ( V_460 , & V_463 ) ;
if ( F_56 ( V_35 -> V_418 ) ) {
V_32 = F_57 ( V_35 -> V_418 ) ;
F_14 ( & V_460 -> V_9 , L_43 , V_32 ) ;
goto V_464;
}
V_32 = F_58 ( & V_460 -> V_9 ,
& V_465 , V_466 ,
...
static int T_4 F_61 ( struct V_459 * V_460 )
{
struct V_34 * V_35 = F_62 ( V_460 ) ;
F_63 ( & V_460 -> V_9 ) ;
F_59 ( V_35 -> V_418 ) ;
F_60 ( V_35 ) ;
return 0 ;
}
static T_3 int F_64 ( struct V_468 * V_469 ,
const struct V_470 * V_302 )
{
struct V_34 * V_35 ;
int V_32 ;
V_35 = F_53 ( sizeof *V_35 , V_461 ) ;
...
return - V_462 ;
F_65 ( V_469 , V_35 ) ;
V_35 -> V_418 = F_66 ( V_469 , & V_463 ) ;
if ( F_56 ( V_35 -> V_418 ) ) {
V_32 = F_57 ( V_35 -> V_418 ) ;
F_14 ( & V_469 -> V_9 , L_43 , V_32 ) ;
goto V_464;
}
V_32 = F_58 ( & V_469 -> V_9 ,
& V_465 , V_466 ,
...
static T_4 int F_67 ( struct V_468 * V_471 )
{
struct V_34 * V_35 = F_68 ( V_471 ) ;
F_63 ( & V_471 -> V_9 ) ;
F_59 ( V_35 -> V_418 ) ;
F_60 ( V_35 ) ;
return 0 ;
