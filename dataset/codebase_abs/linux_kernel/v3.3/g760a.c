...
struct V_8 * V_11 = F_8 ( V_4 ) ;
F_9 ( & V_11 -> V_12 ) ;
if ( F_10 ( V_13 , V_11 -> V_14 + V_15 )
|| ! V_11 -> V_16 ) {
F_11 ( & V_4 -> V_10 , L_1 ) ;
...
static T_4 F_13 ( struct V_9 * V_10 , struct V_23 * V_24 ,
char * V_25 )
{
...
static T_4 F_15 ( struct V_9 * V_10 , struct V_23 * V_24 ,
char * V_25 )
{
struct V_8 * V_11 = F_6 ( V_10 ) ;
return sprintf ( V_25 , L_2 , F_16 ( V_11 -> V_17 ) ) ;
}
static T_4 F_17 ( struct V_9 * V_10 , struct V_23 * V_24 ,
...
V_37 ) )
return - V_38 ;
V_11 = F_23 ( sizeof( struct V_8 ) , V_39 ) ;
if ( ! V_11 )
return - V_40 ;
F_24 ( V_4 , V_11 ) ;
V_11 -> V_4 = V_4 ;
...
V_11 -> V_28 = V_41 ;
V_11 -> V_2 = V_42 ;
V_35 = F_26 ( & V_4 -> V_10 . V_43 , & V_44 ) ;
if ( V_35 )
goto V_45;
V_11 -> V_46 = F_27 ( & V_4 -> V_10 ) ;
if ( F_28 ( V_11 -> V_46 ) ) {
V_35 = F_29 ( V_11 -> V_46 ) ;
goto V_47;
}
