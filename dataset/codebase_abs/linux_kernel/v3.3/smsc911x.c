...
{
unsigned int V_180 = ( V_179 + V_181 + 3 ) >> 2 ;
if ( F_39 ( V_180 >= 4 ) ) {
unsigned int V_182 = 500 ;
unsigned int V_13 ;
F_14 ( V_2 , V_183 , V_184 ) ;
do {
F_44 ( 1 ) ;
V_13 = F_7 ( V_2 , V_183 ) ;
} while ( ( V_13 & V_184 ) && -- V_182 );
if ( F_38 ( V_182 == 0 ) )
F_36 ( V_2 , V_32 , L_53
L_54 , V_13 ) ;
} else {
...
static int F_74 ( struct V_185 * V_186 , int V_187 )
{
struct V_1 * V_2 =
F_75 ( V_186 , struct V_1 , V_186 ) ;
...
V_190 -> V_9 = V_190 -> V_197 ;
F_78 ( V_190 ) ;
F_79 ( V_190 , V_181 ) ;
F_80 ( V_190 , V_75 - 4 ) ;
V_2 -> V_11 -> V_84 ( V_2 ,
( unsigned int * ) V_190 -> V_197 , V_180 ) ;
V_190 -> V_198 = F_81 ( V_190 , V_28 ) ;
F_82 ( V_190 ) ;
F_83 ( V_190 ) ;
V_28 -> V_159 . V_199 ++ ;
V_28 -> V_159 . V_200 += ( V_75 - 4 ) ;
}
return V_188 ;
}
static unsigned int F_84 ( char V_44 [ V_91 ] )
{
return ( F_85 ( V_91 , V_44 ) >> 26 ) & 0x3f ;
}
...
F_40 ( V_2 , V_205 , V_2 -> V_206 ) ;
F_46 ( V_2 , V_32 , L_57 ,
V_119 , V_2 -> V_204 , V_2 -> V_206 ) ;
}
...
static void
F_95 ( struct V_1 * V_2 , T_4 V_214 [ 6 ] )
{
T_1 V_215 = ( V_214 [ 5 ] << 8 ) | V_214 [ 4 ] ;
T_1 V_216 = ( V_214 [ 3 ] << 24 ) | ( V_214 [ 2 ] << 16 ) |
( V_214 [ 1 ] << 8 ) | V_214 [ 0 ] ;
F_35 ( V_2 ) ;
F_40 ( V_2 , V_217 , V_215 ) ;
F_40 ( V_2 , V_218 , V_216 ) ;
}
...
F_14 ( V_2 , V_232 , V_219 ) ;
F_46 ( V_2 , V_226 , L_71 , V_28 -> V_135 ) ;
V_2 -> V_233 = 0 ;
F_100 () ;
V_35 = F_7 ( V_2 , V_193 ) ;
V_35 |= V_234 ;
...
F_103 ( & V_2 -> V_186 ) ;
V_35 = F_7 ( V_2 , V_193 ) ;
V_35 |= ( V_238 | V_194 | V_239 ) ;
F_14 ( V_2 , V_193 , V_35 ) ;
F_98 ( & V_2 -> V_45 ) ;
V_35 = F_37 ( V_2 , V_99 ) ;
V_35 |= ( V_101 | V_102 | V_240 ) ;
F_40 ( V_2 , V_99 , V_35 ) ;
F_99 ( & V_2 -> V_45 ) ;
F_14 ( V_2 , V_94 , V_95 ) ;
F_104 ( V_28 ) ;
...
F_106 ( V_28 ) ;
F_107 ( & V_2 -> V_186 ) ;
V_28 -> V_159 . V_196 += F_7 ( V_2 , V_241 ) ;
F_71 ( V_28 ) ;
if ( V_2 -> V_88 )
F_108 ( V_2 -> V_88 ) ;
F_46 ( V_2 , V_242 , L_75 ) ;
...
static int F_109 ( struct V_189 * V_190 , struct V_23 * V_28 )
{
struct V_1 * V_2 = F_24 ( V_28 ) ;
unsigned int V_243 ;
unsigned int V_244 ;
...
T_1 V_69 ;
T_3 V_71 ;
V_243 = F_7 ( V_2 , V_62 ) & V_246 ;
if ( F_38 ( V_243 < V_247 ) )
F_36 ( V_2 , V_248 ,
L_76 , V_243 ) ;
V_244 = ( T_1 ) ( ( T_3 ) V_190 -> V_9 & 0x03 ) << 16 ;
V_244 |= V_79 | V_80 ;
V_244 |= ( unsigned int ) V_190 -> V_249 ;
V_245 = ( ( unsigned int ) V_190 -> V_249 ) << 16 ;
V_245 |= ( unsigned int ) V_190 -> V_249 ;
F_14 ( V_2 , V_18 , V_244 ) ;
F_14 ( V_2 , V_18 , V_245 ) ;
V_71 = ( T_3 ) V_190 -> V_9 & ( ~ 0x3 ) ;
V_69 = ( T_1 ) V_190 -> V_249 + 3 ;
V_69 += ( T_1 ) ( ( T_3 ) V_190 -> V_9 & 0x3 ) ;
V_69 >>= 2 ;
V_2 -> V_11 -> V_81 ( V_2 , ( unsigned int * ) V_71 , V_69 ) ;
V_243 -= ( V_190 -> V_249 + 32 ) ;
F_110 ( V_190 ) ;
F_111 ( V_190 ) ;
if ( F_38 ( F_70 ( V_2 ) >= 30 ) )
F_71 ( V_28 ) ;
...
static struct V_251 * F_112 ( struct V_23 * V_28 )
{
struct V_1 * V_2 = F_24 ( V_28 ) ;
F_71 ( V_28 ) ;
V_28 -> V_159 . V_196 += F_7 ( V_2 , V_241 ) ;
...
if ( V_28 -> V_5 & V_252 ) {
V_2 -> V_201 = V_253 ;
V_2 -> V_202 = ( V_254 | V_255 ) ;
V_2 -> V_204 = 0 ;
V_2 -> V_206 = 0 ;
} else if ( V_28 -> V_5 & V_256 ) {
V_2 -> V_201 = V_254 ;
V_2 -> V_202 = ( V_253 | V_255 ) ;
V_2 -> V_204 = 0 ;
V_2 -> V_206 = 0 ;
} else if ( ! F_114 ( V_28 ) ) {
...
F_115 (ha, dev) {
unsigned int V_261 = F_84 ( V_260 -> V_44 ) ;
unsigned int V_262 = 0x01 << ( V_261 & 0x1F ) ;
if ( V_261 & 0x20 )
V_257 |= V_262 ;
else
V_258 |= V_262 ;
...
static T_6 F_116 ( int V_135 , void * V_263 )
{
struct V_23 * V_28 = V_263 ;
struct V_1 * V_2 = F_24 ( V_28 ) ;
T_1 V_264 = F_7 ( V_2 , V_191 ) ;
T_1 V_265 = F_7 ( V_2 , V_193 ) ;
int V_266 = V_267 ;
T_1 V_35 ;
if ( F_38 ( V_264 & V_265 & V_268 ) ) {
V_35 = F_7 ( V_2 , V_193 ) ;
V_35 &= ( ~ V_234 ) ;
F_14 ( V_2 , V_193 , V_35 ) ;
F_14 ( V_2 , V_191 , V_268 ) ;
V_2 -> V_233 = 1 ;
F_100 () ;
V_266 = V_269 ;
}
if ( F_38 ( V_264 & V_265 & V_270 ) ) {
F_46 ( V_2 , V_271 , L_78 ) ;
F_14 ( V_2 , V_191 , V_270 ) ;
if ( V_2 -> V_207 )
F_87 ( V_2 ) ;
V_266 = V_269 ;
}
if ( V_264 & V_265 & V_272 ) {
V_35 = F_7 ( V_2 , V_235 ) ;
V_35 |= V_236 ;
F_14 ( V_2 , V_235 , V_35 ) ;
F_14 ( V_2 , V_191 , V_272 ) ;
F_117 ( V_28 ) ;
V_266 = V_269 ;
}
if ( F_38 ( V_264 & V_265 & V_273 ) ) {
F_46 ( V_2 , V_271 , L_79 ) ;
F_14 ( V_2 , V_191 , V_273 ) ;
V_266 = V_269 ;
}
if ( F_39 ( V_264 & V_265 & V_192 ) ) {
if ( F_39 ( F_118 ( & V_2 -> V_186 ) ) ) {
V_35 = F_7 ( V_2 , V_193 ) ;
V_35 &= ( ~ V_194 ) ;
F_14 ( V_2 , V_193 , V_35 ) ;
F_119 ( & V_2 -> V_186 ) ;
...
static int F_123 ( struct V_23 * V_28 , void * V_274 )
{
struct V_1 * V_2 = F_24 ( V_28 ) ;
struct V_275 * V_44 = V_274 ;
if ( V_2 -> V_212 <= 1 && F_124 ( V_28 ) )
return - V_276 ;
if ( ! F_97 ( V_44 -> V_277 ) )
return - V_221 ;
memcpy ( V_28 -> V_214 , V_44 -> V_277 , V_91 ) ;
F_98 ( & V_2 -> V_45 ) ;
F_95 ( V_2 , V_28 -> V_214 ) ;
F_99 ( & V_2 -> V_45 ) ;
F_62 ( V_28 , L_81 , V_28 -> V_214 ) ;
return 0 ;
}
...
if ( F_7 ( V_2 , V_224 ) & V_225 ) {
F_36 ( V_2 , V_133 , L_83 ) ;
return - V_276 ;
}
V_301 = V_300 | V_225 ;
F_14 ( V_2 , V_224 , V_301 ) ;
do {
F_52 ( 1 ) ;
V_301 = F_7 ( V_2 , V_224 ) ;
} while ( ( V_301 & V_225 ) && ( -- V_182 ) );
if ( ! V_182 ) {
F_46 ( V_2 , V_133 , L_84 ) ;
return - V_220 ;
}
...
int V_29 ;
F_139 ( V_2 ) ;
V_249 = F_145 ( V_309 -> V_249 , V_307 ) ;
for ( V_29 = 0 ; V_29 < V_249 ; V_29 ++ ) {
...
memcpy ( V_9 , & V_310 [ V_309 -> V_34 ] , V_249 ) ;
V_309 -> V_249 = V_249 ;
return 0 ;
}
...
{
struct V_1 * V_2 = F_24 ( V_28 ) ;
T_1 V_215 = F_37 ( V_2 , V_217 ) ;
T_1 V_216 = F_37 ( V_2 , V_218 ) ;
V_28 -> V_214 [ 0 ] = ( T_4 ) ( V_216 ) ;
V_28 -> V_214 [ 1 ] = ( T_4 ) ( V_216 >> 8 ) ;
V_28 -> V_214 [ 2 ] = ( T_4 ) ( V_216 >> 16 ) ;
V_28 -> V_214 [ 3 ] = ( T_4 ) ( V_216 >> 24 ) ;
V_28 -> V_214 [ 4 ] = ( T_4 ) ( V_215 ) ;
V_28 -> V_214 [ 5 ] = ( T_4 ) ( V_215 >> 8 ) ;
}
...
case 0x01150000 :
case 0x218A0000 :
V_2 -> V_212 = V_2 -> V_154 & 0x0000FFFF ;
break;
case 0x118A0000 :
case 0x117A0000 :
case 0x116A0000 :
...
F_151 ( V_28 ) ;
V_28 -> V_5 |= V_319 ;
F_152 ( V_28 , & V_2 -> V_186 , F_74 , V_320 ) ;
V_28 -> V_321 = & V_322 ;
V_28 -> V_323 = & V_324 ;
return 0 ;
}
...
memcpy ( V_28 -> V_214 , V_2 -> V_4 . V_332 , 6 ) ;
F_46 ( V_2 , V_130 ,
L_123 ) ;
} else {
F_178 ( V_28 ) ;
...
static int F_180 ( struct V_355 * V_28 )
{
...
static int F_182 ( struct V_355 * V_28 )
{
struct V_23 * V_24 = F_181 ( V_28 ) ;
struct V_1 * V_2 = F_24 ( V_24 ) ;
unsigned int V_314 = 100 ;
