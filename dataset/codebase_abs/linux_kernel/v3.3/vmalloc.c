...
int F_197 ( struct V_148 * V_149 , void * V_2 ,
unsigned long V_150 )
{
struct V_107 * V_113 ;
...
static int F_199 ( T_2 * V_4 , T_10 V_158 , unsigned long V_2 , void * V_159 )
{
T_2 * * * V_33 = V_159 ;
if ( V_33 ) {
* ( * V_33 ) = V_4 ;
...
struct V_107 * F_200 ( T_8 V_40 , T_2 * * V_160 )
{
struct V_107 * V_113 ;
...
struct V_107 * * F_207 ( const unsigned long * V_164 ,
...
V_169 = F_142 ( sizeof( V_169 [ 0 ] ) * V_166 , V_106 ) ;
V_168 = F_142 ( sizeof( V_168 [ 0 ] ) * V_166 , V_106 ) ;
if ( ! V_168 || ! V_169 )
goto V_177;
for ( V_113 = 0 ; V_113 < V_166 ; V_113 ++ ) {
V_168 [ V_113 ] = F_142 ( sizeof( struct V_26 ) , V_106 ) ;
V_169 [ V_113 ] = F_142 ( sizeof( struct V_107 ) , V_106 ) ;
...
F_60 ( & V_51 ) ;
for ( V_113 = 0 ; V_113 < V_166 ; V_113 ++ )
F_151 ( V_169 [ V_113 ] , V_168 [ V_113 ] , V_134 ,
F_207 ) ;
F_64 ( V_168 ) ;
return V_169 ;
V_178:
...
void F_209 ( struct V_107 * * V_169 , int V_166 )
{
int V_97 ;
...
static void * F_210 ( struct V_179 * V_180 , T_11 * V_181 )
__acquires( &vmlist_lock
static void * F_211 ( struct V_179 * V_180 , void * V_33 , T_11 * V_181 )
{
struct V_107 * V_182 = V_33 ;
++ * V_181 ;
return V_182 -> V_9 ;
}
static void F_212 ( struct V_179 * V_180 , void * V_33 )
__releases( &vmlist_lock
static void F_213 ( struct V_179 * V_180 , struct V_107 * V_182 )
{
if ( V_183 ) {
...
V_184 [ F_214 ( V_182 -> V_13 [ V_14 ] ) ] ++ ;
F_215 (nr, N_HIGH_MEMORY)
if ( V_184 [ V_14 ] )
F_216 ( V_180 , L_7 , V_14 , V_184 [ V_14 ] ) ;
}
}
static int F_217 ( struct V_179 * V_180 , void * V_33 )
{
struct V_107 * V_182 = V_33 ;
F_216 ( V_180 , L_8 ,
V_182 -> V_2 , V_182 -> V_2 + V_182 -> V_40 , V_182 -> V_40 ) ;
if ( V_182 -> V_114 )
F_216 ( V_180 , L_9 , V_182 -> V_114 ) ;
if ( V_182 -> V_122 )
F_216 ( V_180 , L_10 , V_182 -> V_122 ) ;
if ( V_182 -> V_187 )
F_216 ( V_180 , L_11 , ( unsigned long long ) V_182 -> V_187 ) ;
if ( V_182 -> V_59 & V_117 )
F_216 ( V_180 , L_12 ) ;
if ( V_182 -> V_59 & V_134 )
F_216 ( V_180 , L_13 ) ;
...
static int F_219 ( struct V_189 * V_189 , struct V_190 * V_190 )
{
unsigned int * V_191 = NULL ;
int V_19 ;
if ( V_183 ) {
V_191 = F_220 ( V_186 * sizeof( unsigned int ) , V_106 ) ;
if ( V_191 == NULL )
return - V_15 ;
}
V_19 = F_221 ( V_190 , & V_192 ) ;
if ( ! V_19 ) {
