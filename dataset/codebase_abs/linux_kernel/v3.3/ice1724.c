...
V_177 = 1 ;
V_134 = F_89 ( V_2 -> V_181 , L_7 , V_174 , 1 , V_177 , & V_176 ) ;
if ( V_134 < 0 )
return V_134 ;
F_90 ( V_176 , V_182 , & V_183 ) ;
if ( V_177 )
F_90 ( V_176 , V_184 ,
& V_185 ) ;
V_176 -> V_20 = V_2 ;
...
V_187 = L_9 ;
V_134 = F_89 ( V_2 -> V_181 , V_187 , V_174 , V_204 , V_177 , & V_176 ) ;
if ( V_134 < 0 )
return V_134 ;
if ( V_204 )
F_90 ( V_176 , V_182 ,
...
if ( V_204 <= 0 )
return 0 ;
V_134 = F_89 ( V_2 -> V_181 , L_10 , V_174 , V_204 , 0 , & V_176 ) ;
if ( V_134 < 0 )
return V_134 ;
F_90 ( V_176 , V_182 ,
& V_213 ) ;
...
V_17 . V_20 = V_2 ;
V_134 = F_107 ( V_216 , & V_17 , & V_2 -> V_17 ) ;
if ( V_134 < 0 )
F_49 ( V_221 L_12 ) ;
else
return 0 ;
...
static inline unsigned int F_108 ( struct V_1 * V_2 , int V_223 )
{
...
unsigned int V_223 ;
F_110 ( V_44 , L_14 , V_2 -> V_181 -> V_227 ) ;
F_110 ( V_44 , L_15 ) ;
F_110 ( V_44 , L_16 , V_2 -> V_106 . V_228 ) ;
F_110 ( V_44 , L_17 , V_2 -> V_106 . V_137 ) ;
F_110 ( V_44 , L_18 , V_2 -> V_106 . V_229 ) ;
F_110 ( V_44 , L_19 ,
...
{
struct V_224 * V_225 ;
if ( ! F_112 ( V_2 -> V_181 , L_31 , & V_225 ) )
F_113 ( V_225 , V_2 , F_109 ) ;
}
...
static unsigned int F_118 ( struct V_246 * V_247 )
{
...
static void F_119 ( struct V_246 * V_247 , unsigned int V_19 )
{
...
static inline int F_136 ( int V_223 )
{
...
int F_138 ( struct V_1 * V_2 , int V_279 )
{
unsigned long V_19 ;
unsigned char V_280 ;
...
static int F_141 ( struct V_235 * V_236 ,
struct V_241 * V_242 )
{
struct V_1 * V_2 = F_116 ( V_236 ) ;
int V_223 = F_142 ( V_236 , & V_242 -> V_284 ) ;
V_242 -> V_243 . V_266 . V_269 [ 0 ] =
F_138 ( V_2 , F_136 ( V_223 ) ) ;
return 0 ;
}
...
V_2 -> V_106 . V_228 =
( F_149 ( V_2 , V_292 , 0x00 ) << 0 ) |
( F_149 ( V_2 , V_292 , 0x01 ) << 8 ) |
( F_149 ( V_2 , V_292 , 0x02 ) << 16 ) |
( F_149 ( V_2 , V_292 , 0x03 ) << 24 ) ;
if ( V_2 -> V_106 . V_228 == 0 ||
V_2 -> V_106 . V_228 == ( unsigned int ) - 1 ) {
T_6 V_303 , V_174 ;
F_152 ( V_2 -> V_189 , V_304 ,
& V_303 ) ;
F_152 ( V_2 -> V_189 , V_305 , & V_174 ) ;
V_2 -> V_106 . V_228 =
( ( unsigned int ) F_153 ( V_303 ) << 16 ) | F_153 ( V_174 ) ;
if ( V_2 -> V_106 . V_228 == 0 ||
V_2 -> V_106 . V_228 == ( unsigned int ) - 1 ) {
F_49 ( V_13 L_39 ) ;
return - V_306 ;
...
V_2 -> V_106 . V_228 ) ;
V_312:
V_2 -> V_106 . V_137 = F_149 ( V_2 , V_292 , 0x04 ) ;
...
V_2 -> V_106 . V_229 = F_149 ( V_2 , V_292 , 0x05 ) ;
if ( V_2 -> V_106 . V_229 != 2 )
F_49 ( V_221 L_44 ,
V_2 -> V_106 . V_229 ) ;
V_137 = V_2 -> V_106 . V_137 - 6 ;
for ( V_43 = 0 ; V_43 < V_137 ; V_43 ++ )
V_2 -> V_106 . V_25 [ V_43 ] = F_149 ( V_2 , V_292 , V_43 + 6 ) ;
V_313:
V_2 -> V_106 . V_231 = F_108 ( V_2 , V_314 ) ;
V_2 -> V_106 . V_232 = F_108 ( V_2 , V_315 ) ;
V_2 -> V_106 . V_230 = F_108 ( V_2 , V_316 ) ;
return 0 ;
}
...
return - V_15 ;
if ( ! V_2 -> V_326 ) {
V_134 = F_160 ( V_2 -> V_181 ,
F_161 ( & V_327 , V_2 ) ) ;
if ( V_134 < 0 )
return V_134 ;
}
V_134 = F_160 ( V_2 -> V_181 , F_161 ( & V_328 , V_2 ) ) ;
if ( V_134 < 0 )
return V_134 ;
V_134 = F_160 ( V_2 -> V_181 , V_325 = F_161 ( & V_329 , V_2 ) ) ;
if ( V_134 < 0 )
return V_134 ;
V_325 -> V_284 . V_174 = V_2 -> V_176 -> V_174 ;
V_134 = F_160 ( V_2 -> V_181 , V_325 = F_161 ( & V_330 , V_2 ) ) ;
if ( V_134 < 0 )
return V_134 ;
V_325 -> V_284 . V_174 = V_2 -> V_176 -> V_174 ;
V_134 = F_160 ( V_2 -> V_181 , V_325 = F_161 ( & V_331 , V_2 ) ) ;
if ( V_134 < 0 )
return V_134 ;
V_325 -> V_284 . V_174 = V_2 -> V_176 -> V_174 ;
#if 0
...
{
int V_134 ;
V_134 = F_160 ( V_2 -> V_181 , F_161 ( & V_332 , V_2 ) ) ;
if ( V_134 < 0 )
return V_134 ;
V_134 = F_160 ( V_2 -> V_181 , F_161 ( & V_333 , V_2 ) ) ;
if ( V_134 < 0 )
return V_134 ;
V_134 = F_160 ( V_2 -> V_181 , F_161 ( & V_334 , V_2 ) ) ;
if ( V_134 < 0 )
return V_134 ;
V_134 = F_160 ( V_2 -> V_181 , F_161 ( & V_335 , V_2 ) ) ;
if ( V_134 < 0 )
return V_134 ;
...
V_337 . V_33 = 2 ;
V_134 = F_160 ( V_2 -> V_181 , F_161 ( & V_337 , V_2 ) ) ;
if ( V_134 < 0 )
return V_134 ;
}
V_134 = F_160 ( V_2 -> V_181 , F_161 ( & V_339 , V_2 ) ) ;
if ( V_134 < 0 )
return V_134 ;
return 0 ;
}
...
static int F_169 ( struct V_342 * V_174 )
{
struct V_1 * V_2 = V_174 -> V_343 ;
return F_163 ( V_2 ) ;
}
static int T_5 F_170 ( struct V_344 * V_181 ,
struct V_345 * V_189 ,
const char * V_298 ,
struct V_1 * * V_346 )
{
...
F_176 ( V_189 -> V_63 ) ;
V_181 -> V_20 = V_2 ;
V_134 = F_177 ( V_189 , L_7 ) ;
if ( V_134 < 0 ) {
F_168 ( V_2 ) ;
F_167 ( V_189 ) ;
return V_134 ;
}
V_2 -> V_234 = F_178 ( V_189 , 0 ) ;
V_2 -> V_147 = F_178 ( V_189 , 1 ) ;
if ( F_179 ( V_189 -> V_63 , F_47 ,
V_359 , V_360 , V_2 ) ) {
F_180 ( V_13 L_45 , V_189 -> V_63 ) ;
F_163 ( V_2 ) ;
return - V_15 ;
}
V_2 -> V_63 = V_189 -> V_63 ;
F_155 ( V_2 ) ;
if ( F_151 ( V_2 , V_298 ) < 0 ) {
F_163 ( V_2 ) ;
return - V_15 ;
}
if ( F_157 ( V_2 ) < 0 ) {
...
V_134 = F_181 ( V_181 , V_361 , V_2 , & V_127 ) ;
if ( V_134 < 0 ) {
F_163 ( V_2 ) ;
return V_134 ;
}
F_182 ( V_181 , & V_189 -> V_292 ) ;
* V_346 = V_2 ;
return 0 ;
}
static int T_5 F_183 ( struct V_345 * V_189 ,
...
V_134 = F_184 ( V_368 [ V_292 ] , V_284 [ V_292 ] , V_369 , 0 , & V_181 ) ;
if ( V_134 < 0 )
return V_134 ;
strcpy ( V_181 -> V_370 , L_7 ) ;
strcpy ( V_181 -> V_371 , L_46 ) ;
V_134 = F_170 ( V_181 , V_189 , V_308 [ V_292 ] , & V_2 ) ;
if ( V_134 < 0 ) {
F_185 ( V_181 ) ;
return V_134 ;
}
...
if ( ! V_2 -> V_114 )
F_78 ( V_2 ) ;
V_134 = F_88 ( V_2 , V_364 ++ ) ;
if ( V_134 < 0 ) {
F_185 ( V_181 ) ;
return V_134 ;
}
V_134 = F_100 ( V_2 , V_364 ++ ) ;
if ( V_134 < 0 ) {
F_185 ( V_181 ) ;
return V_134 ;
}
V_134 = F_104 ( V_2 , V_364 ++ ) ;
if ( V_134 < 0 ) {
F_185 ( V_181 ) ;
return V_134 ;
}
...
struct V_379 * V_38 ;
V_134 = F_186 ( V_181 , L_47 , 0 , 1 , 1 , & V_38 ) ;
if ( V_134 < 0 ) {
F_185 ( V_181 ) ;
return V_134 ;
}
...
static void T_7 F_190 ( struct V_345 * V_189 )
{
F_185 ( F_191 ( V_189 ) ) ;
F_189 ( V_189 , NULL ) ;
}
static int F_192 ( struct V_345 * V_189 , T_8 V_388 )
{
struct V_344 * V_181 = F_191 ( V_189 ) ;
...
F_195 ( V_2 -> V_17 ) ;
F_33 ( & V_2 -> V_53 ) ;
V_2 -> V_391 = V_2 -> V_5 ( V_2 ) ;
V_2 -> V_392 = F_12 ( F_3 ( V_2 , V_195 ) ) ;
V_2 -> V_393 = F_2 ( F_15 ( V_2 , V_193 ) ) ;
V_2 -> V_394 = F_17 ( F_3 ( V_2 , V_233 ) ) ;
F_34 ( & V_2 -> V_53 ) ;
if ( V_2 -> V_395 )
V_2 -> V_395 ( V_2 ) ;
F_167 ( V_189 ) ;
F_196 ( V_189 ) ;
F_197 ( V_189 , F_198 ( V_189 , V_388 ) ) ;
return 0 ;
}
static int F_199 ( struct V_345 * V_189 )
{
struct V_344 * V_181 = F_191 ( V_189 ) ;
struct V_1 * V_2 = V_181 -> V_20 ;
if ( ! V_2 -> V_389 )
...
F_93 ( V_2 , V_2 -> V_392 ) ;
F_9 ( V_2 -> V_393 , F_15 ( V_2 , V_193 ) ) ;
F_14 ( V_2 -> V_394 , F_3 ( V_2 , V_233 ) ) ;
if ( V_2 -> V_17 )
F_202 ( V_2 -> V_17 ) ;
F_193 ( V_181 , V_398 ) ;
return 0 ;
