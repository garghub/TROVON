...
V_157 = F_94 ( V_155 , V_134 ) ;
memcpy ( V_32 -> V_104 , V_158 , V_157 ) ;
F_95 ( V_159 , & V_110 -> V_12 , V_29 , V_157 ,
V_32 -> V_104 ) ;
F_96 ( V_32 , V_8 -> V_12 ,
F_62 ( V_8 -> V_12 ,
V_110 -> V_160 ) ,
...
F_12 ( L_55 , V_29 ) ;
if ( F_98 ( V_113 ) ) {
unsigned char V_161 = F_99 ( V_113 ) ;
...
F_12 ( L_55 , V_29 ) ;
if ( F_98 ( V_113 ) ) {
unsigned char V_166 = F_101 ( V_113 ) ;
...
static int F_103 ( int V_173 , int * V_174 )
{
int V_150 ;
T_1 V_175 ;
T_1 V_176 ;
...
for ( V_150 = 0 ; V_150 < F_104 ( V_178 ) ; V_150 ++ ) {
...
V_18 = F_105 ( V_117 , V_167 ) ;
if ( V_181 & V_203 )
F_111 ( V_113 , V_167 , V_167 ) ;
F_3 ( V_8 , V_128 , V_139 , 0x0c ) ;
if ( V_110 -> V_114 -> V_18 != - V_115 ) {
...
F_12 ( L_74 , V_29 ,
V_113 -> V_162 -> V_163 ,
F_113 ( V_113 -> V_162 -> V_187 ) ) ;
F_12 ( L_75 , V_29 ,
V_180 -> V_163 ,
F_113 ( V_180 -> V_187 ) ) ;
F_12 ( L_63 , V_29 , V_110 -> V_135 ) ;
F_106 ( V_113 , V_117 , V_180 ) ;
if ( V_110 -> V_114 -> V_18 != - V_115 ) {
V_18 = F_28 ( V_110 -> V_114 , V_45 ) ;
if ( V_18 )
F_12 ( L_71 ,
...
static int F_119 ( struct V_116 * V_117 , unsigned int V_241 ,
...
V_210 = V_117 -> V_143 ;
if ( F_120 ( & V_242 , V_17 , sizeof( int ) ) )
return - V_209 ;
switch ( V_241 ) {
case V_243 :
if ( V_242 & V_214 )
...
if ( F_115 ( V_246 , & V_247 , sizeof( * V_246 ) ) )
return - V_209 ;
return 0 ;
}
...
if ( V_83 )
goto V_270;
F_134 (KERN_INFO KBUILD_MODNAME L_90 DRIVER_VERSION L_91
DRIVER_DESC L_92 ) ;
V_83 = F_135 ( & V_271 ) ;
if ( V_83 )
goto V_272;
