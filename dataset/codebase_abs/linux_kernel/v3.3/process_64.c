...
V_9 = F_21 ( ( unsigned ) V_7 -> V_12 [ 14 ] ) ;
V_11 = F_22 () ;
F_23 ( V_13 ) ;
if ( F_24 ( & V_10 , V_9 , sizeof( V_10 ) ) ) {
F_23 ( V_11 ) ;
return;
}
F_23 ( V_11 ) ;
...
if ( V_7 -> V_18 & V_19 )
F_25 ( L_9 , ( void * ) V_17 -> V_15 [ 7 ] ) ;
}
void F_28 ( struct V_6 * V_7 )
{
F_25 ( L_10 , V_7 -> V_18 ,
V_7 -> V_22 , V_7 -> V_23 , V_7 -> V_24 , F_29 () ) ;
F_25 ( L_11 , ( void * ) V_7 -> V_22 ) ;
F_25 ( L_12 ,
...
V_7 -> V_12 [ 15 ] ) ;
F_25 ( L_16 , ( void * ) V_7 -> V_12 [ 15 ] ) ;
F_26 ( V_7 ) ;
F_30 ( V_25 , ( unsigned long * ) V_7 -> V_12 [ V_26 ] ) ;
}
static void F_31 ( struct V_27 * V_28 , struct V_6 * V_7 ,
int V_29 )
{
F_32 () ;
...
V_9 = (struct V_16 * )
( V_7 -> V_12 [ V_26 ] + V_21 ) ;
if ( F_33 ( V_28 , ( unsigned long ) V_9 ) ) {
...
static void F_34 ( struct V_30 * V_36 )
{
int V_37 = 0 ;
...
unsigned long F_48 ( struct V_46 * V_47 )
{
struct V_27 * V_48 = F_49 ( V_47 ) ;
...
static unsigned long F_55 ( unsigned long V_58 , unsigned long V_59 )
{
unsigned long V_52 , V_60 , V_61 ;
if ( ! ( F_27 ( V_20 ) ) ) {
V_58 += V_21 ;
V_59 += V_21 ;
F_56 ( V_52 , & ( ( (struct V_16 T_1 * ) V_59 ) -> V_15 [ 6 ] ) ) ;
V_52 += V_21 ;
} else
F_56 ( V_52 , & ( ( (struct V_8 T_1 * ) V_59 ) -> V_15 [ 6 ] ) ) ;
V_58 &= ~ 15UL ;
V_60 = V_52 - V_59 ;
V_61 = ( V_58 - V_60 ) ;
if ( F_57 ( ( void T_1 * ) V_61 , ( void T_1 * ) V_59 , V_60 ) )
V_61 = 0 ;
else if ( F_27 ( V_20 ) ) {
if ( F_58 ( ( ( V_62 ) V_58 ) ,
...
static inline void F_59 ( int V_64 , int V_65 ,
struct V_27 * V_53 )
{
int V_66 ;
...
if ( ! F_63 ( ( char T_1 * ) V_51 , V_71 , V_69 ) ) {
F_59 ( V_68 , F_62 () - 1 , V_53 ) ;
F_54 ( F_62 () - 1 ) ;
}
} while ( V_68 -- );
}
}
static void F_64 ( unsigned long V_51 )
{
T_4 V_72 ;
V_72 . V_73 = V_74 ;
V_72 . V_75 = 0 ;
...
T_5 long F_70 ( unsigned long V_82 ,
unsigned long V_83 ,
struct V_6 * V_7 ,
unsigned long V_84 )
{
...
#ifdef F_71
if ( F_27 ( V_20 ) ) {
V_85 = F_21 ( V_7 -> V_12 [ V_89 ] ) ;
V_86 = F_21 ( V_7 -> V_12 [ V_90 ] ) ;
} else
#endif
{
...
int F_73 ( unsigned long V_82 , unsigned long V_51 ,
unsigned long V_92 ,
struct V_46 * V_93 , struct V_6 * V_7 )
{
struct V_27 * V_53 = F_49 ( V_93 ) ;
struct V_94 * V_95 ;
unsigned long V_96 ;
char * V_97 ;
int V_98 ;
...
T_6 V_98 ( int (* F_75)( void * ) , void * V_117 , unsigned long V_38 )
{
long V_118 ;
...
int F_76 ( struct V_6 * V_7 , T_7 * V_119 )
{
unsigned long * V_120 = F_38 () -> V_119 ;
unsigned long V_121 = F_38 () -> V_57 [ 0 ] ;
if ( F_27 ( V_20 ) ) {
T_8 * V_122 = ( T_8 * ) V_119 ;
if ( V_121 & V_123 )
...
if ( V_121 & V_129 ) {
V_122 -> V_130 = ( unsigned int ) F_38 () -> V_131 [ 0 ] ;
V_122 -> V_132 = 1 ;
} else {
V_122 -> V_130 = 0 ;
V_122 -> V_132 = 0 ;
...
sizeof( unsigned int ) * 32 ) ;
if( V_121 & V_129 ) {
V_119 -> V_130 = F_38 () -> V_131 [ 0 ] ;
V_119 -> V_134 = F_38 () -> V_135 [ 0 ] ;
} else {
...
T_5 int F_77 ( struct V_6 * V_7 )
{
int error , V_137 = 0 ;
char * V_138 ;
if ( V_7 -> V_12 [ V_139 ] == 0 )
V_137 = 1 ;
V_138 = F_78 ( ( char T_1 * ) V_7 -> V_12 [ V_137 + V_113 ] ) ;
error = F_79 ( V_138 ) ;
if ( F_80 ( V_138 ) )
goto V_140;
error = F_81 ( V_138 ,
...
unsigned long F_84 ( struct V_46 * V_41 )
{
