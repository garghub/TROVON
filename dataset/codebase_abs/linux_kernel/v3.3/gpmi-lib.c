...
static int F_5 ( void T_1 * V_4 , bool V_5 )
{
int V_6 ;
int V_3 = 0x400 ;
V_6 = F_1 ( V_4 , V_7 ) ;
...
static unsigned int F_24 ( unsigned int time ,
unsigned int V_48 , unsigned int V_49 )
{
unsigned int V_50 ;
V_50 = ( time + V_48 - 1 ) / V_48 ;
return F_25 ( V_50 , V_49 ) ;
}
...
if ( V_74 > V_56 -> V_85 )
V_74 = V_56 -> V_85 ;
#define F_27 ((int) ideal_sample_delay_in_ns)
#define F_28 \
((int) ((sample_delay_factor * clock_period_in_ns) >> \
dll_delay_shift))
#define F_29 (abs(QUANTIZED_DELAY - IDEAL_DELAY))
#define F_30 (DELAY_ERROR > (tEYE >> 1))
while ( F_30 &&
( V_71 < V_56 -> V_89 ) ) {
if ( F_28 > F_27 ) {
if ( V_74 != 0 )
...
int F_39 ( struct V_11 * V_12 , unsigned V_101 )
{
struct V_13 * V_14 = & V_12 -> V_13 ;
T_3 V_2 = 0 ;
T_3 V_25 = 0 ;
...
F_55 ( V_12 , V_127 ) ;
V_110 = V_108 -> V_121 -> V_122 ( V_108 , & V_12 -> V_134 ,
1 , V_128 , 1 ) ;
if ( ! V_110 ) {
F_8 ( L_19 ) ;
return - 1 ;
