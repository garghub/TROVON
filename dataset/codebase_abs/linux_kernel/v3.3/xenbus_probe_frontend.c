...
static void F_30 ( struct V_20 * V_48 ,
const char * * V_49 , unsigned int V_50 )
{
F_31 ( V_51 , V_49 [ V_24 ] , L_6 , L_16 , & V_52 ) ;
F_2 ( V_53 L_17 ,
V_49 [ V_24 ] , F_32 ( V_52 ) ) ;
F_33 ( & V_54 ) ;
}
static void F_34 ( char * V_55 , int V_56 )
{
long V_57 ;
V_57 = F_35 ( V_54 ,
V_52 == V_56 , 5 * V_45 ) ;
...
static void F_36 ( char * V_58 , char * V_55 , int V_59 )
{
struct V_20 V_60 ;
F_2 ( V_53 L_17 ,
V_55 , F_32 ( V_59 ) ) ;
memset ( & V_60 , 0 , sizeof( V_60 ) ) ;
V_60 . V_61 = F_5 ( V_62 | V_63 , L_19 , V_55 ) ;
if ( ! V_60 . V_61 )
return;
V_60 . V_64 = F_30 ;
V_52 = V_39 ;
...
switch ( V_59 ) {
case V_34 :
F_38 ( V_51 , V_58 , L_21 , L_22 , V_65 ) ;
F_34 ( V_55 , V_65 ) ;
case V_65 :
F_38 ( V_51 , V_58 , L_21 , L_22 , V_66 ) ;
F_34 ( V_55 , V_66 ) ;
case V_66 :
F_38 ( V_51 , V_58 , L_21 , L_22 , V_67 ) ;
F_34 ( V_55 , V_68 ) ;
}
F_39 ( & V_60 ) ;
F_2 ( V_36 L_23 , V_55 ) ;
...
static void F_40 ( char * V_69 , char * V_18 )
{
int V_59 , V_70 , V_9 ;
char * V_71 , * V_72 ;
V_72 = F_5 ( V_62 | V_63 , L_24 , V_69 , V_18 ) ;
if ( ! V_72 )
return;
V_9 = F_31 ( V_51 , V_72 , L_21 , L_16 , & V_70 ) ;
if ( V_9 != 1 )
goto V_73;
switch ( V_70 ) {
case V_34 :
...
F_2 ( V_53 L_25 ,
V_72 , F_32 ( V_70 ) ) ;
V_71 = F_41 ( V_51 , V_72 , L_8 , NULL ) ;
if ( ! V_71 || F_42 ( V_71 ) )
goto V_73;
V_9 = F_31 ( V_51 , V_71 , L_21 , L_16 , & V_59 ) ;
if ( V_9 == 1 )
F_36 ( V_72 , V_71 , V_59 ) ;
F_8 ( V_71 ) ;
break;
...
int V_75 , V_76 ;
int V_77 , V_78 ;
V_74 = F_44 ( V_51 , L_26 , L_6 , & V_75 ) ;
if ( F_42 ( V_74 ) )
return;
for ( V_77 = 0 ; V_77 < V_75 ; V_77 ++ ) {
V_18 = F_44 ( V_51 , L_26 , V_74 [ V_77 ] , & V_76 ) ;
if ( F_42 ( V_18 ) )
continue;
for ( V_78 = 0 ; V_78 < V_76 ; V_78 ++ )
F_40 ( V_74 [ V_77 ] , V_18 [ V_78 ] ) ;
F_8 ( V_18 ) ;
}
F_8 ( V_74 ) ;
}
