...
static void F_88 ( struct V_85 * V_44 )
{
struct V_2 * V_3 = V_44 -> V_3 ;
struct V_61 * V_22 = V_3 -> V_22 ;
struct V_51 * V_52 = F_18 ( V_22 ) ;
...
static int F_96 ( struct V_85 * V_44 ,
struct V_35 * V_36 )
{
struct V_2 * V_3 = V_44 -> V_3 ;
...
static void F_100 ( struct V_85 * V_44 ,
struct V_35 * V_36 )
{
struct V_2 * V_3 = V_44 -> V_3 ;
struct V_51 * V_52 = F_18 ( V_3 -> V_22 ) ;
...
static int F_103 ( struct V_85 * V_44 , T_4 V_254 )
{
struct V_2 * V_3 = V_44 -> V_3 ;
struct V_51 * V_52 = F_18 ( V_3 -> V_22 ) ;
...
if ( V_254 & V_261 ) {
struct V_62 * V_75 = V_44 -> V_64 . V_63 ;
int V_262 = V_75 -> V_263 ;
F_40 ( V_52 , V_94 , L_41 ,
V_75 -> V_76 ) ;
F_105 ( & V_3 -> V_22 -> V_264 [ V_262 ] ,
V_44 -> V_64 . V_63 ,
V_44 -> V_64 . V_265 ) ;
if ( F_39 ( V_3 , V_44 , & V_3 -> V_22 -> V_264 [ V_262 ] ) < 0 ) {
F_30 ( V_52 , L_42 ) ;
F_6 ( & V_3 -> V_69 ) ;
return - V_7 ;
}
...
static void F_107 ( struct V_85 * V_44 ,
unsigned int V_270 ,
unsigned int * V_271 ,
T_5 V_272 )
{
...
static int F_111 ( struct V_85 * V_44 ,
struct V_35 * V_36 ,
struct V_127 * V_128 )
{
struct V_2 * V_3 = V_44 -> V_3 ;
...
F_7 ( V_3 ) ;
V_133 = (struct V_132 * ) V_128 -> V_131 ;
F_112 ( V_3 -> V_82 , V_133 -> V_100 ) ;
V_20 = F_48 ( V_3 , V_36 , V_128 ) ;
F_8 ( V_3 ) ;
F_6 ( & V_3 -> V_69 ) ;
return V_20 ;
}
static int F_113 ( struct V_85 * V_44 ,
struct V_35 * V_36 , T_3 V_276 ,
...
V_280 . V_283 = V_278 -> V_284 ;
V_280 . V_285 = V_278 -> V_286 ;
V_280 . V_287 = V_278 -> V_288 ;
V_280 . V_289 = V_278 -> V_290 ;
V_281 = F_114 ( V_276 , V_3 -> V_291 ) ;
F_40 ( V_52 , V_94 ,
L_46 ,
V_276 , V_281 , V_278 -> V_284 , V_278 -> V_286 ,
V_278 -> V_288 , V_278 -> V_290 ) ;
V_20 = F_115 ( V_3 , V_281 , & V_280 ) ;
if ( V_20 ) {
F_30 ( V_52 , L_47 ) ;
goto V_252;
}
if ( ( V_3 -> V_22 -> V_57 == V_58 ) &&
( V_281 == V_3 -> V_291 [ V_292 ] ) )
F_116 ( V_3 ) ;
V_252:
F_8 ( V_3 ) ;
F_6 ( & V_3 -> V_69 ) ;
...
static int F_117 ( struct V_85 * V_44 ,
enum V_293 V_294 ,
struct V_35 * V_36 ,
struct V_127 * V_128 ,
struct V_295 * V_296 )
...
switch ( V_294 ) {
case V_299 :
V_20 = F_118 ( V_52 , V_36 , V_128 , V_296 ) ;
if ( V_20 >= 0 ) {
V_296 -> V_300 = V_20 ;
V_296 -> V_92 |= V_301 ;
...
F_121 ( V_3 -> V_22 ) ;
F_40 ( V_52 , V_94 , L_49 ,
V_52 -> V_135 , V_52 -> V_309 ) ;
}
static void F_122 ( void * V_33 , T_1 * V_34 , struct V_35 * V_36 )
{
struct V_2 * V_3 = (struct V_2 * ) V_33 ;
struct V_51 * V_52 = F_18 ( V_3 -> V_22 ) ;
struct V_37 * V_38 = & V_36 -> V_38 ;
if ( ( V_36 -> type == V_60 ) && V_38 -> V_42 ) {
V_52 -> V_309 = V_38 -> V_310 ;
...
static void F_124 ( struct V_85 * V_44 ,
struct V_35 * V_36 ,
struct V_37 * V_38 ,
T_4 V_254 )
{
...
static T_5 F_128 ( struct V_85 * V_44 ,
struct V_35 * V_36 )
{
struct V_2 * V_3 = V_44 -> V_3 ;
T_5 V_322 ;
F_4 ( & V_3 -> V_69 ) ;
F_7 ( V_3 ) ;
V_322 = F_129 ( V_3 -> V_22 ) ;
F_8 ( V_3 ) ;
F_6 ( & V_3 -> V_69 ) ;
return V_322 ;
}
static void F_130 ( struct V_85 * V_44 ,
struct V_35 * V_36 , T_5 V_322 )
{
struct V_2 * V_3 = V_44 -> V_3 ;
F_4 ( & V_3 -> V_69 ) ;
F_7 ( V_3 ) ;
F_131 ( V_3 -> V_22 , V_322 ) ;
F_8 ( V_3 ) ;
F_6 ( & V_3 -> V_69 ) ;
}
...
static int F_134 ( struct V_85 * V_44 ,
struct V_35 * V_36 ,
enum V_179 V_180 ,
struct V_127 * V_128 ,
T_3 V_181 , T_3 * V_323 , T_1 V_324 )
{
struct V_2 * V_3 = V_44 -> V_3 ;
struct V_132 * V_133 ;
int V_20 = 0 ;
...
F_136 ( V_36 , V_128 -> V_54 , V_181 ) ;
break;
case V_328 :
V_133 = (struct V_132 * ) V_128 -> V_131 ;
F_62 ( & V_3 -> V_70 . V_189 ) ;
V_133 -> V_190 [ V_181 ] = V_329 ;
F_63 ( & V_3 -> V_70 . V_189 ) ;
break;
default:
...
static void F_138 ( struct V_85 * V_44 )
{
struct V_2 * V_3 = V_44 -> V_3 ;
F_4 ( & V_3 -> V_69 ) ;
F_62 ( & V_3 -> V_330 ) ;
...
static int F_139 ( struct V_85 * V_44 , T_4 V_331 )
{
return 0 ;
}
static void F_140 ( struct V_85 * V_44 ,
T_1 V_332 )
{
struct V_2 * V_3 = V_44 -> V_3 ;
F_4 ( & V_3 -> V_69 ) ;
...
static int F_141 ( struct V_85 * V_44 ,
struct V_35 * V_36 ,
const struct V_333 * V_49 )
{
struct V_2 * V_3 = V_44 -> V_3 ;
struct V_51 * V_52 = F_18 ( V_3 -> V_22 ) ;
struct V_334 V_335 ;
...
V_335 . V_119 = V_130 -> V_100 ;
V_335 . V_154 = V_336 ;
V_335 . V_49 = F_50 ( V_49 -> V_337 [ V_336 ] . V_338 ) ;
F_34 ( V_339 , & V_335 ) ;
if ( V_20 ) {
F_30 ( V_52 ,
L_55
...
V_335 . V_154 = V_340 ;
V_335 . V_49 = F_50 ( V_49 -> V_337 [ V_340 ] . V_338 ) ;
F_34 ( V_339 , & V_335 ) ;
if ( V_20 ) {
F_30 ( V_52 ,
L_57
...
F_40 ( V_52 , V_94 , L_58 ,
V_49 -> V_337 [ V_336 ] . V_338 ,
V_49 -> V_337 [ V_340 ] . V_338 ) ;
V_252:
return V_20 ;
}
static int F_142 ( struct V_85 * V_44 ,
struct V_341 * V_342 )
{
struct V_2 * V_3 = V_44 -> V_3 ;
struct V_61 * V_22 = V_3 -> V_22 ;
struct V_343 * V_344 = & V_22 -> V_345 ;
V_342 -> V_346 = V_344 -> V_347 ;
V_342 -> V_348 = V_344 -> V_349 ;
V_342 -> V_350 = V_344 -> V_351 ;
V_342 -> V_352 = V_344 -> V_353 ;
return 0 ;
}
