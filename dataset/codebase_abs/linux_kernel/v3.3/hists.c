...
V_91 = F_70 ( V_55 , V_113 , L_16 , V_44 , V_114 , V_36 ) ;
if ( V_112 )
V_91 += F_70 ( V_55 + V_91 , V_113 - V_91 ,
L_17 ,
...
static int F_71 ( struct V_123 * V_124 , int V_44 ,
...
struct V_157 , V_3 ) ;
struct V_123 * V_124 = F_89 ( V_90 , struct V_123 , V_22 ) ;
bool V_92 = F_46 ( V_35 , V_64 ) ;
unsigned long V_44 = V_124 -> V_5 . V_42 . V_44 [ V_118 ] ;
const char * V_36 = F_90 ( V_124 ) ;
char V_55 [ 256 ] , V_114 ;
...
V_85 ) ;
V_44 = F_69 ( V_44 , & V_114 ) ;
V_91 = F_70 ( V_55 , sizeof( V_55 ) , L_47 , V_44 ,
...
F_47 ( V_35 , V_161 ) ;
V_44 = F_69 ( V_44 , & V_114 ) ;
V_91 += F_70 ( V_55 , sizeof( V_55 ) , L_49 ,
V_44 , V_114 , V_114 == ' ' ? L_18 : L_11 ) ;
V_159 = V_55 ;
}
...
V_166 = F_89 ( V_164 -> V_33 . V_25 , struct V_123 , V_22 ) ;
else
V_166 = F_89 ( V_166 -> V_22 . V_25 , struct V_123 , V_22 ) ;
goto V_168;
case V_139 :
if ( V_166 -> V_22 . V_169 == & V_164 -> V_33 )
V_166 = F_89 ( V_164 -> V_33 . V_169 , struct V_123 , V_22 ) ;
else
V_166 = F_89 ( V_166 -> V_22 . V_169 , struct V_123 , V_22 ) ;
goto V_168;
case V_148 :
if ( ! F_77 ( & V_158 -> V_3 ,
L_36 ) )
...
const char * V_36 = F_90 ( V_166 ) ;
T_1 V_173 = strlen ( V_36 ) + 7 ;
if ( V_158 . V_3 . V_4 < V_173 )
V_158 . V_3 . V_4 = V_173 ;
if ( V_166 -> V_58 == NULL )
V_166 -> V_58 = F_94 ( V_36 ) ;
}
return F_91 ( & V_158 , V_164 -> V_6 , V_162 , F_33 ,
V_37 , V_38 ) ;
}
int F_95 ( struct V_163 * V_164 , const char * V_162 ,
void (* F_33)( void * V_37 ) , void * V_37 ,
int V_38 )
{
if ( V_164 -> V_6 == 1 ) {
struct V_123 * V_23 = F_89 ( V_164 -> V_33 . V_25 ,
struct V_123 , V_22 ) ;
const char * V_36 = F_90 ( V_23 ) ;
return F_71 ( V_23 , V_164 -> V_6 , V_162 ,
V_36 , false , F_33 , V_37 ,
V_38 ) ;
}
return F_93 ( V_164 , V_162 ,
F_33 , V_37 , V_38 ) ;
}
