...
static void F_127 ( struct V_177 * V_178 , struct V_16 * V_16 )
{
...
static struct F_13 *
F_133 ( struct V_177 * V_178 , struct V_16 * V_16 )
{
struct V_1 * V_2 ;
...
static int F_137 ( struct V_177 * V_187 , struct V_16 * V_147 ,
struct V_188 * V_189 )
{
struct V_19 * V_190 ;
struct V_191 * V_192 ;
...
static void F_142 ( struct V_177 * V_187 , struct V_16 * V_147 ,
struct V_188 * V_189 )
{
struct V_19 * V_190 ;
struct V_191 * V_192 ;
F_138 (task, cgrp, tset) {
V_192 = F_143 ( V_190 , V_194 , V_195 ) ;
if ( V_192 ) {
F_144 ( V_192 ) ;
F_145 ( V_192 ) ;
}
