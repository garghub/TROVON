...
V_100 = V_20 -> V_77 ;
if ( V_99 > 10 ) {
while ( V_99 >= 10 && V_20 -> V_77 < 63 ) {
V_20 -> V_77 ++ ;
V_99 /= 2 ;
}
} else if ( V_98 > 20 ) {
while ( V_98 >= 20 && V_20 -> V_77 > 0 ) {
V_20 -> V_77 -- ;
V_98 /= 2 ;
}
}
...
if ( V_20 -> V_94 &&
V_20 -> V_94 != V_101 )
V_20 -> V_77 = V_100 + ( V_20 -> V_77 - V_100 ) / 2 ;
if ( V_20 -> V_77 != V_100 ) {
V_20 -> V_94 = V_101 ;
F_7 ( V_1 , V_89 , V_20 -> V_77 ) ;
}
...
F_20 ( V_1 , V_20 -> V_118 , V_113 ) ;
return;
case 2 :
F_21 ( V_1 , V_120 , V_20 -> V_118 ,
V_113 ) ;
V_20 -> V_91 = V_115 ;
break;
}
...
error:
V_20 -> V_92 = 1 ;
F_21 ( V_1 , V_120 , NULL , 0 ) ;
F_21 ( V_1 , V_111 , NULL , 0 ) ;
}
...
F_21 ( V_1 , V_119 , V_106 , V_107 ) ;
}
static void F_24 ( struct V_1 * V_1 , T_2 * V_106 , int V_107 )
{
int V_80 = V_1 -> V_46 . V_71 [ V_1 -> V_81 ] . V_65 ;
if ( V_107 == 0 )
return;
if ( V_80 == 1 )
F_23 ( V_1 , V_106 , V_107 ) ;
else
...
static int F_26 ( struct V_1 * V_1 , T_2 * V_106 , int V_107 )
{
struct V_20 * V_20 = (struct V_20 * ) V_1 ;
T_2 V_129 ;
if ( V_107 != 2 )
...
const struct V_44 * V_45 )
{
return F_30 ( V_134 , V_45 , & V_135 , sizeof( struct V_20 ) ,
V_136 ) ;
}
...
static int F_32 ( struct V_133 * V_134 )
{
return 0 ;
}
