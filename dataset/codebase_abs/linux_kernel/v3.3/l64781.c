...
static int F_11 ( struct V_20 * V_21 , T_3 * V_73 )
{
struct V_1 * V_2 = V_21 -> V_25 ;
int V_74 = F_4 ( V_2 , 0x32 ) ;
int V_75 = F_4 ( V_2 , 0x0e ) ;
F_4 ( V_2 , 0x00 ) ;
F_4 ( V_2 , 0x01 ) ;
* V_73 = 0 ;
if ( V_75 > 5 )
...
static int F_12 ( struct V_20 * V_21 , T_2 * V_81 )
{
struct V_1 * V_2 = V_21 -> V_25 ;
* V_81 = F_4 ( V_2 , 0x39 )
| ( F_4 ( V_2 , 0x3a ) << 8 ) ;
...
static int F_13 ( struct V_20 * V_21 , T_4 * V_82 )
{
struct V_1 * V_2 = V_21 -> V_25 ;
T_1 V_75 = F_4 ( V_2 , 0x0e ) ;
* V_82 = ( V_75 << 8 ) | V_75 ;
return 0 ;
}
static int F_14 ( struct V_20 * V_21 , T_4 * V_83 )
{
struct V_1 * V_2 = V_21 -> V_25 ;
T_1 V_84 = 0xff - F_4 ( V_2 , 0x33 ) ;
* V_83 = ( V_84 << 8 ) | V_84 ;
return 0 ;
}
static int F_15 ( struct V_20 * V_21 , T_2 * V_85 )
{
struct V_1 * V_2 = V_21 -> V_25 ;
* V_85 = F_4 ( V_2 , 0x37 )
| ( F_4 ( V_2 , 0x38 ) << 8 ) ;
...
struct V_20 * F_22 ( const struct V_92 * V_10 ,
struct V_93 * V_14 )
{
struct V_1 * V_2 = NULL ;
int V_94 = - 1 ;
...
V_2 = F_23 ( sizeof( struct V_1 ) , V_95 ) ;
...
memcpy ( & V_2 -> V_96 . V_39 , & V_97 , sizeof( struct V_98 ) ) ;
V_2 -> V_96 . V_25 = V_2 ;
return & V_2 -> V_96 ;
error:
if ( V_94 >= 0 )
