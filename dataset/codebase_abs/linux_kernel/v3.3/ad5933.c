...
F_6 ( V_9 , V_95 ) ;
V_9 -> V_81 = V_95 ;
F_39 ( & V_9 -> V_82 , V_9 -> V_96 ) ;
F_22 ( & V_47 -> V_50 ) ;
return;
}
F_4 ( V_9 -> V_2 , V_21 , 1 , & V_94 ) ;
if ( V_94 & V_97 ) {
int V_98 = F_37 ( V_47 -> V_71 ,
V_47 -> V_72 ) ;
F_4 ( V_9 -> V_2 ,
F_48 ( 1 , V_47 -> V_71 ) ?
V_99 : V_100 ,
...
V_93 -> V_77 -> V_101 ( V_93 , ( T_1 * ) V_45 , F_49 () ) ;
} else {
F_39 ( & V_9 -> V_82 , V_9 -> V_96 ) ;
F_22 ( & V_47 -> V_50 ) ;
return;
...
{
int V_6 , V_106 = 0 ;
struct V_107 * V_108 = V_2 -> V_7 . V_109 ;
struct V_8 * V_9 ;
...
V_9 -> V_41 = V_9 -> V_108 -> V_41 ;
if ( V_9 -> V_108 -> V_112 ) {
V_9 -> V_28 = V_9 -> V_108 -> V_112 ;
V_9 -> V_14 = V_113 ;
} else {
V_9 -> V_28 = V_114 ;
V_9 -> V_14 = V_115 ;
...
F_57 ( & V_9 -> V_82 , F_45 ) ;
V_9 -> V_96 = F_40 ( V_116 ) ;
V_47 -> V_7 . V_117 = & V_2 -> V_7 ;
V_47 -> V_118 = & V_119 ;
V_47 -> V_120 = V_105 -> V_120 ;
V_47 -> V_89 = V_121 ;
V_47 -> V_122 = V_73 ;
V_47 -> V_123 = 1 ;
V_6 = F_43 ( V_47 ) ;
