...
static int F_37 ( struct V_66 * V_66 , void * V_77 , struct V_78 * V_79 )
{
if ( V_79 -> V_80 > 0 )
return - V_81 ;
F_36 ( V_79 -> V_71 , L_12 , sizeof( V_79 -> V_71 ) ) ;
V_79 -> type = V_82 ;
V_79 -> V_83 = 0 ;
V_79 -> V_84 = 0 ;
V_79 -> V_85 = 0 ;
...
static int F_38 ( struct V_66 * V_66 , void * V_77 , unsigned int * V_87 )
{
* V_87 = 0 ;
return 0 ;
}
static int F_39 ( struct V_66 * V_66 , void * V_77 , unsigned int V_87 )
{
return ( V_87 > 0 ) ? - V_81 : 0 ;
}
static int F_40 ( struct V_66 * V_66 , void * V_67 ,
struct V_88 * V_89 )
{
switch ( V_89 -> V_90 ) {
case V_91 :
return F_41 ( V_89 , 0 , 255 , 1 , 240 ) ;
case V_92 :
return F_41 ( V_89 , 0 , 255 , 1 , 192 ) ;
case V_93 :
return F_41 ( V_89 , 0 , 255 , 1 , 128 ) ;
}
return - V_81 ;
}
...
static int F_48 ( struct V_66 * V_66 , void * V_77 , struct V_98 * V_99 )
{
struct V_1 * V_1 = F_35 ( V_66 ) ;
struct V_100 * V_101 = & V_99 -> V_99 . V_101 ;
V_101 -> V_61 = V_1 -> V_61 ;
V_101 -> V_60 = V_1 -> V_60 ;
V_101 -> V_102 = V_103 ;
V_101 -> V_104 = V_105 ;
V_101 -> V_106 = 3 * V_1 -> V_61 ;
V_101 -> V_107 = 3 * V_1 -> V_61 * V_1 -> V_60 ;
V_101 -> V_108 = V_109 ;
return 0 ;
}
static int F_49 ( struct V_66 * V_66 , void * V_77 , struct V_98 * V_99 )
{
struct V_100 * V_101 = & V_99 -> V_99 . V_101 ;
if ( V_101 -> V_60 < 60 || V_101 -> V_61 < 80 ) {
V_101 -> V_60 = 60 ;
V_101 -> V_61 = 80 ;
} else if ( V_101 -> V_60 < 120 || V_101 -> V_61 < 160 ) {
V_101 -> V_60 = 120 ;
V_101 -> V_61 = 160 ;
} else {
V_101 -> V_60 = 240 ;
...
V_101 -> V_102 = V_103 ;
V_101 -> V_104 = V_105 ;
V_101 -> V_106 = 3 * V_101 -> V_61 ;
V_101 -> V_107 = 3 * V_101 -> V_61 * V_101 -> V_60 ;
V_101 -> V_108 = V_109 ;
return 0 ;
}
static int F_50 ( struct V_66 * V_66 , void * V_77 , struct V_98 * V_99 )
{
struct V_1 * V_1 = F_35 ( V_66 ) ;
struct V_100 * V_101 = & V_99 -> V_99 . V_101 ;
int V_96 = F_49 ( V_66 , V_77 , V_99 ) ;
if ( V_96 )
return V_96 ;
switch ( V_101 -> V_60 ) {
case 60 :
...
static int F_51 ( struct V_66 * V_66 , void * V_77 , struct V_114 * V_99 )
{
...
enum V_116 type = V_99 -> type ;
if ( V_99 -> V_80 > 0 )
return - V_81 ;
* V_99 = V_115 [ V_99 -> V_80 ] ;
V_99 -> type = type ;
return 0 ;
}
static T_3 F_52 ( struct V_66 * V_66 , char T_1 * V_30 ,
T_2 V_14 , T_4 * V_117 )
{
struct V_1 * V_1 = F_35 ( V_66 ) ;
int V_47 ;
...
static struct V_1 * F_53 ( struct V_118 * V_20 )
{
struct V_1 * V_1 ;
struct V_5 * V_6 ;
V_1 = F_54 ( sizeof( * V_1 ) , V_119 ) ;
if ( V_1 == NULL )
return NULL ;
V_6 = & V_1 -> V_6 ;
...
NULL , 0 , NULL ) ;
V_1 -> V_33 = ( V_1 -> V_3 -> V_120 & V_121 ) ? 1 : 0 ;
if ( V_1 -> V_19 == NULL ) {
F_11 ( V_6 , L_16 , V_20 -> V_71 ) ;
F_56 ( V_1 ) ;
return NULL ;
}
F_36 ( V_1 -> V_122 . V_71 , L_17 , sizeof( V_1 -> V_122 . V_71 ) ) ;
V_1 -> V_122 . V_6 = V_6 ;
...
static int F_60 ( struct V_118 * V_20 )
{
struct V_1 * V_1 ;
struct V_5 * V_6 ;
if ( V_118 [ 0 ] != - 1 ) {
int V_2 , V_129 = 0 ;
for ( V_2 = 0 ; V_2 < V_130 && V_118 [ V_2 ] != - 1 ; V_2 ++ ) {
if ( V_118 [ 0 ] == V_20 -> V_131 )
V_129 = 1 ;
}
if ( ! V_129 )
return - V_132 ;
...
F_25 ( V_1 ) ;
F_46 ( V_1 -> V_19 ) ;
if ( F_62 ( & V_1 -> V_122 , V_135 , V_136 ) < 0 ) {
F_11 ( V_6 , L_18 ,
V_1 -> V_3 -> V_71 ) ;
F_61 ( V_1 -> V_19 ) ;
F_56 ( V_1 ) ;
...
static void F_67 ( struct V_118 * V_20 )
{
F_60 ( V_20 ) ;
}
static void F_68 ( struct V_118 * V_20 )
{
}
