...
static T_1 int F_23 ( struct V_60 * V_61 )
{
...
V_16 = F_24 ( & V_61 -> V_21 , sizeof( struct V_15 ) ,
V_63 ) ;
if ( ! V_16 ) {
F_5 ( & V_61 -> V_21 , L_22 ) ;
V_43 = - V_64 ;
...
static int T_2 F_41 ( struct V_60 * V_61 )
{
struct V_13 * V_14 = F_42 ( V_61 ) ;
struct V_15 * V_16 = F_2 ( V_14 ) ;
struct V_33 * V_34 = & V_16 -> V_34 ;
if ( V_16 -> V_35 & V_56 )
F_43 ( & V_54 ,
