...
struct V_212 * V_213 = V_26 -> V_51 . V_214 ;
T_1 V_215 ;
int V_6 = 0 ;
int V_216 = V_217 ;
if ( ( V_210 -> V_66 ) & V_218 )
...
V_50 = F_59 ( - 1 , V_43 -> V_72 , V_216 , 0 ) ;
if ( F_60 ( V_50 ) ) {
F_24 ( & V_26 -> V_51 , L_35 ) ;
return V_50 ;
}
V_43 -> V_72 = V_50 ;
V_43 -> V_222 = V_43 -> V_72 + V_216 ;
#ifdef F_61
V_223 . V_72 = V_43 -> V_72 ;
V_223 . V_224 = V_216 ;
V_223 . V_214 = F_62 ( V_213 ) ;
V_223 . V_225 = & V_226 ;
F_63 ( & V_223 ) ;
#endif
if ( F_64 ( V_26 -> V_27 , V_227 ) == 0 ) {
F_18 ( & V_26 -> V_51 , L_36 ) ;
return - V_28 ;
}
if ( V_15 ) {
...
if ( V_26 -> V_234
&& V_43 -> V_72
&& V_43 -> V_222 > V_43 -> V_72 ) {
if ( F_37 () ) {
F_70 ( V_210 -> V_41 ) ;
V_50 = F_71 ( V_26 -> V_234 , V_43 -> V_72 ,
V_43 -> V_222 ) ;
} else {
V_50 = F_72 ( V_26 -> V_234 , V_43 -> V_72 ,
V_43 -> V_222 ) ;
}
if ( V_50 < 0 )
goto V_36;
...
if ( F_37 () ) {
F_10 ( V_33 , & V_215 , V_235 ) ;
V_215 &= ~ ( V_236 | V_237 | \
V_238 | V_239 ) ;
F_9 ( V_33 , V_215 , V_235 ) ;
}
#ifdef F_73
if ( V_213 )
V_50 = F_74 ( V_213 , NULL , NULL , & V_26 -> V_51 ) ;
else
#endif
