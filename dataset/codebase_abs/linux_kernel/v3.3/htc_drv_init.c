...
{
int V_144 ;
switch ( F_60 ( V_2 -> V_10 ) ) {
case V_145 :
break;
case V_146 :
V_2 -> V_10 -> V_147 . V_148 = 7 ;
V_2 -> V_10 -> V_147 . V_149 = 6 ;
V_2 -> V_10 -> V_147 . V_150 = 8 ;
...
V_2 -> V_155 |= V_156 ;
V_10 = F_66 ( sizeof( struct V_53 ) , V_157 ) ;
if ( ! V_10 )
return - V_158 ;
V_10 -> V_159 . V_24 = V_24 ;
V_10 -> V_159 . V_160 = V_25 ;
V_10 -> V_161 |= V_162 ;
V_10 -> V_163 . V_164 = F_27 ;
V_10 -> V_163 . V_165 = F_34 ;
V_10 -> V_163 . V_166 = F_39 ;
V_10 -> V_163 . V_167 = F_40 ;
V_10 -> V_163 . V_168 = F_42 ;
V_10 -> V_163 . V_169 = F_43 ;
V_2 -> V_10 = V_10 ;
V_55 = F_28 ( V_10 ) ;
V_55 -> V_170 = & V_10 -> V_163 ;
V_55 -> V_171 = & V_172 ;
V_55 -> V_10 = V_10 ;
V_55 -> V_12 = V_2 -> V_12 ;
V_55 -> V_2 = V_2 ;
...
( unsigned long ) V_2 ) ;
F_69 ( & V_2 -> V_181 , V_182 ,
( unsigned long ) V_2 ) ;
F_70 ( & V_2 -> V_183 , V_184 ) ;
F_71 ( & V_2 -> V_185 , V_186 ) ;
F_71 ( & V_2 -> V_187 , V_188 ) ;
F_72 ( & V_2 -> F_16 . V_189 , V_190 ,
( unsigned long ) V_2 ) ;
F_73 ( V_55 , & V_79 ) ;
V_55 -> V_191 = V_79 << 2 ;
V_26 = F_74 ( V_10 ) ;
...
if ( V_26 )
goto V_193;
for ( V_67 = 0 ; V_67 < V_194 ; V_67 ++ )
V_2 -> V_195 . V_196 [ V_67 ] = NULL ;
F_75 ( V_10 ) ;
F_57 ( V_2 ) ;
F_58 ( V_2 ) ;
if ( V_154 && strncmp ( V_154 , V_197 , 5 ) == 0 ) {
V_10 -> V_147 . V_198 = V_146 ;
if ( F_60 ( V_10 ) != V_145 )
F_59 ( V_2 ) ;
}
return 0 ;
...
if ( V_26 )
return - V_125 ;
V_2 -> V_232 = F_81 ( V_230 . V_233 ) ;
V_2 -> V_234 = F_81 ( V_230 . V_235 ) ;
...
struct V_240 * V_57 ;
char V_241 [ 64 ] ;
error = F_65 ( V_2 , V_24 , V_154 , V_25 ) ;
if ( error != 0 )
goto V_242;
V_10 = V_2 -> V_10 ;
V_55 = F_28 ( V_10 ) ;
...
if ( error != 0 )
goto V_243;
error = F_83 ( & V_55 -> V_244 , V_2 -> V_12 -> V_13 ,
F_23 ) ;
if ( error )
goto V_245;
V_57 = & V_55 -> V_244 ;
...
goto V_252;
if ( ! F_89 ( V_57 ) ) {
error = F_90 ( V_12 -> V_13 , V_57 -> V_253 ) ;
if ( error )
goto V_254;
}
error = F_91 ( V_2 -> V_10 ) ;
...
V_2 -> V_45 ,
V_2 -> V_47 ) ;
F_92 ( V_2 -> V_10 , V_241 , sizeof( V_241 ) ) ;
F_93 ( V_12 -> V_13 , L_21 , V_241 ) ;
F_94 ( V_2 ) ;
F_95 ( V_2 ) ;
return 0 ;
V_254:
...
int F_96 ( struct V_255 * V_256 , struct V_257 * V_8 ,
T_1 V_24 , char * V_154 , T_2 V_25 )
{
struct V_11 * V_12 ;
struct V_1 * V_2 ;
int V_26 ;
V_12 = F_97 ( sizeof( struct V_1 ) , & V_258 ) ;
if ( ! V_12 )
return - V_158 ;
V_2 = V_12 -> V_2 ;
V_2 -> V_12 = V_12 ;
...
void F_102 ( struct V_255 * V_256 , bool V_261 )
{
if ( V_256 -> V_259 ) {
if ( V_261 )
V_256 -> V_259 -> V_10 -> V_161 |= V_262 ;
F_9 ( V_256 -> V_259 ) ;
F_100 ( V_256 -> V_259 ) ;
F_101 ( V_256 -> V_259 -> V_12 ) ;
}
}
void F_103 ( struct V_255 * V_256 )
{
F_104 ( V_256 -> V_259 , V_263 ) ;
}
int F_105 ( struct V_255 * V_256 )
{
...
if ( V_26 )
return V_26 ;
V_26 = F_18 ( V_2 , V_2 -> V_10 -> V_159 . V_24 ,
V_2 -> V_10 -> V_159 . V_160 ) ;
return V_26 ;
}
