...
if ( ! V_20 )
return 0 ;
V_6 = F_6 ( & V_19 -> V_7 , sizeof( * V_6 ) , V_23 ) ;
if ( ! V_6 ) {
F_7 ( & V_19 -> V_7 , L_1 ) ;
V_22 = - V_24 ;
goto V_25;
...
if ( V_6 )
F_12 ( V_6 -> V_9 , F_8 ( V_6 -> V_9 ) ) ;
}
static int T_1 F_13 ( struct V_18 * V_19 ,
const struct V_33 * V_34 )
{
int V_35 , V_36 , V_37 , V_22 ;
F_10 ( & V_19 -> V_7 , NULL ) ;
V_36 = F_14 ( V_19 , 0 ) ;
if ( V_36 < 0 ) {
F_7 ( & V_19 -> V_7 , L_3 , V_36 ) ;
return V_36 ;
}
V_35 = ( V_36 & 0xfe ) >> 2 ;
V_37 = V_36 & 0x3 ;
if ( V_35 != 1 ) {
F_7 ( & V_19 -> V_7 , L_4 , V_35 ) ;
return - V_38 ;
}
F_15 ( & V_19 -> V_7 , L_5 , V_37 + 1 ) ;
V_22 = F_4 ( V_19 ) ;
if ( V_22 != 0 )
return V_22 ;
V_22 = F_16 ( & V_19 -> V_7 , & V_39 ,
& V_40 , 1 ) ;
if ( V_22 != 0 ) {
...
static int T_2 F_17 ( struct V_18 * V_19 )
{
F_18 ( & V_19 -> V_7 ) ;
F_11 ( V_19 ) ;
return 0 ;
