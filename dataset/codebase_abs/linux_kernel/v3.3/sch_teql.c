...
static struct V_84 * F_56 ( struct V_5 * V_6 ,
struct V_84 * V_85 )
{
struct V_25 * V_18 = F_40 ( V_6 ) ;
V_85 -> V_76 = V_18 -> V_76 ;
...
static int F_57 ( struct V_5 * V_6 , int V_86 )
{
struct V_25 * V_18 = F_40 ( V_6 ) ;
struct V_3 * V_8 ;
if ( V_86 < 68 )
...
V_26 = F_40 ( V_6 ) ;
F_63 ( V_26 -> V_88 . V_105 , V_6 -> V_106 , V_107 ) ;
V_49 = F_64 ( & V_26 -> V_88 ) ;
if ( V_49 ) {
F_65 ( V_6 ) ;
F_62 ( V_6 ) ;
