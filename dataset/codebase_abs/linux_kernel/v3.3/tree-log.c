...
F_89 ( V_70 ) -> V_120 = ( T_1 ) - 1 ;
if ( V_70 -> V_119 == 0 ) {
if ( F_31 ( V_70 -> V_121 ) ) {
V_5 = F_90 ( V_2 , V_4 , NULL , V_32 ,
V_117 , 1 ) ;
F_48 ( V_5 ) ;
}
...
V_50:
F_23 ( V_32 ) ;
V_5 = F_95 ( V_2 , V_4 , V_32 , V_35 -> V_43 , V_35 -> V_66 ,
...
if ( F_101 ( V_4 , V_21 , V_94 ) )
return - V_76 ;
V_96 = F_67 ( V_21 , V_94 ) ;
V_5 = F_96 ( V_2 , V_4 , V_32 , V_21 , V_94 , V_35 ) ;
F_48 ( V_5 ) ;
...
static T_2 int F_102 ( struct V_3 * V_4 ,
struct V_31 * V_32 ,
T_1 V_98 , int V_131 ,
T_1 * V_132 , T_1 * V_133 )
{
...
static int F_107 ( struct V_3 * log , struct V_20 * V_21 ,
struct V_22 * V_23 , T_1 V_24 )
{
int V_136 ;
struct V_31 * V_32 ;
...
if ( F_109 ( V_159 ) != * V_147 )
F_112 ( 1 ) ;
if ( V_32 -> V_49 [ * V_147 ] >=
F_104 ( V_159 ) )
break;
V_157 = F_113 ( V_159 , V_32 -> V_49 [ * V_147 ] ) ;
V_158 = F_114 ( V_159 , V_32 -> V_49 [ * V_147 ] ) ;
V_161 = F_115 ( V_4 , * V_147 - 1 ) ;
V_160 = V_32 -> V_48 [ * V_147 ] ;
V_156 = F_116 ( V_160 ) ;
V_89 = F_117 ( V_4 , V_157 , V_161 ) ;
if ( ! V_89 )
return - V_52 ;
if ( * V_147 == 1 ) {
...
F_112 ( * V_147 < 0 ) ;
F_112 ( * V_147 >= V_162 ) ;
V_32 -> V_49 [ * V_147 ] = F_104 ( V_32 -> V_48 [ * V_147 ] ) ;
F_124 () ;
return 0 ;
}
...
if ( V_33 + 1 < F_104 ( V_32 -> V_48 [ V_148 ] ) ) {
V_32 -> V_49 [ V_148 ] ++ ;
* V_147 = V_148 ;
F_112 ( * V_147 == 0 ) ;
return 0 ;
...
if ( ! V_32 )
return - V_52 ;
V_147 = F_109 ( log -> V_164 ) ;
V_166 = V_147 ;
V_32 -> V_48 [ V_147 ] = log -> V_164 ;
F_128 ( log -> V_164 ) ;
V_32 -> V_49 [ V_147 ] = 0 ;
while ( 1 ) {
V_165 = F_111 ( V_2 , log , V_32 , & V_147 , V_23 ) ;
if ( V_165 > 0 )
break;
if ( V_165 < 0 )
V_5 = V_165 ;
V_165 = F_125 ( V_2 , log , V_32 , & V_147 , V_23 ) ;
if ( V_165 > 0 )
break;
if ( V_165 < 0 )
V_5 = V_165 ;
...
int V_99 = V_60 % 2 ;
do {
F_134 ( & V_4 -> V_169 [ V_99 ] ,
& V_30 , V_170 ) ;
F_4 ( & V_4 -> V_7 ) ;
if ( V_4 -> V_15 -> V_171 !=
V_2 -> V_60 && V_4 -> V_167 < V_60 + 2 &&
F_135 ( & V_4 -> V_172 [ V_99 ] ) )
F_136 () ;
F_137 ( & V_4 -> V_169 [ V_99 ] , & V_30 ) ;
F_2 ( & V_4 -> V_7 ) ;
...
F_2 ( & V_4 -> V_7 ) ;
V_173 = V_4 -> V_167 % 2 ;
if ( F_135 ( & V_4 -> V_172 [ V_173 ] ) ) {
F_132 ( V_2 , V_4 , V_4 -> V_167 ) ;
F_4 ( & V_4 -> V_7 ) ;
return 0 ;
}
F_140 ( & V_4 -> V_172 [ V_173 ] , 1 ) ;
if ( F_135 ( & V_4 -> V_172 [ ( V_173 + 1 ) % 2 ] ) )
F_132 ( V_2 , V_4 , V_4 -> V_167 - 1 ) ;
while ( 1 ) {
unsigned long V_176 = V_4 -> V_13 ;
if ( ! F_141 ( V_4 , V_177 ) && V_4 -> V_12 ) {
F_4 ( & V_4 -> V_7 ) ;
F_142 ( 1 ) ;
F_2 ( & V_4 -> V_7 ) ;
}
...
V_175 = V_180 ;
V_5 = F_143 ( log , & log -> V_181 , V_175 ) ;
F_48 ( V_5 ) ;
F_144 ( & log -> V_168 , log -> V_164 ) ;
V_4 -> V_13 = 0 ;
V_4 -> V_167 ++ ;
log -> V_167 = V_4 -> V_167 ;
V_4 -> V_9 = 0 ;
...
F_145 ( log , & log -> V_181 , V_175 ) ;
F_4 ( & V_17 -> V_7 ) ;
V_5 = - V_178 ;
goto V_75;
}
V_174 = V_17 -> V_167 % 2 ;
if ( F_135 ( & V_17 -> V_172 [ V_174 ] ) ) {
F_145 ( log , & log -> V_181 , V_175 ) ;
F_132 ( V_2 , V_17 ,
V_17 -> V_167 ) ;
F_4 ( & V_17 -> V_7 ) ;
...
F_140 ( & V_17 -> V_172 [ V_174 ] , 1 ) ;
if ( F_135 ( & V_17 -> V_172 [ ( V_174 + 1 ) % 2 ] ) ) {
F_132 ( V_2 , V_17 ,
V_17 -> V_167 - 1 ) ;
}
F_138 ( V_2 , V_17 ) ;
...
F_48 ( V_5 ) ;
F_145 ( log , & log -> V_181 , V_175 ) ;
F_147 ( V_4 -> V_15 -> V_184 ,
V_17 -> V_164 -> V_27 ) ;
F_148 ( V_4 -> V_15 -> V_184 ,
F_109 ( V_17 -> V_164 ) ) ;
V_17 -> V_13 = 0 ;
V_17 -> V_167 ++ ;
F_8 () ;
...
F_4 ( & V_4 -> V_7 ) ;
V_183:
F_140 ( & V_17 -> V_172 [ V_174 ] , 0 ) ;
F_8 () ;
if ( F_12 ( & V_17 -> V_169 [ V_174 ] ) )
F_13 ( & V_17 -> V_169 [ V_174 ] ) ;
V_75:
F_140 ( & V_4 -> V_172 [ V_173 ] , 0 ) ;
F_8 () ;
...
if ( V_5 )
break;
F_154 ( & log -> V_181 , V_27 , V_187 ,
V_179 | V_180 , V_51 ) ;
}
F_123 ( log -> V_164 ) ;
F_25 ( log ) ;
}
int F_155 ( struct V_1 * V_2 , struct V_3 * V_4 )
{
if ( V_4 -> V_8 ) {
F_152 ( V_2 , V_4 -> V_8 ) ;
V_4 -> V_8 = NULL ;
...
if ( V_94 ) {
V_5 = F_159 ( V_2 , log , V_32 , V_94 ) ;
V_189 += V_96 ;
F_48 ( V_5 ) ;
}
F_23 ( V_32 ) ;
V_94 = F_71 ( V_2 , log , V_32 , V_190 ,
V_99 , V_95 , V_96 , - 1 ) ;
if ( F_72 ( V_94 ) ) {
V_6 = F_158 ( V_94 ) ;
goto V_193;
...
log = V_4 -> V_8 ;
F_2 ( & F_89 ( V_70 ) -> V_7 ) ;
V_5 = F_161 ( V_2 , log , V_95 , V_96 , F_45 ( V_70 ) ,
V_98 , & V_99 ) ;
F_4 ( & F_89 ( V_70 ) -> V_7 ) ;
if ( V_5 == - V_182 ) {
V_4 -> V_15 -> V_171 = V_2 -> V_60 ;
...
V_5 = F_166 ( V_4 , V_32 , V_117 , V_131 ) ;
if ( V_5 == 0 ) {
struct V_34 V_204 ;
F_87 ( V_32 -> V_48 [ 0 ] , & V_204 ,
V_32 -> V_49 [ 0 ] ) ;
if ( V_131 == V_204 . type )
V_195 = F_167 ( V_198 , V_204 . V_66 ) + 1 ;
}
goto V_205;
}
V_5 = F_166 ( V_4 , V_32 , V_117 , V_131 ) ;
if ( V_5 == 0 ) {
struct V_34 V_204 ;
F_87 ( V_32 -> V_48 [ 0 ] , & V_204 , V_32 -> V_49 [ 0 ] ) ;
if ( V_131 == V_204 . type ) {
V_195 = V_204 . V_66 ;
...
F_87 ( V_202 , V_213 + V_148 , V_148 + V_207 ) ;
}
V_5 = F_172 ( V_2 , log , V_197 ,
V_213 , V_214 , V_208 ) ;
if ( V_5 ) {
F_25 ( V_215 ) ;
return V_5 ;
...
if ( F_173 ( V_213 + V_148 ) == V_155 ) {
int V_61 ;
V_212 = F_39 ( V_202 , V_207 + V_148 ,
struct V_68 ) ;
if ( F_174 ( V_202 , V_212 ) < V_2 -> V_60 )
continue;
...
if ( V_209 == V_217 )
V_206 = V_154 ;
V_5 = F_169 ( V_2 , log , V_32 , V_117 , V_206 ) ;
} else {
V_5 = F_177 ( V_2 , log , V_70 , 0 , 0 ) ;
}
if ( V_5 ) {
V_6 = V_5 ;
goto V_192;
...
V_5 = F_170 ( V_2 , log , V_197 , V_202 , V_222 ,
V_223 , V_209 ) ;
if ( V_5 ) {
V_6 = V_5 ;
goto V_192;
...
V_32 -> V_49 [ 0 ] ++ ;
if ( V_32 -> V_49 [ 0 ] < V_136 ) {
F_87 ( V_32 -> V_48 [ 0 ] , & V_200 ,
V_32 -> V_49 [ 0 ] ) ;
goto V_111;
}
if ( V_223 ) {
V_5 = F_170 ( V_2 , log , V_197 , V_202 ,
V_222 ,
V_223 , V_209 ) ;
if ( V_5 ) {
V_6 = V_5 ;
...
F_23 ( V_32 ) ;
F_23 ( V_197 ) ;
V_5 = F_168 ( V_2 , V_4 , V_70 , V_32 , V_197 ) ;
if ( V_5 ) {
V_6 = V_5 ;
goto V_192;
}
}
F_89 ( V_70 ) -> V_191 = V_2 -> V_60 ;
V_192:
F_4 ( & F_89 ( V_70 ) -> V_7 ) ;
F_78 ( V_32 ) ;
F_78 ( V_197 ) ;
...
if ( F_110 ( V_70 -> V_121 ) &&
F_89 ( V_70 ) -> V_231 <= V_229 &&
F_89 ( V_70 ) -> V_232 <= V_229 )
goto V_75;
if ( ! F_31 ( V_70 -> V_121 ) ) {
...
struct V_70 * V_70 )
{
struct V_3 * V_4 = F_89 ( V_70 ) -> V_4 ;
int V_5 = 0 ;
F_2 ( & V_4 -> V_7 ) ;
if ( F_89 ( V_70 ) -> V_191 == V_2 -> V_60 &&
F_89 ( V_70 ) -> V_235 <= V_4 -> V_186 )
V_5 = 1 ;
F_4 ( & V_4 -> V_7 ) ;
return V_5 ;
}
...
struct V_3 * V_4 , struct V_70 * V_70 ,
struct V_226 * V_160 , int V_236 )
{
int V_209 = V_236 ? V_217 : V_224 ;
struct V_227 * V_228 ;
struct V_226 * V_230 = NULL ;
int V_5 = 0 ;
T_1 V_229 = V_4 -> V_15 -> V_237 ;
V_228 = V_70 -> V_234 ;
if ( F_141 ( V_4 , V_238 ) ) {
V_5 = 1 ;
goto V_239;
...
if ( V_4 != F_89 ( V_70 ) -> V_4 ||
F_184 ( & V_4 -> V_168 ) == 0 ) {
V_5 = 1 ;
goto V_239;
}
V_5 = F_178 ( V_2 , V_70 , V_160 ,
V_228 , V_229 ) ;
if ( V_5 )
goto V_239;
if ( F_182 ( V_2 , V_70 ) ) {
...
{
struct V_226 * V_160 = F_180 ( V_226 ) ;
int V_5 ;
V_5 = F_183 ( V_2 , V_4 , V_226 -> V_233 , V_160 , 0 ) ;
F_181 ( V_160 ) ;
return V_5 ;
}
int F_186 ( struct V_3 * V_17 )
{
int V_5 ;
struct V_31 * V_32 ;
struct V_1 * V_2 ;
...
return - V_52 ;
V_15 -> V_243 = 1 ;
V_2 = F_187 ( V_15 -> V_185 , 0 ) ;
F_48 ( F_72 ( V_2 ) ) ;
V_23 . V_2 = V_2 ;
V_23 . V_25 = 1 ;
V_5 = F_127 ( V_2 , V_17 , & V_23 ) ;
F_48 ( V_5 ) ;
V_111:
V_35 . V_43 = V_44 ;
V_35 . V_66 = ( T_1 ) - 1 ;
...
& V_125 ) ;
F_48 ( F_72 ( log ) ) ;
V_242 . V_43 = V_125 . V_66 ;
V_242 . type = V_244 ;
V_242 . V_66 = ( T_1 ) - 1 ;
V_23 . V_146 = F_189 ( V_15 , & V_242 ) ;
F_48 ( F_99 ( V_23 . V_146 ) ) ;
V_23 . V_146 -> V_8 = log ;
F_190 ( V_2 , V_23 . V_146 ) ;
V_5 = F_127 ( V_2 , log , & V_23 ) ;
F_48 ( V_5 ) ;
if ( V_23 . V_149 == V_153 ) {
V_5 = F_91 ( V_2 , V_23 . V_146 ,
V_32 ) ;
F_48 ( V_5 ) ;
}
...
return;
V_247:
F_89 ( V_92 ) -> V_232 = V_2 -> V_60 ;
}
int F_193 ( struct V_1 * V_2 ,
struct V_70 * V_70 , struct V_70 * V_248 ,
struct V_226 * V_160 )
{
struct V_3 * V_4 = F_89 ( V_70 ) -> V_4 ;
if ( F_110 ( V_70 -> V_121 ) )
...
if ( F_89 ( V_70 ) -> V_191 <=
V_4 -> V_15 -> V_237 &&
( ! V_248 || F_89 ( V_248 ) -> V_191 <=
V_4 -> V_15 -> V_237 ) )
return 0 ;
return F_183 ( V_2 , V_4 , V_70 , V_160 , 1 ) ;
}
