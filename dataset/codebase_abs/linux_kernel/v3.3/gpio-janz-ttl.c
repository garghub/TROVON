...
static void T_3 F_7 ( struct V_4 * V_5 , T_1 V_19 , T_4 V_20 )
{
F_6 ( V_19 , & V_5 -> V_15 -> V_21 ) ;
F_6 ( V_20 , & V_5 -> V_15 -> V_21 ) ;
}
static void T_3 F_8 ( struct V_4 * V_5 )
{
...
static int T_3 F_9 ( struct V_32 * V_33 )
{
struct V_34 * V_35 ;
...
F_12 ( V_33 , V_5 ) ;
F_13 ( & V_5 -> V_12 ) ;
V_38 = F_14 ( V_33 , V_44 , 0 ) ;
if ( ! V_38 ) {
F_10 ( V_6 , L_3 ) ;
V_8 = - V_45 ;
goto V_46;
}
V_5 -> V_15 = F_15 ( V_38 -> V_47 , F_16 ( V_38 ) ) ;
if ( ! V_5 -> V_15 ) {
F_10 ( V_6 , L_4 ) ;
V_8 = - V_43 ;
goto V_46;
...
static int T_5 F_20 ( struct V_32 * V_33 )
{
