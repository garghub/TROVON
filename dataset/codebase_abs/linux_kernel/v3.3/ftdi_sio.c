...
static void F_69 ( struct V_6 * V_7 , int V_166 )
{
struct V_10 * V_11 = F_8 ( V_7 ) ;
F_27 ( & V_7 -> V_21 -> V_167 ) ;
if ( ! V_7 -> V_21 -> V_168 ) {
if ( ! V_166 && F_10 ( V_7 -> V_21 -> V_22 ,
F_11 ( V_7 -> V_21 -> V_22 , 0 ) ,
V_169 ,
V_170 ,
0 , V_11 -> V_25 , NULL , 0 ,
...
V_11 = F_8 ( V_7 ) ;
if ( V_11 -> V_37 == V_38 ) {
unsigned char * V_173 = V_171 ;
int V_124 , V_174 , V_175 ;
V_132 = 0 ;
F_75 ( & V_7 -> V_176 , V_32 ) ;
for ( V_124 = 0 ; V_124 < V_172 - 1 ; V_124 += V_11 -> V_127 ) {
V_174 = F_76 ( int , V_172 - V_124 , V_11 -> V_127 ) - 1 ;
V_175 = F_77 ( & V_7 -> V_177 , & V_173 [ V_124 + 1 ] , V_174 ) ;
if ( ! V_175 )
break;
V_11 -> V_148 . V_178 += V_175 ;
V_173 [ V_124 ] = ( V_175 << 2 ) + 1 ;
V_132 += V_175 + 1 ;
}
F_78 ( & V_7 -> V_176 , V_32 ) ;
} else {
V_132 = F_79 ( & V_7 -> V_177 , V_171 , V_172 ,
& V_7 -> V_176 ) ;
V_11 -> V_148 . V_178 += V_132 ;
}
return V_132 ;
}
static int F_80 ( struct V_28 * V_29 ,
struct V_6 * V_7 , struct V_10 * V_11 ,
char * V_179 , int V_174 )
{
int V_124 ;
char V_180 ;
char V_181 ;
char * V_182 ;
F_9 ( L_35 , V_16 , V_7 -> V_183 ) ;
if ( V_174 < 2 ) {
F_9 ( L_36 ) ;
return 0 ;
}
...
V_11 -> V_148 . V_199 ++ ;
F_82 ( V_7 ) ;
} else if ( V_179 [ 1 ] & V_200 ) {
V_181 = V_201 ;
V_11 -> V_148 . V_202 ++ ;
} else if ( V_179 [ 1 ] & V_203 ) {
V_181 = V_204 ;
V_11 -> V_148 . V_205 ++ ;
}
if ( V_179 [ 1 ] & V_206 ) {
...
if ( ! V_174 )
return 0 ;
V_11 -> V_148 . V_210 += V_174 ;
V_182 = V_179 + 2 ;
if ( V_7 -> V_7 . V_211 && V_7 -> V_212 ) {
for ( V_124 = 0 ; V_124 < V_174 ; V_124 ++ , V_182 ++ ) {
if ( ! F_84 ( V_7 , * V_182 ) )
F_83 ( V_29 , * V_182 , V_181 ) ;
}
} else {
F_85 ( V_29 , V_182 , V_181 , V_174 ) ;
}
return V_174 ;
}
static void F_86 ( struct V_213 * V_213 )
{
struct V_6 * V_7 = V_213 -> V_214 ;
struct V_28 * V_29 ;
struct V_10 * V_11 = F_8 ( V_7 ) ;
char * V_215 = ( char * ) V_213 -> V_216 ;
int V_124 ;
int V_174 ;
int V_132 = 0 ;
V_29 = F_87 ( & V_7 -> V_7 ) ;
if ( ! V_29 )
return;
for ( V_124 = 0 ; V_124 < V_213 -> V_217 ; V_124 += V_11 -> V_127 ) {
V_174 = F_76 ( int , V_213 -> V_217 - V_124 , V_11 -> V_127 ) ;
V_132 += F_80 ( V_29 , V_7 , V_11 , & V_215 [ V_124 ] , V_174 ) ;
}
if ( V_132 )
F_88 ( V_29 ) ;
F_89 ( V_29 ) ;
}
static void F_90 ( struct V_28 * V_29 , int V_218 )
{
struct V_6 * V_7 = V_29 -> V_219 ;
struct V_10 * V_11 = F_8 ( V_7 ) ;
T_2 V_12 ;
if ( V_218 )
V_12 = V_11 -> V_220 | V_221 ;
else
V_12 = V_11 -> V_220 ;
...
struct V_6 * V_7 , struct V_161 * V_224 )
{
struct V_70 * V_22 = V_7 -> V_21 -> V_22 ;
struct V_10 * V_11 = F_8 ( V_7 ) ;
struct V_161 * V_225 = V_29 -> V_225 ;
unsigned int V_226 = V_225 -> V_227 ;
T_2 V_12 ;
unsigned int V_228 = V_225 -> V_229 ;
unsigned char V_230 ;
unsigned char V_231 ;
F_9 ( L_14 , V_16 ) ;
if ( V_11 -> V_151 && ( ( V_225 -> V_227 & V_232 ) != V_233 ) ) {
F_9 ( L_40 , V_16 ) ;
...
if ( V_224 == 0 )
goto V_235;
if ( V_224 -> V_227 == V_225 -> V_227
&& V_224 -> V_236 == V_225 -> V_236
&& V_224 -> V_237 == V_225 -> V_237 )
goto V_238;
if ( ( V_224 -> V_227 & ( V_239 | V_240 | V_241 | V_242 | V_243 ) ) ==
( V_225 -> V_227 & ( V_239 | V_240 | V_241 | V_242 | V_243 ) ) )
goto V_244;
V_235:
V_12 = 0 ;
V_12 |= ( V_226 & V_243 ? V_245 :
V_246 ) ;
if ( V_226 & V_241 ) {
if ( V_226 & V_242 )
V_12 |= V_226 & V_240 ?
...
if ( V_226 & V_239 ) {
switch ( V_226 & V_239 ) {
case V_252 : V_12 |= 7 ; F_9 ( L_42 ) ; break;
case V_253 : V_12 |= 8 ; F_9 ( L_43 ) ; break;
default:
F_18 ( & V_7 -> V_22 , L_44 ) ;
}
}
...
V_16 ) ;
F_29 ( & V_11 -> V_89 ) ;
if ( ! V_224 || ( V_224 -> V_227 & V_232 ) == V_233 )
F_70 ( V_7 , V_14 | V_15 ) ;
}
V_238:
if ( V_226 & V_234 ) {
...
F_9 ( L_51 ,
V_16 , V_228 ) ;
V_231 = V_225 -> V_256 [ V_257 ] ;
V_230 = V_225 -> V_256 [ V_258 ] ;
V_12 = ( V_230 << 8 ) | ( V_231 ) ;
if ( F_10 ( V_22 ,
F_11 ( V_22 , 0 ) ,
V_169 ,
...
if ( V_146 < 0 )
goto V_260;
V_146 = ( V_77 [ 0 ] & V_263 ? V_264 : 0 ) |
( V_77 [ 0 ] & V_265 ? V_266 : 0 ) |
( V_77 [ 0 ] & V_267 ? V_268 : 0 ) |
( V_77 [ 0 ] & V_269 ? V_270 : 0 ) |
V_11 -> V_27 ;
V_260:
F_22 ( V_77 ) ;
return V_146 ;
...
struct V_6 * V_7 = V_29 -> V_219 ;
struct V_10 * V_11 = F_8 ( V_7 ) ;
struct V_272 * V_273 = & V_11 -> V_148 ;
V_148 -> V_186 = V_273 -> V_186 ;
V_148 -> V_188 = V_273 -> V_188 ;
V_148 -> V_190 = V_273 -> V_190 ;
V_148 -> V_192 = V_273 -> V_192 ;
V_148 -> V_178 = V_273 -> V_178 ;
V_148 -> V_210 = V_273 -> V_210 ;
V_148 -> V_205 = V_273 -> V_205 ;
V_148 -> V_202 = V_273 -> V_202 ;
V_148 -> V_207 = V_273 -> V_207 ;
V_148 -> V_199 = V_273 -> V_199 ;
V_148 -> V_274 = V_273 -> V_274 ;
return 0 ;
}
static int F_94 ( struct V_28 * V_29 ,
unsigned int V_275 , unsigned long V_276 )
{
struct V_6 * V_7 = V_29 -> V_219 ;
struct V_10 * V_11 = F_8 ( V_7 ) ;
struct V_272 V_277 ;
...
return - V_283 ;
V_277 = V_11 -> V_148 ;
if ( V_277 . V_190 == V_278 . V_190 && V_277 . V_188 == V_278 . V_188 &&
V_277 . V_192 == V_278 . V_192 && V_277 . V_186 == V_278 . V_186 )
return - V_134 ;
if ( ( ( V_276 & V_284 ) && ( V_277 . V_190 != V_278 . V_190 ) ) ||
( ( V_276 & V_264 ) && ( V_277 . V_188 != V_278 . V_188 ) ) ||
( ( V_276 & V_270 ) && ( V_277 . V_192 != V_278 . V_192 ) ) ||
( ( V_276 & V_266 ) && ( V_277 . V_186 != V_278 . V_186 ) ) ) {
return 0 ;
}
V_278 = V_277 ;
}
break;
case V_285 :
return F_30 ( V_7 , (struct V_82 T_3 * ) V_276 ) ;
break;
default:
break;
}
...
if ( V_287 > 0 && V_288 > 0 ) {
int V_124 ;
for ( V_124 = 0 ; V_289 [ V_124 ] . V_290 ; V_124 ++ )
;
V_289 [ V_124 ] . V_291 = V_292 ;
V_289 [ V_124 ] . V_290 = V_287 ;
V_289 [ V_124 ] . V_55 = V_288 ;
}
V_137 = F_98 ( & V_293 ) ;
if ( V_137 )
goto V_294;
