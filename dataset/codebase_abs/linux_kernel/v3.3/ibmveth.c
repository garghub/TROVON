...
static T_3 F_56 ( struct V_90 * V_49 ,
T_3 V_133 )
{
if ( ! ( V_133 & V_134 ) )
V_133 &= ~ V_135 ;
...
static int F_60 ( struct V_90 * V_49 ,
T_3 V_133 )
{
struct V_1 * V_2 = F_42 ( V_49 ) ;
...
static void F_61 ( struct V_90 * V_49 , T_1 V_157 , T_4 * V_50 )
{
int V_23 ;
if ( V_157 != V_158 )
return;
...
static T_5 F_69 ( struct V_38 * V_39 ,
struct V_90 * V_45 )
{
struct V_1 * V_2 = F_42 ( V_45 ) ;
unsigned int V_170 ;
...
const T_6 * V_193 = & F_70 ( V_39 ) -> V_194 [ V_23 ] ;
V_27 = F_80 ( & V_2 -> V_48 -> V_49 , V_193 , 0 ,
F_81 ( V_193 ) , V_191 ) ;
if ( F_22 ( & V_2 -> V_48 -> V_49 , V_27 ) )
goto V_195;
V_167 [ V_23 + 1 ] . V_53 . V_54 = V_170 | F_81 ( V_193 ) ;
...
F_82 ( & V_2 -> V_48 -> V_49 , V_167 [ V_23 ] . V_53 . V_56 ,
...
static int F_86 ( struct V_200 * V_92 , int V_201 )
{
struct V_1 * V_2 =
F_87 ( V_92 , struct V_1 , V_92 ) ;
...
static void F_100 ( struct V_90 * V_45 )
{
struct V_1 * V_2 = F_42 ( V_45 ) ;
unsigned long V_42 ;
if ( ( V_45 -> V_214 & V_215 ) ||
( F_101 ( V_45 ) > V_2 -> V_216 ) ) {
V_42 = F_102 ( V_2 -> V_48 -> V_61 ,
V_217 |
V_218 ,
0 ) ;
if ( V_42 != V_62 ) {
...
static int F_104 ( struct V_90 * V_49 , int V_225 )
{
struct V_1 * V_2 = F_42 ( V_49 ) ;
...
if ( V_229 && ( V_86 = F_41 ( V_2 -> V_45 ) ) )
return V_86 ;
return - V_231 ;
}
static void F_107 ( struct V_90 * V_49 )
{
F_28 ( F_42 ( V_49 ) ) ;
V_101 ( V_49 -> V_100 , V_49 ) ;
}
static unsigned long F_106 ( struct V_226 * V_48 )
{
struct V_90 * V_45 = F_108 ( & V_48 -> V_49 ) ;
struct V_1 * V_2 ;
unsigned long V_71 ;
int V_23 ;
int V_232 = 1 ;
...
V_71 += F_109 ( V_232 * sizeof( struct V_95 ) ) ;
return V_71 ;
}
static int T_8 F_110 ( struct V_226 * V_49 ,
...
unsigned char * V_238 ;
unsigned int * V_239 ;
F_111 ( & V_49 -> V_49 , L_43 ,
V_49 -> V_61 ) ;
V_238 = ( unsigned char * ) F_112 ( V_49 , V_240 ,
NULL ) ;
if ( ! V_238 ) {
F_113 ( & V_49 -> V_49 , L_44 ) ;
return - V_231 ;
}
V_239 = ( unsigned int * ) F_112 ( V_49 ,
V_241 , NULL ) ;
if ( ! V_239 ) {
F_113 ( & V_49 -> V_49 , L_45
L_46 ) ;
return - V_231 ;
}
V_45 = F_114 ( sizeof( struct V_1 ) ) ;
if ( ! V_45 )
return - V_93 ;
V_2 = F_42 ( V_45 ) ;
F_115 ( & V_49 -> V_49 , V_45 ) ;
V_2 -> V_48 = V_49 ;
V_2 -> V_45 = V_45 ;
V_2 -> V_216 = * V_239 ;
V_2 -> V_104 = 0 ;
F_116 ( V_45 , & V_2 -> V_92 , F_86 , 16 ) ;
if ( ( * V_238 & 0x3 ) != 0x02 )
V_238 += 2 ;
V_2 -> V_242 = 0 ;
...
V_19 [ V_23 ] ) ;
error = F_118 ( V_250 , & V_252 ,
& V_49 -> V_49 . V_250 , L_47 , V_23 ) ;
if ( ! error )
F_119 ( V_250 , V_253 ) ;
}
F_19 ( V_45 , L_48 , V_2 ) ;
...
static int T_9 F_122 ( struct V_226 * V_49 )
{
struct V_90 * V_45 = F_108 ( & V_49 -> V_49 ) ;
struct V_1 * V_2 = F_42 ( V_45 ) ;
int V_23 ;
for ( V_23 = 0 ; V_23 < V_66 ; V_23 ++ )
F_123 ( & V_2 -> V_67 [ V_23 ] . V_250 ) ;
F_124 ( V_45 ) ;
F_121 ( V_45 ) ;
F_115 ( & V_49 -> V_49 , NULL ) ;
return 0 ;
}
static T_10 F_125 ( struct V_249 * V_250 ,
struct V_254 * V_255 , char * V_182 )
{
struct V_14 * V_15 = F_87 ( V_250 ,
struct V_14 ,
V_250 ) ;
if ( V_255 == & V_256 )
...
static T_10 F_126 ( struct V_249 * V_250 , struct V_254 * V_255 ,
const char * V_182 , T_11 V_36 )
{
struct V_14 * V_15 = F_87 ( V_250 ,
struct V_14 ,
V_250 ) ;
struct V_90 * V_45 = F_108 (
F_87 ( V_250 -> V_259 , struct V_74 , V_250 ) ) ;
struct V_1 * V_2 = F_42 ( V_45 ) ;
long V_260 = F_127 ( V_182 , NULL , 10 ) ;
long V_86 ;
if ( V_255 == & V_256 ) {
if ( V_260 && ! V_15 -> V_22 ) {
if ( F_58 ( V_45 ) ) {
...
static int F_128 ( struct V_74 * V_49 )
{
struct V_90 * V_45 = F_108 ( V_49 ) ;
V_101 ( V_45 -> V_100 , V_45 ) ;
return 0 ;
}
static int T_12 F_129 ( void )
{
F_130 ( V_264 L_54 , V_130 ,
V_265 , V_132 ) ;
return F_131 ( & V_266 ) ;
}
