...
if ( V_183 == 0 || V_183 > V_14 -> V_124 . V_23 )
V_183 = V_14 -> V_124 . V_23 ;
}
F_110 ( V_183 == 0 ) ;
F_111 ( & V_14 -> V_184 , V_183 ) ;
}
static int
...
struct V_185 * V_186 ;
int V_113 ;
if ( V_109 == NULL || F_113 ( V_109 ) < sizeof( * V_186 ) )
return - V_114 ;
V_186 = F_63 ( V_109 ) ;
V_14 -> V_154 = V_186 -> V_154 ;
...
V_186 . V_154 = V_14 -> V_154 ;
F_96 ( V_94 , V_110 , sizeof( V_186 ) , & V_186 ) ;
return V_94 -> V_62 ;
V_159:
F_125 ( V_94 , V_188 ) ;
return - 1 ;
