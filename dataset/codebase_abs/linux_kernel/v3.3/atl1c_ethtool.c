...
sizeof( V_100 -> V_58 ) ) ;
F_25 ( V_100 -> V_104 , F_26 ( V_6 -> V_41 ) ,
sizeof( V_100 -> V_104 ) ) ;
V_100 -> V_105 = 0 ;
V_100 -> V_106 = 0 ;
V_100 -> V_107 = F_14 ( V_2 ) ;
V_100 -> V_108 = F_18 ( V_2 ) ;
}
static void F_27 ( struct V_1 * V_2 ,
struct V_109 * V_110 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
V_110 -> V_9 = V_111 | V_112 ;
V_110 -> V_113 = 0 ;
if ( V_6 -> V_110 & V_114 )
V_110 -> V_113 |= V_115 ;
if ( V_6 -> V_110 & V_116 )
...
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
if ( V_110 -> V_113 & ( V_122 | V_123 |
V_115 | V_119 | V_117 ) )
return - V_124 ;
V_6 -> V_110 = 0 ;
if ( V_110 -> V_113 & V_111 )
V_6 -> V_110 |= V_120 ;
if ( V_110 -> V_113 & V_112 )
V_6 -> V_110 |= V_121 ;
F_29 ( & V_6 -> V_41 -> V_42 , V_6 -> V_110 ) ;
return 0 ;
}
