...
static void F_28 ( struct V_40 * V_41 , int V_46 )
{
if ( ! V_46 ) {
...
F_7 ( L_17 ,
V_44 , V_37 ) ;
V_50 = F_37 ( V_41 , V_52 , 0 ) ;
if ( V_50 == NULL ) {
F_25 ( & V_41 -> V_17 , L_18 ) ;
return - V_51 ;
}
V_48 = F_38 ( V_50 -> V_53 , F_39 ( V_50 ) ,
V_41 -> V_54 ) ;
if ( V_48 == NULL ) {
F_25 ( & V_41 -> V_17 , L_19 ) ;
V_43 = - V_51 ;
...
static int F_45 ( struct V_40 * V_41 , T_4 V_59 )
{
V_60 = F_3 ( V_35 ) ;
F_28 ( V_41 , 0 ) ;
return 0 ;
