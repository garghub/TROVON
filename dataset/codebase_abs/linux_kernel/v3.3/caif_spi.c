...
V_10 -> V_39 . V_40 [ 0 ] = F_1 ( & V_10 -> V_39 . V_106 [ 0 ] ) ;
if ( ! V_10 -> V_39 . V_40 [ 0 ] ) {
V_96 = - V_107 ;
goto V_108;
}
V_10 -> V_39 . V_42 = F_1 ( & V_10 -> V_39 . V_109 ) ;
if ( ! V_10 -> V_39 . V_42 ) {
V_96 = - V_107 ;
goto V_110;
}
F_60 ( & V_10 -> V_111 , V_112 ) ;
F_61 ( & V_10 -> V_84 ) ;
V_10 -> V_113 = false ;
F_62 ( & V_10 -> V_88 ) ;
V_10 -> V_114 = F_63 ( V_91 -> V_9 ) ;
if ( ! V_10 -> V_114 ) {
F_36 ( V_83 L_23 ) ;
V_96 = - V_107 ;
goto V_115;
...
F_64 ( & V_10 -> V_89 ) ;
F_16 ( V_10 ) ;
V_10 -> V_81 . V_116 = F_35 ;
V_10 -> V_81 . V_117 = F_42 ;
V_10 -> V_81 . V_82 = V_10 ;
F_38 ( & V_118 ) ;
F_65 ( & V_10 -> V_119 , & V_120 ) ;
F_40 ( & V_118 ) ;
F_66 ( V_10 -> V_114 , & V_10 -> V_111 ) ;
return 0 ;
V_115:
F_3 ( V_10 -> V_39 . V_42 , V_10 -> V_39 . V_109 ) ;
V_110:
F_3 ( V_10 -> V_39 . V_40 [ 0 ] , V_10 -> V_39 . V_106 [ 0 ] ) ;
V_108:
return V_96 ;
}
...
V_91 -> V_123 = & V_124 ;
V_91 -> type = V_125 ;
V_91 -> V_92 = V_126 | V_127 ;
V_91 -> V_128 = 0 ;
V_91 -> V_129 = V_130 ;
V_91 -> V_131 = V_132 ;
F_71 ( & V_10 -> V_72 ) ;
F_71 ( & V_10 -> V_63 ) ;
V_10 -> V_78 . V_133 = V_134 ;
V_10 -> V_78 . V_135 = false ;
V_10 -> V_78 . V_136 = false ;
V_10 -> V_78 . V_137 = false ;
V_10 -> V_66 = V_91 ;
}
int F_72 ( struct V_138 * V_43 )
{
struct V_10 * V_10 = NULL ;
struct V_90 * V_66 ;
struct V_139 * V_91 ;
int V_96 ;
V_91 = (struct V_139 * ) V_43 -> V_91 . V_140 ;
V_66 = F_73 ( sizeof( struct V_10 ) ,
L_24 , F_70 ) ;
if ( ! V_91 )
return - V_107 ;
V_10 = F_45 ( V_66 ) ;
...
struct V_143 * V_145 ;
struct V_10 * V_10 = NULL ;
F_77 (list_node, n, &cfspi_list) {
V_10 = F_78 ( V_144 , struct V_10 , V_119 ) ;
F_79 ( V_10 -> V_66 ) ;
}
F_80 ( & V_7 . V_8 ,
& V_146 ) ;
