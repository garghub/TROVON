...
static int F_23 ( struct V_50 * V_6 )
{
...
static int F_27 ( struct V_50 * V_6 )
{
struct V_1 * V_2 = F_24 ( V_6 ) ;
F_25 ( & V_2 -> V_14 -> V_51 ) ;
if ( V_2 -> V_49 && ! V_2 -> V_48 && V_2 -> V_14 -> V_52 )
...
static void F_28 ( struct V_1 * V_2 , bool V_53 )
{
F_25 ( & V_2 -> V_14 -> V_51 ) ;
...
static T_4 F_29 ( struct V_50 * V_6 ,
struct V_54 * V_55 , char * V_9 )
{
struct V_1 * V_2 = F_24 ( V_6 ) ;
return sprintf ( V_9 , L_1 , V_2 -> V_48 ) ;
}
static T_4 F_30 ( struct V_50 * V_6 ,
struct V_54 * V_55 ,
...
struct V_1 * F_43 ( struct V_50 * V_6 , T_1 V_83 , unsigned int V_35 ,
