...
static int F_83 ( struct V_26 * V_27 , struct V_181 * V_182 , int V_183 )
{
struct V_1 * V_2 = F_22 ( V_27 ) ;
if ( ! F_84 ( V_27 ) )
return - V_184 ;
if ( ! V_2 -> V_105 )
return - V_184 ;
return F_85 ( V_2 -> V_105 , V_182 , V_183 ) ;
}
static T_5 F_86 ( struct V_185 * V_25 ,
...
V_48 += sprintf ( V_188 + V_48 , L_20 , V_2 -> V_23 ( V_2 , V_28 ) ,
( V_28 % 8 ) == 7 ? L_21 : L_22 ) ;
V_48 += sprintf ( V_188 + V_48 , L_21 ) ;
return V_48 ;
}
static int F_88 ( struct V_26 * V_27 , struct V_189 * V_183 )
{
struct V_1 * V_2 = F_22 ( V_27 ) ;
return F_89 ( V_2 -> V_105 , V_183 ) ;
}
static int F_90 ( struct V_26 * V_27 , struct V_189 * V_183 )
{
struct V_1 * V_2 = F_22 ( V_27 ) ;
return F_91 ( V_2 -> V_105 , V_183 ) ;
}
static int F_92 ( struct V_26 * V_27 )
{
struct V_1 * V_2 = F_22 ( V_27 ) ;
return F_93 ( V_2 -> V_105 ) ;
}
...
F_99 ( & V_2 -> V_155 ) ;
F_100 ( & V_2 -> V_64 ) ;
V_2 -> V_4 = F_101 ( V_19 -> V_25 . V_200 , 0 ) ;
if ( ! V_2 -> V_4 ) {
F_29 ( & V_19 -> V_25 , L_24 ) ;
goto V_201;
}
V_2 -> V_158 = 0 ;
V_67 = ( T_7 * ) F_102 ( V_19 -> V_25 . V_200 , L_25 , NULL ) ;
if ( V_67 && F_103 ( * V_67 ) ) {
V_2 -> V_158 |= V_202 ;
V_27 -> V_192 |= V_203 ;
}
V_67 = ( T_7 * ) F_102 ( V_19 -> V_25 . V_200 , L_26 , NULL ) ;
if ( V_67 && F_103 ( * V_67 ) )
V_2 -> V_158 |= V_159 ;
V_21 = F_104 ( V_19 -> V_25 . V_200 , L_27 , 0 ) ;
if ( ! V_21 ) {
F_29 ( & V_19 -> V_25 , L_28 ) ;
goto V_204;
}
...
V_2 -> V_179 = F_106 ( V_21 , 0 ) ;
V_2 -> V_176 = F_106 ( V_21 , 1 ) ;
F_105 ( V_21 ) ;
if ( ! V_2 -> V_179 || ! V_2 -> V_176 ) {
F_29 ( & V_19 -> V_25 , L_31 ) ;
V_173 = - V_60 ;
goto V_205;
}
V_69 = F_102 ( V_19 -> V_25 . V_200 , L_32 , & V_190 ) ;
if ( ( ! V_69 ) || ( V_190 != 6 ) ) {
F_29 ( & V_19 -> V_25 , L_33 ) ;
V_173 = - V_175 ;
goto V_205;
...
F_33 ( V_27 , ( void * ) V_69 ) ;
V_173 = F_107 ( V_2 , V_19 -> V_25 . V_200 ) ;
if ( V_173 )
F_108 ( & V_19 -> V_25 , L_34 ) ;
V_2 -> V_174 = F_104 ( V_19 -> V_25 . V_200 , L_35 , 0 ) ;
if ( V_2 -> V_174 )
F_20 ( V_2 -> V_25 , L_36 , V_21 -> V_206 , V_21 ) ;
V_173 = F_109 ( & V_2 -> V_25 -> V_207 , & V_208 ) ;
if ( V_173 ) {
F_29 ( V_2 -> V_25 , L_37 ) ;
goto V_205;
}
V_173 = F_110 ( V_2 -> V_27 ) ;
if ( V_173 ) {
