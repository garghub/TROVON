...
V_32 -> V_33 -> V_34 , V_26 ) ;
V_78 -> V_101 =
F_65 ( F_66 ( & V_13 -> V_102 ) ) ;
F_67 ( V_13 , V_2 , 1 ) ;
F_50 ( V_2 ) ;
} else {
if ( F_45 ( & V_13 -> V_94 ) != V_97 ) {
V_41 = F_68 ( V_13 , V_2 , V_53 ) ;
if ( V_41 )
goto V_84;
}
V_41 = F_69 ( V_2 , V_13 ) ;
...
void F_70 ( struct V_38 * V_77 ,
struct V_1 * V_2 , struct V_31 * V_108 ,
int V_109 )
{
struct V_13 * V_13 = F_39 ( V_77 ) ;
struct V_110 * V_110 ;
...
if ( F_76 ( ! F_71 ( V_2 , V_58 ) ) )
goto V_84;
V_2 -> V_115 = F_77 ( V_2 , V_77 ) ;
V_13 -> V_68 . V_116 ++ ;
V_13 -> V_68 . V_117 += V_2 -> V_3 + sizeof( struct V_53 ) ;
V_77 -> V_118 = V_24 ;
if ( F_78 ( V_13 , V_53 -> V_91 , V_53 -> V_93 ) )
goto V_84;
F_79 ( V_2 ) ;
goto V_17;
V_84:
...
struct V_13 * V_13 ;
int V_41 ;
V_77 = F_85 ( sizeof( * V_13 ) , V_44 , F_80 ) ;
if ( ! V_77 )
goto V_17;
V_41 = F_86 ( V_77 ) ;
if ( V_41 < 0 ) {
...
{
if ( V_33 -> V_120 -> V_156 == F_62 )
return 1 ;
return 0 ;
}
static int F_97 ( struct V_38 * V_52 , struct V_157 * V_158 )
{
V_158 -> V_159 = 0 ;
V_158 -> V_160 = 0 ;
F_98 ( V_158 , V_161 ) ;
...
struct V_173 * V_174 )
{
strcpy ( V_174 -> V_175 , L_21 ) ;
strcpy ( V_174 -> V_60 , V_176 ) ;
strcpy ( V_174 -> V_177 , L_22 ) ;
strcpy ( V_174 -> V_178 , L_23 ) ;
}
static T_2 F_100 ( struct V_38 * V_52 )
{
return - V_179 ;
}
static void F_101 ( struct V_38 * V_52 , T_2 V_180 )
{
}
