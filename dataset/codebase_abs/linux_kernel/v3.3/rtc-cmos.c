...
static int T_10
F_86 ( struct V_127 * V_128 , const struct V_129 * V_130 )
{
F_83 ( & V_128 -> V_13 ) ;
if ( F_87 ( V_128 , 0 ) == 0x70 && ! F_88 ( V_128 , 0 ) )
return F_46 ( & V_128 -> V_13 ,
F_89 ( V_128 , V_131 , 0 ) , 8 ) ;
else
return F_46 ( & V_128 -> V_13 ,
F_89 ( V_128 , V_131 , 0 ) ,
F_90 ( V_128 , 0 ) ) ;
}
static void T_8 F_91 ( struct V_127 * V_128 )
{
F_66 ( & V_128 -> V_13 ) ;
}
static int F_92 ( struct V_127 * V_128 , T_11 V_132 )
{
return F_68 ( & V_128 -> V_13 ) ;
}
static int F_93 ( struct V_127 * V_128 )
{
return F_73 ( & V_128 -> V_13 ) ;
}
static void F_94 ( struct V_127 * V_128 )
{
if ( V_133 == V_134 && ! F_72 ( & V_128 -> V_13 ) )
return;
F_65 () ;
}
static T_12 void F_95 ( struct V_135 * V_136 )
{
...
if ( ! V_138 )
return;
V_11 = F_96 ( V_138 , L_31 , NULL ) ;
if ( V_11 )
F_30 ( F_97 ( V_11 ) , V_33 ) ;
V_11 = F_96 ( V_138 , L_32 , NULL ) ;
if ( V_11 )
...
static inline void F_95 ( struct V_135 * V_136 ) {}
static int T_12 F_99 ( struct V_135 * V_136 )
{
F_95 ( V_136 ) ;
F_83 ( & V_136 -> V_13 ) ;
...
static int T_8 F_102 ( struct V_135 * V_136 )
{
F_66 ( & V_136 -> V_13 ) ;
return 0 ;
}
static void F_103 ( struct V_135 * V_136 )
{
if ( V_133 == V_134 && ! F_72 ( & V_136 -> V_13 ) )
return;
F_65 () ;
}
