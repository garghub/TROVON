...
break;
case V_87 :
V_3 = ( V_18 -> V_64 >> V_88 [ V_7 ] ) & 0x01 ;
break;
case V_89 :
V_3 = ( ( ( V_90 ) V_18 -> V_40 [ V_7 ] & 0xff00 ) == 0x8000 ) ;
break;
default:
V_3 = 0 ;
F_66 ( V_21 , L_5 , V_74 ) ;
...
return sprintf ( V_70 , L_6 , V_18 -> V_117 ) ;
}
...
{
struct V_17 * V_18 = F_36 ( V_21 ) ;
return sprintf ( V_70 , L_6 , F_83 ( V_18 -> V_34 , V_18 -> V_117 ) ) ;
}
static T_3 F_84 ( struct V_23 * V_21 , struct V_68 * V_69 ,
char * V_70 )
{
struct V_17 * V_18 = F_37 ( V_21 ) ;
return sprintf ( V_70 , L_14 , V_18 -> V_118 ) ;
}
static inline void F_85 ( int V_119 )
{
F_32 ( 0x55 , V_119 ) ;
}
static inline void F_86 ( int V_119 )
{
F_32 ( 0xaa , V_119 ) ;
}
static inline int F_87 ( int V_119 , int V_1 )
{
F_32 ( V_1 , V_119 ) ;
return F_33 ( V_119 + 1 ) ;
}
static inline void F_88 ( int V_119 , int V_1 , int V_4 )
{
F_32 ( V_1 , V_119 ) ;
F_32 ( V_4 , V_119 + 1 ) ;
}
static void F_77 ( struct V_23 * V_21 ,
struct V_120 * V_69 , T_5 V_121 )
{
if ( F_89 ( & V_21 -> V_122 , V_69 , V_121 ) ) {
F_31 ( V_21 , L_15 ,
V_69 -> V_118 ) ;
}
}
...
{
struct V_120 * * V_69 ;
for ( V_69 = V_124 -> V_125 ; * V_69 ; V_69 ++ ) {
F_77 ( V_21 , * V_69 , V_121 ) ;
}
}
...
if ( V_18 -> V_32 & V_43 ) {
F_92 ( & V_21 -> V_122 , & V_130 ) ;
}
if ( V_18 -> V_32 & V_33 ) {
F_92 ( & V_21 -> V_122 , & V_131 ) ;
}
if ( V_18 -> V_32 & V_59 ) {
F_92 ( & V_21 -> V_122 , & V_132 ) ;
}
if ( V_18 -> V_32 & V_62 ) {
F_92 ( & V_21 -> V_122 , & V_133 ) ;
}
if ( V_18 -> V_32 & V_37 ) {
F_92 ( & V_21 -> V_122 , & V_134 ) ;
}
F_92 ( & V_21 -> V_122 , & V_135 ) ;
if ( ! V_18 -> V_20 ) {
F_93 ( & V_21 -> V_122 , & V_136 . V_69 ) ;
}
}
...
int V_137 , V_7 ;
if ( ! V_18 -> V_20 ) {
V_137 = F_95 ( & V_21 -> V_122 , & V_136 . V_69 ) ;
if ( V_137 ) {
goto exit;
}
}
V_137 = F_96 ( & V_21 -> V_122 , & V_135 ) ;
if ( V_137 ) {
goto V_138;
}
if ( V_18 -> V_32 & V_43 ) {
V_137 = F_96 ( & V_21 -> V_122 ,
& V_130 ) ;
if ( V_137 ) {
goto V_138;
}
...
if ( V_18 -> V_32 & V_33 ) {
V_137 = F_96 ( & V_21 -> V_122 , & V_131 ) ;
if ( V_137 ) {
goto V_138;
}
}
if ( V_18 -> V_32 & V_59 ) {
V_137 = F_96 ( & V_21 -> V_122 , & V_132 ) ;
if ( V_137 ) {
goto V_138;
}
}
if ( V_18 -> V_32 & V_62 ) {
V_137 = F_96 ( & V_21 -> V_122 , & V_133 ) ;
if ( V_137 ) {
goto V_138;
}
}
if ( V_18 -> V_32 & V_37 ) {
V_137 = F_96 ( & V_21 -> V_122 , & V_134 ) ;
if ( V_137 ) {
goto V_138;
}
}
...
static int F_101 ( int V_119 , struct V_17 * V_18 )
{
int V_137 = 0 , V_1 ;
V_90 V_22 ;
F_85 ( V_119 ) ;
V_1 = V_150 ? V_150 : F_87 ( V_119 , 0x20 ) ;
if ( ! ( V_1 == V_151 || V_1 == V_152 ||
V_1 == V_153 ) ) {
V_137 = - V_154 ;
goto exit;
}
F_88 ( V_119 , 0x07 , 0x0a ) ;
V_22 = ( F_87 ( V_119 , 0x60 ) << 8 ) |
F_87 ( V_119 , 0x61 ) ;
if ( ! V_22 ) {
V_137 = - V_154 ;
goto exit;
...
static int T_6 F_116 ( int V_119 , unsigned short * V_22 )
{
int V_137 = 0 , V_1 ;
