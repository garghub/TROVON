...
static int F_44 ( struct V_3 * V_4 , unsigned long V_59 ,
...
static int F_46 ( struct V_3 * V_4 , unsigned long V_65 , struct V_3 * V_66 ,
struct V_3 * * V_67 )
{
struct V_5 * V_6 = F_2 ( V_4 ) ;
if ( V_66 == NULL )
...
static struct V_3 * F_47 ( struct V_3 * V_4 , unsigned long V_65 )
{
struct V_5 * V_6 = F_2 ( V_4 ) ;
return V_6 -> V_9 ;
}
static unsigned long F_48 ( struct V_3 * V_4 , T_2 V_68 )
{
return 1 ;
}
static void F_49 ( struct V_3 * V_4 , unsigned long V_65 )
{
}
static void F_50 ( struct V_3 * V_4 , struct V_69 * V_70 )
{
if ( ! V_70 -> V_71 ) {
