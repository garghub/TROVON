...
static int F_126 ( struct V_135 * V_135 , struct V_269 * V_270 )
{
struct V_114 * V_115 = V_135 -> V_229 ;
return F_127 ( & V_115 -> V_160 , V_270 ) ;
}
static struct V_243 * F_128 ( struct V_10 * V_11 ,
const struct V_243
...
snprintf ( V_190 -> V_156 , sizeof( V_190 -> V_156 ) , L_48 , V_11 -> V_156 , V_272 ) ;
F_130 ( V_190 , V_11 ) ;
return V_190 ;
}
...
{
int V_168 = - 1 ;
V_11 -> V_190 = F_128 ( V_11 , & V_277 , L_49 ) ;
if ( ! V_11 -> V_190 ) {
F_132 ( V_278 L_50 ,
V_11 -> V_156 ) ;
return - V_100 ;
}
F_133 ( & V_11 -> V_12 . V_14 ) ;
F_133 ( & V_11 -> V_12 . V_253 ) ;
V_168 = F_134 ( V_11 -> V_190 , V_247 , V_279 ) ;
if ( V_168 < 0 ) {
F_132 ( V_278 L_50 ,
V_11 -> V_156 ) ;
return V_168 ;
