...
static int F_34 ( struct V_11 * V_11 , int V_112 )
{
struct V_82 * V_82 = & V_11 -> V_82 ;
int V_113 ;
int V_104 ;
...
static T_2 F_40 ( struct V_11 * V_11 , void * V_122 , char * V_1 )
{
struct V_14 * V_15 = V_11 -> V_16 ;
return sprintf ( V_1 , L_22 , V_15 -> V_121 ) ;
}
static T_2 F_41 ( struct V_11 * V_11 , void * V_122 ,
const char * V_1 , T_3 V_123 )
{
struct V_14 * V_15 = V_11 -> V_16 ;
unsigned int V_124 ;
int V_104 ;
V_104 = F_42 ( V_1 , 10 , & V_124 ) ;
if ( V_104 )
return V_104 ;
if ( V_124 > 1 )
return - V_89 ;
if ( V_124 != V_15 -> V_121 ) {
V_104 = F_34 ( V_11 , V_124 ) ;
if ( ! V_104 )
V_15 -> V_121 = V_124 ;
}
return V_104 ? V_104 : V_123 ;
}
static T_2 F_43 ( struct V_11 * V_11 , void * V_122 , char * V_1 )
{
struct V_14 * V_15 = V_11 -> V_16 ;
return sprintf ( V_1 , L_23 , V_4 [ V_15 -> V_48 ] ) ;
}
static T_2 F_44 ( struct V_11 * V_11 , void * V_122 ,
...
static T_2 F_49 ( struct V_11 * V_11 ,
void * V_122 , char * V_1 )
{
return - V_89 ;
}
static T_2 F_50 ( struct V_11 * V_11 , void * V_122 ,
const char * V_1 , T_3 V_123 )
{
struct V_14 * V_15 = V_11 -> V_16 ;
unsigned int V_124 ;
...
static void F_51 ( struct V_11 * V_11 )
{
struct V_14 * V_15 = V_11 -> V_16 ;
F_52 ( & V_11 -> V_82 . V_116 -> V_56 ,
& V_132 . V_133 ) ;
F_52 ( & V_11 -> V_82 . V_116 -> V_56 ,
& V_134 . V_133 ) ;
if ( V_11 -> V_105 >= V_106 )
...
{
struct V_138 * V_139 = F_55 ( V_137 ) ;
struct V_14 * V_15 = F_56 ( V_139 , struct V_14 , V_28 ) ;
...
V_104 = F_58 ( & V_11 -> V_82 . V_116 -> V_56 ,
& V_132 . V_133 ) ;
if ( V_104 ) {
F_31 ( V_11 , L_25 ) ;
return V_104 ;
...
struct V_14 * V_15 ;
int V_104 ;
V_15 = F_60 ( sizeof( struct V_14 ) , V_148 ) ;
if ( ! V_15 ) {
V_104 = - V_129 ;
goto V_149;
}
...
static enum V_152 F_62 ( struct V_11 * V_11 )
{
struct V_82 * V_82 = & V_11 -> V_82 ;
...
F_12 ( V_11 , L_28 , V_153 [ 0 ] , V_153 [ 1 ] , V_153 [ 2 ] ) ;
if ( V_153 [ 0 ] != 0x67 || V_153 [ 1 ] != 0x00 )
return - V_155 ;
F_63 ( V_11 , L_29 , V_153 [ 2 ] ) ;
return V_153 [ 2 ] ;
}
int F_64 ( struct V_11 * V_11 , bool V_156 )
{
int V_157 ;
V_157 = F_62 ( V_11 ) ;
if ( V_157 < 0 )
