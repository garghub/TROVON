...
static int F_114 ( struct V_35 * V_35 , struct V_76 * V_185 )
{
struct V_170 V_171 ;
F_45 ( V_186 ) ;
F_115 ( & V_171 , V_35 , V_187 ) ;
while ( ! F_27 ( V_185 ) ) {
struct V_172 * V_173 = F_116 ( V_185 -> V_79 ) ;
F_117 ( V_173 ) ;
if ( ! F_118 ( & V_171 , V_173 ) )
F_119 ( V_173 , & V_186 ) ;
}
F_120 ( & V_171 ) ;
if ( ! F_27 ( & V_186 ) ) {
...
void F_122 ( struct V_189 * V_109 )
{
if ( F_93 ( ! V_109 -> V_190 ) ) {
F_123 ( V_109 ) ;
V_109 -> V_191 -> V_192 ( & V_109 -> V_193 , V_109 ) ;
} else {
F_3 ( L_41 , V_109 -> V_190 ) ;
if ( F_20 ( V_109 -> V_35 ) -> V_9 -> V_134 &
V_194 ) {
F_124 ( V_133 ,
& F_28 ( V_109 -> V_35 ) -> V_134 ) ;
F_125 ( V_109 -> V_35 ) ;
}
V_109 -> V_193 . V_195 = F_114 ( V_109 -> V_35 , & V_109 -> V_116 ) ;
}
V_109 -> V_191 -> V_196 ( V_109 ) ;
}
static void
F_126 ( struct V_170 * V_197 ,
struct V_189 * V_109 )
{
F_127 ( & V_109 -> V_116 , & V_197 -> V_198 ) ;
if ( V_109 -> V_173 && F_27 ( & V_109 -> V_173 -> V_199 ) )
F_119 ( V_109 -> V_173 , & V_197 -> V_198 ) ;
F_108 ( V_197 ) ;
V_197 -> V_200 = 1 ;
F_128 ( V_109 ) ;
}
static enum V_201
F_129 ( struct V_189 * V_202 ,
const struct V_203 * V_204 ,
struct V_46 * V_47 ,
int V_205 )
{
struct V_35 * V_35 = V_202 -> V_35 ;
enum V_201 V_206 ;
struct V_7 * V_8 = F_20 ( V_35 ) ;
V_202 -> V_191 = V_204 ;
V_202 -> V_47 = F_96 ( V_47 ) ;
F_3 ( L_42 , V_5 ,
V_35 -> V_90 , V_202 -> args . V_157 , V_202 -> args . V_67 , V_205 ) ;
V_206 = V_8 -> V_9 -> V_207 ( V_202 , V_205 ) ;
if ( V_206 == V_208 ) {
F_43 ( V_202 -> V_47 ) ;
V_202 -> V_47 = NULL ;
} else
...
static void
F_131 ( struct V_170 * V_197 , struct V_76 * V_185 , int V_205 )
{
struct V_189 * V_109 ;
const struct V_203 * V_204 = V_197 -> V_210 ;
struct V_46 * V_47 = V_197 -> V_174 ;
V_197 -> V_174 = NULL ;
while ( ! F_27 ( V_185 ) ) {
enum V_201 V_206 ;
V_109 = F_66 ( V_185 -> V_79 , struct V_189 , V_211 ) ;
F_41 ( & V_109 -> V_211 ) ;
V_206 = F_129 ( V_109 , V_204 , V_47 , V_205 ) ;
if ( V_206 == V_208 )
F_126 ( V_197 , V_109 ) ;
}
F_43 ( V_47 ) ;
...
int
F_132 ( struct V_170 * V_197 )
{
F_45 ( V_185 ) ;
int V_155 ;
V_155 = F_133 ( V_197 , & V_185 ) ;
if ( V_155 != 0 ) {
F_43 ( V_197 -> V_174 ) ;
V_197 -> V_174 = NULL ;
return V_155 ;
}
F_131 ( V_197 , & V_185 , V_197 -> V_212 ) ;
return 0 ;
}
static void F_134 ( struct V_213 * V_109 )
{
struct V_170 V_171 ;
F_43 ( V_109 -> V_47 ) ;
V_109 -> V_47 = NULL ;
...
V_194 )
F_125 ( V_109 -> V_35 ) ;
F_135 ( & V_171 , V_109 -> V_35 ) ;
while ( ! F_27 ( & V_109 -> V_116 ) ) {
struct V_172 * V_173 = F_116 ( V_109 -> V_116 . V_79 ) ;
F_117 ( V_173 ) ;
F_118 ( & V_171 , V_173 ) ;
}
F_120 ( & V_171 ) ;
}
void F_136 ( struct V_213 * V_109 )
{
if ( F_93 ( ! V_109 -> V_190 ) ) {
F_137 ( V_109 ) ;
V_109 -> V_191 -> V_192 ( & V_109 -> V_193 , V_109 ) ;
...
static enum V_201
F_140 ( struct V_213 * V_214 ,
const struct V_203 * V_204 ,
struct V_46 * V_47 )
{
struct V_35 * V_35 = V_214 -> V_35 ;
struct V_7 * V_8 = F_20 ( V_35 ) ;
enum V_201 V_206 ;
V_214 -> V_191 = V_204 ;
V_214 -> V_47 = F_96 ( V_47 ) ;
F_3 ( L_44 ,
V_5 , V_35 -> V_90 , V_214 -> args . V_157 , V_214 -> args . V_67 ) ;
V_206 = V_8 -> V_9 -> V_215 ( V_214 ) ;
if ( V_206 == V_208 ) {
F_43 ( V_214 -> V_47 ) ;
V_214 -> V_47 = NULL ;
} else {
...
static void
F_141 ( struct V_170 * V_197 , struct V_76 * V_185 )
{
struct V_213 * V_109 ;
const struct V_203 * V_204 = V_197 -> V_210 ;
struct V_46 * V_47 = V_197 -> V_174 ;
...
while ( ! F_27 ( V_185 ) ) {
enum V_201 V_206 ;
V_109 = F_66 ( V_185 -> V_79 , struct V_213 , V_211 ) ;
F_41 ( & V_109 -> V_211 ) ;
V_206 = F_140 ( V_109 , V_204 , V_47 ) ;
if ( V_206 == V_208 )
F_138 ( V_197 , V_109 ) ;
}
F_43 ( V_47 ) ;
...
int
F_142 ( struct V_170 * V_197 )
{
F_45 ( V_185 ) ;
int V_155 ;
V_155 = F_143 ( V_197 , & V_185 ) ;
if ( V_155 != 0 ) {
F_43 ( V_197 -> V_174 ) ;
V_197 -> V_174 = NULL ;
return V_155 ;
...
static void F_144 ( struct V_35 * V_35 , struct V_76 * V_217 )
{
struct V_46 * V_47 ;
F_2 (lseg, &NFS_I(inode)->layout->plh_segs, pls_list) {
if ( V_47 -> V_82 . V_74 == V_154 &&
F_40 ( V_218 , & V_47 -> V_52 ) )
F_14 ( & V_47 -> V_49 , V_217 ) ;
}
}
void F_145 ( struct V_46 * V_47 )
{
if ( V_47 -> V_82 . V_74 == V_154 ) {
F_3 ( L_45 , V_5 ) ;
F_37 ( F_78 ( V_154 ) , & V_47 -> V_53 -> V_56 ) ;
} else {
F_3 ( L_46 , V_5 ) ;
F_37 ( F_78 ( V_147 ) , & V_47 -> V_53 -> V_56 ) ;
}
}
void
F_123 ( struct V_189 * V_202 )
{
struct V_85 * V_86 = F_28 ( V_202 -> V_35 ) ;
T_6 V_219 = V_202 -> V_220 + V_202 -> V_167 . V_157 ;
bool V_221 = false ;
F_5 ( & V_86 -> V_87 . V_45 ) ;
...
if ( ! F_55 ( V_218 , & V_202 -> V_47 -> V_52 ) ) {
F_96 ( V_202 -> V_47 ) ;
}
if ( V_219 > V_86 -> V_44 -> V_222 )
V_86 -> V_44 -> V_222 = V_219 ;
F_6 ( & V_86 -> V_87 . V_45 ) ;
F_3 ( L_48 ,
V_5 , V_202 -> V_47 , V_86 -> V_44 -> V_222 ) ;
if ( V_221 )
F_146 ( V_202 -> V_35 ) ;
}
void F_147 ( struct V_223 * V_109 )
{
...
int
F_148 ( struct V_35 * V_35 , bool V_225 )
{
struct V_223 * V_109 ;
struct V_85 * V_86 = F_28 ( V_35 ) ;
T_6 V_219 ;
int V_24 = 0 ;
F_3 ( L_49 , V_5 , V_35 -> V_90 ) ;
...
if ( ! F_40 ( V_133 , & V_86 -> V_134 ) )
goto V_226;
if ( F_55 ( V_227 , & V_86 -> V_134 ) ) {
if ( ! V_225 ) {
V_24 = - V_106 ;
goto V_226;
}
V_24 = F_149 ( & V_86 -> V_134 , V_227 ,
V_228 , V_229 ) ;
if ( V_24 )
goto V_226;
}
...
F_124 ( V_227 , & V_86 -> V_134 ) ;
F_6 ( & V_35 -> V_45 ) ;
F_150 ( & V_86 -> V_134 , V_227 ) ;
goto V_226;
}
F_144 ( V_35 , & V_109 -> V_230 ) ;
V_219 = V_86 -> V_44 -> V_222 ;
V_86 -> V_44 -> V_222 = 0 ;
memcpy ( & V_109 -> args . V_96 . V_109 , V_86 -> V_44 -> V_95 . V_109 ,
sizeof( V_86 -> V_44 -> V_95 . V_109 ) ) ;
F_6 ( & V_35 -> V_45 ) ;
V_109 -> args . V_35 = V_35 ;
V_109 -> V_231 = F_91 ( V_86 -> V_44 -> V_41 ) ;
F_151 ( & V_109 -> V_232 ) ;
V_109 -> args . V_233 = F_20 ( V_35 ) -> V_234 ;
V_109 -> V_167 . V_232 = & V_109 -> V_232 ;
V_109 -> args . V_235 = V_219 - 1 ;
V_109 -> V_167 . V_12 = F_20 ( V_35 ) ;
V_24 = F_152 ( V_109 , V_225 ) ;
V_4:
if ( V_24 )
F_146 ( V_35 ) ;
F_3 ( L_50 , V_5 , V_24 ) ;
