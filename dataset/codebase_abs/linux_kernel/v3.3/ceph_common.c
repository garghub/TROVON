...
int F_24 ( struct V_35 * * V_72 , char * V_39 ,
const char * V_73 , const char * V_74 ,
int (* F_25)( char * V_75 , void * V_76 ) ,
void * V_76 )
{
struct V_35 * V_57 ;
const char * V_75 ;
int V_54 = - V_77 ;
T_1 V_78 [ V_79 ] ;
V_57 = F_26 ( sizeof( * V_57 ) , V_80 ) ;
if ( ! V_57 )
return V_54 ;
V_57 -> V_41 = F_27 ( V_81 , sizeof( * V_57 -> V_41 ) ,
V_80 ) ;
if ( ! V_57 -> V_41 )
goto V_68;
F_13 ( L_37 , V_57 , V_39 ,
...
V_57 -> V_88 = V_89 ;
V_57 -> V_90 = V_91 ;
V_54 = F_28 ( V_73 , V_74 , V_57 -> V_41 ,
V_81 , & V_57 -> V_49 ) ;
if ( V_54 < 0 )
goto V_68;
while ( ( V_75 = F_29 ( & V_39 , L_38 ) ) != NULL ) {
int V_92 , V_93 , V_43 ;
if ( ! * V_75 )
continue;
V_54 = - V_55 ;
V_92 = F_30 ( ( char * ) V_75 , V_94 , V_78 ) ;
if ( V_92 < 0 && F_25 ) {
V_54 = F_25 ( ( char * ) V_75 , V_76 ) ;
if ( V_54 < 0 ) {
F_5 ( L_39 , V_75 ) ;
goto V_68;
}
...
break;
case V_102 :
V_54 = F_12 ( V_78 [ 0 ] . V_97 , & V_57 -> V_31 ) ;
if ( V_54 == 0 )
V_57 -> V_82 |= V_103 ;
break;
case V_104 :
V_57 -> V_44 = F_32 ( V_78 [ 0 ] . V_97 ,
V_78 [ 0 ] . V_99 - V_78 [ 0 ] . V_97 ,
V_80 ) ;
break;
case V_105 :
V_57 -> V_45 = F_26 ( sizeof( * V_57 -> V_45 ) , V_80 ) ;
if ( ! V_57 -> V_45 ) {
V_54 = - V_77 ;
goto V_68;
}
V_54 = F_33 ( V_57 -> V_45 , V_78 [ 0 ] . V_97 ) ;
if ( V_54 < 0 )
goto V_68;
break;
case V_106 :
...
V_54 = F_17 ( V_57 -> V_45 , V_78 [ 0 ] . V_97 ) ;
if ( V_54 < 0 )
goto V_68;
break;
case V_107 :
...
struct V_28 * F_35 ( struct V_35 * V_57 , void * V_76 ,
unsigned V_117 ,
unsigned V_118 )
{
struct V_28 * V_29 ;
...
V_29 -> V_128 = F_40 ( V_120 ,
V_29 -> V_117 ,
V_29 -> V_118 ) ;
if ( F_19 ( V_29 -> V_128 ) ) {
V_54 = F_20 ( V_29 -> V_128 ) ;
goto V_129;
}
V_29 -> V_128 -> V_130 = F_39 ( V_29 , V_131 ) ;
V_54 = F_41 ( & V_29 -> V_50 , V_29 ) ;
if ( V_54 < 0 )
goto V_132;
V_54 = F_42 ( & V_29 -> V_133 , V_29 ) ;
if ( V_54 < 0 )
goto V_134;
return V_29 ;
V_134:
...
int F_50 ( struct V_28 * V_29 , unsigned long V_137 )
{
int V_54 ;
...
while ( ! F_49 ( V_29 ) ) {
V_54 = - V_140 ;
if ( V_138 && F_52 ( V_141 , V_137 + V_138 ) )
return V_54 ;
F_13 ( L_47 ) ;
V_54 = F_53 ( V_29 -> V_122 ,
F_49 ( V_29 ) || ( V_29 -> V_123 < 0 ) ,
V_138 ) ;
...
int F_54 ( struct V_28 * V_29 )
{
int V_43 ;
unsigned long V_137 = V_141 ;
F_13 ( L_48 ) ;
F_55 ( & V_29 -> V_121 ) ;
V_43 = F_50 ( V_29 , V_137 ) ;
F_56 ( & V_29 -> V_121 ) ;
return V_43 ;
}
