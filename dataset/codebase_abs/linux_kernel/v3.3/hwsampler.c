...
static void V_76 ( struct V_110 * V_111 )
{
unsigned int V_8 ;
int V_26 ;
struct V_9 * V_10 ;
V_10 = F_60 ( V_111 , struct V_9 , V_76 ) ;
V_8 = F_41 () ;
