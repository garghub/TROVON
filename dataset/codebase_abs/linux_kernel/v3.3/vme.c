...
F_64 ( & V_49 -> V_3 , L_58 , V_152 -> V_22 , V_21 -> V_144 ,
V_49 -> V_144 ) ;
V_154 = F_65 ( & V_49 -> V_3 ) ;
if ( V_154 )
goto V_161;
...
static int F_66 ( struct V_151 * V_152 , unsigned int V_153 )
{
struct V_4 * V_21 ;
int V_154 = 0 ;
F_14 ( & V_142 ) ;
F_67 (bridge, &vme_bus_list, bus_list) {
...
int F_68 ( struct V_151 * V_152 , unsigned int V_153 )
{
int V_154 ;
V_152 -> V_162 . V_22 = V_152 -> V_22 ;
V_152 -> V_162 . V_159 = & V_160 ;
F_30 ( & V_152 -> V_145 ) ;
V_154 = F_69 ( & V_152 -> V_162 ) ;
if ( V_154 )
return V_154 ;
V_154 = F_66 ( V_152 , V_153 ) ;
if ( V_154 )
F_70 ( & V_152 -> V_162 ) ;
return V_154 ;
}
void F_71 ( struct V_151 * V_152 )
{
...
static int F_72 ( struct V_2 * V_3 , struct V_164 * V_152 )
{
struct V_151 * V_165 ;
