...
static void T_1 F_3 ( struct V_6 * V_7 , struct V_8 * V_9 )
{
int V_10 ;
struct V_11 * V_12 ;
...
static T_2 F_38 ( int V_20 , void * V_66 )
{
...
static T_2 F_41 ( int V_20 , void * V_66 )
{
struct V_46 * V_47 = V_66 ;
struct V_48 * V_49 = F_29 ( V_47 ) ;
struct V_6 * V_28 = V_49 -> V_50 ;
...
static T_2 F_50 ( int V_20 , void * V_66 )
{
struct V_46 * V_47 = V_66 ;
struct V_48 * V_49 = F_29 ( V_47 ) ;
struct V_6 * V_28 = V_49 -> V_50 ;
...
static T_2 F_58 ( int V_20 , void * V_66 )
{
struct V_46 * V_47 = V_66 ;
struct V_48 * V_49 = F_29 ( V_47 ) ;
struct V_6 * V_28 = V_49 -> V_50 ;
...
V_28 -> V_77 . V_79 = ( unsigned char * ) F_65 ( NULL , V_89 , & V_87 , V_90 ) ;
V_28 -> V_77 . V_61 = 0 ;
V_28 -> V_77 . V_78 = 0 ;
V_28 -> V_83 = 0 ;
F_44 ( V_28 -> V_22 ,
...
static int F_73 ( struct V_8 * V_9 , T_4 V_52 )
{
struct V_6 * V_50 ;
struct V_46 * V_47 ;
struct V_48 * V_49 ;
...
static void F_79 ( struct V_99 * V_98 )
{
struct V_48 * V_49 = F_80 ( V_98 , struct V_48 , V_98 ) ;
struct V_46 * V_47 = V_49 -> V_50 -> V_47 ;
struct V_6 * V_28 = V_49 -> V_50 ;
unsigned short V_36 ;
int V_100 = 10 ;
while ( F_28 ( V_47 ) && -- V_100 )
...
static int F_81 ( struct V_102 * V_103 , struct V_46 * V_47 )
{
struct V_48 * V_49 = F_29 ( V_47 ) ;
int V_32 = F_82 ( V_103 ) ;
F_83 ( V_47 ) ;
...
V_49 -> V_55 . V_56 = F_85 ( V_103 , V_49 -> V_55 . V_57 , V_49 -> V_55 . V_104 ) ;
F_86 ( & V_49 -> V_98 ) ;
F_87 ( V_103 ) ;
return 0 ;
}
static int F_88 ( struct V_46 * V_47 , struct V_105 * V_105 , int V_106 )
{
...
static struct V_117 * F_91 ( struct V_46 * V_47 )
{
struct V_48 * V_49 = F_29 ( V_47 ) ;
return & V_49 -> V_58 ;
}
...
static int F_99 ( T_5 * V_126 , int V_127 )
{
V_126 -> V_61 = F_100 ( V_127 , V_128 ) ;
if ( ! V_126 -> V_61 )
return - V_119 ;
V_126 -> V_104 = V_127 ;
V_126 -> V_129 = FALSE ;
V_126 -> V_52 = V_53 ;
V_126 -> V_57 = V_126 -> V_61 ;
return 0 ;
}
static int T_1 F_101 ( struct V_8 * V_9 )
{
struct V_46 * V_47 ;
struct V_48 * V_49 ;
unsigned int V_130 ;
struct V_6 * V_50 ;
int V_118 ;
if ( V_9 -> V_131 >= 0 && V_9 -> V_131 < F_102 ( V_132 ) && \
V_132 [ V_9 -> V_131 ] [ 3 ] == V_9 -> V_131 ) {
V_118 = F_103 ( V_132 [ V_9 -> V_131 ] , V_123 ) ;
if ( V_118 )
return V_118 ;
} else {
F_104 ( & V_9 -> V_47 , L_11 ) ;
...
V_49 -> V_50 = V_50 ;
V_50 -> V_47 = V_47 ;
V_118 = F_99 ( & V_49 -> V_51 , V_136 ) ;
if ( V_118 )
goto V_137;
V_118 = F_99 ( & V_49 -> V_55 , V_138 ) ;
if ( V_118 )
goto V_139;
V_47 -> V_140 = & V_141 ;
V_47 -> V_20 = V_50 -> V_20 ;
...
V_49 -> V_122 . V_148 . V_149 &= V_130 ;
V_49 -> V_122 . V_150 . V_149 = 1 ;
F_107 ( & V_49 -> V_122 ) ;
V_118 = F_108 ( V_47 ) ;
if ( V_118 ) {
...
F_109 ( V_50 ) ;
V_134:
F_111 ( V_132 [ V_9 -> V_131 ] ) ;
} else
F_112 ( V_9 , V_50 ) ;
return V_118 ;
}
static int T_6 F_113 ( struct V_8 * V_9 )
{
struct V_6 * V_50 ;
