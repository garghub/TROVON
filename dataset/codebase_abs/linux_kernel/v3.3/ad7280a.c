...
{
int V_51 , V_62 , V_4 ;
V_10 -> V_89 = F_34 ( sizeof( * V_10 -> V_89 ) * ( V_10 -> V_68 + 1 ) *
V_90 * 2 , V_69 ) ;
if ( V_10 -> V_89 == NULL )
return - V_70 ;
for ( V_51 = 0 , V_4 = 0 ; V_51 <= V_10 -> V_68 ; V_51 ++ )
...
static T_3 F_40 ( int V_109 , void * V_110 )
{
struct V_55 * V_56 = V_110 ;
struct V_9 * V_10 = F_22 ( V_56 ) ;
unsigned * V_67 ;
int V_5 , V_18 ;
V_67 = F_32 ( V_10 -> V_111 , sizeof( * V_67 ) , V_69 ) ;
if ( V_67 == NULL )
return V_112 ;
V_18 = F_17 ( V_10 , V_10 -> V_111 , V_67 ) ;
if ( V_18 < 0 )
goto V_113;
...
if ( ( ( V_67 [ V_5 ] >> 11 ) & 0xFFF ) >= V_10 -> V_106 )
F_41 ( V_56 ,
F_44 ( V_77 ,
0 ,
V_115 ,
...
F_26 ( & V_56 -> V_63 ) ;
if ( V_118 -> V_60 == V_87 )
V_18 = F_17 ( V_10 , V_10 -> V_111 , NULL ) ;
else
V_18 = F_16 ( V_10 , V_118 -> V_60 >> 8 ,
V_118 -> V_60 & 0xFF ) ;
F_27 ( & V_56 -> V_63 ) ;
if ( V_18 < 0 )
return V_18 ;
...
return V_121 ;
case V_122 :
if ( ( V_118 -> V_60 & 0xFF ) <= V_41 )
V_120 = ( 4000 * 1000 ) >> V_123 ;
else
V_120 = ( 5000 * 1000 ) >> V_123 ;
* V_8 = V_120 / 1000 ;
* V_119 = ( V_120 % 1000 ) * 1000 ;
return V_124 ;
}
return - V_66 ;
}
static int T_4 F_47 ( struct V_13 * V_14 )
{
const struct V_125 * V_126 = V_14 -> V_51 . V_127 ;
struct V_9 * V_10 ;
int V_18 ;
...
F_50 ( V_10 -> V_14 ) ;
V_10 -> V_48 = F_51 ( V_126 -> V_134 & 0x3 ) ;
V_10 -> V_33 = F_52 ( V_126 -> V_135
& 0x3 ) | ( V_126 -> V_136 ?
V_137 : 0 ) ;
V_18 = F_18 ( V_10 ) ;
if ( V_18 < 0 )
...
V_10 -> V_12 += 5 ;
V_56 -> V_97 = F_54 ( V_14 ) -> V_97 ;
V_56 -> V_51 . V_140 = & V_14 -> V_51 ;
V_56 -> V_141 = V_142 ;
V_18 = F_31 ( V_10 ) ;
if ( V_18 < 0 )
goto V_138;
