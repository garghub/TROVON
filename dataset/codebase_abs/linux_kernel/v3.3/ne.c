...
static void F_52 ( int V_144 )
{
int V_133 ;
struct V_130 * V_131 ;
for ( V_133 = 0 ; V_133 < V_140 ; V_133 ++ ) {
V_131 = V_145 [ V_133 ] ;
if ( V_131 && ( ! F_49 ( V_131 ) || V_144 ) ) {
F_48 ( V_131 ) ;
F_53 ( V_131 ) ;
V_145 [ V_133 ] = NULL ;
}
...
static int F_54 ( struct V_130 * V_131 , T_2 V_146 )
{
struct V_1 * V_2 = F_49 ( V_131 ) ;
if ( F_55 ( V_2 ) ) {
struct V_15 * V_16 = (struct V_15 * ) V_21 . V_22 ;
...
{
int V_147 = F_64 ( & V_148 , F_42 ) ;
F_52 ( 0 ) ;
return V_147 ;
}
struct V_1 * T_1 F_66 ( int V_150 )
{
int V_133 ;
struct V_1 * V_2 ;
V_133 = 0 ;
while ( ( V_145 [ V_133 ] && F_49 ( V_145 [ V_133 ] ) ) ||
V_142 [ V_133 ] ) {
if ( ++ V_133 == V_140 )
return F_67 ( - V_137 ) ;
}
