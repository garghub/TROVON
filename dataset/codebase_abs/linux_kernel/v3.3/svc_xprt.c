...
static void F_107 ( struct V_181 * V_192 )
{
struct V_18 * V_19 ;
...
V_87 = & V_33 -> V_121 [ V_119 ] ;
F_37 ( & V_87 -> V_96 ) ;
while ( ! F_53 ( & V_87 -> V_97 ) ) {
V_19 = F_104 ( & V_87 -> V_97 , struct V_18 , V_37 ) ;
F_9 ( & V_19 -> V_37 ) ;
}
F_39 ( & V_87 -> V_96 ) ;
}
F_109 (xprt, tmp, &serv->sv_tempsocks, xpt_list)
F_88 ( V_19 ) ;
F_109 (xprt, tmp, &serv->sv_permsocks, xpt_list)
F_88 ( V_19 ) ;
F_63 ( ! F_53 ( & V_33 -> V_74 ) ) ;
F_63 ( ! F_53 ( & V_33 -> V_128 ) ) ;
}
static void F_110 ( struct V_194 * V_195 , int V_196 )
{
struct V_189 * V_190 =
...
struct V_18 * F_112 ( struct V_32 * V_33 , const char * V_6 ,
const T_2 V_215 , const unsigned short V_45 )
{
struct V_18 * V_19 ;
...
static int F_113 ( const struct V_18 * V_19 ,
...
int F_114 ( struct V_32 * V_33 , char * V_11 , const int V_222 )
{
struct V_18 * V_19 ;
int V_14 , V_223 ;
char * V_219 ;
...
V_223 = 0 ;
F_5 (xprt, &serv->sv_permsocks, xpt_list) {
V_14 = F_113 ( V_19 , V_219 , V_222 - V_223 ) ;
if ( V_14 < 0 ) {
* V_11 = '\0' ;
V_223 = V_14 ;
}
...
static void * F_115 ( struct V_224 * V_225 , T_3 * V_219 )
{
...
static void * F_116 ( struct V_224 * V_225 , void * V_144 , T_3 * V_219 )
{
...
static void F_117 ( struct V_224 * V_225 , void * V_144 )
{
}
static int F_118 ( struct V_224 * V_225 , void * V_144 )
{
struct V_86 * V_87 = V_144 ;
if ( V_144 == V_228 ) {
F_119 ( V_225 , L_37 ) ;
...
int F_121 ( struct V_32 * V_33 , struct V_229 * V_229 )
{
int V_71 ;
V_71 = F_122 ( V_229 , & V_230 ) ;
if ( ! V_71 )
