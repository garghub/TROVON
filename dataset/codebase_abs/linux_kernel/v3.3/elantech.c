...
F_41 ( V_123 , V_28 -> V_122 ) ;
F_42 ( V_124 , V_28 -> V_122 ) ;
F_41 ( V_40 , V_28 -> V_125 ) ;
F_41 ( V_41 , V_28 -> V_125 ) ;
F_41 ( V_33 , V_28 -> V_125 ) ;
F_41 ( V_37 , V_28 -> V_125 ) ;
F_41 ( V_38 , V_28 -> V_125 ) ;
F_41 ( V_39 , V_28 -> V_125 ) ;
switch ( V_10 -> V_18 ) {
case 1 :
if ( V_10 -> V_30 < 0x020000 &&
( V_10 -> V_42 [ 0 ] & V_43 ) ) {
F_41 ( V_44 , V_28 -> V_125 ) ;
F_41 ( V_45 , V_28 -> V_125 ) ;
}
F_43 ( V_28 , V_34 , V_103 , V_105 , 0 , 0 ) ;
F_43 ( V_28 , V_35 , V_104 , V_36 , 0 , 0 ) ;
break;
case 2 :
F_41 ( V_59 , V_28 -> V_125 ) ;
F_41 ( V_126 , V_28 -> V_127 ) ;
case 3 :
F_43 ( V_28 , V_34 , V_103 , V_105 , 0 , 0 ) ;
F_43 ( V_28 , V_35 , V_104 , V_36 , 0 , 0 ) ;
if ( V_10 -> V_60 ) {
F_43 ( V_28 , V_61 , V_128 ,
V_129 , 0 , 0 ) ;
F_43 ( V_28 , V_62 , V_130 ,
V_131 , 0 , 0 ) ;
}
F_44 ( V_28 , 2 ) ;
...
static T_3 F_47 ( struct V_1 * V_1 , void * V_132 ,
char * V_133 )
{
struct V_9 * V_10 = V_1 -> V_11 ;
struct V_134 * V_135 = V_132 ;
unsigned char * V_16 = ( unsigned char * ) V_10 + V_135 -> V_136 ;
int V_12 = 0 ;
if ( V_135 -> V_16 )
V_12 = F_9 ( V_1 , V_135 -> V_16 , V_16 ) ;
return sprintf ( V_133 , L_17 , ( V_135 -> V_16 && V_12 ) ? - 1 : * V_16 ) ;
}
static T_3 F_48 ( struct V_1 * V_1 ,
void * V_132 , const char * V_133 , T_4 V_137 )
{
struct V_9 * V_10 = V_1 -> V_11 ;
struct V_134 * V_135 = V_132 ;
unsigned char * V_16 = ( unsigned char * ) V_10 + V_135 -> V_136 ;
unsigned char V_138 ;
int V_139 ;
V_139 = F_49 ( V_133 , 16 , & V_138 ) ;
if ( V_139 )
return V_139 ;
if ( V_10 -> V_18 == 1 ) {
if ( V_135 -> V_16 == 0x10 )
V_138 |= V_102 ;
else if ( V_135 -> V_16 == 0x11 )
V_138 |= V_140 ;
}
if ( ! V_135 -> V_16 || F_10 ( V_1 , V_135 -> V_16 , V_138 ) == 0 )
* V_16 = V_138 ;
return V_137 ;
}
static bool F_50 ( const unsigned char * V_3 )
{
static const unsigned char V_141 [] = { 200 , 100 , 80 , 60 , 40 , 20 , 10 } ;
int V_23 ;
if ( V_3 [ 0 ] == 0 )
return false ;
if ( V_3 [ 1 ] == 0 )
return true ;
for ( V_23 = 0 ; V_23 < F_51 ( V_141 ) ; V_23 ++ )
if ( V_3 [ 2 ] == V_141 [ V_23 ] )
return false ;
return true ;
}
int F_52 ( struct V_1 * V_1 , bool V_142 )
{
struct V_4 * V_4 = & V_1 -> V_4 ;
unsigned char V_3 [ 3 ] ;
F_3 ( & V_1 -> V_4 , NULL , V_143 ) ;
if ( F_3 ( V_4 , NULL , V_144 ) ||
F_3 ( V_4 , NULL , V_22 ) ||
F_3 ( V_4 , NULL , V_22 ) ||
F_3 ( V_4 , NULL , V_22 ) ||
F_3 ( V_4 , V_3 , V_5 ) ) {
...
{
int V_151 = ( V_10 -> V_30 & 0x0f0000 ) >> 16 ;
...
int V_23 , error ;
unsigned char V_3 [ 3 ] ;
V_1 -> V_11 = V_10 = F_60 ( sizeof( struct V_9 ) , V_152 ) ;
if ( ! V_10 )
return - V_153 ;
V_10 -> V_85 [ 0 ] = 1 ;
...
error = F_62 ( & V_1 -> V_4 . V_148 -> V_28 . V_149 ,
& V_150 ) ;
if ( error ) {
F_4 ( V_1 ,
L_32 ,
