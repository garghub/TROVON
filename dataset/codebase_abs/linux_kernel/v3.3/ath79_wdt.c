...
static T_1 F_14 ( struct V_11 * V_11 , const char * V_17 ,
T_2 V_18 , T_3 * V_19 )
{
if ( V_18 ) {
if ( ! V_20 ) {
...
static long F_17 ( struct V_11 * V_11 , unsigned int V_24 ,
unsigned long V_25 )
{
...
static int T_5 F_20 ( struct V_39 * V_40 )
{
T_6 V_41 ;
int V_28 ;
V_42 = F_21 ( & V_40 -> V_43 , L_3 ) ;
if ( F_22 ( V_42 ) )
return F_23 ( V_42 ) ;
V_28 = F_24 ( V_42 ) ;
if ( V_28 )
