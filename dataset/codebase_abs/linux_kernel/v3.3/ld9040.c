...
struct V_70 V_64 ;
V_2 = F_33 ( sizeof( struct V_1 ) , V_71 ) ;
if ( ! V_2 )
return - V_72 ;
V_21 -> V_73 = 9 ;
V_3 = F_34 ( V_21 ) ;
...
V_52 = F_37 ( L_14 , & V_21 -> V_32 , V_2 , & V_76 ) ;
if ( F_38 ( V_52 ) ) {
V_3 = F_39 ( V_52 ) ;
goto V_74;
}
...
static int T_2 F_46 ( struct V_69 * V_21 )
{
struct V_1 * V_2 = F_47 ( & V_21 -> V_32 ) ;
F_24 ( V_2 , V_59 ) ;
F_48 ( V_2 -> V_63 ) ;
F_43 ( V_2 -> V_52 ) ;
F_44 ( F_4 ( V_9 ) , V_9 ) ;
...
static int F_49 ( struct V_69 * V_21 , T_3 V_81 )
{
int V_3 = 0 ;
struct V_1 * V_2 = F_47 ( & V_21 -> V_32 ) ;
F_50 ( & V_21 -> V_32 , L_17 , V_2 -> V_56 ) ;
V_3 = F_24 ( V_2 , V_59 ) ;
return V_3 ;
}
static int F_51 ( struct V_69 * V_21 )
{
int V_3 = 0 ;
struct V_1 * V_2 = F_47 ( & V_21 -> V_32 ) ;
V_2 -> V_56 = V_59 ;
...
static void F_52 ( struct V_69 * V_21 )
{
struct V_1 * V_2 = F_47 ( & V_21 -> V_32 ) ;
F_24 ( V_2 , V_59 ) ;
}
