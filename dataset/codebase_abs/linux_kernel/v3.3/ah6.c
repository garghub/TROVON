...
static void F_18 ( struct V_23 * V_24 , struct V_16 * V_25 ) {}
static void F_21 ( struct V_23 * V_24 , struct V_35 * V_36 )
{
int V_37 , V_38 ;
struct V_27 * V_39 ;
struct V_27 V_28 ;
...
static int F_22 ( struct V_23 * V_24 , int V_5 , int V_43 )
{
union {
struct V_23 * V_24 ;
struct V_16 * V_44 ;
...
static void F_24 ( struct V_55 * V_10 , int V_56 )
{
int V_57 ;
T_1 * V_58 ;
T_1 * V_14 ;
struct V_59 * V_60 = V_10 -> V_61 ;
struct V_62 * V_63 = F_25 ( V_60 ) -> V_64 ;
struct V_65 * V_66 = V_63 -> V_61 ;
struct V_23 * V_67 = F_26 ( V_60 ) ;
struct V_68 * V_69 = V_68 ( V_60 ) ;
struct V_9 * V_70 ;
V_57 = F_27 ( V_60 ) - sizeof( struct V_23 ) ;
if ( V_57 )
V_57 += sizeof( * V_70 ) ;
V_58 = F_28 ( V_60 ) -> V_12 ;
V_70 = F_9 ( V_58 ) ;
...
static int F_32 ( struct V_62 * V_63 , struct V_59 * V_60 )
{
int V_56 ;
int V_3 ;
int V_57 ;
...
V_67 = F_26 ( V_60 ) ;
V_67 -> V_79 = F_36 ( V_60 -> V_5 - sizeof( * V_67 ) ) ;
V_49 = * F_37 ( V_60 ) ;
* F_37 ( V_60 ) = V_80 ;
...
V_67 -> V_83 [ 2 ] = 0 ;
V_67 -> V_84 = 0 ;
V_69 -> V_40 = ( F_38 ( sizeof( * V_69 ) + V_66 -> V_72 ) >> 2 ) - 2 ;
V_69 -> V_85 = 0 ;
V_69 -> V_86 = V_63 -> V_87 . V_86 ;
V_69 -> V_88 = F_39 ( F_40 ( V_60 ) -> V_89 . V_90 . V_91 ) ;
F_41 ( V_76 , V_3 ) ;
F_42 ( V_60 , V_76 , 0 , V_60 -> V_5 ) ;
F_43 ( V_15 , V_76 , V_14 , V_60 -> V_5 ) ;
F_44 ( V_15 , 0 , F_24 , V_60 ) ;
F_28 ( V_60 ) -> V_12 = V_58 ;
V_56 = F_45 ( V_15 ) ;
if ( V_56 ) {
if ( V_56 == - V_92 )
...
V_49 = V_69 -> V_49 ;
V_97 = ( V_69 -> V_40 + 2 ) << 2 ;
if ( V_97 != F_38 ( sizeof( * V_69 ) + V_66 -> V_103 ) &&
V_97 != F_38 ( sizeof( * V_69 ) + V_66 -> V_72 ) )
goto V_77;
if ( ! F_53 ( V_60 , V_97 ) )
goto V_77;
if ( ( V_56 = F_33 ( V_60 , 0 , & V_75 ) ) < 0 )
...
static void F_56 ( struct V_59 * V_60 , struct V_106 * V_18 ,
T_1 type , T_1 V_107 , int V_13 , T_3 V_108 )
{
struct V_109 * V_109 = F_57 ( V_60 -> V_110 ) ;
...
type != V_112 )
return;
V_63 = F_58 ( V_109 , V_60 -> V_113 , ( V_114 * ) & V_24 -> V_42 , V_69 -> V_86 , V_80 , V_115 ) ;
if ( ! V_63 )
return;
F_59 ( V_116 L_5 ,
F_60 ( V_69 -> V_86 ) , & V_24 -> V_42 ) ;
F_61 ( V_63 ) ;
}
...
if ( V_63 -> V_120 )
goto error;
V_66 = F_63 ( sizeof( * V_66 ) , V_121 ) ;
if ( V_66 == NULL )
return - V_78 ;
V_2 = F_64 ( V_63 -> V_119 -> V_122 , 0 , 0 ) ;
if ( F_65 ( V_2 ) )
goto error;
V_66 -> V_2 = V_2 ;
if ( F_66 ( V_2 , V_63 -> V_119 -> V_123 ,
( V_63 -> V_119 -> V_124 + 7 ) / 8 ) )
goto error;
V_118 = F_67 ( V_63 -> V_119 -> V_122 , 0 ) ;
F_68 ( ! V_118 ) ;
...
V_63 -> V_131 . V_132 = F_38 ( sizeof( struct V_68 ) +
V_66 -> V_72 ) ;
