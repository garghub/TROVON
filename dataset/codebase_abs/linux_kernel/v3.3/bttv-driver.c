...
struct V_20 * V_21 = V_213 ;
struct V_9 * V_10 = V_21 -> V_10 ;
strcpy ( V_269 -> V_392 , L_22 ) ;
F_120 ( V_269 -> V_393 , V_10 -> V_479 -> V_308 , sizeof( V_269 -> V_393 ) ) ;
sprintf ( V_269 -> V_395 , L_23 , F_121 ( V_10 -> V_11 . V_396 ) ) ;
V_269 -> V_397 = V_405 ;
return 0 ;
}
...
int V_18 ;
F_191 ( L_56 , V_488 ,
V_489 [ V_488 >> 28 ] ? V_489 [ V_488 >> 28 ] : L_57 ) ;
for ( V_18 = F_12 ( V_48 ) - 1 ; V_18 >= 0 ; V_18 -- )
if ( V_488 & ( 1 << ( V_18 + 12 ) ) )
F_191 ( L_58 , V_48 [ V_18 ] ) ;
F_191 ( L_59 , V_488 & 0xfff ) ;
...
{
F_25 ( L_63 , ( unsigned long long ) V_10 -> main. V_503 ) ;
F_25 ( L_64 ,
...
F_25 ( L_88 ,
V_10 -> V_11 . V_61 ,
( V_529 & V_176 ) ? L_89 : L_90 ,
( V_529 & V_180 ) ? L_91 : L_90 ,
F_18 ( V_523 ) ) ;
F_195 ( V_528 , V_529 ) ;
F_191 ( L_79 ) ;
if ( V_536 )
...
V_7 -> V_541 = V_536 ;
F_223 ( V_7 , V_10 ) ;
snprintf ( V_7 -> V_308 , sizeof( V_7 -> V_308 ) , L_96 ,
V_10 -> V_17 , ( V_10 -> V_17 == 848 && V_10 -> V_542 == 0x12 ) ? L_97 : L_90 ,
...
if ( V_389 > 0 )
F_198 ( L_98 ) ;
V_10 -> V_394 = F_221 ( V_10 , & V_544 , L_99 ) ;
if ( NULL == V_10 -> V_394 )
goto V_241;
...
& V_546 ) < 0 ) {
F_21 ( L_101 , V_10 -> V_11 . V_61 ) ;
goto V_241;
}
V_10 -> V_543 = F_221 ( V_10 , & V_544 , L_102 ) ;
if ( NULL == V_10 -> V_543 )
goto V_241;
...
if ( ! V_10 -> V_548 )
return 0 ;
V_10 -> V_479 = F_221 ( V_10 , & V_549 , L_103 ) ;
if ( NULL == V_10 -> V_479 )
goto V_241;
...
struct V_511 V_591 ;
unsigned long V_161 ;
F_24 ( L_119 , V_10 -> V_11 . V_61 , V_265 . V_592 ) ;
F_55 ( & V_10 -> V_163 , V_161 ) ;
