...
static T_2 F_3 ( T_2 V_10 , T_2 V_11 )
{
...
F_12 ( V_25 L_2 , V_3 ,
V_19 -> V_10 , V_19 -> V_11 , ( V_19 -> V_11 - V_19 -> V_10 ) >> 20 ) ;
return 0 ;
}
...
void T_6 F_37 ( int V_60 )
{
int V_61 , V_3 ;
V_3 = F_38 ( V_60 ) ;
F_39 ( V_3 == V_24 || ! F_40 ( V_3 ) ) ;
V_61 = V_23 [ V_3 ] ;
F_41 (nid)
if ( V_23 [ V_3 ] == V_61 )
F_42 ( V_60 , V_62 [ V_3 ] ) ;
}
void T_6 F_43 ( int V_60 )
{
int V_6 ;
F_41 (i)
F_44 ( V_60 , V_62 [ V_6 ] ) ;
}
static void T_6 F_45 ( int V_60 , bool V_63 )
{
int V_3 , V_61 ;
V_3 = F_38 ( V_60 ) ;
if ( V_3 == V_24 ) {
