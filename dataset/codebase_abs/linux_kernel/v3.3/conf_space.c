...
V_39 = V_5 + V_10 ;
V_40 = F_15 ( V_37 ) ;
V_41 = F_15 ( V_37 ) + V_9 -> V_10 ;
if ( ( V_38 >= V_40 && V_38 < V_41 )
|| ( V_39 > V_40 && V_39 <= V_41 ) ) {
V_23 = F_1 ( V_2 , V_37 , V_40 ,
& V_42 ) ;
if ( V_23 )
goto V_44;
V_6 = F_5 ( V_6 , V_42 ,
...
if ( V_23 )
break;
V_42 = F_5 ( V_42 , V_6 , F_3 ( V_10 ) ,
V_38 - V_40 ) ;
V_23 = F_2 ( V_2 , V_37 , V_40 ,
V_42 ) ;
V_45 = 1 ;
}
}
...
V_9 = V_37 -> V_9 ;
if ( V_9 -> V_52 )
V_9 -> V_52 ( V_2 , F_15 ( V_37 ) , V_37 -> V_15 ) ;
F_24 ( V_37 ) ;
}
}
