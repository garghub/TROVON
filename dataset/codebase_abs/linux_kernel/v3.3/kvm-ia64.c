...
if ( V_354 -> V_357 [ V_13 ] )
F_168 ( (struct V_358 * ) V_354 -> V_357 [ V_13 ] ) ;
}
}
}
...
goto V_163;
if ( ! F_185 ( V_366 , V_364 ,
sizeof( struct V_360 ) ) ) {
F_23 ( V_48 L_19
L_20 ) ;
goto V_163;
}
V_361 = F_149 ( sizeof( struct V_360 ) , V_197 ) ;
if ( ! V_361 ) {
V_53 = - V_285 ;
goto V_163;
}
V_53 = F_181 ( V_2 , V_361 ) ;
if ( V_53 )
goto V_163;
...
if ( F_120 ( & V_364 , V_365 , sizeof( void * ) ) )
goto V_163;
if ( ! F_185 ( V_368 , V_364 ,
sizeof( struct V_360 ) ) ) {
F_23 ( V_48 L_21
L_22 ) ;
goto V_163;
}
V_361 = F_186 ( sizeof( struct V_360 ) , V_197 ) ;
if ( ! V_361 ) {
V_53 = - V_285 ;
goto V_163;
}
...
if ( V_355 + V_356 > ( V_373 >> V_137 ) )
return - V_285 ;
for ( V_12 = 0 ; V_12 < V_356 ; V_12 ++ ) {
V_372 = F_188 ( V_5 , V_355 + V_12 ) ;
if ( ! F_189 ( V_372 ) ) {
F_109 ( V_5 , V_355 + V_12 ,
V_372 << V_137 ,
V_374 | V_375 ) ;
V_354 -> V_357 [ V_12 ] = ( unsigned long ) F_190 ( V_372 ) ;
} else {
F_109 ( V_5 , V_355 + V_12 ,
V_376 | ( V_372 << V_137 ) ,
V_377 ) ;
...
{
long V_378 = 1 , V_30 = 1 , V_379 = 1 ;
long V_303 ;
V_303 = F_197 ( & V_378 , & V_30 , & V_379 , 0 ) ;
if ( V_303 )
goto V_163;
if ( ! ( V_378 & V_380 ) )
goto V_163;
F_23 ( V_50 L_23 ) ;
V_303 = F_198 ( & V_282 , & V_381 ) ;
if ( V_303 )
goto V_163;
...
static void F_199 ( struct V_186 * V_383 ,
struct V_384 * V_384 )
{
...
if ( ! F_111 ( L_11 ) )
return;
V_387 = ( unsigned long ) V_384 -> V_388 ;
V_385 = V_36 + V_383 -> V_389 - V_387 ;
V_386 = V_36 + V_383 -> V_390 - V_387 ;
F_23 ( V_48 L_27
L_28 ) ;
memcpy ( ( void * ) V_385 , ( void * ) V_386 , 0x60 ) ;
}
static int F_200 ( struct V_186 * V_383 ,
struct V_384 * V_384 )
{
unsigned long V_387 ;
unsigned long V_391 ;
...
V_387 = ( unsigned long ) V_384 -> V_388 ;
V_391 = V_384 -> V_397 ;
if ( F_102 ( V_391 > V_284 ) )
return - V_264 ;
memcpy ( ( void * ) V_36 , ( void * ) V_387 , V_391 ) ;
F_199 ( V_383 , V_384 ) ;
F_5 ( V_36 , V_391 ) ;
V_392 = V_383 -> V_304 - V_387 ;
V_186 -> V_304 = V_38 + V_392 ;
F_23 ( V_50 L_30 ,
V_186 -> V_304 ) ;
V_394 = ( unsigned long ) V_383 -> V_330 - V_387 ;
V_186 -> V_330 = ( V_398 * ) ( V_38 +
V_394 ) ;
V_393 = * ( unsigned long * ) V_383 -> V_330 - V_387 ;
V_396 = (struct V_395 * ) ( V_36 + V_394 ) ;
V_396 -> V_399 = V_38 + V_393 ;
V_396 -> V_400 = V_38 + ( V_396 -> V_400 - V_387 ) ;
F_23 ( V_50 L_31 ,
V_38 + V_393 ) ;
V_394 = ( unsigned long ) V_383 -> V_187 - V_387 ;
V_186 -> V_187 = ( V_401 * ) ( V_38 +
V_394 ) ;
V_393 = * ( unsigned long * ) V_383 -> V_187 - V_387 ;
V_396 = (struct V_395 * ) ( V_36 + V_394 ) ;
V_396 -> V_399 = V_38 + V_393 ;
V_396 -> V_400 = V_38 + ( V_396 -> V_400 - V_387 ) ;
V_336 = V_396 -> V_400 ;
...
int F_201 ( void * V_402 )
{
int V_53 ;
struct V_186 * V_383 = (struct V_186 * ) V_402 ;
if ( ! F_196 () ) {
F_23 ( V_85 L_34 ) ;
V_53 = - V_403 ;
goto V_163;
...
static void F_203 ( struct V_5 * V_5 ,
struct V_353 * V_354 )
{
int V_12 ;
long V_306 ;
unsigned long V_407 ;
unsigned long * V_408 = ( unsigned long * ) ( V_5 -> V_6 . V_165 +
F_107 ( struct V_199 , V_409 ) ) ;
V_407 = F_204 ( V_354 ) ;
V_306 = V_354 -> V_355 / V_410 ;
F_20 ( & V_5 -> V_6 . V_338 ) ;
for ( V_12 = 0 ; V_12 < V_407 / sizeof( long ) ; ++ V_12 ) {
V_354 -> V_408 [ V_12 ] = V_408 [ V_306 + V_12 ] ;
V_408 [ V_306 + V_12 ] = 0 ;
}
F_22 ( & V_5 -> V_6 . V_338 ) ;
}
int F_205 ( struct V_5 * V_5 ,
struct V_411 * log )
{
int V_53 ;
unsigned long V_407 ;
...
if ( log -> V_35 >= V_413 )
goto V_163;
V_354 = F_206 ( V_5 -> V_414 , log -> V_35 ) ;
V_53 = - V_415 ;
if ( ! V_354 -> V_408 )
goto V_163;
F_203 ( V_5 , V_354 ) ;
V_53 = F_207 ( V_5 , log , & V_412 ) ;
if ( V_53 )
goto V_163;
if ( V_412 ) {
F_193 ( V_5 ) ;
V_407 = F_204 ( V_354 ) ;
memset ( V_354 -> V_408 , 0 , V_407 ) ;
}
V_53 = 0 ;
V_163:
F_126 ( & V_5 -> V_268 ) ;
...
F_51 ( & V_2 -> V_120 ) ;
V_416 = F_158 () ;
if ( V_131 != V_416 && ( unsigned ) V_131 < V_417 && F_210 ( V_131 ) )
if ( ! F_42 ( V_182 , & V_2 -> V_124 ) )
F_211 ( V_131 ) ;
F_159 () ;
}
int F_212 ( struct V_1 * V_2 , struct V_418 * V_274 )
{
return F_40 ( V_2 , V_274 -> V_91 ) ;
}
int F_213 ( struct V_320 * V_319 , T_11 V_419 )
{
return V_319 -> V_2 -> V_333 == V_419 ;
}
int F_214 ( struct V_320 * V_319 , T_12 V_420 )
{
return 0 ;
}
int F_215 ( struct V_1 * V_421 , struct V_1 * V_422 )
{
return V_421 -> V_6 . V_245 - V_422 -> V_6 . V_245 ;
}
int F_216 ( struct V_1 * V_2 , struct V_320 * V_423 ,
int V_424 , int V_419 , int V_425 )
{
struct V_320 * V_426 = V_2 -> V_6 . V_319 ;
return ( V_425 == 0 ) ?
F_213 ( V_426 , V_419 ) :
F_214 ( V_426 , V_419 ) ;
}
static int F_217 ( int * V_427 )
{
T_5 V_428 , V_429 ;
int V_12 ;
...
{
struct V_24 * V_24 = F_41 ( V_2 -> V_5 , V_2 -> V_6 . V_24 ) ;
if ( V_24 -> V_92 [ 0 ] & ( 1UL << V_430 ) )
return V_430 ;
if ( V_24 -> V_92 [ 0 ] & ( 1UL << V_431 ) )
return V_431 ;
return F_217 ( ( int * ) & V_24 -> V_92 [ 0 ] ) ;
}
