...
V_20 = F_47 ( V_40 , 0 , V_49 -> V_67 , V_71 ) ;
if ( V_20 )
goto V_73;
F_48 ( V_49 , V_3 , V_40 ) ;
if ( V_45 & V_72 )
...
static int F_50 ( struct V_2 * V_3 , struct V_39 * V_40 )
{
if ( F_51 ( V_3 , V_40 ) < 0 ) {
F_44 ( V_40 ) ;
return V_74 ;
...
static inline int F_52 ( T_2 * V_76 , T_3 V_11 ,
T_3 V_77 , struct V_1 * V_7 )
{
if ( ! V_7 -> V_24 )
return 1 ;
if ( V_7 -> V_31 . V_9 == V_10 &&
! memcmp ( V_7 -> V_31 . V_13 , V_76 , V_78 ) )
return 1 ;
if ( V_7 -> V_31 . V_9 == V_79 &&
V_11 == V_7 -> V_31 . V_11 &&
V_77 == V_7 -> V_31 . V_77 )
return 1 ;
return 0 ;
}
int F_53 ( struct V_22 * V_23 , struct V_39 * V_40 )
{
struct V_2 * V_3 , * V_80 = NULL ;
struct V_81 * V_82 ;
int V_83 = V_75 ;
T_3 V_11 , V_77 ;
F_54 ( V_23 -> type != V_29 ) ;
V_11 = F_35 ( V_23 ) -> F_55 ( V_23 ) ;
V_77 = F_35 ( V_23 ) -> F_56 ( V_23 ) ;
F_57 ( & V_4 ) ;
F_58 (sk, node, &dgram_head) {
if ( F_52 ( V_23 -> V_84 , V_11 , V_77 ,
F_1 ( V_3 ) ) ) {
if ( V_80 ) {
struct V_39 * V_85 ;
V_85 = F_59 ( V_40 , V_86 ) ;
...
static int F_61 ( struct V_2 * V_3 , int V_87 , int V_88 ,
char V_37 * V_89 , int V_37 * V_90 )
{
struct V_1 * V_7 = F_1 ( V_3 ) ;
int V_91 , V_17 ;
if ( V_87 != V_92 )
...
if ( F_62 ( V_17 , V_90 ) )
return - V_93 ;
V_17 = F_63 (unsigned int, len, sizeof(int)) ;
switch ( V_88 ) {
case V_94 :
V_91 = V_7 -> V_12 ;
break;
...
if ( F_21 ( V_17 , V_90 ) )
return - V_93 ;
if ( F_64 ( V_89 , & V_91 , V_17 ) )
return - V_93 ;
return 0 ;
}
static int F_65 ( struct V_2 * V_3 , int V_87 , int V_88 ,
char V_37 * V_89 , unsigned int V_90 )
{
struct V_1 * V_7 = F_1 ( V_3 ) ;
int V_91 ;
int V_20 = 0 ;
