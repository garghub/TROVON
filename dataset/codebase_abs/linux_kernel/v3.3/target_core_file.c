...
struct V_15 * V_17 = V_69 -> V_66 . V_70 -> V_17 ;
struct V_14 * V_20 = V_17 -> V_71 ;
struct V_26 * V_72 = V_20 -> V_41 ;
struct V_73 * V_74 = V_65 -> V_75 ;
struct V_76 * V_77 ;
T_2 V_25 ;
T_3 V_78 = ( V_65 -> V_79 *
V_17 -> V_80 -> V_81 . V_82 ) ;
int V_30 = 0 , V_83 ;
V_77 = F_2 ( sizeof( struct V_76 ) * V_65 -> V_84 , V_5 ) ;
if ( ! V_77 ) {
F_3 ( L_21 ) ;
return - V_6 ;
}
F_32 (task->task_sg, sg, task->task_sg_nents, i) {
V_77 [ V_83 ] . V_85 = V_74 -> V_86 ;
V_77 [ V_83 ] . V_87 = F_33 ( V_74 ) ;
}
V_25 = F_9 () ;
F_10 ( F_11 () ) ;
V_30 = F_34 ( V_72 , & V_77 [ 0 ] , V_65 -> V_84 , & V_78 ) ;
F_10 ( V_25 ) ;
F_6 ( V_77 ) ;
if ( F_16 ( V_72 -> V_40 -> V_88 -> V_44 ) ) {
if ( V_30 < 0 || V_30 != V_65 -> V_89 ) {
F_3 ( L_22
L_23 , V_30 ,
( int ) V_65 -> V_89 ) ;
...
V_25 = F_9 () ;
F_10 ( F_11 () ) ;
V_30 = F_36 ( V_72 , & V_77 [ 0 ] , V_65 -> V_84 , & V_78 ) ;
F_10 ( V_25 ) ;
F_6 ( V_77 ) ;
if ( V_30 < 0 || V_30 != V_65 -> V_89 ) {
F_3 ( L_27 , V_30 ) ;
...
{
struct V_90 * V_91 = V_65 -> V_70 ;
struct V_15 * V_20 = V_91 -> V_17 ;
struct V_14 * V_14 = V_20 -> V_71 ;
int V_92 = ( V_91 -> V_93 [ 1 ] & 0x2 ) ;
T_3 V_94 , V_95 ;
int V_30 ;
if ( V_92 )
F_38 ( V_91 , 1 ) ;
...
V_94 = V_91 -> V_96 * V_20 -> V_80 -> V_81 . V_82 ;
if ( V_91 -> V_97 )
V_95 = V_94 + V_91 -> V_97 ;
else
V_95 = V_98 ;
}
V_30 = F_39 ( V_14 -> V_41 , V_94 , V_95 , 1 ) ;
if ( V_30 != 0 )
F_3 ( L_28 , V_30 ) ;
if ( ! V_92 )
F_38 ( V_91 , V_30 == 0 ) ;
}
static void F_40 ( struct V_90 * V_91 , struct V_64 * V_65 )
{
struct V_15 * V_20 = V_91 -> V_17 ;
struct V_14 * V_14 = V_20 -> V_71 ;
T_3 V_94 = V_65 -> V_79 * V_20 -> V_80 -> V_81 . V_82 ;
T_3 V_95 = V_94 + V_65 -> V_89 ;
int V_30 ;
F_4 ( L_29 ,
V_65 -> V_79 , V_65 -> V_89 ) ;
V_30 = F_39 ( V_14 -> V_41 , V_94 , V_95 , 1 ) ;
...
V_30 = F_35 ( V_65 ) ;
if ( V_30 > 0 &&
V_20 -> V_80 -> V_81 . V_101 > 0 &&
V_20 -> V_80 -> V_81 . V_102 > 0 &&
( V_91 -> V_103 & V_104 ) ) {
F_40 ( V_91 , V_65 ) ;
}
}
...
{
struct V_14 * V_14 = V_17 -> V_111 ;
char * V_112 , * V_113 , * V_114 , * V_115 ;
T_5 args [ V_116 ] ;
int V_30 = 0 , V_117 , V_118 ;
V_115 = F_45 ( V_109 , V_5 ) ;
if ( ! V_115 )
return - V_6 ;
V_112 = V_115 ;
while ( ( V_113 = F_46 ( & V_115 , L_30 ) ) != NULL ) {
if ( ! * V_113 )
continue;
V_118 = F_47 ( V_113 , V_119 , args ) ;
switch ( V_118 ) {
case V_120 :
V_114 = F_48 ( & args [ 0 ] ) ;
if ( ! V_114 ) {
...
struct V_14 * V_14 = V_17 -> V_111 ;
T_4 V_127 = 0 ;
V_127 = sprintf ( V_126 + V_127 , L_41 , V_14 -> V_60 ) ;
V_127 += sprintf ( V_126 + V_127 , L_42 ,
V_14 -> V_32 , V_14 -> V_52 ,
( V_14 -> V_37 & V_38 ) ?
L_43 : L_44 ) ;
return V_127 ;
...
{
struct V_14 * V_14 = V_20 -> V_71 ;
unsigned long long V_130 = F_22 ( V_14 -> V_52 ,
V_20 -> V_80 -> V_81 . V_82 ) ;
return V_130 ;
}
