...
V_2 -> V_336 = 1 ;
V_2 -> V_337 = 0x1f ;
V_2 -> V_164 = F_154 ( V_2 , & V_338 , L_41 ) ;
if ( ! V_2 -> V_164 ) {
F_47 ( L_42 ) ;
return - V_125 ;
}
V_154 = F_158 ( V_2 -> V_164 , V_291 ,
V_339 [ V_2 -> V_340 ] ) ;
if ( V_154 ) {
F_47 ( L_43 ,
V_154 ) ;
...
memcpy ( & V_341 , & V_338 ,
sizeof( V_341 ) ) ;
strcpy ( V_341 . V_158 , L_45 ) ;
V_2 -> V_311 = F_154 ( V_2 , & V_341 , L_46 ) ;
V_154 = F_158 ( V_2 -> V_311 , V_292 ,
V_342 [ V_2 -> V_340 ] ) ;
if ( V_154 < 0 ) {
F_47 ( L_47 ) ;
return V_154 ;
...
if ( V_248 [ V_2 -> V_249 ] . V_198 . type == V_343 ) {
V_2 -> V_310 = F_154 ( V_2 , & V_344 ,
L_49 ) ;
if ( ! V_2 -> V_310 ) {
F_47 ( L_42 ) ;
return - V_125 ;
}
V_154 = F_158 ( V_2 -> V_310 , V_293 ,
V_345 [ V_2 -> V_340 ] ) ;
if ( V_154 < 0 ) {
F_47 ( L_50 ) ;
return V_154 ;
