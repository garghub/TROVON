...
return F_64 ( V_63 , V_69 , V_72 , V_67 , V_73 ) ;
}
V_16:
...
F_138 ( V_114 , V_73 , V_72 , V_69 , V_51 ) ;
F_70 ( V_114 ) ;
F_71 ( & V_63 -> V_64 ) ;
F_68 ( V_73 ) ;
if ( F_9 ( ! F_120 ( * V_67 , V_106 ) ) ) {
...
struct V_73 * F_139 ( struct V_62 * V_63 ,
unsigned long V_99 ,
T_5 * V_67 ,
unsigned int V_86 )
{
...
int F_142 ( struct V_118 * V_119 , struct V_68 * V_69 ,
...
int F_146 ( struct V_68 * V_69 , T_5 * V_67 ,
...
int F_147 ( struct V_68 * V_69 , struct V_68 * V_123 ,
unsigned long V_124 ,
...
if ( F_99 ( * V_127 ) ) {
F_73 ( & V_63 -> V_64 ) ;
F_100 ( V_69 -> V_104 , V_127 ) ;
V_34 = - 1 ;
} else {
V_67 = F_149 ( V_63 , V_124 , V_127 ) ;
F_19 ( ! F_72 ( * V_128 ) ) ;
...
int F_150 ( struct V_68 * V_69 , T_5 * V_67 ,
...
T_5 V_75 ;
V_75 = F_149 ( V_63 , V_99 , V_67 ) ;
V_75 = F_151 ( V_75 , V_130 ) ;
...
if ( V_85 & ~ V_87 )
goto V_16;
V_132 = F_153 ( V_63 , V_85 ) ;
if ( ! F_154 ( * V_132 ) )
goto V_16;
V_133 = F_155 ( V_132 , V_85 ) ;
if ( ! F_156 ( * V_133 ) )
goto V_16;
V_67 = F_157 ( V_133 , V_85 ) ;
if ( F_72 ( * V_67 ) )
goto V_16;
if ( F_101 ( * V_67 ) != V_73 )
goto V_16;
...
static int F_158 ( struct V_73 * V_73 ,
struct V_68 * V_69 ,
unsigned long V_85 )
{
struct V_62 * V_63 = V_69 -> V_122 ;
...
int V_34 = 0 ;
F_71 ( & V_63 -> V_64 ) ;
V_67 = F_152 ( V_73 , V_63 , V_85 ,
V_134 ) ;
if ( V_67 ) {
F_159 ( V_69 , V_85 , V_67 ) ;
V_34 = 1 ;
}
F_73 ( & V_63 -> V_64 ) ;
return V_34 ;
}
static void F_160 ( struct V_73 * V_73 )
{
int V_108 ;
struct V_1 * V_1 = F_161 ( V_73 ) ;
int V_136 = 0 ;
F_162 ( & V_1 -> V_137 ) ;
F_163 ( V_73 ) ;
F_164 ( V_73 ) ;
for ( V_108 = V_51 - 1 ; V_108 >= 1 ; V_108 -- ) {
struct V_73 * V_138 = V_73 + V_108 ;
F_165 ( F_132 ( V_138 ) < 0 ) ;
V_136 += F_132 ( V_138 ) ;
F_165 ( V_136 < 0 ) ;
F_165 ( F_166 ( & V_138 -> V_139 ) != 0 ) ;
F_167 ( F_132 ( V_73 ) + F_132 ( V_138 ) + 1 ,
& V_138 -> V_139 ) ;
F_168 () ;
V_138 -> V_86 &= ~ V_140 | V_141 ;
V_138 -> V_86 |= ( V_73 -> V_86 &
( ( 1L << V_142 ) |
( 1L << V_143 ) |
( 1L << V_144 ) |
( 1L << V_145 ) ) ) ;
V_138 -> V_86 |= ( 1L << V_146 ) ;
F_129 () ;
V_138 -> V_147 = V_73 -> V_147 ;
F_165 ( V_138 -> V_148 ) ;
V_138 -> V_148 = V_73 -> V_148 ;
V_138 -> V_149 = V_73 -> V_149 + V_108 ;
F_165 ( ! F_169 ( V_138 ) ) ;
F_165 ( ! F_170 ( V_138 ) ) ;
F_165 ( ! F_171 ( V_138 ) ) ;
F_165 ( ! F_172 ( V_138 ) ) ;
F_173 ( V_1 , V_73 , V_138 ) ;
}
F_174 ( V_136 , & V_73 -> V_139 ) ;
F_165 ( F_166 ( & V_73 -> V_139 ) <= 0 ) ;
F_175 ( V_73 , V_150 ) ;
F_176 ( V_1 , V_151 , V_51 ) ;
F_177 ( V_73 ) ;
F_178 ( V_73 ) ;
F_179 ( & V_1 -> V_137 ) ;
...
static int F_181 ( struct V_73 * V_73 ,
struct V_68 * V_69 ,
unsigned long V_85 )
{
struct V_62 * V_63 = V_69 -> V_122 ;
...
F_129 () ;
F_79 ( V_63 , V_85 , V_67 , F_185 ( * V_67 ) ) ;
F_186 ( V_69 , V_85 , V_85 + V_90 ) ;
F_122 ( V_63 , V_67 , V_61 ) ;
V_34 = 1 ;
}
F_73 ( & V_63 -> V_64 ) ;
...
static void F_187 ( struct V_73 * V_73 ,
struct V_104 * V_104 )
{
int V_152 , V_153 ;
struct V_154 * V_155 ;
...
F_165 ( F_188 ( V_73 ) ) ;
V_152 = 0 ;
F_189 (avc, &anon_vma->head, same_anon_vma) {
struct V_68 * V_69 = V_155 -> V_69 ;
unsigned long V_99 = F_190 ( V_73 , V_69 ) ;
F_165 ( F_191 ( V_69 ) ) ;
if ( V_99 == - V_156 )
continue;
V_152 += F_158 ( V_73 , V_69 , V_99 ) ;
}
if ( V_152 != F_132 ( V_73 ) )
F_13 ( V_20 L_15 ,
V_152 , F_132 ( V_73 ) ) ;
F_165 ( V_152 != F_132 ( V_73 ) ) ;
F_160 ( V_73 ) ;
V_153 = 0 ;
F_189 (avc, &anon_vma->head, same_anon_vma) {
struct V_68 * V_69 = V_155 -> V_69 ;
...
if ( V_99 == - V_156 )
continue;
V_153 += F_181 ( V_73 , V_69 , V_99 ) ;
}
if ( V_152 != V_153 )
F_13 ( V_20 L_16 ,
V_152 , V_153 , F_132 ( V_73 ) ) ;
F_165 ( V_152 != V_153 ) ;
}
int F_192 ( struct V_73 * V_73 )
{
struct V_104 * V_104 ;
int V_34 = 1 ;
F_165 ( ! F_169 ( V_73 ) ) ;
...
int F_195 ( struct V_68 * V_69 ,
unsigned long * V_70 , int V_158 )
{
switch ( V_158 ) {
case V_159 :
if ( * V_70 & ( V_160 | V_161 ) )
...
static inline struct V_163 * F_200 ( void )
{
if ( ! V_13 )
return NULL ;
return F_201 ( V_13 , V_94 ) ;
}
static inline void F_202 ( struct V_163 * V_163 )
{
F_203 ( V_13 , V_163 ) ;
}
static int T_3 F_54 ( void )
{
V_14 = F_204 ( V_164 * sizeof( struct V_165 ) ,
V_94 ) ;
if ( ! V_14 )
return - V_15 ;
return 0 ;
}
static struct V_163 * F_205 ( struct V_62 * V_63 )
{
struct V_163 * V_163 ;
struct V_165 * V_166 ;
struct V_167 * V_168 ;
V_166 = & V_14 [ ( ( unsigned long ) V_63 / sizeof( struct V_62 ) )
% V_164 ] ;
F_206 (mm_slot, node, bucket, hash) {
if ( V_63 == V_163 -> V_63 )
return V_163 ;
}
return NULL ;
}
static void F_207 ( struct V_62 * V_63 ,
struct V_163 * V_163 )
{
struct V_165 * V_166 ;
V_166 = & V_14 [ ( ( unsigned long ) V_63 / sizeof( struct V_62 ) )
% V_164 ] ;
V_163 -> V_63 = V_63 ;
F_208 ( & V_163 -> V_169 , V_166 ) ;
}
static inline int F_209 ( struct V_62 * V_63 )
{
return F_166 ( & V_63 -> V_170 ) == 0 ;
}
int F_210 ( struct V_62 * V_63 )
{
struct V_163 * V_163 ;
int V_12 ;
V_163 = F_200 () ;
...
if ( V_69 -> V_177 )
return 0 ;
F_19 ( F_214 ( V_69 ) || V_69 -> V_70 & V_161 ) ;
V_175 = ( V_69 -> V_89 + ~ V_87 ) & V_87 ;
V_176 = V_69 -> V_91 & V_87 ;
if ( V_175 < V_176 )
return F_88 ( V_69 ) ;
return 0 ;
}
void F_215 ( struct V_62 * V_63 )
{
struct V_163 * V_163 ;
int free = 0 ;
F_71 ( & V_172 ) ;
V_163 = F_205 ( V_63 ) ;
if ( V_163 && V_21 . V_163 != V_163 ) {
F_216 ( & V_163 -> V_169 ) ;
F_110 ( & V_163 -> V_173 ) ;
free = 1 ;
}
...
static void F_220 ( struct V_73 * V_73 )
{
F_221 ( V_73 , V_179 + 0 ) ;
F_222 ( V_73 ) ;
F_223 ( V_73 ) ;
}
static void F_224 ( T_7 * V_88 , T_7 * V_180 )
{
while ( -- V_180 >= V_88 ) {
T_7 V_181 = * V_180 ;
if ( ! F_126 ( V_181 ) )
...
static void F_226 ( T_7 * V_88 )
{
F_224 ( V_88 , V_88 + V_51 ) ;
}
...
for ( V_180 = V_88 ; V_180 < V_88 + V_51 ;
V_180 ++ , V_85 += V_111 ) {
T_7 V_181 = * V_180 ;
if ( F_126 ( V_181 ) ) {
if ( ++ V_184 <= V_49 )
...
if ( ! F_228 ( V_181 ) || ! F_229 ( V_181 ) ) {
F_224 ( V_88 , V_180 ) ;
goto V_16;
}
V_73 = F_230 ( V_69 , V_85 , V_181 ) ;
if ( F_9 ( ! V_73 ) ) {
F_224 ( V_88 , V_180 ) ;
goto V_16;
}
...
F_19 ( ! F_234 ( V_73 ) ) ;
F_19 ( F_235 ( V_73 ) ) ;
if ( F_236 ( V_181 ) || F_237 ( V_73 ) ||
F_238 ( V_69 -> V_122 , V_85 ) )
V_182 = 1 ;
}
if ( F_9 ( ! V_182 ) )
F_226 ( V_88 ) ;
...
static void F_239 ( T_7 * V_88 , struct V_73 * V_73 ,
struct V_68 * V_69 ,
unsigned long V_85 ,
T_11 * V_185 )
{
T_7 * V_180 ;
for ( V_180 = V_88 ; V_180 < V_88 + V_51 ; V_180 ++ ) {
T_7 V_181 = * V_180 ;
struct V_73 * V_100 ;
if ( F_126 ( V_181 ) ) {
F_240 ( V_73 , V_85 ) ;
...
static void F_243 ( struct V_62 * V_63 ,
unsigned long V_85 ,
struct V_73 * * V_186 ,
struct V_68 * V_69 ,
int V_168 )
...
if ( F_9 ( F_209 ( V_63 ) ) )
goto V_16;
V_69 = F_248 ( V_63 , V_85 ) ;
V_175 = ( V_69 -> V_89 + ~ V_87 ) & V_87 ;
V_176 = V_69 -> V_91 & V_87 ;
if ( V_85 < V_175 || V_85 + V_90 > V_176 )
goto V_16;
if ( ( ! ( V_69 -> V_70 & V_160 ) && ! F_249 () ) ||
( V_69 -> V_70 & V_129 ) )
goto V_16;
if ( ! V_69 -> V_104 || V_69 -> V_177 )
goto V_16;
if ( F_191 ( V_69 ) )
goto V_16;
F_19 ( F_214 ( V_69 ) || V_69 -> V_70 & V_161 ) ;
...
goto V_16;
V_67 = F_157 ( V_133 , V_85 ) ;
if ( ! F_250 ( * V_67 ) || F_94 ( * V_67 ) )
goto V_16;
F_251 ( V_69 -> V_104 ) ;
V_88 = F_95 ( V_67 , V_85 ) ;
V_185 = F_252 ( V_63 , V_67 ) ;
F_71 ( & V_63 -> V_64 ) ;
V_107 = F_121 ( V_69 , V_85 , V_67 ) ;
F_73 ( & V_63 -> V_64 ) ;
F_71 ( V_185 ) ;
V_183 = F_227 ( V_69 , V_85 , V_88 ) ;
F_73 ( V_185 ) ;
if ( F_9 ( ! V_183 ) ) {
F_128 ( V_88 ) ;
F_71 ( & V_63 -> V_64 ) ;
...
F_253 ( V_69 -> V_104 ) ;
F_239 ( V_88 , V_114 , V_69 , V_85 , V_185 ) ;
F_128 ( V_88 ) ;
F_70 ( V_114 ) ;
V_61 = F_254 ( V_107 ) ;
F_19 ( F_180 ( V_61 ) != 1 ) ;
...
static int F_255 ( struct V_62 * V_63 ,
struct V_68 * V_69 ,
unsigned long V_85 ,
struct V_73 * * V_186 )
{
...
if ( ! F_250 ( * V_67 ) || F_94 ( * V_67 ) )
goto V_16;
V_88 = F_256 ( V_63 , V_67 , V_85 , & V_185 ) ;
for ( V_190 = V_85 , V_180 = V_88 ; V_180 < V_88 + V_51 ;
V_180 ++ , V_190 += V_111 ) {
T_7 V_181 = * V_180 ;
if ( F_126 ( V_181 ) ) {
if ( ++ V_184 <= V_49 )
...
if ( ! F_228 ( V_181 ) || ! F_229 ( V_181 ) )
goto V_191;
V_73 = F_230 ( V_69 , V_190 , V_181 ) ;
if ( F_9 ( ! V_73 ) )
goto V_191;
if ( V_168 == - 1 )
V_168 = F_114 ( V_73 ) ;
F_19 ( F_65 ( V_73 ) ) ;
if ( ! F_235 ( V_73 ) || F_234 ( V_73 ) || ! F_169 ( V_73 ) )
goto V_191;
if ( F_180 ( V_73 ) != 1 )
goto V_191;
if ( F_236 ( V_181 ) || F_237 ( V_73 ) ||
...
F_257 ( V_88 , V_185 ) ;
if ( V_34 )
F_243 ( V_63 , V_85 , V_186 , V_69 , V_168 ) ;
V_16:
return V_34 ;
}
static void F_258 ( struct V_163 * V_163 )
{
struct V_62 * V_63 = V_163 -> V_63 ;
F_19 ( V_192 != 1 && ! F_259 ( & V_172 ) ) ;
if ( F_209 ( V_63 ) ) {
F_216 ( & V_163 -> V_169 ) ;
F_110 ( & V_163 -> V_173 ) ;
F_202 ( V_163 ) ;
...
static unsigned int F_260 ( unsigned int V_45 ,
struct V_73 * * V_186 )
__releases( &khugepaged_mm_lock
static int F_261 ( void )
{
...
static void F_263 ( struct V_73 * * V_186 )
{
...
void F_276 ( struct V_62 * V_63 , T_5 * V_67 )
{
struct V_73 * V_73 ;
F_71 ( & V_63 -> V_64 ) ;
if ( F_9 ( ! F_94 ( * V_67 ) ) ) {
...
static void F_277 ( struct V_62 * V_63 ,
unsigned long V_85 )
{
T_9 * V_132 ;
T_10 * V_133 ;
...
void F_279 ( struct V_68 * V_69 ,
unsigned long V_196 ,
unsigned long V_120 ,
long V_197 )
{
if ( V_196 & ~ V_87 &&
( V_196 & V_87 ) >= V_69 -> V_89 &&
( V_196 & V_87 ) + V_90 <= V_69 -> V_91 )
F_277 ( V_69 -> V_122 , V_196 ) ;
if ( V_120 & ~ V_87 &&
( V_120 & V_87 ) >= V_69 -> V_89 &&
( V_120 & V_87 ) + V_90 <= V_69 -> V_91 )
F_277 ( V_69 -> V_122 , V_120 ) ;
if ( V_197 > 0 ) {
struct V_68 * V_105 = V_69 -> V_198 ;
unsigned long V_199 = V_105 -> V_89 ;
V_199 += V_197 << V_10 ;
if ( V_199 & ~ V_87 &&
( V_199 & V_87 ) >= V_105 -> V_89 &&
( V_199 & V_87 ) + V_90 <= V_105 -> V_91 )
F_277 ( V_105 -> V_122 , V_199 ) ;
}
}
