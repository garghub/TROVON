...
return - V_171 ;
return F_115 ( V_10 -> V_1 , V_10 -> V_21 , V_238 ) ;
}
...
F_118 ( V_1 , V_10 , (struct V_244 * ) V_61 ) ;
}
...
static int F_125 ( struct V_282 * V_283 , void * V_161 )
{
struct V_1 * V_1 = V_283 -> V_284 ;
int V_285 = F_126 ( V_1 -> V_33 . V_286 , V_287 ) ;
...
int V_290 = F_132 ( V_287 , V_1 -> V_33 . V_286 - V_287 * V_288 ) ;
F_129 ( L_19 , L_20 ) ;
F_129 ( L_21 ,
...
F_130 ( L_26 , V_75 . V_217 ) ;
F_130 ( L_27 , V_75 . V_292 ) ;
F_130 ( L_28 , V_75 . V_2 ) ;
F_130 ( L_29 , V_75 . V_293 ) ;
F_131 ( L_30 , V_40 . V_76 ) ;
F_131 ( L_31 , V_40 . V_217 ) ;
F_131 ( L_32 , V_40 . V_294 ) ;
F_128 ( L_33 , L_34 , F_80 ( V_1 , & V_34 [ V_29 ] . V_40 ) ) ;
F_128 ( L_33 , L_35 ,
V_1 -> V_33 . V_158 [ V_34 [ V_29 ] . V_40 . V_157 ] ) ;
F_131 ( L_36 , V_40 . V_293 ) ;
F_131 ( L_37 , V_40 . V_295 ) ;
F_131 ( L_38 , V_84 . V_76 ) ;
F_131 ( L_39 , V_84 . V_217 - V_218 ) ;
F_131 ( L_40 , V_84 . V_296 ) ;
F_131 ( L_41 , V_84 . V_2 ) ;
F_131 ( L_42 , V_84 . V_293 ) ;
return 0 ;
}
V_288 -= V_285 ;
if ( V_288 == 0 ) {
...
F_133 ( V_283 , L_45 , L_30 , V_297 -> V_76 ) ;
...
F_133 ( V_283 , L_45 , L_30 , V_50 -> V_76 ) ;
F_133 ( V_283 , L_45 , L_34 ,
F_80 ( V_1 , V_50 ) ) ;
F_133 ( V_283 , L_45 , L_35 ,
V_1 -> V_33 . V_158 [ V_50 -> V_157 ] ) ;
F_133 ( V_283 , L_45 , L_46 , V_50 -> V_293 ) ;
F_133 ( V_283 , L_45 , L_37 , V_50 -> V_295 ) ;
}
#undef F_131
#undef F_130
#undef F_129
...
{
return F_126 ( V_1 -> V_33 . V_286 , V_287 ) + 1 +
( ( V_1 -> V_48 & V_49 ) != 0 ) ;
}
...
static void F_136 ( struct V_282 * V_283 , void * V_161 )
{
}
static void * F_137 ( struct V_282 * V_283 , void * V_161 , T_8 * V_298 )
{
int V_299 = F_134 ( V_283 -> V_284 ) ;
++ * V_298 ;
return * V_298 < V_299 ? ( void * ) ( ( V_289 ) * V_298 + 1 ) : NULL ;
...
static int F_140 ( struct V_282 * V_283 , void * V_161 )
{
struct V_1 * V_1 = V_283 -> V_284 ;
int V_285 = F_126 ( V_1 -> V_33 . V_286 , V_287 ) ;
int V_29 , V_288 = ( V_289 ) V_161 - 1 ;
...
? V_34 [ V_29 ] . V_40 . V_291 -> V_19
: L_22 ) ) ;
F_142 ( L_33 , L_48 , V_40 . V_306 ) ;
F_131 ( L_49 , V_87 . V_307 ) ;
F_131 ( L_50 , V_87 . V_249 ) ;
F_131 ( L_51 , V_87 . V_250 ) ;
F_131 ( L_52 , V_87 . V_253 ) ;
F_131 ( L_53 , V_87 . V_252 ) ;
F_131 ( L_54 , V_87 . V_308 ) ;
F_130 ( L_55 , V_245 ) ;
F_130 ( L_56 , V_247 ) ;
F_130 ( L_57 , V_251 ) ;
F_130 ( L_58 , V_75 . V_309 ) ;
F_130 ( L_59 , V_75 . V_77 ) ;
F_130 ( L_60 , V_310 ) ;
F_131 ( L_61 , V_84 . V_311 ) ;
F_131 ( L_62 , V_84 . V_312 ) ;
F_131 ( L_63 , V_84 . V_313 ) ;
return 0 ;
}
V_288 -= V_285 ;
if ( V_288 == 0 ) {
...
F_133 ( V_283 , L_65 , L_48 ,
V_50 -> V_306 ) ;
F_133 ( V_283 , L_65 , L_36 , V_50 -> V_293 ) ;
F_133 ( V_283 , L_65 , L_37 , V_50 -> V_295 ) ;
}
#undef F_131
#undef F_130
#undef F_129
...
static void F_145 ( struct V_282 * V_283 , void * V_161 )
{
}
static void * F_146 ( struct V_282 * V_283 , void * V_161 , T_8 * V_298 )
{
int V_299 = F_143 ( V_283 -> V_284 ) ;
( * V_298 ) ++ ;
return * V_298 < V_299 ? ( void * ) ( ( V_289 ) * V_298 + 1 ) : NULL ;
...
static int F_148 ( struct V_282 * V_283 , void * V_161 )
{
struct V_1 * V_1 = V_283 -> V_284 ;
...
static int F_151 ( struct V_282 * V_283 , void * V_161 )
{
if ( V_161 == V_327 ) {
F_152 ( V_283 , L_78 ) ;
} else {
...
static void * F_155 ( struct V_282 * V_283 , void * V_161 , T_8 * V_298 )
{
( * V_298 ) ++ ;
return F_153 ( V_283 -> V_284 , * V_298 ) ;
}
static void F_156 ( struct V_282 * V_283 , void * V_161 )
{
}
...
struct V_9 * V_10 = F_46 ( V_1 , V_2 ) ;
V_10 -> V_82 = V_347 ;
V_10 -> V_32 = F_181 ( & V_10 -> V_11 ) ? V_345 : 1 ;
V_347 += V_10 -> V_32 ;
}
V_7 -> V_286 = V_347 ;
V_343 = 64 ;
...
F_179 ( & V_34 -> V_40 , 0 , 0 , 1024 , V_343 ) ;
V_34 -> V_84 . V_217 = 72 ;
V_70 -> V_75 . V_217 = 1024 ;
}
F_179 ( & V_7 -> V_38 , V_164 , 0 , 512 , V_343 ) ;
F_179 ( & V_7 -> V_50 , V_164 , 0 , V_349 + 1 ,
V_343 ) ;
}
static void T_11 F_183 ( struct V_1 * V_1 , int V_290 )
{
int V_150 ;
struct V_9 * V_10 ;
...
while ( ( V_35 = F_185 ( V_1 -> V_104 , V_299 , V_350 ) ) >= V_351 )
V_350 = V_35 ;
if ( V_35 == 0 ) {
...
static int T_11 F_188 ( struct V_356 * V_104 ,
...
V_384 ) ;
if ( F_159 ( V_1 -> V_330 ) )
F_178 ( & V_104 -> V_5 , L_126
L_127 ) ;
else
F_158 ( V_1 ) ;
}
if ( V_30 == V_385 && F_184 ( V_1 ) == 0 )
V_1 -> V_48 |= V_103 ;
else {
V_35 = F_208 ( V_104 ) ;
if ( V_35 ) {
...
static void T_13 F_218 ( struct V_356 * V_104 )
{
...
static void T_13 F_222 ( struct V_356 * V_104 )
{
struct V_1 * V_1 ;
int V_2 ;
V_1 = F_219 ( V_104 ) ;
...
V_384 = F_207 ( V_197 , NULL ) ;
if ( F_159 ( V_384 ) )
F_6 (KERN_WARNING KBUILD_MODNAME L_136
L_137 ) ;
V_20 = F_224 ( & V_388 ) ;
if ( V_20 < 0 && ! F_159 ( V_384 ) )
F_225 ( V_384 ) ;
return V_20 ;
}
