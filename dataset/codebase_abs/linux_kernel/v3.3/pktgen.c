...
static void F_79 ( struct V_21 * V_22 , T_1 V_199 )
{
T_1 V_200 , V_201 ;
T_8 V_202 ;
struct V_203 V_149 ;
F_80 ( & V_149 . V_204 , V_205 , V_206 ) ;
F_81 ( & V_149 . V_204 , V_199 ) ;
V_202 = F_82 ( F_83 ( & V_149 . V_204 ) ) ;
if ( V_202 <= 0 ) {
V_22 -> V_207 = F_84 ( V_199 , V_22 -> V_29 ) ;
return;
}
V_200 = F_1 () ;
if ( V_202 < 100000 ) {
...
do {
F_86 ( V_209 ) ;
F_87 ( & V_149 . V_204 , V_206 ) ;
if ( ! F_88 ( & V_149 . V_204 ) )
V_149 . V_210 = NULL ;
if ( F_89 ( V_149 . V_210 ) )
F_90 () ;
F_91 ( & V_149 . V_204 ) ;
} while ( V_149 . V_210 && V_22 -> V_86 && ! F_92 ( V_208 ) );
F_93 ( V_211 ) ;
V_201 = F_1 () ;
}
V_22 -> V_88 += F_82 ( F_94 ( V_201 , V_200 ) ) ;
V_22 -> V_207 = F_84 ( V_199 , V_22 -> V_29 ) ;
}
...
static inline int F_98 ( const struct V_21 * V_22 , int V_214 )
{
...
static void F_101 ( struct V_21 * V_22 , int V_214 )
{
struct V_218 * V_219 = V_22 -> V_215 [ V_214 ] . V_219 ;
if ( ! V_219 ) {
V_219 = F_102 ( & V_171 , V_220 ,
( V_221 * ) & V_22 -> V_99 ,
( V_221 * ) & V_22 -> V_98 ,
V_222 ,
V_22 -> V_223 ,
...
static int F_111 ( struct V_234 * V_235 , struct V_21 * V_22 )
{
...
int V_150 ;
T_11 * V_245 ;
V_244 = V_219 -> V_225 . V_226 - F_117 ( V_235 ) ;
if ( V_244 > 0 ) {
V_150 = F_118 ( V_235 , V_244 , 0 , V_246 ) ;
if ( V_150 < 0 ) {
F_49 ( L_229 ,
V_150 ) ;
goto V_14;
...
F_119 ( V_235 , V_247 ) ;
V_150 = F_111 ( V_235 , V_22 ) ;
if ( V_150 ) {
F_49 ( L_230 , V_150 ) ;
goto V_14;
}
V_245 = ( T_11 * ) F_120 ( V_235 , V_247 ) ;
...
static void F_122 ( V_231 * V_249 , struct V_21 * V_22 )
{
unsigned V_60 ;
for ( V_60 = 0 ; V_60 < V_22 -> V_59 ; V_60 ++ )
...
static inline T_10 F_123 ( unsigned int V_250 , unsigned int V_251 ,
unsigned int V_252 )
{
return F_124 ( V_250 | ( V_251 << 12 ) | ( V_252 << 13 ) ) ;
}
static void F_125 ( struct V_21 * V_22 , struct V_234 * V_235 ,
int V_253 )
{
struct V_254 V_255 ;
struct V_256 * V_257 ;
V_257 = (struct V_256 * ) F_126 ( V_235 , sizeof( * V_257 ) ) ;
V_253 -= sizeof( * V_257 ) ;
if ( V_22 -> V_28 <= 0 ) {
memset ( F_126 ( V_235 , V_253 ) , 0 , V_253 ) ;
} else {
int V_258 = V_22 -> V_28 ;
int V_60 , V_114 ;
int V_259 ;
...
if ( V_114 > 0 ) {
memset ( F_126 ( V_235 , V_114 ) , 0 , V_114 ) ;
V_253 = V_258 * V_261 ;
}
V_60 = 0 ;
...
V_70 = V_22 -> V_70 ;
V_22 -> V_136 = F_129 ( V_70 , V_262 | V_263 , 0 ) ;
if ( ! V_22 -> V_136 )
break;
}
F_130 ( V_22 -> V_136 ) ;
F_131 ( V_235 , V_60 , V_22 -> V_136 ) ;
F_132 ( V_235 ) -> V_258 [ V_60 ] . V_264 = 0 ;
if ( V_60 == ( V_258 - 1 ) )
F_133 ( & F_132 ( V_235 ) -> V_258 [ V_60 ] ,
( V_253 < V_261 ? V_253 : V_261 ) ) ;
else
F_133 ( & F_132 ( V_235 ) -> V_258 [ V_60 ] , V_259 ) ;
V_253 -= F_134 ( & F_132 ( V_235 ) -> V_258 [ V_60 ] ) ;
V_235 -> V_114 += F_134 ( & F_132 ( V_235 ) -> V_258 [ V_60 ] ) ;
V_235 -> V_265 += F_134 ( & F_132 ( V_235 ) -> V_258 [ V_60 ] ) ;
V_60 ++ ;
F_132 ( V_235 ) -> V_266 = V_60 ;
}
}
...
static struct V_234 * F_136 ( struct V_162 * V_50 ,
struct V_21 * V_22 )
{
...
V_70 = F_128 () ;
V_235 = F_137 ( V_285 + V_22 -> V_130 + 64
...
F_140 ( V_235 -> V_15 ) ;
F_138 ( V_235 , V_253 ) ;
V_245 = ( T_11 * ) F_120 ( V_235 , 14 ) ;
V_249 = ( V_231 * ) F_126 ( V_235 , V_22 -> V_59 * sizeof( T_7 ) ) ;
if ( V_22 -> V_59 )
F_122 ( V_249 , V_22 ) ;
if ( V_22 -> V_62 != 0xffff ) {
if ( V_22 -> V_65 != 0xffff ) {
V_279 = ( T_10 * ) F_126 ( V_235 , sizeof( T_10 ) ) ;
* V_279 = F_123 ( V_22 -> V_65 ,
V_22 -> V_67 ,
V_22 -> V_66 ) ;
V_280 = ( T_10 * ) F_126 ( V_235 , sizeof( T_10 ) ) ;
* V_280 = F_124 ( V_283 ) ;
}
V_277 = ( T_10 * ) F_126 ( V_235 , sizeof( T_10 ) ) ;
* V_277 = F_123 ( V_22 -> V_62 ,
V_22 -> V_64 ,
V_22 -> V_63 ) ;
V_278 = ( T_10 * ) F_126 ( V_235 , sizeof( T_10 ) ) ;
* V_278 = F_124 ( V_276 ) ;
}
V_235 -> V_287 = V_235 -> V_288 ;
V_235 -> V_289 = V_235 -> V_287 + sizeof( struct V_274 ) ;
F_126 ( V_235 , sizeof( struct V_274 ) + sizeof( struct V_271 ) ) ;
F_141 ( V_235 , V_281 ) ;
...
V_272 -> V_291 = F_124 ( V_22 -> V_101 ) ;
V_272 -> V_292 = F_124 ( V_22 -> V_100 ) ;
V_272 -> V_114 = F_124 ( V_253 + 8 ) ;
V_272 -> V_293 = 0 ;
V_275 -> V_294 = 5 ;
V_275 -> V_9 = 4 ;
V_275 -> V_295 = 32 ;
...
V_275 -> V_250 = F_124 ( V_22 -> V_299 ) ;
V_22 -> V_299 ++ ;
V_275 -> V_300 = 0 ;
V_273 = 20 + 8 + V_253 ;
V_275 -> V_301 = F_124 ( V_273 ) ;
V_275 -> V_293 = 0 ;
V_275 -> V_293 = F_144 ( ( void * ) V_275 , V_275 -> V_294 ) ;
V_235 -> V_243 = V_243 ;
V_235 -> V_302 = ( V_235 -> V_287 - V_247 -
V_22 -> V_212 ) ;
V_235 -> V_163 = V_50 ;
V_235 -> V_303 = V_304 ;
F_125 ( V_22 , V_235 , V_253 ) ;
#ifdef F_21
if ( ! F_116 ( V_22 , V_235 , V_243 ) )
return NULL ;
#endif
return V_235 ;
}
...
static struct V_234 * F_147 ( struct V_162 * V_50 ,
struct V_21 * V_22 )
{
struct V_234 * V_235 = NULL ;
T_11 * V_245 ;
...
F_126 ( V_235 , sizeof( struct V_312 ) + sizeof( struct V_271 ) ) ;
F_141 ( V_235 , V_281 ) ;
V_235 -> V_290 = V_22 -> V_36 ;
V_275 = F_148 ( V_235 ) ;
V_272 = F_143 ( V_235 ) ;
...
V_272 -> V_291 = F_124 ( V_22 -> V_101 ) ;
V_272 -> V_292 = F_124 ( V_22 -> V_100 ) ;
V_272 -> V_114 = F_124 ( V_253 + sizeof( struct V_271 ) ) ;
V_272 -> V_293 = 0 ;
...
V_275 -> V_314 = 32 ;
V_275 -> V_315 = F_124 ( sizeof( struct V_271 ) + V_253 ) ;
V_275 -> V_316 = V_296 ;
...
static struct V_234 * F_150 ( struct V_162 * V_50 ,
struct V_21 * V_22 )
{
if ( V_22 -> V_37 & V_38 )
...
{
int V_266 = V_22 -> V_235 ? F_132 ( V_22 -> V_235 ) -> V_266 : - 1 ;
if ( ! V_22 -> V_86 ) {
F_13 ( L_237 ,
V_22 -> V_31 ) ;
return - V_125 ;
...
F_45 ( V_149 ) ;
F_164 (q, n, &t->if_list) {
V_330 = F_165 ( V_329 , struct V_21 , V_331 ) ;
if ( ! V_330 -> V_157 )
continue;
F_121 ( V_330 -> V_235 ) ;
V_330 -> V_235 = NULL ;
...
{
F_61 ( V_149 -> V_332 -> V_333 , V_165 ) ;
}
static void F_169 ( struct V_21 * V_22 )
{
T_1 V_334 = F_1 () ;
F_90 () ;
V_22 -> V_88 += F_82 ( F_94 ( F_1 () , V_334 ) ) ;
}
static void F_170 ( struct V_21 * V_22 )
{
T_1 V_334 = F_1 () ;
while ( F_171 ( & ( V_22 -> V_235 -> V_335 ) ) != 1 ) {
if ( F_92 ( V_208 ) )
break;
if ( F_172 () )
F_169 ( V_22 ) ;
...
T_13 (* F_175)( struct V_234 * , struct V_162 * )
= V_50 -> V_336 -> V_337 ;
struct V_338 * V_339 ;
V_248 V_281 ;
int V_150 ;
...
V_22 -> V_207 = F_84 ( F_1 () , V_340 ) ;
return;
}
if ( ! V_22 -> V_235 || ( V_22 -> V_341 &&
++ V_22 -> V_342 >= V_22 -> V_30 ) ) {
F_121 ( V_22 -> V_235 ) ;
V_22 -> V_235 = F_150 ( V_50 , V_22 ) ;
if ( V_22 -> V_235 == NULL ) {
F_49 ( L_238 ) ;
F_90 () ;
V_22 -> V_342 -- ;
...
F_79 ( V_22 , V_22 -> V_207 ) ;
V_281 = F_177 ( V_22 -> V_235 ) ;
V_339 = F_178 ( V_50 , V_281 ) ;
F_179 ( V_339 ) ;
if ( F_127 ( F_180 ( V_339 ) ) ) {
V_150 = V_345 ;
V_22 -> V_341 = 0 ;
goto V_346;
}
F_181 ( & ( V_22 -> V_235 -> V_335 ) ) ;
V_150 = (* F_175)( V_22 -> V_235 , V_50 ) ;
switch ( V_150 ) {
case V_347 :
F_182 ( V_339 ) ;
V_22 -> V_341 = 1 ;
...
F_59 ( L_241 , V_149 -> V_332 -> V_333 ) ;
F_162 ( V_149 ) ;
F_59 ( L_242 , V_149 -> V_332 -> V_333 ) ;
F_167 ( V_149 ) ;
F_59 ( L_243 , V_149 -> V_332 -> V_333 ) ;
F_168 ( V_149 ) ;
while ( ! F_191 () ) {
F_86 ( V_209 ) ;
F_90 () ;
...
struct V_21 * V_22 ;
int V_14 ;
int V_70 = F_196 ( V_149 -> V_354 ) ;
V_22 = F_56 ( V_154 , V_156 ) ;
if ( V_22 ) {
F_49 ( L_246 ) ;
return - V_361 ;
}
V_22 = F_197 ( sizeof( struct V_21 ) , V_262 , V_70 ) ;
if ( ! V_22 )
return - V_363 ;
strcpy ( V_22 -> V_31 , V_154 ) ;
V_22 -> V_215 = F_198 ( V_145 * sizeof( struct V_364 ) ,
V_70 ) ;
if ( V_22 -> V_215 == NULL ) {
F_199 ( V_22 ) ;
return - V_363 ;
...
static int T_14 F_201 ( int V_354 )
{
struct V_148 * V_149 ;
struct V_373 * V_374 ;
struct V_375 * V_325 ;
V_149 = F_197 ( sizeof( struct V_148 ) , V_262 ,
F_196 ( V_354 ) ) ;
if ( ! V_149 ) {
F_49 ( L_248 ) ;
return - V_363 ;
...
F_210 ( V_325 , V_354 ) ;
V_149 -> V_332 = V_325 ;
V_374 = F_62 ( V_149 -> V_332 -> V_333 , 0600 , V_165 ,
& V_378 , V_149 ) ;
if ( ! V_374 ) {
F_49 ( L_247 ,
...
struct V_21 * V_325 ;
F_164 (q, n, &t->if_list) {
V_325 = F_165 ( V_329 , struct V_21 , V_331 ) ;
if ( V_325 == V_22 )
F_208 ( & V_325 -> V_331 ) ;
}
}
...
struct V_328 * V_329 , * V_113 ;
V_357 = true ;
F_164 (q, n, &pktgen_threads) {
V_149 = F_165 ( V_329 , struct V_148 , V_376 ) ;
F_211 ( V_149 -> V_332 ) ;
F_199 ( V_149 ) ;
}
F_221 ( & V_383 ) ;
