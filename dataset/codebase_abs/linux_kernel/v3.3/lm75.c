...
V_25 | V_26 ) )
return - V_27 ;
V_9 = F_17 ( sizeof( struct V_8 ) , V_28 ) ;
if ( ! V_9 )
return - V_29 ;
F_18 ( V_14 , V_9 ) ;
F_19 ( & V_9 -> V_16 ) ;
...
V_20 = F_22 ( & V_14 -> V_2 . V_33 , & V_34 ) ;
if ( V_20 )
goto V_31;
V_9 -> V_35 = F_23 ( & V_14 -> V_2 ) ;
if ( F_4 ( V_9 -> V_35 ) ) {
V_20 = F_5 ( V_9 -> V_35 ) ;
goto V_36;
}
...
static int F_20 ( struct V_13 * V_14 , T_3 V_51 )
{
if ( V_51 == V_30 )
...
static int F_13 ( struct V_13 * V_14 , T_3 V_51 , T_4 V_52 )
{
if ( V_51 == V_30 )
...
struct V_8 * V_53 = V_9 ;
F_11 ( & V_9 -> V_16 ) ;
if ( F_38 ( V_54 , V_9 -> V_55 + V_56 + V_56 / 2 )
|| ! V_9 -> V_57 ) {
int V_42 ;
F_21 ( & V_14 -> V_2 , L_7 ) ;
for ( V_42 = 0 ; V_42 < F_39 ( V_9 -> V_10 ) ; V_42 ++ ) {
int V_20 ;
V_20 = F_20 ( V_14 , V_17 [ V_42 ] ) ;
if ( F_40 ( V_20 < 0 ) ) {
F_21 ( V_2 ,
L_8 ,
V_17 [ V_42 ] , V_20 ) ;
