...
int F_49 ( struct V_72 * V_73 , char * V_105 , T_10 V_25 ,
struct V_98 * V_99 ,
struct V_106 * V_107 )
{
...
int F_61 ( struct V_72 * V_73 , char * V_105 , T_10 V_25 ,
struct V_98 * V_99 ,
char T_7 * V_125 )
{
struct V_106 V_107 ;
...
static inline T_12 F_144 ( const struct V_198 * V_199 )
{
return F_138 ( V_199 ) -> error ;
}
static T_13 F_145 ( const struct V_198 * V_199 )
{
const T_13 * V_200 = F_139 ( V_199 ) ;
return F_146 ( * V_200 ) ;
}
