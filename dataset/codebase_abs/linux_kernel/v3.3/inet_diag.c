...
V_26 -> V_42 = 1 ;
V_26 -> V_43 = V_13 -> V_82 ;
V_26 -> V_83 = F_23 ( V_13 -> V_84 ) ;
} else if ( V_13 -> V_80 == V_85 ) {
V_26 -> V_42 = 4 ;
V_26 -> V_43 = V_13 -> V_86 ;
V_26 -> V_83 = F_23 ( V_13 -> V_84 ) ;
} else if ( F_24 ( & V_11 -> V_87 ) ) {
V_26 -> V_42 = 2 ;
V_26 -> V_43 = V_13 -> V_86 ;
V_26 -> V_83 = F_23 ( V_11 -> V_87 . V_88 ) ;
} else {
V_26 -> V_42 = 0 ;
V_26 -> V_83 = 0 ;
}
#undef F_23
if ( V_32 & ( 1 << ( V_89 - 1 ) ) )
V_28 = F_13 ( V_15 , V_89 , sizeof( struct V_90 ) ) ;
if ( ( V_32 & ( 1 << ( V_91 - 1 ) ) ) && V_13 -> V_92 ) {
const T_4 V_93 = strlen ( V_13 -> V_92 -> V_94 ) ;
strcpy ( F_13 ( V_15 , V_91 , V_93 + 1 ) ,
V_13 -> V_92 -> V_94 ) ;
}
V_9 -> V_95 ( V_11 , V_26 , V_28 ) ;
if ( V_11 -> V_36 < V_37 &&
V_13 -> V_92 && V_13 -> V_92 -> V_96 )
V_13 -> V_92 -> V_96 ( V_11 , V_32 , V_15 ) ;
V_79:
V_27 -> V_97 = F_9 ( V_15 ) - V_31 ;
return V_15 -> V_93 ;
V_76:
V_98:
F_25 ( V_15 , V_31 ) ;
...
long T_3 ;
struct V_25 * V_26 ;
const unsigned char * V_102 = F_9 ( V_15 ) ;
struct V_21 * V_27 = F_11 ( V_15 , V_18 , V_19 ,
V_22 -> V_35 , sizeof( * V_26 ) ) ;
V_26 = F_12 ( V_27 ) ;
F_10 ( V_101 -> V_103 != V_37 ) ;
V_27 -> V_20 = V_20 ;
T_3 = V_101 -> V_104 - V_105 ;
if ( T_3 < 0 )
T_3 = 0 ;
V_26 -> V_39 = V_101 -> V_106 ;
V_26 -> V_43 = 0 ;
V_26 -> V_44 . V_45 = V_101 -> V_107 ;
F_14 ( V_101 , V_26 -> V_44 . V_47 ) ;
V_26 -> V_44 . V_48 = V_101 -> V_108 ;
V_26 -> V_44 . V_50 = V_101 -> V_109 ;
V_26 -> V_44 . V_52 [ 0 ] = V_101 -> V_110 ;
V_26 -> V_44 . V_54 [ 0 ] = V_101 -> V_111 ;
V_26 -> V_41 = V_101 -> V_112 ;
V_26 -> V_42 = 3 ;
V_26 -> V_83 = F_29 ( T_3 * 1000 , V_113 ) ;
V_26 -> V_77 = 0 ;
V_26 -> V_78 = 0 ;
V_26 -> V_67 = 0 ;
V_26 -> V_68 = 0 ;
...
static int F_54 ( const void * V_144 , int V_93 , int V_173 )
{
while ( V_93 >= 0 ) {
const struct V_146 * V_147 = V_144 ;
if ( V_173 > V_93 )
...
case V_157 :
case V_150 :
if ( V_147 -> V_153 < 4 || V_147 -> V_153 > V_93 + 4 || V_147 -> V_153 & 3 )
return - V_123 ;
if ( V_147 -> V_153 < V_93 &&
! F_54 ( V_174 , V_175 , V_93 - V_147 -> V_153 ) )
return - V_123 ;
break;
case V_149 :
break;
...
if ( V_147 -> V_145 < 4 || V_147 -> V_145 > V_93 + 4 || V_147 -> V_145 & 3 )
return - V_123 ;
V_144 += V_147 -> V_145 ;
V_93 -= V_147 -> V_145 ;
}
return V_93 == 0 ? 0 : - V_123 ;
}
...
#endif
{
V_143 . V_168 = & V_101 -> V_110 ;
V_143 . V_64 = & V_101 -> V_111 ;
}
V_143 . V_152 = V_101 -> V_179 ;
V_143 . V_156 = F_53 ( V_101 -> V_109 ) ;
V_143 . V_159 = 0 ;
if ( ! F_49 ( V_144 , & V_143 ) )
return 0 ;
}
return F_28 ( V_101 , V_15 , V_26 ,
F_38 ( V_177 -> V_15 ) . V_18 ,
V_177 -> V_27 -> V_129 , V_178 , V_177 -> V_27 ) ;
}
...
goto V_228;
if ( V_26 -> V_124 != V_217 &&
V_101 -> V_106 != V_26 -> V_124 )
goto V_228;
if ( V_26 -> V_44 . V_48 != V_101 -> V_108 &&
V_26 -> V_44 . V_48 )
goto V_228;
if ( V_26 -> V_44 . V_50 != V_101 -> V_109 &&
V_26 -> V_44 . V_50 )
goto V_228;
if ( F_57 ( V_101 , V_15 , V_177 , V_26 , V_144 ) < 0 ) {
F_68 ( V_216 ) ;
goto V_220;
}
V_228:
...
return F_80 ( V_130 , V_15 , V_27 ,
F_77 , NULL , 0 ) ;
}
return F_78 ( V_15 , V_27 ) ;
}
static int F_81 ( struct V_14 * V_15 , struct V_21 * V_241 )
{
int V_230 = sizeof( struct V_16 ) ;
if ( V_97 ( V_241 ) < V_230 )
return - V_123 ;
...
return F_80 ( V_130 , V_15 , V_241 ,
F_73 , NULL , 0 ) ;
}
return F_44 ( V_15 , V_241 , (struct V_16 * ) F_12 ( V_241 ) ) ;
}
int F_82 ( const struct V_1 * V_241 )
{
const T_7 type = V_241 -> V_242 ;
int V_121 = - V_123 ;
if ( type >= V_243 )
goto V_79;
F_3 ( & V_7 ) ;
...
void F_83 ( const struct V_1 * V_241 )
{
const T_7 type = V_241 -> V_242 ;
if ( type >= V_243 )
return;
...
{
const int V_245 = ( V_243 *
sizeof( struct V_1 * ) ) ;
int V_121 = - V_127 ;
V_3 = F_85 ( V_245 , V_128 ) ;
if ( ! V_3 )
goto V_79;
V_121 = F_86 ( & V_1 ) ;
if ( V_121 )
