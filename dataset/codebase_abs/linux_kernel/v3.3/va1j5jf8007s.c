...
static int F_19 ( struct V_4 * V_5 , int V_60 )
{
T_2 V_24 [ 2 ] ;
struct V_10 V_50 ;
V_24 [ 0 ] = 0x17 ;
V_24 [ 1 ] = V_60 ? 0x01 : 0x00 ;
V_50 . V_6 = V_5 -> V_20 -> V_21 ;
V_50 . V_22 = 0 ;
V_50 . V_23 = sizeof( V_24 ) ;
V_50 . V_24 = V_24 ;
...
memcpy ( V_24 , V_62 [ V_7 ] , sizeof( V_24 ) ) ;
if ( F_2 ( V_5 -> V_26 , & V_50 , 1 ) != 1 )
return - V_27 ;
}
return 0 ;
...
T_2 V_24 [ 2 ] ;
struct V_10 V_50 ;
V_5 = F_28 ( sizeof( struct V_4 ) , V_71 ) ;
if ( ! V_5 )
return NULL ;
V_5 -> V_20 = V_20 ;
V_5 -> V_26 = V_26 ;
V_2 = & V_5 -> V_2 ;
memcpy ( & V_2 -> V_72 , & V_73 , sizeof( struct V_74 ) ) ;
V_2 -> V_19 = V_5 ;
V_24 [ 0 ] = 0x01 ;
V_24 [ 1 ] = 0x80 ;
V_50 . V_6 = V_5 -> V_20 -> V_21 ;
