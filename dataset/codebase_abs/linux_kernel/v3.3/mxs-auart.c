...
static int T_4
F_48 ( struct V_124 * V_125 , char * V_142 )
{
struct V_1 * V_2 ;
int V_64 = 9600 ;
int V_134 = 8 ;
...
int V_143 = 'n' ;
int V_144 ;
if ( V_125 -> V_130 == - 1 || V_125 -> V_130 >= F_49 ( V_132 ) )
V_125 -> V_130 = 0 ;
V_2 = V_132 [ V_125 -> V_130 ] ;
if ( ! V_2 )
return - V_145 ;
F_34 ( V_2 -> V_107 ) ;
if ( V_142 )
F_50 ( V_142 , & V_64 , & V_30 , & V_134 , & V_143 ) ;
else
F_47 ( & V_2 -> V_5 , & V_64 , & V_30 , & V_134 ) ;
V_144 = F_51 ( & V_2 -> V_5 , V_125 , V_64 , V_30 , V_134 , V_143 ) ;
F_36 ( V_2 -> V_107 ) ;
return V_144 ;
}
static int T_5 F_52 ( struct V_146 * V_147 )
{
struct V_1 * V_2 ;
T_1 V_148 ;
int V_144 = 0 ;
struct V_149 * V_150 ;
V_2 = F_53 ( sizeof( struct V_1 ) , V_151 ) ;
if ( ! V_2 ) {
V_144 = - V_152 ;
goto V_28;
}
V_2 -> V_107 = F_54 ( & V_147 -> V_50 , NULL ) ;
if ( F_55 ( V_2 -> V_107 ) ) {
V_144 = F_56 ( V_2 -> V_107 ) ;
goto V_153;
}
V_150 = F_57 ( V_147 , V_154 , 0 ) ;
if ( ! V_150 ) {
V_144 = - V_155 ;
goto V_156;
}
V_2 -> V_5 . V_157 = V_150 -> V_158 ;
V_2 -> V_5 . V_7 = F_58 ( V_150 -> V_158 , F_59 ( V_150 ) ) ;
V_2 -> V_5 . V_159 = & V_160 ;
V_2 -> V_5 . V_161 = V_162 ;
V_2 -> V_5 . line = V_147 -> V_163 < 0 ? 0 : V_147 -> V_163 ;
V_2 -> V_5 . V_164 = 16 ;
V_2 -> V_5 . V_89 = F_60 ( V_2 -> V_107 ) ;
V_2 -> V_5 . type = V_47 ;
V_2 -> V_5 . V_50 = V_2 -> V_50 = F_61 ( & V_147 -> V_50 ) ;
V_2 -> V_49 = 0 ;
V_2 -> V_52 = 0 ;
V_2 -> V_91 = F_62 ( V_147 , 0 ) ;
V_2 -> V_5 . V_91 = V_2 -> V_91 ;
V_144 = F_63 ( V_2 -> V_91 , F_29 , 0 , F_20 ( & V_147 -> V_50 ) , V_2 ) ;
if ( V_144 )
goto V_156;
F_64 ( V_147 , V_2 ) ;
V_132 [ V_147 -> V_163 ] = V_2 ;
F_31 ( & V_2 -> V_5 ) ;
V_144 = F_65 ( & V_165 , & V_2 -> V_5 ) ;
if ( V_144 )
goto V_166;
...
static int T_6 F_70 ( struct V_146 * V_147 )
{
struct V_1 * V_2 = F_71 ( V_147 ) ;
F_72 ( & V_165 , & V_2 -> V_5 ) ;
V_132 [ V_147 -> V_163 ] = NULL ;
F_68 ( V_2 -> V_107 ) ;
F_67 ( V_2 -> V_91 , V_2 ) ;
