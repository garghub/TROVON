...
V_223 -> V_231 [ V_232 ] =
* V_4 -> V_229 ;
V_223 -> V_231 [ V_232 ] . V_62 =
V_4 -> V_152 . V_159 [ 0 ] ;
V_223 -> V_231 [ V_232 ] . V_233 =
V_4 -> V_152 . V_203 ;
}
if ( ! V_4 -> V_234 ) {
if ( V_4 -> V_127 )
...
V_223 -> V_231 [ V_237 ] =
* V_4 -> V_234 ;
V_223 -> V_231 [ V_237 ] . V_62 =
V_4 -> V_116 [ 0 ] ;
if ( ! V_4 -> V_127 )
V_223 -> V_231 [ V_237 ] . V_238 =
V_4 -> V_115 ;
}
V_3 -> V_225 ++ ;
V_223 ++ ;
...
if ( V_4 -> V_155 ) {
snprintf ( V_4 -> V_246 , sizeof( V_4 -> V_246 ) ,
L_12 , V_3 -> V_228 ) ;
V_223 -> V_40 = V_4 -> V_246 ;
V_223 -> V_231 [ V_232 ] = V_247 ;
V_223 -> V_231 [ V_232 ] . V_62 =
V_4 -> V_155 ;
V_3 -> V_225 ++ ;
V_223 ++ ;
...
static void F_120 ( struct V_2 * V_3 , int V_250 ,
T_3 * V_251 , bool V_179 )
{
int V_53 ;
for ( V_53 = 0 ; V_53 < V_250 ; V_53 ++ ) {
unsigned int V_129 = F_51 ( V_3 , V_251 [ V_53 ] , 0 ,
V_187 , 0 ) ;
if ( V_129 & V_186 )
continue;
if ( V_179 )
...
if ( V_4 -> V_119 )
V_254 = V_4 -> V_27 . V_93 + V_4 -> V_94 ;
else
V_254 = V_4 -> V_27 . V_93 ;
F_120 ( V_3 , V_254 , V_4 -> V_27 . V_252 , V_138 ) ;
F_121 ( V_3 , V_138 ) ;
}
...
V_259 , 0 ) & 0x03 ;
V_256 = ( F_51 ( V_3 , V_3 -> V_196 , 0 ,
0xF84 , 0 ) & 0x3F0000 ) >> 16 ;
V_257 = V_256 & 0x1F ;
V_258 = F_51 ( V_3 , 0x1A , 0 ,
V_260 ,
V_261 ) ;
if ( V_255 == 0x02 ) {
F_7 ( V_3 , V_4 -> V_27 . V_252 [ 0 ] , 0 ,
V_87 ,
V_98 ) ;
if ( V_256 & 0x20 ) {
if ( V_257 > V_258 )
...
static int F_126 ( struct V_2 * V_3 , T_4 V_268 )
{
struct V_1 * V_4 = V_3 -> V_4 ;
F_6 ( V_4 ) ;
return 0 ;
...
{
struct V_1 * V_4 = V_3 -> V_4 ;
return F_128 ( V_3 , & V_4 -> V_269 , V_62 ) ;
}
...
V_254 = F_47 ( V_3 , V_62 , V_111 , F_48 ( V_111 ) ) ;
for ( V_53 = 0 ; V_53 < V_254 ; V_53 ++ ) {
if ( F_49 ( F_30 ( V_3 , V_111 [ V_53 ] ) ) != V_272 )
continue;
if ( V_111 [ V_53 ] == V_270 || F_129 ( V_3 , V_111 [ V_53 ] ) ) {
if ( ! ( V_4 -> V_79 && V_271 == 1 ) )
goto V_273;
}
}
...
if ( V_254 > 1 && F_49 ( F_30 ( V_3 , V_62 ) ) != V_275 )
...
struct V_68 * V_69 )
{
if ( F_130 ( V_3 , V_62 , V_270 , V_271 , V_69 , 1 ) ) {
...
int V_53 , V_276 ;
T_3 V_62 ;
V_4 -> V_152 . V_159 = V_4 -> V_277 ;
V_276 = 0 ;
for ( V_53 = 0 ; V_53 < V_110 -> V_93 ; V_53 ++ ) {
T_3 V_164 = 0 ;
V_62 = V_110 -> V_252 [ V_53 ] ;
if ( ! V_62 )
continue;
...
V_4 -> V_152 . V_153 = V_276 ;
return 0 ;
}
static int F_134 ( struct V_2 * V_3 , const char * V_278 ,
int V_279 , bool V_280 , struct V_68 * V_69 )
{
struct V_1 * V_4 = V_3 -> V_4 ;
char V_40 [ 32 ] ;
T_3 V_164 , V_85 , V_281 , V_62 ;
int V_58 ;
V_164 = V_280 ? V_69 -> V_69 [ 0 ] : 0 ;
V_85 = V_69 -> V_69 [ V_69 -> V_74 - 1 ] ;
V_281 = V_69 -> V_74 > 1 ? V_69 -> V_69 [ 1 ] : 0 ;
if ( V_164 && F_29 ( V_3 , V_164 , V_82 , V_282 ) )
V_62 = V_164 ;
else if ( F_29 ( V_3 , V_85 , V_82 , V_282 ) )
V_62 = V_85 ;
else if ( F_29 ( V_3 , V_281 , V_82 , V_282 ) )
V_62 = V_281 ;
else
V_62 = 0 ;
if ( V_62 ) {
sprintf ( V_40 , L_1 , V_278 ) ;
V_58 = F_135 ( V_4 , V_59 , V_40 ,
F_28 ( V_62 , V_279 , 0 , V_82 ) ) ;
if ( V_58 < 0 )
return V_58 ;
V_69 -> V_80 = V_62 ;
}
...
V_62 = V_85 ;
else if ( F_29 ( V_3 , V_281 , V_82 , V_90 ) )
V_62 = V_281 ;
else
V_62 = 0 ;
if ( V_62 ) {
sprintf ( V_40 , L_2 , V_278 ) ;
V_58 = F_135 ( V_4 , V_283 , V_40 ,
F_28 ( V_62 , V_279 , 0 , V_82 ) ) ;
if ( V_58 < 0 )
return V_58 ;
V_69 -> V_81 = V_62 ;
...
struct V_284 * V_285 = V_110 -> V_118 ;
int V_53 , V_286 , V_254 , V_287 ;
int V_251 [ V_288 ] ;
for ( V_287 = V_289 ; V_287 >= V_290 ; V_287 -- ) {
V_254 = 0 ;
for ( V_53 = 0 ; V_53 < V_110 -> V_117 ; V_53 ++ ) {
unsigned int V_291 ;
if ( V_285 [ V_53 ] . type > V_292 )
continue;
V_291 = F_53 ( V_3 , V_285 [ V_53 ] . V_85 ) ;
if ( F_137 ( V_291 ) != V_287 )
continue;
for ( V_286 = 0 ; V_286 < V_254 ; V_286 ++ )
if ( V_285 [ V_251 [ V_286 ] ] . type < V_285 [ V_53 ] . type ) {
memmove ( V_251 + V_286 + 1 , V_251 + V_286 ,
( V_254 - V_286 ) * sizeof( int ) ) ;
break;
}
V_251 [ V_286 ] = V_53 ;
V_254 ++ ;
}
if ( V_110 -> V_93 + V_254 < 3 )
continue;
for ( V_53 = 0 ; V_53 < V_254 ; V_53 ++ ) {
T_3 V_85 = V_285 [ V_251 [ V_53 ] ] . V_85 ;
V_4 -> V_183 [ V_4 -> V_94 ++ ] = V_85 ;
V_110 -> V_252 [ V_110 -> V_93 ++ ] = V_85 ;
if ( V_110 -> V_93 == 3 )
break;
}
return;
...
for ( V_53 = 0 ; V_53 < V_110 -> V_93 ; V_53 ++ ) {
T_3 V_85 , V_164 ;
V_85 = V_110 -> V_252 [ V_53 ] ;
V_164 = V_4 -> V_152 . V_159 [ V_53 ] ;
if ( ! V_85 || ! V_164 )
continue;
V_69 = V_4 -> V_95 + V_53 ;
if ( V_53 == V_295 ) {
V_58 = F_134 ( V_3 , L_18 , 1 , true , V_69 ) ;
if ( V_58 < 0 )
return V_58 ;
V_58 = F_134 ( V_3 , L_19 , 2 , true , V_69 ) ;
if ( V_58 < 0 )
return V_58 ;
} else {
const char * V_278 = V_293 [ V_53 ] ;
if ( V_110 -> V_296 == V_297 &&
V_110 -> V_93 == 1 )
V_278 = L_20 ;
V_58 = F_134 ( V_3 , V_278 , 3 , true , V_69 ) ;
if ( V_58 < 0 )
return V_58 ;
}
...
for ( V_53 = V_298 ; V_53 >= V_295 ; V_53 -- ) {
...
if ( ! V_4 -> V_102 . V_74 )
F_131 ( V_3 , V_85 ,
V_4 -> V_152 . V_159 [ V_299 ] , 0 ,
& V_4 -> V_102 ) ;
if ( ! F_131 ( V_3 , V_85 , V_4 -> V_152 . V_159 [ V_299 ] ,
...
V_58 = F_134 ( V_3 , L_25 , 3 , V_280 , V_69 ) ;
if ( V_58 < 0 )
return V_58 ;
if ( V_280 )
...
V_58 = F_134 ( V_3 , L_20 , 3 , V_280 , V_69 ) ;
if ( V_58 < 0 )
return V_58 ;
if ( V_280 )
...
static void F_144 ( struct V_2 * V_3 , int V_302 ,
struct V_68 * V_303 , struct V_68 * V_304 )
{
if ( V_302 ) {
F_36 ( V_3 , V_303 , false , false ) ;
F_36 ( V_3 , V_304 , true , false ) ;
} else {
F_36 ( V_3 , V_304 , false , false ) ;
...
T_3 V_62 = V_3 -> V_306 ;
int V_53 ;
for ( V_53 = 0 ; V_53 < V_3 -> V_307 ; V_53 ++ , V_62 ++ ) {
unsigned int V_308 = F_30 ( V_3 , V_62 ) ;
if ( F_49 ( V_308 ) != V_309 )
continue;
if ( V_308 & V_310 )
continue;
...
strcpy ( V_144 -> V_148 . V_149 . V_40 ,
V_4 -> V_118 [ V_144 -> V_148 . V_149 . V_151 ] . V_312 ) ;
return 0 ;
}
...
if ( V_4 -> V_127 ) {
int V_123 = V_4 -> V_118 [ V_168 ] . V_123 ;
V_313 = V_4 -> V_125 [ V_123 ] ;
F_108 ( V_3 , V_168 ) ;
} else {
V_313 = V_4 -> V_125 [ V_43 ] ;
if ( F_87 ( ! V_313 ) )
return - V_204 ;
}
if ( V_313 ) {
F_50 ( V_3 , V_313 , V_141 ) ;
F_7 ( V_3 , V_313 , 0 ,
V_78 ,
...
static void F_153 ( struct V_1 * V_4 , T_3 V_304 , int V_43 )
{
struct V_189 * V_51 ;
...
for ( V_316 = 0 ; V_316 < V_4 -> V_115 ; V_316 ++ ) {
if ( V_4 -> V_125 [ V_316 ] ) {
V_43 = F_140 ( V_3 , V_4 -> V_125 [ V_316 ] ,
V_85 ) ;
if ( V_43 < 0 )
continue;
V_4 -> V_118 [ V_4 -> V_117 ] . V_126 = V_43 ;
} else {
if ( ! F_154 ( V_3 , V_4 -> V_116 [ V_316 ] , V_85 ) )
continue;
}
V_4 -> V_118 [ V_4 -> V_117 ] . V_123 = V_316 ;
if ( ! V_4 -> V_127 &&
V_4 -> V_117 > 0 && V_4 -> V_118 [ 0 ] . V_123 != V_316 ) {
F_157 ( V_317
L_26 ) ;
V_4 -> V_127 = 1 ;
}
...
V_4 -> V_118 [ V_4 -> V_117 ++ ] . V_312 =
F_160 ( V_3 , V_110 , V_53 ) ;
}
if ( V_4 -> V_79 &&
F_156 ( V_3 , V_4 -> V_79 ) )
V_4 -> V_118 [ V_4 -> V_117 ++ ] . V_312 = L_27 ;
return 0 ;
}
...
int V_56 = 0 ;
int V_53 , V_286 , V_58 , V_43 ;
if ( ! V_4 -> V_79 )
return 0 ;
for ( V_53 = 0 ; V_53 < V_110 -> V_117 ; V_53 ++ ) {
T_3 V_85 = V_110 -> V_118 [ V_53 ] . V_85 ;
const char * V_312 = F_160 ( V_3 , V_110 , V_53 ) ;
if ( V_318 && ! strcmp ( V_312 , V_318 ) )
V_56 ++ ;
else
V_56 = 0 ;
V_318 = V_312 ;
...
if ( V_43 >= 0 ) {
V_58 = F_27 ( V_4 , V_312 , V_56 ,
V_43 , V_4 -> V_79 ) ;
if ( V_58 < 0 )
return V_58 ;
F_153 ( V_4 , V_4 -> V_79 , V_43 ) ;
}
for ( V_286 = 0 ; V_286 < V_4 -> V_94 ; V_286 ++ ) {
if ( V_4 -> V_183 [ V_286 ] == V_85 ) {
V_4 -> V_182 [ V_286 ] = V_43 ;
V_4 -> V_175 [ V_286 ] = V_312 ;
break;
}
}
}
...
if ( V_65 == - 1 || ! ( V_65 & V_282 ) )
continue;
V_312 = F_160 ( V_3 , V_110 , V_53 ) ;
snprintf ( V_40 , sizeof( V_40 ) , L_28 , V_312 ) ;
V_58 = F_135 ( V_4 , V_59 , V_40 ,
F_28 ( V_85 , 3 , 0 , V_60 ) ) ;
if ( V_58 < 0 )
return V_58 ;
...
static int F_164 ( struct V_1 * V_4 , struct V_319 * * V_320 ,
struct V_321 * V_322 )
{
struct V_319 * V_113 ;
int V_53 ;
...
if ( V_58 < 0 )
return V_58 ;
V_58 = F_164 ( V_4 , & V_4 -> V_249 , & V_325 ) ;
if ( V_58 < 0 )
return V_58 ;
V_41 = F_70 ( V_4 , & V_326 ) ;
if ( ! V_41 )
...
unsigned char V_328 ;
V_133 = F_53 ( V_3 , V_62 ) ;
V_328 = ( unsigned char ) F_168 ( V_133 ) ;
V_328 = ( V_328 << 4 ) | F_169 ( V_133 ) ;
if ( F_55 ( V_133 ) == V_140
&& ( V_328 == 0xf0 || V_328 == 0xff ) ) {
V_133 = V_133 & ( ~ ( V_329 << 30 ) ) ;
...
struct V_1 * V_4 = V_3 -> V_4 ;
if ( V_4 -> V_152 . V_216 )
F_38 ( V_3 , V_4 -> V_27 . V_331 [ 0 ] , V_98 ) ;
if ( V_4 -> V_330 [ 0 ] )
F_38 ( V_3 , V_4 -> V_27 . V_331 [ 1 ] , V_98 ) ;
}
...
for ( V_53 = 0 ; V_53 < V_110 -> V_93 ; V_53 ++ ) {
if ( V_110 -> V_252 [ V_53 ] &&
F_181 ( V_3 , V_110 -> V_252 [ V_53 ] ) )
F_182 ( V_3 , V_110 -> V_252 [ V_53 ] ,
V_333 | V_264 ) ;
}
for ( V_53 = 0 ; V_53 < V_110 -> V_117 ; V_53 ++ ) {
...
struct V_1 * V_4 = V_3 -> V_4 ;
int V_53 ;
for ( V_53 = 0 ; V_53 < V_4 -> V_334 ; V_53 ++ )
F_184 ( V_3 , V_4 -> V_335 [ V_53 ] ) ;
F_13 ( V_3 ) ;
F_81 ( V_3 , true ) ;
F_41 ( V_3 ) ;
F_43 ( V_3 ) ;
...
static void F_185 ( struct V_336 * V_337 )
{
struct V_1 * V_4 = F_186 ( V_337 , struct V_1 ,
V_30 . V_337 ) ;
if ( V_4 -> V_7 != V_15 )
return;
F_187 ( V_4 -> V_3 ) ;
...
if ( V_348 )
F_52 ( V_3 , 0x23 , & V_129 ) ;
F_50 ( V_3 , 0x16 , V_347 ? V_141 : V_129 ) ;
F_50 ( V_3 , 0x10 , V_129 ) ;
if ( V_348 ) {
F_50 ( V_3 , 0x25 , V_129 ) ;
F_50 ( V_3 , 0x27 , V_129 ) ;
...
struct V_1 * V_4 = V_3 -> V_4 ;
int V_53 ;
for ( V_53 = 0 ; V_53 < V_4 -> V_27 . V_350 ; V_53 ++ ) {
T_3 V_62 ;
int V_111 ;
V_62 = V_4 -> V_27 . V_331 [ V_53 ] ;
if ( ! V_62 )
continue;
...
return;
V_351 = V_3 -> V_306 ;
for ( V_53 = 0 ; V_53 < V_3 -> V_307 ; V_53 ++ , V_351 ++ ) {
unsigned int V_308 = F_30 ( V_3 , V_351 ) ;
if ( F_49 ( V_308 ) != V_309 )
continue;
if ( ! ( V_308 & V_310 ) )
continue;
...
if ( F_4 ( V_3 ) == V_8 ) {
F_25 ( V_3 -> V_228 ) ;
V_3 -> V_228 = F_21 ( L_32 , V_5 ) ;
snprintf ( V_3 -> V_176 -> V_177 -> V_359 ,
sizeof( V_3 -> V_176 -> V_177 -> V_359 ) ,
L_33 , V_3 -> V_360 , V_3 -> V_228 ) ;
}
if ( V_3 -> V_11 == 0x11064397 ) {
F_25 ( V_3 -> V_228 ) ;
V_3 -> V_228 = F_21 ( L_34 , V_5 ) ;
snprintf ( V_3 -> V_176 -> V_177 -> V_359 ,
sizeof( V_3 -> V_176 -> V_177 -> V_359 ) ,
L_33 , V_3 -> V_360 , V_3 -> V_228 ) ;
}
...
F_52 ( V_3 , 0x17 , & V_129 ) ;
F_52 ( V_3 , 0x16 , & V_129 ) ;
F_50 ( V_3 , 0x1a , V_347 ? V_141 : V_129 ) ;
F_50 ( V_3 , 0x10 , V_129 ) ;
F_50 ( V_3 , 0x1d , V_129 ) ;
}
...
F_52 ( V_3 , 0x28 , & V_129 ) ;
F_50 ( V_3 , 0x8 , V_129 ) ;
F_50 ( V_3 , 0x21 , V_347 ? V_141 : V_129 ) ;
V_129 = V_142 ;
F_52 ( V_3 , 0x25 , & V_129 ) ;
if ( V_4 -> V_119 )
F_52 ( V_3 , 0x2a , & V_129 ) ;
...
V_144 -> type = V_363 ;
V_144 -> V_147 = 1 ;
V_144 -> V_148 . integer . V_364 = 0 ;
V_144 -> V_148 . integer . V_365 = 1 ;
return 0 ;
}
...
F_50 ( V_3 , 0x25 , V_129 ) ;
F_50 ( V_3 , 0x16 , V_347 ? V_141 : V_129 ) ;
F_50 ( V_3 , 0x10 , V_367 ? V_141 : V_129 ) ;
}
