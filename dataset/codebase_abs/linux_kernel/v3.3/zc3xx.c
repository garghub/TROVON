...
if ( V_55 >= 0 )
F_6 ( V_171 , L_17 , V_55 ) ;
if ( ( unsigned ) V_188 < V_35 ) {
V_24 -> V_55 = V_188 ;
F_6 ( V_171 , L_18 , V_188 ) ;
} else {
switch ( V_55 ) {
case - 1 :
switch ( V_24 -> V_55 ) {
...
V_164 = & V_1 -> V_164 ;
switch ( V_187 [ V_24 -> V_55 ] ) {
case 0 :
V_164 -> V_165 = V_191 ;
V_164 -> V_192 = F_15 ( V_191 ) ;
break;
case 1 :
V_164 -> V_165 = V_193 ;
V_164 -> V_192 = F_15 ( V_193 ) ;
break;
default:
V_164 -> V_165 = V_194 ;
V_164 -> V_192 = F_15 ( V_194 ) ;
break;
}
V_24 -> V_58 [ GAMMA ] . V_189 = gamma [ V_24 -> V_55 ] ;
switch ( V_24 -> V_55 ) {
case V_43 :
break;
case V_49 :
V_1 -> V_195 = ( 1 << V_163 ) | ( 1 << V_73 ) ;
break;
default:
V_1 -> V_195 = ( 1 << V_73 ) ;
break;
...
struct V_24 * V_24 = (struct V_24 * ) V_1 ;
int V_76 ;
static const struct V_19 * V_198 [ V_35 ] [ 2 ] = {
[ V_36 ] =
{ V_199 , V_200 } ,
[ V_37 ] =
{ V_201 , V_202 } ,
...
F_34 ( V_24 -> V_237 , V_1 -> V_238 , V_1 -> V_239 ,
0x21 ) ;
F_35 ( V_24 -> V_237 , V_24 -> V_185 ) ;
V_76 = V_1 -> V_164 . V_165 [ V_1 -> V_166 ] . V_167 ;
switch ( V_24 -> V_55 ) {
case V_43 :
F_29 ( V_1 ) ;
...
struct V_24 * V_24 = (struct V_24 * ) V_1 ;
if ( V_246 >= 3
&& V_245 [ V_246 - 3 ] == 0xff && V_245 [ V_246 - 2 ] == 0xd9 ) {
F_38 ( V_1 , V_247 ,
V_245 , V_246 - 1 ) ;
return;
}
if ( V_245 [ 0 ] == 0xff && V_245 [ 1 ] == 0xd8 ) {
F_38 ( V_1 , V_248 ,
V_24 -> V_237 , V_249 ) ;
V_245 += 18 ;
V_246 -= 18 ;
}
F_38 ( V_1 , V_250 , V_245 , V_246 ) ;
}
...
switch ( V_253 -> V_2 ) {
case 0 :
strcpy ( ( char * ) V_253 -> V_255 , L_42 ) ;
return 0 ;
case 1 :
strcpy ( ( char * ) V_253 -> V_255 , L_43 ) ;
return 0 ;
case 2 :
strcpy ( ( char * ) V_253 -> V_255 , L_44 ) ;
return 0 ;
}
break;
}
...
{
struct V_24 * V_24 = (struct V_24 * ) V_1 ;
if ( V_257 -> V_185 < V_258 )
V_24 -> V_185 = V_258 ;
else if ( V_257 -> V_185 > V_259 )
V_24 -> V_185 = V_259 ;
else
V_24 -> V_185 = V_257 -> V_185 ;
if ( V_1 -> V_251 )
F_35 ( V_24 -> V_237 , V_24 -> V_185 ) ;
return V_1 -> V_4 ;
}
...
int V_246 )
{
if ( V_246 == 8 && V_245 [ 4 ] == 1 ) {
F_44 ( V_1 -> V_263 , V_264 , 1 ) ;
F_45 ( V_1 -> V_263 ) ;
F_44 ( V_1 -> V_263 , V_264 , 0 ) ;
F_45 ( V_1 -> V_263 ) ;
}
return 0 ;
}
static int F_46 ( struct V_265 * V_266 ,
const struct V_178 * V_179 )
{
return F_47 ( V_266 , V_179 , & V_267 , sizeof( struct V_24 ) ,
V_268 ) ;
}
