...
unsigned long V_46 , T_2 V_47 ,
struct V_48 * V_49 )
{
struct V_9 * V_10 = F_24 ( V_45 ) ;
...
return NULL ;
V_4 -> V_5 = V_5 ;
V_4 -> V_2 . V_2 . V_51 = V_10 -> V_14 . V_51 ;
if ( F_26 ( & V_4 -> V_2 , V_45 , V_46 , V_47 , V_49 ) ) {
F_4 ( V_4 ) ;
return NULL ;
}
return & V_4 -> V_2 . V_2 ;
...
T_3 V_52 , V_53 ;
int V_54 ;
if ( V_10 -> V_55 >= V_56 && F_28 ( V_5 -> V_57 ) )
V_52 = 512 * 1024 * 1024 ;
else
V_52 = 64 * 1024 * 1024 ;
V_10 -> V_14 . V_35 . V_48 = F_29 ( V_58 | V_50 ) ;
if ( ! V_10 -> V_14 . V_35 . V_48 )
return - V_59 ;
V_10 -> V_14 . V_35 . V_36 =
F_30 ( V_5 -> V_57 , V_10 -> V_14 . V_35 . V_48 ,
0 , V_27 , V_60 ) ;
if ( F_31 ( V_5 -> V_57 , V_10 -> V_14 . V_35 . V_36 ) ) {
F_12 ( V_5 , L_5 ) ;
F_32 ( V_10 -> V_14 . V_35 . V_48 ) ;
V_10 -> V_14 . V_35 . V_48 = NULL ;
return - V_59 ;
}
if ( V_10 -> V_55 >= V_61 ) {
V_10 -> V_14 . V_62 = 0 ;
...
V_54 = F_34 ( V_5 , NULL , V_52 / 1024 , V_53 ,
V_68 |
V_69 , & V_13 ) ;
if ( V_54 ) {
F_12 ( V_5 , L_6 , V_54 ) ;
...
V_54 = F_34 ( V_5 , NULL , ( V_52 / 1024 ) + 8 , 16 ,
V_68 |
V_69 , & V_13 ) ;
if ( V_54 ) {
F_12 ( V_5 , L_6 , V_54 ) ;
...
if ( V_10 -> V_14 . V_35 . V_48 ) {
F_37 ( V_5 -> V_57 , V_10 -> V_14 . V_35 . V_36 ,
V_27 , V_60 ) ;
F_32 ( V_10 -> V_14 . V_35 . V_48 ) ;
V_10 -> V_14 . V_35 . V_48 = NULL ;
}
