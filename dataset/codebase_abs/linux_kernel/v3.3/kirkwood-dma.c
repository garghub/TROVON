...
V_82 -> V_59 = F_34 ( V_79 -> V_86 -> V_84 , V_32 ,
& V_82 -> V_47 , V_53 ) ;
if ( ! V_82 -> V_59 )
return - V_54 ;
V_82 -> V_87 = V_32 ;
...
static int F_35 ( struct V_40 * V_88 )
{
...
if ( V_79 -> V_80 [ V_61 ] . V_36 ) {
V_90 = F_33 ( V_79 ,
V_61 ) ;
if ( V_90 )
return V_90 ;
}
if ( V_79 -> V_80 [ V_94 ] . V_36 ) {
V_90 = F_33 ( V_79 ,
V_94 ) ;
if ( V_90 )
return V_90 ;
