...
V_55 . V_85 = 0 ;
V_55 . V_57 = V_79 -> V_86 ;
V_55 . V_59 = F_52 ( V_66 ) -> V_87 ;
V_55 . V_61 = F_52 ( V_66 ) -> V_88 ;
F_53 ( V_66 , F_33 ( & V_55 ) ) ;
V_24 = V_16 -> V_24 ;
V_81 = F_54 ( & V_55 , V_24 , & V_82 ) ;
V_49 = F_34 ( V_2 , & V_55 , V_81 , false ) ;
if ( F_35 ( V_49 ) ) {
V_33 = F_36 ( V_49 ) ;
V_49 = NULL ;
goto V_89;
...
& V_79 -> V_83 ) ;
V_55 . V_11 = V_79 -> V_83 ;
V_33 = F_56 ( V_2 , V_8 , & V_55 , V_24 , V_16 -> V_90 ) ;
V_33 = F_57 ( V_33 ) ;
}
V_89:
if ( V_24 != NULL && V_24 != V_16 -> V_24 )
F_58 ( V_2 , V_24 , V_24 -> V_91 ) ;
F_40 ( V_49 ) ;
return V_33 ;
}
...
{
F_60 ( & F_44 ( V_66 ) -> V_92 ) ;
if ( F_51 ( V_66 ) -> V_93 != NULL )
F_61 ( F_51 ( V_66 ) -> V_93 ) ;
}
static void F_62 ( struct V_1 * V_2 , struct V_7 * V_94 )
{
const struct V_28 * V_95 ;
struct V_7 * V_8 ;
struct V_54 V_55 ;
struct V_35 * V_35 = F_16 ( F_63 ( V_94 ) -> V_36 ) ;
...
F_66 ( V_94 , F_33 ( & V_55 ) ) ;
V_49 = F_34 ( V_96 , & V_55 , NULL , false ) ;
if ( ! F_35 ( V_49 ) ) {
F_67 ( V_8 , V_49 ) ;
F_56 ( V_96 , V_8 , & V_55 , NULL , 0 ) ;
F_46 ( V_101 ) ;
F_46 ( V_102 ) ;
return;
}
...
V_104 = F_70 ( F_71 ( V_2 ) , & V_38 ,
& V_103 -> V_10 , V_18 -> V_22 ,
& V_103 -> V_11 , F_72 ( V_18 -> V_21 ) ,
F_21 ( V_8 ) ) ;
if ( V_104 != NULL ) {
if ( V_104 -> V_3 != V_39 ) {
F_24 ( V_104 ) ;
...
struct V_78 * V_79 ;
struct V_15 * V_16 = F_10 ( V_2 ) ;
const T_4 V_107 = F_74 ( V_8 ) -> V_108 ;
struct V_109 * V_110 = F_75 ( V_8 ) ;
if ( V_8 -> V_111 == F_76 ( V_112 ) )
return F_77 ( V_2 , V_8 ) ;
if ( ! F_64 ( V_8 ) )
return 0 ;
if ( F_78 ( V_2 , V_107 ) ) {
...
goto V_118;
V_106 = F_44 ( V_66 ) ;
if ( F_84 ( V_2 , V_106 , V_8 ) )
goto V_118;
if ( F_85 ( V_2 , V_8 , V_66 ) )
goto V_118;
V_79 = F_51 ( V_66 ) ;
V_79 -> V_83 = F_14 ( V_8 ) -> V_10 ;
V_79 -> V_84 = F_14 ( V_8 ) -> V_11 ;
if ( F_86 ( V_2 , V_8 ) ||
...
F_93 ( V_132 -> V_138 , & V_131 -> V_11 ) ;
F_93 ( V_132 -> V_139 , & V_131 -> V_10 ) ;
V_131 -> V_140 = V_131 -> V_10 ;
F_2 ( V_135 ) -> V_5 = & V_6 ;
V_135 -> V_141 = V_142 ;
V_131 -> V_143 = NULL ;
V_131 -> V_24 = NULL ;
...
V_131 = F_10 ( V_135 ) ;
memcpy ( V_131 , V_16 , sizeof( struct V_15 ) ) ;
V_131 -> V_11 = V_79 -> V_83 ;
V_131 -> V_10 = V_79 -> V_84 ;
V_131 -> V_140 = V_79 -> V_84 ;
V_135 -> V_58 = V_79 -> V_86 ;
V_132 -> V_153 = NULL ;
V_131 -> V_119 . V_154 = V_16 -> V_119 . V_154 ;
V_131 -> V_143 = NULL ;
if ( V_79 -> V_93 != NULL ) {
V_131 -> V_143 = F_96 ( V_79 -> V_93 , V_155 ) ;
F_61 ( V_79 -> V_93 ) ;
V_79 -> V_93 = NULL ;
if ( V_131 -> V_143 )
F_97 ( V_131 -> V_143 , V_135 ) ;
}
V_131 -> V_24 = NULL ;
V_131 -> V_144 = F_21 ( V_8 ) ;
V_131 -> V_145 = F_14 ( V_8 ) -> V_146 ;
if ( V_24 != NULL ) {
V_131 -> V_24 = F_98 ( V_135 , V_24 ) ;
if ( V_24 != V_16 -> V_24 )
F_58 ( V_2 , V_24 , V_24 -> V_91 ) ;
}
F_2 ( V_135 ) -> V_156 = 0 ;
...
static int F_100 ( struct V_1 * V_2 , struct V_7 * V_8 )
{
struct V_15 * V_16 = F_10 ( V_2 ) ;
...
if ( V_2 -> V_3 == V_165 ) {
if ( F_102 ( V_2 , V_8 , V_17 ( V_8 ) , V_8 -> V_12 ) )
goto V_166;
if ( V_163 ) {
F_103 ( V_163 ) ;
}
...
if ( V_2 -> V_3 == V_68 ) {
struct V_1 * V_104 = F_68 ( V_2 , V_8 ) ;
if ( V_104 == NULL )
goto V_164;
if ( V_104 != V_2 ) {
if ( F_104 ( V_2 , V_104 , V_8 ) )
goto V_166;
if ( V_163 != NULL )
F_103 ( V_163 ) ;
return 0 ;
...
V_18 = V_17 ( V_8 ) ;
F_75 ( V_8 ) -> V_128 = F_28 ( V_18 ) ;
F_75 ( V_8 ) -> V_169 = V_18 -> V_99 ;
if ( F_109 ( V_8 ) )
F_75 ( V_8 ) -> V_170 = V_171 ;
else
F_75 ( V_8 ) -> V_170 = F_110 ( V_8 ) ;
V_2 = F_111 ( & V_38 , V_8 ,
V_18 -> V_22 , V_18 -> V_21 ) ;
if ( V_2 == NULL ) {
F_112 ( L_2
...
if ( ! F_113 ( V_2 , V_176 , V_8 ) )
goto V_175;
return F_114 ( V_2 , V_8 , 1 ) ? - 1 : 0 ;
V_172:
if ( ! F_113 ( NULL , V_176 , V_8 ) )
goto V_168;
if ( V_18 -> V_99 != V_100 ) {
F_75 ( V_8 ) -> V_113 =
V_177 ;
...
static int F_115 ( struct V_1 * V_2 , struct V_178 * V_179 ,
int V_180 )
{
...
if ( V_55 . V_85 & V_196 ) {
struct V_197 * V_85 ;
V_85 = F_117 ( V_2 , V_55 . V_85 ) ;
if ( V_85 == NULL )
return - V_189 ;
V_182 -> V_198 = V_85 -> V_49 ;
F_118 ( V_85 ) ;
}
}
if ( F_119 ( & V_182 -> V_198 ) )
V_182 -> V_198 . V_199 [ 15 ] = 1 ;
V_185 = F_88 ( & V_182 -> V_198 ) ;
if ( V_185 & V_200 )
return - V_201 ;
if ( V_185 & V_126 ) {
...
V_184 -> V_5 = & V_6 ;
V_2 -> V_141 = V_142 ;
V_33 = F_122 ( V_2 , (struct V_178 * ) & sin , sizeof( sin ) ) ;
if ( V_33 ) {
V_184 -> V_156 = V_205 ;
V_184 -> V_5 = & V_213 ;
V_2 -> V_141 = F_100 ;
...
F_93 ( V_53 -> V_139 , & V_16 -> V_10 ) ;
F_93 ( V_53 -> V_160 , & V_16 -> V_140 ) ;
return V_33 ;
}
if ( ! F_119 ( & V_16 -> V_140 ) )
V_10 = & V_16 -> V_140 ;
...
V_55 . V_61 = V_53 -> V_62 ;
F_32 ( V_2 , F_33 ( & V_55 ) ) ;
V_81 = F_54 ( & V_55 , V_16 -> V_24 , & V_82 ) ;
V_49 = F_34 ( V_2 , & V_55 , V_81 , true ) ;
if ( F_35 ( V_49 ) ) {
V_33 = F_36 ( V_49 ) ;
goto V_214;
}
...
static int T_7 F_133 ( struct V_35 * V_35 )
{
if ( V_38 . V_219 == NULL )
return - V_220 ;
return F_134 ( & V_35 -> V_97 . V_98 , V_221 ,
V_222 , V_13 , V_35 ) ;
}
static void T_8 F_135 ( struct V_35 * V_35 )
{
F_136 ( V_35 -> V_97 . V_98 ) ;
}
static int T_9 F_137 ( void )
{
int V_33 = F_138 ( & V_223 , 1 ) ;
if ( V_33 != 0 )
goto V_41;
V_33 = F_139 ( & V_224 , V_13 ) ;
if ( V_33 != 0 )
goto V_225;
F_140 ( & V_226 ) ;
V_33 = F_141 ( & V_227 ) ;
