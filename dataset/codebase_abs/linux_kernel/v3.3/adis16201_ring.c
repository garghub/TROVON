...
int V_12 = 0 ;
T_3 * V_31 ;
T_4 V_32 = V_29 -> V_33 -> V_34 ( V_29 ) ;
V_31 = F_11 ( V_32 , V_35 ) ;
if ( V_31 == NULL ) {
F_8 ( & V_7 -> V_22 -> V_23 , L_2 ) ;
return - V_36 ;
}
if ( ! F_12 ( V_2 -> V_37 , V_2 -> V_38 )
&& F_1 ( V_2 , V_7 -> V_3 ) >= 0 )
for (; V_12 < F_13 ( V_2 -> V_37 ,
V_2 -> V_38 ) ; V_12 ++ )
V_31 [ V_12 ] = F_14 ( ( V_39 * ) & ( V_7 -> V_3 [ V_12 * 2 ] ) ) ;
if ( V_29 -> V_40 )
* ( ( V_41 * ) ( V_31 + ( ( V_12 + 3 ) / 4 ) * 4 ) ) = V_27 -> V_42 ;
V_29 -> V_33 -> V_43 ( V_29 , ( T_1 * ) V_31 , V_27 -> V_42 ) ;
F_15 ( V_2 -> V_44 ) ;
F_16 ( V_31 ) ;
return V_45 ;
}
