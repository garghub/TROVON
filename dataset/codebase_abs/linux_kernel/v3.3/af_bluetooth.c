...
F_47 ( V_95 , & V_2 -> V_66 -> V_45 ) ;
return V_83 ;
}
int F_68 ( struct V_18 * V_1 , unsigned int V_96 , unsigned long V_97 )
{
struct V_1 * V_2 = V_1 -> V_2 ;
struct V_48 * V_49 ;
long V_98 ;
...
if ( V_2 -> V_31 == V_84 )
return - V_12 ;
V_98 = V_2 -> V_100 - F_69 ( V_2 ) ;
if ( V_98 < 0 )
V_98 = 0 ;
V_10 = F_70 ( V_98 , ( int V_101 * ) V_97 ) ;
break;
case V_102 :
if ( V_2 -> V_31 == V_84 )
return - V_12 ;
...
break;
case V_103 :
V_10 = F_72 ( V_2 , (struct V_104 V_101 * ) V_97 ) ;
break;
case V_105 :
V_10 = F_73 ( V_2 , (struct V_106 V_101 * ) V_97 ) ;
break;
default:
V_10 = - V_107 ;
break;
...
int F_74 ( struct V_1 * V_2 , int V_108 , unsigned long V_59 )
{
F_41 ( V_60 , V_61 ) ;
int V_10 = 0 ;
F_21 ( L_9 , V_2 ) ;
