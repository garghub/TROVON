...
struct V_1 * V_2 = V_20 -> V_21 ;
int V_6 ;
F_3 ( L_7 , V_28 , V_69 -> V_85 ) ;
V_20 -> V_70 . V_86 = V_63 ;
V_6 = F_7 ( V_2 , V_69 -> V_85 ) ;
if ( V_6 ) {
F_3 ( L_4 , V_28 , V_6 ) ;
return - V_17 ;
}
...
struct V_19 * F_19 ( struct V_89 * V_90 )
{
struct V_1 * V_2 = NULL ;
F_20 ( L_8 , V_28 ) ;
V_2 = F_21 ( sizeof( struct V_1 ) , V_91 ) ;
if ( V_2 == NULL )
goto error;
V_2 -> V_16 = & V_90 -> V_92 ;
memcpy ( & V_2 -> V_11 , & V_93 , sizeof( V_93 ) ) ;
memcpy ( & V_2 -> V_37 . V_38 , & V_94 ,
sizeof( V_94 ) ) ;
V_2 -> V_37 . V_21 = V_2 ;
if ( F_16 ( & V_2 -> V_37 ) < 0 )
goto error;
