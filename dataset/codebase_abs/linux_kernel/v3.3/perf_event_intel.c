...
static T_2 void F_92 ( void )
{
F_35 ( V_126 L_3 ) ;
V_9 . V_127 = 0 ;
V_9 . V_128 = NULL ;
}
static T_2 void F_93 ( void )
{
F_35 ( V_126 L_3 ) ;
V_9 . V_127 = 0 ;
V_9 . V_128 = NULL ;
}
static T_2 void F_94 ( void )
{
int V_57 ;
F_49 (bit, x86_pmu.events_mask, ARRAY_SIZE(intel_arch_events_map)) {
V_2 [ V_129 [ V_57 ] . V_130 ] = 0 ;
F_35 ( V_126 L_4 ,
V_129 [ V_57 ] . V_131 ) ;
}
}
static T_2 void F_95 ( void )
{
union V_132 V_133 ;
V_133 . V_134 = V_9 . V_135 ;
if ( V_133 . V_136 . V_137 ) {
V_2 [ V_138 ] = 0x7f89 ;
V_133 . V_136 . V_137 = 0 ;
V_9 . V_135 = V_133 . V_134 ;
F_35 ( V_139 L_5 ) ;
}
}
T_2 int F_96 ( void )
...
F_100 ( 10 , & V_143 . V_134 , & V_133 . V_134 , & V_144 , & V_141 . V_134 ) ;
if ( V_143 . V_136 . V_149 < V_150 )
return - V_148 ;
V_40 = V_143 . V_136 . V_151 ;
if ( V_40 < 2 )
V_9 = V_152 ;
else
V_9 = V_153 ;
V_9 . V_40 = V_40 ;
V_9 . V_48 = V_143 . V_136 . V_48 ;
V_9 . V_154 = V_143 . V_136 . V_155 ;
V_9 . V_156 = ( 1ULL << V_143 . V_136 . V_155 ) - 1 ;
V_9 . V_135 = V_133 . V_134 ;
V_9 . V_157 = V_143 . V_136 . V_149 ;
if ( V_40 > 1 )
V_9 . V_49 = F_101 ( ( int ) V_141 . V_136 . V_49 , 3 ) ;
if ( V_40 > 1 ) {
T_1 V_158 ;
F_20 ( V_159 , V_158 ) ;
V_9 . V_160 . V_158 = V_158 ;
}
F_102 () ;
F_103 ( F_94 ) ;
switch ( V_145 . V_161 ) {
