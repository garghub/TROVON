...
F_143 ( V_40 , V_5 -> V_17 ) ;
F_139 ( V_5 ) ;
F_144 ( V_5 -> V_16 , V_5 -> V_151 ) ;
F_145 ( V_5 -> V_16 , V_5 -> V_17 ) ;
F_146 ( V_5 , V_157 , V_158 , true ,
true ) ;
return 0 ;
V_66:
V_5 -> type -> remove ( V_5 ) ;
...
static unsigned int F_163 ( unsigned int V_170 , unsigned int V_171 )
{
if ( V_170 == 0 )
return 0 ;
if ( V_170 < V_171 )
...
int F_146 ( struct V_4 * V_5 , unsigned int V_172 ,
unsigned int V_173 , bool V_174 ,
bool V_175 )
{
struct V_1 * V_2 ;
unsigned V_176 = F_163 ( V_172 , V_177 ) ;
unsigned V_178 = F_163 ( V_173 , V_177 ) ;
F_61 ( V_5 ) ;
...
void F_166 ( struct V_4 * V_5 , unsigned int * V_172 ,
unsigned int * V_173 , bool * V_174 )
{
* V_174 = V_5 -> V_18 ;
...
static void F_167 ( struct V_107 * V_108 )
{
...
static int F_169 ( struct V_182 * V_16 , struct V_183 * V_184 , int V_185 )
{
struct V_4 * V_5 = F_170 ( V_16 ) ;
struct V_186 * V_108 = F_171 ( V_184 ) ;
F_61 ( V_5 ) ;
if ( ( V_185 == V_187 || V_185 == V_188 ) &&
( V_108 -> V_189 & 0xfc00 ) == 0x0400 )
V_108 -> V_189 ^= V_190 | 0x0400 ;
return F_172 ( & V_5 -> V_191 , V_108 , V_185 ) ;
}
...
static void F_176 ( struct V_182 * V_16 )
{
struct V_4 * V_5 = F_170 ( V_16 ) ;
struct V_1 * V_2 ;
F_48 (channel, efx)
...
static int F_178 ( struct V_182 * V_16 )
{
struct V_4 * V_5 = F_170 ( V_16 ) ;
F_61 ( V_5 ) ;
...
if ( V_5 -> V_103 & V_115 )
return - V_194 ;
if ( F_179 ( V_5 ) && F_180 ( V_5 , V_78 ) )
return - V_132 ;
F_78 ( V_5 ) ;
F_74 ( V_5 ) ;
return 0 ;
}
static int F_181 ( struct V_182 * V_16 )
{
struct V_4 * V_5 = F_170 ( V_16 ) ;
...
static struct V_195 * F_182 ( struct V_182 * V_16 , struct V_195 * V_196 )
{
struct V_4 * V_5 = F_170 ( V_16 ) ;
...
static void F_185 ( struct V_182 * V_16 )
{
struct V_4 * V_5 = F_170 ( V_16 ) ;
...
static int F_186 ( struct V_182 * V_16 , int V_230 )
{
struct V_4 * V_5 = F_170 ( V_16 ) ;
int V_57 = 0 ;
F_61 ( V_5 ) ;
...
static int F_187 ( struct V_182 * V_16 , void * V_108 )
{
struct V_4 * V_5 = F_170 ( V_16 ) ;
...
static void F_188 ( struct V_182 * V_16 )
{
struct V_4 * V_5 = F_170 ( V_16 ) ;
struct V_237 * V_238 ;
...
F_189 (ha, net_dev) {
V_242 = F_190 ( V_118 , V_238 -> V_233 ) ;
V_243 = V_242 & ( V_247 - 1 ) ;
F_191 ( V_243 , V_240 -> V_248 ) ;
}
F_191 ( 0xff , V_240 -> V_248 ) ;
}
if ( V_5 -> V_77 )
F_192 ( V_5 -> V_164 , & V_5 -> V_109 ) ;
}
static int F_193 ( struct V_182 * V_16 , T_6 V_108 )
{
struct V_4 * V_5 = F_170 ( V_16 ) ;
...
static T_7
F_198 ( struct V_260 * V_261 , struct V_262 * V_263 , char * V_264 )
{
struct V_4 * V_5 = F_199 ( F_200 ( V_261 ) ) ;
...
F_82 ( V_5 -> V_16 ) ;
F_207 () ;
V_57 = F_208 ( & V_5 -> V_127 -> V_261 , & V_270 ) ;
if ( V_57 ) {
F_50 ( V_5 , V_38 , V_5 -> V_16 ,
L_63 ) ;
goto V_271;
...
if ( ! V_5 -> V_16 )
return;
F_18 ( F_170 ( V_5 -> V_16 ) != V_5 ) ;
F_48 (channel, efx) {
F_41 (tx_queue, channel)
F_211 ( V_45 ) ;
}
if ( F_88 ( V_5 ) ) {
F_212 ( V_5 -> V_64 , F_213 ( V_5 -> V_127 ) , sizeof( V_5 -> V_64 ) ) ;
F_214 ( & V_5 -> V_127 -> V_261 , & V_270 ) ;
F_209 ( V_5 -> V_16 ) ;
}
}
void F_215 ( struct V_4 * V_5 , enum V_272 V_273 )
{
F_61 ( V_5 ) ;
F_70 ( V_5 ) ;
F_93 ( & V_5 -> V_104 ) ;
...
int F_216 ( struct V_4 * V_5 , enum V_272 V_273 , bool V_275 )
{
int V_57 ;
F_61 ( V_5 ) ;
...
int F_180 ( struct V_4 * V_5 , enum V_272 V_273 )
{
int V_57 , V_276 ;
bool V_277 ;
...
static void F_222 ( struct V_107 * V_108 )
{
struct V_4 * V_5 = F_12 ( V_108 , struct V_4 , V_280 ) ;
unsigned long V_281 = F_223 ( V_5 -> V_7 ) ;
if ( ! V_281 )
return;
if ( V_5 -> V_160 != V_161 ) {
...
F_25 ( V_5 , V_38 , V_5 -> V_16 ,
L_73 ,
F_218 ( V_273 ) , F_218 ( type ) ) ;
break;
}
F_225 ( V_273 , & V_5 -> V_7 ) ;
F_153 ( V_5 ) ;
F_192 ( V_284 , & V_5 -> V_280 ) ;
}
int F_226 ( struct V_4 * V_5 )
{
return 0 ;
}
void F_227 ( struct V_4 * V_5 ) {}
static bool F_228 ( struct V_4 * V_5 )
{
return false ;
}
static int F_229 ( struct V_4 * V_5 , const struct V_285 * type ,
...
F_232 ( & V_5 -> V_287 ) ;
#endif
F_233 ( & V_5 -> V_280 , F_222 ) ;
F_234 ( & V_5 -> V_165 , F_167 ) ;
V_5 -> V_127 = V_127 ;
V_5 -> V_288 = V_289 ;
V_5 -> V_160 = V_162 ;
F_212 ( V_5 -> V_64 , F_213 ( V_127 ) , sizeof( V_5 -> V_64 ) ) ;
V_5 -> V_16 = V_16 ;
F_230 ( & V_5 -> V_199 ) ;
F_235 ( & V_5 -> V_104 ) ;
...
static void F_241 ( struct V_127 * V_127 )
{
struct V_4 * V_5 ;
V_5 = F_199 ( V_127 ) ;
if ( ! V_5 )
...
static int T_8 F_247 ( struct V_127 * V_127 ,
...
V_5 = F_170 ( V_16 ) ;
F_243 ( V_127 , V_5 ) ;
F_249 ( V_16 , & V_127 -> V_261 ) ;
V_57 = F_229 ( V_5 , type , V_127 , V_16 ) ;
if ( V_57 )
goto V_58;
F_83 ( V_5 , V_33 , V_5 -> V_16 ,
L_77 ) ;
...
static int F_253 ( struct V_260 * V_261 )
{
struct V_127 * V_127 = F_200 ( V_261 ) ;
struct V_4 * V_5 = F_199 ( V_127 ) ;
V_5 -> type -> V_126 ( V_5 ) ;
V_5 -> V_7 = 0 ;
F_254 ( V_127 ) ;
return F_255 ( V_127 , V_312 ) ;
}
static int F_256 ( struct V_260 * V_261 )
{
struct V_127 * V_127 = F_200 ( V_261 ) ;
struct V_4 * V_5 = F_199 ( V_127 ) ;
int V_57 ;
V_57 = F_255 ( V_127 , V_313 ) ;
if ( V_57 )
return V_57 ;
F_257 ( V_127 ) ;
V_57 = F_105 ( V_127 ) ;
...
static int F_258 ( struct V_260 * V_261 )
{
int V_57 ;
F_251 ( V_261 ) ;
V_57 = F_253 ( V_261 ) ;
