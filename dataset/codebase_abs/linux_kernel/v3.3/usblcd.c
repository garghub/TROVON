...
static T_1 F_17 ( struct V_7 * V_7 , char T_2 * V_18 ,
T_3 V_19 , T_4 * V_20 )
{
struct V_2 * V_3 ;
int V_21 = 0 ;
...
static T_1 F_28 ( struct V_7 * V_7 , const char T_2 * V_45 ,
T_3 V_19 , T_4 * V_20 )
{
struct V_2 * V_3 ;
int V_21 = 0 , V_11 ;
...
( V_62 & 0xF0 ) >> 4 , ( V_62 & 0xF ) , V_3 -> V_4 -> V_70 ) ;
F_53 ( & V_9 -> V_3 , L_12 ,
V_9 -> V_71 ) ;
return 0 ;
error:
...
{
int time ;
time = F_55 ( & V_3 -> V_53 , 1000 ) ;
if ( ! time )
F_56 ( & V_3 -> V_53 ) ;
}
static int F_57 ( struct V_8 * V_72 , T_6 V_73 )
{
struct V_2 * V_3 = F_11 ( V_72 ) ;
if ( ! V_3 )
return 0 ;
F_54 ( V_3 ) ;
return 0 ;
}
static int F_58 ( struct V_8 * V_72 )
{
return 0 ;
}
