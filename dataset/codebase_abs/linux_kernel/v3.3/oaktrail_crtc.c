...
if ( ! V_111 -> V_114 || V_111 -> V_114 -> V_3 != V_3 )
continue;
V_107 = F_21 ( V_111 ) ;
switch ( V_107 -> type ) {
case V_10 :
...
V_123 = ( V_66 -> V_119 -
V_29 -> V_119 ) / 2 ;
F_13 ( V_74 , ( V_29 -> V_118 - 1 ) |
( ( V_66 -> V_124 - 1 ) << 16 ) ) ;
F_13 ( V_83 , ( V_29 -> V_119 - 1 ) |
( ( V_66 -> V_125 - 1 ) << 16 ) ) ;
F_13 ( V_77 ,
( V_66 -> V_126 - V_122 - 1 ) |
...
F_13 ( V_74 , ( V_66 -> V_118 - 1 ) |
( ( V_66 -> V_124 - 1 ) << 16 ) ) ;
F_13 ( V_83 , ( V_66 -> V_119 - 1 ) |
( ( V_66 -> V_125 - 1 ) << 16 ) ) ;
...
V_154 = V_68 * V_3 -> V_152 -> V_165 [ 0 ] + V_67 * ( V_3 -> V_152 -> V_166 / 8 ) ;
F_13 ( V_160 , V_3 -> V_152 -> V_165 [ 0 ] ) ;
V_97 = F_12 ( V_35 ) ;
V_97 &= ~ V_167 ;
