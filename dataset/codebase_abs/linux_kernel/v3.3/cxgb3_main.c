...
F_173 ( V_15 , & V_294 ) ;
F_164 ( & V_15 -> V_252 ) ;
F_174 ( V_292 -> V_295 , V_296 , sizeof( V_292 -> V_295 ) ) ;
F_174 ( V_292 -> V_297 , V_298 , sizeof( V_292 -> V_297 ) ) ;
F_174 ( V_292 -> V_299 , F_175 ( V_15 -> V_53 ) ,
sizeof( V_292 -> V_299 ) ) ;
if ( V_293 )
snprintf ( V_292 -> V_300 , sizeof( V_292 -> V_300 ) ,
L_38 ,
F_176 ( V_293 ) ? L_39 : L_40 ,
F_177 ( V_293 ) ,
F_178 ( V_293 ) ,
F_179 ( V_293 ) ,
F_180 ( V_294 ) ,
...
static void F_183 ( struct V_1 * V_2 , T_6 V_301 , T_2 * V_195 )
{
if ( V_301 == V_286 )
memcpy ( V_195 , V_287 , sizeof( V_287 ) ) ;
}
static unsigned long F_184 ( struct V_15 * V_15 ,
...
static void F_185 ( struct V_1 * V_2 , struct V_304 * V_305 ,
T_8 * V_195 )
{
struct V_6 * V_16 = F_4 ( V_2 ) ;
struct V_15 * V_15 = V_16 -> V_15 ;
...
* V_195 ++ = F_184 ( V_15 , V_16 , V_327 ) ;
* V_195 ++ = F_184 ( V_15 , V_16 , V_328 ) ;
* V_195 ++ = F_184 ( V_15 , V_16 , V_329 ) ;
* V_195 ++ = F_184 ( V_15 , V_16 , V_330 ) ;
* V_195 ++ = F_184 ( V_15 , V_16 , V_331 ) ;
* V_195 ++ = 0 ;
* V_195 ++ = 0 ;
* V_195 ++ = 0 ;
* V_195 ++ = V_5 -> V_278 ;
...
static inline void F_186 ( struct V_15 * V_335 , void * V_133 ,
...
static void F_187 ( struct V_1 * V_2 , struct V_338 * V_339 ,
void * V_133 )
{
struct V_6 * V_16 = F_4 ( V_2 ) ;
struct V_15 * V_335 = V_16 -> V_15 ;
V_339 -> V_297 = 3 | ( V_335 -> V_97 . V_130 << 10 ) | ( F_188 ( V_335 ) << 31 ) ;
memset ( V_133 , 0 , V_289 ) ;
F_186 ( V_335 , V_133 , 0 , V_340 ) ;
F_186 ( V_335 , V_133 , V_341 , V_342 ) ;
F_186 ( V_335 , V_133 , V_343 , V_344 ) ;
F_186 ( V_335 , V_133 , V_345 , V_346 ) ;
F_186 ( V_335 , V_133 , V_347 , V_348 ) ;
F_186 ( V_335 , V_133 , V_349 ,
F_189 ( V_348 , 1 ) ) ;
F_186 ( V_335 , V_133 , F_189 ( V_349 , 1 ) ,
F_189 ( V_350 , 1 ) ) ;
}
...
static int F_192 ( struct V_1 * V_2 , struct V_362 * V_363 )
{
struct V_6 * V_7 = F_4 ( V_2 ) ;
V_363 -> V_364 = V_7 -> V_8 . V_364 ;
V_363 -> V_365 = V_7 -> V_8 . V_365 ;
if ( F_2 ( V_2 ) ) {
F_193 ( V_363 , V_7 -> V_8 . V_9 ) ;
...
static int F_194 ( int V_9 , int V_13 )
{
int V_376 = 0 ;
switch ( V_9 ) {
case V_377 :
...
static int F_195 ( struct V_1 * V_2 , struct V_362 * V_363 )
{
struct V_6 * V_7 = F_4 ( V_2 ) ;
...
T_6 V_9 = F_196 ( V_363 ) ;
int V_376 = F_194 ( V_9 , V_363 -> V_13 ) ;
...
if ( F_17 ( V_2 ) )
F_199 ( & V_7 -> V_18 , - 1 , - 1 , V_385 -> V_398 ) ;
}
return 0 ;
}
static void F_200 ( struct V_1 * V_2 , struct V_401 * V_402 )
{
struct V_6 * V_16 = F_4 ( V_2 ) ;
struct V_15 * V_15 = V_16 -> V_15 ;
...
V_402 -> V_407 = V_408 ;
V_402 -> V_409 = V_410 ;
V_402 -> V_411 = V_404 -> V_412 ;
V_402 -> V_413 = V_404 -> V_414 ;
V_402 -> V_415 = V_404 -> V_416 ;
V_402 -> V_417 = V_404 -> V_418 [ 0 ] ;
}
static int F_201 ( struct V_1 * V_2 , struct V_401 * V_402 )
{
struct V_6 * V_16 = F_4 ( V_2 ) ;
struct V_15 * V_15 = V_16 -> V_15 ;
struct V_403 * V_404 ;
int V_58 ;
if ( V_402 -> V_411 > V_406 ||
V_402 -> V_415 > V_408 ||
V_402 -> V_417 > V_410 ||
V_402 -> V_413 > V_419 ||
V_402 -> V_413 < V_420 ||
V_402 -> V_411 < V_421 ||
V_402 -> V_415 < V_421 ||
V_402 -> V_417 < V_15 -> V_97 . V_422 * V_423 )
return - V_142 ;
if ( V_15 -> V_51 & V_145 )
return - V_146 ;
V_404 = & V_15 -> V_97 . V_70 . V_131 [ V_16 -> V_66 ] ;
for ( V_58 = 0 ; V_58 < V_16 -> V_65 ; ++ V_58 , ++ V_404 ) {
V_404 -> V_414 = V_402 -> V_413 ;
V_404 -> V_412 = V_402 -> V_411 ;
V_404 -> V_416 = V_402 -> V_415 ;
V_404 -> V_418 [ 0 ] = V_402 -> V_417 ;
V_404 -> V_418 [ 1 ] = V_402 -> V_417 ;
V_404 -> V_418 [ 2 ] = V_402 -> V_417 ;
}
return 0 ;
}
static int F_202 ( struct V_1 * V_2 , struct V_424 * V_425 )
{
struct V_6 * V_16 = F_4 ( V_2 ) ;
struct V_15 * V_15 = V_16 -> V_15 ;
struct V_403 * V_426 ;
struct V_117 * V_71 ;
int V_58 ;
if ( V_425 -> V_427 * 10 > V_428 )
return - V_142 ;
for ( V_58 = 0 ; V_58 < V_16 -> V_65 ; V_58 ++ ) {
V_426 = & V_15 -> V_97 . V_70 . V_131 [ V_58 ] ;
V_71 = & V_15 -> V_70 . V_71 [ V_58 ] ;
V_426 -> V_429 = V_425 -> V_427 ;
F_203 ( V_71 , V_426 ) ;
}
return 0 ;
}
static int F_204 ( struct V_1 * V_2 , struct V_424 * V_425 )
{
struct V_6 * V_16 = F_4 ( V_2 ) ;
struct V_15 * V_15 = V_16 -> V_15 ;
struct V_403 * V_404 = V_15 -> V_97 . V_70 . V_131 ;
V_425 -> V_427 = V_404 -> V_429 ;
return 0 ;
}
static int F_205 ( struct V_1 * V_2 , struct V_430 * V_402 ,
T_2 * V_195 )
{
struct V_6 * V_16 = F_4 ( V_2 ) ;
struct V_15 * V_15 = V_16 -> V_15 ;
int V_58 , V_67 = 0 ;
T_2 * V_133 = F_206 ( V_290 , V_85 ) ;
if ( ! V_133 )
return - V_103 ;
V_402 -> V_431 = V_432 ;
for ( V_58 = V_402 -> V_19 & ~ 3 ; ! V_67 && V_58 < V_402 -> V_19 + V_402 -> V_134 ; V_58 += 4 )
V_67 = F_207 ( V_15 , V_58 , ( V_433 * ) & V_133 [ V_58 ] ) ;
if ( ! V_67 )
memcpy ( V_195 , V_133 + V_402 -> V_19 , V_402 -> V_134 ) ;
F_208 ( V_133 ) ;
return V_67 ;
}
static int F_209 ( struct V_1 * V_2 , struct V_430 * V_434 ,
T_2 * V_195 )
{
struct V_6 * V_16 = F_4 ( V_2 ) ;
struct V_15 * V_15 = V_16 -> V_15 ;
...
T_2 * V_133 ;
int V_67 ;
if ( V_434 -> V_431 != V_432 )
return - V_142 ;
V_435 = V_434 -> V_19 & ~ 3 ;
V_436 = ( V_434 -> V_134 + ( V_434 -> V_19 & 3 ) + 3 ) & ~ 3 ;
if ( V_435 != V_434 -> V_19 || V_436 != V_434 -> V_134 ) {
V_133 = F_206 ( V_436 , V_85 ) ;
if ( ! V_133 )
return - V_103 ;
V_67 = F_207 ( V_15 , V_435 , ( V_433 * ) V_133 ) ;
if ( ! V_67 && V_436 > 4 )
V_67 = F_207 ( V_15 ,
V_435 + V_436 - 4 ,
( V_433 * ) & V_133 [ V_436 - 4 ] ) ;
if ( V_67 )
goto V_209;
memcpy ( V_133 + ( V_434 -> V_19 & 3 ) , V_195 , V_434 -> V_134 ) ;
} else
V_133 = V_195 ;
V_67 = F_210 ( V_15 , 0 ) ;
if ( V_67 )
goto V_209;
for ( V_7 = ( V_433 * ) V_133 ; ! V_67 && V_436 ; V_436 -= 4 , V_7 ++ ) {
V_67 = F_211 ( V_15 , V_435 , * V_7 ) ;
V_435 += 4 ;
}
if ( ! V_67 )
V_67 = F_210 ( V_15 , 1 ) ;
...
static void F_212 ( struct V_1 * V_2 , struct V_437 * V_438 )
{
V_438 -> V_364 = 0 ;
V_438 -> V_439 = 0 ;
memset ( & V_438 -> V_440 , 0 , sizeof( V_438 -> V_440 ) ) ;
}
static int F_213 ( int V_139 , int V_171 , int V_172 )
{
return V_139 < 0 || ( V_139 <= V_172 && V_139 >= V_171 ) ;
}
static int F_214 ( struct V_1 * V_2 , void T_9 * V_441 )
{
struct V_6 * V_16 = F_4 ( V_2 ) ;
struct V_15 * V_15 = V_16 -> V_15 ;
T_6 V_363 ;
int V_138 ;
if ( F_215 ( & V_363 , V_441 , sizeof( V_363 ) ) )
return - V_442 ;
switch ( V_363 ) {
case V_443 : {
int V_58 ;
...
if ( ! F_77 ( V_140 ) )
return - V_141 ;
if ( F_215 ( & V_445 , V_441 , sizeof( V_445 ) ) )
return - V_442 ;
if ( V_445 . V_128 >= V_107 )
return - V_142 ;
if ( ! F_213 ( V_445 . V_447 , 0 , V_428 ) ||
! F_213 ( V_445 . V_448 , 0 , 255 ) ||
! F_213 ( V_445 . V_418 [ 0 ] , V_423 ,
V_410 ) ||
! F_213 ( V_445 . V_418 [ 1 ] , V_423 ,
V_410 ) ||
! F_213 ( V_445 . V_418 [ 2 ] , V_449 ,
V_450 ) ||
! F_213 ( V_445 . V_412 [ 0 ] , V_421 ,
V_406 ) ||
! F_213 ( V_445 . V_412 [ 1 ] , V_421 ,
V_408 ) ||
! F_213 ( V_445 . V_414 , V_420 ,
V_419 ) )
return - V_142 ;
if ( ( V_15 -> V_51 & V_145 ) &&
( V_445 . V_414 >= 0 || V_445 . V_412 [ 0 ] >= 0 ||
V_445 . V_412 [ 1 ] >= 0 || V_445 . V_418 [ 0 ] >= 0 ||
V_445 . V_418 [ 1 ] >= 0 || V_445 . V_418 [ 2 ] >= 0 ||
V_445 . V_73 >= 0 || V_445 . V_448 >= 0 ) )
return - V_146 ;
if ( F_144 ( V_233 , & V_15 -> V_231 ) ) {
V_446 = 0 ;
F_35 (adapter, i) {
...
if ( V_445 . V_128 < V_446 )
return - V_142 ;
if ( V_445 . V_128 > V_446 + V_65 - 1 )
return - V_142 ;
V_404 = & V_15 -> V_97 . V_70 . V_131 [ V_445 . V_128 ] ;
if ( V_445 . V_414 >= 0 )
V_404 -> V_414 = V_445 . V_414 ;
if ( V_445 . V_412 [ 0 ] >= 0 )
V_404 -> V_412 = V_445 . V_412 [ 0 ] ;
if ( V_445 . V_412 [ 1 ] >= 0 )
V_404 -> V_416 = V_445 . V_412 [ 1 ] ;
if ( V_445 . V_418 [ 0 ] >= 0 )
V_404 -> V_418 [ 0 ] = V_445 . V_418 [ 0 ] ;
if ( V_445 . V_418 [ 1 ] >= 0 )
V_404 -> V_418 [ 1 ] = V_445 . V_418 [ 1 ] ;
if ( V_445 . V_418 [ 2 ] >= 0 )
V_404 -> V_418 [ 2 ] = V_445 . V_418 [ 2 ] ;
if ( V_445 . V_448 >= 0 )
V_404 -> V_448 = V_445 . V_448 ;
if ( V_445 . V_447 >= 0 ) {
struct V_117 * V_71 =
& V_15 -> V_70 . V_71 [ V_445 . V_128 ] ;
V_404 -> V_429 = V_445 . V_447 ;
F_203 ( V_71 , V_404 ) ;
}
if ( V_445 . V_73 >= 0 ) {
if ( V_15 -> V_51 & V_52 )
V_404 -> V_73 = V_445 . V_73 ;
else {
...
if ( V_445 . V_128 >= V_65 )
return - V_142 ;
V_404 = & V_15 -> V_97 . V_70 . V_131 [ V_446 + V_445 . V_128 ] ;
V_445 . V_414 = V_404 -> V_414 ;
V_445 . V_418 [ 0 ] = V_404 -> V_418 [ 0 ] ;
V_445 . V_418 [ 1 ] = V_404 -> V_418 [ 1 ] ;
V_445 . V_418 [ 2 ] = V_404 -> V_418 [ 2 ] ;
V_445 . V_412 [ 0 ] = V_404 -> V_412 ;
V_445 . V_412 [ 1 ] = V_404 -> V_416 ;
V_445 . V_73 = V_404 -> V_73 ;
V_445 . V_451 = ! ! ( V_2 -> V_455 & V_453 ) ;
V_445 . V_447 = V_404 -> V_429 ;
V_445 . V_448 = V_404 -> V_448 ;
V_445 . V_456 = V_446 ;
if ( V_15 -> V_51 & V_52 )
V_445 . V_457 = V_15 -> V_62 [ V_446 + V_445 . V_128 + 1 ] . V_69 ;
else
V_445 . V_457 = V_15 -> V_53 -> V_55 ;
if ( F_217 ( V_441 , & V_445 , sizeof( V_445 ) ) )
return - V_442 ;
break;
}
case V_458 : {
struct V_459 V_460 ;
unsigned int V_58 , V_66 = 0 , V_461 = 0 ;
if ( ! F_77 ( V_140 ) )
return - V_141 ;
if ( V_15 -> V_51 & V_145 )
return - V_146 ;
if ( F_215 ( & V_460 , V_441 , sizeof( V_460 ) ) )
return - V_442 ;
if ( V_460 . V_139 < 1 ||
( V_460 . V_139 > 1 && ! ( V_15 -> V_51 & V_52 ) ) )
return - V_142 ;
F_35 (adapter, i)
if ( V_15 -> V_28 [ V_58 ] && V_15 -> V_28 [ V_58 ] != V_2 )
V_461 += F_37 ( V_15 , V_58 ) -> V_65 ;
if ( V_460 . V_139 + V_461 > V_107 )
return - V_142 ;
V_16 -> V_65 = V_460 . V_139 ;
F_35 (adapter, i)
if ( V_15 -> V_28 [ V_58 ] ) {
V_16 = F_37 ( V_15 , V_58 ) ;
V_16 -> V_66 = V_66 ;
...
V_460 . V_363 = V_462 ;
V_460 . V_139 = V_16 -> V_65 ;
if ( F_217 ( V_441 , & V_460 , sizeof( V_460 ) ) )
return - V_442 ;
break;
}
case V_463 : {
...
if ( F_215 ( & V_445 , V_441 , sizeof( V_445 ) ) )
return - V_442 ;
V_464 = F_218 ( V_441 + sizeof( V_445 ) , V_445 . V_134 ) ;
if ( F_219 ( V_464 ) )
return F_220 ( V_464 ) ;
V_138 = F_107 ( V_15 , V_464 , V_445 . V_134 ) ;
F_208 ( V_464 ) ;
if ( V_138 )
return V_138 ;
break;
...
if ( F_221 ( V_15 ) )
return - V_146 ;
if ( F_215 ( & V_469 , V_441 , sizeof( V_469 ) ) )
return - V_442 ;
if ( V_469 . V_470 != V_93 )
return - V_142 ;
if ( V_469 . V_169 [ 0 ] < 81 )
...
if ( V_469 . V_169 [ V_58 ] < V_469 . V_169 [ V_58 - 1 ] )
return - V_142 ;
memcpy ( V_15 -> V_97 . V_169 , V_469 . V_169 ,
sizeof( V_15 -> V_97 . V_169 ) ) ;
break;
}
case V_471 : {
struct V_472 * V_7 = & V_15 -> V_97 . V_473 ;
struct V_474 V_469 = { . V_363 = V_471 } ;
if ( ! F_80 ( V_15 ) )
return - V_288 ;
V_469 . V_475 = V_7 -> V_476 ;
V_469 . V_477 = V_7 -> V_478 ;
V_469 . V_479 = V_7 -> V_480 ;
V_469 . V_481 = V_7 -> V_482 ;
V_469 . V_483 = V_7 -> V_484 + V_7 -> V_485 * V_7 -> V_486 ;
if ( F_217 ( V_441 , & V_469 , sizeof( V_469 ) ) )
return - V_442 ;
break;
}
case V_487 : {
...
return - V_142 ;
if ( V_469 . V_481 * V_469 . V_479 > V_7 -> V_485 ||
V_469 . V_477 * V_469 . V_475 > V_7 -> V_488 )
return - V_142 ;
V_7 -> V_480 = V_469 . V_479 ;
V_7 -> V_476 = V_469 . V_475 ;
V_7 -> V_482 = V_469 . V_481 ;
V_7 -> V_478 = V_469 . V_477 ;
break;
}
case V_489 : {
struct V_465 V_445 ;
...
if ( F_215 ( & V_445 , V_441 , sizeof( V_445 ) ) )
return - V_442 ;
if ( ( V_445 . V_154 & 7 ) || ( V_445 . V_134 & 7 ) )
return - V_142 ;
if ( V_445 . V_493 == V_494 )
V_491 = & V_15 -> V_495 ;
else if ( V_445 . V_493 == V_496 )
V_491 = & V_15 -> V_497 ;
else if ( V_445 . V_493 == V_498 )
V_491 = & V_15 -> V_499 ;
else
return - V_142 ;
V_445 . V_297 = 3 | ( V_15 -> V_97 . V_130 << 10 ) ;
if ( F_217 ( V_441 , & V_445 , sizeof( V_445 ) ) )
return - V_442 ;
V_441 += sizeof( V_445 ) ;
while ( V_445 . V_134 ) {
unsigned int V_500 =
F_223 (unsigned int, t.len, sizeof(buf)) ;
V_138 =
F_224 ( V_491 , V_445 . V_154 / 8 , V_500 / 8 ,
V_133 ) ;
if ( V_138 )
return V_138 ;
if ( F_217 ( V_441 , V_133 , V_500 ) )
return - V_442 ;
V_441 += V_500 ;
V_445 . V_154 += V_500 ;
V_445 . V_134 -= V_500 ;
...
if ( F_215 ( & V_445 , V_441 , sizeof( V_445 ) ) )
return - V_442 ;
V_473 = ( const struct V_503 * ) & V_445 . V_504 ;
if ( V_445 . V_505 )
F_225 ( V_15 , V_473 , 0 ,
V_445 . V_506 ,
V_445 . V_507 ) ;
...
static int F_226 ( struct V_1 * V_2 , struct V_510 * V_84 , int V_363 )
{
struct V_511 * V_195 = F_227 ( V_84 ) ;
struct V_6 * V_16 = F_4 ( V_2 ) ;
struct V_15 * V_15 = V_16 -> V_15 ;
switch ( V_363 ) {
case V_512 :
...
( V_195 -> V_514 & 0x1f00 ) &&
! ( V_195 -> V_514 & 0xe0e0 ) )
V_195 -> V_514 = F_229 ( V_195 -> V_514 >> 8 ,
V_195 -> V_514 & 0x1f ) ;
case V_515 :
return F_230 ( & V_16 -> V_38 . V_370 , V_195 , V_363 ) ;
case V_516 :
return F_214 ( V_2 , V_84 -> V_517 ) ;
default:
return - V_288 ;
}
}
static int F_231 ( struct V_1 * V_2 , int V_518 )
{
struct V_6 * V_16 = F_4 ( V_2 ) ;
struct V_15 * V_15 = V_16 -> V_15 ;
int V_138 ;
if ( V_518 < 81 )
return - V_142 ;
if ( ( V_138 = F_27 ( & V_16 -> V_18 , V_518 ) ) )
return V_138 ;
V_2 -> V_45 = V_518 ;
F_94 ( V_15 ) ;
if ( V_15 -> V_97 . V_130 == 0 && F_221 ( V_15 ) )
F_135 ( V_15 , V_15 -> V_97 . V_169 ,
V_15 -> V_97 . V_235 , V_15 -> V_97 . V_236 ,
V_15 -> V_28 [ 0 ] -> V_45 ) ;
return 0 ;
}
static int F_232 ( struct V_1 * V_2 , void * V_7 )
{
struct V_6 * V_16 = F_4 ( V_2 ) ;
struct V_15 * V_15 = V_16 -> V_15 ;
struct V_519 * V_154 = V_7 ;
if ( ! F_233 ( V_154 -> V_520 ) )
return - V_142 ;
memcpy ( V_2 -> V_47 , V_154 -> V_520 , V_2 -> V_521 ) ;
F_28 ( & V_16 -> V_18 , V_46 , V_2 -> V_47 ) ;
if ( F_221 ( V_15 ) )
F_92 ( V_15 , V_16 -> V_26 ) ;
return 0 ;
}
static void F_234 ( struct V_15 * V_25 , const struct V_6 * V_7 )
{
int V_58 ;
for ( V_58 = V_7 -> V_66 ; V_58 < V_7 -> V_66 + V_7 -> V_65 ; V_58 ++ ) {
struct V_522 * V_404 = & V_25 -> V_70 . V_71 [ V_58 ] . V_72 ;
F_126 ( & V_404 -> V_523 ) ;
F_127 ( & V_404 -> V_523 ) ;
}
}
static void F_235 ( struct V_1 * V_2 , T_10 V_455 )
{
struct V_6 * V_16 = F_4 ( V_2 ) ;
struct V_15 * V_15 = V_16 -> V_15 ;
if ( V_15 -> V_97 . V_130 > 0 ) {
F_236 ( V_15 , 1 << V_16 -> V_26 ,
V_455 & V_524 ) ;
} else {
unsigned int V_58 , V_525 = V_455 & V_524 ;
F_35 (adapter, i)
V_525 |=
V_15 -> V_28 [ V_58 ] -> V_455 & V_524 ;
F_236 ( V_15 , 1 , V_525 ) ;
}
F_234 ( V_15 , V_16 ) ;
}
static T_10 F_237 ( struct V_1 * V_2 ,
T_10 V_455 )
{
if ( V_455 & V_524 )
V_455 |= V_526 ;
...
static int F_238 ( struct V_1 * V_2 , T_10 V_455 )
{
T_10 V_527 = V_2 -> V_455 ^ V_455 ;
if ( V_527 & V_524 )
F_235 ( V_2 , V_455 ) ;
return 0 ;
}
...
V_528 = V_15 ;
F_39 ( V_15 , V_71 -> V_72 . V_73 ) ( 0 , V_528 ) ;
}
}
...
if ( ! ( V_7 -> V_38 . V_530 & V_531 ) && F_17 ( V_2 ) ) {
F_11 ( V_15 , V_58 ) ;
...
static void F_247 ( struct V_533 * V_534 )
{
struct V_15 * V_15 = F_248 ( V_534 , struct V_15 ,
V_229 . V_534 ) ;
const struct V_535 * V_7 = & V_15 -> V_97 ;
int V_28 ;
unsigned int V_153 , V_532 , V_536 ;
V_15 -> V_537 ++ ;
F_241 ( V_15 ) ;
if ( ! V_7 -> V_226 ||
( V_15 -> V_537 * V_7 -> V_226 ) / 10 >=
V_7 -> V_228 ) {
F_240 ( V_15 ) ;
V_15 -> V_537 = 0 ;
}
...
T_6 V_538 ;
V_538 = F_12 ( V_15 , V_31 + V_18 -> V_19 ) ;
V_536 = 0 ;
if ( V_538 & V_539 ) {
V_18 -> V_305 . V_271 ++ ;
V_536 |= V_539 ;
}
F_7 ( V_15 , V_31 + V_18 -> V_19 , V_536 ) ;
}
V_532 = F_12 ( V_15 , V_540 ) ;
V_536 = 0 ;
if ( V_532 & V_541 ) {
struct V_117 * V_71 = & V_15 -> V_70 . V_71 [ 0 ] ;
int V_58 = 0 ;
V_536 |= V_541 ;
V_153 = ( F_12 ( V_15 , V_542 ) >> V_543 ) &
0xffff ;
while ( V_153 ) {
V_71 -> V_544 [ V_58 ] . V_545 += ( V_153 & 1 ) ;
if ( V_58 )
V_71 ++ ;
V_58 ^= 1 ;
V_153 >>= 1 ;
...
F_7 ( V_15 , V_540 , V_536 ) ;
F_126 ( & V_15 -> V_223 ) ;
if ( V_15 -> V_231 & V_232 )
F_129 ( V_15 ) ;
F_127 ( & V_15 -> V_223 ) ;
}
static void F_249 ( struct V_533 * V_534 )
{
struct V_15 * V_15 = F_248 ( V_534 , struct V_15 ,
F_249 ) ;
F_155 ( & V_15 -> V_163 , V_546 , 0 ) ;
}
...
static void F_256 ( struct V_533 * V_534 )
{
struct V_15 * V_15 = F_248 ( V_534 , struct V_15 ,
V_552 ) ;
int V_58 ;
...
static int F_261 ( struct V_15 * V_15 , int V_536 , int V_222 )
{
int V_58 , V_138 = 0 ;
if ( F_80 ( V_15 ) &&
F_144 ( V_233 , & V_15 -> V_231 ) ) {
F_155 ( & V_15 -> V_163 , V_557 , 0 ) ;
F_141 ( & V_15 -> V_163 ) ;
}
F_35 (adapter, i) {
...
static void F_272 ( struct V_533 * V_534 )
{
struct V_15 * V_15 = F_248 ( V_534 , struct V_15 ,
V_559 ) ;
int V_67 = 0 ;
...
F_7 ( V_15 , V_22 , 0 ) ;
F_7 ( V_15 , V_21 , 0 ) ;
F_7 ( V_15 , F_189 ( V_22 , 1 ) , 0 ) ;
F_7 ( V_15 , F_189 ( V_21 , 1 ) , 0 ) ;
F_162 ( & V_15 -> V_223 ) ;
F_123 ( V_15 ) ;
F_259 ( V_224 , & V_15 -> V_559 ) ;
F_164 ( & V_15 -> V_223 ) ;
}
F_273 ( V_15 , L_45 ) ;
if ( ! F_275 ( V_15 , 0xa0 , 4 , V_560 ) )
F_273 ( V_15 , L_46 ,
V_560 [ 0 ] , V_560 [ 1 ] ,
V_560 [ 2 ] , V_560 [ 3 ] ) ;
}
static T_11 F_276 ( struct V_561 * V_53 ,
T_12 V_27 )
{
...
static T_11 F_278 ( struct V_561 * V_53 )
{
struct V_15 * V_15 = F_277 ( V_53 ) ;
if ( ! F_265 ( V_15 ) )
return V_565 ;
...
static void F_279 ( struct V_561 * V_53 )
{
struct V_15 * V_15 = F_277 ( V_53 ) ;
F_273 ( V_15 , L_47 ,
F_12 ( V_15 , V_566 ) ) ;
...
int V_58 , V_59 = 0 ;
int V_567 = F_281 () ;
int V_568 = V_25 -> V_97 . V_422 ;
int V_65 = V_25 -> V_569 - 1 ;
...
static int T_13 F_282 ( struct V_15 * V_25 )
{
struct V_570 V_571 [ V_107 + 1 ] ;
int V_572 ;
int V_58 , V_67 ;
V_572 = F_168 ( V_571 ) ;
for ( V_58 = 0 ; V_58 < V_572 ; ++ V_58 )
V_571 [ V_58 ] . V_573 = V_58 ;
while ( ( V_67 = F_283 ( V_25 -> V_53 , V_571 , V_572 ) ) > 0 )
V_572 = V_67 ;
if ( V_67 < 0 )
F_30 ( V_25 -> V_53 ) ;
if ( ! V_67 && V_572 < ( V_25 -> V_97 . V_422 + 1 ) ) {
F_30 ( V_25 -> V_53 ) ;
V_67 = - 1 ;
}
if ( ! V_67 ) {
for ( V_58 = 0 ; V_58 < V_572 ; ++ V_58 )
V_25 -> V_62 [ V_58 ] . V_69 = V_571 [ V_58 ] . V_457 ;
V_25 -> V_569 = V_572 ;
}
return V_67 ;
}
static void T_13 F_284 ( struct V_15 * V_25 ,
...
V_576 [ V_25 -> V_97 . V_577 . V_578 ] ,
V_25 -> V_97 . V_577 . V_579 ) ;
else
snprintf ( V_133 , sizeof( V_133 ) , L_55 ,
V_576 [ V_25 -> V_97 . V_577 . V_578 ] ,
V_25 -> V_97 . V_577 . V_9 , V_25 -> V_97 . V_577 . V_579 ) ;
F_35 (adap, i) {
struct V_1 * V_2 = V_25 -> V_28 [ V_58 ] ;
const struct V_6 * V_16 = F_4 ( V_2 ) ;
if ( ! F_144 ( V_58 , & V_25 -> V_580 ) )
continue;
F_3 ( V_3 L_56 ,
V_2 -> V_4 , V_575 -> V_63 , V_16 -> V_38 . V_63 ,
F_80 ( V_25 ) ? L_57 : L_58 , V_25 -> V_97 . V_130 , V_133 ,
( V_25 -> V_51 & V_52 ) ? L_59 :
( V_25 -> V_51 & V_54 ) ? L_60 : L_58 ) ;
if ( V_25 -> V_4 == V_2 -> V_4 && V_25 -> V_97 . V_160 . V_581 )
F_3 ( V_3
L_61 ,
V_25 -> V_4 , F_285 ( & V_25 -> V_495 ) >> 20 ,
F_285 ( & V_25 -> V_499 ) >> 20 ,
F_285 ( & V_25 -> V_497 ) >> 20 ,
V_25 -> V_97 . V_160 . V_582 ) ;
}
}
static void T_13 F_286 ( struct V_1 * V_2 )
{
struct V_6 * V_16 = F_4 ( V_2 ) ;
memcpy ( V_16 -> V_49 . V_50 , V_2 -> V_47 , V_166 ) ;
V_16 -> V_49 . V_50 [ 3 ] |= 0x80 ;
}
static int T_13 F_287 ( struct V_561 * V_53 ,
const struct V_583 * V_584 )
{
static int V_585 ;
int V_58 , V_67 , V_586 = 0 ;
T_14 V_587 , V_588 ;
const struct V_574 * V_575 ;
struct V_15 * V_15 = NULL ;
struct V_6 * V_16 ;
if ( ! V_585 ) {
F_3 ( V_3 L_62 , V_589 , V_298 ) ;
++ V_585 ;
}
if ( ! V_224 ) {
V_224 = F_288 ( V_296 ) ;
...
F_299 ( & V_15 -> V_252 ) ;
F_300 ( & V_15 -> V_596 ) ;
F_301 ( & V_15 -> V_552 , F_256 ) ;
F_301 ( & V_15 -> V_559 , F_272 ) ;
F_301 ( & V_15 -> F_249 , F_249 ) ;
F_301 ( & V_15 -> F_250 , F_250 ) ;
F_301 ( & V_15 -> F_251 , F_251 ) ;
F_302 ( & V_15 -> V_229 , F_247 ) ;
for ( V_58 = 0 ; V_58 < V_575 -> V_597 + V_575 -> V_598 ; ++ V_58 ) {
struct V_1 * V_123 ;
...
V_123 -> V_600 = V_587 ;
V_123 -> V_601 = V_587 + V_588 - 1 ;
V_123 -> V_602 = V_603 | V_604 |
V_605 | V_606 | V_524 ;
V_123 -> V_455 |= V_123 -> V_602 | V_526 ;
if ( V_586 )
V_123 -> V_455 |= V_607 ;
V_123 -> V_608 = & V_609 ;
F_305 ( V_123 , & V_610 ) ;
...
F_311 ( V_15 ) ;
if ( F_80 ( V_15 ) ) {
F_310 ( V_233 , & V_15 -> V_580 ) ;
F_312 ( V_15 ) ;
}
if ( V_612 > 1 && F_282 ( V_15 ) == 0 )
V_15 -> V_51 |= V_52 ;
else if ( V_612 > 0 && F_313 ( V_53 ) == 0 )
V_15 -> V_51 |= V_54 ;
F_280 ( V_15 ) ;
V_67 = F_136 ( & V_15 -> V_28 [ 0 ] -> V_2 . V_237 ,
& V_613 ) ;
F_35 (adapter, i)
F_235 ( V_15 -> V_28 [ V_58 ] , V_15 -> V_28 [ V_58 ] -> V_455 ) ;
F_284 ( V_15 , V_575 ) ;
return 0 ;
V_599:
F_314 ( V_15 -> V_339 ) ;
for ( V_58 = V_575 -> V_597 + V_575 -> V_598 - 1 ; V_58 >= 0 ; -- V_58 )
if ( V_15 -> V_28 [ V_58 ] )
...
static void T_15 F_317 ( struct V_561 * V_53 )
{
struct V_15 * V_15 = F_277 ( V_53 ) ;
if ( V_15 ) {
int V_58 ;
