...
static inline int F_75 ( T_5 V_128 , T_5 V_129 )
{
return V_128 == V_130 || V_128 == V_129 ;
}
static struct V_131 * F_76 ( struct V_2 * V_3 )
{
struct V_131 * V_132 ;
for ( V_132 = V_133 ; ; V_132 ++ )
if ( F_75 ( V_132 -> V_5 , V_3 -> V_5 ) &&
F_75 ( V_132 -> V_6 , V_3 -> V_6 ) &&
F_75 ( V_132 -> V_134 , V_3 -> V_7 ) &&
F_75 ( V_132 -> V_135 , V_3 -> V_8 ) )
break;
return V_132 ;
}
...
static int T_6
F_92 ( struct V_2 * V_3 , const struct V_138 * V_161 )
{
struct V_131 * V_132 ;
struct V_9 * V_10 ;
const struct V_29 * V_30 ;
...
static int F_101 ( struct V_2 * V_3 , T_7 V_168 )
{
struct V_9 * V_10 = F_100 ( V_3 ) ;
if ( V_10 )
F_88 ( V_10 ) ;
F_94 ( V_3 ) ;
F_102 ( V_3 , F_103 ( V_3 , V_168 ) ) ;
return 0 ;
}
