...
if ( V_47 >= V_49 )
return ~ 0 ;
V_48 = F_37 ( & V_50 [ V_47 ] ) & ~ V_46 ;
do {
if ( V_48 &&
! F_35 ( V_48 , V_45 ) )
return V_48 ;
V_48 = F_38 ( & V_50 [ V_47 ] , V_48 , V_45 ) ;
} while ( V_48 != V_45 );
return V_45 ;
}
int F_39 ( T_4 V_47 , T_4 V_51 , T_4 V_52 , T_4 V_53 )
{
unsigned long V_54 = F_40 ( V_47 ) ;
unsigned int V_45 , V_44 , V_55 ;
V_45 = ( V_53 << 16 ) | ( V_52 << 8 ) | V_51 ;
V_44 = F_14 ( V_54 ) ;
V_55 = F_36 ( V_47 , V_45 ) ;
if ( V_55 != V_45 ) {
F_41 ( V_56 L_4
...
V_143 = F_14 ( V_10 ) ;
F_59 ( V_145 , L_34 , V_143 ) ;
F_27 ( V_10 , V_143 ^ V_146 ) ;
V_144 = F_14 ( V_10 ) ;
F_59 ( V_145 , L_34 , V_144 ) ;
if ( V_144 != V_143 )
return 0 ;
V_144 = F_13 ( V_143 ) ;
...
F_75 () ;
F_151 ( & V_223 ) ;
F_59 ( V_145 , V_224 L_78 ,
F_42 () , V_220 , V_221 ) ;
V_221 = V_221 & 0xff ;
while ( V_221 ) {
if ( V_221 & 0x1 )
F_59 ( V_145 , V_225 L_79 , V_222 [ V_162 ] ) ;
V_162 ++ ;
V_221 >>= 1 ;
} ;
F_59 ( V_145 , V_225 L_80 ) ;
F_78 () ;
}
void T_1 F_142 ( void )
{
