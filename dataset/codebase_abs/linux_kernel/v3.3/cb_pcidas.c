...
F_32 ( 0 , V_6 -> V_34 + V_119 ) ;
V_1 = F_33 ( V_112 -> V_117 ) ;
}
V_115 = F_34 ( V_1 ) |
F_35 ( V_1 ) | F_36 ( F_37 ( V_112 -> V_117 ) ) ;
if ( F_37 ( V_112 -> V_117 ) & V_120 )
V_115 |= V_121 ;
if ( F_38 ( V_112 -> V_117 ) != V_122 )
V_115 |= V_123 ;
F_32 ( V_115 , V_6 -> V_34 + V_124 ) ;
F_32 ( 0 , V_6 -> V_36 + V_125 ) ;
for ( V_114 = 0 ; V_114 < V_112 -> V_114 ; V_114 ++ ) {
F_32 ( 0 , V_6 -> V_36 + V_126 ) ;
for ( V_15 = 0 ; V_15 < V_116 ; V_15 ++ ) {
if ( F_39 ( V_6 -> V_34 + V_124 ) & V_127 )
break;
}
if ( V_15 == V_116 )
return - V_128 ;
V_113 [ V_114 ] = F_39 ( V_6 -> V_36 + V_126 ) ;
}
return V_114 ;
}
...
~ V_136 & ~ F_2 ( V_1 ) ;
V_6 -> V_135 |=
V_137 | F_1 ( V_1 , F_37 ( V_112 -> V_117 ) ) ;
F_32 ( V_6 -> V_135 , V_6 -> V_34 + V_138 ) ;
F_42 ( & V_4 -> V_134 , V_133 ) ;
V_6 -> V_139 [ V_1 ] = V_113 [ 0 ] ;
F_32 ( V_113 [ 0 ] , V_6 -> V_42 + F_4 ( V_1 ) ) ;
return 1 ;
}
...
unsigned int * V_113 )
{
V_113 [ 0 ] = V_6 -> V_139 [ F_33 ( V_112 -> V_117 ) ] ;
return 1 ;
}
...
T_1 V_144 ;
int V_145 ;
V_145 = F_43 ( V_4 , F_33 ( V_112 -> V_117 ) , & V_144 ) ;
if ( V_145 < 0 )
return V_145 ;
V_113 [ 0 ] = V_144 ;
return 1 ;
...
struct V_111 * V_112 , unsigned int * V_113 )
{
const unsigned int V_1 = F_33 ( V_112 -> V_117 ) ;
...
struct V_111 * V_112 , unsigned int * V_113 )
{
V_113 [ 0 ] = V_6 -> V_146 [ F_33 ( V_112 -> V_117 ) ] ;
return 1 ;
}
...
return 1 ;
V_6 -> V_148 = V_147 ;
F_32 ( F_5 ( V_4 ) | ( V_147 & 0xff ) ,
V_6 -> V_34 + V_119 ) ;
F_44 ( 1 ) ;
F_32 ( F_5 ( V_4 ) | V_149 | ( V_147 & 0xff ) ,
V_6 -> V_34 + V_119 ) ;
F_44 ( 1 ) ;
F_32 ( F_5 ( V_4 ) | ( V_147 & 0xff ) ,
V_6 -> V_34 + V_119 ) ;
...
struct V_111 * V_112 , unsigned int * V_113 )
{
unsigned int V_1 = F_33 ( V_112 -> V_117 ) ;
...
return 4 ;
if ( V_153 -> V_184 ) {
V_156 = F_37 ( V_153 -> V_184 [ 0 ] ) ;
V_157 = F_33 ( V_153 -> V_184 [ 0 ] ) ;
for ( V_15 = 1 ; V_15 < V_153 -> V_176 ; V_15 ++ ) {
if ( F_33 ( V_153 -> V_184 [ V_15 ] ) !=
( V_157 + V_15 ) % V_11 -> V_59 ) {
F_47 ( V_4 ,
L_9 ) ;
V_154 ++ ;
}
if ( F_37 ( V_153 -> V_184 [ V_15 ] ) != V_156 ) {
F_47 ( V_4 ,
L_10 ) ;
V_154 ++ ;
}
...
unsigned long V_133 ;
F_32 ( 0 , V_6 -> V_34 + V_119 ) ;
F_32 ( 0 , V_6 -> V_34 + V_187 ) ;
F_32 ( 0 , V_6 -> V_36 + V_125 ) ;
V_115 = F_34 ( F_33 ( V_153 -> V_184 [ 0 ] ) ) |
F_35 ( F_33 ( V_153 -> V_184 [ V_153 -> V_176 - 1 ] ) ) |
F_36 ( F_37 ( V_153 -> V_184 [ 0 ] ) ) ;
if ( F_37 ( V_153 -> V_184 [ 0 ] ) & V_120 )
V_115 |= V_121 ;
if ( F_38 ( V_153 -> V_184 [ 0 ] ) != V_122 )
V_115 |= V_123 ;
...
V_6 -> V_191 ) ;
#endif
F_32 ( V_6 -> V_191 | V_198 | INT | V_199 ,
V_6 -> V_34 + V_200 ) ;
F_42 ( & V_4 -> V_134 , V_133 ) ;
V_115 = 0 ;
...
if ( V_153 -> V_164 == V_159 && V_153 -> V_176 > 1 )
V_115 |= V_208 ;
F_32 ( V_115 , V_6 -> V_34 + V_187 ) ;
#ifdef F_27
F_13 ( V_4 -> V_29 , L_14 , V_115 ) ;
#endif
return 0 ;
}
...
if ( F_33 ( V_153 -> V_184 [ 0 ] ) != 0 ||
F_33 ( V_153 -> V_184 [ 1 ] ) != 1 ) {
F_47 ( V_4 ,
L_15 ) ;
V_154 ++ ;
}
...
V_6 -> V_135 |=
F_3 ( F_33 ( V_153 -> V_184 [ V_15 ] ) ) ;
V_6 -> V_135 |= F_1 ( F_33 ( V_153 -> V_184 [ V_15 ] ) ,
F_37 ( V_153 ->
V_184 [ V_15 ] ) ) ;
}
F_32 ( V_6 -> V_135 , V_6 -> V_34 + V_138 ) ;
...
for ( V_15 = 0 ; V_15 < V_116 ; V_15 ++ ) {
if ( ( V_244 & F_39 ( V_6 -> V_34 +
V_200 ) ) == 0 )
break;
F_57 ( V_11 , F_39 ( V_6 -> V_36 ) ) ;
if ( V_186 -> V_153 . V_167 == V_166 && -- V_6 -> V_190 == 0 ) {
V_75 ( V_4 , V_11 ) ;
V_186 -> V_236 |= V_241 ;
break;
...
if ( V_230 & V_226 ) {
F_41 ( & V_4 -> V_134 , V_133 ) ;
F_32 ( V_6 -> V_191 | V_226 ,
V_6 -> V_34 + V_200 ) ;
F_42 ( & V_4 -> V_134 , V_133 ) ;
if ( F_39 ( V_6 -> V_42 + V_138 ) & V_228 ) {
if ( V_153 -> V_167 == V_168 ||
( V_153 -> V_167 == V_166
&& V_6 -> V_214 ) ) {
F_47 ( V_4 , L_23 ) ;
...
F_32 ( V_6 -> V_191 , V_6 -> V_34 + V_200 ) ;
F_42 ( & V_4 -> V_134 , V_133 ) ;
F_32 ( 0 , V_6 -> V_34 + V_187 ) ;
F_32 ( 0 , V_6 -> V_34 + V_124 ) ;
return 0 ;
}
...
V_6 -> V_34 + V_119 ) ;
F_44 ( V_259 ) ;
F_32 ( F_5 ( V_4 ) , V_6 -> V_34 + V_119 ) ;
return 1 ;
}
static int F_45 ( struct V_3 * V_4 , T_1 V_147 )
{
...
static int F_46 ( struct V_3 * V_4 , unsigned int V_1 ,
T_1 V_147 )
{
...
static int F_43 ( struct V_3 * V_4 , unsigned int V_257 ,
T_1 * V_113 )
{
