...
{
struct V_1 * V_2 = F_18 ( V_7 ) ;
F_22 ( V_127 -> V_128 , V_129 , sizeof( V_127 -> V_128 ) ) ;
F_22 ( V_127 -> V_130 , V_131 ,
sizeof( V_127 -> V_130 ) ) ;
snprintf ( V_127 -> V_132 , sizeof( V_127 -> V_132 ) ,
L_4 ,
( V_2 -> V_133 & 0x00ff0000 ) >> 16 ,
( V_2 -> V_133 & 0x0000ff00 ) >> 8 ,
( V_2 -> V_133 & 0x000000ff ) ) ;
F_22 ( V_127 -> V_134 , F_23 ( V_2 -> V_135 ) ,
sizeof( V_127 -> V_134 ) ) ;
V_127 -> V_136 = 0 ;
V_127 -> V_137 = 0 ;
if ( ! F_24 ( V_138 , & V_2 -> V_14 ) )
V_127 -> V_139 = sizeof( struct V_140 ) ;
else
V_127 -> V_139 = sizeof( struct V_141 ) ;
V_127 -> V_142 = 0 ;
}
static void F_25 ( struct V_30 * V_7 , struct V_143 * V_144 )
{
struct V_1 * V_2 = F_18 ( V_7 ) ;
V_144 -> V_103 = V_145 ;
V_144 -> V_146 = V_2 -> V_144 ;
}
static int F_26 ( struct V_30 * V_7 , struct V_143 * V_144 )
{
struct V_1 * V_2 = F_18 ( V_7 ) ;
int V_4 ;
...
F_27 ( V_2 , V_27 , V_2 -> V_7 , L_5 , V_2 -> V_144 ) ;
if ( ! V_2 -> V_144 ) {
T_1 V_144 = 0 ;
V_4 = F_28 ( V_2 , V_144 ) ;
...
static int F_29 ( struct V_30 * V_7 ,
enum V_148 V_149 )
{
struct V_1 * V_2 = F_18 ( V_7 ) ;
switch ( V_149 ) {
...
V_2 -> V_156 &= ~ V_157 ;
F_37 ( V_2 ) ;
if ( F_24 ( V_155 , & V_2 -> V_14 ) ) {
F_39 ( V_2 -> V_7 ) ;
F_36 ( V_155 , & V_2 -> V_14 ) ;
}
}
static void F_40 ( struct V_158 * V_159 ,
unsigned int V_160 )
{
...
V_159 = F_44 ( V_2 -> V_7 , V_164 ) ;
if ( ! V_159 )
return - V_166 ;
V_159 -> V_167 = 0 ;
F_45 ( V_159 , V_164 ) ;
F_40 ( V_159 , V_164 ) ;
V_163 = F_46 ( V_159 , V_2 -> V_7 ) ;
if ( V_163 != V_168 )
return - V_169 ;
F_47 ( & V_2 -> V_162 ) ;
}
F_48 ( 2 ) ;
F_49 ( & V_2 -> V_5 [ 0 ] , 128 ) ;
return F_50 ( & V_2 -> V_162 ) ? - V_151 : 0 ;
}
static int F_51 ( struct V_1 * V_2 , T_2 * V_21 )
{
* V_21 = F_32 ( V_2 ) ;
if ( * V_21 )
goto V_170;
...
static void F_52 ( struct V_30 * V_7 ,
...
static int F_54 ( struct V_30 * V_7 )
{
struct V_1 * V_2 = F_18 ( V_7 ) ;
if ( ! F_24 ( V_138 , & V_2 -> V_14 ) )
...
static void F_55 ( struct V_30 * V_7 ,
...
static int F_57 ( struct V_30 * V_31 , struct V_180 * V_181 )
{
...
static int F_58 ( struct V_30 * V_7 , struct V_180 * V_181 )
{
struct V_1 * V_2 = F_18 ( V_7 ) ;
...
static void F_59 ( struct V_30 * V_185 ,
struct V_186 * V_187 )
{
...
static int F_61 ( struct V_30 * V_185 ,
struct V_186 * V_187 )
{
struct V_1 * V_2 = F_18 ( V_185 ) ;
int V_4 = 0 ;
...
static T_1 F_62 ( struct V_30 * V_7 )
{
struct V_1 * V_2 = F_18 ( V_7 ) ;
return V_2 -> V_191 ;
}
static void F_63 ( struct V_30 * V_7 , T_1 V_192 )
{
struct V_1 * V_2 = F_18 ( V_7 ) ;
V_2 -> V_191 = V_192 ;
}
