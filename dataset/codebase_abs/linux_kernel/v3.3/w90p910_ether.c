...
V_6 = F_2 ( V_2 ) ;
V_15 = V_6 -> V_15 ;
V_6 -> V_46 = (struct V_50 * )
F_17 ( & V_15 -> V_2 , sizeof( struct V_50 ) ,
& V_6 -> V_51 , V_52 ) ;
if ( ! V_6 -> V_46 ) {
F_18 ( & V_15 -> V_2 , L_5 ) ;
return - V_53 ;
}
V_6 -> V_48 = (struct V_54 * )
F_17 ( & V_15 -> V_2 , sizeof( struct V_54 ) ,
& V_6 -> V_55 , V_52 ) ;
if ( ! V_6 -> V_48 ) {
F_18 ( & V_15 -> V_2 , L_6 ) ;
F_19 ( & V_15 -> V_2 , sizeof( struct V_50 ) ,
V_6 -> V_46 , V_6 -> V_51 ) ;
return - V_53 ;
}
...
if ( V_49 == V_56 - 1 )
V_57 = F_20 ( struct V_50 , V_58 [ 0 ] ) ;
else
V_57 = F_20 ( struct V_50 , V_58 [ V_49 + 1 ] ) ;
V_46 -> V_59 = V_6 -> V_51 + V_57 ;
V_46 -> V_60 = V_6 -> V_51 +
F_20 ( struct V_50 , V_61 [ V_49 ] ) ;
V_46 -> V_62 = 0 ;
V_46 -> V_63 = 0 ;
}
V_6 -> V_64 = V_6 -> V_51 ;
...
if ( V_49 == V_65 - 1 )
V_57 = F_20 ( struct V_54 , V_58 [ 0 ] ) ;
else
V_57 = F_20 ( struct V_54 , V_58 [ V_49 + 1 ] ) ;
V_48 -> V_59 = V_6 -> V_55 + V_57 ;
V_48 -> V_62 = V_66 ;
V_48 -> V_60 = V_6 -> V_55 +
F_20 ( struct V_54 , V_67 [ V_49 ] ) ;
}
V_6 -> V_68 = V_6 -> V_55 ;
return 0 ;
}
...
static void F_31 ( struct V_1 * V_2 , unsigned int V_97 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
unsigned int V_7 ;
V_7 = F_3 ( V_6 -> V_8 + V_9 ) ;
...
static int F_38 ( struct V_1 * V_2 , void * V_113 )
{
...
struct V_14 * V_15 ;
V_15 = V_6 -> V_15 ;
F_19 ( & V_15 -> V_2 , sizeof( struct V_54 ) ,
V_6 -> V_48 , V_6 -> V_55 ) ;
F_19 ( & V_15 -> V_2 , sizeof( struct V_50 ) ,
V_6 -> V_46 , V_6 -> V_51 ) ;
F_35 ( V_2 ) ;
...
static struct V_123 * F_44 ( struct V_1 * V_2 )
{
struct V_5 * V_6 ;
V_6 = F_2 ( V_2 ) ;
return & V_6 -> V_124 ;
...
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
if ( ! ( F_45 ( V_2 , V_132 -> V_106 , V_132 -> V_133 ) ) ) {
V_6 -> V_132 = V_132 ;
F_47 ( V_132 ) ;
return 0 ;
}
...
V_137 = V_6 -> V_51 +
F_20 ( struct V_50 , V_58 [ V_6 -> V_104 ] ) ;
while ( V_137 != V_136 ) {
...
V_137 = V_6 -> V_55 +
F_20 ( struct V_54 , V_58 [ V_6 -> V_105 ] ) ;
if ( V_7 == V_137 )
break;
V_138 = V_148 -> V_62 ;
V_125 = V_138 & 0xFFFF ;
...
struct V_176 * V_177 )
{
strcpy ( V_177 -> V_178 , V_179 ) ;
strcpy ( V_177 -> V_180 , V_181 ) ;
}
static int F_67 ( struct V_1 * V_2 , struct V_182 * V_174 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
return F_68 ( & V_6 -> V_19 , V_174 ) ;
}
static int F_69 ( struct V_1 * V_2 , struct V_182 * V_174 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
return F_70 ( & V_6 -> V_19 , V_174 ) ;
}
...
static int T_4 F_78 ( struct V_14 * V_15 )
{
struct V_5 * V_6 ;
struct V_1 * V_2 ;
int error ;
...
return - V_53 ;
V_6 = F_2 ( V_2 ) ;
V_6 -> V_195 = F_80 ( V_15 , V_196 , 0 ) ;
if ( V_6 -> V_195 == NULL ) {
F_18 ( & V_15 -> V_2 , L_22 ) ;
error = - V_197 ;
goto V_198;
}
if ( ! F_81 ( V_6 -> V_195 -> V_199 ,
F_82 ( V_6 -> V_195 ) , V_15 -> V_21 ) ) {
F_18 ( & V_15 -> V_2 , L_23 ) ;
error = - V_200 ;
goto V_198;
}
V_6 -> V_8 = F_83 ( V_6 -> V_195 -> V_199 , F_82 ( V_6 -> V_195 ) ) ;
if ( V_6 -> V_8 == NULL ) {
F_18 ( & V_15 -> V_2 , L_24 ) ;
error = - V_197 ;
goto V_201;
}
V_6 -> V_121 = F_84 ( V_15 , 0 ) ;
if ( V_6 -> V_121 < 0 ) {
F_18 ( & V_15 -> V_2 , L_25 ) ;
error = - V_197 ;
goto V_202;
}
V_6 -> V_122 = F_84 ( V_15 , 1 ) ;
if ( V_6 -> V_122 < 0 ) {
F_18 ( & V_15 -> V_2 , L_26 ) ;
error = - V_197 ;
goto V_203;
...
F_85 ( V_15 , V_2 ) ;
V_6 -> V_120 = F_86 ( & V_15 -> V_2 , NULL ) ;
if ( F_87 ( V_6 -> V_120 ) ) {
F_18 ( & V_15 -> V_2 , L_27 ) ;
error = F_88 ( V_6 -> V_120 ) ;
goto V_204;
}
V_6 -> V_119 = F_86 ( & V_15 -> V_2 , L_28 ) ;
if ( F_87 ( V_6 -> V_119 ) ) {
F_18 ( & V_15 -> V_2 , L_27 ) ;
...
F_91 ( V_6 -> V_8 ) ;
V_201:
F_92 ( V_6 -> V_195 -> V_199 , F_82 ( V_6 -> V_195 ) ) ;
V_198:
F_93 ( V_2 ) ;
return error ;
}
static int T_5 F_94 ( struct V_14 * V_15 )
{
