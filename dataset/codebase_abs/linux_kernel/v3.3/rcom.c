...
static int F_45 ( struct V_1 * V_2 , struct V_7 * V_11 )
{
T_2 V_125 ;
int V_126 = 0 ;
switch ( V_11 -> V_27 ) {
...
void F_46 ( struct V_1 * V_2 , struct V_7 * V_11 , int V_47 )
{
int V_127 = sizeof( struct V_7 ) + sizeof( struct V_93 ) ;
if ( F_47 ( V_2 ) && ( V_11 -> V_27 != V_59 ) ) {
F_26 ( V_2 , L_9 ,
V_11 -> V_27 , V_47 ) ;
goto V_58;
}
