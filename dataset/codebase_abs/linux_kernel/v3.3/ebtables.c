...
if ( V_125 != 0 )
return V_125 ;
strncpy ( V_30 , V_74 -> V_15 . V_14 -> V_30 , sizeof( V_30 ) ) ;
if ( F_4 ( V_199 , V_30 , V_113 ) )
return - V_7 ;
return 0 ;
}
...
static int F_111 ( struct V_212 * V_247 ,
...
if ( V_251 )
V_251 -> V_126 = V_125 ;
F_112 ( type == V_245 && V_248 ) ;
V_247 = (struct V_212 * ) V_250 ;
}
return V_249 ;
}
static int F_113 ( struct V_31 * V_25 , const unsigned char * V_80 ,
unsigned int * V_252 ,
struct V_228 * V_229 )
{
...
V_125 = F_111 ( V_247 , V_177 , V_28 , V_229 , V_80 ) ;
if ( V_125 < 0 )
return V_125 ;
V_254 += V_125 ;
if ( V_256 && V_254 ) {
...
static int F_115 ( unsigned char * V_18 , unsigned int V_258 ,
struct V_228 * V_229 )
{
unsigned int V_259 = V_258 ;
int V_125 ;
V_125 = F_50 ( V_18 , V_258 , F_113 , V_18 ,
& V_259 , V_229 ) ;
if ( V_125 < 0 )
return V_125 ;
F_112 ( V_259 ) ;
...
static int F_116 ( struct V_133 * V_134 ,
...
if ( V_185 . V_176 >= V_186 / sizeof( struct V_70 ) )
return - V_172 ;
memcpy ( V_134 , & V_185 , F_114 ( struct V_133 , V_90 ) ) ;
for ( V_28 = 0 ; V_28 < V_140 ; V_28 ++ )
...
static int F_117 ( struct V_116 * V_116 , void T_1 * V_183 ,
unsigned int V_97 )
{
...
V_125 = F_115 ( V_261 , V_185 . V_137 , & V_229 ) ;
if ( V_125 < 0 )
goto V_262;
F_100 ( L_48 ,
...
static int F_121 ( struct V_116 * V_116 , void T_1 * V_183 ,
unsigned int V_97 )
{
struct V_224 V_199 ;
if ( F_60 ( & V_199 , V_183 , sizeof( V_199 ) ) )
...
switch ( V_201 ) {
case V_207 :
V_125 = F_117 ( F_80 ( V_204 ) , V_183 , V_97 ) ;
break;
case V_208 :
V_125 = F_121 ( F_80 ( V_204 ) , V_183 , V_97 ) ;
break;
default:
V_125 = - V_127 ;
}
...
static int F_123 ( struct V_203 * V_204 , int V_201 ,
