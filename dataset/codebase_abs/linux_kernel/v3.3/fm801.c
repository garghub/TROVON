...
static int F_84 ( struct V_197 * V_107 )
{
struct V_1 * V_2 = V_107 -> V_198 ;
return F_77 ( V_2 ) ;
}
static int T_4 F_85 ( struct V_199 * V_110 ,
struct V_200 * V_118 ,
int V_183 ,
struct V_1 * * V_201 )
{
struct V_1 * V_2 ;
int V_96 ;
static struct V_202 V_166 = {
. V_203 = F_84 ,
} ;
* V_201 = NULL ;
if ( ( V_96 = F_86 ( V_118 ) ) < 0 )
return V_96 ;
V_2 = F_87 ( sizeof( * V_2 ) , V_204 ) ;
if ( V_2 == NULL ) {
F_82 ( V_118 ) ;
return - V_205 ;
}
...
V_2 -> V_84 = - 1 ;
V_2 -> V_183 = V_183 ;
if ( ( V_96 = F_89 ( V_118 , L_4 ) ) < 0 ) {
F_83 ( V_2 ) ;
F_82 ( V_118 ) ;
return V_96 ;
}
V_2 -> V_11 = F_90 ( V_118 , 0 ) ;
if ( ( V_183 & V_184 ) == 0 ) {
if ( F_91 ( V_118 -> V_84 , F_35 , V_206 ,
V_207 , V_2 ) ) {
...
if ( ( V_96 = F_94 ( V_110 , V_210 , V_2 , & V_166 ) ) < 0 ) {
F_77 ( V_2 ) ;
return V_96 ;
}
F_95 ( V_110 , & V_118 -> V_211 ) ;
#ifdef F_78
V_2 -> V_120 . V_15 = V_2 ;
V_2 -> V_120 . V_166 = & V_212 ;
sprintf ( V_2 -> V_120 . V_213 , L_13 , F_96 ( V_118 ) ) ;
if ( ( V_183 & V_214 ) > 0 &&
( V_183 & V_214 ) < 4 ) {
if ( F_97 ( & V_2 -> V_120 ) ) {
F_9 ( V_20 L_14 ) ;
...
if ( ! ( V_2 -> V_183 & V_196 ) ) {
F_98 ( V_2 -> V_120 . V_110 , F_50 ( V_2 ) -> V_116 ,
...
static int T_4 F_99 ( struct V_200 * V_118 ,
...
V_96 = F_100 ( V_223 [ V_211 ] , V_224 [ V_211 ] , V_225 , 0 , & V_110 ) ;
if ( V_96 < 0 )
return V_96 ;
if ( ( V_96 = F_85 ( V_110 , V_118 , V_183 [ V_211 ] , & V_2 ) ) < 0 ) {
F_101 ( V_110 ) ;
return V_96 ;
}
V_110 -> V_15 = V_2 ;
strcpy ( V_110 -> V_226 , L_4 ) ;
strcpy ( V_110 -> V_227 , L_16 ) ;
strcat ( V_110 -> V_227 , V_2 -> V_101 ? L_17 : L_18 ) ;
sprintf ( V_110 -> V_228 , L_19 ,
V_110 -> V_227 , V_2 -> V_11 , V_2 -> V_84 ) ;
if ( V_2 -> V_183 & V_184 )
goto V_229;
...
if ( ( V_96 = F_103 ( V_110 , F_7 ( V_2 , V_234 ) ,
F_7 ( V_2 , V_235 ) ,
V_236 , 1 , & V_219 ) ) < 0 ) {
F_101 ( V_110 ) ;
return V_96 ;
}
if ( ( V_96 = F_104 ( V_219 , 0 , 1 , NULL ) ) < 0 ) {
F_101 ( V_110 ) ;
return V_96 ;
}
V_229:
if ( ( V_96 = F_105 ( V_110 ) ) < 0 ) {
F_101 ( V_110 ) ;
return V_96 ;
}
F_106 ( V_118 , V_110 ) ;
...
static void T_6 F_107 ( struct V_200 * V_118 )
{
F_101 ( F_108 ( V_118 ) ) ;
F_106 ( V_118 , NULL ) ;
}
static int F_109 ( struct V_200 * V_118 , T_7 V_237 )
{
struct V_199 * V_110 = F_108 ( V_118 ) ;
...
F_112 ( V_2 -> V_13 ) ;
F_112 ( V_2 -> V_162 ) ;
for ( V_164 = 0 ; V_164 < F_12 ( V_239 ) ; V_164 ++ )
V_2 -> V_239 [ V_164 ] = F_3 ( V_2 -> V_11 + V_239 [ V_164 ] ) ;
F_82 ( V_118 ) ;
F_113 ( V_118 ) ;
F_114 ( V_118 , F_115 ( V_118 , V_237 ) ) ;
return 0 ;
}
static int F_116 ( struct V_200 * V_118 )
{
struct V_199 * V_110 = F_108 ( V_118 ) ;
struct V_1 * V_2 = V_110 -> V_15 ;
int V_164 ;
...
F_120 ( V_2 -> V_162 ) ;
for ( V_164 = 0 ; V_164 < F_12 ( V_239 ) ; V_164 ++ )
F_4 ( V_2 -> V_239 [ V_164 ] , V_2 -> V_11 + V_239 [ V_164 ] ) ;
F_110 ( V_110 , V_241 ) ;
return 0 ;
}
