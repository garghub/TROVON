...
V_81 -> V_129 ,
V_81 -> V_130 ,
( unsigned long long ) F_72 ( V_81 ) ,
F_69 ( V_109 ) ,
F_69 ( V_108 ) ,
( V_84 && V_98 ) ? V_84 -> V_131 : 0 ,
( V_84 && V_98 ) ? V_84 -> V_132 : 0 ,
( V_84 && V_98 ) ? V_84 -> V_133 : 0 ) ;
if ( V_84 )
F_48 ( V_84 ) ;
return 0 ;
}
int F_73 ( struct V_1 * V_2 , struct V_20 * V_21 ,
struct V_22 * V_22 , struct V_3 * V_81 )
{
...
struct V_83 * V_84 = F_46 ( V_81 ) ;
if ( V_84 ) {
V_11 = F_76 ( V_84 , & V_135 , & V_136 , & V_137 , & V_134 ) ;
F_48 ( V_84 ) ;
}
F_17 ( V_2 , L_30 ,
V_11 , V_134 , V_135 , V_136 , V_137 ) ;
return 0 ;
}
