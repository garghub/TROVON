...
static int T_6 F_77 ( struct V_164 * V_165 )
{
...
F_79 ( V_43 , & V_165 -> V_2 ) ;
F_80 ( V_165 , V_43 ) ;
V_167 = F_81 ( V_165 , V_172 , 0 ) ;
if ( ! V_167 ) {
F_15 ( & V_165 -> V_2 , L_20 ) ;
V_44 = - V_121 ;
goto free;
}
V_168 = F_82 ( & V_165 -> V_2 , V_167 -> V_173 ,
F_83 ( V_167 ) , V_167 -> V_124 ) ;
if ( ! V_168 ) {
F_15 ( & V_165 -> V_2 , L_21 ) ;
V_44 = - V_121 ;
goto free;
...
V_167 = F_81 ( V_165 , V_172 , 1 ) ;
if ( V_167 ) {
V_169 = F_82 ( & V_165 -> V_2 , V_167 -> V_173 ,
F_83 ( V_167 ) , V_167 -> V_124 ) ;
if ( ! V_169 ) {
F_15 ( & V_165 -> V_2 , L_22 ) ;
V_44 = - V_121 ;
...
V_60 -> V_43 = V_43 ;
V_60 -> V_176 = 0 ;
V_60 -> V_177 = F_83 ( V_168 ) ;
V_60 -> V_4 = F_84 ( & V_165 -> V_2 , V_43 -> V_125 ,
F_83 ( V_168 ) ) ;
if ( ! V_60 -> V_4 ) {
F_15 ( & V_165 -> V_2 , L_24 ) ;
V_44 = - V_121 ;
...
V_170 = F_86 (unsigned int,
128 , (netdev->mem_end - netdev->mem_start + 1) / ETHOC_BUFSIZ) ;
if ( V_170 < 4 ) {
V_44 = - V_135 ;
goto error;
}
V_60 -> V_27 = F_87 ( V_170 >> 1 ) ;
V_60 -> V_35 = V_170 - V_60 -> V_27 ;
F_48 ( & V_165 -> V_2 , L_27 ,
V_60 -> V_27 , V_60 -> V_35 ) ;
V_60 -> V_22 = F_88 ( & V_165 -> V_2 , V_170 * sizeof( void * ) , V_179 ) ;
if ( ! V_60 -> V_22 ) {
V_44 = - V_171 ;
goto error;
}
...
V_60 -> V_119 -> V_87 = F_94 ( sizeof( int ) * V_133 , V_179 ) ;
if ( ! V_60 -> V_119 -> V_87 ) {
V_44 = - V_171 ;
goto V_192;
}
...
static int T_9 F_105 ( struct V_164 * V_165 )
{
struct V_42 * V_43 = F_106 ( V_165 ) ;
...
static int F_109 ( struct V_164 * V_165 , T_10 V_200 )
{
return - V_138 ;
}
static int F_110 ( struct V_164 * V_165 )
{
return - V_138 ;
}
