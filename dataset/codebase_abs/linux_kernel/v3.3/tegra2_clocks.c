...
T_1 V_97 ;
V_22 >>= V_13 -> V_51 ;
V_13 -> V_29 = ( V_22 & V_98 ) ? V_30 : V_53 ;
if ( ! ( V_22 & V_99 ) )
V_13 -> V_29 = V_53 ;
if ( V_13 -> V_56 & V_100 ) {
V_97 = ( V_22 & V_101 ) >> V_102 ;
V_13 -> div = ( V_97 + 2 ) ;
V_13 -> V_55 = 2 ;
} else if ( V_13 -> V_56 & V_103 ) {
V_13 -> div = 2 ;
V_13 -> V_55 = 1 ;
} else {
V_13 -> div = 1 ;
...
F_33 ( & V_57 , V_56 ) ;
V_22 = F_3 ( V_13 -> V_27 ) ;
V_104 = V_22 >> V_13 -> V_51 ;
V_104 &= 0xFFFF ;
V_104 |= V_98 | V_99 ;
V_22 &= ~ ( 0xFFFF << V_13 -> V_51 ) ;
V_22 |= V_104 << V_13 -> V_51 ;
F_2 ( V_22 , V_13 -> V_27 ) ;
F_34 ( & V_57 , V_56 ) ;
return 0 ;
} else if ( V_13 -> V_56 & V_103 ) {
F_15 ( ! ( V_13 -> V_56 & V_105 ) ) ;
F_33 ( & V_57 , V_56 ) ;
V_22 = F_3 ( V_13 -> V_27 ) ;
V_22 &= ~ V_106 ;
F_2 ( V_22 , V_13 -> V_27 ) ;
...
static int F_59 ( struct V_12 * V_13 , unsigned long V_8 )
{
T_1 V_22 ;
T_1 V_104 ;
int V_9 ;
...
static long F_60 ( struct V_12 * V_13 , unsigned long V_8 )
{
int V_109 ;
unsigned long V_7 = F_29 ( V_13 -> V_40 ) ;
F_11 ( L_10 , V_6 , V_13 -> V_21 , V_8 ) ;
...
{
T_1 V_22 = F_3 ( V_13 -> V_27 ) ;
const struct V_25 * V_110 = NULL ;
const struct V_25 * V_26 ;
if ( V_13 -> V_56 & V_111 ) {
for ( V_26 = V_13 -> V_37 ; V_26 -> V_38 != NULL ; V_26 ++ ) {
if ( V_22 >> V_112 == V_26 -> V_39 )
V_110 = V_26 ;
}
F_15 ( ! V_110 ) ;
V_13 -> V_40 = V_110 -> V_38 ;
} else {
...
V_13 -> div = V_97 + 2 ;
V_13 -> V_55 = 2 ;
} else if ( V_13 -> V_56 & V_114 ) {
T_1 V_115 = V_22 & V_116 ;
V_13 -> div = V_115 + 1 ;
V_13 -> V_55 = 1 ;
} else {
V_13 -> div = 1 ;
...
V_13 -> V_29 = V_30 ;
if ( ! V_13 -> V_45 . V_117 . V_118 )
return;
if ( ! ( F_3 ( V_119 + F_62 ( V_13 ) ) &
F_63 ( V_13 ) ) )
V_13 -> V_29 = V_53 ;
if ( ! ( V_13 -> V_56 & V_120 ) )
if ( F_3 ( V_121 + F_62 ( V_13 ) ) &
F_63 ( V_13 ) )
V_13 -> V_29 = V_53 ;
}
...
return 0 ;
F_33 ( & V_57 , V_56 ) ;
V_122 = V_123 [ V_13 -> V_45 . V_117 . V_118 ] ++ ;
if ( V_122 > 1 )
goto V_48;
F_2 ( F_63 ( V_13 ) ,
V_124 + F_65 ( V_13 ) ) ;
if ( ! ( V_13 -> V_56 & V_120 ) && ! ( V_13 -> V_56 & V_125 ) )
F_2 ( F_63 ( V_13 ) ,
V_50 + F_65 ( V_13 ) ) ;
if ( V_13 -> V_56 & V_126 ) {
V_22 = F_3 ( V_13 -> V_27 ) ;
...
F_33 ( & V_57 , V_56 ) ;
if ( V_13 -> V_43 )
V_123 [ V_13 -> V_45 . V_117 . V_118 ] -- ;
if ( V_123 [ V_13 -> V_45 . V_117 . V_118 ] == 0 )
F_2 ( F_63 ( V_13 ) ,
V_127 + F_65 ( V_13 ) ) ;
F_34 ( & V_57 , V_56 ) ;
}
static void F_67 ( struct V_12 * V_13 , bool assert )
{
unsigned long V_128 = assert ? V_49 : V_50 ;
F_11 ( L_12 , V_6 ,
assert ? L_7 : L_8 , V_13 -> V_21 ) ;
F_15 ( ! V_13 -> V_45 . V_117 . V_118 ) ;
if ( ! ( V_13 -> V_56 & V_120 ) )
F_2 ( F_63 ( V_13 ) ,
V_128 + F_65 ( V_13 ) ) ;
}
static int F_68 ( struct V_12 * V_13 , struct V_12 * V_42 )
{
T_1 V_22 ;
const struct V_25 * V_26 ;
...
static int F_69 ( struct V_12 * V_13 , unsigned long V_8 )
{
T_1 V_22 ;
int V_109 ;
unsigned long V_7 = F_29 ( V_13 -> V_40 ) ;
...
static long F_70 ( struct V_12 * V_13 ,
unsigned long V_8 )
{
int V_109 ;
unsigned long V_7 = F_29 ( V_13 -> V_40 ) ;
...
if ( V_109 < 0 )
return V_109 ;
return F_43 ( V_7 , V_109 + 1 ) ;
}
return - V_10 ;
}
void F_71 ( struct V_12 * V_13 , int V_130 )
{
T_1 V_27 ;
unsigned long V_56 ;
F_33 ( & V_13 -> V_131 , V_56 ) ;
V_130 = F_72 ( V_130 , 0 , 15 ) ;
V_27 = F_3 ( V_13 -> V_27 ) ;
V_27 &= ~ V_132 ;
V_27 |= V_133 ;
V_27 |= V_130 << V_134 ;
F_2 ( V_27 , V_13 -> V_27 ) ;
F_34 ( & V_13 -> V_131 , V_56 ) ;
}
...
static long F_75 ( struct V_12 * V_13 , unsigned long V_8 )
{
long V_135 = V_8 ;
V_135 = F_76 ( V_135 ) ;
if ( V_135 < 0 )
return V_13 -> V_94 ;
F_15 ( V_135 != F_70 ( V_13 , V_135 ) ) ;
return V_135 ;
}
...
static int F_88 ( struct V_12 * V_136 )
{
struct V_12 * V_13 ;
unsigned long V_8 = V_136 -> V_137 ;
F_89 (c, &bus->shared_bus_list, u.shared_bus_user.node)
if ( V_13 -> V_45 . V_138 . V_139 )
V_8 = F_90 ( V_13 -> V_45 . V_138 . V_8 , V_8 ) ;
if ( V_8 == F_74 ( V_136 ) )
return 0 ;
return F_91 ( V_136 , V_8 ) ;
}
static void F_92 ( struct V_12 * V_13 )
{
unsigned long V_56 ;
V_13 -> V_94 = V_13 -> V_40 -> V_94 ;
V_13 -> V_45 . V_138 . V_8 = V_13 -> V_40 -> V_94 ;
V_13 -> V_29 = V_53 ;
V_13 -> V_140 = true ;
F_33 ( & V_13 -> V_40 -> V_131 , V_56 ) ;
F_93 ( & V_13 -> V_45 . V_138 . V_141 ,
& V_13 -> V_40 -> V_142 ) ;
F_34 ( & V_13 -> V_40 -> V_131 , V_56 ) ;
}
...
int V_44 ;
long V_135 = V_8 ;
V_135 = F_95 ( V_13 -> V_40 , V_135 ) ;
if ( V_135 < 0 )
return V_135 ;
F_33 ( & V_13 -> V_40 -> V_131 , V_56 ) ;
V_13 -> V_45 . V_138 . V_8 = V_135 ;
V_44 = F_88 ( V_13 -> V_40 ) ;
F_34 ( & V_13 -> V_40 -> V_131 , V_56 ) ;
return V_44 ;
}
...
{
int V_58 ;
struct V_25 * V_26 = V_143 ;
const struct V_144 * V_145 = V_146 ;
struct V_147 * V_148 ;
for ( V_58 = 0 ; V_145 -> V_21 ; V_58 ++ , V_26 ++ , V_145 ++ ) {
V_26 -> V_38 = F_101 ( V_145 -> V_21 ) ;
if ( ! V_26 -> V_38 )
F_4 ( L_14 , V_6 ,
V_145 -> V_21 ) ;
V_26 -> V_39 = V_145 -> V_39 ;
}
V_148 = V_149 ;
for ( V_58 = 0 ; V_58 < F_102 ( V_149 ) ; V_58 ++ , V_148 ++ ) {
F_103 ( V_148 -> V_12 ) ;
F_104 ( V_148 ) ;
}
}
...
F_103 ( V_13 ) ;
F_106 ( & V_13 -> V_142 ) ;
if ( ! V_13 -> V_148 . V_150 && ! V_13 -> V_148 . V_151 )
V_13 -> V_148 . V_151 = V_13 -> V_21 ;
V_13 -> V_148 . V_12 = V_13 ;
F_104 ( & V_13 -> V_148 ) ;
}
void T_3 F_107 ( void )
{
int V_58 ;
struct V_12 * V_13 ;
for ( V_58 = 0 ; V_58 < F_102 ( V_152 ) ; V_58 ++ )
F_105 ( V_152 [ V_58 ] ) ;
for ( V_58 = 0 ; V_58 < F_102 ( V_153 ) ; V_58 ++ )
F_105 ( & V_153 [ V_58 ] ) ;
for ( V_58 = 0 ; V_58 < F_102 ( V_154 ) ; V_58 ++ ) {
V_13 = F_101 ( V_154 [ V_58 ] . V_21 ) ;
if ( ! V_13 ) {
F_4 ( L_15 , V_6 ,
V_154 [ V_58 ] . V_21 ) ;
continue;
}
V_154 [ V_58 ] . V_148 . V_12 = V_13 ;
F_104 ( & V_154 [ V_58 ] . V_148 ) ;
}
F_100 () ;
}
void F_108 ( void )
{
unsigned long V_155 , V_58 ;
T_1 * V_156 = V_157 ;
* V_156 ++ = F_3 ( V_15 ) & V_158 ;
* V_156 ++ = F_3 ( V_159 . V_27 + V_71 ) ;
* V_156 ++ = F_3 ( V_159 . V_27 + F_51 ( & V_159 ) ) ;
* V_156 ++ = F_3 ( V_160 . V_27 + V_71 ) ;
* V_156 ++ = F_3 ( V_160 . V_27 + F_51 ( & V_160 ) ) ;
* V_156 ++ = F_3 ( V_161 . V_27 + V_71 ) ;
* V_156 ++ = F_3 ( V_161 . V_27 + F_51 ( & V_161 ) ) ;
* V_156 ++ = F_3 ( V_162 . V_27 + V_71 ) ;
* V_156 ++ = F_3 ( V_162 . V_27 + F_51 ( & V_162 ) ) ;
* V_156 ++ = F_3 ( V_163 . V_27 + V_71 ) ;
* V_156 ++ = F_3 ( V_163 . V_27 + F_51 ( & V_163 ) ) ;
* V_156 ++ = F_3 ( V_164 . V_27 ) ;
* V_156 ++ = F_3 ( V_165 . V_27 ) ;
* V_156 ++ = F_3 ( V_166 . V_27 ) ;
* V_156 ++ = F_3 ( V_167 . V_27 ) ;
* V_156 ++ = F_3 ( V_167 . V_27 + V_41 ) ;
* V_156 ++ = F_3 ( V_168 . V_27 ) ;
* V_156 ++ = F_3 ( V_168 . V_27 + V_41 ) ;
* V_156 ++ = F_3 ( V_169 . V_27 ) ;
* V_156 ++ = F_3 ( V_170 . V_27 ) ;
for ( V_155 = V_171 ; V_155 <= V_172 ;
V_155 += 4 ) {
if ( V_155 == V_173 )
continue;
* V_156 ++ = F_3 ( V_155 ) ;
...
V_155 = V_121 ;
for ( V_58 = 0 ; V_58 < V_174 ; V_58 ++ , V_155 += 4 )
* V_156 ++ = F_3 ( V_155 ) ;
V_155 = V_119 ;
for ( V_58 = 0 ; V_58 < V_175 ; V_58 ++ , V_155 += 4 )
* V_156 ++ = F_3 ( V_155 ) ;
* V_156 ++ = F_3 ( V_176 ) ;
* V_156 ++ = F_3 ( V_177 ) ;
F_15 ( V_156 - V_157 != F_102 ( V_157 ) ) ;
}
void F_109 ( void )
{
unsigned long V_155 , V_58 ;
...
V_22 |= * V_156 ++ ;
F_2 ( V_22 , V_15 ) ;
F_2 ( * V_156 ++ , V_159 . V_27 + V_71 ) ;
F_2 ( * V_156 ++ , V_159 . V_27 + F_51 ( & V_159 ) ) ;
F_2 ( * V_156 ++ , V_160 . V_27 + V_71 ) ;
F_2 ( * V_156 ++ , V_160 . V_27 + F_51 ( & V_160 ) ) ;
F_2 ( * V_156 ++ , V_161 . V_27 + V_71 ) ;
F_2 ( * V_156 ++ , V_161 . V_27 + F_51 ( & V_161 ) ) ;
F_2 ( * V_156 ++ , V_162 . V_27 + V_71 ) ;
F_2 ( * V_156 ++ , V_162 . V_27 + F_51 ( & V_162 ) ) ;
F_2 ( * V_156 ++ , V_163 . V_27 + V_71 ) ;
F_2 ( * V_156 ++ , V_163 . V_27 + F_51 ( & V_163 ) ) ;
F_45 ( 1000 ) ;
F_2 ( * V_156 ++ , V_164 . V_27 ) ;
F_2 ( * V_156 ++ , V_165 . V_27 ) ;
F_2 ( * V_156 ++ , V_166 . V_27 ) ;
F_2 ( * V_156 ++ , V_167 . V_27 ) ;
F_2 ( * V_156 ++ , V_167 . V_27 + V_41 ) ;
F_2 ( * V_156 ++ , V_168 . V_27 ) ;
F_2 ( * V_156 ++ , V_168 . V_27 + V_41 ) ;
F_2 ( * V_156 ++ , V_169 . V_27 ) ;
F_2 ( * V_156 ++ , V_170 . V_27 ) ;
F_2 ( 0xbffffff9ul , V_119 ) ;
F_2 ( 0xfefffff7ul , V_119 + 4 ) ;
F_2 ( 0x77f01bfful , V_119 + 8 ) ;
F_110 () ;
for ( V_155 = V_171 ; V_155 <= V_172 ;
V_155 += 4 ) {
if ( V_155 == V_173 )
