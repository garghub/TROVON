...
static int F_20 ( struct V_72 * V_7 ,
struct V_3 * V_4 )
{
...
T_1 * V_9 = V_6 -> V_10 ;
int V_22 ;
V_2 = F_30 ( sizeof( struct V_1 ) , V_76 ) ;
if ( ! V_2 )
return - V_32 ;
V_9 -> V_40 = V_2 ;
V_2 -> V_7 . V_77 = & V_78 ;
...
int V_22 ;
T_1 * V_9 = V_6 -> V_10 ;
struct V_81 * V_82 = & V_6 -> V_51 ;
struct V_83 * V_84 ;
V_22 = F_39 ( & V_9 -> V_40 -> V_7 ) ;
if ( V_22 )
F_40 ( L_5 ) ;
F_41 (plane, &config->plane_list, head)
V_84 -> V_77 -> V_85 ( V_84 ) ;
}
