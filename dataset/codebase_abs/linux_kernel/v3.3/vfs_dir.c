...
F_2 ( & V_38 ) ;
V_24 = F_13 ( V_23 -> V_44 , V_21 -> V_30 + V_21 -> V_33 ,
...
V_18 -> V_47 , F_15 ( & V_38 . V_51 ) , F_1 ( & V_38 ) ) ;
F_14 ( & V_38 ) ;
if ( V_37 ) {
V_24 = 0 ;
goto V_48;
...
while ( V_21 -> V_33 < V_21 -> V_34 ) {
V_24 = F_19 ( V_23 -> V_44 , V_21 -> V_30 + V_21 -> V_33 ,
V_21 -> V_34 - V_21 -> V_33 ,
& V_53 ) ;
if ( V_24 < 0 ) {
F_10 ( V_40 , L_2 , V_24 ) ;
...
int F_20 ( struct V_58 * V_58 , struct V_17 * V_18 )
{
struct V_22 * V_23 ;
V_23 = V_18 -> V_25 ;
F_10 ( V_40 , L_3 ,
V_58 , V_18 , V_23 ? V_23 -> V_23 : - 1 ) ;
if ( V_23 )
F_21 ( V_23 ) ;
return 0 ;
}
