...
if ( V_47 == V_60 || V_47 == V_61 ) {
V_53 = V_55 ? V_63 : 0 ;
V_53 |= V_54 & 0x01 ? V_64 : 0 ;
V_53 |= V_54 & 0x02 ? V_65 : 0 ;
V_53 |= V_54 & 0x04 ? V_66 : 0 ;
} else {
V_53 = V_55 ? V_67 : 0 ;
V_53 |= V_54 & 0x01 ? V_68 : 0 ;
V_53 |= V_54 & 0x02 ? V_69 : 0 ;
V_53 |= V_54 & 0x04 ? V_70 : 0 ;
}
V_50 = F_78 ( V_45 ) ;
V_49 = V_14 + V_50 ;
if ( V_47 == V_60 ) {
...
* ( V_49 + V_16 ) = ( V_46 & 0xFF000000 ) | V_71 |
V_72 | V_73 | V_74 |
V_63 | V_75 | V_53 ;
}
if ( V_47 == V_61 )
* V_49 = ( V_46 & 0xFFF00000 ) | V_72 | V_73 | V_75 |
V_74 | V_63 | V_53 ;
if ( ( V_47 == V_23 || V_47 == V_62 ) && ( * V_49 ) == 0 ) {
unsigned long * V_76 ;
V_76 = ( unsigned long * ) F_63 ( V_77 ,
F_64 ( V_23 ) ) ;
if ( ! V_76 ) {
F_77 ( L_3 ) ;
V_3 = - V_34 ;
...
memset ( V_76 , 0 , V_23 ) ;
* V_49 = ( ( ( ( int ) F_72 ( V_76 ) ) & V_22 ) | V_20 ) ;
}
V_21 = ( unsigned long * ) F_9 ( ( ( * V_49 ) & V_22 ) ) ;
V_52 = F_79 ( V_45 ) ;
V_51 = V_21 + V_52 ;
if ( V_47 == V_23 )
* V_51 = ( V_46 & V_78 ) | V_79 | V_80 | V_81 |
V_67 | V_82 | V_53 ;
if ( V_47 == V_62 ) {
int V_16 ;
for ( V_16 = 0 ; V_16 < 16 ; V_16 ++ )
* ( V_51 + V_16 ) = ( V_46 & V_83 ) | V_79 |
V_81 | V_80 | V_67 | V_84 | V_53 ;
}
V_3 = F_5 ( V_8 ) ;
V_5:
F_70 ( & V_36 , V_35 ) ;
...
static T_3 F_80 ( struct V_7 * V_8 , unsigned long V_45 ,
T_3 V_47 )
{
struct V_9 * V_10 ;
unsigned long V_35 ;
...
if ( V_47 == V_23 )
* V_51 = 0 ;
if ( V_47 == V_23 || V_47 == V_62 ) {
int V_85 = 0 ;
for ( V_16 = 0 ; V_16 < V_86 ; V_16 ++ )
if ( V_21 [ V_16 ] )
V_85 = 1 ;
if ( ! V_85 ) {
...
goto V_5;
F_14 ( V_27 , V_29 , 0 ) ;
F_83 ( V_27 , V_29 , V_45 & V_89 ) ;
V_87 = F_84 ( V_27 , V_29 ) ;
if ( F_85 ( V_27 , V_29 ) )
V_3 = ( V_87 & 0xFF000000 ) | ( V_45 & 0x00FFFFFF ) ;
else
V_3 = ( V_87 & 0xFFFFF000 ) | ( V_45 & 0x00000FFF ) ;
if ( F_86 ( V_27 , V_29 ) )
V_3 = 0 ;
F_4 ( V_11 ) ;
V_5:
...
{
unsigned int V_91 = F_89 ( V_27 , V_29 ) ;
F_90 ( L_6 ,
...
( V_91 & 0x40 ) ? L_14 : L_9 ,
( V_91 & 0x80 ) ? L_15 : L_9 ,
( V_91 & 0x10000 ) ? L_16 : L_9 ,
( V_91 & 0x40000000 ) ? L_17 : L_9 ,
( V_91 & 0x80000000 ) ? L_18 : L_9 ) ;
F_90 ( L_19 ,
...
static int T_5 F_104 ( int V_95 , int V_96 , int V_97 , int V_98 )
{
int V_16 = 0 ;
unsigned int V_30 = 0 ;
unsigned int V_31 = 0 ;
...
V_102 = F_105 ( V_30 , V_16 ) ;
V_101 = F_106 ( V_30 , V_16 ) ;
V_99 = F_107 ( V_31 , V_16 ) ;
V_100 = F_108 ( V_31 , V_16 ) ;
if ( V_95 == V_99 && V_96 == V_100 && V_101 == V_97 && V_102 == V_98 )
return V_16 ;
}
return - V_103 ;
}
...
{
V_57 [ V_104 ] =
F_104 ( V_105 , V_105 , V_106 , 1 ) ;
V_57 [ V_107 ] =
F_104 ( V_108 , V_108 , V_106 , 1 ) ;
V_57 [ V_109 ] =
F_104 ( V_110 , V_110 , V_106 , 1 ) ;
V_57 [ V_111 ] =
F_104 ( V_112 , V_112 , V_106 , 1 ) ;
}
