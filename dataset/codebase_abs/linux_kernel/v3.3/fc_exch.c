...
V_30 -> V_50 = V_50 ;
V_30 -> V_103 = V_103 ;
V_30 -> V_36 = F_127 ( 2 , V_236 ) ;
if ( ! V_30 -> V_36 )
goto V_237;
V_234 = ( V_30 -> V_103 - V_30 -> V_50 + 1 ) / ( V_104 + 1 ) ;
V_30 -> V_97 = V_234 - 1 ;
...
{
if ( ! V_62 -> V_68 . V_241 )
V_62 -> V_68 . V_241 = F_43 ;
if ( ! V_62 -> V_68 . V_242 )
V_62 -> V_68 . V_242 = F_44 ;
if ( ! V_62 -> V_68 . V_243 )
V_62 -> V_68 . V_243 = F_110 ;
if ( ! V_62 -> V_68 . V_244 )
V_62 -> V_68 . V_244 = F_35 ;
if ( ! V_62 -> V_68 . V_245 )
V_62 -> V_68 . V_245 = F_74 ;
if ( ! V_62 -> V_68 . V_246 )
V_62 -> V_68 . V_246 = F_64 ;
if ( ! V_62 -> V_68 . V_247 )
V_62 -> V_68 . V_247 = F_103 ;
if ( ! V_62 -> V_68 . V_248 )
V_62 -> V_68 . V_248 = F_48 ;
if ( ! V_62 -> V_68 . V_249 )
V_62 -> V_68 . V_249 = F_89 ;
if ( ! V_62 -> V_68 . V_250 )
V_62 -> V_68 . V_250 = F_90 ;
return 0 ;
}
int F_141 ( void )
{
V_236 = F_142 ( L_20 , sizeof( struct V_6 ) ,
0 , V_251 , NULL ) ;
if ( ! V_236 )
return - V_77 ;
V_104 = 1 ;
