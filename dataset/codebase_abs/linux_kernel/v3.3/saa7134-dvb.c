...
case V_241 :
case V_242 :
V_86 -> V_27 . V_88 = F_33 ( V_243 ,
& V_244 , & V_2 -> V_46 ) ;
if ( V_86 -> V_27 . V_88 ) {
if ( F_33 ( V_245 , V_86 -> V_27 . V_88 ,
& V_246 , & V_2 -> V_46 ) == NULL ) {
F_15 ( L_33 ,
V_7 ) ;
}
...
if ( ! V_86 -> V_27 . V_88 )
goto V_139;
V_9 = F_33 ( V_272 , V_86 -> V_27 . V_88 , & V_270 ) ;
if ( ! V_9 ) {
F_43 ( V_105 L_37 ,
V_2 -> V_56 ) ;
goto V_139;
...
V_86 -> V_27 . V_88 -> V_273 = F_46 ;
V_100 = F_47 ( & V_2 -> V_87 , V_274 , V_2 ,
& V_2 -> V_57 -> V_2 , V_275 , 0 , NULL ) ;
if ( ! V_100 ) {
