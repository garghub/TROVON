...
V_4 -> V_7 = V_32 -> V_38 ;
snprintf ( V_4 -> V_39 , sizeof( V_4 -> V_39 ) , L_4 , V_30 + 1 ) ;
V_4 -> V_40 . V_39 = V_4 -> V_39 ;
V_4 -> V_40 . V_30 = V_30 ;
V_4 -> V_40 . V_41 = & V_42 ;
V_4 -> V_40 . type = V_43 ;
V_4 -> V_40 . V_44 = V_45 ;
V_4 -> V_20 = F_18 ( & V_4 -> V_40 , & V_24 -> V_25 ,
V_28 -> V_4 [ V_30 ] , V_4 , NULL ) ;
if ( F_19 ( V_4 -> V_20 ) ) {
V_6 = F_20 ( V_4 -> V_20 ) ;
F_16 ( V_5 -> V_25 , L_5 ,
V_30 + 1 , V_6 ) ;
...
static T_3 int F_25 ( struct V_23 * V_24 )
{
struct V_3 * V_4 = F_26 ( V_24 ) ;
F_23 ( V_24 , NULL ) ;
F_27 ( F_21 ( V_24 , 0 ) , V_4 ) ;
F_24 ( V_4 -> V_20 ) ;
return 0 ;
}
