...
{
struct V_51 * V_52 = V_26 -> V_52 -> V_51 ;
struct V_49 * V_50 = V_26 -> V_50 ;
F_39 ( V_50 , V_53 ,
V_52 -> V_54 , V_55 , ( 4096 * 1024 ) - 1 ) ;
return 0 ;
}
static int T_3 F_40 ( struct V_56 * V_57 )
{
struct V_1 * V_58 ;
V_58 = F_41 ( & V_57 -> V_54 ,
2 * sizeof( struct V_1 ) ,
...
return - V_22 ;
F_42 ( V_57 , V_58 ) ;
return F_43 ( & V_57 -> V_54 , & V_60 ) ;
}
static int T_4 F_44 ( struct V_56 * V_57 )
{
F_45 ( & V_57 -> V_54 ) ;
return 0 ;
}
