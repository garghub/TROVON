...
ASSERT ( ( F_26 ( & V_9 -> V_26 ) & 0xffff0000 ) != 0x6b6b0000 ) ;
#endif
if ( V_9 -> V_27 . V_48 == V_49 &&
V_38 != V_11 -> V_11 . V_50
) {
F_32 ( L_12 , V_9 -> V_27 . V_43 ) ;
F_18 ( V_11 , & V_41 ) ;
F_33 ( V_11 , V_9 ) ;
F_20 ( V_11 , V_41 ) ;
}
if ( V_9 -> V_23 != V_9 -> V_51 )
F_34 ( V_9 -> V_23 ) ;
V_9 -> V_23 = NULL ;
...
static void F_41 ( struct V_1 * V_38 )
{
struct V_8 * V_9 ;
struct V_2 * V_11 ;
ASSERT ( V_38 ) ;
...
#endif
F_42 ( V_9 -> V_27 . V_39 ,
V_9 -> V_27 . V_39 -> V_55 , > , 0 ) ;
if ( F_43 ( & V_9 -> V_26 ) ) {
F_32 ( L_13 , V_9 -> V_27 . V_43 ) ;
...
V_11 = F_2 ( V_3 , struct V_10 , V_11 ) ;
F_18 ( V_11 , & V_41 ) ;
F_46 ( & V_11 -> V_57 -> V_58 -> V_59 ) ;
V_42 = F_47 ( V_11 -> V_57 -> V_58 ) ;
F_48 ( & V_11 -> V_57 -> V_58 -> V_59 ) ;
F_20 ( V_11 , V_41 ) ;
if ( V_42 == - V_60 )
F_49 ( V_11 ,
L_15
...
if ( ! V_9 -> V_23 )
return - V_46 ;
ASSERT ( F_50 ( V_9 -> V_23 -> V_67 -> V_68 ) ) ;
F_51 ( & V_9 -> V_27 , V_63 ) ;
V_64 = F_52 ( V_9 -> V_23 -> V_67 ) ;
if ( V_64 == V_63 )
return 0 ;
F_18 ( V_11 , & V_41 ) ;
F_53 ( & V_9 -> V_23 -> V_67 -> V_69 ) ;
if ( V_64 & ~ V_70 && V_63 > V_64 ) {
F_32 ( L_18 , V_64 ) ;
V_62 . V_71 = V_72 ;
V_62 . V_73 = V_64 & V_70 ;
V_42 = F_54 ( V_9 -> V_23 , & V_62 ) ;
if ( V_42 < 0 )
goto V_74;
}
V_62 . V_71 = V_72 ;
...
static void F_57 ( struct V_2 * V_11 )
{
F_3 ( L_11 ) ;
}
