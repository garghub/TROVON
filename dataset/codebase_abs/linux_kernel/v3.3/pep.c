...
int V_69 , V_194 ;
if ( ( V_191 -> V_193 & ~ ( V_195 | V_196 | V_197 |
V_198 ) ) ||
! ( V_191 -> V_193 & V_196 ) )
return - V_62 ;
...
if ( ! V_2 )
return V_69 ;
F_8 ( V_2 , V_199 + 3 + V_31 -> V_142 ) ;
V_69 = F_99 ( F_100 ( V_2 , V_15 ) , V_191 -> V_200 , V_15 ) ;
if ( V_69 < 0 )
goto V_201;
F_65 ( V_13 ) ;
V_192 = F_101 ( V_13 , V_135 & V_195 ) ;
...
struct V_190 * V_191 , T_4 V_15 , int V_216 ,
int V_135 , int * V_217 )
{
struct V_1 * V_2 ;
int V_69 ;
if ( V_135 & ~ ( V_218 | V_219 | V_220 | V_195 | V_221 |
V_197 | V_198 ) )
return - V_62 ;
if ( F_72 ( 1 << V_13 -> V_50 & ( V_126 | V_125 ) ) )
return - V_202 ;
if ( ( V_135 & V_218 ) || F_36 ( V_13 , V_166 ) ) {
struct V_30 * V_31 = F_18 ( V_13 ) ;
if ( V_135 & V_219 )
return - V_62 ;
V_2 = F_117 ( & V_31 -> V_85 ) ;
...
V_2 = F_70 ( V_13 , V_135 , V_216 , & V_69 ) ;
F_65 ( V_13 ) ;
if ( V_2 == NULL ) {
...
V_15 = V_2 -> V_15 ;
V_69 = F_119 ( V_2 , 0 , V_191 -> V_200 , V_15 ) ;
if ( ! V_69 )
V_69 = ( V_135 & V_220 ) ? V_2 -> V_15 : V_15 ;
F_120 ( V_13 , V_2 ) ;
return V_69 ;
}
