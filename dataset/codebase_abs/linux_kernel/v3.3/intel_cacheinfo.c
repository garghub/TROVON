...
if ( ! F_43 ( V_117 ) )
continue;
F_44 ( V_117 , V_54 -> V_72 ) ;
}
}
} else if ( ( V_84 -> V_51 == 0x15 ) && ( ( V_55 == 1 ) || ( V_55 == 2 ) ) ) {
V_67 = 1 ;
...
for ( V_66 = 0 ; V_66 < V_96 ; V_66 ++ )
F_48 ( V_64 , V_66 ) ;
F_51 ( F_38 ( V_118 , V_64 ) ) ;
F_38 ( V_118 , V_64 ) = NULL ;
}
static void T_1 F_52 ( void * V_120 )
{
...
if ( V_96 == 0 )
return - V_121 ;
F_38 ( V_118 , V_64 ) = F_55 (
sizeof( struct V_59 ) * V_96 , V_122 ) ;
if ( F_38 ( V_118 , V_64 ) == NULL )
return - V_123 ;
F_56 ( V_64 , F_52 , & V_97 , true ) ;
if ( V_97 ) {
F_51 ( F_38 ( V_118 , V_64 ) ) ;
F_38 ( V_118 , V_64 ) = NULL ;
}
...
int type , char * V_60 )
{
T_5 V_124 = F_59 ( V_60 + V_125 - 1 , V_125 ) - V_60 ;
int V_102 = 0 ;
if ( V_124 > 1 ) {
...
static struct V_129 * * T_1 F_65 ( void )
{
...
if ( F_16 ( V_75 ) )
V_102 += 1 ;
V_130 = F_55 ( V_102 * sizeof ( struct V_129 * ) , V_122 ) ;
if ( V_130 == NULL )
return V_130 = V_131 ;
...
static T_3 F_66 ( struct V_135 * V_136 , struct V_129 * V_133 , char * V_60 )
{
struct V_137 * V_138 = F_67 ( V_133 ) ;
struct V_139 * V_54 = F_68 ( V_136 ) ;
T_3 V_67 ;
V_67 = V_138 -> F_66 ?
V_138 -> F_66 ( F_42 ( V_54 -> V_64 , V_54 -> V_55 ) ,
V_60 , V_54 -> V_64 ) :
0 ;
return V_67 ;
}
static T_3 F_69 ( struct V_135 * V_136 , struct V_129 * V_133 ,
const char * V_60 , T_4 V_68 )
{
struct V_137 * V_138 = F_67 ( V_133 ) ;
struct V_139 * V_54 = F_68 ( V_136 ) ;
T_3 V_67 ;
V_67 = V_138 -> F_69 ?
V_138 -> F_69 ( F_42 ( V_54 -> V_64 , V_54 -> V_55 ) ,
V_60 , V_68 , V_54 -> V_64 ) :
0 ;
return V_67 ;
}
...
return V_69 ;
F_38 ( V_140 , V_64 ) =
F_55 ( sizeof( struct V_135 ) , V_122 ) ;
if ( F_53 ( F_38 ( V_140 , V_64 ) == NULL ) )
goto V_142;
F_38 ( V_141 , V_64 ) = F_55 (
sizeof( struct V_139 ) * V_96 , V_122 ) ;
if ( F_53 ( F_38 ( V_141 , V_64 ) == NULL ) )
goto V_142;
return 0 ;
V_142:
F_70 ( V_64 ) ;
...
static int T_1 F_72 ( struct V_143 * V_144 )
{
...
V_148 . V_131 = F_65 () ;
#endif
V_97 = F_73 ( & ( V_146 -> V_136 ) ,
& V_148 ,
F_38 ( V_140 , V_64 ) ,
L_12 , V_66 ) ;
if ( F_53 ( V_97 ) ) {
for ( V_101 = 0 ; V_101 < V_66 ; V_101 ++ )
F_76 ( & ( F_74 ( V_64 , V_101 ) -> V_136 ) ) ;
F_76 ( F_38 ( V_140 , V_64 ) ) ;
F_70 ( V_64 ) ;
return V_97 ;
}
F_77 ( & ( V_146 -> V_136 ) , V_149 ) ;
}
F_46 ( V_64 , F_24 ( V_150 ) ) ;
F_77 ( F_38 ( V_140 , V_64 ) , V_149 ) ;
return 0 ;
}
static void T_1 F_78 ( struct V_143 * V_144 )
{
unsigned int V_64 = V_144 -> V_145 ;
unsigned long V_66 ;
if ( F_38 ( V_118 , V_64 ) == NULL )
return;
if ( ! F_79 ( V_64 , F_24 ( V_150 ) ) )
return;
F_49 ( V_64 , F_24 ( V_150 ) ) ;
for ( V_66 = 0 ; V_66 < V_96 ; V_66 ++ )
F_76 ( & ( F_74 ( V_64 , V_66 ) -> V_136 ) ) ;
F_76 ( F_38 ( V_140 , V_64 ) ) ;
F_70 ( V_64 ) ;
}
static int T_1 F_80 ( struct V_151 * V_152 ,
