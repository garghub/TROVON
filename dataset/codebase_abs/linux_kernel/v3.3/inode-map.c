...
goto V_29;
F_48 ( V_3 -> V_5 , L_2 ,
( T_1 ) ( unsigned long ) V_76 ,
V_76 -> V_89 , 1 ) ;
V_27:
V_77 = F_49 ( V_3 , V_12 ) ;
if ( F_27 ( V_77 ) && F_50 ( V_77 ) != - V_90 ) {
V_17 = F_50 ( V_77 ) ;
goto V_91;
}
if ( F_27 ( V_77 ) ) {
...
static int F_63 ( struct V_2 * V_3 , T_1 * V_23 )
{
struct V_11 * V_12 ;
int V_17 ;
struct V_13 * V_94 ;
...
int V_17 ;
F_4 ( & V_3 -> V_97 ) ;
if ( F_65 ( V_3 -> V_34 < V_24 ) ) {
V_17 = F_63 ( V_3 ,
& V_3 -> V_34 ) ;
if ( V_17 )
goto V_29;
}
if ( F_65 ( V_3 -> V_34 >= V_43 ) ) {
V_17 = - V_46 ;
goto V_29;
}
* V_23 = ++ V_3 -> V_34 ;
