...
memcpy ( & V_3 . V_68 , & V_3 . V_67 , 4 ) ;
V_66 = 4 ;
if ( F_26 ( 7 ) ) {
register unsigned long T_6 V_69 ( L_9 ) = V_70 / 64 - 1 ;
asm volatile(".insn s,0xb2b00000,%0"
: "=m" (S390_lowcore.stfle_fac_list), "+d" (reg0)
: : "cc");
V_66 = ( T_6 + 1 ) * 8 ;
}
memset ( ( char * ) V_3 . V_68 + V_66 , 0 ,
V_70 / 8 - V_66 ) ;
}
...
V_88 = V_21 + V_14 ;
V_87 = V_21 + V_14 + 1 ;
V_72 = F_40 ( V_87 , V_89 - V_14 - 1 ) ;
if ( V_72 ) {
if ( * V_87 == '=' )
memmove ( V_21 , V_87 + 1 , V_72 ) ;
else
* V_88 = ' ' ;
}
}
static inline int F_41 ( const char * V_90 )
{
int V_5 ;
