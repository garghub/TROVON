...
static int
F_3 ( struct V_1 * V_2 , T_1 V_8 , T_1 V_9 ,
struct V_10 * V_11 )
{
T_1 V_12 = 0 ;
int V_3 = 0 ;
...
V_25 -> V_31 = 0 ;
V_15 =
( T_2 ) ( ( V_11 -> V_32 & V_33 ) >> 8 ) ;
V_16 =
( T_2 ) ( ( V_11 -> V_34 & V_33 ) >> 8 ) ;
V_17 =
( T_2 ) ( ( V_11 -> V_35 & V_33 ) >> 8 ) ;
V_18 = F_4 ( V_16 , V_17 ) ;
...
V_25 -> V_44 > V_56 ) ) {
V_18 = V_25 -> V_45 - V_60 ;
V_25 -> V_45 = F_4 ( ( T_1 ) V_27 -> V_64 , V_18 ) ;
V_18 = V_25 -> V_62 - V_60 ;
V_25 -> V_62 =
...
static int
F_7 ( struct V_1 * V_2 , T_1 V_8 , T_1 V_9 )
{
T_1 V_18 ;
T_1 V_19 = V_8 * 200 * 1024 ;
T_1 V_20 = V_66 * V_9 ;
...
V_81 [ V_88 ] =
F_9 ( ( V_83 ) V_25 -> V_62 ) ;
V_81 [ V_89 ] = F_9 ( ( V_83 ) V_25 -> V_50 ) ;
V_81 [ V_90 ] = F_9 ( ( V_83 ) V_25 -> V_91 ) ;
V_81 [ V_92 ] =
F_9 ( V_25 -> V_93 ) ;
V_81 [ V_94 ] =
F_9 ( V_25 -> V_95 ) ;
V_81 [ V_96 ] = F_9 ( V_25 -> V_97 ) ;
F_5 ( L_15 ,
V_25 -> V_68 , V_25 -> V_71 ,
V_25 -> V_73 , V_25 -> V_75 ,
V_25 -> V_91 ) ;
...
void
F_13 ( struct V_1 * V_2 , void * V_119 )
{
T_1 V_9 ;
T_1 V_120 ;
T_1 V_121 ;
...
V_130 . V_35 =
F_17 ( V_11 -> V_35 ) ;
V_130 . V_43 = F_17 ( V_11 -> V_43 ) ;
V_130 . V_40 = F_17 ( V_11 -> V_40 ) ;
V_130 . V_41 = F_17 ( V_11 -> V_41 ) ;
F_16 ( & V_2 -> V_131 , V_105 ) ;
F_5 ( L_22 , V_9 ) ;
if ( ! V_9 ) {
F_5 ( L_23 ) ;
...
static void
F_21 ( struct V_1 * V_2 , T_1 * V_168 ,
V_83 V_169 , T_1 V_170 ,
T_2 V_171 )
{
int V_3 , V_112 ;
...
F_5 ( L_34 , V_25 -> V_172 [ 0 ] ,
V_25 -> V_172 [ 1 ] , V_25 -> V_172 [ 2 ] ) ;
if ( ! V_25 -> V_176 ) {
struct V_177 V_99 ;
V_25 -> V_176 = 1 ;
memset ( & V_99 , 0 , sizeof( V_99 ) ) ;
...
V_112 = F_22 ( V_2 , V_184 , sizeof( V_99 ) , & V_99 ) ;
if ( V_112 )
F_5 ( L_35 L_36 ) ;
V_25 -> V_185 = V_186 ;
}
...
void
F_23 ( struct V_1 * V_2 , void * V_187 )
{
...
F_15 ( & V_2 -> V_131 , V_105 ) ;
V_11 = & ( ( (struct V_132 * ) V_187 ) -> V_133 . V_134 ) ;
if ( V_11 -> V_135 != V_136 ) {
F_5 ( L_38 ) ;
F_16 ( & V_2 -> V_131 , V_105 ) ;
return;
}
V_198 = ! ! ( V_201 -> V_205 . V_105 & V_206 ) ;
V_196 = F_24 ( V_201 -> V_205 . V_207 ) ;
V_199 =
! ! ( ( (struct V_132 * ) V_187 ) ->
V_208 & V_209 ) ;
V_197 =
F_17 ( ( (struct V_132 * ) V_187 ) -> V_208 ) >> 16 ;
...
V_188 =
F_17 ( V_11 -> V_32 ) & V_210 ;
V_189 =
F_17 ( V_11 -> V_34 ) & V_210 ;
V_190 =
F_17 ( V_11 -> V_35 ) & V_210 ;
V_191 = F_17 ( V_11 -> V_211 ) & V_210 ;
V_192 = F_17 ( V_11 -> V_212 ) & V_210 ;
V_193 = F_17 ( V_11 -> V_213 ) & V_210 ;
F_16 ( & V_2 -> V_131 , V_105 ) ;
V_25 -> V_214 ++ ;
...
F_5 ( L_40 , V_196 , V_198 ,
V_25 -> V_214 ) ;
F_5 ( L_41 , V_191 , V_192 ,
V_193 ) ;
F_5 ( L_42 , V_188 , V_189 ,
V_190 ) ;
if ( V_25 -> V_214 != V_2 -> V_154 -> V_155 -> V_156 )
return;
F_19 ( V_2 , V_146 , V_25 ) ;
V_168 [ 0 ] =
V_25 -> V_188 / V_2 -> V_154 -> V_155 -> V_156 ;
V_168 [ 1 ] =
V_25 -> V_189 / V_2 -> V_154 -> V_155 -> V_156 ;
V_168 [ 2 ] =
V_25 -> V_190 / V_2 -> V_154 -> V_155 -> V_156 ;
for ( V_3 = 0 ; V_3 < V_159 ; V_3 ++ ) {
if ( ! V_25 -> V_162 [ V_3 ] &&
V_168 [ V_3 ] <= V_170 ) {
V_170 = V_168 [ V_3 ] ;
...
F_5 ( L_44 , V_170 ,
V_169 ) ;
F_21 ( V_2 , V_168 , V_169 ,
V_170 ,
F_18 ( V_2 -> V_154 -> V_163 ) ) ;
if ( V_2 -> V_154 -> V_215 -> V_216 -> V_217 )
V_2 -> V_154 -> V_215 -> V_216 -> V_217 ( V_2 ) ;
V_25 -> V_185 = V_218 ;
F_25 ( V_2 , false ) ;
}
void
...
{
int V_3 ;
memset ( & ( V_2 -> V_30 ) , 0 , sizeof( struct V_24 ) ) ;
memset ( & ( V_2 -> V_167 ) , 0 , sizeof( struct V_147 ) ) ;
for ( V_3 = 0 ; V_3 < V_159 ; V_3 ++ )
V_2 -> V_167 . V_172 [ V_3 ] =
V_174 ;
F_27 ( V_2 , V_106 , true ) ;
