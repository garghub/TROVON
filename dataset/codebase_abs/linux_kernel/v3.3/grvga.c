...
static int T_4 F_10 ( struct V_62 * V_63 )
{
struct V_3 * V_4 ;
int V_64 = - V_16 ;
unsigned long V_65 ;
...
V_4 -> V_14 = V_75 ;
V_4 -> V_47 = V_6 -> V_76 ;
V_4 -> V_77 = V_78 | V_79 | V_80 ;
V_4 -> V_14 . V_15 = V_68 ;
if ( ! F_14 ( V_63 -> V_81 [ 0 ] . V_82 , F_15 ( & V_63 -> V_81 [ 0 ] ) , L_10 ) ) {
F_12 ( & V_63 -> V_63 , L_11 ) ;
V_64 = - V_83 ;
goto V_71;
}
V_6 -> V_18 = F_16 ( & V_63 -> V_81 [ 0 ] , 0 ,
F_15 ( & V_63 -> V_81 [ 0 ] ) ,
L_10 ) ;
if ( ! V_6 -> V_18 ) {
F_12 ( & V_63 -> V_63 , L_12 ) ;
...
V_67 = F_22 ( & V_63 -> V_63 , ( void * ) V_65 , V_68 , V_92 ) ;
for ( V_90 = V_65 ;
V_90 < F_23 ( V_65 + V_68 ) ;
V_90 += V_93 ) {
F_24 ( F_25 ( V_90 ) ) ;
...
V_4 -> V_95 = ( char V_96 * ) V_65 ;
V_4 -> V_14 . V_51 = V_67 ;
V_4 -> V_14 . V_15 = V_68 ;
F_26 ( & V_63 -> V_63 , V_4 ) ;
F_27 ( & V_63 -> V_63 ,
L_17 ,
V_4 -> V_97 , V_4 -> V_2 . V_8 , V_4 -> V_2 . V_9 , V_4 -> V_2 . V_10 ,
V_68 >> 10 , V_4 -> V_95 ) ;
V_64 = F_28 ( V_4 ) ;
if ( V_64 < 0 ) {
F_12 ( & V_63 -> V_63 , L_18 ) ;
...
F_33 ( & V_4 -> V_84 ) ;
V_85:
F_34 ( & V_63 -> V_81 [ 0 ] , V_6 -> V_18 ,
F_15 ( & V_63 -> V_81 [ 0 ] ) ) ;
V_72:
F_30 ( V_63 -> V_81 [ 0 ] . V_82 , F_15 ( & V_63 -> V_81 [ 0 ] ) ) ;
V_71:
F_35 ( V_4 ) ;
return V_64 ;
}
static int T_5 F_36 ( struct V_62 * V_98 )
{
struct V_3 * V_4 = F_37 ( & V_98 -> V_63 ) ;
struct V_5 * V_6 = V_4 -> V_6 ;
if ( V_4 ) {
F_38 ( V_4 ) ;
F_33 ( & V_4 -> V_84 ) ;
F_34 ( & V_98 -> V_81 [ 0 ] , V_6 -> V_18 ,
F_15 ( & V_98 -> V_81 [ 0 ] ) ) ;
F_30 ( V_98 -> V_81 [ 0 ] . V_82 , F_15 ( & V_98 -> V_81 [ 0 ] ) ) ;
if ( ! V_6 -> V_94 ) {
F_30 ( V_4 -> V_14 . V_51 , V_4 -> V_14 . V_15 ) ;
F_31 ( V_4 -> V_95 ) ;
} else
F_32 ( ( void * ) V_4 -> V_95 ) ;
F_35 ( V_4 ) ;
