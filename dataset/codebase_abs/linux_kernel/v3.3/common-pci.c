...
F_37 ( & V_91 , & V_79 [ 0 ] ) ;
F_37 ( & V_92 , & V_79 [ 1 ] ) ;
F_38 ( & V_77 -> V_93 , & V_79 [ 0 ] ) ;
F_38 ( & V_77 -> V_93 , & V_79 [ 1 ] ) ;
V_94 = F_23 ;
V_95 = F_25 ;
return 1 ;
}
struct V_32 * T_7 F_39 ( int V_75 , struct V_76 * V_77 )
{
return F_40 ( NULL , V_77 -> V_96 , & V_97 , V_77 ,
& V_77 -> V_93 ) ;
}
int F_41 ( struct V_45 * V_46 , T_8 V_98 )
{
if ( V_98 >= V_48 - 1 )
return 0 ;
return - V_99 ;
