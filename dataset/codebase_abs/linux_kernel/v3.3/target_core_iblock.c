...
if ( V_107 > V_108 )
V_107 = V_108 ;
V_67 = F_53 ( V_109 , V_107 , V_15 -> V_33 ) ;
if ( ! V_67 ) {
F_3 ( L_34 ) ;
return NULL ;
}
F_4 ( L_35
L_36 , V_67 , V_59 -> V_110 , V_15 -> V_33 ) ;
F_4 ( L_37 , V_67 , V_59 -> V_111 ) ;
V_67 -> V_77 = V_15 -> V_45 ;
V_67 -> V_71 = V_59 ;
V_67 -> V_112 = F_50 ;
V_67 -> V_76 = & V_113 ;
V_67 -> V_114 = V_79 ;
F_54 ( & V_62 -> V_63 ) ;
F_4 ( L_38 , ( unsigned long long ) V_67 -> V_114 ) ;
F_4 ( L_39 ,
F_55 ( & V_62 -> V_63 ) ) ;
return V_67 ;
}
...
struct V_115 V_116 ;
struct V_117 * V_118 ;
T_1 V_119 , V_107 = V_59 -> V_110 ;
T_2 V_120 ;
struct V_121 V_122 ;
int V_123 ;
if ( V_59 -> V_124 == V_125 ) {
if ( V_21 -> V_47 -> V_48 . V_126 == 0 ||
( V_21 -> V_47 -> V_48 . V_127 > 0 &&
( V_70 -> V_128 & V_129 ) ) )
V_123 = V_130 ;
else
V_123 = V_131 ;
...
while ( F_60 ( V_67 , F_61 ( V_118 ) , V_118 -> V_137 , V_118 -> V_138 )
!= V_118 -> V_137 ) {
V_67 = F_52 ( V_59 , V_120 , V_107 ) ;
if ( ! V_67 )
goto V_139;
...
V_120 += V_118 -> V_137 >> V_140 ;
V_107 -- ;
}
F_62 ( & V_122 ) ;
while ( ( V_67 = F_63 ( & V_116 ) ) )
F_36 ( V_123 , V_67 ) ;
F_64 ( & V_122 ) ;
return 0 ;
V_139:
...
static void V_113 ( struct V_67 * V_67 , int V_68 )
{
struct V_58 * V_59 = V_67 -> V_71 ;
struct V_57 * V_143 = F_24 ( V_59 ) ;
if ( ! F_68 ( V_144 , & V_67 -> V_145 ) && ! V_68 )
V_68 = - V_146 ;
if ( V_68 != 0 ) {
F_3 ( L_42
L_43 , V_67 , V_68 ) ;
...
return;
F_4 ( L_44 ,
V_59 , V_67 , V_59 -> V_133 ,
( unsigned long long ) V_67 -> V_114 , V_68 ) ;
F_71 ( V_59 , ! F_55 ( & V_143 -> V_147 ) ) ;
}
