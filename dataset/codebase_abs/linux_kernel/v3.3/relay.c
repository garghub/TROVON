...
if ( ! V_142 -> V_139 )
return 0 ;
F_45 ( & V_27 -> V_151 . V_53 -> V_73 -> V_152 ) ;
do {
if ( ! F_85 ( V_4 , * V_149 ) )
break;
...
F_47 ( & V_27 -> V_151 . V_53 -> V_73 -> V_152 ) ;
return V_142 -> V_148 ;
}
static T_8 F_93 ( struct V_26 * V_27 ,
char T_11 * V_153 ,
T_2 V_139 ,
T_9 * V_149 )
{
...
V_142 . V_148 = 0 ;
V_142 . V_139 = V_139 ;
V_142 . V_146 . V_4 = V_153 ;
V_142 . error = 0 ;
return F_91 ( V_27 , V_149 , F_89 ,
NULL , & V_142 ) ;
}
static void F_94 ( struct V_3 * V_154 , int V_68 )
{
V_154 -> V_68 += V_68 ;
if ( V_154 -> V_68 >= V_154 -> V_6 -> V_96 ) {
F_74 ( V_154 -> V_6 , V_154 -> V_51 , 1 ) ;
V_154 -> V_68 %= V_154 -> V_6 -> V_96 ;
}
}
...
{
struct V_3 * V_154 ;
V_154 = (struct V_3 * ) F_96 ( V_4 -> V_12 ) ;
F_94 ( V_154 , V_4 -> V_158 ) ;
}
static void F_97 ( struct V_159 * V_160 , unsigned int V_38 )
{
}
static T_8 F_98 ( struct V_26 * V_161 ,
T_9 * V_149 ,
struct V_155 * V_156 ,
T_2 V_162 ,
unsigned int V_108 ,
int * V_163 )
{
unsigned int V_164 , V_165 , V_166 , V_167 , V_168 ;
struct V_3 * V_154 = V_161 -> V_97 ;
unsigned int V_96 = V_154 -> V_6 -> V_96 ;
T_12 V_169 = ( T_12 ) * V_149 ;
T_13 V_29 = ( T_13 ) V_154 -> V_6 -> V_29 ;
T_2 V_141 = ( T_2 ) F_99 ( V_169 , V_29 ) ;
T_2 V_130 = V_141 / V_96 ;
T_2 V_48 = V_154 -> V_48 [ V_130 ] ;
T_2 V_170 = V_130 * V_96 + V_96 - V_48 ;
struct V_12 * V_171 [ V_172 ] ;
...
T_8 V_145 ;
if ( V_154 -> V_54 == V_154 -> V_55 )
return 0 ;
if ( F_100 ( V_156 , & V_160 ) )
return - V_92 ;
if ( V_162 > ( V_96 - V_141 % V_96 ) )
V_162 = V_96 - V_141 % V_96 ;
V_167 = V_154 -> V_6 -> V_29 >> V_16 ;
V_164 = ( V_141 / V_20 ) % V_167 ;
V_165 = V_141 & ~ V_178 ;
V_168 = F_101 (unsigned int, subbuf_pages, pipe->buffers) ;
for ( V_166 = 0 ; V_160 . V_168 < V_168 ; V_160 . V_168 ++ ) {
unsigned int V_179 , V_180 , V_158 ;
unsigned int V_181 = V_141 + V_166 ;
if ( ! V_162 )
break;
V_179 = F_101 (unsigned long, len, PAGE_SIZE - poff) ;
V_158 = V_179 ;
V_160 . V_171 [ V_160 . V_168 ] = V_154 -> V_40 [ V_164 ] ;
V_160 . V_174 [ V_160 . V_168 ] . V_70 = V_165 ;
V_180 = V_181 + V_179 ;
if ( V_180 >= V_170 ) {
V_179 = V_170 - V_181 ;
V_158 = V_179 + V_48 ;
}
V_160 . V_174 [ V_160 . V_168 ] . V_162 = V_179 ;
V_160 . V_174 [ V_160 . V_168 ] . V_158 = V_158 ;
V_162 -= V_179 ;
V_166 += V_179 ;
V_165 = 0 ;
V_164 = ( V_164 + 1 ) % V_167 ;
...
if ( ! V_160 . V_168 )
goto V_182;
V_145 = * V_163 = F_102 ( V_156 , & V_160 ) ;
if ( V_145 < 0 || V_145 < V_166 )
goto V_182;
if ( V_141 + V_145 == V_170 )
V_145 += V_48 ;
V_182:
F_103 ( V_156 , & V_160 ) ;
return V_145 ;
}
static T_8 F_104 ( struct V_26 * V_161 ,
T_9 * V_149 ,
struct V_155 * V_156 ,
T_2 V_162 ,
unsigned int V_108 )
...
V_183 = 0 ;
while ( V_162 && ! V_183 ) {
V_145 = F_98 ( V_161 , V_149 , V_156 , V_162 , V_108 , & V_163 ) ;
if ( V_145 < 0 )
break;
else if ( ! V_145 ) {
if ( V_108 & V_184 )
