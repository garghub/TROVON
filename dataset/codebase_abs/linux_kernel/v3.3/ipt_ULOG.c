...
static void F_13 ( unsigned int V_20 ,
...
struct V_29 * V_30 ;
struct V_31 V_32 ;
unsigned int V_33 = F_14 ( V_25 -> V_34 ) - 1 ;
if ( V_25 -> V_35 == 0 || V_25 -> V_35 > V_5 -> V_36 )
V_28 = V_5 -> V_36 ;
else
V_28 = V_25 -> V_35 ;
V_16 = F_15 ( sizeof( * V_27 ) + V_28 ) ;
V_2 = & V_3 [ V_33 ] ;
F_8 ( & V_14 ) ;
if ( ! V_2 -> V_5 ) {
...
F_3 ( L_6 , V_2 -> V_6 , V_25 -> V_38 ) ;
V_30 = F_17 ( V_2 -> V_5 , 0 , V_2 -> V_6 , V_39 ,
sizeof( * V_27 ) + V_28 ) ;
V_2 -> V_6 ++ ;
V_27 = F_18 ( V_30 ) ;
if ( V_5 -> V_40 . V_41 == 0 )
...
V_27 -> V_42 = V_28 ;
V_32 = F_20 ( V_5 -> V_40 ) ;
F_21 ( V_32 . V_43 , & V_27 -> V_44 ) ;
F_21 ( V_32 . V_45 , & V_27 -> V_46 ) ;
F_21 ( V_5 -> V_47 , & V_27 -> V_47 ) ;
V_27 -> V_48 = V_20 ;
if ( V_26 != NULL )
...
V_5 -> V_50 != V_5 -> V_51 &&
V_22 -> V_49 <= V_52 ) {
memcpy ( V_27 -> V_53 , F_22 ( V_5 ) , V_22 -> V_49 ) ;
V_27 -> V_54 = V_22 -> V_49 ;
} else
V_27 -> V_54 = 0 ;
if ( V_22 )
strncpy ( V_27 -> V_55 , V_22 -> V_56 , sizeof( V_27 -> V_55 ) ) ;
else
V_27 -> V_55 [ 0 ] = '\0' ;
if ( V_23 )
strncpy ( V_27 -> V_57 , V_23 -> V_56 , sizeof( V_27 -> V_57 ) ) ;
else
V_27 -> V_57 [ 0 ] = '\0' ;
if ( F_23 ( V_5 , 0 , V_27 -> V_58 , V_28 ) < 0 )
F_24 () ;
if ( V_2 -> V_6 > 1 )
V_2 -> V_7 -> V_59 |= V_60 ;
V_2 -> V_7 = V_30 ;
if ( ! F_2 ( & V_2 -> V_4 ) ) {
V_2 -> V_4 . V_61 = V_62 + V_63 * V_64 / 100 ;
F_25 ( & V_2 -> V_4 ) ;
}
...
{
F_13 ( V_67 -> V_20 , V_5 , V_67 -> V_22 , V_67 -> V_23 ,
V_67 -> V_68 , NULL ) ;
return V_69 ;
}
...
F_13 ( V_20 , V_5 , V_22 , V_23 , & V_25 , V_26 ) ;
}
