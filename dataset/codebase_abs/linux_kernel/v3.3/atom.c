...
bool F_73 ( struct V_2 * V_3 , int V_5 , T_3 * V_168 ,
T_3 * V_169 )
{
int V_171 = V_5 * 2 + 4 ;
...
{
int V_5 = F_75 ( V_174 , V_175 ) ;
T_4 V_176 ;
int V_177 = 0 ;
struct V_178 * V_179 ;
if ( F_72 ( V_3 , V_5 , NULL , NULL , NULL , & V_176 ) ) {
