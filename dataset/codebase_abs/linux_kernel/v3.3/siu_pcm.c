...
{
struct V_95 * V_29 = V_73 -> V_29 -> V_95 ;
struct V_96 * V_28 = V_73 -> V_28 ;
struct V_3 * V_4 = V_5 ;
struct V_97 * V_98 = F_48 ( V_29 -> V_27 ) ;
int V_62 ;
int V_99 ;
if ( V_98 -> V_100 < 0 || V_98 -> V_100 >= V_101 )
return - V_57 ;
V_4 -> V_63 = V_98 -> V_100 ;
for ( V_99 = V_98 -> V_100 ; V_99 < V_98 -> V_100 + 1 ; V_99 ++ ) {
struct V_1 * * V_2 = & V_102 [ V_99 ] ;
V_62 = F_49 ( V_99 , V_2 , V_29 ) ;
if ( V_62 < 0 )
return V_62 ;
V_62 = F_50 ( V_28 ,
V_103 , NULL ,
...
return 0 ;
V_105:
F_53 ( V_102 [ V_98 -> V_100 ] ) ;
F_18 ( V_29 -> V_27 , L_25 ) ;
return V_62 ;
}
static void F_54 ( struct V_96 * V_28 )
{
struct V_97 * V_98 = F_48 ( V_28 -> V_29 -> V_27 ) ;
struct V_1 * V_2 = V_102 [ V_98 -> V_100 ] ;
F_55 ( & V_2 -> V_44 . V_17 ) ;
F_55 ( & V_2 -> V_9 . V_17 ) ;
F_53 ( V_2 ) ;
F_56 ( V_28 ) ;
