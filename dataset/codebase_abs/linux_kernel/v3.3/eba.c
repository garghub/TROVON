...
F_60 () ;
V_27 = F_38 ( V_2 , V_2 -> V_93 , V_81 , 0 , V_82 ) ;
if ( V_27 ) {
if ( V_27 != V_47 ) {
F_34 ( L_31
L_32 , V_27 , V_81 ) ;
...
F_60 () ;
if ( memcmp ( V_2 -> V_66 , V_2 -> V_93 , V_82 ) ) {
F_34 ( L_33
L_34 , V_81 ) ;
V_27 = - V_94 ;
goto V_89;
...
F_34 ( L_35
L_36 , V_2 -> V_100 , V_2 -> V_99 ) ;
if ( V_2 -> V_101 )
F_34 ( L_37 ,
V_2 -> V_101 ) ;
}
int F_62 ( struct V_1 * V_2 , struct V_95 * V_96 )
{
...
V_2 -> V_13 = V_109 ;
V_2 -> V_5 = V_96 -> V_97 + 1 ;
V_104 = V_2 -> V_110 + V_111 ;
for ( V_102 = 0 ; V_102 < V_104 ; V_102 ++ ) {
V_26 = V_2 -> V_60 [ V_102 ] ;
if ( ! V_26 )
continue;
F_60 () ;
V_26 -> V_31 = F_8 ( V_26 -> V_112 * sizeof( int ) ,
V_113 ) ;
if ( ! V_26 -> V_31 ) {
V_27 = - V_21 ;
goto V_51;
}
for ( V_103 = 0 ; V_103 < V_26 -> V_112 ; V_103 ++ )
V_26 -> V_31 [ V_103 ] = V_33 ;
V_106 = F_65 ( V_96 , F_66 ( V_2 , V_102 ) ) ;
if ( ! V_106 )
continue;
F_67 (rb, seb, &sv->root, u.rb) {
if ( V_108 -> V_10 >= V_26 -> V_112 )
F_68 ( V_106 , V_108 , & V_96 -> V_114 ) ;
V_26 -> V_31 [ V_108 -> V_10 ] = V_108 -> V_28 ;
}
}
if ( V_2 -> V_115 < V_116 ) {
F_69 ( L_39 ,
...
if ( ! V_2 -> V_60 [ V_102 ] )
continue;
F_14 ( V_2 -> V_60 [ V_102 ] -> V_31 ) ;
V_2 -> V_60 [ V_102 ] -> V_31 = NULL ;
}
return V_27 ;
}
