...
{
struct V_1 * V_2 = F_67 ( & V_122 -> V_33 ) ;
struct V_78 * V_123 = V_2 -> V_98 . V_123 ;
F_76 ( & V_123 -> V_124 , & V_125 ) ;
F_77 ( & V_2 -> V_98 ) ;
F_78 ( V_2 -> V_88 , V_2 ) ;
F_79 ( V_2 -> V_88 ) ;
F_22 ( V_2 ) ;
...
F_90 ( V_139 , V_129 ) ;
F_90 ( V_140 , V_129 ) ;
V_2 -> V_55 = F_91 ( V_129 , F_74 , NULL ) ;
if ( ! V_2 -> V_55 ) {
F_19 ( & V_122 -> V_33 , L_36 ) ;
V_49 = - V_141 ;
goto V_142;
}
V_2 -> V_13 = F_92 ( V_128 , 0 ) ;
if ( ! V_2 -> V_13 ) {
F_19 ( & V_122 -> V_33 , L_37 ) ;
V_49 = - V_69 ;
goto V_143;
}
V_2 -> V_126 = F_93 ( F_94 () , 0x100000 ) ;
if ( ! V_2 -> V_126 ) {
...
V_130 = F_21 ( V_2 -> V_13 + V_146 ) ;
if ( V_130 != 0x02 && V_130 != 0x03 ) {
F_19 ( & V_122 -> V_33 , L_40 ) ;
V_49 = - V_141 ;
goto V_145;
}
V_130 = F_10 ( V_2 -> V_13 + V_147 ) ;
V_2 -> V_92 = ( V_130 & ( 1 << 18 ) ) ? V_148 : V_149 ;
V_2 -> V_88 = F_95 ( V_128 , 0 ) ;
if ( V_2 -> V_88 == V_150 ) {
F_19 ( & V_122 -> V_33 , L_41 ) ;
V_49 = - V_141 ;
goto V_145;
}
V_49 = F_96 ( V_2 -> V_88 , F_49 , V_151 , V_134 , V_2 ) ;
if ( V_49 ) {
