...
if ( V_14 >= V_47 || V_14 < 0 )
return - V_51 ;
return F_10 ( V_11 , V_52 ,
V_44 -> V_53 , V_14 , V_44 -> V_48 . V_15 ) ;
case V_54 :
if ( V_14 >= V_47 || V_14 < 0 )
return - V_51 ;
return F_10 ( V_11 , V_55 ,
V_44 -> V_53 , V_14 , V_44 -> V_48 . V_15 ) ;
case V_56 :
if ( V_14 >= V_47 || V_14 < 0 )
return - V_51 ;
return F_10 ( V_11 , V_57 ,
V_44 -> V_53 , V_14 , V_44 -> V_48 . V_15 ) ;
case V_58 :
if ( V_14 <= - V_47 || V_14 > 0 )
return - V_51 ;
...
static int T_3 F_28 ( struct V_10 * V_11 )
{
struct V_1 * V_2 = F_5 ( V_11 ) ;
struct V_43 * V_67 ;
unsigned int V_4 ;
V_67 = F_29 ( sizeof( struct V_43 ) ,
V_2 -> V_5 -> V_68 , V_69 ) ;
if ( ! V_67 )
return - V_70 ;
...
V_67 [ V_4 ] . V_3 = V_4 ;
V_67 [ V_4 ] . V_53 = F_30 ( V_4 ) ;
}
V_11 -> V_67 = V_67 ;
return 0 ;
}
static int T_3 F_31 ( struct V_72 * V_18 )
{
enum V_73 type = F_32 ( V_18 ) -> V_74 ;
struct V_10 * V_11 ;
struct V_1 * V_2 ;
unsigned int V_4 ;
int V_20 ;
...
V_2 -> V_5 = & V_75 [ type ] ;
V_2 -> V_18 = V_18 ;
V_11 -> V_33 . V_76 = & V_18 -> V_33 ;
V_11 -> V_77 = F_32 ( V_18 ) -> V_77 ;
V_11 -> V_78 = & V_79 ;
V_11 -> V_80 = V_81 ;
...
static int T_4 F_43 ( struct V_72 * V_18 )
{
