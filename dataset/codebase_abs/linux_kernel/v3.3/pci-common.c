...
void F_67 ( struct V_35 * V_6 , struct V_127 * V_128 ,
struct V_51 * V_112 )
{
T_1 V_52 = 0 , V_129 = ( T_1 ) - 1 ;
struct V_4 * V_17 = F_17 ( V_6 -> V_27 ) ;
if ( ! V_17 )
return;
if ( V_112 -> V_63 & V_60 ) {
V_52 = ( unsigned long ) V_17 -> V_22 - V_25 ;
V_129 = 0xffffffffu ;
} else if ( V_112 -> V_63 & V_59 )
V_52 = V_17 -> V_118 ;
V_128 -> V_64 = ( V_112 -> V_64 - V_52 ) & V_129 ;
V_128 -> V_66 = ( V_112 -> V_66 - V_52 ) & V_129 ;
}
void F_68 ( struct V_35 * V_6 , struct V_51 * V_112 ,
struct V_127 * V_128 )
{
T_1 V_52 = 0 , V_129 = ( T_1 ) - 1 ;
struct V_4 * V_17 = F_17 ( V_6 -> V_27 ) ;
...
V_52 = V_17 -> V_118 ;
V_112 -> V_64 = ( V_128 -> V_64 + V_52 ) & V_129 ;
V_112 -> V_66 = ( V_128 -> V_66 + V_52 ) & V_129 ;
}
static void T_5 F_69 ( struct V_51 * V_112 , struct V_35 * V_6 )
{
struct V_4 * V_17 = F_17 ( V_6 -> V_27 ) ;
T_1 V_52 = 0 , V_129 = ( T_1 ) - 1 ;
if ( V_112 -> V_63 & V_60 ) {
...
V_52 = V_17 -> V_118 ;
V_112 -> V_64 = ( V_112 -> V_64 + V_52 ) & V_129 ;
V_112 -> V_66 = ( V_112 -> V_66 + V_52 ) & V_129 ;
}
static void T_5 F_70 ( struct V_35 * V_6 )
{
struct V_4 * V_17 = F_17 ( V_6 -> V_27 ) ;
int V_56 ;
if ( ! V_17 ) {
...
for ( V_56 = 0 ; V_56 < V_131 ; V_56 ++ ) {
struct V_51 * V_112 = V_6 -> V_51 + V_56 ;
if ( ! V_112 -> V_63 )
continue;
if ( V_112 -> V_64 == 0 && ! ( V_124 & V_132 ) ) {
F_28 ( L_29 \
L_30 ,
F_29 ( V_6 ) , V_56 ,
...
static int T_5 F_71 ( struct V_26 * V_27 ,
struct V_51 * V_112 )
{
struct V_4 * V_17 = F_17 ( V_27 ) ;
struct V_35 * V_6 = V_27 -> V_134 ;
T_1 V_52 ;
V_87 V_135 ;
int V_56 ;
if ( V_124 & V_132 )
...
static void T_5 F_73 ( struct V_26 * V_27 )
{
struct V_51 * V_112 ;
int V_56 ;
struct V_35 * V_6 = V_27 -> V_134 ;
...
void T_5 F_76 ( struct V_26 * V_27 )
{
struct V_35 * V_6 ;
F_28 ( L_35 ,
V_27 -> V_88 , V_27 -> V_134 ? F_29 ( V_27 -> V_134 ) : L_36 ) ;
F_14 (dev, &bus->devices, bus_list) {
V_6 -> V_6 . V_140 = F_22 ( V_6 ) ;
F_77 ( & V_6 -> V_6 , F_78 ( V_6 -> V_27 ) ) ;
F_79 ( & V_6 -> V_6 , V_3 ) ;
V_6 -> V_6 . V_141 . V_142 = ( void * ) V_143 ;
F_27 ( V_6 ) ;
}
}
void T_5 F_80 ( struct V_26 * V_27 )
{
if ( V_27 -> V_134 != NULL )
F_81 ( V_27 ) ;
F_75 ( V_27 ) ;
...
static int F_82 ( struct V_35 * V_6 )
{
if ( ( V_124 & V_144 ) &&
! ( V_6 -> V_27 -> V_145 & V_146 ) )
return 1 ;
return 0 ;
}
T_1 F_83 ( void * V_147 , const struct V_51 * V_112 ,
T_1 V_21 , T_1 V_148 )
{
struct V_35 * V_6 = V_147 ;
T_1 V_64 = V_112 -> V_64 ;
if ( V_112 -> V_63 & V_60 ) {
if ( F_82 ( V_6 ) )
return V_64 ;
...
static int T_11 F_84 ( struct V_51 * V_30 ,
struct V_51 * V_112 )
{
struct V_51 * V_149 , * * V_150 ;
struct V_51 * * V_151 = NULL ;
for ( V_150 = & V_30 -> V_122 ; ( V_149 = * V_150 ) != NULL ; V_150 = & V_149 -> V_121 ) {
if ( V_149 -> V_66 < V_112 -> V_64 )
continue;
if ( V_112 -> V_66 < V_149 -> V_64 )
break;
if ( V_149 -> V_64 < V_112 -> V_64 || V_149 -> V_66 > V_112 -> V_66 )
return - 1 ;
if ( V_151 == NULL )
V_151 = V_150 ;
}
...
* V_151 = V_112 ;
* V_150 = NULL ;
for ( V_149 = V_112 -> V_122 ; V_149 != NULL ; V_149 = V_149 -> V_121 ) {
V_149 -> V_30 = V_112 ;
F_28 ( L_37 ,
V_149 -> V_120 ,
( unsigned long long ) V_149 -> V_64 ,
( unsigned long long ) V_149 -> V_66 , V_112 -> V_120 ) ;
}
return 0 ;
}
...
continue;
if ( V_27 -> V_30 == NULL )
V_153 = ( V_112 -> V_63 & V_60 ) ?
& V_154 : & V_155 ;
else {
if ( V_124 & V_156 )
goto V_157;
V_153 = F_86 ( V_27 -> V_134 , V_112 ) ;
if ( V_153 == V_112 ) {
continue;
}
}
F_28 ( L_39
L_40 ,
V_27 -> V_134 ? F_29 ( V_27 -> V_134 ) : L_36 ,
V_27 -> V_88 , V_56 ,
( unsigned long long ) V_112 -> V_64 ,
( unsigned long long ) V_112 -> V_66 ,
( unsigned int ) V_112 -> V_63 ,
V_153 , ( V_153 && V_153 -> V_120 ) ? V_153 -> V_120 : L_41 ) ;
if ( V_153 && ! ( V_153 -> V_63 & V_133 ) ) {
if ( F_87 ( V_153 , V_112 ) == 0 )
continue;
if ( F_84 ( V_153 , V_112 ) == 0 )
continue;
}
F_57 ( V_158 L_42
L_43 , V_56 , V_27 -> V_88 ) ;
...
static inline void T_5 F_88 ( struct V_35 * V_6 , int V_159 )
{
struct V_51 * V_153 , * V_160 = & V_6 -> V_51 [ V_159 ] ;
F_28 ( L_44 ,
F_29 ( V_6 ) , V_159 ,
( unsigned long long ) V_160 -> V_64 ,
( unsigned long long ) V_160 -> V_66 ,
( unsigned int ) V_160 -> V_63 ) ;
V_153 = F_86 ( V_6 , V_160 ) ;
if ( ! V_153 || ( V_153 -> V_63 & V_133 ) ||
F_87 ( V_153 , V_160 ) < 0 ) {
F_57 ( V_158 L_45
L_46 , V_159 , F_29 ( V_6 ) ) ;
...
F_28 ( L_47 ,
V_153 ,
( unsigned long long ) V_153 -> V_64 ,
( unsigned long long ) V_153 -> V_66 ,
( unsigned int ) V_153 -> V_63 ) ;
V_160 -> V_63 |= V_133 ;
V_160 -> V_66 -= V_160 -> V_64 ;
V_160 -> V_64 = 0 ;
}
}
static void T_11 F_89 ( int V_161 )
{
...
F_41 (dev) {
F_72 ( V_6 , V_136 , & V_135 ) ;
for ( V_159 = 0 ; V_159 <= V_61 ; V_159 ++ ) {
V_160 = & V_6 -> V_51 [ V_159 ] ;
if ( V_160 -> V_30 )
continue;
if ( ! V_160 -> V_63 || ( V_160 -> V_63 & V_133 ) )
continue;
if ( V_159 == V_61 )
V_162 = 1 ;
if ( V_160 -> V_63 & V_60 )
...
static void T_11 F_92 ( struct V_26 * V_27 )
{
struct V_4 * V_17 = F_17 ( V_27 ) ;
T_1 V_52 ;
struct V_51 * V_112 , * V_167 ;
int V_56 ;
F_28 ( L_49 ,
F_16 ( V_27 ) ) ;
...
goto V_168;
V_52 = ( unsigned long ) V_17 -> V_22 - V_25 ;
V_112 = F_93 ( sizeof( struct V_51 ) , V_8 ) ;
F_94 ( V_112 == NULL ) ;
V_112 -> V_120 = L_50 ;
V_112 -> V_63 = V_60 ;
V_112 -> V_64 = V_52 ;
...
for ( V_56 = 0 ; V_56 < 3 ; V_56 ++ ) {
V_167 = & V_17 -> V_119 [ V_56 ] ;
if ( ! ( V_167 -> V_63 & V_59 ) )
continue;
F_28 ( L_54 , V_167 ) ;
if ( ( V_167 -> V_64 - V_52 ) <= 0xa0000 &&
( V_167 -> V_66 - V_52 ) >= 0xbffff )
break;
}
if ( V_56 >= 3 )
return;
...
void T_5 F_97 ( struct V_26 * V_27 )
{
struct V_35 * V_6 ;
struct V_26 * V_169 ;
F_14 (dev, &bus->devices, bus_list) {
int V_56 ;
for ( V_56 = 0 ; V_56 < V_170 ; V_56 ++ ) {
struct V_51 * V_160 = & V_6 -> V_51 [ V_56 ] ;
if ( V_160 -> V_30 || ! V_160 -> V_64 || ! V_160 -> V_63 )
continue;
F_28 ( L_59
L_60 ,
F_29 ( V_6 ) , V_56 ,
...
int F_101 ( struct V_35 * V_6 , int V_129 )
{
return F_102 ( V_6 , V_129 ) ;
}
static void T_5 F_103 ( struct V_4 * V_17 , struct V_171 * V_172 )
{
struct V_51 * V_112 ;
int V_56 ;
V_112 = & V_17 -> V_18 ;
...
{
struct V_4 * V_17 = V_27 -> V_174 ;
return F_106 ( V_17 -> V_14 ) ;
}
static void T_5 F_107 ( struct V_4 * V_17 )
{
F_108 ( V_172 ) ;
struct V_26 * V_27 ;
...
V_28 ? V_28 -> V_38 : L_71 ) ;
F_103 ( V_17 , & V_172 ) ;
V_27 = F_109 ( V_17 -> V_30 , V_17 -> V_175 ,
V_17 -> V_176 , V_17 , & V_172 ) ;
if ( V_27 == NULL ) {
F_57 ( V_130 L_72 ,
V_17 -> V_10 ) ;
F_110 ( & V_172 ) ;
...
V_27 -> V_177 = V_17 -> V_175 ;
V_17 -> V_27 = V_27 ;
V_17 -> V_178 = V_27 -> V_179 ;
}
...
struct V_4 * V_17 , * V_29 ;
F_19 (hose, tmp, &hose_list, list_node)
if ( V_27 >= V_17 -> V_175 && V_27 <= V_17 -> V_178 )
return V_17 ;
return NULL ;
}
long F_113 ( long V_182 , unsigned long V_27 , unsigned long V_183 )
{
struct V_4 * V_17 ;
long V_184 = - V_185 ;
V_17 = F_112 ( V_27 ) ;
...
static int
F_114 ( struct V_26 * V_27 , unsigned int V_183 , int V_52 ,
int V_192 , T_9 * V_84 )
{
return V_193 ;
}
static int
F_115 ( struct V_26 * V_27 , unsigned int V_183 , int V_52 ,
int V_192 , T_9 V_84 )
{
return V_193 ;
}
static struct V_26 *
F_116 ( struct V_4 * V_17 , int V_194 )
{
static struct V_26 V_27 ;
if ( ! V_17 )
F_57 ( V_130 L_74 , V_194 ) ;
V_27 . V_88 = V_194 ;
V_27 . V_174 = V_17 ;
V_27 . V_176 = V_17 ? V_17 -> V_176 : & V_195 ;
return & V_27 ;
}
int F_117 ( struct V_4 * V_17 , int V_27 , int V_183 ,
int V_196 )
{
return F_118 ( F_116 ( V_17 , V_27 ) , V_183 , V_196 ) ;
}
