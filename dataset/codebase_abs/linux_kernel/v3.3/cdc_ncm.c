...
goto error;
V_100 = F_24 ( V_7 , V_17 -> V_103 , V_6 ) ;
if ( V_100 )
goto error;
V_20 = V_17 -> V_103 -> V_24 -> V_25 . V_26 ;
V_100 = F_25 ( V_6 -> V_14 , V_20 , 0 ) ;
if ( V_100 )
goto V_118;
if ( F_4 ( V_17 ) )
goto V_118;
V_100 = F_25 ( V_6 -> V_14 , V_20 , 1 ) ;
if ( V_100 )
goto V_118;
...
static void F_34 ( T_1 * V_131 , T_2 V_132 , T_2 V_133 , T_2 V_134 )
{
if ( V_132 >= V_134 )
return;
if ( V_132 >= V_133 )
...
static struct V_135 *
F_35 ( struct V_16 * V_17 , struct V_135 * V_136 )
{
struct V_135 * V_137 ;
T_2 V_138 ;
T_2 V_139 ;
...
V_139 = F_38 ( sizeof( struct V_151 ) ,
V_17 -> V_40 ) +
sizeof( struct V_152 ) +
( V_17 -> V_42 + 1 ) *
sizeof( struct V_153 ) ;
V_140 = V_139 ;
V_139 = F_38 ( V_139 , V_17 -> V_38 ) + V_17 -> V_36 ;
F_34 ( V_137 -> V_103 , 0 , V_139 , V_139 ) ;
V_141 = 0 ;
V_17 -> V_146 = 0 ;
}
...
V_17 -> V_154 . V_155 [ V_141 ] . V_156 = F_39 ( V_136 -> V_99 ) ;
V_17 -> V_154 . V_155 [ V_141 ] . V_157 = F_39 ( V_139 ) ;
V_139 += V_136 -> V_99 ;
V_140 = V_139 ;
V_139 = F_38 ( V_139 , V_17 -> V_38 ) + V_17 -> V_36 ;
F_34 ( V_137 -> V_103 , V_140 , V_139 ,
V_17 -> V_34 ) ;
F_18 ( V_136 ) ;
V_136 = NULL ;
}
...
if ( V_139 > V_160 )
V_139 = V_17 -> V_34 ;
F_34 ( V_137 -> V_103 , V_140 , V_139 , V_17 -> V_34 ) ;
V_140 = V_139 ;
...
F_39 ( sizeof( V_17 -> V_154 . V_162 ) ) ;
V_17 -> V_154 . V_162 . V_166 = F_39 ( V_17 -> V_167 ) ;
V_17 -> V_154 . V_162 . V_168 = F_39 ( V_140 ) ;
V_142 = F_38 ( sizeof( struct V_151 ) , V_17 -> V_40 ) ;
V_17 -> V_154 . V_162 . V_169 = F_39 ( V_142 ) ;
...
sizeof( struct V_153 ) ) ;
V_17 -> V_154 . V_170 . V_172 = F_39 ( V_138 ) ;
...
static struct V_135 *
F_47 ( struct V_5 * V_6 , struct V_135 * V_136 , T_6 V_19 )
{
struct V_135 * V_137 ;
struct V_16 * V_17 = (struct V_16 * ) V_6 -> V_103 [ 0 ] ;
T_1 V_181 = 0 ;
...
static int F_48 ( struct V_5 * V_6 , struct V_135 * V_183 )
{
struct V_135 * V_136 ;
struct V_16 * V_17 ;
int V_184 ;
...
static void F_54 ( struct V_5 * V_6 , struct V_193 * V_193 )
{
struct V_16 * V_17 ;
struct V_194 * V_195 ;
V_17 = (struct V_16 * ) V_6 -> V_103 [ 0 ] ;
...
F_53 (KERN_INFO KBUILD_MODNAME L_34
L_35 ,
...
static int
F_60 ( struct V_80 * V_14 , const struct V_204 * V_205 )
{
return F_61 ( V_14 , V_205 ) ;
}
static void F_62 ( struct V_80 * V_81 )
{
struct V_5 * V_6 = F_63 ( V_81 ) ;
if ( V_6 == NULL )
return;
F_64 ( V_81 ) ;
}
static int F_65 ( struct V_5 * V_6 , int V_127 )
{
