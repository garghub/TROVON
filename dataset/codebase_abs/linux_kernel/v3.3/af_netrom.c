...
int V_147 = 0 ;
F_49 ( V_11 ) ;
if ( V_11 -> V_28 == V_115 && V_10 -> V_49 == V_148 ) {
V_10 -> V_49 = V_149 ;
goto V_150;
}
if ( V_11 -> V_28 == V_121 && V_10 -> V_49 == V_148 ) {
V_10 -> V_49 = V_151 ;
V_147 = - V_152 ;
goto V_150;
}
...
V_34 -> V_49 = V_116 ;
F_38 ( V_11 ) ;
if ( V_11 -> V_28 != V_115 && ( V_146 & V_157 ) ) {
V_147 = - V_158 ;
goto V_150;
}
if ( V_11 -> V_28 == V_156 ) {
...
static int F_83 ( struct V_56 * V_10 , struct V_56 * V_163 , int V_146 )
{
struct V_45 * V_46 ;
struct V_10 * V_164 ;
F_76 ( V_159 ) ;
...
int * V_166 , int V_167 )
{
struct V_129 * V_168 = (struct V_129 * ) V_127 ;
struct V_10 * V_11 = V_10 -> V_11 ;
struct V_33 * V_34 = F_11 ( V_11 ) ;
F_49 ( V_11 ) ;
if ( V_167 != 0 ) {
...
V_168 -> V_134 . V_136 = V_137 ;
V_168 -> V_134 . V_135 = 1 ;
V_168 -> V_134 . V_138 = V_34 -> V_80 ;
memset ( V_168 -> V_142 , 0 , sizeof( V_168 -> V_142 ) ) ;
V_168 -> V_142 [ 0 ] = V_34 -> V_40 ;
* V_166 = sizeof( struct V_129 ) ;
} else {
V_168 -> V_134 . V_136 = V_137 ;
V_168 -> V_134 . V_135 = 0 ;
V_168 -> V_134 . V_138 = V_34 -> V_27 ;
* V_166 = sizeof( struct V_133 ) ;
}
F_50 ( V_11 ) ;
return 0 ;
}
...
struct V_10 * V_170 ;
struct V_33 * V_171 ;
T_1 * V_172 , * V_37 , * V_130 ;
unsigned short V_173 , V_174 ;
unsigned short V_175 , V_176 ;
unsigned short V_177 , V_146 , V_105 , V_178 ;
int V_179 ;
V_46 -> V_11 = NULL ;
V_172 = ( T_1 * ) ( V_46 -> V_44 + 0 ) ;
V_37 = ( T_1 * ) ( V_46 -> V_44 + 7 ) ;
V_173 = V_46 -> V_44 [ 15 ] ;
V_174 = V_46 -> V_44 [ 16 ] ;
V_175 = V_46 -> V_44 [ 17 ] ;
V_176 = V_46 -> V_44 [ 18 ] ;
V_177 = V_46 -> V_44 [ 19 ] & 0x0F ;
V_146 = V_46 -> V_44 [ 19 ] & 0xF0 ;
if ( V_177 == V_180 &&
V_173 == V_181 && V_174 == V_181 ) {
F_88 ( V_46 , V_182 + V_183 ) ;
F_89 ( V_46 ) ;
return F_90 ( V_46 , V_2 ) ;
}
V_11 = NULL ;
if ( V_173 == 0 && V_174 == 0 ) {
if ( V_177 == V_184 && V_146 == V_185 )
V_11 = F_23 ( V_175 , V_176 , V_172 ) ;
} else {
if ( V_177 == V_186 )
V_11 = F_23 ( V_173 , V_174 , V_172 ) ;
else
V_11 = F_22 ( V_173 , V_174 ) ;
}
if ( V_11 != NULL ) {
F_89 ( V_46 ) ;
if ( V_177 == V_184 && V_46 -> V_78 == 22 )
F_11 ( V_11 ) -> V_107 = 1 ;
else
F_11 ( V_11 ) -> V_107 = 0 ;
V_179 = F_91 ( V_11 , V_46 ) ;
F_25 ( V_11 ) ;
return V_179 ;
}
if ( V_177 != V_186 ) {
...
V_171 -> V_36 = V_41 % 256 ;
V_41 ++ ;
if ( V_105 < V_171 -> V_105 )
V_171 -> V_105 = V_105 ;
if ( V_46 -> V_78 == 37 ) {
V_178 = V_46 -> V_44 [ 36 ] * 256 + V_46 -> V_44 [ 35 ] ;
if ( V_178 * V_55 < V_171 -> V_68 )
V_171 -> V_68 = V_178 * V_55 ;
V_171 -> V_107 = 1 ;
} else {
V_171 -> V_107 = 0 ;
}
...
static int F_98 ( struct V_195 * V_196 , struct V_56 * V_10 ,
struct V_197 * V_198 , T_4 V_78 )
{
struct V_10 * V_11 = V_10 -> V_11 ;
struct V_33 * V_34 = F_11 ( V_11 ) ;
struct V_133 * V_199 = (struct V_133 * ) V_198 -> V_200 ;
int V_147 ;
struct V_133 V_168 ;
struct V_45 * V_46 ;
unsigned char * V_201 ;
int V_202 ;
if ( V_198 -> V_203 & ~ ( V_204 | V_205 | V_206 ) )
return - V_64 ;
F_49 ( V_11 ) ;
if ( F_65 ( V_11 , V_132 ) ) {
V_147 = - V_139 ;
...
if ( V_199 ) {
if ( V_198 -> V_210 < sizeof( V_168 ) ) {
V_147 = - V_64 ;
goto V_207;
}
V_168 = * V_199 ;
if ( F_20 ( & V_34 -> V_40 , & V_168 . V_138 ) != 0 ) {
V_147 = - V_153 ;
goto V_207;
}
if ( V_168 . V_136 != V_137 ) {
V_147 = - V_64 ;
goto V_207;
}
} else {
...
V_168 . V_136 = V_137 ;
V_168 . V_138 = V_34 -> V_40 ;
}
if ( V_78 > 65536 ) {
V_147 = - V_211 ;
goto V_207;
}
V_202 = V_78 + V_182 + V_183 ;
if ( ( V_46 = F_100 ( V_11 , V_202 , V_198 -> V_203 & V_204 , & V_147 ) ) == NULL )
goto V_207;
F_101 ( V_46 , V_202 - V_78 ) ;
F_89 ( V_46 ) ;
V_201 = F_102 ( V_46 , V_183 ) ;
* V_201 ++ = V_34 -> V_38 ;
* V_201 ++ = V_34 -> V_39 ;
* V_201 ++ = 0 ;
* V_201 ++ = 0 ;
* V_201 ++ = V_212 ;
F_103 ( V_46 , V_78 ) ;
if ( F_104 ( F_105 ( V_46 ) , V_198 -> V_213 , V_78 ) ) {
F_39 ( V_46 ) ;
V_147 = - V_65 ;
goto V_207;
}
...
static int F_107 ( struct V_195 * V_196 , struct V_56 * V_10 ,
struct V_197 * V_198 , T_4 V_202 , int V_146 )
{
struct V_10 * V_11 = V_10 -> V_11 ;
struct V_133 * V_168 = (struct V_133 * ) V_198 -> V_200 ;
T_4 V_214 ;
struct V_45 * V_46 ;
int V_215 ;
F_49 ( V_11 ) ;
...
if ( ( V_46 = F_108 ( V_11 , V_146 & ~ V_204 , V_146 & V_204 , & V_215 ) ) == NULL ) {
F_50 ( V_11 ) ;
return V_215 ;
}
F_89 ( V_46 ) ;
...
F_109 ( V_46 , 0 , V_198 -> V_213 , V_214 ) ;
if ( V_168 != NULL ) {
V_168 -> V_136 = V_137 ;
F_110 ( V_46 , 7 , V_168 -> V_138 . V_217 ,
V_81 ) ;
}
V_198 -> V_210 = sizeof( * V_168 ) ;
F_111 ( V_11 , V_46 ) ;
F_50 ( V_11 ) ;
return V_214 ;
}
static int F_112 ( struct V_56 * V_10 , unsigned int V_218 , unsigned long V_219 )
{
struct V_10 * V_11 = V_10 -> V_11 ;
void T_2 * V_220 = ( void T_2 * ) V_219 ;
int V_179 ;
switch ( V_218 ) {
case V_221 : {
long V_222 ;
F_49 ( V_11 ) ;
V_222 = V_11 -> V_114 - F_113 ( V_11 ) ;
if ( V_222 < 0 )
V_222 = 0 ;
F_50 ( V_11 ) ;
return F_46 ( V_222 , ( int T_2 * ) V_220 ) ;
}
case V_223 : {
struct V_45 * V_46 ;
long V_222 = 0L ;
...
case V_224 :
F_49 ( V_11 ) ;
V_179 = F_115 ( V_11 , V_220 ) ;
F_50 ( V_11 ) ;
return V_179 ;
case V_225 :
F_49 ( V_11 ) ;
V_179 = F_116 ( V_11 , V_220 ) ;
F_50 ( V_11 ) ;
return V_179 ;
case V_226 :
case V_227 :
...
if ( ! F_67 ( V_155 ) )
return - V_145 ;
return F_117 ( V_218 , V_220 ) ;
default:
return - V_239 ;
}
return 0 ;
}
static void * F_118 ( struct V_240 * V_241 , T_5 * V_242 )
{
F_6 ( & V_12 ) ;
return F_119 ( & V_25 , * V_242 ) ;
}
static void * F_120 ( struct V_240 * V_241 , void * V_243 , T_5 * V_242 )
{
return F_121 ( V_243 , & V_25 , V_242 ) ;
}
static void F_122 ( struct V_240 * V_241 , void * V_243 )
{
F_8 ( & V_12 ) ;
}
static int F_123 ( struct V_240 * V_241 , void * V_243 )
{
struct V_10 * V_13 = F_124 ( V_243 ) ;
struct V_1 * V_2 ;
struct V_33 * V_34 ;
const char * V_244 ;
char V_245 [ 11 ] ;
...
V_244 = V_2 -> V_247 ;
F_126 ( V_241 , L_3 , F_127 ( V_245 , & V_34 -> V_80 ) ) ;
F_126 ( V_241 , L_3 , F_127 ( V_245 , & V_34 -> V_40 ) ) ;
F_126 ( V_241 ,
L_4 ,
F_127 ( V_245 , & V_34 -> V_27 ) ,
V_244 ,
V_34 -> V_35 ,
V_34 -> V_36 ,
V_34 -> V_38 ,
...
V_34 -> V_70 / V_55 ,
F_128 ( & V_34 -> V_250 ) / V_55 ,
V_34 -> V_74 / V_55 ,
F_128 ( & V_34 -> V_251 ) / ( 60 * V_55 ) ,
V_34 -> V_76 / ( 60 * V_55 ) ,
V_34 -> V_119 ,
V_34 -> V_72 ,
V_34 -> V_105 ,
F_113 ( V_13 ) ,
F_129 ( V_13 ) ,
V_13 -> V_252 ? F_130 ( V_13 -> V_252 ) -> V_253 : 0L ) ;
F_25 ( V_13 ) ;
}
return 0 ;
}
static int F_131 ( struct V_254 * V_254 , struct V_255 * V_255 )
{
return F_132 ( V_255 , & V_256 ) ;
}
static int T_6 F_133 ( void )
{
int V_42 ;
int V_257 = F_134 ( & V_92 , 0 ) ;
if ( V_257 != 0 )
goto V_207;
if ( V_258 > 0x7fffffff / sizeof( struct V_1 * ) ) {
F_135 ( V_259 L_5 ) ;
return - 1 ;
}
V_260 = F_136 ( V_258 * sizeof( struct V_1 * ) , V_261 ) ;
if ( V_260 == NULL ) {
F_135 ( V_259 L_6 ) ;
return - 1 ;
}
for ( V_42 = 0 ; V_42 < V_258 ; V_42 ++ ) {
char V_247 [ V_262 ] ;
struct V_1 * V_2 ;
sprintf ( V_247 , L_7 , V_42 ) ;
V_2 = F_137 ( 0 , V_247 , V_263 ) ;
if ( ! V_2 ) {
F_135 ( V_259 L_8 ) ;
goto V_264;
}
...
#endif
F_146 () ;
F_147 ( & V_22 , L_11 , V_270 , & V_271 ) ;
F_147 ( & V_22 , L_12 , V_270 , & V_272 ) ;
F_147 ( & V_22 , L_13 , V_270 , & V_273 ) ;
V_207:
return V_257 ;
V_264:
while ( -- V_42 >= 0 ) {
