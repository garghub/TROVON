...
static T_1
F_57 ( struct V_43 * V_44 , struct V_45 * V_46 ,
const char * V_2 , T_2 V_54 )
{
struct V_47 * V_48 = F_52 ( V_46 ) ;
struct V_5 * V_6 ;
T_1 V_49 ;
...
int F_70 ( struct V_62 * V_63 )
{
int V_12 ;
struct V_64 * V_65 = F_71 ( V_63 ) ;
struct V_5 * V_6 = V_63 -> V_66 ;
if ( F_72 ( ! V_6 ) )
return - V_67 ;
V_12 = F_73 ( V_65 ) ;
if ( V_12 )
return V_12 ;
V_12 = F_74 ( & V_6 -> V_44 , F_75 ( & V_65 -> V_44 ) , L_3 , L_4 ) ;
if ( V_12 < 0 ) {
F_76 ( V_65 ) ;
return V_12 ;
}
