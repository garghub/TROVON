...
struct V_99 * V_100 ;
V_100 = F_25 ( & V_101 , V_52 -> V_10 . V_11 . V_98 ) ;
if ( V_100 ) {
F_14 ( V_46 , L_19 , V_100 -> V_73 ) ;
F_26 ( V_100 ) ;
}
}
break;
#ifdef F_27
case V_102 :
F_14 ( V_46 , L_20 , V_52 -> V_10 . V_103 . V_104 ) ;
if ( V_52 -> V_10 . V_103 . V_105 ) {
F_14 ( V_46 , L_21 ) ;
F_17 ( V_46 , V_52 -> V_10 . V_103 . V_105 ) ;
}
break;
#endif
case V_106 :
F_14 ( V_46 , L_22 ) ;
F_17 ( V_46 , V_52 -> V_10 . V_107 ) ;
break;
}
}
...
if ( V_52 == NULL )
return;
V_46 = F_29 ( V_55 -> V_108 , V_109 , V_110 ) ;
if ( V_46 == NULL )
return;
if ( V_52 -> V_111 )
