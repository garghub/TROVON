...
static void
F_65 ( struct V_57 * V_6 , struct V_170 * V_171 ,
struct V_170 * V_172 )
{
struct V_1 * V_2 =
F_20 ( V_6 , struct V_1 , V_6 ) ;
...
V_173 |= V_194 ;
V_175 = F_66 ( V_6 , V_171 , V_172 , 0 , 4000000 ) ;
V_176 = 1 ;
V_177 = 0x10 ;
V_178 = 0x3600 ;
switch ( V_175 ) {
...
static void
F_70 ( struct V_57 * V_6 , unsigned int V_62 ,
unsigned int V_213 )
{
}
static void F_71 ( struct V_57 * V_6 )
{
}
static int F_72 ( struct V_57 * V_6 )
{
return 0 ;
}
static void F_73 ( struct V_57 * V_6 , int V_128 )
{
struct V_1 * V_2 =
F_20 ( V_6 , struct V_1 , V_6 ) ;
V_2 -> V_6 . type = V_214 ;
...
static int
F_74 ( struct V_57 * V_6 , struct V_215 * V_216 )
{
return - V_217 ;
}
static const char *
...
static void F_77 ( struct V_57 * V_6 , int V_92 )
{
struct V_1 * V_2 =
F_20 ( V_6 , struct V_1 , V_6 ) ;
F_76 ( V_2 ) ;
...
static void
F_78 ( struct V_221 * V_222 , const char * V_223 , unsigned int V_14 )
{
...
V_225 = F_80 ( & V_2 -> V_6 . V_131 ) ;
} else
F_81 ( & V_2 -> V_6 . V_131 ) ;
V_58 = F_1 ( V_2 , V_22 ) ;
F_4 ( V_2 , V_22 , 0 ) ;
F_82 ( & V_2 -> V_6 , V_223 , V_14 , F_77 ) ;
F_76 ( V_2 ) ;
F_4 ( V_2 , V_22 , V_58 ) ;
if ( V_225 )
F_83 ( & V_2 -> V_6 . V_131 ) ;
...
static int T_7
F_85 ( struct V_221 * V_222 , char * V_228 )
{
struct V_1 * V_2 ;
int V_175 = 115200 ;
int V_229 = 8 ;
...
return - V_233 ;
if ( V_228 )
F_86 ( V_228 , & V_175 , & V_103 , & V_229 , & V_230 ) ;
return F_87 ( & V_2 -> V_6 , V_222 , V_175 , V_103 , V_229 , V_230 ) ;
}
static int F_88 ( struct V_234 * V_235 , T_8 V_62 )
{
void * V_236 = F_89 ( V_235 ) ;
struct V_1 * V_2 ;
...
F_91 ( V_235 ) ;
F_92 ( V_235 , F_93 ( V_235 , V_62 ) ) ;
return 0 ;
}
static int F_94 ( struct V_234 * V_235 )
{
void * V_236 = F_89 ( V_235 ) ;
struct V_1 * V_2 ;
int V_18 ;
...
static int F_98 ( struct V_237 * V_73 )
{
int V_239 ;
V_239 = F_99 ( V_73 , 500 ) ;
if ( V_239 )
...
static int F_100 ( struct V_237 * V_73 )
{
return 0 ;
}
static int F_101 ( struct V_237 * V_73 )
{
return 0 ;
}
...
return V_18 ;
if ( V_21 == 3 ) {
V_18 = F_105 ( V_235 -> V_124 , F_54 , 0 , L_29 , V_245 ) ;
if ( V_18 ) {
F_104 ( & V_235 -> V_73 , L_30 ) ;
goto V_246;
}
F_106 ( V_235 , V_245 ) ;
} else {
V_135 = & V_245 -> V_6 [ V_21 ] ;
V_135 -> V_6 . V_124 = V_235 -> V_124 ;
V_135 -> V_6 . V_73 = & V_235 -> V_73 ;
V_135 -> V_73 = & V_235 -> V_73 ;
V_18 = F_105 ( V_235 -> V_124 , F_50 , 0 , V_135 -> V_49 , V_135 ) ;
if ( V_18 ) {
F_104 ( & V_235 -> V_73 , L_30 ) ;
goto V_246;
}
F_107 ( & V_231 , & V_135 -> V_6 ) ;
F_106 ( V_235 , V_135 ) ;
}
F_108 ( & V_235 -> V_73 ) ;
F_109 ( & V_235 -> V_73 ) ;
...
if ( ! V_47 )
return;
V_47 -> V_248 = 0xffa28000 ;
V_47 -> V_249 = 0x1000 ;
if ( ! ( F_112 ( V_47 -> V_248 , V_47 -> V_249 , L_31 ) ) )
F_113 ( L_32 ) ;
V_47 -> V_250 = F_114 ( ( unsigned long ) V_47 -> V_248 , V_47 -> V_249 ) ;
if ( ! V_47 -> V_250 ) {
F_115 ( L_33 ) ;
V_18 = - V_51 ;
goto V_251;
...
V_135 -> V_6 . V_252 = V_253 ;
V_135 -> V_6 . V_254 = ( V_255 ) V_47 -> V_248
+ V_256
+ V_48 * V_257 ;
V_135 -> V_6 . V_7 = V_47 -> V_250 + V_256
+ V_48 * V_257 ;
sprintf ( V_135 -> V_49 , L_34 , V_48 ) ;
V_135 -> V_6 . V_113 = 64 ;
V_135 -> V_6 . V_258 = & V_259 ;
V_135 -> V_6 . line = V_48 ;
V_135 -> V_6 . V_128 = V_260 ;
...
for ( V_48 = 0 ; V_48 < 6 ; V_48 ++ ) {
V_247 -> V_33 = V_48 ;
V_247 -> V_137 = ( V_48 & 0x1 ) ? V_86 : V_76 ;
V_247 -> V_135 = & V_47 -> V_6 [ V_48 / 2 ] ;
V_247 -> V_250 = V_47 -> V_250 + V_262 +
V_48 * V_263 ;
V_247 ++ ;
}
V_245 = V_47 ;
...
return;
V_251:
F_116 ( V_47 -> V_248 , V_47 -> V_249 ) ;
F_11 ( V_47 ) ;
return;
}
static void F_117 ( struct V_234 * V_235 )
{
void * V_236 = F_89 ( V_235 ) ;
struct V_1 * V_2 ;
if ( ! V_236 )
