...
V_16 = F_30 ( V_38 [ V_30 ] , V_39 [ V_30 ] , V_40 , 0 , & V_13 ) ;
if ( V_16 < 0 )
return V_16 ;
...
F_33 ( & V_6 -> V_42 ) ;
strcpy ( V_13 -> V_2 , L_9 ) ;
strcpy ( V_13 -> V_43 , L_4 ) ;
sprintf ( V_13 -> V_44 , L_10 ,
V_13 -> V_43 , V_6 -> V_9 ) ;
F_34 ( V_6 ) ;
V_16 = F_35 ( V_13 ) ;
if ( V_16 < 0 ) {
...
V_48 -> V_68 ,
V_48 -> V_57 ) ;
return F_69 ( V_46 -> V_48 , V_67 ) ;
}
static T_5 F_70 ( struct V_45
* V_46 )
{
struct V_54 * V_55 = F_49 ( V_46 ) ;
struct V_5 * V_6 = V_55 -> V_6 ;
...
L_20
L_21 , V_16 ) ;
V_16 = F_76 ( V_6 -> V_13 , F_77 ( & V_86 , V_6 ) ) ;
if ( V_16 < 0 ) {
F_19 ( V_20 L_24 , V_16 ) ;
return V_16 ;
}
...
static int F_79 ( struct V_87 * V_88 ,
struct V_98
* V_99 )
{
struct V_5 * V_6 = F_80 ( V_88 ) ;
if ( F_81 ( & V_6 -> V_8 ) )
