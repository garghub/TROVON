...
if ( V_12 . V_84 . V_85 && V_49 -> V_73 . V_74 > 1 )
F_35 ( V_49 ) ;
}
void F_36 ( struct V_48 * V_49 )
{
struct V_4 * V_43 = & F_25 ( V_4 ) ;
struct V_79 * V_80 = & V_49 -> V_63 ;
V_43 -> V_82 &= ~ ( 1ULL << V_80 -> V_83 ) ;
...
static inline bool F_41 ( unsigned long V_65 )
{
#ifdef F_42
return V_65 > V_88 ;
#else
...
if ( ! F_41 ( V_65 ) ) {
int V_99 , V_66 = V_97 ;
V_99 = F_44 ( V_96 , ( void V_100 * ) V_46 , V_66 ) ;
if ( V_99 != V_66 )
return 0 ;
V_98 = V_96 ;
} else
...
if ( V_49 -> V_73 . V_74 > 1 && F_43 ( & V_61 ) )
V_61 . V_47 |= V_108 ;
else
V_61 . V_47 &= ~ V_108 ;
if ( F_51 ( V_49 , & V_59 , & V_61 ) )
F_52 ( V_49 , 0 ) ;
}
static void F_53 ( struct V_60 * V_103 )
{
struct V_4 * V_43 = & F_25 ( V_4 ) ;
struct V_2 * V_3 = V_43 -> V_3 ;
...
if ( V_12 . V_13 ) {
char V_118 = V_12 . V_84 . V_85 ? '+' : '-' ;
int V_119 = V_12 . V_84 . V_120 ;
switch ( V_119 ) {
case 0 :
