...
static int F_42 ( struct V_84 * V_85 , unsigned long V_39 ,
void * V_86 )
{
struct V_87 * V_88 = V_86 ;
unsigned long * V_89 ;
if ( F_43 ( & F_32 ( V_88 -> V_73 ) , V_90 ) )
return 0 ;
V_89 = & V_91 . V_71 ;
#ifdef F_31
if ( ! ( V_88 -> V_55 & V_92 ) )
...
static T_4 F_48 ( struct V_103 * V_104 )
{
T_4 V_105 = ( T_4 ) F_13 () ;
...
unsigned long T_5 F_66 ( void )
{
int V_16 , V_73 = F_67 () ;
if ( ! V_2 && ! F_43 ( & F_32 ( V_73 ) , V_90 ) )
return 0 ;
F_68 (i)
