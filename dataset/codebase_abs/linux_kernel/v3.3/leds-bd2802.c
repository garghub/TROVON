...
static int T_4 F_41 ( struct V_22 * V_13 ,
const struct V_93 * V_4 )
{
struct V_1 * V_2 ;
struct V_36 * V_32 ;
int V_25 , V_17 ;
V_2 = F_42 ( sizeof( struct V_1 ) , V_94 ) ;
if ( ! V_2 ) {
F_2 ( & V_13 -> V_14 , L_16 ) ;
return - V_95 ;
}
...
V_2 -> V_43 = V_101 ;
F_46 ( & V_2 -> V_57 ) ;
for ( V_17 = 0 ; V_17 < F_21 ( V_102 ) ; V_17 ++ ) {
V_25 = F_22 ( & V_2 -> V_13 -> V_14 ,
V_102 [ V_17 ] ) ;
if ( V_25 ) {
F_2 ( & V_2 -> V_13 -> V_14 , L_4 ,
V_102 [ V_17 ] -> V_51 . V_52 ) ;
goto V_103;
}
}
V_25 = F_35 ( V_2 ) ;
...
V_103:
for ( V_17 -- ; V_17 >= 0 ; V_17 -- )
F_23 ( & V_2 -> V_13 -> V_14 , V_102 [ V_17 ] ) ;
V_99:
F_47 ( V_2 ) ;
return V_25 ;
}
static int T_5 F_48 ( struct V_22 * V_13 )
{
