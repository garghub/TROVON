...
if ( V_42 -> V_76 . V_77 . V_78 ) {
V_42 -> V_76 . V_77 . V_78 ( V_42 ) ;
if ( V_42 -> V_76 . V_79 ) V_42 -> V_76 . V_79 ( V_42 , 0 ) ;
}
F_5 ( V_2 , V_74 -> V_21 ) ;
F_6 ( V_2 , V_74 -> V_80 ) ;
F_8 ( V_2 , V_74 -> V_81 ) ;
...
struct V_73 * V_74 = & V_42 -> V_75 ;
struct V_1 * V_2 = V_42 -> V_43 ;
T_9 V_82 ; unsigned V_83 ;
V_83 = F_4 ( V_2 , 0x07 ) & 0x03 ;
if ( V_83 == 0 ) V_83 = 90999000L / 2L ;
else if ( V_83 == 1 ) V_83 = 60666000L ;
else if ( V_83 == 2 ) V_83 = 80888000L ;
else V_83 = 90999000L ;
V_83 >>= 8 ;
V_82 = V_83 * ( F_4 ( V_2 , 0x44 ) & 0x1f ) +
( ( V_83 * F_4 ( V_2 , 0x45 ) ) >> 8 ) +
( ( V_83 * F_4 ( V_2 , 0x46 ) ) >> 16 ) ;
V_74 -> V_84 += V_82 ;
...
static int F_25 ( struct V_41 * V_42 , T_10 V_85 )
{
struct V_1 * V_2 = V_42 -> V_43 ;
return F_1 ( V_2 , 0x76 , ( F_4 ( V_2 , 0x76 ) & ~ 0x10 ) | ( ( ( V_85 == V_86 ) ) ? 0x10 : 0 ) ) ;
}
...
struct V_41 * F_28 ( const struct V_87 * V_9 ,
struct V_88 * V_14 )
{
struct V_1 * V_2 = NULL ;
int V_17 ;
