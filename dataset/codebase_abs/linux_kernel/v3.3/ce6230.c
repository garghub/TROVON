...
{
F_9 ( L_4 , V_29 ) ;
V_33 -> V_50 [ 0 ] . V_51 = F_18 ( V_52 , & V_44 ,
& V_33 -> V_53 -> V_54 ) ;
if ( V_33 -> V_50 [ 0 ] . V_51 == NULL )
return - V_55 ;
return 0 ;
}
...
int V_5 ;
F_9 ( L_4 , V_29 ) ;
V_5 = F_18 ( V_56 , V_33 -> V_50 [ 0 ] . V_51 , & V_33 -> V_53 -> V_54 ,
& V_57 ) == NULL ? - V_55 : 0 ;
return V_5 ;
}
static int F_20 ( struct V_30 * V_31 , int V_58 )
{
int V_5 ;
F_9 ( L_5 , V_29 , V_58 ) ;
V_5 = F_21 ( V_31 -> V_2 , 1 , V_58 ) ;
if ( V_5 )
F_2 ( L_6 , V_5 ) ;
return V_5 ;
}
...
F_9 ( L_7 , V_29 ,
V_60 -> V_63 -> V_64 . V_65 ) ;
if ( V_60 -> V_63 -> V_64 . V_65 == 1 ) {
V_5 = F_23 ( V_60 , & V_66 , V_67 ,
& V_31 , V_68 ) ;
if ( V_5 )
F_2 ( L_8 , V_5 ) ;
}
