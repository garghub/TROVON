...
int V_205 ;
V_205 = V_2 -> V_104 ;
V_2 -> V_104 = ( V_205 + 1 ) % V_2 -> V_128 ;
F_77 ( V_2 -> V_104 == V_2 -> V_125 ) ;
V_2 -> V_124 ++ ;
return V_205 ;
}
static int F_87 ( struct V_206 * V_49 , int V_139 )
{
struct V_1 * V_2 =
...
V_118 -> V_129 = V_208 ;
V_118 -> V_36 = F_17 ( NULL , V_24 -> V_5 , V_208 , V_135 ) ;
F_92 ( V_24 ) ;
F_18 () ;
V_118 -> V_40 = V_41 | V_210 | V_211 |
V_212 | V_213 | V_214 ;
F_18 () ;
F_3 ( V_2 , V_8 , V_215 | V_116 ) ;
V_133 -> V_216 += V_208 ;
V_133 -> V_217 ++ ;
V_22 -> V_218 = V_47 ;
...
{
int V_52 = 0 ;
for ( V_52 = 0 ; F_1 ( V_2 , V_220 ) & V_221 ; V_52 ++ ) {
if ( V_52 == V_222 )
return - V_223 ;
F_95 ( 10 ) ;
}
...
static int F_96 ( struct V_224 * V_225 , int V_16 , int V_226 )
{
...
F_3 ( V_2 , V_220 , ( V_16 << 16 ) | ( V_226 << 21 ) | V_229 ) ;
for ( V_52 = 0 ; ! ( ( V_89 = F_1 ( V_2 , V_220 ) ) & V_230 ) ; V_52 ++ ) {
if ( V_52 == V_222 ) {
F_7 ( V_228
L_23 ) ;
return - V_231 ;
...
static int F_97 ( struct V_224 * V_225 , int V_16 , int V_226 ,
T_5 V_232 )
{
struct V_1 * V_2 = V_225 -> V_227 ;
if ( F_94 ( V_2 ) ) {
...
F_3 ( V_2 , V_220 , ( V_16 << 16 ) | ( V_226 << 21 ) |
V_233 | ( V_232 & 0xffff ) ) ;
if ( F_94 ( V_2 ) ) {
F_7 ( V_11 L_22 ) ;
return - V_223 ;
...
static int F_98 ( struct V_21 * V_22 , struct V_234 * V_235 ,
int V_103 )
{
struct V_1 * V_2 = F_14 ( V_22 ) ;
if ( V_2 -> V_18 != NULL )
return F_99 ( V_2 -> V_18 , V_235 , V_103 ) ;
return - V_236 ;
}
static struct V_237 * F_100 ( struct V_1 * V_2 , int V_16 )
{
struct V_224 * V_225 = V_2 -> V_238 ;
struct V_237 * V_239 ;
int V_65 ;
int V_240 ;
int V_52 ;
...
V_239 = NULL ;
for ( V_52 = 0 ; V_52 < V_240 ; V_52 ++ ) {
int V_78 = ( V_65 + V_52 ) & 0x1f ;
if ( V_225 -> V_242 [ V_78 ] == NULL )
F_101 ( V_225 , V_78 ) ;
if ( V_239 == NULL ) {
V_239 = V_225 -> V_242 [ V_78 ] ;
if ( V_239 != NULL )
F_9 ( V_2 , V_78 ) ;
}
}
...
{
struct V_237 * V_18 = V_2 -> V_18 ;
F_10 ( V_2 ) ;
F_103 ( V_2 -> V_22 , F_104 ( & V_18 -> V_22 ) , 0 , V_243 ) ;
if ( V_161 == 0 ) {
V_18 -> V_244 = V_245 ;
V_18 -> V_161 = 0 ;
V_18 -> V_162 = 0 ;
V_18 -> V_246 &= V_247 ;
V_18 -> V_248 = V_18 -> V_246 | V_249 ;
} else {
V_18 -> V_244 = V_250 ;
V_18 -> V_248 = 0 ;
V_18 -> V_161 = V_161 ;
...
if ( V_2 -> V_251 -> V_252 )
V_2 -> V_251 -> V_252 () ;
V_2 -> V_18 = F_100 ( V_2 , V_2 -> V_251 -> V_16 & 0x1f ) ;
if ( V_2 -> V_18 != NULL )
F_102 ( V_2 , V_2 -> V_251 -> V_161 , V_2 -> V_251 -> V_162 ) ;
F_29 ( V_2 , NULL , V_22 -> V_94 ) ;
return 0 ;
}
...
struct V_253 * V_254 )
{
strncpy ( V_254 -> V_255 , V_256 , 32 ) ;
strncpy ( V_254 -> V_257 , V_258 , 32 ) ;
strncpy ( V_254 -> V_259 , L_24 , 32 ) ;
strncpy ( V_254 -> V_260 , L_24 , 32 ) ;
}
static int F_111 ( struct V_261 * V_262 )
{
struct V_1 * V_2 = NULL ;
...
V_2 -> V_22 = V_22 ;
V_2 -> V_265 = V_265 ;
V_264 = F_117 ( V_262 , V_268 , 0 ) ;
if ( V_264 == NULL ) {
V_182 = - V_231 ;
goto V_269;
}
V_2 -> V_4 = F_118 ( V_264 -> V_65 , F_119 ( V_264 ) ) ;
if ( V_2 -> V_4 == NULL ) {
V_182 = - V_85 ;
goto V_269;
}
V_264 = F_117 ( V_262 , V_270 , 0 ) ;
F_77 ( ! V_264 ) ;
V_22 -> V_169 = V_264 -> V_65 ;
V_22 -> V_271 = & V_272 ;
V_22 -> V_273 = 2 * V_48 ;
V_22 -> V_274 = 0 ;
F_120 ( V_22 , & V_275 ) ;
F_121 ( & V_2 -> V_136 , F_50 ) ;
F_7 ( V_75 L_28 , V_256 ) ;
F_122 ( V_22 -> V_94 ) ;
V_2 -> V_251 = V_262 -> V_22 . V_276 ;
V_2 -> V_29 = V_277 ;
if ( V_2 -> V_251 -> V_278 )
V_2 -> V_29 = V_2 -> V_251 -> V_278 ;
V_2 -> V_128 = V_279 ;
if ( V_2 -> V_251 -> V_280 )
V_2 -> V_128 = V_2 -> V_251 -> V_280 ;
V_2 -> V_15 = V_2 -> V_251 -> V_281 ;
F_77 ( V_2 -> V_15 > 2 ) ;
F_123 ( V_22 , & V_2 -> V_49 , F_87 , V_2 -> V_29 ) ;
memset ( & V_2 -> V_45 , 0 , sizeof( struct V_282 ) ) ;
F_124 ( & V_2 -> V_45 ) ;
V_2 -> V_45 . V_283 = F_20 ;
...
V_2 -> V_238 -> V_227 = V_2 ;
V_2 -> V_238 -> V_132 = L_29 ;
V_2 -> V_238 -> V_285 = F_96 ;
V_2 -> V_238 -> V_286 = F_97 ;
snprintf ( V_2 -> V_238 -> V_287 , V_288 , L_30 ,
V_262 -> V_132 , V_262 -> V_287 ) ;
V_2 -> V_238 -> V_81 = & V_262 -> V_22 ;
V_2 -> V_238 -> V_289 = 0xffffffff ;
V_182 = F_126 ( V_2 -> V_238 ) ;
if ( V_182 )
goto V_290;
F_68 ( V_2 ) ;
V_182 = F_106 ( V_22 ) ;
...
static int F_135 ( struct V_261 * V_262 )
{
struct V_21 * V_22 = F_136 ( V_262 ) ;
struct V_1 * V_2 = F_14 ( V_22 ) ;
if ( V_2 -> V_71 ) {
...
static int F_142 ( struct V_261 * V_262 , T_6 V_293 )
{
return - V_292 ;
}
