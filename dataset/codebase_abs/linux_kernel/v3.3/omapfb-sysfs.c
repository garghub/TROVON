...
struct V_6 * V_7 = F_2 ( V_2 ) ;
struct V_8 * V_9 = F_3 ( V_7 ) ;
return snprintf ( V_5 , V_10 , L_10 , V_9 -> V_22 -> V_61 ) ;
}
...
struct V_6 * V_7 = F_2 ( V_2 ) ;
struct V_8 * V_9 = F_3 ( V_7 ) ;
return snprintf ( V_5 , V_10 , L_11 , V_9 -> V_22 -> V_62 ) ;
}
...
if ( V_16 )
return V_16 ;
return snprintf ( V_5 , V_10 , L_12 , ( unsigned ) V_64 ) ;
}
...
for ( V_39 = 0 ; V_39 < V_31 -> V_40 ; V_39 ++ ) {
int V_33 ;
for ( V_33 = 0 ; V_33 < F_45 ( V_65 ) ; V_33 ++ ) {
