...
V_27 = F_4 ( V_131 ) ;
if ( V_141 ) {
T_6 V_158 = ( V_27 & ~ V_159 ) | V_133 | V_132
...
T_7 V_194 , V_195 , V_196 , V_197 = 0xffff ;
V_194 = * V_103 ++ ;
V_195 = * V_105 ++ ;
V_196 = * V_106 ++ ;
if ( V_108 )
...
T_4 V_301 [] = { 0 , 0x12 , 9 , 9 , 6 , 5 } ;
T_4 V_302 [] = { 2 , 2 , 0 , 0 , 5 , 5 } ;
T_6 V_303 , V_304 , V_305 , V_306 , V_307 ;
int V_54 , V_278 ;
int V_308 = 0 ;
int V_309 = 0 ;
...
V_293 -> V_228 &= ~ V_371 ;
V_293 -> V_221 = ( V_2 -> V_161 . V_221 & ( T_6 )
~ ( V_372 |
V_373 |
V_374 |
V_375 |
