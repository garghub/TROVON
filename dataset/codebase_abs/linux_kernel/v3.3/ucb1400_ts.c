...
F_45 ( & V_2 -> V_47 ) ;
F_46 ( V_2 -> V_37 , V_2 ) ;
V_2 -> V_37 -> V_38 . V_71 = & V_50 -> V_38 ;
V_2 -> V_37 -> V_72 = L_5 ;
V_2 -> V_37 -> V_73 . V_74 = F_11 ( V_2 -> V_3 ,
V_75 ) ;
V_2 -> V_37 -> V_73 . V_76 = V_2 -> V_73 ;
V_2 -> V_37 -> V_77 = F_34 ;
V_2 -> V_37 -> V_78 = F_36 ;
V_2 -> V_37 -> V_79 [ 0 ] = F_47 ( V_80 ) | F_47 ( V_81 ) ;
V_2 -> V_37 -> V_82 [ F_48 ( V_34 ) ] = F_47 ( V_34 ) ;
V_67 = F_11 ( V_2 -> V_3 , V_83 ) ;
F_2 ( V_2 -> V_3 , V_83 , V_67 | V_84 ) ;
F_24 ( V_2 -> V_3 ) ;
V_65 = F_8 ( V_2 ) ;
V_66 = F_9 ( V_2 ) ;
F_25 ( V_2 -> V_3 ) ;
F_20 ( & V_50 -> V_38 , L_6 , V_65 , V_66 ) ;
F_49 ( V_2 -> V_37 , V_31 , 0 , V_65 , 0 , 0 ) ;
F_49 ( V_2 -> V_37 , V_32 , 0 , V_66 , 0 , 0 ) ;
F_49 ( V_2 -> V_37 , V_33 , 0 , 0 , 0 , 0 ) ;
F_28 ( V_2 ) ;
error = F_50 ( V_2 -> V_43 , NULL , F_21 ,
V_85 | V_86 ,
L_7 , V_2 ) ;
if ( error ) {
F_41 ( & V_50 -> V_38 ,
...
static int T_4 F_54 ( struct V_49 * V_50 )
{
struct V_1 * V_2 = V_50 -> V_38 . V_64 ;
F_52 ( V_2 -> V_43 , V_2 ) ;
F_55 ( V_2 -> V_37 ) ;
...
static int F_56 ( struct V_88 * V_38 )
{
struct V_1 * V_2 = V_38 -> V_64 ;
...
static int F_59 ( struct V_88 * V_38 )
{
struct V_1 * V_2 = V_38 -> V_64 ;
struct V_26 * V_27 = V_2 -> V_37 ;
F_57 ( & V_27 -> V_89 ) ;
