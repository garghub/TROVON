...
static int T_1 F_2 ( struct V_5 * V_6 ,
struct V_7 * V_8 , struct V_1 * V_2 , unsigned int V_3 )
{
...
static int T_1 F_8 ( struct V_5 * V_6 ,
struct V_1 * V_2 , unsigned int V_3 , struct V_23 * * V_24 )
{
...
static int T_1 F_10 ( struct V_23 * V_30 ,
struct V_7 * V_31 )
{
unsigned long V_32 ;
unsigned char V_33 ;
...
static int T_1 F_22 ( struct V_1 * V_2 , unsigned int V_3 )
{
struct V_5 * V_6 ;
struct V_23 * V_30 ;
struct V_7 * V_31 ;
...
static int T_2 F_38 ( struct V_1 * V_2 , unsigned int V_3 )
{
F_37 ( F_39 ( V_2 ) ) ;
F_36 ( V_2 , NULL ) ;
return 0 ;
