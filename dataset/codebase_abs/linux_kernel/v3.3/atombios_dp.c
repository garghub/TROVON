...
int F_32 ( struct V_146 * V_147 ,
struct V_126 * V_127 )
{
struct V_9 * V_10 = V_147 -> V_10 ;
struct V_11 * V_12 = V_10 -> V_13 ;
struct V_39 * V_39 = F_33 ( V_127 ) ;
int V_148 = V_149 ;
if ( ! F_3 ( V_12 ) )
return V_148 ;
if ( F_27 ( V_127 ) ==
...
V_152 [ V_84 ] = F_10 ( V_39 , 0x503 + V_84 ) ;
if ( V_152 [ 0 ] == 0x73 &&
V_152 [ 1 ] == 0x69 &&
V_152 [ 2 ] == 0x76 &&
V_152 [ 3 ] == 0x61 &&
...
V_148 = V_153 ;
} else if ( V_127 -> V_154 == V_155 ) {
T_1 V_156 = F_10 ( V_39 , V_157 ) ;
if ( V_156 & 1 )
V_148 = V_153 ;
}
return V_148 ;
...
static bool F_36 ( struct V_39 * V_39 ,
T_1 V_79 [ V_80 ] )
{
int V_44 ;
V_44 = F_8 ( V_39 , V_82 ,
...
bool F_37 ( struct V_39 * V_39 )
{
T_1 V_79 [ V_80 ] ;
struct V_41 * V_165 = V_39 -> V_43 ;
if ( ! F_36 ( V_39 , V_79 ) )
return false ;
if ( F_16 ( V_79 , V_165 -> V_162 ) )
return false ;
return true ;
}
static void F_38 ( struct V_166 * V_167 )
{
F_39 ( V_167 -> V_147 ,
V_168 ,
0 , V_167 -> V_101 [ 0 ] ) ;
F_6 ( V_167 -> V_39 , V_169 ,
V_167 -> V_101 , V_167 -> V_162 , 0 ) ;
}
static void F_40 ( struct V_166 * V_167 , int V_170 )
{
int V_171 = 0 ;
if ( F_3 ( V_167 -> V_12 ) || ! V_167 -> V_172 ) {
switch ( V_170 ) {
case V_173 :
V_171 = V_174 ;
break;
...
F_29 ( V_167 -> V_12 , V_179 ,
V_167 -> V_136 , V_167 -> V_180 , V_171 ) ;
}
F_9 ( V_167 -> V_39 , V_181 , V_170 ) ;
}
static int F_42 ( struct V_166 * V_167 )
{
struct V_182 * V_182 = F_43 ( V_167 -> V_147 ) ;
struct V_183 * V_165 = V_182 -> V_184 ;
T_1 V_156 ;
if ( V_167 -> V_118 [ 0 ] >= 0x11 )
F_9 ( V_167 -> V_39 ,
V_185 , V_186 ) ;
if ( V_167 -> V_118 [ 3 ] & 0x1 )
F_9 ( V_167 -> V_39 ,
V_187 , V_188 ) ;
else
F_9 ( V_167 -> V_39 ,
V_187 , 0 ) ;
if ( ( V_167 -> V_127 -> V_154 == V_155 ) &&
( V_165 -> V_148 == V_153 ) ) {
F_9 ( V_167 -> V_39 , V_189 , 1 ) ;
}
V_156 = V_167 -> V_162 ;
if ( V_167 -> V_118 [ 0 ] >= 0x11 )
V_156 |= V_190 ;
F_9 ( V_167 -> V_39 , V_191 , V_156 ) ;
V_156 = F_24 ( V_167 -> V_136 ) ;
F_9 ( V_167 -> V_39 , V_192 , V_156 ) ;
if ( F_3 ( V_167 -> V_12 ) || ! V_167 -> V_172 )
F_41 ( V_167 -> V_147 ,
V_193 , 0 ) ;
else
F_29 ( V_167 -> V_12 , V_194 ,
V_167 -> V_136 , V_167 -> V_180 , 0 ) ;
F_9 ( V_167 -> V_39 ,
V_181 ,
V_195 ) ;
return 0 ;
}
static int F_44 ( struct V_166 * V_167 )
{
F_7 ( 400 ) ;
F_9 ( V_167 -> V_39 ,
V_181 ,
...
F_46 ( V_167 -> V_201 * 4 ) ;
if ( ! F_36 ( V_167 -> V_39 , V_167 -> V_79 ) )
break;
if ( F_15 ( V_167 -> V_79 , V_167 -> V_162 ) ) {
V_198 = true ;
break;
}
for ( V_84 = 0 ; V_84 < V_167 -> V_162 ; V_84 ++ ) {
if ( ( V_167 -> V_101 [ V_84 ] & V_109 ) == 0 )
break;
}
if ( V_84 == V_167 -> V_162 ) {
F_12 ( L_19 ) ;
...
V_167 -> V_200 = 0 ;
V_199 = V_167 -> V_101 [ 0 ] & V_112 ;
F_19 ( V_167 -> V_79 , V_167 -> V_162 , V_167 -> V_101 ) ;
F_38 ( V_167 ) ;
}
if ( ! V_198 ) {
F_12 ( L_21 ) ;
...
if ( ! F_36 ( V_167 -> V_39 , V_167 -> V_79 ) )
break;
if ( F_16 ( V_167 -> V_79 , V_167 -> V_162 ) ) {
V_202 = true ;
break;
}
if ( V_167 -> V_200 > 5 ) {
...
void F_48 ( struct V_146 * V_147 ,
struct V_126 * V_127 )
{
struct V_9 * V_10 = V_147 -> V_10 ;
struct V_11 * V_12 = V_10 -> V_13 ;
struct V_182 * V_182 = F_43 ( V_147 ) ;
struct V_183 * V_165 ;
struct V_39 * V_39 ;
struct V_41 * V_42 ;
struct V_166 V_167 ;
int V_15 ;
T_1 V_156 , V_204 , V_205 ;
if ( ! V_182 -> V_184 )
return;
V_165 = V_182 -> V_184 ;
V_39 = F_33 ( V_127 ) ;
...
V_167 . V_172 = true ;
V_15 = F_2 ( V_16 , V_138 ) ;
if ( F_49 ( V_12 -> V_20 . V_21 , V_15 , & V_204 , & V_205 ) ) {
if ( V_205 > 1 ) {
V_167 . V_172 = false ;
}
}
...
V_167 . V_180 |= V_211 ;
V_167 . V_201 = F_10 ( V_39 , V_212 ) ;
V_156 = F_10 ( V_39 , V_124 ) ;
if ( F_50 ( V_12 ) && ( V_156 & V_213 ) )
V_167 . V_203 = true ;
else
V_167 . V_203 = false ;
memcpy ( V_167 . V_118 , V_42 -> V_118 , 8 ) ;
V_167 . V_12 = V_12 ;
V_167 . V_147 = V_147 ;
V_167 . V_127 = V_127 ;
V_167 . V_39 = V_39 ;
V_167 . V_162 = V_42 -> V_162 ;
V_167 . V_136 = V_42 -> V_136 ;
if ( F_42 ( & V_167 ) )
goto V_214;
if ( F_45 ( & V_167 ) )
goto V_214;
