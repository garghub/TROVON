...
static int F_42 ( struct V_1 * V_2 , unsigned short V_105 )
{
struct V_6 * V_7 = V_2 -> V_8 ;
struct V_103 * V_81 ;
...
static int F_44 ( struct V_1 * V_2 , unsigned short V_105 )
{
struct V_103 * V_81 , * V_110 = NULL ;
struct V_6 * V_7 = V_2 -> V_8 ;
...
F_29 ( & V_7 -> V_104 ) ;
if ( V_110 ) {
F_38 ( V_7 , V_105 , V_111 ) ;
F_24 ( V_110 ) ;
}
F_45 ( V_7 -> V_2 ) ;
return 0 ;
}
static int F_46 ( struct V_6 * V_7 , int V_112 )
{
int V_11 = 0 ;
F_47 ( V_113 , 2 , L_22 ) ;
F_48 ( V_113 , 2 , & V_7 , sizeof( void * ) ) ;
F_49 ( V_7 , 0 , 1 ) ;
if ( V_7 -> V_114 . V_13 == V_115 &&
V_7 -> V_116 . V_13 == V_115 &&
( V_7 -> V_13 == V_14 ) ) {
if ( V_112 &&
V_7 -> V_16 . type != V_17 ) {
F_50 ( V_7 -> V_2 ) ;
...
while ( V_121 ) {
V_71 = F_61 ( V_7 ,
& V_7 -> V_124 . V_125 -> V_126 [ V_7 -> V_127 . V_128 ] ,
& V_7 -> V_127 . V_129 , & V_7 -> V_127 . V_130 , & V_50 ) ;
if ( ! V_71 ) {
* V_122 = 1 ;
break;
}
...
static int F_68 ( struct V_149 * V_150 , int V_121 )
{
...
if ( V_7 -> V_154 . V_155 ) {
V_7 -> V_156 . V_157 ++ ;
V_7 -> V_156 . V_158 = F_70 () ;
}
while ( 1 ) {
if ( ! V_7 -> V_127 . V_159 ) {
V_7 -> V_127 . V_160 = 0 ;
V_7 -> V_127 . V_159 = F_71 (
V_7 -> V_46 . V_161 , 0 , & V_7 -> V_127 . V_128 ,
& V_7 -> V_127 . V_160 ) ;
if ( V_7 -> V_127 . V_159 <= 0 ) {
V_7 -> V_127 . V_159 = 0 ;
break;
}
V_7 -> V_127 . V_129 =
...
while ( V_7 -> V_127 . V_159 ) {
V_152 = & V_7 -> V_124 . V_125 -> V_126 [ V_7 -> V_127 . V_128 ] ;
if ( ! ( V_7 -> V_127 . V_160 &&
F_72 ( V_7 , V_152 -> V_152 ,
V_7 -> V_127 . V_160 , L_24 ) ) )
V_123 += F_59 (
V_7 , V_153 , & V_122 ) ;
else
V_122 = 1 ;
...
F_75 ( V_150 ) ;
if ( F_76 ( V_7 -> V_46 . V_161 , 0 ) )
F_77 ( & V_7 -> V_150 ) ;
V_166:
if ( V_7 -> V_154 . V_155 )
V_7 -> V_156 . V_167 += F_70 () -
V_7 -> V_156 . V_158 ;
return V_123 ;
}
...
V_7 -> V_16 . V_117 |= V_118 ;
memcpy ( V_7 -> V_2 -> V_174 , V_5 -> V_46 . V_49 . V_48 ,
V_60 ) ;
F_81 ( & V_7 -> V_170 -> V_2 ,
L_30 ,
...
F_15 ( 2 , L_38
L_37 , F_87 ( V_7 ) , V_11 ) ;
F_86 ( V_113 , 2 , L_39 , V_11 ) ;
return V_11 ;
}
F_48 ( V_113 , 2 , V_7 -> V_2 -> V_174 , V_60 ) ;
} else {
F_90 ( V_7 -> V_2 -> V_174 ) ;
...
static int F_91 ( struct V_1 * V_2 , void * V_178 )
{
...
F_92 ( V_7 , 3 , V_180 -> V_181 , V_60 ) ;
if ( F_43 ( V_7 , V_107 ) ) {
F_14 ( V_7 , 3 , L_43 ) ;
return - V_182 ;
}
V_11 = F_84 ( V_7 , & V_7 -> V_2 -> V_174 [ 0 ] ) ;
if ( ! V_11 )
V_11 = F_82 ( V_7 , V_180 -> V_181 ) ;
return V_11 ;
}
...
F_26 ( & V_7 -> V_68 ) ;
F_94 (ha, dev)
F_21 ( V_7 , V_184 -> V_180 , 0 ) ;
F_95 (ha, dev)
F_21 ( V_7 , V_184 -> V_180 , 1 ) ;
F_29 ( & V_7 -> V_68 ) ;
if ( ! F_96 ( V_7 , V_185 ) )
return;
F_97 ( V_7 ) ;
...
int V_186 = 0 ;
struct V_6 * V_7 = V_2 -> V_8 ;
struct V_70 * V_187 = V_71 ;
int V_76 = F_99 ( V_71 ) ;
int V_77 = F_30 ( V_7 , V_71 ) ;
struct V_188 * V_189 = V_7 -> V_124 . V_190
...
if ( ( V_7 -> V_16 . type == V_17 ) &&
( V_71 -> V_133 == F_63 ( V_198 ) ) )
goto V_197;
if ( V_7 -> V_154 . V_155 ) {
V_7 -> V_156 . V_199 ++ ;
V_7 -> V_156 . V_200 = F_70 () ;
}
F_101 ( V_2 ) ;
if ( V_7 -> V_16 . type == V_17 )
...
V_193 ++ ;
F_103 ( V_187 ) ;
F_33 ( V_7 , V_50 , V_187 , V_76 , V_77 ) ;
V_50 -> V_50 . V_80 . V_86 = V_187 -> V_87 ;
...
if ( ! V_187 )
goto V_197;
V_50 = (struct V_75 * ) F_65 ( V_187 ,
sizeof( struct V_75 ) ) ;
F_105 ( V_187 , sizeof( struct V_75 ) ) ;
F_33 ( V_7 , V_50 , V_187 , V_76 , V_77 ) ;
}
}
V_186 = F_106 ( V_7 , ( void * ) V_50 , V_187 ,
V_193 ) ;
if ( ! V_186 ) {
if ( V_192 >= 0 )
F_107 ( V_202 , V_50 ) ;
...
sizeof( struct V_203 ) ) )
goto V_197;
V_11 = F_109 ( V_7 , V_189 , V_187 , V_50 ,
V_186 ) ;
} else
V_11 = F_110 ( V_7 , V_189 , V_187 , V_50 ,
V_186 , V_192 , V_194 ) ;
if ( ! V_11 ) {
V_7 -> V_146 . V_204 ++ ;
V_7 -> V_146 . V_191 += V_191 ;
if ( V_187 != V_71 )
F_67 ( V_71 ) ;
V_11 = V_205 ;
} else {
...
static int F_119 ( struct V_211 * V_170 )
{
struct V_6 * V_7 = F_120 ( & V_170 -> V_2 ) ;
F_121 ( & V_7 -> V_108 ) ;
F_121 ( & V_7 -> V_65 ) ;
V_7 -> V_154 . V_212 = 1 ;
V_7 -> V_16 . V_213 = 0 ;
V_7 -> V_214 . V_215 = V_216 ;
V_7 -> V_214 . V_217 = ( V_218 * )
V_219 ;
V_7 -> V_214 . V_220 = ( V_218 * )
V_221 ;
V_7 -> V_214 . V_222 = V_223 ;
return 0 ;
}
static void F_122 ( struct V_211 * V_224 )
{
struct V_6 * V_7 = F_120 ( & V_224 -> V_2 ) ;
F_49 ( V_7 , 0 , 1 ) ;
F_123 ( V_7 -> V_225 , F_93 ( V_7 , 0xffffffff ) == 0 ) ;
if ( V_224 -> V_13 == V_226 )
F_124 ( V_224 ) ;
if ( V_7 -> V_2 ) {
F_125 ( V_7 -> V_2 ) ;
...
case V_177 :
V_7 -> V_2 = F_127 ( 0 , L_50 , V_227 ) ;
break;
case V_17 :
V_7 -> V_2 = F_127 ( 0 , L_51 , V_227 ) ;
V_7 -> V_2 -> V_34 |= V_228 ;
break;
default:
V_7 -> V_2 = F_128 ( 0 ) ;
...
V_7 -> V_16 . V_239 = 1 ;
F_85 ( V_7 ) ;
F_130 ( V_7 -> V_2 , & V_7 -> V_170 -> V_2 ) ;
F_131 ( V_7 -> V_2 , & V_7 -> V_150 , F_68 , V_240 ) ;
return F_132 ( V_7 -> V_2 ) ;
}
static int F_133 ( struct V_211 * V_170 , int V_112 )
{
struct V_6 * V_7 = F_120 ( & V_170 -> V_2 ) ;
int V_11 = 0 ;
enum V_241 V_242 ;
...
V_7 -> V_16 . V_213 = 0 ;
V_7 -> V_13 = V_119 ;
memset ( & V_7 -> V_127 , 0 , sizeof( struct V_248 ) ) ;
F_138 ( V_7 ) ;
F_47 ( V_113 , 2 , L_54 ) ;
V_11 = F_139 ( V_7 ) ;
if ( V_11 ) {
...
static int F_150 ( struct V_211 * V_170 )
{
return F_133 ( V_170 , 0 ) ;
}
static int F_151 ( struct V_211 * V_224 ,
int V_112 )
{
struct V_6 * V_7 = F_120 ( & V_224 -> V_2 ) ;
...
F_134 ( & V_7 -> V_244 ) ;
F_47 ( V_113 , 3 , L_57 ) ;
F_48 ( V_113 , 3 , & V_7 , sizeof( void * ) ) ;
if ( V_7 -> V_2 && F_152 ( V_7 -> V_2 ) )
F_143 ( V_7 -> V_2 ) ;
V_242 = V_7 -> V_13 ;
if ( ( ! V_112 && V_7 -> V_16 . V_213 ) || V_7 -> V_16 . V_213 == 2 ) {
F_137 ( V_7 , V_255 ) ;
V_7 -> V_16 . V_213 = 1 ;
}
F_46 ( V_7 , V_112 ) ;
V_11 = F_147 ( F_148 ( V_7 ) ) ;
V_253 = F_147 ( F_149 ( V_7 ) ) ;
V_254 = F_147 ( F_12 ( V_7 ) ) ;
if ( ! V_11 )
...
if ( V_242 == V_14 )
V_7 -> V_13 = V_250 ;
F_145 ( & V_224 -> V_2 . V_251 , V_252 ) ;
F_146 ( & V_7 -> V_244 ) ;
F_146 ( & V_7 -> V_243 ) ;
return 0 ;
}
static int F_124 ( struct V_211 * V_224 )
{
return F_151 ( V_224 , 0 ) ;
}
static int V_223 ( void * V_256 )
{
struct V_6 * V_7 ;
int V_11 = 0 ;
...
static void F_159 ( struct V_211 * V_170 )
{
struct V_6 * V_7 = F_120 ( & V_170 -> V_2 ) ;
F_49 ( V_7 , 0 , 1 ) ;
if ( ( V_170 -> V_13 == V_226 ) && V_7 -> V_16 . V_213 )
F_137 ( V_7 , V_255 ) ;
F_55 ( V_7 , 0 ) ;
F_56 ( V_7 ) ;
}
static int F_160 ( struct V_211 * V_170 )
{
struct V_6 * V_7 = F_120 ( & V_170 -> V_2 ) ;
if ( V_7 -> V_2 )
F_161 ( V_7 -> V_2 ) ;
...
static int F_162 ( struct V_211 * V_170 )
{
struct V_6 * V_7 = F_120 ( & V_170 -> V_2 ) ;
int V_11 = 0 ;
if ( V_170 -> V_13 == V_257 )
...
F_14 ( V_7 , 5 , L_66 ) ;
F_123 ( V_7 -> V_225 ,
F_165 ( & V_7 -> V_116 . V_258 , 0 , 1 ) == 0 ) ;
F_166 ( V_7 , V_87 , V_100 ) ;
F_14 ( V_7 , 6 , L_67 ) ;
F_167 ( F_168 ( V_7 -> V_116 . V_161 ) , V_34 ) ;
V_11 = F_169 ( V_7 -> V_116 . V_161 , & V_7 -> V_116 . V_259 ,
( V_260 ) V_100 , 0 , 0 ) ;
F_170 ( F_168 ( V_7 -> V_116 . V_161 ) , V_34 ) ;
if ( V_11 ) {
F_15 ( 2 , L_68
L_69 , V_11 ) ;
F_5 ( V_7 , 2 , L_70 , V_11 ) ;
F_171 ( V_100 -> V_261 , V_100 ) ;
F_172 ( & V_7 -> V_116 . V_258 , 0 ) ;
F_173 ( & V_7 -> V_225 ) ;
}
return V_11 ;
}
...
T_5 V_263 , V_264 ;
F_14 ( V_7 , 4 , L_71 ) ;
F_175 ( V_7 , V_100 , V_265 ) ;
V_263 = ( T_5 ) ( V_102 + V_262 ) ;
V_264 = ( T_5 ) V_262 ;
memcpy ( F_176 ( V_100 -> V_46 ) , & V_263 , 2 ) ;
memcpy ( F_177 ( V_100 -> V_46 ) , & V_264 , 2 ) ;
memcpy ( F_178 ( V_100 -> V_46 ) , & V_264 , 2 ) ;
memcpy ( F_179 ( V_100 -> V_46 ) , & V_264 , 2 ) ;
return F_164 ( V_7 , V_263 , V_100 ) ;
}
int F_180 ( struct V_1 * V_2 , void * V_46 , int V_262 )
{
struct V_99 * V_100 ;
struct V_6 * V_7 ;
int V_11 ;
...
( V_7 -> V_13 != V_15 ) )
return - V_12 ;
V_100 = F_181 ( & V_7 -> V_116 ) ;
memcpy ( V_100 -> V_46 + V_102 , V_46 , V_262 ) ;
V_11 = F_174 ( V_7 , V_100 , V_262 ) ;
return V_11 ;
}
