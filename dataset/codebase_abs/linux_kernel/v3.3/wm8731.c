...
struct V_3 * V_4 = F_2 ( V_2 ) ;
int V_20 = 0 , V_6 ;
V_20 = F_29 ( V_2 , 7 , 9 , V_4 -> V_82 ) ;
if ( V_20 < 0 ) {
F_30 ( V_2 -> V_11 , L_2 , V_20 ) ;
return V_20 ;
}
for ( V_6 = 0 ; V_6 < F_3 ( V_4 -> V_79 ) ; V_6 ++ )
V_4 -> V_79 [ V_6 ] . V_83 = V_84 [ V_6 ] ;
...
static int T_2 F_35 ( struct V_92 * V_93 )
{
struct V_3 * V_4 ;
int V_20 ;
V_4 = F_36 ( sizeof( struct V_3 ) , V_94 ) ;
if ( V_4 == NULL )
return - V_95 ;
V_4 -> V_82 = V_96 ;
F_37 ( V_93 , V_4 ) ;
...
static int T_3 F_40 ( struct V_92 * V_93 )
{
F_41 ( & V_93 -> V_11 ) ;
F_39 ( F_42 ( V_93 ) ) ;
return 0 ;
}
static T_2 int F_43 ( struct V_99 * V_100 ,
...
static T_3 int F_45 ( struct V_99 * V_104 )
{
F_41 ( & V_104 -> V_11 ) ;
F_39 ( F_46 ( V_104 ) ) ;
return 0 ;
