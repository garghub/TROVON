...
static int F_14 ( struct V_1 * V_2 , T_4 * V_92 )
{
struct V_5 * V_6 = V_2 -> V_7 ;
int V_93 , V_94 , V_95 ;
if ( ( V_93 = F_5 ( V_6 , V_96 ) ) < 0 )
return - V_97 ;
if ( ( V_94 = F_5 ( V_6 , V_98 ) ) < 0 )
return - V_97 ;
...
if ( V_95 & ( 1 << 6 ) )
* V_92 |= V_104 ;
if ( ( * V_92 & ( V_100 | V_101 | V_103 ) ) !=
( V_100 | V_101 | V_103 ) )
* V_92 &= ~ V_102 ;
return 0 ;
}
static int F_15 ( struct V_1 * V_2 , T_2 * V_105 )
{
struct V_5 * V_6 = V_2 -> V_7 ;
* V_105 = ( F_5 ( V_6 , V_106 ) << 16 ) |
( F_5 ( V_6 , V_107 ) << 8 ) |
( F_5 ( V_6 , V_108 ) ) ;
return 0 ;
}
static int F_16 ( struct V_1 * V_2 , T_3 * V_109 )
{
struct V_5 * V_6 = V_2 -> V_7 ;
T_3 signal = ( ( F_5 ( V_6 , V_110 ) & 0x0f ) << 12 ) |
( F_5 ( V_6 , V_111 ) << 4 ) ;
* V_109 = ~ signal ;
return 0 ;
}
static int F_17 ( struct V_1 * V_2 , T_3 * V_112 )
{
struct V_5 * V_6 = V_2 -> V_7 ;
T_1 V_113 = F_5 ( V_6 , V_114 ) ;
* V_112 = ( V_113 << 8 ) | V_113 ;
return 0 ;
}
...
{
struct V_5 * V_6 = V_2 -> V_7 ;
* V_115 = ( F_5 ( V_6 , V_116 ) << 8 ) |
( F_5 ( V_6 , V_117 ) ) ;
return 0 ;
}
static int F_19 ( struct V_1 * V_2 , struct V_118 * V_119 )
{
V_119 -> V_120 = 800 ;
V_119 -> V_121 = 0 ;
V_119 -> V_122 = 0 ;
...
{
struct V_5 * V_6 = V_2 -> V_7 ;
static T_1 V_123 [] = { V_124 , 0xC0 } ;
F_8 ( L_5 , V_25 ) ;
if ( ( F_5 ( V_6 , V_27 ) & 0x10 ) == 0 ||
( F_5 ( V_6 , V_125 ) & 0x20 ) == 0 ) {
F_4 ( V_2 , V_123 , sizeof( V_123 ) ) ;
return V_6 -> V_12 . V_126 ( V_2 ) ;
}
return 0 ;
}
...
struct V_1 * F_23 ( const struct V_127 * V_12 ,
struct V_128 * V_17 )
{
struct V_5 * V_6 = NULL ;
V_6 = F_24 ( sizeof( struct V_5 ) , V_129 ) ;
if ( V_6 == NULL ) goto error;
V_6 -> V_17 = V_17 ;
memcpy ( & V_6 -> V_12 , V_12 , sizeof( struct V_127 ) ) ;
if ( F_5 ( V_6 , V_130 ) != V_131 ) goto error;
memcpy ( & V_6 -> V_132 . V_74 , & V_133 , sizeof( struct V_134 ) ) ;
V_6 -> V_132 . V_7 = V_6 ;
return & V_6 -> V_132 ;
error:
F_22 ( V_6 ) ;
