...
static int F_32 ( struct V_6 * V_10 , bool V_43 )
{
if ( F_28 ( V_10 ) )
return F_31 ( & V_10 -> V_10 , V_43 ) ;
F_30 ( V_10 -> V_42 , V_43 ) ;
return 0 ;
}
static int F_33 ( struct V_47 * V_48 , bool V_43 )
{
struct V_12 * V_10 ;
T_1 V_1 ;
if ( ! F_34 ( V_48 ) )
...
if ( V_43 ) {
F_37 ( V_10 , V_50 ) ;
F_38 ( V_10 -> V_17 . V_51 , V_10 -> V_17 . V_52 ) ;
} else {
F_39 ( V_10 -> V_17 . V_51 , V_10 -> V_17 . V_52 ) ;
F_40 ( V_10 ) ;
}
return 0 ;
}
static void F_41 ( struct V_4 * V_42 , bool V_43 )
{
while ( V_42 -> V_44 ) {
struct V_6 * V_46 = V_42 -> V_45 ;
if ( V_46 -> V_53 )
return;
if ( ! F_33 ( & V_46 -> V_10 , V_43 ) )
return;
V_42 = V_42 -> V_44 ;
}
if ( V_42 -> V_46 )
...
static int F_42 ( struct V_6 * V_10 , bool V_43 )
{
if ( V_10 -> V_53 )
return 0 ;
if ( ! F_33 ( & V_10 -> V_10 , V_43 ) )
return 0 ;
F_41 ( V_10 -> V_42 , V_43 ) ;
return 0 ;
}
static int F_43 ( struct V_47 * V_10 , T_1 * V_1 )
{
struct V_6 * V_6 ;
T_7 V_54 ;
V_6 = F_44 ( V_10 ) ;
V_54 = ( F_45 ( V_6 -> V_55 ) << 16 ) | F_46 ( V_6 -> V_55 ) ;
* V_1 = F_47 ( F_21 ( V_10 -> V_44 ) , V_54 ) ;
if ( ! * V_1 )
return - V_40 ;
return 0 ;
}
static int F_48 ( struct V_47 * V_10 , T_1 * V_1 )
{
int V_56 ;
unsigned int V_57 , V_42 ;
V_56 = sscanf ( F_49 ( V_10 ) , L_4 , & V_57 , & V_42 ) ;
if ( V_56 != 2 )
return - V_40 ;
* V_1 = F_50 ( V_57 , V_42 ) ;
if ( ! * V_1 )
