...
T_1 F_20 ( struct V_23 * V_24 , const char T_2 * V_28 , T_3 V_29 ,
T_4 * V_30 )
{
if ( ! V_29 )
return 0 ;
...
switch ( V_35 ) {
case V_39 :
return F_24 ( (struct V_40 * ) V_36 , & V_41 ,
sizeof( V_41 ) ) ? - V_33 : 0 ;
case V_42 :
case V_43 :
return F_25 ( 0 , ( int * ) V_36 ) ;
case V_44 :
F_6 () ;
return 0 ;
case V_45 :
...
{
int V_51 = F_32 ( V_1 . V_6 ) ;
if ( V_51 )
return V_51 ;
F_9 () ;
return 0 ;
}
static int T_6 F_33 ( struct V_52 * V_53 )
{
int V_54 ;
struct V_55 * V_56 = F_34 ( V_53 , V_57 , 0 ) ;
if ( ! V_56 )
return - V_58 ;
V_1 . V_2 = F_35 ( & V_53 -> V_50 , V_56 ) ;
if ( ! V_1 . V_2 )
return - V_59 ;
V_1 . V_6 = F_36 ( & V_53 -> V_50 , NULL ) ;
if ( F_37 ( V_1 . V_6 ) )
return F_38 ( V_1 . V_6 ) ;
V_54 = F_32 ( V_1 . V_6 ) ;
if ( V_54 )
...
static int T_7 F_43 ( struct V_52 * V_53 )
{
F_44 ( & V_61 ) ;
F_30 ( V_1 . V_6 ) ;
F_42 ( V_1 . V_6 ) ;
