...
V_67 -> V_124 = V_124 ;
F_110 ( & V_67 -> V_121 ) ;
V_158 = F_111 ( V_164 , V_67 -> V_130 ) ;
V_69 = F_112 ( V_165 , V_123 , V_158 , NULL , L_15 , V_159 ) ;
if ( F_53 ( V_69 ) ) {
V_22 = F_55 ( V_69 ) ;
goto V_166;
}
...
static char * F_114 ( struct V_122 * V_158 , T_8 * V_168 )
{
return F_115 ( V_13 , L_16 , F_83 ( V_158 ) ) ;
}
...
F_118 ( & V_19 [ V_169 ] ) ;
V_165 = F_119 ( V_171 , L_13 ) ;
if ( F_53 ( V_165 ) ) {
V_22 = F_55 ( V_165 ) ;
goto V_172;
}
V_165 -> V_173 = F_114 ;
V_22 = F_120 ( & V_170 , 0 , V_161 , L_13 ) ;
if ( V_22 )
goto V_174;
V_164 = F_121 ( V_170 ) ;
F_122 ( & V_175 , & V_176 ) ;
V_22 = F_123 ( & V_175 , F_111 ( V_164 , 0 ) , V_161 ) ;
if ( V_22 )
goto V_177;
