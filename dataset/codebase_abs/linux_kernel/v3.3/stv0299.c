...
F_3 ( L_19 , V_15 ) ;
if ( V_2 -> V_10 -> V_99 )
V_2 -> V_10 -> V_99 ( V_18 , 0 ) ;
if ( V_96 -> V_100 == V_101 ) V_98 = 0 ;
else if ( V_96 -> V_100 == V_102 ) V_98 = 1 ;
else {
F_20 ( L_20 ) ;
return - V_20 ;
}
if ( V_2 -> V_10 -> V_103 ) V_98 = ( ~ V_98 ) & 1 ;
F_1 ( V_2 , 0x0c , ( F_5 ( V_2 , 0x0c ) & 0xfe ) | V_98 ) ;
if ( V_18 -> V_104 . V_105 . V_106 ) {
V_18 -> V_104 . V_105 . V_106 ( V_18 ) ;
if ( V_18 -> V_104 . V_107 ) V_18 -> V_104 . V_107 ( V_18 , 0 ) ;
}
F_7 ( V_2 , V_96 -> V_108 ) ;
F_12 ( V_18 , V_96 -> V_109 ) ;
F_1 ( V_2 , 0x22 , 0x00 ) ;
F_1 ( V_2 , 0x23 , 0x00 ) ;
V_2 -> V_110 = V_96 -> V_111 ;
V_2 -> V_108 = V_96 -> V_108 ;
V_2 -> V_109 = V_96 -> V_109 ;
return 0 ;
}
...
T_5 V_112 ;
int V_98 ;
V_112 = ( T_5 ) ( V_113 ) ( ( F_5 ( V_2 , 0x22 ) << 8 )
| F_5 ( V_2 , 0x23 ) ) ;
V_112 *= ( V_2 -> V_10 -> V_42 >> 16 ) ;
V_112 += 500 ;
V_112 /= 1000 ;
V_96 -> V_111 += V_112 ;
V_98 = F_5 ( V_2 , 0x0c ) & 1 ;
if ( V_2 -> V_10 -> V_103 ) V_98 = ( ~ V_98 ) & 1 ;
V_96 -> V_100 = V_98 ? V_102 : V_101 ;
V_96 -> V_108 = F_8 ( V_2 ) ;
V_96 -> V_109 = F_14 ( V_2 ) ;
return 0 ;
}
...
static int F_33 ( struct V_17 * V_18 , int V_115 )
{
struct V_1 * V_2 = V_18 -> V_19 ;
if ( V_115 ) {
F_1 ( V_2 , 0x05 , 0xb5 ) ;
...
static int F_35 ( struct V_17 * V_18 , struct V_116 * V_117 )
{
struct V_1 * V_2 = V_18 -> V_19 ;
struct V_95 * V_96 = & V_18 -> V_97 ;
V_117 -> V_118 = V_2 -> V_10 -> V_118 ;
if ( V_96 -> V_109 < 10000000 ) {
V_117 -> V_119 = V_96 -> V_109 / 32000 ;
V_117 -> V_120 = 5000 ;
} else {
V_117 -> V_119 = V_96 -> V_109 / 16000 ;
V_117 -> V_120 = V_96 -> V_109 / 2000 ;
}
return 0 ;
}
...
struct V_17 * F_38 ( const struct V_121 * V_10 ,
struct V_122 * V_14 )
{
struct V_1 * V_2 = NULL ;
int V_123 ;
V_2 = F_39 ( sizeof( struct V_1 ) , V_124 ) ;
...
F_10 ( 200 ) ;
V_123 = F_5 ( V_2 , 0x00 ) ;
if ( V_123 != 0xa1 && V_123 != 0x80 ) goto error;
memcpy ( & V_2 -> V_125 . V_104 , & V_126 , sizeof( struct V_127 ) ) ;
V_2 -> V_125 . V_19 = V_2 ;
return & V_2 -> V_125 ;
error:
F_37 ( V_2 ) ;
