...
F_86 ( V_2 , V_18 -> V_240 -> V_241 ) ;
F_86 ( V_2 , V_18 -> V_242 -> V_241 ) ;
V_194 = V_18 -> V_242 ;
if ( ! V_194 ) {
F_16 ( & V_18 -> V_2 , L_96 ,
V_12 ) ;
...
if ( V_167 -> V_211 == 1 )
return - V_78 ;
V_246 = F_93 ( & V_167 -> V_70 , V_6 , V_246 ,
& V_167 -> V_66 ) ;
F_81 ( V_61 ) ;
return V_246 ;
}
...
static void F_101 ( struct V_46 * V_167 )
{
unsigned long V_63 ;
F_22 ( & V_167 -> V_66 , V_63 ) ;
if ( V_167 -> V_213 == V_214 )
...
static int F_104 ( struct V_46 * V_167 )
{
struct V_194 * V_194 ;
int V_8 = 0 ;
unsigned long V_63 ;
...
V_74 -> V_290 = F_103 ( V_61 ) ;
V_74 -> V_291 = F_100 ( V_61 ) ;
if ( F_99 ( V_61 ) ) {
V_74 -> V_262 |= V_292 ;
F_4 ( L_117 ,
...
static int F_113 ( struct V_46 * V_167 ,
...
static int F_118 ( struct V_128 * V_22 )
{
struct V_36 * V_195 ;
struct V_46 * V_167 ;
struct V_1 * V_2 ;
...
int V_37 ;
V_2 = V_22 -> V_2 ;
V_195 = F_119 ( sizeof( struct V_36 ) , V_41 ) ;
if ( V_195 == NULL ) {
...
V_167 = F_119 ( sizeof( struct V_46 ) , V_41 ) ;
if ( V_167 == NULL ) {
...
static void F_126 ( struct V_128 * V_22 )
{
F_4 ( L_63 , V_12 ) ;
}
...
static T_10 F_128 ( struct V_91 * V_2 ,
...
struct V_17 * V_18 = F_129 ( V_2 ) ;
struct V_46 * V_167 = F_73 ( V_18 ) ;
unsigned int V_345 = F_131 ( V_344 , NULL , 0 ) ;
...
{
return F_133 ( & V_18 -> V_2 , & V_346 ) ;
}
static int F_134 ( struct V_17 * V_18 )
{
F_135 ( & V_18 -> V_2 , & V_346 ) ;
return 0 ;
}
static int T_12 F_136 ( void )
{
int V_200 ;
V_200 = F_137 ( & V_347 ) ;
if ( V_200 )
