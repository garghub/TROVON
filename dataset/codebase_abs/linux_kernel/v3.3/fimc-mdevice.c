...
V_18 = F_53 ( V_75 , V_76 , V_78 ,
V_83 , V_79 ) ;
if ( V_18 )
return V_18 ;
V_18 = F_54 ( V_78 , V_84 , & V_78 -> V_85 [ 0 ] ,
& V_75 -> V_85 [ V_76 ] , V_79 ) ;
if ( V_18 )
break;
F_24 ( & V_37 -> V_44 , L_6 ,
...
return - V_26 ;
if ( V_102 -> V_17 ++ == 0 ) {
F_65 ( V_102 -> clock , V_42 -> V_106 ) ;
V_102 -> V_107 = V_42 -> V_106 ;
V_18 = F_66 ( V_102 -> clock ) ;
}
V_39 -> V_105 = 1 ;
F_64 ( L_15 , V_42 -> V_104 ,
F_67 ( V_102 -> clock ) ) ;
return V_18 ;
}
...
F_68 ( V_102 -> clock ) ;
V_39 -> V_105 = 0 ;
F_64 ( L_16 , V_42 -> V_104 ) ;
}
return V_18 ;
}
int F_10 ( struct V_7 * V_8 , bool V_16 )
{
struct V_38 * V_39 = F_55 ( V_8 ) ;
struct V_36 * V_37 = F_69 ( & V_8 -> V_20 ) ;
return F_34 ( V_37 , V_39 , V_16 ) ;
}
static int F_70 ( struct V_108 * V_75 ,
...
static T_1 F_73 ( struct V_59 * V_50 ,
struct V_113 * V_114 , char * V_115 )
{
struct V_63 * V_49 = F_74 ( V_50 ) ;
struct V_36 * V_37 = F_75 ( V_49 ) ;
if ( V_37 -> V_62 )
return F_76 ( V_115 , L_17 , V_116 ) ;
return F_76 ( V_115 , L_18 , V_116 ) ;
}
static T_1 F_77 ( struct V_59 * V_50 ,
struct V_113 * V_114 ,
...
static int T_3 F_78 ( struct V_63 * V_49 )
{
struct V_119 * V_44 ;
struct V_36 * V_37 ;
int V_18 ;
V_37 = F_79 ( sizeof( struct V_36 ) , V_120 ) ;
if ( ! V_37 )
return - V_121 ;
F_80 ( & V_37 -> V_87 ) ;
V_37 -> V_49 = V_49 ;
F_76 ( V_37 -> V_122 . V_123 , L_21 ,
sizeof( V_37 -> V_122 . V_123 ) ) ;
V_37 -> V_122 . V_124 = F_70 ;
...
F_81 ( & V_49 -> V_50 ) ) ;
V_18 = F_82 ( & V_49 -> V_50 , & V_37 -> V_44 ) ;
if ( V_18 < 0 ) {
F_22 ( V_44 , L_23 , V_18 ) ;
goto V_128;
}
V_18 = F_83 ( & V_37 -> V_122 ) ;
if ( V_18 < 0 ) {
F_22 ( V_44 , L_24 , V_18 ) ;
goto V_129;
}
...
static int T_4 F_90 ( struct V_63 * V_49 )
{
struct V_36 * V_37 = F_75 ( V_49 ) ;
if ( ! V_37 )
return 0 ;
F_91 ( & V_49 -> V_50 , & V_131 ) ;
F_46 ( V_37 ) ;
F_87 ( & V_37 -> V_122 ) ;
F_62 ( V_37 ) ;
F_89 ( V_37 ) ;
