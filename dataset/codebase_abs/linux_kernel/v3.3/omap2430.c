...
{
struct V_2 * V_2 = F_29 ( V_50 , struct V_2 , V_47 ) ;
struct V_51 * V_52 = V_2 -> V_20 ;
struct V_53 * V_54 = V_52 -> V_55 ;
struct V_56 * V_57 = V_54 -> V_58 ;
switch ( V_2 -> V_46 ) {
case V_59 :
F_6 ( V_2 -> V_20 , L_8 ) ;
if ( ! F_32 ( V_2 ) || V_2 -> V_60 ) {
F_33 ( V_2 -> V_20 ) ;
F_34 ( V_2 -> V_7 ) ;
F_19 ( V_2 , 1 ) ;
}
...
T_2 V_39 , V_65 = 0 ;
struct V_51 * V_52 = V_2 -> V_20 ;
struct V_53 * V_66 = V_52 -> V_55 ;
struct V_56 * V_57 = V_66 -> V_58 ;
V_2 -> V_7 = F_40 () ;
if ( ! V_2 -> V_7 ) {
F_41 ( L_12 ) ;
return - V_67 ;
...
static int T_3 F_52 ( struct V_78 * V_79 )
{
struct V_53 * V_54 = V_79 -> V_52 . V_55 ;
struct V_78 * V_2 ;
struct V_80 * V_81 ;
int V_32 = - V_82 ;
V_81 = F_53 ( sizeof( * V_81 ) , V_83 ) ;
if ( ! V_81 ) {
F_21 ( & V_79 -> V_52 , L_17 ) ;
goto V_84;
}
...
V_54 -> V_89 = & V_90 ;
F_55 ( V_79 , V_81 ) ;
V_32 = F_56 ( V_2 , V_79 -> V_91 ,
V_79 -> V_92 ) ;
if ( V_32 ) {
F_21 ( & V_79 -> V_52 , L_20 ) ;
goto V_93;
}
V_32 = F_57 ( V_2 , V_54 , sizeof( * V_54 ) ) ;
if ( V_32 ) {
F_21 ( & V_79 -> V_52 , L_21 ) ;
goto V_93;
}
...
static int T_4 F_62 ( struct V_78 * V_79 )
{
struct V_80 * V_81 = F_63 ( V_79 ) ;
F_64 ( V_81 -> V_2 ) ;
F_60 ( V_81 -> V_2 ) ;
F_65 ( & V_79 -> V_52 ) ;
F_61 ( V_81 ) ;
...
{
struct V_80 * V_81 = F_67 ( V_52 ) ;
struct V_2 * V_2 = F_68 ( V_81 ) ;
V_2 -> V_94 . V_95 = F_25 ( V_2 -> V_10 ,
V_69 ) ;
F_24 ( V_2 ) ;
F_69 ( V_2 -> V_7 , 1 ) ;
return 0 ;
