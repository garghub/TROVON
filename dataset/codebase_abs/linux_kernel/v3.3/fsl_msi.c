...
V_57 = V_29 ;
F_42 ( V_56 ) ;
switch ( V_10 -> V_66 & V_67 ) {
case V_75 :
V_59 = F_1 ( V_10 -> V_76 ,
V_58 * 0x10 ) ;
break;
case V_68 :
V_59 = F_1 ( V_10 -> V_76 , V_58 * 0x4 ) ;
break;
case V_77 :
V_64 = F_43 ( F_19 ( V_28 ) , & V_59 ) ;
if ( V_64 ) {
F_44 ( L_10
L_11 , V_28 , V_64 ) ;
V_59 = 0 ;
...
if ( V_82 -> V_18 . V_18 )
F_11 ( & V_82 -> V_18 ) ;
if ( ( V_82 -> V_66 & V_67 ) != V_77 )
F_55 ( V_82 -> V_76 ) ;
F_54 ( V_82 ) ;
return 0 ;
}
static int T_6 F_56 ( struct V_9 * V_82 ,
struct V_80 * V_49 ,
int V_87 , int V_88 )
{
struct V_62 * V_63 = NULL ;
int V_89 ;
V_89 = F_57 ( V_49 -> V_49 . V_21 , V_88 ) ;
if ( V_89 == V_29 ) {
F_31 ( & V_49 -> V_49 , L_12 ,
V_44 , V_88 ) ;
return 0 ;
}
V_63 = F_58 ( sizeof( struct V_62 ) , V_90 ) ;
if ( ! V_63 ) {
F_31 ( & V_49 -> V_49 , L_13 ) ;
return - V_48 ;
}
...
static int T_6 F_61 ( struct V_80 * V_49 )
{
...
V_92 = F_62 ( V_102 , & V_49 -> V_49 ) ;
if ( ! V_92 )
return - V_51 ;
V_100 = V_92 -> V_43 ;
F_63 ( V_103 L_14 ) ;
V_82 = F_58 ( sizeof( struct V_9 ) , V_90 ) ;
if ( ! V_82 ) {
F_31 ( & V_49 -> V_49 , L_15 ) ;
return - V_48 ;
}
F_64 ( V_49 , V_82 ) ;
V_82 -> V_20 = F_65 ( V_49 -> V_49 . V_21 , V_104 ,
V_19 , & V_105 , 0 ) ;
if ( V_82 -> V_20 == NULL ) {
F_31 ( & V_49 -> V_49 , L_16 ) ;
V_95 = - V_48 ;
...
if ( ( V_100 -> V_107 & V_67 ) != V_77 ) {
V_95 = F_66 ( V_49 -> V_49 . V_21 , 0 , & V_94 ) ;
if ( V_95 ) {
F_31 ( & V_49 -> V_49 , L_17 ,
V_49 -> V_49 . V_21 -> V_50 ) ;
goto V_106;
}
V_82 -> V_76 = F_67 ( V_94 . V_108 , F_68 ( & V_94 ) ) ;
if ( ! V_82 -> V_76 ) {
F_31 ( & V_49 -> V_49 , L_18 ,
V_49 -> V_49 . V_21 -> V_50 ) ;
goto V_106;
...
V_82 -> V_40 =
V_100 -> V_40 + ( V_94 . V_108 & 0xfffff ) ;
}
V_82 -> V_66 = V_100 -> V_107 ;
V_82 -> V_20 -> V_11 = V_82 ;
V_82 -> T_5 = V_49 -> V_49 . V_21 -> T_5 ;
V_17 = F_8 ( V_82 ) ;
if ( V_17 ) {
F_31 ( & V_49 -> V_49 , L_19 ) ;
goto V_106;
...
V_95 = F_56 ( V_82 , V_49 , V_87 + V_96 , V_88 ) ;
if ( V_95 )
goto V_106;
}
}
F_69 ( & V_82 -> V_84 , & V_110 ) ;
if ( ! V_111 . V_112 ) {
V_111 . V_112 = F_28 ;
V_111 . V_113 = F_14 ;
V_111 . V_114 = F_12 ;
} else if ( V_111 . V_112 != F_28 ) {
F_31 ( & V_49 -> V_49 , L_23 ) ;
V_95 = - V_115 ;
goto V_106;
}
