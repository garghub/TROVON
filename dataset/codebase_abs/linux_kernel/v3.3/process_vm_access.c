...
T_5 T_2
F_28 ( T_6 V_39 ,
const struct V_68 T_4 * V_11 ,
unsigned long V_40 ,
const struct V_68 T_4 * V_41 ,
unsigned long V_42 ,
unsigned long V_43 , int V_15 )
{
struct V_10 V_59 [ V_60 ] ;
...
if ( V_43 != 0 )
return - V_64 ;
if ( ! F_29 ( V_69 , V_11 , V_40 * sizeof( * V_11 ) ) )
goto V_70;
if ( ! F_29 ( V_69 , V_41 , V_42 * sizeof( * V_41 ) ) )
goto V_70;
if ( V_15 )
