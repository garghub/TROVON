...
int F_13 ( struct V_1 * V_1 , T_2 V_69 )
{
T_2 V_21 ;
int V_26 ;
if ( V_1 -> V_70 != V_71 )
...
int F_14 ( struct V_1 * V_1 , T_2 * V_78 )
{
if ( V_1 -> V_70 != V_71 )
return - V_72 ;
if ( V_78 == NULL ) {
...
int F_17 ( struct V_1 * V_1 , T_3 V_81 )
{
T_2 V_21 ;
T_1 V_82 = 0 ;
int V_26 ;
...
int F_20 ( struct V_1 * V_1 , T_3 * V_86 )
{
if ( V_1 -> V_70 != V_71 )
return - V_72 ;
if ( V_86 == NULL ) {
...
V_88 &= ~ V_97 ;
V_21 = V_88 ;
V_26 = F_5 ( V_1 , V_98 , V_33 , & V_21 ,
sizeof( V_21 ) , NULL , NULL ) ;
if ( V_26 < 0 )
return V_26 ;
return 0 ;
}
int F_22 ( struct V_1 * V_1 , T_3 V_99 )
{
T_3 V_100 ;
int V_26 ;
...
int F_23 ( struct V_1 * V_1 , T_3 * V_86 )
{
if ( V_1 -> V_70 != V_71 )
return - V_72 ;
if ( V_86 == NULL ) {
...
int F_24 ( struct V_1 * V_1 , T_3 V_101 )
{
T_3 V_100 ;
int V_26 ;
if ( V_1 -> V_70 != V_71 )
...
int F_25 ( struct V_1 * V_1 , T_2 * V_103 )
{
T_2 V_104 ;
T_1 V_25 ;
int V_26 ;
...
V_26 = F_5 ( V_1 , V_105 , V_39 , NULL , 2 ,
& V_104 , & V_25 ) ;
if ( V_26 < 0 )
return V_26 ;
* V_103 = F_9 ( V_104 ) ;
...
int F_26 ( struct V_1 * V_1 , short V_106 )
{
T_2 V_21 ;
int V_26 ;
if ( V_106 < V_107 ||
...
int F_27 ( struct V_1 * V_1 , short * V_111 )
{
if ( V_1 -> V_70 != V_71 )
return - V_72 ;
if ( V_111 == NULL ) {
...
int F_28 ( struct V_1 * V_1 , T_2 V_112 )
{
T_2 V_21 ;
int V_26 ;
...
V_21 = ( T_2 ) V_112 ;
V_26 = F_5 ( V_1 , V_115 , V_33 , & V_21 ,
sizeof( V_21 ) , NULL , NULL ) ;
if ( V_26 < 0 )
return V_26 ;
V_21 = V_116 ;
V_26 = F_5 ( V_1 , V_117 , V_33 , & V_21 ,
sizeof( V_21 ) , NULL , NULL ) ;
if ( V_26 < 0 )
return V_26 ;
return 0 ;
}
int F_29 ( struct V_1 * V_1 , T_2 * V_112 )
{
T_2 V_118 ;
T_1 V_25 ;
int V_26 ;
...
V_26 = F_5 ( V_1 , V_115 , V_39 , NULL , 2 ,
& V_118 , & V_25 ) ;
if ( V_26 < 0 )
return V_26 ;
* V_112 = F_9 ( V_118 ) ;
...
int F_30 ( struct V_1 * V_1 , T_2 V_112 )
{
T_2 V_21 ;
int V_26 ;
if ( V_1 -> V_70 != V_71 )
...
int F_31 ( struct V_1 * V_1 , T_2 * V_123 )
{
if ( V_1 -> V_70 != V_71 )
return - V_72 ;
if ( V_123 == NULL ) {
...
int F_32 ( struct V_1 * V_1 , T_3 V_124 )
{
T_2 V_21 ;
int V_26 ;
...
&& V_1 -> V_2 . V_3 . V_4 == V_5 ) {
V_21 = V_126 ;
V_26 = F_5 ( V_1 , V_127 , V_33 , & V_21 ,
sizeof( V_21 ) , NULL , NULL ) ;
if ( V_26 < 0 )
return V_26 ;
V_21 = V_128 ;
V_26 = F_5 ( V_1 , V_129 , V_33 , & V_21 ,
sizeof( V_21 ) , NULL , NULL ) ;
if ( V_26 < 0 )
return V_26 ;
...
int F_33 ( struct V_1 * V_1 , T_3 * V_134 )
{
if ( V_1 -> V_70 != V_71 )
return - V_72 ;
if ( V_134 == NULL ) {
...
int F_34 ( struct V_1 * V_1 , T_3 V_135 )
{
T_2 V_21 ;
int V_26 ;
if ( V_1 -> V_70 != V_71 )
...
int F_35 ( struct V_1 * V_1 , T_3 * V_135 )
{
if ( V_1 -> V_70 != V_71 )
return - V_72 ;
if ( V_135 == NULL ) {
