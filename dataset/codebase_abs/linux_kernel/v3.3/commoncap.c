...
V_40 -> V_94 = V_40 -> V_95 = V_40 -> V_87 ;
V_40 -> V_96 = V_40 -> V_97 = V_40 -> V_89 ;
if ( V_34 )
V_40 -> V_17 = V_40 -> V_29 ;
else
F_22 ( V_40 -> V_17 ) ;
...
int F_39 ( struct V_45 * V_45 , const char * V_101 ,
const void * V_102 , T_3 V_61 , int V_103 )
{
if ( ! strcmp ( V_101 , V_50 ) ) {
if ( ! F_7 ( V_104 ) )
return - V_18 ;
return 0 ;
}
if ( ! strncmp ( V_101 , V_105 ,
sizeof( V_105 ) - 1 ) &&
! F_7 ( V_106 ) )
return - V_18 ;
return 0 ;
}
int F_40 ( struct V_45 * V_45 , const char * V_101 )
{
if ( ! strcmp ( V_101 , V_50 ) ) {
if ( ! F_7 ( V_104 ) )
return - V_18 ;
...
{
if ( ( V_41 -> V_86 == 0 || V_41 -> V_87 == 0 || V_41 -> V_94 == 0 ) &&
( V_40 -> V_86 != 0 && V_40 -> V_87 != 0 && V_40 -> V_94 != 0 ) &&
! F_33 ( V_100 ) ) {
F_22 ( V_40 -> V_29 ) ;
F_22 ( V_40 -> V_17 ) ;
}
...
int F_42 ( struct V_8 * V_40 , const struct V_8 * V_41 , int V_103 )
{
switch ( V_103 ) {
case V_107 :
case V_108 :
...
static int F_45 ( struct V_24 * V_112 )
{
int V_113 ;
F_9 () ;
V_113 = F_12 ( F_11 ( V_112 ) -> V_29 ,
F_10 () -> V_29 ) ;
F_14 () ;
if ( ! V_113 && ! F_7 ( V_114 ) )
return - V_18 ;
...
int F_46 ( struct V_24 * V_112 )
{
return F_45 ( V_112 ) ;
}
int F_47 ( struct V_24 * V_112 , int V_115 )
{
return F_45 ( V_112 ) ;
}
int F_48 ( struct V_24 * V_112 , int V_116 )
{
return F_45 ( V_112 ) ;
}
...
int F_52 ( int V_117 , unsigned long V_118 , unsigned long V_119 ,
...
if ( ! F_50 ( V_118 ) )
goto error;
error = ! ! F_5 ( V_40 -> V_42 , V_118 ) ;
goto V_124;
case V_125 :
error = F_49 ( V_40 , V_118 ) ;
if ( error < 0 )
goto error;
goto V_126;
case V_127 :
error = - V_18 ;
if ( ( ( ( V_40 -> V_99 & V_128 ) >> 1 )
& ( V_40 -> V_99 ^ V_118 ) )
|| ( ( V_40 -> V_99 & V_128 & ~ V_118 ) )
|| ( V_118 & ~ ( V_128 | V_129 ) )
|| ( F_4 ( F_10 () ,
F_10 () -> V_15 -> V_16 , V_38 ,
V_39 ) != 0 )
...
int F_56 ( struct V_135 * V_136 , long V_137 )
{
int V_138 = 0 ;
if ( F_4 ( F_10 () , & V_13 , V_106 ,
V_139 ) == 0 )
V_138 = 1 ;
return F_57 ( V_136 , V_137 , V_138 ) ;
}
int F_58 ( struct V_77 * V_77 , unsigned long V_140 ,
unsigned long V_141 , unsigned long V_103 ,
unsigned long V_142 , unsigned long V_143 )
{
int V_27 = 0 ;
if ( V_142 < V_144 ) {
V_27 = F_4 ( F_10 () , & V_13 , V_145 ,
V_39 ) ;
if ( V_27 == 0 )
V_146 -> V_103 |= V_147 ;
}
