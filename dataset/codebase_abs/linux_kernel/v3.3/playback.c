...
F_5 ( & V_12 -> V_36 , V_23 ) ;
if ( F_9 ( V_57 , & V_12 -> V_23 ) ) {
struct V_59 * V_60 = V_85 -> V_60 ;
V_12 -> V_89 +=
V_53 / V_12 -> V_27 -> V_4 ;
if ( V_12 -> V_89 >= V_60 -> V_63 )
V_12 -> V_89 -= V_60 -> V_63 ;
}
F_32 ( V_22 , & V_12 -> V_37 ) ;
for ( V_14 = V_43 ; V_14 -- ; )
if ( V_1 -> V_47 [ V_14 ] . V_90 == - V_91 ) {
V_83 = 1 ;
break;
}
if ( F_33 ( V_22 , & V_12 -> V_74 ) )
V_83 = 1 ;
F_7 ( & V_12 -> V_36 , V_23 ) ;
if ( ! V_83 ) {
F_4 ( V_12 ) ;
...
int V_94 ;
struct V_59 * V_60 = V_85 -> V_60 ;
struct V_11 * V_12 = F_36 ( V_85 ) ;
V_94 = F_37 ( V_60 , 0 , V_95 ,
( & V_12 ->
V_27 -> V_29 ) ) ;
if ( V_94 < 0 )
return V_94 ;
V_60 -> V_96 = V_12 -> V_27 -> V_97 ;
return 0 ;
}
...
if ( V_85 -> V_100 == NULL )
return - V_82 ;
if ( V_85 -> V_100 -> V_101 == NULL )
return - V_82 ;
V_85 -> V_101 = V_85 -> V_100 -> V_101 ;
V_12 = F_36 ( V_85 ) ;
}
if ( ( V_12 -> V_23 & V_71 ) == 0 ) {
V_26 = F_27 ( V_12 ) ;
...
int F_45 ( struct V_11 * V_12 , int V_102 )
{
int V_94 ;
switch ( V_102 ) {
case V_103 :
...
F_51 ( V_43 , V_81 ) ;
if ( V_1 == NULL ) {
F_8 ( V_12 -> V_39 -> V_40 , L_7 ) ;
return - V_82 ;
}
V_1 -> V_110 = V_12 -> V_39 -> V_111 ;
V_1 -> V_112 =
F_52 ( V_12 -> V_39 -> V_111 ,
V_12 -> V_113 &
V_114 ) ;
V_1 -> V_115 = V_116 ;
V_1 -> V_88 = - 1 ;
