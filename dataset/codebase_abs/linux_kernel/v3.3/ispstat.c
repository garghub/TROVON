...
int F_79 ( struct V_104 * V_27 ,
struct V_112 * V_113 ,
struct V_114 * V_115 )
{
struct V_1 * V_2 = F_73 ( V_27 ) ;
if ( V_115 -> type != V_2 -> V_78 )
return - V_24 ;
return F_80 ( V_113 , V_115 , V_116 ) ;
}
int F_81 ( struct V_104 * V_27 ,
struct V_112 * V_113 ,
struct V_114 * V_115 )
{
return F_82 ( V_113 , V_115 ) ;
}
...
struct V_120 * V_121 = & V_27 -> V_111 ;
F_88 ( V_27 , V_119 ) ;
snprintf ( V_27 -> V_28 , V_122 , L_43 , V_28 ) ;
V_27 -> V_123 = 1 << 16 ;
V_27 -> V_48 |= V_124 | V_125 ;
F_89 ( V_27 , V_2 ) ;
V_2 -> V_126 . V_48 = V_127 ;
V_121 -> V_85 = NULL ;
return F_90 ( V_121 , 1 , & V_2 -> V_126 , 0 ) ;
}
