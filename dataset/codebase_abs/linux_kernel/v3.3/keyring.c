...
void F_61 ( struct V_4 * V_5 , struct V_44 * type ,
unsigned long V_94 )
...
F_34 ( V_5 ) ;
F_34 ( V_4 ) ;
V_14 = F_53 ( V_5 , V_4 -> type , V_4 -> V_6 , & V_94 ) ;
if ( V_14 == 0 ) {
V_14 = F_54 ( V_5 , V_4 ) ;
if ( V_14 == 0 )
F_55 ( V_5 , V_4 , & V_94 ) ;
F_61 ( V_5 , V_4 -> type , V_94 ) ;
}
return V_14 ;
}
...
F_67 ( V_5 , 0 ) ;
if ( V_17 ) {
F_58 ( V_5 -> V_19 . V_20 , NULL ) ;
F_59 ( & V_17 -> V_88 , F_68 ) ;
}
}
static bool F_71 ( struct V_4 * V_4 , T_8 V_102 )
{
return F_37 ( V_103 , & V_4 -> V_37 ) ||
( V_4 -> V_64 > 0 && V_4 -> V_64 <= V_102 ) ;
}
void F_72 ( struct V_4 * V_5 , T_8 V_102 )
{
struct V_16 * V_17 , * V_104 ;
struct V_4 * V_4 ;
int V_18 , V_105 , V_106 ;
F_56 ( L_7 , F_73 ( V_5 ) , V_5 -> V_6 ) ;
F_64 ( & V_5 -> V_95 ) ;
V_17 = F_24 ( V_5 ) ;
if ( ! V_17 )
goto V_107;
V_105 = 0 ;
for ( V_18 = V_17 -> V_22 - 1 ; V_18 >= 0 ; V_18 -- )
if ( ! F_71 ( V_17 -> V_23 [ V_18 ] , V_102 ) )
V_105 ++ ;
if ( V_105 == V_17 -> V_22 )
goto V_108;
V_106 = F_74 ( V_105 , 4 ) ;
V_104 = F_66 ( sizeof( struct V_16 ) + V_106 * sizeof( struct V_4 * ) ,
V_98 ) ;
if ( ! V_104 )
goto V_99;
V_104 -> V_26 = V_106 ;
