...
static int F_55 ( int V_155 , struct V_5 * V_6 )
{
struct V_1 * V_2 = V_6 -> V_56 ;
switch ( V_155 ) {
case V_24 :
...
static T_2 F_56 ( int V_160 , void * V_161 )
{
...
static void F_58 ( struct V_167 * V_168 )
{
struct V_1 * V_2 =
F_59 ( V_168 , struct V_1 , V_164 ) ;
F_41 ( V_2 ) ;
}
...
static int T_3 F_67 ( struct V_174 * V_33 )
{
...
F_15 ( V_2 ) ;
V_152 = F_76 ( V_2 -> V_199 , F_56 , 0 , V_33 -> V_186 , V_6 ) ;
if ( V_152 ) {
