...
V_74 = V_73 -> V_51 . V_52 ;
for ( V_75 = 0 ; V_75 < V_4 -> V_51 . V_57 ; V_75 ++ ) {
V_7 =
F_24 ( & V_4 -> V_51 .
V_52 [ V_75 ] ,
& V_74 [ V_75 ] ) ;
...
V_80 = V_79 -> V_10 . V_80 ;
V_81 = V_79 -> V_10 . V_81 ;
V_82 = sizeof( union V_1 ) ;
if ( F_26 ( V_78 ) == V_83 ) {
V_82 = sizeof( struct V_84 ) ;
}
F_6 ( F_13 ( char , V_79 ) ,
F_13 ( char , V_78 ) , V_82 ) ;
V_79 -> V_10 . V_80 = V_80 ;
...
if ( V_78 -> string . V_12 ) {
V_79 -> string . V_12 =
F_27 ( ( T_3 ) V_78 -> string .
V_13 + 1 ) ;
if ( ! V_79 -> string . V_12 ) {
return ( V_68 ) ;
}
F_6 ( V_79 -> string . V_12 ,
V_78 -> string . V_12 ,
( T_3 ) V_78 -> string . V_13 + 1 ) ;
}
break;
case V_18 :
if ( V_78 -> V_19 . V_20 == V_86 ) {
break;
}
F_28 ( V_78 -> V_19 . V_87 ) ;
break;
...
T_1 V_7 = V_8 ;
F_2 ( V_103 ) ;
V_100 -> V_10 . type = V_99 -> V_10 . type ;
V_100 -> V_10 . V_71 = V_99 -> V_10 . V_71 ;
V_100 -> V_51 . V_57 = V_99 -> V_51 . V_57 ;
V_100 -> V_51 . V_52 = F_20 ( ( ( T_3 )
V_99 -> V_51 .
V_57 +
1 ) * sizeof( void * ) ) ;
if ( ! V_100 -> V_51 . V_52 ) {
...
T_1 V_7 = V_8 ;
F_2 ( V_104 ) ;
* V_79 = F_19 ( V_78 -> V_10 . type ) ;
if ( ! * V_79 ) {
F_3 ( V_68 ) ;
}
if ( V_78 -> V_10 . type == V_56 ) {
V_7 =
F_32 ( V_78 , * V_79 ,
V_102 ) ;
} else {
