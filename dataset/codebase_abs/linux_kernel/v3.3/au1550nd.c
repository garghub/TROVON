...
if ( V_68 -> V_87 )
V_4 -> V_46 |= V_47 ;
V_4 -> V_88 = ( V_68 -> V_87 ) ? F_6 : F_1 ;
V_18 -> V_45 = ( V_68 -> V_87 ) ? F_9 : F_4 ;
V_4 -> V_89 = F_12 ;
V_4 -> V_90 = ( V_68 -> V_87 ) ? F_16 : F_13 ;
V_4 -> V_91 = ( V_68 -> V_87 ) ? F_17 : F_14 ;
V_4 -> V_92 = ( V_68 -> V_87 ) ? F_18 : F_15 ;
V_6 = F_41 ( & V_18 -> V_19 , 1 ) ;
if ( V_6 ) {
F_35 ( & V_66 -> V_71 , L_8 , V_6 ) ;
goto V_80;
}
F_42 ( & V_18 -> V_19 , V_68 -> V_93 , V_68 -> V_94 ) ;
return 0 ;
V_80:
F_43 ( V_18 -> V_21 ) ;
V_77:
