...
struct V_129 * V_130 ;
struct V_131 * V_132 ;
if ( ( V_130 = F_33 ( & V_9 -> V_133 , NULL ) ) != NULL )
F_34 ( V_130 ) ;
if ( ( V_130 = F_33 ( & V_9 -> V_134 , NULL ) ) != NULL )
F_34 ( V_130 ) ;
F_35 ( V_10 ) ;
if ( ( V_132 = F_33 ( & V_9 -> V_132 , NULL ) ) != NULL )
F_36 ( V_10 , V_132 , V_132 -> V_135 ) ;
}
int F_37 ( struct V_2 * V_3 , struct V_75 * V_76 ,
int * V_136 , int V_137 )
{
...
int F_39 ( struct V_2 * V_3 , unsigned int V_145 , unsigned long V_146 )
{
struct V_3 * V_10 = V_3 -> V_10 ;
struct V_1 * V_1 = F_18 ( V_10 ) ;
switch( V_145 )
{
case V_147 :
return F_40 ( V_10 , (struct V_148 V_149 * ) V_146 ) ;
case V_150 :
return F_41 ( V_10 , (struct V_151 V_149 * ) V_146 ) ;
case V_152 :
case V_153 :
return F_42 ( V_1 , V_145 , ( void V_149 * ) V_146 ) ;
case V_154 :
return F_43 ( V_1 , ( void V_149 * ) V_146 ) ;
case V_155 :
...
V_12 = F_49 ( V_161 , struct V_11 , V_168 ) ;
if ( V_169 & V_12 -> V_33 ) {
if ( V_4 == V_12 -> V_4 )
break;
V_162 = V_161 ;
...
V_179 . V_142 = V_9 -> V_142 ;
V_179 . V_121 = V_9 -> V_121 ;
V_179 . V_181 = V_9 -> V_144 ;
V_179 . V_182 = V_10 -> V_114 ;
V_179 . V_183 = V_10 -> V_184 ;
V_179 . V_185 = V_7 -> V_127 ;
V_179 . V_186 = V_7 -> V_71 ;
F_58 ( V_10 , F_59 ( & V_179 ) ) ;
V_176 = F_60 ( & V_179 , V_9 -> V_132 , & V_177 ) ;
V_173 = F_61 ( V_10 , & V_179 , V_176 , false ) ;
if ( F_62 ( V_173 ) ) {
V_10 -> V_187 = 0 ;
V_10 -> V_188 = - F_63 ( V_173 ) ;
return F_63 ( V_173 ) ;
}
F_64 ( V_10 , V_173 , NULL , NULL ) ;
}
return 0 ;
}
int F_65 ( struct V_3 * V_10 , struct V_129 * V_130 )
{
struct V_8 * V_9 = F_17 ( V_10 ) ;
struct V_189 * V_132 = F_66 ( V_130 ) ;
if ( V_9 -> V_190 . V_191 ) {
...
static int F_68 ( struct V_129 * V_130 , int V_13 )
{
...
int V_207 ;
if ( V_13 != V_208 ) {
V_30 = F_69 ( V_209 [ V_13 ] ) ;
if ( F_70 ( ! V_30 ) )
break;
if ( ! ( V_30 -> V_33 & V_210 ) )
break;
}
if ( F_70 ( ! F_71 ( V_130 , 8 ) ) )
break;
V_206 = ( void * ) V_130 -> V_211 ;
V_207 = F_72 ( V_206 ) ;
if ( F_70 ( ! F_71 ( V_130 , V_207 ) ) )
break;
V_13 = V_206 -> V_212 ;
F_73 ( V_130 , V_207 ) ;
}
...
int V_18 = - V_85 ;
if ( F_70 ( ! F_71 ( V_130 , sizeof( * V_214 ) ) ) )
goto V_37;
V_214 = F_75 ( V_130 ) ;
F_73 ( V_130 , sizeof( * V_214 ) ) ;
V_18 = - V_25 ;
F_3 () ;
V_30 = F_69 ( V_209 [
F_68 ( V_130 , V_214 -> V_212 ) ] ) ;
if ( F_76 ( V_30 && V_30 -> V_215 ) ) {
F_77 ( V_130 ) ;
...
static struct V_129 * F_78 ( struct V_129 * V_130 ,
T_2 V_216 )
{
struct V_129 * V_217 = F_79 ( - V_85 ) ;
struct V_213 * V_214 ;
const struct V_204 * V_30 ;
int V_13 ;
struct V_218 * V_219 ;
...
F_73 ( V_130 , sizeof( * V_214 ) ) ;
V_217 = F_79 ( - V_25 ) ;
V_13 = F_68 ( V_130 , V_214 -> V_212 ) ;
F_3 () ;
V_30 = F_69 ( V_209 [ V_13 ] ) ;
if ( F_76 ( V_30 && V_30 -> V_230 ) ) {
F_77 ( V_130 ) ;
...
sizeof( * V_214 ) ) ;
if ( V_13 == V_234 ) {
V_220 = F_81 ( V_130 , & V_221 ) ;
V_219 = (struct V_218 * ) ( F_67 ( V_130 ) +
V_220 ) ;
...
static struct V_129 * * F_82 ( struct V_129 * * V_237 ,
struct V_129 * V_130 )
{
const struct V_204 * V_30 ;
...
V_239 = F_84 ( V_130 , V_242 ) ;
if ( F_85 ( V_130 , V_241 ) ) {
V_239 = F_86 ( V_130 , V_241 , V_242 ) ;
if ( F_70 ( ! V_239 ) )
goto V_37;
}
F_87 ( V_130 , sizeof( * V_239 ) ) ;
F_88 ( V_130 , F_83 ( V_130 ) ) ;
V_243 += F_20 ( V_239 -> V_232 ) != F_89 ( V_130 ) ;
F_3 () ;
V_13 = V_239 -> V_212 ;
V_30 = F_69 ( V_209 [ V_13 ] ) ;
if ( ! V_30 || ! V_30 -> V_245 ) {
F_90 ( V_130 , F_83 ( V_130 ) ) ;
V_13 = F_68 ( V_130 , V_13 ) ;
F_87 ( V_130 , - F_91 ( V_130 ) ) ;
F_77 ( V_130 ) ;
F_92 ( V_130 , F_83 ( V_130 ) ) ;
V_30 = F_69 ( V_209 [ V_13 ] ) ;
if ( ! V_30 || ! V_30 -> V_245 )
goto V_115;
V_239 = F_75 ( V_130 ) ;
}
F_93 ( V_130 ) -> V_13 = V_13 ;
V_243 -- ;
V_240 = F_94 ( V_130 ) ;
...
V_246 = F_75 ( V_159 ) ;
if ( V_240 != F_94 ( V_159 ) ||
memcmp ( V_239 , V_246 , F_96 ( struct V_213 , V_232 ) ) ||
memcmp ( & V_239 -> V_212 , & V_246 -> V_212 ,
V_240 - F_96 ( struct V_213 , V_212 ) ) ) {
F_95 ( V_159 ) -> V_247 = 0 ;
continue;
}
F_95 ( V_159 ) -> V_243 |= V_243 ;
}
F_95 ( V_130 ) -> V_243 |= V_243 ;
V_244 = V_130 -> V_244 ;
F_97 ( V_130 , V_239 , F_94 ( V_130 ) ) ;
...
{
const struct V_204 * V_30 ;
struct V_213 * V_239 = F_75 ( V_130 ) ;
int V_18 = - V_248 ;
V_239 -> V_232 = F_14 ( V_130 -> V_207 - F_99 ( V_130 ) -
sizeof( * V_239 ) ) ;
F_3 () ;
V_30 = F_69 ( V_209 [ F_93 ( V_130 ) -> V_13 ] ) ;
...
{
if ( F_105 ( ( void V_251 * * ) V_1 -> V_252 . V_253 ,
sizeof( struct V_254 ) ,
F_106 ( struct V_254 ) ) < 0 )
return - V_255 ;
if ( F_105 ( ( void V_251 * * ) V_1 -> V_252 . V_256 ,
sizeof( struct V_254 ) ,
F_106 ( struct V_254 ) ) < 0 )
goto V_257;
if ( F_105 ( ( void V_251 * * ) V_1 -> V_252 . V_258 ,
sizeof( struct V_259 ) ,
F_106 ( struct V_259 ) ) < 0 )
goto V_260;
if ( F_105 ( ( void V_251 * * ) V_1 -> V_252 . V_261 ,
sizeof( struct V_262 ) ,
F_106 ( struct V_262 ) ) < 0 )
goto V_263;
V_1 -> V_252 . V_264 = F_107 ( sizeof( struct V_265 ) ,
V_36 ) ;
if ( ! V_1 -> V_252 . V_264 )
goto V_266;
return 0 ;
...
struct V_160 * V_272 ;
int V_18 = 0 ;
F_121 ( sizeof( struct V_189 ) > sizeof( V_271 -> V_273 ) ) ;
