...
if ( V_77 == NULL )
return 0 ;
V_77 -> V_100 -> V_101 ( V_77 , & V_98 , & V_99 ) ;
if ( ( V_2 -> V_36 & V_94 ) == 0 ) {
V_96 = V_20 -> V_22 ;
V_97 = V_20 -> V_23 ;
} else {
...
if ( V_98 < V_20 -> V_25 + V_96 ) {
F_9 ( L_19
L_20 ,
V_2 -> V_59 , V_20 -> V_25 , V_96 , V_98 ) ;
return - V_14 ;
}
if ( V_99 < V_20 -> V_26 + V_97 ) {
F_9 ( L_21
L_20 ,
V_2 -> V_59 , V_20 -> V_26 , V_97 , V_99 ) ;
return - V_14 ;
}
return 0 ;
}
