...
F_6 ( & V_3 -> V_15 , V_7 ) ;
V_8 = F_10 ( & V_3 -> V_16 . V_17 . V_18 ,
V_6 -> V_13 ,
& V_6 -> V_11 ) ;
F_8 ( & V_3 -> V_15 , V_7 ) ;
if ( V_8 != V_19 && V_8 != V_21 ) {
F_3 ( V_6 -> V_13 ) ;
V_6 -> V_13 = NULL ;
F_3 ( V_6 ) ;
V_6 = NULL ;
...
int V_29 = V_30 ;
F_6 ( & V_3 -> V_15 , V_7 ) ;
F_13 ( & V_3 -> V_16 . V_17 . V_18 , & V_26 -> V_31 ) ;
F_8 ( & V_3 -> V_15 , V_7 ) ;
V_28 . V_3 = V_3 ;
V_28 . V_32 = 0 ;
F_14 ( & V_28 . V_33 ) ;
F_6 ( & V_3 -> V_15 , V_7 ) ;
V_29 = F_15 ( & V_3 -> V_16 . V_34 , & V_26 -> V_35 ,
V_36 , & V_28 ) ;
if ( V_29 != V_19 ) {
F_8 ( & V_3 -> V_15 , V_7 ) ;
goto V_37;
...
F_14 ( & V_28 . V_33 ) ;
F_6 ( & V_3 -> V_15 , V_7 ) ;
V_29 = F_17 ( & V_3 -> V_16 . V_39 , & V_26 -> V_40 ,
V_36 , & V_28 ) ;
if ( V_29 != V_19 ) {
F_8 ( & V_3 -> V_15 , V_7 ) ;
goto V_37;
...
static int
F_24 ( struct V_52 * V_18 , T_1 V_44 , T_1 V_24 )
{
T_6 V_53 ;
V_53 = ( V_44 >> 15 ) & 0x7 ;
if ( V_53 == 0 ) {
...
struct V_5 * V_55 = V_2 -> V_20 ;
struct V_3 * V_3 = (struct V_3 * ) V_55 -> V_4 ;
struct V_52 * V_18 = & V_3 -> V_16 . V_17 . V_18 ;
...
snprintf ( V_67 , sizeof( V_67 ) , L_14 , F_5 ( V_3 -> V_14 ) ) ;
if ( ! V_3 -> V_70 ) {
V_3 -> V_70 =
F_36 ( V_67 , V_68 ) ;
if ( ! V_3 -> V_70 ) {
