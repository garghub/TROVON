...
{
struct V_91 * V_91 = V_1 -> V_92 ;
return F_20 ( V_91 -> V_93 ) ;
}
static
void F_21 ( struct V_102 * V_102 )
{
...
goto V_79;
default:
if ( F_23 ( & V_91 -> V_111 , V_112 ,
V_113 ) )
goto V_114;
F_3 ( V_14 , L_22 , V_102 -> V_105 ) ;
}
V_64 = F_24 ( V_102 , V_19 ) ;
if ( V_64 < 0 ) {
F_3 ( V_14 , L_23 ,
V_64 ) ;
goto error;
...
static void F_27 ( struct V_91 * V_91 )
{
F_28 ( & V_91 -> V_111 ) ;
}
...
struct V_104 * V_115 = V_91 -> V_98 ;
struct V_116 * V_93 = F_30 ( V_115 ) ;
struct V_13 * V_14 = & V_115 -> V_14 ;
int V_64 ;
struct V_117 * V_118 ;
V_118 = & V_115 -> V_99 -> V_119 [ 0 ] . V_100 ;
V_91 -> V_120 = ( void * ) F_31 ( V_62 ) ;
if ( V_91 -> V_120 == NULL ) {
F_3 ( V_14 , L_26 ) ;
goto V_121;
}
V_91 -> V_122 = F_32 ( 0 , V_62 ) ;
if ( V_91 -> V_122 == NULL ) {
F_3 ( V_14 , L_27 ) ;
goto V_123;
}
F_33 ( V_91 -> V_122 , V_93 ,
F_34 ( V_93 , V_118 -> V_124 ) ,
V_91 -> V_120 , V_125 ,
F_21 , V_91 , V_118 -> V_126 ) ;
V_64 = F_24 ( V_91 -> V_122 , V_19 ) ;
if ( V_64 < 0 ) {
F_3 ( V_14 , L_28 , V_64 ) ;
goto V_127;
}
...
struct V_128 * V_129 ;
struct V_13 * V_14 = & V_2 -> V_15 . V_14 ;
struct V_116 * V_93 = V_91 -> V_93 ;
char * V_130 ;
struct V_131 * V_132 ;
T_1 V_133 , V_134 ;
T_3 V_69 ;
V_134 = ( V_93 -> V_135 - V_93 -> V_136 ) /
sizeof( V_93 -> V_136 [ 0 ] ) ;
V_130 = V_93 -> V_137 [ V_134 ] ;
V_133 = F_4 ( V_93 -> V_135 -> V_100 . V_138 ) ;
while ( V_133 >= sizeof( * V_132 ) ) {
V_132 = (struct V_131 * ) V_130 ;
F_40 ( V_14 , L_29
L_30 ,
V_132 -> V_139 , V_132 -> V_140 ,
( V_130 - V_93 -> V_137 [ V_134 ] ) ,
V_133 ) ;
if ( V_132 -> V_139 == V_141 )
goto V_142;
V_130 += V_132 -> V_140 ;
V_133 -= V_132 -> V_140 ;
}
...
V_142:
V_64 = - V_17 ;
if ( V_132 -> V_140 > V_133 ) {
F_3 ( V_14 , L_32
L_33 ,
V_133 , V_132 -> V_140 ) ;
goto error;
}
if ( V_132 -> V_140 < sizeof( * V_129 ) ) {
F_3 ( V_14 , L_34
L_35 ) ;
goto error;
}
V_129 = (struct V_128 * ) V_132 ;
V_69 = F_41 ( V_129 -> V_144 ) ;
if ( V_69 != 0x0100 ) {
F_3 ( V_14 , L_36
L_37 , V_69 ) ;
V_64 = - V_17 ;
...
V_2 -> V_69 = V_69 ;
F_40 ( V_14 , L_38 , V_2 -> V_69 ) ;
V_64 = 0 ;
error:
return V_64 ;
}
static int F_42 ( struct V_104 * V_115 ,
...
F_27 ( V_91 ) ;
V_91 -> V_93 = F_44 ( F_30 ( V_115 ) ) ;
V_91 -> V_98 = F_45 ( V_115 ) ;
V_91 -> V_1 = V_1 ;
V_1 -> V_149 = V_150 ;
V_1 -> V_151 = F_29 ;
V_1 -> V_152 = F_37 ;
...
static void F_52 ( struct V_104 * V_115 )
{
struct V_91 * V_91 = F_53 ( V_115 ) ;
...
static int F_55 ( struct V_104 * V_115 )
{
struct V_91 * V_91 = F_53 ( V_115 ) ;
struct V_1 * V_1 = V_91 -> V_1 ;
F_56 ( V_1 ) ;
...
static int F_57 ( struct V_104 * V_115 )
{
struct V_91 * V_91 = F_53 ( V_115 ) ;
struct V_1 * V_1 = V_91 -> V_1 ;
return F_58 ( V_1 ) ;
