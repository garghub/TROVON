...
static void F_28 ( struct V_4 * V_4 , unsigned int V_47 )
{
struct V_17 * V_18 = V_4 -> V_19 ;
if ( V_47 >= 80 ) {
V_18 -> V_5 |= V_48 ;
...
static int F_29 ( struct V_50 * V_50 , unsigned char V_16 )
{
struct V_4 * V_51 = F_30 ( V_50 -> V_51 ) ;
char V_52 = V_53 ;
if ( F_3 ( V_51 , V_16 ) )
return - 1 ;
...
static int F_31 ( struct V_50 * V_50 )
{
struct V_4 * V_51 = F_30 ( V_50 -> V_51 ) ;
...
static int F_35 ( unsigned char * V_55 )
{
return ( V_55 [ 0 ] & 0xFC ) == 0x84 && ( V_55 [ 3 ] & 0xCC ) == 0xC4 ;
}
static void F_36 ( struct V_50 * V_56 , unsigned char * V_57 )
{
struct V_4 * V_58 = F_30 ( V_56 ) ;
...
{
struct V_17 * V_18 = V_4 -> V_19 ;
struct V_4 * V_58 = F_30 ( V_18 -> V_54 ) ;
if ( V_58 ) {
if ( V_58 -> V_61 == 4 )
V_18 -> V_5 |= V_62 ;
else
...
{
struct V_50 * V_50 ;
V_50 = F_40 ( sizeof( struct V_50 ) , V_63 ) ;
if ( ! V_50 ) {
F_27 ( V_4 ,
L_9 ) ;
return;
...
V_50 -> V_31 . type = V_64 ;
F_41 ( V_50 -> V_15 , L_10 , sizeof( V_50 -> V_15 ) ) ;
F_41 ( V_50 -> V_65 , L_11 , sizeof( V_50 -> V_15 ) ) ;
V_50 -> V_66 = F_29 ;
V_50 -> V_67 = F_31 ;
V_50 -> V_68 = F_34 ;
...
static void F_44 ( struct V_70 * V_59 , int V_71 ,
int V_72 , int V_73 )
{
V_59 -> V_71 = V_71 ;
V_59 -> V_72 = V_72 ;
...
static void F_45 ( const unsigned char V_55 [] ,
struct V_17 * V_18 ,
struct V_74 * V_75 )
{
...
break;
case 2 :
F_44 ( & V_73 -> V_80 , V_55 [ 1 ] , V_55 [ 2 ] , V_55 [ 4 ] ) ;
break;
default:
break;
}
...
static int F_46 ( const unsigned char V_55 [] ,
struct V_17 * V_18 ,
struct V_74 * V_75 )
{
...
case 1 :
if ( V_107 -> V_72 >= 2 )
F_44 ( V_80 , 3 , 0 , V_107 -> V_72 ) ;
else
F_44 ( V_80 , 3 , 0 , 2 ) ;
break;
case 2 :
if ( V_107 -> V_73 >= 3 ) {
F_44 ( V_80 , 3 , 0 , V_107 -> V_73 ) ;
break;
}
if ( V_18 -> V_108 ) {
F_44 ( V_80 , 3 , - 1 , - 1 ) ;
...
V_4 -> V_19 = V_18 = F_40 ( sizeof( struct V_17 ) , V_63 ) ;
if ( ! V_18 )
return - V_167 ;
F_97 ( V_4 ) ;
if ( F_22 ( V_4 ) ) {
...
V_18 -> V_119 = F_47 ( V_18 -> V_22 ) ? V_125 : V_128 ;
F_42 ( V_4 ,
L_21 ,
F_103 ( V_18 -> V_28 ) ,
