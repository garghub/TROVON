...
case V_234 :
case V_235 :
V_106 = ( V_69 - V_228 ) / 0x3c ;
V_17 -> V_30 [ V_106 ] = F_9 ( V_52 , V_59 ) ;
V_17 -> V_236 [ V_106 ] = V_59 ;
break;
case V_237 :
case V_238 :
case V_239 :
case V_240 :
V_106 = ( ( V_69 - V_237 ) / 0x1c ) + 8 ;
V_17 -> V_30 [ V_106 ] = F_9 ( V_52 , V_59 ) ;
V_17 -> V_236 [ V_106 ] = V_59 ;
break;
case V_241 :
...
V_90 [ V_59 + 0 ] = V_393 + ( T_1 ) ( V_103 -> V_143 . V_144 & 0xffffffff ) ;
...
V_77 = F_5 ( V_52 ) ;
if ( V_77 ) {
F_6 ( V_52 -> V_55 , L_28 , V_402 , __LINE__ ) ;
return V_77 ;
}
break;
case V_403 :
...
V_90 [ V_59 + 1 ] = V_393 + ( T_1 ) ( V_103 -> V_143 . V_144 & 0xffffffff ) ;
...
V_77 = F_5 ( V_52 ) ;
if ( V_77 ) {
F_6 ( V_52 -> V_55 , L_32 , V_402 , __LINE__ , V_59 ) ;
return V_77 ;
}
break;
case V_406 :
...
V_426 = F_9 ( V_52 , V_59 + 1 + ( V_18 * 8 ) + 0 ) ;
V_425 = F_9 ( V_52 , V_59 + 1 + ( V_18 * 8 ) + 1 ) ;
if ( V_52 -> V_95 && ( V_425 + V_426 ) > F_39 ( V_103 -> V_155 ) ) {
F_6 ( V_52 -> V_55 , L_49 ) ;
V_90 [ V_59 + 1 + ( V_18 * 8 ) + 1 ] = F_39 ( V_103 -> V_155 ) ;
}
...
int V_77 ;
if ( V_52 -> V_17 == NULL ) {
V_17 = F_41 ( sizeof( * V_17 ) , V_444 ) ;
if ( V_17 == NULL )
return - V_445 ;
F_4 ( V_17 ) ;
if ( V_52 -> V_95 -> V_107 >= V_108 )
V_106 = V_52 -> V_95 -> V_446 . V_447 . V_448 ;
else
V_106 = V_52 -> V_95 -> V_446 . V_449 . V_448 ;
switch ( V_106 & 0xf ) {
case 0 :
V_17 -> V_450 = 1 ;
break;
...
static int F_44 ( struct V_522 * V_95 ,
T_1 * V_90 , struct V_57 * V_58 )
{
T_1 V_59 = V_58 -> V_59 + 1 ;
T_1 V_393 = V_90 [ V_59 ] ;
T_1 V_391 , V_392 , V_69 , V_18 ;
switch ( V_58 -> V_71 ) {
case V_79 :
case V_523 :
case V_399 :
...
int F_45 ( struct V_522 * V_95 , struct V_539 * V_90 )
{
int V_540 = 0 ;
T_1 V_59 = 0 ;
struct V_57 V_58 ;
do {
V_58 . V_59 = V_59 ;
V_58 . type = F_10 ( V_90 -> V_91 [ V_59 ] ) ;
V_58 . V_66 = F_11 ( V_90 -> V_91 [ V_59 ] ) ;
V_58 . V_67 = 0 ;
switch ( V_58 . type ) {
case V_68 :
F_31 ( V_95 -> V_55 , L_56 ) ;
...
break;
case V_70 :
V_58 . V_71 = F_13 ( V_90 -> V_91 [ V_59 ] ) ;
V_540 = F_44 ( V_95 , V_90 -> V_91 , & V_58 ) ;
V_59 += V_58 . V_66 + 2 ;
break;
default:
F_31 ( V_95 -> V_55 , L_55 , V_58 . type ) ;
V_540 = - V_56 ;
break;
}
if ( V_540 )
break;
} while ( V_59 < V_90 -> V_65 );
return V_540 ;
}
