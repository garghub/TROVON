...
static inline unsigned long F_23 ( unsigned long V_46 )
{
...
{
struct V_1 * V_2 , * V_31 ;
if ( V_65 -> V_66 && ! ( V_65 -> V_67 & V_68 ) )
return - 1 ;
if ( ! V_65 -> V_66 )
return V_5 ;
F_17 ( & V_32 ) ;
F_18 (range, next, &ashmem_lru_list, lru) {
struct V_19 * V_19 = V_2 -> V_7 -> V_20 -> V_69 -> V_70 ;
T_4 V_10 = V_2 -> V_15 * V_71 ;
T_4 V_11 = ( V_2 -> V_16 + 1 ) * V_71 - 1 ;
F_33 ( V_19 , V_10 , V_11 ) ;
V_2 -> V_9 = V_72 ;
F_4 ( V_2 ) ;
V_65 -> V_66 -= F_3 ( V_2 ) ;
