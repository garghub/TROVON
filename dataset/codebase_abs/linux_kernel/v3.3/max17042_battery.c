...
V_18 -> V_25 = V_5 ;
if ( V_18 -> V_25 & 0x8000 ) {
V_18 -> V_25 = ( 0x7fff & ~ V_18 -> V_25 ) + 1 ;
V_18 -> V_25 *= - 1 ;
}
V_18 -> V_25 = V_18 -> V_25 * 10 / 256 ;
break;
case V_43 :
if ( V_20 -> V_44 -> V_45 ) {
...
V_18 -> V_25 = V_5 ;
if ( V_18 -> V_25 & 0x8000 ) {
V_18 -> V_25 = ~ V_18 -> V_25 & 0x7fff ;
V_18 -> V_25 ++ ;
V_18 -> V_25 *= - 1 ;
}
V_18 -> V_25 *= 1562500 / V_20 -> V_44 -> V_47 ;
} else {
return - V_48 ;
}
break;
