...
V_53 = ( V_53 + sizeof( T_2 ) ) & V_76 ;
V_56 = ( V_56 + 2 * sizeof( T_3 ) ) & V_54 ;
V_22 -= sizeof( T_2 ) ;
}
...
V_56 = ( V_56 + sizeof( T_2 ) ) & V_76 ;
V_53 = ( V_53 + 2 * sizeof( T_3 ) ) & V_79 ;
V_22 -= sizeof( T_2 ) ;
}
...
static T_5 F_30 ( int V_92 , void * V_93 )
{
...
static T_5 F_32 ( int V_92 , void * V_93 )
{
struct V_82 * V_67 = V_93 ;
struct V_81 * V_63 ;
struct V_3 * V_4 ;
...
static T_5 F_33 ( int V_92 , void * V_93 )
{
struct V_82 * V_67 = V_93 ;
struct V_81 * V_63 ;
V_63 = V_67 -> V_63 ;
...
static int T_1 F_58 ( struct V_121 * V_42 ,
struct V_3 * * V_122 )
{
struct V_3 * V_4 ;
int V_113 , V_41 ;
...
static int T_1 F_67 ( struct V_138 * V_139 )
{
struct V_121 * V_42 ;
struct V_3 * V_4 ;
int V_41 ;
...
static int T_7 F_73 ( struct V_138 * V_139 )
{
