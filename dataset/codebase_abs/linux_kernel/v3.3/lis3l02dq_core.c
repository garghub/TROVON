...
static T_7 F_20 ( struct V_57 * V_28 ,
struct V_58 * V_59 ,
char * V_60 )
{
...
switch ( V_61 ) {
case V_64 :
V_20 = sprintf ( V_60 , L_2 ) ;
break;
case V_65 :
V_20 = sprintf ( V_60 , L_3 ) ;
break;
case V_66 :
V_20 = sprintf ( V_60 , L_4 ) ;
break;
case V_67 :
V_20 = sprintf ( V_60 , L_5 ) ;
break;
}
return V_20 ;
}
static T_7 F_22 ( struct V_57 * V_28 ,
struct V_58 * V_59 ,
const char * V_60 ,
T_8 V_20 )
{
...
static T_1 F_26 ( int V_1 , void * V_2 )
{
struct V_4 * V_5 = V_2 ;
T_2 V_61 ;
T_9 V_78 = F_27 () ;
...
static int T_10 F_35 ( struct V_100 * V_101 )
{
int V_12 ;
struct V_8 * V_9 ;
struct V_4 * V_5 ;
...
V_9 -> V_22 = V_101 ;
F_38 ( & V_9 -> V_21 ) ;
V_5 -> V_103 = V_101 -> V_28 . V_104 -> V_103 ;
V_5 -> V_28 . V_105 = & V_101 -> V_28 ;
V_5 -> V_106 = & V_107 ;
V_5 -> V_108 = V_109 ;
V_5 -> V_110 = F_39 ( V_109 ) ;
V_5 -> V_111 = V_112 ;
V_12 = F_40 ( V_5 ) ;
if ( V_12 )
goto V_113;
...
if ( V_101 -> V_1 && F_43 ( F_44 ( V_101 -> V_1 ) ) > 0 ) {
V_12 = F_45 ( V_9 -> V_22 -> V_1 ,
& V_116 ,
& F_26 ,
V_117 ,
L_11 ,
