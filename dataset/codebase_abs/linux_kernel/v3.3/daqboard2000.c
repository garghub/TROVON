...
V_6 -> V_90 = 1 ;
V_6 -> V_43 =
F_37 ( F_38 ( V_73 , 0 ) , V_91 ) ;
V_6 -> V_7 =
F_37 ( F_38 ( V_73 , 2 ) , V_92 ) ;
if ( ! V_6 -> V_43 || ! V_6 -> V_7 )
return - V_80 ;
V_50 = F_39 ( V_2 , 3 ) ;
if ( V_50 < 0 )
...
static int T_3 F_48 ( struct V_72 * V_2 ,
const struct V_113
* V_114 )
{
return F_49 ( V_2 , V_115 . V_116 ) ;
}
static void T_4 F_50 ( struct V_72 * V_2 )
{
F_51 ( V_2 ) ;
}
