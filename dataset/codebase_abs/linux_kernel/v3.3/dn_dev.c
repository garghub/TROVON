...
int F_117 ( struct V_197 * V_198 )
{
return F_118 ( & V_52 , V_198 ) ;
}
int F_119 ( struct V_197 * V_198 )
{
return F_120 ( & V_52 , V_198 ) ;
}
static inline int F_121 ( struct V_1 * V_2 )
{
return V_2 -> V_31 != NULL ;
}
static void * F_122 ( struct V_199 * V_116 , T_4 * V_200 )
__acquires( T_8 )
{
int V_7 ;
struct V_1 * V_2 ;
...
static void * F_123 ( struct V_199 * V_116 , void * V_202 , T_4 * V_200 )
{
struct V_1 * V_2 ;
++ * V_200 ;
V_2 = V_202 ;
if ( V_202 == V_201 )
V_2 = F_124 ( & V_76 . V_203 ) ;
F_125 (&init_net, dev) {
if ( ! F_121 ( V_2 ) )
continue;
return V_2 ;
...
static void F_126 ( struct V_199 * V_116 , void * V_202 )
__releases( T_8 )
{
F_79 () ;
}
static char * F_127 ( char type )
{
switch ( type ) {
case V_204 :
return L_4 ;
...
static int F_128 ( struct V_199 * V_116 , void * V_202 )
{
if ( V_202 == V_201 )
F_129 ( V_116 , L_8 ) ;
else {
...
F_127 ( V_26 -> V_4 . V_210 ) ,
0 , 0 ,
V_26 -> V_157 , V_26 -> V_4 . V_157 ,
F_13 ( V_2 ) ,
V_26 -> V_4 . V_164 ,
V_26 -> V_4 . V_211 , V_26 -> V_4 . V_16 ,
V_26 -> V_153 ? F_131 ( F_90 ( * ( V_87 * ) V_26 -> V_153 -> V_212 ) , V_209 ) : L_12 ,
V_26 -> V_195 ? F_131 ( F_90 ( * ( V_87 * ) V_26 -> V_195 -> V_212 ) , V_207 ) : L_12 ) ;
}
return 0 ;
}
static int F_132 ( struct V_213 * V_213 , struct V_214 * V_214 )
{
return F_133 ( V_214 , & V_215 ) ;
}
void T_9 F_134 ( void )
{
...
F_116 () ;
F_136 ( V_217 , V_56 , F_57 , NULL , NULL ) ;
F_136 ( V_217 , V_51 , F_50 , NULL , NULL ) ;
F_136 ( V_217 , V_218 , NULL , F_74 , NULL ) ;
F_137 ( & V_76 , L_15 , V_219 , & V_220 ) ;
#ifdef F_138
{
int V_7 ;
