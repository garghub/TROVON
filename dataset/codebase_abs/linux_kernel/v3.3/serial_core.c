...
V_287 -> V_290 = V_218 -> V_290 ;
V_287 -> V_291 = V_218 -> F_128 ;
V_287 -> V_264 = V_218 -> V_264 ;
V_287 -> V_265 = V_218 -> V_292 ;
V_287 -> type = V_293 ;
V_287 -> V_294 = V_295 ;
V_287 -> V_296 = V_297 ;
V_287 -> V_296 . V_34 = V_298 | V_255 | V_252 | V_45 | V_76 ;
V_287 -> V_296 . V_197 = V_287 -> V_296 . V_196 = 9600 ;
V_287 -> V_8 = V_299 | V_300 ;
V_287 -> V_220 = V_218 ;
F_143 ( V_287 , & V_270 ) ;
for ( V_229 = 0 ; V_229 < V_218 -> V_239 ; V_229 ++ ) {
struct V_3 * V_4 = V_218 -> V_4 + V_229 ;
...
{
struct V_236 * V_302 = V_218 -> V_236 ;
F_149 ( V_302 ) ;
F_146 ( V_302 ) ;
F_147 ( V_218 -> V_4 ) ;
V_218 -> V_236 = NULL ;
...
{
struct V_217 * V_302 = V_245 -> V_241 ;
* V_89 = V_245 -> V_89 ;
return V_302 -> V_236 ;
}
...
int F_160 ( struct V_1 * V_305 , struct V_1 * V_306 )
{
if ( V_305 -> V_108 != V_306 -> V_108 )
return 0 ;
switch ( V_305 -> V_108 ) {
case V_276 :
return ( V_305 -> V_97 == V_306 -> V_97 ) ;
case V_277 :
return ( V_305 -> V_97 == V_306 -> V_97 ) &&
( V_305 -> V_106 == V_306 -> V_106 ) ;
case V_234 :
case V_278 :
case V_279 :
case V_280 :
return ( V_305 -> V_112 == V_306 -> V_112 ) ;
}
return 0 ;
}
...
struct V_24 * V_2 = & V_4 -> V_2 ;
struct V_307 * V_308 = F_162 ( V_2 -> V_5 ) ;
struct V_309 V_310 ;
if ( V_308 && V_308 -> V_10 -> V_311 )
F_163 ( & V_310 ) ;
V_23 -> V_161 . V_170 ++ ;
#ifdef F_164
if ( ( V_23 -> V_8 & V_312 ) && V_232 )
F_165 () ;
#endif
if ( V_2 -> V_8 & V_313 ) {
if ( V_232 )
...
if ( V_308 && V_308 -> V_10 -> V_311 )
V_308 -> V_10 -> V_311 ( V_2 -> V_5 , V_232 , & V_310 ) ;
if ( V_308 )
F_167 ( V_308 ) ;
}
...
unsigned int V_177 , unsigned int V_85 , unsigned int V_314 )
{
struct V_6 * V_5 = V_2 -> V_4 -> V_2 . V_5 ;
if ( ( V_232 & V_2 -> V_315 & ~ V_177 ) == 0 )
F_170 ( V_5 , V_85 , V_314 ) ;
if ( V_232 & ~ V_2 -> V_315 & V_177 )
F_170 ( V_5 , 0 , V_316 ) ;
}
