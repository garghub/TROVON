...
int F_109 ( struct V_2 * V_3 , struct V_143 * V_144 )
{
int V_51 = V_144 -> V_51 ;
...
void F_111 ( struct V_2 * V_3 , struct V_143 * V_144 )
{
F_103 ( V_144 ) ;
F_77 ( V_3 ) ;
}
static struct V_143 * F_112 ( struct V_143 * V_144 , T_5 V_150 )
{
int V_151 ;
F_113 ( V_144 ) ;
...
return V_144 ;
if ( F_114 ( V_144 ) ) {
struct V_143 * V_155 = F_115 ( V_144 , V_150 ) ;
if ( ! V_155 )
return V_144 ;
F_103 ( V_144 ) ;
V_144 = V_155 ;
}
if ( ! F_116 ( V_144 , 0 , - V_151 , V_150 ) )
V_144 -> V_154 -= V_151 ;
return V_144 ;
}
...
static int F_121 ( struct V_2 * V_3 , struct V_143 * V_144 )
{
int V_156 ;
struct V_1 * V_14 = F_1 ( V_3 ) ;
V_156 = - V_133 ;
...
int F_122 ( struct V_2 * V_132 , struct V_143 * V_144 ,
T_1 V_10 , int V_158 )
{
struct V_2 * V_3 ;
int V_60 ;
long V_145 ;
V_144 = F_112 ( V_144 , F_123 () ) ;
V_145 = F_124 ( V_132 , V_158 ) ;
V_96:
V_3 = F_96 ( V_132 , V_10 ) ;
if ( F_125 ( V_3 ) ) {
F_103 ( V_144 ) ;
...
if ( V_60 )
return V_60 ;
return F_109 ( V_3 , V_144 ) ;
}
int F_128 ( struct V_2 * V_3 , unsigned int V_6 )
{
int V_159 = 0 ;
struct V_58 * V_58 ;
F_76 ( ! F_3 ( V_3 ) ) ;
F_129 () ;
V_58 = F_130 ( V_31 [ V_3 -> V_56 ] . V_58 ) ;
if ( V_6 - 1 < V_31 [ V_3 -> V_56 ] . V_22 )
V_159 = F_102 ( V_6 - 1 , V_58 -> V_59 ) ;
F_131 () ;
return V_159 ;
}
static int F_132 ( struct V_2 * V_3 , struct V_143 * V_144 )
{
struct V_1 * V_14 = F_1 ( V_3 ) ;
if ( F_13 ( & V_3 -> V_20 ) <= V_3 -> V_146 &&
! F_102 ( 0 , & V_14 -> V_80 ) ) {
...
F_36 ( V_3 ) ;
if ( V_161 -> V_165 == NULL ) {
if ( F_114 ( V_161 -> V_144 ) ) {
V_161 -> V_165 = F_115 ( V_161 -> V_144 , V_161 -> V_150 ) ;
} else {
V_161 -> V_165 = F_134 ( V_161 -> V_144 ) ;
F_113 ( V_161 -> V_165 ) ;
}
}
if ( V_161 -> V_165 == NULL ) {
...
F_103 ( V_161 -> V_165 ) ;
V_161 -> V_165 = NULL ;
} else if ( F_127 ( V_3 , V_161 -> V_165 ) ) {
F_103 ( V_161 -> V_165 ) ;
V_161 -> V_165 = NULL ;
} else if ( ( V_162 = F_132 ( V_3 , V_161 -> V_165 ) ) < 0 ) {
F_94 ( V_3 ) ;
if ( V_14 -> V_4 & V_166 )
V_161 -> V_167 = 1 ;
} else {
...
int F_135 ( struct V_2 * V_132 , struct V_143 * V_144 , T_1 V_10 ,
T_1 V_6 , T_5 V_150 ,
int (* F_136)( struct V_2 * V_172 , struct V_143 * V_144 , void * V_173 ) ,
void * V_174 )
{
...
int F_139 ( struct V_2 * V_132 , struct V_143 * V_144 , T_1 V_10 ,
T_1 V_6 , T_5 V_150 )
{
return F_135 ( V_132 , V_144 , V_10 , V_6 , V_150 ,
NULL , NULL ) ;
}
static int F_140 ( struct V_2 * V_3 , struct V_178 * V_161 )
{
struct V_1 * V_14 = F_1 ( V_3 ) ;
int V_156 = 0 ;
if ( V_3 == V_161 -> V_163 )
...
int F_141 ( struct V_2 * V_132 , T_1 V_10 , T_1 V_6 , int V_179 )
{
struct V_178 V_175 ;
struct V_33 * V_34 ;
struct V_2 * V_3 ;
...
if ( V_182 )
F_143 ( V_6 - 1 , V_14 -> V_22 ) ;
else
F_144 ( V_6 - 1 , V_14 -> V_22 ) ;
F_83 ( & V_14 -> V_3 , V_67 ) ;
F_51 ( & V_14 -> V_3 ) ;
}
static int F_145 ( struct V_68 * V_2 , int V_183 , int V_184 ,
...
return - V_188 ;
if ( V_186 >= sizeof( int ) &&
F_146 ( V_162 , ( unsigned int T_6 * ) V_185 ) )
return - V_189 ;
switch ( V_184 ) {
case V_190 :
if ( V_162 )
...
static int F_147 ( struct V_68 * V_2 , int V_183 , int V_184 ,
...
static void F_149 ( struct V_196 * V_197 , struct V_143 * V_144 )
{
struct V_198 V_175 ;
V_175 . V_6 = F_150 ( V_144 ) . V_122 ;
F_151 ( V_197 , V_187 , V_190 , sizeof( V_175 ) , & V_175 ) ;
}
static int F_152 ( struct V_199 * V_199 , struct V_68 * V_2 ,
struct V_196 * V_197 , T_3 V_51 )
{
struct V_200 * V_201 = F_153 ( V_199 ) ;
struct V_2 * V_3 = V_2 -> V_3 ;
struct V_1 * V_14 = F_1 ( V_3 ) ;
...
if ( NULL == V_201 -> V_204 )
V_201 -> V_204 = & V_204 ;
V_60 = F_154 ( V_2 , V_197 , V_201 -> V_204 ) ;
if ( V_60 < 0 )
return V_60 ;
if ( V_197 -> V_208 ) {
V_60 = - V_111 ;
...
goto V_88;
V_60 = - V_129 ;
V_144 = F_155 ( V_51 , V_74 ) ;
if ( V_144 == NULL )
goto V_88;
F_150 ( V_144 ) . V_10 = V_14 -> V_10 ;
F_150 ( V_144 ) . V_122 = V_122 ;
memcpy ( F_156 ( V_144 ) , & V_201 -> V_204 -> V_211 , sizeof( struct V_212 ) ) ;
V_60 = - V_189 ;
if ( F_157 ( F_158 ( V_144 , V_51 ) , V_197 -> V_213 , V_51 ) ) {
F_103 ( V_144 ) ;
goto V_88;
}
V_60 = F_159 ( V_3 , V_144 ) ;
if ( V_60 ) {
F_103 ( V_144 ) ;
goto V_88;
}
if ( V_122 ) {
F_28 ( & V_144 -> V_214 ) ;
F_139 ( V_3 , V_144 , V_121 , V_122 , V_74 ) ;
}
V_60 = F_122 ( V_3 , V_144 , V_121 , V_197 -> V_205 & V_215 ) ;
V_88:
F_160 ( V_201 -> V_204 ) ;
return V_60 ;
}
static int F_161 ( struct V_199 * V_199 , struct V_68 * V_2 ,
struct V_196 * V_197 , T_3 V_51 ,
int V_4 )
{
struct V_200 * V_201 = F_153 ( V_199 ) ;
...
return - V_207 ;
V_217 = 0 ;
V_144 = F_162 ( V_3 , V_4 , V_216 , & V_60 ) ;
if ( V_144 == NULL )
goto V_88;
V_218 = V_144 ;
#ifdef F_163
if ( F_49 ( F_164 ( V_144 ) -> V_219 ) ) {
if ( V_4 & V_220 )
V_218 = F_164 ( V_144 ) -> V_219 ;
}
#endif
V_197 -> V_208 = 0 ;
V_217 = V_218 -> V_51 ;
...
F_165 ( V_218 ) ;
V_60 = F_166 ( V_218 , 0 , V_197 -> V_213 , V_217 ) ;
if ( V_197 -> V_202 ) {
struct V_107 * V_105 = (struct V_107 * ) V_197 -> V_202 ;
V_105 -> V_109 = V_110 ;
V_105 -> V_126 = 0 ;
V_105 -> V_115 = F_150 ( V_144 ) . V_10 ;
V_105 -> V_112 = F_4 ( F_150 ( V_144 ) . V_122 ) ;
...
F_169 ( V_2 , V_197 , V_201 -> V_204 , V_4 ) ;
V_88:
F_117 ( V_3 ) ;
return V_60 ? : V_217 ;
}
static void F_170 ( struct V_2 * V_3 , int V_51 )
{
F_171 () ;
}
struct V_2 *
F_172 ( struct V_29 * V_29 , int V_222 , unsigned int V_22 ,
void (* F_173)( struct V_143 * V_144 ) ,
...
int F_180 ( struct V_2 * V_3 , unsigned int V_22 )
{
...
if ( ! V_182 )
return - V_64 ;
V_181 = F_181 ( V_55 -> V_58 , 1 ) ;
memcpy ( V_182 -> V_59 , V_181 -> V_59 , F_87 ( V_55 -> V_22 ) ) ;
F_176 ( V_55 -> V_58 , V_182 ) ;
F_182 ( V_181 , V_226 ) ;
}
V_55 -> V_22 = V_22 ;
return 0 ;
}
int F_183 ( struct V_2 * V_3 , unsigned int V_22 )
{
int V_60 ;
F_14 () ;
V_60 = F_180 ( V_3 , V_22 ) ;
...
void F_184 ( struct V_2 * V_227 , unsigned int V_6 )
{
struct V_2 * V_3 ;
struct V_33 * V_34 ;
...
void F_186 ( int V_30 , unsigned int V_4 )
{
...
V_231 = F_188 ( int , V_15 -> V_233 , V_234 ) ;
V_144 = F_189 ( V_3 , V_231 , 0 , V_74 ) ;
if ( ! V_144 )
goto V_232;
V_51 = V_15 -> V_235 ( V_144 , V_15 ) ;
if ( V_51 > 0 ) {
F_190 ( V_14 -> V_70 ) ;
if ( F_127 ( V_3 , V_144 ) )
F_103 ( V_144 ) ;
...
V_230 = F_191 ( V_144 , V_15 , V_236 , sizeof( V_51 ) , V_237 ) ;
if ( ! V_230 )
goto V_232;
F_192 ( V_15 , V_230 ) ;
memcpy ( F_193 ( V_230 ) , & V_51 , sizeof( V_51 ) ) ;
if ( F_127 ( V_3 , V_144 ) )
F_103 ( V_144 ) ;
else {
F_110 ( & V_3 -> V_17 , V_144 ) ;
...
int F_194 ( struct V_2 * V_132 , struct V_143 * V_144 ,
const struct V_229 * V_230 ,
int (* V_235)( struct V_143 * V_144 ,
struct V_228 * ) ,
int (* V_16)( struct V_228 * ) ,
T_7 V_233 )
{
struct V_228 * V_15 ;
struct V_2 * V_3 ;
...
F_28 ( & V_144 -> V_214 ) ;
V_15 -> V_144 = V_144 ;
V_3 = F_32 ( F_35 ( V_132 ) , V_132 -> V_56 , F_150 ( V_144 ) . V_10 ) ;
if ( V_3 == NULL ) {
F_8 ( V_15 ) ;
return - V_133 ;
}
...
void F_195 ( struct V_143 * V_239 , struct V_229 * V_230 , int V_60 )
{
struct V_143 * V_144 ;
struct V_229 * V_240 ;
struct V_241 * V_242 ;
T_3 V_243 = sizeof( * V_242 ) ;
if ( V_60 )
V_243 += F_196 ( V_230 ) ;
V_144 = F_197 ( V_243 , V_74 ) ;
if ( ! V_144 ) {
struct V_2 * V_3 ;
V_3 = F_32 ( F_35 ( V_239 -> V_3 ) ,
V_239 -> V_3 -> V_56 ,
F_150 ( V_239 ) . V_10 ) ;
if ( V_3 ) {
V_3 -> V_128 = V_129 ;
...
V_240 = F_198 ( V_144 , F_150 ( V_239 ) . V_10 , V_230 -> V_244 ,
V_245 , V_243 , 0 ) ;
V_242 = F_193 ( V_240 ) ;
V_242 -> error = V_60 ;
memcpy ( & V_242 -> V_197 , V_230 , V_60 ? V_230 -> F_196 : sizeof( * V_230 ) ) ;
F_122 ( V_239 -> V_3 , V_144 , F_150 ( V_239 ) . V_10 , V_215 ) ;
}
int F_199 ( struct V_143 * V_144 , int (* V_15)( struct V_143 * ,
struct V_229 * ) )
{
struct V_229 * V_230 ;
int V_60 ;
while ( V_144 -> V_51 >= F_200 ( 0 ) ) {
int V_246 ;
V_230 = F_201 ( V_144 ) ;
V_60 = 0 ;
if ( V_230 -> F_196 < V_247 || V_144 -> V_51 < V_230 -> F_196 )
return 0 ;
if ( ! ( V_230 -> V_248 & V_249 ) )
goto V_250;
if ( V_230 -> V_251 < V_252 )
goto V_250;
V_60 = V_15 ( V_144 , V_230 ) ;
if ( V_60 == - V_238 )
goto V_253;
V_250:
if ( V_230 -> V_248 & V_254 || V_60 )
F_195 ( V_144 , V_230 , V_60 ) ;
V_253:
V_246 = F_202 ( V_230 -> F_196 ) ;
if ( V_246 > V_144 -> V_51 )
V_246 = V_144 -> V_51 ;
F_203 ( V_144 , V_246 ) ;
}
...
int F_204 ( struct V_2 * V_3 , struct V_143 * V_144 , T_1 V_10 ,
unsigned int V_6 , int V_255 , T_5 V_4 )
{
int V_60 = 0 ;
if ( V_6 ) {
int V_256 = 0 ;
...
V_60 = F_205 ( V_3 , V_144 , V_256 , V_6 , V_4 ) ;
}
if ( V_255 ) {
int V_257 ;
V_257 = F_206 ( V_3 , V_144 , V_10 ) ;
if ( ! V_60 || V_60 == - V_177 )
V_60 = V_257 ;
}
return V_60 ;
}
static struct V_2 * F_207 ( struct V_258 * V_259 , T_8 V_260 )
{
...
for ( V_264 = 0 ; V_264 <= V_9 -> V_13 ; V_264 ++ ) {
F_33 (s, node, &hash->table[j]) {
if ( F_35 ( V_265 ) != F_208 ( V_259 ) )
continue;
if ( V_266 == V_260 ) {
V_262 -> V_267 = V_45 ;
V_262 -> V_268 = V_264 ;
...
static void * F_209 ( struct V_258 * V_259 , T_8 * V_260 )
__acquires( T_2 )
{
F_27 ( & T_2 ) ;
return * V_260 ? F_207 ( V_259 , * V_260 - 1 ) : V_269 ;
}
static void * F_210 ( struct V_258 * V_259 , void * V_270 , T_8 * V_260 )
{
struct V_2 * V_265 ;
struct V_261 * V_262 ;
int V_45 , V_264 ;
++ * V_260 ;
if ( V_270 == V_269 )
return F_207 ( V_259 , 0 ) ;
V_262 = V_259 -> V_263 ;
V_265 = V_270 ;
do {
V_265 = F_211 ( V_265 ) ;
} while ( V_265 && F_35 ( V_265 ) != F_208 ( V_259 ) );
if ( V_265 )
return V_265 ;
V_45 = V_262 -> V_267 ;
V_264 = V_262 -> V_268 + 1 ;
do {
struct V_8 * V_9 = & V_31 [ V_45 ] . V_9 ;
for (; V_264 <= V_9 -> V_13 ; V_264 ++ ) {
V_265 = F_212 ( & V_9 -> V_11 [ V_264 ] ) ;
while ( V_265 && F_35 ( V_265 ) != F_208 ( V_259 ) )
V_265 = F_211 ( V_265 ) ;
if ( V_265 ) {
V_262 -> V_267 = V_45 ;
...
static void F_213 ( struct V_258 * V_259 , void * V_270 )
__releases( T_2 )
{
F_29 ( & T_2 ) ;
}
static int F_214 ( struct V_258 * V_259 , void * V_270 )
{
if ( V_270 == V_269 )
F_215 ( V_259 ,
L_3
...
struct V_2 * V_265 = V_270 ;
struct V_1 * V_14 = F_1 ( V_265 ) ;
F_216 ( V_259 , L_5 ,
V_265 ,
V_265 -> V_56 ,
V_14 -> V_10 ,
...
static int F_220 ( struct V_136 * V_136 , struct V_134 * V_134 )
{
return F_221 ( V_136 , V_134 , & V_272 ,
sizeof( struct V_261 ) ) ;
}
int F_222 ( struct V_273 * V_274 )
{
return F_223 ( & V_93 , V_274 ) ;
}
int F_224 ( struct V_273 * V_274 )
{
return F_225 ( & V_93 , V_274 ) ;
}
static int T_9 F_226 ( struct V_29 * V_29 )
{
#ifdef F_227
if ( ! F_228 ( V_29 , L_6 , 0 , & V_275 ) )
return - V_64 ;
#endif
return 0 ;
}
static void T_10 F_229 ( struct V_29 * V_29 )
{
#ifdef F_227
F_230 ( V_29 , L_6 ) ;
#endif
...
F_232 ( L_7 ) ;
F_14 () ;
V_31 [ V_276 ] . V_22 = V_22 ;
F_176 ( V_31 [ V_276 ] . V_58 , V_58 ) ;
V_31 [ V_276 ] . V_79 = V_277 ;
V_31 [ V_276 ] . V_87 = 1 ;
F_24 () ;
}
static int T_11 F_233 ( void )
{
struct V_143 * V_278 ;
int V_45 ;
unsigned long V_279 ;
unsigned int V_280 ;
int V_60 = F_234 ( & V_75 , 0 ) ;
if ( V_60 != 0 )
goto V_88;
F_235 ( sizeof( struct V_281 ) > sizeof( V_278 -> V_15 ) ) ;
V_31 = F_236 ( V_85 , sizeof( * V_31 ) , V_74 ) ;
if ( ! V_31 )
goto F_232;
if ( V_282 >= ( 128 * 1024 ) )
V_279 = V_282 >> ( 21 - V_283 ) ;
else
V_279 = V_282 >> ( 23 - V_283 ) ;
V_280 = F_237 ( V_279 ) - 1 + V_283 ;
V_279 = ( 1UL << V_280 ) / sizeof( struct V_7 ) ;
V_280 = F_237 ( F_238 ( V_279 , ( unsigned long ) V_66 ) ) - 1 ;
for ( V_45 = 0 ; V_45 < V_85 ; V_45 ++ ) {
struct V_8 * V_9 = & V_31 [ V_45 ] . V_9 ;
