...
{
struct V_101 * V_102 ;
int V_64 , V_112 , V_113 , V_76 ;
V_102 = F_22 ( V_6 ) ;
V_102 -> V_6 = V_6 ;
V_6 -> V_106 . V_114 = 1 ;
V_76 = F_31 ( V_6 , 8 , 8 , V_102 -> V_115 ) ;
if ( V_76 < 0 ) {
F_10 ( V_6 -> V_37 , L_12 , V_76 ) ;
return V_76 ;
}
for ( V_64 = 0 ; V_64 < F_14 ( V_102 -> V_109 ) ; V_64 ++ )
V_102 -> V_109 [ V_64 ] . V_116 = V_117 [ V_64 ] ;
...
V_102 -> V_111 [ 0 ] . V_118 = V_119 ;
V_102 -> V_111 [ 1 ] . V_118 = V_120 ;
for ( V_64 = 0 ; V_64 < F_14 ( V_102 -> V_109 ) ; V_64 ++ ) {
V_76 = F_33 ( V_102 -> V_109 [ V_64 ] . V_110 ,
& V_102 -> V_111 [ V_64 ] ) ;
if ( V_76 != 0 ) {
F_10 ( V_6 -> V_37 ,
L_14 ,
...
V_113 = ( V_113 << 8 ) | V_112 ;
if ( V_113 != ( ( V_98 [ V_15 ] << 8 )
| V_98 [ V_14 ] ) ) {
F_10 ( V_6 -> V_37 , L_16 , V_113 ) ;
V_76 = - V_11 ;
goto V_122;
}
V_76 = F_3 ( V_6 , V_16 ) ;
...
static int T_4 F_35 ( struct V_123 * V_124 )
{
struct V_101 * V_102 ;
int V_76 ;
V_102 = F_36 ( sizeof *V_102 , V_125 ) ;
if ( ! V_102 )
return - V_126 ;
V_102 -> V_115 = V_127 ;
F_37 ( V_124 , V_102 ) ;
V_76 = F_38 ( & V_124 -> V_37 ,
& V_128 , & V_129 , 1 ) ;
if ( V_76 < 0 )
F_39 ( V_102 ) ;
return V_76 ;
}
static int T_5 F_40 ( struct V_123 * V_124 )
{
F_41 ( & V_124 -> V_37 ) ;
F_39 ( F_42 ( V_124 ) ) ;
return 0 ;
}
static T_4 int F_43 ( struct V_130 * V_131 ,
...
V_102 -> V_115 = V_134 ;
F_44 ( V_131 , V_102 ) ;
V_76 = F_38 ( & V_131 -> V_37 ,
& V_128 , & V_129 , 1 ) ;
if ( V_76 < 0 )
F_39 ( V_102 ) ;
return V_76 ;
}
static T_5 int F_45 ( struct V_130 * V_135 )
{
F_41 ( & V_135 -> V_37 ) ;
F_39 ( F_46 ( V_135 ) ) ;
return 0 ;
