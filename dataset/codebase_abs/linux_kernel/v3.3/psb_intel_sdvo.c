...
F_124 ( V_264 , V_376 ) ;
if ( V_355 . V_266 ) {
if ( ! F_23 ( V_1 , V_377 , & V_36 , 2 ) )
return false ;
V_7 -> V_378 = 1 ;
V_7 -> V_379 = V_36 & 0x1 ;
V_7 -> V_266 =
F_120 ( V_10 , V_360 , L_43 , 2 ) ;
if ( ! V_7 -> V_266 )
return false ;
V_7 -> V_266 -> V_361 [ 0 ] = 0 ;
V_7 -> V_266 -> V_361 [ 1 ] = 1 ;
...
return F_125 ( V_1 , V_7 , V_355 . V_241 ) ;
else
return true ;
}
static int F_126 ( struct V_381 * V_217 ,
struct V_19 * V_20 ,
int V_382 )
{
struct V_1 * V_213 = V_217 -> V_383 ;
if ( ! F_21 ( V_213 , V_213 -> V_47 ) )
return - V_290 ;
return V_213 -> V_27 -> V_384 -> V_385 ( V_213 -> V_27 , V_20 , V_382 ) ;
}
static T_1 F_127 ( struct V_381 * V_217 )
{
struct V_1 * V_213 = V_217 -> V_383 ;
return V_213 -> V_27 -> V_384 -> V_386 ( V_213 -> V_27 ) ;
}
static bool
F_128 ( struct V_1 * V_213 ,
struct V_9 * V_10 )
{
V_213 -> V_214 . V_387 = V_388 ;
V_213 -> V_214 . V_389 = V_390 ;
snprintf ( V_213 -> V_214 . V_31 , V_391 , L_46 ) ;
V_213 -> V_214 . V_10 . V_392 = & V_10 -> V_393 -> V_10 ;
V_213 -> V_214 . V_383 = V_213 ;
V_213 -> V_214 . V_384 = & V_394 ;
return F_129 ( & V_213 -> V_214 ) == 0 ;
}
...
V_395 = & V_1 -> V_4 ;
V_395 -> type = V_396 ;
F_131 ( V_10 , & V_395 -> V_4 , & V_397 , 0 ) ;
for ( V_13 = 0 ; V_13 < 0x40 ; V_13 ++ ) {
T_2 V_398 ;
if ( ! F_10 ( V_1 , V_13 , & V_398 ) ) {
F_12 ( L_47 ,
F_100 ( V_14 ) ? 'B' : 'C' ) ;
goto V_333;
}
