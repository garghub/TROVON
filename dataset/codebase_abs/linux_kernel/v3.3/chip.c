...
int F_20 ( struct V_5 * V_6 , bool V_21 )
{
int V_11 = 0 ;
F_14 ( V_6 ) ;
V_6 -> V_22 = 0 ;
...
void F_24 ( struct V_5 * V_6 , unsigned int V_26 )
{
if ( V_6 -> V_9 . V_3 -> F_21 )
V_6 -> V_9 . V_3 -> F_21 ( & V_6 -> V_9 ) ;
else
...
void F_26 ( struct V_5 * V_6 , unsigned int V_26 )
{
if ( V_6 -> V_9 . V_3 -> V_23 )
V_6 -> V_9 . V_3 -> V_23 ( & V_6 -> V_9 ) ;
else
...
F_34 ( V_1 , V_6 ) ;
V_31 = V_6 -> V_31 ;
if ( F_35 ( ! V_31 || F_36 ( & V_6 -> V_9 ) ) )
goto V_34;
F_17 ( & V_6 -> V_9 , V_35 ) ;
F_37 ( & V_6 -> V_33 ) ;
V_32 = V_31 -> V_36 ( V_31 -> V_1 , V_31 -> V_37 ) ;
if ( ! V_38 )
F_38 ( V_1 , V_6 , V_32 ) ;
F_33 ( & V_6 -> V_33 ) ;
F_15 ( & V_6 -> V_9 , V_35 ) ;
...
F_46 ( V_6 ) ;
V_47:
V_6 -> V_9 . V_3 -> V_48 ( & V_6 -> V_9 ) ;
V_34:
F_45 ( & V_6 -> V_33 ) ;
return;
V_44:
if ( ! ( V_6 -> V_9 . V_3 -> V_4 & V_49 ) )
goto V_47;
goto V_34;
}
void
...
void * V_37 = F_57 ( V_31 -> V_50 ) ;
T_1 V_51 ;
F_34 ( V_1 , V_6 ) ;
if ( V_3 -> V_29 )
V_3 -> V_29 ( & V_6 -> V_9 ) ;
F_58 ( V_1 , V_31 ) ;
V_51 = V_31 -> V_52 ( V_1 , V_37 ) ;
F_59 ( V_1 , V_31 , V_51 ) ;
if ( V_3 -> V_48 )
V_3 -> V_48 ( & V_6 -> V_9 ) ;
}
void
F_60 ( unsigned int V_1 , T_2 V_53 , int V_54 ,
const char * V_55 )
{
unsigned long V_4 ;
...
T_2 V_53 , const char * V_55 )
{
F_1 ( V_1 , V_3 ) ;
F_60 ( V_1 , V_53 , 0 , V_55 ) ;
}
void F_66 ( unsigned int V_1 , unsigned long V_58 , unsigned long V_59 )
{
unsigned long V_4 ;
struct V_5 * V_6 = F_2 ( V_1 , & V_4 , 0 ) ;
if ( ! V_6 )
