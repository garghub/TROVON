...
if ( V_178 >= V_183 )
break;
F_97 ( F_23 ( V_8 ) , & V_190 , V_191 ) ;
V_9 = F_64 ( V_8 ) ;
if ( V_9 )
;
else if ( V_8 -> V_17 & V_192 )
;
else if ( V_182 )
V_9 = - V_193 ;
else if ( F_98 ( V_194 ) )
...
V_189 = F_102 (unsigned int, skb->len, size) ;
if ( F_103 ( V_167 -> V_176 , V_4 -> V_195 , V_189 ) ) {
F_104 ( & V_8 -> V_32 , V_4 ) ;
if ( V_178 == 0 )
V_178 = - V_196 ;
break;
...
V_6 = F_43 ( V_8 ) ;
if ( V_167 -> V_201 ) {
struct V_98 * V_111 = (struct V_98 * ) V_167 -> V_201 ;
V_9 = - V_112 ;
if ( V_167 -> V_188 < sizeof( * V_111 ) )
goto V_107;
...
V_237 = F_122 ( sizeof( struct V_236 ) , V_35 ) ;
if ( V_237 == NULL ) {
V_9 = - V_69 ;
goto V_107;
}
...
V_117 ,
V_237 -> V_248 ,
V_237 -> V_250 . V_254 . V_256 ,
V_237 -> V_250 . V_254 . V_168 ,
V_252 ) ;
break;
case V_257 :
V_237 -> V_250 . V_258 . string [ V_237 -> V_250 . V_258 . V_168 ] = '\0' ;
F_128 (
V_117 ,
V_237 -> V_248 ,
V_237 -> V_250 . V_258 . string ,
V_252 ) ;
break;
default :
F_41 ( V_237 ) ;
...
switch ( V_43 -> type ) {
case V_81 :
V_237 -> V_250 . V_251 = V_43 -> V_82 . integer ;
break;
case V_253 :
V_237 -> V_250 . V_254 . V_168 = V_43 -> V_168 ;
memcpy ( V_237 -> V_250 . V_254 . V_256 ,
V_43 -> V_82 . V_264 , V_43 -> V_168 ) ;
break;
case V_257 :
V_237 -> V_250 . V_258 . V_168 = V_43 -> V_168 ;
V_237 -> V_250 . V_258 . V_265 = V_43 -> V_265 ;
memcpy ( V_237 -> V_250 . V_258 . string ,
V_43 -> V_82 . string , V_43 -> V_168 ) ;
V_237 -> V_250 . V_258 . string [ V_43 -> V_168 ] = '\0' ;
break;
case V_266 :
default :
return - V_112 ;
}
V_237 -> V_249 = V_43 -> type ;
return 0 ;
}
...
switch ( V_233 ) {
case V_273 :
V_271 = sizeof( struct V_267 ) -
sizeof( struct V_269 ) ;
if ( V_168 < V_271 ) {
V_9 = - V_112 ;
goto V_107;
}
V_84 = F_40 ( & V_268 . V_168 , V_6 -> V_89 . V_90 ,
V_6 -> V_91 ) ;
if ( V_84 == NULL ) {
V_9 = - V_193 ;
goto V_107;
}
if ( F_134 ( V_234 , & V_268 , V_271 ) )
V_9 = - V_196 ;
if ( V_268 . V_168 > 2048 ) {
V_9 = - V_112 ;
goto V_274;
}
V_272 = V_271 + ( V_268 . V_168 * sizeof( struct V_269 ) ) ;
if ( V_272 > V_168 )
V_272 = V_168 ;
if ( F_134 ( V_234 + V_271 , V_84 , V_272 - V_271 ) )
V_9 = - V_196 ;
if ( F_118 ( V_272 , V_235 ) )
V_9 = - V_196 ;
V_274:
F_41 ( V_84 ) ;
break;
...
if ( F_130 ( V_270 , ( int V_217 * ) V_234 ) ) {
V_9 = - V_196 ;
goto V_107;
}
