...
static T_2 int F_14 ( struct V_4 * V_5 ,
struct V_1 * V_2 )
{
int V_29 ;
F_15 ( V_17 , L_15 ) ;
...
static T_3 int F_16 ( struct V_1 * V_2 )
{
struct V_4 * V_5 = V_2 -> V_5 ;
int V_10 ;
V_10 = V_5 -> V_12 + V_17 ;
...
static T_2 int F_18 ( struct V_78 * V_79 )
{
struct V_4 * V_5 = F_10 ( V_79 -> V_9 . V_50 ) ;
...
V_2 = F_20 ( sizeof( struct V_1 ) , V_83 ) ;
if ( ! V_2 )
return - V_84 ;
V_2 -> V_5 = V_5 ;
V_2 -> V_7 = V_5 -> V_85 ;
...
V_2 -> V_86 . type = V_88 ;
V_2 -> V_86 . V_89 = V_90 ;
V_2 -> V_86 . V_91 = F_22 ( V_90 ) ;
V_2 -> V_86 . V_92 = F_9 ;
V_2 -> V_86 . V_93 = V_81 -> V_93 ;
V_2 -> V_86 . V_94 = V_81 -> V_94 ;
V_29 = F_23 ( & V_79 -> V_9 , & V_2 -> V_86 ) ;
if ( V_29 )
goto V_54;
V_2 -> V_86 . V_9 -> V_50 = & V_79 -> V_9 ;
V_2 -> V_95 . V_87 = L_29 ;
V_2 -> V_95 . type = V_96 ;
V_2 -> V_95 . V_89 = V_97 ;
V_2 -> V_95 . V_91 = F_22 ( V_97 ) ;
V_2 -> V_95 . V_92 = F_11 ;
V_2 -> V_95 . V_93 = V_81 -> V_93 ;
V_2 -> V_95 . V_94 = V_81 -> V_94 ;
V_29 = F_23 ( & V_79 -> V_9 , & V_2 -> V_95 ) ;
if ( V_29 )
goto V_98;
V_2 -> V_95 . V_9 -> V_50 = & V_79 -> V_9 ;
V_2 -> V_99 . V_87 = L_30 ;
V_2 -> V_99 . type = V_100 ;
V_2 -> V_99 . V_89 = V_101 ;
V_2 -> V_99 . V_91 = F_22 ( V_101 ) ;
V_2 -> V_99 . V_92 = F_12 ;
V_29 = F_23 ( & V_79 -> V_9 , & V_2 -> V_99 ) ;
if ( V_29 )
goto V_102;
V_2 -> V_99 . V_9 -> V_50 = & V_79 -> V_9 ;
V_2 -> V_73 = V_81 -> V_73 ;
V_2 -> V_76 = V_81 -> V_76 ;
V_2 -> V_77 = V_81 -> V_77 ;
V_2 -> V_6 = V_81 -> V_6 ;
...
static T_3 int F_26 ( struct V_78 * V_79 )
{
struct V_1 * V_2 = F_27 ( V_79 ) ;
if ( V_2 ) {
F_24 ( & V_2 -> V_86 ) ;
F_24 ( & V_2 -> V_95 ) ;
F_24 ( & V_2 -> V_99 ) ;
