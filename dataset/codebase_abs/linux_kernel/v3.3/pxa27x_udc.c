...
F_127 ( V_234 . V_232 . V_240 ) , F_127 ( V_234 . V_232 . V_241 ) ,
F_127 ( V_234 . V_232 . V_242 ) ) ;
if ( F_59 ( V_235 ) )
goto V_237;
...
static void F_128 ( struct V_4 * V_5 , int V_244 , int V_245 )
{
T_1 V_246 ;
struct V_44 * V_45 = & V_5 -> V_44 [ 0 ] ;
...
static void F_131 ( int V_255 , struct V_4 * V_5 )
{
int V_48 ;
struct V_44 * V_45 ;
...
F_29 ( V_5 , V_36 , F_132 ( 0 , V_260 ) ) ;
F_128 ( V_5 , ! ! ( V_256 & V_261 ) ,
! ! ( V_256 & V_262 ) ) ;
}
V_256 >>= 2 ;
...
if ( ! ( V_256 & V_260 ) )
continue;
F_29 ( V_5 , V_36 , F_132 ( V_48 , V_260 ) ) ;
...
F_29 ( V_5 , V_37 , F_132 ( V_48 - 16 , V_260 ) ) ;
if ( ! ( V_258 & V_260 ) )
continue;
F_56 ( V_48 >= F_133 ( V_5 -> V_44 ) ) ;
if ( V_48 < F_133 ( V_5 -> V_44 ) ) {
...
static T_5 F_138 ( int V_255 , void * V_270 )
{
...
static int T_2 F_140 ( struct V_273 * V_274 )
{
struct V_275 * V_276 ;
struct V_4 * V_5 = & V_277 ;
int V_222 = 0 , V_278 ;
V_276 = F_141 ( V_274 , V_279 , 0 ) ;
if ( ! V_276 )
return - V_280 ;
V_5 -> V_255 = F_142 ( V_274 , 0 ) ;
if ( V_5 -> V_255 < 0 )
return V_5 -> V_255 ;
V_5 -> V_90 = & V_274 -> V_90 ;
V_5 -> V_196 = V_274 -> V_90 . V_281 ;
V_5 -> V_208 = F_143 () ;
V_278 = V_5 -> V_196 -> V_197 ;
if ( F_99 ( V_278 ) ) {
V_222 = F_144 ( V_278 , L_90 ) ;
if ( V_222 == 0 )
F_145 ( V_278 ,
V_5 -> V_196 -> V_198 ) ;
}
...
V_5 -> V_212 = F_146 ( & V_274 -> V_90 , NULL ) ;
if ( F_16 ( V_5 -> V_212 ) ) {
V_222 = F_147 ( V_5 -> V_212 ) ;
goto V_282;
}
V_222 = - V_283 ;
V_5 -> V_276 = F_148 ( V_276 -> V_284 , F_149 ( V_276 ) ) ;
if ( ! V_5 -> V_276 ) {
...
V_222 = F_153 ( & V_274 -> V_90 , & V_5 -> V_78 ) ;
if ( V_222 )
goto V_291;
F_14 ( V_5 ) ;
return 0 ;
...
static int T_6 F_157 ( struct V_273 * V_270 )
{
struct V_4 * V_5 = F_158 ( V_270 ) ;
int V_278 = V_5 -> V_196 -> V_197 ;
F_159 ( & V_5 -> V_78 ) ;
F_160 ( V_5 -> V_11 ) ;
F_154 ( V_5 -> V_255 , V_5 ) ;
F_20 ( V_5 ) ;
...
static void F_163 ( struct V_273 * V_270 )
{
struct V_4 * V_5 = F_158 ( V_270 ) ;
if ( F_3 ( V_5 , V_17 ) & V_27 )
F_108 ( V_5 ) ;
}
static int F_164 ( struct V_273 * V_270 , T_7 V_75 )
{
int V_48 ;
struct V_4 * V_5 = F_158 ( V_270 ) ;
struct V_44 * V_45 ;
...
for ( V_48 = 1 ; V_48 < V_50 ; V_48 ++ ) {
V_45 = & V_5 -> V_44 [ V_48 ] ;
V_45 -> V_292 = F_9 ( V_45 , V_56 ) ;
V_45 -> V_293 = F_9 ( V_45 , V_17 ) ;
F_42 ( V_45 , L_94 ,
...
static int F_165 ( struct V_273 * V_270 )
{
int V_48 ;
struct V_4 * V_5 = F_158 ( V_270 ) ;
struct V_44 * V_45 ;
...
for ( V_48 = 1 ; V_48 < V_50 ; V_48 ++ ) {
V_45 = & V_5 -> V_44 [ V_48 ] ;
F_35 ( V_45 , V_56 , V_45 -> V_292 ) ;
F_35 ( V_45 , V_17 , V_45 -> V_293 ) ;
F_42 ( V_45 , L_94 ,
V_45 -> V_292 , V_45 -> V_293 ) ;
}
F_98 ( V_5 , V_5 -> V_294 ) ;
...
if ( ! F_168 () && ! F_169 () )
return - V_10 ;
F_170 ( V_295 L_95 , V_14 , V_15 ) ;
return F_171 ( & V_296 , F_140 ) ;
}
