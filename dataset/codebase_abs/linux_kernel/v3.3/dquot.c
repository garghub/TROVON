...
struct V_250 * V_250 )
{
int error = F_182 ( V_250 -> V_251 ) ;
if ( error )
return error ;
if ( V_250 -> V_251 -> V_252 != V_2 )
error = - V_253 ;
else
error = F_173 ( V_250 -> V_251 -> V_254 , type ,
V_234 , V_222 |
V_223 ) ;
return error ;
}
...
V_251 = F_186 ( V_256 , V_2 -> V_257 , strlen ( V_256 ) ) ;
...
error = F_182 ( V_251 ) ;
if ( ! error )
error = F_173 ( V_251 -> V_254 , type , V_234 ,
V_222 | V_223 ) ;
V_81:
F_189 ( V_251 ) ;
return error ;
...
static int F_198 ( struct V_314 * V_315 , int V_316 ,
void T_4 * V_317 , T_5 * V_318 , T_6 * V_319 )
{
unsigned int type = ( int * ) V_315 -> V_320 - V_104 . V_321 ;
V_104 . V_321 [ type ] =
F_199 ( & V_104 . V_105 [ type ] ) ;
return F_200 ( V_315 , V_316 , V_317 , V_318 , V_319 ) ;
}
static int T_7 F_201 ( void )
{
int V_167 , V_49 ;
unsigned long V_322 , V_323 ;
F_3 ( V_324 L_21 , V_325 ) ;
F_202 ( V_326 ) ;
V_71 = F_203 ( L_22 ,
...
NULL ) ;
V_323 = 0 ;
V_30 = (struct V_28 * ) F_204 ( V_331 , V_323 ) ;
if ( ! V_30 )
F_205 ( L_23 ) ;
for ( V_167 = 0 ; V_167 < V_332 ; V_167 ++ ) {
V_49 = F_206 ( & V_104 . V_105 [ V_167 ] , 0 ) ;
if ( V_49 )
F_205 ( L_24 ) ;
}
V_322 = ( 1UL << V_323 ) * V_333 / sizeof( struct V_28 ) ;
V_25 = 0 ;
do {
V_25 ++ ;
} while ( V_322 >> V_25 );
...
V_322 = 1UL << V_25 ;
V_26 = V_322 - 1 ;
for ( V_167 = 0 ; V_167 < V_322 ; V_167 ++ )
F_207 ( V_30 + V_167 ) ;
F_3 ( L_25 ,
V_322 , V_323 , ( V_333 << V_323 ) ) ;
F_208 ( & V_334 ) ;
return 0 ;
}
