...
static T_4 F_24 ( struct V_69 * V_70 , struct V_71 * V_72 ,
struct V_73 * V_74 ,
char * V_75 , T_5 V_76 , T_6 V_77 )
{
struct V_1 * V_2 = F_25 ( V_72 , struct V_1 , V_72 ) ;
struct V_5 * V_6 = F_2 ( V_2 ) ;
struct V_7 * V_8 = F_3 ( V_6 ) ;
void T_1 * V_9 = V_8 -> V_9 ;
T_4 V_78 ;
for ( V_78 = 0 ; V_77 > 0 && V_76 < V_79 ; V_78 ++ , V_77 -- )
* V_75 ++ = F_8 ( V_9 + V_76 ++ ) ;
return V_78 ;
}
static T_4 F_26 ( struct V_69 * V_70 , struct V_71 * V_72 ,
struct V_73 * V_74 ,
char * V_75 , T_5 V_76 , T_6 V_77 )
{
struct V_1 * V_2 = F_25 ( V_72 , struct V_1 , V_72 ) ;
...
void T_1 * V_9 ;
int V_85 = 0 ;
V_82 = F_28 ( V_6 , V_86 , 0 ) ;
if ( ! V_82 )
return - V_87 ;
V_8 = F_29 ( & V_6 -> V_2 , sizeof( * V_8 ) , V_88 ) ;
if ( ! V_8 )
return - V_89 ;
if ( ! F_30 ( & V_6 -> V_2 , V_82 -> V_90 , V_91 ,
V_6 -> V_92 ) )
return - V_93 ;
V_9 = F_31 ( & V_6 -> V_2 , V_82 -> V_90 , V_91 ) ;
if ( ! V_9 )
return - V_89 ;
V_8 -> V_9 = V_9 ;
V_8 -> V_58 = F_32 ( V_6 , 0 ) ;
...
if ( V_84 & V_94 ) {
V_84 &= V_27 ;
V_83 = F_8 ( V_9 + V_30 ) & V_29 ;
F_5 ( V_12 , V_9 + V_13 ) ;
F_5 ( V_84 , V_9 + V_28 ) ;
F_5 ( V_83 & V_29 , V_9 + V_13 ) ;
}
if ( F_8 ( V_9 + V_55 ) & V_95 )
F_33 ( & V_6 -> V_2 , L_2 ) ;
F_34 ( & V_8 -> V_42 ) ;
V_8 -> V_38 = V_39 ;
F_35 ( V_6 , V_8 ) ;
...
V_66 = F_37 ( V_6 -> V_92 , & V_6 -> V_2 ,
& V_97 , V_98 ) ;
if ( F_38 ( V_66 ) )
return F_39 ( V_66 ) ;
V_8 -> V_66 = V_66 ;
V_85 = F_40 ( & V_6 -> V_2 . V_72 , & V_99 ) ;
if ( V_85 )
F_41 ( V_66 ) ;
return V_85 ;
}
