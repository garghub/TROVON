...
static int T_4 F_32 ( struct V_72 * V_12 )
{
int V_15 = 0 ;
struct V_1 * V_2 = NULL ;
...
struct V_41 * V_42 = NULL ;
struct V_73 V_50 ;
V_2 = F_33 ( sizeof( struct V_1 ) , V_74 ) ;
if ( ! V_2 )
return - V_75 ;
V_12 -> V_76 = 9 ;
V_15 = F_34 ( V_12 ) ;
...
V_2 -> V_12 = V_12 ;
V_2 -> V_23 = & V_12 -> V_23 ;
V_2 -> V_43 = (struct V_39 * ) V_12 -> V_23 . V_78 ;
if ( ! V_2 -> V_43 ) {
F_9 ( & V_12 -> V_23 , L_4 ) ;
goto V_77;
}
V_46 = F_35 ( L_22 , & V_12 -> V_23 , V_2 , & V_79 ) ;
if ( F_36 ( V_46 ) ) {
V_15 = F_37 ( V_46 ) ;
goto V_77;
}
...
V_2 -> V_42 = V_42 ;
V_2 -> V_71 =
sizeof( V_26 ) / ( V_83 * sizeof( int ) ) ;
V_15 = F_39 ( & ( V_12 -> V_23 ) , & V_84 ) ;
if ( V_15 < 0 )
F_9 ( & ( V_12 -> V_23 ) , L_24 ) ;
V_15 = F_39 ( & ( V_12 -> V_23 ) , & V_85 ) ;
if ( V_15 < 0 )
F_9 ( & ( V_12 -> V_23 ) , L_24 ) ;
if ( ! V_2 -> V_43 -> V_86 ) {
V_2 -> V_54 = V_57 ;
...
static int T_5 F_43 ( struct V_72 * V_12 )
{
...
static int F_46 ( struct V_72 * V_12 , T_6 V_87 )
{
int V_15 = 0 ;
struct V_1 * V_2 = F_27 ( & V_12 -> V_23 ) ;
F_47 ( & V_12 -> V_23 , L_26 , V_2 -> V_54 ) ;
V_88 = V_2 -> V_54 ;
V_15 = F_18 ( V_2 , V_57 ) ;
return V_15 ;
}
static int F_48 ( struct V_72 * V_12 )
{
int V_15 = 0 ;
struct V_1 * V_2 = F_27 ( & V_12 -> V_23 ) ;
if ( V_88 == V_56 )
V_2 -> V_54 = V_57 ;
F_47 ( & V_12 -> V_23 , L_27 , V_88 ) ;
V_15 = F_18 ( V_2 , V_88 ) ;
return V_15 ;
}
static void F_49 ( struct V_72 * V_12 )
{
struct V_1 * V_2 = F_27 ( & V_12 -> V_23 ) ;
F_18 ( V_2 , V_57 ) ;
}
