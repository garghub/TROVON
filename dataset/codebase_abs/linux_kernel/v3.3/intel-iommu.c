...
static int T_1 F_207 ( int V_244 )
{
struct V_68 * V_69 ;
struct V_48 * V_49 ;
int V_97 , V_86 = 0 ;
...
int V_64 ;
F_210 (i, nid, &start_pfn, &end_pfn, NULL) {
V_86 = F_200 ( V_232 ,
F_211 ( V_102 ) , F_211 ( V_245 ) ) ;
if ( V_86 )
return V_86 ;
}
}
...
static int F_215 ( struct V_172 * V_173 , int V_247 )
{
if ( ( V_246 & V_248 ) && F_216 ( V_173 ) )
return 1 ;
if ( ( V_246 & V_249 ) && F_217 ( V_173 ) )
return 1 ;
if ( ! ( V_246 & V_250 ) )
return 0 ;
if ( ! F_177 ( V_173 ) ) {
...
return V_255 >= F_219 ( & V_173 -> V_147 ) ;
}
return 1 ;
}
static int T_1 F_220 ( int V_244 )
{
struct V_172 * V_173 = NULL ;
int V_86 ;
V_86 = F_207 ( V_244 ) ;
...
L_43 ,
V_49 -> V_164 ,
( unsigned long long ) V_69 -> V_259 ) ;
} else {
V_49 -> V_153 . V_197 = V_260 ;
V_49 -> V_153 . V_154 = V_261 ;
F_42 ( V_35 L_44
L_43 ,
V_49 -> V_164 ,
( unsigned long long ) V_69 -> V_259 ) ;
...
static struct V_46 * F_233 ( struct V_264 * V_147 ,
struct V_55 * V_56 ,
unsigned long V_265 , V_31 V_255 )
{
struct V_172 * V_173 = F_234 ( V_147 ) ;
struct V_46 * V_46 = NULL ;
V_255 = F_235 ( V_31 , F_236 ( V_56 -> V_107 ) , V_255 ) ;
if ( ! V_37 && V_255 > F_237 ( 32 ) ) {
V_46 = F_238 ( & V_56 -> V_187 , V_265 ,
F_157 ( F_237 ( 32 ) ) , 1 ) ;
if ( V_46 )
return V_46 ;
}
V_46 = F_238 ( & V_56 -> V_187 , V_265 , F_157 ( V_255 ) , 1 ) ;
if ( F_172 ( ! V_46 ) ) {
F_42 ( V_141 L_48 ,
V_265 , F_198 ( V_173 ) ) ;
return NULL ;
...
static int F_242 ( struct V_264 * V_147 )
{
struct V_172 * V_173 ;
int V_143 ;
if ( F_172 ( V_147 -> V_73 != & V_266 ) )
return 1 ;
V_173 = F_234 ( V_147 ) ;
if ( F_241 ( V_173 ) )
return 1 ;
...
static V_218 F_244 ( struct V_264 * V_267 , T_6 V_268 ,
T_5 V_82 , int V_269 , V_23 V_255 )
{
struct V_172 * V_173 = F_234 ( V_267 ) ;
struct V_55 * V_56 ;
T_6 V_270 ;
struct V_46 * V_46 ;
int V_30 = 0 ;
...
return 0 ;
V_49 = F_61 ( V_56 ) ;
V_82 = F_179 ( V_268 , V_82 ) ;
V_46 = F_233 ( V_267 , V_56 , F_10 ( V_82 ) , V_255 ) ;
if ( ! V_46 )
goto error;
if ( V_269 == V_273 || V_269 == V_274 || \
! F_245 ( V_49 -> V_52 ) )
V_30 |= V_27 ;
if ( V_269 == V_275 || V_269 == V_274 )
V_30 |= V_28 ;
V_86 = F_190 ( V_56 , F_11 ( V_46 -> V_276 ) ,
F_11 ( V_271 ) , V_82 , V_30 ) ;
if ( V_86 )
goto error;
if ( F_131 ( V_49 -> V_52 ) )
F_126 ( V_49 , V_56 -> V_171 , F_11 ( V_46 -> V_276 ) , V_82 , 1 ) ;
else
F_99 ( V_49 ) ;
V_270 = ( T_6 ) V_46 -> V_276 << V_9 ;
V_270 += V_268 & ~ V_201 ;
return V_270 ;
error:
if ( V_46 )
...
F_42 ( V_141 L_53 ,
F_198 ( V_173 ) , V_82 , ( unsigned long long ) V_268 , V_269 ) ;
return 0 ;
}
static V_218 F_247 ( struct V_264 * V_147 , struct V_12 * V_12 ,
unsigned long V_92 , T_5 V_82 ,
enum V_277 V_269 ,
struct V_278 * V_279 )
{
return F_244 ( V_147 , F_183 ( V_12 ) + V_92 , V_82 ,
V_269 , F_234 ( V_147 ) -> V_255 ) ;
}
...
V_136 ) ;
for ( V_280 = 0 ; V_280 < V_257 [ V_64 ] . V_222 ; V_280 ++ ) {
unsigned long V_70 ;
struct V_46 * V_46 = V_257 [ V_64 ] . V_46 [ V_280 ] ;
struct V_55 * V_56 = V_257 [ V_64 ] . V_56 [ V_280 ] ;
if ( F_131 ( V_49 -> V_52 ) )
F_126 ( V_49 , V_56 -> V_171 ,
V_46 -> V_276 , V_46 -> V_282 - V_46 -> V_276 + 1 , 0 ) ;
else {
V_70 = F_127 ( F_11 ( V_46 -> V_282 - V_46 -> V_276 + 1 ) ) ;
F_123 ( V_257 [ V_64 ] . V_56 [ V_280 ] ,
( V_31 ) V_46 -> V_276 << V_9 , V_70 ) ;
}
F_246 ( & V_257 [ V_64 ] . V_56 [ V_280 ] -> V_187 , V_46 ) ;
}
V_257 [ V_64 ] . V_222 = 0 ;
}
V_283 = 0 ;
}
static void F_166 ( unsigned long V_284 )
{
unsigned long V_58 ;
F_79 ( & V_285 , V_58 ) ;
F_248 () ;
...
static void F_249 ( struct V_55 * V_286 , struct V_46 * V_46 )
{
unsigned long V_58 ;
int V_222 , V_57 ;
struct V_48 * V_49 ;
...
V_49 = F_61 ( V_286 ) ;
V_57 = V_49 -> V_164 ;
V_222 = V_257 [ V_57 ] . V_222 ;
V_257 [ V_57 ] . V_56 [ V_222 ] = V_286 ;
V_257 [ V_57 ] . V_46 [ V_222 ] = V_46 ;
V_257 [ V_57 ] . V_222 ++ ;
if ( ! V_281 ) {
F_250 ( & V_288 , V_289 + F_251 ( 10 ) ) ;
V_281 = 1 ;
}
V_283 ++ ;
F_80 ( & V_285 , V_58 ) ;
}
static void F_252 ( struct V_264 * V_147 , V_218 V_290 ,
T_5 V_82 , enum V_277 V_269 ,
struct V_278 * V_279 )
{
struct V_172 * V_173 = F_234 ( V_147 ) ;
struct V_55 * V_56 ;
...
F_62 ( ! V_56 ) ;
V_49 = F_61 ( V_56 ) ;
V_46 = F_253 ( & V_56 -> V_187 , F_157 ( V_290 ) ) ;
if ( F_254 ( ! V_46 , L_54 ,
( unsigned long long ) V_290 ) )
return;
V_102 = F_11 ( V_46 -> V_276 ) ;
V_103 = F_11 ( V_46 -> V_282 + 1 ) - 1 ;
F_112 ( L_55 ,
...
static void * F_255 ( struct V_264 * V_267 , T_5 V_82 ,
V_218 * V_291 , T_7 V_58 )
{
void * V_41 ;
int V_105 ;
V_82 = F_180 ( V_82 ) ;
...
if ( ! F_242 ( V_267 ) )
V_58 &= ~ ( V_292 | V_293 ) ;
else if ( V_267 -> V_256 < F_219 ( V_267 ) ) {
if ( V_267 -> V_256 < F_237 ( 32 ) )
V_58 |= V_292 ;
else
V_58 |= V_293 ;
}
...
return NULL ;
memset ( V_41 , 0 , V_82 ) ;
* V_291 = F_244 ( V_267 , F_258 ( V_41 ) , V_82 ,
V_274 ,
V_267 -> V_256 ) ;
if ( * V_291 )
return V_41 ;
...
static void F_260 ( struct V_264 * V_267 , T_5 V_82 , void * V_41 ,
V_218 V_291 )
{
int V_105 ;
V_82 = F_180 ( V_82 ) ;
V_105 = F_256 ( V_82 ) ;
F_252 ( V_267 , V_291 , V_82 , V_274 , NULL ) ;
F_259 ( ( unsigned long ) V_41 , V_105 ) ;
}
static void F_261 ( struct V_264 * V_267 , struct V_208 * V_294 ,
int V_295 , enum V_277 V_269 ,
struct V_278 * V_279 )
{
struct V_172 * V_173 = F_234 ( V_267 ) ;
struct V_55 * V_56 ;
...
F_62 ( ! V_56 ) ;
V_49 = F_61 ( V_56 ) ;
V_46 = F_253 ( & V_56 -> V_187 , F_157 ( V_294 [ 0 ] . V_217 ) ) ;
if ( F_254 ( ! V_46 , L_56 ,
( unsigned long long ) V_294 [ 0 ] . V_217 ) )
return;
V_102 = F_11 ( V_46 -> V_276 ) ;
V_103 = F_11 ( V_46 -> V_282 + 1 ) - 1 ;
F_89 ( V_56 , V_102 , V_103 ) ;
...
static int F_262 ( struct V_264 * V_296 ,
struct V_208 * V_294 , int V_295 , int V_269 )
{
int V_64 ;
struct V_208 * V_209 ;
...
static int F_264 ( struct V_264 * V_267 , struct V_208 * V_294 , int V_295 ,
enum V_277 V_269 , struct V_278 * V_279 )
{
int V_64 ;
struct V_172 * V_173 = F_234 ( V_267 ) ;
struct V_55 * V_56 ;
...
F_62 ( V_269 == V_272 ) ;
if ( F_242 ( V_267 ) )
return F_262 ( V_267 , V_294 , V_295 , V_269 ) ;
V_56 = F_240 ( V_173 ) ;
if ( ! V_56 )
return 0 ;
V_49 = F_61 ( V_56 ) ;
...
V_46 = F_233 ( V_267 , V_56 , F_10 ( V_82 ) ,
V_173 -> V_255 ) ;
if ( ! V_46 ) {
V_294 -> V_219 = 0 ;
return 0 ;
...
if ( V_269 == V_275 || V_269 == V_274 )
V_30 |= V_28 ;
V_297 = F_11 ( V_46 -> V_276 ) ;
V_86 = F_189 ( V_56 , V_297 , V_294 , V_82 , V_30 ) ;
if ( F_172 ( V_86 ) ) {
F_89 ( V_56 , V_297 ,
V_297 + V_82 - 1 ) ;
F_90 ( V_56 , V_297 ,
...
if ( F_131 ( V_49 -> V_52 ) )
F_126 ( V_49 , V_56 -> V_171 , V_297 , V_82 , 1 ) ;
else
F_99 ( V_49 ) ;
return V_295 ;
}
static int F_265 ( struct V_264 * V_147 , V_218 V_298 )
{
return ! V_298 ;
}
...
T_3 V_301 ;
int V_302 ;
V_302 = F_274 ( V_173 -> V_73 , F_275 ( 0 , 0 ) , 0xb0 , & V_301 ) ;
if ( V_302 ) {
...
V_301 &= 0xffff0000 ;
V_69 = F_197 ( V_173 ) ;
if ( F_277 ( ! V_69 || V_69 -> V_259 - V_301 != 0xa000 ,
V_303 ,
L_64 ) )
...
unsigned long V_111 ;
F_70 (iommu, drhd) {
V_49 -> V_305 = F_223 ( sizeof( T_3 ) * V_306 ,
V_42 ) ;
if ( ! V_49 -> V_305 )
goto V_307;
}
...
F_94 ( & V_49 -> V_112 , V_111 ) ;
V_49 -> V_305 [ V_308 ] =
V_119 ( V_49 -> V_113 + V_309 ) ;
V_49 -> V_305 [ V_310 ] =
V_119 ( V_49 -> V_113 + V_311 ) ;
V_49 -> V_305 [ V_312 ] =
V_119 ( V_49 -> V_113 + V_313 ) ;
V_49 -> V_305 [ V_314 ] =
V_119 ( V_49 -> V_113 + V_315 ) ;
F_98 ( & V_49 -> V_112 , V_111 ) ;
}
return 0 ;
V_307:
...
F_70 (iommu, drhd) {
F_94 ( & V_49 -> V_112 , V_111 ) ;
F_96 ( V_49 -> V_305 [ V_308 ] ,
V_49 -> V_113 + V_309 ) ;
F_96 ( V_49 -> V_305 [ V_310 ] ,
V_49 -> V_113 + V_311 ) ;
F_96 ( V_49 -> V_305 [ V_312 ] ,
V_49 -> V_113 + V_313 ) ;
F_96 ( V_49 -> V_305 [ V_314 ] ,
V_49 -> V_113 + V_315 ) ;
F_98 ( & V_49 -> V_112 , V_111 ) ;
}
F_70 (iommu, drhd)
...
{
F_199 ( & V_239 -> V_317 , & V_318 ) ;
}
int T_1 F_289 ( struct V_319 * V_320 )
{
struct V_321 * V_239 ;
struct V_238 * V_322 ;
V_322 = F_223 ( sizeof( * V_322 ) , V_166 ) ;
if ( ! V_322 )
return - V_108 ;
V_322 -> V_323 = V_320 ;
V_239 = (struct V_321 * ) V_320 ;
V_322 -> V_241 = V_239 -> V_241 ;
V_322 -> V_242 = V_239 -> V_242 ;
F_288 ( V_322 ) ;
return 0 ;
}
static int T_1
F_290 ( struct V_238 * V_322 )
{
struct V_321 * V_239 ;
int V_86 ;
V_239 = (struct V_321 * ) V_322 -> V_323 ;
V_86 = F_291 ( ( void * ) ( V_239 + 1 ) ,
( ( void * ) V_239 ) + V_239 -> V_320 . V_216 ,
& V_322 -> V_76 , & V_322 -> V_77 , V_239 -> V_72 ) ;
if ( V_86 || ( V_322 -> V_76 == 0 ) ) {
F_194 ( & V_322 -> V_317 ) ;
F_148 ( V_322 ) ;
}
return V_86 ;
}
int T_1 F_292 ( struct V_319 * V_323 )
{
struct V_324 * V_325 ;
struct V_326 * V_327 ;
V_325 = F_293 ( V_323 , struct V_324 , V_320 ) ;
V_327 = F_223 ( sizeof( * V_327 ) , V_166 ) ;
if ( ! V_327 )
return - V_108 ;
V_327 -> V_323 = V_323 ;
V_327 -> V_80 = V_325 -> V_58 & 0x1 ;
F_199 ( & V_327 -> V_317 , & V_328 ) ;
return 0 ;
}
static int T_1 F_294 ( struct V_326 * V_327 )
{
int V_302 ;
struct V_324 * V_325 ;
if ( V_327 -> V_80 )
return 0 ;
V_325 = F_293 ( V_327 -> V_323 , struct V_324 , V_320 ) ;
V_302 = F_291 ( ( void * ) ( V_325 + 1 ) ,
( void * ) V_325 + V_325 -> V_320 . V_216 ,
& V_327 -> V_76 , & V_327 -> V_77 ,
V_325 -> V_72 ) ;
if ( V_302 || ! V_327 -> V_76 ) {
F_194 ( & V_327 -> V_317 ) ;
F_148 ( V_327 ) ;
...
V_325 = F_293 ( V_327 -> V_323 , struct V_324 , V_320 ) ;
if ( V_325 -> V_72 == F_175 ( V_147 -> V_73 ) )
goto V_143;
}
return 0 ;
V_143:
for ( V_73 = V_147 -> V_73 ; V_73 ; V_73 = V_73 -> V_91 ) {
struct V_172 * V_330 = V_73 -> V_199 ;
if ( ! V_330 || ! F_177 ( V_330 ) ||
V_330 -> V_253 == V_254 )
return 0 ;
if ( V_330 -> V_253 == V_331 ) {
for ( V_64 = 0 ; V_64 < V_327 -> V_76 ; V_64 ++ )
if ( V_327 -> V_77 [ V_64 ] == V_330 )
return 1 ;
break;
}
}
...
int T_1 F_296 ( void )
{
struct V_238 * V_239 , * V_332 ;
struct V_326 * V_325 , * V_333 ;
int V_86 = 0 ;
...
static int F_298 ( struct V_334 * V_335 ,
unsigned long V_336 , void * V_284 )
{
struct V_264 * V_147 = V_284 ;
struct V_172 * V_173 = F_234 ( V_147 ) ;
struct V_55 * V_56 ;
if ( F_242 ( V_147 ) )
return 0 ;
...
V_144 = F_193 ( V_346 , struct V_142 , V_223 ) ;
...
if ( V_143 == 0 ) {
unsigned long V_347 ;
F_79 ( & V_56 -> V_167 , V_347 ) ;
F_142 ( V_49 -> V_164 , & V_56 -> V_61 ) ;
V_56 -> V_168 -- ;
F_73 ( V_56 ) ;
F_80 ( & V_56 -> V_167 , V_347 ) ;
if ( ! ( V_56 -> V_58 & V_59 ) &&
! ( V_56 -> V_58 & V_60 ) ) {
F_79 ( & V_49 -> V_84 , V_347 ) ;
F_142 ( V_56 -> V_171 , V_49 -> V_165 ) ;
V_49 -> V_155 [ V_56 -> V_171 ] = NULL ;
F_80 ( & V_49 -> V_84 , V_347 ) ;
}
}
}
...
F_79 ( & V_56 -> V_167 , V_349 ) ;
if ( F_310 ( V_49 -> V_164 ,
& V_56 -> V_61 ) ) {
V_56 -> V_168 -- ;
F_73 ( V_56 ) ;
}
F_80 ( & V_56 -> V_167 , V_349 ) ;
F_53 ( V_144 ) ;
F_79 ( & V_146 , V_348 ) ;
}
F_80 ( & V_146 , V_348 ) ;
...
static int F_208 ( struct V_55 * V_56 , int V_188 )
{
int V_189 ;
F_154 ( & V_56 -> V_187 , V_175 ) ;
F_138 ( & V_56 -> V_167 ) ;
...
static int F_313 ( struct V_352 * V_56 )
{
struct V_55 * V_55 ;
V_55 = F_311 () ;
if ( ! V_55 ) {
...
static void F_314 ( struct V_352 * V_56 )
{
struct V_55 * V_55 = V_56 -> V_353 ;
V_56 -> V_353 = NULL ;
F_143 ( V_55 ) ;
}
static int F_315 ( struct V_352 * V_56 ,
struct V_264 * V_147 )
{
struct V_55 * V_55 = V_56 -> V_353 ;
struct V_172 * V_173 = F_234 ( V_147 ) ;
...
if ( V_55 -> V_351 > ( 1LL << V_90 ) ) {
F_42 ( V_141 L_78
L_79 ,
V_355 , V_90 , V_55 -> V_351 ) ;
return - V_194 ;
}
V_55 -> V_107 = V_90 ;
...
static void F_316 ( struct V_352 * V_56 ,
struct V_264 * V_147 )
{
struct V_55 * V_55 = V_56 -> V_353 ;
struct V_172 * V_173 = F_234 ( V_147 ) ;
...
static int F_317 ( struct V_352 * V_56 ,
unsigned long V_46 , T_6 V_356 ,
T_5 V_82 , int V_357 )
{
struct V_55 * V_55 = V_56 -> V_353 ;
V_23 V_351 ;
...
F_42 ( V_141 L_78
L_79 ,
V_355 , V_55 -> V_107 , V_351 ) ;
return - V_194 ;
}
V_55 -> V_351 = V_351 ;
}
V_82 = F_179 ( V_356 , V_82 ) ;
V_86 = F_190 ( V_55 , V_46 >> V_10 ,
V_356 >> V_10 , V_82 , V_30 ) ;
return V_86 ;
}
static T_5 F_319 ( struct V_352 * V_56 ,
...
( V_46 + V_82 - 1 ) >> V_10 ) ;
if ( V_55 -> V_351 == V_46 + V_82 )
V_55 -> V_351 = V_46 ;
return V_190 << V_105 ;
}
static T_6 F_320 ( struct V_352 * V_56 ,
unsigned long V_46 )
{
struct V_55 * V_55 = V_56 -> V_353 ;
struct V_25 * V_26 ;
...
static int F_321 ( struct V_352 * V_56 ,
unsigned long V_52 )
{
struct V_55 * V_55 = V_56 -> V_353 ;
if ( V_52 == V_362 )
...
static int F_322 ( struct V_264 * V_147 , unsigned int * V_365 )
{
struct V_172 * V_173 = F_234 ( V_147 ) ;
struct V_172 * V_330 ;
union {
...
if ( F_242 ( V_147 ) )
return - V_180 ;
V_171 . V_366 . V_72 = F_175 ( V_173 -> V_73 ) ;
V_171 . V_366 . V_73 = V_173 -> V_73 -> V_78 ;
V_171 . V_366 . V_74 = V_173 -> V_74 ;
if ( ! F_74 ( V_171 . V_366 . V_72 , V_171 . V_366 . V_73 , V_171 . V_366 . V_74 ) )
return - V_180 ;
V_330 = F_176 ( V_173 ) ;
if ( V_330 ) {
if ( F_177 ( V_330 ) ) {
V_171 . V_366 . V_73 = V_330 -> V_79 -> V_78 ;
V_171 . V_366 . V_74 = 0 ;
} else {
V_171 . V_366 . V_73 = V_330 -> V_73 -> V_78 ;
V_171 . V_366 . V_74 = V_330 -> V_74 ;
}
}
if ( ! V_173 -> V_368 && V_369 )
V_171 . V_366 . V_74 = F_275 ( F_170 ( V_171 . V_366 . V_74 ) , 0 ) ;
* V_365 = V_171 . V_367 ;
return 0 ;
}
...
static void T_8 F_324 ( struct V_172 * V_147 )
{
unsigned short V_371 ;
if ( F_325 ( V_147 , V_372 , & V_371 ) )
return;
if ( ! ( V_371 & V_373 ) ) {
F_42 ( V_35 L_82 ) ;
V_36 = 0 ;
...
struct V_172 * V_173 ;
T_9 V_374 ;
V_173 = F_326 ( V_375 , 0x3a3e , NULL ) ;
if ( ! V_173 )
return;
F_327 ( V_173 ) ;
V_173 = F_326 ( V_375 , 0x342e , NULL ) ;
if ( ! V_173 )
return;
if ( F_328 ( V_173 , 0x188 , & V_374 ) ) {
F_327 ( V_173 ) ;
return;
}
F_327 ( V_173 ) ;
