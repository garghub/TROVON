...
struct V_7 * V_8 ;
int V_134 ;
V_8 = F_39 ( & V_145 -> V_8 , sizeof( struct V_7 ) ,
V_153 ) ;
if ( ! V_8 )
return - V_154 ;
...
V_149 = F_42 ( & V_145 -> V_8 , V_148 -> V_157 ,
F_43 ( V_148 ) , V_145 -> V_158 ) ;
if ( ! V_149 ) {
F_41 ( & V_145 -> V_8 , L_6 ) ;
return - V_159 ;
}
V_152 = V_145 -> V_8 . V_160 ;
V_8 -> V_139 = F_44 ( & V_145 -> V_8 , NULL ) ;
if ( F_45 ( V_8 -> V_139 ) )
return - V_156 ;
F_34 ( V_8 -> V_139 ) ;
V_8 -> V_138 = 1 ;
V_8 -> V_9 = F_46 ( & V_145 -> V_8 , V_148 -> V_157 , F_43 ( V_148 ) ) ;
if ( ! V_8 -> V_9 ) {
F_41 ( & V_145 -> V_8 , L_7 ) ;
V_134 = - V_154 ;
goto V_161;
...
V_8 -> V_26 = V_152 -> V_26 ;
V_8 -> V_27 = V_152 -> V_27 ;
V_8 -> V_162 = V_152 -> V_162 ;
V_8 -> V_130 = V_152 -> V_130 ;
V_8 -> V_32 = V_152 -> V_32 ;
V_8 -> V_35 = V_152 -> V_35 ;
V_146 = & V_8 -> V_117 [ V_31 ] ;
V_146 -> V_163 = V_152 -> V_163 ;
V_146 -> V_164 = V_152 -> V_164 ;
V_146 -> V_165 = V_152 -> V_166 ;
V_146 -> V_167 = ( V_168 ) ( V_152 -> V_169 +
V_148 -> V_157 ) ;
V_150 = F_40 ( V_145 , V_170 , 0 ) ;
if ( ! V_150 ) {
F_41 ( & V_145 -> V_8 , L_8 ) ;
V_134 = - V_156 ;
goto V_161;
}
V_146 -> V_171 = V_150 -> V_157 ;
V_146 = & V_8 -> V_117 [ V_96 ] ;
V_146 -> V_163 = V_152 -> V_163 ;
V_146 -> V_164 = V_152 -> V_164 ;
V_146 -> V_165 = V_152 -> V_172 ;
V_146 -> V_167 = ( V_168 ) ( V_152 -> V_173 +
V_148 -> V_157 ) ;
V_150 = F_40 ( V_145 , V_170 , 1 ) ;
if ( ! V_150 ) {
F_41 ( & V_145 -> V_8 , L_8 ) ;
V_134 = - V_156 ;
goto V_161;
...
V_146 -> V_171 = V_150 -> V_157 ;
F_47 ( & V_145 -> V_8 , V_8 ) ;
V_134 = F_48 ( & V_145 -> V_8 , & V_174 [ V_152 -> V_120 ] ) ;
if ( V_134 != 0 )
goto V_161;
return 0 ;
V_161:
