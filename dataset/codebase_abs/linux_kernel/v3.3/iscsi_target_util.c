...
T_1 V_171 = ( V_15 -> V_172 -> V_171 * 4 ) ;
T_1 V_173 = ( V_15 -> V_172 -> V_173 * 4 ) ;
if ( V_15 -> V_172 -> V_174 ) {
V_15 -> V_175 += V_176 ;
if ( V_15 -> V_175 <= V_173 ) {
V_15 -> V_175 = ( V_173 - V_15 -> V_175 ) ;
} else {
V_169 = ( V_15 -> V_175 / V_173 ) ;
V_170 = ( V_173 * ( V_169 + 1 ) ) +
( V_169 * V_177 ) ;
V_15 -> V_175 = ( V_170 - V_15 -> V_175 ) ;
}
V_15 -> V_178 = 0 ;
F_21 ( L_36
L_37 , V_15 -> V_175 ) ;
...
if ( V_15 -> V_172 -> V_179 ) {
if ( V_15 -> V_180 <= V_171 ) {
V_15 -> V_180 = ( V_171 - V_15 -> V_180 ) ;
} else {
V_168 = ( V_15 -> V_180 / V_171 ) ;
V_170 = ( V_171 * ( V_168 + 1 ) ) +
( V_168 * V_177 ) ;
V_15 -> V_180 = ( V_170 - V_15 -> V_180 ) ;
}
F_21 ( L_38
L_37 , V_15 -> V_180 ) ;
}
...
static int F_81 ( struct V_21 * V_15 , int V_190 )
{
T_3 V_139 ;
struct V_1 * V_2 ;
V_2 = F_17 ( V_15 , V_10 ) ;
...
V_2 -> V_19 = 0xFFFFFFFF ;
F_8 ( & V_15 -> V_48 -> V_194 ) ;
V_2 -> V_131 = ( V_190 ) ? V_15 -> V_48 -> V_131 ++ :
0xFFFFFFFF ;
if ( V_190 && ( V_2 -> V_131 == 0xFFFFFFFF ) )
V_2 -> V_131 = V_15 -> V_48 -> V_131 ++ ;
F_6 ( & V_15 -> V_48 -> V_194 ) ;
F_8 ( & V_15 -> V_129 ) ;
F_5 ( & V_2 -> V_24 , & V_15 -> V_195 ) ;
F_6 ( & V_15 -> V_129 ) ;
if ( V_190 )
F_82 ( V_15 ) ;
F_7 ( V_2 , V_15 , V_139 ) ;
...
{
struct V_21 * V_15 = (struct V_21 * ) V_196 ;
F_77 ( V_15 ) ;
F_8 ( & V_15 -> V_197 ) ;
if ( V_15 -> V_198 & V_199 ) {
F_6 ( & V_15 -> V_197 ) ;
...
F_6 ( & V_15 -> V_197 ) ;
{
struct V_202 * V_203 = V_15 -> V_48 -> V_203 ;
struct V_204 * V_205 = V_203 -> V_206 ;
if ( V_205 ) {
F_8 ( & V_205 -> V_207 . V_208 ) ;
strcpy ( V_205 -> V_207 . V_209 ,
V_15 -> V_48 -> V_79 -> V_210 ) ;
V_205 -> V_207 . V_211 =
V_212 ;
V_205 -> V_207 . V_213 ++ ;
V_15 -> V_48 -> V_214 ++ ;
F_6 ( & V_205 -> V_207 . V_208 ) ;
}
}
F_84 ( V_15 , 0 ) ;
F_80 ( V_15 ) ;
...
V_15 -> V_215 . V_218 =
( F_87 () + V_78 -> V_216 * V_217 ) ;
V_15 -> V_215 . V_196 = ( unsigned long ) V_15 ;
V_15 -> V_215 . V_51 = F_83 ;
V_15 -> V_198 &= ~ V_199 ;
V_15 -> V_198 |= V_201 ;
F_89 ( & V_15 -> V_215 ) ;
F_21 ( L_41
L_42 , V_15 -> V_130 , V_78 -> V_216 ) ;
F_6 ( & V_15 -> V_197 ) ;
}
...
static void F_92 ( unsigned long V_196 )
{
struct V_21 * V_15 = (struct V_21 * ) V_196 ;
F_77 ( V_15 ) ;
F_8 ( & V_15 -> V_197 ) ;
...
return;
F_88 ( & V_15 -> V_221 ) ;
V_15 -> V_221 . V_218 = ( F_87 () + V_78 -> V_220 * V_217 ) ;
V_15 -> V_221 . V_196 = ( unsigned long ) V_15 ;
V_15 -> V_221 . V_51 = F_92 ;
V_15 -> V_219 &= ~ V_199 ;
V_15 -> V_219 |= V_201 ;
F_89 ( & V_15 -> V_221 ) ;
F_21 ( L_43
L_44 , V_15 -> V_130 , V_78 -> V_220 ) ;
}
...
V_223 = F_97 ( V_15 , & V_227 [ 0 ] , V_225 , V_224 ) ;
if ( V_224 != V_223 ) {
if ( V_223 == - V_232 ) {
F_3 ( L_45 ) ;
goto V_228;
...
if ( V_15 -> V_172 -> V_241 )
V_236 += V_242 ;
V_227 . V_243 = V_2 -> V_244 ;
V_227 . V_245 = V_236 ;
V_223 = F_97 ( V_15 , & V_227 , 1 , V_236 ) ;
if ( V_236 != V_223 ) {
if ( V_223 == - V_232 ) {
F_3 ( L_45 ) ;
goto V_240;
...
V_237 = V_2 -> V_224 - V_236 - V_2 -> V_246 ;
if ( V_15 -> V_172 -> V_247 ) {
V_237 -= V_242 ;
if ( V_2 -> V_246 )
V_239 = ( V_2 -> V_229 - 2 ) ;
...
while ( V_237 ) {
T_1 V_248 = ( V_234 -> V_17 - V_3 ) ;
T_1 V_249 = F_99 ( T_1 , V_237 , V_248 ) ;
V_250:
V_223 = V_15 -> V_251 -> V_252 -> V_253 ( V_15 -> V_251 ,
F_66 ( V_234 ) , V_234 -> V_3 + V_3 , V_249 , 0 ) ;
if ( V_223 != V_249 ) {
if ( V_223 == - V_232 ) {
F_3 ( L_46
L_47 ) ;
...
V_254:
if ( V_2 -> V_246 ) {
struct V_226 * V_255 = & V_2 -> V_156 [ V_239 ++ ] ;
V_223 = F_97 ( V_15 , V_255 , 1 , V_2 -> V_246 ) ;
if ( V_2 -> V_246 != V_223 ) {
if ( V_223 == - V_232 ) {
F_3 ( L_45 ) ;
goto V_254;
...
V_256:
if ( V_15 -> V_172 -> V_247 ) {
struct V_226 * V_257 = & V_2 -> V_156 [ V_239 ] ;
V_223 = F_97 ( V_15 , V_257 , 1 , V_242 ) ;
if ( V_242 != V_223 ) {
if ( V_223 == - V_232 ) {
F_3 ( L_45 ) ;
goto V_256;
...
int F_101 ( struct V_21 * V_15 , T_3 V_258 , T_3 V_259 )
{
T_3 V_260 [ V_176 ] ;
int V_261 ;
struct V_226 V_227 ;
struct V_262 * V_119 ;
F_102 ( V_15 , V_258 , V_259 ) ;
memset ( & V_227 , 0 , sizeof( struct V_226 ) ) ;
memset ( & V_260 , 0x0 , V_176 ) ;
V_119 = (struct V_262 * ) & V_260 ;
V_119 -> V_263 = V_264 ;
V_119 -> V_258 = V_258 ;
V_119 -> V_259 = V_259 ;
V_119 -> V_265 = F_103 ( V_15 -> V_266 ) ;
V_227 . V_243 = & V_260 ;
V_227 . V_245 = V_176 ;
F_104 ( V_260 , V_176 ) ;
V_261 = F_97 ( V_15 , & V_227 , 1 , V_176 ) ;
if ( V_261 != V_176 ) {
F_3 ( L_49 ) ;
return - 1 ;
}
...
struct V_267 * V_268 )
{
int V_196 = V_268 -> V_31 , V_269 = 0 , V_270 = 0 , V_245 ;
struct V_226 * V_255 ;
struct V_271 V_272 ;
if ( ! V_15 || ! V_15 -> V_251 || ! V_15 -> V_172 )
return - 1 ;
memset ( & V_272 , 0 , sizeof( struct V_271 ) ) ;
V_255 = V_268 -> V_227 ;
V_245 = V_268 -> V_225 ;
while ( V_270 < V_196 ) {
V_269 = F_109 ( V_15 -> V_251 , & V_272 , V_255 , V_245 ,
( V_196 - V_270 ) , V_273 ) ;
if ( V_269 <= 0 ) {
F_21 ( L_52 ,
V_269 , V_270 ) ;
...
struct V_267 * V_268 )
{
int V_196 = V_268 -> V_31 , V_274 = 0 , V_275 = 0 , V_245 ;
struct V_226 * V_255 ;
struct V_271 V_272 ;
if ( ! V_15 || ! V_15 -> V_251 || ! V_15 -> V_172 )
return - 1 ;
...
V_245 = V_268 -> V_225 ;
while ( V_274 < V_196 ) {
V_275 = F_111 ( V_15 -> V_251 , & V_272 , V_255 , V_245 ,
( V_196 - V_274 ) ) ;
if ( V_275 <= 0 ) {
F_21 ( L_55 ,
V_275 , V_274 ) ;
...
if ( ! V_15 || ! V_15 -> V_251 || ! V_15 -> V_172 )
return - 1 ;
memset ( & V_276 , 0 , sizeof( struct V_267 ) ) ;
V_276 . V_227 = V_227 ;
V_276 . V_225 = V_225 ;
V_276 . V_31 = V_196 ;
V_276 . type = V_277 ;
return F_108 ( V_15 , & V_276 ) ;
}
int F_97 (
struct V_21 * V_15 ,
struct V_226 * V_227 ,
...
V_282 = & V_205 -> V_283 ;
F_50 ( & V_282 -> V_208 ) ;
if ( ! strcmp ( V_15 -> V_284 , V_282 -> V_285 ) &&
( ( F_87 () - V_282 -> V_286 ) < 10 ) ) {
F_51 ( & V_282 -> V_208 ) ;
return;
}
...
V_15 -> V_305 ) ;
strcpy ( V_282 -> V_307 ,
( V_280 ? V_280 -> V_308 : L_57 ) ) ;
V_282 -> V_309 = V_15 -> V_251 -> V_310 -> V_311 ;
snprintf ( V_282 -> V_285 , V_312 ,
L_58 , V_15 -> V_284 ) ;
V_282 -> V_286 = F_87 () ;
}
F_51 ( & V_282 -> V_208 ) ;
}
struct V_204 * F_113 ( struct V_21 * V_15 )
{
struct V_202 * V_203 ;
if ( ! V_15 || ! V_15 -> V_48 )
return NULL ;
V_203 = V_15 -> V_48 -> V_203 ;
if ( ! V_203 )
return NULL ;
if ( ! V_203 -> V_206 )
return NULL ;
