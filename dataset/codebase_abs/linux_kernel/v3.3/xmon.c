...
V_89 = F_102 ( V_89 , V_90 ) ;
}
printf ( L_39 , V_89 ) ;
}
static long F_103 ( unsigned long V_93 )
{
unsigned int V_48 ;
V_93 &= ~ 3 ;
if ( ! F_104 ( V_93 ) ) {
...
static void F_106 ( unsigned long V_59 , unsigned long * V_101 ,
unsigned long * V_102 )
{
...
V_58 = 1 ;
F_1 () ;
V_104 = F_107 ( V_59 , & V_103 , & V_27 , NULL , V_106 ) ;
if ( V_104 != NULL ) {
* V_101 = V_59 - V_27 ;
...
static void
F_119 ( int V_132 , unsigned long V_144 )
{
unsigned int V_141 [ 2 ] ;
...
F_100 ( V_147 ) , F_100 ( V_148 ) ) ;
printf ( L_119 V_98 L_120 V_98 L_32 ,
F_100 ( V_149 ) , F_100 ( V_150 ) ) ;
printf ( L_121 V_98 L_122 V_98 L_32 , V_107 , F_100 ( V_151 ) ) ;
printf ( L_123 V_98 L_124 V_98 L_32 , V_145 , F_100 ( V_152 ) ) ;
#ifdef F_121
if ( F_122 ( V_153 ) ) {
struct V_154 * V_155 ;
struct V_156 * V_157 ;
...
F_119 ( V_165 , V_144 ) ;
case 'r' :
printf ( L_130 , V_165 , F_118 ( V_165 ) ) ;
break;
}
F_108 () ;
}
...
static void
F_123 ( unsigned char * V_144 , int V_103 )
{
int V_173 ;
switch ( V_103 ) {
case 2 :
F_124 ( V_144 [ 0 ] , V_144 [ 1 ] , V_173 ) ;
break;
case 4 :
F_124 ( V_144 [ 0 ] , V_144 [ 3 ] , V_173 ) ;
F_124 ( V_144 [ 1 ] , V_144 [ 2 ] , V_173 ) ;
break;
case 8 :
F_124 ( V_144 [ 0 ] , V_144 [ 7 ] , V_173 ) ;
F_124 ( V_144 [ 1 ] , V_144 [ 6 ] , V_173 ) ;
F_124 ( V_144 [ 2 ] , V_144 [ 5 ] , V_173 ) ;
F_124 ( V_144 [ 3 ] , V_144 [ 4 ] , V_173 ) ;
break;
}
}
static void
...
static void F_126 ( unsigned long V_91 , long V_182 )
{
...
static void
F_128 ( unsigned long V_91 , long V_182 )
{
...
static int
F_129 ( unsigned long V_189 , long V_87 , int V_190 ,
T_2 V_191 )
{
int V_185 , V_192 ;
unsigned long V_193 ;
...
{
return F_129 ( V_189 , V_87 , V_190 , V_197 ) ;
}
void
F_131 ( unsigned long V_93 )
{
...
V_77 = 0 ;
F_101 ( ( void * ) & V_204 ) ;
F_133 ( ( unsigned char * ) V_200 , ( unsigned char * ) V_202 , V_203 , V_204 ) ;
break;
}
}
static void
F_133 ( unsigned char * V_205 , unsigned char * V_206 , unsigned V_207 , unsigned V_208 )
{
...
&& ( ( F_130 ( V_144 ) ^ V_201 ) & V_211 ) == 0 ) {
printf ( L_153 , V_65 , F_130 ( V_144 ) ) ;
if ( ++ V_132 >= 10 )
break;
}
}
...
V_58 = 1 ;
F_1 () ;
V_104 = F_107 ( V_32 , & V_103 , & V_27 , & V_227 ,
V_106 ) ;
F_1 () ;
F_116 ( 200 ) ;
}
...
{
int V_60 ;
unsigned long * V_224 = ( unsigned long * ) F_115 () -> V_239 ;
printf ( L_169 , F_11 () ) ;
...
V_169 V_277 = F_143 ( V_260 ) ;
V_169 V_278 = F_144 ( V_279 ) ;
V_170 V_280 = 0 ;
V_170 V_281 ;
...
F_1 () ;
V_319 = V_322 [ V_60 ] . V_319 ;
F_161 ( V_319 , V_322 [ V_60 ] . V_329 ) ;
F_163 ( & V_319 -> V_327 -> V_328 ,
V_322 [ V_60 ] . V_326 ) ;
F_1 () ;
F_116 ( 200 ) ;
printf ( L_228 , V_60 ) ;
...
static void F_164 ( struct V_319 * V_319 )
{
printf ( L_230 , V_319 ) ;
F_165 ( V_319 , L_231 , V_320 ) ;
F_165 ( V_319 , L_135 , V_104 ) ;
F_165 ( V_319 , L_232 , V_331 ) ;
F_165 ( V_319 , L_233 , V_325 ) ;
F_165 ( V_319 , L_232 , V_332 ) ;
F_165 ( V_319 , L_231 , V_333 ) ;
F_165 ( V_319 , L_232 , V_28 ) ;
F_165 ( V_319 , L_234 , V_334 ) ;
F_165 ( V_319 , L_232 , V_335 ) ;
F_165 ( V_319 , L_232 , V_336 ) ;
F_165 ( V_319 , L_232 , V_337 ) ;
F_165 ( V_319 , L_232 , V_338 [ 0 ] ) ;
F_165 ( V_319 , L_232 , V_338 [ 1 ] ) ;
F_165 ( V_319 , L_232 , V_338 [ 2 ] ) ;
F_165 ( V_319 , L_231 , V_339 ) ;
F_165 ( V_319 , L_234 , V_130 ) ;
F_165 ( V_319 , L_233 , V_340 ) ;
F_165 ( V_319 , L_233 , V_341 ) ;
F_165 ( V_319 , L_233 , V_342 ) ;
F_165 ( V_319 , L_233 , V_343 ) ;
F_165 ( V_319 , L_232 , V_344 ) ;
F_165 ( V_319 , L_233 , V_327 ) ;
F_166 ( L_231 , V_327 -> V_328 ,
F_159 ( & V_319 -> V_327 -> V_328 ) ) ;
F_166 ( L_231 , V_327 -> V_345 ,
F_159 ( & V_319 -> V_327 -> V_345 ) ) ;
F_166 ( L_231 , V_327 -> V_346 ,
F_159 ( & V_319 -> V_327 -> V_346 ) ) ;
F_165 ( V_319 , L_233 , V_347 ) ;
F_165 ( V_319 , L_233 , V_348 ) ;
}
int
F_167 ( unsigned long V_189 , long V_87 , int V_190 )
{
return F_129 ( V_189 , V_87 , V_190 , V_349 ) ;
}
static void F_168 ( unsigned long V_350 , int V_351 )
{
