...
static int T_2 F_29 ( struct V_54 * V_55 )
{
struct V_56 * V_57 = V_55 -> V_48 . V_58 ;
struct V_1 * V_2 ;
struct V_22 * V_22 ;
int V_11 ;
V_2 = F_30 ( sizeof( struct V_1 ) , V_59 ) ;
if ( V_2 == NULL ) {
F_31 ( & V_55 -> V_48 , L_1 ) ;
return - V_60 ;
}
V_2 -> V_3 = V_55 -> V_48 . V_61 ;
if ( V_57 ) {
V_2 -> V_37 = V_57 -> V_37 ;
V_2 -> V_20 = V_57 -> V_20 ;
V_2 -> V_21 = V_57 -> V_21 ;
...
V_22 -> V_65 = F_22 ;
V_22 -> V_66 = F_26 ;
V_22 -> V_48 . V_61 = & V_55 -> V_48 ;
F_34 ( V_67 , V_22 -> V_68 ) ;
F_34 ( V_23 , V_22 -> V_69 ) ;
F_34 ( V_24 , V_22 -> V_69 ) ;
F_35 ( V_22 , V_23 , 0 , 1023 , 0 , 0 ) ;
F_35 ( V_22 , V_24 , 0 , 1023 , 0 , 0 ) ;
F_34 ( V_70 , V_22 -> V_68 ) ;
F_34 ( V_25 , V_22 -> V_71 ) ;
V_2 -> V_22 = V_22 ;
F_36 ( V_22 , V_2 ) ;
...
static int T_3 F_41 ( struct V_54 * V_55 )
{
