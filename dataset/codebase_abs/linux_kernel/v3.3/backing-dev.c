...
static void F_96 ( struct V_1 * V_12 , struct V_9 * V_10 )
{
...
V_10 -> V_24 = V_110 ;
V_10 -> V_112 = V_110 ;
V_50 = F_100 ( & V_10 -> V_113 ) ;
if ( V_50 ) {
V_50:
while ( V_100 -- )
F_101 ( & V_10 -> F_13 [ V_100 ] ) ;
}
return V_50 ;
}
...
F_1 ( & V_10 -> V_12 , V_114 ) ;
F_103 ( & V_10 -> V_12 . V_97 , & V_114 -> V_97 ) ;
F_103 ( & V_10 -> V_12 . V_98 , & V_114 -> V_98 ) ;
F_103 ( & V_10 -> V_12 . V_99 , & V_114 -> V_99 ) ;
F_8 ( & V_10 -> V_12 . V_4 ) ;
F_8 ( & V_114 -> V_4 ) ;
}
F_92 ( V_10 ) ;
...
int F_105 ( struct V_9 * V_10 , char * V_29 ,
unsigned int V_115 )
{
char V_116 [ 32 ] ;
int V_50 ;
...
V_50 = F_38 ( V_10 , NULL , V_116 , F_106 ( & V_118 ) ) ;
if ( V_50 ) {
F_102 ( V_10 ) ;
return V_50 ;
}
...
void F_107 ( struct V_9 * V_10 , int V_119 )
{
enum V_120 V_121 ;
T_7 * V_122 = & V_123 [ V_119 ] ;
V_121 = V_119 ? V_124 : V_125 ;
if ( F_108 ( V_121 , & V_10 -> V_26 ) )
F_109 ( & V_126 [ V_119 ] ) ;
F_60 () ;
if ( F_110 ( V_122 ) )
F_111 ( V_122 ) ;
}
void F_112 ( struct V_9 * V_10 , int V_119 )
{
enum V_120 V_121 ;
V_121 = V_119 ? V_124 : V_125 ;
if ( ! F_113 ( V_121 , & V_10 -> V_26 ) )
F_114 ( & V_126 [ V_119 ] ) ;
}
long F_115 ( int V_119 , long V_66 )
{
long V_41 ;
unsigned long V_127 = V_62 ;
F_116 ( V_128 ) ;
T_7 * V_122 = & V_123 [ V_119 ] ;
F_117 ( V_122 , & V_128 , V_91 ) ;
V_41 = F_118 ( V_66 ) ;
F_119 ( V_122 , & V_128 ) ;
F_120 ( F_121 ( V_66 ) ,
F_121 ( V_62 - V_127 ) ) ;
...
long F_122 ( struct V_129 * V_129 , int V_119 , long V_66 )
{
long V_41 ;
unsigned long V_127 = V_62 ;
F_116 ( V_128 ) ;
T_7 * V_122 = & V_123 [ V_119 ] ;
if ( F_123 ( & V_126 [ V_119 ] ) == 0 ||
! F_124 ( V_129 ) ) {
F_125 () ;
