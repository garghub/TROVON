...
static int F_6 ( struct V_22 * V_23 , T_2 V_2 ,
T_3 * V_6 , T_4 V_7 ,
bool V_24 , bool V_4 )
{
T_5 V_25 = V_23 -> V_26 ;
...
F_10 ( V_13 , L_9 , V_25 ) ;
F_10 ( V_13 , L_10 , V_23 -> V_26 ) ;
F_10 ( V_13 , L_11 , V_7 ) ;
if ( V_8 == 0 ) {
F_9 ( V_13 , L_12 , V_23 -> V_26 ,
V_23 -> V_28 ) ;
if ( V_23 -> V_26 == V_25 ) {
if ( V_7 != 0 ) {
F_11 ( V_23 ) ;
...
static int F_20 ( struct V_39 * V_40 , struct V_41 * V_42 , char * V_50 , char * V_45 )
{
F_15 ( L_14 ) ;
F_2 ( V_13 ) ;
strcpy ( V_50 , L_15 ) ;
...
static int F_21 ( struct V_39 * V_40 , struct V_41 * V_42 , struct V_51 * V_52 , char * V_45 )
{
struct V_22 * V_23 = F_14 ( V_40 ) ;
unsigned long V_46 ;
int V_53 = 0 ;
...
static int F_25 ( struct V_39 * V_40 , struct V_41 * V_42 , struct V_51 * V_52 , char * V_45 )
{
struct V_22 * V_23 = F_14 ( V_40 ) ;
unsigned long V_46 ;
int V_8 = - 1 ;
...
V_23 -> V_60 . V_14 = 2 ;
V_23 -> V_60 . V_15 = V_61 ;
V_8 = F_26 ( & ( V_23 -> V_29 ) , ( V_62 ) & ( V_23 -> V_60 ) ) ;
if( V_8 == V_63 ) {
T_6 V_53 = F_27 ( V_23 -> V_60 . V_17 . T_2 [ 0 ] ) ;
V_52 -> V_58 = F_28 ( V_53 ) * 100000 ;
V_52 -> V_56 = 1 ;
}
F_18 ( V_23 ) ;
F_19 ( V_23 , & V_46 ) ;
...
static int F_29 ( struct V_39 * V_40 , struct V_41 * V_42 , struct V_65 * V_66 , char * V_45 )
{
struct V_22 * V_23 = F_14 ( V_40 ) ;
unsigned long V_46 ;
...
V_23 -> V_60 . V_15 = V_75 ;
V_69 = F_26 ( & ( V_23 -> V_29 ) , ( V_62 ) & ( V_23 -> V_60 ) ) ;
if( V_69 != V_63 ) {
F_10 ( V_13 , L_19 , V_69 ) ;
if ( V_72 < 10 ) {
V_72 ++ ;
...
V_68 -> V_84 . V_88 = ( V_86 ) ( F_31 ( V_89 ) - 1 ) ;
V_68 -> V_84 . V_90 = ( V_86 ) ( F_31 ( V_91 ) - 1 ) ;
V_68 -> V_92 = 0 ;
V_23 -> V_60 . V_14 = 6 ;
V_23 -> V_60 . V_15 = V_93 ;
V_69 = F_26 ( & ( V_23 -> V_29 ) , ( V_62 ) & ( V_23 -> V_60 ) ) ;
...
F_10 ( V_13 , L_25 ) ;
F_33 ( V_68 -> V_114 ) ;
F_34 ( V_68 -> V_114 , V_115 ) ;
F_34 ( V_68 -> V_114 , V_116 ) ;
F_34 ( V_68 -> V_114 , V_117 ) ;
F_34 ( V_68 -> V_114 , V_118 ) ;
F_34 ( V_68 -> V_114 , V_119 ) ;
F_34 ( V_68 -> V_114 , V_120 ) ;
F_34 ( V_68 -> V_114 , V_121 ) ;
...
static int F_35 ( struct V_39 * V_40 , struct V_41 * V_42 , struct V_127 * V_128 , char * V_45 )
{
struct V_22 * V_23 = F_14 ( V_40 ) ;
unsigned long V_46 ;
int V_8 = 0 ;
...
#if 1
if ( F_36 ( V_23 -> V_29 . V_133 . V_134 ) == V_135 ) {
...
static int F_37 ( struct V_39 * V_40 , struct V_41 * V_42 , struct V_65 * V_66 , char * V_45 )
{
struct V_22 * V_23 = F_14 ( V_40 ) ;
unsigned long V_46 ;
int V_8 ;
...
V_23 -> V_60 . V_17 . T_2 [ 0 ] = F_36 ( 0x7FFF ) ;
V_8 = F_39 ( & ( V_23 -> V_29 ) , ( V_62 ) & ( V_23 -> V_60 ) ) ;
F_10 ( V_13 , L_28 , V_8 ) ;
V_23 -> V_60 . V_14 = 2 ;
V_23 -> V_60 . V_15 = V_146 ;
V_23 -> V_60 . V_17 . T_2 [ 0 ] = F_36 ( 0 ) ;
V_8 = F_39 ( & ( V_23 -> V_29 ) , ( V_62 ) & ( V_23 -> V_60 ) ) ;
F_10 ( V_13 , L_29 , V_8 ) ;
#ifdef F_38
V_8 = F_40 ( & ( V_23 -> V_29 ) , V_147 ) ;
#else
V_8 = F_40 ( & ( V_23 -> V_29 ) , V_148 ) ;
#endif
F_18 ( V_23 ) ;
F_19 ( V_23 , & V_46 ) ;
if( V_8 == V_63 ) {
...
static int F_47 ( struct V_39 * V_40 , struct V_41 * V_42 , struct V_156 * V_157 , char * V_45 )
{
struct V_22 * V_23 = F_14 ( V_40 ) ;
unsigned long V_46 ;
int V_8 = 0 ;
...
static int F_49 ( struct V_39 * V_40 , struct V_41 * V_42 , struct V_65 * V_66 , char * V_162 )
{
struct V_22 * V_23 = F_14 ( V_40 ) ;
unsigned long V_46 ;
int V_8 = 0 ;
...
static int F_51 ( struct V_39 * V_40 , struct V_41 * V_42 , struct V_65 * V_66 , char * V_166 )
{
struct V_22 * V_23 = F_14 ( V_40 ) ;
unsigned long V_46 ;
int V_8 = 0 ;
...
#endif
#if 1
if ( F_36 ( V_23 -> V_29 . V_133 . V_134 ) == V_169 ) {
...
static int F_52 ( struct V_39 * V_40 , struct V_41 * V_42 , struct V_65 * V_173 , char * V_174 )
{
struct V_22 * V_23 = F_14 ( V_40 ) ;
unsigned long V_46 ;
...
F_16 ( V_23 , & V_46 ) ;
F_17 ( V_23 ) ;
V_8 = F_6 ( V_23 , V_2 , V_174 , V_173 -> V_73 ,
V_24 , true ) ;
if ( V_8 == 0 )
F_53 ( V_40 ) ;
F_18 ( V_23 ) ;
...
static int F_54 ( struct V_39 * V_40 , struct V_41 * V_42 , struct V_65 * V_173 , char * V_6 )
{
struct V_22 * V_23 = F_14 ( V_40 ) ;
unsigned long V_46 ;
int V_8 = 0 ;
...
F_15 ( L_40 ) ;
F_2 ( V_13 ) ;
F_9 ( V_13 , L_41 , V_23 -> V_26 , V_23 -> V_28 ) ;
if( V_23 -> V_47 == V_48 ) {
V_8 = - V_49 ;
goto V_31;
}
...
static int F_55 ( struct V_39 * V_40 , struct V_41 * V_42 , struct V_65 * V_66 , char * V_178 )
{
struct V_22 * V_23 = F_14 ( V_40 ) ;
unsigned long V_46 ;
int V_8 = 0 ;
...
static int F_57 ( struct V_39 * V_40 , struct V_41 * V_42 , T_12 * V_181 , char * V_45 )
{
struct V_22 * V_23 = F_14 ( V_40 ) ;
unsigned long V_46 ;
int V_8 = 0 ;
...
static int F_60 ( struct V_39 * V_40 , struct V_41 * V_42 , T_12 * V_181 , char * V_45 )
{
struct V_22 * V_23 = F_14 ( V_40 ) ;
unsigned long V_46 ;
int V_8 = 0 ;
...
static int F_61 ( struct V_39 * V_40 , struct V_41 * V_42 , struct V_156 * V_196 , char * V_45 )
{
struct V_22 * V_23 = F_14 ( V_40 ) ;
unsigned long V_46 ;
int V_8 = 0 ;
...
static int F_62 ( struct V_39 * V_40 , struct V_41 * V_42 , struct V_156 * V_199 , char * V_45 )
{
struct V_22 * V_23 = F_14 ( V_40 ) ;
unsigned long V_46 ;
int V_8 = 0 ;
...
static int F_65 ( struct V_39 * V_40 , struct V_41 * V_42 , struct V_156 * V_202 , char * V_45 )
{
int V_8 = 0 ;
struct V_22 * V_23 = F_14 ( V_40 ) ;
unsigned long V_46 ;
...
static int F_67 ( struct V_39 * V_40 , struct V_41 * V_42 , struct V_156 * V_199 , char * V_45 )
{
struct V_22 * V_23 = F_14 ( V_40 ) ;
unsigned long V_46 ;
int V_8 = 0 ;
...
V_69 = F_26 ( & ( V_23 -> V_29 ) , ( V_62 ) & ( V_23 -> V_60 ) ) ;
if( V_69 == V_63 ) {
V_177 = ( F_27 ( V_23 -> V_60 . V_17 . T_2 [ 0 ] ) & 0x100 ) ? 1 : 0 ;
F_45 ( L_54 , V_177 ) ;
} else {
F_44 ( V_13 , L_55 ) ;
F_4 ( V_13 ) ;
...
if( V_69 == V_63 ) {
#ifdef F_38
V_207 = F_27 ( V_23 -> V_60 . V_17 . T_2 [ 0 ] ) ;
if( V_207 & 0x0001 ) {
V_207 = 1 ;
}
...
#else
V_207 = ( T_6 ) F_69 ( V_23 -> V_60 . V_17 . V_77 [ 0 ] ) ;
#endif
...
static int F_70 ( struct V_39 * V_40 , struct V_41 * V_42 , struct V_65 * V_66 , char * V_45 )
{
struct V_22 * V_23 = F_14 ( V_40 ) ;
unsigned long V_46 ;
int V_8 = 0 ;
...
V_23 -> V_60 . V_17 . T_2 [ 0 ] = F_36 ( 0x3FFF ) ;
V_23 -> V_60 . V_17 . T_2 [ 1 ] = F_36 ( 0xFFFF ) ;
V_23 -> V_60 . V_17 . T_2 [ 2 ] = F_36 ( 0xFFFF ) ;
V_23 -> V_60 . V_17 . T_2 [ 3 ] = F_36 ( 0x0007 ) ;
#else
V_23 -> V_60 . V_14 = 2 ;
V_23 -> V_60 . V_15 = V_210 ;
V_23 -> V_60 . V_17 . T_2 [ 0 ] = F_36 ( 0x7FFF ) ;
#endif
V_69 = F_39 ( & ( V_23 -> V_29 ) , ( V_62 ) & ( V_23 -> V_60 ) ) ;
F_10 ( V_13 , L_59 , V_69 ) ;
F_19 ( V_23 , & V_46 ) ;
F_16 ( V_23 , & V_46 ) ;
if( V_69 != V_63 ) {
...
V_23 -> V_60 . V_15 = V_146 ;
V_23 -> V_60 . V_17 . T_2 [ 0 ] = F_36 ( 0 ) ;
V_23 -> V_60 . V_17 . T_2 [ 1 ] = F_36 ( 0 ) ;
V_69 = F_39 ( & ( V_23 -> V_29 ) , ( V_62 ) & ( V_23 -> V_60 ) ) ;
F_19 ( V_23 , & V_46 ) ;
F_16 ( V_23 , & V_46 ) ;
F_10 ( V_13 , L_61 , V_69 ) ;
V_69 = F_40 ( & ( V_23 -> V_29 ) , V_148 ) ;
if( V_69 == V_63 ) {
F_10 ( V_13 , L_30 ) ;
} else {
F_10 ( V_13 , L_62 ) ;
...
memset ( & V_214 , 0 , sizeof( V_214 ) ) ;
V_214 . V_221 = V_227 ;
V_214 . V_17 . V_85 . V_88 = F_31 ( V_215 -> signal ) ;
V_214 . V_17 . V_85 . V_90 = F_31 ( V_215 -> V_228 ) ;
...
V_211 = F_73 ( V_42 , V_211 , V_212 , & V_214 , NULL ) ;
memset ( & V_214 , 0 , sizeof( V_214 ) ) ;
V_214 . V_221 = V_237 ;
V_214 . V_14 = V_238 ;
V_214 . V_17 . V_52 . V_58 = F_74 ( V_215 ) ;
...
V_214 . V_221 = V_239 ;
sprintf ( V_216 , L_65 , V_215 -> V_240 ) ;
V_214 . V_17 . V_66 . V_73 = strlen ( V_216 ) ;
V_211 = F_73 ( V_42 , V_211 , V_212 , & V_214 , V_216 ) ;
V_217 = NULL ;
V_218 = 0 ;
V_217 = F_75 ( V_215 , & V_218 ) ;
if( V_217 != NULL ) {
memset ( & V_214 , 0 , sizeof( V_214 ) ) ;
V_214 . V_221 = V_241 ;
...
V_8 = F_39 ( & V_23 -> V_29 , ( V_62 ) & V_1 ) ;
break;
case V_252 :
V_23 -> V_253 = ! V_244 ;
if ( V_23 -> V_253 )
F_77 ( & ( V_23 -> V_29 ) , V_254 | V_255 ) ;
else
F_77 ( & ( V_23 -> V_29 ) , V_256 | V_255 ) ;
V_8 = 0 ;
break;
case V_245 :
if ( V_244 == V_257 )
...
V_8 = F_6 ( V_23 , V_2 , V_273 -> V_6 , V_273 -> V_7 ,
V_24 , V_4 ) ;
break;
case V_280 :
F_10 ( V_13 , L_76 , V_2 ) ;
...
struct V_281 * F_32 ( struct V_39 * V_40 )
{
struct V_281 * V_282 ;
struct V_22 * V_23 = F_14 ( V_40 ) ;
F_15 ( L_79 ) ;
F_2 ( V_13 ) ;
F_82 ( V_13 , L_80 , L_81 , V_40 -> V_50 , V_40 ) ;
V_282 = NULL ;
V_282 = & ( V_23 -> V_113 ) ;
...
V_282 -> V_85 . V_85 = ( V_86 ) F_27 ( V_284 -> V_287 ) ;
V_282 -> V_85 . V_88 = ( V_86 ) F_31 ( F_27 ( V_284 -> V_288 ) ) ;
V_282 -> V_85 . V_90 = ( V_86 ) F_31 ( F_27 ( V_284 -> V_289 ) ) ;
...
struct V_281 * F_84 ( struct V_39 * V_40 )
{
unsigned long V_46 ;
struct V_22 * V_23 = F_14 ( V_40 ) ;
...
inline void F_86 ( struct V_39 * V_40 , V_86 * V_305 )
{
struct V_140 V_113 ;
int V_69 ;
V_86 V_306 [ 2 ] ;
...
V_307 [ 0 ] . V_312 = 0 ;
V_69 = F_87 ( & ( V_23 -> V_29 ) , & V_307 [ 0 ] , 0 ) ;
if( V_69 == V_63 ) {
V_113 . V_88 = ( V_86 ) F_31 ( V_306 [ 1 ] ) ;
V_113 . V_90 = ( V_86 ) F_31 ( V_306 [ 0 ] ) ;
V_113 . V_85 = V_113 . V_88 > V_113 . V_90 ? V_113 . V_88 - V_113 . V_90 : 0 ;
V_113 . V_229 = ( V_290 |
V_291 |
V_292 |
V_230 ) ;
F_88 ( V_40 , V_305 , & V_113 ) ;
}
}
void F_24 ( struct V_39 * V_40 )
{
union V_43 V_313 ;
struct V_22 * V_23 = F_14 ( V_40 ) ;
...
V_313 . V_166 . V_46 = 1 ;
F_89 ( V_40 , V_318 , & V_313 , V_23 -> V_164 ) ;
return;
}
void F_53 ( struct V_39 * V_40 )
{
union V_43 V_313 ;
struct V_22 * V_23 = F_14 ( V_40 ) ;
int V_177 = 0 ;
...
F_89 ( V_40 , V_119 , & V_313 , ( char * ) & V_324 ) ;
return;
}
