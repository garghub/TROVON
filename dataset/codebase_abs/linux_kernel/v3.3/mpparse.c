...
{
F_41 ( V_111 -> V_108 , F_32 ( V_111 -> V_108 ) ) ;
}
...
if ( ! F_16 ( V_57 , V_58 , V_19 ) )
return 0 ;
F_4 ( V_16 L_50 , ( V_124 ) F_45 ( V_111 ) ) ;
F_4 ( V_16 L_51 , V_111 -> V_108 ) ;
...
V_57 -> V_134 = 0 ;
V_140 = F_1 ( ( unsigned char * ) V_57 , V_57 -> V_62 ) ;
V_57 -> V_134 = 0xff ;
...
V_111 -> V_108 = V_131 ;
V_139 = F_43 ( V_131 ) ;
memcpy ( V_139 , V_57 , V_57 -> V_62 ) ;
V_57 = V_139 ;
if ( V_131 - V_111 -> V_108 ) {
struct V_110 * V_142 ;
F_4 ( V_16 L_55 , 0x400 - 16 ) ;
V_142 = F_43 ( 0x400 - 16 ) ;
memcpy ( V_142 , V_111 , 16 ) ;
V_111 = V_142 ;
V_111 -> V_108 = V_131 ;
}
V_111 -> V_134 = 0 ;
V_111 -> V_134 -= F_1 ( ( unsigned char * ) V_111 , 16 ) ;
F_4 ( V_16 L_56 , V_111 -> V_108 ) ;
}
