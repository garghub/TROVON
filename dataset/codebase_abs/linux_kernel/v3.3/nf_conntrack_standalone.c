...
V_90 = F_62 ( V_96 , sizeof( V_96 ) ,
V_97 ) ;
if ( ! V_90 )
goto V_98;
V_90 [ 1 ] . V_99 = & V_11 -> V_17 . V_61 ;
V_90 [ 2 ] . V_99 = & V_11 -> V_17 . V_18 ;
V_90 [ 3 ] . V_99 = & V_11 -> V_17 . V_100 ;
V_90 [ 4 ] . V_99 = & V_11 -> V_17 . V_101 ;
V_11 -> V_17 . V_102 = F_63 ( V_11 ,
V_103 , V_90 ) ;
if ( ! V_11 -> V_17 . V_102 )
goto V_104;
return 0 ;
...
if ( F_60 ( V_11 , & V_91 ) )
F_65 ( V_92 ) ;
V_90 = V_11 -> V_17 . V_102 -> V_106 ;
F_68 ( V_11 -> V_17 . V_102 ) ;
F_64 ( V_90 ) ;
}
static int F_59 ( struct V_11 * V_11 )
{
...
static void F_72 ( struct V_11 * V_11 )
{
F_67 ( V_11 ) ;
F_57 ( V_11 ) ;
F_71 ( V_11 ) ;
