...
if ( ! V_82 && V_68 -> V_23 . V_94 )
V_82 = F_74 ( F_25 ( V_3 ) , V_68 -> V_23 . V_94 ) ;
if ( V_82 ) {
V_3 -> V_114 = V_82 -> V_114 + sizeof( struct V_47 ) ;
V_3 -> V_88 = V_82 -> V_88 - sizeof( struct V_47 ) ;
}
V_3 -> V_115 = V_68 -> V_23 . V_94 ;
}
static int
...
goto V_128;
V_50 = - V_129 ;
if ( V_119 . V_24 . V_110 != 4 || V_119 . V_24 . V_72 != V_93 ||
...
if ( V_19 -> V_23 . V_94 != V_119 . V_94 ) {
V_19 -> V_23 . V_94 = V_119 . V_94 ;
F_73 ( V_3 ) ;
F_80 ( V_3 ) ;
}
}
