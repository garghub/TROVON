...
void T_1
F_12 ( struct V_23 * V_11 )
{
int V_1 , V_12 ;
int V_13 ;
if ( F_5 () )
return;
if ( V_11 -> V_14 . V_15 != sizeof( struct V_23 ) ) {
F_3 () ;
return;
}
if ( ( V_11 -> V_16 & V_17 ) == 0 )
...
if ( F_13 () >= V_27 )
V_13 = ( V_11 -> V_13 << 8 ) | V_11 -> V_28 ;
else
V_13 = V_11 -> V_13 ;
if ( V_13 >= V_21 ) {
F_4 ( V_20 L_6 , V_1 , V_13 , V_12 ) ;
return;
}
F_10 ( V_13 , V_12 ) ;
F_11 ( V_12 , V_22 ) ;
...
if ( F_5 () )
return;
if ( V_30 -> V_14 . V_15 != sizeof( struct V_29 ) ) {
F_3 () ;
return;
}
if ( ( V_30 -> V_16 & V_33 ) == 0 )
return;
if ( ( V_30 -> V_16 & V_34 ) && ! F_14 () )
return;
V_31 = V_30 -> V_35 ;
V_32 = V_31 + V_30 -> V_15 ;
V_1 = V_30 -> V_18 ;
...
if ( F_16 ( V_12 , V_31 , V_32 ) < 0 ) {
F_3 () ;
return;
}
F_4 ( V_20 L_9 , V_12 , V_1 ,
V_31 , V_32 ) ;
}
void T_1 F_17 ( void ) {}
int T_1 F_18 ( void )
