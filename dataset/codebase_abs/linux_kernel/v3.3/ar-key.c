...
static int F_25 ( struct V_5 * V_5 , const void * V_33 , T_2 V_17 )
{
...
T_3 V_100 ;
int V_13 ;
F_4 ( L_30 , F_26 ( V_5 ) , V_17 ) ;
if ( ! V_33 && V_17 == 0 )
return 0 ;
if ( V_17 > 7 * 4 ) {
V_13 = F_24 ( V_5 , V_33 , V_17 ) ;
if ( V_13 != - V_96 )
return V_13 ;
}
V_13 = - V_4 ;
...
static int F_27 ( struct V_5 * V_5 , const void * V_33 ,
T_2 V_17 )
{
struct V_103 * V_104 ;
F_4 ( L_30 , F_26 ( V_5 ) , V_17 ) ;
...
V_104 = F_28 ( L_32 , 0 , V_105 ) ;
if ( F_29 ( V_104 ) ) {
F_10 ( L_33 , F_30 ( V_104 ) ) ;
return F_30 ( V_104 ) ;
}
if ( F_31 ( V_104 , V_33 , 8 ) < 0 )
F_32 () ;
V_5 -> V_32 . V_33 = V_104 ;
F_10 ( L_10 ) ;
return 0 ;
...
static void F_37 ( const struct V_5 * V_5 , struct V_107 * V_108 )
{
F_38 ( V_108 , V_5 -> V_109 ) ;
}
int F_39 ( struct V_110 * V_111 , char T_6 * V_112 , int V_113 )
{
struct V_5 * V_5 ;
char * V_109 ;
F_4 ( L_35 ) ;
...
if ( ! V_109 )
return - V_19 ;
if ( F_40 ( V_109 , V_112 , V_113 ) ) {
F_9 ( V_109 ) ;
return - V_115 ;
}
V_109 [ V_113 ] = 0 ;
V_5 = F_41 ( & V_116 , V_109 , NULL ) ;
if ( F_29 ( V_5 ) ) {
F_9 ( V_109 ) ;
F_10 ( L_33 , F_30 ( V_5 ) ) ;
return F_30 ( V_5 ) ;
...
int F_42 ( struct V_110 * V_111 , char T_6 * V_112 ,
int V_113 )
{
struct V_5 * V_5 ;
char * V_109 ;
...
int F_43 ( struct V_120 * V_121 ,
const void * V_28 ,
T_7 V_26 ,
T_3 V_24 )
{
const struct V_122 * V_122 = F_44 () ;
struct V_5 * V_5 ;
int V_13 ;
struct {
T_3 V_100 ;
...
F_4 ( L_35 ) ;
V_5 = F_45 ( & V_116 , L_37 , 0 , 0 , V_122 , 0 ,
V_123 ) ;
if ( F_29 ( V_5 ) ) {
F_10 ( L_38 , F_30 ( V_5 ) ) ;
return - V_19 ;
...
struct V_5 * F_49 ( const char * V_124 )
{
const struct V_122 * V_122 = F_44 () ;
struct V_5 * V_5 ;
int V_13 ;
V_5 = F_45 ( & V_116 , V_124 , 0 , 0 , V_122 ,
V_125 , V_123 ) ;
if ( F_29 ( V_5 ) )
return V_5 ;
...
case V_21 :
V_131 += 8 * 4 ;
V_131 += F_52 ( V_9 -> V_16 -> V_22 ) ;
break;
case V_73 :
V_36 = & V_9 -> V_74 -> V_45 ;
V_131 += 4 + V_36 -> V_39 * 4 ;
for ( V_37 = 0 ; V_37 < V_36 -> V_39 ; V_37 ++ )
V_131 += F_52 ( strlen ( V_36 -> V_38 [ V_37 ] ) ) ;
V_131 += 4 + F_52 ( strlen ( V_36 -> V_40 ) ) ;
V_36 = & V_9 -> V_74 -> V_46 ;
V_131 += 4 + V_36 -> V_39 * 4 ;
for ( V_37 = 0 ; V_37 < V_36 -> V_39 ; V_37 ++ )
V_131 += F_52 ( strlen ( V_36 -> V_38 [ V_37 ] ) ) ;
V_131 += 4 + F_52 ( strlen ( V_36 -> V_40 ) ) ;
V_131 += 8 + F_52 ( V_9 -> V_74 -> V_47 . V_63 ) ;
V_131 += 4 * 8 + 2 * 4 ;
V_131 += 4 + V_9 -> V_74 -> V_49 * 8 ;
for ( V_37 = 0 ; V_37 < V_9 -> V_74 -> V_49 ; V_37 ++ )
V_131 += F_52 ( V_9 -> V_74 -> V_48 [ V_37 ] . V_63 ) ;
V_131 += 4 + F_52 ( V_9 -> V_74 -> V_22 ) ;
V_131 += 4 + F_52 ( V_9 -> V_74 -> V_85 ) ;
V_131 += 4 + V_9 -> V_74 -> V_51 * 8 ;
for ( V_37 = 0 ; V_37 < V_9 -> V_74 -> V_51 ; V_37 ++ )
V_131 += F_52 ( V_9 -> V_74 -> V_50 [ V_37 ] . V_63 ) ;
break;
default:
F_32 () ;
continue;
...
F_23 ( ( unsigned long ) V_6 - ( unsigned long ) V_129 , == ,
V_131 ) ;
}
#undef F_56
#undef F_54
