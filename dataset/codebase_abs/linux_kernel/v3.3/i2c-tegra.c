...
static int T_5 F_47 ( struct V_112 * V_113 )
{
struct V_1 * V_2 ;
...
if ( V_113 -> V_19 . V_136 )
V_2 -> V_6 = F_58 ( V_113 -> V_19 . V_136 ,
L_14 ) ;
else if ( V_113 -> V_135 == 3 )
V_2 -> V_6 = 1 ;
F_59 ( & V_2 -> V_67 ) ;
F_60 ( V_113 , V_2 ) ;
V_81 = F_23 ( V_2 ) ;
if ( V_81 ) {
F_41 ( & V_113 -> V_19 , L_15 ) ;
goto V_137;
}
V_81 = F_61 ( V_2 -> V_56 , F_31 , 0 , V_113 -> V_124 , V_2 ) ;
if ( V_81 ) {
F_41 ( & V_113 -> V_19 , L_16 , V_2 -> V_56 ) ;
goto V_137;
}
F_24 ( V_2 -> V_120 ) ;
F_62 ( & V_2 -> V_132 , V_2 ) ;
...
F_68 ( V_41 ) ;
V_128:
F_69 ( V_119 -> V_123 , F_50 ( V_119 ) ) ;
V_127:
F_70 ( V_5 ) ;
return V_81 ;
}
static int T_7 F_71 ( struct V_112 * V_113 )
{
...
F_68 ( V_2 -> V_120 ) ;
F_68 ( V_2 -> V_41 ) ;
F_69 ( V_2 -> V_119 -> V_123 ,
F_50 ( V_2 -> V_119 ) ) ;
F_70 ( V_2 -> V_5 ) ;
F_67 ( V_2 ) ;
return 0 ;
}
static int F_74 ( struct V_112 * V_113 , T_8 V_145 )
{
struct V_1 * V_2 = F_72 ( V_113 ) ;
F_75 ( & V_2 -> V_132 ) ;
V_2 -> V_108 = true ;
...
static int F_77 ( struct V_112 * V_113 )
{
struct V_1 * V_2 = F_72 ( V_113 ) ;
int V_81 ;
F_75 ( & V_2 -> V_132 ) ;
