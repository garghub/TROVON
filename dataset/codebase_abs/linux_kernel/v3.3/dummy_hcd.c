...
if ( V_91 && V_13 -> V_54 ) {
if ( V_109 . V_110 )
V_13 -> V_18 . V_22 = V_13 -> V_54 -> V_111 ;
else if ( V_109 . V_112 )
V_13 -> V_18 . V_22 = F_51 ( V_113 , V_71 ,
V_13 -> V_54 -> V_111 ) ;
else
V_13 -> V_18 . V_22 = V_72 ;
F_49 ( V_13 ) ;
if ( V_13 -> V_18 . V_22 < V_13 -> V_54 -> V_111 )
F_24 ( F_7 ( V_13 ) , L_13
L_14 ,
F_52 ( V_13 -> V_54 -> V_111 ) ) ;
}
V_33 = F_9 ( V_93 ) ;
F_26 ( & V_13 -> V_30 , V_78 ) ;
V_13 -> V_37 = ( V_91 != 0 ) ;
...
static T_3
F_54 ( struct V_14 * V_19 , struct V_114 * V_115 , char * V_87 )
{
struct V_17 * V_13 = F_10 ( V_19 ) ;
if ( ! V_13 -> V_54 || ! V_13 -> V_54 -> V_116 )
return 0 ;
return F_55 ( V_87 , V_117 , L_15 , V_13 -> V_54 -> V_116 ) ;
}
...
static int F_57 ( struct V_21 * V_118 ,
struct V_119 * V_54 )
{
struct V_9 * V_33 = F_9 ( V_118 ) ;
struct V_17 * V_13 = V_33 -> V_13 ;
...
static void
F_58 ( struct V_14 * V_19 )
{
return;
}
static void F_59 ( struct V_17 * V_13 )
{
int V_106 ;
...
F_62 ( & V_13 -> V_18 . V_19 , L_18 ) ;
V_13 -> V_18 . V_19 . V_20 = & V_131 -> V_19 ;
V_13 -> V_18 . V_19 . V_136 = F_58 ;
V_133 = F_63 ( & V_13 -> V_18 . V_19 ) ;
if ( V_133 < 0 ) {
F_64 ( & V_13 -> V_18 . V_19 ) ;
return V_133 ;
}
F_59 ( V_13 ) ;
V_133 = F_65 ( & V_131 -> V_19 , & V_13 -> V_18 ) ;
if ( V_133 < 0 )
goto V_137;
V_133 = F_66 ( & V_13 -> V_18 . V_19 , & V_138 ) ;
if ( V_133 < 0 )
goto V_139;
F_67 ( V_131 , V_13 ) ;
return V_133 ;
...
static int F_70 ( struct V_130 * V_131 )
{
struct V_17 * V_13 = F_71 ( V_131 ) ;
F_68 ( & V_13 -> V_18 ) ;
F_67 ( V_131 , NULL ) ;
F_72 ( & V_13 -> V_18 . V_19 , & V_138 ) ;
F_69 ( & V_13 -> V_18 . V_19 ) ;
return 0 ;
}
...
static int F_76 ( struct V_130 * V_131 , T_4 V_140 )
{
struct V_17 * V_13 = F_71 ( V_131 ) ;
struct V_9 * V_33 = F_9 ( & V_13 -> V_18 ) ;
F_24 ( & V_131 -> V_19 , L_15 , V_141 ) ;
F_73 ( V_13 , V_33 , 1 ) ;
F_53 ( F_5 ( V_33 ) ) ;
return 0 ;
}
...
return - V_67 ;
V_143 = F_79 ( sizeof *V_143 , V_79 ) ;
if ( ! V_143 )
return - V_146 ;
V_143 -> V_142 = V_142 ;
V_33 = F_4 ( V_11 ) ;
F_26 ( & V_33 -> V_13 -> V_30 , V_78 ) ;
V_133 = F_80 ( V_11 , V_142 ) ;
if ( V_133 ) {
F_33 ( V_143 ) ;
goto V_70;
}
...
F_81 ( V_33 -> V_147 ) ;
} else if ( F_82 ( V_33 -> V_147 != V_142 -> V_19 ) )
F_83 ( F_6 ( V_33 ) , L_19 ) ;
F_36 ( & V_143 -> V_148 , & V_33 -> V_148 ) ;
V_142 -> V_149 = V_143 ;
if ( F_84 ( V_142 -> V_150 ) == V_151 )
V_142 -> V_152 = 1 ;
if ( ! F_85 ( & V_33 -> V_153 ) )
...
static int F_86 ( struct V_10 * V_11 , struct V_142 * V_142 , int V_28 )
{
struct V_9 * V_33 ;
unsigned long V_78 ;
int V_133 ;
V_33 = F_4 ( V_11 ) ;
F_26 ( & V_33 -> V_13 -> V_30 , V_78 ) ;
V_133 = F_87 ( V_11 , V_142 , V_28 ) ;
if ( ! V_133 && V_33 -> V_45 != V_154 &&
! F_12 ( & V_33 -> V_148 ) )
...
static int
F_88 ( struct V_17 * V_13 , struct V_142 * V_142 , struct V_1 * V_4 , int V_155 ,
int * V_28 )
{
struct V_5 * V_8 ;
V_156:
...
V_159 = F_89 ( V_157 , V_158 ) ;
V_161 = F_90 ( V_142 -> V_150 ) ;
if ( F_82 ( V_159 == 0 ) )
V_160 = 1 ;
else {
char * V_164 , * V_165 ;
...
break;
V_159 = F_89 ( V_159 , ( unsigned ) V_155 ) ;
if ( V_159 == 0 )
break;
...
static int F_91 ( struct V_17 * V_13 , struct V_1 * V_4 )
{
...
static struct V_1 * F_92 ( struct V_17 * V_13 , V_113 V_32 )
{
int V_106 ;
if ( ! F_93 ( ( V_13 -> V_18 . V_22 == V_23 ?
V_13 -> V_24 : V_13 -> V_25 ) ) )
return NULL ;
if ( ( V_32 & ~ V_83 ) == 0 )
return & V_13 -> V_4 [ 0 ] ;
...
static int F_94 ( struct V_9 * V_33 , struct V_142 * V_142 ,
struct V_171 * V_172 ,
int * V_28 )
{
struct V_1 * V_173 ;
...
unsigned V_175 ;
unsigned V_176 ;
V_175 = F_95 ( V_172 -> V_177 ) ;
V_176 = F_95 ( V_172 -> V_178 ) ;
switch ( V_172 -> V_179 ) {
case V_180 :
...
static void F_96 ( unsigned long V_202 )
{
...
if ( ! V_122 [ V_106 ] )
break;
V_13 -> V_4 [ V_106 ] . V_125 = 0 ;
}
V_205:
F_97 (urbp, tmp, &dum_hcd->urbp_list, urbp_list) {
struct V_142 * V_142 ;
struct V_5 * V_8 ;
V_113 V_32 ;
struct V_1 * V_4 = NULL ;
...
continue;
type = F_84 ( V_142 -> V_150 ) ;
if ( V_203 <= 0 && type == V_208 )
continue;
V_32 = F_98 ( V_142 -> V_150 ) ;
if ( F_90 ( V_142 -> V_150 ) )
V_32 |= V_83 ;
V_4 = F_92 ( V_13 , V_32 ) ;
if ( ! V_4 ) {
...
case V_213 :
V_155 = V_61 ( V_155 , F_91 ( V_13 , V_4 ) ) ;
V_28 = - V_214 ;
break;
case V_215 :
V_155 = V_61 ( V_155 , F_91 ( V_13 , V_4 ) ) ;
...
V_212:
V_4 -> V_127 = V_103 ;
V_203 = F_88 ( V_13 , V_142 , V_4 , V_155 , & V_28 ) ;
break;
}
if ( V_28 == - V_80 )
continue;
...
F_100 ( F_5 ( V_33 ) , V_142 ) ;
F_15 ( & V_13 -> V_30 ) ;
F_101 ( F_5 ( V_33 ) , V_142 , V_28 ) ;
F_16 ( & V_13 -> V_30 ) ;
goto V_205;
}
if ( F_12 ( & V_33 -> V_148 ) ) {
...
static int F_103 ( struct V_10 * V_11 , char * V_87 )
{
struct V_9 * V_33 ;
unsigned long V_78 ;
int V_62 = 0 ;
...
if ( ! F_104 ( V_11 ) )
goto V_70;
if ( V_33 -> V_52 && F_105 ( V_103 , V_33 -> V_102 ) ) {
V_33 -> V_35 |= ( V_216 << 16 ) ;
V_33 -> V_35 &= ~ V_51 ;
F_20 ( V_33 ) ;
}
...
static inline void
F_107 ( struct V_218 * V_60 )
{
memset ( V_60 , 0 , sizeof *V_60 ) ;
V_60 -> V_65 = 0x2a ;
V_60 -> V_219 = 12 ;
V_60 -> V_220 = F_108 ( 0x0001 ) ;
V_60 -> V_221 = 1 ;
V_60 -> V_222 . V_223 . V_224 = 0x04 ;
V_60 -> V_222 . V_223 . V_225 = 0xffff ;
}
static inline void
F_109 ( struct V_218 * V_60 )
{
memset ( V_60 , 0 , sizeof *V_60 ) ;
V_60 -> V_65 = 0x29 ;
V_60 -> V_219 = 9 ;
...
if ( V_11 -> V_22 == V_34 )
F_107 ( (struct V_218 * ) V_87 ) ;
else
F_109 ( (struct V_218 * ) V_87 ) ;
break;
case V_237 :
* ( V_238 * ) V_87 = F_111 ( 0 ) ;
break;
...
F_20 ( V_33 ) ;
( ( V_241 * ) V_87 ) [ 0 ] = F_108 ( V_33 -> V_35 ) ;
( ( V_241 * ) V_87 ) [ 1 ] = F_108 ( V_33 -> V_35 >> 16 ) ;
break;
case V_242 :
V_62 = - V_210 ;
break;
...
F_24 ( & V_11 -> V_15 . V_251 -> V_19 , L_15 , V_141 ) ;
F_74 ( & V_33 -> V_13 -> V_30 ) ;
V_33 -> V_45 = V_46 ;
F_20 ( V_33 ) ;
V_11 -> V_140 = V_252 ;
...
static inline T_3
F_114 ( char * V_87 , T_6 V_254 , struct V_142 * V_142 )
{
int V_4 = F_98 ( V_142 -> V_150 ) ;
...
ep, ep ? (usb_pipein (urb->pipe) ? L_5 : L_6) : L_48 ,
({ char *s; \
...
static T_3
F_115 ( struct V_14 * V_19 , struct V_114 * V_115 , char * V_87 )
{
struct V_10 * V_11 = F_116 ( V_19 ) ;
struct V_9 * V_33 = F_4 ( V_11 ) ;
struct V_143 * V_143 ;
T_6 V_254 = 0 ;
unsigned long V_78 ;
...
T_6 V_255 ;
V_255 = F_114 ( V_87 , V_117 - V_254 , V_143 -> V_142 ) ;
V_87 += V_255 ;
V_254 += V_255 ;
}
F_27 ( & V_33 -> V_13 -> V_30 , V_78 ) ;
...
static int F_117 ( struct V_9 * V_33 )
{
F_118 ( & V_33 -> V_153 ) ;
V_33 -> V_153 . V_116 = F_96 ;
...
struct V_17 * V_13 ;
V_13 = ( F_4 ( V_11 ) ) -> V_13 ;
F_72 ( F_6 ( F_4 ( V_11 ) ) , & V_261 ) ;
F_123 ( V_13 -> V_54 ) ;
F_124 ( F_6 ( F_4 ( V_11 ) ) , L_49 ) ;
}
...
int F_128 ( struct V_10 * V_11 , struct V_263 * V_147 ,
struct V_264 * * V_265 , unsigned int V_266 ,
T_1 V_79 )
{
if ( V_11 -> V_22 != V_34 )
...
static int F_129 ( struct V_130 * V_131 )
{
struct V_10 * V_25 ;
struct V_10 * V_24 ;
int V_62 ;
F_124 ( & V_131 -> V_19 , L_51 V_268 L_52 , V_269 ) ;
if ( ! V_109 . V_110 )
V_9 . V_78 = V_262 ;
V_25 = F_130 ( & V_9 , & V_131 -> V_19 , F_131 ( & V_131 -> V_19 ) ) ;
if ( ! V_25 )
return - V_146 ;
V_25 -> V_270 = 1 ;
V_62 = F_132 ( V_25 , 0 , 0 ) ;
...
if ( V_109 . V_110 ) {
V_24 = F_134 ( & V_9 , & V_131 -> V_19 ,
F_131 ( & V_131 -> V_19 ) , V_25 ) ;
if ( ! V_24 ) {
V_62 = - V_146 ;
goto V_271;
}
...
static int F_135 ( struct V_130 * V_131 )
{
struct V_17 * V_13 ;
V_13 = ( F_4 ( F_71 ( V_131 ) ) ) -> V_13 ;
if ( V_13 -> V_24 ) {
F_136 ( F_5 ( V_13 -> V_24 ) ) ;
F_133 ( F_5 ( V_13 -> V_24 ) ) ;
}
...
static int F_137 ( struct V_130 * V_131 , T_4 V_140 )
{
struct V_10 * V_11 ;
struct V_9 * V_33 ;
int V_133 = 0 ;
...
V_33 = F_4 ( V_11 ) ;
if ( V_33 -> V_45 == V_154 ) {
F_138 ( & V_131 -> V_19 , L_53 ) ;
V_133 = - V_273 ;
} else
F_139 ( V_274 , & V_11 -> V_78 ) ;
return V_133 ;
}
static int F_140 ( struct V_130 * V_131 )
{
struct V_10 * V_11 ;
F_24 ( & V_131 -> V_19 , L_15 , V_141 ) ;
V_11 = F_71 ( V_131 ) ;
F_141 ( V_274 , & V_11 -> V_78 ) ;
F_53 ( V_11 ) ;
return 0 ;
}
