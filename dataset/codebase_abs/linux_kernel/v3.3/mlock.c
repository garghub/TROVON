...
static int F_43 ( unsigned long V_15 , T_3 V_63 , int V_70 )
{
struct V_18 * V_19 = V_38 -> V_19 ;
unsigned long V_16 , V_65 , V_71 ;
...
F_5 ( V_63 != F_41 ( V_63 ) ) ;
V_16 = V_15 + V_63 ;
for ( V_65 = V_15 ; V_65 < V_16 ; V_65 = V_71 ) {
if ( ! V_72 ) {
V_72 = 1 ;
F_44 ( & V_19 -> V_28 ) ;
V_14 = F_42 ( V_19 , V_65 ) ;
...
break;
V_71 = F_45 ( V_16 , V_14 -> V_27 ) ;
if ( V_14 -> V_31 & ( V_44 | V_45 ) )
continue;
if ( V_65 < V_14 -> V_26 )
V_65 = V_14 -> V_26 ;
V_9 = F_20 ( V_14 , V_65 , V_71 , & V_72 ) ;
if ( V_9 < 0 ) {
if ( V_70 ) {
V_9 = 0 ;
continue;
...
if ( V_73 == V_75 )
goto V_56;
for ( V_14 = V_38 -> V_19 -> V_76 ; V_14 ; V_14 = V_51 -> V_69 ) {
T_1 V_52 ;
V_52 = V_14 -> V_31 | V_43 ;
if ( ! ( V_73 & V_77 ) )
V_52 &= ~ V_43 ;
...
int F_48 ( T_3 V_78 , struct V_79 * V_80 )
{
unsigned long V_81 , V_72 ;
int V_82 = 0 ;
V_72 = ( V_78 + V_23 - 1 ) >> V_58 ;
V_81 = F_3 ( V_2 ) ;
if ( V_81 == V_83 )
V_82 = 1 ;
V_81 >>= V_58 ;
...
void F_52 ( T_3 V_78 , struct V_79 * V_80 )
{
F_49 ( & V_84 ) ;
V_80 -> V_85 -= ( V_78 + V_23 - 1 ) >> V_58 ;
F_51 ( & V_84 ) ;
F_53 ( V_80 ) ;
}
