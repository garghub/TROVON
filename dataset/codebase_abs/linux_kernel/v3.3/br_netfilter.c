...
static unsigned int F_86 ( unsigned int V_97 , struct V_1 * V_2 ,
const struct V_28 * V_98 ,
const struct V_28 * V_99 ,
int (* F_76)( struct V_1 * ) )
{
struct V_17 * V_18 = F_87 ( V_2 ) ;
...
V_98 = * ( (struct V_28 * * ) ( V_2 -> V_116 ) ) ;
}
F_23 ( V_2 ) ;
F_54 ( V_68 , V_117 , V_2 , V_98 ,
V_2 -> V_14 , V_118 , 1 ) ;
return 0 ;
}
static unsigned int F_92 ( unsigned int V_97 , struct V_1 * V_2 ,
const struct V_28 * V_98 ,
const struct V_28 * V_99 ,
int (* F_76)( struct V_1 * ) )
{
...
V_2 -> V_3 = F_3 ( V_104 ) ;
F_77 ( V_120 , V_125 , V_2 , F_16 ( V_98 ) , V_119 ,
F_89 ) ;
return V_107 ;
}
static unsigned int F_93 ( unsigned int V_97 , struct V_1 * V_2 ,
const struct V_28 * V_98 ,
const struct V_28 * V_99 ,
int (* F_76)( struct V_1 * ) )
{
struct V_29 * V_108 ;
struct V_15 * V_16 ;
struct V_28 * * V_126 = (struct V_28 * * ) ( V_2 -> V_116 ) ;
V_108 = F_15 ( V_99 ) ;
if ( V_108 == NULL )
return V_111 ;
V_16 = V_108 -> V_16 ;
...
* V_126 = (struct V_28 * ) V_98 ;
F_77 ( V_130 , V_131 , V_2 , (struct V_28 * ) V_98 ,
(struct V_28 * ) V_99 , F_89 ) ;
return V_107 ;
}
static int F_95 ( struct V_1 * V_2 )
{
int V_132 ;
if ( V_2 -> V_133 != NULL && V_2 -> V_3 == F_3 ( V_114 ) &&
V_2 -> V_36 + F_96 ( V_2 ) > V_2 -> V_14 -> V_10 &&
! F_97 ( V_2 ) ) {
if ( F_33 ( V_2 ) )
return V_101 ;
V_132 = F_98 ( V_2 , V_134 ) ;
} else
V_132 = V_134 ( V_2 ) ;
return V_132 ;
}
...
static unsigned int F_99 ( unsigned int V_97 , struct V_1 * V_2 ,
const struct V_28 * V_98 ,
const struct V_28 * V_99 ,
int (* F_76)( struct V_1 * ) )
{
struct V_31 * V_32 = V_2 -> V_32 ;
struct V_28 * V_135 = F_16 ( V_2 -> V_14 ) ;
T_4 V_120 ;
if ( ! V_32 || ! ( V_32 -> V_40 & V_123 ) )
return V_111 ;
if ( ! V_135 )
return V_101 ;
if ( F_82 ( V_2 ) || F_83 ( V_2 ) || F_84 ( V_2 ) )
...
V_2 -> V_3 = F_3 ( V_104 ) ;
F_77 ( V_120 , V_136 , V_2 , NULL , V_135 ,
F_95 ) ;
return V_107 ;
}
static unsigned int F_100 ( unsigned int V_97 , struct V_1 * V_2 ,
const struct V_28 * V_98 ,
const struct V_28 * V_99 ,
int (* F_76)( struct V_1 * ) )
{
...
static
int F_101 ( T_5 * V_138 , int V_139 ,
void T_6 * V_140 , T_7 * V_141 , T_8 * V_142 )
{
int V_132 ;
V_132 = F_102 ( V_138 , V_139 , V_140 , V_141 , V_142 ) ;
if ( V_139 && * ( int * ) ( V_138 -> V_39 ) )
* ( int * ) ( V_138 -> V_39 ) = 1 ;
return V_132 ;
}
int T_9 F_103 ( void )
...
if ( V_132 < 0 )
return V_132 ;
V_132 = F_105 ( V_143 , F_106 ( V_143 ) ) ;
if ( V_132 < 0 ) {
F_107 ( & V_27 ) ;
return V_132 ;
}
#ifdef F_108
V_144 = F_109 ( V_145 , V_146 ) ;
if ( V_144 == NULL ) {
F_110 ( V_147
L_1 ) ;
F_111 ( V_143 , F_106 ( V_143 ) ) ;
F_107 ( & V_27 ) ;
return - V_148 ;
}
#endif
