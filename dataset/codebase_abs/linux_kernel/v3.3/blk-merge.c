...
bool F_63 ( struct V_20 * V_21 , struct V_3 * V_3 )
{
if ( ! F_51 ( V_21 ) )
return false ;
...
return false ;
if ( F_64 ( V_3 ) != F_47 ( V_21 ) )
return false ;
if ( V_21 -> V_69 != V_3 -> V_74 -> V_75 || V_21 -> V_59 )
return false ;
if ( F_28 ( V_3 ) != F_38 ( V_21 ) )
return false ;
return true ;
}
int F_65 ( struct V_20 * V_21 , struct V_3 * V_3 )
{
if ( F_52 ( V_21 ) + F_33 ( V_21 ) == V_3 -> V_76 )
return V_77 ;
else if ( F_52 ( V_21 ) - F_34 ( V_3 ) == V_3 -> V_76 )
return V_78 ;
return V_79 ;
}
