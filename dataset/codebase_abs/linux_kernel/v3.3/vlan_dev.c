...
V_39 = F_16 ( V_2 ) ;
if ( F_17 ( V_39 == V_43 || V_39 == V_44 ) ) {
struct V_45 * V_46 ;
V_46 = F_18 ( F_8 ( V_4 ) -> V_45 ) ;
F_19 ( & V_46 -> V_47 ) ;
V_46 -> V_48 ++ ;
V_46 -> V_49 += V_23 ;
F_20 ( & V_46 -> V_47 ) ;
} else {
F_21 ( F_8 ( V_4 ) -> V_45 -> V_50 ) ;
}
return V_39 ;
}
static int F_22 ( struct V_3 * V_4 , int V_51 )
{
...
V_16 = V_56 -> V_17 [ V_54 & 0xF ] ;
V_59 = F_25 ( sizeof( struct V_15 ) , V_63 ) ;
if ( ! V_59 )
return - V_64 ;
V_59 -> V_20 = V_16 ;
V_59 -> V_18 = V_54 ;
...
int F_26 ( const struct V_3 * V_4 , T_3 V_29 , T_3 V_65 )
{
struct F_8 * V_56 = F_8 ( V_4 ) ;
T_3 V_66 = V_56 -> V_29 ;
if ( V_65 & ~ ( V_30 | V_67 |
...
if ( F_27 ( V_4 ) && ( V_56 -> V_29 ^ V_66 ) & V_67 ) {
if ( V_56 -> V_29 & V_67 )
F_28 ( V_4 ) ;
else
F_29 ( V_4 ) ;
...
void F_30 ( const struct V_3 * V_4 , char * V_70 )
{
...
! ( V_56 -> V_29 & V_68 ) )
return - V_73 ;
if ( F_32 ( V_4 -> V_13 , V_38 -> V_13 ) ) {
V_71 = F_33 ( V_38 , V_4 -> V_13 ) ;
if ( V_71 < 0 )
goto V_74;
}
if ( V_4 -> V_29 & V_75 ) {
...
static int F_43 ( struct V_3 * V_4 , void * V_80 )
{
...
if ( ! ( V_4 -> V_29 & V_72 ) )
goto V_74;
if ( F_32 ( V_82 -> V_83 , V_38 -> V_13 ) ) {
V_71 = F_33 ( V_38 , V_82 -> V_83 ) ;
if ( V_71 < 0 )
return V_71 ;
}
if ( F_32 ( V_4 -> V_13 , V_38 -> V_13 ) )
...
static int F_45 ( struct V_3 * V_4 , struct V_85 * V_86 , int V_87 )
{
struct V_3 * V_38 = F_8 ( V_4 ) -> V_38 ;
...
static int F_47 ( struct V_3 * V_4 , struct V_99 * V_100 )
{
struct V_3 * V_38 = F_8 ( V_4 ) -> V_38 ;
const struct V_88 * V_89 = V_38 -> V_41 ;
int V_71 = 0 ;
if ( F_46 ( V_38 ) && V_89 -> V_101 )
...
static int F_49 ( struct V_3 * V_4 , T_1 V_102 )
{
struct V_3 * V_38 = F_8 ( V_4 ) -> V_38 ;
const struct V_88 * V_89 = V_38 -> V_41 ;
int V_23 = 0 ;
...
static int F_52 ( struct V_3 * V_4 , T_4 * V_110 , int type )
{
struct V_3 * V_38 = F_8 ( V_4 ) -> V_38 ;
const struct V_88 * V_89 = V_38 -> V_41 ;
int V_28 = - V_69 ;
...
static int F_53 ( struct V_3 * V_4 , T_1 V_102 ,
struct V_103 * V_104 , unsigned int V_105 )
{
struct V_3 * V_38 = F_8 ( V_4 ) -> V_38 ;
const struct V_88 * V_89 = V_38 -> V_41 ;
...
static void F_54 ( struct V_3 * V_4 , int V_113 )
{
struct V_3 * V_38 = F_8 ( V_4 ) -> V_38 ;
if ( V_4 -> V_29 & V_72 ) {
if ( V_113 & V_75 )
...
if ( V_113 & V_77 )
F_35 ( V_38 , V_4 -> V_29 & V_77 ? 1 : - 1 ) ;
}
}
static void F_55 ( struct V_3 * V_114 )
{
F_56 ( F_8 ( V_114 ) -> V_38 , V_114 ) ;
F_57 ( F_8 ( V_114 ) -> V_38 , V_114 ) ;
}
...
static void F_60 ( struct V_3 * V_4 , int V_120 )
{
F_59 ( & V_4 -> V_121 ,
& V_122 ,
V_120 ) ;
...
F_68 ( V_56 -> V_45 ) ;
V_56 -> V_45 = NULL ;
for ( V_157 = 0 ; V_157 < F_69 ( V_56 -> V_17 ) ; V_157 ++ ) {
...
static T_5 F_71 ( struct V_3 * V_4 ,
T_5 V_139 )
{
struct V_3 * V_38 = F_8 ( V_4 ) -> V_38 ;
T_3 V_158 = V_139 ;
...
static struct V_169 * F_75 ( struct V_3 * V_4 , struct V_169 * V_46 )
{
if ( F_8 ( V_4 ) -> V_45 ) {
struct V_45 * V_80 ;
T_3 V_170 = 0 , V_50 = 0 ;
...
unsigned int V_176 ;
V_80 = F_77 ( F_8 ( V_4 ) -> V_45 , V_157 ) ;
do {
V_176 = F_78 ( & V_80 -> V_47 ) ;
V_171 = V_80 -> V_177 ;
V_172 = V_80 -> V_178 ;
V_173 = V_80 -> V_179 ;
V_174 = V_80 -> V_48 ;
V_175 = V_80 -> V_49 ;
} while ( F_79 ( & V_80 -> V_47 , V_176 ) );
V_46 -> V_177 += V_171 ;
V_46 -> V_178 += V_172 ;
V_46 -> V_180 += V_173 ;
V_46 -> V_48 += V_174 ;
...
static int F_81 ( struct V_3 * V_4 , struct V_181 * V_182 )
{
struct F_8 * V_163 = F_8 ( V_4 ) ;
struct V_3 * V_38 = V_163 -> V_38 ;
struct V_183 * V_183 ;
int V_71 = 0 ;
V_183 = F_82 ( sizeof( * V_183 ) , V_63 ) ;
V_71 = - V_155 ;
if ( ! V_183 )
goto V_74;
V_183 -> V_4 = V_38 ;
F_83 ( V_183 -> V_184 , V_38 -> V_11 , V_93 ) ;
V_71 = F_84 ( V_183 ) ;
if ( V_71 ) {
F_70 ( V_183 ) ;
goto V_74;
