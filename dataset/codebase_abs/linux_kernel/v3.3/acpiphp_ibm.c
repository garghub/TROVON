...
if ( V_38 == 0x80 ) {
F_7 ( L_8 , V_26 ) ;
F_13 ( V_40 -> V_41 , V_40 -> V_35 , V_37 ) ;
F_14 ( V_40 -> V_41 -> V_42 . V_43 ,
F_15 ( & V_40 -> V_41 -> V_44 ) ,
V_40 -> V_35 , V_37 ) ;
} else
V_40 -> V_35 = V_35 ;
...
static T_5 F_18 ( struct V_59 * V_60 , struct V_61 * V_62 ,
struct V_63 * V_64 ,
