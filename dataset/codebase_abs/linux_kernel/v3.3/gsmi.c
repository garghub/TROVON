...
* V_46 = F_13 (unsigned long, *data_size,
gsmi_dev.data_buf->length) ;
* V_46 = F_13 (unsigned long, *data_size, param.data_len) ;
...
static T_5 F_15 ( unsigned long * V_69 ,
T_4 * V_43 ,
T_6 * V_44 )
{
struct V_70 V_48 = {
...
static T_7 F_17 ( struct V_75 * V_76 , struct V_77 * V_78 ,
struct V_79 * V_80 ,
...
static T_7 F_18 ( struct V_77 * V_78 ,
struct V_86 * V_45 ,
...
static T_7 F_20 ( struct V_77 * V_78 ,
struct V_86 * V_45 ,
const char * V_81 , T_3 V_83 )
{
int V_17 ;
...
static T_9 T_10 F_25 ( T_9 V_87 , unsigned V_107 )
{
T_9 V_108 = V_87 ;
T_9 V_109 = V_108 ;
V_109 <<= 18 ;
...
static V_12 T_10 F_26 ( char V_110 [ 8 ] )
{
T_9 V_111 ;
memcpy ( & V_111 , V_110 , 8 ) ;
return F_25 ( V_111 , 32 ) ;
}
...
V_108 = F_26 ( V_114 . V_115 . V_116 ) ;
if ( V_108 == V_118 ) {
const char * V_119 = F_29 ( V_120 ) ;
...
V_6 . V_123 = F_32 ( L_22 , - 1 , NULL , 0 ) ;
if ( F_33 ( V_6 . V_123 ) ) {
F_3 ( V_4 L_23 ) ;
return F_34 ( V_6 . V_123 ) ;
}
F_35 ( & V_6 . V_59 ) ;
V_6 . V_123 -> V_124 . V_125 = F_36 ( 32 ) ;
V_6 . V_123 -> V_124 . V_126 =
& V_6 . V_123 -> V_124 . V_125 ;
V_54 = - V_26 ;
V_6 . V_7 = F_37 ( L_22 , & V_6 . V_123 -> V_124 ,
V_10 , V_127 , 0 ) ;
if ( ! V_6 . V_7 )
goto V_128;
V_6 . V_50 = F_1 () ;
...
V_54 = - V_26 ;
V_130 = F_38 ( L_22 , V_131 ) ;
if ( ! V_130 ) {
F_3 ( V_117 L_28 ) ;
goto V_128;
}
V_54 = F_39 ( V_130 , & V_132 ) ;
if ( V_54 ) {
F_3 ( V_117 L_29 ) ;
goto V_128;
}
V_54 = F_40 ( V_130 , V_133 ) ;
if ( V_54 ) {
F_3 ( V_117 L_30 ) ;
goto V_134;
}
V_54 = F_41 ( & V_135 , & V_136 , V_130 ) ;
if ( V_54 ) {
F_3 ( V_117 L_31 ) ;
goto V_137;
}
