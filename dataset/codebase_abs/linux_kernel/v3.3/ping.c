...
static inline int F_41 ( int type , int V_87 )
{
if ( type == V_88 && V_87 == 0 )
return 1 ;
return 0 ;
}
void F_42 ( struct V_89 * V_90 , T_1 V_91 )
{
...
int type = V_95 -> type ;
int V_87 = V_95 -> V_87 ;
struct V_1 * V_1 = F_43 ( V_90 -> V_97 ) ;
struct V_10 * V_11 ;
int V_98 ;
int V_66 ;
if ( ! F_41 ( V_95 -> type , V_95 -> V_87 ) )
return;
F_3 ( L_14 , type ,
...
static int F_45 ( void * V_126 , char * V_127 ,
...
F_16 () ;
if ( F_46 ( V_127 + sizeof( struct V_94 ) ,
...
static int F_47 ( struct V_10 * V_11 , struct V_131 * V_132 ,
struct V_136 * V_137 )
{
struct V_89 * V_90 = F_48 ( & V_11 -> V_138 ) ;
V_132 -> V_134 = F_49 ( ( char * ) & V_132 -> V_95 ,
sizeof( struct V_94 ) , V_132 -> V_134 ) ;
V_132 -> V_95 . V_139 = F_50 ( V_132 -> V_134 ) ;
memcpy ( F_51 ( V_90 ) , & V_132 -> V_95 , sizeof( struct V_94 ) ) ;
V_90 -> V_140 = V_141 ;
return F_52 ( V_11 , V_137 ) ;
}
static int F_53 ( struct V_142 * V_143 , struct V_10 * V_11 , struct V_144 * V_145 ,
T_5 V_146 )
{
struct V_1 * V_1 = F_8 ( V_11 ) ;
struct V_136 V_137 ;
...
return - V_159 ;
if ( F_54 ( ( V_123 * ) & V_150 , V_145 -> V_160 ,
sizeof( struct V_94 ) ) )
return - V_135 ;
if ( ! F_41 ( V_150 . type , V_150 . V_87 ) )
return - V_67 ;
if ( V_145 -> V_161 ) {
...
V_149 . V_169 = 0 ;
V_66 = F_55 ( V_11 , & V_149 . V_169 ) ;
if ( V_66 )
return V_66 ;
if ( V_145 -> V_170 ) {
V_66 = F_56 ( F_8 ( V_11 ) , V_145 , & V_149 ) ;
if ( V_66 )
return V_66 ;
if ( V_149 . V_167 )
free = 1 ;
...
F_63 ( & V_137 , V_149 . V_168 , V_11 -> V_181 , V_156 ,
V_182 , V_11 -> V_183 ,
F_64 ( V_11 ) , V_155 , V_31 , 0 , 0 ) ;
F_65 ( V_11 , F_66 ( & V_137 ) ) ;
V_152 = F_67 ( V_1 , & V_137 , V_11 ) ;
if ( F_68 ( V_152 ) ) {
V_66 = F_69 ( V_152 ) ;
V_152 = NULL ;
if ( V_66 == - V_184 )
...
V_132 . V_134 = 0 ;
V_66 = F_71 ( V_11 , & V_137 , F_45 , & V_132 , V_146 ,
0 , & V_149 , & V_152 , V_145 -> V_157 ) ;
if ( V_66 )
F_72 ( V_11 ) ;
else
V_66 = F_47 ( V_11 , & V_132 , & V_137 ) ;
F_40 ( V_11 ) ;
V_79:
F_73 ( V_152 ) ;
if ( free )
F_74 ( V_149 . V_167 ) ;
if ( ! V_66 ) {
F_75 ( F_8 ( V_11 ) , V_150 . type ) ;
return V_146 ;
}
return V_66 ;
V_190:
F_76 ( & V_152 -> V_192 ) ;
if ( ! ( V_145 -> V_157 & V_193 ) || V_146 )
goto V_191;
V_66 = 0 ;
goto V_79;
}
static int F_77 ( struct V_142 * V_143 , struct V_10 * V_11 , struct V_144 * V_145 ,
T_5 V_146 , int V_194 , int V_195 , int * V_61 )
{
struct V_16 * V_17 = F_6 ( V_11 ) ;
...
* V_61 = sizeof( * sin ) ;
if ( V_195 & V_197 )
return F_78 ( V_11 , V_145 , V_146 ) ;
V_90 = F_79 ( V_11 , V_195 , V_194 , & V_66 ) ;
if ( ! V_90 )
goto V_79;
V_196 = V_90 -> V_146 ;
if ( V_196 > V_146 ) {
...
V_66 = F_80 ( V_90 , 0 , V_145 -> V_160 , V_196 ) ;
if ( V_66 )
goto V_199;
F_81 ( V_145 , V_11 , V_90 ) ;
if ( sin ) {
sin -> V_164 = V_165 ;
sin -> V_70 = 0 ;
...
F_89 ( V_90 , V_90 -> V_40 - ( V_123 * ) V_95 ) ;
...
static struct V_10 * F_91 ( struct V_202 * V_43 , int V_203 )
{
struct V_10 * V_11 ;
struct V_204 * V_205 = V_43 -> V_206 ;
struct V_1 * V_1 = F_92 ( V_43 ) ;
for ( V_205 -> V_207 = V_203 ; V_205 -> V_207 < V_208 ;
++ V_205 -> V_207 ) {
struct V_13 * V_14 ;
struct V_5 * V_34 ;
V_34 = & V_6 . V_8 [ V_205 -> V_207 ] ;
if ( F_93 ( V_34 ) )
continue;
F_94 (sk, node, hslot) {
...
static struct V_10 * F_96 ( struct V_202 * V_43 , struct V_10 * V_11 )
{
struct V_204 * V_205 = V_43 -> V_206 ;
struct V_1 * V_1 = F_92 ( V_43 ) ;
do {
...
if ( ! V_11 )
return F_91 ( V_43 , V_205 -> V_207 + 1 ) ;
return V_11 ;
}
static struct V_10 * F_98 ( struct V_202 * V_43 , T_6 V_210 )
{
struct V_10 * V_11 = F_91 ( V_43 , 0 ) ;
if ( V_11 )
while ( V_210 && ( V_11 = F_96 ( V_43 , V_11 ) ) != NULL )
-- V_210 ;
return V_210 ? NULL : V_11 ;
}
static void * F_99 ( struct V_202 * V_43 , T_6 * V_210 )
{
struct V_204 * V_205 = V_43 -> V_206 ;
V_205 -> V_207 = 0 ;
F_22 ( & V_6 . V_20 ) ;
return * V_210 ? F_98 ( V_43 , * V_210 - 1 ) : V_211 ;
}
static void * F_100 ( struct V_202 * V_43 , void * V_212 , T_6 * V_210 )
{
struct V_10 * V_11 ;
if ( V_212 == V_211 )
V_11 = F_98 ( V_43 , 0 ) ;
else
V_11 = F_96 ( V_43 , V_212 ) ;
++ * V_210 ;
return V_11 ;
}
static void F_101 ( struct V_202 * V_43 , void * V_212 )
{
F_23 ( & V_6 . V_20 ) ;
}
static void F_102 ( struct V_10 * V_213 , struct V_202 * V_214 ,
int V_207 , int * V_146 )
{
struct V_16 * V_147 = F_6 ( V_213 ) ;
T_3 V_215 = V_147 -> V_85 ;
T_3 V_216 = V_147 -> V_36 ;
T_7 V_217 = F_34 ( V_147 -> V_86 ) ;
T_7 V_218 = F_34 ( V_147 -> V_30 ) ;
F_103 ( V_214 , L_24
L_25 ,
V_207 , V_216 , V_218 , V_215 , V_217 , V_213 -> V_121 ,
F_104 ( V_213 ) ,
F_105 ( V_213 ) ,
0 , 0L , 0 , F_106 ( V_213 ) , 0 , F_107 ( V_213 ) ,
F_108 ( & V_213 -> V_57 ) , V_213 ,
F_108 ( & V_213 -> V_219 ) , V_146 ) ;
}
static int F_109 ( struct V_202 * V_43 , void * V_212 )
{
if ( V_212 == V_211 )
F_103 ( V_43 , L_26 ,
L_27
...
struct V_204 * V_205 = V_43 -> V_206 ;
int V_146 ;
F_102 ( V_212 , V_43 , V_205 -> V_207 , & V_146 ) ;
F_103 ( V_43 , L_30 , 127 - V_146 , L_31 ) ;
}
return 0 ;
}
static int F_110 ( struct V_220 * V_220 , struct V_221 * V_221 )
{
return F_111 ( V_220 , V_221 , & V_222 ,
sizeof( struct V_204 ) ) ;
}
...
struct V_223 * V_224 ;
int V_225 = 0 ;
V_224 = F_113 ( V_1 , L_32 , V_226 , & V_227 ) ;
if ( ! V_224 )
V_225 = - V_228 ;
return V_225 ;
}
