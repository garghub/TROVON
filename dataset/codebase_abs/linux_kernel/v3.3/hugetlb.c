...
if ( F_242 ( F_243 ( F_200 ( V_211 ) , V_223 ) ) )
goto V_240;
return 0 ;
}
F_244 ( 1 ) ;
...
F_211 ( V_46 ) ;
V_242 = F_192 ( V_23 , V_46 , ( ( V_23 -> V_37 & V_251 )
&& ( V_23 -> V_37 & V_218 ) ) ) ;
F_212 ( V_226 , V_24 , V_211 , V_242 ) ;
if ( ( V_41 & V_249 ) && ! ( V_23 -> V_37 & V_218 ) ) {
V_98 = F_236 ( V_226 , V_23 , V_24 , V_211 , V_242 , V_46 ) ;
}
F_74 ( & V_226 -> V_221 ) ;
F_263 ( V_46 ) ;
V_141:
...
F_260 ( V_46 ) ;
F_73 ( & V_226 -> V_221 ) ;
if ( F_45 ( ! F_243 ( V_209 , F_200 ( V_211 ) ) ) )
goto V_256;
if ( V_41 & V_249 ) {
if ( ! F_267 ( V_209 ) ) {
...
T_12 * V_257 , int V_193 )
{
F_161 () ;
return NULL ;
}
int F_269 ( struct V_212 * V_226 , struct V_22 * V_23 ,
struct V_46 * * V_258 , struct V_22 * * V_259 ,
unsigned long * V_260 , int * V_195 , int V_49 ,
unsigned int V_41 )
{
unsigned long V_261 ;
unsigned long V_262 = * V_260 ;
int V_263 = * V_195 ;
struct V_20 * V_21 = F_20 ( V_23 ) ;
F_73 ( & V_226 -> V_221 ) ;
while ( V_262 < V_23 -> V_205 && V_263 ) {
T_10 * V_223 ;
int V_264 ;
struct V_46 * V_46 ;
V_223 = F_204 ( V_226 , V_262 & F_222 ( V_21 ) ) ;
V_264 = ! V_223 || F_207 ( F_200 ( V_223 ) ) ;
if ( V_264 && ( V_41 & V_265 ) &&
! F_253 ( V_21 , V_23 , V_262 ) ) {
V_263 = 0 ;
break;
}
if ( V_264 ||
( ( V_41 & V_266 ) && ! F_267 ( F_200 ( V_223 ) ) ) ) {
int V_98 ;
F_74 ( & V_226 -> V_221 ) ;
V_98 = F_264 ( V_226 , V_23 , V_262 ,
( V_41 & V_266 ) ? V_249 : 0 ) ;
F_73 ( & V_226 -> V_221 ) ;
if ( ! ( V_98 & V_267 ) )
continue;
...
V_261 = ( V_262 & ~ F_222 ( V_21 ) ) >> V_29 ;
V_46 = F_209 ( F_200 ( V_223 ) ) ;
V_268:
if ( V_258 ) {
V_258 [ V_49 ] = F_270 ( V_46 , V_261 ) ;
F_210 ( V_258 [ V_49 ] ) ;
}
if ( V_259 )
V_259 [ V_49 ] = V_23 ;
...
* V_195 = V_263 ;
* V_260 = V_262 ;
return V_49 ? V_49 : - V_269 ;
}
void F_271 ( struct V_22 * V_23 ,
unsigned long V_24 , unsigned long V_16 , T_13 V_270 )
{
struct V_212 * V_226 = V_23 -> V_227 ;
...
void F_276 ( struct V_118 * V_118 , long V_272 , long V_273 )
{
struct V_20 * V_21 = F_275 ( V_118 ) ;
long V_12 = F_10 ( & V_118 -> V_121 -> V_122 , V_272 ) ;
F_73 ( & V_118 -> V_245 ) ;
V_118 -> V_246 -= ( F_259 ( V_21 ) * V_273 ) ;
F_74 ( & V_118 -> V_245 ) ;
F_75 ( V_118 -> V_121 , ( V_12 - V_273 ) ) ;
F_186 ( V_21 , - ( V_12 - V_273 ) ) ;
}
static int F_277 ( struct V_46 * V_274 )
{
struct V_46 * V_46 ;
struct V_46 * V_108 ;
struct V_20 * V_21 = F_39 ( V_274 ) ;
int V_53 = F_48 ( V_274 ) ;
