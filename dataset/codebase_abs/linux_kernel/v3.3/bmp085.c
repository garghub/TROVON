...
static unsigned char F_16 ( struct V_5 * V_6 )
{
return V_6 -> V_35 ;
}
static T_4 F_17 ( struct V_49 * V_28 ,
struct V_50 * V_51 ,
...
static T_4 F_20 ( struct V_49 * V_28 ,
struct V_50 * V_51 , char * V_52 )
{
struct V_1 * V_2 = F_18 ( V_28 ) ;
struct V_5 * V_6 = F_2 ( V_2 ) ;
return sprintf ( V_52 , L_5 , F_16 ( V_6 ) ) ;
}
...
struct V_5 * V_6 ;
int V_66 = 0 ;
V_6 = F_29 ( sizeof( struct V_5 ) , V_67 ) ;
if ( ! V_6 ) {
V_66 = - V_68 ;
goto exit;
}
...
if ( V_66 != 0 )
goto V_69;
V_66 = F_31 ( & V_2 -> V_28 . V_70 , & V_71 ) ;
if ( V_66 )
goto V_69;
F_27 ( & V_6 -> V_2 -> V_28 , L_8 ) ;
goto exit;
V_69:
F_32 ( V_6 ) ;
exit:
