...
unsigned short V_4 = F_219 ( V_1058 -> V_535 . V_1060 . V_412 ) ;
V_166 -> V_1059 = V_140 ;
if ( F_29 ( ( F_219 ( V_1058 -> V_535 . V_1060 . V_412 ) + V_1061 ) >
F_376 ( V_770 -> V_498 ) ) ) {
V_166 -> V_670 . V_1062 ++ ;
...
char V_1322 [ 32 ] ;
T_3 V_4 ;
F_473 ( V_899 -> V_1323 , V_1324 , sizeof( V_899 -> V_1323 ) ) ;
F_473 ( V_899 -> V_980 , V_1325 , sizeof( V_899 -> V_980 ) ) ;
V_4 = sizeof( V_1321 ) ;
...
V_1321 , V_1322 ) ;
F_473 ( V_899 -> V_1329 , F_474 ( V_134 -> V_474 ) ,
sizeof( V_899 -> V_1329 ) ) ;
V_899 -> V_1330 = V_383 ;
}
static T_3 F_475 ( struct V_165 * V_166 )
{
struct V_17 * V_23 = F_339 ( V_166 ) ;
...
static T_13 F_479 ( int V_1333 , void * V_3 )
{
struct V_17 * V_23 = V_3 ;
T_3 V_219 , V_220 ;
if ( ! V_23 )
...
static void F_484 ( struct V_106 * V_107 )
{
struct V_17 * V_23 =
...
static void F_485 ( struct V_17 * V_23 )
{
V_23 -> V_1128 = - 1 ;
V_23 -> V_1129 = - 1 ;
V_23 -> V_1130 = 0 ;
...
static int T_14 F_490 ( struct V_17 * V_23 )
{
int V_429 = 0 ;
F_491 ( & V_23 -> V_228 ) ;
F_491 ( & V_23 -> V_483 ) ;
F_492 ( & V_23 -> V_665 , F_321 ) ;
F_493 ( & V_23 -> V_330 , F_372 ) ;
F_493 ( & V_23 -> V_555 , F_265 ) ;
F_493 ( & V_23 -> V_561 , F_266 ) ;
F_493 ( & V_23 -> V_776 , F_299 ) ;
F_493 ( & V_23 -> V_246 , F_163 ) ;
F_492 ( & V_23 -> V_191 , F_484 ) ;
F_493 ( & V_23 -> V_193 , V_1339 ) ;
F_493 ( & V_23 -> V_190 , V_1340 ) ;
F_492 ( & V_23 -> V_186 , F_331 ) ;
F_492 ( & V_23 -> V_187 , F_332 ) ;
F_492 ( & V_23 -> V_188 , F_330 ) ;
F_492 ( & V_23 -> V_189 , F_283 ) ;
F_492 ( & V_23 -> V_641 , F_279 ) ;
F_493 ( & V_23 -> V_650 , F_333 ) ;
F_493 ( & V_23 -> V_702 , F_371 ) ;
F_492 ( & V_23 -> V_319 , F_168 ) ;
F_493 ( & V_23 -> V_672 , F_487 ) ;
F_493 ( & V_23 -> V_241 , F_489 ) ;
F_492 ( & V_23 -> V_108 , F_57 ) ;
F_492 ( & V_23 -> V_104 , F_62 ) ;
F_492 ( & V_23 -> V_114 , F_66 ) ;
F_493 ( & V_23 -> V_812 , F_310 ) ;
#ifdef F_290
F_493 ( & V_23 -> V_958 , F_365 ) ;
#endif
F_494 ( & V_23 -> V_1336 , ( void (*) ( unsigned long ) )
F_140 , ( unsigned long ) V_23 ) ;
return V_429 ;
}
static void F_495 ( struct V_165 * V_166 ,
struct V_883 * V_244 )
{
struct V_17 * V_23 = F_339 ( V_166 ) ;
int V_7 ;
...
int V_155 , V_7 , V_8 ;
if ( V_23 -> V_1353 ) {
F_497 ( V_23 -> V_163 , V_23 -> V_1353 ) ;
V_23 -> V_1353 = 0 ;
}
if ( V_23 -> V_37 & V_697 )
return - V_303 ;
if ( V_149 && ! V_23 -> V_149 ) {
V_23 -> V_149 = F_498 ( V_149 , sizeof( * V_23 -> V_149 ) ,
V_148 ) ;
if ( V_23 -> V_149 == NULL ) {
F_46 ( L_509 ,
V_149 ) ;
...
if ( F_499 ( V_23 -> V_163 , & V_1356 [ V_8 ] ) ) {
F_93 ( L_511 ) ;
return 0 ;
}
if ( V_23 -> V_37 & V_184 ) {
...
static int F_501 ( struct V_165 * V_166 )
{
int V_155 = 0 ;
struct V_17 * V_23 = F_339 ( V_166 ) ;
F_59 ( & V_23 -> V_109 ) ;
...
V_1361 -> V_866 = F_498 ( V_202 -> V_203 ,
...
V_1375 -> V_866 = F_498 ( V_202 -> V_209 ,
sizeof( struct V_1364 ) ,
V_148 ) ;
if ( ! V_1375 -> V_866 ) {
V_155 = - V_473 ;
...
F_503 ( V_182 -> V_183 , & V_23 -> V_474 -> V_166 ) ;
...
static T_12 F_507 ( struct V_1002 * V_498 ,
struct V_165 * V_166 )
{
F_74 ( L_526 ) ;
F_237 ( V_498 ) ;
...
if ( V_23 -> V_157 )
return - V_160 ;
V_23 -> V_157 = F_508 ( sizeof( struct V_1379 ) , 1 ) ;
if ( V_23 -> V_157 == NULL )
return - V_473 ;
...
F_510 ( V_23 -> V_157 , & V_23 -> V_474 -> V_166 ) ;
...
static int T_14 F_514 ( struct V_474 * V_1382 ,
...
F_517 ( V_1382 ) ;
V_554 = F_518 ( V_1382 , F_519 ( 32 ) ) ;
if ( ! V_554 )
V_554 = F_520 ( V_1382 , F_519 ( 32 ) ) ;
if ( V_554 ) {
F_4 (KERN_WARNING DRV_NAME L_528 ) ;
goto V_1388;
}
F_521 ( V_1382 , V_23 ) ;
V_554 = F_522 ( V_1382 , V_1324 ) ;
if ( V_554 )
goto V_1388;
F_523 ( V_1382 , 0x40 , & V_21 ) ;
if ( ( V_21 & 0x0000ff00 ) != 0 )
F_524 ( V_1382 , 0x40 , V_21 & 0xffff00ff ) ;
V_412 = F_525 ( V_1382 , 0 ) ;
V_23 -> V_1389 = V_412 ;
V_137 = F_526 ( V_1382 , 0 ) ;
if ( ! V_137 ) {
V_554 = - V_1386 ;
goto V_1390;
}
...
F_408 ( V_23 , 1 ) ;
V_554 = F_527 ( V_1382 -> V_1333 , F_479 , V_1392 , V_1324 , V_23 ) ;
if ( V_554 ) {
F_46 ( L_532 , V_1382 -> V_1333 ) ;
goto V_1391;
}
F_510 ( V_167 , & V_1382 -> V_166 ) ;
F_59 ( & V_23 -> V_109 ) ;
V_23 -> V_163 -> V_1393 = F_468 ;
V_23 -> V_163 -> V_893 = F_495 ;
...
V_167 -> V_1407 = F_528 ( V_1382 , 0 ) ;
V_167 -> V_1408 = V_167 -> V_1407 + F_525 ( V_1382 , 0 ) - 1 ;
V_554 = F_529 ( & V_1382 -> V_166 . V_1409 , & V_1410 ) ;
if ( V_554 ) {
F_46 ( L_533 ) ;
F_60 ( & V_23 -> V_109 ) ;
goto V_1411;
...
F_513 ( V_23 -> V_167 ) ;
V_1412:
F_531 ( & V_1382 -> V_166 . V_1409 , & V_1410 ) ;
V_1411:
F_532 ( V_1382 -> V_1333 , V_23 ) ;
V_1391:
F_533 ( V_23 -> V_22 ) ;
V_1390:
F_534 ( V_1382 ) ;
...
static void T_16 F_536 ( struct V_474 * V_1382 )
{
struct V_17 * V_23 = F_537 ( V_1382 ) ;
...
static int F_540 ( struct V_474 * V_1382 , T_17 V_661 )
{
struct V_17 * V_23 = F_537 ( V_1382 ) ;
struct V_165 * V_166 = V_23 -> V_167 ;
...
F_542 ( V_1382 ) ;
F_535 ( V_1382 ) ;
F_543 ( V_1382 , F_544 ( V_1382 , V_661 ) ) ;
V_23 -> V_1414 = F_545 () ;
return 0 ;
}
static int F_546 ( struct V_474 * V_1382 )
{
struct V_17 * V_23 = F_537 ( V_1382 ) ;
struct V_165 * V_166 = V_23 -> V_167 ;
int V_554 ;
T_3 V_21 ;
F_4 ( V_1311 L_539 , V_166 -> V_158 ) ;
F_543 ( V_1382 , V_1415 ) ;
V_554 = F_516 ( V_1382 ) ;
if ( V_554 ) {
F_4 ( V_1056 L_540 ,
...
F_524 ( V_1382 , 0x40 , V_21 & 0xffff00ff ) ;
F_548 ( V_166 ) ;
V_23 -> V_1353 = F_545 () - V_23 -> V_1414 ;
F_128 ( & V_23 -> V_193 ) ;
return 0 ;
}
static void F_549 ( struct V_474 * V_1382 )
{
struct V_17 * V_23 = F_537 ( V_1382 ) ;
F_160 ( V_23 ) ;
F_535 ( V_1382 ) ;
...
V_429 = F_552 ( & V_1416 . V_1323 , & V_1417 ) ;
if ( V_429 ) {
F_46 ( L_544 ) ;
F_553 ( & V_1416 ) ;
return V_429 ;
