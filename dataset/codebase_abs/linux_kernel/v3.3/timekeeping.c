...
return;
F_62 ( V_5 . clock -> V_76 &&
( V_5 . V_10 + V_72 > V_5 . clock -> V_10 +
V_5 . clock -> V_76 ) ,
L_3 ,
V_5 . clock -> V_77 , ( long ) V_5 . V_10 + V_72 ,
( long ) V_5 . clock -> V_10 +
V_5 . clock -> V_76 ) ;
V_5 . V_10 += V_72 ;
V_5 . V_12 += V_2 ;
...
static T_1 F_63 ( T_1 V_68 , int V_9 )
{
T_2 V_78 = ( T_2 ) V_48 << V_5 . V_9 ;
T_2 V_79 ;
...
V_9 = F_68 ( V_68 ) - F_68 ( V_5 . V_11 ) ;
V_9 = F_69 ( 0 , V_9 ) ;
V_81 = ( 8 * sizeof( V_75 ) - ( F_68 ( V_75 ) + 1 ) ) - 1 ;
V_9 = F_70 ( V_9 , V_81 ) ;
while ( V_68 >= V_5 . V_11 ) {
V_68 = F_63 ( V_68 , V_9 ) ;
if( V_68 < V_5 . V_11 << V_9 )
...
T_3 V_82 = - ( T_3 ) V_5 . V_15 ;
V_5 . V_15 = 0 ;
V_5 . V_16 += V_82 << V_5 . V_17 ;
}
V_23 . V_35 = ( ( T_3 ) V_5 . V_15 >> V_5 . V_9 ) + 1 ;
V_5 . V_15 -= ( T_3 ) V_23 . V_35 << V_5 . V_9 ;
V_5 . V_16 += V_5 . V_15 <<
V_5 . V_17 ;
if ( F_66 ( V_23 . V_35 >= V_48 ) ) {
V_23 . V_35 -= V_48 ;
V_23 . V_24 ++ ;
F_64 () ;
}
...
F_19 ( V_29 , - V_83 . V_24 , - V_83 . V_35 ) ;
}
void F_72 ( struct V_28 * V_29 )
{
struct V_28 V_36 , V_84 ;
unsigned int V_30 ;
T_3 V_31 ;
F_12 ( V_32 ) ;
do {
...
F_19 ( V_29 , V_29 -> V_24 + V_36 . V_24 + V_84 . V_24 ,
V_29 -> V_35 + V_36 . V_35 + V_84 . V_35 + V_31 ) ;
}
T_4 F_73 ( void )
{
struct V_28 V_29 ;
...
void F_74 ( struct V_28 * V_29 )
{
* V_29 = F_30 ( * V_29 , V_59 ) ;
}
unsigned long F_75 ( void )
{
return V_23 . V_24 ;
}
...
struct V_28 F_78 ( void )
{
struct V_28 V_44 , V_85 ;
unsigned long V_30 ;
do {
V_30 = F_13 ( & V_33 ) ;
V_44 = V_23 ;
...
F_19 ( & V_44 , V_44 . V_24 + V_85 . V_24 ,
V_44 . V_35 + V_85 . V_35 ) ;
return V_44 ;
}
void F_79 ( unsigned long V_86 )
{
V_87 += V_86 ;
F_65 () ;
F_80 ( V_86 ) ;
}
void F_81 ( struct V_28 * V_88 ,
struct V_28 * V_89 , struct V_28 * V_84 )
{
unsigned long V_30 ;
do {
V_30 = F_13 ( & V_33 ) ;
