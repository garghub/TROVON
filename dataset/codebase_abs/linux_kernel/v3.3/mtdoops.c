...
if ( F_23 ( V_11 ) && V_20 == - V_41 ) {
V_20 = F_25 ( V_11 , V_2 -> V_29 * V_15 ) ;
if ( V_20 < 0 ) {
F_17 ( V_39 L_7 ) ;
return;
}
...
static void F_26 ( struct V_1 * V_2 , int V_42 )
{
struct V_10 * V_11 = V_2 -> V_11 ;
T_3 V_43 ;
T_2 * V_44 ;
...
V_20 = F_28 ( V_11 , V_2 -> V_29 * V_15 ,
V_15 , & V_43 , V_2 -> V_45 ) ;
if ( V_43 != V_15 || V_20 < 0 )
F_17 ( V_39 L_9 ,
V_2 -> V_29 * V_15 , V_43 , V_15 , V_20 ) ;
F_1 ( V_2 , V_2 -> V_29 ) ;
memset ( V_2 -> V_45 , 0xff , V_15 ) ;
F_19 ( V_2 ) ;
}
...
return;
V_67 = V_2 -> V_45 + V_52 ;
V_66 = F_34 ( V_61 , V_15 - V_52 ) ;
V_65 = F_34 ( V_59 , V_15 - V_52 - V_66 ) ;
V_64 = V_61 - V_66 ;
V_63 = V_59 - V_65 ;
