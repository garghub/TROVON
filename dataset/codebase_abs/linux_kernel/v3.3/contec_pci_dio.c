...
{
F_12 ( V_2 -> V_44 , L_8 ) ;
F_12 ( V_2 -> V_44 , L_9 , V_43 [ 0 ] , V_43 [ 1 ] ) ;
if ( V_42 -> V_45 != 2 )
return - V_46 ;
if ( V_43 [ 0 ] ) {
V_8 -> V_47 &= ~ V_43 [ 0 ] ;
V_8 -> V_47 |= V_43 [ 0 ] & V_43 [ 1 ] ;
F_12 ( V_2 -> V_44 , L_10 , V_8 -> V_47 ,
V_2 -> V_25 + V_11 -> V_48 ) ;
F_13 ( V_8 -> V_47 , V_2 -> V_25 + V_11 -> V_48 ) ;
}
return 2 ;
}
...
if ( V_42 -> V_45 != 2 )
return - V_46 ;
V_43 [ 1 ] = F_14 ( V_2 -> V_25 + V_11 -> V_49 ) ;
return 2 ;
}
static int T_1 F_15 ( struct V_5 * V_2 ,
const struct V_50 * V_51 )
{
return F_16 ( V_2 , V_52 . V_53 ) ;
}
