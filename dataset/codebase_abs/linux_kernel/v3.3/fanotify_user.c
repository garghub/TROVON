...
static T_3 F_79 ( struct V_84 * V_85 ,
T_3 V_30 ,
unsigned int V_89 )
{
T_3 V_102 = - 1 ;
...
return - V_52 ;
F_81 ( V_85 , F_56 ) ;
V_25 = F_82 ( V_85 , V_3 , NULL , V_13 , 0 ) ;
if ( V_25 )
goto V_118;
}
V_114 = F_79 ( V_85 , V_30 , V_89 ) ;
if ( V_114 & ~ F_74 ( V_13 ) -> V_107 )
F_75 ( V_13 ) ;
V_118:
F_73 ( V_85 ) ;
return V_25 ;
...
return - V_52 ;
F_81 ( V_85 , F_56 ) ;
V_25 = F_82 ( V_85 , V_3 , V_73 , NULL , 0 ) ;
if ( V_25 )
goto V_118;
}
V_114 = F_79 ( V_85 , V_30 , V_89 ) ;
...
T_8 (F_84)( int V_120 , unsigned int V_89 ,
T_9 V_30 , int V_87 ,
...
case V_124 :
if ( V_89 & V_134 )
V_25 = F_80 ( V_3 , V_13 , V_30 , V_89 ) ;
else
V_25 = F_83 ( V_3 , V_73 , V_30 , V_89 ) ;
break;
case V_125 :
if ( V_89 & V_134 )
V_25 = F_71 ( V_3 , V_13 , V_30 , V_89 ) ;
else
V_25 = F_76 ( V_3 , V_73 , V_30 , V_89 ) ;
break;
case V_126 :
if ( V_89 & V_134 )
F_85 ( V_3 ) ;
...
T_10 long F_87 ( long V_120 , long V_89 , T_9 V_30 ,
long V_87 , long V_121 )
{
return F_88 ( ( int ) V_120 , ( unsigned int ) V_89 ,
V_30 , ( int ) V_87 ,
( const char T_5 * ) V_121 ) ;
}
static int T_11 F_89 ( void )
{
V_86 = F_90 ( V_84 , V_135 ) ;
V_49 = F_90 ( V_37 ,
V_135 ) ;
return 0 ;
}
