...
V_63 . V_78 = V_19 -> V_78 ;
V_63 . V_73 = F_38 (
F_56 ( ( unsigned long ) V_59 , & V_88 ) ) . V_74 ;
if ( F_39 ( V_92 , & V_63 , 1 ) )
F_40 () ;
if ( V_63 . V_76 == V_77 )
F_41 ( V_19 -> V_70 ) ;
...
{
enum V_1 V_94 ;
int V_18 = F_62 ( V_40 , V_15 , L_14 , L_15 , & V_94 , NULL ) ;
if ( V_18 )
V_94 = V_4 ;
return V_94 ;
}
