...
void * V_141 ;
char * V_142 ;
void T_3 * V_143 = F_55 ( V_66 -> V_123 . V_7 , 4096 ) ;
V_140 = F_11 ( V_143 + V_144 ) ;
if ( F_64 ( V_66 ) ) {
V_140 &= 0xf ;
switch ( V_140 ) {
case 0 : V_142 = L_39 ; break;
case 1 : V_142 = L_40 ; break;
case 2 : V_142 = L_41 ; break;
case 3 : V_142 = L_42 ; break;
case 4 : V_142 = L_43 ; break;
case 5 : V_142 = L_44 ; break;
default: V_142 = L_45 ;
}
F_2 ( V_145 L_46 ,
V_142 , V_140 & 0xf , ( long ) V_66 -> V_123 . V_7 ) ;
if ( V_140 < 2 ) {
F_2 ( V_45 L_47
L_48 ) ;
}
...
} else if ( F_65 ( V_66 ) || F_66 ( V_66 ) ) {
int V_147 , V_148 ;
V_140 &= 0xff ;
V_147 = V_140 >> 4 , V_148 = V_140 & 0xf ;
F_2 ( V_145 L_49 ,
F_65 ( V_66 ) ? L_50 : L_51 , V_147 ,
V_148 , V_140 , ( long ) V_66 -> V_123 . V_7 ) ;
V_139 = & V_149 ;
} else {
F_2 ( V_63 L_52 ,
( long ) V_66 -> V_123 . V_7 ) ;
...
V_141 = F_67 ( V_66 -> V_123 . V_7 + V_151 ) ;
...
V_85 -> V_152 = V_140 ;
V_85 -> V_16 . V_29 = V_143 ;
V_85 -> V_16 . V_66 = V_66 ;
V_85 -> V_75 = V_141 ;
V_85 -> V_16 . V_153 = F_68 ( V_66 ) ;
F_69 ( V_66 , V_85 ) ;
V_154 = & V_155 ;
F_70 ( F_43 ( V_85 ) ) ;
F_71 ( & V_85 -> V_156 ) ;
...
if ( ! V_159 ) {
V_159 = F_55 ( V_160 , 64 * 1024 ) ;
V_157 = & V_161 ;
}
F_56 ( V_66 , V_85 ) ;
}
if ( V_85 -> V_16 . V_103 . V_7 < V_162 )
V_85 -> V_16 . V_103 . V_7 = V_162 ;
if ( F_30 ( & V_62 ,
& ( V_85 -> V_16 . V_59 ) ) ) {
F_2 ( V_45 L_54 ,
( long ) V_85 -> V_16 . V_59 . V_7 ,
( long ) V_85 -> V_16 . V_59 . V_8 ) ;
V_85 -> V_16 . V_59 . V_9 = 0 ;
}
F_73 ( & V_136 , & V_85 -> V_16 . V_57 ) ;
if ( V_85 -> V_16 . V_61 . V_7 )
F_73 ( & V_136 , & V_85 -> V_16 . V_61 ) ;
if ( V_85 -> V_16 . V_59 . V_9 )
F_73 ( & V_136 , & V_85 -> V_16 . V_59 ) ;
if ( V_85 -> V_16 . V_64 . V_9 )
F_73 ( & V_136 , & V_85 -> V_16 . V_64 ) ;
V_66 -> V_66 . V_52 = V_85 ;
V_137 = V_85 -> V_16 . V_17 =
F_74 ( & V_66 -> V_66 , V_85 -> V_16 . V_103 . V_7 ,
V_139 , NULL , & V_136 ) ;
if ( ! V_137 ) {
F_75 ( & V_136 ) ;
return 0 ;
}
V_137 -> V_20 = F_76 ( V_137 ) ;
if ( F_72 () ) {
F_77 ( L_55 ) ;
F_78 ( V_137 ) ;
F_77 ( L_56 ) ;
...
void F_85 ( struct V_83 * V_165 , T_2 V_166 , T_2 V_167 )
{
void T_3 * V_29 = F_55 ( V_165 -> V_123 . V_7 , 4096 ) ;
V_167 <<= 2 ;
F_86 ( ( V_166 & 0x001fffff ) != 0 ) ;
F_86 ( ( V_167 & 0x001fffff ) != 0 ) ;
F_29 ( L_59 , V_38 , V_166 , V_167 ) ;
F_22 ( V_167 , V_29 + V_168 ) ;
F_22 ( V_166 , V_29 + V_169 ) ;
F_87 ( V_29 ) ;
}
