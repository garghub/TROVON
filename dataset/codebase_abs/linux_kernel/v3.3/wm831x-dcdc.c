...
static T_3 int F_34 ( struct V_71 * V_72 )
{
struct V_5 * V_5 = F_35 ( V_72 -> V_27 . V_73 ) ;
...
V_76 = 0 ;
V_76 = V_72 -> V_76 - V_76 ;
F_14 ( & V_72 -> V_27 , L_11 , V_76 + 1 ) ;
if ( V_64 == NULL || V_64 -> V_4 [ V_76 ] == NULL )
return - V_80 ;
V_4 = F_36 ( & V_72 -> V_27 , sizeof( struct V_3 ) ,
V_81 ) ;
if ( V_4 == NULL ) {
F_31 ( & V_72 -> V_27 , L_12 ) ;
return - V_82 ;
...
V_4 -> V_9 = V_78 -> V_85 ;
snprintf ( V_4 -> V_66 , sizeof( V_4 -> V_66 ) , L_14 , V_76 + 1 ) ;
V_4 -> V_86 . V_66 = V_4 -> V_66 ;
V_4 -> V_86 . V_76 = V_76 ;
V_4 -> V_86 . type = V_87 ;
V_4 -> V_86 . V_88 = V_41 + 1 ;
V_4 -> V_86 . V_89 = & V_90 ;
V_4 -> V_86 . V_91 = V_92 ;
...
V_4 -> V_52 = V_25 & V_54 ;
if ( V_64 -> V_4 [ V_76 ] )
F_29 ( V_4 , V_64 -> V_4 [ V_76 ] -> V_93 ) ;
V_4 -> V_36 = F_38 ( & V_4 -> V_86 , & V_72 -> V_27 ,
V_64 -> V_4 [ V_76 ] , V_4 , NULL ) ;
if ( F_39 ( V_4 -> V_36 ) ) {
V_25 = F_40 ( V_4 -> V_36 ) ;
F_31 ( V_5 -> V_27 , L_17 ,
V_76 + 1 , V_25 ) ;
...
static T_4 int F_46 ( struct V_71 * V_72 )
{
struct V_3 * V_4 = F_47 ( V_72 ) ;
F_43 ( V_72 , NULL ) ;
F_44 ( F_41 ( V_72 , L_20 ) , V_4 ) ;
F_44 ( F_41 ( V_72 , L_18 ) , V_4 ) ;
F_45 ( V_4 -> V_36 ) ;
if ( V_4 -> V_47 )
F_33 ( V_4 -> V_47 ) ;
...
static T_3 int F_53 ( struct V_71 * V_72 )
{
struct V_5 * V_5 = F_35 ( V_72 -> V_27 . V_73 ) ;
struct V_74 * V_64 = V_5 -> V_27 -> V_75 ;
int V_76 ;
...
static T_4 int F_54 ( struct V_71 * V_72 )
{
struct V_3 * V_4 = F_47 ( V_72 ) ;
F_43 ( V_72 , NULL ) ;
F_44 ( F_41 ( V_72 , L_18 ) , V_4 ) ;
...
struct V_5 * V_5 = F_35 ( V_72 -> V_27 . V_73 ) ;
struct V_74 * V_64 = V_5 -> V_27 -> V_75 ;
int V_76 = V_72 -> V_76 % F_27 ( V_64 -> V_4 ) ;
struct V_3 * V_4 ;
struct V_77 * V_78 ;
int V_25 , V_34 ;
F_14 ( & V_72 -> V_27 , L_11 , V_76 + 1 ) ;
if ( V_64 == NULL || V_64 -> V_4 [ V_76 ] == NULL )
return - V_80 ;
V_4 = F_57 ( sizeof( struct V_3 ) , V_81 ) ;
if ( V_4 == NULL ) {
F_31 ( & V_72 -> V_27 , L_12 ) ;
return - V_82 ;
}
...
static T_4 int F_59 ( struct V_71 * V_72 )
{
struct V_3 * V_4 = F_47 ( V_72 ) ;
F_43 ( V_72 , NULL ) ;
F_44 ( F_41 ( V_72 , L_18 ) , V_4 ) ;
...
static T_3 int F_60 ( struct V_71 * V_72 )
{
struct V_5 * V_5 = F_35 ( V_72 -> V_27 . V_73 ) ;
struct V_74 * V_64 = V_5 -> V_27 -> V_75 ;
int V_76 = V_72 -> V_76 % F_27 ( V_64 -> V_101 ) ;
struct V_3 * V_4 ;
int V_25 ;
F_14 ( & V_72 -> V_27 , L_22 , V_76 + 1 ) ;
if ( V_64 == NULL || V_64 -> V_101 [ V_76 ] == NULL )
return - V_80 ;
V_4 = F_57 ( sizeof( struct V_3 ) , V_81 ) ;
if ( V_4 == NULL ) {
F_31 ( & V_72 -> V_27 , L_12 ) ;
...
V_4 -> V_5 = V_5 ;
snprintf ( V_4 -> V_66 , sizeof( V_4 -> V_66 ) , L_23 , V_76 + 1 ) ;
V_4 -> V_86 . V_66 = V_4 -> V_66 ;
V_4 -> V_86 . V_76 = V_76 + V_102 ;
V_4 -> V_86 . V_89 = & V_103 ;
V_4 -> V_86 . type = V_87 ;
V_4 -> V_86 . V_91 = V_92 ;
V_4 -> V_36 = F_38 ( & V_4 -> V_86 , & V_72 -> V_27 ,
V_64 -> V_101 [ V_76 ] , V_4 , NULL ) ;
if ( F_39 ( V_4 -> V_36 ) ) {
V_25 = F_40 ( V_4 -> V_36 ) ;
F_31 ( V_5 -> V_27 , L_24 ,
V_76 + 1 , V_25 ) ;
...
static T_4 int F_61 ( struct V_71 * V_72 )
{
struct V_3 * V_4 = F_47 ( V_72 ) ;
F_43 ( V_72 , NULL ) ;
F_45 ( V_4 -> V_36 ) ;
