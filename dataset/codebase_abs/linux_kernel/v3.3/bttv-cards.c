...
static int T_1 F_55 ( struct V_1 * V_2 , const T_3 * V_187 ,
T_2 V_188 )
{
T_2 V_189 ;
T_3 V_190 ;
int V_4 ;
F_8 ( 0xffffff , V_191 | V_192 | V_193 ) ;
F_14 ( 0 ) ;
F_9 ( V_194 ) ;
F_14 ( V_193 ) ;
F_9 ( V_194 ) ;
...
int V_197 ;
V_197 = F_56 ( & V_196 , L_55 , & V_2 -> V_6 . V_7 -> V_198 ) ;
if ( V_197 != 0 ) {
F_45 ( L_56 , V_2 -> V_6 . V_12 ) ;
return V_197 ;
}
V_197 = F_55 ( V_2 , V_196 -> V_199 , V_196 -> V_200 ) ;
F_2 ( L_57 ,
V_2 -> V_6 . V_12 , ( V_197 < 0 ) ? L_58 : L_59 ) ;
F_57 ( V_196 ) ;
return V_197 ;
}
static void T_1 F_40 ( struct V_1 * V_2 , const T_3 V_201 [ 256 ] )
{
int V_4 ;
T_2 V_202 = 0 ;
int V_5 = - 1 ;
if ( V_2 -> V_6 . type == V_82 ) {
if ( ! strncmp ( V_201 , L_60 , 4 ) ) {
T_3 V_203 = 0 ;
...
V_202 *= 10 , V_202 += V_201 [ V_4 ] - '0' ;
}
} else {
unsigned short type ;
for ( V_4 = 4 * 16 ; V_4 < 8 * 16 ; V_4 += 16 ) {
T_4 V_203 = F_58 ( V_201 + V_4 , 16 ) ;
if ( ( V_203 & 0xff ) + ( V_203 >> 8 ) == 0xff )
break;
}
if ( V_4 >= 8 * 16 )
return;
V_201 += V_4 ;
type = F_59 ( ( V_204 * ) ( V_201 + 4 ) ) ;
switch( type ) {
case 0x0004 :
V_5 = V_104 ;
break;
...
V_202 = F_60 ( ( V_205 * ) ( V_201 + 6 ) ) ;
}
F_2 ( L_62 ,
V_2 -> V_6 . V_12 , V_5 ,
V_5 > 0 ? V_17 [ V_5 ] . V_13 : L_63 , V_202 ) ;
...
{
int V_206 , V_207 , V_208 , V_33 = 0 ;
V_206 = ( V_23 [ 0x41 ] & 0x7 ) ;
V_207 = ( V_23 [ 0x41 ] & 0x18 ) >> 3 ;
V_208 = ( V_23 [ 0x42 ] & 0xf0 ) >> 4 ;
...
T_2 F_61 ( struct V_1 * V_2 , T_2 V_3 )
{
if ( V_2 -> V_212 == V_213 ) {
if ( V_214 [ V_2 -> V_215 ] . V_216 & V_217 )
V_3 |= 0x10000 ;
else
V_3 &= ~ 0x10000 ;
}
...
static void T_1 F_30 ( struct V_1 * V_2 , int V_218 )
{
int V_219 = ( 1 << V_218 ) ;
F_8 ( V_219 , V_219 ) ;
F_15 ( V_219 , 0 ) ;
...
{
static int V_222 [] V_223 = { 0x08 , 0x09 , 0x0a , 0x0b , 0x0d , 0x0d ,
...
F_9 ( 10 ) ;
F_14 ( 1 << 2 ) ;
for ( V_4 = 0 ; V_4 < F_4 ( V_222 ) ; V_4 ++ ) {
V_224 = F_64 ( V_2 , 0x1E , 0 , V_222 [ V_4 ] , 1 ) ;
if ( V_224 != - 1 ) {
F_2 ( L_75 ,
V_222 [ V_4 ] , V_224 , F_12 ( V_2 , 0x1F , NULL ) ) ;
}
}
F_2 ( L_76 ) ;
}
...
{
if ( V_2 -> V_185 ) {
F_15 ( V_2 -> V_185 | V_2 -> V_184 | V_2 -> V_186 ,
V_2 -> V_185 | V_2 -> V_184 | V_2 -> V_186 ) ;
F_9 ( 5 ) ;
}
F_15 ( V_234 , 0 ) ;
F_9 ( 5 ) ;
if ( V_2 -> V_185 ) {
F_15 ( V_2 -> V_184 | V_2 -> V_186 , 0 ) ;
F_9 ( 5 ) ;
}
}
...
void F_75 ( struct V_1 * V_2 , unsigned short V_183 )
{
F_73 ( L_88 , V_183 ) ;
F_53 ( V_2 , 5 * V_183 + 0x358 ) ;
}
...
{
static const T_3 V_238 [] = { 0x3 , 0x1 , 0x2 , 0x4 , 0xf , 0x7 , 0xe , 0x0 ,
...
unsigned char V_199 ) {
unsigned int V_241 ;
V_241 = ( V_199 << 7 ) | ( ( V_240 & 3 ) << 4 ) | ( V_239 & 0xf ) ;
F_15 ( 0x1ff , V_241 ) ;
...
V_264 [ 0 ] = 0 ;
V_264 [ 1 ] = 0 ;
V_197 = F_64 ( V_2 , ( V_265 << 1 ) , V_264 [ 0 ] , V_264 [ 1 ] , 1 ) ;
if ( V_197 ) {
F_3 ( L_91 ,
V_2 -> V_6 . V_12 , V_197 ) ;
return;
}
V_197 = F_12 ( V_2 , ( V_265 << 1 ) , NULL ) ;
if ( ! ( V_197 & V_266 ) ) {
F_3 ( L_92 ,
V_2 -> V_6 . V_12 , V_197 ) ;
return;
...
unsigned char V_240 ,
unsigned char V_199 ) {
const T_2 V_269 = ( ( V_239 & 0xf ) | ( V_240 & 3 ) << 4 ) ;
const T_2 V_270 = 1 << 16 ;
const T_2 V_271 = 1 << 17 ;
const T_2 V_272 = V_199 << 18 ;
...
if ( V_18 != V_284 )
F_2 ( L_99 , V_284 ) ;
while ( ( V_198 = F_89 ( V_286 ,
V_287 , V_198 ) ) ) {
unsigned char V_288 ;
F_90 ( V_198 , 0x53 , & V_288 ) ;
if ( V_70 )
F_2 ( L_100 ,
V_288 ) ;
}
