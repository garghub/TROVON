...
V_17 . V_48 [ V_44 ] . V_1 = V_1 ;
V_17 . V_48 [ V_44 ] . V_4 =
V_52 -> V_4 ;
V_17 . V_48 [ V_44 ] . V_50 = V_50 ;
F_29 ( &
( V_17 . V_48 [ V_44 ] .
V_21 ) , V_52 -> V_21 ) ;
F_14 ( V_1 , V_52 ) ;
...
V_55:
F_3 ( V_53 , sizeof( struct V_2 ) ) ;
}
static T_2
F_31 ( T_5 * V_6 , T_3 V_59 )
{
T_4 V_60 ;
if ( V_59 == sizeof( T_3 ) ) {
return ( ( T_2 )
...
T_1 V_13 ;
F_34 ( V_67 ) ;
V_64 = F_2 ( V_63 , sizeof( struct V_32 ) ) ;
if ( ! V_64 ) {
F_35 ( V_9 ) ;
}
F_14 ( V_63 ,
