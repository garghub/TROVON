...
V_89 -> V_99 = F_59 ( V_11 ) ;
F_63 ( V_79 , V_100 , V_61 , & V_11 -> V_37 ) ;
V_85 . V_101 = F_46 ( V_83 - V_11 -> V_68 ) ;
V_85 . V_102 = 0 ;
V_85 . V_103 = F_46 ( V_83 - V_11 -> V_13 ) ;
V_85 . V_104 = 0 ;
F_63 ( V_79 , V_105 , sizeof( V_85 ) , & V_85 ) ;
...
int F_75 ( struct V_78 * V_79 , struct V_112 * V_113 )
{
struct V_107 * V_107 = F_76 ( V_79 -> V_114 ) ;
struct V_48 * V_35 ;
int V_115 = 0 ;
F_42 () ;
F_77 (net, dev) {
struct V_6 * V_7 = F_78 ( V_35 ) ;
int V_28 ;
if ( ! ( V_35 -> V_116 & V_117 ) )
continue;
for ( V_28 = 0 ; V_28 < V_17 ; V_28 ++ ) {
...
static int F_80 ( struct V_25 * V_66 , const T_5 * V_37 ,
T_6 V_51 , T_6 V_82 )
{
...
int F_81 ( struct V_78 * V_79 , struct V_86 * V_87 , void * V_125 )
{
struct V_107 * V_107 = F_76 ( V_79 -> V_114 ) ;
struct V_88 * V_89 ;
...
int V_108 ;
F_82 () ;
V_108 = F_83 ( V_87 , sizeof( * V_89 ) , V_127 , V_128 , NULL ) ;
if ( V_108 < 0 )
return V_108 ;
V_89 = F_62 ( V_87 ) ;
if ( V_89 -> V_97 == 0 ) {
...
V_35 = F_85 ( V_107 , V_89 -> V_97 ) ;
if ( V_35 == NULL ) {
F_84 ( L_7 ) ;
return - V_129 ;
}
if ( ! V_127 [ V_100 ] || F_86 ( V_127 [ V_100 ] ) != V_61 ) {
F_84 ( L_8 ) ;
return - V_70 ;
}
V_37 = F_87 ( V_127 [ V_100 ] ) ;
if ( ! F_53 ( V_37 ) ) {
F_84 ( L_9 ) ;
return - V_70 ;
}
...
F_20 ( & V_26 -> V_7 -> V_29 ) ;
V_108 = F_80 ( V_26 , V_37 , V_89 -> V_99 , V_87 -> V_131 ) ;
F_26 ( & V_26 -> V_7 -> V_29 ) ;
}
return V_108 ;
}
static int F_89 ( struct V_25 * V_26 , const T_3 * V_37 )
{
struct V_6 * V_7 = V_26 -> V_7 ;
struct V_65 * V_19 = & V_7 -> V_69 [ F_9 ( V_37 ) ] ;
struct V_2 * V_11 ;
...
int F_90 ( struct V_78 * V_79 , struct V_86 * V_87 , void * V_125 )
{
struct V_107 * V_107 = F_76 ( V_79 -> V_114 ) ;
struct V_88 * V_89 ;
struct V_25 * V_26 ;
...
V_132 = F_92 ( V_87 , sizeof( * V_89 ) , V_100 ) ;
if ( V_132 == NULL || F_86 ( V_132 ) != V_61 ) {
F_84 ( L_14 ) ;
return - V_70 ;
}
V_37 = F_87 ( V_132 ) ;
