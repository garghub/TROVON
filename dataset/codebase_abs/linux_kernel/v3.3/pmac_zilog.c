...
V_2 -> V_42 . type = V_245 ;
V_2 -> V_42 . V_30 = 0 ;
if ( V_2 -> V_42 . V_94 == V_246 &&
V_208 -> V_247 && V_208 -> V_247 -> V_247 &&
F_92 ( V_208 -> V_247 -> V_247 , L_45 ) ) {
...
static int F_99 ( struct V_248 * V_249 , const struct V_250 * V_251 )
{
struct V_1 * V_2 ;
int V_4 ;
for ( V_4 = 0 ; V_4 < V_252 ; V_4 ++ )
if ( V_253 [ V_4 ] . V_134 == V_249 -> V_254 . V_255 . V_256 )
break;
if ( V_4 >= V_252 )
return - V_219 ;
V_2 = & V_253 [ V_4 ] ;
V_2 -> V_255 = V_249 ;
V_2 -> V_42 . V_255 = & V_249 -> V_254 . V_255 ;
F_100 ( & V_249 -> V_254 . V_255 , V_2 ) ;
if ( F_101 ( V_2 -> V_255 , L_46 ) )
F_95 ( V_257 L_47
L_48 ,
V_2 -> V_134 -> V_212 ) ;
else
V_2 -> V_30 |= V_258 ;
return F_102 ( & V_259 , & V_2 -> V_42 ) ;
}
static int F_103 ( struct V_248 * V_249 )
{
struct V_1 * V_2 = F_104 ( & V_249 -> V_254 . V_255 ) ;
if ( ! V_2 )
return - V_219 ;
F_105 ( & V_259 , & V_2 -> V_42 ) ;
if ( V_2 -> V_30 & V_258 ) {
F_106 ( V_2 -> V_255 ) ;
V_2 -> V_30 &= ~ V_258 ;
}
F_100 ( & V_249 -> V_254 . V_255 , NULL ) ;
V_2 -> V_255 = NULL ;
V_2 -> V_42 . V_255 = NULL ;
return 0 ;
}
static int F_107 ( struct V_248 * V_249 , T_4 V_260 )
{
struct V_1 * V_2 = F_104 ( & V_249 -> V_254 . V_255 ) ;
if ( V_2 == NULL ) {
F_95 ( L_49 ) ;
...
F_108 ( & V_259 , & V_2 -> V_42 ) ;
return 0 ;
}
static int F_109 ( struct V_248 * V_249 )
{
struct V_1 * V_2 = F_104 ( & V_249 -> V_254 . V_255 ) ;
if ( V_2 == NULL )
return 0 ;
F_110 ( & V_259 , & V_2 -> V_42 ) ;
return 0 ;
}
static int T_3 F_111 ( void )
{
struct V_207 * V_261 , * V_262 , * V_263 , * V_208 ;
int V_211 = 0 ;
int V_98 ;
V_261 = F_94 ( NULL , L_50 ) ;
while ( V_261 ) {
V_262 = V_263 = NULL ;
for ( V_208 = NULL ; ( V_208 = F_112 ( V_261 , V_208 ) ) != NULL ; ) {
...
F_96 ( V_263 ) ;
F_95 ( V_264 L_53 ,
( ! V_262 ) ? 'a' : 'b' , V_261 -> V_265 ) ;
goto V_266;
}
if ( V_263 != NULL ) {
V_253 [ V_211 ] . V_101 = & V_253 [ V_211 + 1 ] ;
V_253 [ V_211 + 1 ] . V_101 = & V_253 [ V_211 ] ;
}
V_253 [ V_211 ] . V_30 = V_267 ;
V_253 [ V_211 ] . V_134 = V_262 ;
V_253 [ V_211 + 1 ] . V_134 = V_263 ;
V_253 [ V_211 ] . V_42 . line = V_211 ;
V_253 [ V_211 + 1 ] . V_42 . line = V_211 + 1 ;
V_98 = F_85 ( & V_253 [ V_211 ] ) ;
if ( V_98 == 0 && V_263 != NULL )
V_98 = F_85 ( & V_253 [ V_211 + 1 ] ) ;
if ( V_98 != 0 ) {
F_96 ( V_262 ) ;
F_96 ( V_263 ) ;
memset ( & V_253 [ V_211 ] , 0 , sizeof( struct V_1 ) ) ;
memset ( & V_253 [ V_211 + 1 ] , 0 , sizeof( struct V_1 ) ) ;
goto V_266;
}
V_211 += 2 ;
V_266:
V_261 = F_94 ( V_261 , L_50 ) ;
}
V_268 = V_211 ;
return 0 ;
}
...
struct V_215 * V_216 ;
int V_94 ;
V_216 = F_114 ( V_2 -> V_269 , V_270 , 0 ) ;
V_94 = F_115 ( V_2 -> V_269 , 0 ) ;
if ( ! V_216 || ! V_94 )
return - V_219 ;
V_2 -> V_42 . V_220 = V_216 -> V_221 ;
V_2 -> V_42 . V_222 = ( unsigned char V_271 * ) V_216 -> V_221 ;
V_2 -> V_42 . V_239 = V_240 ;
V_2 -> V_42 . V_94 = V_94 ;
V_2 -> V_42 . V_241 = V_166 ;
V_2 -> V_42 . V_242 = 1 ;
...
return V_272 ;
V_268 ++ ;
V_253 [ 0 ] . V_101 = & V_253 [ 1 ] ;
V_253 [ 1 ] . V_101 = & V_253 [ 0 ] ;
V_253 [ 1 ] . V_42 . line = 1 ;
V_253 [ 1 ] . V_30 = 0 ;
V_253 [ 1 ] . V_269 = & V_274 ;
V_272 = F_85 ( & V_253 [ 1 ] ) ;
...
if ( V_253 [ V_4 ] . V_269 == V_269 )
break;
if ( V_4 >= V_268 )
return - V_219 ;
V_2 = & V_253 [ V_4 ] ;
V_2 -> V_42 . V_255 = & V_269 -> V_255 ;
F_116 ( V_269 , V_2 ) ;
return F_102 ( & V_259 , & V_2 -> V_42 ) ;
}
static int T_5 F_103 ( struct V_275 * V_269 )
{
struct V_1 * V_2 = F_117 ( V_269 ) ;
if ( ! V_2 )
return - V_219 ;
F_105 ( & V_259 , & V_2 -> V_42 ) ;
F_116 ( V_269 , NULL ) ;
...
static void F_129 ( struct V_281 * V_282 , const char * V_283 , unsigned int V_211 )
{
struct V_1 * V_2 = & V_253 [ V_282 -> V_284 ] ;
unsigned long V_30 ;
F_44 ( & V_2 -> V_42 . V_57 , V_30 ) ;
F_7 ( V_2 , V_6 , V_2 -> V_32 [ 1 ] & ~ V_9 ) ;
F_7 ( V_2 , V_15 , V_2 -> V_32 [ 5 ] | V_16 | V_119 | V_121 ) ;
F_130 ( & V_2 -> V_42 , V_283 , V_211 , F_128 ) ;
F_7 ( V_2 , V_6 , V_2 -> V_32 [ 1 ] ) ;
F_45 ( & V_2 -> V_42 . V_57 , V_30 ) ;
}
static int T_3 F_131 ( struct V_281 * V_285 , char * V_286 )
{
struct V_1 * V_2 ;
struct V_113 * V_42 ;
int V_161 = 38400 ;
...
F_71 ( V_150 ) ;
if ( V_286 )
F_134 ( V_286 , & V_161 , & V_63 , & V_287 , & V_288 ) ;
return F_135 ( V_42 , V_285 , V_161 , V_63 , V_287 , V_288 ) ;
}
