...
if ( ! V_12 )
return NULL ;
V_12 -> V_101 = F_75 ( & V_102 , 0 , 0 , V_103 ) ;
if ( V_12 -> V_101 < 0 )
goto V_104;
V_12 -> V_17 . V_105 =
( V_106 * 1024 ) / V_107 ;
V_12 -> V_17 . V_108 = 0 ;
V_12 -> V_17 . V_109 = V_110 ;
V_12 -> V_17 . V_111 = L_9 ;
V_12 -> V_94 = V_97 ;
V_98 = F_76 ( & V_12 -> V_17 ) ;
if ( V_98 )
...
goto V_112;
F_78 ( & V_12 -> V_17 . V_82 ,
V_113 , ( unsigned long ) V_12 ) ;
F_78 ( & V_12 -> V_63 , V_114 , ( unsigned long ) V_12 ) ;
F_17 ( & V_12 -> V_22 ) ;
F_17 ( & V_12 -> V_115 ) ;
F_17 ( & V_12 -> V_74 [ 0 ] ) ;
F_17 ( & V_12 -> V_74 [ 1 ] ) ;
...
struct V_11 * F_85 ( T_3 * V_118 , T_1 * V_75 )
{
return F_86 ( V_118 , V_75 , - 1 ) ;
}
struct V_11 *
F_86 ( T_3 * V_118 , T_1 * V_75 , int V_97 )
{
struct V_11 * V_119 , * V_12 ;
V_119 = F_73 ( V_103 , V_97 ) ;
if ( ! V_119 )
return NULL ;
V_12 = F_87 ( V_119 , V_118 , V_75 ) ;
if ( ! V_12 )
F_65 ( V_119 ) ;
return V_12 ;
}
struct V_11 *
F_87 ( struct V_11 * V_12 , T_3 * V_118 ,
T_1 * V_75 )
{
if ( ! V_12 )
return NULL ;
