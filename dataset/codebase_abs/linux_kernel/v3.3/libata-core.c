...
static void F_288 ( void * V_580 , T_7 V_616 )
{
...
int F_291 ( struct V_491 * V_430 , struct V_617 * V_618 )
{
int V_25 , V_180 ;
if ( ! ( V_430 -> V_42 & V_601 ) ) {
...
for ( V_25 = 0 ; V_25 < V_430 -> V_586 ; V_25 ++ )
V_430 -> V_587 [ V_25 ] -> V_31 = V_619 ++ ;
for ( V_25 = 0 ; V_25 < V_430 -> V_586 ; V_25 ++ ) {
V_180 = F_292 ( V_430 -> V_15 , V_430 -> V_587 [ V_25 ] ) ;
if ( V_180 ) {
goto V_620;
}
}
V_180 = F_293 ( V_430 , V_618 ) ;
if ( V_180 )
goto V_620;
F_294 ( V_430 ) ;
for ( V_25 = 0 ; V_25 < V_430 -> V_586 ; V_25 ++ ) {
...
V_620:
while ( -- V_25 >= 0 ) {
F_297 ( V_430 -> V_587 [ V_25 ] ) ;
}
return V_180 ;
}
int F_298 ( struct V_491 * V_430 , int V_621 ,
...
if ( ! V_621 ) {
F_87 ( V_622 ) ;
return F_291 ( V_430 , V_618 ) ;
}
V_180 = F_299 ( V_430 -> V_15 , V_621 , V_622 , V_623 ,
F_300 ( V_430 -> V_15 ) , V_430 ) ;
if ( V_180 )
return V_180 ;
for ( V_25 = 0 ; V_25 < V_430 -> V_586 ; V_25 ++ )
F_301 ( V_430 -> V_587 [ V_25 ] , L_156 , V_621 ) ;
V_180 = F_291 ( V_430 , V_618 ) ;
if ( V_180 )
F_302 ( V_430 -> V_15 , V_621 , V_430 ) ;
return V_180 ;
}
...
void F_307 ( struct V_491 * V_430 )
{
int V_25 ;
for ( V_25 = 0 ; V_25 < V_430 -> V_586 ; V_25 ++ )
F_303 ( V_430 -> V_587 [ V_25 ] ) ;
F_308 ( V_430 ) ;
}
void F_309 ( struct V_628 * V_629 )
{
struct V_21 * V_15 = & V_629 -> V_15 ;
struct V_491 * V_430 = F_262 ( V_15 ) ;
F_307 ( V_430 ) ;
}
int F_310 ( struct V_628 * V_629 , const struct V_630 * V_131 )
{
unsigned long V_354 = 0 ;
switch ( V_131 -> V_631 ) {
case 1 : {
T_2 V_632 = 0 ;
F_311 ( V_629 , V_131 -> V_531 , & V_632 ) ;
V_354 = V_632 ;
break;
}
case 2 : {
T_4 V_633 = 0 ;
F_312 ( V_629 , V_131 -> V_531 , & V_633 ) ;
V_354 = V_633 ;
break;
}
case 4 : {
T_1 V_634 = 0 ;
F_313 ( V_629 , V_131 -> V_531 , & V_634 ) ;
V_354 = V_634 ;
break;
}
default:
...
void F_314 ( struct V_628 * V_629 , T_6 V_535 )
{
F_315 ( V_629 ) ;
F_316 ( V_629 ) ;
...
int F_322 ( struct V_628 * V_629 , T_6 V_535 )
{
...
static int T_9 F_324 ( char * * V_451 ,
struct V_27 * V_638 ,
const char * * V_251 )
{
...
if ( V_147 ) {
* V_147 ++ = '\0' ;
V_638 -> V_21 = F_326 ( V_147 , & V_644 , 10 ) ;
if ( V_147 == V_644 || * V_644 != '\0' ) {
* V_251 = L_206 ;
return - V_117 ;
}
}
V_638 -> V_30 = F_326 ( V_142 , & V_644 , 10 ) ;
if ( V_147 == V_644 || * V_644 != '\0' ) {
* V_251 = L_207 ;
return - V_117 ;
}
...
F_328 ( V_267 L_214 V_657 L_215 ) ;
return 0 ;
V_260:
return V_180 ;
}
static void T_10 F_334 ( void )
{
F_335 ( V_656 ) ;
F_336 () ;
F_333 () ;
...
T_1 F_339 ( struct V_4 * V_5 , void T_11 * V_531 , T_1 V_358 , T_1 V_532 ,
...
static unsigned int F_341 ( struct V_192 * V_193 )
{
return V_212 ;
}
...
int F_343 ( const struct V_4 * V_5 , const char * V_663 ,
const char * V_664 , ... )
{
struct V_665 V_666 ;
T_12 args ;
...
V_666 . V_664 = V_664 ;
V_666 . V_668 = & args ;
V_667 = F_328 ( L_216 , V_663 , V_5 -> V_31 , & V_666 ) ;
va_end ( args ) ;
return V_667 ;
}
int F_344 ( const struct V_2 * V_3 , const char * V_663 ,
const char * V_664 , ... )
{
struct V_665 V_666 ;
T_12 args ;
...
int F_345 ( const struct V_14 * V_15 , const char * V_663 ,
const char * V_664 , ... )
{
struct V_665 V_666 ;
T_12 args ;
...
void F_346 ( const struct V_21 * V_15 , const char * V_669 )
{
F_347 ( V_267 , V_15 , L_218 , V_669 ) ;
}
