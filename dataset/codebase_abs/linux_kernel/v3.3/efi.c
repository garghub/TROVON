...
F_20 ( L_26 ) ;
for ( V_15 = 0 ; V_15 < F_8 ( V_29 -> V_31 ) && V_15 < V_20 -> V_67 - 1 ; V_15 ++ ) {
struct V_68 * V_69 ;
unsigned V_70 = 0 ;
unsigned V_71 ;
T_3 V_72 = F_16 ( V_36 [ V_15 ] . V_51 ) ;
T_3 V_73 = F_16 ( V_36 [ V_15 ] . V_52 ) -
F_16 ( V_36 [ V_15 ] . V_51 ) + 1ULL ;
if ( ! F_22 ( & V_36 [ V_15 ] , F_4 ( V_20 -> V_6 ) ) )
continue;
F_28 ( V_20 , V_15 + 1 , V_72 * V_35 , V_73 * V_35 ) ;
if ( ! F_23 ( V_36 [ V_15 ] . V_49 ,
V_74 ) )
V_20 -> V_75 [ V_15 + 1 ] . V_76 = V_77 ;
V_69 = & V_20 -> V_75 [ V_15 + 1 ] . V_69 ;
F_29 ( & V_36 [ V_15 ] . V_78 , V_66 ) ;
F_30 ( V_66 , V_69 -> V_79 ) ;
V_71 = F_31 ( sizeof( V_69 -> V_80 ) - 1 ,
sizeof( V_36 [ V_15 ] . V_81 ) ) ;
V_69 -> V_80 [ V_71 ] = 0 ;
while ( V_70 < V_71 ) {
T_6 V_82 = V_36 [ V_15 ] . V_81 [ V_70 ] & 0xff ;
if ( V_82 && ! isprint ( V_82 ) )
V_82 = '!' ;
V_69 -> V_80 [ V_70 ] = V_82 ;
V_70 ++ ;
}
V_20 -> V_75 [ V_15 + 1 ] . V_83 = true ;
}
F_17 ( V_36 ) ;
F_17 ( V_29 ) ;
F_32 ( V_20 -> V_84 , L_27 , V_85 ) ;
return 1 ;
}
