...
static void F_65 ( struct V_56 * V_57 )
{
F_45 ( V_57 -> V_2 , L_8
L_9 , V_57 -> V_86 ) ;
...
{
struct V_106 * V_107 = F_77 ( V_2 -> V_12 ) ;
...
{
V_2 -> V_22 . V_23 = F_90 ( V_24 , V_118 ) ;
if ( ! V_2 -> V_22 . V_23 )
goto exit;
V_2 -> V_120 = F_90 ( V_2 -> V_61 -> V_121 , V_118 ) ;
if ( ! V_2 -> V_120 )
goto exit;
V_2 -> V_119 = F_90 ( V_2 -> V_61 -> V_122 , V_118 ) ;
if ( ! V_2 -> V_119 )
goto exit;
return 0 ;
exit:
...
int F_107 ( struct V_106 * V_123 , T_4 V_134 )
{
struct V_125 * V_126 = F_105 ( V_123 ) ;
struct V_1 * V_2 = V_126 -> V_129 ;
return F_108 ( V_2 , V_134 ) ;
}
int F_109 ( struct V_106 * V_123 )
{
struct V_125 * V_126 = F_105 ( V_123 ) ;
struct V_1 * V_2 = V_126 -> V_129 ;
return F_110 ( V_2 ) ;
