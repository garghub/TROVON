...
for ( V_4 = 0 ; V_4 < V_3 -> V_8 ; V_4 ++ ) {
V_3 -> V_9 [ V_4 ] . V_10 = ( char * ) F_38 ( V_3 -> V_9 [ V_4 ] . V_10 ) ;
V_6 += V_3 -> V_9 [ V_4 ] . V_12 ;
}
V_7 = V_3 -> V_7 ;
if ( V_3 -> V_7 )
V_3 -> V_7 = (struct V_1 * ) F_38 ( V_3 -> V_7 ) ;
else
V_3 -> V_7 = NULL ;
...
if ( V_22 ) {
F_34 ( V_22 -> V_10 ) ;
F_41 ( V_22 -> V_37 , V_22 -> V_86 ) ;
}
}
static int F_42 ( const char * V_87 ,
T_3 V_70 ,
struct V_21 * V_22 )
{
int * V_29 ;
int V_64 ;
V_22 -> V_10 = F_43 ( V_70 , V_45 ) ;
if ( V_22 -> V_10 == NULL ) {
F_40 ( V_22 ) ;
return - V_46 ;
}
...
static struct V_21 * F_44 ( const char * V_88 ,
const struct V_89 * V_90 )
{
return F_45 ( V_88 , V_91 | V_92 , NULL , V_90 ) ;
}
