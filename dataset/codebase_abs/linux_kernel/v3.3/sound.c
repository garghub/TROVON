...
void * V_9 ,
const char * V_39 , struct V_40 * V_40 )
{
int V_3 ;
struct V_7 * V_41 ;
if ( F_18 ( ! V_39 ) )
return - V_31 ;
V_41 = F_21 ( sizeof *V_41 , V_42 ) ;
if ( V_41 == NULL )
return - V_43 ;
V_41 -> type = type ;
V_41 -> V_1 = V_1 ? V_1 -> V_32 : - 1 ;
V_41 -> V_40 = V_12 ;
V_41 -> V_24 = V_24 ;
V_41 -> V_9 = V_9 ;
F_7 ( & V_11 ) ;
...
V_10 [ V_3 ] = V_41 ;
V_41 -> V_12 = F_24 ( V_44 , V_40 , F_25 ( V_45 , V_3 ) ,
V_9 , L_4 , V_39 ) ;
if ( F_26 ( V_41 -> V_12 ) ) {
V_10 [ V_3 ] = NULL ;
F_8 ( & V_11 ) ;
...
F_7 ( & V_11 ) ;
V_3 = F_28 ( type , V_1 , V_12 ) ;
if ( V_3 >= 0 && ( V_50 = V_10 [ V_3 ] -> V_12 ) != NULL )
V_49 = F_32 ( V_50 , V_48 ) ;
F_8 ( & V_11 ) ;
return V_49 ;
}
...
static void F_34 ( struct V_51 * V_52 , struct V_53 * V_54 )
{
int V_3 ;
struct V_7 * V_18 ;
F_7 ( & V_11 ) ;
...
{
struct V_51 * V_52 ;
V_52 = F_37 ( V_55 , L_16 , NULL ) ;
if ( V_52 ) {
V_52 -> V_56 . V_57 . V_58 = F_34 ;
if ( F_38 ( V_52 ) < 0 ) {
F_39 ( V_52 ) ;
V_52 = NULL ;
}
