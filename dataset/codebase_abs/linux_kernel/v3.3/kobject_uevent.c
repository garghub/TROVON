...
int F_26 ( struct V_14 * V_15 , enum V_3 V_4 )
{
...
static int F_28 ( struct V_70 * V_70 )
{
struct V_38 * V_39 ;
V_39 = F_10 ( sizeof( * V_39 ) , V_45 ) ;
if ( ! V_39 )
return - V_46 ;
V_39 -> V_56 = F_29 ( V_70 , V_71 ,
1 , NULL , NULL , V_72 ) ;
if ( ! V_39 -> V_56 ) {
F_30 ( V_69
L_21 ) ;
...
static void F_32 ( struct V_70 * V_70 )
{
struct V_38 * V_39 ;
F_16 ( & V_55 ) ;
F_17 (ue_sk, &uevent_sock_list, list) {
if ( F_33 ( V_39 -> V_56 ) == V_70 )
goto V_76;
}
F_23 ( & V_55 ) ;
return;
