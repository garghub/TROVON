...
int F_53 ( struct V_1 * V_2 , enum V_116 V_117 )
{
if ( F_54 ( V_117 >= V_118 ) )
return - V_101 ;
return F_1 ( V_2 , V_14 + V_117 ) ;
}
...
V_78 = F_63 ( V_9 , V_31 -> V_141 , V_31 -> V_144 , V_31 -> V_143 ) ;
if ( V_78 ) {
F_61 ( V_2 -> V_99 , L_8 , V_78 ) ;
return - V_145 ;
}
return 0 ;
}
static int F_64 ( struct V_130 * V_146 ,
...
{
F_55 ( V_2 , V_123 ) ;
F_55 ( V_2 , V_2 -> V_115 . V_151 ) ;
return 0 ;
}
static int F_67 ( struct V_1 * V_2 )
{
struct V_30 * V_31 ;
struct V_152 * V_153 = F_68 ( V_2 -> V_99 ) ;
struct V_154 * V_155 = F_16 ( V_2 -> V_99 ,
struct V_154 , V_99 ) ;
int V_78 = 0 ;
V_31 = F_69 ( sizeof( struct V_30 ) , V_156 ) ;
if ( V_31 == NULL )
return - V_157 ;
F_70 ( V_2 , V_31 ) ;
V_31 -> V_2 = V_2 ;
V_2 -> V_10 = F_71 ( V_2 -> V_99 -> V_158 ) ;
V_2 -> V_159 = 1 ;
...
V_31 -> V_160 = F_72 ( V_155 , 0 ) ;
if ( V_31 -> V_160 < 0 ) {
F_61 ( V_2 -> V_99 , L_10 ) ;
V_78 = - V_101 ;
goto V_161;
}
V_31 -> V_67 = F_73 ( L_11 , 0 , 0 ) ;
if ( ! V_31 -> V_67 ) {
V_78 = - V_157 ;
goto V_161;
}
F_74 ( & V_31 -> V_89 . V_47 , F_36 ) ;
F_74 ( & V_31 -> V_33 . V_47 , F_15 ) ;
F_74 ( & V_31 -> V_44 . V_47 , F_20 ) ;
F_75 ( & V_31 -> V_85 ) ;
F_76 ( & V_31 -> V_33 . V_52 ) ;
F_76 ( & V_31 -> V_44 . V_52 ) ;
V_78 = F_77 ( V_31 -> V_160 , NULL , F_37 ,
0 , L_12 , V_2 ) ;
if ( V_78 ) {
F_61 ( V_2 -> V_99 , L_13 , V_78 ) ;
goto V_162;
}
F_8 ( V_2 ) ;
V_78 = F_55 ( V_2 , V_123 ) ;
...
static int T_4 F_82 ( struct V_154 * V_155 )
{
return F_83 ( & V_155 -> V_99 , & V_163 ,
V_164 , F_11 ( V_164 ) ) ;
}
static int T_5 F_84 ( struct V_154 * V_155 )
{
F_85 ( & V_155 -> V_99 ) ;
return 0 ;
}
