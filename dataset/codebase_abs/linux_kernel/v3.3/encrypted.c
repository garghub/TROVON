...
static struct V_57 * F_21 ( struct V_58 * V_59 )
{
struct V_57 * V_57 ;
int V_60 ;
V_60 = sizeof( struct V_61 ) + F_22 ( V_59 ) ;
V_57 = F_16 ( V_60 , V_45 ) ;
if ( ! V_57 )
return F_23 ( - V_62 ) ;
V_57 -> V_63 . V_2 = V_59 ;
...
static int F_24 ( T_3 * V_65 , const T_3 * V_47 , unsigned int V_66 ,
...
V_24 = F_25 ( V_69 , V_47 , V_66 ) ;
if ( ! V_24 )
V_24 = F_26 ( & V_57 -> V_63 , V_67 , V_68 , V_65 ) ;
F_27 ( V_57 ) ;
return V_24 ;
}
static int F_28 ( T_3 * V_65 , const T_3 * V_67 , unsigned int V_68 )
{
struct V_57 * V_57 ;
int V_24 ;
V_57 = F_21 ( V_71 ) ;
...
static int F_29 ( T_3 * V_73 , enum V_74 V_75 ,
...
V_49 ) ;
V_24 = F_28 ( V_73 , V_76 , V_77 ) ;
F_27 ( V_76 ) ;
return V_24 ;
}
static int F_31 ( struct V_79 * V_80 , const T_3 * V_47 ,
...
V_80 -> V_64 = 0 ;
V_24 = F_32 ( V_80 -> V_2 , V_47 , V_81 ) ;
if ( V_24 < 0 ) {
F_4 ( L_23 , V_24 ) ;
F_8 ( V_80 -> V_2 ) ;
return V_24 ;
}
F_33 ( V_80 -> V_2 , V_43 , V_5 ) ;
return 0 ;
}
...
char V_90 [ 16 ] ;
int V_24 ;
V_88 = F_38 ( V_39 -> V_21 , V_6 ) ;
V_89 = V_88 - V_39 -> V_21 ;
V_24 = F_31 ( & V_80 , V_73 , V_84 ,
V_39 -> V_43 , V_5 ) ;
if ( V_24 < 0 )
goto V_15;
F_39 ( V_39 ) ;
...
F_40 ( V_86 , 2 ) ;
F_41 ( & V_86 [ 0 ] , V_39 -> V_91 ,
V_39 -> V_21 ) ;
F_41 ( & V_86 [ 1 ] , V_90 , V_89 ) ;
F_40 ( V_87 , 1 ) ;
F_41 ( V_87 , V_39 -> V_92 , V_88 ) ;
V_24 = F_42 ( & V_80 , V_87 , V_86 , V_88 ) ;
F_8 ( V_80 . V_2 ) ;
if ( V_24 < 0 )
F_4 ( L_26 , V_24 ) ;
else
...
T_3 * V_65 ;
int V_24 ;
V_24 = F_29 ( V_73 , V_93 , V_48 , V_49 ) ;
if ( V_24 < 0 )
goto V_15;
V_65 = V_39 -> V_19 + V_39 -> V_94 ;
V_24 = F_24 ( V_65 , V_73 , sizeof V_73 ,
V_39 -> V_19 , V_39 -> V_94 ) ;
if ( ! V_24 )
F_45 ( NULL , V_65 , V_78 ) ;
V_15:
...
V_27 = V_39 -> V_19 ;
V_24 = F_24 ( V_65 , V_73 , sizeof V_73 , V_27 , V_44 ) ;
if ( V_24 < 0 )
goto V_15;
...
F_40 ( V_86 , 1 ) ;
F_40 ( V_87 , 2 ) ;
F_41 ( V_86 , V_39 -> V_92 , V_88 ) ;
F_41 ( & V_87 [ 0 ] , V_39 -> V_91 ,
V_39 -> V_21 ) ;
F_41 ( & V_87 [ 1 ] , V_90 , sizeof V_90 ) ;
V_24 = F_48 ( & V_80 , V_87 , V_86 , V_88 ) ;
F_8 ( V_80 . V_2 ) ;
if ( V_24 < 0 )
goto V_15;
F_39 ( V_39 ) ;
...
if ( V_24 < 0 )
return - V_10 ;
V_24 = F_53 ( V_39 -> V_92 , V_105 ,
V_88 ) ;
if ( V_24 < 0 )
return - V_10 ;
V_104 = V_39 -> V_19 + V_39 -> V_94 ;
V_24 = F_53 ( V_104 , V_105 + ( V_88 * 2 ) ,
V_78 ) ;
if ( V_24 < 0 )
return - V_10 ;
V_82 = F_34 ( V_39 , & V_48 , & V_49 ) ;
if ( F_3 ( V_82 ) )
return F_5 ( V_82 ) ;
...
V_24 = F_29 ( V_73 , V_107 , V_48 , V_49 ) ;
if ( V_24 < 0 )
goto V_15;
V_24 = F_47 ( V_39 , V_73 , sizeof V_73 ) ;
if ( V_24 < 0 )
F_4 ( L_32 , V_24 ) ;
V_15:
F_54 ( & V_82 -> V_54 ) ;
...
static int F_61 ( struct V_47 * V_47 , const void * V_56 ,
T_2 V_46 )
{
struct V_38 * V_39 = NULL ;
char * V_18 = NULL ;
...
V_24 = F_58 ( V_39 , V_47 -> V_110 , V_19 , V_20 ,
V_21 , V_22 ) ;
if ( V_24 < 0 ) {
F_27 ( V_39 ) ;
goto V_15;
...
{
struct V_38 * V_39 ;
V_39 = F_64 ( V_112 , struct V_38 , V_112 ) ;
memset ( V_39 -> V_91 , 0 , V_39 -> V_21 ) ;
F_27 ( V_39 ) ;
}
static int F_65 ( struct V_47 * V_47 , const void * V_56 , T_2 V_46 )
{
...
if ( V_24 < 0 )
goto V_15;
V_113 = F_49 ( V_47 , V_39 -> V_19 ,
V_114 , V_39 -> V_46 ) ;
if ( F_3 ( V_113 ) ) {
V_24 = F_5 ( V_113 ) ;
goto V_15;
}
F_56 ( V_113 , V_39 -> V_19 , V_114 ,
V_39 -> V_46 ) ;
memcpy ( V_113 -> V_43 , V_39 -> V_43 , V_5 ) ;
memcpy ( V_113 -> V_108 , V_39 -> V_108 ,
V_39 -> V_95 ) ;
F_62 ( V_47 , V_113 ) ;
F_66 ( & V_39 -> V_112 , F_63 ) ;
V_15:
F_27 ( V_67 ) ;
return V_24 ;
}
static long F_67 ( const struct V_47 * V_47 , char T_4 * V_115 ,
T_2 V_68 )
{
struct V_38 * V_39 ;
struct V_47 * V_82 ;
...
if ( V_24 < 0 )
goto V_15;
V_24 = F_37 ( V_39 , V_73 , sizeof V_73 ) ;
if ( V_24 < 0 )
goto V_15;
...
{
int V_24 ;
V_69 = F_74 ( V_70 , 0 , V_4 ) ;
if ( F_3 ( V_69 ) ) {
F_13 ( L_33 ,
V_70 ) ;
return F_5 ( V_69 ) ;
}
V_71 = F_74 ( V_72 , 0 , V_4 ) ;
if ( F_3 ( V_71 ) ) {
F_13 ( L_33 ,
V_72 ) ;
V_24 = F_5 ( V_71 ) ;
