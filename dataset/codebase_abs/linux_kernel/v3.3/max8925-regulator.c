...
static int F_12 ( struct V_6 * V_7 , int V_28 )
{
struct V_1 * V_2 = F_3 ( V_7 ) ;
unsigned char V_11 , V_12 ;
if ( V_28 < V_29 || V_28 > V_30 )
return - V_5 ;
V_11 = ( V_28 - V_29 + V_31 - 1 ) / V_31 ;
V_11 <<= V_32 ;
V_12 = 3 << V_32 ;
...
{
struct V_1 * V_2 = F_3 ( V_7 ) ;
return F_6 ( V_2 -> V_17 , V_2 -> V_18 , 1 << V_33 ,
1 << V_33 ) ;
}
static int F_14 ( struct V_6 * V_7 )
{
struct V_1 * V_2 = F_3 ( V_7 ) ;
return F_6 ( V_2 -> V_17 , V_2 -> V_18 , 1 << V_33 , 0 ) ;
}
static struct V_1 * T_1 F_15 ( int V_34 )
{
struct V_1 * V_35 ;
int V_36 ;
for ( V_36 = 0 ; V_36 < F_16 ( V_1 ) ; V_36 ++ ) {
V_35 = & V_1 [ V_36 ] ;
...
{
struct V_40 * V_13 = F_18 ( V_39 -> V_14 . V_41 ) ;
...
static int T_2 F_23 ( struct V_38 * V_39 )
{
struct V_6 * V_7 = F_24 ( V_39 ) ;
F_22 ( V_39 , NULL ) ;
F_25 ( V_7 ) ;
return 0 ;
}
