static int T_1 F_1 ( void T_2 * V_1 , T_3 * V_2 )
{
int V_3 = 1000 ;
...
static int T_1 F_4 ( void T_2 * V_1 )
{
T_3 V_2 ;
F_5 ( 1 , V_1 + V_7 ) ;
F_6 ( 10 ) ;
...
static int T_1 F_7 ( void T_2 * V_1 , T_3 V_10 )
{
int V_3 = 1000 ;
...
static int T_1 F_8 ( void T_2 * V_1 , T_3 * V_13 , T_3 * V_14 )
{
int V_15 ;
V_15 = F_7 ( V_1 , V_16 ) ;
if ( V_15 < 0 )
...
static int T_1 F_9 ( void T_2 * V_17 )
{
if ( ( F_2 ( V_17 + V_18 ) & 0x3f ) != V_19 )
return - V_9 ;
return 0 ;
}
static void F_10 ( void T_2 * V_17 , T_3 V_20 )
{
F_5 ( V_20 , V_17 + V_21 ) ;
}
static int T_1 F_11 ( struct V_22 * V_23 , unsigned int V_24 )
{
if ( ! V_25 [ V_24 ] )
return 0 ;
switch ( V_1 [ V_24 ] ) {
...
static int T_1 F_16 ( struct V_64 * V_65 , T_3 * type )
{
T_3 V_13 ;
T_3 V_14 ;
int V_15 ;
...
static int T_1 F_17 ( struct V_64 * V_65 , T_3 V_70 )
{
int V_15 ;
...
static void F_18 ( struct V_64 * V_65 , T_4 V_27 )
{
T_3 V_72 = F_2 ( V_65 -> V_73 + V_74 ) ;
int V_75 ;
...
static void T_1 F_20 ( struct V_64 * V_65 , T_4 V_27 )
{
int V_75 ;
for ( V_75 = V_76 ; V_75 ; V_75 -- ) {
T_3 V_72 = F_2 ( V_65 -> V_73 + V_75 - 1 ) ;
V_65 -> V_27 = ( V_65 -> V_27 << 8 ) | V_72 ;
}
V_27 |= V_65 -> V_27 & V_77 ;
F_18 ( V_65 , V_27 ) ;
}
static int T_1 F_21 ( struct V_64 * V_65 , T_3 V_20 )
{
int V_15 ;
V_15 = F_9 ( V_65 -> V_17 ) ;
if ( V_15 < 0 )
...
static int T_1 F_25 ( struct V_22 * V_23 , unsigned int V_24 )
{
struct V_64 * V_65 ;
struct V_85 * V_86 ;
struct V_79 * V_80 ;
...
static int T_5 F_42 ( struct V_22 * V_23 , unsigned int V_24 )
{
F_41 ( F_43 ( V_23 ) ) ;
F_40 ( V_23 , NULL ) ;
return 0 ;
