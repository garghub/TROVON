...
V_114 = 0xa0 ;
if ( V_19 -> V_48 [ V_113 ] . V_18 )
V_114 |= 0x03 ;
F_10 ( & V_19 -> V_1 , 0x13 , V_114 ) ;
return;
}
}
if ( V_19 -> V_48 [ V_113 ] . V_18 )
...
case V_64 :
V_116 = 0x0a ;
if ( V_19 -> V_48 [ V_118 ] . V_18 )
V_116 |= 0x80 ;
if ( V_19 -> V_48 [ V_117 ] . V_18 )
V_116 |= 0x40 ;
F_10 ( & V_19 -> V_1 , 0x1e , V_116 ) ;
break;
}
}
...
T_2 V_121 ;
V_121 = 0xdf ;
switch ( V_19 -> V_48 [ V_119 ] . V_18 ) {
case 0 :
F_10 ( V_1 , 0x13 , V_121 | 0x20 ) ;
break;
case 1 :
F_10 ( V_1 , 0x13 , V_121 ) ;
F_10 ( V_1 , 0x3b , 0x0a ) ;
...
{
struct V_19 * V_19 = (struct V_19 * ) V_1 ;
F_36 ( V_19 -> V_125 , V_19 -> V_50 ) ;
#if V_6 < 64
#error "No room enough in usb_buf for quantization table"
#endif
memcpy ( V_1 -> V_11 , & V_19 -> V_125 [ V_126 ] , 64 ) ;
F_4 ( V_1 -> V_7 ,
F_8 ( V_1 -> V_7 , 0 ) ,
0x08 ,
V_15 | V_9 | V_10 ,
...
V_1 -> V_11 , 64 ,
500 ) ;
memcpy ( V_1 -> V_11 , & V_19 -> V_125 [ V_127 ] , 64 ) ;
F_4 ( V_1 -> V_7 ,
F_8 ( V_1 -> V_7 , 0 ) ,
0x08 ,
V_15 | V_9 | V_10 ,
...
500 ) ;
V_19 -> V_128 ^= 0x40 ;
F_7 ( V_1 , 0x18 , V_19 -> V_128 ) ;
}
static void V_53 ( struct V_129 * V_52 )
{
struct V_19 * V_19 = F_37 ( V_52 , struct V_19 , V_52 ) ;
struct V_1 * V_1 = & V_19 -> V_1 ;
F_38 ( & V_1 -> V_130 ) ;
F_6 ( V_131 , L_28 , V_19 -> V_50 ) ;
F_35 ( V_1 ) ;
F_39 ( & V_1 -> V_130 ) ;
}
...
const T_2 * V_136 ;
int V_25 ;
static const T_2 V_137 [] =
{ 0x00 , 0x40 , 0x20 , 0x00 , 0x00 , 0x00 } ;
static const T_2 V_138 [] =
{ 0x00 , 0x40 , 0x38 , 0x30 , 0x00 , 0x20 } ;
static const T_2 V_139 [] = { 0x60 , 0x00 , 0x00 } ;
static const T_2 V_140 [] = { 0x2d , 0x2d , 0x3a , 0x05 , 0x04 , 0x3f } ;
static const T_2 V_141 [] = { 0x28 , 0xd8 , 0x14 , 0xec } ;
static const T_2 V_142 [] =
{ 0x14 , 0xec , 0x0a , 0xf6 } ;
static const T_2 V_143 [] =
{ 0x1e , 0xe2 , 0x14 , 0xec } ;
static const T_2 V_144 [] = { 0x32 , 0xdd , 0x2d , 0xdd } ;
...
{ 0x14 , 0xe7 , 0x1e , 0xdd } ;
F_41 ( V_19 -> V_125 , V_1 -> V_148 , V_1 -> V_149 ,
0x21 ) ;
V_54 = V_67 [ V_19 -> V_20 ] ;
V_132 = V_54 [ 1 ] ;
if ( V_19 -> V_42 & V_150 )
...
F_9 ( V_1 , 0x9a , V_136 , 6 ) ;
F_9 ( V_1 , 0xd4 , V_139 , sizeof V_139 ) ;
...
F_9 ( V_1 , 0x84 , V_160 , sizeof V_160 ) ;
switch ( V_19 -> V_20 ) {
case V_21 :
case V_120 :
case V_109 :
...
F_7 ( V_1 , 0x06 , 0x20 ) ;
V_135 = NULL ;
V_25 = V_1 -> V_33 . V_43 [ V_1 -> V_161 ] . V_162 ;
V_132 |= V_155 | V_163 ;
V_133 &= ~ V_154 ;
V_133 |= 0x02 ;
switch ( V_19 -> V_20 ) {
...
F_9 ( V_1 , 0xc0 , V_140 , 6 ) ;
switch ( V_19 -> V_20 ) {
case V_21 :
case V_23 :
case V_32 :
F_9 ( V_1 , 0xca , V_142 , 4 ) ;
break;
case V_64 :
F_9 ( V_1 , 0xca , V_143 , 4 ) ;
break;
default:
F_9 ( V_1 , 0xca , V_141 , 4 ) ;
break;
}
switch ( V_19 -> V_20 ) {
case V_21 :
...
break;
case V_23 :
F_9 ( V_1 , 0xce , V_145 , 4 ) ;
break;
case V_64 :
F_9 ( V_1 , 0xce , V_147 , 4 ) ;
break;
default:
F_9 ( V_1 , 0xce , V_144 , 4 ) ;
break;
}
V_19 -> V_128 = V_54 [ 0x18 ] | ( V_25 << 4 ) | 0x40 ;
F_7 ( V_1 , 0x18 , V_19 -> V_128 ) ;
F_35 ( V_1 ) ;
F_7 ( V_1 , 0x17 , V_133 ) ;
F_7 ( V_1 , 0x01 , V_132 ) ;
...
F_30 ( V_1 ) ;
F_34 ( V_1 ) ;
V_19 -> V_176 = V_19 -> V_47 = 0 ;
V_19 -> V_177 = V_19 -> V_178 = 0 ;
V_19 -> V_179 = F_43 ( V_180 ) ;
return V_1 -> V_5 ;
}
static void F_44 ( struct V_1 * V_1 )
{
struct V_19 * V_19 = (struct V_19 * ) V_1 ;
static const T_2 V_181 [] =
...
return;
V_19 -> V_49 = V_115 ;
V_105 = F_48 ( & V_19 -> V_189 ) ;
F_6 ( V_83 , L_29 , V_105 ) ;
if ( V_105 < V_187 - V_188 ||
V_105 > V_187 + V_188 ) {
switch ( V_19 -> V_20 ) {
case V_23 :
V_186 = V_19 -> V_89 ;
...
{
int V_189 ;
V_189 = ( V_13 [ 27 ] << 8 ) + V_13 [ 28 ]
+ ( V_13 [ 31 ] << 8 ) + V_13 [ 32 ]
+ ( V_13 [ 23 ] << 8 ) + V_13 [ 24 ]
+ ( V_13 [ 35 ] << 8 ) + V_13 [ 36 ]
+ ( V_13 [ 29 ] << 10 ) + ( V_13 [ 30 ] << 2 ) ;
V_189 >>= 10 ;
F_50 ( & V_19 -> V_189 , V_189 ) ;
}
...
F_52 ( V_1 , V_193 , V_13 , V_27 ) ;
if ( V_190 == 0 ) {
int V_198 ;
V_198 = ( V_19 -> V_176 * 100 ) /
( V_19 -> V_47 *
V_1 -> V_199 [ 0 ] -> V_200 [ 0 ] . V_201 ) ;
if ( V_198 >= 85 )
V_190 = - 3 ;
else if ( V_198 < 75 )
V_190 = 2 ;
...
switch ( V_210 -> V_212 ) {
case 0 :
strcpy ( ( char * ) V_210 -> V_213 , L_30 ) ;
return 0 ;
case 1 :
strcpy ( ( char * ) V_210 -> V_213 , L_31 ) ;
return 0 ;
case 2 :
strcpy ( ( char * ) V_210 -> V_213 , L_32 ) ;
return 0 ;
}
break;
}
...
int V_4 = - V_214 ;
if ( V_3 == 1 && V_13 [ 0 ] == 1 ) {
F_57 ( V_1 -> V_215 , V_216 , 1 ) ;
F_58 ( V_1 -> V_215 ) ;
F_57 ( V_1 -> V_215 , V_216 , 0 ) ;
F_58 ( V_1 -> V_215 ) ;
V_4 = 0 ;
}
return V_4 ;
}
static int F_59 ( struct V_217 * V_218 ,
const struct V_38 * V_39 )
{
return F_60 ( V_218 , V_39 , & V_219 , sizeof( struct V_19 ) ,
V_220 ) ;
}
