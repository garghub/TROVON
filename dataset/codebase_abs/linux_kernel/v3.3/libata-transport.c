...
static int F_30 ( struct V_27 * V_28 , void * V_29 )
{
...
{
struct V_22 * V_23 = F_34 ( V_2 ) ;
struct V_30 V_31 = { V_35 , 0 } ;
F_35 ( & V_23 -> V_41 , F_30 , & V_31 ) ;
return V_31 . V_34 ;
}
static T_1
F_36 ( struct V_1 * V_2 ,
...
static void F_41 ( struct V_22 * V_2 )
{
F_9 ( & V_2 -> V_12 ) ;
F_2 ( & V_2 -> V_12 ) ;
}
...
struct V_50 * F_42 ( void )
{
struct V_18 * V_19 ;
int V_51 ;
V_19 = F_43 ( sizeof( struct V_18 ) , V_52 ) ;
if ( ! V_19 )
return NULL ;
V_19 -> V_53 . V_54 = V_55 ;
V_19 -> V_53 . V_56 = V_57 ;
...
void F_49 ( struct V_50 * V_53 )
{
struct V_18 * V_19 = F_25 ( V_53 ) ;
F_50 ( & V_19 -> V_53 . V_8 ) ;
F_50 ( & V_19 -> V_20 ) ;
F_50 ( & V_19 -> V_48 ) ;
F_51 ( V_19 ) ;
