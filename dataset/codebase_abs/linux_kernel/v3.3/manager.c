...
int V_47 , V_17 ;
V_71 = F_32 () ;
V_72 = F_33 ( sizeof( struct V_1 ) * V_71 ,
V_73 ) ;
F_9 ( V_72 == NULL ) ;
...
F_46 (ovl1, &mgr->overlays, list) {
V_97 = V_93 [ V_95 -> V_65 ] ;
if ( V_97 == NULL )
continue;
F_46 (ovl2, &mgr->overlays, list) {
if ( V_95 == V_96 )
continue;
V_98 = V_93 [ V_96 -> V_65 ] ;
if ( V_98 == NULL )
...
F_46 (ovl, &mgr->overlays, list) {
struct V_92 * V_102 ;
int V_17 ;
V_102 = V_93 [ V_100 -> V_65 ] ;
if ( V_102 == NULL )
continue;
V_17 = F_48 ( V_100 , V_102 , V_8 ) ;
if ( V_17 )
return V_17 ;
}
return 0 ;
