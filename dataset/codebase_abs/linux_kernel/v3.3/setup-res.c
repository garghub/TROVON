...
static int F_15 ( struct V_11 * V_12 , struct V_1 * V_2 ,
int V_3 , T_2 V_37 )
{
struct V_11 * V_26 , * V_27 ;
T_2 V_15 , V_25 ;
...
static int F_16 ( struct V_1 * V_2 , int V_3 , int V_37 , T_2 V_48 )
{
struct V_11 * V_12 = V_2 -> V_11 + V_3 ;
struct V_35 * V_36 ;
int V_40 ;
char * type ;
V_36 = V_2 -> V_36 ;
while ( ( V_40 = F_13 ( V_36 , V_2 , V_3 , V_37 , V_48 ) ) ) {
...
F_10 ( & V_2 -> V_2 ,
L_14 ,
V_3 , type , ( unsigned long long ) F_17 ( V_12 ) ) ;
}
return V_40 ;
}
int F_18 ( struct V_1 * V_2 , int V_3 , T_2 V_53 ,
T_2 V_48 )
{
struct V_11 * V_12 = V_2 -> V_11 + V_3 ;
T_2 V_54 ;
...
V_54 = F_17 ( V_12 ) + V_53 + V_48 ;
V_40 = F_16 ( V_2 , V_3 , V_54 , V_48 ) ;
if ( ! V_40 ) {
V_12 -> V_13 &= ~ V_55 ;
...
V_36 = V_2 -> V_36 ;
V_37 = F_17 ( V_12 ) ;
V_40 = F_16 ( V_2 , V_3 , V_37 , V_38 ) ;
if ( V_40 < 0 && V_2 -> V_47 [ V_3 ] )
V_40 = F_15 ( V_12 , V_2 , V_3 , V_37 ) ;
if ( ! V_40 ) {
V_12 -> V_13 &= ~ V_55 ;
F_10 ( & V_2 -> V_2 , L_17 , V_3 , V_12 ) ;
if ( V_3 < V_56 )
...
void F_21 ( struct V_1 * V_2 , struct V_57 * V_58 )
{
int V_59 ;
...
if ( V_66 )
V_38 = F_20 ( V_66 -> V_2 , V_66 -> V_12 ) ;
if ( V_64 > V_38 ) {
V_63 = F_23 ( sizeof( * V_63 ) , V_67 ) ;
if ( ! V_63 )
F_24 ( L_21
L_22 ) ;
V_63 -> V_65 = V_66 ;
...
int F_25 ( struct V_1 * V_2 , int V_8 )
{
T_3 V_68 , V_69 ;
int V_59 ;
struct V_11 * V_61 ;
