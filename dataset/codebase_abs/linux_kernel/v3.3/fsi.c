...
struct V_11 * V_12 = F_17 ( V_17 ) ;
int V_34 = F_21 ( V_17 ) ;
F_65 ( V_12 , V_34 , V_22 -> V_56 ) ;
V_12 -> V_83 = 0 ;
}
static int F_68 ( struct V_16 * V_17 , int V_139 ,
struct V_15 * V_22 )
{
struct V_11 * V_12 = F_17 ( V_17 ) ;
int V_34 = F_21 ( V_17 ) ;
...
static int F_71 ( struct V_11 * V_12 , unsigned int V_142 )
{
T_1 V_2 = 0 ;
switch ( V_142 & V_143 ) {
case V_144 :
...
static int F_73 ( struct V_15 * V_22 , unsigned int V_142 )
{
...
static T_7 F_84 ( struct V_16 * V_17 )
{
struct V_11 * V_12 = F_17 ( V_17 ) ;
struct V_33 * V_45 = F_22 ( V_12 , F_21 ( V_17 ) ) ;
return F_25 ( V_12 , V_45 -> V_50 ) ;
}
...
V_172 = F_91 ( V_168 , V_174 , 0 ) ;
V_120 = F_92 ( V_168 , 0 ) ;
if ( ! V_172 || ( int ) V_120 <= 0 ) {
F_29 ( & V_168 -> V_56 , L_9 ) ;
V_7 = - V_173 ;
goto exit;
}
V_6 = F_93 ( sizeof( * V_6 ) , V_164 ) ;
if ( ! V_6 ) {
F_29 ( & V_168 -> V_56 , L_10 ) ;
V_7 = - V_175 ;
goto exit;
}
V_6 -> V_10 = F_94 ( V_172 -> V_66 , F_95 ( V_172 ) ) ;
if ( ! V_6 -> V_10 ) {
V_7 = - V_176 ;
F_29 ( & V_168 -> V_56 , L_11 ) ;
goto V_177;
}
V_6 -> V_120 = V_120 ;
V_6 -> V_26 = V_168 -> V_56 . V_178 ;
V_6 -> V_75 = (struct V_179 * ) V_170 -> V_180 ;
F_96 ( & V_6 -> V_9 ) ;
...
F_97 ( & V_168 -> V_56 ) ;
F_98 ( & V_168 -> V_56 , V_6 ) ;
V_7 = F_99 ( V_120 , & F_63 , 0 ,
V_170 -> V_181 , V_6 ) ;
if ( V_7 ) {
F_29 ( & V_168 -> V_56 , L_12 ) ;
goto V_182;
}
V_7 = F_100 ( & V_168 -> V_56 , & V_183 ) ;
if ( V_7 < 0 ) {
F_29 ( & V_168 -> V_56 , L_13 ) ;
goto V_184;
}
V_7 = F_101 ( & V_168 -> V_56 , V_185 ,
F_102 ( V_185 ) ) ;
if ( V_7 < 0 ) {
F_29 ( & V_168 -> V_56 , L_14 ) ;
goto V_186;
}
return V_7 ;
V_186:
...
{
struct V_5 * V_6 ;
V_6 = F_109 ( & V_168 -> V_56 ) ;
F_104 ( V_6 -> V_120 , V_6 ) ;
F_106 ( & V_168 -> V_56 ) ;
F_110 ( & V_168 -> V_56 , F_102 ( V_185 ) ) ;
F_103 ( & V_168 -> V_56 ) ;
F_105 ( V_6 -> V_10 ) ;
F_107 ( V_6 ) ;
return 0 ;
...
static int F_113 ( struct V_82 * V_56 )
{
struct V_5 * V_6 = F_109 ( V_56 ) ;
...
static int F_114 ( struct V_82 * V_56 )
{
struct V_5 * V_6 = F_109 ( V_56 ) ;
struct V_11 * V_24 = & V_6 -> V_24 ;
struct V_11 * V_25 = & V_6 -> V_25 ;
