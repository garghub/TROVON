...
static struct V_2 * * F_96 ( struct V_133 * V_134 , T_6 V_135 )
{
struct V_14 * V_14 = F_74 ( V_134 ) ;
unsigned V_6 ;
if ( ! F_12 ( V_14 , & V_144 ) )
...
static struct V_2 * * F_97 ( struct V_133 * V_134 , struct V_2 * * V_3 )
{
struct V_14 * V_14 = F_74 ( V_134 ) ;
unsigned V_6 ;
...
static void * F_98 ( struct V_133 * V_134 , T_6 * V_135 )
__acquires( V_151 )
{
F_24 ( & V_151 ) ;
return * V_135 ? F_96 ( V_134 , * V_135 - 1 ) : V_136 ;
}
static void * F_99 ( struct V_133 * V_134 , void * V_137 , T_6 * V_135 )
{
struct V_2 * * V_3 ;
if ( V_137 == V_136 )
V_3 = F_96 ( V_134 , 0 ) ;
else
V_3 = F_97 ( V_134 , V_137 ) ;
( * V_135 ) ++ ;
return V_3 ;
}
static void F_100 ( struct V_133 * V_134 , void * V_137 )
__releases( V_151 )
{
F_26 ( & V_151 ) ;
}
static int F_101 ( struct V_133 * V_134 , void * V_137 )
{
int V_35 ;
if ( V_137 == V_136 )
...
static int F_102 ( struct V_141 * V_141 , struct V_84 * V_84 )
{
