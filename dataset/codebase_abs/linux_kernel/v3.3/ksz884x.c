...
if ( F_226 ( V_414 ) && F_227 ( V_414 ) )
F_228 ( V_414 ) ;
}
}
static inline void F_229 ( struct V_419 * V_438 , struct V_419 * V_410 )
{
V_410 -> V_414 = V_438 -> V_414 ;
...
static T_7 F_231 ( struct V_419 * V_410 , struct V_420 * V_414 )
{
struct V_421 * V_422 = F_215 ( V_414 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
struct V_1 * V_2 = & V_259 -> V_2 ;
...
if ( V_442 < V_103 ||
( ( V_429 == V_410 -> V_428 ) &&
( V_445 == F_235 ( V_410 -> V_439 ) ) ) ) {
struct V_419 * V_443 = V_410 ;
V_410 = F_233 ( V_443 -> V_33 ) ;
if ( ! V_410 ) {
V_294 = V_444 ;
goto V_446;
}
...
static void F_239 ( struct V_420 * V_414 )
{
...
static inline void F_240 ( struct V_419 * V_410 )
{
...
static inline int F_243 ( struct V_420 * V_414 , struct V_1 * V_2 ,
...
V_410 -> V_439 = F_247 ( V_410 , V_414 ) ;
if ( V_2 -> V_209 & ( V_464 | V_319 ) )
F_240 ( V_410 ) ;
V_414 -> V_432 . V_465 ++ ;
V_414 -> V_432 . V_466 += V_459 ;
V_460 = F_248 ( V_410 ) ;
return 0 ;
}
...
{
T_1 V_483 = 0 ;
struct V_420 * V_414 = (struct V_420 * ) V_482 ;
struct V_421 * V_422 = F_215 ( V_414 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
struct V_1 * V_2 = & V_259 -> V_2 ;
F_11 ( V_2 , & V_483 ) ;
...
static void F_261 ( struct V_420 * V_414 )
{
struct V_421 * V_422 = F_215 ( V_414 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
F_3 ( & V_259 -> V_2 ) ;
F_258 ( V_414 -> V_481 , V_414 ) ;
}
...
static int F_263 ( struct V_420 * V_414 )
{
struct V_421 * V_422 = F_215 ( V_414 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
struct V_203 * V_66 = & V_422 -> V_66 ;
...
static int F_269 ( struct V_420 * V_414 )
{
struct V_421 * V_422 = F_215 ( V_414 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
struct V_1 * V_2 = & V_259 -> V_2 ;
int V_294 = 0 ;
V_259 -> V_414 = V_414 ;
V_294 = F_270 ( V_414 -> V_481 , F_258 , V_501 , V_414 -> V_502 , V_414 ) ;
if ( V_294 )
return V_294 ;
F_271 ( & V_259 -> V_478 ) ;
F_271 ( & V_259 -> V_485 ) ;
...
static void F_272 ( struct V_420 * V_414 , int V_503 )
{
struct V_421 * V_422 = F_215 ( V_414 ) ;
...
F_274 ( V_414 ) ;
F_275 ( V_422 , V_504 , V_414 , L_5 ,
V_503 == V_422 -> V_503 ? L_6 : L_7 ) ;
}
static int F_276 ( struct V_420 * V_414 )
{
struct V_421 * V_422 = F_215 ( V_414 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
struct V_1 * V_2 = & V_259 -> V_2 ;
...
V_422 -> V_381 = 0 ;
V_422 -> V_323 = 0 ;
memset ( & V_414 -> V_432 , 0 , sizeof( struct V_505 ) ) ;
...
static struct V_505 * F_278 ( struct V_420 * V_414 )
{
struct V_421 * V_422 = F_215 ( V_414 ) ;
struct V_203 * V_66 = & V_422 -> V_66 ;
...
int V_154 ;
int V_93 ;
V_414 -> V_432 . V_510 = V_66 -> V_85 [ V_474 ] ;
V_414 -> V_432 . V_511 = V_66 -> V_85 [ V_512 ] ;
V_414 -> V_432 . V_381 = 0 ;
V_414 -> V_432 . V_513 = 0 ;
V_414 -> V_432 . V_514 = 0 ;
V_414 -> V_432 . V_515 = 0 ;
...
V_81 = & V_2 -> V_82 [ V_93 ] ;
V_414 -> V_432 . V_381 += ( unsigned long )
V_81 -> V_85 [ V_518 ] ;
V_414 -> V_432 . V_513 += ( unsigned long )
V_81 -> V_85 [ V_519 ] ;
V_414 -> V_432 . V_514 += ( unsigned long ) (
V_81 -> V_85 [ V_520 ] +
V_81 -> V_85 [ V_521 ] +
V_81 -> V_85 [ V_522 ] +
V_81 -> V_85 [ V_523 ] ) ;
V_414 -> V_432 . V_515 += ( unsigned long )
V_81 -> V_85 [ V_524 ] ;
V_414 -> V_432 . V_516 += ( unsigned long ) (
V_81 -> V_85 [ V_525 ] +
V_81 -> V_85 [ V_526 ] ) ;
V_414 -> V_432 . V_517 += ( unsigned long )
V_81 -> V_85 [ V_527 ] ;
}
return & V_414 -> V_432 ;
}
static int F_279 ( struct V_420 * V_414 , void * V_32 )
{
struct V_421 * V_422 = F_215 ( V_414 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
struct V_1 * V_2 = & V_259 -> V_2 ;
...
memcpy ( V_414 -> V_493 , V_529 -> V_530 , V_531 ) ;
V_3 = F_13 ( V_2 ) ;
if ( V_422 -> V_66 . V_231 > 0 )
F_179 ( V_2 , V_414 -> V_493 ) ;
else
...
static void F_280 ( struct V_420 * V_414 , struct V_421 * V_422 ,
...
static void F_282 ( struct V_420 * V_414 )
{
struct V_421 * V_422 = F_215 ( V_414 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
struct V_1 * V_2 = & V_259 -> V_2 ;
struct V_535 * V_536 ;
int V_381 = ( V_414 -> V_537 & V_538 ) ;
F_280 ( V_414 , V_422 , V_2 , ( V_414 -> V_537 & V_539 ) ) ;
if ( V_259 -> V_2 . V_384 > 1 )
V_381 |= ( V_414 -> V_537 & V_540 ) ;
F_281 ( V_422 , V_2 , V_381 ) ;
if ( V_259 -> V_2 . V_384 > 1 )
return;
if ( ( V_414 -> V_537 & V_540 ) && ! F_283 ( V_414 ) ) {
int V_154 = 0 ;
if ( F_284 ( V_414 ) > V_541 ) {
if ( V_541 != V_2 -> V_379 ) {
V_2 -> V_379 = V_541 ;
++ V_2 -> V_321 ;
F_183 ( V_2 , V_2 -> V_321 ) ;
...
if ( V_154 >= V_541 )
break;
memcpy ( V_2 -> V_380 [ V_154 ++ ] , V_536 -> V_32 , V_280 ) ;
}
V_2 -> V_379 = ( T_4 ) V_154 ;
F_182 ( V_2 ) ;
} else {
...
static int F_286 ( struct V_420 * V_414 , int V_542 )
{
struct V_421 * V_422 = F_215 ( V_414 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
struct V_1 * V_2 = & V_259 -> V_2 ;
...
static int F_287 ( struct V_420 * V_414 , struct V_549 * V_550 , int V_551 )
{
struct V_421 * V_422 = F_215 ( V_414 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
struct V_1 * V_2 = & V_259 -> V_2 ;
...
int V_294 ;
int V_552 = 0 ;
struct V_553 * V_20 = F_288 ( V_550 ) ;
if ( F_289 ( & V_422 -> V_554 ) )
return - V_555 ;
V_294 = 0 ;
switch ( V_551 ) {
case V_556 :
V_20 -> V_557 = V_422 -> V_364 ;
case V_558 :
if ( V_20 -> V_557 != V_422 -> V_364 || V_20 -> V_559 >= 6 )
V_552 = - V_560 ;
else
F_120 ( V_2 , V_66 -> V_229 -> V_561 , V_20 -> V_559 ,
& V_20 -> V_562 ) ;
break;
case V_563 :
if ( ! F_290 ( V_564 ) )
V_552 = - V_565 ;
else if ( V_20 -> V_557 != V_422 -> V_364 || V_20 -> V_559 >= 6 )
V_552 = - V_560 ;
else
F_121 ( V_2 , V_66 -> V_229 -> V_561 , V_20 -> V_559 ,
V_20 -> V_566 ) ;
break;
default:
V_552 = - V_567 ;
...
static int F_292 ( struct V_420 * V_414 , int V_557 , int V_559 )
{
struct V_421 * V_422 = F_215 ( V_414 ) ;
struct V_203 * V_66 = & V_422 -> V_66 ;
struct V_1 * V_2 = V_66 -> V_2 ;
T_3 V_562 ;
F_120 ( V_2 , V_66 -> V_229 -> V_561 , V_559 << 1 , & V_562 ) ;
return V_562 ;
}
static void F_293 ( struct V_420 * V_414 , int V_557 , int V_559 , int V_185 )
{
struct V_421 * V_422 = F_215 ( V_414 ) ;
struct V_203 * V_66 = & V_422 -> V_66 ;
struct V_1 * V_2 = V_66 -> V_2 ;
...
F_121 ( V_2 , V_491 , V_559 << 1 , V_185 ) ;
}
static int F_294 ( struct V_420 * V_414 , struct V_568 * V_551 )
{
struct V_421 * V_422 = F_215 ( V_414 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
F_295 ( & V_259 -> V_569 ) ;
F_296 ( & V_422 -> V_570 , V_551 ) ;
V_551 -> V_571 |= V_572 ;
F_297 ( & V_259 -> V_569 ) ;
V_422 -> V_571 = V_551 -> V_571 ;
return 0 ;
}
static int F_298 ( struct V_420 * V_414 , struct V_568 * V_551 )
{
struct V_421 * V_422 = F_215 ( V_414 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
struct V_203 * V_66 = & V_422 -> V_66 ;
T_2 V_251 = F_299 ( V_551 ) ;
int V_294 ;
if ( V_551 -> V_573 && V_422 -> V_571 == V_551 -> V_571 ) {
V_551 -> V_571 |= V_574 ;
if ( 10 == V_251 )
V_551 -> V_571 &=
~ ( V_575 |
...
V_294 = F_300 ( & V_422 -> V_570 , V_551 ) ;
F_297 ( & V_259 -> V_569 ) ;
return V_294 ;
}
static int F_301 ( struct V_420 * V_414 )
{
struct V_421 * V_422 = F_215 ( V_414 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
int V_294 ;
F_295 ( & V_259 -> V_569 ) ;
V_294 = F_302 ( & V_422 -> V_570 ) ;
F_297 ( & V_259 -> V_569 ) ;
return V_294 ;
}
static T_2 F_303 ( struct V_420 * V_414 )
{
struct V_421 * V_422 = F_215 ( V_414 ) ;
int V_294 ;
V_294 = F_304 ( & V_422 -> V_570 ) ;
return V_294 ;
}
static void F_305 ( struct V_420 * V_414 ,
struct V_579 * V_26 )
{
struct V_421 * V_422 = F_215 ( V_414 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
F_306 ( V_26 -> V_580 , V_581 , sizeof( V_26 -> V_580 ) ) ;
F_306 ( V_26 -> V_582 , V_583 , sizeof( V_26 -> V_582 ) ) ;
F_306 ( V_26 -> V_584 , F_307 ( V_259 -> V_261 ) ,
sizeof( V_26 -> V_584 ) ) ;
}
static int F_308 ( struct V_420 * V_414 )
{
struct V_585 * V_586 = V_587 ;
int V_588 = 0x10 * sizeof( T_2 ) ;
while ( V_586 -> V_589 > V_586 -> V_590 ) {
V_588 += ( V_586 -> V_589 - V_586 -> V_590 + 3 ) / 4 * 4 ;
V_586 ++ ;
}
return V_588 ;
}
static void F_309 ( struct V_420 * V_414 , struct V_591 * V_592 ,
void * V_593 )
{
struct V_421 * V_422 = F_215 ( V_414 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
...
while ( V_586 -> V_589 > V_586 -> V_590 ) {
for ( V_33 = V_586 -> V_590 ; V_33 < V_586 -> V_589 ; V_33 += 4 ) {
...
static void F_311 ( struct V_420 * V_414 ,
struct V_594 * V_595 )
{
struct V_421 * V_422 = F_215 ( V_414 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
V_595 -> V_596 = V_259 -> V_597 ;
V_595 -> V_598 = V_259 -> V_282 ;
memset ( & V_595 -> V_599 , 0 , sizeof( V_595 -> V_599 ) ) ;
}
static int F_312 ( struct V_420 * V_414 ,
struct V_594 * V_595 )
{
struct V_421 * V_422 = F_215 ( V_414 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
static const T_4 V_283 [] = { 192 , 168 , 1 , 1 } ;
if ( V_595 -> V_598 & ~ V_259 -> V_597 )
return - V_545 ;
V_259 -> V_282 = V_595 -> V_598 ;
if ( V_595 -> V_598 )
V_259 -> V_282 |= V_600 ;
F_153 ( & V_259 -> V_2 , V_259 -> V_282 , V_283 ) ;
return 0 ;
}
static T_2 F_313 ( struct V_420 * V_414 )
{
struct V_421 * V_422 = F_215 ( V_414 ) ;
return V_422 -> V_601 ;
}
static void F_314 ( struct V_420 * V_414 , T_2 V_97 )
{
struct V_421 * V_422 = F_215 ( V_414 ) ;
V_422 -> V_601 = V_97 ;
}
...
static int F_316 ( struct V_420 * V_414 ,
struct V_603 * V_604 , T_4 * V_20 )
{
struct V_421 * V_422 = F_215 ( V_414 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
T_4 * V_605 = ( T_4 * ) V_606 ;
int V_154 ;
int V_33 ;
V_33 = ( V_604 -> V_89 + V_604 -> V_33 + 1 ) / 2 ;
for ( V_154 = V_604 -> V_89 / 2 ; V_154 < V_33 ; V_154 ++ )
V_606 [ V_154 ] = F_130 ( & V_259 -> V_2 , V_154 ) ;
V_604 -> V_607 = V_608 ;
memcpy ( V_20 , & V_605 [ V_604 -> V_89 ] , V_604 -> V_33 ) ;
return 0 ;
}
...
int V_154 ;
int V_33 ;
if ( V_604 -> V_607 != V_608 )
return - V_545 ;
V_33 = ( V_604 -> V_89 + V_604 -> V_33 + 1 ) / 2 ;
for ( V_154 = V_604 -> V_89 / 2 ; V_154 < V_33 ; V_154 ++ )
V_606 [ V_154 ] = F_130 ( & V_259 -> V_2 , V_154 ) ;
memcpy ( V_609 , V_606 , V_602 * 2 ) ;
memcpy ( & V_605 [ V_604 -> V_89 ] , V_20 , V_604 -> V_33 ) ;
for ( V_154 = 0 ; V_154 < V_602 ; V_154 ++ )
if ( V_609 [ V_154 ] != V_606 [ V_154 ] ) {
V_606 [ V_154 ] = V_609 [ V_154 ] ;
F_131 ( & V_259 -> V_2 , V_154 , V_606 [ V_154 ] ) ;
}
return 0 ;
}
...
struct V_258 * V_259 = V_422 -> V_397 ;
struct V_1 * V_2 = & V_259 -> V_2 ;
V_611 -> V_573 = ( V_2 -> V_122 & V_218 ) ? 0 : 1 ;
if ( ! V_2 -> V_104 ) {
V_611 -> V_612 =
( V_2 -> V_209 & V_211 ) ? 1 : 0 ;
V_611 -> V_613 =
...
static int F_319 ( struct V_420 * V_414 ,
struct V_610 * V_611 )
{
struct V_421 * V_422 = F_215 ( V_414 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
...
F_133 ( V_2 , V_611 -> V_612 , V_611 -> V_613 ) ;
}
F_297 ( & V_259 -> V_569 ) ;
return 0 ;
}
static void F_320 ( struct V_420 * V_414 ,
struct V_615 * V_27 )
{
struct V_421 * V_422 = F_215 ( V_414 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
struct V_1 * V_2 = & V_259 -> V_2 ;
V_27 -> V_616 = ( 1 << 9 ) ;
V_27 -> V_617 = V_2 -> V_347 . V_327 ;
V_27 -> V_618 = ( 1 << 9 ) ;
V_27 -> V_619 = V_2 -> V_400 . V_327 ;
}
static void F_321 ( struct V_420 * V_414 , T_2 V_620 , T_4 * V_24 )
{
struct V_421 * V_422 = F_215 ( V_414 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
struct V_1 * V_2 = & V_259 -> V_2 ;
...
static int F_322 ( struct V_420 * V_414 , int V_624 )
{
struct V_421 * V_422 = F_215 ( V_414 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
struct V_1 * V_2 = & V_259 -> V_2 ;
...
static void F_323 ( struct V_420 * V_414 ,
struct V_625 * V_432 , T_5 * V_20 )
{
struct V_421 * V_422 = F_215 ( V_414 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
struct V_1 * V_2 = & V_259 -> V_2 ;
struct V_203 * V_66 = & V_422 -> V_66 ;
int V_626 = V_432 -> V_626 ;
int V_154 ;
int V_627 ;
int V_93 ;
int V_294 ;
...
if ( V_627 < V_383 )
F_324 ( & V_259 -> V_496 ) ;
if ( 1 == V_66 -> V_507 && V_627 < V_383 ) {
V_93 = V_627 ;
V_294 = F_325 (
V_259 -> V_85 [ V_93 ] . V_85 ,
2 == V_259 -> V_85 [ V_93 ] . V_628 ,
V_497 * 1 ) ;
} else
for ( V_154 = 0 , V_93 = V_627 ; V_154 < V_66 -> V_507 - V_627 ; V_154 ++ , V_93 ++ ) {
if ( 0 == V_154 ) {
V_294 = F_325 (
V_259 -> V_85 [ V_93 ] . V_85 ,
2 == V_259 -> V_85 [ V_93 ] . V_628 ,
...
V_627 = V_626 ;
V_626 -= V_627 ;
for ( V_154 = 0 ; V_154 < V_627 ; V_154 ++ )
* V_20 ++ = V_85 [ V_154 ] ;
}
static int F_326 ( struct V_420 * V_414 ,
T_9 V_225 )
{
struct V_421 * V_422 = F_215 ( V_414 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
...
static void F_327 ( struct V_420 * V_414 , struct V_421 * V_422 ,
struct V_203 * V_66 )
{
...
static void F_328 ( struct V_630 * V_631 )
{
struct V_258 * V_259 =
F_141 ( V_631 , struct V_258 , V_496 ) ;
struct V_1 * V_2 = & V_259 -> V_2 ;
struct V_80 * V_81 ;
int V_154 ;
V_508 = V_393 ;
for ( V_154 = 0 ; V_154 < V_2 -> V_507 ; V_154 ++ ) {
V_81 = & V_2 -> V_82 [ V_154 ] ;
if ( V_81 -> V_84 || 1 == V_259 -> V_85 [ V_154 ] . V_628 ) {
if ( F_31 ( V_2 , V_154 ) )
break;
V_259 -> V_85 [ V_154 ] . V_628 = 0 ;
if ( 0 == V_81 -> V_84 ) {
V_259 -> V_85 [ V_154 ] . V_628 = 2 ;
F_329 (
& V_259 -> V_85 [ V_154 ] . V_85 ) ;
}
} else if ( V_393 >= V_259 -> V_85 [ V_154 ] . time ) {
if ( V_243 == V_81 -> V_162 )
V_259 -> V_85 [ V_154 ] . V_628 = 1 ;
...
static void F_330 ( unsigned long V_593 )
{
struct V_258 * V_259 = (struct V_258 * ) V_593 ;
F_328 ( & V_259 -> V_496 ) ;
if ( V_259 -> V_632 ) {
if ( V_259 -> V_632 <= V_393 ) {
F_143 ( & V_259 -> V_2 ) ;
V_259 -> V_632 = 0 ;
}
} else if ( F_140 ( & V_259 -> V_2 ) ) {
V_259 -> V_632 = V_393 + V_497 * 2 ;
}
F_194 ( & V_259 -> V_495 ) ;
}
static void F_331 ( unsigned long V_593 )
{
struct V_420 * V_414 = (struct V_420 * ) V_593 ;
struct V_421 * V_422 = F_215 ( V_414 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
struct V_1 * V_2 = & V_259 -> V_2 ;
struct V_203 * V_66 = & V_422 -> V_66 ;
if ( ! ( V_2 -> V_225 & V_488 ) )
F_136 ( V_66 ) ;
F_327 ( V_414 , V_422 , V_66 ) ;
F_194 ( & V_422 -> V_492 ) ;
}
static int T_10 F_332 ( struct V_420 * V_414 )
{
struct V_421 * V_422 = F_215 ( V_414 ) ;
F_191 ( & V_422 -> V_492 , 500 * V_497 / 1000 ,
F_331 , V_414 ) ;
V_414 -> V_449 = V_497 / 2 ;
V_414 -> V_633 = V_634 | V_635 | V_629 ;
V_414 -> V_633 |= V_636 ;
V_414 -> V_225 |= V_414 -> V_633 ;
F_333 ( & V_422 -> V_554 , 1 ) ;
V_422 -> V_570 . V_637 = 0x1 ;
V_422 -> V_570 . V_638 = 0x7 ;
V_422 -> V_570 . V_414 = V_414 ;
V_422 -> V_570 . F_292 = F_292 ;
V_422 -> V_570 . F_293 = F_293 ;
V_422 -> V_570 . V_557 = V_422 -> V_66 . V_231 + 1 ;
V_422 -> V_601 = F_334 ( V_601 ,
( V_639 | V_640 | V_641 ) ) ;
return 0 ;
}
static void F_335 ( struct V_420 * V_414 )
{
if ( V_414 -> V_449 )
F_336 ( V_414 ) ;
F_337 ( V_414 ) ;
}
static void F_338 ( struct V_258 * V_259 , T_4 * V_642 , int V_66 )
{
int V_154 ;
int V_373 ;
int V_643 ;
int V_103 ;
V_154 = V_373 = V_103 = V_643 = 0 ;
while ( V_373 < V_280 ) {
if ( V_642 [ V_154 ] ) {
int V_644 ;
V_643 = 1 ;
V_644 = F_339 ( V_642 [ V_154 ] ) ;
if ( V_644 >= 0 )
V_103 = V_103 * 16 + V_644 ;
else if ( ':' == V_642 [ V_154 ] )
V_643 = 2 ;
else
break;
...
V_259 -> V_2 . V_104 -> V_646 [ V_373 ++ ] =
( T_4 ) V_103 ;
V_259 -> V_2 . V_104 -> V_646 [ 5 ] +=
V_259 -> V_2 . V_364 ;
}
V_103 = V_643 = 0 ;
}
...
V_20 [ V_154 ] = F_130 ( V_2 , V_154 + V_647 ) ;
if ( ( V_20 [ 0 ] || V_20 [ 1 ] || V_20 [ 2 ] ) && V_20 [ 0 ] != 0xffff ) {
V_21 -> V_646 [ 5 ] = ( T_4 ) V_20 [ 0 ] ;
V_21 -> V_646 [ 4 ] = ( T_4 ) ( V_20 [ 0 ] >> 8 ) ;
V_21 -> V_646 [ 3 ] = ( T_4 ) V_20 [ 1 ] ;
V_21 -> V_646 [ 2 ] = ( T_4 ) ( V_20 [ 1 ] >> 8 ) ;
V_21 -> V_646 [ 1 ] = ( T_4 ) V_20 [ 2 ] ;
V_21 -> V_646 [ 0 ] = ( T_4 ) ( V_20 [ 2 ] >> 8 ) ;
}
}
static int T_11 F_341 ( struct V_260 * V_261 ,
const struct V_648 * V_364 )
{
struct V_420 * V_414 ;
struct V_421 * V_422 ;
struct V_258 * V_259 ;
...
V_650 = F_346 ( V_261 , 0 ) ;
V_651 = F_347 ( V_261 , 0 ) ;
if ( ( F_348 ( V_261 , 0 ) & V_656 ) != 0 )
return V_552 ;
if ( ! F_349 ( V_650 , V_651 , V_581 ) )
return V_552 ;
F_350 ( V_261 ) ;
V_552 = - V_463 ;
V_26 = F_196 ( sizeof( struct V_649 ) , V_396 ) ;
if ( ! V_26 )
goto V_657;
V_259 = & V_26 -> V_258 ;
V_259 -> V_261 = V_261 ;
V_2 = & V_259 -> V_2 ;
V_2 -> V_4 = F_351 ( V_650 , V_651 ) ;
if ( ! V_2 -> V_4 )
goto V_658;
V_67 = F_154 ( V_2 ) ;
if ( ! V_67 ) {
...
snprintf ( V_654 , sizeof( V_654 ) , L_9 , V_582 ) ;
V_654 [ 13 ] = V_67 + '0' ;
V_258 ( & V_259 -> V_261 -> V_414 , L_10 , V_654 ) ;
F_352 ( & V_259 -> V_261 -> V_414 , L_11 , V_2 -> V_4 , V_261 -> V_481 ) ;
V_2 -> V_384 = 1 ;
V_653 = 1 ;
V_652 = 1 ;
V_2 -> V_374 = 0 ;
...
V_2 -> V_662 = V_259 ;
V_259 -> V_411 = ( V_548 + 3 ) & ~ 3 ;
if ( F_207 ( V_259 ) )
goto V_663;
V_259 -> V_2 . V_364 = V_664 ;
F_353 ( & V_259 -> V_436 ) ;
F_354 ( & V_259 -> V_569 ) ;
F_355 ( & V_259 -> V_478 , F_253 ,
( unsigned long ) V_259 ) ;
F_355 ( & V_259 -> V_485 , F_256 ,
( unsigned long ) V_259 ) ;
F_266 ( & V_259 -> V_478 ) ;
F_266 ( & V_259 -> V_485 ) ;
for ( V_154 = 0 ; V_154 < V_106 ; V_154 ++ )
F_356 ( & V_259 -> V_85 [ V_154 ] . V_85 ) ;
if ( V_642 [ 0 ] != ':' )
F_338 ( V_259 , V_642 , V_645 ) ;
F_176 ( V_2 ) ;
if ( V_2 -> V_384 > 1 ) {
memcpy ( V_21 -> V_646 , V_2 -> V_281 , V_280 ) ;
F_340 ( V_2 ) ;
if ( V_665 [ 0 ] != ':' )
F_338 ( V_259 , V_665 , V_666 ) ;
}
F_156 ( V_2 ) ;
if ( V_2 -> V_104 )
F_186 ( V_2 ) ;
...
F_357 ( & V_259 -> V_496 , F_328 ) ;
F_191 ( & V_259 -> V_495 , 500 * V_497 / 1000 ,
F_330 , V_259 ) ;
for ( V_154 = 0 ; V_154 < V_2 -> V_384 ; V_154 ++ ) {
V_414 = F_358 ( sizeof( struct V_421 ) ) ;
if ( ! V_414 )
goto V_668;
V_26 -> V_669 [ V_154 ] = V_414 ;
V_422 = F_215 ( V_414 ) ;
V_422 -> V_397 = V_259 ;
V_422 -> V_364 = V_664 ++ ;
V_66 = & V_422 -> V_66 ;
...
for ( V_67 = 0 , V_491 = V_154 ; V_67 < V_653 ; V_67 ++ , V_491 ++ ) {
V_2 -> V_233 [ V_491 ] . V_561 = V_491 ;
V_2 -> V_233 [ V_491 ] . V_261 = V_414 ;
V_2 -> V_233 [ V_491 ] . V_162 = V_244 ;
}
V_414 -> V_670 = ( unsigned long ) V_2 -> V_4 ;
V_414 -> V_671 = V_414 -> V_670 + V_651 - 1 ;
V_414 -> V_481 = V_261 -> V_481 ;
if ( V_645 == V_154 )
memcpy ( V_414 -> V_493 , V_259 -> V_2 . V_281 ,
V_280 ) ;
else {
memcpy ( V_414 -> V_493 , V_21 -> V_646 , V_280 ) ;
if ( ! memcmp ( V_21 -> V_646 , V_2 -> V_281 ,
V_280 ) )
V_414 -> V_493 [ 5 ] += V_66 -> V_231 ;
}
V_414 -> V_672 = & V_672 ;
F_359 ( V_414 , & V_673 ) ;
if ( F_360 ( V_414 ) )
...
for ( V_154 = 0 ; V_154 < V_2 -> V_384 ; V_154 ++ ) {
if ( V_26 -> V_669 [ V_154 ] ) {
F_335 ( V_26 -> V_669 [ V_154 ] ) ;
V_26 -> V_669 [ V_154 ] = NULL ;
}
}
V_663:
F_212 ( V_259 ) ;
...
static void F_365 ( struct V_260 * V_261 )
{
int V_154 ;
struct V_649 * V_26 = F_366 ( V_261 ) ;
...
static int F_368 ( struct V_260 * V_261 )
{
int V_154 ;
struct V_649 * V_26 = F_366 ( V_261 ) ;
struct V_258 * V_259 = & V_26 -> V_258 ;
...
for ( V_154 = 0 ; V_154 < V_2 -> V_384 ; V_154 ++ ) {
if ( V_26 -> V_669 [ V_154 ] ) {
struct V_420 * V_414 = V_26 -> V_669 [ V_154 ] ;
if ( F_226 ( V_414 ) ) {
F_276 ( V_414 ) ;
F_372 ( V_414 ) ;
}
...
static int F_373 ( struct V_260 * V_261 , T_12 V_162 )
{
int V_154 ;
struct V_649 * V_26 = F_366 ( V_261 ) ;
struct V_258 * V_259 = & V_26 -> V_258 ;
...
F_375 ( V_261 ) ;
F_371 ( V_261 , F_376 ( V_261 , V_162 ) , 1 ) ;
F_369 ( V_261 , F_376 ( V_261 , V_162 ) ) ;
return 0 ;
}
static int T_10 F_377 ( void )
{
return F_378 ( & V_675 ) ;
}
static void T_13 F_379 ( void )
{
F_380 ( & V_675 ) ;
}
