...
#ifdef F_71
F_93 ( ! V_91 -> V_77 ) ;
F_93 ( ( unsigned long ) V_79 & ~ V_131 ) ;
#endif
F_93 ( ! V_4 ) ;
F_93 ( ( unsigned long ) V_4 & ~ V_131 ) ;
F_93 ( V_91 -> V_111 < V_123 ) ;
F_93 ( V_91 -> V_111 & ~ V_131 ) ;
F_93 ( V_91 -> V_111 < V_63 ) ;
F_93 ( V_91 -> V_113 < V_132 ) ;
F_93 ( F_94 ( V_91 ) < 0 ) ;
V_126 = F_95 ( V_91 -> V_89 * sizeof( V_126 [ 0 ] ) ) ;
V_127 = F_95 ( V_91 -> V_89 * sizeof( V_127 [ 0 ] ) ) ;
V_129 = F_95 ( V_133 * sizeof( V_129 [ 0 ] ) ) ;
V_128 = F_95 ( V_133 * sizeof( V_128 [ 0 ] ) ) ;
...
V_124 -> V_4 = V_4 ;
V_124 -> V_48 = V_120 ;
V_124 -> V_37 = F_98 ( V_120 ) ;
V_124 -> V_74 = true ;
F_99 ( V_124 -> V_27 , V_21 ) ;
if ( V_91 -> V_112 ) {
...
static int T_5 F_100 ( char * V_142 )
{
if ( 0 )
;
#ifdef F_101
...
V_123 = F_83 ( V_77 + V_112 +
F_104 ( T_2 , V_113 , V_132 ) ) ;
V_113 = V_123 - V_77 - V_112 ;
V_149 = F_104 ( T_2 , V_123 , V_63 ) ;
V_110 = F_105 ( V_149 , V_114 ) ;
V_108 = V_110 / V_149 ;
...
int V_160 = F_106 ( V_148 [ V_106 ] , V_108 ) ;
V_158 += V_160 ;
...
V_165 = F_83 ( V_91 -> V_89 * sizeof( void * ) ) ;
V_164 = F_82 ( V_165 ) ;
if ( ! V_164 ) {
V_167 = - V_45 ;
goto V_168;
...
F_54 ( L_23 ,
F_113 ( V_123 ) , V_80 , V_91 -> V_77 , V_91 -> V_112 ,
V_91 -> V_113 , V_91 -> V_111 ) ;
V_167 = F_91 ( V_91 , V_80 ) ;
goto V_168;
V_169:
for ( V_106 = 0 ; V_106 < V_91 -> V_89 ; V_106 ++ )
V_162 ( V_164 [ V_106 ] ,
...
F_111 ( V_30 ) ;
V_180 [ V_181 ++ ] = F_115 ( V_30 ) ;
}
V_176 . V_44 = V_183 ;
V_176 . V_7 = F_87 () * V_91 -> V_111 ;
F_116 ( & V_176 , V_28 ) ;
for ( V_94 = 0 ; V_94 < F_87 () ; V_94 ++ ) {
unsigned long V_184 =
...
V_167 = F_117 ( V_184 , & V_180 [ V_94 * V_178 ] ,
V_178 ) ;
if ( V_167 < 0 )
F_118 ( L_27 , V_167 ) ;
...
V_167 = F_91 ( V_91 , V_176 . V_1 ) ;
goto V_185;
V_182:
while ( -- V_181 >= 0 )
V_162 ( F_119 ( V_180 [ V_181 ] ) , V_28 ) ;
V_167 = - V_45 ;
V_185:
F_85 ( F_76 ( V_180 ) , V_179 ) ;
F_84 ( V_91 ) ;
return V_167 ;
}
...
T_2 V_53 )
{
return F_121 ( V_7 , V_53 , F_76 ( V_186 ) ) ;
}
...
void * V_191 ;
V_91 = F_80 ( 1 , 1 ) ;
V_191 = F_125 ( V_111 , V_28 , F_76 ( V_186 ) ) ;
if ( ! V_91 || ! V_191 )
F_118 ( L_30 ) ;
V_91 -> V_113 = V_111 ;
V_91 -> V_111 = V_111 ;
