...
if ( ! V_10 )
return - V_62 ;
if ( ! V_19 || V_19 != V_10 -> V_19 || ! V_19 -> V_191 )
return - V_18 ;
F_13 ( & V_10 -> V_38 , V_15 ) ;
V_10 -> V_19 = NULL ;
F_72 ( V_10 , V_19 ) ;
F_14 ( & V_10 -> V_38 , V_15 ) ;
V_19 -> V_191 ( & V_10 -> V_20 ) ;
V_10 -> V_20 . V_10 . V_19 = NULL ;
...
struct V_192 V_193 ;
int V_39 ;
V_193 . V_194 = F_9 ( & V_2 -> V_194 ) ;
V_193 . V_195 = F_9 ( & V_2 -> V_195 ) ;
V_193 . V_196 = F_75 ( ( F_9 ( & V_2 -> V_197 ) << 8 )
| F_9 ( & V_2 -> V_198 ) ) ;
V_193 . V_199 = F_75 ( ( F_9 ( & V_2 -> V_200 ) << 8 )
| F_9 ( & V_2 -> V_201 ) ) ;
V_193 . V_202 = F_75 ( ( F_9 ( & V_2 -> V_203 ) << 8 )
| F_9 ( & V_2 -> V_204 ) ) ;
F_2 ( 0 , & V_2 -> V_205 ) ;
F_19 ( & V_10 -> V_12 [ 0 ] , 0 ) ;
V_10 -> V_12 [ 0 ] . V_45 = 0 ;
if ( F_29 ( V_193 . V_194 & V_206 ) ) {
V_10 -> V_12 [ 0 ] . V_32 = 1 ;
V_10 -> V_63 = V_86 ;
F_2 ( V_207 , & V_10 -> V_2 -> V_208 ) ;
} else {
V_10 -> V_12 [ 0 ] . V_32 = 0 ;
V_10 -> V_63 = V_99 ;
switch ( V_193 . V_195 ) {
...
F_76 ( V_193 . V_196 ) , F_76 ( V_193 . V_199 ) ,
F_76 ( V_193 . V_202 ) ) ;
#endif
V_10 -> V_106 = ( V_193 . V_195 == V_216
&& V_193 . V_194 == V_214 ) ;
if ( F_38 ( V_10 -> V_106 ) )
V_10 -> V_107 = ( V_193 . V_196 != F_75 ( 0 ) ) ;
F_32 ( & V_10 -> V_38 ) ;
V_39 = V_10 -> V_19 -> V_189 ( & V_10 -> V_20 , & V_193 ) ;
F_33 ( & V_10 -> V_38 ) ;
if ( F_38 ( V_39 < 0 ) ) {
V_211:
#ifdef F_31
F_18 ( V_10 , L_112 ,
V_193 . V_194 , V_193 . V_195 , V_39 ) ;
#endif
F_1 ( V_2 , V_139 , 0 ) ;
V_10 -> V_12 [ 0 ] . V_45 = 1 ;
V_10 -> V_63 = V_137 ;
...
static T_7 F_77 ( int V_217 , void * V_149 )
{
struct V_9 * V_10 = V_149 ;
struct V_1 T_1 * V_2 = V_10 -> V_2 ;
struct V_11 * V_12 ;
T_2 V_218 , V_219 = 0 ;
unsigned V_150 , V_220 = 5 ;
F_33 ( & V_10 -> V_38 ) ;
V_221:
V_218 = F_9 ( & V_2 -> V_88 ) & V_10 -> V_47 ;
if ( ! V_218 )
goto F_27;
V_10 -> V_61 ++ ;
if ( F_38 ( V_218 & V_181 ) ) {
...
F_32 ( & V_10 -> V_38 ) ;
if ( V_218 )
F_12 ( V_10 , L_121 , V_218 ,
F_9 ( & V_2 -> V_88 ) , V_10 -> V_47 ) ;
return F_80 ( V_219 ) ;
}
static void F_81 ( struct V_232 * V_149 )
{
struct V_9 * V_10 = F_82 ( V_149 ) ;
F_26 ( V_10 ) ;
}
static void F_83 ( struct V_233 * V_75 )
{
...
static int F_97 ( struct V_233 * V_75 , const struct V_239 * V_240 )
{
...
if ( ! V_75 -> V_217 ) {
F_100 ( V_244 L_124 , F_99 ( V_75 ) ) ;
V_136 = - V_62 ;
goto V_245;
}
V_10 = F_21 ( sizeof *V_10 , V_246 ) ;
if ( V_10 == NULL ) {
...
F_102 ( & V_10 -> V_38 ) ;
V_10 -> V_75 = V_75 ;
V_10 -> V_20 . V_167 = & V_248 ;
V_10 -> V_20 . V_187 = V_182 ;
F_103 ( & V_10 -> V_20 . V_10 , L_126 ) ;
V_10 -> V_20 . V_10 . V_249 = & V_75 -> V_10 ;
V_10 -> V_20 . V_10 . V_250 = V_75 -> V_10 . V_250 ;
V_10 -> V_20 . V_10 . V_251 = F_81 ;
V_10 -> V_20 . V_37 = V_252 ;
V_136 = F_104 ( V_75 ) ;
if ( V_136 < 0 ) {
...
V_241 = F_92 ( V_75 , 0 ) ;
V_242 = F_93 ( V_75 , 0 ) ;
if ( ! F_105 ( V_241 , V_242 , V_252 ) ) {
F_12 ( V_10 , L_128 ) ;
V_136 = - V_30 ;
goto V_245;
}
V_10 -> V_236 = 1 ;
V_243 = F_106 ( V_241 , V_242 ) ;
if ( V_243 == NULL ) {
F_12 ( V_10 , L_129 ) ;
V_136 = - V_253 ;
goto V_245;
}
V_10 -> V_2 = (struct V_1 T_1 * ) V_243 ;
F_96 ( V_75 , V_10 ) ;
F_79 ( V_10 , L_106 , V_254 ) ;
F_79 ( V_10 , L_130 V_255 L_131 , F_60 () ) ;
F_79 ( V_10 , L_132 , V_75 -> V_217 , V_243 ) ;
F_67 ( V_10 ) ;
F_66 ( V_10 ) ;
if ( F_107 ( V_75 -> V_217 , F_77 , V_256 ,
V_252 , V_10 ) != 0 ) {
F_12 ( V_10 , L_133 , V_75 -> V_217 ) ;
V_136 = - V_30 ;
goto V_245;
}
V_10 -> V_235 = 1 ;
