...
static T_2 F_34 ( struct V_52 * V_52 , const char T_3 * V_57 ,
T_4 V_58 , T_5 * V_59 )
{
if ( V_58 ) {
if ( ! V_54 ) {
...
static long F_36 ( struct V_52 * V_52 , unsigned int V_63 ,
unsigned long V_64 )
{
int V_47 ;
int V_65 ;
...
switch ( V_63 ) {
case V_70 :
return F_37 ( V_69 . V_68 , & V_14 . V_68 ,
sizeof( V_14 . V_68 ) ) ? - V_62 : 0 ;
case V_71 :
V_47 = F_26 () ;
if ( V_47 < 0 )
return V_47 ;
return F_38 ( V_47 , V_69 . V_60 ) ;
case V_72 :
return F_38 ( 0 , V_69 . V_60 ) ;
case V_73 :
if ( F_35 ( V_65 , V_69 . V_60 ) )
return - V_62 ;
if ( V_65 & V_74 )
F_25 () ;
if ( V_65 & V_75 )
...
return 0 ;
case V_77 :
if ( F_35 ( V_66 , V_69 . V_60 ) )
return - V_62 ;
if ( F_16 ( V_66 ) )
return - V_13 ;
F_21 () ;
case V_78 :
return F_38 ( V_14 . V_11 , V_69 . V_60 ) ;
default:
return - V_79 ;
}
}
static int F_39 ( struct V_80 * V_81 , unsigned long V_82 ,
void * V_83 )
{
...
V_99 = V_102 ? V_102 : F_4 ( V_23 , V_103 ) ;
switch ( V_99 ) {
case V_104 :
V_14 . type = V_33 ;
break;
...
goto exit;
default:
F_12 (KERN_INFO DRVNAME L_12 ,
(unsigned int)devid) ;
V_19 = - V_40 ;
goto exit;
}
F_12 (KERN_INFO DRVNAME L_13 ,
...
{
static const unsigned short V_110 [] = { 0x2e , 0x4e } ;
int V_19 = - V_40 ;
int V_60 ;
for ( V_60 = 0 ; V_60 < F_48 ( V_110 ) ; V_60 ++ ) {
V_19 = F_45 ( V_110 [ V_60 ] ) ;
if ( V_19 == 0 )
break;
}
if ( V_60 == F_48 ( V_110 ) )
return V_19 ;
return F_40 ( V_110 [ V_60 ] ) ;
}
static void T_8 F_49 ( void )
{
if ( F_27 () ) {
F_12 (KERN_WARNING DRVNAME
L_14 ) ;
F_25 () ;
}
F_43 ( & V_95 ) ;
