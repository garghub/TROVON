...
static int F_40 ( struct V_87 * V_56 ,
struct V_39 * V_40 )
{
...
if ( ! V_89 || ! * V_89 )
return 0 ;
while ( ( V_90 = F_42 ( & V_89 , L_11 ) ) != NULL ) {
if ( ! * V_90 )
continue;
V_91 = V_90 ;
}
...
{
F_44 ( & V_2 -> V_92 . V_15 -> V_56 ) ;
}
static int F_45 ( struct V_93 * V_37 , struct V_14 * V_15 )
{
struct V_41 * V_42 ;
struct V_94 * V_54 = & V_15 -> V_54 ;
if ( V_15 -> V_56 . V_57 ) {
V_42 = V_15 -> V_56 . V_57 ;
F_46 ( V_42 ) ;
if ( V_42 -> V_86 . V_95 )
...
int V_97 = 32 ;
int V_13 ;
if ( F_51 ( V_2 ) || V_2 -> V_66 . V_98 <= ( 32 * 1024 * 1024 ) )
V_97 = 8 ;
V_15 = F_52 ( sizeof( struct V_14 ) , V_99 ) ;
if ( ! V_15 )
return - V_32 ;
V_15 -> V_2 = V_2 ;
V_2 -> V_92 . V_15 = V_15 ;
V_15 -> V_56 . V_100 = & V_101 ;
...
if ( ! V_2 -> V_92 . V_15 )
return;
F_45 ( V_2 -> V_53 , V_2 -> V_92 . V_15 ) ;
F_39 ( V_2 -> V_92 . V_15 ) ;
V_2 -> V_92 . V_15 = NULL ;
}
void F_57 ( struct V_1 * V_2 , int V_104 )
{
F_58 ( V_2 -> V_92 . V_15 -> V_56 . V_57 , V_104 ) ;
}
int F_59 ( struct V_1 * V_2 )
{
struct V_11 * V_105 ;
int V_22 = 0 ;
V_105 = F_4 ( V_2 -> V_92 . V_15 -> V_54 . V_96 ) ;
V_22 += F_29 ( V_105 ) ;
return V_22 ;
}
bool F_60 ( struct V_1 * V_2 , struct V_11 * V_105 )
{
if ( V_105 == F_4 ( V_2 -> V_92 . V_15 -> V_54 . V_96 ) )
return true ;
return false ;
}
