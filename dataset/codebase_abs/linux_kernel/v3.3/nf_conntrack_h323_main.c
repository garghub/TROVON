...
static int F_40 ( struct V_1 * V_2 , struct V_4 * V_5 ,
enum V_6 V_7 ,
unsigned char * * V_8 , int V_10 ,
T_10 * V_154 )
{
...
if ( ( V_154 -> V_68 & V_160 ) &&
( V_156 ) && V_5 -> V_60 & V_61 &&
F_31 ( V_5 , * V_8 , & V_154 -> V_161 ,
& V_32 , & V_33 ) &&
memcmp ( & V_32 , & V_5 -> V_52 [ ! V_15 ] . V_53 . V_54 . V_55 , sizeof( V_32 ) ) ) {
F_6 ( L_26 ,
& V_32 , F_12 ( V_33 ) , & V_5 -> V_52 [ ! V_15 ] . V_53 . V_54 . V_55 ,
F_12 ( V_5 -> V_52 [ ! V_15 ] . V_53 . V_54 . V_162 . V_163 . V_33 ) ) ;
...
if ( F_46 ( V_2 , V_5 , V_7 , & V_8 , V_10 , & V_189 ) < 0 )
goto V_119;
}
F_28 ( & V_117 ) ;
return V_116 ;
...
static struct V_48 * F_50 ( struct V_4 * V_5 ,
union V_31 * V_32 ,
T_2 V_33 )
{
struct V_207 * V_207 = F_51 ( V_5 ) ;
struct V_48 * exp ;
struct V_208 V_53 ;
...
exp = F_52 ( V_207 , F_53 ( V_5 ) , & V_53 ) ;
if ( exp && exp -> V_210 == V_5 )
return exp ;
return NULL ;
}
static int F_54 ( struct V_48 * exp ,
unsigned V_211 )
{
if ( ! exp || ! F_55 ( & exp -> V_211 ) )
return 0 ;
...
if ( F_31 ( V_5 , * V_8 , & V_30 [ V_155 ] , & V_32 , & V_33 ) &&
...
F_6 ( L_46
L_47 , V_12 -> V_211 ) ;
F_63 ( V_5 , V_2 , V_12 -> V_211 * V_214 ) ;
F_26 ( & V_236 ) ;
exp = F_50 ( V_5 , & V_5 -> V_52 [ V_15 ] . V_53 . V_57 . V_55 ,
V_12 -> V_218 [ ! V_15 ] ) ;
if ( exp ) {
F_6 ( L_48
L_49 ,
...
if ( F_71 ( V_2 , V_5 , V_7 , & V_8 , & V_247 ) < 0 )
goto V_119;
V_268:
F_28 ( & V_117 ) ;
return V_116 ;
