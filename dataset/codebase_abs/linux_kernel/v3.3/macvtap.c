...
V_164 = F_99 ( V_20 , 0 , V_140 , V_142 , V_89 ) ;
F_92 () ;
V_2 = F_93 ( V_4 -> V_2 ) ;
if ( V_2 )
F_100 ( V_2 , V_89 , V_164 == 0 , 0 ) ;
F_95 () ;
return V_164 ? V_164 : ( V_89 + V_142 ) ;
}
static T_5 F_101 ( struct V_3 * V_4 , struct V_156 * V_157 ,
...
struct V_19 * V_20 ;
T_5 V_164 = 0 ;
F_103 ( F_27 ( & V_4 -> V_17 ) , & V_69 ) ;
while ( V_89 ) {
V_62 -> V_71 = V_165 ;
V_20 = F_104 ( & V_4 -> V_17 . V_26 ) ;
if ( ! V_20 ) {
if ( V_91 ) {
V_164 = - V_40 ;
break;
...
static T_5 F_108 ( struct V_156 * V_157 , const struct V_94 * V_140 ,
unsigned long V_97 , T_6 V_158 )
{
struct V_10 * V_10 = V_157 -> V_159 ;
struct V_3 * V_4 = V_10 -> V_18 ;
...
V_164 = F_101 ( V_4 , V_157 , V_140 , V_89 , V_10 -> V_162 & V_163 ) ;
V_164 = F_73 ( T_5 , V_164 , V_89 ) ;
V_16:
return V_164 ;
}
static long F_109 ( struct V_10 * V_10 , unsigned int V_168 ,
unsigned long V_169 )
{
struct V_3 * V_4 = V_10 -> V_18 ;
struct V_1 * V_2 ;
...
return - V_161 ;
V_164 = 0 ;
if ( F_111 ( & V_172 -> V_180 , V_2 -> V_9 -> V_181 , V_182 ) ||
F_112 ( V_4 -> V_57 , & V_172 -> V_178 ) )
V_164 = - V_103 ;
F_60 ( V_2 -> V_9 ) ;
return V_164 ;
case V_183 :
if ( F_112 ( V_79 | V_78 | V_77 , V_173 ) )
return - V_103 ;
return 0 ;
case V_184 :
if ( F_110 ( V_174 , V_173 ) )
return - V_103 ;
V_4 -> V_17 . V_185 = V_174 ;
return 0 ;
case V_186 :
V_176 = V_4 -> V_80 ;
if ( F_112 ( V_176 , V_175 ) )
return - V_103 ;
return 0 ;
case V_187 :
if ( F_110 ( V_176 , V_175 ) )
return - V_103 ;
...
static long F_113 ( struct V_10 * V_10 , unsigned int V_168 ,
unsigned long V_169 )
{
return F_109 ( V_10 , V_168 , ( unsigned long ) F_114 ( V_169 ) ) ;
}
static int F_115 ( struct V_156 * V_157 , struct V_194 * V_53 ,
struct V_138 * V_139 , T_4 V_141 )
{
struct V_3 * V_4 = F_116 ( V_53 , struct V_3 , V_53 ) ;
return F_85 ( V_4 , V_139 , V_139 -> V_195 , V_141 , V_139 -> V_196 ,
V_139 -> V_197 & V_198 ) ;
}
static int F_117 ( struct V_156 * V_157 , struct V_194 * V_53 ,
struct V_138 * V_139 , T_4 V_141 ,
int V_57 )
{
struct V_3 * V_4 = F_116 ( V_53 , struct V_3 , V_53 ) ;
...
if ( V_57 & ~ ( V_198 | V_199 ) )
return - V_44 ;
V_164 = F_101 ( V_4 , V_157 , V_139 -> V_195 , V_141 ,
V_57 & V_198 ) ;
if ( V_164 > V_141 ) {
V_139 -> V_197 |= V_199 ;
...
struct V_194 * F_118 ( struct V_10 * V_10 )
{
struct V_3 * V_4 ;
if ( V_10 -> V_200 != & V_201 )
return F_119 ( - V_44 ) ;
...
static int F_120 ( struct V_203 * V_204 ,
...
if ( V_12 )
return F_121 ( V_12 ) ;
V_209 = F_122 ( F_123 ( V_214 ) , V_2 -> V_42 ) ;
V_208 = F_124 ( V_215 , & V_9 -> V_9 , V_209 ,
V_9 , L_2 , V_9 -> V_216 ) ;
if ( F_125 ( V_208 ) ) {
F_38 ( V_2 ) ;
return F_121 ( F_126 ( V_208 ) ) ;
}
break;
case V_217 :
V_209 = F_122 ( F_123 ( V_214 ) , V_2 -> V_42 ) ;
...
goto V_218;
F_130 ( & V_219 , & V_201 ) ;
V_12 = F_131 ( & V_219 , V_214 , V_41 ) ;
if ( V_12 )
goto V_220;
V_215 = F_132 ( V_221 , L_3 ) ;
if ( F_125 ( V_215 ) ) {
V_12 = F_126 ( V_215 ) ;
goto V_222;
}
