...
T_9 V_175 , struct V_176 * V_177 , int V_178 , unsigned long * V_179 )
{
T_10 V_180 ;
T_1 V_11 ;
int V_28 ;
...
T_9 V_175 , struct V_176 * V_177 , int V_178 ,
...
T_9 V_175 , struct V_176 * V_177 , int V_178 , unsigned long * V_201 ,
int * V_202 )
{
T_1 V_11 = 0 ;
if ( V_130 ) {
...
int type , T_7 V_220 , struct V_22 * V_217 )
{
...
char * V_218 , int V_219 , struct V_44 * V_45 ,
struct V_22 * V_217 , int V_239 , T_6 * V_242 ,
...
T_9 V_175 , T_12 V_138 , unsigned int V_290 )
{
struct V_291 * V_85 = V_288 ;
struct V_292 * V_293 = ( void * ) ( V_85 -> V_294 + V_85 -> V_295 ) ;
unsigned int V_296 ;
V_296 = F_144 ( sizeof( struct V_292 ) + V_289 , sizeof( T_12 ) ) ;
...
static T_1 F_145 ( struct V_130 * V_130 , T_13 V_299 ,
struct V_300 * V_301 , T_9 * V_302 )
{
struct V_291 V_85 ;
struct V_292 * V_293 ;
int V_28 ;
...
T_1
F_151 ( struct V_1 * V_2 , struct V_22 * V_23 , T_9 * V_302 ,
struct V_300 * V_301 , T_13 V_299 )
{
T_1 V_11 ;
struct V_130 * V_130 ;
T_9 V_175 = * V_302 ;
