...
return - V_14 ;
V_51 . V_52 = & V_47 -> V_53 ;
V_49 = F_21 ( V_47 , V_54 , 0 ) ;
if ( ! V_49 )
return - V_55 ;
V_6 . V_56 = F_22 ( V_49 -> V_57 , F_23 ( V_49 ) ) ;
if ( ! V_6 . V_56 ) {
F_24 ( & V_47 -> V_53 , L_3 ) ;
return - V_58 ;
}
V_50 = F_13 ( F_25 ( V_59 * 1000 ) ) ;
if ( V_50 )
return V_50 ;
V_50 = F_26 ( & V_51 ) ;
if ( V_50 )
...
F_27 ( & V_6 . V_10 , F_3 , 0 ) ;
F_5 ( & V_6 . V_10 , V_5 + V_11 ) ;
F_6 (KERN_INFO DRV_NAME L_4 ,
heartbeat, nowayout) ;
return 0 ;
}
static int T_6 F_28 ( struct V_46 * V_47 )
{
int V_50 ;
V_50 = F_29 ( & V_51 ) ;
if ( ! V_50 )
