...
void F_108 ( struct V_1 * V_2 , int V_92 , int V_227 )
{
struct V_35 * V_36 ;
F_106 (sdev, shost) {
if ( V_92 == F_107 ( V_36 ) &&
...
int
F_111 ( struct V_35 * V_228 , int V_229 )
{
struct V_11 * V_12 ;
struct V_1 * V_2 = V_228 -> V_15 ;
struct V_22 V_23 ;
unsigned long V_6 ;
int V_25 ;
if ( F_104 ( V_2 ) < 0 )
return V_49 ;
V_12 = F_112 ( V_228 , V_207 ) ;
F_113 ( NULL , & V_23 ) ;
V_12 -> V_22 = & V_23 ;
...
int F_115 ( const T_1 * V_57 , int V_236 ,
struct V_47 * V_48 )
{
if ( ! V_57 || ! V_236 )
return 0 ;
...
const T_1 * F_117 ( const T_1 * V_57 , int V_236 ,
int V_237 )
{
int V_238 , V_239 , V_240 , V_241 ;
const T_1 * V_242 ;
if ( ( V_236 < 8 ) || ( 0 == ( V_238 = V_57 [ 7 ] ) ) )
return NULL ;
...
V_238 : ( V_236 - 8 ) ;
V_242 = & V_57 [ 8 ] ;
for ( V_240 = 0 , V_241 = 0 ; V_241 < V_238 ; V_241 += V_240 ) {
V_242 += V_240 ;
V_239 = ( V_241 < ( V_238 - 1 ) ) ? V_242 [ 1 ] : - 1 ;
V_240 = V_239 + 2 ;
if ( V_242 [ 0 ] == V_237 )
return V_242 ;
if ( V_239 < 0 )
...
int F_118 ( const T_1 * V_57 , int V_236 ,
T_2 * V_243 )
{
int V_244 ;
const T_1 * V_245 ;
...
case 0x72 :
case 0x73 :
V_245 = F_117 ( V_57 , V_236 ,
0 ) ;
if ( V_245 && ( 0xa == V_245 [ 1 ] ) ) {
V_246 = 0 ;
for ( V_244 = 0 ; V_244 < 8 ; ++ V_244 ) {
if ( V_244 > 0 )
V_246 <<= 8 ;
V_246 |= V_245 [ 4 + V_244 ] ;
}
...
void F_119 ( int V_247 , T_1 * V_248 , T_1 V_249 , T_1 V_64 , T_1 V_68 )
{
if ( V_247 ) {
V_248 [ 0 ] = 0x72 ;
V_248 [ 1 ] = V_249 ;
