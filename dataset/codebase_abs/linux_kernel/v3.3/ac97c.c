...
F_34 ( V_3 , V_65 , V_165 | V_162 ) ;
F_62 ( 2 ) ;
F_34 ( V_3 , V_65 , V_162 ) ;
}
}
static int T_4 F_68 ( struct V_166 * V_20 )
{
struct V_167 * V_130 ;
struct V_2 * V_3 ;
struct V_168 * V_69 ;
...
if ( F_21 () ) {
V_172 = F_71 ( & V_20 -> V_21 , L_20 ) ;
} else {
V_172 = F_71 ( & V_20 -> V_21 , L_21 ) ;
}
if ( F_8 ( V_172 ) ) {
F_5 ( & V_20 -> V_21 , L_22 ) ;
return F_9 ( V_172 ) ;
...
F_72 ( V_172 ) ;
V_44 = F_73 ( V_179 , V_180 ,
V_181 , sizeof( struct V_2 ) , & V_130 ) ;
if ( V_44 ) {
F_5 ( & V_20 -> V_21 , L_23 ) ;
goto V_182;
}
...
V_3 -> V_172 = V_172 ;
V_3 -> V_20 = V_20 ;
V_3 -> V_69 = F_76 ( V_69 -> V_187 , F_77 ( V_69 ) ) ;
if ( ! V_3 -> V_69 ) {
F_5 ( & V_20 -> V_21 , L_28 ) ;
goto V_188;
}
if ( F_66 ( V_170 -> V_164 ) ) {
if ( F_78 ( V_170 -> V_164 , L_29 ) ) {
F_5 ( & V_20 -> V_21 , L_30 ) ;
V_3 -> V_164 = - V_189 ;
} else {
F_79 ( V_170 -> V_164 , 1 ) ;
...
if ( F_21 () ) {
if ( V_170 -> V_191 . V_159 ) {
struct V_157 * V_158 = & V_170 -> V_191 ;
T_5 V_192 ;
V_158 -> V_193 = V_69 -> V_187 + V_194 + 2 ;
F_82 ( V_192 ) ;
F_83 ( V_195 , V_192 ) ;
V_3 -> V_24 . V_26 = F_84 ( V_192 , F_64 ,
V_158 ) ;
F_50 ( & V_3 -> V_20 -> V_21 , L_33 ,
F_85 ( & V_3 -> V_24 . V_26 -> V_21 -> V_160 ) ) ;
F_10 ( V_126 , & V_3 -> V_30 ) ;
}
if ( V_170 -> V_196 . V_159 ) {
struct V_157 * V_158 = & V_170 -> V_196 ;
T_5 V_192 ;
V_158 -> V_197 = V_69 -> V_187 + V_198 + 2 ;
F_82 ( V_192 ) ;
F_83 ( V_195 , V_192 ) ;
V_3 -> V_24 . V_25 = F_84 ( V_192 , F_64 ,
V_158 ) ;
...
static int F_96 ( struct V_166 * V_20 , T_6 V_200 )
{
struct V_167 * V_130 = F_97 ( V_20 ) ;
...
static int F_98 ( struct V_166 * V_20 )
{
struct V_167 * V_130 = F_97 ( V_20 ) ;
struct V_2 * V_3 = V_130 -> V_141 ;
F_72 ( V_3 -> V_172 ) ;
...
static int T_7 F_99 ( struct V_166 * V_20 )
{
struct V_167 * V_130 = F_97 ( V_20 ) ;
