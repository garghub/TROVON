...
static void F_15 ( struct V_3 * V_4 , int V_36 , void * V_37 ,
T_3 V_19 )
{
struct V_12 V_13 [ 3 ] ;
struct V_14 V_15 ;
...
static int F_21 ( struct V_3 * V_4 , bool V_48 )
{
if ( V_4 -> V_49 )
V_4 -> V_49 ( V_48 ) ;
return 0 ;
}
static int T_5 F_22 ( struct V_9 * V_50 )
{
struct V_51 * V_52 ;
struct V_53 * V_6 ;
struct V_3 * V_4 ;
...
V_4 -> V_63 = V_52 -> V_63 ;
V_54 = F_29 ( V_4 -> V_1 , F_1 , 0 , V_64 , V_4 ) ;
if ( V_54 < 0 ) {
F_7 ( L_14 , V_54 ) ;
goto V_62;
}
...
static int T_6 F_34 ( struct V_9 * V_50 )
{
struct V_3 * V_4 = F_35 ( & V_50 -> V_55 ) ;
F_32 ( V_4 -> V_1 , V_4 ) ;
F_36 ( V_4 ) ;
return 0 ;
}
