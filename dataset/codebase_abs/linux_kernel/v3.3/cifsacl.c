...
if ( V_160 > V_171 / sizeof( struct V_147 * ) )
return;
...
& V_82 -> V_164 ,
& V_169 ) ;
if ( F_22 ( & ( V_163 [ V_49 ] -> V_56 ) , & V_173 ) == 0 )
F_58 ( V_163 [ V_49 ] -> V_152 ,
V_163 [ V_49 ] -> type ,
& V_82 -> V_164 ,
& V_169 ) ;
...
static int F_67 ( struct V_156 * V_174 , struct V_47 * V_158 ,
struct V_47 * V_159 , T_8 V_149 )
{
T_9 V_151 = 0 ;
struct V_156 * V_175 ;
V_175 = (struct V_156 * ) ( ( char * ) V_174 + sizeof( struct V_156 ) ) ;
V_151 += F_61 ( (struct V_147 * ) ( ( char * ) V_175 + V_151 ) ,
V_158 , V_149 , V_166 ) ;
V_151 += F_61 ( (struct V_147 * ) ( ( char * ) V_175 + V_151 ) ,
V_159 , V_149 , V_168 ) ;
V_151 += F_61 ( (struct V_147 * ) ( ( char * ) V_175 + V_151 ) ,
& V_172 , V_149 , V_170 ) ;
V_174 -> V_151 = F_62 ( V_151 + sizeof( struct V_156 ) ) ;
V_174 -> V_160 = F_57 ( 3 ) ;
return 0 ;
}
...
struct V_111 * V_112 , int V_176 , struct V_81 * V_82 )
{
int V_55 = 0 ;
struct V_47 * V_115 , * V_116 ;
struct V_156 * V_177 ;
char * V_155 = ( ( char * ) V_112 ) + V_176 ;
T_4 V_119 ;
if ( V_112 == NULL )
return - V_178 ;
V_115 = (struct V_47 * ) ( ( char * ) V_112 +
...
V_177 = (struct V_156 * ) ( ( char * ) V_112 + V_119 ) ;
F_34 ( V_140 , L_33
L_34 ,
...
T_4 V_179 , T_8 V_149 , T_10 V_180 , T_11 V_181 , int * V_182 )
{
int V_55 = 0 ;
T_4 V_119 ;
T_4 V_183 ;
...
V_119 = F_20 ( V_112 -> V_119 ) ;
V_177 = (struct V_156 * ) ( ( char * ) V_112 + V_119 ) ;
V_183 = sizeof( struct V_111 ) ;
V_184 = (struct V_156 * ) ( ( char * ) V_113 + V_183 ) ;
V_184 -> V_51 = V_177 -> V_51 ;
V_184 -> V_151 = 0 ;
V_184 -> V_160 = 0 ;
V_55 = F_67 ( V_184 , V_115 , V_116 ,
V_149 ) ;
V_114 = V_183 + F_64 ( V_184 -> V_151 ) ;
F_56 ( V_112 , V_113 , V_114 ) ;
* V_182 = V_186 ;
} else {
memcpy ( V_113 , V_112 , V_179 ) ;
if ( V_180 != V_187 ) {
...
T_7 V_190 , T_12 * V_191 )
{
struct V_111 * V_112 = NULL ;
int V_192 , V_55 ;
struct V_193 * V_194 = F_72 ( V_79 ) ;
if ( F_33 ( V_194 ) )
return F_73 ( V_194 ) ;
V_192 = F_74 () ;
V_55 = F_75 ( V_192 , F_76 ( V_194 ) , V_190 , & V_112 , V_191 ) ;
F_77 ( V_192 ) ;
F_78 ( V_194 ) ;
F_34 ( 1 , L_42 , V_76 , V_55 , * V_191 ) ;
if ( V_55 )
return F_79 ( V_55 ) ;
return V_112 ;
}
static struct V_111 * F_80 ( struct V_78 * V_79 ,
const char * V_195 , T_12 * V_191 )
{
struct V_111 * V_112 = NULL ;
int V_196 = 0 ;
int V_192 , V_55 , V_197 = 0 ;
T_7 V_190 ;
struct V_198 * V_199 ;
struct V_193 * V_194 = F_72 ( V_79 ) ;
if ( F_33 ( V_194 ) )
...
if ( F_81 ( V_79 ) )
V_197 |= V_200 ;
V_55 = F_82 ( V_192 , V_199 , V_195 , V_201 , V_202 ,
V_197 , & V_190 , & V_196 , NULL , V_79 -> V_203 ,
V_79 -> V_204 & V_205 ) ;
if ( ! V_55 ) {
V_55 = F_75 ( V_192 , V_199 , V_190 , & V_112 , V_191 ) ;
F_83 ( V_192 , V_199 , V_190 ) ;
}
F_78 ( V_194 ) ;
F_77 ( V_192 ) ;
F_34 ( 1 , L_42 , V_76 , V_55 , * V_191 ) ;
...
struct V_206 * V_206 , const char * V_195 ,
T_12 * V_191 )
{
struct V_111 * V_112 = NULL ;
struct V_207 * V_208 = NULL ;
if ( V_206 )
V_208 = F_85 ( F_86 ( V_206 ) , true ) ;
if ( ! V_208 )
return F_80 ( V_79 , V_195 , V_191 ) ;
V_112 = F_71 ( V_79 , V_208 -> V_209 , V_191 ) ;
F_87 ( V_208 ) ;
return V_112 ;
}
int F_88 ( struct V_111 * V_113 , T_4 V_210 ,
struct V_206 * V_206 , const char * V_195 , int V_182 )
{
int V_196 = 0 ;
int V_192 , V_55 , V_211 , V_197 = 0 ;
T_7 V_190 ;
struct V_198 * V_199 ;
struct V_78 * V_79 = F_89 ( V_206 -> V_212 ) ;
struct V_193 * V_194 = F_72 ( V_79 ) ;
if ( F_33 ( V_194 ) )
return F_44 ( V_194 ) ;
V_199 = F_76 ( V_194 ) ;
...
if ( F_81 ( V_79 ) )
V_197 |= V_200 ;
if ( V_182 == V_188 || V_182 == V_189 )
V_211 = V_213 ;
else
V_211 = V_214 ;
V_55 = F_82 ( V_192 , V_199 , V_195 , V_201 , V_211 ,
V_197 , & V_190 , & V_196 , NULL , V_79 -> V_203 ,
V_79 -> V_204 & V_205 ) ;
if ( V_55 ) {
F_59 ( 1 , L_43 ) ;
...
V_55 = F_90 ( V_192 , V_199 , V_190 , V_113 , V_210 , V_182 ) ;
...
struct V_206 * V_206 , const char * V_195 , const T_7 * V_216 )
{
struct V_111 * V_112 = NULL ;
T_12 V_210 = 0 ;
int V_55 = 0 ;
F_34 ( V_140 , L_45 , V_195 ) ;
if ( V_216 )
V_112 = F_71 ( V_79 , * V_216 , & V_210 ) ;
else
V_112 = F_84 ( V_79 , V_206 , V_195 , & V_210 ) ;
if ( F_33 ( V_112 ) ) {
V_55 = F_44 ( V_112 ) ;
F_59 ( 1 , L_46 , V_76 , V_55 ) ;
} else {
V_55 = F_69 ( V_79 , V_112 , V_210 , V_82 ) ;
F_18 ( V_112 ) ;
if ( V_55 )
F_59 ( 1 , L_47 , V_55 ) ;
}
...
int
F_92 ( struct V_206 * V_206 , const char * V_195 , T_8 V_149 ,
T_10 V_180 , T_11 V_181 )
{
int V_55 = 0 ;
int V_182 = V_186 ;
T_4 V_179 = 0 ;
...
F_34 ( V_140 , L_48 , V_195 ) ;
V_112 = F_84 ( F_89 ( V_206 -> V_212 ) , V_206 , V_195 , & V_179 ) ;
if ( F_33 ( V_112 ) ) {
V_55 = F_44 ( V_112 ) ;
F_59 ( 1 , L_46 , V_76 , V_55 ) ;
} else {
V_179 = V_179 < V_217 ?
V_217 : V_179 ;
V_113 = F_16 ( V_179 , V_45 ) ;
if ( ! V_113 ) {
F_59 ( 1 , L_49 ) ;
F_18 ( V_112 ) ;
return - V_46 ;
}
V_55 = F_70 ( V_112 , V_113 , V_179 , V_149 , V_180 , V_181 ,
& V_182 ) ;
F_34 ( V_140 , L_50 , V_55 ) ;
if ( ! V_55 ) {
V_55 = F_88 ( V_113 , V_179 , V_206 ,
V_195 , V_182 ) ;
