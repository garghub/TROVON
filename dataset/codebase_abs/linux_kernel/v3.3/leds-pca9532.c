...
#ifdef F_33
if ( V_11 -> V_48 . V_20 ) {
int V_31 = F_34 ( & V_11 -> V_48 ) ;
if ( V_31 ) {
F_3 ( & V_11 -> V_2 -> V_20 , L_2 ,
L_3 , V_31 ) ;
return V_31 ;
}
}
...
V_11 -> V_55 -> V_71 [ 0 ] = F_40 ( V_41 ) ;
V_11 -> V_55 -> V_72 [ 0 ] = F_40 ( V_42 ) |
F_40 ( V_43 ) ;
V_11 -> V_55 -> V_73 = F_18 ;
F_41 ( V_11 -> V_55 , V_11 ) ;
F_36 ( & V_11 -> V_36 , F_20 ) ;
...
{
struct V_10 * V_11 = F_2 ( V_2 ) ;
struct V_56 * V_87 = V_2 -> V_20 . V_88 ;
int V_31 ;
if ( ! V_87 )
return - V_89 ;
if ( ! F_48 ( V_2 -> V_90 ,
