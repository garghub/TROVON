...
static int T_1 F_7 ( const char T_2 * V_28 , int V_29 )
{
char V_30 = 0 ;
int V_31 ;
for ( V_31 = 0 ; V_31 < V_29 ; V_31 ++ )
V_30 += V_28 [ V_31 ] ;
return ( ( V_30 == 0 ) && ( V_29 > 0 ) ) ;
}
static int T_1 F_8 ( const char T_2 * V_32 )
{
struct V_33 * V_34 ;
int V_35 ;
...
if ( V_32 == NULL )
return - V_44 ;
for ( V_40 = V_32 ; V_40 < V_32 + V_43 ; V_40 += 16 ) {
V_41 = F_8 ( V_40 ) ;
if ( ! V_41 )
break;
}
...
static void T_1 F_10 ( const struct V_45 * V_46 , void * V_47 )
{
struct V_48 * V_49 ;
unsigned long V_5 ;
if ( V_46 -> type == V_50 ) {
V_49 = (struct V_48 * ) V_46 ;
if ( V_49 -> V_36 == V_15 ) {
V_5 =
V_49 -> V_51 +
V_49 -> V_52 ;
...
static void T_1 F_37 ( const struct V_45 * V_46 , void * V_47 )
{
struct V_98 * V_99 ;
if ( V_46 -> type == V_100 ) {
V_99 = (struct V_98 * ) V_46 ;
if ( V_99 -> V_101 & 0x01 )
V_70 = 1 ;
}
}
