...
static struct V_18 * F_19 ( struct V_12 * V_13 )
{
unsigned long V_17 ;
...
static int F_23 ( struct V_12 * V_13 , T_1 V_30 )
{
T_1 V_19 [ 10 ] ;
T_1 V_31 = 0 ;
T_1 * V_32 = V_19 ;
unsigned V_33 = 0 ;
F_17 ( & V_13 -> V_7 -> V_10 , L_3 , V_11 ,
0xFF & V_30 ) ;
* V_32 ++ = V_34 ;
* V_32 ++ = V_35 ;
V_31 += V_35 ;
...
static int F_24 ( struct V_12 * V_13 , int V_37 )
{
...
while ( ( V_19 = F_19 ( V_13 ) ) != NULL ) {
F_17 ( & V_13 -> V_7 -> V_10 , L_17 , V_11 , V_19 -> V_25 ) ;
V_16 = F_28 ( V_13 , V_19 -> V_8 , V_19 -> V_21 ) ;
if ( V_16 > 0 ) {
F_22 ( V_19 ) ;
return V_16 ;
}
...
V_19 [ 1 ] = F_25 ( V_73 ) ;
V_19 [ 2 ] = F_25 ( 12 ) ;
V_19 [ 3 ] = F_25 ( V_74 << 16 | V_75 ) ;
V_19 [ 4 ] = F_25 ( V_13 -> V_76 ) ;
V_19 [ 5 ] = F_25 ( V_13 -> V_77 ) ;
...
F_16 ( & V_13 -> V_22 , V_17 ) ;
F_33 ( V_7 -> V_81 ) ;
F_17 ( & V_7 -> V_10 , L_19 , V_11 ) ;
V_78 = F_34 ( V_7 -> V_82 -> V_10 ) ;
if ( V_78 )
F_17 ( & V_7 -> V_10 , L_20 ,
V_11 , V_78 ) ;
return V_78 ;
...
if ( V_78 == 0 ) {
F_33 ( V_7 -> V_81 ) ;
F_17 ( & V_82 -> V_10 -> V_10 , L_21 , V_11 ) ;
V_78 = F_37 ( V_7 -> V_81 , V_84 ) ;
if ( V_78 )
F_12 ( & V_82 -> V_10 -> V_10 ,
L_22 ,
V_11 , V_78 ) ;
...
static void F_40 ( struct V_94 * V_94 )
{
struct V_6 * V_7 = V_94 -> V_95 ;
if ( V_7 ) {
struct V_12 * V_13 =
F_31 ( V_7 ) ;
if ( V_46 == F_1 ( V_94 -> V_96 ) ) {
if ( V_13 -> V_76 == V_97 ) {
F_23 ( V_13 ,
( ( T_1 * ) V_94 -> V_96 ) [ 4 ] ) ;
}
...
memcpy ( V_99 , V_3 , V_37 ) ;
F_7 ( & V_7 -> V_10 , V_11 , V_37 , V_99 ) ;
F_43 ( V_94 , V_82 -> V_10 ,
F_44 ( V_82 -> V_10 ,
V_7 -> V_101 ) ,
V_99 , V_37 ,
...
if ( V_13 -> V_76 == V_97 ) {
return F_27 ( V_13 , V_3 , V_37 ) ;
} else {
return F_29 ( V_13 , V_3 , V_37 ) ;
}
}
static int F_48 ( struct V_86 * V_87 )
{
struct V_6 * V_7 = V_87 -> V_112 ;
struct V_12 * V_13 = F_31 ( V_7 ) ;
...
unsigned long V_17 ;
if ( V_13 -> V_17 & V_48 ) {
F_17 ( & V_13 -> V_7 -> V_10 , L_30 , V_11 ) ;
} else if ( V_13 -> V_15 != V_93 &&
V_13 -> V_15 != V_80 ) {
if ( V_13 -> V_17 & V_23 ) {
F_10 ( V_13 , V_8 , V_14 ) ;
} else if ( V_113 ||
...
static void F_50 ( struct V_94 * V_94 )
{
unsigned long V_17 ;
struct V_6 * V_7 = V_94 -> V_95 ;
struct V_83 * V_82 = V_7 -> V_82 ;
struct V_12 * V_13 = F_31 ( V_7 ) ;
unsigned char * V_8 = V_94 -> V_96 ;
int V_78 = V_94 -> V_78 ;
int V_115 ;
if ( ! V_82 ) {
F_17 ( & V_94 -> V_10 -> V_10 , L_31 , V_11 ) ;
return;
}
if ( V_78 ) {
F_17 ( & V_94 -> V_10 -> V_10 , L_32 ,
V_11 , V_78 ) ;
return;
}
F_7 ( & V_7 -> V_10 , V_11 , V_94 -> V_9 , V_8 ) ;
F_49 ( V_13 , V_8 , V_94 -> V_9 , 1 ) ;
if ( V_94 -> V_9 == 0 &&
0 != ( V_13 -> V_17 & V_116 ) ) {
F_13 ( & V_13 -> V_22 , V_17 ) ;
V_13 -> V_17 &= ~ V_116 ;
F_16 ( & V_13 -> V_22 , V_17 ) ;
V_115 = F_37 ( V_7 -> V_91 , V_20 ) ;
if ( V_115 )
F_12 ( & V_7 -> V_10 ,
L_33 ,
V_11 , V_115 ) ;
...
case - V_120 :
case - V_121 :
F_17 ( & V_94 -> V_10 -> V_10 , L_35 ,
V_11 , V_78 ) ;
return;
default:
F_17 ( & V_94 -> V_10 -> V_10 , L_36 ,
V_11 , V_78 ) ;
return;
}
F_7 ( & V_7 -> V_10 , V_11 , V_94 -> V_9 ,
V_94 -> V_96 ) ;
if ( V_94 -> V_9 == sizeof( V_122 ) &&
0 == memcmp ( V_8 , V_122 ,
sizeof( V_122 ) ) ) {
F_17 ( & V_7 -> V_10 , L_37 , V_11 ) ;
if ( 0 == ( V_13 -> V_17 & V_118 ) ) {
V_115 = F_37 ( V_7 -> V_91 , V_20 ) ;
if ( V_115 ) {
F_12 ( & V_7 -> V_10 ,
L_38 ,
...
} else if ( V_94 -> V_9 == ( 4 + sizeof( V_123 ) )
&& 0 == memcmp ( V_8 , V_123 ,
sizeof( V_123 ) ) ) {
F_13 ( & V_13 -> V_22 , V_17 ) ;
V_13 -> V_17 |= V_89 ;
...
F_49 ( V_13 , V_8 , V_94 -> V_9 , 0 ) ;
V_115 = F_37 ( V_94 , V_20 ) ;
if ( V_115 )
F_12 ( & V_94 -> V_10 -> V_10 ,
L_40 ,
V_11 , V_115 ) ;
...
if ( V_13 == NULL ) {
F_12 ( & V_7 -> V_10 , L_41 , V_11 ) ;
return - V_100 ;
}
F_61 ( & V_13 -> V_124 ) ;
F_62 ( & V_13 -> V_22 ) ;
F_63 ( & V_13 -> V_24 ) ;
V_13 -> V_124 . V_8 = ( unsigned long ) V_13 ;
V_13 -> V_124 . V_127 = F_58 ;
V_13 -> V_7 = V_7 ;
V_13 -> V_15 = 0 ;
V_13 -> V_17 = 0 ;
V_13 -> V_37 = 0 ;
