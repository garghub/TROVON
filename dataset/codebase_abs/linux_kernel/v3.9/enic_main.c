...
static int F_164 ( struct V_108 * V_107 , int V_265 )
{
struct V_16 * V_17 = V_107 -> V_117 ;
struct V_1 * V_1 = F_16 ( V_17 ) ;
unsigned int V_266 = F_6 ( V_1 , 0 ) ;
unsigned int V_267 = F_7 ( V_1 , 0 ) ;
unsigned int V_69 = F_8 () ;
unsigned int V_268 = V_265 ;
unsigned int V_109 = - 1 ;
unsigned int V_269 , V_270 , V_110 ;
int V_177 ;
V_270 = F_78 ( & V_1 -> V_13 [ V_266 ] ,
V_268 , F_162 , NULL ) ;
V_110 = F_78 ( & V_1 -> V_13 [ V_267 ] ,
V_109 , F_42 , NULL ) ;
V_269 = V_270 + V_110 ;
if ( V_269 > 0 )
F_79 ( & V_1 -> V_69 [ V_69 ] ,
...
static int F_167 ( struct V_108 * V_107 , int V_265 )
{
struct V_16 * V_17 = V_107 -> V_117 ;
struct V_1 * V_1 = F_16 ( V_17 ) ;
...
unsigned int V_271 = V_265 ;
unsigned int V_269 ;
int V_177 ;
V_269 = F_78 ( & V_1 -> V_13 [ V_13 ] ,
V_271 , F_162 , NULL ) ;
if ( V_269 > 0 )
F_79 ( & V_1 -> V_69 [ V_69 ] ,
V_269 ,
...
break;
case V_73 :
for ( V_47 = 0 ; V_47 < F_173 ( V_1 -> V_275 ) ; V_47 ++ )
if ( V_1 -> V_275 [ V_47 ] . V_276 )
F_172 ( V_1 -> V_277 [ V_47 ] . V_278 ,
V_1 -> V_275 [ V_47 ] . V_279 ) ;
break;
default:
break;
}
...
for ( V_47 = 0 ; V_47 < V_1 -> V_12 ; V_47 ++ ) {
V_69 = F_11 ( V_1 , V_47 ) ;
snprintf ( V_1 -> V_275 [ V_69 ] . V_281 ,
sizeof( V_1 -> V_275 [ V_69 ] . V_281 ) ,
L_13 , V_17 -> V_51 , V_47 ) ;
V_1 -> V_275 [ V_69 ] . V_282 = F_76 ;
V_1 -> V_275 [ V_69 ] . V_279 = & V_1 -> V_107 [ V_47 ] ;
}
for ( V_47 = 0 ; V_47 < V_1 -> V_15 ; V_47 ++ ) {
V_69 = F_12 ( V_1 , V_47 ) ;
snprintf ( V_1 -> V_275 [ V_69 ] . V_281 ,
sizeof( V_1 -> V_275 [ V_69 ] . V_281 ) ,
L_14 , V_17 -> V_51 , V_47 ) ;
V_1 -> V_275 [ V_69 ] . V_282 = F_77 ;
V_1 -> V_275 [ V_69 ] . V_279 = V_1 ;
}
V_69 = F_13 ( V_1 ) ;
snprintf ( V_1 -> V_275 [ V_69 ] . V_281 ,
sizeof( V_1 -> V_275 [ V_69 ] . V_281 ) ,
L_15 , V_17 -> V_51 ) ;
V_1 -> V_275 [ V_69 ] . V_282 = F_80 ;
V_1 -> V_275 [ V_69 ] . V_279 = V_1 ;
V_69 = F_14 ( V_1 ) ;
snprintf ( V_1 -> V_275 [ V_69 ] . V_281 ,
sizeof( V_1 -> V_275 [ V_69 ] . V_281 ) ,
L_16 , V_17 -> V_51 ) ;
V_1 -> V_275 [ V_69 ] . V_282 = F_81 ;
V_1 -> V_275 [ V_69 ] . V_279 = V_1 ;
for ( V_47 = 0 ; V_47 < F_173 ( V_1 -> V_275 ) ; V_47 ++ )
V_1 -> V_275 [ V_47 ] . V_276 = 0 ;
for ( V_47 = 0 ; V_47 < V_1 -> V_283 ; V_47 ++ ) {
V_177 = F_175 ( V_1 -> V_277 [ V_47 ] . V_278 ,
V_1 -> V_275 [ V_47 ] . V_282 , 0 ,
V_1 -> V_275 [ V_47 ] . V_281 ,
V_1 -> V_275 [ V_47 ] . V_279 ) ;
if ( V_177 ) {
F_171 ( V_1 ) ;
break;
}
V_1 -> V_275 [ V_47 ] . V_276 = 1 ;
}
break;
default:
break;
...
for ( V_47 = 0 ; V_47 < V_1 -> V_287 ; V_47 ++ )
F_198 ( & V_1 -> V_13 [ V_47 ] ) ;
for ( V_47 = 0 ; V_47 < V_1 -> V_283 ; V_47 ++ )
F_199 ( & V_1 -> V_69 [ V_47 ] ) ;
return 0 ;
}
static int F_200 ( struct V_16 * V_17 , int V_288 )
{
struct V_1 * V_1 = F_16 ( V_17 ) ;
int V_289 = F_120 ( V_17 ) ;
if ( V_288 < V_93 || V_288 > V_94 )
return - V_71 ;
if ( F_1 ( V_1 ) || F_3 ( V_1 ) )
return - V_56 ;
if ( V_289 )
...
static void F_201 ( struct V_290 * V_291 )
{
struct V_1 * V_1 = F_202 ( V_291 , struct V_1 , V_95 ) ;
struct V_16 * V_17 = V_1 -> V_17 ;
int V_288 = F_57 ( V_1 -> V_30 ) ;
int V_177 ;
unsigned int V_47 ;
V_288 = F_58 ( int , V_93 , F_32 ( int , V_94 , V_288 ) ) ;
F_203 () ;
F_190 ( & V_1 -> V_272 ) ;
for ( V_47 = 0 ; V_47 < V_1 -> V_12 ; V_47 ++ )
F_192 ( & V_1 -> V_107 [ V_47 ] ) ;
...
for ( V_47 = 0 ; V_47 < V_1 -> V_12 ; V_47 ++ ) {
V_69 = F_11 ( V_1 , V_47 ) ;
F_76 ( V_1 -> V_277 [ V_69 ] . V_278 ,
& V_1 -> V_107 [ V_47 ] ) ;
}
for ( V_47 = 0 ; V_47 < V_1 -> V_15 ; V_47 ++ ) {
V_69 = F_12 ( V_1 , V_47 ) ;
F_77 ( V_1 -> V_277 [ V_69 ] . V_278 , V_1 ) ;
}
break;
case V_72 :
...
int V_177 ;
F_209 ( F_210 () ) ;
V_177 = F_207 ( V_30 , V_292 ) ;
if ( V_177 )
return V_177 ;
time = V_273 + ( V_294 * 2 ) ;
do {
V_177 = F_208 ( V_30 , & V_293 ) ;
if ( V_177 )
return V_177 ;
if ( V_293 )
return 0 ;
F_211 ( V_294 / 10 ) ;
} while ( F_212 ( time , V_273 ) );
return - V_295 ;
}
static int F_213 ( struct V_1 * V_1 )
{
int V_177 ;
V_177 = F_206 ( V_1 -> V_30 , V_296 ,
V_297 , 0 ) ;
if ( V_177 )
...
{
T_7 V_300 ;
union V_301 * V_302 = NULL ;
union V_301 V_303 = {
. V_304 [ 0 ] . V_305 = { 85 , 67 , 83 , 97 , 119 , 101 , 115 , 111 , 109 , 101 } ,
. V_304 [ 1 ] . V_305 = { 80 , 65 , 76 , 79 , 117 , 110 , 105 , 113 , 117 , 101 } ,
. V_304 [ 2 ] . V_305 = { 76 , 73 , 78 , 85 , 88 , 114 , 111 , 99 , 107 , 115 } ,
. V_304 [ 3 ] . V_305 = { 69 , 78 , 73 , 67 , 105 , 115 , 99 , 111 , 111 , 108 } ,
} ;
int V_177 ;
V_302 = F_218 ( V_1 -> V_2 ,
sizeof( union V_301 ) , & V_300 ) ;
if ( ! V_302 )
return - V_232 ;
memcpy ( V_302 , & V_303 , sizeof( union V_301 ) ) ;
F_43 ( & V_1 -> V_284 ) ;
V_177 = F_219 ( V_1 ,
V_300 ,
sizeof( union V_301 ) ) ;
F_48 ( & V_1 -> V_284 ) ;
F_220 ( V_1 -> V_2 , sizeof( union V_301 ) ,
V_302 , V_300 ) ;
return V_177 ;
}
static int F_221 ( struct V_1 * V_1 , T_2 V_306 )
{
T_7 V_307 ;
...
if ( ! V_309 )
return - V_232 ;
for ( V_47 = 0 ; V_47 < ( 1 << V_306 ) ; V_47 ++ )
( * V_309 ) . V_310 [ V_47 / 4 ] . V_305 [ V_47 % 4 ] = V_47 % V_1 -> V_12 ;
F_43 ( & V_1 -> V_284 ) ;
V_177 = F_222 ( V_1 ,
V_307 ,
sizeof( union V_308 ) ) ;
F_48 ( & V_1 -> V_284 ) ;
F_220 ( V_1 -> V_2 , sizeof( union V_308 ) ,
V_309 , V_307 ) ;
return V_177 ;
}
static int F_223 ( struct V_1 * V_1 , T_2 V_311 ,
T_2 V_312 , T_2 V_306 , T_2 V_313 , T_2 V_314 )
{
const T_2 V_315 = 0 ;
const T_2 V_316 = 1 ;
int V_177 ;
...
const T_2 V_311 = 0 ;
const T_2 V_312 = V_317 |
V_318 |
V_319 |
V_320 ;
const T_2 V_306 = 7 ;
const T_2 V_313 = 0 ;
T_2 V_314 = F_226 ( V_1 , V_321 ) && ( V_1 -> V_12 > 1 ) ;
if ( V_314 ) {
if ( ! F_217 ( V_1 ) ) {
if ( F_221 ( V_1 , V_306 ) ) {
V_314 = 0 ;
...
return F_223 ( V_1 , V_311 , V_312 ,
V_306 , V_313 , V_314 ) ;
}
static void F_228 ( struct V_290 * V_291 )
{
struct V_1 * V_1 = F_202 ( V_291 , struct V_1 , V_105 ) ;
if ( ! F_120 ( V_1 -> V_17 ) )
return;
F_203 () ;
F_229 ( V_1 ) ;
...
{
unsigned int V_322 = F_32 (unsigned int, enic->rq_count, ENIC_RQ_MAX) ;
unsigned int V_323 = F_32 (unsigned int, enic->wq_count, ENIC_WQ_MAX) ;
unsigned int V_47 ;
F_209 ( F_173 ( V_1 -> V_277 ) < V_322 + V_323 + 2 ) ;
for ( V_47 = 0 ; V_47 < V_322 + V_323 + 2 ; V_47 ++ )
V_1 -> V_277 [ V_47 ] . V_324 = V_47 ;
if ( F_226 ( V_1 , V_321 ) &&
V_1 -> V_325 . V_326 < 1 &&
V_1 -> V_12 >= V_322 &&
V_1 -> V_15 >= V_323 &&
V_1 -> V_287 >= V_322 + V_323 &&
V_1 -> V_283 >= V_322 + V_323 + 2 ) {
if ( ! F_233 ( V_1 -> V_2 , V_1 -> V_277 , V_322 + V_323 + 2 ) ) {
V_1 -> V_12 = V_322 ;
V_1 -> V_15 = V_323 ;
V_1 -> V_287 = V_322 + V_323 ;
V_1 -> V_283 = V_322 + V_323 + 2 ;
...
if ( V_1 -> V_325 . V_326 < 1 &&
V_1 -> V_12 >= 1 &&
V_1 -> V_15 >= V_323 &&
V_1 -> V_287 >= 1 + V_323 &&
V_1 -> V_283 >= 1 + V_323 + 2 ) {
if ( ! F_233 ( V_1 -> V_2 , V_1 -> V_277 , 1 + V_323 + 2 ) ) {
V_1 -> V_12 = 1 ;
V_1 -> V_15 = V_323 ;
V_1 -> V_287 = 1 + V_323 ;
V_1 -> V_283 = 1 + V_323 + 2 ;
...
{
unsigned int V_47 ;
for ( V_47 = 0 ; V_47 < F_173 ( V_1 -> V_329 ) ; V_47 ++ )
if ( V_1 -> V_329 [ V_47 ] . V_330 )
F_250 ( V_1 -> V_329 [ V_47 ] . V_330 ) ;
}
static int F_251 ( struct V_331 * V_2 , const struct V_332 * V_333 )
{
...
for ( V_47 = 0 ; V_47 < F_173 ( V_1 -> V_329 ) ; V_47 ++ ) {
if ( ! ( F_261 ( V_2 , V_47 ) & V_340 ) )
continue;
V_1 -> V_329 [ V_47 ] . V_79 = F_262 ( V_2 , V_47 ) ;
V_1 -> V_329 [ V_47 ] . V_330 = F_263 ( V_2 , V_47 , V_1 -> V_329 [ V_47 ] . V_79 ) ;
if ( ! V_1 -> V_329 [ V_47 ] . V_330 ) {
F_214 ( V_117 , L_41 , V_47 ) ;
V_177 = - V_341 ;
goto V_342;
}
V_1 -> V_329 [ V_47 ] . V_343 = F_264 ( V_2 , V_47 ) ;
}
V_1 -> V_30 = F_265 ( NULL , V_1 , V_2 , V_1 -> V_329 ,
F_173 ( V_1 -> V_329 ) ) ;
if ( ! V_1 -> V_30 ) {
F_214 ( V_117 , L_42 ) ;
V_177 = - V_341 ;
...
#ifdef F_5
V_335 = F_266 ( V_2 , V_344 ) ;
if ( V_335 ) {
F_267 ( V_2 , V_335 + V_345 ,
& V_1 -> V_9 ) ;
if ( V_1 -> V_9 ) {
...
#endif
V_1 -> V_196 = F_269 ( V_336 , sizeof( * V_1 -> V_196 ) , V_347 ) ;
if ( ! V_1 -> V_196 ) {
V_177 = - V_232 ;
goto V_348;
}
...
F_272 ( & V_1 -> V_272 ) ;
V_1 -> V_272 . V_351 = F_168 ;
V_1 -> V_272 . V_46 = ( unsigned long ) V_1 ;
F_273 ( & V_1 -> V_105 , F_228 ) ;
F_273 ( & V_1 -> V_95 , F_201 ) ;
for ( V_47 = 0 ; V_47 < V_1 -> V_15 ; V_47 ++ )
F_270 ( & V_1 -> V_87 [ V_47 ] ) ;
V_1 -> V_92 = V_1 -> V_325 . V_91 ;
...
V_17 -> V_357 = 2 * V_294 ;
V_17 -> V_358 = & V_359 ;
V_17 -> V_259 |= V_360 | V_361 ;
if ( F_226 ( V_1 , V_362 ) ) {
V_17 -> V_259 &= ~ V_360 ;
V_1 -> V_136 = 1 ;
V_1 -> V_137 = V_1 -> V_325 . V_137 ;
F_274 ( V_117 , L_50 , V_1 -> V_137 ) ;
}
if ( F_226 ( V_1 , V_363 ) )
V_17 -> V_364 |= V_365 | V_366 ;
if ( F_226 ( V_1 , V_367 ) )
V_17 -> V_364 |= V_368 |
V_369 | V_370 ;
if ( F_226 ( V_1 , V_371 ) )
V_17 -> V_364 |= V_260 ;
V_17 -> V_259 |= V_17 -> V_364 ;
if ( V_334 )
V_17 -> V_259 |= V_372 ;
V_17 -> V_5 |= V_373 ;
V_177 = F_275 ( V_17 ) ;
...
static void F_283 ( struct V_331 * V_2 )
{
