...
static int F_49 ( struct V_7 * V_7 , int V_102 , int V_103 )
{
struct V_30 * V_30 = & V_7 -> V_30 ;
unsigned char V_69 [ 2 ] ;
V_7 -> V_78 = false ;
...
if ( V_106 ) {
F_26 ( V_30 , V_69 , V_107 ) ;
return 3 ;
}
if ( V_102 != 3 )
return 2 ;
if ( ! F_26 ( V_30 , V_69 , V_108 ) ) {
V_7 -> V_101 = V_69 [ 0 ] << 8 | V_69 [ 1 ] ;
return 2 ;
}
V_69 [ 0 ] = 3 ;
if ( F_26 ( V_30 , V_69 , V_104 ) )
return 2 ;
V_69 [ 0 ] = 0 ;
...
struct V_7 * V_7 = F_9 ( V_10 ) ;
F_43 ( V_7 ) ;
F_26 ( & V_7 -> V_30 , NULL , V_111 ) ;
}
static void F_52 ( struct V_10 * V_10 )
{
struct V_7 * V_7 = F_9 ( V_10 ) ;
F_53 ( & V_10 -> V_14 . V_112 , & V_113 ) ;
F_43 ( V_7 ) ;
F_54 ( V_7 -> V_14 ) ;
F_55 ( & V_7 -> V_87 ) ;
F_56 ( V_10 ) ;
...
const void * V_11 )
{
const unsigned int * V_114 = V_11 ;
unsigned int V_3 ;
if ( V_7 -> V_8 == 2 )
for ( V_3 = 0 ; V_114 [ V_3 ] != - 1U ; V_3 ++ )
F_6 ( V_114 [ V_3 ] , V_7 -> V_62 ) ;
}
...
V_115 = V_117 [ V_3 ] ;
V_7 -> V_19 [ V_3 ] = V_118 [ V_115 ] ;
V_7 -> V_19 [ V_3 | 0x80 ] = V_118 [ V_115 | 0x80 ] ;
if ( V_7 -> V_15 )
for ( V_70 = 0 ; V_70 < F_2 ( V_119 ) ; V_70 ++ )
if ( ( V_115 | 0x80 ) == V_119 [ V_70 ] . V_120 )
V_7 -> V_19 [ V_3 | 0x80 ] = V_119 [ V_70 ] . V_19 ;
}
} else if ( V_7 -> V_8 == 3 ) {
memcpy ( V_7 -> V_19 , V_121 , sizeof( V_7 -> V_19 ) ) ;
} else {
memcpy ( V_7 -> V_19 , V_118 , sizeof( V_7 -> V_19 ) ) ;
if ( V_7 -> V_15 )
for ( V_3 = 0 ; V_3 < F_2 ( V_119 ) ; V_3 ++ ) {
V_115 = V_119 [ V_3 ] . V_120 ;
V_7 -> V_19 [ V_115 ] = V_119 [ V_3 ] . V_19 ;
}
}
V_115 = F_7 ( V_7 , V_122 ) ;
V_7 -> V_19 [ V_115 ] = V_123 ;
F_6 ( V_115 , V_7 -> V_62 ) ;
V_115 = F_7 ( V_7 , V_124 ) ;
V_7 -> V_19 [ V_115 ] = V_125 ;
F_6 ( V_115 , V_7 -> V_62 ) ;
if ( V_126 )
V_126 ( V_7 , V_127 ) ;
}
...
int V_3 ;
if ( V_7 -> V_78 )
snprintf ( V_7 -> V_128 , sizeof( V_7 -> V_128 ) ,
L_21 ) ;
else
snprintf ( V_7 -> V_128 , sizeof( V_7 -> V_128 ) ,
L_22 ,
...
V_13 -> V_128 = V_7 -> V_128 ;
V_13 -> V_42 = V_7 -> V_42 ;
V_13 -> V_101 . V_129 = V_130 ;
V_13 -> V_101 . V_131 = 0x0001 ;
V_13 -> V_101 . V_132 = V_7 -> V_37 ? 1 : V_7 -> V_8 ;
V_13 -> V_101 . V_133 = V_7 -> V_101 ;
V_13 -> V_134 = F_38 ;
V_13 -> V_14 . V_135 = & V_7 -> V_30 . V_10 -> V_14 ;
F_64 ( V_13 , V_7 ) ;
V_13 -> V_136 [ 0 ] = F_65 ( V_61 ) | F_65 ( V_95 ) |
F_65 ( V_34 ) ;
if ( V_7 -> V_26 ) {
V_13 -> V_136 [ 0 ] |= F_65 ( V_94 ) ;
V_13 -> V_137 [ 0 ] = F_65 ( V_75 ) |
F_65 ( V_76 ) | F_65 ( V_73 ) ;
}
if ( V_7 -> V_78 )
V_13 -> V_137 [ 0 ] |= F_65 ( V_79 ) |
F_65 ( V_81 ) | F_65 ( V_80 ) |
F_65 ( V_83 ) | F_65 ( V_82 ) ;
if ( ! V_7 -> V_56 ) {
V_13 -> V_59 [ V_60 ] = 250 ;
...
V_13 -> V_138 [ 0 ] = V_7 -> V_139 ? F_65 ( V_46 ) :
F_65 ( V_35 ) | F_65 ( V_46 ) ;
if ( V_7 -> V_15 ) {
V_13 -> V_136 [ 0 ] |= F_65 ( V_140 ) ;
V_13 -> V_141 [ 0 ] = F_65 ( V_64 ) |
F_65 ( V_65 ) ;
F_6 ( V_63 , V_13 -> V_142 ) ;
}
V_13 -> V_19 = V_7 -> V_19 ;
V_13 -> V_143 = sizeof( unsigned short ) ;
V_13 -> V_144 = F_2 ( V_118 ) ;
for ( V_3 = 0 ; V_3 < V_116 ; V_3 ++ ) {
if ( V_7 -> V_19 [ V_3 ] != V_145 &&
V_7 -> V_19 [ V_3 ] != V_45 &&
V_7 -> V_19 [ V_3 ] < V_146 ) {
F_6 ( V_7 -> V_19 [ V_3 ] , V_13 -> V_142 ) ;
}
}
}
static int F_66 ( struct V_10 * V_10 , struct V_147 * V_148 )
{
struct V_7 * V_7 ;
struct V_13 * V_14 ;
int V_149 = - V_150 ;
V_7 = F_67 ( sizeof( struct V_7 ) , V_151 ) ;
V_14 = F_68 () ;
if ( ! V_7 || ! V_14 )
goto V_152;
V_7 -> V_14 = V_14 ;
...
F_61 ( V_7 ) ;
F_63 ( V_7 ) ;
V_149 = F_73 ( & V_10 -> V_14 . V_112 , & V_113 ) ;
if ( V_149 )
goto V_160;
F_40 ( V_7 ) ;
if ( V_10 -> V_26 )
...
goto V_163;
return 0 ;
V_163: F_53 ( & V_10 -> V_14 . V_112 , & V_113 ) ;
V_160: F_56 ( V_10 ) ;
V_158: F_57 ( V_10 , NULL ) ;
V_152: F_75 ( V_14 ) ;
F_58 ( V_7 ) ;
return V_149 ;
}
...
static T_2 F_77 ( struct V_165 * V_14 , char * V_166 ,
T_2 (* F_78)( struct V_7 * , char * ) )
{
struct V_10 * V_10 = F_79 ( V_14 ) ;
struct V_7 * V_7 = F_9 ( V_10 ) ;
return F_78 ( V_7 , V_166 ) ;
}
static T_2 F_80 ( struct V_165 * V_14 , const char * V_166 , T_3 V_167 ,
...
return V_164 ;
F_43 ( V_7 ) ;
V_164 = F_78 ( V_7 , V_166 , V_167 ) ;
F_40 ( V_7 ) ;
F_33 ( & V_7 -> V_88 ) ;
return V_164 ;
}
static T_2 F_82 ( struct V_7 * V_7 , char * V_166 )
{
return sprintf ( V_166 , L_27 , V_7 -> V_78 ? 1 : 0 ) ;
}
static T_2 F_83 ( struct V_7 * V_7 , const char * V_166 , T_3 V_167 )
{
struct V_13 * V_168 , * V_169 ;
unsigned int V_18 ;
int V_149 ;
bool V_170 ;
unsigned char V_171 ;
...
static T_2 F_85 ( struct V_7 * V_7 , char * V_166 )
{
T_3 V_174 = F_86 ( V_166 , V_175 - 2 ,
V_7 -> V_62 , V_116 ) ;
V_166 [ V_174 ++ ] = '\n' ;
V_166 [ V_174 ] = '\0' ;
return V_174 ;
...
const char * V_166 , T_3 V_167 )
{
F_88 ( V_176 , V_116 ) ;
int V_149 ;
V_149 = F_89 ( V_166 , V_176 , V_116 ) ;
if ( V_149 )
return V_149 ;
memcpy ( V_7 -> V_62 , V_176 , sizeof( V_7 -> V_62 ) ) ;
return V_167 ;
}
static T_2 F_90 ( struct V_7 * V_7 , char * V_166 )
{
return sprintf ( V_166 , L_27 , V_7 -> V_15 ? 1 : 0 ) ;
}
static T_2 F_91 ( struct V_7 * V_7 , const char * V_166 , T_3 V_167 )
{
struct V_13 * V_168 , * V_169 ;
unsigned int V_18 ;
int V_149 ;
...
static T_2 F_92 ( struct V_7 * V_7 , char * V_166 )
{
return sprintf ( V_166 , L_27 , V_7 -> V_8 ) ;
}
static T_2 F_93 ( struct V_7 * V_7 , const char * V_166 , T_3 V_167 )
{
struct V_13 * V_168 , * V_169 ;
unsigned int V_18 ;
int V_149 ;
...
static T_2 F_94 ( struct V_7 * V_7 , char * V_166 )
{
return sprintf ( V_166 , L_27 , V_7 -> V_56 ? 1 : 0 ) ;
}
static T_2 F_95 ( struct V_7 * V_7 , const char * V_166 , T_3 V_167 )
{
struct V_13 * V_168 , * V_169 ;
unsigned int V_18 ;
int V_149 ;
...
static T_2 F_96 ( struct V_7 * V_7 , char * V_166 )
{
return sprintf ( V_166 , L_27 , V_7 -> V_139 ? 1 : 0 ) ;
}
static T_2 F_97 ( struct V_7 * V_7 , const char * V_166 , T_3 V_167 )
{
struct V_13 * V_168 , * V_169 ;
unsigned int V_18 ;
int V_149 ;
...
static T_2 F_98 ( struct V_7 * V_7 , char * V_166 )
{
return sprintf ( V_166 , L_28 , V_7 -> V_44 ) ;
}
static int T_4 F_99 ( const struct V_180 * V_101 )
{
V_126 = F_59 ;
V_127 = V_101 -> V_181 ;
return 1 ;
}
static int T_4 F_100 ( const struct V_180 * V_101 )
{
V_36 = V_101 -> V_181 ;
return 1 ;
}
