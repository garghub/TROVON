...
static inline struct V_38 * F_17 (
struct V_39 * V_40 ,
struct V_41 * * V_42 )
{
* V_42 = NULL ;
...
{
struct V_60 * V_60 = F_22 ( V_40 -> V_12 . V_46 ) ;
...
V_2 -> V_71 [ V_66 ] . V_72 = V_25 -> V_72 ;
V_2 -> V_71 [ V_66 ] . V_73 = V_66 ;
V_2 -> V_71 [ V_66 ] . V_74 = V_25 -> V_75 ;
V_2 -> V_71 [ V_66 ] . V_76 = V_25 -> V_77 ;
V_2 -> V_71 [ V_66 ] . V_78 = & V_79 ;
V_2 -> V_71 [ V_66 ] . type = V_80 ;
V_2 -> V_71 [ V_66 ] . V_81 = V_82 ;
V_64 . V_12 = V_60 -> V_12 ;
V_64 . V_59 = V_59 ;
V_64 . V_69 = V_2 ;
if ( V_42 ) {
...
{
struct V_60 * V_60 = F_32 ( V_40 ) ;
struct V_1 * V_2 = V_60 -> V_84 ;
int V_66 ;
