...
return memcmp ( V_59 , V_44 , V_37 ) ? - V_66 : 0 ;
}
static void F_73 ( struct V_6 * V_62 , int V_7 )
{
struct V_2 * V_3 = V_62 -> V_10 ;
struct V_1 * V_41 = F_1 ( V_3 ) ;
if ( ! V_7 )
...
static int F_77 ( struct V_67 * V_36 )
{
struct V_68 * V_69 = ( void * ) V_36 -> V_70 ;
struct V_71 * V_72 = F_78 ( V_69 ) ;
...
V_4 &= ~ ( F_84 () - 1 ) ;
V_36 -> V_74 . V_75 = V_4 +
F_85 ( struct V_1 , V_49 ) +
F_86 ( sizeof( struct V_27 ) +
F_17 ( V_22 ) ,
sizeof( struct V_47 ) +
F_87 ( V_20 ) ) ;
return 0 ;
...
static void F_89 ( struct V_67 * V_36 )
{
struct V_17 * V_18 = F_62 ( V_36 ) ;
F_88 ( V_18 -> V_20 ) ;
F_90 ( V_18 -> V_22 ) ;
}
static struct V_68 * F_91 ( struct V_76 * * V_77 ,
const char * V_78 ,
const char * V_79 ,
const char * V_80 )
{
...
goto V_92;
V_18 = F_78 ( V_69 ) ;
V_86 = F_96 ( V_84 , struct V_85 , V_93 . V_64 ) ;
V_7 = F_97 ( & V_18 -> V_20 , & V_86 -> V_93 ,
V_69 ) ;
if ( V_7 )
goto V_94;
F_98 ( & V_18 -> V_22 , V_69 ) ;
V_7 = F_99 ( & V_18 -> V_22 , V_79 , 0 ,
F_100 ( V_82 -> type ,
V_82 -> V_88 ) ) ;
if ( V_7 )
goto V_95;
...
static struct V_68 * F_106 ( struct V_76 * * V_77 )
{
const char * V_121 ;
char V_79 [ V_103 ] ;
char V_78 [ V_103 ] ;
...
V_103 )
return F_94 ( - V_100 ) ;
return F_91 ( V_77 , V_78 , V_79 , L_4 ) ;
}
static void F_108 ( struct V_68 * V_69 )
{
struct V_71 * V_18 = F_78 ( V_69 ) ;
F_104 ( & V_18 -> V_22 ) ;
F_105 ( & V_18 -> V_20 ) ;
F_29 ( V_69 ) ;
}
static struct V_68 * F_109 ( struct V_76 * * V_77 )
{
const char * V_79 ;
const char * V_80 ;
char V_78 [ V_103 ] ;
...
V_79 , V_80 ) >= V_103 )
return F_94 ( - V_100 ) ;
return F_91 ( V_77 , V_78 , V_79 , V_80 ) ;
}
static int F_110 ( struct V_13 * V_122 , const V_5 * V_15 ,
unsigned int V_16 )
{
...
V_28 ) ;
V_7 = F_112 ( V_124 , V_15 , V_16 ) ;
F_14 ( V_122 , F_12 ( V_124 ) &
V_29 ) ;
return V_7 ;
}
static int F_113 ( struct V_13 * V_122 ,
unsigned int V_37 )
{
struct V_123 * V_18 = F_9 ( V_122 ) ;
switch ( V_37 ) {
...
return F_114 ( V_18 -> V_124 , V_37 ) ;
}
static struct V_2 * F_115 ( struct V_2 * V_3 )
{
struct V_2 * V_126 = F_5 ( V_3 ) ;
struct V_13 * V_14 = F_3 ( V_3 ) ;
struct V_123 * V_18 = F_9 ( V_14 ) ;
struct V_13 * V_124 = V_18 -> V_124 ;
V_5 * V_24 = F_4 ( ( V_5 * ) ( V_126 + 1 ) + F_116 ( V_124 ) ,
F_2 ( V_124 ) + 1 ) ;
memcpy ( V_24 , V_18 -> V_125 , 4 ) ;
memcpy ( V_24 + 4 , V_3 -> V_24 , 8 ) ;
F_117 ( V_126 , V_124 ) ;
F_118 ( V_126 , V_3 -> V_64 . V_127 , V_3 -> V_64 . F_7 ,
V_3 -> V_64 . V_10 ) ;
F_119 ( V_126 , V_3 -> V_45 , V_3 -> V_42 , V_3 -> V_40 , V_24 ) ;
F_120 ( V_126 , V_3 -> V_63 , V_3 -> V_57 ) ;
return V_126 ;
}
...
static int F_125 ( struct V_67 * V_36 )
{
struct V_68 * V_69 = ( void * ) V_36 -> V_70 ;
struct V_128 * V_129 = F_78 ( V_69 ) ;
...
static void F_128 ( struct V_67 * V_36 )
{
struct V_123 * V_18 = F_62 ( V_36 ) ;
F_129 ( V_18 -> V_124 ) ;
}
static struct V_68 * F_130 ( struct V_76 * * V_77 )
{
struct V_81 * V_82 ;
struct V_68 * V_69 ;
struct V_128 * V_129 ;
...
V_129 = F_78 ( V_69 ) ;
F_131 ( V_129 , V_69 ) ;
V_7 = F_132 ( V_129 , V_130 , 0 ,
F_100 ( V_82 -> type , V_82 -> V_88 ) ) ;
if ( V_7 )
goto V_131;
V_101 = F_133 ( V_129 ) ;
V_7 = - V_38 ;
...
V_69 -> V_101 . V_115 = F_125 ;
V_69 -> V_101 . V_116 = F_128 ;
V_69 -> V_101 . V_112 . V_117 = F_110 ;
V_69 -> V_101 . V_112 . V_118 = F_113 ;
V_69 -> V_101 . V_112 . V_119 = F_121 ;
V_69 -> V_101 . V_112 . V_120 = F_123 ;
...
static void F_135 ( struct V_68 * V_69 )
{
F_136 ( F_78 ( V_69 ) ) ;
F_29 ( V_69 ) ;
}
static inline struct V_135 * F_137 (
struct V_2 * V_3 )
{
unsigned long V_4 = F_2 ( F_3 ( V_3 ) ) ;
return ( void * ) F_4 ( ( V_5 * ) F_5 ( V_3 ) , V_4 + 1 ) ;
}
static int F_138 ( struct V_13 * V_122 , const V_5 * V_15 ,
unsigned int V_16 )
{
...
static int F_139 ( struct V_13 * V_122 ,
unsigned int V_37 )
{
struct V_136 * V_18 = F_9 ( V_122 ) ;
if ( V_37 != 16 )
...
static struct V_2 * F_140 ( struct V_2 * V_3 ,
int V_137 )
{
struct V_13 * V_14 = F_3 ( V_3 ) ;
struct V_136 * V_18 = F_9 ( V_14 ) ;
struct V_135 * V_138 = F_137 ( V_3 ) ;
struct V_2 * V_126 = & V_138 -> V_126 ;
struct V_25 * V_42 = V_3 -> V_42 ;
struct V_25 * V_139 = V_138 -> V_139 ;
struct V_25 * V_140 = V_138 -> V_140 ;
struct V_25 * V_63 = V_138 -> V_63 ;
unsigned int V_37 = F_67 ( V_14 ) ;
unsigned int V_57 = V_3 -> V_57 ;
struct V_141 * V_142 ;
V_5 * V_143 ;
V_5 * V_24 = F_4 ( ( V_5 * ) ( V_138 + 1 ) + F_116 ( V_18 -> V_124 ) ,
F_2 ( V_18 -> V_124 ) + 1 ) ;
memcpy ( V_24 , V_18 -> V_125 , 4 ) ;
memcpy ( V_24 + 4 , V_3 -> V_24 , 8 ) ;
if ( V_137 )
...
F_66 ( V_138 -> V_44 , V_42 ,
V_3 -> V_40 - V_37 ,
V_37 , 0 ) ;
F_19 ( V_139 , V_138 -> V_44 , V_37 ) ;
V_142 = F_141 ( V_42 ) ;
V_143 = F_142 ( V_142 ) ? NULL : F_143 ( V_142 ) + V_42 -> V_144 ;
F_33 ( V_140 , 2 ) ;
F_34 ( V_140 , V_3 -> V_24 , 8 ) ;
F_144 ( V_140 , V_42 , V_143 == V_3 -> V_24 + 8 , 2 ) ;
V_57 += 8 + V_3 -> V_40 - ( V_137 ? 0 : V_37 ) ;
if ( V_3 -> V_63 -> V_145 == V_3 -> V_57 ) {
F_33 ( V_63 , 2 ) ;
F_145 ( V_63 , F_141 ( V_3 -> V_63 ) , V_3 -> V_63 -> V_145 ,
V_3 -> V_63 -> V_144 ) ;
} else {
F_53 ( V_3 -> V_57 > sizeof( V_138 -> V_146 ) ) ;
F_66 ( V_138 -> V_146 , V_3 -> V_63 , 0 ,
V_3 -> V_57 , 0 ) ;
F_33 ( V_63 , 2 ) ;
F_34 ( V_63 , V_138 -> V_146 , V_3 -> V_57 ) ;
}
F_144 ( V_63 , V_140 , 0 , 2 ) ;
F_117 ( V_126 , V_18 -> V_124 ) ;
F_118 ( V_126 , V_3 -> V_64 . V_127 , V_3 -> V_64 . F_7 ,
V_3 -> V_64 . V_10 ) ;
F_119 ( V_126 , V_139 , V_139 , V_137 ? 0 : V_37 , V_24 ) ;
F_120 ( V_126 , V_63 , V_57 ) ;
return V_126 ;
}
...
static int F_148 ( struct V_67 * V_36 )
{
struct V_68 * V_69 = ( void * ) V_36 -> V_70 ;
struct V_128 * V_129 = F_78 ( V_69 ) ;
...
static void F_149 ( struct V_67 * V_36 )
{
struct V_136 * V_18 = F_62 ( V_36 ) ;
F_129 ( V_18 -> V_124 ) ;
}
static struct V_68 * F_150 ( struct V_76 * * V_77 )
{
struct V_81 * V_82 ;
struct V_68 * V_69 ;
struct V_128 * V_129 ;
...
V_69 -> V_101 . V_115 = F_148 ;
V_69 -> V_101 . V_116 = F_149 ;
V_69 -> V_101 . V_112 . V_117 = F_138 ;
V_69 -> V_101 . V_112 . V_118 = F_139 ;
V_69 -> V_101 . V_112 . V_119 = F_146 ;
V_69 -> V_101 . V_112 . V_120 = F_147 ;
V_69 -> V_101 . V_112 . V_134 = L_6 ;
V_35:
return V_69 ;
V_132:
...
static void F_151 ( struct V_68 * V_69 )
{
F_136 ( F_78 ( V_69 ) ) ;
F_29 ( V_69 ) ;
}
