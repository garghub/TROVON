...
F_18 ( V_23 ) ;
V_128 -> V_129 = V_130 ;
memcpy ( & V_128 -> V_131 , V_23 -> V_40 -> V_132 , V_18 ) ;
#if 1
...
V_69 = F_27 ( & ( V_23 -> V_29 ) , ( V_62 ) & ( V_23 -> V_60 ) ) ;
if( V_69 == V_63 ) {
memcpy ( & V_128 -> V_131 , V_23 -> V_60 . V_17 . T_3 , V_18 ) ;
} else {
V_8 = - V_64 ;
}
}
...
V_214 . V_221 = V_115 ;
V_214 . V_17 . V_128 . V_129 = V_130 ;
memcpy ( V_214 . V_17 . V_128 . V_131 , V_215 -> V_155 , V_18 ) ;
V_214 . V_14 = V_222 ;
...
if( V_69 == V_63 ) {
memset ( & V_313 , 0 , sizeof( V_313 ) ) ;
memcpy ( V_313 . V_3 . V_131 , V_23 -> V_60 . V_17 . T_3 , V_18 ) ;
...
union V_43 V_313 ;
memset ( & V_313 , 0 , sizeof( V_313 ) ) ;
memcpy ( V_313 . V_3 . V_131 , V_40 -> V_132 , V_18 ) ;
V_313 . V_3 . V_129 = V_130 ;
...
memcpy ( V_324 . V_335 . V_131 , V_326 , V_18 ) ;
