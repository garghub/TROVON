...
void
F_34 ( struct V_1 * V_2 , int V_22 , T_1 * V_85 ,
T_1 type , int V_86 )
{
struct V_3 * V_4 ;
struct V_87 * V_88 ;
...
memcpy ( V_96 . V_59 , V_95 -> V_59 , V_24 ) ;
V_96 . V_97 |=
F_28 ( ( T_2 ) V_95 -> V_22 << V_98 ) ;
V_96 . V_97 |= F_28 (
( T_2 ) V_95 -> V_99 << V_100 ) ;
...
void F_42 ( struct V_105 * V_31 , T_1 V_9 )
{
struct V_1 * V_2 ;
struct V_3 * V_4 ;
unsigned long V_106 ;
int V_7 ;
for ( V_7 = 0 ; V_7 < V_31 -> V_107 ; V_7 ++ ) {
V_2 = V_31 -> V_2 [ V_7 ] ;
if ( ! V_2 )
continue;
if ( F_43 ( & V_2 -> V_26 ) )
