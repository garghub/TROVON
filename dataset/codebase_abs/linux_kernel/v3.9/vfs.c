...
V_276 = V_266 -> V_29 ;
V_281 = V_276 -> V_21 ;
V_11 = ( V_2 -> V_211 == 2 ) ? V_126 : V_283 ;
if ( V_265 -> V_30 != V_266 -> V_30 )
goto V_12;
V_11 = V_127 ;
...
if ( ! type )
type = V_287 -> V_21 -> V_37 & V_288 ;
V_28 = F_33 ( V_287 -> V_21 ) ;
if ( V_28 )
goto V_289;
if ( type != V_33 )
V_28 = F_144 ( V_225 , V_287 ) ;
else
V_28 = F_145 ( V_225 , V_287 ) ;
if ( ! V_28 )
V_28 = F_36 ( V_23 ) ;
V_289:
F_15 ( V_287 ) ;
...
static int F_146 ( void * V_290 , const char * V_24 , int V_291 ,
T_9 V_180 , T_12 V_144 , unsigned int V_292 )
{
struct V_293 * V_85 = V_290 ;
struct V_294 * V_295 = ( void * ) ( V_85 -> V_296 + V_85 -> V_297 ) ;
unsigned int V_298 ;
V_298 = F_147 ( sizeof( struct V_294 ) + V_291 , sizeof( T_12 ) ) ;
if ( V_85 -> V_297 + V_298 > V_299 ) {
V_85 -> V_300 = 1 ;
return - V_100 ;
}
V_295 -> V_291 = V_291 ;
...
V_295 -> V_144 = V_144 ;
V_295 -> V_292 = V_292 ;
memcpy ( V_295 -> V_24 , V_24 , V_291 ) ;
V_85 -> V_297 += V_298 ;
return 0 ;
}
static T_1 F_148 ( struct V_132 * V_132 , T_13 V_301 ,
struct V_302 * V_303 , T_9 * V_304 )
{
struct V_293 V_85 ;
struct V_294 * V_295 ;
int V_28 ;
int V_176 ;
T_9 V_180 ;
V_85 . V_296 = ( void * ) F_149 ( V_88 ) ;
if ( ! V_85 . V_296 )
return F_28 ( - V_89 ) ;
V_180 = * V_304 ;
while ( 1 ) {
struct V_36 * V_305 = F_101 ( V_132 ) ;
unsigned int V_298 ;
V_303 -> V_11 = V_306 ;
V_85 . V_297 = 0 ;
V_85 . V_300 = 0 ;
...
if ( ! V_176 )
break;
V_28 = F_151 ( & V_305 -> V_197 ) ;
if ( V_28 )
break;
V_295 = (struct V_294 * ) V_85 . V_296 ;
while ( V_176 > 0 ) {
V_180 = V_295 -> V_180 ;
if ( V_301 ( V_303 , V_295 -> V_24 , V_295 -> V_291 , V_295 -> V_180 ,
V_295 -> V_144 , V_295 -> V_292 ) )
break;
if ( V_303 -> V_11 != V_124 )
break;
V_298 = F_147 ( sizeof( * V_295 ) + V_295 -> V_291 ,
sizeof( T_12 ) ) ;
V_176 -= V_298 ;
V_295 = (struct V_294 * ) ( ( char * ) V_295 + V_298 ) ;
}
F_99 ( & V_305 -> V_197 ) ;
if ( V_176 > 0 )
break;
V_180 = F_152 ( V_132 , 0 , V_307 ) ;
}
F_153 ( ( unsigned long ) ( V_85 . V_296 ) ) ;
if ( V_28 )
return F_28 ( V_28 ) ;
* V_304 = V_180 ;
return V_303 -> V_11 ;
...
T_1
F_154 ( struct V_1 * V_2 , struct V_22 * V_23 , T_9 * V_304 ,
struct V_302 * V_303 , T_13 V_301 )
{
T_1 V_11 ;
struct V_132 * V_132 ;
T_9 V_180 = * V_304 ;
...
if ( V_11 )
goto V_12;
V_180 = F_152 ( V_132 , V_180 , V_308 ) ;
if ( V_180 < 0 ) {
V_11 = F_28 ( ( int ) V_180 ) ;
goto V_309;
}
V_11 = F_148 ( V_132 , V_301 , V_303 , V_304 ) ;
if ( V_11 == V_306 || V_11 == V_310 )
V_11 = V_124 ;
V_309:
F_80 ( V_132 ) ;
V_12:
...
T_1
F_155 ( struct V_1 * V_2 , struct V_22 * V_23 , struct V_311 * V_312 , int V_110 )
{
T_1 V_11 ;
...
{
return F_158 ( V_2 , exp ) & V_313 ;
}
T_1
F_45 ( struct V_1 * V_2 , struct V_5 * exp ,
struct V_3 * V_3 , int V_314 )
{
struct V_36 * V_36 = V_3 -> V_21 ;
int V_11 ;
if ( ( V_314 & V_315 ) == V_118 )
return 0 ;
#if 0
...
return 0 ;
V_11 = F_161 ( V_36 , V_314 & ( V_319 | V_320 | V_321 ) ) ;
if ( V_11 == - V_322 && F_34 ( V_36 -> V_37 ) &&
( V_314 == ( V_136 | V_57 ) ||
V_314 == ( V_136 | V_323 ) ) )
V_11 = F_161 ( V_36 , V_321 ) ;
return V_11 ? F_28 ( V_11 ) : 0 ;
}
void
F_162 ( void )
{
struct V_142 * V_324 , * V_325 ;
unsigned int V_326 ;
F_22 ( L_9 ) ;
for ( V_326 = 0 ; V_326 < V_327 ; V_326 ++ ) {
V_324 = V_153 [ V_326 ] . V_155 ;
while( V_324 ) {
V_325 = V_324 ;
V_324 = V_324 -> V_156 ;
F_57 ( V_325 ) ;
}
V_153 [ V_326 ] . V_155 = NULL ;
}
}
int
F_163 ( int V_328 )
...
int V_329 = 0 ;
int V_330 ;
struct V_142 * * V_324 = NULL ;
if ( V_153 [ 0 ] . V_155 )
return 0 ;
V_330 = F_164 ( V_328 , V_327 ) ;
if ( V_330 < 2 )
V_330 = 2 ;
V_328 = V_330 * V_327 ;
F_22 ( L_10 , V_328 ) ;
for ( V_326 = 0 ; V_326 < V_327 ; V_326 ++ ) {
F_165 ( & V_153 [ V_326 ] . V_154 ) ;
V_324 = & V_153 [ V_326 ] . V_155 ;
for ( V_329 = 0 ; V_329 < V_330 ; V_329 ++ ) {
* V_324 = F_166 ( sizeof( struct V_142 ) , V_88 ) ;
if ( ! * V_324 )
goto V_331;
V_324 = & ( * V_324 ) -> V_156 ;
}
...
V_176 = F_54 ( V_23 -> V_29 , V_24 , & V_332 ) ;
if ( V_176 < 0 )
return F_66 ( V_176 ) ;
V_95 = F_67 ( & V_93 , V_332 , V_176 ) ;
F_57 ( V_332 ) ;
return V_95 ;
}
int
...
int error ;
if ( ! F_168 ( V_36 ) ||
! V_36 -> V_229 -> V_335 || ! V_36 -> V_229 -> V_336 )
return - V_105 ;
switch( type ) {
case V_333 :
V_24 = V_102 ;
...
V_332 = F_56 ( V_176 , V_88 ) ;
if ( ! V_332 )
return - V_89 ;
error = F_60 ( & V_93 , V_95 , V_332 , V_176 ) ;
if ( error < 0 )
goto V_337;
V_176 = error ;
} else
...
goto V_337;
if ( V_176 )
error = F_61 ( V_23 -> V_29 , V_24 , V_332 , V_176 , 0 ) ;
else {
if ( ! F_49 ( V_36 -> V_37 ) && type == V_334 )
error = 0 ;
else {
