...
if ( ! V_12 )
goto V_13;
V_3 = F_1 ( V_8 , V_10 , V_14 ) ;
if ( V_3 ) {
F_4 ( & V_6 -> V_15 , L_1 , V_16 , V_3 ) ;
return;
}
V_11 = V_8 [ V_10 - 2 ] >> 2 ;
if ( V_11 > ( V_10 - 2 ) ) {
...
F_5 ( & V_4 -> V_15 -> V_15 , L_3 , V_16 , V_11 ) ;
V_10 = V_11 ;
V_13:
...
{
switch ( V_27 -> V_28 -> V_29 -> V_30 . V_31 ) {
case V_32 :
break;
case V_33 :
V_25 = 1 ;
...
if ( V_36 || V_37 ) {
F_12 ( L_4 , V_36 , V_37 ) ;
for ( V_35 = 0 ; V_35 < F_13 ( V_38 ) ; V_35 ++ ) {
if ( ! V_38 [ V_35 ] . V_39 && ! V_38 [ V_35 ] . V_40 ) {
V_38 [ V_35 ] . V_39 = V_36 ;
V_38 [ V_35 ] . V_40 = V_37 ;
break;
}
