...
F_19 ( V_2 , V_42 ) ;
if ( V_42 == 0x37 ) {
V_41 = F_20 ( V_2 -> V_4 . V_5 -> V_44 ,
V_2 -> V_4 . V_45 ) ;
if ( F_21 ( V_41 ) ) {
V_10 = - V_22 ;
goto V_46;
}
V_10 = F_22 ( ( char V_47 * ) V_41 ,
V_48 ) ;
if ( V_10 ) {
V_10 = - V_22 ;
goto V_46;
}
V_41 = F_20 ( V_2 -> V_4 . V_5 -> V_44 + V_48 ,
V_2 -> V_4 . V_45 ) ;
if ( F_21 ( V_41 ) ) {
V_10 = - V_22 ;
goto V_46;
...
{
V_2 -> V_11 . V_51 ++ ;
F_26 ( V_2 , V_2 -> V_4 . V_5 -> V_52 ) ;
return F_3 ( V_2 , V_2 -> V_4 . V_5 -> V_52 ) ;
}
...
{
T_3 V_55 ;
T_4 V_56 = V_2 -> V_4 . V_5 -> V_23 ;
if ( V_56 & 3 || ( V_56 >> 2 ) >= F_29 ( V_57 ) )
return - V_22 ;
V_55 = V_57 [ V_56 >> 2 ] ;
if ( V_55 )
return V_55 ( V_2 ) ;
