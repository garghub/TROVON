...
V_2 -> V_143 = F_27 ( F_16 ( V_136 -> V_131 ) - V_132 ,
sizeof( V_2 -> V_144 ) ) ;
...
#define F_36 3
#define F_37 1
V_190 -> V_94 . V_93 . V_161 = F_36 ;
V_190 -> V_94 . V_93 . V_12 = F_37 ;
if ( ! F_38 ( V_2 , V_8 -> V_201 ,
( V_54 ) V_2 -> V_202 , 0 ) ) {
struct V_203 * V_204 ;
V_204 = F_38 ( V_2 , V_8 -> V_201 ,
V_205 , 0 ) ;
if ( V_204 )
...
#define F_39 6
#define F_40 2
V_190 -> V_207 . V_208 . V_161 = F_39 ;
V_190 -> V_207 . V_208 . V_12 = F_40 ;
...
F_2 ( V_8 -> V_9 , L_26 ,
V_190 -> V_34 [ 0 ] , V_190 -> V_34 [ 1 ] ,
V_190 -> V_34 [ 2 ] , V_190 -> V_34 [ 3 ] ) ;
F_2 ( V_8 -> V_9 , L_27 ) ;
if ( F_18 ( V_8 ) ) {
V_74 = (struct V_73 * ) V_78 ;
V_74 -> V_19 . type = F_3 ( V_115 ) ;
...
V_2 -> V_99 . V_159 ) ;
return F_48 ( V_2 , V_245 ,
V_221 , 0 , V_15 ) ;
}
static int F_52 ( struct V_1 * V_2 , T_1 * V_258 )
{
T_1 V_83 [ V_247 ] ;
int V_27 ;
if ( ! V_258 || F_53 ( V_258 ) )
...
memcpy ( V_83 , V_258 , V_247 ) ;
V_27 = F_48 ( V_2 , V_259 ,
V_221 , 0 , V_83 ) ;
return V_27 ;
}
int F_54 ( struct V_1 * V_2 , T_1 * V_258 )
{
if ( ! V_2 -> V_152 )
return 0 ;
switch ( V_2 -> V_198 ) {
case V_256 :
return F_52 ( V_2 , V_258 ) ;
case V_200 :
return F_48 ( V_2 ,
V_260 ,
V_221 , 0 , NULL ) ;
case V_261 :
return F_48 ( V_2 , V_262 ,
V_221 , 0 , NULL ) ;
default:
break;
}
