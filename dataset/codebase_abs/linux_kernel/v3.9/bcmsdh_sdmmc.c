...
static int F_44 ( struct V_10 * V_12 ,
...
struct V_74 * V_75 ;
F_15 ( V_42 , L_12 ) ;
F_15 ( V_42 , L_29 , V_12 -> V_76 ) ;
F_15 ( V_42 , L_30 , V_12 -> V_77 ) ;
F_15 ( V_42 , L_31 , V_12 -> V_78 ) ;
F_15 ( V_42 , L_32 , V_12 -> V_20 ) ;
if ( V_12 -> V_20 == 1 )
return 0 ;
if ( V_12 -> V_20 != 2 )
return - V_79 ;
V_75 = F_45 ( sizeof( struct V_74 ) , V_18 ) ;
if ( ! V_75 )
return - V_19 ;
...
V_2 -> V_12 [ 0 ] = V_12 -> V_80 -> V_10 [ 0 ] ;
V_2 -> V_12 [ 1 ] = V_12 -> V_80 -> V_10 [ 0 ] ;
V_2 -> V_12 [ 2 ] = V_12 ;
V_2 -> V_75 = V_75 ;
V_75 -> V_81 . V_82 = V_2 ;
V_75 -> V_83 = V_84 ;
F_46 ( & V_12 -> V_85 , V_75 ) ;
F_46 ( & V_2 -> V_12 [ 1 ] -> V_85 , V_75 ) ;
V_2 -> V_85 = & V_2 -> V_12 [ 1 ] -> V_85 ;
F_47 ( & V_2 -> V_4 , false ) ;
F_48 ( & V_2 -> V_24 ) ;
F_48 ( & V_2 -> V_30 ) ;
F_48 ( & V_2 -> V_43 ) ;
...
F_52 ( V_2 ) ;
F_46 ( & V_2 -> V_12 [ 1 ] -> V_85 , NULL ) ;
F_46 ( & V_2 -> V_12 [ 2 ] -> V_85 , NULL ) ;
F_12 ( V_75 ) ;
F_12 ( V_2 ) ;
}
F_15 ( V_42 , L_17 ) ;
}
static int F_53 ( struct V_78 * V_85 )
{
T_6 V_87 ;
struct V_74 * V_75 = F_51 ( V_85 ) ;
struct V_1 * V_2 = V_75 -> V_81 . V_82 ;
int V_49 = 0 ;
F_15 ( V_42 , L_21 ) ;
F_47 ( & V_2 -> V_4 , true ) ;
V_87 = F_54 ( V_2 -> V_12 [ 1 ] ) ;
if ( ! ( V_87 & V_88 ) ) {
F_8 ( L_37 ) ;
return - V_29 ;
}
V_49 = F_55 ( V_2 -> V_12 [ 1 ] , V_88 ) ;
if ( V_49 ) {
F_8 ( L_38 ) ;
return V_49 ;
}
...
static int F_57 ( struct V_78 * V_85 )
{
struct V_74 * V_75 = F_51 ( V_85 ) ;
struct V_1 * V_2 = V_75 -> V_81 . V_82 ;
F_56 ( V_2 , true ) ;
