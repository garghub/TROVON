...
F_66 ( & V_2 -> V_179 , V_180 ) ;
F_67 ( & V_2 -> F_16 . V_181 , V_182 ,
( unsigned long ) V_2 ) ;
F_68 ( V_55 , & V_79 ) ;
V_55 -> V_183 = V_79 << 2 ;
V_26 = F_69 ( V_10 ) ;
...
if ( V_26 )
goto V_185;
for ( V_67 = 0 ; V_67 < V_186 ; V_67 ++ )
V_2 -> V_187 . V_188 [ V_67 ] = NULL ;
F_70 ( V_10 ) ;
F_57 ( V_2 ) ;
F_58 ( V_2 ) ;
F_71 ( V_2 , V_144 ) ;
...
F_73 ( V_202 ) |
F_73 ( V_203 ) ;
V_12 -> V_13 -> V_204 = & V_205 ;
V_12 -> V_13 -> V_206 = 1 ;
V_12 -> V_13 -> V_189 &= ~ V_207 ;
V_12 -> V_13 -> V_189 |= V_208 |
V_209 ;
V_12 -> V_210 = 4 ;
V_12 -> V_211 = 5000 ;
V_12 -> V_212 = 1 ;
V_12 -> V_213 = sizeof( struct V_214 ) ;
V_12 -> V_215 = sizeof( struct V_216 ) ;
V_12 -> V_217 = sizeof( struct V_218 ) +
sizeof( struct V_219 ) + 4 ;
if ( V_2 -> V_10 -> V_100 . V_101 & V_126 )
V_12 -> V_13 -> V_220 [ V_128 ] =
& V_2 -> V_127 [ V_128 ] ;
if ( V_2 -> V_10 -> V_100 . V_101 & V_136 )
V_12 -> V_13 -> V_220 [ V_137 ] =
& V_2 -> V_127 [ V_137 ] ;
if ( V_2 -> V_10 -> V_100 . V_101 & V_221 ) {
if ( V_2 -> V_10 -> V_100 . V_101 & V_126 )
F_49 ( V_2 ,
& V_2 -> V_127 [ V_128 ] . V_222 ) ;
if ( V_2 -> V_10 -> V_100 . V_101 & V_136 )
F_49 ( V_2 ,
& V_2 -> V_127 [ V_137 ] . V_222 ) ;
}
F_74 ( V_12 , V_55 -> V_223 ) ;
}
...
if ( V_26 )
return - V_125 ;
V_2 -> V_227 = F_77 ( V_225 . V_228 ) ;
V_2 -> V_229 = F_77 ( V_225 . V_230 ) ;
snprintf ( V_12 -> V_13 -> V_231 , sizeof( V_12 -> V_13 -> V_231 ) , L_16 ,
V_2 -> V_227 ,
V_2 -> V_229 ) ;
F_22 ( V_2 -> V_8 , L_17 ,
V_2 -> V_227 ,
...
if ( error != 0 )
goto V_237;
error = F_79 ( & V_55 -> V_238 , V_2 -> V_12 -> V_13 ,
F_23 ) ;
if ( error )
goto V_239;
V_57 = & V_55 -> V_238 ;
...
goto V_246;
if ( ! F_85 ( V_57 ) ) {
error = F_86 ( V_12 -> V_13 , V_57 -> V_247 ) ;
if ( error )
goto V_248;
}
error = F_87 ( V_2 -> V_10 ) ;
...
V_2 -> V_45 ,
V_2 -> V_47 ) ;
F_88 ( V_2 -> V_10 , V_235 , sizeof( V_235 ) ) ;
F_89 ( V_12 -> V_13 , L_21 , V_235 ) ;
F_90 ( V_2 ) ;
F_91 ( V_2 ) ;
return 0 ;
V_248:
...
int F_92 ( struct V_249 * V_250 , struct V_251 * V_8 ,
T_1 V_24 , char * V_144 , T_2 V_25 )
{
struct V_11 * V_12 ;
struct V_1 * V_2 ;
int V_26 ;
V_12 = F_93 ( sizeof( struct V_1 ) , & V_252 ) ;
if ( ! V_12 )
return - V_148 ;
V_2 = V_12 -> V_2 ;
V_2 -> V_12 = V_12 ;
...
void F_98 ( struct V_249 * V_250 , bool V_255 )
{
if ( V_250 -> V_253 ) {
if ( V_255 )
V_250 -> V_253 -> V_10 -> V_151 |= V_256 ;
F_9 ( V_250 -> V_253 ) ;
F_96 ( V_250 -> V_253 ) ;
F_97 ( V_250 -> V_253 -> V_12 ) ;
}
}
void F_99 ( struct V_249 * V_250 )
{
F_100 ( V_250 -> V_253 , V_257 ) ;
}
int F_101 ( struct V_249 * V_250 )
{
struct V_1 * V_2 = V_250 -> V_253 ;
int V_26 ;
V_26 = F_1 ( V_2 ) ;
if ( V_26 )
return V_26 ;
