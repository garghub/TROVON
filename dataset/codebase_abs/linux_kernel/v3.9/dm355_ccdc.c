...
V_2 . V_308 = F_51 ( & V_295 -> V_24 , L_27 ) ;
if ( F_52 ( V_2 . V_308 ) ) {
V_298 = F_53 ( V_2 . V_308 ) ;
goto V_309;
}
if ( F_54 ( V_2 . V_308 ) ) {
V_298 = - V_301 ;
...
V_2 . V_311 = F_51 ( & V_295 -> V_24 , L_28 ) ;
if ( F_52 ( V_2 . V_311 ) ) {
V_298 = F_53 ( V_2 . V_311 ) ;
goto V_310;
}
if ( F_54 ( V_2 . V_311 ) ) {
V_298 = - V_301 ;
...
if ( NULL == V_295 -> V_24 . V_313 ) {
V_298 = - V_301 ;
goto V_312;
}
F_45 = V_295 -> V_24 . V_313 ;
F_45 () ;
V_2 . V_24 = & V_295 -> V_24 ;
F_55 ( V_314 L_29 , V_299 . V_304 ) ;
return 0 ;
V_312:
F_56 ( V_2 . V_311 ) ;
F_57 ( V_2 . V_311 ) ;
...
F_58 ( V_2 . V_3 ) ;
V_307:
F_59 ( V_297 -> V_303 , F_49 ( V_297 ) ) ;
V_302:
F_60 ( & V_299 ) ;
return V_298 ;
}
static int F_61 ( struct V_294 * V_295 )
{
struct V_296 * V_297 ;
F_56 ( V_2 . V_311 ) ;
F_56 ( V_2 . V_308 ) ;
