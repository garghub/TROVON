...
F_97 ( & V_2 -> V_45 ) ;
F_40 ( V_2 , V_219 , V_220 ) ;
F_98 ( & V_2 -> V_45 ) ;
V_180 = 50 ;
while ( ( F_7 ( V_2 , V_221 ) & V_222 ) &&
-- V_180 ) {
F_44 ( 10 ) ;
}
if ( F_38 ( V_180 == 0 ) )
...
F_14 ( V_2 , V_229 , V_217 ) ;
F_46 ( V_2 , V_223 , L_70 , V_28 -> V_135 ) ;
V_2 -> V_230 = 0 ;
F_99 () ;
V_35 = F_7 ( V_2 , V_191 ) ;
V_35 |= V_231 ;
...
F_102 ( & V_2 -> V_184 ) ;
V_35 = F_7 ( V_2 , V_191 ) ;
V_35 |= ( V_235 | V_192 | V_236 ) ;
F_14 ( V_2 , V_191 , V_35 ) ;
F_97 ( & V_2 -> V_45 ) ;
V_35 = F_37 ( V_2 , V_99 ) ;
V_35 |= ( V_101 | V_102 | V_237 ) ;
F_40 ( V_2 , V_99 , V_35 ) ;
F_98 ( & V_2 -> V_45 ) ;
F_14 ( V_2 , V_94 , V_95 ) ;
F_103 ( V_28 ) ;
...
static int F_104 ( struct V_23 * V_28 )
{
struct V_1 * V_2 = F_24 ( V_28 ) ;
unsigned int V_35 ;
V_35 = F_7 ( V_2 , V_229 ) ;
...
F_105 ( V_28 ) ;
F_106 ( & V_2 -> V_184 ) ;
V_28 -> V_159 . V_195 += F_7 ( V_2 , V_238 ) ;
F_71 ( V_28 ) ;
if ( V_2 -> V_88 )
F_107 ( V_2 -> V_88 ) ;
F_46 ( V_2 , V_239 , L_74 ) ;
...
static int F_108 ( struct V_187 * V_188 , struct V_23 * V_28 )
{
struct V_1 * V_2 = F_24 ( V_28 ) ;
unsigned int V_240 ;
unsigned int V_241 ;
...
T_1 V_69 ;
T_3 V_71 ;
V_240 = F_7 ( V_2 , V_62 ) & V_243 ;
if ( F_38 ( V_240 < V_244 ) )
F_36 ( V_2 , V_245 ,
L_75 , V_240 ) ;
V_241 = ( T_1 ) ( ( T_3 ) V_188 -> V_9 & 0x03 ) << 16 ;
V_241 |= V_79 | V_80 ;
V_241 |= ( unsigned int ) V_188 -> V_246 ;
V_242 = ( ( unsigned int ) V_188 -> V_246 ) << 16 ;
V_242 |= ( unsigned int ) V_188 -> V_246 ;
F_14 ( V_2 , V_18 , V_241 ) ;
F_14 ( V_2 , V_18 , V_242 ) ;
V_71 = ( T_3 ) V_188 -> V_9 & ( ~ 0x3 ) ;
V_69 = ( T_1 ) V_188 -> V_246 + 3 ;
V_69 += ( T_1 ) ( ( T_3 ) V_188 -> V_9 & 0x3 ) ;
V_69 >>= 2 ;
V_2 -> V_11 -> V_81 ( V_2 , ( unsigned int * ) V_71 , V_69 ) ;
V_240 -= ( V_188 -> V_246 + 32 ) ;
F_109 ( V_188 ) ;
F_110 ( V_188 ) ;
if ( F_38 ( F_70 ( V_2 ) >= 30 ) )
F_71 ( V_28 ) ;
...
static struct V_248 * F_111 ( struct V_23 * V_28 )
{
struct V_1 * V_2 = F_24 ( V_28 ) ;
F_71 ( V_28 ) ;
V_28 -> V_159 . V_195 += F_7 ( V_2 , V_238 ) ;
...
static void F_112 ( struct V_23 * V_28 )
{
struct V_1 * V_2 = F_24 ( V_28 ) ;
unsigned long V_5 ;
if ( V_28 -> V_5 & V_249 ) {
...
V_2 -> V_202 = 0 ;
V_2 -> V_204 = 0 ;
} else if ( V_28 -> V_5 & V_253 ) {
V_2 -> V_199 = V_251 ;
V_2 -> V_200 = ( V_250 | V_252 ) ;
V_2 -> V_202 = 0 ;
V_2 -> V_204 = 0 ;
} else if ( ! F_113 ( V_28 ) ) {
...
struct V_256 * V_257 ;
V_2 -> V_199 = V_252 ;
V_2 -> V_200 = ( V_250 | V_251 ) ;
F_114 (ha, dev) {
unsigned int V_258 = F_83 ( V_257 -> V_44 ) ;
...
static T_5 F_115 ( int V_135 , void * V_260 )
{
struct V_23 * V_28 = V_260 ;
struct V_1 * V_2 = F_24 ( V_28 ) ;
T_1 V_261 = F_7 ( V_2 , V_189 ) ;
T_1 V_262 = F_7 ( V_2 , V_191 ) ;
int V_263 = V_264 ;
T_1 V_35 ;
if ( F_38 ( V_261 & V_262 & V_265 ) ) {
V_35 = F_7 ( V_2 , V_191 ) ;
V_35 &= ( ~ V_231 ) ;
F_14 ( V_2 , V_191 , V_35 ) ;
F_14 ( V_2 , V_189 , V_265 ) ;
V_2 -> V_230 = 1 ;
F_99 () ;
V_263 = V_266 ;
}
if ( F_38 ( V_261 & V_262 & V_267 ) ) {
F_46 ( V_2 , V_268 , L_77 ) ;
F_14 ( V_2 , V_189 , V_267 ) ;
if ( V_2 -> V_205 )
F_86 ( V_2 ) ;
V_263 = V_266 ;
}
...
V_35 |= V_233 ;
F_14 ( V_2 , V_232 , V_35 ) ;
F_14 ( V_2 , V_189 , V_269 ) ;
F_116 ( V_28 ) ;
V_263 = V_266 ;
}
if ( F_38 ( V_261 & V_262 & V_270 ) ) {
F_46 ( V_2 , V_268 , L_78 ) ;
F_14 ( V_2 , V_189 , V_270 ) ;
V_263 = V_266 ;
}
if ( F_39 ( V_261 & V_262 & V_190 ) ) {
if ( F_39 ( F_117 ( & V_2 -> V_184 ) ) ) {
V_35 = F_7 ( V_2 , V_191 ) ;
V_35 &= ( ~ V_192 ) ;
F_14 ( V_2 , V_191 , V_35 ) ;
F_118 ( & V_2 -> V_184 ) ;
...
static void F_119 ( struct V_23 * V_28 )
{
F_120 ( V_28 -> V_135 ) ;
F_115 ( 0 , V_28 ) ;
F_121 ( V_28 -> V_135 ) ;
}
static int F_122 ( struct V_23 * V_28 , void * V_271 )
{
struct V_1 * V_2 = F_24 ( V_28 ) ;
struct V_272 * V_44 = V_271 ;
if ( V_2 -> V_210 <= 1 && F_123 ( V_28 ) )
return - V_273 ;
if ( ! F_124 ( V_44 -> V_274 ) )
return - V_275 ;
memcpy ( V_28 -> V_212 , V_44 -> V_274 , V_91 ) ;
F_97 ( & V_2 -> V_45 ) ;
F_94 ( V_2 , V_28 -> V_212 ) ;
F_98 ( & V_2 -> V_45 ) ;
F_62 ( V_28 , L_80 , V_28 -> V_212 ) ;
return 0 ;
}
static int F_125 ( struct V_23 * V_28 , struct V_276 * V_277 , int V_278 )
{
struct V_1 * V_2 = F_24 ( V_28 ) ;
if ( ! F_123 ( V_28 ) || ! V_2 -> V_88 )
return - V_279 ;
return F_126 ( V_2 -> V_88 , V_277 , V_278 ) ;
}
static int
F_127 ( struct V_23 * V_28 , struct V_280 * V_278 )
{
struct V_1 * V_2 = F_24 ( V_28 ) ;
V_278 -> V_281 = 1 ;
V_278 -> V_282 = 1 ;
return F_128 ( V_2 -> V_88 , V_278 ) ;
}
static int
F_129 ( struct V_23 * V_28 , struct V_280 * V_278 )
{
struct V_1 * V_2 = F_24 ( V_28 ) ;
return F_130 ( V_2 -> V_88 , V_278 ) ;
}
static void F_131 ( struct V_23 * V_28 ,
struct V_283 * V_284 )
{
F_132 ( V_284 -> V_285 , V_286 , sizeof( V_284 -> V_285 ) ) ;
F_132 ( V_284 -> V_287 , V_288 , sizeof( V_284 -> V_287 ) ) ;
F_132 ( V_284 -> V_289 , F_63 ( V_28 -> V_28 . V_153 ) ,
sizeof( V_284 -> V_289 ) ) ;
}
...
static void F_136 ( struct V_23 * V_28 , T_1 V_291 )
{
struct V_1 * V_2 = F_24 ( V_28 ) ;
V_2 -> V_290 = V_291 ;
}
...
{
return ( ( ( V_292 - V_293 ) / 4 + 1 ) + ( V_294 - V_99 ) + 1 + 32 ) *
sizeof( T_1 ) ;
}
static void
F_138 ( struct V_23 * V_28 , struct V_295 * V_296 ,
void * V_15 )
{
struct V_1 * V_2 = F_24 ( V_28 ) ;
struct V_87 * V_88 = V_2 -> V_88 ;
...
unsigned int V_85 = 0 ;
T_1 * V_9 = V_15 ;
V_296 -> V_287 = V_2 -> V_154 ;
for ( V_29 = V_293 ; V_29 <= V_292 ; V_29 += ( sizeof( T_1 ) ) )
V_9 [ V_85 ++ ] = F_7 ( V_2 , V_29 ) ;
for ( V_29 = V_99 ; V_29 <= V_294 ; V_29 ++ ) {
F_8 ( & V_2 -> V_45 , V_5 ) ;
...
static int F_140 ( struct V_1 * V_2 , T_1 V_298 )
{
int V_180 = 100 ;
T_1 V_299 ;
F_46 ( V_2 , V_133 , L_81 , V_298 ) ;
if ( F_7 ( V_2 , V_221 ) & V_222 ) {
F_36 ( V_2 , V_133 , L_82 ) ;
return - V_273 ;
}
V_299 = V_298 | V_222 ;
F_14 ( V_2 , V_221 , V_299 ) ;
do {
F_52 ( 1 ) ;
V_299 = F_7 ( V_2 , V_221 ) ;
} while ( ( V_299 & V_222 ) && ( -- V_180 ) );
if ( ! V_180 ) {
F_46 ( V_2 , V_133 , L_83 ) ;
return - V_218 ;
}
...
int V_25 ;
F_46 ( V_2 , V_133 , L_85 , V_301 ) ;
V_25 = F_140 ( V_2 , V_298 ) ;
if ( ! V_25 )
...
int V_29 ;
F_139 ( V_2 ) ;
V_246 = F_145 ( V_307 -> V_246 , V_305 ) ;
for ( V_29 = 0 ; V_29 < V_246 ; V_29 ++ ) {
int V_25 = F_141 ( V_2 , V_29 , V_308 ) ;
if ( V_25 < 0 ) {
V_307 -> V_246 = 0 ;
return V_25 ;
}
}
memcpy ( V_9 , & V_308 [ V_307 -> V_34 ] , V_246 ) ;
V_307 -> V_246 = V_246 ;
return 0 ;
}
...
F_139 ( V_2 ) ;
F_140 ( V_2 , V_309 ) ;
V_25 = F_142 ( V_2 , V_307 -> V_34 , * V_9 ) ;
F_140 ( V_2 , V_310 ) ;
V_307 -> V_246 = 1 ;
return V_25 ;
}
static void F_147 ( struct V_23 * V_28 )
{
struct V_1 * V_2 = F_24 ( V_28 ) ;
...
static int F_148 ( struct V_23 * V_28 )
{
struct V_1 * V_2 = F_24 ( V_28 ) ;
...
F_46 ( V_2 , V_130 , L_89 , V_28 -> V_135 ) ;
F_46 ( V_2 , V_130 , L_90 ) ;
F_149 ( & V_2 -> V_10 ) ;
F_149 ( & V_2 -> V_45 ) ;
if ( V_2 -> V_7 == 0 ) {
...
V_259 = V_313 | F_150 ( V_313 ) ;
while ( ! ( F_7 ( V_2 , V_314 ) & V_259 ) && -- V_312 )
F_44 ( 1000 ) ;
if ( V_312 == 0 ) {
F_151 ( L_92 ) ;
return - V_129 ;
...
F_152 ( V_28 ) ;
V_28 -> V_5 |= V_317 ;
F_153 ( V_28 , & V_2 -> V_184 , F_74 , V_318 ) ;
V_28 -> V_319 = & V_320 ;
V_28 -> V_321 = & V_322 ;
return 0 ;
}
...
F_156 ( V_22 , NULL ) ;
F_157 ( V_28 ) ;
F_158 ( V_28 -> V_135 , V_28 ) ;
V_324 = F_159 ( V_22 , V_325 ,
L_103 ) ;
if ( ! V_324 )
V_324 = F_160 ( V_22 , V_325 , 0 ) ;
F_161 ( V_324 -> V_326 , F_162 ( V_324 ) ) ;
F_163 ( V_2 -> V_7 ) ;
( void ) F_28 ( V_22 ) ;
F_32 ( V_22 ) ;
F_164 ( V_28 ) ;
...
static int F_165 ( struct V_327 * V_4 ,
struct V_328 * V_329 )
{
const char * V_330 ;
T_1 V_331 = 0 ;
if ( ! V_329 )
return - V_129 ;
V_4 -> V_132 = F_166 ( V_329 ) ;
V_330 = F_167 ( V_329 ) ;
if ( V_330 )
memcpy ( V_4 -> V_330 , V_330 , V_91 ) ;
F_168 ( V_329 , L_104 , & V_4 -> V_332 ) ;
F_168 ( V_329 , L_105 , & V_331 ) ;
if ( V_331 == 4 )
V_4 -> V_5 |= V_6 ;
else
V_4 -> V_5 |= V_8 ;
if ( F_169 ( V_329 , L_106 , NULL ) )
V_4 -> V_225 = V_333 ;
if ( F_169 ( V_329 , L_107 , NULL ) )
V_4 -> V_227 = V_334 ;
if ( F_169 ( V_329 , L_108 , NULL ) )
V_4 -> V_5 |= V_57 ;
if ( F_169 ( V_329 , L_109 , NULL ) )
V_4 -> V_5 |= V_59 ;
if ( F_169 ( V_329 , L_110 , NULL ) )
V_4 -> V_5 |= V_316 ;
return 0 ;
}
...
{
struct V_328 * V_329 = V_22 -> V_28 . V_335 ;
struct V_23 * V_28 ;
struct V_1 * V_2 ;
struct V_327 * V_4 = V_22 -> V_28 . V_336 ;
struct V_323 * V_324 , * V_337 ;
...
V_338 = F_162 ( V_324 ) ;
V_337 = F_160 ( V_22 , V_342 , 0 ) ;
if ( ! V_337 ) {
F_172 ( L_113 ) ;
V_340 = - V_129 ;
goto V_341;
}
if ( ! F_173 ( V_324 -> V_326 , V_338 , V_286 ) ) {
V_340 = - V_273 ;
goto V_341;
}
V_28 = F_174 ( sizeof( struct V_1 ) ) ;
if ( ! V_28 ) {
V_340 = - V_143 ;
goto V_343;
}
F_175 ( V_28 , & V_22 -> V_28 ) ;
V_2 = F_24 ( V_28 ) ;
V_28 -> V_135 = V_337 -> V_326 ;
V_339 = V_337 -> V_5 & V_344 ;
V_2 -> V_7 = F_176 ( V_324 -> V_326 , V_338 ) ;
V_2 -> V_28 = V_28 ;
V_2 -> V_290 = ( ( 1 << V_345 ) - 1 ) ;
F_156 ( V_22 , V_28 ) ;
V_340 = F_30 ( V_22 ) ;
...
goto V_347;
if ( V_2 -> V_7 == NULL ) {
F_36 ( V_2 , V_130 , L_114 ) ;
V_340 = - V_143 ;
goto V_348;
}
V_340 = F_165 ( & V_2 -> V_4 , V_329 ) ;
if ( V_340 && V_4 ) {
...
if ( V_340 < 0 )
goto V_348;
if ( V_2 -> V_4 . V_225 == V_333 )
V_217 |= V_226 ;
if ( V_2 -> V_4 . V_227 == V_334 )
V_217 |= V_228 ;
F_14 ( V_2 , V_229 , V_217 ) ;
F_95 ( V_28 ) ;
V_340 = F_177 ( V_28 -> V_135 , F_115 ,
V_339 | V_351 , V_28 -> V_134 , V_28 ) ;
if ( V_340 ) {
F_36 ( V_2 , V_130 ,
L_116 , V_28 -> V_135 ) ;
goto V_348;
...
V_340 = F_178 ( V_28 ) ;
if ( V_340 ) {
F_36 ( V_2 , V_130 , L_117 , V_340 ) ;
goto V_352;
} else {
F_46 ( V_2 , V_130 ,
L_118 , V_28 -> V_134 ) ;
}
V_340 = F_65 ( V_22 , V_28 ) ;
if ( V_340 ) {
F_36 ( V_2 , V_130 , L_119 , V_340 ) ;
goto V_353;
}
F_97 ( & V_2 -> V_45 ) ;
if ( F_124 ( V_28 -> V_212 ) ) {
...
F_46 ( V_2 , V_130 ,
L_120 ) ;
} else if ( F_124 ( V_2 -> V_4 . V_330 ) ) {
memcpy ( V_28 -> V_212 , V_2 -> V_4 . V_330 , 6 ) ;
F_46 ( V_2 , V_130 ,
L_121 ) ;
} else {
F_179 ( V_28 ) ;
...
static int F_181 ( struct V_354 * V_28 )
{
struct V_23 * V_24 = F_182 ( V_28 ) ;
struct V_1 * V_2 = F_24 ( V_24 ) ;
F_14 ( V_2 , V_314 ,
V_355 | V_356 |
V_357 | V_358 ) ;
...
static int F_183 ( struct V_354 * V_28 )
{
struct V_23 * V_24 = F_182 ( V_28 ) ;
struct V_1 * V_2 = F_24 ( V_24 ) ;
unsigned int V_312 = 100 ;
F_14 ( V_2 , V_37 , 0 ) ;
while ( ! ( F_7 ( V_2 , V_314 ) & V_313 ) && -- V_312 )
F_44 ( 1000 ) ;
return ( V_312 == 0 ) ? - V_33 : 0 ;
}
