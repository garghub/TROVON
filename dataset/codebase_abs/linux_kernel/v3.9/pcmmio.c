...
int V_140 ;
V_2 -> V_141 = V_2 -> V_142 -> V_143 ;
V_41 = V_134 -> V_144 [ 0 ] ;
V_63 [ 0 ] = V_134 -> V_144 [ 1 ] ;
F_3 ( V_145 L_7 , V_2 -> V_146 ,
V_2 -> V_141 , V_41 ) ;
V_2 -> V_41 = V_41 ;
if ( ! V_41 || ! F_34 ( V_41 , 32 , V_2 -> V_141 ) ) {
F_3 ( V_147 L_8 , V_2 -> V_146 ) ;
return - V_148 ;
}
V_34 = F_35 ( sizeof( * V_34 ) , V_149 ) ;
if ( ! V_34 )
return - V_150 ;
V_2 -> V_35 = V_34 ;
for ( V_31 = 0 ; V_31 < V_67 ; ++ V_31 ) {
V_34 -> V_37 [ V_31 ] . V_151 = V_31 ;
V_34 -> V_37 [ V_31 ] . V_41 =
V_2 -> V_41 + 16 + V_31 * V_152 ;
...
V_138 = V_137 + 2 ;
V_34 -> V_154 =
F_38 ( V_138 , sizeof( struct V_155 ) ,
V_149 ) ;
if ( ! V_34 -> V_154 ) {
F_3 ( V_147 L_9 ,
V_2 -> V_146 ) ;
...
return V_140 ;
V_4 = & V_2 -> V_78 [ 0 ] ;
V_4 -> V_35 = & V_34 -> V_154 [ 0 ] ;
V_4 -> V_156 = 0xffff ;
V_4 -> V_157 = & V_158 ;
V_4 -> V_159 = V_160 | V_161 | V_162 ;
V_4 -> type = V_163 ;
V_4 -> V_11 = 16 ;
V_4 -> V_164 = V_4 -> V_11 ;
V_4 -> V_165 = F_29 ;
...
int V_8 ;
V_4 = & V_2 -> V_78 [ V_135 ] ;
V_4 -> V_35 = & V_34 -> V_154 [ V_135 ] ;
V_4 -> V_156 = 1 ;
V_4 -> V_157 = & V_169 ;
V_4 -> V_159 = V_160 | V_170 ;
V_4 -> type = V_171 ;
V_4 -> V_172 = F_1 ;
V_4 -> V_173 = F_6 ;
V_4 -> V_11 = F_40 ( V_136 , V_174 ) ;
