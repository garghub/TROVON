...
{
struct V_16 * V_180 = V_157 -> V_157 . V_181 ;
struct V_16 V_4 ;
int V_82 , V_158 ;
...
static int
F_89 ( struct V_182 * V_157 , const struct V_183 * V_184 )
{
struct V_16 V_4 ;
int line ;
int V_185 ;
...
line = F_76 ( & V_4 ) ;
if ( line < 0 ) {
F_92 ( V_186 L_5 , F_93 ( V_157 ) , line ) ;
F_94 ( V_157 ) ;
return line ;
}
...
static void F_96 ( struct V_182 * V_157 )
{
...
static int F_98 ( struct V_182 * V_157 , T_3 V_62 )
{
struct V_1 * V_2 = F_97 ( V_157 ) ;
if ( V_2 )
F_86 ( & V_177 , & V_2 -> V_4 ) ;
...
static int F_102 ( struct V_182 * V_157 )
{
struct V_1 * V_2 = F_97 ( V_157 ) ;
F_100 ( V_157 , V_187 ) ;
F_103 ( V_157 ) ;
