...
struct V_1 * F_47 ( struct V_165 * V_32 ,
const struct V_128 * V_21 )
{
struct V_1 * V_2 ;
int V_166 ;
V_2 = F_48 ( sizeof( * V_2 ) , V_34 ) ;
if ( ! V_2 )
return NULL ;
V_2 -> V_32 = V_32 ;
V_2 -> V_33 = V_32 -> V_33 ;
...
V_2 -> V_32 -> V_137 = F_35 ( L_44 , V_2 -> V_141 ) ;
if ( ! V_2 -> V_32 -> V_137 ) {
F_9 ( V_2 , L_45 ) ;
V_166 = - V_17 ;
goto V_169;
...
int F_58 ( const char * V_140 , const struct V_134 * V_135 )
{
int V_9 ;
struct V_1 * V_2 ;
struct V_132 * V_133 ;
F_41 ( & V_159 ) ;
for ( V_9 = 0 ; V_9 < F_59 ( V_132 ) ; V_9 ++ ) {
V_133 = & V_132 [ V_9 ] ;
if ( strcmp ( V_133 -> V_140 , V_140 ) )
continue;
V_133 -> V_135 = V_135 ;
F_60 (drv, &op->drv, list)
V_2 -> V_138 = F_33 ( V_2 , V_133 ) ;
F_43 ( & V_159 ) ;
return 0 ;
}
...
F_60 (drv, &iwlwifi_opmode_table[i].drv, list)
F_37 ( V_2 ) ;
F_43 ( & V_159 ) ;
return;
}
