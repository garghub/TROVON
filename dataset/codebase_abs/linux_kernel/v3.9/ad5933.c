...
F_6 ( V_9 , V_88 ) ;
V_9 -> V_76 = V_88 ;
F_39 ( & V_9 -> V_77 , V_9 -> V_89 ) ;
F_22 ( & V_47 -> V_50 ) ;
return;
}
F_4 ( V_9 -> V_2 , V_21 , 1 , & V_87 ) ;
if ( V_87 & V_90 ) {
int V_91 = F_48 ( V_47 -> V_72 ,
V_47 -> V_73 ) ;
F_4 ( V_9 -> V_2 ,
F_49 ( 1 , V_47 -> V_72 ) ?
V_92 : V_93 ,
...
{
int V_6 , V_98 = 0 ;
struct V_99 * V_100 = V_2 -> V_7 . V_101 ;
struct V_8 * V_9 ;
...
V_9 -> V_41 = V_9 -> V_100 -> V_41 ;
if ( V_9 -> V_100 -> V_104 ) {
V_9 -> V_28 = V_9 -> V_100 -> V_104 ;
V_9 -> V_14 = V_105 ;
} else {
V_9 -> V_28 = V_106 ;
V_9 -> V_14 = V_107 ;
