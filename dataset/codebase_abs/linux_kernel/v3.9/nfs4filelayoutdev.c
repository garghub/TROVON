...
struct V_1 *
F_71 ( struct V_139 * V_140 , T_5 V_152 )
{
struct V_56 * V_57 = F_67 ( V_140 ) -> V_57 ;
struct V_1 * V_2 = V_57 -> V_62 [ V_152 ] ;
struct V_123 * V_153 = F_72 ( V_140 ) ;
if ( F_73 ( V_153 ) )
return NULL ;
if ( V_2 == NULL ) {
F_2 ( V_154 L_43 ,
...
if ( ! V_2 -> V_6 ) {
struct V_38 * V_155 = F_55 ( V_140 -> V_156 -> V_157 ) ;
int V_158 ;
V_158 = F_14 ( V_155 , V_2 ) ;
if ( V_158 ) {
F_75 ( V_153 ) ;
return NULL ;
}
