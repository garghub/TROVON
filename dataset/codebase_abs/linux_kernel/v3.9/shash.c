...
strncpy ( V_77 . type , L_1 , sizeof( V_77 . type ) ) ;
V_77 . V_79 = V_53 -> V_80 ;
V_77 . V_67 = V_78 -> V_67 ;
if ( F_77 ( V_75 , V_81 ,
...
static void F_78 ( struct V_84 * V_85 , struct V_50 * V_53 )
{
struct V_6 * V_78 = F_55 ( V_53 ) ;
F_79 ( V_85 , L_2 ) ;
F_79 ( V_85 , L_3 , V_53 -> V_80 ) ;
F_79 ( V_85 , L_4 , V_78 -> V_67 ) ;
}
struct V_1 * F_80 ( const char * V_86 , T_2 type ,
T_2 V_17 )
{
return F_81 ( V_86 , & V_56 , type , V_17 ) ;
}
...
int F_87 ( struct V_6 * V_91 , int V_92 )
{
int V_93 , V_94 ;
...
int F_88 ( struct V_6 * V_91 , int V_92 )
{
int V_93 , V_94 ;
...
F_89 ( L_5 ,
V_91 [ V_93 ] . V_38 . V_95 ,
V_91 [ V_93 ] . V_38 . V_96 , V_94 ) ;
}
return 0 ;
}
int F_90 ( struct V_97 * V_98 ,
struct V_99 * V_100 )
{
int V_12 ;
V_12 = F_82 ( & V_100 -> V_53 ) ;
if ( V_12 )
return V_12 ;
return F_91 ( V_98 , F_92 ( V_100 ) ) ;
}
void F_93 ( struct V_101 * V_100 )
{
F_94 ( F_95 ( V_100 ) ) ;
F_96 ( V_99 ( V_100 ) ) ;
}
int F_97 ( struct V_102 * V_103 ,
struct V_6 * V_53 ,
struct V_101 * V_100 )
{
return F_98 ( & V_103 -> V_38 , & V_53 -> V_38 , V_100 ,
& V_56 ) ;
}
struct V_6 * F_99 ( struct V_104 * V_105 , T_2 type , T_2 V_17 )
{
struct V_50 * V_53 ;
V_53 = F_100 ( V_105 , & V_56 , type , V_17 ) ;
return F_59 ( V_53 ) ? F_101 ( V_53 ) :
F_102 ( V_53 , struct V_6 , V_38 ) ;
}
