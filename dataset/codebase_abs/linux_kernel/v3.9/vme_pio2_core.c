...
T_1 V_5 ;
int V_16 ;
V_2 = F_17 ( sizeof( struct V_1 ) , V_36 ) ;
if ( V_2 == NULL ) {
V_6 = - V_37 ;
goto V_38;
}
V_2 -> V_39 = V_20 -> V_31 ;
V_2 -> V_40 = V_40 [ V_2 -> V_39 ] ;
V_2 -> V_41 = V_41 [ V_2 -> V_39 ] ;
V_2 -> V_42 = V_14 [ V_2 -> V_39 ] ;
V_2 -> V_7 = V_13 [ V_2 -> V_39 ] & V_43 ;
strncpy ( V_2 -> V_44 , V_44 [ V_2 -> V_39 ] , V_45 ) ;
V_2 -> V_20 = V_20 ;
for ( V_17 = 0 ; V_17 < V_45 ; V_17 ++ ) {
if ( isdigit ( V_2 -> V_44 [ V_17 ] ) == 0 ) {
...
switch ( V_2 -> V_44 [ V_17 ] ) {
case '0' :
V_2 -> V_49 [ V_17 - 1 ] . V_50 = V_51 ;
break;
case '1' :
case '2' :
case '3' :
case '4' :
V_2 -> V_49 [ V_17 - 1 ] . V_50 = V_52 ;
break;
case '5' :
V_2 -> V_49 [ V_17 - 1 ] . V_50 = V_53 ;
break;
case '6' :
case '7' :
case '8' :
case '9' :
V_2 -> V_49 [ V_17 - 1 ] . V_50 = V_54 ;
break;
}
}
V_2 -> V_11 = F_18 ( V_20 , V_55 , V_56 , V_57 ) ;
if ( V_2 -> V_11 == NULL ) {
F_7 ( & V_2 -> V_20 -> V_21 ,
L_14 ) ;
V_6 = - V_58 ;
...
V_6 = F_19 ( V_2 -> V_11 , 1 , V_2 -> V_41 , 0x10000 , V_55 ,
( V_56 | V_60 | V_61 ) , V_57 ) ;
if ( V_6 ) {
F_7 ( & V_2 -> V_20 -> V_21 ,
L_15 ) ;
...
V_16 = ( V_2 -> V_42 & V_19 ) | V_66 ;
F_25 ( V_20 , V_2 -> V_7 , V_16 ) ;
V_67:
F_9 ( V_2 ) ;
V_65:
V_64:
F_19 ( V_2 -> V_11 , 0 , 0 , 0 , V_74 , 0 , V_57 ) ;
V_62:
F_26 ( V_2 -> V_11 ) ;
V_59:
V_48:
...
static int F_28 ( struct V_30 * V_20 )
{
int V_16 ;
int V_17 ;
