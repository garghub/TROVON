...
V_2 = F_80 ( & V_169 -> V_16 , sizeof( * V_2 ) + V_173 -> V_180 *
...
V_2 -> V_40 = V_173 ;
F_81 ( V_169 , V_2 ) ;
V_171 = F_82 ( V_169 , V_183 , 0 ) ;
if ( ! V_171 ) {
F_18 ( & V_169 -> V_16 , L_31 ) ;
return - V_137 ;
}
V_2 -> V_5 = F_83 ( & V_169 -> V_16 , V_171 ) ;
if ( F_84 ( V_2 -> V_5 ) )
return F_85 ( V_2 -> V_5 ) ;
V_2 -> V_164 = F_86 ( & V_169 -> V_16 , NULL ) ;
if ( F_84 ( V_2 -> V_164 ) ) {
F_18 ( & V_169 -> V_16 , L_32 ) ;
return F_85 ( V_2 -> V_164 ) ;
}
F_87 ( & V_2 -> V_36 ) ;
F_88 ( & V_169 -> V_16 ) ;
if ( ! F_89 ( & V_169 -> V_16 ) ) {
V_99 = F_90 ( & V_169 -> V_16 ) ;
if ( V_99 ) {
F_18 ( & V_169 -> V_16 , L_33 ,
V_99 ) ;
goto V_184;
}
}
...
F_1 ( V_2 , V_37 , V_39 ) ;
F_1 ( V_2 , V_185 , 0 ) ;
F_1 ( V_2 , V_186 , 0xFFFFFFFFul ) ;
F_76 ( V_2 -> V_164 ) ;
F_66 ( & V_2 -> V_187 . V_188 ) ;
for ( V_142 = 0 ; V_142 < V_173 -> V_180 ; V_142 ++ ) {
struct V_6 * V_7 = & V_2 -> V_188 [ V_142 ] ;
V_7 -> V_8 = V_189 +
V_142 * V_190 ;
V_171 = F_82 ( V_169 , V_191 , V_142 ) ;
if ( ! V_171 ) {
V_99 = - V_137 ;
F_18 ( & V_169 -> V_16 , L_34 , V_142 ) ;
goto V_192;
}
V_7 -> V_85 = V_171 -> V_193 ;
snprintf ( V_7 -> V_194 , sizeof( V_7 -> V_194 ) , L_35 , V_142 ) ;
V_99 = F_93 ( & V_169 -> V_16 , V_7 -> V_85 ,
F_50 , 0 , V_7 -> V_194 , V_7 ) ;
if ( V_99 ) {
F_18 ( & V_169 -> V_16 ,
L_36 ,
V_142 , V_99 ) ;
...
F_95 ( V_196 , V_2 -> V_187 . V_197 ) ;
F_95 ( V_198 , V_2 -> V_187 . V_197 ) ;
F_95 ( V_199 , V_2 -> V_187 . V_197 ) ;
V_2 -> V_187 . V_16 = & V_169 -> V_16 ;
V_2 -> V_187 . V_200 =
F_71 ;
V_2 -> V_187 . V_201 =
F_74 ;
V_2 -> V_187 . V_202 = F_65 ;
V_2 -> V_187 . V_203 = F_70 ;
V_2 -> V_187 . V_204 = F_60 ;
V_2 -> V_187 . V_205 = F_57 ;
V_2 -> V_187 . V_206 = F_55 ;
V_99 = F_96 ( & V_2 -> V_187 ) ;
if ( V_99 < 0 ) {
F_18 ( & V_169 -> V_16 ,
L_37 , V_99 ) ;
...
{
struct V_1 * V_2 = F_102 ( V_169 ) ;
int V_142 ;
struct V_6 * V_7 ;
F_103 ( & V_2 -> V_187 ) ;
for ( V_142 = 0 ; V_142 < V_2 -> V_40 -> V_180 ; ++ V_142 ) {
V_7 = & V_2 -> V_188 [ V_142 ] ;
F_97 ( & V_7 -> V_87 ) ;
}
F_98 ( & V_169 -> V_16 ) ;
