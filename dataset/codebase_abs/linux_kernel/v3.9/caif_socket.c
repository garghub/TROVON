...
V_59 = F_41 ( V_15 , 0 , V_58 -> V_67 , V_60 ) ;
if ( V_59 )
goto V_68;
V_59 = ( V_18 & V_66 ) ? V_15 -> V_26 : V_60 ;
V_68:
F_42 ( V_7 , V_15 ) ;
F_38 ( V_7 ) ;
return V_59 ;
...
static long F_43 ( struct V_6 * V_7 , long V_69 )
{
F_44 ( V_70 ) ;
F_45 ( V_7 ) ;
for (; ; ) {
F_46 ( F_47 ( V_7 ) , & V_70 , V_71 ) ;
if ( ! F_48 ( & V_7 -> V_21 ) ||
V_7 -> V_47 ||
V_7 -> V_34 != V_35 ||
F_24 ( V_7 , V_28 ) ||
...
! V_69 )
break;
F_7 ( V_74 , & V_7 -> V_75 -> V_18 ) ;
F_50 ( V_7 ) ;
V_69 = F_51 ( V_69 ) ;
F_45 ( V_7 ) ;
F_5 ( V_74 , & V_7 -> V_75 -> V_18 ) ;
}
F_52 ( F_47 ( V_7 ) , & V_70 ) ;
F_50 ( V_7 ) ;
return V_69 ;
...
goto V_80;
F_10 ( V_7 ) ;
V_79 = F_54 ( V_7 , V_18 & V_83 , V_77 ) ;
V_69 = F_55 ( V_7 , V_18 & V_84 ) ;
do {
int V_85 ;
struct V_14 * V_15 ;
F_45 ( V_7 ) ;
...
if ( F_60 ( V_76 -> V_67 , V_15 -> V_88 , V_85 ) ) {
F_61 ( & V_7 -> V_21 , V_15 ) ;
if ( V_78 == 0 )
V_78 = - V_89 ;
break;
...
F_67 ( V_33 , V_2 -> V_7 . V_98 ) ;
if ( V_2 -> V_11 . V_12 == NULL ) {
F_27 ( V_15 ) ;
return - V_99 ;
}
return V_2 -> V_11 . V_12 -> V_100 ( V_2 -> V_11 . V_12 , V_33 ) ;
}
static int F_68 ( struct V_54 * V_54 , struct V_56 * V_6 ,
struct V_57 * V_76 , T_1 V_26 )
{
struct V_6 * V_7 = V_6 -> V_7 ;
struct V_1 * V_2 = F_11 ( V_7 , struct V_1 , V_7 ) ;
int V_101 ;
...
goto V_16;
V_59 = - V_99 ;
if ( F_30 ( V_76 -> V_67 -> V_102 == NULL ) )
goto V_16;
V_94 = V_76 -> V_62 & V_84 ;
V_69 = F_70 ( V_7 , V_94 ) ;
V_69 = F_63 ( F_11 ( V_7 , struct V_1 , V_7 ) ,
1 , V_69 , & V_59 ) ;
if ( V_59 )
goto V_16;
V_59 = - V_87 ;
...
goto V_16;
V_101 = V_26 + V_2 -> V_107 + V_2 -> V_108 ;
V_59 = - V_109 ;
V_15 = F_71 ( V_7 , V_101 , V_94 , & V_59 ) ;
if ( ! V_15 || F_72 ( V_15 ) < V_101 )
goto V_16;
F_73 ( V_15 , V_2 -> V_107 ) ;
V_59 = F_74 ( F_75 ( V_15 , V_26 ) , V_76 -> V_67 , V_26 ) ;
if ( V_59 )
goto V_16;
V_59 = F_65 ( V_15 , V_2 , V_94 , V_69 ) ;
if ( V_59 < 0 )
return V_59 ;
return V_26 ;
V_16:
...
long V_69 ;
V_16 = - V_61 ;
if ( F_30 ( V_76 -> V_62 & V_63 ) )
goto V_111;
if ( F_30 ( V_76 -> V_65 ) )
goto V_111;
V_69 = F_70 ( V_7 , V_76 -> V_62 & V_84 ) ;
V_69 = F_63 ( V_2 , 1 , V_69 , & V_16 ) ;
...
goto V_111;
F_73 ( V_15 , V_2 -> V_107 ) ;
V_77 = F_59 ( int , V_77 , F_72 ( V_15 ) ) ;
V_16 = F_74 ( F_75 ( V_15 , V_77 ) , V_76 -> V_67 , V_77 ) ;
if ( V_16 ) {
F_27 ( V_15 ) ;
goto V_111;
}
...
return - V_125 ;
F_45 ( & ( V_2 -> V_7 ) ) ;
if ( V_121 > sizeof( V_2 -> V_129 . V_133 . V_88 ) ||
F_79 ( & V_2 -> V_129 . V_133 . V_88 , V_120 , V_121 ) ) {
F_50 ( & V_2 -> V_7 ) ;
return - V_99 ;
}
V_2 -> V_129 . V_133 . V_77 = V_121 ;
F_50 ( & V_2 -> V_7 ) ;
return 0 ;
default:
return - V_125 ;
...
struct V_56 * V_6 , T_3 * V_70 )
{
struct V_6 * V_7 = V_6 -> V_7 ;
unsigned int V_163 ;
struct V_1 * V_2 = F_11 ( V_7 , struct V_1 , V_7 ) ;
F_102 ( V_162 , F_47 ( V_7 ) , V_70 ) ;
V_163 = 0 ;
if ( V_7 -> V_47 )
V_163 |= V_160 ;
if ( V_7 -> V_43 == V_49 )
