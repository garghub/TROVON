...
T_6 V_92 , T_6 V_93 , T_6 V_94 , int V_95 )
{
F_20 ( L_11 ) ;
}
...
static void F_3 ( struct V_1 * V_2 , int V_96 , int V_97 , int V_98 , int V_99 )
{
struct V_32 * V_33 = F_14 ( V_2 ) ;
if ( ! V_33 )
return;
F_45 ( L_13 , V_96 , V_97 , V_98 , V_99 , V_2 ) ;
F_46 ( V_33 -> V_45 , V_96 , V_97 , V_98 , V_99 ) ;
}
struct V_32 * F_47 ( struct V_43 * V_38 )
{
struct V_36 * V_37 = V_38 -> V_39 ;
struct V_22 * V_23 = NULL ;
struct V_32 * V_33 ;
int V_51 = 0 ;
V_23 = F_48 ( sizeof( * V_23 ) , V_100 ) ;
if ( ! V_23 )
goto V_68;
F_49 ( & V_23 -> V_21 , F_10 ) ;
V_33 = & V_23 -> V_24 ;
V_33 -> V_101 = & V_102 ;
V_51 = F_50 ( V_38 , V_33 ,
V_37 -> V_103 , V_37 -> V_104 ) ;
if ( V_51 ) {
F_26 ( V_38 -> V_38 , L_14 , V_51 ) ;
goto V_68;
}
F_51 ( V_33 ) ;
F_52 ( V_38 ) ;
