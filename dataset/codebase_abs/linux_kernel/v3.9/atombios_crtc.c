...
if ( ( V_35 -> V_198 & ( V_199 | V_200 ) ) ||
( F_38 ( V_36 ) != V_201 ) ) {
if ( V_181 ) {
struct V_202 * V_202 = F_39 ( V_181 ) ;
struct V_203 * V_204 =
V_202 -> V_205 ;
V_184 = V_204 -> V_184 ;
}
...
args . V_169 . V_222 = V_35 -> V_210 ;
args . V_169 . V_223 = V_183 ;
if ( V_11 -> V_206 && V_11 -> V_145 . V_162 )
args . V_169 . V_224 |=
V_225 ;
F_5 ( V_9 -> V_31 . V_32 ,
V_12 , ( V_33 * ) & args ) ;
V_182 = F_41 ( args . V_169 . V_221 ) * 10 ;
break;
case 3 :
args . V_151 . V_226 . V_221 = F_4 ( V_4 -> clock / 10 ) ;
args . V_151 . V_226 . V_222 = V_35 -> V_210 ;
args . V_151 . V_226 . V_223 = V_183 ;
...
args . V_151 . V_226 . V_227 |=
V_229 ;
args . V_151 . V_226 . V_221 = F_4 ( V_184 / 10 ) ;
} else if ( V_35 -> V_198 & ( V_200 ) ) {
struct V_230 * V_231 = V_35 -> V_46 ;
if ( V_183 == V_232 )
...
F_5 ( V_9 -> V_31 . V_32 ,
V_12 , ( V_33 * ) & args ) ;
V_182 = F_43 ( args . V_151 . V_236 . V_237 ) * 10 ;
if ( args . V_151 . V_236 . V_238 ) {
V_11 -> V_187 |= V_196 ;
V_11 -> V_187 |= V_208 ;
V_11 -> V_209 = args . V_151 . V_236 . V_238 ;
}
if ( args . V_151 . V_236 . V_239 ) {
V_11 -> V_187 |= V_196 ;
V_11 -> V_187 |= V_240 ;
V_11 -> V_241 = args . V_151 . V_236 . V_239 ;
}
break;
default:
...
args . V_169 . V_255 = F_4 ( V_251 ) ;
args . V_169 . V_256 = F_4 ( V_252 ) ;
args . V_169 . V_257 = V_253 ;
args . V_169 . V_239 = V_254 ;
args . V_169 . V_175 = V_132 ;
...
args . V_164 . V_255 = F_4 ( V_251 ) ;
args . V_164 . V_256 = F_4 ( V_252 ) ;
args . V_164 . V_257 = V_253 ;
args . V_164 . V_239 = V_254 ;
...
args . V_151 . V_255 = F_4 ( V_251 ) ;
args . V_151 . V_256 = F_4 ( V_252 ) ;
args . V_151 . V_257 = V_253 ;
args . V_151 . V_239 = V_254 ;
args . V_151 . V_175 = V_132 ;
if ( V_18 == V_259 )
args . V_151 . V_260 = V_261 ;
else
args . V_151 . V_260 = V_262 ;
if ( V_206 && ( V_145 -> type & V_163 ) )
args . V_151 . V_260 |= V_263 ;
args . V_151 . V_264 = V_210 ;
args . V_151 . V_265 = V_183 ;
break;
case 5 :
args . V_245 . V_17 = V_18 ;
args . V_245 . V_221 = F_4 ( clock / 10 ) ;
args . V_245 . V_238 = V_251 ;
args . V_245 . V_256 = F_4 ( V_252 ) ;
args . V_245 . V_266 = F_46 ( V_253 * 100000 ) ;
args . V_245 . V_239 = V_254 ;
args . V_245 . V_260 = 0 ;
if ( V_206 && ( V_145 -> type & V_163 ) )
args . V_245 . V_260 |= V_267 ;
switch ( V_185 ) {
case 8 :
default:
args . V_245 . V_260 |= V_268 ;
break;
case 10 :
args . V_245 . V_260 |= V_269 ;
break;
}
args . V_245 . V_222 = V_210 ;
args . V_245 . V_265 = V_183 ;
args . V_245 . V_175 = V_132 ;
break;
case 6 :
args . V_247 . V_248 = F_46 ( V_18 << 24 | clock / 10 ) ;
args . V_247 . V_238 = V_251 ;
args . V_247 . V_256 = F_4 ( V_252 ) ;
args . V_247 . V_266 = F_46 ( V_253 * 100000 ) ;
args . V_247 . V_239 = V_254 ;
args . V_247 . V_260 = 0 ;
if ( V_206 && ( V_145 -> type & V_163 ) )
args . V_247 . V_260 |= V_270 ;
switch ( V_185 ) {
case 8 :
default:
args . V_247 . V_260 |= V_271 ;
break;
case 10 :
args . V_247 . V_260 |= V_272 ;
break;
case 12 :
args . V_247 . V_260 |= V_273 ;
break;
case 16 :
args . V_247 . V_260 |= V_274 ;
break;
}
args . V_247 . V_222 = V_210 ;
args . V_247 . V_265 = V_183 ;
...
V_11 -> V_185 = 8 ;
V_11 -> V_206 = false ;
if ( ( V_35 -> V_42 & ( V_199 | V_200 ) ) ||
( F_38 ( V_11 -> V_36 ) != V_201 ) ) {
struct V_230 * V_231 = V_35 -> V_46 ;
struct V_180 * V_181 =
F_33 ( V_11 -> V_36 ) ;
struct V_202 * V_202 =
...
F_7 ( V_11 -> V_36 ) ;
T_9 V_285 = V_4 -> clock ;
T_9 V_251 = 0 , V_252 = 0 , V_253 = 0 , V_254 = 0 ;
struct V_286 * V_287 ;
int V_183 = F_34 ( V_11 -> V_36 ) ;
switch ( V_11 -> V_132 ) {
case V_134 :
V_287 = & V_9 -> clock . V_288 ;
break;
case V_137 :
V_287 = & V_9 -> clock . V_289 ;
break;
case V_139 :
case V_140 :
default:
V_287 = & V_9 -> clock . V_290 ;
break;
}
V_287 -> V_106 = V_11 -> V_187 ;
V_287 -> V_291 = V_11 -> V_209 ;
V_287 -> V_254 = V_11 -> V_241 ;
if ( V_35 -> V_42 & ( V_43 ) )
F_52 ( V_287 , V_11 -> V_182 , & V_285 ,
& V_252 , & V_253 , & V_251 , & V_254 ) ;
else if ( F_8 ( V_9 ) )
F_53 ( V_287 , V_11 -> V_182 , & V_285 ,
& V_252 , & V_253 , & V_251 , & V_254 ) ;
else
F_52 ( V_287 , V_11 -> V_182 , & V_285 ,
& V_252 , & V_253 , & V_251 , & V_254 ) ;
...
V_183 , V_35 -> V_210 , V_4 -> clock ,
V_251 , V_252 , V_253 , V_254 ,
V_11 -> V_185 , V_11 -> V_206 , & V_11 -> V_145 ) ;
if ( V_11 -> V_206 ) {
if ( F_25 ( V_9 ) ) {
T_9 V_292 ;
T_9 V_159 = ( ( ( V_252 * 10 ) + V_253 ) * V_11 -> V_145 . V_162 ) / 10000 ;
V_11 -> V_145 . V_159 = ( V_159 / 10 ) & V_293 ;
V_11 -> V_145 . V_159 |= ( ( V_159 - ( V_159 / 10 ) ) << V_294 ) &
V_295 ;
if ( V_11 -> V_145 . type & V_296 )
V_292 = ( 4 * V_159 * V_251 * ( V_11 -> V_145 . V_297 * 2048 ) ) /
( 125 * 25 * V_287 -> V_298 / 100 ) ;
else
V_292 = ( 2 * V_159 * V_251 * ( V_11 -> V_145 . V_297 * 2048 ) ) /
( 125 * 25 * V_287 -> V_298 / 100 ) ;
V_11 -> V_145 . V_161 = V_292 ;
}
...
struct V_309 * V_310 ;
T_11 V_311 ;
V_33 V_312 , V_313 , V_314 ;
unsigned V_315 , V_316 , V_317 , V_318 ;
T_9 V_319 = F_55 ( V_320 ) ;
T_9 V_321 , V_322 , V_323 ;
int V_324 ;
if ( ! V_303 && ! V_2 -> V_300 ) {
F_56 ( L_2 ) ;
return 0 ;
...
V_305 = F_57 ( V_2 -> V_300 ) ;
V_306 = V_2 -> V_300 ;
}
V_308 = V_305 -> V_308 ;
V_310 = F_58 ( V_308 ) ;
V_324 = F_59 ( V_310 , false ) ;
if ( F_60 ( V_324 != 0 ) )
return V_324 ;
if ( V_303 )
V_311 = F_61 ( V_310 ) ;
else {
V_324 = F_62 ( V_310 , V_325 , & V_311 ) ;
if ( F_60 ( V_324 != 0 ) ) {
F_63 ( V_310 ) ;
return - V_326 ;
}
}
F_64 ( V_310 , & V_314 , NULL ) ;
F_63 ( V_310 ) ;
switch ( V_306 -> V_327 ) {
case 8 :
V_312 = ( F_65 ( V_328 ) |
...
if ( V_314 & V_337 ) {
if ( V_9 -> V_69 >= V_338 )
V_321 = V_9 -> V_339 . V_340 . V_341 ;
else if ( V_9 -> V_69 >= V_342 )
V_321 = V_9 -> V_339 . V_343 . V_341 ;
else
V_321 = V_9 -> V_339 . V_344 . V_341 ;
switch ( ( V_321 & 0xf0 ) >> 4 ) {
case 0 :
V_312 |= F_68 ( V_345 ) ;
break;
...
V_312 |= F_69 ( V_348 ) ;
F_70 ( V_314 , & V_315 , & V_316 , & V_317 , & V_318 ) ;
V_312 |= F_71 ( V_318 ) ;
V_312 |= F_72 ( V_315 ) ;
V_312 |= F_73 ( V_316 ) ;
V_312 |= F_74 ( V_317 ) ;
...
F_27 ( V_361 + V_11 -> V_362 ,
F_76 ( V_311 ) ) ;
F_27 ( V_363 + V_11 -> V_362 ,
F_76 ( V_311 ) ) ;
F_27 ( V_364 + V_11 -> V_362 ,
( T_9 ) V_311 & V_365 ) ;
F_27 ( V_366 + V_11 -> V_362 ,
( T_9 ) V_311 & V_365 ) ;
F_27 ( V_367 + V_11 -> V_362 , V_312 ) ;
F_27 ( V_368 + V_11 -> V_362 , V_319 ) ;
F_27 ( V_369 + V_11 -> V_362 , 0 ) ;
F_27 ( V_370 + V_11 -> V_362 , 0 ) ;
F_27 ( V_371 + V_11 -> V_362 , 0 ) ;
F_27 ( V_372 + V_11 -> V_362 , 0 ) ;
F_27 ( V_373 + V_11 -> V_362 , V_306 -> V_374 ) ;
F_27 ( V_375 + V_11 -> V_362 , V_306 -> V_376 ) ;
V_313 = V_306 -> V_377 [ 0 ] / ( V_306 -> V_327 / 8 ) ;
F_27 ( V_378 + V_11 -> V_362 , V_313 ) ;
F_27 ( V_379 + V_11 -> V_362 , 1 ) ;
F_27 ( V_380 + V_11 -> V_362 ,
V_306 -> V_376 ) ;
V_301 &= ~ 3 ;
V_302 &= ~ 1 ;
F_27 ( V_381 + V_11 -> V_362 ,
( V_301 << 16 ) | V_302 ) ;
V_322 = V_2 -> V_4 . V_382 ;
V_323 = ( V_2 -> V_4 . V_383 + 1 ) & ~ 1 ;
F_27 ( V_384 + V_11 -> V_362 ,
( V_322 << 16 ) | V_323 ) ;
V_321 = F_26 ( V_385 + V_11 -> V_362 ) ;
V_321 &= ~ V_386 ;
F_27 ( V_385 + V_11 -> V_362 , V_321 ) ;
F_27 ( V_387 + V_11 -> V_362 , 0 ) ;
if ( ! V_303 && V_300 && V_300 != V_2 -> V_300 ) {
V_305 = F_57 ( V_300 ) ;
V_310 = F_58 ( V_305 -> V_308 ) ;
V_324 = F_59 ( V_310 , false ) ;
if ( F_60 ( V_324 != 0 ) )
return V_324 ;
F_77 ( V_310 ) ;
...
if ( V_9 -> V_69 >= V_194 ) {
if ( V_11 -> V_18 ) {
F_27 ( V_403 , F_76 ( V_311 ) ) ;
F_27 ( V_404 , F_76 ( V_311 ) ) ;
} else {
F_27 ( V_405 , F_76 ( V_311 ) ) ;
F_27 ( V_406 , F_76 ( V_311 ) ) ;
}
}
F_27 ( V_407 + V_11 -> V_362 ,
( T_9 ) V_311 ) ;
F_27 ( V_408 +
V_11 -> V_362 , ( T_9 ) V_311 ) ;
F_27 ( V_409 + V_11 -> V_362 , V_312 ) ;
if ( V_9 -> V_69 >= V_398 )
F_27 ( V_410 + V_11 -> V_362 , V_319 ) ;
F_27 ( V_411 + V_11 -> V_362 , 0 ) ;
F_27 ( V_412 + V_11 -> V_362 , 0 ) ;
F_27 ( V_413 + V_11 -> V_362 , 0 ) ;
F_27 ( V_414 + V_11 -> V_362 , 0 ) ;
F_27 ( V_415 + V_11 -> V_362 , V_306 -> V_374 ) ;
F_27 ( V_416 + V_11 -> V_362 , V_306 -> V_376 ) ;
V_313 = V_306 -> V_377 [ 0 ] / ( V_306 -> V_327 / 8 ) ;
F_27 ( V_417 + V_11 -> V_362 , V_313 ) ;
F_27 ( V_418 + V_11 -> V_362 , 1 ) ;
F_27 ( V_419 + V_11 -> V_362 ,
V_306 -> V_376 ) ;
V_301 &= ~ 3 ;
V_302 &= ~ 1 ;
F_27 ( V_420 + V_11 -> V_362 ,
( V_301 << 16 ) | V_302 ) ;
V_322 = V_2 -> V_4 . V_382 ;
V_323 = ( V_2 -> V_4 . V_383 + 1 ) & ~ 1 ;
F_27 ( V_421 + V_11 -> V_362 ,
( V_322 << 16 ) | V_323 ) ;
V_321 = F_26 ( V_422 + V_11 -> V_362 ) ;
V_321 &= ~ V_423 ;
F_27 ( V_422 + V_11 -> V_362 , V_321 ) ;
F_27 ( V_424 + V_11 -> V_362 , 0 ) ;
if ( ! V_303 && V_300 && V_300 != V_2 -> V_300 ) {
V_305 = F_57 ( V_300 ) ;
V_310 = F_58 ( V_305 -> V_308 ) ;
V_324 = F_59 ( V_310 , false ) ;
...
int F_80 ( struct V_1 * V_2 , int V_301 , int V_302 ,
struct V_299 * V_425 )
{
struct V_6 * V_7 = V_2 -> V_7 ;
struct V_8 * V_9 = V_7 -> V_10 ;
if ( F_25 ( V_9 ) )
return F_54 ( V_2 , V_425 , V_301 , V_302 , 0 ) ;
else if ( F_8 ( V_9 ) )
return F_79 ( V_2 , V_425 , V_301 , V_302 , 0 ) ;
else
return F_81 ( V_2 , V_425 , V_301 , V_302 , 0 ) ;
}
int F_82 ( struct V_1 * V_2 ,
struct V_299 * V_300 ,
int V_301 , int V_302 , enum V_426 V_74 )
{
struct V_6 * V_7 = V_2 -> V_7 ;
struct V_8 * V_9 = V_7 -> V_10 ;
if ( F_25 ( V_9 ) )
return F_54 ( V_2 , V_300 , V_301 , V_302 , 1 ) ;
else if ( F_8 ( V_9 ) )
return F_79 ( V_2 , V_300 , V_301 , V_302 , 1 ) ;
else
return F_81 ( V_2 , V_300 , V_301 , V_302 , 1 ) ;
}
...
if ( V_437 -> V_36 &&
! F_42 ( F_34 ( V_437 -> V_36 ) ) ) {
if ( V_437 -> V_181 == V_11 -> V_181 ) {
if ( V_437 -> V_132 != V_140 )
return V_437 -> V_132 ;
}
V_439 = V_437 -> V_182 ;
if ( ( V_2 -> V_4 . clock == V_436 -> V_4 . clock ) &&
( V_182 == V_439 ) &&
( V_11 -> V_206 == V_437 -> V_206 ) &&
( V_437 -> V_132 != V_140 ) )
return V_437 -> V_132 ;
}
}
...
{
if ( F_18 ( V_9 ) )
F_45 ( V_9 , V_9 -> clock . V_443 ) ;
else if ( F_25 ( V_9 ) ) {
struct V_144 V_145 ;
bool V_206 = F_49 ( V_9 , & V_145 ,
V_444 ,
V_9 -> clock . V_443 ) ;
if ( V_206 )
...
struct V_3 * V_4 ,
struct V_3 * V_5 ,
int V_301 , int V_302 , struct V_299 * V_425 )
{
struct V_11 * V_11 = F_2 ( V_2 ) ;
struct V_6 * V_7 = V_2 -> V_7 ;
struct V_8 * V_9 = V_7 -> V_10 ;
