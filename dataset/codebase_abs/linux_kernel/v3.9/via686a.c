...
{
if ( V_2 <= 1 )
return ( T_1 ) F_2 ( ( V_1 * 21024 - 1205000 ) / 250000 , 0 , 255 ) ;
else if ( V_2 == 2 )
return ( T_1 ) F_2 ( ( V_1 * 15737 - 1205000 ) / 250000 , 0 , 255 ) ;
else if ( V_2 == 3 )
return ( T_1 ) F_2 ( ( V_1 * 10108 - 1205000 ) / 250000 , 0 , 255 ) ;
else
return ( T_1 ) F_2 ( ( V_1 * 41714 - 12050000 ) / 2500000 , 0 ,
255 ) ;
}
