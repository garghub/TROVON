...
static int F_37 ( struct V_1 * V_2 , struct V_33 * V_56 )
{
struct V_33 * V_34 ;
struct V_4 * V_5 = ( void * ) & V_2 -> V_6 ;
struct V_15 * V_16 = V_5 -> V_16 ;
...
if ( V_57 < 0 )
goto error;
V_61 = (struct V_60 * ) ( V_56 -> V_6 + V_64 ) ;
switch ( V_61 -> V_67 & F_22 ( 0x00ffffff ) ) {
case F_22 ( V_37 ) :
V_39 = ( T_1 * ) & V_61 -> V_67 ;
V_38 = V_39 [ 3 ] ;
break;
...
break;
default:
F_40 ( V_2 , V_68 , V_2 -> V_27 ,
L_3 ,
F_41 ( V_61 -> V_67 ) ) ;
goto V_69;
}
V_63 = V_61 -> V_63 ;
for ( V_58 = 0 ; V_58 < V_57 ; V_58 ++ , V_63 ++ ) {
V_59 = F_16 ( V_63 -> V_70 ) ;
V_40 = F_16 ( V_63 -> V_71 ) ;
if ( ( V_59 == 0 ) || ( V_40 == 0 ) ) {
if ( ! V_58 )
...
if ( ( ( V_59 + V_40 ) > V_56 -> V_40 ) || ( V_40 > V_16 -> V_72 ) ) {
F_40 ( V_2 , V_68 , V_2 -> V_27 ,
L_4 ,
V_58 , V_59 , V_40 , V_56 ) ;
if ( ! V_58 )
...
V_34 = F_33 ( V_2 , V_56 -> V_6 + V_59 , V_40 , V_38 ) ;
if ( ! V_34 )
goto error;
F_42 ( V_2 , V_34 ) ;
}
...
static int F_43 ( struct V_13 * V_8 , T_7 V_74 )
{
int V_20 = 0 ;
struct V_1 * V_2 = F_9 ( V_8 ) ;
struct V_4 * V_5 = ( void * ) & V_2 -> V_6 ;
...
if ( V_20 < 0 )
goto error;
if ( V_8 == V_16 -> V_24 && V_5 -> V_18 && V_5 -> V_18 -> V_75 )
V_20 = V_5 -> V_18 -> V_75 ( V_8 , V_74 ) ;
if ( V_20 < 0 )
F_45 ( V_8 ) ;
error:
return V_20 ;
...
struct V_4 * V_5 = ( void * ) & V_2 -> V_6 ;
struct V_15 * V_16 = V_5 -> V_16 ;
bool V_76 = ( V_8 == V_16 -> V_24 && V_5 -> V_18 && V_5 -> V_18 -> V_77 ) ;
if ( V_76 )
V_20 = V_5 -> V_18 -> V_77 ( V_8 ) ;
if ( V_20 < 0 )
goto V_11;
V_20 = F_45 ( V_8 ) ;
if ( V_20 < 0 && V_76 && V_5 -> V_18 -> V_75 )
V_5 -> V_18 -> V_75 ( V_8 , V_78 ) ;
V_11:
return V_20 ;
}
