...
if ( ! V_3 -> V_61 )
return - V_40 ;
V_94 = F_60 ( V_97 , & V_88 -> V_37 ) ;
if ( ! V_94 )
return - V_98 ;
V_3 -> V_17 = (struct V_99 * ) V_94 -> V_44 ;
V_34 = F_53 ( V_88 ) ;
if ( V_34 ) {
...
V_100 . V_9 = F_61 ( & V_88 -> V_37 ) ;
V_100 . V_101 = V_102 ;
V_100 . V_21 = V_21 ;
V_100 . V_18 = V_3 -> V_17 -> V_18 ;
V_3 -> V_37 = & V_88 -> V_37 ;
V_3 -> V_103 = F_62 ( & V_100 ,
& V_88 -> V_37 , V_3 ) ;
if ( ! V_3 -> V_103 ) {
F_10 ( & V_88 -> V_37 , L_13 ) ;
return - V_38 ;
