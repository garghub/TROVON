...
int F_7 ( struct V_6 * V_11 , const char * V_13 )
{
return F_8 ( & V_11 -> V_2 , V_13 ) ;
}
int F_9 ( struct V_6 * V_11 , const char * V_14 )
{
char V_3 [ 1024 ] ;
int V_15 ;
...
void F_10 ( struct V_6 * V_11 , struct V_7 * V_8 )
{
F_11 ( & V_11 -> V_2 , & V_8 -> V_1 ) ;
}
struct V_7 * F_12 ( struct V_6 * V_11 , const char * V_3 )
{
struct V_7 * V_8 = NULL ;
struct V_1 * V_1 = F_13 ( & V_11 -> V_2 , V_3 ) ;
if ( V_1 )
...
struct V_6 * F_16 ( bool V_9 , const char * V_21 )
{
...
struct V_7 * F_20 ( const struct V_6 * V_11 , unsigned int V_26 )
{
struct V_7 * V_8 = NULL ;
struct V_1 * V_1 ;
V_1 = F_21 ( & V_11 -> V_2 , V_26 ) ;
if ( V_1 )
V_8 = F_2 ( V_1 , struct V_7 , V_1 ) ;
return V_8 ;
}
