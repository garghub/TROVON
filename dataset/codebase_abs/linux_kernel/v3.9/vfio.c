...
static void F_49 ( struct V_36 * V_24 )
{
struct V_13 * V_14 = V_24 -> V_14 ;
...
static bool F_70 ( struct V_13 * V_14 , struct V_24 * V_25 )
{
struct V_36 * V_24 ;
V_24 = F_51 ( V_14 , V_25 ) ;
if ( ! V_24 )
...
{
struct V_36 * V_24 = F_72 ( V_25 ) ;
struct V_13 * V_14 = V_24 -> V_14 ;
struct V_22 * V_22 = V_14 -> V_22 ;
void * V_38 = V_24 -> V_38 ;
F_29 ( V_14 ) ;
F_49 ( V_24 ) ;
F_73 ( V_8 . V_40 , ! F_70 ( V_14 , V_25 ) ) ;
F_39 ( V_14 ) ;
F_68 ( V_22 ) ;
return V_38 ;
}
...
static long F_79 ( struct V_18 * V_19 ,
unsigned long V_58 )
{
struct V_3 * V_4 ;
long V_26 = - V_64 ;
...
static long F_80 ( struct V_71 * V_72 ,
...
static long F_81 ( struct V_71 * V_72 ,
unsigned int V_73 , unsigned long V_58 )
{
V_58 = ( unsigned long ) F_82 ( V_58 ) ;
return F_80 ( V_72 , V_73 , V_58 ) ;
}
static int F_83 ( struct V_78 * V_78 , struct V_71 * V_72 )
{
struct V_18 * V_19 ;
...
static int F_84 ( struct V_78 * V_78 , struct V_71 * V_72 )
{
struct V_18 * V_19 = V_72 -> V_74 ;
V_72 -> V_74 = NULL ;
F_18 ( V_19 ) ;
...
static T_1 F_85 ( struct V_71 * V_72 , char T_2 * V_79 ,
T_3 V_80 , T_4 * V_81 )
{
struct V_18 * V_19 = V_72 -> V_74 ;
struct V_3 * V_4 = V_19 -> V_59 ;
if ( F_86 ( ! V_4 || ! V_4 -> V_2 -> V_82 ) )
return - V_10 ;
return V_4 -> V_2 -> V_82 ( V_19 -> V_63 , V_79 , V_80 , V_81 ) ;
}
static T_1 F_87 ( struct V_71 * V_72 , const char T_2 * V_79 ,
T_3 V_80 , T_4 * V_81 )
{
struct V_18 * V_19 = V_72 -> V_74 ;
struct V_3 * V_4 = V_19 -> V_59 ;
if ( F_86 ( ! V_4 || ! V_4 -> V_2 -> V_83 ) )
return - V_10 ;
return V_4 -> V_2 -> V_83 ( V_19 -> V_63 , V_79 , V_80 , V_81 ) ;
}
static int F_88 ( struct V_71 * V_72 , struct V_84 * V_85 )
{
struct V_18 * V_19 = V_72 -> V_74 ;
struct V_3 * V_4 = V_19 -> V_59 ;
if ( F_86 ( ! V_4 || ! V_4 -> V_2 -> V_86 ) )
return - V_10 ;
return V_4 -> V_2 -> V_86 ( V_19 -> V_63 , V_85 ) ;
}
...
static int F_94 ( struct V_13 * V_14 , int V_89 )
{
struct V_90 V_91 ;
struct V_18 * V_19 ;
struct V_3 * V_4 ;
...
static bool F_98 ( struct V_13 * V_14 )
{
return ( F_99 ( V_14 -> V_22 ,
V_14 , F_54 ) == 0 ) ;
}
static int F_100 ( struct V_13 * V_14 , char * V_79 )
{
struct V_36 * V_24 ;
struct V_71 * V_72 ;
int V_26 = - V_64 ;
if ( 0 == F_58 ( & V_14 -> V_29 ) ||
! V_14 -> V_19 -> V_59 || ! F_98 ( V_14 ) )
return - V_10 ;
F_3 ( & V_14 -> V_28 ) ;
F_4 (device, &group->device_list, group_next) {
...
static long F_105 ( struct V_71 * V_72 ,
unsigned int V_73 , unsigned long V_58 )
{
...
struct V_104 V_105 ;
unsigned long V_106 ;
V_106 = F_106 ( struct V_104 , V_107 ) ;
if ( F_107 ( & V_105 , ( void T_2 * ) V_58 , V_106 ) )
return - V_108 ;
...
if ( V_14 -> V_19 )
V_105 . V_107 |= V_111 ;
if ( F_108 ( ( void T_2 * ) V_58 , & V_105 , V_106 ) )
return - V_108 ;
V_26 = 0 ;
break;
}
...
{
char * V_79 ;
V_79 = F_110 ( ( const char T_2 * ) V_58 , V_115 ) ;
if ( F_34 ( V_79 ) )
return F_69 ( V_79 ) ;
V_26 = F_100 ( V_14 , V_79 ) ;
F_6 ( V_79 ) ;
break;
}
}
...
{
V_58 = ( unsigned long ) F_82 ( V_58 ) ;
return F_105 ( V_72 , V_73 , V_58 ) ;
}
static int F_112 ( struct V_78 * V_78 , struct V_71 * V_72 )
{
struct V_13 * V_14 ;
V_14 = F_43 ( F_113 ( V_78 ) ) ;
if ( ! V_14 )
return - V_64 ;
if ( V_14 -> V_19 ) {
F_39 ( V_14 ) ;
...
static int F_114 ( struct V_78 * V_78 , struct V_71 * V_72 )
{
struct V_13 * V_14 = V_72 -> V_74 ;
V_72 -> V_74 = NULL ;
F_92 ( V_14 ) ;
...
static int F_115 ( struct V_78 * V_78 , struct V_71 * V_72 )
{
...
static long F_116 ( struct V_71 * V_72 ,
unsigned int V_73 , unsigned long V_58 )
{
struct V_36 * V_24 = V_72 -> V_74 ;
if ( F_86 ( ! V_24 -> V_2 -> V_61 ) )
return - V_10 ;
return V_24 -> V_2 -> V_61 ( V_24 -> V_38 , V_73 , V_58 ) ;
}
static T_1 F_117 ( struct V_71 * V_72 , char T_2 * V_79 ,
T_3 V_80 , T_4 * V_81 )
{
struct V_36 * V_24 = V_72 -> V_74 ;
if ( F_86 ( ! V_24 -> V_2 -> V_82 ) )
return - V_10 ;
return V_24 -> V_2 -> V_82 ( V_24 -> V_38 , V_79 , V_80 , V_81 ) ;
}
static T_1 F_118 ( struct V_71 * V_72 ,
const char T_2 * V_79 ,
T_3 V_80 , T_4 * V_81 )
{
struct V_36 * V_24 = V_72 -> V_74 ;
if ( F_86 ( ! V_24 -> V_2 -> V_83 ) )
return - V_10 ;
return V_24 -> V_2 -> V_83 ( V_24 -> V_38 , V_79 , V_80 , V_81 ) ;
}
static int F_119 ( struct V_71 * V_72 , struct V_84 * V_85 )
{
struct V_36 * V_24 = V_72 -> V_74 ;
if ( F_86 ( ! V_24 -> V_2 -> V_86 ) )
return - V_10 ;
return V_24 -> V_2 -> V_86 ( V_24 -> V_38 , V_85 ) ;
}
static long F_120 ( struct V_71 * V_72 ,
unsigned int V_73 , unsigned long V_58 )
{
V_58 = ( unsigned long ) F_82 ( V_58 ) ;
return F_116 ( V_72 , V_73 , V_58 ) ;
}
static char * F_121 ( struct V_24 * V_25 , T_5 * V_116 )
{
return F_122 ( V_6 , L_10 , F_60 ( V_25 ) ) ;
}
...
F_25 ( & V_8 . V_12 ) ;
F_125 ( & V_8 . V_40 ) ;
V_8 . V_32 = F_126 ( V_117 , L_11 ) ;
if ( F_34 ( V_8 . V_32 ) ) {
V_26 = F_69 ( V_8 . V_32 ) ;
goto V_118;
}
V_8 . V_32 -> V_119 = F_121 ;
V_26 = F_127 ( & V_8 . V_33 , 0 , V_16 , L_11 ) ;
if ( V_26 )
goto V_120;
F_128 ( & V_8 . V_121 , & V_94 ) ;
V_26 = F_129 ( & V_8 . V_121 , V_8 . V_33 , 1 ) ;
if ( V_26 )
goto V_122;
...
F_128 ( & V_8 . V_124 , & V_125 ) ;
V_26 = F_129 ( & V_8 . V_124 ,
F_31 ( F_32 ( V_8 . V_33 ) , 1 ) , V_16 - 1 ) ;
if ( V_26 )
goto V_126;
F_130 ( V_127 L_12 V_128 L_13 ) ;
F_131 ( L_14 ) ;
return 0 ;
V_126:
