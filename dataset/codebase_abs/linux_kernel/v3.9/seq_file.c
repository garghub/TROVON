...
int F_40 ( struct V_48 * V_48 , struct V_5 * V_5 )
{
...
void * F_42 ( struct V_5 * V_53 , const struct V_6 * V_68 ,
int V_69 )
{
int V_70 ;
void * V_66 ;
...
int F_44 ( struct V_5 * V_73 , const struct V_6 * V_68 ,
int V_69 )
{
return F_42 ( V_73 , V_68 , V_69 ) ? 0 : - V_11 ;
}
int F_45 ( struct V_1 * V_2 , char V_52 )
{
if ( V_2 -> V_3 < V_2 -> V_4 ) {
...
int F_46 ( struct V_1 * V_2 , const char * V_49 )
{
...
V_54 = F_48 ( V_2 -> V_23 + V_2 -> V_3 , V_2 -> V_4 - V_2 -> V_3 , V_75 ) ;
if ( ! V_54 )
goto V_76;
V_2 -> V_3 += V_54 ;
return 0 ;
...
int F_50 ( struct V_1 * V_67 , const void * V_65 , T_4 V_54 )
{
...
struct V_77 * F_51 ( struct V_77 * V_78 , T_1 V_19 )
{
struct V_77 * V_79 ;
F_52 (lh, head)
if ( V_19 -- == 0 )
...
struct V_77 * F_53 ( struct V_77 * V_78 , T_1 V_19 )
{
if ( ! V_19 )
return V_78 ;
return F_51 ( V_78 , V_19 - 1 ) ;
}
struct V_77 * F_54 ( void * V_64 , struct V_77 * V_78 , T_1 * V_31 )
{
struct V_77 * V_79 ;
...
struct V_80 * F_55 ( struct V_81 * V_78 , T_1 V_19 )
{
struct V_80 * V_82 ;
F_56 (node, head)
if ( V_19 -- == 0 )
...
struct V_80 * F_57 ( struct V_81 * V_78 , T_1 V_19 )
{
if ( ! V_19 )
return V_83 ;
return F_55 ( V_78 , V_19 - 1 ) ;
}
struct V_80 * F_58 ( void * V_64 , struct V_81 * V_78 ,
T_1 * V_31 )
{
...
struct V_80 * F_59 ( struct V_81 * V_78 ,
T_1 V_19 )
{
struct V_80 * V_82 ;
F_60 (node, head)
...
struct V_80 * F_61 ( struct V_81 * V_78 ,
T_1 V_19 )
{
if ( ! V_19 )
return V_83 ;
return F_59 ( V_78 , V_19 - 1 ) ;
}
struct V_80 * F_62 ( void * V_64 ,
struct V_81 * V_78 ,
T_1 * V_31 )
{
struct V_80 * V_82 = V_64 ;
++ * V_31 ;
if ( V_64 == V_83 )
return F_63 ( V_78 -> V_84 ) ;
else
return F_63 ( V_82 -> V_28 ) ;
}
