...
F_32 ( & V_6 -> V_76 , V_74 ) ;
if ( V_111 < V_178 )
F_52 ( V_181 , & V_2 -> V_25 . V_182 ) ;
}
static void F_53 ( struct V_183 * V_184 )
{
struct V_1 * V_2 =
F_47 ( V_184 , struct V_1 , V_25 . V_182 ) ;
F_54 ( & V_2 -> V_6 . V_45 -> V_10 ) ;
}
static unsigned int F_55 ( struct V_5 * V_6 )
{
return V_185 | V_186 | V_187 ;
}
static void F_56 ( struct V_5 * V_6 , int V_188 )
{
unsigned int V_50 ;
V_50 = F_2 ( V_6 , V_98 ) ;
if ( V_188 ) {
...
static void F_59 ( struct V_5 * V_6 , int V_193 )
{
struct V_1 * V_2 = F_20 ( V_6 ) ;
F_21 ( V_2 -> V_37 ) ;
F_4 ( V_6 , V_14 , V_193 ? V_194 : V_195 ) ;
F_23 ( V_2 -> V_37 ) ;
}
static void F_60 ( struct V_5 * V_6 , int V_196 )
{
unsigned long V_74 ;
F_28 ( & V_6 -> V_76 , V_74 ) ;
if ( V_196 & V_197 ) {
...
static enum V_210 F_65 ( struct V_211 * V_212 )
{
unsigned long V_74 ;
int V_40 = V_213 ;
struct V_1 * V_2 = F_47 ( V_212 , struct V_1 ,
V_150 ) ;
struct V_5 * V_6 = & V_2 -> V_6 ;
F_28 ( & V_6 -> V_76 , V_74 ) ;
if ( ! F_63 ( V_6 ) ) {
F_66 ( V_212 , V_2 -> V_151 ) ;
V_40 = V_214 ;
}
F_32 ( & V_6 -> V_76 , V_74 ) ;
return V_40 ;
}
static T_2 F_67 ( int V_4 , void * V_19 )
{
unsigned long V_74 ;
unsigned long V_215 ;
struct V_1 * V_2 = V_19 ;
...
static T_2 F_75 ( int V_4 , void * V_19 )
{
...
{
return ( V_10 -> type == V_198 ) ? L_5 : NULL ;
}
...
if ( V_228 > 16 )
V_228 -= 16 ;
V_34 -> V_137 = F_78 ( V_6 -> V_19 , V_129 -> V_230 , V_135 ,
V_28 ) ;
V_6 -> V_45 -> V_10 . V_231 = 1 ;
V_40 = F_19 ( V_6 ) ;
if ( F_10 ( V_40 ) ) {
F_12 ( V_22 L_6 ) ;
goto V_232;
...
V_34 -> V_119 = 0 ;
V_34 -> V_133 = 0 ;
V_34 -> V_144 . V_240 = F_45 ;
V_34 -> V_144 . V_241 = NULL ;
V_34 -> V_38 -> V_242 = V_243 |
F_79 ( V_2 -> V_244 ) | V_245 ;
V_34 -> V_38 -> V_246 = ( V_247 << 16 )
| ( V_247 ) ;
V_34 -> V_38 -> V_248 = ( V_247 << 16 ) ;
V_34 -> V_38 -> V_249 =
V_2 -> V_6 . V_11 + V_250 ;
V_25 -> V_144 . V_240 = F_48 ;
V_25 -> V_144 . V_241 = NULL ;
V_25 -> V_38 -> V_242 = V_243 |
F_80 ( V_2 -> V_251 ) | V_245 ;
V_25 -> V_38 -> V_246 = ( V_247 << 16 )
| ( V_247 ) ;
V_25 -> V_38 -> V_248 = V_247 ;
V_25 -> V_38 -> V_139 = V_6 -> V_11 + V_252 ;
V_2 -> V_115 |= V_218 ;
V_2 -> V_115 |= V_253 ;
F_4 ( V_6 , V_254 , 0 ) ;
V_40 = F_81 ( V_6 -> V_4 , F_67 , V_255 ,
L_7 , V_2 ) ;
if ( F_10 ( V_40 ) ) {
F_12 ( V_22 L_8 ) ;
goto V_256;
...
struct V_127 * V_34 = & V_2 -> V_34 ;
struct V_216 * V_25 = & V_2 -> V_25 ;
V_34 -> V_38 = F_87 ( sizeof( V_27 ) , V_259 | V_260 ) ;
if ( ! V_34 -> V_38 )
return - V_13 ;
V_34 -> V_39 = F_87 ( sizeof( V_33 ) , V_259 | V_260 ) ;
if ( ! V_34 -> V_39 ) {
V_40 = - V_13 ;
goto V_261;
}
...
V_34 -> V_39 ,
sizeof( V_33 ) , V_28 ) ;
V_34 -> V_144 . V_262 = F_40 ( V_34 -> V_35 ) ;
F_88 ( & V_25 -> V_263 ) ;
...
V_25 -> V_30 = F_91 ( V_25 -> V_29 , V_259 , & V_25 -> V_31 ) ;
if ( ! V_25 -> V_30 ) {
F_90 ( L_14 , V_264 ) ;
V_40 = - V_13 ;
goto V_266;
}
V_25 -> V_38 = F_87 ( sizeof( V_27 ) , V_259 | V_260 ) ;
if ( ! V_25 -> V_38 ) {
F_90 ( L_15 , V_264 ) ;
V_40 = - V_13 ;
goto V_267;
}
V_25 -> V_39 = F_87 ( sizeof( V_33 ) , V_259 | V_260 ) ;
if ( ! V_25 -> V_39 ) {
F_90 ( L_16 , V_264 ) ;
V_40 = - V_13 ;
goto V_268;
...
V_6 = & V_2 -> V_6 ;
V_6 -> V_19 = & V_17 -> V_19 ;
V_269 = F_94 ( V_17 , V_273 , 0 ) ;
if ( F_10 ( ! V_269 ) )
return - V_274 ;
V_6 -> V_11 = V_269 -> V_275 ;
V_6 -> V_4 = F_95 ( V_17 , 0 ) ;
if ( F_10 ( V_6 -> V_4 < 0 ) )
return - V_274 ;
if ( F_10 ( F_96 ( V_6 -> V_4 , 1 ) ) )
return - V_274 ;
if ( V_271 == NULL || V_271 -> V_276 < 0 )
V_2 -> V_3 . V_4 = - 1 ;
else {
V_2 -> V_3 . V_4 = V_271 -> V_276 ;
V_2 -> V_3 . V_209 = 1 ;
V_2 -> V_3 . V_225 = V_271 -> V_277 ;
V_2 -> V_3 . V_226 = V_271 -> V_226 ;
...
V_2 -> V_47 = V_271 -> V_47 ;
V_269 = F_97 ( V_17 , V_278 ,
L_17 ) ;
if ( F_10 ( ! V_269 ) )
return - V_274 ;
V_2 -> V_143 = V_269 -> V_275 ;
V_2 -> V_114 = V_269 -> V_279 ;
V_269 = F_97 ( V_17 , V_278 ,
L_18 ) ;
if ( F_10 ( ! V_269 ) )
return - V_274 ;
V_2 -> V_244 = V_269 -> V_275 ;
V_2 -> V_251 = V_269 -> V_279 ;
V_6 -> V_280 = V_281 ;
V_6 -> V_229 = V_282 ;
V_6 -> V_283 = & V_284 ;
V_6 -> V_74 = V_285 ;
...
return V_40 ;
V_2 -> V_43 = V_223 ;
F_101 ( & V_2 -> V_150 , V_286 ,
V_152 ) ;
V_2 -> V_150 . V_287 = F_65 ;
...
{
int V_40 , V_288 ;
for ( V_288 = 0 ; V_288 < V_21 ; V_288 ++ )
V_24 [ V_288 ] . V_6 . type = V_289 ;
V_181 = F_105 ( L_20 ) ;
if ( F_10 ( ! V_181 ) )
return - V_13 ;
V_40 = F_106 ( & V_36 ) ;
if ( F_10 ( V_40 ) ) {
F_12 ( V_22 L_21 , V_264 ) ;
goto V_290;
}
V_40 = F_107 ( & V_291 ) ;
if ( V_40 ) {
...
V_2 -> V_115 = 0 ;
F_4 ( V_6 , V_108 , V_2 -> V_115 ) ;
F_113 ( V_2 -> V_25 . V_263 , V_2 -> V_25 . V_111 == V_122 ) ;
F_23 ( V_2 -> V_37 ) ;
if ( V_2 -> V_43 != V_208 )
F_23 ( V_2 -> V_37 ) ;
V_2 -> V_43 = V_223 ;
