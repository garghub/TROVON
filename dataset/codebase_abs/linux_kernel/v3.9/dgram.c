...
static int F_61 ( struct V_2 * V_3 , int V_85 , int V_86 ,
char V_37 * V_87 , int V_37 * V_88 )
{
struct V_1 * V_7 = F_1 ( V_3 ) ;
int V_89 , V_17 ;
if ( V_85 != V_90 )
...
if ( F_21 ( V_17 , V_88 ) )
return - V_91 ;
if ( F_64 ( V_87 , & V_89 , V_17 ) )
return - V_91 ;
return 0 ;
}
static int F_65 ( struct V_2 * V_3 , int V_85 , int V_86 ,
char V_37 * V_87 , unsigned int V_88 )
{
struct V_1 * V_7 = F_1 ( V_3 ) ;
int V_89 ;
int V_20 = 0 ;
