...
struct V_3 * V_4 ;
int V_111 ;
V_2 -> V_112 = V_2 -> V_113 -> V_114 ;
V_6 = F_34 ( sizeof( * V_6 ) , V_115 ) ;
if ( ! V_6 )
return - V_116 ;
V_2 -> V_7 = V_6 ;
...
V_2 -> V_18 = V_4 ;
V_4 -> type = V_123 ;
V_4 -> V_124 = V_125 | V_126 | V_127 | V_128 ;
V_4 -> V_129 = 8 ;
V_4 -> V_130 = 2048 ;
V_4 -> V_131 = 0xffff ;
V_4 -> V_132 = & V_133 ;
