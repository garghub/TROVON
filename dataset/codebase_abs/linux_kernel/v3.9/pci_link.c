...
return - V_46 ;
V_5 -> V_29 = V_29 ;
strcpy ( F_29 ( V_29 ) , V_72 ) ;
strcpy ( F_30 ( V_29 ) , V_73 ) ;
V_29 -> V_74 = V_5 ;
F_22 ( & V_68 ) ;
V_34 = F_4 ( V_5 ) ;
if ( V_34 )
...
for ( V_6 = 0 ; V_6 < V_5 -> V_14 . V_20 ; V_6 ++ ) {
if ( V_5 -> V_14 . V_35 == V_5 -> V_14 . V_19 [ V_6 ] ) {
F_3 ( V_75 L_34 , V_5 -> V_14 . V_19 [ V_6 ] ) ;
V_71 = 1 ;
} else
F_3 ( V_75 L_35 , V_5 -> V_14 . V_19 [ V_6 ] ) ;
}
F_3 ( V_75 L_36 ) ;
if ( ! V_71 )
F_3 ( V_75 L_34 , V_5 -> V_14 . V_35 ) ;
if ( ! V_5 -> V_29 -> V_28 . V_38 )
F_3 ( V_75 L_37 ) ;
F_3 ( V_75 L_38 ) ;
F_31 ( & V_5 -> V_76 , & V_77 ) ;
...
static void F_34 ( struct V_67 * V_29 )
{
struct V_4 * V_5 ;
V_5 = F_21 ( V_29 ) ;
F_22 ( & V_68 ) ;
...
static int T_3 F_36 ( char * V_78 , int V_79 )
{
int V_6 ;
...
static int T_3 F_40 ( char * V_78 )
{
return F_36 ( V_78 , 1 ) ;
}
static int T_3 F_41 ( char * V_78 )
{
return F_36 ( V_78 , 0 ) ;
}
static int T_3 F_42 ( char * V_78 )
{
V_64 = 0 ;
return 1 ;
}
