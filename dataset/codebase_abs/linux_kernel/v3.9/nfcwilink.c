...
V_4 -> V_23 = ( void * ) V_7 -> V_26 ;
V_19 = (struct V_18 * )
F_10 ( V_4 , sizeof( struct V_18 ) ) ;
V_19 -> V_11 = V_27 ;
V_19 -> V_13 = V_28 ;
V_19 -> V_29 = 0 ;
V_7 -> V_15 . V_29 = 0 ;
...
V_7 -> V_15 . V_29 ,
V_7 -> V_15 . V_32 ) ;
if ( ( V_7 -> V_15 . V_29 != 5 ) || ( V_7 -> V_15 . V_32 != 0 ) ) {
F_9 ( & V_7 -> V_22 -> V_23 ,
L_6 ) ;
return - V_33 ;
}
...
V_4 = F_1 ( V_2 , V_24 ) ;
if ( ! V_4 ) {
F_9 ( & V_7 -> V_22 -> V_23 , L_11 ) ;
return - V_25 ;
}
V_4 -> V_23 = ( void * ) V_7 -> V_26 ;
memcpy ( F_10 ( V_4 , V_2 ) , V_10 , V_2 ) ;
V_21 = F_11 ( V_4 ) ;
if ( V_21 )
return V_21 ;
V_20 = F_12 ( & V_7 -> V_16 ,
...
T_2 * V_50 ;
int V_2 , V_21 ;
F_8 ( & V_7 -> V_22 -> V_23 , L_12 ) ;
F_17 ( V_51 , & V_7 -> V_52 ) ;
V_21 = F_7 ( V_7 , V_17 ) ;
if ( V_21 )
goto exit;
V_21 = F_18 ( & V_47 , V_17 , & V_7 -> V_22 -> V_23 ) ;
if ( V_21 ) {
F_9 ( & V_7 -> V_22 -> V_23 , L_13 , V_21 ) ;
if ( V_21 == - V_53 )
V_21 = 0 ;
goto exit;
}
...
F_8 ( & V_7 -> V_22 -> V_23 , L_18 , V_4 -> V_2 ) ;
F_25 ( V_4 , ( V_5 - 1 ) ) ;
...
V_21 = F_27 ( V_4 ) ;
if ( V_21 < 0 ) {
F_9 ( & V_7 -> V_22 -> V_23 , L_19 , V_21 ) ;
return V_21 ;
}
return 0 ;
}
static int F_28 ( struct V_64 * V_26 )
{
struct V_6 * V_7 = F_29 ( V_26 ) ;
unsigned long V_20 ;
int V_21 ;
F_8 ( & V_7 -> V_22 -> V_23 , L_20 ) ;
...
static int F_34 ( struct V_64 * V_26 )
{
struct V_6 * V_7 = F_29 ( V_26 ) ;
int V_21 ;
F_8 ( & V_7 -> V_22 -> V_23 , L_24 ) ;
if ( ! F_35 ( V_65 , & V_7 -> V_52 ) )
return 0 ;
V_21 = F_36 ( & V_67 ) ;
if ( V_21 )
F_9 ( & V_7 -> V_22 -> V_23 , L_25 , V_21 ) ;
V_7 -> V_72 = NULL ;
return V_21 ;
}
static int F_11 ( struct V_1 * V_4 )
{
struct V_64 * V_26 = (struct V_64 * ) V_4 -> V_23 ;
struct V_6 * V_7 = F_29 ( V_26 ) ;
struct V_39 V_40 = { V_43 , V_45 , 0x0000 } ;
long V_2 ;
F_8 ( & V_7 -> V_22 -> V_23 , L_26 , V_4 -> V_2 ) ;
...
if ( V_2 < 0 ) {
F_5 ( V_4 ) ;
F_9 ( & V_7 -> V_22 -> V_23 , L_27 , V_2 ) ;
return - V_63 ;
}
return 0 ;
}
static int F_39 ( struct V_73 * V_22 )
{
static struct V_6 * V_7 ;
int V_21 ;
T_4 V_74 ;
F_8 ( & V_22 -> V_23 , L_28 ) ;
V_7 = F_40 ( & V_22 -> V_23 , sizeof( struct V_6 ) , V_24 ) ;
if ( ! V_7 ) {
V_21 = - V_25 ;
goto exit;
}
...
F_42 ( V_7 -> V_26 , & V_22 -> V_23 ) ;
F_43 ( V_7 -> V_26 , V_7 ) ;
V_21 = F_44 ( V_7 -> V_26 ) ;
if ( V_21 < 0 ) {
F_9 ( & V_22 -> V_23 , L_30 , V_21 ) ;
goto V_83;
}
F_45 ( & V_22 -> V_23 , V_7 ) ;
goto exit;
...
static int F_47 ( struct V_73 * V_22 )
{
struct V_6 * V_7 = F_48 ( & V_22 -> V_23 ) ;
struct V_64 * V_26 ;
F_8 ( & V_22 -> V_23 , L_31 ) ;
if ( ! V_7 )
return - V_63 ;
