...
struct V_50 * V_51 ;
int V_149 ;
V_15 -> V_150 = V_15 -> V_151 -> V_152 ;
V_17 = F_42 ( sizeof( * V_17 ) , V_153 ) ;
if ( ! V_17 )
return - V_154 ;
V_15 -> V_18 = V_17 ;
V_149 = F_43 ( V_148 , V_15 -> V_150 ) ;
if ( V_149 )
return V_149 ;
...
V_51 = & V_15 -> V_156 [ 3 ] ;
V_51 -> type = V_178 ;
V_51 -> V_158 = V_159 | V_172 ;
V_51 -> V_162 = 16 ;
V_51 -> V_99 = 1 ;
V_51 -> V_164 = & V_176 ;
V_51 -> V_177 = F_38 ;
F_47 ( V_15 -> V_179 , L_10 , V_15 -> V_150 ) ;
return 0 ;
}
