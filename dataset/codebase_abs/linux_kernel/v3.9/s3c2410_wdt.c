...
V_32 = F_31 ( V_42 , V_47 -> V_53 , F_15 , 0 ,
V_40 -> V_54 , V_40 ) ;
if ( V_32 != 0 ) {
F_13 ( V_42 , L_18 , V_32 ) ;
goto V_55;
...
static int F_35 ( struct V_39 * V_42 )
{
F_36 ( & V_26 ) ;
F_20 () ;
F_34 ( V_18 ) ;
...
static void F_37 ( struct V_39 * V_42 )
{
F_7 ( & V_26 ) ;
}
static int F_38 ( struct V_39 * V_42 , T_2 V_58 )
{
V_59 = F_6 ( V_5 + V_8 ) ;
V_60 = F_6 ( V_5 + V_15 ) ;
F_7 ( & V_26 ) ;
...
static int F_39 ( struct V_39 * V_42 )
{
F_3 ( V_60 , V_5 + V_15 ) ;
F_3 ( V_60 , V_5 + V_6 ) ;
F_3 ( V_59 , V_5 + V_8 ) ;
