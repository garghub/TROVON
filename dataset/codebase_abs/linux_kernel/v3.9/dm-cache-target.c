...
static T_5 F_41 ( T_5 V_34 , T_6 V_42 )
{
F_42 ( V_34 , V_42 ) ;
return V_34 ;
}
static T_7 F_43 ( struct V_6 * V_6 , T_2 V_22 )
{
T_6 V_43 = V_6 -> V_44 ;
T_5 V_34 = F_24 ( V_22 ) ;
if ( ! F_40 ( V_6 ) )
...
static void F_45 ( struct V_6 * V_6 , T_7 V_34 )
{
unsigned long V_46 ;
F_46 ( & V_6 -> V_47 . V_48 ) ;
F_47 ( & V_6 -> V_49 , V_46 ) ;
...
static void F_51 ( struct V_6 * V_6 , T_7 V_34 )
{
unsigned long V_46 ;
F_47 ( & V_6 -> V_49 , V_46 ) ;
...
static bool F_53 ( struct V_6 * V_6 , T_7 V_34 )
{
int V_21 ;
unsigned long V_46 ;
F_47 ( & V_6 -> V_49 , V_46 ) ;
...
{
T_5 V_127 = F_126 ( V_28 -> V_74 ,
V_6 -> V_44 ) ;
T_5 V_128 = V_28 -> V_74 + F_127 ( V_28 ) ;
T_5 V_34 ;
...
F_8 ( V_6 ) ;
F_164 ( V_6 -> V_7 , & V_6 -> V_154 , V_148 ) ;
}
static int F_165 ( struct V_158 * V_26 , int V_159 )
{
struct V_160 * V_161 = F_166 ( V_26 -> V_73 ) ;
return F_167 ( & V_161 -> V_162 , V_159 ) ;
}
static int F_168 ( struct V_163 * V_164 , int V_159 )
{
struct V_6 * V_6 = F_161 ( V_164 , struct V_6 , V_165 ) ;
return F_165 ( V_6 -> V_72 , V_159 ) ||
F_165 ( V_6 -> V_75 , V_159 ) ;
}
static void F_169 ( struct V_6 * V_6 )
{
unsigned V_166 ;
if ( V_6 -> V_167 )
...
F_175 ( V_6 -> V_52 ) ;
if ( V_6 -> V_168 )
F_176 ( V_6 -> V_39 , V_6 -> V_168 ) ;
if ( V_6 -> V_72 )
F_176 ( V_6 -> V_39 , V_6 -> V_72 ) ;
if ( V_6 -> V_75 )
F_176 ( V_6 -> V_39 , V_6 -> V_75 ) ;
if ( V_6 -> V_38 )
F_177 ( V_6 -> V_38 ) ;
for ( V_166 = 0 ; V_166 < V_6 -> V_169 ; V_166 ++ )
F_178 ( V_6 -> V_170 [ V_166 ] ) ;
F_178 ( V_6 -> V_170 ) ;
F_178 ( V_6 ) ;
}
static void F_179 ( struct V_171 * V_39 )
{
struct V_6 * V_6 = V_39 -> V_172 ;
F_169 ( V_6 ) ;
}
static T_8 F_180 ( struct V_158 * V_26 )
{
return F_181 ( V_26 -> V_73 -> V_173 ) >> V_174 ;
}
static void F_182 ( struct V_175 * V_176 )
{
if ( V_176 -> V_168 )
F_176 ( V_176 -> V_39 , V_176 -> V_168 ) ;
if ( V_176 -> V_75 )
F_176 ( V_176 -> V_39 , V_176 -> V_75 ) ;
if ( V_176 -> V_72 )
F_176 ( V_176 -> V_39 , V_176 -> V_72 ) ;
F_178 ( V_176 ) ;
}
static bool F_183 ( struct V_177 * V_178 , char * * error )
{
if ( ! V_178 -> V_179 ) {
* error = L_8 ;
return false ;
...
static int F_184 ( struct V_175 * V_176 , struct V_177 * V_178 ,
char * * error )
{
int V_21 ;
T_8 V_180 ;
char V_34 [ V_181 ] ;
if ( ! F_183 ( V_178 , error ) )
return - V_182 ;
V_21 = F_185 ( V_176 -> V_39 , F_186 ( V_178 ) , V_183 | V_184 ,
& V_176 -> V_168 ) ;
if ( V_21 ) {
* error = L_9 ;
return V_21 ;
}
V_180 = F_180 ( V_176 -> V_168 ) ;
if ( V_180 > V_185 )
F_102 ( L_10 ,
F_187 ( V_176 -> V_168 -> V_73 , V_34 ) , V_186 ) ;
return 0 ;
}
static int F_188 ( struct V_175 * V_176 , struct V_177 * V_178 ,
char * * error )
{
int V_21 ;
if ( ! F_183 ( V_178 , error ) )
...
if ( ! F_183 ( V_178 , error ) )
return - V_182 ;
if ( F_191 ( F_186 ( V_178 ) , 10 , & V_121 ) || ! V_121 ||
V_121 < V_190 ||
V_121 & ( V_190 - 1 ) ) {
* error = L_14 ;
return - V_182 ;
...
static void F_192 ( struct V_192 * V_193 )
{
V_193 -> V_194 = V_195 ;
V_193 -> V_62 = false ;
}
static int F_193 ( struct V_175 * V_176 , struct V_177 * V_178 ,
char * * error )
{
...
F_192 ( V_193 ) ;
V_21 = F_194 ( V_197 , V_178 , & V_179 , error ) ;
if ( V_21 )
return - V_182 ;
while ( V_179 -- ) {
V_198 = F_186 ( V_178 ) ;
...
static int F_195 ( struct V_175 * V_176 , struct V_177 * V_178 ,
char * * error )
{
static struct V_196 V_197 [] = {
{ 0 , 1024 , L_20 } ,
...
if ( ! F_183 ( V_178 , error ) )
return - V_182 ;
V_176 -> V_199 = F_186 ( V_178 ) ;
V_21 = F_194 ( V_197 , V_178 , & V_176 -> V_200 , error ) ;
if ( V_21 )
return - V_182 ;
V_176 -> V_201 = ( const char * * ) V_178 -> V_202 ;
F_196 ( V_178 , V_176 -> V_200 ) ;
return 0 ;
}
static int F_197 ( struct V_175 * V_176 , int V_179 , char * * V_202 ,
char * * error )
{
int V_21 ;
struct V_177 V_178 ;
V_178 . V_179 = V_179 ;
V_178 . V_202 = V_202 ;
V_21 = F_184 ( V_176 , & V_178 , error ) ;
if ( V_21 )
return V_21 ;
V_21 = F_188 ( V_176 , & V_178 , error ) ;
if ( V_21 )
return V_21 ;
...
if ( V_21 )
return V_21 ;
V_21 = F_193 ( V_176 , & V_178 , error ) ;
if ( V_21 )
return V_21 ;
V_21 = F_195 ( V_176 , & V_178 , error ) ;
if ( V_21 )
return V_21 ;
return 0 ;
}
static int F_198 ( struct V_203 * V_14 , int V_179 , const char * * V_202 )
{
int V_21 = 0 ;
if ( V_179 & 1 ) {
F_102 ( L_21 ) ;
...
while ( V_179 ) {
V_21 = F_199 ( V_14 , V_202 [ 0 ] , V_202 [ 1 ] ) ;
if ( V_21 ) {
F_102 ( L_22 ,
V_202 [ 0 ] , V_202 [ 1 ] ) ;
return V_21 ;
...
static int F_200 ( struct V_6 * V_6 , struct V_175 * V_176 ,
char * * error )
{
int V_21 ;
V_6 -> V_38 = F_201 ( V_176 -> V_199 ,
V_6 -> V_204 ,
V_6 -> V_188 ,
V_6 -> V_45 ) ;
if ( ! V_6 -> V_38 ) {
...
V_21 = F_198 ( V_6 -> V_38 , V_176 -> V_200 , V_176 -> V_201 ) ;
if ( V_21 ) {
* error = L_24 ;
F_177 ( V_6 -> V_38 ) ;
V_6 -> V_38 = NULL ;
...
static bool F_202 ( T_8 V_44 ,
T_8 V_205 )
{
( void ) F_68 ( V_205 , V_44 ) ;
return V_205 > V_206 ;
}
static T_8 F_203 ( T_8 V_207 ,
T_8 V_205 )
{
T_8 V_44 ;
V_44 = F_204 ( V_207 ) ;
if ( V_205 )
while ( F_202 ( V_44 , V_205 ) )
V_44 *= 2 ;
return V_44 ;
}
static int F_205 ( struct V_175 * V_176 , struct V_6 * * V_208 )
{
int V_21 = 0 ;
...
T_5 V_209 ;
struct V_210 * V_52 ;
bool V_211 = V_176 -> V_61 . V_194 == V_195 ;
V_6 = F_206 ( sizeof( * V_6 ) , V_212 ) ;
if ( ! V_6 )
return - V_17 ;
V_6 -> V_39 = V_176 -> V_39 ;
V_39 -> V_172 = V_6 ;
...
V_39 -> V_216 = true ;
V_39 -> V_217 = true ;
memcpy ( & V_6 -> V_61 , & V_176 -> V_61 , sizeof( V_6 -> V_61 ) ) ;
V_39 -> V_218 = F_61 ( V_6 ) ;
V_6 -> V_165 . V_219 = F_168 ;
F_207 ( V_39 -> V_40 , & V_6 -> V_165 ) ;
V_6 -> V_168 = V_176 -> V_168 ;
V_6 -> V_72 = V_176 -> V_72 ;
V_6 -> V_75 = V_176 -> V_75 ;
V_176 -> V_168 = V_176 -> V_72 = V_176 -> V_75 = NULL ;
V_209 = V_6 -> V_188 = V_176 -> V_188 ;
V_209 = F_41 ( V_209 , V_176 -> V_191 ) ;
V_6 -> V_209 = F_74 ( V_209 ) ;
V_6 -> V_45 = V_176 -> V_191 ;
if ( F_208 ( V_39 , V_6 -> V_45 ) ) {
V_21 = - V_182 ;
goto V_220;
}
if ( V_176 -> V_191 & ( V_176 -> V_191 - 1 ) ) {
T_5 V_204 = V_176 -> V_187 ;
V_6 -> V_41 = - 1 ;
V_204 = F_41 ( V_204 , V_176 -> V_191 ) ;
V_6 -> V_204 = F_34 ( V_204 ) ;
} else {
V_6 -> V_41 = F_209 ( V_176 -> V_191 ) ;
V_6 -> V_204 = F_34 ( V_176 -> V_187 >> V_6 -> V_41 ) ;
}
V_21 = F_200 ( V_6 , V_176 , error ) ;
if ( V_21 )
goto V_220;
V_6 -> V_221 = V_176 -> V_200 ;
V_52 = F_210 ( V_6 -> V_168 -> V_73 ,
V_176 -> V_191 , V_211 ,
F_211 ( V_6 -> V_38 ) ) ;
if ( F_212 ( V_52 ) ) {
* error = L_25 ;
...
F_215 ( & V_6 -> V_92 ) ;
V_6 -> V_37 = 0 ;
V_6 -> V_35 = F_3 ( F_31 ( V_6 -> V_204 ) ) ;
if ( ! V_6 -> V_35 ) {
* error = L_26 ;
goto V_220;
}
F_5 ( V_6 -> V_35 , F_31 ( V_6 -> V_204 ) ) ;
V_6 -> V_44 =
F_203 ( V_6 -> V_45 ,
V_6 -> V_188 ) ;
V_6 -> V_223 = F_43 ( V_6 , V_6 -> V_209 ) ;
V_6 -> V_50 = F_3 ( F_49 ( V_6 -> V_223 ) ) ;
if ( ! V_6 -> V_50 ) {
* error = L_27 ;
goto V_220;
}
F_5 ( V_6 -> V_50 , F_49 ( V_6 -> V_223 ) ) ;
V_6 -> V_116 = F_216 ( & V_224 ) ;
if ( F_212 ( V_6 -> V_116 ) ) {
* error = L_28 ;
V_21 = F_213 ( V_6 -> V_116 ) ;
goto V_220;
}
V_6 -> V_7 = F_217 ( L_29 V_225 , V_226 ) ;
if ( ! V_6 -> V_7 ) {
* error = L_30 ;
goto V_220;
}
F_218 ( & V_6 -> V_8 , F_160 ) ;
F_219 ( & V_6 -> V_154 , F_162 ) ;
V_6 -> V_147 = V_125 ;
V_6 -> V_10 = F_220 ( V_227 ) ;
if ( ! V_6 -> V_10 ) {
* error = L_31 ;
goto V_220;
}
...
static int F_223 ( struct V_6 * V_6 , int V_179 , const char * * V_202 )
{
unsigned V_166 ;
const char * * V_233 ;
V_233 = F_224 ( V_179 , sizeof( * V_233 ) , V_212 ) ;
if ( ! V_233 )
return - V_17 ;
for ( V_166 = 0 ; V_166 < V_179 ; V_166 ++ ) {
V_233 [ V_166 ] = F_225 ( V_202 [ V_166 ] , V_212 ) ;
if ( ! V_233 [ V_166 ] ) {
while ( V_166 -- )
F_178 ( V_233 [ V_166 ] ) ;
F_178 ( V_233 ) ;
...
static int F_226 ( struct V_171 * V_39 , unsigned V_179 , char * * V_202 )
{
int V_21 = - V_182 ;
struct V_175 * V_176 ;
struct V_6 * V_6 = NULL ;
V_176 = F_206 ( sizeof( * V_176 ) , V_212 ) ;
if ( ! V_176 ) {
V_39 -> error = L_34 ;
return - V_17 ;
}
V_176 -> V_39 = V_39 ;
V_21 = F_197 ( V_176 , V_179 , V_202 , & V_39 -> error ) ;
if ( V_21 )
goto V_234;
V_21 = F_205 ( V_176 , & V_6 ) ;
if ( V_21 )
goto V_234;
V_21 = F_223 ( V_6 , V_179 - 3 , ( const char * * ) V_202 + 3 ) ;
if ( V_21 ) {
F_169 ( V_6 ) ;
goto V_234;
}
...
static int F_227 ( struct V_171 * V_39 , struct V_28 * V_28 )
{
struct V_6 * V_6 = V_39 -> V_172 ;
int V_21 ;
T_2 V_27 = F_73 ( V_6 , V_28 ) ;
...
static int F_228 ( struct V_171 * V_39 , struct V_28 * V_28 , int error )
{
struct V_6 * V_6 = V_39 -> V_172 ;
unsigned long V_46 ;
T_1 V_76 = F_61 ( V_6 ) ;
...
{
unsigned V_166 , V_21 ;
for ( V_166 = 0 ; V_166 < F_31 ( V_6 -> V_204 ) ; V_166 ++ ) {
V_21 = F_231 ( V_6 -> V_52 , F_34 ( V_166 ) ,
F_29 ( V_6 , F_34 ( V_166 ) ) ) ;
if ( V_21 )
return V_21 ;
}
...
{
unsigned V_166 , V_21 ;
V_21 = F_233 ( V_6 -> V_52 , V_6 -> V_44 ,
V_6 -> V_223 ) ;
if ( V_21 ) {
F_234 ( L_37 ) ;
return V_21 ;
}
for ( V_166 = 0 ; V_166 < F_49 ( V_6 -> V_223 ) ; V_166 ++ ) {
V_21 = F_235 ( V_6 -> V_52 , F_44 ( V_166 ) ,
F_53 ( V_6 , F_44 ( V_166 ) ) ) ;
if ( V_21 )
return V_21 ;
}
...
static int F_236 ( void * V_109 , T_4 V_36 , T_2 V_22 ,
T_6 V_237 )
{
struct V_6 * V_6 = V_109 ;
return F_237 ( V_6 -> V_52 , V_36 , V_237 ) ;
}
static int F_238 ( struct V_6 * V_6 )
{
int V_21 ;
V_21 = F_239 ( V_6 -> V_52 , V_6 -> V_38 ) ;
if ( V_21 ) {
F_234 ( L_38 ) ;
return V_21 ;
}
V_21 = F_240 ( V_6 -> V_38 , F_236 , V_6 ) ;
if ( V_21 )
F_234 ( L_39 ) ;
return V_21 ;
}
static bool F_241 ( struct V_6 * V_6 )
{
...
if ( V_240 )
F_234 ( L_42 ) ;
V_241 = F_140 ( V_6 -> V_52 , ! V_238 && ! V_239 && ! V_240 ) ;
if ( V_241 )
F_234 ( L_43 ) ;
return ! V_238 && ! V_239 && ! V_240 && ! V_241 ;
}
static void F_242 ( struct V_171 * V_39 )
{
struct V_6 * V_6 = V_39 -> V_172 ;
F_150 ( V_6 ) ;
F_153 ( V_6 ) ;
...
static int F_243 ( void * V_109 , T_2 V_22 , T_4 V_36 ,
bool V_242 , T_6 V_237 , bool V_243 )
{
int V_21 ;
struct V_6 * V_6 = V_109 ;
V_21 = F_244 ( V_6 -> V_38 , V_22 , V_36 , V_237 , V_243 ) ;
if ( V_21 )
return V_21 ;
if ( V_242 )
F_32 ( V_6 , V_22 , V_36 ) ;
...
static int F_245 ( void * V_109 , T_8 V_44 ,
T_7 V_244 , bool V_245 )
{
struct V_6 * V_6 = V_109 ;
if ( V_245 )
F_45 ( V_6 , V_244 ) ;
...
static int F_246 ( struct V_171 * V_39 )
{
int V_21 = 0 ;
struct V_6 * V_6 = V_39 -> V_172 ;
T_8 V_246 = F_180 ( V_6 -> V_75 ) ;
( void ) F_68 ( V_246 , V_6 -> V_45 ) ;
if ( F_31 ( V_6 -> V_204 ) != V_246 || ! V_6 -> V_230 ) {
V_6 -> V_204 = F_34 ( V_246 ) ;
V_21 = F_247 ( V_6 -> V_52 , V_6 -> V_204 ) ;
if ( V_21 ) {
F_234 ( L_44 ) ;
return V_21 ;
}
...
static void F_250 ( struct V_171 * V_39 )
{
struct V_6 * V_6 = V_39 -> V_172 ;
V_6 -> V_77 = true ;
F_162 ( & V_6 -> V_154 . V_122 ) ;
}
static void F_251 ( struct V_171 * V_39 , T_9 type ,
unsigned V_247 , char * V_208 , unsigned V_248 )
{
int V_21 = 0 ;
unsigned V_166 ;
T_10 V_249 = 0 ;
...
V_21 = F_254 ( V_6 -> V_52 , & V_251 ) ;
if ( V_21 ) {
F_234 ( L_49 ) ;
goto V_87;
}
V_253 = F_255 ( V_6 -> V_38 ) ;
F_256 ( L_50 ,
( unsigned long long ) ( V_251 - V_250 ) ,
...
( unsigned long long ) F_31 ( V_253 ) ,
V_6 -> V_37 ) ;
if ( V_6 -> V_61 . V_62 )
F_256 ( L_51 ) ;
else
F_256 ( L_52 ) ;
F_256 ( L_53 , ( unsigned long long ) V_6 -> V_130 ) ;
if ( V_249 < V_248 ) {
V_21 = F_257 ( V_6 -> V_38 , V_208 + V_249 , V_248 - V_249 ) ;
if ( V_21 )
F_234 ( L_54 , V_21 ) ;
}
break;
case V_256 :
F_258 ( V_252 , V_6 -> V_168 -> V_73 -> V_257 ) ;
F_256 ( L_55 , V_252 ) ;
F_258 ( V_252 , V_6 -> V_75 -> V_73 -> V_257 ) ;
F_256 ( L_55 , V_252 ) ;
F_258 ( V_252 , V_6 -> V_72 -> V_73 -> V_257 ) ;
F_256 ( L_56 , V_252 ) ;
for ( V_166 = 0 ; V_166 < V_6 -> V_169 - 1 ; V_166 ++ )
F_256 ( L_57 , V_6 -> V_170 [ V_166 ] ) ;
if ( V_6 -> V_169 )
F_256 ( L_57 , V_6 -> V_170 [ V_6 -> V_169 - 1 ] ) ;
}
return;
V_87:
F_256 ( L_58 ) ;
}
static int F_259 ( struct V_6 * V_6 , char * * V_202 )
{
unsigned long V_121 ;
if ( ! strcasecmp ( V_202 [ 0 ] , L_59 ) ) {
if ( F_191 ( V_202 [ 1 ] , 10 , & V_121 ) )
return - V_182 ;
V_6 -> V_130 = V_121 ;
return 0 ;
}
...
static int F_260 ( struct V_171 * V_39 , unsigned V_179 , char * * V_202 )
{
int V_21 ;
struct V_6 * V_6 = V_39 -> V_172 ;
if ( V_179 != 2 )
return - V_182 ;
V_21 = F_259 ( V_6 , V_202 ) ;
if ( V_21 == V_258 )
return F_199 ( V_6 -> V_38 , V_202 [ 0 ] , V_202 [ 1 ] ) ;
return V_21 ;
}
static int F_261 ( struct V_171 * V_39 ,
T_11 F_110 , void * V_259 )
{
int V_21 = 0 ;
struct V_6 * V_6 = V_39 -> V_172 ;
V_21 = F_110 ( V_39 , V_6 -> V_75 , 0 , F_180 ( V_6 -> V_75 ) , V_259 ) ;
if ( ! V_21 )
...
{
struct V_6 * V_6 = V_39 -> V_172 ;
struct V_160 * V_161 = F_166 ( V_6 -> V_72 -> V_73 ) ;
if ( ! V_161 -> V_265 )
return V_264 ;
V_261 -> V_71 = V_6 -> V_72 -> V_73 ;
return F_263 ( V_264 , V_161 -> V_265 ( V_161 , V_261 , V_263 ) ) ;
}
static void F_264 ( struct V_6 * V_6 , struct V_266 * V_267 )
{
V_267 -> V_268 = V_6 -> V_44 * 1024 ;
V_267 -> V_269 = V_6 -> V_44 << V_174 ;
}
static void F_265 ( struct V_171 * V_39 , struct V_266 * V_267 )
{
struct V_6 * V_6 = V_39 -> V_172 ;
F_266 ( V_267 , 0 ) ;
F_267 ( V_267 , V_6 -> V_45 << V_174 ) ;
F_264 ( V_6 , V_267 ) ;
}
