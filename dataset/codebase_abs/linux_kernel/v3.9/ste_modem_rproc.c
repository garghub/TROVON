...
struct V_1 * V_1 ;
int V_35 ;
F_17 ( & V_28 -> V_41 . V_43 , L_14 ) ;
if ( ! V_28 -> V_29 . V_42 || ! V_28 -> V_29 . V_30 || ! V_28 -> V_29 . V_38 ||
! V_28 -> V_29 . V_39 ) {
F_18 ( & V_28 -> V_41 . V_43 , L_15 ) ;
return - V_37 ;
}
V_1 = F_19 ( & V_28 -> V_41 . V_43 , V_28 -> V_41 . V_16 , & V_46 ,
V_47 , sizeof( * V_4 ) ) ;
if ( ! V_1 )
return - V_48 ;
V_4 = V_1 -> V_5 ;
...
V_4 -> V_1 = V_1 ;
V_28 -> V_33 = V_4 ;
V_4 -> V_28 -> V_29 . V_42 ( V_4 -> V_28 , & V_49 ) ;
V_1 -> V_50 = & V_51 ;
V_4 -> V_6 = F_20 ( V_1 -> V_43 . V_44 , V_21 ,
& V_4 -> V_45 ,
V_52 ) ;
if ( ! V_4 -> V_6 ) {
F_4 ( V_4 , L_16 ) ;
