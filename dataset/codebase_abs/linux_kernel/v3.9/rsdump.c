...
V_56 = F_5 ( struct V_55 , V_54 ) ;
for ( V_7 = 0 ; V_56 -> V_57 ; V_7 ++ ) {
F_3 ( L_10 ,
V_7 ) ;
F_1 ( V_56 , V_58 ) ;
V_56 = F_2 ( struct V_55 ,
V_56 , V_56 -> V_57 ) ;
}
}
...
{
F_3 ( L_17 , V_59 , F_27 ( V_60 ) ) ;
}
static void F_14 ( char * V_59 )
{
F_3 ( L_18 , V_59 ) ;
}
static void F_17 ( V_27 V_57 , T_1 * V_49 )
{
T_1 V_61 ;
for ( V_61 = 0 ; V_61 < V_57 ; V_61 ++ ) {
F_3 ( L_19 , L_20 , V_61 , V_49 [ V_61 ] ) ;
}
}
static void F_15 ( T_1 V_57 , T_1 * V_49 )
{
T_1 V_61 ;
for ( V_61 = 0 ; V_61 < V_57 ; V_61 ++ ) {
F_3 ( L_21 , V_49 [ V_61 ] ) ;
...
static void F_18 ( T_1 V_57 , V_25 * V_49 )
{
T_1 V_61 ;
for ( V_61 = 0 ; V_61 < V_57 ; V_61 ++ ) {
F_3 ( L_22 , L_23 , V_61 , V_49 [ V_61 ] ) ;
}
}
static void F_19 ( V_27 V_57 , V_27 * V_49 )
{
V_27 V_61 ;
for ( V_61 = 0 ; V_61 < V_57 ; V_61 ++ ) {
F_3 ( L_24 , L_25 , V_61 , V_49 [ V_61 ] ) ;
}
}
