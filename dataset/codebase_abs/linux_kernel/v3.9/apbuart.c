...
if ( F_18 ( V_32 ) || F_19 ( V_2 ) ) {
F_1 ( V_2 ) ;
return;
}
V_33 = V_2 -> V_12 >> 1 ;
do {
F_17 ( V_2 , V_32 -> V_36 [ V_32 -> V_37 ] ) ;
V_32 -> V_37 = ( V_32 -> V_37 + 1 ) & ( V_38 - 1 ) ;
V_2 -> V_14 . V_35 ++ ;
if ( F_18 ( V_32 ) )
break;
} while ( -- V_33 > 0 );
...
int V_51 ;
unsigned int V_3 ;
V_51 = F_30 ( V_2 -> V_40 , F_22 , 0 , L_1 , V_2 ) ;
if ( V_51 )
return V_51 ;
V_3 = F_2 ( V_2 ) ;
F_3 ( V_2 ,
...
static void
F_54 ( struct V_88 * V_89 , const char * V_90 , unsigned int V_33 )
{
...
V_2 -> V_40 = V_102 -> V_106 . V_107 [ 0 ] ;
F_67 ( & V_108 , (struct V_1 * ) V_2 ) ;
F_52 ( (struct V_1 * ) V_2 ) ;
F_68 ( V_109 L_6 ,
( unsigned long long ) V_2 -> V_74 , V_2 -> V_40 ) ;
return 0 ;
}
