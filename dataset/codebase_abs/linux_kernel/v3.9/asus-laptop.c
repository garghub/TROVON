...
F_122 ( & V_20 -> F_12 -> V_37 -> V_38 . V_212 ,
V_213 ) ;
return ;
}
F_106 ( V_20 , V_196 ) ;
}
static T_6 F_123 ( struct V_214 * V_212 ,
struct V_215 * V_118 ,
int V_216 )
{
struct V_35 * V_38 = F_26 ( V_212 , struct V_35 , V_212 ) ;
struct V_59 * V_217 = F_124 ( V_38 ) ;
struct V_19 * V_20 = F_125 ( V_217 ) ;
T_1 V_1 = V_20 -> V_1 ;
bool V_218 ;
if ( V_20 -> V_50 ) {
...
if ( V_157 )
goto V_231;
V_157 = F_130 ( & V_20 -> V_59 -> V_38 . V_212 ,
& V_232 ) ;
if ( V_157 )
goto V_233;
return 0 ;
...
{
F_134 ( & V_20 -> V_59 -> V_38 . V_212 , & V_232 ) ;
F_135 ( V_20 -> V_59 ) ;
}
...
V_10 =
F_10 ( V_20 -> V_1 , L_66 , NULL , & V_235 ) ;
if ( F_31 ( V_10 ) )
F_6 ( L_67 ) ;
else if ( V_235 )
F_138 ( L_68 ,
( V_125 ) V_235 ) ;
if ( F_3 ( V_20 -> V_1 , L_69 , V_237 ) )
F_54 ( L_70 , V_237 ) ;
if ( V_158 . V_12 ) {
V_234 = V_158 . V_12 ;
switch ( V_234 -> type ) {
...
if ( ! strcmp ( V_97 , L_74 ) )
V_20 -> V_97 = V_95 ;
else if ( ! strcmp ( V_97 , L_75 ) )
V_20 -> V_97 = V_183 ;
if ( ! strcmp ( V_94 , L_74 ) )
V_20 -> V_94 = V_95 ;
else if ( ! strcmp ( V_94 , L_75 ) )
V_20 -> V_94 = V_183 ;
if ( V_242 >= 0 )
F_68 ( V_20 , ! ! V_242 ) ;
if ( V_243 >= 0 )
...
if ( ! V_234 )
return;
if ( strncmp ( V_234 , L_76 , 6 ) == 0 ) {
V_243 = - 1 ;
}
}
static int F_145 ( struct V_202 * V_35 )
{
struct V_19 * V_20 ;
int V_157 ;
F_138 ( L_77 ,
V_124 ) ;
V_20 = F_146 ( sizeof( struct V_19 ) , V_240 ) ;
if ( ! V_20 )
return - V_51 ;
V_20 -> V_1 = V_35 -> V_1 ;
strcpy ( F_147 ( V_35 ) , V_248 ) ;
strcpy ( F_148 ( V_35 ) , V_249 ) ;
V_35 -> V_250 = V_20 ;
V_20 -> V_35 = V_35 ;
F_143 () ;
V_157 = F_141 ( V_20 ) ;
...
static int F_150 ( struct V_202 * V_35 )
{
struct V_19 * V_20 = F_118 ( V_35 ) ;
F_57 ( V_20 ) ;
F_98 ( V_20 ) ;
