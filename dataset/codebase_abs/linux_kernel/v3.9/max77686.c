...
struct V_31 * V_32 )
{
struct V_33 * V_34 = F_11 ( V_30 -> V_35 . V_36 ) ;
...
V_32 -> V_46 = F_14 ( V_47 ) ;
V_41 = F_15 ( & V_30 -> V_35 , sizeof( * V_41 ) *
V_32 -> V_46 , V_48 ) ;
if ( ! V_41 ) {
F_13 ( & V_30 -> V_35 ,
L_5 ) ;
...
{
struct V_33 * V_34 = F_11 ( V_30 -> V_35 . V_36 ) ;
struct V_31 * V_32 = F_17 ( V_34 -> V_35 ) ;
struct V_4 * V_5 ;
int V_44 , V_52 = 0 ;
struct V_53 V_54 = { } ;
F_18 ( & V_30 -> V_35 , L_6 , V_55 ) ;
if ( ! V_32 ) {
F_13 ( & V_30 -> V_35 , L_7 ) ;
return - V_56 ;
}
...
V_5 = F_15 ( & V_30 -> V_35 , sizeof( struct V_4 ) ,
V_48 ) ;
if ( ! V_5 )
return - V_49 ;
V_54 . V_35 = & V_30 -> V_35 ;
...
V_5 -> V_9 [ V_44 ] = V_47 [ V_44 ] . V_13 ;
V_5 -> V_2 [ V_44 ] = F_20 ( & V_47 [ V_44 ] , & V_54 ) ;
if ( F_21 ( V_5 -> V_2 [ V_44 ] ) ) {
V_52 = F_22 ( V_5 -> V_2 [ V_44 ] ) ;
F_13 ( & V_30 -> V_35 ,
L_9 , V_44 ) ;
V_5 -> V_2 [ V_44 ] = NULL ;
goto V_59;
