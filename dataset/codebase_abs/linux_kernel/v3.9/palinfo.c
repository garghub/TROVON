...
int V_4 ;
char V_164 [ 3 + 4 + 1 ] ;
sprintf ( V_164 , L_126 , V_161 ) ;
V_163 = F_43 ( V_164 , V_165 ) ;
if ( ! V_163 )
return;
V_151 . V_156 = V_161 ;
for ( V_4 = 0 ; V_4 < V_166 ; V_4 ++ ) {
V_151 . V_154 = V_4 ;
F_44 (
V_153 [ V_4 ] . V_167 , 0 , V_163 ,
F_39 , ( void * ) V_151 . V_10 ) ;
}
}
static void
F_45 ( unsigned int V_168 )
{
char V_164 [ 3 + 4 + 1 ] ;
sprintf ( V_164 , L_126 , V_168 ) ;
F_46 ( V_164 , V_165 ) ;
}
static int T_17 F_47 ( struct V_169 * V_170 ,
unsigned long V_171 , void * V_168 )
{
unsigned int V_172 = ( unsigned long ) V_168 ;
switch ( V_171 ) {
case V_173 :
case V_174 :
F_42 ( V_172 ) ;
...
{
int V_3 = 0 ;
F_8 ( V_178 L_127 , V_179 ) ;
V_165 = F_43 ( L_128 , NULL ) ;
if ( ! V_165 )
return - V_180 ;
F_49 (i) {
F_42 ( V_3 ) ;
