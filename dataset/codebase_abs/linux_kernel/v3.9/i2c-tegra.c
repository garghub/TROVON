...
{
struct V_1 * V_2 ;
struct V_136 * V_137 = V_135 -> V_19 . V_138 ;
struct V_139 * V_140 ;
struct V_141 * V_44 ;
struct V_141 * V_43 ;
...
int V_67 ;
int V_40 = 0 ;
V_140 = F_50 ( V_135 , V_143 , 0 ) ;
if ( ! V_140 ) {
F_25 ( & V_135 -> V_19 , L_9 ) ;
return - V_93 ;
}
V_5 = F_51 ( & V_135 -> V_19 , V_140 ) ;
if ( F_52 ( V_5 ) )
return F_53 ( V_5 ) ;
V_140 = F_50 ( V_135 , V_144 , 0 ) ;
if ( ! V_140 ) {
F_25 ( & V_135 -> V_19 , L_10 ) ;
return - V_93 ;
}
V_67 = V_140 -> V_145 ;
V_44 = F_54 ( & V_135 -> V_19 , L_11 ) ;
if ( F_52 ( V_44 ) ) {
F_25 ( & V_135 -> V_19 , L_12 ) ;
return F_53 ( V_44 ) ;
}
V_2 = F_55 ( & V_135 -> V_19 , sizeof( * V_2 ) , V_146 ) ;
if ( ! V_2 ) {
F_25 ( & V_135 -> V_19 , L_13 ) ;
return - V_147 ;
}
V_2 -> V_5 = V_5 ;
V_2 -> V_44 = V_44 ;
...
V_2 -> V_67 = V_67 ;
V_2 -> V_99 = V_135 -> V_151 ;
V_2 -> V_19 = & V_135 -> V_19 ;
V_2 -> V_54 = 100000 ;
if ( V_137 ) {
V_2 -> V_54 = V_137 -> V_54 ;
} else if ( V_2 -> V_19 -> V_152 ) {
V_142 = F_56 ( V_2 -> V_19 -> V_152 ,
L_14 , NULL ) ;
if ( V_142 )
V_2 -> V_54 = F_57 ( V_142 ) ;
}
...
V_155 = F_58 ( F_59 ( V_156 ) ,
& V_135 -> V_19 ) ;
V_2 -> V_41 = V_155 -> V_8 ;
V_2 -> V_6 = F_60 ( V_135 -> V_19 . V_152 ,
L_15 ) ;
} else if ( V_135 -> V_151 == 3 ) {
V_2 -> V_6 = 1 ;
}
F_61 ( & V_2 -> V_86 ) ;
if ( ! V_2 -> V_41 -> V_42 ) {
V_43 = F_54 ( & V_135 -> V_19 , L_16 ) ;
if ( F_52 ( V_43 ) ) {
...
V_40 = F_28 ( V_2 ) ;
if ( V_40 ) {
F_25 ( & V_135 -> V_19 , L_18 ) ;
return V_40 ;
}
V_40 = F_63 ( & V_135 -> V_19 , V_2 -> V_67 ,
F_34 , 0 , F_64 ( & V_135 -> V_19 ) , V_2 ) ;
if ( V_40 ) {
F_25 ( & V_135 -> V_19 , L_19 , V_2 -> V_67 ) ;
return V_40 ;
}
F_65 ( & V_2 -> V_148 , V_2 ) ;
V_2 -> V_148 . V_157 = V_158 ;
V_2 -> V_148 . V_159 = V_160 ;
F_66 ( V_2 -> V_148 . V_161 , L_20 ,
sizeof( V_2 -> V_148 . V_161 ) ) ;
V_2 -> V_148 . V_149 = & V_150 ;
V_2 -> V_148 . V_19 . V_162 = & V_135 -> V_19 ;
V_2 -> V_148 . V_163 = V_135 -> V_151 ;
V_2 -> V_148 . V_19 . V_152 = V_135 -> V_19 . V_152 ;
V_40 = F_67 ( & V_2 -> V_148 ) ;
if ( V_40 ) {
F_25 ( & V_135 -> V_19 , L_21 ) ;
return V_40 ;
}
F_68 ( & V_2 -> V_148 ) ;
return 0 ;
...
static int F_72 ( struct V_164 * V_19 )
{
...
static int F_76 ( struct V_164 * V_19 )
{
struct V_1 * V_2 = F_73 ( V_19 ) ;
int V_40 ;
F_74 ( & V_2 -> V_148 ) ;
