...
return;
if ( F_68 ( V_4 ) ) {
F_69 ( & V_4 -> V_7 . V_53 , V_54 ) ;
F_70 ( V_55 , & V_4 -> V_7 . V_53 ) ;
} else
F_71 ( & V_4 -> V_43 , V_56 ) ;
}
...
bool (* F_90)( struct V_3 * , void * ) , void * V_67 )
{
struct V_3 * V_4 = NULL ;
F_2 ( L_9 ,
V_2 , F_29 ( V_2 ) ) ;
...
static bool F_91 ( struct V_3 * V_4 , void * V_67 )
{
return true ;
}
...
void F_94 ( struct V_1 * V_2 , int V_69 )
{
struct V_15 * V_68 ;
F_77 ( & V_2 -> V_34 ) ;
V_68 = & V_2 -> V_17 [ V_2 -> V_24 ] ;
...
void F_101 ( struct V_3 * V_4 , unsigned long V_75 )
{
V_4 -> V_5 = V_75 ;
F_74 ( & V_76 , V_4 , F_100 ) ;
}
...
void F_110 ( struct V_3 * V_4 , int V_69 )
{
V_4 -> V_58 = V_69 ;
V_4 -> V_89 = F_106 ;
if ( F_24 ( V_4 ) )
...
void F_111 ( const struct V_91 * V_92 , void * V_93 )
{
if ( V_92 -> V_94 != NULL )
V_92 -> V_94 ( V_93 ) ;
}
...
{
V_38 -> V_48 |= V_98 ;
F_112 ( F_119 ( V_97 , struct V_3 , V_7 . V_53 ) ) ;
V_38 -> V_48 &= ~ V_98 ;
}
void * F_120 ( struct V_3 * V_4 , T_5 V_99 )
{
struct V_100 * V_101 ;
T_6 V_102 = V_103 ;
if ( F_26 ( V_4 ) )
...
if ( V_99 <= V_105 )
V_101 = F_121 ( V_106 , V_102 ) ;
else
V_101 = F_122 ( V_99 , V_102 ) ;
if ( ! V_101 )
return NULL ;
V_101 -> V_107 = V_99 ;
F_2 ( L_16 ,
...
void F_123 ( void * V_108 )
{
T_5 V_99 ;
struct V_100 * V_101 ;
if ( ! V_108 )
return;
V_101 = F_119 ( V_108 , struct V_100 , V_67 ) ;
V_99 = V_101 -> V_107 ;
F_2 ( L_17 ,
V_99 , V_101 ) ;
if ( V_99 <= V_105 )
...
static void F_126 ( struct V_3 * V_4 , const struct V_109 * V_110 )
{
...
F_129 ( void )
{
return (struct V_3 * ) F_121 ( V_117 , V_118 ) ;
}
struct V_3 * F_130 ( const struct V_109 * V_119 )
{
...
F_111 ( V_4 -> V_77 , V_4 -> V_79 ) ;
if ( V_85 & V_121 ) {
F_2 ( L_20 , V_4 -> V_6 ) ;
F_124 ( V_4 , V_117 ) ;
}
}
static void F_133 ( struct V_96 * V_97 )
{
F_132 ( F_119 ( V_97 , struct V_3 , V_7 . V_53 ) ) ;
}
static void F_134 ( struct V_3 * V_4 )
{
F_109 ( V_4 ) ;
if ( V_4 -> V_122 . V_123 ) {
F_135 ( V_4 -> V_122 . V_123 ) ;
...
{
if ( V_16 != NULL ) {
F_69 ( & V_4 -> V_7 . V_53 , F_133 ) ;
F_70 ( V_16 , & V_4 -> V_7 . V_53 ) ;
} else
F_132 ( V_4 ) ;
}
static void F_138 ( struct V_3 * V_4 , struct V_124 * V_16 )
{
if ( F_58 ( & V_4 -> V_50 ) ) {
F_134 ( V_4 ) ;
F_137 ( V_4 , V_16 ) ;
