...
static int F_33 ( struct V_61 * V_6 ,
T_3 V_66 )
{
struct V_1 * V_2 = F_26 ( V_6 ) ;
F_32 ( & V_2 -> V_53 ) ;
...
static int F_34 ( struct V_61 * V_6 )
{
struct V_1 * V_2 = F_26 ( V_6 ) ;
F_22 ( & V_2 -> V_53 , V_54 ) ;
return 0 ;
}
static int F_35 ( struct V_61 * V_6 ,
...
F_29 ( & V_63 ) ;
V_5 = F_36 ( & V_64 , V_6 , 0 , 0 , V_74 ) ;
F_31 ( & V_63 ) ;
if ( V_5 < 0 )
goto V_75;
V_71 = V_5 ;
V_2 = F_37 ( sizeof( * V_2 ) , V_74 ) ;
if ( ! V_2 ) {
V_5 = - V_76 ;
goto V_77;
}
V_2 -> V_50 . V_62 = F_38 ( V_74 , L_5 , V_6 -> V_62 , V_71 ) ;
if ( ! V_2 -> V_50 . V_62 ) {
V_5 = - V_76 ;
goto V_78;
}
