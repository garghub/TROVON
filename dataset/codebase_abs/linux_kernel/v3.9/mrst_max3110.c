...
static int F_75 ( struct V_7 * V_8 , T_5 V_66 )
{
struct V_1 * V_2 = F_76 ( V_8 ) ;
F_77 ( V_2 -> V_83 ) ;
F_78 ( & V_143 , & V_2 -> V_31 ) ;
...
return 0 ;
V_157:
F_90 ( ( unsigned long ) V_144 ) ;
V_155:
F_9 ( V_2 ) ;
return V_13 ;
}
static int F_91 ( struct V_7 * V_150 )
{
struct V_1 * V_2 = F_76 ( V_150 ) ;
if ( ! V_2 )
return 0 ;
F_92 ( & V_143 , & V_2 -> V_31 ) ;
F_90 ( ( unsigned long ) V_2 -> V_35 . V_20 ) ;
if ( V_2 -> V_156 )
F_58 ( V_2 -> V_156 ) ;
F_9 ( V_2 ) ;
return 0 ;
