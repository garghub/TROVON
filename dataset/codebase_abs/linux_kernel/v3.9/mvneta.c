...
V_294 , V_2 ) ;
if ( V_270 ) {
F_75 ( V_2 -> V_17 , L_26 , V_2 -> V_17 -> V_254 ) ;
goto V_295;
}
F_167 ( V_2 -> V_17 ) ;
V_270 = F_177 ( V_2 ) ;
...
V_211 = F_224 ( V_17 ) ;
if ( V_211 < 0 ) {
F_206 ( & V_337 -> V_17 , L_34 ) ;
goto V_362;
}
F_126 ( V_17 , L_35 , V_17 -> V_252 ) ;
