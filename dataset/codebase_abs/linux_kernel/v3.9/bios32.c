...
F_36 ( & V_64 -> V_76 ) ;
if ( V_89 -> V_95 )
V_64 -> V_95 = V_89 -> V_95 [ V_91 ] ;
V_73 = V_89 -> V_96 ( V_91 , V_64 ) ;
if ( V_73 > 0 ) {
V_73 = F_26 ( V_91 , V_64 ) ;
if ( V_73 ) {
F_37 ( V_64 ) ;
...
if ( V_89 -> V_97 )
V_64 -> V_2 = V_89 -> V_97 ( V_91 , V_64 ) ;
else
V_64 -> V_2 = F_38 ( NULL , V_64 -> V_72 ,
V_89 -> V_98 , V_64 , & V_64 -> V_76 ) ;
if ( ! V_64 -> V_2 )
F_34 ( L_10 ) ;
V_72 = V_64 -> V_2 -> V_99 . V_19 + 1 ;
F_39 ( & V_64 -> V_100 , V_90 ) ;
} else {
F_37 ( V_64 ) ;
if ( V_73 < 0 )
break;
...
char * T_5 F_50 ( char * V_105 )
{
if ( ! strcmp ( V_105 , L_11 ) ) {
V_69 = 1 ;
return NULL ;
} else if ( ! strcmp ( V_105 , L_12 ) ) {
F_42 ( V_104 ) ;
return NULL ;
}
return V_105 ;
}
T_6 F_51 ( void * V_106 , const struct V_18 * V_79 ,
T_6 V_107 , T_6 V_108 )
{
T_6 V_20 = V_79 -> V_20 ;
if ( V_79 -> V_25 & V_80 && V_20 & 0x300 )
V_20 = ( V_20 + 0x3ff ) & ~ 0x3ff ;
V_20 = ( V_20 + V_108 - 1 ) & ~ ( V_108 - 1 ) ;
return V_20 ;
}
int F_52 ( struct V_5 * V_6 , int V_109 )
{
T_2 V_54 , V_110 ;
int V_111 ;
struct V_18 * V_26 ;
...
int F_53 ( struct V_5 * V_6 , struct V_117 * V_118 ,
enum V_119 V_120 , int V_121 )
{
struct V_63 * V_122 = V_6 -> V_65 ;
unsigned long V_123 ;
if ( V_120 == V_124 ) {
return - V_113 ;
} else {
V_123 = V_118 -> V_125 + ( V_122 -> V_78 >> V_126 ) ;
}
V_118 -> V_127 = F_54 ( V_118 -> V_127 ) ;
if ( F_55 ( V_118 , V_118 -> V_128 , V_123 ,
V_118 -> V_129 - V_118 -> V_128 ,
V_118 -> V_127 ) )
return - V_130 ;
return 0 ;
}
void T_5 F_56 ( unsigned long V_131 )
{
struct V_132 V_133 = {
. V_134 = V_135 ,
. type = V_136 ,
