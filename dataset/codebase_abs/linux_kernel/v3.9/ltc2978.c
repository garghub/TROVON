...
V_53 ) )
return - V_54 ;
V_1 = F_13 ( & V_5 -> V_55 , sizeof( struct V_10 ) ,
V_56 ) ;
if ( ! V_1 )
return - V_57 ;
V_50 = F_14 ( V_5 , V_58 ) ;
...
F_15 ( & V_5 -> V_55 , L_1 , V_50 ) ;
return - V_54 ;
}
if ( V_1 -> V_44 != V_44 -> V_64 )
F_16 ( & V_5 -> V_55 ,
L_2 ,
V_44 -> V_65 ,
V_66 [ V_1 -> V_44 ] . V_65 ) ;
...
V_1 -> V_14 = 0x7c00 ;
V_1 -> V_33 = 0x7bff ;
for ( V_51 = 0 ; V_51 < F_17 ( V_1 -> V_20 ) ; V_51 ++ )
V_1 -> V_20 [ V_51 ] = 0x7c00 ;
V_1 -> V_42 = 0x7c00 ;
switch ( V_1 -> V_44 ) {
case V_45 :
V_9 -> V_68 = F_6 ;
V_9 -> V_69 = 8 ;
V_9 -> V_70 [ 0 ] = V_71 | V_72
| V_73 | V_74
| V_75 | V_76 ;
...
V_9 -> V_68 = F_7 ;
V_9 -> V_69 = 2 ;
V_9 -> V_70 [ 0 ] = V_71 | V_77
| V_72
| V_73 | V_74
| V_78 | V_79
| V_80 | V_75
| V_81 | V_76 ;
V_9 -> V_70 [ 1 ] = V_73 | V_74
| V_78 | V_79
| V_80
| V_75 | V_76 ;
V_1 -> V_40 [ 0 ] = 0x7c00 ;
...
for ( V_51 = 0 ; V_51 < V_9 -> V_69 ; V_51 ++ )
V_1 -> V_30 [ V_51 ] = 0xffff ;
return F_18 ( V_5 , V_44 , V_9 ) ;
}
