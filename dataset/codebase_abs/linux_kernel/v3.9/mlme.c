...
void F_69 ( struct V_5 * V_6 , T_6 V_100 ,
struct V_53 * V_54 ,
unsigned int V_101 , T_4 V_46 )
{
struct V_8 * V_8 = V_6 -> V_8 ;
struct V_9 * V_10 = F_2 ( V_8 ) ;
F_70 ( V_6 , V_100 , V_54 , V_101 ) ;
F_71 ( V_10 , V_6 , V_100 , V_54 , V_101 , V_46 ) ;
}
void F_72 ( struct V_5 * V_6 , T_6 V_100 ,
struct V_53 * V_54 ,
T_4 V_46 )
{
struct V_8 * V_8 = V_6 -> V_8 ;
struct V_9 * V_10 = F_2 ( V_8 ) ;
F_73 ( V_6 , V_100 , V_54 ) ;
F_74 ( V_10 , V_6 , V_100 , V_54 , V_46 ) ;
}
void F_75 ( struct V_1 * V_2 , const T_1 * V_102 ,
struct V_103 * V_104 , T_4 V_46 )
{
struct V_8 * V_8 = V_2 -> V_7 -> V_8 ;
struct V_9 * V_10 = F_2 ( V_8 ) ;
F_76 ( V_2 , V_102 , V_104 ) ;
F_77 ( V_10 , V_2 , V_102 , V_104 , V_46 ) ;
}
void F_78 ( struct V_1 * V_2 , const T_1 * V_102 , T_4 V_46 )
{
struct V_8 * V_8 = V_2 -> V_7 -> V_8 ;
struct V_9 * V_10 = F_2 ( V_8 ) ;
F_79 ( V_2 , V_102 ) ;
F_80 ( V_10 , V_2 , V_102 , V_46 ) ;
}
void F_81 ( struct V_1 * V_2 , const T_1 * V_102 ,
enum V_105 V_92 ,
T_4 V_46 )
{
struct V_8 * V_8 = V_2 -> V_7 -> V_8 ;
struct V_9 * V_10 = F_2 ( V_8 ) ;
F_82 ( V_10 , V_2 , V_102 , V_92 , V_46 ) ;
}
int F_83 ( struct V_5 * V_6 , T_5 V_106 ,
...
return - V_69 ;
V_113 = ( V_107 & V_118 ) >> 4 ;
if ( ! ( V_6 -> V_8 -> V_114 [ V_6 -> V_119 ] . V_120 & F_84 ( V_113 ) ) )
return - V_69 ;
V_112 = F_85 ( sizeof( * V_111 ) + V_109 , V_11 ) ;
if ( ! V_112 )
return - V_121 ;
F_86 ( & V_6 -> V_122 ) ;
F_87 (reg, &wdev->mgmt_registrations, list) {
int V_123 = F_88 ( V_109 , V_111 -> V_109 ) ;
...
V_112 -> V_109 = V_109 ;
V_112 -> V_125 = V_106 ;
V_112 -> V_107 = F_89 ( V_107 ) ;
F_90 ( & V_112 -> V_126 , & V_6 -> V_127 ) ;
if ( V_10 -> V_98 -> V_128 )
F_91 ( V_10 , V_6 , V_107 , true ) ;
V_24:
F_92 ( & V_6 -> V_122 ) ;
return V_67 ;
}
void F_93 ( struct V_5 * V_6 , T_5 V_125 )
{
struct V_8 * V_8 = V_6 -> V_8 ;
struct V_9 * V_10 = F_2 ( V_8 ) ;
struct V_110 * V_111 , * V_129 ;
F_86 ( & V_6 -> V_122 ) ;
F_94 (reg, tmp, &wdev->mgmt_registrations, list) {
...
if ( ! ( V_6 -> V_8 -> V_114 [ V_6 -> V_119 ] . V_138 & F_84 ( V_135 >> 4 ) ) )
return - V_69 ;
if ( F_99 ( V_16 -> V_137 ) &&
...
if ( ! F_20 ( V_16 -> V_36 , F_100 ( V_6 ) ) )
return - V_69 ;
return F_101 ( V_10 , V_6 , V_54 , V_131 ,
V_132 , V_3 , V_4 , V_133 , V_134 ,
V_100 ) ;
}
bool F_102 ( struct V_5 * V_6 , int V_151 , int V_152 ,
...
F_89 ( V_116 | V_118 ) ;
T_3 V_135 ;
F_103 ( V_6 , V_151 , V_152 ) ;
V_135 = ( F_11 ( V_16 -> V_137 ) & V_118 ) >> 4 ;
if ( ! ( V_154 -> V_120 & F_84 ( V_135 ) ) ) {
F_104 ( false ) ;
return false ;
}
V_50 = V_3 + F_105 ( V_16 -> V_137 ) ;
V_155 = V_4 - F_105 ( V_16 -> V_137 ) ;
F_86 ( & V_6 -> V_122 ) ;
F_87 (reg, &wdev->mgmt_registrations, list) {
...
void F_107 ( struct V_5 * V_6 , T_6 V_100 ,
const T_1 * V_3 , T_2 V_4 , bool V_158 , T_4 V_46 )
{
struct V_8 * V_8 = V_6 -> V_8 ;
struct V_9 * V_10 = F_2 ( V_8 ) ;
F_108 ( V_6 , V_100 , V_158 ) ;
F_109 ( V_10 , V_6 , V_100 , V_3 , V_4 , V_158 , V_46 ) ;
}
...
struct V_8 * V_8 = V_6 -> V_8 ;
struct V_9 * V_10 = F_2 ( V_8 ) ;
F_114 ( V_2 , V_161 , V_162 ) ;
F_115 ( V_10 , V_2 , V_161 , V_162 , V_46 ) ;
}
...
struct V_8 * V_8 = V_6 -> V_8 ;
struct V_9 * V_10 = F_2 ( V_8 ) ;
F_117 ( V_10 , V_2 , V_161 , V_162 ,
V_163 , V_164 , V_46 ) ;
}
void F_118 ( struct V_1 * V_2 , const T_1 * V_28 ,
...
struct V_9 * V_10 = F_2 ( V_8 ) ;
F_119 ( V_2 , V_28 ) ;
F_120 ( V_10 , V_2 , V_28 , V_165 , V_46 ) ;
}
void F_121 ( struct V_1 * V_2 , int V_166 ,
const T_1 * V_28 , bool V_167 , T_4 V_46 )
{
struct V_5 * V_6 = V_2 -> V_7 ;
struct V_8 * V_8 = V_6 -> V_8 ;
struct V_9 * V_10 = F_2 ( V_8 ) ;
F_122 ( V_2 , V_166 , V_28 , V_167 ) ;
F_123 ( V_10 , V_2 , V_166 , V_28 , V_167 , V_46 ) ;
}
...
int V_179 , V_79 ;
V_170 = F_125 ( V_169 , struct V_170 , V_169 ) ;
V_10 = F_125 ( V_170 , struct V_9 ,
V_180 ) ;
V_8 = & V_10 -> V_8 ;
F_55 ( & V_181 ) ;
for ( V_179 = 0 ; V_179 < V_182 ; V_179 ++ ) {
V_174 = V_8 -> V_183 [ V_179 ] ;
if ( ! V_174 )
continue;
for ( V_79 = 0 ; V_79 < V_174 -> V_184 ; V_79 ++ ) {
V_175 = & V_174 -> V_185 [ V_79 ] ;
if ( V_175 -> V_186 != V_187 )
continue;
V_177 = V_175 -> V_188 +
V_189 ;
if ( F_126 ( V_190 , V_177 ) ) {
V_175 -> V_186 = V_191 ;
F_127 ( & V_172 , V_175 ,
V_192 ) ;
F_128 ( V_10 , & V_172 ,
...
V_178 = F_88 ( V_178 , V_177 - V_190 ) ;
V_176 = true ;
}
}
F_56 ( & V_181 ) ;
if ( V_176 )
F_129 ( V_194 , & V_10 -> V_180 ,
V_178 ) ;
}
...
unsigned long V_177 ;
F_131 ( V_8 , V_172 ) ;
F_132 ( V_8 , V_172 , V_187 ) ;
V_177 = F_133 ( V_189 ) ;
F_129 ( V_194 , & V_10 -> V_180 ,
V_177 ) ;
F_128 ( V_10 , V_172 , V_195 , NULL , V_46 ) ;
}
void F_134 ( struct V_1 * V_196 ,
enum V_197 V_198 , T_4 V_46 )
{
struct V_5 * V_6 = V_196 -> V_7 ;
struct V_8 * V_8 = V_6 -> V_8 ;
struct V_9 * V_10 = F_2 ( V_8 ) ;
struct V_171 V_172 ;
unsigned long V_177 ;
...
if ( F_29 ( ! V_6 -> V_73 ) )
return;
F_127 ( & V_172 , V_6 -> V_73 , V_192 ) ;
switch ( V_198 ) {
case V_200 :
V_177 = V_6 -> V_201 +
F_133 ( V_202 ) ;
F_29 ( ! F_126 ( V_190 , V_177 ) ) ;
F_132 ( V_8 , & V_172 , V_203 ) ;
break;
case V_204 :
break;
default:
...
V_6 -> V_199 = false ;
F_128 ( V_10 , & V_172 , V_198 , V_196 , V_46 ) ;
}
