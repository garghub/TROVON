...
struct V_15 * V_15 = (struct V_15 * ) V_3 ;
F_18 ( V_47 , L_9 , V_11 ) ;
V_6 = F_19 ( V_15 , V_49 , 0xf0 | ( V_11 & 0xf ) ) ;
return ( V_6 < 0 ) ? V_6 : 0 ;
}
...
V_50 = V_11 % V_52 ;
V_51 = F_22 ( 512 , V_11 / V_52 ) ;
F_18 ( V_47 , L_10 ,
V_51 , V_50 ) ;
V_6 = F_19 ( V_15 , V_53 , V_50 >> 8 ) ;
if ( V_6 < 0 )
goto V_54;
V_6 = F_19 ( V_15 , V_55 , V_50 & 0xff ) ;
if ( V_6 < 0 )
goto V_54;
V_6 = F_19 ( V_15 , V_56 , V_51 >> 8 ) ;
if ( V_6 < 0 )
goto V_54;
V_6 = F_19 ( V_15 , V_57 , V_51 & 0xff ) ;
V_54:
return V_6 ;
}
