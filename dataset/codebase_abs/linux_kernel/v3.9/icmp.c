...
( V_69 -> V_89 + sizeof( * V_71 ) ) > V_69 -> V_90 )
goto V_16;
if ( V_69 -> V_91 != V_92 )
goto V_16;
if ( V_8 -> V_93 & ( V_94 | V_95 ) )
goto V_16;
if ( V_71 -> V_96 & F_56 ( V_97 ) )
goto V_16;
if ( V_39 [ type ] . error ) {
if ( V_71 -> V_98 == V_67 ) {
T_3 V_99 , * V_100 ;
...
if ( F_61 ( V_8 ) &&
V_2 -> V_3 . V_104 )
V_19 = F_62 ( V_2 , F_63 ( V_69 ) ) ;
if ( V_19 )
V_56 = F_64 ( V_19 , 0 , V_105 ) ;
else
V_56 = 0 ;
F_65 () ;
}
...
static void F_68 ( struct V_34 * V_35 , T_4 V_86 )
{
const struct V_70 * V_71 = ( const struct V_70 * ) V_35 -> V_40 ;
const struct V_111 * V_112 ;
int V_98 = V_71 -> V_98 ;
if ( ! F_69 ( V_35 , V_71 -> V_101 * 4 + 8 ) )
return;
F_70 ( V_35 , V_98 , V_86 ) ;
F_60 () ;
V_112 = F_71 ( V_113 [ V_98 ] ) ;
...
struct V_2 * V_2 ;
T_4 V_86 = 0 ;
V_2 = F_22 ( F_73 ( V_35 ) -> V_19 ) ;
if ( ! F_69 ( V_35 , sizeof( struct V_70 ) ) )
goto V_115;
V_41 = F_28 ( V_35 ) ;
...
case V_18 :
if ( V_120 . V_121 ) {
F_74 (KERN_INFO pr_fmt(L_1),
&iph->daddr) ;
} else {
V_86 = F_75 ( V_41 -> V_108 . V_122 . V_123 ) ;
if ( ! V_86 )
goto V_16;
}
break;
case V_124 :
F_74 (KERN_INFO pr_fmt(L_2),
&iph->daddr) ;
break;
default:
break;
...
if ( ! F_69 ( V_35 , sizeof( struct V_70 ) ) )
return;
F_68 ( V_35 , F_28 ( V_35 ) -> V_108 . V_109 ) ;
}
...
goto V_115;
F_81 ( & V_134 ) ;
V_37 . V_40 . V_135 [ 1 ] = F_82 ( ( V_134 . V_136 % 86400 ) * V_137 +
V_134 . V_138 / V_139 ) ;
V_37 . V_40 . V_135 [ 2 ] = V_37 . V_40 . V_135 [ 1 ] ;
if ( F_83 ( V_35 , 0 , & V_37 . V_40 . V_135 [ 0 ] , 4 ) )
F_84 () ;
V_37 . V_40 . V_41 = * F_28 ( V_35 ) ;
...
return;
V_115:
F_24 ( F_22 ( F_73 ( V_35 ) -> V_19 ) , V_130 ) ;
goto V_16;
}
...
struct V_7 * V_8 = F_35 ( V_35 ) ;
struct V_2 * V_2 = F_22 ( V_8 -> V_13 . V_19 ) ;
if ( ! F_87 ( NULL , V_141 , V_35 ) ) {
struct V_142 * V_143 = F_88 ( V_35 ) ;
int V_144 ;
if ( ! ( V_143 && V_143 -> V_145 [ V_143 -> V_32 - 1 ] -> V_146 . V_20 &
V_147 ) )
goto V_148;
if ( ! F_69 ( V_35 , sizeof( * V_41 ) + sizeof( struct V_70 ) ) )
goto V_148;
V_144 = F_66 ( V_35 ) ;
F_89 ( V_35 , sizeof( * V_41 ) ) ;
...
void F_96 ( struct V_34 * V_35 , T_4 V_86 )
{
struct V_70 * V_71 = (struct V_70 * ) V_35 -> V_40 ;
struct V_49 * V_41 = (struct V_49 * ) ( V_35 -> V_40 + ( V_71 -> V_101 << 2 ) ) ;
...
if ( type == V_17 && V_11 == V_18 )
F_98 ( V_35 , V_2 , V_86 , 0 , 0 , V_67 , 0 ) ;
else if ( type == V_156 )
F_99 ( V_35 , V_2 , 0 , 0 , V_67 , 0 ) ;
}
static void T_5 F_100 ( struct V_2 * V_2 )
{
int V_157 ;
F_101 (i)
F_102 ( V_2 -> V_3 . F_1 [ V_157 ] ) ;
F_103 ( V_2 -> V_3 . F_1 ) ;
V_2 -> V_3 . F_1 = NULL ;
}
static int T_6 F_104 ( struct V_2 * V_2 )
{
int V_157 , V_75 ;
V_2 -> V_3 . F_1 =
F_105 ( V_158 * sizeof( struct V_1 * ) , V_159 ) ;
if ( V_2 -> V_3 . F_1 == NULL )
return - V_160 ;
F_101 (i) {
struct V_1 * V_4 ;
V_75 = F_106 ( & V_4 , V_161 ,
V_162 , V_67 , V_2 ) ;
if ( V_75 < 0 )
goto V_163;
V_2 -> V_3 . F_1 [ V_157 ] = V_4 ;
V_4 -> V_164 = 2 * F_107 ( 64 * 1024 ) ;
F_108 ( V_4 , V_165 ) ;
F_37 ( V_4 ) -> V_166 = V_167 ;
}
V_2 -> V_3 . V_131 = 0 ;
V_2 -> V_3 . V_153 = 1 ;
V_2 -> V_3 . V_127 = 1 ;
V_2 -> V_3 . V_27 = 1 * V_168 ;
V_2 -> V_3 . V_22 = 0x1818 ;
V_2 -> V_3 . V_104 = 0 ;
return 0 ;
V_163:
