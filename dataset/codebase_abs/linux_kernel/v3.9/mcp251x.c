...
F_48 ( & V_10 -> V_12 , L_9 , V_149 , V_150 ) ;
...
V_206 |= V_209 ;
V_22 = F_70 ( V_10 -> V_154 , NULL , F_65 ,
V_206 , V_210 , V_4 ) ;
if ( V_22 ) {
...
if ( V_23 ) {
V_10 -> V_12 . V_229 = ~ 0 ;
V_4 -> V_16 = F_78 ( & V_10 -> V_12 ,
V_230 ,
& V_4 -> V_25 ,
V_231 ) ;
if ( V_4 -> V_16 ) {
V_4 -> V_18 = ( V_4 -> V_16 + ( V_230 / 2 ) ) ;
V_4 -> V_27 = ( V_232 ) ( V_4 -> V_25 +
( V_230 / 2 ) ) ;
} else {
V_23 = 0 ;
}
...
if ( ! V_23 ) {
V_4 -> V_16 = F_79 ( V_47 , V_233 ) ;
if ( ! V_4 -> V_16 ) {
V_22 = - V_216 ;
goto V_234;
}
V_4 -> V_18 = F_79 ( V_47 , V_233 ) ;
if ( ! V_4 -> V_18 ) {
V_22 = - V_216 ;
goto V_235;
}
...
static int F_89 ( struct V_9 * V_10 , T_6 V_99 )
{
struct V_151 * V_152 = V_10 -> V_12 . V_153 ;
struct V_3 * V_4 = F_6 ( & V_10 -> V_12 ) ;
struct V_1 * V_2 = V_4 -> V_2 ;
