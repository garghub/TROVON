...
struct V_125 V_34 = { V_126 , NULL } ;
union V_127 V_128 [ 4 ] , * V_129 ;
struct V_130 V_131 ;
struct V_132 * V_133 ;
T_5 V_134 ;
V_134 = F_60 ( & V_2 -> V_45 ) ;
if ( ! V_134 || F_61 ( V_134 , & V_133 ) )
return - V_119 ;
V_131 . V_83 = F_62 ( V_128 ) ;
V_131 . V_135 = V_128 ;
V_128 [ 0 ] . type = V_136 ;
V_128 [ 0 ] . V_70 . V_18 = sizeof( V_124 ) ;
V_128 [ 0 ] . V_70 . V_135 = V_124 ;
V_128 [ 1 ] . type = V_137 ;
V_128 [ 1 ] . integer . V_109 = 1 ;
V_128 [ 2 ] . type = V_137 ;
V_128 [ 2 ] . integer . V_109 = 1 ;
V_128 [ 3 ] . type = V_137 ;
V_128 [ 3 ] . integer . V_109 = 0 ;
if ( F_63 ( F_64 ( V_134 , L_35 , & V_131 , & V_34 ) ) ) {
F_13 ( & V_2 -> V_45 , L_36 ) ;
return - V_119 ;
}
V_129 = (union V_127 * ) V_34 . V_135 ;
if ( V_129 -> type != V_137 ) {
F_13 ( & V_2 -> V_45 , L_37 ,
V_129 -> type ) ;
F_29 ( V_34 . V_135 ) ;
...
V_123 -> V_138 = V_129 -> integer . V_109 ;
F_29 ( V_34 . V_135 ) ;
return 0 ;
}
...
const struct V_139 * V_63 )
{
int V_14 ;
struct V_10 * V_11 ;
struct V_72 * V_60 ;
V_80 V_140 ;
struct V_122 * V_141 = V_2 -> V_45 . V_141 ;
F_37 ( L_38 , V_2 -> V_30 ) ;
if ( ! V_2 -> V_62 ) {
F_13 ( & V_2 -> V_45 ,
L_39 ) ;
...
F_66 ( V_2 , V_11 ) ;
V_11 -> V_2 = V_2 ;
V_140 = V_11 -> V_123 . V_138 ;
V_11 -> V_24 = F_67 ( V_140 ) ;
F_68 ( & V_11 -> V_19 ) ;
V_14 = F_32 ( V_11 , V_97 ) ;
if ( V_14 < 0 )
goto V_142;
...
V_60 -> V_146 = F_33 ;
V_60 -> V_147 = F_35 ;
V_60 -> V_45 . V_148 = & V_2 -> V_45 ;
F_72 ( & V_60 -> V_45 , F_60 ( & V_2 -> V_45 ) ) ;
V_60 -> V_149 = V_150 ;
V_60 -> V_151 = F_12 ( V_11 -> V_42 . V_121 ) ;
V_60 -> V_152 = F_12 ( V_11 -> V_42 . V_153 ) ;
V_60 -> V_154 = F_12 ( V_11 -> V_42 . V_155 ) ;
snprintf ( V_60 -> V_117 , sizeof( V_60 -> V_117 ) , L_41 ,
V_2 -> V_117 , V_60 -> V_152 , V_60 -> V_154 ) ;
V_14 = F_73 ( V_60 ) ;
if ( V_14 ) {
if ( V_14 != - V_119 )
F_39 ( V_2 , L_42 , V_14 ) ;
...
static int F_77 ( struct V_67 * V_45 )
{
...
static int F_81 ( struct V_67 * V_45 )
{
int V_14 ;
struct V_1 * V_2 = F_78 ( V_45 ) ;
V_14 = F_16 ( V_2 ) ;
