...
static void F_25 ( unsigned int V_37 , struct V_38 * V_39 )
{
struct V_5 * V_6 = V_29 ;
int V_40 , V_41 = 0 ;
unsigned int V_21 , V_22 , V_42 ;
...
if ( ( V_6 -> V_47 == 0 ) && ( V_22 & ( V_48 | V_49 ) ) ) {
F_26 ( V_6 -> V_50 ) ;
V_41 = 1 ;
}
if ( V_41 )
V_39 -> V_33 . V_51 -> V_52 ( & V_39 -> V_33 ) ;
}
static unsigned int F_27 ( unsigned int V_37 )
{
...
if ( V_65 [ V_40 ] . V_59 != ~ 0 && V_65 [ V_40 ] . V_58 != ~ 0 ) {
V_58 = V_65 [ V_40 ] . V_58 ;
V_59 = V_65 [ V_40 ] . V_59 ;
V_60 = ( ( V_59 - 1 ) & ~ V_59 ) + 1 ;
} else {
...
F_11 ( V_6 , V_18 , 0 , V_61 + V_79 + V_40 * 4 ,
V_60 ) ;
F_11 ( V_6 , V_18 , 0 , V_80 + V_40 * 4 , V_59 ) ;
F_11 ( V_6 , V_18 , 0 , V_61 + V_81 + V_40 * 4 , V_58 ) ;
F_18 ( V_32 L_7 ,
V_40 , V_59 , V_58 ) ;
}
...
static T_3 F_35 ( int V_37 , void * V_87 )
{
F_18 ( V_88 L_8 ) ;
return V_89 ;
}
static T_3 F_36 ( int V_37 , void * V_87 )
{
struct V_5 * V_6 = V_87 ;
struct V_63 * V_20 = V_6 -> V_20 ;
unsigned int V_90 ;
...
V_6 -> V_20 = V_20 ;
V_6 -> V_37 = V_97 -> V_110 . V_111 [ 0 ] ;
V_6 -> V_47 = ( V_100 & V_112 ) >> V_113 ;
F_18 ( V_32 L_18 , V_20 , V_6 -> V_37 ) ;
V_6 -> V_77 = 1 ;
...
V_6 -> V_44 = F_27 ( 5 ) ;
if ( V_6 -> V_47 & 1 )
V_6 -> V_50 = V_97 -> V_110 . V_111 [ 1 ] ;
else
V_6 -> V_50 = F_27 ( 6 ) ;
V_98 = F_45 ( V_6 -> V_37 , F_35 , 0 ,
L_27 , V_6 ) ;
if ( V_98 )
F_18 ( V_88 L_28 ) ;
} else {
for ( V_40 = 0 ; V_40 < 4 ; V_40 ++ ) {
F_44 ( V_97 -> V_110 . V_111 [ V_40 ] ,
V_133 , L_5 ,
1 ) ;
V_6 -> V_10 [ V_40 ] = V_97 -> V_110 . V_111 [ V_40 ] ;
}
V_6 -> V_44 = V_6 -> V_10 [ 0 ] ;
if ( V_6 -> V_47 & 1 )
V_6 -> V_50 = V_97 -> V_110 . V_111 [ 4 ] ;
else
V_6 -> V_50 = V_6 -> V_10 [ 0 ] ;
F_4 ( V_20 -> V_21 , F_5 ( V_20 -> V_21 ) | ( V_6 -> V_115 & 0xf ) ) ;
}
V_98 = F_45 ( V_6 -> V_44 , F_36 , V_134 ,
L_29 , V_6 ) ;
if ( V_98 ) {
F_18 ( V_135 L_30 , V_98 ) ;
goto V_136;
}
F_4 ( V_20 -> V_21 , F_5 ( V_20 -> V_21 ) | V_137 | V_138 ) ;
V_6 -> V_123 . V_139 = & V_140 ;
V_6 -> V_123 . V_141 = F_1 ;
F_46 ( V_97 , & V_6 -> V_123 ) ;
return 0 ;
V_136:
