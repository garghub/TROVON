...
T_3 V_55 ;
F_12 ( V_1 -> V_30 , L_5 , F_28 ( V_1 -> V_43 -> V_44 ) ) ;
switch ( V_1 -> V_43 -> V_44 ) {
case V_56 :
F_27 ( V_1 ) ;
F_12 ( V_1 -> V_30 , L_6 ,
...
static int
F_60 ( struct V_1 * V_1 , struct V_25 * V_26 ,
...
V_6 = F_60 ( V_1 , V_26 + V_165 , V_129 ++ , V_6 ) ;
if ( V_6 < 0 ) {
F_70 ( L_41 ,
V_163 , V_165 ) ;
return V_6 ;
...
V_165 ++ ;
V_1 -> V_169 = F_62 ( V_165 , V_1 -> V_169 ) ;
}
F_69 ( V_162 L_42 ,
V_163 ,
...
static int F_73 ( T_4 V_170 , struct V_1 * V_1 )
{
T_3 V_55 ;
char * type ;
...
V_1 -> V_190 = F_76 ( V_54 ) ;
snprintf ( V_172 , 32 , L_57 , F_77 ( V_1 -> V_190 ) ,
F_78 ( V_1 -> V_190 ) ,
...
V_26 -> V_29 = F_80 ( V_9 ) + V_54 ;
#if F_81 ( V_192 ) || F_81 ( V_193 )
V_26 -> V_194 = V_1 -> V_195 + 0x400 + F_80 ( V_9 ) ;
V_26 -> V_196 = V_1 -> V_197 + 0x400 + F_80 ( V_9 ) ;
V_26 -> V_198 =
V_1 -> V_199 + 0x400 + F_80 ( V_9 ) ;
if ( V_9 == 0 )
V_26 -> V_200 = V_54 - 0x400 + V_201 ;
else
V_26 -> V_200 = V_54 + 0x400 + ( ( ( V_9 - 1 ) & 0xf ) << 2 ) ;
#endif
V_26 -> V_34 = F_82 ( V_9 , 0 ) + V_54 ;
V_26 -> V_202 = F_83 ( V_9 , V_54 ) ;
V_26 -> V_203 = 1 ;
V_26 -> V_204 = 1 ;
if ( V_26 -> V_145 ) {
F_12 ( V_1 -> V_30 ,
...
void F_91 ( struct V_1 * V_1 , T_3 V_31 , T_3 V_209 )
{
...
static T_6
F_94 ( struct V_2 * V_3 , struct V_210 * V_211 , char * V_212 )
{
...
static T_6
F_95 ( struct V_2 * V_3 , struct V_210 * V_211 ,
...
F_26 ( & V_1 -> V_42 , V_41 ) ;
if ( F_96 ( V_212 , L_13 ) )
V_174 = F_97 ( V_1 , V_213 ) ;
else if ( F_96 ( V_212 , L_14 ) )
V_174 = F_97 ( V_1 , V_214 ) ;
else if ( F_96 ( V_212 , L_68 ) )
V_174 = F_97 ( V_1 , V_215 ) ;
else
V_174 = - V_168 ;
F_30 ( & V_1 -> V_42 , V_41 ) ;
...
F_26 ( & V_1 -> V_42 , V_41 ) ;
V_1 -> V_95 = V_216 ? F_100 ( int , V_216 , V_96 ) : 0 ;
if ( V_1 -> V_43 -> V_44 == V_49 )
V_1 -> V_47 = 0 ;
F_41 ( V_1 , V_76 + F_35 ( V_216 ) ) ;
F_30 ( & V_1 -> V_42 , V_41 ) ;
return V_151 ;
}
static T_6
F_101 ( struct V_2 * V_3 , struct V_210 * V_211 , char * V_212 )
{
struct V_1 * V_1 = F_1 ( V_3 ) ;
unsigned long V_41 ;
unsigned long V_216 ;
...
static void F_105 ( struct V_219 * V_24 )
{
struct V_1 * V_1 = F_106 ( V_24 , struct V_1 , V_118 ) ;
if ( V_1 -> V_43 -> V_44 != V_1 -> V_220 ) {
V_1 -> V_220 = V_1 -> V_43 -> V_44 ;
F_107 ( & V_1 -> V_30 -> V_221 , NULL , L_76 ) ;
}
}
static struct V_1 * F_108 ( struct V_2 * V_3 ,
...
int V_31 ;
struct V_52 * V_53 ;
V_53 = F_109 ( & V_224 , V_3 , F_110 ( V_3 ) ) ;
if ( ! V_53 )
return NULL ;
V_1 = F_111 ( V_53 ) ;
F_112 ( & V_1 -> V_225 ) ;
...
static int
F_123 ( struct V_2 * V_3 , int V_232 , void T_2 * V_240 )
{
int V_174 ;
struct V_1 * V_1 ;
...
V_1 = F_108 ( V_3 , V_242 -> V_136 , V_240 ) ;
if ( ! V_1 ) {
V_174 = - V_245 ;
goto V_244;
}
...
F_56 ( V_1 ) ;
F_54 ( V_1 ) ;
V_174 = F_73 ( V_242 -> V_136 -> V_259
? V_187
: V_260 , V_1 ) ;
if ( V_174 < 0 )
goto V_261;
F_131 ( & V_1 -> V_99 , F_25 , ( unsigned long ) V_1 ) ;
F_132 ( & V_1 -> V_118 , F_105 ) ;
if ( F_133 ( V_232 , V_1 -> V_252 , 0 , F_110 ( V_3 ) , V_1 ) ) {
F_99 ( V_3 , L_78 , V_232 ) ;
V_174 = - V_233 ;
goto V_261;
}
...
V_53 = F_32 ( V_1 ) ;
F_136 ( V_1 -> V_43 -> V_65 , & V_53 -> V_58 ) ;
V_53 -> V_58 . V_262 = 1 ;
V_1 -> V_43 -> V_65 -> V_101 = & V_53 -> V_58 ;
V_53 -> V_263 = 2 * ( V_242 -> V_11 ? : 250 ) ;
if ( V_242 -> V_264 ) {
T_3 V_265 = F_137 ( V_1 -> V_36 ) ;
V_265 |= V_266 ;
F_138 ( V_1 -> V_36 , V_265 ) ;
}
F_33 ( V_1 ) ;
V_1 -> V_43 -> V_65 -> V_267 = 0 ;
V_1 -> V_43 -> V_44 = V_81 ;
V_174 = F_139 ( V_1 ) ;
if ( V_174 < 0 )
goto V_261;
...
if ( V_174 < 0 )
goto V_268;
V_174 = F_141 ( & V_1 -> V_30 -> V_221 , & V_235 ) ;
if ( V_174 )
goto V_269;
F_7 ( V_1 -> V_30 ) ;
return 0 ;
...
static int F_145 ( struct V_126 * V_127 )
{
struct V_2 * V_3 = & V_127 -> V_3 ;
int V_270 = F_146 ( V_127 , L_80 ) ;
int V_174 ;
struct V_271 * V_272 ;
void T_2 * V_273 ;
V_272 = F_147 ( V_127 , V_274 , 0 ) ;
if ( ! V_272 || V_270 <= 0 )
return - V_233 ;
V_273 = F_148 ( V_272 -> V_258 , F_149 ( V_272 ) ) ;
if ( ! V_273 ) {
F_99 ( V_3 , L_81 ) ;
return - V_245 ;
}
V_174 = F_123 ( V_3 , V_270 , V_273 ) ;
if ( V_174 < 0 )
F_150 ( V_273 ) ;
return V_174 ;
}
...
V_1 -> V_278 . V_265 = F_137 ( V_1 -> V_36 ) ;
...
F_138 ( V_1 -> V_36 , V_1 -> V_278 . V_265 ) ;
