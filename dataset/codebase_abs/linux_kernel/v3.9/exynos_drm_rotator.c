...
if ( F_46 ( V_2 -> V_128 ) )
return F_47 ( V_2 -> V_128 ) ;
V_2 -> V_14 = F_48 ( V_123 , 0 ) ;
if ( V_2 -> V_14 < 0 ) {
F_42 ( V_46 , L_19 ) ;
return V_2 -> V_14 ;
}
V_124 = F_49 ( V_2 -> V_14 , NULL , F_7 ,
V_129 , L_20 , V_2 ) ;
if ( V_124 < 0 ) {
F_42 ( V_46 , L_21 ) ;
return V_124 ;
}
V_2 -> clock = F_50 ( V_46 , L_22 ) ;
if ( F_51 ( V_2 -> clock ) ) {
F_42 ( V_46 , L_23 ) ;
V_124 = F_47 ( V_2 -> clock ) ;
goto V_130;
}
F_52 ( V_46 ) ;
V_17 = & V_2 -> V_17 ;
V_17 -> V_46 = V_46 ;
V_17 -> V_131 [ V_71 ] = & V_132 ;
V_17 -> V_131 [ V_24 ] = & V_133 ;
V_17 -> V_134 = F_39 ;
V_17 -> V_135 = F_40 ;
V_124 = F_34 ( V_17 ) ;
if ( V_124 < 0 ) {
...
static int F_61 ( struct V_1 * V_2 , bool V_3 )
{
F_35 ( L_4 , V_56 ) ;
if ( V_3 ) {
F_62 ( V_2 -> clock ) ;
