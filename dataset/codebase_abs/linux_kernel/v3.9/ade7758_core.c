...
int F_26 ( struct V_1 * V_2 , bool V_30 )
{
int V_5 ;
T_3 V_31 ;
...
int V_5 ;
struct V_8 * V_9 ;
struct V_6 * V_7 = F_34 ( sizeof( * V_9 ) ) ;
if ( V_7 == NULL ) {
V_5 = - V_46 ;
goto V_22;
}
V_9 = F_3 ( V_7 ) ;
F_35 ( V_45 , V_7 ) ;
V_9 -> V_21 = F_36 ( V_47 , sizeof( * V_9 -> V_21 ) , V_48 ) ;
if ( V_9 -> V_21 == NULL ) {
V_5 = - V_46 ;
goto V_49;
}
V_9 -> V_11 = F_36 ( V_50 , sizeof( * V_9 -> V_11 ) , V_48 ) ;
if ( V_9 -> V_11 == NULL ) {
V_5 = - V_46 ;
goto V_51;
}
