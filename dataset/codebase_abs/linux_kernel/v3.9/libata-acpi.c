...
static int F_56 ( struct V_5 * V_2 , bool V_137 )
{
int V_138 = V_139 ;
if ( ! V_137 )
goto V_140;
...
V_138 = V_143 ;
V_140:
return F_59 ( & V_2 -> V_38 -> V_39 ,
NULL , V_138 ) ;
}
static void F_60 ( struct V_7 * V_8 , T_5 V_144 )
{
bool V_137 = F_61 ( V_144 ) ;
struct V_5 * V_2 ;
T_1 V_32 ;
int V_145 ;
F_12 (dev, &ap->link, ENABLED) {
...
static void F_65 ( struct V_7 * V_8 , T_5 V_144 )
{
struct V_5 * V_2 ;
T_1 V_148 ;
V_148 = F_4 ( V_8 ) ;
...
if ( ! V_149 )
continue;
F_63 ( V_149 , V_144 . V_23 & V_146 ?
V_147 : V_150 ) ;
}
if ( ! ( V_144 . V_23 & V_146 ) )
F_63 ( V_148 , V_150 ) ;
}
void F_66 ( struct V_7 * V_8 , T_5 V_144 )
{
if ( V_8 -> V_9 & V_10 )
F_60 ( V_8 , V_144 ) ;
else
...
int F_67 ( struct V_5 * V_2 )
{
struct V_7 * V_8 = V_2 -> V_14 -> V_8 ;
struct V_151 * V_152 = & V_8 -> V_14 . V_153 ;
int V_154 = V_8 -> V_9 & V_10 ;
int V_132 = 0 ;
int V_54 ;
if ( ! F_7 ( V_2 ) )
return 0 ;
if ( ! ( V_2 -> V_9 & V_136 ) &&
! ( V_154 && ( V_152 -> V_42 . V_9 & V_155 ) ) )
return 0 ;
if ( V_154 ) {
V_54 = F_51 ( V_2 ) ;
if ( V_54 && V_54 != - V_55 )
...
return 0 ;
V_156:
if ( V_54 == - V_58 && ! V_132 && ! ( V_8 -> V_157 & V_158 ) )
return 0 ;
if ( ! ( V_2 -> V_9 & V_159 ) ) {
V_2 -> V_9 |= V_159 ;
return V_54 ;
...
V_2 -> V_9 |= V_15 ;
F_37 ( V_2 , L_26 ) ;
if ( ! V_132 && ! ( V_8 -> V_157 & V_158 ) )
return 0 ;
return V_54 ;
}
void F_70 ( struct V_5 * V_2 )
{
F_2 ( V_2 ) ;
}
static void F_71 ( struct V_5 * V_2 )
{
struct V_160 * V_38 = V_2 -> V_38 ;
T_1 V_32 ;
V_32 = F_7 ( V_2 ) ;
if ( V_32 )
F_72 ( V_32 , & V_38 -> V_39 ) ;
...
void F_75 ( struct V_5 * V_2 )
{
F_71 ( V_2 ) ;
if ( F_57 ( V_2 ) )
F_76 ( & V_2 -> V_38 -> V_39 , 0 ) ;
}
...
{
struct V_1 * V_2 = V_8 -> V_22 . V_161 ;
struct V_162 * V_163 ;
if ( ! F_1 ( V_2 ) )
return 0 ;
V_163 = F_79 ( V_2 ) ;
if ( ( V_163 -> V_141 >> 8 ) != V_164 &&
( V_163 -> V_141 >> 8 ) != V_165 )
return 0 ;
return 1 ;
}
static int F_80 ( struct V_7 * V_8 , T_1 * V_32 )
{
if ( V_8 -> V_9 & V_10 )
return - V_166 ;
* V_32 = F_5 ( F_6 ( V_8 -> V_22 . V_161 ) ,
V_8 -> V_12 ) ;
if ( ! * V_32 )
return - V_166 ;
if ( V_45 ( V_8 , & V_8 -> V_167 ) == 0 )
V_8 -> V_157 |= V_168 ;
return 0 ;
}
static int F_81 ( struct V_7 * V_8 , struct V_160 * V_38 ,
T_1 * V_32 )
{
struct V_5 * V_169 ;
if ( V_8 -> V_9 & V_10 ) {
if ( ! F_8 ( V_8 ) )
V_169 = & V_8 -> V_14 . V_1 [ V_38 -> V_68 ] ;
else
V_169 = & V_8 -> V_170 [ V_38 -> V_171 ] . V_1 [ V_38 -> V_68 ] ;
}
else {
V_169 = & V_8 -> V_14 . V_1 [ V_38 -> V_68 ] ;
}
...
static int F_85 ( struct V_1 * V_2 , T_1 * V_32 )
{
...
return - V_166 ;
if ( F_86 ( V_2 ) )
return F_80 ( V_8 , V_32 ) ;
else if ( F_87 ( V_2 ) ) {
struct V_160 * V_38 = F_88 ( V_2 ) ;
return F_81 ( V_8 , V_38 , V_32 ) ;
} else
return - V_166 ;
}
int F_89 ( void )
