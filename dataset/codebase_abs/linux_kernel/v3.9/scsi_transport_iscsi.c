...
static T_1
F_175 ( struct V_1 * V_2 , struct V_5 * V_6 ,
char * V_7 )
{
struct V_124 * V_135 = F_47 ( V_2 -> V_29 ) ;
return sprintf ( V_7 , L_78 , V_135 -> V_146 ) ;
}
static T_4 F_176 ( struct V_30 * V_22 ,
struct V_31 * V_6 , int V_32 )
{
struct V_1 * V_118 = F_25 ( V_22 , struct V_1 , V_22 ) ;
struct V_124 * V_135 = F_177 ( V_118 ) ;
...
static T_4 F_178 ( struct V_30 * V_22 ,
struct V_31 * V_6 , int V_32 )
{
struct V_1 * V_118 = F_25 ( V_22 , struct V_1 , V_22 ) ;
struct V_71 * V_72 = F_179 ( V_118 ) ;
...
V_35 = V_435 ;
else if ( V_6 == & V_436 . V_6 )
V_35 = V_437 ;
else {
F_26 ( 1 , L_80 ) ;
return 0 ;
}
return V_4 -> V_8 -> V_69 ( V_438 , V_35 ) ;
}
...
V_439 = V_441 [ V_32 ] . V_132 ;
break;
}
}
return V_439 ;
}
char * F_181 ( struct V_71 * V_72 )
{
int V_32 ;
char * V_131 = L_81 ;
struct V_107 * V_108 = V_72 -> V_119 ;
T_5 V_442 = V_108 -> V_442 ;
for ( V_32 = 0 ; V_32 < F_54 ( V_443 ) ; V_32 ++ ) {
if ( V_443 [ V_32 ] . V_134 & V_442 ) {
V_131 = V_443 [ V_32 ] . V_132 ;
break;
}
}
return V_131 ;
}
static int F_182 ( struct V_444 * V_445 ,
struct V_1 * V_2 )
{
struct V_124 * V_135 ;
struct V_71 * V_72 ;
...
return 0 ;
V_4 = F_32 ( V_72 -> V_88 ) ;
if ( V_4 -> V_446 . V_447 . V_20 != & V_448 . V_20 )
return 0 ;
return & V_4 -> V_446 . V_447 == V_445 ;
}
static int F_183 ( struct V_444 * V_445 ,
struct V_1 * V_2 )
{
struct V_124 * V_135 ;
struct V_122 * V_123 ;
...
return 0 ;
V_4 = F_32 ( V_72 -> V_88 ) ;
if ( V_4 -> V_449 . V_447 . V_20 != & V_450 . V_20 )
return 0 ;
return & V_4 -> V_449 . V_447 == V_445 ;
}
static int F_184 ( struct V_444 * V_445 ,
struct V_1 * V_2 )
{
struct V_71 * V_72 ;
struct V_3 * V_4 ;
...
V_72 = F_41 ( V_2 ) ;
if ( ! V_72 -> V_88 ||
V_72 -> V_88 -> V_451 . V_447 . V_20 != & V_452 . V_20 )
return 0 ;
V_4 = F_32 ( V_72 -> V_88 ) ;
return & V_4 -> V_33 . V_451 . V_447 == V_445 ;
}
struct V_453 *
F_186 ( struct V_8 * V_183 )
{
struct V_3 * V_4 ;
unsigned long V_127 ;
int V_15 ;
...
if ( V_15 )
goto V_458;
V_15 = F_16 ( & V_4 -> V_2 . V_22 , & V_459 ) ;
if ( V_15 )
goto V_24;
V_4 -> V_33 . V_451 . V_447 . V_20 = & V_452 . V_20 ;
V_4 -> V_33 . V_451 . V_447 . V_460 = F_184 ;
V_4 -> V_33 . V_451 . V_447 . V_461 = & V_462 ;
V_4 -> V_33 . V_463 = sizeof( struct V_107 ) ;
F_187 ( & V_4 -> V_33 . V_451 ) ;
V_4 -> V_449 . V_447 . V_20 = & V_450 . V_20 ;
V_4 -> V_449 . V_447 . V_460 = F_183 ;
V_4 -> V_449 . V_447 . V_461 = & V_464 ;
F_187 ( & V_4 -> V_449 ) ;
V_4 -> V_446 . V_447 . V_20 = & V_448 . V_20 ;
V_4 -> V_446 . V_447 . V_460 = F_182 ;
V_4 -> V_446 . V_447 . V_461 = & V_465 ;
F_187 ( & V_4 -> V_446 ) ;
F_49 ( & V_184 , V_127 ) ;
F_109 ( & V_4 -> V_454 , & V_466 ) ;
F_51 ( & V_184 , V_127 ) ;
F_12 ( V_467 L_83 , V_183 -> V_132 ) ;
return & V_4 -> V_33 ;
V_24:
F_17 ( & V_4 -> V_2 ) ;
return NULL ;
...
F_189 ( & V_4 -> V_449 ) ;
F_189 ( & V_4 -> V_446 ) ;
F_189 ( & V_4 -> V_33 . V_451 ) ;
F_19 ( & V_4 -> V_2 . V_22 , & V_459 ) ;
F_17 ( & V_4 -> V_2 ) ;
F_71 ( & V_342 ) ;
return 0 ;
}
static T_11 int F_190 ( void )
{
int V_15 ;
struct V_468 V_469 = {
. V_470 = 1 ,
