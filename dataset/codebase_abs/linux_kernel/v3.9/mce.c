...
static int T_6 F_149 ( struct V_75 * V_76 )
{
struct V_132 * V_133 = & V_49 ;
if ( V_76 -> V_8 == V_196 ) {
F_137 ( L_32 ) ;
...
static int T_6 F_154 ( struct V_75 * V_76 )
{
if ( V_76 -> V_199 != 5 )
return 0 ;
switch ( V_76 -> V_8 ) {
...
void T_6 F_164 ( struct V_75 * V_76 )
{
if ( V_49 . V_77 )
return;
if ( F_154 ( V_76 ) )
...
static int F_173 ( char T_7 * * V_220 , T_8 V_221 )
{
int V_222 ;
T_2 V_223 ;
struct V_1 V_2 ;
...
static T_9 F_177 ( struct V_212 * V_228 , char T_7 * V_220 ,
T_8 V_221 , T_10 * V_229 )
{
char T_7 * V_230 = V_220 ;
unsigned long * V_219 ;
unsigned V_28 , V_16 ;
int V_27 , V_180 ;
...
static unsigned int F_184 ( struct V_212 * V_212 , T_11 * V_233 )
{
...
void F_191 ( T_9 (* F_192)( struct V_212 * V_228 ,
const char T_7 * V_220 ,
T_8 V_221 , T_10 * V_229 ) )
{
V_246 = F_192 ;
}
T_9 F_193 ( struct V_212 * V_228 , const char T_7 * V_220 ,
T_8 V_221 , T_10 * V_229 )
{
if ( V_246 )
...
static int T_12 F_194 ( char * V_247 )
{
struct V_132 * V_133 = & V_49 ;
if ( * V_247 == 0 ) {
F_195 () ;
...
static T_9 F_212 ( struct V_253 * V_254 , struct V_251 * V_252 ,
char * V_230 )
{
return sprintf ( V_230 , L_42 , F_210 ( V_252 ) -> V_94 ) ;
}
static T_9 F_213 ( struct V_253 * V_254 , struct V_251 * V_252 ,
const char * V_230 , T_8 V_255 )
{
T_2 V_256 ;
...
static T_9 F_216 ( struct V_253 * V_254 , struct V_251 * V_252 ,
const char * V_230 , T_8 V_257 )
{
char * V_239 ;
...
static T_9 F_217 ( struct V_253 * V_254 ,
struct V_251 * V_252 ,
const char * V_230 , T_8 V_255 )
{
T_2 V_256 ;
...
static T_9 F_218 ( struct V_253 * V_254 ,
struct V_251 * V_252 ,
const char * V_230 , T_8 V_255 )
{
T_2 V_256 ;
...
static T_9 F_219 ( struct V_253 * V_254 ,
struct V_251 * V_252 ,
const char * V_230 , T_8 V_255 )
{
T_9 V_18 = F_220 ( V_254 , V_252 , V_230 , V_255 ) ;
F_204 () ;
return V_18 ;
}
...
static T_6 int F_222 ( unsigned int V_3 )
{
struct V_253 * V_258 ;
int V_180 ;
int V_27 , V_259 ;
...
static T_6 void F_228 ( unsigned int V_3 )
{
...
static void T_6 F_231 ( void * V_269 )
{
...
static void T_6 F_232 ( void * V_269 )
{
unsigned long V_270 = * ( unsigned long * ) V_269 ;
int V_27 ;
if ( ! F_60 ( F_115 ( & V_159 ) ) )
...
static int T_12 F_245 ( char * V_247 )
{
V_49 . V_77 = true ;
return 1 ;
}
