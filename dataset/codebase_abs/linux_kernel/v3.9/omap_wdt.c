...
T_2 V_27 ;
int V_28 ;
V_23 = F_19 ( & V_19 -> V_15 , sizeof( * V_23 ) , V_29 ) ;
if ( ! V_23 )
return - V_30 ;
V_25 = F_20 ( V_19 , V_31 , 0 ) ;
if ( ! V_25 )
return - V_32 ;
V_26 = F_21 ( & V_19 -> V_15 , V_25 -> V_33 ,
F_22 ( V_25 ) , V_19 -> V_34 ) ;
if ( ! V_26 )
return - V_35 ;
V_2 = F_19 ( & V_19 -> V_15 , sizeof( * V_2 ) , V_29 ) ;
if ( ! V_2 )
return - V_30 ;
V_2 -> V_14 = false ;
V_2 -> V_26 = V_26 ;
...
V_2 -> V_5 = 0x1234 ;
F_23 ( & V_2 -> V_13 ) ;
V_2 -> V_3 = F_24 ( & V_19 -> V_15 , V_25 -> V_33 , F_22 ( V_25 ) ) ;
if ( ! V_2 -> V_3 )
return - V_30 ;
V_23 -> V_36 = & V_37 ;
V_23 -> V_38 = & V_39 ;
...
static int F_36 ( struct V_18 * V_19 , T_3 V_52 )
{
struct V_11 * V_12 = F_33 ( V_19 ) ;
struct V_1 * V_2 = F_10 ( V_12 ) ;
F_11 ( & V_2 -> V_13 ) ;
