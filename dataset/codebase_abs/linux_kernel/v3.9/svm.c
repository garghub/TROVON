...
if ( ! F_111 ( V_9 ) ) {
F_35 ( V_9 , 0 ) ;
V_10 -> V_1 -> V_42 . V_71 . V_72 = V_10 -> V_9 . V_23 . V_277 << 12 ;
V_10 -> V_1 -> V_42 . V_71 . V_167 = V_10 -> V_9 . V_23 . V_277 << 8 ;
}
F_112 ( V_9 , & V_276 , & V_275 , & V_275 , & V_275 ) ;
F_113 ( V_9 , V_278 , V_276 ) ;
return 0 ;
}
...
static void F_135 ( struct V_8 * V_9 , unsigned long V_307 )
{
...
static void F_136 ( struct V_8 * V_9 , enum V_310 V_311 )
{
switch ( V_311 ) {
case V_312 :
F_72 ( ! V_39 ) ;
F_137 ( V_9 , V_9 -> V_23 . V_313 , F_138 ( V_9 ) ) ;
break;
default:
F_77 () ;
}
...
{
struct V_165 * V_323 = F_141 ( V_9 , V_166 ) ;
return V_323 -> V_72 ;
}
...
{
unsigned long V_349 = F_156 () & V_350 ;
...
static void F_161 ( struct V_8 * V_9 , unsigned long V_365 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
...
F_165 ( & V_10 -> V_9 , V_368 ) ;
V_126 = F_166 ( & V_10 -> V_9 , V_368 , V_64 ,
V_10 -> V_1 -> V_2 . V_372 ,
V_10 -> V_1 -> V_2 . V_373 ) ;
break;
case V_374 :
...
T_2 V_402 ;
int V_50 ;
V_50 = F_195 ( V_9 -> V_279 , F_196 ( V_271 ) , & V_402 ,
...
{
int V_126 ;
V_126 = F_202 ( V_9 , & V_9 -> V_23 . V_410 ) ;
V_9 -> V_23 . V_410 . V_411 = F_198 ;
V_9 -> V_23 . V_410 . V_412 = F_193 ;
V_9 -> V_23 . V_410 . V_413 = F_194 ;
V_9 -> V_23 . V_410 . V_414 = F_199 ;
...
static void * F_210 ( struct V_7 * V_10 , T_2 V_426 , struct V_148 * * V_427 )
{
struct V_148 * V_148 ;
F_211 () ;
V_148 = F_212 ( V_10 -> V_9 . V_279 , V_426 >> V_119 ) ;
if ( F_213 ( V_148 ) )
goto error;
* V_427 = V_148 ;
return F_214 ( V_148 ) ;
...
V_6 = V_394 % 8 ;
V_81 = 0 ;
if ( F_219 ( V_10 -> V_9 . V_279 , V_426 , & V_81 , 1 ) )
V_81 &= ( 1 << V_6 ) ;
...
return V_420 ;
V_27 *= 4 ;
if ( F_219 ( V_10 -> V_9 . V_279 , V_10 -> V_17 . V_431 + V_27 , & V_365 , 4 ) )
return V_420 ;
...
static inline void F_223 ( struct V_1 * V_442 , struct V_1 * V_443 )
{
...
V_1 -> V_2 . V_448 ,
V_450 ) ;
V_449 = F_210 ( V_10 , V_10 -> V_17 . V_1 , & V_148 ) ;
if ( ! V_449 )
return 1 ;
F_225 ( & V_10 -> V_9 ) ;
V_10 -> V_17 . V_1 = 0 ;
...
V_449 -> V_42 . V_263 = F_226 ( & V_10 -> V_9 ) ;
V_449 -> V_42 . V_271 = F_138 ( & V_10 -> V_9 ) ;
V_449 -> V_42 . V_419 = V_1 -> V_42 . V_419 ;
V_449 -> V_42 . V_267 = V_10 -> V_9 . V_23 . V_267 ;
V_449 -> V_42 . V_307 = F_227 ( & V_10 -> V_9 ) ;
...
F_108 ( & V_10 -> V_9 , V_18 -> V_42 . V_307 ) ;
F_27 ( & V_10 -> V_9 , V_18 -> V_42 . V_38 ) ;
F_153 ( & V_10 -> V_9 , V_18 -> V_42 . V_263 | V_454 ) ;
...
F_113 ( & V_10 -> V_9 , V_262 , V_18 -> V_42 . V_68 ) ;
...
if ( F_219 ( V_10 -> V_9 . V_279 , V_27 , & V_365 , 4 ) )
return false ;
...
V_449 = F_210 ( V_10 , V_10 -> V_1 -> V_42 . V_452 , & V_148 ) ;
if ( ! V_449 )
return false ;
if ( ! F_234 ( V_449 ) ) {
...
V_18 -> V_42 . V_307 = F_227 ( & V_10 -> V_9 ) ;
...
F_108 ( & V_10 -> V_9 , V_449 -> V_42 . V_307 ) ;
F_27 ( & V_10 -> V_9 , V_449 -> V_42 . V_38 ) ;
F_153 ( & V_10 -> V_9 , V_449 -> V_42 . V_263 ) ;
F_155 ( & V_10 -> V_9 , V_449 -> V_42 . V_267 ) ;
if ( V_39 ) {
V_10 -> V_1 -> V_42 . V_271 = V_449 -> V_42 . V_271 ;
V_10 -> V_9 . V_23 . V_271 = V_449 -> V_42 . V_271 ;
} else
( void ) F_230 ( & V_10 -> V_9 , V_449 -> V_42 . V_271 ) ;
F_231 ( & V_10 -> V_9 ) ;
...
F_113 ( & V_10 -> V_9 , V_262 , V_449 -> V_42 . V_68 ) ;
...
if ( ! F_38 ( V_506 ) )
return F_262 ( V_10 ) ;
if ( F_124 ( ( V_10 -> V_1 -> V_2 . V_371 & V_509 ) == 0 ) )
return F_262 ( V_10 ) ;
...
T_2 F_277 ( struct V_8 * V_9 , T_2 V_514 )
{
struct V_1 * V_1 = F_8 ( F_4 ( V_9 ) ) ;
return V_1 -> V_2 . V_185 +
F_96 ( V_9 , V_514 ) ;
}
static int F_278 ( struct V_8 * V_9 , unsigned V_515 , T_2 * V_516 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
switch ( V_515 ) {
case V_517 : {
...
break;
default:
return F_279 ( V_9 , V_515 , V_516 ) ;
}
return 0 ;
}
static int F_280 ( struct V_7 * V_10 )
{
T_1 V_515 = V_10 -> V_9 . V_23 . V_261 [ V_430 ] ;
T_2 V_516 ;
if ( F_278 ( & V_10 -> V_9 , V_515 , & V_516 ) ) {
F_281 ( V_515 ) ;
F_205 ( & V_10 -> V_9 , 0 ) ;
} else {
F_282 ( V_515 , V_516 ) ;
V_10 -> V_9 . V_23 . V_261 [ V_455 ] = V_516 & 0xffffffff ;
V_10 -> V_9 . V_23 . V_261 [ V_278 ] = V_516 >> 32 ;
V_10 -> V_55 = F_34 ( & V_10 -> V_9 ) + 2 ;
F_31 ( & V_10 -> V_9 ) ;
}
return 1 ;
}
static int F_283 ( struct V_8 * V_9 , T_2 V_516 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
int V_535 , V_536 ;
if ( V_516 & ~ V_537 )
...
static int F_284 ( struct V_8 * V_9 , struct V_540 * V_26 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
...
break;
case V_532 :
return F_283 ( V_9 , V_516 ) ;
case V_544 :
F_286 ( V_9 , L_15 , V_515 , V_516 ) ;
break;
default:
...
struct V_540 V_26 ;
T_1 V_515 = V_10 -> V_9 . V_23 . V_261 [ V_430 ] ;
T_2 V_516 = ( V_10 -> V_9 . V_23 . V_261 [ V_455 ] & - 1u )
| ( ( T_2 ) ( V_10 -> V_9 . V_23 . V_261 [ V_278 ] & - 1u ) << 32 ) ;
V_26 . V_516 = V_516 ;
V_26 . V_130 = V_515 ;
V_26 . V_545 = false ;
V_10 -> V_55 = F_34 ( & V_10 -> V_9 ) + 2 ;
...
L_79 , V_42 -> V_469 ) ;
F_55 ( L_61 ,
L_80 , V_42 -> V_270 , L_81 , V_42 -> V_526 ) ;
F_55 ( L_61 ,
...
static void F_297 ( struct V_8 * V_9 , T_2 * V_549 , T_2 * V_550 )
{
...
if ( F_7 ( V_9 ) ) {
int V_417 ;
F_299 ( V_10 -> V_1 -> V_42 . V_68 , V_407 ,
V_10 -> V_1 -> V_2 . V_371 ,
V_10 -> V_1 -> V_2 . V_369 ,
V_10 -> V_1 -> V_2 . V_447 ,
V_10 -> V_1 -> V_2 . V_448 ,
...
static inline void F_306 ( struct V_7 * V_10 , int V_562 )
{
struct V_11 * V_2 ;
V_2 = & V_10 -> V_1 -> V_2 ;
V_2 -> V_446 = V_562 ;
...
struct V_7 * V_10 = F_4 ( V_9 ) ;
F_72 ( ! ( F_20 ( V_10 ) ) ) ;
F_308 ( V_9 -> V_23 . V_565 . V_62 ) ;
++ V_9 -> V_301 . V_566 ;
V_10 -> V_1 -> V_2 . V_74 = V_9 -> V_23 . V_565 . V_62 |
V_47 | V_48 ;
}
static void F_309 ( struct V_8 * V_9 , int V_567 , int V_568 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
...
static void F_310 ( struct V_8 * V_9 , bool V_569 )
{
return;
}
static int F_311 ( struct V_279 * V_279 )
{
return 0 ;
}
static void F_312 ( struct V_8 * V_9 , T_2 * V_570 )
{
return;
}
static void F_313 ( struct V_279 * V_279 , int V_571 )
{
return;
}
...
static bool F_315 ( struct V_8 * V_9 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
...
static int F_320 ( struct V_279 * V_279 , unsigned int V_34 )
{
return 0 ;
}
...
static void F_321 ( struct V_8 * V_9 )
{
}
static inline void F_322 ( struct V_8 * V_9 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
if ( F_7 ( V_9 ) && ( V_9 -> V_23 . V_24 & V_422 ) )
return;
...
F_326 ( & V_10 -> V_9 , V_577 , V_80 ) ;
} else
F_327 ( & V_10 -> V_9 , V_577 ) ;
break;
case V_493 :
F_328 ( & V_10 -> V_9 , V_577 , false ) ;
break;
default:
break;
}
...
F_331 ( V_10 -> V_1 -> V_2 . V_407 , V_9 , V_450 ) ;
if ( F_124 ( V_10 -> V_1 -> V_2 . V_407 == V_425 ) )
F_332 ( & V_10 -> V_9 ) ;
F_23 () ;
if ( F_124 ( V_10 -> V_1 -> V_2 . V_407 == V_425 ) )
F_333 ( & V_10 -> V_9 ) ;
...
if ( F_124 ( V_10 -> V_1 -> V_2 . V_407 ==
V_418 + V_217 ) )
F_180 ( V_10 ) ;
F_2 ( V_10 -> V_1 ) ;
}
static void F_335 ( struct V_8 * V_9 , unsigned long V_403 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
...
static void F_336 ( struct V_8 * V_9 , unsigned long V_403 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
V_10 -> V_1 -> V_2 . V_401 = V_403 ;
F_3 ( V_10 -> V_1 , V_404 ) ;
...
static void
F_338 ( struct V_8 * V_9 , unsigned char * V_586 )
{
V_586 [ 0 ] = 0x0f ;
V_586 [ 1 ] = 0x01 ;
V_586 [ 2 ] = 0xd9 ;
}
static void F_339 ( void * V_587 )
{
* ( int * ) V_587 = 0 ;
}
...
static T_2 F_341 ( struct V_8 * V_9 , T_11 V_588 , bool V_589 )
{
return 0 ;
}
...
static void F_343 ( T_1 V_590 , struct V_591 * V_592 )
{
switch ( V_590 ) {
case 0x80000001 :
if ( V_17 )
...
static int F_349 ( struct V_8 * V_9 ,
struct V_598 * V_45 ,
enum V_599 V_600 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
...
T_2 V_616 ;
T_1 V_617 ;
V_616 = ( V_9 -> V_23 . V_261 [ V_278 ] & 0xffff ) << 16 ;
if ( V_45 -> V_22 == V_618 ||
V_45 -> V_22 == V_619 ) {
V_616 |= V_397 ;
V_617 = V_45 -> V_620 ;
...
static int T_5 F_350 ( void )
{
return F_351 ( & V_627 , sizeof( struct V_7 ) ,
F_352 ( struct V_7 ) , V_628 ) ;
}
static void T_6 F_353 ( void )
{
F_354 () ;
}
