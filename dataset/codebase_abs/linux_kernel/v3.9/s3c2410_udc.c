...
static int F_84 ( struct V_171 * V_226 ,
struct V_227 * V_139 )
{
struct V_59 * V_60 = F_85 ( V_226 ) ;
F_6 ( V_89 , L_71 , V_75 , V_139 -> V_139 . V_179 ) ;
V_60 -> V_139 = V_139 ;
V_60 -> V_141 . V_62 . V_139 = & V_139 -> V_139 ;
F_74 ( V_60 ) ;
return 0 ;
}
static int F_86 ( struct V_171 * V_226 ,
struct V_227 * V_139 )
{
struct V_59 * V_60 = F_85 ( V_226 ) ;
V_60 -> V_139 = NULL ;
...
F_96 ( & V_60 -> V_158 ) ;
V_206 = V_229 -> V_62 . V_236 ;
V_237 = V_238 ;
V_239 = V_240 ;
if ( ! F_97 ( V_237 , V_239 , V_241 ) )
return - V_242 ;
V_2 = F_98 ( V_237 , V_239 ) ;
if ( ! V_2 ) {
V_198 = - V_243 ;
goto V_244;
}
F_99 ( & V_60 -> V_141 . V_62 ) ;
V_60 -> V_141 . V_62 . V_245 = & V_229 -> V_62 ;
V_60 -> V_141 . V_62 . V_246 = V_229 -> V_62 . V_246 ;
V_198 = F_100 ( & V_60 -> V_141 . V_62 ) ;
if ( V_198 ) {
F_91 ( & V_60 -> V_141 . V_62 , L_79 , V_198 ) ;
goto V_247;
}
V_199 = V_60 ;
F_101 ( V_229 , V_60 ) ;
...
0 , V_241 , V_60 ) ;
if ( V_198 != 0 ) {
F_91 ( V_62 , L_80 , V_169 , V_198 ) ;
V_198 = - V_242 ;
goto V_248;
}
F_88 ( V_62 , L_81 , V_169 ) ;
if ( V_206 && V_206 -> V_213 > 0 ) {
V_198 = F_103 ( V_206 -> V_213 , L_82 ) ;
if ( V_198 < 0 ) {
F_91 ( V_62 , L_83 ) ;
goto V_249;
}
...
{
struct V_59 * V_60 = F_115 ( V_229 ) ;
unsigned int V_212 ;
F_88 ( & V_229 -> V_62 , L_69 , V_75 ) ;
if ( V_60 -> V_139 )
return - V_242 ;
F_116 ( & V_60 -> V_141 ) ;
F_111 ( & V_60 -> V_141 . V_62 ) ;
...
F_88 ( & V_229 -> V_62 , L_90 , V_75 ) ;
return 0 ;
}
static int
F_120 ( struct V_228 * V_229 , T_8 V_262 )
{
F_81 ( V_221 ) ;
return 0 ;
}
...
{
int V_198 ;
F_6 ( V_89 , L_91 , V_241 , V_263 ) ;
V_258 = F_123 ( V_241 , NULL ) ;
if ( F_90 ( V_258 ) ) {
F_124 ( L_92 ,
V_241 , F_92 ( V_258 ) ) ;
V_258 = NULL ;
