...
V_1 -> V_21 = V_21 ;
V_1 -> V_18 . V_278 . V_21 = & V_21 -> V_21 ;
F_5 ( V_1 , V_279 | V_280 , V_7 ) ;
...
{
struct V_1 * V_1 = F_99 ( V_275 ) ;
F_4 ( V_1 , V_279 | V_280 , V_7 ) ;
V_21 -> V_281 ( & V_1 -> V_18 ) ;
V_1 -> V_18 . V_278 . V_21 = NULL ;
F_56 ( V_1 ) ;
F_12 ( V_1 ) ;
V_1 -> V_21 = NULL ;
return 0 ;
}
static int F_101 ( struct V_274 * V_282 )
{
struct V_1 * V_1 = F_102 ( V_282 ) ;
return F_2 ( V_1 , V_283 ) & 0x03FF ;
}
static int F_103 ( struct V_274 * V_18 , int V_284 )
{
...
static int T_5 F_104 ( struct V_285 * V_286 )
{
struct V_1 * V_1 = F_105 ( & V_286 -> V_278 ) ;
F_106 ( & V_1 -> V_18 ) ;
F_107 ( & V_1 -> V_18 . V_278 ) ;
F_108 ( & V_1 -> V_257 ) ;
F_109 ( V_1 -> V_5 ) ;
F_110 ( F_111 ( V_286 , 0 ) , V_1 ) ;
...
static void F_114 ( struct V_263 * V_23 , struct V_266 * V_288 )
{
}
static int T_6 F_115 ( struct V_285 * V_286 )
{
...
int V_33 = 0 ;
int V_178 ;
V_290 = F_116 ( V_286 , V_293 , 0 ) ;
if ( ! V_290 ) {
V_33 = - V_112 ;
F_16 ( L_19 ) ;
goto V_294;
}
V_291 = F_116 ( V_286 , V_295 , 0 ) ;
if ( ! V_291 ) {
V_33 = - V_112 ;
F_117 ( & V_286 -> V_278 ,
L_20 ) ;
...
V_5 = F_118 ( V_290 -> V_296 , F_119 ( V_290 ) ) ;
if ( V_5 == NULL ) {
V_33 = - V_75 ;
F_16 ( L_21 ) ;
goto V_294;
}
if ( V_286 -> V_278 . V_297 == NULL ) {
F_117 ( & V_286 -> V_278 , L_22 ) ;
V_33 = - V_112 ;
goto V_294;
}
...
V_1 -> V_51 = V_286 -> V_278 . V_297 ;
V_1 -> V_160 = V_291 -> V_262 & V_298 ;
F_120 ( & V_1 -> V_17 ) ;
F_121 ( & V_286 -> V_278 , V_1 ) ;
V_1 -> V_18 . V_299 = & V_300 ;
F_122 ( & V_1 -> V_18 . V_278 ) ;
F_123 ( & V_1 -> V_18 . V_278 , L_24 ) ;
V_1 -> V_18 . V_301 = V_222 ;
V_1 -> V_18 . V_278 . V_302 = & V_286 -> V_278 ;
V_1 -> V_18 . V_278 . V_303 = V_286 -> V_278 . V_303 ;
V_1 -> V_18 . V_278 . V_304 = V_286 -> V_278 . V_304 ;
V_1 -> V_18 . V_305 = V_306 ;
F_124 ( & V_1 -> V_257 ) ;
V_1 -> V_257 . V_307 = F_84 ;
V_1 -> V_257 . V_308 = ( unsigned long ) V_1 ;
V_1 -> V_5 = V_5 ;
V_33 = F_125 ( V_291 -> V_296 , F_81 , V_309 ,
V_306 , V_1 ) ;
if ( V_33 < 0 ) {
F_16 ( L_25 , V_33 ) ;
goto V_294;
...
if ( V_1 -> V_51 -> V_52 ) {
snprintf ( V_292 , sizeof( V_292 ) , L_26 , V_286 -> V_310 ) ;
V_1 -> V_287 = F_126 ( & V_286 -> V_278 , V_292 ) ;
if ( F_127 ( V_1 -> V_287 ) ) {
F_117 ( & V_286 -> V_278 , L_27 ,
V_292 ) ;
V_33 = F_128 ( V_1 -> V_287 ) ;
goto V_311;
}
F_129 ( V_1 -> V_287 ) ;
}
...
F_13 ( & V_1 -> V_18 . V_206 -> V_312 ) ;
for ( V_178 = 0 ; V_178 < V_29 ; V_178 ++ ) {
struct V_45 * V_23 = & V_1 -> V_23 [ V_178 ] ;
if ( V_178 != 0 ) {
F_13 ( & V_1 -> V_23 [ V_178 ] . V_23 . V_312 ) ;
F_94 ( & V_1 -> V_23 [ V_178 ] . V_23 . V_312 ,
& V_1 -> V_18 . V_312 ) ;
}
V_23 -> V_1 = V_1 ;
F_13 ( & V_23 -> V_24 ) ;
V_23 -> V_23 . V_305 = V_313 [ V_178 ] ;
V_23 -> V_23 . V_299 = & V_314 ;
V_23 -> V_23 . V_76 = 512 ;
}
...
if ( V_1 -> V_205 == NULL )
goto V_315;
V_1 -> V_205 -> V_176 = F_114 ;
F_56 ( V_1 ) ;
V_33 = F_130 ( & V_1 -> V_18 . V_278 ) ;
if ( V_33 ) {
F_16 ( L_28 , V_33 ) ;
goto V_316;
}
V_33 = F_131 ( & V_286 -> V_278 , & V_1 -> V_18 ) ;
if ( V_33 )
goto V_317;
F_132 ( & V_286 -> V_278 , L_29 , V_318 ) ;
return 0 ;
V_317:
F_107 ( & V_1 -> V_18 . V_278 ) ;
V_316:
