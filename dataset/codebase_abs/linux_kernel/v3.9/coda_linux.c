...
if ( V_29 -> V_42 != - 1 )
V_9 -> V_43 = F_6 ( & V_44 , ( V_45 ) V_29 -> V_42 ) ;
if ( V_29 -> V_46 != - 1 )
V_9 -> V_47 = F_7 ( & V_44 , ( V_48 ) V_29 -> V_46 ) ;
if ( V_29 -> V_49 != - 1 )
F_8 ( V_9 , V_29 -> V_49 ) ;
if ( V_29 -> V_50 != - 1 )
V_9 -> V_51 = V_29 -> V_50 ;
...
void F_9 ( struct V_60 * V_60 , struct V_28 * V_61 )
{
unsigned int V_62 ;
V_61 -> V_40 = - 1 ;
V_61 -> V_42 = ( V_63 ) - 1 ;
...
if ( V_62 & V_77 ) {
V_61 -> V_42 = ( V_63 ) F_10 ( & V_44 , V_60 -> V_78 ) ;
}
if ( V_62 & V_79 ) {
V_61 -> V_46 = ( V_64 ) F_11 ( & V_44 , V_60 -> V_80 ) ;
}
if ( V_62 & V_81 ) {
V_61 -> V_50 = V_60 -> V_82 ;
}
