...
static int F_78 ( struct V_129 * V_129 , void * V_148 , struct V_161 * V_46 )
{
struct V_3 * V_4 = V_148 ;
struct V_7 * V_8 = V_4 -> V_9 ;
struct V_10 * V_11 = & V_8 -> V_11 [ V_14 ] ;
...
static int F_80 ( struct V_129 * V_129 , void * V_148 , struct V_161 * V_46 )
{
struct V_3 * V_4 = V_148 ;
struct V_7 * V_8 = V_4 -> V_9 ;
struct V_10 * V_11 = & V_8 -> V_11 [ V_14 ] ;
...
if ( V_59 )
return V_59 ;
V_59 = F_83 ( V_8 -> V_169 , V_94 , V_170 , 1 ) ;
if ( V_59 && V_59 != - V_171 && V_59 != - V_172 ) {
F_3 ( 1 , V_13 , L_42 ) ;
return V_59 ;
}
V_59 = F_84 ( & V_11 -> V_135 , V_167 ) ;
if ( V_59 ) {
F_3 ( 1 , V_13 , L_43 ) ;
return V_59 ;
}
...
V_11 -> V_65 = 0 ;
V_59 = F_83 ( V_8 -> V_169 , V_94 , V_170 , 0 ) ;
if ( V_59 && V_59 != - V_171 && V_59 != - V_172 )
F_3 ( 1 , V_13 , L_45 ) ;
return F_86 ( & V_11 -> V_135 , V_167 ) ;
}
static int F_87 (
struct V_53 * V_173 ,
struct V_174 * V_175 ,
...
static int F_89 ( struct V_129 * V_129 , void * V_148 , T_5 * V_197 )
{
struct V_3 * V_4 = V_148 ;
struct V_7 * V_8 = V_4 -> V_9 ;
int V_59 = 0 ;
F_3 ( 2 , V_13 , L_50 ) ;
V_59 = F_83 ( V_8 -> V_169 , V_94 , V_198 , V_197 ) ;
...
static int F_90 ( struct V_129 * V_129 , void * V_148 , T_5 * V_196 )
{
struct V_3 * V_4 = V_148 ;
struct V_7 * V_8 = V_4 -> V_9 ;
F_3 ( 2 , V_13 , L_52 ) ;
...
static int F_91 ( struct V_129 * V_129 , void * V_148 , T_5 * V_197 )
{
struct V_3 * V_4 = V_148 ;
struct V_7 * V_8 = V_4 -> V_9 ;
struct V_10 * V_11 = & V_8 -> V_11 [ V_14 ] ;
...
F_49 ( V_8 ) ;
V_59 = F_83 ( V_8 -> V_169 , V_200 , V_201 , * V_197 ) ;
if ( V_59 && V_59 != - V_171 && V_59 != - V_172 ) {
F_3 ( 1 , V_13 , L_56 ) ;
return V_59 ;
}
...
snprintf ( V_208 -> V_214 , sizeof( V_208 -> V_214 ) , L_64 , F_101 ( V_55 ) ) ;
snprintf ( V_208 -> V_215 , sizeof( V_208 -> V_215 ) , L_65 ,
F_101 ( V_55 ) ) ;
F_102 ( V_208 -> V_216 , V_91 -> V_217 , sizeof( V_208 -> V_216 ) ) ;
return 0 ;
}
...
static int F_105 ( struct V_129 * V_129 , void * V_148 , enum V_218 V_219 )
{
struct V_3 * V_4 = V_148 ;
struct V_7 * V_8 = V_4 -> V_9 ;
return F_106 ( & V_8 -> V_145 , & V_4 -> V_145 , V_219 ) ;
}
...
struct V_7 * V_8 = V_4 -> V_9 ;
int V_59 ;
V_59 = F_83 ( V_8 -> V_169 , V_94 , V_228 , V_227 ) ;
if ( V_59 == - V_171 || V_59 == - V_172 )
return - V_26 ;
return V_59 ;
}
...
struct V_7 * V_8 = V_4 -> V_9 ;
int V_59 ;
V_59 = F_83 ( V_8 -> V_169 , V_94 , V_230 , V_227 ) ;
if ( V_59 == - V_171 || V_59 == - V_172 )
return - V_199 ;
return V_59 ;
}
...
V_59 = F_83 ( V_8 -> V_169 , V_94 , V_234 , V_227 ) ;
if ( V_59 == - V_171 || V_59 == - V_172 )
V_59 = 0 ;
if ( V_59 < 0 ) {
F_3 ( 2 , V_13 , L_67 ) ;
...
return F_113 ( & V_83 . V_265 , 0 , V_200 ,
V_266 , V_258 ) ;
}
...
struct V_3 * V_4 = V_148 ;
struct V_7 * V_8 = V_4 -> V_9 ;
return F_83 ( V_8 -> V_169 , V_200 , V_269 , V_268 ) ;
}
static int F_115 ( struct V_129 * V_129 , void * V_148 ,
struct V_267 * V_268 ) {
struct V_3 * V_4 = V_148 ;
struct V_7 * V_8 = V_4 -> V_9 ;
return F_83 ( V_8 -> V_169 , V_200 , V_270 , V_268 ) ;
}
static int F_116 ( struct V_129 * V_130 , void * V_148 )
{
F_117 ( & V_83 . V_265 , 0 , V_200 , V_271 ) ;
return 0 ;
}
...
F_64 ( V_83 . V_82 [ V_273 ] ) ;
return V_272 ;
}
static T_6 int F_119 ( struct V_282 * V_283 )
{
struct V_177 * V_284 ;
struct V_53 * V_91 ;
...
V_272 = F_118 () ;
if ( V_272 ) {
F_120 ( V_55 -> V_214 , L_77 ) ;
return V_272 ;
}
V_272 = F_121 ( V_55 , & V_83 . V_265 ) ;
if ( V_272 ) {
F_120 ( V_55 -> V_214 , L_78 ) ;
return V_272 ;
}
while ( ( V_137 = F_122 ( V_283 , V_291 , V_286 ) ) ) {
for ( V_86 = V_137 -> V_292 ; V_86 <= V_137 -> V_293 ; V_86 ++ ) {
if ( F_123 ( V_86 , F_45 , V_294 ,
L_79 , ( void * )
...
V_181 = V_91 -> V_181 ;
V_83 . V_169 = F_62 ( sizeof( struct V_184 * ) * V_181 ,
V_140 ) ;
if ( V_83 . V_169 == NULL ) {
F_63 ( L_81 ) ;
V_272 = - V_141 ;
...
F_133 ( & V_8 -> V_145 ) ;
F_134 ( V_8 -> V_194 , V_8 ) ;
V_272 = F_88 ( V_91 , V_8 , 0 ) ;
if ( V_272 )
goto V_303;
V_272 = F_135 ( V_8 -> V_194 ,
V_304 , ( V_273 ? 1 : 0 ) ) ;
if ( V_272 )
goto V_303;
}
F_130 ( & V_83 . V_265 , L_84 ) ;
return 0 ;
V_303:
...
V_137 = F_122 ( V_283 , V_291 , V_86 ) ;
for ( V_273 = V_137 -> V_292 ; V_273 <= V_137 -> V_293 ; V_273 ++ )
F_124 ( V_273 , ( void * ) ( & V_83 . V_82 [ V_86 ] -> V_38 ) ) ;
}
return V_272 ;
}
static int F_138 ( struct V_282 * V_305 )
{
int V_86 ;
struct V_7 * V_8 ;
F_137 ( & V_83 . V_265 ) ;
...
static int F_139 ( struct V_305 * V_82 )
{
struct V_10 * V_11 ;
struct V_7 * V_8 ;
int V_86 ;
...
static int F_140 ( struct V_305 * V_82 )
{
struct V_10 * V_11 ;
struct V_7 * V_8 ;
int V_86 ;
...
while ( ( V_137 = F_122 ( V_283 , V_291 , V_86 ) ) ) {
