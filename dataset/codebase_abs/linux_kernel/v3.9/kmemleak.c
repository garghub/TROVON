...
unsigned long V_147 ;
V_144 = F_154 ( V_142 + 5 , 0 , & V_147 ) ;
if ( V_144 < 0 )
goto V_66;
F_136 () ;
if ( V_147 ) {
V_124 = F_155 ( V_147 * 1000 ) ;
F_134 () ;
}
...
static void F_156 ( struct V_148 * V_149 )
{
struct V_3 * V_4 ;
...
static void T_3 F_160 ( struct V_75 * log )
{
struct V_31 V_30 ;
V_30 . V_32 = log -> V_29 ;
V_30 . V_33 = log -> V_30 ;
...
#endif
V_24 = F_155 ( V_154 ) ;
V_124 = F_155 ( V_155 * 1000 ) ;
V_50 = F_163 ( V_3 , V_156 ) ;
V_49 = F_163 ( V_46 , V_156 ) ;
if ( V_77 >= F_74 ( V_75 ) )
F_38 ( L_54
L_55 , V_77 ) ;
F_75 ( V_21 ) ;
...
V_158 = F_165 ( L_39 , V_160 , NULL , NULL ,
& V_161 ) ;
if ( ! V_158 )
F_38 ( L_57 ) ;
F_131 ( & V_125 ) ;
