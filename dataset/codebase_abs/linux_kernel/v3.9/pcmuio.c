...
V_2 -> V_134 = V_34 -> V_135 ;
V_36 = F_33 ( sizeof( * V_36 ) , V_136 ) ;
if ( ! V_36 )
return - V_137 ;
V_2 -> V_37 = V_36 ;
for ( V_31 = 0 ; V_31 < V_70 ; ++ V_31 ) {
V_36 -> V_40 [ V_31 ] . V_138 = V_31 ;
V_36 -> V_40 [ V_31 ] . V_44 = V_2 -> V_44 + V_31 * V_45 ;
V_36 -> V_40 [ V_31 ] . V_66 = 0 ;
F_34 ( & V_36 -> V_40 [ V_31 ] . V_74 ) ;
}
V_126 = V_139 * V_34 -> V_38 ;
V_127 = F_35 ( V_126 ) ;
V_36 -> V_140 = F_36 ( V_127 ,
sizeof( struct V_141 ) ,
V_136 ) ;
if ( ! V_36 -> V_140 )
return - V_137 ;
V_129 = F_37 ( V_2 , V_127 ) ;
if ( V_129 )
return V_129 ;
V_47 = 0 ;
V_31 = 0 ;
...
int V_69 ;
if ( V_2 -> V_44 )
F_42 ( V_2 -> V_44 , V_45 * V_34 -> V_38 ) ;
for ( V_69 = 0 ; V_69 < V_70 ; ++ V_69 ) {
if ( V_36 -> V_40 [ V_69 ] . V_66 )
F_40 ( V_36 -> V_40 [ V_69 ] . V_66 , V_2 ) ;
}
if ( V_36 && V_36 -> V_140 )
F_43 ( V_36 -> V_140 ) ;
}
