...
if ( V_2 -> V_447 == NULL )
return - V_245 ;
V_2 -> V_448 = F_213 ( V_2 -> V_77 + 5 , V_361 ) ;
if ( ! V_2 -> V_448 ) {
F_177 ( V_2 -> V_447 ) ;
V_2 -> V_447 = NULL ;
return - V_245 ;
...
unsigned int V_6 ;
unsigned int V_449 ;
V_2 -> V_262 = F_216 ( V_2 -> V_450 , V_451 , & V_2 -> V_452 ) ;
if ( V_2 -> V_262 == NULL )
return - V_245 ;
memset ( V_2 -> V_262 , 0 , V_451 ) ;
...
if ( V_6 == V_2 -> V_14 - 1 )
V_2 -> V_15 [ V_6 ] . V_346 = F_217 ( V_449 ) ;
else
V_2 -> V_15 [ V_6 ] . V_346 = F_217 ( V_449 + ( ( V_6 + 1 ) * sizeof( struct V_261 ) ) ) ;
F_159 ( V_2 -> V_15 [ V_6 ] , V_387 ) ;
}
for ( V_6 = 0 ; V_6 < V_2 -> V_10 ; V_6 ++ ) {
V_2 -> V_11 [ V_6 ] . V_453 = V_449 + ( ( V_2 -> V_14 + V_6 ) * sizeof( struct V_261 ) ) ;
if ( V_6 == V_2 -> V_10 - 1 )
V_2 -> V_11 [ V_6 ] . V_346 = F_217 ( V_449 + V_2 -> V_14 * sizeof( struct V_261 ) ) ;
else
V_2 -> V_11 [ V_6 ] . V_346 = F_217 ( V_449 + ( ( V_2 -> V_14 + V_6 + 1 ) * sizeof( struct V_261 ) ) ) ;
}
return 0 ;
}
...
{
if ( V_2 -> V_262 != NULL ) {
F_219 ( V_2 -> V_450 , V_451 , V_2 -> V_262 , V_2 -> V_452 ) ;
V_2 -> V_262 = NULL ;
V_2 -> V_15 = NULL ;
V_2 -> V_11 = NULL ;
}
}
static int F_220 ( struct V_1 * V_2 , struct V_261 * V_262 , int V_4 )
{
int V_6 ;
for ( V_6 = 0 ; V_6 < V_4 ; V_6 ++ ) {
if ( ( V_262 [ V_6 ] . V_73 = F_216 ( V_2 -> V_450 , V_387 , & V_262 [ V_6 ] . V_454 ) ) == NULL )
return - V_245 ;
V_262 [ V_6 ] . V_455 = F_217 ( ( unsigned int ) V_262 [ V_6 ] . V_454 ) ;
}
return 0 ;
}
static void F_221 ( struct V_1 * V_2 , struct V_261 * V_262 , int V_4 )
{
int V_6 ;
for ( V_6 = 0 ; V_6 < V_4 ; V_6 ++ ) {
if ( V_262 [ V_6 ] . V_73 == NULL )
continue;
F_219 ( V_2 -> V_450 , V_387 , V_262 [ V_6 ] . V_73 , V_262 [ V_6 ] . V_454 ) ;
V_262 [ V_6 ] . V_73 = NULL ;
}
}
...
{
if ( V_2 -> V_262 ) {
F_221 ( V_2 , V_2 -> V_15 , V_2 -> V_14 ) ;
F_221 ( V_2 , V_2 -> V_11 , V_2 -> V_10 ) ;
F_218 ( V_2 ) ;
}
F_214 ( V_2 ) ;
}
...
{
if ( F_226 ( V_2 -> V_154 , V_248 , L_143 ) == NULL ) {
F_12 ( ( L_144 ,
V_2 -> V_8 , V_2 -> V_154 ) ) ;
V_2 -> V_36 = V_456 ;
goto V_457;
...
V_2 -> V_458 = true ;
V_2 -> V_459 = F_227 ( V_2 -> V_154 , V_248 ) ;
if ( ! V_2 -> V_459 ) {
F_12 ( ( L_145 ,
V_2 -> V_8 , V_2 -> V_154 ) ) ;
V_2 -> V_36 = V_460 ;
...
static struct V_1 * F_233 ( int V_472 , int V_473 , struct V_474 * V_450 )
{
struct V_1 * V_2 ;
V_2 = F_213 ( sizeof( struct V_1 ) , V_361 ) ;
if ( ! V_2 ) {
F_12 ( ( L_153 ,
V_32 , V_472 , V_473 ) ) ;
} else {
...
V_2 -> V_472 = V_472 ;
V_2 -> V_473 = V_473 ;
F_237 ( & V_2 -> V_71 , V_480 , ( unsigned long ) V_2 ) ;
F_237 ( & V_2 -> V_271 , V_481 , ( unsigned long ) V_2 ) ;
V_2 -> V_450 = V_450 ;
V_2 -> V_155 = V_450 -> V_249 ;
V_2 -> V_154 = F_238 ( V_450 , 0 ) ;
V_2 -> V_482 = V_483 ;
V_2 -> V_484 = V_485 ;
V_2 -> V_36 = - 1 ;
}
...
static void F_239 ( int V_472 , struct V_474 * V_450 )
{
...
V_353 [ V_6 ] = F_233 ( V_472 , V_6 , V_450 ) ;
if ( V_353 [ V_6 ] == NULL ) {
for ( -- V_6 ; V_6 >= 0 ; -- V_6 ) {
F_240 ( & V_353 [ V_6 ] -> V_38 ) ;
F_177 ( V_353 [ V_6 ] ) ;
}
return;
}
...
F_243 ( & V_2 -> V_38 , V_487 , V_2 -> line ,
& V_2 -> V_450 -> V_179 ) ;
}
}
static int F_244 ( struct V_474 * V_179 ,
...
static void F_247 ( struct V_474 * V_179 )
{
}
...
F_249 ( V_487 , V_2 -> line ) ;
if ( ( V_148 = F_250 ( V_487 ) ) )
F_12 ( ( L_157 , V_148 ) ) ;
F_251 ( V_487 ) ;
}
V_2 = V_34 ;
...
static void T_11 F_259 ( void )
{
F_248 () ;
}
static T_1 F_260 ( struct V_1 * V_2 , unsigned int V_508 )
{
F_261 () ;
return F_262 ( ( void V_509 * ) V_459 ) ;
}
static void F_263 ( struct V_1 * V_2 , unsigned int V_508 , T_1 V_174 )
{
F_261 () ;
F_264 ( V_174 , ( void V_509 * ) V_459 ) ;
}
static T_12 F_99 ( struct V_1 * V_2 , unsigned int V_508 )
{
F_261 () ;
return F_265 ( ( void V_509 * ) V_459 ) ;
}
static void F_100 ( struct V_1 * V_2 , unsigned int V_508 , T_12 V_174 )
{
F_261 () ;
F_266 ( V_174 , ( void V_509 * ) V_459 ) ;
}
static T_8 F_165 ( struct V_1 * V_2 , unsigned int V_508 )
{
F_261 () ;
return F_267 ( ( void V_509 * ) V_459 ) ;
}
static void F_166 ( struct V_1 * V_2 , unsigned int V_508 , T_8 V_174 )
{
F_261 () ;
...
if ( V_2 -> V_68 . V_69 != V_89 ) {
F_263 ( V_2 , V_510 , 0x49 ) ;
if ( V_2 -> V_68 . V_137 )
F_271 ( V_2 , V_2 -> V_68 . V_137 ) ;
else
F_271 ( V_2 , 3686400 ) ;
}
}
static void F_271 ( struct V_1 * V_2 , T_9 V_511 )
{
unsigned int div ;
...
F_100 ( V_2 , V_409 , ( unsigned short ) ( F_99 ( V_2 , V_409 ) | V_514 ) ) ;
F_166 ( V_2 , V_515 , V_2 -> V_15 [ 0 ] . V_453 ) ;
if ( V_2 -> V_68 . V_69 != V_89 ) {
...
F_166 ( V_2 , V_517 , V_2 -> V_11 [ V_2 -> V_336 ] . V_453 ) ;
...
V_338 |= V_267 ;
F_100 ( V_2 , V_389 , V_338 ) ;
F_263 ( V_2 , V_510 , 0x69 ) ;
F_198 ( V_2 ) ;
V_338 = V_316 + V_514 + V_267 ;
if ( ( F_165 ( V_2 , V_521 ) & V_354 ) && V_2 -> V_68 . V_85 &&
( ( V_2 -> V_147 < ( V_2 -> V_68 . V_85 * 16 ) ) ||
( V_2 -> V_147 % ( V_2 -> V_68 . V_85 * 16 ) ) ) ) {
V_338 |= V_288 ;
F_271 ( V_2 , V_2 -> V_68 . V_85 * 8 ) ;
} else {
F_271 ( V_2 , V_2 -> V_68 . V_85 * 16 ) ;
}
...
F_263 ( V_2 , V_539 , ( unsigned char ) V_338 ) ;
V_338 = 0 ;
switch( V_2 -> V_68 . V_69 ) {
case V_282 :
V_338 |= V_316 + V_522 ;
...
if ( V_2 -> V_68 . V_137 )
V_338 |= V_266 + V_267 ;
F_263 ( V_2 , V_510 , ( unsigned char ) V_338 ) ;
...
F_271 ( V_2 , V_2 -> V_68 . V_137 * 16 ) ;
}
else
F_271 ( V_2 , V_2 -> V_68 . V_137 ) ;
F_190 ( V_2 ) ;
F_198 ( V_2 ) ;
F_100 ( V_2 , V_409 , V_316 + V_514 + V_267 ) ;
if ( V_2 -> V_68 . V_135 )
F_270 ( V_2 ) ;
}
...
F_263 ( V_2 , V_539 , ( unsigned char ) ( ( V_2 -> V_385 >> 8 ) & 0xff ) ) ;
} else if ( ! ( V_540 & V_177 ) ) {
V_540 &= ~ ( V_333 + V_334 ) ;
}
...
if ( V_2 -> V_412 & V_554 )
V_338 |= V_267 ;
F_263 ( V_2 , V_555 , V_338 ) ;
}
static void F_33 ( struct V_1 * V_2 )
{
unsigned char V_338 = F_260 ( V_2 , V_555 ) ;
if ( V_2 -> V_62 & V_64 )
V_338 |= V_288 ;
else
V_338 &= ~ V_288 ;
...
F_145 ( ( L_164 ,
V_2 -> V_8 , V_12 , V_558 ) ) ;
F_138 ( V_2 , V_2 -> V_15 [ V_258 ] . V_73 , F_45 ( int , V_558 , V_2 -> V_314 ) , L_94 ) ;
if ( V_558 ) {
if ( ! ( V_2 -> V_68 . V_139 & V_562 ) ) {
V_558 -= V_560 ;
V_560 = 0 ;
...
V_2 -> V_117 . V_161 ++ ;
while( V_565 ) {
int V_567 = F_45 ( int , V_565 , V_2 -> V_314 ) ;
...
static unsigned int F_277 ( struct V_1 * V_2 )
{
unsigned int V_4 = 0 ;
unsigned int V_6 = V_2 -> V_9 ;
do
...
unsigned int V_6 ;
struct V_261 * V_574 ;
if ( F_278 ( V_209 , V_387 ) > F_277 ( V_2 ) )
return false ;
...
static unsigned int V_4 = F_281 ( V_575 ) ;
unsigned int V_6 ;
int V_148 = 0 ;
for ( V_6 = 0 ; V_6 < V_4 ; V_6 ++ ) {
F_100 ( V_2 , V_547 , V_575 [ V_6 ] ) ;
F_100 ( V_2 , V_513 , V_575 [ ( V_6 + 1 ) % V_4 ] ) ;
if ( ( F_99 ( V_2 , V_547 ) != V_575 [ V_6 ] ) ||
( F_99 ( V_2 , V_513 ) != V_575 [ ( V_6 + 1 ) % V_4 ] ) ) {
V_148 = - V_33 ;
break;
}
}
V_2 -> V_357 = ( F_165 ( V_2 , V_521 ) & V_333 ) ? 1 : 0 ;
...
V_2 -> V_68 . V_135 = 1 ;
V_2 -> V_38 . V_21 = NULL ;
for ( V_4 = 0 ; V_4 < F_285 ; ++ V_4 )
V_73 [ V_4 ] = ( unsigned char ) V_4 ;
V_2 -> V_566 = 0 ;
memset ( V_2 -> V_447 , 0 , F_285 ) ;
F_17 ( & V_2 -> V_54 , V_22 ) ;
F_181 ( V_2 ) ;
F_148 ( V_2 ) ;
F_41 ( V_2 , V_73 , V_4 ) ;
