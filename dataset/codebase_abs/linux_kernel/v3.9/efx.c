...
if ( V_98 -> V_99 )
F_98 ( V_2 , V_101 , V_2 -> V_6 ,
L_18 ,
V_98 -> V_102 , V_98 -> V_103 ? L_19 : L_20 ,
V_2 -> V_6 -> V_74 ,
( V_2 -> V_104 ? L_21 : L_9 ) ) ;
else
F_98 ( V_2 , V_101 , V_2 -> V_6 , L_22 ) ;
}
void F_99 ( struct V_1 * V_2 , T_2 V_105 )
{
V_2 -> V_106 = V_105 ;
if ( V_105 ) {
if ( V_105 & V_107 )
...
void F_100 ( struct V_1 * V_2 , T_3 V_108 )
{
V_2 -> V_108 = V_108 ;
if ( V_2 -> V_106 ) {
if ( V_108 & V_110 )
...
if ( F_119 ( & V_81 -> V_82 , V_136 ) ) {
V_59 = F_120 ( & V_81 -> V_82 , V_136 ) ;
if ( V_59 == 0 )
break;
}
V_136 >>= 1 ;
...
V_59 = F_121 ( & V_81 -> V_82 , V_136 ) ;
if ( V_59 ) {
F_2 ( V_2 , V_36 , V_2 -> V_6 ,
L_33 ) ;
goto V_132;
}
V_2 -> V_138 = F_122 ( V_2 -> V_81 , V_139 ) ;
V_59 = F_123 ( V_81 , V_139 , L_34 ) ;
if ( V_59 ) {
F_2 ( V_2 , V_36 , V_2 -> V_6 ,
L_35 ) ;
V_59 = - V_7 ;
...
if ( F_4 ( ! F_130 ( & V_144 , V_48 ) ) ) {
F_131 ( V_2 , V_36 , V_2 -> V_6 ,
L_39 ) ;
return 1 ;
}
V_145 = 0 ;
F_132 (cpu) {
if ( ! F_133 ( V_146 , V_144 ) ) {
++ V_145 ;
F_134 ( V_144 , V_144 ,
F_135 ( V_146 ) ) ;
}
...
static int
F_139 ( struct V_1 * V_2 , struct V_148 * V_149 )
{
#ifdef F_140
unsigned int V_43 ;
int V_59 ;
V_2 -> V_6 -> V_150 = F_141 ( V_2 -> V_151 ) ;
if ( ! V_2 -> V_6 -> V_150 )
return - V_93 ;
for ( V_43 = 0 ; V_43 < V_2 -> V_151 ; V_43 ++ ) {
V_59 = F_142 ( V_2 -> V_6 -> V_150 ,
V_149 [ V_43 ] . V_152 ) ;
if ( V_59 ) {
F_143 ( V_2 -> V_6 -> V_150 ) ;
V_2 -> V_6 -> V_150 = NULL ;
...
V_29 *= 2 ;
V_29 += V_155 ;
V_29 = F_145 ( V_29 , V_153 ) ;
for ( V_43 = 0 ; V_43 < V_29 ; V_43 ++ )
V_149 [ V_43 ] . V_161 = V_43 ;
V_59 = F_146 ( V_2 -> V_81 , V_149 , V_29 ) ;
if ( V_59 > 0 ) {
F_2 ( V_2 , V_5 , V_2 -> V_6 ,
L_43
L_44 , V_59 , V_29 ) ;
...
V_59 = F_149 ( V_2 -> V_81 ) ;
if ( V_59 == 0 ) {
F_148 ( V_2 , 0 ) -> V_33 = V_2 -> V_81 -> V_33 ;
} else {
F_2 ( V_2 , V_5 , V_2 -> V_6 ,
L_47 ) ;
V_2 -> V_158 = V_164 ;
...
V_2 -> V_165 = ( ( V_2 -> V_151 > 1 || ! F_137 ( V_2 ) ) ?
V_2 -> V_151 : F_138 ( V_2 ) ) ;
return 0 ;
}
static void F_85 ( struct V_1 * V_2 , bool V_166 )
{
struct V_8 * V_9 ;
F_21 ( V_2 -> V_3 == V_4 ) ;
if ( V_2 -> V_31 )
...
static void F_81 ( struct V_1 * V_2 , bool V_166 )
{
struct V_8 * V_9 ;
if ( V_2 -> V_3 == V_4 )
return;
...
V_2 -> type -> V_169 ( V_2 ) ;
if ( V_2 -> V_29 > 1 )
F_157 ( & V_2 -> V_170 , sizeof( V_2 -> V_170 ) ) ;
for ( V_43 = 0 ; V_43 < F_158 ( V_2 -> V_171 ) ; V_43 ++ )
V_2 -> V_171 [ V_43 ] =
F_159 ( V_43 , V_2 -> V_165 ) ;
F_155 ( V_2 ) ;
F_160 ( V_2 -> V_6 , V_2 -> V_162 ) ;
F_161 ( V_2 -> V_6 , V_2 -> V_151 ) ;
F_162 ( V_2 , V_172 , V_173 , true ,
true ) ;
return 0 ;
V_61:
V_2 -> type -> remove ( V_2 ) ;
...
F_69 ( V_2 ) ;
F_21 ( V_2 -> V_3 == V_4 ) ;
if ( V_2 -> V_83 || ! F_94 ( V_2 -> V_6 ) )
return;
F_112 ( V_2 ) ;
F_58 ( V_2 ) ;
if ( V_2 -> type -> V_177 != NULL ) {
F_169 ( V_2 -> V_178 , & V_2 -> V_179 ,
V_180 ) ;
} else {
F_107 ( & V_2 -> V_114 ) ;
...
static unsigned int F_176 ( unsigned int V_184 , unsigned int V_185 )
{
if ( V_184 == 0 )
return 0 ;
if ( V_184 * 1000 < V_185 )
...
int F_162 ( struct V_1 * V_2 , unsigned int V_186 ,
unsigned int V_187 , bool V_188 ,
bool V_189 )
{
struct V_8 * V_9 ;
unsigned int V_190 = F_177 ( V_2 -> type -> V_191 *
V_2 -> V_192 ,
1000 ) ;
unsigned int V_193 ;
unsigned int V_194 ;
...
return - V_176 ;
V_193 = F_176 ( V_186 , V_2 -> V_192 ) ;
V_194 = F_176 ( V_187 , V_2 -> V_192 ) ;
...
void F_179 ( struct V_1 * V_2 , unsigned int * V_186 ,
unsigned int * V_187 , bool * V_188 )
{
* V_188 = V_2 -> V_21 ;
* V_187 = F_177 ( V_2 -> V_28 *
V_2 -> V_192 ,
1000 ) ;
if ( V_2 -> V_66 == 0 )
* V_186 = * V_187 ;
...
static void F_180 ( struct V_117 * V_118 )
{
...
static int F_182 ( struct V_197 * V_6 , struct V_198 * V_199 , int V_200 )
{
struct V_1 * V_2 = F_183 ( V_6 ) ;
struct V_201 * V_118 = F_184 ( V_199 ) ;
if ( V_200 == V_202 )
return F_185 ( V_2 , V_199 , V_200 ) ;
if ( ( V_200 == V_203 || V_200 == V_204 ) &&
( V_118 -> V_205 & 0xfc00 ) == 0x0400 )
V_118 -> V_205 ^= V_206 | 0x0400 ;
return F_186 ( & V_2 -> V_207 , V_118 , V_200 ) ;
}
static void F_82 ( struct V_8 * V_9 )
{
struct V_1 * V_2 = V_9 -> V_2 ;
V_9 -> V_54 = V_2 -> V_6 ;
F_187 ( V_9 -> V_54 , & V_9 -> V_19 ,
F_14 , V_208 ) ;
}
...
static void F_191 ( struct V_197 * V_6 )
{
struct V_1 * V_2 = F_183 ( V_6 ) ;
struct V_8 * V_9 ;
F_54 (channel, efx)
...
static int F_193 ( struct V_197 * V_6 )
{
struct V_1 * V_2 = F_183 ( V_6 ) ;
int V_59 ;
...
static int F_197 ( struct V_197 * V_6 )
{
struct V_1 * V_2 = F_183 ( V_6 ) ;
...
static struct V_210 * F_198 ( struct V_197 * V_6 ,
struct V_210 * V_211 )
{
struct V_1 * V_2 = F_183 ( V_6 ) ;
...
static void F_201 ( struct V_197 * V_6 )
{
struct V_1 * V_2 = F_183 ( V_6 ) ;
...
static int F_202 ( struct V_197 * V_6 , int V_245 )
{
struct V_1 * V_2 = F_183 ( V_6 ) ;
int V_59 ;
V_59 = F_1 ( V_2 ) ;
...
static int F_203 ( struct V_197 * V_6 , void * V_118 )
{
struct V_1 * V_2 = F_183 ( V_6 ) ;
...
static void F_206 ( struct V_197 * V_6 )
{
struct V_1 * V_2 = F_183 ( V_6 ) ;
struct V_253 * V_254 ;
...
if ( V_2 -> V_83 )
F_210 ( V_2 -> V_178 , & V_2 -> V_119 ) ;
}
static int F_211 ( struct V_197 * V_6 , T_6 V_118 )
{
struct V_1 * V_2 = F_183 ( V_6 ) ;
...
static int F_215 ( struct V_267 * V_268 ,
...
static T_7
F_216 ( struct V_275 * V_82 , struct V_276 * V_277 , char * V_63 )
{
struct V_1 * V_2 = F_217 ( F_218 ( V_82 ) ) ;
...
F_226 () ;
V_59 = F_227 ( & V_2 -> V_81 -> V_82 , & V_287 ) ;
if ( V_59 ) {
F_2 ( V_2 , V_5 , V_2 -> V_6 ,
L_63 ) ;
goto V_288;
...
if ( ! V_2 -> V_6 )
return;
F_21 ( F_183 ( V_2 -> V_6 ) != V_2 ) ;
F_54 (channel, efx) {
F_47 (tx_queue, channel)
F_230 ( V_46 ) ;
}
F_231 ( V_2 -> V_67 , F_232 ( V_2 -> V_81 ) , sizeof( V_2 -> V_67 ) ) ;
F_233 ( & V_2 -> V_81 -> V_82 , & V_287 ) ;
F_221 () ;
F_228 ( V_2 -> V_6 ) ;
V_2 -> V_3 = V_289 ;
F_226 () ;
}
void F_234 ( struct V_1 * V_2 , enum V_290 V_291 )
{
F_69 ( V_2 ) ;
F_80 ( V_2 ) ;
F_81 ( V_2 , false ) ;
...
int F_235 ( struct V_1 * V_2 , enum V_290 V_291 , bool V_293 )
{
int V_59 ;
F_69 ( V_2 ) ;
...
int F_195 ( struct V_1 * V_2 , enum V_290 V_291 )
{
int V_59 , V_294 ;
bool V_295 ;
F_98 ( V_2 , V_5 , V_2 -> V_6 , L_67 ,
F_238 ( V_291 ) ) ;
F_79 ( V_2 ) ;
F_234 ( V_2 , V_291 ) ;
...
F_252 ( & V_2 -> V_179 , F_180 ) ;
F_252 ( & V_2 -> V_305 , V_306 ) ;
V_2 -> V_81 = V_81 ;
V_2 -> V_307 = V_308 ;
V_2 -> V_3 = V_289 ;
F_231 ( V_2 -> V_67 , F_232 ( V_81 ) , sizeof( V_2 -> V_67 ) ) ;
V_2 -> V_6 = V_6 ;
F_248 ( & V_2 -> V_214 ) ;
F_253 ( & V_2 -> V_114 ) ;
V_2 -> V_127 = & V_309 ;
V_2 -> V_207 . V_82 = V_6 ;
F_251 ( & V_2 -> V_119 , F_109 ) ;
F_254 ( & V_2 -> V_310 ) ;
...
static int F_273 ( struct V_81 * V_81 ,
...
{
struct V_81 * V_81 = F_218 ( V_82 ) ;
struct V_1 * V_2 = F_217 ( V_81 ) ;
V_2 -> type -> V_133 ( V_2 ) ;
V_2 -> V_285 = 0 ;
F_281 ( V_81 ) ;
