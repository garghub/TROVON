...
if ( V_2 -> V_6 > 1 )
V_2 -> V_7 -> V_8 = V_9 ;
F_3 ( V_2 -> V_5 ) . V_10 = V_1 + 1 ;
F_4 ( V_11 , V_2 -> V_5 , 0 , V_1 + 1 , V_12 ) ;
V_2 -> V_6 = 0 ;
V_2 -> V_5 = NULL ;
}
...
static struct V_15 * F_8 ( unsigned int V_16 )
{
struct V_15 * V_5 ;
unsigned int V_17 ;
V_17 = F_9 ( V_16 , V_18 ) ;
V_5 = F_10 ( V_17 , V_12 | V_19 ) ;
if ( ! V_5 ) {
if ( V_17 > V_16 ) {
V_5 = F_10 ( V_16 , V_12 ) ;
if ( ! V_5 )
...
static void F_12 ( unsigned int V_20 , const struct V_15 * V_5 ,
...
if ( ! ( V_2 -> V_5 = F_8 ( V_16 ) ) )
goto V_36;
} else if ( V_16 > F_14 ( V_2 -> V_5 ) ) {
F_1 ( V_31 ) ;
if ( ! ( V_2 -> V_5 = F_8 ( V_16 ) ) )
goto V_36;
}
V_30 = F_15 ( V_2 -> V_5 , 0 , V_2 -> V_6 , 0 ,
V_16 - F_16 ( sizeof( * V_30 ) ) , 0 ) ;
if ( ! V_30 ) {
F_17 ( V_2 -> V_5 ) ;
V_2 -> V_5 = NULL ;
goto V_36;
...
F_12 ( V_59 , V_5 , V_22 , V_23 , & V_62 , V_26 ) ;
}
static unsigned int
F_29 ( struct V_15 * V_5 , const struct V_68 * V_69 )
{
F_12 ( V_69 -> V_59 , V_5 , V_69 -> V_22 , V_69 -> V_23 ,
V_69 -> V_70 , NULL ) ;
return V_71 ;
}
