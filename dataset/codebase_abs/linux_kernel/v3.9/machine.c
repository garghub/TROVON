...
{
struct V_14 * V_14 = F_6 ( V_1 , V_49 -> V_144 . V_50 ) ;
struct V_14 * V_28 = F_6 ( V_1 , V_49 -> V_144 . V_145 ) ;
if ( V_51 )
F_109 ( V_49 , stdout ) ;
...
int F_111 ( struct V_1 * V_1 , union V_48 * V_49 )
{
struct V_14 * V_14 = F_41 ( V_1 , V_49 -> V_144 . V_50 ) ;
if ( V_51 )
F_109 ( V_49 , stdout ) ;
if ( V_14 != NULL )
F_112 ( V_1 , V_14 ) ;
...
void F_112 ( struct V_1 * V_1 , struct V_14 * V_47 )
{
V_1 -> V_11 = NULL ;
F_17 ( & V_47 -> V_5 , & V_1 -> V_8 ) ;
F_114 ( & V_47 -> V_21 , & V_1 -> V_10 ) ;
}
static bool F_115 ( struct V_151 * V_152 )
{
if ( V_152 -> V_79 && ! regexec ( & V_153 , V_152 -> V_79 , 0 , NULL , 0 ) )
return 1 ;
return 0 ;
}
...
for ( V_66 = 0 ; V_66 < V_160 ; V_66 ++ ) {
V_159 = V_161 [ V_66 ] ;
F_117 ( V_14 , V_1 , V_159 , V_59 ,
V_156 , & V_158 , NULL ) ;
if ( V_158 . V_152 )
goto V_162;
}
V_162:
V_155 -> V_163 = V_156 ;
V_155 -> V_164 = V_158 . V_163 ;
V_155 -> V_152 = V_158 . V_152 ;
V_155 -> V_56 = V_158 . V_56 ;
}
struct V_165 * F_118 ( struct V_1 * V_1 ,
struct V_14 * V_166 ,
struct V_167 * V_168 )
{
struct V_165 * V_169 ;
unsigned int V_66 ;
V_169 = calloc ( V_168 -> V_170 , sizeof( struct V_165 ) ) ;
if ( ! V_169 )
return NULL ;
for ( V_66 = 0 ; V_66 < V_168 -> V_170 ; V_66 ++ ) {
F_116 ( V_1 , V_166 , & V_169 [ V_66 ] . V_171 , V_168 -> V_172 [ V_66 ] . V_171 ) ;
F_116 ( V_1 , V_166 , & V_169 [ V_66 ] . V_173 , V_168 -> V_172 [ V_66 ] . V_173 ) ;
V_169 [ V_66 ] . V_174 = V_168 -> V_172 [ V_66 ] . V_174 ;
}
return V_169 ;
}
...
int V_178 ;
F_120 ( & V_179 ) ;
if ( V_176 -> V_170 > V_180 ) {
F_121 ( L_39 ) ;
return 0 ;
}
for ( V_66 = 0 ; V_66 < V_176 -> V_170 ; V_66 ++ ) {
T_5 V_156 ;
struct V_157 V_158 ;
if ( V_181 . V_182 == V_183 )
V_156 = V_176 -> V_184 [ V_66 ] ;
else
V_156 = V_176 -> V_184 [ V_176 -> V_170 - V_66 - 1 ] ;
if ( V_156 >= V_185 ) {
switch ( V_156 ) {
case V_186 :
V_138 = V_187 ;
...
V_178 = F_122 ( & V_179 ,
V_156 , V_158 . V_56 , V_158 . V_152 ) ;
if ( V_178 )
return V_178 ;
}
return 0 ;
}
static int F_123 ( struct F_123 * V_195 , void * V_78 )
{
struct V_179 * V_196 = V_78 ;
return F_122 ( V_196 , V_195 -> V_156 ,
V_195 -> V_56 , V_195 -> V_152 ) ;
}
...
if ( V_64 )
return V_64 ;
if ( ! ( ( V_198 -> V_202 . V_203 & V_204 ) &&
( V_198 -> V_202 . V_203 & V_205 ) ) )
return 0 ;
if ( ( ! V_200 -> V_206 . V_207 ) ||
( ! V_200 -> V_208 . V_44 ) )
return 0 ;
return F_125 ( F_123 , & V_179 , V_1 ,
V_14 , V_198 -> V_202 . V_209 ,
V_200 ) ;
}
