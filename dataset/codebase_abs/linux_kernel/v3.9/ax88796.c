...
memcpy ( V_3 -> V_140 , V_138 , 6 ) ;
}
#ifdef F_63
if ( V_53 -> V_71 -> V_136 & V_141 ) {
unsigned char V_142 [ 6 ] ;
struct V_95 V_96 ;
V_96 . V_49 = V_5 ;
V_96 . V_143 = F_47 ;
V_96 . V_144 = F_48 ;
...
V_53 -> V_71 -> V_142 )
memcpy ( V_3 -> V_140 , V_53 -> V_71 -> V_142 , V_154 ) ;
F_6 ( V_3 ) ;
V_5 -> V_67 = L_15 ;
V_5 -> V_156 = V_50 ;
V_5 -> V_134 = V_134 ;
...
V_5 = F_2 ( V_3 ) ;
V_53 = F_1 ( V_3 ) ;
V_53 -> V_71 = V_87 -> V_3 . V_176 ;
F_79 ( V_87 , V_3 ) ;
V_5 -> V_177 = V_53 -> V_71 -> V_178 ;
V_68 = F_72 ( V_87 , V_179 , 0 ) ;
if ( ! V_68 ) {
F_80 ( & V_87 -> V_3 , L_17 ) ;
V_60 = - V_180 ;
goto V_181;
...
V_174 = F_74 ( V_7 ) ;
if ( V_53 -> V_71 -> V_183 )
V_5 -> V_184 = V_53 -> V_71 -> V_183 ;
else {
V_5 -> V_184 = V_53 -> V_183 ;
for ( V_60 = 0 ; V_60 < 0x18 ; V_60 ++ )
V_53 -> V_183 [ V_60 ] = ( V_174 / 0x18 ) * V_60 ;
}
if ( ! F_81 ( V_7 -> V_171 , V_174 , V_87 -> V_67 ) ) {
F_80 ( & V_87 -> V_3 , L_19 ) ;
V_60 = - V_180 ;
goto V_181;
}
V_5 -> V_7 = F_82 ( V_7 -> V_171 , V_174 ) ;
V_3 -> V_20 = ( unsigned long ) V_5 -> V_7 ;
if ( V_5 -> V_7 == NULL ) {
F_80 ( & V_87 -> V_3 , L_20 , V_7 ) ;
V_60 = - V_180 ;
goto V_185;
}
...
V_53 -> V_183 [ V_60 ] = ( V_174 / 0x20 ) * V_60 ;
}
} else {
V_175 = F_74 ( V_173 ) ;
if ( ! F_81 ( V_173 -> V_171 , V_175 , V_87 -> V_67 ) ) {
F_80 ( & V_87 -> V_3 , L_19 ) ;
V_60 = - V_180 ;
goto V_186;
}
V_53 -> V_172 = F_82 ( V_173 -> V_171 , V_175 ) ;
if ( ! V_53 -> V_172 ) {
F_80 ( & V_87 -> V_3 , L_21 ) ;
V_60 = - V_180 ;
goto V_187;
}
V_5 -> V_184 [ 0x1f ] = V_53 -> V_172 - V_5 -> V_7 ;
}
V_60 = F_62 ( V_3 ) ;
if ( ! V_60 )
return 0 ;
...
static int F_83 ( struct V_86 * V_3 , T_3 V_188 )
{
struct V_2 * V_189 = F_69 ( V_3 ) ;
struct V_1 * V_53 = F_1 ( V_189 ) ;
V_53 -> V_190 = V_53 -> V_79 ;
F_84 ( V_189 ) ;
F_34 ( V_189 ) ;
return 0 ;
}
...
{
struct V_2 * V_189 = F_69 ( V_87 ) ;
struct V_1 * V_53 = F_1 ( V_189 ) ;
F_61 ( V_189 , F_2 ( V_189 ) ) ;
F_18 ( V_189 , V_53 -> V_190 ) ;
F_86 ( V_189 ) ;
if ( V_53 -> V_190 )
F_28 ( V_189 ) ;
return 0 ;
