...
V_83 = F_78 ( V_3 -> V_4 -> V_28 ) ;
V_84 = F_76 () ;
V_81 = F_79 ( V_83 , V_82 ) >> V_3 -> V_7 -> V_9 ;
V_81 = F_79 ( V_81 , V_84 ) ;
if ( V_81 < 64 )
V_81 = 64 ;
V_81 = F_80 ( V_81 ) ;
...
static void V_109 ( int V_110 , unsigned long V_111 , void * V_77 )
{
struct V_2 * V_3 = V_77 ;
struct V_13 * V_92 = NULL ;
if ( V_110 || V_111 ) {
...
V_3 -> V_108 = F_119 ( & V_130 ) ;
if ( F_120 ( V_3 -> V_108 ) ) {
V_51 = F_121 ( V_3 -> V_108 ) ;
V_42 -> error = L_23 ;
goto V_131;
}
V_3 -> V_72 = F_122 ( V_132 , V_133 ) ;
if ( ! V_3 -> V_72 ) {
V_42 -> error = L_24 ;
goto V_134;
}
...
V_51 = V_3 -> V_7 -> type -> V_139 ( V_3 -> V_7 , F_73 ,
( void * ) V_3 ) ;
if ( V_51 < 0 ) {
V_42 -> error = L_26 ;
goto V_140;
...
V_143 . V_141 = V_37 -> V_80 ;
V_37 -> V_80 = V_36 -> V_80 ;
V_36 -> V_80 = V_143 . V_141 ;
V_143 . V_142 = V_37 -> V_7 ;
V_37 -> V_7 = V_36 -> V_7 ;
V_36 -> V_7 = V_143 . V_142 ;
V_37 -> V_7 -> V_35 = V_37 ;
V_36 -> V_7 -> V_35 = V_36 ;
V_37 -> V_42 -> V_144 = V_37 -> V_7 -> V_48 ;
...
static void F_141 ( struct V_2 * V_3 , int V_148 )
{
if ( ! V_3 -> V_105 )
return;
if ( V_148 == - V_149 )
...
F_25 ( L_31 ) ;
if ( V_3 -> V_7 -> type -> V_150 )
V_3 -> V_7 -> type -> V_150 ( V_3 -> V_7 ) ;
V_3 -> V_105 = 0 ;
F_142 ( V_3 -> V_42 -> V_58 ) ;
}
static void F_143 ( struct V_70 * V_71 , int V_151 )
{
struct V_62 * V_65 ;
struct V_2 * V_3 = V_71 -> V_35 ;
struct V_13 * V_152 = NULL ;
...
V_41:
F_55 ( & V_71 -> V_65 ) ;
V_153 = F_86 ( & V_71 -> V_153 ) ;
V_152 = F_86 ( & V_71 -> V_152 ) ;
V_154 = V_71 -> V_154 ;
if ( V_154 ) {
V_154 -> V_155 = V_71 -> V_156 ;
V_154 -> V_157 = V_71 -> V_158 ;
}
F_64 ( V_71 ) ;
F_94 () ;
F_43 ( & V_3 -> V_43 ) ;
...
static void F_145 ( void * V_77 , int V_151 )
{
struct V_70 * V_71 = V_77 ;
F_143 ( V_71 , V_151 ) ;
}
static void F_146 ( int V_110 , unsigned long V_111 , void * V_77 )
{
struct V_70 * V_71 = V_77 ;
struct V_2 * V_3 = V_71 -> V_35 ;
if ( V_110 || V_111 )
...
V_3 -> V_7 -> type -> V_159 ( V_3 -> V_7 , & V_71 -> V_65 ,
F_145 , V_71 ) ;
}
...
V_160 = F_78 ( V_28 ) ;
V_99 . V_28 = V_28 ;
V_99 . V_107 = F_3 ( V_3 -> V_7 , V_71 -> V_65 . V_66 ) ;
V_99 . V_39 = F_79 ( ( T_1 ) V_3 -> V_7 -> V_48 , V_160 - V_99 . V_107 ) ;
V_100 . V_28 = V_3 -> V_5 -> V_28 ;
V_100 . V_107 = F_3 ( V_3 -> V_7 , V_71 -> V_65 . V_76 ) ;
V_100 . V_39 = V_99 . V_39 ;
F_102 ( V_3 -> V_108 , & V_99 , 1 , & V_100 , 0 , F_146 , V_71 ) ;
}
static void V_156 ( struct V_13 * V_13 , int error )
{
void * V_161 = V_13 -> V_157 ;
F_148 ( V_161 , 0 , error ? 1 : 0 ) ;
}
static void F_149 ( struct V_70 * V_71 ,
struct V_13 * V_13 )
{
struct V_2 * V_3 = V_71 -> V_35 ;
void * V_161 ;
V_71 -> V_154 = V_13 ;
V_71 -> V_156 = V_13 -> V_155 ;
V_71 -> V_158 = V_13 -> V_157 ;
V_161 = F_150 ( V_3 -> V_108 ,
F_146 , V_71 ) ;
V_13 -> V_155 = V_156 ;
V_13 -> V_157 = V_161 ;
F_137 ( V_13 ) ;
...
if ( ! V_65 )
return NULL ;
return F_152 ( V_65 , struct V_70 , V_65 ) ;
}
static struct V_70 *
...
V_71 -> V_163 = 0 ;
V_71 -> V_154 = NULL ;
if ( V_3 -> V_7 -> type -> V_164 ( V_3 -> V_7 , & V_71 -> V_65 ) ) {
F_64 ( V_71 ) ;
return NULL ;
}
F_68 ( & V_3 -> V_86 , & V_71 -> V_65 ) ;
return V_71 ;
}
static void F_154 ( struct V_2 * V_3 , struct V_62 * V_65 ,
struct V_13 * V_13 , T_2 V_8 )
{
V_13 -> V_165 = V_3 -> V_5 -> V_28 ;
V_13 -> V_166 = F_3 ( V_3 -> V_7 ,
F_70 ( V_65 -> V_76 ) +
( V_8 - V_65 -> V_66 ) ) +
( V_13 -> V_166 &
V_3 -> V_7 -> V_167 ) ;
}
static int F_155 ( struct V_114 * V_42 , struct V_13 * V_13 )
{
struct V_62 * V_65 ;
struct V_2 * V_3 = V_42 -> V_136 ;
int V_51 = V_147 ;
...
F_154 ( V_3 , & V_71 -> V_65 , V_13 , V_8 ) ;
V_51 = V_172 ;
if ( ! V_71 -> V_163 &&
V_13 -> V_173 == ( V_3 -> V_7 -> V_48 << V_174 ) ) {
V_71 -> V_163 = 1 ;
F_43 ( & V_3 -> V_43 ) ;
F_149 ( V_71 , V_13 ) ;
goto V_41;
}
F_158 ( & V_71 -> V_153 , V_13 ) ;
if ( ! V_71 -> V_163 ) {
V_71 -> V_163 = 1 ;
F_43 ( & V_3 -> V_43 ) ;
F_147 ( V_71 ) ;
...
static int F_159 ( struct V_114 * V_42 , struct V_13 * V_13 )
{
struct V_62 * V_65 ;
struct V_2 * V_3 = V_42 -> V_136 ;
int V_51 = V_147 ;
...
static int F_161 ( struct V_114 * V_42 , struct V_13 * V_13 , int error )
{
struct V_2 * V_3 = V_42 -> V_136 ;
if ( F_8 ( V_13 ) )
F_15 ( V_3 , V_13 ) ;
...
static void F_162 ( struct V_114 * V_42 )
{
struct V_2 * V_3 = V_42 -> V_136 ;
F_108 ( V_3 ) ;
}
static int F_163 ( struct V_114 * V_42 )
{
int V_51 = 0 ;
struct V_2 * V_3 = V_42 -> V_136 ;
struct V_2 * V_36 = NULL , * V_37 = NULL ;
...
static T_3 F_167 ( struct V_10 * V_28 )
{
T_3 V_177 ;
F_37 ( & V_27 ) ;
V_177 = F_74 ( F_31 ( V_28 ) ) ;
F_38 ( & V_27 ) ;
return V_177 ;
}
...
struct V_2 * V_3 = V_42 -> V_136 ;
F_165 ( V_42 ) ;
V_42 -> V_144 = F_167 ( V_3 -> V_4 -> V_28 ) ;
F_104 ( V_3 ) ;
}
static void F_169 ( struct V_114 * V_42 , T_6 type ,
unsigned V_178 , char * V_179 , unsigned V_180 )
{
unsigned V_181 = 0 ;
struct V_2 * V_35 = V_42 -> V_136 ;
switch ( type ) {
case V_182 :
F_42 ( & V_35 -> V_43 ) ;
if ( ! V_35 -> V_105 )
...
if ( V_35 -> V_7 -> type -> V_183 ) {
T_1 V_184 , V_185 ,
V_186 ;
V_35 -> V_7 -> type -> V_183 ( V_35 -> V_7 ,
& V_184 ,
& V_185 ,
& V_186 ) ;
F_170 ( L_38 ,
...
break;
case V_187 :
F_170 ( L_40 , V_35 -> V_4 -> V_188 , V_35 -> V_5 -> V_188 ) ;
V_35 -> V_7 -> type -> V_189 ( V_35 -> V_7 , type , V_179 + V_181 ,
V_180 - V_181 ) ;
break;
}
}
static int F_171 ( struct V_114 * V_42 ,
T_7 V_190 , void * V_191 )
{
struct V_2 * V_35 = V_42 -> V_136 ;
int V_51 ;
V_51 = V_190 ( V_42 , V_35 -> V_4 , 0 , V_42 -> V_192 , V_191 ) ;
if ( ! V_51 )
V_51 = V_190 ( V_42 , V_35 -> V_5 , 0 , F_78 ( V_35 -> V_5 -> V_28 ) , V_191 ) ;
return V_51 ;
}
static int F_172 ( struct V_24 * V_52 , T_1 V_107 ,
struct V_13 * V_13 )
{
int V_51 = V_147 ;
struct V_2 * V_35 ;
...
goto V_195;
if ( V_107 >= F_173 ( V_35 -> V_42 -> V_58 ) )
goto V_195;
V_8 = F_156 ( V_35 -> V_7 , V_107 ) ;
...
V_32 = F_31 ( V_4 -> V_28 ) ;
if ( V_32 )
V_51 = F_172 ( & V_32 -> V_52 , V_13 -> V_166 , V_13 ) ;
F_38 ( & V_27 ) ;
return V_51 ;
}
static int F_100 ( struct V_2 * V_196 ,
...
struct V_4 * V_32 ;
F_37 ( & V_27 ) ;
V_32 = F_31 ( V_196 -> V_4 -> V_28 ) ;
for ( V_145 = 0 ; V_145 < V_55 ; V_145 += V_196 -> V_42 -> V_144 )
if ( F_172 ( & V_32 -> V_52 , V_107 + V_145 , NULL ) ==
V_172 )
V_197 = 1 ;
F_38 ( & V_27 ) ;
return V_197 ;
}
static int F_174 ( struct V_114 * V_42 , unsigned int V_115 , char * * V_116 )
{
int V_51 ;
struct V_1 * V_198 ;
if ( V_115 != 1 ) {
...
V_51 = F_113 ( V_42 , V_116 [ 0 ] , F_114 ( V_42 -> V_58 ) , & V_198 ) ;
if ( V_51 ) {
V_42 -> error = L_42 ;
return V_51 ;
}
...
static void F_175 ( struct V_114 * V_42 )
{
struct V_1 * V_198 = V_42 -> V_136 ;
F_129 ( V_42 , V_198 ) ;
}
static int F_176 ( struct V_114 * V_42 , struct V_13 * V_13 )
{
struct V_1 * V_198 = V_42 -> V_136 ;
V_13 -> V_165 = V_198 -> V_28 ;
if ( V_13 -> V_168 & V_169 )
return V_147 ;
return ( F_157 ( V_13 ) == V_171 ) ? F_139 ( V_198 , V_13 ) : V_147 ;
}
static void F_177 ( struct V_114 * V_42 )
{
struct V_1 * V_198 = V_42 -> V_136 ;
V_42 -> V_144 = F_167 ( V_198 -> V_28 ) ;
}
static void F_178 ( struct V_114 * V_42 , T_6 type ,
unsigned V_178 , char * V_179 , unsigned V_180 )
{
struct V_1 * V_198 = V_42 -> V_136 ;
switch ( type ) {
...
break;
case V_187 :
snprintf ( V_179 , V_180 , L_43 , V_198 -> V_188 ) ;
break;
}
}
static int F_179 ( struct V_114 * V_42 , struct V_199 * V_200 ,
struct V_201 * V_202 , int V_203 )
{
struct V_1 * V_198 = V_42 -> V_136 ;
struct V_204 * V_205 = F_180 ( V_198 -> V_28 ) ;
if ( ! V_205 -> V_206 )
return V_203 ;
V_200 -> V_165 = V_198 -> V_28 ;
return F_79 ( V_203 , V_205 -> V_206 ( V_205 , V_200 , V_202 ) ) ;
}
static int F_181 ( struct V_114 * V_42 ,
T_7 V_190 , void * V_191 )
{
struct V_1 * V_198 = V_42 -> V_136 ;
return V_190 ( V_42 , V_198 , 0 , V_42 -> V_192 , V_191 ) ;
}
