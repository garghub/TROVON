...
static int F_76 ( struct V_74 * V_74 )
{
struct V_21 * V_22 = F_68 ( V_74 ) ;
...
static unsigned int F_79 ( struct V_74 * V_74 ,
struct V_146 * V_147 )
{
struct V_21 * V_22 = F_68 ( V_74 ) ;
struct V_12 * V_13 = V_74 -> V_142 ;
unsigned int V_148 ;
F_8 ( & V_22 -> V_27 ) ;
V_148 = F_80 ( V_74 , V_13 -> V_26 , V_147 ) ;
F_10 ( & V_22 -> V_27 ) ;
return V_148 ;
}
static int F_81 ( struct V_74 * V_74 , struct V_149 * V_150 )
{
struct V_21 * V_22 = F_68 ( V_74 ) ;
struct V_12 * V_13 = V_74 -> V_142 ;
int V_112 ;
if ( F_70 ( & V_22 -> V_27 ) )
return - V_143 ;
V_112 = F_82 ( V_74 , V_13 -> V_26 , V_150 ) ;
F_10 ( & V_22 -> V_27 ) ;
return V_112 ;
}
...
int V_59 ;
int V_112 ;
V_22 = F_84 ( & V_152 -> V_23 , sizeof( * V_22 ) , V_140 ) ;
if ( ! V_22 )
return - V_141 ;
F_85 ( & V_22 -> V_72 ) ;
V_22 -> V_144 = F_86 ( & V_152 -> V_23 , L_23 ) ;
if ( F_73 ( V_22 -> V_144 ) ) {
return F_74 ( V_22 -> V_144 ) ;
}
V_22 -> V_145 = F_86 ( & V_152 -> V_23 , L_24 ) ;
if ( F_73 ( V_22 -> V_145 ) )
return F_74 ( V_22 -> V_145 ) ;
V_59 = F_87 ( V_152 , 0 ) ;
V_156 = F_88 ( V_152 , V_157 , 0 ) ;
if ( V_59 < 0 || V_156 == NULL ) {
F_89 ( & V_152 -> V_23 , L_25 ) ;
return - V_158 ;
}
V_112 = F_90 ( & V_152 -> V_23 , & V_22 -> V_51 ) ;
if ( V_112 )
return V_112 ;
F_91 ( & V_22 -> V_27 ) ;
V_154 = F_92 () ;
...
* V_154 = V_160 ;
V_154 -> V_161 = & V_22 -> V_27 ;
F_93 ( V_154 , V_22 ) ;
snprintf ( V_154 -> V_91 , sizeof( V_154 -> V_91 ) , L_27 , V_160 . V_91 ) ;
V_22 -> V_154 = V_154 ;
F_94 ( & V_22 -> V_51 , V_162
L_28 , V_154 -> V_87 ) ;
F_95 ( V_152 , V_22 ) ;
V_22 -> V_28 = F_96 ( & V_152 -> V_23 , V_156 ) ;
if ( F_73 ( V_22 -> V_28 ) ) {
V_112 = F_74 ( V_22 -> V_28 ) ;
goto V_163;
}
V_22 -> V_59 = V_59 ;
V_22 -> V_156 = V_156 ;
if ( F_97 ( & V_152 -> V_23 , V_22 -> V_59 , F_21 ,
0 , V_78 , V_22 ) < 0 ) {
V_112 = - V_158 ;
goto V_163;
}
V_22 -> V_126 = F_98 ( & V_152 -> V_23 ) ;
if ( F_73 ( V_22 -> V_126 ) ) {
F_17 ( & V_22 -> V_51 , L_29 ) ;
V_112 = F_74 ( V_22 -> V_126 ) ;
goto V_163;
}
V_22 -> V_25 = F_99 ( & V_164 ) ;
if ( F_73 ( V_22 -> V_25 ) ) {
F_17 ( & V_22 -> V_51 , L_30 ) ;
V_112 = F_74 ( V_22 -> V_25 ) ;
goto V_165;
}
V_112 = F_100 ( V_154 , V_166 , 0 ) ;
if ( V_112 ) {
F_17 ( & V_22 -> V_51 , L_31 ) ;
goto V_167;
}
...
{
struct V_21 * V_22 = F_106 ( V_152 ) ;
F_94 ( & V_22 -> V_51 , L_32 V_162 ) ;
F_107 ( V_22 -> V_154 ) ;
F_101 ( V_22 -> V_25 ) ;
F_102 ( V_22 -> V_126 ) ;
F_104 ( & V_22 -> V_51 ) ;
