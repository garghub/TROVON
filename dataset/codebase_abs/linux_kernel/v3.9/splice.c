...
V_24 = F_86 ( V_95 -> V_96 . V_54 , V_124 + V_4 -> V_37 , V_95 -> V_39 , & V_125 ) ;
...
{
T_1 V_24 ;
V_24 = F_75 ( V_2 , V_107 , V_56 , V_39 , V_10 , F_85 ) ;
if ( V_24 > 0 )
* V_56 += V_24 ;
return V_24 ;
}
T_1 F_88 ( struct V_1 * V_2 , struct V_54 * V_107 ,
T_2 * V_56 , T_3 V_39 , unsigned int V_10 )
{
return F_75 ( V_2 , V_107 , V_56 , V_39 , V_10 , F_61 ) ;
}
static long F_89 ( struct V_1 * V_2 , struct V_54 * V_107 ,
T_2 * V_56 , T_3 V_39 , unsigned int V_10 )
{
T_1 (* F_90)( struct V_1 * , struct V_54 * ,
...
return - V_100 ;
V_24 = F_91 ( V_131 , V_107 , V_56 , V_39 ) ;
if ( F_41 ( V_24 < 0 ) )
return V_24 ;
if ( V_107 -> V_98 && V_107 -> V_98 -> F_90 )
F_90 = V_107 -> V_98 -> F_90 ;
else
F_90 = F_87 ;
return F_90 ( V_2 , V_107 , V_56 , V_39 , V_10 ) ;
}
...
return - V_128 ;
V_24 = F_91 ( V_133 , V_55 , V_56 , V_39 ) ;
if ( F_41 ( V_24 < 0 ) )
return V_24 ;
...
{
struct V_54 * V_54 = V_95 -> V_96 . V_54 ;
return F_89 ( V_2 , V_54 , & V_54 -> V_140 , V_95 -> V_103 ,
V_95 -> V_10 ) ;
}
...
V_145 = & V_107 -> V_140 ;
V_24 = F_89 ( V_143 , V_107 , V_145 , V_39 , V_10 ) ;
if ( V_142 && F_105 ( V_142 , V_145 , sizeof( T_2 ) ) )
V_24 = - V_148 ;
return V_24 ;
}
if ( V_144 ) {
...
V_145 = & V_55 -> V_140 ;
V_24 = F_92 ( V_55 , V_145 , V_144 , V_39 , V_10 ) ;
if ( V_141 && F_105 ( V_141 , V_145 , sizeof( T_2 ) ) )
V_24 = - V_148 ;
return V_24 ;
}
return - V_100 ;
...
int V_49 ;
error = - V_148 ;
if ( F_104 ( & V_155 , V_150 , sizeof( V_155 ) ) )
break;
V_156 = V_155 . V_92 ;
V_39 = V_155 . V_93 ;
error = 0 ;
...
if ( V_154 > V_153 - V_32 )
V_154 = V_153 - V_32 ;
error = F_108 ( ( unsigned long ) V_156 , V_154 ,
0 , & V_36 [ V_32 ] ) ;
if ( F_41 ( error <= 0 ) )
break;
...
char * V_108 ;
int V_24 ;
if ( ! F_110 ( V_95 -> V_96 . V_161 , V_95 -> V_39 ) ) {
V_108 = V_4 -> V_41 -> V_109 ( V_2 , V_4 , 1 ) ;
V_24 = F_111 ( V_95 -> V_96 . V_161 , V_108 + V_4 -> V_37 ,
V_95 -> V_39 ) ;
V_4 -> V_41 -> V_111 ( V_2 , V_4 , V_108 ) ;
if ( ! V_24 ) {
V_24 = V_95 -> V_39 ;
...
V_24 = V_95 -> V_39 ;
if ( F_105 ( V_95 -> V_96 . V_161 , V_108 + V_4 -> V_37 , V_95 -> V_39 ) )
V_24 = - V_148 ;
V_4 -> V_41 -> V_111 ( V_2 , V_4 , V_108 ) ;
V_107:
if ( V_24 > 0 )
V_95 -> V_96 . V_161 += V_24 ;
return V_24 ;
}
...
if ( F_41 ( ! F_107 ( V_164 , V_156 , V_39 ) ) ) {
error = - V_148 ;
break;
}
V_95 . V_39 = 0 ;
V_95 . V_103 = V_39 ;
V_95 . V_10 = V_10 ;
V_95 . V_96 . V_161 = V_156 ;
V_95 . V_82 = 0 ;
V_163 = F_74 ( V_2 , & V_95 , F_109 ) ;
if ( V_163 < 0 ) {
if ( ! V_24 )
V_24 = V_163 ;
break;
...
if ( F_29 ( V_2 , & V_21 ) )
return - V_53 ;
V_21 . V_23 = F_106 ( V_150 , V_162 , V_21 . V_36 ,
V_21 . V_38 , false ,
V_21 . V_50 ) ;
if ( V_21 . V_23 <= 0 )
V_24 = V_21 . V_23 ;
