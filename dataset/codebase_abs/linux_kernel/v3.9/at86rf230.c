...
static int F_48 ( struct V_80 * V_16 )
{
struct V_1 * V_2 = F_49 ( V_16 ) ;
struct V_81 * V_82 = V_16 -> V_17 . V_83 ;
if ( ! V_82 ) {
F_47 ( & V_16 -> V_17 , L_11 ) ;
return - V_48 ;
}
...
if ( V_33 )
goto V_96;
V_33 = F_57 ( V_2 -> V_84 , L_13 ) ;
if ( V_33 )
goto V_97;
if ( F_58 ( V_2 -> V_85 ) ) {
V_33 = F_57 ( V_2 -> V_85 , L_14 ) ;
if ( V_33 )
goto V_98;
}
V_33 = F_59 ( V_2 -> V_84 , 1 ) ;
if ( V_33 )
goto V_99;
if ( F_58 ( V_2 -> V_85 ) ) {
V_33 = F_59 ( V_2 -> V_85 , 0 ) ;
if ( V_33 )
goto V_99;
}
F_22 ( 1 ) ;
...
F_60 ( V_2 -> V_84 , 1 ) ;
F_22 ( 1 ) ;
V_33 = F_7 ( V_2 , V_100 , & V_87 ) ;
if ( V_33 )
goto V_99;
V_33 = F_7 ( V_2 , V_101 , & V_88 ) ;
if ( V_33 )
goto V_99;
if ( V_88 != 0x00 || V_87 != 0x1f ) {
F_47 ( & V_16 -> V_17 , L_15 ,
V_88 , V_87 ) ;
V_33 = - V_48 ;
goto V_99;
}
V_33 = F_7 ( V_2 , V_102 , & V_2 -> V_103 ) ;
if ( V_33 )
goto V_99;
V_33 = F_7 ( V_2 , V_104 , & V_2 -> V_105 ) ;
if ( V_33 )
goto V_99;
switch ( V_2 -> V_103 ) {
case 2 :
...
F_46 ( & V_16 -> V_17 , L_19 , V_89 , V_2 -> V_105 ) ;
if ( ! V_90 ) {
V_33 = - V_106 ;
goto V_99;
}
...
if ( V_33 )
goto V_99;
V_33 = F_61 ( V_16 -> V_72 , F_42 , V_107 ,
F_62 ( & V_16 -> V_17 ) , V_2 ) ;
if ( V_33 )
goto V_99;
V_33 = F_63 ( V_2 -> V_17 ) ;
...
static int F_70 ( struct V_80 * V_16 )
{
struct V_1 * V_2 = F_49 ( V_16 ) ;
F_64 ( V_2 -> V_17 ) ;
F_65 ( V_16 -> V_72 , V_2 ) ;
