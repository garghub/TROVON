...
L_25 ,
V_40 . log [ V_1 -> V_44 ] . V_32 ,
V_40 . log [ V_1 -> V_44 ] . V_52 ,
V_40 . log [ V_1 -> V_44 ] . V_34 ,
V_40 . log [ V_1 -> V_44 ] . V_35 . V_53 [ 0 ] ,
V_40 . log [ V_1 -> V_44 ] . V_35 . V_53 [ 1 ] ) ;
break;
case V_54 :
snprintf ( V_28 , sizeof( V_28 ) ,
L_26 ,
...
return - V_72 ;
#endif
V_1 = F_29 ( sizeof( * V_1 ) , V_73 ) ;
F_3 ( V_1 == NULL , - V_10 , V_74 , L_39 ) ;
V_1 -> V_36 = V_36 ;
V_1 -> V_75 = 0 ;
V_1 -> V_76 . V_77 = V_1 ;
V_1 -> V_76 . V_78 = & V_79 ;
...
static int
F_32 ( struct V_68 * V_68 ,
struct V_36 * V_36 )
{
T_2 * V_1 = V_36 -> V_88 ;
F_2 ( V_70 , L_42 ,
V_36 , V_1 ) ;
F_3 ( V_1 == NULL , 0 , V_74 , L_43 ) ;
V_36 -> V_88 = NULL ;
F_33 ( V_1 ) ;
if( V_1 -> V_75 )
{
...
V_36 , V_1 ) ;
V_23 = V_64 | V_65 ;
F_3 ( V_1 == NULL , V_23 , V_74 , L_43 ) ;
if( ! V_1 -> V_75 )
V_23 |= F_24 ( V_1 , V_36 , V_37 ) ;
F_19 ( V_70 , L_37 , V_23 ) ;
return V_23 ;
}
static long
...
if ( F_42 ( & V_1 -> V_87 ) )
return - V_100 ;
if( V_1 -> V_75 && ! F_46 ( F_47 ( & V_1 -> V_76 ) ,
( int T_3 * ) V_94 ) )
V_69 = 0 ;
F_45 ( & V_1 -> V_87 ) ;
break;
...
if ( F_42 ( & V_1 -> V_87 ) )
return - V_100 ;
if( V_1 -> V_75 && ! F_46 ( F_48 ( & V_1 -> V_76 ) ,
( int T_3 * ) V_94 ) )
V_69 = 0 ;
F_45 ( & V_1 -> V_87 ) ;
break;
...
V_69 = 0 ;
#else
if( F_52 ( (struct V_114 T_3 * ) V_94 , & V_1 -> V_114 ) )
V_69 = 0 ;
#endif
F_45 ( & V_1 -> V_87 ) ;
break;
...
V_69 = 0 ;
#else
if( ! F_54 ( & V_1 -> V_114 , (struct V_114 T_3 * ) V_94 ) )
V_69 = 0 ;
#endif
F_45 ( & V_1 -> V_87 ) ;
break;
...
if( ( F_59 ( V_125 ) < ( V_1 -> V_135 + V_129 ) ) ||
( F_60 ( V_125 ) ) )
{
struct V_124 * V_136 ;
F_6 ( V_137 , L_63 ) ;
V_136 = F_61 ( V_125 , V_1 -> V_135 + V_129 ) ;
F_62 ( V_125 ) ;
F_3 ( V_136 == NULL , NULL , V_95 , L_64 ) ;
V_125 = V_136 ;
}
if( V_129 )
{
...
F_2 ( V_130 , L_65 ,
V_76 , V_141 ) ;
F_40 ( V_141 != NULL , 0 , V_95 , L_66 ) ;
if( ! ( F_65 ( 0 , & V_141 -> V_142 ) ) )
{
#ifdef F_66
F_44 ( V_141 ) ;
#endif
...
F_68 ( 0 , V_137 , L_68 ,
F_69 ( & V_141 -> V_146 -> V_147 ) ) ;
V_125 = F_57 ( V_141 , V_125 ) ;
F_3 ( V_125 == NULL , 1 , V_95 , L_69 ) ;
V_39 = F_70 ( V_141 -> V_146 , V_125 ) ;
if( V_39 < 0 )
{
F_5 ( V_95 , L_70 , V_39 ) ;
}
...
break;
case V_105 :
if( F_46 ( V_1 -> V_85 [ 0 ] , ( T_9 T_3 * ) V_94 ) )
break;
V_69 = 0 ;
break;
case V_106 :
if( F_41 ( V_1 -> V_85 [ 0 ] , ( T_9 T_3 * ) V_94 ) )
break;
V_69 = 0 ;
break;
case V_107 :
if( F_46 ( V_1 -> V_86 , ( T_9 T_3 * ) V_94 ) )
break;
V_69 = 0 ;
break;
case V_108 :
if( F_41 ( V_1 -> V_86 , ( T_9 T_3 * ) V_94 ) )
break;
V_69 = 0 ;
break;
case V_109 :
if( F_18 ( V_94 , V_1 -> V_85 , sizeof( V_1 -> V_85 ) ) )
break;
V_69 = 0 ;
break;
case V_110 :
