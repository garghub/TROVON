...
V_33 = F_74 ( V_8 -> V_22 . V_143 , F_46 , V_164 ,
V_8 -> V_161 , V_8 ) ;
if ( V_33 )
return V_33 ;
V_33 = F_74 ( V_8 -> V_22 . V_144 , F_49 , V_164 ,
V_8 -> V_163 , V_8 ) ;
if ( V_33 ) {
F_71 ( V_8 -> V_22 . V_143 , V_8 ) ;
return V_33 ;
...
static int F_79 ( struct V_7 * V_8 , const void * V_168 , unsigned int V_26 )
{
struct V_15 * V_17 ;
unsigned long V_16 ;
int V_33 ;
...
if ( ! V_17 )
return - V_170 ;
memcpy ( V_17 , V_168 , V_26 ) ;
V_33 = F_16 ( V_8 , V_17 , V_16 ) ;
if ( ! V_33 )
V_33 = V_26 ;
return V_33 ;
}
static int F_80 ( struct V_7 * V_8 , void * V_168 , unsigned int V_26 )
{
struct V_15 * V_17 ;
...
static int F_81 ( struct V_7 * V_8 , const void * V_168 ,
unsigned int V_26 )
{
...
static int F_85 ( struct V_7 * V_8 , unsigned long V_182 )
{
unsigned long V_183 ;
int V_27 = 1000 ;
F_3 ( V_180 , L_37 ,
V_182 , V_8 -> V_74 , V_8 -> V_75 ) ;
while ( V_27 -- > 0 ) {
unsigned long V_70 ;
V_70 = F_31 ( V_8 -> V_34 ,
& V_183 ,
...
static int F_89 ( struct V_7 * V_8 , void * V_168 , unsigned int V_26 )
{
struct V_15 * V_181 ;
unsigned long V_70 , V_102 ;
int V_33 , V_173 ;
...
V_184 = V_17 -> V_60 & V_177 ;
if ( ( V_181 == NULL && ! ( V_17 -> V_60 & V_178 ) ) ||
( V_181 != NULL && ( V_17 -> V_60 & V_178 ) ) ) {
if ( ! V_181 )
V_102 = F_5 ( V_8 , V_102 ) ;
V_33 = F_86 ( V_8 , V_102 ) ;
if ( V_33 )
...
memcpy ( V_168 ,
( V_8 -> V_22 . V_23 == V_140 ?
V_17 -> V_44 . V_45 : V_17 -> V_44 . V_66 . V_175 ) , V_184 ) ;
V_168 += V_184 ;
V_173 += V_184 ;
if ( V_17 -> V_60 & V_179 )
break;
...
static int F_90 ( struct V_7 * V_8 , const void * V_168 ,
unsigned int V_26 )
{
if ( V_26 > V_8 -> V_22 . V_148 )
V_26 = V_8 -> V_22 . V_148 ;
return F_81 ( V_8 , V_168 , V_26 ) ;
}
static int F_91 ( struct V_7 * V_8 , void * V_168 , unsigned int V_26 )
{
if ( ! V_8 -> V_186 ) {
...
if ( V_26 > V_8 -> V_186 )
V_26 = V_8 -> V_186 ;
memcpy ( V_168 , V_8 -> V_135 + V_8 -> V_187 , V_26 ) ;
V_8 -> V_187 += V_26 ;
V_8 -> V_186 -= V_26 ;
return V_26 ;
}
int F_92 ( struct V_7 * V_8 , const void * V_168 , unsigned int V_26 )
{
unsigned long V_54 ;
int V_33 ;
if ( ! V_168 )
...
V_33 = V_8 -> V_132 -> V_189 ( V_8 , V_168 , V_26 ) ;
F_48 ( & V_8 -> V_96 , V_54 ) ;
return V_33 ;
}
int F_93 ( struct V_7 * V_8 , void * V_168 , unsigned int V_26 )
{
unsigned long V_54 ;
int V_33 ;
if ( ! V_168 )
...
V_33 = V_8 -> V_132 -> V_190 ( V_8 , V_168 , V_26 ) ;
F_48 ( & V_8 -> V_96 , V_54 ) ;
return V_33 ;
}
static long F_94 ( struct V_119 * V_120 , unsigned long V_191 )
{
struct V_192 * V_124 = & V_120 -> V_124 ;
unsigned long V_193 , V_194 , V_195 , V_27 ;
int V_196 ;
V_27 = V_124 -> V_27 ;
V_194 = V_124 -> V_197 ;
V_196 = 0 ;
V_198:
V_193 = F_95 ( V_124 -> V_125 , V_27 , V_194 , V_191 , 0 ) ;
V_195 = V_193 + V_191 ;
if ( F_82 ( V_195 >= V_27 ) ) {
if ( F_88 ( V_196 < 1 ) ) {
V_27 = V_194 ;
...
static T_5 F_98 ( T_5 V_199 , T_5 V_200 , T_5 V_201 )
{
return ( ( V_200 << V_202 ) |
( V_199 << V_203 ) |
V_201 ) ;
}
static T_5 F_99 ( T_5 V_204 , unsigned long * V_205 )
{
T_5 V_206 = V_204 >> V_202 ;
V_204 &= ~ V_207 ;
* V_205 = V_206 * 3 ;
return ( V_204 >> ( 13ULL + ( V_206 * 3ULL ) ) ) ;
}
static struct V_121 * F_100 ( struct V_119 * V_120 ,
unsigned long V_191 )
{
long V_208 ;
V_208 = F_94 ( V_120 , V_191 ) ;
if ( F_82 ( V_208 < 0 ) )
return NULL ;
return V_120 -> V_127 + V_208 ;
}
static T_5 F_101 ( unsigned int V_209 )
{
T_5 V_210 ;
V_210 = F_97 () ;
if ( V_209 & V_211 ) {
...
static int F_102 ( unsigned long V_109 , long V_224 )
{
int V_225 = 0 ;
do {
unsigned long V_102 = ( V_109 + V_115 ) & V_226 ;
V_224 -= ( V_102 - V_109 ) ;
V_109 = V_102 ;
V_225 ++ ;
} while ( V_224 > 0 );
...
static void F_103 ( struct V_227 * V_228 , unsigned long V_229 ,
unsigned long V_10 , unsigned long V_224 )
{
do {
unsigned long V_230 , V_102 = V_229 + V_115 ;
T_5 V_231 ;
V_228 -> V_127 [ V_228 -> V_232 ] . V_233 = V_228 -> V_210 | V_229 ;
V_230 = V_115 ;
if ( V_10 )
V_230 = V_115 - V_10 ;
if ( V_230 > V_224 )
V_230 = V_224 ;
V_231 = F_98 ( V_228 -> V_232 ,
F_97 () , V_10 ) ;
V_10 = 0 ;
if ( V_231 == V_228 -> V_234 ) {
V_228 -> V_235 [ V_228 -> V_236 - 1 ] . V_237 += V_230 ;
} else {
V_228 -> V_235 [ V_228 -> V_236 ] . V_238 = V_231 ;
V_228 -> V_235 [ V_228 -> V_236 ] . V_237 = V_230 ;
V_228 -> V_236 ++ ;
}
V_228 -> V_234 = V_231 + V_230 ;
V_228 -> V_232 ++ ;
V_224 -= V_230 ;
V_229 = V_102 ;
} while ( V_224 > 0 );
...
{
unsigned long V_109 = F_105 ( F_106 ( V_240 ) ) << V_203 ;
long V_224 = V_240 -> V_241 ;
if ( ( V_240 -> V_242 | V_224 ) & ( 8UL - 1 ) )
return - V_243 ;
return F_102 ( V_109 + V_240 -> V_242 , V_224 ) ;
}
static int F_107 ( struct V_239 * V_240 , int V_244 )
{
int V_225 ;
int V_78 ;
V_225 = 0 ;
for ( V_78 = 0 ; V_78 < V_244 ; V_78 ++ ) {
int V_33 = F_104 ( V_240 + V_78 ) ;
if ( V_33 < 0 )
return V_33 ;
V_225 += V_33 ;
}
...
struct V_239 * V_240 , int V_244 ,
struct V_245 * V_235 , int V_246 ,
unsigned int V_209 )
{
unsigned long V_78 , V_191 , V_54 ;
struct V_121 * V_109 ;
struct V_227 V_1 ;
struct V_119 * V_120 ;
int V_33 ;
...
V_109 = F_100 ( V_120 , V_191 ) ;
F_48 ( & V_120 -> V_96 , V_54 ) ;
if ( ! V_109 )
return - V_114 ;
V_1 . V_127 = V_120 -> V_127 ;
V_1 . V_235 = V_235 ;
V_1 . V_210 = F_101 ( V_209 ) ;
V_1 . V_234 = ~ ( T_5 ) 0 ;
V_1 . V_232 = ( V_109 - V_120 -> V_127 ) ;
V_1 . V_236 = 0 ;
for ( V_78 = 0 ; V_78 < V_244 ; V_78 ++ )
F_103 ( & V_1 , F_105 ( F_106 ( & V_240 [ V_78 ] ) ) << V_203 ,
V_240 [ V_78 ] . V_242 , V_240 [ V_78 ] . V_241 ) ;
return V_1 . V_236 ;
}
int F_109 ( struct V_7 * V_8 ,
void * V_168 , unsigned int V_224 ,
struct V_245 * V_235 , int V_246 ,
unsigned int V_209 )
{
unsigned long V_191 , V_229 , V_54 ;
struct V_121 * V_109 ;
struct V_227 V_1 ;
struct V_119 * V_120 ;
if ( ( V_209 & ~ V_247 ) || ( V_246 < 1 ) )
return - V_36 ;
V_229 = F_55 ( V_168 ) ;
if ( ( V_229 | V_224 ) & ( 8UL - 1 ) )
return - V_243 ;
V_191 = F_102 ( V_229 , V_224 ) ;
V_120 = & V_8 -> V_120 ;
F_47 ( & V_120 -> V_96 , V_54 ) ;
V_109 = F_100 ( V_120 , V_191 ) ;
F_48 ( & V_120 -> V_96 , V_54 ) ;
...
V_1 . V_232 = ( V_109 - V_120 -> V_127 ) ;
V_1 . V_236 = 0 ;
F_103 ( & V_1 , ( V_229 & V_226 ) , ( V_229 & ~ V_226 ) , V_224 ) ;
F_17 ( V_1 . V_236 != 1 ) ;
return V_1 . V_236 ;
}
...
{
struct V_192 * V_124 = & V_120 -> V_124 ;
unsigned long V_78 , V_205 , V_199 , V_191 ;
struct V_121 * V_109 ;
V_191 = F_111 ( ( ( V_204 & ~ V_226 ) + V_26 ) ) >> V_203 ;
V_199 = F_99 ( V_204 , & V_205 ) ;
V_109 = V_120 -> V_127 + V_199 ;
F_17 ( V_199 > V_124 -> V_27 ||
( V_199 + V_191 ) > V_124 -> V_27 ) ;
for ( V_78 = 0 ; V_78 < V_191 ; V_78 ++ ) {
if ( V_109 -> V_204 )
F_112 ( V_34 , V_204 + ( V_78 << V_205 ) ,
V_109 -> V_204 ) ;
V_109 -> V_233 = 0 ;
F_113 ( V_199 + V_78 , V_124 -> V_125 ) ;
}
}
void F_114 ( struct V_7 * V_8 , struct V_245 * V_235 ,
int V_246 )
{
struct V_119 * V_120 = & V_8 -> V_120 ;
unsigned long V_54 ;
int V_78 ;
F_47 ( & V_120 -> V_96 , V_54 ) ;
for ( V_78 = 0 ; V_78 < V_246 ; V_78 ++ ) {
T_5 V_248 = V_235 [ V_78 ] . V_238 ;
T_5 V_26 = V_235 [ V_78 ] . V_237 ;
F_110 ( V_8 -> V_34 , V_120 , V_248 , V_26 ) ;
}
F_48 ( & V_120 -> V_96 , V_54 ) ;
}
int F_115 ( struct V_7 * V_8 , int V_249 ,
void * V_168 , unsigned int V_224 , unsigned long V_242 ,
struct V_245 * V_235 , int V_246 )
{
unsigned int V_250 ;
unsigned long V_110 ;
...
V_250 = V_224 ;
for ( V_78 = 0 ; V_78 < V_246 ; V_78 ++ ) {
unsigned long V_253 = V_235 [ V_78 ] . V_238 ;
unsigned long V_254 = V_235 [ V_78 ] . V_237 ;
unsigned long V_255 ;
if ( F_82 ( V_242 ) ) {
unsigned long V_256 = V_242 ;
if ( V_256 > V_254 )
V_256 = V_254 ;
V_242 -= V_256 ;
V_254 -= V_256 ;
...
void * F_117 ( struct V_7 * V_8 , unsigned int V_224 ,
struct V_245 * V_235 , int * V_246 ,
unsigned int V_209 )
{
void * V_168 ;
...
if ( V_224 & ( 8UL - 1 ) )
return F_69 ( - V_36 ) ;
V_168 = F_60 ( V_224 , V_113 ) ;
if ( ! V_168 )
return F_69 ( - V_114 ) ;
V_33 = F_109 ( V_8 , V_168 , V_224 , V_235 , * V_246 , V_209 ) ;
if ( V_33 < 0 ) {
F_62 ( V_168 ) ;
return F_69 ( V_33 ) ;
}
...
void F_118 ( struct V_7 * V_8 , void * V_168 , unsigned int V_224 ,
struct V_245 * V_235 , int V_246 )
{
F_114 ( V_8 , V_235 , V_246 ) ;
F_62 ( V_168 ) ;
}
...
if ( ! V_258 )
return - V_136 ;
V_259 = F_121 ( V_258 , V_260 , L_49 ) ;
V_33 = - V_136 ;
if ( V_259 == V_260 )
goto V_100;
V_79 = F_122 ( V_258 , V_259 , L_50 , NULL ) ;
if ( ! V_79 )
goto V_100;
V_50 = 1 ;
V_51 = 0 ;
if ( F_123 ( V_261 , V_50 , & V_51 ) ) {
F_28 (KERN_INFO PFX L_51 ) ;
goto V_100;
}
F_28 ( V_262 L_52 , V_263 ) ;
if ( ! * V_79 ) {
