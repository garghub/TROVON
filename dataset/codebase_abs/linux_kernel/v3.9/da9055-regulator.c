...
struct V_46 * V_47 = V_9 -> V_56 -> V_74 ;
int V_7 , V_66 ;
if ( V_47 == NULL || V_47 -> V_75 [ V_72 -> V_48 ] == NULL )
return - V_76 ;
V_4 = F_24 ( & V_72 -> V_56 , sizeof( struct V_3 ) ,
V_77 ) ;
if ( ! V_4 )
return - V_78 ;
...
V_45 . V_80 = V_9 -> V_80 ;
if ( V_47 && V_47 -> V_75 )
V_45 . V_81 = V_47 -> V_75 [ V_72 -> V_48 ] ;
V_7 = F_17 ( V_4 , & V_45 , V_47 , V_72 -> V_48 ) ;
if ( V_7 < 0 )
return V_7 ;
V_4 -> V_2 = F_26 ( & V_4 -> V_6 -> V_70 ,
& V_45 ) ;
if ( F_27 ( V_4 -> V_2 ) ) {
F_25 ( & V_72 -> V_56 , L_3 ,
V_4 -> V_6 -> V_70 . V_50 ) ;
...
if ( V_72 -> V_48 == V_82 || V_72 -> V_48 == V_83 ) {
V_66 = F_29 ( V_72 , L_4 ) ;
V_66 = F_30 ( V_9 -> V_84 , V_66 ) ;
