...
static struct V_2 * F_24 ( struct V_5 * V_5 )
{
struct V_1 * V_1 , * V_34 ;
struct V_5 * V_35 ;
int V_36 ;
V_1 = F_25 ( sizeof( * V_1 ) , V_23 ) ;
if ( ! V_1 )
return F_26 ( - V_26 ) ;
F_27 ( & V_1 -> V_32 ) ;
V_35 = V_5 -> V_37 ;
...
static void F_31 ( char * V_40 , short V_31 )
{
int V_41 = 0 ;
memset ( V_40 , 0 , V_42 ) ;
if ( V_31 & V_43 )
...
static void F_33 ( char * V_49 , unsigned V_50 )
{
if ( V_50 == ~ 0 )
strcpy ( V_49 , L_1 ) ;
else
...
static int F_34 ( struct V_5 * V_5 , struct V_51 * V_52 ,
struct V_53 * V_50 )
{
...
static int F_43 ( struct V_1 * V_62 ,
struct V_18 * V_19 )
{
...
return 1 ;
V_37 = F_3 ( V_63 ) ;
return F_39 ( V_37 , V_19 ) ;
}
static inline int F_44 ( struct V_1 * V_37 )
{
if ( ! V_37 )
return 1 ;
return V_37 -> V_38 == V_39 ;
}
static int F_45 ( struct V_1 * V_54 ,
...
static int F_47 ( struct V_5 * V_74 , struct V_51 * V_52 ,
const char * V_65 )
{
int V_75 ;
F_28 ( & V_22 ) ;
...
static int F_48 ( short type , T_1 V_29 , T_1 V_30 ,
short V_31 )
{
struct V_1 * V_1 ;
struct V_18 V_19 ;
...
int F_49 ( struct V_77 * V_77 , int V_78 )
{
short type , V_31 = 0 ;
if ( F_50 ( V_77 -> V_79 ) )
type = V_48 ;
...
if ( V_78 & V_81 )
V_31 |= V_43 ;
return F_48 ( type , F_52 ( V_77 ) , F_53 ( V_77 ) ,
V_31 ) ;
}
int F_54 ( int V_82 , T_2 V_83 )
{
short type ;
if ( ! F_50 ( V_82 ) && ! F_51 ( V_82 ) )
return 0 ;
if ( F_50 ( V_82 ) )
type = V_48 ;
else
type = V_47 ;
return F_48 ( type , F_55 ( V_83 ) , F_56 ( V_83 ) ,
V_45 ) ;
}
