...
{
struct V_106 * V_6 = V_105 -> V_56 . V_107 ;
struct V_23 * V_24 = F_69 ( V_105 ) ;
struct V_1 * V_2 = F_30 ( V_24 ) ;
const char * V_108 = F_70 ( V_24 ) ;
struct V_109 * V_110 ;
int V_111 ;
int V_87 ;
int V_112 ;
if ( V_6 && F_62 ( V_6 -> V_113 ) ) {
memcpy ( V_24 -> V_26 , V_6 -> V_113 , V_101 ) ;
} else {
F_71 ( V_24 ) ;
}
V_110 = F_72 ( V_105 , V_114 , 0 ) ;
if ( ! V_110 )
return - V_115 ;
V_111 = F_73 ( V_110 ) ;
if ( ! F_74 ( & V_105 -> V_56 , V_110 -> V_116 , V_111 , V_108 ) )
return - V_117 ;
V_2 -> V_4 = F_75 ( & V_105 -> V_56 , V_110 -> V_116 , V_111 ) ;
if ( ! V_2 -> V_4 )
return - V_117 ;
F_76 ( & V_2 -> V_8 ) ;
V_2 -> V_30 = V_111 < V_118 ;
if ( V_2 -> V_30 ) {
V_2 -> V_119 = F_5 ;
V_2 -> V_120 = F_9 ;
} else {
...
F_21 ( V_2 ) ;
if ( F_11 ( V_2 , V_121 ) != V_122 )
return - V_123 ;
V_87 = F_77 ( V_105 , 0 ) ;
if ( V_87 < 0 )
return V_87 ;
V_112 = F_78 ( V_87 , F_52 ,
V_124 , V_108 , V_24 ) ;
if ( V_112 < 0 )
return V_112 ;
V_2 -> V_87 = V_87 ;
V_2 -> V_58 = V_6 ? V_6 -> V_58 : - V_125 ;
if ( F_31 ( V_2 -> V_58 ) ) {
char * V_126 = F_79 ( & V_105 -> V_56 , 16 , V_127 ) ;
if ( ! V_126 )
return - V_83 ;
snprintf ( V_126 , 16 , L_7 , V_108 ) ;
V_2 -> V_128 = F_80 ( V_2 -> V_58 ) ;
if ( F_81 ( V_2 -> V_128 , F_55 ,
V_129 | V_130 ,
V_126 , V_2 -> V_24 ) < 0 )
V_2 -> V_58 = - V_125 ;
}
F_82 ( V_24 , L_8 , ( V_131 ) V_110 -> V_116 , V_87 ) ;
return 0 ;
}
...
static int F_92 ( struct V_104 * V_105 )
{
struct V_23 * V_24 = F_69 ( V_105 ) ;
struct V_1 * V_2 = F_30 ( V_24 ) ;
F_21 ( V_2 ) ;
...
static int F_94 ( struct V_143 * V_56 )
{
struct V_104 * V_105 = F_95 ( V_56 ) ;
struct V_23 * V_24 = F_69 ( V_105 ) ;
struct V_1 * V_2 = F_30 ( V_24 ) ;
if ( F_56 ( V_24 ) ) {
F_59 ( V_24 ) ;
...
static int F_97 ( struct V_143 * V_56 )
{
struct V_104 * V_105 = F_95 ( V_56 ) ;
struct V_23 * V_24 = F_69 ( V_105 ) ;
struct V_1 * V_2 = F_30 ( V_24 ) ;
