...
unsigned int F_24 ( struct V_22 * V_78 , unsigned char * V_79 ,
...
static void F_39 ( void * V_1 , bool V_100 )
{
...
static int T_7 F_45 ( struct V_113 * V_114 )
{
struct V_105 * V_106 = V_114 -> V_78 . V_115 ;
struct V_70 * V_78 = & V_114 -> V_78 ;
struct V_9 * V_10 ;
struct V_116 * V_117 ;
struct V_20 * V_21 ;
struct V_39 * V_24 ;
enum V_118 V_107 ;
int V_119 ;
V_107 = F_46 ( V_114 ) -> V_120 ;
V_10 = F_47 ( V_78 , sizeof( * V_10 ) , V_121 ) ;
if ( ! V_10 ) {
F_27 ( V_78 , L_3 ) ;
return - V_122 ;
}
V_10 -> V_102 = F_48 ( V_114 , 0 ) ;
V_117 = F_49 ( V_114 , V_123 , 0 ) ;
if ( V_117 == NULL ) {
F_27 ( V_78 , L_4 ) ;
return - V_124 ;
}
if ( ! F_50 ( V_78 , V_117 -> V_125 ,
F_51 ( V_117 ) , V_126 ) ) {
F_27 ( V_78 , L_5 ) ;
return - V_38 ;
}
V_10 -> V_29 = F_52 ( V_78 , V_117 -> V_125 , F_51 ( V_117 ) ) ;
if ( ! V_10 -> V_29 ) {
F_27 ( V_78 , L_6 ) ;
return - V_122 ;
}
V_10 -> V_31 = F_53 ( & V_114 -> V_78 , L_7 ) ;
if ( F_54 ( V_10 -> V_31 ) ) {
F_27 ( V_78 , L_8 ) ;
V_119 = F_55 ( V_10 -> V_31 ) ;
V_10 -> V_31 = NULL ;
return V_119 ;
}
F_56 ( V_10 -> V_31 ) ;
...
V_21 -> V_46 . V_135 = V_10 -> V_29 + V_136 ;
V_21 -> V_46 . V_83 = V_10 -> V_29 + V_137 ;
V_21 -> V_46 . V_72 = V_10 -> V_29 + V_138 ;
V_21 -> V_46 . V_55 = V_10 -> V_29 + V_138 ;
V_21 -> V_46 . V_57 = V_10 -> V_29 + V_139 ;
V_21 -> V_46 . V_59 = V_10 -> V_29 + V_140 ;
V_21 -> V_46 . V_61 = V_10 -> V_29 + V_141 ;
V_21 -> V_46 . V_63 = V_10 -> V_29 + V_142 ;
V_21 -> V_46 . V_71 = V_10 -> V_29 + V_143 ;
V_21 -> V_46 . V_76 = V_10 -> V_29 + V_144 ;
V_21 -> V_46 . V_75 = V_10 -> V_29 + V_144 ;
V_21 -> V_46 . V_77 = V_10 -> V_29 + V_145 ;
V_21 -> V_46 . V_52 = V_10 -> V_29 + V_145 ;
F_58 ( V_21 , L_11 ,
( unsigned long long ) V_117 -> V_125 ) ;
V_24 -> V_25 = V_10 ;
if ( V_106 && V_106 -> V_146 )
V_106 -> V_146 () ;
F_42 ( V_10 , V_106 ) ;
F_59 ( V_114 , V_24 ) ;
return F_60 ( V_24 , V_10 -> V_102 ,
...
static int T_8 F_62 ( struct V_113 * V_114 )
{
struct V_39 * V_24 = F_63 ( V_114 ) ;
struct V_9 * V_10 = V_24 -> V_25 ;
F_64 ( V_24 ) ;
F_61 ( V_10 -> V_31 ) ;
return 0 ;
}
static int F_65 ( struct V_70 * V_78 )
{
struct V_113 * V_114 = F_66 ( V_78 ) ;
struct V_39 * V_24 = F_63 ( V_114 ) ;
return F_67 ( V_24 , V_148 ) ;
}
static int F_68 ( struct V_70 * V_78 )
{
struct V_113 * V_114 = F_66 ( V_78 ) ;
struct V_39 * V_24 = F_63 ( V_114 ) ;
struct V_105 * V_106 = V_114 -> V_78 . V_115 ;
