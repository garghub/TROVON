...
static void F_41 ( struct V_8 * V_57 ,
struct V_49 * V_89 )
{
struct V_85 * V_63 = V_89 -> V_63 ;
if ( V_89 -> V_11 -> V_111 < 1 )
return;
...
break;
case V_113 :
F_42 ( V_114 , V_63 -> V_115 ) ;
F_42 ( V_116 , V_63 -> V_115 ) ;
F_42 ( V_117 , V_63 -> V_115 ) ;
F_43 ( V_105 , V_63 -> V_115 ) ;
V_63 -> V_112 = ( V_89 -> V_11 -> V_17 [ 0 ] -> V_56 ) ?
L_5 :
L_6 ;
break;
}
}
static int F_44 ( struct V_8 * V_9 , const struct V_118 * V_101 )
{
int V_21 ;
struct V_35 * V_36 ;
struct V_10 * V_11 ;
