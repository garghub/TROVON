...
static int F_14 ( struct V_24 * V_24 , struct V_17 * V_25 )
{
return F_10 ( V_25 , F_12 ,
F_11 ( V_25 ) -> V_26 ) ;
}
void F_15 ( struct V_4 * V_5 )
{
V_5 -> V_27 = F_16 ( F_17 ( & V_5 -> V_28 -> V_29 ) ,
V_30 ) ;
if ( F_18 ( V_5 -> V_27 ) )
V_5 -> V_27 = NULL ;
V_5 -> V_31 = F_19 ( L_7 ,
...
int T_6 F_22 ( void )
{
V_38 = F_23 ( L_9 , 16 , 1 , 16 * sizeof( long ) ) ;
if ( ! V_38 )
return - V_39 ;
F_24 ( V_38 , & V_40 ) ;
F_25 ( V_38 , 3 ) ;
F_26 ( L_10 ) ;
V_41 = F_23 ( L_11 , 2 , 1 , 16 ) ;
if ( ! V_41 )
return - V_39 ;
F_24 ( V_41 , & V_42 ) ;
F_25 ( V_41 , 6 ) ;
