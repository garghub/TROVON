...
static void F_73 ( struct V_1 * V_76 , unsigned long * V_52 )
{
struct V_1 * V_89 ;
unsigned long V_32 ;
if ( ! V_52 )
...
int T_3 F_77 ( struct V_90 * V_90 , unsigned long V_20 ,
int V_32 )
{
unsigned long V_3 = F_22 ( V_20 ) ;
struct V_43 * V_44 = V_90 -> V_91 ;
struct V_5 * V_15 ;
struct V_1 * V_76 ;
unsigned long * V_52 ;
unsigned long V_92 ;
int V_12 ;
V_12 = F_11 ( V_3 , V_44 -> V_93 ) ;
if ( V_12 < 0 && V_12 != - V_13 )
return V_12 ;
V_76 = F_57 ( V_3 , V_44 -> V_93 , V_32 ) ;
if ( ! V_76 )
return - V_14 ;
V_52 = F_33 () ;
if ( ! V_52 ) {
...
static void F_81 ( struct V_1 * V_76 , int V_32 )
{
int V_83 ;
if ( ! V_76 )
return;
...
static inline void F_81 ( struct V_1 * V_76 , int V_32 )
{
}
void F_85 ( struct V_90 * V_90 , struct V_5 * V_15 )
{
struct V_1 * V_76 = NULL ;
unsigned long * V_52 = NULL , V_92 ;
struct V_43 * V_44 = V_90 -> V_91 ;
F_78 ( V_44 , & V_92 ) ;
if ( V_15 -> V_19 ) {
V_52 = V_15 -> V_40 ;
