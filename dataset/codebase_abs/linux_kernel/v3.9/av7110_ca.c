...
T_9 V_63 ;
V_63 . V_64 = 2 ;
V_63 . V_65 = ( F_33 ( V_1 -> V_66 ) ?
V_67 : V_68 ) | V_69 ;
V_63 . V_70 = 16 ;
V_63 . V_71 = V_72 ;
memcpy ( V_57 , & V_63 , sizeof( V_63 ) ) ;
break;
}
case V_73 :
{
T_3 * V_74 = ( T_3 * ) V_57 ;
if ( V_74 -> V_75 < 0 || V_74 -> V_75 > 1 ) {
F_34 ( & V_1 -> V_60 ) ;
return - V_34 ;
}
V_1 -> V_5 [ V_74 -> V_75 ] . V_75 = V_74 -> V_75 ;
V_1 -> V_5 [ V_74 -> V_75 ] . type = F_33 ( V_1 -> V_66 ) ?
V_67 : V_68 ;
memcpy ( V_74 , & V_1 -> V_5 [ V_74 -> V_75 ] , sizeof( T_3 ) ) ;
break;
}
case V_76 :
break;
...
V_74 . V_75 = 16 ;
V_74 . type = V_72 ;
memcpy ( V_57 , & V_74 , sizeof ( V_74 ) ) ;
break;
}
case V_79 :
{
T_11 * V_80 = ( T_11 * ) V_57 ;
if ( V_80 -> V_81 >= 16 || V_80 -> V_82 > 1 ) {
F_34 ( & V_1 -> V_60 ) ;
return - V_34 ;
}
F_35 ( V_1 , V_83 , V_84 , 5 ,
( V_80 -> V_81 << 8 ) | V_80 -> V_82 ,
( V_80 -> V_85 [ 0 ] << 8 ) | V_80 -> V_85 [ 1 ] ,
( V_80 -> V_85 [ 2 ] << 8 ) | V_80 -> V_85 [ 3 ] ,
( V_80 -> V_85 [ 4 ] << 8 ) | V_80 -> V_85 [ 5 ] ,
( V_80 -> V_85 [ 6 ] << 8 ) | V_80 -> V_85 [ 7 ] ) ;
break;
}
default:
V_59 = - V_34 ;
...
static T_4 F_36 ( struct V_19 * V_19 , const char T_5 * V_25 ,
T_6 V_26 , T_7 * V_27 )
{
struct V_41 * V_42 = V_19 -> V_43 ;
struct V_1 * V_1 = V_42 -> V_44 ;
...
static T_4 F_37 ( struct V_19 * V_19 , char T_5 * V_25 ,
T_6 V_26 , T_7 * V_27 )
{
struct V_41 * V_42 = V_19 -> V_43 ;
struct V_1 * V_1 = V_42 -> V_44 ;
