...
if ( F_55 ( V_115 ) )
return F_56 ( V_115 ) ;
V_63 = F_46 ( V_65 , & V_115 -> V_48 , V_115 , V_117 ) ;
F_57 ( V_115 ) ;
F_58 ( V_115 ) ;
return V_63 ;
}
...
if ( F_27 ( V_2 ) )
V_118 = F_63 ( V_132 , V_129 -> V_135 . V_54 ,
F_59 ( V_124 ) ) ;
if ( V_118 == - V_130 ) {
V_131 = F_64 ( V_129 ) ;
if ( F_55 ( V_131 ) )
...
struct V_63 * V_63 ;
F_10 ( V_109 , L_10 , V_129 -> V_135 . V_54 ) ;
V_79 = 0 ;
V_137 = NULL ;
V_123 = NULL ;
...
V_79 = F_71 ( V_137 , V_54 , V_136 , V_3 , V_28 ) ;
if ( V_79 < 0 ) {
F_10 ( V_109 , L_12 , V_79 ) ;
goto error;
}
if ( ! ( V_136 & V_138 ) ) {
V_123 = F_70 ( V_132 , 1 , & V_54 , 1 ) ;
if ( F_55 ( V_123 ) ) {
V_79 = F_62 ( V_123 ) ;
F_10 ( V_109 ,
L_11 , V_79 ) ;
...
if ( V_2 -> V_95 )
V_63 = F_79 ( V_2 , V_123 , V_128 -> V_139 ) ;
else
V_63 = F_72 ( V_2 , V_123 , V_128 -> V_139 ) ;
if ( F_55 ( V_63 ) ) {
F_41 ( V_123 ) ;
...
static int
F_81 ( struct V_63 * V_128 , struct V_129 * V_129 ,
...
F_86 ( & V_67 -> V_74 ) ;
V_79 = F_87 ( V_145 , V_129 , V_150 , V_146 ) ;
if ( V_79 )
goto error;
V_145 -> V_151 = V_123 ;
#ifdef F_16
if ( V_2 -> V_95 )
F_88 ( V_129 -> V_133 , V_145 ) ;
#endif
* V_146 |= V_152 ;
V_153:
F_89 ( V_4 ) ;
...
int F_90 ( struct V_63 * V_154 , struct V_129 * V_155 )
{
return F_60 ( V_154 , V_155 , 0 ) ;
}
int F_91 ( struct V_63 * V_154 , struct V_129 * V_155 )
{
return F_60 ( V_154 , V_155 , V_126 ) ;
}
int
F_92 ( struct V_63 * V_156 , struct V_129 * V_157 ,
...
if ( F_55 ( V_161 ) )
return F_62 ( V_161 ) ;
V_162 = F_64 ( V_157 -> V_134 ) ;
if ( F_55 ( V_162 ) ) {
V_118 = F_62 ( V_162 ) ;
goto V_164;
}
V_163 = F_64 ( V_159 -> V_134 ) ;
if ( F_55 ( V_163 ) ) {
V_118 = F_62 ( V_163 ) ;
goto V_165;
}
F_93 ( & V_2 -> V_166 ) ;
if ( F_27 ( V_2 ) ) {
V_118 = F_94 ( V_162 , V_157 -> V_135 . V_54 ,
V_163 , V_159 -> V_135 . V_54 ) ;
if ( V_118 == - V_130 )
V_118 = F_95 ( V_161 , V_163 ,
V_159 -> V_135 . V_54 ) ;
if ( V_118 != - V_130 )
goto V_167;
}
...
static int
F_99 ( struct V_170 * V_171 , struct V_129 * V_129 ,
struct V_172 * V_17 )
{
int V_79 ;
struct V_1 * V_2 ;
...
V_79 = - V_173 ;
V_2 = F_100 ( V_129 ) ;
if ( V_2 -> V_95 == V_174 || V_2 -> V_95 == V_175 ) {
F_101 ( V_129 -> V_133 , V_17 ) ;
return 0 ;
}
V_123 = F_61 ( V_129 ) ;
if ( F_55 ( V_123 ) )
...
static int F_102 ( struct V_129 * V_129 , struct V_176 * V_176 )
{
int V_118 ;
struct V_1 * V_2 ;
struct V_122 * V_123 ;
...
V_46 . V_3 = F_1 ( V_2 , V_176 -> V_179 ) ;
if ( V_176 -> V_177 & V_180 )
V_46 . V_52 = V_176 -> V_181 . V_182 ;
if ( V_176 -> V_177 & V_183 )
V_46 . V_51 = V_176 -> V_184 . V_182 ;
if ( V_176 -> V_177 & V_185 )
V_46 . V_53 = V_176 -> V_186 ;
if ( F_3 ( V_2 ) ) {
if ( V_176 -> V_177 & V_187 )
V_46 . V_58 = V_176 -> V_188 ;
if ( V_176 -> V_177 & V_189 )
V_46 . V_60 = V_176 -> V_190 ;
}
if ( F_104 ( V_129 -> V_133 -> V_94 ) )
F_105 ( V_129 -> V_133 -> V_86 ) ;
V_118 = F_96 ( V_123 , & V_46 ) ;
if ( V_118 < 0 )
return V_118 ;
if ( ( V_176 -> V_177 & V_185 ) &&
V_176 -> V_186 != F_106 ( V_129 -> V_133 ) )
F_107 ( V_129 -> V_133 , V_176 -> V_186 ) ;
F_68 ( V_129 -> V_133 ) ;
F_108 ( V_129 -> V_133 , V_176 ) ;
F_109 ( V_129 -> V_133 ) ;
return 0 ;
}
void
...
if ( ( F_104 ( V_63 -> V_94 ) ) || ( F_2 ( V_63 -> V_94 ) ) ) {
...
V_3 |= V_63 -> V_94 & ~ V_18 ;
V_63 -> V_94 = V_3 ;
F_111 ( V_63 , V_17 -> V_53 ) ;
V_63 -> V_80 = ( F_106 ( V_63 ) + 512 - 1 ) >> 9 ;
V_67 -> V_73 &= ~ V_197 ;
}
T_5 F_48 ( struct V_116 * V_48 )
{
...
static int F_112 ( struct V_129 * V_129 , char * V_198 , int V_199 )
{
int V_118 ;
struct V_1 * V_2 ;
struct V_122 * V_123 ;
struct V_16 * V_115 ;
F_10 ( V_109 , L_20 , V_129 -> V_135 . V_54 ) ;
V_118 = - V_173 ;
V_2 = F_100 ( V_129 ) ;
V_123 = F_61 ( V_129 ) ;
if ( F_55 ( V_123 ) )
...
V_118 = F_113 ( strlen ( V_115 -> V_28 ) + 1 , ( V_201 ) V_199 ) ;
...
static void * F_114 ( struct V_129 * V_129 , struct V_202 * V_203 )
{
int V_141 = 0 ;
char * V_204 = F_115 () ;
F_10 ( V_109 , L_22 , V_129 -> V_135 . V_54 ) ;
if ( ! V_204 )
V_204 = F_34 ( - V_112 ) ;
else {
V_141 = F_112 ( V_129 , V_204 , V_205 ) ;
if ( V_141 < 0 ) {
F_116 ( V_204 ) ;
V_204 = F_34 ( V_141 ) ;
} else
V_204 [ F_113 ( V_141 , V_205 - 1 ) ] = 0 ;
}
F_117 ( V_203 , V_204 ) ;
return NULL ;
}
void
F_118 ( struct V_129 * V_129 , struct V_202 * V_203 , void * V_206 )
{
char * V_207 = F_119 ( V_203 ) ;
F_10 ( V_109 , L_23 ,
V_129 -> V_135 . V_54 , F_55 ( V_207 ) ? L_24 : V_207 ) ;
if ( ! F_55 ( V_207 ) )
F_116 ( V_207 ) ;
}
...
static int
F_121 ( struct V_63 * V_128 , struct V_129 * V_129 , const char * V_208 )
{
F_10 ( V_109 , L_26 ,
V_128 -> V_119 , V_129 -> V_135 . V_54 , V_208 ) ;
return F_120 ( V_128 , V_129 , V_21 , V_208 ) ;
}
static int
F_122 ( struct V_129 * V_157 , struct V_63 * V_128 ,
struct V_129 * V_129 )
{
int V_118 ;
char * V_54 ;
...
V_118 = F_120 ( V_128 , V_129 , V_138 , V_54 ) ;
F_116 ( V_54 ) ;
if ( ! V_118 ) {
F_124 ( V_161 , V_157 -> V_133 ) ;
F_68 ( V_128 ) ;
}
V_209:
F_41 ( V_161 ) ;
...
return - V_112 ;
if ( F_6 ( V_3 ) )
sprintf ( V_54 , L_29 , F_126 ( V_19 ) , F_127 ( V_19 ) ) ;
else if ( F_7 ( V_3 ) )
sprintf ( V_54 , L_30 , F_126 ( V_19 ) , F_127 ( V_19 ) ) ;
else if ( F_5 ( V_3 ) )
* V_54 = 0 ;
else if ( F_4 ( V_3 ) )
* V_54 = 0 ;
...
V_136 = F_1 ( V_2 , V_3 ) ;
V_118 = F_120 ( V_128 , V_129 , V_136 , V_54 ) ;
F_116 ( V_54 ) ;
return V_118 ;
}
