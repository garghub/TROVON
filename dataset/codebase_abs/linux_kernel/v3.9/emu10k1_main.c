...
F_34 ( L_23 , V_170 -> V_292 , V_170 -> V_258 , V_2 -> V_290 , V_2 -> V_100 ) ;
...
if ( V_77 >= V_299 )
break;
snprintf ( V_261 -> V_296 , sizeof( V_261 -> V_296 ) , L_30 , V_271 -> V_296 , V_77 ) ;
}
}
