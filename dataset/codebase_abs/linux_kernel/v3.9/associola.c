...
V_150 = F_43 ( V_152 , struct V_149 , V_161 ) ;
F_44 ( V_152 ) ;
F_45 ( V_150 ) ;
}
V_2 -> V_80 . V_102 = 0 ;
...
F_42 (pos, temp, &asoc->peer.transport_addr_list) {
V_267 = F_43 ( V_152 , struct V_149 , V_161 ) ;
...
V_152 = V_152 -> V_181 ;
V_208 = F_43 ( V_152 , struct V_149 , V_161 ) ;
...
F_130 ( V_8 ) ;
F_51 ( & V_162 ) ;
V_300 = F_131 ( & V_163 , V_2 , V_301 , 0 , V_302 ) ;
if ( V_300 >= 0 ) {
V_301 = V_300 + 1 ;
if ( V_301 == V_303 )
V_301 = 1 ;
...
if ( V_308 -> V_245 . V_310 -> V_311 == V_311 ) {
F_138 ( V_308 ) ;
return V_308 ;
}
}
