...
F_68 ( & V_10 -> V_36 , & V_135 ) ;
V_10 -> V_36 . V_136 = V_137 ;
V_12 = F_69 ( & V_10 -> V_36 , V_123 , 1 ) ;
if ( V_12 ) {
ERROR ( V_10 , L_29 ) ;
goto V_134;
}
if ( V_138 )
F_70 ( & V_106 [ 2 ] , V_138 , ( sizeof V_106 ) - 2 ) ;
V_4 = strlen ( V_106 ) ;
V_106 [ 0 ] = ( V_4 >> 8 ) & 0xFF ;
V_106 [ 1 ] = V_4 & 0xFF ;
F_71 ( V_80 ) ;
...
V_10 -> V_80 = V_80 ;
F_44 ( V_10 , L_30 V_150 L_31 , V_151 ) ;
return 0 ;
V_134:
F_58 ( V_109 ) ;
return V_12 ;
...
static int T_9 F_77 ( struct V_94 * V_95 )
{
int V_32 ;
V_32 = F_78 ( V_95 , V_152 ) ;
if ( V_32 < 0 )
return V_32 ;
V_153 . V_154 = V_152 [ V_155 ] . V_110 ;
V_153 . V_156 = V_152 [ V_157 ] . V_110 ;
V_153 . V_158 = V_152 [ V_159 ] . V_110 ;
V_32 = F_79 ( V_95 , & V_143 , F_63 ) ;
if ( V_32 )
return V_32 ;
F_80 ( V_95 , & V_160 ) ;
return V_32 ;
