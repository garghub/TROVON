...
V_107 = true ;
if ( V_266 & V_269 ) {
V_4 -> V_51 . V_54 = V_94 -> V_270 ;
F_14 ( V_2 , V_4 ) ;
}
V_4 -> V_5 . V_177 = F_3 ( V_6 -> V_94 . V_271 ) ;
if ( V_6 -> V_94 . V_272 )
V_4 -> V_5 . V_17 |= V_18 ;
else
V_4 -> V_5 . V_17 &= ~ V_18 ;
...
if ( V_4 -> V_56 . V_57 ) {
V_4 -> V_56 . V_152 = V_94 -> V_276 &
V_277 ;
V_4 -> V_56 . V_278 = ! ! ( V_94 -> V_276 &
V_279 ) ;
F_86 ( V_2 , V_4 , V_94 ) ;
F_53 ( V_2 , & V_2 -> V_223 ) ;
}
F_52 ( V_2 , V_4 ) ;
if ( V_94 -> V_280 && ( V_2 -> V_26 != V_163 ) )
V_4 -> V_5 . V_17 |= V_178 ;
else
V_4 -> V_5 . V_17 &= ~ V_178 ;
if ( V_94 -> V_280 )
