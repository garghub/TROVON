...
if ( V_24 )
goto V_36;
V_24 = F_18 ( & V_7 -> V_39 , V_27 , 1 , 0 , V_34 ) ;
if ( V_24 < 0 )
goto V_40;
V_25 = V_24 ;
F_19 ( & V_27 -> V_41 , & V_5 -> V_42 ) ;
F_4 ( & V_2 -> V_9 ) ;
...
struct V_26 * V_45 ;
F_2 ( & V_2 -> V_9 ) ;
V_45 = F_23 ( & V_7 -> V_39 , V_23 -> V_44 ) ;
if ( V_45 == NULL ) {
F_4 ( & V_2 -> V_9 ) ;
return - V_32 ;
}
F_24 ( & V_7 -> V_39 , V_23 -> V_44 ) ;
F_25 ( & V_45 -> V_41 ) ;
F_20 ( & V_45 -> V_38 ) ;
F_21 ( V_45 ) ;
F_4 ( & V_2 -> V_9 ) ;
...
{
struct V_28 * V_5 = V_22 -> V_29 ;
struct V_26 * V_46 , * V_47 ;
if ( ! ( V_22 -> V_48 -> V_49 && V_22 -> V_49 -> V_50 . V_51 ) )
return;
F_27 ( & V_22 -> V_49 -> V_50 ) ;
F_2 ( & V_2 -> V_9 ) ;
if ( F_28 ( & V_5 -> V_42 ) ) {
