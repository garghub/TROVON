...
static struct V_1 *
F_47 ( struct V_9 * V_10 , T_3 * V_38 ,
struct V_99 * V_100 )
{
struct V_1 * V_2 = NULL ;
if ( V_10 -> V_54 . V_55 . V_121 & V_122 )
F_48 ( V_10 -> V_123 , V_38 ,
V_100 -> V_124 ,
V_100 -> V_125 ,
V_115 ) ;
else
...
static void F_58 ( unsigned long V_128 )
{
struct V_1 * V_2 ;
T_4 V_5 , V_6 , V_7 ;
struct V_9 * V_10 ;
...
{
if ( ! F_63 ( & V_2 -> V_10 -> V_34 ) )
return;
if ( V_2 -> V_10 -> V_54 . V_55 . V_121 != V_142 )
return;
if ( F_64 ( & V_2 -> V_116 ) )
V_2 -> V_131 = true ;
}
...
static inline void F_67 ( struct V_1 * V_2 , int V_143 )
{
V_2 -> V_116 . V_144 = V_105 + ( V_145 * V_143 / 1000 ) ;
V_2 -> V_116 . V_128 = ( unsigned long ) V_2 ;
V_2 -> V_116 . V_146 = F_58 ;
V_2 -> V_136 = V_143 ;
F_66 ( & V_2 -> V_116 ) ;
}
...
V_2 -> V_3 = V_134 ;
F_67 ( V_2 , V_10 -> V_54 . V_55 . V_56 . V_148 ) ;
F_19 ( & V_2 -> V_59 ) ;
F_8 ( V_10 ,
L_7 ,
V_2 -> V_2 . V_38 ) ;
...
if ( V_154 != V_61 &&
( ! V_100 . V_163 || ! V_100 . V_129 ) ) {
F_8 ( V_10 , L_12 ) ;
return;
}
memcpy ( & V_6 , F_73 ( V_100 . V_160 ) , 2 ) ;
if ( V_154 == V_94 ||
( V_154 == V_61 && V_74 == 8 ) )
memcpy ( & V_5 , F_74 ( V_100 . V_160 ) , 2 ) ;
F_5 () ;
V_2 = F_50 ( V_10 , V_70 -> V_89 ) ;
if ( ! V_2 && V_154 != V_96 ) {
F_8 ( V_10 , L_13 ) ;
F_7 () ;
return;
