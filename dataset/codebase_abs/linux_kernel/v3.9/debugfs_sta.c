...
struct V_91 * V_92 = V_7 -> V_90 -> V_93 . V_94 ;
T_9 V_95 [ 3 * V_96 ] ;
V_7 -> V_93 . V_97 = true ;
if ( ! V_92 )
return;
snprintf ( V_95 , sizeof( V_95 ) , L_50 , V_7 -> V_7 . V_98 ) ;
V_7 -> V_93 . V_99 = F_34 ( V_95 , V_92 ) ;
if ( ! V_7 -> V_93 . V_99 )
return;
F_35 ( V_100 ) ;
F_35 ( V_101 ) ;
...
F_36 ( V_122 , V_122 ) ;
F_36 ( V_123 , V_123 ) ;
F_37 ( V_88 , V_90 , & V_7 -> V_7 , V_7 -> V_93 . V_99 ) ;
}
void F_38 ( struct V_6 * V_7 )
{
struct V_87 * V_88 = V_7 -> V_88 ;
struct V_89 * V_90 = V_7 -> V_90 ;
F_39 ( V_88 , V_90 , & V_7 -> V_7 , V_7 -> V_93 . V_99 ) ;
F_40 ( V_7 -> V_93 . V_99 ) ;
V_7 -> V_93 . V_99 = NULL ;
}
