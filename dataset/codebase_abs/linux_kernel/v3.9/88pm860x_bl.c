...
{
struct V_1 * V_2 = F_22 ( V_37 -> V_29 . V_42 ) ;
...
if ( V_14 == NULL )
return - V_53 ;
V_49 = F_24 ( V_37 , V_54 , L_8 ) ;
if ( ! V_49 ) {
F_15 ( & V_37 -> V_29 , L_9 ) ;
return - V_55 ;
}
V_14 -> V_18 = V_49 -> V_56 ;
V_49 = F_24 ( V_37 , V_54 , L_10 ) ;
if ( ! V_49 ) {
F_15 ( & V_37 -> V_29 , L_11 ) ;
return - V_55 ;
}
V_14 -> V_27 = V_49 -> V_56 ;
V_49 = F_24 ( V_37 , V_54 , L_12 ) ;
if ( ! V_49 ) {
F_15 ( & V_37 -> V_29 , L_13 ) ;
return - V_55 ;
}
V_14 -> V_22 = V_49 -> V_56 ;
memset ( V_38 , 0 , V_51 ) ;
sprintf ( V_38 , L_14 , V_37 -> V_57 ) ;
V_14 -> V_3 = V_37 -> V_57 ;
V_14 -> V_2 = V_2 ;
V_14 -> V_17 = ( V_2 -> V_57 == V_58 ) ? V_2 -> V_59 : V_2 -> V_60 ;
V_14 -> V_20 = V_16 ;
