...
F_6 ( F_7 ( F_24 ( V_72 ) ) ) ;
F_6 ( F_7 ( F_8 ( V_78 , 0 ) ) ) ;
for ( V_20 = V_25 -> V_85 . V_86 ; V_20 ; V_20 = V_20 -> V_22 ) {
if ( V_20 -> V_35 & V_87 ) {
int V_88 ;
if ( V_20 -> V_35 & V_89 ) {
V_88 = * ( int * ) ( V_74 + V_20 -> V_88 ) ;
V_88 &= 0xffff ;
} else
V_88 = V_20 -> V_88 ;
F_6 ( F_7 ( F_8 ( ( char * ) V_74 + V_88 , 0 ) ) ) ;
} else {
V_69 = F_26 ( V_25 , V_74 + V_20 -> V_88 ,
V_20 -> V_41 ) ;
if ( V_20 -> V_35 & V_90 ) {
F_6 ( F_7 ( F_24 ( V_69 ) ) ) ;
} else {
...
static int F_31 ( const char * V_95 , int V_96 , const char * * V_97 )
{
const char * * V_98 ;
int V_99 , V_100 = 0 ;
...
V_101 = F_32 () ;
F_33 ( V_101 ) ;
if ( F_34 ( V_101 , F_1 , V_96 + 2 , ( char * * ) V_98 ,
( char * * ) NULL ) ) {
V_100 = - 1 ;
goto error;
}
...
static int F_40 ( struct V_84 * V_84 , const char * V_103 )
{
...
V_107 = 0 ;
V_108 = 0 ;
for ( V_104 = V_25 -> V_85 . V_86 ; V_104 ; V_104 = V_104 -> V_22 ) {
if ( V_107 ++ )
fprintf ( V_109 , L_52 ) ;
if ( ++ V_108 % 5 == 0 )
fprintf ( V_109 , L_53 ) ;
