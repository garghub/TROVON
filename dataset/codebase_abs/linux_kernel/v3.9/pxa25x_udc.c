...
static int F_69 ( struct V_128 * V_170 ,
struct V_171 * V_39 )
{
struct V_24 * V_25 = F_70 ( V_170 ) ;
int V_172 ;
V_25 -> V_39 = V_39 ;
V_25 -> V_40 . V_25 . V_39 = & V_39 -> V_39 ;
V_25 -> F_53 = 1 ;
if ( ! F_62 ( V_25 -> V_141 ) ) {
V_172 = F_71 ( V_25 -> V_141 -> V_173 ,
& V_25 -> V_40 ) ;
if ( V_172 )
goto V_174;
}
...
static int F_74 ( struct V_128 * V_170 ,
struct V_171 * V_39 )
{
struct V_24 * V_25 = F_70 ( V_170 ) ;
F_75 () ;
...
F_76 () ;
if ( ! F_62 ( V_25 -> V_141 ) )
( void ) F_71 ( V_25 -> V_141 -> V_173 , NULL ) ;
...
static void F_81 ( unsigned long V_178 )
{
...
F_84 ( V_189 . V_186 . V_197 ) ,
F_84 ( V_189 . V_186 . V_198 ) ,
F_84 ( V_189 . V_186 . V_199 ) ) ;
...
static void F_89 ( struct V_222 * V_25 )
{
F_13 ( L_89 , V_31 , F_90 ( V_25 ) ) ;
}
static int T_6 F_91 ( struct V_223 * V_224 )
{
struct V_24 * V_25 = & V_225 ;
int V_172 , V_177 ;
T_3 V_226 ;
F_92 ( L_90 , V_227 , V_228 ) ;
...
if ( V_177 < 0 )
return - V_125 ;
V_25 -> V_139 = F_96 ( & V_224 -> V_25 , NULL ) ;
if ( F_97 ( V_25 -> V_139 ) ) {
V_172 = F_98 ( V_25 -> V_139 ) ;
goto V_247;
}
F_99 ( L_93 , V_227 , V_177 ,
V_25 -> V_106 ? L_11 : L_94 ,
V_248 L_38
) ;
V_25 -> V_25 = & V_224 -> V_25 ;
V_25 -> V_2 = V_224 -> V_25 . V_249 ;
V_25 -> V_141 = F_100 ( V_250 ) ;
if ( F_2 ( V_25 -> V_2 -> V_6 ) ) {
if ( ( V_172 = F_101 ( V_25 -> V_2 -> V_6 ,
L_95 ) ) ) {
F_102 ( & V_224 -> V_25 ,
L_96 ,
V_25 -> V_2 -> V_6 , V_172 ) ;
...
F_104 ( & V_25 -> V_175 ) ;
V_25 -> V_175 . V_252 = F_81 ;
V_25 -> V_175 . V_253 = ( unsigned long ) V_25 ;
F_105 ( & V_25 -> V_40 . V_25 ) ;
V_25 -> V_40 . V_25 . V_254 = & V_224 -> V_25 ;
V_25 -> V_40 . V_25 . V_255 = V_224 -> V_25 . V_255 ;
V_172 = F_106 ( & V_25 -> V_40 . V_25 ) ;
if ( V_172 ) {
V_25 -> V_39 = NULL ;
V_25 -> V_40 . V_25 . V_39 = NULL ;
goto V_256;
...
static void F_119 ( struct V_223 * V_178 )
{
F_1 () ;
}
static int T_7 F_120 ( struct V_223 * V_224 )
{
struct V_24 * V_25 = F_121 ( V_224 ) ;
if ( V_25 -> V_39 )
return - V_261 ;
F_122 ( & V_25 -> V_40 ) ;
F_115 ( & V_25 -> V_40 . V_25 ) ;
...
static int F_123 ( struct V_223 * V_25 , T_8 V_262 )
{
struct V_24 * V_134 = F_121 ( V_25 ) ;
unsigned long V_48 ;
if ( ! F_2 ( V_134 -> V_2 -> V_6 ) && ! V_134 -> V_2 -> V_7 )
F_85 ( L_99 ) ;
V_134 -> V_137 = 1 ;
...
static int F_124 ( struct V_223 * V_25 )
{
struct V_24 * V_134 = F_121 ( V_25 ) ;
unsigned long V_48 ;
V_134 -> V_137 = 0 ;
