...
static bool F_105 ( struct V_282 * V_86 , void * V_295 )
{
struct V_312 * V_313 = V_295 ;
if ( V_86 -> V_314 != & V_313 -> V_291 -> V_315 )
return false ;
return ( V_86 -> V_316 == V_313 -> V_316 ) ;
}
bool F_106 ( struct V_282 * V_86 , void * V_295 )
{
T_3 * V_317 ;
if ( V_86 -> V_314 -> V_98 -> V_318 != & V_319 . V_320 )
return false ;
V_317 = V_86 -> V_321 ;
return * V_317 == ( unsigned ) V_295 ;
}
static struct V_282 * F_107 ( struct V_322 * V_323 ,
struct V_324 * V_325 )
{
int V_326 = V_323 -> V_327 ;
struct V_290 * V_291 = V_325 -> V_328 ;
struct V_312 V_313 ;
T_6 V_329 ;
if ( ! V_291 )
return NULL ;
...
return NULL ;
V_313 . V_291 = V_291 ;
V_313 . V_316 = V_323 -> args [ 0 ] ;
F_108 ( V_329 ) ;
F_109 ( V_330 , V_329 ) ;
F_109 ( V_331 , V_329 ) ;
return F_110 ( V_329 , F_105 , & V_313 ) ;
}
static int F_111 ( struct V_282 * V_86 )
{
...
static int F_113 ( struct V_282 * V_86 , enum V_332 V_333 , unsigned long V_52 )
{
struct V_281 * V_293 = F_92 ( V_86 ) ;
struct V_284 * V_292 , * V_309 ;
unsigned long V_206 ;
...
break;
case V_337 :
V_335 = (struct V_334 * ) V_52 ;
if ( V_335 -> V_338 == V_339 ) {
if ( V_335 -> V_165 )
V_293 -> V_340 = V_335 -> V_165 ;
if ( V_335 -> V_341 )
V_293 -> V_342 = F_114 ( V_335 -> V_341 ) ;
if ( V_335 -> V_343 )
V_293 -> V_344 = V_335 -> V_343 ;
} else if ( V_335 -> V_338 == V_345 ) {
if ( V_335 -> V_164 )
V_293 -> V_340 = V_335 -> V_164 ;
if ( V_335 -> V_346 )
V_293 -> V_342 = F_114 ( V_335 -> V_346 ) ;
if ( V_335 -> V_347 )
V_293 -> V_344 = V_335 -> V_347 ;
}
break;
default:
...
static void F_115 ( struct V_282 * V_86 )
{
struct V_281 * V_293 = F_92 ( V_86 ) ;
unsigned long V_206 ;
F_60 ( & V_293 -> V_214 , V_206 ) ;
...
static enum V_349
F_116 ( struct V_282 * V_86 , T_7 V_307 ,
struct V_350 * V_351 )
{
return F_117 ( V_86 , V_307 , V_351 ) ;
}
static void F_118 ( struct V_282 * V_86 )
{
F_100 ( ( unsigned long ) F_92 ( V_86 ) ) ;
}
static T_7 F_119 ( struct V_285 * V_286 )
{
struct V_284 * V_292 , * V_352 = F_94 ( V_286 ) ;
struct V_281 * V_293 = F_92 ( V_286 -> V_86 ) ;
T_7 V_307 ;
unsigned long V_206 ;
F_60 ( & V_293 -> V_214 , V_206 ) ;
while ( ! F_120 ( & V_352 -> V_311 ) ) {
V_292 = F_121 ( V_352 -> V_311 . V_169 , struct V_284 , V_311 ) ;
F_122 ( & V_292 -> V_287 ) ;
F_103 ( & V_292 -> V_311 , & V_293 -> V_302 ) ;
}
V_307 = F_122 ( & V_352 -> V_287 ) ;
F_66 ( & V_352 -> V_311 , & V_293 -> V_302 ) ;
F_62 ( & V_293 -> V_214 , V_206 ) ;
return V_307 ;
}
static inline void F_123 ( struct V_284 * V_292 )
{
V_292 -> V_296 = NULL ;
V_292 -> V_9 . V_160 = & V_292 -> V_353 ;
V_292 -> V_9 . V_6 = V_292 ;
V_292 -> V_354 . V_194 = V_355 ;
V_292 -> V_354 . V_176 = 0 ;
V_292 -> V_354 . V_181 = 0 ;
V_292 -> V_354 . V_190 = V_356 ;
V_292 -> V_354 . V_192 = V_357 ;
V_292 -> V_9 . V_134 = & V_292 -> V_354 ;
V_292 -> V_9 . V_5 = F_104 ;
V_292 -> V_287 . V_358 = F_119 ;
F_85 ( & V_292 -> V_311 ) ;
}
static int F_124 ( struct V_290 * V_291 , T_8 V_359 , int V_326 )
{
struct V_284 * V_292 ;
unsigned long V_206 ;
int V_219 ;
if ( ! V_291 )
return 0 ;
V_292 = F_125 ( V_326 * sizeof( * V_292 ) , V_359 ) ;
if ( ! V_292 )
return 0 ;
F_60 ( & V_291 -> V_298 , V_206 ) ;
for ( V_219 = 0 ; V_219 < V_326 ; V_219 ++ ) {
F_123 ( & V_292 [ V_219 ] ) ;
...
return NULL ;
F_60 ( & V_291 -> V_298 , V_206 ) ;
if ( ! F_120 ( & V_291 -> V_299 ) ) {
V_292 = F_121 ( V_291 -> V_299 . V_169 ,
struct V_284 , V_311 ) ;
F_127 ( & V_292 -> V_311 ) ;
V_292 -> V_300 = V_301 ;
...
static struct V_284 * F_128 ( struct V_281 * V_293 )
{
struct V_290 * V_291 = V_293 -> V_12 ;
T_3 * V_317 = V_293 -> V_86 . V_321 ;
struct V_284 * V_292 ;
V_292 = F_126 ( V_291 ) ;
if ( ! V_292 ) {
if ( ! F_124 ( V_291 , V_360 , 1 ) )
return NULL ;
V_292 = F_126 ( V_291 ) ;
if ( ! V_292 ) {
...
V_292 -> V_287 . V_307 = 0 ;
F_129 ( & V_292 -> V_287 ) ;
V_292 -> V_9 . V_36 = V_317 ? V_293 -> V_86 . V_316 : 0 ;
V_292 -> V_354 . V_15 = & V_293 -> V_12 -> V_306 . V_15 ;
F_130 ( & V_292 -> V_287 , & V_293 -> V_86 ) ;
return V_292 ;
}
static inline void F_131 ( struct V_159 * V_353 ,
T_9 V_60 , T_9 V_361 , T_10 V_362 )
{
V_353 -> V_169 = NULL ;
V_353 -> V_163 = V_362 ;
V_353 -> V_165 = V_60 ;
...
static struct V_284 *
F_132 ( struct V_281 * V_293 , T_9 V_60 ,
T_9 V_361 , T_10 V_362 )
{
struct V_284 * V_292 = F_128 ( V_293 ) ;
if ( ! V_292 ) {
F_36 ( V_293 -> V_12 -> V_306 . V_98 , L_43 ,
V_137 , __LINE__ ) ;
return NULL ;
}
F_131 ( & V_292 -> V_353 , V_60 , V_361 , V_362 ) ;
return V_292 ;
}
static inline int F_133 ( struct V_284 * V_292 , T_10 V_362 )
{
struct V_281 * V_293 = V_292 -> V_296 ;
struct V_19 * V_20 = & V_293 -> V_12 -> V_306 ;
int V_344 ;
V_344 = V_20 -> V_15 . V_253 / 8 ;
V_344 *= V_20 -> V_15 . V_256 ;
V_344 >>= V_292 -> V_354 . V_187 ;
if ( V_344 > 16 )
V_344 = 16 ;
while ( V_344 > 1 ) {
if ( ! ( V_362 % ( V_344 << V_292 -> V_354 . V_187 ) ) )
break;
V_344 -- ;
}
return V_344 ;
}
static struct V_285 * F_134 (
struct V_282 * V_86 , T_9 V_363 , T_10 V_362 ,
T_10 V_364 , enum V_365 V_338 ,
unsigned long V_206 , void * V_366 )
{
struct V_284 * V_292 ;
struct V_281 * V_293 = F_92 ( V_86 ) ;
T_9 V_60 ;
...
V_292 -> V_354 . V_187 = V_293 -> V_342 ;
V_292 -> V_354 . V_184 = 1 ;
V_293 -> V_310 = true ;
F_131 ( & V_292 -> V_353 , V_60 , V_361 , V_364 ) ;
return & V_292 -> V_287 ;
}
static struct V_285 *
F_135 ( struct V_282 * V_86 , T_9 V_60 ,
T_9 V_361 , T_10 V_362 , unsigned long V_206 )
{
struct V_284 * V_292 ;
struct V_281 * V_293 = F_92 ( V_86 ) ;
struct V_19 * V_20 ;
int V_367 ;
if ( F_136 ( ! V_293 || ! V_362 ) )
return NULL ;
V_20 = & V_293 -> V_12 -> V_306 ;
V_292 = F_132 ( V_293 , V_60 , V_361 , V_362 ) ;
if ( ! V_292 )
return NULL ;
V_292 -> V_354 . V_172 = 1 ;
V_292 -> V_354 . V_174 = 1 ;
V_292 -> V_9 . V_145 = V_148 ;
V_367 = V_20 -> V_15 . V_253 / 8 ;
while ( V_367 > 1 ) {
if ( ! ( V_362 % V_367 ) )
break;
V_367 /= 2 ;
...
V_292 -> V_354 . V_187 = 0 ;
while ( V_367 != ( 1 << V_292 -> V_354 . V_187 ) )
V_292 -> V_354 . V_187 ++ ;
V_292 -> V_354 . V_184 = F_133 ( V_292 , V_362 ) ;
V_292 -> V_287 . V_206 = V_206 ;
return & V_292 -> V_287 ;
}
static struct V_285 *
F_137 ( struct V_282 * V_86 , struct V_368 * V_369 ,
unsigned int V_370 , enum V_365 V_338 ,
unsigned long V_359 , void * V_366 )
{
struct V_284 * V_371 , * V_292 = NULL ;
struct V_281 * V_293 = F_92 ( V_86 ) ;
struct V_368 * V_372 ;
unsigned long V_206 ;
int V_219 ;
T_9 V_87 ;
if ( F_136 ( ! V_293 || ! V_369 || ! V_370 ) )
return NULL ;
V_87 = V_293 -> V_340 ;
V_371 = NULL ;
...
return NULL ;
F_60 ( & V_291 -> V_298 , V_206 ) ;
while ( ! F_120 ( & V_371 -> V_311 ) ) {
V_292 = F_121 ( V_371 -> V_311 . V_169 ,
struct V_284 , V_311 ) ;
F_103 ( & V_292 -> V_311 , & V_291 -> V_299 ) ;
}
F_103 ( & V_371 -> V_311 , & V_291 -> V_299 ) ;
F_62 ( & V_291 -> V_298 , V_206 ) ;
return NULL ;
}
if ( ! V_371 )
...
F_66 ( & V_292 -> V_311 , & V_371 -> V_311 ) ;
if ( V_338 == V_339 ) {
V_292 -> V_354 . V_172 = 1 ;
V_292 -> V_354 . V_174 = 0 ;
V_292 -> V_9 . V_145 = V_146 ;
F_131 ( & V_292 -> V_353 ,
V_87 , F_139 ( V_372 ) , F_140 ( V_372 ) ) ;
} else {
V_292 -> V_354 . V_172 = 0 ;
V_292 -> V_354 . V_174 = 1 ;
V_292 -> V_9 . V_145 = V_147 ;
F_131 ( & V_292 -> V_353 ,
F_139 ( V_372 ) , V_87 , F_140 ( V_372 ) ) ;
}
V_292 -> V_354 . V_187 = V_293 -> V_342 ;
V_292 -> V_354 . V_184 = 1 ;
}
V_292 -> V_287 . V_206 = V_359 ;
return & V_292 -> V_287 ;
}
static T_11 F_141 ( int V_373 , void * V_218 )
{
if ( F_64 ( V_218 ) )
return V_374 ;
else
...
static int
F_142 ( struct V_376 * V_377 , const struct V_378 * V_13 )
{
struct V_379 * V_380 ;
struct V_290 * V_291 ;
struct V_281 * V_293 , * V_381 ;
struct V_19 * V_20 ;
struct V_382 * V_383 ;
struct V_384 * V_385 ;
int V_219 , V_207 , V_373 ;
int V_16 ;
V_380 = V_377 -> V_98 . V_386 ;
V_291 = F_143 ( & V_377 -> V_98 , sizeof( * V_291 ) , V_274 ) ;
if ( ! V_291 ) {
F_36 ( & V_377 -> V_98 , L_45 ) ;
return - V_217 ;
}
V_20 = & V_291 -> V_306 ;
V_20 -> V_98 = & V_377 -> V_98 ;
V_20 -> V_229 = NULL ;
V_20 -> V_216 = V_380 ? V_380 -> V_387 : 0 ;
V_385 = & V_377 -> V_385 ;
V_20 -> V_23 = F_144 ( & V_377 -> V_98 , V_385 ) ;
if ( ! V_20 -> V_23 )
return - V_348 ;
F_145 ( V_377 , V_291 ) ;
V_373 = V_377 -> V_373 [ 0 ] ;
V_207 = F_146 ( V_373 , F_141 , 0 ,
F_147 ( & V_377 -> V_98 ) , V_20 ) ;
if ( V_207 )
return V_207 ;
V_207 = F_83 ( V_20 ) ;
if ( V_207 )
...
F_85 ( & V_291 -> V_299 ) ;
F_84 ( & V_291 -> V_298 ) ;
if ( ! F_124 ( V_291 , V_274 , V_389 ) )
F_148 ( & V_377 -> V_98 , L_46 ) ;
V_383 = & V_291 -> V_315 ;
F_85 ( & V_383 -> V_223 ) ;
if ( V_380 )
V_16 = F_149 ( int , V_380 -> V_390 , V_20 -> V_15 . V_16 ) ;
else
V_16 = F_149 ( int , V_20 -> V_15 . V_213 , V_20 -> V_15 . V_16 ) ;
V_291 -> V_391 = F_79 ( V_16 * sizeof( * V_293 ) , V_274 ) ;
if ( ! V_291 -> V_391 ) {
V_207 = - V_217 ;
F_36 ( & V_377 -> V_98 , L_47 ) ;
goto V_392;
}
for ( V_219 = 0 ; V_219 < V_16 ; V_219 ++ ) {
V_293 = & V_291 -> V_391 [ V_219 ] ;
if ( ! V_377 -> V_98 . V_393 )
V_293 -> V_86 . V_321 = V_380 ? & V_380 -> V_317 [ V_219 ] : NULL ;
else
V_293 -> V_86 . V_321 = V_377 -> V_98 . V_393 ;
F_85 ( & V_293 -> V_302 ) ;
F_84 ( & V_293 -> V_214 ) ;
V_293 -> V_304 = NULL ;
V_293 -> V_86 . V_314 = V_383 ;
V_293 -> V_12 = V_291 ;
F_66 ( & V_293 -> V_86 . V_394 , & V_383 -> V_223 ) ;
}
V_383 -> V_98 = & V_377 -> V_98 ;
if ( V_380 ) {
V_383 -> V_395 = V_380 -> V_395 ;
} else {
F_109 ( V_396 , V_383 -> V_395 ) ;
if ( V_20 -> V_15 . V_213 ) {
F_109 ( V_330 , V_383 -> V_395 ) ;
F_109 ( V_331 , V_383 -> V_395 ) ;
F_109 ( V_397 , V_383 -> V_395 ) ;
}
}
V_383 -> V_398 = F_111 ;
V_383 -> V_399 = F_115 ;
...
V_207 = F_150 ( V_383 ) ;
if ( V_207 ) {
F_36 ( & V_377 -> V_98 , L_48 ) ;
goto V_406;
}
if ( V_377 -> V_98 . V_393 ) {
V_207 = F_151 ( V_377 -> V_98 . V_393 ,
F_107 , V_291 ) ;
if ( V_207 ) {
F_36 ( & V_377 -> V_98 ,
L_49 ) ;
...
chan.device_node) {
F_68 ( & V_293 -> V_86 . V_394 ) ;
F_113 ( & V_293 -> V_86 , V_336 , 0 ) ;
F_115 ( & V_293 -> V_86 ) ;
}
V_392:
F_90 ( V_20 ) ;
...
static int F_153 ( struct V_376 * V_377 )
{
struct V_290 * V_291 = F_154 ( V_377 ) ;
struct V_281 * V_293 , * V_381 ;
struct V_19 * V_20 ;
int V_373 ;
if ( ! V_291 )
