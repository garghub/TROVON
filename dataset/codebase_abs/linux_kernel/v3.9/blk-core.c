...
return;
F_36 ( V_12 -> V_59 ) ;
V_198 = F_197 ( V_12 , & V_179 , V_35 ) ;
if ( V_198 == V_199 ) {
if ( F_180 ( V_12 , V_179 , V_35 ) ) {
F_198 ( V_12 , V_179 , V_35 ) ;
if ( ! F_199 ( V_12 , V_179 ) )
F_200 ( V_12 , V_179 , V_198 ) ;
goto V_209;
}
} else if ( V_198 == V_200 ) {
...
static inline void F_206 ( struct V_35 * V_35 )
{
struct V_18 * V_19 = V_35 -> V_215 ;
if ( F_207 ( V_35 ) && V_19 != V_19 -> V_216 ) {
struct V_4 * V_217 = V_19 -> V_218 ;
V_35 -> V_46 += V_217 -> V_219 ;
V_35 -> V_215 = V_19 -> V_216 ;
F_208 ( F_15 ( V_35 -> V_215 ) , V_35 ,
V_19 -> V_220 ,
V_35 -> V_46 - V_217 -> V_219 ) ;
}
}
static void F_209 ( struct V_35 * V_35 )
{
char V_221 [ V_222 ] ;
F_25 ( V_50 L_11 ) ;
F_25 ( V_50 L_12 ,
F_210 ( V_35 -> V_215 , V_221 ) ,
V_35 -> V_145 ,
( unsigned long long ) V_35 -> V_46 + F_207 ( V_35 ) ,
( long long ) ( F_211 ( V_35 -> V_215 -> V_223 ) >> 9 ) ) ;
F_26 ( V_224 , & V_35 -> V_38 ) ;
}
static int T_4 F_212 ( char * V_225 )
{
return F_213 ( & V_226 , V_225 ) ;
}
static bool F_214 ( struct V_4 * V_5 , unsigned int V_227 )
{
return V_5 -> V_228 && F_215 ( & V_226 , V_227 ) ;
}
static int T_4 F_216 ( void )
{
struct V_229 * V_230 = F_217 ( L_13 ,
NULL , & V_226 ) ;
return F_218 ( V_230 ) ? F_219 ( V_230 ) : 0 ;
}
static inline bool F_214 ( struct V_4 * V_5 ,
unsigned int V_227 )
{
return false ;
}
static inline int F_220 ( struct V_35 * V_35 , unsigned int V_231 )
{
V_24 V_232 ;
if ( ! V_231 )
return 0 ;
V_232 = F_211 ( V_35 -> V_215 -> V_223 ) >> 9 ;
if ( V_232 ) {
...
static T_5 bool
F_221 ( struct V_35 * V_35 )
{
struct V_11 * V_12 ;
int V_231 = F_207 ( V_35 ) ;
int V_104 = - V_39 ;
char V_221 [ V_222 ] ;
struct V_4 * V_5 ;
F_222 () ;
...
if ( F_214 ( V_5 , V_35 -> V_40 ) ||
F_214 ( & F_173 ( V_5 ) -> V_10 ,
V_35 -> V_40 ) )
goto V_234;
F_206 ( V_35 ) ;
if ( F_220 ( V_35 , V_231 ) )
goto V_234;
if ( ( V_35 -> V_145 & ( V_146 | V_147 ) ) && ! V_12 -> V_235 ) {
...
if ( ( V_35 -> V_145 & V_236 ) &&
( ! F_225 ( V_12 ) ||
( ( V_35 -> V_145 & V_237 ) && ! F_226 ( V_12 ) ) ) ) {
V_104 = - V_238 ;
goto V_234;
}
if ( V_35 -> V_145 & V_239 && ! F_227 ( V_35 -> V_215 ) ) {
V_104 = - V_238 ;
goto V_234;
}
F_152 ( V_240 , V_12 -> V_100 ) ;
if ( F_228 ( V_12 , V_35 ) )
return false ;
F_229 ( V_12 , V_35 ) ;
return true ;
...
void F_230 ( struct V_35 * V_35 )
{
struct V_241 V_242 ;
if ( ! F_221 ( V_35 ) )
return;
if ( V_149 -> V_241 ) {
F_231 ( V_149 -> V_241 , V_35 ) ;
return;
}
F_151 ( V_35 -> V_193 ) ;
F_232 ( & V_242 ) ;
...
V_35 = F_233 ( V_149 -> V_241 ) ;
} while ( V_35 );
V_149 -> V_241 = NULL ;
}
void F_234 ( int V_6 , struct V_35 * V_35 )
{
V_35 -> V_145 |= V_6 ;
if ( F_235 ( V_35 ) ) {
unsigned int V_92 ;
if ( F_24 ( V_6 & V_239 ) )
V_92 = F_236 ( V_35 -> V_215 ) >> 9 ;
else
V_92 = F_207 ( V_35 ) ;
if ( V_6 & V_171 ) {
F_237 ( V_244 , V_92 ) ;
...
int F_240 ( struct V_11 * V_12 , struct V_1 * V_2 )
{
if ( ! F_241 ( V_2 ) )
return 0 ;
if ( F_31 ( V_2 ) > F_242 ( V_12 , V_2 -> V_43 ) ) {
F_25 ( V_41 L_20 , V_42 ) ;
return - V_39 ;
}
F_243 ( V_2 ) ;
if ( V_2 -> V_190 > F_244 ( V_12 ) ) {
F_25 ( V_41 L_21 , V_42 ) ;
return - V_39 ;
}
return 0 ;
}
int F_245 ( struct V_11 * V_12 , struct V_1 * V_2 )
{
unsigned long V_66 ;
int V_173 = V_249 ;
if ( F_240 ( V_12 , V_2 ) )
...
F_151 ( F_33 ( V_2 ) && ! V_227 ) ;
return V_227 ;
}
static void F_247 ( struct V_1 * V_179 , unsigned int V_227 )
{
if ( F_3 ( V_179 ) ) {
...
V_7 = F_4 () ;
V_5 = V_179 -> V_5 ;
F_248 ( V_7 , V_5 , V_251 [ V_6 ] , V_227 >> 9 ) ;
F_12 () ;
}
}
static void F_249 ( struct V_1 * V_179 )
{
if ( F_3 ( V_179 ) && ! ( V_179 -> V_43 & V_47 ) ) {
unsigned long V_252 = V_34 - V_179 -> V_33 ;
const int V_6 = F_2 ( V_179 ) ;
struct V_4 * V_5 ;
int V_7 ;
V_7 = F_4 () ;
...
struct V_1 * F_252 ( struct V_11 * V_12 )
{
struct V_1 * V_2 ;
int V_20 ;
while ( ( V_2 = F_253 ( V_12 ) ) != NULL ) {
if ( ! ( V_2 -> V_43 & V_255 ) ) {
if ( V_2 -> V_43 & V_256 )
F_254 ( V_12 , V_2 ) ;
V_2 -> V_43 |= V_255 ;
...
void F_257 ( struct V_1 * V_179 )
{
F_259 ( V_179 ) ;
V_179 -> V_189 = F_33 ( V_179 ) ;
if ( F_24 ( F_265 ( V_179 ) ) )
V_179 -> V_264 -> V_189 = F_33 ( V_179 -> V_264 ) ;
F_266 ( V_179 ) ;
}
struct V_1 * F_267 ( struct V_11 * V_12 )
{
struct V_1 * V_2 ;
V_2 = F_252 ( V_12 ) ;
if ( V_2 )
...
bool F_268 ( struct V_1 * V_179 , int error , unsigned int V_265 )
{
int V_266 , V_267 , V_268 = 0 ;
struct V_35 * V_35 ;
if ( ! V_179 -> V_35 )
return false ;
F_269 ( V_179 -> V_12 , V_179 ) ;
if ( V_179 -> V_52 == V_201 )
V_179 -> V_204 = 0 ;
...
if ( F_24 ( V_273 >= V_35 -> V_186 ) ) {
F_30 ( V_179 , L_28 ) ;
F_25 ( V_41 L_29 ,
V_42 , V_273 , V_35 -> V_186 ) ;
break;
}
V_36 = F_270 ( V_35 , V_273 ) -> V_185 ;
F_271 ( V_36 > V_35 -> V_40 ) ;
if ( F_24 ( V_36 > V_265 ) ) {
V_267 += V_265 ;
V_266 += V_265 ;
break;
...
if ( V_267 ) {
F_21 ( V_179 , V_35 , V_267 , error ) ;
V_35 -> V_274 += V_268 ;
F_272 ( V_35 ) -> V_184 += V_265 ;
F_272 ( V_35 ) -> V_185 -= V_265 ;
}
V_179 -> V_188 -= V_266 ;
...
if ( F_33 ( V_179 ) < F_273 ( V_179 ) ) {
F_30 ( V_179 , L_30 ) ;
V_179 -> V_188 = F_273 ( V_179 ) ;
}
F_243 ( V_179 ) ;
return true ;
}
static bool F_274 ( struct V_1 * V_2 , int error ,
unsigned int V_265 ,
unsigned int V_275 )
{
if ( F_268 ( V_2 , error , V_265 ) )
return true ;
if ( F_24 ( F_265 ( V_2 ) ) &&
F_268 ( V_2 -> V_264 , error , V_275 ) )
return true ;
if ( F_275 ( V_2 -> V_12 ) )
F_276 ( V_2 -> V_9 ) ;
return false ;
}
void F_277 ( struct V_1 * V_179 )
{
struct V_11 * V_12 = V_179 -> V_12 ;
V_179 -> V_43 &= ~ V_259 ;
if ( V_12 -> V_130 )
...
static void F_278 ( struct V_1 * V_179 , int error )
{
if ( F_164 ( V_179 ) )
F_165 ( V_179 -> V_12 , V_179 ) ;
F_151 ( F_166 ( V_179 ) ) ;
if ( F_24 ( V_276 ) && V_179 -> V_52 == V_201 )
F_279 ( & V_179 -> V_12 -> V_17 ) ;
F_161 ( V_179 ) ;
if ( V_179 -> V_43 & V_259 )
F_277 ( V_179 ) ;
F_249 ( V_179 ) ;
if ( V_179 -> V_234 )
V_179 -> V_234 ( V_179 , error ) ;
else {
if ( F_265 ( V_179 ) )
F_174 ( V_179 -> V_264 -> V_12 , V_179 -> V_264 ) ;
F_174 ( V_179 -> V_12 , V_179 ) ;
}
}
static bool F_280 ( struct V_1 * V_2 , int error ,
unsigned int V_265 , unsigned int V_275 )
{
struct V_11 * V_12 = V_2 -> V_12 ;
unsigned long V_66 ;
if ( F_274 ( V_2 , error , V_265 , V_275 ) )
return true ;
F_59 ( V_12 -> V_59 , V_66 ) ;
F_278 ( V_2 , error ) ;
F_60 ( V_12 -> V_59 , V_66 ) ;
...
bool F_282 ( struct V_1 * V_2 , int error , unsigned int V_265 )
{
return F_280 ( V_2 , error , V_265 , 0 ) ;
}
void F_283 ( struct V_1 * V_2 , int error )
{
bool V_277 ;
unsigned int V_275 = 0 ;
if ( F_24 ( F_265 ( V_2 ) ) )
V_275 = F_33 ( V_2 -> V_264 ) ;
V_277 = F_280 ( V_2 , error , F_33 ( V_2 ) , V_275 ) ;
F_151 ( V_277 ) ;
}
bool F_284 ( struct V_1 * V_2 , int error )
{
return F_282 ( V_2 , error , F_273 ( V_2 ) ) ;
}
bool F_285 ( struct V_1 * V_2 , int error )
{
F_45 ( error >= 0 ) ;
return F_282 ( V_2 , error , F_246 ( V_2 ) ) ;
}
bool F_286 ( struct V_1 * V_2 , int error , unsigned int V_265 )
{
return F_281 ( V_2 , error , V_265 , 0 ) ;
}
...
if ( F_24 ( F_265 ( V_2 ) ) )
V_275 = F_33 ( V_2 -> V_264 ) ;
V_277 = F_281 ( V_2 , error , F_33 ( V_2 ) , V_275 ) ;
F_151 ( V_277 ) ;
}
bool F_287 ( struct V_1 * V_2 , int error )
{
return F_286 ( V_2 , error , F_273 ( V_2 ) ) ;
}
bool F_288 ( struct V_1 * V_2 , int error )
{
F_45 ( error >= 0 ) ;
return F_286 ( V_2 , error , F_246 ( V_2 ) ) ;
}
void F_194 ( struct V_11 * V_12 , struct V_1 * V_2 ,
struct V_35 * V_35 )
{
V_2 -> V_43 |= V_35 -> V_145 & V_278 ;
if ( F_235 ( V_35 ) ) {
V_2 -> V_190 = F_289 ( V_12 , V_35 ) ;
V_2 -> V_54 = F_179 ( V_35 ) ;
}
V_2 -> V_188 = V_35 -> V_40 ;
...
static void F_296 ( struct V_1 * V_285 , struct V_1 * V_286 )
{
V_285 -> V_7 = V_286 -> V_7 ;
V_285 -> V_43 = ( V_286 -> V_43 & V_287 ) | V_288 ;
V_285 -> V_52 = V_286 -> V_52 ;
V_285 -> V_23 = F_7 ( V_286 ) ;
V_285 -> V_188 = F_33 ( V_286 ) ;
V_285 -> V_190 = V_286 -> V_190 ;
V_285 -> V_194 = V_286 -> V_194 ;
V_285 -> V_289 = V_286 -> V_289 ;
}
int F_297 ( struct V_1 * V_2 , struct V_1 * V_290 ,
struct V_291 * V_292 , T_2 V_90 ,
int (* F_298)( struct V_35 * , struct V_35 * , void * ) ,
void * V_293 )
{
...
V_292 = V_295 ;
F_16 ( NULL , V_2 ) ;
F_299 (bio_src, rq_src) {
V_35 = F_300 ( V_294 , V_90 , V_292 ) ;
if ( ! V_35 )
goto V_296;
if ( F_298 && F_298 ( V_35 , V_294 , V_293 ) )
goto V_296;
if ( V_2 -> V_35 ) {
V_2 -> V_53 -> V_193 = V_35 ;
V_2 -> V_53 = V_35 ;
...
int F_301 ( struct V_11 * V_12 , struct V_56 * V_57 )
{
return F_302 ( V_61 , V_57 ) ;
}
int F_303 ( struct V_11 * V_12 ,
struct V_297 * V_298 , unsigned long V_299 )
{
return F_42 ( V_61 , V_298 , V_299 ) ;
}
void F_304 ( struct V_196 * V_197 )
{
struct V_300 * V_301 = V_149 ;
V_197 -> V_302 = V_303 ;
F_17 ( & V_197 -> V_213 ) ;
F_17 ( & V_197 -> V_304 ) ;
if ( ! V_301 -> V_197 ) {
...
static int F_305 ( void * V_305 , struct V_306 * V_307 , struct V_306 * V_221 )
{
...
static void F_306 ( struct V_11 * V_12 , unsigned int V_310 ,
bool V_311 )
__releases( V_12 -> V_59 )
{
F_307 ( V_12 , V_310 , ! V_311 ) ;
if ( V_311 )
F_56 ( V_12 ) ;
else
F_37 ( V_12 ) ;
...
static void F_309 ( struct V_196 * V_197 , bool V_311 )
{
F_310 ( V_312 ) ;
while ( ! F_67 ( & V_197 -> V_304 ) ) {
F_311 ( & V_197 -> V_304 , & V_312 ) ;
while ( ! F_67 ( & V_312 ) ) {
struct V_313 * V_314 = F_312 ( & V_312 ,
struct V_313 ,
V_213 ) ;
F_313 ( & V_314 -> V_213 ) ;
...
struct V_313 * F_314 ( T_6 V_316 , void * V_293 ,
int V_317 )
{
...
if ( ! V_197 )
return NULL ;
F_315 (cb, &plug->cb_list, list)
if ( V_314 -> V_315 == V_316 && V_314 -> V_293 == V_293 )
return V_314 ;
F_151 ( V_317 < sizeof( * V_314 ) ) ;
V_314 = F_316 ( V_317 , V_240 ) ;
if ( V_314 ) {
V_314 -> V_293 = V_293 ;
V_314 -> V_315 = V_316 ;
F_317 ( & V_314 -> V_213 , & V_197 -> V_304 ) ;
}
return V_314 ;
}
void F_204 ( struct V_196 * V_197 , bool V_311 )
{
struct V_11 * V_12 ;
unsigned long V_66 ;
struct V_1 * V_2 ;
F_310 ( V_213 ) ;
unsigned int V_310 ;
F_151 ( V_197 -> V_302 != V_303 ) ;
F_309 ( V_197 , V_311 ) ;
if ( F_67 ( & V_197 -> V_213 ) )
return;
F_311 ( & V_197 -> V_213 , & V_213 ) ;
F_318 ( NULL , & V_213 , F_305 ) ;
V_12 = NULL ;
V_310 = 0 ;
F_319 ( V_66 ) ;
while ( ! F_67 ( & V_213 ) ) {
V_2 = F_320 ( V_213 . V_318 ) ;
F_261 ( & V_2 -> V_21 ) ;
F_151 ( ! V_2 -> V_12 ) ;
if ( V_2 -> V_12 != V_12 ) {
if ( V_12 )
F_306 ( V_12 , V_310 , V_311 ) ;
V_12 = V_2 -> V_12 ;
V_310 = 0 ;
F_321 ( V_12 -> V_59 ) ;
}
