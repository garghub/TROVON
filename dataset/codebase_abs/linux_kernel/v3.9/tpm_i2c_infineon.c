...
static bool F_25 ( struct V_30 * V_31 , T_1 V_52 )
{
return ( V_52 == V_46 ) ;
}
static int F_26 ( struct V_70 * V_57 )
{
T_4 V_35 ;
int V_10 = 0 ;
struct V_30 * V_31 ;
...
V_31 -> V_35 . V_73 = 0 ;
V_31 -> V_35 . V_42 = F_28 ( V_74 ) ;
V_31 -> V_35 . V_67 = F_28 ( V_75 ) ;
V_31 -> V_35 . V_60 = F_28 ( V_74 ) ;
V_31 -> V_35 . V_48 = F_28 ( V_74 ) ;
if ( F_12 ( V_31 , 0 ) != 0 ) {
V_10 = - V_72 ;
goto V_76;
}
if ( F_1 ( F_29 ( 0 ) , ( T_1 * ) & V_35 , 4 ) < 0 ) {
V_10 = - V_20 ;
goto V_77;
}
V_35 = F_23 ( ( V_58 ) V_35 ) ;
...
static int F_37 ( struct V_81 * V_7 ,
const struct V_82 * V_83 )
{
int V_10 ;
if ( V_6 . V_7 != NULL )
return - V_49 ;
if ( ! F_38 ( V_7 -> V_12 , V_84 ) ) {
F_22 ( & V_7 -> V_57 ,
L_5 ) ;
return - V_72 ;
}
...
static int F_39 ( struct V_81 * V_7 )
{
