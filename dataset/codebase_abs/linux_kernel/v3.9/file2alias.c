...
static bool F_49 ( const char * V_57 , unsigned V_253 , const char * V_254 )
{
if ( V_253 != strlen ( V_254 ) )
return false ;
return memcmp ( V_57 , V_254 , V_253 ) == 0 ;
}
static void F_50 ( void * V_7 , unsigned long V_5 ,
unsigned long V_6 ,
const char * V_4 ,
void * V_124 ,
struct V_16 * V_17 )
...
unsigned int V_8 ;
char V_18 [ 500 ] ;
int (* F_51)( const char * , void * V_255 , char * V_18 ) = V_124 ;
F_2 ( V_17 -> V_57 , V_4 , V_5 , V_6 , V_7 ) ;
V_5 -= V_6 ;
for ( V_8 = 0 ; V_8 < V_5 ; V_8 += V_6 ) {
if ( F_51 ( V_17 -> V_57 , V_7 + V_8 , V_18 ) ) {
F_7 ( & V_17 -> V_40 ,
L_30 , V_18 ) ;
}
}
}
void F_52 ( struct V_16 * V_17 , struct V_256 * V_257 ,
T_3 * V_258 , const char * V_259 )
{
void * V_7 ;
char * V_260 = NULL ;
const char * V_57 ;
unsigned int V_253 ;
if ( ! V_258 -> V_261 || F_53 ( V_257 , V_258 ) >= V_257 -> V_262 )
return;
if ( F_54 ( V_258 -> V_263 ) != V_264 )
return;
V_57 = strstr ( V_259 , L_114 ) ;
if ( ! V_57 )
return;
V_57 += strlen ( L_114 ) ;
V_253 = strlen ( V_57 ) ;
if ( V_253 < strlen ( L_115 ) )
return;
if ( strcmp ( V_57 + V_253 - strlen ( L_115 ) , L_115 ) )
return;
V_253 -= strlen ( L_115 ) ;
if ( V_257 -> V_265 [ F_53 ( V_257 , V_258 ) ] . V_266 & V_267 ) {
V_260 = calloc ( 1 , V_258 -> V_268 ) ;
V_7 = V_260 ;
} else {
V_7 = ( void * ) V_257 -> V_269
+ V_257 -> V_265 [ F_53 ( V_257 , V_258 ) ] . V_270
+ V_258 -> V_271 ;
}
if ( F_49 ( V_57 , V_253 , L_31 ) )
F_10 ( V_7 , V_258 -> V_268 , V_17 ) ;
else if ( F_49 ( V_57 , V_253 , L_60 ) )
F_21 ( V_7 , V_258 -> V_268 , V_17 ) ;
else if ( F_49 ( V_57 , V_253 , L_116 ) )
F_22 ( V_7 , V_258 -> V_268 , V_17 ) ;
else {
struct V_272 * * V_242 ;
F_55 ( V_273 ) ;
for ( V_242 = V_274 ; V_242 < V_275 ; V_242 ++ ) {
if ( F_49 ( V_57 , V_253 , ( * V_242 ) -> V_4 ) ) {
F_50 ( V_7 , V_258 -> V_268 , ( * V_242 ) -> V_6 ,
...
void F_56 ( struct V_276 * V_277 , struct V_16 * V_17 )
{
F_7 ( V_277 , L_9 ) ;
F_57 ( V_277 , V_17 -> V_40 . V_242 , V_17 -> V_40 . V_278 ) ;
