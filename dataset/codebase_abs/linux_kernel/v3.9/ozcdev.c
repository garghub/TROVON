...
static int F_13 ( struct V_9 * V_9 , struct V_10 * V_11 )
{
F_7 ( L_4 ) ;
return 0 ;
}
static T_1 F_14 ( struct V_10 * V_11 , char T_2 * V_17 , T_3 V_18 ,
T_4 * V_19 )
{
int V_20 ;
int V_21 ;
...
static T_1 F_18 ( struct V_10 * V_11 , const char T_2 * V_17 ,
T_3 V_18 , T_4 * V_19 )
{
struct V_2 * V_3 ;
struct V_31 * V_32 ;
...
static int F_25 ( const T_5 * V_48 )
{
int V_49 = 0 ;
struct V_2 * V_3 ;
struct V_2 * V_50 ;
...
static long F_28 ( struct V_10 * V_11 , unsigned int V_53 ,
unsigned long V_54 )
{
int V_49 = 0 ;
if ( F_29 ( V_53 ) != V_55 )
...
static unsigned int F_37 ( struct V_10 * V_11 , T_6 * V_75 )
{
unsigned int V_76 = 0 ;
...
int F_55 ( void )
{
F_56 ( V_89 , 1 , V_6 , NULL , 0 ) ;
F_57 ( V_6 , 1 ) ;
return 0 ;
}
void F_58 ( void )
{
F_56 ( V_89 , 2 , V_6 , NULL , 0 ) ;
F_57 ( V_6 , 0 ) ;
}
