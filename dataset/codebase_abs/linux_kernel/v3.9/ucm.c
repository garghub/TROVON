...
F_87 ( V_210 -> V_211 - V_212 , V_213 ) ;
F_16 ( V_210 ) ;
}
static T_1 F_88 ( struct V_143 * V_209 , struct V_214 * V_215 ,
char * V_194 )
{
struct V_207 * V_210 ;
V_210 = F_82 ( V_209 , struct V_207 , V_209 ) ;
...
{
struct V_207 * V_210 = F_105 ( V_143 , & V_241 ) ;
if ( ! V_210 )
return;
F_103 ( & V_210 -> V_209 ) ;
}
...
{
int V_217 ;
V_217 = F_107 ( V_227 , V_212 ,
L_2 ) ;
if ( V_217 ) {
F_91 ( V_219 L_5 ) ;
goto V_242;
}
V_217 = F_108 ( & V_233 , & V_243 . V_215 ) ;
if ( V_217 ) {
F_91 ( V_219 L_6 ) ;
goto V_244;
}
