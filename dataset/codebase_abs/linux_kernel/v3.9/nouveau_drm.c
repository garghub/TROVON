...
if ( V_42 )
return;
if ( V_12 -> V_43 < V_44 ) V_25 = F_31 ( V_5 ) ;
else if ( V_12 -> V_45 < 0x17 ) V_25 = F_32 ( V_5 ) ;
else if ( V_12 -> V_43 < V_46 ) V_25 = F_33 ( V_5 ) ;
else if ( V_12 -> V_45 < 0x84 ) V_25 = F_34 ( V_5 ) ;
else if ( V_12 -> V_43 < V_47 ) V_25 = F_35 ( V_5 ) ;
else V_25 = F_36 ( V_5 ) ;
if ( V_25 ) {
F_37 ( V_5 , L_1 , V_25 ) ;
F_24 ( V_5 ) ;
...
V_25 = F_38 ( V_5 , & V_5 -> V_31 , V_49 , V_50 ,
V_40 , V_41 , & V_5 -> V_35 ) ;
if ( V_25 ) {
F_37 ( V_5 , L_3 , V_25 ) ;
F_24 ( V_5 ) ;
...
if ( V_12 -> V_43 < V_47 ) {
V_25 = F_39 ( V_5 -> V_12 , NULL , 32 , 0 , 0 ,
& V_5 -> V_34 ) ;
if ( V_25 ) {
F_37 ( V_5 , L_4 , V_25 ) ;
F_24 ( V_5 ) ;
...
if ( ! V_59 )
return - V_61 ;
V_59 -> V_62 [ 0 ] . V_28 = F_44 ( V_16 , 1 ) ;
V_59 -> V_62 [ 0 ] . V_21 = F_45 ( V_16 , 1 ) ;
V_59 -> V_63 = 1 ;
if ( F_45 ( V_16 , 2 ) ) {
V_59 -> V_62 [ V_59 -> V_63 ] . V_28 = F_44 ( V_16 , 2 ) ;
V_59 -> V_62 [ V_59 -> V_63 ] . V_21 = F_45 ( V_16 , 2 ) ;
V_59 -> V_63 ++ ;
}
if ( F_45 ( V_16 , 3 ) ) {
V_59 -> V_62 [ V_59 -> V_63 ] . V_28 = F_44 ( V_16 , 3 ) ;
V_59 -> V_62 [ V_59 -> V_63 ] . V_21 = F_45 ( V_16 , 3 ) ;
V_59 -> V_63 ++ ;
}
#ifdef F_46
...
F_47 ( V_59 , L_5 , V_60 ) ;
F_48 ( V_59 ) ;
V_25 = F_49 ( V_16 , F_10 ( V_16 ) , F_50 ( V_16 ) ,
V_26 , V_27 , & V_12 ) ;
if ( V_25 )
return V_25 ;
F_51 ( V_16 ) ;
V_25 = F_52 ( V_16 , V_57 , & V_68 ) ;
if ( V_25 ) {
...
static int
F_53 ( struct V_9 * V_7 , unsigned long V_66 )
{
...
if ( V_25 )
return V_25 ;
F_54 ( & V_5 -> V_31 . V_29 , & V_69 ) ;
V_7 -> V_70 = V_5 ;
V_5 -> V_7 = V_7 ;
F_55 ( & V_5 -> V_71 ) ;
F_56 ( & V_5 -> V_72 . V_73 ) ;
if ( F_57 ( V_7 ) && V_7 -> V_74 ) {
V_25 = F_40 (nv_object(drm), NVDRM_CLIENT,
NVDRM_DEVICE, 0x0080 ,
...
goto V_75;
F_58 ( V_5 ) ;
F_59 ( F_19 ( V_5 ) , V_76 , V_49 ) ;
}
V_25 = F_40 (nv_object(drm), NVDRM_CLIENT, NVDRM_DEVICE,
...
F_86 ( V_5 , L_9 ) ;
F_89 ( & V_5 -> V_84 . V_85 , V_86 ) ;
if ( V_5 -> V_37 && F_27 ( V_5 ) -> V_87 ) {
if ( ! F_27 ( V_5 ) -> V_87 ( V_5 ) )
return - V_61 ;
}
F_86 ( V_5 , L_10 ) ;
...
static int
F_108 ( struct V_9 * V_7 , struct V_95 * V_96 )
{
struct V_15 * V_16 = V_7 -> V_16 ;
struct V_4 * V_5 = V_4 ( V_7 ) ;
struct V_23 * V_24 ;
char V_17 [ 32 ] , V_97 [ V_98 ] ;
int V_25 ;
F_109 ( V_97 , V_99 ) ;
snprintf ( V_17 , sizeof( V_17 ) , L_14 , V_97 , F_110 ( V_96 -> V_100 ) ) ;
...
V_96 -> V_101 = V_24 ;
F_111 ( & V_5 -> V_31 . V_29 ) ;
F_112 ( & V_24 -> V_3 , & V_5 -> V_71 ) ;
F_113 ( & V_5 -> V_31 . V_29 ) ;
return 0 ;
}
static void
F_114 ( struct V_9 * V_7 , struct V_95 * V_96 )
{
struct V_23 * V_24 = V_23 ( V_96 ) ;
struct V_4 * V_5 = V_4 ( V_7 ) ;
if ( V_24 -> V_102 )
F_115 ( V_24 -> V_102 ) ;
F_111 ( & V_5 -> V_31 . V_29 ) ;
...
static void
F_117 ( struct V_9 * V_7 , struct V_95 * V_96 )
{
struct V_23 * V_24 = V_23 ( V_96 ) ;
F_18 ( V_24 ) ;
}
