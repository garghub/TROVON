...
static T_1 F_2 ( T_1 V_1 , const void T_2 * V_2 , void * V_3 )
{
if ( V_1 <= 256 )
return F_3 ( V_1 , V_2 , V_3 ) ;
return F_1 ( V_1 , V_2 , V_3 ) ;
}
static T_1 F_4 ( T_1 V_1 , void T_2 * V_2 , const void * V_3 )
{
...
static T_1 F_7 ( T_1 V_1 , void T_2 * V_7 ,
const void T_2 * V_8 )
{
...
static T_1 F_8 ( T_1 V_1 , void T_2 * V_7 )
{
register unsigned long T_3 V_4 ( L_1 ) = 0x810000UL ;
unsigned long V_5 , V_6 ;
V_5 = - 4096UL ;
...
static T_1 F_9 ( T_1 V_9 , const char T_2 * V_10 )
{
...
do {
V_13 = ( T_1 ) V_10 & ~ V_16 ;
V_12 = F_10 ( 256UL , V_17 - V_13 ) ;
V_12 = F_10 ( V_9 - V_11 , V_12 ) ;
...
static T_1 F_12 ( T_1 V_9 , const char T_2 * V_10 ,
char * V_18 )
{
T_1 V_11 , V_12 , V_13 , V_14 ;
if ( F_13 ( ! V_9 ) )
