...
static T_1
F_42 ( struct V_39 * V_52 , const char T_2 * V_53 ,
T_3 V_54 , T_4 * V_55 )
{
char V_56 [ 64 ] ;
int V_5 ;
bool V_57 = false , V_50 ;
bool V_58 = false ;
int V_28 = - 1 ;
struct V_6 * V_7 = NULL ;
if ( V_54 > 63 )
V_54 = 63 ;
if ( F_43 ( V_56 , V_53 , V_54 ) )
return - V_59 ;
F_6 ( & V_13 ) ;
if ( ! V_1 . V_2 ) {
V_54 = - V_14 ;
...
static void F_11 ( struct V_1 * V_64 )
{
if ( V_64 -> V_65 ) {
F_45 ( V_64 -> V_65 ) ;
V_64 -> V_65 = NULL ;
...
static int F_4 ( struct V_1 * V_64 )
{
if ( V_64 -> V_66 )
return 0 ;
V_64 -> V_66 = F_46 ( L_21 , NULL ) ;
if ( ! V_64 -> V_66 ) {
F_8 ( V_51 L_22 ) ;
goto V_67;
}
V_64 -> V_65 = F_47 ( L_23 , 0644 ,
V_64 -> V_66 , NULL , & V_68 ) ;
if ( ! V_64 -> V_65 ) {
F_8 ( V_51 L_24 ) ;
goto V_67;
