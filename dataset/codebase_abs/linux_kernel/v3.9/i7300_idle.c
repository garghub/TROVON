...
static T_8 F_46 ( struct V_88 * V_89 , char T_9 * V_90 , T_10 V_91 ,
T_11 * V_92 )
{
unsigned long * V_93 = V_89 -> V_94 ;
char V_95 [ 32 ] ;
int V_96 ;
V_96 = snprintf ( V_95 , 32 , L_15 , * V_93 ) ;
return F_47 ( V_90 , V_91 , V_92 , V_95 , V_96 ) ;
}
static int T_3 F_48 ( void )
{
F_49 ( & V_76 ) ;
V_87 = 0 ;
if ( F_50 ( & V_50 , & V_28 , V_97 ) )
return - V_47 ;
if ( F_23 () )
return - V_47 ;
if ( F_10 () )
