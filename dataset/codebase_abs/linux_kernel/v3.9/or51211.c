...
static int F_11 ( struct V_14 * V_15 , T_2 * V_40 )
{
struct V_1 * V_2 = V_15 -> V_18 ;
unsigned char V_28 [ 2 ] ;
unsigned char V_41 [] = { 0x04 , 0x00 , 0x03 , 0x00 } ;
* V_40 = 0 ;
if ( F_1 ( V_2 , V_2 -> V_23 -> V_25 , V_41 , 3 ) ) {
F_3 ( L_13 ) ;
return - 1 ;
}
F_7 ( 3 ) ;
...
static T_3 F_12 ( T_3 V_47 , T_3 V_48 )
{
if ( V_47 == 0 )
return 0 ;
V_47 = 2 * F_13 ( V_47 ) ;
...
static int F_14 ( struct V_14 * V_15 , T_4 * V_49 )
{
struct V_1 * V_2 = V_15 -> V_18 ;
T_1 V_28 [ 2 ] ;
T_1 V_41 [ 3 ] ;
...
V_2 -> V_49 = F_12 ( V_28 [ 0 ] , 89599047 ) ;
* V_49 = ( V_2 -> V_49 ) >> 16 ;
F_6 ( L_18 , V_28 [ 0 ] ,
V_2 -> V_49 >> 24 , ( ( ( V_2 -> V_49 >> 8 ) & 0xffff ) * 100 ) >> 16 ) ;
return 0 ;
}
static int F_15 ( struct V_14 * V_15 , T_4 * V_50 )
{
struct V_1 * V_2 = (struct V_1 * ) V_15 -> V_18 ;
T_4 V_49 ;
int V_51 ;
V_51 = V_15 -> V_36 . V_52 ( V_15 , & V_49 ) ;
if ( V_51 != 0 )
return V_51 ;
...
static int F_16 ( struct V_14 * V_15 , T_3 * V_53 )
{
* V_53 = - V_54 ;
return 0 ;
}
static int F_17 ( struct V_14 * V_15 , T_3 * V_55 )
{
* V_55 = - V_54 ;
return 0 ;
}
...
{
struct V_1 * V_2 = V_15 -> V_18 ;
const struct V_56 * V_23 = V_2 -> V_23 ;
const struct V_16 * V_17 ;
unsigned char V_57 [] = { 0x04 , 0x00 , 0x30 , 0x00 , 0x00 } ;
unsigned char V_28 [ 14 ] ;
int V_51 , V_20 ;
if ( ! V_2 -> V_58 ) {
F_8 ( L_19 ,
V_59 ) ;
V_51 = V_23 -> V_60 ( V_15 , & V_17 ,
V_59 ) ;
F_8 ( L_20 ) ;
if ( V_51 ) {
F_3 ( L_21
...
struct V_14 * F_24 ( const struct V_56 * V_23 ,
struct V_67 * V_11 )
{
struct V_1 * V_2 = NULL ;
...
V_2 -> V_58 = 0 ;
V_2 -> V_34 = 0 ;
memcpy ( & V_2 -> V_69 . V_36 , & V_70 , sizeof( struct V_71 ) ) ;
V_2 -> V_69 . V_18 = V_2 ;
return & V_2 -> V_69 ;
}
