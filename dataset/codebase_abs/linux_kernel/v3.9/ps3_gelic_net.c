...
unsigned int V_45 ;
T_5 V_135 ;
V_135 = * ( T_5 * ) ( V_30 -> V_58 -> V_64 ) & V_136 ;
...
F_125 ( F_126 ( struct V_1 , V_30 ) % 32 ) ;
V_232 =
sizeof( struct V_1 ) +
sizeof( struct V_33 ) * V_233 +
sizeof( struct V_33 ) * V_31 +
V_234 - 1 ;
V_89 = F_127 ( V_232 , V_235 ) ;
if ( ! V_89 )
return NULL ;
V_2 = F_128 ( V_89 , V_234 ) ;
V_2 -> V_236 = V_89 ;
...
for ( V_45 = 0 ; V_45 < F_137 ( V_238 ) ; V_45 ++ ) {
V_4 = F_10 ( F_3 ( V_2 ) , F_4 ( V_2 ) ,
V_242 ,
V_238 [ V_45 ] . V_121 ,
0 , 0 , & V_19 , & V_9 ) ;
...
static int F_138 ( struct V_244 * V_77 )
{
struct V_1 * V_2 ;
struct V_10 * V_15 ;
int V_123 ;
...
static int F_157 ( struct V_244 * V_77 )
{
struct V_1 * V_2 = F_158 ( V_77 ) ;
struct V_10 * V_261 ;
F_16 ( L_3 , V_5 ) ;
F_13 ( V_2 , V_186 ) ;
#ifdef F_96
...
F_152 ( V_2 -> V_151 , V_2 ) ;
V_261 -> V_151 = V_260 ;
F_153 ( V_2 -> V_77 , V_2 -> V_151 ) ;
F_160 ( V_2 -> V_237 ,
F_161 ( & V_2 -> V_214 ) == 0 ) ;
F_143 ( F_3 ( V_2 ) , F_4 ( V_2 ) ,
0 , 0 ) ;
F_162 ( V_261 ) ;
F_130 ( F_54 ( V_261 ) -> V_236 ) ;
F_154 ( V_261 ) ;
F_142 ( V_77 , NULL ) ;
F_155 ( V_77 -> V_247 ) ;
F_156 ( V_77 ) ;
