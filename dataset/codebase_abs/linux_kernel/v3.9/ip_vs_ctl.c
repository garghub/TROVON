...
V_417 [ V_158 ++ ] . V_180 = & V_15 -> V_441 ;
V_15 -> V_442 = F_229 ( V_2 , L_63 , V_417 ) ;
if ( V_15 -> V_442 == NULL ) {
if ( ! F_38 ( V_2 , & V_418 ) )
F_51 ( V_417 ) ;
return - V_125 ;
...
F_236 ( L_64 , 0 , V_2 -> V_445 , & V_446 ) ;
F_236 ( L_65 , 0 , V_2 -> V_445 , & V_447 ) ;
F_236 ( L_66 , 0 , V_2 -> V_445 ,
& V_448 ) ;
if ( F_224 ( V_2 ) )
goto V_449;
return 0 ;
...
F_92 ( V_2 , & V_15 -> V_170 ) ;
F_231 ( V_2 ) ;
F_238 ( L_66 , V_2 -> V_445 ) ;
F_238 ( L_65 , V_2 -> V_445 ) ;
F_238 ( L_64 , V_2 -> V_445 ) ;
F_50 ( V_15 -> V_170 . V_78 ) ;
}
int T_10 F_239 ( void )
{
