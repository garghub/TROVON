...
V_105 = F_26 ( V_10 -> V_39 ) ;
V_69 = F_27 ( V_91 -> V_110 ) ;
V_96 = F_27 ( V_91 -> V_111 ) - F_27 ( V_91 -> V_110 ) ;
V_97 = F_27 ( V_91 -> V_112 ) - F_27 ( V_91 -> V_111 ) ;
V_98 = F_27 ( V_91 -> V_113 ) ;
if ( V_89 ) {
V_98 += * V_89 ;
* V_89 = V_98 ;
}
V_108 = F_27 ( V_91 -> V_114 ) ;
V_99 = F_27 ( V_91 -> V_99 ) ;
V_107 = F_27 ( V_91 -> V_107 ) ;
...
if ( V_107 == V_120 && V_66 != 0 ) {
F_2 ( L_33 ,
( int ) V_119 ) ;
V_32 = - V_45 ;
goto V_116;
}
if ( V_107 == V_120 && F_28 ( V_99 ) )
V_99 = V_121 ;
#ifndef F_29
if ( V_99 & ( V_122 | V_123 ) ) {
F_2 ( L_34 ) ;
...
V_102 = F_34 (unsigned long, bss_len + stack_len,
relocs * sizeof(unsigned long)) ;
if ( ( V_99 & ( V_121 | V_122 ) ) == 0 ) {
F_8 ( L_35 ) ;
V_92 = F_35 ( V_10 -> V_39 , 0 , V_69 , V_127 | V_128 ,
V_129 | V_130 , 0 ) ;
if ( ! V_92 || F_18 ( V_92 ) ) {
if ( ! V_92 )
...
V_83 = ( unsigned long * ) ( V_93 + ( F_27 ( V_91 -> V_133 ) - V_69 ) ) ;
V_100 = V_95 ;
V_101 = V_27 ;
} else {
...
V_95 = V_92 + F_27 ( V_91 -> V_110 ) ;
V_93 = F_38 ( V_95 +
V_71 * sizeof( unsigned long ) ,
V_132 ) ;
V_83 = ( unsigned long * )
( V_93 + ( F_27 ( V_91 -> V_133 ) - V_69 ) ) ;
V_100 = V_92 ;
V_101 = V_27 ;
#ifdef F_29
if ( V_99 & V_122 ) {
...
if ( V_99 & V_117 )
F_2 ( L_42 ,
( int ) V_92 , 0x00ffffff & F_27 ( V_91 -> V_134 ) , F_27 ( V_91 -> V_110 ) ) ;
...
V_3 -> V_20 -> V_135 = ( V_3 -> V_20 -> V_67 + 3 ) & ~ 3 ;
V_3 -> V_20 -> V_136 . V_137 = V_100 + V_101 - V_98 ;
}
if ( V_99 & V_117 )
F_2 ( L_43 ,
V_66 ? L_44 : L_45 , V_10 -> V_118 ,
( int ) V_70 , ( int ) V_109 ,
( int ) V_93 ,
( int ) ( V_93 + V_96 ) ,
( int ) ( V_93 + V_96 ) ,
...
V_88 -> V_73 [ V_66 ] . V_134 = ( 0x00ffffff & F_27 ( V_91 -> V_134 ) ) + V_92 ;
V_88 -> V_73 [ V_66 ] . V_75 = F_27 ( V_91 -> V_75 ) ;
if ( V_99 & V_138 ) {
...
unsigned long V_65 , V_140 ;
V_140 = F_27 ( V_83 [ V_106 ] ) ;
if ( F_39 ( V_140 , & V_139 ) )
continue;
V_65 = F_40 ( V_140 ) ;
...
F_42 ( V_104 , V_65 , V_140 ) ;
}
}
} else {
for ( V_106 = 0 ; V_106 < V_108 ; V_106 ++ )
F_22 ( F_27 ( V_83 [ V_106 ] ) ) ;
}
F_43 ( V_70 , V_109 ) ;
...
static int F_19 ( int V_66 , struct V_62 * V_141 )
{
struct V_9 V_10 ;
int V_142 ;
char V_29 [ 16 ] ;
...
V_10 . V_118 = V_29 ;
V_10 . V_39 = F_44 ( V_10 . V_118 ) ;
V_142 = F_45 ( V_10 . V_39 ) ;
if ( F_46 ( V_10 . V_39 ) )
return V_142 ;
V_10 . V_143 = F_47 () ;
V_142 = - V_36 ;
...
V_142 = F_48 ( & V_10 ) ;
if ( ! F_18 ( V_142 ) )
V_142 = F_25 ( & V_10 , V_141 , V_66 , NULL ) ;
F_49 ( V_10 . V_143 ) ;
V_144:
F_50 ( V_10 . V_39 ) ;
F_51 ( V_10 . V_39 ) ;
...
#define F_54 (PAGE_SIZE * MAX_ARG_PAGES - sizeof(void *))
V_98 = F_54 - V_10 -> V_14 ;
V_98 += ( V_10 -> V_15 + 1 ) * sizeof( char * ) ;
V_98 += ( V_10 -> V_16 + 1 ) * sizeof( char * ) ;
V_98 += V_19 - 1 ;
V_142 = F_25 ( V_10 , & V_88 , 0 , & V_98 ) ;
if ( F_18 ( V_142 ) )
return V_142 ;
for ( V_106 = 0 ; V_106 < V_71 ; V_106 ++ )
if ( V_88 . V_73 [ V_106 ] . V_74 )
for ( V_149 = 0 ; V_149 < V_71 ; V_149 ++ )
( - ( V_149 + 1 ) ) [ ( unsigned long * ) ( V_88 . V_73 [ V_106 ] . V_68 ) ] =
( V_88 . V_73 [ V_149 ] . V_74 ) ?
V_88 . V_73 [ V_149 ] . V_68 : V_150 ;
F_55 ( V_10 ) ;
F_56 ( & V_151 ) ;
V_14 = ( ( V_3 -> V_20 -> V_136 . V_137 + V_98 + 3 ) & ~ 3 ) - 4 ;
F_8 ( L_47 , ( int ) V_14 ) ;
for ( V_106 = F_54 - 1 ; V_106 >= V_10 -> V_14 ; V_106 -- )
* ( char * ) -- V_14 =
( ( char * ) F_57 ( V_10 -> V_152 [ V_106 / V_153 ] ) ) [ V_106 % V_153 ] ;
V_13 = ( unsigned long * ) F_3 ( V_14 , V_10 ) ;
V_148 = V_88 . V_73 [ 0 ] . V_134 ;
#ifdef F_17
for ( V_106 = V_71 - 1 ; V_106 > 0 ; V_106 -- ) {
if ( V_88 . V_73 [ V_106 ] . V_74 ) {
-- V_13 ; F_5 ( V_148 , V_13 ) ;
V_148 = V_88 . V_73 [ V_106 ] . V_134 ;
}
}
#endif
V_3 -> V_20 -> V_154 = ( unsigned long ) V_13 ;
#ifdef F_58
F_58 ( V_147 ) ;
#endif
F_8 ( L_48 ,
( int ) V_147 , ( int ) V_148 , ( int ) V_3 -> V_20 -> V_154 ) ;
F_59 ( V_147 , V_148 , V_3 -> V_20 -> V_154 ) ;
return 0 ;
}
