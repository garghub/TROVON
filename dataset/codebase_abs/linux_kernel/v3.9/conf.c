...
unsigned int V_66 ;
F_37 ( & V_65 , NULL ) ;
V_66 = ( unsigned int ) ( ( V_65 . V_67 + 1 ) * ( V_65 . V_68 + 1 ) ) ;
srand ( V_66 ) ;
break;
}
case V_15 :
...
if ( ! V_24 )
break;
if ( ( strcmp ( V_24 , L_10 ) != 0 ) && ( strcmp ( V_24 , L_57 ) != 0 ) ) {
if ( F_42 ( V_24 , V_75 ) ) {
fprintf ( V_74 ,
_ ( L_58 ) ,
V_24 ) ;
...
switch ( V_12 ) {
case V_69 : V_24 = L_59 ; break;
case V_70 : V_24 = L_60 ; break;
case V_71 : V_24 = L_61 ; break;
case V_72 : V_24 = L_62 ; break;
case V_63 : V_24 = L_63 ; break;
default: break;
}
if ( F_42 ( V_24 , V_75 ) &&
F_42 ( L_64 , V_75 ) ) {
...
void F_12 ( char * V_4 , int V_82 , T_2 * V_83 )
{
if ( fgets ( V_4 , V_82 , V_83 ) == NULL )
fprintf ( V_74 , L_71 ) ;
}
