...
static int F_59 ( struct V_1 * V_2 , struct V_54 * V_55 , void * V_99 )
{
struct V_52 * V_52 = F_15 ( V_2 -> V_53 ) ;
struct V_40 * V_68 ;
struct V_5 * V_6 ;
...
V_24 = 0 ;
if ( ! V_31 -> V_38 && ! V_31 -> V_103 &&
F_55 ( V_8 -> V_6 ) )
F_65 ( & V_31 -> V_104 , V_107 ) ;
break;
}
V_102:
F_58 ( & V_8 -> V_98 ) ;
...
static int F_66 ( struct V_1 * V_2 , struct V_54 * V_55 , void * V_99 )
{
struct V_5 * V_6 ;
struct V_40 * V_68 ;
struct V_7 * V_8 ;
