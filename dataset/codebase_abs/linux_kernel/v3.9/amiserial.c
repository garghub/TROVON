...
static void F_75 ( struct V_14 * V_15 , struct V_108 * V_109 )
{
struct V_1 * V_2 = V_15 -> V_16 ;
unsigned long V_17 ;
...
static void F_77 ( struct V_14 * V_15 , struct V_196 * V_197 )
{
struct V_1 * V_102 = V_15 -> V_16 ;
struct V_65 * V_66 = & V_102 -> V_53 ;
if ( F_1 ( V_102 , V_15 -> V_3 , L_34 ) )
return;
if ( F_78 ( V_66 , V_15 , V_197 ) == 0 )
return;
V_102 -> V_51 &= ~ V_36 ;
if ( V_66 -> V_17 & V_91 ) {
V_20 . V_21 = V_37 ;
...
static void F_79 ( struct V_14 * V_15 , int V_124 )
{
struct V_1 * V_2 = V_15 -> V_16 ;
...
return;
V_198 = V_201 ;
V_199 = ( V_2 -> V_124 - V_126 / 50 ) / V_2 -> V_125 ;
V_199 = V_199 / 5 ;
if ( V_199 == 0 )
V_199 = 1 ;
if ( V_124 )
V_199 = F_82 (unsigned long, char_time, timeout) ;
if ( ! V_124 || V_124 > 2 * V_2 -> V_124 )
V_124 = 2 * V_2 -> V_124 ;
#ifdef F_83
F_3 ( L_36 , V_124 , V_199 ) ;
F_3 ( L_37 , V_201 ) ;
#endif
...
if ( F_74 ( V_188 ) )
break;
if ( V_124 && F_86 ( V_201 , V_198 + V_124 ) )
break;
}
F_87 ( V_202 ) ;
#ifdef F_83
...
static int F_89 ( struct V_14 * V_15 , struct V_196 * V_197 )
{
...
return F_90 ( V_66 , V_15 , V_197 ) ;
}
static inline void F_91 ( struct V_205 * V_206 , int line ,
struct V_1 * V_102 )
{
char V_207 [ 30 ] , V_161 , V_29 ;
unsigned long V_17 ;
F_92 ( V_206 , L_42 , line ) ;
F_6 ( V_17 ) ;
V_29 = V_10 . V_11 ;
...
strcat ( V_207 , L_47 ) ;
if ( V_102 -> V_110 )
F_92 ( V_206 , L_48 , V_102 -> V_111 / V_102 -> V_110 ) ;
F_92 ( V_206 , L_49 , V_102 -> V_34 . V_60 , V_102 -> V_34 . V_41 ) ;
if ( V_102 -> V_34 . V_47 )
F_92 ( V_206 , L_50 , V_102 -> V_34 . V_47 ) ;
if ( V_102 -> V_34 . V_46 )
F_92 ( V_206 , L_51 , V_102 -> V_34 . V_46 ) ;
if ( V_102 -> V_34 . V_45 )
F_92 ( V_206 , L_52 , V_102 -> V_34 . V_45 ) ;
if ( V_102 -> V_34 . V_48 )
F_92 ( V_206 , L_53 , V_102 -> V_34 . V_48 ) ;
F_92 ( V_206 , L_54 , V_207 + 1 ) ;
}
static int F_93 ( struct V_205 * V_206 , void * V_208 )
{
F_92 ( V_206 , L_55 , V_209 ) ;
F_91 ( V_206 , 0 , & V_204 [ 0 ] ) ;
return 0 ;
}
static int F_94 ( struct V_210 * V_210 , struct V_196 * V_196 )
{
return F_95 ( V_196 , F_93 , NULL ) ;
}
...
static void F_98 ( struct V_65 * V_66 , int raise )
{
struct V_1 * V_2 = F_99 ( V_66 , struct V_1 ,
V_53 ) ;
unsigned long V_17 ;
if ( raise )
V_2 -> V_95 |= V_13 | V_12 ;
...
static int T_4 F_100 ( struct V_213 * V_214 )
{
unsigned long V_17 ;
struct V_1 * V_102 ;
int error ;
...
static int T_5 F_110 ( struct V_213 * V_214 )
{
int error ;
struct V_1 * V_102 = F_111 ( V_214 ) ;
...
{
return F_113 ( & V_239 , F_100 ) ;
}
static void T_5 F_114 ( void )
{
F_115 ( & V_239 ) ;
}
static void F_116 ( char V_135 )
{
V_20 . V_59 = ( unsigned char ) V_135 | 0x100 ;
while ( ! ( V_20 . V_30 & 0x2000 ) )
F_117 () ;
}
static void F_118 ( struct V_240 * V_241 , const char * V_242 ,
unsigned V_134 )
{
...
static struct V_243 * F_119 ( struct V_240 * V_135 , int * V_144 )
{
* V_144 = 0 ;
return V_215 ;
}
