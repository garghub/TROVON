...
V_30 = F_41 ( & V_11 -> V_108 , sizeof( struct V_1 ) , V_111 ) ;
if ( ! V_30 )
return - V_112 ;
V_3 = & V_30 -> V_3 ;
...
if ( V_103 != 0x02 )
F_34 ( V_3 , L_21 ) ;
error = F_16 ( V_3 , V_115 ) ;
if ( error < 0 )
return error ;
V_101 = 0x20 | V_30 -> V_113 -> V_116 << 5
| V_30 -> V_113 -> V_117 << 2 ;
error = F_10 ( V_3 , V_118 , V_101 ) ;
if ( error < 0 )
return error ;
V_102 = 0x01 | V_30 -> V_113 -> V_119 << 2
| V_30 -> V_113 -> V_120 << 1
| V_30 -> V_113 -> V_121 ;
error = F_10 ( V_3 , V_122 , V_102 ) ;
if ( error < 0 )
return error ;
