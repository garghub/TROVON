...
if ( V_25 -> V_119 ) {
F_83 ( V_112 , ' ' ) ;
V_25 -> V_119 ( V_112 , V_117 ) ;
}
F_83 ( V_112 , '\n' ) ;
} else {
struct V_1 * V_2 = F_84 ( V_117 ) ;
struct V_36 * V_120 = F_24 ( V_2 ) ;
F_85 ( V_112 ,
L_11 ,
V_2 ,
F_86 ( & V_2 -> V_121 ) ,
F_87 ( V_2 ) ,
F_70 ( V_2 ) ,
F_88 ( F_89 ( V_112 ) , F_90 ( V_2 ) ) ,
F_91 ( V_2 ) ,
& V_120 -> V_122 ,
& V_120 -> V_123 ,
V_120 -> V_28 ? F_91 ( V_120 -> V_28 ) : 0LU ) ;
if ( V_25 -> V_119 ) {
F_83 ( V_112 , ' ' ) ;
V_25 -> V_119 ( V_112 , V_117 ) ;
}
...
static int F_92 ( struct V_124 * V_124 , struct V_82 * V_82 )
{
struct V_24 * V_125 ;
struct V_115 * V_116 ;
V_125 = F_93 ( V_124 ) -> V_126 ;
V_116 = F_94 ( V_82 , & V_127 ,
sizeof( struct V_115 ) ) ;
if ( ! V_116 )
return - V_128 ;
V_116 -> V_25 = V_125 ;
...
int F_95 ( struct V_129 * V_129 , struct V_17 * V_17 , const char * V_130 ,
struct V_24 * V_125 ,
int (* F_96)( struct V_111 * , void * ) )
{
struct V_131 * V_132 ;
V_125 -> V_119 = F_96 ;
V_125 -> V_133 . V_23 = V_129 ;
V_125 -> V_133 . V_134 = F_92 ;
V_125 -> V_133 . V_135 = V_136 ;
V_125 -> V_133 . V_137 = V_138 ;
V_125 -> V_133 . V_139 = V_140 ;
V_132 = F_97 ( V_130 , 0 , V_17 -> V_141 , & V_125 -> V_133 ) ;
if ( ! V_132 )
return - V_128 ;
V_132 -> V_126 = V_125 ;
return 0 ;
}
void F_98 ( struct V_17 * V_17 , const char * V_130 )
{
F_99 ( V_130 , V_17 -> V_141 ) ;
}
int F_95 ( struct V_129 * V_129 , struct V_17 * V_17 , const char * V_130 ,
struct V_24 * V_125 ,
int (* F_96)( struct V_111 * , void * ) )
