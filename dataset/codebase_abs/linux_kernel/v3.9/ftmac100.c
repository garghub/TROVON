...
static int F_103 ( struct V_11 * V_12 , struct V_119 * V_120 )
{
struct V_1 * V_2 = F_95 ( V_12 ) ;
return F_104 ( & V_2 -> V_121 , V_120 ) ;
}
static int F_105 ( struct V_11 * V_12 , struct V_119 * V_120 )
{
struct V_1 * V_2 = F_95 ( V_12 ) ;
...
V_2 -> V_64 = & V_152 -> V_64 ;
F_138 ( & V_2 -> V_96 ) ;
F_139 ( V_12 , & V_2 -> V_124 , F_115 , 64 ) ;
V_2 -> V_154 = F_140 ( V_154 -> V_162 , F_141 ( V_154 ) ,
F_102 ( & V_152 -> V_64 ) ) ;
if ( ! V_2 -> V_154 ) {
F_142 ( & V_152 -> V_64 , L_23 ) ;
V_102 = - V_100 ;
goto V_163;
}
V_2 -> V_4 = F_143 ( V_154 -> V_162 , F_141 ( V_154 ) ) ;
if ( ! V_2 -> V_4 ) {
F_142 ( & V_152 -> V_64 , L_24 ) ;
V_102 = - V_17 ;
goto V_164;
}
V_2 -> V_122 = V_122 ;
...
static int T_5 F_151 ( struct V_151 * V_152 )
{
struct V_11 * V_12 ;
struct V_1 * V_2 ;
V_12 = F_152 ( V_152 ) ;
