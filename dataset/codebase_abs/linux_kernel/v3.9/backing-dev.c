...
static void F_40 ( unsigned long V_53 )
{
...
unsigned long V_56 ;
V_56 = F_47 ( V_57 * 10 ) ;
F_48 ( & V_10 -> V_12 . V_58 , V_59 + V_56 ) ;
}
static unsigned long F_49 ( void )
{
unsigned long V_60 ;
V_60 = F_47 ( V_57 * 10 ) ;
return F_50 ( 5UL * 60 * V_61 , V_60 ) ;
}
...
if ( F_39 ( V_64 ) || ! F_14 ( & V_64 -> V_10 -> V_73 ) ) {
F_58 ( & V_64 -> V_58 ) ;
F_59 ( V_64 , 0 ) ;
}
F_41 ( & V_74 ) ;
...
int F_37 ( struct V_9 * V_10 , struct V_33 * V_82 ,
const char * V_83 , ... )
{
T_5 args ;
struct V_33 * V_34 ;
...
return 0 ;
va_start ( args , V_83 ) ;
V_34 = F_77 ( V_46 , V_82 , F_78 ( 0 , 0 ) , V_10 , V_83 , args ) ;
va_end ( args ) ;
if ( F_33 ( V_34 ) )
return F_34 ( V_34 ) ;
V_10 -> V_34 = V_34 ;
if ( F_62 ( V_10 ) ) {
struct V_1 * V_12 = & V_10 -> V_12 ;
V_12 -> V_55 = F_79 ( F_55 , V_12 , L_20 ,
F_69 ( V_34 ) ) ;
if ( F_33 ( V_12 -> V_55 ) )
return F_34 ( V_12 -> V_55 ) ;
}
F_17 ( V_10 , F_69 ( V_34 ) ) ;
F_65 ( V_77 , & V_10 -> V_26 ) ;
F_41 ( & V_74 ) ;
...
int F_82 ( struct V_9 * V_10 , T_6 V_34 )
{
return F_37 ( V_10 , NULL , L_21 , F_83 ( V_34 ) , F_84 ( V_34 ) ) ;
}
...
static void F_92 ( struct V_1 * V_12 , struct V_9 * V_10 )
{
...
F_93 ( & V_12 -> V_93 ) ;
F_94 ( & V_12 -> V_4 ) ;
F_95 ( & V_12 -> V_58 , F_40 , ( unsigned long ) V_10 ) ;
}
...
F_1 ( & V_10 -> V_12 , V_108 ) ;
F_100 ( & V_10 -> V_12 . V_91 , & V_108 -> V_91 ) ;
F_100 ( & V_10 -> V_12 . V_92 , & V_108 -> V_92 ) ;
F_100 ( & V_10 -> V_12 . V_93 , & V_108 -> V_93 ) ;
F_8 ( & V_10 -> V_12 . V_4 ) ;
F_8 ( & V_108 -> V_4 ) ;
}
F_88 ( V_10 ) ;
...
int F_102 ( struct V_9 * V_10 , char * V_29 ,
unsigned int V_109 )
{
char V_110 [ 32 ] ;
int V_50 ;
...
if ( V_50 )
return V_50 ;
sprintf ( V_110 , L_22 , V_29 , L_23 ) ;
V_50 = F_37 ( V_10 , NULL , V_110 , F_103 ( & V_112 ) ) ;
if ( V_50 ) {
F_99 ( V_10 ) ;
return V_50 ;
}
...
void F_104 ( struct V_9 * V_10 , int V_113 )
{
enum V_114 V_115 ;
T_7 * V_116 = & V_117 [ V_113 ] ;
V_115 = V_113 ? V_118 : V_119 ;
if ( F_105 ( V_115 , & V_10 -> V_26 ) )
F_106 ( & V_120 [ V_113 ] ) ;
F_53 () ;
if ( F_107 ( V_116 ) )
F_108 ( V_116 ) ;
}
void F_109 ( struct V_9 * V_10 , int V_113 )
{
enum V_114 V_115 ;
V_115 = V_113 ? V_118 : V_119 ;
if ( ! F_110 ( V_115 , & V_10 -> V_26 ) )
F_111 ( & V_120 [ V_113 ] ) ;
}
long F_112 ( int V_113 , long V_56 )
{
long V_40 ;
unsigned long V_121 = V_59 ;
F_113 ( V_122 ) ;
T_7 * V_116 = & V_117 [ V_113 ] ;
F_114 ( V_116 , & V_122 , V_85 ) ;
V_40 = F_115 ( V_56 ) ;
F_116 ( V_116 , & V_122 ) ;
F_117 ( F_118 ( V_56 ) ,
F_118 ( V_59 - V_121 ) ) ;
...
long F_119 ( struct V_123 * V_123 , int V_113 , long V_56 )
{
long V_40 ;
unsigned long V_121 = V_59 ;
F_113 ( V_122 ) ;
T_7 * V_116 = & V_117 [ V_113 ] ;
if ( F_120 ( & V_120 [ V_113 ] ) == 0 ||
! F_121 ( V_123 ) ) {
F_122 () ;
V_40 = V_56 - ( V_59 - V_121 ) ;
if ( V_40 < 0 )
V_40 = 0 ;
goto V_124;
}
...
int F_124 ( struct V_125 * V_126 , int V_127 ,
...
if ( F_125 ( V_128 , V_131 , sizeof( V_131 ) ) )
return - V_132 ;
F_126 ( V_133 L_25 ,
V_126 -> V_134 ) ;
* V_129 = 2 ;
