...
int F_179 ( struct V_36 * V_39 , T_2 * V_267 )
{
struct V_3 * V_4 ;
struct V_268 * V_6 ;
int V_161 = 0 ;
...
* V_267 = V_39 -> V_269 . V_273 + 1 ;
return V_161 ;
}
void F_180 ( struct V_36 * V_39 , T_2 V_267 )
{
struct V_3 * V_4 ;
struct V_268 * V_6 ;
if ( ! F_126 ( V_39 ) && ! F_123 ( V_39 ) ) {
...
int V_29 ( struct V_277 * V_277 , int V_204 )
{
int V_60 ;
int V_1 = V_204 ? V_136 : V_137 ;
struct V_29 * V_108 = V_277 -> V_278 ;
struct V_36 * V_39 = F_46 ( V_277 -> V_279 ) ;
F_11 ( ! V_108 ) ;
if ( F_126 ( V_39 ) ) {
if ( V_204 )
return - V_211 ;
...
void F_188 ( struct V_277 * V_277 , int V_204 )
{
int V_1 = V_204 ? V_136 : V_137 ;
struct V_29 * V_108 = V_277 -> V_278 ;
struct V_36 * V_39 = F_46 ( V_277 -> V_279 ) ;
...
static void F_189 ( struct V_280 * V_280 )
{
struct V_49 * V_50 ;
V_50 = F_9 ( V_280 , struct V_49 , V_281 ) ;
F_190 ( V_50 ) ;
}
void F_191 ( struct V_49 * V_50 )
{
if ( V_50 )
F_192 ( & V_50 -> V_281 , F_189 ) ;
}
static void F_193 ( struct V_49 * V_282 )
{
F_194 ( & V_282 -> V_281 ) ;
}
...
{
struct V_49 * V_50 ;
V_50 = F_196 ( sizeof( struct V_49 ) , V_283 ) ;
if ( ! V_50 ) {
F_113 ( - V_284 ) ;
goto V_163;
}
...
static struct V_3 * F_198 ( struct V_3 * V_286 ,
struct V_287 * V_73 )
{
struct V_3 * V_288 , * V_60 = NULL ;
struct V_49 * V_50 = V_73 -> V_289 ;
F_68 ( & V_51 ) ;
F_199 (iter, &start->l_debug_list, l_debug_list) {
if ( & V_288 -> V_52 == & V_50 -> V_53 ) {
F_3 ( 0 , L_60 , V_60 ) ;
break;
}
if ( V_288 -> V_37 != NULL ) {
...
static void * F_200 ( struct V_290 * V_291 , T_6 * V_292 )
{
struct V_287 * V_73 = V_291 -> V_293 ;
struct V_3 * V_288 ;
F_21 ( & V_51 ) ;
V_288 = F_198 ( & V_73 -> V_294 , V_73 ) ;
if ( V_288 ) {
V_73 -> V_295 = * V_288 ;
V_288 = & V_73 -> V_295 ;
}
...
static void F_201 ( struct V_290 * V_291 , void * V_296 )
{
}
static void * F_202 ( struct V_290 * V_291 , void * V_296 , T_6 * V_292 )
{
struct V_287 * V_73 = V_291 -> V_293 ;
struct V_3 * V_288 = V_296 ;
struct V_3 * V_297 = & V_73 -> V_294 ;
F_21 ( & V_51 ) ;
V_288 = F_198 ( V_288 , V_73 ) ;
F_26 ( & V_297 -> V_52 ) ;
if ( V_288 ) {
F_22 ( & V_297 -> V_52 , & V_288 -> V_52 ) ;
V_73 -> V_295 = * V_288 ;
V_288 = & V_73 -> V_295 ;
}
F_23 ( & V_51 ) ;
...
static int F_203 ( struct V_290 * V_291 , void * V_296 )
{
int V_298 ;
char * V_6 ;
...
if ( ! V_4 )
return - V_217 ;
F_204 ( V_291 , L_61 , V_299 ) ;
if ( V_4 -> V_21 == V_30 )
F_204 ( V_291 , L_62 , V_107 - 1 ,
V_4 -> V_8 ,
( unsigned int ) F_50 ( V_4 ) ) ;
else
F_204 ( V_291 , L_63 , V_47 , V_4 -> V_8 ) ;
F_204 ( V_291 , L_64
L_65
L_61
L_61
...
{
struct V_290 * V_301 = V_213 -> V_215 ;
struct V_287 * V_73 = V_301 -> V_293 ;
struct V_3 * V_34 = & V_73 -> V_294 ;
F_24 ( V_34 ) ;
F_191 ( V_73 -> V_289 ) ;
...
struct V_290 * V_301 ;
struct V_36 * V_39 ;
V_73 = F_218 ( sizeof( struct V_287 ) , V_283 ) ;
if ( ! V_73 ) {
V_60 = - V_284 ;
F_113 ( V_60 ) ;
goto V_163;
...
V_39 = V_27 -> V_302 ;
F_193 ( V_39 -> V_84 ) ;
V_73 -> V_289 = V_39 -> V_84 ;
F_42 ( & V_73 -> V_294 . V_52 ) ;
V_60 = F_219 ( V_213 , & V_303 ) ;
if ( V_60 ) {
F_190 ( V_73 ) ;
F_113 ( V_60 ) ;
goto V_163;
...
V_39 -> V_311 = F_225 ( V_312 , V_39 , L_71 ) ;
if ( F_226 ( V_39 -> V_311 ) ) {
V_161 = F_227 ( V_39 -> V_311 ) ;
V_39 -> V_311 = NULL ;
F_113 ( V_161 ) ;
goto V_175;
}
V_161 = F_228 ( V_39 -> V_313 ,
V_39 -> V_314 ,
strlen ( V_39 -> V_314 ) ,
& V_170 , V_315 , V_39 ,
& V_309 ) ;
...
V_205:
F_54 ( & V_39 -> V_274 , V_39 ) ;
F_55 ( & V_39 -> V_275 , V_39 ) ;
F_56 ( & V_39 -> V_276 , V_39 ) ;
F_57 ( & V_39 -> V_269 . V_270 , V_39 ) ;
V_39 -> V_176 = V_309 ;
V_161 = 0 ;
V_175:
if ( V_161 < 0 ) {
...
F_61 ( & V_39 -> V_275 ) ;
F_61 ( & V_39 -> V_276 ) ;
F_61 ( & V_39 -> V_269 . V_270 ) ;
F_230 ( V_39 -> V_176 , V_316 ) ;
V_39 -> V_176 = NULL ;
F_222 ( V_39 ) ;
}
...
F_80 ( & V_4 -> V_89 , V_152 ) ;
V_4 -> V_82 |= V_198 ;
while ( V_4 -> V_82 & V_318 ) {
F_106 ( V_4 , & V_59 , V_318 , 0 ) ;
F_81 ( & V_4 -> V_89 , V_152 ) ;
F_3 ( 0 , L_82 , V_4 -> V_8 ) ;
V_161 = F_103 ( & V_59 ) ;
if ( V_161 )
...
F_238 ( V_39 , & V_39 -> V_276 ) ;
F_238 ( V_39 , & V_39 -> V_269 . V_270 ) ;
}
int F_239 ( struct V_27 * V_27 )
{
int V_161 , V_319 ;
V_319 = F_234 ( F_46 ( V_27 -> V_97 ) ,
& F_45 ( V_27 ) -> V_209 ) ;
if ( V_319 < 0 )
F_113 ( V_319 ) ;
V_161 = V_319 ;
...
V_1 = V_4 -> V_74 ;
F_81 ( & V_4 -> V_89 , V_152 ) ;
V_322 -> V_331 = V_4 -> V_37 -> V_329 ( V_4 , V_323 ) ;
if ( V_322 -> V_331 == V_332 ) {
F_3 ( V_158 , L_97 ,
V_4 -> V_8 ) ;
goto V_325;
}
F_80 ( & V_4 -> V_89 , V_152 ) ;
if ( ( V_323 != V_4 -> V_77 ) || ( V_1 != V_4 -> V_74 ) ) {
F_3 ( V_158 , L_98
L_99 , V_4 -> V_8 , V_323 ,
...
if ( V_4 -> V_74 == V_136 )
V_317 = 1 ;
if ( V_317 && ! ( V_4 -> V_82 & V_154 ) )
V_4 -> V_37 -> V_317 ( V_4 ) ;
}
V_174 = F_134 ( V_4 , V_138 ) ;
F_81 ( & V_4 -> V_89 , V_152 ) ;
V_60 = F_135 ( V_39 , V_4 , V_138 , V_317 ,
V_174 ) ;
V_325:
if ( V_60 )
F_113 ( V_60 ) ;
...
static int F_249 ( struct V_338 * V_339 ,
struct V_3 * V_4 ,
int V_138 )
{
int V_340 = F_250 ( V_339 ) ;
F_11 ( V_138 != V_139 && V_138 != V_137 ) ;
F_11 ( V_4 -> V_74 != V_136 && ! V_340 ) ;
if ( V_340 )
return 1 ;
F_251 ( F_46 ( F_252 ( V_339 ) ) ) ;
return 0 ;
}
...
F_21 ( & V_343 ) ;
while ( 1 ) {
V_277 = F_258 ( V_108 -> V_109 ,
V_108 -> V_345 , 1 ) ;
if ( ! V_277 )
break;
F_23 ( & V_343 ) ;
F_3 ( 0 , L_103 , V_277 -> V_346 . V_45 ,
V_277 -> V_346 . V_44 ) ;
F_259 ( V_277 ) ;
F_260 ( V_277 ) ;
F_21 ( & V_343 ) ;
...
struct V_33 * V_348 =
F_14 ( V_4 ) ;
return F_249 ( & V_348 -> V_349 , V_4 , V_138 ) ;
}
...
{
struct V_350 * V_6 ;
struct V_31 * V_351 = F_13 ( V_4 ) ;
struct V_352 * V_98 = F_264 ( V_351 -> V_99 . V_100 ,
V_351 -> V_99 . V_129 ) ;
V_6 = F_2 ( & V_4 -> V_7 ) ;
V_6 -> V_9 = V_353 ;
V_6 -> V_354 = F_139 ( V_98 -> V_355 ) ;
V_6 -> V_356 = F_139 ( V_98 -> V_357 ) ;
V_6 -> V_358 = F_139 ( V_351 -> V_359 ) ;
V_6 -> V_360 = F_139 ( V_351 -> V_99 . V_361 ) ;
V_6 -> V_362 = F_139 ( V_351 -> V_99 . V_363 ) ;
V_6 -> V_364 = F_139 ( V_351 -> V_99 . V_365 ) ;
}
void F_265 ( struct V_31 * V_351 , int V_204 )
{
struct V_3 * V_4 = & V_351 -> V_366 ;
struct V_36 * V_39 = F_46 ( V_351 -> V_99 . V_100 ) ;
int V_1 = V_204 ? V_136 : V_137 ;
if ( ! F_126 ( V_39 ) && ! F_123 ( V_39 ) )
F_16 ( V_39 , V_4 , V_1 ) ;
}
static int F_266 ( struct V_31 * V_351 )
{
struct V_352 * V_98 = F_264 ( V_351 -> V_99 . V_100 ,
V_351 -> V_99 . V_129 ) ;
struct V_3 * V_4 = & V_351 -> V_366 ;
struct V_350 * V_6 = F_2 ( & V_4 -> V_7 ) ;
struct V_243 * V_244 = NULL ;
struct V_367 * V_368 ;
int V_161 = 0 ;
if ( F_154 ( & V_4 -> V_7 ) &&
V_6 -> V_9 == V_353 ) {
V_98 -> V_355 = F_4 ( V_6 -> V_354 ) ;
V_98 -> V_357 = F_4 ( V_6 -> V_356 ) ;
V_351 -> V_359 = F_4 ( V_6 -> V_358 ) ;
V_351 -> V_99 . V_361 = F_4 ( V_6 -> V_360 ) ;
V_351 -> V_99 . V_363 = F_4 ( V_6 -> V_362 ) ;
V_351 -> V_99 . V_365 =
F_4 ( V_6 -> V_364 ) ;
} else {
V_161 = F_267 ( V_351 -> V_369 ,
V_351 -> V_370 , & V_244 ) ;
if ( V_161 ) {
F_113 ( V_161 ) ;
goto V_175;
...
V_368 = (struct V_367 * )
( V_244 -> V_249 + V_371 ) ;
V_98 -> V_355 = F_162 ( V_368 -> V_355 ) ;
V_98 -> V_357 = F_162 ( V_368 -> V_357 ) ;
V_351 -> V_359 = F_162 ( V_368 -> V_359 ) ;
V_351 -> V_99 . V_361 = F_162 ( V_368 -> V_361 ) ;
V_351 -> V_99 . V_363 = F_162 ( V_368 -> V_363 ) ;
V_351 -> V_99 . V_365 =
F_162 ( V_368 -> V_365 ) ;
F_170 ( V_244 ) ;
F_34 ( V_4 ) ;
...
int F_268 ( struct V_31 * V_351 , int V_204 )
{
struct V_3 * V_4 = & V_351 -> V_366 ;
struct V_36 * V_39 = F_46 ( V_351 -> V_99 . V_100 ) ;
int V_1 = V_204 ? V_136 : V_137 ;
...
int F_269 ( struct V_33 * V_372 , int V_204 )
{
int V_161 ;
int V_1 = V_204 ? V_136 : V_137 ;
struct V_3 * V_4 = & V_372 -> V_35 ;
...
void F_270 ( struct V_33 * V_372 , int V_204 )
{
int V_1 = V_204 ? V_136 : V_137 ;
struct V_3 * V_4 = & V_372 -> V_35 ;
struct V_36 * V_39 = V_4 -> V_28 ;
...
goto V_373;
F_81 ( & V_4 -> V_89 , V_152 ) ;
V_161 = F_240 ( V_39 , V_4 , & V_322 ) ;
if ( V_161 < 0 )
F_113 ( V_161 ) ;
F_80 ( & V_4 -> V_89 , V_152 ) ;
V_373:
if ( V_4 -> V_82 & V_198 || ! V_322 . V_327 ) {
F_72 ( V_4 , V_318 ) ;
} else
F_85 ( V_39 , V_4 ) ;
F_3 ( V_158 , L_105 , V_4 -> V_8 ,
V_322 . V_327 ? L_106 : L_107 ) ;
F_81 ( & V_4 -> V_89 , V_152 ) ;
if ( V_322 . V_331 != V_337
&& V_4 -> V_37 -> V_374 )
V_4 -> V_37 -> V_374 ( V_39 , V_4 ) ;
}
...
F_71 ( V_4 , V_318 ) ;
F_80 ( & V_39 -> V_375 , V_152 ) ;
if ( F_25 ( & V_4 -> V_91 ) ) {
F_107 ( & V_4 -> V_91 ,
& V_39 -> V_376 ) ;
V_39 -> V_377 ++ ;
}
F_81 ( & V_39 -> V_375 , V_152 ) ;
}
...
struct V_3 * V_4 ;
F_80 ( & V_39 -> V_375 , V_152 ) ;
V_39 -> V_379 = V_39 -> V_380 ;
V_378 = V_39 -> V_377 ;
while ( V_378 ) {
F_11 ( F_25 ( & V_39 -> V_376 ) ) ;
V_4 = F_273 ( V_39 -> V_376 . V_381 ,
struct V_3 , V_91 ) ;
F_26 ( & V_4 -> V_91 ) ;
V_39 -> V_377 -- ;
F_81 ( & V_39 -> V_375 , V_152 ) ;
...
unsigned long V_152 ;
F_80 ( & V_39 -> V_375 , V_152 ) ;
if ( V_39 -> V_379 != V_39 -> V_380 )
V_383 = 1 ;
F_81 ( & V_39 -> V_375 , V_152 ) ;
return V_383 ;
}
static int V_312 ( void * V_384 )
{
int V_161 = 0 ;
struct V_36 * V_39 = V_384 ;
while ( ! ( F_276 () &&
F_274 ( V_39 ) ) ) {
F_277 ( V_39 -> V_385 ,
F_275 ( V_39 ) ||
