...
V_7 = F_46 ( & V_27 -> V_28 , sizeof( * V_7 ) , V_73 ) ;
if ( ! V_7 ) {
F_40 ( & V_27 -> V_28 , L_6 ) ;
V_68 = - V_74 ;
goto V_72;
}
V_7 -> V_30 = F_47 ( V_27 -> V_28 . V_75 , V_9 ,
& V_76 , V_7 ) ;
if ( ! V_7 -> V_30 ) {
V_68 = - V_74 ;
goto V_72;
...
static int F_58 ( struct V_85 * V_27 )
{
struct V_6 * V_7 ;
struct V_1 * V_86 ;
struct V_87 * V_88 ;
int V_68 = 0 ;
V_88 = F_59 ( V_27 , V_89 , 0 ) ;
if ( ! V_88 )
return - V_38 ;
V_7 = F_60 ( sizeof( struct V_6 ) , V_73 ) ;
if ( ! V_7 ) {
F_40 ( & V_27 -> V_28 ,
L_8 ) ;
return - V_74 ;
}
V_7 -> V_12 = F_43 ( V_88 -> V_65 , F_61 ( V_88 ) ) ;
if ( V_7 -> V_12 == NULL ) {
V_68 = - V_38 ;
goto V_90;
}
...
static int F_64 ( struct V_85 * V_27 )
{
