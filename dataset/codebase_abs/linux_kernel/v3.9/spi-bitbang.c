...
{
struct V_25 * V_26 =
F_18 ( V_43 , struct V_25 , V_43 ) ;
unsigned long V_28 ;
struct V_44 * V_45 , * V_46 ;
F_11 ( & V_26 -> V_38 , V_28 ) ;
V_26 -> V_39 = 1 ;
F_19 (m, _m, &bitbang->queue, queue) {
struct V_1 * V_2 ;
unsigned V_3 ;
struct V_7 * V_8 = NULL ;
unsigned V_47 ;
...
if ( V_8 -> V_58 )
F_22 ( V_8 -> V_58 ) ;
if ( V_48 && ! F_23 ( & V_8 -> V_59 , & V_45 -> V_60 ) ) {
F_12 ( V_3 ) ;
V_26 -> V_40 ( V_2 , V_41 ) ;
F_12 ( V_3 ) ;
}
...
int F_24 ( struct V_1 * V_2 , struct V_44 * V_45 )
{
struct V_25 * V_26 ;
unsigned long V_28 ;
int V_49 = 0 ;
...
F_25 ( & V_45 -> V_51 , & V_26 -> V_51 ) ;
F_26 ( V_26 -> V_65 , & V_26 -> V_43 ) ;
}
F_13 ( & V_26 -> V_38 , V_28 ) ;
return V_49 ;
}
