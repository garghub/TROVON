...
static void F_38 ( struct V_81 * V_65 )
{
switch ( V_65 -> V_82 ) {
case 1 :
F_39 ( V_65 -> V_68 ) ;
...
static void F_43 ( struct V_84 * V_85 , T_4 V_86 )
{
do {
memset ( V_85 , 0 , sizeof( * V_85 ) ) ;
V_85 -> V_20 . V_21 = 0x0010 ;
V_85 -> V_20 . V_22 = 0x000e ;
V_85 -> V_86 = V_86 ;
if ( F_4 ( V_85 ) )
break;
if ( V_85 -> V_1 . V_22 != 0x0001 ) {
F_21 ( 2 , L_25 ,
V_85 -> V_1 . V_22 ) ;
break;
}
F_21 ( 2 , L_26 , V_85 -> V_87 ) ;
switch ( V_85 -> V_87 ) {
case 0 :
F_41 ( & V_85 -> V_88 . V_89 ) ;
break;
...
break;
default:
F_21 ( 2 , L_27 , V_85 -> V_87 ) ;
break;
}
} while ( V_85 -> V_88 . V_89 . V_83 & 0x80 );
}
static void F_44 ( struct V_91 * V_92 , struct V_91 * V_93 , int V_94 )
{
struct V_84 * V_85 = V_95 ;
if ( V_94 ) {
F_42 () ;
return;
}
F_21 ( 2 , L_28
L_29 ,
V_92 -> V_96 , V_92 -> V_97 , V_92 -> V_98 , V_92 -> V_99 , V_92 -> V_100 ,
V_92 -> V_101 , V_92 -> V_67 ) ;
F_11 ( 2 , L_30 ) ;
F_43 ( V_85 , V_102 | V_103 ) ;
}
...
int F_52 ( struct V_47 V_35 , int V_104 )
{
...
static void
F_53 ( struct V_107 * V_108 )
{
int V_15 ;
for ( V_15 = 0 ; V_15 <= V_75 ; V_15 ++ ) {
if ( ! V_108 -> V_109 [ V_15 ] )
continue;
F_54 ( V_108 -> V_109 [ V_15 ] ) ;
}
}
static int
...
int F_57 ( struct V_107 * V_108 , int V_111 )
{
struct {
struct V_112 V_20 ;
T_3 V_113 : 2 ;
...
int
F_58 ( struct V_107 * V_108 , int V_111 )
{
int V_14 ;
if ( V_111 && ! V_108 -> V_123 ) {
V_108 -> V_116 = ( void * ) F_59 ( V_124 | V_125 ) ;
V_108 -> V_118 = ( void * ) F_59 ( V_124 | V_125 ) ;
if ( ! V_108 -> V_116 || ! V_108 -> V_118 ) {
F_60 ( ( unsigned long ) V_108 -> V_116 ) ;
F_60 ( ( unsigned long ) V_108 -> V_118 ) ;
return - V_5 ;
}
}
V_14 = F_57 ( V_108 , V_111 ) ;
if ( ! V_14 ) {
V_108 -> V_123 = V_111 ;
if ( V_108 -> V_123 ) {
V_14 = F_55 ( V_108 ) ;
...
int F_61 ( struct V_47 V_35 , int V_120 , int V_126 ,
...
static void
F_63 ( struct V_72 * V_73 , T_1 V_141 ,
struct V_142 * V_143 )
{
struct V_142 * V_142 ;
int V_15 , V_16 ;
...
{
int V_14 ;
V_95 = ( void * ) F_59 ( V_124 | V_125 ) ;
V_18 = ( void * ) F_59 ( V_124 | V_125 ) ;
if ( ! V_95 || ! V_18 ) {
V_14 = - V_5 ;
goto V_152;
}
V_14 = F_68 ( V_153 , F_44 ) ;
if ( V_14 )
goto V_152;
return V_14 ;
V_152:
F_60 ( ( unsigned long ) V_18 ) ;
F_60 ( ( unsigned long ) V_95 ) ;
return V_14 ;
}
void T_5 F_69 ( void )
{
...
int F_73 ( void * V_129 , unsigned int V_80 , T_2 V_169 )
{
struct {
struct V_112 V_20 ;
unsigned int V_170 ;
...
int F_74 ( void * V_129 , void * V_164 , T_6 V_176 )
{
struct {
struct V_112 V_20 ;
...
int F_76 ( struct F_76 * V_182 , T_4 V_183 )
{
int V_13 , V_14 ;
