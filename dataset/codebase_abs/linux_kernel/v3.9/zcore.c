...
static int T_2 F_39 ( enum V_19 V_20 )
{
int V_50 ;
switch ( V_20 ) {
case V_89 :
...
static int T_2 F_43 ( unsigned long * V_94 )
{
int V_31 ;
struct V_69 * V_70 ;
V_70 = F_28 ( V_67 * sizeof( struct V_69 ) ,
...
static int T_2 F_44 ( int V_20 , struct V_56 * V_95 )
{
int V_50 , V_31 ;
...
struct V_107 V_107 ;
int V_50 ;
V_50 = F_8 ( & V_107 , V_108 , sizeof( V_107 ) ) ;
if ( V_50 )
return V_50 ;
if ( V_107 . V_109 == 0 )
return 0 ;
...
return - V_24 ;
if ( V_107 . V_109 < V_57 )
V_50 = F_8 ( V_72 , V_107 . V_109 , V_8 ) ;
else
V_50 = F_49 ( V_72 , ( void * ) V_107 . V_109 , V_8 ) ;
...
if ( V_113 )
return - V_11 ;
V_114 = F_53 ( L_13 , 4 , 1 , 4 * sizeof( long ) ) ;
F_54 ( V_114 , & V_115 ) ;
F_55 ( V_114 , 6 ) ;
F_4 ( L_14 , V_111 . V_116 . V_117 . V_118 . V_119 ) ;
F_4 ( L_15 , ( unsigned long long ) V_111 . V_116 . V_117 . V_120 ) ;
F_4 ( L_16 , ( unsigned long long ) V_111 . V_116 . V_117 . V_121 ) ;
V_50 = F_56 () ;
if ( V_50 )
goto V_55;
V_50 = F_41 () ;
...
if ( V_50 )
goto V_55;
V_123 = F_58 ( L_13 , NULL ) ;
if ( ! V_123 ) {
V_50 = - V_24 ;
goto V_55;
}
V_124 = F_59 ( L_21 , V_125 , V_123 , NULL ,
& V_126 ) ;
if ( ! V_124 ) {
V_50 = - V_24 ;
goto V_127;
}
V_128 = F_59 ( L_22 , V_125 , V_123 ,
NULL , & V_129 ) ;
if ( ! V_128 ) {
V_50 = - V_24 ;
goto V_130;
}
V_131 = F_59 ( L_23 , V_125 , V_123 ,
NULL , & V_132 ) ;
if ( ! V_131 ) {
V_50 = - V_24 ;
goto V_133;
}
V_134 = F_59 ( L_24 , V_125 | V_135 , V_123 ,
NULL , & V_136 ) ;
if ( ! V_134 ) {
V_50 = - V_24 ;
goto V_137;
