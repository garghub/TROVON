...
struct V_284 * V_285 ;
struct V_300 * V_315 ;
int V_310 = F_239 ( V_27 ) ;
if ( F_249 ( V_314 ) )
return V_314 ;
if ( V_310 != V_314 && F_250 ( V_310 , V_314 ) && F_249 ( V_310 ) )
return V_310 ;
V_285 = F_251 ( F_252 ( V_316 , V_314 ) ) ;
F_253 (sd) {
V_315 = V_285 -> V_304 ;
do {
...
if ( V_310 == V_314 || ! F_249 ( V_310 ) )
goto V_57;
}
V_314 = F_254 ( F_242 ( V_315 ) ,
F_243 ( V_27 ) ) ;
goto V_317;
V_57:
V_315 = V_315 -> V_57 ;
...
static int
F_255 ( struct V_24 * V_27 , int V_318 , int V_319 )
{
...
static void
F_258 ( struct V_24 * V_27 , int V_332 )
{
struct V_25 * V_26 = & V_27 -> V_26 ;
struct V_23 * V_23 = F_21 ( V_26 ) ;
if ( V_26 -> V_161 . V_162 ) {
...
static unsigned long
F_259 ( struct V_25 * V_44 , struct V_25 * V_26 )
{
...
static void F_261 ( struct V_25 * V_26 )
{
F_33 (se)
F_21 ( V_26 ) -> V_198 = V_26 ;
}
static void F_262 ( struct V_22 * V_22 , struct V_24 * V_27 , int V_319 )
{
struct V_24 * V_44 = V_22 -> V_44 ;
...
static struct V_24 * F_265 ( struct V_22 * V_22 )
{
struct V_24 * V_27 ;
...
static void F_266 ( struct V_22 * V_22 , struct V_24 * V_207 )
{
...
static void F_267 ( struct V_22 * V_22 )
{
struct V_24 * V_44 = V_22 -> V_44 ;
struct V_23 * V_23 = F_20 ( V_44 ) ;
...
static bool F_268 ( struct V_22 * V_22 , struct V_24 * V_27 , bool V_342 )
{
struct V_25 * V_26 = & V_27 -> V_26 ;
...
static void F_269 ( struct V_24 * V_27 , struct V_348 * V_349 )
{
F_270 ( V_349 -> V_350 , V_27 , 0 ) ;
F_271 ( V_27 , V_349 -> V_351 ) ;
F_272 ( V_349 -> V_352 , V_27 , 0 ) ;
F_273 ( V_349 -> V_352 , V_27 , 0 ) ;
}
static int
F_274 ( struct V_24 * V_27 , T_2 V_81 , struct V_284 * V_285 )
{
T_3 V_41 ;
if ( V_27 -> V_273 != & V_274 )
return 0 ;
...
static
int F_276 ( struct V_24 * V_27 , struct V_348 * V_349 )
{
int V_355 = 0 ;
...
V_349 -> V_111 &= ~ V_361 ;
if ( F_277 ( V_349 -> V_350 , V_27 ) ) {
F_144 ( V_27 , V_26 . V_77 . V_362 ) ;
return 0 ;
}
V_355 = F_274 ( V_27 , V_349 -> V_350 -> V_82 , V_349 -> V_285 ) ;
if ( ! V_355 ||
...
static int F_278 ( struct V_348 * V_349 )
{
struct V_24 * V_27 , * V_141 ;
F_279 (p, n, &env->src_rq->cfs_tasks, se.group_node) {
...
return 0 ;
while ( ! F_196 ( V_370 ) ) {
V_27 = F_281 ( V_370 , struct V_24 , V_26 . V_132 ) ;
V_349 -> V_372 ++ ;
...
continue;
V_57:
F_284 ( & V_27 -> V_26 . V_132 , V_370 ) ;
}
F_64 ( V_349 -> V_285 , V_368 [ V_349 -> V_231 ] , V_371 ) ;
return V_371 ;
}
static void F_285 ( struct V_134 * V_31 , int V_276 )
{
struct V_25 * V_26 = V_31 -> V_26 [ V_276 ] ;
...
F_192 ( V_22 ) ;
F_217 (rq, cfs_rq) {
F_285 ( V_23 -> V_31 , V_22 -> V_276 ) ;
}
F_288 ( & V_22 -> V_229 , V_111 ) ;
}
static int F_289 ( struct V_134 * V_31 , void * V_239 )
{
unsigned long V_69 ;
...
V_22 -> V_380 = V_81 ;
F_188 () ;
F_291 ( F_289 , V_242 , ( void * ) V_276 ) ;
F_190 () ;
}
static unsigned long F_282 ( struct V_24 * V_27 )
{
...
static inline void F_286 ( int V_276 )
{
}
static inline void F_290 ( long V_276 )
{
}
static unsigned long F_282 ( struct V_24 * V_27 )
{
...
static inline int F_292 ( struct V_284 * V_285 ,
enum V_381 V_231 )
{
int V_301 ;
switch ( V_231 ) {
...
unsigned long F_293 ( struct V_284 * V_285 , int V_276 )
{
return V_311 ;
}
unsigned long __weak F_294 ( struct V_284 * V_285 , int V_276 )
{
return F_293 ( V_285 , V_276 ) ;
}
unsigned long F_295 ( struct V_284 * V_285 , int V_276 )
{
...
static void F_299 ( struct V_284 * V_285 , int V_276 )
{
unsigned long V_11 = V_285 -> V_331 ;
...
void F_300 ( struct V_284 * V_285 , int V_276 )
{
...
static inline int
F_302 ( struct V_284 * V_285 , struct V_300 * V_303 )
{
...
static inline void F_303 ( struct V_348 * V_349 ,
...
F_300 ( V_349 -> V_285 , V_349 -> V_351 ) ;
} else if ( F_306 ( V_104 , V_303 -> V_312 -> V_398 ) )
F_300 ( V_349 -> V_285 , V_349 -> V_351 ) ;
}
...
( V_403 - V_404 ) > 1 )
V_402 -> V_414 = 1 ;
V_402 -> V_415 = F_307 ( V_303 -> V_312 -> V_313 ,
V_311 ) ;
if ( ! V_402 -> V_415 )
V_402 -> V_415 = F_302 ( V_349 -> V_285 , V_303 ) ;
V_402 -> V_416 = V_303 -> V_416 ;
if ( V_402 -> V_415 > V_402 -> V_411 )
V_402 -> V_417 = 1 ;
}
static bool F_308 ( struct V_348 * V_349 ,
struct V_418 * V_419 ,
struct V_300 * V_315 ,
struct V_401 * V_402 )
{
...
V_349 -> V_351 < F_309 ( V_315 ) ) {
if ( ! V_419 -> V_422 )
return true ;
if ( F_309 ( V_419 -> V_422 ) > F_309 ( V_315 ) )
return true ;
}
return false ;
}
static inline void F_310 ( struct V_348 * V_349 ,
...
V_423 = 1 ;
V_301 = F_292 ( V_349 -> V_285 , V_349 -> V_231 ) ;
do {
int V_309 ;
V_309 = F_244 ( V_349 -> V_351 , F_242 ( V_315 ) ) ;
memset ( & V_402 , 0 , sizeof( V_402 ) ) ;
F_303 ( V_349 , V_315 , V_301 , V_309 , V_400 , & V_402 ) ;
if ( V_309 && ! ( * V_400 ) )
return;
...
} else if ( F_308 ( V_349 , V_419 , V_315 , & V_402 ) ) {
...
static int F_311 ( struct V_348 * V_349 , struct V_418 * V_419 )
{
int V_438 ;
...
static inline
void F_312 ( struct V_348 * V_349 , struct V_418 * V_419 )
{
...
static inline void F_313 ( struct V_348 * V_349 , struct V_418 * V_419 )
{
...
static struct V_300 *
F_314 ( struct V_348 * V_349 , int * V_400 )
{
struct V_418 V_419 ;
memset ( & V_419 , 0 , sizeof( V_419 ) ) ;
F_310 ( V_349 , V_400 , & V_419 ) ;
if ( ! ( * V_400 ) )
goto V_65;
...
static struct V_22 * F_315 ( struct V_348 * V_349 ,
struct V_300 * V_303 )
{
...
unsigned long V_449 = F_307 ( V_313 ,
V_311 ) ;
unsigned long V_281 ;
if ( ! V_449 )
V_449 = F_302 ( V_349 -> V_285 , V_303 ) ;
...
static int F_316 ( struct V_348 * V_349 )
{
...
static int F_317 ( int V_289 , struct V_22 * F_275 ,
...
F_319 ( V_1 , V_457 ) ;
V_454 = F_320 ( V_349 . V_358 ) ;
F_144 ( V_285 , V_458 [ V_231 ] ) ;
V_459:
V_303 = F_314 ( & V_349 , V_400 ) ;
if ( * V_400 == 0 )
goto V_447;
if ( ! V_303 ) {
...
V_422 = F_315 ( & V_349 , V_303 ) ;
if ( ! V_422 ) {
F_144 ( V_285 , V_461 [ V_231 ] ) ;
goto V_447;
}
F_264 ( V_422 == V_349 . V_352 ) ;
...
void F_329 ( int V_289 , struct V_22 * F_275 )
{
struct V_284 * V_285 ;
int V_474 = 0 ;
unsigned long V_475 = V_104 + V_476 ;
F_275 -> V_477 = F_275 -> clock ;
if ( F_275 -> V_478 < V_354 )
return;
F_133 ( F_275 , 1 ) ;
F_180 ( & F_275 -> V_229 ) ;
F_286 ( V_289 ) ;
...
F_190 () ;
F_178 ( & F_275 -> V_229 ) ;
if ( V_474 || F_85 ( V_104 , F_275 -> V_475 ) ) {
F_275 -> V_475 = V_475 ;
}
}
...
static inline int F_334 ( int V_487 )
{
int V_488 = F_335 ( V_489 . V_490 ) ;
if ( V_488 < V_360 && F_249 ( V_488 ) )
return V_488 ;
return V_360 ;
}
static void F_336 ( int V_276 )
{
int V_491 ;
V_489 . V_475 ++ ;
V_491 = F_334 ( V_276 ) ;
if ( V_491 >= V_360 )
return;
if ( F_337 ( V_492 , F_338 ( V_491 ) ) )
return;
F_339 ( V_491 ) ;
return;
}
static inline void F_340 ( int V_276 )
{
if ( F_11 ( F_341 ( V_493 , F_338 ( V_276 ) ) ) ) {
F_326 ( V_276 , V_489 . V_490 ) ;
F_342 ( & V_489 . V_494 ) ;
F_343 ( V_493 , F_338 ( V_276 ) ) ;
}
}
static inline void F_344 ( void )
{
struct V_284 * V_285 ;
int V_276 = F_174 () ;
if ( ! F_341 ( V_495 , F_338 ( V_276 ) ) )
return;
F_343 ( V_495 , F_338 ( V_276 ) ) ;
F_188 () ;
F_256 (cpu, sd)
F_345 ( & V_285 -> V_304 -> V_312 -> V_496 ) ;
F_190 () ;
}
void F_346 ( void )
{
...
if ( F_341 ( V_495 , F_338 ( V_276 ) ) )
return;
F_347 ( V_495 , F_338 ( V_276 ) ) ;
F_188 () ;
F_256 (cpu, sd)
F_342 ( & V_285 -> V_304 -> V_312 -> V_496 ) ;
F_190 () ;
}
void F_348 ( int V_276 )
{
if ( ! F_349 ( V_276 ) )
return;
if ( F_341 ( V_493 , F_338 ( V_276 ) ) )
return;
F_350 ( V_276 , V_489 . V_490 ) ;
F_345 ( & V_489 . V_494 ) ;
F_347 ( V_493 , F_338 ( V_276 ) ) ;
}
static int T_11 F_351 ( struct V_497 * V_498 ,
...
static void F_353 ( int V_276 , enum V_381 V_231 )
{
int V_400 = 1 ;
struct V_22 * V_22 = F_230 ( V_276 ) ;
unsigned long V_395 ;
...
if ( F_306 ( V_104 , V_285 -> V_480 + V_395 ) ) {
if ( F_317 ( V_276 , V_22 , V_285 , V_231 , & V_400 ) ) {
V_231 = V_382 ;
}
V_285 -> V_480 = V_104 ;
}
...
static void F_356 ( int V_289 , enum V_381 V_231 )
{
struct V_22 * F_275 = F_230 ( V_289 ) ;
struct V_22 * V_22 ;
int V_407 ;
if ( V_231 != V_446 ||
! F_341 ( V_492 , F_338 ( V_289 ) ) )
goto V_109;
...
F_333 ( & V_22 -> V_229 ) ;
F_353 ( V_407 , V_446 ) ;
if ( F_85 ( F_275 -> V_475 , V_22 -> V_475 ) )
F_275 -> V_475 = V_22 -> V_475 ;
}
V_489 . V_475 = F_275 -> V_475 ;
V_109:
F_343 ( V_492 , F_338 ( V_289 ) ) ;
}
static inline int F_359 ( struct V_22 * V_22 , int V_276 )
{
unsigned long V_81 = V_104 ;
struct V_284 * V_285 ;
if ( F_11 ( F_249 ( V_276 ) ) )
...
static void F_356 ( int V_289 , enum V_381 V_231 ) { }
static void F_360 ( struct V_515 * V_516 )
{
int V_289 = F_174 () ;
struct V_22 * F_275 = F_230 ( V_289 ) ;
enum V_381 V_231 = F_275 -> F_329 ?
V_446 : V_382 ;
F_353 ( V_289 , V_231 ) ;
F_356 ( V_289 , V_231 ) ;
}
static inline int F_361 ( int V_276 )
{
return ! F_362 ( F_230 ( V_276 ) -> V_285 ) ;
}
void F_363 ( struct V_22 * V_22 , int V_276 )
{
if ( F_306 ( V_104 , V_22 -> V_475 ) &&
F_9 ( ! F_361 ( V_276 ) ) )
F_364 ( V_517 ) ;
#ifdef F_365
if ( F_359 ( V_22 , V_276 ) && F_9 ( ! F_361 ( V_276 ) ) )
F_336 ( V_276 ) ;
#endif
}
...
static void F_367 ( struct V_22 * V_22 )
{
F_5 () ;
F_216 ( V_22 ) ;
}
static void F_368 ( struct V_22 * V_22 , struct V_24 * V_44 , int V_208 )
{
struct V_23 * V_23 ;
struct V_25 * V_26 = & V_44 -> V_26 ;
F_33 (se) {
...
static void F_369 ( struct V_24 * V_27 )
{
struct V_23 * V_23 ;
struct V_25 * V_26 = & V_27 -> V_26 , * V_44 ;
int V_289 = F_174 () ;
struct V_22 * V_22 = F_275 () ;
unsigned long V_111 ;
F_287 ( & V_22 -> V_229 , V_111 ) ;
F_192 ( V_22 ) ;
V_23 = F_20 ( V_95 ) ;
...
static void
F_372 ( struct V_22 * V_22 , struct V_24 * V_27 , int V_519 )
{
if ( ! V_27 -> V_26 . V_75 )
return;
if ( V_22 -> V_44 == V_27 ) {
...
static void F_373 ( struct V_22 * V_22 , struct V_24 * V_27 )
{
struct V_25 * V_26 = & V_27 -> V_26 ;
struct V_23 * V_23 = F_21 ( V_26 ) ;
...
static void F_376 ( struct V_22 * V_22 )
{
...
static void F_379 ( struct V_24 * V_27 , int V_75 )
{
struct V_23 * V_23 ;
...
void F_381 ( struct V_134 * V_31 )
{
int V_310 ;
F_215 ( F_176 ( V_31 ) ) ;
F_382 (i) {
if ( V_31 -> V_23 )
F_383 ( V_31 -> V_23 [ V_310 ] ) ;
if ( V_31 -> V_26 )
F_383 ( V_31 -> V_26 [ V_310 ] ) ;
}
F_383 ( V_31 -> V_23 ) ;
F_383 ( V_31 -> V_26 ) ;
}
int F_384 ( struct V_134 * V_31 , struct V_134 * V_32 )
{
struct V_23 * V_23 ;
struct V_25 * V_26 ;
int V_310 ;
V_31 -> V_23 = F_385 ( sizeof( V_23 ) * V_360 , V_525 ) ;
if ( ! V_31 -> V_23 )
goto V_526;
V_31 -> V_26 = F_385 ( sizeof( V_26 ) * V_360 , V_525 ) ;
if ( ! V_31 -> V_26 )
goto V_526;
V_31 -> V_138 = V_70 ;
F_209 ( F_176 ( V_31 ) ) ;
F_382 (i) {
V_23 = F_386 ( sizeof( struct V_23 ) ,
V_525 , F_387 ( V_310 ) ) ;
if ( ! V_23 )
goto V_526;
V_26 = F_386 ( sizeof( struct V_25 ) ,
V_525 , F_387 ( V_310 ) ) ;
if ( ! V_26 )
goto V_527;
F_377 ( V_23 ) ;
F_388 ( V_31 , V_23 , V_26 , V_310 , V_32 -> V_26 [ V_310 ] ) ;
}
return 1 ;
V_527:
F_383 ( V_23 ) ;
...
void F_389 ( struct V_134 * V_31 , int V_276 )
{
struct V_22 * V_22 = F_230 ( V_276 ) ;
unsigned long V_111 ;
...
void F_388 ( struct V_134 * V_31 , struct V_23 * V_23 ,
...
int F_390 ( struct V_134 * V_31 , unsigned long V_138 )
{
int V_310 ;
unsigned long V_111 ;
if ( ! V_31 -> V_26 [ 0 ] )
return - V_528 ;
V_138 = F_301 ( V_138 , F_127 ( V_139 ) , F_127 ( V_529 ) ) ;
F_391 ( & V_530 ) ;
if ( V_31 -> V_138 == V_138 )
goto V_317;
V_31 -> V_138 = V_138 ;
...
void F_389 ( struct V_134 * V_31 , int V_276 ) { }
static unsigned int F_393 ( struct V_22 * V_22 , struct V_24 * V_531 )
{
struct V_25 * V_26 = & V_531 -> V_26 ;
unsigned int V_532 = 0 ;
if ( V_22 -> V_38 . V_69 . V_11 )
V_532 = F_394 ( F_58 ( F_21 ( V_26 ) , V_26 ) ) ;
return V_532 ;
}
void F_395 ( struct V_533 * V_534 , int V_276 )
{
struct V_23 * V_23 ;
F_188 () ;
F_217 (cpu_rq(cpu), cfs_rq)
F_396 ( V_534 , V_276 , V_23 ) ;
F_190 () ;
}
T_12 void F_397 ( void )
{
#ifdef F_101
F_398 ( V_517 , F_360 ) ;
#ifdef F_365
V_489 . V_475 = V_104 ;
F_399 ( & V_489 . V_490 , V_535 ) ;
F_400 ( F_351 , 0 ) ;
#endif
#endif
}
