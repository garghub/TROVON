...
if ( V_114 -> V_128 ) {
struct V_127 * V_139 = V_114 -> V_128 ;
struct V_140 V_141 ;
F_80 ( & V_141 ) ;
V_139 -> V_128 . V_142 = 0 ;
V_139 -> V_128 . V_143 = V_141 . V_143 ;
V_139 -> V_128 . V_144 = V_141 . V_144 ;
F_61 ( & V_139 -> V_18 . V_145 , & V_139 -> V_18 . V_8 -> V_146 ) ;
F_81 ( & V_139 -> V_18 . V_8 -> V_147 ) ;
}
F_71 ( & V_114 -> V_120 ) ;
if ( V_138 )
* V_138 = * V_114 ;
...
F_82 ( void * V_148 )
{
struct V_111 * V_112 = V_148 ;
struct V_16 * V_17 = V_112 -> V_17 ;
struct V_113 V_149 ;
if ( ! F_77 ( V_112 , & V_149 ) ) {
if ( F_9 ( V_17 -> V_20 ) -> V_21 < V_22 ) {
F_83 ( V_17 -> V_11 , V_149 . V_93 , V_149 . V_99 +
V_149 . V_135 * V_149 . V_150 +
V_149 . V_134 * V_149 . V_151 / 8 ) ;
}
}
return 0 ;
}
...
struct V_15 * V_100 ;
int V_19 ;
args -> V_150 = F_85 ( args -> V_153 * ( args -> V_151 / 8 ) , 256 ) ;
args -> V_154 = args -> V_150 * args -> V_155 ;
args -> V_154 = F_85 ( args -> V_154 , V_156 ) ;
V_19 = F_86 ( V_11 , args -> V_154 , 0 , V_157 , 0 , 0 , & V_100 ) ;
if ( V_19 )
return V_19 ;
...
int
F_87 ( struct V_7 * V_8 , struct V_10 * V_11 ,
T_2 V_9 )
{
return F_88 ( V_8 , V_9 ) ;
}
...
if ( V_6 ) {
struct V_15 * V_100 = V_6 -> V_159 ;
* V_158 = V_100 -> V_100 . V_160 ;
F_2 ( V_6 ) ;
return 0 ;
}
return - V_42 ;
