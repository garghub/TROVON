...
F_2 ( V_2 ) -> V_9 != V_9 ||
V_10 != * ( ( T_2 * ) F_2 ( V_2 ) ) ) )
return F_6 ( V_2 ) == 0 ? V_5 : V_15 ;
return V_5 ;
}
static unsigned int
F_7 ( unsigned int V_17 , struct V_1 * V_2 ,
...
static int T_3 F_9 ( struct V_20 * V_20 )
{
struct V_21 * V_22 ;
V_22 = F_10 ( & V_23 ) ;
if ( V_22 == NULL )
...
F_11 ( V_20 , & V_23 , V_22 ) ;
F_12 ( V_22 ) ;
return F_13 ( V_20 -> V_13 . V_14 ) ;
}
static void T_4 F_14 ( struct V_20 * V_20 )
{
F_15 ( V_20 , V_20 -> V_13 . V_14 ) ;
}
