...
int F_64 ( struct V_17 * V_18 , struct V_147 * V_148 ,
int V_149 )
{
T_2 * V_20 ;
int error ;
...
error = F_33 ( V_18 , & V_148 -> V_93 , & V_148 -> V_6 ) ;
if ( F_7 ( error ) )
return error ;
...
static int F_67 ( struct V_17 * V_18 , struct V_157 * V_22 )
{
T_2 * V_20 ;
