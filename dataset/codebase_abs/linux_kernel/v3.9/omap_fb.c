...
for ( V_6 = 0 ; V_6 < V_19 ; V_6 ++ ) {
struct V_22 * V_22 = & V_16 -> V_17 [ V_6 ] ;
int V_120 , V_36 = V_113 -> V_121 [ V_6 ] ;
...
V_120 = V_36 * V_113 -> V_55 / V_31 -> V_17 [ V_6 ] . V_37 ;
if ( V_120 > ( F_44 ( V_114 [ V_6 ] ) - V_113 -> V_122 [ V_6 ] ) ) {
F_17 ( V_63 -> V_63 , L_9 ,
V_114 [ V_6 ] -> V_120 - V_113 -> V_122 [ V_6 ] , V_120 ) ;
V_83 = - V_116 ;
goto V_117;
}
V_22 -> V_18 = V_114 [ V_6 ] ;
V_22 -> V_34 = V_113 -> V_122 [ V_6 ] ;
V_22 -> V_36 = V_36 ;
V_22 -> V_38 = 0 ;
}
F_45 ( V_11 , V_113 ) ;
V_83 = F_46 ( V_63 , V_11 , & V_123 ) ;
if ( V_83 ) {
F_17 ( V_63 -> V_63 , L_10 , V_83 ) ;
goto V_117;
}
