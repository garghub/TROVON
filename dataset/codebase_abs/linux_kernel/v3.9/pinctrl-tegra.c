...
unsigned V_121 , unsigned long * V_42 )
{
F_14 ( V_8 -> V_20 , L_12 ) ;
return - V_120 ;
}
...
V_6 = F_1 ( V_2 , V_3 , V_4 ) ;
V_123 = ( 1 << V_67 ) - 1 ;
V_122 = ( V_6 >> V_66 ) & V_123 ;
* V_42 = F_26 ( V_52 , V_122 ) ;
return 0 ;
}
...
enum V_64 V_52 = F_40 ( V_42 ) ;
T_4 V_122 = F_42 ( V_42 ) ;
const char * V_125 = L_17 ;
int V_44 ;
for ( V_44 = 0 ; V_44 < F_24 ( V_51 ) ; V_44 ++ ) {
if ( V_51 [ V_44 ] . V_52 == V_52 ) {
V_125 = V_51 [ V_44 ] . V_48 ;
break;
}
}
F_10 ( V_18 , L_18 , F_45 ( V_125 ) , V_122 ) ;
}
int F_48 ( struct V_126 * V_127 ,
const struct V_128 * V_129 )
{
struct V_1 * V_2 ;
struct V_130 * V_131 ;
int V_44 ;
V_2 = F_49 ( & V_127 -> V_20 , sizeof( * V_2 ) , V_30 ) ;
if ( ! V_2 ) {
F_14 ( & V_127 -> V_20 , L_19 ) ;
return - V_31 ;
}
V_2 -> V_20 = & V_127 -> V_20 ;
V_2 -> V_9 = V_129 ;
V_132 . V_16 = V_2 -> V_9 -> V_133 ;
V_134 . V_13 = F_11 ( & V_127 -> V_20 ) ;
V_134 . V_14 = V_2 -> V_9 -> V_14 ;
V_134 . V_16 = V_2 -> V_9 -> V_16 ;
for ( V_44 = 0 ; ; V_44 ++ ) {
V_131 = F_50 ( V_127 , V_135 , V_44 ) ;
if ( ! V_131 )
break;
}
V_2 -> V_136 = V_44 ;
V_2 -> V_5 = F_49 ( & V_127 -> V_20 , V_2 -> V_136 * sizeof( * V_2 -> V_5 ) ,
V_30 ) ;
if ( ! V_2 -> V_5 ) {
F_14 ( & V_127 -> V_20 , L_20 ) ;
return - V_137 ;
}
for ( V_44 = 0 ; V_44 < V_2 -> V_136 ; V_44 ++ ) {
V_131 = F_50 ( V_127 , V_135 , V_44 ) ;
if ( ! V_131 ) {
F_14 ( & V_127 -> V_20 , L_21 ) ;
return - V_137 ;
}
if ( ! F_51 ( & V_127 -> V_20 , V_131 -> V_138 ,
F_52 ( V_131 ) ,
F_11 ( & V_127 -> V_20 ) ) ) {
F_14 ( & V_127 -> V_20 ,
L_22 , V_44 ) ;
...
V_2 -> V_5 [ V_44 ] = F_53 ( & V_127 -> V_20 , V_131 -> V_138 ,
F_52 ( V_131 ) ) ;
if ( ! V_2 -> V_5 [ V_44 ] ) {
F_14 ( & V_127 -> V_20 , L_23 , V_44 ) ;
return - V_137 ;
}
}
V_2 -> V_139 = F_54 ( & V_134 , & V_127 -> V_20 , V_2 ) ;
if ( ! V_2 -> V_139 ) {
F_14 ( & V_127 -> V_20 , L_24 ) ;
return - V_137 ;
}
F_55 ( V_2 -> V_139 , & V_132 ) ;
F_56 ( V_127 , V_2 ) ;
F_57 ( & V_127 -> V_20 , L_25 ) ;
return 0 ;
}
int F_58 ( struct V_126 * V_127 )
{
struct V_1 * V_2 = F_59 ( V_127 ) ;
F_60 ( V_2 -> V_139 ) ;
return 0 ;
}
