...
struct V_40 * V_41 = V_2 -> V_41 ;
struct V_42 * V_43 = (struct V_42 * ) V_201 ;
F_130 ( V_2 , & V_41 -> V_66 . V_69 [ V_41 -> V_66 . V_247 ] ,
V_4 -> V_248 , 0 , V_249 ) ;
F_45 ( V_2 , V_4 , V_43 , V_172 ) ;
return V_4 -> V_73 ;
}
...
{
T_1 V_253 , V_86 ;
T_1 (* F_146) ( struct V_1 * , struct V_3 * , void * ,
T_1 );
T_1 V_254 = 0 ;
if ( F_72 ( V_4 ) )
V_254 = 1 ;
...
F_146 = V_256 [ ( V_253 * V_257 ) + V_202 ] ;
V_86 = ( F_146 ) ( V_2 , V_4 , V_201 , V_202 ) ;
if ( V_254 ) {
F_3 ( V_2 , V_72 , V_36 ,
L_26 ,
