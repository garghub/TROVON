...
if ( F_31 ( V_4 ) && ( V_39 -> V_29 ^ V_66 ) & V_69 ) {
if ( V_39 -> V_29 & V_69 )
F_34 ( V_4 ) ;
else
F_35 ( V_4 ) ;
...
{
strncpy ( V_71 , F_8 ( V_4 ) -> V_38 -> V_11 , 23 ) ;
}
...
! ( V_39 -> V_29 & V_68 ) )
return - V_74 ;
if ( ! F_38 ( V_4 -> V_13 , V_38 -> V_13 ) ) {
V_72 = F_39 ( V_38 , V_4 -> V_13 ) ;
if ( V_72 < 0 )
goto V_75;
}
if ( V_4 -> V_29 & V_76 ) {
...
memcpy ( V_39 -> V_80 , V_38 -> V_13 , V_14 ) ;
if ( V_39 -> V_29 & V_67 )
F_32 ( V_4 ) ;
if ( V_39 -> V_29 & V_69 )
F_34 ( V_4 ) ;
...
if ( ! ( V_4 -> V_29 & V_73 ) )
goto V_75;
if ( ! F_38 ( V_83 -> V_84 , V_38 -> V_13 ) ) {
V_72 = F_39 ( V_38 , V_83 -> V_84 ) ;
if ( V_72 < 0 )
return V_72 ;
}
if ( ! F_38 ( V_4 -> V_13 , V_38 -> V_13 ) )
...
{
struct V_3 * V_38 = F_8 ( V_4 ) -> V_38 ;
const struct V_89 * V_90 = V_38 -> V_91 ;
struct V_86 V_92 ;
int V_72 = - V_93 ;
strncpy ( V_92 . V_94 , V_38 -> V_11 , V_95 ) ;
V_92 . V_96 = V_87 -> V_96 ;
switch ( V_88 ) {
case V_97 :
case V_98 :
case V_99 :
if ( F_52 ( V_38 ) && V_90 -> V_100 )
V_72 = V_90 -> V_100 ( V_38 , & V_92 , V_88 ) ;
break;
}
if ( ! V_72 )
V_87 -> V_96 = V_92 . V_96 ;
...
const struct V_89 * V_90 = V_38 -> V_91 ;
int V_72 = 0 ;
if ( F_52 ( V_38 ) && V_90 -> V_103 )
V_72 = V_90 -> V_103 ( V_38 , V_102 ) ;
return V_72 ;
}
...
int V_28 = 0 ;
if ( V_90 -> V_108 )
V_28 = V_90 -> V_108 ( V_38 , V_104 , V_106 , V_107 ) ;
return V_28 ;
}
...
int V_28 = - V_70 ;
if ( V_90 -> V_113 )
V_28 = V_90 -> V_113 ( V_38 , V_112 , type ) ;
return V_28 ;
}
...
int V_28 = 0 ;
if ( V_90 -> V_114 )
V_28 = V_90 -> V_114 ( V_38 , V_104 , V_106 , V_107 ) ;
return V_28 ;
}
...
if ( V_4 -> V_29 & V_73 ) {
if ( V_115 & V_76 )
F_40 ( V_38 , V_4 -> V_29 & V_76 ? 1 : - 1 ) ;
if ( V_115 & V_78 )
F_41 ( V_38 , V_4 -> V_29 & V_78 ? 1 : - 1 ) ;
}
}
static void F_61 ( struct V_3 * V_116 )
{
F_62 ( F_8 ( V_116 ) -> V_38 , V_116 ) ;
F_63 ( F_8 ( V_116 ) -> V_38 , V_116 ) ;
}
...
int V_122 = 0 ;
F_45 ( V_4 ) ;
V_4 -> V_29 = V_38 -> V_29 & ~ ( V_73 | V_78 | V_76 |
V_125 | V_126 ) ;
V_4 -> V_127 = V_38 -> V_128 ;
V_4 -> V_129 = ( V_38 -> V_129 & ( ( 1 << V_130 ) |
( 1 << V_131 ) ) ) |
( 1 << V_132 ) ;
...
V_138 | V_139 |
V_140 ;
V_4 -> V_141 |= V_38 -> V_142 | V_143 ;
V_4 -> V_144 = V_38 -> V_144 ;
V_4 -> V_145 = V_38 -> V_145 ;
if ( F_69 ( V_4 -> V_13 ) )
memcpy ( V_4 -> V_13 , V_38 -> V_13 , V_4 -> V_146 ) ;
if ( F_69 ( V_4 -> V_147 ) )
memcpy ( V_4 -> V_147 , V_38 -> V_147 , V_4 -> V_146 ) ;
#if F_70 ( V_148 )
...
F_75 ( V_39 -> V_46 ) ;
V_39 -> V_46 = NULL ;
for ( V_159 = 0 ; V_159 < F_76 ( V_39 -> V_17 ) ; V_159 ++ ) {
while ( ( V_158 = V_39 -> V_17 [ V_159 ] ) != NULL ) {
V_39 -> V_17 [ V_159 ] = V_158 -> V_20 ;
F_77 ( V_158 ) ;
}
}
}
