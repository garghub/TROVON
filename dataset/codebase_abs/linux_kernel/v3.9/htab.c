...
static long F_15 ( unsigned long V_24 , unsigned long V_25 ,
...
F_5 ( & V_20 , V_16 ) ;
V_8 = F_10 ( V_21 , V_24 & ~ 0x3UL ,
& V_14 [ 0 ] , & V_14 [ 1 ] ,
& V_14 [ 2 ] , & V_14 [ 3 ] ,
& V_15 ) ;
if ( V_8 ) {
F_7 ( L_3 ,
V_23 , F_8 ( V_8 ) , V_2 , V_24 , V_6 ) ;
F_9 () ;
}
V_9 = V_14 [ V_24 % 4 ] ;
if ( ! F_16 ( V_9 , V_27 ) || ! ( V_9 & V_19 ) ) {
V_17 = - 1 ;
} else {
V_8 = F_17 ( V_21 ,
V_24 , 0 , 0 ) ;
...
static void F_18 ( unsigned long V_25 , unsigned long V_28 ,
int V_6 , int V_7 )
{
F_14 ( L_4 ) ;
}
static void F_19 ( unsigned long V_24 , unsigned long V_2 ,
int V_6 , int V_7 , int V_26 )
{
unsigned long V_16 ;
int V_8 ;
F_5 ( & V_20 , V_16 ) ;
V_8 = F_17 ( V_21 , V_24 , 0 , 0 ) ;
if ( V_8 ) {
F_7 ( L_5 ,
V_23 , F_8 ( V_8 ) , V_2 , V_24 , V_6 ) ;
F_9 () ;
...
void T_2 F_23 ( unsigned long V_32 )
{
V_33 . V_34 = F_19 ;
V_33 . V_35 = F_15 ;
V_33 . V_36 = F_18 ;
