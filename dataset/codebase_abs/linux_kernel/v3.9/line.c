...
int V_33 = 0 ;
if ( V_37 )
V_33 = F_29 ( V_24 -> V_31 , V_36 , V_40 ,
F_1 , V_41 ,
V_24 -> V_42 , V_2 ) ;
if ( V_33 )
return V_33 ;
if ( V_38 )
V_33 = F_29 ( V_24 -> V_25 , V_36 , V_43 ,
F_22 , V_41 ,
V_24 -> V_44 , V_2 ) ;
return V_33 ;
}
static int F_30 ( struct V_45 * V_35 , struct V_10 * V_11 )
{
int V_16 ;
struct line * line = V_11 -> V_12 ;
V_16 = F_31 ( line ) ;
...
F_33 ( line , & V_11 -> V_47 . V_48 ,
& V_11 -> V_47 . V_49 ) ;
return 0 ;
}
static void F_34 ( struct V_45 * V_35 )
{
struct V_10 * V_11 = F_25 ( V_35 ) ;
struct line * line = V_11 -> V_12 ;
if ( line -> V_46 ) {
F_35 ( V_11 ) ;
line -> V_46 = 0 ;
...
int F_36 ( struct V_10 * V_11 , struct V_50 * V_51 )
{
struct line * line = V_11 -> V_12 ;
return F_37 ( & line -> V_35 , V_11 , V_51 ) ;
}
int F_38 ( struct V_52 * V_24 , struct V_10 * V_11 ,
struct line * line )
{
int V_16 ;
V_16 = F_39 ( V_24 , V_11 ) ;
...
void F_40 ( struct V_10 * V_11 , struct V_50 * V_51 )
{
struct line * line = V_11 -> V_12 ;
F_41 ( & line -> V_35 , V_11 , V_51 ) ;
}
...
int F_46 ( struct line * V_53 , int V_5 , char * V_56 ,
...
line -> V_63 = V_64 ;
line -> V_62 = 1 ;
V_33 = F_49 ( V_64 , line , V_5 , V_58 , V_59 ) ;
if ( ! V_33 ) {
struct V_67 * V_68 = F_51 ( & line -> V_35 ,
V_24 , V_5 , NULL ) ;
if ( F_52 ( V_68 ) ) {
* V_59 = L_6 ;
V_33 = F_53 ( V_68 ) ;
...
return F_46 ( V_53 , V_5 , V_19 , V_58 , V_59 ) ;
}
...
line = & V_53 [ V_75 ] ;
if ( ! line -> V_62 )
F_58 ( V_73 , V_74 , V_5 , L_4 , 1 ) ;
else {
struct V_10 * V_11 = F_25 ( & line -> V_35 ) ;
if ( V_11 == NULL ) {
F_58 ( V_73 , V_74 , V_5 , line -> V_63 , 1 ) ;
} else {
V_5 = F_59 ( line , V_73 , V_74 , V_59 ) ;
F_27 ( V_11 ) ;
}
}
return V_5 ;
...
return F_46 ( V_53 , V_5 , L_4 , NULL , V_59 ) ;
}
