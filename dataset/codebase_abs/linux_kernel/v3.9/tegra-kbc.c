...
V_68 &= ~ V_62 ;
V_69 &= ~ V_63 ;
switch ( V_15 -> V_70 [ V_7 ] . type ) {
case V_71 :
V_68 |= ( ( V_15 -> V_70 [ V_7 ] . V_72 << 1 ) | 1 ) << V_60 ;
break;
case V_73 :
V_69 |= ( ( V_15 -> V_70 [ V_7 ] . V_72 << 1 ) | 1 ) << V_61 ;
break;
case V_74 :
break;
}
...
F_18 ( V_15 ) ;
F_17 ( V_15 , false ) ;
F_10 ( V_15 -> V_77 , V_15 -> V_22 + V_78 ) ;
V_75 = F_24 ( V_15 -> V_75 , V_79 ) ;
V_17 = F_25 ( V_75 ) ;
V_17 |= F_26 ( 1 ) ;
V_17 |= V_39 ;
V_17 |= V_80 ;
...
* V_84 = 0 ;
for ( V_7 = 0 ; V_7 < V_59 ; V_7 ++ ) {
const struct V_85 * V_70 = & V_15 -> V_70 [ V_7 ] ;
switch ( V_70 -> type ) {
case V_71 :
if ( V_70 -> V_72 >= V_57 ) {
F_37 ( V_15 -> V_83 ,
...
{
struct V_87 * V_88 = V_15 -> V_83 -> V_89 ;
T_1 V_90 ;
int V_7 ;
T_1 V_84 = 0 ;
T_1 V_91 = 0 ;
...
int V_94 ;
int V_95 ;
if ( ! F_39 ( V_88 , L_4 , & V_90 ) )
V_15 -> V_75 = V_90 ;
if ( ! F_39 ( V_88 , L_5 , & V_90 ) )
V_15 -> V_77 = V_90 ;
if ( F_40 ( V_88 , L_6 , NULL ) )
V_15 -> V_31 = true ;
if ( F_40 ( V_88 , L_7 , NULL ) )
V_15 -> V_56 = true ;
if ( ! F_41 ( V_88 , L_8 , & V_94 ) ) {
F_37 ( V_15 -> V_83 , L_9 ) ;
return - V_96 ;
}
V_84 = V_94 / sizeof( T_1 ) ;
if ( ! F_41 ( V_88 , L_10 , & V_94 ) ) {
F_37 ( V_15 -> V_83 , L_11 ) ;
return - V_96 ;
}
V_91 = V_94 / sizeof( T_1 ) ;
if ( ! F_41 ( V_88 , L_12 , & V_94 ) ) {
F_37 ( V_15 -> V_83 , L_13 ) ;
return - V_96 ;
}
if ( ! V_84 || ! V_91 || ( ( V_84 + V_91 ) > V_59 ) ) {
F_37 ( V_15 -> V_83 ,
L_14 ) ;
return - V_97 ;
}
for ( V_7 = 0 ; V_7 < V_59 ; V_7 ++ )
V_15 -> V_70 [ V_7 ] . type = V_74 ;
V_95 = F_42 ( V_88 , L_8 ,
V_93 , V_84 ) ;
if ( V_95 < 0 ) {
F_37 ( V_15 -> V_83 , L_15 ) ;
...
for ( V_7 = 0 ; V_7 < V_84 ; V_7 ++ ) {
V_15 -> V_70 [ V_93 [ V_7 ] ] . type = V_71 ;
V_15 -> V_70 [ V_93 [ V_7 ] ] . V_72 = V_7 ;
}
for ( V_7 = 0 ; V_7 < V_91 ; V_7 ++ ) {
V_15 -> V_70 [ V_92 [ V_7 ] ] . type = V_73 ;
V_15 -> V_70 [ V_92 [ V_7 ] ] . V_72 = V_7 ;
}
return 0 ;
}
...
unsigned int V_75 ;
unsigned int V_103 ;
unsigned int V_104 = V_34 ;
V_15 = F_44 ( & V_99 -> V_83 , sizeof( * V_15 ) , V_105 ) ;
if ( ! V_15 ) {
F_37 ( & V_99 -> V_83 , L_17 ) ;
return - V_106 ;
}
...
if ( ! F_36 ( V_15 , & V_84 ) )
return - V_97 ;
V_101 = F_46 ( V_99 , V_107 , 0 ) ;
if ( ! V_101 ) {
F_37 ( & V_99 -> V_83 , L_18 ) ;
return - V_108 ;
}
V_15 -> V_48 = F_47 ( V_99 , 0 ) ;
if ( V_15 -> V_48 < 0 ) {
F_37 ( & V_99 -> V_83 , L_19 ) ;
return - V_108 ;
}
V_15 -> V_35 = F_48 ( & V_99 -> V_83 ) ;
if ( ! V_15 -> V_35 ) {
F_37 ( & V_99 -> V_83 , L_20 ) ;
return - V_106 ;
}
F_49 ( & V_15 -> V_46 , F_11 , ( unsigned long ) V_15 ) ;
V_15 -> V_22 = F_50 ( & V_99 -> V_83 , V_101 ) ;
if ( ! V_15 -> V_22 ) {
F_37 ( & V_99 -> V_83 , L_21 ) ;
return - V_109 ;
}
V_15 -> V_76 = F_51 ( & V_99 -> V_83 , NULL ) ;
if ( F_52 ( V_15 -> V_76 ) ) {
F_37 ( & V_99 -> V_83 , L_22 ) ;
return F_53 ( V_15 -> V_76 ) ;
}
V_75 = F_24 ( V_15 -> V_75 , V_79 ) ;
V_103 = ( V_110 + V_75 ) * V_84 ;
V_15 -> V_45 = V_111 + V_103 + V_15 -> V_77 ;
V_15 -> V_45 = F_54 ( V_15 -> V_45 , V_112 ) ;
V_15 -> V_35 -> V_113 = V_99 -> V_113 ;
V_15 -> V_35 -> V_114 . V_115 = V_116 ;
V_15 -> V_35 -> V_83 . V_117 = & V_99 -> V_83 ;
V_15 -> V_35 -> V_118 = F_33 ;
V_15 -> V_35 -> V_119 = F_35 ;
if ( V_15 -> V_120 && V_15 -> V_30 )
V_104 *= 2 ;
V_102 = F_55 ( V_15 -> V_120 , NULL ,
V_104 , V_86 ,
V_15 -> V_28 , V_15 -> V_35 ) ;
if ( V_102 ) {
F_37 ( & V_99 -> V_83 , L_23 ) ;
...
F_56 ( V_121 , V_15 -> V_35 -> V_122 ) ;
F_57 ( V_15 -> V_35 , V_12 , V_13 ) ;
F_58 ( V_15 -> V_35 , V_15 ) ;
V_102 = F_59 ( & V_99 -> V_83 , V_15 -> V_48 , F_16 ,
V_123 | V_124 , V_99 -> V_113 , V_15 ) ;
if ( V_102 ) {
F_37 ( & V_99 -> V_83 , L_24 ) ;
return V_102 ;
}
F_30 ( V_15 -> V_48 ) ;
V_102 = F_60 ( V_15 -> V_35 ) ;
if ( V_102 ) {
F_37 ( & V_99 -> V_83 , L_25 ) ;
return V_102 ;
}
F_61 ( V_99 , V_15 ) ;
F_62 ( & V_99 -> V_83 , V_15 -> V_56 ) ;
return 0 ;
}
static void F_63 ( struct V_14 * V_15 , bool V_37 )
{
T_1 V_17 ;
V_17 = F_6 ( V_15 -> V_22 + V_38 ) ;
if ( V_37 )
...
static int F_64 ( struct V_126 * V_83 )
{
struct V_98 * V_99 = F_65 ( V_83 ) ;
struct V_14 * V_15 = F_66 ( V_99 ) ;
F_67 ( & V_15 -> V_35 -> V_127 ) ;
if ( F_68 ( & V_99 -> V_83 ) ) {
F_30 ( V_15 -> V_48 ) ;
F_31 ( & V_15 -> V_46 ) ;
F_9 ( V_15 , false ) ;
F_10 ( 0x7 , V_15 -> V_22 + V_43 ) ;
V_15 -> V_128 = F_6 ( V_15 -> V_22 + V_129 ) ;
F_10 ( 0 , V_15 -> V_22 + V_129 ) ;
F_17 ( V_15 , true ) ;
F_69 ( 30 ) ;
V_15 -> V_52 = false ;
F_63 ( V_15 , true ) ;
...
F_71 ( & V_15 -> V_35 -> V_127 ) ;
return 0 ;
}
static int F_72 ( struct V_126 * V_83 )
{
struct V_98 * V_99 = F_65 ( V_83 ) ;
struct V_14 * V_15 = F_66 ( V_99 ) ;
int V_102 = 0 ;
...
F_17 ( V_15 , false ) ;
F_63 ( V_15 , false ) ;
F_10 ( V_15 -> V_128 , V_15 -> V_22 + V_129 ) ;
F_9 ( V_15 , true ) ;
if ( V_15 -> V_52 && V_15 -> V_131 ) {
F_2 ( V_15 -> V_35 , V_15 -> V_131 , 1 ) ;
F_8 ( V_15 -> V_35 ) ;
F_2 ( V_15 -> V_35 , V_15 -> V_131 , 0 ) ;
F_8 ( V_15 -> V_35 ) ;
}
} else {
if ( V_15 -> V_35 -> V_130 )
