...
V_47 = V_6 -> V_51 ;
if ( V_47 ) {
struct V_52 * V_52 = F_15 ( V_6 -> V_51 ) ;
V_48 = V_52 -> V_53 -> V_54 ;
V_46 = V_52 -> V_55 ;
V_50 = ( V_56 ) V_6 -> V_57 << V_37 ;
}
F_8 ( V_2 ,
L_5 ,
V_6 -> V_19 ,
...
V_49 & V_59 ? 'w' : '-' ,
V_49 & V_60 ? 'x' : '-' ,
V_49 & V_22 ? V_49 & V_61 ? 'S' : 's' : 'p' ,
V_50 ,
F_16 ( V_48 ) , F_17 ( V_48 ) , V_46 , & V_40 ) ;
if ( V_47 ) {
F_13 ( V_2 , V_40 ) ;
F_18 ( V_2 , & V_47 -> V_62 , L_6 ) ;
} else if ( V_4 ) {
T_2 V_63 = F_19 ( V_44 -> V_64 , V_6 , V_41 ) ;
if ( V_63 != 0 ) {
F_13 ( V_2 , V_40 ) ;
...
static int F_21 ( struct V_1 * V_2 , void * V_65 , int V_41 )
{
struct V_9 * V_10 = V_65 ;
return F_14 ( V_2 , F_5 ( V_10 , struct V_5 , V_17 ) ,
V_41 ) ;
}
static int F_22 ( struct V_1 * V_2 , void * V_65 )
{
return F_21 ( V_2 , V_65 , 1 ) ;
}
static int F_23 ( struct V_1 * V_2 , void * V_65 )
{
return F_21 ( V_2 , V_65 , 0 ) ;
}
static void * F_24 ( struct V_1 * V_2 , V_56 * V_66 )
{
struct V_43 * V_44 = V_2 -> V_45 ;
struct V_3 * V_4 ;
struct V_9 * V_10 ;
V_56 V_67 = * V_66 ;
V_44 -> V_64 = F_25 ( V_44 -> V_68 , V_69 ) ;
if ( ! V_44 -> V_64 )
return F_26 ( - V_70 ) ;
V_4 = F_27 ( V_44 -> V_64 , V_71 ) ;
if ( ! V_4 || F_28 ( V_4 ) ) {
F_29 ( V_44 -> V_64 ) ;
V_44 -> V_64 = NULL ;
return V_4 ;
...
static void F_30 ( struct V_1 * V_2 , void * V_72 )
{
struct V_43 * V_44 = V_2 -> V_45 ;
if ( V_44 -> V_64 ) {
struct V_3 * V_4 = V_44 -> V_64 -> V_4 ;
F_9 ( & V_4 -> V_15 ) ;
F_31 ( V_4 ) ;
F_29 ( V_44 -> V_64 ) ;
}
}
static void * F_32 ( struct V_1 * V_2 , void * V_65 , V_56 * V_66 )
{
struct V_9 * V_10 = V_65 ;
( * V_66 ) ++ ;
return V_10 ? F_4 ( V_10 ) : NULL ;
}
static int F_33 ( struct V_52 * V_52 , struct V_47 * V_47 ,
const struct V_73 * V_74 )
{
struct V_43 * V_44 ;
int V_75 = - V_76 ;
V_44 = F_34 ( sizeof( * V_44 ) , V_77 ) ;
if ( V_44 ) {
V_44 -> V_68 = F_35 ( V_52 ) ;
V_75 = F_36 ( V_47 , V_74 ) ;
if ( ! V_75 ) {
struct V_1 * V_2 = V_47 -> V_78 ;
V_2 -> V_45 = V_44 ;
} else {
F_37 ( V_44 ) ;
}
...
{
return F_33 ( V_52 , V_47 , & V_79 ) ;
}
static int F_39 ( struct V_52 * V_52 , struct V_47 * V_47 )
{
return F_33 ( V_52 , V_47 , & V_80 ) ;
}
