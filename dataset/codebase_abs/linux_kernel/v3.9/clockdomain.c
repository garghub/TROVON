...
int F_30 ( int (* F_31)( struct V_1 * V_3 , void * V_43 ) ,
void * V_43 )
{
struct V_1 * V_3 ;
int V_22 = 0 ;
...
struct V_5 * F_32 ( struct V_1 * V_3 )
{
if ( ! V_3 )
return NULL ;
return V_3 -> V_6 . V_8 ;
...
int F_36 ( struct V_1 * V_20 , struct V_1 * V_21 )
{
struct V_12 * V_14 ;
int V_22 = 0 ;
if ( ! V_20 || ! V_21 )
...
V_3 -> V_46 &= ~ V_47 ;
V_22 = V_24 -> V_45 ( V_3 ) ;
V_22 |= F_38 ( V_3 -> V_6 . V_8 ) ;
return V_22 ;
}
int V_45 ( struct V_1 * V_3 )
{
int V_22 ;
F_33 ( V_3 -> V_6 . V_8 ) ;
V_22 = F_37 ( V_3 ) ;
...
if ( ! V_3 )
return false ;
return ( V_3 -> V_40 & V_50 ) ? true : false ;
}
void F_44 ( struct V_1 * V_3 )
{
struct V_17 * V_18 ;
if ( ! V_39 || V_3 -> V_40 & V_51 )
return;
...
int V_52 ( struct V_1 * V_3 , struct V_54 * V_54 )
{
if ( ! V_54 )
return - V_7 ;
return F_46 ( V_3 ) ;
}
int F_47 ( struct V_1 * V_3 , struct V_54 * V_54 )
{
if ( ! V_3 || ! V_54 || ! V_24 || ! V_24 -> F_47 )
return - V_7 ;
F_33 ( V_3 -> V_6 . V_8 ) ;
if ( ( F_48 ( V_54 ) == 0 ) && V_3 -> V_53 == 0 )
goto V_55;
if ( V_3 -> V_53 == 0 ) {
F_34 ( V_3 -> V_6 . V_8 ) ;
F_49 ( 1 ) ;
...
int F_50 ( struct V_1 * V_3 , struct V_57 * V_58 )
{
if ( F_51 () || F_52 () )
return 0 ;
if ( ! V_58 )
...
int F_53 ( struct V_1 * V_3 , struct V_57 * V_58 )
{
if ( F_51 () || F_52 () )
return 0 ;
if ( ! V_3 || ! V_58 || ! V_24 || ! V_24 -> F_47 )
return - V_7 ;
F_33 ( V_3 -> V_6 . V_8 ) ;
if ( V_3 -> V_53 == 0 ) {
F_34 ( V_3 -> V_6 . V_8 ) ;
