...
{
struct V_1 * V_2 = V_14 ;
struct V_47 * V_48 = F_42 ( & V_2 -> V_39 ) ;
F_37 ( V_2 ) ;
if ( V_48 ) {
F_43 ( V_48 ) ;
F_44 ( V_48 ) ;
...
static int F_45 ( struct V_47 * V_48 , const unsigned char * V_24 ,
int V_16 )
{
...
while ( 1 ) {
F_38 ( & V_2 -> V_42 , V_41 ) ;
V_25 = F_46 ( V_2 -> V_46 , V_2 -> V_44 , V_45 ) ;
if ( V_16 < V_25 )
V_25 = V_16 ;
if ( V_25 ) {
...
static int F_47 ( struct V_47 * V_48 , struct V_51 * V_52 )
{
struct V_1 * V_2 = & V_53 [ V_48 -> V_33 ] ;
if ( ! V_2 -> V_54 )
return - V_35 ;
return F_48 ( & V_2 -> V_39 , V_48 , V_52 ) ;
}
static void F_49 ( struct V_47 * V_48 , struct V_51 * V_52 )
{
struct V_1 * V_2 = & V_53 [ V_48 -> V_33 ] ;
if ( V_2 -> V_54 )
F_50 ( & V_2 -> V_39 , V_48 , V_52 ) ;
}
...
int V_16 ;
F_38 ( & V_2 -> V_42 , V_41 ) ;
V_16 = F_52 ( V_2 -> V_46 , V_2 -> V_44 , V_45 ) ;
F_40 ( & V_2 -> V_42 , V_41 ) ;
return V_16 ;
}
...
static int F_58 ( struct V_56 * V_39 ,
struct V_47 * V_48 )
{
struct V_1 * V_2 = F_59 ( V_39 , struct V_1 , V_39 ) ;
int V_15 ;
V_48 -> V_49 = V_2 ;
...
V_2 -> V_3 = 1 ;
V_15 = F_60 ( V_2 -> V_4 , F_41 , 0 , L_14 , V_2 ) ;
if ( V_15 < 0 ) {
F_61 ( V_2 -> V_54 , L_16 ,
V_2 -> V_4 , V_15 ) ;
F_62 ( V_2 -> V_55 , V_2 ) ;
...
static void F_63 ( struct V_56 * V_39 )
{
struct V_1 * V_2 = F_59 ( V_39 , struct V_1 , V_39 ) ;
F_62 ( V_2 -> V_4 , V_2 ) ;
F_62 ( V_2 -> V_55 , V_2 ) ;
...
F_66 ( & V_2 -> V_39 ) ;
V_2 -> V_39 . V_60 = & V_61 ;
V_2 -> V_54 = F_67 ( & V_2 -> V_39 , V_34 , V_30 ,
& V_58 -> V_54 ) ;
if ( F_68 ( V_2 -> V_54 ) ) {
V_15 = F_69 ( V_2 -> V_54 ) ;
