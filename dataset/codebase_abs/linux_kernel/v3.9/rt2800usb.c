...
{
if ( V_77 == V_78 )
F_45 ( V_2 , V_79 , 0xff , 0 , 2 ) ;
else
F_45 ( V_2 , V_80 , 0xff , 0xff , 2 ) ;
return 0 ;
}
...
static T_4 * F_50 ( struct V_18 * V_19 )
{
...
struct V_97 * V_98 )
{
struct V_99 * V_100 = F_52 ( V_19 -> V_95 ) ;
T_4 * V_101 = ( T_4 * ) V_19 -> V_95 -> V_43 ;
T_1 V_102 ;
F_53 ( V_101 , 0 , & V_102 ) ;
F_4 ( & V_102 , V_103 ,
F_54 ( V_19 -> V_95 -> V_44 , 4 ) - V_96 ) ;
F_4 ( & V_102 , V_104 ,
...
V_100 -> V_22 |= V_111 ;
V_100 -> V_112 = V_101 ;
V_100 -> V_113 = V_96 + V_114 ;
}
static int F_56 ( struct V_18 * V_19 )
{
return F_54 ( V_19 -> V_95 -> V_44 , 4 ) + 4 ;
}
static enum V_115
F_57 ( struct V_18 * V_19 , T_1 V_6 )
{
T_4 * V_116 ;
T_1 V_102 ;
