...
{
return F_114 ( V_218 , F_112 , F_115 ( V_260 ) -> V_261 ) ;
}
void F_116 ( struct V_1 * V_2 , const char * V_262 ,
unsigned int V_85 ,
void (* putchar)( struct V_1 * , int ) )
{
unsigned int V_248 ;
for ( V_248 = 0 ; V_248 < V_85 ; V_248 ++ , V_262 ++ ) {
if ( * V_262 == '\n' )
putchar ( V_2 , '\r' ) ;
putchar ( V_2 , * V_262 ) ;
}
...
struct V_1 * T_5
F_117 ( struct V_1 * V_263 , int V_259 , struct V_264 * V_265 )
{
int V_266 = V_265 -> V_88 ;
if ( V_266 < 0 || V_266 >= V_259 || ( V_263 [ V_266 ] . V_99 == 0 &&
V_263 [ V_266 ] . V_267 == NULL ) )
for ( V_266 = 0 ; V_266 < V_259 ; V_266 ++ )
if ( V_263 [ V_266 ] . V_99 != 0 ||
V_263 [ V_266 ] . V_267 != NULL )
break;
V_265 -> V_88 = V_266 ;
return V_263 + V_266 ;
...
void
F_118 ( char * V_268 , int * V_46 , int * V_183 , int * V_47 , int * V_269 )
{
char * V_262 = V_268 ;
* V_46 = F_119 ( V_262 , NULL , 10 ) ;
while ( * V_262 >= '0' && * V_262 <= '9' )
V_262 ++ ;
if ( * V_262 )
* V_183 = * V_262 ++ ;
if ( * V_262 )
...
int
F_120 ( struct V_1 * V_2 , struct V_264 * V_265 ,
int V_46 , int V_183 , int V_47 , int V_269 )
{
struct V_57 V_33 ;
static struct V_57 V_270 ;
int V_248 ;
F_121 ( & V_2 -> V_9 ) ;
F_122 ( & V_2 -> V_9 , & V_271 ) ;
...
V_33 . V_34 |= V_73 ;
V_2 -> V_20 |= V_37 ;
V_2 -> V_10 -> V_77 ( V_2 , & V_33 , & V_270 ) ;
if ( V_265 )
V_265 -> V_32 = V_33 . V_34 ;
return 0 ;
}
...
static int F_123 ( struct V_278 * V_279 , void * V_261 )
{
struct V_280 * V_281 = V_261 ;
struct V_256 * V_282 = V_281 -> V_237 -> V_256 ;
T_6 V_283 = F_124 ( V_282 -> V_284 , V_282 -> V_285 ) +
V_281 -> V_2 -> line ;
return V_279 -> V_283 == V_283 ;
}
...
struct V_24 * V_2 = & V_4 -> V_2 ;
struct V_278 * V_286 ;
struct V_280 V_281 = { V_23 , V_236 } ;
F_57 ( & V_2 -> V_115 ) ;
V_286 = F_126 ( V_23 -> V_279 , & V_281 , F_123 ) ;
if ( F_127 ( V_286 ) ) {
if ( ! F_128 ( V_23 -> V_102 ) )
V_23 -> V_287 = 1 ;
F_129 ( V_286 ) ;
...
V_23 -> V_289 = 1 ;
if ( V_2 -> V_8 & V_41 ) {
const struct V_290 * V_10 = V_23 -> V_10 ;
int V_291 ;
if ( V_288 || ! F_14 ( V_23 ) ) {
F_22 ( V_45 , & V_2 -> V_8 ) ;
F_23 ( V_43 , & V_2 -> V_8 ) ;
...
for ( V_291 = 3 ; ! V_10 -> V_151 ( V_23 ) && V_291 ; V_291 -- )
F_130 ( 10 ) ;
if ( ! V_291 )
F_65 ( V_292 L_25
L_26 ,
...
switch ( V_2 -> V_110 ) {
case V_296 :
snprintf ( V_295 , sizeof( V_295 ) , L_28 , V_2 -> V_99 ) ;
break;
case V_297 :
...
V_2 -> V_279 ? L_27 : L_24 ,
V_236 -> F_131 ,
V_236 -> V_256 -> V_293 + V_2 -> line ,
V_295 , V_2 -> V_102 , F_105 ( V_2 ) ) ;
}
static void
...
{
unsigned int V_8 ;
if ( ! V_2 -> V_99 && ! V_2 -> V_114 && ! V_2 -> V_267 )
return;
V_8 = 0 ;
if ( V_2 -> V_8 & V_158 )
V_8 |= V_159 ;
...
F_6 ( & V_2 -> V_9 , V_8 ) ;
if ( V_2 -> V_31 && ! ( V_2 -> V_31 -> V_8 & V_304 ) )
F_139 ( V_2 -> V_31 ) ;
if ( ! F_14 ( V_2 ) )
F_94 ( V_4 , V_223 ) ;
}
}
static int F_140 ( struct V_256 * V_237 , int line , char * V_268 )
{
...
if ( V_268 ) {
F_118 ( V_268 , & V_46 , & V_183 , & V_47 , & V_269 ) ;
return F_120 ( V_2 , NULL , V_46 , V_183 , V_47 , V_269 ) ;
}
return 0 ;
}
...
V_309 -> V_284 = V_236 -> V_284 ;
V_309 -> V_285 = V_236 -> V_313 ;
V_309 -> type = V_314 ;
V_309 -> V_315 = V_316 ;
V_309 -> V_317 = V_318 ;
...
struct V_256 * F_154 ( struct V_264 * V_265 , int * V_88 )
{
struct V_235 * V_323 = V_265 -> V_261 ;
* V_88 = V_265 -> V_88 ;
return V_323 -> V_256 ;
}
...
V_23 -> V_4 = V_4 ;
if ( ! ( F_14 ( V_23 ) && ( V_23 -> V_31 -> V_8 & V_304 ) ) ) {
F_121 ( & V_23 -> V_9 ) ;
F_122 ( & V_23 -> V_9 , & V_271 ) ;
}
F_138 ( V_236 , V_4 , V_23 ) ;
V_286 = F_171 ( V_2 , V_236 -> V_256 ,
V_23 -> line , V_23 -> V_279 , V_2 , V_330 ) ;
if ( F_172 ( ! F_173 ( V_286 ) ) ) {
F_174 ( V_286 , 1 ) ;
} else {
F_65 ( V_292 L_36 ,
V_23 -> line ) ;
