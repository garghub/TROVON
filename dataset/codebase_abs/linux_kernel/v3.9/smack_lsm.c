...
static int F_56 ( struct V_2 * V_120 ,
struct V_4 * V_118 ,
struct V_2 * V_121 ,
struct V_4 * V_119 )
{
...
static int F_57 ( struct V_2 * V_2 , int V_122 )
{
struct V_40 V_41 ;
int V_123 = V_122 & V_124 ;
V_122 &= ( V_83 | V_87 | V_125 | V_126 ) ;
if ( V_122 == 0 )
return 0 ;
if ( V_123 )
return - V_127 ;
F_16 ( & V_41 , V_42 , V_128 ) ;
F_54 ( & V_41 , V_2 ) ;
return F_18 ( F_45 ( V_2 ) , V_122 , & V_41 ) ;
}
...
static int F_71 ( struct V_93 * V_93 , int V_122 )
{
return 0 ;
}
