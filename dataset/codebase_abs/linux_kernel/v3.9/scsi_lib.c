...
V_44 = F_25 ( V_34 , V_10 , V_43 , V_231 , V_123 ,
V_58 , V_39 , V_40 , NULL ) ;
F_28 ( V_231 ) ;
return V_44 ;
}
int
F_177 ( struct V_16 * V_34 , int V_241 , int V_228 ,
unsigned char * V_36 , int V_123 , int V_39 , int V_40 ,
struct V_229 * V_230 , struct V_57 * V_58 )
{
...
memset ( V_36 , 0 , V_123 ) ;
V_59 = F_25 ( V_34 , V_10 , V_161 , V_36 , V_123 ,
V_58 , V_39 , V_40 , NULL ) ;
if ( V_232 && ! F_178 ( V_59 ) &&
( F_95 ( V_59 ) & V_144 ) ) {
if ( F_179 ( V_58 ) ) {
...
int
F_180 ( struct V_16 * V_34 , int V_39 , int V_40 ,
struct V_57 * V_247 )
{
char V_10 [] = {
V_248 , 0 , 0 , 0 , 0 , 0 ,
...
V_58 = V_247 ;
do {
V_59 = F_25 ( V_34 , V_10 , V_159 , NULL , 0 , V_58 ,
V_39 , V_40 , NULL ) ;
if ( V_34 -> V_130 && F_179 ( V_58 ) &&
V_58 -> V_124 == V_129 )
V_34 -> V_131 = 1 ;
} while ( F_179 ( V_58 ) &&
...
int
F_181 ( struct V_16 * V_34 , enum V_249 V_250 )
{
...
static void F_184 ( struct V_16 * V_34 , struct V_255 * V_256 )
{
int V_257 = 0 ;
char * V_258 [ 3 ] ;
switch ( V_256 -> V_259 ) {
...
V_258 [ V_257 ++ ] = NULL ;
F_185 ( & V_34 -> V_85 . V_261 , V_262 , V_258 ) ;
}
void F_186 ( struct V_83 * V_84 )
{
struct V_16 * V_34 ;
F_45 ( V_263 ) ;
...
void F_189 ( struct V_16 * V_34 , struct V_255 * V_256 )
{
unsigned long V_21 ;
#if 0
...
struct V_255 * F_191 ( enum V_269 V_259 ,
T_1 V_270 )
{
...
void F_192 ( struct V_16 * V_34 ,
enum V_269 V_259 , T_1 V_270 )
{
struct V_255 * V_256 = F_191 ( V_259 , V_270 ) ;
if ( ! V_256 ) {
...
int
F_193 ( struct V_16 * V_34 )
{
int V_271 = F_181 ( V_34 , V_175 ) ;
if ( V_271 )
return V_271 ;
F_44 ( V_34 -> V_19 ) ;
while ( V_34 -> V_71 ) {
...
static void
F_196 ( struct V_16 * V_34 , void * V_230 )
{
F_193 ( V_34 ) ;
}
void
F_197 ( struct V_17 * V_18 )
{
F_198 ( V_18 , NULL , F_196 ) ;
}
static void
F_199 ( struct V_16 * V_34 , void * V_230 )
{
F_195 ( V_34 ) ;
}
void
F_200 ( struct V_17 * V_18 )
{
F_198 ( V_18 , NULL , F_199 ) ;
}
int
F_201 ( struct V_16 * V_34 )
{
struct V_19 * V_20 = V_34 -> V_19 ;
unsigned long V_21 ;
int V_271 = 0 ;
V_271 = F_181 ( V_34 , V_176 ) ;
if ( V_271 ) {
V_271 = F_181 ( V_34 , V_177 ) ;
if ( V_271 )
return V_271 ;
}
F_13 ( V_20 -> V_32 , V_21 ) ;
...
static void
F_205 ( struct V_16 * V_34 , void * V_230 )
{
F_201 ( V_34 ) ;
}
static int
F_206 ( struct V_1 * V_2 , void * V_230 )
{
if ( F_207 ( V_2 ) )
F_198 ( F_208 ( V_2 ) , NULL ,
F_205 ) ;
return 0 ;
}
void
...
F_210 ( V_2 , NULL , F_206 ) ;
}
static void
F_211 ( struct V_16 * V_34 , void * V_230 )
{
F_203 ( V_34 , * (enum V_249 * ) V_230 ) ;
}
static int
F_212 ( struct V_1 * V_2 , void * V_230 )
{
if ( F_207 ( V_2 ) )
F_198 ( F_208 ( V_2 ) , V_230 ,
F_211 ) ;
return 0 ;
}
void
F_213 ( struct V_1 * V_2 , enum V_249 V_272 )
{
if ( F_207 ( V_2 ) )
F_198 ( F_208 ( V_2 ) , & V_272 ,
F_211 ) ;
else
F_210 ( V_2 , & V_272 , F_212 ) ;
}
void * F_214 ( struct V_91 * V_92 , int V_273 ,
T_5 * V_274 , T_5 * V_123 )
{
int V_217 ;
T_5 V_275 = 0 , V_276 = 0 ;
...
V_278 = F_218 ( F_219 ( V_277 ) , ( * V_274 >> V_279 ) ) ;
* V_274 &= ~ V_280 ;
V_275 = V_281 - * V_274 ;
if ( * V_123 > V_275 )
* V_123 = V_275 ;
...
void F_221 ( void * V_282 )
{
F_222 ( V_282 ) ;
}
void F_223 ( struct V_16 * V_34 )
{
F_126 ( & V_34 -> V_283 ) ;
}
void F_224 ( struct V_16 * V_34 )
{
if ( F_225 ( F_226 ( & V_34 -> V_283 ) <= 0 ) )
return;
F_227 ( & V_34 -> V_283 ) ;
}
