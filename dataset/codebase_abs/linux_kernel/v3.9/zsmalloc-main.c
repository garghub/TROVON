...
struct V_31 * F_70 ( T_1 V_54 )
{
int V_37 , V_97 ;
struct V_31 * V_32 ;
V_97 = F_71 ( sizeof( * V_32 ) , V_44 ) ;
V_32 = F_72 ( V_97 , V_78 ) ;
if ( ! V_32 )
return NULL ;
...
F_78 ( & V_25 -> V_100 ) ;
V_25 -> V_105 += V_25 -> V_67 ;
}
V_101 = ( unsigned long ) V_45 -> V_56 ;
F_24 ( V_101 , & V_102 , & V_103 ) ;
V_104 = F_26 ( V_102 , V_103 , V_25 -> V_11 ) ;
V_62 = (struct V_61 * ) F_37 ( V_102 ) +
V_104 / sizeof( * V_62 ) ;
V_45 -> V_56 = V_62 -> V_30 ;
memset ( V_62 , V_106 , sizeof( * V_62 ) ) ;
F_38 ( V_62 ) ;
V_45 -> V_15 ++ ;
F_18 ( V_32 , V_45 ) ;
F_79 ( & V_25 -> V_100 ) ;
...
void F_80 ( struct V_31 * V_32 , unsigned long V_101 )
{
struct V_61 * V_62 ;
struct V_1 * V_45 , * V_107 ;
...
if ( F_45 ( ! V_101 ) )
return;
F_24 ( V_101 , & V_107 , & V_108 ) ;
V_45 = F_20 ( V_107 ) ;
F_5 ( V_45 , & V_2 , & V_4 ) ;
V_25 = & V_32 -> V_24 [ V_2 ] ;
V_109 = F_26 ( V_107 , V_108 , V_25 -> V_11 ) ;
F_78 ( & V_25 -> V_100 ) ;
V_62 = (struct V_61 * ) ( ( unsigned char * ) F_37 ( V_107 )
+ V_109 ) ;
V_62 -> V_30 = V_45 -> V_56 ;
F_38 ( V_62 ) ;
V_45 -> V_56 = ( void * ) V_101 ;
V_45 -> V_15 -- ;
V_4 = F_18 ( V_32 , V_45 ) ;
if ( V_4 == V_19 )
V_25 -> V_105 -= V_25 -> V_67 ;
