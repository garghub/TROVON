...
if ( V_99 . V_108 && V_112 -> V_114 > 1 ) {
struct V_111 * V_161 ;
F_88 ( V_112 , V_106 , V_160 ) ;
V_37 = V_106 ;
F_89 (pos, evsel) {
...
static inline void F_91 ( char * * V_166 , int V_18 )
{
int V_167 ;
...
static inline bool F_92 ( void * V_45 )
{
return V_45 == NULL ;
}
...
goto V_183;
if ( F_96 ( V_178 ) ) {
V_166 [ V_172 ] = F_97 ( V_65 ) ;
if ( ! V_166 [ V_172 ] )
goto V_183;
V_169 [ V_172 ] = F_97 ( V_176 ) ;
if ( ! V_169 [ V_172 ] ) {
free ( V_166 [ V_172 ] ) ;
F_98 ( L_37 ) ;
fclose ( V_180 ) ;
...
F_99 ( V_171 ) ;
if ( V_172 ) {
V_173 = F_100 ( V_172 , V_166 ) ;
if ( V_173 < V_172 && V_173 >= 0 ) {
V_170 = F_97 ( V_169 [ V_173 ] ) ;
if ( V_170 ) {
if ( V_184 )
free ( ( void * ) V_185 ) ;
V_185 = V_170 ;
...
static int F_101 ( struct V_111 * V_112 , int V_49 ,
...
V_12 -> V_227 = true ;
V_146 = F_112 ( V_12 , V_112 -> V_228 , V_39 ) ;
V_12 -> V_227 = false ;
if ( ( V_146 == 'q' || V_146 == F_110 ( 'c' ) )
&& V_199 != - 2 && V_198 != - 2 )
goto V_225;
F_36 ( & V_2 -> V_3 , V_2 -> V_5 -> V_6 ) ;
if ( V_146 )
...
static void F_121 ( struct V_36 * V_2 ,
void * V_128 , int V_74 )
{
struct V_233 * V_234 = F_67 ( V_2 ,
struct V_233 , V_3 ) ;
struct V_111 * V_112 = F_122 ( V_128 , struct V_111 , V_17 ) ;
bool V_105 = F_46 ( V_2 , V_74 ) ;
unsigned long V_49 = V_112 -> V_5 . V_47 . V_49 [ V_159 ] ;
const char * V_37 = F_123 ( V_112 ) ;
char V_60 [ 256 ] , V_155 ;
...
F_49 ( V_235 , V_2 -> V_4 - V_63 ) ;
if ( V_105 )
V_234 -> V_32 = V_112 ;
}
static int F_125 ( struct V_233 * V_234 ,
int V_49 , const char * V_238 ,
struct V_38 * V_39 )
{
...
V_39 -> V_45 ( V_39 -> V_46 ) ;
V_37 = F_123 ( V_161 ) ;
V_40 = F_101 ( V_161 , V_49 , V_238 ,
V_37 , true , V_39 ,
V_234 -> V_189 ) ;
F_37 ( & V_234 -> V_3 , V_41 ) ;
switch ( V_40 ) {
case V_205 :
if ( V_161 -> V_17 . V_27 == & V_240 -> V_35 )
V_161 = F_122 ( V_240 -> V_35 . V_27 , struct V_111 , V_17 ) ;
else
V_161 = F_122 ( V_161 -> V_17 . V_27 , struct V_111 , V_17 ) ;
goto V_243;
case V_206 :
if ( V_161 -> V_17 . V_244 == & V_240 -> V_35 )
V_161 = F_122 ( V_240 -> V_35 . V_244 , struct V_111 , V_17 ) ;
else
V_161 = F_122 ( V_161 -> V_17 . V_244 , struct V_111 , V_17 ) ;
goto V_243;
case V_218 :
if ( ! F_109 ( & V_234 -> V_3 ,
L_65 ) )
...
static bool F_127 ( struct V_36 * T_7 V_245 ,
void * V_128 )
{
struct V_111 * V_112 = F_122 ( V_128 , struct V_111 , V_17 ) ;
if ( V_99 . V_108 && ! F_128 ( V_112 ) )
return true ;
return false ;
}
static int F_129 ( struct V_239 * V_240 ,
...
const char * V_37 = F_123 ( V_161 ) ;
T_1 V_250 = strlen ( V_37 ) + 7 ;
if ( V_234 . V_3 . V_4 < V_250 )
V_234 . V_3 . V_4 = V_250 ;
}
return F_125 ( & V_234 , V_6 , V_238 , V_39 ) ;
}
int F_130 ( struct V_239 * V_240 , const char * V_238 ,
struct V_38 * V_39 ,
struct V_188 * V_189 )
{
int V_6 = V_240 -> V_6 ;
V_251:
if ( V_6 == 1 ) {
struct V_111 * V_25 = F_122 ( V_240 -> V_35 . V_27 ,
struct V_111 , V_17 ) ;
const char * V_37 = F_123 ( V_25 ) ;
return F_101 ( V_25 , V_6 , V_238 ,
