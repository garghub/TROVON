...
V_21 = F_21 ( sizeof( * V_2 ) ) ;
if ( V_21 == NULL )
return - V_50 ;
V_2 = F_11 ( V_21 ) ;
F_22 ( V_9 , V_21 ) ;
V_2 -> V_51 = F_23 ( & V_9 -> V_52 , L_2 ) ;
if ( ! F_24 ( V_2 -> V_51 ) ) {
V_17 = F_25 ( V_2 -> V_51 ) ;
if ( V_17 )
goto V_53;
...
V_2 -> V_40 = V_2 -> V_55 -> V_58 ;
V_2 -> V_9 = V_9 ;
V_2 -> V_24 = 0x55 ;
V_21 -> V_52 . V_59 = & V_9 -> V_52 ;
V_21 -> V_60 = F_27 ( V_9 ) -> V_60 ;
V_21 -> V_61 = & V_62 ;
V_21 -> V_63 = V_64 ;
V_21 -> V_65 = V_2 -> V_55 -> V_25 ;
V_21 -> V_66 = V_67 ;
V_48 = 1 ;
V_17 = F_1 ( V_2 , V_68 , 0 ,
! ! V_49 , 0 ) ;
