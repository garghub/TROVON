...
static void F_57 ( struct V_142 * V_142 )
{
...
F_61 ( V_4 -> V_5 , V_2 -> V_11 ,
F_62 ( V_2 -> V_11 ,
V_157 -> V_158 ) ,
V_4 -> V_159 ,
sizeof( V_4 -> V_159 ) ,
F_57 , V_2 ) ;
V_32 = F_58 ( V_4 -> V_5 , V_79 ) ;
if ( V_32 != 0 ) {
F_17 ( & V_2 -> V_11 -> V_11 ,
L_21 , V_69 , V_32 ) ;
F_3 ( V_4 -> V_5 ) ;
...
F_66 ( & V_26 -> V_87 ) ;
V_26 -> V_30 = V_30 ;
V_26 -> V_88 = F_60 ( 0 , V_79 ) ;
if ( ! V_26 -> V_88 ) {
F_4 ( V_26 ) ;
return - V_80 ;
}
V_161 = V_2 -> V_30 [ 0 ] -> V_162 ;
F_61 ( V_26 -> V_88 , V_2 -> V_11 ,
F_67 ( V_2 -> V_11 , V_161 ) ,
V_26 -> V_163 ,
sizeof( V_26 -> V_163 ) ,
F_53 , V_30 ) ;
...
static void F_72 ( struct V_47 * V_48 , int V_173 )
{
struct V_29 * V_30 = V_48 -> V_125 ;
struct V_25 * V_26 ;
int V_32 ;
...
static void F_73 ( struct V_29 * V_30 , int V_176 )
{
struct V_10 * V_11 = V_30 -> V_2 -> V_11 ;
struct V_25 * V_26 = F_21 ( V_30 ) ;
if ( ! V_176 ) {
