...
{
struct V_7 * V_8 = F_11 ( V_9 ) ;
return sprintf ( V_88 , L_30 , F_62 ( V_8 -> V_51 ) ) ;
}
...
F_7 ( V_9 , L_31 ) ;
return sprintf ( V_88 , L_30 , F_66 ( V_104 , V_8 -> V_105 ) ) ;
}
static T_2 F_67 ( struct V_36 * V_9 , struct V_86 * V_87 ,
char * V_88 )
{
struct V_7 * V_8 = F_68 ( V_9 ) ;
return sprintf ( V_88 , L_30 , V_8 -> V_105 ) ;
}
...
return sprintf ( V_88 , L_32 , ( V_8 -> V_37 >> V_106 ) & 1 ) ;
}
...
{
struct V_7 * V_8 = F_11 ( V_9 ) ;
return sprintf ( V_88 , L_30 , F_79 ( V_8 -> V_29 . V_49 ) ) ;
}
...
struct V_86 * V_87 , char * V_88 )
{
return sprintf ( V_88 , L_30 , V_108 ) ;
}
