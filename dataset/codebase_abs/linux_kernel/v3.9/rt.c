...
struct V_72 * V_57 = F_27 ( V_21 ) -> V_57 ;
...
if ( V_149 != V_152 ) {
unsigned long V_34 ;
if ( V_56 -> V_43 . V_153 != V_154 ) {
V_56 -> V_43 . V_116 ++ ;
V_56 -> V_43 . V_153 = V_154 ;
}
V_34 = F_199 ( F_103 ( V_149 , V_150 ) , V_155 / V_156 ) ;
if ( V_56 -> V_43 . V_116 > V_34 )
V_56 -> V_157 . V_158 = V_56 -> V_104 . V_108 ;
}
}
static void F_200 ( struct V_22 * V_22 , struct V_40 * V_56 , int V_159 )
{
struct V_41 * V_42 = & V_56 -> V_43 ;
F_108 ( V_22 ) ;
F_196 ( V_22 , V_56 ) ;
...
void F_204 ( struct V_164 * V_165 , int V_46 )
{
T_4 V_75 ;
struct V_21 * V_21 ;
F_145 () ;
F_91 (rt_rq, iter, cpu_rq(cpu))
F_205 ( V_165 , V_46 , V_21 ) ;
F_149 () ;
}
