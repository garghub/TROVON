...
static int F_37 ( struct V_188 * V_189 )
{
struct V_1 * V_1 =
F_22 ( V_189 -> V_190 , struct V_1 , V_191 ) ;
struct V_22 * V_22 = (struct V_22 * ) V_1 ;
...
F_39 ( V_203 , 8 ) ;
V_22 -> V_55 = F_40 ( V_203 , & V_205 ,
V_206 , 0 , 255 , 1 , 128 ) ;
V_22 -> V_56 = F_40 ( V_203 , & V_205 ,
V_207 , 0 , 255 , 1 , 128 ) ;
V_22 -> gamma = F_40 ( V_203 , & V_205 ,
V_199 , 1 , 6 , 1 , gamma [ V_22 -> V_53 ] ) ;
if ( V_22 -> V_53 == V_41 )
V_22 -> V_193 = F_40 ( V_203 , & V_205 ,
V_208 , 0x30d , 0x493e , 1 , 0x927 ) ;
V_22 -> V_209 = F_40 ( V_203 , & V_205 ,
V_192 , 0 , 1 , 1 , 1 ) ;
if ( V_22 -> V_53 != V_47 )
V_22 -> V_210 = F_41 ( V_203 , & V_205 ,
V_200 ,
V_211 , 0 ,
V_212 ) ;
V_22 -> V_213 = F_40 ( V_203 , & V_205 ,
V_201 , 0 , 3 , 1 ,
V_22 -> V_53 == V_51 ? 0 : 2 ) ;
V_22 -> V_214 = F_40 ( V_203 , & V_205 ,
V_196 ,
...
F_48 ( V_22 -> V_66 , V_1 -> V_260 , V_1 -> V_261 ,
0x21 ) ;
V_70 = V_1 -> V_157 . V_158 [ V_1 -> V_159 ] . V_160 ;
switch ( V_22 -> V_53 ) {
case V_41 :
...
F_20 ( V_1 , F_49 ( V_22 -> V_209 ) ) ;
if ( V_1 -> V_4 < 0 )
return V_1 -> V_4 ;
V_22 -> V_265 = F_50 ( V_266 ) ;
F_51 ( V_22 -> V_265 , & V_22 -> V_162 ) ;
return 0 ;
}
...
struct V_22 * V_22 = (struct V_22 * ) V_1 ;
if ( V_268 >= 3
&& V_267 [ V_268 - 3 ] == 0xff && V_267 [ V_268 - 2 ] == 0xd9 ) {
F_55 ( V_1 , V_269 ,
V_267 , V_268 - 1 ) ;
return;
}
if ( V_267 [ 0 ] == 0xff && V_267 [ 1 ] == 0xd8 ) {
F_55 ( V_1 , V_270 ,
V_22 -> V_66 , V_271 ) ;
V_267 += 18 ;
V_268 -= 18 ;
}
F_55 ( V_1 , V_272 , V_267 , V_268 ) ;
}
static int F_56 ( struct V_1 * V_1 ,
const struct V_273 * V_274 )
{
struct V_22 * V_22 = (struct V_22 * ) V_1 ;
return F_57 ( V_22 -> V_214 , V_274 -> V_275 ) ;
}
...
int V_268 )
{
if ( V_268 == 8 && V_267 [ 4 ] == 1 ) {
F_60 ( V_1 -> V_279 , V_280 , 1 ) ;
F_61 ( V_1 -> V_279 ) ;
F_60 ( V_1 -> V_279 , V_280 , 0 ) ;
F_61 ( V_1 -> V_279 ) ;
}
return 0 ;
}
static int F_62 ( struct V_281 * V_282 ,
const struct V_180 * V_181 )
{
return F_63 ( V_282 , V_181 , & V_283 , sizeof( struct V_22 ) ,
V_284 ) ;
}
