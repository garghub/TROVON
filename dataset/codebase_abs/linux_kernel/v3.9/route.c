...
static int F_227 ( struct V_65 * V_344 , struct V_313 * V_314 , void * V_345 )
{
...
int V_92 ;
struct V_65 * V_66 ;
V_239 = F_228 ( V_314 , sizeof( * V_346 ) , V_348 , V_349 , V_351 ) ;
if ( V_239 < 0 )
goto V_352;
V_346 = F_217 ( V_314 ) ;
V_66 = F_229 ( V_353 , V_42 ) ;
if ( V_66 == NULL ) {
V_239 = - V_255 ;
goto V_352;
}
F_230 ( V_66 ) ;
F_231 ( V_66 ) ;
F_39 ( V_66 ) -> V_104 = V_354 ;
F_232 ( V_66 , V_355 + sizeof( struct V_74 ) ) ;
V_39 = V_348 [ V_336 ] ? F_233 ( V_348 [ V_336 ] ) : 0 ;
V_2 = V_348 [ V_335 ] ? F_233 ( V_348 [ V_335 ] ) : 0 ;
V_350 = V_348 [ V_343 ] ? F_234 ( V_348 [ V_343 ] ) : 0 ;
V_92 = V_348 [ V_341 ] ? F_234 ( V_348 [ V_341 ] ) : 0 ;
memset ( & V_86 , 0 , sizeof( V_86 ) ) ;
V_86 . V_67 = V_2 ;
V_86 . V_102 = V_39 ;
V_86 . V_201 = V_346 -> V_322 ;
V_86 . V_202 = V_348 [ V_337 ] ? F_234 ( V_348 [ V_337 ] ) : 0 ;
V_86 . V_204 = V_92 ;
if ( V_350 ) {
struct V_3 * V_4 ;
V_4 = F_235 ( V_48 , V_350 ) ;
if ( V_4 == NULL ) {
V_239 = - V_295 ;
goto V_356;
}
...
V_66 -> V_92 = V_92 ;
F_236 () ;
V_239 = F_237 ( V_66 , V_2 , V_39 , V_346 -> V_322 , V_4 ) ;
F_238 () ;
V_69 = F_97 ( V_66 ) ;
...
int F_243 ( struct V_65 * V_66 , struct V_359 * V_360 )
{
return V_66 -> V_361 ;
}
...
static int F_245 ( T_11 * V_362 , int V_363 ,
void T_12 * V_364 ,
T_13 * V_365 , T_2 * V_366 )
{
if ( V_363 ) {
F_36 ( (struct V_48 * ) V_362 -> V_367 ) ;
return 0 ;
}
return - V_183 ;
}
...
V_368 = V_369 ;
if ( ! F_247 ( V_48 , & V_370 ) ) {
V_368 = F_248 ( V_368 , sizeof( V_369 ) , V_42 ) ;
if ( V_368 == NULL )
goto V_371;
if ( V_48 -> V_372 != & V_373 )
V_368 [ 0 ] . V_374 = NULL ;
...
V_368 [ 0 ] . V_367 = V_48 ;
V_48 -> V_83 . V_375 = F_249 ( V_48 , L_19 , V_368 ) ;
...
{
F_254 ( & V_48 -> V_63 , 0 ) ;
F_255 ( & V_48 -> V_83 . V_378 ,
sizeof( V_48 -> V_83 . V_378 ) ) ;
return 0 ;
}
static int T_3 F_256 ( struct V_48 * V_48 )
{
struct V_379 * V_380 = F_257 ( sizeof( * V_380 ) , V_42 ) ;
if ( ! V_380 )
return - V_43 ;
F_258 ( V_380 ) ;
...
F_272 () ;
#endif
F_273 ( V_388 , V_389 , F_227 , NULL , NULL ) ;
#ifdef F_274
F_33 ( & V_390 ) ;
#endif
F_33 ( & V_391 ) ;
