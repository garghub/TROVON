...
F_16 ( V_2 , 0x0a , 0x0001 ) ; F_9 ( 1 ) ;
if ( V_33 -> V_46 ) {
F_16 ( V_2 , 0x0f , ( V_33 -> V_47 << 5 ) | ( V_33 -> V_48 << 1 ) | V_49 | V_50 ) ; F_9 ( 1 ) ;
F_26 ( L_3 ,
( V_33 -> V_47 << 5 ) | ( V_33 -> V_48 << 1 ) | V_49 | V_50 ) ;
} else {
F_16 ( V_2 , 0x0f , 0x0acc ) ; F_9 ( 1 ) ;
}
...
F_37 ( L_8 ) ;
F_34 ( V_2 , V_110 -> V_115 , & V_33 -> V_116 ) ;
}
...
{
struct V_32 * V_33 = (struct V_32 * ) F_21 ( V_2 ) ;
F_42 ( V_2 , V_33 -> V_111 -> V_120 . V_121 , V_126 ) ;
V_33 -> V_111 -> V_122 = V_123 ;
}
...
static bool F_49 ( struct V_1 * V_2 , T_7 V_59 )
{
struct V_32 * V_33 = (struct V_32 * ) F_21 ( V_2 ) ;
bool V_131 = false ;
if ( V_59 == V_33 -> V_59 )
...
bool F_51 ( struct V_1 * V_2 , T_7 V_132 , T_2 V_133 )
{
struct V_32 * V_33 = (struct V_32 * ) F_21 ( V_2 ) ;
bool V_134 = false ;
bool V_135 = false ;
...
if ( V_33 -> V_149 ) {
V_136 = V_33 -> V_59 ;
if ( ( V_136 == V_142 || V_136 == V_146 ) && ( ! V_33 -> V_147 ) && V_33 -> V_141 <= V_144 ) {
V_33 -> V_148 = V_60 ;
F_54 ( V_2 ) ;
}
}
...
if ( V_33 -> V_111 -> V_128 == V_183 )
V_33 -> V_66 = V_33 -> V_66 | V_186 | V_187 | V_188 ;
