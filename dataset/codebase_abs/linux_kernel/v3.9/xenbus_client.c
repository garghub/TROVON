...
if ( ! V_19 )
return - V_24 ;
V_18 = F_45 ( 1 , & V_19 -> V_82 , false ) ;
if ( V_18 )
goto V_83;
V_81 = F_46 ( F_47 ( V_19 -> V_82 ) ) ;
V_18 = F_48 ( V_14 , V_58 , & V_19 -> V_77 , V_81 ) ;
if ( V_18 )
goto V_83;
F_41 ( & V_78 ) ;
F_42 ( & V_19 -> V_79 , & V_80 ) ;
...
int F_48 ( struct V_13 * V_14 , int V_58 ,
T_3 * V_77 , void * V_59 )
{
struct V_62 V_63 ;
F_50 ( & V_63 , ( unsigned long ) V_59 , V_65 , V_58 ,
V_14 -> V_42 ) ;
F_39 ( & V_63 , 1 ) ;
if ( V_63 . V_75 != V_76 ) {
F_6 ( V_14 , V_63 . V_75 ,
...
int F_51 ( struct V_13 * V_14 , void * V_59 )
{
return V_60 -> V_84 ( V_14 , V_59 ) ;
}
static int F_52 ( struct V_13 * V_14 , void * V_59 )
{
struct V_68 * V_19 ;
struct V_85 V_63 = {
...
unsigned int V_86 ;
F_41 ( & V_78 ) ;
F_53 (node, &xenbus_valloc_pages, next) {
if ( V_19 -> V_70 -> V_81 == V_59 ) {
F_54 ( & V_19 -> V_79 ) ;
goto V_87;
}
}
...
V_63 . V_77 = V_19 -> V_77 ;
V_63 . V_73 = F_38 (
F_55 ( ( unsigned long ) V_59 , & V_86 ) ) . V_74 ;
if ( F_56 ( V_90 , & V_63 , 1 ) )
F_57 () ;
if ( V_63 . V_75 == V_76 )
F_40 ( V_19 -> V_70 ) ;
...
static int F_58 ( struct V_13 * V_14 , void * V_59 )
{
int V_91 ;
struct V_68 * V_19 ;
void * V_81 ;
...
{
struct V_85 V_63 ;
F_61 ( & V_63 , ( unsigned long ) V_59 , V_65 , V_77 ) ;
if ( F_56 ( V_90 , & V_63 , 1 ) )
F_57 () ;
if ( V_63 . V_75 != V_76 )
F_27 ( V_14 , V_63 . V_75 ,
...
enum V_1 F_62 ( const char * V_15 )
{
enum V_1 V_92 ;
int V_18 = F_63 ( V_40 , V_15 , L_14 , L_15 , & V_92 , NULL ) ;
if ( V_18 )
V_92 = V_4 ;
return V_92 ;
}
