...
static void F_32 ( struct V_47 * V_25 )
{
int V_8 ;
for ( V_8 = 0 ; V_8 < V_94 ; V_8 ++ ) {
if ( F_33 ( V_25 -> clock [ V_8 ] ) )
continue;
F_34 ( V_25 -> clock [ V_8 ] ) ;
F_35 ( V_25 -> clock [ V_8 ] ) ;
}
...
if ( F_38 ( V_25 -> clock [ V_8 ] ) ) {
V_34 = F_39 ( V_25 -> clock [ V_8 ] ) ;
goto V_96;
}
V_34 = F_40 ( V_25 -> clock [ V_8 ] ) ;
if ( V_34 < 0 ) {
F_35 ( V_25 -> clock [ V_8 ] ) ;
V_25 -> clock [ V_8 ] = NULL ;
goto V_96;
...
V_99 = F_44 ( V_98 , V_8 ) ;
if ( V_99 <= 0 ) {
F_41 ( & V_98 -> V_92 , L_13 , V_8 ) ;
return - V_102 ;
}
V_34 = F_45 ( & V_98 -> V_92 , V_99 , V_103 ,
0 , F_46 ( & V_98 -> V_92 ) , V_3 ) ;
if ( V_34 < 0 ) {
F_41 ( & V_98 -> V_92 , L_14 , V_34 ) ;
break;
}
}
return V_34 ;
...
struct V_109 * V_110 ;
int V_34 = 0 ;
V_25 = F_48 ( V_92 , sizeof( * V_25 ) , V_111 ) ;
if ( ! V_25 )
return - V_112 ;
F_49 ( & V_25 -> V_113 ) ;
F_50 ( & V_25 -> V_114 ) ;
...
V_25 -> V_50 = * V_50 ;
V_108 = ( void * ) F_51 ( V_98 ) -> V_117 ;
V_25 -> V_85 = V_108 -> V_85 ;
V_110 = F_52 ( V_98 , V_118 , 0 ) ;
V_25 -> V_119 = F_53 ( V_92 , V_110 ) ;
if ( F_38 ( V_25 -> V_119 ) )
return F_39 ( V_25 -> V_119 ) ;
V_34 = F_42 ( V_98 , V_25 ) ;
if ( V_34 < 0 )
return V_34 ;
V_34 = V_50 -> V_115 () ;
...
goto V_121;
F_55 ( V_98 , V_25 ) ;
F_56 ( V_25 -> clock [ V_122 ] ,
V_25 -> V_50 . V_49 . V_123 ) ;
F_57 ( V_92 , L_16 ,
F_58 ( V_25 -> clock [ V_122 ] ) ) ;
F_59 ( V_25 ) ;
F_60 ( V_92 ) ;
V_34 = F_61 ( V_92 ) ;
if ( V_34 < 0 )
goto V_124;
V_25 -> V_125 = F_62 ( V_92 ) ;
if ( F_38 ( V_25 -> V_125 ) ) {
V_34 = F_39 ( V_25 -> V_125 ) ;
goto V_126;
}
V_34 = F_26 ( V_25 ) ;
if ( V_34 < 0 )
...
if ( V_34 < 0 )
goto V_128;
V_34 = F_63 ( & V_25 -> V_52 , & V_25 -> V_69 ) ;
if ( V_34 < 0 )
goto V_128;
F_64 ( & V_25 -> V_83 . V_129 ) ;
V_34 = F_65 ( & V_25 -> V_52 ) ;
if ( V_34 < 0 )
goto V_130;
V_34 = F_20 ( V_25 ) ;
