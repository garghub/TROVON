...
static T_3 F_48 ( struct V_5 * V_6 , int V_22 ,
unsigned long V_93 )
{
...
V_137 = F_86 ( V_134 [ V_135 ] ) ;
if ( V_137 -> V_141 != V_142 >> 16 ) {
F_85 ( L_4 ,
V_142 >> 16 , V_142 & 0xffff , V_137 -> V_141 ) ;
return - V_139 ;
}
V_138 = F_87 ( & V_6 -> V_9 ) ;
if ( V_138 < 0 )
...
F_89 ( & V_6 -> V_124 , F_80 ) ;
F_90 ( & V_6 -> V_80 ) ;
V_6 -> V_81 = F_91 ( V_4 ) -> V_143 ;
if ( V_6 -> V_81 < 2 )
V_6 -> V_81 = 2 ;
if ( ( V_6 -> V_144 = V_137 -> V_144 ) < 1 )
V_6 -> V_144 = 1 ;
V_6 -> V_32 = V_137 -> V_32 ;
return 0 ;
}
...
V_137 . V_82 = V_6 -> V_82 ;
V_137 . V_141 = V_142 ;
V_137 . V_144 = V_6 -> V_144 ;
V_137 . V_32 = V_6 -> V_32 ;
V_137 . V_147 = 0 ;
V_146 = F_95 ( V_12 , V_148 ) ;
if ( V_146 == NULL )
goto V_149;
if ( F_96 ( V_12 , V_135 , sizeof( V_137 ) , & V_137 ) )
goto V_149;
F_97 ( V_12 , V_146 ) ;
F_98 ( V_145 ) ;
return V_12 -> V_127 ;
...
static int F_100 ( struct V_3 * V_4 , unsigned long V_150 ,
struct V_11 * V_12 , struct V_151 * V_152 )
{
struct V_1 * V_14 = (struct V_1 * ) V_150 ;
T_5 * V_145 = F_93 ( V_4 ) ;
struct V_132 * V_146 ;
struct V_153 V_133 ;
F_94 ( V_145 ) ;
V_152 -> V_154 = V_14 -> V_38 ? V_14 -> V_38 -> V_10 . V_31 : V_155 ;
V_152 -> V_156 = V_14 -> V_10 . V_31 ;
if ( ! V_14 -> V_22 && V_14 -> V_59 . V_74 . V_6 )
V_152 -> V_157 = V_14 -> V_59 . V_74 . V_6 -> V_2 ;
V_146 = F_95 ( V_12 , V_148 ) ;
if ( V_146 == NULL )
goto V_149;
memset ( & V_133 , 0 , sizeof( V_133 ) ) ;
V_133 . V_85 . V_85 = F_101 ( & V_14 -> V_85 ) ;
V_133 . V_67 = F_102 ( V_14 -> V_67 ) ;
V_133 . ceil . V_85 = F_101 ( & V_14 -> ceil ) ;
V_133 . V_66 = F_102 ( V_14 -> V_66 ) ;
V_133 . V_110 = V_14 -> V_110 ;
V_133 . V_35 = V_14 -> V_35 ;
V_133 . V_22 = V_14 -> V_22 ;
if ( F_96 ( V_12 , V_158 , sizeof( V_133 ) , & V_133 ) )
goto V_149;
F_97 ( V_12 , V_146 ) ;
F_98 ( V_145 ) ;
return V_12 -> V_127 ;
...
static int
F_103 ( struct V_3 * V_4 , unsigned long V_150 , struct V_159 * V_160 )
{
struct V_1 * V_14 = (struct V_1 * ) V_150 ;
if ( ! V_14 -> V_22 && V_14 -> V_59 . V_74 . V_6 )
...
if ( F_104 ( V_160 , & V_14 -> V_92 ) < 0 ||
F_105 ( V_160 , NULL , & V_14 -> V_161 ) < 0 ||
F_106 ( V_160 , & V_14 -> V_83 ) < 0 )
return - 1 ;
return F_107 ( V_160 , & V_14 -> V_89 , sizeof( V_14 -> V_89 ) ) ;
}
static int F_108 ( struct V_3 * V_4 , unsigned long V_150 , struct V_3 * V_162 ,
struct V_3 * * V_163 )
{
struct V_1 * V_14 = (struct V_1 * ) V_150 ;
if ( V_14 -> V_22 )
return - V_139 ;
if ( V_162 == NULL &&
( V_162 = F_109 ( V_4 -> V_164 , & V_165 ,
V_14 -> V_10 . V_31 ) ) == NULL )
return - V_166 ;
F_110 ( V_4 ) ;
* V_163 = V_14 -> V_59 . V_74 . V_6 ;
V_14 -> V_59 . V_74 . V_6 = V_162 ;
if ( * V_163 != NULL ) {
F_111 ( * V_163 , ( * V_163 ) -> V_6 . V_75 ) ;
F_76 ( * V_163 ) ;
}
F_112 ( V_4 ) ;
return 0 ;
}
static struct V_3 * F_113 ( struct V_3 * V_4 , unsigned long V_150 )
{
struct V_1 * V_14 = (struct V_1 * ) V_150 ;
return ! V_14 -> V_22 ? V_14 -> V_59 . V_74 . V_6 : NULL ;
}
static void F_114 ( struct V_3 * V_4 , unsigned long V_150 )
{
struct V_1 * V_14 = (struct V_1 * ) V_150 ;
if ( V_14 -> V_59 . V_74 . V_6 -> V_6 . V_75 == 0 )
F_33 ( F_2 ( V_4 ) , V_14 ) ;
}
static unsigned long F_115 ( struct V_3 * V_4 , T_1 V_31 )
{
...
if ( ! V_14 -> V_38 )
return 0 ;
if ( V_14 -> V_38 -> V_168 > 1 )
return 0 ;
return 1 ;
}
static void F_117 ( struct V_5 * V_6 , struct V_1 * V_14 ,
struct V_3 * V_169 )
{
...
V_38 -> V_59 . V_74 . V_6 = V_169 ? V_169 : & V_170 ;
V_38 -> V_72 = V_38 -> V_67 ;
V_38 -> V_71 = V_38 -> V_66 ;
V_38 -> V_88 = F_118 () ;
V_38 -> V_57 = V_62 ;
...
static int F_128 ( struct V_3 * V_4 , unsigned long V_150 )
{
struct V_5 * V_6 = F_2 ( V_4 ) ;
struct V_1 * V_14 = (struct V_1 * ) V_150 ;
unsigned int V_75 ;
struct V_3 * V_169 = NULL ;
int V_172 = 0 ;
if ( V_14 -> V_168 || V_14 -> V_173 )
return - V_174 ;
if ( ! V_14 -> V_22 && F_116 ( V_14 ) ) {
V_169 = F_109 ( V_4 -> V_164 , & V_165 ,
V_14 -> V_38 -> V_10 . V_31 ) ;
V_172 = 1 ;
}
F_110 ( V_4 ) ;
...
F_19 ( & V_14 -> V_48 , V_6 -> V_44 + V_14 -> V_22 ) ;
if ( V_172 )
F_117 ( V_6 , V_14 , V_169 ) ;
F_54 ( -- V_14 -> V_167 == 0 ) ;
F_112 ( V_4 ) ;
return 0 ;
}
static void F_130 ( struct V_3 * V_4 , unsigned long V_150 )
{
struct V_1 * V_14 = (struct V_1 * ) V_150 ;
if ( -- V_14 -> V_167 == 0 )
F_119 ( V_4 , V_14 ) ;
...
T_1 V_175 , struct V_132 * * V_176 ,
unsigned long * V_150 )
{
int V_138 = - V_139 ;
struct V_5 * V_6 = F_2 ( V_4 ) ;
struct V_1 * V_14 = (struct V_1 * ) * V_150 , * V_38 ;
struct V_132 * V_133 = V_176 [ V_148 ] ;
struct V_132 * V_134 [ V_177 ] ;
struct V_153 * V_178 ;
if ( ! V_133 )
goto V_179;
V_138 = F_84 ( V_134 , V_180 , V_133 , V_140 ) ;
if ( V_138 < 0 )
goto V_179;
V_138 = - V_139 ;
if ( V_134 [ V_158 ] == NULL )
goto V_179;
V_38 = V_175 == V_155 ? NULL : F_1 ( V_175 , V_4 ) ;
V_178 = F_86 ( V_134 [ V_158 ] ) ;
if ( ! V_178 -> V_85 . V_85 || ! V_178 -> ceil . V_85 )
goto V_179;
if ( ! V_14 ) {
struct V_3 * V_169 ;
int V_35 ;
...
V_138 = - V_166 ;
V_14 = F_133 ( sizeof( * V_14 ) , V_189 ) ;
if ( ! V_14 )
goto V_179;
V_138 = F_134 ( & V_14 -> V_92 , & V_14 -> V_161 ,
F_93 ( V_4 ) ,
V_176 [ V_186 ] ? : & V_183 . V_181 ) ;
if ( V_138 ) {
F_123 ( V_14 ) ;
goto V_179;
}
...
V_14 -> V_59 . V_74 . V_6 = V_169 ? V_169 : & V_170 ;
V_14 -> V_10 . V_31 = V_31 ;
V_14 -> V_38 = V_38 ;
V_14 -> V_72 = F_135 ( V_178 -> V_67 ) ;
V_14 -> V_71 = F_135 ( V_178 -> V_66 ) ;
V_14 -> V_86 = 60 * V_190 ;
V_14 -> V_88 = F_118 () ;
V_14 -> V_57 = V_62 ;
F_136 ( & V_6 -> V_9 , & V_14 -> V_10 ) ;
if ( V_38 )
V_38 -> V_168 ++ ;
} else {
if ( V_176 [ V_186 ] ) {
V_138 = F_137 ( & V_14 -> V_92 , & V_14 -> V_161 ,
F_93 ( V_4 ) ,
V_176 [ V_186 ] ) ;
if ( V_138 )
return V_138 ;
...
if ( ! V_14 -> V_22 ) {
V_14 -> V_110 = V_178 -> V_85 . V_85 / V_6 -> V_144 ;
if ( ! V_178 -> V_110 && V_14 -> V_110 < 1000 ) {
F_51 (
L_6 ,
V_14 -> V_10 . V_31 ) ;
V_14 -> V_110 = 1000 ;
}
if ( ! V_178 -> V_110 && V_14 -> V_110 > 200000 ) {
F_51 (
L_7 ,
V_14 -> V_10 . V_31 ) ;
V_14 -> V_110 = 200000 ;
...
if ( V_178 -> V_110 )
V_14 -> V_110 = V_178 -> V_110 ;
if ( ( V_14 -> V_35 = V_178 -> V_35 ) >= V_125 )
V_14 -> V_35 = V_125 - 1 ;
}
F_138 ( & V_14 -> V_85 , V_178 -> V_85 . V_85 ) ;
F_138 ( & V_14 -> ceil , V_178 -> ceil . V_85 ) ;
V_14 -> V_67 = F_135 ( V_178 -> V_67 ) ;
V_14 -> V_66 = F_135 ( V_178 -> V_67 ) ;
F_112 ( V_4 ) ;
F_139 ( V_4 , & V_6 -> V_9 ) ;
* V_150 = ( unsigned long ) V_14 ;
return 0 ;
V_179:
return V_138 ;
}
static struct V_17 * * F_140 ( struct V_3 * V_4 , unsigned long V_150 )
{
struct V_5 * V_6 = F_2 ( V_4 ) ;
struct V_1 * V_14 = (struct V_1 * ) V_150 ;
...
static unsigned long F_141 ( struct V_3 * V_4 , unsigned long V_38 ,
T_1 V_31 )
{
struct V_1 * V_14 = F_1 ( V_31 , V_4 ) ;
if ( V_14 )
...
static void F_142 ( struct V_3 * V_4 , unsigned long V_150 )
{
struct V_1 * V_14 = (struct V_1 * ) V_150 ;
if ( V_14 )
V_14 -> V_173 -- ;
}
static void F_143 ( struct V_3 * V_4 , struct V_192 * V_150 )
{
struct V_5 * V_6 = F_2 ( V_4 ) ;
struct V_1 * V_14 ;
unsigned int V_103 ;
...
for ( V_103 = 0 ; V_103 < V_6 -> V_9 . V_130 ; V_103 ++ ) {
F_75 (cl, &q->clhash.hash[i], common.hnode) {
if ( V_150 -> V_194 < V_150 -> V_195 ) {
V_150 -> V_194 ++ ;
continue;
}
if ( V_150 -> V_196 ( V_4 , ( unsigned long ) V_14 , V_150 ) < 0 ) {
V_150 -> V_193 = 1 ;
return;
}
V_150 -> V_194 ++ ;
