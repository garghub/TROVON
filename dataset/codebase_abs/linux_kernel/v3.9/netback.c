...
struct V_69 * V_157 )
{
struct V_158 * V_159 = F_27 ( V_50 ) ;
T_2 * V_55 = V_159 -> V_55 ;
T_1 V_24 = * ( ( T_1 * ) V_50 -> V_90 ) ;
int V_3 , V_160 ;
V_160 = ( F_13 ( & V_159 -> V_55 [ 0 ] ) == V_24 ) ;
for ( V_3 = V_160 ; V_3 < V_159 -> V_54 ; V_3 ++ , V_145 ++ ) {
struct V_12 * V_12 ;
T_3 V_161 ;
struct V_78 * V_78 =
V_7 -> V_78 ;
V_161 = F_15 ( V_7 -> V_26 ++ ) ;
V_24 = V_7 -> V_162 [ V_161 ] ;
V_12 = F_96 ( V_7 , V_50 , V_24 ) ;
if ( ! V_12 )
goto V_163;
V_157 -> V_80 . V_82 . V_83 = V_145 -> V_68 ;
V_157 -> V_80 . V_81 = V_2 -> V_81 ;
V_157 -> V_80 . V_45 = V_145 -> V_45 ;
V_157 -> V_88 . V_82 . V_87 = F_35 ( F_34 ( V_12 ) ) ;
V_157 -> V_88 . V_81 = V_86 ;
V_157 -> V_88 . V_45 = V_145 -> V_45 ;
V_157 -> V_89 = V_145 -> V_46 ;
V_157 -> V_76 = V_84 ;
V_157 ++ ;
...
F_99 ( V_7 , V_24 , V_98 ) ;
V_160 = ( F_13 ( & V_159 -> V_55 [ 0 ] ) == V_24 ) ;
for ( V_3 = V_160 ; V_3 < V_54 ; V_3 ++ ) {
int V_165 , V_166 ;
V_24 = F_13 ( & V_159 -> V_55 [ V_3 ] ) ;
V_166 = ( ++ V_157 ) -> V_94 ;
if ( F_72 ( ! V_166 ) ) {
if ( F_95 ( V_163 ) )
F_99 ( V_7 , V_24 , V_95 ) ;
...
V_24 = * ( ( T_1 * ) V_50 -> V_90 ) ;
F_99 ( V_7 , V_24 , V_95 ) ;
for ( V_165 = V_160 ; V_165 < V_3 ; V_165 ++ ) {
V_24 = F_13 ( & V_159 -> V_55 [ V_165 ] ) ;
F_99 ( V_7 , V_24 , V_95 ) ;
}
V_163 = V_166 ;
}
...
V_50 -> V_167 += V_145 -> V_46 ;
V_50 -> V_168 += V_145 -> V_46 ;
F_103 ( V_7 -> V_11 [ V_24 ] ) ;
F_99 ( V_7 , V_24 , V_95 ) ;
}
}
...
memcpy ( & V_170 , F_31 ( & V_2 -> V_138 , V_147 ) ,
sizeof( V_170 ) ) ;
if ( F_95 ( ! V_170 . type ||
V_170 . type >= V_172 ) ) {
V_2 -> V_138 . V_64 = ++ V_147 ;
...
memcpy ( & V_169 [ V_170 . type - 1 ] , & V_170 , sizeof( V_170 ) ) ;
V_2 -> V_138 . V_64 = ++ V_147 ;
} while ( V_170 . V_76 & V_173 );
return V_149 ;
}
...
F_27 ( V_50 ) -> V_174 = V_175 ;
F_27 ( V_50 ) -> V_174 |= V_176 ;
F_27 ( V_50 ) -> V_177 = 0 ;
return 0 ;
}
...
if ( V_50 -> V_119 != V_120 )
return 0 ;
if ( V_50 -> V_184 != F_108 ( V_185 ) )
goto V_135;
V_179 = ( void * ) V_50 -> V_90 ;
V_180 = V_50 -> V_90 + 4 * V_179 -> V_186 ;
if ( V_180 >= F_39 ( V_50 ) )
goto V_135;
V_50 -> V_187 = V_180 - V_50 -> V_47 ;
switch ( V_179 -> V_184 ) {
case V_188 :
V_50 -> V_189 = F_109 ( struct V_190 , V_191 ) ;
if ( V_182 ) {
struct V_190 * V_192 = (struct V_190 * ) V_180 ;
V_192 -> V_191 = ~ F_110 ( V_179 -> V_193 , V_179 -> V_194 ,
V_50 -> V_89 - V_179 -> V_186 * 4 ,
V_188 , 0 ) ;
}
break;
case V_195 :
V_50 -> V_189 = F_109 ( struct V_196 , V_191 ) ;
if ( V_182 ) {
struct V_196 * V_197 = (struct V_196 * ) V_180 ;
V_197 -> V_191 = ~ F_110 ( V_179 -> V_193 , V_179 -> V_194 ,
V_50 -> V_89 - V_179 -> V_186 * 4 ,
V_195 , 0 ) ;
}
break;
...
if ( ( V_180 + V_50 -> V_189 + 2 ) > F_39 ( V_50 ) )
goto V_135;
V_163 = 0 ;
V_135:
return V_163 ;
...
unsigned long V_200 =
V_2 -> V_201 . V_202 +
F_113 ( V_2 -> V_203 / 1000 ) ;
if ( F_66 ( & V_2 -> V_201 ) )
return true ;
if ( F_114 ( V_198 , V_200 ) ) {
V_2 -> V_201 . V_202 = V_198 ;
F_86 ( V_2 ) ;
}
if ( V_46 > V_2 -> V_142 ) {
V_2 -> V_201 . V_90 =
...
{
struct V_69 * V_157 = V_7 -> V_205 , * V_206 ;
struct V_49 * V_50 ;
int V_107 ;
...
struct V_1 * V_2 ;
struct V_144 V_207 ;
struct V_144 V_208 [ V_35 ] ;
struct V_12 * V_12 ;
struct V_124 V_169 [ V_172 - 1 ] ;
T_1 V_24 ;
T_4 V_10 ;
int V_149 ;
unsigned int V_167 ;
...
V_10 = V_2 -> V_138 . V_64 ;
F_117 () ;
memcpy ( & V_207 , F_31 ( & V_2 -> V_138 , V_10 ) , sizeof( V_207 ) ) ;
if ( V_207 . V_46 > V_2 -> V_142 &&
F_112 ( V_2 , V_207 . V_46 ) ) {
F_60 ( V_2 ) ;
continue;
}
V_2 -> V_142 -= V_207 . V_46 ;
V_149 -- ;
V_2 -> V_138 . V_64 = ++ V_10 ;
memset ( V_169 , 0 , sizeof( V_169 ) ) ;
if ( V_207 . V_76 & V_210 ) {
V_149 = F_104 ( V_2 , V_169 ,
V_149 ) ;
V_10 = V_2 -> V_138 . V_64 ;
if ( F_95 ( V_149 < 0 ) )
continue;
}
V_107 = F_94 ( V_2 , & V_207 , V_208 , V_149 ) ;
if ( F_95 ( V_107 < 0 ) )
continue;
V_10 += V_107 ;
if ( F_95 ( V_207 . V_46 < V_211 ) ) {
F_44 ( V_2 -> V_29 ,
L_14 , V_207 . V_46 ) ;
F_89 ( V_2 , & V_207 , V_10 ) ;
continue;
}
if ( F_95 ( ( V_207 . V_45 + V_207 . V_46 ) > V_31 ) ) {
F_92 ( V_2 -> V_29 ,
L_15 ,
V_207 . V_45 , V_207 . V_46 ,
( V_207 . V_45 & ~ V_57 ) + V_207 . V_46 ) ;
F_91 ( V_2 ) ;
continue;
}
V_161 = F_15 ( V_7 -> V_26 ) ;
V_24 = V_7 -> V_162 [ V_161 ] ;
V_167 = ( V_207 . V_46 > V_212 &&
V_107 < V_35 ) ?
V_212 : V_207 . V_46 ;
V_50 = F_118 ( V_167 + V_213 + V_214 ,
V_215 | V_216 ) ;
if ( F_95 ( V_50 == NULL ) ) {
F_44 ( V_2 -> V_29 ,
L_16 ) ;
...
F_119 ( V_50 , V_213 + V_214 ) ;
if ( V_169 [ V_129 - 1 ] . type ) {
struct V_124 * V_33 ;
V_33 = & V_169 [ V_129 - 1 ] ;
...
V_157 -> V_80 . V_82 . V_83 = V_207 . V_68 ;
V_157 -> V_80 . V_81 = V_2 -> V_81 ;
V_157 -> V_80 . V_45 = V_207 . V_45 ;
V_157 -> V_88 . V_82 . V_87 = F_35 ( F_34 ( V_12 ) ) ;
V_157 -> V_88 . V_81 = V_86 ;
V_157 -> V_88 . V_45 = V_207 . V_45 ;
V_157 -> V_89 = V_207 . V_46 ;
V_157 -> V_76 = V_84 ;
V_157 ++ ;
...
V_2 -> V_138 . V_64 = V_10 ;
F_84 ( V_2 ) ;
if ( ( V_157 - V_7 -> V_205 ) >= F_52 ( V_7 -> V_205 ) )
break;
}
return V_157 - V_7 -> V_205 ;
}
static void F_122 ( struct V_6 * V_7 )
{
struct V_69 * V_157 = V_7 -> V_205 ;
struct V_49 * V_50 ;
while ( ( V_50 = F_54 ( & V_7 -> V_218 ) ) != NULL ) {
struct V_144 * V_145 ;
struct V_1 * V_2 ;
T_1 V_24 ;
unsigned V_167 ;
...
if ( V_145 -> V_76 & V_219 )
V_50 -> V_119 = V_120 ;
else if ( V_145 -> V_76 & V_220 )
V_50 -> V_119 = V_123 ;
F_101 ( V_7 , V_50 ) ;
if ( F_26 ( V_50 ) < V_212 && F_123 ( V_50 ) ) {
int V_221 = F_124 ( int , V_50 -> V_89 , V_212 ) ;
F_125 ( V_50 , V_221 - F_26 ( V_50 ) ) ;
}
V_50 -> V_29 = V_2 -> V_29 ;
V_50 -> V_184 = F_126 ( V_50 , V_50 -> V_29 ) ;
if ( F_106 ( V_2 , V_50 ) ) {
F_44 ( V_2 -> V_29 ,
L_18 ) ;
F_120 ( V_50 ) ;
...
V_2 -> V_29 -> V_116 . V_222 += V_50 -> V_89 ;
V_2 -> V_29 -> V_116 . V_223 ++ ;
F_127 ( V_2 , V_50 ) ;
}
}
...
V_103 -> V_76 = V_76 ;
V_103 -> V_66 = V_66 ;
V_103 -> V_94 = ( V_228 ) V_46 ;
if ( V_225 < 0 )
V_103 -> V_94 = ( V_228 ) V_225 ;
V_2 -> V_39 . V_42 = ++ V_3 ;
return V_103 ;
}
...
struct V_234 * V_235 ;
int V_163 = - V_236 ;
V_163 = F_140 ( F_138 ( V_2 ) ,
V_229 , & V_231 ) ;
if ( V_163 )
goto V_163;
V_233 = (struct V_232 * ) V_231 ;
F_141 ( & V_2 -> V_138 , V_233 , V_31 ) ;
V_163 = F_140 ( F_138 ( V_2 ) ,
V_230 , & V_231 ) ;
if ( V_163 )
goto V_163;
V_235 = (struct V_234 * ) V_231 ;
F_141 ( & V_2 -> V_39 , V_235 , V_31 ) ;
V_2 -> V_37 = 0 ;
return 0 ;
V_163:
F_136 ( V_2 ) ;
...
V_7 -> V_131 . V_204 = F_69 ;
V_7 -> V_26 = 0 ;
V_7 -> V_25 = V_21 ;
for ( V_3 = 0 ; V_3 < V_21 ; V_3 ++ )
V_7 -> V_162 [ V_3 ] = V_3 ;
F_147 ( & V_7 -> V_27 ) ;
V_7 -> V_239 = F_148 ( F_132 ,
( void * ) V_7 ,
L_19 , V_14 ) ;
if ( F_149 ( V_7 -> V_239 ) ) {
F_150 ( V_240 L_20 ) ;
F_151 ( & V_7 -> V_131 ) ;
V_237 = F_152 ( V_7 -> V_239 ) ;
goto V_241;
}
F_153 ( V_7 -> V_239 , V_14 ) ;
F_154 ( & V_7 -> V_134 ) ;
F_155 ( & V_7 -> V_133 ) ;
F_156 ( & V_7 -> V_8 , 0 ) ;
F_157 ( V_7 -> V_239 ) ;
