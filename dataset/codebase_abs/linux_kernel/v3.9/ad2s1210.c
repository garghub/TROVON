...
static T_2 F_18 ( struct V_35 * V_36 ,
struct V_37 * V_38 ,
char * V_39 )
{
struct V_3 * V_4 = F_14 ( F_15 ( V_36 ) ) ;
...
static T_2 F_19 ( struct V_35 * V_36 ,
struct V_37 * V_38 ,
const char * V_39 ,
T_3 V_17 )
{
...
unsigned long V_25 ;
int V_9 ;
V_9 = F_20 ( V_39 , 10 , & V_25 ) ;
if ( V_9 )
return V_9 ;
if ( V_25 < V_41 || V_25 > V_42 ) {
F_8 ( L_3 ) ;
return - V_43 ;
}
F_16 ( & V_4 -> V_40 ) ;
...
{
unsigned long V_74 = V_4 -> V_5 -> V_52 ? V_75 : V_76 ;
struct V_77 V_78 [] = {
{ V_4 -> V_5 -> V_55 , V_75 , L_10 } ,
{ V_4 -> V_5 -> V_6 [ 0 ] , V_74 , L_11 } ,
{ V_4 -> V_5 -> V_6 [ 1 ] , V_74 , L_12 } ,
{ V_4 -> V_5 -> V_31 [ 0 ] , V_74 , L_13 } ,
{ V_4 -> V_5 -> V_31 [ 0 ] , V_74 , L_14 } ,
} ;
return F_39 ( V_78 , F_40 ( V_78 ) ) ;
}
...
struct V_3 * V_4 ;
int V_9 ;
if ( V_80 -> V_36 . V_81 == NULL )
return - V_43 ;
V_59 = F_44 ( sizeof( * V_4 ) ) ;
if ( V_59 == NULL ) {
V_9 = - V_82 ;
goto V_44;
}
V_4 = F_14 ( V_59 ) ;
V_4 -> V_5 = V_80 -> V_36 . V_81 ;
V_9 = F_38 ( V_4 ) ;
if ( V_9 < 0 )
goto V_83;
F_45 ( V_80 , V_59 ) ;
...
V_4 -> V_33 = 12 ;
V_4 -> V_24 = V_84 ;
V_59 -> V_36 . V_85 = & V_80 -> V_36 ;
V_59 -> V_86 = & V_87 ;
V_59 -> V_88 = V_89 ;
V_59 -> V_90 = V_91 ;
V_59 -> V_92 = F_40 ( V_91 ) ;
V_59 -> V_93 = F_47 ( V_80 ) -> V_93 ;
V_9 = F_48 ( V_59 ) ;
if ( V_9 )
goto V_94;
V_4 -> V_25 = V_80 -> V_95 ;
