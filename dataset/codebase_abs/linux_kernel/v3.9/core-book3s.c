...
T_4 F_73 ( struct V_182 * V_183 ,
struct V_184 * V_93 , char * V_185 )
{
struct V_186 * V_187 ;
V_187 = F_74 ( V_93 , struct V_186 , V_93 ) ;
return sprintf ( V_185 , L_4 , V_187 -> V_188 ) ;
}
static void F_75 ( struct V_82 * V_91 , unsigned long V_45 ,
struct V_1 * V_2 )
{
T_1 V_189 = V_91 -> V_100 . V_133 ;
T_3 V_98 , V_99 , V_123 ;
int V_190 = 0 ;
if ( V_91 -> V_100 . V_101 & V_102 ) {
F_16 ( V_91 -> V_100 . V_44 , 0 ) ;
...
if ( V_190 ) {
struct V_191 V_192 ;
F_76 ( & V_192 , ~ 0ULL , V_91 -> V_100 . V_178 ) ;
if ( V_91 -> V_93 . V_193 & V_194 )
F_2 ( V_2 , & V_192 . V_195 ) ;
if ( F_77 ( V_91 , & V_192 , V_2 ) )
F_50 ( V_91 , 0 ) ;
}
}
...
static bool F_81 ( unsigned long V_45 )
{
if ( ( 0x80000000 - V_45 ) <= 256 )
return true ;
return false ;
}
static bool F_82 ( unsigned long V_45 )
{
if ( ( int ) V_45 < 0 )
return true ;
return false ;
...
V_197 = 1 ;
V_198 = 0 ;
for ( V_69 = 0 ; V_69 < V_56 -> V_127 ; ++ V_69 ) {
V_91 = V_56 -> V_91 [ V_69 ] ;
if ( V_91 -> V_100 . V_44 == ( V_68 + 1 ) ) {
V_198 = 1 ;
F_75 ( V_91 , V_45 [ V_68 ] , V_2 ) ;
break;
}
}
if ( ! V_198 )
...
continue;
if ( F_81 ( V_45 [ V_91 -> V_100 . V_44 - 1 ] ) ) {
V_197 = 1 ;
F_75 ( V_91 ,
V_45 [ V_91 -> V_100 . V_44 - 1 ] ,
V_2 ) ;
}
}
}
...
static void F_89 ( int V_202 )
{
struct V_55 * V_56 = & F_90 ( V_55 , V_202 ) ;
if ( ! V_8 )
return;
...
static int T_5
F_91 ( struct V_203 * V_204 , unsigned long V_205 , void * V_206 )
{
unsigned int V_202 = ( long ) V_206 ;
switch ( V_205 & ~ V_207 ) {
case V_208 :
F_89 ( V_202 ) ;
break;
...
int T_5 F_92 ( struct V_210 * V_118 )
{
if ( V_8 )
return - V_180 ;
V_8 = V_118 ;
F_93 ( L_6 ,
V_118 -> V_211 ) ;
V_210 . V_212 = V_8 -> V_212 ;
#ifdef V_29
if ( F_94 () & V_29 )
V_30 = V_31 ;
#endif
F_95 ( & V_210 , L_7 , V_171 ) ;
F_96 ( F_91 ) ;
return 0 ;
}
