...
goto V_279;
V_278:
V_276 = F_165 ( sizeof( struct V_235 ) , V_84 | V_128 ) ;
if ( ! V_276 )
goto V_279;
V_276 -> V_37 = V_37 ;
V_276 -> V_27 = * V_27 ;
...
if ( V_27 -> V_224 != F_122 ( V_282 ) -> V_224 ) {
V_280 = V_282 ;
break;
}
V_282 = V_282 -> V_283 ;
...
struct V_289 * V_290 , struct V_150 * V_291 )
{
struct V_8 * V_9 ;
struct V_6 * V_7 ;
struct V_51 * V_284 ;
...
static int F_184 ( struct V_302 * V_280 ,
unsigned long V_303 , void * V_304 )
{
struct V_150 * V_305 = (struct V_150 * ) V_304 ;
struct V_8 * V_9 ;
struct V_6 * V_7 ;
switch ( V_303 ) {
case V_306 :
...
V_315 -> V_225 = ( void ( * ) ( struct V_3 * ) ) F_134 ;
V_315 -> V_318 = & V_312 ;
V_10 = F_188 ( V_315 ) ;
if ( V_10 )
goto V_316;
...
int V_10 ;
if ( V_320 ) {
F_191 ( L_10 , V_161 , sizeof( V_161 ) , & V_10 ) ;
if ( F_93 ( V_10 ) ) {
F_41 ( V_10 ) ;
V_10 = - V_132 ;
goto V_212;
}
V_100 = F_192 ( F_193 ( V_321 ) , L_11 ) ;
if ( ! V_100 ) {
F_5 ( V_5 L_12 ) ;
