...
if ( ! V_94 )
return - V_44 ;
V_97 = F_69 ( V_40 -> V_13 . V_99 . V_98 , V_94 ) ;
if ( ! V_97 )
return - V_95 ;
V_47 = V_97 ;
for ( V_21 = 0 ; V_21 < V_40 -> V_63 ; V_21 ++ ) {
sprintf ( V_98 , L_25 ,
V_83 [ V_40 -> V_64 [ V_21 ] . type ] ) ;
V_97 = F_74 ( V_98 , V_100 | V_101 , V_47 ,
& V_40 -> V_93 [ V_21 ] ) ;
if ( ! V_97 )
goto V_102;
}
V_97 = F_75 ( L_26 , V_100 | V_101 , V_47 ,
& V_40 -> V_90 ) ;
if ( ! V_97 )
goto V_102;
V_97 = F_76 ( L_27 , V_100 | V_101 , V_47 ,
& V_40 -> V_89 ) ;
if ( ! V_97 )
goto V_102;
V_97 = F_77 ( L_28 , V_101 , V_47 ,
& V_40 -> V_13 ,
& V_103 ) ;
if ( ! V_97 )
goto V_102;
...
int F_78 ( struct V_39 * V_40 )
{
int V_21 , V_42 ;
V_40 -> V_46 . V_98 = F_79 ( V_105 , L_29 , V_40 -> V_106 ) ;
if ( ! V_40 -> V_46 . V_98 )
return - V_95 ;
