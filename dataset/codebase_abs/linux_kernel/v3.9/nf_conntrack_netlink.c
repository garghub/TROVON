...
F_91 ( V_171 , V_179 , V_178 [ type ] , V_180 ) ;
if ( ! V_171 [ V_19 ] )
return - V_177 ;
V_4 -> V_20 . V_21 = V_21 ;
...
static int
F_190 ( struct V_188 * V_189 , struct V_1 * V_2 ,
const struct V_101 * V_102 ,
const struct V_8 * const V_178 [] )
{
struct V_128 * V_128 = F_81 ( V_189 ) ;
...
static int
F_197 ( struct V_128 * V_128 , T_4 V_181 ,
const struct V_8 * const V_178 [] ,
V_122 V_190 ,
T_2 V_100 , int V_140 )
{
...
if ( V_178 [ V_302 ] ) {
V_130 = F_196 ( V_178 [ V_302 ] ,
exp , V_190 ) ;
if ( V_130 < 0 )
goto V_330;
}
V_130 = F_200 ( exp , V_100 , V_140 ) ;
V_330:
F_186 ( exp ) ;
V_39:
F_78 ( F_85 ( V_157 ) ) ;
...
static int
F_201 ( struct V_188 * V_189 , struct V_1 * V_2 ,
const struct V_101 * V_102 ,
const struct V_8 * const V_178 [] )
{
struct V_128 * V_128 = F_81 ( V_189 ) ;
...
return V_130 ;
F_82 ( & V_163 ) ;
exp = F_202 ( V_128 , V_181 , & V_4 ) ;
if ( ! exp ) {
F_89 ( & V_163 ) ;
V_130 = - V_191 ;
if ( V_102 -> V_195 & V_136 ) {
V_130 = F_197 ( V_128 , V_181 , V_178 ,
V_190 ,
F_86 ( V_2 ) . V_100 ,
F_104 ( V_102 ) ) ;
}
...
V_130 = - V_246 ;
if ( ! ( V_102 -> V_195 & V_137 ) )
V_130 = F_195 ( exp , V_178 ) ;
F_89 ( & V_163 ) ;
return V_130 ;
}
static int
F_203 ( struct V_1 * V_2 , T_2 V_100 , T_2 V_91 , int V_247 ,
const struct V_248 * V_249 )
{
struct V_101 * V_102 ;
struct V_103 * V_104 ;
...
static int
F_204 ( struct V_1 * V_2 , struct V_151 * V_152 )
{
int V_247 ;
struct V_128 * V_128 = F_81 ( V_2 -> V_154 ) ;
if ( V_152 -> args [ 0 ] == V_277 )
...
continue;
V_249 = F_168 ( V_128 -> V_23 . V_278 , V_247 ) ;
if ( F_203 ( V_2 , F_86 ( V_152 -> V_2 ) . V_100 ,
V_152 -> V_102 -> V_168 ,
V_247 , V_249 ) < 0 )
break;
}
...
static int
F_205 ( struct V_188 * V_189 , struct V_1 * V_2 ,
const struct V_101 * V_102 ,
const struct V_8 * const V_178 [] )
{
if ( V_102 -> V_195 & V_196 ) {
...
static int T_8 F_206 ( struct V_128 * V_128 )
{
#ifdef F_207
int V_7 ;
V_7 = F_208 ( V_128 , & V_339 ) ;
if ( V_7 < 0 ) {
F_209 ( L_5 ) ;
goto V_330;
}
V_7 = F_210 ( V_128 , & V_340 ) ;
if ( V_7 < 0 ) {
F_209 ( L_6 ) ;
goto V_341;
}
...
static void F_212 ( struct V_128 * V_128 )
{
#ifdef F_207
F_213 ( V_128 , & V_340 ) ;
F_211 ( V_128 , & V_339 ) ;
...
static void T_9 F_214 ( struct V_342 * V_343 )
{
struct V_128 * V_128 ;
