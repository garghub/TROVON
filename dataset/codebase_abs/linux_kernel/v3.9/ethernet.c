...
static struct V_106 * F_60 ( const struct V_106 * V_107 ,
int V_108 )
{
...
const T_7 * V_32 ;
for (; ; ) {
V_109 = F_61 ( V_107 , V_109 ) ;
if ( ! V_109 )
break;
V_32 = F_62 ( V_109 , L_2 , & V_110 ) ;
if ( V_32 && ( F_63 ( * V_32 ) == V_108 ) )
break;
}
return V_109 ;
}
static struct V_106 * F_64 ( struct V_106 * V_111 ,
int V_61 , int V_13 )
{
struct V_106 * V_112 , * V_113 ;
V_112 = F_60 ( V_111 , V_61 ) ;
if ( ! V_112 )
return NULL ;
V_113 = F_60 ( V_112 , V_13 ) ;
F_65 ( V_112 ) ;
return V_113 ;
}
...
V_9 = F_18 ( V_37 ) ;
V_9 -> V_91 = F_64 ( V_111 , V_61 , V_132 ) ;
F_82 ( & V_9 -> V_10 ,
F_5 ) ;
V_9 -> V_129 = V_129 ;
V_9 -> V_13 = V_13 ;
V_9 -> V_97 = F_83 ( V_9 -> V_13 ) ;
V_9 -> V_117 = V_117 - F_84 ( V_13 ) * 4 ;
for ( V_119 = 0 ; V_119 < 16 ; V_119 ++ )
F_79 ( & V_9 -> V_131 [ V_119 ] ) ;
for ( V_119 = 0 ; V_119 < F_84 ( V_13 ) ;
V_119 ++ )
F_76 ( V_9 -> V_117 + V_119 * 4 , 0 ) ;
switch ( V_9 -> V_129 ) {
case V_130 :
case V_133 :
case V_134 :
