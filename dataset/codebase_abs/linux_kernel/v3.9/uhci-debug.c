...
V_10 += sprintf ( V_10 ,
L_91 ,
V_5 -> V_111 , V_5 -> V_111 & 1023 ,
V_5 -> V_112 , V_5 -> V_112 & 1023 ) ;
V_25:
if ( V_10 - V_1 > V_8 )
V_10 += sprintf ( V_10 , L_21 ) ;
return V_10 - V_1 ;
...
V_5 -> V_122 ,
F_29 ( V_5 ) -> V_123 . V_124 ,
F_29 ( V_5 ) -> V_123 . V_125 ) ;
if ( V_48 <= 1 )
goto V_49;
V_10 += sprintf ( V_10 , L_107 ) ;
V_117 = 10 ;
V_118 = 0 ;
for ( V_32 = 0 ; V_32 < V_126 ; ++ V_32 ) {
T_2 V_127 ;
if ( V_10 - V_1 > V_8 )
goto V_25;
V_113 = 0 ;
...
V_115 = V_116 ;
do {
V_7 = F_20 ( V_115 , struct V_6 , V_131 ) ;
V_115 = V_115 -> V_64 ;
...
int V_133 = 0 ;
V_37 = V_5 -> V_134 [ V_32 ] ;
V_10 += sprintf ( V_10 , L_113 , V_120 [ V_32 ] ) ;
...
V_14 = V_119 ;
if ( ! V_14 )
V_14 = F_31 ( V_5 , V_5 -> V_136 ) ;
goto V_137;
}
V_116 = & V_37 -> V_65 ;
V_115 = V_116 -> V_64 ;
while ( V_115 != V_116 ) {
V_37 = F_20 ( V_115 , struct V_50 , V_65 ) ;
V_115 = V_115 -> V_64 ;
if ( ++ V_133 <= 10 ) {
...
if ( ! V_119 && V_37 -> V_138 >= V_139 )
V_119 = F_31 ( V_5 , V_37 ) ;
}
if ( ( V_133 -= 10 ) > 0 )
V_10 += sprintf ( V_10 , L_115 , V_133 ) ;
V_14 = F_32 ( V_5 ) ;
if ( V_32 <= V_140 )
;
else if ( V_32 < V_141 )
...
static int F_33 ( struct V_142 * V_142 , struct V_143 * V_143 )
{
struct V_4 * V_5 = V_142 -> V_144 ;
struct V_145 * V_146 ;
unsigned long V_147 ;
V_146 = F_34 ( sizeof( * V_146 ) , V_148 ) ;
if ( ! V_146 )
return - V_149 ;
V_146 -> V_150 = F_34 ( V_151 , V_148 ) ;
if ( ! V_146 -> V_150 ) {
F_35 ( V_146 ) ;
return - V_149 ;
}
V_146 -> V_152 = 0 ;
F_36 ( & V_5 -> V_153 , V_147 ) ;
if ( V_5 -> V_154 )
V_146 -> V_152 = F_28 ( V_5 , V_146 -> V_150 ,
V_151 - V_155 ) ;
F_37 ( & V_5 -> V_153 , V_147 ) ;
V_143 -> V_156 = V_146 ;
return 0 ;
}
static T_3 F_38 ( struct V_143 * V_143 , T_3 V_157 , int V_158 )
{
struct V_145 * V_146 ;
T_3 V_159 = - 1 ;
V_146 = V_143 -> V_156 ;
...
break;
case 1 :
V_159 = V_143 -> V_160 + V_157 ;
break;
}
if ( V_159 < 0 || V_159 > V_146 -> V_152 )
return - V_161 ;
return ( V_143 -> V_160 = V_159 ) ;
}
static T_4 F_39 ( struct V_143 * V_143 , char T_5 * V_1 ,
T_6 V_162 , T_3 * V_163 )
{
struct V_145 * V_146 = V_143 -> V_156 ;
return F_40 ( V_1 , V_162 , V_163 , V_146 -> V_150 , V_146 -> V_152 ) ;
}
static int F_41 ( struct V_142 * V_142 , struct V_143 * V_143 )
{
struct V_145 * V_146 = V_143 -> V_156 ;
F_35 ( V_146 -> V_150 ) ;
F_35 ( V_146 ) ;
