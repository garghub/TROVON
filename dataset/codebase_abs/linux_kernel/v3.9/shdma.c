...
if ( ! V_7 || ! V_7 -> V_26 )
return - V_132 ;
V_28 = F_70 ( V_106 , V_133 , 0 ) ;
V_65 = F_70 ( V_106 , V_133 , 1 ) ;
V_130 = F_70 ( V_106 , V_134 , 0 ) ;
if ( ! V_28 || ! V_130 )
return - V_132 ;
if ( ! F_71 ( V_28 -> V_135 , F_72 ( V_28 ) , V_106 -> V_136 ) ) {
F_51 ( & V_106 -> V_32 , L_9 ) ;
return - V_62 ;
}
if ( V_65 && ! F_71 ( V_65 -> V_135 , F_72 ( V_65 ) , V_106 -> V_136 ) ) {
...
V_31 = & V_5 -> V_30 . V_31 ;
V_5 -> V_6 = F_73 ( V_28 -> V_135 , F_72 ( V_28 ) ) ;
if ( ! V_5 -> V_6 )
goto V_139;
if ( V_65 ) {
V_5 -> V_65 = F_73 ( V_65 -> V_135 , F_72 ( V_65 ) ) ;
if ( ! V_5 -> V_65 )
goto V_140;
}
if ( ! V_7 -> V_141 )
F_74 ( V_142 , V_31 -> V_143 ) ;
if ( V_7 -> V_82 && V_7 -> V_83 )
F_74 ( V_144 , V_31 -> V_143 ) ;
V_31 -> V_145 = V_60 ;
V_5 -> V_30 . V_146 = & V_147 ;
V_5 -> V_30 . V_148 = sizeof( struct V_72 ) ;
...
if ( V_107 < 0 )
F_51 ( & V_106 -> V_32 , L_12 , V_152 , V_107 ) ;
F_79 ( & V_20 ) ;
F_80 ( & V_5 -> V_153 , & V_154 ) ;
F_81 ( & V_20 ) ;
V_107 = F_16 ( V_5 ) ;
if ( V_107 )
goto V_155;
#if F_82 ( V_156 ) || F_82 ( V_157 )
V_131 = F_70 ( V_106 , V_134 , 1 ) ;
if ( ! V_131 )
V_131 = V_130 ;
else
V_127 ++ ;
if ( V_131 == V_130 ||
( V_130 -> V_19 & V_158 ) == V_159 )
V_120 = V_160 ;
V_124 = V_130 -> V_135 ;
...
V_131 = V_130 ;
#endif
if ( V_131 -> V_135 == V_131 -> V_162 &&
! F_70 ( V_106 , V_134 , 1 ) ) {
for (; V_126 < V_7 -> V_26 ; V_126 ++ ) {
if ( V_126 < V_123 ) {
V_125 [ V_126 ] = V_131 -> V_135 ;
V_122 [ V_126 ] = V_160 ;
} else {
V_128 = 1 ;
break;
...
do {
for ( V_25 = V_131 -> V_135 ; V_25 <= V_131 -> V_162 ; V_25 ++ ) {
if ( V_126 >= V_123 ) {
V_128 = 1 ;
break;
}
...
V_138:
if ( V_65 )
F_94 ( V_65 -> V_135 , F_72 ( V_65 ) ) ;
V_137:
F_94 ( V_28 -> V_135 , F_72 ( V_28 ) ) ;
return V_107 ;
}
static int F_95 ( struct V_105 * V_106 )
{
struct V_4 * V_5 = F_61 ( V_106 ) ;
struct V_114 * V_31 = & V_5 -> V_30 . V_31 ;
struct V_129 * V_165 ;
...
F_93 () ;
F_55 ( V_5 ) ;
V_165 = F_70 ( V_106 , V_133 , 0 ) ;
if ( V_165 )
F_94 ( V_165 -> V_135 , F_72 ( V_165 ) ) ;
V_165 = F_70 ( V_106 , V_133 , 1 ) ;
if ( V_165 )
F_94 ( V_165 -> V_135 , F_72 ( V_165 ) ) ;
return 0 ;
}
...
{
int V_107 = F_99 ( & V_166 ) ;
if ( V_107 )
return V_107 ;
return F_100 ( & V_167 , F_69 ) ;
}
