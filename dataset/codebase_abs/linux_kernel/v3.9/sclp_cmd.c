...
if ( V_88 && V_121 && ( V_121 + V_122 == V_88 ) ) {
V_122 ++ ;
return;
}
if ( ! V_121 )
goto V_123;
V_91 = F_36 ( V_121 ) ;
V_97 = ( unsigned long long ) V_122 * V_39 ;
if ( V_91 >= V_124 )
goto V_123;
if ( V_91 + V_97 > V_124 )
V_97 = V_124 - V_91 ;
...
F_53 ( & V_127 -> V_132 , V_129 ) ;
}
static int F_54 ( struct V_133 * V_134 )
{
if ( ! V_118 )
return 0 ;
F_55 ( L_8 ) ;
...
if ( V_3 )
goto V_4;
V_137 = F_61 ( L_9 , - 1 , NULL , 0 ) ;
V_3 = F_62 ( V_137 ) ? F_63 ( V_137 ) : 0 ;
if ( V_3 )
goto V_144;
F_51 () ;
goto V_4;
...
static int F_65 ( T_2 V_1 , T_5 V_145 )
{
struct V_146 * V_2 ;
int V_3 ;
if ( ! V_147 )
return - V_80 ;
V_2 = (struct V_146 * ) F_28 ( V_58 | V_81 ) ;
if ( ! V_2 )
return - V_59 ;
V_2 -> V_17 . V_18 = V_90 ;
V_2 -> V_148 = V_149 ;
...
int F_67 ( T_5 V_145 )
{
return F_65 ( V_151 , V_145 ) ;
}
int F_68 ( T_5 V_145 )
{
return F_65 ( V_152 , V_145 ) ;
}
...
if ( ! V_154 )
return - V_80 ;
V_2 = (struct V_153 * ) F_28 ( V_58 | V_81 ) ;
if ( ! V_2 )
return - V_59 ;
V_2 -> V_17 . V_18 = sizeof( * V_2 ) ;
V_3 = F_19 ( V_1 , V_2 ) ;
...
int F_70 ( struct V_155 V_156 )
{
return F_69 ( V_157 | V_156 . V_92 << 8 ) ;
}
int F_71 ( struct V_155 V_156 )
{
return F_69 ( V_158 | V_156 . V_92 << 8 ) ;
}
int F_72 ( struct V_159 * V_47 )
{
struct V_160 * V_2 ;
int V_3 ;
if ( ! V_161 )
return - V_80 ;
V_2 = (struct V_160 * ) F_28 ( V_58 | V_81 ) ;
if ( ! V_2 )
return - V_59 ;
V_2 -> V_17 . V_18 = sizeof( * V_2 ) ;
V_3 = F_19 ( V_162 , V_2 ) ;
...
memcpy ( V_47 -> V_163 , V_2 -> V_163 , V_164 ) ;
memcpy ( V_47 -> V_72 , V_2 -> V_72 , V_164 ) ;
memcpy ( V_47 -> V_70 , V_2 -> V_70 , V_164 ) ;
V_4:
F_29 ( ( unsigned long ) V_2 ) ;
return V_3 ;
}
