...
static inline bool F_178 ( struct V_83 * V_83 , struct V_1 * V_2 )
{
unsigned long V_214 , V_215 ;
bool V_216 ;
if ( V_2 -> V_139 <= V_203 )
return false ;
V_214 = F_21 ( F_179 ( V_83 ) ,
( V_83 -> V_217 + V_218 - 1 ) /
V_218 ) ;
V_215 = F_163 ( V_83 ) + V_214 + ( 2UL << V_2 -> V_139 ) ;
V_216 = F_180 ( V_83 , 0 , V_215 , 0 , 0 ) ;
if ( F_181 ( V_83 , V_2 -> V_139 ) )
return V_216 ;
if ( ! F_173 ( V_83 , V_2 -> V_139 ) )
return false ;
return V_216 ;
}
static bool F_182 ( struct V_219 * V_219 , struct V_1 * V_2 )
{
struct V_220 * V_221 ;
struct V_83 * V_83 ;
unsigned long V_222 ;
...
static bool F_187 ( struct V_83 * V_83 )
{
return V_83 -> V_156 < F_188 ( V_83 ) * 6 ;
}
...
static unsigned long F_189 ( struct V_219 * V_219 ,
struct V_1 * V_2 ,
struct V_13 * V_15 )
{
...
static bool F_200 ( T_7 V_102 , struct V_219 * V_219 ,
T_8 * V_246 )
{
struct V_83 * V_83 ;
int V_247 = F_194 ( V_102 ) ;
T_6 * V_237 ;
if ( V_37 -> V_38 & V_248 )
goto V_20;
if ( F_143 ( V_37 ) )
goto V_20;
F_193 ( V_219 , V_247 , NULL , & V_83 ) ;
V_237 = V_83 -> V_162 ;
if ( F_196 ( V_237 ) )
goto V_20;
F_79 ( V_249 ) ;
...
unsigned long F_203 ( struct V_219 * V_219 , int V_139 ,
T_7 V_102 , T_8 * V_246 )
{
unsigned long V_93 ;
struct V_1 V_2 = {
. V_102 = ( V_102 = F_204 ( V_102 ) ) ,
. V_113 = ! V_231 ,
. V_199 = V_19 ,
. V_100 = 1 ,
. V_189 = 1 ,
...
if ( F_200 ( V_102 , V_219 , V_246 ) )
return 1 ;
F_205 ( V_139 ,
V_2 . V_113 ,
V_102 ) ;
V_93 = F_189 ( V_219 , & V_2 , & V_15 ) ;
F_206 ( V_93 ) ;
return V_93 ;
}
unsigned long F_207 ( struct V_209 * V_213 ,
...
unsigned long F_210 ( struct V_209 * V_213 ,
T_7 V_102 ,
bool V_252 )
{
struct V_219 * V_219 ;
...
{
if ( ! F_180 ( V_83 , V_139 , F_163 ( V_83 ) +
V_214 , V_244 , 0 ) )
return false ;
...
static bool F_217 ( T_6 * V_237 , int V_139 , int V_244 )
{
...
static bool F_218 ( T_6 * V_237 , int V_139 , long V_258 ,
int V_244 )
{
if ( V_258 )
return false ;
if ( F_198 ( & V_237 -> V_250 ) ) {
F_219 ( & V_237 -> V_250 ) ;
return false ;
}
return F_217 ( V_237 , V_139 , V_244 ) ;
}
static unsigned long F_220 ( T_6 * V_237 , int V_139 ,
int * V_244 )
{
bool V_259 = false ;
int V_239 ;
...
if ( F_216 ( V_83 , V_266 , 0 , V_260 ) )
F_222 ( V_83 , V_115 ) ;
}
if ( F_198 ( & V_237 -> V_250 ) &&
F_196 ( V_237 ) )
F_219 ( & V_237 -> V_250 ) ;
if ( F_217 ( V_237 , V_139 , * V_244 ) ) {
V_259 = true ;
break;
}
if ( V_2 . V_93 >= V_19 )
...
static void F_226 ( T_6 * V_237 , int V_139 , int V_244 )
{
long V_258 = 0 ;
F_227 ( V_269 ) ;
if ( F_228 ( V_37 ) || F_229 () )
return;
F_230 ( & V_237 -> V_243 , & V_269 , V_270 ) ;
if ( F_218 ( V_237 , V_139 , V_258 , V_244 ) ) {
V_258 = F_231 ( V_155 / 10 ) ;
F_232 ( & V_237 -> V_243 , & V_269 ) ;
F_230 ( & V_237 -> V_243 , & V_269 , V_270 ) ;
}
if ( F_218 ( V_237 , V_139 , V_258 , V_244 ) ) {
F_233 ( V_237 -> V_163 ) ;
...
const struct V_282 * V_282 = F_238 ( V_237 -> V_163 ) ;
F_239 ( V_117 ) ;
if ( ! F_240 ( V_282 ) )
F_241 ( V_281 , V_282 ) ;
V_37 -> V_227 = & V_227 ;
...
break;
if ( ! V_18 ) {
F_243 ( V_237 -> V_163 , V_139 ) ;
V_279 = V_244 ;
V_277 = F_220 ( V_237 , V_139 ,
& V_279 ) ;
}
}
V_37 -> V_227 = NULL ;
...
void F_244 ( struct V_83 * V_83 , int V_139 , enum V_245 V_244 )
{
T_6 * V_237 ;
if ( ! F_184 ( V_83 ) )
return;
...
if ( ! F_198 ( & V_237 -> V_243 ) )
return;
if ( F_180 ( V_83 , V_139 , F_179 ( V_83 ) , 0 , 0 ) )
return;
F_245 ( V_237 -> V_163 , F_148 ( V_83 ) , V_139 ) ;
F_199 ( & V_237 -> V_243 ) ;
}
...
unsigned long F_188 ( struct V_83 * V_83 )
{
int V_25 ;
V_25 = F_5 ( V_83 , V_286 ) +
F_5 ( V_83 , V_144 ) ;
...
unsigned long F_248 ( unsigned long V_199 )
{
struct V_227 V_227 ;
struct V_1 V_2 = {
. V_102 = V_254 ,
...
struct V_219 * V_219 = F_249 ( F_250 () , V_2 . V_102 ) ;
...
static int F_252 ( struct V_287 * V_288 , unsigned long V_289 ,
void * V_290 )
{
int V_255 ;
if ( V_289 == V_291 || V_289 == V_292 ) {
F_253 (nid, N_MEMORY) {
T_6 * V_237 = F_212 ( V_255 ) ;
const struct V_282 * V_293 ;
V_293 = F_238 ( V_237 -> V_163 ) ;
if ( F_254 ( V_294 , V_293 ) < V_295 )
F_241 ( V_237 -> F_237 , V_293 ) ;
}
}
return V_296 ;
}
...
if ( V_237 -> F_237 )
return 0 ;
V_237 -> F_237 = F_256 ( F_237 , V_237 , L_4 , V_255 ) ;
if ( F_257 ( V_237 -> F_237 ) ) {
F_50 ( V_297 == V_298 ) ;
F_258 ( L_5 , V_255 ) ;
V_18 = F_259 ( V_237 -> F_237 ) ;
V_237 -> F_237 = NULL ;
}
return V_18 ;
}
void F_260 ( int V_255 )
{
struct V_280 * F_237 = F_212 ( V_255 ) -> F_237 ;
if ( F_237 ) {
F_261 ( F_237 ) ;
F_212 ( V_255 ) -> F_237 = NULL ;
}
}
...
return V_316 ;
V_163 = F_270 ( V_83 ) ;
if ( F_271 ( V_163 , V_317 ) && V_163 != F_250 () )
return V_316 ;
if ( F_272 ( V_83 , V_318 ) )
return V_316 ;
...
void F_275 ( struct V_34 * * V_320 , int V_138 )
{
struct V_4 * V_4 ;
...
int F_278 ( struct V_327 * V_328 , int V_329 ,
void T_10 * V_330 ,
T_11 * V_331 , T_12 * V_332 )
{
F_276 () ;
F_279 ( V_328 , V_329 , V_330 , V_331 , V_332 ) ;
V_333 = 0 ;
return 0 ;
}
static T_13 F_280 ( struct V_334 * V_335 ,
struct V_336 * V_337 ,
char * V_338 )
{
F_276 () ;
...
static T_13 F_281 ( struct V_334 * V_335 ,
struct V_336 * V_337 ,
...
int F_282 ( struct V_340 * V_340 )
{
return F_283 ( & V_340 -> V_335 , & V_341 ) ;
}
void F_284 ( struct V_340 * V_340 )
{
F_285 ( & V_340 -> V_335 , & V_341 ) ;
}
