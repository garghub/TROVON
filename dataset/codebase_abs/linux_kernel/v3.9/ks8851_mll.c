...
static int F_99 ( struct V_201 * V_202 )
{
int V_86 = - V_203 ;
...
T_2 V_207 , V_4 ;
struct V_208 * V_93 ;
V_205 = F_100 ( V_202 , V_209 , 0 ) ;
V_206 = F_100 ( V_202 , V_209 , 1 ) ;
if ( ! F_101 ( V_205 -> V_210 , F_102 ( V_205 ) , V_88 ) )
goto V_211;
if ( ! F_101 ( V_206 -> V_210 , F_102 ( V_206 ) , V_88 ) )
goto V_212;
...
V_2 = F_38 ( V_23 ) ;
V_2 -> V_23 = V_23 ;
V_2 -> V_10 = F_105 ( V_205 -> V_210 , F_102 ( V_205 ) ) ;
if ( ! V_2 -> V_10 )
goto V_214;
V_2 -> V_9 = F_105 ( V_206 -> V_210 , F_102 ( V_206 ) ) ;
if ( ! V_2 -> V_9 )
goto V_215;
...
V_2 -> V_149 . V_222 = 1 ;
V_2 -> V_149 . V_223 = 0xf ;
V_2 -> V_149 . V_224 = F_88 ;
V_2 -> V_149 . V_225 = F_89 ;
F_93 ( V_23 , L_15 , V_157 ) ;
V_2 -> V_157 = F_109 ( V_157 , ( V_226 |
V_227 |
V_228 ) ) ;
F_16 ( V_2 ) ;
if ( ( F_4 ( V_2 , V_229 ) & ~ V_230 ) != V_231 ) {
F_92 ( V_23 , L_16 ) ;
V_86 = - V_232 ;
goto V_233;
}
...
F_95 ( V_2 ) ;
V_4 = F_4 ( V_2 , V_235 ) ;
F_6 ( V_2 , V_235 , V_4 | V_236 ) ;
V_93 = V_202 -> V_155 . V_237 ;
if ( ! V_93 ) {
F_92 ( V_23 , L_17 ) ;
V_86 = - V_232 ;
goto V_238;
...
F_116 ( V_23 ) ;
V_213:
F_117 ( V_206 -> V_210 , F_102 ( V_206 ) ) ;
V_212:
F_117 ( V_205 -> V_210 , F_102 ( V_205 ) ) ;
V_211:
return V_86 ;
}
static int F_118 ( struct V_201 * V_202 )
{
struct V_53 * V_23 = F_119 ( V_202 ) ;
struct V_1 * V_2 = F_38 ( V_23 ) ;
struct V_204 * V_239 = F_100 ( V_202 , V_209 , 0 ) ;
F_120 ( V_2 -> V_57 ) ;
F_114 ( V_23 ) ;
F_115 ( V_2 -> V_10 ) ;
F_116 ( V_23 ) ;
F_117 ( V_239 -> V_210 , F_102 ( V_239 ) ) ;
F_111 ( V_202 , NULL ) ;
return 0 ;
}
