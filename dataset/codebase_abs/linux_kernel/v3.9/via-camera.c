...
V_151 -> type = V_153 ;
V_151 -> V_154 = V_155 ;
strcpy ( V_151 -> V_156 , L_8 ) ;
return 0 ;
}
static int F_80 ( struct V_121 * V_122 , void * V_142 , unsigned int * V_3 )
{
* V_3 = 0 ;
return 0 ;
}
static int F_81 ( struct V_121 * V_122 , void * V_142 , unsigned int V_3 )
{
if ( V_3 != 0 )
return - V_13 ;
return 0 ;
}
static int F_82 ( struct V_121 * V_122 , void * V_142 , T_7 * V_154 )
{
return 0 ;
}
static int F_83 ( struct V_121 * V_122 , void * V_142 ,
struct V_157 * V_158 )
{
if ( V_158 -> V_152 >= V_4 )
return - V_13 ;
F_84 ( V_158 -> V_159 , V_5 [ V_158 -> V_152 ] . V_160 ,
sizeof( V_158 -> V_159 ) ) ;
V_158 -> V_2 = V_5 [ V_158 -> V_152 ] . V_2 ;
return 0 ;
}
static void F_85 ( struct V_161 * V_162 ,
struct V_161 * V_163 )
{
* V_163 = * V_162 ;
if ( V_162 -> V_85 < V_164 || V_162 -> V_88 < V_165 ) {
V_162 -> V_85 = V_164 ;
V_162 -> V_88 = V_165 ;
}
if ( V_162 -> V_85 > V_86 || V_162 -> V_88 > V_89 ) {
V_162 -> V_85 = V_86 ;
V_162 -> V_88 = V_89 ;
}
V_163 -> V_85 = V_86 ;
...
static void F_86 ( struct V_161 * V_162 ,
struct V_161 * V_163 )
{
struct V_1 * V_166 = F_1 ( V_162 -> V_2 ) ;
V_163 -> V_98 = V_163 -> V_85 * V_166 -> V_167 ;
V_163 -> V_68 = V_163 -> V_88 * V_163 -> V_98 ;
V_162 -> V_2 = V_163 -> V_2 ;
V_162 -> V_117 = V_163 -> V_117 ;
V_162 -> V_98 = 2 * V_162 -> V_85 ;
V_162 -> V_68 = V_162 -> V_98 * V_162 -> V_88 ;
}
static int F_87 ( struct V_6 * V_7 ,
struct V_161 * V_168 , struct V_161 * V_169 )
{
int V_8 ;
struct V_22 V_23 ;
struct V_1 * V_166 = F_1 ( V_168 -> V_2 ) ;
V_168 -> V_2 = V_166 -> V_2 ;
F_85 ( V_168 , V_169 ) ;
F_16 ( & V_23 , V_169 , V_166 -> V_25 ) ;
V_8 = F_14 ( V_7 , V_27 , V_170 , & V_23 ) ;
F_88 ( V_169 , & V_23 ) ;
F_86 ( V_168 , V_169 ) ;
return V_8 ;
}
...
int V_8 ;
F_60 ( & V_7 -> V_124 ) ;
V_8 = F_87 ( V_7 , & V_158 -> V_158 . V_173 , & V_172 . V_158 . V_173 ) ;
F_62 ( & V_7 -> V_124 ) ;
return V_8 ;
}
...
int V_8 ;
struct V_171 V_172 ;
struct V_1 * V_166 = F_1 ( V_158 -> V_158 . V_173 . V_2 ) ;
F_60 ( & V_7 -> V_124 ) ;
if ( V_7 -> V_47 != V_111 ) {
V_8 = - V_134 ;
goto V_49;
...
if ( V_8 )
goto V_49;
V_7 -> V_67 = V_158 -> V_158 . V_173 ;
V_7 -> V_24 = V_172 . V_158 . V_173 ;
V_7 -> V_25 = V_166 -> V_25 ;
V_8 = F_15 ( V_7 ) ;
if ( ! V_8 )
V_8 = F_44 ( V_7 ) ;
...
struct V_174 * V_175 )
{
strcpy ( V_175 -> V_176 , L_9 ) ;
strcpy ( V_175 -> V_177 , L_9 ) ;
V_175 -> V_178 = 1 ;
V_175 -> V_179 = V_180 |
V_181 | V_182 ;
return 0 ;
...
{
struct V_6 * V_7 = V_142 ;
return F_94 ( & V_7 -> V_126 , V_184 ) ;
}
static int F_95 ( struct V_121 * V_122 , void * V_142 ,
struct V_185 * V_46 )
{
struct V_6 * V_7 = V_142 ;
return F_96 ( & V_7 -> V_126 , V_46 ) ;
}
static int F_97 ( struct V_121 * V_122 , void * V_142 , struct V_185 * V_46 )
{
struct V_6 * V_7 = V_142 ;
return F_98 ( & V_7 -> V_126 , V_46 ) ;
}
static int F_99 ( struct V_121 * V_122 , void * V_142 , struct V_185 * V_46 )
{
struct V_6 * V_7 = V_142 ;
return F_100 ( & V_7 -> V_126 , V_46 , V_122 -> V_136 & V_137 ) ;
}
static int F_101 ( struct V_121 * V_122 , void * V_142 , enum V_186 V_187 )
{
struct V_6 * V_7 = V_142 ;
int V_8 = 0 ;
if ( V_187 != V_128 )
...
static int F_104 ( struct V_121 * V_122 , void * V_142 , enum V_186 V_187 )
{
struct V_6 * V_7 = V_142 ;
int V_8 ;
if ( V_187 != V_128 )
...
int V_8 ;
F_60 ( & V_7 -> V_124 ) ;
V_8 = F_14 ( V_7 , V_27 , V_192 , V_191 ) ;
F_62 ( & V_7 -> V_124 ) ;
V_191 -> V_191 . V_193 . V_194 = V_7 -> V_61 ;
return V_8 ;
}
...
return - V_13 ;
V_197 -> type = V_198 ;
V_197 -> V_199 . V_200 = V_164 ;
V_197 -> V_199 . V_201 = V_165 ;
V_197 -> V_199 . V_202 = V_86 ;
V_197 -> V_199 . V_203 = V_89 ;
...
static int F_112 ( void * V_142 )
{
struct V_6 * V_7 = V_142 ;
int V_8 = 0 ;
F_113 ( V_210 , 0x78 , 0 , 0x80 ) ;
F_113 ( V_210 , 0x1e , 0xc0 , 0xc0 ) ;
F_38 ( V_7 ) ;
F_63 ( V_109 , & V_7 -> V_45 ) ;
if ( V_7 -> V_125 > 0 )
F_8 ( V_7 ) ;
...
static int F_119 ( struct V_219 * V_220 )
{
int V_8 ;
struct V_221 * V_222 ;
struct V_223 * V_37 = V_220 -> V_12 . V_224 ;
struct V_225 V_226 = {
. type = L_15 ,
. V_227 = 0x42 >> 1 ,
. V_224 = & V_228 ,
...
if ( F_120 () && F_114 () )
return - V_134 ;
V_7 = F_121 ( sizeof( struct V_6 ) , V_231 ) ;
if ( V_7 == NULL )
return - V_77 ;
V_232 = V_7 ;
V_7 -> V_11 = V_220 ;
...
V_7 -> V_45 = 1 << V_109 ;
V_7 -> V_25 = V_235 ;
V_8 = F_123 ( & V_220 -> V_12 , & V_7 -> V_236 ) ;
if ( V_8 ) {
F_4 ( & V_220 -> V_12 , L_18 ) ;
goto V_237;
}
V_8 = F_124 ( & V_7 -> V_238 , 10 ) ;
if ( V_8 )
goto V_239;
V_7 -> V_236 . V_238 = & V_7 -> V_238 ;
V_220 -> V_12 . V_240 = & V_37 -> V_220 -> V_240 ;
F_125 ( & V_220 -> V_12 , 0xffffffff ) ;
F_113 ( V_210 , 0x78 , 0 , 0x80 ) ;
F_113 ( V_210 , 0x1e , 0xc0 , 0xc0 ) ;
V_8 = F_2 ( V_7 ) ;
if ( V_8 )
...
F_8 ( V_7 ) ;
V_222 = F_126 ( V_242 ) ;
V_7 -> V_243 = F_127 ( & V_7 -> V_236 , V_222 ,
& V_226 , NULL ) ;
if ( V_7 -> V_243 == NULL ) {
F_4 ( & V_220 -> V_12 , L_19 ) ;
V_8 = - V_244 ;
...
F_38 ( V_7 ) ;
V_8 = F_128 ( V_37 -> V_220 -> V_33 , F_22 ,
F_32 , V_246 , L_9 , V_7 ) ;
if ( V_8 )
goto V_245;
V_7 -> V_247 = V_248 ;
V_7 -> V_247 . V_236 = & V_7 -> V_236 ;
V_8 = F_129 ( & V_7 -> V_247 , V_249 , - 1 ) ;
if ( V_8 )
goto V_250;
F_130 ( & V_7 -> V_247 , V_7 ) ;
#ifdef F_131
