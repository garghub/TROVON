...
if ( ! ( T_1 ) V_65 . V_39 ) {
F_6 ( L_25 ,
V_3 -> V_28 , V_65 . V_80 , V_65 . V_39 ) ;
F_24 ( & V_65 ) ;
return V_81 ;
}
V_78 = F_25 ( ( T_1 ) V_65 . V_39 , V_69 ) ;
if ( V_78 > V_67 ) {
F_6 ( L_26
L_27 , V_3 -> V_28 ,
V_68 , V_66 , V_67 ) ;
...
V_79 = F_26 ( V_63 ) + V_66 ;
if ( V_60 == V_75 )
memcpy ( V_65 . V_80 , V_79 , V_78 ) ;
else
memcpy ( V_79 , V_65 . V_80 , V_78 ) ;
V_67 -= V_78 ;
if ( ! V_67 )
continue;
V_69 -= V_78 ;
...
const char * V_21 , T_4 V_84 )
{
struct V_1 * V_1 = F_1 ( V_3 ) ;
char * V_85 , * V_86 , * V_87 ;
T_5 args [ V_88 ] ;
int V_41 = 0 , V_89 , V_90 ;
V_87 = F_29 ( V_21 , V_8 ) ;
if ( ! V_87 )
return - V_9 ;
V_85 = V_87 ;
while ( ( V_86 = F_30 ( & V_87 , L_28 ) ) != NULL ) {
if ( ! * V_86 )
continue;
V_90 = F_31 ( V_86 , V_91 , args ) ;
switch ( V_90 ) {
case V_92 :
F_32 ( args , & V_89 ) ;
V_1 -> V_35 = V_89 ;
...
F_8 ( V_85 ) ;
return ( ! V_41 ) ? V_84 : V_41 ;
}
static T_4 F_33 ( struct V_2 * V_3 , char * V_93 )
{
struct V_1 * V_1 = F_1 ( V_3 ) ;
T_4 V_94 = sprintf ( V_93 , L_31 ,
V_1 -> V_28 ) ;
V_94 += sprintf ( V_93 + V_94 , L_32
L_33 , V_1 -> V_35 ,
V_29 , V_1 -> V_26 ) ;
return V_94 ;
}
