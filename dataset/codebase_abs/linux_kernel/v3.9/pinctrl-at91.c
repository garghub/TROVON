...
V_227 = F_12 ( & V_139 -> V_9 , sizeof( char * ) * V_107 -> V_154 , V_27 ) ;
if ( ! V_227 ) {
V_88 = - V_28 ;
goto V_233;
}
...
V_102 -> V_110 = V_226 ;
V_102 -> V_237 = V_102 -> V_109 = V_102 -> V_110 * V_44 ;
