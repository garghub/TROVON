...
if ( V_119 )
V_10 -> V_16 ( V_5 , V_119 , V_128 ) ;
}
static void F_50 ( struct V_4 * V_5 , unsigned short V_129 ,
unsigned V_82 )
{
struct V_9 * V_10 = V_5 -> V_11 ;
struct V_98 * V_99 = & V_5 -> V_100 [ V_101 ] ;
...
V_10 -> V_16 ( V_5 , V_238 | V_125 | V_239 | V_123 | V_121 | V_240 | V_127 , V_128 ) ;
...
V_10 -> V_16 ( V_5 , V_240 | V_127 | V_125 | V_239 | V_123 | V_121 | V_238 , V_128 ) ;
F_42 ( V_5 , V_14 ,
V_342 , 1 ) ;
F_78 ( L_32 ,
V_10 -> V_15 ) ;
...
struct V_9 * V_10 V_196 = V_5 -> V_11 ;
unsigned V_545 ;
struct V_98 * V_99 = & V_5 -> V_100 [ V_118 ] ;
#ifdef F_24
unsigned long V_12 ;
#endif
if ( ( V_58 . V_59 & V_60 ) == 0 ) {
