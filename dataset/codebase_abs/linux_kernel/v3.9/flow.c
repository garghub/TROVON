...
struct V_75 * V_76 ;
V_76 = & F_32 ( V_71 -> V_72 -> V_5 ) -> V_77 ;
V_76 -> V_69 = ( unsigned long ) V_71 ;
F_46 ( V_76 ) ;
}
void F_47 ( void )
{
...
static int T_5 F_60 ( struct V_2 * V_3 , int V_80 )
{
struct V_28 * V_29 = F_3 ( V_3 -> V_5 , V_80 ) ;
T_1 V_81 = sizeof( struct V_82 ) * F_20 ( V_3 ) ;
if ( ! V_29 -> V_64 ) {
V_29 -> V_64 = F_61 ( V_81 , V_83 , F_62 ( V_80 ) ) ;
if ( ! V_29 -> V_64 ) {
F_63 ( L_1 , V_81 ) ;
return - V_84 ;
}
V_29 -> V_6 = 1 ;
V_29 -> V_31 = 0 ;
F_64 ( & V_29 -> V_77 , F_42 , 0 ) ;
}
return 0 ;
}
static int T_5 F_65 ( struct V_85 * V_86 ,
unsigned long V_87 ,
void * V_88 )
{
struct V_2 * V_3 = F_66 ( V_86 , struct V_2 , V_89 ) ;
int V_90 , V_80 = ( unsigned long ) V_88 ;
struct V_28 * V_29 = F_3 ( V_3 -> V_5 , V_80 ) ;
switch ( V_87 ) {
case V_91 :
case V_92 :
