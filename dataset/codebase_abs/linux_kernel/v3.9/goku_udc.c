...
static int F_70 ( struct V_137 * V_181 ,
struct V_182 * V_19 )
{
struct V_9 * V_10 = F_71 ( V_181 ) ;
...
static void
F_72 ( struct V_9 * V_10 , struct V_182 * V_19 )
{
unsigned V_146 ;
F_12 ( V_10 , L_106 , V_125 ) ;
...
static int F_73 ( struct V_137 * V_181 ,
struct V_182 * V_19 )
{
struct V_9 * V_10 = F_71 ( V_181 ) ;
unsigned long V_15 ;
...
V_185 . V_188 = F_75 ( ( F_9 ( & V_2 -> V_189 ) << 8 )
| F_9 ( & V_2 -> V_190 ) ) ;
V_185 . V_191 = F_75 ( ( F_9 ( & V_2 -> V_192 ) << 8 )
| F_9 ( & V_2 -> V_193 ) ) ;
V_185 . V_194 = F_75 ( ( F_9 ( & V_2 -> V_195 ) << 8 )
| F_9 ( & V_2 -> V_196 ) ) ;
F_2 ( 0 , & V_2 -> V_197 ) ;
F_19 ( & V_10 -> V_12 [ 0 ] , 0 ) ;
V_10 -> V_12 [ 0 ] . V_45 = 0 ;
...
F_76 ( V_185 . V_188 ) , F_76 ( V_185 . V_191 ) ,
F_76 ( V_185 . V_194 ) ) ;
#endif
V_10 -> V_102 = ( V_185 . V_187 == V_208
&& V_185 . V_186 == V_206 ) ;
if ( F_38 ( V_10 -> V_102 ) )
V_10 -> V_103 = ( V_185 . V_188 != F_75 ( 0 ) ) ;
F_32 ( & V_10 -> V_38 ) ;
...
static T_7 F_77 ( int V_210 , void * V_145 )
{
struct V_9 * V_10 = V_145 ;
struct V_1 T_1 * V_2 = V_10 -> V_2 ;
struct V_11 * V_12 ;
T_2 V_211 , V_212 = 0 ;
unsigned V_146 , V_213 = 5 ;
F_33 ( & V_10 -> V_38 ) ;
V_214:
V_211 = F_9 ( & V_2 -> V_84 ) & V_10 -> V_47 ;
if ( ! V_211 )
goto F_27;
V_10 -> V_61 ++ ;
if ( F_38 ( V_211 & V_177 ) ) {
...
F_32 ( & V_10 -> V_38 ) ;
if ( V_211 )
F_12 ( V_10 , L_118 , V_211 ,
F_9 ( & V_2 -> V_84 ) , V_10 -> V_47 ) ;
return F_80 ( V_212 ) ;
}
static void F_81 ( struct V_225 * V_145 )
{
struct V_9 * V_10 = F_82 ( V_145 ) ;
F_26 ( V_10 ) ;
}
static void F_83 ( struct V_226 * V_227 )
{
struct V_9 * V_10 = F_84 ( V_227 ) ;
F_12 ( V_10 , L_106 , V_125 ) ;
F_85 ( & V_10 -> V_20 ) ;
F_86 ( V_10 -> V_19 ) ;
#ifdef F_87
...
static int F_97 ( struct V_226 * V_227 , const struct V_233 * V_234 )
{
...
int V_132 ;
if ( ! V_227 -> V_210 ) {
F_98 ( V_238 L_120 , F_99 ( V_227 ) ) ;
V_132 = - V_62 ;
goto V_239;
}
V_10 = F_21 ( sizeof *V_10 , V_240 ) ;
if ( V_10 == NULL ) {
F_100 ( L_121 , F_99 ( V_227 ) ) ;
V_132 = - V_241 ;
goto V_239;
}
F_101 ( & V_10 -> V_38 ) ;
...
F_102 ( & V_10 -> V_20 . V_10 , L_122 ) ;
V_10 -> V_20 . V_10 . V_244 = & V_227 -> V_10 ;
V_10 -> V_20 . V_10 . V_245 = V_227 -> V_10 . V_245 ;
V_10 -> V_20 . V_10 . V_246 = F_81 ;
V_10 -> V_20 . V_37 = V_247 ;
V_132 = F_103 ( V_227 ) ;
if ( V_132 < 0 ) {
F_12 ( V_10 , L_123 , V_132 ) ;
goto V_239;
}
V_10 -> V_231 = 1 ;
V_235 = F_92 ( V_227 , 0 ) ;
V_236 = F_93 ( V_227 , 0 ) ;
if ( ! F_104 ( V_235 , V_236 , V_247 ) ) {
F_12 ( V_10 , L_124 ) ;
V_132 = - V_30 ;
goto V_239;
}
V_10 -> V_230 = 1 ;
V_237 = F_105 ( V_235 , V_236 ) ;
if ( V_237 == NULL ) {
F_12 ( V_10 , L_125 ) ;
V_132 = - V_248 ;
goto V_239;
...
F_96 ( V_227 , V_10 ) ;
F_79 ( V_10 , L_106 , V_249 ) ;
F_79 ( V_10 , L_126 V_250 L_127 , F_60 () ) ;
F_79 ( V_10 , L_128 , V_227 -> V_210 , V_237 ) ;
F_67 ( V_10 ) ;
F_66 ( V_10 ) ;
if ( F_106 ( V_227 -> V_210 , F_77 , V_251 ,
V_247 , V_10 ) != 0 ) {
F_12 ( V_10 , L_129 , V_227 -> V_210 ) ;
V_132 = - V_30 ;
goto V_239;
}
V_10 -> V_229 = 1 ;
...
F_107 ( V_227 ) ;
#ifdef F_87
F_108 ( V_228 , 0 , NULL , F_63 , V_10 ) ;
#endif
V_132 = F_109 ( & V_10 -> V_20 . V_10 ) ;
if ( V_132 ) {
F_110 ( & V_10 -> V_20 . V_10 ) ;
goto V_239;
}
V_10 -> V_232 = 1 ;
V_132 = F_111 ( & V_227 -> V_10 , & V_10 -> V_20 ) ;
if ( V_132 )
goto V_239;
return 0 ;
V_239:
