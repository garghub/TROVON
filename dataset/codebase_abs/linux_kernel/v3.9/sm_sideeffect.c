...
F_64 ( V_102 , ( V_42 - V_103 -> V_110 ) ) ;
if ( ! F_20 ( & V_102 -> V_61 , F_59 ( V_102 ) ) )
F_21 ( V_102 ) ;
if ( V_104 && V_2 -> V_19 . V_111 == 1 )
F_65 ( V_102 ) ;
}
static int F_66 ( T_2 * V_101 ,
struct V_1 * V_2 ,
struct V_6 * V_7 )
{
int V_112 = 0 ;
if ( F_67 ( & V_2 -> V_90 , V_7 ) ) {
struct V_37 * V_37 = F_16 ( V_2 -> V_38 . V_39 ) ;
...
V_2 , V_116 [ V_48 ] ) ;
if ( F_71 ( V_39 , V_117 ) ) {
if ( F_72 ( V_2 , V_118 ) && F_73 ( V_39 , V_119 ) )
V_39 -> V_120 = V_121 ;
if ( F_72 ( V_2 , V_122 ) &&
F_73 ( V_39 , V_118 ) )
V_39 -> V_123 |= V_124 ;
...
static void F_76 ( T_2 * V_101 ,
struct V_1 * V_2 )
{
struct V_115 * V_39 = V_2 -> V_38 . V_39 ;
if ( F_71 ( V_39 , V_117 ) && F_73 ( V_39 , V_130 ) &&
( ! V_2 -> V_131 ) && ( V_39 -> V_123 != V_132 ) )
return;
F_77 ( V_2 ) ;
F_78 ( V_2 ) ;
}
static void F_79 ( T_2 * V_101 ,
struct V_1 * V_2 ,
struct V_6 * V_7 )
{
struct V_10 * V_102 ;
V_102 = F_69 ( V_2 , V_7 -> V_11 ) ;
...
static void F_83 ( struct V_143 * V_94 ,
struct V_6 * V_7 )
{
struct V_144 * V_145 ;
F_84 (skip, chunk) {
F_85 ( V_94 , F_43 ( V_145 -> V_146 ) , F_43 ( V_145 -> V_147 ) ) ;
}
}
...
V_102 = F_88 ( V_149 , struct V_10 , V_150 ) ;
if ( ! F_89 ( & V_102 -> V_76 ,
& V_2 -> V_19 . V_151 ) ) {
F_90 ( V_2 , & V_102 -> V_76 ) ;
}
...
F_104 * T_14 V_179 ( ( V_180 ) ) = V_174 [ V_92 ] ;
V_172 = F_105 ( V_37 , V_92 , V_48 , V_93 ) ;
F_106 ( & V_14 ) ;
V_181 ;
V_173 = (* V_172 -> V_182 )( V_37 , V_49 , V_2 , V_93 , V_171 , & V_14 ) ;
V_183 ;
error = F_107 ( V_92 , V_93 , V_48 ,
V_49 , V_2 , V_171 , V_173 ,
& V_14 , V_100 ) ;
V_184 ;
return error ;
}
static int F_107 ( T_4 V_92 , T_5 V_93 ,
T_9 V_48 ,
struct V_170 * V_49 ,
struct V_1 * V_2 ,
void * V_171 ,
...
{
int error ;
if ( 0 != ( error = F_108 ( V_92 , V_93 , V_48 ,
V_49 , V_2 ,
V_171 , V_173 ,
V_14 , V_100 ) ) )
goto V_185;
...
break;
case V_88 :
F_70 ( V_14 , V_2 , V_194 -> V_206 . V_48 ) ;
break;
case V_209 :
error = F_119 ( & V_2 -> V_19 . V_24 ,
V_194 -> V_206 . V_210 , NULL ) ;
break;
case V_211 :
F_120 ( & V_2 -> V_19 . V_24 , V_194 -> V_206 . V_210 ) ;
F_121 ( & V_2 -> V_94 , V_194 -> V_206 . V_210 ) ;
F_52 ( & V_2 -> V_94 , V_50 ) ;
break;
case V_212 :
F_83 ( & V_2 -> V_94 , V_194 -> V_206 . V_7 ) ;
break;
case V_213 :
...
L_18 , & V_2 -> V_94 ) ;
F_125 ( & V_2 -> V_94 , V_194 -> V_206 . V_7 ,
V_50 ) ;
break;
case V_87 :
F_19 ( L_16 ,
...
L_18 , & V_2 -> V_94 ) ;
F_82 ( & V_2 -> V_94 , V_194 -> V_206 . V_225 ) ;
break;
case V_34 :
if ( ! V_2 -> V_90 . V_226 ) {
F_126 ( & V_2 -> V_90 ) ;
...
error = F_97 ( & V_2 -> V_90 , V_194 -> V_206 . V_7 ) ;
break;
case V_227 :
...
break;
case V_228 :
F_129 ( & V_2 -> V_90 , V_194 -> V_206 . V_11 ,
V_229 ) ;
break;
case V_230 :
F_129 ( & V_2 -> V_90 , V_194 -> V_206 . V_11 ,
...
error = F_114 ( & V_2 -> V_90 ) ;
V_202 = 0 ;
V_2 -> V_19 . V_220 = V_102 ;
break;
case V_278 :
F_91 ( V_2 , V_194 -> V_206 . error ) ;
break;
case V_279 :
F_92 ( V_14 , V_2 ,
V_194 -> V_206 . T_11 ) ;
...
error = F_96 ( V_2 , V_194 -> V_206 . V_163 ) ;
break;
case V_284 :
F_98 ( V_2 ) ;
break;
