...
struct V_236 * V_237 = V_17 -> V_238 ;
const char * V_239 = V_237 -> V_239 ;
unsigned int V_240 ;
struct V_111 * V_7 ;
struct V_6 * V_232 ;
const struct V_241 * V_148 ;
int V_184 , V_242 ;
if ( V_237 -> V_89 >= F_74 ( V_88 ) ) {
F_11 ( V_17 , L_36 ,
V_237 -> V_89 ) ;
return - V_33 ;
}
...
if ( ! F_75 ( & V_7 -> V_115 , V_7 , V_244 , V_148 ,
V_242 , NULL , V_188 ) ) {
V_184 = - V_226 ;
goto V_245;
}
F_76 ( V_148 , V_242 , & V_7 -> V_247 ) ;
V_7 -> V_115 . V_153 = V_7 -> V_115 . V_170 * 2 ;
V_2 -> V_7 = V_7 ;
F_3 ( V_2 , 0x00100010L , V_248 ) ;
F_28 ( V_2 , 255 ) ;
F_27 ( V_2 , true , 0xFF ) ;
...
static bool F_79 ( struct V_13 * V_29 , void * V_127 )
{
struct V_251 * V_252 = V_127 ;
struct V_30 * V_17 ;
struct V_236 * V_237 ;
if ( ! F_80 ( V_29 ) )
return false ;
...
V_17 = V_252 -> V_2 -> V_17 ;
V_237 = V_17 -> V_238 ;
return V_252 -> V_116 == V_29 -> V_21 &&
V_237 -> V_253 == V_29 -> V_30 -> V_17 ;
}
static void F_81 ( struct V_111 * V_7 )
{
F_36 ( V_7 ) ;
F_78 ( & V_7 -> V_235 ) ;
F_82 ( V_7 ) ;
...
return - V_156 ;
F_86 ( & V_2 -> V_27 ) ;
V_2 -> V_4 = F_87 ( V_255 -> V_259 , F_88 ( V_255 ) ) ;
if ( ! V_2 -> V_4 ) {
V_184 = - V_156 ;
goto V_260;
}
F_89 ( L_39 , V_255 , V_2 -> V_4 ) ;
F_90 () ;
V_2 -> V_17 = V_17 ;
F_91 ( V_221 , V_2 ) ;
V_252 . V_2 = V_2 ;
...
static int F_99 ( struct V_220 * V_17 )
{
...
if ( ! V_266 || ! * V_266 )
return 0 ;
while ( ( V_265 = F_103 ( & V_266 , L_42 ) ) != NULL ) {
if ( ! * V_265 )
continue;
if ( ! strncmp ( V_265 , L_43 , 4 ) )
V_188 = F_104 ( V_265 + 4 , NULL , 0 ) ;
else
V_244 = V_265 ;
}
#endif
