...
if ( 1 ) {
T_1 V_66 , V_22 ;
V_66 = F_3 ( V_2 , & V_2 -> V_5 -> V_4 ) ;
V_22 = F_3 ( V_2 , & V_2 -> V_5 -> V_22 ) ;
if ( ( V_22 & V_67 ) || ! ( V_66 & V_68 ) ) {
F_30 ( V_2 -> V_69 . V_70 ) ;
F_2 ( V_2 , V_67 , & V_2 -> V_5 -> V_22 ) ;
}
F_31 ( V_2 , L_4 ,
V_22 , V_66 ) ;
F_18 ( V_2 ) ;
...
F_22 ( V_71 ) ) )
return;
if ( V_2 -> V_72 > 0 || ( V_2 -> V_73 &&
V_2 -> V_25 + V_2 -> V_74 > 0 ) )
F_5 ( V_2 , V_71 , true ) ;
}
static enum V_75 F_33 ( struct V_13 * V_76 )
{
struct V_1 * V_2 = F_34 ( V_76 , struct V_1 , V_13 ) ;
T_2 V_77 ;
unsigned long V_78 ;
unsigned long V_79 ;
unsigned V_80 ;
...
if ( V_77 . V_83 >= V_2 -> V_9 [ V_80 ] . V_83 )
V_84 [ V_80 ] ( V_2 ) ;
else
F_5 ( V_2 , V_80 , false ) ;
}
