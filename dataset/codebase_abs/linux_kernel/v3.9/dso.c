...
struct V_1 * F_56 ( struct V_87 * V_88 , const char * V_33 )
{
struct V_1 * V_91 ;
F_52 (pos, head, node)
...
T_1 F_57 ( struct V_87 * V_88 , T_5 * V_93 ,
bool (F_58)( struct V_1 * V_1 , int V_94 ) , int V_94 )
{
struct V_1 * V_91 ;
T_1 V_24 = 0 ;
F_52 (pos, head, node) {
if ( F_58 && F_58 ( V_91 , V_94 ) )
continue;
V_24 += F_59 ( V_91 , V_93 ) ;
V_24 += fprintf ( V_93 , L_10 , V_91 -> V_26 ) ;
}
return V_24 ;
}
T_1 F_60 ( struct V_87 * V_88 , T_5 * V_93 )
{
struct V_1 * V_91 ;
T_1 V_24 = 0 ;
F_52 (pos, head, node) {
int V_41 ;
for ( V_41 = 0 ; V_41 < V_75 ; ++ V_41 )
V_24 += F_61 ( V_91 , V_41 , V_93 ) ;
}
return V_24 ;
}
T_1 F_59 ( struct V_1 * V_1 , T_5 * V_93 )
{
char V_95 [ V_23 * 2 + 1 ] ;
F_5 ( V_1 -> V_31 , sizeof( V_1 -> V_31 ) , V_95 ) ;
return fprintf ( V_93 , L_11 , V_95 ) ;
}
T_1 F_61 ( struct V_1 * V_1 , enum V_72 type , T_5 * V_93 )
{
struct V_44 * V_96 ;
T_1 V_24 = fprintf ( V_93 , L_12 , V_1 -> V_66 ) ;
if ( V_1 -> V_66 != V_1 -> V_26 )
V_24 += fprintf ( V_93 , L_13 , V_1 -> V_26 ) ;
V_24 += fprintf ( V_93 , L_14 , V_97 [ type ] ,
F_39 ( V_1 , type ) ? L_6 : L_15 ) ;
V_24 += F_59 ( V_1 , V_93 ) ;
V_24 += fprintf ( V_93 , L_16 ) ;
for ( V_96 = F_10 ( & V_1 -> V_76 [ type ] ) ; V_96 ; V_96 = F_12 ( V_96 ) ) {
struct V_98 * V_91 = F_11 ( V_96 , struct V_98 , V_44 ) ;
V_24 += F_62 ( V_91 , V_93 ) ;
}
return V_24 ;
}
