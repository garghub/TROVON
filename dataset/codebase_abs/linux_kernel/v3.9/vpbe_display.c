...
static int F_86 ( struct V_152 * V_232 , struct V_233 * V_234 )
{
...
if ( F_87 ( & V_14 -> V_84 ) )
return - V_235 ;
V_5 = F_88 ( & V_14 -> V_216 , V_234 ) ;
F_32 ( & V_14 -> V_84 ) ;
return V_5 ;
}
static unsigned int F_89 ( struct V_152 * V_232 , T_3 * V_236 )
{
struct V_61 * V_62 = V_232 -> V_156 ;
struct V_13 * V_14 = V_62 -> V_14 ;
struct V_3 * V_4 = V_62 -> V_2 -> V_4 ;
...
if ( V_14 -> V_54 ) {
F_34 ( & V_14 -> V_84 ) ;
V_237 = F_90 ( & V_14 -> V_216 , V_232 , V_236 ) ;
F_32 ( & V_14 -> V_84 ) ;
}
return V_237 ;
}
...
struct V_27 * V_28 = V_2 -> V_28 ;
int V_237 ;
V_62 = F_93 ( sizeof( struct V_61 ) , V_238 ) ;
if ( V_62 == NULL ) {
F_3 ( & V_4 -> V_11 ,
L_60 ) ;
return - V_239 ;
...
V_2 -> V_48 [ V_47 ] =
F_105 ( sizeof( struct V_13 ) , V_238 ) ;
if ( ! V_2 -> V_48 [ V_47 ] ) {
F_106 ( V_257 L_67 ) ;
return - V_239 ;
}
...
int V_42 ;
F_106 ( V_276 L_71 ) ;
V_2 = F_105 ( sizeof( struct V_1 ) , V_238 ) ;
if ( ! V_2 ) {
F_106 ( V_257 L_67 ) ;
return - V_239 ;
}
F_107 ( & V_2 -> V_30 ) ;
V_237 = F_116 ( & V_277 , NULL , V_2 ,
F_101 ) ;
if ( V_237 < 0 )
return V_237 ;
...
V_42 = V_274 -> V_281 ;
if ( F_118 ( V_42 , F_14 , V_282 , V_283 ,
V_2 ) ) {
F_3 ( & V_2 -> V_4 -> V_11 ,
L_74 ) ;
V_237 = - V_272 ;
