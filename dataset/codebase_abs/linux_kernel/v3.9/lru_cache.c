...
void F_14 ( struct V_1 * V_2 , unsigned V_20 )
{
...
static struct V_16 * F_37 ( struct V_1 * V_2 , unsigned int V_47 , bool V_56 )
{
struct V_16 * V_18 ;
F_26 () ;
if ( V_2 -> V_4 & V_57 ) {
...
{
struct V_16 * V_18 , * V_61 ;
F_26 () ;
F_45 (e, tmp, &lc->to_be_changed, list) {
++ V_2 -> V_43 ;
V_18 -> V_34 = V_18 -> V_36 ;
F_29 ( & V_18 -> V_37 , & V_2 -> V_24 ) ;
}
...
unsigned int F_46 ( struct V_1 * V_2 , struct V_16 * V_18 )
{
F_26 () ;
F_27 ( V_2 , V_18 ) ;
F_21 ( V_18 -> V_49 == 0 ) ;
...
struct V_16 * F_48 ( struct V_1 * V_2 , unsigned V_20 )
{
F_21 ( V_20 >= V_2 -> V_29 ) ;
...
unsigned int F_49 ( struct V_1 * V_2 , struct V_16 * V_18 )
{
F_27 ( V_2 , V_18 ) ;
return V_18 -> V_33 ;
}
void F_50 ( struct V_1 * V_2 , unsigned int V_47 , int V_62 )
{
struct V_16 * V_18 ;
struct V_52 * V_63 ;
if ( V_62 < 0 || V_62 >= V_2 -> V_29 )
return;
V_18 = F_48 ( V_2 , V_62 ) ;
F_21 ( V_18 -> V_34 != V_18 -> V_36 ) ;
F_21 ( V_18 -> V_49 != 0 ) ;
...
void F_51 ( struct V_45 * V_46 , struct V_1 * V_2 , char * V_64 ,
void (* F_52) ( struct V_45 * , struct V_16 * ) )
{
