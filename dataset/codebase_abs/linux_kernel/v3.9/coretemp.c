...
static int T_3 F_17 ( struct V_31 * V_32 , T_2 V_33 ,
struct V_1 * V_2 )
{
int V_36 ;
T_2 V_18 , V_19 ;
...
static int T_3 F_23 ( struct V_11 * V_12 ,
struct V_1 * V_2 , int V_57 )
{
int V_36 , V_37 ;
...
static int T_3 F_25 ( unsigned int V_20 )
{
...
static struct V_69 T_3 * F_28 ( unsigned int V_20 )
{
T_5 V_16 = F_29 ( V_20 ) ;
struct V_70 * V_71 ;
F_10 ( & V_72 ) ;
...
static struct V_11 T_3 * F_31 ( unsigned int V_20 ,
int V_74 )
{
struct V_11 * V_12 ;
...
static int T_3 F_35 ( struct V_69 * V_73 ,
unsigned int V_20 , int V_74 )
{
struct V_11 * V_12 ;
...
static void T_3 F_39 ( unsigned int V_20 , int V_74 )
{
...
static int T_3 F_49 ( unsigned int V_20 )
{
int V_36 ;
struct V_69 * V_73 ;
struct V_70 * V_70 ;
...
static void T_3 F_54 ( unsigned int V_20 )
{
...
static bool T_3 F_58 ( struct V_9 * V_10 )
{
int V_37 ;
for ( V_37 = V_79 - 1 ; V_37 >= 0 ; -- V_37 ) {
if ( V_10 -> V_13 [ V_37 ] &&
...
static void T_3 F_59 ( unsigned int V_20 )
{
struct V_31 * V_32 = & F_26 ( V_20 ) ;
struct V_69 * V_73 = F_28 ( V_20 ) ;
int V_36 ;
...
static int T_3 F_63 ( struct V_92 * V_93 ,
