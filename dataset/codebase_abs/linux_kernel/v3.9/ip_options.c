...
break;
case V_65 :
if ( ( ! V_2 && ! F_18 ( V_49 -> V_60 , V_61 ) ) || V_4 -> V_42 ) {
V_50 = V_44 ;
goto error;
}
V_4 -> V_42 = V_44 - V_9 ;
...
error:
if ( V_2 ) {
F_21 ( V_2 , V_68 , 0 , F_6 ( ( V_50 - V_9 ) << 24 ) ) ;
}
return - V_33 ;
}
...
static struct V_69 * F_23 ( const int V_12 )
{
return F_24 ( sizeof( struct V_69 ) + ( ( V_12 + 3 ) & ~ 3 ) ,
V_70 ) ;
}
static int F_25 ( struct V_49 * V_49 , struct V_69 * * V_71 ,
...
int F_27 ( struct V_49 * V_49 , struct V_69 * * V_71 ,
unsigned char T_3 * V_72 , int V_12 )
{
struct V_69 * V_4 = F_23 ( V_12 ) ;
if ( ! V_4 )
return - V_73 ;
if ( V_12 && F_28 ( V_4 -> V_4 . V_11 , V_72 , V_12 ) ) {
F_26 ( V_4 ) ;
return - V_74 ;
}
return F_25 ( V_49 , V_71 , V_4 , V_12 ) ;
}
int F_29 ( struct V_49 * V_49 , struct V_69 * * V_71 ,
...
if ( V_77 + 3 > V_78 ) {
F_21 ( V_2 , V_68 , 0 , F_6 ( ( V_4 -> V_13 + 2 ) << 24 ) ) ;
return - V_33 ;
}
memcpy ( & V_79 , & V_44 [ V_77 - 1 ] , 4 ) ;
V_82 = V_2 -> V_88 ;
F_34 ( V_2 , NULL ) ;
V_83 = F_35 ( V_2 , V_79 , V_9 -> V_40 , V_9 -> V_89 , V_2 -> V_36 ) ;
V_81 = F_17 ( V_2 ) ;
