...
break;
case - V_23 :
F_12 ( & V_3 -> V_21 -> V_21 , L_6 ,
F_13 ( V_3 -> V_24 ) ) ;
break;
case - V_25 :
F_12 ( & V_3 -> V_21 -> V_21 , L_7 ) ;
break;
default:
F_12 ( & V_3 -> V_21 -> V_21 , L_8
L_9 , V_3 -> V_11 ) ;
break;
}
F_14 ( & V_9 -> V_26 , V_19 ) ;
...
V_46 += sizeof( V_49 ) ;
V_48 = F_30 ( V_9 -> V_15 . V_68 , & V_45 , V_53 ,
1 , V_46 ) ;
if ( V_48 != V_46 ) {
F_28 ( & V_9 -> V_65 -> V_21 ,
L_13 ,
...
struct V_8 * V_9 = F_34 ( V_15 , struct V_8 , V_15 ) ;
while ( ! F_35 () ) {
if ( F_36 ( V_15 ) )
break;
if ( F_24 ( V_9 ) < 0 )
