...
V_54 = F_27 ( V_49 , V_57 , 0 ) ;
if ( V_54 == NULL ) {
F_24 ( & V_49 -> V_22 , L_6 ) ;
return - V_56 ;
}
V_54 = F_28 ( V_54 -> V_58 , F_29 ( V_54 ) , V_49 -> V_59 ) ;
if ( V_54 == NULL ) {
F_24 ( & V_49 -> V_22 , L_7 ) ;
return - V_60 ;
}
...
V_2 = F_31 ( sizeof( struct V_1 ) , V_63 ) ;
if ( ! V_2 ) {
F_24 ( & V_49 -> V_22 , L_9 ) ;
error = - V_61 ;
goto V_64;
...
V_2 -> V_8 = F_33 ( V_54 -> V_58 , F_29 ( V_54 ) ) ;
if ( V_2 -> V_8 == NULL ) {
F_24 ( & V_49 -> V_22 , L_10 ) ;
error = - V_61 ;
goto V_65;
...
V_12 -> V_59 = V_49 -> V_59 ;
V_12 -> V_67 . V_68 = V_69 ;
V_12 -> V_22 . V_70 = & V_49 -> V_22 ;
V_12 -> V_71 = F_22 ;
V_12 -> V_72 = F_17 ;
error = F_37 ( V_51 , NULL ,
V_17 ,
V_6 ,
V_2 -> V_21 , V_12 ) ;
if ( error ) {
...
F_49 ( V_12 ) ;
V_62:
F_50 ( V_54 -> V_58 , F_29 ( V_54 ) ) ;
return error ;
}
static int F_51 ( struct V_48 * V_49 )
{
struct V_1 * V_2 = F_52 ( V_49 ) ;
struct V_53 * V_54 ;
...
static int F_54 ( struct V_78 * V_22 )
{
struct V_48 * V_49 = F_55 ( V_22 ) ;
struct V_1 * V_79 = F_52 ( V_49 ) ;
...
static int F_60 ( struct V_78 * V_22 )
{
struct V_48 * V_49 = F_55 ( V_22 ) ;
struct V_1 * V_79 = F_52 ( V_49 ) ;
struct V_12 * V_12 = V_79 -> V_12 ;
