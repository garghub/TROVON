...
static void F_82 ( const struct V_233 * V_234 ,
void * V_27 )
{
struct V_1 * V_2 = V_27 ;
...
V_11 = F_29 ( V_2 , V_234 -> V_141 , V_234 -> V_235 ) ;
if ( V_11 ) {
F_11 ( & V_229 -> V_8 ,
L_96 , V_11 ) ;
goto V_148;
...
static int F_85 ( struct V_228 * V_229 ,
const struct V_237 * V_238 )
{
struct V_239 * V_240 = F_86 ( V_229 ) ;
...
F_3 ( V_8 , L_100
L_101 , V_242 ) ;
F_87 ( & ( V_1 [ V_242 ] . V_19 ) , 1 ) ;
V_1 [ V_242 ] . V_45 = V_240 ;
V_1 [ V_242 ] . V_7 = V_229 ;
V_1 [ V_242 ] . V_245 = V_229 -> V_246 -> V_247 . V_248 ;
F_73 ( V_229 , & ( V_1 [ V_242 ] ) ) ;
F_3 ( V_8 , L_102 , V_1 [ V_242 ] . V_245 ) ;
V_1 [ V_242 ] . V_72 =
( V_1 [ V_242 ] . V_45 -> V_249 == V_250 ) ;
V_1 [ V_242 ] . V_68 = F_88 ( V_67 , V_80 ) ;
if ( ! V_1 [ V_242 ] . V_68 ) {
F_72 ( & ( V_1 [ V_242 ] ) ) ;
F_8 ( & V_230 ) ;
return - V_81 ;
}
V_1 [ V_242 ] . V_120 = F_88 ( V_122 , V_80 ) ;
if ( ! V_1 [ V_242 ] . V_120 ) {
F_72 ( & ( V_1 [ V_242 ] ) ) ;
F_8 ( & V_230 ) ;
return - V_81 ;
}
V_1 [ V_242 ] . V_31 = F_88 ( V_33 , V_80 ) ;
if ( ! ( V_1 [ V_242 ] . V_31 ) ) {
F_72 ( & ( V_1 [ V_242 ] ) ) ;
F_8 ( & V_230 ) ;
return - V_81 ;
}
V_1 [ V_242 ] . V_128 = F_88 ( V_129 , V_80 ) ;
if ( ! ( V_1 [ V_242 ] . V_128 ) ) {
F_72 ( & ( V_1 [ V_242 ] ) ) ;
F_8 ( & V_230 ) ;
return - V_81 ;
}
V_1 [ V_242 ] . V_146 = F_88 ( V_71 , V_80 ) ;
if ( ! ( V_1 [ V_242 ] . V_146 ) ) {
F_72 ( & ( V_1 [ V_242 ] ) ) ;
F_8 ( & V_230 ) ;
return - V_81 ;
}
V_3 = F_89 ( V_1 [ V_242 ] . V_45 ,
V_1 [ V_242 ] . V_245 , 3 ) ;
if ( V_3 < 0 ) {
F_11 ( V_8 , L_103
L_104 ,
...
V_1 [ V_242 ] . V_6 = V_252 ;
V_1 [ V_242 ] . V_5 = F_90 ( V_1 [ V_242 ] . V_6 ,
sizeof( struct V_22 * ) ,
V_80 ) ;
if ( ! ( V_1 [ V_242 ] . V_5 ) ) {
F_72 ( & ( V_1 [ V_242 ] ) ) ;
...
V_1 [ V_242 ] . V_57 = F_90 ( V_1 [ V_242 ] . V_58 ,
...
V_1 [ V_242 ] . V_57 [ V_3 ] = F_91 ( 1 , V_80 ) ;
...
static void F_95 ( struct V_228 * V_262 )
{
struct V_1 * V_2 = F_80 ( V_262 ) ;
struct V_239 * V_240 = F_86 ( V_262 ) ;
if ( ! V_2 ) {
F_11 ( & V_262 -> V_8 ,
L_109 ) ;
return;
