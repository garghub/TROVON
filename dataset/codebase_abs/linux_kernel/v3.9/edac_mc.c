...
static void F_56 ( unsigned long V_115 , unsigned long V_116 ,
T_1 V_44 )
{
struct V_115 * V_117 ;
void * V_118 ;
...
F_60 ( V_119 ) ;
V_118 = F_61 ( V_117 ) ;
F_62 ( V_118 + V_116 , V_44 ) ;
F_63 ( V_118 ) ;
if ( F_59 ( V_117 ) )
F_64 ( V_119 ) ;
}
int F_65 ( struct V_5 * V_6 , unsigned long V_115 )
{
struct V_25 * * V_37 = V_6 -> V_37 ;
int V_50 , V_7 , V_65 , V_8 ;
F_3 ( 1 , L_48 , V_6 -> V_71 , V_115 ) ;
V_50 = - 1 ;
for ( V_7 = 0 ; V_7 < V_6 -> V_36 ; V_7 ++ ) {
...
break;
V_121 += V_62 [ V_7 ] ;
V_6 -> V_59 [ V_7 ] [ V_121 ] += V_9 ;
if ( V_7 < V_6 -> V_11 - 1 )
V_121 *= V_6 -> V_13 [ V_7 + 1 ] . V_44 ;
}
}
...
if ( V_128 && * V_128 )
F_73 ( L_57 ,
V_126 , V_132 , V_22 , V_14 , V_127 , V_128 ) ;
else
F_73 ( L_58 ,
V_126 , V_132 , V_22 , V_14 , V_127 ) ;
}
F_67 ( V_6 , V_120 , V_62 , V_125 ) ;
}
void F_74 ( const enum V_136 type ,
struct V_5 * V_6 ,
struct V_137 * V_138 )
{
char V_127 [ 80 ] ;
int V_62 [ V_60 ] = { V_138 -> V_139 , V_138 -> V_140 , V_138 -> V_141 } ;
if ( type == V_142 ) {
snprintf ( V_127 , sizeof( V_127 ) ,
L_59 ,
V_138 -> V_129 , V_138 -> V_130 ,
V_138 -> V_24 , V_138 -> V_143 ) ;
F_68 ( V_6 , V_138 -> V_125 , V_62 , V_138 -> V_126 , V_138 -> V_14 , V_138 -> V_22 ,
V_127 , V_138 -> V_128 , V_138 -> V_120 ,
V_138 -> V_129 , V_138 -> V_130 , V_138 -> V_24 ) ;
} else {
snprintf ( V_127 , sizeof( V_127 ) ,
L_60 ,
V_138 -> V_129 , V_138 -> V_130 , V_138 -> V_24 ) ;
F_70 ( V_6 , V_138 -> V_125 , V_62 , V_138 -> V_126 , V_138 -> V_14 , V_138 -> V_22 ,
V_127 , V_138 -> V_128 , V_138 -> V_120 ) ;
}
}
void F_75 ( const enum V_136 type ,
struct V_5 * V_6 ,
const T_2 V_125 ,
const unsigned long V_129 ,
const unsigned long V_130 ,
const unsigned long V_143 ,
const int V_139 ,
const int V_140 ,
const int V_141 ,
const char * V_126 ,
...
char * V_10 ;
int V_50 = - 1 , V_16 = - 1 ;
int V_62 [ V_60 ] = { V_139 , V_140 , V_141 } ;
int V_7 , V_144 = 0 ;
T_3 V_145 ;
struct V_137 * V_138 = & V_6 -> V_146 ;
F_3 ( 3 , L_61 , V_6 -> V_71 ) ;
...
if ( V_139 >= 0 && V_139 != V_2 -> V_14 [ 0 ] )
continue;
if ( V_140 >= 0 && V_140 != V_2 -> V_14 [ 1 ] )
continue;
if ( V_141 >= 0 && V_141 != V_2 -> V_14 [ 2 ] )
continue;
if ( V_2 -> V_24 > V_138 -> V_24 )
V_138 -> V_24 = V_2 -> V_24 ;
if ( V_138 -> V_120 && V_2 -> V_23 ) {
if ( V_144 >= V_147 ) {
V_138 -> V_120 = false ;
break;
}
...
if ( ! V_138 -> V_120 ) {
strcpy ( V_138 -> V_22 , L_64 ) ;
} else {
F_3 ( 4 , L_65 , V_50 , V_16 ) ;
if ( V_10 == V_138 -> V_22 )
strcpy ( V_138 -> V_22 , L_66 ) ;
if ( type == V_142 ) {
if ( V_50 >= 0 ) {
V_6 -> V_37 [ V_50 ] -> V_149 += V_125 ;
if ( V_16 >= 0 )
V_6 -> V_37 [ V_50 ] -> V_31 [ V_16 ] -> V_149 += V_125 ;
}
} else
if ( V_50 >= 0 )
V_6 -> V_37 [ V_50 ] -> V_150 += V_125 ;
}
V_10 = V_138 -> V_14 ;
for ( V_7 = 0 ; V_7 < V_6 -> V_11 ; V_7 ++ ) {
if ( V_62 [ V_7 ] < 0 )
...
if ( V_10 > V_138 -> V_14 )
* ( V_10 - 1 ) = '\0' ;
V_145 = F_76 ( V_138 -> V_24 ) + 1 ;
F_77 ( type , V_138 -> V_126 , V_138 -> V_22 , V_138 -> V_125 ,
V_6 -> V_71 , V_138 -> V_139 , V_138 -> V_140 , V_138 -> V_141 ,
F_78 ( V_138 -> V_129 ) | V_138 -> V_130 ,
V_145 , V_138 -> V_143 , V_138 -> V_128 ) ;
F_74 ( type , V_6 , V_138 ) ;
}
