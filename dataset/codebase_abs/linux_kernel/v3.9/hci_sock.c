...
static int F_90 ( struct V_84 * V_8 , int V_180 , int V_181 ,
char T_1 * V_182 , unsigned int V_11 )
{
struct V_183 V_184 = { . V_32 = 0 } ;
struct V_8 * V_9 = V_8 -> V_9 ;
int V_89 = 0 , V_185 = 0 ;
F_3 ( L_7 , V_9 , V_181 ) ;
F_63 ( V_9 ) ;
...
case V_188 :
{
struct V_14 * V_189 = & F_6 ( V_9 ) -> V_21 ;
V_184 . V_25 = V_189 -> V_25 ;
V_184 . V_32 = V_189 -> V_32 ;
V_184 . V_31 [ 0 ] = * ( ( V_190 * ) V_189 -> V_31 + 0 ) ;
V_184 . V_31 [ 1 ] = * ( ( V_190 * ) V_189 -> V_31 + 1 ) ;
}
V_11 = F_66 (unsigned int, len, sizeof(uf)) ;
if ( F_41 ( & V_184 , V_182 , V_11 ) ) {
V_89 = - V_90 ;
break;
}
if ( ! F_48 ( V_134 ) ) {
V_184 . V_25 &= V_173 . V_25 ;
V_184 . V_31 [ 0 ] &= * ( ( V_190 * ) V_173 . V_31 + 0 ) ;
V_184 . V_31 [ 1 ] &= * ( ( V_190 * ) V_173 . V_31 + 1 ) ;
}
{
struct V_14 * V_189 = & F_6 ( V_9 ) -> V_21 ;
V_189 -> V_25 = V_184 . V_25 ;
V_189 -> V_32 = V_184 . V_32 ;
* ( ( V_190 * ) V_189 -> V_31 + 0 ) = V_184 . V_31 [ 0 ] ;
* ( ( V_190 * ) V_189 -> V_31 + 1 ) = V_184 . V_31 [ 1 ] ;
}
break;
default:
V_89 = - V_191 ;
...
static int F_92 ( struct V_84 * V_8 , int V_180 , int V_181 ,
char T_1 * V_182 , int T_1 * V_192 )
{
struct V_183 V_184 ;
struct V_8 * V_9 = V_8 -> V_9 ;
int V_11 , V_185 , V_89 = 0 ;
F_3 ( L_7 , V_9 , V_181 ) ;
if ( F_91 ( V_11 , V_192 ) )
return - V_90 ;
F_63 ( V_9 ) ;
...
static int F_95 ( struct V_193 * V_193 , struct V_84 * V_8 , int V_194 ,
int V_195 )
{
struct V_8 * V_9 ;
F_3 ( L_8 , V_8 ) ;
...
return - V_197 ;
V_8 -> V_198 = & V_199 ;
V_9 = F_96 ( V_193 , V_200 , V_36 , & V_201 ) ;
if ( ! V_9 )
return - V_202 ;
F_97 ( V_8 , V_9 ) ;
F_98 ( V_9 , V_203 ) ;
...
if ( V_89 < 0 )
return V_89 ;
V_89 = F_102 ( V_207 , & V_208 ) ;
if ( V_89 < 0 ) {
F_103 ( L_9 ) ;
goto error;
}
V_89 = F_104 ( V_209 , & V_210 , L_10 , & V_12 , NULL ) ;
if ( V_89 < 0 ) {
F_103 ( L_11 ) ;
F_105 ( V_207 ) ;
goto error;
