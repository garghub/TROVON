...
static void F_77 ( struct V_1 * V_2 , char V_153 )
{
struct V_42 * V_43 ;
++ V_2 -> V_11 . V_154 ;
F_5 ( V_2 , L_26 , V_153 ) ;
...
struct V_1 * F_78 ( unsigned V_155 )
{
struct V_1 * V_2 ;
if ( V_155 >= V_156 )
return NULL ;
...
static int F_82 ( struct V_160 * V_49 )
{
int V_84 = - V_161 ;
int V_162 , V_14 ;
if ( V_163 )
...
static void F_83 ( struct V_159 * V_159 )
{
struct V_160 * V_49 = F_84 ( V_159 , V_159 ) ;
...
{
F_90 ( & V_2 -> V_49 -> V_159 , F_83 ) ;
}
static void F_91 ( struct V_166 * V_166 , int V_167 )
{
...
static int F_92 ( struct V_166 * V_166 )
{
struct V_1 * V_2 = F_43 ( V_166 , V_2 ) ;
int V_169 ;
V_169 = ( V_2 -> V_58 & V_64 ) ;
...
static unsigned F_93 ( struct V_1 * V_2 , struct V_55 * V_56 )
{
unsigned V_170 , V_171 ;
V_170 = F_94 ( & V_56 -> V_172 ) ;
F_95 ( & V_56 -> V_172 , V_170 , V_170 ) ;
V_171 = 12 + ( ( F_96 ( V_56 ) ) ? 4 : 2 ) + ( ( F_97 ( V_56 ) ) ? 2 : 0 ) ;
switch ( F_98 ( V_56 ) ) {
case V_173 :
V_171 -= ( F_96 ( V_56 ) ) ? 1 : 0 ;
break;
...
static int F_103 ( struct V_166 * V_166 ,
struct V_55 * V_56 )
{
struct V_1 * V_2 = F_43 ( V_166 , V_2 ) ;
unsigned V_170 ;
...
static void F_106 ( struct V_166 * V_166 )
{
struct V_1 * V_2 = F_43 ( V_166 , V_2 ) ;
struct V_100 * V_91 , * V_101 ;
F_107 ( & V_2 -> V_76 ) ;
...
static int F_110 ( struct V_55 * V_56 , struct V_194 * V_195 )
{
struct V_1 * V_2 = V_56 -> V_196 ;
return F_111 ( & V_2 -> V_2 , V_56 , V_195 ) ;
}
static void F_112 ( struct V_55 * V_56 , struct V_194 * V_195 )
{
struct V_1 * V_2 = V_56 -> V_196 ;
F_113 ( & V_2 -> V_2 , V_56 , V_195 ) ;
}
...
static void F_116 ( struct V_55 * V_56 )
{
struct V_1 * V_2 = V_56 -> V_196 ;
V_56 -> V_196 = NULL ;
F_89 ( V_2 ) ;
}
static int F_117 ( struct V_197 * V_198 , struct V_55 * V_56 )
{
struct V_1 * V_2 = F_78 ( V_56 -> V_155 ) ;
int V_84 ;
V_84 = F_118 ( V_198 , V_56 ) ;
if ( ! V_84 )
V_56 -> V_196 = V_2 ;
else
F_89 ( V_2 ) ;
...
static int F_119 ( struct V_197 * V_198 , struct V_55 * V_56 )
{
struct V_1 * V_2 = F_78 ( F_120 ( V_56 -> V_155 ) ) ;
int V_84 ;
V_84 = F_118 ( V_198 , V_56 ) ;
if ( ! V_84 )
V_56 -> V_196 = V_2 ;
...
static int F_121 ( struct V_55 * V_56 , const unsigned char * V_91 , int V_3 )
{
struct V_1 * V_2 = V_56 -> V_196 ;
int V_4 , V_37 ;
F_5 ( V_2 , L_21 , V_3 ) ;
...
static void F_125 ( struct V_55 * V_56 , char V_153 )
{
struct V_1 * V_2 = V_56 -> V_196 ;
F_5 ( V_2 , L_26 , V_153 ) ;
F_77 ( V_2 , V_153 ) ;
...
struct V_202 V_203 ;
V_203 = V_2 -> V_60 ;
return F_130 ( V_2 -> V_2 . V_78 ,
F_128 ( V_2 , V_201 , & V_203 ) ) ;
}
...
return ( F_132 ( V_205 , & V_206 , sizeof( * V_205 ) ) ) ? - V_211 : 0 ;
}
static int F_133 ( struct V_1 * V_2 ,
struct V_204 T_3 * V_205 )
{
struct V_204 V_206 ;
if ( F_134 ( & V_206 , V_205 , sizeof( V_206 ) ) )
return - V_211 ;
...
static int F_136 ( struct V_55 * V_56 , unsigned V_217 ,
unsigned long V_218 )
{
struct V_1 * V_2 = V_56 -> V_196 ;
int V_84 ;
...
case V_219 :
F_79 ( & V_2 -> V_2 . V_220 ) ;
V_84 = F_131 ( V_2 , ( void T_3 * ) V_218 ) ;
F_81 ( & V_2 -> V_2 . V_220 ) ;
break;
case V_221 :
F_79 ( & V_2 -> V_2 . V_220 ) ;
V_84 = F_133 ( V_2 , ( void T_3 * ) V_218 ) ;
F_81 ( & V_2 -> V_2 . V_220 ) ;
break;
case V_222 :
V_84 = F_129 ( V_2 , V_218 ) ;
break;
default:
V_84 = - V_223 ;
}
...
static void F_137 ( struct V_55 * V_56 , struct V_224 * V_88 )
{
struct V_1 * V_2 = V_56 -> V_196 ;
unsigned V_170 ;
F_2 ( & V_2 -> V_6 ) ;
...
static int F_138 ( struct V_55 * V_56 , int V_229 )
{
struct V_1 * V_2 = V_56 -> V_196 ;
long V_230 ;
F_5 ( V_2 , L_21 , V_229 ) ;
...
static int F_141 ( struct V_55 * V_56 )
{
struct V_1 * V_2 = V_56 -> V_196 ;
unsigned V_233 ;
F_2 ( & V_2 -> V_6 ) ;
...
static int F_142 ( struct V_55 * V_56 , unsigned V_234 , unsigned V_235 )
{
struct V_1 * V_2 = V_56 -> V_196 ;
...
static int F_143 ( struct V_55 * V_56 ,
struct V_236 * V_60 )
{
struct V_1 * V_2 = V_56 -> V_196 ;
struct V_11 V_11 ;
...
static void F_144 ( struct V_9 * V_10 , struct V_1 * V_2 )
{
struct V_11 V_11 ;
memcpy ( & V_11 , & V_2 -> V_11 , sizeof( V_11 ) ) ;
if ( V_2 -> V_2 . V_168 )
...
static void F_146 ( struct V_9 * V_10 , struct V_42 * V_43 )
{
int V_46 = V_43 -> V_46 ;
F_20 () ;
F_9 ( V_10 , L_38 , F_147 ( & V_43 -> V_242 -> V_243 ) ) ;
...
static int F_149 ( struct V_9 * V_10 , void * V_246 )
{
struct V_1 * V_2 ;
int V_162 ;
F_150 ( V_10 , L_43 ) ;
for ( V_162 = 0 ; V_162 < V_156 && ( V_2 = F_78 ( V_162 ) ) ; ++ V_162 ) {
F_9 ( V_10 , L_44 , V_162 ) ;
if ( F_135 ( V_215 ) )
F_144 ( V_10 , V_2 ) ;
F_89 ( V_2 ) ;
...
V_2 = F_78 ( V_49 -> V_165 [ V_162 ] -> V_155 ) ;
if ( V_2 ) {
...
F_37 () ;
F_9 ( V_10 , L_46 ,
F_147 ( V_49 -> V_35 -> V_243 ) ,
( unsigned long long ) V_49 -> V_35 -> V_244 ) ;
F_153 (peer, &serial->peer_list, list)
F_146 ( V_10 , V_43 ) ;
F_39 () ;
return 0 ;
}
static int F_154 ( struct V_248 * V_248 , struct V_194 * V_195 )
{
return F_155 ( V_195 , F_149 , NULL ) ;
}
static int F_156 ( struct V_248 * V_248 , struct V_194 * V_195 )
{
return F_155 ( V_195 , F_151 , V_248 -> V_249 ) ;
}
static int F_157 ( struct V_248 * V_248 , struct V_194 * V_195 )
{
return F_155 ( V_195 , F_152 , V_248 -> V_249 ) ;
}
static inline int F_158 ( T_4 V_250 )
{
...
static inline void F_160 ( struct V_261 * V_262 ,
struct V_1 * V_2 )
{
T_5 V_87 = V_2 -> V_130 . V_131 ;
T_5 V_148 = V_2 -> V_130 . V_131 + 4 ;
T_1 V_263 = V_2 -> V_130 . V_133 - 4 ;
V_262 -> V_264 = F_161 ( V_87 >> 32 ) ;
V_262 -> V_265 = F_161 ( V_87 ) ;
V_262 -> V_266 = F_161 ( V_148 >> 32 ) ;
V_262 -> V_267 = F_161 ( V_148 ) ;
V_262 -> V_263 = F_161 ( V_263 ) ;
}
static inline void F_162 ( struct V_251 * V_252 ,
struct V_1 * V_2 )
{
V_252 -> V_254 . V_250 = F_163 ( V_253 ) ;
V_252 -> V_254 . V_37 = F_163 ( F_158 ( V_252 -> V_254 . V_250 ) ) ;
F_160 ( & V_252 -> V_255 , V_2 ) ;
}
static inline void F_164 ( struct V_251 * V_252 ,
struct V_1 * V_2 )
{
V_252 -> V_254 . V_250 = F_163 ( V_256 ) ;
V_252 -> V_254 . V_37 = F_163 ( F_158 ( V_252 -> V_254 . V_250 ) ) ;
F_160 ( & V_252 -> V_257 , V_2 ) ;
}
static inline void F_165 ( struct V_251 * V_252 )
{
V_252 -> V_254 . V_250 = F_163 ( V_256 | V_260 ) ;
V_252 -> V_254 . V_37 = F_163 ( F_158 ( V_252 -> V_254 . V_250 ) ) ;
}
static inline void F_166 ( struct V_251 * V_252 )
{
V_252 -> V_254 . V_250 = F_163 ( V_258 ) ;
V_252 -> V_254 . V_37 = F_163 ( F_158 ( V_252 -> V_254 . V_250 ) ) ;
}
static inline void F_167 ( struct V_251 * V_252 )
{
V_252 -> V_254 . V_250 = F_163 ( V_259 | V_260 ) ;
V_252 -> V_254 . V_37 = F_163 ( F_158 ( V_252 -> V_254 . V_250 ) ) ;
}
static inline void F_168 ( struct V_251 * V_252 )
{
V_252 -> V_254 . V_250 = F_163 ( V_259 ) ;
V_252 -> V_254 . V_37 = F_163 ( F_158 ( V_252 -> V_254 . V_250 ) ) ;
}
static void F_169 ( struct V_42 * V_43 ,
struct V_261 * V_262 )
{
struct V_1 * V_2 = V_43 -> V_2 ;
V_43 -> V_87 = F_170 ( V_262 -> V_264 , V_262 -> V_265 ) ;
V_43 -> V_148 = F_170 ( V_262 -> V_266 , V_262 -> V_267 ) ;
V_43 -> V_263 = F_171 ( V_262 -> V_263 ) ;
F_172 ( V_43 , V_268 ) ;
F_2 ( & V_2 -> V_6 ) ;
V_2 -> V_191 = F_11 ( V_43 -> V_191 , V_43 -> V_263 ) ;
F_173 ( & V_2 -> V_7 , V_2 -> V_191 ) ;
F_4 ( & V_43 -> V_2 -> V_6 ) ;
if ( V_2 -> V_2 . V_168 && V_2 -> V_237 -> V_269 != NULL )
(* V_2 -> V_237 -> V_269 )( V_270 , V_2 -> V_238 ) ;
F_174 ( & V_43 -> V_242 , L_47 ,
( unsigned long long ) V_43 -> V_244 , F_147 ( V_2 -> V_243 ) ) ;
}
static inline int F_175 ( struct V_42 * V_43 ,
struct V_251 * V_252 )
{
int V_46 ;
int V_23 , V_271 = 5 ;
...
V_46 = V_43 -> V_46 ;
F_20 () ;
V_23 = F_176 ( V_43 -> V_49 -> V_35 ,
V_132 ,
V_43 -> V_50 ,
V_46 , V_43 -> V_51 ,
V_43 -> V_245 ,
V_252 , F_159 ( V_252 -> V_254 . V_37 ) ) ;
...
static struct V_1 * F_177 ( struct V_42 * V_43 ,
int V_155 )
{
struct V_1 * V_2 ;
...
static struct V_1 * F_180 ( struct V_42 * V_43 )
{
...
static void F_181 ( struct V_1 * V_2 , bool V_275 )
{
if ( V_275 )
F_27 ( V_2 , 0 ) ;
F_2 ( & V_2 -> V_6 ) ;
V_2 -> V_191 = F_182 ( V_276 ) ;
F_173 ( & V_2 -> V_7 , V_2 -> V_191 ) ;
F_179 ( V_2 -> V_43 , NULL ) ;
F_4 ( & V_2 -> V_6 ) ;
if ( V_2 -> V_2 . V_168 && V_2 -> V_237 -> V_269 != NULL )
...
static void F_183 ( unsigned long V_102 )
{
...
static int F_185 ( struct V_42 * V_43 )
{
struct V_1 * V_2 ;
struct V_251 * V_252 ;
int V_84 , V_23 ;
...
V_43 -> V_2 = V_2 ;
F_172 ( V_43 , V_278 ) ;
F_162 ( V_252 , V_43 -> V_2 ) ;
F_187 ( & V_43 -> V_282 , F_183 , ( unsigned long ) V_43 ) ;
F_188 ( & V_43 -> V_282 , V_75 + V_283 ) ;
F_4 ( & V_43 -> V_6 ) ;
V_23 = F_175 ( V_43 , V_252 ) ;
F_2 ( & V_43 -> V_6 ) ;
...
static void F_190 ( struct V_197 * V_198 ,
struct V_1 * V_2 )
{
struct V_55 * V_56 ;
F_79 ( & V_2 -> V_2 . V_220 ) ;
...
F_81 ( & V_2 -> V_2 . V_220 ) ;
if ( V_198 == V_285 )
F_191 ( V_198 , F_192 ( V_2 ) ) ;
else
F_191 ( V_198 , V_2 -> V_155 ) ;
}
static struct V_160 * F_193 ( struct V_34 * V_35 )
{
struct V_160 * V_49 ;
F_194 (serial, &fwserial_list, list) {
if ( V_35 == V_49 -> V_35 )
return V_49 ;
}
return NULL ;
}
static struct V_160 * F_195 ( struct V_34 * V_35 )
{
struct V_160 * V_49 ;
F_153 (serial, &fwserial_list, list) {
if ( V_35 == V_49 -> V_35 )
return V_49 ;
}
return NULL ;
...
{
struct V_42 * V_43 = F_198 ( F_48 ( V_90 ) , V_288 ) ;
int V_84 ;
V_84 = F_185 ( V_43 ) ;
if ( V_84 == - V_142 && ++ V_43 -> V_289 < V_290 )
F_25 ( & V_43 -> V_288 , V_291 ) ;
}
static int F_199 ( struct V_160 * V_49 , struct V_292 * V_242 )
{
struct V_243 * V_293 = & V_242 -> V_243 ;
struct V_21 * V_294 = F_200 ( V_242 ) ;
struct V_42 * V_43 ;
struct V_295 V_296 ;
int V_297 , V_298 ;
int V_46 ;
V_43 = F_201 ( sizeof( * V_43 ) , V_193 ) ;
if ( ! V_43 )
return - V_48 ;
F_172 ( V_43 , V_280 ) ;
F_202 ( V_293 , V_43 ) ;
...
F_203 () ;
V_43 -> V_46 = V_46 ;
F_204 ( & V_296 , V_242 -> V_301 ) ;
while ( F_205 ( & V_296 , & V_297 , & V_298 ) ) {
...
V_43 -> V_2 = NULL ;
F_15 ( & V_43 -> V_282 ) ;
F_207 ( & V_43 -> V_90 , NULL ) ;
F_208 ( & V_43 -> V_288 , F_197 ) ;
V_43 -> V_49 = V_49 ;
F_209 ( & V_43 -> V_105 , & V_49 -> V_306 ) ;
F_174 ( & V_43 -> V_242 , L_52 ,
( unsigned long long ) V_43 -> V_244 ) ;
if ( V_294 -> V_307 ) {
V_49 -> V_308 = V_43 ;
if ( V_309 ) {
struct V_1 * V_2 ;
V_2 = F_177 ( V_43 , V_274 ) ;
if ( ! F_210 ( V_2 ) ) {
struct V_261 V_262 ;
F_2 ( & V_43 -> V_6 ) ;
V_43 -> V_2 = V_2 ;
...
static void F_211 ( struct V_42 * V_43 )
{
struct V_1 * V_2 ;
F_2 ( & V_43 -> V_6 ) ;
F_172 ( V_43 , V_311 ) ;
...
static int F_213 ( struct V_292 * V_242 )
{
struct V_21 * V_294 = F_200 ( V_242 ) ;
...
V_312 = F_219 ( & V_49 -> V_165 [ V_14 ] -> V_2 ,
V_320 ,
V_49 -> V_165 [ V_14 ] -> V_155 ,
V_35 -> V_243 ) ;
if ( F_210 ( V_312 ) ) {
V_84 = F_220 ( V_312 ) ;
F_186 ( & V_242 , L_55 , V_84 ) ;
goto V_321;
}
...
if ( V_309 ) {
struct V_243 * V_322 ;
V_322 = F_219 ( & V_49 -> V_165 [ V_14 ] -> V_2 ,
V_285 ,
F_192 ( V_49 -> V_165 [ V_14 ] ) ,
V_35 -> V_243 ) ;
if ( F_210 ( V_322 ) ) {
V_84 = F_220 ( V_322 ) ;
F_186 ( & V_242 , L_56 , V_84 ) ;
goto V_321;
}
...
if ( ! F_221 ( V_323 ) ) {
V_49 -> V_324 = F_222 ( F_147 ( & V_242 -> V_243 ) ,
V_323 ) ;
if ( ! F_221 ( V_49 -> V_324 ) ) {
F_223 ( L_57 , 0444 , V_49 -> V_324 ,
V_49 , & V_325 ) ;
F_223 ( L_58 , 0444 , V_49 -> V_324 ,
V_49 , & V_326 ) ;
}
}
F_209 ( & V_49 -> V_105 , & V_327 ) ;
F_224 ( & V_242 , L_59 ,
F_147 ( V_35 -> V_243 ) , ( unsigned long long ) V_35 -> V_244 ) ;
V_84 = F_199 ( V_49 , V_242 ) ;
if ( ! V_84 )
return 0 ;
F_186 ( & V_242 , L_60 , V_84 ) ;
F_225 ( V_49 -> V_324 ) ;
F_212 ( & V_49 -> V_105 ) ;
if ( V_309 )
F_191 ( V_285 , F_192 ( V_49 -> V_165 [ V_14 ] ) ) ;
V_321:
for ( -- V_14 ; V_14 >= 0 ; -- V_14 )
F_191 ( V_320 , V_49 -> V_165 [ V_14 ] -> V_155 ) ;
F_90 ( & V_49 -> V_159 , F_83 ) ;
return V_84 ;
V_313:
for ( -- V_162 ; V_162 >= 0 ; -- V_162 ) {
F_88 ( & V_49 -> V_165 [ V_162 ] -> V_2 ) ;
F_54 ( V_49 -> V_165 [ V_162 ] ) ;
}
F_54 ( V_49 ) ;
return V_84 ;
}
static int F_226 ( struct V_243 * V_293 )
{
struct V_292 * V_242 = V_292 ( V_293 ) ;
struct V_160 * V_49 ;
int V_84 ;
F_79 ( & V_328 ) ;
V_49 = F_193 ( F_200 ( V_242 ) -> V_35 ) ;
if ( ! V_49 )
V_84 = F_213 ( V_242 ) ;
else
V_84 = F_199 ( V_49 , V_242 ) ;
...
static int F_227 ( struct V_243 * V_293 )
{
struct V_42 * V_43 = F_228 ( V_293 ) ;
...
F_225 ( V_49 -> V_324 ) ;
for ( V_162 = 0 ; V_162 < V_274 ; ++ V_162 )
F_190 ( V_320 , V_49 -> V_165 [ V_162 ] ) ;
if ( V_309 )
F_190 ( V_285 , V_49 -> V_165 [ V_162 ] ) ;
F_90 ( & V_49 -> V_159 , F_83 ) ;
}
F_81 ( & V_328 ) ;
return 0 ;
}
static void F_229 ( struct V_292 * V_242 )
{
struct V_21 * V_294 = F_200 ( V_242 ) ;
...
{
struct V_42 * V_43 = F_198 ( V_90 , V_90 ) ;
struct V_261 * V_255 = & V_43 -> V_329 . V_255 ;
struct V_1 * V_2 ;
struct V_251 * V_252 ;
int V_23 ;
V_252 = F_58 ( sizeof( * V_252 ) , V_193 ) ;
...
case V_280 :
if ( ! V_2 ) {
F_186 ( & V_43 -> V_242 , L_61 ) ;
F_165 ( V_252 ) ;
} else {
V_43 -> V_2 = V_2 ;
F_164 ( V_252 , V_43 -> V_2 ) ;
F_172 ( V_43 , V_330 ) ;
V_2 = NULL ;
}
break;
...
bool V_275 = false ;
int V_23 ;
if ( V_45 != V_334 . V_131 || V_37 < sizeof( V_252 -> V_254 ) )
return V_25 ;
if ( V_37 != F_159 ( V_252 -> V_254 . V_37 ) ||
V_37 != F_158 ( V_252 -> V_254 . V_250 ) )
return V_26 ;
F_2 ( & V_43 -> V_6 ) ;
if ( V_43 -> V_229 == V_311 ) {
F_186 ( & V_43 -> V_242 , L_64 ) ;
F_4 ( & V_43 -> V_6 ) ;
return V_25 ;
}
V_23 = V_39 ;
F_5 ( & V_43 -> V_242 , L_65 , V_252 -> V_254 . V_250 ) ;
switch ( F_159 ( V_252 -> V_254 . V_250 ) & V_335 ) {
case V_253 :
if ( F_233 ( & V_43 -> V_90 ) ) {
F_186 ( & V_43 -> V_242 , L_66 ) ;
V_23 = V_134 ;
} else {
V_43 -> V_329 . V_255 = V_252 -> V_255 ;
F_234 ( & V_43 -> V_90 , F_230 ) ;
F_235 ( V_336 , & V_43 -> V_90 ) ;
}
break;
case V_256 :
if ( V_43 -> V_229 != V_278 ) {
V_23 = V_134 ;
} else if ( F_159 ( V_252 -> V_254 . V_250 ) & V_260 ) {
F_224 ( & V_43 -> V_242 , L_67 ) ;
V_2 = F_184 ( V_43 ) ;
} else {
struct V_1 * V_206 = V_43 -> V_2 ;
F_169 ( V_43 , & V_252 -> V_257 ) ;
F_4 ( & V_43 -> V_6 ) ;
F_40 ( V_206 ) ;
F_2 ( & V_43 -> V_6 ) ;
}
...
if ( F_159 ( V_252 -> V_254 . V_250 ) & V_260 )
F_224 ( & V_43 -> V_242 , L_69 ) ;
V_2 = F_184 ( V_43 ) ;
V_275 = true ;
}
break;
default:
F_186 ( & V_43 -> V_242 , L_70 ,
F_159 ( V_252 -> V_254 . V_250 ) ) ;
V_23 = V_26 ;
}
F_4 ( & V_43 -> V_6 ) ;
if ( V_2 )
...
switch ( V_44 ) {
case V_132 :
V_23 = F_232 ( V_43 , V_252 , V_45 , V_37 ) ;
break;
default:
V_23 = V_135 ;
}
...
{
int V_84 , V_337 = ! ! ( V_309 ) ;
V_323 = F_222 ( V_338 , NULL ) ;
if ( V_274 + V_337 > V_339 )
V_274 = V_339 - V_337 ;
V_164 = V_274 + V_337 ;
V_320 = F_238 ( V_156 , V_340
| V_341 ) ;
if ( F_210 ( V_320 ) ) {
V_84 = F_220 ( V_320 ) ;
return V_84 ;
...
V_334 . V_133 = sizeof( struct V_251 ) ;
V_334 . V_318 = F_236 ;
V_84 = F_218 ( & V_334 ,
& V_360 ) ;
if ( V_84 ) {
