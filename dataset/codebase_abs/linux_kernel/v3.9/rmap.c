...
if ( F_146 ( V_87 ) == V_96 )
goto V_43;
F_172 (vma, &mapping->i_mmap_nonlinear,
shared.nonlinear) {
...
int F_174 ( struct V_38 * V_38 , enum V_91 V_87 )
{
int V_77 ;
F_96 ( ! F_97 ( V_38 ) ) ;
F_5 ( ! F_73 ( V_38 ) && F_86 ( V_38 ) ) ;
if ( F_18 ( F_103 ( V_38 ) ) )
V_77 = F_175 ( V_38 , V_87 ) ;
else if ( F_63 ( V_38 ) )
...
int F_176 ( struct V_38 * V_38 )
{
F_5 ( ! F_97 ( V_38 ) || F_177 ( V_38 ) ) ;
if ( F_18 ( F_103 ( V_38 ) ) )
...
static int F_178 ( struct V_38 * V_38 , int (* F_179)( struct V_38 * ,
...
struct V_10 * V_11 = V_12 -> V_11 ;
unsigned long V_51 = F_61 ( V_38 , V_11 ) ;
V_77 = F_179 ( V_38 , V_11 , V_51 , V_130 ) ;
if ( V_77 != V_93 )
break;
}
F_54 ( V_1 ) ;
...
static int F_180 ( struct V_38 * V_38 , int (* F_179)( struct V_38 * ,
struct V_10 * , unsigned long , void * ) , void * V_130 )
{
struct V_73 * V_40 = V_38 -> V_40 ;
T_3 V_45 = V_38 -> V_46 << ( V_47 - V_48 ) ;
...
int F_181 ( struct V_38 * V_38 , int (* F_179)( struct V_38 * ,
struct V_10 * , unsigned long , void * ) , void * V_130 )
{
F_5 ( ! F_97 ( V_38 ) ) ;
if ( F_18 ( F_103 ( V_38 ) ) )
return F_182 ( V_38 , F_179 , V_130 ) ;
else if ( F_63 ( V_38 ) )
return F_178 ( V_38 , F_179 , V_130 ) ;
else
return F_180 ( V_38 , F_179 , V_130 ) ;
}
static void F_183 ( struct V_38 * V_38 ,
struct V_10 * V_11 , unsigned long V_51 , int V_80 )
{
struct V_1 * V_1 = V_11 -> V_1 ;
F_96 ( ! V_1 ) ;
