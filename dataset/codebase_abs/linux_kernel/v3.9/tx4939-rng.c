...
struct V_18 * V_19 ;
int V_9 ;
V_19 = F_16 ( V_17 , V_20 , 0 ) ;
if ( ! V_19 )
return - V_21 ;
V_8 = F_17 ( & V_17 -> V_17 , sizeof( * V_8 ) , V_22 ) ;
if ( ! V_8 )
return - V_23 ;
V_8 -> V_1 = F_18 ( & V_17 -> V_17 , V_19 ) ;
if ( F_19 ( V_8 -> V_1 ) )
return F_20 ( V_8 -> V_1 ) ;
V_8 -> V_5 . V_24 = F_21 ( & V_17 -> V_17 ) ;
V_8 -> V_5 . V_25 = F_10 ;
V_8 -> V_5 . V_26 = F_14 ;
F_1 () ;
F_8 ( V_27 , V_8 -> V_1 , V_11 ) ;
F_8 ( 0 , V_8 -> V_1 , V_11 ) ;
...
static int T_4 F_24 ( struct V_16 * V_17 )
{
struct V_7 * V_8 = F_25 ( V_17 ) ;
F_26 ( & V_8 -> V_5 ) ;
F_22 ( V_17 , NULL ) ;
return 0 ;
}
