...
{
V_24 -> V_26 . V_5 = V_25 -> V_5 ;
V_24 -> V_26 . V_6 = V_25 -> V_6 ;
}
static int
F_14 ( struct V_27 * V_28 , const struct V_11 * V_12 ,
...
struct V_1 V_13 = { } ;
if ( ! F_15 ( V_12 , V_34 -> V_37 & V_38 ,
& V_13 . V_6 , & V_13 . V_7 ) )
return - V_39 ;
F_16 ( V_12 , V_34 -> V_37 & V_40 , & V_13 . V_5 ) ;
F_16 ( V_12 , V_34 -> V_37 & V_41 , & V_13 . V_3 ) ;
return V_35 ( V_28 , & V_13 , F_17 ( V_34 , V_24 ) , V_34 -> V_42 ) ;
}
static int
F_18 ( struct V_27 * V_28 , struct V_43 * V_44 [] ,
...
if ( V_44 [ V_54 ] )
* V_45 = F_22 ( V_44 [ V_54 ] ) ;
V_51 = F_23 ( V_44 [ V_14 ] , & V_13 . V_5 ) ;
if ( V_51 )
return V_51 ;
V_51 = F_23 ( V_44 [ V_15 ] , & V_13 . V_3 ) ;
if ( V_51 )
return V_51 ;
if ( V_44 [ V_16 ] )
V_13 . V_6 = F_24 ( V_44 [ V_16 ] ) ;
else
return - V_53 ;
if ( V_44 [ V_17 ] ) {
V_13 . V_7 = F_25 ( V_44 [ V_17 ] ) ;
V_50 = F_26 ( V_13 . V_7 ) ;
if ( V_13 . V_7 == 0 )
return - V_55 ;
} else
...
return F_29 ( V_51 , V_37 ) ? 0 : V_51 ;
}
V_47 = V_5 = F_30 ( V_13 . V_5 ) ;
if ( V_44 [ V_60 ] ) {
V_51 = F_31 ( V_44 [ V_60 ] , & V_47 ) ;
if ( V_51 )
return V_51 ;
if ( V_5 > V_47 )
F_32 ( V_5 , V_47 ) ;
} else if ( V_44 [ V_61 ] ) {
T_3 V_62 = F_25 ( V_44 [ V_61 ] ) ;
if ( ! V_62 || V_62 > 32 )
return - V_63 ;
F_33 ( V_5 , V_47 , V_62 ) ;
}
V_49 = V_6 = F_34 ( V_13 . V_6 ) ;
if ( V_50 && V_44 [ V_52 ] ) {
V_49 = F_35 ( V_44 [ V_52 ] ) ;
if ( V_6 > V_49 )
F_32 ( V_6 , V_49 ) ;
...
if ( V_46 )
V_5 = F_30 ( V_24 -> V_26 . V_5 ) ;
for (; ! F_36 ( V_47 , V_5 ) ; V_5 ++ ) {
V_48 = V_46 && V_5 == F_30 ( V_24 -> V_26 . V_5 ) ? F_34 ( V_24 -> V_26 . V_6 )
: V_6 ;
for (; V_48 <= V_49 ; V_48 ++ ) {
V_13 . V_5 = F_11 ( V_5 ) ;
V_13 . V_6 = F_37 ( V_48 ) ;
V_51 = V_35 ( V_28 , & V_13 , V_22 , V_37 ) ;
if ( V_51 && ! F_29 ( V_51 , V_37 ) )
return V_51 ;
else
V_51 = 0 ;
}
...
T_1 * V_4 )
{
return F_40 ( & V_2 -> V_5 . V_70 , & V_3 -> V_5 . V_70 ) &&
F_40 ( & V_2 -> V_3 . V_70 , & V_3 -> V_3 . V_70 ) &&
V_2 -> V_6 == V_3 -> V_6 &&
V_2 -> V_7 == V_3 -> V_7 ;
}
static inline bool
