...
static int T_6 F_30 ( struct V_2 * V_2 )
{
struct V_88 * V_89 ;
struct V_90 * V_91 ;
V_89 = V_92 ;
if ( ! F_31 ( V_2 , & V_93 ) ) {
V_89 = F_32 ( V_89 , sizeof( V_92 ) , V_94 ) ;
if ( ! V_89 )
goto V_95;
V_89 [ 0 ] . V_53 = & V_2 -> V_77 . V_78 . V_81 ;
}
V_91 = F_33 ( V_2 , L_1 , V_89 ) ;
if ( ! V_91 )
goto V_96;
V_2 -> V_97 . V_98 = V_91 ;
return 0 ;
...
static void T_7 F_35 ( struct V_2 * V_2 )
{
struct V_88 * V_89 ;
if ( V_2 -> V_97 . V_98 == NULL )
return;
V_89 = V_2 -> V_97 . V_98 -> V_100 ;
F_36 ( V_2 -> V_97 . V_98 ) ;
if ( ! F_31 ( V_2 , & V_93 ) )
F_34 ( V_89 ) ;
}
