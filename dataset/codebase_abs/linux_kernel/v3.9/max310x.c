...
static int F_55 ( struct V_171 * V_172 , T_2 V_67 )
{
int V_173 ;
struct V_13 * V_14 = F_56 ( & V_172 -> V_2 ) ;
F_11 ( & V_172 -> V_2 , L_6 ) ;
V_173 = F_57 ( & V_14 -> V_174 , & V_14 -> V_45 ) ;
F_26 ( & V_14 -> V_83 ) ;
F_40 ( V_14 -> V_20 , V_146 ,
V_175 ,
V_175 ) ;
...
F_6 ( V_14 ) ;
F_28 ( & V_14 -> V_83 ) ;
return F_59 ( & V_14 -> V_174 , & V_14 -> V_45 ) ;
}
static int F_60 ( struct V_176 * V_177 , unsigned V_178 )
{
unsigned int V_94 = 0 ;
struct V_13 * V_14 = F_30 ( V_177 , struct V_13 , V_179 ) ;
F_26 ( & V_14 -> V_83 ) ;
F_7 ( V_14 -> V_20 , V_12 , & V_94 ) ;
F_28 ( & V_14 -> V_83 ) ;
return ! ! ( ( V_94 >> 4 ) & ( 1 << V_178 ) ) ;
}
static void F_61 ( struct V_176 * V_177 , unsigned V_178 , int V_180 )
{
struct V_13 * V_14 = F_30 ( V_177 , struct V_13 , V_179 ) ;
F_26 ( & V_14 -> V_83 ) ;
F_40 ( V_14 -> V_20 , V_12 , 1 << V_178 , V_180 ?
1 << V_178 : 0 ) ;
F_28 ( & V_14 -> V_83 ) ;
}
static int F_62 ( struct V_176 * V_177 , unsigned V_178 )
{
struct V_13 * V_14 = F_30 ( V_177 , struct V_13 , V_179 ) ;
F_26 ( & V_14 -> V_83 ) ;
F_40 ( V_14 -> V_20 , V_181 , 1 << V_178 , 0 ) ;
F_28 ( & V_14 -> V_83 ) ;
return 0 ;
}
static int F_63 ( struct V_176 * V_177 ,
unsigned V_178 , int V_180 )
{
struct V_13 * V_14 = F_30 ( V_177 , struct V_13 , V_179 ) ;
F_26 ( & V_14 -> V_83 ) ;
F_40 ( V_14 -> V_20 , V_181 , 1 << V_178 ,
1 << V_178 ) ;
F_40 ( V_14 -> V_20 , V_12 , 1 << V_178 , V_180 ?
1 << V_178 : 0 ) ;
F_28 ( & V_14 -> V_83 ) ;
...
V_14 -> V_20 = F_71 ( V_172 , & V_14 -> V_193 ) ;
if ( F_72 ( V_14 -> V_20 ) ) {
V_173 = F_73 ( V_14 -> V_20 ) ;
F_66 ( V_2 , L_14 ) ;
goto V_209;
}
V_173 = F_5 ( V_14 -> V_20 , V_156 , V_210 ) ;
if ( V_173 ) {
F_66 ( V_2 , L_15 ) ;
goto V_209;
}
...
V_173 = F_74 ( V_2 , V_172 -> V_79 , NULL , F_25 ,
V_218 | V_219 ,
F_75 ( V_2 ) , V_14 ) ;
if ( V_173 ) {
F_66 ( V_2 , L_18 , V_172 -> V_79 ) ;
goto V_209;
}
V_14 -> V_174 . V_220 = V_221 ;
V_14 -> V_174 . V_222 = F_75 ( V_2 ) ;
V_14 -> V_174 . F_75 = L_19 ;
V_14 -> V_174 . V_223 = V_224 ;
V_14 -> V_174 . V_225 = V_226 ;
V_173 = F_76 ( & V_14 -> V_174 ) ;
if ( V_173 ) {
F_66 ( V_2 , L_20 ) ;
goto V_209;
}
...
F_79 ( & V_14 -> V_174 , & V_14 -> V_45 ) ;
#ifdef F_80
if ( V_25 -> V_236 ) {
V_14 -> V_179 . V_220 = V_221 ;
V_14 -> V_179 . V_2 = V_2 ;
V_14 -> V_179 . V_237 = F_75 ( V_2 ) ;
V_14 -> V_179 . V_238 = F_62 ;
V_14 -> V_179 . V_239 = F_60 ;
V_14 -> V_179 . V_240 = F_63 ;
V_14 -> V_179 . V_241 = F_61 ;
V_14 -> V_179 . V_242 = V_25 -> V_236 ;
V_14 -> V_179 . V_243 = V_14 -> V_191 ;
V_14 -> V_179 . V_244 = 1 ;
if ( F_81 ( & V_14 -> V_179 ) ) {
V_14 -> V_179 . V_242 = 0 ;
}
...
static int F_83 ( struct V_171 * V_172 )
{
struct V_1 * V_2 = & V_172 -> V_2 ;
...
F_85 ( V_14 -> V_93 ) ;
F_86 ( & V_14 -> V_174 , & V_14 -> V_45 ) ;
F_87 ( & V_14 -> V_174 ) ;
#ifdef F_80
if ( V_14 -> V_25 -> V_236 ) {
V_173 = F_88 ( & V_14 -> V_179 ) ;
if ( V_173 )
F_66 ( V_2 , L_24 , V_173 ) ;
}
#endif
