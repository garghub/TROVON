...
static int F_20 ( struct V_78 * V_10 )
{
struct V_79 * V_80 ;
unsigned int V_81 ;
int V_65 ;
...
V_6 = F_24 ( & V_10 -> V_11 , sizeof( struct V_5 ) , V_83 ) ;
if ( ! V_6 )
return - V_84 ;
V_6 -> V_81 = V_81 ;
V_6 -> V_33 = F_25 ( & V_10 -> V_11 , V_80 ) ;
if ( ! V_6 -> V_33 ) {
F_23 ( & V_10 -> V_11 , L_5 ) ;
return - V_85 ;
}
...
F_26 ( V_10 , V_6 ) ;
F_27 ( & V_6 -> V_7 , & V_86 ) ;
F_28 ( & V_6 -> V_7 , & V_10 -> V_11 ) ;
snprintf ( V_6 -> V_7 . V_87 , V_88 , L_6 ,
F_29 ( V_9 -> V_28 -> V_11 ) ) ;
V_65 = F_30 ( V_9 -> V_28 , & V_6 -> V_7 ) ;
F_4 ( & V_10 -> V_11 , L_7 , V_29 , V_6 , V_65 ) ;
if ( V_65 < 0 )
goto V_89;
F_31 ( & V_10 -> V_11 ) ;
F_4 ( & V_10 -> V_11 , L_8 ) ;
...
static int F_32 ( struct V_78 * V_10 )
{
struct V_5 * V_6 = F_33 ( V_10 ) ;
F_34 ( & V_6 -> V_7 ) ;
F_35 ( & V_10 -> V_11 ) ;
F_26 ( V_10 , NULL ) ;
return 0 ;
