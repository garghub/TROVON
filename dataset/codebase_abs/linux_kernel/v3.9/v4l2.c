...
static int F_59 ( struct V_77 * V_78 , unsigned int * V_79 ,
unsigned int * V_34 )
{
...
static unsigned int F_68 ( struct V_95 * V_95 ,
struct V_96 * V_70 )
{
struct V_26 * V_27 = V_95 -> V_97 ;
return F_69 ( V_95 , & V_27 -> V_98 , V_70 ) ;
}
static int F_70 ( struct V_95 * V_95 , struct V_99 * V_100 )
{
struct V_26 * V_27 = V_95 -> V_97 ;
return F_71 ( & V_27 -> V_98 , V_100 ) ;
}
...
static T_5 F_79 ( struct V_95 * V_95 , char T_6 * V_69 ,
T_4 V_79 , T_7 * V_107 )
{
struct V_26 * V_27 = V_95 -> V_97 ;
return F_80 ( & V_27 -> V_98 , V_69 , V_79 , V_107 , 0 ,
V_95 -> V_108 & V_109 ) ;
}
static int F_81 ( struct V_95 * V_95 )
{
struct V_26 * V_27 = V_95 -> V_97 ;
F_82 ( & V_27 -> V_98 ) ;
F_83 ( & V_27 -> V_98 ) ;
...
static int F_84 ( struct V_95 * V_95 , void * V_110 ,
struct V_111 * V_112 )
{
...
static int F_87 ( struct V_95 * V_95 , void * V_110 ,
struct V_122 * V_123 )
{
struct V_26 * V_27 = V_110 ;
struct V_1 * V_1 = V_27 -> V_1 ;
if ( V_123 -> V_128 >= V_1 -> V_15 ) {
int V_30 = F_86 ( V_1 , V_123 ) ;
if ( V_30 < 0 )
return V_30 ;
} else {
snprintf ( V_123 -> V_129 , sizeof( V_123 -> V_129 ) , L_11 ,
V_123 -> V_128 + 1 ) ;
if ( ! F_88 ( V_1 , V_123 -> V_128 ) )
V_123 -> V_130 = V_131 ;
}
V_123 -> type = V_132 ;
if ( V_1 -> V_133 == V_134 )
...
static int F_89 ( struct V_95 * V_95 , void * V_110 , unsigned int V_128 )
{
struct V_26 * V_27 = V_110 ;
...
static int F_91 ( struct V_95 * V_95 , void * V_110 ,
struct V_138 * V_139 )
{
if ( V_139 -> V_128 )
return - V_18 ;
V_139 -> V_140 = V_141 ;
F_92 ( V_139 -> V_142 , L_12 , sizeof( V_139 -> V_142 ) ) ;
return 0 ;
}
static int F_93 ( struct V_95 * V_95 , void * V_110 ,
struct V_143 * V_139 )
{
struct V_26 * V_27 = V_110 ;
struct V_1 * V_1 = V_27 -> V_1 ;
...
if ( F_95 ( & V_27 -> V_98 ) )
return - V_152 ;
return F_93 ( V_95 , V_110 , V_139 ) ;
}
static int F_96 ( struct V_95 * V_95 , void * V_110 ,
struct V_143 * V_139 )
{
struct V_26 * V_27 = V_110 ;
struct V_1 * V_1 = V_27 -> V_1 ;
...
{
struct V_26 * V_27 = V_110 ;
return F_98 ( & V_27 -> V_98 , V_154 ) ;
}
static int F_99 ( struct V_95 * V_95 , void * V_110 , struct V_155 * V_156 )
{
struct V_26 * V_27 = V_110 ;
return F_100 ( & V_27 -> V_98 , V_156 ) ;
}
static int F_101 ( struct V_95 * V_95 , void * V_110 , struct V_155 * V_156 )
{
struct V_26 * V_27 = V_110 ;
return F_102 ( & V_27 -> V_98 , V_156 ) ;
}
static int F_103 ( struct V_95 * V_95 , void * V_110 , struct V_155 * V_156 )
{
struct V_26 * V_27 = V_110 ;
return F_104 ( & V_27 -> V_98 , V_156 , V_95 -> V_108 & V_109 ) ;
}
static int F_105 ( struct V_95 * V_95 , void * V_110 , enum V_157 V_19 )
{
struct V_26 * V_27 = V_110 ;
if ( V_19 != V_105 )
return - V_18 ;
return F_106 ( & V_27 -> V_98 ) ;
}
static int F_107 ( struct V_95 * V_95 , void * V_110 , enum V_157 V_19 )
{
struct V_26 * V_27 = V_110 ;
if ( V_19 != V_105 )
return - V_18 ;
return F_108 ( & V_27 -> V_98 ) ;
}
static int F_109 ( struct V_95 * V_95 , void * V_110 , T_8 * V_19 )
{
return 0 ;
}
static int F_110 ( struct V_95 * V_95 , void * V_110 ,
struct V_158 * V_159 )
{
V_159 -> V_160 = F_111 ( V_161 , V_159 -> V_160 ) ;
if ( ! V_159 -> V_160 )
return - V_18 ;
switch ( V_159 -> V_160 ) {
#ifdef F_112
...
V_159 -> V_167 = 0 ;
F_92 ( V_159 -> V_129 , L_13 , sizeof( V_159 -> V_129 ) ) ;
return 0 ;
#else
case V_162 :
return F_113 ( V_159 , 0 , 1 , 1 , 0 ) ;
#endif
}
return - V_18 ;
}
static int F_114 ( struct V_95 * V_95 , void * V_110 ,
struct V_168 * V_169 )
{
struct V_26 * V_27 = V_110 ;
struct V_1 * V_1 = V_27 -> V_1 ;
...
V_30 = F_122 ( V_1 -> V_175 , V_178 , V_179 ) ;
if ( V_30 < 0 ) {
F_123 ( V_1 -> V_175 ) ;
V_1 -> V_175 = NULL ;
return V_30 ;
