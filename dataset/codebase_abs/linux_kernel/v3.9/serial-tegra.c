...
V_2 -> V_49 = F_109 ( & V_219 -> V_50 , NULL ) ;
if ( F_110 ( V_2 -> V_49 ) ) {
F_18 ( & V_219 -> V_50 , L_29 ) ;
return F_111 ( V_2 -> V_49 ) ;
}
V_9 -> V_237 = V_238 ;
V_9 -> V_141 = F_112 ( V_219 , 0 ) ;
V_9 -> V_6 = 2 ;
V_47 = F_113 ( & V_239 , V_9 ) ;
if ( V_47 < 0 ) {
F_18 ( & V_219 -> V_50 , L_30 , V_47 ) ;
return V_47 ;
}
return V_47 ;
}
...
static int F_117 ( struct V_240 * V_50 )
{
struct V_1 * V_2 = F_118 ( V_50 ) ;
struct V_8 * V_9 = & V_2 -> V_4 ;
return F_119 ( & V_239 , V_9 ) ;
}
static int F_120 ( struct V_240 * V_50 )
{
struct V_1 * V_2 = F_118 ( V_50 ) ;
struct V_8 * V_9 = & V_2 -> V_4 ;
return F_121 ( & V_239 , V_9 ) ;
}
