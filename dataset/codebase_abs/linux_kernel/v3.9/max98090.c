...
F_13 ( V_80 , V_34 ,
V_196 , V_196 ) ;
for ( V_191 = 0 ; V_191 < F_17 ( V_197 ) ; V_191 ++ ) {
if ( V_197 [ V_191 ] == V_75 -> V_121 ) {
break;
}
}
for ( V_120 = 0 ; V_120 < F_17 ( V_198 ) - 1 ; V_120 ++ ) {
if ( V_75 -> V_123 <= ( V_198 [ V_120 ] +
V_198 [ V_120 + 1 ] ) / 2 ) {
break;
}
}
...
F_13 ( V_80 , V_16 ,
V_202 ,
V_203 [ V_191 ] [ V_120 ] << V_204 ) ;
return 0 ;
}
static int F_35 ( struct V_135 * V_142 ,
int V_205 , unsigned int V_206 , int V_207 )
{
struct V_85 * V_80 = V_142 -> V_80 ;
struct V_74 * V_75 = F_9 ( V_80 ) ;
if ( V_206 == V_75 -> V_121 )
return 0 ;
if ( ( V_206 >= 10000000 ) && ( V_206 < 20000000 ) ) {
F_22 ( V_80 , V_23 ,
V_208 ) ;
} else if ( ( V_206 >= 20000000 ) && ( V_206 < 40000000 ) ) {
F_22 ( V_80 , V_23 ,
V_209 ) ;
} else if ( ( V_206 >= 40000000 ) && ( V_206 < 60000000 ) ) {
F_22 ( V_80 , V_23 ,
V_210 ) ;
} else {
F_5 ( V_80 -> V_2 , L_13 ) ;
...
static int F_36 ( struct V_135 * V_136 , int V_211 )
{
struct V_85 * V_80 = V_136 -> V_80 ;
int V_140 ;
V_140 = V_211 ? V_212 : 0 ;
...
static void F_37 ( struct V_213 * V_214 )
{
struct V_74 * V_75 = F_38 ( V_214 ,
struct V_74 ,
V_215 . V_214 ) ;
...
F_39 ( V_75 -> V_224 , V_216 ,
V_220 | V_221 ) ;
F_40 ( V_110 ) ;
}
static T_2 F_41 ( int V_225 , void * V_226 )
{
struct V_85 * V_80 = V_226 ;
struct V_74 * V_75 = F_9 ( V_80 ) ;
int V_76 ;
unsigned int V_89 ;
unsigned int V_227 ;
...
V_75 -> V_180 = V_217 ;
F_50 ( & V_75 -> V_215 , F_37 ) ;
F_22 ( V_80 , V_57 ,
V_249 | V_250 ) ;
F_21 ( V_80 -> V_2 , L_37 , V_75 -> V_225 ) ;
V_76 = F_51 ( V_75 -> V_225 , NULL ,
F_41 , V_251 ,
L_38 , V_80 ) ;
if ( V_76 < 0 ) {
F_5 ( V_80 -> V_2 , L_39 ,
...
int V_76 ;
F_55 ( L_40 ) ;
V_75 = F_56 ( & V_260 -> V_2 , sizeof( struct V_74 ) ,
V_263 ) ;
if ( V_75 == NULL )
return - V_264 ;
V_75 -> V_112 = V_262 -> V_265 ;
F_57 ( V_260 , V_75 ) ;
V_75 -> V_241 = V_260 ;
V_75 -> V_240 = V_260 -> V_2 . V_266 ;
V_75 -> V_225 = V_260 -> V_225 ;
V_75 -> V_77 = F_58 ( V_260 , & V_267 ) ;
if ( F_59 ( V_75 -> V_77 ) ) {
V_76 = F_60 ( V_75 -> V_77 ) ;
F_5 ( & V_260 -> V_2 , L_41 , V_76 ) ;
goto V_268;
}
V_76 = F_61 ( & V_260 -> V_2 ,
& V_269 , V_270 ,
...
static int F_63 ( struct V_259 * V_271 )
{
struct V_74 * V_75 = F_64 ( & V_271 -> V_2 ) ;
F_65 ( & V_271 -> V_2 ) ;
F_62 ( V_75 -> V_77 ) ;
return 0 ;
}
...
{
struct V_74 * V_75 = F_64 ( V_2 ) ;
F_67 ( V_75 -> V_77 , false ) ;
F_28 ( V_75 -> V_77 ) ;
return 0 ;
}
