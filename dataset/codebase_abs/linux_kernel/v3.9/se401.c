...
V_78 = V_83 << 4 ; break;
case 4 :
V_78 = ( V_83 << 4 ) | 0x02 ; break;
}
F_7 ( V_1 , V_84 , V_78 ) ;
F_7 ( V_1 , V_85 , V_27 -> V_72 ) ;
V_27 -> V_86 = 0 ;
V_27 -> V_87 = 0 ;
V_27 -> V_88 = 0 ;
V_27 -> V_89 = 0 ;
...
F_8 ( V_1 , V_100 ) ;
F_8 ( V_1 , V_101 ) ;
V_94 = 256 * F_8 ( V_1 , V_98 ) +
F_8 ( V_1 , V_99 ) ;
V_95 = 256 * F_8 ( V_1 , V_100 ) +
F_8 ( V_1 , V_101 ) ;
V_96 = V_27 -> V_72 ;
if ( V_95 > 10 ) {
while ( V_95 >= 10 && V_27 -> V_72 < 63 ) {
V_27 -> V_72 ++ ;
V_95 /= 2 ;
}
} else if ( V_94 > 20 ) {
while ( V_94 >= 20 && V_27 -> V_72 > 0 ) {
V_27 -> V_72 -- ;
V_94 /= 2 ;
}
}
...
if ( V_27 -> V_90 &&
V_27 -> V_90 != V_97 )
V_27 -> V_72 = V_96 + ( V_27 -> V_72 - V_96 ) / 2 ;
if ( V_27 -> V_72 != V_96 ) {
V_27 -> V_90 = V_97 ;
F_7 ( V_1 , V_85 , V_27 -> V_72 ) ;
}
...
static void F_20 ( struct V_1 * V_1 , T_3 * V_102 , int V_103 )
{
struct V_27 * V_27 = (struct V_27 * ) V_1 ;
switch ( V_27 -> V_32 ) {
case V_33 :
...
F_21 ( V_1 , V_107 , V_102 , V_103 ) ;
}
static void F_22 ( struct V_1 * V_1 , T_3 * V_102 , int V_103 )
{
struct V_27 * V_27 = (struct V_27 * ) V_1 ;
int V_108 = V_1 -> V_54 * V_1 -> V_55 ;
int V_43 , V_109 , V_110 , V_111 , V_112 , V_113 ;
if ( V_27 -> V_88 )
return;
if ( V_1 -> V_105 == V_107 && V_103 == 1024 ) {
V_1 -> V_105 = V_106 ;
return;
}
V_43 = 0 ;
...
if ( V_113 > V_103 - V_43 )
V_113 = V_103 - V_43 ;
memcpy ( & V_27 -> V_114 [ V_27 -> V_86 ] , & V_102 [ V_43 ] , V_113 ) ;
V_27 -> V_86 += V_113 ;
V_43 += V_113 ;
if ( V_27 -> V_86 < 4 )
break;
}
V_110 = V_27 -> V_114 [ 3 ] + ( V_27 -> V_114 [ 2 ] << 8 ) ;
V_111 = V_27 -> V_114 [ 1 ] + ( ( V_27 -> V_114 [ 0 ] & 0x3f ) << 8 ) ;
V_112 = ( V_27 -> V_114 [ 0 ] & 0xc0 ) >> 6 ;
V_109 = ( ( V_110 + 47 ) >> 4 ) << 1 ;
if ( V_109 > 1024 ) {
F_4 ( L_12 ,
V_109 ) ;
...
F_20 ( V_1 , V_27 -> V_114 , V_109 ) ;
return;
case 2 :
F_21 ( V_1 , V_116 , V_27 -> V_114 ,
V_109 ) ;
V_27 -> V_87 = V_111 ;
break;
}
...
error:
V_27 -> V_88 = 1 ;
F_21 ( V_1 , V_116 , NULL , 0 ) ;
F_21 ( V_1 , V_107 , NULL , 0 ) ;
}
static void F_23 ( struct V_1 * V_1 , T_3 * V_102 , int V_103 )
{
struct V_41 * V_41 = & V_1 -> V_41 ;
int V_108 = V_41 -> V_66 [ V_1 -> V_77 ] . V_64 ;
if ( V_1 -> V_117 == 0 ) {
F_21 ( V_1 , V_116 , V_102 , V_103 ) ;
return;
}
if ( V_1 -> V_117 + V_103 >= V_108 ) {
F_20 ( V_1 , V_102 , V_103 ) ;
return;
}
F_21 ( V_1 , V_115 , V_102 , V_103 ) ;
}
static void F_24 ( struct V_1 * V_1 , T_3 * V_102 , int V_103 )
{
int V_76 = V_1 -> V_41 . V_66 [ V_1 -> V_77 ] . V_60 ;
if ( V_103 == 0 )
return;
...
F_22 ( V_1 , V_102 , V_103 ) ;
}
static int F_25 ( struct V_1 * V_1 , T_3 * V_102 , int V_103 )
{
struct V_27 * V_27 = (struct V_27 * ) V_1 ;
T_3 V_118 ;
if ( V_103 != 2 )
...
{
struct V_1 * V_1 =
F_29 ( V_124 -> V_125 , struct V_1 , V_126 ) ;
struct V_27 * V_27 = (struct V_27 * ) V_1 ;
V_1 -> V_6 = 0 ;
if ( ! V_1 -> V_127 )
return 0 ;
...
break;
case V_130 :
F_11 ( V_1 , V_124 -> V_20 , V_27 -> V_26 -> V_20 ) ;
break;
}
return V_1 -> V_6 ;
}
...
{
struct V_27 * V_27 = (struct V_27 * ) V_1 ;
struct V_131 * V_132 = & V_1 -> V_126 ;
V_1 -> V_133 . V_126 = V_132 ;
F_31 ( V_132 , 4 ) ;
if ( V_27 -> V_74 )
F_32 ( V_132 , & V_134 ,
V_128 , 0 , 255 , 1 , 15 ) ;
F_32 ( V_132 , & V_134 ,
V_129 , 0 , 50 , 1 , 25 ) ;
V_27 -> V_135 = F_32 ( V_132 , & V_134 ,
V_130 , 0 , 32767 , 1 , 15000 ) ;
V_27 -> V_26 = F_33 ( V_132 , & V_134 ,
V_136 ,
V_35 , 0 , 0 ) ;
if ( V_132 -> error ) {
F_4 ( L_15 ) ;
...
const struct V_39 * V_40 )
{
return F_36 ( V_138 , V_40 , & V_139 , sizeof( struct V_27 ) ,
V_140 ) ;
}
