...
goto V_35;
F_3 ( V_2 , L_7 ,
V_32 -> type , V_30 -> V_38 , V_4 -> V_39 ,
V_30 -> V_40 ? V_30 -> V_40 -> V_41 : L_8 ,
V_30 -> V_42 ? V_30 -> V_42 -> V_41 : L_8 ) ;
if ( V_4 -> V_43 )
F_3 ( V_2 , L_9 , V_4 -> V_43 ) ;
if ( V_4 -> V_44 && V_4 -> V_44 -> type == V_45 ) {
F_3 ( V_2 , L_10 ,
F_11 ( V_4 ) -> V_46 , F_11 ( V_4 ) -> V_47 ,
F_4 ( F_11 ( V_4 ) -> V_48 ) ) ;
if ( V_30 -> V_49 == V_50 ) {
switch ( F_11 ( V_4 ) -> V_48 ) {
case F_12 ( V_51 ) :
F_5 ( V_2 , V_4 ) ;
break;
case F_12 ( V_52 ) :
...
static int F_17 ( const struct V_58 * V_30 )
{
const struct V_31 * V_32 = V_30 -> V_33 ;
if ( V_32 -> type > V_59 ) {
F_18 ( L_11 ,
