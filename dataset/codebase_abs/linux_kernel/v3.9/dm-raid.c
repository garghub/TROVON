...
static void F_72 ( struct V_11 * V_12 , T_4 type ,
unsigned V_153 , char * V_154 , unsigned V_155 )
{
struct V_10 * V_14 = V_12 -> V_141 ;
unsigned V_156 = 1 ;
unsigned V_157 = 0 ;
...
switch ( type ) {
case V_160 :
F_73 ( L_85 , V_14 -> V_6 -> V_7 , V_14 -> V_20 . V_21 ) ;
if ( F_19 ( V_161 , & V_14 -> V_20 . V_162 ) )
V_159 = V_14 -> V_20 . V_163 ;
else
V_159 = V_14 -> V_20 . V_27 ;
if ( V_159 >= V_14 -> V_20 . V_164 ) {
V_158 = 1 ;
V_159 = V_14 -> V_20 . V_164 ;
} else {
for ( V_8 = 0 ; V_8 < V_14 -> V_20 . V_21 ; V_8 ++ )
if ( ! F_19 ( V_40 , & V_14 -> V_17 [ V_8 ] . V_28 . V_41 ) )
V_158 = 1 ;
...
( unsigned long long ) V_14 -> V_20 . V_164 ) ;
break;
case V_165 :
for ( V_8 = 0 ; V_8 < V_14 -> V_20 . V_21 ; V_8 ++ ) {
if ( ( V_14 -> V_71 & V_75 ) &&
...
V_156 += ( F_74 ( V_14 -> V_71 & ~ V_75 ) * 2 ) ;
if ( V_14 -> V_71 & ( V_73 | V_72 ) )
V_156 -- ;
F_73 ( L_90 , V_14 -> V_6 -> V_7 ,
V_156 , V_14 -> V_20 . V_53 ) ;
if ( ( V_14 -> V_71 & V_73 ) &&
( V_14 -> V_20 . V_27 == V_70 ) )
F_73 ( L_91 ) ;
if ( V_14 -> V_71 & V_72 )
...
V_14 -> V_20 . V_54 . V_82 ) ;
if ( V_14 -> V_71 & V_84 )
F_73 ( L_95 , V_14 -> V_20 . V_86 ) ;
if ( V_14 -> V_71 & V_87 )
F_73 ( L_96 , V_14 -> V_20 . V_88 ) ;
for ( V_8 = 0 ; V_8 < V_14 -> V_20 . V_21 ; V_8 ++ )
if ( V_14 -> V_17 [ V_8 ] . V_30 &&
F_19 ( V_76 , & V_14 -> V_17 [ V_8 ] . V_28 . V_41 ) )
F_73 ( L_97 , V_8 ) ;
...
V_14 -> V_20 . V_54 . V_79 ) ;
if ( V_14 -> V_71 & V_83 ) {
struct V_166 * V_167 = V_14 -> V_20 . V_141 ;
F_73 ( L_99 ,
V_167 ? V_167 -> V_168 * 2 : 0 ) ;
}
if ( V_14 -> V_71 & V_89 )
F_73 ( L_100 ,
...
F_73 ( L_102 ,
F_1 ( V_14 -> V_20 . V_1 ) ) ;
F_73 ( L_103 , V_14 -> V_20 . V_21 ) ;
for ( V_8 = 0 ; V_8 < V_14 -> V_20 . V_21 ; V_8 ++ ) {
if ( V_14 -> V_17 [ V_8 ] . V_29 )
F_73 ( L_104 , V_14 -> V_17 [ V_8 ] . V_29 -> V_7 ) ;
else
F_73 ( L_105 ) ;
if ( V_14 -> V_17 [ V_8 ] . V_30 )
F_73 ( L_104 , V_14 -> V_17 [ V_8 ] . V_30 -> V_7 ) ;
else
F_73 ( L_105 ) ;
}
}
}
static int F_75 ( struct V_11 * V_12 , T_5 V_169 , void * V_170 )
{
struct V_10 * V_14 = V_12 -> V_141 ;
unsigned V_8 ;
int V_34 = 0 ;
...
static void F_76 ( struct V_11 * V_12 , struct V_171 * V_172 )
{
struct V_10 * V_14 = V_12 -> V_141 ;
unsigned V_173 = V_14 -> V_20 . V_53 << 9 ;
struct V_166 * V_167 = V_14 -> V_20 . V_141 ;
F_77 ( V_172 , V_173 ) ;
F_78 ( V_172 , V_173 * ( V_167 -> V_21 - V_167 -> V_174 ) ) ;
}
