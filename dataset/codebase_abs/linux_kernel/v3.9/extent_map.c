...
F_30 ( & V_12 -> V_20 , & V_7 -> V_10 ) ;
F_31 ( & V_48 -> V_20 ) ;
F_32 ( & V_48 -> V_21 , & V_7 -> V_8 ) ;
F_11 ( V_48 ) ;
}
}
V_49 = F_23 ( & V_12 -> V_21 ) ;
...
int F_33 ( struct V_6 * V_7 , T_2 V_29 , T_2 V_51 ,
T_2 V_55 )
{
int V_56 = 0 ;
struct V_2 * V_12 ;
...
struct V_21 * V_49 ;
struct V_2 * V_60 ;
V_60 = F_35 ( V_7 , V_12 -> V_29 , V_12 -> V_51 ) ;
if ( V_60 ) {
F_11 ( V_60 ) ;
V_56 = - V_61 ;
goto V_58;
...
static T_2 F_41 ( T_2 V_29 , T_2 V_51 )
{
if ( V_29 + V_51 < V_29 )
return ( T_2 ) - 1 ;
return V_29 + V_51 ;
...
T_2 V_29 , T_2 V_51 , int V_62 )
{
struct V_2 * V_12 ;
struct V_21 * V_21 ;
struct V_21 * V_35 = NULL ;
struct V_21 * V_38 = NULL ;
T_2 V_63 = F_41 ( V_29 , V_51 ) ;
...
if ( V_62 && ! ( V_63 > V_12 -> V_29 && V_29 < F_19 ( V_12 ) ) )
return NULL ;
F_40 ( & V_12 -> V_19 ) ;
return V_12 ;
}
...
T_2 V_29 , T_2 V_51 )
{
return F_42 ( V_7 , V_29 , V_51 , 1 ) ;
}
struct V_2 * F_43 ( struct V_6 * V_7 ,
T_2 V_29 , T_2 V_51 )
{
return F_42 ( V_7 , V_29 , V_51 , 0 ) ;
}
int F_44 ( struct V_6 * V_7 , struct V_2 * V_12 )
{
int V_56 = 0 ;
F_12 ( F_26 ( V_39 , & V_12 -> V_15 ) ) ;
F_32 ( & V_12 -> V_21 , & V_7 -> V_8 ) ;
if ( ! F_26 ( V_41 , & V_12 -> V_15 ) )
F_31 ( & V_12 -> V_20 ) ;
V_12 -> V_14 = 0 ;
return V_56 ;
