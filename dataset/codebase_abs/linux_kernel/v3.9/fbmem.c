...
__acquires( &info->lock
static int F_87 ( struct V_1 * V_119 )
{
const bool V_245 = V_119 -> V_43 & V_246 ;
V_119 -> V_43 &= ~ V_246 ;
#ifdef F_88
V_119 -> V_43 |= V_245 ? 0 : V_247 ;
#else
V_119 -> V_43 |= V_245 ? V_247 : 0 ;
#endif
if ( V_119 -> V_43 & V_247 && ! F_89 ( V_119 ) ) {
F_90 ( L_6
L_7 , V_119 -> V_15 . V_121 ) ;
return - V_248 ;
} else if ( ! ( V_119 -> V_43 & V_247 ) && F_89 ( V_119 ) ) {
F_90 ( L_8
L_7 , V_119 -> V_15 . V_121 ) ;
return - V_248 ;
}
...
static bool F_91 ( struct V_249 * V_250 , struct V_249 * V_251 )
{
if ( V_250 -> V_252 == V_251 -> V_252 )
return true ;
if ( V_250 -> V_252 > V_251 -> V_252 && V_250 -> V_252 < V_251 -> V_252 + V_251 -> V_39 )
return true ;
return false ;
}
static bool F_92 ( struct V_253 * V_254 ,
struct V_253 * V_255 )
{
int V_35 , V_36 ;
if ( ! V_255 || ! V_254 )
return false ;
for ( V_35 = 0 ; V_35 < V_255 -> V_7 ; ++ V_35 ) {
struct V_249 * V_75 = & V_255 -> V_256 [ V_35 ] ;
for ( V_36 = 0 ; V_36 < V_254 -> V_7 ; ++ V_36 ) {
struct V_249 * V_257 = & V_254 -> V_256 [ V_36 ] ;
F_58 ( V_258 L_9 ,
( unsigned long long ) V_257 -> V_252 ,
( unsigned long long ) V_257 -> V_39 ,
( unsigned long long ) V_75 -> V_252 ,
...
static void F_93 ( struct V_253 * V_259 ,
const char * V_260 , bool V_261 )
{
int V_35 ;
...
if ( ! V_6 [ V_35 ] )
continue;
if ( ! ( V_6 [ V_35 ] -> V_43 & V_263 ) )
continue;
V_262 = V_6 [ V_35 ] -> V_264 ;
if ( F_92 ( V_262 , V_259 ) ||
( V_261 && V_262 && V_262 -> V_7 &&
V_262 -> V_256 [ 0 ] . V_252 == V_265 ) ) {
F_58 ( V_266 L_10
L_11 ,
V_260 , V_6 [ V_35 ] -> V_15 . V_121 ) ;
F_94 ( V_6 [ V_35 ] ) ;
}
}
}
...
F_98 ( & V_1 -> V_11 ) ;
F_98 ( & V_1 -> V_238 ) ;
V_1 -> V_269 = F_99 ( V_270 , V_1 -> V_271 ,
F_100 ( V_272 , V_35 ) , NULL , L_5 , V_35 ) ;
if ( F_101 ( V_1 -> V_269 ) ) {
F_58 ( V_181 L_12 , V_35 , F_102 ( V_1 -> V_269 ) ) ;
V_1 -> V_269 = NULL ;
} else
F_103 ( V_1 ) ;
if ( V_1 -> V_273 . V_42 == NULL ) {
V_1 -> V_273 . V_42 = F_26 ( V_274 , V_102 ) ;
if ( V_1 -> V_273 . V_42 ) {
V_1 -> V_273 . V_39 = V_274 ;
V_1 -> V_273 . V_41 = 1 ;
V_1 -> V_273 . V_275 = 1 ;
V_1 -> V_273 . V_276 = 32 ;
V_1 -> V_273 . V_43 = V_277 ;
}
}
V_1 -> V_273 . V_24 = 0 ;
if ( ! V_1 -> V_273 . V_278 )
V_1 -> V_273 . V_278 = ~ ( T_2 ) 0 ;
if ( ! V_1 -> V_273 . V_279 )
V_1 -> V_273 . V_279 = ~ ( T_2 ) 0 ;
...
return - V_147 ;
if ( V_1 -> V_269 ) {
F_108 ( V_270 , F_100 ( V_272 , V_35 ) ) ;
V_1 -> V_269 = NULL ;
}
return 0 ;
}
void F_109 ( struct V_253 * V_259 ,
const char * V_260 , bool V_261 )
{
F_3 ( & V_5 ) ;
F_93 ( V_259 , V_260 , V_261 ) ;
F_5 ( & V_5 ) ;
}
int
...
void F_112 ( struct V_1 * V_10 , int V_95 )
{
struct V_154 V_155 ;
V_155 . V_10 = V_10 ;
if ( V_95 ) {
...
F_113 ( void )
{
F_114 ( L_13 , 0 , NULL , & V_286 ) ;
if ( F_115 ( V_272 , L_13 , & V_287 ) )
F_58 ( L_14 , V_272 ) ;
V_270 = F_116 ( V_288 , L_15 ) ;
if ( F_101 ( V_270 ) ) {
F_58 ( V_181 L_16 , F_102 ( V_270 ) ) ;
V_270 = NULL ;
}
return 0 ;
}
...
int F_121 ( struct V_1 * V_10 )
{
struct V_154 V_155 ;
struct V_12 V_13 = V_10 -> V_13 ;
struct V_289 * V_117 , * V_48 ;
struct V_290 * V_168 ;
struct V_164 * V_116 , V_179 ;
int V_132 = 1 ;
F_122 (pos, n, &info->modelist) {
V_168 = F_123 ( V_117 , struct V_290 , V_291 ) ;
V_116 = & V_168 -> V_179 ;
F_124 ( & V_13 , V_116 ) ;
V_13 . V_153 = V_292 ;
...
if ( ! F_59 ( & V_10 -> V_168 ) ) {
V_155 . V_10 = V_10 ;
V_132 = F_53 ( V_293 , & V_155 ) ;
}
return V_132 ;
}
int F_126 ( char * V_260 , char * * V_294 )
{
char * V_295 , * V_296 = NULL ;
int V_297 = 0 ;
int V_298 = strlen ( V_260 ) , V_35 ;
if ( V_298 && V_299 && strncmp ( V_260 , L_17 , 4 ) )
V_297 = 1 ;
if ( V_298 && ! V_297 ) {
for ( V_35 = 0 ; V_35 < V_3 ; V_35 ++ ) {
if ( V_300 [ V_35 ] == NULL )
...
continue;
V_295 = V_300 [ V_35 ] ;
if ( ! strncmp ( V_260 , V_295 , V_298 ) &&
V_295 [ V_298 ] == ':' )
V_296 = V_295 + V_298 + 1 ;
}
}
if ( V_296 && ! strncmp ( V_296 , L_18 , 3 ) )
V_297 = 1 ;
if ( V_294 )
* V_294 = V_296 ;
return V_297 ;
}
static int T_11 F_127 ( char * V_296 )
{
int V_35 , V_301 = 0 ;
if ( ! V_296 || ! * V_296 )
V_301 = 1 ;
if ( ! V_301 && ! strncmp ( V_296 , L_19 , 6 ) ) {
V_299 = 1 ;
V_301 = 1 ;
}
if ( ! V_301 && ! strchr ( V_296 , ':' ) ) {
V_302 = V_296 ;
V_301 = 1 ;
}
if ( ! V_301 ) {
