...
int V_130 ;
do {
V_130 = F_84 ( & V_129 -> V_131 ) ;
F_80 ( V_127 , & V_129 -> V_125 ) ;
} while ( F_85 ( & V_129 -> V_131 , V_130 ) );
} else
...
struct V_70 * V_71 ;
F_3 ( L_27 , V_5 ) ;
V_135 = F_87 ( sizeof( * V_135 ) , V_38 ) ;
if ( V_135 == NULL )
return NULL ;
V_135 -> args . V_136 = V_137 ;
if ( V_135 -> args . V_136 > V_62 -> V_64 )
V_135 -> args . V_136 = V_62 -> V_64 ;
V_135 -> args . V_138 = V_139 ;
V_135 -> args . V_62 = * V_62 ;
V_135 -> args . type = V_14 -> V_10 -> V_2 ;
V_135 -> args . V_36 = V_37 ;
V_135 -> args . V_133 = F_88 ( V_133 ) ;
V_135 -> V_38 = V_38 ;
V_71 = F_89 ( V_135 , V_38 ) ;
if ( F_90 ( V_71 ) ) {
switch ( F_91 ( V_71 ) ) {
case - V_140 :
case - V_141 :
...
static void F_92 ( struct V_36 * V_36 ,
struct V_91 * V_66 )
{
struct V_47 * V_48 = F_28 ( V_36 ) ;
struct V_70 * V_71 , * V_27 ;
if ( ! F_35 ( V_142 , & V_48 -> V_143 ) )
return;
F_62 (lseg, tmp, &nfsi->layout->plh_segs, pls_list) {
if ( ! F_35 ( V_144 , & V_71 -> V_76 ) )
continue;
F_60 ( V_71 , V_66 ) ;
}
}
...
V_146 -> args . V_125 = V_125 ;
V_146 -> args . V_148 = F_22 ( V_37 ) -> V_10 -> V_2 ;
V_146 -> args . V_36 = V_37 ;
V_146 -> args . V_49 = V_34 ;
V_146 -> V_43 = F_22 ( V_37 ) -> V_12 ;
V_25 = F_95 ( V_146 ) ;
V_4:
F_3 ( L_32 , V_5 , V_25 ) ;
return V_25 ;
...
F_5 ( & V_37 -> V_52 ) ;
V_34 = F_28 ( V_37 ) -> V_49 ;
if ( ! V_34 || ! F_35 ( V_151 , & V_34 -> V_60 ) ||
F_42 ( V_79 , & V_34 -> V_60 ) )
goto V_152;
F_62 (lseg, tmp, &lo->plh_segs, pls_list)
if ( F_42 ( V_153 , & V_71 -> V_76 ) ) {
F_61 ( V_71 , & V_92 ) ;
V_150 = true ;
}
if ( ! V_150 )
...
void F_101 ( struct V_36 * V_37 , T_1 V_154 )
{
struct V_33 * V_34 ;
F_5 ( & V_37 -> V_52 ) ;
V_34 = F_28 ( V_37 ) -> V_49 ;
if ( F_77 ( V_154 , V_34 -> V_124 ) )
V_34 -> V_124 = V_154 ;
F_7 ( & V_37 -> V_52 ) ;
}
bool F_102 ( struct V_36 * V_37 , T_1 * V_154 , struct V_155 * V_156 )
{
struct V_47 * V_48 = F_28 ( V_37 ) ;
struct V_33 * V_34 ;
struct V_70 * V_71 ;
...
if ( F_42 ( V_153 , & V_71 -> V_76 ) ) {
F_103 ( & F_22 ( V_37 ) -> V_80 , V_156 , NULL ) ;
V_150 = true ;
goto V_4;
}
V_34 = V_48 -> V_49 ;
V_157 = F_79 ( V_34 -> V_121 . V_122 ) ;
* V_154 = V_157 + F_55 ( & V_34 -> V_123 ) ;
V_4:
F_7 ( & V_37 -> V_52 ) ;
return V_150 ;
}
static T_5
F_104 ( struct V_61 * V_82 ,
struct V_61 * V_83 )
{
T_5 V_158 ;
V_158 = V_82 -> V_63 - V_83 -> V_63 ;
if ( V_158 )
return V_158 ;
V_158 = V_83 -> V_64 - V_82 -> V_64 ;
if ( V_158 )
return V_158 ;
return ( int ) ( V_82 -> V_53 == V_159 ) - ( int ) ( V_83 -> V_53 == V_159 ) ;
}
static void
F_105 ( struct V_33 * V_34 ,
struct V_70 * V_71 )
{
struct V_70 * V_160 ;
F_3 ( L_33 , V_5 ) ;
F_2 (lp, &lo->plh_segs, pls_list) {
if ( F_104 ( & V_71 -> V_97 , & V_160 -> V_97 ) > 0 )
continue;
F_106 ( & V_71 -> V_72 , & V_160 -> V_72 ) ;
F_3 ( L_34
L_35
L_36 ,
V_5 , V_71 , V_71 -> V_97 . V_53 ,
V_71 -> V_97 . V_63 , V_71 -> V_97 . V_64 ,
V_160 , V_160 -> V_97 . V_53 , V_160 -> V_97 . V_63 ,
V_160 -> V_97 . V_64 ) ;
goto V_4;
}
F_106 ( & V_71 -> V_72 , & V_34 -> V_78 ) ;
F_3 ( L_34
L_37 ,
V_5 , V_71 , V_71 -> V_97 . V_53 ,
V_71 -> V_97 . V_63 , V_71 -> V_97 . V_64 ) ;
...
F_45 ( & V_34 -> V_103 ) ;
V_34 -> V_41 = V_37 ;
V_34 -> V_45 = F_108 ( V_133 -> V_161 -> V_7 -> V_162 ) ;
return V_34 ;
}
static struct V_33 *
F_109 ( struct V_36 * V_37 ,
struct V_132 * V_133 ,
T_2 V_38 )
{
struct V_47 * V_48 = F_28 ( V_37 ) ;
...
goto V_163;
F_7 ( & V_37 -> V_52 ) ;
V_115 = F_107 ( V_37 , V_133 , V_38 ) ;
F_5 ( & V_37 -> V_52 ) ;
if ( F_110 ( V_48 -> V_49 == NULL ) ) {
V_48 -> V_49 = V_115 ;
return V_115 ;
} else if ( V_115 != NULL )
F_23 ( V_115 ) ;
...
static bool F_114 ( struct V_132 * V_133 ,
struct V_36 * V_37 , int V_53 )
{
struct V_166 * V_167 = V_133 -> V_168 ;
struct V_47 * V_48 = F_28 ( V_37 ) ;
T_6 V_169 = F_115 ( V_37 ) ;
...
if ( ! F_117 ( F_22 ( V_37 ) ) )
goto V_4;
if ( F_114 ( V_133 , V_37 , V_53 ) )
goto V_4;
F_5 ( & V_37 -> V_52 ) ;
V_34 = F_109 ( V_37 , V_133 , V_38 ) ;
if ( V_34 == NULL ) {
F_7 ( & V_37 -> V_52 ) ;
goto V_4;
}
...
if ( V_186 . V_64 != V_65 )
V_186 . V_64 = F_118 ( V_186 . V_64 ) ;
V_71 = F_86 ( V_34 , V_133 , & V_186 , V_38 ) ;
F_36 ( & V_34 -> V_123 ) ;
V_192:
F_29 ( V_34 ) ;
V_4:
...
struct V_70 *
F_120 ( struct V_134 * V_135 )
{
struct V_33 * V_34 = F_28 ( V_135 -> args . V_36 ) -> V_49 ;
struct V_195 * V_196 = & V_135 -> V_196 ;
struct V_70 * V_71 ;
struct V_36 * V_37 = V_34 -> V_41 ;
int V_25 = 0 ;
V_71 = F_22 ( V_37 ) -> V_10 -> V_28 ( V_34 , V_196 , V_135 -> V_38 ) ;
if ( ! V_71 || F_90 ( V_71 ) ) {
if ( ! V_71 )
V_25 = - V_140 ;
else
...
F_105 ( V_34 , V_71 ) ;
if ( V_196 -> V_198 ) {
F_48 ( V_153 , & V_71 -> V_76 ) ;
F_48 ( V_151 , & V_34 -> V_60 ) ;
}
F_7 ( & V_37 -> V_52 ) ;
return V_71 ;
V_4:
...
void
F_122 ( struct V_199 * V_200 , struct V_201 * V_202 )
{
T_3 V_203 = V_202 -> V_204 ;
F_123 ( V_200 -> V_205 != NULL ) ;
if ( V_202 -> V_206 != V_202 -> V_207 ) {
F_124 ( V_200 ) ;
return;
}
if ( V_200 -> V_208 == NULL )
V_203 = F_115 ( V_200 -> V_209 ) - F_125 ( V_202 ) ;
else
V_203 = F_126 ( V_200 -> V_208 ) ;
V_200 -> V_205 = F_116 ( V_200 -> V_209 ,
V_202 -> V_210 ,
F_125 ( V_202 ) ,
V_203 ,
V_159 ,
...
void
F_129 ( struct V_199 * V_200 , struct V_36 * V_36 ,
const struct V_213 * V_214 )
{
struct V_8 * V_14 = F_22 ( V_36 ) ;
struct V_1 * V_39 = V_14 -> V_10 ;
if ( V_39 == NULL )
F_130 ( V_200 , V_36 , V_214 ) ;
else
F_131 ( V_200 , V_36 , V_39 -> V_215 , V_214 , V_14 -> V_216 , 0 ) ;
}
void
F_132 ( struct V_199 * V_200 , struct V_36 * V_36 ,
int V_217 ,
const struct V_213 * V_214 )
{
struct V_8 * V_14 = F_22 ( V_36 ) ;
struct V_1 * V_39 = V_14 -> V_10 ;
if ( V_39 == NULL )
F_133 ( V_200 , V_36 , V_217 , V_214 ) ;
else
F_131 ( V_200 , V_36 , V_39 -> V_218 , V_214 , V_14 -> V_219 , V_217 ) ;
}
bool
F_134 ( struct V_199 * V_200 , struct V_201 * V_220 ,
struct V_201 * V_202 )
{
if ( V_200 -> V_205 == NULL )
return F_135 ( V_200 , V_220 , V_202 ) ;
return F_125 ( V_202 ) < F_56 ( V_200 -> V_205 -> V_97 . V_63 ,
V_200 -> V_205 -> V_97 . V_64 ) ;
}
int F_136 ( struct V_36 * V_36 ,
struct V_91 * V_66 ,
const struct V_213 * V_214 ,
struct V_221 * V_222 )
{
struct V_199 V_200 ;
F_38 ( V_223 ) ;
F_133 ( & V_200 , V_36 , V_224 , V_214 ) ;
V_200 . V_208 = V_222 ;
while ( ! F_24 ( V_66 ) ) {
struct V_201 * V_202 = F_137 ( V_66 -> V_94 ) ;
F_138 ( V_202 ) ;
if ( ! F_139 ( & V_200 , V_202 ) )
F_140 ( V_202 , & V_223 ) ;
}
F_141 ( & V_200 ) ;
if ( ! F_24 ( & V_223 ) ) {
...
if ( F_22 ( V_229 -> V_36 ) -> V_10 -> V_143 &
V_232 ) {
F_144 ( V_229 -> V_36 ) ;
}
if ( ! F_33 ( V_233 , & V_229 -> V_143 ) )
V_227 -> V_156 . V_234 = F_136 ( V_229 -> V_36 ,
& V_229 -> V_235 ,
V_229 -> V_236 ,
V_229 -> V_222 ) ;
}
void F_145 ( struct V_226 * V_227 )
{
struct V_228 * V_229 = V_227 -> V_230 ;
if ( ! V_229 -> V_231 ) {
F_146 ( V_227 ) ;
V_229 -> V_237 -> V_238 ( & V_227 -> V_156 , V_227 ) ;
} else
F_143 ( V_227 ) ;
V_229 -> V_237 -> V_239 ( V_227 ) ;
}
static void
F_147 ( struct V_199 * V_240 ,
struct V_226 * V_227 )
{
struct V_228 * V_229 = V_227 -> V_230 ;
if ( ! F_33 ( V_233 , & V_229 -> V_143 ) ) {
F_148 ( & V_229 -> V_235 , & V_240 -> V_241 ) ;
F_128 ( V_240 ) ;
V_240 -> V_242 = 1 ;
}
F_149 ( V_227 ) ;
...
static void
F_152 ( struct V_199 * V_240 , struct V_91 * V_66 , int V_247 )
{
struct V_226 * V_227 ;
...
while ( ! F_24 ( V_66 ) ) {
enum V_243 V_248 ;
V_227 = F_153 ( V_66 , struct V_226 , V_253 ) ;
F_25 ( & V_227 -> V_253 ) ;
V_248 = F_150 ( V_227 , V_246 , V_71 , V_247 ) ;
if ( V_248 == V_250 )
F_147 ( V_240 , V_227 ) ;
}
F_54 ( V_71 ) ;
}
static void F_154 ( struct V_228 * V_229 )
{
F_54 ( V_229 -> V_71 ) ;
F_155 ( V_229 ) ;
}
int
F_156 ( struct V_199 * V_240 )
{
struct V_254 * V_255 ;
struct V_228 * V_229 ;
int V_102 ;
...
V_229 = & V_255 -> V_230 ;
F_158 ( V_240 , V_229 , F_154 ) ;
V_229 -> V_71 = F_113 ( V_240 -> V_205 ) ;
F_15 ( & V_229 -> V_258 ) ;
V_102 = F_159 ( V_240 , V_229 ) ;
if ( V_102 != 0 ) {
F_54 ( V_240 -> V_205 ) ;
V_240 -> V_205 = NULL ;
} else
F_152 ( V_240 , & V_229 -> V_259 , V_240 -> V_260 ) ;
if ( F_9 ( & V_229 -> V_258 ) )
V_229 -> V_236 -> V_261 ( V_229 ) ;
return V_102 ;
}
int F_160 ( struct V_36 * V_36 ,
struct V_91 * V_66 ,
const struct V_213 * V_214 ,
struct V_221 * V_222 )
{
...
static void F_161 ( struct V_262 * V_227 )
{
struct V_228 * V_229 = V_227 -> V_230 ;
...
if ( ! F_33 ( V_233 , & V_229 -> V_143 ) )
V_227 -> V_156 . V_234 = F_160 ( V_229 -> V_36 ,
& V_229 -> V_235 ,
V_229 -> V_236 ,
V_229 -> V_222 ) ;
}
void F_162 ( struct V_262 * V_227 )
{
struct V_228 * V_229 = V_227 -> V_230 ;
if ( F_110 ( ! V_229 -> V_231 ) ) {
F_163 ( V_227 ) ;
V_229 -> V_237 -> V_238 ( & V_227 -> V_156 , V_227 ) ;
} else
F_161 ( V_227 ) ;
...
static void
F_167 ( struct V_199 * V_240 , struct V_91 * V_66 )
{
struct V_262 * V_227 ;
const struct V_245 * V_246 = V_240 -> V_252 ;
struct V_70 * V_71 = V_240 -> V_205 ;
...
while ( ! F_24 ( V_66 ) ) {
enum V_243 V_248 ;
V_227 = F_153 ( V_66 , struct V_262 , V_253 ) ;
F_25 ( & V_227 -> V_253 ) ;
V_248 = F_166 ( V_227 , V_246 , V_71 ) ;
if ( V_248 == V_250 )
F_164 ( V_240 , V_227 ) ;
}
F_54 ( V_71 ) ;
...
V_229 = & V_267 -> V_230 ;
F_158 ( V_240 , V_229 , F_168 ) ;
V_229 -> V_71 = F_113 ( V_240 -> V_205 ) ;
F_15 ( & V_229 -> V_258 ) ;
V_102 = F_172 ( V_240 , V_229 ) ;
if ( V_102 != 0 ) {
F_54 ( V_240 -> V_205 ) ;
V_240 -> V_205 = NULL ;
} else
F_167 ( V_240 , & V_229 -> V_259 ) ;
if ( F_9 ( & V_229 -> V_258 ) )
V_229 -> V_236 -> V_261 ( V_229 ) ;
return V_102 ;
}
static void F_173 ( struct V_36 * V_36 , struct V_91 * V_268 )
{
struct V_70 * V_71 ;
F_2 (lseg, &NFS_I(inode)->layout->plh_segs, pls_list) {
if ( V_71 -> V_97 . V_53 == V_54 &&
F_35 ( V_144 , & V_71 -> V_76 ) )
F_17 ( & V_71 -> V_73 , V_268 ) ;
}
}
static void F_174 ( struct V_36 * V_36 , struct V_91 * V_268 )
{
struct V_70 * V_71 , * V_27 ;
unsigned long * V_269 = & F_28 ( V_36 ) -> V_143 ;
...
bool V_273 = false ;
F_5 ( & V_36 -> V_52 ) ;
if ( ! F_33 ( V_142 , & V_48 -> V_143 ) ) {
V_273 = true ;
F_3 ( L_61 ,
V_5 , V_36 -> V_107 ) ;
}
if ( ! F_33 ( V_144 , & V_229 -> V_71 -> V_76 ) ) {
F_113 ( V_229 -> V_71 ) ;
}
...
void F_180 ( struct V_275 * V_227 )
{
struct V_8 * V_9 = F_22 ( V_227 -> args . V_36 ) ;
if ( V_9 -> V_10 -> V_276 )
V_9 -> V_10 -> V_276 ( V_227 ) ;
F_174 ( V_227 -> args . V_36 , & V_227 -> V_106 ) ;
}
int
F_98 ( struct V_36 * V_36 , bool V_277 )
{
struct V_275 * V_227 ;
struct V_47 * V_48 = F_28 ( V_36 ) ;
T_6 V_271 ;
...
if ( ! F_42 ( V_142 , & V_48 -> V_143 ) )
return 0 ;
V_227 = F_87 ( sizeof( * V_227 ) , V_212 ) ;
if ( ! V_227 ) {
V_25 = - V_140 ;
goto V_4;
}
if ( ! F_42 ( V_142 , & V_48 -> V_143 ) )
goto V_278;
if ( F_33 ( V_270 , & V_48 -> V_143 ) ) {
if ( ! V_277 ) {
V_25 = - V_104 ;
goto V_278;
}
V_25 = F_181 ( & V_48 -> V_143 , V_270 ,
V_279 , V_280 ) ;
if ( V_25 )
goto V_278;
}
...
F_5 ( & V_36 -> V_52 ) ;
if ( ! F_35 ( V_142 , & V_48 -> V_143 ) ) {
F_52 ( V_270 , & V_48 -> V_143 ) ;
F_7 ( & V_36 -> V_52 ) ;
F_177 ( & V_48 -> V_143 , V_270 ) ;
goto V_278;
}
F_173 ( V_36 , & V_227 -> V_106 ) ;
V_271 = V_48 -> V_49 -> V_274 ;
V_48 -> V_49 -> V_274 = 0 ;
F_80 ( & V_227 -> args . V_125 , & V_48 -> V_49 -> V_121 ) ;
F_7 ( & V_36 -> V_52 ) ;
V_227 -> args . V_36 = V_36 ;
V_227 -> V_281 = F_108 ( V_48 -> V_49 -> V_45 ) ;
F_182 ( & V_227 -> V_282 ) ;
V_227 -> args . V_283 = F_22 ( V_36 ) -> V_284 ;
V_227 -> V_196 . V_282 = & V_227 -> V_282 ;
V_227 -> args . V_285 = V_271 - 1 ;
V_227 -> V_196 . V_14 = F_22 ( V_36 ) ;
V_25 = F_183 ( V_227 , V_277 ) ;
V_4:
if ( V_25 )
F_179 ( V_36 ) ;
F_3 ( L_64 , V_5 , V_25 ) ;
...
struct V_166 * F_185 ( void )
{
struct V_166 * V_286 ;
V_286 = F_87 ( sizeof( * V_286 ) , V_212 ) ;
if ( ! V_286 ) {
F_3 ( L_65 , V_5 ) ;
return NULL ;
}
