...
V_11 = V_13 -> V_28 -> V_29 ( V_13 , V_2 ) ;
if ( V_11 ) {
F_9 ( V_15 , V_30 ) ;
goto error;
}
V_13 -> V_31 . V_32 += V_2 -> V_33 ;
V_13 -> V_31 . V_34 ++ ;
F_13 ( & V_13 -> V_22 ) ;
F_14 ( V_2 ) ;
...
F_16 ( V_2 , V_4 ) ;
V_13 = V_4 -> V_14 ;
} while ( V_13 && ! ( V_13 -> V_19 -> V_39 & V_40 ) );
V_11 = 0 ;
V_36:
return V_11 ;
error:
...
F_20 ( V_2 ) ;
V_11 = F_2 ( V_2 ) -> V_41 -> V_42 ( V_2 ) ;
if ( F_11 ( V_11 != 1 ) )
goto V_43;
if ( ! F_2 ( V_2 ) -> V_14 )
return F_21 ( V_2 ) ;
V_11 = F_22 ( F_2 ( V_2 ) -> V_41 -> V_44 ,
V_45 , V_2 ,
NULL , F_2 ( V_2 ) -> V_7 , V_46 ) ;
if ( F_11 ( V_11 != 1 ) )
goto V_43;
}
if ( V_11 == - V_35 )
...
{
struct V_52 * V_53 ;
if ( V_13 -> V_54 . V_44 == V_55 )
V_53 = F_32 ( V_13 ,
F_33 ( F_2 ( V_2 ) -> V_41 -> V_44 ) ) ;
else
V_53 = V_13 -> V_53 ;
if ( V_53 == NULL )
return - V_56 ;
return V_53 -> V_57 -> V_58 ( V_13 , V_2 ) ;
}
