...
[ V_123 ] = { L_21 , & V_114 , V_115 | V_116 } ,
[ V_124 ] = { L_22 , & V_114 , V_115 | V_110 } ,
[ V_125 ] = { L_23 , & V_114 , V_115 | V_110 } ,
#if F_77 ( V_126 ) || F_77 ( V_127 )
[ V_128 ] = { L_24 , & V_129 , V_110 } ,
#endif
#ifdef F_78
[ V_130 ] = { L_25 , & V_114 , V_115 | V_116 } ,
[ V_131 ] = { L_26 , & V_114 , V_115 | V_116 } ,
[ V_132 ] = { L_27 , & V_114 , V_115 | V_116 } ,
#endif
{ L_5 }
} ;
struct V_12 * V_12 = V_7 ;
int V_133 ;
V_133 = F_79 ( V_104 , 0x6e667364 , V_107 ) ;
if ( V_133 )
return V_133 ;
V_104 -> V_27 = F_80 ( V_12 ) ;
return 0 ;
}
static struct V_42 * F_81 ( struct V_134 * V_135 ,
int V_136 , const char * V_137 , void * V_7 )
{
return F_82 ( V_135 , V_136 , V_23 -> V_24 -> V_25 , F_76 ) ;
}
...
{
struct V_138 * V_139 ;
V_139 = F_87 ( L_28 , NULL ) ;
if ( ! V_139 )
return - V_54 ;
V_139 = F_88 ( L_13 , 0 , V_139 ,
& V_140 ) ;
if ( ! V_139 )
return - V_54 ;
return 0 ;
...
static T_7 int F_89 ( struct V_12 * V_12 )
{
int V_141 ;
struct V_16 * V_17 = F_11 ( V_12 , V_18 ) ;
V_141 = F_90 ( V_12 ) ;
...
static T_8 void F_93 ( struct V_12 * V_12 )
{
F_94 ( V_12 ) ;
F_92 ( V_12 ) ;
}
