...
static int F_77 ( struct V_36 * V_37 , struct V_176 * V_166 )
{
struct V_1 * V_2 = F_20 ( V_37 ) ;
return F_78 ( & V_2 -> V_98 , V_166 ) ;
}
static int F_79 ( struct V_36 * V_37 , struct V_176 * V_166 )
{
struct V_1 * V_2 = F_20 ( V_37 ) ;
...
static int F_101 ( struct V_222 * V_223 , T_8 V_224 )
{
struct V_1 * V_2 = F_102 ( & V_223 -> V_37 ) ;
struct V_36 * V_37 = V_2 -> V_18 ;
if ( F_23 ( V_37 ) ) {
F_103 ( V_37 ) ;
F_54 ( V_37 ) ;
...
static int F_106 ( struct V_222 * V_223 )
{
struct V_36 * V_225 ;
struct V_1 * V_2 ;
int V_12 ;
...
F_108 ( & V_2 -> V_39 ) ;
F_109 ( & V_2 -> V_145 ) ;
F_110 ( & V_2 -> V_113 , F_47 ) ;
F_110 ( & V_2 -> V_142 , F_63 ) ;
F_111 ( & V_2 -> V_10 ) ;
F_112 ( & V_2 -> V_7 , & V_2 -> V_10 ) ;
F_111 ( & V_2 -> V_27 ) ;
F_112 ( & V_2 -> V_28 [ 0 ] , & V_2 -> V_27 ) ;
F_112 ( & V_2 -> V_28 [ 1 ] , & V_2 -> V_27 ) ;
V_2 -> V_197 . V_103 = V_2 ;
V_2 -> V_197 . V_229 = V_230 ;
V_2 -> V_197 . V_231 = F_85 ;
V_2 -> V_197 . V_232 = F_86 ;
V_2 -> V_98 . V_37 = V_225 ;
V_2 -> V_98 . V_233 = 1 ,
V_2 -> V_98 . V_234 = 1 ;
V_2 -> V_98 . V_235 = 0xf ;
V_2 -> V_98 . V_236 = F_97 ;
V_2 -> V_98 . V_237 = F_98 ;
F_113 ( & V_223 -> V_37 , L_24 , V_174 ) ;
V_2 -> V_174 = F_114 ( V_174 , ( V_238 |
V_239 |
V_240 ) ) ;
F_115 ( & V_2 -> V_115 ) ;
F_116 ( V_225 , & V_241 ) ;
F_117 ( V_225 , & V_223 -> V_37 ) ;
F_118 ( & V_223 -> V_37 , V_2 ) ;
V_225 -> V_242 = V_243 ;
V_225 -> V_244 = & V_245 ;
V_225 -> V_70 = V_223 -> V_70 ;
F_15 ( V_2 , V_246 ) ;
V_226 = F_10 ( V_2 , V_247 ) ;
if ( ( V_226 & ~ V_248 ) != V_249 ) {
F_40 ( & V_223 -> V_37 , L_25 ) ;
V_12 = - V_250 ;
goto V_251;
}
...
F_99 ( V_2 ) ;
F_26 ( V_2 ) ;
V_12 = F_119 ( V_223 -> V_70 , NULL , F_39 ,
V_254 | V_255 ,
V_225 -> V_256 , V_2 ) ;
if ( V_12 < 0 ) {
F_40 ( & V_223 -> V_37 , L_26 ) ;
goto V_257;
}
V_12 = F_120 ( V_225 ) ;
if ( V_12 ) {
F_40 ( & V_223 -> V_37 , L_27 ) ;
goto V_258;
}
F_121 ( V_225 , L_28 ,
F_122 ( V_226 ) , V_225 -> V_42 , V_225 -> V_70 ,
V_2 -> V_44 & V_45 ? L_29 : L_30 ) ;
return 0 ;
V_258:
F_123 ( V_225 -> V_70 , V_2 ) ;
V_251:
V_257:
F_124 ( V_225 ) ;
return V_12 ;
...
{
struct V_1 * V_259 = F_102 ( & V_223 -> V_37 ) ;
if ( F_126 ( V_259 ) )
F_113 ( & V_223 -> V_37 , L_31 ) ;
F_127 ( V_259 -> V_18 ) ;
F_123 ( V_223 -> V_70 , V_259 ) ;
F_124 ( V_259 -> V_18 ) ;
return 0 ;
}
