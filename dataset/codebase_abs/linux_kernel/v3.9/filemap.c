...
struct V_99 * V_99 = F_156 ( V_154 -> V_160 ) ;
int V_20 = V_170 ;
F_157 ( V_99 -> V_172 ) ;
F_158 ( V_154 -> V_160 ) ;
F_106 ( V_1 ) ;
if ( V_1 -> V_3 != V_99 -> V_173 ) {
F_81 ( V_1 ) ;
V_20 = V_174 ;
goto V_58;
}
...
int F_162 ( struct V_90 * V_90 , struct V_153 * V_154 )
{
struct V_2 * V_3 = V_90 -> V_98 ;
if ( ! V_3 -> V_12 -> V_119 )
return - V_175 ;
...
int F_163 ( struct V_90 * V_90 , struct V_153 * V_154 )
{
if ( ( V_154 -> V_178 & V_179 ) && ( V_154 -> V_178 & V_180 ) )
return - V_140 ;
return F_162 ( V_90 , V_154 ) ;
}
int F_162 ( struct V_90 * V_90 , struct V_153 * V_154 )
{
return - V_181 ;
...
static struct V_1 * F_164 ( struct V_2 * V_3 ,
T_2 V_5 ,
int (* F_165)( void * , struct V_1 * ) ,
void * V_182 ,
T_3 V_59 )
{
struct V_1 * V_1 ;
...
int V_47 ;
V_184:
V_1 = F_164 ( V_3 , V_5 , F_165 , V_182 , V_59 ) ;
if ( F_168 ( V_1 ) )
return V_1 ;
if ( F_2 ( V_1 ) )
goto V_58;
...
void * V_182 )
{
return F_167 ( V_3 , V_5 , F_165 , V_182 , F_117 ( V_3 ) ) ;
}
static struct V_1 * F_170 ( struct V_1 * V_1 )
{
if ( ! F_168 ( V_1 ) ) {
F_95 ( V_1 ) ;
if ( ! F_2 ( V_1 ) ) {
...
T_3 V_59 )
{
T_9 * F_165 = ( T_9 * ) V_3 -> V_12 -> V_119 ;
return F_170 ( F_167 ( V_3 , V_5 , F_165 , NULL , V_59 ) ) ;
}
...
void * V_182 )
{
return F_170 ( F_169 ( V_3 , V_5 , F_165 , V_182 ) ) ;
}
static T_8 F_173 ( char * V_185 ,
const struct V_131 * V_132 , T_8 V_186 , T_8 V_187 )
{
T_8 V_188 = 0 , V_125 = 0 ;
while ( V_187 ) {
char T_10 * V_127 = V_132 -> V_141 + V_186 ;
int V_189 = F_36 ( V_187 , V_132 -> V_138 - V_186 ) ;
V_186 = 0 ;
V_125 = F_174 ( V_185 , V_127 , V_189 ) ;
V_188 += V_189 ;
V_187 -= V_189 ;
V_185 += V_189 ;
V_132 ++ ;
...
struct V_190 * V_38 , unsigned long V_55 , T_8 V_187 )
{
char * V_124 ;
T_8 V_188 ;
F_9 ( ! F_176 () ) ;
...
int V_125 ;
char T_10 * V_127 = V_38 -> V_132 -> V_141 + V_38 -> V_191 ;
V_125 = F_174 ( V_124 + V_55 , V_127 , V_187 ) ;
V_188 = V_187 - V_125 ;
} else {
V_188 = F_173 ( V_124 + V_55 ,
V_38 -> V_132 , V_38 -> V_191 , V_187 ) ;
}
F_134 ( V_124 ) ;
return V_188 ;
}
...
int V_125 ;
char T_10 * V_127 = V_38 -> V_132 -> V_141 + V_38 -> V_191 ;
V_125 = F_178 ( V_124 + V_55 , V_127 , V_187 ) ;
V_188 = V_187 - V_125 ;
} else {
V_188 = F_173 ( V_124 + V_55 ,
V_38 -> V_132 , V_38 -> V_191 , V_187 ) ;
...
void F_179 ( struct V_190 * V_38 , T_8 V_187 )
{
F_9 ( V_38 -> V_106 < V_187 ) ;
if ( F_56 ( V_38 -> V_133 == 1 ) ) {
V_38 -> V_191 += V_187 ;
V_38 -> V_106 -= V_187 ;
} else {
const struct V_131 * V_132 = V_38 -> V_132 ;
T_8 V_186 = V_38 -> V_191 ;
unsigned long V_133 = V_38 -> V_133 ;
while ( V_187 || F_100 ( V_38 -> V_106 && ! V_132 -> V_138 ) ) {
int V_189 ;
V_189 = F_36 ( V_187 , V_132 -> V_138 - V_186 ) ;
F_9 ( ! V_38 -> V_106 || V_38 -> V_106 < V_189 ) ;
V_38 -> V_106 -= V_189 ;
V_187 -= V_189 ;
V_186 += V_189 ;
if ( V_132 -> V_138 == V_186 ) {
V_132 ++ ;
V_133 -- ;
V_186 = 0 ;
}
...
int F_180 ( struct V_190 * V_38 , T_8 V_187 )
{
char T_10 * V_127 = V_38 -> V_132 -> V_141 + V_38 -> V_191 ;
V_187 = F_36 ( V_187 , V_38 -> V_132 -> V_138 - V_38 -> V_191 ) ;
return F_181 ( V_127 , V_187 ) ;
}
T_8 F_182 ( const struct V_190 * V_38 )
{
const struct V_131 * V_132 = V_38 -> V_132 ;
if ( V_38 -> V_133 == 1 )
return V_38 -> V_106 ;
else
return F_36 ( V_38 -> V_106 , V_132 -> V_138 - V_38 -> V_191 ) ;
}
inline int F_183 ( struct V_90 * V_90 , T_1 * V_144 , T_8 * V_106 , int V_192 )
{
struct V_99 * V_99 = V_90 -> V_98 -> V_46 ;
unsigned long V_193 = F_184 ( V_194 ) ;
if ( F_100 ( * V_144 < 0 ) )
return - V_140 ;
if ( ! V_192 ) {
if ( V_90 -> V_149 & V_195 )
...
if ( * V_106 > V_193 - ( F_186 ( V_193 ) ) * V_144 ) {
* V_106 = V_193 - ( F_186 ( V_193 ) ) * V_144 ;
}
}
}
if ( F_100 ( * V_144 + * V_106 > V_199 &&
! ( V_90 -> V_149 & V_200 ) ) ) {
if ( * V_144 >= V_199 ) {
return - V_198 ;
}
if ( * V_106 > V_199 - ( unsigned long ) * V_144 ) {
* V_106 = V_199 - ( unsigned long ) * V_144 ;
}
}
if ( F_56 ( ! V_192 ) ) {
if ( F_100 ( * V_144 >= V_99 -> V_172 -> V_201 ) ) {
if ( * V_106 || * V_144 > V_99 -> V_172 -> V_201 ) {
return - V_198 ;
}
}
if ( F_100 ( * V_144 + * V_106 > V_99 -> V_172 -> V_201 ) )
* V_106 = V_99 -> V_172 -> V_201 - * V_144 ;
} else {
#ifdef F_187
T_1 V_109 ;
if ( F_188 ( F_189 ( V_99 ) ) )
...
int F_190 ( struct V_90 * V_90 , struct V_2 * V_3 ,
...
int F_191 ( struct V_90 * V_90 , struct V_2 * V_3 ,
T_1 V_144 , unsigned V_203 , unsigned V_188 ,
struct V_1 * V_1 , void * V_204 )
{
const struct V_205 * V_206 = V_3 -> V_12 ;
F_125 ( V_1 ) ;
return V_206 -> V_208 ( V_90 , V_3 , V_144 , V_203 , V_188 , V_1 , V_204 ) ;
}
V_139
F_192 ( struct V_142 * V_143 , const struct V_131 * V_132 ,
...
T_2 V_18 ;
if ( V_106 != V_209 )
* V_133 = F_193 ( (struct V_131 * ) V_132 , * V_133 , V_106 ) ;
...
V_130 = V_3 -> V_12 -> V_151 ( V_212 , V_143 , V_132 , V_144 , * V_133 ) ;
if ( V_3 -> V_6 ) {
F_194 ( V_3 ,
V_144 >> V_32 , V_18 ) ;
}
if ( V_130 > 0 ) {
V_144 += V_130 ;
if ( V_144 > F_43 ( V_99 ) && ! F_195 ( V_99 -> V_213 ) ) {
F_196 ( V_99 , V_144 ) ;
F_197 ( V_99 ) ;
}
* V_95 = V_144 ;
...
struct V_1 * F_198 ( struct V_2 * V_3 ,
...
static V_139 F_199 ( struct V_90 * V_90 ,
struct V_190 * V_38 , T_1 V_144 )
{
struct V_2 * V_3 = V_90 -> V_98 ;
...
void * V_204 ;
V_55 = ( V_144 & ( V_105 - 1 ) ) ;
V_187 = F_202 (unsigned long, PAGE_CACHE_SIZE - offset,
iov_iter_count(i)) ;
V_221:
if ( F_100 ( F_180 ( V_38 , V_187 ) ) ) {
V_214 = - V_129 ;
break;
}
V_214 = V_12 -> V_207 ( V_90 , V_3 , V_144 , V_187 , V_42 ,
& V_1 , & V_204 ) ;
if ( F_100 ( V_214 ) )
break;
if ( F_123 ( V_3 ) )
F_124 ( V_1 ) ;
F_203 () ;
V_188 = F_175 ( V_1 , V_38 , V_55 , V_187 ) ;
F_204 () ;
F_124 ( V_1 ) ;
F_125 ( V_1 ) ;
V_214 = V_12 -> V_208 ( V_90 , V_3 , V_144 , V_187 , V_188 ,
V_1 , V_204 ) ;
if ( F_100 ( V_214 < 0 ) )
break;
V_188 = V_214 ;
...
V_139
F_207 ( struct V_142 * V_143 , const struct V_131 * V_132 ,
unsigned long V_133 , T_1 V_144 , T_1 * V_95 ,
...
V_139 V_214 ;
struct V_190 V_38 ;
F_208 ( & V_38 , V_132 , V_133 , V_106 , V_130 ) ;
V_214 = F_199 ( V_90 , & V_38 , V_144 ) ;
if ( F_56 ( V_214 >= 0 ) ) {
V_130 += V_214 ;
* V_95 = V_144 + V_214 ;
}
...
V_15 -> V_10 = V_3 -> V_10 ;
V_130 = 0 ;
V_47 = F_183 ( V_90 , & V_144 , & V_106 , F_195 ( V_99 -> V_213 ) ) ;
if ( V_47 )
goto V_58;
if ( V_106 == 0 )
goto V_58;
...
T_1 V_223 ;
V_139 V_224 ;
V_130 = F_192 ( V_143 , V_132 , & V_133 , V_144 ,
V_95 , V_106 , V_209 ) ;
if ( V_130 < 0 || V_130 == V_106 )
goto V_58;
V_144 += V_130 ;
V_106 -= V_130 ;
V_224 = F_207 ( V_143 , V_132 ,
...
V_223 = V_144 + V_224 - V_130 - 1 ;
V_47 = F_45 ( V_90 -> V_98 , V_144 , V_223 ) ;
if ( V_47 == 0 ) {
V_130 = V_224 ;
F_211 ( V_3 ,
V_144 >> V_32 ,
...
V_139 F_212 ( struct V_142 * V_143 , const struct V_131 * V_132 ,
unsigned long V_133 , T_1 V_144 )
{
struct V_90 * V_90 = V_143 -> V_145 ;
struct V_99 * V_99 = V_90 -> V_98 -> V_46 ;
...
F_213 ( V_99 -> V_172 ) ;
F_214 ( & V_99 -> V_225 ) ;
V_20 = F_209 ( V_143 , V_132 , V_133 , & V_143 -> V_147 ) ;
F_215 ( & V_99 -> V_225 ) ;
if ( V_20 > 0 || V_20 == - V_226 ) {
V_139 V_47 ;
V_47 = F_216 ( V_90 , V_144 , V_20 ) ;
if ( V_47 < 0 && V_20 > 0 )
V_20 = V_47 ;
}
F_217 ( V_99 -> V_172 ) ;
...
int F_218 ( struct V_1 * V_1 , T_3 V_53 )
{
struct V_2 * const V_3 = V_1 -> V_3 ;
F_9 ( ! F_17 ( V_1 ) ) ;
if ( F_219 ( V_1 ) )
return 0 ;
if ( V_3 && V_3 -> V_12 -> V_227 )
return V_3 -> V_12 -> V_227 ( V_1 , V_53 ) ;
return F_220 ( V_1 ) ;
}
