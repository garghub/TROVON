...
F_25 ( struct V_6 * V_7 )
{
static const int V_108 [ 4 ] = { 10 , 20 , 55 , 110 } ;
struct V_38 * V_39 ;
int V_4 , V_127 ;
V_39 = V_7 -> V_121 -> V_124 -> V_125 [ V_128 ] ;
if ( ! V_39 )
return;
for ( V_4 = 0 , V_127 = 0 ; V_4 < V_39 -> V_110 ; V_4 ++ ) {
struct V_94 * V_95 = & V_39 -> V_108 [ V_4 ] ;
if ( V_95 -> V_52 & V_97 )
continue;
for ( V_127 = 0 ; V_127 < F_26 ( V_108 ) ; V_127 ++ ) {
if ( V_95 -> V_98 != V_108 [ V_127 ] )
continue;
V_7 -> V_129 [ V_127 ] = V_4 ;
break;
}
...
static void *
F_27 ( struct V_120 * V_121 , struct V_130 * V_131 )
{
struct V_6 * V_7 ;
V_7 = F_21 ( sizeof( struct V_6 ) , V_132 ) ;
if ( ! V_7 )
return NULL ;
V_7 -> V_116 = 15 ;
V_7 -> V_117 = 1023 ;
