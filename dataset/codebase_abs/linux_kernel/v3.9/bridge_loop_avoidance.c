...
struct V_48 * V_49 ;
int V_38 ;
V_123 = F_5 ( V_122 , struct V_123 , V_122 ) ;
V_125 = F_5 ( V_123 , struct V_124 , V_122 ) ;
V_24 = F_5 ( V_125 , struct V_23 , V_26 ) ;
V_49 = F_27 ( V_24 ) ;
if ( ! V_49 )
goto V_61;
F_69 ( V_24 , V_49 , 0 ) ;
...
V_138 %= V_132 ;
V_78 = & V_24 -> V_26 . V_133 [ V_138 ] ;
if ( F_68 ( V_78 -> V_129 ,
V_131 ) )
break;
if ( V_78 -> V_41 != V_41 )
continue;
if ( F_6 ( V_78 -> V_16 , V_140 -> V_16 ) )
continue;
V_103 = 1 ;
goto V_61;
}
...
V_78 -> V_41 = V_41 ;
V_78 -> V_129 = V_76 ;
memcpy ( V_78 -> V_16 , V_140 -> V_16 , V_36 ) ;
...
struct V_79 * V_80 , int V_143 )
{
struct V_47 * V_47 ;
struct V_99 * V_100 ;
struct V_12 * V_19 ;
short V_7 = - 1 ;
if ( ! F_50 ( & V_80 -> V_24 -> V_126 ) )
return 0 ;
if ( ! F_65 ( V_46 , V_143 + V_62 ) )
return 0 ;
V_47 = (struct V_47 * ) ( ( ( T_2 * ) V_46 -> V_1 ) + V_143 ) ;
if ( F_57 ( V_47 -> V_104 ) == V_105 ) {
if ( ! F_65 ( V_46 , V_143 + sizeof( struct V_99 ) ) )
return 0 ;
V_100 = (struct V_99 * ) ( V_46 -> V_1 + V_143 ) ;
V_7 = F_57 ( V_100 -> V_106 ) & V_107 ;
}
V_19 = F_20 ( V_80 -> V_24 ,
V_80 -> V_16 , V_7 ) ;
