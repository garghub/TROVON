...
F_75 ( V_133 , V_129 , V_128 ) ;
F_76 ( V_133 -> V_134 . V_135 ,
F_77 ( & V_133 -> V_8 ) , V_129 , V_128 ) ;
}
static T_4 F_78 ( T_2 V_65 , T_7 V_136 ,
void * V_137 , void * * V_138 )
{
struct V_139 * V_140 ;
if ( F_79 ( F_80 ( V_65 , & V_140 ) ) ) {
F_46 ( L_34 ,
...
static void F_81 ( struct V_31 * V_87 ,
struct V_93 * V_143 )
{
...
static int F_102 ( struct V_87 * V_8 )
{
struct V_109 * V_110 ;
T_2 V_65 ;
...
if ( F_79 ( F_103 ( V_97 , L_49 ,
& V_65 ) ) ) {
int V_96 = 1 ;
if ( F_45 ( V_97 , L_49 , & V_96 , NULL ) )
F_13 ( L_50 ) ;
}
if ( F_79 ( F_103 ( V_97 , L_14 ,
& V_65 ) ) )
F_99 () ;
return 0 ;
}
...
static int F_106 ( void * V_127 , bool V_149 )
{
int V_68 ;
...
static int F_107 ( struct V_31 * V_87 ,
enum V_152 V_153 )
{
int V_154 = 0 ;
struct V_155 * V_156 ;
...
V_156 = F_108 ( V_39 , & V_87 -> V_8 , type ,
& V_168 , ( void * ) V_153 ) ;
if ( ! V_156 )
return - V_37 ;
...
static int F_88 ( struct V_31 * V_87 ,
unsigned int V_65 )
{
T_3 V_104 ;
int V_32 ;
...
V_169 -> V_172 . V_89 . V_39 = L_58 ;
V_169 -> V_172 . V_89 . V_100 = V_101 | V_173 ;
V_169 -> V_172 . V_102 = F_116 ;
V_169 -> V_172 . V_174 = F_114 ;
F_53 ( & V_169 -> V_175 . V_89 ) ;
V_169 -> V_175 . V_89 . V_39 = L_59 ;
V_169 -> V_175 . V_89 . V_100 = V_101 | V_173 ;
V_169 -> V_175 . V_102 = F_119 ;
V_169 -> V_175 . V_174 = F_118 ;
...
V_182 -> V_185 [ 0 ] . V_102 = F_121 ;
V_182 -> V_185 [ 0 ] . V_174 = F_120 ;
...
static int F_123 ( unsigned short V_100 )
{
unsigned int V_68 ;
...
V_187 -> V_194 . V_102 = F_125 ;
F_53 ( & V_187 -> V_172 . V_89 ) ;
V_187 -> V_172 . V_89 . V_39 = L_67 ;
V_187 -> V_172 . V_89 . V_100 = V_101 | V_173 ;
V_187 -> V_172 . V_102 = F_127 ;
V_187 -> V_172 . V_174 = F_126 ;
...
{
unsigned int V_68 ;
if ( F_58 ( V_200 -> V_65 , 0x0100 , & V_68 ) )
return - V_112 ;
switch ( V_200 -> V_65 ) {
case 0x0146 :
...
if ( V_196 < 0 )
return V_196 ;
return snprintf ( V_82 , V_92 , L_63 , V_196 ? L_72 : L_73 ) ;
}
...
V_200 -> V_89 . V_89 . V_39 = L_74 ;
V_200 -> V_89 . V_89 . V_100 = V_101 ;
V_200 -> V_89 . V_102 = F_130 ;
...
return - V_37 ;
F_53 ( & V_205 -> V_89 ) ;
V_205 -> V_89 . V_39 = L_76 ;
V_205 -> V_89 . V_100 = V_101 | V_173 ;
V_205 -> V_102 = F_132 ;
V_205 -> V_174 = F_131 ;
...
V_206 -> V_89 . V_89 . V_39 = L_77 ;
V_206 -> V_89 . V_89 . V_100 = V_101 | V_173 ;
V_206 -> V_89 . V_102 = F_134 ;
V_206 -> V_89 . V_174 = F_133 ;
...
static int F_141 ( struct V_31 * V_87 )
{
T_4 V_72 ;
int V_68 = 0 ;
T_2 V_65 ;
struct V_109 * V_110 ;
F_71 ( L_82 , V_221 , V_222 ) ;
V_133 = V_87 ;
strcpy ( F_142 ( V_87 ) , L_83 ) ;
V_97 = V_87 -> V_65 ;
V_68 = F_143 ( V_87 ) ;
...
static int F_146 ( struct V_31 * V_87 )
{
struct V_109 * V_110 ;
F_139 () ;
V_133 = NULL ;
...
static T_1 F_147 ( T_1 V_8 )
{
T_1 V_230 , V_231 ;
F_148 ( F_149 ( V_232 . V_233 -> V_234 . V_235 + 4 ) & 2 ,
V_236 ) ;
F_150 ( V_8 , V_232 . V_233 -> V_234 . V_235 + 4 ) ;
V_230 = F_149 ( V_232 . V_233 -> V_234 . V_235 + 4 ) ;
V_231 = F_149 ( V_232 . V_233 -> V_234 . V_235 ) ;
F_13 ( L_92 , V_8 , ( V_231 << 8 ) | V_230 ) ;
return V_231 ;
}
static T_1 F_151 ( T_1 V_8 , T_1 V_237 )
{
T_1 V_230 ;
F_148 ( F_149 ( V_232 . V_233 -> V_234 . V_235 + 4 ) & 2 ,
V_236 ) ;
...
F_148 ( F_149 ( V_232 . V_233 -> V_234 . V_235 + 4 ) & 2 ,
V_236 ) ;
F_150 ( V_237 , V_232 . V_233 -> V_234 . V_235 ) ;
V_230 = F_149 ( V_232 . V_233 -> V_234 . V_235 ) ;
F_13 ( L_93 , V_8 , V_237 , V_230 ) ;
return V_230 ;
}
static T_1 F_152 ( T_1 V_8 , T_1 V_237 , T_1 V_80 )
{
T_1 V_230 ;
F_148 ( F_149 ( V_232 . V_233 -> V_234 . V_235 + 4 ) & 2 , V_236 ) ;
F_150 ( V_8 , V_232 . V_233 -> V_234 . V_235 + 4 ) ;
F_148 ( F_149 ( V_232 . V_233 -> V_234 . V_235 + 4 ) & 2 , V_236 ) ;
F_150 ( V_237 , V_232 . V_233 -> V_234 . V_235 ) ;
F_148 ( F_149 ( V_232 . V_233 -> V_234 . V_235 + 4 ) & 2 , V_236 ) ;
F_150 ( V_80 , V_232 . V_233 -> V_234 . V_235 ) ;
V_230 = F_149 ( V_232 . V_233 -> V_234 . V_235 ) ;
F_13 ( L_94 ,
V_8 , V_237 , V_80 , V_230 ) ;
return V_230 ;
}
static int F_153 ( const T_1 V_238 , const T_1 V_239 )
{
if ( V_238 == 0x31 ) {
...
static void F_154 ( struct V_240 * V_8 )
{
struct V_241 * V_242 ;
V_242 = F_155 ( V_243 ,
V_244 , NULL ) ;
...
for ( V_270 = 0 ; V_270 < 100 && F_151 ( 0x91 , 0x1 ) ; V_270 ++ )
F_160 ( 10 ) ;
F_147 ( 0x93 ) ;
...
F_148 ( F_152 ( 0x90 , V_271 ,
0x5a ) ,
V_267 ) ;
V_232 . V_268 = 1 ;
return 0 ;
}
int F_161 ( int V_272 , T_1 V_67 )
{
if ( ! V_264 )
return - V_112 ;
F_162 ( & V_232 . V_273 ) ;
...
break;
case V_275 :
F_148 ( F_152 ( 0x90 , V_276 , V_67 ) ,
V_267 ) ;
break;
case V_277 :
F_148 ( F_152 ( 0x90 , V_278 , V_67 ) ,
V_267 ) ;
break;
case V_279 :
F_148 ( F_152 ( 0x90 , V_280 , V_67 ) ,
V_267 ) ;
break;
case V_281 :
F_148 ( F_152 ( 0x90 , V_282 , V_67 ) ,
V_267 ) ;
break;
case V_283 :
F_148 ( F_152 ( 0x90 , V_284 , V_67 ) ,
V_267 ) ;
break;
case V_285 :
F_148 ( F_152 ( 0x90 , V_265 , V_67 ) ,
V_267 ) ;
break;
case V_286 :
F_148 ( F_152 ( 0x90 , V_287 , V_67 ) ,
V_267 ) ;
break;
default:
F_20 ( L_98 , V_272 ) ;
...
static T_6 F_169 ( struct V_87 * V_8 ,
struct V_88 * V_89 , char * V_82 )
{
T_6 V_77 = 0 ;
F_162 ( & V_232 . V_273 ) ;
...
static int F_170 ( unsigned long V_67 )
{
return F_171 ( V_291 , V_67 ) ;
}
static int F_172 ( T_1 * V_67 )
{
return F_173 ( V_291 , V_67 ) ;
}
...
static T_6 F_175 ( struct V_87 * V_8 ,
struct V_88 * V_89 , char * V_82 )
{
T_1 V_67 = 0 ;
if ( F_172 ( & V_67 ) )
...
static int F_176 ( int V_292 , struct V_293 * V_294 , int V_295 )
{
return F_177 ( V_292 , V_294 , V_295 , & V_296 . V_297 ) ;
}
...
static int F_179 ( struct V_298 * V_298 , struct V_293 * V_293 )
{
unsigned long V_4 ;
F_2 ( & V_296 . V_6 , V_4 ) ;
if ( F_180 ( & V_296 . V_299 ) == 1 )
F_181 ( & V_296 . V_7 ) ;
F_9 ( & V_296 . V_6 , V_4 ) ;
return 0 ;
}
static T_6 F_182 ( struct V_293 * V_293 , char T_8 * V_300 ,
T_5 V_77 , T_9 * V_196 )
{
T_6 V_57 ;
unsigned char V_301 ;
...
( V_293 -> V_302 & V_303 ) )
return - V_304 ;
V_57 = F_183 ( V_296 . V_305 ,
F_6 ( & V_296 . V_7 ) != 0 ) ;
if ( V_57 )
return V_57 ;
while ( V_57 < V_77 &&
( F_184 ( & V_296 . V_7 , & V_301 , sizeof( V_301 ) ,
& V_296 . V_6 ) == sizeof( V_301 ) ) ) {
if ( F_185 ( V_301 , V_300 ++ ) )
return - V_306 ;
V_57 ++ ;
}
if ( V_57 > 0 ) {
struct V_298 * V_298 = F_186 ( V_293 ) ;
V_298 -> V_307 = F_187 ( V_298 -> V_308 ) ;
}
return V_57 ;
}
static unsigned int F_188 ( struct V_293 * V_293 , T_10 * V_309 )
{
F_189 ( V_293 , & V_296 . V_305 , V_309 ) ;
if ( F_6 ( & V_296 . V_7 ) )
return V_310 | V_311 ;
return 0 ;
}
static int F_190 ( T_1 V_312 , T_11 * V_67 )
{
T_1 V_313 , V_314 ;
if ( F_173 ( V_312 , & V_313 ) )
return - 1 ;
if ( F_173 ( V_312 + 1 , & V_314 ) )
return - 1 ;
* V_67 = V_313 | ( V_314 << 8 ) ;
return 0 ;
}
static long F_191 ( struct V_293 * V_315 , unsigned int V_181 ,
unsigned long V_96 )
{
int V_57 = 0 ;
...
V_317 = ( ( V_67 & 0xff ) - 1 ) << 5 ;
if ( F_192 ( V_316 , & V_317 , sizeof( V_317 ) ) )
V_57 = - V_306 ;
break;
case V_320 :
if ( V_217 . V_8 == NULL ) {
...
if ( F_193 ( & V_317 , V_316 , sizeof( V_317 ) ) ) {
V_57 = - V_306 ;
break;
}
V_67 = ( V_317 >> 5 ) + 1 ;
...
break;
case V_321 :
if ( F_190 ( V_322 , & V_318 ) ) {
V_57 = - V_112 ;
break;
}
if ( F_192 ( V_316 , & V_318 , sizeof( V_318 ) ) )
V_57 = - V_306 ;
break;
case V_323 :
if ( F_190 ( V_324 , & V_318 ) ) {
V_57 = - V_112 ;
break;
}
if ( F_192 ( V_316 , & V_318 , sizeof( V_318 ) ) )
...
static void F_194 ( T_1 V_12 )
{
F_15 ( & V_296 . V_7 , ( unsigned char * ) & V_12 ,
sizeof( V_12 ) , & V_296 . V_6 ) ;
F_195 ( & V_296 . V_297 , V_337 , V_338 ) ;
F_196 ( & V_296 . V_305 ) ;
}
...
static int F_197 ( void ) { return 0 ; }
static void F_200 ( void ) { }
static void F_194 ( T_1 V_12 ) { }
static T_4
F_202 ( struct V_341 * V_342 , void * V_137 )
{
T_7 V_32 ;
...
struct V_344 * V_345 =
F_204 ( & V_8 -> V_348 , struct V_344 , V_347 ) ;
if ( ! V_363 ) {
F_13 ( L_103 ) ;
return V_142 ;
}
...
{
T_4 V_57 = F_43 ( V_87 -> V_65 , L_114 , NULL ,
NULL ) ;
...
V_239 = F_149 ( V_8 -> V_233 -> V_234 . V_235 ) ;
if ( V_8 -> V_233 -> V_365 . V_235 )
V_238 = F_149 ( V_8 -> V_233 -> V_365 . V_235 ) ;
else
V_238 = F_149 ( V_8 -> V_233 -> V_234 . V_235 +
V_8 -> V_247 ) ;
F_13 ( L_117 ,
...
V_384:
F_10 ( V_380 ) ;
F_75 ( V_8 -> V_385 , 1 , V_380 ) ;
F_194 ( V_380 ) ;
return V_381 ;
}
static int F_210 ( struct V_31 * V_87 )
{
struct V_344 * V_363 , * V_386 ;
struct V_354 * V_353 , * V_387 ;
if ( F_207 ( V_87 ) ) {
F_20 ( L_119 ) ;
return - V_372 ;
}
F_211 ( V_232 . V_388 -> V_353 . V_357 [ 0 ] , & V_232 ) ;
F_212 ( V_232 . V_233 -> V_234 . V_235 ,
V_232 . V_233 -> V_234 . V_364 ) ;
if ( V_232 . V_233 -> V_365 . V_235 )
F_212 ( V_232 . V_233 -> V_365 . V_235 ,
V_232 . V_233 -> V_365 . V_364 ) ;
F_200 () ;
F_31 () ;
F_213 ( & V_61 -> V_8 . V_389 , & V_390 ) ;
F_40 () ;
F_214 (io, tmp_io, &spic_dev.ioports, list) {
F_215 ( & V_363 -> V_347 ) ;
F_47 ( V_363 ) ;
}
F_214 (irq, tmp_irq, &spic_dev.interrupts, list) {
F_215 ( & V_353 -> V_347 ) ;
F_47 ( V_353 ) ;
}
V_232 . V_233 = NULL ;
...
static int F_216 ( struct V_31 * V_87 )
{
int V_68 ;
struct V_344 * V_363 , * V_386 ;
struct V_354 * V_353 , * V_387 ;
F_71 ( L_82 , V_391 , V_222 ) ;
V_232 . V_385 = V_87 ;
strcpy ( F_142 ( V_87 ) , L_83 ) ;
F_154 ( & V_232 ) ;
F_217 ( & V_232 . V_273 ) ;
...
if ( F_197 () )
goto V_393;
F_218 (io, &spic_dev.ioports, list) {
if ( F_219 ( V_363 -> V_234 . V_235 , V_363 -> V_234 . V_364 ,
L_121 ) ) {
F_13 ( L_122 ,
V_363 -> V_234 . V_235 , V_363 -> V_234 . V_394 ,
V_363 -> V_234 . V_364 ) ;
if ( V_363 -> V_365 . V_235 ) {
if ( F_219 ( V_363 -> V_365 . V_235 ,
V_363 -> V_365 . V_364 ,
L_121 ) ) {
F_13 ( L_123 ,
...
F_218 (irq, &spic_dev.interrupts, list) {
if ( ! F_220 ( V_353 -> V_353 . V_357 [ 0 ] , V_354 ,
0 , L_6 , & V_232 ) ) {
F_13 ( L_127
L_128 ,
V_353 -> V_353 . V_357 [ 0 ] ,
...
V_68 = F_208 ( V_87 , V_232 . V_233 , V_232 . V_388 ) ;
if ( V_68 ) {
F_20 ( L_130 ) ;
goto V_397;
}
...
if ( V_68 )
goto V_398;
V_68 = F_221 ( & V_61 -> V_8 . V_389 , & V_390 ) ;
if ( V_68 )
goto V_399;
return 0 ;
V_399:
...
static int F_224 ( struct V_87 * V_8 )
{
F_208 ( F_223 ( V_8 ) ,
V_232 . V_233 , V_232 . V_388 ) ;
return 0 ;
}
static int T_13 F_225 ( void )
{
int V_68 ;
if ( ! V_400 && F_226 ( V_401 ) ) {
V_68 = F_227 ( & V_402 ) ;
if ( V_68 ) {
F_20 ( L_131 ) ;
goto V_60;
