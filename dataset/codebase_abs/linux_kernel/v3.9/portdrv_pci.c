...
static int F_26 ( struct V_9 * V_9 , void * V_12 )
{
struct V_31 * V_31 ;
struct V_32 * V_33 ;
struct V_34 * V_35 ;
...
V_8 = F_31 ( & V_5 -> V_5 , & V_23 , F_34 ) ;
return V_23 ;
}
static int F_38 ( struct V_9 * V_9 , void * V_12 )
{
struct V_31 * V_31 ;
struct V_32 * V_33 ;
if ( V_9 -> V_36 == & V_37 && V_9 -> V_33 ) {
...
{
int V_8 ;
V_8 = F_31 ( & V_5 -> V_5 , NULL , F_38 ) ;
}
static int T_1 F_40 ( const struct V_53 * V_54 )
{
F_41 ( L_6 ,
V_54 -> V_55 ) ;
F_42 () ;
