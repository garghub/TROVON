...
static void F_20 ( struct V_1 * V_2 , unsigned int V_45 )
{
}
...
static void
F_28 ( struct V_1 * V_2 , struct V_54 * V_55 ,
struct V_54 * V_56 )
{
unsigned long V_47 ;
...
V_55 -> V_60 |= V_64 ;
V_55 -> V_65 &= ~ ( V_66 | V_67 ) ;
V_57 = F_29 ( V_2 , V_55 , V_56 , 0 , V_2 -> V_68 / 16 ) ;
V_58 = F_30 ( V_2 , V_57 ) ;
...
{
return F_37 ( V_2 -> V_89 , 32 , V_53 )
!= NULL ? 0 : - V_90 ;
}
static void F_38 ( struct V_1 * V_2 , int V_47 )
{
if ( V_47 & V_91 && F_36 ( V_2 ) == 0 )
V_2 -> type = V_88 ;
}
static int F_39 ( struct V_1 * V_2 , struct V_92 * V_93 )
{
int V_52 = 0 ;
...
static void F_41 ( struct V_1 * V_2 , int V_8 )
{
while ( * V_12 & 0x20 )
F_42 () ;
* V_13 = V_8 ;
...
static void
F_43 ( struct V_99 * V_100 , const char * V_101 ,
unsigned int V_33 )
{
F_44 ( & V_97 , V_101 , V_33 , F_41 ) ;
}
static void T_2
F_45 ( struct V_1 * V_2 , int * V_57 ,
int * V_21 , int * V_102 )
{
if ( * V_85 == 1 ) {
unsigned int V_103 ;
...
static int T_2 F_46 ( struct V_99 * V_100 , char * V_104 )
{
struct V_1 * V_2 = & V_97 ;
int V_57 = 9600 ;
int V_102 = 8 ;
...
V_57 = 57600 ;
if ( V_104 )
F_48 ( V_104 , & V_57 , & V_21 , & V_102 , & V_105 ) ;
else
F_45 ( V_2 , & V_57 , & V_21 , & V_102 ) ;
return F_49 ( V_2 , V_100 , V_57 , V_21 , V_102 , V_105 ) ;
}
