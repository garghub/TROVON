...
static void F_51 ( struct V_113 * V_55 )
{
struct V_43 * V_44 = (struct V_43 * ) V_55 ;
V_44 -> V_45 |= V_91 ;
}
...
static void F_55 ( struct V_113 * V_55 )
{
struct V_43 * V_44 = (struct V_43 * ) V_55 ;
struct V_1 T_1 * V_2 = F_16 ( V_55 ) ;
unsigned char V_125 ;
...
static void F_56 ( struct V_113 * V_55 , int V_129 )
{
struct V_43 * V_44 = (struct V_43 * ) V_55 ;
struct V_1 T_1 * V_2 = F_16 ( V_55 ) ;
...
static int F_58 ( struct V_113 * V_55 )
{
struct V_43 * V_44 = F_54 ( V_55 ) ;
unsigned long V_45 ;
if ( F_29 ( V_44 ) )
...
static void F_59 ( struct V_113 * V_55 )
{
struct V_43 * V_44 = F_54 ( V_55 ) ;
struct V_1 T_1 * V_2 ;
unsigned long V_45 ;
...
static void
F_61 ( struct V_113 * V_55 , struct V_167 * V_168 ,
struct V_167 * V_169 )
{
struct V_43 * V_44 = (struct V_43 * ) V_55 ;
unsigned long V_45 ;
int V_170 , V_50 ;
V_170 = F_62 ( V_55 , V_168 , V_169 , 1200 , 76800 ) ;
F_47 ( & V_44 -> V_55 . V_103 , V_45 ) ;
V_50 = F_15 ( V_170 , V_53 / V_54 ) ;
F_60 ( V_44 , V_168 -> V_171 , V_168 -> V_172 , V_50 ) ;
if ( F_63 ( & V_44 -> V_55 , V_168 -> V_171 ) )
V_44 -> V_45 |= V_173 ;
else
V_44 -> V_45 &= ~ V_173 ;
V_44 -> V_49 = V_168 -> V_171 ;
F_10 ( V_44 , F_16 ( V_55 ) ) ;
F_64 ( V_55 , V_168 -> V_171 , V_170 ) ;
F_48 ( & V_44 -> V_55 . V_103 , V_45 ) ;
}
static const char * F_65 ( struct V_113 * V_55 )
{
struct V_43 * V_44 = F_54 ( V_55 ) ;
return ( V_44 -> V_45 & V_174 ) ? L_1 : L_2 ;
}
static void F_66 ( struct V_113 * V_55 )
{
}
static int F_67 ( struct V_113 * V_55 )
{
return 0 ;
}
static void F_68 ( struct V_113 * V_55 , int V_45 )
{
}
static int F_69 ( struct V_113 * V_55 , struct V_175 * V_176 )
{
return - V_177 ;
}
static int F_70 ( struct V_113 * V_55 )
{
...
static void F_71 ( struct V_113 * V_55 ,
unsigned char V_56 )
{
struct V_43 * V_44 = (struct V_43 * ) V_55 ;
F_72 ( & V_44 -> V_55 , V_56 ) ;
}
static int T_4 F_73 ( int V_179 )
{
struct V_43 * V_44 ;
unsigned long V_180 ;
int V_181 = V_179 * 2 ;
...
V_182 = F_74 ( V_180 , V_183 ) ;
if ( ! V_182 )
return - V_184 ;
for ( V_7 = 0 ; V_7 < V_181 ; V_7 ++ ) {
V_44 = & V_182 [ V_7 ] ;
F_75 ( & V_44 -> V_55 . V_103 ) ;
if ( V_7 == 0 )
V_185 = V_44 ;
if ( V_7 < V_181 - 1 )
V_44 -> V_108 = V_44 + 1 ;
...
static void F_72 ( struct V_113 * V_55 , int V_56 )
{
struct V_1 T_1 * V_2 = F_16 ( V_55 ) ;
int V_188 = V_189 ;
do {
...
static void
F_81 ( struct V_194 * V_195 , const char * V_196 , unsigned int V_197 )
{
...
V_199 = F_83 ( & V_44 -> V_55 . V_103 ) ;
} else
F_42 ( & V_44 -> V_55 . V_103 ) ;
F_84 ( & V_44 -> V_55 , V_196 , V_197 , F_72 ) ;
F_9 ( 2 ) ;
if ( V_199 )
F_43 ( & V_44 -> V_55 . V_103 ) ;
F_85 ( V_45 ) ;
}
static int T_4 F_86 ( struct V_194 * V_195 , char * V_202 )
{
struct V_43 * V_44 = & V_182 [ V_195 -> V_198 ] ;
unsigned long V_45 ;
int V_170 , V_50 ;
...
F_88 ( V_195 , V_44 -> V_55 . V_207 -> V_208 ) ;
...
F_60 ( V_44 , V_195 -> V_49 , 0 , V_50 ) ;
F_50 ( & V_44 -> V_55 , V_123 | V_121 ) ;
F_57 ( V_44 ) ;
F_48 ( & V_44 -> V_55 . V_103 , V_45 ) ;
return 0 ;
}
static inline struct V_194 * F_89 ( void )
{
return & V_219 ;
}
...
F_92 ( V_59 -> V_226 , L_4 , sizeof( V_59 -> V_226 ) ) ;
} else {
V_59 -> V_222 . V_224 = V_227 ;
V_59 -> V_222 . V_228 = 1 ;
F_92 ( V_59 -> V_226 , L_5 , sizeof( V_59 -> V_226 ) ) ;
}
F_92 ( V_59 -> V_229 ,
( ( V_44 -> V_45 & V_220 ) ?
L_6 : L_7 ) ,
...
static void F_94 ( struct V_43 * V_44 )
{
struct V_1 T_1 * V_2 ;
unsigned long V_45 ;
int V_170 , V_50 ;
...
static int F_97 ( struct V_242 * V_243 )
{
...
int V_248 = 0 ;
int V_249 ;
if ( F_98 ( V_243 -> V_207 . V_208 , L_8 , NULL ) )
V_248 = 1 ;
if ( V_248 )
V_246 = V_250 + V_244 ;
else
V_246 = V_245 ;
V_187 [ V_246 ] = F_99 ( & V_243 -> V_251 [ 0 ] , 0 ,
sizeof( struct V_186 ) ,
L_2 ) ;
if ( ! V_187 [ V_246 ] )
return - V_184 ;
...
F_94 ( & V_44 [ 1 ] ) ;
if ( ! V_248 ) {
if ( F_100 ( F_89 () , V_243 -> V_207 . V_208 ,
& V_205 , V_44 [ 0 ] . V_55 . line ,
false ) )
V_44 -> V_45 |= V_267 ;
V_249 = F_101 ( & V_205 , & V_44 [ 0 ] . V_55 ) ;
if ( V_249 ) {
F_102 ( & V_243 -> V_251 [ 0 ] ,
...
false ) )
V_44 -> V_45 |= V_267 ;
V_249 = F_101 ( & V_205 , & V_44 [ 1 ] . V_55 ) ;
if ( V_249 ) {
F_103 ( & V_205 , & V_44 [ 0 ] . V_55 ) ;
F_102 ( & V_243 -> V_251 [ 0 ] ,
V_247 , sizeof( struct V_186 ) ) ;
return V_249 ;
}
...
V_243 -> V_253 . V_254 [ 0 ] , F_65 ( & V_44 [ 0 ] . V_55 ) ) ;
F_87 ( V_204 L_11
L_10 ,
F_104 ( & V_243 -> V_207 ) ,
( unsigned long long ) V_44 [ 1 ] . V_55 . V_255 ,
V_243 -> V_253 . V_254 [ 0 ] , F_65 ( & V_44 [ 1 ] . V_55 ) ) ;
V_244 ++ ;
}
F_105 ( & V_243 -> V_207 , & V_44 [ 0 ] ) ;
return 0 ;
}
...
F_103 ( & V_205 , & V_44 -> V_55 ) ;
}
static int F_108 ( struct V_242 * V_243 )
{
struct V_43 * V_44 = F_109 ( & V_243 -> V_207 ) ;
struct V_186 T_1 * V_16 ;
F_106 ( & V_44 [ 0 ] ) ;
F_106 ( & V_44 [ 1 ] ) ;
V_16 = V_187 [ V_44 [ 0 ] . V_55 . line / 2 ] ;
F_102 ( & V_243 -> V_251 [ 0 ] , V_16 , sizeof( struct V_186 ) ) ;
F_105 ( & V_243 -> V_207 , NULL ) ;
return 0 ;
}
