...
static int F_181 ( struct V_215 * V_215 , void * V_13 ,
struct V_406 * V_407 )
{
return 0 ;
}
...
static int F_190 ( struct V_215 * V_215 , void * V_216 ,
struct V_389 * V_109 )
{
...
static int F_192 ( struct V_215 * V_416 , void * V_216 , unsigned int V_3 )
{
return 0 ;
}
static int F_193 ( struct V_215 * V_215 , void * V_13 , T_7 * V_19 )
{
return 0 ;
}
static int F_194 ( struct V_215 * V_215 , void * V_216 ,
struct V_1 * V_120 )
{
const struct V_1 * V_199 ;
if ( V_120 -> V_2 < V_313 ||
...
V_11 -> V_229 |= V_230 ;
V_11 -> V_423 = 0 ;
F_196 ( & V_11 -> V_176 . V_424 ) ;
F_197 ( & V_11 -> V_176 . V_177 ) ;
...
void F_203 ( struct V_10 * V_11 , unsigned long V_329 )
{
enum V_123 V_124 ;
F_204 ( & V_11 -> V_233 ) ;
if ( V_11 -> V_176 . V_190 ) {
...
F_205 ( V_11 , & V_11 -> V_176 , V_276 ) ;
}
F_206 ( V_11 , & V_11 -> V_176 ) ;
V_275:
F_207 ( & V_11 -> V_233 ) ;
}
