...
static void F_93 ( struct V_2 * V_3 , struct V_41 * V_42 ,
unsigned int V_27 )
{
while ( V_27 -- )
F_94 ( V_42 , V_3 -> V_25 [ V_27 ] . V_38 ) ;
F_92 ( V_3 -> V_57 ) ;
F_95 ( V_3 -> V_76 ) ;
F_90 ( V_3 ) ;
}
static int F_96 ( struct V_2 * V_3 , struct V_41 * V_42 ,
...
if ( F_97 ( V_42 , V_125 [ 0 ] , F_98 ( V_42 -> V_84 ) ,
& V_3 -> V_25 [ V_25 ] . V_38 ) ) {
V_42 -> error = L_14 ;
return - V_128 ;
}
...
static struct V_82 * F_99 ( struct V_41 * V_42 ,
...
V_120 = F_100 ( V_125 [ 0 ] , V_42 , F_29 , V_131 ,
V_125 + 2 ) ;
if ( ! V_120 ) {
V_42 -> error = L_18 ;
return NULL ;
...
static int F_101 ( struct V_2 * V_3 , unsigned V_129 , char * * V_125 ,
unsigned * V_130 )
{
unsigned V_132 ;
...
static int F_102 ( struct V_41 * V_42 , unsigned int V_129 , char * * V_125 )
{
int V_69 ;
...
struct V_82 * V_120 ;
char V_126 ;
V_120 = F_99 ( V_42 , V_129 , V_125 , & V_130 ) ;
if ( ! V_120 )
return - V_127 ;
V_125 += V_130 ;
V_129 -= V_130 ;
...
V_3 = F_84 ( V_30 , V_120 -> type -> V_135 ( V_120 ) , V_42 , V_120 ) ;
if ( ! V_3 ) {
F_103 ( V_120 ) ;
return - V_136 ;
}
for ( V_27 = 0 ; V_27 < V_30 ; V_27 ++ ) {
V_69 = F_96 ( V_3 , V_42 , V_27 , V_125 ) ;
if ( V_69 ) {
F_93 ( V_3 , V_42 , V_27 ) ;
return V_69 ;
}
...
V_3 -> V_7 = 0 ;
F_106 ( & V_3 -> V_40 , V_40 ) ;
V_69 = F_101 ( V_3 , V_129 , V_125 , & V_130 ) ;
if ( V_69 )
goto V_145;
V_125 += V_130 ;
V_129 -= V_130 ;
...
F_110 ( V_3 -> V_4 ) ;
V_137:
F_93 ( V_3 , V_42 , V_3 -> V_30 ) ;
return V_69 ;
}
static void F_111 ( struct V_41 * V_42 )
{
...
static int F_116 ( struct V_41 * V_42 , struct V_14 * V_14 )
{
...
struct V_82 * log = F_44 ( V_3 -> V_76 ) ;
struct V_141 * V_147 =
F_117 ( V_14 , sizeof( struct V_141 ) ) ;
...
if ( F_31 ( ! V_27 ) )
return - V_62 ;
F_118 ( & V_147 -> V_148 , V_14 ) ;
V_147 -> V_27 = V_27 ;
F_55 ( V_27 , V_14 ) ;
return V_153 ;
}
static int F_119 ( struct V_41 * V_42 , struct V_14 * V_14 , int error )
{
int V_15 = F_64 ( V_14 ) ;
struct V_2 * V_3 = (struct V_2 * ) V_42 -> V_43 ;
...
static char F_129 ( struct V_25 * V_27 )
{
if ( ! F_19 ( & ( V_27 -> V_31 ) ) )
return 'A' ;
...
static void F_130 ( struct V_41 * V_42 , T_5 type ,
...
F_131 ( L_34 , V_3 -> V_30 ) ;
for ( V_27 = 0 ; V_27 < V_3 -> V_30 ; V_27 ++ ) {
F_131 ( L_35 , V_3 -> V_25 [ V_27 ] . V_38 -> V_39 ) ;
V_166 [ V_27 ] = F_129 ( & ( V_3 -> V_25 [ V_27 ] ) ) ;
}
V_166 [ V_27 ] = '\0' ;
F_131 ( L_36 ,
...
F_131 ( L_37 , V_3 -> V_30 ) ;
for ( V_27 = 0 ; V_27 < V_3 -> V_30 ; V_27 ++ )
F_131 ( L_38 , V_3 -> V_25 [ V_27 ] . V_38 -> V_39 ,
( unsigned long long ) V_3 -> V_25 [ V_27 ] . V_77 ) ;
if ( V_3 -> V_133 & V_134 )
F_131 ( L_39 ) ;
}
}
static int F_132 ( struct V_41 * V_42 ,
T_6 V_99 , void * V_6 )
{
struct V_2 * V_3 = V_42 -> V_43 ;
int V_104 = 0 ;
