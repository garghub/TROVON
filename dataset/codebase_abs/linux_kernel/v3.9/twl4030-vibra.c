...
{
struct V_37 * V_38 = V_36 -> V_34 . V_41 ;
struct V_39 * V_42 = V_36 -> V_34 . V_43 -> V_44 ;
struct V_4 * V_5 ;
int V_45 ;
if ( ! V_38 && ! V_42 ) {
F_22 ( & V_36 -> V_34 , L_2 ) ;
...
V_5 = F_23 ( & V_36 -> V_34 , sizeof( * V_5 ) , V_47 ) ;
if ( ! V_5 )
return - V_48 ;
V_5 -> V_34 = & V_36 -> V_34 ;
V_5 -> V_19 = F_19 ( V_38 , V_42 ) ;
F_24 ( & V_5 -> V_14 , F_8 ) ;
V_5 -> V_23 = F_25 ( & V_36 -> V_34 ) ;
if ( V_5 -> V_23 == NULL ) {
F_26 ( & V_36 -> V_34 , L_3 ) ;
return - V_48 ;
}
F_27 ( V_5 -> V_23 , V_5 ) ;
V_5 -> V_23 -> V_49 = L_4 ;
V_5 -> V_23 -> V_50 . V_51 = 1 ;
V_5 -> V_23 -> V_34 . V_43 = V_36 -> V_34 . V_43 ;
V_5 -> V_23 -> V_52 = F_13 ;
F_28 ( V_53 , V_5 -> V_23 -> V_54 ) ;
V_45 = F_29 ( V_5 -> V_23 , NULL , F_10 ) ;
if ( V_45 < 0 ) {
F_22 ( & V_36 -> V_34 , L_5 ) ;
return V_45 ;
}
