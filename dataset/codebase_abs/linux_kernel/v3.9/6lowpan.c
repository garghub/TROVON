...
F_5 ( L_15
L_16 , V_53 -> V_61 ,
F_24 ( V_53 -> V_62 ) , V_53 -> V_63 , V_53 -> V_64 ) ;
F_7 ( V_29 , L_17 ,
F_25 ( V_24 ) , sizeof( struct V_52 ) ) ;
if ( ! V_54 )
V_54 = V_3 -> V_65 ;
...
memcpy ( F_32 ( V_24 , V_15 - V_56 ) , V_56 , V_15 - V_56 ) ;
...
V_59 . V_84 = V_85 ;
V_59 . V_86 = 0xff ;
memcpy ( & ( V_59 . V_87 ) , V_55 , 8 ) ;
memcpy ( & ( V_58 . V_87 ) , V_54 , 8 ) ;
F_33 ( V_24 ) -> V_88 = V_89 ;
return F_34 ( V_24 , V_1 ( V_3 ) -> V_90 ,
...
int V_94 = V_95 ;
F_36 () ;
F_37 (entry, &lowpan_devices, list)
if ( V_1 ( V_92 -> V_96 ) -> V_90 == V_24 -> V_3 ) {
V_93 = F_38 ( V_24 , V_97 ) ;
if ( ! V_93 ) {
V_94 = - V_98 ;
break;
...
static int F_41 ( struct V_23 * V_24 , struct V_52 * V_53 )
{
struct V_23 * V_99 ;
int V_94 = V_95 ;
V_99 = F_42 ( V_24 , sizeof( struct V_52 ) , F_43 ( V_24 ) ,
V_97 ) ;
F_44 ( V_24 ) ;
if ( ! V_99 )
return - V_98 ;
F_32 ( V_99 , sizeof( struct V_52 ) ) ;
F_45 ( V_99 ) ;
F_46 ( V_99 , V_53 , sizeof( struct V_52 ) ) ;
V_99 -> V_100 = F_47 ( V_60 ) ;
V_99 -> V_101 = V_102 ;
V_94 = F_35 ( V_99 ) ;
F_44 ( V_99 ) ;
return V_94 ;
}
static void F_48 ( unsigned long V_103 )
{
struct V_104 * V_92 = (struct V_104 * ) V_103 ;
F_5 ( L_31 , V_92 -> V_105 ) ;
F_49 ( & V_92 -> V_106 ) ;
F_50 ( V_92 -> V_24 ) ;
F_51 ( V_92 ) ;
...
{
struct V_104 * V_107 ;
V_107 = F_53 ( sizeof( struct V_104 ) ,
V_97 ) ;
if ( ! V_107 )
goto V_108;
F_54 ( & V_107 -> V_106 ) ;
V_107 -> V_109 = V_11 ;
V_107 -> V_105 = V_105 ;
V_107 -> V_24 = F_55 ( V_24 -> V_3 , V_107 -> V_109 +
sizeof( struct V_52 ) ) ;
if ( ! V_107 -> V_24 )
goto V_110;
V_107 -> V_24 -> V_67 = V_24 -> V_67 ;
V_107 -> V_24 -> V_3 = V_24 -> V_3 ;
F_56 ( V_107 -> V_24 , sizeof( struct V_52 ) ) ;
F_57 ( V_107 -> V_24 , V_107 -> V_109 ) ;
F_58 ( & V_107 -> V_111 ) ;
V_107 -> V_111 . V_112 = V_113 + V_114 ;
V_107 -> V_111 . V_30 = ( unsigned long ) V_107 ;
V_107 -> V_111 . V_115 = F_48 ;
F_59 ( & V_107 -> V_111 ) ;
F_60 ( & V_107 -> V_106 , & V_116 ) ;
return V_107 ;
V_110:
F_51 ( V_107 ) ;
V_108:
...
if ( F_17 ( V_24 , & V_123 ) )
goto V_126;
if ( F_64 ( ( V_123 * 8 + V_24 -> V_11 ) <= V_107 -> V_109 ) )
F_65 ( V_107 -> V_24 , V_123 * 8 ,
V_24 -> V_30 , V_24 -> V_11 ) ;
else
goto V_126;
...
if ( F_17 ( V_24 , & V_51 ) )
goto V_118;
V_49 = F_33 ( V_24 ) -> V_58 . V_87 ;
V_48 = F_33 ( V_24 ) -> V_59 . V_87 ;
F_5 ( L_32 , V_50 , V_51 ) ;
if ( V_51 & V_128 ) {
F_5 ( L_33 ) ;
if ( F_17 ( V_24 , & V_117 ) )
...
if ( ( V_50 & 0x03 ) != V_130 )
V_53 . V_64 = V_131 [ V_50 & 0x03 ] ;
else {
if ( F_17 ( V_24 , & ( V_53 . V_64 ) ) )
goto V_118;
}
V_44 = ( ( V_51 & V_132 ) >> V_77 ) & 0x03 ;
F_5 ( L_35 ) ;
...
static int F_69 ( struct V_2 * V_3 , void * V_137 )
{
struct V_138 * V_58 = V_137 ;
if ( F_70 ( V_3 ) )
return - V_139 ;
memcpy ( V_3 -> V_65 , V_58 -> V_140 , V_3 -> V_141 ) ;
return 0 ;
}
...
static int
F_72 ( struct V_23 * V_24 , T_1 * V_56 ,
...
V_144 = F_73 ( V_145 + V_142 + V_143 + V_149 ) ;
if ( ! V_144 )
return - V_98 ;
V_144 -> V_67 = V_24 -> V_67 ;
V_144 -> V_3 = V_24 -> V_3 ;
memcpy ( F_57 ( V_144 , V_142 ) , V_24 -> V_30 , V_142 ) ;
memcpy ( F_57 ( V_144 , V_145 ) , V_56 , V_145 ) ;
if ( V_143 )
F_74 ( V_24 , V_123 + V_142 ,
F_57 ( V_144 , V_143 ) , V_143 ) ;
...
if ( V_151 - V_123 < V_11 )
V_11 = V_151 - V_123 ;
V_45 = F_72 ( V_24 , V_56 , V_150 ,
V_11 , V_123 ) ;
V_123 += V_11 ;
}
return V_45 ;
}
static T_3 F_77 ( struct V_23 * V_24 , struct V_2 * V_3 )
{
int V_45 = - 1 ;
F_5 ( L_45 ) ;
V_24 -> V_3 = V_1 ( V_3 ) -> V_90 ;
if ( V_24 -> V_3 == NULL ) {
F_5 ( L_46 ) ;
goto error;
}
...
static struct V_158 * F_78 ( const struct V_2 * V_3 )
{
struct V_2 * V_90 = V_1 ( V_3 ) -> V_90 ;
return F_79 ( V_90 ) -> F_80 ( V_90 ) ;
}
static T_2 F_81 ( const struct V_2 * V_3 )
{
struct V_2 * V_90 = V_1 ( V_3 ) -> V_90 ;
return F_79 ( V_90 ) -> F_82 ( V_90 ) ;
}
static T_2 F_83 ( const struct V_2 * V_3 )
{
struct V_2 * V_90 = V_1 ( V_3 ) -> V_90 ;
return F_79 ( V_90 ) -> F_84 ( V_90 ) ;
}
...
static int F_86 ( struct V_176 * V_177 [] , struct V_176 * V_30 [] )
{
if ( V_177 [ V_178 ] ) {
if ( F_87 ( V_177 [ V_178 ] ) != V_7 )
return - V_31 ;
}
return 0 ;
}
...
if ( V_3 -> type != V_160 )
goto V_118;
if ( V_24 -> V_30 [ 0 ] == V_183 ) {
V_182 = F_42 ( V_24 , V_184 - 1 ,
F_43 ( V_24 ) , V_97 ) ;
if ( ! V_182 )
goto V_118;
V_182 -> V_100 = F_47 ( V_60 ) ;
V_182 -> V_101 = V_102 ;
F_14 ( V_182 , 1 ) ;
F_45 ( V_182 ) ;
F_89 ( V_182 , sizeof( struct V_52 ) ) ;
F_35 ( V_182 ) ;
F_44 ( V_182 ) ;
F_44 ( V_24 ) ;
} else {
...
static int F_91 ( struct V_186 * V_187 , struct V_2 * V_3 ,
...
if ( ! V_177 [ V_188 ] )
return - V_31 ;
V_90 = F_92 ( V_187 , F_93 ( V_177 [ V_188 ] ) ) ;
if ( ! V_90 )
return - V_189 ;
V_1 ( V_3 ) -> V_90 = V_90 ;
F_94 ( & V_1 ( V_3 ) -> V_190 ) ;
V_92 = F_53 ( sizeof( struct V_91 ) , V_191 ) ;
if ( ! V_92 ) {
F_95 ( V_90 ) ;
V_1 ( V_3 ) -> V_90 = NULL ;
return - V_98 ;
...
F_96 ( & V_1 ( V_3 ) -> V_190 ) ;
F_54 ( & V_92 -> V_106 ) ;
F_60 ( & V_92 -> V_106 , & V_192 ) ;
F_97 ( & V_1 ( V_3 ) -> V_190 ) ;
F_98 ( V_3 ) ;
return 0 ;
}
static void F_99 ( struct V_2 * V_3 , struct V_193 * V_56 )
{
struct V_1 * V_194 = V_1 ( V_3 ) ;
struct V_2 * V_90 = V_194 -> V_90 ;
struct V_91 * V_92 , * V_44 ;
F_100 () ;
F_96 ( & V_1 ( V_3 ) -> V_190 ) ;
F_101 (entry, tmp, &lowpan_devices, list) {
if ( V_92 -> V_96 == V_3 ) {
F_49 ( & V_92 -> V_106 ) ;
F_51 ( V_92 ) ;
}
...
static inline int T_4 F_104 ( void )
{
return F_105 ( & V_195 ) ;
}
...
static int F_108 ( struct V_196 * V_197 ,
unsigned long V_198 ,
void * V_199 )
{
struct V_2 * V_3 = V_199 ;
F_109 ( V_200 ) ;
struct V_91 * V_92 , * V_44 ;
if ( V_3 -> type != V_160 )
goto V_155;
if ( V_198 == V_201 ) {
F_101 (entry, tmp, &lowpan_devices, list) {
if ( V_1 ( V_92 -> V_96 ) -> V_90 == V_3 )
F_99 ( V_92 -> V_96 , & V_200 ) ;
}
F_110 ( & V_200 ) ;
}
V_155:
...
{
struct V_104 * V_107 , * V_205 ;
F_106 () ;
F_114 ( & V_203 ) ;
F_116 ( & V_204 ) ;
F_62 ( & V_125 ) ;
F_101 (frame, tframe, &lowpan_fragments, list) {
F_66 ( & V_107 -> V_111 ) ;
F_49 ( & V_107 -> V_106 ) ;
F_50 ( V_107 -> V_24 ) ;
F_51 ( V_107 ) ;
