...
static int F_97 ( struct V_173 * V_174 )
{
...
void T_7 * V_99 ;
int V_142 , V_143 ;
V_177 = V_174 -> V_180 -> V_181 ;
V_3 = & V_175 [ V_177 ] ;
V_150 = F_98 ( & V_174 -> V_28 , L_18 ) ;
if ( F_99 ( V_150 ) ) {
F_100 ( & V_174 -> V_28 , L_19 ) ;
V_142 = - V_182 ;
goto exit;
}
V_179 = F_101 ( V_174 , V_183 , 0 ) ;
V_143 = F_102 ( V_174 , 0 ) ;
if ( ! V_179 || V_143 <= 0 ) {
V_142 = - V_182 ;
goto V_184;
}
if ( ! F_103 ( V_179 -> V_185 ,
F_104 ( V_179 ) ,
V_174 -> V_153 ) ) {
V_142 = - V_172 ;
goto V_184;
}
V_99 = F_105 ( V_179 -> V_185 , F_104 ( V_179 ) ) ;
if ( ! V_99 ) {
V_142 = - V_186 ;
goto V_187;
}
V_28 = F_106 ( sizeof( struct V_1 ) ,
1 << V_3 -> V_7 ) ;
if ( ! V_28 ) {
V_142 = - V_186 ;
goto V_188;
...
V_28 -> V_170 |= V_191 ;
V_2 = F_31 ( V_28 ) ;
V_2 -> V_38 . clock . V_192 = F_107 ( V_150 ) ;
V_2 -> V_38 . V_193 = & V_194 ;
V_2 -> V_38 . V_195 = F_90 ;
V_2 -> V_38 . V_196 = F_37 ;
V_2 -> V_38 . V_197 = V_42 ;
V_2 -> V_28 = V_28 ;
...
V_2 -> V_3 . type = V_177 ;
V_2 -> V_150 = V_150 ;
V_2 -> V_25 = V_174 -> V_28 . V_198 ;
V_2 -> V_30 = 0x7ff ;
F_108 ( V_28 , & V_2 -> V_117 , F_64 , F_4 ( V_2 ) ) ;
if ( F_75 ( V_2 ) )
V_28 -> V_199 [ 0 ] = & V_200 ;
F_109 ( & V_174 -> V_28 , V_28 ) ;
F_110 ( V_28 , & V_174 -> V_28 ) ;
V_142 = F_111 ( V_28 ) ;
if ( V_142 ) {
F_100 ( & V_174 -> V_28 , L_20 ) ;
goto V_201;
}
F_112 ( V_28 ) ;
F_113 ( & V_174 -> V_28 , L_21 ,
V_2 -> V_12 , V_28 -> V_143 ) ;
return 0 ;
V_201:
F_114 ( V_28 ) ;
