...
char V_255 [ 32 ] ;
int V_3 ;
T_16 V_256 = { . V_82 = V_257 } ;
int V_114 ;
strcpy ( V_255 , V_39 -> V_136 ) ;
V_3 = strlen ( V_255 ) ;
V_255 [ V_3 ] = V_255 [ V_3 - 1 ] ;
V_255 [ V_3 - 1 ] = '/' ;
V_3 ++ ;
strcpy ( V_255 + V_3 , V_41 ? L_44 : L_45 ) ;
V_59 -> V_117 = F_144 ( ( V_118 ) V_255 , 0 ) ;
F_78 ( L_46 ,
V_255 , V_59 -> V_117 , & V_59 -> V_117 ) ;
if ( V_59 -> V_117 < 0 ) {
if ( V_59 -> V_117 == V_258 )
F_82 ( V_144 L_47 ,
V_255 ) ;
...
V_256 . V_237 . V_259 = V_260 ;
V_256 . V_237 . V_251 = V_261 ;
V_114 = F_68 ( V_59 -> V_117 , 0 ,
...
F_153 ( & V_59 -> V_63 ) ;
V_59 -> V_122 = F_154 ( V_275 | V_276 , V_123 ) ;
if ( ! V_59 -> V_122 ) {
F_155 ( V_39 ) ;
return NULL ;
}
...
static int T_17 F_162 ( char * V_279 )
{
int V_280 = F_163 ( V_279 , & V_131 ) ;
if ( V_280 != 0 ) {
F_51 ( L_55 ,
V_279 ) ;
} else {
