...
F_69 ( & V_8 -> V_151 ) ;
V_8 -> V_77 = & V_8 -> V_152 ;
if ( F_70 ( & V_8 -> V_152 , 4096 , V_140 ) < 0 ) {
F_21 ( V_8 ) ;
return NULL ;
}
F_71 ( & V_8 -> V_86 ) ;
F_72 ( & V_8 -> V_144 ) ;
V_8 -> V_144 . V_153 = F_62 ;
...
static void F_74 ( struct V_110 * V_107 )
{
struct V_7 * V_8 = F_75 ( V_107 , struct V_7 , V_107 ) ;
F_76 ( & V_8 -> V_144 ) ;
...
int F_162 ( struct V_229 * V_90 , int V_250 )
{
struct V_232 * V_236 = (struct V_232 * ) F_144 ( V_90 ) ;
...
if ( V_268 -> V_274 [ 0 ] != '\0' )
V_269 = V_268 -> V_274 ;
V_90 = F_167 ( sizeof( struct V_232 ) ,
V_269 ,
F_163 ) ;
if ( ! V_90 ) {
F_168 ( L_36 ) ;
...
static void F_172 ( struct V_110 * V_107 , int V_278 )
{
struct V_7 * V_8 = F_75 ( V_107 , struct V_7 , V_107 ) ;
...
static int F_173 ( struct V_279 * V_280 , struct V_94 * V_95 )
{
struct V_47 * V_48 ;
struct V_7 * V_8 ;
...
if ( V_8 == NULL )
return - V_80 ;
V_195 = F_174 ( & V_8 -> V_107 , V_280 , V_95 ) ;
if ( V_195 ) {
if ( V_283 )
F_82 ( V_8 ) ;
return V_195 ;
...
static int F_175 ( struct V_94 * V_95 , struct V_205 * V_290 )
{
...
F_91 ( V_107 , V_95 ) ;
V_8 -> V_103 = 0 ;
F_112 ( V_291 , & V_107 -> V_71 ) ;
F_63 ( V_8 ) ;
return F_176 ( V_107 , V_95 , V_290 ) ;
}
static void F_177 ( struct V_94 * V_95 , struct V_205 * V_290 )
{
struct V_7 * V_8 = V_95 -> V_289 ;
struct V_47 * V_48 ;
if ( V_8 == NULL )
...
F_87 ( & V_8 -> V_151 ) ;
V_48 = V_8 -> V_48 ;
if ( F_178 ( & V_8 -> V_107 , V_95 , V_290 ) == 0 )
goto V_292;
F_48 ( V_8 ) ;
F_179 ( & V_8 -> V_107 , V_95 ) ;
F_91 ( & V_8 -> V_107 , NULL ) ;
V_292:
F_82 ( V_8 ) ;
F_82 ( V_48 -> V_8 [ 0 ] ) ;
...
static int F_182 ( struct V_94 * V_95 , const unsigned char * V_117 ,
int V_4 )
{
int V_293 ;
struct V_7 * V_8 = V_95 -> V_289 ;
if ( V_8 -> V_145 == V_146 )
return - V_203 ;
V_293 = F_183 ( V_8 -> V_77 , V_117 , V_4 , & V_8 -> V_81 ) ;
F_36 ( V_8 ) ;
return V_293 ;
}
...
static void F_186 ( struct V_94 * V_95 )
{
struct V_7 * V_8 = V_95 -> V_289 ;
if ( V_8 -> V_145 == V_146 )
return;
...
static void F_187 ( struct V_94 * V_95 , int V_295 )
{
}
...
static void F_191 ( struct V_94 * V_95 , struct V_301 * V_302 )
{
struct V_7 * V_8 = V_95 -> V_289 ;
if ( V_8 -> V_145 == V_146 )
return;
F_192 ( & V_95 -> V_104 , V_302 ) ;
}
static void F_193 ( struct V_94 * V_95 )
{
struct V_7 * V_8 = V_95 -> V_289 ;
if ( V_8 -> V_145 == V_146 )
return;
...
static int F_195 ( struct V_94 * V_95 , int V_145 )
{
struct V_7 * V_8 = V_95 -> V_289 ;
int V_304 = 0 ;
if ( V_8 -> V_145 == V_146 )
