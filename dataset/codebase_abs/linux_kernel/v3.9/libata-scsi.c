...
{ 0x04 , V_161 , 0x00 , 0x00 } ,
{ 0x08 , V_163 , 0x04 , 0x00 } ,
{ 0x10 , V_161 , 0x14 , 0x00 } ,
{ 0x08 , V_163 , 0x04 , 0x00 } ,
{ 0x40 , V_164 , 0x11 , 0x04 } ,
{ 0x80 , V_164 , 0x11 , 0x04 } ,
{ 0xFF , 0xFF , 0xFF , 0xFF } ,
} ;
static const unsigned char V_165 [] [ 4 ] = {
{ 0x80 , V_161 , 0x47 , 0x00 } ,
{ 0x20 , V_162 , 0x00 , 0x00 } ,
...
for ( V_159 = 0 ; V_165 [ V_159 ] [ 0 ] != 0xFF ; V_159 ++ ) {
if ( V_165 [ V_159 ] [ 0 ] & V_156 ) {
* V_54 = V_165 [ V_159 ] [ 1 ] ;
* V_55 = V_165 [ V_159 ] [ 2 ] ;
* V_56 = V_165 [ V_159 ] [ 3 ] ;
goto V_166;
...
struct V_148 * V_149 = & V_136 -> V_168 ;
unsigned char * V_169 = V_53 -> V_60 ;
unsigned char * V_117 = V_169 + 8 ;
int V_158 = V_136 -> V_10 -> V_61 -> V_170 == NULL ;
memset ( V_169 , 0 , V_107 ) ;
V_53 -> V_57 = ( V_58 << 24 ) | V_59 ;
if ( V_136 -> V_171 ||
V_149 -> V_151 & ( V_155 | V_172 | V_173 | V_174 ) ) {
F_57 ( V_136 -> V_10 -> V_175 , V_149 -> V_151 , V_149 -> V_153 ,
& V_169 [ 1 ] , & V_169 [ 2 ] , & V_169 [ 3 ] , V_158 ) ;
V_169 [ 1 ] &= 0x0f ;
} else {
V_169 [ 1 ] = V_121 ;
V_169 [ 2 ] = 0 ;
...
static int F_62 ( struct V_145 * V_191 )
{
...
const T_3 * V_221 = V_143 -> V_222 ;
if ( V_143 -> V_223 < 5 )
goto V_224;
V_149 -> V_13 |= V_225 | V_226 ;
V_149 -> V_227 = V_228 ;
if ( V_221 [ 1 ] & 0x1 ) {
;
}
...
if ( ( V_136 -> V_10 -> V_13 & V_233 ) &&
V_234 == V_235 )
goto V_236;
if ( ( V_136 -> V_10 -> V_13 & V_237 ) &&
F_88 () )
goto V_236;
V_149 -> V_151 = V_238 ;
}
...
struct V_148 * V_149 = & V_136 -> V_149 ;
struct V_25 * V_2 = V_136 -> V_2 ;
T_7 V_247 = V_136 -> V_2 -> V_81 ;
const T_3 * V_221 = V_143 -> V_222 ;
T_7 V_185 ;
T_8 V_248 ;
V_149 -> V_13 |= V_226 | V_225 ;
V_149 -> V_227 = V_228 ;
if ( V_221 [ 0 ] == V_249 ) {
if ( V_143 -> V_223 < 10 )
goto V_224;
...
if ( F_95 ( V_185 , V_248 ) ) {
V_149 -> V_151 = V_232 ;
V_149 -> V_1 |= ( V_185 >> 24 ) & 0xf ;
} else if ( F_96 ( V_185 , V_248 ) ) {
if ( ! ( V_2 -> V_13 & V_253 ) )
goto V_252;
V_149 -> V_13 |= V_180 ;
V_149 -> V_151 = V_254 ;
V_149 -> V_181 = ( V_248 >> 8 ) & 0xff ;
V_149 -> V_184 = ( V_185 >> 40 ) & 0xff ;
V_149 -> V_183 = ( V_185 >> 32 ) & 0xff ;
V_149 -> V_182 = ( V_185 >> 24 ) & 0xff ;
} else
goto V_252;
V_149 -> V_176 = V_248 & 0xff ;
V_149 -> V_179 = ( V_185 >> 16 ) & 0xff ;
V_149 -> V_178 = ( V_185 >> 8 ) & 0xff ;
V_149 -> V_177 = V_185 & 0xff ;
V_149 -> V_1 |= V_231 ;
} else {
...
goto V_251;
V_136 -> V_13 |= V_243 ;
V_136 -> V_147 = V_248 * V_143 -> V_1 -> V_201 ;
V_29 = F_99 ( & V_136 -> V_149 , V_136 -> V_2 , V_185 , V_248 , V_261 ,
V_136 -> V_270 ) ;
if ( F_63 ( V_29 == 0 ) )
return 0 ;
if ( V_29 == - V_271 )
...
V_136 -> V_279 = V_53 -> V_276 ;
}
V_136 -> V_280 = F_100 ;
if ( V_274 ( V_136 ) )
goto V_281;
if ( V_10 -> V_61 -> V_282 ) {
if ( ( V_29 = V_10 -> V_61 -> V_282 ( V_136 ) ) )
goto V_283;
}
F_104 ( V_136 ) ;
F_91 ( L_36 ) ;
...
T_3 * V_137 = args -> V_53 -> V_222 , * V_319 = V_294 ;
const T_3 V_320 [] = {
0 , 0 , 0 , 0 ,
0 ,
0 , 0x2 , 0x0
...
{
if ( V_136 -> V_171 && ( ( V_136 -> V_171 & V_341 ) == 0 ) ) {
F_58 ( V_136 ) ;
}
...
#ifdef F_145
if ( V_10 -> V_61 -> V_342 )
V_10 -> V_61 -> V_342 ( V_10 , & V_136 -> V_149 ) ;
#endif
V_53 -> V_60 [ 0 ] = 0x70 ;
V_53 -> V_60 [ 2 ] = V_136 -> V_149 . V_153 >> 4 ;
F_146 ( V_136 ) ;
F_147 ( & V_136 -> V_343 , V_53 -> V_60 , V_107 ) ;
F_103 ( V_136 , & V_136 -> V_343 , 1 ) ;
V_136 -> V_279 = V_112 ;
memset ( & V_136 -> V_221 , 0 , V_136 -> V_2 -> V_344 ) ;
V_136 -> V_221 [ 0 ] = V_345 ;
V_136 -> V_221 [ 4 ] = V_107 ;
V_136 -> V_149 . V_13 |= V_226 | V_225 ;
V_136 -> V_149 . V_151 = V_346 ;
if ( F_143 ( V_10 ) ) {
V_136 -> V_149 . V_227 = V_347 ;
V_136 -> V_149 . V_153 |= V_348 ;
} else {
V_136 -> V_149 . V_227 = V_349 ;
V_136 -> V_149 . V_178 = V_107 ;
V_136 -> V_149 . V_179 = 0 ;
}
V_136 -> V_147 = V_107 ;
V_136 -> V_280 = F_142 ;
...
{
struct V_52 * V_53 = V_136 -> V_137 ;
unsigned int V_171 = V_136 -> V_171 ;
F_91 ( L_47 , V_171 ) ;
if ( F_17 ( V_136 -> V_10 -> V_61 -> V_170 &&
( V_171 || V_136 -> V_13 & V_350 ) ) ) {
if ( ! ( V_136 -> V_13 & V_350 ) ) {
F_58 ( V_136 ) ;
}
if ( V_136 -> V_221 [ 0 ] == V_351 && V_136 -> V_2 -> V_22 )
V_136 -> V_2 -> V_22 -> V_352 = 0 ;
...
T_3 * V_137 = V_53 -> V_222 ;
if ( ( V_137 [ 0 ] == V_353 ) && ( ( V_137 [ 1 ] & 0x03 ) == 0 ) ) {
unsigned long V_13 ;
T_3 * V_5 ;
...
struct V_52 * V_143 = V_136 -> V_137 ;
struct V_25 * V_2 = V_136 -> V_2 ;
int V_354 = ( V_143 -> V_276 == V_113 ) ;
int V_355 = ! V_354 && ( V_2 -> V_13 & V_334 ) ;
unsigned int V_147 ;
memset ( V_136 -> V_221 , 0 , V_2 -> V_344 ) ;
memcpy ( V_136 -> V_221 , V_143 -> V_222 , V_143 -> V_223 ) ;
V_136 -> V_280 = F_148 ;
V_136 -> V_149 . V_13 |= V_226 | V_225 ;
if ( V_143 -> V_276 == V_277 ) {
V_136 -> V_149 . V_13 |= V_265 ;
F_97 ( L_48 ) ;
}
V_136 -> V_149 . V_151 = V_346 ;
F_53 ( V_136 ) ;
if ( ! V_354 && ! V_355 && F_150 ( V_136 ) )
V_355 = 1 ;
V_147 = F_76 ( F_151 ( V_136 ) , ( unsigned int ) 63 * 1024 ) ;
if ( V_147 & 0x1 )
V_147 ++ ;
V_136 -> V_149 . V_178 = ( V_147 & 0xFF ) ;
V_136 -> V_149 . V_179 = ( V_147 >> 8 ) ;
if ( V_354 )
V_136 -> V_149 . V_227 = V_356 ;
else if ( V_355 )
V_136 -> V_149 . V_227 = V_349 ;
else {
V_136 -> V_149 . V_227 = V_347 ;
...
struct V_25 * V_2 = V_136 -> V_2 ;
const T_3 * V_221 = V_143 -> V_222 ;
if ( ( V_149 -> V_227 = F_155 ( V_221 [ 1 ] ) ) == V_366 )
goto V_224;
if ( V_221 [ 0 ] == V_114 ) {
if ( V_221 [ 1 ] & 0x01 ) {
V_149 -> V_367 = V_221 [ 3 ] ;
...
V_149 -> V_176 = V_221 [ 6 ] ;
V_149 -> V_177 = V_221 [ 8 ] ;
V_149 -> V_178 = V_221 [ 10 ] ;
V_149 -> V_179 = V_221 [ 12 ] ;
V_149 -> V_1 = V_221 [ 13 ] ;
V_149 -> V_151 = V_221 [ 14 ] ;
} else {
V_149 -> V_13 &= ~ V_180 ;
V_149 -> V_153 = V_221 [ 3 ] ;
V_149 -> V_176 = V_221 [ 4 ] ;
...
V_149 -> V_1 = V_2 -> V_40 ?
V_149 -> V_1 | V_368 : V_149 -> V_1 & ~ V_368 ;
switch ( V_149 -> V_151 ) {
case V_369 :
case V_370 :
case V_371 :
case V_372 :
if ( V_149 -> V_227 != V_365 || V_149 -> V_176 != 1 )
goto V_224;
V_136 -> V_373 = F_54 ( V_143 ) ;
break;
case V_374 :
case V_375 :
case V_376 :
...
if ( V_143 -> V_276 == V_277 )
V_149 -> V_13 |= V_265 ;
V_136 -> V_13 |= V_400 | V_401 ;
F_53 ( V_136 ) ;
if ( V_149 -> V_227 == V_364 && V_2 -> V_402 == 0 )
goto V_224;
if ( ( V_221 [ 1 ] & 0xe0 ) && ! F_157 ( V_149 ) )
goto V_224;
if ( F_157 ( V_149 ) ) {
...
if ( V_149 -> V_151 == V_403 &&
V_149 -> V_153 == V_404 )
goto V_224;
if ( V_149 -> V_151 >= 0x5C && V_149 -> V_151 <= 0x5F && ! V_405 )
goto V_224;
return 0 ;
V_224:
...
V_149 -> V_367 = 0 ;
V_149 -> V_153 = V_407 ;
V_149 -> V_181 = ( V_406 / 512 ) >> 8 ;
V_149 -> V_176 = V_406 / 512 ;
V_149 -> V_151 = V_408 ;
V_149 -> V_13 |= V_226 | V_225 | V_180 |
V_265 ;
F_53 ( V_136 ) ;
return 0 ;
V_224:
...
goto V_224;
if ( ! F_52 ( V_143 ) || F_51 ( V_143 ) -> V_418 < V_42 )
goto V_419;
V_319 = F_159 ( F_160 ( F_51 ( V_143 ) ) ) ;
if ( V_42 < V_415 )
goto V_419;
if ( V_325 )
V_416 = V_319 [ 3 ] ;
...
struct V_25 * V_2 )
{
T_3 V_425 = V_143 -> V_222 [ 0 ] ;
T_9 V_274 ;
int V_29 = 0 ;
if ( V_2 -> V_46 == V_47 ) {
if ( F_17 ( ! V_143 -> V_223 || V_143 -> V_223 > V_2 -> V_344 ) )
goto V_426;
...
if ( F_17 ( V_42 > V_143 -> V_223 || V_42 > V_2 -> V_344 ) )
goto V_426;
V_274 = F_149 ;
} else {
if ( F_17 ( V_143 -> V_223 > 16 ) )
...
if ( V_274 )
V_29 = F_102 ( V_2 , V_143 , V_274 ) ;
else
F_170 ( V_2 , V_143 ) ;
return V_29 ;
V_426:
F_97 ( L_51 ,
V_143 -> V_223 , V_425 , V_2 -> V_344 ) ;
V_143 -> V_57 = V_284 << 16 ;
V_143 -> V_76 ( V_143 ) ;
return 0 ;
}
...
{
int V_159 , V_29 ;
for ( V_159 = 0 ; V_159 < V_30 -> V_445 ; V_159 ++ ) {
struct V_9 * V_10 = V_30 -> V_446 [ V_159 ] ;
struct V_7 * V_8 ;
V_29 = - V_109 ;
...
return 0 ;
V_460:
F_176 ( V_30 -> V_446 [ V_159 ] -> V_450 ) ;
V_447:
while ( -- V_159 >= 0 ) {
struct V_7 * V_8 = V_30 -> V_446 [ V_159 ] -> V_450 ;
F_177 ( V_8 ) ;
F_176 ( V_8 ) ;
}
return V_29 ;
...
void F_204 ( struct V_25 * V_2 )
{
if ( V_2 -> V_22 )
F_205 ( V_2 -> V_22 , V_207 ,
V_473 ) ;
}
void F_206 ( struct V_474 * V_475 )
{
struct V_9 * V_10 =
F_207 ( V_475 , struct V_9 , V_468 . V_475 ) ;
int V_159 ;
if ( V_10 -> V_36 & V_476 ) {
F_97 ( L_54 ) ;
return;
...
F_203 ( & V_10 -> V_24 ) ;
if ( V_10 -> V_360 )
for ( V_159 = 0 ; V_159 < V_478 ; V_159 ++ )
F_203 ( & V_10 -> V_360 [ V_159 ] ) ;
F_178 ( V_10 , 0 ) ;
F_199 ( & V_10 -> V_477 ) ;
F_97 ( L_36 ) ;
}
int F_208 ( struct V_7 * V_8 , unsigned int V_361 ,
...
void F_209 ( struct V_474 * V_475 )
{
struct V_9 * V_10 =
F_207 ( V_475 , struct V_9 , V_484 ) ;
struct V_23 * V_24 ;
struct V_25 * V_2 ;
unsigned long V_13 ;
F_193 ( & V_10 -> V_477 ) ;
...
struct V_9 * F_211 ( struct V_442 * V_30 ,
struct V_485 * V_486 ,
struct V_7 * V_8 )
{
struct V_9 * V_10 ;
...
int F_219 ( struct V_9 * V_10 )
{
int V_29 = V_10 -> V_61 -> V_495 ( V_10 ) ;
if ( V_29 )
return V_29 ;
V_10 -> V_175 = F_220 ( & V_496 ) ;
return 0 ;
}
...
int F_222 ( struct V_21 * V_22 , struct V_9 * V_10 )
{
F_61 ( V_22 ) ;
F_66 ( V_22 , V_10 -> V_24 . V_1 ) ;
return 0 ;
}
int F_223 ( struct V_52 * V_53 , struct V_9 * V_10 )
{
int V_29 = 0 ;
F_166 ( V_10 , V_53 ) ;
