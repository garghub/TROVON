...
static int F_163 ( struct V_2 * V_3 , struct V_382 * V_383 , const struct V_58 * V_59 , int V_384 )
{
int V_23 ;
struct V_41 * V_348 ;
struct V_58 * V_307 ;
...
static int F_164 ( T_3 V_134 )
{
return F_63 ( F_57 ( V_134 ) * 2 ) ;
}
static int F_165 ( struct V_78 * V_135 , int V_112 ,
T_4 * V_184 , T_4 * V_251 ,
T_9 * V_134 )
{
int V_441 , V_405 ;
if ( V_112 < F_164 ( V_135 -> V_84 ) )
return - V_71 ;
...
static int F_166 ( struct V_392 * V_442 , int V_47 ,
struct V_443 * V_444 )
{
int V_23 ;
struct V_392 * V_445 ;
...
V_47 < V_442 -> V_411 )
return - V_71 ;
V_23 = F_165 ( (struct V_78 * ) ( V_442 + 1 ) ,
V_442 -> V_411 ,
...
V_47 < V_445 -> V_411 )
return - V_71 ;
V_23 = F_165 ( (struct V_78 * ) ( V_445 + 1 ) ,
V_445 -> V_411 ,
...
V_452 = F_165 ( (struct V_78 * ) ( V_454 + 1 ) ,
...
V_452 = F_166 ( V_393 , V_47 , & V_444 [ V_352 ] ) ;
if ( V_452 < 0 ) {
V_23 = V_452 ;
goto V_35;
} else {
...
static int F_168 ( struct V_2 * V_3 , struct V_41 * V_8 , const struct V_58 * V_59 , void * const * V_108 )
{
struct V_10 * V_10 = F_7 ( V_3 ) ;
unsigned int V_384 ;
int V_23 = 0 , V_464 ;
...
return - V_71 ;
V_384 = F_169 ( V_409 -> V_424 ) ;
if ( V_384 >= V_465 )
return - V_71 ;
V_464 = ( V_59 -> V_320 == V_432 ) ;
V_383 = F_170 ( V_10 , V_146 , V_391 ,
...
V_23 = F_163 ( V_3 , V_383 , V_59 , V_384 ) ;
}
V_35:
F_157 ( V_383 ) ;
return V_23 ;
}
static int F_171 ( struct V_382 * V_383 , int V_384 , int V_373 , void * V_374 )
{
struct V_1 * V_6 = V_374 ;
struct V_41 * V_348 ;
struct V_58 * V_307 ;
...
{
struct V_10 * V_10 = F_7 ( & V_6 -> V_3 ) ;
return V_387 ( V_10 , & V_6 -> V_7 . V_378 . V_467 , F_171 , ( void * ) V_6 ) ;
}
static void F_173 ( struct V_1 * V_6 )
{
F_141 ( & V_6 -> V_7 . V_378 . V_467 ) ;
}
static int F_174 ( struct V_2 * V_3 , struct V_41 * V_8 , const struct V_58 * V_59 , void * const * V_108 )
{
struct V_1 * V_6 = F_1 ( V_3 ) ;
if ( V_6 -> V_7 . V_7 != NULL )
return - V_379 ;
...
static int F_175 ( const struct V_344 * V_345 )
{
struct V_41 * V_468 ;
struct V_58 * V_59 ;
...
static int F_176 ( struct V_2 * V_3 , struct V_41 * V_8 , const struct V_58 * V_59 , void * const * V_108 )
{
struct V_10 * V_10 = F_7 ( V_3 ) ;
struct V_344 V_345 ;
struct V_367 V_368 ;
...
static struct V_58 * F_179 ( struct V_41 * V_8 , int * V_472 )
{
...
static inline int F_180 ( const struct V_394 * V_395 ,
...
static int F_182 ( const struct V_394 * V_395 )
{
int V_352 , V_479 = 0 ;
for ( V_352 = 0 ; ; V_352 ++ ) {
...
if ( ! V_185 -> V_212 )
continue;
if ( F_180 ( V_395 , V_185 ) && V_185 -> V_360 )
...
if ( ! V_187 -> V_212 )
continue;
if ( ! ( F_181 ( V_395 , V_187 ) && V_187 -> V_360 ) )
continue;
for ( V_456 = 1 ; ; V_456 ++ ) {
...
static void F_184 ( struct V_41 * V_8 , const struct V_394 * V_395 )
{
struct V_481 * V_75 ;
int V_352 ;
...
static int F_186 ( struct V_382 * V_383 , const struct V_344 * V_345 )
{
return 0 ;
}
static int F_187 ( struct V_142 * V_164 , const struct V_344 * V_345 )
{
struct V_41 * V_348 ;
struct V_58 * V_307 ;
int V_499 ;
...
static int F_189 ( struct V_382 * V_383 , int V_384 , const struct V_344 * V_345 )
{
if ( V_383 && V_383 -> type != V_391 )
return 0 ;
switch ( V_345 -> V_328 ) {
case V_335 :
return F_186 ( V_383 , V_345 ) ;
case V_329 :
case V_331 :
case V_333 :
...
static int F_192 ( struct V_142 * V_164 , struct V_394 * V_395 , struct V_382 * V_383 )
{
struct V_41 * V_8 ;
struct V_58 * V_59 ;
struct V_76 * V_79 ;
...
V_59 -> V_63 = 0 ;
V_59 -> V_322 = 0 ;
V_59 -> V_62 = V_164 -> V_198 . V_303 = F_190 () ;
V_59 -> V_323 = 0 ;
V_79 = (struct V_76 * ) F_43 ( V_8 ,
sizeof( struct V_76 ) + V_178 ) ;
V_79 -> V_86 =
...
static struct V_382 * F_193 ( struct V_2 * V_3 , int V_505 ,
...
static int F_194 ( struct V_142 * V_164 , T_4 * V_510 , T_5 V_253 )
{
struct V_41 * V_8 ;
struct V_58 * V_59 ;
struct V_143 * V_135 ;
...
static int F_195 ( struct V_41 * V_8 , int V_512 , int type ,
...
static int F_196 ( struct V_41 * V_8 , const struct V_455 * V_456 )
{
struct V_453 * V_454 ;
T_7 * V_135 ;
...
static int F_197 ( struct V_41 * V_8 ,
...
static int F_198 ( const struct V_439 * V_183 , T_7 V_384 , T_7 type ,
...
V_59 -> V_62 = 0 ;
V_59 -> V_323 = 0 ;
if ( V_456 != NULL && ( F_196 ( V_8 , V_456 ) < 0 ) )
goto V_23;
F_195 ( V_8 , V_517 , V_119 , V_183 ) ;
F_195 ( V_8 , V_517 , V_120 , V_183 ) ;
V_409 = (struct V_408 * ) F_43 ( V_8 , sizeof( struct V_408 ) ) ;
V_409 -> V_410 = V_518 / 8 ;
V_409 -> V_415 = V_416 ;
V_409 -> V_417 = V_421 ;
...
if ( V_148 < 0 )
goto V_23;
if ( F_197 ( V_8 , V_519 -> V_133 , V_148 ,
...
static int F_199 ( struct V_522 * V_522 ,
...
goto V_35;
V_23 = - V_528 ;
if ( F_200 ( F_43 ( V_8 , V_47 ) , V_524 -> V_529 , V_47 ) )
goto V_35;
V_59 = F_179 ( V_8 , & V_23 ) ;
if ( ! V_59 )
goto V_35;
...
goto V_35;
V_524 -> V_536 = 0 ;
V_8 = F_202 ( V_3 , V_218 , V_218 & V_533 , & V_23 ) ;
if ( V_8 == NULL )
goto V_35;
V_531 = V_8 -> V_47 ;
if ( V_531 > V_47 ) {
...
F_203 ( V_8 ) ;
V_23 = F_204 ( V_8 , 0 , V_524 -> V_529 , V_531 ) ;
if ( V_23 )
goto V_537;
F_205 ( V_524 , V_3 , V_8 ) ;
...
static int F_207 ( struct V_538 * V_539 , void * V_540 )
{
struct V_2 * V_541 = F_208 ( V_540 ) ;
if ( V_540 == V_542 )
F_209 ( V_539 , L_4 ) ;
else
F_209 ( V_539 , L_5 ,
...
{
struct V_549 * V_550 ;
V_550 = F_225 ( L_6 , 0 , V_10 -> V_551 , & V_552 ) ;
if ( V_550 == NULL )
return - V_31 ;
return 0 ;
}
