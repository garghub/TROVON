...
void F_136 ( struct V_122 * V_123 , T_2 V_124 )
{
T_3 V_125 ;
T_3 V_126 ;
int V_127 ;
V_123 -> V_128 = ( T_3 ) V_124 << 3 ;
V_123 -> V_127 = 0 ;
V_123 -> V_126 = 1 ;
if ( V_123 -> V_128 > 0 ) {
for ( V_127 = 0 ; V_127 < 16 ; V_127 ++ ) {
V_123 -> V_127 = V_127 ;
V_125 = 8LLU * V_129 * ( 1 << V_123 -> V_127 ) ;
V_126 = F_137 ( V_125 , V_123 -> V_128 ) ;
if ( V_126 > V_130 )
break;
}
V_123 -> V_127 = V_127 - 1 ;
V_125 = 8LLU * V_129 * ( 1 << V_123 -> V_127 ) ;
V_123 -> V_126 = F_137 ( V_125 , V_123 -> V_128 ) ;
}
}
