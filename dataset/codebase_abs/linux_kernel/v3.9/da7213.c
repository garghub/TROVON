...
V_237 |
V_238 , V_213 ) ;
V_33 -> V_173 = V_193 -> V_239 ;
}
return 0 ;
}
static int F_28 ( struct V_240 * V_241 ,
const struct V_242 * V_243 )
{
struct V_32 * V_33 ;
struct V_192 * V_193 = F_29 ( & V_241 -> V_31 ) ;
int V_57 ;
V_33 = F_30 ( & V_241 -> V_31 , sizeof( struct V_32 ) ,
V_244 ) ;
if ( ! V_33 )
return - V_245 ;
if ( V_193 )
V_33 -> V_193 = V_193 ;
F_31 ( V_241 , V_33 ) ;
V_33 -> V_195 = F_32 ( V_241 , & V_246 ) ;
if ( F_33 ( V_33 -> V_195 ) ) {
V_57 = F_34 ( V_33 -> V_195 ) ;
F_22 ( & V_241 -> V_31 , L_6 , V_57 ) ;
return V_57 ;
}
V_57 = F_35 ( & V_241 -> V_31 ,
& V_247 , & V_248 , 1 ) ;
if ( V_57 < 0 ) {
F_22 ( & V_241 -> V_31 , L_7 ,
V_57 ) ;
...
static int F_36 ( struct V_240 * V_249 )
{
F_37 ( & V_249 -> V_31 ) ;
return 0 ;
}
