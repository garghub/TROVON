...
struct V_5 * V_6 = V_2 -> V_7 ;
struct V_55 * V_56 ;
unsigned long V_51 , V_273 ;
int V_274 , V_275 ;
F_90 ( V_2 , & V_255 -> V_2 ) ;
V_2 -> V_276 = V_4 -> V_277 ;
if ( F_91 ( V_255 , L_26 ) < 0 ) {
F_32 ( V_2 -> V_87 ,
L_27 ) ;
return - V_278 ;
}
...
F_93 ( V_2 -> V_87 ,
L_28 ,
V_2 -> V_276 , V_51 , V_273 ) ;
V_6 -> V_51 = V_51 ;
V_2 -> V_9 = V_273 ;
V_6 -> V_137 = F_3 ( V_2 -> V_9 + V_90 ) & V_138 ;
if ( F_80 ( V_255 , 3 ) >= 32 ) {
unsigned short V_279 = 0 ;
V_6 -> V_75 = F_3 ( V_2 -> V_9 + V_280 ) ;
...
F_93 ( V_2 -> V_87 , L_31 , V_255 -> V_244 ) ;
}
V_275 = F_96 ( V_2 , 3 ) ;
if ( V_275 )
return V_275 ;
V_56 = & V_2 -> V_286 [ 0 ] ;
V_56 -> type = V_287 ;
V_56 -> V_288 = V_289 | V_290 | V_291 ;
V_56 -> V_68 = V_4 -> V_292 ;
V_56 -> V_293 = ( 1 << V_4 -> V_11 ) - 1 ;
V_56 -> V_294 = & V_295 ;
V_56 -> V_296 = & F_25 ;
V_56 -> V_297 = 256 ;
if ( V_274 == 0 ) {
...
if ( V_4 -> V_282 > 0 ) {
V_56 -> type = V_302 ;
V_56 -> V_288 = V_303 | V_291 ;
V_56 -> V_68 = V_4 -> V_282 ;
V_56 -> V_293 = ( 1 << V_4 -> V_15 ) - 1 ;
V_56 -> V_294 = & V_304 ;
V_56 -> V_305 = & F_33 ;
V_56 -> V_296 = & F_34 ;
V_56 -> V_297 = V_4 -> V_282 ;
if ( V_274 == 0 ) {
V_2 -> V_251 = V_56 ;
V_56 -> V_288 |= V_306 ;
V_56 -> V_299 = & F_58 ;
...
static int F_98 ( struct V_1 * V_2 , struct V_259 * V_260 )
{
const struct V_3 * V_4 = F_2 ( V_2 ) ;
struct V_255 * V_255 ;
int V_275 ;
F_66 ( V_2 -> V_87 , L_33 ,
V_4 -> V_277 , V_260 -> V_262 [ 0 ] , V_260 -> V_262 [ 1 ] ) ;
V_275 = F_86 ( V_2 ) ;
if ( V_275 )
return V_275 ;
...
{
const struct V_3 * V_4 = F_2 ( V_2 ) ;
struct V_255 * V_310 = F_100 ( V_2 ) ;
if ( V_2 -> V_286 && V_4 -> V_193 )
F_104 ( V_2 , & V_2 -> V_286 [ 2 ] ) ;
if ( V_2 -> V_244 )
F_105 ( V_2 -> V_244 , V_2 ) ;
if ( V_310 ) {
if ( V_2 -> V_9 )
...
static int F_108 ( struct V_255 * V_2 ,
const struct V_311 * V_312 )
{
return F_109 ( V_2 , & V_313 ) ;
}
