...
static void F_64 ( struct V_7 * V_8 , int V_110 )
{
struct V_1 * V_2 ;
if ( ! V_8 || ! V_48 )
return;
...
void F_68 ( struct V_7 * V_8 , int V_110 )
{
...
static int F_69 ( struct V_112 * V_113 , void * V_114 )
{
if ( 0 == V_48 ) {
F_70 ( V_113 , L_44 ) ;
F_70 ( V_113 , L_45 , V_46 . V_47 ) ;
} else {
F_70 ( V_113 , L_46 ) ;
F_70 ( V_113 ,
L_47
...
static int F_71 ( struct V_115 * V_115 , struct V_116 * V_116 )
{
return F_72 ( V_116 , F_69 , NULL ) ;
}
static int T_5 F_73 ( void )
{
if ( F_74 ( V_117 ) )
F_75 ( L_53 , 0 , NULL , & V_118 ) ;
return 0 ;
}
