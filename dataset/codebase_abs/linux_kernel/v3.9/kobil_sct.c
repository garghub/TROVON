...
if ( V_74 -> V_78 ) {
F_23 ( & V_2 -> V_2 , V_76 , V_74 -> V_78 ) ;
F_24 ( & V_2 -> V_2 ) ;
}
V_53 = F_18 ( V_2 -> V_72 , V_73 ) ;
F_4 ( & V_2 -> V_23 , L_15 , V_33 , V_53 ) ;
}
static void F_25 ( struct V_74 * V_79 )
{
}
static int F_26 ( struct V_37 * V_38 , struct V_1 * V_2 ,
...
F_27 ( & V_2 -> V_23 , V_33 , V_81 , V_7 -> V_80 + V_7 -> V_20 ) ;
