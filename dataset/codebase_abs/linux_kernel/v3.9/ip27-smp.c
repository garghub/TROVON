...
static void T_9 F_34 ( int V_1 , struct V_54 * V_55 )
{
unsigned long V_56 = ( unsigned long ) F_35 ( V_55 ) ;
unsigned long V_57 = F_36 ( V_55 ) ;
...
static void T_8 F_42 ( unsigned int V_60 )
{
}
