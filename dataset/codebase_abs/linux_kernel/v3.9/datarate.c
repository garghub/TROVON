...
T_4 V_10 , T_4 V_11 ,
int V_12 , T_5 * V_13 , T_5 * V_14 ,
T_5 * V_15 , T_6 * V_16 , T_6 * V_17 )
{
int V_2 ;
T_6 V_18 = 0 , V_6 = 0 ;
T_5 V_19 = V_9 -> V_20 ;
...
T_7 V_44 [ V_3 ] = { 10 , 20 , 55 , 110 , 60 , 90 , 120 , 180 ,
240 , 360 , 480 , 540 } ;
T_7 V_45 = 0 ;
T_5 V_46 = 0 ;
T_7 V_47 = 0 ;
...
F_1 ( V_1 ) ;
F_5 ( V_23 , V_24 L_6 , ( int ) V_1 -> V_55 , ( int ) V_46 , ( int ) V_42 ) ;
return;
}
T_2
F_11 (
