...
void F_72 ( struct V_114 * V_115 , T_6 V_116 )
{
unsigned long V_104 ;
...
void F_75 ( struct V_114 * V_115 , bool V_122 )
{
unsigned long V_104 ;
struct V_1 * V_2 = F_73 ( V_115 -> V_117 -> V_118 ) ;
void T_2 * V_119 = V_2 -> V_20 ;
...
if ( ! V_90 -> V_96 . V_132 )
V_90 -> V_96 . V_132 = & V_133 ;
F_44 ( V_90 , V_92 ) ;
V_4 = F_77 ( & V_90 -> V_96 , sizeof( struct V_3 ) ,
V_134 ) ;
if ( ! V_4 )
return - V_87 ;
V_2 = F_78 ( & V_135 , & V_90 -> V_96 ,
F_79 ( & V_90 -> V_96 ) ) ;
if ( ! V_2 ) {
F_48 ( & V_90 -> V_96 , L_11 ) ;
return - V_87 ;
...
if ( V_93 )
goto V_136;
V_4 -> V_47 = F_84 ( V_90 -> V_96 . V_97 ,
L_13 ) ;
V_125 = F_85 ( V_90 , V_137 , 0 ) ;
if ( ! V_125 ) {
F_48 ( & V_90 -> V_96 , L_14 ) ;
V_93 = - V_138 ;
goto V_139;
...
V_2 -> V_142 = F_86 ( V_125 ) ;
V_2 -> V_20 = F_87 ( & V_90 -> V_96 , V_125 -> V_141 , F_86 ( V_125 ) ) ;
if ( ! V_2 -> V_20 ) {
F_48 ( & V_90 -> V_96 , L_15 ) ;
V_93 = - V_87 ;
goto V_139;
...
V_4 -> V_8 = F_88 ( & V_90 -> V_96 , V_127 , V_2 -> V_20 ,
V_92 -> V_147 ,
V_148 ) ;
if ( F_82 ( V_4 -> V_8 ) ) {
F_48 ( & V_90 -> V_96 , L_17 ) ;
...
F_89 ( V_2 -> V_8 ) ;
V_129 -> V_117 = F_77 ( & V_90 -> V_96 , sizeof( struct V_149 ) ,
V_134 ) ;
if ( ! V_129 -> V_117 ) {
F_48 ( & V_90 -> V_96 , L_18 ) ;
V_93 = - V_87 ;
...
if ( V_92 -> V_151 == V_152 ) {
V_4 -> V_153 =
F_93 ( & V_90 -> V_96 , V_154 ) ;
if ( ! F_94 ( V_4 -> V_153 ) )
F_95 ( V_4 -> V_153 -> V_117 , & V_2 -> V_5 ) ;
}
#endif
V_93 = F_96 ( V_2 , V_126 , V_155 ) ;
if ( V_93 ) {
F_48 ( & V_90 -> V_96 , L_21 ) ;
goto V_150;
}
...
static void F_106 ( struct V_89 * V_90 )
{
struct V_3 * V_4 = F_51 ( V_90 ) ;
struct V_1 * V_2 = F_53 ( V_4 -> V_11 ) ;
if ( V_2 -> V_156 -> V_157 )
