...
F_23 ( V_67 ) ;
F_24 ( & V_24 -> V_68 . V_54 ) ;
V_66 = F_25 ( & V_24 -> V_68 . V_69 , V_19 , V_24 -> V_68 . V_70 ++ , 0 ,
V_71 ) ;
if ( V_66 >= 0 )
V_19 -> V_72 = V_66 ;
F_26 ( & V_24 -> V_68 . V_54 ) ;
...
static void F_28 ( struct V_23 * V_24 , int V_72 )
{
F_24 ( & V_24 -> V_68 . V_54 ) ;
F_29 ( & V_24 -> V_68 . V_69 , V_72 ) ;
F_26 ( & V_24 -> V_68 . V_54 ) ;
}
struct V_18 * F_30 ( struct V_23 * V_24 , int V_72 )
{
unsigned long V_34 ;
struct V_18 * V_19 ;
F_10 ( & V_24 -> V_68 . V_54 , V_34 ) ;
V_19 = F_31 ( & V_24 -> V_68 . V_69 , V_72 ) ;
...
struct V_78 * V_31 ;
struct V_32 * V_33 ;
struct V_79 * V_80 = F_33 ( V_76 -> V_80 ) ;
struct V_79 * V_81 = F_33 ( V_76 -> V_81 ) ;
unsigned long V_82 ;
T_2 V_83 , V_84 , V_85 ;
void T_3 * V_86 ;
int V_36 ;
...
if ( V_36 )
return V_36 ;
V_19 -> V_87 . V_88 = V_19 -> V_72 ;
V_19 -> V_87 . V_89 = V_90 ;
V_19 -> V_91 . V_92 = F_34 ( V_24 , V_24 -> V_93 ,
& V_19 -> V_91 . V_94 , V_67 ) ;
if ( ! V_19 -> V_91 . V_92 ) {
V_36 = - V_38 ;
goto V_52;
}
V_19 -> V_95 . V_92 = F_34 ( V_24 , V_24 -> V_93 ,
& V_19 -> V_95 . V_94 , V_67 ) ;
if ( ! V_19 -> V_95 . V_92 ) {
V_36 = - V_38 ;
goto V_96;
...
V_29 . V_115 = F_35 ( V_19 -> V_91 . V_94 ) ;
V_29 . V_116 = F_35 ( V_19 -> V_95 . V_94 ) ;
V_29 . V_45 = F_9 ( V_117 ) ;
V_29 . V_47 = F_9 ( V_118 ) ;
...
F_38 ( & V_19 -> V_124 ) ;
V_83 = F_39 ( V_31 -> V_48 ) ;
V_84 = F_39 ( V_31 -> V_125 ) ;
V_82 = V_24 -> V_126 + F_39 ( V_31 -> V_127 ) ;
V_85 = F_40 ( sizeof( struct V_128 ) + V_84 * V_83 ) ;
V_86 = F_41 ( V_82 , V_85 ) ;
if ( ! V_86 ) {
V_36 = - V_38 ;
goto V_129;
...
V_131 ) ;
V_83 = F_39 ( V_31 -> V_49 ) ;
V_84 = F_39 ( V_31 -> V_132 ) ;
V_82 = V_24 -> V_126 + F_39 ( V_31 -> V_133 ) ;
V_85 = F_40 ( sizeof( struct V_128 ) + V_84 * V_83 ) ;
V_86 = F_41 ( V_82 , V_85 ) ;
if ( ! V_86 ) {
V_36 = - V_38 ;
...
static inline void F_45 ( struct V_79 * V_80 , struct V_79 * V_81 )
{
if ( V_80 == V_81 )
F_24 ( & V_80 -> V_54 ) ;
else if ( V_80 > V_81 ) {
F_24 ( & V_80 -> V_54 ) ;
F_46 ( & V_81 -> V_54 , V_137 ) ;
} else {
F_24 ( & V_81 -> V_54 ) ;
F_46 ( & V_80 -> V_54 , V_137 ) ;
}
}
static inline void F_47 ( struct V_79 * V_80 , struct V_79 * V_81 )
{
if ( V_80 == V_81 )
F_26 ( & V_80 -> V_54 ) ;
else if ( V_80 > V_81 ) {
...
struct V_79 * V_80 ;
struct V_79 * V_81 ;
V_80 = F_33 ( V_19 -> V_87 . V_80 ) ;
V_81 = F_33 ( V_19 -> V_87 . V_81 ) ;
F_45 ( V_80 , V_81 ) ;
F_28 ( V_24 , V_19 -> V_72 ) ;
F_47 ( V_80 , V_81 ) ;
F_21 ( V_24 , V_19 ) ;
F_50 ( V_24 , V_19 , V_80 -> V_138 ) ;
if ( V_80 != V_81 )
F_50 ( V_24 , V_19 , V_81 -> V_138 ) ;
F_43 ( V_19 -> V_91 . V_136 ) ;
F_43 ( V_19 -> V_95 . V_136 ) ;
F_44 ( V_19 -> V_91 . V_92 ) ;
F_44 ( V_19 -> V_95 . V_92 ) ;
F_51 ( & V_19 -> V_123 ) ;
F_52 ( V_19 -> V_124 , ! F_53 ( & V_19 -> V_123 ) ) ;
}
static int
F_54 ( struct V_139 * V_140 , struct V_141 * V_142 , int V_143 , T_2 * V_144 ,
T_1 * V_145 )
{
T_2 V_146 = 0 ;
T_1 V_147 = 0 ;
...
static inline void F_55 ( struct V_23 * V_24 , T_2 V_153 , T_4 V_92 )
{
while ( F_56 ( V_24 -> V_154 + V_155 ) & 0x80000000 )
F_57 ( 10 ) ;
F_58 ( F_59 ( V_153 , V_92 ) ,
V_24 -> V_154 + V_155 ) ;
}
static int F_60 ( struct V_156 * V_157 , union V_60 * V_29 , struct V_18 * V_19 , T_2 V_158 )
{
union V_60 * V_159 ;
V_159 = F_61 ( V_157 ) ;
if ( V_159 == NULL ) {
...
int F_65 ( struct V_164 * V_87 , struct V_165 * V_166 ,
struct V_165 * * V_167 )
{
struct V_23 * V_24 = F_66 ( V_87 -> V_168 ) ;
struct V_18 * V_19 = F_67 ( V_87 ) ;
union V_60 V_29 ;
unsigned long V_169 ;
int V_36 = 0 ;
T_2 V_34 ;
...
V_36 = F_54 ( (struct V_139 * ) & ( V_29 . V_173 . V_186 . V_196 ) ,
V_166 -> V_197 ,
V_166 -> V_193 ,
& V_170 , & V_171 ) ;
...
F_35 ( V_166 -> V_29 . V_203 . V_206 ) ;
V_36 = F_54 ( (struct V_139 * )
...
V_36 = F_60 ( & V_19 -> V_91 , & V_29 , V_19 , V_84 ) ;
if ( V_36 ) {
F_11 ( & V_19 -> V_54 , V_169 ) ;
break;
}
F_55 ( V_24 , V_19 -> V_91 . V_213 , V_19 -> V_91 . V_214 ) ;
F_11 ( & V_19 -> V_54 , V_169 ) ;
V_166 = V_166 -> V_215 ;
}
V_172:
...
int F_70 ( struct V_164 * V_87 , struct V_216 * V_166 ,
struct V_216 * * V_167 )
{
struct V_23 * V_24 = F_66 ( V_87 -> V_168 ) ;
struct V_18 * V_19 = F_67 ( V_87 ) ;
...
F_8 ( & V_29 , V_219 ) ;
F_69 ( & V_29 , 0 ) ;
F_71 ( V_166 -> V_193 >= 256 ) ;
V_36 = F_54 ( (struct V_139 * ) & ( V_29 . V_217 . V_196 ) ,
V_166 -> V_197 ,
...
F_10 ( & V_19 -> V_54 , V_169 ) ;
V_36 = F_60 ( & V_19 -> V_95 , & V_29 , V_19 , V_19 -> V_95 . V_84 ) ;
if ( V_36 ) {
F_11 ( & V_19 -> V_54 , V_169 ) ;
break;
}
F_55 ( V_24 , V_19 -> V_95 . V_213 , V_19 -> V_95 . V_214 ) ;
F_11 ( & V_19 -> V_54 , V_169 ) ;
V_166 = V_166 -> V_215 ;
}
V_172:
