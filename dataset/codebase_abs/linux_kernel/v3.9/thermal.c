...
return 0 ;
F_27 ( V_2 -> V_9 , type , 1 ) ;
F_28 ( V_2 -> V_9 -> V_76 . V_77 ,
F_29 ( & V_2 -> V_9 -> V_78 ) , type , 1 ) ;
if ( V_73 == V_64 && V_79 )
return 1 ;
return 0 ;
}
...
struct V_80 * V_81 )
{
return F_30 ( V_53 , V_81 , true ) ;
}
static int
F_36 ( struct V_52 * V_53 ,
struct V_80 * V_81 )
{
return F_30 ( V_53 , V_81 , false ) ;
}
...
if ( F_39 ( V_2 -> V_51 ) )
return - V_11 ;
V_56 = F_40 ( & V_2 -> V_9 -> V_78 . V_90 ,
& V_2 -> V_51 -> V_9 . V_90 , L_32 ) ;
if ( V_56 )
return V_56 ;
V_56 = F_40 ( & V_2 -> V_51 -> V_9 . V_90 ,
...
V_2 -> V_50 = 1 ;
F_42 ( & V_2 -> V_9 -> V_78 , L_34 ,
V_2 -> V_51 -> V_92 ) ;
return 0 ;
}
static void F_43 ( struct V_1 * V_2 )
{
F_44 ( & V_2 -> V_9 -> V_78 . V_90 , L_32 ) ;
F_44 ( & V_2 -> V_51 -> V_9 . V_90 , L_22 ) ;
F_45 ( V_2 -> V_51 ) ;
V_2 -> V_51 = NULL ;
F_46 ( V_2 -> V_9 -> V_10 , V_91 ) ;
}
static void F_47 ( struct V_83 * V_9 , T_4 V_93 )
{
...
static int F_52 ( struct V_83 * V_9 )
{
int V_56 = 0 ;
struct V_1 * V_2 = NULL ;
if ( ! V_9 )
return - V_6 ;
V_2 = F_53 ( sizeof( struct V_1 ) , V_103 ) ;
if ( ! V_2 )
return - V_104 ;
V_2 -> V_9 = V_9 ;
strcpy ( V_2 -> V_44 , V_9 -> V_76 . V_105 ) ;
strcpy ( F_54 ( V_9 ) , V_106 ) ;
strcpy ( F_55 ( V_9 ) , V_107 ) ;
V_9 -> V_108 = V_2 ;
F_56 ( & V_2 -> V_109 ) ;
V_56 = F_50 ( V_2 ) ;
if ( V_56 )
...
static int F_58 ( struct V_83 * V_9 )
{
struct V_1 * V_2 = NULL ;
if ( ! V_9 || ! F_48 ( V_9 ) )
return - V_6 ;
...
static int F_60 ( struct V_9 * V_78 )
{
struct V_1 * V_2 ;
int V_25 , V_84 , V_112 , V_56 ;
if ( ! V_78 )
return - V_6 ;
V_2 = F_48 ( F_61 ( V_78 ) ) ;
if ( ! V_2 )
