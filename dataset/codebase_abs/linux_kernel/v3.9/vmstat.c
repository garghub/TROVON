...
unsigned long V_87 = F_76 ( V_10 ) ;
unsigned long V_46 [ V_78 ] = { 0 , } ;
for ( V_84 = V_85 ; V_84 < V_87 ; V_84 += V_88 ) {
struct V_35 * V_35 ;
if ( ! F_77 ( V_84 ) )
continue;
V_35 = F_78 ( V_84 ) ;
if ( ! F_79 ( V_84 , V_35 , V_10 ) )
continue;
V_77 = F_80 ( V_35 ) ;
if ( V_77 < V_78 )
V_46 [ V_77 ] ++ ;
...
static int F_82 ( struct V_69 * V_70 , void * V_72 )
{
T_1 * V_21 = ( T_1 * ) V_72 ;
if ( ! F_83 ( V_21 -> V_75 , V_89 ) )
return 0 ;
F_69 ( V_70 , L_11 , V_90 ) ;
F_69 ( V_70 , L_12 , V_88 ) ;
F_70 ( V_70 , '\n' ) ;
...
{
return F_85 ( V_92 , & V_93 ) ;
}
static int F_86 ( struct V_91 * V_91 , struct V_92 * V_92 )
{
return F_85 ( V_92 , & V_94 ) ;
}
static void F_87 ( struct V_69 * V_70 , T_1 * V_21 ,
struct V_10 * V_10 )
{
int V_3 ;
...
L_23 ,
V_10 -> V_100 [ 0 ] ) ;
for ( V_3 = 1 ; V_3 < F_89 ( V_10 -> V_100 ) ; V_3 ++ )
...
static int F_91 ( struct V_69 * V_70 , void * V_72 )
{
T_1 * V_21 = ( T_1 * ) V_72 ;
F_63 ( V_70 , V_21 , F_87 ) ;
return 0 ;
}
static int F_92 ( struct V_91 * V_91 , struct V_92 * V_92 )
{
return F_85 ( V_92 , & V_105 ) ;
}
static void * F_93 ( struct V_69 * V_70 , T_5 * V_71 )
{
unsigned long * V_33 ;
int V_3 , V_106 ;
if ( * V_71 >= F_89 ( V_99 ) )
...
static void * F_99 ( struct V_69 * V_70 , void * V_72 , T_5 * V_71 )
{
( * V_71 ) ++ ;
if ( * V_71 >= F_89 ( V_99 ) )
return NULL ;
...
static int F_100 ( struct V_69 * V_70 , void * V_72 )
{
...
static void F_101 ( struct V_69 * V_70 , void * V_72 )
{
F_102 ( V_70 -> V_109 ) ;
V_70 -> V_109 = NULL ;
}
static int F_103 ( struct V_91 * V_91 , struct V_92 * V_92 )
{
return F_85 ( V_92 , & V_117 ) ;
}
static void F_104 ( struct V_118 * V_119 )
{
F_45 ( F_105 () ) ;
F_106 ( & F_107 ( V_120 ) ,
F_108 ( V_121 ) ) ;
}
static void T_6 F_109 ( int V_2 )
{
struct V_122 * V_123 = & F_3 ( V_120 , V_2 ) ;
F_110 ( V_123 , F_104 ) ;
F_111 ( V_2 , V_123 , F_112 ( V_124 , V_2 ) ) ;
}
static int T_6 F_113 ( struct V_125 * V_126 ,
unsigned long V_127 ,
void * V_128 )
{
long V_2 = ( long ) V_128 ;
...
#endif
#ifdef F_119
F_120 ( L_36 , V_141 , NULL , & V_142 ) ;
F_120 ( L_37 , V_141 , NULL , & V_143 ) ;
F_120 ( L_38 , V_141 , NULL , & V_144 ) ;
F_120 ( L_39 , V_141 , NULL , & V_145 ) ;
#endif
return 0 ;
}
static int F_121 ( unsigned int V_60 ,
struct V_58 * V_59 )
{
if ( V_59 -> V_61 == 0 )
return 1000 ;
...
for ( V_60 = 0 ; V_60 < V_64 ; ++ V_60 ) {
F_54 ( V_10 , V_60 , & V_59 ) ;
V_146 = F_121 ( V_60 , & V_59 ) ;
F_69 ( V_70 , L_40 , V_146 / 1000 , V_146 % 1000 ) ;
}
F_70 ( V_70 , '\n' ) ;
}
static int F_123 ( struct V_69 * V_70 , void * V_72 )
{
T_1 * V_21 = ( T_1 * ) V_72 ;
if ( ! F_83 ( V_21 -> V_75 , V_89 ) )
return 0 ;
F_63 ( V_70 , V_21 , F_122 ) ;
return 0 ;
}
static int F_124 ( struct V_91 * V_91 , struct V_92 * V_92 )
{
return F_85 ( V_92 , & V_147 ) ;
}
...
static int F_126 ( struct V_69 * V_70 , void * V_72 )
{
T_1 * V_21 = ( T_1 * ) V_72 ;
F_63 ( V_70 , V_21 , F_125 ) ;
return 0 ;
}
static int F_127 ( struct V_91 * V_91 , struct V_92 * V_92 )
{
return F_85 ( V_92 , & V_148 ) ;
}
static int T_7 F_128 ( void )
{
struct V_149 * V_150 ;
V_150 = F_129 ( L_41 , NULL ) ;
if ( ! V_150 )
return - V_110 ;
if ( ! F_130 ( L_42 , 0444 ,
V_150 , NULL , & V_151 ) )
