...
static int F_155 ( struct V_4 * V_5 , T_7 V_171 , int V_172 )
{
int V_64 = 0 ;
struct V_136 * V_137 = V_5 -> V_159 ;
...
V_64 = V_137 -> V_140 -> V_205 ( V_137 , V_171 ) ;
}
if ( ! V_5 -> V_180 ) {
...
int F_162 ( struct V_4 * V_5 , T_7 V_171 )
{
F_36 ( & V_5 -> V_85 ) ;
if ( V_171 & V_190 ) {
bool V_206 ;
