...
int V_45 ;
V_106 = F_40 ( V_104 , V_109 , 0 ) ;
if ( ! V_106 ) {
F_9 ( & V_104 -> V_8 , L_18 ) ;
return - V_110 ;
}
V_107 = F_40 ( V_104 , V_111 , 0 ) ;
if ( ! V_107 ) {
F_9 ( & V_104 -> V_8 , L_19 ) ;
return - V_110 ;
}
V_108 = F_41 ( V_106 -> V_112 , F_42 ( V_106 ) ,
V_104 -> V_113 ) ;
if ( ! V_108 ) {
F_9 ( & V_104 -> V_8 , L_20 ) ;
return - V_114 ;
}
V_8 = F_43 ( sizeof( struct V_1 ) , V_115 ) ;
if ( ! V_8 ) {
V_45 = - V_116 ;
goto V_117;
}
...
F_44 ( & V_8 -> V_75 ) ;
#endif
V_8 -> V_8 = F_45 ( & V_104 -> V_8 ) ;
V_8 -> V_107 = V_107 -> V_112 ;
V_8 -> V_11 = V_8 -> V_8 -> V_118 ;
F_46 ( V_104 , V_8 ) ;
if ( ! V_8 -> V_11 && V_104 -> V_8 . V_119 ) {
T_2 V_120 ;
V_8 -> V_11 = F_47 ( & V_104 -> V_8 ,
sizeof( struct V_10 ) , V_115 ) ;
if ( ! V_8 -> V_11 ) {
V_45 = - V_116 ;
goto V_121;
}
memcpy ( V_8 -> V_11 , & V_122 ,
sizeof( struct V_10 ) ) ;
if ( ! F_48 ( V_104 -> V_8 . V_119 , L_21 ,
& V_120 ) )
V_8 -> V_11 -> V_23 = V_120 / 1000 ;
} else if ( ! V_8 -> V_11 ) {
V_8 -> V_11 = & V_122 ;
}
V_8 -> V_18 = F_49 ( & V_104 -> V_8 , NULL ) ;
if ( F_50 ( V_8 -> V_18 ) ) {
V_45 = - V_110 ;
goto V_121;
}
F_51 ( V_8 -> V_18 ) ;
V_8 -> V_5 = F_52 ( V_106 -> V_112 , F_42 ( V_106 ) ) ;
if ( ! V_8 -> V_5 ) {
V_45 = - V_114 ;
goto V_123;
}
F_14 ( V_8 ) ;
V_45 = F_53 ( V_8 -> V_107 , F_31 , 0 , V_104 -> V_113 , V_8 ) ;
if ( V_45 ) {
F_9 ( & V_104 -> V_8 , L_22 , V_8 -> V_107 ) ;
goto V_124;
}
V_45 = F_35 ( V_8 ) ;
if ( V_45 ) {
...
V_41 -> V_126 = V_127 ;
V_41 -> V_128 = V_129 ;
F_55 ( V_41 -> V_113 , L_24 , sizeof( V_41 -> V_113 ) ) ;
V_41 -> V_130 = & V_131 ;
V_41 -> V_8 . V_132 = & V_104 -> V_8 ;
V_41 -> V_32 = V_133 ;
V_41 -> V_8 . V_119 = V_104 -> V_8 . V_119 ;
V_41 -> V_134 = V_104 -> V_135 ;
V_45 = F_56 ( V_41 ) ;
if ( V_45 ) {
F_9 ( & V_104 -> V_8 , L_25 ) ;
goto V_125;
...
F_63 ( V_8 ) ;
V_117:
F_64 ( V_106 -> V_112 , F_42 ( V_106 ) ) ;
return V_45 ;
}
static int F_65 ( struct V_103 * V_104 )
{
struct V_1 * V_8 = F_66 ( V_104 ) ;
struct V_105 * V_106 ;
F_37 ( V_8 ) ;
F_67 ( & V_8 -> V_35 ) ;
F_62 ( & V_104 -> V_8 ) ;
...
static int F_68 ( struct V_136 * V_8 )
{
struct V_103 * V_104 = F_69 ( V_8 ) ;
struct V_1 * V_2 = F_66 ( V_104 ) ;
F_10 ( V_2 , 0 ) ;
F_60 ( V_2 -> V_18 ) ;
return 0 ;
}
static int F_70 ( struct V_136 * V_8 )
{
struct V_103 * V_104 = F_69 ( V_8 ) ;
struct V_1 * V_2 = F_66 ( V_104 ) ;
F_51 ( V_2 -> V_18 ) ;
