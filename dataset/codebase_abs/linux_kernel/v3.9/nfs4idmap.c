...
static int
F_52 ( struct V_64 * V_65 , int type , T_3 V_8 , char * V_9 )
{
struct V_4 * V_49 , V_71 = {
. V_8 = V_8 ,
. type = type ,
...
static bool
F_54 ( struct V_64 * V_65 , int type , const char * V_9 , T_3 V_70 , T_3 * V_8 )
{
int V_72 ;
char V_35 [ 11 ] ;
...
V_35 [ V_70 ] = '\0' ;
V_72 = F_55 ( V_35 , 10 , V_8 ) ;
return V_72 == 0 ;
}
static T_2
F_56 ( struct V_64 * V_65 , int type , const char * V_9 , T_3 V_70 , T_3 * V_8 )
{
if ( V_74 && V_65 -> V_75 . V_76 < V_77 )
if ( F_54 ( V_65 , type , V_9 , V_70 , V_8 ) )
return 0 ;
return F_48 ( V_65 , type , V_9 , V_70 , V_8 ) ;
}
static int
F_57 ( struct V_64 * V_65 , int type , T_3 V_8 , char * V_9 )
{
if ( V_74 && V_65 -> V_75 . V_76 < V_77 )
return sprintf ( V_9 , L_1 , V_8 ) ;
return F_52 ( V_65 , type , V_8 , V_9 ) ;
}
T_2
F_58 ( struct V_64 * V_65 , const char * V_9 , T_4 V_70 ,
T_5 * V_78 )
{
T_2 V_79 ;
T_3 V_8 = - 1 ;
V_79 = F_56 ( V_65 , V_45 , V_9 , V_70 , & V_8 ) ;
* V_78 = F_59 ( & V_80 , V_8 ) ;
if ( ! F_60 ( * V_78 ) )
V_79 = V_73 ;
return V_79 ;
...
T_2 V_79 ;
T_3 V_8 = - 1 ;
V_79 = F_56 ( V_65 , V_18 , V_9 , V_70 , & V_8 ) ;
* V_81 = F_62 ( & V_80 , V_8 ) ;
if ( ! F_63 ( * V_81 ) )
V_79 = V_73 ;
return V_79 ;
...
int
F_64 ( struct V_64 * V_65 , T_5 V_78 , char * V_9 )
{
T_3 V_8 = F_65 ( & V_80 , V_78 ) ;
return F_57 ( V_65 , V_45 , V_8 , V_9 ) ;
}
int
F_66 ( struct V_64 * V_65 , T_6 V_81 , char * V_9 )
{
T_3 V_8 = F_67 ( & V_80 , V_81 ) ;
return F_57 ( V_65 , V_18 , V_8 , V_9 ) ;
}
