...
static int
F_91 ( struct V_136 * V_136 , struct V_188 T_4 * V_189 ,
const int * V_110 )
{
int V_12 ;
struct V_188 V_190 ;
...
static int
F_92 ( struct V_136 * V_136 , const char * V_59 , unsigned int V_102 ,
...
V_195 = F_93 ( V_55 , V_193 , V_121 , & V_12 ) ;
if ( ! V_195 )
goto V_198;
F_8 ( L_50 ,
...
static int
F_95 ( struct V_136 * V_136 , const void T_4 * V_128 , unsigned int V_110 )
{
int V_12 ;
struct V_160 V_186 ;
struct V_73 * V_121 ;
...
goto V_200;
F_8 ( L_51 ) ;
V_12 = F_92 ( V_136 , V_186 . V_59 , V_186 . V_102 , V_121 ,
...
static int
F_97 ( struct V_136 * V_136 , const void T_4 * V_128 ,
...
static int
F_99 ( struct V_43 * V_48 , void T_4 * * V_209 ,
...
F_31 (ematch, e) {
V_12 = F_100 ( V_105 , V_209 , V_130 ) ;
if ( V_12 != 0 )
return V_12 ;
}
V_62 = V_48 -> V_62 - ( V_211 - * V_130 ) ;
V_55 = F_14 ( V_48 ) ;
V_12 = F_101 ( V_55 , V_209 , V_130 ) ;
if ( V_12 )
return V_12 ;
V_133 = V_48 -> V_133 - ( V_211 - * V_130 ) ;
if ( F_102 ( V_62 , & V_210 -> V_62 ) != 0 ||
F_102 ( V_133 , & V_210 -> V_133 ) != 0 )
return - V_176 ;
return 0 ;
}
static int
F_103 ( struct V_104 * V_135 ,
const char * V_59 ,
...
static void F_104 ( struct V_181 * V_48 )
{
struct V_47 * V_55 ;
struct V_104 * V_105 ;
F_31 (ematch, e)
...
static int
F_107 ( struct V_181 * V_48 , void * * V_209 ,
...
static int
F_110 ( struct V_43 * V_48 , struct V_136 * V_136 , const char * V_59 )
{
struct V_104 * V_105 ;
struct V_142 V_152 ;
unsigned int V_151 ;
...
static int
F_112 ( struct V_136 * V_136 , void T_4 * V_128 , unsigned int V_110 )
{
int V_12 ;
struct V_223 V_186 ;
struct V_73 * V_121 ;
...
V_12 = F_111 ( V_136 , V_186 . V_59 , V_186 . V_102 ,
...
static int
F_115 ( struct V_224 * V_225 , int V_226 , void T_4 * V_128 ,
unsigned int V_110 )
{
int V_12 ;
if ( ! F_116 ( F_117 ( V_225 ) -> V_227 , V_228 ) )
return - V_229 ;
switch ( V_226 ) {
case V_230 :
V_12 = F_112 ( F_117 ( V_225 ) , V_128 , V_110 ) ;
break;
case V_231 :
V_12 = F_97 ( F_117 ( V_225 ) , V_128 , V_110 , 1 ) ;
break;
default:
F_8 ( L_59 , V_226 ) ;
V_12 = - V_140 ;
...
static int
F_118 ( unsigned int V_171 , struct V_1 * V_84 ,
void T_4 * V_172 )
{
struct V_158 * V_109 ;
const struct V_73 * V_74 = V_84 -> V_74 ;
...
static int
F_119 ( struct V_136 * V_136 , struct V_232 T_4 * V_189 ,
int * V_110 )
{
int V_12 ;
struct V_232 V_190 ;
...
if ( F_82 ( & V_190 , V_189 , sizeof( V_190 ) ) != 0 )
return - V_176 ;
if ( * V_110 != sizeof( struct V_232 ) + V_190 . V_130 ) {
F_8 ( L_61 ,
* V_110 , sizeof( V_190 ) + V_190 . V_130 ) ;
return - V_140 ;
}
...
switch ( V_226 ) {
case V_233 :
V_12 = F_81 ( F_117 ( V_225 ) , V_128 , V_110 , 1 ) ;
break;
case V_234 :
V_12 = F_119 ( F_117 ( V_225 ) , V_128 , V_110 ) ;
break;
default:
V_12 = F_121 ( V_225 , V_226 , V_128 , V_110 ) ;
}
return V_12 ;
}
static int
F_122 ( struct V_224 * V_225 , int V_226 , void T_4 * V_128 , unsigned int V_110 )
{
int V_12 ;
if ( ! F_116 ( F_117 ( V_225 ) -> V_227 , V_228 ) )
return - V_229 ;
switch ( V_226 ) {
case V_230 :
V_12 = F_95 ( F_117 ( V_225 ) , V_128 , V_110 ) ;
break;
case V_231 :
V_12 = F_97 ( F_117 ( V_225 ) , V_128 , V_110 , 0 ) ;
break;
default:
F_8 ( L_59 , V_226 ) ;
V_12 = - V_140 ;
...
static int
F_121 ( struct V_224 * V_225 , int V_226 , void T_4 * V_128 , int * V_110 )
{
int V_12 ;
if ( ! F_116 ( F_117 ( V_225 ) -> V_227 , V_228 ) )
return - V_229 ;
switch ( V_226 ) {
case V_233 :
V_12 = F_81 ( F_117 ( V_225 ) , V_128 , V_110 , 0 ) ;
break;
case V_234 :
V_12 = F_91 ( F_117 ( V_225 ) , V_128 , V_110 ) ;
break;
case V_235 :
case V_236 : {
struct V_237 V_238 ;
int V_56 ;
if ( * V_110 != sizeof( V_238 ) ) {
V_12 = - V_140 ;
break;
}
if ( F_82 ( & V_238 , V_128 , sizeof( V_238 ) ) != 0 ) {
V_12 = - V_176 ;
break;
}
V_238 . V_59 [ sizeof( V_238 . V_59 ) - 1 ] = 0 ;
if ( V_226 == V_236 )
V_56 = 1 ;
else
V_56 = 0 ;
F_85 ( F_123 ( V_82 , V_238 . V_59 ,
V_238 . V_146 ,
V_56 , & V_12 ) ,
L_63 , V_238 . V_59 ) ;
break;
...
struct V_1 * F_124 ( struct V_136 * V_136 ,
const struct V_1 * V_84 ,
const struct V_160 * V_161 )
{
int V_12 ;
...
if ( V_12 != 0 )
goto V_241;
V_240 = F_125 ( V_136 , V_84 , & V_239 , V_121 ) ;
if ( F_48 ( V_240 ) ) {
V_12 = F_49 ( V_240 ) ;
goto V_241;
}
...
void F_126 ( struct V_136 * V_136 , struct V_1 * V_84 )
{
struct V_73 * V_74 ;
void * V_175 ;
struct V_242 * V_243 = V_84 -> V_139 ;
struct V_43 * V_77 ;
V_74 = F_127 ( V_84 ) ;
V_175 = V_74 -> V_78 [ F_68 () ] ;
F_18 (iter, loc_cpu_entry, private->size)
...
static inline bool
F_128 ( T_7 V_244 , T_7 V_245 , T_7 V_246 ,
T_7 type , T_7 V_247 ,
bool V_248 )
{
return ( ( V_244 == 0xFF ) ||
...
static bool
F_129 ( const struct V_37 * V_38 , struct V_39 * V_40 )
{
const struct V_249 * V_250 ;
struct V_249 V_251 ;
const struct V_252 * V_253 = V_40 -> V_108 ;
if ( V_40 -> V_94 != 0 )
return false ;
V_250 = F_130 ( V_38 , V_40 -> V_97 , sizeof( V_251 ) , & V_251 ) ;
if ( V_250 == NULL ) {
F_8 ( L_65 ) ;
V_40 -> V_98 = true ;
return false ;
}
return F_128 ( V_253 -> type ,
V_253 -> V_247 [ 0 ] ,
V_253 -> V_247 [ 1 ] ,
V_250 -> type , V_250 -> V_247 ,
! ! ( V_253 -> V_22 & V_254 ) ) ;
}
static int F_131 ( const struct V_142 * V_40 )
{
const struct V_252 * V_253 = V_40 -> V_108 ;
return ( V_253 -> V_22 & ~ V_254 ) ? - V_140 : 0 ;
}
static int T_8 F_132 ( struct V_136 * V_136 )
{
return F_133 ( V_136 , V_100 ) ;
}
static void T_9 F_134 ( struct V_136 * V_136 )
{
F_135 ( V_136 , V_100 ) ;
}
...
if ( V_12 < 0 )
goto V_256;
V_12 = F_138 ( V_257 , F_139 ( V_257 ) ) ;
if ( V_12 < 0 )
goto V_258;
V_12 = F_140 ( V_259 , F_139 ( V_259 ) ) ;
if ( V_12 < 0 )
goto V_260;
V_12 = F_141 ( & V_261 ) ;
if ( V_12 < 0 )
...
return 0 ;
V_262:
F_143 ( V_259 , F_139 ( V_259 ) ) ;
V_260:
F_144 ( V_257 , F_139 ( V_257 ) ) ;
V_258:
F_145 ( & V_255 ) ;
V_256:
return V_12 ;
