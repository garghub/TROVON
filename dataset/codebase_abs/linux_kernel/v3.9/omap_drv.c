...
V_4 -> V_56 = V_73 -> V_56 ;
V_2 -> V_5 = V_4 ;
V_4 -> V_76 = F_41 ( L_14 , 0 ) ;
F_42 ( & V_4 -> V_77 ) ;
F_43 ( V_2 ) ;
V_66 = F_5 ( V_2 ) ;
if ( V_66 ) {
F_18 ( V_2 -> V_2 , L_15 , V_66 ) ;
V_2 -> V_5 = NULL ;
F_44 ( V_4 ) ;
return V_66 ;
}
...
static int F_57 ( struct V_1 * V_2 , struct V_50 * V_78 )
{
V_78 -> V_79 = NULL ;
F_2 ( L_19 , V_2 , V_78 ) ;
return 0 ;
...
F_60 ( & V_4 -> V_23 [ V_80 ] -> V_82 ,
V_4 -> V_81 , 0 ) ;
}
for ( V_80 = 0 ; V_80 < V_4 -> V_25 ; V_80 ++ ) {
F_60 ( & V_4 -> V_24 [ V_80 ] -> V_82 ,
V_4 -> V_81 , 0 ) ;
}
}
F_61 ( V_2 ) ;
...
static void F_65 ( struct V_1 * V_2 , struct V_50 * V_78 )
{
F_2 ( L_24 , V_2 , V_78 ) ;
}
static int F_66 ( struct V_83 * V_84 , T_1 V_85 )
{
F_2 ( L_25 ) ;
return 0 ;
}
static int F_67 ( struct V_83 * V_86 )
{
F_2 ( L_25 ) ;
return 0 ;
}
static void F_68 ( struct V_83 * V_86 )
{
F_2 ( L_25 ) ;
}
static int F_69 ( struct V_83 * V_86 )
{
F_2 ( L_26 , V_86 -> V_12 ) ;
return F_70 ( & V_87 , V_86 ) ;
}
static int F_71 ( struct V_83 * V_86 )
{
F_2 ( L_25 ) ;
F_72 ( & V_87 , V_86 ) ;
F_73 ( & V_88 ) ;
