...
if ( V_4 < 0 )
goto V_40;
V_38 = F_48 ( V_34 , V_4 , V_61 , & V_47 . V_49 , V_21 ) ;
if ( V_38 )
goto V_40;
V_4 = F_20 ( & V_32 , V_34 , V_33 ) ;
if ( V_4 > 0 ) {
...
static inline int
F_99 ( struct V_80 * V_86 , T_6 V_167 ,
...
if ( V_170 )
return V_170 ;
V_36 = F_21 ( V_172 -> V_176 , & V_169 ) ;
F_2 ( & V_169 ) ;
if ( ! V_36 )
return V_159 ;
if ( F_53 ( V_172 -> V_176 , & V_36 -> V_14 , & V_90 -> V_177 ) < 0 )
return V_159 ;
V_170 = V_159 ;
...
V_170 = V_179 ;
V_40:
F_25 ( & V_36 -> V_14 , V_172 -> V_176 ) ;
return V_170 ;
}
static int
F_102 ( struct V_89 * V_90 , T_5 * V_94 )
{
struct V_80 * V_81 = & V_90 -> V_101 . V_102 [ 0 ] ;
struct V_80 * V_86 = & V_90 -> V_115 . V_102 [ 0 ] ;
T_3 V_180 ;
...
if ( F_62 ( V_81 ) != V_184 )
goto V_182;
V_93 -> V_164 = F_62 ( V_81 ) ;
V_93 -> V_111 = F_62 ( V_81 ) ;
V_93 -> V_158 = F_62 ( V_81 ) ;
if ( F_61 ( V_81 , & V_93 -> V_166 ) )
goto V_182;
if ( V_180 != F_60 ( V_93 -> V_166 . V_4 ) + 5 * 4 )
goto V_182;
...
case V_188 :
* V_94 = V_110 ;
V_47 = F_52 ( V_172 -> V_178 , & V_93 -> V_166 ) ;
if ( ! V_47 )
goto V_182;
...
if ( V_87 == NULL )
goto V_40;
V_202 = ( T_4 * ) ( V_87 + 1 ) - ( T_4 * ) V_198 -> V_102 [ 0 ] . V_85 ;
V_139 = V_198 -> V_4 - V_202 ;
F_14 ( V_139 % 4 ) ;
* V_87 ++ = F_72 ( V_139 ) ;
* V_87 ++ = F_72 ( V_93 -> V_111 ) ;
if ( F_87 ( V_198 , & V_140 , V_202 ,
V_139 ) )
F_88 () ;
...
return 0 ;
V_4 = V_87 ++ ;
V_148 = ( T_4 * ) V_87 - ( T_4 * ) V_198 -> V_102 [ 0 ] . V_85 ;
* V_87 ++ = F_72 ( V_93 -> V_111 ) ;
V_205 = V_198 -> V_206 ;
...
return - V_22 ;
* V_4 = F_72 ( V_198 -> V_4 - V_148 ) ;
V_144 = 3 - ( ( V_198 -> V_4 - V_148 - 1 ) & 3 ) ;
V_87 = ( T_5 * ) ( V_198 -> V_143 [ 0 ] . V_85 + V_198 -> V_143 [ 0 ] . V_84 ) ;
memset ( V_87 , 0 , V_144 ) ;
...
if ( V_199 -> V_47 )
F_25 ( & V_199 -> V_47 -> V_14 , V_172 -> V_178 ) ;
V_199 -> V_47 = NULL ;
return V_132 ;
}
static void
