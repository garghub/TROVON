...
static int F_98 ( struct V_118 * V_95 ,
struct V_124 * V_39 )
{
struct V_10 * V_11 ;
...
static void F_100 ( struct V_200 * V_189 )
{
struct V_10 * V_11 = F_101 ( V_189 ) ;
unsigned long V_9 ;
F_2 ( & V_11 -> V_12 , V_9 ) ;
F_62 ( F_101 ( V_189 ) , 0 ) ;
F_7 ( & V_11 -> V_12 , V_9 ) ;
...
V_130 -> V_206 = 1 ;
V_130 -> V_191 = F_104 ( V_202 , L_99 , 0 ,
& V_9 ) ;
V_130 -> V_190 = ( V_9 & V_207 ) ? 1 : 0 ;
V_130 -> V_135 = F_104 ( V_202 , L_100 , 0 ,
& V_9 ) ;
...
int V_208 ;
struct V_209 * V_210 ;
if ( ! V_189 -> V_211 && ! V_199 -> V_189 . V_198 ) {
F_27 ( L_101 ) ;
return - V_174 ;
}
if ( V_199 -> V_212 != 2 ) {
...
V_208 = F_111 ( V_11 -> V_130 . V_135 , L_106 ) ;
if ( V_208 ) {
F_27 ( L_107 ) ;
goto V_220;
}
...
V_11 -> V_123 = F_113 ( V_210 -> V_216 , F_108 ( V_210 ) ) ;
if ( ! V_11 -> V_123 ) {
V_208 = - V_221 ;
goto V_222;
}
...
F_61 ( V_11 -> V_126 ) ;
V_11 -> V_224 = F_118 ( V_199 , 0 ) ;
V_208 = F_119 ( V_11 -> V_224 , F_85 ,
0 , V_33 , V_11 ) ;
if ( V_208 < 0 ) {
...
V_208 = F_111 ( V_11 -> V_130 . V_191 , L_112 ) ;
if ( V_208 < 0 ) {
F_27 ( L_113 ) ;
goto V_226;
}
...
if ( F_119 ( F_123 ( V_11 -> V_130 . V_191 ) ,
F_89 , 0 , V_33 , V_11 ) ) {
F_27 ( L_114 ,
V_11 -> V_130 . V_191 ) ;
V_208 = - V_217 ;
...
V_208 = F_124 ( V_189 , & V_11 -> V_95 ) ;
if ( V_208 )
goto V_228;
F_125 ( V_189 , V_11 ) ;
F_126 ( V_189 , 1 ) ;
F_14 ( V_11 ) ;
F_127 ( L_116 , V_33 , V_34 ) ;
return 0 ;
V_228:
if ( F_110 ( V_11 -> V_130 . V_191 ) && ! V_11 -> V_130 . V_206 )
F_128 ( F_123 ( V_11 -> V_130 . V_191 ) , V_11 ) ;
V_227:
if ( F_110 ( V_11 -> V_130 . V_191 ) )
F_129 ( V_11 -> V_130 . V_191 ) ;
V_226:
F_128 ( V_11 -> V_224 , V_11 ) ;
V_225:
F_130 ( & V_11 -> V_95 . V_189 ) ;
V_223:
F_131 ( V_11 -> V_123 ) ;
V_222:
if ( F_63 () )
F_129 ( V_11 -> V_130 . V_135 ) ;
V_220:
F_132 ( V_210 -> V_216 , F_108 ( V_210 ) ) ;
F_27 ( L_117 , V_33 , V_208 ) ;
return V_208 ;
}
static int T_7 F_133 ( struct V_200 * V_199 )
{
...
static int F_136 ( struct V_200 * V_199 , T_8 V_229 )
{
struct V_10 * V_11 = F_101 ( V_199 ) ;
int V_230 = V_11 -> V_39 && F_137 ( & V_199 -> V_189 ) ;
unsigned long V_9 ;
...
F_139 ( V_11 -> V_224 ) ;
V_11 -> V_231 = V_230 ;
if ( F_110 ( V_11 -> V_130 . V_191 ) && ! V_11 -> V_130 . V_206 && V_230 )
F_139 ( V_11 -> V_130 . V_191 ) ;
return 0 ;
}
static int F_140 ( struct V_200 * V_199 )
{
struct V_10 * V_11 = F_101 ( V_199 ) ;
unsigned long V_9 ;
if ( F_110 ( V_11 -> V_130 . V_191 ) && ! V_11 -> V_130 . V_206 &&
