...
T_1 V_175 ;
T_1 V_176 = 0 ;
static const struct V_177 T_9 V_178 [] = {
{ . type = L_27 , } ,
{ . V_179 = L_27 , } ,
{} ,
} ;
...
if ( ! ( V_1 -> V_3 & V_4 ) )
V_1 -> V_152 . V_187 = F_94 ;
#ifdef F_111
V_1 -> V_153 = V_188 ;
V_1 -> V_153 . V_103 = V_103 ;
if ( ! ( V_1 -> V_3 & V_4 ) )
V_1 -> V_153 . V_187 = F_94 ;
#endif
#ifdef F_105
V_1 -> V_148 = V_189 ;
...
if ( V_174 ) {
unsigned int V_191 = F_129 ( V_171 + 1 ) ;
V_1 -> V_147 = F_55 ( V_191 * sizeof( long ) , V_83 ) ;
F_25 ( V_1 -> V_147 == NULL ) ;
...
F_25 ( V_1 -> V_3 & V_42 ) ;
#endif
F_30 ( V_1 , V_1 -> V_185 , & V_1 -> V_21 , F_13 ( V_194 ) , 0x1000 ) ;
F_30 ( V_1 , V_1 -> V_185 , & V_1 -> V_26 , F_13 ( V_195 ) , 0x1000 ) ;
if ( V_1 -> V_3 & V_161 ) {
T_1 V_196 ;
int V_197 ;
F_30 ( V_1 , V_1 -> V_185 , & V_1 -> V_198 ,
V_199 , 0x1000 ) ;
V_196 = F_3 ( V_1 -> V_16 , & V_1 -> V_198 ,
V_200 ) ;
V_176 = V_196 & V_201 ;
if ( V_176 >= 0x401 ) {
...
if ( V_176 < 0x400 && ( V_3 & V_202 ) ) {
F_106 ( V_203 . V_204 != V_205 ) ;
V_203 . V_204 = V_206 ;
}
if ( ! ( V_1 -> V_3 & V_154 ) ) {
F_35 ( V_75 L_34 ) ;
F_32 ( V_1 -> V_21 , F_13 ( V_207 ) ,
F_33 ( V_1 -> V_21 , F_13 ( V_207 ) )
| V_208 ) ;
while( F_33 ( V_1 -> V_21 , F_13 ( V_207 ) )
& V_208 )
F_134 () ;
}
if ( V_1 -> V_3 & V_202 )
...
F_30 ( V_1 , V_1 -> V_185 , & V_1 -> V_27 [ V_2 ] ,
F_13 ( V_213 ) + V_2 * F_13 ( V_214 ) ,
0x1000 ) ;
}
V_172 = F_33 ( V_1 -> V_21 , F_13 ( V_215 ) ) ;
V_175 = ( V_172 & V_216 )
>> V_217 ;
if ( V_168 )
V_175 = V_168 * V_218 - 1 ;
...
F_35 ( V_44 L_40
L_41 ,
V_103 , V_173 , ( unsigned long long ) V_1 -> V_185 , F_135 () ) ;
F_35 ( V_44 L_42 ,
...
void T_3 F_142 ( struct V_1 * V_1 , unsigned int V_225 ,
T_2 V_185 )
{
unsigned int V_226 = V_225 * V_1 -> V_168 ;
F_25 ( V_225 >= V_218 ) ;
F_30 ( V_1 ,
V_185 , & V_1 -> V_34 [ V_225 ] , 0 ,
F_13 ( V_35 ) * V_1 -> V_168 ) ;
if ( ( V_226 + V_1 -> V_168 ) > V_1 -> V_126 )
V_1 -> V_126 = V_226 + V_1 -> V_168 ;
}
...
F_70 ( F_13 ( V_228 ) , 0xf ) ;
if ( V_1 -> V_3 & V_161 ) {
T_1 V_196 = F_3 ( V_1 -> V_16 , & V_1 -> V_198 ,
V_200 ) ;
T_1 V_229 = V_196 & V_201 ;
if ( V_229 >= 0x0301 )
V_227 = 8 ;
}
if ( V_1 -> V_3 & V_162 )
F_144 ( V_1 , V_230 ) ;
for ( V_78 = 0 ; V_78 < V_227 ; V_78 ++ ) {
...
F_32 ( V_1 -> V_21 , F_13 ( V_234 ) , V_1 -> V_146 ) ;
if ( ! ( V_1 -> V_3 & V_235 ) )
F_32 ( V_1 -> V_21 , F_13 ( V_207 ) ,
F_33 ( V_1 -> V_21 , F_13 ( V_207 ) )
| V_236 ) ;
...
if ( V_135 != V_239 ) {
F_35 ( V_44 L_45 ,
V_1 -> V_41 -> V_240 , V_135 ) ;
F_149 ( V_135 , V_1 ) ;
F_150 ( V_135 , & F_118 ) ;
}
}
}
void T_3 F_151 ( struct V_1 * V_1 , T_1 V_241 )
{
T_1 V_242 ;
V_242 = F_33 ( V_1 -> V_21 , V_243 ) ;
V_242 &= ~ V_244 ;
V_242 |= F_152 ( V_241 ) ;
F_32 ( V_1 -> V_21 , V_243 , V_242 ) ;
}
void T_3 F_153 ( struct V_1 * V_1 , int V_245 )
{
unsigned long V_3 ;
T_1 V_242 ;
F_44 ( & V_246 , V_3 ) ;
...
void F_113 ( unsigned int V_79 , unsigned int V_248 )
{
...
{
struct V_1 * V_1 = V_224 ;
return F_71 ( F_13 ( V_228 ) ) ;
}
void F_156 ( int V_252 )
{
struct V_1 * V_1 = V_224 ;
V_252 &= V_253 ;
F_70 ( F_13 ( V_228 ) , V_252 ) ;
}
void F_157 ( int V_254 )
{
struct V_1 * V_1 = V_224 ;
unsigned long V_3 ;
T_1 V_250 = 1 << F_2 () ;
...
return F_162 ( V_1 -> V_220 , V_93 ) ;
}
unsigned int F_121 ( struct V_1 * V_1 )
{
return F_158 ( V_1 , F_13 ( V_257 ) ) ;
}
unsigned int V_206 ( void )
{
struct V_1 * V_1 = V_224 ;
F_25 ( V_1 == NULL ) ;
return F_121 ( V_1 ) ;
}
unsigned int V_205 ( void )
{
#ifdef F_163
struct V_1 * V_1 = V_224 ;
T_1 V_93 ;
...
unsigned int F_165 ( void )
{
struct V_1 * V_1 = V_224 ;
F_25 ( V_1 == NULL ) ;
return F_158 ( V_1 , F_13 ( V_259 ) ) ;
}
void F_166 ( void )
{
struct V_1 * V_1 = V_224 ;
...
F_35 ( V_44 L_50 ) ;
for ( V_78 = 0 ; V_78 < 4 ; V_78 ++ ) {
unsigned int V_260 = F_167 ( V_1 -> V_220 ,
V_1 -> V_94 [ 0 ] + V_78 ) ;
if ( V_260 == V_239 ) {
F_35 ( V_105 L_51 , V_261 [ V_78 ] ) ;
continue;
}
F_168 ( V_260 , V_78 ) ;
}
}
void F_169 ( int V_2 , int V_262 )
{
struct V_1 * V_1 = V_224 ;
T_1 V_263 ;
F_25 ( V_1 == NULL ) ;
if ( ( unsigned int ) V_262 > 3 ) {
F_35 ( L_52 ,
F_170 () , V_262 ) ;
return;
}
#ifdef F_171
F_43 ( L_53 , V_1 -> V_103 , V_262 ) ;
#endif
V_263 = 1 << F_64 ( V_2 ) ;
F_70 ( F_13 ( V_264 ) +
V_262 * F_13 ( V_265 ) , V_263 ) ;
}
int T_3 F_172 ( void )
{
int V_266 ;
...
int V_109 = F_64 ( V_2 ) ;
int V_78 ;
V_268 = F_33 ( V_1 -> V_21 , F_13 ( V_269 ) ) ;
V_268 |= ( 1 << V_109 ) ;
F_32 ( V_1 -> V_21 , F_13 ( V_269 ) , V_268 ) ;
F_33 ( V_1 -> V_21 , F_13 ( V_269 ) ) ;
V_268 &= ~ ( 1 << V_109 ) ;
F_32 ( V_1 -> V_21 , F_13 ( V_269 ) , V_268 ) ;
F_33 ( V_1 -> V_21 , F_13 ( V_269 ) ) ;
if ( V_1 -> V_3 & V_161 ) {
