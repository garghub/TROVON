...
int F_12 ( struct V_1 * V_2 , struct V_1 * * V_35 )
{
struct V_1 * V_36 ;
int V_7 = V_2 -> V_7 ;
int V_14 , V_37 , V_38 ;
V_36 = calloc ( 1 , sizeof( * V_36 ) + V_7 * sizeof( int ) ) ;
if ( ! V_36 )
return - 1 ;
for ( V_14 = 0 ; V_14 < V_7 ; V_14 ++ ) {
V_37 = F_10 ( V_2 , V_14 ) ;
for ( V_38 = 0 ; V_38 < V_36 -> V_7 ; V_38 ++ ) {
if ( V_37 == V_36 -> V_6 [ V_38 ] )
break;
}
if ( V_38 == V_36 -> V_7 ) {
V_36 -> V_6 [ V_36 -> V_7 ] = V_37 ;
V_36 -> V_7 ++ ;
}
}
* V_35 = V_36 ;
