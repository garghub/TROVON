...
int F_36 ( unsigned long V_52 , unsigned long V_53 )
{
struct V_45 V_46 ;
struct V_47 * V_48 ;
int V_13 , V_5 ;
...
static void F_35 ( struct V_45 * V_46 , struct V_47 * V_48 )
{
struct V_11 * V_12 ;
V_46 -> V_4 . V_6 . V_61 = 0 ;
V_46 -> V_4 . V_6 . V_62 = 0 ;
...
static inline void F_43 ( struct V_3 * V_80 , int V_81 )
{
struct V_10 * V_29 ;
V_29 = F_6 ( V_80 ) ;
V_29 -> V_74 = V_81 ;
...
static inline void F_48 ( unsigned long V_18 , struct V_3 * V_4 )
{
...
static inline void F_49 ( unsigned short V_18 , struct V_3 * V_4 )
{
...
static inline unsigned long F_50 ( struct V_3 * V_4 )
{
...
static inline int F_51 ( int V_88 , struct V_89 * V_90 )
{
...
static void F_52 ( struct V_3 * V_4 , int V_40 ,
...
goto V_97;
if ( F_51 ( V_40 , & V_28 -> V_98 ) )
goto V_97;
if ( V_40 == 0x21 && F_51 ( F_53 ( V_4 ) , & V_28 -> V_99 ) )
goto V_97;
...
if ( ( V_94 >> 16 ) == V_96 )
goto V_97;
F_55 ( V_91 , V_92 , F_50 ( V_4 ) , V_97 ) ;
F_55 ( V_91 , V_92 , V_4 -> V_6 . V_95 , V_97 ) ;
F_55 ( V_91 , V_92 , F_56 ( V_4 ) , V_97 ) ;
V_4 -> V_6 . V_95 = V_94 >> 16 ;
F_57 ( V_4 ) -= 6 ;
F_56 ( V_4 ) = V_94 & 0xffff ;
F_46 ( V_4 ) ;
F_45 ( V_4 ) ;
F_47 ( V_4 ) ;
return;
V_97:
F_43 ( V_4 , V_100 + ( V_40 << 8 ) ) ;
}
int F_58 ( struct V_3 * V_4 , long V_101 , int V_102 )
{
if ( V_103 . V_60 ) {
if ( ( V_102 == 3 ) || ( V_102 == 1 ) ) {
...
F_52 ( V_4 , V_102 , ( unsigned char T_1 * ) ( V_4 -> V_6 . V_106 << 4 ) , F_57 ( V_4 ) ) ;
return 0 ;
}
if ( V_102 != 1 )
return 1 ;
...
void F_61 ( struct V_3 * V_4 , long V_101 )
{
unsigned char V_109 ;
...
V_114 = 0 ;
do {
switch ( V_109 = F_64 ( V_110 , V_111 , V_115 ) ) {
...
case 0x9c :
if ( V_113 ) {
F_65 ( V_91 , V_92 , F_50 ( V_4 ) , V_115 ) ;
F_57 ( V_4 ) -= 4 ;
} else {
F_55 ( V_91 , V_92 , F_50 ( V_4 ) , V_115 ) ;
F_57 ( V_4 ) -= 2 ;
}
F_56 ( V_4 ) = V_111 ;
F_63 ;
...
case 0xcd : {
int V_117 = F_64 ( V_110 , V_111 , V_115 ) ;
F_56 ( V_4 ) = V_111 ;
if ( V_103 . V_118 ) {
if ( ( 1 << ( V_117 & 7 ) ) & V_103 . V_119 [ V_117 >> 3 ] )
F_43 ( V_4 , V_100 + ( V_117 << 8 ) ) ;
}
F_52 ( V_4 , V_117 , V_91 , V_92 ) ;
return;
}
case 0xcf :
{
...
V_120 = F_67 ( V_91 , V_92 , V_115 ) ;
V_121 = F_67 ( V_91 , V_92 , V_115 ) ;
V_116 = F_67 ( V_91 , V_92 , V_115 ) ;
F_57 ( V_4 ) += 6 ;
}
F_56 ( V_4 ) = V_120 ;
...
static T_7 F_68 ( int V_117 , void * V_123 )
{
int V_124 ;
unsigned long V_18 ;
F_69 ( & V_125 , V_18 ) ;
...
F_70 ( V_127 [ V_117 ] . V_128 , V_127 [ V_117 ] . V_48 , 1 ) ;
F_71 ( V_117 ) ;
F_72 ( & V_125 , V_18 ) ;
return V_129 ;
V_42:
...
static inline void F_73 ( int V_131 )
{
unsigned long V_18 ;
F_74 ( V_131 , NULL ) ;
...
static inline int F_76 ( int V_131 )
{
int V_135 ;
unsigned long V_18 ;
int V_5 = 0 ;
if ( F_77 ( V_131 ) ) return 0 ;
...
static int F_37 ( int V_136 , int V_131 )
{
int V_5 ;
switch ( V_136 ) {
case V_58 : {
...
int V_128 = V_131 >> 8 ;
int V_137 = V_131 & 255 ;
if ( ! F_79 ( V_138 ) ) return - V_49 ;
if ( ! ( ( 1 << V_128 ) & V_139 ) ) return - V_49 ;
if ( F_77 ( V_137 ) ) return - V_49 ;
if ( V_127 [ V_137 ] . V_48 ) return - V_49 ;
V_5 = F_80 ( V_137 , & F_68 , 0 , V_140 , NULL ) ;
if ( V_5 ) return V_5 ;
