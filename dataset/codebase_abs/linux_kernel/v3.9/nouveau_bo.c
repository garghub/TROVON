...
int V_51 ;
V_51 = F_28 ( V_33 , false , false , false , 0 ) ;
if ( V_51 )
goto V_91;
if ( V_36 -> V_83 && ! ( V_90 & ( 1 << V_33 -> V_66 . V_92 ) ) ) {
F_29 ( V_10 , L_2 , V_33 ,
1 << V_33 -> V_66 . V_92 , V_90 ) ;
V_51 = - V_93 ;
goto V_91;
}
if ( V_36 -> V_83 ++ )
...
{
int V_51 ;
V_51 = F_28 ( & V_36 -> V_33 , false , false , false , 0 ) ;
if ( V_51 )
return V_51 ;
...
if ( V_138 && V_138 -> V_92 == V_94 ) {
F_82 ( V_145 , V_138 -> V_144 ) ;
} else
if ( V_138 && V_138 -> V_92 == V_96 &&
...
{
struct V_116 * V_117 = & V_34 -> V_117 [ V_66 -> V_92 ] ;
struct V_9 * V_10 = F_11 ( V_34 ) ;
struct V_1 * V_2 = V_10 -> V_2 ;
int V_51 ;
V_66 -> V_185 . V_5 = NULL ;
...
if ( V_51 )
return V_51 ;
if ( V_36 -> V_33 . V_66 . V_92 == V_94 )
F_82 ( V_145 , V_36 -> V_33 . V_66 . V_144 ) ;
else if ( V_36 -> V_33 . V_66 . V_92 == V_96 ) {
if ( V_143 -> V_48 )
