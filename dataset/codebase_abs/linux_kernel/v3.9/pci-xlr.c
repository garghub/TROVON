...
void F_15 ( unsigned int V_27 )
{
F_14 ( V_27 ) ;
}
int F_16 ( struct V_13 * V_14 , struct V_28 * V_29 )
{
struct V_30 V_31 ;
struct V_13 * V_25 ;
int V_27 , V_32 ;
...
switch ( V_45 -> V_27 ) {
case V_19 :
F_25 ( V_48 , ( 0x90 >> 2 ) , 0xffffffff ) ;
break;
case V_20 :
F_25 ( V_48 , ( 0x94 >> 2 ) , 0xffffffff ) ;
break;
case V_22 :
F_25 ( V_48 , ( 0x190 >> 2 ) , 0xffffffff ) ;
break;
case V_24 :
F_25 ( V_48 , ( 0x194 >> 2 ) , 0xffffffff ) ;
break;
}
}
...
int T_4 F_27 ( const struct V_13 * V_14 , T_5 V_50 , T_5 V_51 )
{
return F_11 ( V_14 ) ;
}
