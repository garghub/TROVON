...
return F_16 ( V_27 -> V_44 , 0 , V_33 , V_34 ) ;
}
static int
F_17 ( struct V_1 * V_2 ,
struct V_1 * V_14 ,
...
if ( V_12 < sizeof( * args ) )
return - V_20 ;
V_50 = F_18 ( V_2 , V_14 , V_46 , 0 , 0xc00000 ,
0x2000 , args -> V_51 ,
( 1ULL << V_38 ) |
( 1ULL << V_15 ) |
( 1ULL << V_16 ) |
...
if ( V_50 )
return V_50 ;
V_50 = F_20 ( V_2 , V_2 , 0x8000 , 16 , & V_27 -> V_44 ) ;
if ( V_50 )
return V_50 ;
F_21 ( V_27 ) -> V_52 = F_1 ;
F_21 ( V_27 ) -> V_53 = F_8 ;
...
struct V_6 * V_7 ;
int V_50 ;
V_50 = F_28 ( V_2 , V_14 , V_46 , NULL , 0x10000 ,
0x1000 , V_64 , & V_7 ) ;
* V_48 = F_19 ( V_7 ) ;
if ( V_50 )
return V_50 ;
V_50 = F_29 ( V_2 , F_19 ( V_7 ) , 0x0200 , 0 ,
V_65 , & V_7 -> V_21 ) ;
if ( V_50 )
return V_50 ;
V_50 = F_29 ( V_2 , F_19 ( V_7 ) , 0x4000 , 0 ,
0 , & V_7 -> V_66 ) ;
if ( V_50 )
return V_50 ;
V_50 = F_30 ( F_31 ( V_2 ) -> V_67 , & V_7 -> V_67 , V_7 -> V_66 ) ;
if ( V_50 )
return V_50 ;
V_50 = F_29 ( V_2 , F_19 ( V_7 ) , 0x1000 , 0x400 ,
V_65 , & V_7 -> V_60 ) ;
if ( V_50 )
return V_50 ;
V_50 = F_29 ( V_2 , F_19 ( V_7 ) , 0x0100 , 0x100 ,
V_65 , & V_7 -> V_57 ) ;
if ( V_50 )
return V_50 ;
return 0 ;
...
static void
F_32 ( struct V_68 * V_69 , int V_70 )
{
struct V_71 * V_25 = V_69 -> V_25 ;
F_9 ( V_25 , 0x002140 , 0x40000000 , 0x40000000 ) ;
}
static void
F_33 ( struct V_68 * V_69 , int V_70 )
{
struct V_71 * V_25 = V_69 -> V_25 ;
F_9 ( V_25 , 0x002140 , 0x40000000 , 0x00000000 ) ;
}
static int
F_34 ( struct V_1 * V_2 , struct V_1 * V_14 ,
struct V_45 * V_46 , void * V_47 , T_2 V_12 ,
struct V_1 * * V_48 )
{
struct V_24 * V_25 ;
int V_50 ;
V_50 = F_35 ( V_2 , V_14 , V_46 , 1 , 127 , & V_25 ) ;
* V_48 = F_19 ( V_25 ) ;
if ( V_50 )
return V_50 ;
V_50 = F_29 ( V_2 , NULL , 128 * 4 , 0x1000 , 0 ,
& V_25 -> V_72 [ 0 ] ) ;
if ( V_50 )
return V_50 ;
V_50 = F_29 ( V_2 , NULL , 128 * 4 , 0x1000 , 0 ,
...
if ( V_50 )
return V_50 ;
V_25 -> V_7 . V_73 -> V_74 = F_32 ;
V_25 -> V_7 . V_73 -> V_75 = F_33 ;
V_25 -> V_7 . V_73 -> V_25 = V_25 ;
F_36 ( V_25 ) -> V_76 = 0x00000100 ;
F_36 ( V_25 ) -> V_77 = V_78 ;
F_37 ( V_25 ) -> V_79 = & V_80 ;
F_37 ( V_25 ) -> V_81 = V_82 ;
return 0 ;
