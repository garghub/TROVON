...
int F_44 ( struct V_2 * V_3 , unsigned long V_30 , unsigned long V_18 )
{
F_15 ( & V_3 -> V_29 ) ;
F_15 ( & V_3 -> V_9 ) ;
V_3 -> V_12 = 0 ;
...
F_4 ( & V_3 -> V_8 ) ;
F_48 (entry, next, &mm->unused_nodes, node_list) {
F_7 ( & V_40 -> V_11 ) ;
F_35 ( V_40 ) ;
-- V_3 -> V_12 ;
}
...
void F_49 ( struct V_2 * V_3 , const char * V_59 )
{
struct V_1 * V_40 ;
unsigned long V_60 = 0 , V_61 = 0 , V_62 = 0 ;
unsigned long V_21 , V_22 , V_63 ;
V_21 = F_12 ( & V_3 -> V_58 ) ;
V_22 = F_13 ( & V_3 -> V_58 ) ;
V_63 = V_22 - V_21 ;
if ( V_63 )
...
V_62 = V_61 + V_60 ;
F_50 ( V_64 L_5 , V_59 , V_62 ,
V_60 , V_61 ) ;
}
int F_52 ( struct V_65 * V_66 , struct V_2 * V_3 )
{
struct V_1 * V_40 ;
unsigned long V_60 = 0 , V_61 = 0 , V_62 = 0 ;
unsigned long V_21 , V_22 , V_63 ;
