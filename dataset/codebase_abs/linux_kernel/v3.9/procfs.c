...
struct V_3 * V_154 = V_152 -> V_155 -> V_148 ;
T_2 V_156 = * V_150 ;
if ( V_156 )
return NULL ;
if ( F_42 ( F_43 ( & V_157 , F_39 , F_40 , 0 , V_154 ) ) )
return NULL ;
F_44 ( & V_154 -> V_158 ) ;
return V_154 ;
}
static void * F_45 ( struct V_1 * V_2 , void * V_159 , T_2 * V_150 )
{
++ * V_150 ;
if ( V_159 )
F_46 ( V_159 ) ;
...
static void F_47 ( struct V_1 * V_2 , void * V_159 )
{
if ( V_159 )
F_46 ( V_159 ) ;
}
static int F_48 ( struct V_1 * V_2 , void * V_159 )
{
struct V_151 * V_152 = V_2 -> V_153 ;
int (* F_49) ( struct V_1 * , struct V_3 * ) = V_152 -> V_148 ;
return F_49 ( V_2 , V_159 ) ;
}
static int F_50 ( struct V_160 * V_160 , struct V_161 * V_161 )
{
int V_162 = F_51 ( V_161 , & V_163 ) ;
if ( ! V_162 ) {
struct V_1 * V_2 = V_161 -> V_164 ;
V_2 -> V_153 = F_52 ( V_160 ) ;
}
return V_162 ;
}
static void F_53 ( struct V_3 * V_4 , char * V_165 ,
int (* F_54) ( struct V_1 * , struct V_3 * ) )
{
F_55 ( V_165 , 0 , F_2 ( V_4 ) -> V_166 ,
& V_167 , F_54 ) ;
}
...
* V_154 = '!' ;
F_59 ( & F_60 ( V_4 ) . V_168 ) ;
F_2 ( V_4 ) -> V_166 = F_61 ( V_105 , V_169 ) ;
if ( F_2 ( V_4 ) -> V_166 ) {
F_2 ( V_4 ) -> V_166 -> V_148 = V_4 ;
F_53 ( V_4 , L_143 , F_1 ) ;
F_53 ( V_4 , L_144 , F_5 ) ;
F_53 ( V_4 , L_145 , F_21 ) ;
F_53 ( V_4 , L_146 , F_23 ) ;
...
{
struct V_151 * V_152 = F_2 ( V_4 ) -> V_166 ;
char V_105 [ V_106 ] ;
char * V_154 ;
F_57 ( V_105 , F_58 ( V_4 ) , V_106 ) ;
V_154 = strchr ( V_105 , '/' ) ;
