...
F_47 ( V_5 , V_56 ) ;
V_43 = V_5 -> V_8 -> V_57 -> F_45 ( V_5 , V_56 ) ;
F_48 ( V_5 , V_56 ) ;
return V_43 ;
}
return 0 ;
...
__acquires( V_5 -> V_58 )
{
F_50 ( V_59 , & V_5 -> V_39 , V_41 ) ;
T_1 * V_60 ;
V_60 = F_51 ( & V_5 -> V_39 , V_41 ) ;
while ( V_5 -> V_39 & V_40 ) {
F_23 ( & V_5 -> V_58 ) ;
F_52 ( V_60 , & V_59 , V_61 , V_62 ) ;
F_21 ( & V_5 -> V_58 ) ;
}
}
...
static void F_59 ( struct V_5 * V_5 , struct V_32 * V_16 ,
struct V_55 * V_56 )
{
if ( V_5 -> V_39 & V_65 )
return;
...
static int
F_61 ( struct V_5 * V_5 , struct V_55 * V_56 )
{
...
static int
F_67 ( struct V_5 * V_5 , struct V_32 * V_16 ,
struct V_55 * V_56 )
{
int V_43 = 0 ;
F_21 ( & V_5 -> V_58 ) ;
if ( ! F_68 ( & V_5 -> V_79 ) )
F_62 ( ! ( V_5 -> V_39 & ( V_80 | V_65 ) ) ) ;
else
F_62 ( V_5 -> V_39 & V_80 ) ;
if ( V_5 -> V_39 & V_40 ) {
if ( V_56 -> V_29 != V_67 )
...
V_81 = F_70 ( V_2 -> V_83 / 2 ,
V_84 / V_85 ) ;
V_81 = F_70 ( V_81 , V_20 -> V_24 ) ;
V_81 = F_71 ( V_81 + V_86 ,
V_86 ) ;
}
return V_81 ;
...
static long F_76 ( struct V_32 * V_16 ,
struct V_19 * V_20 )
{
unsigned long V_92 = V_37 ;
long V_94 = 0 ;
...
long F_79 ( struct V_32 * V_16 , long V_24 ,
enum V_26 V_27 )
{
struct V_19 V_20 = {
. V_24 = V_24 ,
...
static void F_85 ( struct V_32 * V_16 ,
unsigned long V_92 )
{
F_86 ( V_16 -> V_2 , 0 , 0 , 0 , 0 , 0 , V_92 ) ;
}
...
F_42 ( V_16 , V_20 ) ;
if ( V_20 -> V_7 )
V_104 = F_72 ( V_20 -> V_7 , V_16 , V_20 ) ;
else
V_104 = F_76 ( V_16 , V_20 ) ;
F_90 ( V_16 -> V_2 , V_20 ) ;
F_85 ( V_16 , V_102 ) ;
if ( V_104 )
continue;
...
static long F_95 ( struct V_32 * V_16 )
{
if ( F_80 ( V_16 -> V_2 ) ) {
struct V_19 V_20 = {
. V_24 = V_82 ,
...
return F_87 ( V_16 , & V_20 ) ;
}
return 0 ;
}
static long F_96 ( struct V_32 * V_16 )
{
unsigned long V_107 ;
long V_24 ;
if ( ! V_108 )
...
long F_97 ( struct V_32 * V_16 , int V_111 )
{
struct V_1 * V_2 = V_16 -> V_2 ;
struct V_19 * V_20 ;
long V_94 = 0 ;
F_98 ( V_3 , & V_16 -> V_2 -> V_4 ) ;
while ( ( V_20 = F_92 ( V_2 ) ) != NULL ) {
if ( V_111 )
V_20 -> V_29 = V_67 ;
F_99 ( V_2 , V_20 ) ;
V_94 += F_87 ( V_16 , V_20 ) ;
...
V_94 += F_96 ( V_16 ) ;
V_94 += F_95 ( V_16 ) ;
F_102 ( V_3 , & V_16 -> V_2 -> V_4 ) ;
return V_94 ;
}
int F_103 ( void * V_113 )
{
...
void F_116 ( long V_24 , enum V_26 V_27 )
{
struct V_1 * V_2 ;
if ( ! V_24 ) {
V_24 = F_82 ( V_99 ) +
...
static T_2 void F_121 ( struct V_5 * V_5 )
{
...
F_123 ( V_127
L_3 ,
V_115 -> V_128 , F_124 ( V_115 ) , V_5 -> V_122 ,
V_10 , V_5 -> V_8 -> V_123 ) ;
if ( V_124 ) {
F_23 ( & V_124 -> V_125 ) ;
F_125 ( V_124 ) ;
...
void F_126 ( struct V_5 * V_5 , int V_116 )
{
struct V_6 * V_7 = V_5 -> V_8 ;
struct V_1 * V_2 = NULL ;
if ( V_116 & ( V_77 | V_78 ) ) {
...
F_62 ( ! F_136 ( & V_7 -> V_137 ) ) ;
F_21 ( & V_138 ) ;
F_137 (inode, &sb->s_inodes, i_sb_list) {
struct V_72 * V_73 = V_5 -> V_11 ;
F_21 ( & V_5 -> V_58 ) ;
...
void F_144 ( struct V_6 * V_7 , enum V_26 V_27 )
{
return F_141 ( V_7 , F_93 () , V_27 ) ;
}
...
if ( ! F_146 ( & V_7 -> V_137 ) )
return 0 ;
F_141 ( V_7 , V_140 , V_27 ) ;
F_147 ( & V_7 -> V_137 ) ;
return 1 ;
}
int F_148 ( struct V_6 * V_7 , enum V_26 V_27 )
{
return F_145 ( V_7 , F_93 () , V_27 ) ;
}
...
int F_150 ( struct V_5 * V_5 , int V_143 )
{
...
V_56 . V_71 = 0 ;
F_152 () ;
return F_67 ( V_5 , V_16 , & V_56 ) ;
}
int F_153 ( struct V_5 * V_5 , struct V_55 * V_56 )
{
return F_67 ( V_5 , & F_3 ( V_5 ) -> V_16 , V_56 ) ;
}
int F_154 ( struct V_5 * V_5 , int V_63 )
{
struct V_55 V_56 = {
. V_29 = V_63 ? V_67 : V_30 ,
. V_71 = 0 ,
} ;
return F_153 ( V_5 , & V_56 ) ;
}
