...
V_5 -> V_547 = V_548 ;
V_5 -> V_549 = V_548 ;
V_528 = F_279 ( & V_473 , V_5 , V_526 , V_526 + 1 , V_496 ) ;
if ( V_528 < 0 ) {
if ( V_528 == - V_550 ) {
V_106 = V_530 ;
F_280 ( L_46 ) ;
...
V_527 = F_279 ( & V_14 -> V_74 , V_5 , V_72 , V_72 + 1 , V_496 ) ;
if ( V_527 < 0 ) {
if ( V_527 == - V_550 ) {
V_106 = V_552 ;
F_280 ( L_47 ) ;
...
if ( V_106 )
goto V_505;
V_472 = F_289 ( L_38 , V_561 | V_562 , NULL , & V_563 , NULL ) ;
if ( ! V_472 ) {
F_236 ( V_557 L_51 ) ;
goto V_505;
}
F_290 ( & V_564 ) ;
F_182 ( & V_523 ) ;
V_460 . V_470 = F_291 ( L_52 ) ;
if ( ! V_460 . V_470 ) {
F_236 ( V_557 L_53 ) ;
goto V_505;
}
F_292 ( & V_460 . V_71 , F_215 ) ;
F_32 ( & V_460 . V_462 ) ;
F_182 ( & V_460 . V_461 ) ;
F_236 ( V_476 L_54
L_55 V_565 L_56 ,
V_566 , V_567 , V_568 ) ;
F_236 ( V_476 L_57 , F_293 () ) ;
F_236 ( V_476 L_58 ,
V_475 ) ;
return 0 ;
V_505:
...
if ( V_124 == NULL )
return;
F_294 ( V_124 -> V_185 , V_570 | V_343 | V_571 ) ;
F_294 ( V_124 -> V_572 , V_570 | V_343 | V_571 ) ;
F_212 ( V_124 ) ;
}
...
if ( V_14 -> V_104 . V_100 ) {
F_70 ( & V_14 -> V_104 . V_102 ) ;
F_295 ( V_14 -> V_104 . V_100 , V_573 ) ;
F_296 ( V_14 -> V_104 . V_100 ) ;
V_14 -> V_104 . V_100 = NULL ;
F_71 ( & V_14 -> V_104 . V_102 ) ;
}
if ( V_14 -> V_108 . V_100 ) {
F_70 ( & V_14 -> V_108 . V_102 ) ;
F_295 ( V_14 -> V_108 . V_100 , V_573 ) ;
F_296 ( V_14 -> V_108 . V_100 ) ;
V_14 -> V_108 . V_100 = NULL ;
F_71 ( & V_14 -> V_108 . V_102 ) ;
}
}
void F_297 ( struct V_13 * V_14 )
{
struct V_4 * V_5 ;
int V_72 ;
F_48 () ;
...
F_96 ( F_301 ( V_5 , V_5 -> V_124 ) == V_5 -> V_124 -> V_156 . V_588 ) ;
V_251 = V_5 -> V_124 -> V_156 . V_588 ;
if ( F_302 ( V_5 , V_5 -> V_124 , V_251 , V_589 ) ) {
F_120 ( V_168 , L_61 ) ;
F_303 ( V_5 , 1 , V_590 ) ;
}
...
int F_305 ( struct V_4 * V_5 , struct V_569 * V_337 )
{
struct V_574 * V_96 ;
T_4 V_88 , V_43 ;
...
if ( ! V_96 )
goto V_481;
if ( F_302 ( V_5 , V_337 , V_337 -> V_156 . V_588 , V_594 ) ) {
F_120 ( V_168 , L_62 ) ;
V_325 = V_593 ;
goto V_106;
}
V_88 = F_306 ( V_96 -> V_88 ) ;
V_43 = F_306 ( V_96 -> V_43 ) ;
if ( V_88 == V_578 ||
...
if ( F_306 ( V_96 -> V_580 ) != V_337 -> V_156 . V_580 ) {
F_120 ( V_168 , L_66 ,
F_306 ( V_96 -> V_580 ) , V_337 -> V_156 . V_580 ) ;
V_325 = V_599 ;
goto V_106;
}
if ( F_306 ( V_96 -> V_586 ) != V_337 -> V_156 . V_586 ) {
F_120 ( V_168 , L_67 ,
F_306 ( V_96 -> V_586 ) , V_337 -> V_156 . V_586 ) ;
V_325 = V_599 ;
goto V_106;
}
if ( F_306 ( V_96 -> V_579 ) != V_337 -> V_156 . V_579 ) {
F_120 ( V_168 , L_68 ,
F_306 ( V_96 -> V_579 ) , V_337 -> V_156 . V_579 ) ;
V_325 = V_599 ;
goto V_106;
}
if ( F_306 ( V_96 -> V_583 ) != V_584 ) {
F_120 ( V_168 , L_69 ,
F_306 ( V_96 -> V_583 ) , V_584 ) ;
V_325 = V_599 ;
goto V_106;
}
V_337 -> V_156 . V_591 = F_307 ( V_96 -> V_577 ) ;
for ( V_154 = V_158 ; V_154 < V_159 ; V_154 ++ )
V_337 -> V_156 . V_160 [ V_154 ] = F_307 ( V_96 -> V_160 [ V_154 ] ) ;
V_337 -> V_156 . V_43 = F_306 ( V_96 -> V_43 ) ;
V_337 -> V_156 . V_585 = F_307 ( V_96 -> V_585 ) ;
F_9 ( & V_5 -> V_14 -> V_22 ) ;
if ( V_5 -> V_10 . V_31 < V_255 ) {
unsigned int V_352 ;
V_352 = F_306 ( V_96 -> V_587 ) ;
V_352 = F_308 ( V_352 , V_406 ) ;
V_5 -> V_405 = V_352 ;
}
F_14 ( & V_5 -> V_14 -> V_22 ) ;
V_106:
...
void F_309 ( struct V_4 * V_5 , unsigned int line , const char * F_31 )
{
if ( ! F_310 ( V_575 , & V_5 -> V_43 ) ) {
F_311 ( & V_5 -> V_392 , V_600 + V_601 ) ;
V_5 -> V_602 . line = line ;
V_5 -> V_602 . F_31 = F_31 ;
}
}
...
{
if ( ! F_310 ( V_575 , & V_5 -> V_43 ) )
F_311 ( & V_5 -> V_392 , V_600 + 5 * V_601 ) ;
}
void F_313 ( struct V_4 * V_5 ) __must_hold( T_9 )
{
int V_154 ;
for ( V_154 = V_170 ; V_154 < V_171 ; V_154 ++ )
V_5 -> V_124 -> V_156 . V_160 [ V_154 + 1 ] = V_5 -> V_124 -> V_156 . V_160 [ V_154 ] ;
}
void F_314 ( struct V_4 * V_5 , int V_603 , T_2 V_200 ) __must_hold( T_9 )
{
if ( V_603 == V_158 ) {
if ( V_5 -> V_10 . V_341 == V_342 )
V_200 |= 1 ;
...
void F_316 ( struct V_4 * V_5 , int V_603 , T_2 V_200 ) __must_hold( T_9 )
{
unsigned long V_43 ;
F_23 ( & V_5 -> V_124 -> V_156 . V_157 , V_43 ) ;
F_314 ( V_5 , V_603 , V_200 ) ;
...
void F_317 ( struct V_4 * V_5 ) __must_hold( T_9 )
{
T_2 V_200 ;
...
F_314 ( V_5 , V_158 , V_200 ) ;
F_14 ( & V_5 -> V_124 -> V_156 . V_157 ) ;
F_93 ( V_5 , L_71 ) ;
F_99 ( V_5 ) ;
}
void F_318 ( struct V_4 * V_5 , T_2 V_200 ) __must_hold( T_9 )
{
unsigned long V_43 ;
...
if ( F_82 ( V_5 ) ) {
F_324 ( V_5 , V_606 -> V_607 , V_606 -> V_43 ) ;
V_325 = V_606 -> V_608 ( V_5 ) ;
F_325 ( V_5 ) ;
F_83 ( V_5 ) ;
}
F_326 ( V_609 , & V_5 -> V_43 ) ;
F_7 ( & V_5 -> V_12 ) ;
if ( V_606 -> V_610 )
...
F_330 ( V_5 , F_16 ( V_11 , V_355 ) ) ;
return 0 ;
}
void F_331 ( struct V_4 * V_5 )
{
F_96 ( V_5 -> V_10 . V_11 == V_576 ) ;
if ( ! F_310 ( V_612 , & V_5 -> V_43 ) )
F_332 ( & V_5 -> V_14 -> V_423 , & V_5 -> V_380 ) ;
}
...
if ( ! F_310 ( V_611 , & V_5 -> V_43 ) )
F_332 ( & V_5 -> V_14 -> V_423 , & V_5 -> V_383 . V_38 ) ;
}
F_14 ( & V_5 -> V_14 -> V_22 ) ;
}
int F_334 ( struct V_4 * V_5 , int (* V_608)( struct V_4 * ) ,
char * V_607 , enum V_615 V_43 )
{
int V_325 ;
F_96 ( V_45 != V_5 -> V_14 -> V_71 . V_54 ) ;
...
void F_320 ( struct V_4 * V_5 , int V_617 ) __must_hold( T_9 )
{
...
F_337 ( & V_5 -> V_14 -> V_423 , & V_5 -> V_381 ) ;
}
...
const char * F_339 ( enum V_85 V_86 )
{
...
int F_340 ( struct V_4 * V_5 , struct V_647 * V_154 )
{
struct V_114 * V_115 ;
F_341 ( V_65 ) ;
long V_648 ;
...
return F_347 ( V_655 -> V_10 ) ;
}
static char *
F_348 ( unsigned int type ) {
static char * V_661 [] = {
[ V_662 ] = L_125 ,
[ V_663 ] = L_126 ,
[ V_664 ] = L_127 ,
...
unsigned int
F_349 ( struct V_4 * V_5 , unsigned int type )
{
static struct V_654 V_673 = { 0 , 0 } ;
unsigned int V_674 = (
( V_675 == 0 ||
( ( 1 << F_50 ( V_5 ) ) & V_675 ) != 0 ) &&
( ( ( F_346 ( & V_673 ) % 100 ) + 1 ) <= V_676 ) ) ;
if ( V_674 ) {
V_677 ++ ;
if ( F_350 ( & V_678 ) )
F_160 ( V_168 , L_136 ,
