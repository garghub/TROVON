...
V_9 -> V_35 = F_58 ( - 1 , 0 , V_9 -> V_8 . V_24 , 0 ) ;
if ( F_23 ( V_9 -> V_35 ) ) {
F_49 ( & V_61 -> V_64 , L_24 ) ;
return 0 ;
}
V_9 -> V_36 = F_59 ( V_63 , V_9 -> V_8 . V_24 ,
V_9 -> V_35 , 0 , & V_84 , NULL ) ;
if ( F_60 ( ! V_9 -> V_36 ) ) {
F_42 ( & V_61 -> V_64 , L_25 ) ;
F_61 ( V_9 -> V_35 , V_9 -> V_8 . V_24 ) ;
V_28 = - V_85 ;
goto V_86;
}
F_62 ( V_39 , F_29 ) ;
for ( V_54 = 0 ; V_54 < V_9 -> V_8 . V_24 ; V_54 ++ ) {
F_63 ( V_54 + V_9 -> V_35 , & V_87 ,
V_88 ) ;
F_64 ( V_54 + V_9 -> V_35 , V_89 ) ;
F_65 ( V_54 + V_9 -> V_35 , V_9 ) ;
}
F_66 ( V_39 , V_9 ) ;
F_57 ( & V_61 -> V_64 , L_26 ) ;
return 0 ;
...
static int F_69 ( struct V_90 * V_64 )
{
struct V_9 * V_9 = F_70 ( V_64 ) ;
...
static int F_71 ( struct V_90 * V_64 )
{
struct V_9 * V_9 = F_70 ( V_64 ) ;
int V_54 , V_91 = F_32 ( V_9 -> V_8 . V_24 , V_56 ) ;
void T_2 * V_92 ;
...
V_56 ) ) - 1 ;
if ( V_9 -> V_16 . V_31 != - 1 )
F_72 ( V_31 , V_92 , V_93 , V_21 ) ;
if ( V_9 -> V_16 . V_44 != - 1 )
F_72 ( V_44 , V_92 , V_93 , V_21 ) ;
F_72 ( V_23 , V_92 , V_93 , V_21 ) ;
F_72 ( V_17 , V_92 , V_93 , V_21 ) ;
F_72 ( V_41 , V_92 , V_93 , V_21 ) ;
}
