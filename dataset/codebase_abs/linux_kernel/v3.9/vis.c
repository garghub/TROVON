...
F_22 ( V_47 , L_2 , V_8 -> V_44 ) ;
}
}
static T_4
F_23 ( struct V_46 * V_47 ,
const struct V_48 * V_8 ,
const T_3 * V_49 , bool V_42 )
{
if ( V_42 && V_8 -> V_50 == 0 )
return F_22 ( V_47 , L_3 , V_8 -> V_51 ) ;
else if ( F_11 ( V_8 -> V_49 , V_49 ) )
return F_22 ( V_47 , L_4 , V_8 -> V_51 ,
V_8 -> V_50 ) ;
return 0 ;
}
static void
...
F_25 ( V_47 , & V_55 , V_29 ,
V_52 ) ;
F_28 (entry, n, &vis_if_list, list) {
F_29 ( & V_8 -> V_14 ) ;
F_7 ( V_8 ) ;
}
}
}
int F_30 ( struct V_46 * V_47 , void * V_56 )
{
struct V_57 * V_58 ;
struct V_35 * V_36 ;
struct V_59 * V_60 = (struct V_59 * ) V_47 -> V_61 ;
struct V_5 * V_6 = F_31 ( V_60 ) ;
struct V_34 * V_31 = V_6 -> V_12 . V_31 ;
T_1 V_32 ;
int V_62 = 0 ;
int V_63 = F_32 ( & V_6 -> V_64 ) ;
V_58 = F_33 ( V_6 ) ;
if ( ! V_58 )
goto V_65;
if ( V_63 == V_66 )
...
if ( ! V_6 -> V_12 . V_31 )
return NULL ;
V_78 . V_15 = F_45 ( sizeof( * V_76 ) ) ;
if ( ! V_78 . V_15 )
return NULL ;
V_82 = sizeof( * V_76 ) ;
V_80 = V_78 . V_15 ;
V_76 = (struct V_21 * ) F_46 ( V_80 , V_82 ) ;
...
V_4 -> V_15 = F_45 ( V_82 + V_86 + V_87 ) ;
if ( ! V_4 -> V_15 ) {
F_7 ( V_4 ) ;
return NULL ;
}
F_50 ( V_4 -> V_15 , V_86 + V_87 ) ;
V_29 = (struct V_21 * ) F_46 ( V_4 -> V_15 , V_82 ) ;
F_51 ( & V_4 -> V_10 ) ;
F_52 ( & V_4 -> V_11 ) ;
F_52 ( & V_4 -> V_69 ) ;
V_4 -> V_88 = V_89 ;
...
if ( V_29 -> V_52 > V_83 )
V_29 -> V_52 = V_83 ;
F_41 ( V_6 , & V_4 -> V_69 , V_29 -> V_85 ) ;
V_81 = F_53 ( V_6 -> V_12 . V_31 , F_10 ,
F_12 , V_4 ,
& V_4 -> V_24 ) ;
if ( V_81 != 0 ) {
F_40 ( & V_4 -> V_10 , F_1 ) ;
...
V_4 -> V_88 = V_89 ;
V_29 = (struct V_21 * ) V_4 -> V_15 -> V_25 ;
V_29 -> V_95 = F_32 ( & V_6 -> V_64 ) ;
memcpy ( V_29 -> V_90 , V_91 , V_33 ) ;
V_29 -> V_112 . V_113 = V_114 ;
V_29 -> V_84 = F_63 ( F_48 ( V_29 -> V_84 ) + 1 ) ;
V_29 -> V_52 = 0 ;
V_29 -> V_115 = 0 ;
...
if ( ! ( V_100 -> V_102 & V_103 ) )
continue;
if ( F_42 ( V_6 , & V_4 -> V_69 ,
V_100 -> V_105 ) )
continue;
memcpy ( V_29 -> V_90 , V_100 -> V_105 , V_33 ) ;
V_126 = F_68 ( V_4 -> V_15 , V_45 ) ;
if ( ! V_126 )
continue;
if ( ! F_69 ( V_126 , V_100 , NULL ) )
F_9 ( V_126 ) ;
}
F_16 () ;
}
...
V_82 += V_86 + V_87 ;
V_6 -> V_12 . V_108 -> V_15 = F_45 ( V_82 ) ;
if ( ! V_6 -> V_12 . V_108 -> V_15 )
goto V_136;
F_50 ( V_6 -> V_12 . V_108 -> V_15 , V_86 + V_87 ) ;
V_80 = V_6 -> V_12 . V_108 -> V_15 ;
V_29 = (struct V_21 * ) F_46 ( V_80 , sizeof( * V_29 ) ) ;
V_88 = V_89 - F_79 ( V_133 ) ;
V_6 -> V_12 . V_108 -> V_88 = V_88 ;
F_52 ( & V_6 -> V_12 . V_108 -> V_69 ) ;
...
static void F_86 ( struct V_16 * V_17 , void * V_142 )
{
struct V_3 * V_4 ;
