...
{
struct V_7 * V_8 ;
V_8 = F_47 ( sizeof( * V_8 ) , V_67 ) ;
if ( V_8 == NULL )
return - V_68 ;
V_6 -> V_8 = V_8 ;
V_8 -> V_32 = F_48 ( V_6 , V_69 ,
V_70 ,
V_71 ) ;
if ( V_8 -> V_32 < 0 ) {
F_49 ( V_72 L_4 ,
...
memcpy ( V_8 -> V_74 , V_75 , sizeof( V_8 -> V_74 ) ) ;
V_8 -> V_76 = 4 ;
switch ( V_8 -> V_32 ) {
case V_77 :
case V_78 :
...
V_8 -> V_21 . V_76 = V_8 -> V_76 ;
V_8 -> V_21 . V_74 = V_8 -> V_74 ;
V_8 -> V_18 = V_89 ;
V_6 -> V_65 = V_90 ;
return 0 ;
}
