...
switch ( V_147 -> V_169 ) {
case V_170 :
V_213 = F_101 ( & V_83 -> V_197 ) ;
V_115 -> V_193 |= F_13 ( F_80 ( V_213 ) ) ;
V_213 = V_83 -> V_203 . V_218 ;
V_115 -> V_193 |= F_13 ( F_81 ( V_213 ) ) ;
break;
case V_180 :
if ( F_93 ( & V_83 -> V_197 ) ||
F_92 ( & V_83 -> V_197 ) ) {
...
for ( V_141 = 0 ; V_141 < V_149 ; V_141 ++ ) {
struct V_126 * V_83 = & V_272 -> V_150 [ V_141 ] . V_151 ;
while ( ! F_66 ( V_83 ) )
F_129 ( V_83 -> V_16 ) ;
}
}
for ( V_8 = 0 ; V_8 < V_140 ; V_8 ++ ) {
struct V_128 * V_139 , * V_273 ;
...
V_6 = F_131 ( V_283 , V_284 , V_285 , V_286 ) ;
if ( V_6 != V_287 ) {
F_43 ( V_3 , L_44 ,
V_288 , V_289 ) ;
F_43 ( V_3 , L_45
...
F_43 ( V_3 , L_53
L_54 ) ;
V_295 = F_136 ( V_3 , & V_3 -> V_296 -> V_297 ) ;
V_295 &= V_298 ;
V_295 &= ~ V_299 ;
F_21 ( V_3 , L_55
L_56 ) ;
F_137 ( V_3 , ( ( T_4 ) V_120 & ( T_4 ) ~ V_298 ) | V_295 ,
& V_3 -> V_296 -> V_297 ) ;
}
static void F_138 ( struct V_2 * V_3 , unsigned int V_140 ,
T_5 T_6 * V_96 , T_7 V_300 )
{
...
L_67 ,
V_3 -> V_279 [ V_8 ] , V_300 ) ;
if ( V_3 -> V_279 [ V_8 ] != V_300 &&
V_3 -> V_279 [ V_8 ] != V_307 ) {
if ( V_3 -> V_279 [ V_8 ] == 0x03 )
V_3 -> V_275 -- ;
else
V_3 -> V_274 -- ;
V_3 -> V_279 [ V_8 ] = V_307 ;
...
V_140 = F_60 ( V_3 -> V_132 ) ;
V_3 -> V_279 = F_2 ( sizeof( * V_3 -> V_279 ) * V_140 , V_5 ) ;
if ( ! V_3 -> V_279 )
return - V_43 ;
...
V_96 = & V_3 -> V_310 -> V_312 + V_308 ;
while ( 1 ) {
T_3 V_313 ;
V_313 = F_139 ( V_3 , V_96 ) ;
if ( F_145 ( V_313 ) == V_314 )
F_138 ( V_3 , V_140 , V_96 ,
( T_7 ) F_146 ( V_313 ) ) ;
V_308 = F_147 ( V_313 ) ;
if ( ! V_308 || ( V_3 -> V_274 + V_3 -> V_275 )
== V_140 )
break;
V_96 += V_308 ;
}
...
if ( V_3 -> V_274 ) {
V_3 -> V_277 = F_148 ( sizeof( * V_3 -> V_277 ) *
V_3 -> V_274 , V_5 ) ;
if ( ! V_3 -> V_277 )
return - V_43 ;
V_309 = 0 ;
...
T_3 V_247 , V_295 ;
int V_8 ;
V_247 = F_139 ( V_3 , & V_3 -> V_316 -> V_247 ) ;
F_21 ( V_3 , L_77 , V_247 ) ;
...
V_20 = F_150 ( F_139 ( V_3 , & V_3 -> V_310 -> V_132 ) ) ;
F_21 ( V_3 , L_81 ,
( unsigned int ) V_20 ) ;
V_319 = F_139 ( V_3 , & V_3 -> V_316 -> V_321 ) ;
V_20 |= ( V_319 & ~ V_322 ) ;
F_21 ( V_3 , L_82 ,
( unsigned int ) V_20 ) ;
F_151 ( V_3 , V_20 , & V_3 -> V_316 -> V_321 ) ;
...
goto V_46;
V_3 -> V_267 = F_18 ( V_3 , 1 , 1 , V_325 , V_5 ) ;
if ( ! V_3 -> V_267 )
goto V_46;
F_19 ( & V_3 -> V_268 ) ;
...
V_320 = F_136 ( V_3 , & V_3 -> V_316 -> V_267 ) ;
V_320 = ( V_320 & ( T_4 ) V_326 ) |
( V_3 -> V_267 -> V_37 -> V_7 & ( T_4 ) ~ V_326 ) |
V_3 -> V_267 -> V_4 ;
F_21 ( V_3 , L_90 , V_20 ) ;
F_137 ( V_3 , V_320 , & V_3 -> V_316 -> V_267 ) ;
F_153 ( V_3 ) ;
V_3 -> V_266 = F_45 ( V_3 , true , true , V_5 ) ;
if ( ! V_3 -> V_266 )
goto V_46;
V_3 -> V_101 ++ ;
V_20 = F_139 ( V_3 , & V_3 -> V_310 -> V_327 ) ;
V_20 &= V_328 ;
F_21 ( V_3 , L_91
L_92 , V_20 ) ;
V_3 -> V_329 = ( void T_6 * ) V_3 -> V_310 + V_20 ;
F_154 ( V_3 ) ;
F_155 ( V_3 ) ;
V_3 -> V_296 = & V_3 -> V_330 -> V_296 [ 0 ] ;
F_21 ( V_3 , L_93 ) ;
V_3 -> V_265 = F_18 ( V_3 , V_331 , 1 , V_21 ,
V_5 ) ;
if ( ! V_3 -> V_265 )
goto V_46;
if ( F_132 ( V_3 , V_5 ) < 0 )
...
sizeof( struct V_260 ) * V_331 , & V_7 ,
V_323 ) ;
if ( ! V_3 -> V_261 . V_263 )
goto V_46;
F_21 ( V_3 , L_94 ,
( unsigned long long ) V_7 ) ;
memset ( V_3 -> V_261 . V_263 , 0 , sizeof( struct V_260 ) * V_331 ) ;
V_3 -> V_261 . V_262 = V_331 ;
V_3 -> V_261 . V_264 = V_7 ;
F_21 ( V_3 , L_95 ,
V_3 -> V_261 . V_262 ,
V_3 -> V_261 . V_263 ,
( unsigned long long ) V_3 -> V_261 . V_264 ) ;
for ( V_20 = 0 , V_6 = V_3 -> V_265 -> V_37 ; V_20 < V_331 ; V_20 ++ ) {
struct V_260 * V_332 = & V_3 -> V_261 . V_263 [ V_20 ] ;
V_332 -> V_333 = F_9 ( V_6 -> V_7 ) ;
V_332 -> V_334 = F_13 ( V_12 ) ;
V_332 -> V_335 = 0 ;
V_6 = V_6 -> V_16 ;
}
V_20 = F_139 ( V_3 , & V_3 -> V_296 -> V_336 ) ;
V_20 &= V_337 ;
V_20 |= V_331 ;
F_21 ( V_3 , L_96 ,
V_20 ) ;
F_151 ( V_3 , V_20 , & V_3 -> V_296 -> V_336 ) ;
F_21 ( V_3 , L_97 ) ;
F_21 ( V_3 , L_98 ,
( unsigned long long ) V_3 -> V_261 . V_264 ) ;
V_320 = F_136 ( V_3 , & V_3 -> V_296 -> V_338 ) ;
V_320 &= V_298 ;
V_320 |= ( V_3 -> V_261 . V_264 & ( T_4 ) ~ V_298 ) ;
F_137 ( V_3 , V_320 , & V_3 -> V_296 -> V_338 ) ;
F_134 ( V_3 ) ;
F_21 ( V_3 , L_99 ) ;
F_156 ( V_3 , 0 ) ;
F_69 ( & V_3 -> V_339 ) ;
...
V_3 -> V_153 [ V_8 ] = NULL ;
for ( V_8 = 0 ; V_8 < V_315 ; ++ V_8 ) {
V_3 -> V_281 [ 0 ] . V_340 [ V_8 ] = 0 ;
V_3 -> V_281 [ 1 ] . V_340 [ V_8 ] = 0 ;
}
if ( F_121 ( V_3 , V_5 ) )
goto V_46;
if ( F_142 ( V_3 , V_5 ) )
goto V_46;
F_19 ( & V_3 -> V_341 ) ;
V_295 = F_139 ( V_3 , & V_3 -> V_316 -> V_342 ) ;
V_295 &= ~ V_343 ;
V_295 |= V_344 ;
F_151 ( V_3 , V_295 , & V_3 -> V_316 -> V_342 ) ;
return 0 ;
V_46:
F_43 ( V_3 , L_100 ) ;
F_157 ( V_3 ) ;
