...
F_85 ( V_17 -> V_180 [ V_103 ] . V_181 ) ,
V_17 -> V_131 +
V_17 -> V_180 [ V_103 ] . V_182 ) ;
}
V_32 -> V_7 |= F_4 ( V_2 , V_8 ) ;
V_35 = V_17 -> V_175 ;
F_37 (td, &urbp->td_list, list) {
