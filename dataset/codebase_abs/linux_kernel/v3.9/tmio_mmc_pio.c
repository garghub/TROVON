...
F_21 ( V_2 ) ;
} else if ( V_144 -> V_168 != V_173 ) {
if ( V_2 -> V_172 ) {
struct V_138 * V_139 = V_2 -> V_139 ;
if ( V_144 -> V_168 == V_174 )
F_77 ( V_2 ) ;
F_17 ( V_2 ) ;
V_2 -> V_172 = false ;
F_85 ( V_65 ) ;
if ( V_139 -> V_175 )
V_139 -> V_175 ( V_2 -> V_49 ) ;
}
}
if ( V_2 -> V_172 ) {
switch ( V_144 -> V_145 ) {
case V_176 :
F_14 ( V_2 , V_177 , 0x80e0 ) ;
break;
case V_146 :
F_14 ( V_2 , V_177 , 0x00e0 ) ;
break;
}
}
F_75 ( 140 ) ;
...
F_92 ( V_38 ) ;
if ( ! V_38 -> V_182 )
V_38 -> V_182 = V_139 -> V_183 ? : V_184 | V_185 ;
else if ( V_139 -> V_183 )
F_30 ( F_93 ( V_38 ) , L_20 ) ;
}
static void F_94 ( struct V_186 * V_49 ,
struct V_138 * V_139 )
{
const struct V_187 * V_188 = V_49 -> V_65 . V_189 ;
if ( ! V_188 )
return;
if ( F_95 ( V_188 , L_21 , NULL ) )
V_139 -> V_62 |= V_178 ;
}
...
V_190 -> V_49 = V_49 ;
F_99 ( V_49 , V_38 ) ;
V_190 -> V_159 = V_139 -> V_159 ;
V_190 -> V_48 = V_139 -> V_48 ;
V_190 -> V_195 = F_19 ( V_191 ) >> 10 ;
V_190 -> V_196 = F_100 ( V_191 -> V_197 , F_19 ( V_191 ) ) ;
if ( ! V_190 -> V_196 ) {
V_151 = - V_194 ;
goto V_198;
}
V_38 -> V_199 = & V_200 ;
V_38 -> V_142 |= V_201 | V_139 -> V_202 ;
V_38 -> V_203 = V_139 -> V_204 ;
V_38 -> V_205 = 32 ;
V_38 -> V_206 = 512 ;
V_38 -> V_207 = ( V_208 / V_38 -> V_206 ) *
V_38 -> V_205 ;
V_38 -> V_209 = V_38 -> V_206 * V_38 -> V_207 ;
V_38 -> V_210 = V_38 -> V_209 ;
F_91 ( V_190 ) ;
V_190 -> V_94 = ! ( V_139 -> V_62 & V_211 ||
V_38 -> V_142 & V_212 ||
V_38 -> V_142 & V_213 ||
V_38 -> V_214 . V_215 >= 0 ) ;
V_190 -> V_172 = false ;
...
F_104 ( & V_190 -> V_63 ) ;
F_105 ( & V_190 -> V_165 ) ;
F_106 ( & V_190 -> V_59 , F_23 ) ;
F_107 ( & V_190 -> V_70 , F_35 ) ;
F_108 ( V_190 , V_139 ) ;
V_151 = F_109 ( V_38 ) ;
if ( V_139 -> V_175 )
V_139 -> V_175 ( V_49 ) ;
