...
V_12 [ 60 ] = V_8 -> V_13 ++ ;
F_3 ( & V_14 ) ;
F_4 ( & V_2 -> V_15 -> V_16 , L_1 , V_17 , V_4 , V_12 ) ;
V_10 = F_5 ( V_2 , V_12 , sizeof( V_12 ) , V_12 , sizeof( V_12 ) ) ;
if ( V_10 )
goto V_18;
for ( V_11 = 0 ; V_11 < 3 ; V_11 ++ ) {
V_10 = F_6 ( V_2 -> V_15 , F_7 ( V_2 -> V_15 ,
V_2 -> V_19 -> V_20 ) , V_12 , sizeof( V_12 ) ,
& V_9 , 2000 ) ;
if ( V_10 ) {
F_4 ( & V_2 -> V_15 -> V_16 , L_2 \
L_3 , V_17 , V_10 ) ;
} else {
F_4 ( & V_2 -> V_15 -> V_16 , L_4 , V_17 ,
V_6 , V_12 ) ;
if ( V_12 [ 63 ] != 0x4f )
F_4 ( & V_2 -> V_15 -> V_16 , L_5 ,
V_17 ) ;
break;
}
}
if ( V_10 ) {
F_8 ( & V_2 -> V_15 -> V_16 , L_6 ,
V_21 , V_10 ) ;
goto V_18;
}
if ( V_5 && V_6 )
...
{
T_1 V_12 [] = { V_24 , V_22 >> 8 , V_22 & 0xff , 0x01 } ;
int V_10 ;
V_10 = F_1 ( V_2 , V_12 , sizeof( V_12 ) , V_23 , 1 ) ;
F_4 ( & V_2 -> V_15 -> V_16 , L_7 , V_17 , V_22 , * V_23 ) ;
return V_10 ;
}
static int F_11 ( struct V_1 * V_2 , T_2 V_22 , T_1 V_23 )
{
T_1 V_12 [] = { V_25 , V_22 >> 8 , V_22 & 0xff , 0x01 , V_23 } ;
F_4 ( & V_2 -> V_15 -> V_16 , L_7 , V_17 , V_22 , V_23 ) ;
...
{
T_1 V_12 [] = { V_29 } ;
return F_1 ( V_2 , V_12 , sizeof( V_12 ) , V_28 , 3 ) ;
}
static int F_15 ( struct V_30 * V_31 , int V_32 )
{
T_1 V_12 [] = { V_33 , ( T_1 ) V_32 , 0x00 } ;
F_4 ( & F_16 ( V_31 ) -> V_15 -> V_16 , L_8 , V_17 , V_32 ) ;
return F_1 ( F_16 ( V_31 ) , V_12 , sizeof( V_12 ) , NULL , 0 ) ;
}
static int F_17 ( struct V_1 * V_2 , T_1 V_34 , T_1 V_35 )
{
T_1 V_12 [] = { V_36 , 0x01 , V_34 , V_35 } ;
F_4 ( & V_2 -> V_15 -> V_16 , L_9 , V_17 ,
V_34 , V_35 ) ;
return F_1 ( V_2 , V_12 , sizeof( V_12 ) , NULL , 0 ) ;
}
static int F_18 ( struct V_1 * V_2 , T_1 V_32 )
{
T_1 V_12 [] = { V_36 , 0x02 , V_32 } ;
F_4 ( & V_2 -> V_15 -> V_16 , L_8 , V_17 , V_32 ) ;
return F_1 ( V_2 , V_12 , sizeof( V_12 ) , NULL , 0 ) ;
}
...
V_12 [ 0 ] = V_49 ;
V_12 [ 1 ] = ( V_40 [ V_11 ] . V_50 << 1 ) | 0x01 ;
V_12 [ 2 ] = V_40 [ V_11 ] . V_12 [ 0 ] ;
V_12 [ 3 ] = V_40 [ V_11 ] . V_12 [ 1 ] ;
V_12 [ 4 ] = V_40 [ V_11 ] . V_47 - 1 ;
V_12 [ 5 ] = V_40 [ V_11 + 1 ] . V_47 ;
V_10 = F_1 ( V_2 , V_12 , 6 , V_40 [ V_11 + 1 ] . V_12 ,
V_40 [ V_11 + 1 ] . V_47 ) ;
V_42 = 2 ;
} else {
...
V_12 [ 0 ] = V_51 ;
V_12 [ 1 ] = ( V_40 [ V_11 ] . V_50 << 1 ) ;
V_12 [ 2 ] = V_40 [ V_11 ] . V_47 ;
V_12 [ 3 ] = 0x01 ;
memcpy ( & V_12 [ 4 ] , V_40 [ V_11 ] . V_12 , V_40 [ V_11 ] . V_47 ) ;
V_10 = F_1 ( V_2 , V_12 , 4 + V_40 [ V_11 ] . V_47 , NULL , 0 ) ;
V_42 = 1 ;
}
if ( V_10 )
break;
...
int V_10 ;
F_4 ( & V_2 -> V_15 -> V_16 , L_11 , V_17 , V_31 -> V_28 , V_32 ) ;
if ( V_32 == 0 )
return 0 ;
switch ( V_8 -> V_67 ) {
case V_70 :
...
T_1 V_115 [ 2 ] ;
int V_10 ;
V_10 = F_1 ( V_2 , V_12 , sizeof( V_12 ) , V_115 , sizeof( V_115 ) ) ;
if ( V_10 )
return V_10 ;
if ( V_115 [ 0 ] ) {
...
int V_10 ;
T_1 V_12 [] = { V_126 , 0x02 , 0x40 | V_50 >> 8 , V_50 & 0xff , 0x00 , 1 } ;
T_1 V_23 ;
V_10 = F_1 ( V_2 , V_12 , sizeof( V_12 ) , & V_23 , 1 ) ;
if ( V_10 )
return V_10 ;
...
struct V_1 * V_2 = V_123 -> V_125 ;
int V_10 ;
T_1 V_12 [] = { V_126 , 0x03 , 0x40 | V_50 >> 8 , V_50 & 0xff , 0x00 , 1 , V_23 } ;
V_10 = F_1 ( V_2 , V_12 , sizeof( V_12 ) , NULL , 0 ) ;
if ( V_10 )
return V_10 ;
return 0 ;
}
...
struct V_1 * V_2 = V_123 -> V_125 ;
int V_10 ;
T_1 V_12 [] = { V_126 , 0x04 , 0x40 , V_50 , 0x00 , 1 } ;
T_1 V_23 ;
V_10 = F_1 ( V_2 , V_12 , sizeof( V_12 ) , & V_23 , 1 ) ;
if ( V_10 )
return V_10 ;
...
struct V_1 * V_2 = V_123 -> V_125 ;
int V_10 ;
T_1 V_12 [] = { V_126 , 0x05 , 0x40 , V_50 , 0x00 , 1 , V_23 } ;
V_10 = F_1 ( V_2 , V_12 , sizeof( V_12 ) , NULL , 0 ) ;
if ( V_10 )
return V_10 ;
return 0 ;
