...
{
return F_153 ( V_40 , 1 , V_59 , V_17 , V_3 , V_120 ,
V_106 , F_158 ( 0 ) ) ;
}
...
static void F_164 ( const void * V_2 , int V_121 )
{
struct V_107 * V_113 ;
if ( ! V_2 )
return;
if ( ( V_7 - 1 ) & ( unsigned long ) V_2 ) {
F_165 ( 1 , V_122 L_3 , V_2 ) ;
return;
}
V_113 = F_163 ( V_2 ) ;
if ( F_55 ( ! V_113 ) ) {
...
V_113 -> V_123 = V_123 ;
if ( V_126 > V_7 ) {
V_13 = F_174 ( V_126 , 1 , V_127 | V_129 ,
V_130 , V_44 , V_114 ) ;
V_113 -> V_59 |= V_124 ;
} else {
...
goto V_133;
V_113 = F_153 ( V_40 , V_41 , V_135 | V_115 ,
...
{
return F_174 ( V_40 , 1 , V_45 , V_11 , V_120 ,
F_158 ( 0 ) ) ;
}
static inline void * F_181 ( unsigned long V_40 ,
int V_44 , T_6 V_59 )
{
return F_174 ( V_40 , 1 , V_59 , V_130 ,
V_44 , F_158 ( 0 ) ) ;
}
void * F_182 ( unsigned long V_40 )
{
return F_181 ( V_40 , V_120 ,
V_106 | V_129 ) ;
}
...
{
return F_174 ( V_40 , 1 , V_106 | V_129 , V_130 ,
V_44 , F_158 ( 0 ) ) ;
}
...
{
return F_174 ( V_40 , 1 , V_106 | V_129 , V_138 ,
V_120 , F_158 ( 0 ) ) ;
}
void * F_188 ( unsigned long V_40 )
{
return F_174 ( V_40 , 1 , V_139 , V_130 ,
V_120 , F_158 ( 0 ) ) ;
}
...
struct V_107 * V_113 ;
void * V_19 ;
V_19 = F_174 ( V_40 , 1 , V_139 | V_128 , V_130 ,
V_120 , F_158 ( 0 ) ) ;
if ( V_19 ) {
V_113 = F_162 ( V_19 ) ;
V_113 -> V_59 |= V_137 ;
...
static int F_190 ( char * V_140 , char * V_2 , unsigned long V_105 )
{
struct V_12 * V_33 ;
int V_141 = 0 ;
while ( V_105 ) {
...
static int F_193 ( char * V_140 , char * V_2 , unsigned long V_105 )
{
struct V_12 * V_33 ;
int V_141 = 0 ;
while ( V_105 ) {
...
long F_194 ( char * V_140 , char * V_2 , unsigned long V_105 )
{
struct V_107 * V_35 ;
char * V_144 , * V_145 = V_140 ;
...
memset ( V_140 , 0 , V_146 - ( V_140 - V_145 ) ) ;
return V_146 ;
}
long F_197 ( char * V_140 , char * V_2 , unsigned long V_105 )
{
struct V_107 * V_35 ;
char * V_144 ;
...
int F_198 ( struct V_148 * V_149 , void * V_2 ,
unsigned long V_150 )
{
struct V_107 * V_113 ;
...
static int F_200 ( T_2 * V_4 , T_10 V_159 , unsigned long V_2 , void * V_160 )
{
T_2 * * * V_33 = V_160 ;
if ( V_33 ) {
* ( * V_33 ) = V_4 ;
...
struct V_107 * F_201 ( T_8 V_40 , T_2 * * V_161 )
{
struct V_107 * V_113 ;
...
if ( V_30 -> va_end > V_3 ) {
* V_162 = V_30 ;
* V_163 = F_204 ( F_50 ( & ( * V_162 ) -> V_27 ) ) ;
} else {
* V_163 = V_30 ;
* V_162 = F_204 ( F_206 ( & ( * V_163 ) -> V_27 ) ) ;
}
return true ;
}
static unsigned long F_207 ( struct V_26 * * V_162 ,
struct V_26 * * V_163 ,
unsigned long V_41 )
{
...
unsigned long V_2 ;
if ( * V_162 )
V_2 = F_208 ( ( * V_162 ) -> va_start & ~ ( V_41 - 1 ) , V_164 ) ;
else
V_2 = V_164 ;
...
struct V_107 * * F_209 ( const unsigned long * V_165 ,
...
V_170 = F_211 ( V_167 , sizeof( V_170 [ 0 ] ) , V_106 ) ;
V_169 = F_211 ( V_167 , sizeof( V_169 [ 0 ] ) , V_106 ) ;
if ( ! V_169 || ! V_170 )
goto V_178;
for ( V_113 = 0 ; V_113 < V_167 ; V_113 ++ ) {
V_169 [ V_113 ] = F_143 ( sizeof( struct V_26 ) , V_106 ) ;
V_170 [ V_113 ] = F_143 ( sizeof( struct V_107 ) , V_106 ) ;
...
F_61 ( & V_51 ) ;
for ( V_113 = 0 ; V_113 < V_167 ; V_113 ++ )
F_152 ( V_170 [ V_113 ] , V_169 [ V_113 ] , V_135 ,
F_209 ) ;
F_65 ( V_169 ) ;
return V_170 ;
V_179:
...
void F_212 ( struct V_107 * * V_170 , int V_167 )
{
int V_97 ;
...
static void * F_213 ( struct V_180 * V_181 , T_11 * V_182 )
__acquires( &vmlist_lock
static void * F_214 ( struct V_180 * V_181 , void * V_33 , T_11 * V_182 )
{
struct V_107 * V_183 = V_33 ;
++ * V_182 ;
return V_183 -> V_9 ;
}
static void F_215 ( struct V_180 * V_181 , void * V_33 )
__releases( &vmlist_lock
static void F_216 ( struct V_180 * V_181 , struct V_107 * V_183 )
{
if ( F_217 ( V_184 ) ) {
unsigned int V_14 , * V_185 = V_181 -> V_186 ;
if ( ! V_185 )
return;
memset ( V_185 , 0 , V_187 * sizeof( unsigned int ) ) ;
for ( V_14 = 0 ; V_14 < V_183 -> V_123 ; V_14 ++ )
V_185 [ F_218 ( V_183 -> V_13 [ V_14 ] ) ] ++ ;
F_219 (nr, N_HIGH_MEMORY)
if ( V_185 [ V_14 ] )
F_220 ( V_181 , L_7 , V_14 , V_185 [ V_14 ] ) ;
}
}
static int F_221 ( struct V_180 * V_181 , void * V_33 )
{
struct V_107 * V_183 = V_33 ;
F_220 ( V_181 , L_8 ,
V_183 -> V_2 , V_183 -> V_2 + V_183 -> V_40 , V_183 -> V_40 ) ;
if ( V_183 -> V_114 )
F_220 ( V_181 , L_9 , V_183 -> V_114 ) ;
if ( V_183 -> V_123 )
F_220 ( V_181 , L_10 , V_183 -> V_123 ) ;
if ( V_183 -> V_188 )
F_220 ( V_181 , L_11 , ( unsigned long long ) V_183 -> V_188 ) ;
if ( V_183 -> V_59 & V_117 )
F_220 ( V_181 , L_12 ) ;
if ( V_183 -> V_59 & V_135 )
F_220 ( V_181 , L_13 ) ;
...
static int F_223 ( struct V_190 * V_190 , struct V_191 * V_191 )
{
unsigned int * V_192 = NULL ;
int V_19 ;
if ( F_217 ( V_184 ) ) {
V_192 = F_224 ( V_187 * sizeof( unsigned int ) , V_106 ) ;
if ( V_192 == NULL )
return - V_15 ;
}
V_19 = F_225 ( V_191 , & V_193 ) ;
if ( ! V_19 ) {
struct V_180 * V_181 = V_191 -> V_194 ;
V_181 -> V_186 = V_192 ;
} else
F_65 ( V_192 ) ;
return V_19 ;
