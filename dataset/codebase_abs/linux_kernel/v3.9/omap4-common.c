...
V_64 -> V_67 [ 0 ] . V_68 = V_60 ;
V_64 -> V_67 [ 0 ] . V_69 = V_70 ;
}
return 0 ;
}
static T_1 void F_44 ( struct V_58 * V_59 )
{
struct V_63 * V_64 ;
if ( ! V_59 ) {
F_45 ( L_4 , V_32 ) ;
...
int T_1 F_46 ( struct V_72 * V_73 )
{
struct V_72 * V_74 ;
F_47 ( V_73 ) ;
for ( V_74 = V_73 ; V_74 -> V_75 ; V_74 ++ ) {
if ( ! V_74 -> V_62 )
continue;
F_44 ( & V_74 -> V_62 -> V_59 ) ;
}
...
void F_48 ( char V_76 , const char * V_77 )
{
F_49 () ;
while ( 1 ) ;
}
