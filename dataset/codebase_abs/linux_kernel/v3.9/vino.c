...
{
struct V_56 * V_57 = F_109 ( V_261 ) ;
unsigned int V_333 = V_261 -> V_334 & V_335 ;
struct V_1 * V_2 ;
...
if ( V_124 )
goto V_41;
if ( V_155 -> V_348 < V_341 [ V_4 ] . V_349 ||
V_155 -> V_348 > V_341 [ V_4 ] . V_350 ) {
V_124 = - V_351 ;
goto V_41;
}
V_124 = F_133 ( V_252 , V_352 , V_155 ) ;
if ( V_124 )
V_124 = - V_17 ;
break;
}
...
if ( V_124 )
goto V_41;
if ( V_155 -> V_348 < V_345 [ V_4 ] . V_349 ||
V_155 -> V_348 > V_345 [ V_4 ] . V_350 ) {
V_124 = - V_351 ;
goto V_41;
}
V_124 = F_100 ( V_252 , V_352 , V_155 ) ;
if ( V_124 )
V_124 = - V_17 ;
break;
}
...
static void F_137 ( struct V_355 * V_356 )
{
struct V_1 * V_2 = V_356 -> V_357 ;
V_2 -> V_55 ++ ;
F_2 ( L_105 , V_2 -> V_55 ) ;
}
static void F_138 ( struct V_355 * V_356 )
{
struct V_1 * V_2 = V_356 -> V_357 ;
V_2 -> V_55 -- ;
F_2 ( L_106 , V_2 -> V_55 ) ;
}
static int F_139 ( struct V_261 * V_261 , struct V_355 * V_356 )
{
struct V_56 * V_57 = F_109 ( V_261 ) ;
unsigned long V_198 = V_356 -> V_358 ;
unsigned long V_14 = V_356 -> V_359 - V_356 -> V_358 ;
unsigned long V_49 = V_356 -> V_360 << V_361 ;
struct V_1 * V_2 = NULL ;
...
if ( V_14 < V_9 )
break;
if ( F_142 ( V_356 , V_198 , V_365 , V_9 ,
V_356 -> V_366 ) ) {
F_2 ( L_115 ) ;
V_16 = - V_336 ;
goto V_41;
...
static unsigned int F_143 ( struct V_261 * V_261 , T_6 * V_373 )
{
struct V_56 * V_57 = F_109 ( V_261 ) ;
unsigned int V_210 ;
unsigned int V_16 = 0 ;
...
if ( V_210 > 0 )
goto V_375;
F_144 ( V_261 , & V_57 -> V_197 . V_203 , V_373 ) ;
if ( F_38 ( & V_57 -> V_197 , & V_210 ) ) {
F_2 ( L_117 ) ;
V_16 = V_374 ;
goto error;
...
unsigned int V_378 , unsigned long V_379 )
{
struct V_56 * V_57 = F_109 ( V_261 ) ;
long V_16 ;
if ( F_140 ( & V_57 -> V_353 ) )
return - V_204 ;
V_16 = F_146 ( V_261 , V_378 , V_379 ) ;
F_27 ( & V_57 -> V_353 ) ;
return V_16 ;
}
static void F_147 ( int V_380 )
{
switch( V_380 ) {
case 11 :
F_148 ( V_187 -> V_142 . V_381 ) ;
V_187 -> V_142 . V_381 = NULL ;
case 10 :
F_148 ( V_187 -> V_141 . V_381 ) ;
V_187 -> V_141 . V_381 = NULL ;
case 9 :
F_149 ( & V_382 ) ;
case 8 :
F_150 ( V_383 , NULL ) ;
case 7 :
if ( V_187 -> V_142 . V_381 ) {
F_151 ( V_187 -> V_142 . V_381 ) ;
V_187 -> V_142 . V_381 = NULL ;
}
case 6 :
if ( V_187 -> V_141 . V_381 ) {
F_151 ( V_187 -> V_141 . V_381 ) ;
V_187 -> V_141 . V_381 = NULL ;
}
case 5 :
F_5 ( NULL ,
...
V_127 = (struct V_391 * ) F_156 ( V_392 , sizeof( struct V_391 ) ) ;
if ( ! V_127 ) {
F_34 ( V_54 L_124 ) ;
return - V_106 ;
}
V_393 ++ ;
if ( F_157 ( V_387 , & ( V_127 -> V_387 ) ) ) {
F_34 ( V_54 L_125 ) ;
F_147 ( V_393 ) ;
return - V_255 ;
}
if ( F_158 ( V_387 ) != V_394 ) {
F_34 ( V_54 L_126 ,
V_387 ) ;
F_147 ( V_393 ) ;
return - V_255 ;
}
F_34 ( V_395 L_127 , F_159 ( V_387 ) ) ;
return 0 ;
}
...
int V_124 ;
int V_4 ;
V_187 = F_161 ( sizeof( struct V_397 ) , V_18 ) ;
if ( ! V_187 ) {
F_147 ( V_393 ) ;
return - V_19 ;
}
V_393 ++ ;
F_162 ( V_187 -> V_386 . V_257 , L_128 ,
sizeof( V_187 -> V_386 . V_257 ) ) ;
V_124 = F_163 ( NULL , & V_187 -> V_386 ) ;
if ( V_124 )
return V_124 ;
V_393 ++ ;
V_187 -> V_385 = F_13 ( V_18 | V_20 ) ;
if ( ! V_187 -> V_385 ) {
F_147 ( V_393 ) ;
return - V_19 ;
}
...
( void * ) V_187 -> V_385 ,
V_9 , V_10 ) ;
for ( V_4 = 0 ; V_4 < V_384 ; V_4 ++ ) {
V_187 -> V_188 . V_7 [ V_4 ] = V_396 ;
}
V_127 -> V_155 = 0 ;
...
F_54 ( V_147 ) ;
V_127 -> V_156 = 0 ;
V_127 -> V_141 . V_398 = V_399 ;
V_127 -> V_142 . V_398 = V_399 ;
return 0 ;
}
...
V_393 ++ ;
memcpy ( V_57 -> V_381 , & V_400 ,
sizeof( struct V_401 ) ) ;
strcpy ( V_57 -> V_381 -> V_257 , V_257 ) ;
V_57 -> V_381 -> V_402 = F_151 ;
V_57 -> V_381 -> V_386 = & V_187 -> V_386 ;
F_168 ( V_57 -> V_381 , V_57 ) ;
return 0 ;
}
...
if ( V_16 )
return V_16 ;
V_16 = F_164 ( & V_187 -> V_142 , V_405 ,
V_406 ) ;
if ( V_16 )
return V_16 ;
V_16 = F_170 ( V_383 , F_91 , 0 ,
V_268 , NULL ) ;
if ( V_16 ) {
F_34 ( V_54 L_130 ,
V_383 ) ;
...
F_172 ( & V_382 , & V_187 -> V_386 ) ;
V_393 ++ ;
V_16 = F_173 ( V_187 -> V_141 . V_381 ,
V_407 , - 1 ) ;
if ( V_16 < 0 ) {
F_34 ( V_54 L_132
L_133 ) ;
