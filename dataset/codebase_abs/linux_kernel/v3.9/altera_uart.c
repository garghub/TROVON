...
static T_2 F_29 ( int V_66 , void * V_67 )
{
struct V_1 * V_2 = V_67 ;
struct V_10 * V_11 = F_7 ( V_2 , struct V_10 , V_2 ) ;
unsigned int V_68 ;
...
static void F_33 ( unsigned long V_67 )
{
struct V_1 * V_2 = ( void * ) V_67 ;
struct V_10 * V_11 = F_7 ( V_2 , struct V_10 , V_2 ) ;
F_29 ( 0 , V_2 ) ;
F_34 ( & V_11 -> V_69 , V_70 + F_35 ( V_2 ) ) ;
}
...
int V_72 ;
if ( ! V_2 -> V_66 ) {
F_38 ( & V_11 -> V_69 , F_33 , ( unsigned long ) V_2 ) ;
F_34 ( & V_11 -> V_69 , V_70 + F_35 ( V_2 ) ) ;
return 0 ;
}
V_72 = F_39 ( V_2 -> V_66 , F_29 , 0 ,
V_73 , V_2 ) ;
if ( V_72 ) {
F_40 ( V_73 L_1
...
static void F_50 ( struct V_1 * V_2 , unsigned char V_78 )
{
while ( ! ( F_1 ( V_2 , V_7 ) &
V_60 ) )
F_49 () ;
...
static void F_51 ( struct V_1 * V_2 , const char V_78 )
{
while ( ! ( F_1 ( V_2 , V_7 ) &
V_60 ) )
F_49 () ;
...
static void F_52 ( struct V_79 * V_80 , const char * V_81 ,
unsigned int V_82 )
{
...
{
struct V_98 * V_99 = V_93 -> V_96 . V_100 ;
struct V_1 * V_2 ;
struct V_101 * V_102 ;
struct V_101 * V_103 ;
...
int V_72 ;
if ( V_104 == - 1 ) {
for ( V_104 = 0 ; V_104 < V_89 ; V_104 ++ )
if ( V_83 [ V_104 ] . V_2 . V_106 == 0 )
break;
}
if ( V_104 < 0 || V_104 >= V_89 )
return - V_77 ;
V_2 = & V_83 [ V_104 ] . V_2 ;
V_102 = F_62 ( V_93 , V_107 , 0 ) ;
if ( V_102 )
V_2 -> V_106 = V_102 -> V_108 ;
else if ( V_99 )
V_2 -> V_106 = V_99 -> V_106 ;
else
return - V_77 ;
V_103 = F_62 ( V_93 , V_109 , 0 ) ;
if ( V_103 )
V_2 -> V_66 = V_103 -> V_108 ;
else if ( V_99 )
V_2 -> V_66 = V_99 -> V_66 ;
if ( V_99 )
V_2 -> V_30 = V_99 -> V_30 ;
