...
F_46 () ;
F_31 ( L_112 ) ;
F_31 ( L_113 , V_69 -> V_72 , F_45 ( V_69 ) ) ;
F_42 ( V_8 ) ;
F_31 ( L_114 ) ;
F_31 ( L_115 , V_8 -> V_195 -> V_61 ) ;
F_31 ( L_43 ) ;
F_32 () ;
F_31 ( L_79 ) ;
F_44 ( V_69 ) ;
...
static int F_173 ( struct V_64 * V_65 , unsigned int V_63 ,
...
F_174 ( ( V_281 * ) & V_24 -> V_149 ) ;
if ( F_49 ( V_24 ) ) {
F_31 ( L_116 , V_24 -> V_52 , V_24 -> V_61 ) ;
if ( V_24 -> V_62 > 1 )
F_31 ( L_4 , V_24 -> V_62 ) ;
F_31 ( L_21 ) ;
F_32 () ;
...
V_204 = F_131 ( V_204 , V_220 ) ;
if ( V_195 && ! F_175 ( V_195 ) )
return F_172 ( V_69 , V_8 , V_12 ) ;
...
static int
F_177 ( struct V_68 * V_69 , struct V_64 * V_65 ,
unsigned long V_12 )
{
if ( ! F_8 () )
return 0 ;
...
static int F_178 ( struct V_68 * V_69 , struct V_64 * V_65 ,
unsigned long V_12 )
{
if ( F_59 ( ! V_2 ) )
return 0 ;
...
return 0 ;
if ( V_69 -> V_71 <= 0 )
return F_177 ( V_69 , V_65 , V_12 ) ;
return 1 ;
}
static int F_179 ( struct V_7 * V_8 , struct V_64 * V_65 )
{
if ( V_8 -> V_194 == V_65 )
return 1 ;
if ( V_8 -> V_279 ) {
...
static int
F_180 ( struct V_64 * V_65 , const char * V_61 ,
...
static int F_182 ( struct V_68 * V_69 ,
struct V_64 * V_65 , unsigned long V_12 )
{
struct V_7 * V_8 ;
unsigned int V_70 ;
...
static void
F_183 ( struct V_64 * V_65 , int V_286 , unsigned long V_12 )
{
struct V_68 * V_69 = V_3 ;
if ( ! F_178 ( V_69 , V_65 , V_12 ) )
return;
if ( V_286 ) {
if ( ! F_182 ( V_69 , V_65 , V_12 ) )
return;
} else {
if ( ! F_181 ( V_69 , V_65 , V_12 ) )
return;
}
F_130 ( V_69 ) ;
}
static int F_175 ( struct V_64 * V_65 )
{
struct V_68 * V_69 = V_3 ;
int V_13 ;
for ( V_13 = 0 ; V_13 < V_69 -> V_71 ; V_13 ++ ) {
...
void F_185 ( struct V_64 * V_65 , const char * V_61 ,
struct V_93 * V_52 , unsigned int V_63 ,
unsigned long V_12 )
{
unsigned long V_95 ;
...
V_3 -> V_4 = 1 ;
F_164 ( V_95 ) ;
if ( F_180 ( V_65 , V_61 , V_52 , V_63 , V_12 ) )
F_130 ( V_3 ) ;
V_3 -> V_4 = 0 ;
F_67 ( V_95 ) ;
}
void F_186 ( struct V_64 * V_65 , unsigned int V_63 ,
...
F_164 ( V_95 ) ;
V_3 -> V_4 = 1 ;
F_187 ( V_65 , V_63 , V_199 , V_40 , V_218 , V_195 , V_12 ) ;
F_173 ( V_65 , V_63 , V_199 , V_40 , V_218 ,
F_162 ( V_95 ) , V_195 , V_12 , 0 ) ;
V_3 -> V_4 = 0 ;
F_67 ( V_95 ) ;
}
void F_188 ( struct V_64 * V_65 , int V_286 ,
unsigned long V_12 )
{
unsigned long V_95 ;
if ( F_59 ( V_3 -> V_4 ) )
...
V_3 -> V_4 = 1 ;
F_189 ( V_65 , V_12 ) ;
F_183 ( V_65 , V_286 , V_12 ) ;
V_3 -> V_4 = 0 ;
F_67 ( V_95 ) ;
}
int F_190 ( struct V_64 * V_65 )
{
unsigned long V_95 ;
int V_5 = 0 ;
if ( F_59 ( V_3 -> V_4 ) )
...
static int
F_193 ( struct V_68 * V_69 , struct V_64 * V_65 ,
unsigned long V_12 )
{
if ( ! F_8 () )
return 0 ;
...
static void
F_196 ( struct V_64 * V_65 , unsigned long V_12 )
{
struct V_68 * V_69 = V_3 ;
struct V_7 * V_8 , * V_219 ;
struct V_23 * V_25 ;
...
void F_200 ( struct V_64 * V_65 , unsigned long V_12 )
{
unsigned long V_95 ;
if ( F_59 ( ! V_38 ) )
return;
...
static void F_202 ( struct V_6 * V_24 )
{
int V_13 ;
for ( V_13 = 0 ; V_13 < V_109 ; V_13 ++ ) {
if ( V_111 [ V_13 ] . V_24 == V_24 )
F_203 ( & V_111 [ V_13 ] . V_115 ) ;
}
F_203 ( & V_24 -> V_104 ) ;
F_203 ( & V_24 -> V_101 ) ;
V_24 -> V_52 = NULL ;
}
static inline int F_204 ( const void * V_82 , void * V_78 , unsigned long V_296 )
{
return V_82 >= V_78 && V_82 < V_78 + V_296 ;
}
void F_205 ( void * V_78 , unsigned long V_296 )
{
...
if ( F_86 ( V_113 ) )
continue;
F_206 (class, next, head, hash_entry) {
if ( F_204 ( V_24 -> V_52 , V_78 , V_296 ) )
F_202 ( V_24 ) ;
else if ( F_204 ( V_24 -> V_61 , V_78 , V_296 ) )
F_202 ( V_24 ) ;
}
}
if ( V_297 )
...
static void
F_209 ( struct V_68 * V_69 , const void * V_301 ,
...
static inline int F_210 ( const void * V_301 , unsigned long V_303 ,
const void * V_304 , unsigned long V_305 )
{
return V_304 + V_305 <= V_301 ||
V_301 + V_303 <= V_304 ;
}
void F_211 ( const void * V_301 , unsigned long V_303 )
{
struct V_68 * V_69 = V_3 ;
struct V_7 * V_8 ;
unsigned long V_95 ;
...
for ( V_13 = 0 ; V_13 < V_69 -> V_71 ; V_13 ++ ) {
V_8 = V_69 -> V_73 + V_13 ;
if ( F_210 ( V_301 , V_303 , V_8 -> V_194 ,
sizeof( * V_8 -> V_194 ) ) )
continue;
F_209 ( V_69 , V_301 , V_301 + V_303 , V_8 ) ;
break;
}
F_101 ( V_95 ) ;
}
static void F_212 ( struct V_68 * V_69 )
{
if ( ! F_8 () )
return;
if ( V_136 )
...
void F_221 ( const char * V_315 , const int line , const char * V_316 )
{
struct V_68 * V_69 = V_3 ;
#ifndef F_222
if ( ! F_8 () )
