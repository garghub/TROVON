...
static int F_83 ( struct V_6 * V_7 , T_3 V_161 )
{
struct V_4 * V_5 = F_5 ( V_7 ) ;
if ( V_5 ) {
V_5 -> V_162 = F_29 ( V_5 -> V_51 ) ;
F_30 ( V_5 -> V_162 | V_5 -> V_52 , V_5 -> V_51 ) ;
F_9 ( V_5 , V_108 ) ;
}
return 0 ;
}
