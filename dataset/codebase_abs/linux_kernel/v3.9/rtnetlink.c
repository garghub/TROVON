...
static int F_146 ( struct V_39 * V_40 , struct V_60 * V_61 , void * V_302 )
{
struct V_27 * V_27 = F_105 ( V_40 -> V_241 ) ;
struct V_97 * V_98 ;
struct V_28 * V_29 ;
...
static int F_149 ( struct V_39 * V_40 , struct V_60 * V_61 , void * V_302 )
{
struct V_27 * V_27 = F_105 ( V_40 -> V_241 ) ;
const struct V_18 * V_20 ;
struct V_28 * V_29 ;
...
V_188 = V_20 -> V_307 () ;
V_26 = - V_295 ;
V_29 = F_155 ( V_20 -> V_308 , V_281 , V_20 -> V_309 ,
V_186 , V_188 ) ;
if ( ! V_29 )
goto V_26;
F_156 ( V_29 , V_27 ) ;
...
static int F_159 ( struct V_39 * V_40 , struct V_60 * V_61 , void * V_302 )
{
struct V_27 * V_27 = F_105 ( V_40 -> V_241 ) ;
const struct V_18 * V_20 ;
struct V_28 * V_29 ;
...
! V_20 -> V_324 )
return - V_268 ;
V_26 = V_20 -> V_324 ( V_29 , V_248 , V_42 ) ;
if ( V_26 < 0 )
return V_26 ;
V_282 = 1 ;
}
...
if ( V_248 [ V_205 ] || V_248 [ V_191 ] || V_248 [ V_326 ] )
return - V_268 ;
if ( ! V_20 ) {
#ifdef F_160
if ( V_19 [ 0 ] ) {
...
V_318 = F_113 ( V_27 , V_248 ) ;
if ( F_126 ( V_318 ) )
return F_127 ( V_318 ) ;
V_29 = F_154 ( V_318 , V_281 , V_20 , V_248 ) ;
if ( F_126 ( V_29 ) ) {
V_26 = F_127 ( V_29 ) ;
goto V_45;
}
...
if ( V_20 -> V_327 )
V_26 = V_20 -> V_327 ( V_27 , V_29 , V_248 , V_42 ) ;
else
V_26 = F_162 ( V_29 ) ;
...
static int F_165 ( struct V_39 * V_40 , struct V_60 * V_61 , void * V_302 )
{
struct V_27 * V_27 = F_105 ( V_40 -> V_241 ) ;
struct V_97 * V_98 ;
char V_281 [ V_146 ] ;
...
if ( V_29 == NULL )
return - V_291 ;
V_328 = F_166 ( F_84 ( V_29 , V_129 ) , V_15 ) ;
if ( V_328 == NULL )
return - V_16 ;
V_26 = F_89 ( V_328 , V_29 , V_256 , F_52 ( V_40 ) . V_257 ,
V_61 -> V_258 , 0 , 0 , V_129 ) ;
if ( V_26 < 0 ) {
F_167 ( V_26 == - V_43 ) ;
F_168 ( V_328 ) ;
} else
V_26 = F_56 ( V_328 , V_27 , F_52 ( V_40 ) . V_257 ) ;
return V_26 ;
}
...
int type = V_240 -> V_61 -> V_331 - V_4 ;
if ( V_244 < V_245 || V_244 == V_332 )
continue;
if ( V_10 [ V_244 ] == NULL ||
...
static int F_175 ( struct V_39 * V_40 , struct V_60 * V_61 , void * V_302 )
{
struct V_27 * V_27 = F_105 ( V_40 -> V_241 ) ;
struct V_336 * V_337 ;
...
V_26 = V_20 -> V_357 ( V_337 , V_248 , V_29 , V_335 , V_61 -> V_321 ) ;
if ( V_26 )
goto V_45;
else
V_337 -> V_342 &= ~ V_353 ;
}
if ( ( V_337 -> V_342 & V_350 ) && V_29 -> V_144 -> V_357 ) {
V_26 = V_29 -> V_144 -> V_357 ( V_337 , V_248 ,
V_29 , V_335 ,
V_61 -> V_321 ) ;
if ( ! V_26 ) {
...
static int F_178 ( struct V_39 * V_40 , struct V_60 * V_61 , void * V_302 )
{
struct V_27 * V_27 = F_105 ( V_40 -> V_241 ) ;
struct V_336 * V_337 ;
struct V_32 * V_248 [ V_352 + 1 ] ;
...
static int F_180 ( struct V_39 * V_40 ,
struct V_239 * V_240 ,
struct V_28 * V_29 ,
int * V_244 ,
struct V_361 * V_24 )
...
int V_26 ;
F_182 ( V_29 ) ;
V_26 = F_180 ( V_40 , V_240 , V_29 , & V_244 , & V_29 -> V_365 ) ;
if ( V_26 )
goto V_45;
F_180 ( V_40 , V_240 , V_29 , & V_244 , & V_29 -> V_366 ) ;
V_45:
F_183 ( V_29 ) ;
return V_244 ;
}
static int F_184 ( struct V_39 * V_40 , struct V_239 * V_240 )
{
int V_244 = 0 ;
struct V_27 * V_27 = F_105 ( V_40 -> V_241 ) ;
struct V_28 * V_29 ;
...
int F_186 ( struct V_39 * V_40 , T_5 V_52 , T_5 V_159 ,
...
if ( ! V_369 )
goto V_70;
if ( F_187 ( V_40 , V_370 , V_371 ) ||
F_187 ( V_40 , V_372 , V_368 ) ) {
F_50 ( V_40 , V_369 ) ;
goto V_70;
}
F_49 ( V_40 , V_369 ) ;
...
static int F_188 ( struct V_39 * V_40 , struct V_239 * V_240 )
{
struct V_27 * V_27 = F_105 ( V_40 -> V_241 ) ;
struct V_28 * V_29 ;
int V_244 = 0 ;
...
struct V_32 * V_373 ;
T_5 V_374 = 0 ;
V_373 = F_189 ( V_240 -> V_61 , sizeof( struct V_375 ) ,
V_252 ) ;
if ( V_373 )
V_374 = F_108 ( V_373 ) ;
F_106 () ;
...
static int F_191 ( struct V_28 * V_29 , T_8 V_62 )
{
struct V_27 * V_27 = F_124 ( V_29 ) ;
struct V_28 * V_356 = F_90 ( V_29 ) ;
struct V_39 * V_40 ;
int V_26 = - V_268 ;
V_40 = F_166 ( F_190 () , V_349 ) ;
if ( ! V_40 ) {
V_26 = - V_295 ;
goto V_283;
}
...
static int F_192 ( struct V_39 * V_40 , struct V_60 * V_61 ,
void * V_302 )
{
struct V_27 * V_27 = F_105 ( V_40 -> V_241 ) ;
struct V_97 * V_98 ;
...
V_378 = F_189 ( V_61 , sizeof( struct V_97 ) , V_235 ) ;
if ( V_378 ) {
...
if ( ! V_26 )
V_26 = F_191 ( V_29 , V_379 ) ;
V_45:
return V_26 ;
}
static int F_195 ( struct V_39 * V_40 , struct V_60 * V_61 ,
void * V_302 )
{
struct V_27 * V_27 = F_105 ( V_40 -> V_241 ) ;
struct V_97 * V_98 ;
...
static int F_196 ( struct V_39 * V_40 , struct V_60 * V_61 )
{
struct V_27 * V_27 = F_105 ( V_40 -> V_241 ) ;
T_1 V_11 ;
int V_384 , V_19 ;
...
return - V_268 ;
type -= V_4 ;
if ( V_61 -> F_193 < F_197 ( sizeof( struct V_375 ) ) )
return 0 ;
V_36 = ( (struct V_375 * ) F_198 ( V_61 ) ) -> V_387 ;
V_384 = type >> 2 ;
V_19 = type & 3 ;
if ( V_19 != 2 && ! F_128 ( V_27 -> V_284 , V_285 ) )
return - V_286 ;
if ( V_19 == 2 && V_61 -> V_321 & V_388 ) {
struct V_55 * V_56 ;
T_2 V_13 ;
T_3 V_14 ;
T_8 V_389 = 0 ;
...
V_26 = F_199 ( V_56 , V_40 , V_61 , & V_391 ) ;
}
F_1 () ;
return V_26 ;
}
memset ( V_393 , 0 , ( V_394 * sizeof( struct V_395 * ) ) ) ;
V_385 = V_396 [ V_384 ] ;
if ( V_61 -> F_193 < V_385 )
return - V_264 ;
if ( V_61 -> F_193 > V_385 ) {
int V_397 = V_61 -> F_193 - F_85 ( V_385 ) ;
struct V_395 * V_163 = ( void * ) V_61 + F_85 ( V_385 ) ;
while ( F_200 ( V_163 , V_397 ) ) {
unsigned int V_398 = V_163 -> V_399 & V_400 ;
if ( V_398 ) {
if ( V_398 > V_401 [ V_384 ] )
return - V_264 ;
V_393 [ V_398 - 1 ] = V_163 ;
}
V_163 = F_201 ( V_163 , V_397 ) ;
}
}
V_11 = F_15 ( V_36 , type ) ;
if ( V_11 == NULL )
return - V_268 ;
return V_11 ( V_40 , V_61 , ( void * ) & V_393 [ 0 ] ) ;
}
static void F_202 ( struct V_39 * V_40 )
{
F_1 () ;
F_203 ( V_40 , & F_196 ) ;
F_5 () ;
}
static int F_204 ( struct V_402 * V_403 , unsigned long V_404 , void * V_405 )
{
struct V_28 * V_29 = V_405 ;
switch ( V_404 ) {
case V_406 :
case V_407 :
case V_408 :
...
static int T_11 F_205 ( struct V_27 * V_27 )
{
struct V_55 * V_241 ;
struct V_419 V_420 = {
. V_421 = V_422 ,
...
V_241 = F_206 ( V_27 , V_426 , & V_420 ) ;
if ( ! V_241 )
return - V_295 ;
V_27 -> V_56 = V_241 ;
return 0 ;
}
static void T_12 F_207 ( struct V_27 * V_27 )
{
F_208 ( V_27 -> V_56 ) ;
V_27 -> V_56 = NULL ;
}
void T_13 F_209 ( void )
{
int V_66 ;
V_394 = 0 ;
for ( V_66 = 0 ; V_66 < F_210 ( V_401 ) ; V_66 ++ )
if ( V_401 [ V_66 ] > V_394 )
V_394 = V_401 [ V_66 ] ;
V_393 = F_132 ( V_394 * sizeof( struct V_395 * ) , V_15 ) ;
if ( ! V_393 )
F_21 ( L_15 ) ;
if ( F_211 ( & V_427 ) )
F_21 ( L_16 ) ;
F_212 ( & V_428 ) ;
F_20 ( V_12 , V_429 , F_165 ,
F_104 , F_169 ) ;
F_20 ( V_12 , V_430 , F_146 , NULL , NULL ) ;
F_20 ( V_12 , V_256 , F_159 , NULL , NULL ) ;
F_20 ( V_12 , V_431 , F_149 , NULL , NULL ) ;
F_20 ( V_12 , V_432 , NULL , F_171 , NULL ) ;
F_20 ( V_12 , V_433 , NULL , F_171 , NULL ) ;
F_20 ( V_434 , V_358 , F_175 , NULL , NULL ) ;
F_20 ( V_434 , V_360 , F_178 , NULL , NULL ) ;
F_20 ( V_434 , V_435 , NULL , F_184 , NULL ) ;
F_20 ( V_434 , V_429 , NULL , F_188 , NULL ) ;
F_20 ( V_434 , V_431 , F_195 , NULL , NULL ) ;
F_20 ( V_434 , V_430 , F_192 , NULL , NULL ) ;
}
