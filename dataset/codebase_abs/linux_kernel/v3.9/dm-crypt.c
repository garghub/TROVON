...
static int F_123 ( struct V_2 * V_3 , char * V_157 )
{
unsigned V_64 ;
int V_23 ;
V_3 -> V_6 = F_124 ( V_3 -> V_54 * sizeof( struct V_5 * ) ,
V_43 ) ;
if ( ! V_3 -> V_6 )
return - V_44 ;
for ( V_64 = 0 ; V_64 < V_3 -> V_54 ; V_64 ++ ) {
V_3 -> V_6 [ V_64 ] = F_125 ( V_157 , 0 , 0 ) ;
...
static int F_128 ( struct V_2 * V_3 , char * V_24 )
{
int V_33 = - V_39 ;
...
static int F_140 ( struct V_34 * V_35 ,
...
V_3 -> V_164 = F_141 ( V_165 , V_43 ) ;
if ( ! V_3 -> V_164 )
goto V_174;
V_166 = V_165 ;
V_170 = F_142 ( & V_166 , L_13 ) ;
V_37 = F_142 ( & V_170 , L_15 ) ;
if ( ! V_170 )
V_3 -> V_54 = 1 ;
...
V_3 -> V_53 = V_3 -> V_54 ;
V_3 -> V_37 = F_141 ( V_37 , V_43 ) ;
if ( ! V_3 -> V_37 )
goto V_174;
V_167 = F_142 ( & V_166 , L_13 ) ;
V_169 = F_142 ( & V_166 , L_13 ) ;
V_168 = F_142 ( & V_169 , L_15 ) ;
if ( V_166 )
F_144 ( L_18 ) ;
V_3 -> V_4 = F_145 ( sizeof( * ( V_3 -> V_4 ) ) ,
F_146 ( struct V_1 ) ) ;
if ( ! V_3 -> V_4 ) {
V_35 -> error = L_19 ;
goto V_174;
...
V_172 = F_123 ( V_3 , V_171 ) ;
if ( V_172 < 0 ) {
V_35 -> error = L_25 ;
goto V_42;
}
V_172 = F_128 ( V_3 , V_24 ) ;
if ( V_172 < 0 ) {
V_35 -> error = L_26 ;
goto V_42;
}
...
static int F_148 ( struct V_34 * V_35 , unsigned int V_184 , char * * V_185 )
{
struct V_2 * V_3 ;
...
V_3 -> V_25 = V_25 ;
V_35 -> V_161 = V_3 ;
V_172 = F_140 ( V_35 , V_185 [ 0 ] , V_185 [ 1 ] ) ;
if ( V_172 < 0 )
goto V_42;
V_172 = - V_44 ;
V_3 -> V_126 = F_149 ( V_193 , V_194 ) ;
if ( ! V_3 -> V_126 ) {
V_35 -> error = L_40 ;
goto V_42;
}
V_3 -> V_88 = sizeof( struct V_86 ) ;
V_3 -> V_88 += F_150 ( F_3 ( V_3 ) ) ;
V_3 -> V_88 = F_64 ( V_3 -> V_88 , F_151 () ) ;
V_3 -> V_88 += F_65 ( F_3 ( V_3 ) ) &
~ ( F_151 () - 1 ) ;
V_3 -> V_101 = F_152 ( V_193 , V_3 -> V_88 +
sizeof( struct V_8 ) + V_3 -> V_10 ) ;
if ( ! V_3 -> V_101 ) {
V_35 -> error = L_41 ;
goto V_42;
}
V_3 -> V_121 = F_153 ( V_195 , 0 ) ;
if ( ! V_3 -> V_121 ) {
V_35 -> error = L_42 ;
goto V_42;
}
V_3 -> V_45 = F_154 ( V_193 , 0 ) ;
if ( ! V_3 -> V_45 ) {
V_35 -> error = L_43 ;
goto V_42;
}
...
V_3 -> V_84 = V_187 ;
if ( F_155 ( V_35 , V_185 [ 3 ] , F_156 ( V_35 -> V_196 ) , & V_3 -> V_137 ) ) {
V_35 -> error = L_46 ;
goto V_42;
}
...
V_189 . V_184 = V_184 ;
V_189 . V_185 = V_185 ;
V_172 = F_157 ( V_192 , & V_189 , & V_186 , & V_35 -> error ) ;
if ( V_172 )
goto V_42;
V_190 = F_158 ( & V_189 ) ;
if ( V_186 == 1 && V_190 &&
...
static int F_160 ( struct V_34 * V_35 , struct V_75 * V_75 )
{
struct V_109 * V_110 ;
struct V_2 * V_3 = V_35 -> V_161 ;
...
if ( F_113 ( V_75 ) )
V_75 -> V_141 = V_3 -> V_142 + F_161 ( V_35 , V_75 -> V_141 ) ;
return V_205 ;
}
V_110 = F_92 ( V_3 , V_75 , F_161 ( V_35 , V_75 -> V_141 ) ) ;
if ( F_53 ( V_110 -> V_127 ) == V_134 ) {
...
static void F_162 ( struct V_34 * V_35 , T_6 type ,
...
break;
case V_213 :
F_163 ( L_54 , V_3 -> V_164 ) ;
if ( V_3 -> V_25 > 0 )
for ( V_64 = 0 ; V_64 < V_3 -> V_25 ; V_64 ++ )
F_163 ( L_55 , V_3 -> V_24 [ V_64 ] ) ;
else
F_163 ( L_13 ) ;
F_163 ( L_56 , ( unsigned long long ) V_3 -> V_84 ,
...
{
struct V_2 * V_3 = V_35 -> V_161 ;
F_129 ( V_215 , & V_3 -> V_28 ) ;
}
static int F_165 ( struct V_34 * V_35 )
{
struct V_2 * V_3 = V_35 -> V_161 ;
if ( ! F_166 ( V_160 , & V_3 -> V_28 ) ) {
F_167 ( L_58 ) ;
return - V_216 ;
}
return 0 ;
...
{
struct V_2 * V_3 = V_35 -> V_161 ;
F_131 ( V_215 , & V_3 -> V_28 ) ;
}
static int F_169 ( struct V_34 * V_35 , unsigned V_184 , char * * V_185 )
{
struct V_2 * V_3 = V_35 -> V_161 ;
int V_172 = - V_39 ;
if ( V_184 < 2 )
...
if ( ! F_166 ( V_215 , & V_3 -> V_28 ) ) {
F_144 ( L_60 ) ;
return - V_39 ;
}
if ( V_184 == 3 && ! strcasecmp ( V_185 [ 1 ] , L_61 ) ) {
V_172 = F_128 ( V_3 , V_185 [ 2 ] ) ;
if ( V_172 )
return V_172 ;
if ( V_3 -> V_96 && V_3 -> V_96 -> V_183 )
V_172 = V_3 -> V_96 -> V_183 ( V_3 ) ;
...
static int F_170 ( struct V_34 * V_35 , struct V_218 * V_219 ,
struct V_89 * V_220 , int V_221 )
{
struct V_2 * V_3 = V_35 -> V_161 ;
struct V_222 * V_223 = F_171 ( V_3 -> V_137 -> V_138 ) ;
if ( ! V_223 -> V_224 )
return V_221 ;
V_219 -> V_136 = V_3 -> V_137 -> V_138 ;
V_219 -> V_141 = V_3 -> V_142 + F_161 ( V_35 , V_219 -> V_141 ) ;
return F_172 ( V_221 , V_223 -> V_224 ( V_223 , V_219 , V_220 ) ) ;
}
