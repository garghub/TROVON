...
if ( V_167 -> type == V_72 ) {
F_60 ( & V_32 -> V_187 , V_181 ) ;
F_29 ( V_32 -> V_100 , V_188 , & V_13 -> V_194 ,
& V_13 -> V_78 ) ;
F_61 ( & V_13 -> V_194 ) ;
V_13 -> V_14 = 0 ;
F_62 ( & V_32 -> V_187 , V_181 ) ;
...
struct V_195 * V_196 ;
if ( V_156 -> type == V_72 ) {
V_196 = & V_13 -> V_178 [ V_170 -> V_171 . V_51 ] ;
V_196 -> V_181 &= ~ V_197 ;
F_60 ( & V_32 -> V_187 , V_181 ) ;
F_64 ( & V_196 -> V_198 , & V_13 -> V_194 ) ;
V_13 -> V_14 ++ ;
F_62 ( & V_32 -> V_187 , V_181 ) ;
} else if ( V_156 -> type == V_57 ) {
V_196 = & V_13 -> V_172 [ V_170 -> V_171 . V_51 ] ;
V_196 -> V_181 &= ~ V_197 ;
F_60 ( & V_32 -> V_187 , V_181 ) ;
F_65 ( V_170 -> V_171 . V_51 , & V_13 -> V_191 ) ;
F_64 ( & V_196 -> V_198 , & V_13 -> V_189 ) ;
V_13 -> V_18 ++ ;
F_62 ( & V_32 -> V_187 , V_181 ) ;
} else {
F_19 ( L_46 , V_156 -> type ) ;
}
if ( F_2 ( V_13 ) )
F_30 ( V_13 ) ;
F_29 ( V_32 -> V_100 , V_103 , V_32 ) ;
}
struct V_199 * F_66 ( void )
{
return & V_200 ;
}
struct V_201 * F_67 ( void )
{
return & V_202 ;
}
const struct V_203 * F_68 ( void )
{
return & V_204 ;
}
...
struct V_205 V_206 ;
int V_5 ;
F_70 ( & V_13 -> V_180 , V_207 ) ;
if ( V_13 -> V_180 . error ) {
F_19 ( L_47 ) ;
return V_13 -> V_180 . error ;
}
for ( V_5 = 0 ; V_5 < V_207 ; V_5 ++ ) {
if ( F_71 ( V_208 [ V_5 ] . V_127 ) ) {
memset ( & V_206 , 0 , sizeof( struct V_205 ) ) ;
V_206 . V_209 = & V_210 ;
V_206 . V_127 = V_208 [ V_5 ] . V_127 ;
V_206 . V_211 = V_208 [ V_5 ] . V_212 ;
V_206 . V_213 = V_208 [ V_5 ] . V_214 ;
V_206 . V_215 = V_208 [ V_5 ] . V_216 ;
V_206 . V_35 = V_208 [ V_5 ] . V_35 ;
V_206 . type = V_208 [ V_5 ] . type ;
V_206 . V_217 = V_208 [ V_5 ] . V_217 ;
V_206 . V_218 = 0 ;
V_13 -> V_219 [ V_5 ] = F_72 ( & V_13 -> V_180 ,
& V_206 , NULL ) ;
} else {
V_13 -> V_219 [ V_5 ] = F_73 ( & V_13 -> V_180 ,
& V_210 ,
V_208 [ V_5 ] . V_127 , V_208 [ V_5 ] . V_212 ,
V_208 [ V_5 ] . V_214 , V_208 [ V_5 ] . V_217 ,
V_208 [ V_5 ] . V_216 ) ;
}
if ( V_13 -> V_180 . error ) {
F_19 ( L_48 , V_5 ) ;
...
if ( V_208 [ V_5 ] . V_220 && V_13 -> V_219 [ V_5 ] )
V_13 -> V_219 [ V_5 ] -> V_181 |= V_221 ;
}
return 0 ;
}
...
{
struct V_2 V_3 ;
V_3 . V_9 . V_10 . V_11 = V_222 ;
V_13 -> V_74 = F_1 ( & V_3 , V_49 ) ;
V_3 . V_9 . V_10 . V_11 = V_223 ;
