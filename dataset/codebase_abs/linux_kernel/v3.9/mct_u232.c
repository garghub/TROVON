...
F_29 ( & V_69 -> V_70 , V_72 ) ;
V_69 -> V_74 = V_74 ;
F_19 ( V_13 , & V_69 -> V_33 , V_69 -> V_74 ) ;
F_30 ( & V_69 -> V_70 , V_72 ) ;
V_71 = F_31 ( V_13 -> V_65 , V_20 ) ;
if ( V_71 ) {
F_9 ( & V_13 -> V_5 ,
L_13 ,
V_13 -> V_65 -> V_82 , V_71 ) ;
...
static void F_33 ( struct V_12 * V_13 , int V_83 )
{
unsigned int V_33 ;
struct V_68 * V_69 = F_27 ( V_13 ) ;
F_34 ( & V_69 -> V_70 ) ;
...
static void F_38 ( struct V_84 * V_84 )
{
struct V_12 * V_13 = V_84 -> V_67 ;
struct V_68 * V_69 = F_27 ( V_13 ) ;
unsigned char * V_85 = V_84 -> V_86 ;
int V_71 ;
int V_87 = V_84 -> V_87 ;
unsigned long V_72 ;
switch ( V_87 ) {
...
F_39 ( & V_13 -> V_5 , V_91 , V_84 -> V_92 , V_85 ) ;
if ( V_84 -> V_93 > 2 ) {
if ( V_84 -> V_92 ) {
F_40 ( & V_13 -> V_13 , V_85 ,
V_84 -> V_92 ) ;
...
struct V_1 * V_2 = V_13 -> V_2 ;
struct V_68 * V_69 = F_27 ( V_13 ) ;
struct V_97 * V_76 = & V_11 -> V_76 ;
unsigned int V_99 = V_76 -> V_77 ;
unsigned int V_100 = V_98 -> V_77 ;
unsigned long V_72 ;
unsigned int V_33 ;
unsigned char V_73 ;
F_29 ( & V_69 -> V_70 , V_72 ) ;
...
V_73 = 0 ;
if ( ( V_100 & V_78 ) == V_101 ) {
F_11 ( & V_13 -> V_5 , L_18 , V_91 ) ;
V_33 |= V_36 | V_38 ;
F_15 ( V_13 , V_33 ) ;
}
F_3 ( V_11 , V_2 , V_13 , F_44 ( V_11 ) ) ;
if ( ( V_99 & V_78 ) == V_101 ) {
F_11 ( & V_13 -> V_5 , L_19 , V_91 ) ;
V_33 &= ~ ( V_36 | V_38 ) ;
F_15 ( V_13 , V_33 ) ;
}
if ( V_99 & V_102 )
...
static void F_45 ( struct V_10 * V_11 , int V_117 )
{
...
F_51 ( V_126 ) ;
struct V_12 * V_13 = V_11 -> V_118 ;
struct V_68 * V_127 = F_27 ( V_13 ) ;
struct V_46 V_128 , V_129 ;
unsigned long V_72 ;
F_11 ( & V_13 -> V_5 , L_21 , V_91 , V_124 ) ;
switch ( V_124 ) {
case V_130 :
F_11 ( & V_13 -> V_5 , L_22 , V_91 ) ;
F_29 ( & V_127 -> V_70 , V_72 ) ;
V_129 = V_127 -> V_47 ;
F_30 ( & V_127 -> V_70 , V_72 ) ;
for ( ; ; ) {
F_52 ( & V_13 -> V_95 ,
& V_126 , V_131 ) ;
F_53 () ;
F_54 ( & V_13 -> V_95 , & V_126 ) ;
if ( F_55 ( V_132 ) )
return - V_133 ;
if ( V_13 -> V_2 -> V_134 )
return - V_135 ;
...
V_128 = V_127 -> V_47 ;
F_30 ( & V_127 -> V_70 , V_72 ) ;
if ( V_128 . V_53 == V_129 . V_53 && V_128 . V_49 == V_129 . V_49 &&
V_128 . V_55 == V_129 . V_55 && V_128 . V_51 == V_129 . V_51 )
return - V_135 ;
if ( ( ( V_125 & V_136 ) && ( V_128 . V_53 != V_129 . V_53 ) ) ||
( ( V_125 & V_57 ) && ( V_128 . V_49 != V_129 . V_49 ) ) ||
( ( V_125 & V_63 ) && ( V_128 . V_55 != V_129 . V_55 ) ) ||
( ( V_125 & V_59 ) && ( V_128 . V_51 != V_129 . V_51 ) ) ) {
return 0 ;
}
V_129 = V_128 ;
}
...
struct V_12 * V_13 = V_11 -> V_118 ;
struct V_68 * V_127 = F_27 ( V_13 ) ;
struct V_46 * V_139 = & V_127 -> V_47 ;
unsigned long V_72 ;
F_29 ( & V_127 -> V_70 , V_72 ) ;
V_47 -> V_51 = V_139 -> V_51 ;
V_47 -> V_49 = V_139 -> V_49 ;
V_47 -> V_53 = V_139 -> V_53 ;
V_47 -> V_55 = V_139 -> V_55 ;
V_47 -> V_140 = V_139 -> V_140 ;
V_47 -> V_141 = V_139 -> V_141 ;
V_47 -> V_142 = V_139 -> V_142 ;
V_47 -> V_143 = V_139 -> V_143 ;
V_47 -> V_144 = V_139 -> V_144 ;
V_47 -> V_145 = V_139 -> V_145 ;
V_47 -> V_146 = V_139 -> V_146 ;
F_30 ( & V_127 -> V_70 , V_72 ) ;
F_11 ( & V_13 -> V_5 , L_23 ,
V_91 , V_47 -> V_140 , V_47 -> V_141 ) ;
return 0 ;
}
