...
V_83 |
V_60 -> V_58 ) ;
V_78 -> V_46 = F_62 ( F_37 ( V_60 -> V_46 ) ) ;
V_78 -> V_84 = F_62 ( V_60 -> V_55 | V_85 ) ;
V_78 -> V_86 = F_63 ( V_60 -> V_56 ) ;
V_78 -> V_87 = F_63 ( V_60 -> V_57 ) ;
V_78 -> V_88 = F_62 ( V_60 -> V_39 . V_37 ) ;
if ( V_60 -> V_39 . V_3 < 0 ) {
V_78 -> V_81 |= F_62 ( V_89 ) ;
V_78 -> V_90 = 0 ;
} else {
V_78 -> V_90 = F_63 ( F_35 ( V_20 ,
& V_60 -> V_39 ) ) ;
}
...
V_78 -> V_84 |= F_62 ( V_92 |
V_93 ) ;
V_78 -> V_94 = F_62 ( 1 << V_60 -> V_39 . V_3 ) ;
} else {
V_78 -> V_81 |= F_62 ( V_95 ) ;
}
V_30 = F_38 ( V_20 , V_48 ,
...
int V_97 , int V_36 , T_2 * V_98 )
{
struct F_19 * V_65 = F_19 ( V_20 ) ;
T_3 * V_99 ;
T_4 V_100 ;
int V_12 ;
V_99 = F_66 ( & V_65 -> V_22 . V_27 , V_39 -> V_24 +
V_97 , & V_100 ) ;
if ( ! V_99 )
return - V_18 ;
F_67 ( & V_20 -> V_101 -> V_20 , V_100 ,
V_36 * sizeof ( T_2 ) , V_102 ) ;
for ( V_12 = 0 ; V_12 < V_36 ; ++ V_12 )
V_99 [ V_12 ] = F_63 ( V_98 [ V_12 ] | V_103 ) ;
F_68 ( & V_20 -> V_101 -> V_20 , V_100 ,
V_36 * sizeof ( T_2 ) , V_102 ) ;
return 0 ;
}
...
int V_105 ;
int V_106 ;
V_105 = V_107 / sizeof( T_2 ) ;
V_106 = V_105 - ( V_39 -> V_24 + V_97 )
% V_105 ;
V_104 = F_70 ( int , V_106 , V_36 ) ;
while ( V_36 > 0 ) {
V_30 = F_65 ( V_20 , V_39 , V_97 , V_104 , V_98 ) ;
if ( V_30 )
return V_30 ;
V_36 -= V_104 ;
V_97 += V_104 ;
V_98 += V_104 ;
V_104 = F_70 ( int , V_105 , V_36 ) ;
}
return V_30 ;
}
...
V_108 = V_48 -> V_80 ;
while ( V_36 > 0 ) {
V_104 = F_70 ( int , V_110 / sizeof( T_2 ) - 2 ,
V_36 ) ;
V_108 [ 0 ] = F_63 ( V_39 -> V_24 + V_97 ) ;
V_108 [ 1 ] = 0 ;
for ( V_12 = 0 ; V_12 < V_104 ; ++ V_12 )
V_108 [ V_12 + 2 ] = F_63 ( V_98 [ V_12 ] |
V_103 ) ;
V_30 = F_42 ( V_20 , V_48 , V_104 ) ;
if ( V_30 ) {
F_64 ( V_20 , V_48 ) ;
return V_30 ;
}
...
return F_69 ( V_20 , V_39 , V_97 , V_36 , V_98 ) ;
}
...
int V_30 ;
int V_12 ;
V_98 = F_73 ( V_80 -> V_36 * sizeof *V_98 , V_14 ) ;
if ( ! V_98 )
return - V_18 ;
for ( V_12 = 0 ; V_12 < V_80 -> V_36 ; ++ V_12 )
if ( V_80 -> V_112 == 1 )
V_98 [ V_12 ] = V_80 -> V_113 . V_114 + ( V_12 << V_80 -> V_37 ) ;
else
V_98 [ V_12 ] = V_80 -> V_98 [ V_12 ] . V_114 ;
V_30 = F_71 ( V_20 , V_39 , 0 , V_80 -> V_36 , V_98 ) ;
F_16 ( V_98 ) ;
return V_30 ;
}
int F_74 ( struct V_19 * V_20 , T_1 V_55 , enum V_115 type ,
struct V_116 * V_117 )
{
T_1 V_69 ;
if ( ( type == V_118 &&
! ( V_20 -> V_43 . V_81 & V_119 ) ) ||
( type == V_120 &&
! ( V_20 -> V_43 . V_121 & V_122 ) ) )
return - V_123 ;
V_69 = F_45 ( V_20 ) ;
if ( V_69 == - 1 )
return - V_18 ;
V_117 -> V_46 = F_36 ( V_69 ) ;
V_117 -> V_55 = V_55 ;
V_117 -> type = type ;
V_117 -> V_61 = V_62 ;
return 0 ;
}
int F_75 ( struct V_19 * V_20 , struct V_116 * V_117 )
{
struct V_47 * V_48 ;
struct V_77 * V_78 ;
int V_30 ;
V_30 = F_51 ( V_20 , F_37 ( V_117 -> V_46 ) ) ;
if ( V_30 )
return V_30 ;
V_48 = F_59 ( V_20 ) ;
if ( F_60 ( V_48 ) ) {
...
V_78 = V_48 -> V_80 ;
memset ( V_78 , 0 , sizeof( * V_78 ) ) ;
V_78 -> V_46 = F_62 ( F_37 ( V_117 -> V_46 ) ) ;
V_78 -> V_84 = F_62 ( V_117 -> V_55 ) ;
if ( V_117 -> type == V_120 ) {
V_78 -> V_81 |= F_62 ( V_91 ) ;
V_78 -> V_124 = F_62 ( V_125 ) ;
V_78 -> V_84 |= F_62 ( V_85 ) ;
}
V_30 = F_38 ( V_20 , V_48 ,
F_37 ( V_117 -> V_46 ) &
...
F_64 ( V_20 , V_48 ) ;
V_79:
F_54 ( V_20 , F_37 ( V_117 -> V_46 ) ) ;
return V_30 ;
}
void F_76 ( struct V_19 * V_20 , struct V_116 * V_117 )
{
int V_30 ;
if ( V_117 -> V_61 == V_73 ) {
V_30 = F_39 ( V_20 , NULL ,
...
int V_30 ;
if ( ! F_78 ( V_20 -> V_43 . V_74 ) )
return - V_109 ;
if ( F_79 ( V_20 ) )
return 0 ;
V_30 = F_80 ( & V_22 -> V_66 , V_20 -> V_43 . V_74 ,
~ 0 , V_20 -> V_43 . V_126 , 0 ) ;
if ( V_30 )
return V_30 ;
V_30 = F_9 ( & V_22 -> V_26 ,
F_81 ( ( T_1 ) V_20 -> V_43 . V_127 /
( 1 << V_25 ) ) ) ;
if ( V_30 )
goto V_128;
if ( V_20 -> V_43 . V_129 ) {
...
return;
if ( V_65 -> V_129 >= 0 )
F_30 ( V_20 , V_65 -> V_129 ,
F_82 ( V_20 -> V_43 . V_129 - 1 ) ) ;
F_17 ( & V_22 -> V_26 ) ;
F_83 ( & V_22 -> V_66 ) ;
}
static inline int F_85 ( struct V_131 * V_132 , T_2 * V_98 ,
int V_36 , T_2 V_56 )
{
int V_12 , V_133 ;
if ( V_36 > V_132 -> V_134 )
return - V_109 ;
V_133 = ( 1 << V_132 -> V_37 ) - 1 ;
if ( V_56 & V_133 )
return - V_109 ;
if ( 0 )
for ( V_12 = 0 ; V_12 < V_36 ; ++ V_12 ) {
...
if ( V_132 -> V_135 >= V_132 -> V_136 )
return - V_109 ;
return 0 ;
}
int F_86 ( struct V_19 * V_20 , struct V_131 * V_132 , T_2 * V_98 ,
int V_36 , T_2 V_56 , T_1 * V_137 , T_1 * V_138 )
{
T_1 V_46 ;
int V_12 , V_30 ;
V_30 = F_85 ( V_132 , V_98 , V_36 , V_56 ) ;
if ( V_30 )
return V_30 ;
++ V_132 -> V_135 ;
V_46 = F_37 ( V_132 -> V_60 . V_46 ) ;
V_46 += V_20 -> V_43 . V_74 ;
* V_137 = * V_138 = V_132 -> V_60 . V_46 = F_36 ( V_46 ) ;
* ( V_139 * ) V_132 -> V_140 = V_141 ;
F_87 () ;
F_67 ( & V_20 -> V_101 -> V_20 , V_132 -> V_100 ,
V_36 * sizeof( T_2 ) , V_102 ) ;
for ( V_12 = 0 ; V_12 < V_36 ; ++ V_12 )
V_132 -> V_99 [ V_12 ] = F_63 ( V_98 [ V_12 ] | V_103 ) ;
F_68 ( & V_20 -> V_101 -> V_20 , V_132 -> V_100 ,
V_36 * sizeof( T_2 ) , V_102 ) ;
V_132 -> V_140 -> V_46 = F_62 ( V_46 ) ;
V_132 -> V_140 -> V_137 = F_62 ( V_46 ) ;
V_132 -> V_140 -> V_87 = F_63 ( V_36 * ( 1ull << V_132 -> V_37 ) ) ;
V_132 -> V_140 -> V_86 = F_63 ( V_56 ) ;
F_87 () ;
* ( V_139 * ) V_132 -> V_140 = V_142 ;
F_87 () ;
return 0 ;
}
int F_88 ( struct V_19 * V_20 , T_1 V_55 , T_1 V_58 , int V_134 ,
int V_136 , V_139 V_37 , struct V_131 * V_132 )
{
struct F_19 * V_65 = F_19 ( V_20 ) ;
int V_30 = - V_18 ;
if ( V_136 > V_20 -> V_43 . V_143 )
return - V_109 ;
if ( V_37 < ( F_89 ( V_20 -> V_43 . V_144 ) - 1 ) || V_37 >= 32 )
return - V_109 ;
if ( V_134 * sizeof * V_132 -> V_99 > V_107 )
return - V_109 ;
V_132 -> V_37 = V_37 ;
V_132 -> V_134 = V_134 ;
V_132 -> V_136 = V_136 ;
V_132 -> V_135 = 0 ;
V_30 = F_55 ( V_20 , V_55 , 0 , 0 , V_58 , V_134 ,
V_37 , & V_132 -> V_60 ) ;
if ( V_30 )
return V_30 ;
V_132 -> V_99 = F_66 ( & V_65 -> V_22 . V_27 ,
V_132 -> V_60 . V_39 . V_24 ,
& V_132 -> V_100 ) ;
if ( ! V_132 -> V_99 ) {
V_30 = - V_18 ;
goto V_145;
...
return 0 ;
V_145:
( void ) F_57 ( V_20 , & V_132 -> V_60 ) ;
return V_30 ;
}
int F_90 ( struct V_19 * V_20 , struct V_131 * V_132 )
{
struct F_19 * V_65 = F_19 ( V_20 ) ;
int V_30 ;
V_30 = F_58 ( V_20 , & V_132 -> V_60 ) ;
if ( V_30 )
return V_30 ;
V_132 -> V_140 = F_66 ( & V_65 -> V_22 . V_70 ,
F_37 ( V_132 -> V_60 . V_46 ) , NULL ) ;
if ( ! V_132 -> V_140 )
return - V_18 ;
return 0 ;
}
void F_91 ( struct V_19 * V_20 , struct V_131 * V_132 ,
T_1 * V_137 , T_1 * V_138 )
{
struct V_47 * V_48 ;
int V_30 ;
...
V_132 -> V_60 . V_61 = V_75 ;
}
int F_93 ( struct V_19 * V_20 , struct V_131 * V_132 )
{
int V_76 ;
if ( V_132 -> V_135 )
return - V_147 ;
V_76 = F_57 ( V_20 , & V_132 -> V_60 ) ;
if ( V_76 )
return V_76 ;
V_132 -> V_60 . V_61 = V_62 ;
return 0 ;
}
int F_94 ( struct V_19 * V_20 )
{
return F_32 ( V_20 , 0 , 0 , 0 , V_148 , 1000 ,
V_149 ) ;
}
