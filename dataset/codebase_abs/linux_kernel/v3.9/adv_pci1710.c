...
static const void * F_42 ( struct V_1 * V_2 ,
struct V_161 * V_162 )
{
const struct V_13 * V_14 ;
int V_8 ;
for ( V_8 = 0 ; V_8 < F_43 ( V_163 ) ; V_8 ++ ) {
V_14 = & V_163 [ V_8 ] ;
if ( V_162 -> V_164 == V_14 -> V_165 )
return V_14 ;
}
return NULL ;
}
...
return - V_170 ;
V_2 -> V_171 = V_14 ;
V_2 -> V_172 = V_14 -> V_173 ;
V_16 = F_46 ( sizeof( * V_16 ) , V_174 ) ;
if ( ! V_16 )
return - V_175 ;
V_2 -> V_17 = V_16 ;
V_167 = F_47 ( V_162 , V_2 -> V_172 ) ;
if ( V_167 )
return V_167 ;
V_2 -> V_23 = F_48 ( V_162 , 2 ) ;
V_169 = 0 ;
if ( V_14 -> V_176 )
V_169 ++ ;
if ( V_14 -> V_154 )
...
if ( V_14 -> V_179 )
V_169 ++ ;
V_167 = F_49 ( V_2 , V_169 ) ;
if ( V_167 )
return V_167 ;
F_41 ( V_2 ) ;
if ( V_14 -> V_180 && V_162 -> V_105 ) {
V_167 = F_50 ( V_162 -> V_105 , F_30 ,
V_181 , V_2 -> V_172 , V_2 ) ;
if ( V_167 == 0 )
V_2 -> V_105 = V_162 -> V_105 ;
}
V_168 = 0 ;
if ( V_14 -> V_176 ) {
V_4 = & V_2 -> V_89 [ V_168 ] ;
V_2 -> V_182 = V_4 ;
V_4 -> type = V_183 ;
V_4 -> V_184 = V_185 | V_186 | V_187 ;
if ( V_14 -> V_188 )
V_4 -> V_184 |= V_189 ;
V_4 -> V_6 = V_14 -> V_176 ;
V_4 -> V_190 = V_14 -> V_191 ;
V_4 -> V_192 = V_14 -> V_176 ;
V_4 -> V_193 = V_14 -> V_194 ;
V_4 -> V_195 = F_24 ;
V_4 -> V_196 = F_11 ;
if ( V_2 -> V_105 ) {
V_4 -> V_184 |= V_197 ;
...
V_4 = & V_2 -> V_89 [ V_168 ] ;
V_4 -> type = V_200 ;
V_4 -> V_184 = V_201 | V_187 | V_186 ;
V_4 -> V_6 = V_14 -> V_154 ;
V_4 -> V_190 = V_14 -> V_202 ;
V_4 -> V_192 = V_14 -> V_154 ;
V_4 -> V_193 = V_14 -> V_203 ;
switch ( V_14 -> V_48 ) {
case V_160 :
V_4 -> V_204 = F_23 ;
break;
...
V_4 = & V_2 -> V_89 [ V_168 ] ;
V_4 -> type = V_205 ;
V_4 -> V_184 = V_185 | V_187 | V_186 ;
V_4 -> V_6 = V_14 -> V_177 ;
V_4 -> V_190 = 1 ;
V_4 -> V_192 = V_14 -> V_177 ;
V_4 -> V_193 = & V_206 ;
V_4 -> V_207 = 0 ;
V_4 -> V_208 = F_16 ;
V_168 ++ ;
...
V_4 -> V_6 = V_14 -> V_178 ;
V_4 -> V_190 = 1 ;
V_4 -> V_192 = V_14 -> V_178 ;
V_4 -> V_193 = & V_206 ;
V_4 -> V_207 = ( 1 << V_14 -> V_178 ) - 1 ;
V_4 -> V_58 = 0 ;
V_4 -> V_208 = F_17 ;
V_168 ++ ;
}
...
V_4 = & V_2 -> V_89 [ V_168 ] ;
V_4 -> type = V_210 ;
V_4 -> V_184 = V_185 | V_201 ;
V_4 -> V_6 = V_14 -> V_179 ;
V_4 -> V_192 = V_14 -> V_179 ;
V_4 -> V_190 = 0xffff ;
V_4 -> V_193 = & V_211 ;
V_4 -> V_196 = F_19 ;
V_4 -> V_204 = F_20 ;
...
static int F_55 ( struct V_161 * V_2 ,
const struct V_214 * V_215 )
{
return F_56 ( V_2 , & V_216 ) ;
}
