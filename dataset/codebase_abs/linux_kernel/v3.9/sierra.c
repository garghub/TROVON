...
F_55 ( V_40 -> V_112 [ V_22 ] ) ;
F_55 ( V_38 -> V_46 ) ;
}
static int F_56 ( struct V_37 * V_38 , T_4 V_113 )
{
int V_114 ;
int V_97 = - V_115 ;
int V_22 ;
...
static struct V_67 * F_57 ( struct V_9 * V_10 , int V_98 ,
...
if ( V_79 ) {
F_38 ( V_67 , V_10 -> V_33 ,
F_39 ( V_10 -> V_33 , V_98 ) | V_116 ,
V_79 , V_118 , V_119 , V_117 ) ;
F_10 ( & V_10 -> V_33 -> V_33 , L_30 , V_74 ,
V_116 == V_120 ? 'i' : 'o' , V_67 , V_79 ) ;
} else {
F_10 ( & V_10 -> V_33 -> V_33 , L_31 , V_74 ,
V_116 == V_120 ? 'i' : 'o' , V_67 , V_79 ) ;
F_21 ( V_67 ) ;
V_67 = NULL ;
}
...
static int F_64 ( struct V_48 * V_49 , struct V_37 * V_38 )
{
struct V_39 * V_40 ;
struct V_9 * V_10 = V_38 -> V_10 ;
...
V_98 = V_38 -> V_125 ;
for ( V_22 = 0 ; V_22 < V_40 -> V_111 ; V_22 ++ ) {
V_67 = F_57 ( V_10 , V_98 , V_120 , V_38 ,
V_126 , V_127 ,
F_43 ) ;
V_40 -> V_112 [ V_22 ] = V_67 ;
}
F_65 ( V_10 -> V_33 ,
F_39 ( V_10 -> V_33 , V_98 ) | V_120 ) ;
V_97 = F_56 ( V_38 , V_127 ) ;
if ( V_97 ) {
F_58 ( V_38 ) ;
if ( ! V_10 -> V_122 )
F_16 ( V_10 -> V_14 ) ;
...
static void F_66 ( struct V_37 * V_38 , int V_128 )
{
struct V_39 * V_40 ;
V_40 = F_13 ( V_38 ) ;
V_40 -> V_45 = V_128 ;
...
static int F_76 ( struct V_37 * V_38 )
{
struct V_39 * V_40 ;
V_40 = F_13 ( V_38 ) ;
F_22 ( V_40 ) ;
...
static int F_79 ( struct V_9 * V_10 , T_6 V_139 )
{
struct V_70 * V_71 ;
int V_140 ;
if ( F_80 ( V_139 ) ) {
