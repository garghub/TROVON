...
int F_37 ( struct V_1 * V_2 , T_5 * V_89 ,
struct V_36 * V_46 , struct V_36 * V_90 )
{
struct V_67 V_68 ;
...
V_92 = * V_89 ;
V_91 = ( * V_89 * sizeof( V_94 ) ) - sizeof( struct V_67 ) ;
V_68 . V_42 = V_91 ;
V_68 . V_73 = 0 ;
} else {
return 0 ;
}
F_6 ( & V_2 -> V_18 -> V_2 , V_95 , F_39 ( & V_68 ) ) ;
* V_89 -= V_92 ;
if ( F_28 ( V_2 , & V_68 ,
V_2 -> V_26 + V_2 -> V_5 ) ) {
V_2 -> V_8 = V_9 ;
...
F_42 ( V_2 -> V_8 != V_98 ) ;
V_97 = V_2 -> V_26 + V_2 -> V_5 ;
F_42 ( V_2 -> V_23 < V_2 -> V_5 + V_68 -> V_42 ) ;
F_43 ( V_2 , V_97 , V_68 -> V_42 ) ;
V_2 -> V_5 += V_68 -> V_42 ;
if ( ! V_68 -> V_73 )
return 0 ;
F_6 ( & V_2 -> V_18 -> V_2 ,
...
F_30 ( & V_46 -> V_60 , & V_96 -> V_60 ) ;
}
return 0 ;
}
int F_44 ( struct V_1 * V_2 , T_5 * V_89 )
{
if ( ( ( * V_89 ) * sizeof( V_94 ) ) < ( sizeof( struct V_67 )
+ sizeof( struct V_100 ) ) ) {
return - V_101 ;
}
* V_89 -= F_38 ( sizeof( struct V_100 ) ) ;
...
const struct V_37 * V_37 , struct V_105 * V_106 )
{
struct V_36 * V_107 = NULL ;
struct V_36 * V_108 = NULL ;
bool V_109 = false ;
...
if ( F_49 ( V_2 , V_37 , & V_2 -> V_104 . V_60 ) )
V_109 = true ;
F_49 ( V_2 , V_37 , & V_2 -> V_110 . V_60 ) ;
if ( F_49 ( V_2 , V_37 , & V_2 -> V_111 . V_60 ) )
V_109 = true ;
