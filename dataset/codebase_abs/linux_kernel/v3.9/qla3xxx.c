...
V_2 -> V_210 == V_211 ? L_64 : L_65 ,
V_2 -> V_540 ) ;
F_64 ( V_17 , L_66 ,
F_93 ( V_209 , & V_2 -> V_199 ) ? L_67 : L_68 ) ;
F_64 ( V_17 , L_69 ,
( ( V_2 -> V_541 == 64 ) ? L_70 : L_71 ) ,
( ( V_2 -> V_542 ) ? L_72 : L_73 ) ) ;
F_64 ( V_17 , L_74 ,
V_2 -> V_7 ) ;
F_64 ( V_17 , L_75 , V_38 -> V_325 ) ;
F_78 ( V_2 , V_543 , V_17 , L_76 , V_17 -> V_70 ) ;
}
...
F_195 ( V_2 ) ;
if ( V_2 -> V_15 ) {
V_17 -> V_415 = V_2 -> V_74 . V_170 . V_591 ;
F_44 ( V_17 , V_2 -> V_74 . V_592 . V_593 ) ;
} else {
V_17 -> V_415 = V_2 -> V_74 . V_169 . V_591 ;
F_44 ( V_17 , V_2 -> V_74 . V_594 . V_593 ) ;
}
V_17 -> V_595 = V_378 ;
F_218 ( V_2 ) ;
if ( V_2 -> V_542 )
F_237 ( V_38 , ( int ) 0x4e , ( V_65 ) 0x0036 ) ;
V_30 = F_238 ( V_17 ) ;
if ( V_30 ) {
F_47 ( L_101 , F_113 ( V_38 ) ) ;
goto V_590;
}
F_149 ( V_17 ) ;
F_148 ( V_17 ) ;
V_2 -> V_335 = F_239 ( V_17 -> V_125 ) ;
F_240 ( & V_2 -> V_336 , F_216 ) ;
F_240 ( & V_2 -> V_562 , F_217 ) ;
F_240 ( & V_2 -> V_203 , F_96 ) ;
F_241 ( & V_2 -> V_206 ) ;
V_2 -> V_206 . V_596 = F_220 ;
V_2 -> V_206 . V_597 = V_207 + V_208 * 2 ;
...
static void F_246 ( struct V_537 * V_38 )
{
struct V_67 * V_17 = F_247 ( V_38 ) ;
struct V_1 * V_2 = F_108 ( V_17 ) ;
F_248 ( V_17 ) ;
F_24 ( V_2 ) ;
if ( V_2 -> V_335 ) {
