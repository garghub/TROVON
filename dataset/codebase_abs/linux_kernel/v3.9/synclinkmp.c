...
static int F_179 ( T_1 * V_1 , V_431 * V_445 , T_10 * V_446 , int V_12 )
{
int V_339 ;
unsigned long V_447 ;
...
if ( V_1 -> V_451 == NULL )
return - V_226 ;
V_1 -> V_452 = F_183 ( V_1 -> V_68 , V_353 ) ;
if ( ! V_1 -> V_452 ) {
F_146 ( V_1 -> V_451 ) ;
V_1 -> V_451 = NULL ;
return - V_226 ;
...
{
if ( F_186 ( V_1 -> V_124 , V_428 , L_132 ) == NULL ) {
F_4 ( L_133 ,
...
V_1 -> V_455 = true ;
if ( F_186 ( V_1 -> V_126 + V_1 -> V_456 , 128 , L_132 ) == NULL ) {
F_4 ( L_134 ,
...
V_1 -> V_457 = true ;
if ( F_186 ( V_1 -> V_123 + V_1 -> V_458 , V_229 , L_132 ) == NULL ) {
F_4 ( L_135 ,
...
V_1 -> V_459 = true ;
if ( F_186 ( V_1 -> V_125 + V_1 -> V_460 , V_461 , L_132 ) == NULL ) {
F_4 ( L_136 ,
...
V_1 -> V_464 = F_187 ( V_1 -> V_126 , V_465 ) ;
if ( ! V_1 -> V_464 ) {
F_4 ( L_138 ,
__FILE__ , __LINE__ , V_1 -> V_25 , V_1 -> V_126 ) ;
V_1 -> V_24 = V_463 ;
...
V_1 -> V_464 += V_1 -> V_456 ;
V_1 -> V_466 = F_187 ( V_1 -> V_123 , V_465 ) ;
if ( ! V_1 -> V_466 ) {
F_4 ( L_139 ,
__FILE__ , __LINE__ , V_1 -> V_25 , V_1 -> V_123 ) ;
V_1 -> V_24 = V_463 ;
...
if ( V_1 -> V_455 ) {
F_191 ( V_1 -> V_124 , V_428 ) ;
V_1 -> V_455 = false ;
}
if ( V_1 -> V_457 ) {
F_191 ( V_1 -> V_126 + V_1 -> V_456 , 128 ) ;
V_1 -> V_457 = false ;
}
if ( V_1 -> V_459 ) {
F_191 ( V_1 -> V_123 + V_1 -> V_458 , V_229 ) ;
V_1 -> V_459 = false ;
}
if ( V_1 -> V_462 ) {
F_191 ( V_1 -> V_125 + V_1 -> V_460 , V_461 ) ;
V_1 -> V_462 = false ;
}
if ( V_1 -> V_440 ) {
F_192 ( V_1 -> V_440 ) ;
...
if ( V_1 -> V_466 ) {
F_192 ( V_1 -> V_466 - V_1 -> V_458 ) ;
V_1 -> V_466 = NULL ;
}
if ( V_1 -> V_467 ) {
F_192 ( V_1 -> V_467 - V_1 -> V_460 ) ;
V_1 -> V_467 = NULL ;
}
if ( V_1 -> V_464 ) {
F_192 ( V_1 -> V_464 - V_1 -> V_456 ) ;
V_1 -> V_464 = NULL ;
}
if ( V_31 >= V_32 )
F_4 ( L_143 ,
...
static T_1 * F_194 ( int V_470 , int V_251 , struct V_474 * V_475 )
{
T_1 * V_1 ;
...
V_1 -> V_126 = F_199 ( V_475 , 0 ) ;
V_1 -> V_123 = F_199 ( V_475 , 2 ) ;
V_1 -> V_124 = F_199 ( V_475 , 3 ) ;
V_1 -> V_125 = F_199 ( V_475 , 4 ) ;
...
V_1 -> V_481 = V_482 ;
V_1 -> V_483 = V_484 ;
F_200 ( & V_1 -> V_86 , V_485 , ( unsigned long ) V_1 ) ;
F_200 ( & V_1 -> V_354 , V_486 ,
( unsigned long ) V_1 ) ;
...
static void F_201 ( int V_470 , struct V_474 * V_475 )
{
T_1 * V_345 [ V_488 ] ;
int V_27 ;
for ( V_27 = 0 ; V_27 < V_488 ; ++ V_27 ) {
V_345 [ V_27 ] = F_194 ( V_470 , V_27 , V_475 ) ;
if( V_345 [ V_27 ] == NULL ) {
for ( -- V_27 ; V_27 >= 0 ; -- V_27 ) {
F_202 ( & V_345 [ V_27 ] -> V_27 ) ;
F_146 ( V_345 [ V_27 ] ) ;
}
return;
}
...
static void F_216 ( T_1 * V_1 , int V_381 )
{
if ( V_381 ) {
...
if ( V_1 -> V_65 . V_211 )
F_218 ( V_1 , V_1 -> V_65 . V_211 ) ;
else
F_218 ( V_1 , 3686400 ) ;
}
static void F_218 ( T_1 * V_1 , T_13 V_82 )
{
T_13 V_510 ;
unsigned char V_511 ;
T_13 V_512 = 0 ;
...
F_76 ( V_1 , V_509 , V_147 ) ;
if ( V_1 -> V_65 . V_11 & V_197 )
F_218 ( V_1 , V_1 -> V_65 . V_211 * V_535 ) ;
else
F_218 ( V_1 , V_1 -> V_65 . V_211 ) ;
if ( V_1 -> V_65 . V_11 & V_202 )
V_1 -> V_345 [ 0 ] -> V_507 |= ( V_280 << ( V_1 -> V_251 * 2 ) ) ;
...
{
F_221 ( V_1 , 0 , V_1 -> V_434 - 1 ) ;
}
static void F_221 ( T_1 * V_1 , unsigned int V_555 , unsigned int V_556 )
{
bool V_557 = false ;
while( ! V_557 ) {
...
if ( V_31 >= V_571 )
F_222 ( V_1 , V_1 -> V_436 [ V_558 ] . V_448 ,
...
T_10 * V_564 ;
if ( V_31 >= V_571 )
F_222 ( V_1 , V_61 , F_35 (unsigned int, count, SCABUFSIZE) , 1 ) ;
for( V_339 = 0 ; ; )
{
V_572 = F_35 (unsigned int, count, SCABUFSIZE) ;
V_563 = & V_1 -> V_437 [ V_339 ] ;
V_564 = & V_1 -> V_438 [ V_339 ] ;
F_223 ( V_1 , V_564 -> V_448 , V_61 , V_572 ) ;
V_563 -> V_444 = V_572 ;
V_563 -> V_258 = 0 ;
V_61 += V_572 ;
V_12 -= V_572 ;
...
static unsigned int V_12 = F_225 ( V_576 ) ;
unsigned int V_339 ;
bool V_182 = true ;
unsigned long V_11 ;
F_13 ( & V_1 -> V_47 , V_11 ) ;
...
F_14 ( & V_1 -> V_47 , V_11 ) ;
V_1 -> V_345 [ 0 ] -> V_344 = 0 ;
if ( F_224 ( V_1 -> V_345 [ 0 ] ) &&
F_224 ( V_1 -> V_345 [ 1 ] ) ) {
V_1 -> V_345 [ 0 ] -> V_344 = 2 ;
if ( F_224 ( V_1 -> V_345 [ 2 ] ) &&
F_224 ( V_1 -> V_345 [ 3 ] ) )
V_1 -> V_345 [ 0 ] -> V_344 += 2 ;
}
else {
...
if ( ! F_226 ( V_1 -> V_345 [ 0 ] ) ||
! F_226 ( V_1 -> V_345 [ 1 ] ) ||
( V_1 -> V_344 == 4 && ! F_226 ( V_1 -> V_345 [ 2 ] ) ) ||
( V_1 -> V_344 == 4 && ! F_226 ( V_1 -> V_345 [ 3 ] ) ) ) {
F_4 ( L_163 ,
__FILE__ , __LINE__ , V_1 -> V_25 , ( unsigned short ) ( V_1 -> V_127 ) ) ;
return - V_21 ;
}
if ( ! F_229 ( V_1 -> V_345 [ 0 ] ) ||
! F_229 ( V_1 -> V_345 [ 1 ] ) ||
( V_1 -> V_344 == 4 && ! F_229 ( V_1 -> V_345 [ 2 ] ) ) ||
( V_1 -> V_344 == 4 && ! F_229 ( V_1 -> V_345 [ 3 ] ) ) ) {
F_4 ( L_164 ,
__FILE__ , __LINE__ , V_1 -> V_25 ) ;
return - V_21 ;
}
...
unsigned long V_12 = F_225 ( V_576 ) ;
unsigned long V_339 ;
...
static void F_223 ( T_1 * V_1 , char * V_605 , const char * V_606 , unsigned short V_12 )
{
...
static void F_222 ( T_1 * V_1 , const char * V_10 , int V_12 , int V_237 )
{
int V_339 ;
int V_609 ;
if ( V_237 )
...
static int F_232 ( struct V_474 * V_152 ,
...
static void F_234 ( struct V_474 * V_152 )
{
}
