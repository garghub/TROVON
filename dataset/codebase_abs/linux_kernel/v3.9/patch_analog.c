...
V_101 = F_70 ( V_6 , 0x1a , 0 , V_41 , 0 ) ;
F_71 ( V_6 , 0x1b , V_41 , 0 ,
V_103 , V_101 ) ;
}
static void F_72 ( struct V_5 * V_6 )
{
struct V_7 * V_8 = V_6 -> V_8 ;
V_8 -> V_102 = F_66 ( V_6 , 0x1a ) ;
if ( V_8 -> V_104 )
V_8 -> V_102 = ! V_8 -> V_102 ;
F_69 ( V_6 ) ;
}
static void F_73 ( struct V_5 * V_6 , unsigned int V_99 )
{
if ( ( V_99 >> 26 ) != V_105 )
return;
F_72 ( V_6 ) ;
...
static int F_79 ( struct V_5 * V_6 , T_1 V_49 )
{
unsigned int V_107 = F_80 ( V_6 , V_49 ) ;
return F_81 ( V_107 ) != V_108 ;
}
...
const struct V_110 * V_111 , int V_112 )
{
if ( V_112 == V_113 )
V_6 -> V_104 = 1 ;
}
...
V_8 -> V_85 . V_114 = 0x07 ;
V_8 -> V_94 = 0x19 ;
F_87 ( V_8 , 0x18 , 0 , V_41 ) ;
V_8 -> V_85 . V_35 . V_115 = 1 ;
F_88 ( V_6 , NULL , V_116 , V_117 ) ;
F_89 ( V_6 , V_113 ) ;
V_29 = F_61 ( V_6 ) ;
if ( V_29 < 0 ) {
F_51 ( V_6 ) ;
...
int V_172 = F_99 ( V_6 , V_171 ) ;
if ( V_172 == 2 )
return F_100 ( V_2 , V_4 , 2 , V_169 ) ;
else if ( V_172 == 3 )
return F_100 ( V_2 , V_4 , 3 , V_170 ) ;
else
return - V_168 ;
}
...
if ( ! V_171 )
return 0 ;
V_172 = F_99 ( V_6 , V_171 ) ;
if ( V_172 != 2 && V_172 != 3 )
return 0 ;
if ( ! F_104 ( & V_8 -> V_85 , NULL , & V_175 ) )
return - V_31 ;
return 0 ;
}
...
if ( ! F_57 ( V_2 , V_11 ) )
return 0 ;
F_108 ( V_6 , 0x05 , V_8 -> V_86 ? V_187 : 0 ) ;
F_71 ( V_6 , 0x06 , V_41 , 0 ,
V_103 ,
V_8 -> V_86 ? 0 : V_103 ) ;
return 1 ;
}
...
static void F_113 ( void * V_194 , int V_195 )
{
struct V_5 * V_6 = V_194 ;
struct V_7 * V_8 = V_6 -> V_8 ;
F_114 ( V_6 , V_8 -> V_196 , 0 ,
V_82 ,
V_195 ? 0x02 : 0x00 ) ;
}
...
V_8 -> V_85 . V_114 = 0x0e ;
V_8 -> V_94 = 0x10 ;
F_87 ( V_8 , 0x0d , 0 , V_41 ) ;
F_88 ( V_6 , NULL , V_204 , V_205 ) ;
F_89 ( V_6 , V_113 ) ;
V_29 = F_61 ( V_6 ) ;
if ( V_29 < 0 )
goto error;
...
V_8 -> V_35 . V_36 = 0 ;
V_8 -> V_9 = & V_221 ;
V_6 -> V_95 . V_157 = F_112 ;
V_6 -> V_95 . V_156 = F_111 ;
F_117 ( V_6 , 0x11 , V_199 ,
( 0x17 << V_200 ) |
( 0x17 << V_201 ) |
( 0x05 << V_202 ) |
...
struct V_5 * V_6 = F_2 ( V_2 ) ;
struct V_7 * V_8 = V_6 -> V_8 ;
return F_121 ( V_6 , V_4 , V_8 -> V_140 ,
V_8 -> V_142 ) ;
}
...
struct V_5 * V_6 = F_2 ( V_2 ) ;
struct V_7 * V_8 = V_6 -> V_8 ;
return F_123 ( V_6 , V_11 , V_8 -> V_140 ,
...
struct V_5 * V_6 = F_2 ( V_2 ) ;
struct V_7 * V_8 = V_6 -> V_8 ;
int V_29 = F_125 ( V_6 , V_11 , V_8 -> V_140 ,
V_8 -> V_142 ,
& V_8 -> V_35 . V_68 ) ;
if ( V_29 >= 0 && V_8 -> V_143 )
...
struct V_5 * V_6 = F_2 ( V_2 ) ;
unsigned int V_228 ;
V_228 = F_128 ( V_6 , 0x1d , 0 , V_229 ,
V_230 ) ;
if ( ! ( V_228 & 0x80 ) )
V_11 -> V_14 . V_15 . V_16 [ 0 ] = 0 ;
else {
V_228 = F_128 ( V_6 , 0x0b , 0 ,
V_231 , 0 ) ;
if ( V_228 < 3 )
V_228 ++ ;
else
...
static void F_132 ( struct V_5 * V_6 , unsigned int V_99 )
{
if ( ( V_99 >> 26 ) != V_232 )
return;
if ( F_66 ( V_6 , 0x11 ) )
...
int V_172 = F_99 ( V_6 , 0x0b ) + 1 ;
if ( V_172 > 4 )
V_172 = 4 ;
return F_100 ( V_2 , V_4 , V_172 , V_164 ) ;
}
...
V_8 -> V_239 [ V_8 -> V_173 ] ) ;
if ( V_236 )
F_138 ( V_6 , V_236 , false , true ) ;
V_236 = F_137 ( V_6 , V_8 -> V_239 [ V_174 ] ) ;
if ( V_236 )
F_138 ( V_6 , V_236 , true , true ) ;
V_8 -> V_173 = V_174 ;
V_6 -> V_238 = 0 ;
F_139 ( & V_6 -> V_237 ) ;
F_140 ( V_6 ) ;
...
struct V_235 * V_236 ;
V_236 = F_137 ( V_6 , V_8 -> V_239 [ V_19 ] ) ;
if ( V_236 )
F_138 ( V_6 , V_236 , V_236 -> V_241 , false ) ;
}
return 0 ;
}
...
if ( ! V_8 -> V_85 . V_90 . V_240 ||
F_144 ( F_145 ( V_6 , 0x1d ) ) != V_246 )
return 0 ;
V_172 = F_99 ( V_6 , 0x0b ) + 1 ;
if ( V_172 != 3 && V_172 != 4 )
return 0 ;
for ( V_19 = 0 ; V_19 < V_172 ; V_19 ++ ) {
struct V_235 * V_236 = F_146 ( & V_8 -> V_85 . V_247 ) ;
if ( ! V_236 )
return - V_31 ;
* V_236 = V_242 [ V_19 ] ;
if ( ! V_19 )
V_236 -> V_241 = 1 ;
V_8 -> V_239 [ V_19 ] = F_147 ( V_6 , V_236 ) ;
}
if ( ! F_104 ( & V_8 -> V_85 , NULL , & V_248 ) )
return - V_31 ;
V_6 -> V_95 . V_157 = F_141 ;
return 0 ;
}
...
static int F_157 ( struct V_51 * V_52 ,
struct V_5 * V_6 ,
unsigned int V_55 ,
unsigned int V_56 ,
struct V_53 * V_54 )
...
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
int V_328 = F_76 ( V_2 , V_11 ) ;
int V_101 = ( ! V_11 -> V_14 . integer . V_14 [ 0 ] &&
...
unsigned int V_97 ;
V_97 = F_66 ( V_6 , 0x14 ) ;
F_47 ( V_6 , 0x0c , 0 , V_98 ,
V_97 ? 0 : 1 ) ;
}
static void F_164 ( struct V_5 * V_6 , unsigned int V_99 )
{
switch ( V_99 >> 26 ) {
case V_330 :
F_162 ( V_6 ) ;
...
if ( F_66 ( V_6 , 0x14 ) )
V_244 = 0 ;
else if ( F_66 ( V_6 , 0x1c ) )
V_244 = 4 ;
else
V_244 = 1 ;
F_47 ( V_6 , 0x0c , 0 , V_98 , V_244 ) ;
}
...
V_8 -> V_35 . V_36 = 0 ;
V_6 -> V_95 . V_156 = F_168 ;
V_6 -> V_95 . V_157 = F_169 ;
F_117 ( V_6 , 0x20 , V_199 ,
( 0x17 << V_200 ) |
( 0x17 << V_201 ) |
( 0x05 << V_202 ) |
...
V_8 -> V_21 [ 0 ] = V_349 ;
V_8 -> V_35 . V_36 = 0 ;
V_6 -> V_95 . V_156 = F_164 ;
V_6 -> V_95 . V_157 = F_165 ;
F_117 ( V_6 , 0x20 , V_199 ,
( 0x17 << V_200 ) |
( 0x17 << V_201 ) |
( 0x05 << V_202 ) |
...
V_8 -> V_35 . V_36 = 0 ;
V_8 -> V_9 = & V_353 ;
V_6 -> V_95 . V_156 = F_171 ;
V_6 -> V_95 . V_157 = F_172 ;
break;
case V_354 :
V_8 -> V_34 [ 0 ] = V_355 ;
V_8 -> V_21 [ V_8 -> V_20 ++ ] =
V_356 ;
V_8 -> V_35 . V_36 = 0 ;
V_6 -> V_95 . V_156 = F_174 ;
V_6 -> V_95 . V_157 = F_175 ;
break;
case V_357 :
V_8 -> V_34 [ 0 ] = V_358 ;
V_8 -> V_21 [ 0 ] = V_359 ;
V_8 -> V_35 . V_36 = 0 ;
V_6 -> V_95 . V_156 = F_177 ;
V_6 -> V_95 . V_157 = F_178 ;
F_117 ( V_6 , 0x20 , V_199 ,
( 0x17 << V_200 ) |
( 0x17 << V_201 ) |
( 0x05 << V_202 ) |
...
static void F_182 ( struct V_5 * V_6 , unsigned int V_99 )
{
switch ( V_99 >> 26 ) {
case V_361 :
F_180 ( V_6 ) ;
...
V_8 -> V_21 [ V_8 -> V_20 ++ ] =
V_380 ;
V_6 -> V_95 . V_156 = F_182 ;
V_6 -> V_95 . V_157 = F_181 ;
}
break;
case V_381 :
V_8 -> V_33 = 3 ;
