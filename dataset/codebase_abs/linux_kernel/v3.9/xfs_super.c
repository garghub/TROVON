...
V_10 = F_119 ( sizeof( struct V_9 ) , V_23 ) ;
if ( ! V_10 )
goto V_174;
F_63 ( & V_10 -> V_243 ) ;
F_120 ( & V_10 -> V_285 ) ;
F_62 ( & V_10 -> V_263 , 0 ) ;
F_121 ( & V_10 -> V_286 , V_287 ) ;
F_121 ( & V_10 -> V_288 , V_289 ) ;
V_10 -> V_14 = V_13 ;
V_13 -> V_290 = V_10 ;
