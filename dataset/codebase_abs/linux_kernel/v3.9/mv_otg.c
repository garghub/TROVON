...
static T_3
F_47 ( struct V_108 * V_16 , struct V_109 * V_110 , char * V_111 )
{
struct V_4 * V_5 = F_48 ( V_16 ) ;
return F_49 ( V_111 , V_112 , L_21 ,
V_5 -> V_20 . V_78 ) ;
}
static T_3
F_50 ( struct V_108 * V_16 , struct V_109 * V_110 ,
...
int F_54 ( struct V_114 * V_15 )
{
struct V_4 * V_5 = F_55 ( V_15 ) ;
F_56 ( & V_5 -> V_15 -> V_16 . V_115 , & V_116 ) ;
if ( V_5 -> V_17 ) {
F_57 ( V_5 -> V_17 ) ;
F_58 ( V_5 -> V_17 ) ;
}
...
{
struct V_117 * V_7 = V_15 -> V_16 . V_118 ;
struct V_4 * V_5 ;
struct V_1 * V_2 ;
struct V_119 * V_120 ;
int V_63 = 0 , V_121 , V_60 ;
T_4 V_122 ;
if ( V_7 == NULL ) {
F_17 ( & V_15 -> V_16 , L_27 ) ;
return - V_9 ;
}
V_122 = sizeof( * V_5 ) + sizeof( struct V_62 * ) * V_7 -> V_61 ;
V_5 = F_62 ( & V_15 -> V_16 , V_122 , V_123 ) ;
if ( ! V_5 ) {
F_17 ( & V_15 -> V_16 , L_28 ) ;
return - V_124 ;
}
V_2 = F_62 ( & V_15 -> V_16 , sizeof( * V_2 ) , V_123 ) ;
if ( ! V_2 )
return - V_124 ;
F_60 ( V_15 , V_5 ) ;
V_5 -> V_15 = V_15 ;
V_5 -> V_7 = V_7 ;
V_5 -> V_61 = V_7 -> V_61 ;
for ( V_121 = 0 ; V_121 < V_5 -> V_61 ; V_121 ++ ) {
V_5 -> V_62 [ V_121 ] = F_63 ( & V_15 -> V_16 ,
V_7 -> V_125 [ V_121 ] ) ;
if ( F_64 ( V_5 -> V_62 [ V_121 ] ) ) {
V_63 = F_65 ( V_5 -> V_62 [ V_121 ] ) ;
return V_63 ;
}
}
V_5 -> V_17 = F_66 ( L_29 ) ;
...
V_5 -> V_66 = F_69 ( & V_15 -> V_16 , V_120 -> V_132 , F_70 ( V_120 ) ) ;
if ( V_5 -> V_66 == NULL ) {
F_17 ( & V_15 -> V_16 , L_33 ) ;
V_63 = - V_133 ;
goto V_131;
...
V_5 -> V_134 = F_69 ( & V_15 -> V_16 , V_120 -> V_132 , F_70 ( V_120 ) ) ;
if ( V_5 -> V_134 == NULL ) {
F_17 ( & V_15 -> V_16 , L_36 ) ;
V_63 = - V_133 ;
goto V_131;
...
V_5 -> V_35 =
(struct V_135 V_136 * ) ( ( unsigned long ) V_5 -> V_134
+ ( F_21 ( V_5 -> V_134 ) & V_137 ) ) ;
if ( V_7 -> V_23 ) {
V_63 = F_71 ( & V_15 -> V_16 , V_7 -> V_23 -> V_58 ,
NULL , F_46 ,
V_138 , L_38 , V_5 ) ;
if ( V_63 ) {
F_9 ( & V_15 -> V_16 ,
...
if ( V_7 -> V_49 ) {
V_5 -> V_67 = 1 ;
V_63 = F_71 ( & V_15 -> V_16 , V_7 -> V_49 -> V_58 ,
NULL , F_46 ,
V_138 , L_40 , V_5 ) ;
if ( V_63 ) {
F_9 ( & V_15 -> V_16 ,
...
F_20 ( V_5 ) ;
F_24 ( V_5 ) ;
V_120 = F_72 ( V_5 -> V_15 , V_140 , 0 ) ;
if ( V_120 == NULL ) {
F_17 ( & V_15 -> V_16 , L_43 ) ;
V_63 = - V_9 ;
goto V_141;
}
V_5 -> V_58 = V_120 -> V_132 ;
...
V_63 = F_74 ( & V_5 -> V_6 , V_142 ) ;
if ( V_63 < 0 ) {
F_17 ( & V_15 -> V_16 , L_45 ,
V_63 ) ;
goto V_141;
}
V_63 = F_75 ( & V_15 -> V_16 . V_115 , & V_116 ) ;
if ( V_63 < 0 ) {
F_6 ( & V_15 -> V_16 ,
L_46 , V_63 ) ;
goto V_143;
...
static int F_77 ( struct V_114 * V_15 , T_5 V_86 )
{
struct V_4 * V_5 = F_55 ( V_15 ) ;
if ( V_5 -> V_6 . V_86 != V_88 ) {
F_9 ( & V_15 -> V_16 ,
...
static int F_78 ( struct V_114 * V_15 )
{
struct V_4 * V_5 = F_55 ( V_15 ) ;
T_1 V_42 ;
if ( ! V_5 -> V_67 ) {
