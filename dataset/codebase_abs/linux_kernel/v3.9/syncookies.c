...
struct V_14 * V_15 ;
struct V_73 * V_74 ;
struct V_75 * V_76 = F_26 ( V_34 ) ;
const struct V_40 * V_41 = F_12 ( V_36 ) ;
T_5 V_30 = F_17 ( V_41 -> V_77 ) - 1 ;
struct V_33 * V_78 = V_34 ;
struct V_12 * V_13 ;
int V_43 ;
struct V_79 * V_80 ;
V_11 V_81 ;
...
V_15 = F_7 ( V_13 ) ;
V_74 = F_30 ( V_13 ) ;
V_74 -> V_91 = F_17 ( V_41 -> V_48 ) - 1 ;
V_74 -> V_92 = V_30 ;
V_13 -> V_43 = V_43 ;
V_15 -> V_93 = V_41 -> V_47 ;
V_15 -> V_94 = V_41 -> V_46 ;
V_15 -> V_95 = F_11 ( V_36 ) -> V_3 ;
V_15 -> V_96 = F_11 ( V_36 ) -> V_2 ;
V_15 -> V_23 = V_23 ;
V_15 -> V_21 = V_60 . V_21 ;
V_15 -> V_22 = V_60 . V_22 ;
V_15 -> V_20 = V_60 . V_20 ;
V_15 -> V_97 = V_60 . V_63 ;
V_13 -> V_98 = V_60 . V_63 ? V_60 . V_99 : 0 ;
V_74 -> V_100 = V_60 . V_63 ? V_60 . V_62 : 0 ;
V_74 -> V_101 = NULL ;
if ( V_71 && V_71 -> V_102 ) {
int V_103 = sizeof( struct V_104 ) + V_71 -> V_102 ;
V_15 -> V_71 = F_31 ( V_103 , V_105 ) ;
...
V_13 -> V_106 = 0UL ;
V_13 -> V_107 = 0 ;
F_35 ( & V_83 , V_34 -> V_108 , V_34 -> V_109 ,
F_36 ( V_34 ) , V_110 , V_111 ,
F_37 ( V_34 ) ,
( V_71 && V_71 -> V_112 ) ? V_71 -> V_113 : V_15 -> V_96 ,
V_15 -> V_95 , V_41 -> V_46 , V_41 -> V_47 ) ;
F_38 ( V_13 , F_39 ( & V_83 ) ) ;
V_80 = F_40 ( F_16 ( V_34 ) , & V_83 ) ;
if ( F_41 ( V_80 ) ) {
F_22 ( V_13 ) ;
goto V_87;
}
V_13 -> V_114 = V_76 -> V_114 ? : F_42 ( & V_80 -> V_53 , V_115 ) ;
F_43 ( F_44 ( V_34 ) , V_13 -> V_43 ,
& V_13 -> V_116 , & V_13 -> V_114 ,
V_15 -> V_20 , & V_81 ,
F_42 ( & V_80 -> V_53 , V_117 ) ) ;
V_15 -> V_81 = V_81 ;
V_78 = F_19 ( V_34 , V_36 , V_13 , & V_80 -> V_53 ) ;
if ( V_78 )
F_45 ( V_78 ) -> V_118 . V_119 . V_120 . V_121 = V_83 ;
V_87: return V_78 ;
}
