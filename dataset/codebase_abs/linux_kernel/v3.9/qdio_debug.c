...
static int F_18 ( struct V_25 * V_26 , void * V_27 )
{
...
static T_1 F_19 ( struct V_68 * V_68 , const char T_2 * V_74 ,
T_3 V_75 , T_4 * V_76 )
{
struct V_25 * V_77 = V_68 -> V_78 ;
...
static int F_23 ( struct V_67 * V_67 , struct V_68 * V_69 )
{
return F_16 ( V_69 , F_18 ,
F_17 ( V_69 ) -> V_70 ) ;
}
static void F_24 ( struct V_29 * V_30 )
{
char V_81 [ V_82 ] ;
snprintf ( V_81 , V_82 , L_31 ,
V_30 -> V_38 ? L_32 : L_33 ,
V_30 -> V_83 ) ;
V_30 -> V_84 = F_25 ( V_81 , V_85 | V_86 | V_87 ,
V_30 -> V_4 -> V_88 , V_30 , & V_89 ) ;
if ( F_26 ( V_30 -> V_84 ) )
V_30 -> V_84 = NULL ;
}
void F_27 ( struct V_3 * V_4 , struct V_90 * V_19 )
{
struct V_29 * V_30 ;
int V_32 ;
V_4 -> V_88 = F_28 ( F_4 ( & V_19 -> V_20 ) ,
V_91 ) ;
if ( F_26 ( V_4 -> V_88 ) )
V_4 -> V_88 = NULL ;
V_4 -> V_92 = F_25 ( L_34 ,
...
{
V_91 = F_28 ( L_35 , NULL ) ;
V_94 = F_5 ( L_36 , 16 , 1 , 16 ) ;
F_6 ( V_94 , & V_22 ) ;
F_7 ( V_94 , V_95 ) ;
F_2 ( L_37 ) ;
V_96 = F_5 ( L_38 , 4 , 1 , 16 ) ;
F_6 ( V_96 , & V_22 ) ;
F_7 ( V_96 , V_95 ) ;
F_32 ( L_37 ) ;
return 0 ;
