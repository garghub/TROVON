...
if ( V_114 ) {
V_141 = V_114 -> V_144 ;
switch ( F_110 ( V_141 -> V_145 . V_146 . V_131 ) ) {
case V_147 :
F_111 ( V_76 ) ;
F_75 ( NULL , V_114 ) ;
V_114 = NULL ;
...
case V_132 :
V_140 = V_114 -> V_144 ;
if ( V_97 -> V_21 > F_112 ( V_140 -> V_148 [
F_110 ( V_140 -> V_145 . V_83 ) - 1 ] . V_21 ) ) {
F_111 ( V_76 ) ;
F_75 ( NULL , V_114 ) ;
V_114 = NULL ;
} else if ( V_97 -> V_21 <=
F_112 ( V_140 -> V_148 [ 0 ] . V_21 ) ) {
F_111 ( V_76 ) ;
F_75 ( NULL , V_114 ) ;
V_114 = NULL ;
}
...
F_113 ( V_132 ) )
break;
if ( F_114 ( V_141 -> V_145 . V_146 . V_131 !=
F_113 ( V_147 ) ) ) {
F_115 ( L_1 ,
V_149 ,
V_76 -> V_22 -> V_28 ,
...
V_142 = V_141 -> V_142 ;
for ( V_139 = 0 ; V_139 < F_110 ( V_141 -> V_145 . V_83 ) ;
V_142 ++ , V_139 ++ ) {
if ( V_97 -> V_21
<= F_112 ( V_142 -> V_21 ) ) {
V_97 -> V_101 = F_112 ( V_142 -> V_150 ) ;
F_116 ( V_76 ,
V_142 ) ;
break;
}
}
if ( V_139 == F_110 ( V_141 -> V_145 . V_83 ) ) {
F_75 ( NULL , V_114 ) ;
return ( 0 ) ;
}
F_75 ( NULL , V_114 ) ;
...
break;
V_97 -> V_101 = F_112 ( V_140 -> V_145 . V_146 . V_151 ) ;
F_75 ( NULL , V_114 ) ;
...
while ( V_20 > 0 ) {
V_156 = V_153 ;
error = F_118 ( args -> V_22 , ( V_160 ) V_159 ,
...
V_154 = F_119 ( V_33 , V_152 [ V_139 ] . V_162 ) ;
V_158 = F_120 ( V_33 , V_152 [ V_139 ] . V_165 ) ;
error = F_121 ( V_33 , NULL , V_33 -> V_166 ,
V_154 , V_158 , 0 , & V_114 , NULL ) ;
if ( error )
return ( error ) ;
V_157 = F_122 ( int , V_20 , F_123 ( V_114 -> V_167 ) ) ;
F_124 ( V_114 , 0 , V_157 , V_155 , V_168 ) ;
F_125 ( V_114 ) ;
V_155 += V_157 ;
V_20 -= V_157 ;
...
V_169 = 0 ;
error = F_127 ( args -> V_51 , args -> V_22 , V_158 , & V_169 ,
V_24 ) ;
if ( error ) {
return ( error ) ;
}
...
F_36 ( args -> V_40 , args -> V_39 ) ;
V_156 = 1 ;
error = F_128 ( args -> V_51 , V_22 , ( V_160 ) V_159 ,
V_158 ,
V_161 | V_171 ,
...
ASSERT ( ( V_152 . V_162 != V_163 ) &&
( V_152 . V_162 != V_164 ) ) ;
V_154 = F_119 ( V_33 , V_152 . V_162 ) ,
V_158 = F_120 ( V_33 , V_152 . V_165 ) ;
V_114 = F_129 ( V_33 -> V_166 , V_154 , V_158 , 0 ) ;
if ( ! V_114 )
return V_173 ;
V_172 = F_123 ( V_114 -> V_167 ) ;
V_157 = F_122 ( int , V_20 , V_172 ) ;
F_124 ( V_114 , 0 , V_157 , V_170 , V_174 ) ;
if ( V_157 < V_172 )
F_130 ( V_114 , V_157 , V_172 - V_157 ) ;
error = F_131 ( V_114 ) ;
F_125 ( V_114 ) ;
if ( error )
return error ;
...
V_154 = F_119 ( V_33 , V_152 . V_162 ) ,
V_158 = F_120 ( V_33 , V_152 . V_165 ) ;
V_114 = F_133 ( V_33 -> V_166 , V_154 , V_158 , V_176 ) ;
if ( V_114 ) {
F_134 ( V_114 ) ;
F_125 ( V_114 ) ;
V_114 = NULL ;
...
while ( ! V_175 ) {
F_36 ( args -> V_40 , args -> V_39 ) ;
error = F_135 ( args -> V_51 , args -> V_22 , V_159 , V_158 ,
V_161 | V_171 ,
...
if ( V_42 )
F_30 ( args -> V_51 , args -> V_22 , 0 ) ;
error = F_40 ( & args -> V_51 , args -> V_22 ) ;
if ( error )
return ( error ) ;
}
return ( 0 ) ;
