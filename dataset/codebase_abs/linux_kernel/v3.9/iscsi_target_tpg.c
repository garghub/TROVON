...
{
unsigned char V_100 [ 256 ] , V_101 [ 256 ] , * V_102 = NULL ;
int V_103 ;
struct V_16 * V_17 ;
struct V_38 * V_39 = & V_5 -> V_27 ;
if ( ( V_28 != 1 ) && ( V_28 != 0 ) ) {
...
return - V_64 ;
if ( V_28 ) {
snprintf ( V_100 , sizeof( V_100 ) , L_32 , V_17 -> V_65 ) ;
V_102 = strstr ( V_100 , V_66 ) ;
if ( ! V_102 )
goto V_25;
if ( ! strncmp ( V_102 + 4 , L_33 , 1 ) ) {
if ( ! strcmp ( V_100 , V_102 ) )
sprintf ( V_101 , L_32 , V_102 + 5 ) ;
else {
V_102 -- ;
* V_102 = '\0' ;
V_103 = sprintf ( V_101 , L_32 , V_100 ) ;
V_102 += 5 ;
sprintf ( V_101 + V_103 , L_32 , V_102 ) ;
}
} else {
V_102 -- ;
* V_102 = '\0' ;
sprintf ( V_101 , L_32 , V_100 ) ;
}
...
if ( V_102 )
goto V_25;
strncat ( V_100 , L_33 , strlen ( L_33 ) ) ;
strncat ( V_100 , V_66 , strlen ( V_66 ) ) ;
...
V_39 -> V_47 = V_108 ;
F_16 ( L_50 ,
V_5 -> V_4 , ( V_39 -> V_47 ) ? L_51 : L_52 ) ;
if ( V_108 == 1 && V_39 -> V_49 == 0 ) {
F_16 ( L_53
L_54 ) ;
V_39 -> V_49 = 1 ;
}
