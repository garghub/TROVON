...
static void F_29 ( struct V_1 * V_2 , bool V_44 )
{
unsigned char V_45 [] = { V_46 , V_47 , V_44 } ;
F_19 ( V_2 , V_45 , 3 ) ;
}
static void F_30 ( char * V_48 , T_2 V_49 )
{
V_48 [ 3 ] = V_49 >> 16 && 0xff ;
V_48 [ 4 ] = V_49 >> 24 && 0xff ;
V_48 [ 5 ] = V_49 >> 0 && 0xff ;
...
{
struct V_1 * V_2 = F_4 ( V_51 , struct V_1 , V_39 ) ;
unsigned long V_34 ;
long V_52 ;
struct V_16 * V_9 ;
F_20 ( & V_2 -> V_36 , V_34 ) ;
while ( ! F_32 ( & V_2 -> V_38 ) ) {
V_9 = F_33 ( & V_2 -> V_38 , struct V_16 , V_37 ) ;
F_22 ( & V_2 -> V_36 , V_34 ) ;
F_15 ( V_2 , 0 ) ;
V_52 = F_34 (
& V_2 -> V_53 , F_28 ( 5000 ) ) ;
...
static int F_36 ( struct V_1 * V_2 , struct V_16 * V_9 )
{
...
V_14 , 16 , 1 , V_9 -> V_8 ,
V_9 -> V_8 [ 1 ] + 2 , true ) ;
F_37 ( & V_2 -> V_6 , V_9 -> V_8 [ 0 ] & 0x8f ,
V_9 -> V_8 ) ;
return 0 ;
}
static void F_38 ( struct V_50 * V_51 )
{
struct V_1 * V_2 = F_4 ( V_51 , struct V_1 , V_55 ) ;
unsigned long V_34 ;
struct V_16 * V_9 ;
F_20 ( & V_2 -> V_56 , V_34 ) ;
while ( ! F_32 ( & V_2 -> V_57 ) ) {
V_9 = F_33 ( & V_2 -> V_57 , struct V_16 , V_37 ) ;
F_35 ( & V_9 -> V_37 ) ;
F_22 ( & V_2 -> V_56 , V_34 ) ;
if ( V_2 -> V_41 ==
...
{
if ( V_2 -> V_59 -> V_28 != F_14 ( V_2 -> V_59 ) ) {
F_10 ( V_2 -> V_12 , L_17 ,
( V_60 ) F_14 ( V_2 -> V_59 ) ,
( V_60 ) V_2 -> V_59 -> V_28 ) ;
F_11 ( V_2 , V_2 -> V_59 ) ;
...
static void F_44 ( struct V_1 * V_2 , unsigned int V_62 ,
bool V_63 )
{
F_10 ( V_2 -> V_12 , L_18 ,
V_62 , V_2 -> V_44 ) ;
...
V_2 -> V_24 . V_28 = 0 ;
V_2 -> V_58 = & V_2 -> V_24 ;
F_21 ( & V_2 -> V_58 -> V_37 , & V_2 -> V_38 ) ;
} else {
V_2 -> V_58 = F_33 ( & V_2 -> V_38 , struct V_16 ,
V_37 ) ;
V_2 -> V_58 -> V_28 = 0 ;
}
F_43 ( & V_2 -> V_36 ) ;
...
static T_3 F_46 ( int V_64 , void * V_12 )
{
unsigned long V_62 ;
unsigned int V_65 = 0 ;
...
V_62 = F_47 ( V_2 -> V_72 + V_73 ) ;
if ( ( V_62 & V_67 ) == 0 && ( V_62 & ~ V_67 ) != 0 ) {
F_10 ( V_2 -> V_12 , L_22 , V_62 ) ;
return V_74 ;
}
if ( ( V_62 & V_68 ) == 0 ) {
F_10 ( V_2 -> V_12 , L_23 ) ;
...
if ( ( V_62 & V_71 ) == 0 ) {
V_65 = F_47 ( V_2 -> V_72 + V_75 ) ;
if ( V_62 & V_70 )
F_48 ( 0 , V_2 -> V_72 + V_75 ) ;
}
if ( V_62 == ( V_68 | V_70 ) )
V_2 -> V_44 = 0 ;
switch ( V_2 -> V_44 ) {
...
V_79 = V_81 | V_82 |
( 0x2 << V_83 ) ;
F_48 ( V_79 , V_2 -> V_72 + V_84 ) ;
F_56 ( V_2 -> V_80 , 8 * 80000 ) ;
F_48 ( V_85 , V_2 -> V_72 + V_86 ) ;
F_48 ( 0x1E , V_2 -> V_72 + V_87 ) ;
F_48 ( V_2 -> V_78 >> 1 , V_2 -> V_72 + V_88 ) ;
F_48 ( 0 , V_2 -> V_72 + V_89 ) ;
F_57 ( V_2 -> V_64 ) ;
F_58 ( V_2 -> V_80 ) ;
}
...
V_2 = F_63 ( & V_95 -> V_12 , sizeof( struct V_1 ) , V_110 ) ;
if ( V_2 == NULL ) {
F_10 ( & V_95 -> V_12 , L_38 ) ;
return - V_35 ;
}
...
V_2 -> V_33 = F_65 ( V_2 -> V_12 -> V_111 ,
L_39 , 0 ) ;
if ( V_2 -> V_33 < 0 ) {
F_10 ( & V_95 -> V_12 , L_40 ) ;
return - V_112 ;
}
if ( F_66 ( V_2 -> V_12 -> V_111 ,
L_41 , & V_2 -> V_78 ) ) {
F_10 ( & V_95 -> V_12 , L_42 ) ;
return - V_112 ;
}
...
V_102 = F_67 ( V_95 , V_113 , 0 ) ;
if ( ! V_102 ) {
F_10 ( & V_95 -> V_12 , L_44 ) ;
return - V_112 ;
}
V_72 = F_68 ( & V_95 -> V_12 , V_102 ) ;
if ( F_69 ( V_72 ) )
return F_70 ( V_72 ) ;
V_102 = F_67 ( V_95 , V_114 , 0 ) ;
if ( ! V_102 ) {
F_10 ( & V_95 -> V_12 , L_45 ) ;
return - V_112 ;
}
V_80 = F_71 ( & V_95 -> V_12 , L_46 ) ;
if ( F_69 ( V_80 ) ) {
F_10 ( V_2 -> V_12 , L_47 ) ;
return - V_112 ;
}
...
F_77 ( & V_2 -> V_55 , F_38 ) ;
F_77 ( & V_2 -> V_39 , F_31 ) ;
V_52 = F_78 ( & V_95 -> V_12 , V_2 -> V_33 , V_116 ,
L_48 ) ;
if ( V_52 < 0 ) {
F_10 ( V_2 -> V_12 , L_49 ) ;
return - V_112 ;
}
V_52 = F_79 ( & V_95 -> V_12 , V_2 -> V_64 , F_46 , 0 ,
L_50 , V_2 ) ;
if ( V_52 ) {
F_10 ( V_2 -> V_12 , L_51 ) ;
return - V_112 ;
...
V_93 = V_2 ;
V_118 = F_61 ;
V_9 = F_24 ( V_2 , V_103 , 2 ) ;
if ( V_9 ) {
F_5 ( V_2 -> V_12 , L_52 ,
V_9 -> V_8 [ 4 ] , V_9 -> V_8 [ 5 ] , V_9 -> V_8 [ 6 ] , V_9 -> V_8 [ 7 ] ) ;
F_11 ( V_2 , V_9 ) ;
}
V_96 = F_80 ( V_2 -> V_12 , - 1 , V_119 ,
F_81 ( V_119 ) , V_72 , 0 , NULL ) ;
if ( V_96 )
F_10 ( V_2 -> V_12 , L_53 ) ;
F_19 ( V_2 , V_105 , 4 ) ;
F_30 ( V_107 , V_120 ) ;
...
static int F_86 ( struct V_122 * V_12 )
{
struct V_94 * V_95 = F_87 ( V_12 ) ;
struct V_1 * V_2 = F_83 ( V_95 ) ;
struct V_16 * V_9 ;
char V_123 [] = { V_46 , V_124 } ;
F_16 ( V_2 -> V_12 , L_54 ) ;
F_29 ( V_2 , false ) ;
V_9 = F_24 ( V_2 , V_123 , sizeof( V_123 ) ) ;
F_11 ( V_2 , V_9 ) ;
F_59 ( V_2 ) ;
return 0 ;
}
