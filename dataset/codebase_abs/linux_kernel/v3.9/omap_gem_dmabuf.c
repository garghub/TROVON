...
if ( F_34 ( ! V_7 -> V_29 ) )
return - V_30 ;
if ( F_35 ( V_7 ) < V_28 -> V_31 - V_28 -> V_32 ) {
V_12 = - V_30 ;
goto V_33;
}
if ( ! V_7 -> V_34 -> V_35 -> V_36 ) {
V_12 = - V_30 ;
goto V_33;
}
V_28 -> V_37 |= V_38 | V_39 | V_40 | V_41 ;
V_28 -> V_42 = V_7 -> V_34 -> V_35 -> V_36 ;
V_28 -> V_43 = V_7 ;
V_28 -> V_44 = F_36 ( F_37 ( V_28 -> V_37 ) ) ;
V_28 -> V_42 -> V_45 ( V_28 ) ;
V_33:
return F_38 ( V_7 , V_28 ) ;
}
struct V_18 * F_39 ( struct V_46 * V_34 ,
struct V_6 * V_7 , int V_47 )
{
return F_40 ( V_7 , & V_48 , V_7 -> V_17 , V_47 ) ;
}
struct V_6 * F_41 ( struct V_46 * V_34 ,
struct V_18 * V_19 )
{
struct V_6 * V_7 ;
if ( V_19 -> V_49 == & V_48 ) {
