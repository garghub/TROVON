...
static void F_16 ( struct V_9 * V_10 , T_2 * V_67 )
{
F_17 ( V_10 , V_68 , V_10 -> V_69 ,
L_25 ,
F_18 ( V_67 [ 0 ] ) / 1000 ,
F_18 ( V_67 [ 1 ] ) / 1000 ) ;
}
void F_19 ( struct V_9 * V_10 , struct V_70 * V_70 )
{
struct V_64 * V_71 ;
if ( V_70 -> V_72 < sizeof *V_71 )
return;
if ( F_20 ( V_73 , & V_10 -> V_74 ) ) {
F_16 ( V_10 , ( T_2 * ) V_70 -> V_75 ) ;
return;
}
V_71 = V_70 -> V_75 ;
switch ( V_71 -> V_76 ) {
case V_77 :
F_21 ( V_10 , V_68 , V_10 -> V_69 , L_26 ,
V_71 -> V_78 ? L_27 : L_28 ) ;
if ( V_71 -> V_78 )
F_22 ( V_10 -> V_69 ) ;
else
...
break;
case V_79 :
F_21 ( V_10 , V_68 , V_10 -> V_69 , L_29 ,
V_70 -> V_72 ) ;
if ( V_70 -> V_72 != ( sizeof *V_71 + 8 ) )
F_24 ( V_73 , & V_10 -> V_74 ) ;
else
F_16 ( V_10 , ( T_2 * ) & V_71 [ 1 ] ) ;
break;
default:
F_25 ( V_10 -> V_69 , L_30 ,
V_71 -> V_76 ) ;
