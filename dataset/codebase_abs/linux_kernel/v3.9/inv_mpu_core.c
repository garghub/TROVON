...
F_32 ( V_5 , V_21 ) ;
V_21 -> V_89 . V_123 = & V_5 -> V_89 ;
V_21 -> V_124 = V_109 -> V_124 ;
V_21 -> V_125 = V_126 ;
V_21 -> V_127 = F_18 ( V_126 ) ;
V_21 -> V_128 = & V_129 ;
V_21 -> V_130 = V_131 ;
V_9 = F_33 ( V_21 ,
V_132 ,
...
static int F_41 ( struct V_114 * V_5 )
{
struct V_20 * V_21 = F_42 ( V_5 ) ;
struct V_1 * V_2 = F_8 ( V_21 ) ;
F_43 ( V_21 ) ;
F_38 ( V_2 ) ;
F_39 ( V_21 ) ;
...
{
return F_6 (
F_8 ( F_42 ( F_45 ( V_89 ) ) ) , true ) ;
}
static int F_46 ( struct V_88 * V_89 )
{
return F_6 (
F_8 ( F_42 ( F_45 ( V_89 ) ) ) , false ) ;
}
