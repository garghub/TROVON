...
static int F_33 ( struct V_4 * V_30 , T_2 V_24 , T_1 * V_43 )
{
int V_8 ;
struct V_3 * V_5 = F_4 ( V_30 ) ;
struct V_22 * V_23 ;
unsigned long V_37 ;
if ( ! F_31 ( & V_5 -> V_40 , V_37 ) )
return - V_41 ;
V_23 = F_21 ( V_5 , V_24 ) ;
if ( V_23 ) {
* V_43 = V_23 -> V_43 ;
...
static void F_34 ( struct V_4 * V_30 , T_2 V_24 , bool V_45 )
{
struct V_3 * V_5 = F_4 ( V_30 ) ;
struct V_22 * V_23 ;
V_23 = F_21 ( V_5 , V_24 ) ;
...
{
int V_8 ;
struct V_3 * V_5 = F_52 ( sizeof( * V_5 ) , V_68 ) ;
if ( ! V_5 )
return NULL ;
F_50 ( V_5 ) ;
F_53 ( & V_5 -> free ) ;
