...
static T_3 F_26 ( struct V_48 * V_49 , char * V_52 , T_4 V_53 , T_2 * V_54 )
{
int V_55 = 0 ;
int V_20 = 0 ;
F_27 ( V_56 , V_57 ) ;
...
static T_3 F_34 ( struct V_48 * V_49 , const char * V_52 , T_4 V_53 ,
T_2 * V_54 )
{
int V_20 ;
unsigned int V_66 ;
...
static unsigned int F_41 ( struct V_48 * V_48 , T_5 * V_56 )
{
F_42 ( V_48 , & V_47 , V_56 ) ;
if ( V_31 != V_29 )
return V_73 | V_74 ;
...
switch ( V_75 ) {
case V_82 :
V_55 = F_44 ( V_77 , ( T_6 * ) V_76 ) ;
if ( V_55 )
return V_55 ;
break;
case V_83 :
V_55 = F_44 ( V_84 , ( T_6 * ) V_76 ) ;
if ( V_55 )
return V_55 ;
break;
case V_85 :
V_55 = F_44 ( V_86 , ( T_6 * ) V_76 ) ;
if ( V_55 )
return V_55 ;
break;
case V_87 :
V_55 = F_45 ( V_81 , ( T_6 * ) V_76 ) ;
if ( V_55 )
return V_55 ;
if ( V_81 != V_84 )
return - V_58 ;
...
static int F_46 ( struct V_94 * V_95 , struct V_48 * V_49 )
{
if ( V_39 || ! F_16 () )
return - V_71 ;
F_47 ( V_3 ) ;
...
static int F_48 ( struct V_94 * V_95 , struct V_48 * V_49 )
{
if ( V_27 ) {
V_27 = 0 ;
F_49 ( V_24 ) ;
