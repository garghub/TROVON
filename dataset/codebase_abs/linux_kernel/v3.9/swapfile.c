...
F_21 ( & V_60 ) ;
F_21 ( & V_68 -> V_47 ) ;
F_139 ( V_68 , V_66 , V_51 , V_166 ) ;
F_143 ( V_68 -> type ) ;
F_20 ( & V_68 -> V_47 ) ;
F_20 ( & V_60 ) ;
}
static void F_144 ( struct V_3 * V_68 )
{
F_21 ( & V_60 ) ;
F_21 ( & V_68 -> V_47 ) ;
F_139 ( V_68 , V_68 -> V_66 , V_68 -> V_51 , F_145 ( V_68 ) ) ;
F_20 ( & V_68 -> V_47 ) ;
F_20 ( & V_60 ) ;
}
static unsigned F_146 ( struct V_153 * V_153 , T_10 * V_169 )
{
struct V_170 * V_171 = V_153 -> V_172 ;
F_147 ( V_153 , & V_173 , V_169 ) ;
...
static void * F_148 ( struct V_170 * V_180 , T_11 * V_181 )
{
struct V_3 * V_4 ;
int type ;
T_11 V_182 = * V_181 ;
...
static void * F_151 ( struct V_170 * V_180 , void * V_185 , T_11 * V_181 )
{
...
static void F_152 ( struct V_170 * V_180 , void * V_185 )
{
F_153 ( & V_183 ) ;
}
static int F_154 ( struct V_170 * V_180 , void * V_185 )
{
struct V_3 * V_4 = V_185 ;
struct V_153 * V_153 ;
int V_186 ;
...
V_153 = V_4 -> V_154 ;
V_186 = F_156 ( V_180 , & V_153 -> V_187 , L_3 ) ;
F_157 ( V_180 , L_4 ,
V_186 < 40 ? 40 - V_186 : 1 , L_5 ,
F_137 ( F_158 ( V_153 ) -> V_164 ) ?
L_6 : L_7 ,
V_4 -> V_39 << ( V_16 - 10 ) ,
V_4 -> V_40 << ( V_16 - 10 ) ,
V_4 -> V_66 ) ;
...
static int F_159 ( struct V_162 * V_162 , struct V_153 * V_153 )
{
struct V_170 * V_171 ;
int V_8 ;
V_8 = F_160 ( V_153 , & V_188 ) ;
if ( V_8 )
return V_8 ;
V_171 = V_153 -> V_172 ;
V_171 -> V_174 = F_38 ( & V_175 ) ;
...
static struct V_3 * F_165 ( void )
{
struct V_3 * V_68 ;
unsigned int type ;
V_68 = F_166 ( sizeof( * V_68 ) , V_19 ) ;
if ( ! V_68 )
return F_167 ( - V_109 ) ;
F_21 ( & V_60 ) ;
for ( type = 0 ; type < V_70 ; type ++ ) {
...
static int F_171 ( struct V_3 * V_68 , struct V_162 * V_162 )
{
int error ;
if ( F_137 ( V_162 -> V_164 ) ) {
V_68 -> V_18 = F_64 ( F_172 ( V_162 ) ) ;
error = F_173 ( V_68 -> V_18 ,
V_192 | V_193 | V_194 ,
V_195 ) ;
if ( error < 0 ) {
V_68 -> V_18 = NULL ;
...
V_68 -> V_197 = F_174 ( V_68 -> V_18 ) ;
error = F_175 ( V_68 -> V_18 , V_117 ) ;
if ( error < 0 )
return error ;
V_68 -> V_35 |= V_88 ;
} else if ( F_176 ( V_162 -> V_164 ) ) {
...
static unsigned long F_178 ( struct V_3 * V_68 ,
union V_202 * V_202 ,
struct V_162 * V_162 )
{
int V_131 ;
...
if ( F_179 ( V_202 -> V_206 . V_207 ) == 1 ) {
F_180 ( & V_202 -> V_206 . V_207 ) ;
F_180 ( & V_202 -> V_206 . V_208 ) ;
F_180 ( & V_202 -> V_206 . V_209 ) ;
for ( V_131 = 0 ; V_131 < V_202 -> V_206 . V_209 ; V_131 ++ )
F_180 ( & V_202 -> V_206 . V_210 [ V_131 ] ) ;
}
...
if ( ! V_203 )
return 0 ;
V_204 = F_182 ( V_162 ) >> V_16 ;
if ( V_204 && V_203 > V_204 ) {
F_36 ( V_211
L_12 ) ;
return 0 ;
}
if ( V_202 -> V_206 . V_209 && F_176 ( V_162 -> V_164 ) )
return 0 ;
if ( V_202 -> V_206 . V_209 > V_213 )
return 0 ;
return V_203 ;
}
static int F_183 ( struct V_3 * V_68 ,
union V_202 * V_202 ,
unsigned char * V_51 ,
unsigned long V_203 ,
T_2 * V_161 )
...
V_9 -> V_220 = V_168 + V_218 ;
F_20 ( & V_60 ) ;
}
static int F_185 ( T_1 V_6 , unsigned char V_29 )
{
struct V_3 * V_68 ;
unsigned long V_5 , type ;
unsigned char V_83 ;
...
{
int V_14 = 0 ;
while ( ! V_14 && F_185 ( V_6 , 1 ) == - V_109 )
V_14 = F_188 ( V_6 , V_225 ) ;
return V_14 ;
}
int F_189 ( T_1 V_6 )
{
return F_185 ( V_6 , V_2 ) ;
}
struct V_3 * F_190 ( struct V_7 * V_7 )
{
T_1 V_180 = { . V_9 = F_49 (page) } ;
F_127 ( ! F_54 ( V_7 ) ) ;
return V_65 [ F_34 ( V_180 ) ] ;
}
struct V_155 * F_191 ( struct V_7 * V_7 )
{
F_41 ( ! F_54 ( V_7 ) ) ;
return F_190 ( V_7 ) -> V_154 -> V_157 ;
}
T_3 F_192 ( struct V_7 * V_7 )
{
T_1 V_180 = { . V_9 = F_49 (page) } ;
F_41 ( ! F_54 ( V_7 ) ) ;
return F_35 ( V_180 ) ;
}
int F_188 ( T_1 V_6 , T_13 V_226 )
{
struct V_3 * V_4 ;
struct V_7 * V_67 ;
struct V_7 * V_7 ;
