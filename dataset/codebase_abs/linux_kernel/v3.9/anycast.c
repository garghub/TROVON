...
static inline struct V_43 * F_49 ( struct V_63 * V_64 )
{
struct V_43 * V_65 = NULL ;
struct V_66 * V_67 = F_50 ( V_64 ) ;
struct V_14 * V_14 = F_51 ( V_64 ) ;
V_67 -> V_11 = NULL ;
F_48 (net, state->dev) {
struct V_10 * V_11 ;
V_11 = F_13 ( V_67 -> V_9 ) ;
...
static struct V_43 * F_52 ( struct V_63 * V_64 , struct V_43 * V_65 )
{
struct V_66 * V_67 = F_50 ( V_64 ) ;
V_65 = V_65 -> V_53 ;
while ( ! V_65 ) {
if ( F_53 ( V_67 -> V_11 != NULL ) )
F_46 ( & V_67 -> V_11 -> V_49 ) ;
V_67 -> V_9 = F_54 ( V_67 -> V_9 ) ;
if ( ! V_67 -> V_9 ) {
V_67 -> V_11 = NULL ;
break;
}
...
static struct V_43 * F_55 ( struct V_63 * V_64 , T_1 V_68 )
{
struct V_43 * V_65 = F_49 ( V_64 ) ;
if ( V_65 )
while ( V_68 && ( V_65 = F_52 ( V_64 , V_65 ) ) != NULL )
-- V_68 ;
return V_68 ? NULL : V_65 ;
}
static void * F_56 ( struct V_63 * V_64 , T_1 * V_68 )
__acquires( T_2 )
{
F_8 () ;
return F_55 ( V_64 , * V_68 ) ;
}
static void * F_57 ( struct V_63 * V_64 , void * V_69 , T_1 * V_68 )
{
struct V_43 * V_65 = F_52 ( V_64 , V_69 ) ;
++ * V_68 ;
return V_65 ;
}
static void F_58 ( struct V_63 * V_64 , void * V_69 )
__releases( T_2 )
{
struct V_66 * V_67 = F_50 ( V_64 ) ;
if ( F_53 ( V_67 -> V_11 != NULL ) ) {
...
static int F_61 ( struct V_71 * V_71 , struct V_72 * V_72 )
{
return F_62 ( V_71 , V_72 , & V_73 ,
sizeof( struct V_66 ) ) ;
}
int T_3 F_63 ( struct V_14 * V_14 )
{
if ( ! F_64 ( L_2 , V_74 , V_14 -> V_75 , & V_76 ) )
return - V_25 ;
return 0 ;
}
