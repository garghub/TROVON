...
int F_65 ( struct V_43 * V_44 , const T_2 * V_81 )
{
...
F_70 ( & V_100 -> V_54 ) ;
V_101 -> V_2 = V_100 ;
V_100 -> V_112 . V_56 = ( unsigned long ) V_100 ;
V_100 -> V_112 . V_113 = V_114 ;
V_100 -> V_6 = V_5 ;
F_13 ( & V_100 -> V_84 ) ;
F_71 ( & V_100 -> V_112 ) ;
V_24 = F_3 () ;
...
F_72 ( & V_24 -> V_18 [ V_103 ] ) ;
V_88 = - V_89 ;
F_73 (node, bucket, list) {
V_2 = V_83 -> V_2 ;
if ( V_2 -> V_44 == V_44 &&
F_54 ( V_81 , V_2 -> V_81 ) )
goto V_115;
...
V_102 = 1 ;
V_116 ++ ;
F_75 ( & V_24 -> V_18 [ V_103 ] ) ;
F_76 ( & V_10 ) ;
if ( V_102 ) {
F_77 ( V_117 , & V_97 -> V_118 ) ;
F_78 ( & V_99 -> V_119 , & V_44 -> V_120 ) ;
}
return 0 ;
V_115:
F_75 ( & V_24 -> V_18 [ V_103 ] ) ;
...
{
struct V_8 * V_24 ;
static const T_2 V_125 [ V_58 ] = { 0xff , 0xff , 0xff , 0xff , 0xff , 0xff } ;
struct V_1 * V_2 ;
struct V_30 * V_83 ;
struct V_43 * V_44 = V_48 -> V_44 ;
int V_13 ;
T_3 V_126 = F_88 ( V_127 ) ;
F_36 () ;
V_24 = F_37 ( V_9 ) ;
F_58 (tbl, node, i) {
V_2 = V_83 -> V_2 ;
...
F_19 ( & V_2 -> V_84 ) ;
F_89 ( V_44 ,
V_44 -> V_92 . V_93 . V_129 . V_130 ,
V_2 -> V_81 , F_90 ( V_2 -> V_128 ) ,
V_126 , V_125 ) ;
}
}
F_38 () ;
}
static void F_91 ( struct V_121 * V_131 )
{
...
static void F_93 ( struct V_8 * V_24 , struct V_30 * V_83 )
{
struct V_1 * V_2 ;
V_2 = V_83 -> V_2 ;
F_72 ( & V_2 -> V_84 ) ;
...
int F_98 ( struct V_43 * V_44 , const T_2 * V_42 )
{
struct V_8 * V_24 ;
struct V_1 * V_2 ;
struct V_30 * V_83 ;
...
{
struct V_49 * V_50 ;
while ( ( V_50 = F_104 ( & V_2 -> V_54 ) ) != NULL )
F_102 ( V_2 -> V_44 , V_50 ) ;
}
void F_105 ( struct V_1 * V_2 , struct V_47 * V_53 )
{
F_16 ( & V_2 -> V_84 ) ;
F_27 ( V_2 , V_53 ) ;
V_2 -> V_128 = 0xffff ;
...
static void F_107 ( struct V_27 * V_28 , bool V_25 )
{
struct V_1 * V_2 ;
struct V_30 * V_83 = F_108 ( V_28 , struct V_30 , V_33 ) ;
V_2 = V_83 -> V_2 ;
F_62 ( V_28 ) ;
if ( V_25 ) {
F_92 ( & V_2 -> V_112 ) ;
...
static int F_109 ( struct V_27 * V_28 , struct V_8 * V_14 )
{
struct V_1 * V_2 ;
struct V_30 * V_83 , * V_101 ;
T_1 V_103 ;
...
if ( V_101 == NULL )
return - V_41 ;
V_83 = F_108 ( V_28 , struct V_30 , V_33 ) ;
V_2 = V_83 -> V_2 ;
V_101 -> V_2 = V_2 ;
