...
static int F_26 ( struct V_34 * V_23 , const struct V_35 * V_36 )
{
short V_3 ;
int V_17 , V_18 , V_19 ;
T_1 V_1 [ 3 ] ;
...
static int F_20 ( struct V_22 * V_22 )
{
struct V_15 * V_16 ;
V_16 = F_24 ( V_22 ) ;
F_34 ( V_16 ) ;
...
static T_4 F_29 ( int V_17 , int V_52 )
{
...
{
F_88 ( V_155 -> V_156 , V_157 , sizeof( V_155 -> V_156 ) ) ;
F_88 ( V_155 -> V_46 , V_158 , sizeof( V_155 -> V_46 ) ) ;
}
static int F_89 ( struct V_15 * V_16 , struct V_127 * V_128 )
{
struct V_8 * V_9 = F_6 ( V_16 ) ;
int V_159 ;
F_90 ( & V_9 -> V_39 ) ;
...
static int F_92 ( struct V_15 * V_16 , struct V_127 * V_128 )
{
struct V_8 * V_9 = F_6 ( V_16 ) ;
int V_159 ;
F_90 ( & V_9 -> V_39 ) ;
...
static T_8 F_94 ( struct V_15 * V_16 )
{
return V_14 ;
}
static void F_95 ( struct V_15 * V_16 , T_8 V_160 )
{
V_14 = V_160 ;
}
static void
...
static int
F_22 ( struct V_22 * V_23 , T_2 V_33 )
{
unsigned long V_70 ;
struct V_15 * V_16 ;
struct V_8 * V_9 ;
