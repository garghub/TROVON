...
F_44 ( V_10 -> V_49 , V_10 -> V_13 ,
F_45 ( V_10 -> V_13 , 4 ) ,
V_10 -> V_49 -> V_6 , 2 * sizeof( T_1 ) ,
F_16 , V_2 , 8 ) ;
F_46 ( V_76 , & V_2 -> V_112 ) ;
if ( F_47 ( V_2 , V_2 -> V_113 -> V_20 &
V_114 ) < 0 )
goto V_115;
if ( V_19 -> V_20 & V_116 ) {
...
if ( V_19 -> V_20 & V_21 ) {
V_83 = 1024 ;
V_82 = F_43 ( V_10 -> V_13 , 6 ) ;
} else {
V_83 = 512 ;
V_82 = F_43 ( V_10 -> V_13 , 1 ) ;
}
for ( V_26 = 0 ; V_26 < 8 ; ++ V_26 ) {
...
goto V_115;
F_42 ( V_10 -> V_54 [ V_26 ] , V_10 -> V_13 , V_82 ,
