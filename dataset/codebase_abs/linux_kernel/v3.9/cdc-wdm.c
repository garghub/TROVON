...
{
struct V_1 * V_4 = F_54 ( V_111 , struct V_1 , V_53 ) ;
unsigned long V_15 ;
int V_33 ;
F_45 ( & V_4 -> V_10 , V_15 ) ;
if ( F_14 ( V_46 , & V_4 -> V_15 ) ) {
...
static int F_55 ( struct V_2 * V_3 , struct V_112 * V_113 ,
T_7 V_114 , int (* V_108)( struct V_2 * , int ) )
{
int V_33 = - V_52 ;
struct V_1 * V_4 ;
V_4 = F_56 ( sizeof( struct V_1 ) , V_70 ) ;
if ( ! V_4 )
goto V_81;
F_57 ( & V_4 -> V_115 ) ;
F_58 ( & V_4 -> V_91 ) ;
...
F_60 ( & V_4 -> V_16 ) ;
V_4 -> V_27 = V_114 ;
V_4 -> V_88 = F_35 ( ( T_7 ) V_3 -> V_116 -> V_4 . V_117 ) ;
V_4 -> V_3 = V_3 ;
F_61 ( & V_4 -> V_53 , F_53 ) ;
V_33 = - V_118 ;
if ( ! F_62 ( V_113 ) )
goto V_94;
V_4 -> V_119 = F_63 ( V_113 ) ;
...
if ( ! V_4 -> V_57 )
goto V_94;
V_4 -> V_55 = F_64 ( 0 , V_70 ) ;
if ( ! V_4 -> V_55 )
goto V_94;
V_4 -> V_48 = F_64 ( 0 , V_70 ) ;
if ( ! V_4 -> V_48 )
goto V_94;
V_4 -> V_54 = F_64 ( 0 , V_70 ) ;
if ( ! V_4 -> V_54 )
goto V_94;
V_4 -> V_29 = F_26 ( V_4 -> V_27 , V_70 ) ;
if ( ! V_4 -> V_29 )
goto V_94;
V_4 -> V_36 = F_26 ( V_4 -> V_119 , V_70 ) ;
if ( ! V_4 -> V_36 )
goto V_94;
...
V_4 -> V_108 = V_108 ;
F_2 ( & V_5 ) ;
F_68 ( & V_4 -> V_115 , & V_124 ) ;
F_4 ( & V_5 ) ;
V_33 = F_69 ( V_3 , & V_125 ) ;
if ( V_33 < 0 )
goto V_94;
else
F_70 ( & V_3 -> V_21 , L_25 , F_71 ( V_3 -> V_126 ) ) ;
V_81:
return V_33 ;
V_94:
F_2 ( & V_5 ) ;
...
static int F_73 ( struct V_2 * V_3 , int V_127 )
{
int V_33 = F_29 ( V_3 ) ;
if ( V_33 < 0 )
goto V_94;
...
static int F_74 ( struct V_2 * V_3 , const struct V_129 * V_96 )
{
int V_33 = - V_118 ;
struct V_130 * V_131 ;
struct V_112 * V_113 ;
struct V_132 * V_133 ;
T_5 * V_59 = V_3 -> V_134 -> V_135 ;
int V_136 = V_3 -> V_134 -> V_137 ;
T_7 V_138 = V_139 ;
if ( ! V_59 )
goto V_94;
while ( V_136 > 2 ) {
...
break;
case V_143 :
V_133 = (struct V_132 * ) V_59 ;
V_138 = F_75 ( V_133 -> V_27 ) ;
F_11 ( & V_3 -> V_21 ,
L_27 , V_138 ) ;
break;
default:
...
V_131 = V_3 -> V_116 ;
if ( V_131 -> V_4 . V_144 != 1 )
goto V_94;
V_113 = & V_131 -> V_145 [ 0 ] . V_4 ;
V_33 = F_55 ( V_3 , V_113 , V_138 , & F_73 ) ;
V_94:
return V_33 ;
}
struct V_146 * F_76 ( struct V_2 * V_3 ,
struct V_112 * V_113 ,
int V_114 ,
int (* V_108)( struct V_2 * , int ) )
{
int V_33 = - V_118 ;
V_33 = F_55 ( V_3 , V_113 , V_114 , V_108 ) ;
if ( V_33 < 0 )
goto V_94;
return & V_147 ;
V_94:
...
static int F_82 ( struct V_2 * V_3 , T_8 V_148 )
{
