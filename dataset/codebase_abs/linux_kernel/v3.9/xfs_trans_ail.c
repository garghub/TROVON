...
F_53 ( V_57 ) ;
F_10 ( & V_2 -> V_13 ) ;
while ( ( V_3 = F_7 ( V_2 ) ) != NULL ) {
F_54 ( & V_2 -> V_58 , & V_57 , V_59 ) ;
V_2 -> V_35 = V_3 -> V_10 ;
F_50 ( V_2 -> V_56 ) ;
F_11 ( & V_2 -> V_13 ) ;
F_42 () ;
...
{
struct V_1 * V_2 ;
V_2 = F_66 ( sizeof( struct V_1 ) , V_70 ) ;
if ( ! V_2 )
return V_71 ;
V_2 -> V_24 = V_23 ;
F_67 ( & V_2 -> V_5 ) ;
