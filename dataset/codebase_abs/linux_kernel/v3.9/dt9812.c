...
struct V_117 * V_118 , struct V_127 * V_128 ,
unsigned int * V_129 )
{
struct V_114 * V_115 = V_4 -> V_116 ;
unsigned int V_47 = F_41 ( V_128 -> V_130 ) ;
int V_131 ;
T_2 V_37 = 0 ;
F_15 ( V_115 -> V_36 , & V_37 ) ;
for ( V_131 = 0 ; V_131 < V_128 -> V_131 ; V_131 ++ )
V_129 [ V_131 ] = ( ( 1 << V_47 ) & V_37 ) != 0 ;
return V_131 ;
}
...
int V_131 ;
for ( V_131 = 0 ; V_131 < V_128 -> V_131 ; V_131 ++ )
F_25 ( V_115 -> V_36 , V_47 , V_129 [ V_131 ] ) ;
return V_131 ;
}
static int F_46 ( struct V_113 * V_4 , struct V_133 * V_134 )
{
struct V_114 * V_115 ;
int V_25 ;
struct V_117 * V_118 ;
