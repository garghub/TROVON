...
T_5 V_118 , T_6 * V_119 )
{
const struct V_73 * V_74 = F_61 ( F_64 ( V_114 ) ) ;
...
++ V_121 ;
-- V_118 ;
if ( F_66 ( V_121 , V_118 , ':' ) != NULL ) {
V_16 = V_126 ;
V_123 = F_67 ( V_121 , V_118 , ( void * ) & V_5 , '\n' , NULL ) ;
} else {
V_16 = V_20 ;
V_123 = F_68 ( V_121 , V_118 , ( void * ) & V_5 , '\n' , NULL ) ;
}
if ( ! V_123 ) {
F_38 ( L_12 ) ;
return - V_77 ;
