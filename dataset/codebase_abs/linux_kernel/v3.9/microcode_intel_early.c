...
static T_2 F_9 ( unsigned long V_18 )
{
T_2 V_33 ;
V_33 = ( V_18 >> 8 ) & 0xf ;
if ( V_33 == 0xf )
...
static T_2 F_10 ( unsigned long V_18 )
{
T_2 V_33 , V_34 ;
V_33 = F_9 ( V_18 ) ;
V_34 = ( V_18 >> 4 ) & 0xf ;
...
static void F_16 ( struct V_2 * * V_25 , T_2 * V_7 ,
unsigned int * V_54 )
{
int V_21 ;
int V_55 = 0 ;
...
static void T_1 F_38 ( struct V_5 * V_6 )
{
struct V_2 * V_82 ;
int * V_83 ;
int * V_84 ;
...
static inline void T_1 F_38 ( struct V_5 * V_6 )
{
struct V_2 * V_82 ;
V_82 = V_6 -> V_24 ;
if ( V_82 == NULL )
...
static int T_1 F_41 ( struct V_29 * V_29 ,
struct V_5 * V_6 )
{
struct V_2 * V_82 ;
unsigned int V_63 [ 2 ] ;
