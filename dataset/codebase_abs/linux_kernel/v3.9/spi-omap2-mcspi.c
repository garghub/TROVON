...
V_141 |= V_146 ;
if ( V_138 && V_138 -> V_147 && V_105 -> V_95 == NULL ) {
...
F_3 ( 0 , V_11 -> V_7
+ V_90 ) ;
if ( V_136 -> V_148 || V_105 -> V_52 >= V_149 )
V_51 = F_41 ( V_9 , V_105 ) ;
else
V_51 = F_42 ( V_9 , V_105 ) ;
V_136 -> V_150 += V_51 ;
...
static int F_68 ( struct V_156 * V_35 )
{
struct V_5 * V_6 ;
struct V_1 * V_2 ;
V_2 = F_69 ( V_35 ) ;
...
T_1 V_164 = 0 ;
static int V_165 = 1 ;
struct V_166 * V_133 = V_158 -> V_35 . V_167 ;
const struct V_168 * V_169 ;
struct V_170 * V_170 ;
V_2 = F_71 ( & V_158 -> V_35 , sizeof *V_6 ) ;
if ( V_2 == NULL ) {
F_47 ( & V_158 -> V_35 , L_26 ) ;
return - V_132 ;
}
V_2 -> V_171 = V_118 | V_120 | V_115 ;
V_2 -> V_172 = F_54 ;
V_2 -> V_173 = F_16 ;
V_2 -> V_174 = F_18 ;
V_2 -> V_175 = F_62 ;
V_2 -> V_176 = F_57 ;
V_2 -> V_35 . V_167 = V_133 ;
F_72 ( & V_158 -> V_35 , V_2 ) ;
V_6 = F_2 ( V_2 ) ;
V_6 -> V_2 = V_2 ;
V_169 = F_73 ( V_177 , & V_158 -> V_35 ) ;
if ( V_169 ) {
T_1 V_178 = 1 ;
V_160 = V_169 -> V_40 ;
F_74 ( V_133 , L_27 , & V_178 ) ;
V_2 -> V_134 = V_178 ;
V_2 -> V_165 = V_165 ++ ;
if ( F_75 ( V_133 , L_28 , NULL ) )
V_6 -> V_108 = V_179 ;
} else {
V_160 = V_158 -> V_35 . V_180 ;
V_2 -> V_134 = V_160 -> V_178 ;
if ( V_158 -> V_181 != - 1 )
V_2 -> V_165 = V_158 -> V_181 ;
V_6 -> V_108 = V_160 -> V_108 ;
}
V_164 = V_160 -> V_164 ;
V_162 = F_76 ( V_158 , V_182 , 0 ) ;
if ( V_162 == NULL ) {
V_140 = - V_183 ;
goto V_184;
}
V_162 -> V_185 += V_164 ;
V_162 -> V_186 += V_164 ;
V_6 -> V_88 = V_162 -> V_185 ;
V_6 -> V_7 = F_77 ( & V_158 -> V_35 , V_162 ) ;
if ( F_78 ( V_6 -> V_7 ) ) {
V_140 = F_79 ( V_6 -> V_7 ) ;
goto V_184;
}
V_6 -> V_35 = & V_158 -> V_35 ;
F_80 ( & V_6 -> V_26 . V_11 ) ;
V_6 -> V_43 = F_81 ( V_2 -> V_134 ,
sizeof( struct V_41 ) ,
V_131 ) ;
if ( V_6 -> V_43 == NULL )
goto V_184;
for ( V_163 = 0 ; V_163 < V_2 -> V_134 ; V_163 ++ ) {
char V_187 [ 14 ] ;
struct V_161 * V_188 ;
sprintf ( V_187 , L_29 , V_163 ) ;
V_188 = F_82 ( V_158 , V_189 ,
V_187 ) ;
if ( ! V_188 ) {
F_47 ( & V_158 -> V_35 , L_30 ) ;
V_140 = - V_183 ;
break;
}
V_6 -> V_43 [ V_163 ] . V_125 = V_188 -> V_185 ;
sprintf ( V_187 , L_31 , V_163 ) ;
V_188 = F_82 ( V_158 , V_189 ,
V_187 ) ;
if ( ! V_188 ) {
F_47 ( & V_158 -> V_35 , L_32 ) ;
V_140 = - V_183 ;
break;
}
V_6 -> V_43 [ V_163 ] . V_128 = V_188 -> V_185 ;
}
if ( V_140 < 0 )
goto V_190;
V_170 = F_83 ( & V_158 -> V_35 ) ;
if ( F_78 ( V_170 ) )
F_84 ( & V_158 -> V_35 ,
L_33 ) ;
F_85 ( & V_158 -> V_35 ) ;
F_86 ( & V_158 -> V_35 , V_191 ) ;
F_87 ( & V_158 -> V_35 ) ;
if ( V_140 || F_67 ( V_6 ) < 0 )
goto V_192;
V_140 = F_88 ( V_2 ) ;
...
static int F_94 ( struct V_156 * V_35 )
{
