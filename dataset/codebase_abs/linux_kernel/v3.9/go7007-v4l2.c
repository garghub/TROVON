...
{
struct V_9 * V_10 = ( (struct V_17 * ) V_124 ) -> V_10 ;
int V_109 = V_185 -> V_109 ;
if ( 0 == F_23 ( & V_10 -> V_82 , V_186 , V_187 , V_185 ) )
return 0 ;
V_185 -> V_109 = V_109 ;
return F_24 ( V_185 ) ;
}
...
{
struct V_9 * V_10 = ( (struct V_17 * ) V_124 ) -> V_10 ;
if ( 0 == F_23 ( & V_10 -> V_82 , V_186 , V_188 , V_99 ) )
return 0 ;
...
{
struct V_9 * V_10 = ( (struct V_17 * ) V_124 ) -> V_10 ;
if ( 0 == F_23 ( & V_10 -> V_82 , V_186 , V_189 , V_99 ) )
return 0 ;
return F_27 ( V_99 , V_10 ) ;
}
static int F_58 ( struct V_16 * V_190 , void * V_124 ,
struct V_191 * V_192 )
{
struct V_9 * V_10 = ( (struct V_17 * ) V_124 ) -> V_10 ;
struct V_193 V_194 = {
. V_195 = 1001 * V_10 -> V_196 ,
. V_197 = V_10 -> V_91 ,
} ;
if ( V_192 -> type != V_62 )
return - V_52 ;
V_192 -> V_192 . V_198 . V_199 |= V_200 ;
V_192 -> V_192 . V_198 . V_194 = V_194 ;
return 0 ;
}
static int F_59 ( struct V_16 * V_190 , void * V_124 ,
struct V_191 * V_192 )
{
struct V_9 * V_10 = ( (struct V_17 * ) V_124 ) -> V_10 ;
...
if ( V_192 -> type != V_62 )
return - V_52 ;
if ( V_192 -> V_192 . V_198 . V_203 != 0 )
return - V_52 ;
V_201 = V_10 -> V_91 *
V_192 -> V_192 . V_198 . V_194 . V_195 ;
V_202 = 1001 * V_192 -> V_192 . V_198 . V_194 . V_197 ;
if ( V_201 != 0 && V_202 != 0 && V_201 > V_202 )
V_10 -> V_196 = ( V_201 + V_202 / 2 ) / V_202 ;
else
V_10 -> V_196 = 1 ;
return 0 ;
}
static int F_60 ( struct V_16 * V_190 , void * V_124 ,
struct V_204 * V_205 )
{
struct V_9 * V_10 = ( (struct V_17 * ) V_124 ) -> V_10 ;
if ( ( V_10 -> V_57 -> V_12 & V_134 ) ||
( V_10 -> V_57 -> V_58 & V_206 ) )
return - V_52 ;
if ( V_205 -> V_138 > 0 )
return - V_52 ;
V_205 -> type = V_207 ;
V_205 -> V_208 . V_45 = V_10 -> V_57 -> V_44 ;
V_205 -> V_208 . V_46 = V_10 -> V_57 -> V_43 ;
return 0 ;
}
static int F_61 ( struct V_16 * V_190 , void * V_124 ,
struct V_209 * V_210 )
{
struct V_9 * V_10 = ( (struct V_17 * ) V_124 ) -> V_10 ;
if ( ( V_10 -> V_57 -> V_12 & V_134 ) ||
...
return - V_52 ;
V_210 -> type = V_211 ;
V_210 -> V_208 . V_195 = 1001 ;
V_210 -> V_208 . V_197 = V_10 -> V_57 -> V_91 ;
return 0 ;
}
static int F_62 ( struct V_16 * V_16 , void * V_124 , T_3 * V_212 )
{
struct V_9 * V_10 = ( (struct V_17 * ) V_124 ) -> V_10 ;
switch ( V_10 -> V_53 ) {
case V_54 :
...
static int F_63 ( struct V_16 * V_16 , void * V_124 , T_3 * V_212 )
{
struct V_9 * V_10 = ( (struct V_17 * ) V_124 ) -> V_10 ;
if ( V_10 -> V_14 )
return - V_21 ;
if ( ! ( V_10 -> V_57 -> V_58 & V_206 ) && * V_212 != 0 )
return - V_52 ;
if ( * V_212 == 0 )
return - V_52 ;
if ( ( V_10 -> V_57 -> V_12 & V_134 ) &&
V_10 -> V_215 == V_10 -> V_57 -> V_216 - 1 ) {
if ( ! V_10 -> V_217 )
return - V_183 ;
if ( F_23 ( & V_10 -> V_82 , V_186 , V_218 , * V_212 ) < 0 )
return - V_52 ;
}
if ( * V_212 & V_213 ) {
V_10 -> V_53 = V_54 ;
...
return - V_52 ;
F_23 ( & V_10 -> V_82 , V_186 , V_218 , * V_212 ) ;
F_22 ( V_10 , NULL , 0 ) ;
return 0 ;
}
static int F_64 ( struct V_16 * V_16 , void * V_124 , T_3 * V_212 )
{
struct V_9 * V_10 = ( (struct V_17 * ) V_124 ) -> V_10 ;
if ( ( V_10 -> V_57 -> V_12 & V_134 ) &&
V_10 -> V_215 == V_10 -> V_57 -> V_216 - 1 ) {
if ( ! V_10 -> V_217 )
return - V_183 ;
return F_23 ( & V_10 -> V_82 , V_83 , V_220 , V_212 ) ;
} else if ( V_10 -> V_57 -> V_58 & V_206 )
...
{
struct V_9 * V_10 = ( (struct V_17 * ) V_124 ) -> V_10 ;
if ( V_222 -> V_138 >= V_10 -> V_57 -> V_216 )
return - V_52 ;
strncpy ( V_222 -> V_129 , V_10 -> V_57 -> V_223 [ V_222 -> V_138 ] . V_129 ,
sizeof( V_222 -> V_129 ) ) ;
if ( ( V_10 -> V_57 -> V_12 & V_134 ) &&
V_222 -> V_138 == V_10 -> V_57 -> V_216 - 1 )
V_222 -> type = V_224 ;
else
V_222 -> type = V_225 ;
V_222 -> V_226 = 0 ;
V_222 -> V_227 = 0 ;
if ( V_10 -> V_57 -> V_58 & V_206 )
V_222 -> V_212 = V_213 | V_214 |
V_219 ;
else
V_222 -> V_212 = 0 ;
return 0 ;
}
static int F_66 ( struct V_16 * V_16 , void * V_124 , unsigned int * V_215 )
{
struct V_9 * V_10 = ( (struct V_17 * ) V_124 ) -> V_10 ;
* V_215 = V_10 -> V_215 ;
return 0 ;
}
static int F_67 ( struct V_16 * V_16 , void * V_124 , unsigned int V_215 )
{
struct V_9 * V_10 = ( (struct V_17 * ) V_124 ) -> V_10 ;
if ( V_215 >= V_10 -> V_57 -> V_216 )
return - V_52 ;
if ( V_10 -> V_14 )
return - V_21 ;
V_10 -> V_215 = V_215 ;
return F_23 ( & V_10 -> V_82 , V_83 , V_228 , V_215 , 0 , 0 ) ;
}
...
if ( ! V_10 -> V_217 )
return - V_183 ;
return F_23 ( & V_10 -> V_82 , V_227 , V_231 , V_230 ) ;
}
...
return F_23 ( & V_10 -> V_82 , V_227 , V_237 , V_230 ) ;
}
...
return - V_183 ;
V_31 -> type = V_239 ;
return F_23 ( & V_10 -> V_82 , V_227 , V_240 , V_31 ) ;
}
...
if ( ! V_10 -> V_217 )
return - V_183 ;
return F_23 ( & V_10 -> V_82 , V_227 , V_241 , V_31 ) ;
}
...
V_243 -> V_244 . V_245 = 0 ;
V_243 -> V_244 . V_246 = 0 ;
V_243 -> V_244 . V_45 = 720 ;
V_243 -> V_244 . V_46 = 480 ;
V_243 -> V_247 . V_245 = 0 ;
V_243 -> V_247 . V_246 = 0 ;
V_243 -> V_247 . V_45 = 720 ;
V_243 -> V_247 . V_46 = 480 ;
break;
case V_55 :
V_243 -> V_244 . V_245 = 0 ;
V_243 -> V_244 . V_246 = 0 ;
V_243 -> V_244 . V_45 = 720 ;
V_243 -> V_244 . V_46 = 576 ;
V_243 -> V_247 . V_245 = 0 ;
V_243 -> V_247 . V_246 = 0 ;
V_243 -> V_247 . V_45 = 720 ;
V_243 -> V_247 . V_46 = 576 ;
break;
case V_56 :
V_243 -> V_244 . V_245 = 0 ;
V_243 -> V_244 . V_246 = 0 ;
V_243 -> V_244 . V_45 = V_10 -> V_57 -> V_44 ;
V_243 -> V_244 . V_46 = V_10 -> V_57 -> V_43 ;
V_243 -> V_247 . V_245 = 0 ;
V_243 -> V_247 . V_246 = 0 ;
V_243 -> V_247 . V_45 = V_10 -> V_57 -> V_44 ;
V_243 -> V_247 . V_46 = V_10 -> V_57 -> V_43 ;
break;
}
return 0 ;
}
static int F_73 ( struct V_16 * V_16 , void * V_124 , struct V_248 * V_249 )
{
struct V_9 * V_10 = ( (struct V_17 * ) V_124 ) -> V_10 ;
if ( V_249 -> type != V_62 )
return - V_52 ;
...
V_249 -> V_250 . V_245 = 0 ;
V_249 -> V_250 . V_246 = 0 ;
V_249 -> V_250 . V_45 = 720 ;
V_249 -> V_250 . V_46 = 480 ;
break;
case V_55 :
V_249 -> V_250 . V_245 = 0 ;
V_249 -> V_250 . V_246 = 0 ;
V_249 -> V_250 . V_45 = 720 ;
V_249 -> V_250 . V_46 = 576 ;
break;
case V_56 :
V_249 -> V_250 . V_245 = 0 ;
V_249 -> V_250 . V_246 = 0 ;
V_249 -> V_250 . V_45 = V_10 -> V_57 -> V_44 ;
V_249 -> V_250 . V_46 = V_10 -> V_57 -> V_43 ;
break;
}
return 0 ;
}
static int F_74 ( struct V_16 * V_16 , void * V_124 , const struct V_248 * V_249 )
{
if ( V_249 -> type != V_62 )
return - V_52 ;
return 0 ;
...
static T_4 F_77 ( struct V_16 * V_16 , char T_5 * V_257 ,
T_6 V_144 , T_7 * V_258 )
{
return - V_52 ;
}
static void F_78 ( struct V_259 * V_260 )
{
struct V_1 * V_2 = V_260 -> V_261 ;
++ V_2 -> V_147 ;
}
static void F_79 ( struct V_259 * V_260 )
{
struct V_1 * V_2 = V_260 -> V_261 ;
unsigned long V_12 ;
if ( -- V_2 -> V_147 == 0 ) {
...
static int F_80 ( struct V_259 * V_260 , struct V_262 * V_263 )
{
struct V_264 * V_264 ;
V_264 = F_81 ( V_265 | V_266 ) ;
if ( ! V_264 )
return V_267 ;
F_82 ( V_264 , ( unsigned long ) V_263 -> V_268 ) ;
V_263 -> V_264 = V_264 ;
return 0 ;
}
static int F_83 ( struct V_16 * V_16 , struct V_259 * V_260 )
{
struct V_17 * V_18 = V_16 -> V_27 ;
unsigned int V_138 ;
...
return - V_52 ;
if ( V_260 -> V_271 - V_260 -> V_272 != V_67 )
return - V_52 ;
F_7 ( & V_18 -> V_25 ) ;
V_138 = V_260 -> V_273 / V_164 ;
if ( V_138 >= V_18 -> V_26 ) {
F_12 ( & V_18 -> V_25 ) ;
return - V_52 ;
}
if ( V_138 * V_164 != V_260 -> V_273 ) {
F_12 ( & V_18 -> V_25 ) ;
return - V_52 ;
}
...
V_18 -> V_29 [ V_138 ] . V_160 = V_260 -> V_272 ;
V_260 -> V_274 = & V_275 ;
V_260 -> V_269 |= V_276 ;
V_260 -> V_269 &= ~ V_277 ;
V_260 -> V_261 = & V_18 -> V_29 [ V_138 ] ;
F_12 ( & V_18 -> V_25 ) ;
return 0 ;
}
...
static void F_86 ( struct V_281 * V_282 )
{
struct V_9 * V_10 = F_14 ( V_282 ) ;
F_87 ( V_282 ) ;
if ( -- V_10 -> V_24 == 0 )
F_19 ( V_10 ) ;
}
...
return - V_23 ;
* V_10 -> V_284 = V_285 ;
V_10 -> V_284 -> V_286 = V_10 -> V_287 ;
V_283 = F_90 ( V_10 -> V_284 , V_288 , - 1 ) ;
if ( V_283 < 0 ) {
F_87 ( V_10 -> V_284 ) ;
V_10 -> V_284 = NULL ;
return V_283 ;
}
V_283 = F_91 ( V_10 -> V_287 , & V_10 -> V_82 ) ;
if ( V_283 < 0 ) {
F_87 ( V_10 -> V_284 ) ;
V_10 -> V_284 = NULL ;
return V_283 ;
}
F_92 ( V_10 -> V_284 , V_10 ) ;
++ V_10 -> V_24 ;
F_93 ( V_10 -> V_287 , L_4 ,
F_94 ( V_10 -> V_284 ) ) ;
return 0 ;
