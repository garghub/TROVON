...
struct V_10 * V_39 ;
struct V_7 * V_86 ;
if ( F_46 ( V_85 -> V_87 & V_88 ) ) {
F_47 ( V_3 , V_85 ) ;
return;
}
V_66 = V_3 -> V_45 ;
if ( F_46 ( ! F_43 ( V_3 , V_66 , V_85 ) ) ) {
T_1 V_62 = V_85 -> V_73 ;
struct V_89 * V_90 ;
...
V_63 = V_85 -> V_73 ;
V_39 = F_23 ( V_3 -> V_6 , & V_63 ) ;
V_86 = F_25 ( V_3 , V_39 , V_85 -> V_73 ,
& V_63 ) ;
V_85 -> V_74 = V_86 -> V_16 ;
V_85 -> V_73 = V_63 + V_39 -> V_28 +
V_86 -> V_52 ;
if ( F_46 ( ( V_85 -> V_87 & V_96 ) &&
! F_15 ( F_3 ( V_85 -> V_74 ) ) ) ) {
F_50 ( V_85 , 0 ) ;
return;
}
...
static void F_53 ( struct V_97 * V_98 , struct V_3 * V_3 )
{
F_54 ( V_98 , L_39 , V_3 -> V_45 / 2 ) ;
return;
}
