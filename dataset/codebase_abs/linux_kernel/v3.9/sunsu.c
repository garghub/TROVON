...
static void
F_23 ( struct V_1 * V_2 , unsigned char * V_41 )
{
...
V_2 -> V_4 . V_50 . V_86 ++ ;
if ( V_41 & V_87 )
F_35 ( & V_2 -> V_4 , V_41 & V_88 ) ;
if ( V_41 & V_89 )
F_36 ( & V_2 -> V_4 , V_41 & V_90 ) ;
F_37 ( & V_2 -> V_4 . V_43 -> V_4 . V_91 ) ;
}
static T_1 F_38 ( int V_92 , void * V_93 )
{
struct V_1 * V_2 = V_93 ;
unsigned long V_39 ;
unsigned char V_41 ;
...
int V_100 , V_101 ;
V_2 -> V_99 &= ~ V_102 ;
V_2 -> V_99 |= F_41 ( V_98 , & V_101 ) ;
V_100 = V_2 -> V_4 . V_21 / ( 16 * V_101 ) ;
F_42 ( & V_2 -> V_4 , V_2 -> V_99 , 0 , V_100 ) ;
}
static void F_43 ( struct V_1 * V_2 , int V_103 )
{
do {
unsigned char V_44 = F_10 ( V_2 , V_48 ) ;
if ( V_2 -> V_104 == V_105 ) {
#ifdef F_44
F_45 ( & V_2 -> V_106 , V_44 , 0 ) ;
#endif
} else if ( V_2 -> V_104 == V_107 ) {
int V_108 = F_46 ( V_44 , V_103 ) ;
switch ( V_108 ) {
case 2 :
F_40 ( V_2 ) ;
case 1 :
...
static void F_50 ( struct V_31 * V_4 , unsigned int V_117 )
{
struct V_1 * V_2 = (struct V_1 * ) V_4 ;
...
static void F_51 ( struct V_31 * V_4 , int V_128 )
{
struct V_1 * V_2 = (struct V_1 * ) V_4 ;
unsigned long V_39 ;
F_21 ( & V_2 -> V_4 . V_24 , V_39 ) ;
...
if ( V_2 -> V_104 != V_144 ) {
V_132 = F_55 ( V_2 -> V_4 . V_92 , F_47 ,
V_145 , V_146 [ V_2 -> V_104 ] , V_2 ) ;
} else {
V_132 = F_55 ( V_2 -> V_4 . V_92 , F_38 ,
V_145 , V_146 [ V_2 -> V_104 ] , V_2 ) ;
}
if ( V_132 ) {
F_54 ( L_2 , V_2 -> V_4 . V_92 ) ;
return V_132 ;
}
F_11 ( V_2 , V_131 , V_147 ) ;
F_21 ( & V_2 -> V_4 . V_24 , V_39 ) ;
V_2 -> V_4 . V_117 |= V_125 ;
F_50 ( & V_2 -> V_4 , V_2 -> V_4 . V_117 ) ;
F_22 ( & V_2 -> V_4 . V_24 , V_39 ) ;
V_2 -> V_28 = V_36 | V_148 ;
...
#endif
( void ) F_1 ( V_2 , V_48 ) ;
F_59 ( V_2 -> V_4 . V_92 , V_2 ) ;
}
static void
F_42 ( struct V_31 * V_4 , unsigned int V_99 ,
...
V_153 |= V_171 ;
F_21 ( & V_2 -> V_4 . V_24 , V_39 ) ;
F_61 ( V_4 , V_99 , ( V_4 -> V_21 / ( 16 * V_100 ) ) ) ;
V_2 -> V_4 . V_37 = V_55 | V_94 | V_38 ;
if ( V_151 & V_172 )
V_2 -> V_4 . V_37 |= V_54 | V_53 ;
if ( V_151 & ( V_173 | V_174 ) )
V_2 -> V_4 . V_37 |= V_52 ;
V_2 -> V_4 . V_67 = 0 ;
if ( V_151 & V_175 )
...
static void
F_63 ( struct V_31 * V_4 , struct V_184 * V_185 ,
struct V_184 * V_186 )
{
unsigned int V_187 , V_100 ;
V_187 = F_64 ( V_4 , V_185 , V_186 , 0 , V_4 -> V_21 / 16 ) ;
V_100 = F_65 ( V_4 , V_187 ) ;
F_42 ( V_4 , V_185 -> V_188 , V_185 -> V_189 , V_100 ) ;
}
...
static int
F_69 ( struct V_31 * V_4 , struct V_192 * V_193 )
{
return - V_194 ;
}
static const char *
...
static int F_72 ( struct V_106 * V_106 , unsigned char V_44 )
{
...
static int F_73 ( struct V_106 * V_106 )
{
struct V_1 * V_2 = V_106 -> V_196 ;
unsigned long V_39 ;
int V_108 ;
...
static void F_74 ( struct V_106 * V_106 )
{
struct V_1 * V_2 = V_106 -> V_196 ;
unsigned long V_39 ;
F_21 ( & V_198 , V_39 ) ;
...
F_78 ( V_106 -> V_195 , L_6 , sizeof( V_106 -> V_195 ) ) ;
} else {
V_106 -> V_226 . V_228 = V_230 ;
V_106 -> V_226 . V_231 = 1 ;
F_78 ( V_106 -> V_195 , L_7 , sizeof( V_106 -> V_195 ) ) ;
}
F_78 ( V_106 -> V_232 ,
...
static void F_82 ( struct V_31 * V_4 , int V_44 )
{
struct V_1 * V_2 = (struct V_1 * ) V_4 ;
F_80 ( V_2 ) ;
F_5 ( V_2 , V_74 , V_44 ) ;
}
static void F_83 ( struct V_240 * V_241 , const char * V_242 ,
unsigned int V_72 )
{
...
V_244 = F_85 ( & V_2 -> V_4 . V_24 ) ;
} else
F_86 ( & V_2 -> V_4 . V_24 ) ;
V_28 = F_1 ( V_2 , V_30 ) ;
F_5 ( V_2 , V_30 , 0 ) ;
F_87 ( & V_2 -> V_4 , V_242 , V_72 , F_82 ) ;
F_80 ( V_2 ) ;
F_5 ( V_2 , V_30 , V_28 ) ;
if ( V_244 )
F_88 ( & V_2 -> V_4 . V_24 ) ;
...
static int T_3 F_90 ( struct V_240 * V_241 , char * V_247 )
{
...
static inline struct V_240 * F_93 ( void )
{
return & V_254 ;
}
static enum V_104 F_94 ( struct V_255 * V_256 )
{
struct V_255 * V_257 = F_95 ( L_11 ) ;
if ( V_257 ) {
const char * V_258 = F_96 ( V_257 , L_12 , NULL ) ;
const char * V_259 = F_96 ( V_257 , L_13 , NULL ) ;
if ( V_258 ) {
if ( V_256 == F_95 ( V_258 ) )
return V_105 ;
}
...
static int F_97 ( struct V_260 * V_261 )
{
...
V_2 -> V_270 = F_99 ( V_263 ) ;
V_2 -> V_4 . V_11 = F_100 ( V_263 , 0 , V_2 -> V_270 , L_14 ) ;
if ( ! V_2 -> V_4 . V_11 ) {
if ( type != V_144 )
F_101 ( V_2 ) ;
return - V_268 ;
...
return 0 ;
V_275:
F_102 ( & V_261 -> V_262 [ 0 ] , V_2 -> V_4 . V_11 , V_2 -> V_270 ) ;
return V_265 ;
}
static int F_106 ( struct V_260 * V_261 )
{
struct V_1 * V_2 = F_107 ( & V_261 -> V_222 ) ;
bool V_277 = false ;
if ( V_2 -> V_104 == V_107 ||
V_2 -> V_104 == V_105 )
V_277 = true ;
