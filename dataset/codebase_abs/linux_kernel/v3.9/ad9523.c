...
F_52 (i, &active_mask, AD9523_NUM_CHAN)
F_11 ( V_2 ,
F_26 ( V_87 ) ,
F_51 ( V_186 ) |
V_72 ) ;
V_6 = F_11 ( V_2 , V_187 , 0 ) ;
if ( V_6 < 0 )
return V_6 ;
V_6 = F_11 ( V_2 , V_49 ,
V_188 ) ;
...
static int F_53 ( struct V_189 * V_16 )
{
struct V_83 * V_84 = V_16 -> V_17 . V_190 ;
struct V_1 * V_2 ;
struct V_4 * V_5 ;
int V_6 ;
if ( ! V_84 ) {
...
V_5 -> V_16 = V_16 ;
V_5 -> V_84 = V_84 ;
V_2 -> V_17 . V_193 = & V_16 -> V_17 ;
V_2 -> V_194 = ( V_84 -> V_194 [ 0 ] != 0 ) ? V_84 -> V_194 :
F_59 ( V_16 ) -> V_194 ;
V_2 -> V_195 = & V_196 ;
V_2 -> V_197 = V_198 ;
V_2 -> V_162 = V_5 -> V_176 ;
...
static int F_65 ( struct V_189 * V_16 )
{
struct V_1 * V_2 = F_66 ( V_16 ) ;
struct V_4 * V_5 = F_2 ( V_2 ) ;
F_67 ( V_2 ) ;
if ( ! F_56 ( V_5 -> V_78 ) ) {
F_62 ( V_5 -> V_78 ) ;
