...
if ( ! V_39 -> V_3 . V_46 )
goto V_156;
if ( V_39 -> V_3 . V_46 -> type != V_72 || V_39 -> V_3 . V_46 -> V_157 )
goto V_158;
V_39 -> V_2 . V_46 = F_49 ( & V_70 , V_39 -> V_63 . V_113 ) ;
if ( ! V_39 -> V_2 . V_46 )
goto V_158;
if ( V_39 -> V_2 . V_46 -> type != V_72 || V_39 -> V_2 . V_46 -> V_157 )
goto V_159;
F_24 () ;
V_128 = F_17 ( V_39 ) ;
if ( ! V_128 )
F_50 ( & V_39 -> V_76 , & V_160 ) ;
V_159:
F_51 ( V_39 -> V_2 . V_46 ) ;
V_158:
F_51 ( V_39 -> V_3 . V_46 ) ;
...
static int F_53 ( struct V_36 * V_37 , struct V_84 * V_85 , void * V_149 )
{
struct V_38 * V_39 = NULL ;
struct V_74 * V_75 ;
struct V_82 * V_150 ;
...
V_162 . V_163 = F_21 ;
F_58 ( & V_162 ) ;
if ( F_59 ( V_164 , V_165 , NULL , F_35 , NULL ) ) {
F_60 ( & V_162 ) ;
F_61 ( V_77 ) ;
return - V_166 ;
}
F_59 ( V_164 , V_118 , F_45 , NULL , NULL ) ;
F_59 ( V_164 , V_167 , F_53 , NULL , NULL ) ;
return 0 ;
}
