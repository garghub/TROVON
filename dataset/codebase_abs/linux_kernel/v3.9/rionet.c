...
{
struct V_4 * V_5 = F_2 ( V_2 ) ;
F_61 ( V_56 -> V_76 , V_32 , sizeof( V_56 -> V_76 ) ) ;
F_61 ( V_56 -> V_77 , V_78 , sizeof( V_56 -> V_77 ) ) ;
F_61 ( V_56 -> V_79 , L_10 , sizeof( V_56 -> V_79 ) ) ;
F_61 ( V_56 -> V_80 , V_5 -> V_9 -> V_45 , sizeof( V_56 -> V_80 ) ) ;
}
...
static void F_63 ( struct V_1 * V_2 , T_2 V_82 )
{
struct V_4 * V_5 = F_2 ( V_2 ) ;
V_5 -> V_81 = V_82 ;
}
static int F_64 ( struct V_52 * V_9 , struct V_1 * V_2 )
{
int V_67 = 0 ;
struct V_4 * V_5 ;
T_1 V_83 ;
...
F_21 ( V_9 -> V_48 ) ;
V_41 [ V_9 -> V_42 ] . V_49 = (struct V_22 * * ) F_65 ( V_85 ,
F_56 ( V_84 ) ) ;
...
static int F_70 ( struct V_22 * V_23 , const struct V_96 * V_42 )
{
int V_67 = - V_97 ;
T_2 V_98 , V_99 ;
struct V_57 * V_58 ;
...
if ( V_71 >= V_101 )
return V_67 ;
V_100 = F_71 ( V_71 , V_102 ) ;
if ( ! V_100 ) {
F_72 ( V_23 -> V_72 -> V_73 , V_103 ,
& V_98 ) ;
F_72 ( V_23 -> V_72 -> V_73 , V_104 ,
& V_99 ) ;
if ( ! F_73 ( V_98 , V_99 ) ) {
F_14 ( V_44
L_12 ,
...
V_41 [ V_71 ] . V_2 = V_2 ;
V_67 = F_64 ( V_23 -> V_72 -> V_73 , V_2 ) ;
F_75 ( & V_41 [ V_71 ] . V_105 ) ;
V_41 [ V_71 ] . V_43 = 0 ;
} else if ( V_41 [ V_71 ] . V_2 == NULL )
goto V_69;
if ( F_76 ( V_23 ) ) {
if ( ! ( V_58 = F_77 ( sizeof( struct V_57 ) , V_85 ) ) ) {
V_67 = - V_86 ;
goto V_69;
}
V_58 -> V_23 = V_23 ;
F_78 ( & V_58 -> V_74 , & V_41 [ V_71 ] . V_105 ) ;
}
F_79 ( V_23 , V_41 [ V_71 ] . V_2 ) ;
V_69:
return V_67 ;
}
