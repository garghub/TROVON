...
unsigned int V_111 ;
#ifdef F_98
F_99 ( L_49 , V_209 , V_46 . V_210 , & V_211 ) ;
#endif
if ( ! V_212 )
return 0 ;
F_11 ( ( L_50 ) ) ;
...
static int T_1 F_106 ( char * V_217 )
{
char * V_204 , * V_218 , * V_219 ;
int V_220 = 0 ;
V_221 = 1 ;
V_212 = 1 ;
if ( F_102 ( V_217 ) )
...
V_218 = V_217 ;
while ( V_218 && * V_218 ) {
if ( ( V_204 = strchr ( V_218 , ':' ) ) )
* V_204 ++ = '\0' ;
if ( strlen ( V_218 ) > 0 ) {
F_11 ( ( L_69 , V_220 , V_218 ) ) ;
switch ( V_220 ) {
case 0 :
if ( ( V_55 = F_93 ( V_218 ) ) == V_222 )
V_55 = V_65 ;
break;
case 1 :
if ( ( V_77 = F_93 ( V_218 ) ) == V_222 )
V_77 = V_65 ;
break;
case 2 :
if ( ( V_64 = F_93 ( V_218 ) ) == V_222 )
V_64 = V_65 ;
break;
case 3 :
if ( ( V_57 = F_93 ( V_218 ) ) == V_222 )
V_57 = V_65 ;
break;
case 4 :
if ( ( V_219 = strchr ( V_218 , '.' ) ) ) {
* V_219 ++ = '\0' ;
F_107 ( F_58 () -> V_165 , V_219 ,
sizeof( F_58 () -> V_165 ) ) ;
}
F_107 ( F_58 () -> V_75 , V_218 ,
sizeof( F_58 () -> V_75 ) ) ;
V_74 = 1 ;
break;
case 5 :
F_107 ( V_5 , V_218 , sizeof( V_5 ) ) ;
break;
case 6 :
if ( F_102 ( V_218 ) == 0 &&
V_55 == V_65 ) {
...
static int T_1 F_108 ( char * V_217 )
{
return F_106 ( V_217 ) ;
}
static int T_1 F_109 ( char * V_217 )
{
if ( F_107 ( V_122 , V_217 ,
sizeof( V_122 ) )
>= sizeof( V_122 ) )
F_7 ( L_70 ,
V_122 ) ;
