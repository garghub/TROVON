...
V_58 = V_21 -> V_69 ;
V_21 -> V_69 = NULL ;
if ( ! V_58 || V_58 -> V_70 != V_59 -> V_70 ) {
F_25 ( V_67 | V_62 , L_9 ) ;
goto V_71;
}
if ( V_58 -> V_50 != V_59 -> V_50 ) {
F_25 ( V_67 | V_62 ,
L_10 ,
V_58 -> V_50 ,
V_59 -> V_50 ) ;
...
for ( V_20 = 0 ; V_20 < V_59 -> V_50 ; V_20 ++ ) {
if ( V_58 -> V_51 [ V_20 ] . V_64 ||
V_59 -> V_51 [ V_20 ] . V_64 ) {
F_25 ( V_67 | V_62 ,
L_11 , V_20 ,
V_58 -> V_51 [ V_20 ] . V_64 ,
...
+ V_58 -> V_51 [ V_20 ] . V_53 ;
if ( V_61 & 0x80 ) {
F_28 ( V_1 , V_75 , NULL , 0 ) ;
F_28 ( V_1 , V_76 , NULL , 0 ) ;
} else {
#if F_22 ( V_54 )
T_2 V_77 = V_61 & 0x40 ? 1 : 0 ;
if ( V_21 -> V_55 != V_77 ) {
F_23 ( V_1 -> V_56 ,
V_57 ,
V_77 ) ;
...
{
struct V_1 * V_1 =
F_30 ( V_80 -> V_81 , struct V_1 , V_82 ) ;
V_1 -> V_7 = 0 ;
if ( ! V_1 -> V_63 )
return 0 ;
switch ( V_80 -> V_14 ) {
...
const struct V_13 * V_14 )
{
return F_35 ( V_28 , V_14 , & V_98 , sizeof( struct V_21 ) ,
V_99 ) ;
}
