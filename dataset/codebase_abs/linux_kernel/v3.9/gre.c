...
V_33 = false ;
if ( V_30 -> V_46 == F_21 ( V_47 ) ) {
struct V_48 * V_49 = F_22 ( V_10 ) ;
V_10 -> V_46 = V_49 -> V_50 ;
} else {
V_10 -> V_46 = V_30 -> V_46 ;
}
...
V_54 = ( T_4 * ) ( V_30 + 1 ) ;
* V_54 = 0 ;
* ( V_56 * ) V_54 = F_34 ( F_35 ( V_10 , 0 , V_10 -> V_57 , 0 ) ) ;
}
F_31 ( V_10 , V_32 - V_27 ) ;
F_24 ( V_10 ) ;
F_25 ( V_10 , V_31 ) ;
V_10 -> V_31 = V_31 ;
} while ( ( V_10 = V_10 -> V_58 ) );
V_41:
return V_24 ;
}
