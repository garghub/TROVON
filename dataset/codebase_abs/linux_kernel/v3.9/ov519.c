...
static void F_69 ( struct V_7 * V_7 , T_2 V_253 )
{
struct V_2 * V_2 = (struct V_2 * ) V_7 ;
if ( V_2 -> V_250 != V_253 ) {
#if F_66 ( V_249 )
F_67 ( V_7 -> V_251 , V_252 , V_253 ) ;
F_68 ( V_7 -> V_251 ) ;
#endif
if ( V_253 )
V_2 -> V_84 = 1 ;
...
{
struct V_2 * V_2 = (struct V_2 * ) V_7 ;
if ( ! ( V_254 [ 0 ] | V_254 [ 1 ] | V_254 [ 2 ] | V_254 [ 3 ] | V_254 [ 4 ] | V_254 [ 5 ] | V_254 [ 6 ] | V_254 [ 7 ] ) &&
( V_254 [ 8 ] & 0x08 ) ) {
F_69 ( V_7 , ( V_254 [ 8 ] >> 2 ) & 1 ) ;
if ( V_254 [ 8 ] & 0x80 ) {
if ( ( V_254 [ 9 ] + 1 ) * 8 != V_7 -> V_172 ||
( V_254 [ 10 ] + 1 ) * 8 != V_7 -> V_192 ) {
F_3 ( V_65 , L_61
L_62 ,
( V_254 [ 9 ] + 1 ) * 8 , ( V_254 [ 10 ] + 1 ) * 8 ,
V_7 -> V_172 , V_7 -> V_192 ) ;
V_7 -> V_256 = V_257 ;
return;
}
F_71 ( V_7 , V_258 , V_254 , 11 ) ;
return;
} else {
F_71 ( V_7 , V_259 , V_254 , 0 ) ;
V_2 -> V_260 = 0 ;
}
}
V_255 -- ;
F_71 ( V_7 , V_261 , V_254 , V_255 ) ;
}
...
{
struct V_2 * V_2 = (struct V_2 * ) V_7 ;
if ( ( ! ( V_262 [ 0 ] | V_262 [ 1 ] | V_262 [ 2 ] | V_262 [ 3 ] | V_262 [ 5 ] ) ) && V_262 [ 6 ] ) {
F_69 ( V_7 , ( V_262 [ 6 ] >> 1 ) & 1 ) ;
F_71 ( V_7 , V_258 , NULL , 0 ) ;
...
if ( V_255 & 7 ) {
V_255 -- ;
if ( V_2 -> V_260 == V_262 [ V_255 ] )
V_2 -> V_260 ++ ;
else if ( V_2 -> V_260 == 0 || V_262 [ V_255 ] ) {
F_3 ( V_65 , L_63 ,
( int ) V_262 [ V_255 ] , ( int ) V_2 -> V_260 ) ;
V_7 -> V_256 = V_257 ;
return;
}
}
F_71 ( V_7 , V_261 , V_262 , V_255 ) ;
}
static void F_73 ( struct V_7 * V_7 ,
T_2 * V_262 ,
int V_255 )
{
if ( V_262 [ 0 ] == 0xff && V_262 [ 1 ] == 0xff && V_262 [ 2 ] == 0xff ) {
switch ( V_262 [ 3 ] ) {
case 0x50 :
#define F_74 16
V_262 += F_74 ;
...
case V_10 :
case V_11 :
F_70 ( V_7 , V_262 , V_255 ) ;
break;
case V_36 :
case V_37 :
F_72 ( V_7 , V_262 , V_255 ) ;
break;
case V_38 :
F_73 ( V_7 , V_262 , V_255 ) ;
break;
case V_12 :
F_75 ( V_7 , V_262 , V_255 ) ;
break;
case V_13 :
F_77 ( V_7 , V_262 , V_255 ) ;
break;
}
}
...
{
struct V_2 * V_2 = (struct V_2 * ) V_7 ;
static const struct V_56 V_264 [] [ 7 ] = {
...
{
struct V_2 * V_2 = (struct V_2 * ) V_7 ;
static const struct V_56 V_267 [] [ 31 ] = {
...
case V_75 :
case V_77 :
F_24 ( V_2 , V_268 , V_55 >> 4 , 0x0f ) ;
break;
case V_66 : {
static const T_2 V_269 [] = {
0x03 , 0x09 , 0x0b , 0x0f , 0x53 , 0x6f , 0x35 , 0x7f
} ;
F_20 ( V_2 , 0x64 , V_269 [ V_55 >> 5 ] ) ;
break;
}
case V_74 :
case V_69 : {
...
{
struct V_2 * V_2 = (struct V_2 * ) V_7 ;
static const struct V_56 V_271 [] [ 6 ] = {
...
switch ( V_55 ) {
case 0 :
F_24 ( V_2 , V_225 , 0 , V_273 ) ;
break;
case 1 :
F_24 ( V_2 , V_225 , V_273 ,
V_273 ) ;
F_24 ( V_2 , V_274 , 0x08 , 0x18 ) ;
break;
case 2 :
F_24 ( V_2 , V_225 , V_273 ,
V_273 ) ;
F_24 ( V_2 , V_274 , 0x00 , 0x18 ) ;
break;
case 3 :
F_24 ( V_2 , V_225 , V_273 ,
V_273 ) ;
F_24 ( V_2 , V_274 , V_275 ,
0x18 ) ;
break;
}
} else {
...
if ( V_2 -> V_9 != V_13 )
return - V_278 ;
F_89 ( V_2 -> V_280 , V_277 -> V_279 ) ;
return 0 ;
}
static int F_90 ( struct V_285 * V_286 )
{
struct V_7 * V_7 =
F_91 ( V_286 -> V_287 , struct V_7 , V_288 ) ;
struct V_2 * V_2 = (struct V_2 * ) V_7 ;
V_7 -> V_8 = 0 ;
switch ( V_286 -> V_129 ) {
case V_289 :
V_7 -> V_290 -> V_55 = F_22 ( V_2 , 0x10 ) ;
break;
}
return 0 ;
}
static int F_92 ( struct V_285 * V_286 )
{
struct V_7 * V_7 =
F_91 ( V_286 -> V_287 , struct V_7 , V_288 ) ;
struct V_2 * V_2 = (struct V_2 * ) V_7 ;
...
if ( V_286 -> V_295 )
F_82 ( V_7 , V_286 -> V_55 ) ;
if ( ! V_286 -> V_55 && V_2 -> V_296 -> V_295 )
F_78 ( V_7 , V_2 -> V_296 -> V_55 ) ;
break;
case V_297 :
F_81 ( V_7 , V_286 -> V_55 ) ;
break;
case V_298 :
F_59 ( V_7 , V_286 -> V_55 , V_2 -> V_233 -> V_55 ) ;
break;
case V_289 :
if ( V_286 -> V_295 )
F_46 ( V_7 , V_286 -> V_55 ) ;
if ( ! V_286 -> V_55 && V_7 -> V_290 -> V_295 )
F_80 ( V_7 , V_7 -> V_290 -> V_55 ) ;
break;
case V_299 :
return - V_300 ;
}
...
{
struct V_2 * V_2 = (struct V_2 * ) V_7 ;
struct V_301 * V_302 = & V_7 -> V_288 ;
V_7 -> V_303 . V_288 = V_302 ;
F_94 ( V_302 , 10 ) ;
if ( V_304 [ V_2 -> V_59 ] . V_305 )
V_2 -> V_296 = F_95 ( V_302 , & V_306 ,
V_291 , 0 ,
V_2 -> V_59 == V_73 ? 6 : 255 , 1 ,
V_2 -> V_59 == V_73 ? 3 : 127 ) ;
if ( V_304 [ V_2 -> V_59 ] . V_307 ) {
if ( V_2 -> V_59 == V_73 )
F_95 ( V_302 , & V_306 ,
V_292 , 0 , 6 , 1 , 3 ) ;
else
...
if ( V_304 [ V_2 -> V_59 ] . V_308 )
F_95 ( V_302 , & V_306 ,
V_297 , 0 ,
V_2 -> V_59 == V_73 ? 4 : 255 , 1 ,
V_2 -> V_59 == V_73 ? 2 : 127 ) ;
if ( V_304 [ V_2 -> V_59 ] . V_309 )
V_7 -> V_290 = F_95 ( V_302 , & V_306 ,
V_310 , 0 , 255 , 1 , 127 ) ;
if ( V_304 [ V_2 -> V_59 ] . V_311 ) {
V_2 -> V_232 = F_95 ( V_302 , & V_306 ,
V_298 , 0 , 1 , 1 , 0 ) ;
V_2 -> V_233 = F_95 ( V_302 , & V_306 ,
V_312 , 0 , 1 , 1 , 0 ) ;
}
if ( V_304 [ V_2 -> V_59 ] . V_313 )
V_2 -> V_314 = F_95 ( V_302 , & V_306 ,
V_294 , 0 , 1 , 1 , 1 ) ;
if ( V_304 [ V_2 -> V_59 ] . V_315 )
V_7 -> V_316 = F_95 ( V_302 , & V_306 ,
V_289 , 0 , 1 , 1 , 1 ) ;
if ( V_304 [ V_2 -> V_59 ] . V_317 ) {
if ( V_2 -> V_59 == V_67 )
V_2 -> V_318 = F_96 ( V_302 , & V_306 ,
V_293 ,
V_319 , 0 ,
V_319 ) ;
else
...
if ( V_7 -> V_316 )
F_97 ( 3 , & V_7 -> V_316 , 0 , true ) ;
if ( V_2 -> V_314 )
F_97 ( 2 , & V_2 -> V_314 , 0 , false ) ;
if ( V_2 -> V_232 )
F_98 ( 2 , & V_2 -> V_232 ) ;
return 0 ;
}
...
const struct V_128 * V_129 )
{
return F_100 ( V_182 , V_129 , & V_324 , sizeof( struct V_2 ) ,
V_325 ) ;
}
