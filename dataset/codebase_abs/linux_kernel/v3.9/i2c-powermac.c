...
const T_5 * V_56 ;
int V_18 ;
V_56 = F_16 ( V_55 , L_10 , & V_18 ) ;
if ( V_56 && ( V_18 >= sizeof( int ) ) )
return ( F_17 ( V_56 ) & 0xff ) >> 1 ;
V_56 = F_16 ( V_55 , L_11 , & V_18 ) ;
if ( V_56 && ( V_18 >= sizeof( int ) ) )
return ( F_17 ( V_56 ) & 0xff ) >> 1 ;
...
bool V_62 )
{
struct V_54 * V_63 = F_22 ( V_11 ) ;
int V_12 ;
#define F_23 67
if ( F_24 ( V_63 , L_16 ) && ! V_62 ) {
union V_8 V_9 ;
...
{
char V_65 [ 16 ] ;
if ( F_27 ( V_55 , V_65 , sizeof( V_65 ) ) >= 0 ) {
...
if ( F_24 ( V_55 , L_25 ) )
V_62 = true ;
if ( ! F_26 ( V_2 , V_55 , V_3 ,
V_59 . type , sizeof( V_59 . type ) ) ) {
continue;
}
V_59 . V_3 = V_3 ;
V_59 . V_67 = F_31 ( V_55 , 0 ) ;
V_59 . V_66 = F_32 ( V_55 ) ;
V_61 = F_20 ( V_2 , & V_59 ) ;
if ( ! V_61 ) {
F_4 ( & V_2 -> V_35 , L_26
...
static int F_34 ( struct V_51 * V_35 )
{
