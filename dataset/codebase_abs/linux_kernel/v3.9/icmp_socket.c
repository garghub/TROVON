...
if ( F_33 ( & V_15 -> V_66 ) != V_67 )
goto V_68;
V_49 = F_34 ( V_15 , V_38 -> V_69 ) ;
if ( ! V_49 )
goto V_68;
V_51 = F_35 ( V_49 ) ;
if ( ! V_51 )
...
if ( ! V_51 -> V_70 )
goto V_68;
if ( V_51 -> V_70 -> V_71 != V_72 )
goto V_68;
memcpy ( V_38 -> V_73 ,
V_44 -> V_74 -> V_75 , V_76 ) ;
if ( V_29 == sizeof( struct V_47 ) )
memcpy ( V_38 -> V_77 ,
V_51 -> V_70 -> V_74 -> V_75 , V_76 ) ;
F_36 ( V_46 , V_51 -> V_70 , V_51 -> V_78 ) ;
goto V_53;
V_68:
V_38 -> V_60 = V_79 ;
F_32 ( V_6 , V_38 , V_29 ) ;
...
static unsigned int F_41 ( struct V_3 * V_3 , T_5 * V_80 )
{
struct V_5 * V_6 = V_3 -> V_19 ;
F_42 ( V_3 , & V_6 -> V_18 , V_80 ) ;
if ( V_6 -> V_13 > 0 )
return V_81 | V_82 ;
return 0 ;
}
