...
V_117 = V_12 + V_116 ;
error = F_72 ( V_31 , V_117 ) ;
if ( error )
goto V_130;
}
if ( V_17 -> V_54 & V_131 )
V_121 |= V_132 ;
error = - F_73 ( V_2 , V_119 , & V_118 , 0 , V_121 ) ;
if ( error )
goto V_130;
if ( V_117 ) {
struct V_133 V_133 ;
...
struct V_17 * V_17 )
{
if ( ! ( V_17 -> V_54 & V_137 ) && F_33 ( V_31 ) > V_138 )
return - V_139 ;
if ( F_23 ( F_76 ( V_31 -> V_113 ) ) )
return - V_33 ;
return 0 ;
}
STATIC int
...
T_11 V_144 )
{
struct V_31 * V_31 = F_71 ( V_142 ) ;
T_10 * V_2 = F_16 ( V_31 ) ;
int error ;
T_2 V_145 ;
V_145 = ( T_2 ) F_83 ( T_1 , 32768 , V_2 -> V_140 . V_146 ) ;
error = F_84 ( V_2 , V_143 , V_145 ,
...
unsigned V_172 ;
unsigned int V_173 ;
V_171 = F_83 ( T_12 , V_19 - V_167 , V_174 ) ;
V_172 = F_96 ( & V_166 , V_31 -> V_11 , V_167 ,
V_171 ) ;
if ( V_172 == 0 ) {
if ( type == V_160 )
break;
...
V_156 = F_89 ( V_7 , & V_176 , type ) ;
if ( V_156 ) {
* V_12 = F_100 ( T_1 , V_169 , V_176 ) ;
F_98 ( V_7 ) ;
goto V_106;
}
V_155 = F_90 ( V_7 ) + V_177 ;
F_98 ( V_7 ) ;
}
if ( V_172 < V_171 ) {
if ( type == V_161 ) {
...
! F_103 ( V_164 [ V_173 ] . V_85 ) ) )
goto V_106;
if ( V_164 [ V_173 ] . V_95 == V_96 ) {
if ( F_94 ( V_31 , & V_164 [ V_173 ] ,
V_160 , & V_12 ) )
goto V_106;
}
}
...
case V_188 :
case V_189 :
return F_107 ( V_17 , V_12 , V_186 ) ;
case V_190 :
return F_102 ( V_17 , V_12 ) ;
case V_191 :
return F_105 ( V_17 , V_12 ) ;
default:
return - V_63 ;
}
}
