...
int V_132 = 0 ;
struct V_133 * V_82 ;
V_8 = F_33 ( & V_126 -> V_104 , sizeof( * V_8 ) , V_134 ) ;
if ( ! V_8 )
return - V_135 ;
...
V_8 -> V_10 = F_42 ( & V_126 -> V_104 , V_128 ) ;
if ( F_37 ( V_8 -> V_10 ) ) {
V_132 = F_38 ( V_8 -> V_10 ) ;
goto V_142;
}
...
V_8 -> V_73 . V_146 = V_128 -> V_147 + V_148 ;
V_8 -> V_72 . V_146 = V_128 -> V_147 + V_149 ;
V_8 -> V_72 . V_106 = 6 ;
V_8 -> V_73 . V_106 = 4 ;
V_128 = F_43 ( V_126 , V_150 , L_4 ) ;
if ( V_128 )
V_8 -> V_72 . V_151 = V_128 -> V_147 ;
V_128 = F_43 ( V_126 , V_150 , L_5 ) ;
if ( V_128 )
V_8 -> V_73 . V_151 = V_128 -> V_147 ;
F_44 ( V_126 , V_8 ) ;
V_132 = F_45 ( & V_126 -> V_104 , V_82 ) ;
if ( V_132 ) {
F_39 ( & V_126 -> V_104 , L_6 ) ;
goto V_142;
}
V_8 -> V_152 = F_46 ( L_7 , V_126 -> V_153 ) ;
if ( ! V_8 -> V_152 ) {
V_132 = - V_135 ;
goto V_154;
}
F_44 ( V_8 -> V_152 , V_8 ) ;
V_132 = F_47 ( V_8 -> V_152 ) ;
if ( V_132 ) {
F_39 ( & V_126 -> V_104 , L_8 ) ;
goto V_155;
}
V_8 -> V_156 = F_46 ( L_9 , V_126 -> V_153 ) ;
if ( ! V_8 -> V_156 ) {
V_132 = - V_135 ;
goto V_157;
}
F_44 ( V_8 -> V_156 , V_8 ) ;
V_132 = F_47 ( V_8 -> V_156 ) ;
if ( V_132 ) {
F_39 ( & V_126 -> V_104 , L_8 ) ;
goto V_158;
}
...
F_50 ( & V_126 -> V_104 ) ;
V_142:
F_51 ( V_128 -> V_147 , F_52 ( V_128 ) ) ;
V_141:
F_53 ( V_8 -> V_137 ) ;
V_138:
return V_132 ;
}
static int F_54 ( struct V_125 * V_126 )
{
struct V_127 * V_128 = F_41 ( V_126 , V_139 , 0 ) ;
struct V_7 * V_8 = F_55 ( V_126 ) ;
F_56 ( V_8 -> V_156 ) ;
F_56 ( V_8 -> V_152 ) ;
F_50 ( & V_126 -> V_104 ) ;
if ( V_8 -> V_27 & V_103 )
