...
void F_56 ( struct V_1 * V_2 , int V_95 )
{
F_57 ( V_2 -> V_83 . V_15 -> V_40 . V_58 , V_95 ) ;
}
int F_58 ( struct V_1 * V_2 )
{
struct V_11 * V_96 ;
int V_22 = 0 ;
V_96 = F_4 ( V_2 -> V_83 . V_15 -> V_56 . V_87 ) ;
V_22 += F_29 ( V_96 ) ;
return V_22 ;
}
bool F_59 ( struct V_1 * V_2 , struct V_11 * V_96 )
{
if ( V_96 == F_4 ( V_2 -> V_83 . V_15 -> V_56 . V_87 ) )
return true ;
return false ;
}
