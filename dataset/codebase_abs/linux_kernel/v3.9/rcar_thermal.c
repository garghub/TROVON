...
F_48 ( & V_2 -> V_18 ) ;
V_2 -> V_11 = V_11 ;
V_40 = F_49 ( V_44 , V_54 , 0 ) ;
if ( V_40 ) {
int V_16 ;
V_46 = F_49 ( V_44 , V_55 , V_47 ++ ) ;
if ( ! V_46 ) {
F_15 ( V_11 , L_10 ) ;
return - V_48 ;
}
V_16 = F_50 ( V_11 , V_40 -> V_56 , F_38 , 0 ,
F_51 ( V_11 ) , V_2 ) ;
if ( V_16 ) {
F_15 ( V_11 , L_11 ) ;
return V_16 ;
}
V_2 -> V_4 = F_52 ( V_11 , V_46 ) ;
if ( F_53 ( V_2 -> V_4 ) )
return F_54 ( V_2 -> V_4 ) ;
