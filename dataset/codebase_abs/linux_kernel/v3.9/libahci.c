...
F_116 ( V_14 , V_22 , V_180 ) ;
}
T_9 F_123 ( int V_295 , void * V_296 )
{
struct V_13 * V_14 = V_296 ;
struct V_92 * V_93 = V_14 -> V_18 ;
void T_1 * V_22 = F_12 ( V_14 ) ;
unsigned long V_28 ;
T_2 V_180 ;
...
T_9 F_127 ( int V_295 , void * V_296 )
{
struct V_13 * V_299 = V_296 ;
struct V_92 * V_93 = V_299 -> V_18 ;
struct V_73 * V_17 = V_299 -> V_17 ;
struct V_15 * V_16 = V_17 -> V_18 ;
void T_1 * V_1 = V_16 -> V_1 ;
unsigned int V_2 ;
T_2 V_249 , V_300 ;
...
V_249 = F_2 ( V_1 + V_162 ) ;
if ( ! V_249 ) {
T_2 V_180 = V_93 -> V_297 ;
F_129 ( & V_17 -> V_30 ) ;
F_60 ( L_50 ) ;
return V_180 ? V_301 : V_302 ;
}
V_300 = V_249 & V_16 -> V_53 ;
for ( V_2 = 0 ; V_2 < V_17 -> V_163 ; V_2 ++ ) {
struct V_13 * V_14 ;
if ( ! ( V_300 & ( 1 << V_2 ) ) )
continue;
...
T_9 F_131 ( int V_295 , void * V_296 )
{
struct V_73 * V_17 = V_296 ;
struct V_15 * V_16 ;
unsigned int V_2 , V_303 = 0 ;
void T_1 * V_1 ;
T_2 V_249 , V_300 ;
F_60 ( L_31 ) ;
V_16 = V_17 -> V_18 ;
...
static unsigned int F_133 ( struct V_222 * V_223 )
{
struct V_13 * V_14 = V_223 -> V_14 ;
void T_1 * V_22 = F_12 ( V_14 ) ;
struct V_92 * V_93 = V_14 -> V_18 ;
V_93 -> V_293 = V_223 -> V_7 -> V_87 ;
if ( V_223 -> V_169 . V_235 == V_304 )
F_3 ( 1 << V_223 -> V_175 , V_22 + V_83 ) ;
if ( V_93 -> V_233 && V_93 -> V_305 != V_223 -> V_7 -> V_87 -> V_128 ) {
T_2 V_245 = F_2 ( V_22 + V_246 ) ;
V_245 &= ~ ( V_306 | V_248 ) ;
V_245 |= V_223 -> V_7 -> V_87 -> V_128 << V_307 ;
F_3 ( V_245 , V_22 + V_246 ) ;
V_93 -> V_305 = V_223 -> V_7 -> V_87 -> V_128 ;
}
F_3 ( 1 << V_223 -> V_175 , V_22 + V_196 ) ;
F_47 ( V_223 -> V_7 -> V_87 ) ;
return 0 ;
}
static bool F_134 ( struct V_222 * V_223 )
{
struct V_92 * V_93 = V_223 -> V_14 -> V_18 ;
T_6 * V_215 = V_93 -> V_215 ;
if ( V_93 -> V_233 )
V_215 += V_223 -> V_7 -> V_87 -> V_128 * V_308 ;
if ( V_223 -> V_169 . V_235 == V_309 && V_223 -> V_310 == V_311 &&
! ( V_223 -> V_28 & V_312 ) ) {
F_135 ( V_215 + V_313 , & V_223 -> V_314 ) ;
V_223 -> V_314 . V_218 = ( V_215 + V_313 ) [ 15 ] ;
} else
F_135 ( V_215 + V_216 , & V_223 -> V_314 ) ;
return true ;
}
...
static void F_38 ( struct V_13 * V_14 , bool V_316 )
{
void T_1 * V_22 = F_12 ( V_14 ) ;
...
if ( V_125 )
return;
V_318 = ( V_317 & V_327 ) >> V_328 ;
V_319 = V_329 / ( V_318 + 1 ) ;
if ( V_319 > 0x3ff )
V_319 = 0x3ff ;
if ( V_7 -> V_330 [ V_331 ] &
V_332 ) {
V_320 = V_7 -> V_330 [ V_333 ] &
V_334 ;
if ( ! V_320 )
V_320 = 10 ;
V_321 = V_7 -> V_330 [ V_335 ] ;
if ( ! V_321 )
V_321 = 20 ;
} else {
V_320 = 10 ;
...
static int F_149 ( struct V_13 * V_14 , T_10 V_343 )
{
const char * V_132 = NULL ;
int V_125 ;
V_125 = F_44 ( V_14 , & V_132 ) ;
...
T_5 V_345 ;
T_4 V_346 , V_347 ;
V_93 = F_152 ( V_7 , sizeof( * V_93 ) , V_348 ) ;
if ( ! V_93 )
return - V_349 ;
if ( ( V_16 -> V_19 & V_69 ) && F_153 ( V_14 ) ) {
void T_1 * V_22 = F_12 ( V_14 ) ;
T_2 V_102 = F_2 ( V_22 + V_23 ) ;
if ( V_102 & V_350 )
V_93 -> V_340 = true ;
...
V_344 = F_154 ( V_7 , V_346 , & V_345 , V_348 ) ;
if ( ! V_344 )
return - V_349 ;
memset ( V_344 , 0 , V_346 ) ;
V_93 -> V_179 = V_344 ;
V_93 -> V_94 = V_345 ;
V_344 += V_353 ;
V_345 += V_353 ;
...
void F_157 ( struct V_73 * V_17 , const char * V_356 )
{
struct V_15 * V_16 = V_17 -> V_18 ;
void T_1 * V_1 = V_16 -> V_1 ;
T_2 V_52 , V_19 , V_20 , V_357 , V_358 ;
const char * V_359 ;
V_52 = F_2 ( V_1 + V_21 ) ;
V_19 = V_16 -> V_19 ;
V_20 = V_16 -> V_20 ;
...
T_6 V_375 ;
void T_1 * V_1 = V_16 -> V_1 ;
T_2 V_25 = F_2 ( V_1 + V_376 ) ;
T_2 V_26 = F_2 ( V_1 + V_31 ) ;
if ( ! V_377 || ! ( V_16 -> V_19 & V_367 ) )
return;
V_375 = ( V_26 & V_378 ) >> 16 ;
if ( V_375 ) {
V_16 -> V_25 = ( ( V_25 >> 16 ) * 4 ) ;
