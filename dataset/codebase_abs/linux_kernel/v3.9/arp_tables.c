...
static int F_78 ( struct V_175 * V_175 , struct V_181 T_6 * V_182 ,
const int * V_8 )
{
int V_10 ;
struct V_181 V_183 ;
...
static int F_79 ( struct V_175 * V_175 , const char * V_94 ,
unsigned int V_116 ,
struct V_90 * V_115 ,
unsigned int V_186 ,
void T_6 * V_187 )
...
V_188 = F_80 ( V_102 , V_186 , V_115 , & V_10 ) ;
if ( ! V_188 )
goto V_191;
F_11 ( L_48 ,
...
static int F_82 ( struct V_175 * V_175 , const void T_6 * V_123 ,
unsigned int V_8 )
{
int V_10 ;
struct V_147 V_179 ;
...
goto V_193;
F_11 ( L_49 ) ;
V_10 = F_79 ( V_175 , V_179 . V_94 , V_179 . V_116 , V_115 ,
...
static inline void F_86 ( struct V_173 * V_78 )
{
struct V_76 * V_102 ;
V_102 = F_87 ( V_78 ) ;
F_39 ( V_102 -> V_104 . V_105 . V_106 -> V_138 ) ;
...
static int
F_89 ( struct V_173 * V_78 , void * * V_204 ,
...
static int F_91 ( const char * V_94 ,
unsigned int V_116 ,
struct V_90 * * V_207 ,
void * * V_208 ,
unsigned int V_162 ,
...
static int F_92 ( struct V_175 * V_175 , void T_6 * V_123 ,
unsigned int V_8 )
{
int V_10 ;
struct V_215 V_179 ;
...
V_10 = F_91 ( V_179 . V_94 , V_179 . V_116 ,
...
static int F_95 ( struct V_216 * V_217 , int V_218 , void T_6 * V_123 ,
unsigned int V_8 )
{
int V_10 ;
if ( ! F_96 ( F_97 ( V_217 ) -> V_219 , V_220 ) )
return - V_221 ;
switch ( V_218 ) {
case V_222 :
V_10 = F_92 ( F_97 ( V_217 ) , V_123 , V_8 ) ;
break;
case V_223 :
V_10 = F_84 ( F_97 ( V_217 ) , V_123 , V_8 , 1 ) ;
break;
default:
F_11 ( L_56 , V_218 ) ;
V_10 = - V_130 ;
...
static int F_98 ( struct V_77 * V_78 , void T_6 * * V_204 ,
T_7 * V_126 ,
struct V_144 * V_103 ,
unsigned int V_9 )
{
...
if ( F_57 ( V_224 , V_78 , sizeof( struct V_77 ) ) != 0 ||
F_57 ( & V_224 -> V_103 , & V_103 [ V_9 ] ,
sizeof( V_103 [ V_9 ] ) ) != 0 )
return - V_167 ;
...
V_102 = F_15 ( V_78 ) ;
V_10 = F_99 ( V_102 , V_204 , V_126 ) ;
if ( V_10 )
return V_10 ;
V_128 = V_78 -> V_128 - ( V_206 - * V_126 ) ;
if ( F_100 ( V_122 , & V_224 -> V_122 ) != 0 ||
F_100 ( V_128 , & V_224 -> V_128 ) != 0 )
return - V_167 ;
return 0 ;
}
static int F_101 ( unsigned int V_162 ,
struct V_1 * V_84 ,
void T_6 * V_163 )
{
struct V_144 * V_103 ;
...
static int F_102 ( struct V_175 * V_175 ,
...
static int F_103 ( struct V_216 * V_217 , int V_218 , void T_6 * V_123 ,
int * V_8 )
{
int V_10 ;
if ( ! F_96 ( F_97 ( V_217 ) -> V_219 , V_220 ) )
...
switch ( V_218 ) {
case V_226 :
V_10 = F_68 ( F_97 ( V_217 ) , V_123 , V_8 , 1 ) ;
break;
case V_227 :
V_10 = F_102 ( F_97 ( V_217 ) , V_123 , V_8 ) ;
break;
default:
V_10 = F_104 ( V_217 , V_218 , V_123 , V_8 ) ;
}
return V_10 ;
}
static int F_105 ( struct V_216 * V_217 , int V_218 , void T_6 * V_123 , unsigned int V_8 )
{
int V_10 ;
if ( ! F_96 ( F_97 ( V_217 ) -> V_219 , V_220 ) )
return - V_221 ;
switch ( V_218 ) {
case V_222 :
V_10 = F_82 ( F_97 ( V_217 ) , V_123 , V_8 ) ;
break;
case V_223 :
V_10 = F_84 ( F_97 ( V_217 ) , V_123 , V_8 , 0 ) ;
break;
default:
F_11 ( L_56 , V_218 ) ;
V_10 = - V_130 ;
...
static int F_104 ( struct V_216 * V_217 , int V_218 , void T_6 * V_123 , int * V_8 )
{
int V_10 ;
if ( ! F_96 ( F_97 ( V_217 ) -> V_219 , V_220 ) )
return - V_221 ;
switch ( V_218 ) {
case V_226 :
V_10 = F_68 ( F_97 ( V_217 ) , V_123 , V_8 , 0 ) ;
break;
case V_227 :
V_10 = F_78 ( F_97 ( V_217 ) , V_123 , V_8 ) ;
break;
case V_228 : {
struct V_229 V_230 ;
if ( * V_8 != sizeof( V_230 ) ) {
...
if ( F_69 ( & V_230 , V_123 , sizeof( V_230 ) ) != 0 ) {
V_10 = - V_167 ;
break;
}
V_230 . V_94 [ sizeof( V_230 . V_94 ) - 1 ] = 0 ;
F_72 ( F_106 ( V_100 , V_230 . V_94 ,
V_230 . V_136 , 1 , & V_10 ) ,
L_60 , V_230 . V_94 ) ;
break;
}
...
struct V_1 * F_107 ( struct V_175 * V_175 ,
const struct V_1 * V_84 ,
const struct V_147 * V_148 )
{
int V_10 ;
...
if ( V_10 != 0 )
goto V_233;
V_232 = F_108 ( V_175 , V_84 , & V_231 , V_115 ) ;
if ( F_37 ( V_232 ) ) {
V_10 = F_38 ( V_232 ) ;
goto V_233;
}
...
static int T_9 F_111 ( struct V_175 * V_175 )
{
return F_112 ( V_175 , V_100 ) ;
}
static void T_10 F_113 ( struct V_175 * V_175 )
{
F_114 ( V_175 , V_100 ) ;
}
