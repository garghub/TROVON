...
T_4 F_19 ( int V_27 , void * V_28 )
{
F_17 ( V_28 , F_20 () ) ;
return V_29 ;
}
void F_21 ( struct V_6 * V_7 , T_3 time )
{
int V_21 ;
if ( ! V_7 -> V_22 )
for ( V_21 = 0 ; V_21 < V_23 ; V_21 ++ )
...
{
V_7 -> V_22 -- ;
if ( V_7 -> V_22 == 0 && V_7 -> V_30 && V_7 -> V_30 -> V_31 )
...
static void F_27 ( struct V_6 * V_7 , int V_27 )
{
F_7 ( & V_7 -> V_32 ) ;
F_28 ( V_27 - V_7 -> V_26 , V_7 -> V_33 ) ;
F_9 ( & V_7 -> V_32 ) ;
}
...
bool V_36
= F_30 ( V_7 -> V_33 , V_23 ) ;
F_31 ( V_35 -> V_37 -> V_38 -> V_39 ) ;
V_35 -> V_27 = F_24 ( V_7 ) ;
V_10 = F_32 ( V_35 -> V_27 , V_35 -> V_40 , V_35 -> V_41 ,
V_35 -> type , V_35 -> V_8 ,
V_35 ) ;
if ( V_10 < 0 ) {
F_33 ( V_35 -> V_37 -> V_38 -> V_39 ) ;
return V_10 ;
}
...
struct V_34
* F_38 ( T_4 (* V_40)( int V_27 , void * V_44 ) ,
...
T_5 V_49 ;
struct V_34 * V_35 ;
V_35 = F_39 ( sizeof *V_35 , V_13 ) ;
if ( V_35 == NULL )
return NULL ;
va_start ( V_49 , V_48 ) ;
V_35 -> V_8 = F_40 ( V_13 , V_48 , V_49 ) ;
va_end ( V_49 ) ;
if ( V_35 -> V_8 == NULL ) {
F_41 ( V_35 ) ;
return NULL ;
...
struct V_6 * F_57 ( const char * V_48 , ... )
{
T_5 V_49 ;
struct V_6 * V_7 ;
V_7 = F_58 ( sizeof *V_7 , V_13 ) ;
if ( V_7 ) {
int V_21 ;
V_7 -> V_2 . type = & V_65 ;
V_7 -> V_2 . V_66 = & V_67 ;
...
int F_67 ( struct V_47 * V_37 )
{
return F_29 ( V_37 -> V_7 ,
V_37 -> V_74 ) ;
}
int F_68 ( struct V_47 * V_37 )
{
return F_34 ( V_37 -> V_7 ,
V_37 -> V_74 ) ;
}
