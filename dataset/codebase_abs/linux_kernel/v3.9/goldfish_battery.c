...
V_8 -> V_54 = F_15 ( & V_38 -> V_41 , V_40 -> V_55 , V_40 -> V_56 - V_40 -> V_55 + 1 ) ;
if ( V_8 -> V_54 == NULL ) {
F_14 ( & V_38 -> V_41 , L_4 ) ;
return - V_43 ;
}
V_8 -> V_26 = F_16 ( V_38 , 0 ) ;
if ( V_8 -> V_26 < 0 ) {
F_14 ( & V_38 -> V_41 , L_5 ) ;
return - V_53 ;
}
V_10 = F_17 ( & V_38 -> V_41 , V_8 -> V_26 , F_5 ,
V_57 , V_38 -> V_48 , V_8 ) ;
if ( V_10 )
return V_10 ;
V_10 = F_18 ( & V_38 -> V_41 , & V_8 -> V_9 ) ;
if ( V_10 )
return V_10 ;
V_10 = F_18 ( & V_38 -> V_41 , & V_8 -> V_15 ) ;
if ( V_10 ) {
F_19 ( & V_8 -> V_9 ) ;
return V_10 ;
}
