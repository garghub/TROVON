...
static void F_94 ( struct V_268 * V_269 )
{
V_269 -> V_270 = * ( T_4 * ) ( F_95 ( V_269 ) - 2 ) ;
V_269 -> V_271 = V_272 ;
F_96 ( V_269 , V_269 -> V_116 - 2 ) ;
}
static int F_97 ( struct V_1 * V_2 , struct V_268 * V_269 )
{
while ( V_269 -> V_116 > 0 ) {
T_2 V_273 , V_274 ;
struct V_268 * V_275 ;
...
F_94 ( V_269 ) ;
F_96 ( V_269 , V_269 -> V_116 - 4 ) ;
V_269 -> V_292 = V_51 + sizeof( struct V_268 ) ;
return 1 ;
}
V_275 = F_99 ( V_269 , V_293 ) ;
if ( F_4 ( ! V_275 ) ) {
F_5 ( V_2 -> V_14 , L_90 ) ;
return 0 ;
}
...
static T_2 F_102 ( struct V_268 * V_269 )
{
T_4 V_294 = ( T_4 ) F_103 ( V_269 ) ;
T_4 V_295 = V_294 + V_269 -> V_296 ;
return ( V_295 << 16 ) | V_294 ;
}
static struct V_268 * F_104 ( struct V_1 * V_2 ,
struct V_268 * V_269 , T_8 V_55 )
{
bool V_270 = V_269 -> V_271 == V_297 ;
int V_298 = V_270 ? V_210 : V_299 ;
T_2 V_300 , V_301 ;
F_3 ( F_105 ( V_269 ) -> V_302 ) ;
if ( F_106 ( V_269 ) < V_298 ) {
struct V_268 * V_303 = F_107 ( V_269 ,
V_298 , 0 , V_55 ) ;
F_108 ( V_269 ) ;
V_269 = V_303 ;
if ( ! V_269 )
...
if ( V_270 ) {
if ( V_269 -> V_116 <= 45 ) {
long V_304 = F_103 ( V_269 ) ;
T_9 V_305 = F_109 ( V_269 -> V_4 + V_304 ,
V_269 -> V_116 - V_304 , 0 ) ;
* ( ( V_306 * ) ( V_269 -> V_4 + V_304
+ V_269 -> V_296 ) ) = F_110 ( V_305 ) ;
V_270 = false ;
} else {
T_2 V_307 = F_102 ( V_269 ) ;
F_111 ( V_269 , 4 ) ;
F_8 ( & V_307 ) ;
...
static int F_112 ( struct V_1 * V_2 , int V_311 )
{
struct V_53 * V_54 = (struct V_53 * ) ( V_2 -> V_4 [ 0 ] ) ;
