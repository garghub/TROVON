...
V_105 += V_117 -> V_105 ;
V_106 += V_117 -> V_106 ;
F_67 ( V_84 , & V_109 , & V_110 ) ;
V_112 += V_117 -> V_112 ;
}
V_100 = F_68 ( V_84 , V_21 ) ;
...
F_76 ( V_2 , ' ' , V_102 ) ;
F_76 ( V_2 , ' ' , V_89 ) ;
F_76 ( V_2 , ' ' , V_87 ? F_78 ( V_87 ) : 0 ) ;
F_76 ( V_2 , ' ' , V_113 ) ;
F_76 ( V_2 , ' ' , V_87 ? ( V_101 ? V_87 -> V_128 : 1 ) : 0 ) ;
F_76 ( V_2 , ' ' , V_87 ? ( V_101 ? V_87 -> V_129 : 1 ) : 0 ) ;
F_76 ( V_2 , ' ' , ( V_101 && V_87 ) ? V_87 -> V_130 : 0 ) ;
F_76 ( V_2 , ' ' , V_91 ) ;
F_76 ( V_2 , ' ' , V_90 ) ;
F_76 ( V_2 , ' ' , V_84 -> V_60 . signal . V_117 [ 0 ] & 0x7fffffffUL ) ;
F_76 ( V_2 , ' ' , V_84 -> V_62 . V_117 [ 0 ] & 0x7fffffffUL ) ;
F_76 ( V_2 , ' ' , V_97 . V_117 [ 0 ] & 0x7fffffffUL ) ;
F_76 ( V_2 , ' ' , V_98 . V_117 [ 0 ] & 0x7fffffffUL ) ;
F_76 ( V_2 , ' ' , V_92 ) ;
F_76 ( V_2 , ' ' , 0 ) ;
F_76 ( V_2 , ' ' , 0 ) ;
F_75 ( V_2 , ' ' , V_84 -> V_131 ) ;
...
struct V_86 * V_87 = F_51 ( V_84 ) ;
if ( V_87 ) {
V_11 = F_84 ( V_87 , & V_143 , & V_144 , & V_145 , & V_142 ) ;
F_53 ( V_87 ) ;
}
F_76 ( V_2 , 0 , V_11 ) ;
F_76 ( V_2 , ' ' , V_142 ) ;
...
static struct V_22 *
F_85 ( struct V_146 * V_146 , struct V_22 * V_147 , T_5 V_148 )
{
struct V_3 * V_149 , * V_84 ;
struct V_22 * V_22 = NULL ;
F_86 ( & V_150 ) ;
V_149 = F_87 ( F_88 ( V_146 ) , V_151 ) ;
if ( ! V_149 )
goto V_152;
if ( V_147 ) {
V_84 = F_87 ( V_147 , V_151 ) ;
if ( V_84 && V_84 -> V_32 == V_149 &&
! ( F_89 ( & V_84 -> V_153 ) ) ) {
if ( F_90 ( & V_84 -> V_153 , & V_149 -> V_154 ) )
goto V_152;
V_84 = F_91 ( & V_84 -> V_153 ,
struct V_3 , V_153 ) ;
V_22 = F_92 ( F_93 ( V_84 ) ) ;
goto V_152;
}
}
F_94 (task, &start->children, sibling) {
if ( V_148 -- == 0 ) {
V_22 = F_92 ( F_93 ( V_84 ) ) ;
break;
}
...
static int F_96 ( struct V_1 * V_155 , void * V_156 )
{
...
static void * F_97 ( struct V_1 * V_155 , T_5 * V_148 )
{
return F_85 ( V_155 -> V_157 , NULL , * V_148 ) ;
}
static void * F_98 ( struct V_1 * V_155 , void * V_156 , T_5 * V_148 )
{
struct V_22 * V_22 ;
V_22 = F_85 ( V_155 -> V_157 , V_156 , * V_148 + 1 ) ;
F_61 ( V_156 ) ;
++ * V_148 ;
return V_22 ;
}
static void F_99 ( struct V_1 * V_155 , void * V_156 )
{
F_61 ( V_156 ) ;
}
static int F_100 ( struct V_146 * V_146 , struct V_160 * V_160 )
{
struct V_1 * V_2 ;
int V_161 ;
V_161 = F_101 ( V_160 , & V_162 ) ;
if ( V_161 )
return V_161 ;
V_2 = V_160 -> V_163 ;
V_2 -> V_157 = V_146 ;
...
int F_102 ( struct V_146 * V_146 , struct V_160 * V_160 )
{
F_103 ( V_146 , V_160 ) ;
return 0 ;
}
