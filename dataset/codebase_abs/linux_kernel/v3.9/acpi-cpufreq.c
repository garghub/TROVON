...
if ( V_42 -> V_73 . V_137 != V_42 -> V_138 . V_137 ) {
V_86 = - V_87 ;
goto V_136;
}
switch ( V_42 -> V_73 . V_137 ) {
case V_139 :
if ( V_5 . V_6 == V_10 &&
V_5 . V_121 == 0xf ) {
F_12 ( L_22 ) ;
...
V_40 -> V_48 = F_78 ( sizeof( struct V_141 ) *
( V_42 -> V_45 + 1 ) , V_116 ) ;
if ( ! V_40 -> V_48 ) {
V_86 = - V_115 ;
goto V_136;
...
V_33 -> V_142 . V_143 = 0 ;
for ( V_43 = 0 ; V_43 < V_42 -> V_45 ; V_43 ++ ) {
if ( ( V_42 -> V_46 [ V_43 ] . V_143 * 1000 ) >
V_33 -> V_142 . V_143 )
V_33 -> V_142 . V_143 =
V_42 -> V_46 [ V_43 ] . V_143 * 1000 ;
}
if ( V_42 -> V_73 . V_137 == V_140 &&
...
if ( V_86 )
goto V_144;
if ( V_42 -> V_46 [ 0 ] . V_96 * 1000 != V_33 -> V_142 . V_145 )
F_66 (KERN_WARNING FW_WARN L_27 ) ;
switch ( V_42 -> V_73 . V_137 ) {
case V_139 :
V_33 -> V_146 = F_52 ( V_40 , V_33 -> V_1 ) ;
break;
case V_140 :
V_128 . V_147 = F_43 ;
V_33 -> V_146 = F_43 ( V_1 ) ;
...
( T_1 ) V_42 -> V_46 [ V_43 ] . V_152 ,
( T_1 ) V_42 -> V_46 [ V_43 ] . V_143 ) ;
...
struct V_160 * * V_161 ;
F_12 ( L_35 ) ;
for ( V_161 = V_162 ; * V_161 != NULL ; V_161 ++ )
;
if ( V_161 [ 1 ] == NULL )
* V_161 = & V_163 ;
}
