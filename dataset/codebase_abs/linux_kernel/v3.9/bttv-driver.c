...
static int F_235 ( struct V_557 * V_8 , const struct V_561 * V_562 )
{
int V_489 ;
unsigned char V_563 ;
struct V_9 * V_10 ;
...
static void F_269 ( struct V_557 * V_557 )
{
...
static int F_276 ( struct V_557 * V_557 , T_13 V_269 )
{
struct V_594 * V_506 = F_270 ( V_557 ) ;
struct V_9 * V_10 = F_271 ( V_506 ) ;
struct V_516 V_596 ;
