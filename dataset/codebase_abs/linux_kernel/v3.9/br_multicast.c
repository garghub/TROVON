...
int F_158 ( struct V_26 * V_27 , unsigned long V_216 )
{
int V_65 = - V_217 ;
F_155 ( & V_27 -> V_50 ) ;
if ( ! F_30 ( V_27 -> V_51 ) )
...
int F_159 ( struct V_120 * V_48 , unsigned long V_216 )
{
...
int F_161 ( struct V_26 * V_27 , unsigned long V_216 )
{
int V_65 = 0 ;
struct V_12 * V_13 ;
F_155 ( & V_27 -> V_50 ) ;
...
int F_162 ( struct V_26 * V_27 , unsigned long V_216 )
{
V_216 = ! ! V_216 ;
F_155 ( & V_27 -> V_50 ) ;
if ( V_27 -> V_145 == V_216 )
...
int F_163 ( struct V_26 * V_27 , unsigned long V_216 )
{
int V_65 = - V_217 ;
V_16 V_37 ;
struct V_12 * V_13 ;
