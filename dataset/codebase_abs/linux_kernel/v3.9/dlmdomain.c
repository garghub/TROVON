...
{
union V_103 V_104 ;
V_104 . V_105 = F_89 ( V_102 ) ;
* V_101 = V_104 . V_101 ;
}
static int F_90 ( struct V_60 * V_61 , T_2 V_21 , void * V_62 ,
void * * V_63 )
{
struct V_106 * V_107 ;
struct V_100 V_101 = {
...
static int F_93 ( struct V_60 * V_61 , T_2 V_21 , void * V_62 ,
void * * V_63 )
{
struct V_128 * assert ;
struct V_14 * V_15 = NULL ;
...
V_137 = F_96 ( V_146 , V_132 / V_145 ) ;
V_137 = F_97 ( V_131 , ( T_1 ) V_137 ) ;
V_135 = V_131 ;
...
static int F_98 ( struct V_14 * V_15 , unsigned long * V_115 )
{
...
goto V_144;
V_130 = F_99 ( sizeof( struct V_129 ) , V_9 ) ;
if ( ! V_130 ) {
V_37 = - V_148 ;
F_100 ( V_37 ) ;
goto V_144;
...
static int F_101 ( struct V_60 * V_61 , T_2 V_21 ,
void * V_62 , void * * V_63 )
{
struct V_129 * V_130 ;
struct V_14 * V_15 = NULL ;
...
V_77 = F_94 ( V_15 , V_130 , V_131 , sizeof( V_130 -> V_134 ) ) ;
V_144:
if ( V_152 )
F_27 ( & V_15 -> V_26 ) ;
F_27 ( & V_36 ) ;
...
static int F_102 ( struct V_14 * V_15 , struct V_153 * V_154 )
{
struct V_155 * V_131 ;
struct V_156 * V_133 ;
int V_10 , V_138 ;
...
static int F_106 ( struct V_14 * V_15 , unsigned long * V_115 )
{
...
if ( F_67 ( V_115 , V_74 , 0 ) >= V_74 )
goto V_144;
V_154 = F_99 ( sizeof( struct V_153 ) , V_9 ) ;
if ( ! V_154 ) {
V_37 = - V_148 ;
F_100 ( V_37 ) ;
goto V_144;
...
static int F_107 ( struct V_60 * V_61 , T_2 V_21 ,
void * V_62 , void * * V_63 )
{
struct V_153 * V_154 ;
struct V_14 * V_15 = NULL ;
...
static int F_108 ( struct V_60 * V_61 , T_2 V_21 , void * V_62 ,
void * * V_63 )
{
struct V_170 * V_171 ;
struct V_14 * V_15 = NULL ;
...
F_11 ( 0 , L_93 , V_15 ) ;
V_186 = F_99 ( sizeof( * V_186 ) , V_9 ) ;
if ( ! V_186 ) {
V_77 = - V_148 ;
F_100 ( V_77 ) ;
goto V_144;
}
F_117 ( V_15 -> V_179 , sizeof( V_15 -> V_179 ) ) ;
F_26 ( & V_15 -> V_26 ) ;
...
if ( V_15 -> V_82 . V_83 > 1 ||
V_15 -> V_82 . V_84 > 0 ) {
V_77 = F_106 ( V_15 , V_186 -> V_188 ) ;
if ( V_77 ) {
F_100 ( V_77 ) ;
goto V_144;
}
V_77 = F_98 ( V_15 , V_186 -> V_188 ) ;
if ( V_77 ) {
F_100 ( V_77 ) ;
goto V_144;
}
}
F_114 ( V_15 , V_186 -> V_188 ) ;
F_26 ( & V_36 ) ;
V_15 -> V_38 = V_39 ;
V_15 -> V_44 ++ ;
F_27 ( & V_36 ) ;
...
{
F_118 ( V_15 -> V_19 , & V_15 -> V_189 ) ;
F_118 ( V_15 -> V_19 , & V_15 -> V_190 ) ;
F_119 ( & V_15 -> V_191 ) ;
}
static int F_120 ( struct V_14 * V_15 )
{
int V_77 ;
F_11 ( 0 , L_97 ) ;
F_121 ( & V_15 -> V_190 , V_192 ,
V_193 , V_15 , V_194 ) ;
V_77 = F_122 ( V_15 -> V_19 , & V_15 -> V_190 ) ;
if ( V_77 )
goto V_144;
F_121 ( & V_15 -> V_189 , V_195 ,
V_196 , V_15 , V_197 ) ;
V_77 = F_122 ( V_15 -> V_19 , & V_15 -> V_189 ) ;
if ( V_77 )
goto V_144;
V_77 = F_123 ( V_198 , V_15 -> V_80 ,
sizeof( struct V_199 ) ,
V_200 ,
V_15 , NULL , & V_15 -> V_191 ) ;
if ( V_77 )
goto V_144;
V_77 = F_123 ( V_201 , V_15 -> V_80 ,
sizeof( struct V_202 ) ,
V_203 ,
V_15 , V_204 ,
& V_15 -> V_191 ) ;
if ( V_77 )
goto V_144;
V_77 = F_123 ( V_205 , V_15 -> V_80 ,
sizeof( struct V_206 ) ,
V_207 ,
V_15 , NULL , & V_15 -> V_191 ) ;
if ( V_77 )
goto V_144;
V_77 = F_123 ( V_208 , V_15 -> V_80 ,
V_209 ,
V_210 ,
V_15 , NULL , & V_15 -> V_191 ) ;
if ( V_77 )
goto V_144;
V_77 = F_123 ( V_211 , V_15 -> V_80 ,
V_212 ,
V_213 ,
V_15 , NULL , & V_15 -> V_191 ) ;
if ( V_77 )
goto V_144;
V_77 = F_123 ( V_214 , V_15 -> V_80 ,
V_215 ,
V_216 ,
V_15 , NULL , & V_15 -> V_191 ) ;
if ( V_77 )
goto V_144;
V_77 = F_123 ( V_87 , V_15 -> V_80 ,
sizeof( struct V_65 ) ,
F_68 ,
V_15 , NULL , & V_15 -> V_191 ) ;
if ( V_77 )
goto V_144;
V_77 = F_123 ( V_217 , V_15 -> V_80 ,
sizeof( struct V_218 ) ,
V_219 ,
V_15 , NULL , & V_15 -> V_191 ) ;
if ( V_77 )
goto V_144;
V_77 = F_123 ( V_220 , V_15 -> V_80 ,
sizeof( struct V_221 ) ,
V_222 ,
V_15 , NULL , & V_15 -> V_191 ) ;
if ( V_77 )
goto V_144;
V_77 = F_123 ( V_223 , V_15 -> V_80 ,
V_224 ,
V_225 ,
V_15 , NULL , & V_15 -> V_191 ) ;
if ( V_77 )
goto V_144;
V_77 = F_123 ( V_226 , V_15 -> V_80 ,
sizeof( struct V_227 ) ,
V_228 ,
V_15 , NULL , & V_15 -> V_191 ) ;
if ( V_77 )
goto V_144;
V_77 = F_123 ( V_229 , V_15 -> V_80 ,
sizeof( struct V_230 ) ,
V_231 ,
V_15 , NULL , & V_15 -> V_191 ) ;
if ( V_77 )
goto V_144;
V_77 = F_123 ( V_232 , V_15 -> V_80 ,
sizeof( struct V_233 ) ,
V_234 ,
V_15 , NULL , & V_15 -> V_191 ) ;
if ( V_77 )
goto V_144;
V_77 = F_123 ( V_235 , V_15 -> V_80 ,
sizeof( struct V_236 ) ,
V_237 ,
V_15 , NULL , & V_15 -> V_191 ) ;
if ( V_77 )
goto V_144;
V_77 = F_123 ( V_238 , V_15 -> V_80 ,
sizeof( struct V_239 ) ,
V_240 ,
V_15 , NULL , & V_15 -> V_191 ) ;
if ( V_77 )
goto V_144;
V_77 = F_123 ( V_85 , V_15 -> V_80 ,
sizeof( struct V_65 ) ,
F_61 ,
V_15 , NULL , & V_15 -> V_191 ) ;
if ( V_77 )
...
static struct V_14 * F_133 ( const char * V_32 ,
T_2 V_80 )
{
int V_10 ;
int V_37 ;
struct V_14 * V_15 = NULL ;
V_15 = F_99 ( sizeof( * V_15 ) , V_9 ) ;
if ( ! V_15 ) {
F_100 ( - V_148 ) ;
goto V_92;
}
V_15 -> V_19 = F_134 ( V_32 , V_9 ) ;
if ( V_15 -> V_19 == NULL ) {
F_100 ( - V_148 ) ;
F_7 ( V_15 ) ;
V_15 = NULL ;
...
F_140 ( & V_15 -> V_29 ) ;
F_140 ( & V_15 -> V_249 ) ;
F_140 ( & V_15 -> V_118 . V_250 ) ;
F_140 ( & V_15 -> V_118 . V_251 ) ;
F_140 ( & V_15 -> V_118 . V_252 ) ;
F_140 ( & V_15 -> V_253 ) ;
F_140 ( & V_15 -> V_191 ) ;
F_140 ( & V_15 -> V_93 ) ;
V_15 -> V_118 . V_30 = 0 ;
...
F_142 ( & V_15 -> V_269 [ V_10 ] , 0 ) ;
F_142 ( & V_15 -> V_270 [ V_10 ] , 0 ) ;
}
F_139 ( & V_15 -> V_271 ) ;
F_140 ( & V_15 -> V_272 ) ;
F_143 ( & V_15 -> V_273 , V_274 ) ;
F_144 ( & V_15 -> V_43 ) ;
V_15 -> V_38 = V_117 ;
F_140 ( & V_15 -> V_275 ) ;
F_11 ( 0 , L_104 ,
F_145 ( & V_15 -> V_43 . V_276 ) ) ;
V_92:
return V_15 ;
}
...
struct V_14 * F_146 ( const char * V_32 ,
T_2 V_80 ,
struct V_95 * V_124 )
{
int V_37 ;
...
{
int V_77 = 0 ;
V_77 = F_123 ( V_180 , V_151 ,
sizeof( struct V_106 ) ,
F_90 ,
NULL , NULL , & V_284 ) ;
if ( V_77 )
goto V_144;
V_77 = F_123 ( V_183 , V_151 ,
sizeof( struct V_128 ) ,
F_93 ,
NULL , NULL , & V_284 ) ;
if ( V_77 )
goto V_144;
V_77 = F_123 ( V_173 , V_151 ,
sizeof( struct V_170 ) ,
F_108 ,
NULL , NULL , & V_284 ) ;
if ( V_77 )
goto V_144;
V_77 = F_123 ( V_150 , V_151 ,
sizeof( struct V_129 ) ,
F_101 ,
NULL , NULL , & V_284 ) ;
if ( V_77 )
goto V_144;
V_77 = F_123 ( V_169 , V_151 ,
sizeof( struct V_153 ) ,
F_107 ,
NULL , NULL , & V_284 ) ;
V_144:
...
void F_156 ( struct V_14 * V_15 ,
struct V_285 * V_286 )
{
F_157 ( & V_287 ) ;
F_148 ( & V_286 -> V_288 , & V_15 -> V_275 ) ;
F_158 ( & V_287 ) ;
}
void F_159 ( struct V_285 * V_286 )
{
F_157 ( & V_287 ) ;
F_40 ( & V_286 -> V_288 ) ;
F_158 ( & V_287 ) ;
