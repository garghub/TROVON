...
V_153 = V_1 -> V_13 ;
V_151 = 0 ;
V_150 = F_14 ( ( (struct V_102 * ) V_154 ) -> V_1 ) ;
while ( ! error && ! V_151 && V_146 -> V_155 < V_1 -> V_97 ) {
V_156:
if ( V_146 -> V_157 != V_1 -> V_116 ) {
for ( V_39 = 0 ;
V_39 < V_1 -> V_97 && V_39 < V_100 ; ) {
if ( ! V_39 ) {
V_39 += V_132 ;
continue;
}
...
V_100 = V_39 ;
V_146 -> V_155 = V_100 ;
V_146 -> V_157 = V_1 -> V_116 ;
}
while ( ! error && V_146 -> V_155 < V_1 -> V_97 ) {
if ( V_146 -> V_155 == 0 ) {
error = V_148 ( V_147 , L_6 , 1 , 0 , V_1 -> V_28 ,
V_158 ) ;
if ( error )
break;
V_151 ++ ;
error = V_148 ( V_147 , L_7 , 2 , 0 , V_150 ,
V_158 ) ;
if ( error )
break;
V_151 ++ ;
V_146 -> V_155 = V_100 = V_132 ;
continue;
}
V_103 = (struct V_102 * ) ( V_154 + V_100 ) ;
...
V_100 += F_94 ( V_103 -> V_105 ,
V_92 ) ;
if ( F_14 ( V_103 -> V_1 ) ) {
T_5 V_159 = V_146 -> V_157 ;
error = V_148 ( V_147 , V_103 -> V_42 ,
V_103 -> V_106 ,
V_146 -> V_155 ,
F_14 ( V_103 -> V_1 ) ,
F_127 ( V_153 , V_103 -> V_160 ) ) ;
if ( error )
break;
if ( V_159 != V_146 -> V_157 )
goto V_156;
V_151 ++ ;
}
V_146 -> V_155 += F_94 ( V_103 -> V_105 ,
V_92 ) ;
}
V_100 = 0 ;
}
...
struct V_90 * F_128 ( struct V_1 * V_1 ,
struct V_102 * * V_161 ,
int * V_162 )
{
struct V_4 V_5 ;
...
if ( * V_162 )
return NULL ;
* V_161 = (struct V_102 * ) F_8 ( & V_5 ) -> V_49 ;
return V_5 . V_30 ;
}
int F_129 ( T_3 * V_51 , struct V_1 * V_163 ,
struct V_1 * V_1 )
{
int V_58 , V_92 = V_31 ;
struct V_4 V_5 ;
...
struct V_90 * F_132 ( struct V_1 * V_98 ,
const struct V_164 * V_110 ,
struct V_102 * * V_165 ,
int * V_149 )
{
int V_58 ;
...
if ( ( void * ) V_167 - ( ( void * ) F_8 ( & V_5 ) -> V_49 ) <
V_31 ) {
V_99 = ( void * ) F_8 ( & V_5 ) -> V_49 +
V_132 ;
V_92 = V_31 -
...
if ( V_113 )
goto V_25;
V_113 = F_135 ( V_51 , V_98 , V_167 , V_30 ,
V_99 , V_92 , 0 ) ;
if ( V_113 )
goto V_25;
F_136 ( V_30 , L_8 ) ;
...
if ( V_99 )
* V_99 = V_169 ;
return (struct V_102 * ) ( V_169 + V_100 ) ;
}
int F_138 ( struct V_1 * V_98 , int * V_149 )
{
int V_113 , V_92 ;
struct V_4 V_5 ;
void * V_169 ;
...
int F_140 ( T_3 * V_51 , struct V_1 * V_1 )
{
int V_58 ;
F_42 ( & F_2 ( V_1 ) -> V_29 ) ;
V_58 = F_44 ( V_51 , V_1 ) ;
...
if ( error )
goto V_25;
V_173 = V_5 . V_30 -> V_177 << V_1 -> V_13 -> V_178 ;
V_173 += ( char * ) F_8 ( & V_5 ) - V_5 . V_30 -> V_130 ;
V_173 += F_142 ( struct V_10 , V_49 ) ;
V_174 = F_53 ( V_1 ) ;
if ( V_173 )
error = F_143 ( V_171 , 0 , V_173 ,
V_174 , V_71 ) ;
F_20 ( V_5 . V_30 ) ;
V_25:
F_19 ( & F_2 ( V_1 ) -> V_29 ) ;
...
void F_145 ( struct V_1 * V_1 , int * V_172 )
{
T_3 * V_51 ;
int V_92 , V_54 , V_72 ;
T_1 V_97 ;
