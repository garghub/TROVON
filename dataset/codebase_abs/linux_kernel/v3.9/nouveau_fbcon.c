...
V_28 = V_81 ? NULL : V_9 -> V_29 ;
if ( V_28 && V_12 -> V_21 >= V_22 ) {
V_13 = F_35 ( V_65 , F_36 ( V_28 -> V_82 ) -> V_83 ,
& V_6 -> V_63 . V_84 ) ;
if ( V_13 ) {
F_30 ( V_9 , L_4 , V_13 ) ;
V_28 = NULL ;
...
F_37 ( & V_10 -> V_85 ) ;
V_2 = F_38 ( 0 , & V_69 -> V_10 ) ;
if ( ! V_2 ) {
V_13 = - V_86 ;
goto V_87;
}
V_13 = F_39 ( & V_2 -> V_88 , 256 , 0 ) ;
if ( V_13 ) {
V_13 = - V_86 ;
goto V_87;
}
V_2 -> V_7 = V_6 ;
F_40 ( V_10 , & V_6 -> V_63 , & V_67 , V_65 ) ;
V_63 = & V_6 -> V_63 ;
V_61 = & V_63 -> V_89 ;
V_6 -> V_44 . V_61 = V_61 ;
V_6 -> V_44 . V_45 = V_2 ;
strcpy ( V_2 -> V_90 . V_91 , L_5 ) ;
if ( V_81 )
V_2 -> V_17 = V_92 | V_18 ;
else
V_2 -> V_17 = V_92 | V_93 |
...
V_2 -> V_17 |= V_96 ;
V_2 -> V_56 = & V_97 ;
V_2 -> V_90 . V_98 = V_65 -> V_99 . V_100 . V_101 . V_89 +
V_65 -> V_99 . V_100 . V_101 . V_102 ;
V_2 -> V_90 . V_103 = V_70 ;
V_2 -> V_104 = F_41 ( V_63 -> V_65 ) ;
V_2 -> V_105 = V_70 ;
F_42 ( V_2 , V_61 -> V_73 [ 0 ] , V_61 -> V_106 ) ;
F_43 ( V_2 , & V_6 -> V_44 , V_59 -> V_107 , V_59 -> V_108 ) ;
F_8 ( & V_10 -> V_85 ) ;
if ( V_28 ) {
V_13 = - V_16 ;
if ( V_12 -> V_21 < V_22 )
...
F_25 ( V_10 , V_6 ) ;
F_47 ( V_9 , L_6 ,
V_63 -> V_89 . V_48 , V_63 -> V_89 . V_51 ,
V_65 -> V_99 . V_102 , V_65 ) ;
F_48 ( V_10 -> V_69 , V_2 ) ;
return 0 ;
V_87:
F_8 ( & V_10 -> V_85 ) ;
...
void
F_49 ( struct V_43 * V_10 )
{
struct V_8 * V_9 = V_8 ( V_10 ) ;
F_50 ( & V_9 -> V_6 -> V_44 ) ;
}
static int
F_51 ( struct V_43 * V_10 , struct V_5 * V_6 )
{
...
if ( V_63 -> V_65 ) {
F_55 ( V_63 -> V_65 ) ;
F_56 ( V_63 -> V_65 , & V_63 -> V_84 ) ;
F_57 ( V_63 -> V_65 -> V_111 ) ;
V_63 -> V_65 = NULL ;
}
F_58 ( & V_6 -> V_44 ) ;
F_59 ( & V_63 -> V_89 ) ;
...
{
struct V_8 * V_9 = V_8 ( V_10 ) ;
struct V_63 * V_112 = V_63 ( V_9 -> V_12 ) ;
struct V_5 * V_6 ;
int V_113 ;
int V_13 ;
if ( ! V_10 -> V_114 . V_115 )
return 0 ;
V_6 = F_62 ( sizeof( struct V_5 ) , V_116 ) ;
if ( ! V_6 )
return - V_86 ;
V_6 -> V_10 = V_10 ;
V_9 -> V_6 = V_6 ;
V_6 -> V_44 . V_117 = & V_118 ;
...
F_65 ( & V_6 -> V_44 ) ;
if ( V_112 -> V_119 . V_70 <= 32 * 1024 * 1024 )
V_113 = 8 ;
else
if ( V_112 -> V_119 . V_70 <= 64 * 1024 * 1024 )
V_113 = 16 ;
else
V_113 = 32 ;
F_66 ( V_10 ) ;
...
{
struct V_8 * V_9 = V_8 ( V_10 ) ;
V_9 -> V_6 -> V_120 = V_9 -> V_6 -> V_44 . V_45 -> V_17 ;
V_9 -> V_6 -> V_44 . V_45 -> V_17 |= V_18 ;
}
void F_70 ( struct V_43 * V_10 )
{
struct V_8 * V_9 = V_8 ( V_10 ) ;
V_9 -> V_6 -> V_44 . V_45 -> V_17 = V_9 -> V_6 -> V_120 ;
}
