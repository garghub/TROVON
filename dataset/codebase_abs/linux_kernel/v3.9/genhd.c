...
struct V_2 * V_3 = F_85 ( V_86 ) ;
if ( V_3 -> V_122 )
return V_3 -> V_122 ( V_3 , V_121 ) ;
return NULL ;
}
static int F_131 ( struct V_27 * V_28 , void * V_103 )
{
struct V_2 * V_123 = V_103 ;
struct V_10 V_11 ;
struct V_1 * V_124 ;
char V_57 [ V_93 ] ;
int V_125 ;
F_9 ( & V_11 , V_123 , V_16 ) ;
while ( ( V_124 = F_10 ( & V_11 ) ) ) {
V_125 = F_132 () ;
F_133 ( V_125 , V_124 ) ;
F_134 () ;
F_20 ( V_28 , L_24
L_25 ,
F_38 ( F_89 ( V_124 ) ) , F_40 ( F_89 ( V_124 ) ) ,
V_72 ( V_123 , V_124 -> V_4 , V_57 ) ,
F_135 ( V_124 , V_126 [ V_127 ] ) ,
F_135 ( V_124 , V_128 [ V_127 ] ) ,
F_135 ( V_124 , V_129 [ V_127 ] ) ,
F_136 ( F_135 ( V_124 , V_130 [ V_127 ] ) ) ,
F_135 ( V_124 , V_126 [ V_131 ] ) ,
F_135 ( V_124 , V_128 [ V_131 ] ) ,
F_135 ( V_124 , V_129 [ V_131 ] ) ,
F_136 ( F_135 ( V_124 , V_130 [ V_131 ] ) ) ,
F_137 ( V_124 ) ,
F_136 ( F_135 ( V_124 , V_132 ) ) ,
F_136 ( F_135 ( V_124 , V_133 ) )
) ;
}
F_13 ( & V_11 ) ;
return 0 ;
...
{
return F_104 ( V_107 , & V_134 ) ;
}
static int T_4 F_139 ( void )
{
F_140 ( L_26 , 0 , NULL , & V_135 ) ;
F_140 ( L_27 , 0 , NULL , & V_136 ) ;
return 0 ;
}
...
if ( ! V_3 -> V_143 )
return NULL ;
V_142 = V_3 -> V_143 -> V_142 ;
if ( V_142 && ! F_150 ( V_142 ) )
return NULL ;
...
static void F_154 ( struct V_2 * V_144 , int V_145 )
{
char V_146 [] = L_28 ;
char * V_147 [] = { V_146 , NULL } ;
if ( ! V_145 )
V_146 [ 8 ] = '0' ;
F_155 ( & F_45 ( V_144 ) -> V_64 , V_148 , V_147 ) ;
}
void F_156 ( struct V_67 * V_68 , int V_149 )
{
V_68 -> V_150 -> V_151 = V_149 ;
}
void F_157 ( struct V_2 * V_3 , int V_149 )
{
struct V_10 V_11 ;
struct V_1 * V_5 ;
if ( V_3 -> V_24 . V_151 != V_149 ) {
F_154 ( V_3 , V_149 ) ;
V_3 -> V_24 . V_151 = V_149 ;
}
F_9 ( & V_11 , V_3 , V_19 ) ;
while ( ( V_5 = F_10 ( & V_11 ) ) )
V_5 -> V_151 = V_149 ;
...
return;
F_19 ( & V_154 -> V_161 ) ;
F_165 ( & V_154 -> V_162 , V_12 ) ;
V_160 = ! V_154 -> V_163 ++ ;
F_166 ( & V_154 -> V_162 , V_12 ) ;
if ( V_160 )
F_167 ( & V_3 -> V_154 -> V_164 ) ;
F_21 ( & V_154 -> V_161 ) ;
}
static void F_168 ( struct V_2 * V_3 , bool V_165 )
{
struct V_153 * V_154 = V_3 -> V_154 ;
unsigned long V_166 ;
unsigned long V_12 ;
F_165 ( & V_154 -> V_162 , V_12 ) ;
if ( F_69 ( V_154 -> V_163 <= 0 ) )
goto V_167;
if ( -- V_154 -> V_163 )
goto V_167;
V_166 = F_162 ( V_3 ) ;
F_169 ( & V_154 -> V_164 . V_168 , V_166 / 4 ) ;
if ( V_165 )
F_170 ( V_169 , & V_154 -> V_164 , 0 ) ;
else if ( V_166 )
F_170 ( V_169 , & V_154 -> V_164 , V_166 ) ;
V_167:
F_166 ( & V_154 -> V_162 , V_12 ) ;
}
...
void F_172 ( struct V_2 * V_3 , unsigned int V_170 )
{
struct V_153 * V_154 = V_3 -> V_154 ;
if ( ! V_154 )
return;
...
V_154 -> V_171 |= V_170 ;
if ( ! V_154 -> V_163 )
F_174 ( V_169 , & V_154 -> V_164 , 0 ) ;
F_175 ( & V_154 -> V_162 ) ;
}
unsigned int F_176 ( struct V_2 * V_3 , unsigned int V_170 )
{
const struct V_172 * V_173 = V_3 -> V_143 ;
struct V_153 * V_154 = V_3 -> V_154 ;
unsigned int V_174 ;
unsigned int V_171 = V_170 ;
if ( ! V_154 ) {
if ( ( V_170 & V_175 ) &&
V_173 -> V_176 && V_173 -> V_176 ( V_3 ) )
return V_175 ;
return 0 ;
}
F_164 ( V_3 ) ;
...
F_175 ( & V_154 -> V_162 ) ;
F_177 ( V_154 , & V_171 ) ;
F_168 ( V_3 , V_154 -> V_171 ? true : false ) ;
F_173 ( & V_154 -> V_162 ) ;
V_174 = V_154 -> V_174 & V_170 ;
V_154 -> V_174 &= ~ V_170 ;
F_175 ( & V_154 -> V_162 ) ;
F_69 ( V_171 & V_170 ) ;
return V_174 ;
}
static void F_178 ( struct V_177 * V_178 )
{
struct V_179 * V_164 = F_179 ( V_178 ) ;
struct V_153 * V_154 = F_180 ( V_164 , struct V_153 , V_164 ) ;
F_177 ( V_154 , & V_154 -> V_171 ) ;
}
static void F_177 ( struct V_153 * V_154 ,
unsigned int * V_180 )
{
struct V_2 * V_3 = V_154 -> V_3 ;
char * V_147 [ F_23 ( V_181 ) + 1 ] = { } ;
unsigned int V_171 = * V_180 ;
unsigned int V_157 ;
unsigned long V_166 ;
int V_182 = 0 , V_22 ;
V_157 = V_3 -> V_143 -> V_183 ( V_3 , V_171 ) ;
F_173 ( & V_154 -> V_162 ) ;
V_157 &= ~ V_154 -> V_174 ;
V_154 -> V_174 |= V_157 ;
* V_180 &= ~ V_171 ;
V_166 = F_162 ( V_3 ) ;
if ( ! V_154 -> V_163 && V_166 )
F_170 ( V_169 , & V_154 -> V_164 , V_166 ) ;
F_175 ( & V_154 -> V_162 ) ;
for ( V_22 = 0 ; V_22 < F_23 ( V_181 ) ; V_22 ++ )
if ( V_157 & V_3 -> V_157 & ( 1 << V_22 ) )
V_147 [ V_182 ++ ] = V_181 [ V_22 ] ;
if ( V_182 )
F_155 ( & F_45 ( V_3 ) -> V_64 , V_148 , V_147 ) ;
}
static T_6 F_181 ( unsigned int V_157 , char * V_57 )
{
const char * V_184 = L_11 ;
T_6 V_100 = 0 ;
int V_22 ;
for ( V_22 = 0 ; V_22 < F_23 ( V_185 ) ; V_22 ++ )
if ( V_157 & ( 1 << V_22 ) ) {
...
{
struct V_2 * V_3 = F_85 ( V_86 ) ;
return F_181 ( V_3 -> V_157 , V_57 ) ;
}
static T_6 F_183 ( struct V_65 * V_86 ,
struct V_111 * V_112 , char * V_57 )
{
struct V_2 * V_3 = F_85 ( V_86 ) ;
return F_181 ( V_3 -> V_158 , V_57 ) ;
}
...
{
struct V_2 * V_3 = F_85 ( V_86 ) ;
return sprintf ( V_57 , L_31 , V_3 -> V_154 -> V_156 ) ;
}
static T_6 F_185 ( struct V_65 * V_86 ,
struct V_111 * V_112 ,
const char * V_57 , T_7 V_186 )
{
struct V_2 * V_3 = F_85 ( V_86 ) ;
long V_166 ;
if ( ! V_186 || ! sscanf ( V_57 , L_32 , & V_166 ) )
return - V_118 ;
if ( V_166 < 0 && V_166 != - 1 )
return - V_118 ;
F_164 ( V_3 ) ;
V_3 -> V_154 -> V_156 = V_166 ;
F_168 ( V_3 , true ) ;
return V_186 ;
}
static int F_186 ( const char * V_187 ,
const struct V_188 * V_189 )
{
struct V_153 * V_154 ;
int V_39 ;
V_39 = F_187 ( V_187 , V_189 ) ;
if ( V_39 < 0 )
return V_39 ;
F_19 ( & V_190 ) ;
...
if ( ! V_3 -> V_154 )
return;
if ( F_195 ( & F_45 ( V_3 ) -> V_64 , V_192 ) < 0 )
F_190 ( L_34 ,
V_3 -> V_72 ) ;
F_19 ( & V_190 ) ;
F_196 ( & V_3 -> V_154 -> V_191 , & V_153 ) ;
F_21 ( & V_190 ) ;
F_168 ( V_3 , true ) ;
}
...
F_164 ( V_3 ) ;
F_19 ( & V_190 ) ;
F_197 ( & V_3 -> V_154 -> V_191 ) ;
F_21 ( & V_190 ) ;
F_198 ( & F_45 ( V_3 ) -> V_64 , V_192 ) ;
}
static void F_126 ( struct V_2 * V_3 )
{
F_69 ( V_3 -> V_154 && V_3 -> V_154 -> V_163 != 1 ) ;
F_27 ( V_3 -> V_154 ) ;
}
