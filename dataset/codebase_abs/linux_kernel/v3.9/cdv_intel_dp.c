...
static int
F_32 ( struct V_117 * V_41 , struct V_1 * V_2 , const char * V_118 )
{
struct V_4 * V_5 = V_2 -> V_6 ;
int V_85 ;
F_8 ( L_18 , V_118 ) ;
...
( ( V_150 . V_151 - 1 ) << V_164 ) |
V_150 . V_152 ) ;
F_10 ( F_45 ( V_162 ) , V_150 . V_153 ) ;
F_10 ( F_46 ( V_162 ) , V_150 . V_154 ) ;
F_10 ( F_47 ( V_162 ) , V_150 . V_155 ) ;
}
}
static void
...
V_5 -> V_165 |= V_5 -> V_168 ;
if ( V_129 -> V_169 & V_170 )
V_5 -> V_165 |= V_171 ;
if ( V_129 -> V_169 & V_172 )
V_5 -> V_165 |= V_173 ;
V_5 -> V_165 |= V_174 ;
switch ( V_5 -> V_138 ) {
case 1 :
...
if ( V_5 -> V_178 )
V_5 -> V_165 |= V_179 ;
memset ( V_5 -> V_180 , 0 , V_181 ) ;
V_5 -> V_180 [ 0 ] = V_5 -> V_15 ;
V_5 -> V_180 [ 1 ] = V_5 -> V_138 ;
if ( V_5 -> V_8 [ V_9 ] >= 0x11 &&
( V_5 -> V_8 [ V_10 ] & V_182 ) ) {
V_5 -> V_180 [ 1 ] |= V_183 ;
V_5 -> V_165 |= V_184 ;
...
static T_1
F_59 ( T_1 V_197 [ V_198 ] ,
int V_199 )
{
return V_197 [ V_199 - V_196 ] ;
}
static T_1
F_60 ( T_1 V_197 [ V_198 ] ,
int V_200 )
{
int V_56 = V_201 + ( V_200 >> 1 ) ;
int V_202 = ( ( V_200 & 1 ) ?
V_203 :
V_204 ) ;
T_1 V_205 = F_59 ( V_197 , V_56 ) ;
return ( ( V_205 >> V_202 ) & 3 ) << V_206 ;
}
static T_1
F_61 ( T_1 V_197 [ V_198 ] ,
int V_200 )
{
int V_56 = V_201 + ( V_200 >> 1 ) ;
int V_202 = ( ( V_200 & 1 ) ?
...
T_1 V_210 = 0 ;
int V_200 ;
for ( V_200 = 0 ; V_200 < V_5 -> V_138 ; V_200 ++ ) {
T_1 V_211 = F_60 ( V_5 -> V_197 , V_200 ) ;
T_1 V_212 = F_61 ( V_5 -> V_197 , V_200 ) ;
if ( V_211 > V_57 )
V_57 = V_211 ;
if ( V_212 > V_210 )
V_210 = V_212 ;
...
V_5 -> V_217 [ V_200 ] = V_57 | V_210 ;
}
static T_1
F_63 ( T_1 V_197 [ V_198 ] ,
int V_200 )
{
int V_56 = V_196 + ( V_200 >> 1 ) ;
int V_202 = ( V_200 & 1 ) * 4 ;
T_1 V_205 = F_59 ( V_197 , V_56 ) ;
return ( V_205 >> V_202 ) & 0xf ;
}
static bool
F_64 ( T_1 V_197 [ V_198 ] , int V_138 )
{
int V_200 ;
T_1 V_218 ;
for ( V_200 = 0 ; V_200 < V_138 ; V_200 ++ ) {
V_218 = F_63 ( V_197 , V_200 ) ;
if ( ( V_218 & V_219 ) == 0 )
return false ;
}
return true ;
...
T_1 V_218 ;
int V_200 ;
V_220 = F_59 ( V_5 -> V_197 ,
V_221 ) ;
if ( ( V_220 & V_222 ) == 0 )
return false ;
for ( V_200 = 0 ; V_200 < V_5 -> V_138 ; V_200 ++ ) {
V_218 = F_63 ( V_5 -> V_197 , V_200 ) ;
if ( ( V_218 & V_223 ) != V_223 )
return false ;
}
return true ;
}
...
if ( V_85 != V_5 -> V_138 ) {
F_8 ( L_25 ,
V_5 -> V_217 [ 0 ] , V_5 -> V_138 ) ;
return false ;
}
return true ;
}
static void
F_68 ( struct V_1 * V_2 , T_1 V_228 )
{
struct V_21 * V_22 = V_2 -> V_23 . V_22 ;
struct V_4 * V_5 = V_2 -> V_6 ;
struct V_229 * V_230 ;
...
F_8 ( L_26 ) ;
F_70 ( V_22 ) ;
F_71 ( V_22 , V_230 -> V_237 , 0x0505313A ) ;
F_71 ( V_22 , V_230 -> V_238 , 0x43406055 ) ;
V_233 = ( V_231 + V_232 ) * 2 ;
if ( V_232 == 1 && V_231 == 1 ) {
F_71 ( V_22 , V_230 -> V_239 , 0x055738954 ) ;
} else
F_71 ( V_22 , V_230 -> V_239 , V_240 [ V_233 ] ) ;
if ( ( V_231 + V_232 ) == V_241 )
F_71 ( V_22 , V_230 -> V_242 , 0x70802040 ) ;
else
F_71 ( V_22 , V_230 -> V_242 , 0x40802040 ) ;
F_71 ( V_22 , V_230 -> V_238 , 0xc3406055 ) ;
F_71 ( V_22 , V_230 -> V_243 , 0x1f030040 ) ;
V_233 = 2 * V_232 + 1 ;
F_71 ( V_22 , V_230 -> V_244 , V_240 [ V_233 ] ) ;
return;
}
static void
F_54 ( struct V_1 * V_2 )
...
V_5 -> V_180 [ 0 ] ,
V_5 -> V_180 [ 1 ] ) ;
if ( ! F_66 ( V_2 , V_248 , V_252 ) ) {
F_8 ( L_30 ) ;
}
F_68 ( V_2 , V_5 -> V_217 [ 0 ] ) ;
F_67 ( V_2 , V_252 ) ;
F_26 ( 200 ) ;
if ( ! F_58 ( V_2 ) )
break;
F_8 ( L_31 ,
V_5 -> V_197 [ 0 ] , V_5 -> V_197 [ 1 ] , V_5 -> V_197 [ 2 ] ,
V_5 -> V_197 [ 3 ] , V_5 -> V_197 [ 4 ] , V_5 -> V_197 [ 5 ] ) ;
if ( F_64 ( V_5 -> V_197 , V_5 -> V_138 ) ) {
F_8 ( L_32 ) ;
V_246 = true ;
break;
}
for ( V_56 = 0 ; V_56 < V_5 -> V_138 ; V_56 ++ )
if ( ( V_5 -> V_217 [ V_56 ] & V_214 ) == 0 )
break;
if ( V_56 == V_5 -> V_138 )
break;
if ( ( V_5 -> V_217 [ 0 ] & V_236 ) == V_245 ) {
++ V_247 ;
if ( V_247 == 5 )
break;
} else
V_247 = 0 ;
V_245 = V_5 -> V_217 [ 0 ] & V_236 ;
F_62 ( V_2 ) ;
}
if ( ! V_246 ) {
F_8 ( L_33 , V_5 -> V_217 [ 0 ] ) ;
}
V_5 -> V_165 = V_165 ;
}
static void
...
struct V_4 * V_5 = V_2 -> V_6 ;
T_3 V_165 = V_5 -> V_165 ;
if ( ( F_9 ( V_5 -> V_64 ) & V_186 ) == 0 )
return;
F_8 ( L_2 ) ;
{
V_165 &= ~ V_249 ;
F_10 ( V_5 -> V_64 , V_165 | V_258 ) ;
}
F_9 ( V_5 -> V_64 ) ;
F_11 ( 17 ) ;
F_10 ( V_5 -> V_64 , V_165 & ~ V_186 ) ;
F_9 ( V_5 -> V_64 ) ;
}
static enum V_259
F_73 ( struct V_1 * V_2 )
...
static enum V_259
F_74 ( struct V_40 * V_41 , bool V_262 )
{
struct V_1 * V_2 = F_21 ( V_41 ) ;
struct V_4 * V_5 = V_2 -> V_6 ;
enum V_259 V_68 ;
struct V_263 * V_263 = NULL ;
int V_50 = F_1 ( V_2 ) ;
V_5 -> V_178 = false ;
if ( V_50 )
F_7 ( V_2 ) ;
...
if ( V_5 -> V_264 ) {
V_5 -> V_178 = V_5 -> V_264 > 0 ;
} else {
V_263 = F_75 ( V_41 , & V_5 -> V_99 ) ;
if ( V_263 ) {
V_5 -> V_178 = F_76 ( V_263 ) ;
F_77 ( V_263 ) ;
}
}
if ( V_50 )
...
struct V_4 * V_5 = V_2 -> V_6 ;
int V_85 ;
V_85 = F_85 ( & V_41 -> V_23 , V_269 , V_270 ) ;
if ( V_85 )
return V_85 ;
if ( V_269 == V_6 -> V_271 ) {
int V_56 = V_270 ;
