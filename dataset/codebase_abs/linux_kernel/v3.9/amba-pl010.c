...
V_4 -> V_2 . line = V_152 ;
V_4 -> V_79 = V_79 ;
V_4 -> V_77 = V_79 -> V_79 . V_163 ;
V_141 [ V_152 ] = V_4 ;
F_73 ( V_79 , V_4 ) ;
V_133 = F_74 ( & V_164 , & V_4 -> V_2 ) ;
if ( V_133 ) {
F_73 ( V_79 , NULL ) ;
V_141 [ V_152 ] = NULL ;
F_75 ( V_4 -> V_86 ) ;
...
static int F_78 ( struct V_148 * V_79 )
{
struct V_3 * V_4 = F_79 ( V_79 ) ;
int V_152 ;
F_73 ( V_79 , NULL ) ;
F_80 ( & V_164 , & V_4 -> V_2 ) ;
for ( V_152 = 0 ; V_152 < F_66 ( V_141 ) ; V_152 ++ )
...
static int F_81 ( struct V_148 * V_79 , T_4 V_40 )
{
struct V_3 * V_4 = F_79 ( V_79 ) ;
if ( V_4 )
F_82 ( & V_164 , & V_4 -> V_2 ) ;
...
static int F_83 ( struct V_148 * V_79 )
{
struct V_3 * V_4 = F_79 ( V_79 ) ;
if ( V_4 )
F_84 ( & V_164 , & V_4 -> V_2 ) ;
