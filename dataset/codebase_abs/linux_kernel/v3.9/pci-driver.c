...
int F_87 ( struct V_1 * V_2 , struct V_90 * V_91 ,
const char * V_92 )
{
...
static int F_97 ( struct V_4 * V_34 , struct V_103 * V_104 )
{
struct V_33 * V_105 ;
if ( ! V_34 )
return - V_32 ;
...
if ( ! V_105 )
return - V_32 ;
if ( F_98 ( V_104 , L_6 , V_105 -> V_7 ) )
return - V_14 ;
if ( F_98 ( V_104 , L_7 , V_105 -> V_3 , V_105 -> V_4 ) )
return - V_14 ;
if ( F_98 ( V_104 , L_8 , V_105 -> V_106 ,
V_105 -> V_107 ) )
return - V_14 ;
if ( F_98 ( V_104 , L_9 , F_99 ( V_105 ) ) )
return - V_14 ;
if ( F_98 ( V_104 , L_10 ,
V_105 -> V_3 , V_105 -> V_4 ,
