...
F_2 ( & V_12 ) ;
V_18 = F_83 ( & V_20 , V_13 , 0 , 256 , V_200 ) ;
F_3 ( & V_12 ) ;
if ( V_18 < 0 )
return V_18 ;
V_8 -> V_5 = F_84 ( 1 << V_19 ) ;
...
F_86 ( V_8 -> V_157 , F_65 ) ;
F_87 ( V_8 -> V_157 , V_226 ) ;
F_88 ( V_8 -> V_157 , V_232 ) ;
...
static int F_95 ( struct V_99 * V_13 )
{
struct V_7 * V_8 = F_27 ( V_13 ) ;
return ( V_8 -> V_240 == 1 ) ;
}
...
if ( V_10 )
goto V_241;
V_10 = F_99 ( & V_13 -> V_42 . V_242 , & V_8 -> V_207 ) ;
if ( V_10 )
goto V_241;
V_10 = F_82 ( V_13 ) ;
if ( ! V_10 ) {
...
F_100 ( & V_13 -> V_42 . V_242 , & V_8 -> V_207 ) ;
V_241:
F_97 ( V_13 , NULL ) ;
F_94 ( V_8 ) ;
F_7 ( V_8 ) ;
...
static void F_101 ( struct V_99 * V_13 )
{
struct V_7 * V_8 = F_27 ( V_13 ) ;
unsigned long V_160 ;
F_55 ( & V_8 -> V_161 , V_160 ) ;
...
static int F_104 ( struct V_99 * V_13 , T_6 V_246 )
{
struct V_7 * V_8 = F_27 ( V_13 ) ;
unsigned long V_160 ;
F_55 ( & V_8 -> V_161 , V_160 ) ;
...
static int F_105 ( struct V_99 * V_13 )
{
struct V_7 * V_8 = F_27 ( V_13 ) ;
unsigned long V_160 ;
int V_10 = 0 ;
...
unsigned char V_45 ;
F_2 ( & V_156 -> V_249 ) ;
V_247 = F_79 ( sizeof( struct V_7 ) , V_200 ) ;
if ( ! V_247 ) {
V_10 = - V_152 ;
goto V_250;
}
