...
static void F_41 ( char V_44 , const char * V_45 )
{
if ( V_44 == 's' ) {
F_42 ( 0x41000000 ) ;
} else {
...
static enum V_48 F_49 ( struct V_46 * V_47 )
{
struct V_50 * V_51 = F_46 ( V_47 ,
struct V_50 , V_47 ) ;
unsigned long V_14 ;
...
if ( ! F_38 () )
return - V_54 ;
for ( V_29 = 0 ; V_29 < F_51 ( V_55 ) ; V_29 ++ ) {
struct V_50 * V_51 ;
V_51 = F_52 ( sizeof( * V_51 ) , V_56 ) ;
if ( ! V_51 )
break;
