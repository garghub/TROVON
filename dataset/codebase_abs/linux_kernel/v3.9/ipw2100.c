...
V_469 ++ ;
V_4 = F_201 ( V_469 , & V_469 , 16 ) ;
} else
V_4 = F_201 ( V_469 , & V_469 , 10 ) ;
if ( V_469 == V_15 )
F_31 ( L_199 , V_15 ) ;
else
V_44 = V_4 ;
...
V_6 -> V_150 -> V_500 = V_4 ;
F_31 ( L_205 , V_6 -> V_150 -> V_500 ) ;
}
F_31 ( L_45 ) ;
return V_14 ;
}
static T_9 F_207 ( struct V_472 * V_318 , struct V_473 * V_474 ,
char * V_15 )
{
struct V_5 * V_6 = F_186 ( V_318 ) ;
...
static int F_208 ( struct V_5 * V_6 , int V_501 )
{
if ( ( V_501 ? 1 : 0 ) ==
( V_6 -> V_49 & V_206 ? 1 : 0 ) )
return 0 ;
...
static int F_211 ( struct V_5 * V_6 , int V_382 )
{
...
static void F_214 ( struct V_5 * V_6 , struct V_374 * V_502 )
{
F_31 ( L_42 ) ;
if ( ! V_502 )
return;
...
T_8 V_469 ;
F_31 ( L_42 ) ;
V_63 = F_213 ( V_6 , & V_6 -> V_390 , V_504 ) ;
if ( V_63 ) {
F_62 ( L_215 ,
V_6 -> V_33 -> V_51 ) ;
return V_63 ;
}
V_6 -> V_505 = F_219 ( V_506 ,
sizeof( struct V_60 ) ,
V_313 ) ;
if ( ! V_6 -> V_505 ) {
F_214 ( V_6 , & V_6 -> V_390 ) ;
...
int V_19 , V_40 , V_63 = - V_31 ;
F_31 ( L_42 ) ;
V_63 = F_213 ( V_6 , & V_6 -> V_339 , V_327 ) ;
if ( V_63 ) {
F_31 ( L_217 ) ;
return V_63 ;
}
V_63 = F_211 ( V_6 , V_327 ) ;
if ( V_63 ) {
F_31 ( L_218 ) ;
F_214 ( V_6 , & V_6 -> V_339 ) ;
return V_63 ;
...
F_31 ( L_221 , V_6 -> V_33 -> V_514 ) ;
return 0 ;
}
static int F_228 ( struct V_5 * V_6 , int V_288 )
{
struct V_56 V_57 = {
. V_56 = V_515 ,
. V_88 = 0 ,
...
static int F_229 ( struct V_5 * V_6 , T_1 V_517 ,
int V_288 )
{
struct V_56 V_57 = {
. V_56 = V_518 ,
...
static int F_233 ( struct V_5 * V_6 , T_1 V_539 ,
int V_288 )
{
struct V_56 V_57 = {
. V_56 = V_540 ,
...
static int F_234 ( struct V_5 * V_6 , int V_545 )
{
struct V_56 V_57 = {
. V_56 = V_546 ,
. V_88 = 0 ,
...
static int F_237 ( struct V_5 * V_6 , T_1 V_554 )
{
struct V_56 V_57 = {
. V_56 = V_555 ,
. V_88 = 0 ,
...
static int F_238 ( struct V_5 * V_6 , T_1 V_559 )
{
struct V_56 V_57 = {
. V_56 = V_560 ,
. V_88 = 0 ,
...
static int F_240 ( struct V_5 * V_6 , T_3 * V_274 ,
int V_288 )
{
struct V_56 V_57 = {
. V_56 = V_564 ,
...
static int F_244 ( struct V_5 * V_6 , T_1 V_588 )
{
struct V_56 V_57 = {
. V_56 = V_553 ,
. V_88 = 0 ,
...
static int F_254 ( struct V_5 * V_6 , int V_288 )
{
...
F_253 ( V_6 , V_6 -> V_150 -> V_493 . V_495 , 1 ) ;
}
V_63 =
F_248 ( V_6 ,
V_6 -> V_150 -> V_190 .
...
static void F_255 ( struct V_262 * V_263 )
{
struct V_5 * V_6 =
...
#ifdef F_154
if ( V_6 -> V_150 -> V_198 == V_199 ) {
V_63 = F_230 ( V_6 , V_6 -> V_245 , V_288 ) ;
if ( V_63 )
return V_63 ;
F_31 ( L_45 ) ;
return 0 ;
...
if ( V_63 )
return - V_70 ;
V_63 = F_228 ( V_6 , V_288 ) ;
if ( V_63 )
return V_63 ;
V_63 = F_229 ( V_6 , V_6 -> V_150 -> V_198 , V_288 ) ;
if ( V_63 )
return V_63 ;
if ( V_6 -> V_150 -> V_198 == V_434 ) {
V_63 = F_230 ( V_6 , V_6 -> V_245 , V_288 ) ;
...
if ( V_63 )
return V_63 ;
V_63 = F_233 ( V_6 , V_6 -> V_544 , V_288 ) ;
if ( V_63 )
return V_63 ;
V_63 = F_234 ( V_6 , V_547 ) ;
if ( V_63 )
return V_63 ;
V_63 = F_237 ( V_6 , V_6 -> V_558 ) ;
if ( V_63 )
return V_63 ;
if ( V_6 -> V_187 & V_628 )
V_274 = V_6 -> V_274 ;
...
static int F_257 ( struct V_1 * V_2 , void * V_469 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
...
F_267 ( V_81 -> V_652 , V_653 , sizeof( V_81 -> V_652 ) ) ;
F_267 ( V_81 -> V_121 , V_654 , sizeof( V_81 -> V_121 ) ) ;
F_268 ( V_6 , V_650 , sizeof( V_650 ) ) ;
F_269 ( V_6 , V_651 , sizeof( V_651 ) ) ;
snprintf ( V_81 -> V_655 , sizeof( V_81 -> V_655 ) , L_241 ,
V_650 , V_6 -> V_156 , V_651 ) ;
F_267 ( V_81 -> V_656 , F_270 ( V_6 -> V_261 ) ,
sizeof( V_81 -> V_656 ) ) ;
}
...
static void F_272 ( struct V_262 * V_263 )
{
struct V_5 * V_6 =
...
static struct V_1 * F_274 ( struct V_261 * V_261 ,
void T_12 * V_7 )
{
struct V_5 * V_6 ;
struct V_1 * V_2 ;
...
F_280 ( & V_6 -> V_295 , F_255 ) ;
F_280 ( & V_6 -> V_286 , V_689 ) ;
F_280 ( & V_6 -> V_182 , F_272 ) ;
F_280 ( & V_6 -> V_216 , F_273 ) ;
F_280 ( & V_6 -> V_297 , F_118 ) ;
F_281 ( & V_6 -> V_460 , ( void (*) ( unsigned long ) )
F_169 , ( unsigned long ) V_6 ) ;
V_6 -> V_215 = 1 ;
V_6 -> V_181 = 1 ;
return V_2 ;
}
static int F_282 ( struct V_261 * V_261 ,
...
if ( ( V_4 & 0x0000ff00 ) != 0 )
F_292 ( V_261 , 0x40 , V_4 & 0xffff00ff ) ;
F_293 ( V_261 , V_695 ) ;
if ( ! F_25 ( V_2 ) ) {
F_27 (KERN_WARNING DRV_NAME
L_256 ) ;
...
V_692 = 2 ;
F_84 ( & V_6 -> V_266 ) ;
F_31 ( L_262 , V_2 -> V_51 , F_270 ( V_261 ) ) ;
V_63 = F_297 ( & V_261 -> V_2 . V_697 , & V_698 ) ;
if ( V_63 )
goto V_71;
if ( ! ( V_6 -> V_49 & V_487 ) ) {
if ( F_83 ( V_6 ) ) {
...
static int F_310 ( struct V_261 * V_261 )
{
struct V_5 * V_6 = F_306 ( V_261 ) ;
struct V_1 * V_2 = V_6 -> V_33 ;
int V_63 ;
...
static void F_313 ( struct V_261 * V_261 )
{
struct V_5 * V_6 = F_306 ( V_261 ) ;
F_99 ( V_6 ) ;
F_290 ( V_261 ) ;
...
F_323 ( L_272 , V_711 -> V_712 ) ;
V_63 = F_230 ( V_6 , V_711 -> V_712 , 0 ) ;
}
V_623:
F_85 ( & V_6 -> V_266 ) ;
return V_63 ;
...
if ( F_331 ( V_218 -> V_219 . V_631 ) ||
F_332 ( V_218 -> V_219 . V_631 ) ) {
F_323 ( L_277 ) ;
V_6 -> V_187 &= ~ V_628 ;
...
V_63 = F_240 ( V_6 , V_218 -> V_219 . V_631 , 0 ) ;
F_323 ( L_278 , V_218 -> V_219 . V_631 ) ;
V_623:
F_85 ( & V_6 -> V_266 ) ;
return V_63 ;
}
...
struct V_5 * V_6 = F_2 ( V_2 ) ;
int V_63 = 0 , V_147 ;
if ( F_208 ( V_6 , V_218 -> V_754 . V_775 ) )
return - V_776 ;
if ( V_6 -> V_150 -> V_198 != V_434 )
return 0 ;
...
V_63 = F_238 ( V_6 , V_218 -> V_559 . V_147 ) ;
F_323 ( L_296 ,
V_218 -> V_559 . V_147 ) ;
goto V_623;
}
...
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
return F_350 ( V_6 -> V_150 , V_81 , V_218 , V_708 ) ;
}
...
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
return F_352 ( V_6 -> V_150 , V_81 , V_218 , V_596 ) ;
}
...
V_63 = F_234 ( V_6 , F_235 ( V_6 -> V_548 ) ) ;
F_323 ( L_304 , V_6 -> V_548 ) ;
V_623:
F_85 ( & V_6 -> V_266 ) ;
return V_63 ;
}
...
return - V_31 ;
if ( V_218 -> V_37 . V_287 ) {
V_15 = F_358 ( V_708 , V_218 -> V_37 . V_287 , V_239 ) ;
if ( V_15 == NULL )
return - V_240 ;
F_129 ( V_150 -> V_643 ) ;
V_150 -> V_643 = V_15 ;
...
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
return F_363 ( V_6 -> V_150 , V_81 , V_218 , V_708 ) ;
}
...
V_315 = V_673 ;
if ( F_235 ( V_6 -> V_548 ) != V_315 )
V_63 = F_234 ( V_6 , V_315 ) ;
V_623:
F_85 ( & V_6 -> V_266 ) ;
return V_63 ;
}
...
static struct V_820 * F_375 ( struct V_1 * V_2 )
{
enum {
V_821 = 30 ,
V_822 = 60 ,
...
static int F_376 ( struct V_119 * V_845 )
{
struct V_846 * V_847 =
(struct V_846 * ) V_845 -> V_848 -> V_37 ;
if ( F_377 ( V_847 -> V_121 ) != V_849 ) {
...
V_202 = F_379 ( & V_845 -> V_848 , V_853 , & V_6 -> V_261 -> V_2 ) ;
if ( V_202 < 0 ) {
F_27 (KERN_ERR DRV_NAME L_67
L_328 ,
