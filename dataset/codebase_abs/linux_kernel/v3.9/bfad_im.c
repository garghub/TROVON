...
int error = 1 ;
F_47 ( & V_119 ) ;
error = F_48 ( & V_120 , V_52 , 0 , 0 , V_121 ) ;
if ( error < 0 ) {
F_49 ( & V_119 ) ;
F_50 ( V_122 L_11 ) ;
goto V_63;
...
V_52 -> V_49 -> V_136 =
V_138 ;
error = F_52 ( V_52 -> V_49 , V_118 , & V_13 -> V_139 -> V_118 ) ;
if ( error ) {
F_50 ( V_122 L_12 , error ) ;
goto V_140;
}
return 0 ;
V_140:
...
V_124:
F_47 ( & V_119 ) ;
F_54 ( & V_120 , V_52 -> V_123 ) ;
F_49 ( & V_119 ) ;
V_63:
return error ;
}
void
F_55 ( struct V_12 * V_13 , struct V_51 * V_52 )
{
F_2 ( V_13 , V_13 -> V_141 ) ;
F_17 ( V_65 , V_13 , V_66 , L_13 ,
V_52 -> V_49 -> V_67 ) ;
F_56 ( V_52 -> V_49 ) ;
F_57 ( V_52 -> V_49 ) ;
F_53 ( V_52 -> V_49 ) ;
...
static void
F_58 ( struct V_142 * V_143 )
{
struct V_51 * V_52 =
F_59 ( V_143 , struct V_51 , V_144 ) ;
if ( V_52 -> V_104 -> V_134 != V_135 ) {
V_52 -> V_57 |= V_116 ;
F_60 ( V_52 -> V_145 ) ;
}
...
T_5
F_61 ( struct V_12 * V_13 , struct V_103 * V_104 )
{
int V_59 = V_74 ;
struct V_51 * V_52 ;
...
void
F_63 ( struct V_12 * V_13 , struct V_103 * V_104 )
{
...
struct V_48 *
F_51 ( struct V_51 * V_52 , struct V_12 * V_13 )
{
struct V_164 * V_165 ;
if ( V_52 -> V_104 -> V_134 == V_135 )
V_165 = & V_166 ;
...
return F_78 ( V_165 , sizeof( unsigned long ) ) ;
}
void
F_79 ( struct V_12 * V_13 , struct V_51 * V_52 )
{
if ( ! ( V_52 -> V_57 & V_116 ) )
F_80 ( V_13 -> V_96 -> V_114 ) ;
F_55 ( V_52 -> V_13 , V_52 ) ;
F_64 ( V_52 ) ;
F_67 ( V_52 ) ;
}
void
F_77 ( struct V_109 * V_96 )
{
if ( V_96 && V_96 -> V_114 ) {
F_80 ( V_96 -> V_114 ) ;
F_81 ( V_96 -> V_114 ) ;
...
F_2 ( V_13 , 0 ) ;
snprintf ( V_96 -> V_173 , V_174 , L_14 ,
V_13 -> V_141 ) ;
V_96 -> V_114 = F_82 ( V_96 -> V_173 ) ;
if ( ! V_96 -> V_114 )
return V_79 ;
return V_74 ;
}
static int
F_83 ( struct V_91 * V_92 )
{
if ( V_92 -> V_175 )
F_84 ( V_92 , V_34 ) ;
else
...
{
struct V_188 * V_189 = F_98 ( F_99 ( V_92 ) ) ;
struct V_14 * V_15 =
(struct V_14 * ) V_189 -> V_190 ;
struct V_191 * V_77 = V_15 -> V_17 -> V_73 -> V_77 ;
if ( ! V_189 || F_100 ( V_189 ) )
return - V_197 ;
if ( F_101 ( V_77 ) == V_204 ) {
if ( V_92 -> V_84 == 0 ) {
V_92 -> V_205 |= V_206 |
...
void
F_104 ( struct V_51 * V_52 )
{
struct V_48 * V_31 = V_52 -> V_49 ;
struct V_12 * V_13 = V_52 -> V_13 ;
struct V_103 * V_104 = V_52 -> V_104 ;
char V_226 [ V_227 ] ;
struct V_228 * V_229 = F_105 ( & V_13 -> V_77 ) ;
F_106 ( V_31 ) =
F_107 ( ( F_108 ( V_104 -> V_230 ) ) ) ;
F_109 ( V_31 ) =
F_107 ( ( F_110 ( V_104 -> V_230 ) ) ) ;
F_111 ( V_31 ) = F_112 ( & V_13 -> V_77 ) ;
F_113 ( V_31 ) = V_231 ;
memset ( F_114 ( V_31 ) , 0 ,
sizeof( F_114 ( V_31 ) ) ) ;
if ( V_232 & V_233 )
...
V_227 ) ;
sprintf ( F_115 ( V_31 ) , L_15 , V_226 ) ;
F_116 ( V_31 ) = F_102 ( & V_13 -> V_77 ) ;
F_117 ( V_31 ) = V_229 -> V_239 . V_240 ;
}
static void
F_118 ( struct V_51 * V_52 , struct V_16 * V_17 )
{
struct V_241 V_242 ;
struct V_188 * V_188 ;
struct V_14 * V_15 ;
V_242 . V_243 =
F_107 ( F_119 ( & V_17 -> V_80 ) ) ;
V_242 . V_244 =
F_107 ( F_40 ( & V_17 -> V_80 ) ) ;
V_242 . V_245 =
F_120 ( F_41 ( & V_17 -> V_80 ) ) ;
V_242 . V_246 = V_247 ;
V_17 -> V_188 = V_188 =
F_121 ( V_52 -> V_49 , 0 , & V_242 ) ;
if ( ! V_188 )
return;
V_188 -> V_248 =
F_122 ( & V_17 -> V_80 ) ;
V_188 -> V_249 = F_123 ( & V_17 -> V_80 ) ;
V_15 = V_188 -> V_190 ;
V_15 -> V_17 = V_17 ;
V_242 . V_246 |= V_250 ;
if ( V_242 . V_246 != V_247 )
F_124 ( V_188 , V_242 . V_246 ) ;
if ( ( V_188 -> V_251 != - 1 )
&& ( V_188 -> V_251 < V_90 ) )
...
{
struct V_16 * V_17 = F_59 ( V_143 , struct V_16 ,
V_99 ) ;
...
int V_59 ;
int V_255 = 0 ;
struct V_188 * V_189 = F_98 ( F_99 ( V_11 -> V_30 ) ) ;
V_59 = F_100 ( V_189 ) ;
if ( V_59 ) {
V_11 -> V_26 = V_59 ;
V_208 ( V_11 ) ;
...
V_56 = F_129 ( & V_13 -> V_77 , (struct V_2 * ) V_11 ,
V_17 -> V_73 , V_255 ) ;
if ( ! V_56 ) {
F_50 ( V_122 L_21 ) ;
F_19 ( & V_13 -> V_61 , V_57 ) ;
