...
static int T_4 F_63 ( struct V_72 * V_73 )
{
T_1 V_51 ;
int V_8 ;
if ( ! V_13 -> V_14 ) {
...
struct V_113 V_30 ;
memset ( & V_30 , 0 , sizeof( struct V_113 ) ) ;
V_30 . type = V_114 ;
V_30 . V_115 = V_3 - 1 ;
V_116 = F_69 ( L_13 , NULL ,
NULL , & V_117 ,
& V_30 ) ;
if ( F_70 ( V_116 ) )
return F_71 ( V_116 ) ;
...
if ( V_36 )
goto V_122;
if ( V_13 -> V_86 && ( F_63 ( V_120 ) < 0 ) ) {
V_36 = - V_4 ;
goto V_122;
}
V_36 = F_75 ( & V_120 -> V_33 . V_123 ,
& V_124 ) ;
if ( V_36 )
goto V_125;
if ( ! V_13 -> V_38 ) {
if ( V_27 )
V_36 = F_76 ( & V_120 -> V_33 ,
& V_101 ) ;
if ( V_36 )
goto V_125;
} else {
...
F_85 ( & V_120 -> V_33 . V_123 , & V_124 ) ;
if ( ! V_13 -> V_38 && V_27 )
F_86 ( & V_120 -> V_33 , & V_101 ) ;
F_87 ( V_120 ) ;
F_82 ( & V_118 ) ;
F_83 ( V_116 ) ;
if ( V_13 -> V_38 ) {
