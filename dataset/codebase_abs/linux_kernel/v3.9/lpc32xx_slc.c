...
return - V_146 ;
if ( F_25 ( V_2 -> V_11 -> V_33 ) &&
F_77 ( V_2 -> V_11 -> V_33 , L_24 ) ) {
F_41 ( & V_138 -> V_79 , L_25 ) ;
return - V_130 ;
}
F_27 ( V_2 ) ;
...
V_67 = F_84 ( V_21 , NULL , & V_142 , V_2 -> V_11 -> V_186 ,
V_2 -> V_11 -> V_187 ) ;
if ( ! V_67 )
return V_67 ;
F_85 ( V_21 ) ;
...
static int F_93 ( struct V_137 * V_138 , T_6 V_188 )
{
T_1 V_4 ;
struct V_1 * V_2 = F_91 ( V_138 ) ;
V_4 = F_19 ( F_3 ( V_2 -> V_6 ) ) ;
