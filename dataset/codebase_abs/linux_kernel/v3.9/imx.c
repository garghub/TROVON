...
if ( F_17 ( V_2 ) ) {
struct V_135 * V_136 ;
V_136 = V_2 -> V_8 . V_137 -> V_138 ;
V_2 -> V_131 = V_136 -> V_131 ;
V_2 -> V_133 = V_136 -> V_133 ;
V_2 -> V_42 = V_136 -> V_139 ;
if ( V_136 -> V_140 )
V_136 -> V_140 ( 1 ) ;
}
return 0 ;
...
static void
F_48 ( struct V_7 * V_8 , struct V_141 * V_142 ,
struct V_141 * V_143 )
{
struct V_1 * V_2 = (struct V_1 * ) V_8 ;
unsigned long V_33 ;
unsigned int V_14 , V_144 , V_145 , V_146 , V_147 ;
unsigned int V_148 = V_143 ? V_143 -> V_149 & V_150 : V_151 ;
unsigned int div , V_152 ;
unsigned long V_153 , V_154 ;
T_2 V_155 ;
if ( 0 ) {
V_142 -> V_149 &= ~ ( V_156 | V_157 | V_158 ) ;
V_142 -> V_149 |= V_159 ;
}
while ( ( V_142 -> V_149 & V_150 ) != V_160 &&
( V_142 -> V_149 & V_150 ) != V_151 ) {
V_142 -> V_149 &= ~ V_150 ;
V_142 -> V_149 |= V_148 ;
V_148 = V_151 ;
}
if ( ( V_142 -> V_149 & V_150 ) == V_151 )
V_14 = V_161 | V_118 | V_162 ;
else
V_14 = V_118 | V_162 ;
if ( V_142 -> V_149 & V_157 ) {
if ( V_2 -> V_163 ) {
V_14 &= ~ V_162 ;
V_14 |= V_164 ;
} else {
...
if ( V_142 -> V_149 & V_165 )
V_14 |= V_166 ;
if ( V_142 -> V_149 & V_167 ) {
V_14 |= V_168 ;
if ( V_142 -> V_149 & V_169 )
V_14 |= V_170 ;
}
F_47 ( & V_2 -> V_35 ) ;
V_146 = F_49 ( V_8 , V_142 , V_143 , 50 , V_8 -> V_171 / 16 ) ;
V_147 = F_50 ( V_8 , V_146 ) ;
F_13 ( & V_2 -> V_8 . V_34 , V_33 ) ;
V_2 -> V_8 . V_88 = 0 ;
if ( V_142 -> V_172 & V_173 )
V_2 -> V_8 . V_88 |= ( V_83 | V_81 ) ;
if ( V_142 -> V_172 & ( V_174 | V_175 ) )
V_2 -> V_8 . V_88 |= V_79 ;
V_2 -> V_8 . V_87 = 0 ;
if ( V_142 -> V_172 & V_176 )
V_2 -> V_8 . V_87 |= V_81 ;
if ( V_142 -> V_172 & V_177 ) {
V_2 -> V_8 . V_87 |= V_79 ;
if ( V_142 -> V_172 & V_176 )
V_2 -> V_8 . V_87 |= V_85 ;
}
F_51 ( V_8 , V_142 -> V_149 , V_146 ) ;
V_144 = F_5 ( V_2 -> V_8 . V_12 + V_13 ) ;
F_7 ( V_144 & ~ ( V_43 | V_49 | V_126 ) ,
V_2 -> V_8 . V_12 + V_13 ) ;
while ( ! ( F_5 ( V_2 -> V_8 . V_12 + V_40 ) & V_41 ) )
F_19 () ;
V_145 = F_5 ( V_2 -> V_8 . V_12 + V_15 ) ;
F_7 ( V_145 & ~ ( V_129 | V_51 ) ,
V_2 -> V_8 . V_12 + V_15 ) ;
V_145 &= ( V_129 | V_51 ) ;
if ( F_17 ( V_2 ) ) {
div = 1 ;
} else {
div = V_2 -> V_8 . V_171 / ( V_146 * 16 ) ;
if ( div > 7 )
div = 7 ;
if ( ! div )
div = 1 ;
}
F_52 ( 16 * div * V_146 , V_2 -> V_8 . V_171 ,
1 << 16 , 1 << 16 , & V_153 , & V_154 ) ;
V_155 = V_2 -> V_8 . V_171 ;
V_155 *= V_153 ;
F_53 ( V_155 , V_154 * 16 * div ) ;
F_54 ( V_142 ,
( V_178 ) V_155 , ( V_178 ) V_155 ) ;
V_153 -= 1 ;
V_154 -= 1 ;
V_152 = F_5 ( V_2 -> V_8 . V_12 + V_106 ) ;
V_152 = ( V_152 & ( ~ V_107 ) ) | F_55 ( div ) ;
F_7 ( V_152 , V_2 -> V_8 . V_12 + V_106 ) ;
F_7 ( V_153 , V_2 -> V_8 . V_12 + V_179 ) ;
F_7 ( V_154 , V_2 -> V_8 . V_12 + V_180 ) ;
if ( F_3 ( V_2 ) )
F_7 ( V_2 -> V_8 . V_171 / div / 1000 ,
V_2 -> V_8 . V_12 + V_181 ) ;
F_7 ( V_144 , V_2 -> V_8 . V_12 + V_13 ) ;
F_7 ( V_14 | V_145 , V_2 -> V_8 . V_12 + V_15 ) ;
if ( F_56 ( & V_2 -> V_8 , V_142 -> V_149 ) )
F_21 ( & V_2 -> V_8 ) ;
F_14 ( & V_2 -> V_8 . V_34 , V_33 ) ;
}
...
{
struct V_183 * V_184 = F_59 ( V_8 -> V_137 ) ;
struct V_185 * V_186 ;
...
return - V_190 ;
if ( V_230 )
F_78 ( V_230 , & V_146 , & V_82 , & V_222 , & V_231 ) ;
else
F_73 ( V_2 , & V_146 , & V_82 , & V_222 ) ;
F_42 ( V_2 , 0 ) ;
return F_79 ( & V_2 -> V_8 , V_214 , V_146 , V_82 , V_222 , V_231 ) ;
}
static int F_80 ( struct V_183 * V_137 , T_4 V_30 )
{
struct V_1 * V_2 = F_81 ( V_137 ) ;
unsigned int V_64 ;
...
static int F_83 ( struct V_183 * V_137 )
{
struct V_1 * V_2 = F_81 ( V_137 ) ;
unsigned int V_64 ;
V_64 = F_5 ( V_2 -> V_8 . V_12 + V_17 ) ;
...
struct V_183 * V_184 )
{
struct V_234 * V_235 = V_184 -> V_137 . V_236 ;
const struct V_237 * V_238 =
F_86 ( V_239 , & V_184 -> V_137 ) ;
int V_189 ;
if ( ! V_235 )
return 1 ;
V_189 = F_87 ( V_235 , L_4 ) ;
if ( V_189 < 0 ) {
F_88 ( & V_184 -> V_137 , L_5 , V_189 ) ;
return V_189 ;
}
V_2 -> V_8 . line = V_189 ;
...
struct V_183 * V_184 )
{
struct V_135 * V_136 = V_184 -> V_137 . V_138 ;
...
struct V_185 * V_248 ;
struct V_249 * V_249 ;
V_2 = F_92 ( & V_184 -> V_137 , sizeof( * V_2 ) , V_250 ) ;
if ( ! V_2 )
return - V_251 ;
...
if ( ! V_248 )
return - V_190 ;
V_247 = F_93 ( & V_184 -> V_137 , V_248 -> V_188 , V_252 ) ;
if ( ! V_247 )
return - V_251 ;
V_2 -> V_8 . V_137 = & V_184 -> V_137 ;
...
V_249 = F_96 ( & V_184 -> V_137 ) ;
if ( F_97 ( V_249 ) ) {
V_189 = F_98 ( V_249 ) ;
F_88 ( & V_184 -> V_137 , L_8 , V_189 ) ;
return V_189 ;
}
V_2 -> V_258 = F_99 ( & V_184 -> V_137 , L_9 ) ;
if ( F_97 ( V_2 -> V_258 ) ) {
V_189 = F_98 ( V_2 -> V_258 ) ;
F_88 ( & V_184 -> V_137 , L_10 , V_189 ) ;
return V_189 ;
}
V_2 -> V_227 = F_99 ( & V_184 -> V_137 , L_11 ) ;
if ( F_97 ( V_2 -> V_227 ) ) {
V_189 = F_98 ( V_2 -> V_227 ) ;
F_88 ( & V_184 -> V_137 , L_12 , V_189 ) ;
return V_189 ;
}
F_100 ( V_2 -> V_227 ) ;
F_100 ( V_2 -> V_258 ) ;
...
V_136 = V_184 -> V_137 . V_138 ;
if ( V_136 && V_136 -> V_259 ) {
V_189 = V_136 -> V_259 ( V_184 ) ;
if ( V_189 )
goto V_260;
}
