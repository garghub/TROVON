...
F_2 ( V_2 - V_11 -> V_2 , V_15 + V_31 ) ;
F_2 ( ( T_1 ) ( V_5 >> 32 ) , V_15 + V_32 ) ;
F_2 ( ( T_1 ) V_5 , V_15 + V_33 ) ;
F_2 ( V_6 , V_15 + V_34 ) ;
F_2 ( ( T_1 ) V_7 , V_15 + V_35 ) ;
F_2 ( V_4 , V_15 + V_27 ) ;
V_8 = F_5 ( V_15 + V_36 ) ;
}
F_6 ( & V_11 -> V_30 , V_29 ) ;
...
static int F_7 ( struct V_1 * V_2 , struct V_37 * V_38 )
{
T_4 V_39 = V_38 -> V_5 ;
T_1 V_6 = V_38 -> V_6 ;
T_1 V_40 ;
...
static int F_11 ( struct V_1 * V_2 , T_4 V_39 ,
struct V_50 * V_51 )
{
T_1 V_40 ;
...
static int F_13 ( struct V_1 * V_2 , T_4 V_58 , T_5 V_6 ,
T_5 * V_55 , T_6 * V_59 )
{
T_1 V_40 ;
...
static int F_14 ( struct V_1 * V_2 , T_4 V_60 , T_5 V_6 ,
...
static int F_15 ( struct V_1 * V_2 , T_4 V_39 )
{
T_1 V_40 ;
if ( V_39 >= V_2 -> V_41 )
goto V_42;
V_40 = F_8 ( V_39 , V_2 -> V_45 ) ;
if ( V_40 )
goto V_42;
...
V_71 = F_5 ( V_15 + V_73 ) ;
V_70 = F_5 ( V_15 + V_74 ) ;
V_2 -> V_43 = F_5 ( V_15 + V_75 ) ;
V_2 -> V_41 = F_5 ( V_15 + V_76 ) ;
V_2 -> V_41 |= ( T_2 ) F_5 ( V_15 + V_77 ) << 32 ;
V_2 -> V_44 = F_5 ( V_15 + V_78 ) ;
V_2 -> V_79 = V_2 -> V_44 ;
V_2 -> V_45 = F_5 ( V_15 + V_80 ) /
( V_2 -> V_43 + V_2 -> V_44 ) * V_2 -> V_43 ;
F_8 ( V_2 -> V_41 , V_2 -> V_43 + V_2 -> V_44 ) ;
V_2 -> V_41 *= V_2 -> V_43 ;
F_21 ( & V_64 -> V_22 ,
L_9 ,
V_69 , V_2 -> V_41 , V_2 -> V_43 , V_2 -> V_44 , V_2 -> V_45 ) ;
F_6 ( & V_11 -> V_30 , V_29 ) ;
V_2 -> V_12 = V_11 ;
V_2 -> V_72 = V_72 = F_18 ( & V_64 -> V_22 , V_70 + 1 , V_66 ) ;
if ( V_72 == NULL )
return - V_81 ;
...
V_104 = F_25 ( V_64 , V_105 , 0 ) ;
if ( V_104 == NULL )
return - V_83 ;
V_15 = F_26 ( & V_64 -> V_22 , V_104 -> V_106 , V_107 ) ;
if ( V_15 == NULL )
return - V_81 ;
V_102 = F_5 ( V_15 + V_108 ) ;
if ( V_102 != V_109 ) {
F_22 ( & V_64 -> V_22 ,
L_11 ,
V_102 , V_109 ) ;
...
if ( V_98 == 0 )
return - V_83 ;
V_11 = F_18 ( & V_64 -> V_22 , sizeof( * V_11 ) +
