...
V_188 = F_75 ( V_188 , < , V_175 ) ? V_175 : V_188 ;
V_188 = F_75 ( V_188 , > , V_177 ) ? V_177 : V_188 ;
V_11 -> V_186 = V_188 ;
...
struct V_120 * V_155 ;
int V_157 ;
V_11 = F_86 ( sizeof( * V_11 ) , V_205 ) ;
if ( ! V_11 )
return - V_206 ;
snprintf ( V_11 -> V_117 . V_118 , sizeof( V_11 -> V_117 . V_118 ) ,
L_28 , V_207 , V_200 ) ;
V_157 = F_87 ( NULL , & V_11 -> V_117 ) ;
if ( V_157 )
goto V_208;
V_11 -> V_3 = & V_5 [ 0 ] ;
V_11 -> V_186 = V_190 ;
...
V_204 = & V_11 -> V_72 ;
F_88 ( V_204 , 11 ) ;
V_11 -> V_81 = F_89 ( V_204 , & V_209 ,
V_210 , 0 , 255 , 1 , 200 ) ;
V_11 -> V_74 = F_89 ( V_204 , & V_209 ,
V_211 , 0 , 255 , 1 , 127 ) ;
V_11 -> V_77 = F_89 ( V_204 , & V_209 ,
V_212 , 0 , 255 , 1 , 16 ) ;
V_11 -> V_78 = F_89 ( V_204 , & V_209 ,
V_213 , 0 , 255 , 1 , 127 ) ;
V_11 -> V_79 = F_89 ( V_204 , & V_209 ,
V_214 , - 128 , 127 , 1 , 0 ) ;
V_11 -> V_80 = F_89 ( V_204 , & V_209 ,
V_215 , 0 , 1 , 1 , 1 ) ;
V_11 -> V_65 = F_89 ( V_204 , & V_209 ,
V_216 , 0 , 255 , 1 , 100 ) ;
V_11 -> V_37 = F_89 ( V_204 , & V_209 ,
V_195 , 0 , 255 , 1 , 0 ) ;
V_11 -> V_196 = F_90 ( V_204 , & V_217 , NULL ) ;
V_11 -> V_82 = F_90 ( V_204 , & V_218 , NULL ) ;
V_11 -> V_83 = F_90 ( V_204 , & V_219 , NULL ) ;
V_11 -> boolean = F_90 ( V_204 , & V_220 , NULL ) ;
V_11 -> V_86 = F_90 ( V_204 , & V_221 , NULL ) ;
V_11 -> string = F_90 ( V_204 , & V_222 , NULL ) ;
V_11 -> V_85 = F_90 ( V_204 , & V_223 , NULL ) ;
V_11 -> V_88 = F_90 ( V_204 , & V_224 , NULL ) ;
if ( V_204 -> error ) {
V_157 = V_204 -> error ;
goto V_225;
}
F_91 ( 2 , & V_11 -> V_80 , 0 , true ) ;
...
goto V_225;
F_94 ( & V_11 -> V_134 ) ;
F_95 ( & V_11 -> V_99 . V_102 ) ;
F_96 ( & V_11 -> V_99 . V_111 ) ;
V_202 = & V_11 -> V_199 ;
* V_202 = V_237 ;
V_202 -> V_238 = V_238 ;
V_202 -> V_117 = & V_11 -> V_117 ;
V_202 -> V_239 = V_155 ;
F_97 ( V_240 , & V_202 -> V_100 ) ;
V_202 -> V_73 = & V_11 -> V_134 ;
F_98 ( V_202 , V_11 ) ;
V_157 = F_99 ( V_202 , V_241 , V_242 ) ;
if ( V_157 < 0 )
goto V_225;
F_54 ( & V_11 -> V_198 , & V_198 ) ;
F_79 ( & V_11 -> V_117 , L_29 ,
F_80 ( V_202 ) ) ;
return 0 ;
V_225:
F_83 ( V_204 ) ;
...
{
const struct V_243 * V_244 = F_101 ( L_30 ) ;
int V_157 = 0 , V_163 ;
if ( V_244 == NULL ) {
F_102 ( V_245 L_31 ) ;
return - V_246 ;
