...
struct V_1 * F_37 ( struct V_23 * V_23 , struct V_5 * V_6 ,
...
struct V_1 * V_2 ;
F_38 () ;
V_2 = F_39 ( V_23 , V_6 , V_25 , V_26 , V_27 , F_40 ( V_56 ) , V_29 ) ;
F_41 () ;
return V_2 ;
}
...
{
const struct V_62 * V_63 = F_29 ( V_2 ) ;
const struct V_44 * V_45 = F_30 ( V_2 ) ;
