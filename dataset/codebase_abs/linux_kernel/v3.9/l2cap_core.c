...
V_151 = F_81 ( V_14 ) ;
if ( V_14 -> V_6 == V_92 )
V_88 = F_156 ( V_157 , V_89 , V_287 , V_313 ,
V_14 -> V_60 , V_151 ) ;
else
V_88 = F_156 ( V_157 , V_128 , V_287 , V_313 ,
V_14 -> V_60 , V_151 ) ;
if ( F_113 ( V_88 ) ) {
V_15 = F_157 ( V_88 ) ;
goto V_18;
...
int V_15 = 0 ;
int V_323 = V_324 / 5 ;
F_164 ( F_165 ( V_13 ) , & V_321 ) ;
F_166 ( V_325 ) ;
while ( V_14 -> V_326 > 0 && V_14 -> V_3 ) {
if ( ! V_323 )
V_323 = V_324 / 5 ;
if ( F_167 ( V_322 ) ) {
V_15 = F_168 ( V_323 ) ;
...
struct V_32 * V_36 ;
struct V_173 * V_37 ;
F_21 ( L_20 , V_14 , V_330 ) ;
if ( F_90 ( V_14 ) )
return;
F_175 ( V_330 , & V_14 -> V_126 ) ;
while ( ! F_176 ( & V_14 -> V_126 ) ) {
V_36 = F_177 ( & V_14 -> V_126 ) ;
F_36 ( V_36 ) -> V_37 . V_241 = 1 ;
V_37 = & F_36 ( V_36 ) -> V_37 ;
V_37 -> V_174 = 0 ;
V_37 -> V_38 = V_14 -> V_331 ;
...
F_91 ( V_14 , V_36 ) ;
F_21 ( L_21 , V_37 -> V_38 ) ;
V_14 -> V_331 = F_178 ( V_14 , V_14 -> V_331 ) ;
V_14 -> V_332 ++ ;
}
}
static int F_179 ( struct V_1 * V_14 )
{
struct V_32 * V_36 , * V_333 ;
struct V_173 * V_37 ;
int V_334 = 0 ;
F_21 ( L_3 , V_14 ) ;
if ( V_14 -> V_23 != V_56 )
...
V_14 -> V_336 = F_182 ( & V_14 -> V_126 , V_36 ) ;
F_91 ( V_14 , V_333 ) ;
F_21 ( L_21 , V_37 -> V_38 ) ;
}
F_21 ( L_22 , V_334 ,
V_14 -> V_326 , F_183 ( & V_14 -> V_126 ) ) ;
return V_334 ;
}
...
if ( V_14 -> V_73 == V_74 ) {
T_1 V_73 = F_109 ( 0 , ( T_2 * ) V_333 -> V_156 , V_333 -> V_155 ) ;
F_103 ( V_73 , F_108 ( V_333 ,
V_217 ) ) ;
}
F_91 ( V_14 , V_333 ) ;
F_21 ( L_25 , V_37 . V_38 ) ;
...
{
struct V_173 V_37 ;
T_1 V_338 = F_191 ( V_14 , V_14 -> V_227 ,
V_14 -> V_225 ) ;
int V_339 ;
F_21 ( L_26 ,
...
struct V_341 * V_342 , int V_155 ,
int V_343 , struct V_32 * V_36 )
{
struct V_2 * V_3 = V_14 -> V_3 ;
struct V_32 * * V_344 ;
int V_334 = 0 ;
if ( F_194 ( F_108 ( V_36 , V_343 ) , V_342 -> V_345 , V_343 ) )
return - V_346 ;
V_334 += V_343 ;
V_155 -= V_343 ;
V_344 = & F_195 ( V_36 ) -> V_347 ;
while ( V_155 ) {
struct V_32 * V_275 ;
V_343 = F_196 (unsigned int, conn->mtu, len) ;
V_275 = V_14 -> V_24 -> V_348 ( V_14 , V_343 ,
V_342 -> V_349 & V_350 ) ;
if ( F_113 ( V_275 ) )
return F_157 ( V_275 ) ;
* V_344 = V_275 ;
if ( F_194 ( F_108 ( * V_344 , V_343 ) , V_342 -> V_345 , V_343 ) )
return - V_346 ;
( * V_344 ) -> V_162 = V_36 -> V_162 ;
V_334 += V_343 ;
V_155 -= V_343 ;
V_36 -> V_155 += ( * V_344 ) -> V_155 ;
V_36 -> V_351 += ( * V_344 ) -> V_155 ;
V_344 = & ( * V_344 ) -> V_352 ;
}
return V_334 ;
}
static struct V_32 * F_197 ( struct V_1 * V_14 ,
struct V_341 * V_342 , T_6 V_155 ,
T_8 V_162 )
{
struct V_2 * V_3 = V_14 -> V_3 ;
struct V_32 * V_36 ;
int V_15 , V_343 , V_216 = V_211 + V_353 ;
struct V_214 * V_215 ;
F_21 ( L_28 , V_14 , V_155 , V_162 ) ;
V_343 = F_196 (unsigned int, (conn->mtu - hlen), len) ;
V_36 = V_14 -> V_24 -> V_348 ( V_14 , V_343 + V_216 ,
V_342 -> V_349 & V_350 ) ;
if ( F_113 ( V_36 ) )
return V_36 ;
V_36 -> V_162 = V_162 ;
V_215 = (struct V_214 * ) F_108 ( V_36 , V_211 ) ;
V_215 -> V_4 = F_16 ( V_14 -> V_6 ) ;
V_215 -> V_155 = F_16 ( V_155 + V_353 ) ;
F_198 ( V_14 -> V_10 , F_108 ( V_36 , V_353 ) ) ;
V_15 = F_193 ( V_14 , V_342 , V_155 , V_343 , V_36 ) ;
if ( F_199 ( V_15 < 0 ) ) {
F_92 ( V_36 ) ;
return F_107 ( V_15 ) ;
}
...
V_343 = F_196 (unsigned int, (conn->mtu - L2CAP_HDR_SIZE), len) ;
V_36 = V_14 -> V_24 -> V_348 ( V_14 , V_343 + V_211 ,
V_342 -> V_349 & V_350 ) ;
if ( F_113 ( V_36 ) )
return V_36 ;
V_36 -> V_162 = V_162 ;
...
T_6 V_358 ;
T_2 V_188 ;
F_21 ( L_30 , V_14 , V_342 , V_155 ) ;
V_358 = V_14 -> V_3 -> V_310 ;
if ( ! V_14 -> V_169 )
V_358 = F_196 ( T_6 , V_358 , V_359 ) ;
if ( V_14 -> V_73 )
V_358 -= V_217 ;
V_358 -= F_104 ( V_14 ) ;
V_358 = F_196 ( T_6 , V_358 , V_14 -> V_360 ) ;
if ( V_155 <= V_358 ) {
V_188 = V_361 ;
V_357 = 0 ;
V_358 = V_155 ;
...
while ( V_155 > 0 ) {
V_36 = F_201 ( V_14 , V_342 , V_358 , V_357 ) ;
if ( F_113 ( V_36 ) ) {
F_203 ( V_356 ) ;
return F_157 ( V_36 ) ;
}
...
int F_205 ( struct V_1 * V_14 , struct V_341 * V_342 , T_6 V_155 ,
T_8 V_162 )
{
struct V_32 * V_36 ;
int V_15 ;
struct V_33 V_356 ;
if ( V_14 -> V_86 == V_93 ) {
V_36 = F_197 ( V_14 , V_342 , V_155 , V_162 ) ;
if ( F_113 ( V_36 ) )
return F_157 ( V_36 ) ;
F_91 ( V_14 , V_36 ) ;
return V_155 ;
...
if ( V_155 > V_14 -> V_90 )
return - V_365 ;
V_36 = F_200 ( V_14 , V_342 , V_155 , V_162 ) ;
if ( F_113 ( V_36 ) )
return F_157 ( V_36 ) ;
F_91 ( V_14 , V_36 ) ;
V_15 = V_155 ;
...
F_206 ( & V_356 ) ;
V_15 = F_202 ( V_14 , & V_356 , V_342 , V_155 ) ;
if ( V_14 -> V_23 != V_56 ) {
F_203 ( & V_356 ) ;
V_15 = - V_335 ;
}
...
if ( V_14 -> V_326 == 0 || V_174 == V_14 -> V_370 )
return;
F_21 ( L_34 ,
V_14 -> V_370 , V_14 -> V_326 ) ;
for ( V_369 = V_14 -> V_370 ; V_369 != V_174 ;
V_369 = F_178 ( V_14 , V_369 ) ) {
V_368 = F_34 ( & V_14 -> V_126 , V_369 ) ;
if ( V_368 ) {
F_211 ( V_368 , & V_14 -> V_126 ) ;
F_92 ( V_368 ) ;
V_14 -> V_326 -- ;
}
}
...
struct V_173 * V_37 ,
struct V_33 * V_330 , T_2 V_371 )
{
F_21 ( L_36 , V_14 , V_37 , V_330 ,
V_371 ) ;
switch ( V_371 ) {
case V_366 :
if ( V_14 -> V_336 == NULL )
V_14 -> V_336 = F_214 ( V_330 ) ;
F_175 ( V_330 , & V_14 -> V_126 ) ;
F_179 ( V_14 ) ;
break;
case V_372 :
...
{
F_21 ( L_40 ,
V_14 , V_37 , V_330 , V_371 , V_14 -> V_245 ) ;
switch ( V_14 -> V_245 ) {
case V_246 :
F_213 ( V_14 , V_37 , V_330 , V_371 ) ;
break;
case V_376 :
F_215 ( V_14 , V_37 , V_330 , V_371 ) ;
break;
default:
break;
}
...
{
F_21 ( L_11 , V_14 , V_37 ) ;
F_123 ( V_14 , V_37 , NULL , V_377 ) ;
}
static void F_217 ( struct V_1 * V_14 ,
struct V_173 * V_37 )
{
F_21 ( L_11 , V_14 , V_37 ) ;
F_123 ( V_14 , V_37 , NULL , V_378 ) ;
}
...
if ( V_36 -> V_13 == V_13 )
continue;
V_380 = F_180 ( V_36 , V_45 ) ;
if ( ! V_380 )
continue;
if ( V_14 -> V_24 -> V_381 ( V_14 , V_380 ) )
F_92 ( V_380 ) ;
}
F_7 ( & V_3 -> V_8 ) ;
}
static struct V_32 * F_87 ( struct V_2 * V_3 , T_2 V_154 ,
T_2 V_9 , T_1 V_382 , void * V_156 )
{
struct V_32 * V_36 , * * V_344 ;
struct V_383 * V_384 ;
struct V_214 * V_215 ;
int V_155 , V_343 ;
F_21 ( L_41 ,
V_3 , V_154 , V_9 , V_382 ) ;
V_155 = V_211 + V_385 + V_382 ;
V_343 = F_196 (unsigned int, conn->mtu, len) ;
V_36 = F_106 ( V_343 , V_45 ) ;
if ( ! V_36 )
return NULL ;
V_215 = (struct V_214 * ) F_108 ( V_36 , V_211 ) ;
V_215 -> V_155 = F_16 ( V_385 + V_382 ) ;
if ( V_3 -> V_88 -> type == V_89 )
V_215 -> V_4 = F_79 ( V_386 ) ;
else
V_215 -> V_4 = F_79 ( V_99 ) ;
V_384 = (struct V_383 * ) F_108 ( V_36 , V_385 ) ;
V_384 -> V_154 = V_154 ;
V_384 -> V_9 = V_9 ;
V_384 -> V_155 = F_16 ( V_382 ) ;
if ( V_382 ) {
V_343 -= V_211 + V_385 ;
memcpy ( F_108 ( V_36 , V_343 ) , V_156 , V_343 ) ;
V_156 += V_343 ;
}
V_155 -= V_36 -> V_155 ;
V_344 = & F_195 ( V_36 ) -> V_347 ;
while ( V_155 ) {
V_343 = F_196 (unsigned int, conn->mtu, len) ;
* V_344 = F_106 ( V_343 , V_45 ) ;
if ( ! * V_344 )
goto V_387;
memcpy ( F_108 ( * V_344 , V_343 ) , V_156 , V_343 ) ;
V_155 -= V_343 ;
V_156 += V_343 ;
V_344 = & ( * V_344 ) -> V_352 ;
}
...
static inline int F_219 ( void * * V_388 , int * type , int * V_389 ,
unsigned long * V_390 )
{
struct V_391 * V_392 = * V_388 ;
int V_155 ;
V_155 = V_393 + V_392 -> V_155 ;
* V_388 += V_155 ;
* type = V_392 -> type ;
* V_389 = V_392 -> V_155 ;
switch ( V_392 -> V_155 ) {
case 1 :
* V_390 = * ( ( T_2 * ) V_392 -> V_390 ) ;
break;
case 2 :
* V_390 = F_98 ( V_392 -> V_390 ) ;
break;
case 4 :
* V_390 = F_96 ( V_392 -> V_390 ) ;
break;
default:
* V_390 = ( unsigned long ) V_392 -> V_390 ;
break;
}
F_21 ( L_42 , * type , V_392 -> V_155 , * V_390 ) ;
return V_155 ;
}
static void F_220 ( void * * V_388 , T_2 type , T_2 V_155 , unsigned long V_390 )
{
struct V_391 * V_392 = * V_388 ;
F_21 ( L_42 , type , V_155 , V_390 ) ;
V_392 -> type = type ;
V_392 -> V_155 = V_155 ;
switch ( V_155 ) {
case 1 :
* ( ( T_2 * ) V_392 -> V_390 ) = V_390 ;
break;
case 2 :
F_103 ( V_390 , V_392 -> V_390 ) ;
break;
case 4 :
F_102 ( V_390 , V_392 -> V_390 ) ;
break;
default:
memcpy ( V_392 -> V_390 , ( void * ) V_390 , V_155 ) ;
break;
}
* V_388 += V_393 + V_155 ;
}
static void F_221 ( void * * V_388 , struct V_1 * V_14 )
{
struct V_394 V_395 ;
switch ( V_14 -> V_119 ) {
case V_121 :
V_395 . V_152 = V_14 -> V_100 ;
V_395 . V_396 = V_14 -> V_102 ;
V_395 . V_397 = F_16 ( V_14 -> V_104 ) ;
V_395 . V_398 = F_222 ( V_14 -> V_106 ) ;
V_395 . V_399 = F_223 ( V_109 ) ;
V_395 . V_400 = F_223 ( V_111 ) ;
break;
case V_125 :
V_395 . V_152 = 1 ;
V_395 . V_396 = V_103 ;
...
F_220 ( V_388 , V_401 , sizeof( V_395 ) ,
( unsigned long ) & V_395 ) ;
}
...
F_56 ( & V_14 -> V_402 , F_224 ) ;
F_226 ( & V_14 -> V_122 ) ;
V_15 = F_37 ( & V_14 -> V_123 , V_14 -> V_77 ) ;
if ( V_15 < 0 )
return V_15 ;
V_15 = F_37 ( & V_14 -> V_124 , V_14 -> V_337 ) ;
if ( V_15 < 0 )
F_40 ( & V_14 -> V_123 ) ;
return V_15 ;
}
static inline T_7 F_227 ( T_7 V_119 , T_5 V_407 )
{
switch ( V_119 ) {
case V_125 :
case V_121 :
if ( F_129 ( V_119 , V_407 ) )
return V_119 ;
default:
return V_120 ;
}
...
{
return V_229 && V_14 -> V_3 -> V_267 & V_408 ;
}
static inline bool F_229 ( struct V_1 * V_14 )
{
return V_229 && V_14 -> V_3 -> V_267 & V_409 ;
}
static void F_230 ( struct V_1 * V_14 ,
struct V_410 * V_411 )
{
if ( V_14 -> V_405 && V_14 -> V_169 ) {
T_10 V_412 = V_14 -> V_169 -> V_157 -> V_413 ;
V_412 = F_231 ( V_412 , 1000 ) ;
V_412 = 3 * V_412 + 500 ;
if ( V_412 > 0xffff )
V_412 = 0xffff ;
V_411 -> V_29 = F_16 ( ( T_1 ) V_412 ) ;
V_411 -> V_31 = V_411 -> V_29 ;
} else {
V_411 -> V_29 = F_79 ( V_414 ) ;
V_411 -> V_31 = F_79 ( V_415 ) ;
}
}
...
{
struct V_417 * V_235 = V_156 ;
struct V_410 V_411 = { . V_119 = V_14 -> V_119 } ;
void * V_388 = V_235 -> V_156 ;
T_1 V_41 ;
F_21 ( L_3 , V_14 ) ;
if ( V_14 -> V_286 || V_14 -> V_418 )
goto V_18;
switch ( V_14 -> V_119 ) {
case V_125 :
case V_121 :
...
break;
if ( F_229 ( V_14 ) )
F_58 ( V_419 , & V_14 -> V_83 ) ;
default:
V_14 -> V_119 = F_227 ( V_411 . V_119 , V_14 -> V_3 -> V_267 ) ;
break;
}
V_18:
if ( V_14 -> V_98 != V_91 )
F_220 ( & V_388 , V_420 , 2 , V_14 -> V_98 ) ;
switch ( V_14 -> V_119 ) {
case V_120 :
...
V_411 . V_31 = 0 ;
V_411 . V_423 = 0 ;
F_220 ( & V_388 , V_424 , sizeof( V_411 ) ,
( unsigned long ) & V_411 ) ;
break;
case V_121 :
V_411 . V_119 = V_121 ;
V_411 . V_422 = V_14 -> V_75 ;
F_230 ( V_14 , & V_411 ) ;
V_41 = F_196 ( T_1 , V_425 , V_14 -> V_3 -> V_310 -
V_212 - V_355 -
V_217 ) ;
V_411 . V_423 = F_16 ( V_41 ) ;
F_232 ( V_14 ) ;
V_411 . V_421 = F_196 ( T_1 , V_14 -> V_77 ,
V_78 ) ;
F_220 ( & V_388 , V_424 , sizeof( V_411 ) ,
( unsigned long ) & V_411 ) ;
if ( F_73 ( V_419 , & V_14 -> V_83 ) )
F_221 ( & V_388 , V_14 ) ;
if ( F_73 ( V_207 , & V_14 -> V_83 ) )
F_220 ( & V_388 , V_426 , 2 ,
V_14 -> V_77 ) ;
if ( V_14 -> V_3 -> V_267 & V_427 )
if ( V_14 -> V_73 == V_428 ||
F_73 ( V_429 , & V_14 -> V_71 ) ) {
V_14 -> V_73 = V_428 ;
F_220 ( & V_388 , V_430 , 1 ,
V_14 -> V_73 ) ;
}
...
{
struct V_431 * V_132 = V_156 ;
void * V_388 = V_132 -> V_156 ;
void * V_235 = V_14 -> V_432 ;
int V_155 = V_14 -> V_433 ;
int type , V_434 , V_389 ;
unsigned long V_390 ;
struct V_410 V_411 = { . V_119 = V_120 } ;
struct V_394 V_395 ;
T_2 V_435 = 0 ;
T_1 V_310 = V_91 ;
T_1 V_133 = V_436 ;
...
F_21 ( L_3 , V_14 ) ;
while ( V_155 >= V_393 ) {
V_155 -= F_219 ( & V_235 , & type , & V_389 , & V_390 ) ;
V_434 = type & V_437 ;
type &= V_438 ;
switch ( type ) {
case V_420 :
...
break;
case V_424 :
if ( V_389 == sizeof( V_411 ) )
memcpy ( & V_411 , ( void * ) V_390 , V_389 ) ;
break;
case V_430 :
if ( V_390 == V_428 )
F_58 ( V_429 , & V_14 -> V_71 ) ;
break;
case V_401 :
V_435 = 1 ;
if ( V_389 == sizeof( V_395 ) )
memcpy ( & V_395 , ( void * ) V_390 , V_389 ) ;
break;
case V_426 :
if ( ! V_229 )
return - V_58 ;
F_58 ( V_207 , & V_14 -> V_83 ) ;
F_58 ( V_441 , & V_14 -> V_71 ) ;
V_14 -> V_79 = V_416 ;
V_14 -> V_337 = V_390 ;
break;
default:
...
if ( V_14 -> V_418 || V_14 -> V_286 > 1 )
goto V_18;
switch ( V_14 -> V_119 ) {
case V_125 :
case V_121 :
if ( ! F_73 ( V_276 , & V_14 -> V_71 ) ) {
V_14 -> V_119 = F_227 ( V_411 . V_119 ,
V_14 -> V_3 -> V_267 ) ;
break;
}
if ( V_435 ) {
...
V_14 -> V_90 = V_310 ;
F_58 ( V_445 , & V_14 -> V_71 ) ;
}
F_220 ( & V_388 , V_420 , 2 , V_14 -> V_90 ) ;
if ( V_435 ) {
if ( V_14 -> V_102 != V_446 &&
V_395 . V_396 != V_446 &&
V_395 . V_396 != V_14 -> V_102 ) {
...
break;
case V_121 :
if ( ! F_73 ( V_441 , & V_14 -> V_71 ) )
V_14 -> V_337 = V_411 . V_421 ;
else
V_411 . V_421 = V_78 ;
V_14 -> V_450 = V_411 . V_422 ;
V_41 = F_196 ( T_1 , F_234 ( V_411 . V_423 ) ,
...
F_58 ( V_449 , & V_14 -> V_71 ) ;
F_220 ( & V_388 , V_424 ,
sizeof( V_411 ) , ( unsigned long ) & V_411 ) ;
if ( F_73 ( V_419 , & V_14 -> V_83 ) ) {
V_14 -> V_451 = V_395 . V_152 ;
V_14 -> V_452 = V_395 . V_396 ;
V_14 -> V_453 = F_234 ( V_395 . V_397 ) ;
V_14 -> V_454 =
F_235 ( V_395 . V_400 ) ;
V_14 -> V_455 =
F_235 ( V_395 . V_399 ) ;
...
while ( V_155 >= V_393 ) {
V_155 -= F_219 ( & V_132 , & type , & V_389 , & V_390 ) ;
switch ( type ) {
case V_420 :
if ( V_390 < V_444 ) {
* V_133 = V_443 ;
...
break;
case V_426 :
V_14 -> V_80 = F_196 ( T_1 , V_390 , V_14 -> V_80 ) ;
F_220 ( & V_388 , V_426 , 2 ,
V_14 -> V_77 ) ;
break;
case V_401 :
...
if ( V_14 -> V_119 == V_120 && V_14 -> V_119 != V_411 . V_119 )
return - V_58 ;
V_14 -> V_119 = V_411 . V_119 ;
if ( * V_133 == V_436 || * V_133 == V_447 ) {
switch ( V_411 . V_119 ) {
case V_121 :
V_14 -> V_29 = F_234 ( V_411 . V_29 ) ;
V_14 -> V_31 = F_234 ( V_411 . V_31 ) ;
V_14 -> V_458 = F_234 ( V_411 . V_423 ) ;
if ( ! F_73 ( V_207 , & V_14 -> V_83 ) )
V_14 -> V_80 = F_196 ( T_1 , V_14 -> V_80 ,
V_411 . V_421 ) ;
if ( F_73 ( V_419 , & V_14 -> V_83 ) ) {
V_14 -> V_104 = F_234 ( V_395 . V_397 ) ;
V_14 -> V_106 =
F_235 ( V_395 . V_398 ) ;
V_14 -> V_108 = F_235 ( V_395 . V_399 ) ;
V_14 -> V_110 =
F_235 ( V_395 . V_400 ) ;
}
break;
...
V_459 = V_140 ;
F_21 ( L_44 , V_14 , V_459 ) ;
F_80 ( V_3 , V_14 -> V_9 , V_459 , sizeof( V_132 ) , & V_132 ) ;
...
. V_29 = F_79 ( V_414 ) ,
. V_31 = F_79 ( V_415 ) ,
. V_423 = F_16 ( V_14 -> V_98 ) ,
. V_421 = F_196 ( T_1 , V_14 -> V_80 , V_78 ) ,
} ;
...
V_14 -> V_458 = F_234 ( V_411 . V_423 ) ;
if ( F_73 ( V_207 , & V_14 -> V_83 ) )
V_14 -> V_80 = F_196 ( T_1 , V_14 -> V_80 , V_461 ) ;
else
V_14 -> V_80 = F_196 ( T_1 , V_14 -> V_80 ,
V_411 . V_421 ) ;
break;
...
struct V_383 * V_384 , T_2 * V_156 )
{
struct V_462 * V_463 = (struct V_462 * ) V_156 ;
if ( V_463 -> V_55 != V_464 )
return 0 ;
if ( ( V_3 -> V_258 & V_259 ) &&
V_384 -> V_9 == V_3 -> V_263 ) {
...
F_80 ( V_3 , V_384 -> V_9 , V_459 , sizeof( V_132 ) , & V_132 ) ;
if ( V_133 == V_279 && V_138 == V_139 ) {
struct V_261 V_469 ;
V_469 . type = F_79 ( V_262 ) ;
V_3 -> V_258 |= V_259 ;
V_3 -> V_263 = F_84 ( V_3 ) ;
F_128 ( & V_3 -> V_264 , V_265 ) ;
F_80 ( V_3 , V_3 -> V_263 , V_266 ,
...
struct V_383 * V_384 , T_2 * V_156 )
{
struct V_314 * V_157 = V_3 -> V_88 -> V_157 ;
struct V_168 * V_88 = V_3 -> V_88 ;
F_155 ( V_157 ) ;
if ( F_73 ( V_470 , & V_157 -> V_471 ) &&
! F_239 ( V_472 , & V_88 -> V_83 ) )
F_246 ( V_157 , & V_88 -> V_287 , V_88 -> type ,
V_88 -> V_313 , 0 , NULL , 0 ,
V_88 -> V_473 ) ;
F_159 ( V_157 ) ;
F_243 ( V_3 , V_384 , V_156 , V_140 , 0 ) ;
return 0 ;
}
...
struct V_383 * V_384 , T_1 V_476 ,
T_2 * V_156 )
{
struct V_417 * V_235 = (struct V_417 * ) V_156 ;
T_1 V_6 , V_83 ;
T_2 V_132 [ 64 ] ;
struct V_1 * V_14 ;
int V_155 , V_15 = 0 ;
...
struct V_478 V_463 ;
V_463 . V_55 = F_79 ( V_479 ) ;
V_463 . V_7 = F_16 ( V_14 -> V_7 ) ;
V_463 . V_6 = F_16 ( V_14 -> V_6 ) ;
F_80 ( V_3 , V_384 -> V_9 , V_480 ,
sizeof( V_463 ) , & V_463 ) ;
goto V_474;
}
V_155 = V_476 - sizeof( * V_235 ) ;
if ( V_155 < 0 || V_14 -> V_433 + V_155 > sizeof( V_14 -> V_432 ) ) {
F_80 ( V_3 , V_384 -> V_9 , V_475 ,
F_237 ( V_14 , V_132 ,
V_481 , V_83 ) , V_132 ) ;
goto V_474;
}
memcpy ( V_14 -> V_432 + V_14 -> V_433 , V_235 -> V_156 , V_155 ) ;
V_14 -> V_433 += V_155 ;
if ( V_83 & V_482 ) {
F_80 ( V_3 , V_384 -> V_9 , V_475 ,
F_237 ( V_14 , V_132 ,
...
V_14 -> V_9 = V_384 -> V_9 ;
F_80 ( V_3 , V_384 -> V_9 , V_475 , V_155 , V_132 ) ;
V_14 -> V_418 ++ ;
V_14 -> V_433 = 0 ;
if ( ! F_73 ( V_457 , & V_14 -> V_71 ) )
goto V_474;
if ( F_73 ( V_483 , & V_14 -> V_71 ) ) {
F_248 ( V_14 ) ;
if ( V_14 -> V_119 == V_121 ||
V_14 -> V_119 == V_125 )
V_15 = F_225 ( V_14 ) ;
...
if ( F_73 ( V_484 , & V_14 -> V_71 ) &&
F_73 ( V_448 , & V_14 -> V_71 ) ) {
if ( ! V_14 -> V_169 )
F_249 ( V_14 , V_132 , V_384 -> V_9 , V_83 ) ;
else
V_14 -> V_9 = V_384 -> V_9 ;
}
V_474:
...
struct V_383 * V_384 , T_2 * V_156 )
{
struct V_431 * V_132 = (struct V_431 * ) V_156 ;
T_1 V_7 , V_83 , V_133 ;
struct V_1 * V_14 ;
int V_155 = F_234 ( V_384 -> V_155 ) - sizeof( * V_132 ) ;
int V_15 = 0 ;
V_7 = F_67 ( V_132 -> V_7 ) ;
...
F_112 ( V_484 , & V_14 -> V_71 ) ;
break;
case V_447 :
F_58 ( V_484 , & V_14 -> V_71 ) ;
if ( F_73 ( V_448 , & V_14 -> V_71 ) ) {
char V_278 [ 64 ] ;
...
if ( V_14 -> V_418 <= V_485 ) {
char V_235 [ 64 ] ;
if ( V_155 > sizeof( V_235 ) - sizeof( struct V_417 ) ) {
F_78 ( V_14 , V_277 ) ;
goto V_18;
}
V_133 = V_436 ;
...
V_132 . V_6 = F_16 ( V_14 -> V_7 ) ;
V_132 . V_7 = F_16 ( V_14 -> V_6 ) ;
F_80 ( V_3 , V_384 -> V_9 , V_488 , sizeof( V_132 ) , & V_132 ) ;
F_24 ( V_13 ) ;
V_13 -> V_489 = V_490 ;
F_25 ( V_13 ) ;
F_61 ( V_14 ) ;
...
struct V_383 * V_384 , T_2 * V_156 )
{
struct V_487 * V_132 = (struct V_487 * ) V_156 ;
T_1 V_6 , V_7 ;
struct V_1 * V_14 ;
V_7 = F_67 ( V_132 -> V_7 ) ;
V_6 = F_67 ( V_132 -> V_6 ) ;
...
T_2 V_278 [ 8 ] ;
T_8 V_267 = V_269 ;
struct V_491 * V_132 = (struct V_491 * ) V_278 ;
V_132 -> type = F_79 ( V_262 ) ;
V_132 -> V_133 = F_79 ( V_492 ) ;
if ( ! V_270 )
V_267 |= V_271 | V_272
| V_427 ;
if ( V_229 )
...
F_80 ( V_3 , V_384 -> V_9 , V_493 , sizeof( V_278 ) ,
V_278 ) ;
} else if ( type == V_494 ) {
T_2 V_278 [ 12 ] ;
struct V_491 * V_132 = (struct V_491 * ) V_278 ;
...
V_495 [ 0 ] &= ~ V_233 ;
V_132 -> type = F_79 ( V_494 ) ;
V_132 -> V_133 = F_79 ( V_492 ) ;
memcpy ( V_132 -> V_156 , V_495 , sizeof( V_495 ) ) ;
F_80 ( V_3 , V_384 -> V_9 , V_493 , sizeof( V_278 ) ,
V_278 ) ;
} else {
struct V_491 V_132 ;
V_132 . type = F_16 ( type ) ;
V_132 . V_133 = F_79 ( V_496 ) ;
F_80 ( V_3 , V_384 -> V_9 , V_493 , sizeof( V_132 ) ,
& V_132 ) ;
}
return 0 ;
}
...
struct V_383 * V_384 , T_2 * V_156 )
{
struct V_491 * V_132 = (struct V_491 * ) V_156 ;
T_1 type , V_133 ;
type = F_67 ( V_132 -> type ) ;
V_133 = F_67 ( V_132 -> V_133 ) ;
F_21 ( L_54 , type , V_133 ) ;
if ( V_384 -> V_9 != V_3 -> V_263 ||
V_3 -> V_258 & V_260 )
return 0 ;
F_242 ( & V_3 -> V_264 ) ;
if ( V_133 != V_492 ) {
...
if ( V_235 -> V_237 == V_500 ) {
F_243 ( V_3 , V_384 , V_156 , V_460 ,
V_235 -> V_237 ) ;
return 0 ;
}
...
if ( ! V_157 )
goto error;
if ( V_157 -> V_501 != V_502 || ! F_73 ( V_503 , & V_157 -> V_83 ) ) {
F_160 ( V_157 ) ;
goto error;
}
V_14 = F_243 ( V_3 , V_384 , V_156 , V_460 ,
V_235 -> V_237 ) ;
if ( V_14 ) {
struct V_113 * V_114 = V_3 -> V_88 -> V_113 ;
struct V_168 * V_169 ;
V_169 = F_259 ( V_157 , V_504 , V_3 -> V_287 ) ;
if ( ! V_169 ) {
F_160 ( V_157 ) ;
return - V_346 ;
}
...
V_132 . V_133 = F_79 ( V_468 ) ;
V_132 . V_138 = F_79 ( V_139 ) ;
}
F_80 ( V_14 -> V_3 , V_14 -> V_9 , V_460 ,
sizeof( V_132 ) , & V_132 ) ;
if ( V_133 == V_282 ) {
F_20 ( V_14 , V_57 ) ;
F_58 ( V_284 , & V_14 -> V_71 ) ;
...
static void F_272 ( struct V_1 * V_14 , T_2 V_405 ,
T_2 V_529 )
{
F_121 ( V_14 ) ;
V_14 -> V_406 = V_405 ;
...
{
T_2 V_405 = V_14 -> V_405 ;
T_2 V_529 = V_14 -> V_529 ;
F_21 ( L_64 ,
V_14 , V_133 , V_405 , V_529 ) ;
if ( V_14 -> V_23 == V_137 || V_14 -> V_23 == V_534 ) {
F_50 ( V_14 ) ;
return;
}
if ( V_14 -> V_23 != V_56 ) {
F_271 ( V_14 , V_133 , V_405 , V_529 ) ;
} else if ( V_133 != V_528 ) {
F_274 ( V_14 , V_133 ) ;
} else {
switch ( V_14 -> V_250 ) {
...
if ( ! V_157 || V_157 -> V_501 != V_502 ||
! F_73 ( V_503 , & V_157 -> V_83 ) ) {
if ( V_157 )
F_160 ( V_157 ) ;
V_133 = V_533 ;
goto V_536;
...
F_278 ( V_3 , V_384 -> V_9 , V_509 , V_133 ) ;
return 0 ;
}
...
V_14 = F_8 ( V_3 , V_509 ) ;
if ( ! V_14 ) {
F_264 ( V_3 , V_384 -> V_9 , V_509 ) ;
return 0 ;
}
if ( V_14 -> V_165 == V_527 ) {
if ( V_133 == V_526 ) {
V_14 -> V_405 = V_14 -> V_406 ;
if ( ! V_14 -> V_405 )
F_265 ( V_14 ) ;
} else {
V_14 -> V_406 = V_14 -> V_405 ;
...
struct F_283 * V_235 ;
struct V_546 V_132 ;
T_1 V_541 , V_542 , V_543 , V_544 , V_476 ;
int V_15 ;
if ( ! ( V_88 -> V_547 & V_548 ) )
return - V_20 ;
V_476 = F_67 ( V_384 -> V_155 ) ;
if ( V_476 != sizeof( struct F_283 ) )
return - V_499 ;
...
switch ( V_384 -> V_154 ) {
case V_480 :
F_241 ( V_3 , V_384 , V_156 ) ;
break;
case V_236 :
V_15 = F_245 ( V_3 , V_384 , V_156 ) ;
break;
case V_140 :
case V_460 :
V_15 = F_247 ( V_3 , V_384 , V_156 ) ;
break;
case V_285 :
V_15 = F_250 ( V_3 , V_384 , V_476 , V_156 ) ;
break;
case V_475 :
V_15 = F_251 ( V_3 , V_384 , V_156 ) ;
break;
case V_274 :
V_15 = F_253 ( V_3 , V_384 , V_156 ) ;
break;
case V_488 :
V_15 = F_254 ( V_3 , V_384 , V_156 ) ;
break;
case V_552 :
F_80 ( V_3 , V_384 -> V_9 , V_553 , V_476 , V_156 ) ;
break;
case V_553 :
break;
case V_266 :
V_15 = F_255 ( V_3 , V_384 , V_156 ) ;
break;
case V_493 :
V_15 = F_256 ( V_3 , V_384 , V_156 ) ;
break;
case V_239 :
V_15 = F_257 ( V_3 , V_384 , V_476 , V_156 ) ;
break;
case V_510 :
V_15 = F_276 ( V_3 , V_384 , V_476 , V_156 ) ;
break;
case V_513 :
V_15 = F_279 ( V_3 , V_384 , V_476 , V_156 ) ;
break;
case V_516 :
V_15 = F_280 ( V_3 , V_384 , V_476 , V_156 ) ;
break;
case V_519 :
V_15 = F_281 ( V_3 , V_384 , V_476 , V_156 ) ;
break;
default:
F_286 ( L_68 , V_384 -> V_154 ) ;
V_15 = - V_20 ;
break;
}
return V_15 ;
...
return 0 ;
case V_554 :
return F_283 ( V_3 , V_384 , V_156 ) ;
case V_551 :
return 0 ;
default:
F_286 ( L_69 , V_384 -> V_154 ) ;
return - V_20 ;
}
}
...
while ( V_155 >= V_385 ) {
T_1 V_476 ;
memcpy ( & V_384 , V_156 , V_385 ) ;
V_156 += V_385 ;
V_155 -= V_385 ;
V_476 = F_234 ( V_384 . V_155 ) ;
F_21 ( L_70 , V_384 . V_154 , V_476 ,
V_384 . V_9 ) ;
if ( V_476 > V_155 || ! V_384 . V_9 ) {
F_21 ( L_71 ) ;
break;
}
if ( V_3 -> V_88 -> type == V_89 )
V_15 = F_287 ( V_3 , & V_384 , V_156 ) ;
else
V_15 = F_285 ( V_3 , & V_384 , V_476 , V_156 ) ;
if ( V_15 ) {
struct V_462 V_463 ;
F_286 ( L_72 , V_15 ) ;
V_463 . V_55 = F_79 ( V_464 ) ;
F_80 ( V_3 , V_384 . V_9 , V_480 ,
sizeof( V_463 ) , & V_463 ) ;
}
V_156 += V_476 ;
...
{
if ( ! F_293 ( V_36 ) )
F_195 ( V_36 ) -> V_347 = V_559 ;
V_559 -> V_352 = NULL ;
( * V_560 ) -> V_352 = V_559 ;
* V_560 = V_559 ;
V_36 -> V_155 += V_559 -> V_155 ;
V_36 -> V_351 += V_559 -> V_155 ;
...
if ( V_14 -> V_403 )
break;
V_15 = V_14 -> V_24 -> V_381 ( V_14 , V_36 ) ;
break;
case V_362 :
if ( V_14 -> V_403 )
break;
V_14 -> V_357 = F_98 ( V_36 -> V_156 ) ;
F_97 ( V_36 , V_355 ) ;
if ( V_14 -> V_357 > V_14 -> V_98 ) {
V_15 = - V_365 ;
break;
}
if ( V_36 -> V_155 >= V_14 -> V_357 )
break;
V_14 -> V_403 = V_36 ;
V_14 -> V_404 = V_36 ;
V_36 = NULL ;
...
if ( ! V_14 -> V_403 )
break;
F_292 ( V_14 -> V_403 , V_36 ,
& V_14 -> V_404 ) ;
V_36 = NULL ;
if ( V_14 -> V_403 -> V_155 >= V_14 -> V_357 )
break;
V_15 = 0 ;
break;
case V_363 :
...
if ( V_14 -> V_403 -> V_155 != V_14 -> V_357 )
break;
V_15 = V_14 -> V_24 -> V_381 ( V_14 , V_14 -> V_403 ) ;
if ( ! V_15 ) {
V_14 -> V_403 = NULL ;
V_14 -> V_404 = NULL ;
V_14 -> V_357 = 0 ;
...
if ( V_14 -> V_119 != V_121 )
return;
V_371 = V_562 ? V_372 : V_374 ;
F_123 ( V_14 , NULL , NULL , V_371 ) ;
}
...
V_14 -> V_247 = V_340 ;
if ( V_14 -> V_169 )
V_14 -> V_3 -> V_310 = V_14 -> V_169 -> V_157 -> V_505 ;
else
V_14 -> V_3 -> V_310 = V_14 -> V_3 -> V_88 -> V_157 -> V_311 ;
return F_295 ( V_14 ) ;
}
...
F_210 ( V_14 , V_37 -> V_174 ) ;
if ( ! F_176 ( & V_14 -> V_126 ) )
V_14 -> V_336 = F_214 ( & V_14 -> V_126 ) ;
else
V_14 -> V_336 = NULL ;
V_14 -> V_331 = V_37 -> V_174 ;
V_14 -> V_326 = 0 ;
V_15 = F_304 ( V_14 ) ;
if ( V_15 )
return V_15 ;
...
if ( V_371 == V_573 )
return - V_499 ;
return F_301 ( V_14 , V_37 , NULL , V_371 ) ;
}
...
V_15 = F_295 ( V_14 ) ;
if ( ! V_15 )
V_15 = F_301 ( V_14 , V_37 , V_36 , V_371 ) ;
return V_15 ;
}
static bool F_307 ( struct V_1 * V_14 , T_1 V_174 )
{
T_1 V_579 ;
V_579 = F_191 ( V_14 , V_14 -> V_331 , V_14 -> V_370 ) ;
return F_191 ( V_14 , V_14 -> V_331 , V_174 ) <= V_579 ;
}
...
break;
case V_256 :
V_15 = F_305 ( V_14 , V_37 , V_36 , V_371 ) ;
break;
case V_254 :
V_15 = F_306 ( V_14 , V_37 , V_36 , V_371 ) ;
break;
default:
break;
}
...
if ( F_289 ( V_14 , V_36 ) )
goto V_580;
if ( ! V_37 -> V_181 && V_37 -> V_188 == V_362 )
V_155 -= V_355 ;
if ( V_14 -> V_73 == V_74 )
V_155 -= V_217 ;
if ( V_155 > V_14 -> V_458 ) {
...
V_37 -> V_38 ) ;
if ( V_37 -> V_177 && V_14 -> V_245 != V_376 )
goto V_580;
if ( V_14 -> V_119 != V_125 ) {
V_371 = V_573 ;
V_15 = F_308 ( V_14 , V_37 , V_36 , V_371 ) ;
} else {
...
V_14 -> V_245 != V_376 ) )
goto V_580;
V_371 = V_581 [ V_37 -> V_185 ] ;
if ( F_308 ( V_14 , V_37 , V_36 , V_371 ) )
F_78 ( V_14 , V_277 ) ;
}
return 0 ;
V_580:
...
goto V_580;
F_21 ( L_101 , V_14 , V_36 -> V_155 ) ;
if ( V_14 -> V_23 != V_318 && V_14 -> V_23 != V_56 )
goto V_580;
if ( V_14 -> V_98 < V_36 -> V_155 )
goto V_580;
if ( ! V_14 -> V_24 -> V_381 ( V_14 , V_36 ) )
...
int F_318 ( struct V_314 * V_157 , T_4 * V_312 )
{
int V_584 = 0 , V_585 = 0 , V_586 = 0 ;
struct V_1 * V_5 ;
F_21 ( L_104 , V_157 -> V_587 , V_312 ) ;
F_134 ( & V_16 ) ;
F_2 (c, &chan_list, global_l) {
struct V_26 * V_13 = V_5 -> V_13 ;
if ( V_5 -> V_23 != V_127 )
continue;
if ( ! F_12 ( & F_13 ( V_13 ) -> V_11 , & V_157 -> V_312 ) ) {
V_585 |= V_588 ;
