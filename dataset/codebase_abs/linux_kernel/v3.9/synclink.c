...
if ( V_2 -> V_402 == NULL )
return - V_188 ;
V_2 -> V_404 = F_190 ( V_2 -> V_238 , V_187 ) ;
if ( ! V_2 -> V_404 ) {
F_191 ( V_2 -> V_402 ) ;
V_2 -> V_402 = NULL ;
return - V_188 ;
...
{
if ( F_197 ( V_2 -> V_136 , V_2 -> V_416 , L_125 ) == NULL ) {
F_4 ( L_126 ,
__FILE__ , __LINE__ , V_2 -> V_21 , V_2 -> V_136 ) ;
return - V_300 ;
}
V_2 -> V_417 = true ;
if ( F_198 ( V_2 -> V_176 , F_67 , V_2 -> V_418 ,
V_2 -> V_21 , V_2 ) < 0 ) {
F_4 ( L_127 ,
__FILE__ , __LINE__ , V_2 -> V_21 , V_2 -> V_176 ) ;
goto V_419;
...
V_2 -> V_420 = true ;
if ( V_2 -> V_350 == V_351 ) {
if ( F_199 ( V_2 -> V_352 , 0x40000 , L_125 ) == NULL ) {
F_4 ( L_128 ,
__FILE__ , __LINE__ , V_2 -> V_21 , V_2 -> V_352 ) ;
goto V_419;
}
V_2 -> V_421 = true ;
if ( F_199 ( V_2 -> V_353 + V_2 -> V_422 , 128 , L_125 ) == NULL ) {
F_4 ( L_129 ,
__FILE__ , __LINE__ , V_2 -> V_21 , V_2 -> V_353 + V_2 -> V_422 ) ;
goto V_419;
}
V_2 -> V_423 = true ;
V_2 -> V_389 = F_200 ( V_2 -> V_352 ,
0x40000 ) ;
if ( ! V_2 -> V_389 ) {
F_4 ( L_130 ,
__FILE__ , __LINE__ , V_2 -> V_21 , V_2 -> V_352 ) ;
...
F_193 ( V_2 ) ;
if ( V_2 -> V_417 ) {
F_208 ( V_2 -> V_136 , V_2 -> V_416 ) ;
V_2 -> V_417 = false ;
}
if ( V_2 -> V_421 ) {
F_209 ( V_2 -> V_352 , 0x40000 ) ;
V_2 -> V_421 = false ;
}
if ( V_2 -> V_423 ) {
F_209 ( V_2 -> V_353 + V_2 -> V_422 , 128 ) ;
V_2 -> V_423 = false ;
}
if ( V_2 -> V_389 ) {
F_210 ( V_2 -> V_389 ) ;
...
static void F_245 ( struct V_1 * V_2 , unsigned int V_600 , unsigned int V_601 )
{
bool V_602 = false ;
V_394 * V_603 ;
unsigned int V_604 ;
...
if ( V_19 >= V_616 )
F_246 ( V_2 , V_2 -> V_385 [ V_600 ] . V_400 ,
...
#if V_85
if ( V_2 -> V_86 )
F_247 ( V_2 , V_2 -> V_402 , V_605 ) ;
else
#endif
F_5 ( V_10 , V_2 -> V_402 , V_2 -> V_404 , V_605 ) ;
}
}
F_245 ( V_2 , V_600 , V_601 ) ;
V_606 = true ;
V_608:
...
V_394 * V_603 ;
if ( V_19 >= V_616 )
F_246 ( V_2 , V_414 , F_105 ( int , V_415 , V_380 ) , 1 ) ;
if ( V_2 -> V_36 . V_12 & V_236 ) {
V_2 -> V_56 |= V_57 ;
}
V_387 = V_2 -> V_599 ;
...
static int F_255 ( struct V_646 * V_647 , unsigned short V_483 ,
