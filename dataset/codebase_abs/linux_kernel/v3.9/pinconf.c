...
const char T_1 * V_59 , T_2 V_60 , T_3 * V_61 )
{
int V_62 ;
if ( V_60 > V_63 )
return - V_10 ;
V_62 = sscanf ( V_59 , L_40 , V_58 ) ;
if ( V_62 != 1 )
return - V_10 ;
return V_60 ;
}
static int F_32 ( struct V_39 * V_40 , void * V_57 )
{
if ( strlen ( V_64 ) )
F_16 ( V_40 , L_25 , V_64 ) ;
else
...
{
return F_27 ( V_55 , F_32 , V_54 -> V_56 ) ;
}
static int F_34 ( struct V_55 * V_55 ,
const char T_1 * V_59 , T_2 V_60 , T_3 * V_61 )
{
int V_62 ;
if ( V_60 > V_63 )
return - V_10 ;
V_62 = sscanf ( V_59 , L_40 , V_64 ) ;
if ( V_62 != 1 )
return - V_10 ;
return V_60 ;
}
static int F_35 ( struct V_39 * V_40 , void * V_57 )
{
struct V_65 * V_66 ;
...
bool V_68 = false ;
F_6 ( & V_24 ) ;
F_36 (maps_node, i, map) {
if ( V_14 -> type != V_37 )
continue;
if ( strncmp ( V_14 -> V_19 , V_64 , V_63 ) > 0 )
continue;
for ( V_67 = 0 ; V_67 < V_14 -> V_16 . V_17 . V_20 ; V_67 ++ ) {
if ( 0 == strncmp ( V_14 -> V_16 . V_17 . V_18 ,
V_58 , V_63 ) ) {
V_69 = V_14 -> V_16 . V_17 . V_17 [ V_67 ] ;
V_2 = F_7
( V_14 -> V_41 ) ;
V_68 = true ;
break;
...
static int F_37 ( struct V_54 * V_54 , struct V_55 * V_55 )
{
return F_27 ( V_55 , F_35 , V_54 -> V_56 ) ;
}
static int F_38 ( struct V_55 * V_55 ,
const char T_1 * V_59 , T_2 V_60 , T_3 * V_61 )
{
int V_62 ;
unsigned long V_22 ;
...
continue;
for ( V_67 = 0 ; V_67 < V_14 -> V_16 . V_17 . V_20 ; V_67 ++ ) {
if ( strncmp ( V_14 -> V_16 . V_17 . V_18 , V_58 ,
V_63 ) == 0 )
V_14 -> V_16 . V_17 . V_17 [ V_67 ] = V_69 ;
}
}
F_9 ( & V_24 ) ;
return V_60 ;
}
void F_40 ( struct V_70 * V_71 ,
struct V_1 * V_2 )
{
F_41 ( L_44 , V_72 | V_73 ,
V_71 , V_2 , & V_74 ) ;
F_41 ( L_45 , V_72 | V_73 ,
V_71 , V_2 , & V_75 ) ;
F_41 ( L_46 , ( V_73 | V_76 | V_77 ) ,
V_71 , V_2 , & V_78 ) ;
F_41 ( L_47 , ( V_73 | V_76 | V_77 ) ,
V_71 , V_2 , & V_79 ) ;
F_41 ( L_48 , ( V_73 | V_76 | V_77 ) ,
V_71 , V_2 , & V_80 ) ;
}
