...
F_65 ( V_11 -> V_81 . V_135 , L_39 , sizeof( V_11 -> V_81 . V_135 ) ) ;
V_11 -> V_81 . V_136 = V_137 ;
V_11 -> V_81 . V_138 = & V_139 ;
V_11 -> V_81 . V_85 = 2 ;
V_11 -> V_81 . V_140 = V_141 | V_142 ;
V_11 -> V_35 = 50 ;
F_66 ( & V_11 -> V_17 ) ;
V_11 -> V_3 = & V_2 -> V_3 ;
V_11 -> V_84 = F_67 ( & V_2 -> V_3 , L_40 ) ;
if ( F_68 ( V_11 -> V_84 ) ) {
F_21 ( & V_2 -> V_3 , L_41 ) ;
return - V_143 ;
}
F_5 ( & V_2 -> V_3 , L_42 , V_11 -> V_84 ) ;
V_131 = F_69 ( V_2 , V_144 , 0 ) ;
if ( V_131 == NULL ) {
F_21 ( & V_2 -> V_3 , L_43 ) ;
return - V_143 ;
}
...
if ( F_68 ( V_11 -> V_19 ) )
return F_71 ( V_11 -> V_19 ) ;
F_5 ( & V_2 -> V_3 , L_44 ,
V_11 -> V_19 , V_131 ) ;
V_11 -> V_81 . V_82 = V_11 ;
V_11 -> V_81 . V_3 . V_145 = & V_2 -> V_3 ;
V_11 -> V_146 = F_72 ( V_11 -> V_3 ) ;
if ( V_11 -> V_99 -> V_147 ) {
V_11 -> V_99 -> V_147 ( F_73 ( V_11 -> V_3 ) ) ;
} else if ( F_68 ( V_11 -> V_146 ) && F_54 ( V_11 ) ) {
return - V_59 ;
}
F_36 ( V_11 -> V_84 ) ;
V_12 = F_60 ( V_11 ) ;
...
V_11 -> V_148 = V_12 = F_74 ( V_2 , 0 ) ;
if ( V_12 <= 0 ) {
F_21 ( & V_2 -> V_3 , L_46 ) ;
return V_12 ;
}
V_12 = F_75 ( & V_2 -> V_3 , V_11 -> V_148 , F_23 , 0 ,
F_76 ( & V_2 -> V_3 ) , V_11 ) ;
if ( V_12 != 0 ) {
F_21 ( & V_2 -> V_3 , L_47 , V_11 -> V_148 ) ;
return V_12 ;
}
V_12 = F_50 ( V_11 ) ;
if ( V_12 < 0 ) {
...
V_11 -> V_81 . V_149 = V_11 -> V_99 -> V_129 ;
...
F_80 ( & V_2 -> V_3 ) ;
F_80 ( & V_11 -> V_81 . V_3 ) ;
F_49 ( & V_2 -> V_3 , L_50 , F_76 ( & V_11 -> V_81 . V_3 ) ) ;
return 0 ;
}
...
F_84 ( & V_11 -> V_81 ) ;
F_37 ( V_11 -> V_84 ) ;
if ( V_2 -> V_3 . V_4 && F_68 ( V_11 -> V_146 ) )
F_59 ( V_11 ) ;
return 0 ;
}
static int F_85 ( struct V_150 * V_3 )
{
struct V_1 * V_2 = F_73 ( V_3 ) ;
struct V_10 * V_11 = F_82 ( V_2 ) ;
V_11 -> V_76 = 1 ;
return 0 ;
}
