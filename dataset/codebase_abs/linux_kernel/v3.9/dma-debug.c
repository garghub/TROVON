...
static void F_75 ( struct V_4 * V_5 , void * V_103 )
{
if ( F_76 ( V_103 ) )
F_64 ( V_5 , NULL , L_49
L_50 , V_103 ) ;
}
static inline bool F_77 ( void * V_103 , unsigned long V_70 , void * V_104 , void * V_105 )
{
unsigned long V_106 = ( unsigned long ) V_103 ;
unsigned long V_107 = V_106 + V_70 ;
unsigned long V_108 = ( unsigned long ) V_104 ;
unsigned long V_109 = ( unsigned long ) V_105 ;
return ! ( V_107 <= V_108 || V_106 >= V_109 ) ;
}
static void F_78 ( struct V_4 * V_5 , void * V_103 , unsigned long V_70 )
{
if ( F_77 ( V_103 , V_70 , V_110 , V_111 ) ||
F_77 ( V_103 , V_70 , V_112 , V_113 ) )
F_64 ( V_5 , NULL , L_51 , V_103 , V_70 ) ;
}
...
void F_86 ( struct V_4 * V_5 , T_8 V_103 ,
