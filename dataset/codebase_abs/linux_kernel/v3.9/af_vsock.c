...
T_4 F_68 ( struct V_8 * V_9 )
{
return V_1 -> V_93 ( V_9 ) ;
}
T_4 F_69 ( struct V_8 * V_9 )
{
return V_1 -> V_94 ( V_9 ) ;
}
...
struct V_126 * V_127 , T_6 V_128 , int V_137 )
{
...
unsigned int V_223 , void T_7 * V_224 )
{
T_2 T_7 * V_225 = V_224 ;
int V_57 = 0 ;
switch ( V_223 ) {
...
{
return F_111 ( V_222 , V_223 , ( void T_7 * ) V_227 ) ;
}
...
int F_122 ( const struct V_233 * V_234 )
{
int V_57 = F_123 ( & V_235 ) ;
if ( V_57 )
return V_57 ;
if ( V_1 ) {
V_57 = - V_236 ;
