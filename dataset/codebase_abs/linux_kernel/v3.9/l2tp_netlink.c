...
& V_74 -> V_102 ) ||
F_35 ( V_16 , V_44 , sizeof( V_74 -> V_103 ) ,
& V_74 -> V_103 ) )
goto V_77;
} else
#endif
...
static int F_48 ( struct V_15 * V_16 , T_1 V_64 , T_1 V_65 , int V_66 ,
struct V_1 * V_9 )
{
void * V_18 ;
struct V_67 * V_68 ;
...
static int F_52 ( struct V_15 * V_16 , struct V_2 * V_3 )
{
struct V_1 * V_9 ;
struct V_15 * V_17 ;
int V_19 ;
...
V_19 = F_48 ( V_17 , V_3 -> V_25 , V_3 -> V_26 ,
0 , V_9 ) ;
if ( V_19 < 0 )
goto V_30;
return F_12 ( F_2 ( V_3 ) , V_17 , V_3 -> V_25 ) ;
...
static int F_53 ( struct V_15 * V_16 , struct V_107 * V_108 )
{
struct V_10 * V_10 = F_40 ( V_16 -> V_70 ) ;
struct V_1 * V_9 ;
struct V_7 * V_8 = NULL ;
...
if ( F_48 ( V_16 , F_42 ( V_108 -> V_16 ) . V_64 ,
V_108 -> V_110 -> V_111 , V_112 ,
V_9 ) <= 0 )
break;
V_163 ++ ;
...
int F_55 ( enum V_164 V_118 , const struct V_149 * V_165 )
{
int V_19 ;
V_19 = - V_36 ;
if ( V_118 >= V_119 )
