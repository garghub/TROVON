...
static void F_46 ( struct V_102 * V_50 )
{
F_47 ( & V_50 -> V_55 , & V_103 ) ;
F_47 ( & V_50 -> V_55 , & V_104 ) ;
F_47 ( & V_50 -> V_55 , & V_105 ) ;
F_47 ( & V_50 -> V_55 , & V_106 ) ;
F_47 ( & V_50 -> V_55 , & V_107 ) ;
}
static int F_48 ( struct V_102 * V_50 )
{
int V_42 ;
int V_38 = 0 ;
...
static int F_55 ( struct V_102 * V_50 )
{
int V_42 , V_43 ;
struct V_44 V_28 ;
V_42 = F_1 ( V_41 , 0 , & V_28 ,
...
default:
F_5 ( L_17 ,
V_28 . V_50 [ V_43 ] . V_119 ) ;
continue;
}
if ( ! V_28 . V_50 [ V_43 ] . V_120 ) {
F_5 ( L_18 ,
V_43 , V_28 . V_51 ) ;
continue;
}
V_53 = F_49 ( V_89 , & V_50 -> V_55 , type ,
& V_121 , ( void * ) ( long ) V_43 ) ;
if ( ! V_53 ) {
V_42 = - V_88 ;
goto V_122;
}
...
static int T_5 F_56 ( struct V_102 * V_50 )
{
int V_42 ;
V_78 = NULL ;
V_80 = NULL ;
...
if ( V_42 )
goto V_124;
V_42 = F_57 ( & V_50 -> V_55 , & V_106 ) ;
if ( V_42 )
goto V_124;
V_42 = F_57 ( & V_50 -> V_55 , & V_107 ) ;
if ( V_42 )
goto V_124;
return 0 ;
V_124:
...
static int T_6 F_58 ( struct V_102 * V_50 )
{
int V_43 ;
F_46 ( V_50 ) ;
for ( V_43 = 0 ; V_43 < V_45 ; V_43 ++ ) {
