...
T_4 V_112 = F_50 ( V_5 -> V_57 . V_112 ) ;
T_4 V_58 = F_50 ( V_5 -> V_57 . V_58 ) ;
if ( V_112 == V_111 [ V_101 ] . V_112 &&
V_58 == V_111 [ V_101 ] . V_58 )
break;
}
if ( V_101 < 0 ) {
V_84 = - V_108 ;
...
V_103 = & V_113 [ V_101 ] ;
F_51 ( & V_98 -> V_92 , L_14 , V_103 -> V_114 ) ;
V_105 = F_50 ( V_5 -> V_57 . V_58 ) ;
...
case V_62 :
case V_63 :
V_84 = F_55 ( V_98 , (struct V_65 * ) V_2 ) ;
break;
case V_66 :
case V_67 :
V_84 = F_56 ( V_98 ,
...
if ( V_84 < 0 )
goto V_139;
V_84 = F_59 ( & V_98 -> V_92 . V_140 , & V_5 -> V_92 . V_140 ,
L_19 ) ;
if ( V_84 < 0 )
goto V_139;
F_51 ( & V_98 -> V_92 , L_20 ,
...
static int F_70 ( struct V_97 * V_98 , T_5 V_27 )
{
struct V_1 * V_2 = F_45 ( V_98 ) ;
struct V_141 * V_142 = V_2 -> V_142 ;
F_71 ( V_2 -> V_143 , V_144 ) ;
