...
int F_24 ( struct V_2 * V_3 , unsigned V_5 )
{
int V_26 = V_3 -> V_69 + V_5 ;
return F_25 ( V_26 ) ;
}
void F_26 ( struct V_2 * V_3 , unsigned V_5 )
{
int V_26 = V_3 -> V_69 + V_5 ;
F_27 ( V_26 ) ;
}
...
V_122 = F_47 ( V_123 , & V_109 -> V_11 ) ;
if ( ! V_122 )
return - V_90 ;
V_119 = ( unsigned long ) V_122 -> V_124 ;
} else {
F_6 ( & V_109 -> V_11 , L_37 ) ;
return - V_90 ;
}
...
if ( V_118 )
V_119 = V_118 -> V_125 ;
V_7 = F_48 ( & V_109 -> V_11 , sizeof( struct V_1 ) ,
V_126 ) ;
if ( V_7 == NULL ) {
F_6 ( & V_109 -> V_11 ,
L_38 ) ;
...
V_7 -> V_11 = & V_109 -> V_11 ;
V_7 -> V_39 = F_49 ( V_109 -> V_11 . V_39 ) ;
V_7 -> V_3 = V_128 ;
V_7 -> V_3 . V_11 = & V_109 -> V_11 ;
V_7 -> V_3 . V_69 = V_113 -> V_129 ;
V_7 -> V_3 . V_69 = ( V_115 ) ? - 1 : V_113 -> V_129 ;
F_50 ( & V_7 -> V_130 ) ;
switch ( V_119 ) {
case V_131 :
F_51 ( & V_7 -> V_18 ) ;
