...
V_27 = F_33 ( sizeof( struct V_26 ) , V_80 ) ;
if ( ! V_27 )
return - V_81 ;
F_34 ( & V_27 -> V_41 ) ;
V_27 -> V_37 = & V_76 -> V_37 ;
V_27 -> V_34 = V_34 ;
V_27 -> V_82 = V_34 -> V_82 ;
V_27 -> V_34 -> V_35 = F_35 ( V_27 -> V_34 -> V_82 ,
& V_83 ) ;
if ( F_36 ( V_27 -> V_34 -> V_35 ) ) {
V_30 = F_37 ( V_27 -> V_34 -> V_35 ) ;
...
V_79 = F_43 ( V_34 -> V_87 , V_88 ) ;
if ( ! V_79 )
goto V_84;
V_27 -> V_79 = V_79 ;
V_30 = F_44 ( V_79 , NULL , F_25 , 0 ,
L_26 , V_27 ) ;
if ( V_30 < 0 ) {
F_7 ( & V_76 -> V_37 , L_27 ,
V_27 -> V_79 , V_30 ) ;
