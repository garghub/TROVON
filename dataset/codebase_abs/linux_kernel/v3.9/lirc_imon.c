...
V_98 = F_45 ( V_12 -> V_106 . V_107 ) ;
V_99 = F_45 ( V_12 -> V_106 . V_108 ) ;
F_5 ( V_4 , L_27 ,
V_9 , V_98 , V_99 , V_92 ) ;
...
V_5 = F_41 ( sizeof( struct V_90 ) , V_40 ) ;
if ( ! V_5 ) {
V_97 = 2 ;
goto V_100;
}
V_8 = F_46 ( sizeof( struct V_91 ) , V_40 ) ;
if ( ! V_8 ) {
V_97 = 3 ;
goto V_100;
}
if ( F_47 ( V_8 , V_120 , V_121 ) ) {
F_8 ( V_4 , L_33 , V_9 ) ;
V_97 = 4 ;
goto V_100;
}
...
static int F_59 ( struct V_15 * V_71 , T_6 V_139 )
{
