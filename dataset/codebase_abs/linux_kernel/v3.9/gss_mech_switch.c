...
static struct V_1 * F_23 ( T_1 V_16 )
{
...
int F_26 ( T_2 * V_28 , int V_29 )
{
struct V_1 * V_22 = NULL ;
int V_30 , V_5 = 0 ;
F_8 ( & V_17 ) ;
F_17 (pos, &registered_mechs, gm_list) {
for ( V_30 = 0 ; V_30 < V_22 -> V_6 ; V_30 ++ ) {
if ( V_5 >= V_29 ) {
F_10 ( & V_17 ) ;
return - V_14 ;
}
V_28 [ V_5 ++ ] = V_22 -> V_7 [ V_30 ] . V_16 ;
}
}
F_10 ( & V_17 ) ;
return V_5 ;
...
T_1
F_27 ( struct V_1 * V_2 , T_1 V_31 )
{
int V_5 ;
for ( V_5 = 0 ; V_5 < V_2 -> V_6 ; V_5 ++ ) {
if ( V_2 -> V_7 [ V_5 ] . V_31 == V_31 ) {
...
for ( V_5 = 0 ; V_5 < V_2 -> V_6 ; V_5 ++ ) {
if ( V_2 -> V_7 [ V_5 ] . V_16 == V_16 )
return V_2 -> V_7 [ V_5 ] . V_31 ;
}
return 0 ;
}
char *
F_29 ( struct V_1 * V_2 , T_1 V_31 )
{
int V_5 ;
for ( V_5 = 0 ; V_5 < V_2 -> V_6 ; V_5 ++ ) {
if ( V_2 -> V_7 [ V_5 ] . V_31 == V_31 )
...
int
F_31 ( const void * V_33 , T_3 V_34 ,
struct V_1 * V_35 ,
struct V_36 * * V_37 ,
T_4 V_38 )
{
if ( ! ( * V_37 = F_32 ( sizeof( * * V_37 ) , V_38 ) ) )
return - V_14 ;
( * V_37 ) -> V_39 = F_14 ( V_35 ) ;
return V_35 -> V_40
-> F_31 ( V_33 , V_34 , * V_37 , V_38 ) ;
}
T_1
F_33 ( struct V_36 * V_41 ,
struct V_42 * V_43 ,
struct V_23 * V_44 )
{
return V_41 -> V_39 -> V_40
-> F_33 ( V_41 ,
V_43 ,
V_44 ) ;
}
T_1
F_34 ( struct V_36 * V_41 ,
struct V_42 * V_43 ,
struct V_23 * V_44 )
{
return V_41 -> V_39 -> V_40
