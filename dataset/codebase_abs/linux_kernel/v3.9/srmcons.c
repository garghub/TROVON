...
static int
F_15 ( struct V_25 * V_17 ,
const unsigned char * V_20 , int V_4 )
{
unsigned long V_13 ;
F_16 ( & V_15 , V_13 ) ;
F_12 ( V_17 -> V_2 , ( const char * ) V_20 , V_4 ) ;
F_17 ( & V_15 , V_13 ) ;
return V_4 ;
}
static int
F_18 ( struct V_25 * V_17 )
{
return 512 ;
}
static int
...
static int
F_20 ( struct V_25 * V_17 , struct V_26 * V_27 )
{
...
V_17 -> V_2 = V_2 ;
V_2 -> V_17 = V_17 ;
F_10 ( & V_12 -> V_18 , V_19 + 10 ) ;
}
F_17 ( & V_2 -> V_16 , V_13 ) ;
return 0 ;
}
static void
F_21 ( struct V_25 * V_17 , struct V_26 * V_27 )
{
struct V_11 * V_12 = V_17 -> V_29 ;
struct V_1 * V_2 = & V_12 -> V_2 ;
unsigned long V_13 ;
F_16 ( & V_2 -> V_16 , V_13 ) ;
if ( V_17 -> V_4 == 1 ) {
...
static void
F_32 ( struct V_48 * V_49 , const char * V_50 , unsigned V_4 )
{
unsigned long V_13 ;
F_16 ( & V_15 , V_13 ) ;
F_12 ( NULL , V_50 , V_4 ) ;
...
static struct V_31 *
F_33 ( struct V_48 * V_49 , int * V_51 )
{
* V_51 = V_49 -> V_51 ;
return V_46 ;
}
static int
F_34 ( struct V_48 * V_49 , char * V_52 )
{
return 0 ;
}
void T_2
