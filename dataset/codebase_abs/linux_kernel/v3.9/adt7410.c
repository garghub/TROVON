...
V_11 -> V_21 = F_17 ( F_16 ( V_37 - V_21 , 1000 ) , 0 ,
V_36 ) ;
...
V_12 = F_35 ( & V_2 -> V_10 . V_51 , & V_52 ) ;
if ( V_12 )
goto V_53;
V_11 -> V_54 = F_36 ( & V_2 -> V_10 ) ;
if ( F_21 ( V_11 -> V_54 ) ) {
V_12 = F_22 ( V_11 -> V_54 ) ;
goto V_55;
}
F_37 ( & V_2 -> V_10 , L_6 , V_2 -> V_56 ) ;
return 0 ;
V_55:
F_38 ( & V_2 -> V_10 . V_51 , & V_52 ) ;
V_53:
