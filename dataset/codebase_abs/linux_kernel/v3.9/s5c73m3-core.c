...
static int F_83 ( int V_194 , int V_82 , const char * V_175 )
{
unsigned long V_25 = V_82 ? V_195 : V_196 ;
int V_17 ;
if ( ! F_71 ( V_194 ) )
return 0 ;
V_17 = F_84 ( V_194 , V_25 , V_175 ) ;
if ( ! V_17 )
F_85 ( V_194 , 0 ) ;
return V_17 ;
}
...
V_17 = F_83 ( V_181 -> V_181 , V_181 -> V_182 , L_36 ) ;
if ( V_17 ) {
F_86 ( V_30 ) ;
return V_17 ;
}
...
F_72 ( V_181 -> V_181 , 0 ) ;
V_181 = & V_198 -> V_201 ;
V_17 = F_83 ( V_181 -> V_181 , V_181 -> V_182 , L_37 ) ;
if ( V_17 ) {
F_86 ( V_30 ) ;
return V_17 ;
}
...
V_30 = F_91 ( V_65 , sizeof( * V_30 ) , V_205 ) ;
if ( ! V_30 )
return - V_206 ;
F_92 ( & V_30 -> V_95 ) ;
V_60 = & V_30 -> V_45 ;
...
F_94 ( V_60 , V_30 ) ;
F_95 ( V_60 -> V_175 , L_39 , sizeof( V_60 -> V_175 ) ) ;
V_60 -> V_210 = & V_211 ;
V_60 -> V_25 |= V_212 ;
V_30 -> V_213 [ V_154 ] . V_25 = V_214 ;
V_30 -> V_213 [ V_138 ] . V_25 = V_214 ;
V_60 -> V_191 . type = V_215 ;
V_17 = F_96 ( & V_60 -> V_191 , V_167 ,
V_30 -> V_213 , 0 ) ;
if ( V_17 < 0 )
return V_17 ;
F_97 ( V_190 , V_13 , & V_216 ) ;
