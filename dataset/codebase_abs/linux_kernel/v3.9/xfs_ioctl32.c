...
unsigned long V_59 )
{
struct V_138 * V_138 = F_48 ( V_137 ) ;
struct V_139 * V_140 = F_32 ( V_138 ) ;
struct V_12 * V_13 = V_140 -> V_141 ;
...
if ( F_1 ( & V_1 , V_95 ) )
return - F_4 ( V_11 ) ;
V_66 = F_52 ( V_66 , struct V_183 ) ;
return F_53 ( V_140 , V_138 , V_137 , V_142 , V_66 , & V_1 ) ;
}
case V_184 :
...
case V_190 : {
struct V_191 V_192 ;
struct V_193 T_3 * V_194 = V_95 ;
if ( F_3 ( & V_192 , V_194 ,
F_54 ( struct V_191 , V_195 ) ) ||
F_13 ( & V_192 . V_195 , & V_194 -> V_195 ) )
return - F_4 ( V_11 ) ;
error = F_39 ( V_137 ) ;
if ( error )
return error ;
...
if ( F_24 ( & V_83 , V_95 ) )
return - F_4 ( V_11 ) ;
V_66 = F_52 ( V_66 , struct V_199 ) ;
return F_55 ( V_66 , & V_83 ) ;
}
case V_200 : {
struct V_199 V_83 ;
if ( F_24 ( & V_83 , V_95 ) )
