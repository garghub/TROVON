...
void * V_48 )
{
struct V_1 * V_1 = F_56 ( V_45 -> V_49 ) ;
struct V_50 * V_51 ;
struct V_52 * V_53 [ V_54 + 1 ] ;
struct V_10 * V_55 ;
T_1 V_16 ;
int V_40 = 0 ;
V_40 = F_57 ( V_47 , sizeof( * V_51 ) , V_53 , V_54 , V_56 ) ;
if ( V_40 < 0 )
return V_40 ;
V_51 = F_58 ( V_47 ) ;
if ( V_51 -> V_57 != V_58 ||
...
! F_61 ( V_1 , V_51 -> V_64 ) )
return - V_24 ;
V_40 = F_39 ( V_1 , V_55 , V_51 -> V_59 ,
V_51 -> V_64 , V_16 ,
V_47 -> V_65 & V_66 ) ;
break;
case V_67 :
V_40 = F_46 ( V_1 , V_55 , V_51 -> V_59 ,
V_51 -> V_64 ) ;
break;
default:
V_40 = - V_68 ;
...
struct V_2 * V_5 ,
T_1 V_69 ,
T_1 V_72 , T_1 V_36 , int V_73 ,
unsigned int V_74 )
{
struct V_46 * V_47 = F_64 ( V_45 , V_72 , V_36 , V_73 ,
sizeof( struct V_50 ) , V_74 ) ;
if ( ! V_47 )
return - V_75 ;
F_62 ( V_47 , V_5 -> V_15 , V_5 -> V_13 , V_69 ) ;
if ( F_65 ( V_45 , V_60 , 16 , & V_5 -> V_14 ) < 0 ||
F_66 ( V_45 , V_61 , V_5 -> V_16 ) < 0 ) {
F_67 ( V_45 , V_47 ) ;
return - V_75 ;
}
return F_68 ( V_45 , V_47 ) ;
}
static int F_69 ( struct V_44 * V_45 , struct V_76 * V_77 )
{
struct V_1 * V_1 = F_56 ( V_45 -> V_49 ) ;
struct V_2 * V_5 ;
...
{
return F_72 ( sizeof( struct V_50 ) )
+ F_73 ( 16 )
+ F_73 ( 4 ) ;
}
static int F_74 ( struct V_44 * V_83 , struct V_46 * V_47 ,
void * V_48 )
{
struct V_1 * V_1 = F_56 ( V_83 -> V_49 ) ;
struct V_50 * V_51 ;
struct V_52 * V_53 [ V_54 + 1 ] ;
struct V_10 * V_11 ;
T_1 V_69 ;
...
V_40 = F_63 ( V_45 , V_5 , V_69 ,
F_70 ( V_83 ) . V_72 , V_47 -> V_80 ,
V_63 , 0 ) ;
F_11 ( V_5 ) ;
if ( V_40 < 0 ) {
F_76 ( V_40 == - V_75 ) ;
...
V_40 = F_78 ( V_45 , V_1 , F_70 ( V_83 ) . V_72 ) ;
V_35:
return V_40 ;
}
void T_4 F_79 ( void )
