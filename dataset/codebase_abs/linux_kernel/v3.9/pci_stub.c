...
static struct V_1 * F_28 ( int V_22 , int V_15 ,
int V_23 , int V_24 )
{
struct V_1 * V_4 = NULL ;
unsigned long V_25 ;
...
if ( V_4 -> V_3 != NULL
&& V_22 == F_16 ( V_4 -> V_3 -> V_15 )
&& V_15 == V_4 -> V_3 -> V_15 -> V_16
&& V_23 == F_31 ( V_4 -> V_3 -> V_17 )
&& V_24 == F_32 ( V_4 -> V_3 -> V_17 ) ) {
F_24 ( V_4 ) ;
goto V_27;
}
}
...
static struct V_2 * F_34 ( struct V_28 * V_29 ,
struct V_1 * V_4 )
{
struct V_2 * V_2 = NULL ;
unsigned long V_25 ;
...
struct V_2 * F_36 ( struct V_28 * V_29 ,
struct V_2 * V_3 )
{
struct V_1 * V_4 ;
struct V_2 * V_30 = NULL ;
...
F_20 ( V_3 , V_9 ) ;
sprintf ( V_9 -> V_40 , V_38 L_7 , F_46 ( V_3 ) ) ;
F_2 ( & V_3 -> V_3 , L_8 ) ;
F_47 ( & V_41 ) ;
V_18 = F_48 ( V_3 ) ;
if ( V_18 )
...
static int F_60 ( struct V_2 * V_3 , const struct V_49 * V_50 )
{
int V_18 = 0 ;
F_2 ( & V_3 -> V_3 , L_18 ) ;
if ( F_44 ( V_3 ) ) {
...
V_31 -> V_29 ) ;
if ( V_31 -> V_29 ) {
F_64 (KERN_WARNING DRV_NAME L_25
L_26 ,
pci_name(found_psdev->dev)) ;
F_64 (KERN_WARNING DRV_NAME L_27
L_28 ) ;
F_64 (KERN_WARNING DRV_NAME L_29
L_30 ) ;
F_64 (KERN_WARNING DRV_NAME L_31
L_32 ) ;
F_65 ( V_31 -> V_29 ,
V_31 -> V_3 ) ;
}
...
F_74 ( V_73 , ( unsigned long * ) & V_4 -> V_29 -> V_25 ) ;
F_74 ( V_74 ,
( unsigned long * ) & V_4 -> V_29 -> V_70 -> V_25 ) ;
F_73 () ;
F_75 ( V_4 -> V_29 -> V_75 ) ;
V_69 = F_76 ( V_41 ,
! ( F_77 ( V_74 , ( unsigned long * )
...
F_78 ( V_73 , ( unsigned long * ) & V_4 -> V_29 -> V_25 ) ;
if ( F_77 ( V_77 ,
( unsigned long * ) & V_4 -> V_29 -> V_70 -> V_25 ) ) {
F_2 ( & V_4 -> V_3 -> V_3 ,
L_41 V_38 L_42 ) ;
...
static inline int F_84 ( const char * V_87 , int * V_22 , int * V_15 ,
int * V_23 , int * V_24 )
{
int V_88 = 0 ;
...
static inline int F_85 ( const char * V_87 , int * V_22 , int * V_15 , int
...
static int F_86 ( int V_22 , int V_15 , int V_23 , int V_24 )
{
struct V_33 * V_93 ;
unsigned long V_25 ;
int V_94 = 0 , V_17 = F_87 ( V_23 , V_24 ) ;
if ( V_23 < 0 ) {
for ( V_23 = 0 ; ! V_94 && V_23 < 32 ; ++ V_23 )
V_94 = F_86 ( V_22 , V_15 , V_23 , V_24 ) ;
return V_94 ;
}
if ( V_24 < 0 ) {
...
V_22 , V_15 , V_23 , V_24 ) ;
F_29 ( & V_37 , V_25 ) ;
F_57 ( & V_93 -> V_99 , & V_100 ) ;
F_33 ( & V_37 , V_25 ) ;
return 0 ;
}
static int F_90 ( int V_22 , int V_15 , int V_23 , int V_24 )
{
struct V_33 * V_93 , * V_101 ;
int V_18 = - V_102 ;
unsigned long V_25 ;
F_29 ( & V_37 , V_25 ) ;
F_91 (pci_dev_id, t, &pcistub_device_ids,
slot_list) {
if ( V_93 -> V_22 == V_22 && V_93 -> V_15 == V_15
&& ( V_23 < 0 || F_31 ( V_93 -> V_17 ) == V_23 )
&& ( V_24 < 0 || F_32 ( V_93 -> V_17 ) == V_24 ) ) {
F_56 ( & V_93 -> V_99 ) ;
F_5 ( V_93 ) ;
V_18 = 0 ;
F_54 ( V_38 L_64
...
static int F_92 ( int V_22 , int V_15 , int V_23 , int V_24 ,
...
int V_18 ;
V_18 = F_84 ( V_87 , & V_22 , & V_15 , & V_23 , & V_24 ) ;
if ( V_18 )
goto V_27;
V_18 = F_86 ( V_22 , V_15 , V_23 , V_24 ) ;
V_27:
if ( ! V_18 )
V_18 = V_113 ;
return V_18 ;
}
static T_4 F_95 ( struct V_111 * V_112 , const char * V_87 ,
T_5 V_113 )
{
int V_22 , V_15 , V_23 , V_24 ;
int V_18 ;
...
if ( V_18 )
goto V_27;
V_18 = F_90 ( V_22 , V_15 , V_23 , V_24 ) ;
V_27:
if ( ! V_18 )
V_18 = V_113 ;
return V_18 ;
}
static T_4 F_96 ( struct V_111 * V_112 , char * V_87 )
{
struct V_33 * V_93 ;
T_5 V_113 = 0 ;
unsigned long V_25 ;
...
if ( V_113 >= V_114 )
break;
V_113 += F_97 ( V_87 + V_113 , V_114 - V_113 ,
L_66 ,
V_93 -> V_22 , V_93 -> V_15 ,
F_31 ( V_93 -> V_17 ) ,
F_32 ( V_93 -> V_17 ) ) ;
...
static T_4 F_98 ( struct V_111 * V_112 , char * V_87 )
{
struct V_1 * V_4 ;
struct V_8 * V_9 ;
T_5 V_113 = 0 ;
...
static T_4 F_99 ( struct V_111 * V_112 ,
const char * V_87 ,
T_5 V_113 )
{
struct V_1 * V_4 ;
...
static T_4 F_100 ( struct V_111 * V_112 , const char * V_87 ,
T_5 V_113 )
{
int V_22 , V_15 , V_23 , V_24 , V_90 , V_91 , V_92 ;
int V_18 ;
V_18 = F_85 ( V_87 , & V_22 , & V_15 , & V_23 , & V_24 , & V_90 , & V_91 ,
& V_92 ) ;
if ( V_18 )
goto V_27;
V_18 = F_92 ( V_22 , V_15 , V_23 , V_24 , V_90 , V_91 , V_92 ) ;
V_27:
if ( ! V_18 )
V_18 = V_113 ;
return V_18 ;
...
static T_4 F_102 ( struct V_111 * V_112 , const char * V_87 ,
T_5 V_113 )
{
int V_22 , V_15 , V_23 , V_24 ;
int V_18 ;
...
static T_4 F_103 ( struct V_111 * V_112 , char * V_87 )
{
struct V_1 * V_4 ;
struct V_8 * V_9 ;
T_5 V_113 = 0 ;
...
continue;
V_113 +=
F_97 ( V_87 + V_113 , V_114 - V_113 , L_78 ,
F_46 ( V_4 -> V_3 ) ) ;
}
F_33 ( & V_26 , V_25 ) ;
return V_113 ;
...
{
F_105 ( & V_130 . V_131 , & V_132 ) ;
F_105 ( & V_130 . V_131 ,
& V_133 ) ;
F_105 ( & V_130 . V_131 , & V_134 ) ;
