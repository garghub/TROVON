...
static inline void F_63 ( struct V_20 * V_21 )
{
T_1 V_171 = V_172 ;
if ( F_64 ( V_173 ) )
V_171 |= V_174 ;
F_65 ( & V_21 -> V_25 -> V_171 , V_171 ) ;
}
static int F_66 ( struct V_11 * V_12 , int V_175 )
{
struct V_13 * V_16 = V_12 -> V_17 ;
int V_176 = 0 ;
if ( ( V_16 -> V_26 == V_27 ) && V_8 . V_177 )
V_8 . V_177 () ;
F_67 ( & V_178 ) ;
V_16 -> V_32 ++ ;
if ( V_16 -> V_32 == 1 ) {
...
static int F_69 ( struct V_11 * V_12 , int V_175 )
{
struct V_13 * V_16 = V_12 -> V_17 ;
int V_176 = 0 ;
F_67 ( & V_178 ) ;
...
bool V_179 = true ;
int V_86 ;
for ( V_86 = 0 ; V_86 < V_180 ; V_86 ++ ) {
struct V_13 * V_181 = V_21 -> V_52 [ V_86 ] . V_17 ;
if ( V_181 -> V_32 )
V_179 = false ;
}
if ( V_179 )
F_4 ( & V_21 -> V_25 -> V_171 , 0xffffffff ) ;
F_8 ( V_12 ) ;
}
F_68 ( & V_178 ) ;
return V_176 ;
...
struct V_13 * V_16 = V_12 -> V_17 ;
struct V_20 * V_21 = V_16 -> V_22 ;
const char * V_183 , * V_184 = L_13 ;
struct V_185 * V_186 = V_187 ;
unsigned int V_188 = F_71 ( V_187 ) ;
int V_189 = 1 ;
V_12 -> V_41 . V_190 = V_191 ;
V_12 -> V_192 = & V_193 ;
V_12 -> V_194 = V_195 | V_196 | V_197 |
V_198 ;
V_12 -> V_136 = V_16 -> V_136 ;
V_182 = F_72 ( & V_12 -> V_199 , 16 , 0 ) ;
if ( V_182 )
return V_182 ;
if ( V_16 -> V_26 == V_27 ) {
if ( V_21 -> V_200 ) {
F_73 ( V_21 -> V_201 , & V_12 -> V_202 ) ;
F_74 ( V_12 -> V_202 . V_203 ,
V_12 -> V_202 . V_204 ,
& V_12 -> V_205 ) ;
V_186 = V_12 -> V_202 . V_203 ;
V_188 = V_12 -> V_202 . V_204 ;
}
V_183 = V_206 ;
} else {
V_183 = V_184 ;
}
V_182 = F_75 ( & V_12 -> V_41 , V_12 , V_183 , V_186 , V_188 , NULL ,
V_62 ) ;
if ( ! V_182 ) {
if ( ( V_16 -> V_26 == V_27 ) && V_21 -> V_200 )
V_189 = 0 ;
else
return - V_138 ;
}
if ( ! V_189 ) {
V_182 = F_75 ( & V_12 -> V_41 , V_12 , V_183 , V_187 ,
F_71 ( V_187 ) , NULL , V_62 ) ;
if ( V_182 )
V_189 = 1 ;
}
if ( ! V_189 && V_12 -> V_202 . V_203 ) {
struct V_207 * V_208 = & V_12 -> V_202 ;
struct V_185 * V_203 = & V_208 -> V_203 [ 0 ] ;
if ( V_208 -> V_209 & V_210 ) {
int V_86 ;
for ( V_86 = 0 ; V_86 < V_208 -> V_204 ; V_86 ++ ) {
if ( V_208 -> V_203 [ V_86 ] . V_211 & V_212 ) {
V_203 = & V_208 -> V_203 [ V_86 ] ;
break;
}
}
}
V_12 -> V_41 . V_61 = V_62 ;
F_76 ( & V_12 -> V_41 , V_203 ) ;
}
...
V_16 -> V_213 = 1 ;
F_79 ( V_12 -> V_111 , L_16 , V_16 -> V_77 ) ;
return 0 ;
}
...
static T_13 F_82 ( int V_214 , void * V_215 )
{
struct V_23 T_2 * V_24 = V_215 ;
T_14 V_216 = F_5 ( & V_24 -> V_217 ) ;
if ( V_216 ) {
if ( V_216 & V_172 ) {
F_4 ( & V_24 -> V_38 , 0 ) ;
F_83 ( 1 ) ;
...
static int F_85 ( struct V_222 * V_223 , T_15 V_224 )
{
struct V_20 * V_21 ;
V_21 = F_86 ( & V_223 -> V_111 ) ;
F_10 ( V_21 -> V_52 ) ;
return 0 ;
}
...
static T_16 F_88 ( struct V_225 * V_225 ,
struct V_226 * V_227 , const char * V_148 , T_5 V_32 )
{
enum V_1 V_228 ;
struct V_20 * V_21 =
F_89 ( V_227 , struct V_20 , V_229 ) ;
V_228 = V_21 -> V_91 ;
V_21 -> V_91 = F_1 ( V_148 ) ;
if ( V_228 != V_21 -> V_91 ) {
unsigned int V_86 ;
...
static T_16 F_90 ( struct V_225 * V_225 ,
struct V_226 * V_227 , char * V_148 )
{
struct V_20 * V_21 =
F_89 ( V_227 , struct V_20 , V_229 ) ;
switch ( V_21 -> V_91 ) {
...
static int F_91 ( struct V_222 * V_230 )
{
struct V_231 * V_232 = V_230 -> V_111 . V_233 ;
struct V_13 * V_16 ;
struct V_20 * V_21 ;
T_17 V_234 ;
const void * V_235 ;
unsigned int V_86 ;
int V_134 ;
V_21 = F_92 ( & V_230 -> V_111 , sizeof( struct V_20 ) ,
& V_234 , V_109 | V_110 ) ;
if ( ! V_21 )
return - V_112 ;
V_21 -> V_234 = V_234 ;
if ( ( unsigned long ) V_21 & 31 ) {
F_19 ( & V_230 -> V_111 , L_20 ) ;
V_134 = - V_112 ;
goto error;
}
F_93 ( & V_21 -> V_236 ) ;
...
V_235 = F_94 ( V_232 , L_21 , & V_134 ) ;
if ( V_235 && V_134 == V_238 ) {
memcpy ( V_21 -> V_201 , V_235 , V_238 ) ;
V_21 -> V_200 = true ;
}
V_21 -> V_25 = F_95 ( V_232 , 0 ) ;
if ( ! V_21 -> V_25 ) {
F_19 ( & V_230 -> V_111 , L_22 ) ;
V_134 = - V_153 ;
goto error;
}
V_21 -> V_214 = F_96 ( V_232 , 0 ) ;
if ( ! V_21 -> V_214 ) {
F_19 ( & V_230 -> V_111 , L_23 ) ;
V_134 = - V_138 ;
goto error;
}
V_21 -> V_91 = V_91 ;
V_21 -> V_36 . V_123 = F_7 ( F_15 ( V_21 , V_239 ) ) ;
...
if ( F_5 ( & V_21 -> V_25 -> V_38 ) == V_240 )
F_4 ( & V_21 -> V_25 -> V_28 [ 0 ] , 0 ) ;
F_4 ( & V_21 -> V_25 -> V_28 [ 1 ] , V_21 -> V_36 . V_29 ) ;
F_4 ( & V_21 -> V_25 -> V_28 [ 2 ] , V_21 -> V_36 . V_29 ) ;
F_4 ( & V_21 -> V_25 -> V_171 , 0xffffffff ) ;
F_5 ( & V_21 -> V_25 -> V_217 ) ;
V_134 = F_97 ( V_21 -> V_214 , F_82 , 0 , L_24 ,
V_21 -> V_25 ) ;
if ( V_134 ) {
F_19 ( & V_230 -> V_111 , L_25 ) ;
goto error;
}
for ( V_86 = 0 ; V_86 < V_180 ; V_86 ++ ) {
V_134 = F_70 ( & V_21 -> V_52 [ V_86 ] ) ;
if ( V_134 ) {
F_19 ( & V_230 -> V_111 , L_26 , V_86 ) ;
F_98 ( V_21 -> V_214 , V_21 -> V_25 ) ;
goto error;
}
}
F_99 ( & V_21 -> V_229 . V_227 ) ;
V_21 -> V_229 . V_227 . V_241 = L_27 ;
V_21 -> V_229 . V_227 . V_242 = V_243 | V_244 ;
V_21 -> V_229 . V_245 = F_90 ;
V_21 -> V_229 . V_246 = F_88 ;
V_134 = F_100 ( & V_230 -> V_111 , & V_21 -> V_229 ) ;
if ( V_134 ) {
F_19 ( & V_230 -> V_111 , L_28 ,
V_21 -> V_229 . V_227 . V_241 ) ;
}
F_101 ( & V_230 -> V_111 , V_21 ) ;
return 0 ;
error:
for ( V_86 = 0 ; V_86 < V_180 ; V_86 ++ )
F_80 ( & V_21 -> V_52 [ V_86 ] ) ;
...
static int F_103 ( struct V_222 * V_230 )
{
struct V_20 * V_21 ;
int V_86 ;
V_21 = F_86 ( & V_230 -> V_111 ) ;
F_10 ( & V_21 -> V_52 [ 0 ] ) ;
F_98 ( V_21 -> V_214 , V_21 -> V_25 ) ;
for ( V_86 = 0 ; V_86 < V_180 ; V_86 ++ )
F_80 ( & V_21 -> V_52 [ V_86 ] ) ;
...
static int T_18 F_104 ( char * V_247 )
{
char * V_248 ;
unsigned long V_5 ;
if ( ! V_247 || ! * V_247 )
return 0 ;
while ( ( V_248 = F_105 ( & V_247 , L_29 ) ) != NULL ) {
if ( ! * V_248 )
continue;
if ( ! strncmp ( V_248 , L_30 , 8 ) ) {
V_91 = F_1 ( V_248 + 8 ) ;
} else if ( ! strncmp ( V_248 , L_31 , 4 ) ) {
if ( ! F_2 ( V_248 + 4 , 10 , & V_5 ) )
V_62 = V_5 ;
} else
V_206 = V_248 ;
}
...
F_109 ( L_33 ) ;
#ifdef V_173
V_232 = F_110 ( NULL , L_34 ) ;
if ( ! V_232 ) {
F_48 ( L_35 ) ;
return - V_250 ;
}
V_235 = F_94 ( V_232 , L_36 , NULL ) ;
if ( V_235 == NULL ) {
F_48 ( L_37
L_38 ) ;
F_111 ( V_232 ) ;
...
V_218 = F_112 ( V_235 ) * 13 ;
V_218 /= 8 ;
F_113 ( L_39 ,
V_218 ) ;
V_235 = F_94 ( V_232 , L_40 , NULL ) ;
if ( V_235 == NULL ) {
F_48 ( L_41
L_38 ) ;
F_111 ( V_232 ) ;
